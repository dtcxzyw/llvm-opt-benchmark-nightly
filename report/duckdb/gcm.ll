...
bb.d:                                             ; preds = %.lr.ph80, %_ZL8gcm_multP19mbedtls_gcm_contextPKhPh.exit
  %.04079 = phi i64 [ %3, %.lr.ph80 ], [ %i.dl, %_ZL8gcm_multP19mbedtls_gcm_contextPKhPh.exit ] ; 4 uses
  %.04178 = phi ptr [ %2, %.lr.ph80 ], [ %i.dm, %_ZL8gcm_multP19mbedtls_gcm_contextPKhPh.exit ] ; 11 uses
...
vec.epilog.ph:                                    ; preds = %vector.memcheck
  ...
  %n.vec110 = sub nsw i64 %i.r, %i.s              ; 2 uses
  %i.t = add nsw i64 %.0.i46.lcssa, %n.vec110
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index111 = phi i64 [ 0, %vec.epilog.ph ], [ %index.next114, %vec.epilog.vector.body ] ; 2 uses
  %i.u = add nuw i64 %.0.i46.lcssa, %index111     ; 2 uses
  %i.v = getelementptr inbounds nuw i8, ptr %i.c, i64 %i.u ; 2 uses
  %wide.load112 = load <8 x i8>, ptr %i.v, align 1, !tbaa !15, !alias.scope !17, !noalias !20
  %i.w = getelementptr inbounds nuw i8, ptr %.04178, i64 %i.u
  %wide.load113 = load <8 x i8>, ptr %i.w, align 1, !tbaa !15, !alias.scope !20
  %i.x = xor <8 x i8> %wide.load113, %wide.load112
  store <8 x i8> %i.x, ptr %i.v, align 1, !tbaa !15, !alias.scope !17, !noalias !20
  %index.next114 = add nuw i64 %index111, 8       ; 2 uses
  %i.y = icmp eq i64 %index.next114, %n.vec110
  br i1 %i.y, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !22

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n115 = icmp eq i64 %i.s, 0
  br i1 %cmp.n115, label %_ZL11mbedtls_xorPhPKhS1_m.exit49, label %.lr.ph76.preheader
...
.lr.ph76.prol:                                    ; preds = %.lr.ph76.preheader, %.lr.ph76.prol
  ...
  %i.ac = getelementptr inbounds nuw i8, ptr %.04178, i64 %.1.i4875.prol
...
.lr.ph.1:                                         ; preds = %.lr.ph
  ...
  %i.aj = getelementptr inbounds nuw i8, ptr %.04178, i64 8
...
.lr.ph76:                                         ; preds = %.lr.ph76.prol.loopexit, %.lr.ph76
  ...
  %i.an = getelementptr inbounds nuw i8, ptr %.04178, i64 %.1.i4875
  ...
  %i.at = getelementptr inbounds nuw i8, ptr %.04178, i64 %i.aq
  ...
  %i.az = getelementptr inbounds nuw i8, ptr %.04178, i64 %i.aw
  ...
  %i.bf = getelementptr inbounds nuw i8, ptr %.04178, i64 %i.bc
...
_ZL8gcm_multP19mbedtls_gcm_contextPKhPh.exit:     ; preds = %_ZL11mbedtls_xorPhPKhS1_m.exit49, %_ZL19gcm_mult_smalltablePhPKhPA2_m.exit.i
  %i.dl = sub i64 %.04079, %i.p                   ; 2 uses
  %i.dm = getelementptr inbounds nuw i8, ptr %.04178, i64 %i.p
...
bb.g:                                             ; preds = %_ZL8gcm_multP19mbedtls_gcm_contextPKhPh.exit67, %bb.a
  %.0 = phi i32 [ -20, %bb.a ], [ %i.fp, %_ZL8gcm_multP19mbedtls_gcm_contextPKhPh.exit67 ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #7
  ret i32 %.0
}
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load143 = load <8 x i8>, ptr %i.s, align 1, !tbaa !15, !alias.scope !34, !noalias !37
  %i.t = getelementptr inbounds nuw i8, ptr %1, i64 %i.r
  %wide.load144 = load <8 x i8>, ptr %i.t, align 1, !tbaa !15, !alias.scope !37
...
bb.f:                                             ; preds = %_ZL8gcm_multP19mbedtls_gcm_contextPKhPh.exit, %bb.b
  ...
  %.047 = phi ptr [ %i.dm, %_ZL8gcm_multP19mbedtls_gcm_contextPKhPh.exit ], [ %1, %bb.b ] ; 2 uses
  %.045 = phi i64 [ %i.dl, %_ZL8gcm_multP19mbedtls_gcm_contextPKhPh.exit ], [ %2, %bb.b ] ; 3 uses
  store i64 %.pre-phi, ptr %i.a, align 8, !tbaa !33
  %i.dn = icmp ugt i64 %.045, 15
...
_ZL11mbedtls_xorPhPKhS1_m.exit59:                 ; preds = %_ZL8gcm_multP19mbedtls_gcm_contextPKhPh.exit83, %.lr.ph98
  ...
  %.197 = phi i64 [ %.045, %.lr.ph98 ], [ %i.fv, %_ZL8gcm_multP19mbedtls_gcm_contextPKhPh.exit83 ]
  %.14896 = phi ptr [ %.047, %.lr.ph98 ], [ %i.fw, %_ZL8gcm_multP19mbedtls_gcm_contextPKhPh.exit83 ] ; 3 uses
  ...
  %i.du = getelementptr inbounds nuw i8, ptr %.14896, i64 8
...
_ZL8gcm_multP19mbedtls_gcm_contextPKhPh.exit83:   ; preds = %_ZL11mbedtls_xorPhPKhS1_m.exit59, %_ZL19gcm_mult_smalltablePhPKhPA2_m.exit.i82
  ...
  %i.fv = add i64 %.197, -16                      ; 3 uses
  %i.fw = getelementptr inbounds nuw i8, ptr %.14896, i64 16 ; 2 uses
...
._crit_edge:                                      ; preds = %_ZL8gcm_multP19mbedtls_gcm_contextPKhPh.exit83, %bb.f
  %.148.lcssa = phi ptr [ %.047, %bb.f ], [ %i.fw, %_ZL8gcm_multP19mbedtls_gcm_contextPKhPh.exit83 ] ; 9 uses
  %.1.lcssa = phi i64 [ %.045, %bb.f ], [ %i.fv, %_ZL8gcm_multP19mbedtls_gcm_contextPKhPh.exit83 ] ; 10 uses
...
.preheader:                                       ; preds = %.preheader.loopexit, %bb.h
  ...
  %i.ga = icmp samesign ult i64 %.0.i.lcssa, %.1.lcssa
  br i1 %i.ga, label %iter.check171, label %_ZL11mbedtls_xorPhPKhS1_m.exit

iter.check171:                                    ; preds = %.preheader
  %i.gb = sub nuw nsw i64 %.1.lcssa, %.0.i.lcssa  ; 2 uses
  %min.iters.check156 = icmp samesign ult i64 %i.gb, 8
  br i1 %min.iters.check156, label %.lr.ph107.preheader, label %vector.memcheck148

vector.memcheck148:                               ; preds = %iter.check171
  %i.gc = getelementptr i8, ptr %0, i64 %.0.i.lcssa
  %scevgep149 = getelementptr i8, ptr %i.gc, i64 392
  %i.gd = getelementptr i8, ptr %0, i64 %.1.lcssa
  %scevgep150 = getelementptr i8, ptr %i.gd, i64 392
  %scevgep151 = getelementptr i8, ptr %.148.lcssa, i64 %.0.i.lcssa
  %scevgep152 = getelementptr i8, ptr %.148.lcssa, i64 %.1.lcssa
  %bound0153 = icmp ult ptr %scevgep149, %scevgep152
  %bound1154 = icmp ult ptr %scevgep151, %scevgep150
  %found.conflict155 = and i1 %bound0153, %bound1154
  br i1 %found.conflict155, label %.lr.ph107.preheader, label %vec.epilog.ph175

vec.epilog.ph175:                                 ; preds = %vector.memcheck148
  %i.ge = and i64 %.1.lcssa, 7                    ; 2 uses
  %n.vec176 = sub nsw i64 %i.gb, %i.ge            ; 2 uses
  %i.gf = add nsw i64 %.0.i.lcssa, %n.vec176
  br label %vec.epilog.vector.body177

vec.epilog.vector.body177:                        ; preds = %vec.epilog.vector.body177, %vec.epilog.ph175
  %index178 = phi i64 [ 0, %vec.epilog.ph175 ], [ %index.next181, %vec.epilog.vector.body177 ] ; 2 uses
  %i.gg = add nuw i64 %.0.i.lcssa, %index178      ; 2 uses
  %i.gh = getelementptr inbounds nuw i8, ptr %i.fy, i64 %i.gg ; 2 uses
  %wide.load179 = load <8 x i8>, ptr %i.gh, align 1, !tbaa !15, !alias.scope !43, !noalias !46
  %i.gi = getelementptr inbounds nuw i8, ptr %.148.lcssa, i64 %i.gg
  %wide.load180 = load <8 x i8>, ptr %i.gi, align 1, !tbaa !15, !alias.scope !46
  %i.gj = xor <8 x i8> %wide.load180, %wide.load179
  store <8 x i8> %i.gj, ptr %i.gh, align 1, !tbaa !15, !alias.scope !43, !noalias !46
  %index.next181 = add nuw i64 %index178, 8       ; 2 uses
  %i.gk = icmp eq i64 %index.next181, %n.vec176
  br i1 %i.gk, label %vec.epilog.middle.block182, label %vec.epilog.vector.body177, !llvm.loop !48

vec.epilog.middle.block182:                       ; preds = %vec.epilog.vector.body177
  %cmp.n183 = icmp eq i64 %i.ge, 0
  br i1 %cmp.n183, label %_ZL11mbedtls_xorPhPKhS1_m.exit, label %.lr.ph107.preheader

.lr.ph107.preheader:                              ; preds = %vector.memcheck148, %iter.check171, %vec.epilog.middle.block182
  %.1.i106.ph = phi i64 [ %.0.i.lcssa, %vector.memcheck148 ], [ %.0.i.lcssa, %iter.check171 ], [ %i.gf, %vec.epilog.middle.block182 ] ; 4 uses
  %i.gl = sub i64 %.1.lcssa, %.1.i106.ph
  %xtraiter190 = and i64 %i.gl, 3                 ; 2 uses
  %lcmp.mod191.not = icmp eq i64 %xtraiter190, 0
  br i1 %lcmp.mod191.not, label %.lr.ph107.prol.loopexit, label %.lr.ph107.prol
...
.lr.ph107.prol:                                   ; preds = %.lr.ph107.preheader, %.lr.ph107.prol
  ...
  %prol.iter192 = phi i64 [ %prol.iter192.next, %.lr.ph107.prol ], [ 0, %.lr.ph107.preheader ]
  %i.gm = getelementptr inbounds nuw i8, ptr %i.fy, i64 %.1.i106.prol ; 2 uses
  %i.gn = load i8, ptr %i.gm, align 1, !tbaa !15
  %i.go = getelementptr inbounds nuw i8, ptr %.148.lcssa, i64 %.1.i106.prol
  ...
  br i1 %prol.iter192.cmp.not, label %.lr.ph107.prol.loopexit, label %.lr.ph107.prol, !llvm.loop !49
...
.lr.ph107.prol.loopexit:                          ; preds = %.lr.ph107.prol, %.lr.ph107.preheader
  ...
  %i.gs = sub i64 %.1.i106.ph, %.1.lcssa
...
.lr.ph107:                                        ; preds = %.lr.ph107.prol.loopexit, %.lr.ph107
  ...
  %i.gw = getelementptr inbounds nuw i8, ptr %.148.lcssa, i64 %.1.i106
  ...
  %i.hc = getelementptr inbounds nuw i8, ptr %.148.lcssa, i64 %i.gz
