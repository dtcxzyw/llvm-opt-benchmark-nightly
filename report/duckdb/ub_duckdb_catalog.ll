...
_ZNSt8functionIFvRN6duckdb12CatalogEntryEEEC2ERKS4_.exit.i: ; preds = %bb.c, %bb.a
  %3 = phi <2 x ptr> [ splat (ptr null), %bb.a ], [ %i.e, %bb.c ]
  ...
  %i.l = load <2 x ptr>, ptr %i.k, align 8, !tbaa !193
  %i.m = load ptr, ptr %i.k, align 8, !tbaa !193  ; 2 uses
  store <2 x ptr> %i.l, ptr %i.a, align 8, !tbaa !193
  store <2 x ptr> %3, ptr %i.k, align 8, !tbaa !193
