...
begin_hunk_0_@ckh_try_insert:bb.a
  ...
  call void %i.bv(ptr noundef %i.bs, ptr noundef nonnull %i.a) #15, !inline_history !48
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.q = call zeroext i1 %i.p(ptr noundef %1, ptr noundef nonnull %i.o) #15, !inline_history !49
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.w = call zeroext i1 %i.v(ptr noundef %1, ptr noundef nonnull %i.u) #15, !inline_history !49
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.ac = call zeroext i1 %i.ab(ptr noundef %1, ptr noundef nonnull %i.aa) #15, !inline_history !49
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.ai = call zeroext i1 %i.ah(ptr noundef %1, ptr noundef nonnull %i.ag) #15, !inline_history !49
...
bb.i:                                             ; preds = %ckh_bucket_search.exit.thread29
  ...
  %i.au = call zeroext i1 %i.at(ptr noundef %1, ptr noundef nonnull %i.as) #15, !inline_history !49
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.ba = call zeroext i1 %i.az(ptr noundef %1, ptr noundef nonnull %i.ay) #15, !inline_history !49
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.bg = call zeroext i1 %i.bf(ptr noundef %1, ptr noundef nonnull %i.be) #15, !inline_history !49
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.bm = call zeroext i1 %i.bl(ptr noundef %1, ptr noundef nonnull %i.bk) #15, !inline_history !49
...
begin_hunk_9_@rtree_read:bb.a
  ...
  %i.e = load i64, ptr %i.d, align 8, !tbaa !50   ; 3 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  store i64 %i.e, ptr %i.l, align 8, !tbaa !50
  %i.t = getelementptr inbounds nuw i8, ptr %i.d, i64 8 ; 2 uses
  %i.u = load ptr, ptr %i.t, align 8, !tbaa !53
  store ptr %i.u, ptr %i.r, align 8, !tbaa !53
  store i64 %i.c, ptr %i.d, align 8, !tbaa !50
...
bb.f:                                             ; preds = %.preheader.6, %.preheader.5, %.preheader.4, %.preheader.3, %.preheader.2, %.preheader.1, %.preheader.preheader
  ...
  store i64 %i.au, ptr %.lcssa, align 8, !tbaa !50
  %i.av = getelementptr i8, ptr %.lcssa, i64 -8   ; 2 uses
  %i.aw = load ptr, ptr %i.av, align 8, !tbaa !53
  store ptr %i.aw, ptr %i.ar, align 8, !tbaa !53
  store i64 %i.e, ptr %i.at, align 8, !tbaa !50
  %i.ax = getelementptr inbounds nuw i8, ptr %i.d, i64 8 ; 2 uses
  %i.ay = load ptr, ptr %i.ax, align 8, !tbaa !53
  store ptr %i.ay, ptr %i.av, align 8, !tbaa !53
  store i64 %i.c, ptr %i.d, align 8, !tbaa !50
  store ptr %i.as, ptr %i.ax, align 8, !tbaa !53
  %i.az = lshr i64 %3, 12
...
rtree_leaf_elm_lookup.exit:                       ; preds = %bb.f, %bb.b, %bb.d, %bb.e
  %.1.i = phi ptr [ %i.k, %bb.b ], [ %i.x, %bb.d ], [ %i.aq, %bb.e ], [ %i.bb, %bb.f ]
  %i.bc = load atomic ptr, ptr %.1.i monotonic, align 8, !noalias !64
...
!49 = distinct !{null}
!50 = !{!51, !9, i64 0}
!51 = !{!"rtree_ctx_cache_elm_s", !9, i64 0, !52, i64 8}
!52 = !{!"p1 _ZTS16rtree_leaf_elm_s", !10, i64 0}
!53 = !{!51, !52, i64 8}
!54 = !{!55}
!55 = distinct !{!55, !56, !"rtree_leaf_elm_read: argument 0"}
!56 = distinct !{!56, !"rtree_leaf_elm_read"}
!57 = !{!37, !4, i64 8}
!58 = !{!59}
!59 = distinct !{!59, !60, !"rtree_leaf_elm_bits_decode: argument 0"}
!60 = distinct !{!60, !"rtree_leaf_elm_bits_decode"}
!61 = !{!37, !24, i64 17}
!62 = !{!37, !24, i64 16}
!63 = !{!37, !4, i64 12}
!64 = !{!65}
!65 = distinct !{!65, !66, !"rtree_leaf_elm_read: argument 0"}
!66 = distinct !{!66, !"rtree_leaf_elm_read"}
end_hunk_19
