...
begin_hunk_0_@_ZN11duckdb_zstd23ZSTD_compressSuperBlockEPNS_11ZSTD_CCtx_sEPvmPKvmj:bb.a
  ...
  %i.nf = getelementptr inbounds nuw i8, ptr %6, i64 8 ; 3 uses
  %i.ng = getelementptr inbounds nuw i8, ptr %6, i64 4 ; 3 uses
  %.promoted474.i = load i32, ptr %i.nf, align 4
  %.promoted478.i = load i32, ptr %i.ng, align 4
  br label %bb.ba
...
bb.bc:                                            ; preds = %_ZN11duckdb_zstdL22ZSTD_getSequenceLengthEPKNS_10seqStore_tEPKNS_8seqDef_sE.exit.i
  store i32 %.val432480.i, ptr %i.nf, align 4, !tbaa !3
  store i32 %i.nh, ptr %i.ng, align 4, !tbaa !3
  %i.nv = add i32 %i.ni, -3
...
begin_hunk_2_@_ZN11duckdb_zstd23ZSTD_compressSuperBlockEPNS_11ZSTD_CCtx_sEPvmPKvmj:bb.a
  ...
  store i32 %i.of, ptr %i.nf, align 4, !tbaa !3
  store i32 %i.nh, ptr %i.ng, align 4, !tbaa !3
  br label %.sink.split.i.i
...
bb.w:                                             ; preds = %bb.v
  %i.bq = getelementptr inbounds nuw i8, ptr %i.b, i64 %.1.i ; 7 uses
...
.thread.i:                                        ; preds = %bb.aa, %bb.z
  %.sink.i = phi i8 [ %i.cc, %bb.z ], [ -1, %bb.aa ]
  %.pn.ph.i = phi i64 [ 2, %bb.z ], [ 3, %bb.aa ]
  store i8 %.sink.i, ptr %i.bq, align 1, !tbaa !68
  %.0692.i = getelementptr inbounds nuw i8, ptr %i.bq, i64 %.pn.ph.i
  br label %.thread.i.a

bb.ab:                                            ; preds = %bb.x
  %i.ci = trunc nuw nsw i64 %3 to i8
  store i8 %i.ci, ptr %i.bq, align 1, !tbaa !68
  %.069.i = getelementptr inbounds nuw i8, ptr %i.bq, i64 1
...
.thread.i.a:                                      ; preds = %bb.ab, %.thread.i
  %.0693.i = phi ptr [ %.0692.i, %.thread.i ], [ %.069.i, %bb.ab ] ; 4 uses
  %i.ck = getelementptr inbounds nuw i8, ptr %.0693.i, i64 1 ; 5 uses
  %.not.i63 = icmp eq i32 %14, 0
  br i1 %.not.i63, label %bb.ac, label %.thread10.i

bb.ac:                                            ; preds = %.thread.i.a
  store i8 -4, ptr %.0693.i, align 1, !tbaa !68
...
begin_hunk_5_@_ZN11duckdb_zstdL21ZSTD_compressSubBlockEPKNS_21ZSTD_entropyCTables_tEPKNS_29ZSTD_entropyCTablesMetadata_tEPKNS_8seqDef_sEmPKhmSA_SA_SA_PKNS_18ZSTD_CCtx_params_sEPvmiiiPiSF_j:bb.a
  ...
  store i8 %i.db, ptr %.0693.i, align 1, !tbaa !68
...
bb.af:                                            ; preds = %bb.ae, %bb.ad
  ...
  %i.dv = ptrtoint ptr %.0693.i to i64
