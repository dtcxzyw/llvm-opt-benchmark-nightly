...
bb.h:                                             ; preds = %bb.e
  ...
  %2 = and <2 x i8> %i.af, <i8 -33, i8 -1>
  %i.ag = and <2 x i8> %i.af, <i8 -1, i8 -33>
  %i.ah = add <2 x i8> %i.ag, <i8 -48, i8 -65>
  %i.ai = icmp ult <2 x i8> %i.ah, <i8 10, i8 26>
  %i.aj = add <2 x i8> %2, <i8 -65, i8 -48>
  %i.ak = icmp ult <2 x i8> %i.aj, <i8 26, i8 10>
