...
bb.j:                                             ; preds = %_ZSt13move_backwardIPN10duckdb_re211SparseArrayIiE10IndexValueES4_ET0_T_S6_S5_.exit.i.i.a, %bb.i
  ...
  %.021.i.ptr.i = getelementptr inbounds nuw i8, ptr %i.aw, i64 %.021.i.idx.i ; 5 uses
...
bb.n:                                             ; preds = %bb.j
  ...
  br i1 %i.bm, label %.lr.ph.i.i.i109, label %_ZSt13move_backwardIPN10duckdb_re211SparseArrayIiE10IndexValueES4_ET0_T_S6_S5_.exit.i.i.a

.lr.ph.i.i.i109:                                  ; preds = %bb.n, %.lr.ph.i.i.i109
  %.012.i.i.i = phi ptr [ %.0.i.i.i, %.lr.ph.i.i.i109 ], [ %.pn20.i.i, %bb.n ] ; 4 uses
end_hunk_1
begin_hunk_2_@_ZN10duckdb_re24Prog7FlattenEv:bb.a
  ...
  br i1 %i.bp, label %.lr.ph.i.i.i109, label %_ZSt13move_backwardIPN10duckdb_re211SparseArrayIiE10IndexValueES4_ET0_T_S6_S5_.exit.i.i.a, !llvm.loop !188

_ZSt13move_backwardIPN10duckdb_re211SparseArrayIiE10IndexValueES4_ET0_T_S6_S5_.exit.i.i.a: ; preds = %.lr.ph.i.i.i109, %bb.n, %bb.l, %bb.m
  %.09.lcssa.i.i.i.sink = phi ptr [ %i.aw, %bb.l ], [ %i.aw, %bb.m ], [ %.021.i.ptr.i, %bb.n ], [ %.012.i.i.i, %.lr.ph.i.i.i109 ]
  store i64 %8, ptr %.09.lcssa.i.i.i.sink, align 4
...
end_hunk_2
begin_hunk_3_@_ZN10duckdb_re24Prog7FlattenEv:bb.a
...
.lr.ph.i19.i:                                     ; preds = %.lr.ph.i19.i.preheader, %_ZSt13move_backwardIPN10duckdb_re211SparseArrayIiE10IndexValueES4_ET0_T_S6_S5_.exit.i30.i
  %.021.i20.i = phi ptr [ %.0.i24.i, %_ZSt13move_backwardIPN10duckdb_re211SparseArrayIiE10IndexValueES4_ET0_T_S6_S5_.exit.i30.i ], [ %.018.i18.i, %.lr.ph.i19.i.preheader ] ; 7 uses
...
end_hunk_3
begin_hunk_4_@_ZN10duckdb_re24Prog7FlattenEv:bb.a
...
bb.r:                                             ; preds = %bb.p
  ...
  br i1 %i.cz, label %bb.s, label %_ZSt13move_backwardIPN10duckdb_re211SparseArrayIiE10IndexValueES4_ET0_T_S6_S5_.exit.i30.i
...
bb.t:                                             ; preds = %.lr.ph.i19.i
  ...
  br i1 %i.dd, label %.lr.ph.i.i26.i, label %_ZSt13move_backwardIPN10duckdb_re211SparseArrayIiE10IndexValueES4_ET0_T_S6_S5_.exit.i30.i

.lr.ph.i.i26.i:                                   ; preds = %bb.t, %.lr.ph.i.i26.i
  %.012.i.i27.i = phi ptr [ %.0.i.i29.i, %.lr.ph.i.i26.i ], [ %.pn20.i21.i, %bb.t ] ; 4 uses
end_hunk_4
begin_hunk_5_@_ZN10duckdb_re24Prog7FlattenEv:bb.a
  ...
  br i1 %i.dg, label %.lr.ph.i.i26.i, label %_ZSt13move_backwardIPN10duckdb_re211SparseArrayIiE10IndexValueES4_ET0_T_S6_S5_.exit.i30.i, !llvm.loop !188

_ZSt13move_backwardIPN10duckdb_re211SparseArrayIiE10IndexValueES4_ET0_T_S6_S5_.exit.i30.i: ; preds = %.lr.ph.i.i26.i, %bb.t, %bb.q, %bb.r, %bb.s
  %.09.lcssa.i.i23.i.sink = phi ptr [ %i.aw, %bb.q ], [ %i.aw, %bb.s ], [ %i.aw, %bb.r ], [ %.021.i20.i, %bb.t ], [ %.012.i.i27.i, %.lr.ph.i.i26.i ]
  store i64 %9, ptr %.09.lcssa.i.i23.i.sink, align 4
...
bb.h:                                             ; preds = %bb.f
  %i.az = tail call noundef zeroext i1 %3(ptr noundef nonnull align 4 dereferenceable(8) %i.e, ptr noundef nonnull align 4 dereferenceable(8) %i.av), !inline_history !258
  %7 = load i64, ptr %0, align 4                  ; 2 uses
  br i1 %i.az, label %bb.i, label %bb.j

bb.i:                                             ; preds = %bb.h
  %i.ba = load i64, ptr %i.av, align 4
  store i64 %i.ba, ptr %0, align 4
  store i64 %7, ptr %i.av, align 4
  br label %_ZSt22__move_median_to_firstIPN10duckdb_re211SparseArrayIiE10IndexValueEN9__gnu_cxx5__ops15_Iter_comp_iterIPFbRKS3_S9_EEEEvT_SD_SD_SD_T0_.exit.i.preheader

bb.j:                                             ; preds = %bb.h
  %i.bb = load i64, ptr %i.e, align 4
  store i64 %i.bb, ptr %0, align 4
  store i64 %7, ptr %i.e, align 4
  br label %_ZSt22__move_median_to_firstIPN10duckdb_re211SparseArrayIiE10IndexValueEN9__gnu_cxx5__ops15_Iter_comp_iterIPFbRKS3_S9_EEEEvT_SD_SD_SD_T0_.exit.i.preheader
...
bb.l:                                             ; preds = %bb.k
  %8 = load <2 x i64>, ptr %0, align 4
  %9 = shufflevector <2 x i64> %8, <2 x i64> poison, <2 x i32> <i32 1, i32 0>
  store <2 x i64> %9, ptr %0, align 4
  br label %_ZSt22__move_median_to_firstIPN10duckdb_re211SparseArrayIiE10IndexValueEN9__gnu_cxx5__ops15_Iter_comp_iterIPFbRKS3_S9_EEEEvT_SD_SD_SD_T0_.exit.i.preheader

bb.m:                                             ; preds = %bb.k
  %i.bd = tail call noundef zeroext i1 %3(ptr noundef nonnull align 4 dereferenceable(8) %i.au, ptr noundef nonnull align 4 dereferenceable(8) %i.av), !inline_history !258
  %10 = load i64, ptr %0, align 4                 ; 2 uses
  br i1 %i.bd, label %bb.n, label %bb.o

bb.n:                                             ; preds = %bb.m
  %i.be = load i64, ptr %i.av, align 4
  store i64 %i.be, ptr %0, align 4
  store i64 %10, ptr %i.av, align 4
  br label %_ZSt22__move_median_to_firstIPN10duckdb_re211SparseArrayIiE10IndexValueEN9__gnu_cxx5__ops15_Iter_comp_iterIPFbRKS3_S9_EEEEvT_SD_SD_SD_T0_.exit.i.preheader

bb.o:                                             ; preds = %bb.m
  %i.bf = load i64, ptr %i.au, align 4
  store i64 %i.bf, ptr %0, align 4
  store i64 %10, ptr %i.au, align 4
  br label %_ZSt22__move_median_to_firstIPN10duckdb_re211SparseArrayIiE10IndexValueEN9__gnu_cxx5__ops15_Iter_comp_iterIPFbRKS3_S9_EEEEvT_SD_SD_SD_T0_.exit.i.preheader
