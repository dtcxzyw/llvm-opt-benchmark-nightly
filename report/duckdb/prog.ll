...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6substrEmm.exit: ; preds = %._crit_edge.i.i.i, %bb.b, %bb.c
  ...
  %4 = load ptr, ptr %3, align 8, !tbaa !83, !alias.scope !226
  %i.m = getelementptr inbounds nuw i8, ptr %4, i64 %i.h
  store i8 0, ptr %i.m, align 1, !tbaa !9
  %5 = load i64, ptr %i.l, align 8, !tbaa !81     ; 12 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #22
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(512) %i.a, i8 0, i64 512, i1 false)
  %.not83.i = icmp eq i64 %5, 0                   ; 3 uses
...
.lr.ph.i.preheader:                               ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6substrEmm.exit
  %6 = load ptr, ptr %3, align 8, !tbaa !83       ; 3 uses
...
7:                                                ; preds = %7, %.lr.ph.i.preheader.new
  %.05471.i = phi i64 [ 0, %.lr.ph.i.preheader.new ], [ %20, %7 ] ; 3 uses
  %niter = phi i64 [ 0, %.lr.ph.i.preheader.new ], [ %niter.next.1, %7 ]
  %8 = getelementptr inbounds nuw i8, ptr %6, i64 %.05471.i
  %9 = load i8, ptr %8, align 1, !tbaa !9
  %10 = or disjoint i64 %.05471.i, 1              ; 2 uses
  %11 = trunc i64 %10 to i32
  %12 = shl nuw i32 1, %11
  %13 = zext i8 %9 to i64
  %14 = getelementptr inbounds nuw [2 x i8], ptr %i.a, i64 %13 ; 2 uses
  %15 = load i16, ptr %14, align 2, !tbaa !198
  %16 = trunc i32 %12 to i16
  %17 = or i16 %15, %16
  store i16 %17, ptr %14, align 2, !tbaa !198
  %18 = getelementptr inbounds nuw i8, ptr %6, i64 %10
  %19 = load i8, ptr %18, align 1, !tbaa !9
  %20 = add nuw i64 %.05471.i, 2                  ; 3 uses
  %21 = trunc i64 %20 to i32
  %22 = shl nuw i32 1, %21
  %23 = zext i8 %19 to i64
  %24 = getelementptr inbounds nuw [2 x i8], ptr %i.a, i64 %23 ; 2 uses
  %25 = load i16, ptr %24, align 2, !tbaa !198
  %26 = trunc i32 %22 to i16
  %27 = or i16 %25, %26
  store i16 %27, ptr %24, align 2, !tbaa !198
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %vector.body.preheader.loopexit.unr-lcssa, label %7, !llvm.loop !229

vector.body.preheader.loopexit.unr-lcssa:         ; preds = %7
...
.lr.ph.i.epil.preheader:                          ; preds = %vector.body.preheader.loopexit.unr-lcssa, %.lr.ph.i.preheader
  %.05471.i.epil.init = phi i64 [ 0, %.lr.ph.i.preheader ], [ %20, %vector.body.preheader.loopexit.unr-lcssa ] ; 2 uses
  %lcmp.mod50 = trunc i64 %5 to i1
  call void @llvm.assume(i1 %lcmp.mod50)
  %i.o = getelementptr inbounds nuw i8, ptr %6, i64 %.05471.i.epil.init
...
vector.body:                                      ; preds = %.lr.ph.i.epil.preheader, %vector.body.preheader.loopexit.unr-lcssa, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6substrEmm.exit
  ...
  %.pre95.pre.i = load ptr, ptr %3, align 8, !tbaa !83 ; 9 uses
...
.lr.ph74.split.i:                                 ; preds = %.lr.ph74.i
  %i.cj = add i64 %5, -1                          ; 3 uses
  %xtraiter51 = and i64 %i.cj, 1
  %i.ck = icmp eq i64 %5, 2
...
.epil.preheader:                                  ; preds = %._crit_edge.loopexit.peel.begin.loopexit.i.unr-lcssa, %.lr.ph74.split.i
  ...
  %i.cl = getelementptr inbounds nuw i8, ptr %.pre95.pre.i, i64 %.05673.i.epil.init
...
_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPcNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEEEvT_SA_.exit.i: ; preds = %._crit_edge.loopexit.peel.begin.loopexit.i, %.lr.ph74.i
  ...
  %i.cz = getelementptr inbounds nuw i8, ptr %.pre95.pre.i, i64 %i.cy
  ...
  %i.df = add nuw i64 %i.cy, 1                    ; 2 uses
  %i.dg = icmp eq i64 %i.df, %5
  ...
  %28 = getelementptr inbounds nuw i8, ptr %.pre95.pre.i, i64 %5 ; 2 uses
  %i.di = call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %5, i1 true)
  %i.dj = shl nuw nsw i64 %i.di, 1
  %i.dk = xor i64 %i.dj, 126
  invoke void @_ZSt16__introsort_loopIN9__gnu_cxx17__normal_iteratorIPcNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEElNS0_5__ops15_Iter_less_iterEEvT_SC_T0_T1_(ptr nonnull %.pre95.pre.i, ptr nonnull %28, i64 noundef %i.dk)
...
.noexc:                                           ; preds = %_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPcNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEEEvT_SA_.exit.i
  invoke void @_ZSt22__final_insertion_sortIN9__gnu_cxx17__normal_iteratorIPcNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEENS0_5__ops15_Iter_less_iterEEvT_SC_T0_(ptr nonnull %.pre95.pre.i, ptr nonnull %28)
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5eraseEN9__gnu_cxx17__normal_iteratorIPKcS4_EES9_.exit.i: ; preds = %.preheader.i.i.i.i, %.noexc9, %._crit_edge.i.i.i8, %vector.body
  %i.ex = phi ptr [ %.pre97.i, %._crit_edge.i.i.i8 ], [ %.pre.i, %.noexc9 ], [ %.pre95.pre.i, %vector.body ], [ %.pre.i, %.preheader.i.i.i.i ] ; 2 uses
  %.sroa.05.0.i.i.i = phi ptr [ %i.ew, %._crit_edge.i.i.i8 ], [ %i.dl, %.noexc9 ], [ %.pre95.pre.i, %vector.body ], [ %i.dl, %.preheader.i.i.i.i ]
...
bb.l:                                             ; preds = %bb.l, %.lr.ph74.split.i.new
  ...
  %i.fh = getelementptr inbounds nuw i8, ptr %.pre95.pre.i, i64 %.05673.i
  ...
  %i.fr = getelementptr inbounds nuw i8, ptr %.pre95.pre.i, i64 %i.fp
...
._crit_edge79.i:                                  ; preds = %bb.q
  ...
  %exitcond90.not.i = icmp eq i64 %i.gq, %5
