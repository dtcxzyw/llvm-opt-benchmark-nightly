...
begin_hunk_0_@_ZN6duckdb10CSVSniffer31GenerateStateMachineSearchSpaceERNS_6vectorINS_10unique_ptrINS_18ColumnCountScannerESt14default_deleteIS3_ELb1EEELb1ESaIS6_EEERKNS_17DialectCandidatesE:bb.a
  ...
  %5 = alloca %"struct.duckdb::CSVStateMachineOptions", align 8 ; 18 uses
...
begin_hunk_1_@_ZN6duckdb10CSVSniffer31GenerateStateMachineSearchSpaceERNS_6vectorINS_10unique_ptrINS_18ColumnCountScannerESt14default_deleteIS3_ELb1EEELb1ESaIS6_EEERKNS_17DialectCandidatesE:bb.a
  ...
  %12 = getelementptr inbounds nuw i8, ptr %6, i64 16 ; 10 uses
  %13 = getelementptr inbounds nuw i8, ptr %6, i64 8 ; 4 uses
  %14 = getelementptr inbounds nuw i8, ptr %3, i64 16 ; 6 uses
  %i.t = getelementptr inbounds nuw i8, ptr %3, i64 8
  %i.u = getelementptr inbounds nuw i8, ptr %5, i64 8 ; 6 uses
  %i.v = getelementptr inbounds nuw i8, ptr %5, i64 24 ; 5 uses
  %i.w = getelementptr inbounds nuw i8, ptr %5, i64 16
  %i.x = getelementptr inbounds nuw i8, ptr %5, i64 40
  %i.y = getelementptr inbounds nuw i8, ptr %5, i64 41
  %i.z = getelementptr inbounds nuw i8, ptr %5, i64 42
  %i.aa = getelementptr inbounds nuw i8, ptr %5, i64 43
...
.lr.ph222.split:                                  ; preds = %.lr.ph222, %._crit_edge
  ...
  %.sroa.093.0219 = phi ptr [ %i.ba, %._crit_edge ], [ %i.as, %.lr.ph222 ] ; 3 uses
  %.sroa.0.0.copyload = load i8, ptr %.sroa.093.0219, align 1, !tbaa !100
  %.sroa.5.0..sroa_idx = getelementptr inbounds nuw i8, ptr %.sroa.093.0219, i64 1
  %.sroa.5.0.copyload = load i8, ptr %.sroa.5.0..sroa_idx, align 1, !tbaa !100
  %i.ay = load ptr, ptr %2, align 8, !tbaa !763   ; 2 uses
  %i.az = load ptr, ptr %i.s, align 8, !tbaa !763 ; 2 uses
  %.not104215 = icmp eq ptr %i.ay, %i.az
  br i1 %.not104215, label %._crit_edge, label %.lr.ph
...
.lr.ph:                                           ; preds = %.lr.ph222.split, %_ZN6duckdb22CSVStateMachineOptionsD2Ev.exit
  %.226217 = phi i1 [ %.428, %_ZN6duckdb22CSVStateMachineOptionsD2Ev.exit ], [ %.125220, %.lr.ph222.split ] ; 2 uses
  %.sroa.089.0216 = phi ptr [ %i.iu, %_ZN6duckdb22CSVStateMachineOptionsD2Ev.exit ], [ %i.ay, %.lr.ph222.split ] ; 3 uses
...
begin_hunk_4_@_ZN6duckdb10CSVSniffer31GenerateStateMachineSearchSpaceERNS_6vectorINS_10unique_ptrINS_18ColumnCountScannerESt14default_deleteIS3_ELb1EEELb1ESaIS6_EEERKNS_17DialectCandidatesE:bb.a
  ...
  store i64 %i.bg, ptr %12, align 8, !tbaa !100
  br label %._crit_edge.i.i

._crit_edge.i.i:                                  ; preds = %.noexc.i, %.lr.ph
  %i.bh = phi ptr [ %i.bf, %.noexc.i ], [ %12, %.lr.ph ] ; 2 uses
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2ERKS4_.exit: ; preds = %._crit_edge.i.i, %bb.e, %bb.f
  ...
  store i64 %i.bj, ptr %13, align 8, !tbaa !99
...
bb.g:                                             ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2ERKS4_.exit
  %i.bs = load i64, ptr %13, align 8, !tbaa !99   ; 3 uses
  %i.bt = icmp ult i64 %i.bs, 16
  call void @llvm.assume(i1 %i.bt)
  %i.bu = add nuw nsw i64 %i.bs, 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %14, ptr noundef nonnull align 8 dereferenceable(1) %12, i64 %i.bu, i1 false)
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2EOS4_.exit.i

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2ERKS4_.exit
  store ptr %i.bq, ptr %3, align 8, !tbaa !103
  %i.bv = load i64, ptr %12, align 8, !tbaa !100
  store i64 %i.bv, ptr %14, align 8, !tbaa !100
  %.pre.i = load i64, ptr %13, align 8, !tbaa !99
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2EOS4_.exit.i
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2EOS4_.exit.i: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i, %bb.g
  %i.bw = phi ptr [ %14, %bb.g ], [ %i.bq, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i ] ; 2 uses
  %i.bx = phi i64 [ %i.bs, %bb.g ], [ %.pre.i, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i ] ; 5 uses
  store i64 %i.bx, ptr %i.t, align 8, !tbaa !99
  ...
  store ptr %i.v, ptr %i.u, align 8, !tbaa !98
...
.noexc.i.i.i:                                     ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2EOS4_.exit.i
  %i.bz = invoke noundef ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm(ptr noundef nonnull align 8 dereferenceable(32) %i.u, ptr noundef nonnull align 8 dereferenceable(8) %i.a, i64 noundef 0)
          to label %.noexc.i36 unwind label %bb.k ; 2 uses

.noexc.i36:                                       ; preds = %.noexc.i.i.i
  store ptr %i.bz, ptr %i.u, align 8, !tbaa !103
  %i.ca = load i64, ptr %i.a, align 8, !tbaa !233
  store i64 %i.ca, ptr %i.v, align 8, !tbaa !100
  br label %._crit_edge.i.i.i.i

._crit_edge.i.i.i.i:                              ; preds = %.noexc.i36, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2EOS4_.exit.i
  %i.cb = phi ptr [ %i.bz, %.noexc.i36 ], [ %i.v, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2EOS4_.exit.i ] ; 2 uses
...
bb.j:                                             ; preds = %bb.i, %bb.h, %._crit_edge.i.i.i.i
  ...
  store i64 %i.cd, ptr %i.w, align 8, !tbaa !99
  %i.ce = load ptr, ptr %i.u, align 8, !tbaa !103
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i.i: ; preds = %bb.j, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i
  store i8 0, ptr %i.x, align 8, !tbaa !365
  store i8 %.sroa.0.0.copyload, ptr %i.y, align 1, !tbaa !366
  store i8 0, ptr %i.z, align 2, !tbaa !365
  store i8 %.sroa.5.0.copyload, ptr %i.aa, align 1, !tbaa !366
...
_ZN6duckdb10shared_ptrINS_15CSVStateMachineELb1EED2Ev.exit: ; preds = %bb.at, %bb.av, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i76, %bb.az
  ...
  %i.is = load ptr, ptr %i.u, align 8, !tbaa !103 ; 2 uses
  %i.it = icmp eq ptr %i.is, %i.v
...
.body38:                                          ; preds = %bb.bi, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i83, %bb.be, %bb.bc, %bb.af, %_ZNSt15__allocated_ptrISaISt23_Sp_counted_ptr_inplaceIN6duckdb15CSVStateMachineESaIvELN9__gnu_cxx12_Lock_policyE2EEEED2Ev.exit12.i.i.i.i.i
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #32
  %i.jq = load ptr, ptr %i.u, align 8, !tbaa !103 ; 2 uses
  %i.jr = icmp eq ptr %i.jq, %i.v
