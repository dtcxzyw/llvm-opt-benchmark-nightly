...
begin_hunk_0_@_ZN6duckdb6DuckDB19LoadStaticExtensionINS_17JemallocExtensionEEEvv:bb.a
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #15
  call void @_ZNSt10unique_ptrIN6duckdb19ExtensionActiveLoadESt14default_deleteIS1_EED2Ev(ptr noundef nonnull align 8 dereferenceable(8) %2) #15
  br label %bb.af

bb.af:                                            ; preds = %bb.ae, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit18
  %.pn10.pn.pn.pn = phi { ptr, i32 } [ %.pn10.pn.pn, %bb.ae ], [ %.pn, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit18 ]
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #15
  br label %bb.ag

bb.ag:                                            ; preds = %bb.af, %bb.f
  %.pn10.pn.pn.pn.pn = phi { ptr, i32 } [ %.pn10.pn.pn.pn, %bb.af ], [ %i.g, %bb.f ]
  call void @_ZN6duckdb9ExtensionD2Ev(ptr noundef nonnull align 8 dereferenceable(8) %1) #15
  call void @llvm.lifetime.end.p0(ptr nonnull %1) #15
  resume { ptr, i32 } %.pn10.pn.pn.pn.pn
}

; Function Attrs: mustprogress uwtable
define void @_ZN6duckdb16LinkedExtensionsB5cxx11Ev(ptr dead_on_unwind noalias writable writeonly sret(%"class.duckdb::vector") align 8 captures(none) initializes((0, 24)) %0) local_unnamed_addr #0 personality ptr @__gxx_personality_v0 {
._crit_edge.i.i:
  %1 = alloca [3 x %"class.std::__cxx11::basic_string"], align 8 ; 29 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %1) #15
  %i.a = getelementptr inbounds nuw i8, ptr %1, i64 16 ; 2 uses
  store ptr %i.a, ptr %1, align 8, !tbaa !18
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(14) %i.a, ptr noundef nonnull align 1 dereferenceable(14) @.str, i64 14, i1 false)
  %i.b = getelementptr inbounds nuw i8, ptr %1, i64 8
  store i64 14, ptr %i.b, align 8, !tbaa !7
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(7) %i.e, ptr noundef nonnull align 1 dereferenceable(7) @.str.1, i64 7, i1 false)
  %i.f = getelementptr inbounds nuw i8, ptr %1, i64 40
  store i64 7, ptr %i.f, align 8, !tbaa !7
  %i.g = getelementptr inbounds nuw i8, ptr %1, i64 55
...
define void @_ZN6duckdb15ExtensionHelper24LoadedExtensionTestPathsB5cxx11Ev(ptr dead_on_unwind noalias writable writeonly sret(%"class.duckdb::vector") align 8 captures(none) initializes((0, 24)) %0) local_unnamed_addr #3 align 2 {
bb.a:
