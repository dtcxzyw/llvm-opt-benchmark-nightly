...
begin_hunk_0_@_ZN17duckdb_libpgquery12base_yyparseEPv:bb.a
  ...
  %i.jtg = trunc nuw i8 %i.jtf to i1              ; 2 uses
  %spec.store.select5627 = select i1 %i.jtg, i32 17, i32 1 ; 2 uses
...
bb.bcy:                                           ; preds = %bb.bcx
  %5 = select i1 %i.jtg, i32 25, i32 9            ; 2 uses
...
begin_hunk_3_@_ZN17duckdb_libpgquery12base_yyparseEPv:bb.a
  ...
  %i.jtt = trunc nuw i8 %i.jts to i1              ; 2 uses
  %spec.store.select5628 = select i1 %i.jtt, i32 17, i32 1 ; 2 uses
...
bb.bdd:                                           ; preds = %bb.bdc
  %6 = select i1 %i.jtt, i32 25, i32 9            ; 2 uses
