...
begin_hunk_0_@_ZN6duckdb9ListStats6VerifyERKNS_14BaseStatisticsERNS_6VectorERKNS_15SelectionVectorEm:bb.a
  store i32 0, ptr %i.ih, align 4, !tbaa !39
  %i.ii = load ptr, ptr %i.ic, align 8, !tbaa !40
  %i.ij = getelementptr inbounds nuw i8, ptr %i.ii, i64 16
  %i.ik = load ptr, ptr %i.ij, align 8
  call void %i.ik(ptr noundef nonnull align 8 dereferenceable(16) %i.ic) #28, !inline_history !327
  %i.il = load ptr, ptr %i.ic, align 8, !tbaa !40
  %i.im = getelementptr inbounds nuw i8, ptr %i.il, i64 24
  %i.in = load ptr, ptr %i.im, align 8
  call void %i.in(ptr noundef nonnull align 8 dereferenceable(16) %i.ic) #28, !inline_history !327
  br label %_ZN6duckdb15SelectionVectorD2Ev.exit

bb.r:                                             ; preds = %bb.p
  %i.io = load i8, ptr @__libc_single_threaded, align 1, !tbaa !43
  %.not.i.i.i.i.i = icmp eq i8 %i.io, 0
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i: ; preds = %bb.t, %bb.s
  %.0.i.i.i.i.i.i = phi i32 [ %i.ig, %bb.s ], [ %i.iq, %bb.t ]
  %i.ir = icmp eq i32 %.0.i.i.i.i.i.i, 1
  br i1 %i.ir, label %bb.u, label %_ZN6duckdb15SelectionVectorD2Ev.exit, !prof !44
...
_ZN6duckdb15SelectionVectorD2Ev.exit:             ; preds = %bb.o, %bb.q, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i, %bb.u
  ...
  %i.is = getelementptr inbounds nuw i8, ptr %4, i64 64
  %i.it = load ptr, ptr %i.is, align 8, !tbaa !36 ; 8 uses
  %.not.i.i.i.i.i77 = icmp eq ptr %i.it, null
  br i1 %.not.i.i.i.i.i77, label %_ZN6duckdb15SelectionVectorD2Ev.exit.i, label %bb.v

bb.v:                                             ; preds = %_ZN6duckdb15SelectionVectorD2Ev.exit
  ...
  br i1 %i.iw, label %bb.w, label %bb.x

bb.w:                                             ; preds = %bb.v
  store i32 0, ptr %i.iu, align 8, !tbaa !37
  %i.iy = getelementptr inbounds nuw i8, ptr %i.it, i64 12
  store i32 0, ptr %i.iy, align 4, !tbaa !39
  %i.iz = load ptr, ptr %i.it, align 8, !tbaa !40
  %i.ja = getelementptr inbounds nuw i8, ptr %i.iz, i64 16
  %i.jb = load ptr, ptr %i.ja, align 8
  call void %i.jb(ptr noundef nonnull align 8 dereferenceable(16) %i.it) #28, !inline_history !313
  %i.jc = load ptr, ptr %i.it, align 8, !tbaa !40
  %i.jd = getelementptr inbounds nuw i8, ptr %i.jc, i64 24
  %i.je = load ptr, ptr %i.jd, align 8
  call void %i.je(ptr noundef nonnull align 8 dereferenceable(16) %i.it) #28, !inline_history !313
  br label %_ZN6duckdb15SelectionVectorD2Ev.exit.i

bb.x:                                             ; preds = %bb.v
  %i.jf = load i8, ptr @__libc_single_threaded, align 1, !tbaa !43
  %.not.i.i.i.i.i.i = icmp eq i8 %i.jf, 0
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i: ; preds = %bb.z, %bb.y
  %.0.i.i.i.i.i.i.i = phi i32 [ %i.ix, %bb.y ], [ %i.jh, %bb.z ]
  %i.ji = icmp eq i32 %.0.i.i.i.i.i.i.i, 1
  br i1 %i.ji, label %bb.aa, label %_ZN6duckdb15SelectionVectorD2Ev.exit.i, !prof !44

bb.aa:                                            ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i
  call void @_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE24_M_release_last_use_coldEv(ptr noundef nonnull align 8 dereferenceable(16) %i.it) #28
  br label %_ZN6duckdb15SelectionVectorD2Ev.exit.i

_ZN6duckdb15SelectionVectorD2Ev.exit.i:           ; preds = %bb.aa, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i, %bb.w, %_ZN6duckdb15SelectionVectorD2Ev.exit
  %i.jj = getelementptr inbounds nuw i8, ptr %4, i64 32
  %i.jk = load ptr, ptr %i.jj, align 8, !tbaa !36 ; 8 uses
  %.not.i.i.i.i1.i = icmp eq ptr %i.jk, null
...
bb.ab:                                            ; preds = %_ZN6duckdb15SelectionVectorD2Ev.exit.i
  ...
  br i1 %i.jn, label %bb.ac, label %bb.ad

bb.ac:                                            ; preds = %bb.ab
  store i32 0, ptr %i.jl, align 8, !tbaa !37
  %i.jp = getelementptr inbounds nuw i8, ptr %i.jk, i64 12
  store i32 0, ptr %i.jp, align 4, !tbaa !39
  %i.jq = load ptr, ptr %i.jk, align 8, !tbaa !40
  %i.jr = getelementptr inbounds nuw i8, ptr %i.jq, i64 16
  %i.js = load ptr, ptr %i.jr, align 8
  call void %i.js(ptr noundef nonnull align 8 dereferenceable(16) %i.jk) #28, !inline_history !314
  %i.jt = load ptr, ptr %i.jk, align 8, !tbaa !40
  %i.ju = getelementptr inbounds nuw i8, ptr %i.jt, i64 24
  %i.jv = load ptr, ptr %i.ju, align 8
  call void %i.jv(ptr noundef nonnull align 8 dereferenceable(16) %i.jk) #28, !inline_history !314
  br label %_ZN6duckdb19UnifiedVectorFormatD2Ev.exit

bb.ad:                                            ; preds = %bb.ab
  %i.jw = load i8, ptr @__libc_single_threaded, align 1, !tbaa !43
  %.not.i.i.i.i.i2.i = icmp eq i8 %i.jw, 0
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i3.i: ; preds = %bb.af, %bb.ae
  %.0.i.i.i.i.i.i4.i = phi i32 [ %i.jo, %bb.ae ], [ %i.jy, %bb.af ]
  %i.jz = icmp eq i32 %.0.i.i.i.i.i.i4.i, 1
  br i1 %i.jz, label %bb.ag, label %_ZN6duckdb19UnifiedVectorFormatD2Ev.exit, !prof !44

bb.ag:                                            ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i3.i
  call void @_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE24_M_release_last_use_coldEv(ptr noundef nonnull align 8 dereferenceable(16) %i.jk) #28
  br label %_ZN6duckdb19UnifiedVectorFormatD2Ev.exit
...
bb.ah:                                            ; preds = %_ZN6duckdb15SelectionVectorC2Em.exit._crit_edge
  %i.ka = landingpad { ptr, i32 }
          cleanup
  call void @_ZN6duckdb15SelectionVectorD2Ev(ptr noundef nonnull align 8 dead_on_return(24) dereferenceable(24) %5) #28
  br label %.body

.body:                                            ; preds = %bb.i, %bb.ah
  %.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %i.ka, %bb.ah ], [ %i.fq, %bb.i ]
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #28
  br label %bb.ai

bb.ai:                                            ; preds = %bb.k, %.body, %bb.j
  %.pn61.pn.pn.pn.pn = phi { ptr, i32 } [ %i.fr, %bb.j ], [ %i.fs, %bb.k ], [ %.pn.pn.pn.pn.pn, %.body ]
...
_ZNK6duckdb15SelectionVector9get_indexEm.exit.us78.us.preheader: ; preds = %.lr.ph.split.split.us
  ...
  br i1 %min.iters.check, label %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us78.us.preheader177, label %vector.ph
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %._crit_edge, label %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us78.us.preheader177

_ZNK6duckdb15SelectionVector9get_indexEm.exit.us78.us.preheader177: ; preds = %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us78.us.preheader, %middle.block
...
_ZNK6duckdb15SelectionVector9get_indexEm.exit.us78.us: ; preds = %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us78.us.preheader177, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us78.us
  %.04375.us76.us = phi i64 [ %i.an, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us78.us ], [ %.04375.us76.us.ph, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us78.us.preheader177 ]
  %.04974.us77.us = phi i64 [ %i.ao, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us78.us ], [ %.04974.us77.us.ph, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us78.us.preheader177 ] ; 3 uses
...
_ZNK6duckdb15SelectionVector9get_indexEm.exit.us78: ; preds = %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us78, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us78.preheader.new
  ...
  %niter200 = phi i64 [ 0, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us78.preheader.new ], [ %niter200.next.1, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us78 ]
  ...
  %niter200.next.1 = add nuw i64 %niter200, 2     ; 2 uses
  %niter200.ncmp.1 = icmp eq i64 %niter200.next.1, %unroll_iter199
  br i1 %niter200.ncmp.1, label %._crit_edge.loopexit181.unr-lcssa, label %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us78, !llvm.loop !330
...
_ZNK6duckdb15SelectionVector9get_indexEm.exit.us82: ; preds = %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us82, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us82.preheader.new
  ...
  %niter194 = phi i64 [ 0, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us82.preheader.new ], [ %niter194.next.1, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us82 ]
  ...
  br i1 %niter194.ncmp.1, label %._crit_edge.loopexit183.unr-lcssa, label %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us82, !llvm.loop !330

._crit_edge.loopexit181.unr-lcssa:                ; preds = %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us78
  %lcmp.mod196.not = icmp eq i64 %xtraiter195, 0
  br i1 %lcmp.mod196.not, label %._crit_edge, label %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us78.epil.preheader

_ZNK6duckdb15SelectionVector9get_indexEm.exit.us78.epil.preheader: ; preds = %._crit_edge.loopexit181.unr-lcssa, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us78.preheader
  %.04375.us76.epil.init = phi i64 [ 0, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us78.preheader ], [ %i.bl, %._crit_edge.loopexit181.unr-lcssa ]
  %.04974.us77.epil.init = phi i64 [ 0, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us78.preheader ], [ %i.bm, %._crit_edge.loopexit181.unr-lcssa ]
  %lcmp.mod198 = trunc i64 %3 to i1
...
._crit_edge.loopexit183.unr-lcssa:                ; preds = %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us82
  %lcmp.mod190.not = icmp eq i64 %xtraiter189, 0
  br i1 %lcmp.mod190.not, label %._crit_edge, label %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us82.epil.preheader

_ZNK6duckdb15SelectionVector9get_indexEm.exit.us82.epil.preheader: ; preds = %._crit_edge.loopexit183.unr-lcssa, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us82.preheader
  %.04375.us83.epil.init = phi i64 [ 0, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us82.preheader ], [ %i.cl, %._crit_edge.loopexit183.unr-lcssa ]
  %.04974.us84.epil.init = phi i64 [ 0, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us82.preheader ], [ %i.cm, %._crit_edge.loopexit183.unr-lcssa ]
  %lcmp.mod192 = trunc i64 %3 to i1
...
._crit_edge.loopexit185.unr-lcssa:                ; preds = %_ZNK6duckdb15SelectionVector9get_indexEm.exit
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %._crit_edge, label %_ZNK6duckdb15SelectionVector9get_indexEm.exit.epil.preheader

_ZNK6duckdb15SelectionVector9get_indexEm.exit.epil.preheader: ; preds = %._crit_edge.loopexit185.unr-lcssa, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.preheader
  %.04375.epil.init = phi i64 [ 0, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.preheader ], [ %i.fj, %._crit_edge.loopexit185.unr-lcssa ]
  %.04974.epil.init = phi i64 [ 0, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.preheader ], [ %i.fk, %._crit_edge.loopexit185.unr-lcssa ]
  %lcmp.mod188 = trunc i64 %3 to i1
...
._crit_edge:                                      ; preds = %_ZNK6duckdb15SelectionVector9get_indexEm.exit.epil.preheader, %._crit_edge.loopexit185.unr-lcssa, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us82.epil.preheader, %._crit_edge.loopexit183.unr-lcssa, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us78.epil.preheader, %._crit_edge.loopexit181.unr-lcssa, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us78.us, %middle.block, %.lr.ph, %.preheader
  %.043.lcssa = phi i64 [ 0, %.preheader ], [ %i.cx, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us78.epil.preheader ], [ %i.an, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us78.us ], [ %3, %.lr.ph ], [ %i.di, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.us82.epil.preheader ], [ %i.af, %middle.block ], [ %i.bl, %._crit_edge.loopexit181.unr-lcssa ], [ %i.cl, %._crit_edge.loopexit183.unr-lcssa ], [ %i.fj, %._crit_edge.loopexit185.unr-lcssa ], [ %i.dw, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.epil.preheader ]
...
_ZNK6duckdb15SelectionVector9get_indexEm.exit:    ; preds = %_ZNK6duckdb15SelectionVector9get_indexEm.exit, %_ZNK6duckdb15SelectionVector9get_indexEm.exit.preheader.new
  ...
  br i1 %niter.ncmp.1, label %._crit_edge.loopexit185.unr-lcssa, label %_ZNK6duckdb15SelectionVector9get_indexEm.exit, !llvm.loop !330
...
_ZNK6duckdb15SelectionVector9get_indexEm.exit66:  ; preds = %bb.f, %_ZNK6duckdb15SelectionVector9get_indexEm.exit64
  ...
  br i1 %.not.i67, label %_ZNK6duckdb21TemplatedValidityMaskImE10RowIsValidEm.exit69.preheader, label %.split

.split:                                           ; preds = %_ZNK6duckdb15SelectionVector9get_indexEm.exit66
...
_ZNK6duckdb21TemplatedValidityMaskImE10RowIsValidEm.exit69.preheader111: ; preds = %_ZNK6duckdb21TemplatedValidityMaskImE10RowIsValidEm.exit69.preheader, %.split
  br i1 %min.iters.check161, label %_ZNK6duckdb21TemplatedValidityMaskImE10RowIsValidEm.exit69.preheader176, label %vector.ph162

vector.ph162:                                     ; preds = %_ZNK6duckdb21TemplatedValidityMaskImE10RowIsValidEm.exit69.preheader111
  %i.ga = add i64 %.046103, %n.vec163             ; 2 uses
  %broadcast.splatinsert164 = insertelement <4 x i64> poison, i64 %i.ft, i64 0
  %broadcast.splat165 = shufflevector <4 x i64> %broadcast.splatinsert164, <4 x i64> poison, <4 x i32> zeroinitializer ; 2 uses
  %invariant.op = add <4 x i64> splat (i64 4), %broadcast.splat165
  %i.gb = getelementptr [4 x i8], ptr %i.ee, i64 %.046103
  br label %vector.body166

vector.body166:                                   ; preds = %vector.body166, %vector.ph162
  %index167 = phi i64 [ 0, %vector.ph162 ], [ %index.next170, %vector.body166 ] ; 2 uses
  %vec.ind168 = phi <4 x i64> [ <i64 0, i64 1, i64 2, i64 3>, %vector.ph162 ], [ %vec.ind.next171, %vector.body166 ] ; 3 uses
  %i.gc = add <4 x i64> %vec.ind168, %broadcast.splat165
  %.reass = add <4 x i64> %vec.ind168, %invariant.op
  %i.gd = trunc <4 x i64> %i.gc to <4 x i32>
  %i.ge = trunc <4 x i64> %.reass to <4 x i32>
  %i.gf = getelementptr [4 x i8], ptr %i.gb, i64 %index167 ; 2 uses
  ...
  %vec.ind.next171 = add nuw <4 x i64> %vec.ind168, splat (i64 8)
  %i.gh = icmp eq i64 %index.next170, %n.vec163
  br i1 %i.gh, label %middle.block172, label %vector.body166, !llvm.loop !331

middle.block172:                                  ; preds = %vector.body166
  br i1 %cmp.n173, label %_ZN6duckdb15SelectionVectorC2Em.exit, label %_ZNK6duckdb21TemplatedValidityMaskImE10RowIsValidEm.exit69.preheader176

_ZNK6duckdb21TemplatedValidityMaskImE10RowIsValidEm.exit69.preheader176: ; preds = %_ZNK6duckdb21TemplatedValidityMaskImE10RowIsValidEm.exit69.preheader111, %middle.block172
  %.0100.ph = phi i64 [ 0, %_ZNK6duckdb21TemplatedValidityMaskImE10RowIsValidEm.exit69.preheader111 ], [ %n.vec163, %middle.block172 ]
  %.14799.ph = phi i64 [ %.046103, %_ZNK6duckdb21TemplatedValidityMaskImE10RowIsValidEm.exit69.preheader111 ], [ %i.ga, %middle.block172 ]
  br label %_ZNK6duckdb21TemplatedValidityMaskImE10RowIsValidEm.exit69

_ZNK6duckdb21TemplatedValidityMaskImE10RowIsValidEm.exit69: ; preds = %_ZNK6duckdb21TemplatedValidityMaskImE10RowIsValidEm.exit69.preheader176, %_ZNK6duckdb21TemplatedValidityMaskImE10RowIsValidEm.exit69
  %.0100 = phi i64 [ %i.gm, %_ZNK6duckdb21TemplatedValidityMaskImE10RowIsValidEm.exit69 ], [ %.0100.ph, %_ZNK6duckdb21TemplatedValidityMaskImE10RowIsValidEm.exit69.preheader176 ] ; 2 uses
  %.14799 = phi i64 [ %i.gl, %_ZNK6duckdb21TemplatedValidityMaskImE10RowIsValidEm.exit69 ], [ %.14799.ph, %_ZNK6duckdb21TemplatedValidityMaskImE10RowIsValidEm.exit69.preheader176 ] ; 2 uses
...
_ZN6duckdb15SelectionVectorC2Em.exit:             ; preds = %_ZNK6duckdb21TemplatedValidityMaskImE10RowIsValidEm.exit69, %middle.block172, %.split, %_ZNK6duckdb21TemplatedValidityMaskImE10RowIsValidEm.exit69.preheader
  %.248 = phi i64 [ %.046103, %.split ], [ %.046103, %_ZNK6duckdb21TemplatedValidityMaskImE10RowIsValidEm.exit69.preheader ], [ %i.ga, %middle.block172 ], [ %i.gl, %_ZNK6duckdb21TemplatedValidityMaskImE10RowIsValidEm.exit69 ] ; 2 uses
...
bb.g:                                             ; preds = %_ZN6duckdb15SelectionVectorC2Em.exit._crit_edge
  ...
  br i1 %.not.i.i.i.i, label %_ZN6duckdb15SelectionVectorD2Ev.exit, label %bb.h
...
bb.h:                                             ; preds = %bb.g
  ...
  br i1 %i.gs, label %bb.i, label %bb.j
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i: ; preds = %bb.l, %bb.k
  %.0.i.i.i.i.i.i = phi i32 [ %i.gt, %bb.k ], [ %i.hd, %bb.l ]
  %i.he = icmp eq i32 %.0.i.i.i.i.i.i, 1
  br i1 %i.he, label %bb.m, label %_ZN6duckdb15SelectionVectorD2Ev.exit, !prof !44
...
_ZN6duckdb15SelectionVectorD2Ev.exit:             ; preds = %bb.g, %bb.i, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i, %bb.m
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #28
  ...
  br i1 %.not.i.i.i.i.i70, label %_ZN6duckdb15SelectionVectorD2Ev.exit.i, label %bb.n

bb.n:                                             ; preds = %_ZN6duckdb15SelectionVectorD2Ev.exit
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i: ; preds = %bb.r, %bb.q
  %.0.i.i.i.i.i.i.i = phi i32 [ %i.hk, %bb.q ], [ %i.hu, %bb.r ]
  %i.hv = icmp eq i32 %.0.i.i.i.i.i.i.i, 1
  br i1 %i.hv, label %bb.s, label %_ZN6duckdb15SelectionVectorD2Ev.exit.i, !prof !44
...
_ZN6duckdb15SelectionVectorD2Ev.exit.i:           ; preds = %bb.s, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i, %bb.o, %_ZN6duckdb15SelectionVectorD2Ev.exit
...
bb.t:                                             ; preds = %_ZN6duckdb15SelectionVectorD2Ev.exit.i
  ...
  br i1 %i.ia, label %bb.u, label %bb.v
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i3.i: ; preds = %bb.x, %bb.w
  %.0.i.i.i.i.i.i4.i = phi i32 [ %i.ib, %bb.w ], [ %i.il, %bb.x ]
  %i.im = icmp eq i32 %.0.i.i.i.i.i.i4.i, 1
  br i1 %i.im, label %bb.y, label %_ZN6duckdb19UnifiedVectorFormatD2Ev.exit, !prof !44
...
.body:                                            ; preds = %bb.b, %bb.z
  %.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %i.in, %bb.z ], [ %i.ef, %bb.b ]
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #28
  br label %bb.aa

bb.aa:                                            ; preds = %.body, %bb.c
