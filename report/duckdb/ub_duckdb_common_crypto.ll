...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %.not35.i, label %_ZN6duckdb10MD5Context9MD5UpdateEPKhm.exit, label %bb.c
...
_ZN6duckdb10MD5Context9MD5UpdateEPKhm.exit:       ; preds = %bb.b, %._crit_edge.i
  %.sink53.i = phi i64 [ %.230.lcssa.i, %._crit_edge.i ], [ %i.a, %bb.b ]
  %.sink52.i = phi ptr [ %.2.lcssa.i, %._crit_edge.i ], [ %1, %bb.b ]
  %.sink.i = phi ptr [ %i.ac, %._crit_edge.i ], [ %i.s, %bb.b ]
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %.sink.i, ptr nonnull align 1 %.sink52.i, i64 %.sink53.i, i1 false)
  ret void
}
