...
bb.i:                                             ; preds = %.preheader164, %.thread
  ...
  %.0116170 = load i32, ptr %i.bl, align 4, !tbaa !3 ; 3 uses
...
.lr.ph174:                                        ; preds = %bb.i
  ...
  %.0116 = load i32, ptr %i.bq, align 4, !tbaa !3 ; 3 uses
...
.lr.ph174.1:                                      ; preds = %.lr.ph174
  ...
  %.0116.1 = load i32, ptr %i.bv, align 4, !tbaa !3 ; 3 uses
...
.lr.ph174.2:                                      ; preds = %.lr.ph174.1
  ...
  %.0116.2 = load i32, ptr %i.ca, align 4, !tbaa !3
...
bb.k:                                             ; preds = %bb.j, %.lr.ph181
  ...
  store i32 %.1180, ptr %i.cg, align 4, !tbaa !3
...
_ZN11duckdb_zstdL12ZSTD_hashPtrEPKvjj.exit:       ; preds = %bb.n, %bb.o, %bb.p, %bb.q, %bb.r
  ...
  br i1 %i.ff, label %bb.m, label %._crit_edge196, !llvm.loop !33
