...
._crit_edge182:                                   ; preds = %bb.j
  ...
  %spec.select254 = select i1 %.not137, i32 0, i32 %i.cv
  br label %.thread

.thread:                                          ; preds = %.lr.ph174, %.lr.ph174.1, %._crit_edge182, %.lr.ph174.2, %bb.i, %._crit_edge182.thread240, %.thread157
  %.2155 = phi i32 [ %i.ce, %.thread157 ], [ %.0119188, %bb.i ], [ %.0119188, %.lr.ph174.2 ], [ %i.ce, %._crit_edge182.thread240 ], [ %.1120180, %._crit_edge182 ], [ %.0119188, %.lr.ph174.1 ], [ %.0119188, %.lr.ph174 ]
  %i.cw = phi i32 [ %i.cl, %.thread157 ], [ 0, %bb.i ], [ 0, %.lr.ph174.2 ], [ %i.cs, %._crit_edge182.thread240 ], [ %spec.select254, %._crit_edge182 ], [ 0, %.lr.ph174.1 ], [ 0, %.lr.ph174 ]
...
.preheader:                                       ; preds = %.preheader, %.preheader.preheader.new
  ...
  %.1118191 = phi i32 [ %i.ap, %.preheader.preheader.new ], [ %i.dt, %.preheader ] ; 2 uses
