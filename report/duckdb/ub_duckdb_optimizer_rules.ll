...
bb.b:                                             ; preds = %.lr.ph, %.thread
  %.066 = phi i64 [ 0, %.lr.ph ], [ %i.ax, %.thread ] ; 7 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.q = load i8, ptr %9, align 8, !tbaa !143, !range !159, !noundef !160
...
bb.m:                                             ; preds = %bb.g
  ...
  %i.z = load ptr, ptr %i.h, align 8, !tbaa !142  ; 3 uses
  store ptr %i.y, ptr %i.h, align 8, !tbaa !142
...
_ZNSt6vectorIN6duckdb14BoundCaseCheckESaIS1_EE5eraseEN9__gnu_cxx17__normal_iteratorIPKS1_S3_EES8_.exit: ; preds = %_ZN6duckdb11NumericCastIlmvEET_T0_.exit, %_ZSt8_DestroyIPN6duckdb14BoundCaseCheckES1_EvT_S3_RSaIT0_E.exit.i.i.i, %_ZNSt6vectorIN6duckdb14BoundCaseCheckESaIS1_EE5eraseEN9__gnu_cxx17__normal_iteratorIPKS1_S3_EES8_.exit.a
  %cond1 = phi i1 [ true, %_ZNSt6vectorIN6duckdb14BoundCaseCheckESaIS1_EE5eraseEN9__gnu_cxx17__normal_iteratorIPKS1_S3_EES8_.exit.a ], [ false, %_ZSt8_DestroyIPN6duckdb14BoundCaseCheckES1_EvT_S3_RSaIT0_E.exit.i.i.i ], [ false, %_ZN6duckdb11NumericCastIlmvEET_T0_.exit ]
  %.1 = phi i64 [ %i.t, %_ZNSt6vectorIN6duckdb14BoundCaseCheckESaIS1_EE5eraseEN9__gnu_cxx17__normal_iteratorIPKS1_S3_EES8_.exit.a ], [ %.066, %_ZSt8_DestroyIPN6duckdb14BoundCaseCheckES1_EvT_S3_RSaIT0_E.exit.i.i.i ], [ %.066, %_ZN6duckdb11NumericCastIlmvEET_T0_.exit ]
...
_ZNSt6vectorIN6duckdb14BoundCaseCheckESaIS1_EE5eraseEN9__gnu_cxx17__normal_iteratorIPKS1_S3_EES8_.exit._ZNSt6vectorIN6duckdb14BoundCaseCheckESaIS1_EE5eraseEN9__gnu_cxx17__normal_iteratorIPKS1_S3_EES8_.exit._crit_edge.loopexit_crit_edge: ; preds = %_ZNSt6vectorIN6duckdb14BoundCaseCheckESaIS1_EE5eraseEN9__gnu_cxx17__normal_iteratorIPKS1_S3_EES8_.exit
  %.pre.pre = load ptr, ptr %i.d, align 8, !tbaa !187
  %.pre62.pre = load ptr, ptr %i.e, align 8, !tbaa !187
  br label %.loopexit
...
.thread:                                          ; preds = %_ZNSt6vectorIN6duckdb14BoundCaseCheckESaIS1_EE5eraseEN9__gnu_cxx17__normal_iteratorIPKS1_S3_EES8_.exit, %bb.b
  %.348 = phi i64 [ %.1, %_ZNSt6vectorIN6duckdb14BoundCaseCheckESaIS1_EE5eraseEN9__gnu_cxx17__normal_iteratorIPKS1_S3_EES8_.exit ], [ %.066, %bb.b ]
...
.loopexit:                                        ; preds = %.thread, %_ZNSt6vectorIN6duckdb14BoundCaseCheckESaIS1_EE5eraseEN9__gnu_cxx17__normal_iteratorIPKS1_S3_EES8_.exit._ZNSt6vectorIN6duckdb14BoundCaseCheckESaIS1_EE5eraseEN9__gnu_cxx17__normal_iteratorIPKS1_S3_EES8_.exit._crit_edge.loopexit_crit_edge
  %i.bf = phi ptr [ %.pre62.pre, %_ZNSt6vectorIN6duckdb14BoundCaseCheckESaIS1_EE5eraseEN9__gnu_cxx17__normal_iteratorIPKS1_S3_EES8_.exit._ZNSt6vectorIN6duckdb14BoundCaseCheckESaIS1_EE5eraseEN9__gnu_cxx17__normal_iteratorIPKS1_S3_EES8_.exit._crit_edge.loopexit_crit_edge ], [ %i.ay, %.thread ]
  %i.bg = phi ptr [ %.pre.pre, %_ZNSt6vectorIN6duckdb14BoundCaseCheckESaIS1_EE5eraseEN9__gnu_cxx17__normal_iteratorIPKS1_S3_EES8_.exit._ZNSt6vectorIN6duckdb14BoundCaseCheckESaIS1_EE5eraseEN9__gnu_cxx17__normal_iteratorIPKS1_S3_EES8_.exit._crit_edge.loopexit_crit_edge ], [ %i.az, %.thread ]
