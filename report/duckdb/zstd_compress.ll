...
.preheader.i.i.preheader:                         ; preds = %bb.d
  %i.bo = insertelement <4 x i32> poison, i32 %i.ai, i64 0
  %i.bp = shufflevector <4 x i32> %i.bo, <4 x i32> poison, <4 x i32> zeroinitializer ; 4 uses
  %i.bq = insertelement <4 x i32> poison, i32 %i.ab, i64 0
...
.preheader.i.i:                                   ; preds = %.preheader.i.i.preheader, %.preheader.i.i
  ...
  %.021.i4.i.i = phi i32 [ %i.cu, %.preheader.i.i ], [ 0, %.preheader.i.i.preheader ]
  %i.bs = getelementptr inbounds nuw [4 x i8], ptr %i.bm, i64 %indvars.iv.i.i ; 5 uses
  %i.bt = load <4 x i32>, ptr %i.bs, align 4, !tbaa !3 ; 3 uses
  %i.bu = icmp eq <4 x i32> %i.bt, splat (i32 1)
  %i.bv = icmp ult <4 x i32> %i.bt, %i.bp
  %i.bw = sub <4 x i32> %i.bt, %i.br
  %i.bx = select <4 x i1> %i.bv, <4 x i32> zeroinitializer, <4 x i32> %i.bw
  %i.by = select <4 x i1> %i.bu, <4 x i32> splat (i32 1), <4 x i32> %i.bx
  store <4 x i32> %i.by, ptr %i.bs, align 4, !tbaa !3
  %i.bz = getelementptr inbounds nuw i8, ptr %i.bs, i64 16 ; 2 uses
  %i.ca = load <4 x i32>, ptr %i.bz, align 4, !tbaa !3 ; 3 uses
  %i.cb = icmp eq <4 x i32> %i.ca, splat (i32 1)
  %i.cc = icmp ult <4 x i32> %i.ca, %i.bp
  %i.cd = sub <4 x i32> %i.ca, %i.br
  %i.ce = select <4 x i1> %i.cc, <4 x i32> zeroinitializer, <4 x i32> %i.cd
  %i.cf = select <4 x i1> %i.cb, <4 x i32> splat (i32 1), <4 x i32> %i.ce
  store <4 x i32> %i.cf, ptr %i.bz, align 4, !tbaa !3
  %i.cg = getelementptr inbounds nuw i8, ptr %i.bs, i64 32 ; 2 uses
  %i.ch = load <4 x i32>, ptr %i.cg, align 4, !tbaa !3 ; 3 uses
  %i.ci = icmp eq <4 x i32> %i.ch, splat (i32 1)
  %i.cj = icmp ult <4 x i32> %i.ch, %i.bp
  %i.ck = sub <4 x i32> %i.ch, %i.br
  %i.cl = select <4 x i1> %i.cj, <4 x i32> zeroinitializer, <4 x i32> %i.ck
  %i.cm = select <4 x i1> %i.ci, <4 x i32> splat (i32 1), <4 x i32> %i.cl
  store <4 x i32> %i.cm, ptr %i.cg, align 4, !tbaa !3
  %i.cn = getelementptr inbounds nuw i8, ptr %i.bs, i64 48 ; 2 uses
  %i.co = load <4 x i32>, ptr %i.cn, align 4, !tbaa !3 ; 3 uses
  %i.cp = icmp eq <4 x i32> %i.co, splat (i32 1)
  %i.cq = icmp ult <4 x i32> %i.co, %i.bp
  %i.cr = sub <4 x i32> %i.co, %i.br
  %i.cs = select <4 x i1> %i.cq, <4 x i32> zeroinitializer, <4 x i32> %i.cr
  %i.ct = select <4 x i1> %i.cp, <4 x i32> splat (i32 1), <4 x i32> %i.cs
  store <4 x i32> %i.ct, ptr %i.cn, align 4, !tbaa !3
  %indvars.iv.next7.i.i = add nuw nsw i64 %indvars.iv.i.i, 16
  %i.cu = add nuw nsw i32 %.021.i4.i.i, 1         ; 2 uses
  %exitcond.not.i.i = icmp eq i32 %i.cu, %5
...
.preheader.preheader:                             ; preds = %bb.a
  %i.c = insertelement <4 x i32> poison, i32 %i.a, i64 0
  %i.d = shufflevector <4 x i32> %i.c, <4 x i32> poison, <4 x i32> zeroinitializer ; 4 uses
  %i.e = insertelement <4 x i32> poison, i32 %2, i64 0
  %i.f = shufflevector <4 x i32> %i.e, <4 x i32> poison, <4 x i32> zeroinitializer ; 4 uses
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %.preheader
  %indvars.iv = phi i64 [ %indvars.iv.next7, %.preheader ], [ 0, %.preheader.preheader ] ; 5 uses
  %.021.i4 = phi i32 [ %i.ad, %.preheader ], [ 0, %.preheader.preheader ]
  %i.g = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %indvars.iv ; 2 uses
  %i.h = load <4 x i32>, ptr %i.g, align 4, !tbaa !3 ; 2 uses
  %i.i = icmp ult <4 x i32> %i.h, %i.d
  %i.j = sub <4 x i32> %i.h, %i.f
  %i.k = select <4 x i1> %i.i, <4 x i32> zeroinitializer, <4 x i32> %i.j
  store <4 x i32> %i.k, ptr %i.g, align 4, !tbaa !3
  %i.l = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %indvars.iv
  %i.m = getelementptr inbounds nuw i8, ptr %i.l, i64 16 ; 2 uses
  %i.n = load <4 x i32>, ptr %i.m, align 4, !tbaa !3 ; 2 uses
  %i.o = icmp ult <4 x i32> %i.n, %i.d
  %i.p = sub <4 x i32> %i.n, %i.f
  %i.q = select <4 x i1> %i.o, <4 x i32> zeroinitializer, <4 x i32> %i.p
  store <4 x i32> %i.q, ptr %i.m, align 4, !tbaa !3
  %i.r = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %indvars.iv
  %i.s = getelementptr inbounds nuw i8, ptr %i.r, i64 32 ; 2 uses
  %i.t = load <4 x i32>, ptr %i.s, align 4, !tbaa !3 ; 2 uses
  %i.u = icmp ult <4 x i32> %i.t, %i.d
  %i.v = sub <4 x i32> %i.t, %i.f
  %i.w = select <4 x i1> %i.u, <4 x i32> zeroinitializer, <4 x i32> %i.v
  store <4 x i32> %i.w, ptr %i.s, align 4, !tbaa !3
  %i.x = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %indvars.iv
  %i.y = getelementptr inbounds nuw i8, ptr %i.x, i64 48 ; 2 uses
  %i.z = load <4 x i32>, ptr %i.y, align 4, !tbaa !3 ; 2 uses
  %i.aa = icmp ult <4 x i32> %i.z, %i.d
  %i.ab = sub <4 x i32> %i.z, %i.f
  %i.ac = select <4 x i1> %i.aa, <4 x i32> zeroinitializer, <4 x i32> %i.ab
  store <4 x i32> %i.ac, ptr %i.y, align 4, !tbaa !3
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv, 16
  %i.ad = add nuw nsw i32 %.021.i4, 1             ; 2 uses
  %exitcond.not = icmp eq i32 %i.ad, %3
