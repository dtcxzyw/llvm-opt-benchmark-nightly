...
_ZN11duckdb_zstd18ZSTD_compressBoundEm.exit:      ; preds = %bb.b
  ...
  %2 = icmp ult i64 %spec.select, 131072
  %i.t = sub nuw nsw i64 131072, %spec.select
  %i.u = lshr i64 %i.t, 11
  %i.v = select i1 %2, i64 %i.u, i64 0
...
bb.b:                                             ; preds = %bb.a
  ...
  %7 = icmp ult i64 %4, 131072
  %i.d = sub nuw nsw i64 131072, %4
  %i.e = lshr i64 %i.d, 11
  %i.f = select i1 %7, i64 %i.e, i64 0
  %i.g = add i64 %i.c, %i.f
...
bb.z:                                             ; preds = %bb.y
  ...
  %4 = icmp ult i64 %i.cw, 131072
  %i.da = sub nuw nsw i64 131072, %i.cw
  %i.db = lshr i64 %i.da, 11
  %i.dc = select i1 %4, i64 %i.db, i64 0
...
bb.aq:                                            ; preds = %bb.ap
  ...
  %5 = icmp ult i64 %i.ew, 131072
  %i.fa = sub nuw nsw i64 131072, %i.ew
  %i.fb = lshr i64 %i.fa, 11
  %i.fc = select i1 %5, i64 %i.fb, i64 0
...
_ZN11duckdb_zstd18ZSTD_compressBoundEm.exit:      ; preds = %bb.d
  ...
  %6 = icmp ult i64 %.189, 131072
  %i.ac = sub nuw nsw i64 131072, %.189
  %i.ad = lshr i64 %i.ac, 11
  %i.ae = select i1 %6, i64 %i.ad, i64 0
