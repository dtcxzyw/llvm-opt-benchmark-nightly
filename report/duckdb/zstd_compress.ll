...
begin_hunk_0_@_ZN11duckdb_zstdL30ZSTD_CCtx_init_compressStream2EPNS_11ZSTD_CCtx_sENS_17ZSTD_EndDirectiveEm:bb.a

bb.r:                                             ; preds = %bb.q
  %i.bk = load i32, ptr %i.be, align 4, !tbaa !96
  %i.bl = icmp ugt i32 %i.bk, 16
  %i.bm = select i1 %i.bl, i32 1, i32 2
...
_ZN11duckdb_zstdL29ZSTD_resolveBlockSplitterModeENS_18ZSTD_paramSwitch_eEPKNS_26ZSTD_compressionParametersE.exit: ; preds = %_ZN11duckdb_zstdL18ZSTD_getCParamModeEPKNS_12ZSTD_CDict_sEPKNS_18ZSTD_CCtx_params_sEm.exit, %bb.q, %bb.r
  %.0.i57 = phi i32 [ %i.bg, %_ZN11duckdb_zstdL18ZSTD_getCParamModeEPKNS_12ZSTD_CDict_sEPKNS_18ZSTD_CCtx_params_sEm.exit ], [ 2, %bb.q ], [ %i.bm, %bb.r ]
  store i32 %.0.i57, ptr %i.bf, align 4, !tbaa !92
  %i.bn = getelementptr inbounds nuw i8, ptr %3, i64 96 ; 2 uses
  %i.bo = load i32, ptr %i.bn, align 8, !tbaa !93 ; 2 uses
  %.not.i58 = icmp eq i32 %i.bo, 0
  br i1 %.not.i58, label %bb.s, label %_ZN11duckdb_zstdL21ZSTD_resolveEnableLdmENS_18ZSTD_paramSwitch_eEPKNS_26ZSTD_compressionParametersE.exit

bb.s:                                             ; preds = %_ZN11duckdb_zstdL29ZSTD_resolveBlockSplitterModeENS_18ZSTD_paramSwitch_eEPKNS_26ZSTD_compressionParametersE.exit
  %i.bp = getelementptr inbounds nuw i8, ptr %3, i64 28
  %i.bq = load i32, ptr %i.bp, align 4, !tbaa !101
  %i.br = icmp sgt i32 %i.bq, 6
  br i1 %i.br, label %bb.t, label %_ZN11duckdb_zstdL21ZSTD_resolveEnableLdmENS_18ZSTD_paramSwitch_eEPKNS_26ZSTD_compressionParametersE.exit

bb.t:                                             ; preds = %bb.s
  %i.bs = load i32, ptr %i.be, align 4, !tbaa !96
  %i.bt = icmp ugt i32 %i.bs, 26
  %i.bu = select i1 %i.bt, i32 1, i32 2
  br label %_ZN11duckdb_zstdL21ZSTD_resolveEnableLdmENS_18ZSTD_paramSwitch_eEPKNS_26ZSTD_compressionParametersE.exit

_ZN11duckdb_zstdL21ZSTD_resolveEnableLdmENS_18ZSTD_paramSwitch_eEPKNS_26ZSTD_compressionParametersE.exit: ; preds = %_ZN11duckdb_zstdL29ZSTD_resolveBlockSplitterModeENS_18ZSTD_paramSwitch_eEPKNS_26ZSTD_compressionParametersE.exit, %bb.s, %bb.t
  %.0.i59 = phi i32 [ %i.bo, %_ZN11duckdb_zstdL29ZSTD_resolveBlockSplitterModeENS_18ZSTD_paramSwitch_eEPKNS_26ZSTD_compressionParametersE.exit ], [ 2, %bb.s ], [ %i.bu, %bb.t ]
  store i32 %.0.i59, ptr %i.bn, align 8, !tbaa !93
  %i.bv = getelementptr inbounds nuw i8, ptr %3, i64 144 ; 2 uses
  %i.bw = load i32, ptr %i.bv, align 8, !tbaa !91 ; 2 uses
  %.not.i60 = icmp eq i32 %i.bw, 0
  br i1 %.not.i60, label %bb.u, label %_ZN11duckdb_zstdL30ZSTD_resolveRowMatchFinderModeENS_18ZSTD_paramSwitch_eEPKNS_26ZSTD_compressionParametersE.exit

bb.u:                                             ; preds = %_ZN11duckdb_zstdL21ZSTD_resolveEnableLdmENS_18ZSTD_paramSwitch_eEPKNS_26ZSTD_compressionParametersE.exit
  %i.bx = getelementptr inbounds nuw i8, ptr %3, i64 28
  %i.by = load i32, ptr %i.bx, align 4, !tbaa !101
  %i.bz = add i32 %i.by, -6
  %i.ca = icmp ult i32 %i.bz, -3
  br i1 %i.ca, label %_ZN11duckdb_zstdL30ZSTD_resolveRowMatchFinderModeENS_18ZSTD_paramSwitch_eEPKNS_26ZSTD_compressionParametersE.exit, label %bb.v

bb.v:                                             ; preds = %bb.u
  %i.cb = load i32, ptr %i.be, align 4, !tbaa !96
  %i.cc = icmp ugt i32 %i.cb, 14
  %spec.select.i = select i1 %i.cc, i32 1, i32 2
...
_ZN11duckdb_zstdL30ZSTD_resolveRowMatchFinderModeENS_18ZSTD_paramSwitch_eEPKNS_26ZSTD_compressionParametersE.exit: ; preds = %_ZN11duckdb_zstdL21ZSTD_resolveEnableLdmENS_18ZSTD_paramSwitch_eEPKNS_26ZSTD_compressionParametersE.exit, %bb.u, %bb.v
  %.0.i61 = phi i32 [ %i.bw, %_ZN11duckdb_zstdL21ZSTD_resolveEnableLdmENS_18ZSTD_paramSwitch_eEPKNS_26ZSTD_compressionParametersE.exit ], [ %spec.select.i, %bb.v ], [ 2, %bb.u ]
  store i32 %.0.i61, ptr %i.bv, align 8, !tbaa !91
  %i.cd = getelementptr inbounds nuw i8, ptr %3, i64 200 ; 2 uses
  %i.ce = load i64, ptr %i.cd, align 8, !tbaa !94 ; 2 uses
  %i.cf = icmp eq i64 %i.ce, 0
  %..i = select i1 %i.cf, i64 131072, i64 %i.ce
  store i64 %..i, ptr %i.cd, align 8, !tbaa !94
  %i.cg = getelementptr inbounds nuw i8, ptr %3, i64 208 ; 2 uses
  %i.ch = load i32, ptr %i.cg, align 8, !tbaa !95 ; 2 uses
  %i.ci = getelementptr inbounds nuw i8, ptr %3, i64 44
  %i.cj = load i32, ptr %i.ci, align 4, !tbaa !58
  %.not.i62 = icmp eq i32 %i.ch, 0
  %i.ck = icmp slt i32 %i.cj, 10
  %..i63 = select i1 %i.ck, i32 2, i32 1
  %.0.i64 = select i1 %.not.i62, i32 %..i63, i32 %i.ch
  store i32 %.0.i64, ptr %i.cg, align 8, !tbaa !95
  %i.cl = call fastcc noundef i64 @_ZN11duckdb_zstdL27ZSTD_compressBegin_internalEPNS_11ZSTD_CCtx_sEPKvmNS_22ZSTD_dictContentType_eENS_26ZSTD_dictTableLoadMethod_eEPKNS_12ZSTD_CDict_sEPKNS_18ZSTD_CCtx_params_sEmNS_22ZSTD_buffered_policy_eE(ptr noundef nonnull %0, ptr noundef %.sroa.0.0.copyload, i64 noundef %.sroa.5.0.copyload, i32 noundef %.sroa.7.0.copyload, i32 noundef 0, ptr noundef %i.p, ptr noundef nonnull %3, i64 noundef %i.bc, i32 noundef 1) ; 2 uses
  %i.cm = icmp ult i64 %i.cl, -119
  br i1 %i.cm, label %bb.w, label %_ZN11duckdb_zstdL18ZSTD_initLocalDictEPNS_11ZSTD_CCtx_sE.exit

bb.w:                                             ; preds = %_ZN11duckdb_zstdL30ZSTD_resolveRowMatchFinderModeENS_18ZSTD_paramSwitch_eEPKNS_26ZSTD_compressionParametersE.exit
  %i.cn = getelementptr inbounds nuw i8, ptr %0, i64 3552
  %i.co = getelementptr inbounds nuw i8, ptr %0, i64 356
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.cn, i8 0, i64 16, i1 false)
  %i.cp = load i32, ptr %i.co, align 4, !tbaa !363
  %i.cq = icmp eq i32 %i.cp, 0
  br i1 %i.cq, label %bb.x, label %bb.y

bb.x:                                             ; preds = %bb.w
  %i.cr = getelementptr inbounds nuw i8, ptr %0, i64 752
  %i.cs = load i64, ptr %i.cr, align 8, !tbaa !268 ; 2 uses
  %i.ct = icmp eq i64 %i.cs, %i.bc
  %i.cu = zext i1 %i.ct to i64
  %i.cv = add i64 %i.cs, %i.cu
  br label %bb.y

bb.y:                                             ; preds = %bb.w, %bb.x
  %.sink = phi i64 [ %i.cv, %bb.x ], [ 0, %bb.w ]
  %i.cw = getelementptr inbounds nuw i8, ptr %0, i64 3568
  store i64 %.sink, ptr %i.cw, align 8, !tbaa !365
  %i.cx = getelementptr inbounds nuw i8, ptr %0, i64 3592
  %i.cy = getelementptr inbounds nuw i8, ptr %0, i64 3608
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.cx, i8 0, i64 16, i1 false)
  store i32 1, ptr %i.cy, align 8, !tbaa !102
  %i.cz = getelementptr inbounds nuw i8, ptr %0, i64 3612
  store i32 0, ptr %i.cz, align 4, !tbaa !375
  br label %_ZN11duckdb_zstdL18ZSTD_initLocalDictEPNS_11ZSTD_CCtx_sE.exit

_ZN11duckdb_zstdL18ZSTD_initLocalDictEPNS_11ZSTD_CCtx_sE.exit: ; preds = %bb.y, %_ZN11duckdb_zstdL30ZSTD_resolveRowMatchFinderModeENS_18ZSTD_paramSwitch_eEPKNS_26ZSTD_compressionParametersE.exit, %bb.c
  %.2 = phi i64 [ -64, %bb.c ], [ %i.cl, %_ZN11duckdb_zstdL30ZSTD_resolveRowMatchFinderModeENS_18ZSTD_paramSwitch_eEPKNS_26ZSTD_compressionParametersE.exit ], [ 0, %bb.y ]
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #27
  ret i64 %.2
}

; Function Attrs: mustprogress uwtable
define noundef i64 @_ZN11duckdb_zstd31ZSTD_compressStream2_simpleArgsEPNS_11ZSTD_CCtx_sEPvmPmPKvmS3_NS_17ZSTD_EndDirectiveE(ptr noundef %0, ptr noundef %1, i64 noundef %2, ptr nofree noundef captures(none) %3, ptr noundef %4, i64 noundef %5, ptr nofree noundef captures(none) %6, i32 noundef %7) local_unnamed_addr #2 {
bb.a:
  %8 = alloca %"struct.duckdb_zstd::ZSTD_outBuffer_s", align 8 ; 6 uses
  %9 = alloca %"struct.duckdb_zstd::ZSTD_inBuffer_s", align 8 ; 6 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %8) #27
  call void @llvm.lifetime.start.p0(ptr nonnull %9) #27
  store ptr %1, ptr %8, align 8, !tbaa !226
  %i.a = getelementptr inbounds nuw i8, ptr %8, i64 8
  store i64 %2, ptr %i.a, align 8, !tbaa !228
  %i.b = load i64, ptr %3, align 8, !tbaa !78
  %i.c = getelementptr inbounds nuw i8, ptr %8, i64 16 ; 2 uses
  store i64 %i.b, ptr %i.c, align 8, !tbaa !229
  store ptr %4, ptr %9, align 8, !tbaa !230
  %i.d = getelementptr inbounds nuw i8, ptr %9, i64 8
  store i64 %5, ptr %i.d, align 8, !tbaa !231
  %i.e = load i64, ptr %6, align 8, !tbaa !78
  %i.f = getelementptr inbounds nuw i8, ptr %9, i64 16 ; 2 uses
  store i64 %i.e, ptr %i.f, align 8, !tbaa !232
  %i.g = call noundef i64 @_ZN11duckdb_zstd20ZSTD_compressStream2EPNS_11ZSTD_CCtx_sEPNS_16ZSTD_outBuffer_sEPNS_15ZSTD_inBuffer_sENS_17ZSTD_EndDirectiveE(ptr noundef %0, ptr noundef nonnull %8, ptr noundef nonnull %9, i32 noundef %7)
  %i.h = load i64, ptr %i.c, align 8, !tbaa !229
  store i64 %i.h, ptr %3, align 8, !tbaa !78
  %i.i = load i64, ptr %i.f, align 8, !tbaa !232
  store i64 %i.i, ptr %6, align 8, !tbaa !78
...
define noundef range(i64 -107, 1) i64 @_ZN11duckdb_zstd46ZSTD_copySequencesToSeqStoreExplicitBlockDelimEPNS_11ZSTD_CCtx_sEPNS_21ZSTD_sequencePositionEPKNS_13ZSTD_SequenceEmPKvmNS_18ZSTD_paramSwitch_eE(ptr nofree noundef captures(none) %0, ptr nofree noundef captures(none) %1, ptr nofree noundef readonly captures(none) %2, i64 noundef %3, ptr noundef %4, i64 noundef %5, i32 noundef %6) local_unnamed_addr #14 {
bb.a:
  %7 = alloca %"struct.duckdb_zstd::repcodes_s", align 8 ; 17 uses
  %i.a = load i32, ptr %1, align 8, !tbaa !383    ; 5 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.f = load i64, ptr %i.e, align 8, !tbaa !289
  br label %bb.e

bb.c:                                             ; preds = %bb.a
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 3704
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !149
  %.not123 = icmp eq ptr %i.h, null
  br i1 %.not123, label %bb.e, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.i = getelementptr inbounds nuw i8, ptr %0, i64 3712
  %i.j = load i64, ptr %i.i, align 8, !tbaa !150
  br label %bb.e

bb.e:                                             ; preds = %bb.c, %bb.d, %bb.b
  %.0115 = phi i64 [ %i.f, %bb.b ], [ %i.j, %bb.d ], [ 0, %bb.c ]
  %i.k = getelementptr inbounds nuw i8, ptr %0, i64 3200
  ...
  br i1 %i.o, label %.lr.ph, label %.critedge.thread
...
.lr.ph:                                           ; preds = %bb.e
  ...
  %i.w = getelementptr i8, ptr %0, i64 424
  %i.x = getelementptr inbounds nuw i8, ptr %0, i64 252
  %i.y = getelementptr inbounds nuw i8, ptr %0, i64 1008
  %i.z = getelementptr inbounds nuw i8, ptr %0, i64 952 ; 2 uses
  %i.aa = getelementptr inbounds i8, ptr %i.b, i64 -32 ; 5 uses
  %i.ab = getelementptr inbounds nuw i8, ptr %0, i64 976 ; 6 uses
  %i.ac = ptrtoint ptr %i.aa to i64
  %i.ad = getelementptr inbounds nuw i8, ptr %0, i64 1024 ; 2 uses
  %i.ae = getelementptr inbounds nuw i8, ptr %0, i64 960 ; 3 uses
  %i.af = getelementptr inbounds nuw i8, ptr %0, i64 1028 ; 2 uses
  %.promoted173 = load i32, ptr %i.q, align 4
  %.promoted174 = load i32, ptr %i.r, align 8
  br label %bb.f

bb.f:                                             ; preds = %.lr.ph, %bb.af
  %i.ag = phi i32 [ %.promoted174, %.lr.ph ], [ %i.bm, %bb.af ] ; 4 uses
  %i.ah = phi i32 [ %.promoted173, %.lr.ph ], [ %i.bn, %bb.af ] ; 5 uses
  ...
  br i1 %.not124, label %bb.g, label %.critedge3

bb.g:                                             ; preds = %bb.f
  %i.an = load i32, ptr %i.ak, align 4, !tbaa !236
  %.not125 = icmp eq i32 %i.an, 0
...
bb.al:                                            ; preds = %.critedge.thread
  ...
  %i.ht = getelementptr inbounds nuw i8, ptr %i.hs, i64 %i.hp
  store ptr %i.ht, ptr %i.hq, align 8, !tbaa !225
  %i.hu = load i32, ptr %i.hn, align 4, !tbaa !239
  %i.hv = zext i32 %i.hu to i64                   ; 2 uses
  %i.hw = getelementptr inbounds nuw i8, ptr %.0112.lcssa201, i64 %i.hv
  %i.hx = getelementptr inbounds nuw i8, ptr %1, i64 8 ; 2 uses
  %i.hy = load i64, ptr %i.hx, align 8, !tbaa !386
  %i.hz = add i64 %i.hy, %i.hv
  store i64 %i.hz, ptr %i.hx, align 8, !tbaa !386
  br label %bb.am

bb.am:                                            ; preds = %.critedge.thread, %bb.al
  %.2114 = phi ptr [ %i.hw, %bb.al ], [ %.0112.lcssa201, %.critedge.thread ]
  %.not129 = icmp eq ptr %.2114, %i.b
  br i1 %.not129, label %bb.an, label %.thread

bb.an:                                            ; preds = %bb.am
  %i.ia = add i32 %.0109.lcssa202, 1
  store i32 %i.ia, ptr %1, align 8, !tbaa !383
  br label %.thread

.thread:                                          ; preds = %bb.s, %bb.r, %_ZN11duckdb_zstdL21ZSTD_validateSequenceEjjjmjmi.exit, %bb.am, %bb.an
  %.4 = phi i64 [ -107, %bb.am ], [ 0, %bb.an ], [ -107, %_ZN11duckdb_zstdL21ZSTD_validateSequenceEjjjmjmi.exit ], [ -107, %bb.r ], [ -107, %bb.s ]
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #27
  ret i64 %.4
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none, target_mem: none) uwtable
define noundef range(i64 -107, 4294967296) i64 @_ZN11duckdb_zstd40ZSTD_copySequencesToSeqStoreNoBlockDelimEPNS_11ZSTD_CCtx_sEPNS_21ZSTD_sequencePositionEPKNS_13ZSTD_SequenceEmPKvmNS_18ZSTD_paramSwitch_eE(ptr nofree noundef captures(none) %0, ptr nofree noundef captures(none) %1, ptr nofree noundef readonly captures(none) %2, i64 noundef %3, ptr noundef %4, i64 noundef %5, i32 %6) local_unnamed_addr #14 {
bb.a:
  %7 = alloca %"struct.duckdb_zstd::repcodes_s", align 4 ; 9 uses
  %i.a = load i32, ptr %1, align 8, !tbaa !383    ; 2 uses
  %i.b = getelementptr inbounds nuw i8, ptr %1, i64 4 ; 2 uses
  %i.c = load i32, ptr %i.b, align 4, !tbaa !396  ; 2 uses
  %i.d = trunc i64 %5 to i32
  %i.e = add i32 %i.c, %i.d                       ; 2 uses
  %i.f = getelementptr inbounds nuw i8, ptr %4, i64 %5 ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %7) #27
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 3696
...
bb.c:                                             ; preds = %bb.a
  %i.k = getelementptr inbounds nuw i8, ptr %0, i64 3704
  %i.l = load ptr, ptr %i.k, align 8, !tbaa !149
  %.not157 = icmp eq ptr %i.l, null
  br i1 %.not157, label %bb.e, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.m = getelementptr inbounds nuw i8, ptr %0, i64 3712
  %i.n = load i64, ptr %i.m, align 8, !tbaa !150
  br label %bb.e

bb.e:                                             ; preds = %bb.c, %bb.d, %bb.b
  %.0130 = phi i64 [ %i.j, %bb.b ], [ %i.n, %bb.d ], [ 0, %bb.c ]
  %i.o = getelementptr inbounds nuw i8, ptr %0, i64 3200
  ...
  %.not158230 = icmp eq i32 %i.e, 0
  br i1 %.not158230, label %.critedge, label %.lr.ph

.lr.ph:                                           ; preds = %bb.e
  %.promoted = load i32, ptr %7, align 4
  %i.r = getelementptr inbounds nuw i8, ptr %0, i64 252 ; 2 uses
  ...
  %i.x = getelementptr i8, ptr %0, i64 424
  %i.y = getelementptr inbounds nuw i8, ptr %0, i64 1008
  %i.z = getelementptr inbounds nuw i8, ptr %0, i64 952 ; 2 uses
  ...
  %i.ae = getelementptr inbounds nuw i8, ptr %0, i64 960 ; 3 uses
  %i.af = getelementptr inbounds nuw i8, ptr %0, i64 1028 ; 2 uses
  %.promoted252 = load i32, ptr %i.s, align 4
  %.promoted253 = load i32, ptr %i.t, align 4
  br label %bb.f

bb.f:                                             ; preds = %.lr.ph, %bb.aj
  %i.ag = phi i32 [ %.promoted253, %.lr.ph ], [ %i.bt, %bb.aj ] ; 3 uses
  %i.ah = phi i32 [ %.promoted252, %.lr.ph ], [ %i.bu, %bb.aj ] ; 4 uses
  %.0114238 = phi i32 [ %i.a, %.lr.ph ], [ %spec.select, %bb.aj ] ; 6 uses
  %.0118237 = phi i32 [ %i.c, %.lr.ph ], [ %.1119, %bb.aj ] ; 5 uses
  %.0124236 = phi i32 [ %i.e, %.lr.ph ], [ %.3127, %bb.aj ] ; 8 uses
  %.0131233 = phi ptr [ %4, %.lr.ph ], [ %i.gm, %bb.aj ] ; 13 uses
  ...
  %or.cond = and i1 %.not159, %i.ak
  br i1 %or.cond, label %bb.g, label %.critedge

bb.g:                                             ; preds = %bb.f
  %i.al = getelementptr inbounds nuw [16 x i8], ptr %2, i64 %i.aj ; 3 uses
  %.sroa.0.0.copyload = load i32, ptr %i.al, align 4, !tbaa !3 ; 6 uses
  %.sroa.4.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.al, i64 4
  %.sroa.4.0.copyload = load i32, ptr %.sroa.4.0..sroa_idx, align 4, !tbaa !3 ; 7 uses
  %.sroa.10.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.al, i64 8
  %.sroa.10.0.copyload = load i32, ptr %.sroa.10.0..sroa_idx, align 4, !tbaa !3 ; 3 uses
  %i.am = add i32 %.sroa.10.0.copyload, %.sroa.4.0.copyload ; 3 uses
  %.not160.not = icmp uge i32 %.0124236, %i.am    ; 2 uses
  br i1 %.not160.not, label %bb.h, label %bb.i

bb.h:                                             ; preds = %bb.g
  %.0137 = tail call i32 @llvm.usub.sat.i32(i32 %.sroa.4.0.copyload, i32 %.0118237)
  %i.an = tail call i32 @llvm.usub.sat.i32(i32 %.0118237, i32 %.sroa.4.0.copyload)
  %.0134 = sub i32 %.sroa.10.0.copyload, %i.an
  br label %bb.m

bb.i:                                             ; preds = %bb.g
  %i.ao = icmp ugt i32 %.0124236, %.sroa.4.0.copyload
  br i1 %i.ao, label %bb.j, label %.critedge

bb.j:                                             ; preds = %bb.i
  %i.ap = tail call i32 @llvm.usub.sat.i32(i32 %.sroa.4.0.copyload, i32 %.0118237) ; 2 uses
  %i.aq = add i32 %.0118237, %i.ap
  %i.ar = sub i32 %.0124236, %i.aq                ; 2 uses
  %i.as = zext i32 %.sroa.10.0.copyload to i64
  %i.at = icmp ult i64 %5, %i.as
  br i1 %i.at, label %bb.k, label %bb.l

bb.k:                                             ; preds = %bb.j
  %i.au = load i32, ptr %i.r, align 4, !tbaa !387 ; 4 uses
  %.not162 = icmp ult i32 %i.ar, %i.au
  br i1 %.not162, label %bb.l, label %.thread

.thread:                                          ; preds = %bb.k
  %i.av = sub i32 %i.am, %.0124236                ; 3 uses
  %i.aw = icmp ult i32 %i.av, %i.au
  %i.ax = sub nuw i32 %i.au, %i.av
  %.1140 = select i1 %i.aw, i32 %i.ax, i32 %.0139232
  %i.ay = tail call i32 @llvm.usub.sat.i32(i32 %i.au, i32 %i.av) ; 2 uses
  %.0129 = sub i32 %i.ar, %i.ay
  br label %bb.m
