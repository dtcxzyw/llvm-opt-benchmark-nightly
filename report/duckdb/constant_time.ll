...
begin_hunk_0_@_Z23mbedtls_ct_memmove_leftPvmm:bb.a
.lr.ph29:                                         ; preds = %bb.a
...
.lr.ph.i.preheader:                               ; preds = %.lr.ph.i.preheader.preheader, %_Z20mbedtls_ct_memcpy_ifmPhPKhS1_m.exit
  ...
  %.011 = phi i64 [ %3, %.lr.ph.i.preheader.preheader ], [ %i.fv, %_Z20mbedtls_ct_memcpy_ifmPhPKhS1_m.exit ] ; 3 uses
...
vec.epilog.vector.body92:                         ; preds = %vec.epilog.vector.body92, %vec.epilog.ph87
  ...
  %i.du = icmp eq i64 %index.next95, %n.vec89
  br i1 %i.du, label %vec.epilog.middle.block96, label %vec.epilog.vector.body92, !llvm.loop !24
...
.lr.ph34.i.preheader:                             ; preds = %iter.check83, %vec.epilog.iter.check85, %vec.epilog.middle.block96
  %.133.i.ph = phi i64 [ %i.fn, %iter.check83 ], [ %i.dj, %vec.epilog.iter.check85 ], [ %i.dq, %vec.epilog.middle.block96 ]
  br label %.lr.ph34.i

iter.check:                                       ; preds = %.preheader.i.loopexit
  %i.dv = trunc i64 %i.cx to i8                   ; 5 uses
  %i.dw = shl i64 %indvar49, 3
  %i.dx = sub i64 %i.a, %i.dw                     ; 6 uses
...
vector.main.loop.iter.check:                      ; preds = %vector.memcheck
  %min.iters.check51 = icmp ult i64 %i.dx, 32
  br i1 %min.iters.check51, label %vec.epilog.ph, label %vector.ph

vector.ph:                                        ; preds = %vector.main.loop.iter.check
  %n.mod.vf = and i64 %i.dx, 24
  %n.vec = and i64 %i.dx, -32                     ; 4 uses
  %i.dy = add i64 %i.cy, %n.vec
  %broadcast.splatinsert = insertelement <16 x i8> poison, i8 %i.dv, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load52 = load <16 x i8>, ptr %i.eb, align 1, !tbaa !7, !alias.scope !25
  %i.ec = getelementptr inbounds nuw i8, ptr %0, i64 %i.dz ; 3 uses
  %i.ed = getelementptr inbounds nuw i8, ptr %i.ec, i64 16 ; 2 uses
  %wide.load53 = load <16 x i8>, ptr %i.ec, align 1, !tbaa !7, !alias.scope !28, !noalias !25
  %wide.load54 = load <16 x i8>, ptr %i.ed, align 1, !tbaa !7, !alias.scope !28, !noalias !25
  %i.ee = and <16 x i8> %wide.load53, %broadcast.splat
  %i.ef = and <16 x i8> %wide.load54, %broadcast.splat
  %i.eg = or <16 x i8> %i.ee, %wide.load
  %i.eh = or <16 x i8> %i.ef, %wide.load52
  store <16 x i8> %i.eg, ptr %i.ec, align 1, !tbaa !7, !alias.scope !28, !noalias !25
  store <16 x i8> %i.eh, ptr %i.ed, align 1, !tbaa !7, !alias.scope !28, !noalias !25
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.ei = icmp eq i64 %index.next, %n.vec
  br i1 %i.ei, label %middle.block, label %vector.body, !llvm.loop !30
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec56 = sub i64 %i.dx, %n.mod.vf55           ; 2 uses
  %i.ej = add i64 %i.cy, %n.vec56
  %broadcast.splatinsert57 = insertelement <8 x i8> poison, i8 %i.dv, i64 0
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load61 = load <8 x i8>, ptr %i.em, align 1, !tbaa !7, !alias.scope !28, !noalias !25
  %i.en = and <8 x i8> %wide.load61, %broadcast.splat58
  %i.eo = or <8 x i8> %i.en, %wide.load60
  store <8 x i8> %i.eo, ptr %i.em, align 1, !tbaa !7, !alias.scope !28, !noalias !25
  %index.next62 = add nuw i64 %index59, 8         ; 2 uses
  %i.ep = icmp eq i64 %index.next62, %n.vec56
  br i1 %i.ep, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !31
...
.lr.ph34.i.us.preheader:                          ; preds = %vector.memcheck, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %.133.i.us.ph = phi i64 [ %i.cy, %iter.check ], [ %i.cy, %vector.memcheck ], [ %i.dy, %vec.epilog.iter.check ], [ %i.ej, %vec.epilog.middle.block ] ; 6 uses
  %i.eq = sub i64 %5, %.133.i.us.ph
...
.lr.ph34.i.us.prol:                               ; preds = %.lr.ph34.i.us.preheader
  %i.er = getelementptr inbounds nuw i8, ptr %i.cu, i64 %.133.i.us.ph
  %i.es = load i8, ptr %i.er, align 1, !tbaa !7
  %i.et = getelementptr inbounds nuw i8, ptr %0, i64 %.133.i.us.ph ; 2 uses
  %i.eu = load i8, ptr %i.et, align 1, !tbaa !7
  %i.ev = and i8 %i.eu, %i.dv
  %i.ew = or i8 %i.ev, %i.es
  store i8 %i.ew, ptr %i.et, align 1, !tbaa !7
  %i.ex = add nuw i64 %.133.i.us.ph, 1
  br label %.lr.ph34.i.us.prol.loopexit

.lr.ph34.i.us.prol.loopexit:                      ; preds = %.lr.ph34.i.us.prol, %.lr.ph34.i.us.preheader
  %.133.i.us.unr = phi i64 [ %.133.i.us.ph, %.lr.ph34.i.us.preheader ], [ %i.ex, %.lr.ph34.i.us.prol ]
  %i.ey = icmp eq i64 %5, %.neg
  br i1 %i.ey, label %_Z20mbedtls_ct_memcpy_ifmPhPKhS1_m.exit, label %.lr.ph34.i.us

.lr.ph34.i.us:                                    ; preds = %.lr.ph34.i.us.prol.loopexit, %.lr.ph34.i.us
  %.133.i.us = phi i64 [ %i.fm, %.lr.ph34.i.us ], [ %.133.i.us.unr, %.lr.ph34.i.us.prol.loopexit ] ; 4 uses
  %i.ez = getelementptr inbounds nuw i8, ptr %i.cu, i64 %.133.i.us
  %i.fa = load i8, ptr %i.ez, align 1, !tbaa !7
  %i.fb = getelementptr inbounds nuw i8, ptr %0, i64 %.133.i.us ; 2 uses
  %i.fc = load i8, ptr %i.fb, align 1, !tbaa !7
  %i.fd = and i8 %i.fc, %i.dv
  %i.fe = or i8 %i.fd, %i.fa
  store i8 %i.fe, ptr %i.fb, align 1, !tbaa !7
  %i.ff = add nuw i64 %.133.i.us, 1               ; 2 uses
  %i.fg = getelementptr inbounds nuw i8, ptr %i.cu, i64 %i.ff
  %i.fh = load i8, ptr %i.fg, align 1, !tbaa !7
  %i.fi = getelementptr inbounds nuw i8, ptr %0, i64 %i.ff ; 2 uses
  %i.fj = load i8, ptr %i.fi, align 1, !tbaa !7
  %i.fk = and i8 %i.fj, %i.dv
  %i.fl = or i8 %i.fk, %i.fh
  store i8 %i.fl, ptr %i.fi, align 1, !tbaa !7
  %i.fm = add nuw i64 %.133.i.us, 2               ; 2 uses
  %exitcond.not.i.us.1 = icmp eq i64 %i.fm, %5
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  ...
  %i.fn = phi i64 [ %i.fq, %.lr.ph.i ], [ 8, %.lr.ph.i.preheader ] ; 8 uses
  %.02732.i = phi i64 [ %i.fn, %.lr.ph.i ], [ 0, %.lr.ph.i.preheader ]
  %i.fo = getelementptr inbounds nuw i8, ptr %0, i64 %.02732.i ; 2 uses
  %.0.copyload.i.i = load i64, ptr %i.fo, align 1
  %i.fp = and i64 %.0.copyload.i.i, %i.cx
  store i64 %i.fp, ptr %i.fo, align 1
  %i.fq = add i64 %i.fn, 8                        ; 2 uses
  %.not.i = icmp ugt i64 %i.fq, %5
...
.lr.ph34.i:                                       ; preds = %.lr.ph34.i.preheader, %.lr.ph34.i
  %.133.i = phi i64 [ %i.fu, %.lr.ph34.i ], [ %.133.i.ph, %.lr.ph34.i.preheader ] ; 2 uses
  %i.fr = getelementptr inbounds nuw i8, ptr %0, i64 %.133.i ; 2 uses
  %i.fs = load i8, ptr %i.fr, align 1, !tbaa !7
  %i.ft = and i8 %i.fs, %i.dg
  store i8 %i.ft, ptr %i.fr, align 1, !tbaa !7
  %i.fu = add nuw i64 %.133.i, 1                  ; 2 uses
  %exitcond.not.i = icmp eq i64 %i.fu, %5
...
_Z20mbedtls_ct_memcpy_ifmPhPKhS1_m.exit:          ; preds = %.lr.ph34.i, %.lr.ph34.i.us.prol.loopexit, %.lr.ph34.i.us, %middle.block80, %vec.epilog.middle.block96, %middle.block, %vec.epilog.middle.block, %.preheader.i.loopexit.thread, %.preheader.i.loopexit
  %i.fv = add i64 %.011, 1                        ; 2 uses
  %.not = icmp ugt i64 %i.fv, %4
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph
  ...
  %i.x = and i8 %i.w, %i.d
  store i8 %i.x, ptr %i.v, align 1, !tbaa !7
