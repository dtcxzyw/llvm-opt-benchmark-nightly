...
vec.epilog.iter.check173:                         ; preds = %middle.block168
  ...
  br i1 %min.epilog.iters.check174, label %.lr.ph104.preheader, label %vec.epilog.ph175, !prof !29
...
vec.epilog.vector.body177:                        ; preds = %vec.epilog.vector.body177, %vec.epilog.ph175
  ...
  %wide.load179 = load <4 x i8>, ptr %i.di, align 1, !tbaa !7
  %gep231 = getelementptr i8, ptr %invariant.gep230, i64 %index178
  store <4 x i8> %wide.load179, ptr %gep231, align 1, !tbaa !7
...
vec.epilog.iter.check205:                         ; preds = %middle.block198
  ...
  br i1 %min.epilog.iters.check206, label %.lr.ph119.preheader, label %vec.epilog.ph207, !prof !29
...
vec.epilog.vector.body209:                        ; preds = %vec.epilog.vector.body209, %vec.epilog.ph207
  ...
  %wide.load212 = load <4 x i8>, ptr %i.ir, align 1, !tbaa !7
  %gep233 = getelementptr i8, ptr %invariant.gep232, i64 %index210
  store <4 x i8> %wide.load212, ptr %gep233, align 1, !tbaa !7
