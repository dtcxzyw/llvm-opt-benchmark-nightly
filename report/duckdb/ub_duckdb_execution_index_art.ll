...
.loopexit173:                                     ; preds = %_ZN6duckdb4Node11GetNodeTypeEm.exit, %_ZNKSt6vectorImSaImEE12_M_check_lenEmPKc.exit.i.i
...
.body:                                            ; preds = %.loopexit, %.loopexit.split-lp, %.loopexit168, %.loopexit.split-lp169, %.loopexit173, %bb.ae, %bb.au, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.i.i.i, %bb.ak, %bb.av
  %.pn56 = phi { ptr, i32 } [ %lpad.loopexit.split-lp, %.loopexit.split-lp ], [ %.pn8.i.i.i, %bb.ak ], [ %i.gw, %bb.ae ], [ %i.jx, %bb.au ], [ %i.jy, %bb.av ], [ %lpad.loopexit.split-lp171, %.loopexit.split-lp169 ], [ %i.hu, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i ], [ %i.hu, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.i.i.i ], [ %lpad.loopexit175, %.loopexit173 ], [ %lpad.loopexit170, %.loopexit168 ], [ %lpad.loopexit, %.loopexit ]
