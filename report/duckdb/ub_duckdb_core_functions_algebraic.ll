...
bb.d:                                             ; preds = %bb.c
  ...
  %4 = insertelement <2 x i64> %3, i64 %i.a, i64 1
  %5 = uitofp <2 x i64> %4 to <2 x double>        ; 4 uses
  ...
  %i.p = shufflevector <2 x double> %5, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %foldExtExtBinop = fmul <2 x double> %i.u, %shift
  %foldExtExtBinop18 = fmul <2 x double> %foldExtExtBinop, %5
  %shift20 = shufflevector <2 x double> %5, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop21 = fmul <2 x double> %foldExtExtBinop18, %shift20
  %7 = extractelement <2 x double> %foldExtExtBinop21, i64 0
  %i.v = fdiv double %7, %i.e
...
bb.d:                                             ; preds = %bb.c
  ...
  %4 = insertelement <2 x i64> poison, i64 %i.k, i64 0
  %5 = insertelement <2 x i64> %4, i64 %i.i, i64 1
  %6 = uitofp <2 x i64> %5 to <2 x double>        ; 4 uses
  ...
  %i.x = shufflevector <2 x double> %6, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %foldExtExtBinop = fmul <2 x double> %i.ac, %shift
  %foldExtExtBinop7 = fmul <2 x double> %foldExtExtBinop, %6
  %shift9 = shufflevector <2 x double> %6, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop10 = fmul <2 x double> %foldExtExtBinop7, %shift9
  %8 = extractelement <2 x double> %foldExtExtBinop10, i64 0
  %i.ad = fdiv double %8, %i.m
