...
bb.f:                                             ; preds = %bb.ac, %_ZNK6duckdb18RowGroupCollection12GetRowGroupsEv.exit
  %.028 = phi i64 [ 0, %_ZNK6duckdb18RowGroupCollection12GetRowGroupsEv.exit ], [ %.1.lcssa, %bb.ac ] ; 6 uses
  %.0 = phi i64 [ 0, %_ZNK6duckdb18RowGroupCollection12GetRowGroupsEv.exit ], [ %i.cu, %bb.ac ]
...
bb.g:                                             ; preds = %bb.f
  %i.y = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %.028 ; 2 uses
...
bb.j:                                             ; preds = %_ZNK6duckdb11SegmentNodeINS_8RowGroupEE7GetNodeEv.exit
  ...
  %.198 = add nuw i64 %.028, 1                    ; 2 uses
  %exitcond.not99 = icmp eq i64 %.028, %i.aj
  br i1 %exitcond.not99, label %._crit_edge102, label %.lr.ph

bb.k:                                             ; preds = %.lr.ph
  %.1 = add nuw i64 %.1100, 1                     ; 2 uses
  %exitcond.not = icmp eq i64 %.1100, %i.aj
  br i1 %exitcond.not, label %._crit_edge102, label %.lr.ph, !llvm.loop !3279

.lr.ph:                                           ; preds = %bb.j, %bb.k
  %.1100 = phi i64 [ %.1, %bb.k ], [ %.198, %bb.j ] ; 5 uses
  %i.ak = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %.1100
...
._crit_edge:                                      ; preds = %.lr.ph
  br label %._crit_edge102, !llvm.loop !3279

._crit_edge102:                                   ; preds = %bb.k, %._crit_edge, %bb.j
  %.1.lcssa94 = phi i64 [ %.1100, %._crit_edge ], [ %.198, %bb.j ], [ %.1, %bb.k ]
  %.1.lcssa = phi i64 [ %.1100, %._crit_edge ], [ %umax, %bb.j ], [ %umax, %bb.k ] ; 3 uses
  %i.aq = icmp ult i64 %.1.lcssa94, %4
  ...
  %.not.i = icmp eq i64 %.1.lcssa, %.028
  br i1 %.not.i, label %._crit_edge.i, label %.lr.ph.i

._crit_edge.i:                                    ; preds = %_ZN6duckdb18VersionDeleteState6DeleteEl.exit.i, %._crit_edge102
...
.lr.ph.i:                                         ; preds = %._crit_edge102, %_ZN6duckdb18VersionDeleteState6DeleteEl.exit.i
  %i.as = phi i64 [ %i.co, %_ZN6duckdb18VersionDeleteState6DeleteEl.exit.i ], [ -1, %._crit_edge102 ] ; 2 uses
  %i.at = phi i64 [ %i.ax, %_ZN6duckdb18VersionDeleteState6DeleteEl.exit.i ], [ -1, %._crit_edge102 ]
  %.08.i = phi i64 [ %i.cs, %_ZN6duckdb18VersionDeleteState6DeleteEl.exit.i ], [ 0, %._crit_edge102 ] ; 2 uses
