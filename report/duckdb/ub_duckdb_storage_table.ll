...
bb.f:                                             ; preds = %bb.ac, %_ZNK6duckdb18RowGroupCollection12GetRowGroupsEv.exit
  %.028 = phi i64 [ 0, %_ZNK6duckdb18RowGroupCollection12GetRowGroupsEv.exit ], [ %.1.lcssa, %bb.ac ] ; 5 uses
...
._crit_edge102:                                   ; preds = %bb.k, %._crit_edge, %bb.j
  ...
  %.1.lcssa = phi i64 [ %.1100, %._crit_edge ], [ %umax, %bb.j ], [ %umax, %bb.k ] ; 2 uses
...
.lr.ph.i:                                         ; preds = %_ZN6duckdb18VersionDeleteState6DeleteEl.exit.i, %._crit_edge102
  %i.as = phi i64 [ -1, %._crit_edge102 ], [ %i.co, %_ZN6duckdb18VersionDeleteState6DeleteEl.exit.i ] ; 2 uses
  %i.at = phi i64 [ -1, %._crit_edge102 ], [ %i.ax, %_ZN6duckdb18VersionDeleteState6DeleteEl.exit.i ]
  %.08.i = phi i64 [ 0, %._crit_edge102 ], [ %i.cs, %_ZN6duckdb18VersionDeleteState6DeleteEl.exit.i ] ; 2 uses
