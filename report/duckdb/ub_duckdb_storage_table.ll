...
begin_hunk_1_@_ZN6duckdb8RowGroupC2ERNS_18RowGroupCollectionENS_15RowGroupPointerE:bb.a
  ...
  %.pre33 = load ptr, ptr %.phi.trans.insert, align 8, !tbaa !2363 ; 5 uses
  %.pre34 = load ptr, ptr %i.e, align 8, !tbaa !2366 ; 2 uses
  %.pre32.a = load ptr, ptr %i.f, align 8, !tbaa !2319
  %.pre = load ptr, ptr %i.aj, align 8, !tbaa !2361
...
begin_hunk_5_@_ZNK6duckdb8RowGroup11WriteToDiskERNS_17RowGroupWriteInfoE:_ZNKSt6vectorISt17reference_wrapperIKN6duckdb8RowGroupEESaIS4_EE12_M_check_lenEmPKc.exit.i.i.i
  ...
  %6 = tail call noalias noundef nonnull dereferenceable(8) ptr @_Znwm(i64 noundef 8) #40 ; 3 uses
  %i.b = ptrtoint ptr %1 to i64
  store i64 %i.b, ptr %6, align 8
  %i.c = getelementptr inbounds nuw i8, ptr %6, i64 8 ; 2 uses
  store ptr %6, ptr %3, align 8, !tbaa !2706
  store ptr %i.c, ptr %5, align 8, !tbaa !2704
