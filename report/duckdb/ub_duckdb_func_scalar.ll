...
vector.body1488:                                  ; preds = %vector.body1488, %vector.ph1485
  ...
  %wide.vec = load <4 x i64>, ptr %i.avm, align 8, !alias.scope !673
...
vector.body1506:                                  ; preds = %vector.body1506, %vector.ph1503
  ...
  %wide.vec1510 = load <4 x i64>, ptr %i.awd, align 8, !alias.scope !676
  %strided.vec1511 = shufflevector <4 x i64> %wide.vec1510, <4 x i64> poison, <2 x i32> <i32 0, i32 2>
  %wide.vec1512 = load <4 x i64>, ptr %i.awf, align 8, !alias.scope !676
  %strided.vec1513 = shufflevector <4 x i64> %wide.vec1512, <4 x i64> poison, <2 x i32> <i32 0, i32 2>
