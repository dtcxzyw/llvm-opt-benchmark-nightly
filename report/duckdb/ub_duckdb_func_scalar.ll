...
bb.bt:                                            ; preds = %bb.bq
  %i.jt = getelementptr inbounds nuw i8, ptr %i.jb, i64 %i.jg ; 2 uses
...
bb.bu:                                            ; preds = %bb.bt
  %9 = load <8 x i8>, ptr %i.jt, align 1, !tbaa !34
  %10 = xor <8 x i8> %9, splat (i8 -1)
...
_ZN6duckdb12_GLOBAL__N_123SortKeyConstantOperatorImE6DecodeEPKhRNS_6VectorERmb.exit.i: ; preds = %bb.bv, %bb.bu
  %.0.copyload.i.i8.sink.i.i182 = phi i64 [ %.0.copyload.i.i8.i.i181, %bb.bv ], [ %11, %bb.bu ]
...
bb.cd:                                            ; preds = %bb.ca
  %i.lb = getelementptr inbounds nuw i8, ptr %i.kj, i64 %i.ko ; 2 uses
...
bb.ce:                                            ; preds = %bb.cd
  %12 = load <8 x i8>, ptr %i.lb, align 1, !tbaa !34
  %13 = xor <8 x i8> %12, splat (i8 -1)
...
_ZN6duckdb12_GLOBAL__N_123SortKeyConstantOperatorIlE6DecodeEPKhRNS_6VectorERlb.exit.i: ; preds = %bb.cf, %bb.ce
  %.0.copyload.i.i.i8.sink.i.i200 = phi i64 [ %.0.copyload.i.i.i8.i.i199, %bb.cf ], [ %14, %bb.ce ]
...
bb.cz:                                            ; preds = %bb.cw
  %i.oe = getelementptr inbounds nuw i8, ptr %i.nm, i64 %i.nr ; 2 uses
...
bb.da:                                            ; preds = %bb.cz
  %15 = load <8 x i8>, ptr %i.oe, align 1, !tbaa !34
  %16 = xor <8 x i8> %15, splat (i8 -1)
  %17 = bitcast <8 x i8> %16 to i64
  %i.oi = tail call noundef i64 @llvm.bswap.i64(i64 %17) ; 4 uses
...
bb.dl:                                            ; preds = %bb.di
  %i.pu = getelementptr inbounds nuw i8, ptr %i.pc, i64 %i.ph ; 5 uses
...
bb.dm:                                            ; preds = %bb.dl
  ...
  %18 = load <8 x i8>, ptr %i.py, align 1, !tbaa !34
  %19 = xor <8 x i8> %18, splat (i8 -1)
  %20 = bitcast <8 x i8> %19 to i64
  %.sroa.0.0.insert.insert.i.i6.i.i.i = xor i64 %20, 128
...
bb.dv:                                            ; preds = %bb.ds
  %i.rp = getelementptr inbounds nuw i8, ptr %i.qx, i64 %i.rc ; 4 uses
...
bb.dw:                                            ; preds = %bb.dv
  %21 = load <8 x i8>, ptr %i.rp, align 1, !tbaa !34
  %22 = xor <8 x i8> %21, splat (i8 -1)
  %23 = bitcast <8 x i8> %22 to i64
  %i.rt = getelementptr inbounds nuw i8, ptr %i.rp, i64 8
  %24 = load <8 x i8>, ptr %i.rt, align 1, !tbaa !34
  %25 = xor <8 x i8> %24, splat (i8 -1)
  %26 = bitcast <8 x i8> %25 to i64
  %i.ru = tail call noundef i64 @llvm.bswap.i64(i64 %23)
...
_ZN6duckdb12_GLOBAL__N_123SortKeyConstantOperatorINS_10uhugeint_tEE6DecodeEPKhRNS_6VectorERS2_b.exit.i: ; preds = %bb.dx, %bb.dw
  %.0.copyload.i.i2.i11.sink.i.i = phi i64 [ %.0.copyload.i.i2.i11.i.i, %bb.dx ], [ %26, %bb.dw ]
...
bb.ef:                                            ; preds = %bb.ec
  %i.tb = getelementptr inbounds nuw i8, ptr %i.sj, i64 %i.so ; 4 uses
...
bb.eg:                                            ; preds = %bb.ef
  %27 = load <8 x i8>, ptr %i.tb, align 1, !tbaa !34
  %28 = xor <8 x i8> %27, splat (i8 -1)
  %29 = bitcast <8 x i8> %28 to i64
  %i.tf = getelementptr inbounds nuw i8, ptr %i.tb, i64 8
  %30 = load <8 x i8>, ptr %i.tf, align 1, !tbaa !34
  %31 = xor <8 x i8> %30, splat (i8 -1)
  %32 = bitcast <8 x i8> %31 to i64
  %.sroa.0.0.insert.insert.i.i.i.i.i360 = xor i64 %29, 128
...
_ZN6duckdb12_GLOBAL__N_123SortKeyConstantOperatorINS_9hugeint_tEE6DecodeEPKhRNS_6VectorERS2_b.exit.i: ; preds = %bb.eh, %bb.eg
  %.0.copyload.i.i.i12.sink.i.i = phi i64 [ %.0.copyload.i.i.i12.i.i, %bb.eh ], [ %32, %bb.eg ]
