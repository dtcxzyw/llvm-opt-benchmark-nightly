...
bb.b:                                             ; preds = %bb.c, %bb.a
  %.0377 = phi i64 [ %2, %bb.a ], [ %i.n, %bb.c ] ; 37 uses
...
bb.j:                                             ; preds = %.lr.ph1298, %.lr.ph1298, %.lr.ph1298, %.lr.ph1298, %.lr.ph1298, %.lr.ph1298
  %i.an = add nuw i64 %i.ak, 1                    ; 4 uses
  store i64 %i.an, ptr %i.a, align 8, !tbaa !14
  %49 = icmp ult i64 %i.an, %.0377
  br i1 %49, label %.lr.ph1298, label %.critedge, !llvm.loop !521

.critedge:                                        ; preds = %bb.j, %.lr.ph1298, %.preheader
  %.lcssa = phi i64 [ %.promoted1297, %.preheader ], [ %i.ak, %.lr.ph1298 ], [ %i.an, %bb.j ]
...
_ZN6duckdb10StringUtil16CharacterIsSpaceEc.exit496: ; preds = %.lr.ph, %.lr.ph, %.lr.ph, %.lr.ph, %.lr.ph, %.lr.ph
  ...
  %50 = icmp ult i64 %storemerge, %.0377
  br i1 %50, label %.lr.ph, label %.critedge10, !llvm.loop !528
...
bb.eu:                                            ; preds = %.lr.ph1256, %.lr.ph1256, %.lr.ph1256, %.lr.ph1256, %.lr.ph1256, %.lr.ph1256
  %i.zb = add nuw i64 %i.yy, 1                    ; 4 uses
  store i64 %i.zb, ptr %i.a, align 8, !tbaa !14
  %51 = icmp ult i64 %i.zb, %.0377
  br i1 %51, label %.lr.ph1256, label %.critedge31, !llvm.loop !540

.critedge31:                                      ; preds = %bb.eu, %.lr.ph1256, %.preheader686
  %.promoted1260 = phi i64 [ %.promoted, %.preheader686 ], [ %i.yy, %.lr.ph1256 ], [ %i.zb, %bb.eu ] ; 6 uses
...
bb.ev:                                            ; preds = %switch.early.test.i, %switch.early.test.i, %switch.early.test.i, %switch.early.test.i, %.lr.ph1261
  %i.zm = add nuw i64 %i.ze, 1                    ; 4 uses
  store i64 %i.zm, ptr %i.a, align 8, !tbaa !14
  %52 = icmp ult i64 %i.zm, %.0377
  br i1 %52, label %.lr.ph1261, label %.critedge33, !llvm.loop !541

.critedge33:                                      ; preds = %bb.ev, %switch.early.test.i
  %.lcssa702 = phi i64 [ %i.ze, %switch.early.test.i ], [ %i.zm, %bb.ev ] ; 2 uses
  %.not479 = icmp samesign eq i64 %.lcssa702, %.promoted1260
  br i1 %.not479, label %.thread633, label %bb.ew

.thread633:                                       ; preds = %.critedge31, %.critedge33
  ...
  call void @_ZN6duckdb12optional_idxC2Em(ptr noundef nonnull align 8 dereferenceable(8) %42, i64 noundef %.promoted1260)
...
bb.fd:                                            ; preds = %.lr.ph1293, %.lr.ph1293, %.lr.ph1293, %.lr.ph1293, %.lr.ph1293, %.lr.ph1293
  %i.aad = add nuw i64 %i.aaa, 1                  ; 4 uses
  store i64 %i.aad, ptr %i.a, align 8, !tbaa !14
  %53 = icmp ult i64 %i.aad, %.0377
  br i1 %53, label %.lr.ph1293, label %.critedge35, !llvm.loop !543

.critedge35:                                      ; preds = %bb.fd, %.lr.ph1293, %.preheader678
  %.lcssa697 = phi i64 [ %.promoted1292, %.preheader678 ], [ %i.aaa, %.lr.ph1293 ], [ %i.aad, %bb.fd ]
