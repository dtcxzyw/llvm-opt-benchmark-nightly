...
.lr.ph:                                           ; preds = %bb.q, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit141
  %.sroa.0193.0288 = phi ptr [ %i.ho, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit141 ], [ %i.cs, %bb.q ] ; 3 uses
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.0193.0288) ]
...
begin_hunk_1_@_ZN6duckdbL20PragmaImportDatabaseB5cxx11ERNS_13ClientContextERKNS_18FunctionParametersE:._crit_edge.i.i
  ...
  %i.fb = load ptr, ptr %2, align 8, !tbaa !358   ; 4 uses
...
.lr.ph:                                           ; preds = %bb.a, %bb.c
  ...
  %.sroa.08.015 = phi ptr [ %i.p, %bb.c ], [ %0, %bb.a ] ; 8 uses
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.08.015) ]
