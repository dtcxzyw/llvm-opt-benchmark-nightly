...
.lr.ph98.i._crit_edge:                            ; preds = %.lr.ph98.i, %.lr.ph98.preheader.i
  ...
  %i.dw = tail call range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %.16797.i.lcssa, i1 true)
  %8 = xor i32 %i.dw, 31                          ; 2 uses
  %.neg.i63 = shl nsw i32 -1, %8
  %i.dx = add nsw i32 %.neg.i63, %.16797.i.lcssa
  %i.dy = shl i32 %i.dx, 9
  %i.dz = or disjoint i32 %i.dy, %8
  %i.ea = getelementptr inbounds nuw [4 x i8], ptr %i.aq, i64 %.lcssa117
  store i32 %i.dz, ptr %i.ea, align 4, !tbaa !3, !alias.scope !480, !noalias !483
