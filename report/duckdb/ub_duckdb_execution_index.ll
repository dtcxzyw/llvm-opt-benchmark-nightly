...
bb.c:                                             ; preds = %6
  ...
  br i1 %i.j, label %.loopexit, label %6, !llvm.loop !100
...
begin_hunk_2_@_ZN6duckdb18FixedSizeAllocator4FreeENS_12IndexPointerE:bb.a
  ...
  br i1 %i.q, label %.loopexit, label %7

7:                                                ; preds = %bb.d
  %8 = load ptr, ptr %i.p, align 8, !tbaa !66     ; 3 uses
  %9 = getelementptr inbounds nuw i8, ptr %8, i64 8
  %10 = load i64, ptr %9, align 8, !tbaa !73
  %11 = icmp eq i64 %i.b, %10
  br i1 %11, label %.loopexit, label %.lr.ph.i.i.i.i

12:                                               ; preds = %.lr.ph.i.i.i.i.a
  %13 = icmp eq i64 %i.b, %i.s
  br i1 %13, label %.loopexit, label %.lr.ph.i.i.i.i, !llvm.loop !77

.lr.ph.i.i.i.i:                                   ; preds = %7, %12
  %.020.i.i.i.i = phi ptr [ %14, %12 ], [ %8, %7 ]
  %14 = load ptr, ptr %.020.i.i.i.i, align 8, !tbaa !66 ; 4 uses
  %.not18.i.i.i.i = icmp eq ptr %14, null
  br i1 %.not18.i.i.i.i, label %.loopexit, label %.lr.ph.i.i.i.i.a

.lr.ph.i.i.i.i.a:                                 ; preds = %.lr.ph.i.i.i.i
  ...
  br i1 %i.u, label %12, label %..loopexit_crit_edge21.i.i.i.i, !llvm.loop !77

..loopexit_crit_edge21.i.i.i.i:                   ; preds = %.lr.ph.i.i.i.i.a
  br label %.loopexit, !llvm.loop !77

.loopexit:                                        ; preds = %.lr.ph.i.i.i.i, %12, %bb.c, %6, %..loopexit_crit_edge21.i.i.i.i, %7, %bb.d
  %.sroa.06.1.i.i = phi ptr [ null, %..loopexit_crit_edge21.i.i.i.i ], [ null, %6 ], [ %8, %7 ], [ null, %bb.d ], [ %.sroa.06.0.i.i, %bb.c ], [ %14, %12 ], [ null, %.lr.ph.i.i.i.i ] ; 6 uses
...
.lr.ph:                                           ; preds = %_ZNSt10_HashtableImSt4pairIKmN6duckdb10unique_ptrINS2_15FixedSizeBufferESt14default_deleteIS4_ELb1EEEESaIS8_ENSt8__detail10_Select1stESt8equal_toImESt4hashImENSA_18_Mod_range_hashingENSA_20_Default_ranged_hashENSA_20_Prime_rehash_policyENSA_17_Hashtable_traitsILb0ELb0ELb1EEEE19_M_allocate_bucketsEm.exit, %bb.h
  ...
  %.02530 = phi ptr [ %i.i, %bb.h ], [ %i.h, %_ZNSt10_HashtableImSt4pairIKmN6duckdb10unique_ptrINS2_15FixedSizeBufferESt14default_deleteIS4_ELb1EEEESaIS8_ENSt8__detail10_Select1stESt8equal_toImESt4hashImENSA_18_Mod_range_hashingENSA_20_Default_ranged_hashENSA_20_Prime_rehash_policyENSA_17_Hashtable_traitsILb0ELb0ELb1EEEE19_M_allocate_bucketsEm.exit ] ; 8 uses
...
bb.e:                                             ; preds = %.lr.ph
  ...
  store ptr %.02530, ptr %i.g, align 8, !tbaa !68
...
bb.f:                                             ; preds = %bb.e
  ...
  store ptr %.02530, ptr %i.q, align 8, !tbaa !76
  br label %bb.h
...
.lr.ph:                                           ; preds = %_ZNSt10_HashtableImmSaImENSt8__detail9_IdentityESt8equal_toImESt4hashImENS1_18_Mod_range_hashingENS1_20_Default_ranged_hashENS1_20_Prime_rehash_policyENS1_17_Hashtable_traitsILb0ELb1ELb1EEEE19_M_allocate_bucketsEm.exit, %bb.h
  %.031 = phi i64 [ %.1, %bb.h ], [ 0, %_ZNSt10_HashtableImmSaImENSt8__detail9_IdentityESt8equal_toImESt4hashImENS1_18_Mod_range_hashingENS1_20_Default_ranged_hashENS1_20_Prime_rehash_policyENS1_17_Hashtable_traitsILb0ELb1ELb1EEEE19_M_allocate_bucketsEm.exit ] ; 2 uses
  %.02530 = phi ptr [ %i.i, %bb.h ], [ %i.h, %_ZNSt10_HashtableImmSaImENSt8__detail9_IdentityESt8equal_toImESt4hashImENS1_18_Mod_range_hashingENS1_20_Default_ranged_hashENS1_20_Prime_rehash_policyENS1_17_Hashtable_traitsILb0ELb1ELb1EEEE19_M_allocate_bucketsEm.exit ] ; 8 uses
  %i.i = load ptr, ptr %.02530, align 8, !tbaa !66 ; 2 uses
  %i.j = getelementptr inbounds nuw i8, ptr %.02530, i64 8
  %i.k = load i64, ptr %i.j, align 8, !tbaa !73
  %i.l = urem i64 %i.k, %1                        ; 3 uses
...
bb.e:                                             ; preds = %.lr.ph
  ...
  store ptr %i.o, ptr %.02530, align 8, !tbaa !66
  store ptr %.02530, ptr %i.g, align 8, !tbaa !65
  store ptr %i.g, ptr %i.m, align 8, !tbaa !76
  %i.p = load ptr, ptr %.02530, align 8, !tbaa !66
  %.not28 = icmp eq ptr %i.p, null
  br i1 %.not28, label %bb.h, label %bb.f
...
begin_hunk_8_@_ZNSt10_HashtableImmSaImENSt8__detail9_IdentityESt8equal_toImESt4hashImENS1_18_Mod_range_hashingENS1_20_Default_ranged_hashENS1_20_Prime_rehash_policyENS1_17_Hashtable_traitsILb0ELb1ELb1EEEE8_M_eraseESt17integral_constantIbLb1EERKm:bb.a
  ...
  %.0206270 = phi ptr [ %i.w, %.loopexit.thread ], [ %.020, %bb.h ] ; 2 uses
...
._crit_edge.i.i:                                  ; preds = %.loopexit.thread, %bb.j, %bb.h
  ...
  %.1206271 = phi ptr [ %i.w, %.loopexit.thread ], [ %.0206270, %bb.j ], [ %.020, %bb.h ]
  %.0166568 = phi ptr [ %i.x, %.loopexit.thread ], [ %.1206270, %bb.j ], [ %.120, %bb.h ]
...
bb.o:                                             ; preds = %bb.n
  ...
  store ptr %.020, ptr %i.bf, align 8, !tbaa !76
...
_ZNSt10_HashtableImmSaImENSt8__detail9_IdentityESt8equal_toImESt4hashImENS1_18_Mod_range_hashingENS1_20_Default_ranged_hashENS1_20_Prime_rehash_policyENS1_17_Hashtable_traitsILb0ELb1ELb1EEEE8_M_eraseEmPNS1_15_Hash_node_baseEPNS1_10_Hash_nodeImLb0EEE.exit: ; preds = %bb.i, %bb.l, %bb.m, %bb.n, %bb.o
  %.01664 = phi ptr [ %.1206270, %bb.i ], [ %.0166568, %bb.l ], [ %.120, %bb.m ], [ %.120, %bb.n ], [ %.120, %bb.o ] ; 2 uses
  %.12061 = phi ptr [ %.0206270, %bb.i ], [ %.1206271, %bb.l ], [ %.020, %bb.m ], [ %.020, %bb.n ], [ %.020, %bb.o ]
  %i.bg = load ptr, ptr %.01664, align 8, !tbaa !66
  store ptr %i.bg, ptr %.12061, align 8, !tbaa !66
  tail call void @_ZdlPv(ptr noundef nonnull %.01664) #28
...
begin_hunk_11_@_ZNSt10_HashtableImSt4pairIKmN6duckdb10unique_ptrINS2_15FixedSizeBufferESt14default_deleteIS4_ELb1EEEESaIS8_ENSt8__detail10_Select1stESt8equal_toImESt4hashImENSA_18_Mod_range_hashingENSA_20_Default_ranged_hashENSA_20_Prime_rehash_policyENSA_17_Hashtable_traitsILb0ELb0ELb1EEEE8_M_eraseESt17integral_constantIbLb1EERS1_:bb.a
  ...
  %.020 = phi ptr [ %.01115.i.lcssa, %_ZNSt10_HashtableImSt4pairIKmN6duckdb10unique_ptrINS2_15FixedSizeBufferESt14default_deleteIS4_ELb1EEEESaIS8_ENSt8__detail10_Select1stESt8equal_toImESt4hashImENSA_18_Mod_range_hashingENSA_20_Default_ranged_hashENSA_20_Prime_rehash_policyENSA_17_Hashtable_traitsILb0ELb0ELb1EEEE19_M_find_before_nodeERS1_.exit ], [ %.020.i, %bb.f ] ; 7 uses
...
begin_hunk_12_@_ZNSt10_HashtableImSt4pairIKmN6duckdb10unique_ptrINS2_15FixedSizeBufferESt14default_deleteIS4_ELb1EEEESaIS8_ENSt8__detail10_Select1stESt8equal_toImESt4hashImENSA_18_Mod_range_hashingENSA_20_Default_ranged_hashENSA_20_Prime_rehash_policyENSA_17_Hashtable_traitsILb0ELb0ELb1EEEE8_M_eraseESt17integral_constantIbLb1EERS1_:bb.a
  ...
  %i.ap = phi ptr [ %i.w, %.loopexit.thread ], [ %i.aj, %bb.h ] ; 2 uses
  %i.aq = phi ptr [ %i.u, %.loopexit.thread ], [ %i.ak, %bb.h ]
  %.0206371 = phi ptr [ %i.w, %.loopexit.thread ], [ %.020, %bb.h ] ; 2 uses
...
._crit_edge.i.i:                                  ; preds = %.loopexit.thread, %bb.j, %bb.h
  %i.ax = phi ptr [ %i.w, %.loopexit.thread ], [ %i.ap, %bb.j ], [ %i.aj, %bb.h ]
  %.1206372 = phi ptr [ %i.w, %.loopexit.thread ], [ %.0206371, %bb.j ], [ %.020, %bb.h ]
  %.0166669 = phi ptr [ %i.x, %.loopexit.thread ], [ %.1206371, %bb.j ], [ %.120, %bb.h ]
  %i.ay = phi ptr [ %i.ab, %.loopexit.thread ], [ %i.ar, %bb.j ], [ %i.an, %bb.h ]
  %i.az = phi ptr [ null, %.loopexit.thread ], [ %i.as, %bb.j ], [ null, %bb.h ]
  %i.ba = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
end_hunk_13
...
_ZNSt10_HashtableImSt4pairIKmN6duckdb10unique_ptrINS2_15FixedSizeBufferESt14default_deleteIS4_ELb1EEEESaIS8_ENSt8__detail10_Select1stESt8equal_toImESt4hashImENSA_18_Mod_range_hashingENSA_20_Default_ranged_hashENSA_20_Prime_rehash_policyENSA_17_Hashtable_traitsILb0ELb0ELb1EEEE22_M_remove_bucket_beginEmPNSA_10_Hash_nodeIS8_Lb0EEEm.exit.i: ; preds = %bb.o, %bb.n, %bb.m, %bb.l, %bb.i
  %.01665 = phi ptr [ %.120, %bb.o ], [ %.120, %bb.n ], [ %.120, %bb.m ], [ %.0166669, %bb.l ], [ %.1206371, %bb.i ] ; 3 uses
  %.12062 = phi ptr [ %.020, %bb.o ], [ %.020, %bb.n ], [ %.020, %bb.m ], [ %.1206372, %bb.l ], [ %.0206371, %bb.i ]
  %i.bg = load ptr, ptr %.01665, align 8, !tbaa !66
  store ptr %i.bg, ptr %.12062, align 8, !tbaa !66
  %i.bh = getelementptr inbounds nuw i8, ptr %.01665, i64 16
...
_ZNSt10_HashtableImSt4pairIKmN6duckdb10unique_ptrINS2_15FixedSizeBufferESt14default_deleteIS4_ELb1EEEESaIS8_ENSt8__detail10_Select1stESt8equal_toImESt4hashImENSA_18_Mod_range_hashingENSA_20_Default_ranged_hashENSA_20_Prime_rehash_policyENSA_17_Hashtable_traitsILb0ELb0ELb1EEEE8_M_eraseEmPNSA_15_Hash_node_baseEPNSA_10_Hash_nodeIS8_Lb0EEE.exit: ; preds = %_ZNSt10_HashtableImSt4pairIKmN6duckdb10unique_ptrINS2_15FixedSizeBufferESt14default_deleteIS4_ELb1EEEESaIS8_ENSt8__detail10_Select1stESt8equal_toImESt4hashImENSA_18_Mod_range_hashingENSA_20_Default_ranged_hashENSA_20_Prime_rehash_policyENSA_17_Hashtable_traitsILb0ELb0ELb1EEEE22_M_remove_bucket_beginEmPNSA_10_Hash_nodeIS8_Lb0EEEm.exit.i, %_ZNKSt14default_deleteIN6duckdb15FixedSizeBufferEEclEPS1_.exit.i.i.i.i
  tail call void @_ZdlPv(ptr noundef nonnull %.01665) #28
