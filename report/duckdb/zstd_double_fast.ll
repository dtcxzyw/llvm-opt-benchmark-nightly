...
_ZN11duckdb_zstdL13ZSTD_wildcopyEPvPKvlNS_14ZSTD_overlap_eE.exit.i40.i: ; preds = %bb.n, %bb.l, %bb.k
  %.014.i.i = phi ptr [ %.0379.i245.i, %bb.k ], [ %i.cj, %bb.l ], [ %i.cj, %bb.n ] ; 8 uses
  %.0.i41.i = phi ptr [ %i.er, %bb.k ], [ %i.ff, %bb.l ], [ %i.ff, %bb.n ] ; 6 uses
  %i.fm = icmp ult ptr %.014.i.i, %i.eh
  br i1 %i.fm, label %iter.check1583, label %_ZN11duckdb_zstdL13ZSTD_wildcopyEPvPKvlNS_14ZSTD_overlap_eE.exit.i.i

iter.check1583:                                   ; preds = %_ZN11duckdb_zstdL13ZSTD_wildcopyEPvPKvlNS_14ZSTD_overlap_eE.exit.i40.i
  %.014.i.i1563 = ptrtoaddr ptr %.014.i.i to i64
  %.0.i41.i1562 = ptrtoaddr ptr %.0.i41.i to i64
  %.014.i.i1565 = ptrtoint ptr %.014.i.i to i64
  %i.fn = add i64 %i.dl, 1
  %i.fo = sub i64 %i.fn, %.014.i.i1565            ; 7 uses
  %min.iters.check1566 = icmp ult i64 %i.fo, 4
  %i.fp = sub i64 %.014.i.i1563, %.0.i41.i1562
  %diff.check1564 = icmp ugt i64 %i.fp, -32
  %or.cond = select i1 %min.iters.check1566, i1 true, i1 %diff.check1564
  br i1 %or.cond, label %.lr.ph.i.i.preheader, label %vector.main.loop.iter.check1567

vector.main.loop.iter.check1567:                  ; preds = %iter.check1583
  %min.iters.check1568 = icmp ult i64 %i.fo, 32
  br i1 %min.iters.check1568, label %vec.epilog.ph1587, label %vector.ph1569
...
_ZN11duckdb_zstdL13ZSTD_wildcopyEPvPKvlNS_14ZSTD_overlap_eE.exit479.i.i: ; preds = %bb.cb, %.lr.ph.i114.i.prol.loopexit, %.lr.ph.i114.i, %middle.block1618, %vec.epilog.middle.block1635, %_ZN11duckdb_zstdL13ZSTD_wildcopyEPvPKvlNS_14ZSTD_overlap_eE.exit.i111.i, %bb.bz
...
_ZN11duckdb_zstdL13ZSTD_wildcopyEPvPKvlNS_14ZSTD_overlap_eE.exit.i40.i254: ; preds = %bb.db, %bb.cz, %bb.cy
  %.014.i.i255 = phi ptr [ %.0379.i245.i42, %bb.cy ], [ %i.xd, %bb.cz ], [ %i.xd, %bb.db ] ; 8 uses
  %.0.i41.i256 = phi ptr [ %i.zj, %bb.cy ], [ %i.zx, %bb.cz ], [ %i.zx, %bb.db ] ; 6 uses
  %i.aae = icmp ult ptr %.014.i.i255, %i.yz
  br i1 %i.aae, label %iter.check1427, label %_ZN11duckdb_zstdL13ZSTD_wildcopyEPvPKvlNS_14ZSTD_overlap_eE.exit.i.i245

iter.check1427:                                   ; preds = %_ZN11duckdb_zstdL13ZSTD_wildcopyEPvPKvlNS_14ZSTD_overlap_eE.exit.i40.i254
  %.014.i.i2551407 = ptrtoaddr ptr %.014.i.i255 to i64
  %.0.i41.i2561406 = ptrtoaddr ptr %.0.i41.i256 to i64
  %.014.i.i2551409 = ptrtoint ptr %.014.i.i255 to i64
  %i.aaf = add i64 %i.yd, 1
  %i.aag = sub i64 %i.aaf, %.014.i.i2551409       ; 7 uses
  %min.iters.check1410 = icmp ult i64 %i.aag, 4
  %i.aah = sub i64 %.014.i.i2551407, %.0.i41.i2561406
  %diff.check1408 = icmp ugt i64 %i.aah, -32
  %or.cond1640 = select i1 %min.iters.check1410, i1 true, i1 %diff.check1408
  br i1 %or.cond1640, label %.lr.ph.i.i257.preheader, label %vector.main.loop.iter.check1411

vector.main.loop.iter.check1411:                  ; preds = %iter.check1427
  %min.iters.check1412 = icmp ult i64 %i.aag, 32
  br i1 %min.iters.check1412, label %vec.epilog.ph1431, label %vector.ph1413
...
_ZN11duckdb_zstdL13ZSTD_wildcopyEPvPKvlNS_14ZSTD_overlap_eE.exit479.i.i116: ; preds = %bb.fp, %.lr.ph.i114.i128.prol.loopexit, %.lr.ph.i114.i128, %middle.block1462, %vec.epilog.middle.block1479, %_ZN11duckdb_zstdL13ZSTD_wildcopyEPvPKvlNS_14ZSTD_overlap_eE.exit.i111.i125, %bb.fn
...
_ZN11duckdb_zstdL13ZSTD_wildcopyEPvPKvlNS_14ZSTD_overlap_eE.exit.i40.i498: ; preds = %bb.gp, %bb.gn, %bb.gm
  %.014.i.i499 = phi ptr [ %.0379.i245.i281, %bb.gm ], [ %i.ars, %bb.gn ], [ %i.ars, %bb.gp ] ; 8 uses
...
iter.check:                                       ; preds = %_ZN11duckdb_zstdL13ZSTD_wildcopyEPvPKvlNS_14ZSTD_overlap_eE.exit.i40.i498
  %.014.i.i4991350 = ptrtoaddr ptr %.014.i.i499 to i64
  %.0.i41.i5001349 = ptrtoaddr ptr %.0.i41.i500 to i64
  %.014.i.i4991351 = ptrtoint ptr %.014.i.i499 to i64
  %i.auu = add i64 %i.ass, 1
  %i.auv = sub i64 %i.auu, %.014.i.i4991351       ; 7 uses
  %min.iters.check = icmp ult i64 %i.auv, 4
  %i.auw = sub i64 %.014.i.i4991350, %.0.i41.i5001349
  %diff.check = icmp ugt i64 %i.auw, -32
  %or.cond1642 = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond1642, label %.lr.ph.i.i501.preheader, label %vector.main.loop.iter.check

vector.main.loop.iter.check:                      ; preds = %iter.check
  %min.iters.check1352 = icmp ult i64 %i.auv, 32
  br i1 %min.iters.check1352, label %vec.epilog.ph, label %vector.ph
...
_ZN11duckdb_zstdL13ZSTD_wildcopyEPvPKvlNS_14ZSTD_overlap_eE.exit479.i.i357: ; preds = %bb.jd, %.lr.ph.i114.i369.prol.loopexit, %.lr.ph.i114.i369, %middle.block1384, %vec.epilog.middle.block1401, %_ZN11duckdb_zstdL13ZSTD_wildcopyEPvPKvlNS_14ZSTD_overlap_eE.exit.i111.i366, %bb.jb
...
_ZN11duckdb_zstdL13ZSTD_wildcopyEPvPKvlNS_14ZSTD_overlap_eE.exit.i40.i742: ; preds = %bb.kd, %bb.kb, %bb.ka
  %.014.i.i743 = phi ptr [ %.0379.i245.i525, %bb.ka ], [ %i.bmh, %bb.kb ], [ %i.bmh, %bb.kd ] ; 8 uses
  %.0.i41.i744 = phi ptr [ %i.bon, %bb.ka ], [ %i.bpb, %bb.kb ], [ %i.bpb, %bb.kd ] ; 6 uses
  %i.bpi = icmp ult ptr %.014.i.i743, %i.bod
  br i1 %i.bpi, label %iter.check1505, label %_ZN11duckdb_zstdL13ZSTD_wildcopyEPvPKvlNS_14ZSTD_overlap_eE.exit.i.i733

iter.check1505:                                   ; preds = %_ZN11duckdb_zstdL13ZSTD_wildcopyEPvPKvlNS_14ZSTD_overlap_eE.exit.i40.i742
  %.014.i.i7431485 = ptrtoaddr ptr %.014.i.i743 to i64
  %.0.i41.i7441484 = ptrtoaddr ptr %.0.i41.i744 to i64
  %.014.i.i7431487 = ptrtoint ptr %.014.i.i743 to i64
  %i.bpj = add i64 %i.bnh, 1
  %i.bpk = sub i64 %i.bpj, %.014.i.i7431487       ; 7 uses
  %min.iters.check1488 = icmp ult i64 %i.bpk, 4
  %i.bpl = sub i64 %.014.i.i7431485, %.0.i41.i7441484
  %diff.check1486 = icmp ugt i64 %i.bpl, -32
  %or.cond1644 = select i1 %min.iters.check1488, i1 true, i1 %diff.check1486
  br i1 %or.cond1644, label %.lr.ph.i.i745.preheader, label %vector.main.loop.iter.check1489

vector.main.loop.iter.check1489:                  ; preds = %iter.check1505
  %min.iters.check1490 = icmp ult i64 %i.bpk, 32
  br i1 %min.iters.check1490, label %vec.epilog.ph1509, label %vector.ph1491
