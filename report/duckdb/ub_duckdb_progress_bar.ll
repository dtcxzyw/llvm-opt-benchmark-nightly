...
_ZNK6duckdb12BaseProfilerINSt6chrono3_V212steady_clockEE7ElapsedEv.exit: ; preds = %bb.d, %bb.e
  ...
  %2 = sitofp i64 %i.q to double
  %3 = uitofp i64 %i.s to double
  %i.t = insertelement <2 x double> poison, double %2, i64 0
  %i.u = insertelement <2 x double> %i.t, double %3, i64 1
...
_ZNK6duckdb12BaseProfilerINSt6chrono3_V212steady_clockEE7ElapsedEv.exit.i: ; preds = %bb.m, %bb.l
  ...
  %3 = sitofp i64 %i.as to double
  %4 = uitofp i64 %i.au to double
  %i.av = insertelement <2 x double> poison, double %3, i64 0
  %i.aw = insertelement <2 x double> %i.av, double %4, i64 1
