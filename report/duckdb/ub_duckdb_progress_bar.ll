...
.noexc:                                           ; preds = %bb.c
  ...
  %i.bf = getelementptr inbounds nuw i8, ptr %19, i64 8 ; 11 uses
  store ptr %i.be, ptr %i.bf, align 8, !tbaa !166
...
.noexc:                                           ; preds = %bb.b
  ...
  %i.cu = getelementptr inbounds nuw i8, ptr %34, i64 8 ; 12 uses
  store ptr %i.ct, ptr %i.cu, align 8, !tbaa !166
