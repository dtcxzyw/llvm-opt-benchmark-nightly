...
_ZN10duckdb_hllL6sdslenEPc.exit:                  ; preds = %bb.g, %bb.h, %bb.i, %bb.j, %bb.k, %bb.l
  %.0.i17 = phi i64 [ %i.ae, %bb.l ], [ %i.t, %bb.h ], [ %i.w, %bb.i ], [ %i.z, %bb.j ], [ %i.ac, %bb.k ], [ 0, %bb.g ]
  %i.af = sub i64 %2, %.0.i17
  %i.ag = tail call noundef ptr @_ZN10duckdb_hll14sdsMakeRoomForEPcm(ptr noundef nonnull %0, i64 noundef %i.af) ; 3 uses
  %i.ah = icmp eq ptr %i.ag, null
  br i1 %i.ah, label %_ZN10duckdb_hllL9sdssetlenEPcm.exit, label %_ZN10duckdb_hllL6sdslenEPc.exit._crit_edge

_ZN10duckdb_hllL6sdslenEPc.exit._crit_edge:       ; preds = %_ZN10duckdb_hllL6sdslenEPc.exit
  %.phi.trans.insert = getelementptr inbounds i8, ptr %i.ag, i64 -1
  %.pre = load i8, ptr %.phi.trans.insert, align 1, !tbaa !21
  br label %bb.m

bb.m:                                             ; preds = %_ZN10duckdb_hllL6sdslenEPc.exit._crit_edge, %_ZN10duckdb_hllL8sdsallocEPc.exit
  %i.ai = phi i8 [ %.pre, %_ZN10duckdb_hllL6sdslenEPc.exit._crit_edge ], [ %i.b, %_ZN10duckdb_hllL8sdsallocEPc.exit ]
  %.014 = phi ptr [ %i.ag, %_ZN10duckdb_hllL6sdslenEPc.exit._crit_edge ], [ %0, %_ZN10duckdb_hllL8sdsallocEPc.exit ] ; 13 uses
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %.014, ptr align 1 %1, i64 %2, i1 false)
  %i.aj = getelementptr inbounds nuw i8, ptr %.014, i64 %2
...
bb.n:                                             ; preds = %bb.m
  %i.al = getelementptr inbounds i8, ptr %.014, i64 -1
...
bb.o:                                             ; preds = %bb.m
  %i.an = trunc i64 %2 to i8
  %i.ao = getelementptr inbounds i8, ptr %.014, i64 -4
  store i8 %i.an, ptr %i.ao, align 1, !tbaa !7
  br label %_ZN10duckdb_hllL9sdssetlenEPcm.exit

bb.p:                                             ; preds = %bb.m
  %i.ap = trunc i64 %2 to i16
  %i.aq = getelementptr inbounds i8, ptr %.014, i64 -6
...
; Function Attrs: mustprogress nounwind willreturn memory(readwrite, target_mem: none) uwtable
define noundef ptr @_ZN10duckdb_hll6sdscpyEPcPKc(ptr noundef captures(address, ret: address, provenance) %0, ptr noundef readonly captures(none) %1) local_unnamed_addr #9 {
bb.a:
...
define noundef ptr @_ZN10duckdb_hll13sdscatvprintfEPcPKcP13__va_list_tag(ptr noundef captures(address, ret: address, provenance) %0, ptr noundef readonly captures(none) %1, ptr noundef %2) local_unnamed_addr #14 {
bb.a:
...
end_hunk_2
begin_hunk_3_@_ZN10duckdb_hll10sdstolowerEPc:bb.a
  %i.m = getelementptr inbounds i8, ptr %0, i64 -10
  %i.n = load i32, ptr %i.m, align 1, !tbaa !14
  %i.o = zext i32 %i.n to i64
  br label %_ZN10duckdb_hllL6sdslenEPc.exit
...
.lr.ph:                                           ; preds = %_ZN10duckdb_hllL6sdslenEPc.exit, %.lr.ph
  %.07 = phi i64 [ %i.w, %.lr.ph ], [ 0, %_ZN10duckdb_hllL6sdslenEPc.exit ] ; 2 uses
  %i.r = getelementptr inbounds nuw i8, ptr %0, i64 %.07 ; 2 uses
  %i.s = load i8, ptr %i.r, align 1, !tbaa !21
  %i.t = sext i8 %i.s to i32
  %i.u = tail call i32 @tolower(i32 noundef %i.t) #28
  %i.v = trunc i32 %i.u to i8
  store i8 %i.v, ptr %i.r, align 1, !tbaa !21
  %i.w = add nuw i64 %.07, 1                      ; 2 uses
...
define void @_ZN10duckdb_hll10sdstoupperEPc(ptr noundef captures(none) %0) local_unnamed_addr #17 {
bb.a:
  %i.a = getelementptr inbounds i8, ptr %0, i64 -1
  %i.b = load i8, ptr %i.a, align 1, !tbaa !21
  %i.c = zext i8 %i.b to i32                      ; 2 uses
...
.lr.ph:                                           ; preds = %_ZN10duckdb_hllL6sdslenEPc.exit, %.lr.ph
  ...
  %i.s = load i8, ptr %i.r, align 1, !tbaa !21
  %i.t = sext i8 %i.s to i32
  %i.u = tail call i32 @toupper(i32 noundef %i.t) #28
  %i.v = trunc i32 %i.u to i8
  store i8 %i.v, ptr %i.r, align 1, !tbaa !21
  %i.w = add nuw i64 %.07, 1                      ; 2 uses
  %exitcond.not = icmp eq i64 %i.w, %.0.i
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define noundef i32 @_ZN10duckdb_hll6sdscmpEPcS0_(ptr noundef readonly captures(none) %0, ptr noundef readonly captures(none) %1) local_unnamed_addr #11 {
bb.a:
  %i.a = getelementptr inbounds i8, ptr %0, i64 -1
  %i.b = load i8, ptr %i.a, align 1, !tbaa !21
  %i.c = zext i8 %i.b to i32                      ; 2 uses
