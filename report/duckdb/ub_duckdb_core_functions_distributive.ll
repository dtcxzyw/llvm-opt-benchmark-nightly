...
.lr.ph46.us.i.i.new:                              ; preds = %.prol.loopexit56, %.lr.ph46.us.i.i.new
  ...
  %6 = trunc nuw i8 %i.ap to i1
  %7 = or i1 %.not83, %6
  %i.aq = getelementptr inbounds nuw i8, ptr %i.x, i64 %.sroa.4.145.us.i.i
  %8 = getelementptr inbounds nuw i8, ptr %i.aq, i64 3
  %9 = load i8, ptr %8, align 1, !tbaa !358, !range !318, !alias.scope !10829, !noalias !10830, !noundef !319
  ...
  %11 = trunc nuw i8 %i.ax to i1
  %12 = or i1 %10, %11
  %i.ay = getelementptr inbounds nuw i8, ptr %i.x, i64 %.sroa.4.145.us.i.i
  %13 = getelementptr inbounds nuw i8, ptr %i.ay, i64 6
  %14 = load i8, ptr %13, align 1, !tbaa !358, !range !318, !alias.scope !10829, !noalias !10830, !noundef !319
  ...
  %i.bc = or i8 %i.bb, %14
  %15 = icmp ne i8 %i.bc, 0
  %16 = select i1 %15, i1 true, i1 %12
  %17 = select i1 %16, i1 true, i1 %7
  %i.bd = select i1 %17, i8 1, i8 %i.ag           ; 2 uses
...
.lr.ph46.i.i.new:                                 ; preds = %.prol.loopexit, %.lr.ph46.i.i.new
  ...
  %18 = trunc nuw i8 %i.cw to i1
  %19 = or i1 %.not, %18
  %i.cx = getelementptr inbounds nuw i8, ptr %i.x, i64 %.sroa.4.145.i.i
  %20 = getelementptr inbounds nuw i8, ptr %i.cx, i64 3
  %21 = load i8, ptr %20, align 1, !tbaa !358, !range !318, !alias.scope !10829, !noalias !10830, !noundef !319
  ...
  %23 = trunc nuw i8 %i.de to i1
  %24 = or i1 %22, %23
  %i.df = getelementptr inbounds nuw i8, ptr %i.x, i64 %.sroa.4.145.i.i
  %25 = getelementptr inbounds nuw i8, ptr %i.df, i64 6
  %26 = load i8, ptr %25, align 1, !tbaa !358, !range !318, !alias.scope !10829, !noalias !10830, !noundef !319
  ...
  %i.dk = select i1 %29, i8 1, i8 %i.cn           ; 2 uses
...
_ZNK6duckdb15SelectionVector9get_indexEm.exit21.us.i.i: ; preds = %_ZNK6duckdb15SelectionVector9get_indexEm.exit21.us.i.i, %_ZNK6duckdb15SelectionVector9get_indexEm.exit21.us.i.i.preheader.new
  ...
  %30 = trunc nuw i8 %i.fj to i1
  %31 = or i1 %.not85, %30
  %i.fk = getelementptr inbounds nuw i8, ptr %i.eg, i64 %.04.us.i.i
  %32 = getelementptr inbounds nuw i8, ptr %i.fk, i64 3
  %33 = load i8, ptr %32, align 1, !tbaa !358, !range !318, !alias.scope !10832, !noalias !10833, !noundef !319
  ...
  %35 = trunc nuw i8 %i.fr to i1
  %36 = or i1 %34, %35
  %i.fs = getelementptr inbounds nuw i8, ptr %i.eg, i64 %.04.us.i.i
  %37 = getelementptr inbounds nuw i8, ptr %i.fs, i64 6
  %38 = load i8, ptr %37, align 1, !tbaa !358, !range !318, !alias.scope !10832, !noalias !10833, !noundef !319
...
_ZNK6duckdb15SelectionVector9get_indexEm.exit21.i.i: ; preds = %_ZNK6duckdb15SelectionVector9get_indexEm.exit21.i.i, %_ZNK6duckdb15SelectionVector9get_indexEm.exit21.i.i.preheader.new
  ...
  %44 = trunc nuw i8 %i.hm to i1
  %45 = select i1 %44, i1 true, i1 %43
  %i.hn = select i1 %45, i8 1, i8 %i.go           ; 3 uses
