...
@duckdb_je_witness_lock_error = local_unnamed_addr constant ptr @witness_lock_error_impl, align 8
@duckdb_je_witness_owner_error = local_unnamed_addr constant ptr @witness_owner_error_impl, align 8
@duckdb_je_witness_not_owner_error = local_unnamed_addr constant ptr @witness_not_owner_error_impl, align 8
@duckdb_je_witness_depth_error = local_unnamed_addr constant ptr @witness_depth_error_impl, align 8
...
define void @duckdb_je_witness_init(ptr noundef writeonly captures(none) initializes((0, 12), (16, 32)) %0, ptr noundef %1, i32 noundef %2, ptr noundef %3, ptr noundef %4) local_unnamed_addr #0 {
bb.a:
  store ptr %1, ptr %0, align 8, !tbaa !7
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i32 %2, ptr %i.a, align 8, !tbaa !13
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 16
  store ptr %3, ptr %i.b, align 8, !tbaa !14
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 24
  store ptr %4, ptr %i.c, align 8, !tbaa !15
  ret void
}
...
bb.a:
  tail call void (ptr, ...) @duckdb_je_malloc_printf(ptr noundef nonnull @.str) #6
  ...
  tail call void (ptr, ...) @duckdb_je_malloc_printf(ptr noundef nonnull @.str.1, ptr noundef %i.a, i32 noundef %i.c) #6
...
bb.a:
  ...
  %i.c = load i32, ptr %i.b, align 8, !tbaa !13
  tail call void (ptr, ...) @duckdb_je_malloc_printf(ptr noundef nonnull @.str.4, ptr noundef %i.a, i32 noundef %i.c) #6
  tail call void @abort() #7
  unreachable
}
...
bb.a:
  ...
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.c = load i32, ptr %i.b, align 8, !tbaa !13
  tail call void (ptr, ...) @duckdb_je_malloc_printf(ptr noundef nonnull @.str.5, ptr noundef %i.a, i32 noundef %i.c) #6
  tail call void @abort() #7
  unreachable
}
...
bb.a:
  ...
  tail call void (ptr, ...) @duckdb_je_malloc_printf(ptr noundef nonnull @.str.6, i32 noundef %2, ptr noundef nonnull %i.a, i32 noundef %1) #6
  tail call fastcc void @witness_print_witnesses(ptr noundef %0)
  tail call void (ptr, ...) @duckdb_je_malloc_printf(ptr noundef nonnull @.str.9) #6
  tail call void @abort() #7
  unreachable
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define void @duckdb_je_witnesses_cleanup(ptr noundef readnone captures(none) %0) local_unnamed_addr #2 {
bb.a:
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define void @duckdb_je_witness_prefork(ptr noundef readnone captures(none) %0) local_unnamed_addr #2 {
bb.a:
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define void @duckdb_je_witness_postfork_parent(ptr noundef readnone captures(none) %0) local_unnamed_addr #2 {
bb.a:
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define void @duckdb_je_witness_postfork_child(ptr noundef readnone captures(none) %0) local_unnamed_addr #2 {
bb.a:
  ret void
}
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.h = load ptr, ptr %.01524, align 8, !tbaa !7 ; 2 uses
  br i1 %i.g, label %bb.d, label %bb.e

bb.d:                                             ; preds = %bb.c
  tail call void (ptr, ...) @duckdb_je_malloc_printf(ptr noundef nonnull @.str.2, ptr noundef %i.h, i32 noundef %i.e) #6
  br label %witness_print_witness.exit

bb.e:                                             ; preds = %bb.c
  tail call void (ptr, ...) @duckdb_je_malloc_printf(ptr noundef nonnull @.str.3, ptr noundef %i.h, i32 noundef %i.e, i32 noundef %.025) #6
  br label %witness_print_witness.exit
...
select.unfold._crit_edge:                         ; preds = %witness_print_witness.exit
  %i.m = icmp eq i32 %.1, 1
  %i.n = load ptr, ptr %.01623, align 8, !tbaa !7 ; 2 uses
...
bb.g:                                             ; preds = %select.unfold._crit_edge
  tail call void (ptr, ...) @duckdb_je_malloc_printf(ptr noundef nonnull @.str.2, ptr noundef %i.n, i32 noundef %i.p) #6
  br label %witness_print_witness.exit21

bb.h:                                             ; preds = %select.unfold._crit_edge
  tail call void (ptr, ...) @duckdb_je_malloc_printf(ptr noundef nonnull @.str.3, ptr noundef %i.n, i32 noundef %i.p, i32 noundef %.1) #6
  br label %witness_print_witness.exit21
...
!6 = !{!"Simple C/C++ TBAA"}
!7 = !{!8, !9, i64 0}
!8 = !{!"witness_s", !9, i64 0, !4, i64 8, !10, i64 16, !10, i64 24, !11, i64 32}
!9 = !{!"p1 omnipotent char", !10, i64 0}
!10 = !{!"any pointer", !5, i64 0}
!11 = !{!"", !12, i64 0, !12, i64 8}
!12 = !{!"p1 _ZTS9witness_s", !10, i64 0}
!13 = !{!8, !4, i64 8}
!14 = !{!8, !10, i64 16}
!15 = !{!8, !10, i64 24}
!16 = !{!17, !12, i64 0}
