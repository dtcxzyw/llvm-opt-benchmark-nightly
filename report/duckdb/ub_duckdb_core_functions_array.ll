...
.lr.ph.i.epil.preheader:                          ; preds = %._crit_edge.loopexit.i.unr-lcssa, %.lr.ph.i.preheader
  %.01832.i.epil.init = phi float [ 0.000000e+00, %.lr.ph.i.preheader ], [ %i.dy, %._crit_edge.loopexit.i.unr-lcssa ]
  ...
  %i.do = call float @llvm.fmuladd.f32(float %i.dm, float %i.dn, float %.01832.i.epil.init)
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  %.01832.i = phi float [ %i.dy, %.lr.ph.i ], [ 0.000000e+00, %.lr.ph.i.preheader ]
  ...
  %i.dt = call float @llvm.fmuladd.f32(float %i.dq, float %i.ds, float %.01832.i)
...
.lr.ph.i.epil.preheader:                          ; preds = %._crit_edge.loopexit.i.unr-lcssa, %.lr.ph.i.preheader
  ...
  %.02030.i.epil.init.a = phi ptr [ %i.dl, %.lr.ph.i.preheader ], [ %i.dv, %._crit_edge.loopexit.i.unr-lcssa ]
  ...
  call void @llvm.assume(i1 %lcmp.mod218)
  %i.dm = load double, ptr %.02030.i.epil.init.a, align 8, !tbaa !144 ; 2 uses
...
._crit_edge.loopexit.i:                           ; preds = %._crit_edge.loopexit.i.unr-lcssa, %.lr.ph.i.epil.preheader
  ...
  %.lcssa213.a = phi double [ %i.dz, %._crit_edge.loopexit.i.unr-lcssa ], [ %i.do, %.lr.ph.i.epil.preheader ]
  %18 = extractelement <2 x double> %.lcssa213, i64 1
  %i.dp = fmul double %18, %.lcssa213.a
  %19 = extractelement <2 x double> %.lcssa213, i64 0
  br label %bb.al

.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  %.02030.i = phi ptr [ %i.dx, %.lr.ph.i ], [ %i.dk, %.lr.ph.i.preheader ] ; 3 uses
  %.02030.i.a = phi ptr [ %i.dv, %.lr.ph.i ], [ %i.dl, %.lr.ph.i.preheader ] ; 3 uses
  ...
  %niter = phi i64 [ %niter.next.1, %.lr.ph.i ], [ 0, %.lr.ph.i.preheader ]
  %i.dq = getelementptr inbounds nuw i8, ptr %.02030.i.a, i64 8
  %i.dr = load double, ptr %.02030.i.a, align 8, !tbaa !144 ; 2 uses
  ...
  %i.dv = getelementptr inbounds nuw i8, ptr %.02030.i.a, i64 16 ; 2 uses
...
.lr.ph.i.i.epil.preheader:                        ; preds = %._crit_edge.loopexit.i.i.unr-lcssa, %.lr.ph.i.i.preheader
  %.01832.i.i.epil.init = phi float [ 0.000000e+00, %.lr.ph.i.i.preheader ], [ %i.dy, %._crit_edge.loopexit.i.i.unr-lcssa ]
  ...
  %i.do = call float @llvm.fmuladd.f32(float %i.dm, float %i.dn, float %.01832.i.i.epil.init)
  %13 = insertelement <2 x float> poison, float %i.dm, i64 0
  %14 = insertelement <2 x float> %13, float %i.dn, i64 1 ; 2 uses
  %15 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %14, <2 x float> %14, <2 x float> %.epil.init)
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i
  %.01832.i.i = phi float [ %i.dy, %.lr.ph.i.i ], [ 0.000000e+00, %.lr.ph.i.i.preheader ]
  ...
  %i.dt = call float @llvm.fmuladd.f32(float %i.dq, float %i.ds, float %.01832.i.i)
  %18 = insertelement <2 x float> poison, float %i.dq, i64 0
  %19 = insertelement <2 x float> %18, float %i.ds, i64 1 ; 2 uses
  %20 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %19, <2 x float> %19, <2 x float> %17)
...
.lr.ph.i.i.epil.preheader:                        ; preds = %._crit_edge.loopexit.i.i.unr-lcssa, %.lr.ph.i.i.preheader
  ...
  %.02030.i.i.epil.init.a = phi ptr [ %i.dl, %.lr.ph.i.i.preheader ], [ %i.dv, %._crit_edge.loopexit.i.i.unr-lcssa ]
  ...
  call void @llvm.assume(i1 %lcmp.mod217)
  %i.dm = load double, ptr %.02030.i.i.epil.init.a, align 8, !tbaa !144 ; 2 uses
...
._crit_edge.loopexit.i.i:                         ; preds = %._crit_edge.loopexit.i.i.unr-lcssa, %.lr.ph.i.i.epil.preheader
  ...
  %.lcssa212.a = phi double [ %i.dz, %._crit_edge.loopexit.i.i.unr-lcssa ], [ %i.do, %.lr.ph.i.i.epil.preheader ]
  %18 = extractelement <2 x double> %.lcssa212, i64 1
  %i.dp = fmul double %18, %.lcssa212.a
  %19 = extractelement <2 x double> %.lcssa212, i64 0
  br label %bb.al

.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i
  %.02030.i.i = phi ptr [ %i.dx, %.lr.ph.i.i ], [ %i.dk, %.lr.ph.i.i.preheader ] ; 3 uses
  %.02030.i.i.a = phi ptr [ %i.dv, %.lr.ph.i.i ], [ %i.dl, %.lr.ph.i.i.preheader ] ; 3 uses
  ...
  %niter = phi i64 [ %niter.next.1, %.lr.ph.i.i ], [ 0, %.lr.ph.i.i.preheader ]
  %i.dq = getelementptr inbounds nuw i8, ptr %.02030.i.i.a, i64 8
  %i.dr = load double, ptr %.02030.i.i.a, align 8, !tbaa !144 ; 2 uses
  ...
  %i.dv = getelementptr inbounds nuw i8, ptr %.02030.i.i.a, i64 16 ; 2 uses
  %i.dw = load double, ptr %i.dq, align 8, !tbaa !144 ; 2 uses
