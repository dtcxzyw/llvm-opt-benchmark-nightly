...
begin_hunk_1
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %8, ptr noundef nonnull align 8 dereferenceable(32) %21, i64 16, i1 false), !tbaa.struct !32
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.fg, i8 0, i64 16, i1 false)
  %.sroa.0.0.copyload.i.i.pre.i.i = load <2 x i64>, ptr %8, align 16, !tbaa !14
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %8, ptr noundef nonnull align 8 dereferenceable(32) %i.fi, i64 16, i1 false), !tbaa.struct !32
  store <2 x i64> %.sroa.0.0.copyload.i.i.pre.i.i, ptr %i.fi, align 8, !tbaa !14
  ...
  store <2 x ptr> %i.fm, ptr %i.fj, align 16, !tbaa !23
...
begin_hunk_2
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %7, ptr noundef nonnull align 8 dereferenceable(32) %22, i64 16, i1 false), !tbaa.struct !32
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.fu, i8 0, i64 16, i1 false)
  %.sroa.0.0.copyload.i.i.pre.i.i132 = load <2 x i64>, ptr %7, align 16, !tbaa !14
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %7, ptr noundef nonnull align 8 dereferenceable(32) %i.fw, i64 16, i1 false), !tbaa.struct !32
  store <2 x i64> %.sroa.0.0.copyload.i.i.pre.i.i132, ptr %i.fw, align 8, !tbaa !14
  ...
  store <2 x ptr> %i.ga, ptr %i.fx, align 16, !tbaa !23
...
begin_hunk_3
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %6, ptr noundef nonnull align 8 dereferenceable(32) %36, i64 16, i1 false), !tbaa.struct !32
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.nt, i8 0, i64 16, i1 false)
  %.sroa.0.0.copyload.i.i.pre.i.i218 = load <2 x i64>, ptr %6, align 16, !tbaa !14
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %6, ptr noundef nonnull align 8 dereferenceable(32) %i.nv, i64 16, i1 false), !tbaa.struct !32
  store <2 x i64> %.sroa.0.0.copyload.i.i.pre.i.i218, ptr %i.nv, align 8, !tbaa !14
  ...
  store <2 x ptr> %i.nz, ptr %i.nw, align 16, !tbaa !23
...
begin_hunk_4
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %5, ptr noundef nonnull align 8 dereferenceable(32) %37, i64 16, i1 false), !tbaa.struct !32
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.oh, i8 0, i64 16, i1 false)
  %.sroa.0.0.copyload.i.i.pre.i.i226 = load <2 x i64>, ptr %5, align 16, !tbaa !14
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %5, ptr noundef nonnull align 8 dereferenceable(32) %i.oj, i64 16, i1 false), !tbaa.struct !32
  store <2 x i64> %.sroa.0.0.copyload.i.i.pre.i.i226, ptr %i.oj, align 8, !tbaa !14
  ...
  store <2 x ptr> %i.on, ptr %i.ok, align 16, !tbaa !23
...
bb.l:                                             ; preds = %_ZN6duckdb18BaseScalarFunctionaSERKS0_.exit
  ...
  %.sroa.0.0.copyload.i.i.pre.i = load <2 x i64>, ptr %2, align 16, !tbaa !14
...
_ZNSt8functionIFvRN6duckdb9DataChunkERNS0_15ExpressionStateERNS0_6VectorEEEC2EOS8_.exit.i: ; preds = %bb.l, %_ZN6duckdb18BaseScalarFunctionaSERKS0_.exit
  %.sroa.0.0.copyload.i.i.i = phi <2 x i64> [ zeroinitializer, %_ZN6duckdb18BaseScalarFunctionaSERKS0_.exit ], [ %.sroa.0.0.copyload.i.i.pre.i, %bb.l ]
  ...
  store <2 x i64> %.sroa.0.0.copyload.i.i.i, ptr %i.am, align 8, !tbaa !14
  ...
  store <2 x ptr> %i.at, ptr %i.ar, align 16, !tbaa !23
