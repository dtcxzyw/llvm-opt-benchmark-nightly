...
ehooks_pre_reentrancy.exit.i.i.i:                 ; preds = %bb.n, %tsd_fetch_impl.exit.i.i.i.i
  ...
  %i.bd = call ptr %i.bc(ptr noundef nonnull %i.ao, ptr noundef null, i64 noundef %storemerge.i.i.i, i64 noundef 4096, ptr noundef nonnull %i.a, ptr noundef nonnull %i.b, i32 noundef %.val.i.i.i) #9, !inline_history !54 ; 2 uses
...
bb.s:                                             ; preds = %ehooks_alloc.exit.i.i
  ...
  %.val79.i.i = load i32, ptr %i.bp, align 4, !tbaa !55
...
begin_hunk_2_@duckdb_je_ecache_alloc_grow:tsdn_witness_tsdp_get.exit
  ...
  store i64 %i.br, ptr %i.cb, align 8, !tbaa !56
...
begin_hunk_3_@duckdb_je_ecache_alloc_grow:tsdn_witness_tsdp_get.exit
  ...
  %i.ds = load i32, ptr %i.dr, align 4, !tbaa !57
...
ehooks_pre_reentrancy.exit.i:                     ; preds = %bb.f, %tsd_fetch_impl.exit.i.i
  ...
  %i.z = call ptr %i.y(ptr noundef nonnull %i.k, ptr noundef %3, i64 noundef %4, i64 noundef range(i64 0, -4095) %i.i, ptr noundef nonnull %i.a, ptr noundef %7, i32 noundef %.val.i) #9, !inline_history !58 ; 2 uses
...
bb.j:                                             ; preds = %ehooks_alloc.exit
  ...
  %.val33 = load i32, ptr %i.ak, align 4, !tbaa !55
...
begin_hunk_6_@duckdb_je_extent_alloc_wrapper:tsdn_witness_tsdp_get.exit
  ...
  store i64 %i.am, ptr %i.ax, align 8, !tbaa !56
...
bb.e:                                             ; preds = %bb.k, %malloc_mutex_lock.exit
  %.val40 = load ptr, ptr %i.n, align 8, !tbaa !59 ; 2 uses
  %i.t = icmp eq ptr %.val40, null
  br i1 %i.t, label %bb.f, label %bb.g

bb.f:                                             ; preds = %bb.e
  %.val39 = load ptr, ptr %i.p, align 8, !tbaa !59 ; 2 uses
...
ehooks_pre_reentrancy.exit.i.i:                   ; preds = %bb.j, %tsd_fetch_impl.exit.i.i.i
  %i.as = load ptr, ptr %i.ae, align 8, !tbaa !60
  %.val.i.i = load i32, ptr %2, align 8, !tbaa !48
  %i.at = tail call zeroext i1 %i.as(ptr noundef %i.ab, ptr noundef %i.w, i64 noundef range(i64 0, -4095) %i.y, i1 noundef zeroext %i.aa, i32 noundef %.val.i.i) #9, !inline_history !61 ; 2 uses
...
ehooks_pre_reentrancy.exit.i.i52:                 ; preds = %bb.v, %tsd_fetch_impl.exit.i.i.i51
  %i.cf = load ptr, ptr %i.br, align 8, !tbaa !62
  %.val.i.i53 = load i32, ptr %2, align 8, !tbaa !48
  %i.cg = tail call zeroext i1 %i.cf(ptr noundef %i.bo, ptr noundef %i.bn, i64 noundef range(i64 0, -4095) %i.bi, i64 noundef 0, i64 noundef range(i64 0, -4095) %i.bi, i32 noundef %.val.i.i53) #9, !inline_history !63 ; 2 uses
...
bb.aa:                                            ; preds = %.critedge
  ...
  %i.df = load ptr, ptr %i.de, align 8, !tbaa !64
...
ehooks_pre_reentrancy.exit.i:                     ; preds = %bb.ae, %tsd_fetch_impl.exit.i.i
  %i.ds = load ptr, ptr %i.de, align 8, !tbaa !64
  %.val.i55 = load i32, ptr %2, align 8, !tbaa !48
  %i.dt = tail call zeroext i1 %i.ds(ptr noundef %i.db, ptr noundef %i.cz, i64 noundef range(i64 0, -4095) %i.da, i64 noundef 0, i64 noundef %i.da, i32 noundef %.val.i55) #9, !inline_history !65 ; 2 uses
...
bb.ak:                                            ; preds = %bb.ai
  ...
  %i.eo = load ptr, ptr %i.en, align 8, !tbaa !66
...
ehooks_pre_reentrancy.exit.i58:                   ; preds = %bb.ao, %tsd_fetch_impl.exit.i.i57
  %i.fb = load ptr, ptr %i.en, align 8, !tbaa !66
  %.val.i59 = load i32, ptr %2, align 8, !tbaa !48
  %i.fc = tail call zeroext i1 %i.fb(ptr noundef %i.ek, ptr noundef %i.ei, i64 noundef range(i64 0, -4095) %i.ej, i64 noundef 0, i64 noundef %i.ej, i32 noundef %.val.i59) #9, !inline_history !67 ; 0 uses
...
ehooks_pre_reentrancy.exit.i:                     ; preds = %bb.h, %tsd_fetch_impl.exit.i.i
  ...
  %.val.i = load i32, ptr %2, align 8, !tbaa !48
  tail call void %i.ai(ptr noundef %i.s, ptr noundef %i.m, i64 noundef range(i64 0, -4095) %i.o, i1 noundef zeroext %i.q, i32 noundef %.val.i) #9, !inline_history !69
...
ehooks_pre_reentrancy.exit.i:                     ; preds = %bb.f, %tsd_fetch_impl.exit.i.i
  %i.aa = load ptr, ptr %i.m, align 8, !tbaa !70
  %.val.i = load i32, ptr %1, align 8, !tbaa !48
  %i.ab = tail call zeroext i1 %i.aa(ptr noundef %i.j, ptr noundef %i.f, i64 noundef range(i64 0, -4095) %i.h, i64 noundef %3, i64 noundef %4, i32 noundef %.val.i) #9, !inline_history !71 ; 2 uses
...
ehooks_pre_reentrancy.exit.i:                     ; preds = %bb.f, %tsd_fetch_impl.exit.i.i
  %i.aa = load ptr, ptr %i.m, align 8, !tbaa !66
  %.val.i = load i32, ptr %1, align 8, !tbaa !48
  %i.ab = tail call zeroext i1 %i.aa(ptr noundef %i.j, ptr noundef %i.f, i64 noundef range(i64 0, -4095) %i.h, i64 noundef %3, i64 noundef %4, i32 noundef %.val.i) #9, !inline_history !67 ; 2 uses
...
ehooks_pre_reentrancy.exit.i:                     ; preds = %bb.f, %tsd_fetch_impl.exit.i.i
  %i.aa = load ptr, ptr %i.m, align 8, !tbaa !64
  %.val.i = load i32, ptr %1, align 8, !tbaa !48
  %i.ab = tail call zeroext i1 %i.aa(ptr noundef %i.j, ptr noundef %i.f, i64 noundef range(i64 0, -4095) %i.h, i64 noundef %3, i64 noundef %4, i32 noundef %.val.i) #9, !inline_history !65 ; 2 uses
  br i1 %i.a, label %bb.g, label %tsd_fetch_impl.exit.i17.i
...
begin_hunk_26_@extent_split_impl:tsdn_witness_tsdp_get.exit46
  ...
  %.val49 = load i64, ptr %i.p, align 8, !tbaa !56
...
begin_hunk_27_@extent_split_impl:tsdn_witness_tsdp_get.exit46
  ...
  store i64 %.val49, ptr %i.x, align 8, !tbaa !56
...
ehooks_pre_reentrancy.exit.i:                     ; preds = %bb.i, %tsd_fetch_impl.exit.i.i
  %i.be = load ptr, ptr %i.ap, align 8, !tbaa !72
  %.val.i = load i32, ptr %2, align 8, !tbaa !48
  %i.bf = call zeroext i1 %i.be(ptr noundef nonnull %i.al, ptr noundef %i.ah, i64 noundef %i.ai, i64 noundef %4, i64 noundef %5, i1 noundef zeroext %i.ak, i32 noundef %.val.i) #9, !inline_history !73 ; 2 uses
...
ehooks_pre_reentrancy.exit.i:                     ; preds = %bb.f, %tsd_fetch_impl.exit.i.i
  %i.ak = load ptr, ptr %i.v, align 8, !tbaa !74
  %.val.i = load i32, ptr %2, align 8, !tbaa !48
  %i.al = tail call zeroext i1 %i.ak(ptr noundef %i.s, ptr noundef %i.f, i64 noundef range(i64 0, -4095) %i.h, ptr noundef %i.m, i64 noundef range(i64 0, -4095) %i.o, i1 noundef zeroext %i.q, i32 noundef %.val.i) #9, !inline_history !75 ; 2 uses
...
begin_hunk_32_@extent_merge_impl:tsdn_witness_tsdp_get.exit41
  ...
  %.val50 = load i64, ptr %i.bd, align 8, !tbaa !56
  %i.be = getelementptr i8, ptr %4, i64 32
  %.val49 = load i64, ptr %i.be, align 8, !tbaa !56
  %spec.select = call i64 @llvm.umin.i64(i64 %.val50, i64 %.val49)
  store i64 %spec.select, ptr %i.bd, align 8, !tbaa !56
