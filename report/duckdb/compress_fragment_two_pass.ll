...
_ZL7IsMatchPKhS0_m.exit13.thread:                 ; preds = %_ZL7IsMatchPKhS0_m.exit13.thread.backedge, %bb.c
  ...
  %.1 = phi ptr [ %4, %bb.c ], [ %i.ex, %_ZL7IsMatchPKhS0_m.exit13.thread.backedge ] ; 6 uses
  ...
  br i1 %i.n, label %.split.us.preheader, label %.split, !prof !409
...
.split.us:                                        ; preds = %.split.us.preheader, %.loopexit.split.us206
  %.0287.i.us = phi ptr [ %i.s, %.loopexit.split.us206 ], [ %.0.i9, %.split.us.preheader ] ; 2 uses
  %.0285.i.us = phi i32 [ %i.t, %.loopexit.split.us206 ], [ 32, %.split.us.preheader ] ; 2 uses
  %.1282.i.us = phi i32 [ %i.w, %.loopexit.split.us206 ], [ %.0281.i, %.split.us.preheader ]
...
.lr.ph.us:                                        ; preds = %.split.us, %.backedge.us212
  %i.s = phi ptr [ %i.bl, %.backedge.us212 ], [ %i.q, %.split.us ] ; 4 uses
  %.in285 = phi i32 [ %i.t, %.backedge.us212 ], [ %.0285.i.us, %.split.us ]
  %.2283.i181.us195 = phi i32 [ %i.w, %.backedge.us212 ], [ %.1282.i.us, %.split.us ] ; 2 uses
  ...
  %i.x = getelementptr inbounds i8, ptr %.1288.i180.us196, i64 %i.m ; 4 uses
  %.0.copyload.i50.us198 = load i32, ptr %.1288.i180.us196, align 1
  %.0.copyload.i49.us199 = load i32, ptr %i.x, align 1
  %i.y = icmp eq i32 %.0.copyload.i50.us198, %.0.copyload.i49.us199
  br i1 %i.y, label %bb.d, label %_ZL7IsMatchPKhS0_m.exit15.thread.us201

bb.d:                                             ; preds = %.lr.ph.us
  %i.z = getelementptr inbounds nuw i8, ptr %.1288.i180.us196, i64 4
  ...
  br i1 %i.ad, label %_ZL7IsMatchPKhS0_m.exit15.us200, label %_ZL7IsMatchPKhS0_m.exit15.thread.us201

_ZL7IsMatchPKhS0_m.exit15.us200:                  ; preds = %bb.d
  %i.ae = getelementptr inbounds nuw i8, ptr %.1288.i180.us196, i64 5
  ...
  br i1 %i.ai, label %bb.f, label %_ZL7IsMatchPKhS0_m.exit15.thread.us201, !prof !409

_ZL7IsMatchPKhS0_m.exit15.thread.us201:           ; preds = %_ZL7IsMatchPKhS0_m.exit15.us200, %bb.d, %.lr.ph.us
  %i.aj = zext nneg i32 %.2283.i181.us195 to i64
  ...
  %i.ao = ptrtoint ptr %.1288.i180.us196 to i64   ; 2 uses
  %i.ap = sub i64 %i.ao, %i.a
  %i.aq = trunc i64 %i.ap to i32
  store i32 %i.aq, ptr %i.ak, align 4, !tbaa !3
  %.0.copyload.i54.us202 = load i32, ptr %.1288.i180.us196, align 1
  %.0.copyload.i53.us203 = load i32, ptr %i.an, align 1
  %i.ar = icmp eq i32 %.0.copyload.i54.us202, %.0.copyload.i53.us203
  br i1 %i.ar, label %bb.e, label %.backedge.us212

bb.e:                                             ; preds = %_ZL7IsMatchPKhS0_m.exit15.thread.us201
  %i.as = getelementptr inbounds nuw i8, ptr %.1288.i180.us196, i64 4
  ...
  br i1 %i.aw, label %_ZL7IsMatchPKhS0_m.exit.us205, label %.backedge.us212

_ZL7IsMatchPKhS0_m.exit.us205:                    ; preds = %bb.e
  %i.ax = getelementptr inbounds nuw i8, ptr %.1288.i180.us196, i64 5
  ...
  %.not286 = icmp eq i8 %i.ay, %i.ba
  br i1 %.not286, label %.loopexit.split.us206, label %.backedge.us212, !prof !41

bb.f:                                             ; preds = %_ZL7IsMatchPKhS0_m.exit15.us200
  %i.bb = ptrtoint ptr %.1288.i180.us196 to i64   ; 2 uses
  %i.bc = sub i64 %i.bb, %i.a
  %i.bd = trunc i64 %i.bc to i32
  %i.be = zext nneg i32 %.2283.i181.us195 to i64
  %i.bf = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %i.be
  store i32 %i.bd, ptr %i.bf, align 4, !tbaa !3
  br label %.loopexit.split.us206

.loopexit.split.us206:                            ; preds = %_ZL7IsMatchPKhS0_m.exit.us205, %bb.f
  %.pre-phi = phi i64 [ %i.bb, %bb.f ], [ %i.ao, %_ZL7IsMatchPKhS0_m.exit.us205 ] ; 2 uses
  %.3292.i102.us = phi ptr [ %i.x, %bb.f ], [ %i.an, %_ZL7IsMatchPKhS0_m.exit.us205 ] ; 2 uses
  %i.bg = ptrtoint ptr %.3292.i102.us to i64
  %i.bh = sub i64 %.pre-phi, %i.bg                ; 2 uses
  %i.bi = icmp sgt i64 %i.bh, 262128
  br i1 %i.bi, label %.split.us, label %.split218.us
...
.backedge.us212:                                  ; preds = %_ZL7IsMatchPKhS0_m.exit15.thread.us201, %bb.e, %_ZL7IsMatchPKhS0_m.exit.us205
  ...
  br i1 %i.bm, label %.thread124, label %.lr.ph.us, !prof !411, !llvm.loop !43

.split:                                           ; preds = %_ZL7IsMatchPKhS0_m.exit13.thread, %.loopexit.split.us
  %.0287.i = phi ptr [ %i.br, %.loopexit.split.us ], [ %.0.i9, %_ZL7IsMatchPKhS0_m.exit13.thread ] ; 2 uses
  %.0285.i = phi i32 [ %i.bs, %.loopexit.split.us ], [ 32, %_ZL7IsMatchPKhS0_m.exit13.thread ] ; 2 uses
  %.1282.i = phi i64 [ %i.bu, %.loopexit.split.us ], [ %.0281.i.in, %_ZL7IsMatchPKhS0_m.exit13.thread ]
  %i.bn = lshr i32 %.0285.i, 5
  %i.bo = zext nneg i32 %i.bn to i64
  %i.bp = getelementptr inbounds nuw i8, ptr %.0287.i, i64 %i.bo ; 2 uses
  %i.bq = icmp ugt ptr %i.bp, %i.j
  br i1 %i.bq, label %.thread124, label %.lr.ph, !prof !410

.lr.ph:                                           ; preds = %.split, %.backedge.us
  %i.br = phi ptr [ %i.co, %.backedge.us ], [ %i.bp, %.split ] ; 4 uses
  %.in = phi i32 [ %i.bs, %.backedge.us ], [ %.0285.i, %.split ]
  %.2283.i181.us = phi i64 [ %i.bu, %.backedge.us ], [ %.1282.i, %.split ]
  %.1288.i180.us = phi ptr [ %i.br, %.backedge.us ], [ %.0287.i, %.split ] ; 5 uses
  ...
  %i.bv = getelementptr inbounds nuw [4 x i8], ptr %5, i64 %.2283.i181.us ; 2 uses
  %i.bw = load i32, ptr %i.bv, align 4, !tbaa !3
  %i.bx = sext i32 %i.bw to i64
  %i.by = getelementptr inbounds i8, ptr %1, i64 %i.bx ; 5 uses
  %i.bz = ptrtoint ptr %.1288.i180.us to i64      ; 3 uses
  %i.ca = sub i64 %i.bz, %i.a
  %i.cb = trunc i64 %i.ca to i32
  store i32 %i.cb, ptr %i.bv, align 4, !tbaa !3
...
bb.g:                                             ; preds = %.lr.ph
  %i.cd = getelementptr inbounds nuw i8, ptr %.1288.i180.us, i64 4
  ...
  br i1 %i.ch, label %_ZL7IsMatchPKhS0_m.exit.us, label %.backedge.us

_ZL7IsMatchPKhS0_m.exit.us:                       ; preds = %bb.g
  %i.ci = getelementptr inbounds nuw i8, ptr %.1288.i180.us, i64 5
...
.backedge.us:                                     ; preds = %.lr.ph, %bb.g, %_ZL7IsMatchPKhS0_m.exit.us
  ...
  br i1 %i.cp, label %.thread124, label %.lr.ph, !prof !411, !llvm.loop !43
...
.loopexit.split.us:                               ; preds = %_ZL7IsMatchPKhS0_m.exit.us
  ...
  br i1 %i.cs, label %.split, label %.split218.us

.split218.us:                                     ; preds = %.loopexit.split.us, %.loopexit.split.us206
  %.us-phi219 = phi ptr [ %.3292.i102.us, %.loopexit.split.us206 ], [ %i.by, %.loopexit.split.us ]
  %.us-phi220 = phi i64 [ %.pre-phi, %.loopexit.split.us206 ], [ %i.bz, %.loopexit.split.us ] ; 2 uses
  %.us-phi221 = phi i64 [ %i.bh, %.loopexit.split.us206 ], [ %i.cr, %.loopexit.split.us ]
  %.us-phi222 = phi ptr [ %.1288.i180.us196, %.loopexit.split.us206 ], [ %.1288.i180.us, %.loopexit.split.us ] ; 2 uses
  %i.ct = getelementptr inbounds nuw i8, ptr %.us-phi219, i64 6 ; 4 uses
  %i.cu = getelementptr inbounds nuw i8, ptr %.us-phi222, i64 6 ; 2 uses
  %i.cv = sub i64 %.neg134, %.us-phi220           ; 3 uses
  %i.cw = icmp ugt i64 %i.cv, 7
  br i1 %i.cw, label %.lr.ph232, label %.preheader140

.preheader140:                                    ; preds = %bb.i, %.split218.us
  %.027.i20.lcssa = phi i64 [ %i.cv, %.split218.us ], [ %i.dg, %bb.i ] ; 3 uses
  %.025.i21.lcssa = phi ptr [ %i.cu, %.split218.us ], [ %i.de, %bb.i ]
  %.022.i22.lcssa = phi ptr [ %i.ct, %.split218.us ], [ %i.df, %bb.i ] ; 3 uses
...
.lr.ph232:                                        ; preds = %.split218.us, %bb.i
  %.022.i22231 = phi ptr [ %i.df, %bb.i ], [ %i.ct, %.split218.us ] ; 3 uses
  %.025.i21230 = phi ptr [ %i.de, %bb.i ], [ %i.cu, %.split218.us ] ; 2 uses
  %.027.i20229 = phi i64 [ %i.dg, %bb.i ], [ %i.cv, %.split218.us ]
...
.lr.ph240:                                        ; preds = %.lr.ph240.preheader, %bb.j
  %.224.i26239 = phi ptr [ %9, %bb.j ], [ %.022.i22.lcssa, %.lr.ph240.preheader ] ; 3 uses
  %.126.i25238 = phi ptr [ %i.dl, %bb.j ], [ %.025.i21.lcssa, %.lr.ph240.preheader ] ; 2 uses
  %.128.i24237 = phi i64 [ %8, %bb.j ], [ %.027.i20.lcssa, %.lr.ph240.preheader ]
  %i.di = load i8, ptr %.224.i26239, align 1, !tbaa !9
  %i.dj = load i8, ptr %.126.i25238, align 1, !tbaa !9
  %i.dk = icmp eq i8 %i.di, %i.dj
  br i1 %i.dk, label %bb.j, label %.critedge.i28

bb.j:                                             ; preds = %.lr.ph240
  %8 = add nsw i64 %.128.i24237, -1               ; 2 uses
  %i.dl = getelementptr inbounds nuw i8, ptr %.126.i25238, i64 1
  %9 = getelementptr inbounds nuw i8, ptr %.224.i26239, i64 1
  %.not.i27.a = icmp eq i64 %8, 0
  br i1 %.not.i27.a, label %.critedge.i28, label %.lr.ph240, !llvm.loop !46

.critedge.i28:                                    ; preds = %bb.j, %.lr.ph240, %.preheader140
  %.224.i26.lcssa = phi ptr [ %.022.i22.lcssa, %.preheader140 ], [ %.224.i26239, %.lr.ph240 ], [ %scevgep, %bb.j ]
...
_ZN13duckdb_brotliL24FindMatchLengthWithLimitEPKhS1_m.exit33: ; preds = %bb.h, %.critedge.i28
  ...
  %i.dq = trunc i64 %.us-phi221 to i32            ; 3 uses
  %i.dr = ptrtoint ptr %.0273.i to i64
  %i.ds = sub i64 %.us-phi220, %i.dr              ; 2 uses
  %i.dt = trunc i64 %i.ds to i32                  ; 10 uses
  %i.du = getelementptr inbounds nuw i8, ptr %.us-phi222, i64 %i.dp ; 9 uses
  %i.dv = icmp ult i32 %i.dt, 6
  br i1 %i.dv, label %_ZL13EmitInsertLenjPPj.exit, label %bb.k

bb.k:                                             ; preds = %_ZN13duckdb_brotliL24FindMatchLengthWithLimitEPKhS1_m.exit33
...
_ZL13EmitInsertLenjPPj.exit:                      ; preds = %_ZN13duckdb_brotliL24FindMatchLengthWithLimitEPKhS1_m.exit33, %bb.l, %bb.n, %bb.p, %bb.r, %bb.s
  %.sink = phi i32 [ %i.eu, %bb.s ], [ %i.eh, %bb.l ], [ %i.en, %bb.n ], [ %i.eq, %bb.p ], [ %i.et, %bb.r ], [ %i.dt, %_ZN13duckdb_brotliL24FindMatchLengthWithLimitEPKhS1_m.exit33 ]
  store i32 %.sink, ptr %.189, align 4, !tbaa !3
  %i.ev = getelementptr inbounds nuw i8, ptr %.189, i64 4
...
bb.t:                                             ; preds = %_ZL13EmitInsertLenjPPj.exit
  ...
  %reass.sub287 = sub nsw i32 %i.fd, %i.fg
  %i.fh = add nsw i32 %reass.sub287, 138
  %i.fi = sub i32 %i.ez, %i.ff
  %i.fj = shl i32 %i.fi, 8
  %i.fk = or i32 %i.fj, %i.fh
  br label %bb.u

bb.u:                                             ; preds = %_ZL13EmitInsertLenjPPj.exit, %bb.t
  %storemerge = phi i32 [ %i.fk, %bb.t ], [ 64, %_ZL13EmitInsertLenjPPj.exit ]
  %.1277.i = phi i32 [ %i.dq, %bb.t ], [ %.0276.i.fr, %_ZL13EmitInsertLenjPPj.exit ] ; 3 uses
  store i32 %storemerge, ptr %i.ev, align 4, !tbaa !3
...
bb.v:                                             ; preds = %bb.u
  ...
  store i32 %i.fn, ptr %.290, align 4, !tbaa !3
...
bb.x:                                             ; preds = %bb.w
  ...
  store i32 %i.gc, ptr %.290, align 4, !tbaa !3
  br label %_ZL23EmitCopyLenLastDistancemPPj.exit
...
bb.z:                                             ; preds = %bb.y
  ...
  store i32 %i.gk, ptr %.290, align 4, !tbaa !3
  %i.gl = getelementptr inbounds nuw i8, ptr %.189, i64 12
  store i32 64, ptr %i.gl, align 4, !tbaa !3
  br label %_ZL23EmitCopyLenLastDistancemPPj.exit
...
bb.ab:                                            ; preds = %bb.aa
  ...
  store i32 %i.gw, ptr %.290, align 4, !tbaa !3
  %i.gx = getelementptr inbounds nuw i8, ptr %.189, i64 12
  store i32 64, ptr %i.gx, align 4, !tbaa !3
  br label %_ZL23EmitCopyLenLastDistancemPPj.exit
...
bb.ac:                                            ; preds = %bb.aa
  ...
  store i32 %i.gz, ptr %.290, align 4, !tbaa !3
  %i.ha = getelementptr inbounds nuw i8, ptr %.189, i64 12
  store i32 64, ptr %i.ha, align 4, !tbaa !3
  br label %_ZL23EmitCopyLenLastDistancemPPj.exit

_ZL23EmitCopyLenLastDistancemPPj.exit:            ; preds = %bb.v, %bb.x, %bb.z, %bb.ab, %bb.ac
  %.sink471 = phi i64 [ 12, %bb.v ], [ 12, %bb.x ], [ 16, %bb.z ], [ 16, %bb.ab ], [ 16, %bb.ac ]
  %i.hb = getelementptr inbounds nuw i8, ptr %.189, i64 %.sink471 ; 4 uses
  %.not312.i = icmp ult ptr %i.du, %i.j
  br i1 %.not312.i, label %bb.ad, label %.thread124, !prof !40

bb.ad:                                            ; preds = %_ZL23EmitCopyLenLastDistancemPPj.exit
  ...
  store i32 %i.hi, ptr %i.hj, align 4, !tbaa !3
