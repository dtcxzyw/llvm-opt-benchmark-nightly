...
_ZNSt12_Vector_baseImSaImEE11_M_allocateEm.exit.i: ; preds = %bb.y
  %i.bc = getelementptr inbounds nuw i8, ptr %0, i64 184 ; 2 uses
  %i.bd = load ptr, ptr %i.bc, align 8, !tbaa !454
  %i.be = ptrtoint ptr %i.bd to i64
  %i.bf = sub i64 %i.be, %i.ay                    ; 3 uses
...
bb.z:                                             ; preds = %.noexc66
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.bh, ptr align 8 %i.aw, i64 %i.bf, i1 false)
...
bb.aa:                                            ; preds = %_ZNSt6vectorImSaImEE11_S_relocateEPmS2_S2_RS0_.exit.i
  call void @_ZdlPv(ptr noundef nonnull %i.aw) #28
