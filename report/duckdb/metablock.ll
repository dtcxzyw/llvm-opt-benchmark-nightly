...
begin_hunk_1
  ...
  %11 = sub nsw i32 %i.bq, %.sroa.12242.0.copyload
  %i.bv = add nsw i32 %11, -16                    ; 2 uses
...
bb.s:                                             ; preds = %_ZL19ComputeDistanceCostPKN13duckdb_brotli7CommandEmPK20BrotliDistanceParamsS5_PdPNS_17HistogramDistanceE.exit216.thread
  ...
  %12 = icmp ne i32 %.sroa.12242.0.copyload, %i.fq
  %13 = icmp ne i64 %8, 0
...
begin_hunk_3
  ...
  %14 = sub nsw i32 %i.gb, %.sroa.12242.0.copyload
  %i.gg = add nsw i32 %14, -16                    ; 2 uses
