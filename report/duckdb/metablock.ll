...
bb.c:                                             ; preds = %bb.b
  ...
  %i.o = lshr i32 %i.n, 1
  %i.p = tail call range(i32 1, 33) i32 @llvm.ctlz.i32(i32 %i.o, i1 false) ; 2 uses
  %4 = sub nuw nsw i32 31, %i.p
  %i.q = lshr i32 %i.n, %4
  %i.r = and i32 %i.q, 1
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.ac = tail call range(i32 1, 33) i32 @llvm.ctlz.i32(i32 %i.ab, i1 false) ; 2 uses
  %11 = sub nuw nsw i32 31, %i.ac
