Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/duckdb/original/strutil?download=true
...
define hidden void @_ZN10duckdb_re27CEscapeB5cxx11ERKNS_11StringPieceE(ptr dead_on_unwind noalias writable sret(%"class.std::__cxx11::basic_string") align 8 %0, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(16) %1) local_unnamed_addr #0 personality ptr @__gxx_personality_v0 {
bb.a:
...
.lr.ph.i:                                         ; preds = %bb.a, %bb.m
  %.05260.i = phi i64 [ %.2.i, %bb.m ], [ 0, %bb.a ] ; 17 uses
  %.05659.i = phi ptr [ %i.am, %bb.m ], [ %i.g, %bb.a ] ; 2 uses
  %i.j = sub i64 %i.e, %.05260.i                  ; 2 uses
  %i.k = icmp ult i64 %i.j, 2
  br i1 %i.k, label %_ZN10duckdb_re2L13CEscapeStringEPKcmPcm.exit.thread, label %bb.b

bb.b:                                             ; preds = %.lr.ph.i
  %i.l = load i8, ptr %.05659.i, align 1, !tbaa !16 ; 4 uses
...
bb.k:                                             ; preds = %bb.j
  %i.ah = getelementptr inbounds nuw i8, ptr %i.f, i64 %.05260.i
  ...
  %i.aj = add i64 %.05260.i, 4
  br label %bb.m

bb.l:                                             ; preds = %bb.i
  %i.ak = add i64 %.05260.i, 1
  %i.al = getelementptr inbounds nuw i8, ptr %i.f, i64 %.05260.i
  store i8 %i.l, ptr %i.al, align 1, !tbaa !16
  br label %bb.m

bb.m:                                             ; preds = %bb.l, %bb.k, %bb.h, %bb.g, %bb.f, %bb.e, %bb.d, %bb.c
  %.2.i = phi i64 [ %i.ad, %bb.h ], [ %i.aj, %bb.k ], [ %i.ak, %bb.l ], [ %i.o, %bb.c ], [ %i.r, %bb.d ], [ %i.u, %bb.e ], [ %i.x, %bb.f ], [ %i.aa, %bb.g ] ; 7 uses
  %i.am = getelementptr inbounds nuw i8, ptr %.05659.i, i64 1 ; 2 uses
  %i.an = icmp ult ptr %i.am, %i.h
  br i1 %i.an, label %.lr.ph.i, label %._crit_edge.i, !llvm.loop !17

._crit_edge.i:                                    ; preds = %bb.m
  %i.ao = icmp eq i64 %i.e, %.2.i
...
_ZN10duckdb_re2L13CEscapeStringEPKcmPcm.exit:     ; preds = %._crit_edge.i
  %i.aq = getelementptr inbounds nuw i8, ptr %i.f, i64 %.2.i
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #12
  store i64 %.2.i, ptr %i.a, align 8, !tbaa !15
  %i.as = icmp ugt i64 %.2.i, 15
...
.noexc.i:                                         ; preds = %_ZN10duckdb_re2L13CEscapeStringEPKcmPcm.exit.thread, %_ZN10duckdb_re2L13CEscapeStringEPKcmPcm.exit
  ...
  %.255.i16 = phi i64 [ -1, %_ZN10duckdb_re2L13CEscapeStringEPKcmPcm.exit.thread ], [ %.2.i, %_ZN10duckdb_re2L13CEscapeStringEPKcmPcm.exit ]
...
._crit_edge.i.i:                                  ; preds = %.noexc.i, %_ZN10duckdb_re2L13CEscapeStringEPKcmPcm.exit
  %.255.i15 = phi i64 [ %.255.i16, %.noexc.i ], [ %.2.i, %_ZN10duckdb_re2L13CEscapeStringEPKcmPcm.exit ] ; 2 uses
  %i.aw = phi ptr [ %i.au, %.noexc.i ], [ %i.ar, %_ZN10duckdb_re2L13CEscapeStringEPKcmPcm.exit ] ; 2 uses
  switch i64 %.255.i15, label %bb.o [
    i64 1, label %bb.n
    i64 0, label %bb.p
  ]
...
bb.o:                                             ; preds = %._crit_edge.i.i
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %i.aw, ptr nonnull align 1 %i.f, i64 %.255.i15, i1 false)
  br label %bb.p
