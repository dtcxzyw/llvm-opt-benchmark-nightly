...
bb.e:                                             ; preds = %.lr.ph, %_ZNSt10unique_ptrIN6duckdb14BaseStatisticsESt14default_deleteIS1_EED2Ev.exit
  %.sroa.032.038 = phi ptr [ %i.d, %.lr.ph ], [ %i.al, %_ZNSt10unique_ptrIN6duckdb14BaseStatisticsESt14default_deleteIS1_EED2Ev.exit ] ; 4 uses
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.032.038) ]
...
.lr.ph:                                           ; preds = %bb.a, %_ZNSt10unique_ptrIN6duckdb14BaseStatisticsESt14default_deleteIS1_EED2Ev.exit15
  %.sroa.016.023 = phi ptr [ %i.p, %_ZNSt10unique_ptrIN6duckdb14BaseStatisticsESt14default_deleteIS1_EED2Ev.exit15 ], [ %i.c, %bb.a ] ; 4 uses
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.016.023) ]
...
bb.e:                                             ; preds = %.lr.ph, %_ZNSt10unique_ptrIN6duckdb14BaseStatisticsESt14default_deleteIS1_EED2Ev.exit
  ...
  %.sroa.0173.0185 = phi ptr [ %i.d, %.lr.ph ], [ %i.bb, %_ZNSt10unique_ptrIN6duckdb14BaseStatisticsESt14default_deleteIS1_EED2Ev.exit ] ; 3 uses
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.0173.0185) ]
