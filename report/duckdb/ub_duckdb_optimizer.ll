...
end_hunk_0
begin_hunk_1
%struct.ExpressionCosts = type { %"class.duckdb::unique_ptr.141", i64 }
%"struct.std::__detail::_AllocNode.3286" = type { ptr }
...
%"struct.std::_Hashtable<std::reference_wrapper<duckdb::Expression>, std::pair<const std::reference_wrapper<duckdb::Expression>, duckdb::unique_ptr<duckdb::Expression>>, std::allocator<std::pair<const std::reference_wrapper<duckdb::Expression>, duckdb::unique_ptr<duckdb::Expression>>>, std::__detail::_Select1st, duckdb::ExpressionEquality<duckdb::Expression>, duckdb::ExpressionHashFunction<duckdb::Expression>, std::__detail::_Mod_range_hashing, std::__detail::_Default_ranged_hash, std::__detail::_Prime_rehash_policy, std::__detail::_Hashtable_traits<true, false, true>>::_Scoped_node" = type { ptr, ptr }
%"struct.std::_Rb_tree<unsigned long, std::pair<const unsigned long, duckdb::vector<std::reference_wrapper<duckdb::Expression>>>, std::_Select1st<std::pair<const unsigned long, duckdb::vector<std::reference_wrapper<duckdb::Expression>>>>, std::less<unsigned long>>::_Auto_node" = type { ptr, ptr }
...
bb.d:                                             ; preds = %bb.c
  %.sroa.0.0.copyload.i.i.i.i = load <2 x i64>, ptr %.sroa.0.019.i.ptr.i.i.i, align 8
...
_ZSt13move_backwardIN9__gnu_cxx17__normal_iteratorIPZN6duckdb20ExpressionHeuristics15GetInitialOrderERKNS2_14TableFilterSetEE10FilterCostSt6vectorIS7_SaIS7_EEEESC_ET0_T_SE_SD_.exit.i.i.i.i: ; preds = %bb.f, %bb.e
  store <2 x i64> %.sroa.0.0.copyload.i.i.i.i, ptr %.sroa.043.1, align 8
  br label %bb.h
...
bb.j:                                             ; preds = %bb.i
  %.sroa.0.0.copyload.i39.i.i.i = load <2 x i64>, ptr %.sroa.0.019.i24.i.i.i, align 8
...
_ZSt13move_backwardIN9__gnu_cxx17__normal_iteratorIPZN6duckdb20ExpressionHeuristics15GetInitialOrderERKNS2_14TableFilterSetEE10FilterCostSt6vectorIS7_SaIS7_EEEESC_ET0_T_SE_SD_.exit.i39.i.i.i: ; preds = %bb.m, %bb.l, %bb.k
  store <2 x i64> %.sroa.0.0.copyload.i39.i.i.i, ptr %.sroa.043.1, align 8
  br label %bb.o
...
bb.v:                                             ; preds = %.lr.ph254
  ...
  %.sroa.0177.sroa.0.0.copyload = load <2 x i64>, ptr %i.ca, align 8 ; 2 uses
  %.not.i = icmp eq ptr %.sroa.12.0250, %.sroa.19.0251
  br i1 %.not.i, label %bb.x, label %bb.w

bb.w:                                             ; preds = %bb.v
  store <2 x i64> %.sroa.0177.sroa.0.0.copyload, ptr %.sroa.12.0250, align 8
...
_ZNSt6vectorIN6duckdb24JoinFilterPushdownColumnESaIS1_EED2Ev.exit148: ; preds = %bb.t, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.i.i.i, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i, %.loopexit.split-lp, %.loopexit, %.loopexit218, %.loopexit.split-lp219, %bb.af, %bb.ae
  ...
  %.pn = phi { ptr, i32 } [ %i.cv, %bb.af ], [ %lpad.loopexit.split-lp221, %.loopexit.split-lp219 ], [ %i.cv, %bb.ae ], [ %lpad.loopexit220, %.loopexit218 ], [ %lpad.loopexit, %.loopexit ], [ %lpad.loopexit.split-lp, %.loopexit.split-lp ], [ %i.bx, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i ], [ %i.bx, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.i.i.i ], [ %.pn8.i.i.i, %bb.t ] ; 2 uses
...
bb.l:                                             ; preds = %bb.k
  ...
  %.sroa.0258.sroa.0.0.copyload = load <2 x i64>, ptr %i.y, align 8 ; 2 uses
  %.not.i = icmp eq ptr %.sroa.11.0319, %.sroa.18.0318
  br i1 %.not.i, label %bb.n, label %bb.m

bb.m:                                             ; preds = %bb.l
  store <2 x i64> %.sroa.0258.sroa.0.0.copyload, ptr %.sroa.11.0319, align 8
  br label %_ZNSt6vectorIN6duckdb24JoinFilterPushdownColumnESaIS1_EE9push_backERKS1_.exit
...
bb.k:                                             ; preds = %bb.j
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.cb, ptr noundef nonnull align 8 dereferenceable(16) %8, i64 16, i1 false), !tbaa.struct !65
...
bb.m:                                             ; preds = %bb.l
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.cc, ptr noundef nonnull align 8 dereferenceable(16) %7, i64 16, i1 false), !tbaa.struct !65
...
bb.p:                                             ; preds = %bb.o
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %0, ptr noundef nonnull align 8 dereferenceable(16) %i.f, i64 16, i1 false), !tbaa.struct !65
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.f, ptr noundef nonnull align 8 dereferenceable(16) %5, i64 16, i1 false), !tbaa.struct !65
...
bb.r:                                             ; preds = %bb.q
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %0, ptr noundef nonnull align 8 dereferenceable(16) %i.cc, i64 16, i1 false), !tbaa.struct !65
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.cc, ptr noundef nonnull align 8 dereferenceable(16) %4, i64 16, i1 false), !tbaa.struct !65
  call void @llvm.lifetime.end.p0(ptr nonnull %4)
  br label %_ZSt22__move_median_to_firstIN9__gnu_cxx17__normal_iteratorIPZN6duckdb20ExpressionHeuristics15GetInitialOrderERKNS2_14TableFilterSetEE10FilterCostSt6vectorIS7_SaIS7_EEEENS0_5__ops15_Iter_less_iterEEvT_SF_SF_SF_T0_.exit.i.preheader

bb.s:                                             ; preds = %bb.q
  call void @llvm.lifetime.start.p0(ptr nonnull %3)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %3, ptr noundef nonnull align 8 dereferenceable(16) %0, i64 16, i1 false), !tbaa.struct !65
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %0, ptr noundef nonnull align 8 dereferenceable(16) %i.cb, i64 16, i1 false), !tbaa.struct !65
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.cb, ptr noundef nonnull align 8 dereferenceable(16) %3, i64 16, i1 false), !tbaa.struct !65
...
bb.v:                                             ; preds = %bb.u
  %.sroa.0.0.copyload.i.i = load <2 x i64>, ptr %.sroa.012.1.i.i, align 8
