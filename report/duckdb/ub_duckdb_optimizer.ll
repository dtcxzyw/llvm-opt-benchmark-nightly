...
bb.a:
  ...
  %i.a = load i32, ptr %3, align 4, !tbaa !3, !noalias !4842
...
bb.a:
  ...
  %i.b = load i64, ptr %i.a, align 8, !tbaa !4749 ; 2 uses
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !4742 ; 2 uses
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !4742 ; 2 uses
...
bb.c:                                             ; preds = %_ZNKSt6vectorImN6duckdb19arena_stl_allocatorImEEE12_M_check_lenEmPKc.exit
  ...
  %i.v = load i64, ptr %i.u, align 8, !tbaa !4702 ; 2 uses
  %i.w = add i64 %i.v, %i.r                       ; 2 uses
  %i.x = getelementptr inbounds nuw i8, ptr %i.t, i64 32
  %i.y = load i64, ptr %i.x, align 8, !tbaa !4714
...
bb.d:                                             ; preds = %bb.c, %_ZNKSt6vectorImN6duckdb19arena_stl_allocatorImEEE12_M_check_lenEmPKc.exit
  ...
  %.pre.i.i.i.i = load ptr, ptr %i.s, align 8, !tbaa !4700 ; 2 uses
  %.phi.trans.insert.i.i.i.i = getelementptr inbounds nuw i8, ptr %.pre.i.i.i.i, i64 24
  %.pre4.i.i.i.i = load i64, ptr %.phi.trans.insert.i.i.i.i, align 8, !tbaa !4702 ; 2 uses
...
_ZNSt16allocator_traitsIN6duckdb19arena_stl_allocatorImEEE8allocateERS2_m.exit.i: ; preds = %bb.d, %bb.c
  ...
  %i.ad = load ptr, ptr %i.ac, align 8, !tbaa !4715 ; 2 uses
  ...
  store i64 %.pre-phi.i.i.i.i, ptr %i.af, align 8, !tbaa !4702
...
vector.memcheck:                                  ; preds = %.lr.ph.i.i.preheader
  %i.am = add i64 %i.aa, %i.ae
  %i.an = sub i64 %i.f, %i.am
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %i.aq = getelementptr i8, ptr %i.d, i64 %i.ao
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep47 = getelementptr i8, ptr %i.d, i64 %i.ar ; 2 uses
  %i.as = getelementptr i8, ptr %next.gep47, i64 16
  %wide.load = load <2 x i64>, ptr %next.gep47, align 8, !tbaa !66
  %wide.load48 = load <2 x i64>, ptr %i.as, align 8, !tbaa !66
  %i.at = getelementptr i8, ptr %next.gep, i64 16
  store <2 x i64> %wide.load, ptr %next.gep, align 8, !tbaa !66
  store <2 x i64> %wide.load48, ptr %i.at, align 8, !tbaa !66
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.au = icmp eq i64 %index.next, %n.vec
  br i1 %i.au, label %middle.block, label %vector.body, !llvm.loop !4845
...
.lr.ph.i.i.preheader70:                           ; preds = %vector.memcheck, %.lr.ph.i.i.preheader, %middle.block
  %.015.i.i.ph = phi ptr [ %i.ag, %vector.memcheck ], [ %i.ag, %.lr.ph.i.i.preheader ], [ %i.ap, %middle.block ]
  %.sroa.010.014.i.i.ph = phi ptr [ %i.d, %vector.memcheck ], [ %i.d, %.lr.ph.i.i.preheader ], [ %i.aq, %middle.block ]
  br label %.lr.ph.i.i

.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader70, %.lr.ph.i.i
  %.015.i.i = phi ptr [ %i.ax, %.lr.ph.i.i ], [ %.015.i.i.ph, %.lr.ph.i.i.preheader70 ] ; 2 uses
  %.sroa.010.014.i.i = phi ptr [ %i.aw, %.lr.ph.i.i ], [ %.sroa.010.014.i.i.ph, %.lr.ph.i.i.preheader70 ] ; 2 uses
  %i.av = load i64, ptr %.sroa.010.014.i.i, align 8, !tbaa !66
  store i64 %i.av, ptr %.015.i.i, align 8, !tbaa !66
  %i.aw = getelementptr inbounds nuw i8, ptr %.sroa.010.014.i.i, i64 8 ; 2 uses
  %i.ax = getelementptr inbounds nuw i8, ptr %.015.i.i, i64 8 ; 2 uses
  %.not.i.i = icmp eq ptr %i.aw, %1
  br i1 %.not.i.i, label %_ZSt34__uninitialized_move_if_noexcept_aIPmS0_N6duckdb19arena_stl_allocatorImEEET0_T_S5_S4_RT1_.exit, label %.lr.ph.i.i, !llvm.loop !4846
...
_ZSt34__uninitialized_move_if_noexcept_aIPmS0_N6duckdb19arena_stl_allocatorImEEET0_T_S5_S4_RT1_.exit: ; preds = %.lr.ph.i.i, %middle.block, %_ZNSt16allocator_traitsIN6duckdb19arena_stl_allocatorImEEE8allocateERS2_m.exit.i
  %.0.lcssa.i.i = phi ptr [ %i.ag, %_ZNSt16allocator_traitsIN6duckdb19arena_stl_allocatorImEEE8allocateERS2_m.exit.i ], [ %i.ap, %middle.block ], [ %i.ax, %.lr.ph.i.i ] ; 2 uses
  %.0.lcssa.i.i51 = ptrtoaddr ptr %.0.lcssa.i.i to i64
  %i.ay = getelementptr inbounds nuw i8, ptr %.0.lcssa.i.i, i64 8 ; 5 uses
...
vector.ph55:                                      ; preds = %vector.memcheck50
  %n.vec57 = and i64 %i.bb, 4611686018427387900   ; 3 uses
  %i.be = shl i64 %n.vec57, 3                     ; 2 uses
  %i.bf = getelementptr i8, ptr %i.ay, i64 %i.be  ; 2 uses
...
vector.body58:                                    ; preds = %vector.body58, %vector.ph55
  ...
  %i.bh = shl i64 %index59, 3                     ; 2 uses
  %next.gep60 = getelementptr i8, ptr %i.ay, i64 %i.bh ; 2 uses
  %next.gep61 = getelementptr i8, ptr %1, i64 %i.bh ; 2 uses
  %i.bi = getelementptr i8, ptr %next.gep61, i64 16
  %wide.load62 = load <2 x i64>, ptr %next.gep61, align 8, !tbaa !66
  %wide.load63 = load <2 x i64>, ptr %i.bi, align 8, !tbaa !66
  %i.bj = getelementptr i8, ptr %next.gep60, i64 16
  store <2 x i64> %wide.load62, ptr %next.gep60, align 8, !tbaa !66
  store <2 x i64> %wide.load63, ptr %i.bj, align 8, !tbaa !66
  %index.next64 = add nuw i64 %index59, 4         ; 2 uses
  %i.bk = icmp eq i64 %index.next64, %n.vec57
  br i1 %i.bk, label %middle.block65, label %vector.body58, !llvm.loop !4847

middle.block65:                                   ; preds = %vector.body58
  %cmp.n66 = icmp eq i64 %i.bb, %n.vec57
...
.lr.ph.i.i29.preheader69:                         ; preds = %vector.memcheck50, %.lr.ph.i.i29.preheader, %middle.block65
  %.015.i.i30.ph = phi ptr [ %i.ay, %vector.memcheck50 ], [ %i.ay, %.lr.ph.i.i29.preheader ], [ %i.bf, %middle.block65 ]
  %.sroa.010.014.i.i31.ph = phi ptr [ %1, %vector.memcheck50 ], [ %1, %.lr.ph.i.i29.preheader ], [ %i.bg, %middle.block65 ]
  br label %.lr.ph.i.i29

.lr.ph.i.i29:                                     ; preds = %.lr.ph.i.i29.preheader69, %.lr.ph.i.i29
  %.015.i.i30 = phi ptr [ %i.bn, %.lr.ph.i.i29 ], [ %.015.i.i30.ph, %.lr.ph.i.i29.preheader69 ] ; 2 uses
  %.sroa.010.014.i.i31 = phi ptr [ %i.bm, %.lr.ph.i.i29 ], [ %.sroa.010.014.i.i31.ph, %.lr.ph.i.i29.preheader69 ] ; 2 uses
  %i.bl = load i64, ptr %.sroa.010.014.i.i31, align 8, !tbaa !66
  store i64 %i.bl, ptr %.015.i.i30, align 8, !tbaa !66
  %i.bm = getelementptr inbounds nuw i8, ptr %.sroa.010.014.i.i31, i64 8 ; 2 uses
  %i.bn = getelementptr inbounds nuw i8, ptr %.015.i.i30, i64 8 ; 2 uses
  %.not.i.i32 = icmp eq ptr %i.bm, %i.c
  br i1 %.not.i.i32, label %_ZSt34__uninitialized_move_if_noexcept_aIPmS0_N6duckdb19arena_stl_allocatorImEEET0_T_S5_S4_RT1_.exit34, label %.lr.ph.i.i29, !llvm.loop !4848
...
_ZSt34__uninitialized_move_if_noexcept_aIPmS0_N6duckdb19arena_stl_allocatorImEEET0_T_S5_S4_RT1_.exit34: ; preds = %.lr.ph.i.i29, %middle.block65, %_ZSt34__uninitialized_move_if_noexcept_aIPmS0_N6duckdb19arena_stl_allocatorImEEET0_T_S5_S4_RT1_.exit
  %.0.lcssa.i.i33 = phi ptr [ %i.ay, %_ZSt34__uninitialized_move_if_noexcept_aIPmS0_N6duckdb19arena_stl_allocatorImEEET0_T_S5_S4_RT1_.exit ], [ %i.bf, %middle.block65 ], [ %i.bn, %.lr.ph.i.i29 ]
  ...
  %i.bp = getelementptr inbounds nuw [8 x i8], ptr %i.ag, i64 %i.m
  store ptr %i.bp, ptr %i.bo, align 8, !tbaa !498
  ret void
}
...
bb.j:                                             ; preds = %bb.h
  ...
  %i.z = load ptr, ptr %i.y, align 8, !tbaa !717
  store ptr %i.z, ptr %3, align 8, !tbaa !168
  store ptr %3, ptr %i.y, align 8, !tbaa !717
...
bb.b:                                             ; preds = %bb.a
  ...
  store ptr null, ptr %i.b, align 8, !tbaa !4849
...
_ZNSt10_HashtableImSt4pairIKmmESaIS2_ENSt8__detail10_Select1stESt8equal_toImESt4hashImENS4_18_Mod_range_hashingENS4_20_Default_ranged_hashENS4_20_Prime_rehash_policyENS4_17_Hashtable_traitsILb0ELb0ELb1EEEE19_M_allocate_bucketsEm.exit: ; preds = %bb.b, %_ZNSt8__detail16_Hashtable_allocISaINS_10_Hash_nodeISt4pairIKmmELb0EEEEE19_M_allocate_bucketsEm.exit.i
  ...
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !717  ; 2 uses
  store ptr null, ptr %i.g, align 8, !tbaa !717
...
.lr.ph:                                           ; preds = %_ZNSt10_HashtableImSt4pairIKmmESaIS2_ENSt8__detail10_Select1stESt8equal_toImESt4hashImENS4_18_Mod_range_hashingENS4_20_Default_ranged_hashENS4_20_Prime_rehash_policyENS4_17_Hashtable_traitsILb0ELb0ELb1EEEE19_M_allocate_bucketsEm.exit, %bb.h
  %.031 = phi ptr [ %i.i, %bb.h ], [ %i.h, %_ZNSt10_HashtableImSt4pairIKmmESaIS2_ENSt8__detail10_Select1stESt8equal_toImESt4hashImENS4_18_Mod_range_hashingENS4_20_Default_ranged_hashENS4_20_Prime_rehash_policyENS4_17_Hashtable_traitsILb0ELb0ELb1EEEE19_M_allocate_bucketsEm.exit ] ; 8 uses
  %.02530 = phi i64 [ %.1, %bb.h ], [ 0, %_ZNSt10_HashtableImSt4pairIKmmESaIS2_ENSt8__detail10_Select1stESt8equal_toImESt4hashImENS4_18_Mod_range_hashingENS4_20_Default_ranged_hashENS4_20_Prime_rehash_policyENS4_17_Hashtable_traitsILb0ELb0ELb1EEEE19_M_allocate_bucketsEm.exit ] ; 2 uses
  %i.i = load ptr, ptr %.031, align 8, !tbaa !168 ; 2 uses
...
bb.a:
  ...
  %i.c = load i64, ptr %i.b, align 8, !tbaa !619
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 3 uses
  %i.e = load i64, ptr %i.d, align 8, !tbaa !2226
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 24 ; 3 uses
  %i.g = load i64, ptr %i.f, align 8, !tbaa !2303
  %i.h = tail call { i8, i64 } @_ZNKSt8__detail20_Prime_rehash_policy14_M_need_rehashEmmm(ptr noundef nonnull align 8 dereferenceable(16) %i.a, i64 noundef %i.e, i64 noundef %i.g, i64 noundef %4) ; 2 uses
  %i.i = extractvalue { i8, i64 } %i.h, 0
  %i.j = trunc i8 %i.i to i1
  br i1 %i.j, label %bb.b, label %bb.h
...
_ZNSt10_HashtableIN6duckdb13ColumnBindingESt4pairIKS1_NS0_16ReferencedColumnEESaIS5_ENSt8__detail10_Select1stENS0_21ColumnBindingEqualityENS0_25ColumnBindingHashFunctionENS7_18_Mod_range_hashingENS7_20_Default_ranged_hashENS7_20_Prime_rehash_policyENS7_17_Hashtable_traitsILb1ELb0ELb1EEEE9_M_rehashEmRKm.exit: ; preds = %bb.b
  %i.r = load i64, ptr %i.d, align 8, !tbaa !2226
  %i.s = urem i64 %2, %i.r
  br label %bb.h
...
bb.h:                                             ; preds = %_ZNSt10_HashtableIN6duckdb13ColumnBindingESt4pairIKS1_NS0_16ReferencedColumnEESaIS5_ENSt8__detail10_Select1stENS0_21ColumnBindingEqualityENS0_25ColumnBindingHashFunctionENS7_18_Mod_range_hashingENS7_20_Default_ranged_hashENS7_20_Prime_rehash_policyENS7_17_Hashtable_traitsILb1ELb0ELb1EEEE9_M_rehashEmRKm.exit, %bb.a
  ...
  %i.u = load ptr, ptr %0, align 8, !tbaa !2224   ; 2 uses
...
bb.j:                                             ; preds = %bb.h
  ...
  %i.aa = load ptr, ptr %i.z, align 8, !tbaa !2283
  store ptr %i.aa, ptr %3, align 8, !tbaa !168
  store ptr %3, ptr %i.z, align 8, !tbaa !2283
  %i.ab = load ptr, ptr %3, align 8, !tbaa !168   ; 2 uses
  %.not11.i = icmp eq ptr %i.ab, null
  br i1 %.not11.i, label %bb.l, label %bb.k

bb.k:                                             ; preds = %bb.j
  %i.ac = load i64, ptr %i.d, align 8, !tbaa !2226
...
_ZNSt10_HashtableIN6duckdb13ColumnBindingESt4pairIKS1_NS0_16ReferencedColumnEESaIS5_ENSt8__detail10_Select1stENS0_21ColumnBindingEqualityENS0_25ColumnBindingHashFunctionENS7_18_Mod_range_hashingENS7_20_Default_ranged_hashENS7_20_Prime_rehash_policyENS7_17_Hashtable_traitsILb1ELb0ELb1EEEE22_M_insert_bucket_beginEmPNS7_10_Hash_nodeIS5_Lb1EEE.exit: ; preds = %bb.i, %bb.l
  %i.ah = load i64, ptr %i.f, align 8, !tbaa !2303
  %i.ai = add i64 %i.ah, 1
  store i64 %i.ai, ptr %i.f, align 8, !tbaa !2303
  ret ptr %3
}
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !5754 ; 2 uses
  %.not = icmp eq ptr %i.b, null
  br i1 %.not, label %bb.c, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.c = load ptr, ptr %0, align 8, !tbaa !5750
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !3163 ; 2 uses
  %i.c = load ptr, ptr %1, align 8, !tbaa !2297   ; 2 uses
...
bb.c:                                             ; preds = %_ZNSt15__new_allocatorISt17reference_wrapperIN6duckdb24BoundColumnRefExpressionEEE8allocateEmPKv.exit.i.i.i.i.i, %bb.a
  ...
  store ptr %i.i, ptr %0, align 8, !tbaa !2297
  %i.j = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
  store ptr %i.i, ptr %i.j, align 8, !tbaa !3163
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.ab, label %middle.block, label %vector.body, !llvm.loop !5756
...
.lr.ph.i.i.i.i.i.i:                               ; preds = %.lr.ph.i.i.i.i.i.i.preheader30, %.lr.ph.i.i.i.i.i.i
  ...
  br i1 %.not.i.i.i.i.i.i, label %_ZN6duckdb6vectorISt17reference_wrapperINS_24BoundColumnRefExpressionEELb1ESaIS3_EEC2ERKS5_.exit, label %.lr.ph.i.i.i.i.i.i, !llvm.loop !5757
...
_ZN6duckdb6vectorISt17reference_wrapperINS_24BoundColumnRefExpressionEELb1ESaIS3_EEC2ERKS5_.exit: ; preds = %.lr.ph.i.i.i.i.i.i, %middle.block, %bb.c
  ...
  store ptr %.0.lcssa.i.i.i.i.i.i, ptr %i.j, align 8, !tbaa !3163
  ...
  %i.ai = load ptr, ptr %i.ah, align 8, !tbaa !2292 ; 2 uses
  %i.aj = load ptr, ptr %i.ag, align 8, !tbaa !2289 ; 2 uses
...
.noexc13:                                         ; preds = %_ZNSt15__new_allocatorIN6duckdb23ReferencedStructExtractEE8allocateEmPKv.exit.i.i.i.i.i, %_ZN6duckdb6vectorISt17reference_wrapperINS_24BoundColumnRefExpressionEELb1ESaIS3_EEC2ERKS5_.exit
  ...
  store ptr %i.aq, ptr %i.af, align 8, !tbaa !2289
  %i.ar = getelementptr inbounds nuw i8, ptr %0, i64 32 ; 2 uses
  store ptr %i.aq, ptr %i.ar, align 8, !tbaa !2292
  %i.as = getelementptr inbounds nuw i8, ptr %i.aq, i64 %i.am
  %i.at = getelementptr inbounds nuw i8, ptr %0, i64 40
  store ptr %i.as, ptr %i.at, align 8, !tbaa !3338
  %i.au = load ptr, ptr %i.ag, align 8, !tbaa !3197
  %i.av = load ptr, ptr %i.ah, align 8, !tbaa !3197
...
bb.e:                                             ; preds = %.noexc13
  %i.ax = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.ay = load ptr, ptr %i.af, align 8, !tbaa !2289 ; 2 uses
...
bb.g:                                             ; preds = %.noexc13
  store ptr %i.aw, ptr %i.ar, align 8, !tbaa !2292
  ...
  %i.bc = load ptr, ptr %i.bb, align 8, !tbaa !1659 ; 2 uses
  %i.bd = load ptr, ptr %i.ba, align 8, !tbaa !1658 ; 2 uses
...
.noexc.i.i.i16:                                   ; preds = %bb.h
  invoke void @_ZSt28__throw_bad_array_new_lengthv() #35
          to label %.noexc17 unwind label %bb.n, !inline_history !3255
...
_ZNSt15__new_allocatorIN6duckdb11ColumnIndexEE8allocateEmPKv.exit.i.i.i.i.i: ; preds = %bb.h
  %i.bj = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.bg) #36
          to label %.noexc18 unwind label %bb.n, !inline_history !3255
...
.noexc18:                                         ; preds = %_ZNSt15__new_allocatorIN6duckdb11ColumnIndexEE8allocateEmPKv.exit.i.i.i.i.i, %bb.g
  ...
  %i.bq = invoke noundef ptr @_ZSt16__do_uninit_copyIN9__gnu_cxx17__normal_iteratorIPKN6duckdb11ColumnIndexESt6vectorIS3_SaIS3_EEEEPS3_ET0_T_SC_SB_(ptr %i.bo, ptr %i.bp, ptr noundef %i.bk)
          to label %bb.k unwind label %bb.i, !inline_history !3228

bb.i:                                             ; preds = %.noexc18
  %i.br = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.bs = load ptr, ptr %i.az, align 8, !tbaa !1658 ; 2 uses
  %.not.i.i.i.i15 = icmp eq ptr %i.bs, null
  br i1 %.not.i.i.i.i15, label %.body19, label %bb.j

bb.j:                                             ; preds = %bb.i
  tail call void @_ZdlPv(ptr noundef nonnull %i.bs) #34, !inline_history !3227
  br label %.body19

bb.k:                                             ; preds = %.noexc18
  store ptr %i.bq, ptr %i.bl, align 8, !tbaa !1659
  %i.bt = getelementptr inbounds nuw i8, ptr %0, i64 72
  %i.bu = getelementptr inbounds nuw i8, ptr %1, i64 72
  %i.bv = load i8, ptr %i.bu, align 8, !tbaa !3177
  store i8 %i.bv, ptr %i.bt, align 8, !tbaa !3177
  %i.bw = getelementptr inbounds nuw i8, ptr %0, i64 80 ; 3 uses
  %i.bx = getelementptr inbounds nuw i8, ptr %1, i64 80
  store ptr null, ptr %i.bw, align 8, !tbaa !2287
  %i.by = getelementptr inbounds nuw i8, ptr %0, i64 88
  %i.bz = getelementptr inbounds nuw i8, ptr %1, i64 88
  %i.ca = load i64, ptr %i.bz, align 8, !tbaa !2288
  store i64 %i.ca, ptr %i.by, align 8, !tbaa !2288
  ...
  %i.ce = load i64, ptr %i.cd, align 8, !tbaa !3178
  store i64 %i.ce, ptr %i.cc, align 8, !tbaa !3178
  %i.cf = getelementptr inbounds nuw i8, ptr %0, i64 112
  %i.cg = getelementptr inbounds nuw i8, ptr %1, i64 112
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.cf, ptr noundef nonnull align 8 dereferenceable(16) %i.cg, i64 16, i1 false), !tbaa.struct !1112
  %i.ch = getelementptr inbounds nuw i8, ptr %0, i64 128
  store ptr null, ptr %i.ch, align 8, !tbaa !3327
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #33
  store ptr %i.bw, ptr %2, align 8, !tbaa !5758
