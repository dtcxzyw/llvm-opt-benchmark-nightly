...
._crit_edge:                                      ; preds = %_ZN6duckdb8string_t18SetSizeAndFinalizeEjm.exit
  ...
  br i1 %or.cond.not, label %.loopexit, label %.lr.ph53

.lr.ph:                                           ; preds = %.lr.ph.preheader.a, %_ZN6duckdb8string_t18SetSizeAndFinalizeEjm.exit
  %i.q = phi i64 [ %i.aj, %_ZN6duckdb8string_t18SetSizeAndFinalizeEjm.exit ], [ 0, %.lr.ph.preheader.a ]
  %.051 = phi i1 [ %spec.select, %_ZN6duckdb8string_t18SetSizeAndFinalizeEjm.exit ], [ true, %.lr.ph.preheader.a ]
  %.03650 = phi i32 [ %i.ai, %_ZN6duckdb8string_t18SetSizeAndFinalizeEjm.exit ], [ 0, %.lr.ph.preheader.a ] ; 3 uses
  %.sroa.0.049 = phi ptr [ %i.ah, %_ZN6duckdb8string_t18SetSizeAndFinalizeEjm.exit ], [ %7, %.lr.ph.preheader.a ] ; 3 uses
...
begin_hunk_3_@_ZN6duckdb12VariantUtils19FinalizeVariantKeysERNS_6VectorERNS_15OwningStringMapIjSt3mapINS_8string_tEjSt4lessIS5_ESaISt4pairIKS5_jEEEEERNS_15SelectionVectorEm:bb.a
  ...
  br i1 %exitcond.not, label %.loopexit, label %.lr.ph53, !llvm.loop !97
...
.loopexit:                                        ; preds = %bb.e, %_ZNSt6vectorIjSaIjEE17_S_check_init_lenEmRKS0_.exit.i.i, %._crit_edge
  %8 = load ptr, ptr %4, align 8, !tbaa !60       ; 2 uses
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.d = load ptr, ptr %0, align 8, !tbaa !471    ; 4 uses
...
_ZNSt12_Vector_baseIN6duckdb5ValueESaIS1_EE11_M_allocateEm.exit: ; preds = %bb.c
  ...
  %i.k = load ptr, ptr %i.j, align 8, !tbaa !472  ; 3 uses
...
.lr.ph.i.i.i.i:                                   ; preds = %_ZNSt12_Vector_baseIN6duckdb5ValueESaIS1_EE11_M_allocateEm.exit, %.lr.ph.i.i.i.i
  ...
  %.0911.i.i.i.i = phi ptr [ %i.p, %.lr.ph.i.i.i.i ], [ %i.d, %_ZNSt12_Vector_baseIN6duckdb5ValueESaIS1_EE11_M_allocateEm.exit ] ; 3 uses
...
_ZNSt6vectorIN6duckdb5ValueESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit: ; preds = %_ZNSt6vectorIN6duckdb5ValueESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit.loopexit, %_ZNSt12_Vector_baseIN6duckdb5ValueESaIS1_EE11_M_allocateEm.exit
  %i.r = phi ptr [ %.pre, %_ZNSt6vectorIN6duckdb5ValueESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit.loopexit ], [ %i.d, %_ZNSt12_Vector_baseIN6duckdb5ValueESaIS1_EE11_M_allocateEm.exit ] ; 2 uses
