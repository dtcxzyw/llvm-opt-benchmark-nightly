...
begin_hunk_5_@base_block_alloc:bb.a
  ...
  store ptr null, ptr %i.dx, align 8, !tbaa !51
...
begin_hunk_6_@base_block_alloc:bb.a
  ...
  store i64 %i.eb, ptr %i.eg, align 8, !tbaa !53
...
ehooks_pre_reentrancy.exit.i35:                   ; preds = %bb.ad, %tsd_fetch_impl.exit.i.i34
  %i.cf = load ptr, ptr %i.bq, align 8, !tbaa !58
  %.val.i36 = load i32, ptr %1, align 8, !tbaa !44
  %i.cg = tail call zeroext i1 %i.cf(ptr noundef %i.bn, ptr noundef %2, i64 noundef %3, i64 noundef 0, i64 noundef %3, i32 noundef %.val.i36) #10, !inline_history !59 ; 2 uses
...
bb.ai:                                            ; preds = %ehooks_purge_forced.exit.thread
  ...
  %i.cu = load ptr, ptr %i.ct, align 8, !tbaa !60
...
ehooks_pre_reentrancy.exit.i42:                   ; preds = %bb.am, %tsd_fetch_impl.exit.i.i41
  %i.di = load ptr, ptr %i.ct, align 8, !tbaa !60
  %.val.i43 = load i32, ptr %1, align 8, !tbaa !44
  %i.dj = tail call zeroext i1 %i.di(ptr noundef %i.cq, ptr noundef %2, i64 noundef %3, i64 noundef 0, i64 noundef %3, i32 noundef %.val.i43) #10, !inline_history !61 ; 0 uses
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.au = load i8, ptr %i.at, align 8, !tbaa !30, !range !49, !noundef !50
...
begin_hunk_17_@base_alloc_impl:bb.a
  ...
  store ptr %i.bh, ptr %i.bi, align 8, !tbaa !51
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.by = load i8, ptr %i.bx, align 8, !tbaa !30, !range !49, !noundef !50
...
bb.r:                                             ; preds = %.loopexit
  ...
  %.2.val = load i64, ptr %i.cq, align 8, !tbaa !53
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.h = add i64 %i.g, %i.e
  store i64 %i.h, ptr %i.f, align 8, !tbaa !62
