...
begin_hunk_0_@_Z23mbedtls_mpi_core_randomPmmPKmmPFiPvPhmES2_:bb.a
  ...
  %i.aw = tail call noundef i32 %4(ptr noundef %5, ptr noundef %i.ad, i64 noundef %i.s) ; 2 uses
...
begin_hunk_1_@_Z23mbedtls_mpi_core_randomPmmPKmmPFiPvPhmES2_:bb.a
  ...
  br i1 %i.bg, label %middle.block68, label %vector.body63, !llvm.loop !46
...
begin_hunk_2_@_Z23mbedtls_mpi_core_randomPmmPKmmPFiPvPhmES2_:bb.a
  ...
  br i1 %exitcond.not.i, label %.lr.ph48.preheader.i, label %.lr.ph.i, !llvm.loop !47
...
begin_hunk_4_@_Z23mbedtls_mpi_core_randomPmmPKmmPFiPvPhmES2_:bb.a
  ...
  br i1 %.not42.i, label %_Z24mbedtls_mpi_core_shift_rPmmm.exit, label %.lr.ph52.i, !llvm.loop !49
...
begin_hunk_5_@_Z23mbedtls_mpi_core_randomPmmPKmmPFiPvPhmES2_:bb.a
  ...
  br i1 %i.en, label %_Z23mbedtls_mpi_core_bitlenPKmm.exit.thread.split, label %_Z28mbedtls_mpi_core_fill_randomPmmmPFiPvPhmES0_.exit.split, !llvm.loop !50
...
begin_hunk_6_@_ZL40mbedtls_mpi_core_exp_mod_optionally_safePmPKmS1_mS1_miS1_S_:bb.a
  ...
  br i1 %exitcond.not.i, label %_ZL25exp_mod_precompute_windowPKmS0_mmS0_mPmS1_.exit, label %.lr.ph.i, !llvm.loop !51
...
bb.f:                                             ; preds = %_ZL36exp_mod_table_lookup_optionally_safePmS_mmmi.exit.us, %_ZL25exp_mod_precompute_windowPKmS0_mmS0_mPmS1_.exit.split.us
  ...
  br i1 %or.cond.us, label %.split.us, label %_ZL25exp_mod_precompute_windowPKmS0_mmS0_mPmS1_.exit.split.us, !llvm.loop !52
...
begin_hunk_8_@_ZL40mbedtls_mpi_core_exp_mod_optionally_safePmPKmS1_mS1_miS1_S_:bb.a
  ...
  br i1 %niter107.ncmp.3, label %_ZL36exp_mod_table_lookup_optionally_safePmS_mmmi.exit.loopexit.unr-lcssa, label %_Z28mbedtls_mpi_core_cond_assignPmPKmmm.exit.us.i.i, !llvm.loop !53
...
begin_hunk_9_@_ZL40mbedtls_mpi_core_exp_mod_optionally_safePmPKmS1_mS1_miS1_S_:bb.a
  ...
  br i1 %exitcond.not.i.i, label %_ZL36exp_mod_table_lookup_optionally_safePmS_mmmi.exit, label %.split.i.i, !llvm.loop !53
...
begin_hunk_10_@_ZL40mbedtls_mpi_core_exp_mod_optionally_safePmPKmS1_mS1_miS1_S_:bb.a
  ...
  br i1 %epil.iter.cmp.not, label %_ZL36exp_mod_table_lookup_optionally_safePmS_mmmi.exit, label %_Z28mbedtls_mpi_core_cond_assignPmPKmmm.exit.us.i.i.epil, !llvm.loop !54
...
bb.h:                                             ; preds = %_ZL25exp_mod_precompute_windowPKmS0_mmS0_mPmS1_.exit.split, %_ZL36exp_mod_table_lookup_optionally_safePmS_mmmi.exit
  ...
  br i1 %or.cond, label %.split.us, label %_ZL25exp_mod_precompute_windowPKmS0_mmS0_mPmS1_.exit.split, !llvm.loop !52
...
!45 = !{!"short", !5, i64 0}
!46 = distinct !{!46, !8, !23, !24}
!47 = distinct !{!47, !8, !24, !23}
!48 = distinct !{!48, !8, !23, !24}
!49 = distinct !{!49, !8, !24, !23}
!50 = distinct !{!50, !8}
!51 = distinct !{!51, !8}
!52 = distinct !{!52, !8}
!53 = distinct !{!53, !8}
