...
vector.ph:                                        ; preds = %.lr.ph.i.i.i.i.i.i.preheader
  ...
  %i.bh = getelementptr i8, ptr %i.ar, i64 %i.bg  ; 2 uses
  %i.bi = getelementptr i8, ptr %i.av, i64 %i.bg
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.bj = shl i64 %index, 3                       ; 2 uses
  %next.gep = getelementptr i8, ptr %i.ar, i64 %i.bj ; 2 uses
  %next.gep44 = getelementptr i8, ptr %i.av, i64 %i.bj ; 2 uses
  %i.bk = getelementptr i8, ptr %next.gep44, i64 16
  %wide.load = load <2 x i64>, ptr %next.gep44, align 8, !tbaa !36
  %wide.load45 = load <2 x i64>, ptr %i.bk, align 8, !tbaa !36
  %i.bl = getelementptr i8, ptr %next.gep, i64 16
  store <2 x i64> %wide.load, ptr %next.gep, align 8, !tbaa !36
  store <2 x i64> %wide.load45, ptr %i.bl, align 8, !tbaa !36
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.bm = icmp eq i64 %index.next, %n.vec
  br i1 %i.bm, label %middle.block, label %vector.body, !llvm.loop !173
...
.lr.ph.i.i.i.i.i.i.preheader67:                   ; preds = %.lr.ph.i.i.i.i.i.i.preheader, %middle.block
  %.09.i.i.i.i.i.i.ph = phi ptr [ %i.ar, %.lr.ph.i.i.i.i.i.i.preheader ], [ %i.bh, %middle.block ]
  %.sroa.04.08.i.i.i.i.i.i.ph = phi ptr [ %i.av, %.lr.ph.i.i.i.i.i.i.preheader ], [ %i.bi, %middle.block ]
  br label %.lr.ph.i.i.i.i.i.i

.lr.ph.i.i.i.i.i.i:                               ; preds = %.lr.ph.i.i.i.i.i.i.preheader67, %.lr.ph.i.i.i.i.i.i
  %.09.i.i.i.i.i.i = phi ptr [ %i.bp, %.lr.ph.i.i.i.i.i.i ], [ %.09.i.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.i.preheader67 ] ; 2 uses
  %.sroa.04.08.i.i.i.i.i.i = phi ptr [ %i.bo, %.lr.ph.i.i.i.i.i.i ], [ %.sroa.04.08.i.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.i.preheader67 ] ; 2 uses
  %i.bn = load i64, ptr %.sroa.04.08.i.i.i.i.i.i, align 8, !tbaa !36
  store i64 %i.bn, ptr %.09.i.i.i.i.i.i, align 8, !tbaa !36
  %i.bo = getelementptr inbounds nuw i8, ptr %.sroa.04.08.i.i.i.i.i.i, i64 8 ; 2 uses
  %i.bp = getelementptr inbounds nuw i8, ptr %.09.i.i.i.i.i.i, i64 8 ; 2 uses
  %.not.i.i.i.i.i.i = icmp eq ptr %i.bo, %i.aw
...
.loopexit31:                                      ; preds = %.lr.ph.i.i.i.i.i.i, %middle.block, %.noexc15
  %.0.lcssa.i.i.i.i.i.i = phi ptr [ %i.ar, %.noexc15 ], [ %i.bh, %middle.block ], [ %i.bp, %.lr.ph.i.i.i.i.i.i ]
  ...
  %i.bu = load ptr, ptr %i.br, align 8, !tbaa !132 ; 2 uses
  ...
  %.not.i.i.i.i.i16 = icmp eq ptr %i.bt, %i.bu
  br i1 %.not.i.i.i.i.i16, label %.noexc26, label %bb.h

bb.h:                                             ; preds = %.loopexit31
  %i.by = icmp ugt i64 %i.bx, 9223372036854775800
  br i1 %i.by, label %.noexc.i.i.i24, label %_ZNSt15__new_allocatorIN6duckdb13PhysicalIndexEE8allocateEmPKv.exit.i.i.i.i.i17, !prof !26
...
_ZNSt15__new_allocatorIN6duckdb13PhysicalIndexEE8allocateEmPKv.exit.i.i.i.i.i17: ; preds = %bb.h
  %i.bz = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.bx) #24
...
.noexc26:                                         ; preds = %_ZNSt15__new_allocatorIN6duckdb13PhysicalIndexEE8allocateEmPKv.exit.i.i.i.i.i17, %.loopexit31
  %i.ca = phi ptr [ null, %.loopexit31 ], [ %i.bz, %_ZNSt15__new_allocatorIN6duckdb13PhysicalIndexEE8allocateEmPKv.exit.i.i.i.i.i17 ] ; 8 uses
  store ptr %i.ca, ptr %i.bq, align 8, !tbaa !132
  %i.cb = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  store ptr %i.ca, ptr %i.cb, align 8, !tbaa !172
  %i.cc = getelementptr inbounds nuw i8, ptr %i.ca, i64 %i.bx
  %i.cd = getelementptr inbounds nuw i8, ptr %0, i64 112
  store ptr %i.cc, ptr %i.cd, align 8, !tbaa !125
  %i.ce = load ptr, ptr %i.br, align 8, !tbaa !124 ; 6 uses
  %i.cf = load ptr, ptr %i.bs, align 8, !tbaa !124 ; 3 uses
  %.not7.i.i.i.i.i.i18 = icmp eq ptr %i.ce, %i.cf
...
.lr.ph.i.i.i.i.i.i19.preheader:                   ; preds = %.noexc26
  ...
  %i.ch = ptrtoaddr ptr %i.ca to i64
...
vector.ph51:                                      ; preds = %.lr.ph.i.i.i.i.i.i19.preheader
  %n.vec53 = and i64 %i.cn, 4611686018427387900   ; 3 uses
  %i.cp = shl i64 %n.vec53, 3                     ; 2 uses
  %i.cq = getelementptr i8, ptr %i.ca, i64 %i.cp  ; 2 uses
  %i.cr = getelementptr i8, ptr %i.ce, i64 %i.cp
...
vector.body54:                                    ; preds = %vector.body54, %vector.ph51
  ...
  %i.cs = shl i64 %index55, 3                     ; 2 uses
  %next.gep56 = getelementptr i8, ptr %i.ca, i64 %i.cs ; 2 uses
  %next.gep57 = getelementptr i8, ptr %i.ce, i64 %i.cs ; 2 uses
  %i.ct = getelementptr i8, ptr %next.gep57, i64 16
  %wide.load58 = load <2 x i64>, ptr %next.gep57, align 8, !tbaa !36
  %wide.load59 = load <2 x i64>, ptr %i.ct, align 8, !tbaa !36
  %i.cu = getelementptr i8, ptr %next.gep56, i64 16
  store <2 x i64> %wide.load58, ptr %next.gep56, align 8, !tbaa !36
  store <2 x i64> %wide.load59, ptr %i.cu, align 8, !tbaa !36
  %index.next60 = add nuw i64 %index55, 4         ; 2 uses
  %i.cv = icmp eq i64 %index.next60, %n.vec53
  br i1 %i.cv, label %middle.block61, label %vector.body54, !llvm.loop !175

middle.block61:                                   ; preds = %vector.body54
  %cmp.n62 = icmp eq i64 %i.cn, %n.vec53
...
.lr.ph.i.i.i.i.i.i19.preheader66:                 ; preds = %.lr.ph.i.i.i.i.i.i19.preheader, %middle.block61
  %.09.i.i.i.i.i.i20.ph = phi ptr [ %i.ca, %.lr.ph.i.i.i.i.i.i19.preheader ], [ %i.cq, %middle.block61 ]
  %.sroa.04.08.i.i.i.i.i.i21.ph = phi ptr [ %i.ce, %.lr.ph.i.i.i.i.i.i19.preheader ], [ %i.cr, %middle.block61 ]
  br label %.lr.ph.i.i.i.i.i.i19

.lr.ph.i.i.i.i.i.i19:                             ; preds = %.lr.ph.i.i.i.i.i.i19.preheader66, %.lr.ph.i.i.i.i.i.i19
  %.09.i.i.i.i.i.i20 = phi ptr [ %i.cy, %.lr.ph.i.i.i.i.i.i19 ], [ %.09.i.i.i.i.i.i20.ph, %.lr.ph.i.i.i.i.i.i19.preheader66 ] ; 2 uses
  %.sroa.04.08.i.i.i.i.i.i21 = phi ptr [ %i.cx, %.lr.ph.i.i.i.i.i.i19 ], [ %.sroa.04.08.i.i.i.i.i.i21.ph, %.lr.ph.i.i.i.i.i.i19.preheader66 ] ; 2 uses
  %i.cw = load i64, ptr %.sroa.04.08.i.i.i.i.i.i21, align 8, !tbaa !36
  store i64 %i.cw, ptr %.09.i.i.i.i.i.i20, align 8, !tbaa !36
  %i.cx = getelementptr inbounds nuw i8, ptr %.sroa.04.08.i.i.i.i.i.i21, i64 8 ; 2 uses
  %i.cy = getelementptr inbounds nuw i8, ptr %.09.i.i.i.i.i.i20, i64 8 ; 2 uses
  %.not.i.i.i.i.i.i22 = icmp eq ptr %i.cx, %i.cf
...
.loopexit:                                        ; preds = %.lr.ph.i.i.i.i.i.i19, %middle.block61, %.noexc26
  %.0.lcssa.i.i.i.i.i.i23 = phi ptr [ %i.ca, %.noexc26 ], [ %i.cq, %middle.block61 ], [ %i.cy, %.lr.ph.i.i.i.i.i.i19 ]
  store ptr %.0.lcssa.i.i.i.i.i.i23, ptr %i.cb, align 8, !tbaa !172
  ret void
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %_ZNSt6vectorIN6duckdb13PhysicalIndexESaIS1_EED2Ev.exit, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i, %bb.i
  %.pn.pn = phi { ptr, i32 } [ %i.cz, %bb.i ], [ %.pn, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i ], [ %.pn, %_ZNSt6vectorIN6duckdb13PhysicalIndexESaIS1_EED2Ev.exit ]
  %i.df = load ptr, ptr %i.d, align 8, !tbaa !18  ; 2 uses
  %i.dg = icmp eq ptr %i.df, %i.f
  br i1 %i.dg, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit30, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i28
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i28: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  call void @_ZdlPv(ptr noundef %i.df) #23
