...
bb.l:                                             ; preds = %_ZN6duckdb21TemplatedValidityMaskImE10SetInvalidEm.exit54, %_ZNK6duckdb15SelectionVector9get_indexEm.exit51
  %i.bm = load i64, ptr %i.t, align 8, !tbaa !370 ; 13 uses
...
begin_hunk_1_@_ZN6duckdb9dict_fsst25CompressedStringScanState16ScanToFlatVectorERNS_6VectorEmmm:bb.a
  ...
  %i.bu = ashr exact i64 %i.bt, 2                 ; 9 uses
  %i.bv = xor i64 %i.bm, -1
  %i.bw = add i64 %i.be, %i.bv
  %8 = tail call i64 @llvm.usub.sat.i64(i64 %i.bu, i64 %i.bm)
...
begin_hunk_2_@_ZN6duckdb9dict_fsst25CompressedStringScanState16ScanToFlatVectorERNS_6VectorEmmm:bb.a
  ...
  %9 = tail call i64 @llvm.usub.sat.i64(i64 %i.bu, i64 %i.bm)
...
begin_hunk_4_@_ZN6duckdb9dict_fsst25CompressedStringScanState16ScanToFlatVectorERNS_6VectorEmmm:bb.a
  ...
  %i.co = add nuw i64 %i.ci, 3
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.cp = add nuw i64 %i.ci, 4
...
begin_hunk_5_@_ZN6duckdb9dict_fsst25CompressedStringScanState16ScanToFlatVectorERNS_6VectorEmmm:bb.a
  ...
  %.not.i.i.i.prol = icmp ult i64 %.ph92, %i.bu
  br i1 %.not.i.i.i.prol, label %_ZN6duckdb6vectorIjLb1ESaIjEEixEm.exit.prol, label %.noexc.i, !prof !225
...
begin_hunk_6_@_ZN6duckdb9dict_fsst25CompressedStringScanState16ScanToFlatVectorERNS_6VectorEmmm:bb.a
  ...
  %i.cx = add nuw i64 %.ph92, 1                   ; 2 uses
...
begin_hunk_7_@_ZN6duckdb9dict_fsst25CompressedStringScanState16ScanToFlatVectorERNS_6VectorEmmm:bb.a
  ...
  store i64 %i.bu, ptr %i.c, align 8, !tbaa !46
  %.not.i.i.i = icmp ult i64 %i.dg, %i.bu
  br i1 %.not.i.i.i, label %_ZN6duckdb6vectorIjLb1ESaIjEEixEm.exit, label %.noexc.i, !prof !225
...
begin_hunk_8_@_ZN6duckdb9dict_fsst25CompressedStringScanState16ScanToFlatVectorERNS_6VectorEmmm:bb.a
  ...
  %i.du = add nuw i64 %i.dg, 1                    ; 4 uses
  store i64 %i.du, ptr %i.t, align 8, !tbaa !370
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c)
  store i64 %i.du, ptr %i.b, align 8, !tbaa !46
  store i64 %i.bu, ptr %i.c, align 8, !tbaa !46
  %.not.i.i.i.1 = icmp ult i64 %i.du, %i.bu
  br i1 %.not.i.i.i.1, label %_ZN6duckdb6vectorIjLb1ESaIjEEixEm.exit.1, label %.noexc.i, !prof !225
...
begin_hunk_9_@_ZN6duckdb9dict_fsst25CompressedStringScanState16ScanToFlatVectorERNS_6VectorEmmm:bb.a
  ...
  %i.dy = add nuw i64 %i.dg, 2                    ; 3 uses
...
_ZNK6duckdb15SelectionVector9get_indexEm.exit:    ; preds = %bb.b, %bb.c
  %i.o = phi i64 [ %i.n, %bb.c ], [ %.028, %bb.b ] ; 3 uses
  %i.p = add i64 %i.d, %i.o                       ; 4 uses
  %i.q = load i64, ptr %i.g, align 8, !tbaa !370  ; 13 uses
...
.lr.ph:                                           ; preds = %.preheader
  ...
  %i.u = load ptr, ptr %i.h, align 8, !tbaa !163  ; 5 uses
  ...
  %8 = tail call i64 @llvm.usub.sat.i64(i64 %i.y, i64 %i.q)
  %umin45 = tail call i64 @llvm.umin.i64(i64 %i.aa, i64 %8)
...
begin_hunk_14_@_ZN6duckdb9dict_fsst25CompressedStringScanState6SelectERNS_6VectorEmRKNS_15SelectionVectorEm:bb.a
  ...
  %9 = tail call i64 @llvm.usub.sat.i64(i64 %i.y, i64 %i.q)
  %umin = tail call i64 @llvm.umin.i64(i64 %i.ae, i64 %9)
...
begin_hunk_16_@_ZN6duckdb9dict_fsst25CompressedStringScanState6SelectERNS_6VectorEmRKNS_15SelectionVectorEm:bb.a
  ...
  %i.as = add nuw i64 %i.am, 3
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.at = add nuw i64 %i.am, 4
...
scalar.ph.preheader:                              ; preds = %vector.memcheck, %.lr.ph, %middle.block
  %.ph = phi i32 [ %.pre, %vector.memcheck ], [ %.pre, %.lr.ph ], [ %i.av, %middle.block ]
  %.ph48 = phi i64 [ %i.q, %vector.memcheck ], [ %i.q, %.lr.ph ], [ %i.aj, %middle.block ]
  br label %scalar.ph
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %_ZN6duckdb6vectorIjLb1ESaIjEEixEm.exit.a
  %i.bc = phi i32 [ %i.bq, %_ZN6duckdb6vectorIjLb1ESaIjEEixEm.exit.a ], [ %.ph, %scalar.ph.preheader ]
  %i.bd = phi i64 [ %i.br, %_ZN6duckdb6vectorIjLb1ESaIjEEixEm.exit.a ], [ %.ph48, %scalar.ph.preheader ] ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c)
  store i64 %i.bd, ptr %i.b, align 8, !tbaa !46
  store i64 %i.y, ptr %i.c, align 8, !tbaa !46
  %.not.i.i.i = icmp ult i64 %i.bd, %i.y
  br i1 %.not.i.i.i, label %_ZN6duckdb6vectorIjLb1ESaIjEEixEm.exit.a, label %.noexc.i, !prof !225
...
_ZN6duckdb6vectorIjLb1ESaIjEEixEm.exit.a:         ; preds = %scalar.ph
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c)
  %i.bo = getelementptr inbounds nuw [4 x i8], ptr %i.u, i64 %i.bd
  %i.bp = load i32, ptr %i.bo, align 4, !tbaa !3
  %i.bq = add i32 %i.bc, %i.bp                    ; 3 uses
  store i32 %i.bq, ptr %i.j, align 8, !tbaa !371
  %i.br = add nuw i64 %i.bd, 1                    ; 3 uses
...
._crit_edge:                                      ; preds = %_ZN6duckdb6vectorIjLb1ESaIjEEixEm.exit.a, %.preheader
  %10 = phi i32 [ %.pre, %.preheader ], [ %i.bq, %_ZN6duckdb6vectorIjLb1ESaIjEEixEm.exit.a ]
  %i.bs = tail call { i64, ptr } @_ZN6duckdb9dict_fsst25CompressedStringScanState19FetchStringFromDictERNS_6VectorEjm(ptr noundef nonnull align 8 dereferenceable(208) %0, ptr noundef nonnull align 8 dereferenceable(104) %1, i32 noundef %10, i64 noundef %i.p) ; 2 uses
