...
bb.g:                                             ; preds = %bb.f, %._crit_edge.i
  ...
  br i1 %i.v, label %_ZNSt8_Rb_treeIfSt4pairIKfmESt10_Select1stIS2_ESt4lessIfESaIS2_EE24_M_get_insert_unique_posERS1_.exit, label %3
...
bb.n:                                             ; preds = %bb.m, %._crit_edge.i18
  ...
  br i1 %i.ar, label %_ZNSt8_Rb_treeIfSt4pairIKfmESt10_Select1stIS2_ESt4lessIfESaIS2_EE24_M_get_insert_unique_posERS1_.exit, label %4
...
bb.u:                                             ; preds = %bb.t, %._crit_edge.i36
  ...
  br i1 %i.bm, label %_ZNSt8_Rb_treeIfSt4pairIKfmESt10_Select1stIS2_ESt4lessIfESaIS2_EE24_M_get_insert_unique_posERS1_.exit, label %5

5:                                                ; preds = %bb.u
  br label %_ZNSt8_Rb_treeIfSt4pairIKfmESt10_Select1stIS2_ESt4lessIfESaIS2_EE24_M_get_insert_unique_posERS1_.exit

_ZNSt8_Rb_treeIfSt4pairIKfmESt10_Select1stIS2_ESt4lessIfESaIS2_EE24_M_get_insert_unique_posERS1_.exit: ; preds = %5, %bb.u, %._crit_edge.thread.i43, %4, %bb.n, %._crit_edge.thread.i25, %3, %bb.g, %._crit_edge.thread.i, %bb.r, %bb.k, %bb.o, %bb.p, %bb.i, %bb.c
...
bb.g:                                             ; preds = %bb.f, %._crit_edge.i
  ...
  br i1 %i.v, label %_ZNSt8_Rb_treeIdSt4pairIKdmESt10_Select1stIS2_ESt4lessIdESaIS2_EE24_M_get_insert_unique_posERS1_.exit, label %3
...
bb.n:                                             ; preds = %bb.m, %._crit_edge.i18
  ...
  br i1 %i.ar, label %_ZNSt8_Rb_treeIdSt4pairIKdmESt10_Select1stIS2_ESt4lessIdESaIS2_EE24_M_get_insert_unique_posERS1_.exit, label %4
...
bb.u:                                             ; preds = %bb.t, %._crit_edge.i36
  ...
  br i1 %i.bm, label %_ZNSt8_Rb_treeIdSt4pairIKdmESt10_Select1stIS2_ESt4lessIdESaIS2_EE24_M_get_insert_unique_posERS1_.exit, label %5

5:                                                ; preds = %bb.u
  br label %_ZNSt8_Rb_treeIdSt4pairIKdmESt10_Select1stIS2_ESt4lessIdESaIS2_EE24_M_get_insert_unique_posERS1_.exit

_ZNSt8_Rb_treeIdSt4pairIKdmESt10_Select1stIS2_ESt4lessIdESaIS2_EE24_M_get_insert_unique_posERS1_.exit: ; preds = %5, %bb.u, %._crit_edge.thread.i43, %4, %bb.n, %._crit_edge.thread.i25, %3, %bb.g, %._crit_edge.thread.i, %bb.r, %bb.k, %bb.o, %bb.p, %bb.i, %bb.c
  %.sroa.066.2 = phi ptr [ null, %bb.p ], [ %spec.select, %bb.k ], [ null, %bb.c ], [ %spec.select68, %bb.r ], [ null, %bb.g ], [ %i.ab, %bb.i ], [ %1, %bb.o ], [ null, %bb.n ], [ %.sroa.05.0.i, %3 ], [ null, %._crit_edge.thread.i ], [ %.sroa.05.0.i20, %4 ], [ null, %._crit_edge.thread.i25 ], [ %.sroa.05.0.i38, %5 ], [ null, %._crit_edge.thread.i43 ], [ null, %bb.u ]
  %.sroa.12.2 = phi ptr [ %i.au, %bb.p ], [ %spec.select67, %bb.k ], [ %i.f, %bb.c ], [ %spec.select69, %bb.r ], [ %.019.lcssa27.i, %bb.g ], [ %i.ab, %bb.i ], [ null, %bb.o ], [ %.019.lcssa27.i19, %bb.n ], [ null, %3 ], [ %.019.lcssa28.i.a, %._crit_edge.thread.i ], [ null, %4 ], [ %.019.lcssa28.i26, %._crit_edge.thread.i25 ], [ null, %5 ], [ %.019.lcssa28.i44, %._crit_edge.thread.i43 ], [ %.019.lcssa27.i37, %bb.u ]
  %.fca.0.insert = insertvalue { ptr, ptr } poison, ptr %.sroa.066.2, 0
  %.fca.1.insert = insertvalue { ptr, ptr } %.fca.0.insert, ptr %.sroa.12.2, 1
