...
define void @_ZNK6duckdb25RadixPartitionedHashTable11GetProgressERNS_13ClientContextERNS_15GlobalSinkStateERNS_17GlobalSourceStateE(ptr dead_on_unwind noalias writable sret(%"struct.duckdb::ProgressData") align 8 captures(none) initializes((8, 17)) %0, ptr noundef nonnull readnone align 8 captures(none) dereferenceable(112) %1, ptr noundef nonnull readnone align 8 captures(none) dereferenceable(512) %2, ptr noundef nonnull readonly align 8 captures(none) dereferenceable(81) %3, ptr noundef nonnull readonly align 8 captures(none) dereferenceable(80) %4) local_unnamed_addr #0 align 2 {
bb.a:
...
._crit_edge:                                      ; preds = %.lr.ph, %bb.a
  %.lcssa = phi double [ 0.000000e+00, %bb.a ], [ %i.v, %.lr.ph ] ; 2 uses
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  %6 = phi double [ %i.v, %.lr.ph ], [ 0.000000e+00, %bb.a ]
  ...
  %i.v = tail call double @llvm.fmuladd.f64(double %i.u, double 2.000000e+00, double %6) ; 2 uses
