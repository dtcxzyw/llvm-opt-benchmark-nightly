...
begin_hunk_0_@_ZN10duckdb_lz4L22LZ4_decompress_genericEPKcPciiNS_18earlyEnd_directiveENS_14dict_directiveEPKhS6_m:bb.a
  br i1 %or.cond584, label %_ZN10duckdb_lz4L14LZ4_wildCopy32EPvPKvS0_.exit.thread, label %.loopexit595, !prof !68
...
vector.body1027:                                  ; preds = %vector.body1027, %vector.ph1025
  ...
  br i1 %i.hk, label %middle.block1034, label %vector.body1027, !llvm.loop !51
...
.preheader593:                                    ; preds = %.preheader593.preheader1196, %.preheader593
  ...
  br i1 %i.ie, label %.preheader593, label %_ZN10duckdb_lz4L13LZ4_wildCopy8EPvPKvS0_.exit, !llvm.loop !52
...
_ZN10duckdb_lz4L13LZ4_wildCopy8EPvPKvS0_.exit:    ; preds = %.preheader593, %middle.block1034, %bb.as
  ...
  %.val = load i16, ptr %.7542, align 1, !tbaa !8
...
bb.at:                                            ; preds = %.loopexit596
  ...
  br i1 %exitcond.i5101001.not, label %.lr.ph1004, label %_ZN10duckdb_lz4L14LZ4_wildCopy32EPvPKvS0_.exit.thread, !prof !23

bb.au:                                            ; preds = %.lr.ph1004
  %i.iq = getelementptr inbounds nuw i8, ptr %i.ir, i64 1 ; 2 uses
  %exitcond.i510 = icmp eq ptr %i.ir, %scevgep.i508
  br i1 %exitcond.i510, label %_ZN10duckdb_lz4L14LZ4_wildCopy32EPvPKvS0_.exit.thread, label %.lr.ph1004, !prof !67, !llvm.loop !44
...
.lr.ph1004:                                       ; preds = %bb.at, %bb.au
  ...
  %i.it = load i8, ptr %i.is, align 1, !tbaa !8   ; 2 uses
  %i.iu = zext i8 %i.it to i64
  %i.iv = add i64 %.0.i5091002, %i.iu             ; 3 uses
  %i.iw = icmp eq i8 %i.it, -1
  br i1 %i.iw, label %bb.au, label %_ZN10duckdb_lz4L20read_variable_lengthEPPKhS1_i.exit511, !llvm.loop !44
...
.loopexit604:                                     ; preds = %bb.s, %bb.t, %bb.av
  ...
  %.103951038 = ptrtoaddr ptr %.10395 to i64      ; 17 uses
  %i.jd = getelementptr inbounds nuw i8, ptr %.1374, i64 %8
  %i.je = icmp ult ptr %i.jd, %6
  %or.cond471 = select i1 %i.j, i1 %i.je, i1 false, !prof !69
  br i1 %or.cond471, label %_ZN10duckdb_lz4L14LZ4_wildCopy32EPvPKvS0_.exit.thread, label %bb.aw, !prof !69
...
bb.ax:                                            ; preds = %bb.aw
  ...
  br i1 %i.jj, label %bb.ay, label %bb.ba, !prof !18
...
vector.body1157:                                  ; preds = %vector.body1157, %vector.ph1155
  ...
  %wide.load1161 = load <16 x i8>, ptr %next.gep1159, align 1, !tbaa !8
  %wide.load1162 = load <16 x i8>, ptr %i.km, align 1, !tbaa !8
  %i.kn = getelementptr i8, ptr %next.gep1160, i64 16
  store <16 x i8> %wide.load1161, ptr %next.gep1160, align 1, !tbaa !8
  store <16 x i8> %wide.load1162, ptr %i.kn, align 1, !tbaa !8
  %index.next1163 = add nuw i64 %index1158, 32    ; 2 uses
  %i.ko = icmp eq i64 %index.next1163, %n.vec1156
  br i1 %i.ko, label %middle.block1164, label %vector.body1157, !llvm.loop !53
...
vec.epilog.iter.check1171:                        ; preds = %middle.block1164
  ...
  br i1 %min.epilog.iters.check1172, label %.lr.ph674.preheader, label %vec.epilog.ph1173, !prof !24
...
vec.epilog.vector.body1175:                       ; preds = %vec.epilog.vector.body1175, %vec.epilog.ph1173
  ...
  %wide.load1179 = load <4 x i8>, ptr %next.gep1177, align 1, !tbaa !8
  store <4 x i8> %wide.load1179, ptr %next.gep1178, align 1, !tbaa !8
  %index.next1180 = add nuw i64 %index1176, 4     ; 2 uses
  %i.kr = icmp eq i64 %index.next1180, %n.vec1174
  br i1 %i.kr, label %vec.epilog.middle.block1181, label %vec.epilog.vector.body1175, !llvm.loop !54
...
.lr.ph674:                                        ; preds = %.lr.ph674.preheader, %.lr.ph674
  ...
  %i.kt = load i8, ptr %.0672, align 1, !tbaa !8
  %i.ku = getelementptr inbounds nuw i8, ptr %.11396671, i64 1 ; 3 uses
  store i8 %i.kt, ptr %.11396671, align 1, !tbaa !8
  %i.kv = icmp ult ptr %i.ku, %i.ka
  br i1 %i.kv, label %.lr.ph674, label %.loopexit, !llvm.loop !55
...
.loopexit:                                        ; preds = %.lr.ph674, %middle.block1164, %vec.epilog.middle.block1181, %bb.bd, %bb.bb
  ...
  br label %.preheader594, !llvm.loop !50
...
vector.body1120:                                  ; preds = %vector.body1120, %vector.ph1118
  ...
  %wide.load1124 = load <16 x i8>, ptr %next.gep1122, align 1, !tbaa !8
  %wide.load1125 = load <16 x i8>, ptr %i.lm, align 1, !tbaa !8
  %i.ln = getelementptr i8, ptr %next.gep1123, i64 16
  store <16 x i8> %wide.load1124, ptr %next.gep1123, align 1, !tbaa !8
  store <16 x i8> %wide.load1125, ptr %i.ln, align 1, !tbaa !8
  %index.next1126 = add nuw i64 %index1121, 32    ; 2 uses
  %i.lo = icmp eq i64 %index.next1126, %n.vec1119
  br i1 %i.lo, label %middle.block1127, label %vector.body1120, !llvm.loop !56
...
vec.epilog.iter.check1134:                        ; preds = %middle.block1127
  ...
  br i1 %min.epilog.iters.check1135, label %.lr.ph670.preheader, label %vec.epilog.ph1136, !prof !24
...
vec.epilog.vector.body1138:                       ; preds = %vec.epilog.vector.body1138, %vec.epilog.ph1136
  ...
  %wide.load1142 = load <4 x i8>, ptr %next.gep1140, align 1, !tbaa !8
  store <4 x i8> %wide.load1142, ptr %next.gep1141, align 1, !tbaa !8
  %index.next1143 = add nuw i64 %index1139, 4     ; 2 uses
  %i.lr = icmp eq i64 %index.next1143, %n.vec1137
  br i1 %i.lr, label %vec.epilog.middle.block1144, label %vec.epilog.vector.body1138, !llvm.loop !57
...
.lr.ph670:                                        ; preds = %.lr.ph670.preheader, %.lr.ph670
  ...
  %i.lt = load i8, ptr %.2375669, align 1, !tbaa !8
  %i.lu = getelementptr inbounds nuw i8, ptr %.14668, i64 1 ; 2 uses
  store i8 %i.lt, ptr %.14668, align 1, !tbaa !8
  %i.lv = icmp ult ptr %i.lu, %i.ld
  br i1 %i.lv, label %.lr.ph670, label %.loopexit590, !llvm.loop !58
...
.preheader594:                                    ; preds = %.loopexit, %_ZN10duckdb_lz4L13LZ4_wildCopy8EPvPKvS0_.exit517, %bb.g, %.loopexit590
  ...
  %i.ly = load i8, ptr %.4.ph, align 1, !tbaa !8
...
.lr.ph649.split.us:                               ; preds = %.lr.ph649, %bb.bi
  ...
  br i1 %i.mh, label %bb.bh, label %.loopexit595, !prof !22
...
bb.bh:                                            ; preds = %.lr.ph649.split.us
  ...
  %.val480.us = load i16, ptr %i.mj, align 1, !tbaa !8 ; 2 uses
...
bb.bi:                                            ; preds = %bb.bh
  ...
  %i.nc = load i8, ptr %i.mn, align 1, !tbaa !8
  %i.nd = zext i8 %i.nc to i32                    ; 3 uses
  %i.ne = lshr i32 %i.nd, 4                       ; 2 uses
  %i.nf = zext nneg i32 %i.ne to i64
  %cond.us = icmp eq i32 %i.ne, 15
  br i1 %cond.us, label %._crit_edge, label %.lr.ph649.split.us, !llvm.loop !50

bb.bj:                                            ; preds = %bb.be
  %i.ng = icmp ult i64 %.1372, 8
  br i1 %i.ng, label %bb.bk, label %bb.bl, !prof !18

bb.bk:                                            ; preds = %bb.bj
  store i32 0, ptr %.10395, align 1, !tbaa !8
  %i.nh = load i8, ptr %.1374, align 1, !tbaa !8
  store i8 %i.nh, ptr %.10395, align 1, !tbaa !8
  %i.ni = getelementptr inbounds nuw i8, ptr %.1374, i64 1
  %i.nj = load i8, ptr %i.ni, align 1, !tbaa !8
  %i.nk = getelementptr inbounds nuw i8, ptr %.10395, i64 1
  store i8 %i.nj, ptr %i.nk, align 1, !tbaa !8
  %i.nl = getelementptr inbounds nuw i8, ptr %.1374, i64 2
  %i.nm = load i8, ptr %i.nl, align 1, !tbaa !8
  %i.nn = getelementptr inbounds nuw i8, ptr %.10395, i64 2
  store i8 %i.nm, ptr %i.nn, align 1, !tbaa !8
  %i.no = getelementptr inbounds nuw i8, ptr %.1374, i64 3
  %i.np = load i8, ptr %i.no, align 1, !tbaa !8
  %i.nq = getelementptr inbounds nuw i8, ptr %.10395, i64 3
  store i8 %i.np, ptr %i.nq, align 1, !tbaa !8
  ...
  %i.ny = load i32, ptr %i.nx, align 4, !tbaa !7
...
bb.bm:                                            ; preds = %bb.bl, %bb.bk
  ...
  br i1 %i.ky, label %bb.bn, label %bb.bq, !prof !18
...
vector.body1062:                                  ; preds = %vector.body1062, %vector.ph1060
  ...
  br i1 %i.ow, label %middle.block1069, label %vector.body1062, !llvm.loop !59
...
.preheader591:                                    ; preds = %.preheader591.preheader1189, %.preheader591
  ...
  br i1 %i.pa, label %.preheader591, label %_ZN10duckdb_lz4L13LZ4_wildCopy8EPvPKvS0_.exit514, !llvm.loop !60
...
vector.body1082:                                  ; preds = %vector.body1082, %vector.ph1080
  ...
  %wide.load1086 = load <16 x i8>, ptr %next.gep1084, align 1, !tbaa !8
  %wide.load1087 = load <16 x i8>, ptr %i.pq, align 1, !tbaa !8
  %i.pr = getelementptr i8, ptr %next.gep1085, i64 16
  store <16 x i8> %wide.load1086, ptr %next.gep1085, align 1, !tbaa !8
  store <16 x i8> %wide.load1087, ptr %i.pr, align 1, !tbaa !8
  %index.next1088 = add nuw i64 %index1083, 32    ; 2 uses
  %i.ps = icmp eq i64 %index.next1088, %n.vec1081
  br i1 %i.ps, label %middle.block1089, label %vector.body1082, !llvm.loop !61
...
vec.epilog.iter.check1096:                        ; preds = %middle.block1089
  ...
  br i1 %min.epilog.iters.check1097, label %.lr.ph667.preheader, label %vec.epilog.ph1098, !prof !24
...
vec.epilog.vector.body1100:                       ; preds = %vec.epilog.vector.body1100, %vec.epilog.ph1098
  ...
  %wide.load1104 = load <4 x i8>, ptr %next.gep1102, align 1, !tbaa !8
  store <4 x i8> %wide.load1104, ptr %next.gep1103, align 1, !tbaa !8
  %index.next1105 = add nuw i64 %index1101, 4     ; 2 uses
  %i.pv = icmp eq i64 %index.next1105, %n.vec1099
  br i1 %i.pv, label %vec.epilog.middle.block1106, label %vec.epilog.vector.body1100, !llvm.loop !62
...
.lr.ph667:                                        ; preds = %.lr.ph667.preheader, %.lr.ph667
  ...
  %i.px = load i8, ptr %.5378665, align 1, !tbaa !8
  %i.py = getelementptr inbounds nuw i8, ptr %.16664, i64 1 ; 2 uses
  store i8 %i.px, ptr %.16664, align 1, !tbaa !8
  %i.pz = icmp ult ptr %i.py, %i.jh
  br i1 %i.pz, label %.lr.ph667, label %_ZN10duckdb_lz4L13LZ4_wildCopy8EPvPKvS0_.exit517, !llvm.loop !63
...
vector.body1045:                                  ; preds = %vector.body1045, %vector.ph1043
  ...
  br i1 %i.qt, label %middle.block1052, label %vector.body1045, !llvm.loop !64
...
bb.f:                                             ; preds = %bb.e
  store i32 0, ptr %0, align 1, !tbaa !8
...
.lr.ph.preheader:                                 ; preds = %bb.i
  ...
  %4 = add i64 %i.ax, 16
  %5 = tail call i64 @llvm.umax.i64(i64 %i.aw, i64 %4)
  %i.ay = add i64 %5, -9
...
!11 = !{!"p1 _ZTSN10duckdb_lz421LZ4_stream_t_internalE", !9, i64 0}
!12 = !{!"_ZTSN10duckdb_lz421LZ4_stream_t_internalE", !5, i64 0, !10, i64 16384, !11, i64 16392, !6, i64 16400, !6, i64 16404, !6, i64 16408}
!13 = !{!12, !6, i64 16400}
!14 = !{!12, !11, i64 16392}
!15 = !{!12, !10, i64 16384}
!16 = !{!12, !6, i64 16408}
...
!26 = !{!"long", !5, i64 0}
!27 = !{!"_ZTSN10duckdb_lz427LZ4_streamDecode_t_internalE", !10, i64 0, !10, i64 8, !26, i64 16, !26, i64 24}
!28 = !{!27, !26, i64 24}
!29 = !{!27, !10, i64 8}
!30 = !{!27, !10, i64 0}
!31 = !{!27, !26, i64 16}
...
!37 = !{!"short", !5, i64 0}
!38 = !{!37, !37, i64 0}
!39 = !{!"branch_weights", i32 255873, i32 127}
!40 = distinct !{!40, !19}
