...
.lr.ph.preheader:                                 ; preds = %bb.b
  ...
  %3 = load <2 x i32>, ptr %i.h, align 4
...
.critedge.i:                                      ; preds = %bb.c, %.lr.ph.preheader
  ...
  %.sroa.5.0..sroa_idx7.i = getelementptr inbounds i8, ptr %i.e, i64 %.0.in.i.lcssa
  store <2 x i32> %3, ptr %.sroa.5.0..sroa_idx7.i, align 4
...
.lr.ph.1:                                         ; preds = %.critedge.i
  ...
  %4 = load <2 x i32>, ptr %i.n, align 4
...
.critedge.i.1:                                    ; preds = %bb.e, %bb.d, %.lr.ph.1
  ...
  %.sroa.5.0..sroa_idx7.i.1 = getelementptr inbounds i8, ptr %i.e, i64 %.0.in.i.lcssa.1
  store <2 x i32> %4, ptr %.sroa.5.0..sroa_idx7.i.1, align 4
...
.lr.ph.2:                                         ; preds = %.critedge.i.1
  ...
  %5 = load <2 x i32>, ptr %i.y, align 4
...
.critedge.i.2:                                    ; preds = %bb.h, %bb.g, %bb.f, %.lr.ph.2
  ...
  %.sroa.5.0..sroa_idx7.i.2 = getelementptr inbounds i8, ptr %i.e, i64 %.0.in.i.lcssa.2
  store <2 x i32> %5, ptr %.sroa.5.0..sroa_idx7.i.2, align 4
...
.lr.ph.3:                                         ; preds = %.critedge.i.2
  ...
  %6 = load <2 x i32>, ptr %i.ao, align 4
  %i.ap = load i32, ptr %i.ao, align 4, !tbaa !3  ; 4 uses
...
.critedge.i.3:                                    ; preds = %bb.l, %bb.k, %bb.j, %bb.i, %.lr.ph.3
  ...
  %.sroa.5.0..sroa_idx7.i.3 = getelementptr inbounds i8, ptr %i.e, i64 %.0.in.i.lcssa.3
  store <2 x i32> %6, ptr %.sroa.5.0..sroa_idx7.i.3, align 4
...
.lr.ph.4:                                         ; preds = %.critedge.i.3
  ...
  %7 = load <2 x i32>, ptr %i.bj, align 4
...
.critedge.i.4:                                    ; preds = %bb.q, %bb.p, %bb.o, %bb.n, %bb.m, %.lr.ph.4
  ...
  %.sroa.5.0..sroa_idx7.i.4 = getelementptr inbounds i8, ptr %i.e, i64 %.0.in.i.lcssa.4
  store <2 x i32> %7, ptr %.sroa.5.0..sroa_idx7.i.4, align 4
...
.lr.ph.5:                                         ; preds = %.critedge.i.4
  ...
  %8 = load <2 x i32>, ptr %i.cj, align 4
  %i.ck = load i32, ptr %i.cj, align 4, !tbaa !3  ; 6 uses
  %i.cl = getelementptr inbounds nuw i8, ptr %i.e, i64 40 ; 2 uses
  %i.cm = load i32, ptr %i.cl, align 4, !tbaa !40
  %i.cn = icmp ult i32 %i.cm, %i.ck
...
.critedge.i.5:                                    ; preds = %bb.w, %bb.v, %bb.u, %bb.t, %bb.s, %bb.r, %.lr.ph.5
  ...
  %.sroa.5.0..sroa_idx7.i.5 = getelementptr inbounds i8, ptr %i.e, i64 %.0.in.i.lcssa.5
  store <2 x i32> %8, ptr %.sroa.5.0..sroa_idx7.i.5, align 4
...
.lr.ph.6:                                         ; preds = %.critedge.i.5
  ...
  %9 = load <2 x i32>, ptr %i.do, align 4
  %i.dp = load i32, ptr %i.do, align 4, !tbaa !3  ; 7 uses
  %i.dq = getelementptr inbounds nuw i8, ptr %i.e, i64 48 ; 2 uses
  %i.dr = load i32, ptr %i.dq, align 4, !tbaa !40
  %i.ds = icmp ult i32 %i.dr, %i.dp
...
.critedge.i.6:                                    ; preds = %bb.ad, %bb.ac, %bb.ab, %bb.aa, %bb.z, %bb.y, %bb.x, %.lr.ph.6
  ...
  %.sroa.5.0..sroa_idx7.i.6 = getelementptr inbounds i8, ptr %i.e, i64 %.0.in.i.lcssa.6
  store <2 x i32> %9, ptr %.sroa.5.0..sroa_idx7.i.6, align 4
