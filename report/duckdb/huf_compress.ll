...
bb.d:                                             ; preds = %bb.c
  ...
  %i.t = trunc nuw nsw i32 %i.m to i8             ; 2 uses
...
vector.ph:                                        ; preds = %.lr.ph59
  ...
  %broadcast.splatinsert = insertelement <2 x i8> poison, i8 %5, i64 0
...
begin_hunk_2_@_ZN11duckdb_zstd14HUF_readCTableEPmPjPKvmS1_:bb.a
  ...
  %i.af = select <2 x i1> %i.ad, <2 x i8> zeroinitializer, <2 x i8> %i.ab
...
begin_hunk_3_@_ZN11duckdb_zstd14HUF_readCTableEPmPjPKvmS1_:bb.a
  ...
  %narrow = select i1 %.not53, i8 0, i8 %i.ba
...
begin_hunk_6_@_ZN11duckdb_zstdL35HUF_compress4X_usingCTable_internalEPvmPKvmPKmi:bb.a
  ...
  %gepdiff127.a = sub i64 %gepdiff, %i.h
  %i.n = tail call fastcc noundef i64 @_ZN11duckdb_zstdL35HUF_compress1X_usingCTable_internalEPvmPKvmPKmi(ptr noundef nonnull %i.l, i64 noundef %gepdiff127.a, ptr noundef %i.m, i64 noundef %i.b, ptr noundef %4, i32 noundef %5) ; 6 uses
...
begin_hunk_7_@_ZN11duckdb_zstdL35HUF_compress4X_usingCTable_internalEPvmPKvmPKmi:bb.a
  ...
  %gepdiff128.a = sub i64 %gepdiff, %i.u
  %i.v = tail call fastcc noundef i64 @_ZN11duckdb_zstdL35HUF_compress1X_usingCTable_internalEPvmPKvmPKmi(ptr noundef nonnull %i.s, i64 noundef %gepdiff128.a, ptr noundef %i.t, i64 noundef %i.b, ptr noundef %4, i32 noundef %5) ; 5 uses
