...
begin_hunk_0_@_ZN6duckdb28RewriteCorrelatedExpressions12VisitReplaceERNS_23BoundSubqueryExpressionEPNS_10unique_ptrINS_10ExpressionESt14default_deleteIS4_ELb1EEE:bb.a
  ...
  call void %i.o(ptr noundef nonnull align 8 dereferenceable(32) %4, ptr noundef nonnull align 8 dereferenceable(97) %i.l)
...
.lr.ph:                                           ; preds = %bb.b
  ...
  %i.j = load ptr, ptr %i.i, align 8, !tbaa !874, !nonnull !50, !align !51 ; 4 uses
...
_ZNSt13unordered_mapIN6duckdb13ColumnBindingEmNS0_25ColumnBindingHashFunctionENS0_21ColumnBindingEqualityESaISt4pairIKS1_mEEE4findERS5_.exit: ; preds = %_ZNKSt8__detail15_Hashtable_baseIN6duckdb13ColumnBindingESt4pairIKS2_mENS_10_Select1stENS1_21ColumnBindingEqualityENS1_25ColumnBindingHashFunctionENS_18_Mod_range_hashingENS_20_Default_ranged_hashENS_17_Hashtable_traitsILb1ELb0ELb1EEEE9_M_equalsERS4_mRKNS_16_Hash_node_valueIS5_Lb1EEE.exit.i.i.i.i, %bb.f
  ...
  %i.bm = load i64, ptr %i.n, align 8, !tbaa !876
  %i.bn = load i64, ptr %i.o, align 8, !tbaa !877
...
bb.a:
  ...
  %i.c = load i8, ptr %i.b, align 8, !tbaa !878
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !874, !nonnull !50, !align !51 ; 4 uses
...
_ZNSt13unordered_mapIN6duckdb13ColumnBindingEmNS0_25ColumnBindingHashFunctionENS0_21ColumnBindingEqualityESaISt4pairIKS1_mEEE4findERS5_.exit: ; preds = %_ZNKSt8__detail15_Hashtable_baseIN6duckdb13ColumnBindingESt4pairIKS2_mENS_10_Select1stENS1_21ColumnBindingEqualityENS1_25ColumnBindingHashFunctionENS_18_Mod_range_hashingENS_20_Default_ranged_hashENS_17_Hashtable_traitsILb1ELb0ELb1EEEE9_M_equalsERS4_mRKNS_16_Hash_node_valueIS5_Lb1EEE.exit.i.i.i.i, %bb.f
  ...
  %i.bl = load i64, ptr %i.bk, align 8, !tbaa !876
  %i.bm = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.bn = load i64, ptr %i.bm, align 8, !tbaa !877
  %i.bo = getelementptr inbounds nuw i8, ptr %.sroa.06.1.i.i, i64 24
  %i.bp = load i64, ptr %i.bo, align 8, !tbaa !358
  %i.bq = add i64 %i.bp, %i.bn
end_hunk_5
begin_hunk_6_@_ZN6duckdb26RewriteCorrelatedRecursive15VisitExpressionEPNS_10unique_ptrINS_10ExpressionESt14default_deleteIS2_ELb1EEE:bb.a
  ...
  tail call void %i.bz(ptr noundef nonnull align 8 dereferenceable(32) %0, ptr noundef nonnull align 8 dereferenceable(97) %i.bw), !inline_history !879
...
!873 = !{!348, !348, i64 0}
!874 = !{!875, !348, i64 24}
!875 = !{!"_ZTSN6duckdb26RewriteCorrelatedRecursiveE", !347, i64 0, !28, i64 8, !348, i64 24}
!876 = !{!875, !14, i64 8}
!877 = !{!875, !14, i64 16}
!878 = !{!158, !144, i64 8}
!879 = !{ptr @_ZN6duckdb26RewriteCorrelatedRecursive25RewriteCorrelatedSubqueryERNS_6BinderERNS_15LogicalOperatorE}
!880 = !{!881, !348, i64 8}
