...
.lr.ph39:                                         ; preds = %.thread, %bb.m
  ...
  %i.aw = load i8, ptr %.8.i38, align 1, !tbaa !62, !noalias !1496
...
bb.l:                                             ; preds = %bb.k
  ...
  store i8 %i.ax, ptr %i.bb, align 1, !tbaa !62, !alias.scope !1496
  br label %bb.m
...
bb.m:                                             ; preds = %bb.l, %bb.k
  ...
  br i1 %.not101.i, label %.critedge6.i, label %.lr.ph39, !llvm.loop !1504
...
.critedge6.i:                                     ; preds = %bb.m, %.lr.ph39, %.thread
  ...
  store i32 %i.bh, ptr %i.b, align 4, !tbaa !1505, !alias.scope !1496
...
.preheader:                                       ; preds = %.critedge106.i, %.critedge8.i
  ...
  %i.bk = load i8, ptr %.087.i, align 1, !tbaa !62, !noalias !1496 ; 2 uses
...
.critedge8.i:                                     ; preds = %.preheader, %.preheader
  ...
  br label %.preheader, !llvm.loop !1506

bb.n:                                             ; preds = %.preheader
  %i.bn = add nsw i32 %i.bi, %i.bj                ; 3 uses
  store i32 %i.bn, ptr %i.b, align 4, !tbaa !1505, !alias.scope !1496
  %i.bo = sub i32 %i.bj, %.085.i                  ; 3 uses
  store i32 %i.bo, ptr %2, align 4, !tbaa !1507, !alias.scope !1496
  %i.bp = icmp ugt i32 %i.bo, 768
  br i1 %i.bp, label %bb.o, label %.thread6

bb.o:                                             ; preds = %bb.n
  store i8 1, ptr %i.c, align 1, !tbaa !1508, !alias.scope !1496
  store i32 768, ptr %2, align 4, !tbaa !1507, !alias.scope !1496
  br label %.thread6
...
bb.p:                                             ; preds = %.thread6
  %i.bs = load i8, ptr %.9.i, align 1, !tbaa !62, !noalias !1496
...
bb.r:                                             ; preds = %bb.q
  %i.bu = load i8, ptr %i.bt, align 1, !tbaa !62, !noalias !1496 ; 2 uses
...
.lr.ph48:                                         ; preds = %.critedge109.i, %bb.u
  ...
  %i.bz = load i8, ptr %.11.i47, align 1, !tbaa !62, !noalias !1496
...
bb.u:                                             ; preds = %.lr.ph48
  ...
  br i1 %.not105.i, label %.critedge10.i, label %.lr.ph48, !llvm.loop !1509
...
.critedge10.i:                                    ; preds = %bb.u, %.lr.ph48, %.critedge109.i
  ...
  store i32 %i.cj, ptr %i.b, align 4, !tbaa !1505, !alias.scope !1496
  br label %bb.v
...
.lr.ph53:                                         ; preds = %bb.v
  ...
  call void @llvm.memset.p0.i64(ptr align 1 %scevgep63, i8 0, i64 %i.cn, i1 false), !tbaa !62, !alias.scope !1496
...
define linkonce_odr { i64, i32 } @_ZN17duckdb_fast_float13compute_floatINS_13binary_formatIdEEEENS_17adjusted_mantissaERNS_7decimalE(ptr noundef nonnull align 4 dereferenceable(778) %0) local_unnamed_addr #1 comdat {
bb.a:
  %i.a = load i32, ptr %0, align 4, !tbaa !1507   ; 2 uses
  %i.b = icmp eq i32 %i.a, 0
  br i1 %i.b, label %.thread121, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 4 ; 5 uses
  %i.d = load i32, ptr %i.c, align 4, !tbaa !1505 ; 5 uses
...
thread-pre-split.loopexit:                        ; preds = %.lr.ph253
  br label %thread-pre-split, !llvm.loop !1510

thread-pre-split:                                 ; preds = %.lr.ph.i.i, %.lr.ph.preheader.i.i, %thread-pre-split.loopexit, %._crit_edge250, %._crit_edge.i.thread
  %.pr187 = phi i32 [ %.pr188, %._crit_edge250 ], [ %i.ak, %._crit_edge.i.thread ], [ %i.ak, %.lr.ph.preheader.i.i ], [ %i.ak, %thread-pre-split.loopexit ], [ %i.ak, %.lr.ph.i.i ] ; 3 uses
  %i.j = phi i32 [ %i.m, %._crit_edge250 ], [ 0, %._crit_edge.i.thread ], [ %.145.lcssa94.i, %.lr.ph.preheader.i.i ], [ 0, %thread-pre-split.loopexit ], [ %indvars.i.i, %.lr.ph.i.i ]
...
bb.g:                                             ; preds = %.lr.ph249
  ...
  br i1 %exitcond.not.i, label %._crit_edge250, label %.lr.ph249, !llvm.loop !1511
...
.lr.ph249:                                        ; preds = %bb.f, %bb.g
  ...
  %i.x = load i8, ptr %i.w, align 1, !tbaa !62
  %i.y = zext i8 %i.x to i64
  %i.z = add i64 %i.v, %i.y                       ; 4 uses
  %i.aa = lshr i64 %i.z, %i.t
  %i.ab = icmp eq i64 %i.aa, 0
  br i1 %i.ab, label %bb.g, label %.loopexit.loopexit73.i, !llvm.loop !1511
...
.lr.ph.i:                                         ; preds = %.preheader52.i, %.lr.ph.i
  ...
  br i1 %i.ai, label %.lr.ph.i, label %.loopexit.i, !llvm.loop !1512
...
.loopexit.i:                                      ; preds = %.lr.ph.i, %.loopexit.loopexit73.i, %.preheader52.i
  ...
  store i32 %i.ak, ptr %i.c, align 4, !tbaa !1505
...
.epil.preheader:                                  ; preds = %.preheader.i.unr-lcssa, %.lr.ph65.i
  ...
  store i8 %i.at, ptr %i.ba, align 1, !tbaa !62
...
._crit_edge.i.thread:                             ; preds = %.preheader.i.thread
  store i32 0, ptr %0, align 4, !tbaa !1507
...
bb.i:                                             ; preds = %bb.i, %.lr.ph65.i.new
  ...
  store i8 %i.bc, ptr %i.bj, align 2, !tbaa !62
  ...
  store i8 %i.bl, ptr %i.bu, align 1, !tbaa !62
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %.preheader.i.unr-lcssa, label %bb.i, !llvm.loop !1513
...
bb.j:                                             ; preds = %.lr.ph71.i
  ...
  store i8 %i.bz, ptr %i.cc, align 1, !tbaa !62
  br label %bb.m
...
bb.l:                                             ; preds = %bb.k
  store i8 1, ptr %i.i, align 1, !tbaa !1508
  br label %bb.m

bb.m:                                             ; preds = %bb.l, %bb.k, %bb.j
  %.246.i = phi i32 [ %i.ca, %bb.j ], [ %.14570.i, %bb.l ], [ %.14570.i, %bb.k ] ; 3 uses
  %.not.i = icmp eq i64 %i.bx, 0
  br i1 %.not.i, label %._crit_edge.thread.i, label %.lr.ph71.i, !llvm.loop !1514
...
.lr.ph.preheader.i.i:                             ; preds = %.preheader.i, %._crit_edge.thread.i
  ...
  store i32 %.145.lcssa94.i, ptr %0, align 4, !tbaa !1507
  %indvars.iv.next.i.i251 = add nsw i64 %.pre-phi193, -1 ; 2 uses
  %i.ce = getelementptr inbounds nuw i8, ptr %i.h, i64 %indvars.iv.next.i.i251
...
.lr.ph.i.i:                                       ; preds = %.lr.ph253
  ...
  %i.ch = getelementptr inbounds nuw i8, ptr %i.h, i64 %indvars.iv.next.i.i
  %i.ci = load i8, ptr %i.ch, align 1, !tbaa !62
  %i.cj = icmp eq i8 %i.ci, 0
  br i1 %i.cj, label %.lr.ph253, label %thread-pre-split, !llvm.loop !1510
...
.lr.ph253:                                        ; preds = %.lr.ph.preheader.i.i, %.lr.ph.i.i
  ...
  %indvars.i.i = trunc i64 %indvars.iv.next.i.i252 to i32 ; 3 uses
  store i32 %indvars.i.i, ptr %0, align 4, !tbaa !1507
  %.not.i.i = icmp eq i32 %indvars.i.i, 0
  br i1 %.not.i.i, label %thread-pre-split.loopexit, label %.lr.ph.i.i, !llvm.loop !1510
...
bb.o:                                             ; preds = %bb.n
  %i.cn = load i8, ptr %i.ck, align 2, !tbaa !62  ; 2 uses
...
bb.s:                                             ; preds = %bb.r, %bb.q, %bb.p
  ...
  %i.cx = load i32, ptr %i.c, align 4, !tbaa !1505 ; 4 uses
...
.lr.ph170:                                        ; preds = %.thread126
  ...
  %.pre = load i32, ptr %0, align 4, !tbaa !1507
  br label %bb.u
...
bb.v:                                             ; preds = %.lr.ph260
  ...
  br i1 %exitcond.not.i58, label %._crit_edge261, label %.lr.ph260, !llvm.loop !1511
...
.lr.ph260:                                        ; preds = %bb.u, %bb.v
  ...
  br i1 %i.dr, label %bb.v, label %.loopexit.loopexit73.i60, !llvm.loop !1511
...
.lr.ph.i95:                                       ; preds = %.preheader52.i94, %.lr.ph.i95
  ...
  br i1 %i.dy, label %.lr.ph.i95, label %.loopexit.i61, !llvm.loop !1512
...
.loopexit.i61:                                    ; preds = %.lr.ph.i95, %.loopexit.loopexit73.i60, %.preheader52.i94
  ...
  store i32 %i.ea, ptr %i.c, align 4, !tbaa !1505
...
.epil.preheader289:                               ; preds = %.preheader.i66.unr-lcssa, %.lr.ph65.i86
  ...
  store i8 %i.ei, ptr %i.ep, align 1, !tbaa !62
...
bb.y:                                             ; preds = %bb.y, %.lr.ph65.i86.new
  ...
  store i8 %i.er, ptr %i.ey, align 2, !tbaa !62
  ...
  %i.ff = load i8, ptr %i.fe, align 1, !tbaa !62
  ...
  store i8 %i.fa, ptr %i.fj, align 1, !tbaa !62
  %niter295.next.1 = add i64 %niter295, 2         ; 2 uses
  %niter295.ncmp.1 = icmp eq i64 %niter295.next.1, %unroll_iter294
  br i1 %niter295.ncmp.1, label %.preheader.i66.unr-lcssa, label %bb.y, !llvm.loop !1513
...
bb.z:                                             ; preds = %.lr.ph71.i70
  ...
  store i8 %i.fo, ptr %i.fr, align 1, !tbaa !62
  br label %bb.ac
...
bb.ab:                                            ; preds = %bb.aa
  store i8 1, ptr %i.df, align 1, !tbaa !1508
  br label %bb.ac

bb.ac:                                            ; preds = %bb.ab, %bb.aa, %bb.z
  %.246.i74 = phi i32 [ %i.fp, %bb.z ], [ %.14570.i71, %bb.ab ], [ %.14570.i71, %bb.aa ] ; 3 uses
  %.not.i75 = icmp eq i64 %i.fl, 0
  br i1 %.not.i75, label %._crit_edge.thread.i76, label %.lr.ph71.i70, !llvm.loop !1514
...
.lr.ph.preheader.i.i77:                           ; preds = %.preheader.i66, %._crit_edge.thread.i76
  ...
  store i32 %.145.lcssa94.i78, ptr %0, align 4, !tbaa !1507
  %indvars.iv.next.i.i81263 = add nsw i64 %.pre-phi, -1 ; 2 uses
  %i.ft = getelementptr inbounds nuw i8, ptr %i.de, i64 %indvars.iv.next.i.i81263
...
.lr.ph.i.i79:                                     ; preds = %.lr.ph265
  ...
  %i.fw = getelementptr inbounds nuw i8, ptr %i.de, i64 %indvars.iv.next.i.i81
  %i.fx = load i8, ptr %i.fw, align 1, !tbaa !62
  %i.fy = icmp eq i8 %i.fx, 0
  br i1 %i.fy, label %.lr.ph265, label %_ZN17duckdb_fast_float6detail19decimal_right_shiftERNS_7decimalEj.exit98, !llvm.loop !1510
...
.lr.ph265:                                        ; preds = %.lr.ph.preheader.i.i77, %.lr.ph.i.i79
  ...
  %indvars.i.i82 = trunc i64 %indvars.iv.next.i.i81264 to i32 ; 3 uses
  store i32 %indvars.i.i82, ptr %0, align 4, !tbaa !1507
  %.not.i.i83 = icmp eq i32 %indvars.i.i82, 0
  br i1 %.not.i.i83, label %_ZN17duckdb_fast_float6detail19decimal_right_shiftERNS_7decimalEj.exit98.loopexit, label %.lr.ph.i.i79, !llvm.loop !1510

_ZN17duckdb_fast_float6detail19decimal_right_shiftERNS_7decimalEj.exit98.loopexit: ; preds = %.lr.ph265
  br label %_ZN17duckdb_fast_float6detail19decimal_right_shiftERNS_7decimalEj.exit98, !llvm.loop !1510

_ZN17duckdb_fast_float6detail19decimal_right_shiftERNS_7decimalEj.exit98: ; preds = %.lr.ph.i.i79, %.lr.ph.preheader.i.i77, %_ZN17duckdb_fast_float6detail19decimal_right_shiftERNS_7decimalEj.exit98.loopexit, %._crit_edge.i84.thread, %._crit_edge261, %bb.w
  %i.fz = phi i32 [ 0, %bb.w ], [ %i.ea, %._crit_edge.i84.thread ], [ %i.dg, %._crit_edge261 ], [ %i.ea, %.lr.ph.preheader.i.i77 ], [ %i.ea, %_ZN17duckdb_fast_float6detail19decimal_right_shiftERNS_7decimalEj.exit98.loopexit ], [ %i.ea, %.lr.ph.i.i79 ]
  %i.ga = phi i32 [ 0, %bb.w ], [ 0, %._crit_edge.i84.thread ], [ %i.dh, %._crit_edge261 ], [ %.145.lcssa94.i78, %.lr.ph.preheader.i.i77 ], [ 0, %_ZN17duckdb_fast_float6detail19decimal_right_shiftERNS_7decimalEj.exit98.loopexit ], [ %indvars.i.i82, %.lr.ph.i.i79 ]
  %i.gb = add nsw i32 %spec.store.select, %.5169  ; 3 uses
  %i.gc = icmp slt i32 %i.gb, -1022
  br i1 %i.gc, label %bb.u, label %._crit_edge, !llvm.loop !1515
...
bb.ad:                                            ; preds = %._crit_edge
  ...
  %i.gd = load i32, ptr %0, align 4, !tbaa !1507  ; 4 uses
  %i.ge = icmp eq i32 %i.gd, 0
  br i1 %i.ge, label %.thread142, label %bb.ae

bb.ae:                                            ; preds = %bb.ad
  %i.gf = load i32, ptr %i.c, align 4, !tbaa !1505 ; 9 uses
...
bb.ai:                                            ; preds = %bb.ah
  ...
  %i.gw = load i8, ptr %i.gv, align 2, !tbaa !62
...
bb.al:                                            ; preds = %bb.ak, %bb.aj
  ...
  br i1 %niter302.ncmp.1, label %._crit_edge.i104.loopexit.unr-lcssa, label %bb.ah, !llvm.loop !1516
...
bb.an:                                            ; preds = %bb.am
  ...
  %i.hp = load i8, ptr %i.ho, align 1, !tbaa !1508, !range !145, !noundef !146
...
define linkonce_odr void @_ZN17duckdb_fast_float6detail19decimal_right_shiftERNS_7decimalEj(ptr noundef nonnull align 4 dereferenceable(778) %0, i32 noundef %1) local_unnamed_addr #13 comdat {
bb.a:
  %i.a = zext i32 %1 to i64                       ; 8 uses
  %i.b = load i32, ptr %0, align 4, !tbaa !1507   ; 7 uses
...
bb.b:                                             ; preds = %.lr.ph107
  ...
  br i1 %exitcond.not, label %._crit_edge108, label %.lr.ph107, !llvm.loop !1511
...
.lr.ph107:                                        ; preds = %bb.a, %bb.b
  ...
  br i1 %i.k, label %bb.b, label %.loopexit.loopexit73, !llvm.loop !1511
...
.lr.ph:                                           ; preds = %.preheader52, %.lr.ph
  ...
  br i1 %i.r, label %.lr.ph, label %.loopexit, !llvm.loop !1512
...
.loopexit:                                        ; preds = %.lr.ph, %.loopexit.loopexit73, %.preheader52
  ...
  %i.u = load i32, ptr %i.t, align 4, !tbaa !1505
  %reass.sub = sub i32 %i.u, %.2
  %i.v = add i32 %reass.sub, 1                    ; 2 uses
  store i32 %i.v, ptr %i.t, align 4, !tbaa !1505
...
.epil.preheader:                                  ; preds = %.preheader.loopexit.unr-lcssa, %.lr.ph65
  ...
  store i8 %i.ad, ptr %i.ak, align 1, !tbaa !62
  br label %.preheader
...
bb.e:                                             ; preds = %bb.e, %.lr.ph65.new
  ...
  store i8 %i.an, ptr %i.au, align 2, !tbaa !62
  ...
  store i8 %i.aw, ptr %i.bf, align 1, !tbaa !62
  %niter.next.1 = add i32 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i32 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %.preheader.loopexit.unr-lcssa, label %bb.e, !llvm.loop !1513
...
bb.g:                                             ; preds = %bb.f
  ...
  store i8 %i.bk, ptr %i.bn, align 1, !tbaa !62
  br label %bb.j
...
bb.i:                                             ; preds = %bb.h
  store i8 1, ptr %i.al, align 1, !tbaa !1508
  br label %bb.j

bb.j:                                             ; preds = %bb.h, %bb.i, %bb.g
  %.246 = phi i32 [ %i.bl, %bb.g ], [ %.14570, %bb.i ], [ %.14570, %bb.h ] ; 3 uses
  %.not = icmp eq i64 %i.bi, 0
  br i1 %.not, label %._crit_edge.thread, label %bb.f, !llvm.loop !1514

._crit_edge.thread:                               ; preds = %bb.j
  store i32 %.246, ptr %0, align 4, !tbaa !1507
  br label %.lr.ph.preheader.i

._crit_edge:                                      ; preds = %.preheader
  store i32 %.044.lcssa, ptr %0, align 4, !tbaa !1507
...
.lr.ph.i:                                         ; preds = %bb.k, %.lr.ph.preheader.i
  ...
  %i.bq = getelementptr inbounds nuw i8, ptr %i.c, i64 %indvars.iv.next.i
...
bb.k:                                             ; preds = %.lr.ph.i
  ...
  store i32 %indvars.i, ptr %0, align 4, !tbaa !1507
  %.not.i = icmp eq i32 %indvars.i, 0
  br i1 %.not.i, label %_ZN17duckdb_fast_float6detail4trimERNS_7decimalE.exit, label %.lr.ph.i, !llvm.loop !1510
...
; Function Attrs: inlinehint mustprogress uwtable
define linkonce_odr void @_ZN17duckdb_fast_float6detail18decimal_left_shiftERNS_7decimalEj(ptr noundef nonnull align 4 dereferenceable(778) %0, i32 noundef %1) local_unnamed_addr #13 comdat {
bb.a:
  %i.a = load i32, ptr %0, align 4, !tbaa !1507   ; 4 uses
  %i.b = icmp eq i32 %i.a, 0
...
bb.c:                                             ; preds = %bb.f
  ...
  br i1 %exitcond37.not.i, label %_ZN17duckdb_fast_float6detail35number_of_digits_decimal_left_shiftERKNS_7decimalEj.exit, label %bb.d, !llvm.loop !1517
...
bb.f:                                             ; preds = %bb.d
  ...
  %i.t = load i8, ptr %i.s, align 1, !tbaa !62    ; 2 uses
  %i.u = getelementptr inbounds nuw i8, ptr %i.o, i64 %indvars.iv.i
  %i.v = load i8, ptr %i.u, align 1, !tbaa !62    ; 2 uses
...
bb.i:                                             ; preds = %bb.h
  ...
  store i8 %i.aq, ptr %i.as, align 1, !tbaa !62
  br label %bb.l
...
bb.k:                                             ; preds = %bb.j
  store i8 1, ptr %i.ae, align 1, !tbaa !1508
  br label %bb.l
...
bb.l:                                             ; preds = %bb.j, %bb.k, %bb.i
  ...
  br i1 %i.au, label %bb.h, label %.preheader, !llvm.loop !1518
...
bb.p:                                             ; preds = %bb.o
  store i8 1, ptr %i.ag, align 1, !tbaa !1508
  br label %bb.q

bb.q:                                             ; preds = %bb.o, %bb.p, %bb.n
  %i.bb = add i32 %.159, -1
  %.not = icmp samesign ult i64 %.14358, 10
  br i1 %.not, label %._crit_edge, label %bb.m, !llvm.loop !1519
...
._crit_edge:                                      ; preds = %bb.q, %_ZN17duckdb_fast_float6detail35number_of_digits_decimal_left_shiftERKNS_7decimalEj.exit, %.preheader
  ...
  store i32 %spec.select, ptr %0, align 4, !tbaa !1507
  %i.bd = getelementptr inbounds nuw i8, ptr %0, i64 4 ; 2 uses
  %i.be = load i32, ptr %i.bd, align 4, !tbaa !1505
  %i.bf = add nsw i32 %i.be, %.0.i
  store i32 %i.bf, ptr %i.bd, align 4, !tbaa !1505
...
bb.r:                                             ; preds = %.lr.ph.i47
  ...
  store i32 %indvars.i, ptr %0, align 4, !tbaa !1507
  %.not.i = icmp eq i32 %indvars.i, 0
  br i1 %.not.i, label %_ZN17duckdb_fast_float6detail4trimERNS_7decimalE.exit, label %.lr.ph.i47, !llvm.loop !1510
...
bb.a:
  %i.a = load i32, ptr %0, align 4, !tbaa !1507   ; 4 uses
end_hunk_0
begin_hunk_1_@_ZN17duckdb_fast_float19parse_long_mantissaINS_13binary_formatIfEEEENS_17adjusted_mantissaEPKcS5_:bb.a
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 8
  %i.as = icmp samesign ult i64 %indvars.iv, 760
...
.lr.ph39:                                         ; preds = %.thread, %bb.m
  %.8.i38 = phi ptr [ %i.bd, %bb.m ], [ %.5.i.lcssa, %.thread ] ; 3 uses
  %i.av = phi i32 [ %i.bc, %bb.m ], [ %.lcssa27, %.thread ] ; 4 uses
  %i.aw = load i8, ptr %.8.i38, align 1, !tbaa !62, !noalias !1525
  %i.ax = add i8 %i.aw, -48                       ; 2 uses
  %i.ay = icmp ult i8 %i.ax, 10
  br i1 %i.ay, label %bb.k, label %.critedge6.i
...
bb.l:                                             ; preds = %bb.k
  %i.ba = zext nneg i32 %i.av to i64
  %i.bb = getelementptr inbounds nuw i8, ptr %i.m, i64 %i.ba
  store i8 %i.ax, ptr %i.bb, align 1, !tbaa !62, !alias.scope !1525
  br label %bb.m
...
.critedge6.i:                                     ; preds = %bb.m, %.lr.ph39, %.thread
  ...
  %i.bg = sub i64 %i.be, %i.bf
  %i.bh = trunc i64 %i.bg to i32                  ; 2 uses
  store i32 %i.bh, ptr %i.b, align 4, !tbaa !1505, !alias.scope !1525
  br label %.critedge106.i
...
.preheader:                                       ; preds = %.critedge106.i, %.critedge8.i
  ...
  %.085.i = phi i32 [ %spec.select107.i, %.critedge8.i ], [ 0, %.critedge106.i ] ; 2 uses
  %.087.i = getelementptr inbounds i8, ptr %.9.pn.i, i64 -1 ; 2 uses
  %i.bk = load i8, ptr %.087.i, align 1, !tbaa !62, !noalias !1525 ; 2 uses
  switch i8 %i.bk, label %bb.n [
    i8 48, label %.critedge8.i
    i8 46, label %.critedge8.i
  ]
...
bb.n:                                             ; preds = %.preheader
  %i.bn = add nsw i32 %i.bi, %i.bj                ; 3 uses
  store i32 %i.bn, ptr %i.b, align 4, !tbaa !1505, !alias.scope !1525
  %i.bo = sub i32 %i.bj, %.085.i                  ; 3 uses
  store i32 %i.bo, ptr %2, align 4, !tbaa !1507, !alias.scope !1525
  %i.bp = icmp ugt i32 %i.bo, 768
  br i1 %i.bp, label %bb.o, label %.thread6

bb.o:                                             ; preds = %bb.n
  store i8 1, ptr %i.c, align 1, !tbaa !1508, !alias.scope !1525
  store i32 768, ptr %2, align 4, !tbaa !1507, !alias.scope !1525
  br label %.thread6
...
bb.p:                                             ; preds = %.thread6
  %i.bs = load i8, ptr %.9.i, align 1, !tbaa !62, !noalias !1525
  switch i8 %i.bs, label %bb.v [
    i8 101, label %bb.q
    i8 69, label %bb.q
  ]
...
bb.r:                                             ; preds = %bb.q
  %i.bu = load i8, ptr %i.bt, align 1, !tbaa !62, !noalias !1525 ; 2 uses
  %i.bv = icmp eq i8 %i.bu, 45
  br i1 %i.bv, label %bb.s, label %bb.t
...
.lr.ph48:                                         ; preds = %.critedge109.i, %bb.u
  %.11.i47 = phi ptr [ %i.cg, %bb.u ], [ %.10.i, %.critedge109.i ] ; 2 uses
  %.082.i46 = phi i32 [ %.183.i, %bb.u ], [ 0, %.critedge109.i ] ; 4 uses
  %i.bz = load i8, ptr %.11.i47, align 1, !tbaa !62, !noalias !1525
  %i.ca = add i8 %i.bz, -48                       ; 2 uses
  %i.cb = icmp ult i8 %i.ca, 10
  br i1 %i.cb, label %bb.u, label %.critedge10.i
...
.critedge10.i:                                    ; preds = %bb.u, %.lr.ph48, %.critedge109.i
  ...
  %i.ci = select i1 %.084.i, i32 %i.ch, i32 %.082.i.lcssa
  %i.cj = add nsw i32 %i.br, %i.ci
  store i32 %i.cj, ptr %i.b, align 4, !tbaa !1505, !alias.scope !1525
  br label %bb.v
...
.lr.ph53:                                         ; preds = %bb.v
  ...
  %narrow = sub nuw nsw i32 19, %i.bq
  %i.cn = zext nneg i32 %narrow to i64
  call void @llvm.memset.p0.i64(ptr align 1 %scevgep63, i8 0, i64 %i.cn, i1 false), !tbaa !62, !alias.scope !1525
  br label %_ZN17duckdb_fast_float13parse_decimalEPKcS1_c.exit

_ZN17duckdb_fast_float13parse_decimalEPKcS1_c.exit: ; preds = %.lr.ph53, %bb.v
  %i.co = call { i64, i32 } @_ZN17duckdb_fast_float13compute_floatINS_13binary_formatIfEEEENS_17adjusted_mantissaERNS_7decimalE(ptr noundef nonnull align 4 dereferenceable(778) %2)
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #33
  ret { i64, i32 } %i.co
}

; Function Attrs: mustprogress uwtable
define linkonce_odr { i64, i32 } @_ZN17duckdb_fast_float13compute_floatINS_13binary_formatIfEEEENS_17adjusted_mantissaERNS_7decimalE(ptr noundef nonnull align 4 dereferenceable(778) %0) local_unnamed_addr #1 comdat {
bb.a:
  %i.a = load i32, ptr %0, align 4, !tbaa !1507   ; 2 uses
  %i.b = icmp eq i32 %i.a, 0
  br i1 %i.b, label %.thread121, label %bb.b
...
bb.e:                                             ; preds = %bb.d
  %i.o = zext nneg i32 %.pr188 to i64
  %i.p = getelementptr inbounds nuw i8, ptr @_ZZN17duckdb_fast_float13compute_floatINS_13binary_formatIfEEEENS_17adjusted_mantissaERNS_7decimalEE14decimal_powers, i64 %i.o
  %i.q = load i8, ptr %i.p, align 1, !tbaa !62
  %i.r = zext i8 %i.q to i32
  br label %bb.f
...
bb.r:                                             ; preds = %bb.q
  %i.ct = zext nneg i32 %i.cr to i64
  %i.cu = getelementptr inbounds nuw i8, ptr @_ZZN17duckdb_fast_float13compute_floatINS_13binary_formatIfEEEENS_17adjusted_mantissaERNS_7decimalEE14decimal_powers, i64 %i.ct
  %i.cv = load i8, ptr %i.cu, align 1, !tbaa !62
  %i.cw = zext i8 %i.cv to i32
  br label %bb.s
...
.thread126:                                       ; preds = %bb.t, %bb.o
  ...
  %.2.lcssa.ph = phi i32 [ %i.cz, %bb.t ], [ %.2164, %bb.o ] ; 2 uses
  %i.dc = add nsw i32 %.2.lcssa.ph, -1            ; 2 uses
  %i.dd = icmp slt i32 %.2.lcssa.ph, -125
  br i1 %i.dd, label %.lr.ph170, label %._crit_edge
...
_ZN17duckdb_fast_float6detail19decimal_right_shiftERNS_7decimalEj.exit98: ; preds = %.lr.ph.i.i79, %.lr.ph.preheader.i.i77, %_ZN17duckdb_fast_float6detail19decimal_right_shiftERNS_7decimalEj.exit98.loopexit, %._crit_edge.i84.thread, %._crit_edge261, %bb.w
  ...
  %i.ga = phi i32 [ 0, %bb.w ], [ 0, %._crit_edge.i84.thread ], [ %i.dh, %._crit_edge261 ], [ %.145.lcssa94.i78, %.lr.ph.preheader.i.i77 ], [ 0, %_ZN17duckdb_fast_float6detail19decimal_right_shiftERNS_7decimalEj.exit98.loopexit ], [ %indvars.i.i82, %.lr.ph.i.i79 ]
  %i.gb = add nsw i32 %spec.store.select, %.5169  ; 3 uses
  %i.gc = icmp slt i32 %i.gb, -126
  br i1 %i.gc, label %bb.u, label %._crit_edge, !llvm.loop !1528

._crit_edge:                                      ; preds = %_ZN17duckdb_fast_float6detail19decimal_right_shiftERNS_7decimalEj.exit98, %.thread126
  %.5.lcssa = phi i32 [ %i.dc, %.thread126 ], [ %i.gb, %_ZN17duckdb_fast_float6detail19decimal_right_shiftERNS_7decimalEj.exit98 ] ; 5 uses
  %.not = icmp slt i32 %.5.lcssa, 128
  br i1 %.not, label %bb.ad, label %.thread121

bb.ad:                                            ; preds = %._crit_edge
  tail call void @_ZN17duckdb_fast_float6detail18decimal_left_shiftERNS_7decimalEj(ptr noundef nonnull align 4 dereferenceable(778) %0, i32 noundef 24)
  %i.gd = load i32, ptr %0, align 4, !tbaa !1507  ; 4 uses
  %i.ge = icmp eq i32 %i.gd, 0
  br i1 %i.ge, label %.thread142, label %bb.ae
...
.thread142:                                       ; preds = %bb.ae, %bb.ad
  %i.hw = add nsw i32 %.5.lcssa, 127
  br label %bb.as

_ZN17duckdb_fast_float6detail5roundERNS_7decimalE.exit: ; preds = %._crit_edge.i104, %bb.ao, %bb.ap, %bb.aq, %.thread35.i
  %.029.i = phi i64 [ %.028.lcssa.i, %bb.ap ], [ %.028.lcssa.i, %._crit_edge.i104 ], [ %.028.lcssa.i, %bb.ao ], [ %i.hv, %.thread35.i ], [ %.028.lcssa.i, %bb.aq ] ; 2 uses
  %i.hx = icmp ugt i64 %.029.i, 16777215
  br i1 %i.hx, label %_ZN17duckdb_fast_float6detail5roundERNS_7decimalE.exit.thread140, label %bb.ar
...
_ZN17duckdb_fast_float6detail5roundERNS_7decimalE.exit.thread140: ; preds = %bb.af, %_ZN17duckdb_fast_float6detail5roundERNS_7decimalE.exit
  ...
  %i.hy = add nsw i32 %.5.lcssa, 1
  %i.hz = tail call noundef i64 @_ZN17duckdb_fast_float6detail5roundERNS_7decimalE(ptr noundef nonnull align 4 dereferenceable(778) %0)
  %.not54.not = icmp eq i32 %.5.lcssa, 127
  br i1 %.not54.not, label %.thread121, label %bb.ar

bb.ar:                                            ; preds = %_ZN17duckdb_fast_float6detail5roundERNS_7decimalE.exit.thread140, %_ZN17duckdb_fast_float6detail5roundERNS_7decimalE.exit
  %.6 = phi i32 [ %i.hy, %_ZN17duckdb_fast_float6detail5roundERNS_7decimalE.exit.thread140 ], [ %.5.lcssa, %_ZN17duckdb_fast_float6detail5roundERNS_7decimalE.exit ]
  %.0 = phi i64 [ %i.hz, %_ZN17duckdb_fast_float6detail5roundERNS_7decimalE.exit.thread140 ], [ %.029.i, %_ZN17duckdb_fast_float6detail5roundERNS_7decimalE.exit ] ; 3 uses
  %i.ia = add nsw i32 %.6, 127                    ; 2 uses
  %i.ib = icmp ult i64 %.0, 8388608
  br i1 %i.ib, label %bb.as, label %bb.at
...
bb.at:                                            ; preds = %bb.as, %bb.ar
  %.0146 = phi i64 [ %.0147, %bb.as ], [ %.0, %bb.ar ]
  %.sroa.8.4 = phi i32 [ %i.id, %bb.as ], [ %i.ia, %bb.ar ]
  %i.ie = and i64 %.0146, 8388607
  br label %.thread121

.thread121:                                       ; preds = %bb.s, %bb.at, %._crit_edge, %_ZN17duckdb_fast_float6detail5roundERNS_7decimalE.exit.thread140, %bb.c, %bb.b, %bb.a
  %.sroa.8.6 = phi i32 [ 255, %._crit_edge ], [ 0, %bb.a ], [ 0, %bb.b ], [ 255, %bb.c ], [ 255, %_ZN17duckdb_fast_float6detail5roundERNS_7decimalE.exit.thread140 ], [ %.sroa.8.4, %bb.at ], [ 255, %bb.s ]
  %.sroa.0.4 = phi i64 [ 0, %._crit_edge ], [ 0, %bb.a ], [ 0, %bb.b ], [ 0, %bb.c ], [ 0, %_ZN17duckdb_fast_float6detail5roundERNS_7decimalE.exit.thread140 ], [ %i.ie, %bb.at ], [ 0, %bb.s ]
  %.fca.0.insert = insertvalue { i64, i32 } poison, i64 %.sroa.0.4, 0
  %.fca.1.insert = insertvalue { i64, i32 } %.fca.0.insert, i32 %.sroa.8.6, 1
  ret { i64, i32 } %.fca.1.insert
...
define internal fastcc noundef zeroext i1 @_ZN6duckdbL15IntegerCastLoopINS_15IntegerCastDataIsEELb1ELb0ENS_20IntegerCastOperationELc44EEEbPKcmRT_b(ptr noundef readonly captures(none) %0, i64 noundef %1, ptr noundef nonnull align 2 captures(none) dereferenceable(2) %2) unnamed_addr #27 {
bb.a:
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.j
  %.06093 = phi i64 [ %.7, %bb.j ], [ 1, %.lr.ph.preheader ] ; 6 uses
  %i.b = phi i16 [ %i.aa, %bb.j ], [ %.promoted, %.lr.ph.preheader ] ; 2 uses
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 %.06093
  %i.d = load i8, ptr %i.c, align 1, !tbaa !62    ; 3 uses
  %i.e = add i8 %i.d, -48                         ; 2 uses
end_hunk_1
