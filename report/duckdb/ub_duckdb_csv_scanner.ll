...
bb.b:                                             ; preds = %.lr.ph.i.preheader
  ...
  store double %i.aa, ptr %2, align 8, !tbaa !1477
...
.lr.ph.backedge:                                  ; preds = %bb.e, %bb.d
  ...
  br i1 %i.ao, label %.lr.ph._crit_edge, label %.lr.ph76, !llvm.loop !1479
...
bb.h:                                             ; preds = %.lr.ph.i48, %bb.g
  ...
  store double %i.ba, ptr %2, align 8, !tbaa !1477
  br label %.loopexit
...
bb.a:
  ...
  %i.d = load i8, ptr %0, align 1, !tbaa !62, !noalias !1480
  %i.e = icmp eq i8 %i.d, 45                      ; 2 uses
  %i.f = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.g = zext i1 %i.e to i8
  store i8 %i.g, ptr %i.f, align 4, !tbaa !1483, !alias.scope !1480
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.b
  ...
  %i.j = load i8, ptr %.188.i10, align 1, !tbaa !62, !noalias !1480
...
bb.b:                                             ; preds = %.lr.ph
  ...
  br i1 %.not.i, label %.critedge.i, label %.lr.ph, !llvm.loop !1485
...
bb.c:                                             ; preds = %.lr.ph17, %bb.f
  ...
  %i.n = load i8, ptr %.2.i16, align 1, !tbaa !62, !noalias !1480 ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  store i8 %i.o, ptr %i.s, align 1, !tbaa !62, !alias.scope !1480
  br label %bb.f
...
bb.f:                                             ; preds = %bb.e, %bb.d
  ...
  br i1 %.not99.i, label %.critedge106.i.loopexit, label %bb.c, !llvm.loop !1486
...
.lr.ph22:                                         ; preds = %.lr.ph22.preheader, %bb.h
  ...
  %i.z = load i8, ptr %.3.i21, align 1, !tbaa !62, !noalias !1480
...
bb.h:                                             ; preds = %.lr.ph22
  ...
  br i1 %.not100.i, label %.critedge4.i, label %.lr.ph22, !llvm.loop !1487
...
bb.i:                                             ; preds = %.lr.ph29, %bb.j
  ...
  %.0.copyload.i.i = load i64, ptr %.5.i28.a, align 1, !noalias !1480 ; 2 uses
...
.lr.ph39:                                         ; preds = %.thread, %bb.m
  ...
  %i.as = load i8, ptr %.8.i38, align 1, !tbaa !62, !noalias !1480
...
bb.l:                                             ; preds = %bb.k
  ...
  store i8 %i.at, ptr %i.ax, align 1, !tbaa !62, !alias.scope !1480
  br label %bb.m
...
bb.m:                                             ; preds = %bb.l, %bb.k
  ...
  br i1 %.not101.i, label %.critedge6.i, label %.lr.ph39, !llvm.loop !1488
...
.critedge6.i:                                     ; preds = %bb.m, %.lr.ph39, %.thread
  ...
  store i32 %i.bd, ptr %i.b, align 4, !tbaa !1489, !alias.scope !1480
...
.preheader:                                       ; preds = %.critedge106.i, %.critedge8.i
  ...
  %i.bg = load i8, ptr %.085.i, align 1, !tbaa !62, !noalias !1480 ; 2 uses
...
.critedge8.i:                                     ; preds = %.preheader, %.preheader
  ...
  br label %.preheader, !llvm.loop !1490

bb.n:                                             ; preds = %.preheader
  %i.bj = add nsw i32 %i.be, %i.bf                ; 3 uses
  store i32 %i.bj, ptr %i.b, align 4, !tbaa !1489, !alias.scope !1480
  %i.bk = sub i32 %i.bf, %.083.i                  ; 3 uses
  store i32 %i.bk, ptr %2, align 4, !tbaa !1491, !alias.scope !1480
  %i.bl = icmp ugt i32 %i.bk, 768
  br i1 %i.bl, label %bb.o, label %.thread6

bb.o:                                             ; preds = %bb.n
  store i8 1, ptr %i.c, align 1, !tbaa !1492, !alias.scope !1480
  store i32 768, ptr %2, align 4, !tbaa !1491, !alias.scope !1480
  br label %.thread6
...
bb.p:                                             ; preds = %.thread6
  %i.bo = load i8, ptr %.9.i, align 1, !tbaa !62, !noalias !1480
...
bb.r:                                             ; preds = %bb.q
  %i.bq = load i8, ptr %i.bp, align 1, !tbaa !62, !noalias !1480 ; 2 uses
...
.lr.ph48:                                         ; preds = %.critedge109.i, %bb.u
  ...
  %i.bv = load i8, ptr %.11.i46, align 1, !tbaa !62, !noalias !1480
...
bb.u:                                             ; preds = %.lr.ph48
  ...
  br i1 %.not105.i, label %.critedge10.i, label %.lr.ph48, !llvm.loop !1493
...
.critedge10.i:                                    ; preds = %bb.u, %.lr.ph48, %.critedge109.i
  ...
  store i32 %i.cf, ptr %i.b, align 4, !tbaa !1489, !alias.scope !1480
  br label %bb.v
...
.lr.ph53:                                         ; preds = %bb.v
  ...
  call void @llvm.memset.p0.i64(ptr align 1 %scevgep63, i8 0, i64 %i.cj, i1 false), !tbaa !62, !alias.scope !1480
...
.thread-pre-split.loopexit_crit_edge:             ; preds = %.lr.ph253
  store i32 %indvars.i.i, ptr %0, align 4, !tbaa !1491
  br label %thread-pre-split, !llvm.loop !1494

thread-pre-split.loopexit:                        ; preds = %.lr.ph.i.i
  store i32 %indvars.i.i, ptr %0, align 4, !tbaa !1491
end_hunk_0
begin_hunk_1_@_ZN17duckdb_fast_float6detail12parse_infnanIfEENS_17from_chars_resultEPKcS4_RT_:bb.a

bb.b:                                             ; preds = %.lr.ph.i.preheader
  %i.z = getelementptr inbounds nuw i8, ptr %spec.select, i64 3 ; 6 uses
  %i.aa = select i1 %i.b, float -qnan, float +qnan
  store float %i.aa, ptr %2, align 4, !tbaa !1507
  %.not = icmp eq ptr %i.z, %1
  br i1 %.not, label %.loopexit, label %bb.c
...
.lr.ph.backedge:                                  ; preds = %bb.e, %bb.d
  ...
  %i.an = load i8, ptr %.059.be, align 1, !tbaa !62 ; 2 uses
  %i.ao = icmp eq i8 %i.an, 41
  br i1 %i.ao, label %.lr.ph._crit_edge, label %.lr.ph76, !llvm.loop !1508
...
bb.h:                                             ; preds = %.lr.ph.i48, %bb.g
  ...
  store float %i.ba, ptr %2, align 4, !tbaa !1507
  br label %.loopexit
...
bb.a:
  ...
  %i.c = getelementptr inbounds nuw i8, ptr %2, i64 9
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(10) %2, i8 0, i64 10, i1 false)
  %i.d = load i8, ptr %0, align 1, !tbaa !62, !noalias !1509
  %i.e = icmp eq i8 %i.d, 45                      ; 2 uses
  %i.f = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.g = zext i1 %i.e to i8
  store i8 %i.g, ptr %i.f, align 4, !tbaa !1483, !alias.scope !1509
  %spec.select.i.idx = zext i1 %i.e to i64
  %spec.select.i = getelementptr inbounds nuw i8, ptr %0, i64 %spec.select.i.idx ; 3 uses
  %.not.i9 = icmp eq ptr %spec.select.i, %1
  br i1 %.not.i9, label %.critedge.i, label %.lr.ph.preheader
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.b
  %.188.i10 = phi ptr [ %i.l, %bb.b ], [ %spec.select.i, %.lr.ph.preheader ] ; 3 uses
  %i.j = load i8, ptr %.188.i10, align 1, !tbaa !62, !noalias !1509
  %i.k = icmp eq i8 %i.j, 48
  br i1 %i.k, label %bb.b, label %.critedge.i
...
bb.c:                                             ; preds = %.lr.ph17, %bb.f
  %.2.i16 = phi ptr [ %.188.i.lcssa, %.lr.ph17 ], [ %i.u, %bb.f ] ; 4 uses
  %.promoted26 = phi i32 [ 0, %.lr.ph17 ], [ %i.t, %bb.f ] ; 9 uses
  %i.n = load i8, ptr %.2.i16, align 1, !tbaa !62, !noalias !1509 ; 2 uses
  %i.o = add i8 %i.n, -48                         ; 2 uses
  %i.p = icmp ult i8 %i.o, 10
  br i1 %i.p, label %bb.d, label %.critedge2.i
...
bb.e:                                             ; preds = %bb.d
  %i.r = zext nneg i32 %.promoted26 to i64
  %i.s = getelementptr inbounds nuw i8, ptr %i.m, i64 %i.r
  store i8 %i.o, ptr %i.s, align 1, !tbaa !62, !alias.scope !1509
  br label %bb.f
...
.lr.ph22:                                         ; preds = %.lr.ph22.preheader, %bb.h
  %.3.i21 = phi ptr [ %i.ab, %bb.h ], [ %i.w, %.lr.ph22.preheader ] ; 3 uses
  %i.z = load i8, ptr %.3.i21, align 1, !tbaa !62, !noalias !1509
  %i.aa = icmp eq i8 %i.z, 48
  br i1 %i.aa, label %bb.h, label %.critedge4.i
...
bb.i:                                             ; preds = %.lr.ph29, %bb.j
  ...
  %.5.i28.a = phi ptr [ %.4.i, %.lr.ph29 ], [ %3, %bb.j ] ; 2 uses
  %4 = phi i32 [ %.promoted26, %.lr.ph29 ], [ %6, %bb.j ] ; 2 uses
  %.0.copyload.i.i = load i64, ptr %.5.i28.a, align 1, !noalias !1509 ; 2 uses
  %i.ai = add i64 %.0.copyload.i.i, 5063812098665367110
  %i.aj = add i64 %.0.copyload.i.i, -3472328296227680304 ; 2 uses
  %i.ak = or i64 %i.ai, %i.aj
  %i.al = and i64 %i.ak, -9187201950435737472
...
.lr.ph39:                                         ; preds = %.thread, %bb.m
  %.8.i38 = phi ptr [ %i.az, %bb.m ], [ %.5.i.lcssa, %.thread ] ; 3 uses
  %i.ar = phi i32 [ %i.ay, %bb.m ], [ %.lcssa27, %.thread ] ; 4 uses
  %i.as = load i8, ptr %.8.i38, align 1, !tbaa !62, !noalias !1509
  %i.at = add i8 %i.as, -48                       ; 2 uses
  %i.au = icmp ult i8 %i.at, 10
  br i1 %i.au, label %bb.k, label %.critedge6.i
...
bb.l:                                             ; preds = %bb.k
  %i.aw = zext nneg i32 %i.ar to i64
  %i.ax = getelementptr inbounds nuw i8, ptr %i.m, i64 %i.aw
  store i8 %i.at, ptr %i.ax, align 1, !tbaa !62, !alias.scope !1509
  br label %bb.m
...
.critedge6.i:                                     ; preds = %bb.m, %.lr.ph39, %.thread
  ...
  %i.bc = sub i64 %i.ba, %i.bb
  %i.bd = trunc i64 %i.bc to i32                  ; 2 uses
  store i32 %i.bd, ptr %i.b, align 4, !tbaa !1489, !alias.scope !1509
  br label %.critedge106.i
...
.preheader:                                       ; preds = %.critedge106.i, %.critedge8.i
  ...
  %.083.i = phi i32 [ %spec.select107.i, %.critedge8.i ], [ 0, %.critedge106.i ] ; 2 uses
  %.085.i = getelementptr inbounds i8, ptr %.9.pn.i, i64 -1 ; 2 uses
  %i.bg = load i8, ptr %.085.i, align 1, !tbaa !62, !noalias !1509 ; 2 uses
  switch i8 %i.bg, label %bb.n [
    i8 48, label %.critedge8.i
    i8 46, label %.critedge8.i
  ]
...
bb.n:                                             ; preds = %.preheader
  %i.bj = add nsw i32 %i.be, %i.bf                ; 3 uses
  store i32 %i.bj, ptr %i.b, align 4, !tbaa !1489, !alias.scope !1509
  %i.bk = sub i32 %i.bf, %.083.i                  ; 3 uses
  store i32 %i.bk, ptr %2, align 4, !tbaa !1491, !alias.scope !1509
  %i.bl = icmp ugt i32 %i.bk, 768
  br i1 %i.bl, label %bb.o, label %.thread6

bb.o:                                             ; preds = %bb.n
  store i8 1, ptr %i.c, align 1, !tbaa !1492, !alias.scope !1509
  store i32 768, ptr %2, align 4, !tbaa !1491, !alias.scope !1509
  br label %.thread6
...
bb.p:                                             ; preds = %.thread6
  %i.bo = load i8, ptr %.9.i, align 1, !tbaa !62, !noalias !1509
  switch i8 %i.bo, label %bb.v [
    i8 101, label %bb.q
    i8 69, label %bb.q
  ]
...
bb.r:                                             ; preds = %bb.q
  %i.bq = load i8, ptr %i.bp, align 1, !tbaa !62, !noalias !1509 ; 2 uses
  %i.br = icmp eq i8 %i.bq, 45
  br i1 %i.br, label %bb.s, label %bb.t
...
.lr.ph48:                                         ; preds = %.critedge109.i, %bb.u
  %.081.i47 = phi i32 [ %.1.i, %bb.u ], [ 0, %.critedge109.i ] ; 4 uses
  %.11.i46 = phi ptr [ %i.cc, %bb.u ], [ %.10.i, %.critedge109.i ] ; 2 uses
  %i.bv = load i8, ptr %.11.i46, align 1, !tbaa !62, !noalias !1509
  %i.bw = add i8 %i.bv, -48                       ; 2 uses
  %i.bx = icmp ult i8 %i.bw, 10
  br i1 %i.bx, label %bb.u, label %.critedge10.i
...
.critedge10.i:                                    ; preds = %bb.u, %.lr.ph48, %.critedge109.i
  ...
  %i.ce = select i1 %.082.i, i32 %i.cd, i32 %.081.i.lcssa
  %i.cf = add nsw i32 %i.bn, %i.ce
  store i32 %i.cf, ptr %i.b, align 4, !tbaa !1489, !alias.scope !1509
  br label %bb.v
...
.lr.ph53:                                         ; preds = %bb.v
  ...
  %narrow = sub nuw nsw i32 19, %i.bm
  %i.cj = zext nneg i32 %narrow to i64
  call void @llvm.memset.p0.i64(ptr align 1 %scevgep63, i8 0, i64 %i.cj, i1 false), !tbaa !62, !alias.scope !1509
  br label %_ZN17duckdb_fast_float13parse_decimalEPKcS1_c.exit

_ZN17duckdb_fast_float13parse_decimalEPKcS1_c.exit: ; preds = %.lr.ph53, %bb.v
  %i.ck = call { i64, i32 } @_ZN17duckdb_fast_float13compute_floatINS_13binary_formatIfEEEENS_17adjusted_mantissaERNS_7decimalE(ptr noundef nonnull align 4 dereferenceable(778) %2)
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #33
  ret { i64, i32 } %i.ck
}
