...
begin_hunk_1_@_ZNK6duckdb18StringValueScanner10IsRowValidERNS_11CSVIteratorE:bb.a
  ...
  br i1 %.not, label %_ZNK6duckdb9LineError12HasErrorTypeENS_12CSVErrorTypeE.exit.thread, label %bb.v
...
bb.v:                                             ; preds = %bb.u
  ...
  br i1 %.not24, label %.lr.ph.i, label %_ZNK6duckdb9LineError12HasErrorTypeENS_12CSVErrorTypeE.exit
...
.lr.ph.i:                                         ; preds = %bb.v, %.lr.ph.i
  ...
  %.not.i = icmp eq i8 %i.bo, 6                   ; 3 uses
  ...
  br i1 %or.cond, label %_ZNK6duckdb9LineError12HasErrorTypeENS_12CSVErrorTypeE.exit.loopexit, label %.lr.ph.i
...
_ZNK6duckdb9LineError12HasErrorTypeENS_12CSVErrorTypeE.exit.loopexit: ; preds = %.lr.ph.i
  %.old1.ph = xor i1 %.not.i, true
  br label %_ZNK6duckdb9LineError12HasErrorTypeENS_12CSVErrorTypeE.exit

_ZNK6duckdb9LineError12HasErrorTypeENS_12CSVErrorTypeE.exit: ; preds = %_ZNK6duckdb9LineError12HasErrorTypeENS_12CSVErrorTypeE.exit.loopexit, %bb.v
  %.016.not = phi i1 [ %.not.i, %_ZNK6duckdb9LineError12HasErrorTypeENS_12CSVErrorTypeE.exit.loopexit ], [ false, %bb.v ]
  %.016.not.a = phi i1 [ %.old1.ph, %_ZNK6duckdb9LineError12HasErrorTypeENS_12CSVErrorTypeE.exit.loopexit ], [ true, %bb.v ]
...
_ZNK6duckdb9LineError12HasErrorTypeENS_12CSVErrorTypeE.exit.thread: ; preds = %bb.u
  %4 = getelementptr inbounds nuw i8, ptr %i.bd, i64 256
  %5 = load i64, ptr %4, align 8, !tbaa !678
  %6 = icmp eq i64 %5, 1
  br i1 %6, label %bb.ab, label %bb.z

bb.z:                                             ; preds = %_ZNK6duckdb9LineError12HasErrorTypeENS_12CSVErrorTypeE.exit.thread, %_ZNK6duckdb9LineError12HasErrorTypeENS_12CSVErrorTypeE.exit
  %.016.not42 = phi i1 [ true, %_ZNK6duckdb9LineError12HasErrorTypeENS_12CSVErrorTypeE.exit.thread ], [ %.016.not, %_ZNK6duckdb9LineError12HasErrorTypeENS_12CSVErrorTypeE.exit ]
  %i.bw = getelementptr inbounds nuw i8, ptr %i.bd, i64 928
  %i.bx = load i8, ptr %i.bw, align 8, !tbaa !534, !range !145, !noundef !146
  %i.by = trunc nuw i8 %i.bx to i1
  %or.cond.not = and i1 %.016.not42, %i.by
  br i1 %or.cond.not, label %bb.ab, label %.thread

bb.aa:                                            ; preds = %_ZNK6duckdb9LineError12HasErrorTypeENS_12CSVErrorTypeE.exit
  br i1 %.016.not.a, label %.thread, label %bb.ab

bb.ab:                                            ; preds = %_ZNK6duckdb9LineError12HasErrorTypeENS_12CSVErrorTypeE.exit.thread, %bb.z, %bb.aa
...
.thread:                                          ; preds = %bb.ad, %bb.z, %bb.aa, %bb.ab
  %.0 = phi i1 [ %i.cb, %bb.ab ], [ false, %bb.aa ], [ false, %bb.z ], [ false, %bb.ad ]
