...
begin_hunk_0_@_ZN6duckdb18StringValueScanner5FlushERNS_9DataChunkE:bb.a
  ...
  %28 = alloca %"class.std::__cxx11::basic_ostringstream", align 8 ; 32 uses
...
begin_hunk_1_@_ZN6duckdb18StringValueScanner5FlushERNS_9DataChunkE:bb.a
  ...
  %36 = alloca %"class.std::__cxx11::basic_ostringstream", align 8 ; 32 uses
...
begin_hunk_2_@_ZN6duckdb18StringValueScanner5FlushERNS_9DataChunkE:bb.a
  ...
  %i.av = getelementptr inbounds nuw i8, ptr %28, i64 8 ; 6 uses
...
begin_hunk_3_@_ZN6duckdb18StringValueScanner5FlushERNS_9DataChunkE:bb.a
  ...
  %i.ce = getelementptr inbounds nuw i8, ptr %36, i64 8 ; 6 uses
...
bb.bx:                                            ; preds = %_ZNK6duckdb17StringValueResult14PrintErrorLineEv.exit
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 16) (i8, ptr @_ZTVSt9basic_iosIcSt11char_traitsIcEE, i64 16), ptr %i.an, align 8, !tbaa !18
  store ptr null, ptr %i.ao, align 8, !tbaa !893
  store i8 0, ptr %i.ap, align 8, !tbaa !900
...
bb.by:                                            ; preds = %bb.bx
  store ptr getelementptr inbounds nuw inrange(-24, 16) (i8, ptr @_ZTVNSt7__cxx1119basic_ostringstreamIcSt11char_traitsIcESaIcEEE, i64 24), ptr %28, align 8, !tbaa !18
  store ptr getelementptr inbounds nuw inrange(-24, 16) (i8, ptr @_ZTVNSt7__cxx1119basic_ostringstreamIcSt11char_traitsIcESaIcEEE, i64 64), ptr %i.an, align 8, !tbaa !18
  store ptr getelementptr inbounds nuw inrange(-16, 112) (i8, ptr @_ZTVSt15basic_streambufIcSt11char_traitsIcEE, i64 16), ptr %i.av, align 8, !tbaa !18
  ...
  store ptr %i.ba, ptr %i.az, align 8, !tbaa !82
  store i64 0, ptr %i.bb, align 8, !tbaa !83
  store i8 0, ptr %i.ba, align 8, !tbaa !62
  %i.ma = load ptr, ptr %28, align 8, !tbaa !18
...
begin_hunk_6_@_ZN6duckdb18StringValueScanner5FlushERNS_9DataChunkE:bb.a
  ...
  %i.mw = load ptr, ptr %i.bi, align 8, !tbaa !367, !noalias !911 ; 3 uses
  %.not.i.not.i.i = icmp eq ptr %i.mw, null
  %i.mx = load ptr, ptr %i.bj, align 8, !noalias !911 ; 2 uses
...
bb.fe:                                            ; preds = %_ZNK6duckdb17StringValueResult14PrintErrorLineEv.exit409
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 16) (i8, ptr @_ZTVSt9basic_iosIcSt11char_traitsIcEE, i64 16), ptr %i.bz, align 8, !tbaa !18
  store ptr null, ptr %i.ca, align 8, !tbaa !893
  store i8 0, ptr %i.cb, align 8, !tbaa !900
...
bb.ff:                                            ; preds = %bb.fe
  store ptr getelementptr inbounds nuw inrange(-24, 16) (i8, ptr @_ZTVNSt7__cxx1119basic_ostringstreamIcSt11char_traitsIcESaIcEEE, i64 24), ptr %36, align 8, !tbaa !18
  store ptr getelementptr inbounds nuw inrange(-24, 16) (i8, ptr @_ZTVNSt7__cxx1119basic_ostringstreamIcSt11char_traitsIcESaIcEEE, i64 64), ptr %i.bz, align 8, !tbaa !18
  store ptr getelementptr inbounds nuw inrange(-16, 112) (i8, ptr @_ZTVSt15basic_streambufIcSt11char_traitsIcEE, i64 16), ptr %i.ce, align 8, !tbaa !18
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %i.cf, i8 0, i64 48, i1 false)
  ...
  store ptr %i.cj, ptr %i.ci, align 8, !tbaa !82
  store i64 0, ptr %i.ck, align 8, !tbaa !83
  store i8 0, ptr %i.cj, align 8, !tbaa !62
  %i.yt = load ptr, ptr %36, align 8, !tbaa !18
...
begin_hunk_10_@_ZN6duckdb18StringValueScanner5FlushERNS_9DataChunkE:bb.a
  ...
  %i.zq = load ptr, ptr %i.cr, align 8, !tbaa !367, !noalias !922 ; 3 uses
  %.not.i.not.i.i436 = icmp eq ptr %i.zq, null
  %i.zr = load ptr, ptr %i.cs, align 8, !noalias !922 ; 2 uses
