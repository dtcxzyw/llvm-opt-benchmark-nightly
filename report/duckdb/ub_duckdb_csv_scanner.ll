...
bb.ao:                                            ; preds = %bb.an
  ...
  %6 = xor i64 %i.et, 9223372036854775806
  %i.eu = udiv i64 %6, 10
...
bb.bm:                                            ; preds = %bb.bl, %bb.bj, %.lr.ph
  ...
  %7 = lshr i64 %i.ja, 4
  %8 = xor i64 %7, 576460752303423487
...
bb.ca:                                            ; preds = %bb.bz
  ...
  %9 = xor i64 %i.md, 9223372036854775806
  %i.me = udiv i64 %9, 10
...
bb.cn:                                            ; preds = %.lr.ph.i80.i
  ...
  %10 = xor i64 %i.ns, 9223372036854775806
  %i.nt = udiv i64 %10, 10
...
bb.s:                                             ; preds = %bb.r, %bb.p, %bb.o
  ...
  %6 = lshr i8 %.0.i.i, 4
  %.lhs.trunc.i.i44.i = zext nneg i8 %6 to i32
  %.zext.i.i45.i = xor i32 %.lhs.trunc.i.i44.i, 2047
...
bb.ae:                                            ; preds = %.lr.ph.i55.i
  ...
  %.lhs.trunc.i.i59.i = xor i16 %i.dl, 32766
...
bb.ao:                                            ; preds = %bb.an
  ...
  %7 = xor i64 %i.ex, 9223372036854775806
  %i.ey = udiv i64 %7, 10
...
bb.bm:                                            ; preds = %bb.bl, %bb.bj, %.lr.ph
  ...
  %8 = lshr i64 %i.je, 4
  %9 = xor i64 %8, 576460752303423487
...
bb.ca:                                            ; preds = %bb.bz
  ...
  %10 = xor i64 %i.mh, 9223372036854775806
  %i.mi = udiv i64 %10, 10
...
bb.cn:                                            ; preds = %.lr.ph.i80.i
  ...
  %11 = xor i64 %i.nw, 9223372036854775806
  %i.nx = udiv i64 %11, 10
...
bb.ao:                                            ; preds = %bb.an
  ...
  %9 = xor i64 %i.ev, 9223372036854775806
  %i.ew = udiv i64 %9, 10
...
bb.bm:                                            ; preds = %bb.bl, %bb.bj, %.lr.ph
  ...
  %10 = lshr i64 %i.jc, 4
  %11 = xor i64 %10, 576460752303423487
...
bb.ca:                                            ; preds = %bb.bz
  ...
  %12 = xor i64 %i.mf, 9223372036854775806
  %i.mg = udiv i64 %12, 10
...
bb.cn:                                            ; preds = %.lr.ph.i80.i
  ...
  %13 = xor i64 %i.nu, 9223372036854775806
  %i.nv = udiv i64 %13, 10
...
bb.s:                                             ; preds = %bb.r, %bb.p, %bb.o
  ...
  %6 = lshr i64 %i.br, 4
  %7 = xor i64 %6, 576460752303423487
...
bb.ae:                                            ; preds = %.lr.ph.i53.i
  ...
  %8 = xor i64 %i.dj, 9223372036854775806
  %i.dk = udiv i64 %8, 10
...
bb.ca:                                            ; preds = %bb.bz
  ...
  %12 = xor i64 %i.lz, 9223372036854775806
  %i.ma = udiv i64 %12, 10
...
bb.cn:                                            ; preds = %.lr.ph.i80.i
  ...
  %13 = xor i64 %i.no, 9223372036854775806
  %i.np = udiv i64 %13, 10
...
bb.al:                                            ; preds = %bb.ak
  ...
  %6 = xor i64 %i.ey, 9223372036854775806
  %i.ez = udiv i64 %6, 10
...
bb.bx:                                            ; preds = %bb.bw
  %i.mh = zext nneg i8 %i.mf to i64               ; 2 uses
  %9 = xor i64 %i.mh, 9223372036854775806
  %i.mi = udiv i64 %9, 10
  %i.mj = icmp sgt i64 %i.mc, %i.mi
...
bb.ck:                                            ; preds = %.lr.ph.i88.i
  %i.nv = add nuw i64 %.089138.i.i, 1             ; 3 uses
  %i.nw = zext nneg i8 %i.lr to i64               ; 2 uses
  %10 = xor i64 %i.nw, 9223372036854775806
  %i.nx = udiv i64 %10, 10
...
bb.al:                                            ; preds = %bb.ak
  ...
  %6 = xor i64 %i.fc, 9223372036854775806
  %i.fd = udiv i64 %6, 10
...
bb.bx:                                            ; preds = %bb.bw
  ...
  %9 = xor i64 %i.ml, 9223372036854775806
  %i.mm = udiv i64 %9, 10
...
bb.ck:                                            ; preds = %.lr.ph.i88.i
  ...
  %10 = xor i64 %i.oa, 9223372036854775806
  %i.ob = udiv i64 %10, 10
...
bb.al:                                            ; preds = %bb.ak
  ...
  %6 = xor i64 %i.fd, 9223372036854775806
  %i.fe = udiv i64 %6, 10
...
bb.bx:                                            ; preds = %bb.bw
  ...
  %9 = xor i64 %i.mm, 9223372036854775806
  %i.mn = udiv i64 %9, 10
...
bb.ck:                                            ; preds = %.lr.ph.i88.i
  ...
  %10 = xor i64 %i.ob, 9223372036854775806
  %i.oc = udiv i64 %10, 10
