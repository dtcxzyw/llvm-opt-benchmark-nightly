...
bb.r:                                             ; preds = %bb.h, %_ZNK6duckdb15ReservoirSample20GetActiveSampleCountEv.exit58
  ...
  %3 = uitofp i64 %i.ck to double                 ; 2 uses
  %4 = fdiv double %i.co, %3                      ; 3 uses
  ...
  %i.cp = fadd double %4, %9                      ; 2 uses
  %i.cq = fcmp olt double %i.cp, 1.000000e+00
  %i.cr = fsub double 1.000000e+00, %i.cp
  %i.cs = fadd double %9, %i.cr
  %.050 = select i1 %i.cq, double %i.cs, double %9 ; 2 uses
  ...
  %i.cw = fcmp ogt double %4, %.050
  br i1 %i.cw, label %bb.s, label %bb.x

bb.s:                                             ; preds = %bb.r
  %i.cx = fmul double %4, %i.cv
