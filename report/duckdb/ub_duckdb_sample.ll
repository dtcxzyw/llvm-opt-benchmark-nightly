...
bb.w:                                             ; preds = %._crit_edge
  ...
  br i1 %.not.i.i.i.i.i.i.i.i, label %_ZN6duckdb15SelectionVectorD2Ev.exitthread-pre-split, label %bb.x
...
_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EEC2ERKS2_.exit.i.i.i: ; preds = %bb.x, %._crit_edge
...
_ZN6duckdb15SelectionVectorD2Ev.exitthread-pre-split: ; preds = %bb.w
  ...
  %.pre98.pr = load ptr, ptr %5, align 8, !tbaa !137
  store ptr %.pre98.pr, ptr %0, align 8, !tbaa !137
...
14:                                               ; preds = %_ZN6duckdb15SelectionVectorD2Ev.exitthread-pre-split
  ...
  br i1 %17, label %_ZN6duckdb15SelectionVectorD2Ev.exit.a, label %24

_ZN6duckdb15SelectionVectorD2Ev.exit.a:           ; preds = %14
  ...
  %i.ct = getelementptr inbounds nuw i8, ptr %22, i64 24
  %23 = load ptr, ptr %i.ct, align 8
...
_ZN6duckdb15SelectionVectorD2Ev.exit:             ; preds = %_ZN6duckdb10shared_ptrINS_13SelectionDataELb1EEC2ERKS2_.exit.i.i.i, %31, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i, %_ZN6duckdb15SelectionVectorD2Ev.exit.a, %_ZN6duckdb15SelectionVectorD2Ev.exitthread-pre-split
...
bb.y:                                             ; preds = %_ZN6duckdb15SelectionVectorD2Ev.exit
  %i.cu = getelementptr inbounds nuw i8, ptr %35, i64 8 ; 4 uses
...
bb.z:                                             ; preds = %bb.y
  ...
  %i.cy = getelementptr inbounds nuw i8, ptr %35, i64 12
  store i32 0, ptr %i.cy, align 4, !tbaa !140
  %i.cz = load ptr, ptr %35, align 8, !tbaa !141
  %i.da = getelementptr inbounds nuw i8, ptr %i.cz, i64 16
  %i.db = load ptr, ptr %i.da, align 8
  call void %i.db(ptr noundef nonnull align 8 dereferenceable(16) %35) #29, !inline_history !145
  %i.dc = load ptr, ptr %35, align 8, !tbaa !141
  %i.dd = getelementptr inbounds nuw i8, ptr %i.dc, i64 24
  %i.de = load ptr, ptr %i.dd, align 8
  call void %i.de(ptr noundef nonnull align 8 dereferenceable(16) %35) #29, !inline_history !145
...
_ZN6duckdb15SelectionVectorD2Ev.exit59:           ; preds = %_ZN6duckdb15SelectionVectorD2Ev.exit, %bb.z, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i57, %bb.ad
