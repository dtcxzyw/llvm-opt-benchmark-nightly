...
5:                                                ; preds = %_ZNK6duckdb15ReservoirSample20GetActiveSampleCountEv.exit
  %.018 = call i64 @llvm.usub.sat.i64(i64 %.06.i, i64 2048) ; 3 uses
  %.017 = call i64 @llvm.umin.i64(i64 %.06.i, i64 2048) ; 2 uses
  %6 = icmp ult i64 %.018, %.06.i
...
bb.l:                                             ; preds = %.lr.ph, %_ZNK6duckdb15SelectionVector9get_indexEm.exit
  %.043 = phi i64 [ %.018, %.lr.ph ], [ %i.bg, %_ZNK6duckdb15SelectionVector9get_indexEm.exit ] ; 4 uses
...
bb.t:                                             ; preds = %bb.s
  %i.ax = getelementptr inbounds nuw [4 x i8], ptr %i.aw, i64 %.043
  %i.ay = load i32, ptr %i.ax, align 4, !tbaa !3
  %i.az = zext i32 %i.ay to i64
  br label %_ZNK6duckdb15SelectionVector9get_indexEm.exit

_ZNK6duckdb15SelectionVector9get_indexEm.exit:    ; preds = %bb.s, %bb.t, %bb.o, %bb.p
  %.sink55 = phi i64 [ %i.ap, %bb.o ], [ %i.at, %bb.p ], [ %i.az, %bb.t ], [ %.043, %bb.s ]
  %i.ba = sub nuw i64 %.043, %.018
...
_ZN6duckdb15ReservoirSample5ChunkEv.exit39:       ; preds = %bb.x
  invoke void @_ZN6duckdb9DataChunk5SliceERKS0_RKNS_15SelectionVectorEmm(ptr noundef nonnull align 8 dereferenceable(72) %i.bk, ptr noundef nonnull align 8 dereferenceable(72) %i.bl, ptr noundef nonnull align 8 dereferenceable(24) %3, i64 noundef %.017, i64 noundef 0)
...
bb.z:                                             ; preds = %bb.y
  ...
  store i64 %.017, ptr %i.bn, align 8, !tbaa !103
