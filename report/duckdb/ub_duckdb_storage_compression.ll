...
begin_hunk_0_@_ZN6duckdb9RLEFilterIsEEvRNS_13ColumnSegmentERNS_15ColumnScanStateEmRNS_6VectorERNS_15SelectionVectorERmRKNS_11TableFilterERNS_16TableFilterStateE:bb.a
  ...
  %.0135210 = phi i64 [ 0, %.lr.ph214 ], [ %i.gc, %.loopexit ] ; 12 uses
...
begin_hunk_1_@_ZN6duckdb9RLEFilterIsEEvRNS_13ColumnSegmentERNS_15ColumnScanStateEmRNS_6VectorERNS_15SelectionVectorERmRKNS_11TableFilterERNS_16TableFilterStateE:bb.a
  ...
  %i.fj = shufflevector <4 x i64> %i.fi, <4 x i64> poison, <4 x i32> zeroinitializer
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.fm = shufflevector <4 x i64> %i.fl, <4 x i64> poison, <4 x i32> zeroinitializer
  %i.fn = or disjoint <4 x i64> %i.fm, <i64 4, i64 5, i64 6, i64 7>
  %18 = add i64 %index, %.0135210                 ; 2 uses
  %19 = add i64 %15, %.0135210
  %20 = add i64 %16, %.0135210
  %21 = add i64 %17, %.0135210
  %22 = insertelement <4 x i64> poison, i64 %18, i64 0
  %23 = insertelement <4 x i64> %22, i64 %19, i64 1
  %24 = insertelement <4 x i64> %23, i64 %20, i64 2
  %25 = insertelement <4 x i64> %24, i64 %21, i64 3
  %i.fo = add <4 x i64> %i.fn, %i.fj
  %i.fp = getelementptr inbounds nuw [2 x i8], ptr %i.dg, i64 %18 ; 2 uses
  ...
  %i.fr = trunc <4 x i64> %25 to <4 x i32>
...
begin_hunk_2_@_ZN6duckdb9RLEFilterIiEEvRNS_13ColumnSegmentERNS_15ColumnScanStateEmRNS_6VectorERNS_15SelectionVectorERmRKNS_11TableFilterERNS_16TableFilterStateE:bb.a
  ...
  %.0135210 = phi i64 [ 0, %.lr.ph214 ], [ %i.hr, %.loopexit ] ; 20 uses
...
begin_hunk_3_@_ZN6duckdb9RLEFilterIiEEvRNS_13ColumnSegmentERNS_15ColumnScanStateEmRNS_6VectorERNS_15SelectionVectorERmRKNS_11TableFilterERNS_16TableFilterStateE:bb.a
  ...
  %i.gk = shufflevector <4 x i64> %i.gj, <4 x i64> poison, <4 x i32> zeroinitializer
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.gq = getelementptr inbounds nuw [4 x i8], ptr %i.dg, i64 %18 ; 2 uses
  ...
  %i.gs = trunc <4 x i64> %25 to <4 x i32>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %25 = insertelement <4 x i64> %24, i64 %21, i64 3
  %i.fo = add <4 x i64> %i.fn, %i.fj
  %i.fp = getelementptr inbounds nuw [4 x i8], ptr %i.dg, i64 %18 ; 2 uses
