...
bb.i:                                             ; preds = %bb.h
  ...
  %i.by = zext i8 %i.bx to i16                    ; 3 uses
  %7 = insertelement <2 x i16> poison, i16 %i.by, i64 0
  %8 = shufflevector <2 x i16> %7, <2 x i16> poison, <2 x i32> zeroinitializer
  %9 = add nuw nsw <2 x i16> %8, %6
  %10 = urem <2 x i16> %9, splat (i16 255)        ; 2 uses
  %11 = extractelement <2 x i16> %10, i64 0
  %i.bz = zext nneg i16 %11 to i64
