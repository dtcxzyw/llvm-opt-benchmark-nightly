...
begin_hunk_1_@_ZN6duckdb21TemplatedValidityMaskImE4CopyERKS1_m:bb.a
  store i32 1, ptr %i.w, align 4, !tbaa !48, !noalias !192
  store ptr getelementptr inbounds nuw inrange(-16, 40) (i8, ptr @_ZTVSt23_Sp_counted_ptr_inplaceIN6duckdb21TemplatedValidityDataImEESaIvELN9__gnu_cxx12_Lock_policyE2EE, i64 16), ptr %i.u, align 8, !tbaa !49, !noalias !192
  %i.x = getelementptr inbounds nuw i8, ptr %i.u, i64 16 ; 3 uses
  %3 = load ptr, ptr %1, align 8, !tbaa !197, !noalias !192 ; 7 uses
  %4 = ptrtoaddr ptr %3 to i64
  store ptr null, ptr %i.x, align 8, !tbaa !198, !noalias !192
...
begin_hunk_2_@_ZN6duckdb21TemplatedValidityMaskImE4CopyERKS1_m:bb.a
          to label %.noexc.i.i.i.i.i unwind label %_ZNSt15__allocated_ptrISaISt23_Sp_counted_ptr_inplaceIN6duckdb21TemplatedValidityDataImEESaIvELN9__gnu_cxx12_Lock_policyE2EEEED2Ev.exit11.i.i.i.i.i, !noalias !192 ; 8 uses

.noexc.i.i.i.i.i:                                 ; preds = %bb.i
  store ptr %i.ab, ptr %i.x, align 8, !tbaa !197, !noalias !192
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %i.ae, align 8, !tbaa !40, !noalias !192
  %wide.load24 = load <2 x i64>, ptr %i.af, align 8, !tbaa !40, !noalias !192
end_hunk_3
...
.lr.ph.i.i.i.i.i.i.i.i.prol:                      ; preds = %.lr.ph.i.i.i.i.i.i.i.i.preheader25, %.lr.ph.i.i.i.i.i.i.i.i.prol
  ...
  %i.ak = load i64, ptr %i.aj, align 8, !tbaa !40, !noalias !192
  %i.al = getelementptr inbounds nuw [8 x i8], ptr %i.ab, i64 %.014.i.i.i.i.i.i.i.i.prol
  store i64 %i.ak, ptr %i.al, align 8, !tbaa !40, !noalias !192
end_hunk_4
...
_ZN6duckdb10shared_ptrINS_21TemplatedValidityDataImEELb1EED2Ev.exit13: ; preds = %bb.v, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i6, %bb.r, %_ZN6duckdb15make_shared_ptrINS_21TemplatedValidityDataImEEJRKPmRmEEENS_10shared_ptrIT_Lb1EEEDpOT0_.exit
  ...
  %i.co = load ptr, ptr %i.cn, align 8, !tbaa !197
...
_ZN6duckdb10shared_ptrINS_21TemplatedValidityDataImEELb1EED2Ev.exit: ; preds = %_ZN6duckdb10shared_ptrINS_21TemplatedValidityDataImEELb1EEaSEOS3_.exit, %bb.i, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i, %bb.m
  ...
  store ptr %i.an, ptr %0, align 8, !tbaa !39
  ret void
}
end_hunk_8
begin_hunk_9_@_ZN6duckdb11make_bufferINS_21TemplatedValidityDataImEEJRmEEENS_10shared_ptrIT_Lb1EEEDpOT0_:bb.a
  store ptr getelementptr inbounds nuw inrange(-16, 40) (i8, ptr @_ZTVSt23_Sp_counted_ptr_inplaceIN6duckdb21TemplatedValidityDataImEESaIvELN9__gnu_cxx12_Lock_policyE2EE, i64 16), ptr %i.a, align 8, !tbaa !49, !noalias !220
  %i.d = getelementptr inbounds nuw i8, ptr %i.a, i64 16 ; 3 uses
  %i.e = load i64, ptr %1, align 8, !tbaa !40, !noalias !220
  store ptr null, ptr %i.d, align 8, !tbaa !198, !noalias !220
  %i.f = add i64 %i.e, 63
...
begin_hunk_10_@_ZN6duckdb11make_bufferINS_21TemplatedValidityDataImEEJRmEEENS_10shared_ptrIT_Lb1EEEDpOT0_:bb.a
          to label %.noexc.i.i.i.i.i unwind label %_ZNSt15__allocated_ptrISaISt23_Sp_counted_ptr_inplaceIN6duckdb21TemplatedValidityDataImEESaIvELN9__gnu_cxx12_Lock_policyE2EEEED2Ev.exit10.i.i.i.i.i, !noalias !220 ; 2 uses

.noexc.i.i.i.i.i:                                 ; preds = %bb.a
  store ptr %i.i, ptr %i.d, align 8, !tbaa !197, !noalias !220
...
!194 = distinct !{!194, !"_ZSt11make_sharedIN6duckdb21TemplatedValidityDataImEEJRKPmRmEESt10shared_ptrINSt9enable_ifIXntsr8is_arrayIT_EE5valueES9_E4typeEEDpOT0_"}
!195 = distinct !{!195, !196, !"_ZN6duckdb15make_shared_ptrINS_21TemplatedValidityDataImEEJRKPmRmEEENS_10shared_ptrIT_Lb1EEEDpOT0_: argument 0"}
!196 = distinct !{!196, !"_ZN6duckdb15make_shared_ptrINS_21TemplatedValidityDataImEEJRKPmRmEEENS_10shared_ptrIT_Lb1EEEDpOT0_"}
!197 = !{!29, !29, i64 0}
!198 = !{!199, !29, i64 0}
!199 = !{!"_ZTSSt10_Head_baseILm0EPmLb0EE", !29, i64 0}
!200 = distinct !{!200, !64, !114, !115}
!201 = distinct !{!201, !67}
!202 = distinct !{!202, !64, !114}
end_hunk_11
