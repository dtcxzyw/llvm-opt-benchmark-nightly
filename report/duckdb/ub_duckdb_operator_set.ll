...
bb.a:
  ...
  %4 = alloca %"class.duckdb::vector.757", align 8 ; 11 uses
...
bb.k:                                             ; preds = %bb.j
  ...
  %6 = load ptr, ptr %i.af, align 8, !tbaa !531   ; 4 uses
  %7 = load ptr, ptr %i.ag, align 8, !tbaa !534
  %.not.i.i = icmp eq ptr %6, %7
  br i1 %.not.i.i, label %bb.m, label %bb.l

bb.l:                                             ; preds = %bb.k
  store ptr %i.al, ptr %6, align 8, !tbaa !148
...
bb.m:                                             ; preds = %bb.k
  %8 = load ptr, ptr %4, align 8, !tbaa !535      ; 4 uses
  %i.an = ptrtoint ptr %6 to i64
  %i.ao = ptrtoint ptr %8 to i64
...
bb.o:                                             ; preds = %.noexc29
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.ax, ptr align 8 %8, i64 %i.ap, i1 false)
...
_ZNSt10unique_ptrIN6duckdb25GroupedAggregateHashTableESt14default_deleteIS1_EED2Ev.exit: ; preds = %bb.s, %_ZN6duckdb10unique_ptrINS_25GroupedAggregateHashTableESt14default_deleteIS1_ELb1EEaSEOS4_.exit, %_ZNKSt14default_deleteIN6duckdb25GroupedAggregateHashTableEEclEPS1_.exit.i
  ...
  %i.bv = load ptr, ptr %4, align 8, !tbaa !535   ; 2 uses
...
bb.v:                                             ; preds = %.loopexit, %.loopexit.split-lp, %bb.q, %bb.u
  ...
  %9 = load ptr, ptr %4, align 8, !tbaa !535      ; 2 uses
  %.not.i.i.i31 = icmp eq ptr %9, null
