...
.lr.ph35.i:                                       ; preds = %.preheader.i, %bb.j
  ...
  %i.r = load ptr, ptr %i.q, align 8, !tbaa !314  ; 41 uses
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec449 = and i64 %i.z, 2305843009213693948   ; 3 uses
  %i.ec = mul i64 %n.vec449, 24
  %i.ed = getelementptr i8, ptr %i.r, i64 %i.ec
  %broadcast.splatinsert = insertelement <4 x i1> poison, i1 %i.eb, i64 0
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %vec.phi451 = phi <4 x i1> [ %broadcast.splat, %vec.epilog.ph ], [ %.fr461, %vec.epilog.vector.body ]
  %i.ee = mul i64 %index450, 24                   ; 4 uses
  ...
  %34 = insertelement <4 x i8> poison, i8 %i.ei, i64 0
  %35 = insertelement <4 x i8> %34, i8 %i.ej, i64 1
  %36 = insertelement <4 x i8> %35, i8 %i.ek, i64 2
  %37 = insertelement <4 x i8> %36, i8 %i.el, i64 3
  %38 = icmp eq <4 x i8> %37, splat (i8 103)
  %39 = or <4 x i1> %vec.phi451, %38
  %.fr461 = freeze <4 x i1> %39                   ; 2 uses
  %index.next456 = add nuw i64 %index450, 4       ; 2 uses
...
vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %40 = bitcast <4 x i1> %.fr461 to i4
  %i.en = icmp ne i4 %40, 0
...
!1788 = !{!"branch_weights", i32 4, i32 28}
