...
bb.a:
  ...
  %i.b = tail call zeroext i1 %i.a() #9, !inline_history !18
...
begin_hunk_3_@duckdb_je_decay_ns_until_purge:bb.a
  ...
  br i1 %i.ap, label %.preheader.i, label %vector.body, !llvm.loop !25
...
begin_hunk_4_@duckdb_je_decay_ns_until_purge:bb.a
  ...
  br i1 %i.bj, label %decay_npurge_after_interval.exit64, label %vector.body110, !llvm.loop !26
...
begin_hunk_5_@duckdb_je_decay_ns_until_purge:bb.a
  ...
  br i1 %i.cb, label %middle.block151, label %vector.body142, !llvm.loop !27
...
begin_hunk_6_@duckdb_je_decay_ns_until_purge:bb.a
  ...
  br i1 %i.ct, label %middle.block135, label %vector.body123, !llvm.loop !28
...
begin_hunk_7_@duckdb_je_decay_ns_until_purge:bb.a
  ...
  br i1 %exitcond.not.i67, label %.preheader.i68, label %scalar.ph137, !llvm.loop !29
...
begin_hunk_8_@duckdb_je_decay_ns_until_purge:bb.a
  ...
  br i1 %exitcond26.not.i71, label %decay_npurge_after_interval.exit72, label %.lr.ph22.i, !llvm.loop !30
