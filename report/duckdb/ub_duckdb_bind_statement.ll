...
bb.fp:                                            ; preds = %bb.fo
  invoke void @__cxa_throw(ptr nonnull %i.mj, ptr nonnull @_ZTIN6duckdb23NotImplementedExceptionE, ptr nonnull @_ZNSt13runtime_errorD2Ev) #27
          to label %bb.ny unwind label %bb.fq

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit459.thread: ; preds = %bb.fn
...
bb.fq:                                            ; preds = %bb.fp, %bb.fo
  ...
  br i1 %i.mo, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit459, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i457

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i457: ; preds = %bb.fq
  call void @_ZdlPv(ptr noundef %i.mm) #29
  call void @llvm.lifetime.end.p0(ptr nonnull %51) #25
  call void @llvm.lifetime.end.p0(ptr nonnull %50) #25
  br i1 %.0232, label %bb.fr, label %bb.np

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit459: ; preds = %bb.fq
  call void @llvm.lifetime.end.p0(ptr nonnull %51) #25
  call void @llvm.lifetime.end.p0(ptr nonnull %50) #25
  br i1 %.0232, label %bb.fr, label %bb.np

bb.fr:                                            ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i457, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit459.thread, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit459
  %.pn271740 = phi { ptr, i32 } [ %i.mk, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit459.thread ], [ %i.ml, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit459 ], [ %i.ml, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i457 ]
  call void @__cxa_free_exception(ptr %i.mj) #25
  br label %bb.np

bb.fs:                                            ; preds = %bb.fm, %.critedge.thread
  %i.mp = trunc nuw i8 %.0226.lcssa1303132413431361 to i1 ; 3 uses
...
bb.fu:                                            ; preds = %bb.ft
  ...
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2EPKcRKS3_(ptr noundef nonnull align 8 dereferenceable(32) %52, ptr noundef nonnull @.str.34, ptr noundef nonnull align 1 dereferenceable(1) %53)
          to label %bb.fv unwind label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit462.thread
...
bb.fw:                                            ; preds = %bb.fv
  invoke void @__cxa_throw(ptr nonnull %i.ng, ptr nonnull @_ZTIN6duckdb23NotImplementedExceptionE, ptr nonnull @_ZNSt13runtime_errorD2Ev) #27
          to label %bb.ny unwind label %bb.fx

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit462.thread: ; preds = %bb.fu
...
bb.fx:                                            ; preds = %bb.fw, %bb.fv
  ...
  br i1 %i.nl, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit462, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i460

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i460: ; preds = %bb.fx
  call void @_ZdlPv(ptr noundef %i.nj) #29
  call void @llvm.lifetime.end.p0(ptr nonnull %53) #25
  call void @llvm.lifetime.end.p0(ptr nonnull %52) #25
  br i1 %.0230, label %bb.fy, label %bb.np

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit462: ; preds = %bb.fx
  call void @llvm.lifetime.end.p0(ptr nonnull %53) #25
  call void @llvm.lifetime.end.p0(ptr nonnull %52) #25
  br i1 %.0230, label %bb.fy, label %bb.np

bb.fy:                                            ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i460, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit462.thread, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit462
  %.pn273743 = phi { ptr, i32 } [ %i.nh, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit462.thread ], [ %i.ni, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit462 ], [ %i.ni, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i460 ]
...
bb.gh:                                            ; preds = %bb.gg
  ...
  br i1 %i.oc, label %bb.gi, label %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit464
...
bb.gi:                                            ; preds = %bb.gh
  ...
  br label %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit464

_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit464: ; preds = %bb.gh, %bb.gi
  %i.oo = phi i8 [ 1, %bb.gh ], [ %i.on, %bb.gi ]
  br i1 %.0217.lcssa1305132213451359, label %bb.go, label %bb.gj

bb.gj:                                            ; preds = %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit464
  %or.cond3.not = and i1 %.not1379, %i.ny
...
bb.gk:                                            ; preds = %bb.gj
  ...
  %spec.select774 = select i1 %i.os, i8 %i.oo, i8 0
  br label %bb.go
...
bb.gt:                                            ; preds = %bb.gs
  invoke void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.233) #27
          to label %.noexc466 unwind label %bb.gx

.noexc466:                                        ; preds = %bb.gt
  unreachable

bb.gu:                                            ; preds = %bb.gs
  %i.pr = getelementptr inbounds nuw i8, ptr %55, i64 32 ; 4 uses
  %.not1289 = icmp eq ptr %i.pk, %i.pl
  br i1 %.not1289, label %_ZNSt6vectorIN6duckdb10unique_ptrINS0_10ExpressionESt14default_deleteIS2_ELb1EEESaIS5_EE7reserveEm.exit, label %_ZNSt12_Vector_baseIN6duckdb10unique_ptrINS0_10ExpressionESt14default_deleteIS2_ELb1EEESaIS5_EE11_M_allocateEm.exit.i
...
_ZNSt6vectorIN6duckdb10unique_ptrINS0_10ExpressionESt14default_deleteIS2_ELb1EEESaIS5_EE7reserveEm.exit: ; preds = %bb.gu, %_ZNSt12_Vector_baseIN6duckdb10unique_ptrINS0_10ExpressionESt14default_deleteIS2_ELb1EEESaIS5_EE13_M_deallocateEPS5_m.exit.i
  %.not1103 = icmp eq ptr %i.pk, %i.pl
  br i1 %.not1103, label %._crit_edge1097, label %.lr.ph1096

.lr.ph1096:                                       ; preds = %_ZNSt6vectorIN6duckdb10unique_ptrINS0_10ExpressionESt14default_deleteIS2_ELb1EEESaIS5_EE7reserveEm.exit
...
._crit_edge1097:                                  ; preds = %_ZNSt10unique_ptrIN6duckdb24BoundColumnRefExpressionESt14default_deleteIS1_EED2Ev.exit, %_ZNSt6vectorIN6duckdb10unique_ptrINS0_10ExpressionESt14default_deleteIS2_ELb1EEESaIS5_EE7reserveEm.exit
...
bb.gv:                                            ; preds = %bb.gq, %bb.gp
  %i.qa = landingpad { ptr, i32 }
          cleanup
  br label %_ZNSt6vectorIN6duckdb13ColumnBindingESaIS1_EED2Ev.exit538
...
bb.gy:                                            ; preds = %.lr.ph1096, %_ZNSt10unique_ptrIN6duckdb24BoundColumnRefExpressionESt14default_deleteIS1_EED2Ev.exit
  %.02211095 = phi i64 [ 0, %.lr.ph1096 ], [ %i.rx, %_ZNSt10unique_ptrIN6duckdb24BoundColumnRefExpressionESt14default_deleteIS1_EED2Ev.exit ] ; 4 uses
  %i.qd = invoke noundef nonnull align 8 dereferenceable(16) ptr @_ZN6duckdb6vectorINS_13ColumnBindingELb1ESaIS1_EEixEm(ptr noundef nonnull align 8 dereferenceable(24) %54, i64 noundef %.02211095)
          to label %bb.gz unwind label %bb.hf

bb.gz:                                            ; preds = %bb.gy
  %i.qe = invoke noundef nonnull align 8 dereferenceable(32) ptr @_ZN6duckdb6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEELb1ESaIS6_EEixEm(ptr noundef nonnull align 8 dereferenceable(24) %i.pw, i64 noundef %.02211095)
          to label %bb.ha unwind label %bb.hg

bb.ha:                                            ; preds = %bb.gz
  %i.qf = invoke noundef nonnull align 8 dereferenceable(24) ptr @_ZN6duckdb6vectorINS_11LogicalTypeELb1ESaIS1_EEixEm(ptr noundef nonnull align 8 dereferenceable(24) %i.px, i64 noundef %.02211095)
...
_ZNKSt6vectorIN6duckdb10unique_ptrINS0_10ExpressionESt14default_deleteIS2_ELb1EEESaIS5_EE12_M_check_lenEmPKc.exit.i.i.i: ; preds = %bb.hd
  ...
  %.not.i.i.i.i468 = icmp ne i64 %i.qu, 0
  ...
  %i.qw = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.qv) #26
          to label %.noexc470 unwind label %.loopexit ; 12 uses

.noexc470:                                        ; preds = %_ZNKSt6vectorIN6duckdb10unique_ptrINS0_10ExpressionESt14default_deleteIS2_ELb1EEESaIS5_EE12_M_check_lenEmPKc.exit.i.i.i
...
.lr.ph.i.i.i.i.i.i.i.preheader:                   ; preds = %.noexc470
  ...
  br i1 %min.iters.check, label %.lr.ph.i.i.i.i.i.i.i.preheader1413, label %vector.memcheck
...
vector.memcheck:                                  ; preds = %.lr.ph.i.i.i.i.i.i.i.preheader
  ...
  %scevgep1384 = getelementptr i8, ptr %scevgep, i64 %i.rf
  %scevgep1385 = getelementptr i8, ptr %i.ql, i64 8
  %scevgep1386 = getelementptr i8, ptr %scevgep1385, i64 %i.rf
  %bound0 = icmp ult ptr %i.qw, %scevgep1386
  %bound1 = icmp ult ptr %i.ql, %scevgep1384
  %found.conflict = and i1 %bound0, %bound1
  br i1 %found.conflict, label %.lr.ph.i.i.i.i.i.i.i.preheader1413, label %vector.ph
