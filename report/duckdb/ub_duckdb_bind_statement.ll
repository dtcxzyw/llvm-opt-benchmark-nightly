...
._crit_edge860:                                   ; preds = %_ZNSt10unique_ptrIN6duckdb24BoundColumnRefExpressionESt14default_deleteIS1_EED2Ev.exit, %bb.fa
  %i.px = phi ptr [ null, %bb.fa ], [ %i.rw, %_ZNSt10unique_ptrIN6duckdb24BoundColumnRefExpressionESt14default_deleteIS1_EED2Ev.exit ] ; 4 uses
  %i.py = phi ptr [ null, %bb.fa ], [ %i.rv, %_ZNSt10unique_ptrIN6duckdb24BoundColumnRefExpressionESt14default_deleteIS1_EED2Ev.exit ] ; 10 uses
  %i.pz = phi ptr [ null, %bb.fa ], [ %i.rx, %_ZNSt10unique_ptrIN6duckdb24BoundColumnRefExpressionESt14default_deleteIS1_EED2Ev.exit ] ; 4 uses
  %61 = ptrtoaddr ptr %i.px to i64                ; 2 uses
...
bb.fd:                                            ; preds = %.lr.ph859, %_ZNSt10unique_ptrIN6duckdb24BoundColumnRefExpressionESt14default_deleteIS1_EED2Ev.exit
  %i.qc = phi ptr [ null, %.lr.ph859 ], [ %i.rv, %_ZNSt10unique_ptrIN6duckdb24BoundColumnRefExpressionESt14default_deleteIS1_EED2Ev.exit ] ; 11 uses
  %i.qd = phi ptr [ null, %.lr.ph859 ], [ %i.rw, %_ZNSt10unique_ptrIN6duckdb24BoundColumnRefExpressionESt14default_deleteIS1_EED2Ev.exit ] ; 5 uses
  %i.qe = phi ptr [ null, %.lr.ph859 ], [ %i.rx, %_ZNSt10unique_ptrIN6duckdb24BoundColumnRefExpressionESt14default_deleteIS1_EED2Ev.exit ] ; 3 uses
  %.0156857 = phi i64 [ 0, %.lr.ph859 ], [ %i.ry, %_ZNSt10unique_ptrIN6duckdb24BoundColumnRefExpressionESt14default_deleteIS1_EED2Ev.exit ] ; 3 uses
  %i.qf = invoke noundef ptr @_ZNK6duckdb10unique_ptrINS_15LogicalOperatorESt14default_deleteIS1_ELb1EEptEv(ptr noundef nonnull align 8 dereferenceable(8) %i.is)
          to label %bb.fe unwind label %bb.fq

bb.fe:                                            ; preds = %bb.fd
  %i.qg = getelementptr inbounds nuw i8, ptr %i.qf, i64 64
  %i.qh = invoke noundef nonnull align 8 dereferenceable(24) ptr @_ZN6duckdb6vectorINS_11LogicalTypeELb1ESaIS1_EEixEm(ptr noundef nonnull align 8 dereferenceable(24) %i.qg, i64 noundef %.0156857)
          to label %bb.ff unwind label %bb.fq

bb.ff:                                            ; preds = %bb.fe
  %i.qi = invoke noundef nonnull align 8 dereferenceable(16) ptr @_ZN6duckdb6vectorINS_13ColumnBindingELb1ESaIS1_EEixEm(ptr noundef nonnull align 8 dereferenceable(24) %41, i64 noundef %.0156857)
          to label %bb.fg unwind label %bb.fq     ; 2 uses

bb.fg:                                            ; preds = %bb.ff
  call void @llvm.lifetime.start.p0(ptr nonnull %10)
  %i.qj = invoke noalias noundef nonnull dereferenceable(112) ptr @_Znwm(i64 noundef 112) #26
          to label %.noexc320 unwind label %bb.fq ; 6 uses

.noexc320:                                        ; preds = %bb.fg
  invoke void @_ZN6duckdb11LogicalTypeC1ERKS0_(ptr noundef nonnull align 8 dereferenceable(24) %10, ptr noundef nonnull align 8 dereferenceable(24) %i.qh)
          to label %bb.fh unwind label %bb.fi, !noalias !2285

bb.fh:                                            ; preds = %.noexc320
  %.sroa.0.0.copyload.i = load i64, ptr %i.qi, align 8, !tbaa !97, !noalias !2285
  %.sroa.2.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.qi, i64 8
  %.sroa.2.0.copyload.i = load i64, ptr %.sroa.2.0..sroa_idx.i, align 8, !tbaa !97, !noalias !2285
  invoke void @_ZN6duckdb24BoundColumnRefExpressionC1ENS_11LogicalTypeENS_13ColumnBindingEm(ptr noundef nonnull align 8 dereferenceable(112) %i.qj, ptr noundef nonnull %10, i64 %.sroa.0.0.copyload.i, i64 %.sroa.2.0.copyload.i, i64 noundef 0)
...
bb.fk:                                            ; preds = %bb.fj, %bb.fi
  %.pn.i = phi { ptr, i32 } [ %i.ql, %bb.fj ], [ %i.qk, %bb.fi ]
  call void @_ZdlPv(ptr noundef nonnull %i.qj) #29, !noalias !2285
  br label %.body321

bb.fl:                                            ; preds = %bb.fh
  call void @_ZN6duckdb11LogicalTypeD1Ev(ptr noundef nonnull align 8 dead_on_return(24) dereferenceable(24) %10) #25, !noalias !2285
  call void @llvm.lifetime.end.p0(ptr nonnull %10)
  %.not.i.i323 = icmp eq ptr %i.qe, %i.qd
  br i1 %.not.i.i323, label %bb.fn, label %bb.fm

bb.fm:                                            ; preds = %bb.fl
  %i.qm = ptrtoint ptr %i.qj to i64
  store i64 %i.qm, ptr %i.qe, align 8, !tbaa !117
  %i.qn = getelementptr inbounds nuw i8, ptr %i.qe, i64 8 ; 2 uses
  store ptr %i.qn, ptr %i.pv, align 8, !tbaa !334
  br label %_ZNSt10unique_ptrIN6duckdb24BoundColumnRefExpressionESt14default_deleteIS1_EED2Ev.exit

bb.fn:                                            ; preds = %bb.fl
  %i.qo = ptrtoint ptr %i.qd to i64               ; 3 uses
  %i.qp = ptrtoint ptr %i.qc to i64               ; 3 uses
  %i.qq = sub i64 %i.qo, %i.qp                    ; 3 uses
  %i.qr = icmp eq i64 %i.qq, 9223372036854775800
  br i1 %i.qr, label %bb.fo, label %_ZNKSt6vectorIN6duckdb10unique_ptrINS0_10ExpressionESt14default_deleteIS2_ELb1EEESaIS5_EE12_M_check_lenEmPKc.exit.i.i.i
...
_ZNKSt6vectorIN6duckdb10unique_ptrINS0_10ExpressionESt14default_deleteIS2_ELb1EEESaIS5_EE12_M_check_lenEmPKc.exit.i.i.i: ; preds = %bb.fn
  ...
  %.sroa.speculated.i.i.i.i324 = call i64 @llvm.umax.i64(i64 %i.qs, i64 1)
  %i.qt = add nsw i64 %.sroa.speculated.i.i.i.i324, %i.qs ; 2 uses
  ...
  %.not.i.i.i.i325 = icmp ne i64 %i.qw, 0
  call void @llvm.assume(i1 %.not.i.i.i.i325)
  %i.qx = shl nuw nsw i64 %i.qw, 3
  %i.qy = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.qx) #26
...
.noexc334:                                        ; preds = %_ZNKSt6vectorIN6duckdb10unique_ptrINS0_10ExpressionESt14default_deleteIS2_ELb1EEESaIS5_EE12_M_check_lenEmPKc.exit.i.i.i
  ...
  %i.ra = ptrtoint ptr %i.qj to i64
  store i64 %i.ra, ptr %i.qz, align 8, !tbaa !117
  %.not10.i.i.i.i.i.i.i326 = icmp eq ptr %i.qc, %i.qd
...
.lr.ph.i.i.i.i.i.i.i327.preheader:                ; preds = %.noexc334
  ...
  %min.iters.check1140 = icmp ult i64 %i.rc, 56
...
vector.memcheck1131:                              ; preds = %.lr.ph.i.i.i.i.i.i.i327.preheader
  %scevgep1132 = getelementptr i8, ptr %i.qy, i64 8
  %i.rf = add i64 %i.qo, -8
  %i.rg = sub i64 %i.rf, %i.qp
  %i.rh = and i64 %i.rg, -8                       ; 2 uses
  %scevgep1133 = getelementptr i8, ptr %scevgep1132, i64 %i.rh
  %scevgep1134 = getelementptr i8, ptr %i.qc, i64 8
  %scevgep1135 = getelementptr i8, ptr %scevgep1134, i64 %i.rh
  %bound01136 = icmp ult ptr %i.qy, %scevgep1135
  %bound11137 = icmp ult ptr %i.qc, %scevgep1133
...
vector.ph1141:                                    ; preds = %vector.memcheck1131
  %n.vec1143 = and i64 %i.re, 4611686018427387900 ; 3 uses
  %i.ri = shl i64 %n.vec1143, 3                   ; 2 uses
  %i.rj = getelementptr i8, ptr %i.qy, i64 %i.ri  ; 2 uses
  %i.rk = getelementptr i8, ptr %i.qc, i64 %i.ri
...
vector.body1144:                                  ; preds = %vector.body1144, %vector.ph1141
  ...
  %i.rl = shl i64 %index1145, 3                   ; 2 uses
  %next.gep1146 = getelementptr i8, ptr %i.qy, i64 %i.rl ; 2 uses
  %next.gep1147 = getelementptr i8, ptr %i.qc, i64 %i.rl ; 4 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !2288)
  call void @llvm.experimental.noalias.scope.decl(metadata !2291)
  %i.rm = getelementptr i8, ptr %next.gep1147, i64 16
  %wide.load1148 = load <2 x i64>, ptr %next.gep1147, align 8, !tbaa !117, !alias.scope !2293, !noalias !2288
  %wide.load1149 = load <2 x i64>, ptr %i.rm, align 8, !tbaa !117, !alias.scope !2293, !noalias !2288
  %i.rn = getelementptr i8, ptr %next.gep1146, i64 16
  store <2 x i64> %wide.load1148, ptr %next.gep1146, align 8, !tbaa !117, !alias.scope !2296, !noalias !2293
  store <2 x i64> %wide.load1149, ptr %i.rn, align 8, !tbaa !117, !alias.scope !2296, !noalias !2293
  %i.ro = getelementptr i8, ptr %next.gep1147, i64 16
  store <2 x ptr> splat (ptr null), ptr %next.gep1147, align 8, !tbaa !117, !alias.scope !2293, !noalias !2288
  store <2 x ptr> splat (ptr null), ptr %i.ro, align 8, !tbaa !117, !alias.scope !2293, !noalias !2288
  %index.next1150 = add nuw i64 %index1145, 4     ; 2 uses
  %i.rp = icmp eq i64 %index.next1150, %n.vec1143
  br i1 %i.rp, label %middle.block1151, label %vector.body1144, !llvm.loop !2298

middle.block1151:                                 ; preds = %vector.body1144
  %cmp.n1152 = icmp eq i64 %i.re, %n.vec1143
...
.lr.ph.i.i.i.i.i.i.i327.preheader1226:            ; preds = %vector.memcheck1131, %.lr.ph.i.i.i.i.i.i.i327.preheader, %middle.block1151
  %.012.i.i.i.i.i.i.i328.ph = phi ptr [ %i.qy, %vector.memcheck1131 ], [ %i.qy, %.lr.ph.i.i.i.i.i.i.i327.preheader ], [ %i.rj, %middle.block1151 ]
  %.0911.i.i.i.i.i.i.i329.ph = phi ptr [ %i.qc, %vector.memcheck1131 ], [ %i.qc, %.lr.ph.i.i.i.i.i.i.i327.preheader ], [ %i.rk, %middle.block1151 ]
  br label %.lr.ph.i.i.i.i.i.i.i327

.lr.ph.i.i.i.i.i.i.i327:                          ; preds = %.lr.ph.i.i.i.i.i.i.i327.preheader1226, %.lr.ph.i.i.i.i.i.i.i327
  %.012.i.i.i.i.i.i.i328 = phi ptr [ %i.rs, %.lr.ph.i.i.i.i.i.i.i327 ], [ %.012.i.i.i.i.i.i.i328.ph, %.lr.ph.i.i.i.i.i.i.i327.preheader1226 ] ; 2 uses
  %.0911.i.i.i.i.i.i.i329 = phi ptr [ %i.rr, %.lr.ph.i.i.i.i.i.i.i327 ], [ %.0911.i.i.i.i.i.i.i329.ph, %.lr.ph.i.i.i.i.i.i.i327.preheader1226 ] ; 3 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !2288)
  call void @llvm.experimental.noalias.scope.decl(metadata !2291)
  %i.rq = load i64, ptr %.0911.i.i.i.i.i.i.i329, align 8, !tbaa !117, !alias.scope !2291, !noalias !2288
  store i64 %i.rq, ptr %.012.i.i.i.i.i.i.i328, align 8, !tbaa !117, !alias.scope !2288, !noalias !2291
  store ptr null, ptr %.0911.i.i.i.i.i.i.i329, align 8, !tbaa !117, !alias.scope !2291, !noalias !2288
  %i.rr = getelementptr inbounds nuw i8, ptr %.0911.i.i.i.i.i.i.i329, i64 8 ; 2 uses
  %i.rs = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i.i.i.i328, i64 8 ; 2 uses
  %.not.i.i.i.i.i.i.i330 = icmp eq ptr %i.rr, %i.qd
...
_ZNSt6vectorIN6duckdb10unique_ptrINS0_10ExpressionESt14default_deleteIS2_ELb1EEESaIS5_EE11_S_relocateEPS5_S8_S8_RS6_.exit22.i.i.i: ; preds = %.lr.ph.i.i.i.i.i.i.i327, %middle.block1151, %.noexc334
  %.0.lcssa.i.i.i.i.i.i.i331 = phi ptr [ %i.qy, %.noexc334 ], [ %i.rj, %middle.block1151 ], [ %i.rs, %.lr.ph.i.i.i.i.i.i.i327 ]
  %i.rt = getelementptr inbounds nuw i8, ptr %.0.lcssa.i.i.i.i.i.i.i331, i64 8 ; 2 uses
  %.not.i23.i.i.i332 = icmp eq ptr %i.qc, null
...
bb.fp:                                            ; preds = %_ZNSt6vectorIN6duckdb10unique_ptrINS0_10ExpressionESt14default_deleteIS2_ELb1EEESaIS5_EE11_S_relocateEPS5_S8_S8_RS6_.exit22.i.i.i
  call void @_ZdlPv(ptr noundef nonnull %i.qc) #29
...
_ZNSt6vectorIN6duckdb10unique_ptrINS0_10ExpressionESt14default_deleteIS2_ELb1EEESaIS5_EE17_M_realloc_insertIJS5_EEEvN9__gnu_cxx17__normal_iteratorIPS5_S7_EEDpOT_.exit.i.i: ; preds = %bb.fp, %_ZNSt6vectorIN6duckdb10unique_ptrINS0_10ExpressionESt14default_deleteIS2_ELb1EEESaIS5_EE11_S_relocateEPS5_S8_S8_RS6_.exit22.i.i.i
  store ptr %i.qy, ptr %42, align 8, !tbaa !333
  store ptr %i.rt, ptr %i.pv, align 8, !tbaa !334
  %i.ru = getelementptr inbounds nuw [8 x i8], ptr %i.qy, i64 %i.qw ; 2 uses
  store ptr %i.ru, ptr %i.pw, align 8, !tbaa !335
  br label %_ZNSt10unique_ptrIN6duckdb24BoundColumnRefExpressionESt14default_deleteIS1_EED2Ev.exit
...
_ZNSt10unique_ptrIN6duckdb24BoundColumnRefExpressionESt14default_deleteIS1_EED2Ev.exit: ; preds = %_ZNSt6vectorIN6duckdb10unique_ptrINS0_10ExpressionESt14default_deleteIS2_ELb1EEESaIS5_EE17_M_realloc_insertIJS5_EEEvN9__gnu_cxx17__normal_iteratorIPS5_S7_EEDpOT_.exit.i.i, %bb.fm
  %i.rv = phi ptr [ %i.qy, %_ZNSt6vectorIN6duckdb10unique_ptrINS0_10ExpressionESt14default_deleteIS2_ELb1EEESaIS5_EE17_M_realloc_insertIJS5_EEEvN9__gnu_cxx17__normal_iteratorIPS5_S7_EEDpOT_.exit.i.i ], [ %i.qc, %bb.fm ] ; 2 uses
  %i.rw = phi ptr [ %i.ru, %_ZNSt6vectorIN6duckdb10unique_ptrINS0_10ExpressionESt14default_deleteIS2_ELb1EEESaIS5_EE17_M_realloc_insertIJS5_EEEvN9__gnu_cxx17__normal_iteratorIPS5_S7_EEDpOT_.exit.i.i ], [ %i.qd, %bb.fm ] ; 2 uses
  %i.rx = phi ptr [ %i.rt, %_ZNSt6vectorIN6duckdb10unique_ptrINS0_10ExpressionESt14default_deleteIS2_ELb1EEESaIS5_EE17_M_realloc_insertIJS5_EEEvN9__gnu_cxx17__normal_iteratorIPS5_S7_EEDpOT_.exit.i.i ], [ %i.qn, %bb.fm ] ; 2 uses
  %i.ry = add nuw i64 %.0156857, 1                ; 2 uses
  %i.rz = load ptr, ptr %i.ps, align 8, !tbaa !329
  %i.sa = load ptr, ptr %41, align 8, !tbaa !332
  %i.sb = ptrtoint ptr %i.rz to i64
  %i.sc = ptrtoint ptr %i.sa to i64
  %i.sd = sub i64 %i.sb, %i.sc
  %i.se = ashr exact i64 %i.sd, 4
  %i.sf = icmp ult i64 %i.ry, %i.se
  br i1 %i.sf, label %bb.fd, label %._crit_edge860, !llvm.loop !2300
...
_ZNSt10unique_ptrIN6duckdb24BoundColumnRefExpressionESt14default_deleteIS1_EED2Ev.exit342: ; preds = %_ZNSt10unique_ptrIN6duckdb24BoundColumnRefExpressionESt14default_deleteIS1_EED2Ev.exit342.loopexit.split-lp, %_ZNSt10unique_ptrIN6duckdb24BoundColumnRefExpressionESt14default_deleteIS1_EED2Ev.exit342.loopexit
  ...
  %i.sh = load ptr, ptr %i.qj, align 8, !tbaa !119
  %i.si = getelementptr inbounds nuw i8, ptr %i.sh, i64 8
  %i.sj = load ptr, ptr %i.si, align 8
  call void %i.sj(ptr noundef nonnull align 8 dereferenceable(88) %i.qj) #25, !inline_history !121
  br label %.body321

bb.fr:                                            ; preds = %._crit_edge860
  call void @llvm.experimental.noalias.scope.decl(metadata !2301)
  call void @llvm.lifetime.start.p0(ptr nonnull %9)
  %i.sk = invoke noalias noundef nonnull dereferenceable(152) ptr @_Znwm(i64 noundef 152) #26
...
.noexc343:                                        ; preds = %bb.fr
  ...
  invoke void @_ZN6duckdb23BoundConstantExpressionC1ENS_5ValueE(ptr noundef nonnull align 8 dereferenceable(152) %i.sk, ptr noundef nonnull %9)
...
bb.fs:                                            ; preds = %.noexc343
  ...
  call void @_ZdlPv(ptr noundef nonnull %i.sk) #29, !noalias !2301
  br label %.body344

bb.ft:                                            ; preds = %.noexc343
  store ptr %i.sk, ptr %43, align 8, !tbaa !2304, !alias.scope !2301
  call void @_ZN6duckdb5ValueD1Ev(ptr noundef nonnull align 8 dead_on_return(64) dereferenceable(64) %9) #25, !noalias !2301
  ...
  %i.sm = invoke noundef ptr @_ZNK6duckdb10unique_ptrINS_23BoundConstantExpressionESt14default_deleteIS1_ELb1EEptEv(ptr noundef nonnull align 8 dereferenceable(8) %43)
          to label %bb.fu unwind label %bb.gk     ; 2 uses

bb.fu:                                            ; preds = %bb.ft
  %i.sn = getelementptr inbounds nuw i8, ptr %i.sm, i64 16
  %i.so = getelementptr inbounds nuw i8, ptr %i.sm, i64 24
  %i.sp = load i64, ptr %i.so, align 8, !tbaa !16
  %i.sq = invoke noundef nonnull align 8 dereferenceable(32) ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_replaceEmmPKcm(ptr noundef nonnull align 8 dereferenceable(32) %i.sn, i64 noundef 0, i64 noundef %i.sp, ptr noundef nonnull @.str.150, i64 noundef 13)
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEPKc.exit: ; preds = %bb.fu
  %i.sr = getelementptr inbounds nuw i8, ptr %42, i64 8 ; 2 uses
  %i.ss = ptrtoint ptr %i.pz to i64
  %i.st = ptrtoint ptr %i.py to i64               ; 3 uses
  %i.su = sub i64 %i.ss, %i.st                    ; 3 uses
  %i.sv = ashr exact i64 %i.su, 3                 ; 4 uses
  %i.sw = load ptr, ptr %43, align 8, !tbaa !2304 ; 5 uses
  store ptr null, ptr %43, align 8, !tbaa !2304
  %i.sx = getelementptr inbounds nuw i8, ptr %42, i64 16 ; 2 uses
...
bb.fv:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEPKc.exit
  ...
  store i64 %i.sy, ptr %i.pz, align 8, !tbaa !117
  %i.sz = getelementptr inbounds nuw i8, ptr %i.pz, i64 8 ; 2 uses
  store ptr %i.sz, ptr %i.sr, align 8, !tbaa !334
...
bb.fw:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEPKc.exit
  %i.ta = icmp eq i64 %i.su, 9223372036854775800
  br i1 %i.ta, label %bb.fx, label %_ZNKSt6vectorIN6duckdb10unique_ptrINS0_10ExpressionESt14default_deleteIS2_ELb1EEESaIS5_EE12_M_check_lenEmPKc.exit.i.i.i348
...
_ZNKSt6vectorIN6duckdb10unique_ptrINS0_10ExpressionESt14default_deleteIS2_ELb1EEESaIS5_EE12_M_check_lenEmPKc.exit.i.i.i348: ; preds = %bb.fw
  %.sroa.speculated.i.i.i.i349 = call i64 @llvm.umax.i64(i64 %i.sv, i64 1)
  %i.tb = add nsw i64 %.sroa.speculated.i.i.i.i349, %i.sv ; 2 uses
  %i.tc = icmp ult i64 %i.tb, %i.sv
  %i.td = call i64 @llvm.umin.i64(i64 %i.tb, i64 1152921504606846975)
  %i.te = select i1 %i.tc, i64 1152921504606846975, i64 %i.td ; 3 uses
  %.not.i.i.i.i350 = icmp ne i64 %i.te, 0
  call void @llvm.assume(i1 %.not.i.i.i.i350)
  %i.tf = shl nuw nsw i64 %i.te, 3
  %i.tg = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.tf) #26
...
.noexc361:                                        ; preds = %_ZNKSt6vectorIN6duckdb10unique_ptrINS0_10ExpressionESt14default_deleteIS2_ELb1EEESaIS5_EE12_M_check_lenEmPKc.exit.i.i.i348
  %i.th = getelementptr inbounds nuw i8, ptr %i.tg, i64 %i.su
  %i.ti = ptrtoint ptr %i.sw to i64
  store i64 %i.ti, ptr %i.th, align 8, !tbaa !117
...
.lr.ph.i.i.i.i.i.i.i352.preheader:                ; preds = %.noexc361
  %i.tj = sub i64 %61, %i.st
  %i.tk = add i64 %i.tj, -8                       ; 2 uses
  %i.tl = lshr i64 %i.tk, 3
  %i.tm = add nuw nsw i64 %i.tl, 1                ; 2 uses
  %min.iters.check1162 = icmp ult i64 %i.tk, 152
...
vector.memcheck1155:                              ; preds = %.lr.ph.i.i.i.i.i.i.i352.preheader
  ...
  %scevgep1156 = getelementptr i8, ptr %i.tg, i64 %i.tq
  %scevgep1157 = getelementptr i8, ptr %i.py, i64 %i.tq
  %bound01158 = icmp ult ptr %i.tg, %scevgep1157
...
vector.ph1163:                                    ; preds = %vector.memcheck1155
  ...
  %i.ts = getelementptr i8, ptr %i.tg, i64 %i.tr  ; 2 uses
...
vector.body1166:                                  ; preds = %vector.body1166, %vector.ph1163
  ...
  %next.gep1168 = getelementptr i8, ptr %i.tg, i64 %i.tu ; 2 uses
...
.lr.ph.i.i.i.i.i.i.i352.preheader1224:            ; preds = %vector.memcheck1155, %.lr.ph.i.i.i.i.i.i.i352.preheader, %middle.block1173
  %.012.i.i.i.i.i.i.i353.ph = phi ptr [ %i.tg, %vector.memcheck1155 ], [ %i.tg, %.lr.ph.i.i.i.i.i.i.i352.preheader ], [ %i.ts, %middle.block1173 ]
...
_ZNSt6vectorIN6duckdb10unique_ptrINS0_10ExpressionESt14default_deleteIS2_ELb1EEESaIS5_EE11_S_relocateEPS5_S8_S8_RS6_.exit22.i.i.i356: ; preds = %.lr.ph.i.i.i.i.i.i.i352, %middle.block1173, %.noexc361
  %.0.lcssa.i.i.i.i.i.i.i357 = phi ptr [ %i.tg, %.noexc361 ], [ %i.ts, %middle.block1173 ], [ %i.ub, %.lr.ph.i.i.i.i.i.i.i352 ]
...
_ZNSt6vectorIN6duckdb10unique_ptrINS0_10ExpressionESt14default_deleteIS2_ELb1EEESaIS5_EE17_M_realloc_insertIJS5_EEEvN9__gnu_cxx17__normal_iteratorIPS5_S7_EEDpOT_.exit.i.i359: ; preds = %bb.fy, %_ZNSt6vectorIN6duckdb10unique_ptrINS0_10ExpressionESt14default_deleteIS2_ELb1EEESaIS5_EE11_S_relocateEPS5_S8_S8_RS6_.exit22.i.i.i356
  store ptr %i.tg, ptr %42, align 8, !tbaa !333
  store ptr %i.uc, ptr %i.sr, align 8, !tbaa !334
  %i.ud = getelementptr inbounds nuw [8 x i8], ptr %i.tg, i64 %i.te
  store ptr %i.ud, ptr %i.sx, align 8, !tbaa !335
  br label %_ZNSt10unique_ptrIN6duckdb10ExpressionESt14default_deleteIS1_EED2Ev.exit365
...
_ZNSt10unique_ptrIN6duckdb10ExpressionESt14default_deleteIS1_EED2Ev.exit365: ; preds = %bb.fv, %_ZNSt6vectorIN6duckdb10unique_ptrINS0_10ExpressionESt14default_deleteIS2_ELb1EEESaIS5_EE17_M_realloc_insertIJS5_EEEvN9__gnu_cxx17__normal_iteratorIPS5_S7_EEDpOT_.exit.i.i359
  %i.ue = phi ptr [ %i.sz, %bb.fv ], [ %i.uc, %_ZNSt6vectorIN6duckdb10unique_ptrINS0_10ExpressionESt14default_deleteIS2_ELb1EEESaIS5_EE17_M_realloc_insertIJS5_EEEvN9__gnu_cxx17__normal_iteratorIPS5_S7_EEDpOT_.exit.i.i359 ]
...
.noexc368:                                        ; preds = %_ZNSt10unique_ptrIN6duckdb10ExpressionESt14default_deleteIS1_EED2Ev.exit365
  ...
  %i.uj = load ptr, ptr %i.sx, align 8, !tbaa !335, !noalias !2318
...
.noexc.i.i:                                       ; preds = %bb.a
  %i.i = invoke noundef ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm(ptr noundef nonnull align 8 dereferenceable(96) %i.c, ptr noundef nonnull align 8 dereferenceable(8) %i.a, i64 noundef 0)
...
_ZSt4copyIPN6duckdb13PhysicalIndexES2_ET0_T_S4_S3_.exit: ; preds = %bb.l, %bb.m, %bb.n
  ...
  %i.ah = phi ptr [ %.pre, %bb.l ], [ %i.c, %bb.m ], [ %i.c, %bb.n ] ; 2 uses
  %i.ai = ptrtoaddr ptr %i.ag to i64
  %i.aj = ptrtoaddr ptr %i.ah to i64              ; 2 uses
...
.lr.ph.i.i.i.i.preheader:                         ; preds = %_ZSt4copyIPN6duckdb13PhysicalIndexES2_ET0_T_S4_S3_.exit
  ...
  %i.al = add i64 %.pre-phi33, %i.aj
  %i.am = sub i64 %2, %i.al
  %i.an = add i64 %i.am, -8                       ; 2 uses
  %i.ao = lshr i64 %i.an, 3
  %i.ap = add nuw nsw i64 %i.ao, 1                ; 2 uses
  %min.iters.check = icmp ult i64 %i.an, 104
...
bb.a:
end_hunk_1
begin_hunk_2_@_ZNKSt8__detail17_ReuseOrAllocNodeISaINS_10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEN6duckdb19StatementProperties15CatalogIdentityEELb1EEEEEclIJRKSD_EEEPSE_DpOT_:bb.a
bb.i:                                             ; preds = %_ZNSt16allocator_traitsISaINSt8__detail10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEN6duckdb19StatementProperties15CatalogIdentityEELb1EEEEE9constructISD_JRKSD_EEEvRSF_PT_DpOT0_.exit, %bb.h
  %.0 = phi ptr [ %i.ab, %bb.h ], [ %i.b, %_ZNSt16allocator_traitsISaINSt8__detail10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEN6duckdb19StatementProperties15CatalogIdentityEELb1EEEEE9constructISD_JRKSD_EEEvRSF_PT_DpOT0_.exit ]
  ret ptr %.0
...
_ZSt4copyIPSt17reference_wrapperIN6duckdb12CatalogEntryEES4_ET0_T_S6_S5_.exit: ; preds = %bb.l, %bb.m, %bb.n
  %i.ae = load ptr, ptr %1, align 8, !tbaa !778   ; 2 uses
...
begin_hunk_3_@_ZNSt10_HashtableIN6duckdb13PhysicalIndexES1_SaIS1_ENSt8__detail9_IdentityESt8equal_toIS1_ENS0_25PhysicalIndexHashFunctionENS3_18_Mod_range_hashingENS3_20_Default_ranged_hashENS3_20_Prime_rehash_policyENS3_17_Hashtable_traitsILb1ELb1ELb1EEEE9_M_assignIRKSD_NS3_10_AllocNodeISaINS3_10_Hash_nodeIS1_Lb1EEEEEEEEvOT_RKT0_:bb.a
  %i.af = urem i64 %i.ae, %i.v
  %i.ag = getelementptr inbounds nuw [8 x i8], ptr %i.j, i64 %i.af ; 2 uses
  %i.ah = load ptr, ptr %i.ag, align 8, !tbaa !756
  %.not32 = icmp eq ptr %i.ah, null
  br i1 %.not32, label %bb.j, label %bb.m

bb.j:                                             ; preds = %bb.i
  store ptr %.02636, ptr %i.ag, align 8, !tbaa !756
  br label %bb.m
...
.noexc15:                                         ; preds = %_ZNSt15__new_allocatorIN6duckdb13PhysicalIndexEE8allocateEmPKv.exit.i.i.i.i.i, %bb.f
  ...
  %i.av = load ptr, ptr %i.ai, align 8, !tbaa !1294 ; 5 uses
...
.noexc26:                                         ; preds = %_ZNSt15__new_allocatorIN6duckdb13PhysicalIndexEE8allocateEmPKv.exit.i.i.i.i.i17, %.loopexit31
  ...
  %i.cc = load ptr, ptr %i.bp, align 8, !tbaa !1294 ; 5 uses
