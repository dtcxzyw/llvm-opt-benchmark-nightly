Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/duckdb/original/bitstate?download=true
...
_ZN10duckdb_re28PODArrayINS_3JobEEC2Ei.exit.i:    ; preds = %bb.b
  ...
  %4 = load i32, ptr %i.a, align 8, !tbaa !55     ; 2 uses
...
_ZN10duckdb_re28BitState9GrowStackEv.exit:        ; preds = %_ZN10duckdb_re28PODArrayINS_3JobEEC2Ei.exit.i, %bb.c
  %i.n = phi i32 [ %4, %_ZN10duckdb_re28PODArrayINS_3JobEEC2Ei.exit.i ], [ %.pre, %bb.c ] ; 2 uses
