...
.preheader112:                                    ; preds = %.preheader113, %.loopexit
  ...
  %.sroa.099.0141 = phi ptr [ %i.eg, %.loopexit ], [ %i.al, %.preheader113 ] ; 7 uses
...
vector.memcheck218:                               ; preds = %.lr.ph.preheader
  %i.bx = sub nsw i64 %6, %i.bn
  %i.by = shl nsw i64 %i.bx, 3
  %i.bz = add nsw i64 %i.by, -1
  %diff.check219 = icmp ult i64 %i.bz, 31
  br i1 %diff.check219, label %.lr.ph.preheader235, label %vector.ph222

vector.ph222:                                     ; preds = %vector.memcheck218
  %n.vec224 = and i64 %i.bw, 4611686018427387900  ; 5 uses
  %i.ca = add nsw i64 %n.vec224, %6               ; 2 uses
  %i.cb = add nsw i64 %n.vec224, %i.bn            ; 2 uses
  %i.cc = shl i64 %n.vec224, 3
  %i.cd = getelementptr i8, ptr %i.bo, i64 %i.cc
  %invariant.gep = getelementptr [8 x i8], ptr %i.bk, i64 %6
...
vector.body225:                                   ; preds = %vector.body225, %vector.ph222
  ...
  %i.ce = shl i64 %index226, 3
  %next.gep = getelementptr i8, ptr %i.bo, i64 %i.ce ; 2 uses
  %i.cf = getelementptr i8, ptr %next.gep, i64 16
  %wide.load227 = load <2 x ptr>, ptr %next.gep, align 8, !tbaa !62
  %wide.load228 = load <2 x ptr>, ptr %i.cf, align 8, !tbaa !62
  %gep = getelementptr [8 x i8], ptr %invariant.gep, i64 %index226 ; 2 uses
  %i.cg = getelementptr inbounds nuw i8, ptr %gep, i64 16
  store <2 x ptr> %wide.load227, ptr %gep, align 8, !tbaa !62
  store <2 x ptr> %wide.load228, ptr %i.cg, align 8, !tbaa !62
  %index.next229 = add nuw i64 %index226, 4       ; 2 uses
  %i.ch = icmp eq i64 %index.next229, %n.vec224
  br i1 %i.ch, label %middle.block230, label %vector.body225, !llvm.loop !126

middle.block230:                                  ; preds = %vector.body225
  %cmp.n231 = icmp eq i64 %i.bw, %n.vec224
...
.lr.ph.preheader235:                              ; preds = %vector.memcheck218, %.lr.ph.preheader, %middle.block230
  %indvars.iv157.ph = phi i64 [ %6, %vector.memcheck218 ], [ %6, %.lr.ph.preheader ], [ %i.ca, %middle.block230 ]
  %indvars.iv.ph = phi i64 [ %i.bn, %vector.memcheck218 ], [ %i.bn, %.lr.ph.preheader ], [ %i.cb, %middle.block230 ]
  %.ph = phi ptr [ %i.bo, %vector.memcheck218 ], [ %i.bo, %.lr.ph.preheader ], [ %i.cd, %middle.block230 ]
  br label %.lr.ph

._crit_edge144:                                   ; preds = %.loopexit, %.loopexit.thread
  %.469191 = phi i32 [ %i.fu, %.loopexit.thread ], [ %.267, %.loopexit ] ; 2 uses
  %.pre170 = load ptr, ptr %i.aj, align 8, !tbaa !127 ; 2 uses
  %.pre171 = load ptr, ptr %i.am, align 8, !tbaa !128
  %i.ci = icmp eq ptr %.pre171, %.pre170
  br i1 %i.ci, label %_ZNSt6vectorIN10duckdb_re26SpliceESaIS1_EE5clearEv.exit, label %_ZSt8_DestroyIPN10duckdb_re26SpliceES1_EvT_S3_RSaIT0_E.exit.i.i
...
_ZSt8_DestroyIPN10duckdb_re26SpliceES1_EvT_S3_RSaIT0_E.exit.i.i: ; preds = %.preheader113, %._crit_edge144
  ...
  %i.cj = phi ptr [ %.pre170, %._crit_edge144 ], [ %i.al, %.preheader113 ]
  store ptr %i.cj, ptr %i.am, align 8, !tbaa !128
...
.lr.ph:                                           ; preds = %.lr.ph.preheader235, %.lr.ph
  ...
  %i.ck = phi ptr [ %i.cn, %.lr.ph ], [ %.ph, %.lr.ph.preheader235 ]
  %indvars.iv.next = add nsw i64 %indvars.iv, 1   ; 3 uses
  %i.cl = load ptr, ptr %i.ck, align 8, !tbaa !62
  %indvars.iv.next158 = add nsw i64 %indvars.iv157, 1 ; 2 uses
  %i.cm = getelementptr inbounds [8 x i8], ptr %i.bk, i64 %indvars.iv157
  store ptr %i.cl, ptr %i.cm, align 8, !tbaa !62
  %i.cn = getelementptr inbounds [8 x i8], ptr %i.bk, i64 %indvars.iv.next ; 2 uses
  %i.co = icmp ult ptr %i.cn, %i.bm
  br i1 %i.co, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !129

._crit_edge.loopexit:                             ; preds = %.lr.ph, %middle.block230
  %indvars.iv.next.lcssa = phi i64 [ %i.cb, %middle.block230 ], [ %indvars.iv.next, %.lr.ph ]
  %indvars.iv.next158.lcssa = phi i64 [ %i.ca, %middle.block230 ], [ %indvars.iv.next158, %.lr.ph ]
  %i.cp = trunc nsw i64 %indvars.iv.next158.lcssa to i32
  %i.cq = trunc nsw i64 %indvars.iv.next.lcssa to i32
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.preheader112
  %.166.lcssa = phi i32 [ %.065142, %.preheader112 ], [ %i.cp, %._crit_edge.loopexit ] ; 5 uses
  %.164.lcssa = phi i32 [ %.063143, %.preheader112 ], [ %i.cq, %._crit_edge.loopexit ] ; 3 uses
  %i.cr = load i32, ptr %i.ai, align 4, !tbaa !3
  switch i32 %i.cr, label %bb.m [
    i32 1, label %bb.h
    i32 2, label %bb.h
    i32 3, label %bb.l
  ]
...
bb.h:                                             ; preds = %._crit_edge, %._crit_edge
  ...
  %i.cs = load ptr, ptr %.sroa.099.0141, align 8, !tbaa !130
  store ptr %i.cs, ptr %i.c, align 16, !tbaa !62
  %i.ct = getelementptr inbounds nuw i8, ptr %.sroa.099.0141, i64 20
  %i.cu = load i32, ptr %i.ct, align 4, !tbaa !131
  %i.cv = invoke noundef ptr @_ZN10duckdb_re26Regexp17AlternateNoFactorEPPS0_iNS0_10ParseFlagsE(ptr noundef %i.bm, i32 noundef %i.cu, i32 noundef %2)
          to label %bb.i unwind label %bb.k

bb.i:                                             ; preds = %bb.h
  store ptr %i.cv, ptr %i.f, align 8, !tbaa !62
  %i.cw = invoke noundef ptr @_ZN10duckdb_re26Regexp6ConcatEPPS0_iNS0_10ParseFlagsE(ptr noundef nonnull %i.c, i32 noundef 2, i32 noundef %2)
          to label %bb.j unwind label %bb.k

bb.j:                                             ; preds = %bb.i
  %i.cx = load ptr, ptr %i.ag, align 8, !tbaa !108
  %i.cy = add nsw i32 %.166.lcssa, 1
  %i.cz = sext i32 %.166.lcssa to i64
  %i.da = getelementptr inbounds [8 x i8], ptr %i.cx, i64 %i.cz
  store ptr %i.cw, ptr %i.da, align 8, !tbaa !62
  %i.db = getelementptr inbounds nuw i8, ptr %.sroa.099.0141, i64 16
  %i.dc = load i32, ptr %i.db, align 8, !tbaa !132
  %i.dd = add nsw i32 %i.dc, %.164.lcssa
...
bb.l:                                             ; preds = %._crit_edge
  %i.df = load ptr, ptr %.sroa.099.0141, align 8, !tbaa !130
  %i.dg = add nsw i32 %.166.lcssa, 1
  %i.dh = sext i32 %.166.lcssa to i64
  %i.di = getelementptr inbounds [8 x i8], ptr %i.bk, i64 %i.dh
  store ptr %i.df, ptr %i.di, align 8, !tbaa !62
  %i.dj = getelementptr inbounds nuw i8, ptr %.sroa.099.0141, i64 16
  %i.dk = load i32, ptr %i.dj, align 8, !tbaa !132
...
bb.m:                                             ; preds = %._crit_edge
  ...
  %i.dn = getelementptr inbounds i8, ptr %i.g, i64 %i.dm
  store ptr %i.n, ptr %i.dn, align 8, !tbaa !77
  %i.do = load ptr, ptr %i.g, align 8, !tbaa !77
  %i.dp = getelementptr i8, ptr %i.do, i64 -24
  %i.dq = load i64, ptr %i.dp, align 8
  %i.dr = getelementptr inbounds i8, ptr %i.g, i64 %i.dq
  invoke void @_ZNSt9basic_iosIcSt11char_traitsIcEE4initEPSt15basic_streambufIcS1_E(ptr noundef nonnull align 8 dereferenceable(264) %i.dr, ptr noundef null)
...
bb.n:                                             ; preds = %bb.m
  ...
  invoke void @_ZNSt9basic_iosIcSt11char_traitsIcEE4initEPSt15basic_streambufIcS1_E(ptr noundef nonnull align 8 dereferenceable(264) %i.dv, ptr noundef nonnull %i.p)
...
bb.q:                                             ; preds = %bb.p, %bb.o
  %.pn.pn.i = phi { ptr, i32 } [ %i.dw, %bb.o ], [ %i.dx, %bb.p ]
...
_ZN10LogMessageC2EPKci.exit:                      ; preds = %bb.n
  %i.dy = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %i.g, ptr noundef nonnull @.str.3, i64 noundef 15)
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit: ; preds = %_ZN10LogMessageC2EPKci.exit
  %i.dz = load i32, ptr %i.ai, align 4, !tbaa !3
  %i.ea = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %i.g, i32 noundef %i.dz)
...
bb.r:                                             ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit
  ...
  %i.eb = load i64, ptr %i.y, align 8
  %i.ec = getelementptr inbounds i8, ptr %i.g, i64 %i.eb
end_hunk_0
