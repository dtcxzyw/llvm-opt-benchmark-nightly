...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec = load <4 x i64>, ptr %i.ab, align 8, !tbaa !550
  %strided.vec = shufflevector <4 x i64> %wide.vec, <4 x i64> poison, <2 x i32> <i32 0, i32 2>
  %wide.vec119 = load <4 x i64>, ptr %i.ac, align 8, !tbaa !550
  %strided.vec120 = shufflevector <4 x i64> %wide.vec119, <4 x i64> poison, <2 x i32> <i32 0, i32 2>
...
vector.body480:                                   ; preds = %vector.body480, %vector.ph477
  ...
  %wide.vec484 = load <4 x i64>, ptr %i.ju, align 8, !tbaa !550
  %strided.vec485 = shufflevector <4 x i64> %wide.vec484, <4 x i64> poison, <2 x i32> <i32 0, i32 2>
  %wide.vec486 = load <4 x i64>, ptr %i.jv, align 8, !tbaa !550
  %strided.vec487 = shufflevector <4 x i64> %wide.vec486, <4 x i64> poison, <2 x i32> <i32 0, i32 2>
...
vector.body446:                                   ; preds = %vector.body446, %vector.ph443
  ...
  %wide.vec450 = load <4 x i64>, ptr %i.wb, align 8, !tbaa !550
  %strided.vec451 = shufflevector <4 x i64> %wide.vec450, <4 x i64> poison, <2 x i32> <i32 0, i32 2>
  %wide.vec452 = load <4 x i64>, ptr %i.wc, align 8, !tbaa !550
  %strided.vec453 = shufflevector <4 x i64> %wide.vec452, <4 x i64> poison, <2 x i32> <i32 0, i32 2>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec = load <4 x i64>, ptr %i.afn, align 8, !tbaa !550
  %strided.vec = shufflevector <4 x i64> %wide.vec, <4 x i64> poison, <2 x i32> <i32 0, i32 2>
  %wide.vec438 = load <4 x i64>, ptr %i.afo, align 8, !tbaa !550
  %strided.vec439 = shufflevector <4 x i64> %wide.vec438, <4 x i64> poison, <2 x i32> <i32 0, i32 2>
...
vector.body667:                                   ; preds = %vector.body667, %vector.ph664
  ...
  %wide.vec671 = load <4 x i64>, ptr %i.kn, align 8, !tbaa !550
  %strided.vec672 = shufflevector <4 x i64> %wide.vec671, <4 x i64> poison, <2 x i32> <i32 0, i32 2>
  %wide.vec673 = load <4 x i64>, ptr %i.ko, align 8, !tbaa !550
  %strided.vec674 = shufflevector <4 x i64> %wide.vec673, <4 x i64> poison, <2 x i32> <i32 0, i32 2>
...
vector.body633:                                   ; preds = %vector.body633, %vector.ph630
  ...
  %wide.vec637 = load <4 x i64>, ptr %i.xm, align 8, !tbaa !550
  %strided.vec638 = shufflevector <4 x i64> %wide.vec637, <4 x i64> poison, <2 x i32> <i32 0, i32 2>
  %wide.vec639 = load <4 x i64>, ptr %i.xn, align 8, !tbaa !550
  %strided.vec640 = shufflevector <4 x i64> %wide.vec639, <4 x i64> poison, <2 x i32> <i32 0, i32 2>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec = load <4 x i64>, ptr %i.ahh, align 8, !tbaa !550
  %strided.vec = shufflevector <4 x i64> %wide.vec, <4 x i64> poison, <2 x i32> <i32 0, i32 2>
  %wide.vec625 = load <4 x i64>, ptr %i.ahi, align 8, !tbaa !550
  %strided.vec626 = shufflevector <4 x i64> %wide.vec625, <4 x i64> poison, <2 x i32> <i32 0, i32 2>
...
vector.body677:                                   ; preds = %vector.body677, %vector.ph674
  ...
  %wide.vec681 = load <4 x i64>, ptr %i.lh, align 8, !tbaa !550
  %strided.vec682 = shufflevector <4 x i64> %wide.vec681, <4 x i64> poison, <2 x i32> <i32 0, i32 2>
  %wide.vec683 = load <4 x i64>, ptr %i.li, align 8, !tbaa !550
  %strided.vec684 = shufflevector <4 x i64> %wide.vec683, <4 x i64> poison, <2 x i32> <i32 0, i32 2>
...
vector.body643:                                   ; preds = %vector.body643, %vector.ph640
  ...
  %wide.vec647 = load <4 x i64>, ptr %i.yy, align 8, !tbaa !550
  %strided.vec648 = shufflevector <4 x i64> %wide.vec647, <4 x i64> poison, <2 x i32> <i32 0, i32 2>
  %wide.vec649 = load <4 x i64>, ptr %i.yz, align 8, !tbaa !550
  %strided.vec650 = shufflevector <4 x i64> %wide.vec649, <4 x i64> poison, <2 x i32> <i32 0, i32 2>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec = load <4 x i64>, ptr %i.ajc, align 8, !tbaa !550
  %strided.vec = shufflevector <4 x i64> %wide.vec, <4 x i64> poison, <2 x i32> <i32 0, i32 2>
  %wide.vec635 = load <4 x i64>, ptr %i.ajd, align 8, !tbaa !550
  %strided.vec636 = shufflevector <4 x i64> %wide.vec635, <4 x i64> poison, <2 x i32> <i32 0, i32 2>
