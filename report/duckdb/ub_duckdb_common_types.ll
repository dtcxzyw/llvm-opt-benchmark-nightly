...
.preheader264:                                    ; preds = %bb.bw
  ...
  br i1 %or.cond, label %._crit_edge308, label %.preheader

.preheader:                                       ; preds = %.preheader264, %._crit_edge306.us
  %.081307 = phi i64 [ %20, %._crit_edge306.us ], [ 0, %.preheader264 ] ; 2 uses
...
bb.bz:                                            ; preds = %_ZN6duckdb10FlatVector6IsNullERKNS_6VectorEm.exit
  invoke void @_ZN6duckdb10FlatVector7SetNullERNS_6VectorEmb(ptr noundef nonnull align 8 dereferenceable(104) %i.iz, i64 noundef %i.jr, i1 noundef zeroext true)
          to label %_ZN6duckdb10FlatVector6IsNullERKNS_6VectorEm.exit.thread unwind label %.split.us

_ZN6duckdb10FlatVector6IsNullERKNS_6VectorEm.exit.thread: ; preds = %bb.bz, %_ZN6duckdb10FlatVector6IsNullERKNS_6VectorEm.exit, %bb.by
...
._crit_edge306.us:                                ; preds = %_ZN6duckdb10FlatVector6IsNullERKNS_6VectorEm.exit.thread
  %20 = add nuw i64 %.081307, 1                   ; 2 uses
  %21 = load i64, ptr %i.c, align 8, !tbaa !108
  %22 = icmp ult i64 %20, %21
  br i1 %22, label %.preheader, label %._crit_edge308, !llvm.loop !630
