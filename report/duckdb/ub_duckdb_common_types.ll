...
bb.ah:                                            ; preds = %.loopexit, %.loopexit.split-lp.loopexit.split-lp.loopexit, %.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp, %.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit, %.loopexit.split-lp.loopexit, %bb.m, %bb.t, %bb.s, %bb.i
  %.pn108.pn.pn.pn = phi { ptr, i32 } [ %i.r, %bb.i ], [ %i.bs, %bb.t ], [ %.pn105, %bb.m ], [ %i.br, %bb.s ], [ %lpad.loopexit, %.loopexit ], [ %lpad.loopexit206, %.loopexit.split-lp.loopexit ], [ %lpad.loopexit209, %.loopexit.split-lp.loopexit.split-lp.loopexit ], [ %lpad.loopexit211, %.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit ], [ %lpad.loopexit.split-lp212, %.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp ]
...
bb.aj:                                            ; preds = %bb.ai
  %i.db = load ptr, ptr %7, align 8, !tbaa !724
...
bb.an:                                            ; preds = %bb.am
  call void @_ZN6duckdb11LogicalTypeD1Ev(ptr noundef nonnull align 8 dead_on_return(24) dereferenceable(24) %9) #49
...
bb.ao:                                            ; preds = %bb.an
  call void @_ZN6duckdb5ValueD1Ev(ptr noundef nonnull align 8 dead_on_return(64) dereferenceable(64) %8) #49
...
.lr.ph242:                                        ; preds = %_ZN6duckdb15SelectionVectorC2Em.exit.preheader
  ...
  %i.es = load ptr, ptr %10, align 8, !tbaa !388  ; 2 uses
...
bb.bi:                                            ; preds = %bb.az, %bb.ay, %_ZN6duckdb15SelectionVectorC2Em.exit._crit_edge
  %i.ga = landingpad { ptr, i32 }
          cleanup
  call void @_ZN6duckdb15SelectionVectorD2Ev(ptr noundef nonnull align 8 dead_on_return(24) dereferenceable(24) %10) #49
  br label %.body
...
bb.bw:                                            ; preds = %.loopexit214, %.loopexit.split-lp215, %.loopexit218, %.loopexit.split-lp219, %bb.at, %.body, %bb.ax, %bb.ap
  ...
  call void @_ZN6duckdb19UnifiedVectorFormatD2Ev(ptr noundef nonnull align 8 dead_on_return(73) dereferenceable(73) %7) #49
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #49
  br label %bb.dj
...
bb.by:                                            ; preds = %bb.bx
  %i.hj = load ptr, ptr %11, align 8, !tbaa !724
...
bb.cc:                                            ; preds = %bb.cb
  call void @_ZN6duckdb11LogicalTypeD1Ev(ptr noundef nonnull align 8 dead_on_return(24) dereferenceable(24) %13) #49
...
bb.cd:                                            ; preds = %bb.cc
  call void @_ZN6duckdb5ValueD1Ev(ptr noundef nonnull align 8 dead_on_return(64) dereferenceable(64) %12) #49
...
bb.de:                                            ; preds = %.loopexit223, %.loopexit.split-lp224, %.loopexit228, %.loopexit.split-lp229, %bb.ci, %bb.cp, %bb.ce
  ...
  call void @_ZN6duckdb19UnifiedVectorFormatD2Ev(ptr noundef nonnull align 8 dead_on_return(73) dereferenceable(73) %11) #49
  call void @llvm.lifetime.end.p0(ptr nonnull %11) #49
  br label %bb.dj

bb.df:                                            ; preds = %bb.a
  call void @llvm.lifetime.start.p0(ptr nonnull %14) #49
  call void @_ZN6duckdb6Vector8GetValueERKS0_m(ptr dead_on_unwind nonnull writable sret(%"class.duckdb::Value") align 8 %14, ptr noundef nonnull align 8 dereferenceable(104) %1, i64 noundef %2)
...
bb.dg:                                            ; preds = %bb.df
  call void @_ZN6duckdb5ValueD1Ev(ptr noundef nonnull align 8 dead_on_return(64) dereferenceable(64) %14) #49
...
bb.dj:                                            ; preds = %bb.dh, %bb.de, %bb.bw, %bb.ah
  %.pn112 = phi { ptr, i32 } [ %i.kx, %bb.dh ], [ %.pn108.pn.pn.pn, %bb.ah ], [ %.pn97.pn.pn.pn.pn.pn.pn, %bb.bw ], [ %.pn90.pn.pn.pn, %bb.de ]
...
begin_hunk_31
  ...
  store <2 x i64> %.sroa.0.0.copyload4, ptr %i.bh, align 8
...
begin_hunk_32
  ...
  %.sroa.0.0.copyload6 = load <2 x i64>, ptr %i.a, align 8
...
begin_hunk_33
  ...
  store <2 x i64> %.sroa.0.0.copyload6, ptr %i.bf, align 8
  %.sroa.4.0..sroa_idx = getelementptr inbounds nuw i8, ptr %1, i64 56
