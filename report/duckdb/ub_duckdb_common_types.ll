...
.preheader394:                                    ; preds = %bb.c, %bb.b
  ...
  br i1 %i.j, label %.lr.ph.lr.ph, label %.thread
...
.lr.ph:                                           ; preds = %.lr.ph.lr.ph, %bb.bt
  ...
  %18 = phi i1 [ false, %.lr.ph.lr.ph ], [ true, %bb.bt ] ; 4 uses
  %.0242.not504 = phi i1 [ true, %.lr.ph.lr.ph ], [ false, %bb.bt ]
  br label %bb.d
...
bb.i:                                             ; preds = %bb.e, %bb.g
  ...
  br i1 %i.u, label %.lr.ph478, label %.thread

bb.j:                                             ; preds = %bb.d, %bb.d, %bb.d
  %i.v = add nuw i64 %.1228474, 1                 ; 2 uses
  %i.w = icmp ult i64 %i.v, %1
  br i1 %i.w, label %bb.d, label %.thread, !llvm.loop !949
...
bb.aa:                                            ; preds = %.lr.ph478
  ...
  br i1 %exitcond.not, label %.thread, label %.lr.ph478, !llvm.loop !951
...
begin_hunk_5_@_ZN6duckdb8Interval11FromCStringEPKcmRNS_10interval_tEPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEb:bb.a
  ...
  %19 = icmp eq i64 %i.ch, 0
  %or.cond30.not = and i1 %.0242.not504, %19
  br i1 %or.cond30.not, label %bb.ah, label %bb.al
...
.preheader:                                       ; preds = %bb.ai
  ...
  br i1 %i.ci, label %.lr.ph512, label %.thread
...
bb.ak:                                            ; preds = %.lr.ph512, %.lr.ph512, %.lr.ph512
  ...
  br i1 %exitcond606.not, label %.thread, label %.lr.ph512, !llvm.loop !958
...
bb.bt:                                            ; preds = %.invoke756, %.invoke
  ...
  br i1 %i.eu, label %.lr.ph, label %.thread
...
.thread:                                          ; preds = %bb.l, %bb.bt, %bb.i, %bb.j, %bb.aa, %.lr.ph509, %.lr.ph512, %bb.ak, %.preheader394, %.preheader, %bb.h, %._crit_edge510, %.thread382, %bb.ad, %bb.bv, %bb.bu, %bb.b, %bb.b, %bb.a, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit321, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit303
  %.10 = phi i1 [ false, %bb.a ], [ false, %.lr.ph509 ], [ false, %bb.h ], [ false, %bb.bv ], [ false, %bb.b ], [ false, %bb.ad ], [ false, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit321 ], [ false, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit303 ], [ false, %.preheader394 ], [ false, %bb.b ], [ %18, %bb.j ], [ false, %bb.bu ], [ %18, %bb.aa ], [ true, %.thread382 ], [ %18, %._crit_edge510 ], [ true, %bb.ak ], [ true, %.preheader ], [ false, %.lr.ph512 ], [ true, %bb.bt ], [ false, %bb.l ], [ %18, %bb.i ]
...
_ZN6duckdb12_GLOBAL__N_110TextReader8TryMatchEPKc.exit.thread: ; preds = %bb.bs, %.lr.ph.i.i305, %bb.bf, %.lr.ph.i.i294, %bb.ap, %.lr.ph.i.i283, %bb.ae, %.lr.ph.i.i272, %bb.w, %.lr.ph.i.i261, %bb.l, %.lr.ph.i.i, %._ZN6duckdb12_GLOBAL__N_110TextReader8TryMatchEPKc.exit.thread_crit_edge, %.critedge.i304, %.critedge.i293, %.critedge.i282, %.critedge.i271, %.critedge.i260, %.critedge.i
  ...
  %.0177 = phi i32 [ 5, %bb.bf ], [ 7, %._ZN6duckdb12_GLOBAL__N_110TextReader8TryMatchEPKc.exit.thread_crit_edge ], [ 4, %.critedge.i282 ], [ 6, %.critedge.i304 ], [ 4, %bb.ap ], [ 5, %.critedge.i293 ], [ 1, %.critedge.i ], [ 3, %bb.ae ], [ 2, %.critedge.i260 ], [ 1, %bb.l ], [ 3, %.critedge.i271 ], [ 2, %bb.w ], [ 1, %.lr.ph.i.i ], [ 2, %.lr.ph.i.i261 ], [ 3, %.lr.ph.i.i272 ], [ 4, %.lr.ph.i.i283 ], [ 5, %.lr.ph.i.i294 ], [ 6, %.lr.ph.i.i305 ], [ 6, %bb.bs ]
...
_ZN6duckdb12_GLOBAL__N_110TextReader8TryMatchEPKc.exit333: ; preds = %.lr.ph.i.i330, %bb.cc, %.critedge.i329, %bb.cd
  ...
  %.not11.i327 = phi i32 [ 0, %bb.cd ], [ 1, %.critedge.i329 ], [ 1, %bb.cc ], [ 1, %.lr.ph.i.i330 ]
  %.not11.i327.a = phi i1 [ false, %bb.cd ], [ true, %.critedge.i329 ], [ true, %bb.cc ], [ true, %.lr.ph.i.i330 ] ; 4 uses
...
bb.cr:                                            ; preds = %bb.cl, %_ZN6duckdb12_GLOBAL__N_110TextReader8TryMatchEPKc.exit344
  ...
  %i.vg = add nuw nsw i32 %.not11.i327, %i.vf     ; 8 uses
  %i.vh = select i1 %.not11.i316, i32 1000, i32 0 ; 4 uses
  %i.vi = or disjoint i32 %i.vh, %.0177
