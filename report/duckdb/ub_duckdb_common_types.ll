...
bb.an:                                            ; preds = %bb.am
  call void @_ZN6duckdb11LogicalTypeD1Ev(ptr noundef nonnull align 8 dead_on_return(24) dereferenceable(24) %10) #46
...
bb.bi:                                            ; preds = %bb.az, %bb.ay, %_ZN6duckdb15SelectionVectorC2Em.exit._crit_edge
  %i.ga = landingpad { ptr, i32 }
          cleanup
  call void @_ZN6duckdb15SelectionVectorD2Ev(ptr noundef nonnull align 8 dead_on_return(24) dereferenceable(24) %11) #46
  br label %.body
...
bb.bw:                                            ; preds = %.loopexit214, %.loopexit.split-lp215, %.loopexit218, %.loopexit.split-lp219, %bb.at, %.body, %bb.ax, %bb.ap
  ...
  call void @_ZN6duckdb19UnifiedVectorFormatD2Ev(ptr noundef nonnull align 8 dead_on_return(73) dereferenceable(73) %8) #46
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #46
  br label %bb.dj
...
bb.cc:                                            ; preds = %bb.cb
  call void @_ZN6duckdb11LogicalTypeD1Ev(ptr noundef nonnull align 8 dead_on_return(24) dereferenceable(24) %14) #46
...
bb.cd:                                            ; preds = %bb.cc
  call void @_ZN6duckdb5ValueD1Ev(ptr noundef nonnull align 8 dead_on_return(64) dereferenceable(64) %13) #46
...
bb.de:                                            ; preds = %.loopexit223, %.loopexit.split-lp224, %.loopexit228, %.loopexit.split-lp229, %bb.ci, %bb.cp, %bb.ce
  ...
  call void @_ZN6duckdb19UnifiedVectorFormatD2Ev(ptr noundef nonnull align 8 dead_on_return(73) dereferenceable(73) %12) #46
  call void @llvm.lifetime.end.p0(ptr nonnull %12) #46
  br label %bb.dj
...
bb.dg:                                            ; preds = %bb.df
  call void @_ZN6duckdb5ValueD1Ev(ptr noundef nonnull align 8 dead_on_return(64) dereferenceable(64) %15) #46
