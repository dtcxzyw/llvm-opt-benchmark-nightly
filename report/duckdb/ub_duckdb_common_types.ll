...
_ZNK6duckdb21TemplatedValidityMaskImE10RowIsValidEm.exit.thread: ; preds = %bb.f, %_ZNK6duckdb21TemplatedValidityMaskImE10RowIsValidEm.exit
  ...
  %i.m = call range(i64 0, 59) i64 @llvm.cttz.i64(i64 %i.l, i1 true)
...
.lr.ph55:                                         ; preds = %.lr.ph55, %.lr.ph55.preheader.new
  ...
  %i.ad = call range(i64 0, 59) i64 @llvm.cttz.i64(i64 %i.ac, i1 true)
  ...
  %i.ap = call range(i64 0, 59) i64 @llvm.cttz.i64(i64 %i.ao, i1 true)
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.bm = call range(i64 0, 59) i64 @llvm.cttz.i64(i64 %i.bl, i1 true)
...
.lr.ph55.epil.preheader:                          ; preds = %.loopexit.loopexit.unr-lcssa, %.lr.ph55.preheader
  ...
  %i.by = call range(i64 0, 59) i64 @llvm.cttz.i64(i64 %i.bx, i1 true)
