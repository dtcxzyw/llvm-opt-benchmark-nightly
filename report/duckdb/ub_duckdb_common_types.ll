...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %_ZN6duckdbL30TemplatedFlattenConstantVectorIbEEvPhS1_m.exit, label %.lr.ph.i184.preheader600

.lr.ph.i184.preheader600:                         ; preds = %.lr.ph.i184.preheader, %middle.block
  %.01.i185.ph = phi i64 [ 0, %.lr.ph.i184.preheader ], [ %n.vec, %middle.block ]
  br label %.lr.ph.i184

.lr.ph.i184:                                      ; preds = %.lr.ph.i184.preheader600, %.lr.ph.i184
  %.01.i185 = phi i64 [ %i.hn, %.lr.ph.i184 ], [ %.01.i185.ph, %.lr.ph.i184.preheader600 ] ; 2 uses
...
.lr.ph.i188.preheader:                            ; preds = %bb.bf
  %xtraiter628 = and i64 %i.ho, 3                 ; 3 uses
...
.lr.ph.i188:                                      ; preds = %.lr.ph.i188, %.lr.ph.i188.preheader.new
  ...
  br i1 %niter633.ncmp.3, label %_ZN6duckdbL30TemplatedFlattenConstantVectorIbEEvPhS1_m.exit.loopexit602.unr-lcssa, label %.lr.ph.i188, !llvm.loop !626
...
.lr.ph.i193.preheader:                            ; preds = %bb.bg
  %xtraiter622 = and i64 %i.hz, 3                 ; 3 uses
...
.lr.ph.i193:                                      ; preds = %.lr.ph.i193, %.lr.ph.i193.preheader.new
  ...
  %niter627.next.3 = add i64 %niter627, 4         ; 2 uses
  %niter627.ncmp.3 = icmp eq i64 %niter627.next.3, %unroll_iter626
  br i1 %niter627.ncmp.3, label %_ZN6duckdbL30TemplatedFlattenConstantVectorIbEEvPhS1_m.exit.loopexit603.unr-lcssa, label %.lr.ph.i193, !llvm.loop !627
...
.lr.ph.i198:                                      ; preds = %.lr.ph.i198, %.lr.ph.i198.preheader.new
  ...
  br i1 %niter.ncmp.3, label %_ZN6duckdbL30TemplatedFlattenConstantVectorIbEEvPhS1_m.exit.loopexit604.unr-lcssa, label %.lr.ph.i198, !llvm.loop !628
...
bb.bt:                                            ; preds = %bb.bo, %_ZN6duckdb17VectorArrayBuffer8GetChildEv.exit
  ...
  invoke void @_ZN6duckdb9make_uniqINS_6VectorEJRS1_EEENS_17TemplatedUniqueIfIT_Lb1EE25templated_unique_single_tEDpOT0_(ptr dead_on_unwind nonnull writable sret(%"class.duckdb::unique_ptr.238") align 8 %9, ptr noundef nonnull align 8 dereferenceable(104) %i.iv)
          to label %bb.bu unwind label %23
...
bb.bu:                                            ; preds = %bb.bt
  %i.jk = invoke noundef ptr @_ZNK6duckdb10unique_ptrINS_6VectorESt14default_deleteIS1_ELb1EEptEv(ptr noundef nonnull align 8 dereferenceable(8) %9)
          to label %bb.bv unwind label %25
...
bb.bv:                                            ; preds = %bb.bu
  ...
  invoke void @_ZN6duckdb6Vector7FlattenEm(ptr noundef nonnull align 8 dereferenceable(104) %i.jk, i64 noundef %i.jm)
          to label %bb.bw unwind label %25
...
bb.bw:                                            ; preds = %bb.bv
  ...
  invoke void @_ZN6duckdb15SelectionVectorC2Em(ptr noundef nonnull align 8 dereferenceable(24) %10, i64 noundef %i.jo)
          to label %.preheader264 unwind label %27

.preheader264:                                    ; preds = %bb.bw
  %i.jp = load i64, ptr %i.c, align 8, !tbaa !108
  %20 = icmp ne i64 %i.jp, 0
  %21 = icmp ne i64 %i.iw, 0
  %or.cond = and i1 %20, %21
  br i1 %or.cond, label %.preheader, label %._crit_edge308.split

.preheader:                                       ; preds = %.preheader264, %._crit_edge306
  %.081307 = phi i64 [ %29, %._crit_edge306 ], [ 0, %.preheader264 ] ; 2 uses
  %i.jq = mul i64 %.081307, %i.iw
  br label %bb.bx

._crit_edge308.split:                             ; preds = %._crit_edge306, %.preheader264
  %22 = invoke noundef nonnull align 8 dereferenceable(104) ptr @_ZNK6duckdb10unique_ptrINS_6VectorESt14default_deleteIS1_ELb1EEdeEv(ptr noundef nonnull align 8 dereferenceable(8) %9)
...
._crit_edge306:                                   ; preds = %_ZN6duckdb10FlatVector6IsNullERKNS_6VectorEm.exit.thread
  %29 = add nuw i64 %.081307, 1                   ; 2 uses
  %30 = load i64, ptr %i.c, align 8, !tbaa !108
  %31 = icmp ult i64 %29, %30
  br i1 %31, label %.preheader, label %._crit_edge308.split, !llvm.loop !629

bb.bx:                                            ; preds = %.preheader, %_ZN6duckdb10FlatVector6IsNullERKNS_6VectorEm.exit.thread
  %.082304 = phi i64 [ 0, %.preheader ], [ %i.kf, %_ZN6duckdb10FlatVector6IsNullERKNS_6VectorEm.exit.thread ] ; 5 uses
  %i.jr = add i64 %.082304, %i.jq                 ; 2 uses
  %i.js = invoke noundef nonnull align 8 dereferenceable(104) ptr @_ZNK6duckdb10unique_ptrINS_6VectorESt14default_deleteIS1_ELb1EEdeEv(ptr noundef nonnull align 8 dereferenceable(8) %9)
          to label %bb.by unwind label %32

bb.by:                                            ; preds = %bb.bx
  %i.jt = getelementptr inbounds nuw i8, ptr %i.js, i64 40
  %i.ju = load ptr, ptr %i.jt, align 8, !tbaa !519 ; 2 uses
  %.not.i.i203 = icmp eq ptr %i.ju, null
  br i1 %.not.i.i203, label %_ZN6duckdb10FlatVector6IsNullERKNS_6VectorEm.exit.thread, label %_ZN6duckdb10FlatVector6IsNullERKNS_6VectorEm.exit

_ZN6duckdb10FlatVector6IsNullERKNS_6VectorEm.exit: ; preds = %bb.by
  %i.jv = lshr i64 %.082304, 6
  %i.jw = and i64 %.082304, 63
  ...
  br i1 %i.kb, label %bb.bz, label %_ZN6duckdb10FlatVector6IsNullERKNS_6VectorEm.exit.thread

bb.bz:                                            ; preds = %_ZN6duckdb10FlatVector6IsNullERKNS_6VectorEm.exit
  invoke void @_ZN6duckdb10FlatVector7SetNullERNS_6VectorEmb(ptr noundef nonnull align 8 dereferenceable(104) %i.iz, i64 noundef %i.jr, i1 noundef zeroext true)
          to label %_ZN6duckdb10FlatVector6IsNullERKNS_6VectorEm.exit.thread unwind label %32

32:                                               ; preds = %bb.bz, %bb.bx
  %33 = landingpad { ptr, i32 }
          cleanup
  br label %bb.cf

_ZN6duckdb10FlatVector6IsNullERKNS_6VectorEm.exit.thread: ; preds = %bb.by, %_ZN6duckdb10FlatVector6IsNullERKNS_6VectorEm.exit, %bb.bz
  %i.kc = trunc i64 %.082304 to i32
  ...
  %i.kf = add nuw i64 %.082304, 1                 ; 2 uses
  %exitcond.not = icmp eq i64 %i.kf, %i.iw
  br i1 %exitcond.not, label %._crit_edge306, label %bb.bx, !llvm.loop !630

bb.ca:                                            ; preds = %._crit_edge308.split
  %i.kg = load i64, ptr %i.c, align 8, !tbaa !108
  %i.kh = mul i64 %i.kg, %i.iw
  invoke void @_ZN6duckdb16VectorOperations4CopyERKNS_6VectorERS1_RKNS_15SelectionVectorEmmm(ptr noundef nonnull align 8 dereferenceable(104) %22, ptr noundef nonnull align 8 dereferenceable(104) %i.iz, ptr noundef nonnull align 8 dereferenceable(24) %10, i64 noundef %i.kh, i64 noundef 0, i64 noundef 0)
...
bb.cd:                                            ; preds = %bb.ca, %._crit_edge308.split
...
bb.cf:                                            ; preds = %bb.ce, %bb.cd, %32
  %.pn89 = phi { ptr, i32 } [ %33, %32 ], [ %i.kq, %bb.ce ], [ %i.kp, %bb.cd ]
  call void @_ZN6duckdb15SelectionVectorD2Ev(ptr noundef nonnull align 8 dead_on_return(24) dereferenceable(24) %10) #46
  br label %bb.cg

bb.cg:                                            ; preds = %bb.cf, %27
  %.pn89.pn = phi { ptr, i32 } [ %.pn89, %bb.cf ], [ %28, %27 ]
  call void @llvm.lifetime.end.p0(ptr nonnull %10) #46
  br label %bb.ch

bb.ch:                                            ; preds = %bb.cg, %25
  %.pn89.pn.pn = phi { ptr, i32 } [ %.pn89.pn, %bb.cg ], [ %26, %25 ]
  call void @_ZNSt10unique_ptrIN6duckdb6VectorESt14default_deleteIS1_EED2Ev(ptr noundef nonnull align 8 dereferenceable(8) %9) #46
  br label %bb.ci

bb.ci:                                            ; preds = %bb.ch, %23
  %.pn89.pn.pn.pn = phi { ptr, i32 } [ %.pn89.pn.pn, %bb.ch ], [ %24, %23 ]
  call void @llvm.lifetime.end.p0(ptr nonnull %9) #46
  br label %bb.cj
...
.lr.ph.i.i.i.i.i.i.i.preheader:                   ; preds = %.noexc214
  ...
  %min.iters.check569 = icmp ult i64 %i.mf, 56
...
vector.memcheck:                                  ; preds = %.lr.ph.i.i.i.i.i.i.i.preheader
  ...
  %scevgep565 = getelementptr i8, ptr %scevgep, i64 %i.mk
  %scevgep566 = getelementptr i8, ptr %i.lq, i64 8
  %scevgep567 = getelementptr i8, ptr %scevgep566, i64 %i.mk
  %bound0 = icmp ult ptr %i.mb, %scevgep567
  %bound1 = icmp ult ptr %i.lq, %scevgep565
  %found.conflict = and i1 %bound0, %bound1
  br i1 %found.conflict, label %.lr.ph.i.i.i.i.i.i.i.preheader582, label %vector.ph570

vector.ph570:                                     ; preds = %vector.memcheck
  %n.vec572 = and i64 %i.mh, 4611686018427387900  ; 3 uses
  %i.ml = shl i64 %n.vec572, 3                    ; 2 uses
...
vector.body573:                                   ; preds = %vector.body573, %vector.ph570
  ...
  %i.mo = shl i64 %index574, 3                    ; 2 uses
  %next.gep = getelementptr i8, ptr %i.mb, i64 %i.mo ; 2 uses
  %next.gep575 = getelementptr i8, ptr %i.lq, i64 %i.mo ; 4 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !640)
  call void @llvm.experimental.noalias.scope.decl(metadata !643)
  %i.mp = getelementptr i8, ptr %next.gep575, i64 16
  %wide.load = load <2 x i64>, ptr %next.gep575, align 8, !tbaa !426, !alias.scope !645, !noalias !640
  %wide.load576 = load <2 x i64>, ptr %i.mp, align 8, !tbaa !426, !alias.scope !645, !noalias !640
  ...
  store <2 x i64> %wide.load576, ptr %i.mq, align 8, !tbaa !426, !alias.scope !648, !noalias !645
  %i.mr = getelementptr i8, ptr %next.gep575, i64 16
  ...
  %i.ms = icmp eq i64 %index.next577, %n.vec572
  br i1 %i.ms, label %middle.block578, label %vector.body573, !llvm.loop !650

middle.block578:                                  ; preds = %vector.body573
  %cmp.n579 = icmp eq i64 %i.mh, %n.vec572
...
middle.block:                                     ; preds = %vector.body
  %vector.recur.extract = extractelement <2 x i64> %wide.load131, i64 1 ; 2 uses
  %cmp.n = icmp eq i64 %i.f, %n.vec
  br i1 %cmp.n, label %._crit_edge, label %.lr.ph103.preheader134

.lr.ph103.preheader134:                           ; preds = %vector.memcheck, %.lr.ph103.preheader, %middle.block
  ...
  %xtraiter139 = and i64 %i.f, 3                  ; 2 uses
  %lcmp.mod140.not = icmp eq i64 %xtraiter139, 0
  br i1 %lcmp.mod140.not, label %.lr.ph103.prol.loopexit, label %.lr.ph103.prol

.lr.ph103.prol:                                   ; preds = %.lr.ph103.preheader134, %.lr.ph103.prol
  %.079102.prol = phi ptr [ %.079.prol, %.lr.ph103.prol ], [ %.079102.ph, %.lr.ph103.preheader134 ] ; 2 uses
  %.076101.prol = phi i64 [ %i.cm, %.lr.ph103.prol ], [ %.076101.ph, %.lr.ph103.preheader134 ]
  %.077100.prol = phi i64 [ %i.ci, %.lr.ph103.prol ], [ %.077100.ph, %.lr.ph103.preheader134 ]
  %.07899.prol = phi ptr [ %i.cl, %.lr.ph103.prol ], [ %.07899.ph, %.lr.ph103.preheader134 ] ; 2 uses
  %prol.iter = phi i64 [ %prol.iter.next, %.lr.ph103.prol ], [ 0, %.lr.ph103.preheader134 ]
...
.lr.ph103.prol.loopexit:                          ; preds = %.lr.ph103.prol, %.lr.ph103.preheader134
  %.lcssa136.unr = phi i64 [ poison, %.lr.ph103.preheader134 ], [ %i.ci, %.lr.ph103.prol ]
  %.lcssa.unr = phi ptr [ poison, %.lr.ph103.preheader134 ], [ %i.cl, %.lr.ph103.prol ]
  %.079.lcssa135.unr = phi ptr [ poison, %.lr.ph103.preheader134 ], [ %.079.prol, %.lr.ph103.prol ]
  %.079102.unr = phi ptr [ %.079102.ph, %.lr.ph103.preheader134 ], [ %.079.prol, %.lr.ph103.prol ]
  %.076101.unr = phi i64 [ %.076101.ph, %.lr.ph103.preheader134 ], [ %i.cm, %.lr.ph103.prol ]
  %.077100.unr = phi i64 [ %.077100.ph, %.lr.ph103.preheader134 ], [ %i.ci, %.lr.ph103.prol ]
  %.07899.unr = phi ptr [ %.07899.ph, %.lr.ph103.preheader134 ], [ %i.cl, %.lr.ph103.prol ]
...
._crit_edge:                                      ; preds = %.lr.ph103.prol.loopexit, %.lr.ph103, %middle.block, %bb.h
  ...
  %.077.lcssa = phi i64 [ %i.bm, %bb.h ], [ %vector.recur.extract, %middle.block ], [ %.lcssa136.unr, %.lr.ph103.prol.loopexit ], [ %i.df, %.lr.ph103 ]
  %.079.lcssa = phi ptr [ %.07998, %bb.h ], [ %i.bt, %middle.block ], [ %.079.lcssa135.unr, %.lr.ph103.prol.loopexit ], [ %.079.3, %.lr.ph103 ]
...
.lr.ph103:                                        ; preds = %.lr.ph103.prol.loopexit, %.lr.ph103
  ...
  %exitcond112.not.3 = icmp eq i64 %i.dj, %i.f
  br i1 %exitcond112.not.3, label %._crit_edge, label %.lr.ph103, !llvm.loop !1263
...
.loopexit:                                        ; preds = %_ZN6duckdb21TemplatedValidityMaskImE3SetEmb.exit, %_ZNK6duckdb21TemplatedValidityMaskImE10RowIsValidEm.exit.thread.us.epil.preheader, %.loopexit.loopexit.unr-lcssa, %.preheader, %.lr.ph.split.us, %.thread89, %bb.f, %bb.e, %bb.k, %._crit_edge, %bb.b
  ret void
}
