...
bb.d:                                             ; preds = %bb.c, %bb.b
  %.0 = phi i32 [ %narrow5, %bb.b ], [ %narrow4, %bb.c ]
  ret i32 %.0
}
...
bb.e:                                             ; preds = %bb.d
  ...
  %narrow5.i = sub nuw nsw i32 7, %i.bg
...
_ZN6duckdb4Date22ExtractISODayOfTheWeekENS_6date_tE.exit: ; preds = %bb.e, %bb.f
  %.0.i = phi i32 [ %narrow5.i, %bb.e ], [ %narrow4.i, %bb.f ] ; 3 uses
...
begin_hunk_6_@_ZN6duckdb12_GLOBAL__N_119FromStringRecursiveERNS0_10TextReaderERNS0_10BlobWriterEjbb:bb.a
  ...
  %24 = sub nuw nsw i64 9223372036854775807, %i.aou
