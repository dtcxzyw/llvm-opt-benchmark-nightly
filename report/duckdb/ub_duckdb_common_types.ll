...
.lr.ph:                                           ; preds = %bb.a, %tailrecurse.backedge
  ...
  %.tr124 = phi ptr [ %.tr.be, %tailrecurse.backedge ], [ %0, %bb.a ] ; 69 uses
...
bb.w:                                             ; preds = %.lr.ph
  store ptr @_ZN6duckdbL17CreateListSegmentERKNS_20ListSegmentFunctionsERNS_14ArenaAllocatorEt, ptr %.tr124, align 8, !tbaa !989
  %6 = getelementptr inbounds nuw i8, ptr %.tr124, i64 8
  store ptr @_ZN6duckdbL22WriteDataToListSegmentERKNS_20ListSegmentFunctionsERNS_14ArenaAllocatorEPNS_11ListSegmentERNS_28RecursiveUnifiedVectorFormatERm, ptr %6, align 8, !tbaa !1003
...
bb.am:                                            ; preds = %.lr.ph
  store ptr @_ZN6duckdbL18CreateArraySegmentERKNS_20ListSegmentFunctionsERNS_14ArenaAllocatorEt, ptr %.tr124, align 8, !tbaa !989
  %7 = getelementptr inbounds nuw i8, ptr %.tr124, i64 8
  store ptr @_ZN6duckdbL23WriteDataToArraySegmentERKNS_20ListSegmentFunctionsERNS_14ArenaAllocatorEPNS_11ListSegmentERNS_28RecursiveUnifiedVectorFormatERm, ptr %7, align 8, !tbaa !1003
