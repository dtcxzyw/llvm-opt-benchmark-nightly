...
bb.n:                                             ; preds = %_ZNK6duckdb21TemplatedValidityMaskImE10RowIsValidEm.exit.thread
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %7, ptr noundef nonnull align 8 dereferenceable(16) %i.x, i64 16, i1 false), !tbaa.struct !312
...
bb.o:                                             ; preds = %bb.n
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.z, ptr noundef nonnull align 8 dereferenceable(16) %7, i64 16, i1 false), !tbaa.struct !312
...
bb.aj:                                            ; preds = %bb.ai
  %i.db = load ptr, ptr %8, align 8, !tbaa !773
...
bb.an:                                            ; preds = %bb.am
  call void @_ZN6duckdb11LogicalTypeD1Ev(ptr noundef nonnull align 8 dead_on_return(24) dereferenceable(24) %10) #48
...
bb.ao:                                            ; preds = %bb.an
  call void @_ZN6duckdb5ValueD1Ev(ptr noundef nonnull align 8 dead_on_return(64) dereferenceable(64) %9) #48
...
.lr.ph242:                                        ; preds = %_ZN6duckdb15SelectionVectorC2Em.exit.preheader
  ...
  %i.es = load ptr, ptr %11, align 8, !tbaa !390  ; 2 uses
...
bb.bi:                                            ; preds = %bb.az, %bb.ay, %_ZN6duckdb15SelectionVectorC2Em.exit._crit_edge
  %i.ga = landingpad { ptr, i32 }
          cleanup
  call void @_ZN6duckdb15SelectionVectorD2Ev(ptr noundef nonnull align 8 dead_on_return(24) dereferenceable(24) %11) #48
  br label %.body
...
bb.bw:                                            ; preds = %.loopexit214, %.loopexit.split-lp215, %.loopexit218, %.loopexit.split-lp219, %bb.at, %.body, %bb.ax, %bb.ap
  ...
  call void @_ZN6duckdb19UnifiedVectorFormatD2Ev(ptr noundef nonnull align 8 dead_on_return(73) dereferenceable(73) %8) #48
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #48
  br label %bb.dj
...
bb.by:                                            ; preds = %bb.bx
  %i.hj = load ptr, ptr %12, align 8, !tbaa !773
...
bb.cc:                                            ; preds = %bb.cb
  call void @_ZN6duckdb11LogicalTypeD1Ev(ptr noundef nonnull align 8 dead_on_return(24) dereferenceable(24) %14) #48
...
bb.cd:                                            ; preds = %bb.cc
  call void @_ZN6duckdb5ValueD1Ev(ptr noundef nonnull align 8 dead_on_return(64) dereferenceable(64) %13) #48
...
bb.de:                                            ; preds = %.loopexit223, %.loopexit.split-lp224, %.loopexit228, %.loopexit.split-lp229, %bb.ci, %bb.cp, %bb.ce
  ...
  call void @_ZN6duckdb19UnifiedVectorFormatD2Ev(ptr noundef nonnull align 8 dead_on_return(73) dereferenceable(73) %12) #48
  call void @llvm.lifetime.end.p0(ptr nonnull %12) #48
  br label %bb.dj

bb.df:                                            ; preds = %bb.a
  call void @llvm.lifetime.start.p0(ptr nonnull %15) #48
  call void @_ZN6duckdb6Vector8GetValueERKS0_m(ptr dead_on_unwind nonnull writable sret(%"class.duckdb::Value") align 8 %15, ptr noundef nonnull align 8 dereferenceable(104) %1, i64 noundef %2), !inline_history !513
...
bb.dg:                                            ; preds = %bb.df
  call void @_ZN6duckdb5ValueD1Ev(ptr noundef nonnull align 8 dead_on_return(64) dereferenceable(64) %15) #48
  call void @llvm.lifetime.end.p0(ptr nonnull %15) #48
  br label %bb.di
