begin_hunk_0_@duckdb_je_pai_alloc_batch_default:bb.a
  ...
  %i.c = call ptr %i.b(ptr noundef %0, ptr noundef nonnull %1, i64 noundef %2, i64 noundef 4096, i1 noundef zeroext false, i1 noundef zeroext false, i1 noundef zeroext %5, ptr noundef nonnull %i.a) #2, !inline_history !12 ; 8 uses
  %i.d = load i8, ptr %i.a, align 1, !tbaa !7, !range !13, !noundef !14
  %i.e = load i8, ptr %6, align 1, !tbaa !7, !range !13, !noundef !14
  %i.f = or i8 %i.e, %i.d
...
bb.b:                                             ; preds = %.lr.ph
  ...
  store ptr %i.c, ptr %i.g, align 8, !tbaa !15
  %i.h = getelementptr inbounds nuw i8, ptr %i.c, i64 48 ; 4 uses
  store ptr %i.c, ptr %i.h, align 8, !tbaa !15
...
bb.c:                                             ; preds = %bb.b
  ...
  store ptr %i.l, ptr %i.g, align 8, !tbaa !15
  %i.m = load ptr, ptr %4, align 8, !tbaa !16
  %i.n = getelementptr inbounds nuw i8, ptr %i.m, i64 48
  store ptr %i.c, ptr %i.n, align 8, !tbaa !15
  %i.o = load ptr, ptr %i.h, align 8, !tbaa !15
  %i.p = getelementptr inbounds nuw i8, ptr %i.o, i64 40
  %i.q = load ptr, ptr %i.p, align 8, !tbaa !15
  store ptr %i.q, ptr %i.h, align 8, !tbaa !15
  %i.r = load ptr, ptr %4, align 8, !tbaa !16     ; 2 uses
  %i.s = getelementptr inbounds nuw i8, ptr %i.r, i64 48
  %i.t = load ptr, ptr %i.s, align 8, !tbaa !15
  %i.u = getelementptr inbounds nuw i8, ptr %i.t, i64 40
  store ptr %i.r, ptr %i.u, align 8, !tbaa !15
  %i.v = load ptr, ptr %i.h, align 8, !tbaa !15
  %i.w = getelementptr inbounds nuw i8, ptr %i.v, i64 40
  store ptr %i.c, ptr %i.w, align 8, !tbaa !15
  %.pre.i = load ptr, ptr %i.g, align 8, !tbaa !15
  br label %bb.d

bb.d:                                             ; preds = %bb.b, %bb.c
  %i.x = phi ptr [ %.pre.i, %bb.c ], [ %i.c, %bb.b ]
  store ptr %i.x, ptr %4, align 8, !tbaa !16
...
bb.a:
  ...
  %.val7 = load ptr, ptr %2, align 8, !tbaa !16   ; 2 uses
...
.thread.i:                                        ; preds = %bb.b
  ...
  store ptr %i.p, ptr %i.s, align 8, !tbaa !15
  %i.t = load ptr, ptr %i.h, align 8, !tbaa !15
  %i.u = getelementptr inbounds nuw i8, ptr %i.t, i64 40
  store ptr %.val9, ptr %i.u, align 8, !tbaa !15
...
edata_list_active_remove.exit:                    ; preds = %.thread.i, %bb.c
  ...
  call void %i.v(ptr noundef %0, ptr noundef %1, ptr noundef nonnull %.val9, ptr noundef nonnull %i.a) #2, !inline_history !21
  %i.w = load i8, ptr %i.a, align 1, !tbaa !7, !range !13, !noundef !14
  %i.x = load i8, ptr %3, align 1, !tbaa !7, !range !13, !noundef !14
  %i.y = or i8 %i.x, %i.w
  store i8 %i.y, ptr %3, align 1, !tbaa !7
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #2
  %.val = load ptr, ptr %2, align 8, !tbaa !16    ; 2 uses
