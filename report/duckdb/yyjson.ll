...
bb.iq:                                            ; preds = %bb.ip
  ...
  %.not526.i = icmp ne i32 %i.ciw, 0              ; 2 uses
...
bb.nj:                                            ; preds = %bb.ip
  ...
  %.not520.i = icmp ne i32 %i.dnt, 0              ; 2 uses
...
bb.rq:                                            ; preds = %bb.rp
  ...
  %.not512.i = icmp ne i32 %i.fwu, 0              ; 2 uses
...
bb.rt:                                            ; preds = %bb.rp
  ...
  %.not509.i = icmp ne i32 %i.fyg, 0              ; 2 uses
...
bb.is:                                            ; preds = %bb.ir
  ...
  %.not533.i = icmp ne i32 %i.cix, 0              ; 2 uses
...
bb.nm:                                            ; preds = %bb.ir
  ...
  %.not527.i = icmp ne i32 %i.dnu, 0              ; 2 uses
...
bb.ry:                                            ; preds = %bb.rx
  ...
  %.not517.i = icmp ne i32 %i.fxa, 0              ; 2 uses
...
bb.sc:                                            ; preds = %bb.rx
  ...
  %.not514.i = icmp ne i32 %i.fym, 0              ; 2 uses
