...
_ZN13duckdb_yyjsonL12write_indentEPhmm.exit:      ; preds = %select.unfold1707.prol.loopexit, %select.unfold1707, %bb.rl
  ...
  %6 = or disjoint i8 %i.fuu, 91
  %i.fuv = getelementptr inbounds nuw i8, ptr %.0.i1198.lcssa, i64 1
  store i8 %6, ptr %.0.i1198.lcssa, align 1, !tbaa !81
  %7 = or disjoint i8 %i.fuu, 93
  %i.fuw = getelementptr inbounds nuw i8, ptr %.0.i1198.lcssa, i64 2
  store i8 %7, ptr %i.fuv, align 1, !tbaa !81
...
bb.abk:                                           ; preds = %bb.abj
  ...
  %i.jnw = icmp eq i8 %i.geh, 7                   ; 4 uses
...
bb.abn:                                           ; preds = %bb.abm
  %i.jor = select i1 %i.jnw, i8 32, i8 0          ; 2 uses
  %8 = or disjoint i8 %i.jor, 91
  %i.jos = getelementptr inbounds nuw i8, ptr %.4341.i, i64 1
  store i8 %8, ptr %.4341.i, align 1, !tbaa !81
  %9 = or disjoint i8 %i.jor, 93
  %i.jot = getelementptr inbounds nuw i8, ptr %.4341.i, i64 2
  store i8 %9, ptr %i.jos, align 1, !tbaa !81
...
_ZN13duckdb_yyjsonL12write_indentEPhmm.exit848.i: ; preds = %select.unfold886.prol.loopexit, %select.unfold886, %bb.rq
  ...
  %7 = or disjoint i8 %i.fuv, 91
  %i.fuw = getelementptr inbounds nuw i8, ptr %.0.i846.i.lcssa, i64 1
  store i8 %7, ptr %.0.i846.i.lcssa, align 1, !tbaa !81
  %8 = or disjoint i8 %i.fuv, 93
  %i.fux = getelementptr inbounds nuw i8, ptr %.0.i846.i.lcssa, i64 2
  store i8 %8, ptr %i.fuw, align 1, !tbaa !81
...
bb.acc:                                           ; preds = %bb.acb
  ...
  %i.joh = icmp eq i8 %i.ges, 7                   ; 4 uses
...
bb.acg:                                           ; preds = %bb.acf
  %i.jpc = select i1 %i.joh, i8 32, i8 0          ; 2 uses
  %9 = or disjoint i8 %i.jpc, 91
  %i.jpd = getelementptr inbounds nuw i8, ptr %.4346.i, i64 1
  store i8 %9, ptr %.4346.i, align 1, !tbaa !81
  %10 = or disjoint i8 %i.jpc, 93
  %i.jpe = getelementptr inbounds nuw i8, ptr %.4346.i, i64 2
  store i8 %10, ptr %i.jpd, align 1, !tbaa !81
