...
bb.fp:                                            ; preds = %bb.fn, %bb.fo
  %.sink5234.a = phi i32 [ %i.ata, %bb.fo ], [ %i.asd, %bb.fn ]
  %.sink5230 = phi i32 [ %i.atb, %bb.fo ], [ %i.ase, %bb.fn ] ; 2 uses
  %.sink = phi i64 [ 16, %bb.fo ], [ 12, %bb.fn ]
  %i.atm = zext nneg i32 %.sink5234.a to i64
  ...
  %i.atq = zext i32 %.sink5230 to i64
  ...
  %.not107.i842 = icmp eq i32 %.sink5230, 0
...
_ZN13duckdb_yyjsonL27write_u64_len_15_to_17_trimEPhm.exit847: ; preds = %bb.fp, %bb.fr, %bb.fs
  %.sink5235.a = phi i64 [ %i.atw, %bb.fp ], [ %i.auu, %bb.fr ], [ %i.avf, %bb.fs ]
  %.pn.i839 = and i64 %.sink5235.a, 4294967295
...
bb.fw:                                            ; preds = %bb.fu, %bb.fv
  %.sink5249 = phi i32 [ %i.axi, %bb.fv ], [ %i.awl, %bb.fu ]
  %.sink5245 = phi i32 [ %i.axj, %bb.fv ], [ %i.awm, %bb.fu ] ; 2 uses
  %.sink5236 = phi i64 [ 16, %bb.fv ], [ 12, %bb.fu ]
  %i.axu = zext nneg i32 %.sink5249 to i64
  ...
  %i.axy = zext i32 %.sink5245 to i64
  ...
  %.not107.i864 = icmp eq i32 %.sink5245, 0
  %i.ayc = add nuw nsw i64 %i.axx, 2
  %i.ayd = select i1 %.not107.i864, i64 %i.ayc, i64 %i.ayb
  %i.aye = sub nsw i64 %.sink5236, %i.ayd
  br label %iter.check6138
...
iter.check6138:                                   ; preds = %bb.fz, %bb.fy, %bb.fw
  %.sink5251.a = phi i64 [ %i.azn, %bb.fz ], [ %i.azc, %bb.fy ], [ %i.aye, %bb.fw ]
  %i.azo = and i64 %.sink5251.a, 4294967295
  %i.azp = getelementptr inbounds nuw i8, ptr %i.avw, i64 %i.azo ; 2 uses
  %wide.trip.count3732 = zext nneg i32 %i.aqg to i64 ; 6 uses
  %min.iters.check6124 = icmp ult i32 %i.aqg, 4
  br i1 %min.iters.check6124, label %.lr.ph3125.preheader, label %vector.main.loop.iter.check6125

vector.main.loop.iter.check6125:                  ; preds = %iter.check6138
  %min.iters.check6126 = icmp ult i32 %i.aqg, 32
  br i1 %min.iters.check6126, label %vec.epilog.ph6142, label %vector.ph6127

vector.ph6127:                                    ; preds = %vector.main.loop.iter.check6125
  %n.mod.vf6128 = and i64 %wide.trip.count3732, 28
  %n.vec6129 = and i64 %wide.trip.count3732, 2147483616 ; 4 uses
  br label %vector.body6130

vector.body6130:                                  ; preds = %vector.body6130, %vector.ph6127
  %index6131 = phi i64 [ 0, %vector.ph6127 ], [ %index.next6134, %vector.body6130 ] ; 3 uses
  %i.azq = getelementptr inbounds nuw i8, ptr %i.aeb, i64 %index6131 ; 2 uses
  %i.azr = getelementptr inbounds nuw i8, ptr %i.azq, i64 1
  %i.azs = getelementptr inbounds nuw i8, ptr %i.azq, i64 17
  %wide.load6132.a = load <16 x i8>, ptr %i.azr, align 1, !tbaa !81
  %wide.load6133 = load <16 x i8>, ptr %i.azs, align 1, !tbaa !81
  %i.azt = getelementptr inbounds nuw i8, ptr %i.aeb, i64 %index6131 ; 2 uses
  %i.azu = getelementptr inbounds nuw i8, ptr %i.azt, i64 16
  store <16 x i8> %wide.load6132.a, ptr %i.azt, align 1, !tbaa !81
  store <16 x i8> %wide.load6133, ptr %i.azu, align 1, !tbaa !81
  %index.next6134 = add nuw i64 %index6131, 32    ; 2 uses
  %i.azv = icmp eq i64 %index.next6134, %n.vec6129
  br i1 %i.azv, label %middle.block6135, label %vector.body6130, !llvm.loop !299

middle.block6135:                                 ; preds = %vector.body6130
  %cmp.n6136 = icmp eq i64 %n.vec6129, %wide.trip.count3732
  br i1 %cmp.n6136, label %._crit_edge3126, label %vec.epilog.iter.check6140

vec.epilog.iter.check6140:                        ; preds = %middle.block6135
  %min.epilog.iters.check6141 = icmp eq i64 %n.mod.vf6128, 0
  br i1 %min.epilog.iters.check6141, label %.lr.ph3125.preheader, label %vec.epilog.ph6142, !prof !294

vec.epilog.ph6142:                                ; preds = %vector.main.loop.iter.check6125, %vec.epilog.iter.check6140
end_hunk_0
...
bb.ox:                                            ; preds = %bb.ov, %bb.ow
  %.sink5269.a = phi i32 [ %i.eek, %bb.ow ], [ %i.edn, %bb.ov ]
  %.sink5265 = phi i32 [ %i.eel, %bb.ow ], [ %i.edo, %bb.ov ] ; 2 uses
  %.sink5256 = phi i64 [ 16, %bb.ow ], [ 12, %bb.ov ]
  %i.eew = zext nneg i32 %.sink5269.a to i64
  ...
  %i.efa = zext i32 %.sink5265 to i64
...
_ZN13duckdb_yyjsonL27write_u64_len_15_to_17_trimEPhm.exit781: ; preds = %bb.ox, %bb.oz, %bb.pa
  %.sink5270.a = phi i64 [ %i.efg, %bb.ox ], [ %i.ege, %bb.oz ], [ %i.egp, %bb.pa ]
  %.pn.i773 = and i64 %.sink5270.a, 4294967295
...
bb.pe:                                            ; preds = %bb.pc, %bb.pd
  %.sink5284 = phi i32 [ %i.eji, %bb.pd ], [ %i.eil, %bb.pc ]
  %.sink5280 = phi i32 [ %i.ejj, %bb.pd ], [ %i.eim, %bb.pc ] ; 2 uses
  %.sink5271 = phi i64 [ 16, %bb.pd ], [ 12, %bb.pc ]
  %i.eju = zext nneg i32 %.sink5284 to i64
  ...
  %i.ejy = zext i32 %.sink5280 to i64
  ...
  %.not107.i798 = icmp eq i32 %.sink5280, 0
  %i.ekc = add nuw nsw i64 %i.ejx, 2
  %i.ekd = select i1 %.not107.i798, i64 %i.ekc, i64 %i.ekb
  %i.eke = sub nsw i64 %.sink5271, %i.ekd
  br label %iter.check6017
...
iter.check6017:                                   ; preds = %bb.ph, %bb.pg, %bb.pe
  %.sink5286.a = phi i64 [ %i.eln, %bb.ph ], [ %i.elc, %bb.pg ], [ %i.eke, %bb.pe ]
  %i.elo = and i64 %.sink5286.a, 4294967295
  %i.elp = getelementptr inbounds nuw i8, ptr %i.ehw, i64 %i.elo ; 2 uses
  %wide.trip.count = zext nneg i32 %i.ebq to i64  ; 6 uses
  %min.iters.check6003 = icmp ult i32 %i.ebq, 4
  br i1 %min.iters.check6003, label %.lr.ph2916.preheader, label %vector.main.loop.iter.check6004

vector.main.loop.iter.check6004:                  ; preds = %iter.check6017
  %min.iters.check6005 = icmp ult i32 %i.ebq, 32
  br i1 %min.iters.check6005, label %vec.epilog.ph6021, label %vector.ph6006

vector.ph6006:                                    ; preds = %vector.main.loop.iter.check6004
  %n.mod.vf6007 = and i64 %wide.trip.count, 28
  %n.vec6008 = and i64 %wide.trip.count, 2147483616 ; 4 uses
  br label %vector.body6009

vector.body6009:                                  ; preds = %vector.body6009, %vector.ph6006
  %index6010 = phi i64 [ 0, %vector.ph6006 ], [ %index.next6013, %vector.body6009 ] ; 3 uses
  %i.elq = getelementptr inbounds nuw i8, ptr %i.dpl, i64 %index6010 ; 2 uses
...
bb.yz:                                            ; preds = %bb.yx, %bb.yy
  %.sink5304.a = phi i32 [ %i.hyw, %bb.yy ], [ %i.hxz, %bb.yx ]
  %.sink5300 = phi i32 [ %i.hyx, %bb.yy ], [ %i.hya, %bb.yx ] ; 2 uses
  %.sink5291 = phi i64 [ 16, %bb.yy ], [ 12, %bb.yx ]
  %i.hzi = zext nneg i32 %.sink5304.a to i64
  ...
  %i.hzm = zext i32 %.sink5300 to i64
...
_ZN13duckdb_yyjsonL27write_u64_len_15_to_17_trimEPhm.exit: ; preds = %bb.yz, %bb.zb, %bb.zc
  %.sink5305.a = phi i64 [ %i.hzs, %bb.yz ], [ %i.iaq, %bb.zb ], [ %i.ibb, %bb.zc ]
  %.pn.i709 = and i64 %.sink5305.a, 4294967295
...
bb.zg:                                            ; preds = %bb.ze, %bb.zf
  %.sink5319 = phi i32 [ %i.idu, %bb.zf ], [ %i.icx, %bb.ze ]
  %.sink5315 = phi i32 [ %i.idv, %bb.zf ], [ %i.icy, %bb.ze ] ; 2 uses
  %.sink5306 = phi i64 [ 16, %bb.zf ], [ 12, %bb.ze ]
  %i.ieg = zext nneg i32 %.sink5319 to i64
  ...
  %i.iek = zext i32 %.sink5315 to i64
  ...
  %.not107.i732 = icmp eq i32 %.sink5315, 0
  %i.ieo = add nuw nsw i64 %i.iej, 2
  %i.iep = select i1 %.not107.i732, i64 %i.ieo, i64 %i.ien
  %i.ieq = sub nsw i64 %.sink5306, %i.iep
  br label %iter.check6109
...
iter.check6109:                                   ; preds = %bb.zj, %bb.zi, %bb.zg
  %.sink5321.a = phi i64 [ %i.ifz, %bb.zj ], [ %i.ifo, %bb.zi ], [ %i.ieq, %bb.zg ]
  %i.iga = and i64 %.sink5321.a, 4294967295
  %i.igb = getelementptr inbounds nuw i8, ptr %i.ici, i64 %i.iga ; 2 uses
  %wide.trip.count3713 = zext nneg i32 %i.hwc to i64 ; 6 uses
  %min.iters.check6095 = icmp ult i32 %i.hwc, 4
  br i1 %min.iters.check6095, label %.lr.ph3038.preheader, label %vector.main.loop.iter.check6096

vector.main.loop.iter.check6096:                  ; preds = %iter.check6109
  %min.iters.check6097 = icmp ult i32 %i.hwc, 32
  br i1 %min.iters.check6097, label %vec.epilog.ph6113, label %vector.ph6098

vector.ph6098:                                    ; preds = %vector.main.loop.iter.check6096
  %n.mod.vf6099 = and i64 %wide.trip.count3713, 28
  %n.vec6100 = and i64 %wide.trip.count3713, 2147483616 ; 4 uses
  br label %vector.body6101

vector.body6101:                                  ; preds = %vector.body6101, %vector.ph6098
  %index6102 = phi i64 [ 0, %vector.ph6098 ], [ %index.next6105, %vector.body6101 ] ; 3 uses
  %i.igc = getelementptr inbounds nuw i8, ptr %i.hjx, i64 %index6102 ; 2 uses
...
bb.fp:                                            ; preds = %bb.fn, %bb.fo
  %.sink4423 = phi i32 [ %i.ata, %bb.fo ], [ %i.asd, %bb.fn ]
  %.sink4419 = phi i32 [ %i.atb, %bb.fo ], [ %i.ase, %bb.fn ] ; 2 uses
  %.sink = phi i64 [ 16, %bb.fo ], [ 12, %bb.fn ]
  %i.atm = zext nneg i32 %.sink4423 to i64
  %i.atn = getelementptr inbounds nuw i8, ptr @_ZN13duckdb_yyjsonL23dec_trailing_zero_tableE, i64 %i.atm
  %i.ato = load i8, ptr %i.atn, align 1, !tbaa !81
  %i.atp = zext i8 %i.ato to i64
  %i.atq = zext i32 %.sink4419 to i64
  %i.atr = getelementptr inbounds nuw i8, ptr @_ZN13duckdb_yyjsonL23dec_trailing_zero_tableE, i64 %i.atq
  %i.ats = load i8, ptr %i.atr, align 1, !tbaa !81
  %i.att = zext i8 %i.ats to i64
  %.not107.i142.i = icmp eq i32 %.sink4419, 0
  %i.atu = add nuw nsw i64 %i.atp, 2
...
_ZN13duckdb_yyjsonL27write_u64_len_15_to_17_trimEPhm.exit.i: ; preds = %bb.fs, %bb.fr, %bb.fp
  %.sink4425.a = phi i64 [ %i.avf, %bb.fs ], [ %i.auu, %bb.fr ], [ %i.atw, %bb.fp ]
  %i.avg = and i64 %.sink4425.a, 4294967295
...
bb.fw:                                            ; preds = %bb.fu, %bb.fv
  %.sink4439.a = phi i32 [ %i.axk, %bb.fv ], [ %i.awn, %bb.fu ]
  %.sink4435 = phi i32 [ %i.axl, %bb.fv ], [ %i.awo, %bb.fu ] ; 2 uses
  %.sink4426 = phi i64 [ 16, %bb.fv ], [ 12, %bb.fu ]
  %i.axw = zext nneg i32 %.sink4439.a to i64
  ...
  %i.aya = zext i32 %.sink4435 to i64
  ...
  %.not107.i162.i = icmp eq i32 %.sink4435, 0
  %i.aye = add nuw nsw i64 %i.axz, 2
  %i.ayf = select i1 %.not107.i162.i, i64 %i.aye, i64 %i.ayd
  %i.ayg = sub nsw i64 %.sink4426, %i.ayf
  br label %iter.check5329
...
iter.check5329:                                   ; preds = %bb.fw, %bb.fy, %bb.fz
  %.sink4440.a = phi i64 [ %i.ayg, %bb.fw ], [ %i.aze, %bb.fy ], [ %i.azp, %bb.fz ]
  %.pn.i159.i = and i64 %.sink4440.a, 4294967295
  ...
  %min.iters.check5315 = icmp ult i32 %i.aqg, 4
  br i1 %min.iters.check5315, label %.lr.ph2306.preheader, label %vector.main.loop.iter.check5316

vector.main.loop.iter.check5316:                  ; preds = %iter.check5329
  %min.iters.check5317 = icmp ult i32 %i.aqg, 32
  br i1 %min.iters.check5317, label %vec.epilog.ph5333, label %vector.ph5318

vector.ph5318:                                    ; preds = %vector.main.loop.iter.check5316
  %n.mod.vf5319 = and i64 %wide.trip.count2915, 28
  %n.vec5320 = and i64 %wide.trip.count2915, 2147483616 ; 4 uses
  br label %vector.body5321

vector.body5321:                                  ; preds = %vector.body5321, %vector.ph5318
  %index5322 = phi i64 [ 0, %vector.ph5318 ], [ %index.next5325, %vector.body5321 ] ; 3 uses
  %i.azq = getelementptr inbounds nuw i8, ptr %i.aeb, i64 %index5322 ; 2 uses
  %i.azr = getelementptr inbounds nuw i8, ptr %i.azq, i64 1
  %i.azs = getelementptr inbounds nuw i8, ptr %i.azq, i64 17
  %wide.load5323.a = load <16 x i8>, ptr %i.azr, align 1, !tbaa !81
  %wide.load5324 = load <16 x i8>, ptr %i.azs, align 1, !tbaa !81
  %i.azt = getelementptr inbounds nuw i8, ptr %i.aeb, i64 %index5322 ; 2 uses
  %i.azu = getelementptr inbounds nuw i8, ptr %i.azt, i64 16
  store <16 x i8> %wide.load5323.a, ptr %i.azt, align 1, !tbaa !81
  store <16 x i8> %wide.load5324, ptr %i.azu, align 1, !tbaa !81
  %index.next5325 = add nuw i64 %index5322, 32    ; 2 uses
  %i.azv = icmp eq i64 %index.next5325, %n.vec5320
  br i1 %i.azv, label %middle.block5326, label %vector.body5321, !llvm.loop !347

middle.block5326:                                 ; preds = %vector.body5321
  %cmp.n5327 = icmp eq i64 %n.vec5320, %wide.trip.count2915
  br i1 %cmp.n5327, label %._crit_edge2307, label %vec.epilog.iter.check5331

vec.epilog.iter.check5331:                        ; preds = %middle.block5326
  %min.epilog.iters.check5332 = icmp eq i64 %n.mod.vf5319, 0
  br i1 %min.epilog.iters.check5332, label %.lr.ph2306.preheader, label %vec.epilog.ph5333, !prof !294

vec.epilog.ph5333:                                ; preds = %vector.main.loop.iter.check5316, %vec.epilog.iter.check5331
end_hunk_3
...
bb.pb:                                            ; preds = %bb.oz, %bb.pa
  %.sink4458 = phi i32 [ %i.eel, %bb.pa ], [ %i.edo, %bb.oz ]
  %.sink4454 = phi i32 [ %i.eem, %bb.pa ], [ %i.edp, %bb.oz ] ; 2 uses
  %.sink4445 = phi i64 [ 16, %bb.pa ], [ 12, %bb.oz ]
  %i.eex = zext nneg i32 %.sink4458 to i64
  ...
  %i.efb = zext i32 %.sink4454 to i64
...
_ZN13duckdb_yyjsonL27write_u64_len_15_to_17_trimEPhm.exit.i54: ; preds = %bb.pe, %bb.pd, %bb.pb
  %.sink4460.a = phi i64 [ %i.egq, %bb.pe ], [ %i.egf, %bb.pd ], [ %i.efh, %bb.pb ]
  %i.egr = and i64 %.sink4460.a, 4294967295
...
bb.pi:                                            ; preds = %bb.pg, %bb.ph
  %.sink4474.a = phi i32 [ %i.ejl, %bb.ph ], [ %i.eio, %bb.pg ]
  %.sink4470 = phi i32 [ %i.ejm, %bb.ph ], [ %i.eip, %bb.pg ] ; 2 uses
  %.sink4461 = phi i64 [ 16, %bb.ph ], [ 12, %bb.pg ]
  %i.ejx = zext nneg i32 %.sink4474.a to i64
  ...
  %i.ekb = zext i32 %.sink4470 to i64
  ...
  %.not107.i717.i = icmp eq i32 %.sink4470, 0
  %i.ekf = add nuw nsw i64 %i.eka, 2
  %i.ekg = select i1 %.not107.i717.i, i64 %i.ekf, i64 %i.eke
  %i.ekh = sub nsw i64 %.sink4461, %i.ekg
  br label %iter.check5208
...
iter.check5208:                                   ; preds = %bb.pi, %bb.pk, %bb.pl
  %.sink4475.a = phi i64 [ %i.ekh, %bb.pi ], [ %i.elf, %bb.pk ], [ %i.elq, %bb.pl ]
  %.pn.i714.i = and i64 %.sink4475.a, 4294967295
  %.0.i715.i = getelementptr inbounds nuw i8, ptr %i.ehz, i64 %.pn.i714.i ; 2 uses
  %wide.trip.count = zext nneg i32 %i.ebr to i64  ; 6 uses
  %min.iters.check5194 = icmp ult i32 %i.ebr, 4
  br i1 %min.iters.check5194, label %.lr.ph2097.preheader, label %vector.main.loop.iter.check5195

vector.main.loop.iter.check5195:                  ; preds = %iter.check5208
  %min.iters.check5196 = icmp ult i32 %i.ebr, 32
  br i1 %min.iters.check5196, label %vec.epilog.ph5212, label %vector.ph5197

vector.ph5197:                                    ; preds = %vector.main.loop.iter.check5195
  %n.mod.vf5198 = and i64 %wide.trip.count, 28
  %n.vec5199 = and i64 %wide.trip.count, 2147483616 ; 4 uses
  br label %vector.body5200

vector.body5200:                                  ; preds = %vector.body5200, %vector.ph5197
  %index5201 = phi i64 [ 0, %vector.ph5197 ], [ %index.next5204, %vector.body5200 ] ; 3 uses
  %i.elr = getelementptr inbounds nuw i8, ptr %i.dpm, i64 %index5201 ; 2 uses
...
bb.zr:                                            ; preds = %bb.zp, %bb.zq
  %.sink4493 = phi i32 [ %i.hzh, %bb.zq ], [ %i.hyk, %bb.zp ]
  %.sink4489 = phi i32 [ %i.hzi, %bb.zq ], [ %i.hyl, %bb.zp ] ; 2 uses
  %.sink4480 = phi i64 [ 16, %bb.zq ], [ 12, %bb.zp ]
  %i.hzt = zext nneg i32 %.sink4493 to i64
  ...
  %i.hzx = zext i32 %.sink4489 to i64
...
_ZN13duckdb_yyjsonL27write_u64_len_15_to_17_trimEPhm.exit.i228: ; preds = %bb.zu, %bb.zt, %bb.zr
  %.sink4495.a = phi i64 [ %i.ibm, %bb.zu ], [ %i.ibb, %bb.zt ], [ %i.iad, %bb.zr ]
  %i.ibn = and i64 %.sink4495.a, 4294967295
...
bb.zy:                                            ; preds = %bb.zw, %bb.zx
  %.sink4509.a = phi i32 [ %i.ieh, %bb.zx ], [ %i.idk, %bb.zw ]
  %.sink4505 = phi i32 [ %i.iei, %bb.zx ], [ %i.idl, %bb.zw ] ; 2 uses
  %.sink4496 = phi i64 [ 16, %bb.zx ], [ 12, %bb.zw ]
  %i.iet = zext nneg i32 %.sink4509.a to i64
  ...
  %i.iex = zext i32 %.sink4505 to i64
  ...
  %.not107.i577.i = icmp eq i32 %.sink4505, 0
  %i.ifb = add nuw nsw i64 %i.iew, 2
  %i.ifc = select i1 %.not107.i577.i, i64 %i.ifb, i64 %i.ifa
  %i.ifd = sub nsw i64 %.sink4496, %i.ifc
  br label %iter.check5300
...
iter.check5300:                                   ; preds = %bb.zy, %bb.aaa, %bb.aab
  %.sink4510.a = phi i64 [ %i.ifd, %bb.zy ], [ %i.igb, %bb.aaa ], [ %i.igm, %bb.aab ]
  %.pn.i574.i = and i64 %.sink4510.a, 4294967295
  ...
  %min.iters.check5286 = icmp ult i32 %i.hwn, 4
  br i1 %min.iters.check5286, label %.lr.ph2219.preheader, label %vector.main.loop.iter.check5287

vector.main.loop.iter.check5287:                  ; preds = %iter.check5300
  %min.iters.check5288 = icmp ult i32 %i.hwn, 32
  br i1 %min.iters.check5288, label %vec.epilog.ph5304, label %vector.ph5289

vector.ph5289:                                    ; preds = %vector.main.loop.iter.check5287
  %n.mod.vf5290 = and i64 %wide.trip.count2896, 28
  %n.vec5291 = and i64 %wide.trip.count2896, 2147483616 ; 4 uses
  br label %vector.body5292

vector.body5292:                                  ; preds = %vector.body5292, %vector.ph5289
  %index5293 = phi i64 [ 0, %vector.ph5289 ], [ %index.next5296, %vector.body5292 ] ; 3 uses
  %i.ign = getelementptr inbounds nuw i8, ptr %i.hki, i64 %index5293 ; 2 uses
