...
.preheader63:                                     ; preds = %.lr.ph, %middle.block, %bb.n
  %.0.i44.lcssa = phi i64 [ 0, %bb.n ], [ %i.aq, %middle.block ], [ %i.by, %.lr.ph ] ; 10 uses
...
vector.ph136:                                     ; preds = %vector.memcheck128
  %n.vec138 = and i64 %i.cf, 4611686018427387900  ; 3 uses
  %i.ci = shl i64 %n.vec138, 3                    ; 3 uses
...
_ZL11mbedtls_xorPhPKhS1_m.exit47.preheader193:    ; preds = %vector.memcheck128, %_ZL11mbedtls_xorPhPKhS1_m.exit47.preheader88, %middle.block147
  ...
  %.0.i69.ph = phi i64 [ 0, %vector.memcheck128 ], [ 0, %_ZL11mbedtls_xorPhPKhS1_m.exit47.preheader88 ], [ %i.ci, %middle.block147 ]
...
.preheader:                                       ; preds = %_ZL11mbedtls_xorPhPKhS1_m.exit47, %middle.block147, %_ZL11mbedtls_xorPhPKhS1_m.exit47.preheader
  %.0.i.lcssa = phi i64 [ 0, %_ZL11mbedtls_xorPhPKhS1_m.exit47.preheader ], [ %i.ci, %middle.block147 ], [ %i.eq, %_ZL11mbedtls_xorPhPKhS1_m.exit47 ] ; 10 uses
