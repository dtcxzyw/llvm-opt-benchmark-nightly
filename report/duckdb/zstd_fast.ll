...
bb.e:                                             ; preds = %bb.cc, %bb.d
  ...
  %.pn.i = ptrtoint ptr %.1.i.i to i64            ; 5 uses
...
bb.g:                                             ; preds = %bb.f
  %.1.i.i.lcssa23182322 = ptrtoaddr ptr %.1.i.i to i64 ; 2 uses
...
_ZN11duckdb_zstdL13ZSTD_wildcopyEPvPKvlNS_14ZSTD_overlap_eE.exit364.i.i: ; preds = %bb.bu, %.lr.ph.i60.i.prol.loopexit, %.lr.ph.i60.i, %middle.block2033, %vec.epilog.middle.block2050, %_ZN11duckdb_zstdL13ZSTD_wildcopyEPvPKvlNS_14ZSTD_overlap_eE.exit.i57.i, %bb.bs
...
bb.cm:                                            ; preds = %.thread122.i97, %.lr.ph212.i30
  ...
  %invariant.op2485 = sub i32 1, %.0272.i208.i35
  br label %bb.cn
...
bb.cn:                                            ; preds = %bb.fl, %bb.cm
  ...
  %.pn.i49 = ptrtoint ptr %.1.i.i44 to i64        ; 5 uses
  ...
  %.reass.i53.reass.reass.reass = add i32 %.0313.i.i51, %invariant.op2485 ; 4 uses
...
bb.cp:                                            ; preds = %bb.co
  %.1.i.i44.lcssa22842288 = ptrtoaddr ptr %.1.i.i44 to i64 ; 2 uses
...
_ZN11duckdb_zstdL13ZSTD_wildcopyEPvPKvlNS_14ZSTD_overlap_eE.exit364.i.i124: ; preds = %bb.fd, %.lr.ph.i60.i136.prol.loopexit, %.lr.ph.i60.i136, %middle.block1795, %vec.epilog.middle.block1812, %_ZN11duckdb_zstdL13ZSTD_wildcopyEPvPKvlNS_14ZSTD_overlap_eE.exit.i57.i133, %bb.fb
...
bb.fw:                                            ; preds = %bb.iu, %bb.fv
  ...
  %.pn.i324 = ptrtoint ptr %.1.i.i318 to i64      ; 5 uses
...
bb.fy:                                            ; preds = %bb.fx
  %.1.i.i318.lcssa22672271 = ptrtoaddr ptr %.1.i.i318 to i64 ; 2 uses
...
_ZN11duckdb_zstdL13ZSTD_wildcopyEPvPKvlNS_14ZSTD_overlap_eE.exit364.i.i399: ; preds = %bb.im, %.lr.ph.i60.i411.prol.loopexit, %.lr.ph.i60.i411, %middle.block1676, %vec.epilog.middle.block1693, %_ZN11duckdb_zstdL13ZSTD_wildcopyEPvPKvlNS_14ZSTD_overlap_eE.exit.i57.i408, %bb.ik
...
bb.je:                                            ; preds = %.thread122.i647, %.lr.ph212.i579
  ...
  %invariant.op2486 = sub i32 1, %.0272.i208.i584
  br label %bb.jf
...
bb.jf:                                            ; preds = %bb.md, %bb.je
  ...
  %.pn.i599 = ptrtoint ptr %.1.i.i593 to i64      ; 5 uses
  ...
  %.reass.i603.reass.reass.reass = add i32 %.0313.i.i601, %invariant.op2486 ; 4 uses
...
bb.jh:                                            ; preds = %bb.jg
  %.1.i.i593.lcssa23012305 = ptrtoaddr ptr %.1.i.i593 to i64 ; 2 uses
