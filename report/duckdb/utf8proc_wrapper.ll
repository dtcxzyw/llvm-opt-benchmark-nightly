...
define void @_ZN6duckdb8Utf8Proc9MakeValidEPcmc(ptr nofree noundef captures(none) %0, i64 noundef %1, i8 noundef signext %2) local_unnamed_addr #0 align 2 {
bb.a:
...
define noundef zeroext i1 @_ZN6duckdb8Utf8Proc7IsValidEPKcm(ptr nofree noundef readonly captures(none) %0, i64 noundef %1) local_unnamed_addr #4 align 2 {
bb.a:
...
; Function Attrs: mustprogress uwtable
define void @_ZN6duckdb8Utf8Proc13RemoveInvalidB5cxx11EPKcm(ptr dead_on_unwind noalias nonnull writable sret(%"class.std::__cxx11::basic_string") align 8 %0, ptr nofree noundef readonly captures(none) %1, i64 noundef %2) local_unnamed_addr #2 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
...
.preheader:                                       ; preds = %bb.a
  %.not62.a = icmp eq i64 %2, 0
  br i1 %.not62.a, label %._crit_edge, label %.lr.ph61
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i, %bb.d
  %4 = phi i64 [ %3, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i ], [ 15, %bb.d ]
  %i.m = icmp ugt i64 %i.i, %4
  br i1 %i.m, label %bb.e, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9push_backEc.exit
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9push_backEc.exit: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i, %.noexc
  %i.n = phi ptr [ %.pre.i, %.noexc ], [ %i.j, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i ]
  %i.o = getelementptr inbounds nuw i8, ptr %i.n, i64 %i.h
  store i8 %i.e, ptr %i.o, align 1, !tbaa !10
...
bb.h:                                             ; preds = %bb.g
  %i.u = sub i64 %2, %storemerge60
  %i.v = icmp ugt i64 %i.u, 1
  %i.w = zext i1 %i.v to i64
  %spec.select = add nuw i64 %storemerge60, %i.w
...
bb.j:                                             ; preds = %bb.i
  %i.z = sub i64 %2, %storemerge60
  %i.aa = icmp ult i64 %i.z, 3
  br i1 %i.aa, label %_ZN6duckdbL17UTF8ExtraByteLoopILi1ELi1920EEENS_11UnicodeTypeEiiRmPKcmPNS_20UnicodeInvalidReasonEPm.exit, label %.preheader.i37

.preheader.i37:                                   ; preds = %bb.j
  %i.ab = add nuw i64 %storemerge60, 1            ; 2 uses
  %i.ac = getelementptr inbounds nuw i8, ptr %1, i64 %i.ab
  %i.ad = load i8, ptr %i.ac, align 1, !tbaa !10
  %.not.i38 = icmp slt i8 %i.ad, -64
  %i.ae = add i64 %storemerge60, 2
  %spec.select56 = select i1 %.not.i38, i64 %i.ae, i64 %i.ab
  br label %_ZN6duckdbL17UTF8ExtraByteLoopILi1ELi1920EEENS_11UnicodeTypeEiiRmPKcmPNS_20UnicodeInvalidReasonEPm.exit

bb.k:                                             ; preds = %bb.i
  %i.af = and i32 %i.f, 248
  %i.ag = icmp eq i32 %i.af, 240
  br i1 %i.ag, label %bb.l, label %.loopexit

bb.l:                                             ; preds = %bb.k
  %i.ah = sub i64 %2, %storemerge60
  %i.ai = icmp ult i64 %i.ah, 4
  br i1 %i.ai, label %_ZN6duckdbL17UTF8ExtraByteLoopILi1ELi1920EEENS_11UnicodeTypeEiiRmPKcmPNS_20UnicodeInvalidReasonEPm.exit, label %.preheader.i40

.preheader.i40:                                   ; preds = %bb.l
  %i.aj = add nuw i64 %storemerge60, 1            ; 2 uses
  %i.ak = getelementptr inbounds nuw i8, ptr %1, i64 %i.aj
  %i.al = load i8, ptr %i.ak, align 1, !tbaa !10
  %.not.i41 = icmp slt i8 %i.al, -64
...
bb.m:                                             ; preds = %.preheader.i40
  %i.am = add i64 %storemerge60, 2                ; 2 uses
  %i.an = getelementptr inbounds nuw i8, ptr %1, i64 %i.am
  %i.ao = load i8, ptr %i.an, align 1, !tbaa !10
  %.not.1.i44 = icmp slt i8 %i.ao, -64
  %i.ap = add i64 %storemerge60, 3
  %spec.select57 = select i1 %.not.1.i44, i64 %i.ap, i64 %i.am
  br label %_ZN6duckdbL17UTF8ExtraByteLoopILi1ELi1920EEENS_11UnicodeTypeEiiRmPKcmPNS_20UnicodeInvalidReasonEPm.exit
...
_ZN6duckdbL17UTF8ExtraByteLoopILi1ELi1920EEENS_11UnicodeTypeEiiRmPKcmPNS_20UnicodeInvalidReasonEPm.exit: ; preds = %bb.m, %.preheader.i37, %bb.h, %bb.l, %.preheader.i40, %bb.j
  %.053 = phi i64 [ %spec.select56, %.preheader.i37 ], [ %spec.select57, %bb.m ], [ %spec.select, %bb.h ], [ %storemerge60, %bb.l ], [ %i.aj, %.preheader.i40 ], [ %storemerge60, %bb.j ] ; 4 uses
  %sext = shl i64 %storemerge60, 32
  %i.aq = ashr exact i64 %sext, 32                ; 2 uses
  %.not58 = icmp ugt i64 %i.aq, %.053
...
.lr.ph:                                           ; preds = %_ZN6duckdbL17UTF8ExtraByteLoopILi1ELi1920EEENS_11UnicodeTypeEiiRmPKcmPNS_20UnicodeInvalidReasonEPm.exit, %bb.p
  %.059 = phi i64 [ %i.bd, %bb.p ], [ %i.aq, %_ZN6duckdbL17UTF8ExtraByteLoopILi1ELi1920EEENS_11UnicodeTypeEiiRmPKcmPNS_20UnicodeInvalidReasonEPm.exit ] ; 2 uses
  %i.ar = getelementptr inbounds nuw i8, ptr %1, i64 %.059
  %i.as = load i8, ptr %i.ar, align 1, !tbaa !10
  %i.at = load i64, ptr %i.b, align 8, !tbaa !21  ; 4 uses
  %i.au = add i64 %i.at, 1                        ; 3 uses
  %i.av = load ptr, ptr %0, align 8, !tbaa !23    ; 2 uses
  %i.aw = icmp eq ptr %i.av, %i.a
  br i1 %i.aw, label %bb.n, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i45

bb.n:                                             ; preds = %.lr.ph
  %i.ax = icmp ult i64 %i.at, 16
  tail call void @llvm.assume(i1 %i.ax)
  br label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i45

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i45: ; preds = %.lr.ph
  %5 = load i64, ptr %i.a, align 8, !tbaa !10
  br label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i45

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i45: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i45, %bb.n
  %6 = phi i64 [ %5, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i45 ], [ 15, %bb.n ]
  %i.ay = icmp ugt i64 %i.au, %6
  br i1 %i.ay, label %bb.o, label %bb.p

bb.o:                                             ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i45
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_mutateEmmPKcm(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.at, i64 noundef 0, ptr noundef null, i64 noundef 1)
...
bb.p:                                             ; preds = %.noexc47, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i45
  %i.az = phi ptr [ %.pre.i46, %.noexc47 ], [ %i.av, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i45 ]
  %i.ba = getelementptr inbounds nuw i8, ptr %i.az, i64 %i.at
  store i8 %i.as, ptr %i.ba, align 1, !tbaa !10
  store i64 %i.au, ptr %i.b, align 8, !tbaa !21
...
bb.r:                                             ; preds = %bb.f, %bb.q, %bb.b
  %.pn.pn = phi { ptr, i32 } [ %i.c, %bb.b ], [ %i.r, %bb.f ], [ %i.be, %bb.q ]
  %i.bh = load ptr, ptr %0, align 8, !tbaa !23    ; 2 uses
  %i.bi = icmp eq ptr %i.bh, %i.a
  br i1 %i.bi, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.a

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.a: ; preds = %bb.r
  tail call void @_ZdlPv(ptr noundef %i.bh) #13
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %bb.r, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.a
...
; Function Attrs: mustprogress uwtable
define noundef i64 @_ZN6duckdb8Utf8Proc19NextGraphemeClusterEPKcmm(ptr nofree noundef readonly captures(none) %0, i64 noundef %1, i64 noundef %2) local_unnamed_addr #2 align 2 {
bb.a:
...
; Function Attrs: mustprogress uwtable
define noundef range(i32 -532608, 2363456) i32 @_ZN6duckdb8Utf8Proc15UTF8ToCodepointEPKcRi(ptr nofree noundef readonly captures(none) %0, ptr nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) %1) local_unnamed_addr #2 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
...
bb.l:                                             ; preds = %bb.j
  %i.ad = and i8 %i.a, -8
  %or.cond8 = icmp eq i8 %i.ad, -16
  br i1 %or.cond8, label %bb.m, label %bb.n

bb.m:                                             ; preds = %bb.l
  %i.ae = getelementptr inbounds nuw i8, ptr %0, i64 3
  %i.af = load i8, ptr %i.ae, align 1, !tbaa !10
  store i32 4, ptr %1, align 4, !tbaa !3
  %i.ag = shl nuw nsw i32 %i.b, 18
  %i.ah = zext i8 %i.e to i32
  %i.ai = shl nuw nsw i32 %i.ah, 12
  %i.aj = zext i8 %i.u to i32
  %i.ak = shl nuw nsw i32 %i.aj, 6
  %i.al = zext i8 %i.af to i32
  %i.am = add nsw i32 %i.ag, -63447168
  %i.an = add nsw i32 %i.am, %i.ai
end_hunk_0
