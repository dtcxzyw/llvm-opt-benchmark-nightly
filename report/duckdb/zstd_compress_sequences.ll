...
bb.t:                                             ; preds = %bb.t, %_ZN11duckdb_zstdL15ZSTD_NCountCostEPKjjmj.exit
  %indvars.iv.i69 = phi i64 [ 0, %_ZN11duckdb_zstdL15ZSTD_NCountCostEPKjjmj.exit ], [ %indvars.iv.next.i70, %bb.t ] ; 2 uses
  %.016.i = phi i32 [ 0, %_ZN11duckdb_zstdL15ZSTD_NCountCostEPKjjmj.exit ], [ %i.dg, %bb.t ]
  %i.cv = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %indvars.iv.i69
  %i.cw = load i32, ptr %i.cv, align 4, !tbaa !9  ; 3 uses
  %i.cx = shl i32 %i.cw, 8
  ...
  br i1 %exitcond.i71, label %_ZN11duckdb_zstdL16ZSTD_entropyCostEPKjjm.exit, label %bb.t, !llvm.loop !22

_ZN11duckdb_zstdL16ZSTD_entropyCostEPKjjm.exit:   ; preds = %bb.t
  %i.dh = shl i64 %.1.i, 3
