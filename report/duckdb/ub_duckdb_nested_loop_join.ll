...
_ZN6duckdb6vectorINS_6VectorELb1ESaIS1_EE3getILb1EEERS1_m.exit: ; preds = %bb.a
  ...
  %i.p = getelementptr inbounds nuw [104 x i8], ptr %i.e, i64 %1 ; 2 uses
...
_ZNK6duckdb6vectorINS_13JoinConditionELb1ESaIS1_EE3getILb1EEERKS1_m.exit: ; preds = %bb.a
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b)
  %i.p = getelementptr inbounds nuw [24 x i8], ptr %i.e, i64 %1 ; 2 uses
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %i.p) ]
  ret ptr %i.p
}
...
bb.l:                                             ; preds = %.lr.ph
  ...
  %i.as = getelementptr inbounds nuw [104 x i8], ptr %i.ad, i64 %.068 ; 11 uses
...
bb.q:                                             ; preds = %bb.l
  ...
  %i.bj = getelementptr inbounds nuw [104 x i8], ptr %i.au, i64 %.068 ; 16 uses
  ...
  %i.bm = getelementptr inbounds nuw [24 x i8], ptr %i.ab, i64 %.068 ; 2 uses
