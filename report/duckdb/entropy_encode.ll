...
begin_hunk_0_@_ZN13duckdb_brotli31BrotliConvertBitDepthsToSymbolsEPKhmPt:bb.a
...
.lr.ph.i:                                         ; preds = %.lr.ph.i, %.lr.ph.i.preheader.new
  ...
  br i1 %niter83.ncmp.1.not, label %_ZL17BrotliReverseBitsmt.exit.loopexit.unr-lcssa.a, label %.lr.ph.i, !llvm.loop !50

_ZL17BrotliReverseBitsmt.exit.loopexit.unr-lcssa.a: ; preds = %.lr.ph.i
  %4 = and i64 %i.db, 4
  %lcmp.mod79.not.not = icmp eq i64 %4, 0
  br i1 %lcmp.mod79.not.not, label %.lr.ph.i.epil.preheader, label %_ZL17BrotliReverseBitsmt.exit

.lr.ph.i.epil.preheader:                          ; preds = %_ZL17BrotliReverseBitsmt.exit.loopexit.unr-lcssa.a, %.lr.ph.i.preheader
  %.01115.i.epil.init.a = phi i64 [ %i.cz, %.lr.ph.i.preheader ], [ %i.dr, %_ZL17BrotliReverseBitsmt.exit.loopexit.unr-lcssa.a ]
  %.01214.i.epil.init.a = phi i16 [ %i.cu, %.lr.ph.i.preheader ], [ %i.dm, %_ZL17BrotliReverseBitsmt.exit.loopexit.unr-lcssa.a ]
  ...
  br label %_ZL17BrotliReverseBitsmt.exit

_ZL17BrotliReverseBitsmt.exit:                    ; preds = %.lr.ph.i.epil.preheader, %_ZL17BrotliReverseBitsmt.exit.loopexit.unr-lcssa.a, %bb.b
  %.011.lcssa.i = phi i64 [ %i.cz, %bb.b ], [ %i.dr, %_ZL17BrotliReverseBitsmt.exit.loopexit.unr-lcssa.a ], [ %i.dy, %.lr.ph.i.epil.preheader ]
