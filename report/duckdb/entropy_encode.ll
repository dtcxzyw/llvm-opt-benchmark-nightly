Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/duckdb/original/entropy_encode?download=true
inline.NumInlined: 9
inline.NumDeleted: 5
...
.lr.ph.preheader:                                 ; preds = %bb.a
  ...
  br i1 %min.iters.check, label %.lr.ph.preheader254, label %vector.ph
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %._crit_edge, label %.lr.ph.preheader254

.lr.ph.preheader254:                              ; preds = %.lr.ph.preheader, %middle.block
  %.0136185.ph = phi i64 [ 0, %.lr.ph.preheader ], [ %n.vec, %middle.block ]
  %.0147184.ph = phi i64 [ 0, %.lr.ph.preheader ], [ %i.j, %middle.block ]
  br label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.preheader254, %.lr.ph
  %.0136185 = phi i64 [ %i.n, %.lr.ph ], [ %.0136185.ph, %.lr.ph.preheader254 ] ; 2 uses
  %.0147184 = phi i64 [ %spec.select, %.lr.ph ], [ %.0147184.ph, %.lr.ph.preheader254 ]
...
.critedge.epil.preheader:                         ; preds = %.unr-lcssa, %.critedge.preheader
  ...
  %lcmp.mod260 = trunc i64 %.0149187 to i1
...
bb.d:                                             ; preds = %bb.c
  ...
  %or.cond234 = and i1 %or.cond170, %i.ak
  br i1 %or.cond234, label %.lr.ph193.preheader, label %.loopexit180

.lr.ph193.preheader:                              ; preds = %bb.d
  %i.al = add i64 %0, -2
  %i.am = sub i64 %i.al, %indvar                  ; 3 uses
  %i.an = add i64 %0, -3
  %xtraiter261 = and i64 %i.am, 1
