...
vector.body70:                                    ; preds = %vector.body70, %vector.ph67
  ...
  %4 = load <3 x i64>, ptr %i.v, align 8, !alias.scope !453, !noalias !456
  %strided.vec73 = shufflevector <3 x i64> %4, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
  %5 = load <3 x i64>, ptr %i.x, align 8, !alias.scope !453, !noalias !456
  %strided.vec75 = shufflevector <3 x i64> %5, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
...
vector.body56:                                    ; preds = %vector.body56, %vector.ph53
  ...
  %6 = load <3 x i64>, ptr %i.bu, align 8, !alias.scope !453, !noalias !456
  %strided.vec59 = shufflevector <3 x i64> %6, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
  %7 = load <3 x i64>, ptr %i.bw, align 8, !alias.scope !453, !noalias !456
  %strided.vec61 = shufflevector <3 x i64> %7, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %8 = load <3 x i64>, ptr %i.cr, align 8, !alias.scope !453, !noalias !456
  %strided.vec = shufflevector <3 x i64> %8, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
  %9 = load <3 x i64>, ptr %i.ct, align 8, !alias.scope !453, !noalias !456
  %strided.vec50 = shufflevector <3 x i64> %9, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
...
vector.body84:                                    ; preds = %vector.body84, %vector.ph81
  ...
  %10 = load <3 x i64>, ptr %i.fk, align 8, !alias.scope !468, !noalias !477
  %strided.vec87 = shufflevector <3 x i64> %10, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
  %11 = load <3 x i64>, ptr %i.fm, align 8, !alias.scope !468, !noalias !477
  %strided.vec89 = shufflevector <3 x i64> %11, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
...
vector.body70:                                    ; preds = %vector.body70, %vector.ph67
  ...
  %4 = load <3 x i64>, ptr %i.w, align 8, !alias.scope !485, !noalias !488
  %strided.vec73 = shufflevector <3 x i64> %4, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
  %5 = load <3 x i64>, ptr %i.y, align 8, !alias.scope !485, !noalias !488
  %strided.vec75 = shufflevector <3 x i64> %5, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
...
vector.body56:                                    ; preds = %vector.body56, %vector.ph53
  ...
  %6 = load <3 x i64>, ptr %i.bx, align 8, !alias.scope !485, !noalias !488
  %strided.vec59 = shufflevector <3 x i64> %6, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
  %7 = load <3 x i64>, ptr %i.bz, align 8, !alias.scope !485, !noalias !488
  %strided.vec61 = shufflevector <3 x i64> %7, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %8 = load <3 x i64>, ptr %i.cx, align 8, !alias.scope !485, !noalias !488
  %strided.vec = shufflevector <3 x i64> %8, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
  %9 = load <3 x i64>, ptr %i.cz, align 8, !alias.scope !485, !noalias !488
  %strided.vec50 = shufflevector <3 x i64> %9, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
...
vector.body84:                                    ; preds = %vector.body84, %vector.ph81
  ...
  %10 = load <3 x i64>, ptr %i.fy, align 8, !alias.scope !500, !noalias !509
  %strided.vec87 = shufflevector <3 x i64> %10, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
  %11 = load <3 x i64>, ptr %i.ga, align 8, !alias.scope !500, !noalias !509
  %strided.vec89 = shufflevector <3 x i64> %11, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
...
vector.body73:                                    ; preds = %vector.body73, %vector.ph70
  ...
  %4 = load <3 x i64>, ptr %i.w, align 8, !tbaa !69, !alias.scope !2223, !noalias !2226
  %strided.vec76 = shufflevector <3 x i64> %4, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
  %5 = load <3 x i64>, ptr %i.x, align 8, !tbaa !69, !alias.scope !2223, !noalias !2226
  %strided.vec78 = shufflevector <3 x i64> %5, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
...
vector.body59:                                    ; preds = %vector.body59, %vector.ph56
  ...
  %6 = load <3 x i64>, ptr %i.bu, align 8, !tbaa !69, !alias.scope !2223, !noalias !2226
  %strided.vec62 = shufflevector <3 x i64> %6, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
  %7 = load <3 x i64>, ptr %i.bv, align 8, !tbaa !69, !alias.scope !2223, !noalias !2226
  %strided.vec64 = shufflevector <3 x i64> %7, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %8 = load <3 x i64>, ptr %i.cp, align 8, !tbaa !69, !alias.scope !2223, !noalias !2226
  %strided.vec = shufflevector <3 x i64> %8, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
  %9 = load <3 x i64>, ptr %i.cq, align 8, !tbaa !69, !alias.scope !2223, !noalias !2226
  %strided.vec53 = shufflevector <3 x i64> %9, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
...
vector.body87:                                    ; preds = %vector.body87, %vector.ph84
  ...
  %10 = load <3 x i64>, ptr %i.fb, align 8, !tbaa !69, !alias.scope !2238, !noalias !2247
  %strided.vec90 = shufflevector <3 x i64> %10, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
  %11 = load <3 x i64>, ptr %i.fc, align 8, !tbaa !69, !alias.scope !2238, !noalias !2247
  %strided.vec92 = shufflevector <3 x i64> %11, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
...
vector.body175:                                   ; preds = %vector.body175, %vector.ph172
  ...
  %30 = load <3 x i64>, ptr %i.cd, align 8, !tbaa !69, !alias.scope !2283, !noalias !2291
  %strided.vec178 = shufflevector <3 x i64> %30, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
  %31 = load <3 x i64>, ptr %i.ce, align 8, !tbaa !69, !alias.scope !2283, !noalias !2291
  %strided.vec180 = shufflevector <3 x i64> %31, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %32 = load <3 x i64>, ptr %i.cx, align 8, !tbaa !69, !alias.scope !2283, !noalias !2291
  %strided.vec = shufflevector <3 x i64> %32, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
  %33 = load <3 x i64>, ptr %i.cy, align 8, !tbaa !69, !alias.scope !2283, !noalias !2291
  %strided.vec169 = shufflevector <3 x i64> %33, <3 x i64> poison, <2 x i32> <i32 0, i32 2>
