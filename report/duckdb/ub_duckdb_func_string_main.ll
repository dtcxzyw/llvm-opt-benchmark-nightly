...
begin_hunk_0_@_ZN6duckdb21RegexpReplaceBindDataC2Ev:bb.a
  ...
  store i8 0, ptr %i.l, align 1, !tbaa !1103
  ret void
}
...
bb.a:
  ...
  br i1 %.not.i.i, label %_ZN6duckdb6vectorINS_11LogicalTypeELb1ESaIS1_EE3getILb1EEERS1_m.exit, label %bb.b, !prof !308
...
bb.a:
  store ptr getelementptr inbounds nuw inrange(-16, 40) (i8, ptr @_ZTVN6duckdb12_GLOBAL__N_118ConcatFunctionDataE, i64 16), ptr %0, align 8, !tbaa !80
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8
  tail call void @_ZN6duckdb11LogicalTypeD1Ev(ptr noundef nonnull align 8 dead_on_return(24) dereferenceable(24) %i.a) #28, !inline_history !2185
  tail call void @_ZN6duckdb12FunctionDataD2Ev(ptr noundef nonnull align 8 dead_on_return(8) dereferenceable(33) %0) #28, !inline_history !2185
...
bb.a:
  ...
  %i.c = tail call noalias noundef nonnull dereferenceable(40) ptr @_Znwm(i64 noundef 40) #29, !noalias !2186, !inline_history !2189 ; 6 uses
  store ptr getelementptr inbounds nuw inrange(-16, 40) (i8, ptr @_ZTVN6duckdb12_GLOBAL__N_118ConcatFunctionDataE, i64 16), ptr %i.c, align 8, !tbaa !80, !noalias !2186
  ...
  invoke void @_ZN6duckdb11LogicalTypeC1ERKS0_(ptr noundef nonnull align 8 dereferenceable(24) %i.d, ptr noundef nonnull align 8 dereferenceable(24) %i.a)
          to label %_ZNSt10unique_ptrIN6duckdb12_GLOBAL__N_118ConcatFunctionDataESt14default_deleteIS2_EED2Ev.exit unwind label %.body.i, !noalias !2186, !inline_history !2190

.body.i:                                          ; preds = %bb.a
  %i.e = landingpad { ptr, i32 }
          cleanup
  tail call void @_ZN6duckdb12FunctionDataD2Ev(ptr noundef nonnull align 8 dead_on_return(8) dereferenceable(33) %i.c) #28, !noalias !2186, !inline_history !2190
  tail call void @_ZdlPv(ptr noundef nonnull %i.c) #32, !noalias !2186, !inline_history !2189
  resume { ptr, i32 } %i.e
...
_ZNSt10unique_ptrIN6duckdb12_GLOBAL__N_118ConcatFunctionDataESt14default_deleteIS2_EED2Ev.exit: ; preds = %bb.a
  ...
  store i8 %i.f, ptr %i.g, align 8, !tbaa !186, !noalias !2186
  store ptr %i.c, ptr %0, align 8, !tbaa !333
  ret void
}
...
bb.a:
  ...
  %i.e = load ptr, ptr %0, align 8, !tbaa !322    ; 2 uses
  %i.f = ptrtoint ptr %i.d to i64
  %i.g = ptrtoint ptr %i.e to i64
  %i.h = sub i64 %i.f, %i.g
  ...
  store i64 %i.i, ptr %i.b, align 8, !tbaa !69
  %.not.i.i = icmp ult i64 %1, %i.i
  br i1 %.not.i.i, label %_ZN6duckdb6vectorINS_14BaseStatisticsELb1ESaIS1_EE3getILb1EEERS1_m.exit, label %bb.b, !prof !308
...
bb.a:
  ...
  %i.a = load ptr, ptr %0, align 8, !tbaa !2191   ; 2 uses
...
bb.a:
  %i.a = load ptr, ptr %0, align 8, !tbaa !2191   ; 3 uses
  %.not = icmp eq ptr %i.a, null
