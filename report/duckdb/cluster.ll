...
pred.store.continue:                              ; preds = %vector.body239, %pred.store.if
...
pred.store.continue244:                           ; preds = %pred.store.continue, %pred.store.if243
...
pred.store.continue246:                           ; preds = %pred.store.continue244, %pred.store.if245
...
pred.store.continue248:                           ; preds = %pred.store.continue246, %pred.store.if247
...
pred.store.continue250:                           ; preds = %pred.store.continue248, %pred.store.if249
...
pred.store.continue252:                           ; preds = %pred.store.continue250, %pred.store.if251
