...
begin_hunk_0_@_ZN6duckdb12_GLOBAL__N_111DeserializeERNS_12DeserializerERNS_14ScalarFunctionE:.noexc
  ...
  %i.d = tail call noundef zeroext i1 %i.c(ptr noundef nonnull align 8 dereferenceable(632) %1, i16 noundef zeroext 100, ptr noundef nonnull @.str.8), !inline_history !282
...
.noexc16:                                         ; preds = %.noexc
  ...
  tail call void %i.g(ptr noundef nonnull align 8 dereferenceable(632) %1, i1 noundef zeroext false), !inline_history !282
  br label %_ZNSt10unique_ptrIN6duckdb15NextvalBindDataESt14default_deleteIS1_EED2Ev.exit.thread

.noexc17:                                         ; preds = %.noexc
  tail call void @llvm.experimental.noalias.scope.decl(metadata !283)
  store ptr null, ptr %5, align 8, !tbaa !286, !alias.scope !288
  %i.h = load ptr, ptr %1, align 8, !tbaa !121, !noalias !288
  %i.i = getelementptr inbounds nuw i8, ptr %i.h, i64 88
  %i.j = load ptr, ptr %i.i, align 8, !noalias !288
  %i.k = tail call noundef zeroext i1 %i.j(ptr noundef nonnull align 8 dereferenceable(632) %1), !inline_history !282
...
_ZN6duckdb10unique_ptrINS_10CreateInfoESt14default_deleteIS1_ELb1EEaSEOS4_.exit.i.i: ; preds = %.noexc17
  %i.l = load ptr, ptr %1, align 8, !tbaa !121, !noalias !288
  %i.m = getelementptr inbounds nuw i8, ptr %i.l, i64 56
  %i.n = load ptr, ptr %i.m, align 8, !noalias !288
  tail call void %i.n(ptr noundef nonnull align 8 dereferenceable(632) %1), !inline_history !282
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #17, !noalias !288
  ...
  %i.o = load ptr, ptr %4, align 8, !tbaa !275, !noalias !288 ; 3 uses
  store ptr %i.o, ptr %5, align 8, !tbaa !275, !alias.scope !288
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #17, !noalias !288
  %i.p = load ptr, ptr %1, align 8, !tbaa !121, !noalias !288
  %i.q = getelementptr inbounds nuw i8, ptr %i.p, i64 64
  %i.r = load ptr, ptr %i.q, align 8, !noalias !288
  invoke void %i.r(ptr noundef nonnull align 8 dereferenceable(632) %1)
          to label %bb.a unwind label %bb.b, !noalias !288
...
bb.a:                                             ; preds = %_ZN6duckdb10unique_ptrINS_10CreateInfoESt14default_deleteIS1_ELb1EEaSEOS4_.exit.i.i, %.noexc17
  ...
  %i.s = load ptr, ptr %1, align 8, !tbaa !121, !noalias !288
  %i.t = getelementptr inbounds nuw i8, ptr %i.s, i64 96
  %i.u = load ptr, ptr %i.t, align 8, !noalias !288
  invoke void %i.u(ptr noundef nonnull align 8 dereferenceable(632) %1)
          to label %_ZN6duckdb12Deserializer4ReadINS_10unique_ptrINS_10CreateInfoESt14default_deleteIS3_ELb1EEES3_EENSt9enable_ifIXaasr13is_unique_ptrIT_EE5valuesr15has_deserializeIT0_EE5valueES8_E4typeEv.exit.i unwind label %bb.b, !noalias !288
...
!282 = distinct !{null}
!283 = !{!284}
!284 = distinct !{!284, !285, !"_ZN6duckdb12Deserializer4ReadINS_10unique_ptrINS_10CreateInfoESt14default_deleteIS3_ELb1EEES3_EENSt9enable_ifIXaasr13is_unique_ptrIT_EE5valuesr15has_deserializeIT0_EE5valueES8_E4typeEv: argument 0"}
!285 = distinct !{!285, !"_ZN6duckdb12Deserializer4ReadINS_10unique_ptrINS_10CreateInfoESt14default_deleteIS3_ELb1EEES3_EENSt9enable_ifIXaasr13is_unique_ptrIT_EE5valuesr15has_deserializeIT0_EE5valueES8_E4typeEv"}
!286 = !{!287, !276, i64 0}
!287 = !{!"_ZTSSt10_Head_baseILm0EPN6duckdb10CreateInfoELb0EE", !276, i64 0}
!288 = !{!284, !280}
!289 = !{!290, !117, i64 0}
...
!306 = !{!"_ZTSSt11_Tuple_implILm0EJPN6duckdb10CreateInfoESt14default_deleteIS1_EEE", !287, i64 0}
!307 = !{!308, !331, i64 240}
