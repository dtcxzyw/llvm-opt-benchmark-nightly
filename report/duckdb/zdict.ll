...
vector.body363:                                   ; preds = %_ZN11duckdb_zstdL21ZDICT_totalSampleSizeEPKmj.exit
  ...
  br i1 %min.iters.check368, label %.preheader274.preheader406, label %vector.ph369
...
middle.block375:                                  ; preds = %vector.body372
  ...
  br i1 %cmp.n376, label %.preheader273.preheader, label %.preheader274.preheader406

.preheader274.preheader406:                       ; preds = %vector.body363, %middle.block375
  %indvars.iv297.ph = phi i64 [ 0, %vector.body363 ], [ %n.vec371, %middle.block375 ]
  br label %.preheader274

.preheader274:                                    ; preds = %.preheader274.preheader406, %.preheader274
  %indvars.iv297 = phi i64 [ %indvars.iv.next298, %.preheader274 ], [ %indvars.iv297.ph, %.preheader274.preheader406 ] ; 2 uses
...
.lr.ph4.preheader.i:                              ; preds = %._crit_edge.i
  ...
  %xtraiter410 = and i64 %i.gn, 3                 ; 3 uses
...
.preheader.preheader:                             ; preds = %bb.p, %vector.body380
  ...
  br i1 %min.iters.check385, label %.preheader.preheader402, label %vector.ph386
...
middle.block396:                                  ; preds = %vector.body389
  ...
  br i1 %cmp.n398, label %.loopexit401, label %.preheader.preheader402

.preheader.preheader402:                          ; preds = %.preheader.preheader, %middle.block396
...
.preheader:                                       ; preds = %.preheader.preheader402, %.preheader
  %indvars.iv322 = phi i64 [ %indvars.iv.next323, %.preheader ], [ %indvars.iv322.ph, %.preheader.preheader402 ] ; 2 uses
  %.0176288 = phi i32 [ %i.pn, %.preheader ], [ %.0176288.ph, %.preheader.preheader402 ]
