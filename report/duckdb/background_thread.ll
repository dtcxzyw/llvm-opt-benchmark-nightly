...
begin_hunk_0_@background_thread_entry:bb.a
  ...
  %i.l = tail call i32 @pthread_mutex_trylock(ptr noundef nonnull %i.k) #12
  %.not.i.i = icmp eq i32 %i.l, 0
  br i1 %.not.i.i, label %bb.c, label %atomic_store_b.exit.i.i

atomic_store_b.exit.i.i:                          ; preds = %tsd_fetch_impl.exit
  tail call void @duckdb_je_malloc_mutex_lock_slow(ptr noundef nonnull %i.j) #12
...
begin_hunk_1_@background_thread_entry:bb.a
  ...
  tail call void @duckdb_je_nstime_init(ptr noundef nonnull %i.w, i64 noundef -1) #12
...
background_thread_pause_check.exit.i:             ; preds = %.backedge.i
  ...
  %i.ab = tail call i32 @pthread_mutex_unlock(ptr noundef nonnull %i.k) #12 ; 0 uses
  ...
  %i.ac = tail call i32 @pthread_mutex_unlock(ptr noundef nonnull getelementptr inbounds nuw (i8, ptr @duckdb_je_background_thread_lock, i64 72)) #12 ; 0 uses
  tail call fastcc void @malloc_mutex_lock(ptr noundef %.0.i, ptr noundef nonnull %i.j)
  br label %.backedge.i.backedge

bb.f:                                             ; preds = %.backedge.i
  tail call fastcc void @background_work_sleep_once(ptr noundef %.0.i, ptr noundef nonnull %i.i, i32 noundef %i.b)
  br label %.backedge.i.backedge
...
background_work.exit:                             ; preds = %.backedge.i, %bb.e
  ...
  tail call void @duckdb_je_nstime_init(ptr noundef nonnull %i.w, i64 noundef 0) #12
  %i.ad = getelementptr inbounds nuw i8, ptr %i.i, i64 120
  store atomic i8 0, ptr %i.ad monotonic, align 1
  %i.ae = tail call i32 @pthread_mutex_unlock(ptr noundef nonnull %i.k) #12 ; 0 uses
  ret ptr null
}
...
begin_hunk_5_@background_thread0_work:bb.a
  ...
  br i1 %i.o, label %middle.block, label %vector.body, !llvm.loop !40
...
begin_hunk_7_@background_thread0_work:bb.a
  ...
  br i1 %i.t, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !44
...
begin_hunk_8_@background_thread0_work:bb.a
  ...
  br i1 %i.aa, label %.lr.ph, label %.outer.split.us.lr.ph, !llvm.loop !45
...
begin_hunk_10_@background_thread0_work:bb.a
  ...
  %i.ao = tail call i32 @pthread_mutex_unlock(ptr noundef nonnull %i.an) #12 ; 0 uses
  %i.ap = load ptr, ptr @duckdb_je_background_thread_info, align 8, !tbaa !18
  %i.aq = getelementptr inbounds nuw i8, ptr %i.ap, i64 56
  tail call fastcc void @malloc_mutex_lock(ptr noundef %0, ptr noundef nonnull %i.aq)
...
pre_reentrancy.exit.i:                            ; preds = %bb.c, %.split.us
  ...
  %i.as = tail call fastcc i32 @background_thread_create_signals_masked(ptr noundef nonnull %i.bv, ptr noundef nonnull %i.ar) ; 2 uses
...
bb.f:                                             ; preds = %post_reentrancy.exit.i
  tail call void (ptr, ...) @duckdb_je_malloc_printf(ptr noundef nonnull @.str.4, i32 noundef %i.as) #12
...
check_background_thread_creation.exit:            ; preds = %bb.e, %bb.f
  ...
  tail call fastcc void @malloc_mutex_lock(ptr noundef nonnull %0, ptr noundef nonnull %i.bb)
...
begin_hunk_14_@background_thread0_work:bb.a
  ...
  %i.bq = tail call i32 @pthread_mutex_unlock(ptr noundef nonnull %i.bp) #12 ; 0 uses
  br label %.lr.ph.i.us
...
begin_hunk_15_@background_thread0_work:bb.a
  ...
  %i.cl = tail call i32 @pthread_mutex_unlock(ptr noundef nonnull %i.bw) #12 ; 0 uses
...
check_background_thread_creation.exit.thread38.loopexit.us: ; preds = %bb.l
  ...
  tail call fastcc void @malloc_mutex_lock(ptr noundef %0, ptr noundef nonnull %i.co)
...
bb.f:                                             ; preds = %bb.e, %bb.d
  ...
  %i.ap = load i64, ptr %3, align 8, !tbaa !47
  %i.aq = load i64, ptr %i.v, align 8, !tbaa !49
