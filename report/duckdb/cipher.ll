...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.n = getelementptr i8, ptr %i.c, i64 %index16
  store <4 x i8> %broadcast.splat15, ptr %i.n, align 1, !tbaa !44
  %index.next17 = add nuw i64 %index16, 4         ; 2 uses
  %i.o = icmp eq i64 %index.next17, %n.vec13
  br i1 %i.o, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !49
