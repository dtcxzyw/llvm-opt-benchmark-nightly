...
bb.r:                                             ; preds = %bb.q, %.thread143
  %.0115 = phi ptr [ %i.bn, %bb.q ], [ %1, %.thread143 ] ; 2 uses
...
begin_hunk_1_@mbedtls_cipher_update:bb.a
  ...
  %i.bx = getelementptr inbounds nuw i8, ptr %.0115, i64 %i.bw
...
begin_hunk_2_@mbedtls_cipher_update:bb.a
  ...
  %i.cn = tail call noundef i32 %i.ci(ptr noundef %i.ck, i32 noundef %i.cl, i64 noundef %i.bw, ptr noundef nonnull %i.cm, ptr noundef %.0115, ptr noundef %.0113) ; 2 uses
