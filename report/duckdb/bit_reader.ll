...
define hidden void @_ZN13duckdb_brotli19BrotliInitBitReaderEPNS_15BrotliBitReaderE(ptr noundef writeonly captures(none) initializes((0, 16)) %0) local_unnamed_addr #0 {
bb.a:
...
define hidden noundef range(i32 0, 2) i32 @_ZN13duckdb_brotli21BrotliWarmupBitReaderEPNS_15BrotliBitReaderE(ptr noundef captures(none) %0) local_unnamed_addr #1 {
bb.a:
...
define hidden noundef range(i32 0, 2) i32 @_ZN13duckdb_brotli24BrotliSafeReadBits32SlowEPNS_15BrotliBitReaderEmPm(ptr noundef captures(none) %0, i64 noundef %1, ptr noundef writeonly captures(none) %2) local_unnamed_addr #2 {
bb.a:
...
._crit_edge34:                                    ; preds = %_ZN13duckdb_brotliL14BrotliPullByteEPNS_15BrotliBitReaderE.exit.i, %._crit_edge
  %i.av = phi i64 [ %i.ad, %._crit_edge ], [ %i.ao, %_ZN13duckdb_brotliL14BrotliPullByteEPNS_15BrotliBitReaderE.exit.i ] ; 2 uses
  %.lcssa = phi i64 [ %i.ac, %._crit_edge ], [ %i.ap, %_ZN13duckdb_brotliL14BrotliPullByteEPNS_15BrotliBitReaderE.exit.i ]
  %i.aw = getelementptr inbounds nuw [8 x i8], ptr @_ZN13duckdb_brotli14kBrotliBitMaskE, i64 %i.ae
  %i.ax = load i64, ptr %i.aw, align 8, !tbaa !19
  %i.ay = and i64 %i.ax, %i.av
  %i.az = sub i64 %.lcssa, %i.ae
  store i64 %i.az, ptr %i.b, align 8, !tbaa !7
  %i.ba = lshr i64 %i.av, %i.ae
  store i64 %i.ba, ptr %0, align 8, !tbaa !12
  %i.bb = shl i64 %i.ay, 16
  %i.bc = or disjoint i64 %i.bb, %i.ab
