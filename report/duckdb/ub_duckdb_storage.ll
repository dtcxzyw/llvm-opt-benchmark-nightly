...
bb.e:                                             ; preds = %select.unfold.i, %_ZN17duckdb_moodycamel15ConcurrentQueueIjNS_28ConcurrentQueueDefaultTraitsEE12ProducerBase12dequeue_bulkIN9__gnu_cxx17__normal_iteratorIPjSt6vectorIjSaIjEEEEEEmRT_m.exit.i
  %.1.i = phi i64 [ %i.c, %_ZN17duckdb_moodycamel15ConcurrentQueueIjNS_28ConcurrentQueueDefaultTraitsEE12ProducerBase12dequeue_bulkIN9__gnu_cxx17__normal_iteratorIPjSt6vectorIjSaIjEEEEEEmRT_m.exit.i ], [ %i.t, %select.unfold.i ] ; 5 uses
...
bb.g:                                             ; preds = %bb.f
  %i.af = sub nuw i64 %.1.i, %i.ad                ; 4 uses
  %i.ag = icmp ult i64 %i.ad, 2305843009213693952
  call void @llvm.assume(i1 %i.ag)
  %3 = xor i64 %i.ad, 2305843009213693951
  %4 = icmp ult i64 %3, %i.af
  br i1 %4, label %bb.h, label %_ZNKSt6vectorIjSaIjEE12_M_check_lenEmPKc.exit.i52
...
bb.m:                                             ; preds = %_ZNSt6vectorIjSaIjEE6resizeEm.exit36
  ...
  %5 = xor i64 %i.au, 126
  invoke void @_ZSt16__introsort_loopIN9__gnu_cxx17__normal_iteratorIPjSt6vectorIjSaIjEEEElNS0_5__ops15_Iter_less_iterEEvT_S9_T0_T1_(ptr %.sroa.0.4, ptr %.sroa.21.1, i64 noundef %5)
