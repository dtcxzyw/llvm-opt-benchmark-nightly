...
.lr.ph55:                                         ; preds = %.lr.ph55.preheader, %.lr.ph55
  ...
  %5 = load i64, ptr %i.ag, align 8, !tbaa !70
  %6 = load atomic i64, ptr %4 seq_cst, align 8
  %7 = tail call noundef i64 @llvm.umax.i64(i64 %6, i64 1)
  %8 = insertelement <2 x i64> poison, i64 %5, i64 0
  %9 = insertelement <2 x i64> %8, i64 %7, i64 1
  %10 = uitofp <2 x i64> %9 to <2 x double>
  %11 = load atomic i64, ptr %i.ah seq_cst, align 8
  %12 = uitofp i64 %11 to double
  %13 = fmul double %i.e, %12
  %i.ai = insertelement <2 x double> %i.l, double %13, i64 1
  %i.aj = fdiv <2 x double> %i.ai, %10            ; 2 uses
