...
begin_hunk_0_@_ZNK6duckdb22TemporaryMemoryManager18ComputeReservationERKNS_20TemporaryMemoryStateE:bb.a
  %.not.i.i.i217 = icmp eq ptr %i.mc, null
...
_ZNSt6vectorImSaImEED2Ev.exit218:                 ; preds = %bb.ce, %.body211, %bb.be
  ...
  %i.md = load ptr, ptr %12, align 8, !tbaa !526  ; 2 uses
  %.not.i.i.i219 = icmp eq ptr %i.md, null
...
bb.cg:                                            ; preds = %_ZNSt6vectorImSaImEED2Ev.exit216, %bb.w
  %.3 = phi i64 [ %i.dr, %bb.w ], [ %i.lo, %_ZNSt6vectorImSaImEED2Ev.exit216 ]
  %i.me = load ptr, ptr %10, align 8, !tbaa !1171 ; 2 uses
  %.not.i.i.i221 = icmp eq ptr %i.me, null
...
_ZNSt6vectorIdSaIdEED2Ev.exit:                    ; preds = %bb.cg, %bb.ch
  ...
  %i.mf = load ptr, ptr %9, align 8, !tbaa !526   ; 2 uses
  %.not.i.i.i222 = icmp eq ptr %i.mf, null
...
._crit_edge:                                      ; preds = %.lr.ph, %bb.a
  %.043.lcssa = phi double [ 0.000000e+00, %bb.a ], [ %i.ab, %.lr.ph ]
  %.042.lcssa = phi double [ 1.000000e+00, %bb.a ], [ %i.x, %.lr.ph ] ; 2 uses
  %.0.lcssa = phi double [ 1.000000e+00, %bb.a ], [ %i.y, %.lr.ph ] ; 2 uses
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  %.04249 = phi double [ %i.x, %.lr.ph ], [ 1.000000e+00, %bb.a ]
  %.04348 = phi double [ %i.ab, %.lr.ph ], [ 0.000000e+00, %bb.a ]
  %.04447 = phi i64 [ %i.ac, %.lr.ph ], [ 0, %bb.a ] ; 3 uses
  %i.l = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNK6duckdb6vectorISt17reference_wrapperIKNS_20TemporaryMemoryStateEELb1ESaIS4_EEixEm(ptr noundef nonnull align 8 dereferenceable(24) %0, i64 noundef %.04447)
  %i.m = load ptr, ptr %i.l, align 8, !tbaa !1154 ; 2 uses
  %i.n = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNK6duckdb6vectorImLb1ESaImEEixEm(ptr noundef nonnull align 8 dereferenceable(24) %1, i64 noundef %.04447)
  %i.o = load i64, ptr %i.n, align 8, !tbaa !70
  %i.p = uitofp i64 %i.o to double                ; 2 uses
  %i.q = getelementptr inbounds nuw i8, ptr %i.m, i64 8
  %i.r = load atomic i64, ptr %i.q seq_cst, align 8
  %i.s = tail call noundef i64 @llvm.umax.i64(i64 %i.r, i64 1)
  ...
  %i.x = fmul double %.04249, %i.p                ; 2 uses
  %i.y = fmul double %.050, %i.t                  ; 2 uses
  %i.z = fdiv double %i.p, %i.t
  %i.aa = fsub double 1.000000e+00, %i.z
  %i.ab = tail call double @llvm.fmuladd.f64(double %i.w, double %i.aa, double %.04348) ; 2 uses
  %i.ac = add nuw i64 %.04447, 1                  ; 2 uses
...
; Function Attrs: mustprogress uwtable
define void @_ZN6duckdb5BlockC2ERNS_14BlockAllocatorElRNS_12BlockManagerE(ptr noundef nonnull align 8 dereferenceable(64) %0, ptr noundef nonnull align 1 %1, i64 noundef %2, ptr noundef nonnull align 8 dereferenceable(144) %3) unnamed_addr #0 align 2 {
bb.a:
  tail call void @_ZN6duckdb10FileBufferC2ERNS_14BlockAllocatorENS_14FileBufferTypeERNS_12BlockManagerE(ptr noundef nonnull align 8 dereferenceable(56) %0, ptr noundef nonnull align 1 %1, i8 noundef zeroext 1, ptr noundef nonnull align 8 dereferenceable(144) %3)
  store ptr getelementptr inbounds nuw inrange(-16, 16) (i8, ptr @_ZTVN6duckdb5BlockE, i64 16), ptr %0, align 8, !tbaa !45
end_hunk_0
