begin_hunk_0_@hpa_dalloc_batch:bb.a
  ...
  call void %i.bq(ptr noundef nonnull %4, i1 noundef zeroext true) #8
  %i.br = load i64, ptr %4, align 8
  %i.bs = getelementptr inbounds nuw i8, ptr %.val.i29, i64 20
  store i8 1, ptr %i.bs, align 4, !tbaa !79
...
.sink.split.i.i:                                  ; preds = %bb.j, %hpdata_changing_state_get.exit.thread.i.i
  ...
  store i8 0, ptr %i.bv, align 4, !tbaa !79
...
bb.k:                                             ; preds = %._crit_edge
  ...
  %.val.i.i32 = load i64, ptr %i.by, align 8, !tbaa !80
...
bb.o:                                             ; preds = %hpa_ndirty_max.exit.thread.i.i
  %.val.i10.i.i = load i64, ptr %i.by, align 8, !tbaa !80
...
bb.g:                                             ; preds = %.thread, %malloc_mutex_lock.exit
  ...
  %.val.i = load i64, ptr %i.ab, align 8, !tbaa !80
...
bb.k:                                             ; preds = %hpa_ndirty_max.exit.thread.i
  %.val.i10.i = load i64, ptr %i.ab, align 8, !tbaa !80
...
begin_hunk_8_@hpa_time_until_deferred_work:bb.a
  ...
  %i.bs = load i64, ptr %i.br, align 8, !tbaa !86 ; 2 uses
...
begin_hunk_9_@duckdb_je_hpa_shard_destroy:bb.a
  ...
  %.val = load ptr, ptr %i.d, align 8, !tbaa !88
...
malloc_mutex_lock.exit:                           ; preds = %bb.c, %bb.d
  ...
  %i.o = load i8, ptr %i.n, align 4, !tbaa !89, !range !54, !noundef !71
  %i.p = trunc nuw i8 %i.o to i1
  store i8 %i.a, ptr %i.n, align 4, !tbaa !89
  %.not = xor i1 %i.p, true
  %or.cond = or i1 %2, %.not
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = load i8, ptr %i.c, align 4, !tbaa !89, !range !54, !noundef !71
...
bb.d:                                             ; preds = %.backedge, %bb.c
  ...
  %.val.i = load i64, ptr %i.h, align 8, !tbaa !80
  %.val9.i = load i64, ptr %i.i, align 8, !tbaa !44
  %i.aa = sub i64 %.val.i, %.val9.i
  %i.ab = load i32, ptr %i.j, align 8, !tbaa !81  ; 3 uses
  %i.ac = icmp eq i32 %i.ab, -1
  br i1 %i.ac, label %hpa_ndirty_max.exit.thread.i, label %bb.e

bb.e:                                             ; preds = %bb.d
  %.val.i.i = load i64, ptr %i.k, align 8, !tbaa !82 ; 3 uses
...
bb.h:                                             ; preds = %hpa_ndirty_max.exit.thread.i
  %.val.i10.i = load i64, ptr %i.h, align 8, !tbaa !80
  ...
  %i.aq = load i32, ptr %i.j, align 8, !tbaa !81  ; 3 uses
  %i.ar = icmp eq i32 %i.aq, -1
  br i1 %i.ar, label %hpa_ndirty_max.exit.i.i, label %bb.i

bb.i:                                             ; preds = %bb.h
  %.val.i.i.i = load i64, ptr %i.k, align 8, !tbaa !82 ; 3 uses
...
bb.l:                                             ; preds = %hpa_should_purge.exit
  %i.bc = load i8, ptr %i.n, align 8, !tbaa !90, !range !54, !noundef !71
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.bh = call i64 %i.bg(ptr noundef nonnull %i.o) #8
  %i.bi = load i64, ptr %i.p, align 8, !tbaa !86
...
begin_hunk_15_@hpa_shard_maybe_do_deferred_work:bb.a
  ...
  store i8 0, ptr %i.bm, align 4, !tbaa !79
  %i.bn = getelementptr inbounds nuw i8, ptr %i.bj, i64 17 ; 2 uses
  store i8 0, ptr %i.bn, align 1, !tbaa !91
...
bb.p:                                             ; preds = %bb.o
  ...
  %.val58.i = load ptr, ptr %i.bj, align 8, !tbaa !88
  call void %i.bw(ptr noundef %.val58.i, i64 noundef 2097152) #8
  br label %bb.q
...
begin_hunk_17_@hpa_shard_maybe_do_deferred_work:bb.a
  ...
  %i.cc = load ptr, ptr %i.cb, align 8, !tbaa !93
  %i.cd = load ptr, ptr %i.a, align 8, !tbaa !16
  call void %i.cc(ptr noundef %i.cd, i64 noundef %i.by) #8
...
begin_hunk_18_@hpa_shard_maybe_do_deferred_work:bb.a
  ...
  %i.co = load i64, ptr %i.v, align 8, !tbaa !94
  %i.cp = add i64 %i.co, %.0.lcssa.i
  store i64 %i.cp, ptr %i.v, align 8, !tbaa !94
  ...
  call void %i.cs(ptr noundef nonnull %i.o, i1 noundef zeroext false) #8
  br i1 %i.bp, label %bb.u, label %.critedge.i

bb.u:                                             ; preds = %malloc_mutex_lock.exit.i
  %i.ct = load i64, ptr %i.w, align 8, !tbaa !95
  %i.cu = add i64 %i.ct, 1
  store i64 %i.cu, ptr %i.w, align 8, !tbaa !95
...
hpdata_changing_state_get.exit.i.i:               ; preds = %.critedge.i, %bb.u
  ...
  store i8 1, ptr %i.bn, align 1, !tbaa !91
...
begin_hunk_20_@hpa_shard_maybe_do_deferred_work:bb.a
  ...
  call void %i.dg(ptr noundef nonnull %5, i1 noundef zeroext true) #8
  %i.dh = load i64, ptr %5, align 8
  store i8 1, ptr %i.bm, align 4, !tbaa !79
...
bb.aa:                                            ; preds = %hpa_should_purge.exit.thread
  %.val.i.i29 = load i64, ptr %i.h, align 8, !tbaa !80
  ...
  %i.dq = load i32, ptr %i.j, align 8, !tbaa !81  ; 3 uses
  %i.dr = icmp eq i32 %i.dq, -1
  br i1 %i.dr, label %hpa_hugify_blocked_by_ndirty.exit.thread.i, label %bb.ab

bb.ab:                                            ; preds = %bb.aa
  %.val.i.i.i33 = load i64, ptr %i.k, align 8, !tbaa !82 ; 3 uses
...
begin_hunk_23_@hpa_shard_maybe_do_deferred_work:bb.a
  ...
  %i.eg = call i64 %i.ef(ptr noundef nonnull %4) #8
  %i.eh = load i64, ptr %i.y, align 8, !tbaa !84
...
begin_hunk_24_@hpa_shard_maybe_do_deferred_work:bb.a
  ...
  store i8 0, ptr %i.ek, align 4, !tbaa !79
  ...
  %i.eo = load ptr, ptr %i.en, align 8, !tbaa !96
  %.val34.i = load ptr, ptr %i.ea, align 8, !tbaa !88
  call void %i.eo(ptr noundef %.val34.i, i64 noundef 2097152) #8
...
malloc_mutex_lock.exit.i39:                       ; preds = %bb.ai, %bb.ah
  %i.ev = load i64, ptr %i.z, align 8, !tbaa !97
  %i.ew = add i64 %i.ev, 1
  store i64 %i.ew, ptr %i.z, align 8, !tbaa !97
...
begin_hunk_26_@hpa_shard_maybe_do_deferred_work:bb.a
  ...
  call void %i.fj(ptr noundef nonnull %3, i1 noundef zeroext true) #8
  %i.fk = load i64, ptr %3, align 8
  store i8 1, ptr %i.ek, align 4, !tbaa !79
...
begin_hunk_28_@hpa_try_alloc_batch_no_grow:bb.a
  ...
  store i64 %i.z, ptr %i.ab, align 8, !tbaa !98
  br label %bb.k
...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  %.val47.i = load i64, ptr %i.ae, align 8, !tbaa !98
...
begin_hunk_29_@hpa_try_alloc_batch_no_grow:bb.a
  ...
  store i64 %.val47.i, ptr %i.am, align 8, !tbaa !99
...
begin_hunk_30_@hpa_try_alloc_batch_no_grow:bb.a
  ...
  call void %i.bn(ptr noundef nonnull %7, i1 noundef zeroext true) #8
  %i.bo = load i64, ptr %7, align 8
  %i.bp = getelementptr inbounds nuw i8, ptr %i.v, i64 20
  store i8 1, ptr %i.bp, align 4, !tbaa !79
...
.sink.split.i.i:                                  ; preds = %bb.q, %hpdata_changing_state_get.exit.thread.i.i
  ...
  store i8 0, ptr %i.bs, align 4, !tbaa !79
  br label %bb.r
...
bb.u:                                             ; preds = %.loopexit
  ...
  %.val.i.i24 = load i64, ptr %i.co, align 8, !tbaa !80
  ...
  %i.cs = load i32, ptr %i.cr, align 8, !tbaa !81 ; 3 uses
  %i.ct = icmp eq i32 %i.cs, -1
  br i1 %i.ct, label %hpa_ndirty_max.exit.thread.i.i, label %bb.v

bb.v:                                             ; preds = %bb.u
  %i.cu = getelementptr i8, ptr %1, i64 1360
  %.val.i.i.i = load i64, ptr %i.cu, align 8, !tbaa !82 ; 3 uses
...
bb.y:                                             ; preds = %hpa_ndirty_max.exit.thread.i.i
  %.val.i10.i.i = load i64, ptr %i.co, align 8, !tbaa !80
