Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/duckdb/original/mimics_pcre?download=true
...
.thread78:                                        ; preds = %.thread78.backedge, %_ZNSt5stackIN10duckdb_re29WalkStateIbEESt5dequeIS2_SaIS2_EEE4pushEOS2_.exit
...
_ZNSt5stackIN10duckdb_re29WalkStateIbEESt5dequeIS2_SaIS2_EEE3topEv.exit: ; preds = %.thread78, %bb.g
  %i.as = phi ptr [ %i.ar, %bb.g ], [ %i.al, %.thread78 ] ; 12 uses
...
bb.t:                                             ; preds = %bb.r, %bb.q
  ...
  %.not.i.i.i73 = icmp eq ptr %i.di, %i.dk
...
bb.u:                                             ; preds = %bb.t
  ...
  br label %_ZNSt5stackIN10duckdb_re29WalkStateIbEESt5dequeIS2_SaIS2_EEE4pushEOS2_.exit74
...
_ZNSt5stackIN10duckdb_re29WalkStateIbEESt5dequeIS2_SaIS2_EEE4pushEOS2_.exit74: ; preds = %bb.u, %bb.v
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #15
  br label %.thread78.backedge

.thread78.backedge:                               ; preds = %_ZNSt5stackIN10duckdb_re29WalkStateIbEESt5dequeIS2_SaIS2_EEE4pushEOS2_.exit74, %bb.s, %bb.ae
  br label %.thread78, !llvm.loop !84
...
bb.w:                                             ; preds = %bb.p, %bb.o
  ...
  %i.dy = call noundef zeroext i1 %i.dx(ptr noundef nonnull align 8 dereferenceable(96) %0, ptr noundef nonnull %i.au, i1 noundef zeroext %i.dp, i1 noundef zeroext %i.ds, ptr noundef %i.du, i32 noundef %.pre) ; 3 uses
...
bb.z:                                             ; preds = %bb.n, %bb.w, %bb.y, %bb.x, %bb.i
  %.161 = phi i1 [ %i.bg, %bb.i ], [ %i.dy, %bb.x ], [ %i.dy, %bb.y ], [ %i.dy, %bb.w ], [ %i.bn, %bb.n ] ; 4 uses
...
_ZNSt5stackIN10duckdb_re29WalkStateIbEESt5dequeIS2_SaIS2_EEE3popEv.exit: ; preds = %bb.z
  ...
  br i1 %i.eh, label %.thread80, label %bb.aa
...
_ZNSt5stackIN10duckdb_re29WalkStateIbEESt5dequeIS2_SaIS2_EEE3popEv.exit.thread: ; preds = %bb.z
  ...
  br i1 %i.eo, label %.thread80, label %_ZNSt5stackIN10duckdb_re29WalkStateIbEESt5dequeIS2_SaIS2_EEE3topEv.exit75

bb.aa:                                            ; preds = %_ZNSt5stackIN10duckdb_re29WalkStateIbEESt5dequeIS2_SaIS2_EEE3popEv.exit
  %i.ep = icmp eq ptr %i.ef, %i.ee
  br i1 %i.ep, label %bb.ab, label %_ZNSt5stackIN10duckdb_re29WalkStateIbEESt5dequeIS2_SaIS2_EEE3topEv.exit75
...
bb.ab:                                            ; preds = %bb.aa
  ...
  br label %_ZNSt5stackIN10duckdb_re29WalkStateIbEESt5dequeIS2_SaIS2_EEE3topEv.exit75

_ZNSt5stackIN10duckdb_re29WalkStateIbEESt5dequeIS2_SaIS2_EEE3topEv.exit75: ; preds = %_ZNSt5stackIN10duckdb_re29WalkStateIbEESt5dequeIS2_SaIS2_EEE3popEv.exit.thread, %bb.aa, %bb.ab
  ...
  %.not72 = icmp eq ptr %i.ew, null
  br i1 %.not72, label %bb.ad, label %bb.ac

bb.ac:                                            ; preds = %_ZNSt5stackIN10duckdb_re29WalkStateIbEESt5dequeIS2_SaIS2_EEE3topEv.exit75
  ...
  %7 = zext i1 %.161 to i8
  store i8 %7, ptr %i.fa, align 1, !tbaa !9
  br label %bb.ae

bb.ad:                                            ; preds = %_ZNSt5stackIN10duckdb_re29WalkStateIbEESt5dequeIS2_SaIS2_EEE3topEv.exit75
  %i.fb = getelementptr inbounds i8, ptr %i.eu, i64 -10
  %8 = zext i1 %.161 to i8
  store i8 %8, ptr %i.fb, align 2, !tbaa !88
  %.phi.trans.insert = getelementptr inbounds i8, ptr %i.eu, i64 -16
  %.pre83 = load i32, ptr %.phi.trans.insert, align 8, !tbaa !75
  br label %bb.ae

bb.ae:                                            ; preds = %bb.ad, %bb.ac
  %i.fc = phi i32 [ %.pre83, %bb.ad ], [ %i.ey, %bb.ac ]
  %i.fd = getelementptr inbounds i8, ptr %i.eu, i64 -16
  %i.fe = add nsw i32 %i.fc, 1
  store i32 %i.fe, ptr %i.fd, align 8, !tbaa !75
  br label %.thread78.backedge

.thread80:                                        ; preds = %_ZNSt5stackIN10duckdb_re29WalkStateIbEESt5dequeIS2_SaIS2_EEE3popEv.exit, %_ZNSt5stackIN10duckdb_re29WalkStateIbEESt5dequeIS2_SaIS2_EEE3popEv.exit.thread, %_ZN10LogMessageD2Ev.exit
...
bb.a:
  ...
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !39   ; 6 uses
...
_ZNSt11_Deque_baseIN10duckdb_re29WalkStateIbEESaIS2_EE15_M_allocate_mapEm.exit: ; preds = %bb.k
  ...
  %i.aw = load ptr, ptr %i.c, align 8, !tbaa !39  ; 3 uses
  ...
  br i1 %i.bc, label %bb.m, label %bb.n, !prof !89
