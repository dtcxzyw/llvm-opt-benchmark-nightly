...
begin_hunk_2_@_ZN10duckdb_re26Regexp6WalkerIbE12WalkInternalEPS0_bb:bb.a
  ...
  %i.dv = call noundef zeroext i1 %i.du(ptr noundef nonnull align 8 dereferenceable(96) %0, ptr noundef nonnull %i.au, i1 noundef zeroext %i.dm, i1 noundef zeroext %i.dp, ptr noundef %i.dr, i32 noundef %.pre87)
  %8 = zext i1 %i.dv to i8                        ; 3 uses
...
bb.y:                                             ; preds = %bb.n, %bb.v, %bb.x, %bb.w, %bb.i
  %.3 = phi i8 [ %7, %bb.i ], [ %8, %bb.w ], [ %8, %bb.x ], [ %8, %bb.v ], [ %i.bp, %bb.n ] ; 3 uses
...
begin_hunk_4_@_ZN10duckdb_re26Regexp6WalkerIbE12WalkInternalEPS0_bb:bb.a
  ...
  br i1 %i.ee, label %.thread82, label %bb.z
...
begin_hunk_5_@_ZN10duckdb_re26Regexp6WalkerIbE12WalkInternalEPS0_bb:bb.a
  ...
  br i1 %i.el, label %.thread82, label %_ZNSt5stackIN10duckdb_re29WalkStateIbEESt5dequeIS2_SaIS2_EEE3topEv.exit76
...
begin_hunk_6_@_ZN10duckdb_re26Regexp6WalkerIbE12WalkInternalEPS0_bb:bb.a
  ...
  store i8 %.3, ptr %i.ex, align 1, !tbaa !9
  br label %bb.ad
...
bb.ac:                                            ; preds = %_ZNSt5stackIN10duckdb_re29WalkStateIbEESt5dequeIS2_SaIS2_EEE3topEv.exit76
  ...
  store i8 %.3, ptr %i.ey, align 2, !tbaa !88
...
bb.ae:                                            ; preds = %.thread82, %_ZN10LogMessageD2Ev.exit
