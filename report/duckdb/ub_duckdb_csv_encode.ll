...
bb.t:                                             ; preds = %bb.s, %._crit_edge96
  ...
  %i.di = phi ptr [ %.pre, %bb.s ], [ %.pre107.a, %._crit_edge96 ]
...
bb.ab:                                            ; preds = %bb.aa
  ...
  %.not.i.i.i46.a = icmp eq ptr %.sroa.0.1120, null
  br i1 %.not.i.i.i46.a, label %_ZNSt6vectorIcSaIcEED2Ev.exit, label %bb.ac
