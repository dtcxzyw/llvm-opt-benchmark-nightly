...
begin_hunk_0_@mbedtls_mpi_write_string:bb.a
  ...
  %i.hd = sub nuw nsw i64 %i.fq, %i.gz
...
bb.z:                                             ; preds = %mbedtls_mpi_mod_int.exit.i
  %i.hf = icmp samesign ult i64 %spec.select.sink.i.i, 10
  %i.hg = trunc nuw nsw i64 %spec.select.sink.i.i to i8 ; 2 uses
  %i.hh = getelementptr inbounds i8, ptr %.0.i230, i64 -1 ; 5 uses
  %i.hi = add nuw nsw i8 %i.hg, 55
