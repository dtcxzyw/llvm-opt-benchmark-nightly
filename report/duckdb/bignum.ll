...
bb.c:                                             ; preds = %bb.b
  %i.i = tail call noalias ptr @calloc(i64 noundef %i.c, i64 noundef 8) #14 ; 4 uses
...
bb.f:                                             ; preds = %bb.e, %bb.d
  ...
  %.pre27 = load i16, ptr %i.a, align 2, !tbaa !7
  %.pre28 = zext i16 %.pre27 to i64
  br label %bb.g

bb.g:                                             ; preds = %._crit_edge, %bb.f
  %.pre-phi = phi i64 [ %i.c, %._crit_edge ], [ %.pre28, %bb.f ]
  %3 = phi ptr [ %.pre, %._crit_edge ], [ %i.i, %bb.f ]
...
begin_hunk_3_@mbedtls_mpi_safe_cond_assign:bb.a
  ...
  tail call void @_Z28mbedtls_mpi_core_cond_assignPmPKmmm(ptr noundef %3, ptr noundef %i.aj, i64 noundef %.pre-phi, i64 noundef %.neg.i)
...
bb.i:                                             ; preds = %bb.h
  %i.z = tail call noalias ptr @calloc(i64 noundef %.pre-phi47, i64 noundef 8) #14 ; 4 uses
...
bb.l:                                             ; preds = %bb.k, %bb.j
  ...
  %.pre34 = load i16, ptr %i.m, align 2, !tbaa !7
  %.pre35 = zext i16 %.pre34 to i64
  br label %bb.m

bb.m:                                             ; preds = %._crit_edge, %bb.l
  %.pre-phi36 = phi i64 [ %.pre-phi47, %._crit_edge ], [ %.pre35, %bb.l ]
  %3 = phi ptr [ %.pre, %._crit_edge ], [ %i.z, %bb.l ]
...
begin_hunk_6_@mbedtls_mpi_safe_cond_swap:bb.a
  ...
  tail call void @_Z26mbedtls_mpi_core_cond_swapPmS_mm(ptr noundef %i.be, ptr noundef %3, i64 noundef %.pre-phi36, i64 noundef %.neg.i)
