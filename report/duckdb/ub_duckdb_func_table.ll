...
_ZNKSt6vectorImSaImEE12_M_check_lenEmPKc.exit.i.i:
  ...
  %i.a = tail call noalias noundef nonnull dereferenceable(8) ptr @_Znwm(i64 noundef 8) #32 ; 3 uses
  ...
  store ptr %i.c, ptr %3, align 8, !tbaa !174
  store ptr %i.c, ptr %4, align 8, !tbaa !1555
  ret void
}
