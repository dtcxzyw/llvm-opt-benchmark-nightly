...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  ...
  store i32 %.093116, ptr %i.ag, align 4, !tbaa !3
...
.lr.ph.epil:                                      ; preds = %.lr.ph.epil, %.lr.ph.epil.preheader
  ...
  store i32 %.093116.epil, ptr %i.aw, align 4, !tbaa !3
...
bb.g:                                             ; preds = %bb.g, %.lr.ph120.new
  ...
  br i1 %niter336.ncmp.1, label %._crit_edge121.loopexit.unr-lcssa, label %bb.g, !llvm.loop !45
...
.lr.ph125:                                        ; preds = %.lr.ph125, %.lr.ph125.preheader.new
  ...
  store i32 %.090122, ptr %i.cn, align 4, !tbaa !3
  ...
  br i1 %niter342.ncmp.1, label %._crit_edge126.unr-lcssa, label %.lr.ph125, !llvm.loop !46
...
.lr.ph125.epil.preheader:                         ; preds = %._crit_edge126.unr-lcssa, %.lr.ph125.preheader
  ...
  store i32 %.090122.epil.init, ptr %i.cv, align 4, !tbaa !3
...
scalar.ph.preheader:                              ; preds = %vector.memcheck, %.lr.ph129, %middle.block
  ...
  %xtraiter343 = and i64 %i.dq, 3                 ; 2 uses
...
.loopexit.i.us.us74.i.prol.loopexit:              ; preds = %.loopexit.i.us.us74.i.prol, %.loopexit.i.us.us74.i.preheader
  ...
  %.05267.us.us73.i.unr = phi i32 [ %i.fb, %.loopexit.i.us.us74.i.preheader ], [ %i.fy, %.loopexit.i.us.us74.i.prol ]
...
.loopexit.i.us.us.i.preheader:                    ; preds = %.lr.ph.split.us.i
  ...
  %.neg399 = add i32 %i.eu, 1
  %xtraiter373 = and i32 %i.ga, 1
...
.loopexit.i.us.us.i.prol.loopexit:                ; preds = %.loopexit.i.us.us.i.prol, %.loopexit.i.us.us.i.preheader
  ...
  %.05267.us.us.i.unr = phi i32 [ %i.fb, %.loopexit.i.us.us.i.preheader ], [ %i.gj, %.loopexit.i.us.us.i.prol ]
  %i.gk = icmp eq i32 %i.ew, %.neg399
  br i1 %i.gk, label %.loopexit.i, label %.loopexit.i.us.us.i
...
.loopexit.i.us.us.i:                              ; preds = %.loopexit.i.us.us.i.prol.loopexit, %.loopexit.i.us.us.i
  ...
  %.05267.us.us.i = phi i32 [ %i.hd, %.loopexit.i.us.us.i ], [ %.05267.us.us.i.unr, %.loopexit.i.us.us.i.prol.loopexit ] ; 3 uses
  %i.gl = sext i32 %.05267.us.us.i to i64
  %i.gm = getelementptr inbounds [4 x i8], ptr %i.e, i64 %i.gl
  %i.gn = getelementptr inbounds i8, ptr %i.en, i64 %indvars.iv90.i
  %i.go = load i8, ptr %i.gn, align 1, !tbaa !43
  %i.gp = zext i8 %i.go to i32
  %i.gq = or disjoint i32 %i.fj, %i.gp
  %i.gr = zext i32 %i.gq to i64
  %i.gs = mul nuw i64 %i.gr, 4294967297
  store i64 %i.gs, ptr %i.gm, align 2
  %i.gt = add i32 %.05267.us.us.i, 2
  %i.gu = sext i32 %i.gt to i64
  %i.gv = getelementptr inbounds [4 x i8], ptr %i.e, i64 %i.gu
  %i.gw = getelementptr i8, ptr %i.en, i64 %indvars.iv90.i
  %i.gx = getelementptr i8, ptr %i.gw, i64 1
  %i.gy = load i8, ptr %i.gx, align 1, !tbaa !43
  %i.gz = zext i8 %i.gy to i32
  %i.ha = or disjoint i32 %i.fj, %i.gz
  %i.hb = zext i32 %i.ha to i64
  %i.hc = mul nuw i64 %i.hb, 4294967297
  store i64 %i.hc, ptr %i.gv, align 2
  %i.hd = add i32 %.05267.us.us.i, 4
  %indvars.iv.next91.i.1 = add nsw i64 %indvars.iv90.i, 2 ; 2 uses
  %i.he = trunc nsw i64 %indvars.iv.next91.i.1 to i32
  %.not57.us.us.i.1 = icmp eq i32 %i.ew, %i.he
  br i1 %.not57.us.us.i.1, label %.loopexit.i, label %.loopexit.i.us.us.i, !llvm.loop !51
...
.loopexit.i.us.us74.i:                            ; preds = %.loopexit.i.us.us74.i.prol.loopexit, %.loopexit.i.us.us74.i
  ...
  %.05267.us.us73.i = phi i32 [ %i.hz, %.loopexit.i.us.us74.i ], [ %.05267.us.us73.i.unr, %.loopexit.i.us.us74.i.prol.loopexit ] ; 3 uses
  %i.hf = sext i32 %.05267.us.us73.i to i64
  %i.hg = getelementptr inbounds [4 x i8], ptr %i.e, i64 %i.hf ; 2 uses
  %i.hh = getelementptr inbounds i8, ptr %i.en, i64 %indvars.iv87.i
  %i.hi = load i8, ptr %i.hh, align 1, !tbaa !43
  %i.hj = zext i8 %i.hi to i32
  %i.hk = or disjoint i32 %i.fj, %i.hj
  %i.hl = zext i32 %i.hk to i64
  %i.hm = mul nuw i64 %i.hl, 4294967297           ; 2 uses
  store i64 %i.hm, ptr %i.hg, align 2
  %i.hn = getelementptr inbounds nuw i8, ptr %i.hg, i64 8
  store i64 %i.hm, ptr %i.hn, align 2
  %i.ho = add i32 %.05267.us.us73.i, 4
  %i.hp = sext i32 %i.ho to i64
  %i.hq = getelementptr inbounds [4 x i8], ptr %i.e, i64 %i.hp ; 2 uses
  %i.hr = getelementptr i8, ptr %i.en, i64 %indvars.iv87.i
  %i.hs = getelementptr i8, ptr %i.hr, i64 1
  %i.ht = load i8, ptr %i.hs, align 1, !tbaa !43
  %i.hu = zext i8 %i.ht to i32
  %i.hv = or disjoint i32 %i.fj, %i.hu
  %i.hw = zext i32 %i.hv to i64
  %i.hx = mul nuw i64 %i.hw, 4294967297           ; 2 uses
  store i64 %i.hx, ptr %i.hq, align 2
  %i.hy = getelementptr inbounds nuw i8, ptr %i.hq, i64 8
  store i64 %i.hx, ptr %i.hy, align 2
  %i.hz = add i32 %.05267.us.us73.i, 8
  %indvars.iv.next88.i.1 = add nsw i64 %indvars.iv87.i, 2 ; 2 uses
  %i.ia = trunc nsw i64 %indvars.iv.next88.i.1 to i32
  %.not57.us.us75.i.1 = icmp eq i32 %i.ew, %i.ia
...
.preheader.i.us.i:                                ; preds = %.lr.ph.split.us.i, %.loopexit.i.us.i
  ...
  %.05267.us.i = phi i32 [ %i.ji, %.loopexit.i.us.i ], [ %i.fb, %.lr.ph.split.us.i ] ; 2 uses
  %i.ib = sext i32 %.05267.us.i to i64
  %i.ic = getelementptr inbounds [4 x i8], ptr %i.e, i64 %i.ib ; 9 uses
  %i.id = load i32, ptr %i.fl, align 4, !tbaa !3  ; 3 uses
  %i.ie = icmp sgt i32 %i.id, 0
  br i1 %i.ie, label %.lr.ph.preheader.i.us.i, label %.loopexit.i.us.i

.lr.ph.preheader.i.us.i:                          ; preds = %.preheader.i.us.i
  %i.if = getelementptr inbounds i8, ptr %i.en, i64 %indvars.iv93.i
  %i.ig = load i8, ptr %i.if, align 1, !tbaa !43
  %i.ih = zext i8 %i.ig to i32
  %i.ii = or disjoint i32 %i.fj, %i.ih
  %i.ij = zext i32 %i.ii to i64
  %i.ik = mul nuw i64 %i.ij, 4294967297
  %i.il = zext nneg i32 %i.id to i64
  %i.im = insertelement <4 x i64> poison, i64 %i.ik, i64 0
  %i.in = shufflevector <4 x i64> %i.im, <4 x i64> poison, <4 x i32> zeroinitializer ; 9 uses
  %i.io = add nsw i64 %i.il, -1
