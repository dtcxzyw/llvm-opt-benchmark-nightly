...
begin_hunk_1_@_ZN11duckdb_zstdL38HUF_decompress1X2_usingDTable_internalEPvmPKvmPKji:bb.a
  ...
  %.sroa.31.12173298.i = phi i32 [ %i.bg, %.thread.i ], [ %7, %bb.n ] ; 2 uses
...
.lr.ph.i:                                         ; preds = %.thread.i, %bb.n
  %.sroa.20.573140.i = phi i32 [ %i.bf, %.thread.i ], [ %7, %bb.n ]
...
_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit.i.i: ; preds = %bb.s, %bb.q, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit.i.i.loopexit.split.loop.exit, %bb.w, %bb.v, %bb.u, %.thread.i
  %.sroa.20.1.i = phi i32 [ %7, %bb.v ], [ %i.ec, %bb.w ], [ %i.du, %bb.u ], [ %i.bf, %.thread.i ], [ %.sroa.20.4.i, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit.i.i.loopexit.split.loop.exit ], [ %i.dn, %bb.s ], [ %.sroa.20.3100.i, %bb.q ]
...
bb.q:                                             ; preds = %bb.p, %.thread.i.i
  ...
  %.sroa.36380.14.i = phi i32 [ %i.cc, %bb.p ], [ %8, %.thread.i.i ] ; 2 uses
...
bb.ac:                                            ; preds = %bb.ab, %.thread.i11.i
  ...
  %.sroa.36227.14.i = phi i32 [ %i.ec, %bb.ab ], [ %10, %.thread.i11.i ] ; 2 uses
...
bb.ao:                                            ; preds = %bb.an, %.thread.i17.i
  ...
  %.sroa.36.14.i = phi i32 [ %i.gc, %bb.an ], [ %12, %.thread.i17.i ] ; 2 uses
...
bb.q:                                             ; preds = %bb.p, %.thread.i.i
  ...
  %.sroa.25217.7.i = phi i32 [ %i.cc, %bb.p ], [ %8, %.thread.i.i ] ; 2 uses
...
bb.ac:                                            ; preds = %bb.ab, %.thread.i11.i
  ...
  %.sroa.25134.7.i = phi i32 [ %i.ec, %bb.ab ], [ %10, %.thread.i11.i ] ; 2 uses
...
bb.ao:                                            ; preds = %bb.an, %.thread.i17.i
  ...
  %.sroa.25.7.i = phi i32 [ %i.gc, %bb.an ], [ %12, %.thread.i17.i ] ; 2 uses
...
begin_hunk_25_@_ZN11duckdb_zstdL43HUF_decompress1X2_usingDTable_internal_bmi2EPvmPKvmPKj:bb.a
  ...
  %.sroa.31.12173298 = phi i32 [ %i.be, %.thread ], [ %6, %bb.l ] ; 2 uses
...
begin_hunk_29_@_ZN11duckdb_zstdL43HUF_decompress1X2_usingDTable_internal_bmi2EPvmPKvmPKj:bb.a
  ...
  %.sroa.31.0 = phi i32 [ %6, %bb.z ], [ %i.ic, %bb.y ], [ %.sroa.31.7, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit29.loopexit.split.loop.exit ], [ %i.ik, %bb.aa ], [ %i.be, %.thread ], [ %.sroa.31.5234, %bb.p ], [ %.sroa.31.8, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit29.loopexit329.split.loop.exit ], [ %i.fb, %bb.r ], [ %.sroa.31.4217, %bb.u ], [ %i.hs, %bb.w ] ; 4 uses
...
.thread:                                          ; preds = %bb.d
  ...
  store i32 %4, ptr %i.m, align 8, !tbaa !129
  br label %bb.p
...
.lr.ph:                                           ; preds = %.thread, %bb.l
  %.sroa.20.573140 = phi i32 [ %i.bd, %.thread ], [ %6, %bb.l ]
...
_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit.i: ; preds = %bb.o, %bb.q, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit.i.loopexit.split.loop.exit, %.thread, %bb.t, %bb.s, %bb.u
  %.sroa.20.1 = phi i32 [ %6, %bb.t ], [ %i.ea, %bb.u ], [ %i.ds, %bb.s ], [ %i.bd, %.thread ], [ %.sroa.20.4, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit.i.loopexit.split.loop.exit ], [ %.sroa.20.3100, %bb.o ], [ %i.dl, %bb.q ]
...
bb.o:                                             ; preds = %bb.n, %.thread.i
  ...
  %.sroa.36380.14 = phi i32 [ %i.ca, %bb.n ], [ %7, %.thread.i ] ; 2 uses
...
bb.aa:                                            ; preds = %bb.z, %.thread.i11
  ...
  %.sroa.36227.14 = phi i32 [ %i.ea, %bb.z ], [ %9, %.thread.i11 ] ; 2 uses
...
bb.am:                                            ; preds = %bb.al, %.thread.i17
  ...
  %.sroa.36.14 = phi i32 [ %i.ga, %bb.al ], [ %11, %.thread.i17 ] ; 2 uses
...
bb.o:                                             ; preds = %bb.n, %.thread.i
  ...
  %.sroa.25217.7 = phi i32 [ %i.ca, %bb.n ], [ %7, %.thread.i ] ; 2 uses
...
bb.aa:                                            ; preds = %bb.z, %.thread.i11
  ...
  %.sroa.25134.7 = phi i32 [ %i.ea, %bb.z ], [ %9, %.thread.i11 ] ; 2 uses
...
bb.am:                                            ; preds = %bb.al, %.thread.i17
  ...
  %.sroa.25.7 = phi i32 [ %i.ga, %bb.al ], [ %11, %.thread.i17 ] ; 2 uses
