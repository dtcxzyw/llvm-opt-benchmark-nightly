...
begin_hunk_3
  ...
  br i1 %i.dq, label %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit73, label %bb.g, !prof !105, !llvm.loop !106
...
begin_hunk_5
  ...
  br i1 %i.ad, label %.loopexit226, label %.preheader225, !llvm.loop !138
...
begin_hunk_6
  ...
  br i1 %i.im, label %.preheader, label %.loopexit, !llvm.loop !138
...
bb.c:                                             ; preds = %._crit_edge
  ...
  br i1 %exitcond131, label %.thread, label %bb.d, !llvm.loop !139
...
begin_hunk_12
  ...
  br i1 %i.cq, label %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit.i, label %bb.g, !prof !105, !llvm.loop !117
