...
bb.a:
  ...
  %.sroa.0.0.copyload282 = load ptr, ptr %0, align 8
  %.sroa.8.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
  %.sroa.8.0.copyload = load ptr, ptr %.sroa.8.0..sroa_idx, align 8
  %.sroa.12.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  %.sroa.12.0.copyload = load ptr, ptr %.sroa.12.0..sroa_idx, align 8
  %.sroa.16.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 24 ; 2 uses
...
.loopexit:                                        ; preds = %.preheader
  br label %bb.b, !llvm.loop !135

bb.b:                                             ; preds = %.loopexit, %bb.a
  %.sroa.16.0 = phi ptr [ %.sroa.16.0.copyload, %bb.a ], [ %i.hu, %.loopexit ] ; 3 uses
  %.sroa.12.0 = phi ptr [ %.sroa.12.0.copyload, %bb.a ], [ %i.hm, %.loopexit ] ; 4 uses
  %.sroa.8.0 = phi ptr [ %.sroa.8.0.copyload, %bb.a ], [ %i.he, %.loopexit ] ; 4 uses
  %.sroa.0.0295 = phi ptr [ %.sroa.0.0.copyload282, %bb.a ], [ %i.gw, %.loopexit ] ; 4 uses
  %.sroa.0.0 = phi ptr [ %.sroa.0.0.copyload, %bb.a ], [ %i.gu, %.loopexit ] ; 2 uses
  %.sroa.11.0 = phi ptr [ %.sroa.11.0.copyload, %bb.a ], [ %i.hc, %.loopexit ] ; 2 uses
  %.sroa.18.0 = phi ptr [ %.sroa.18.0.copyload, %bb.a ], [ %i.hk, %.loopexit ] ; 2 uses
  %.sroa.25.0 = phi ptr [ %.sroa.25.0.copyload, %bb.a ], [ %i.hs, %.loopexit ] ; 4 uses
  %.sroa.0142.0 = phi i64 [ %.sroa.0142.0.copyload, %bb.a ], [ %i.gy, %.loopexit ] ; 2 uses
  %.sroa.23.0 = phi i64 [ %.sroa.23.0.copyload, %bb.a ], [ %i.hg, %.loopexit ] ; 2 uses
  %.sroa.42.0 = phi i64 [ %.sroa.42.0.copyload, %bb.a ], [ %i.ho, %.loopexit ] ; 2 uses
end_hunk_0
