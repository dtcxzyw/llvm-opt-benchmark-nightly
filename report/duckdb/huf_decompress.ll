...
_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit22.i: ; preds = %bb.ae, %bb.ad
  ...
  %.sroa.0.7.i = load i64, ptr %.sroa.9790.7.i, align 1, !tbaa !21 ; 3 uses
  %i.iy = icmp ule ptr %.5.i.i40, %i.in
  %i.iz = and i1 %i.iy, %.022.i17.i
  br i1 %i.iz, label %bb.af, label %.preheader.i

.preheader.i:                                     ; preds = %bb.af, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit22.i, %.preheader202.i
  %.5.i.i.lcssa = phi ptr [ %.4.i.i, %.preheader202.i ], [ %.5.i.i40, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit22.i ], [ %i.jn, %bb.af ] ; 3 uses
  %.sroa.9790.7329.i = phi ptr [ @_ZZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tEE10zeroFilled, %.preheader202.i ], [ %.sroa.9790.7.i, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit22.i ], [ @_ZZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tEE10zeroFilled, %bb.af ] ; 2 uses
  %.sroa.31.9328.i = phi i32 [ %.sroa.31.0.i, %.preheader202.i ], [ %.sroa.31.9.i, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit22.i ], [ %i.jj, %bb.af ] ; 2 uses
  %.sroa.0.7327.i = phi i64 [ %.sroa.0.0.i, %.preheader202.i ], [ %.sroa.0.7.i, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit22.i ], [ %.sroa.0.7.i, %bb.af ] ; 3 uses
...
.loopexit.i:                                      ; preds = %.lr.ph248.i, %.preheader.i, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit29.i
  %.sroa.0.1.i = phi i64 [ %.sroa.0.0.i, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit29.i ], [ %.sroa.0.7327.i, %.preheader.i ], [ %.sroa.0.7327.i, %.lr.ph248.i ]
  %.sroa.31.1.i = phi i32 [ %.sroa.31.0.i, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit29.i ], [ %.sroa.31.9328.i, %.preheader.i ], [ %i.jy, %.lr.ph248.i ] ; 6 uses
  %.sroa.9790.1.i = phi ptr [ %.sroa.9790.0.i, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit29.i ], [ %.sroa.9790.7329.i, %.preheader.i ], [ %.sroa.9790.7329.i, %.lr.ph248.i ]
...
_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit29: ; preds = %bb.u, %bb.w, %bb.p, %bb.r, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit29.loopexit331.split.loop.exit, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit29.loopexit.split.loop.exit, %.thread, %bb.z, %bb.aa, %bb.y
  ...
  %.sroa.0.0 = phi i64 [ %.val.i, %bb.z ], [ %.val.i61, %bb.y ], [ %.sroa.0.5, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit29.loopexit.split.loop.exit ], [ %.val30, %bb.aa ], [ %.sroa.0.9, %.thread ], [ %.sroa.0.4236, %bb.p ], [ %.sroa.0.6, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit29.loopexit331.split.loop.exit ], [ %.sroa.0.5, %bb.r ], [ %.sroa.0.3219, %bb.u ], [ %.sroa.0.6, %bb.w ] ; 2 uses
...
_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit22: ; preds = %bb.ab, %bb.ac
  ...
  %.sroa.0.7 = load i64, ptr %.sroa.9790.7, align 1, !tbaa !21 ; 3 uses
  %i.je = icmp ule ptr %.5.i370, %i.it
  %i.jf = and i1 %i.je, %.022.i17
  br i1 %i.jf, label %bb.ad, label %.preheader

.preheader:                                       ; preds = %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit22, %bb.ad, %.preheader202
  %.5.i.lcssa = phi ptr [ %.4.i, %.preheader202 ], [ %.5.i370, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit22 ], [ %i.jt, %bb.ad ] ; 3 uses
  %.sroa.9790.7329 = phi ptr [ @_ZZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tEE10zeroFilled, %.preheader202 ], [ %.sroa.9790.7, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit22 ], [ @_ZZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tEE10zeroFilled, %bb.ad ] ; 2 uses
  %.sroa.31.9328 = phi i32 [ %.sroa.31.0, %.preheader202 ], [ %.sroa.31.9, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit22 ], [ %i.jp, %bb.ad ] ; 2 uses
  %.sroa.0.7327 = phi i64 [ %.sroa.0.0, %.preheader202 ], [ %.sroa.0.7, %bb.ad ], [ %.sroa.0.7, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit22 ] ; 3 uses
...
.loopexit:                                        ; preds = %.lr.ph248, %.preheader, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit29
  %.sroa.0.1 = phi i64 [ %.sroa.0.0, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit29 ], [ %.sroa.0.7327, %.preheader ], [ %.sroa.0.7327, %.lr.ph248 ]
  %.sroa.31.1 = phi i32 [ %.sroa.31.0, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit29 ], [ %.sroa.31.9328, %.preheader ], [ %i.ke, %.lr.ph248 ] ; 6 uses
  %.sroa.9790.1 = phi ptr [ %.sroa.9790.0, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit29 ], [ %.sroa.9790.7329, %.preheader ], [ %.sroa.9790.7329, %.lr.ph248 ]
...
bb.f:                                             ; preds = %bb.e
  %.val.i = load i64, ptr %i.s, align 1, !tbaa !21
  ...
  %i.ab = load ptr, ptr %i.k, align 8, !tbaa !46  ; 8 uses
...
_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit: ; preds = %bb.h, %bb.i
  ...
  %.sroa.0.2 = load i64, ptr %.sroa.6235.2, align 1, !tbaa !21 ; 6 uses
...
_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit74.loopexit: ; preds = %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit, %bb.j
  %.sroa.6235.4.ph.ph = phi ptr [ @_ZZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tEE10zeroFilled, %bb.j ], [ %.sroa.6235.2, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit ]
  %.sroa.17.4.ph.ph = phi i32 [ %i.di, %bb.j ], [ %.sroa.17.2, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit ]
  %.4.i.ph.ph = phi ptr [ %i.dm, %bb.j ], [ %.0.i68, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit ] ; 2 uses
...
_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit74: ; preds = %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit74.loopexit, %bb.m, %bb.n, %bb.l
  ...
  %.sroa.6235.4 = phi ptr [ %.sroa.6235.4.ph.ph, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit74.loopexit ], [ %i.s, %bb.m ], [ %i.ee, %bb.n ], [ %i.dq, %bb.l ]
  %.sroa.17.4 = phi i32 [ %.sroa.17.4.ph.ph, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit74.loopexit ], [ %i.aa, %bb.m ], [ %i.eg, %bb.n ], [ %i.dr, %bb.l ] ; 4 uses
  %.sroa.0.4 = phi i64 [ %.sroa.0.2, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit74.loopexit ], [ %.val.i, %bb.m ], [ %.val, %bb.n ], [ %.val.i95, %bb.l ] ; 2 uses
  %.4.i = phi ptr [ %.4.i.ph.ph, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit74.loopexit ], [ %i.p, %bb.m ], [ %i.p, %bb.n ], [ %i.p, %bb.l ] ; 3 uses
...
_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit67: ; preds = %bb.o, %bb.p
  ...
  %.sroa.0.6 = load i64, ptr %.sroa.6235.6, align 1, !tbaa !21 ; 3 uses
  %i.eq = icmp ule ptr %.5.i100, %i.ei
  %i.er = and i1 %i.eq, %.022.i62
  br i1 %i.er, label %bb.q, label %.preheader

.preheader:                                       ; preds = %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit67, %bb.q, %.preheader63
  %.5.i.lcssa = phi ptr [ %.4.i, %.preheader63 ], [ %.5.i100, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit67 ], [ %i.ff, %bb.q ] ; 3 uses
  %.sroa.0.691 = phi i64 [ %.sroa.0.4, %.preheader63 ], [ %.sroa.0.6, %bb.q ], [ %.sroa.0.6, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit67 ] ; 3 uses
  %.sroa.17.690 = phi i32 [ %.sroa.17.4, %.preheader63 ], [ %.sroa.17.6, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit67 ], [ %i.fb, %bb.q ] ; 2 uses
...
.loopexit:                                        ; preds = %.lr.ph, %.preheader, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit74
  %.sroa.17.8 = phi i32 [ %.sroa.17.4, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit74 ], [ %.sroa.17.690, %.preheader ], [ %i.fq, %.lr.ph ]
  %.sroa.0.7 = phi i64 [ %.sroa.0.4, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit74 ], [ %.sroa.0.691, %.preheader ], [ %.sroa.0.691, %.lr.ph ]
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.z = tail call range(i64 0, 65) i64 @llvm.cttz.i64(i64 %i.y, i1 true) ; 2 uses
  %i.aa = trunc nuw nsw i64 %i.z to i32           ; 5 uses
  %i.ab = load ptr, ptr %i.k, align 8, !tbaa !46  ; 6 uses
...
_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit43.i: ; preds = %bb.i, %bb.h
  ...
  %.sroa.0.2 = load i64, ptr %.sroa.3820.2, align 1, !tbaa !21 ; 6 uses
...
_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit.i: ; preds = %bb.j, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit43.i, %bb.m, %bb.l, %bb.n
  %.sroa.12.4 = phi i32 [ %i.aa, %bb.m ], [ %i.dg, %bb.n ], [ %i.cr, %bb.l ], [ %.sroa.12.2, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit43.i ], [ %i.cl, %bb.j ] ; 3 uses
  %.sroa.0.4 = phi i64 [ %.val.i, %bb.m ], [ %.val59, %bb.n ], [ %.val.i72, %bb.l ], [ %.sroa.0.2, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit43.i ], [ %.sroa.0.2, %bb.j ] ; 3 uses
  %.3.i = phi ptr [ %i.p, %bb.m ], [ %i.p, %bb.n ], [ %i.p, %bb.l ], [ %.0.i46, %_ZN11duckdb_zstdL17BIT_reloadDStreamEPNS_13BIT_DStream_tE.exit43.i ], [ %i.cm, %bb.j ] ; 5 uses
