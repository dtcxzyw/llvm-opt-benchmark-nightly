...
define hidden noundef i64 @_ZNK10duckdb_re211StringPiece4copyEPcmm(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(16) %0, ptr nofree noundef writeonly captures(none) %1, i64 noundef %2, i64 noundef %3) local_unnamed_addr #0 align 2 {
bb.a:
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %1, ptr align 1 %i.e, i64 %.sroa.speculated, i1 false)
...
define hidden { ptr, i64 } @_ZNK10duckdb_re211StringPiece6substrEmm(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(16) %0, i64 noundef %1, i64 noundef %2) local_unnamed_addr #2 align 2 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.b = load i64, ptr %i.a, align 8, !tbaa !7    ; 2 uses
  %spec.select = tail call i64 @llvm.umin.i64(i64 %1, i64 %i.b) ; 2 uses
  %i.c = sub i64 %i.b, %spec.select
  %.0 = tail call i64 @llvm.umin.i64(i64 %2, i64 %i.c)
  %i.d = load ptr, ptr %0, align 8, !tbaa !12
  %i.e = getelementptr inbounds nuw i8, ptr %i.d, i64 %spec.select
...
define hidden noundef i64 @_ZNK10duckdb_re211StringPiece4findERKS0_m(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(16) %0, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(16) %1, i64 noundef %2) local_unnamed_addr #3 align 2 {
bb.a:
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.k = tail call noundef ptr @_ZSt8__searchIPKcS1_N9__gnu_cxx5__ops19_Iter_equal_to_iterEET_S5_S5_T0_S6_T1_(ptr noundef %i.e, ptr noundef %i.f, ptr noundef %i.g, ptr noundef %i.j)
...
define hidden noundef i64 @_ZNK10duckdb_re211StringPiece4findEcm(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(16) %0, i8 noundef signext %1, i64 noundef %2) local_unnamed_addr #4 align 2 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %i.f, label %bb.c, label %_ZSt8find_endIPKcS1_ET_S2_S2_T0_S3_.exit.a

bb.c:                                             ; preds = %bb.b
  %.sroa.speculated18 = tail call i64 @llvm.umin.i64(i64 %2, i64 %i.b)
  br label %bb.d

_ZSt8find_endIPKcS1_ET_S2_S2_T0_S3_.exit.a:       ; preds = %bb.b
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(read, inaccessiblemem: none, target_mem: none) uwtable
define hidden noundef i64 @_ZNK10duckdb_re211StringPiece5rfindEcm(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(16) %0, i8 noundef signext %1, i64 noundef %2) local_unnamed_addr #4 align 2 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.b = load i64, ptr %i.a, align 8, !tbaa !7    ; 2 uses
...
; Function Attrs: mustprogress uwtable
define hidden noundef nonnull align 8 dereferenceable(8) ptr @_ZN10duckdb_re2lsERSoRKNS_11StringPieceE(ptr noundef nonnull returned align 8 dereferenceable(8) %0, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(16) %1) local_unnamed_addr #3 {
bb.a:
