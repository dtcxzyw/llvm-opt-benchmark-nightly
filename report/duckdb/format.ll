...
bb.s:                                             ; preds = %bb.l
  ...
  %i.bn = load i32, ptr %i.bm, align 4, !tbaa !182 ; 2 uses
...
bb.u:                                             ; preds = %bb.s
  ...
  store ptr %i.cb, ptr %7, align 8, !tbaa !1197
  %i.ce = getelementptr inbounds nuw i8, ptr %7, i64 8
  store i32 %i.cd, ptr %i.ce, align 8, !tbaa !1201
  %i.cf = getelementptr inbounds nuw i8, ptr %7, i64 12
  store i32 %i.bx, ptr %i.cf, align 4, !tbaa !1202
  ...
  store i8 %.056, ptr %i.ch, align 8, !tbaa !1203
...
bb.y:                                             ; preds = %bb.x
  ...
  store i64 %i.ct, ptr %i.cq, align 8, !tbaa !1204
...
bb.a:
  ...
  %i.b = load i8, ptr %i.a, align 4, !tbaa !184
  ...
  %i.k = load i8, ptr %i.j, align 4, !tbaa !183   ; 2 uses
...
bb.e:                                             ; preds = %bb.d, %bb.a
  ...
  %i.v = load i32, ptr %i.u, align 4, !tbaa !182
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2EmcRKS3_.exit: ; preds = %bb.a
  ...
  store ptr %i.ak, ptr %4, align 8, !tbaa !41
...
bb.p:                                             ; preds = %bb.l
  %i.an = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.ao = load ptr, ptr %2, align 8, !tbaa !71    ; 2 uses
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %bb.p, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i, %bb.o
  ...
  %i.ar = load ptr, ptr %3, align 8, !tbaa !71    ; 2 uses
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit56: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i54, %bb.n
  ...
  %i.au = load ptr, ptr %4, align 8, !tbaa !71    ; 2 uses
...
bb.a:
  %i.a = load i32, ptr %1, align 4, !tbaa !176
  %i.b = load i32, ptr %2, align 8, !tbaa !1194   ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  tail call void %i.l(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.0.0.copyload.i.i40, i64 noundef %i.i), !inline_history !303
  %.pre = load i32, ptr %2, align 8, !tbaa !1194
...
_ZNK10duckdb_fmt2v68internal16nonfinite_writerIcEclIPcEEvOT_.exit: ; preds = %_ZN10duckdb_fmt2v68internal12basic_writerINS0_12buffer_rangeIcEEE7reserveEm.exit, %bb.d
  ...
  %i.v = load ptr, ptr %i.u, align 8, !tbaa !1196 ; 3 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  tail call void %i.ae(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.0.0.copyload.i.i40, i64 noundef %i.ab), !inline_history !303
...
_ZSt6fill_nIPcmcET_S1_T0_RKT1_.exit:              ; preds = %_ZN10duckdb_fmt2v68internal12basic_writerINS0_12buffer_rangeIcEEE7reserveEm.exit41
  ...
  %i.ap = load i32, ptr %2, align 8, !tbaa !1194  ; 2 uses
...
_ZNK10duckdb_fmt2v68internal16nonfinite_writerIcEclIRPcEEvOT_.exit: ; preds = %_ZSt6fill_nIPcmcET_S1_T0_RKT1_.exit, %bb.g
  ...
  %i.av = load ptr, ptr %i.au, align 8, !tbaa !1196 ; 3 uses
end_hunk_0
...
bb.s:                                             ; preds = %bb.l
  ...
  %i.bo = load i32, ptr %i.bn, align 4, !tbaa !1359 ; 2 uses
...
bb.u:                                             ; preds = %bb.s
  ...
  %.sroa.014.0.insert.ext = zext i32 %spec.select80 to i64
  %.sroa.014.0.insert.insert = or disjoint i64 %.sroa.8.0.insert.shift22, %.sroa.014.0.insert.ext
  store ptr %i.cc, ptr %7, align 8, !tbaa !3332
  %i.cf = getelementptr inbounds nuw i8, ptr %7, i64 8
  store i32 %i.ce, ptr %i.cf, align 8, !tbaa !3334
  %i.cg = getelementptr inbounds nuw i8, ptr %7, i64 12
  store i32 %i.by, ptr %i.cg, align 4, !tbaa !3335
  ...
  store i32 %.056, ptr %i.ci, align 8, !tbaa !3336
...
bb.y:                                             ; preds = %bb.x
  ...
  store i64 %i.cu, ptr %i.cr, align 8, !tbaa !3337
...
bb.a:
  ...
  %i.b = load i8, ptr %i.a, align 4, !tbaa !1364
  %i.c = zext i8 %i.b to i32
  %i.d = shl nuw nsw i32 %i.c, 16                 ; 2 uses
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 9
  %i.f = load i8, ptr %i.e, align 1               ; 2 uses
  ...
  %i.i = or disjoint i32 %i.h, %i.d               ; 9 uses
  %i.j = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.k = load i8, ptr %i.j, align 4, !tbaa !1360  ; 2 uses
  switch i8 %i.k, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2EmcRKS3_.exit [
    i8 0, label %bb.b
    i8 71, label %bb.c
    i8 103, label %bb.q
...
bb.b:                                             ; preds = %bb.a
  %i.l = getelementptr inbounds nuw i8, ptr %0, i64 4
  %i.m = load i32, ptr %i.l, align 4, !tbaa !1359
  %i.n = icmp ne i32 %i.m, 0
  %i.o = icmp slt i8 %i.f, 0
  %i.p = or i1 %i.o, %i.n
  %i.q = select i1 %i.p, i32 536870912, i32 0
...
bb.e:                                             ; preds = %bb.d, %bb.a
  %.sroa.2.1 = phi i32 [ %i.t, %bb.d ], [ %i.i, %bb.a ]
  %i.u = getelementptr inbounds nuw i8, ptr %0, i64 4
  %i.v = load i32, ptr %i.u, align 4, !tbaa !1359
  %.not49 = icmp eq i32 %i.v, 0
  %i.w = select i1 %.not49, i32 %i.h, i32 536870912
  %i.x = and i32 %.sroa.2.1, -536870914
  %i.y = or disjoint i32 %i.x, %i.w
...
bb.g:                                             ; preds = %bb.f, %bb.a
  %.sroa.2.2 = phi i32 [ %i.aa, %bb.f ], [ %i.i, %bb.a ]
  %i.ab = getelementptr inbounds nuw i8, ptr %0, i64 4
  %i.ac = load i32, ptr %i.ab, align 4, !tbaa !1359
  %.not = icmp eq i32 %i.ac, 0
  %i.ad = select i1 %.not, i32 %i.h, i32 536870912
  %i.ae = and i32 %.sroa.2.2, -536870915
  %i.af = or disjoint i32 %i.ae, %i.ad
...
bb.a:
  %i.a = load i32, ptr %1, align 4, !tbaa !1356
  %i.b = load i32, ptr %2, align 8, !tbaa !3329   ; 2 uses
  %.not.not.i = icmp eq i32 %i.b, 0               ; 2 uses
  %.neg = select i1 %.not.not.i, i64 4611686018427387901, i64 4611686018427387900
  %i.c = select i1 %.not.not.i, i64 3, i64 4      ; 5 uses
  %i.d = zext i32 %i.a to i64                     ; 6 uses
  %.not39 = icmp samesign ult i64 %i.c, %i.d
  %.sroa.0.0.copyload.i.i40 = load ptr, ptr %0, align 8 ; 8 uses
  %i.e = getelementptr inbounds nuw i8, ptr %.sroa.0.0.copyload.i.i40, i64 16 ; 3 uses
  %i.f = load i64, ptr %i.e, align 8, !tbaa !120  ; 4 uses
  %i.g = getelementptr inbounds nuw i8, ptr %.sroa.0.0.copyload.i.i40, i64 24
...
bb.c:                                             ; preds = %bb.b
  %i.k = load ptr, ptr %.sroa.0.0.copyload.i.i40, align 8, !tbaa !14
  %i.l = load ptr, ptr %i.k, align 8
  tail call void %i.l(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.0.0.copyload.i.i40, i64 noundef %i.i), !inline_history !1478
  %.pre = load i32, ptr %2, align 8, !tbaa !3329
...
_ZN10duckdb_fmt2v68internal12basic_writerINS0_12buffer_rangeIwEEE7reserveEm.exit: ; preds = %bb.b, %bb.c
  %i.m = phi i32 [ %i.b, %bb.b ], [ %.pre, %bb.c ] ; 2 uses
  store i64 %i.i, ptr %i.e, align 8, !tbaa !120
  %i.n = getelementptr inbounds nuw i8, ptr %.sroa.0.0.copyload.i.i40, i64 8
...
bb.d:                                             ; preds = %_ZN10duckdb_fmt2v68internal12basic_writerINS0_12buffer_rangeIwEEE7reserveEm.exit
  ...
  store i32 %i.t, ptr %i.p, align 4, !tbaa !126
...
bb.f:                                             ; preds = %bb.e
  ...
  tail call void %i.y(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.0.0.copyload.i.i40, i64 noundef %i.v), !inline_history !1478
...
_ZN10duckdb_fmt2v68internal12basic_writerINS0_12buffer_rangeIwEEE7reserveEm.exit41: ; preds = %bb.e, %bb.f
  store i64 %i.v, ptr %i.e, align 8, !tbaa !120
  ...
  %i.ad = load i32, ptr %i.ac, align 4, !tbaa !126 ; 8 uses
...
bb.g:                                             ; preds = %_ZN10duckdb_fmt2v68internal12basic_writerINS0_12buffer_rangeIwEEE7reserveEm.exit41
  ...
  %i.aj = sub nsw i64 %i.d, %i.c
  %i.ak = add nsw i64 %i.aj, 4611686018427387903
  %i.al = and i64 %i.ak, 4611686018427387903      ; 2 uses
  %i.am = add nuw nsw i64 %i.al, 1                ; 2 uses
  %min.iters.check114 = icmp samesign ult i64 %i.al, 7
  br i1 %min.iters.check114, label %.lr.ph.i.i.i.i.preheader, label %vector.ph115

vector.ph115:                                     ; preds = %bb.g
  %n.vec117 = and i64 %i.am, 9223372036854775800  ; 3 uses
  %i.an = shl i64 %n.vec117, 2
  %i.ao = getelementptr i8, ptr %i.ab, i64 %i.an
...
vector.body120:                                   ; preds = %vector.body120, %vector.ph115
  ...
  %i.ap = shl i64 %index121, 2
  %next.gep122 = getelementptr i8, ptr %i.ab, i64 %i.ap ; 2 uses
  %i.aq = getelementptr i8, ptr %next.gep122, i64 16
  store <4 x i32> %broadcast.splat119, ptr %next.gep122, align 4, !tbaa !126
  store <4 x i32> %broadcast.splat119, ptr %i.aq, align 4, !tbaa !126
  %index.next123 = add nuw i64 %index121, 8       ; 2 uses
  %i.ar = icmp eq i64 %index.next123, %n.vec117
  br i1 %i.ar, label %middle.block124, label %vector.body120, !llvm.loop !3338

middle.block124:                                  ; preds = %vector.body120
  %cmp.n125 = icmp eq i64 %i.am, %n.vec117
