...
.lr.ph.i198:                                      ; preds = %bb.ba
  ...
  %i.me = load ptr, ptr %spec.store.select.sroa.sel286, align 8
  %i.mf = load ptr, ptr %i.f, align 8
  %i.mg = sext i32 %i.lw to i64                   ; 3 uses
  %sext.i199 = shl i64 %i.lu, 32
  %i.mh = ashr exact i64 %sext.i199, 32
  %i.mi = add nsw i64 %i.mh, %i.mg
  %i.mj = sext i32 %i.lx to i64
  %i.mk = sext i32 %i.lt to i64
  %i.ml = sext i32 %i.ls to i64                   ; 2 uses
  %i.mm = sext i32 %i.ku to i64
  %i.mn = sext i32 %i.kt to i64                   ; 2 uses
  %i.mo = sext i32 %i.mc to i64
  br label %bb.bb

bb.bb:                                            ; preds = %bb.bg, %.lr.ph.i198
  %indvars.iv.i200 = phi i64 [ %i.mi, %.lr.ph.i198 ], [ %indvars.iv.next.i201, %bb.bg ] ; 7 uses
  %.03561.i = phi i64 [ 0, %.lr.ph.i198 ], [ %i.nm, %bb.bg ] ; 2 uses
  %indvars.iv.next.i201 = add nsw i64 %indvars.iv.i200, -1 ; 5 uses
  %.not.i.i202 = icmp sgt i64 %indvars.iv.i200, %i.mn
  %i.mp = icmp sle i64 %indvars.iv.i200, %i.mm
  %or.cond.i = and i1 %.not.i.i202, %i.mp
...
bb.bc:                                            ; preds = %bb.bb
  %i.mq = sub nsw i64 %indvars.iv.next.i201, %i.mn
  %i.mr = getelementptr inbounds nuw [4 x i8], ptr %i.md, i64 %i.mq
...
_ZZN10duckdb_fmt2v68internal11add_compareERKNS1_6bigintES4_S4_ENKUlS4_iE_clES4_i.exit.i: ; preds = %bb.bc, %bb.bb
  %i.mu = phi i64 [ %i.mt, %bb.bc ], [ 0, %bb.bb ]
  %.not.i45.i = icmp sgt i64 %indvars.iv.i200, %i.ml
  %i.mv = icmp sle i64 %indvars.iv.i200, %i.mk
  %or.cond55.i = and i1 %.not.i45.i, %i.mv
...
bb.bd:                                            ; preds = %_ZZN10duckdb_fmt2v68internal11add_compareERKNS1_6bigintES4_S4_ENKUlS4_iE_clES4_i.exit.i
  %i.mw = sub nsw i64 %indvars.iv.next.i201, %i.ml
  %i.mx = getelementptr inbounds nuw [4 x i8], ptr %i.me, i64 %i.mw
...
_ZZN10duckdb_fmt2v68internal11add_compareERKNS1_6bigintES4_S4_ENKUlS4_iE_clES4_i.exit46.i: ; preds = %bb.bd, %_ZZN10duckdb_fmt2v68internal11add_compareERKNS1_6bigintES4_S4_ENKUlS4_iE_clES4_i.exit.i
  ...
  %i.nb = add nuw nsw i64 %i.na, %i.mu            ; 3 uses
  %.not.i47.i = icmp sgt i64 %indvars.iv.i200, %i.mg
  %i.nc = icmp sle i64 %indvars.iv.i200, %i.mj
...
bb.be:                                            ; preds = %_ZZN10duckdb_fmt2v68internal11add_compareERKNS1_6bigintES4_S4_ENKUlS4_iE_clES4_i.exit46.i
  %i.nd = sub nsw i64 %indvars.iv.next.i201, %i.mg
  %i.ne = getelementptr inbounds nuw [4 x i8], ptr %i.mf, i64 %i.nd
...
bb.bg:                                            ; preds = %bb.bf
  ...
  %.not.not.not.i = icmp sgt i64 %indvars.iv.next.i201, %i.mo
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.bd, label %middle.block, label %vector.body, !llvm.loop !1317
...
._crit_edge:                                      ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block, %_ZN10duckdb_fmt2v68internal6bufferIjE6resizeEm.exit.._crit_edge_crit_edge
  ...
  %i.bl = load i32, ptr %i.d, align 8, !tbaa !97
  %i.bm = sub nsw i32 %i.bl, %i.aa                ; 2 uses
  store i32 %i.bm, ptr %i.d, align 8, !tbaa !97
...
_ZN10duckdb_fmt2v68internal7compareERKNS1_6bigintES4_.exit41: ; preds = %_ZN10duckdb_fmt2v68internal7compareERKNS1_6bigintES4_.exit41.backedge, %bb.g
  %i.cj = phi i64 [ %i.ce, %bb.g ], [ %i.eq, %_ZN10duckdb_fmt2v68internal7compareERKNS1_6bigintES4_.exit41.backedge ] ; 3 uses
  %i.ck = phi i32 [ %i.cf, %bb.g ], [ %i.ew, %_ZN10duckdb_fmt2v68internal7compareERKNS1_6bigintES4_.exit41.backedge ]
  %i.cl = phi i64 [ %.pre79, %bb.g ], [ %i.ey, %_ZN10duckdb_fmt2v68internal7compareERKNS1_6bigintES4_.exit41.backedge ] ; 4 uses
  %.0 = phi i32 [ 0, %bb.g ], [ %i.ev, %_ZN10duckdb_fmt2v68internal7compareERKNS1_6bigintES4_.exit41.backedge ]
...
.lr.ph.i:                                         ; preds = %_ZN10duckdb_fmt2v68internal7compareERKNS1_6bigintES4_.exit41
  %i.cn = load i32, ptr %i.j, align 8, !tbaa !97
  %i.co = sub i32 %i.cn, %i.ck
  %i.cp = load ptr, ptr %i.ci, align 8, !tbaa !93 ; 3 uses
  %i.cq = load ptr, ptr %i.cg, align 8, !tbaa !93 ; 4 uses
  %i.cr = sext i32 %i.co to i64                   ; 2 uses
  %xtraiter145 = and i64 %i.cl, 1
...
.epil.preheader:                                  ; preds = %.preheader.i.unr-lcssa, %.lr.ph.i
  ...
  %.01418.i.epil.init = phi i64 [ 0, %.lr.ph.i ], [ %i.dy, %.preheader.i.unr-lcssa ]
  %lcmp.mod149 = trunc i64 %i.cl to i1
...
.preheader.i:                                     ; preds = %.preheader.i.unr-lcssa, %.epil.preheader
  %.lcssa = phi i64 [ %i.dw, %.preheader.i.unr-lcssa ], [ %i.da, %.epil.preheader ]
...
bb.i:                                             ; preds = %bb.i, %.lr.ph24.i
  %i.dz = phi i32 [ %.promoted.i, %.lr.ph24.i ], [ %i.ec, %bb.i ]
  %.123.i = phi i64 [ 1, %.lr.ph24.i ], [ %i.ed, %bb.i ]
  %i.ea = zext i32 %i.dz to i64
  %i.eb = sub nsw i64 %i.ea, %.123.i              ; 3 uses
  %i.ec = trunc i64 %i.eb to i32                  ; 2 uses
  %i.ed = lshr i64 %i.eb, 63
  %.not11.i = icmp sgt i64 %i.eb, -1
...
.preheader.thread.i:                              ; preds = %._crit_edge.i, %.preheader.i, %_ZN10duckdb_fmt2v68internal7compareERKNS1_6bigintES4_.exit41
  %i.ee = trunc i64 %i.cj to i32
  %i.ef = load ptr, ptr %i.cg, align 8
  %smin.i.i = tail call i32 @llvm.smin.i32(i32 %i.ee, i32 1) ; 2 uses
  %i.eg = trunc i64 %i.cj to i32                  ; 2 uses
  %i.eh = icmp sgt i32 %i.eg, 1
  br i1 %i.eh, label %.lr.ph118, label %.critedge.i.i

.lr.ph118:                                        ; preds = %.preheader.thread.i
  %i.ei = and i64 %i.cj, 2147483647
  br label %bb.k

bb.j:                                             ; preds = %bb.k
  %i.ej = trunc nuw i64 %i.em to i32              ; 2 uses
  %i.ek = icmp sgt i32 %i.ej, 1
  br i1 %i.ek, label %bb.k, label %.critedge.i.i, !llvm.loop !1322

bb.k:                                             ; preds = %.lr.ph118, %bb.j
  %i.el = phi i32 [ %i.eg, %.lr.ph118 ], [ %i.ej, %bb.j ]
  %indvars.iv.i.i117 = phi i64 [ %i.ei, %.lr.ph118 ], [ %i.em, %bb.j ]
  %i.em = add nsw i64 %indvars.iv.i.i117, -1      ; 3 uses
  %i.en = getelementptr inbounds nuw [4 x i8], ptr %i.ef, i64 %i.em
  %i.eo = load i32, ptr %i.en, align 4, !tbaa !3
  %i.ep = icmp eq i32 %i.eo, 0
  br i1 %i.ep, label %bb.j, label %..critedge.i.i_crit_edge, !llvm.loop !1322
...
.critedge.i.i:                                    ; preds = %bb.j, %..critedge.i.i_crit_edge, %.preheader.thread.i
  %.0.in.lcssa.i.i = phi i32 [ %smin.i.i, %.preheader.thread.i ], [ %i.el, %..critedge.i.i_crit_edge ], [ %smin.i.i, %bb.j ] ; 4 uses
  %i.eq = sext i32 %.0.in.lcssa.i.i to i64        ; 6 uses
  %i.er = load i64, ptr %i.ch, align 8, !tbaa !96
  %i.es = icmp ult i64 %i.er, %i.eq
  br i1 %i.es, label %bb.l, label %_ZN10duckdb_fmt2v68internal6bigint16subtract_alignedERKS2_.exit

bb.l:                                             ; preds = %.critedge.i.i
  %i.et = load ptr, ptr %0, align 8, !tbaa !14
  %i.eu = load ptr, ptr %i.et, align 8
  tail call void %i.eu(ptr noundef nonnull align 8 dereferenceable(164) %0, i64 noundef %i.eq), !inline_history !1323
...
_ZN10duckdb_fmt2v68internal6bigint16subtract_alignedERKS2_.exit: ; preds = %.critedge.i.i, %bb.l
  store i64 %i.eq, ptr %i.a, align 8, !tbaa !100
  %i.ev = add nuw nsw i32 %.0, 1                  ; 4 uses
  %i.ew = load i32, ptr %i.d, align 8, !tbaa !97  ; 2 uses
  %i.ex = add nsw i32 %i.ew, %.0.in.lcssa.i.i     ; 2 uses
  %i.ey = load i64, ptr %i.g, align 8, !tbaa !100 ; 3 uses
  %i.ez = trunc i64 %i.ey to i32                  ; 2 uses
  %i.fa = load i32, ptr %i.j, align 8, !tbaa !97
  %i.fb = add nsw i32 %i.fa, %i.ez                ; 2 uses
  %.not.i28 = icmp eq i32 %i.ex, %i.fb
...
bb.m:                                             ; preds = %_ZN10duckdb_fmt2v68internal6bigint16subtract_alignedERKS2_.exit
  ...
  br i1 %i.fc, label %_ZN10duckdb_fmt2v68internal7compareERKNS1_6bigintES4_.exit41.backedge, label %_ZN10duckdb_fmt2v68internal7compareERKNS1_6bigintES4_.exit

bb.n:                                             ; preds = %_ZN10duckdb_fmt2v68internal6bigint16subtract_alignedERKS2_.exit
  %i.fd = sub nsw i32 %.0.in.lcssa.i.i, %i.ez
  %spec.store.select.i30 = tail call i32 @llvm.smax.i32(i32 %i.fd, i32 0) ; 2 uses
  %i.fe = load ptr, ptr %i.cg, align 8
  %i.ff = load ptr, ptr %i.ci, align 8
  %i.fg = zext nneg i32 %spec.store.select.i30 to i64 ; 2 uses
  %sext55.i32 = shl i64 %i.ey, 32
  %i.fh = ashr exact i64 %sext55.i32, 32          ; 2 uses
  %smin78 = tail call i64 @llvm.smin.i64(i64 %i.eq, i64 %i.fg)
...
bb.o:                                             ; preds = %.lr.ph126
  %.not35.not.i35 = icmp sgt i64 %indvars.iv.next.i37, %i.fg
  br i1 %.not35.not.i35, label %.lr.ph126, label %._crit_edge127, !llvm.loop !113

.lr.ph126:                                        ; preds = %bb.n, %bb.o
  %indvars.iv.i34124 = phi i64 [ %indvars.iv.next.i37, %bb.o ], [ %i.eq, %bb.n ]
  %indvars.iv45.i33123 = phi i64 [ %indvars.iv.next46.i38, %bb.o ], [ %i.fh, %bb.n ]
  %indvars.iv.next.i37 = add nsw i64 %indvars.iv.i34124, -1 ; 3 uses
  %indvars.iv.next46.i38 = add nsw i64 %indvars.iv45.i33123, -1 ; 3 uses
  %i.fi = getelementptr inbounds nuw [4 x i8], ptr %i.fe, i64 %indvars.iv.next.i37
  %i.fj = load i32, ptr %i.fi, align 4, !tbaa !3  ; 2 uses
  %i.fk = getelementptr inbounds nuw [4 x i8], ptr %i.ff, i64 %indvars.iv.next46.i38
  %i.fl = load i32, ptr %i.fk, align 4, !tbaa !3  ; 2 uses
  %.not37.i39 = icmp eq i32 %i.fj, %i.fl
  br i1 %.not37.i39, label %bb.o, label %.loopexit.i40, !llvm.loop !113

._crit_edge127:                                   ; preds = %bb.o, %bb.n
  %indvars.iv45.i33.lcssa = phi i64 [ %i.fh, %bb.n ], [ %indvars.iv.next46.i38, %bb.o ]
...
.loopexit.i40:                                    ; preds = %.lr.ph126
  ...
  br i1 %i.fm, label %_ZN10duckdb_fmt2v68internal7compareERKNS1_6bigintES4_.exit41.backedge, label %_ZN10duckdb_fmt2v68internal7compareERKNS1_6bigintES4_.exit
...
_ZN10duckdb_fmt2v68internal7compareERKNS1_6bigintES4_.exit: ; preds = %._crit_edge127, %.loopexit.i40, %bb.m, %._crit_edge116, %bb.b, %.loopexit.i
  %.022 = phi i32 [ 0, %bb.b ], [ 0, %.loopexit.i ], [ 0, %._crit_edge116 ], [ %i.ev, %bb.m ], [ %i.ev, %.loopexit.i40 ], [ %i.ev, %._crit_edge127 ]
  ret i32 %.022
}
