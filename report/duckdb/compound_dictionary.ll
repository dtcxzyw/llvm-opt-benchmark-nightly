...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  store i32 %.0178215.i, ptr %i.as, align 4, !tbaa !3
  %i.at = add i16 %i.am, 1
...
._crit_edge.i:                                    ; preds = %bb.g, %.preheader213.i
  ...
  store i32 %.0167.lcssa.i, ptr %i.bi, align 4, !tbaa !3
...
.new:                                             ; preds = %._crit_edge.i
  ...
  store i32 %.014.lcssa, ptr %i.by, align 4, !tbaa !18
  %i.bz = getelementptr inbounds nuw i8, ptr %i.bp, i64 20
  store i32 %.013.lcssa, ptr %i.bz, align 4, !tbaa !19
