...
bb.b:                                             ; preds = %._crit_edge
  ...
  %i.x = zext i32 %i.f to i64                     ; 6 uses
...
.preheader.preheader.i.unr-lcssa:                 ; preds = %bb.i
  %i.cj = zext nneg i32 %i.h to i64
  br label %.preheader.i

.preheader.i:                                     ; preds = %bb.n, %.preheader.preheader.i.unr-lcssa
  %indvars.iv244.i = phi i64 [ 0, %.preheader.preheader.i.unr-lcssa ], [ %indvars.iv.next245.i, %bb.n ] ; 6 uses
  %i.ck = getelementptr inbounds nuw [2 x i8], ptr %i.z, i64 %indvars.iv244.i
  %i.cl = load i16, ptr %i.ck, align 2, !tbaa !7
  %i.cm = zext i16 %i.cl to i32
  %i.cn = and i64 %indvars.iv244.i, %i.cj         ; 3 uses
  %i.co = getelementptr inbounds nuw [4 x i8], ptr %i.y, i64 %i.cn
  %i.cp = load i32, ptr %i.co, align 4, !tbaa !3
  %spec.select197.i = tail call i32 @llvm.umin.i32(i32 %i.cp, i32 %i.cm) ; 4 uses
  %i.cq = icmp eq i32 %spec.select197.i, 0
  br i1 %i.cq, label %bb.j, label %bb.k

bb.j:                                             ; preds = %.preheader.i
  %i.cr = getelementptr inbounds nuw [2 x i8], ptr %i.bs, i64 %indvars.iv244.i
  store i16 -1, ptr %i.cr, align 2, !tbaa !7
  br label %bb.n

bb.k:                                             ; preds = %.preheader.i
  %i.cs = getelementptr inbounds nuw [4 x i8], ptr %i.w, i64 %i.cn ; 2 uses
  %i.ct = load i32, ptr %i.cs, align 4, !tbaa !3  ; 3 uses
  %i.cu = zext i32 %i.ct to i64
  %i.cv = trunc i32 %i.ct to i16
  %i.cw = getelementptr inbounds nuw [2 x i8], ptr %i.bs, i64 %indvars.iv244.i
  store i16 %i.cv, ptr %i.cw, align 2, !tbaa !7
  %i.cx = getelementptr inbounds nuw [4 x i8], ptr %i.br, i64 %i.cn
  %i.cy = load i32, ptr %i.cx, align 4, !tbaa !3
  %i.cz = zext i32 %i.cy to i64
  %i.da = add nuw nsw i64 %i.cz, %i.cu            ; 2 uses
  %i.db = add i32 %i.ct, %spec.select197.i
  store i32 %i.db, ptr %i.cs, align 4, !tbaa !3
  %i.dc = getelementptr inbounds nuw [4 x i8], ptr %i.ab, i64 %indvars.iv244.i ; 2 uses
  %i.dd = zext nneg i32 %spec.select197.i to i64  ; 2 uses
  %xtraiter43 = and i64 %i.dd, 3                  ; 3 uses
  %i.de = icmp samesign ult i32 %spec.select197.i, 4
  br i1 %i.de, label %.epil.preheader42, label %.new41

.new41:                                           ; preds = %bb.k
  %unroll_iter48 = and i64 %i.dd, 65532
  br label %bb.l

bb.l:                                             ; preds = %bb.l, %.new41
  %.0233.i = phi i64 [ %i.da, %.new41 ], [ %i.dq, %bb.l ] ; 5 uses
  %.0164.in231.i = phi ptr [ %i.dc, %.new41 ], [ %i.du, %bb.l ]
  %niter49 = phi i64 [ 0, %.new41 ], [ %niter49.next.3, %bb.l ]
  %.0164.i = load i32, ptr %.0164.in231.i, align 4, !tbaa !3 ; 2 uses
  %i.df = getelementptr inbounds nuw [4 x i8], ptr %i.bt, i64 %.0233.i
  store i32 %.0164.i, ptr %i.df, align 4, !tbaa !3
  %i.dg = zext i32 %.0164.i to i64
  %i.dh = getelementptr inbounds nuw [4 x i8], ptr %i.ac, i64 %i.dg
  %.0164.i.1 = load i32, ptr %i.dh, align 4, !tbaa !3 ; 2 uses
  %i.di = getelementptr inbounds nuw [4 x i8], ptr %i.bt, i64 %.0233.i
  %i.dj = getelementptr inbounds nuw i8, ptr %i.di, i64 4
  store i32 %.0164.i.1, ptr %i.dj, align 4, !tbaa !3
  %i.dk = zext i32 %.0164.i.1 to i64
  %i.dl = getelementptr inbounds nuw [4 x i8], ptr %i.ac, i64 %i.dk
  %.0164.i.2 = load i32, ptr %i.dl, align 4, !tbaa !3 ; 2 uses
  %i.dm = getelementptr inbounds nuw [4 x i8], ptr %i.bt, i64 %.0233.i
  %i.dn = getelementptr inbounds nuw i8, ptr %i.dm, i64 8
  store i32 %.0164.i.2, ptr %i.dn, align 4, !tbaa !3
  %i.do = zext i32 %.0164.i.2 to i64
  %i.dp = getelementptr inbounds nuw [4 x i8], ptr %i.ac, i64 %i.do
  %.0164.i.3 = load i32, ptr %i.dp, align 4, !tbaa !3 ; 3 uses
  %i.dq = add nuw nsw i64 %.0233.i, 4             ; 3 uses
  %i.dr = getelementptr inbounds nuw [4 x i8], ptr %i.bt, i64 %.0233.i
  %i.ds = getelementptr inbounds nuw i8, ptr %i.dr, i64 12
  store i32 %.0164.i.3, ptr %i.ds, align 4, !tbaa !3
  %i.dt = zext i32 %.0164.i.3 to i64
  %i.du = getelementptr inbounds nuw [4 x i8], ptr %i.ac, i64 %i.dt ; 2 uses
...
.epil.preheader42:                                ; preds = %.unr-lcssa, %bb.k
  %.0233.i.epil.init = phi i64 [ %i.da, %bb.k ], [ %i.dq, %.unr-lcssa ]
  %.0164.in231.i.epil.init = phi ptr [ %i.dc, %bb.k ], [ %i.du, %.unr-lcssa ]
  %lcmp.mod47 = icmp ne i64 %xtraiter43, 0
  tail call void @llvm.assume(i1 %lcmp.mod47)
  br label %bb.m

bb.m:                                             ; preds = %bb.m, %.epil.preheader42
  %.0233.i.epil = phi i64 [ %.0233.i.epil.init, %.epil.preheader42 ], [ %i.dv, %bb.m ] ; 2 uses
  %.0164.in231.i.epil = phi ptr [ %.0164.in231.i.epil.init, %.epil.preheader42 ], [ %i.dy, %bb.m ]
  %epil.iter = phi i64 [ 0, %.epil.preheader42 ], [ %epil.iter.next, %bb.m ]
  %.0164.i.epil = load i32, ptr %.0164.in231.i.epil, align 4, !tbaa !3 ; 3 uses
  %i.dv = add nuw nsw i64 %.0233.i.epil, 1        ; 2 uses
  %i.dw = getelementptr inbounds nuw [4 x i8], ptr %i.bt, i64 %.0233.i.epil
  store i32 %.0164.i.epil, ptr %i.dw, align 4, !tbaa !3
  %i.dx = zext i32 %.0164.i.epil to i64
...
.epilog-lcssa:                                    ; preds = %bb.m, %.unr-lcssa
  ...
  %.lcssa = phi i64 [ %i.dq, %.unr-lcssa ], [ %i.dv, %bb.m ]
  %i.dz = getelementptr [4 x i8], ptr %i.bt, i64 %.lcssa
  %i.ea = getelementptr i8, ptr %i.dz, i64 -4
  %i.eb = or i32 %.0164.i.lcssa, -2147483648
...
bb.n:                                             ; preds = %.epilog-lcssa, %bb.j
  ...
  %exitcond248.not.i = icmp eq i64 %indvars.iv.next245.i, %i.aa
  br i1 %exitcond248.not.i, label %bb.o, label %.preheader.i, !llvm.loop !24
