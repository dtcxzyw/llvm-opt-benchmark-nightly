...
.lr.ph84:                                         ; preds = %.lr.ph84.preheader, %._crit_edge
  ...
  %i.ey = getelementptr inbounds nuw [8 x i8], ptr %i.es, i64 %.04482
...
begin_hunk_1_@_ZN7libfsst16buildSymbolTableERNS_8CountersESt6vectorIPKhSaIS4_EEPKmb:bb.a
  ...
  %i.gc = getelementptr inbounds nuw [8 x i8], ptr %i.gb, i64 %.06694.i
...
begin_hunk_4_@"_ZZN7libfsst16buildSymbolTableERNS_8CountersESt6vectorIPKhSaIS4_EEPKmbENK3$_2clEPNS_11SymbolTableES1_":bb.a
  ...
  %i.fi = getelementptr inbounds nuw [24 x i8], ptr %.sroa.07.1, i64 %.0911.i1718.i.i ; 3 uses
...
bb.y:                                             ; preds = %.lr.ph.i.i.i
  %i.fo = getelementptr inbounds [24 x i8], ptr %.sroa.07.1, i64 %.010.i.i.i
...
bb.a:
  ...
  %i.b = load ptr, ptr %0, align 8, !tbaa !118    ; 9 uses
