...
_ZNSt10unique_ptrISt6vectorImSaImEESt14default_deleteIS2_EED2Ev.exit: ; preds = %_ZNKSt14default_deleteISt6vectorImSaImEEEclEPS2_.exit.i.i.i.i.i, %bb.h
  %i.aq = tail call noundef ptr @_ZNK6duckdb10unique_ptrISt6vectorImSaImEESt14default_deleteIS3_ELb1EEptEv(ptr noundef nonnull align 8 dereferenceable(8) %5) ; 5 uses
...
bb.k:                                             ; preds = %_ZNSt10unique_ptrISt6vectorImSaImEESt14default_deleteIS2_EED2Ev.exit
  ...
  %i.av = load ptr, ptr %i.aq, align 8, !tbaa !93
...
_ZNSt12_Vector_baseImSaImEE11_M_allocateEm.exit.i: ; preds = %bb.k
  %i.bb = getelementptr inbounds nuw i8, ptr %i.aq, i64 8 ; 3 uses
  ...
  %6 = load ptr, ptr %i.aq, align 8, !tbaa !93    ; 4 uses
  %7 = load ptr, ptr %i.bb, align 8, !tbaa !97
  %8 = ptrtoint ptr %7 to i64
  %9 = ptrtoint ptr %6 to i64
  %10 = sub i64 %8, %9                            ; 2 uses
  %i.bh = icmp sgt i64 %10, 0
...
bb.l:                                             ; preds = %_ZNSt12_Vector_baseImSaImEE11_M_allocateEm.exit.i
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.bg, ptr align 8 %6, i64 %10, i1 false)
