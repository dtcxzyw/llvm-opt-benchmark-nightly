...
.lr.ph.us.preheader:                              ; preds = %_ZNK6duckdb10ByteBuffer9availableEm.exit.preheader
  ...
  br i1 %i.aa, label %.epil.preheader, label %.lr.ph.us.preheader.new
...
bb.k:                                             ; preds = %bb.k, %.epil.preheader
  ...
  %gep.us.epil = getelementptr inbounds nuw i8, ptr %1, i64 %i.ad
  store i8 %i.ac, ptr %gep.us.epil, align 1, !tbaa !123
...
._crit_edge.us:                                   ; preds = %bb.k, %._crit_edge.us.unr-lcssa
  ...
  %invariant.gep.us.1 = getelementptr inbounds nuw i8, ptr %1, i64 1 ; 5 uses
  %xtraiter55 = and i64 %wide.trip.count, 3       ; 3 uses
  %i.ak = icmp ult i32 %2, 4
  br i1 %i.ak, label %.epil.preheader54, label %._crit_edge.us.new

._crit_edge.us.new:                               ; preds = %._crit_edge.us
  %unroll_iter59 = and i64 %wide.trip.count, 4294967292
  br label %bb.l

bb.l:                                             ; preds = %bb.l, %._crit_edge.us.new
  %indvars.iv.1 = phi i64 [ 0, %._crit_edge.us.new ], [ %indvars.iv.next.1.3, %bb.l ] ; 6 uses
  %niter60 = phi i64 [ 0, %._crit_edge.us.new ], [ %niter60.next.3, %bb.l ]
  ...
  %gep.us.1 = getelementptr inbounds nuw i8, ptr %invariant.gep.us.1, i64 %i.an
  store i8 %i.am, ptr %gep.us.1, align 1, !tbaa !123
  ...
  %gep.us.1.1 = getelementptr inbounds nuw i8, ptr %invariant.gep.us.1, i64 %i.aq
  store i8 %i.ap, ptr %gep.us.1.1, align 1, !tbaa !123
  ...
  %gep.us.1.2 = getelementptr inbounds nuw i8, ptr %invariant.gep.us.1, i64 %i.at
  store i8 %i.as, ptr %gep.us.1.2, align 1, !tbaa !123
  ...
  %gep.us.1.3 = getelementptr inbounds nuw i8, ptr %invariant.gep.us.1, i64 %i.aw
  store i8 %i.av, ptr %gep.us.1.3, align 1, !tbaa !123
...
._crit_edge.us.1.unr-lcssa:                       ; preds = %bb.l
  ...
  br i1 %lcmp.mod57.not, label %._crit_edge.us.1, label %.epil.preheader54

.epil.preheader54:                                ; preds = %._crit_edge.us.1.unr-lcssa, %._crit_edge.us
  %indvars.iv.1.epil.init = phi i64 [ 0, %._crit_edge.us ], [ %indvars.iv.next.1.3, %._crit_edge.us.1.unr-lcssa ]
  %lcmp.mod58 = icmp ne i64 %xtraiter55, 0
  tail call void @llvm.assume(i1 %lcmp.mod58)
  br label %bb.m

bb.m:                                             ; preds = %bb.m, %.epil.preheader54
  %indvars.iv.1.epil = phi i64 [ %indvars.iv.1.epil.init, %.epil.preheader54 ], [ %indvars.iv.next.1.epil, %bb.m ] ; 3 uses
  %epil.iter56 = phi i64 [ 0, %.epil.preheader54 ], [ %epil.iter56.next, %bb.m ]
  ...
  %gep.us.1.epil = getelementptr inbounds nuw i8, ptr %invariant.gep.us.1, i64 %i.az
  store i8 %i.ay, ptr %gep.us.1.epil, align 1, !tbaa !123
  ...
  br i1 %epil.iter56.cmp.not, label %._crit_edge.us.1, label %bb.m, !llvm.loop !248

._crit_edge.us.1:                                 ; preds = %bb.m, %._crit_edge.us.1.unr-lcssa
  ...
  %invariant.gep.us.2 = getelementptr inbounds nuw i8, ptr %1, i64 2 ; 5 uses
  %xtraiter62 = and i64 %wide.trip.count, 3       ; 3 uses
  %i.bh = icmp ult i32 %2, 4
  br i1 %i.bh, label %.epil.preheader61, label %._crit_edge.us.1.new

._crit_edge.us.1.new:                             ; preds = %._crit_edge.us.1
  %unroll_iter66 = and i64 %wide.trip.count, 4294967292
  br label %bb.n

bb.n:                                             ; preds = %bb.n, %._crit_edge.us.1.new
  %indvars.iv.2 = phi i64 [ 0, %._crit_edge.us.1.new ], [ %indvars.iv.next.2.3, %bb.n ] ; 6 uses
  %niter67 = phi i64 [ 0, %._crit_edge.us.1.new ], [ %niter67.next.3, %bb.n ]
  ...
  %gep.us.2 = getelementptr inbounds nuw i8, ptr %invariant.gep.us.2, i64 %i.bk
  store i8 %i.bj, ptr %gep.us.2, align 1, !tbaa !123
  ...
  %gep.us.2.1 = getelementptr inbounds nuw i8, ptr %invariant.gep.us.2, i64 %i.bn
  store i8 %i.bm, ptr %gep.us.2.1, align 1, !tbaa !123
  ...
  %gep.us.2.2 = getelementptr inbounds nuw i8, ptr %invariant.gep.us.2, i64 %i.bq
  store i8 %i.bp, ptr %gep.us.2.2, align 1, !tbaa !123
  ...
  %gep.us.2.3 = getelementptr inbounds nuw i8, ptr %invariant.gep.us.2, i64 %i.bt
  store i8 %i.bs, ptr %gep.us.2.3, align 1, !tbaa !123
...
._crit_edge.us.2.unr-lcssa:                       ; preds = %bb.n
  ...
  br i1 %lcmp.mod64.not, label %._crit_edge.us.2, label %.epil.preheader61

.epil.preheader61:                                ; preds = %._crit_edge.us.2.unr-lcssa, %._crit_edge.us.1
  %indvars.iv.2.epil.init = phi i64 [ 0, %._crit_edge.us.1 ], [ %indvars.iv.next.2.3, %._crit_edge.us.2.unr-lcssa ]
  %lcmp.mod65 = icmp ne i64 %xtraiter62, 0
  tail call void @llvm.assume(i1 %lcmp.mod65)
  br label %bb.o

bb.o:                                             ; preds = %bb.o, %.epil.preheader61
  %indvars.iv.2.epil = phi i64 [ %indvars.iv.2.epil.init, %.epil.preheader61 ], [ %indvars.iv.next.2.epil, %bb.o ] ; 3 uses
  %epil.iter63 = phi i64 [ 0, %.epil.preheader61 ], [ %epil.iter63.next, %bb.o ]
  ...
  %gep.us.2.epil = getelementptr inbounds nuw i8, ptr %invariant.gep.us.2, i64 %i.bw
  store i8 %i.bv, ptr %gep.us.2.epil, align 1, !tbaa !123
  %indvars.iv.next.2.epil = add nuw nsw i64 %indvars.iv.2.epil, 1
  %epil.iter63.next = add i64 %epil.iter63, 1     ; 2 uses
  %epil.iter63.cmp.not = icmp eq i64 %epil.iter63.next, %xtraiter62
  br i1 %epil.iter63.cmp.not, label %._crit_edge.us.2, label %bb.o, !llvm.loop !249

._crit_edge.us.2:                                 ; preds = %bb.o, %._crit_edge.us.2.unr-lcssa
  ...
  %invariant.gep.us.3 = getelementptr inbounds nuw i8, ptr %1, i64 3 ; 5 uses
  %xtraiter69 = and i64 %wide.trip.count, 3       ; 3 uses
  %i.ce = icmp ult i32 %2, 4
  br i1 %i.ce, label %.epil.preheader68, label %._crit_edge.us.2.new

._crit_edge.us.2.new:                             ; preds = %._crit_edge.us.2
  %unroll_iter73 = and i64 %wide.trip.count, 4294967292
  br label %bb.p

bb.p:                                             ; preds = %bb.p, %._crit_edge.us.2.new
  %indvars.iv.3 = phi i64 [ 0, %._crit_edge.us.2.new ], [ %indvars.iv.next.3.3, %bb.p ] ; 6 uses
  %niter74 = phi i64 [ 0, %._crit_edge.us.2.new ], [ %niter74.next.3, %bb.p ]
  ...
  %gep.us.3 = getelementptr inbounds nuw i8, ptr %invariant.gep.us.3, i64 %i.ch
  store i8 %i.cg, ptr %gep.us.3, align 1, !tbaa !123
  ...
  %gep.us.3.1 = getelementptr inbounds nuw i8, ptr %invariant.gep.us.3, i64 %i.ck
  store i8 %i.cj, ptr %gep.us.3.1, align 1, !tbaa !123
  ...
  %gep.us.3.2 = getelementptr inbounds nuw i8, ptr %invariant.gep.us.3, i64 %i.cn
  store i8 %i.cm, ptr %gep.us.3.2, align 1, !tbaa !123
  ...
  %gep.us.3.3 = getelementptr inbounds nuw i8, ptr %invariant.gep.us.3, i64 %i.cq
  store i8 %i.cp, ptr %gep.us.3.3, align 1, !tbaa !123
...
._crit_edge.us.3.unr-lcssa:                       ; preds = %bb.p
  ...
  br i1 %lcmp.mod71.not, label %._crit_edge.us.3, label %.epil.preheader68

.epil.preheader68:                                ; preds = %._crit_edge.us.3.unr-lcssa, %._crit_edge.us.2
  %indvars.iv.3.epil.init = phi i64 [ 0, %._crit_edge.us.2 ], [ %indvars.iv.next.3.3, %._crit_edge.us.3.unr-lcssa ]
  %lcmp.mod72 = icmp ne i64 %xtraiter69, 0
  tail call void @llvm.assume(i1 %lcmp.mod72)
  br label %bb.q

bb.q:                                             ; preds = %bb.q, %.epil.preheader68
  %indvars.iv.3.epil = phi i64 [ %indvars.iv.3.epil.init, %.epil.preheader68 ], [ %indvars.iv.next.3.epil, %bb.q ] ; 3 uses
  %epil.iter70 = phi i64 [ 0, %.epil.preheader68 ], [ %epil.iter70.next, %bb.q ]
  ...
  %gep.us.3.epil = getelementptr inbounds nuw i8, ptr %invariant.gep.us.3, i64 %i.ct
  store i8 %i.cs, ptr %gep.us.3.epil, align 1, !tbaa !123
  %indvars.iv.next.3.epil = add nuw nsw i64 %indvars.iv.3.epil, 1
  %epil.iter70.next = add i64 %epil.iter70, 1     ; 2 uses
  %epil.iter70.cmp.not = icmp eq i64 %epil.iter70.next, %xtraiter69
  br i1 %epil.iter70.cmp.not, label %._crit_edge.us.3, label %bb.q, !llvm.loop !250
...
bb.m:                                             ; preds = %bb.m, %.epil.preheader54
  ...
  %epil.iter56.next = add i64 %epil.iter56, 1     ; 2 uses
  %epil.iter56.cmp.not = icmp eq i64 %epil.iter56.next, %xtraiter55
  br i1 %epil.iter56.cmp.not, label %._crit_edge.us.1, label %bb.m, !llvm.loop !253
...
bb.o:                                             ; preds = %bb.o, %.epil.preheader61
  ...
  %epil.iter63.next = add i64 %epil.iter63, 1     ; 2 uses
  %epil.iter63.cmp.not = icmp eq i64 %epil.iter63.next, %xtraiter62
  br i1 %epil.iter63.cmp.not, label %._crit_edge.us.2, label %bb.o, !llvm.loop !254
...
bb.q:                                             ; preds = %bb.q, %.epil.preheader68
  ...
  %epil.iter70.next = add i64 %epil.iter70, 1     ; 2 uses
  %epil.iter70.cmp.not = icmp eq i64 %epil.iter70.next, %xtraiter69
  br i1 %epil.iter70.cmp.not, label %._crit_edge.us.3, label %bb.q, !llvm.loop !255
...
._crit_edge.us.3:                                 ; preds = %bb.q, %._crit_edge.us.3.unr-lcssa
  ...
  %invariant.gep.us.4 = getelementptr inbounds nuw i8, ptr %1, i64 4 ; 5 uses
  %xtraiter76 = and i64 %wide.trip.count, 3       ; 3 uses
  %i.db = icmp ult i32 %2, 4
  br i1 %i.db, label %.epil.preheader75, label %._crit_edge.us.3.new

._crit_edge.us.3.new:                             ; preds = %._crit_edge.us.3
  %unroll_iter80 = and i64 %wide.trip.count, 4294967292
  br label %bb.r

bb.r:                                             ; preds = %bb.r, %._crit_edge.us.3.new
  %indvars.iv.4 = phi i64 [ 0, %._crit_edge.us.3.new ], [ %indvars.iv.next.4.3, %bb.r ] ; 6 uses
  %niter81 = phi i64 [ 0, %._crit_edge.us.3.new ], [ %niter81.next.3, %bb.r ]
  ...
  %gep.us.4 = getelementptr inbounds nuw i8, ptr %invariant.gep.us.4, i64 %i.de
  store i8 %i.dd, ptr %gep.us.4, align 1, !tbaa !123
  ...
  %gep.us.4.1 = getelementptr inbounds nuw i8, ptr %invariant.gep.us.4, i64 %i.dh
  store i8 %i.dg, ptr %gep.us.4.1, align 1, !tbaa !123
  ...
  %gep.us.4.2 = getelementptr inbounds nuw i8, ptr %invariant.gep.us.4, i64 %i.dk
  store i8 %i.dj, ptr %gep.us.4.2, align 1, !tbaa !123
  ...
  %gep.us.4.3 = getelementptr inbounds nuw i8, ptr %invariant.gep.us.4, i64 %i.dn
  store i8 %i.dm, ptr %gep.us.4.3, align 1, !tbaa !123
...
._crit_edge.us.4.unr-lcssa:                       ; preds = %bb.r
  ...
  br i1 %lcmp.mod78.not, label %._crit_edge.us.4, label %.epil.preheader75

.epil.preheader75:                                ; preds = %._crit_edge.us.4.unr-lcssa, %._crit_edge.us.3
  %indvars.iv.4.epil.init = phi i64 [ 0, %._crit_edge.us.3 ], [ %indvars.iv.next.4.3, %._crit_edge.us.4.unr-lcssa ]
  %lcmp.mod79 = icmp ne i64 %xtraiter76, 0
  tail call void @llvm.assume(i1 %lcmp.mod79)
  br label %bb.s

bb.s:                                             ; preds = %bb.s, %.epil.preheader75
  %indvars.iv.4.epil = phi i64 [ %indvars.iv.4.epil.init, %.epil.preheader75 ], [ %indvars.iv.next.4.epil, %bb.s ] ; 3 uses
  %epil.iter77 = phi i64 [ 0, %.epil.preheader75 ], [ %epil.iter77.next, %bb.s ]
  ...
  %gep.us.4.epil = getelementptr inbounds nuw i8, ptr %invariant.gep.us.4, i64 %i.dq
  store i8 %i.dp, ptr %gep.us.4.epil, align 1, !tbaa !123
  ...
  br i1 %epil.iter77.cmp.not, label %._crit_edge.us.4, label %bb.s, !llvm.loop !256

._crit_edge.us.4:                                 ; preds = %bb.s, %._crit_edge.us.4.unr-lcssa
  ...
  %invariant.gep.us.5 = getelementptr inbounds nuw i8, ptr %1, i64 5 ; 5 uses
  %xtraiter83 = and i64 %wide.trip.count, 3       ; 3 uses
  %i.dy = icmp ult i32 %2, 4
  br i1 %i.dy, label %.epil.preheader82, label %._crit_edge.us.4.new

._crit_edge.us.4.new:                             ; preds = %._crit_edge.us.4
  %unroll_iter87 = and i64 %wide.trip.count, 4294967292
  br label %bb.t

bb.t:                                             ; preds = %bb.t, %._crit_edge.us.4.new
  %indvars.iv.5 = phi i64 [ 0, %._crit_edge.us.4.new ], [ %indvars.iv.next.5.3, %bb.t ] ; 6 uses
  %niter88 = phi i64 [ 0, %._crit_edge.us.4.new ], [ %niter88.next.3, %bb.t ]
  ...
  %gep.us.5 = getelementptr inbounds nuw i8, ptr %invariant.gep.us.5, i64 %i.eb
  store i8 %i.ea, ptr %gep.us.5, align 1, !tbaa !123
  ...
  %gep.us.5.1 = getelementptr inbounds nuw i8, ptr %invariant.gep.us.5, i64 %i.ee
  store i8 %i.ed, ptr %gep.us.5.1, align 1, !tbaa !123
  ...
  %gep.us.5.2 = getelementptr inbounds nuw i8, ptr %invariant.gep.us.5, i64 %i.eh
  store i8 %i.eg, ptr %gep.us.5.2, align 1, !tbaa !123
  ...
  %gep.us.5.3 = getelementptr inbounds nuw i8, ptr %invariant.gep.us.5, i64 %i.ek
  store i8 %i.ej, ptr %gep.us.5.3, align 1, !tbaa !123
...
._crit_edge.us.5.unr-lcssa:                       ; preds = %bb.t
  ...
  br i1 %lcmp.mod85.not, label %._crit_edge.us.5, label %.epil.preheader82

.epil.preheader82:                                ; preds = %._crit_edge.us.5.unr-lcssa, %._crit_edge.us.4
  %indvars.iv.5.epil.init = phi i64 [ 0, %._crit_edge.us.4 ], [ %indvars.iv.next.5.3, %._crit_edge.us.5.unr-lcssa ]
  %lcmp.mod86 = icmp ne i64 %xtraiter83, 0
  tail call void @llvm.assume(i1 %lcmp.mod86)
  br label %bb.u

bb.u:                                             ; preds = %bb.u, %.epil.preheader82
  %indvars.iv.5.epil = phi i64 [ %indvars.iv.5.epil.init, %.epil.preheader82 ], [ %indvars.iv.next.5.epil, %bb.u ] ; 3 uses
  %epil.iter84 = phi i64 [ 0, %.epil.preheader82 ], [ %epil.iter84.next, %bb.u ]
  ...
  %gep.us.5.epil = getelementptr inbounds nuw i8, ptr %invariant.gep.us.5, i64 %i.en
  store i8 %i.em, ptr %gep.us.5.epil, align 1, !tbaa !123
  ...
  br i1 %epil.iter84.cmp.not, label %._crit_edge.us.5, label %bb.u, !llvm.loop !257

._crit_edge.us.5:                                 ; preds = %bb.u, %._crit_edge.us.5.unr-lcssa
  ...
  %invariant.gep.us.6 = getelementptr inbounds nuw i8, ptr %1, i64 6 ; 5 uses
  %xtraiter90 = and i64 %wide.trip.count, 3       ; 3 uses
  %i.ev = icmp ult i32 %2, 4
  br i1 %i.ev, label %.epil.preheader89, label %._crit_edge.us.5.new

._crit_edge.us.5.new:                             ; preds = %._crit_edge.us.5
  %unroll_iter94 = and i64 %wide.trip.count, 4294967292
  br label %bb.v

bb.v:                                             ; preds = %bb.v, %._crit_edge.us.5.new
  %indvars.iv.6 = phi i64 [ 0, %._crit_edge.us.5.new ], [ %indvars.iv.next.6.3, %bb.v ] ; 6 uses
  %niter95 = phi i64 [ 0, %._crit_edge.us.5.new ], [ %niter95.next.3, %bb.v ]
  ...
  %gep.us.6 = getelementptr inbounds nuw i8, ptr %invariant.gep.us.6, i64 %i.ey
  store i8 %i.ex, ptr %gep.us.6, align 1, !tbaa !123
  ...
  %gep.us.6.1 = getelementptr inbounds nuw i8, ptr %invariant.gep.us.6, i64 %i.fb
  store i8 %i.fa, ptr %gep.us.6.1, align 1, !tbaa !123
  ...
  %gep.us.6.2 = getelementptr inbounds nuw i8, ptr %invariant.gep.us.6, i64 %i.fe
  store i8 %i.fd, ptr %gep.us.6.2, align 1, !tbaa !123
  ...
  %gep.us.6.3 = getelementptr inbounds nuw i8, ptr %invariant.gep.us.6, i64 %i.fh
  store i8 %i.fg, ptr %gep.us.6.3, align 1, !tbaa !123
...
._crit_edge.us.6.unr-lcssa:                       ; preds = %bb.v
  ...
  br i1 %lcmp.mod92.not, label %._crit_edge.us.6, label %.epil.preheader89

.epil.preheader89:                                ; preds = %._crit_edge.us.6.unr-lcssa, %._crit_edge.us.5
  %indvars.iv.6.epil.init = phi i64 [ 0, %._crit_edge.us.5 ], [ %indvars.iv.next.6.3, %._crit_edge.us.6.unr-lcssa ]
  %lcmp.mod93 = icmp ne i64 %xtraiter90, 0
  tail call void @llvm.assume(i1 %lcmp.mod93)
  br label %bb.w

bb.w:                                             ; preds = %bb.w, %.epil.preheader89
  %indvars.iv.6.epil = phi i64 [ %indvars.iv.6.epil.init, %.epil.preheader89 ], [ %indvars.iv.next.6.epil, %bb.w ] ; 3 uses
  %epil.iter91 = phi i64 [ 0, %.epil.preheader89 ], [ %epil.iter91.next, %bb.w ]
  ...
  %gep.us.6.epil = getelementptr inbounds nuw i8, ptr %invariant.gep.us.6, i64 %i.fk
  store i8 %i.fj, ptr %gep.us.6.epil, align 1, !tbaa !123
  ...
  br i1 %epil.iter91.cmp.not, label %._crit_edge.us.6, label %bb.w, !llvm.loop !258

._crit_edge.us.6:                                 ; preds = %bb.w, %._crit_edge.us.6.unr-lcssa
  ...
  %invariant.gep.us.7 = getelementptr inbounds nuw i8, ptr %1, i64 7 ; 5 uses
  %xtraiter97 = and i64 %wide.trip.count, 3       ; 3 uses
  %i.fs = icmp ult i32 %2, 4
  br i1 %i.fs, label %.epil.preheader96, label %._crit_edge.us.6.new

._crit_edge.us.6.new:                             ; preds = %._crit_edge.us.6
  %unroll_iter101 = and i64 %wide.trip.count, 4294967292
  br label %bb.x

bb.x:                                             ; preds = %bb.x, %._crit_edge.us.6.new
  %indvars.iv.7 = phi i64 [ 0, %._crit_edge.us.6.new ], [ %indvars.iv.next.7.3, %bb.x ] ; 6 uses
  %niter102 = phi i64 [ 0, %._crit_edge.us.6.new ], [ %niter102.next.3, %bb.x ]
  ...
  %gep.us.7 = getelementptr inbounds nuw i8, ptr %invariant.gep.us.7, i64 %i.fv
  store i8 %i.fu, ptr %gep.us.7, align 1, !tbaa !123
  ...
  %gep.us.7.1 = getelementptr inbounds nuw i8, ptr %invariant.gep.us.7, i64 %i.fy
  store i8 %i.fx, ptr %gep.us.7.1, align 1, !tbaa !123
  ...
  %gep.us.7.2 = getelementptr inbounds nuw i8, ptr %invariant.gep.us.7, i64 %i.gb
  store i8 %i.ga, ptr %gep.us.7.2, align 1, !tbaa !123
  ...
  %gep.us.7.3 = getelementptr inbounds nuw i8, ptr %invariant.gep.us.7, i64 %i.ge
  store i8 %i.gd, ptr %gep.us.7.3, align 1, !tbaa !123
...
._crit_edge.us.7.unr-lcssa:                       ; preds = %bb.x
  ...
  br i1 %lcmp.mod99.not, label %._crit_edge.us.7, label %.epil.preheader96

.epil.preheader96:                                ; preds = %._crit_edge.us.7.unr-lcssa, %._crit_edge.us.6
  %indvars.iv.7.epil.init = phi i64 [ 0, %._crit_edge.us.6 ], [ %indvars.iv.next.7.3, %._crit_edge.us.7.unr-lcssa ]
  %lcmp.mod100 = icmp ne i64 %xtraiter97, 0
  tail call void @llvm.assume(i1 %lcmp.mod100)
  br label %bb.y

bb.y:                                             ; preds = %bb.y, %.epil.preheader96
  %indvars.iv.7.epil = phi i64 [ %indvars.iv.7.epil.init, %.epil.preheader96 ], [ %indvars.iv.next.7.epil, %bb.y ] ; 3 uses
  %epil.iter98 = phi i64 [ 0, %.epil.preheader96 ], [ %epil.iter98.next, %bb.y ]
  ...
  %gep.us.7.epil = getelementptr inbounds nuw i8, ptr %invariant.gep.us.7, i64 %i.gh
  store i8 %i.gg, ptr %gep.us.7.epil, align 1, !tbaa !123
  ...
  br i1 %epil.iter98.cmp.not, label %._crit_edge.us.7, label %bb.y, !llvm.loop !259
