...
.loopexit.i.i:                                    ; preds = %.loopexit.i.i.loopexit.unr-lcssa, %.lr.ph.i.i.epil, %bb.e
  %i.ap = phi ptr [ %i.m, %bb.e ], [ %storemerge.i.i.3, %.loopexit.i.i.loopexit.unr-lcssa ], [ %storemerge.i.i.epil, %.lr.ph.i.i.epil ] ; 4 uses
  %i.aq = phi i64 [ %i.o, %bb.e ], [ %i.ak, %.loopexit.i.i.loopexit.unr-lcssa ], [ %i.ao, %.lr.ph.i.i.epil ] ; 3 uses
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.ba = getelementptr i8, ptr %i.ap, i64 %i.aq  ; 2 uses
