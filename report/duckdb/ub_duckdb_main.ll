...
begin_hunk_4
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %6, ptr noundef nonnull align 8 dereferenceable(32) %9, i64 16, i1 false), !tbaa.struct !1168
...
_ZNSt8functionIFN6duckdb10unique_ptrINS0_18ProgressBarDisplayESt14default_deleteIS2_ELb1EEEvEEC2EOS7_.exit.i: ; preds = %bb.k, %bb.j
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.0.i.i.i, ptr noundef nonnull align 8 dereferenceable(32) %6, i64 16, i1 false), !tbaa.struct !1168
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %6, ptr noundef nonnull align 8 dereferenceable(32) %8, i64 16, i1 false), !tbaa.struct !1168
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %8, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.0.i.i.i, i64 16, i1 false), !tbaa.struct !1168
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.0.i.i.i)
  %i.aw = getelementptr inbounds nuw i8, ptr %6, i64 16
  %i.ax = getelementptr inbounds nuw i8, ptr %8, i64 16 ; 2 uses
  %i.ay = load ptr, ptr %i.ax, align 8, !tbaa !234 ; 3 uses
  store ptr %i.ay, ptr %i.aw, align 8, !tbaa !234
  store ptr %i.av, ptr %i.ax, align 8, !tbaa !234
...
bb.y:                                             ; preds = %bb.x
  ...
  %i.ce = load ptr, ptr %i.cd, align 8, !tbaa !275 ; 2 uses
...
bb.af:                                            ; preds = %bb.ae, %bb.ad, %.body
  ...
  %i.cm = load ptr, ptr %i.cl, align 8, !tbaa !275 ; 2 uses
...
begin_hunk_7
  ...
  store ptr @_ZN6duckdb23PhysicalResultCollector18GetResultCollectorERNS_13ClientContextERNS_21PreparedStatementDataE, ptr %11, align 8, !tbaa !234
  ...
  store ptr @_ZNSt17_Function_handlerIFRN6duckdb16PhysicalOperatorERNS0_13ClientContextERNS0_21PreparedStatementDataEEPS7_E10_M_managerERSt9_Any_dataRKSA_St18_Manager_operation, ptr %i.cx, align 8, !tbaa !275
...
bb.al:                                            ; preds = %bb.ak
  %i.df = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.dg = load ptr, ptr %i.dd, align 8, !tbaa !275 ; 2 uses
...
_ZNSt8functionIFRN6duckdb16PhysicalOperatorERNS0_13ClientContextERNS0_21PreparedStatementDataEEEC2ERKS8_.exit.i: ; preds = %bb.ak
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.0.i.i.i49, ptr noundef nonnull align 8 dereferenceable(32) %5, i64 16, i1 false), !tbaa.struct !1168
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %5, ptr noundef nonnull align 8 dereferenceable(32) %11, i64 16, i1 false), !tbaa.struct !1168
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %11, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.0.i.i.i49, i64 16, i1 false), !tbaa.struct !1168
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.0.i.i.i49)
  %i.dk = load <2 x ptr>, ptr %i.cx, align 8, !tbaa !234
  %i.dl = load ptr, ptr %i.cx, align 8, !tbaa !234 ; 2 uses
  store <2 x ptr> %i.dk, ptr %i.dd, align 8, !tbaa !234
  %i.dm = load <2 x ptr>, ptr %i.da, align 8, !tbaa !234
  %i.dn = load ptr, ptr %i.da, align 8, !tbaa !275
  store <2 x ptr> %i.dm, ptr %i.cx, align 8, !tbaa !234
...
._ZNSt8functionIFRN6duckdb16PhysicalOperatorERNS0_13ClientContextERNS0_21PreparedStatementDataEEEaSERKS8_.exit_crit_edge: ; preds = %bb.ao
  %.pre71.pre = load ptr, ptr %i.cx, align 8, !tbaa !275
  br label %bb.aq
...
_ZNSt6vectorIN6duckdb11LogicalTypeESaIS1_EED2Ev.exit: ; preds = %_ZSt8_DestroyIPN6duckdb11LogicalTypeES1_EvT_S3_RSaIT0_E.exit.i, %bb.bn
  ...
  %i.fw = load ptr, ptr %i.cx, align 8, !tbaa !275 ; 2 uses
...
.body53:                                          ; preds = %bb.am, %bb.al, %bb.bq, %bb.bw
  ...
  %i.gj = load ptr, ptr %i.cx, align 8, !tbaa !275 ; 2 uses
