...
bb.a:
  ...
  %8 = alloca %"class.std::unique_ptr.470", align 8 ; 6 uses
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !68   ; 3 uses
  %i.c = load ptr, ptr %0, align 8, !tbaa !65     ; 10 uses
...
_ZNKSt6vectorISt6threadSaIS0_EE12_M_check_lenEmPKc.exit: ; preds = %bb.a
  ...
  store i64 0, ptr %i.q, align 8, !tbaa !330
  %i.r = invoke noalias noundef nonnull dereferenceable(48) ptr @_Znwm(i64 noundef 48) #26
          to label %.noexc unwind label %bb.g     ; 7 uses

.noexc:                                           ; preds = %_ZNKSt6vectorISt6threadSaIS0_EE12_M_check_lenEmPKc.exit
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVNSt6thread11_State_implINS_8_InvokerISt5tupleIJPFvPN6duckdb10FileHandleEmmPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEES5_mmSC_EEEEEE, i64 16), ptr %i.r, align 8, !tbaa !81
  %i.s = getelementptr inbounds nuw i8, ptr %i.r, i64 8
  %i.t = load ptr, ptr %6, align 8, !tbaa !15
  store ptr %i.t, ptr %i.s, align 8, !tbaa !332
  %i.u = getelementptr inbounds nuw i8, ptr %i.r, i64 16
  %i.v = load i64, ptr %5, align 8, !tbaa !19
  store i64 %i.v, ptr %i.u, align 8, !tbaa !334
  %i.w = getelementptr inbounds nuw i8, ptr %i.r, i64 24
  %i.x = load i64, ptr %4, align 8, !tbaa !19
  store i64 %i.x, ptr %i.w, align 8, !tbaa !336
  %i.y = getelementptr inbounds nuw i8, ptr %i.r, i64 32
  %i.z = load ptr, ptr %3, align 8, !tbaa !63
  store ptr %i.z, ptr %i.y, align 8, !tbaa !338
  %i.aa = getelementptr inbounds nuw i8, ptr %i.r, i64 40
  %i.ab = load ptr, ptr %2, align 8, !tbaa !62
  store ptr %i.ab, ptr %i.aa, align 8, !tbaa !340
  store ptr %i.r, ptr %8, align 8, !tbaa !342
  invoke void @_ZNSt6thread15_M_start_threadESt10unique_ptrINS_6_StateESt14default_deleteIS1_EEPFvvE(ptr noundef nonnull align 8 dereferenceable(8) %i.q, ptr noundef nonnull %8, ptr noundef nonnull @_ZNSt6thread24_M_thread_deps_never_runEv)
          to label %bb.c unwind label %bb.d

bb.c:                                             ; preds = %.noexc
  %i.ac = load ptr, ptr %8, align 8, !tbaa !342   ; 3 uses
...
_ZNKSt14default_deleteINSt6thread6_StateEEclEPS1_.exit.i.i: ; preds = %bb.c
  ...
  call void %i.af(ptr noundef nonnull align 8 dead_on_return(8) dereferenceable(8) %i.ac) #22, !inline_history !344
  br label %bb.e

bb.d:                                             ; preds = %.noexc
  %i.ag = landingpad { ptr, i32 }
          catch ptr null                          ; 2 uses
  %i.ah = load ptr, ptr %8, align 8, !tbaa !342   ; 3 uses
  %.not.i9.i = icmp eq ptr %i.ah, null
...
_ZNKSt14default_deleteINSt6thread6_StateEEclEPS1_.exit.i10.i: ; preds = %bb.d
  ...
  call void %i.ak(ptr noundef nonnull align 8 dead_on_return(8) dereferenceable(8) %i.ah) #22, !inline_history !344
  br label %bb.i
...
vector.memcheck:                                  ; preds = %.lr.ph.i.i.i.i.preheader
  ...
  %scevgep = getelementptr i8, ptr %i.p, i64 %i.as
  %scevgep56 = getelementptr i8, ptr %i.c, i64 %i.as
  %bound0 = icmp ult ptr %i.p, %scevgep56
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %i.au = getelementptr i8, ptr %i.p, i64 %i.at   ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep = getelementptr i8, ptr %i.p, i64 %i.aw ; 2 uses
  %next.gep57 = getelementptr i8, ptr %i.c, i64 %i.aw ; 3 uses
...
.lr.ph.i.i.i.i.preheader83:                       ; preds = %vector.memcheck, %.lr.ph.i.i.i.i.preheader, %middle.block
  %.012.i.i.i.i.ph = phi ptr [ %i.p, %vector.memcheck ], [ %i.p, %.lr.ph.i.i.i.i.preheader ], [ %i.au, %middle.block ]
  %.0911.i.i.i.i.ph = phi ptr [ %i.c, %vector.memcheck ], [ %i.c, %.lr.ph.i.i.i.i.preheader ], [ %i.av, %middle.block ]
...
_ZNSt6vectorISt6threadSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit: ; preds = %.lr.ph.i.i.i.i, %middle.block, %bb.e
  %.0.lcssa.i.i.i.i = phi ptr [ %i.p, %bb.e ], [ %i.au, %middle.block ], [ %i.bc, %.lr.ph.i.i.i.i ] ; 2 uses
...
.lr.ph.i.i.i.i31.preheader:                       ; preds = %_ZNSt6vectorISt6threadSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit
  %i.be = add i64 %i.d, -8
  %i.bf = sub i64 %i.be, %7                       ; 2 uses
  %i.bg = lshr i64 %i.bf, 3
  %i.bh = add nuw nsw i64 %i.bg, 1                ; 2 uses
  %min.iters.check67 = icmp ult i64 %i.bf, 184
...
vector.memcheck60:                                ; preds = %.lr.ph.i.i.i.i31.preheader
  ...
  %i.bl = getelementptr i8, ptr %.0.lcssa.i.i.i.i, i64 %i.bk
  %scevgep61 = getelementptr i8, ptr %i.bl, i64 16
  %i.bm = getelementptr i8, ptr %1, i64 %i.bk
  %scevgep62 = getelementptr i8, ptr %i.bm, i64 8
...
vector.ph68:                                      ; preds = %vector.memcheck60
  %n.vec70 = and i64 %i.bh, 4611686018427387900   ; 3 uses
  %i.bn = shl i64 %n.vec70, 3                     ; 2 uses
...
vector.body71:                                    ; preds = %vector.body71, %vector.ph68
  ...
  %i.bq = shl i64 %index72, 3                     ; 2 uses
  %next.gep73 = getelementptr i8, ptr %i.bd, i64 %i.bq ; 2 uses
  %next.gep74 = getelementptr i8, ptr %1, i64 %i.bq ; 3 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !359)
  call void @llvm.experimental.noalias.scope.decl(metadata !362)
  %i.br = getelementptr i8, ptr %next.gep74, i64 16 ; 2 uses
  %wide.load75 = load <2 x i64>, ptr %next.gep74, align 8, !tbaa !19, !alias.scope !364, !noalias !359
  %wide.load76 = load <2 x i64>, ptr %i.br, align 8, !tbaa !19, !alias.scope !364, !noalias !359
  ...
  store <2 x i64> %wide.load76, ptr %i.bs, align 8, !tbaa !19, !alias.scope !367, !noalias !364
  store <2 x i64> zeroinitializer, ptr %next.gep74, align 8, !tbaa !19, !alias.scope !364, !noalias !359
  store <2 x i64> zeroinitializer, ptr %i.br, align 8, !tbaa !19, !alias.scope !364, !noalias !359
  %index.next77 = add nuw i64 %index72, 4         ; 2 uses
  %i.bt = icmp eq i64 %index.next77, %n.vec70
  br i1 %i.bt, label %middle.block78, label %vector.body71, !llvm.loop !369

middle.block78:                                   ; preds = %vector.body71
  %cmp.n79 = icmp eq i64 %i.bh, %n.vec70
...
.lr.ph.i.i.i.i31.preheader82:                     ; preds = %vector.memcheck60, %.lr.ph.i.i.i.i31.preheader, %middle.block78
  %.012.i.i.i.i32.ph = phi ptr [ %i.bd, %vector.memcheck60 ], [ %i.bd, %.lr.ph.i.i.i.i31.preheader ], [ %i.bo, %middle.block78 ]
  %.0911.i.i.i.i33.ph = phi ptr [ %1, %vector.memcheck60 ], [ %1, %.lr.ph.i.i.i.i31.preheader ], [ %i.bp, %middle.block78 ]
  br label %.lr.ph.i.i.i.i31

.lr.ph.i.i.i.i31:                                 ; preds = %.lr.ph.i.i.i.i31.preheader82, %.lr.ph.i.i.i.i31
  %.012.i.i.i.i32 = phi ptr [ %i.bw, %.lr.ph.i.i.i.i31 ], [ %.012.i.i.i.i32.ph, %.lr.ph.i.i.i.i31.preheader82 ] ; 2 uses
  %.0911.i.i.i.i33 = phi ptr [ %i.bv, %.lr.ph.i.i.i.i31 ], [ %.0911.i.i.i.i33.ph, %.lr.ph.i.i.i.i31.preheader82 ] ; 3 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !359)
  call void @llvm.experimental.noalias.scope.decl(metadata !362)
  %i.bu = load i64, ptr %.0911.i.i.i.i33, align 8, !tbaa !19, !alias.scope !362, !noalias !359
  store i64 %i.bu, ptr %.012.i.i.i.i32, align 8, !tbaa !19, !alias.scope !359, !noalias !362
  store i64 0, ptr %.0911.i.i.i.i33, align 8, !tbaa !19, !alias.scope !362, !noalias !359
  %i.bv = getelementptr inbounds nuw i8, ptr %.0911.i.i.i.i33, i64 8 ; 2 uses
  %i.bw = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i32, i64 8 ; 2 uses
  %.not.i.i.i.i34 = icmp eq ptr %i.bv, %i.b
...
_ZNSt6vectorISt6threadSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit36: ; preds = %.lr.ph.i.i.i.i31, %middle.block78, %_ZNSt6vectorISt6threadSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit
  %.0.lcssa.i.i.i.i35 = phi ptr [ %i.bd, %_ZNSt6vectorISt6threadSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit ], [ %i.bo, %middle.block78 ], [ %i.bw, %.lr.ph.i.i.i.i31 ]
...
bb.f:                                             ; preds = %_ZNSt6vectorISt6threadSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit36
  call void @_ZdlPv(ptr noundef nonnull %i.c) #24
...
_ZNSt12_Vector_baseISt6threadSaIS0_EE13_M_deallocateEPS0_m.exit: ; preds = %_ZNSt6vectorISt6threadSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit36, %bb.f
  ...
  store ptr %i.p, ptr %0, align 8, !tbaa !65
  store ptr %.0.lcssa.i.i.i.i35, ptr %i.a, align 8, !tbaa !68
  %i.by = getelementptr inbounds nuw [8 x i8], ptr %i.p, i64 %i.l
  store ptr %i.by, ptr %i.bx, align 8, !tbaa !69
  ret void
...
bb.i:                                             ; preds = %bb.d, %_ZNKSt14default_deleteINSt6thread6_StateEEclEPS1_.exit.i10.i, %bb.g
  %eh.lpad-body = phi { ptr, i32 } [ %i.bz, %bb.g ], [ %i.ag, %_ZNKSt14default_deleteINSt6thread6_StateEEclEPS1_.exit.i10.i ], [ %i.ag, %bb.d ]
  %i.cb = extractvalue { ptr, i32 } %eh.lpad-body, 0
  %i.cc = call ptr @__cxa_begin_catch(ptr %i.cb) #22 ; 0 uses
  call void @_ZdlPv(ptr noundef nonnull %i.p) #24
...
.noexc:                                           ; preds = %_ZNKSt6vectorISt6threadSaIS0_EE12_M_check_lenEmPKc.exit
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVNSt6thread11_State_implINS_8_InvokerISt5tupleIJPFvPKcmmPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEES4_mmSB_EEEEEE, i64 16), ptr %i.r, align 8, !tbaa !81
  %i.s = getelementptr inbounds nuw i8, ptr %i.r, i64 8
  %i.t = load ptr, ptr %6, align 8, !tbaa !15
  store ptr %i.t, ptr %i.s, align 8, !tbaa !332
  %i.u = getelementptr inbounds nuw i8, ptr %i.r, i64 16
  ...
  store i64 %i.x, ptr %i.w, align 8, !tbaa !336
  %i.y = getelementptr inbounds nuw i8, ptr %i.r, i64 32
  %i.z = load ptr, ptr %3, align 8, !tbaa !79
  store ptr %i.z, ptr %i.y, align 8, !tbaa !372
  %i.aa = getelementptr inbounds nuw i8, ptr %i.r, i64 40
  %i.ab = load ptr, ptr %2, align 8, !tbaa !62
  store ptr %i.ab, ptr %i.aa, align 8, !tbaa !374
  store ptr %i.r, ptr %8, align 8, !tbaa !342
  invoke void @_ZNSt6thread15_M_start_threadESt10unique_ptrINS_6_StateESt14default_deleteIS1_EEPFvvE(ptr noundef nonnull align 8 dereferenceable(8) %i.q, ptr noundef nonnull %8, ptr noundef nonnull @_ZNSt6thread24_M_thread_deps_never_runEv)
          to label %bb.c unwind label %bb.d
...
_ZNKSt14default_deleteINSt6thread6_StateEEclEPS1_.exit.i.i: ; preds = %bb.c
  ...
  %i.ae = getelementptr inbounds nuw i8, ptr %i.ad, i64 8
  %i.af = load ptr, ptr %i.ae, align 8
  call void %i.af(ptr noundef nonnull align 8 dead_on_return(8) dereferenceable(8) %i.ac) #22, !inline_history !376
  br label %bb.e
...
_ZNKSt14default_deleteINSt6thread6_StateEEclEPS1_.exit.i10.i: ; preds = %bb.d
  ...
  %i.aj = getelementptr inbounds nuw i8, ptr %i.ai, i64 8
  %i.ak = load ptr, ptr %i.aj, align 8
  call void %i.ak(ptr noundef nonnull align 8 dead_on_return(8) dereferenceable(8) %i.ah) #22, !inline_history !376
  br label %bb.i
...
vector.body71:                                    ; preds = %vector.body71, %vector.ph68
  ...
  %wide.load76 = load <2 x i64>, ptr %i.br, align 8, !tbaa !19, !alias.scope !394, !noalias !389
  %i.bs = getelementptr i8, ptr %next.gep73, i64 16
  store <2 x i64> %wide.load75, ptr %next.gep73, align 8, !tbaa !19, !alias.scope !397, !noalias !394
  store <2 x i64> %wide.load76, ptr %i.bs, align 8, !tbaa !19, !alias.scope !397, !noalias !394
  store <2 x i64> zeroinitializer, ptr %next.gep74, align 8, !tbaa !19, !alias.scope !394, !noalias !389
  store <2 x i64> zeroinitializer, ptr %i.br, align 8, !tbaa !19, !alias.scope !394, !noalias !389
  %index.next77 = add nuw i64 %index72, 4         ; 2 uses
  %i.bt = icmp eq i64 %index.next77, %n.vec70
  br i1 %i.bt, label %middle.block78, label %vector.body71, !llvm.loop !399
...
.lr.ph.i.i.i.i31:                                 ; preds = %.lr.ph.i.i.i.i31.preheader82, %.lr.ph.i.i.i.i31
  ...
  call void @llvm.experimental.noalias.scope.decl(metadata !389)
  call void @llvm.experimental.noalias.scope.decl(metadata !392)
  %i.bu = load i64, ptr %.0911.i.i.i.i33, align 8, !tbaa !19, !alias.scope !392, !noalias !389
  store i64 %i.bu, ptr %.012.i.i.i.i32, align 8, !tbaa !19, !alias.scope !389, !noalias !392
