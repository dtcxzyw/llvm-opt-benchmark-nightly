...
_ZNSt6vectorImSaImEED2Ev.exit:                    ; preds = %bb.f, %_ZSt8_DestroyIPN6duckdb11LogicalTypeES1_EvT_S3_RSaIT0_E.exit.i
  call void @llvm.lifetime.end.p0(ptr nonnull %10) #30
  %13 = load ptr, ptr %9, align 8, !tbaa !186     ; 2 uses
...
begin_hunk_1_@_ZN6duckdb16PhysicalHashJoinC2ERNS_12PhysicalPlanERNS_15LogicalOperatorERNS_16PhysicalOperatorES6_NS_6vectorINS_13JoinConditionELb1ESaIS8_EEENS_8JoinTypeEm:bb.a
          cleanup
  call void @_ZNSt10unique_ptrIN6duckdb22JoinFilterPushdownInfoESt14default_deleteIS1_EED2Ev(ptr noundef nonnull align 8 dereferenceable(8) %12) #30
  call void @_ZNSt6vectorIN6duckdb11LogicalTypeESaIS1_EED2Ev(ptr noundef nonnull align 8 dereferenceable(24) %11) #30
  call void @llvm.lifetime.end.p0(ptr nonnull %10) #30
  %14 = load ptr, ptr %9, align 8, !tbaa !186     ; 2 uses
...
_ZNSt12_Vector_baseIN6duckdb10shared_ptrINS0_4TaskELb1EEESaIS3_EE13_M_deallocateEPS3_m.exit.i: ; preds = %_ZNSt12_Vector_baseIN6duckdb10shared_ptrINS0_4TaskELb1EEESaIS3_EE11_M_allocateEm.exit.i
  ...
  %.pre = load ptr, ptr %i.bv, align 8, !tbaa !1445
  %.pre103 = load ptr, ptr %i.bw, align 8, !tbaa !1445
...
_ZNSt6vectorIN6duckdb10shared_ptrINS0_4TaskELb1EEESaIS3_EE7reserveEm.exit: ; preds = %_ZNSt12_Vector_baseIN6duckdb10shared_ptrINS0_4TaskELb1EEESaIS3_EE13_M_deallocateEPS3_m.exit.i, %bb.d
  ...
  %i.ck = phi ptr [ %.pre103, %_ZNSt12_Vector_baseIN6duckdb10shared_ptrINS0_4TaskELb1EEESaIS3_EE13_M_deallocateEPS3_m.exit.i ], [ %i.bx, %bb.d ] ; 2 uses
  %i.cl = phi ptr [ %.pre, %_ZNSt12_Vector_baseIN6duckdb10shared_ptrINS0_4TaskELb1EEESaIS3_EE13_M_deallocateEPS3_m.exit.i ], [ %i.by, %bb.d ] ; 2 uses
