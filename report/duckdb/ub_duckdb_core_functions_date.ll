...
_ZNSt8functionIFvRN6duckdb9DataChunkERNS0_15ExpressionStateERNS0_6VectorEEEC2EOS8_.exit.i.i: ; preds = %bb.n, %bb.n, %bb.n, %bb.n
  ...
  store i64 0, ptr %.sroa.2171.0..sroa_idx, align 8, !tbaa !51
  %.sroa.0.0.copyload.i.i.pre.i.i = load <2 x i64>, ptr %5, align 16, !tbaa !51
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %5, ptr noundef nonnull align 8 dereferenceable(32) %i.bx, i64 16, i1 false), !tbaa.struct !61
  store <2 x i64> %.sroa.0.0.copyload.i.i.pre.i.i, ptr %i.bx, align 8, !tbaa !51
...
_ZNSt8functionIFvRN6duckdb9DataChunkERNS0_15ExpressionStateERNS0_6VectorEEEC2EOS8_.exit.i.i90: ; preds = %bb.ad, %bb.ad, %bb.ad, %bb.ad
  ...
  store i64 0, ptr %.sroa.2.0..sroa_idx, align 8, !tbaa !51
  %.sroa.0.0.copyload.i.i.pre.i.i89 = load <2 x i64>, ptr %4, align 16, !tbaa !51
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %4, ptr noundef nonnull align 8 dereferenceable(32) %i.ez, i64 16, i1 false), !tbaa.struct !61
  store <2 x i64> %.sroa.0.0.copyload.i.i.pre.i.i89, ptr %i.ez, align 8, !tbaa !51
...
bb.b:                                             ; preds = %bb.a
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %2, ptr noundef nonnull align 8 dereferenceable(32) %1, i64 16, i1 false), !tbaa.struct !61
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.b, i8 0, i64 16, i1 false)
  %.sroa.0.0.copyload.i.i.pre.i = load <2 x i64>, ptr %2, align 16, !tbaa !51
...
_ZNSt8functionIFvRN6duckdb9DataChunkERNS0_15ExpressionStateERNS0_6VectorEEEC2EOS8_.exit.i: ; preds = %bb.b, %bb.a
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %2, ptr noundef nonnull align 8 dereferenceable(32) %i.a, i64 16, i1 false), !tbaa.struct !61
  store <2 x i64> %.sroa.0.0.copyload.i.i.i, ptr %i.a, align 8, !tbaa !51
