...
bb.j:                                             ; preds = %.critedge.i.i
  %10 = tail call noundef range(i32 0, 32) i32 @llvm.ctlz.i32(i32 %i.bl, i1 true) ; 2 uses
  %11 = xor i32 %10, 31                           ; 2 uses
  %12 = icmp samesign ugt i32 %11, 11
  br i1 %12, label %_ZN11duckdb_zstdL26HUF_readStats_body_defaultEPhmPjS1_S1_PKvmPvm.exit, label %bb.k

bb.k:                                             ; preds = %bb.j
  %i.bo = sub nuw nsw i32 32, %10
  store i32 %i.bo, ptr %4, align 4, !tbaa !3
  %i.bp = shl nuw nsw i32 2, %11
  %i.bq = sub i32 %i.bp, %i.bl                    ; 2 uses
...
_ZN11duckdb_zstdL26HUF_readStats_body_defaultEPhmPjS1_S1_PKvmPvm.exit: ; preds = %.lr.ph13.i, %bb.m, %bb.l, %bb.k, %bb.j, %.critedge.i.i, %.loopexit.i, %bb.h, %bb.g, %bb.f, %bb.e, %bb.c, %bb.b
  %.0 = phi i64 [ %i.b, %bb.b ], [ -72, %bb.c ], [ -72, %bb.e ], [ %i.ax, %bb.h ], [ -20, %bb.j ], [ %i.cg, %bb.m ], [ -20, %bb.k ], [ -20, %bb.l ], [ -20, %bb.f ], [ -72, %bb.g ], [ -20, %.critedge.i.i ], [ -20, %.loopexit.i ], [ -20, %.lr.ph13.i ]
  ret i64 %.0
}
...
.critedge.i:                                      ; preds = %bb.g
  %.old.i = icmp eq i32 %i.bm, 0
  br i1 %.old.i, label %_ZN11duckdb_zstdL18HUF_readStats_bodyEPhmPjS1_S1_PKvmPvmi.exit, label %bb.h

bb.h:                                             ; preds = %.critedge.i
  %9 = tail call noundef range(i32 0, 32) i32 @llvm.ctlz.i32(i32 %i.bm, i1 true) ; 2 uses
  %10 = xor i32 %9, 31                            ; 2 uses
  %11 = icmp samesign ugt i32 %10, 11
  br i1 %11, label %_ZN11duckdb_zstdL18HUF_readStats_bodyEPhmPjS1_S1_PKvmPvmi.exit, label %bb.i

bb.i:                                             ; preds = %bb.h
  %i.bp = sub nuw nsw i32 32, %9
  store i32 %i.bp, ptr %4, align 4, !tbaa !3
  %i.bq = shl nuw nsw i32 2, %10
  %i.br = sub i32 %i.bq, %i.bm                    ; 2 uses
...
_ZN11duckdb_zstdL18HUF_readStats_bodyEPhmPjS1_S1_PKvmPvmi.exit: ; preds = %.lr.ph13, %.loopexit, %bb.a, %bb.c, %bb.d, %bb.e, %bb.f, %.critedge.i, %bb.h, %bb.i, %bb.j, %bb.k
  %.3.i = phi i64 [ -72, %bb.a ], [ -72, %bb.c ], [ %i.ay, %bb.f ], [ -20, %bb.h ], [ %i.ch, %bb.k ], [ -20, %bb.i ], [ -20, %bb.j ], [ -20, %bb.d ], [ -72, %bb.e ], [ -20, %.critedge.i ], [ -20, %.loopexit ], [ -20, %.lr.ph13 ]
  ret i64 %.3.i
}
