...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load38 = load <4 x i8>, ptr %i.ad, align 1, !tbaa !14, !alias.scope !15 ; 2 uses
  ...
  store <8 x i8> %interleaved.vec40, ptr %i.af, align 1, !tbaa !14, !alias.scope !18, !noalias !15
  %index.next41 = add nuw i64 %index37, 4         ; 2 uses
  %i.ah = icmp eq i64 %index.next41, %n.vec36
  br i1 %i.ah, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !24
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  ...
  br i1 %i.as, label %.lr.ph.i, label %.loopexit.thread.i, !llvm.loop !25
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.av = tail call noundef i64 @_ZN11duckdb_zstd24FSE_decompress_wksp_bmi2EPvmPKvmjS0_mi(ptr noundef %0, i64 noundef %i.at, ptr noundef nonnull %i.au, i64 noundef %i.d, i32 noundef 6, ptr noundef %7, i64 noundef %8, i32 noundef 0) ; 4 uses
  %i.aw = icmp ult i64 %i.av, -119
  br i1 %i.aw, label %.loopexit.i, label %_ZN11duckdb_zstdL26HUF_readStats_body_defaultEPhmPjS1_S1_PKvmPvm.exit
...
.lr.ph13.i:                                       ; preds = %bb.i, %.lr.ph13.preheader.i
  ...
  br i1 %i.ba, label %_ZN11duckdb_zstdL26HUF_readStats_body_defaultEPhmPjS1_S1_PKvmPvm.exit, label %bb.i
...
bb.j:                                             ; preds = %.critedge.i.i
  ...
  br i1 %i.bo, label %_ZN11duckdb_zstdL26HUF_readStats_body_defaultEPhmPjS1_S1_PKvmPvm.exit, label %bb.k
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load.a = load <8 x i8>, ptr %i.q, align 1, !tbaa !14, !alias.scope !27
  %wide.load35.a = load <8 x i8>, ptr %i.r, align 1, !tbaa !14, !alias.scope !27
  ...
  %wide.load36 = load <8 x i8>, ptr %i.q, align 1, !tbaa !14, !alias.scope !27
  %wide.load37 = load <8 x i8>, ptr %i.r, align 1, !tbaa !14, !alias.scope !27
  ...
  store <16 x i8> %interleaved.vec.a, ptr %10, align 1, !tbaa !14, !alias.scope !30, !noalias !27
  ...
  store <16 x i8> %interleaved.vec38.a, ptr %i.v, align 1, !tbaa !14, !alias.scope !30, !noalias !27
  %index.next = add nuw i64 %index, 16            ; 2 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load42 = load <4 x i8>, ptr %i.ab, align 1, !tbaa !14, !alias.scope !27 ; 2 uses
  ...
  store <8 x i8> %interleaved.vec44, ptr %i.ad, align 1, !tbaa !14, !alias.scope !30, !noalias !27
  %index.next45 = add nuw i64 %index41, 4         ; 2 uses
  %i.af = icmp eq i64 %index.next45, %n.vec40
  br i1 %i.af, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !33
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %i.am = load i8, ptr %i.ai, align 1, !tbaa !14
  %i.an = and i8 %i.am, 15
  ...
  br i1 %i.ar, label %.lr.ph, label %.loopexit.thread, !llvm.loop !34
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.au = tail call noundef i64 @_ZN11duckdb_zstd24FSE_decompress_wksp_bmi2EPvmPKvmjS0_mi(ptr noundef %0, i64 noundef %i.as, ptr noundef nonnull %i.at, i64 noundef %i.b, i32 noundef 6, ptr noundef %7, i64 noundef %8, i32 noundef 1) ; 4 uses
  %i.av = icmp ult i64 %i.au, -119
  br i1 %i.av, label %.loopexit, label %_ZN11duckdb_zstdL18HUF_readStats_bodyEPhmPjS1_S1_PKvmPvmi.exit
...
.lr.ph13:                                         ; preds = %.lr.ph13.preheader, %bb.g
  ...
  br i1 %i.az, label %_ZN11duckdb_zstdL18HUF_readStats_bodyEPhmPjS1_S1_PKvmPvmi.exit, label %bb.g
...
bb.g:                                             ; preds = %.lr.ph13
  ...
  %i.be = load i8, ptr %i.ax, align 1, !tbaa !14
...
bb.h:                                             ; preds = %.critedge.i
  %i.bl = tail call noundef range(i32 0, 32) i32 @llvm.ctlz.i32(i32 %i.bi, i1 true) ; 2 uses
  %i.bm = xor i32 %i.bl, 31                       ; 2 uses
  %i.bn = icmp samesign ugt i32 %i.bm, 11
  br i1 %i.bn, label %_ZN11duckdb_zstdL18HUF_readStats_bodyEPhmPjS1_S1_PKvmPvmi.exit, label %bb.i
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.cf = add i32 %i.ce, 1
  store i32 %i.cf, ptr %3, align 4, !tbaa !3
