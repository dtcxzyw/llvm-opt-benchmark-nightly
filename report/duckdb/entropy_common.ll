...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.w = lshr <8 x i8> %wide.load31, splat (i8 4)
  %i.x = getelementptr inbounds nuw i8, ptr %0, i64 %i.s
  %i.y = getelementptr inbounds nuw i8, ptr %0, i64 %i.s
  %i.z = getelementptr inbounds nuw i8, ptr %i.y, i64 16
  %wide.load32 = load <8 x i8>, ptr %i.t, align 1, !tbaa !14, !alias.scope !15
  %wide.load33 = load <8 x i8>, ptr %i.u, align 1, !tbaa !14, !alias.scope !15
  %i.aa = and <8 x i8> %wide.load32, splat (i8 15)
  %i.ab = and <8 x i8> %wide.load33, splat (i8 15)
  ...
  store <16 x i8> %interleaved.vec, ptr %i.x, align 1, !tbaa !14, !alias.scope !18, !noalias !15
  %interleaved.vec34 = shufflevector <8 x i8> %i.w, <8 x i8> %i.ab, <16 x i32> <i32 0, i32 8, i32 1, i32 9, i32 2, i32 10, i32 3, i32 11, i32 4, i32 12, i32 5, i32 13, i32 6, i32 14, i32 7, i32 15>
  store <16 x i8> %interleaved.vec34, ptr %i.z, align 1, !tbaa !14, !alias.scope !18, !noalias !15
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.ai = and <4 x i8> %wide.load38, splat (i8 15)
  %interleaved.vec40 = shufflevector <4 x i8> %i.ag, <4 x i8> %i.ai, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
  store <8 x i8> %interleaved.vec40, ptr %i.ah, align 1, !tbaa !14, !alias.scope !18, !noalias !15
  %index.next41 = add nuw i64 %index37, 4         ; 2 uses
  %i.aj = icmp eq i64 %index.next41, %n.vec36
...
.lr.ph.i.preheader:                               ; preds = %vector.memcheck, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %.ph = phi i64 [ 0, %iter.check ], [ 0, %vector.memcheck ], [ %i.r, %vec.epilog.iter.check ], [ %i.ad, %vec.epilog.middle.block ]
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  %i.ak = phi i64 [ %i.at, %.lr.ph.i ], [ %.ph, %.lr.ph.i.preheader ] ; 3 uses
  ...
  %i.ao = lshr i8 %i.an, 4
  %i.ap = getelementptr inbounds nuw i8, ptr %0, i64 %i.ak ; 2 uses
  ...
  store i8 %i.ar, ptr %i.as, align 1, !tbaa !14
  %i.at = add nuw nsw i64 %i.ak, 2                ; 2 uses
  %i.au = icmp samesign ugt i64 %i.f, %i.at
  br i1 %i.au, label %.lr.ph.i, label %.loopexit.thread.i, !llvm.loop !25
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.ax = tail call noundef i64 @_ZN11duckdb_zstd24FSE_decompress_wksp_bmi2EPvmPKvmjS0_mi(ptr noundef %0, i64 noundef %i.av, ptr noundef nonnull %i.aw, i64 noundef %i.d, i32 noundef 6, ptr noundef %7, i64 noundef %8, i32 noundef 0) ; 4 uses
  %i.ay = icmp ult i64 %i.ax, -119
  br i1 %i.ay, label %.loopexit.i, label %_ZN11duckdb_zstdL26HUF_readStats_body_defaultEPhmPjS1_S1_PKvmPvm.exit

.loopexit.i:                                      ; preds = %bb.h
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(52) %2, i8 0, i64 52, i1 false)
  %.not90.i10.not.i = icmp eq i64 %i.ax, 0
...
.lr.ph13.preheader.i:                             ; preds = %.loopexit.i, %.loopexit.thread.i
  ...
  %.074.i24.i = phi i64 [ %i.f, %.loopexit.thread.i ], [ %i.ax, %.loopexit.i ] ; 3 uses
  br label %.lr.ph13.i

.lr.ph13.i:                                       ; preds = %bb.i, %.lr.ph13.preheader.i
  %i.az = phi i64 [ %i.bn, %bb.i ], [ 0, %.lr.ph13.preheader.i ]
  %.072.i12.i = phi i32 [ %i.bl, %bb.i ], [ 0, %.lr.ph13.preheader.i ]
  %.075.i11.i = phi i32 [ %i.bm, %bb.i ], [ 0, %.lr.ph13.preheader.i ]
...
bb.j:                                             ; preds = %.critedge.i.i
  %i.bo = tail call noundef range(i32 0, 32) i32 @llvm.ctlz.i32(i32 %i.bl, i1 true) ; 2 uses
  %i.bp = xor i32 %i.bo, 31                       ; 2 uses
  %i.bq = icmp samesign ugt i32 %i.bp, 11
  br i1 %i.bq, label %_ZN11duckdb_zstdL26HUF_readStats_body_defaultEPhmPjS1_S1_PKvmPvm.exit, label %bb.k

bb.k:                                             ; preds = %bb.j
  %i.br = sub nuw nsw i32 32, %i.bo
  store i32 %i.br, ptr %4, align 4, !tbaa !3
  ...
  %i.bv = lshr exact i32 -2147483648, %i.bu
  %.not91.i.i = icmp eq i32 %i.bv, %i.bt
  br i1 %.not91.i.i, label %bb.l, label %_ZN11duckdb_zstdL26HUF_readStats_body_defaultEPhmPjS1_S1_PKvmPvm.exit

bb.l:                                             ; preds = %bb.k
  %i.bw = sub nuw nsw i32 32, %i.bu               ; 2 uses
  %i.bx = trunc nuw nsw i32 %i.bw to i8
  %i.by = getelementptr inbounds nuw i8, ptr %0, i64 %.074.i24.i
  store i8 %i.bx, ptr %i.by, align 1, !tbaa !14
  ...
  %i.cg = and i32 %i.ce, 1
  %.not92.i.i = icmp eq i32 %i.cg, 0
  %or.cond.i.i = and i1 %i.cf, %.not92.i.i
  br i1 %or.cond.i.i, label %bb.m, label %_ZN11duckdb_zstdL26HUF_readStats_body_defaultEPhmPjS1_S1_PKvmPvm.exit

bb.m:                                             ; preds = %bb.l
  %i.ch = trunc nuw i64 %.074.i24.i to i32
  %i.ci = add i32 %i.ch, 1
  store i32 %i.ci, ptr %3, align 4, !tbaa !3
  %i.cj = add nuw nsw i64 %.073.i26.i, 1
  br label %_ZN11duckdb_zstdL26HUF_readStats_body_defaultEPhmPjS1_S1_PKvmPvm.exit
...
_ZN11duckdb_zstdL26HUF_readStats_body_defaultEPhmPjS1_S1_PKvmPvm.exit: ; preds = %.lr.ph13.i, %bb.m, %bb.l, %bb.k, %bb.j, %.critedge.i.i, %.loopexit.i, %bb.h, %bb.g, %bb.f, %bb.e, %bb.c, %bb.b
  %.0 = phi i64 [ %i.b, %bb.b ], [ -72, %bb.c ], [ -72, %bb.e ], [ %i.ax, %bb.h ], [ -20, %bb.j ], [ %i.cj, %bb.m ], [ -20, %bb.k ], [ -20, %bb.l ], [ -20, %bb.f ], [ -72, %bb.g ], [ -20, %.critedge.i.i ], [ -20, %.loopexit.i ], [ -20, %.lr.ph13.i ]
  ret i64 %.0
}
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.u = lshr <8 x i8> %wide.load35, splat (i8 4)
  %i.v = getelementptr inbounds nuw i8, ptr %0, i64 %i.q
  %i.w = getelementptr inbounds nuw i8, ptr %0, i64 %i.q
  %i.x = getelementptr inbounds nuw i8, ptr %i.w, i64 16
  %wide.load36 = load <8 x i8>, ptr %i.r, align 1, !tbaa !14, !alias.scope !27
  %wide.load37 = load <8 x i8>, ptr %i.s, align 1, !tbaa !14, !alias.scope !27
  %i.y = and <8 x i8> %wide.load36, splat (i8 15)
  %i.z = and <8 x i8> %wide.load37, splat (i8 15)
  ...
  store <16 x i8> %interleaved.vec, ptr %i.v, align 1, !tbaa !14, !alias.scope !30, !noalias !27
  %interleaved.vec38 = shufflevector <8 x i8> %i.u, <8 x i8> %i.z, <16 x i32> <i32 0, i32 8, i32 1, i32 9, i32 2, i32 10, i32 3, i32 11, i32 4, i32 12, i32 5, i32 13, i32 6, i32 14, i32 7, i32 15>
  store <16 x i8> %interleaved.vec38, ptr %i.x, align 1, !tbaa !14, !alias.scope !30, !noalias !27
  %index.next = add nuw i64 %index, 16            ; 2 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.ag = and <4 x i8> %wide.load42, splat (i8 15)
  %interleaved.vec44 = shufflevector <4 x i8> %i.ae, <4 x i8> %i.ag, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
  store <8 x i8> %interleaved.vec44, ptr %i.af, align 1, !tbaa !14, !alias.scope !30, !noalias !27
  %index.next45 = add nuw i64 %index41, 4         ; 2 uses
  %i.ah = icmp eq i64 %index.next45, %n.vec40
  br i1 %i.ah, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !33
...
.lr.ph.preheader:                                 ; preds = %vector.memcheck, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %.ph = phi i64 [ 0, %iter.check ], [ 0, %vector.memcheck ], [ %i.p, %vec.epilog.iter.check ], [ %i.ab, %vec.epilog.middle.block ]
  br label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  %i.ai = phi i64 [ %i.as, %.lr.ph ], [ %.ph, %.lr.ph.preheader ] ; 4 uses
  %i.aj = lshr exact i64 %i.ai, 1
  %i.ak = getelementptr inbounds nuw i8, ptr %i.g, i64 %i.aj ; 2 uses
  %i.al = load i8, ptr %i.ak, align 1, !tbaa !14
  %i.am = lshr i8 %i.al, 4
  %i.an = getelementptr inbounds nuw i8, ptr %0, i64 %i.ai
  store i8 %i.am, ptr %i.an, align 1, !tbaa !14
  %i.ao = load i8, ptr %i.ak, align 1, !tbaa !14
  %i.ap = and i8 %i.ao, 15
  %i.aq = getelementptr inbounds nuw i8, ptr %0, i64 %i.ai
  %i.ar = getelementptr inbounds nuw i8, ptr %i.aq, i64 1
  store i8 %i.ap, ptr %i.ar, align 1, !tbaa !14
  %i.as = add nuw nsw i64 %i.ai, 2                ; 2 uses
  %i.at = icmp samesign ugt i64 %i.d, %i.as
  br i1 %i.at, label %.lr.ph, label %.loopexit.thread, !llvm.loop !34
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.aw = tail call noundef i64 @_ZN11duckdb_zstd24FSE_decompress_wksp_bmi2EPvmPKvmjS0_mi(ptr noundef %0, i64 noundef %i.au, ptr noundef nonnull %i.av, i64 noundef %i.b, i32 noundef 6, ptr noundef %7, i64 noundef %8, i32 noundef 1) ; 4 uses
  %i.ax = icmp ult i64 %i.aw, -119
  br i1 %i.ax, label %.loopexit, label %_ZN11duckdb_zstdL18HUF_readStats_bodyEPhmPjS1_S1_PKvmPvmi.exit

.loopexit:                                        ; preds = %bb.f
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(52) %2, i8 0, i64 52, i1 false)
  %.not90.i10.not = icmp eq i64 %i.aw, 0
...
.lr.ph13.preheader:                               ; preds = %.loopexit.thread, %.loopexit
  ...
  %.074.i24 = phi i64 [ %i.d, %.loopexit.thread ], [ %i.aw, %.loopexit ] ; 3 uses
  br label %.lr.ph13

.lr.ph13:                                         ; preds = %.lr.ph13.preheader, %bb.g
  %i.ay = phi i64 [ %i.bm, %bb.g ], [ 0, %.lr.ph13.preheader ]
  %.072.i12 = phi i32 [ %i.bk, %bb.g ], [ 0, %.lr.ph13.preheader ]
  %.075.i11 = phi i32 [ %i.bl, %bb.g ], [ 0, %.lr.ph13.preheader ]
  ...
  br i1 %i.bb, label %_ZN11duckdb_zstdL18HUF_readStats_bodyEPhmPjS1_S1_PKvmPvmi.exit, label %bb.g
...
bb.g:                                             ; preds = %.lr.ph13
  ...
  %i.bk = add i32 %i.bj, %.072.i12                ; 4 uses
  %i.bl = add i32 %.075.i11, 1                    ; 2 uses
  %i.bm = zext i32 %i.bl to i64                   ; 2 uses
  %.not90.i = icmp ugt i64 %.074.i24, %i.bm
  br i1 %.not90.i, label %.lr.ph13, label %.critedge.i, !llvm.loop !26

.critedge.i:                                      ; preds = %bb.g
  %.old.i = icmp eq i32 %i.bk, 0
...
bb.h:                                             ; preds = %.critedge.i
  ...
  br i1 %i.bp, label %_ZN11duckdb_zstdL18HUF_readStats_bodyEPhmPjS1_S1_PKvmPvmi.exit, label %bb.i
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.bx = getelementptr inbounds nuw i8, ptr %0, i64 %.074.i24
...
_ZN11duckdb_zstdL18HUF_readStats_bodyEPhmPjS1_S1_PKvmPvmi.exit: ; preds = %.lr.ph13, %.loopexit, %bb.a, %bb.c, %bb.d, %bb.e, %bb.f, %.critedge.i, %bb.h, %bb.i, %bb.j, %bb.k
  %.3.i = phi i64 [ -72, %bb.a ], [ -72, %bb.c ], [ %i.aw, %bb.f ], [ -20, %bb.h ], [ %i.ci, %bb.k ], [ -20, %bb.i ], [ -20, %bb.j ], [ -20, %bb.d ], [ -72, %bb.e ], [ -20, %.critedge.i ], [ -20, %.loopexit ], [ -20, %.lr.ph13 ]
  ret i64 %.3.i
}
