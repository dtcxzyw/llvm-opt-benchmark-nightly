...
begin_hunk_2_@_ZN11duckdb_zstd18HUF_readStats_wkspEPhmPjS1_S1_PKvmPvmi:bb.a
  ...
  br i1 %i.ar, label %.lr.ph.i, label %.loopexit.thread.i, !llvm.loop !24
...
end_hunk_2
begin_hunk_3_@_ZN11duckdb_zstd18HUF_readStats_wkspEPhmPjS1_S1_PKvmPvmi:bb.a
...
end_hunk_3
begin_hunk_4_@_ZN11duckdb_zstdL23HUF_readStats_body_bmi2EPhmPjS1_S1_PKvmPvm:bb.a
  ...
  %wide.load = load <8 x i8>, ptr %i.t, align 1, !tbaa !14, !alias.scope !26
  %wide.load36 = load <8 x i8>, ptr %i.u, align 1, !tbaa !14, !alias.scope !26
  ...
  %wide.load37 = load <8 x i8>, ptr %i.t, align 1, !tbaa !14, !alias.scope !26
  %wide.load38 = load <8 x i8>, ptr %i.u, align 1, !tbaa !14, !alias.scope !26
  ...
  store <16 x i8> %interleaved.vec, ptr %i.x, align 1, !tbaa !14, !alias.scope !29, !noalias !26
  ...
  store <16 x i8> %interleaved.vec39, ptr %i.z, align 1, !tbaa !14, !alias.scope !29, !noalias !26
...
end_hunk_4
begin_hunk_5_@_ZN11duckdb_zstdL23HUF_readStats_body_bmi2EPhmPjS1_S1_PKvmPvm:bb.a
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  %vec.epilog.resume.val = phi i64 [ %n.vec, %vec.epilog.iter.check ], [ 0, %vector.main.loop.iter.check ]
end_hunk_5
begin_hunk_6_@_ZN11duckdb_zstdL23HUF_readStats_body_bmi2EPhmPjS1_S1_PKvmPvm:bb.a
  %i.ae = shl i64 %index42, 1
  %i.af = and i64 %index42, 9223372036854775804
  %i.ag = getelementptr inbounds nuw i8, ptr %i.g, i64 %i.af
  %wide.load43 = load <4 x i8>, ptr %i.ag, align 1, !tbaa !14, !alias.scope !26 ; 2 uses
  ...
  store <8 x i8> %interleaved.vec45, ptr %i.ai, align 1, !tbaa !14, !alias.scope !29, !noalias !26
  %index.next46 = add nuw i64 %index42, 4         ; 2 uses
  %i.ak = icmp eq i64 %index.next46, %n.vec41
  br i1 %i.ak, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !32

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n47 = icmp eq i64 %n.vec41, %i.k
end_hunk_6
begin_hunk_7_@_ZN11duckdb_zstdL23HUF_readStats_body_bmi2EPhmPjS1_S1_PKvmPvm:bb.a
  %indvars.iv.next = add nuw i64 %indvars.iv, 2   ; 2 uses
  %indvars = trunc i64 %indvars.iv.next to i32
  %i.au = icmp ugt i32 %i.h, %indvars
  br i1 %i.au, label %.lr.ph, label %.loopexit.thread, !llvm.loop !33

.loopexit.thread:                                 ; preds = %.lr.ph, %vec.epilog.middle.block, %middle.block
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(52) %2, i8 0, i64 52, i1 false)
end_hunk_7
begin_hunk_8_@_ZN11duckdb_zstdL23HUF_readStats_body_bmi2EPhmPjS1_S1_PKvmPvm:bb.a
