...
.loopexit:                                        ; preds = %bb.c
  ...
  %i.n = load i64, ptr %i.m, align 8, !tbaa !94   ; 3 uses
...
bb.j:                                             ; preds = %_ZNSt11unique_lockISt5mutexE4lockEv.exit, %bb.f
  %i.z = phi i64 [ %.pre, %_ZNSt11unique_lockISt5mutexE4lockEv.exit ], [ %i.w, %bb.f ]
...
_ZN6duckdb13MetadataBlock19FreeBlocksToIntegerEv.exit49: ; preds = %_ZN6duckdb13MetadataBlock19FreeBlocksToIntegerEv.exit49.loopexit, %.lr.ph116
  ...
  %i.ei = getelementptr inbounds nuw i8, ptr %.sroa.077.0115, i64 32 ; 2 uses
  %i.ej = load i64, ptr %i.ei, align 8, !tbaa !37 ; 4 uses
...
.noexc56:                                         ; preds = %.loopexit.i.i
  ...
  %4 = load i64, ptr %i.ei, align 8, !tbaa !37
  store i64 %4, ptr %i.ez, align 8, !tbaa !164
...
._crit_edge54:                                    ; preds = %_ZN6duckdb17MetadataBlockInfoD2Ev.exit, %_ZNSt11unique_lockISt5mutexEC2ERS0_.exit
  %.pre55 = load ptr, ptr %0, align 8, !tbaa !173 ; 6 uses
  %3 = getelementptr inbounds nuw i8, ptr %0, i64 8
  %.pre56 = load ptr, ptr %3, align 8, !tbaa !173 ; 6 uses
...
_ZNSt11unique_lockISt5mutexED2Ev.exit:            ; preds = %"_ZSt25__unguarded_linear_insertIN9__gnu_cxx17__normal_iteratorIPN6duckdb17MetadataBlockInfoESt6vectorIS3_SaIS3_EEEENS0_5__ops14_Val_comp_iterIZNKS2_15MetadataManager15GetMetadataInfoEvE3$_0EEEvT_T0_.exit.i.i.i.i", %._crit_edge54, %bb.d, %bb.g
...
bb.a:
  ...
  %i.a = load i64, ptr %1, align 8, !tbaa !37     ; 4 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 8
...
.loopexit:                                        ; preds = %.lr.ph.i.i, %bb.a, %..loopexit_crit_edge21.i.i
  ...
  store i64 %3, ptr %i.r, align 8, !tbaa !94
