...
.outer:                                           ; preds = %.preheader478, %_ZNSt10unique_ptrIN6duckdb17GlobalSourceStateESt14default_deleteIS1_EED2Ev.exit
  ...
  %.0149.ph = phi i64 [ 0, %.preheader478 ], [ %.1150, %_ZNSt10unique_ptrIN6duckdb17GlobalSourceStateESt14default_deleteIS1_EED2Ev.exit ]
  br label %bb.al

bb.al:                                            ; preds = %.outer, %bb.cr
  %.0158 = phi i64 [ %i.jh, %bb.cr ], [ %.0158.ph, %.outer ] ; 3 uses
  %.0149 = phi i64 [ %i.ji, %bb.cr ], [ %.0149.ph, %.outer ] ; 6 uses
  %41 = icmp ult i64 %.0149, %3
  br i1 %41, label %bb.as, label %.loopexit479
...
bb.cr:                                            ; preds = %bb.cq
  ...
  %i.ji = add nuw nsw i64 %.0149, 1               ; 3 uses
