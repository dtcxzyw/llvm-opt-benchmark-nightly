...
begin_hunk_0_@_ZN13duckdb_brotli16BrotliSplitBlockEPNS_13MemoryManagerEPKNS_7CommandEmPKhmmPK19BrotliEncoderParamsPNS_10BlockSplitESB_SB_:bb.a
  ...
  store i64 %.0137.i, ptr %i.bc, align 8, !tbaa !24
  %.pre.i = load i64, ptr %i.be, align 8, !tbaa !25 ; 2 uses
  %.pre188.i = add i64 %.pre.i, 1
  br label %bb.o

bb.o:                                             ; preds = %bb.n, %bb.i
  %.pre-phi.i = phi i64 [ %.pre188.i, %bb.n ], [ %i.bg, %bb.i ] ; 3 uses
...
bb.q:                                             ; preds = %bb.q, %bb.p
  %.0136.i = phi i64 [ %.154.i, %bb.p ], [ %i.bx, %bb.q ] ; 4 uses
  %i.bw = icmp ult i64 %.0136.i, %.pre-phi.i
  %i.bx = shl i64 %.0136.i, 1
  br i1 %i.bw, label %bb.q, label %bb.r, !llvm.loop !28

bb.r:                                             ; preds = %bb.q
  %i.by = shl i64 %.0136.i, 2
...
bb.t:                                             ; preds = %bb.s, %bb.r
  ...
  store i64 %.0136.i, ptr %i.bs, align 8, !tbaa !27
  %.pre187.i = load i64, ptr %i.be, align 8, !tbaa !25
...
_ZL22SplitByteVectorLiteralPN13duckdb_brotli13MemoryManagerEPKhmmmmdPK19BrotliEncoderParamsPNS_10BlockSplitE.exit.thread: ; preds = %bb.o, %bb.t
  %i.cg = phi i64 [ %.pre187.i, %bb.t ], [ %i.br, %bb.o ]
...
bb.af:                                            ; preds = %_ZL27BuildBlockHistogramsLiteralPKhmS0_mPN13duckdb_brotli16HistogramLiteralE.exit.i, %bb.ae
  %.0181.i = phi i64 [ 0, %bb.ae ], [ %i.qr, %_ZL27BuildBlockHistogramsLiteralPKhmS0_mPN13duckdb_brotli16HistogramLiteralE.exit.i ]
  %.1180.i = phi i64 [ %., %bb.ae ], [ %i.ol, %_ZL27BuildBlockHistogramsLiteralPKhmS0_mPN13duckdb_brotli16HistogramLiteralE.exit.i ] ; 21 uses
  %i.ib = add nuw nsw i64 %.1180.i, 7
  %i.ic = lshr i64 %i.ib, 3                       ; 4 uses
  %i.id = icmp samesign ult i64 %.1180.i, 2
...
bb.ag:                                            ; preds = %bb.af
  %i.ie = shl nuw nsw i64 %.1180.i, 11
...
bb.ah:                                            ; preds = %_ZN13duckdb_brotliL8FastLog2Em.exit.i.i, %bb.ag
  %.1119131.i.i = phi i64 [ 0, %bb.ag ], [ %i.ip, %_ZN13duckdb_brotliL8FastLog2Em.exit.i.i ] ; 3 uses
  %i.if = getelementptr inbounds nuw [1040 x i8], ptr %i.cs, i64 %.1119131.i.i
...
_ZN13duckdb_brotliL8FastLog2Em.exit.i.i:          ; preds = %bb.aj, %bb.ai
  ...
  %i.io = getelementptr inbounds nuw [8 x i8], ptr %i.hm, i64 %.1119131.i.i
  store double %.0.i.i.i, ptr %i.io, align 8, !tbaa !65
  %i.ip = add nuw nsw i64 %.1119131.i.i, 1        ; 2 uses
  %exitcond.not.i156.i = icmp eq i64 %i.ip, %.1180.i
...
.preheader130.i.i:                                ; preds = %_ZN13duckdb_brotliL8FastLog2Em.exit.i.i, %.loopexit129.i.i
  ...
  %i.ir = mul i64 %i.iq, %.1180.i
  %i.is = getelementptr [8 x i8], ptr %i.hm, i64 %i.ir
  br label %bb.ak

bb.ak:                                            ; preds = %_ZL7BitCostm.exit.i.i, %.preheader130.i.i
  %.0120132.i.i = phi i64 [ 0, %.preheader130.i.i ], [ %i.jg, %_ZL7BitCostm.exit.i.i ] ; 4 uses
  %i.it = getelementptr inbounds nuw [8 x i8], ptr %i.hm, i64 %.0120132.i.i
...
_ZL7BitCostm.exit.i.i:                            ; preds = %bb.an, %bb.am, %bb.ak
  ...
  %i.jf = getelementptr [8 x i8], ptr %i.is, i64 %.0120132.i.i
  store double %i.je, ptr %i.jf, align 8, !tbaa !65
  %i.jg = add nuw nsw i64 %.0120132.i.i, 1        ; 2 uses
  %exitcond145.not.i.i = icmp eq i64 %i.jg, %.1180.i
  br i1 %exitcond145.not.i.i, label %.loopexit129.i.i, label %bb.ak, !llvm.loop !68

bb.ao:                                            ; preds = %.loopexit129.i.i
  %i.jh = shl nuw nsw i64 %.1180.i, 3
  ...
  %xtraiter893 = and i64 %.1180.i, 1
  %unroll_iter898 = and i64 %.1180.i, -2
  %lcmp.mod895.not = icmp eq i64 %xtraiter893, 0
  %lcmp.mod897 = trunc i64 %.1180.i to i1
  br label %.new891

.new891:                                          ; preds = %bb.ba, %bb.ao
  %.0116137.i.i = phi i64 [ 0, %bb.ao ], [ %i.lg, %bb.ba ] ; 6 uses
  %i.jj = getelementptr inbounds nuw i8, ptr %.ph, i64 %.0116137.i.i
  %i.jk = load i8, ptr %i.jj, align 1, !tbaa !29
  %i.jl = zext i8 %i.jk to i64
  %i.jm = mul nuw nsw i64 %.1180.i, %i.jl
  %i.jn = getelementptr inbounds nuw [8 x i8], ptr %i.hm, i64 %i.jm ; 3 uses
  %i.jo = getelementptr inbounds nuw i8, ptr %i.hi, i64 %.0116137.i.i ; 3 uses
  br label %bb.ap

bb.ap:                                            ; preds = %bb.at, %.new891
  %.0111135.i.i = phi i64 [ 0, %.new891 ], [ %i.ke, %bb.at ] ; 5 uses
  %.0114134.i.i = phi double [ f0x547D42AEA2879F2E, %.new891 ], [ %.1115.i.i.1, %bb.at ] ; 2 uses
  %niter899 = phi i64 [ 0, %.new891 ], [ %niter899.next.1, %bb.at ]
  %i.jp = getelementptr inbounds nuw [8 x i8], ptr %i.jn, i64 %.0111135.i.i
  %i.jq = load double, ptr %i.jp, align 8, !tbaa !65
  %i.jr = getelementptr inbounds nuw [8 x i8], ptr %i.ho, i64 %.0111135.i.i ; 2 uses
  %i.js = load double, ptr %i.jr, align 8, !tbaa !65
  %i.jt = fadd double %i.jq, %i.js                ; 3 uses
  store double %i.jt, ptr %i.jr, align 8, !tbaa !65
  %i.ju = fcmp olt double %i.jt, %.0114134.i.i
  br i1 %i.ju, label %bb.aq, label %bb.ar

bb.aq:                                            ; preds = %bb.ap
  %i.jv = trunc i64 %.0111135.i.i to i8
  store i8 %i.jv, ptr %i.jo, align 1, !tbaa !29
  br label %bb.ar

bb.ar:                                            ; preds = %bb.aq, %bb.ap
  %.1115.i.i = phi double [ %i.jt, %bb.aq ], [ %.0114134.i.i, %bb.ap ] ; 2 uses
  %i.jw = or disjoint i64 %.0111135.i.i, 1        ; 3 uses
  ...
  %i.kc = fcmp olt double %i.kb, %.1115.i.i
...
bb.at:                                            ; preds = %bb.as, %bb.ar
  %.1115.i.i.1 = phi double [ %i.kb, %bb.as ], [ %.1115.i.i, %bb.ar ] ; 4 uses
  %i.ke = add nuw nsw i64 %.0111135.i.i, 2        ; 4 uses
...
bb.do:                                            ; preds = %_ZL27BuildBlockHistogramsCommandPKtmPKhmPN13duckdb_brotli16HistogramCommandE.exit.i, %bb.dn
  %.0182.i = phi i64 [ 0, %bb.dn ], [ %i.bmq, %_ZL27BuildBlockHistogramsCommandPKtmPKhmPN13duckdb_brotli16HistogramCommandE.exit.i ]
  %.1181.i = phi i64 [ %spec.select.i68, %bb.dn ], [ %i.bkk, %_ZL27BuildBlockHistogramsCommandPKtmPKhmPN13duckdb_brotli16HistogramCommandE.exit.i ] ; 21 uses
  %i.bea = add nuw nsw i64 %.1181.i, 7
  %i.beb = lshr i64 %i.bea, 3                     ; 4 uses
  %i.bec = icmp samesign ult i64 %.1181.i, 2
...
bb.dp:                                            ; preds = %bb.do
  %i.bed = mul nuw nsw i64 %.1181.i, 5632
...
bb.dq:                                            ; preds = %_ZN13duckdb_brotliL8FastLog2Em.exit.i.i88, %bb.dp
  %.1119131.i.i87 = phi i64 [ 0, %bb.dp ], [ %i.beo, %_ZN13duckdb_brotliL8FastLog2Em.exit.i.i88 ] ; 3 uses
  %i.bee = getelementptr inbounds nuw [2832 x i8], ptr %i.ahi, i64 %.1119131.i.i87
...
_ZN13duckdb_brotliL8FastLog2Em.exit.i.i88:        ; preds = %bb.ds, %bb.dr
  ...
  %i.ben = getelementptr inbounds nuw [8 x i8], ptr %i.bdk, i64 %.1119131.i.i87
  store double %.0.i.i.i89, ptr %i.ben, align 8, !tbaa !65
  %i.beo = add nuw nsw i64 %.1119131.i.i87, 1     ; 2 uses
  %exitcond.not.i156.i90 = icmp eq i64 %i.beo, %.1181.i
...
.preheader130.i.i91:                              ; preds = %_ZN13duckdb_brotliL8FastLog2Em.exit.i.i88, %.loopexit129.i.i98
  ...
  %i.beq = mul i64 %i.bep, %.1181.i
  %i.ber = getelementptr [8 x i8], ptr %i.bdk, i64 %i.beq
  br label %bb.dt

bb.dt:                                            ; preds = %_ZL7BitCostm.exit.i.i96, %.preheader130.i.i91
  %.0120132.i.i94 = phi i64 [ 0, %.preheader130.i.i91 ], [ %i.bff, %_ZL7BitCostm.exit.i.i96 ] ; 4 uses
  %i.bes = getelementptr inbounds nuw [8 x i8], ptr %i.bdk, i64 %.0120132.i.i94
  %i.bet = load double, ptr %i.bes, align 8, !tbaa !65
  %gep.i.i95 = getelementptr [2832 x i8], ptr %invariant.gep.i.i93, i64 %.0120132.i.i94
...
_ZL7BitCostm.exit.i.i96:                          ; preds = %bb.dw, %bb.dv, %bb.dt
  ...
  %i.bfe = getelementptr [8 x i8], ptr %i.ber, i64 %.0120132.i.i94
  store double %i.bfd, ptr %i.bfe, align 8, !tbaa !65
  %i.bff = add nuw nsw i64 %.0120132.i.i94, 1     ; 2 uses
  %exitcond145.not.i.i97 = icmp eq i64 %i.bff, %.1181.i
  br i1 %exitcond145.not.i.i97, label %.loopexit129.i.i98, label %bb.dt, !llvm.loop !131

bb.dx:                                            ; preds = %.loopexit129.i.i98
  %i.bfg = shl nuw nsw i64 %.1181.i, 3
  ...
  %xtraiter962 = and i64 %.1181.i, 1
  %unroll_iter968 = and i64 %.1181.i, -2
  %lcmp.mod964.not = icmp eq i64 %xtraiter962, 0
  %lcmp.mod967 = trunc i64 %.1181.i to i1
  br label %.new959

.new959:                                          ; preds = %bb.ej, %bb.dx
  %.0116137.i.i100 = phi i64 [ 0, %bb.dx ], [ %i.bhf, %bb.ej ] ; 6 uses
  %i.bfi = getelementptr inbounds nuw [2 x i8], ptr %i.acw, i64 %.0116137.i.i100
  %i.bfj = load i16, ptr %i.bfi, align 2, !tbaa !73
  %i.bfk = zext i16 %i.bfj to i64
  %i.bfl = mul nuw nsw i64 %.1181.i, %i.bfk
  %i.bfm = getelementptr inbounds nuw [8 x i8], ptr %i.bdk, i64 %i.bfl ; 3 uses
  %i.bfn = getelementptr inbounds nuw i8, ptr %i.bdg, i64 %.0116137.i.i100 ; 3 uses
  br label %bb.dy

bb.dy:                                            ; preds = %bb.ec, %.new959
  %.0111135.i.i101 = phi i64 [ 0, %.new959 ], [ %i.bgd, %bb.ec ] ; 5 uses
  %.0114134.i.i102 = phi double [ f0x547D42AEA2879F2E, %.new959 ], [ %.1115.i.i103.1, %bb.ec ] ; 2 uses
  %niter969 = phi i64 [ 0, %.new959 ], [ %niter969.next.1, %bb.ec ]
  %i.bfo = getelementptr inbounds nuw [8 x i8], ptr %i.bfm, i64 %.0111135.i.i101
  %i.bfp = load double, ptr %i.bfo, align 8, !tbaa !65
  %i.bfq = getelementptr inbounds nuw [8 x i8], ptr %i.bdm, i64 %.0111135.i.i101 ; 2 uses
  ...
  %i.bft = fcmp olt double %i.bfs, %.0114134.i.i102
  br i1 %i.bft, label %bb.dz, label %bb.ea

bb.dz:                                            ; preds = %bb.dy
  %i.bfu = trunc i64 %.0111135.i.i101 to i8
  store i8 %i.bfu, ptr %i.bfn, align 1, !tbaa !29
  br label %bb.ea

bb.ea:                                            ; preds = %bb.dz, %bb.dy
  %.1115.i.i103 = phi double [ %i.bfs, %bb.dz ], [ %.0114134.i.i102, %bb.dy ] ; 2 uses
  %i.bfv = or disjoint i64 %.0111135.i.i101, 1    ; 3 uses
  ...
  %i.bgb = fcmp olt double %i.bga, %.1115.i.i103
...
bb.ec:                                            ; preds = %bb.eb, %bb.ea
  %.1115.i.i103.1 = phi double [ %i.bga, %bb.eb ], [ %.1115.i.i103, %bb.ea ] ; 4 uses
  %i.bgd = add nuw nsw i64 %.0111135.i.i101, 2    ; 4 uses
...
bb.hf:                                            ; preds = %_ZL28BuildBlockHistogramsDistancePKtmPKhmPN13duckdb_brotli17HistogramDistanceE.exit.i, %bb.he
  %.0182.i260 = phi i64 [ 0, %bb.he ], [ %i.dgh, %_ZL28BuildBlockHistogramsDistancePKtmPKhmPN13duckdb_brotli17HistogramDistanceE.exit.i ]
  %.1181.i261 = phi i64 [ %spec.select, %bb.he ], [ %i.deb, %_ZL28BuildBlockHistogramsDistancePKtmPKhmPN13duckdb_brotli17HistogramDistanceE.exit.i ] ; 21 uses
  %i.cxr = add nuw nsw i64 %.1181.i261, 7
  %i.cxs = lshr i64 %i.cxr, 3                     ; 4 uses
  %i.cxt = icmp samesign ult i64 %.1181.i261, 2
...
bb.hg:                                            ; preds = %bb.hf
  %i.cxu = mul nuw nsw i64 %.1181.i261, 4352
...
bb.hh:                                            ; preds = %_ZN13duckdb_brotliL8FastLog2Em.exit.i.i263, %bb.hg
  %.1119131.i.i262 = phi i64 [ 0, %bb.hg ], [ %i.cyf, %_ZN13duckdb_brotliL8FastLog2Em.exit.i.i263 ] ; 3 uses
  %i.cxv = getelementptr inbounds nuw [2192 x i8], ptr %i.cba, i64 %.1119131.i.i262
...
_ZN13duckdb_brotliL8FastLog2Em.exit.i.i263:       ; preds = %bb.hj, %bb.hi
  ...
  %i.cye = getelementptr inbounds nuw [8 x i8], ptr %i.cxc, i64 %.1119131.i.i262
  store double %.0.i.i.i264, ptr %i.cye, align 8, !tbaa !65
  %i.cyf = add nuw nsw i64 %.1119131.i.i262, 1    ; 2 uses
  %exitcond.not.i156.i265 = icmp eq i64 %i.cyf, %.1181.i261
...
.preheader130.i.i266:                             ; preds = %_ZN13duckdb_brotliL8FastLog2Em.exit.i.i263, %.loopexit129.i.i273
  ...
  %i.cyh = mul i64 %i.cyg, %.1181.i261
  %i.cyi = getelementptr [8 x i8], ptr %i.cxc, i64 %i.cyh
  br label %bb.hk

bb.hk:                                            ; preds = %_ZL7BitCostm.exit.i.i271, %.preheader130.i.i266
  %.0120132.i.i269 = phi i64 [ 0, %.preheader130.i.i266 ], [ %i.cyw, %_ZL7BitCostm.exit.i.i271 ] ; 4 uses
  %i.cyj = getelementptr inbounds nuw [8 x i8], ptr %i.cxc, i64 %.0120132.i.i269
  %i.cyk = load double, ptr %i.cyj, align 8, !tbaa !65
  %gep.i.i270 = getelementptr [2192 x i8], ptr %invariant.gep.i.i268, i64 %.0120132.i.i269
...
_ZL7BitCostm.exit.i.i271:                         ; preds = %bb.hn, %bb.hm, %bb.hk
  ...
  %i.cyv = getelementptr [8 x i8], ptr %i.cyi, i64 %.0120132.i.i269
  store double %i.cyu, ptr %i.cyv, align 8, !tbaa !65
  %i.cyw = add nuw nsw i64 %.0120132.i.i269, 1    ; 2 uses
  %exitcond145.not.i.i272 = icmp eq i64 %i.cyw, %.1181.i261
  br i1 %exitcond145.not.i.i272, label %.loopexit129.i.i273, label %bb.hk, !llvm.loop !183

bb.ho:                                            ; preds = %.loopexit129.i.i273
  %i.cyx = shl nuw nsw i64 %.1181.i261, 3
  ...
  %xtraiter1031 = and i64 %.1181.i261, 1
  %unroll_iter1037 = and i64 %.1181.i261, -2
  %lcmp.mod1033.not = icmp eq i64 %xtraiter1031, 0
  %lcmp.mod1036 = trunc i64 %.1181.i261 to i1
  br label %.new1028

.new1028:                                         ; preds = %bb.ia, %bb.ho
  %.0116137.i.i275 = phi i64 [ 0, %bb.ho ], [ %i.daw, %bb.ia ] ; 6 uses
  %i.cyz = getelementptr inbounds nuw [2 x i8], ptr %i.byq, i64 %.0116137.i.i275
  %i.cza = load i16, ptr %i.cyz, align 2, !tbaa !73
  %i.czb = zext i16 %i.cza to i64
  %i.czc = mul nuw nsw i64 %.1181.i261, %i.czb
  %i.czd = getelementptr inbounds nuw [8 x i8], ptr %i.cxc, i64 %i.czc ; 3 uses
  %i.cze = getelementptr inbounds nuw i8, ptr %i.cwy, i64 %.0116137.i.i275 ; 3 uses
  br label %bb.hp

bb.hp:                                            ; preds = %bb.ht, %.new1028
  %.0111135.i.i276 = phi i64 [ 0, %.new1028 ], [ %i.czu, %bb.ht ] ; 5 uses
  %.0114134.i.i277 = phi double [ f0x547D42AEA2879F2E, %.new1028 ], [ %.1115.i.i278.1, %bb.ht ] ; 2 uses
  %niter1038 = phi i64 [ 0, %.new1028 ], [ %niter1038.next.1, %bb.ht ]
  %i.czf = getelementptr inbounds nuw [8 x i8], ptr %i.czd, i64 %.0111135.i.i276
  %i.czg = load double, ptr %i.czf, align 8, !tbaa !65
  %i.czh = getelementptr inbounds nuw [8 x i8], ptr %i.cxe, i64 %.0111135.i.i276 ; 2 uses
  ...
  %i.czk = fcmp olt double %i.czj, %.0114134.i.i277
  br i1 %i.czk, label %bb.hq, label %bb.hr

bb.hq:                                            ; preds = %bb.hp
  %i.czl = trunc i64 %.0111135.i.i276 to i8
  store i8 %i.czl, ptr %i.cze, align 1, !tbaa !29
  br label %bb.hr

bb.hr:                                            ; preds = %bb.hq, %bb.hp
  %.1115.i.i278 = phi double [ %i.czj, %bb.hq ], [ %.0114134.i.i277, %bb.hp ] ; 2 uses
  %i.czm = or disjoint i64 %.0111135.i.i276, 1    ; 3 uses
  ...
  %i.czs = fcmp olt double %i.czr, %.1115.i.i278
...
bb.ht:                                            ; preds = %bb.hs, %bb.hr
  %.1115.i.i278.1 = phi double [ %i.czr, %bb.hs ], [ %.1115.i.i278, %bb.hr ] ; 4 uses
  %i.czu = add nuw nsw i64 %.0111135.i.i276, 2    ; 4 uses
