...
bb.ac:                                            ; preds = %bb.ab
  %3 = load i64, ptr %i.a, align 8, !tbaa !72
  %i.cb = invoke noundef nonnull align 8 dereferenceable(16) ptr @_ZN6duckdb6vectorINS_10shared_ptrINS_9CSVBufferELb1EEELb1ESaIS3_EEixEm(ptr noundef nonnull align 8 dereferenceable(24) %i.f, i64 noundef %3)
...
bb.am:                                            ; preds = %bb.ae
  %4 = load i64, ptr %i.a, align 8, !tbaa !72
  %i.dh = invoke noundef nonnull align 8 dereferenceable(16) ptr @_ZN6duckdb6vectorINS_10shared_ptrINS_9CSVBufferELb1EEELb1ESaIS3_EEixEm(ptr noundef nonnull align 8 dereferenceable(24) %i.f, i64 noundef %4)
...
.critedge:                                        ; preds = %.lr.ph.i.i, %bb.e, %..loopexit_crit_edge21.i.i, %.thread34
  ...
  store i64 %4, ptr %i.ad, align 8, !tbaa !72
