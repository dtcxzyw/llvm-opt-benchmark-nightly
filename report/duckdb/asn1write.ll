...
.preheader.i.i.1:                                 ; preds = %.preheader.i.i
  ...
  store i8 %i.x, ptr %i.z, align 1, !tbaa !12
  %i.aa = lshr i64 %i.m, 16                       ; 2 uses
  %.not22.i.i.1 = icmp eq i64 %i.aa, 0
  br i1 %.not22.i.i.1, label %bb.d, label %.preheader.i.i.2
...
.preheader.i.i.2:                                 ; preds = %.preheader.i.i.1
  ...
  store i8 %i.ab, ptr %i.ad, align 1, !tbaa !12
  %i.ae = lshr i64 %i.m, 24                       ; 2 uses
  %.not22.i.i.2 = icmp eq i64 %i.ae, 0
  br i1 %.not22.i.i.2, label %bb.d, label %.preheader.i.i.3
...
bb.d:                                             ; preds = %.preheader.i.i.3, %.preheader.i.i.2, %.preheader.i.i.1, %.preheader.i.i
  %i.ai = icmp samesign ugt i32 %.1.i.i, 1
  br i1 %i.ai, label %bb.e, label %mbedtls_asn1_write_len.exit.i

bb.e:                                             ; preds = %bb.d
  %i.aj = trunc i32 %.1.i.i to i8
  %i.ak = add i8 %i.aj, 127
  %i.al = load ptr, ptr %0, align 8, !tbaa !9
  %i.am = getelementptr inbounds i8, ptr %i.al, i64 -1 ; 2 uses
  store ptr %i.am, ptr %0, align 8, !tbaa !9
