...
define hidden i32 @mbedtls_asn1_write_mpi(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr noundef %2) local_unnamed_addr #4 {
bb.a:
  %i.a = tail call i64 @mbedtls_mpi_size(ptr noundef %2)
  ...
  br i1 %i.c, label %_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit, label %bb.b
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %i.g, label %_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.h = sub i64 0, %spec.store.select
  %i.i = getelementptr inbounds i8, ptr %i.b, i64 %i.h ; 2 uses
  store ptr %i.i, ptr %0, align 8, !tbaa !9
  %i.j = tail call i32 @mbedtls_mpi_write_binary(ptr noundef %2, ptr noundef nonnull %i.i, i64 noundef %spec.store.select) ; 2 uses
  %.not = icmp eq i32 %i.j, 0
  br i1 %.not, label %bb.d, label %_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit

bb.d:                                             ; preds = %bb.c
  %i.k = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.l = load i16, ptr %i.k, align 8, !tbaa !14
  %i.m = icmp eq i16 %i.l, 1
  br i1 %i.m, label %bb.e, label %bb.h

bb.e:                                             ; preds = %bb.d
  %i.n = load ptr, ptr %0, align 8, !tbaa !9      ; 3 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %i.r, label %_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit, label %bb.g
...
bb.h:                                             ; preds = %bb.g, %bb.e, %bb.d
  ...
  br i1 %i.u, label %_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit, label %bb.i
...
.loopexit.i.i:                                    ; preds = %.preheader23.i.i, %bb.i
  ...
  br i1 %i.ac, label %_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit, label %.preheader.i.i
...
.preheader.i.i:                                   ; preds = %.loopexit.i.i, %.preheader.i.i
  ...
  store i8 %i.ad, ptr %i.af, align 1, !tbaa !12
  %i.ag = lshr i64 %.018.i.i, 8                   ; 2 uses
  %.not22.i.i = icmp eq i64 %i.ag, 0
  br i1 %.not22.i.i, label %bb.j, label %.preheader.i.i, !llvm.loop !13
...
bb.k:                                             ; preds = %bb.j
  ...
  store ptr %i.al, ptr %0, align 8, !tbaa !9
  store i8 %i.aj, ptr %i.al, align 1, !tbaa !12
...
mbedtls_asn1_write_len.exit.i:                    ; preds = %bb.k, %bb.j
  ...
  br i1 %i.ap, label %_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit, label %bb.l
...
bb.l:                                             ; preds = %mbedtls_asn1_write_len.exit.i
  ...
  store i8 2, ptr %i.aq, align 1, !tbaa !12
  %i.ar = trunc nuw i64 %.0 to i32
  %i.as = add i32 %i.ar, 1
  %i.at = add i32 %i.as, %.1.i.i
  br label %_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit

_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit: ; preds = %bb.l, %mbedtls_asn1_write_len.exit.i, %.loopexit.i.i, %bb.h, %bb.c, %bb.f, %bb.a, %bb.b
...
define hidden range(i32 -108, 3) i32 @mbedtls_asn1_write_null(ptr nofree noundef captures(none) %0, ptr noundef %1) local_unnamed_addr #1 {
bb.a:
  ...
  br i1 %i.e, label %_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit, label %.preheader.i.i
...
.preheader.i.i:                                   ; preds = %bb.a
  ...
  br i1 %i.j, label %_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit, label %bb.b

bb.b:                                             ; preds = %.preheader.i.i
  %i.k = getelementptr inbounds i8, ptr %i.g, i64 -1 ; 2 uses
  store ptr %i.k, ptr %0, align 8, !tbaa !9
  store i8 5, ptr %i.k, align 1, !tbaa !12
  br label %_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit

_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit: ; preds = %bb.a, %.preheader.i.i, %bb.b
  %.0.i = phi i32 [ 2, %bb.b ], [ -108, %.preheader.i.i ], [ -108, %bb.a ]
  ret i32 %.0.i
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none, target_mem: none) uwtable
define hidden i32 @mbedtls_asn1_write_oid(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readonly captures(none) %2, i64 noundef %3) local_unnamed_addr #6 {
bb.a:
...
.preheader23.i.i.a:                               ; preds = %bb.c, %.preheader23.i.i.a
  ...
  br i1 %.not.i.i, label %.loopexit.i.i, label %.preheader23.i.i.a, !llvm.loop !7
...
.loopexit.i.i:                                    ; preds = %.preheader23.i.i.a, %bb.b, %bb.c
  ...
  br i1 %i.q, label %_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit, label %.preheader.i.i.a
...
.preheader.i.i.a:                                 ; preds = %.loopexit.i.i, %.preheader.i.i.a
  ...
  store ptr %i.t, ptr %0, align 8, !tbaa !9
  store i8 %i.r, ptr %i.t, align 1, !tbaa !12
  %i.u = lshr i64 %.018.i.i, 8                    ; 2 uses
  %.not22.i.i.a = icmp eq i64 %i.u, 0
  br i1 %.not22.i.i.a, label %bb.d, label %.preheader.i.i.a, !llvm.loop !13
...
mbedtls_asn1_write_len.exit.i:                    ; preds = %bb.e, %bb.d
  ...
  br i1 %i.ad, label %_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit, label %bb.f

bb.f:                                             ; preds = %mbedtls_asn1_write_len.exit.i
  %i.ae = getelementptr inbounds i8, ptr %i.aa, i64 -1 ; 2 uses
  store ptr %i.ae, ptr %0, align 8, !tbaa !9
  store i8 6, ptr %i.ae, align 1, !tbaa !12
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none, target_mem: none) uwtable
define hidden i32 @mbedtls_asn1_write_algorithm_identifier(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readonly captures(none) %2, i64 noundef %3, i64 noundef %4) local_unnamed_addr #6 {
bb.a:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none, target_mem: none) uwtable
define hidden i32 @mbedtls_asn1_write_algorithm_identifier_ext(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readonly captures(none) %2, i64 noundef %3, i64 noundef %4, i32 noundef %5) local_unnamed_addr #6 {
bb.a:
  %.not = icmp eq i32 %5, 0
...
bb.c:                                             ; preds = %bb.b
  ...
  br i1 %i.f, label %_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit, label %.preheader.i.i.i
...
bb.e:                                             ; preds = %bb.b, %bb.a, %bb.d
  ...
  br i1 %or.cond.i.i, label %_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit, label %bb.f
...
mbedtls_asn1_write_raw_buffer.exit.i:             ; preds = %bb.f
  ...
  br i1 %i.v, label %_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit, label %bb.g
...
.preheader23.i.i.i.a:                             ; preds = %bb.g, %.preheader23.i.i.i.a
  ...
  br i1 %.not.i.i.i, label %.loopexit.i.i.i, label %.preheader23.i.i.i.a, !llvm.loop !7
...
.loopexit.i.i.i:                                  ; preds = %.preheader23.i.i.i.a, %bb.g, %bb.f
  ...
  %i.ac = icmp slt i64 %i.ab, %i.y
  br i1 %i.ac, label %_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit, label %.preheader.i.i.i24.a
...
.preheader.i.i.i24.a:                             ; preds = %.loopexit.i.i.i, %.preheader.i.i.i24.a
  ...
  br i1 %.not22.i.i.i.a, label %bb.h, label %.preheader.i.i.i24.a, !llvm.loop !13
...
mbedtls_asn1_write_len.exit.i.i:                  ; preds = %bb.i, %bb.h
  ...
  %i.ap = icmp slt i64 %i.ao, 1
  br i1 %i.ap, label %_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit, label %mbedtls_asn1_write_oid.exit

mbedtls_asn1_write_oid.exit:                      ; preds = %mbedtls_asn1_write_len.exit.i.i
  %i.aq = getelementptr inbounds i8, ptr %i.am, i64 -1 ; 2 uses
  store ptr %i.aq, ptr %0, align 8, !tbaa !9
  store i8 6, ptr %i.aq, align 1, !tbaa !12
  %i.ar = add nuw i32 %9, 1
  %i.as = add i32 %i.ar, %.1.i.i.i                ; 3 uses
  %i.at = icmp slt i32 %i.as, 0
  br i1 %i.at, label %_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit, label %bb.j
...
bb.j:                                             ; preds = %mbedtls_asn1_write_oid.exit
  ...
  br i1 %i.aw, label %_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit, label %bb.k
...
.preheader23.i.i:                                 ; preds = %bb.k, %.preheader23.i.i
  ...
  br i1 %.not.i.i26, label %.loopexit.i.i, label %.preheader23.i.i, !llvm.loop !7

.loopexit.i.i:                                    ; preds = %.preheader23.i.i, %bb.k
  %.1.i.i = phi i32 [ 1, %bb.k ], [ %i.ay, %.preheader23.i.i ] ; 4 uses
  %i.ba = zext nneg i32 %.1.i.i to i64
  %i.bb = load ptr, ptr %0, align 8, !tbaa !9
  %i.bc = ptrtoint ptr %i.bb to i64
  %i.bd = sub i64 %i.bc, %i.p
  %i.be = icmp slt i64 %i.bd, %i.ba
  br i1 %i.be, label %_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit, label %.preheader.i.i
...
.preheader.i.i:                                   ; preds = %.loopexit.i.i, %.preheader.i.i
  ...
  store i8 %i.bf, ptr %i.bh, align 1, !tbaa !12
  %i.bi = lshr i64 %.018.i.i, 8                   ; 2 uses
  %.not22.i.i = icmp eq i64 %i.bi, 0
  br i1 %.not22.i.i, label %bb.l, label %.preheader.i.i, !llvm.loop !13
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.bm = load ptr, ptr %0, align 8, !tbaa !9
  %i.bn = getelementptr inbounds i8, ptr %i.bm, i64 -1 ; 2 uses
  store ptr %i.bn, ptr %0, align 8, !tbaa !9
...
mbedtls_asn1_write_len.exit.i:                    ; preds = %bb.m, %bb.l
  ...
  br i1 %i.br, label %_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit, label %bb.n
...
bb.n:                                             ; preds = %mbedtls_asn1_write_len.exit.i
  ...
  store i8 48, ptr %i.bs, align 1, !tbaa !12
  %i.bt = trunc nuw i64 %i.av to i32
  %i.bu = add i32 %i.bt, 1
  %i.bv = add i32 %i.bu, %.1.i.i
  br label %_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit

_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit: ; preds = %bb.e, %mbedtls_asn1_write_len.exit.i.i, %mbedtls_asn1_write_raw_buffer.exit.i, %.loopexit.i.i.i, %bb.c, %.preheader.i.i.i, %bb.n, %mbedtls_asn1_write_len.exit.i, %.loopexit.i.i, %bb.j, %mbedtls_asn1_write_oid.exit
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(write, argmem: readwrite, inaccessiblemem: none, target_mem: none) uwtable
define hidden range(i32 -108, 4) i32 @mbedtls_asn1_write_bool(ptr nofree noundef captures(none) %0, ptr noundef %1, i32 noundef %2) local_unnamed_addr #1 {
bb.a:
  %i.a = load ptr, ptr %0, align 8, !tbaa !9      ; 2 uses
  %i.b = ptrtoint ptr %i.a to i64
  ...
  %i.d = sub i64 %i.b, %i.c
  %i.e = icmp slt i64 %i.d, 1
  br i1 %i.e, label %_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit, label %bb.b
...
bb.b:                                             ; preds = %bb.a
  ...
  store ptr %i.g, ptr %0, align 8, !tbaa !9
  store i8 %i.f, ptr %i.g, align 1, !tbaa !12
  %i.h = load ptr, ptr %0, align 8, !tbaa !9      ; 2 uses
  %i.i = ptrtoint ptr %i.h to i64
  %i.j = sub i64 %i.i, %i.c
  %i.k = icmp slt i64 %i.j, 1
  br i1 %i.k, label %_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit, label %.preheader.i.i

.preheader.i.i:                                   ; preds = %bb.b
  %i.l = getelementptr inbounds i8, ptr %i.h, i64 -1 ; 2 uses
  store ptr %i.l, ptr %0, align 8, !tbaa !9
  store i8 1, ptr %i.l, align 1, !tbaa !12
  %i.m = load ptr, ptr %0, align 8, !tbaa !9      ; 2 uses
  %i.n = ptrtoint ptr %i.m to i64
  %i.o = sub i64 %i.n, %i.c
  %i.p = icmp slt i64 %i.o, 1
  br i1 %i.p, label %_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit, label %bb.c

bb.c:                                             ; preds = %.preheader.i.i
  %i.q = getelementptr inbounds i8, ptr %i.m, i64 -1 ; 2 uses
  store ptr %i.q, ptr %0, align 8, !tbaa !9
  store i8 1, ptr %i.q, align 1, !tbaa !12
  br label %_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit

_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit: ; preds = %bb.c, %.preheader.i.i, %bb.b, %bb.a
  %.0 = phi i32 [ -108, %bb.a ], [ 3, %bb.c ], [ -108, %.preheader.i.i ], [ -108, %bb.b ]
  ret i32 %.0
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none, target_mem: none) uwtable
define hidden i32 @mbedtls_asn1_write_int(ptr nofree noundef captures(none) %0, ptr noundef %1, i32 noundef %2) local_unnamed_addr #6 {
bb.a:
...
bb.b:                                             ; preds = %bb.c, %bb.a
  ...
  %i.d = sub i64 %i.c, %i.a
  %i.e = icmp slt i64 %i.d, 1
  br i1 %i.e, label %_ZL21asn1_write_tagged_intPPhPKhii.exit, label %bb.c
...
bb.c:                                             ; preds = %bb.b
  ...
  store ptr %i.h, ptr %0, align 8, !tbaa !9
  store i8 %i.g, ptr %i.h, align 1, !tbaa !12
  %i.i = ashr i32 %.017.i, 8                      ; 2 uses
  %i.j = icmp sgt i32 %i.i, 0
  br i1 %i.j, label %bb.b, label %bb.d, !llvm.loop !18

bb.d:                                             ; preds = %bb.c
  %i.k = load ptr, ptr %0, align 8, !tbaa !9      ; 3 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  br i1 %i.o, label %_ZL21asn1_write_tagged_intPPhPKhii.exit, label %bb.f
...
bb.g:                                             ; preds = %bb.f, %bb.d
  ...
  br i1 %i.r, label %_ZL21asn1_write_tagged_intPPhPKhii.exit, label %bb.h
...
.preheader23.i.i.i:                               ; preds = %bb.h, %.preheader23.i.i.i
  ...
  br i1 %.not.i.i.i, label %.loopexit.i.i.i, label %.preheader23.i.i.i, !llvm.loop !7
...
.loopexit.i.i.i:                                  ; preds = %.preheader23.i.i.i, %bb.h
  ...
  br i1 %i.z, label %_ZL21asn1_write_tagged_intPPhPKhii.exit, label %.preheader.i.i.i
...
.preheader.i.i.i:                                 ; preds = %.loopexit.i.i.i, %.preheader.i.i.i
  ...
  store ptr %i.ac, ptr %0, align 8, !tbaa !9
  store i8 %i.aa, ptr %i.ac, align 1, !tbaa !12
  %i.ad = lshr i64 %.018.i.i.i, 8                 ; 2 uses
  %.not22.i.i.i = icmp eq i64 %i.ad, 0
  br i1 %.not22.i.i.i, label %bb.i, label %.preheader.i.i.i, !llvm.loop !13
...
bb.j:                                             ; preds = %bb.i
  ...
  store i8 %i.ag, ptr %i.ai, align 1, !tbaa !12
  br label %mbedtls_asn1_write_len.exit.i.i
...
mbedtls_asn1_write_len.exit.i.i:                  ; preds = %bb.j, %bb.i
  ...
  br i1 %i.am, label %_ZL21asn1_write_tagged_intPPhPKhii.exit, label %bb.k

bb.k:                                             ; preds = %mbedtls_asn1_write_len.exit.i.i
  %i.an = getelementptr inbounds i8, ptr %i.aj, i64 -1 ; 2 uses
  store ptr %i.an, ptr %0, align 8, !tbaa !9
  store i8 2, ptr %i.an, align 1, !tbaa !12
  %i.ao = trunc nuw i64 %.1.i to i32
  %i.ap = add i32 %i.ao, 1
  %i.aq = add i32 %i.ap, %.1.i.i.i
  br label %_ZL21asn1_write_tagged_intPPhPKhii.exit

_ZL21asn1_write_tagged_intPPhPKhii.exit:          ; preds = %bb.b, %bb.e, %bb.g, %.loopexit.i.i.i, %mbedtls_asn1_write_len.exit.i.i, %bb.k
  %.016.i = phi i32 [ -108, %bb.e ], [ -108, %mbedtls_asn1_write_len.exit.i.i ], [ %i.aq, %bb.k ], [ -100, %bb.g ], [ -108, %.loopexit.i.i.i ], [ -108, %bb.b ]
  ret i32 %.016.i
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none, target_mem: none) uwtable
define hidden i32 @mbedtls_asn1_write_enum(ptr nofree noundef captures(none) %0, ptr noundef %1, i32 noundef %2) local_unnamed_addr #6 {
bb.a:
  %i.a = ptrtoint ptr %1 to i64                   ; 4 uses
  br label %bb.b
...
bb.k:                                             ; preds = %mbedtls_asn1_write_len.exit.i.i
  %i.an = getelementptr inbounds i8, ptr %i.aj, i64 -1 ; 2 uses
  store ptr %i.an, ptr %0, align 8, !tbaa !9
  store i8 10, ptr %i.an, align 1, !tbaa !12
  %i.ao = trunc nuw i64 %.1.i to i32
  %i.ap = add i32 %i.ao, 1
  %i.aq = add i32 %i.ap, %.1.i.i.i
  br label %_ZL21asn1_write_tagged_intPPhPKhii.exit
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none, target_mem: none) uwtable
define hidden i32 @mbedtls_asn1_write_tagged_string(ptr nofree noundef captures(none) %0, ptr noundef %1, i32 noundef %2, ptr nofree noundef readonly captures(none) %3, i64 noundef %4) local_unnamed_addr #6 {
bb.a:
  %i.a = load ptr, ptr %0, align 8, !tbaa !9      ; 3 uses
  %i.b = icmp ult ptr %i.a, %1
  %i.c = ptrtoint ptr %i.a to i64
...
.loopexit.i.i:                                    ; preds = %.preheader23.i.i.a, %bb.b, %bb.c
  ...
  br i1 %i.r, label %_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit, label %.preheader.i.i.a
...
.preheader.i.i.a:                                 ; preds = %.loopexit.i.i, %.preheader.i.i.a
  ...
  store i8 %i.s, ptr %i.u, align 1, !tbaa !12
...
bb.e:                                             ; preds = %bb.d
  ...
  store i8 %i.y, ptr %i.aa, align 1, !tbaa !12
  br label %mbedtls_asn1_write_len.exit.i

mbedtls_asn1_write_len.exit.i:                    ; preds = %bb.e, %bb.d
  %i.ab = load ptr, ptr %0, align 8, !tbaa !9     ; 2 uses
  %i.ac = ptrtoint ptr %i.ab to i64
  %i.ad = sub i64 %i.ac, %i.d
  %i.ae = icmp slt i64 %i.ad, 1
  br i1 %i.ae, label %_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit, label %bb.f

bb.f:                                             ; preds = %mbedtls_asn1_write_len.exit.i
  %i.af = getelementptr inbounds i8, ptr %i.ab, i64 -1 ; 2 uses
  store ptr %i.af, ptr %0, align 8, !tbaa !9
  store i8 %i.m, ptr %i.af, align 1, !tbaa !12
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none, target_mem: none) uwtable
define hidden i32 @mbedtls_asn1_write_utf8_string(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readonly captures(none) %2, i64 noundef %3) local_unnamed_addr #6 {
bb.a:
  %i.a = load ptr, ptr %0, align 8, !tbaa !9      ; 3 uses
  %i.b = icmp ult ptr %i.a, %1
  %i.c = ptrtoint ptr %i.a to i64
...
.preheader.i.i.i.a:                               ; preds = %.loopexit.i.i.i, %.preheader.i.i.i.a
  ...
  br i1 %.not22.i.i.i.a, label %bb.d, label %.preheader.i.i.i.a, !llvm.loop !13
...
bb.f:                                             ; preds = %mbedtls_asn1_write_len.exit.i.i
  %i.ae = getelementptr inbounds i8, ptr %i.aa, i64 -1 ; 2 uses
  store ptr %i.ae, ptr %0, align 8, !tbaa !9
  store i8 12, ptr %i.ae, align 1, !tbaa !12
  %i.af = add nuw i32 %7, 1
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none, target_mem: none) uwtable
define hidden i32 @mbedtls_asn1_write_printable_string(ptr nofree noundef captures(none) %0, ptr noundef %1, ptr nofree noundef readonly captures(none) %2, i64 noundef %3) local_unnamed_addr #6 {
bb.a:
  %i.a = load ptr, ptr %0, align 8, !tbaa !9      ; 3 uses
  %i.b = icmp ult ptr %i.a, %1
  %i.c = ptrtoint ptr %i.a to i64
...
bb.f:                                             ; preds = %mbedtls_asn1_write_len.exit.i.i
  %i.ae = getelementptr inbounds i8, ptr %i.aa, i64 -1 ; 2 uses
  store ptr %i.ae, ptr %0, align 8, !tbaa !9
  store i8 19, ptr %i.ae, align 1, !tbaa !12
  %i.af = add nuw i32 %7, 1
  %i.ag = add i32 %i.af, %.1.i.i.i
  br label %mbedtls_asn1_write_tagged_string.exit
...
bb.f:                                             ; preds = %mbedtls_asn1_write_len.exit.i.i
  %i.ae = getelementptr inbounds i8, ptr %i.aa, i64 -1 ; 2 uses
  store ptr %i.ae, ptr %0, align 8, !tbaa !9
  store i8 22, ptr %i.ae, align 1, !tbaa !12
  %i.af = add nuw i32 %7, 1
  %i.ag = add i32 %i.af, %.1.i.i.i
  br label %mbedtls_asn1_write_tagged_string.exit
...
.lr.ph:                                           ; preds = %bb.d
  ...
  br i1 %i.p, label %.loopexit, label %.lr.ph35, !llvm.loop !19
...
.loopexit:                                        ; preds = %.lr.ph, %.lr.ph.preheader, %..loopexit.loopexit_crit_edge, %bb.b, %bb.a
  %.1 = phi i64 [ 0, %bb.a ], [ %3, %bb.b ], [ %i.q, %..loopexit.loopexit_crit_edge ], [ 0, %.lr.ph.preheader ], [ 0, %.lr.ph ]
...
bb.f:                                             ; preds = %mbedtls_asn1_write_len.exit.i
  %i.ae = getelementptr inbounds i8, ptr %i.aa, i64 -1 ; 2 uses
  store ptr %i.ae, ptr %0, align 8, !tbaa !9
  store i8 4, ptr %i.ae, align 1, !tbaa !12
  %i.af = add nuw i32 %7, 1
  %i.ag = add i32 %i.af, %.1.i.i
  br label %_ZL30mbedtls_asn1_write_len_and_tagPPhPKhmh.exit
...
; Function Attrs: mustprogress uwtable
define hidden ptr @mbedtls_asn1_store_named_data(ptr nofree noundef captures(none) %0, ptr noundef %1, i64 noundef %2, ptr nofree noundef readonly captures(address_is_null) %3, i64 noundef %4) local_unnamed_addr #4 {
bb.a:
