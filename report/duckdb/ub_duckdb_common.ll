begin_hunk_0
  ...
  %7 = alloca %"class.duckdb::unique_ptr.1654", align 8 ; 11 uses
...
bb.bk:                                            ; preds = %bb.c
  %i.ey = load ptr, ptr %i.h, align 8, !tbaa !2578 ; 2 uses
...
bb.bl:                                            ; preds = %bb.bk
  ...
  %i.ez = load ptr, ptr %i.g, align 8, !tbaa !1995
...
bb.bo:                                            ; preds = %_ZNKSt8functionIFvP11__dirstreamEEclES1_.exit.i, %bb.bk
  store ptr null, ptr %i.h, align 8, !tbaa !2578
  %i.fb = load ptr, ptr %i.g, align 8, !tbaa !1995 ; 2 uses
...
bb.af:                                            ; preds = %bb.ba, %.lr.ph.i81
  %.079.i = phi i64 [ 0, %.lr.ph.i81 ], [ %i.ss, %bb.ba ] ; 6 uses
  %.sroa.0.078.i = phi i64 [ %9, %.lr.ph.i81 ], [ %.sroa.0.2.i, %bb.ba ] ; 4 uses
  %.sroa.17.076.i = phi i64 [ -1, %.lr.ph.i81 ], [ %.sroa.17.1.i, %bb.ba ] ; 5 uses
  %.sroa.13.074.i = phi i64 [ %i.ki, %.lr.ph.i81 ], [ %.sroa.13.1.i, %bb.ba ] ; 5 uses
  %.sroa.10.073.i = phi i64 [ 0, %.lr.ph.i81 ], [ %.sroa.10.1.i, %bb.ba ] ; 12 uses
  %10 = getelementptr inbounds nuw i8, ptr %i.au, i64 %.079.i
  %11 = load i8, ptr %10, align 1, !tbaa !75, !noalias !6347 ; 12 uses
  %12 = lshr i64 %.079.i, 6                       ; 4 uses
  %13 = and i64 %.079.i, 63                       ; 4 uses
  %i.kp = icmp eq i64 %.sroa.0.078.i, 1
  br i1 %i.kp, label %bb.ag, label %bb.ak

bb.ag:                                            ; preds = %bb.af
  %i.kq = icmp sgt i8 %11, -1
  br i1 %i.kq, label %bb.ah, label %bb.ai

bb.ah:                                            ; preds = %bb.ag
  %i.kr = zext nneg i8 %11 to i64
  %i.ks = mul nsw i64 %i.kn, %i.kr
  %i.kt = getelementptr [8 x i8], ptr %i.km, i64 %i.ks
  %i.ku = getelementptr [8 x i8], ptr %i.kt, i64 %.sroa.10.073.i
...
bb.ai:                                            ; preds = %bb.ag
  %i.kw = getelementptr inbounds nuw [2048 x i8], ptr %i.kj, i64 %.sroa.10.073.i ; 3 uses
  %i.kx = sext i8 %11 to i64                      ; 7 uses
...
_ZNK19duckdb_jaro_winkler6common23BlockPatternMatchVector3getIcEEmlT_.exit.i.i: ; preds = %.lr.ph.i.i.i.i.i, %._ZNK19duckdb_jaro_winkler6common16BitvectorHashmap3getIcEEmT_.exit.loopexit_crit_edge.i.i.i, %.lr.ph.i.i.preheader.i.i.i, %.preheader.i.i.i.i.i, %bb.aj, %bb.ai, %bb.ah
  ...
  %i.ly = and i64 %14, %.sroa.13.074.i            ; 2 uses
  %i.lz = getelementptr inbounds nuw [8 x i8], ptr %i.ke, i64 %.sroa.10.073.i ; 2 uses
...
begin_hunk_31
  ...
  %i.mi = shl nuw i64 %i.mh, %13
  %i.mj = getelementptr inbounds nuw [8 x i8], ptr %i.jt, i64 %12 ; 2 uses
...
bb.an:                                            ; preds = %bb.al
  %i.ms = getelementptr inbounds nuw [2048 x i8], ptr %i.kj, i64 %.sroa.10.073.i ; 3 uses
  %i.mt = sext i8 %11 to i64                      ; 7 uses
...
_ZNK19duckdb_jaro_winkler6common23BlockPatternMatchVector3getIcEEmlT_.exit74.i.i: ; preds = %.lr.ph.i.i.i71.i.i, %._ZNK19duckdb_jaro_winkler6common16BitvectorHashmap3getIcEEmT_.exit.loopexit_crit_edge.i73.i.i, %.lr.ph.i.i.preheader.i67.i.i, %.preheader.i.i.i65.i.i, %bb.ao, %bb.an, %bb.am
  ...
  %i.nu = getelementptr inbounds nuw [8 x i8], ptr %i.ke, i64 %.sroa.10.073.i ; 2 uses
  %i.nv = load i64, ptr %i.nu, align 8, !tbaa !32 ; 2 uses
  %i.nw = xor i64 %i.nv, -1
  %i.nx = and i64 %.0.i72.i.i, %i.nw
  %i.ny = and i64 %i.nx, %.sroa.17.076.i          ; 3 uses
...
.thread.i.i:                                      ; preds = %_ZNK19duckdb_jaro_winkler6common23BlockPatternMatchVector3getIcEEmlT_.exit74.i.i
  %i.nz = add nsw i64 %.sroa.10.073.i, 1
  br label %bb.aq
...
begin_hunk_33
  ...
  %i.od = shl nuw i64 1, %13
  %i.oe = getelementptr inbounds nuw [8 x i8], ptr %i.jt, i64 %12 ; 2 uses
...
bb.aq:                                            ; preds = %.thread.i.i, %bb.ak
  %.1.i.i = phi i64 [ %i.nz, %.thread.i.i ], [ %.sroa.10.073.i, %bb.ak ] ; 4 uses
  %i.oh = add i64 %.sroa.0.078.i, -1
  %i.oi = add i64 %i.oh, %.sroa.10.073.i          ; 5 uses
  %i.oj = icmp slt i64 %.1.i.i, %i.oi
  br i1 %i.oj, label %.lr.ph.i.i86, label %._crit_edge.i.i

.lr.ph.i.i86:                                     ; preds = %bb.aq
  %i.ok = icmp sgt i8 %11, -1
  %i.ol = sext i8 %11 to i64                      ; 7 uses
...
begin_hunk_34
  ...
  %i.qg = shl nuw i64 1, %13
  %i.qh = getelementptr inbounds nuw [8 x i8], ptr %i.jt, i64 %12 ; 2 uses
...
bb.as:                                            ; preds = %._crit_edge.i.i
  %i.qm = icmp sgt i8 %11, -1
  br i1 %i.qm, label %bb.at, label %bb.au

bb.at:                                            ; preds = %bb.as
  %i.qn = zext nneg i8 %11 to i64
...
begin_hunk_37
  ...
  %i.ry = and i64 %i.rx, %.sroa.13.074.i          ; 3 uses
  %i.rz = sub i64 0, %i.ry
  ...
  %i.se = shl nuw i64 %i.sd, %13
  %i.sf = getelementptr inbounds nuw [8 x i8], ptr %i.jt, i64 %12 ; 2 uses
...
_ZN19duckdb_jaro_winkler6detailL28flag_similar_characters_stepIcEEvRKNS_6common23BlockPatternMatchVectorET_RNS0_21FlaggedCharsMultiwordElNS0_15SearchBoundMaskE.exit.i: ; preds = %_ZNK19duckdb_jaro_winkler6common23BlockPatternMatchVector3getIcEEmlT_.exit96.i.i, %._crit_edge.i.i, %.split.us.i.i, %bb.ap, %_ZNK19duckdb_jaro_winkler6common23BlockPatternMatchVector3getIcEEmlT_.exit.i.i
  %i.si = add nsw i64 %.079.i, %.0.i52            ; 2 uses
...
bb.aw:                                            ; preds = %_ZN19duckdb_jaro_winkler6detailL28flag_similar_characters_stepIcEEvRKNS_6common23BlockPatternMatchVectorET_RNS0_21FlaggedCharsMultiwordElNS0_15SearchBoundMaskE.exit.i
  %i.sl = shl i64 %.sroa.13.074.i, 1              ; 2 uses
  %i.sm = or disjoint i64 %i.sl, 1
  %i.sn = add nsw i64 %i.si, 2
  %i.so = icmp slt i64 %i.sn, %i.aw
  %i.sp = icmp eq i64 %i.sl, -2
  %or.cond.i85 = select i1 %i.so, i1 %i.sp, i1 false ; 2 uses
  %spec.select.i = select i1 %or.cond.i85, i64 0, i64 %i.sm
  %15 = zext i1 %or.cond.i85 to i64
...
bb.ay:                                            ; preds = %bb.ax
  %i.sq = shl i64 %.sroa.17.076.i, 1              ; 2 uses
...
bb.ba:                                            ; preds = %bb.az, %bb.ay, %bb.ax
  ...
  %.sroa.17.1.i = phi i64 [ %.sroa.17.076.i, %bb.ax ], [ -1, %bb.az ], [ %i.sq, %bb.ay ]
