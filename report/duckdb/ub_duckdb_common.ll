...
begin_hunk_0_@_ZN6duckdb10StringUtil16SimilarityRatingERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES8_:bb.a
  ...
  %.sroa.speculated45.i.i = tail call i64 @llvm.smin.i64(i64 %i.f, i64 %i.c) ; 5 uses
  %.sroa.speculated45.i.i.a = tail call i64 @llvm.smin.i64(i64 %.sroa.speculated45.i.i, i64 4) ; 4 uses
  %i.g = icmp sgt i64 %.sroa.speculated45.i.i, 0
...
bb.b:                                             ; preds = %.lr.ph.preheader.i.i
  %exitcond.not.i.i = icmp eq i64 %.sroa.speculated45.i.i, 1
...
bb.c:                                             ; preds = %.lr.ph.i.i.1
  %exitcond.not.i.i.1 = icmp eq i64 %.sroa.speculated45.i.i, 2
...
bb.d:                                             ; preds = %.lr.ph.i.i.2
  %exitcond.not.i.i.2 = icmp eq i64 %.sroa.speculated45.i.i, 3
...
begin_hunk_3_@_ZN6duckdb10StringUtil16SimilarityRatingERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES8_:bb.a
  ...
  %spec.select = select i1 %.not.i.i.3, i64 %.sroa.speculated45.i.i.a, i64 3
...
._crit_edge.loopexit.i.i:                         ; preds = %.lr.ph.i.i.3, %bb.d, %.lr.ph.i.i.2, %bb.c, %.lr.ph.i.i.1, %bb.b, %.lr.ph.preheader.i.i
  %.030.lcssa.ph.i.i = phi i64 [ %.sroa.speculated45.i.i.a, %bb.b ], [ 0, %.lr.ph.preheader.i.i ], [ 1, %.lr.ph.i.i.1 ], [ %.sroa.speculated45.i.i.a, %bb.c ], [ 2, %.lr.ph.i.i.2 ], [ %.sroa.speculated45.i.i.a, %bb.d ], [ %spec.select, %.lr.ph.i.i.3 ]
...
begin_hunk_4_@_ZN6duckdb10StringUtil15TopNJaroWinklerERKNS_6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEELb1ESaIS7_EEERKS7_md:bb.a
  ...
  %.sroa.speculated45.i.i.i = call i64 @llvm.smin.i64(i64 %i.aq, i64 %i.ao) ; 5 uses
  %.sroa.speculated45.i.i.i.a = call i64 @llvm.smin.i64(i64 %.sroa.speculated45.i.i.i, i64 4) ; 4 uses
  %i.ar = icmp sgt i64 %.sroa.speculated45.i.i.i, 0
...
bb.i:                                             ; preds = %.lr.ph.preheader.i.i.i
  %exitcond.not.i.i.i = icmp eq i64 %.sroa.speculated45.i.i.i, 1
...
bb.j:                                             ; preds = %.lr.ph.i.i.i.1
  %exitcond.not.i.i.i.1 = icmp eq i64 %.sroa.speculated45.i.i.i, 2
...
bb.k:                                             ; preds = %.lr.ph.i.i.i.2
  %exitcond.not.i.i.i.2 = icmp eq i64 %.sroa.speculated45.i.i.i, 3
...
begin_hunk_7_@_ZN6duckdb10StringUtil15TopNJaroWinklerERKNS_6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEELb1ESaIS7_EEERKS7_md:bb.a
  ...
  %spec.select = select i1 %.not.i.i.i.3, i64 %.sroa.speculated45.i.i.i.a, i64 3
...
._crit_edge.loopexit.i.i.i:                       ; preds = %.lr.ph.i.i.i.3, %bb.k, %.lr.ph.i.i.i.2, %bb.j, %.lr.ph.i.i.i.1, %bb.i, %.lr.ph.preheader.i.i.i
  %.030.lcssa.ph.i.i.i = phi i64 [ %.sroa.speculated45.i.i.i.a, %bb.i ], [ 0, %.lr.ph.preheader.i.i.i ], [ 1, %.lr.ph.i.i.i.1 ], [ %.sroa.speculated45.i.i.i.a, %bb.j ], [ 2, %.lr.ph.i.i.i.2 ], [ %.sroa.speculated45.i.i.i.a, %bb.k ], [ %spec.select, %.lr.ph.i.i.i.3 ]
