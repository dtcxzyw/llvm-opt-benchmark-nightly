...
.lr.ph.i79:                                       ; preds = %_ZNSt6vectorImSaImEE6resizeEm.exit34.i
  ...
  %i.kb = load ptr, ptr %6, align 8, !noalias !6926 ; 4 uses
...
bb.af:                                            ; preds = %bb.ba, %.lr.ph.i79
  ...
  %12 = load i8, ptr %11, align 1, !tbaa !79, !noalias !6926 ; 12 uses
...
bb.az:                                            ; preds = %bb.ay
  ...
  %.sroa.037.8.vec.insert.i503 = shufflevector <4 x i64> %18, <4 x i64> %.sroa.037.24.vec.insert.i, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  br label %bb.ba

bb.ba:                                            ; preds = %bb.az, %bb.ay, %bb.ax
  %.sroa.037.2.i = phi <4 x i64> [ %.sroa.037.1.i, %bb.ax ], [ %.sroa.037.8.vec.insert.i503, %bb.az ], [ %.sroa.037.24.vec.insert56.i, %bb.ay ]
  %i.si = add nuw nsw i64 %.sroa.0.078.i, 1       ; 2 uses
  %exitcond.not.i82 = icmp eq i64 %i.si, %i.av
  br i1 %exitcond.not.i82, label %_ZN19duckdb_jaro_winkler6detailL29flag_similar_characters_blockIPKcS3_EENS0_21FlaggedCharsMultiwordERKNS_6common23BlockPatternMatchVectorET_S9_T0_SA_l.exit, label %bb.af, !llvm.loop !6930
