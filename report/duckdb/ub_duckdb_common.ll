...
bb.bk:                                            ; preds = %bb.c
  %i.fb = load ptr, ptr %i.h, align 8, !tbaa !2767 ; 2 uses
...
bb.bl:                                            ; preds = %bb.bk
  ...
  %i.fc = load ptr, ptr %i.g, align 8, !tbaa !2133
...
bb.bo:                                            ; preds = %_ZNKSt8functionIFvP11__dirstreamEEclES1_.exit.i, %bb.bk
  store ptr null, ptr %i.h, align 8, !tbaa !2767
  %i.fe = load ptr, ptr %i.g, align 8, !tbaa !2133 ; 2 uses
...
bb.af:                                            ; preds = %bb.ba, %.lr.ph.i79
  ...
  %11 = load i8, ptr %10, align 1, !tbaa !79, !noalias !6923 ; 12 uses
