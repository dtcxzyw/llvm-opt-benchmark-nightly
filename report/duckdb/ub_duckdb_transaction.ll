...
begin_hunk_0_@_ZN6duckdb11CommitState15CommitEntryDropERNS_12CatalogEntryEPh:bb.a
  ...
  %i.ap = invoke noundef zeroext i1 %i.ao(ptr noundef nonnull align 8 dereferenceable(632) %5)
          to label %.noexc54 unwind label %bb.n, !inline_history !927
...
.noexc56:                                         ; preds = %.noexc55
  %i.at = load ptr, ptr %3, align 8, !tbaa !928, !noalias !924 ; 2 uses
...
begin_hunk_2_@_ZN6duckdb11CommitState15CommitEntryDropERNS_12CatalogEntryEPh:bb.a
  ...
  call void %i.bc(ptr noundef nonnull align 8 dead_on_return(9) dereferenceable(9) %.sink8.i) #33, !noalias !921, !inline_history !927
  br label %.body57
...
begin_hunk_3_@_ZN6duckdb13WALWriteState17WriteCatalogEntryERNS_12CatalogEntryEPh:bb.a
  ...
  %i.ap = invoke noundef zeroext i1 %i.ao(ptr noundef nonnull align 8 dereferenceable(632) %5)
          to label %.noexc71 unwind label %bb.p, !inline_history !927
...
.noexc73:                                         ; preds = %.noexc72
  %i.at = load ptr, ptr %3, align 8, !tbaa !928, !noalias !978 ; 3 uses
  store ptr %i.at, ptr %7, align 8, !tbaa !928, !alias.scope !978
...
begin_hunk_5_@_ZN6duckdb13WALWriteState17WriteCatalogEntryERNS_12CatalogEntryEPh:bb.a
  ...
  call void %i.bd(ptr noundef nonnull align 8 dead_on_return(9) dereferenceable(9) %.sink8.i) #33, !noalias !970, !inline_history !927
  br label %.body74
...
bb.l:                                             ; preds = %bb.k
  %i.bl = load ptr, ptr %7, align 8, !tbaa !928   ; 3 uses
...
bb.r:                                             ; preds = %bb.k, %_ZN6duckdb18BinaryDeserializer3EndEv.exit
  %i.bx = landingpad { ptr, i32 }
          cleanup
  %.pre = load ptr, ptr %7, align 8, !tbaa !928
  br label %bb.s
...
bb.a:
  ...
  %i.a = load ptr, ptr %0, align 8, !tbaa !928    ; 2 uses
...
!927 = distinct !{null}
!928 = !{!929, !929, i64 0}
!929 = !{!"p1 _ZTSN6duckdb9ParseInfoE", !9, i64 0}
...
!976 = !{!977, !929, i64 0}
!977 = !{!"_ZTSSt10_Head_baseILm0EPN6duckdb9ParseInfoELb0EE", !929, i64 0}
!978 = !{!974, !971}
!979 = !{!980}
