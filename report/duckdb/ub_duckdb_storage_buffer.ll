...
select.unfold:                                    ; preds = %bb.f, %.lr.ph47, %_ZN17duckdb_moodycamel15ConcurrentQueueIN6duckdb18BufferEvictionNodeENS_28ConcurrentQueueDefaultTraitsEE12ProducerBase7dequeueIS2_EEbRT_.exit37
  ...
  %i.ag = load ptr, ptr %i.af, align 8, !tbaa !250
  %.fr = freeze ptr %i.ag                         ; 2 uses
  %i.ah = icmp eq ptr %.fr, null
  %i.ai = getelementptr inbounds i8, ptr %.fr, i64 -8
...
bb.a:
  ...
  %.not.i.i = icmp eq i32 %i.b, 0
  br i1 %.not.i.i, label %bb.b, label %_ZNSt11unique_lockISt5mutexED2Ev.exit32
...
select.unfold.i:                                  ; preds = %bb.b, %select.unfold.i
  ...
  %.fr.i = freeze ptr %i.o                        ; 2 uses
  %i.p = icmp eq ptr %.fr.i, null
  %i.q = getelementptr inbounds i8, ptr %.fr.i, i64 -8
...
select.unfold.i24:                                ; preds = %bb.d, %select.unfold.i24
  ...
  %.fr.i27 = freeze ptr %i.af                     ; 2 uses
  %i.ag = icmp eq ptr %.fr.i27, null
  %i.ah = getelementptr inbounds i8, ptr %.fr.i27, i64 -8
  br i1 %i.ag, label %_ZNK17duckdb_moodycamel15ConcurrentQueueIN6duckdb18BufferEvictionNodeENS_28ConcurrentQueueDefaultTraitsEE11size_approxEv.exit29, label %select.unfold.i24

_ZNK17duckdb_moodycamel15ConcurrentQueueIN6duckdb18BufferEvictionNodeENS_28ConcurrentQueueDefaultTraitsEE11size_approxEv.exit29: ; preds = %select.unfold.i24
...
bb.e:                                             ; preds = %_ZNK17duckdb_moodycamel15ConcurrentQueueIN6duckdb18BufferEvictionNodeENS_28ConcurrentQueueDefaultTraitsEE11size_approxEv.exit29
  ...
  %i.aq = add nsw i64 %.02047, -1                 ; 2 uses
  %.not = icmp eq i64 %i.aq, 0
  %or.cond = select i1 %i.ap, i1 true, i1 %.not
  br i1 %or.cond, label %.thread, label %.lr.ph

.thread:                                          ; preds = %bb.d, %bb.e, %_ZNK17duckdb_moodycamel15ConcurrentQueueIN6duckdb18BufferEvictionNodeENS_28ConcurrentQueueDefaultTraitsEE11size_approxEv.exit29, %bb.c, %bb.b, %_ZNK17duckdb_moodycamel15ConcurrentQueueIN6duckdb18BufferEvictionNodeENS_28ConcurrentQueueDefaultTraitsEE11size_approxEv.exit
...
_ZNSt11unique_lockISt5mutexED2Ev.exit32:          ; preds = %bb.a, %.thread
  ret void
}
...
; Function Attrs: mustprogress uwtable
define void @_ZN6duckdb10BufferPool19EvictBlocksInternalERNS_13EvictionQueueENS_9MemoryTagEmmPNS_10unique_ptrINS_10FileBufferESt14default_deleteIS5_ELb1EEE(ptr dead_on_unwind noalias writable writeonly sret(%"struct.duckdb::BufferPool::EvictionResult") align 8 captures(none) %0, ptr noundef nonnull align 8 dereferenceable(8984) %1, ptr noundef nonnull align 8 dereferenceable(728) %2, i8 noundef zeroext %3, i64 noundef %4, i64 noundef %5, ptr noundef captures(address_is_null) %6) unnamed_addr #6 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
...
.lr.ph.i.i:                                       ; preds = %.backedge.i, %.lr.ph.i.i
  ...
  %.02441.i.i = phi i64 [ %.2.i.i, %.lr.ph.i.i ], [ 0, %.backedge.i ] ; 3 uses
  ...
  %.not34.i.i = icmp ne i64 %i.bd, 0              ; 3 uses
  ...
  %.2.i.i = select i1 %.not34.i.i, i64 %spec.select35.i.i, i64 %.02441.i.i
...
select.unfold.i.i:                                ; preds = %.noexc19.i, %.noexc18.i, %.lr.ph47.i.i
  ...
  %i.cb = icmp eq ptr %.fr.i.i, null
  %i.cc = getelementptr inbounds i8, ptr %.fr.i.i, i64 -8
...
; Function Attrs: mustprogress uwtable
define noundef i64 @_ZN6duckdb10BufferPool15PurgeAgedBlocksEj(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(8984) %0, i32 noundef %1) local_unnamed_addr #6 align 2 {
bb.a:
...
; Function Attrs: mustprogress uwtable
define noundef i64 @_ZN6duckdb10BufferPool23PurgeAgedBlocksInternalERNS_13EvictionQueueEjll(ptr nonnull readnone align 8 captures(none) %0, ptr noundef nonnull align 8 dereferenceable(728) %1, i32 %2, i64 noundef %3, i64 noundef %4) local_unnamed_addr #6 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
...
.lr.ph.i.i:                                       ; preds = %.backedge.i, %.lr.ph.i.i
  ...
  %.not34.i.i = icmp ne i64 %i.r, 0               ; 3 uses
...
select.unfold.i.i:                                ; preds = %.noexc19.i, %.noexc18.i, %.lr.ph47.i.i
  ...
  %.fr.i.i = freeze ptr %i.ao                     ; 2 uses
  %i.ap = icmp eq ptr %.fr.i.i, null
  %i.aq = getelementptr inbounds i8, ptr %.fr.i.i, i64 -8
