...
vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %i.kr, 4611686018427387900     ; 4 uses
  %i.kv = shl i64 %n.vec, 3
  %i.kw = getelementptr i8, ptr %i.kl, i64 %i.kv  ; 2 uses
  %32 = shl i64 %n.vec, 3
  %i.kx = getelementptr i8, ptr %i.ka, i64 %32
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %offset.idx175 = shl i64 %index, 3
  %next.gep176 = getelementptr i8, ptr %i.ka, i64 %offset.idx175 ; 4 uses
...
vector.ph364:                                     ; preds = %vector.memcheck354
  %n.vec366 = and i64 %i.ap, 4611686018427387900  ; 4 uses
  %i.at = shl i64 %n.vec366, 3
  %i.au = getelementptr i8, ptr %i.ak, i64 %i.at  ; 2 uses
  %13 = shl i64 %n.vec366, 3
  %i.av = getelementptr i8, ptr %i.z, i64 %13
  br label %vector.body367

vector.body367:                                   ; preds = %vector.body367, %vector.ph364
  %index368 = phi i64 [ 0, %vector.ph364 ], [ %index.next375, %vector.body367 ] ; 3 uses
  %offset.idx369 = shl i64 %index368, 3
  %next.gep370 = getelementptr i8, ptr %i.ak, i64 %offset.idx369 ; 2 uses
  %offset.idx371 = shl i64 %index368, 3
  %next.gep372 = getelementptr i8, ptr %i.z, i64 %offset.idx371 ; 4 uses
...
vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %i.co, 4611686018427387900     ; 4 uses
  %i.cs = shl i64 %n.vec, 3
  %i.ct = getelementptr i8, ptr %i.cj, i64 %i.cs  ; 2 uses
  %14 = shl i64 %n.vec, 3
  %i.cu = getelementptr i8, ptr %i.by, i64 %14
  br label %vector.body
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %offset.idx350 = shl i64 %index, 3
  %next.gep351 = getelementptr i8, ptr %i.by, i64 %offset.idx350 ; 4 uses
...
vector.ph184:                                     ; preds = %vector.memcheck174
  %n.vec186 = and i64 %i.au, 4611686018427387900  ; 4 uses
  %i.ay = shl i64 %n.vec186, 3
  %i.az = getelementptr i8, ptr %i.ao, i64 %i.ay  ; 2 uses
  %9 = shl i64 %n.vec186, 3
  %i.ba = getelementptr i8, ptr %i.ad, i64 %9
  br label %vector.body187

vector.body187:                                   ; preds = %vector.body187, %vector.ph184
  %index188 = phi i64 [ 0, %vector.ph184 ], [ %index.next195, %vector.body187 ] ; 3 uses
  %offset.idx189 = shl i64 %index188, 3
  %next.gep190 = getelementptr i8, ptr %i.ao, i64 %offset.idx189 ; 2 uses
  %offset.idx191 = shl i64 %index188, 3
  %next.gep192 = getelementptr i8, ptr %i.ad, i64 %offset.idx191 ; 4 uses
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %i.db = shl i64 %n.vec, 3
  %i.dc = getelementptr i8, ptr %i.cr, i64 %i.db  ; 2 uses
  %10 = shl i64 %n.vec, 3
  %i.dd = getelementptr i8, ptr %i.cg, i64 %10
  br label %vector.body
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep171 = getelementptr i8, ptr %i.cg, i64 %offset.idx170 ; 4 uses
...
vector.ph2798:                                    ; preds = %.lr.ph.i.i.i.i.i.i.preheader
  %n.vec2800 = and i64 %i.hh, 4611686018427387900 ; 4 uses
  %i.hj = shl i64 %n.vec2800, 3
  %i.hk = getelementptr i8, ptr %i.hb, i64 %i.hj  ; 2 uses
  %45 = shl i64 %n.vec2800, 3
  %i.hl = getelementptr i8, ptr %.sroa.0751.01215, i64 %45
  br label %vector.body2801

vector.body2801:                                  ; preds = %vector.body2801, %vector.ph2798
  %index2802 = phi i64 [ 0, %vector.ph2798 ], [ %index.next2809, %vector.body2801 ] ; 3 uses
  %offset.idx2803 = shl i64 %index2802, 3
  %next.gep2804 = getelementptr i8, ptr %i.hb, i64 %offset.idx2803 ; 2 uses
  %offset.idx2805 = shl i64 %index2802, 3
  %next.gep2806 = getelementptr i8, ptr %.sroa.0751.01215, i64 %offset.idx2805 ; 2 uses
...
vector.ph2779:                                    ; preds = %vector.memcheck2769
  %n.vec2781 = and i64 %i.jb, 4611686018427387900 ; 4 uses
  %i.jf = shl i64 %n.vec2781, 3
  %i.jg = getelementptr i8, ptr %i.iv, i64 %i.jf  ; 2 uses
  %46 = shl i64 %n.vec2781, 3
  %i.jh = getelementptr i8, ptr %.sroa.0732.01218, i64 %46
  br label %vector.body2782

vector.body2782:                                  ; preds = %vector.body2782, %vector.ph2779
  %index2783 = phi i64 [ 0, %vector.ph2779 ], [ %index.next2790, %vector.body2782 ] ; 3 uses
  %offset.idx2784 = shl i64 %index2783, 3
  %next.gep2785 = getelementptr i8, ptr %i.iv, i64 %offset.idx2784 ; 2 uses
  %offset.idx2786 = shl i64 %index2783, 3
  %next.gep2787 = getelementptr i8, ptr %.sroa.0732.01218, i64 %offset.idx2786 ; 4 uses
...
vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %i.ane, 4611686018427387900    ; 4 uses
  %i.ani = shl i64 %n.vec, 3
  %i.anj = getelementptr i8, ptr %i.amy, i64 %i.ani ; 2 uses
  %47 = shl i64 %n.vec, 3
  %i.ank = getelementptr i8, ptr %i.amn, i64 %47
  br label %vector.body
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %offset.idx2765 = shl i64 %index, 3
  %next.gep2766 = getelementptr i8, ptr %i.amn, i64 %offset.idx2765 ; 4 uses
...
vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %i.pi, 4611686018427387900     ; 4 uses
  %i.pn = shl i64 %n.vec, 3
  %i.po = getelementptr i8, ptr %i.pc, i64 %i.pn  ; 2 uses
  %12 = shl i64 %n.vec, 3
  %i.pp = getelementptr i8, ptr %i.or, i64 %12
  br label %vector.body
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %offset.idx108 = shl i64 %index, 3
  %next.gep109 = getelementptr i8, ptr %i.or, i64 %offset.idx108 ; 4 uses
