...
.thread1721:                                      ; preds = %bb.s, %.thread1714
  ...
  %i.hz = sub i64 %i.hv, %i.hw
  %8 = trunc i64 %i.hz to i32
  %9 = sub i64 %i.hy, %i.ak
  %i.ia = trunc i64 %9 to i32
  %i.ib = insertelement <2 x i32> poison, i32 %8, i64 0
...
bb.y:                                             ; preds = %.thread1734, %bb.v
  ...
  %i.kb = sub i64 %i.jx, %i.jy
  %10 = trunc i64 %i.kb to i32
  %11 = sub i64 %i.ka, %i.ak
  %i.kc = trunc i64 %11 to i32
  %i.kd = insertelement <2 x i32> poison, i32 %10, i64 0
  %i.ke = insertelement <2 x i32> %i.kd, i32 %i.kc, i64 1
...
bb.cr:                                            ; preds = %.thread1943, %bb.co
  ...
  %i.aek = sub i64 %i.aeg, %i.aeh
  %12 = trunc i64 %i.aek to i32
  %13 = sub i64 %i.aej, %i.ak
  %i.ael = trunc i64 %13 to i32
  %i.aem = insertelement <2 x i32> poison, i32 %12, i64 0
  %i.aen = insertelement <2 x i32> %i.aem, i32 %i.ael, i64 1
