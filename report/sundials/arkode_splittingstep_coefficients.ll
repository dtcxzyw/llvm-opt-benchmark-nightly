...
begin_hunk_0_@SplittingStepCoefficients_LoadCoefficientsByName:bb.a
  ...
  store <2 x double> splat (double 1.000000e+00), ptr %i.be, align 8, !tbaa !24
...
bb.k:                                             ; preds = %bb.j
  ...
  store double 1.000000e+00, ptr %i.bj, align 8, !tbaa !24
  ...
  store <2 x double> <double 1.000000e+00, double f0xBFA5555555555555>, ptr %i.bo, align 8, !tbaa !24
  %i.bp = getelementptr inbounds nuw i8, ptr %i.bm, i64 16
  %i.bq = load ptr, ptr %i.bp, align 8, !tbaa !22
  store <2 x double> <double f0x3FD5555555555555, double f0x3FE6AAAAAAAAAAAB>, ptr %i.bq, align 8, !tbaa !24
  %i.br = getelementptr inbounds nuw i8, ptr %i.bm, i64 24
  %i.bs = load ptr, ptr %i.br, align 8, !tbaa !22
  store <2 x double> splat (double 1.000000e+00), ptr %i.bs, align 8, !tbaa !24
  br label %SplittingStepCoefficients_LieTrotter.exit
...
bb.n:                                             ; preds = %bb.m
  ...
  store double 1.000000e+00, ptr %i.ca, align 8, !tbaa !24
...
.epil.preheader:                                  ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph
  ...
  store double 1.000000e+00, ptr %i.i, align 8, !tbaa !24
  ...
  store double 1.000000e+00, ptr %i.n, align 8, !tbaa !24
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %.epil.preheader, %._crit_edge.loopexit.unr-lcssa, %bb.b
  ...
  store double %i.p, ptr %i.r, align 8, !tbaa !24
  br label %bb.d
...
bb.c:                                             ; preds = %bb.c, %.lr.ph.new
  ...
  store double 1.000000e+00, ptr %i.s, align 8, !tbaa !24
  ...
  store double 1.000000e+00, ptr %i.x, align 8, !tbaa !24
  %indvars.iv.next = or disjoint i64 %indvars.iv, 1 ; 3 uses
  %i.y = getelementptr inbounds nuw [8 x i8], ptr %.pre, i64 %indvars.iv.next
  store double 1.000000e+00, ptr %i.y, align 8, !tbaa !24
  ...
  store double 1.000000e+00, ptr %i.ad, align 8, !tbaa !24
...
bb.b:                                             ; preds = %bb.a
  ...
  store <2 x double> splat (double 5.000000e-01), ptr %i.d, align 8, !tbaa !24
  %i.e = icmp sgt i32 %0, 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <2 x double> splat (double 1.000000e+00), ptr %gep, align 8, !tbaa !24
  store <2 x double> splat (double 1.000000e+00), ptr %i.t, align 8, !tbaa !24
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  store double 1.000000e+00, ptr %i.v, align 8, !tbaa !24
  %indvars.iv.next30 = add nsw i64 %indvars.iv29, 1 ; 2 uses
  %i.w = icmp slt i64 %indvars.iv.next30, %2
  br i1 %i.w, label %scalar.ph, label %._crit_edge, !llvm.loop !41
...
bb.c:                                             ; preds = %bb.b
  ...
  store double 1.000000e+00, ptr %i.l, align 8, !tbaa !24
