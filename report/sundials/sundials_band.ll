...
.lr.ph68.i:                                       ; preds = %.lr.ph68.i.preheader, %.loopexit.i
  ...
  %i.z = load i64, ptr %i.y, align 8, !tbaa !24   ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x double>, ptr %i.ao, align 8, !tbaa !20, !alias.scope !36
  %wide.load13 = load <2 x double>, ptr %i.ap, align 8, !tbaa !20, !alias.scope !36
  %i.aq = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %i.am ; 3 uses
  %i.ar = getelementptr inbounds nuw i8, ptr %i.aq, i64 16 ; 2 uses
  %wide.load14 = load <2 x double>, ptr %i.aq, align 8, !tbaa !20, !alias.scope !39, !noalias !36
  %wide.load15 = load <2 x double>, ptr %i.ar, align 8, !tbaa !20, !alias.scope !39, !noalias !36
  ...
  store <2 x double> %i.at, ptr %i.ar, align 8, !tbaa !20, !alias.scope !39, !noalias !36
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.au = icmp eq i64 %index.next, %n.vec
  br i1 %i.au, label %middle.block, label %vector.body, !llvm.loop !41
...
vector.body30:                                    ; preds = %vector.body30, %vector.ph26
  ...
  %wide.load32 = load <2 x double>, ptr %i.cn, align 8, !tbaa !20, !alias.scope !43
  %wide.load33 = load <2 x double>, ptr %i.co, align 8, !tbaa !20, !alias.scope !43
  %i.cp = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %i.cl ; 3 uses
  %i.cq = getelementptr inbounds nuw i8, ptr %i.cp, i64 16 ; 2 uses
  %wide.load34 = load <2 x double>, ptr %i.cp, align 8, !tbaa !20, !alias.scope !46, !noalias !43
  %wide.load35 = load <2 x double>, ptr %i.cq, align 8, !tbaa !20, !alias.scope !46, !noalias !43
  ...
  store <2 x double> %i.cs, ptr %i.cq, align 8, !tbaa !20, !alias.scope !46, !noalias !43
  %index.next36 = add nuw i64 %index31, 4         ; 2 uses
  %i.ct = icmp eq i64 %index.next36, %n.vec27
  br i1 %i.ct, label %middle.block37, label %vector.body30, !llvm.loop !48
...
._crit_edge.i:                                    ; preds = %.lr.ph71.i, %middle.block37, %.lr.ph73.i
  ...
  %indvar.next = add i64 %indvar, 1
  br i1 %i.dc, label %.lr.ph73.i, label %SUNDlsMat_bandGBTRS.exit
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x double>, ptr %i.ag, align 8, !tbaa !20, !alias.scope !50
  %wide.load84 = load <2 x double>, ptr %i.ah, align 8, !tbaa !20, !alias.scope !50
  %i.ai = getelementptr inbounds nuw [8 x i8], ptr %5, i64 %i.ae ; 3 uses
  %i.aj = getelementptr inbounds nuw i8, ptr %i.ai, i64 16 ; 2 uses
  %wide.load85 = load <2 x double>, ptr %i.ai, align 8, !tbaa !20, !alias.scope !53, !noalias !50
  %wide.load86 = load <2 x double>, ptr %i.aj, align 8, !tbaa !20, !alias.scope !53, !noalias !50
  ...
  store <2 x double> %i.al, ptr %i.aj, align 8, !tbaa !20, !alias.scope !53, !noalias !50
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.am = icmp eq i64 %index.next, %n.vec
  br i1 %i.am, label %middle.block, label %vector.body, !llvm.loop !55
...
vector.body101:                                   ; preds = %vector.body101, %vector.ph97
  ...
  %wide.load103 = load <2 x double>, ptr %i.cf, align 8, !tbaa !20, !alias.scope !57
  %wide.load104 = load <2 x double>, ptr %i.cg, align 8, !tbaa !20, !alias.scope !57
  %i.ch = getelementptr inbounds nuw [8 x i8], ptr %5, i64 %i.cd ; 3 uses
  %i.ci = getelementptr inbounds nuw i8, ptr %i.ch, i64 16 ; 2 uses
  %wide.load105 = load <2 x double>, ptr %i.ch, align 8, !tbaa !20, !alias.scope !60, !noalias !57
  %wide.load106 = load <2 x double>, ptr %i.ci, align 8, !tbaa !20, !alias.scope !60, !noalias !57
  ...
  store <2 x double> %i.ck, ptr %i.ci, align 8, !tbaa !20, !alias.scope !60, !noalias !57
  %index.next107 = add nuw i64 %index102, 4       ; 2 uses
  %i.cl = icmp eq i64 %index.next107, %n.vec98
  br i1 %i.cl, label %middle.block108, label %vector.body101, !llvm.loop !62
...
._crit_edge:                                      ; preds = %.lr.ph71, %middle.block108, %.lr.ph73
  ...
  %indvar.next = add i64 %indvar, 1
  br i1 %i.cu, label %.lr.ph73, label %._crit_edge74
