...
bb.a:
  ...
  %i.s = load double, ptr %i.r, align 8, !tbaa !12 ; 2 uses
  %i.t = getelementptr inbounds nuw i8, ptr %i.l, i64 32
  %4 = load double, ptr %i.t, align 8, !tbaa !12  ; 2 uses
  %i.u = getelementptr inbounds nuw i8, ptr %i.l, i64 40
  %5 = load double, ptr %i.u, align 8, !tbaa !12  ; 2 uses
  ...
  %8 = load double, ptr %i.b, align 8, !tbaa !27
  ...
  %9 = load double, ptr %2, align 8, !tbaa !24    ; 8 uses
  %10 = load double, ptr %i.o, align 8, !tbaa !12
  %11 = load double, ptr %i.p, align 8, !tbaa !12
  %12 = load double, ptr %i.q, align 8, !tbaa !28
  %13 = load double, ptr %3, align 8, !tbaa !14   ; 2 uses
  ...
  %24 = tail call double @sqrt(double noundef %23) #11 ; 3 uses
  %25 = fmul double %4, %16
  ...
  %46 = load ptr, ptr %45, align 8, !tbaa !21     ; 2 uses
  ...
  store <2 x double> %i.as, ptr %47, align 8, !tbaa !12
...
bb.a:
  ...
  %i.b = load double, ptr %i.a, align 8, !tbaa !27
