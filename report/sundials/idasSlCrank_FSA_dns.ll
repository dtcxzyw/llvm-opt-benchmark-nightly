...
bb.a:
  ...
  %22 = tail call double @sin(double noundef %i.o) #11 ; 4 uses
  %23 = tail call double @cos(double noundef %i.o) #11 ; 3 uses
  %.val = load ptr, ptr %1, align 8, !tbaa !18
  %i.af = getelementptr i8, ptr %.val, i64 16
  %.val.val = load ptr, ptr %i.af, align 8, !tbaa !21 ; 6 uses
  %i.ag = load double, ptr %4, align 8, !tbaa !28 ; 8 uses
  %24 = load double, ptr %6, align 8, !tbaa !32
  %i.ah = load double, ptr %7, align 8, !tbaa !16 ; 2 uses
  ...
  %i.bh = tail call double @llvm.fmuladd.f64(double %i.ag, double %i.au, double %i.aw)
  ...
  %i.bl = tail call double @llvm.fmuladd.f64(double %i.ag, double %i.ag, double 1.000000e+00)
  ...
  %i.cb = fmul double %i.ag, %i.ca                ; 2 uses
  ...
  %i.ci = fsub double %i.bs, %24
  %i.cj = load <2 x double>, ptr %5, align 8, !tbaa !14 ; 2 uses
  ...
  %i.dn = fsub double %i.m, %23
  %i.do = insertelement <2 x double> poison, double %23, i64 0
  ...
  %i.dx = tail call double @llvm.fmuladd.f64(double %8, double %i.y, double %i.dw)
  %i.dy = tail call double @llvm.fmuladd.f64(double %10, double %i.aa, double %i.dx)
  store double %i.dy, ptr %i.j, align 8, !tbaa !14
  %i.dz = load double, ptr %11, align 8, !tbaa !14
  %i.ea = fsub double %i.dz, %i.du
  %i.eb = fadd double %i.y, %i.ea
  store double %i.eb, ptr %12, align 8, !tbaa !14
  %i.ec = load double, ptr %13, align 8, !tbaa !14
  %i.ed = fsub double %i.ec, %i.s
  %i.ee = tail call double @llvm.fmuladd.f64(double %22, double %i.y, double %i.ed)
  %i.ef = tail call double @llvm.fmuladd.f64(double %i.dr, double %i.aa, double %i.ee)
  store double %i.ef, ptr %14, align 8, !tbaa !14
  %i.eg = load double, ptr %15, align 8, !tbaa !14
  %i.eh = tail call double @llvm.fmuladd.f64(double %i.c, double %i.eg, double %i.dk)
  %i.ei = tail call double @llvm.fmuladd.f64(double %8, double %i.u, double %i.eh)
  %i.ej = tail call double @llvm.fmuladd.f64(double %10, double %i.w, double %i.ei)
  store double %i.ej, ptr %16, align 8, !tbaa !14
  %i.ek = load double, ptr %17, align 8, !tbaa !14
  %i.el = tail call double @llvm.fmuladd.f64(double %i.e, double %i.ek, double %i.dl)
  %i.em = fadd double %i.u, %i.el
  store double %i.em, ptr %18, align 8, !tbaa !14
  %i.en = load double, ptr %19, align 8, !tbaa !14
  %i.eo = tail call double @llvm.fmuladd.f64(double %i.g, double %i.en, double %i.dm)
  %i.ep = insertelement <2 x double> poison, double %22, i64 0
  %i.eq = insertelement <2 x double> %i.ep, double %8, i64 1
  ...
  %i.ew = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.dq, <2 x double> %21, <2 x double> %i.ev)
  store <2 x double> %i.ew, ptr %i.ad, align 8, !tbaa !14
  %i.ex = shufflevector <2 x double> %i.dq, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %i.ey = insertelement <2 x double> %i.ex, double %22, i64 1
  ...
  store <2 x double> %i.fc, ptr %i.ae, align 8, !tbaa !14
  %i.fd = fmul double %i.ac, %i.ds
  %i.fe = fneg double %i.s
  %i.ff = fmul double %23, %i.fe
