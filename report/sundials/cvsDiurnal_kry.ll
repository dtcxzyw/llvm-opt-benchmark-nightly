...
.peel.next:                                       ; preds = %.loopexit.peel.begin, %bb.c
  ...
  %7 = insertelement <2 x double> %6, double %i.ag, i64 1
  ...
  %11 = shufflevector <2 x double> %i.y, <2 x double> %8, <2 x i32> <i32 0, i32 2> ; 2 uses
...
bb.d:                                             ; preds = %.peel.next, %bb.d
  ...
  %i.ea = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %11, <2 x double> %i.dx, <2 x double> %i.dz) ; 2 uses
...
.loopexit.peel.begin:                             ; preds = %bb.d
  ...
  %i.gt = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %11, <2 x double> %i.gq, <2 x double> %i.gs) ; 2 uses
...
.peel.next:                                       ; preds = %.loopexit.peel.begin, %bb.c
  ...
  %9 = insertelement <2 x double> poison, double %i.af, i64 0
  %10 = insertelement <2 x double> %9, double %i.ah, i64 1
  %11 = fmul <2 x double> %8, %10                 ; 3 uses
  ...
  %12 = tail call reassoc double @llvm.vector.reduce.fadd.v2f64(double -0.000000e+00, <2 x double> %11)
  %13 = fneg double %12
  ...
  %14 = shufflevector <2 x double> %11, <2 x double> poison, <2 x i32> <i32 1, i32 1> ; 3 uses
  %i.ce = fmul <2 x double> %14, %i.bp
  %i.cf = insertelement <2 x double> poison, double %13, i64 0
  ...
  %i.ci = shufflevector <2 x double> %11, <2 x double> poison, <2 x i32> zeroinitializer ; 3 uses
