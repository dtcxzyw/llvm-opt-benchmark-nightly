...
.preheader102:                                    ; preds = %.preheader102.lr.ph, %.loopexit183
  ...
  %i.an = add nuw i64 %indvars.iv, 1
  %umax = tail call i64 @llvm.umax.i64(i64 %i.an, i64 %wide.trip.count)
  %1 = sub i64 %umax, %indvars.iv                 ; 3 uses
...
vector.ph:                                        ; preds = %.preheader102
  ...
  %i.ao = add i64 %indvars.iv, %n.vec
  %i.ap = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %indvars.iv
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %vec.phi = phi <2 x i1> [ zeroinitializer, %vector.ph ], [ %i.aw, %vector.body ]
  %vec.phi164 = phi <2 x i1> [ zeroinitializer, %vector.ph ], [ %i.ax, %vector.body ]
  %i.aq = getelementptr inbounds nuw [8 x i8], ptr %i.ap, i64 %index ; 2 uses
  %i.ar = getelementptr inbounds nuw i8, ptr %i.aq, i64 16
  %wide.load = load <2 x double>, ptr %i.aq, align 8, !tbaa !108
  %wide.load165 = load <2 x double>, ptr %i.ar, align 8, !tbaa !108
  %i.as = tail call <2 x double> @llvm.fabs.v2f64(<2 x double> %wide.load)
  %i.at = tail call <2 x double> @llvm.fabs.v2f64(<2 x double> %wide.load165)
  ...
  %i.aw = or <2 x i1> %vec.phi, %i.au             ; 2 uses
  %i.ax = or <2 x i1> %vec.phi164, %i.av          ; 2 uses
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ay = icmp eq i64 %index.next, %n.vec
  br i1 %i.ay, label %middle.block, label %vector.body, !llvm.loop !226

middle.block:                                     ; preds = %vector.body
  %bin.rdx = or <2 x i1> %i.ax, %i.aw
  %bin.rdx.fr = freeze <2 x i1> %bin.rdx
  %i.az = bitcast <2 x i1> %bin.rdx.fr to i2
  %.not = icmp eq i2 %i.az, 0
...
scalar.ph.preheader:                              ; preds = %.preheader102, %middle.block
  %indvars.iv127.ph = phi i64 [ %indvars.iv, %.preheader102 ], [ %i.ao, %middle.block ]
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %i.ba = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %indvars.iv127
  %i.bb = load double, ptr %i.ba, align 8, !tbaa !108
  %i.bc = tail call double @llvm.fabs.f64(double %i.bb)
  %i.bd = fcmp ogt double %i.bc, f0x3D19000000000000
  %.2 = select i1 %i.bd, i32 0, i32 %.1105        ; 2 uses
  %indvars.iv.next128 = add nuw nsw i64 %indvars.iv127, 1 ; 2 uses
  %i.be = icmp samesign ult i64 %indvars.iv.next128, %i.am
  br i1 %i.be, label %scalar.ph, label %.loopexit183, !llvm.loop !227
...
.lr.ph:                                           ; preds = %.thread96
  ...
  %i.bg = load ptr, ptr %i.bf, align 8, !tbaa !119
  %i.bh = getelementptr inbounds nuw i8, ptr %i.bg, i64 16
  %i.bi = load ptr, ptr %i.bh, align 8, !tbaa !188 ; 3 uses
...
bb.y:                                             ; preds = %bb.y, %.lr.ph.new
  ...
  %i.bk = getelementptr inbounds nuw [8 x i8], ptr %i.bi, i64 %indvars.iv131
  %i.bl = load ptr, ptr %i.bk, align 8, !tbaa !189
  %i.bm = getelementptr inbounds nuw [8 x i8], ptr %i.bl, i64 %indvars.iv131
  ...
  %i.bq = getelementptr inbounds nuw [8 x i8], ptr %i.bi, i64 %indvars.iv.next132
  %i.br = load ptr, ptr %i.bq, align 8, !tbaa !189
  %i.bs = getelementptr inbounds nuw [8 x i8], ptr %i.br, i64 %indvars.iv.next132
  %i.bt = load double, ptr %i.bs, align 8, !tbaa !108
  ...
  %.4.1 = select i1 %i.bw, i32 1, i32 %.3109      ; 3 uses
...
.epil.preheader:                                  ; preds = %._crit_edge110.unr-lcssa, %.lr.ph
  ...
  %i.bx = getelementptr inbounds nuw [8 x i8], ptr %i.bi, i64 %indvars.iv131.epil.init
  %i.by = load ptr, ptr %i.bx, align 8, !tbaa !189
  %i.bz = getelementptr inbounds nuw [8 x i8], ptr %i.by, i64 %indvars.iv131.epil.init
  %i.ca = load double, ptr %i.bz, align 8, !tbaa !108
  %i.cb = tail call double @llvm.fabs.f64(double %i.ca)
  %i.cc = fcmp ogt double %i.cb, f0x3D19000000000000
  %.4.epil = select i1 %i.cc, i32 1, i32 %.3109.epil.init
...
bb.aa:                                            ; preds = %.lr.ph119, %.loopexit99
  ...
  %i.cf = xor i64 %indvars.iv144, -1
  %i.cg = add nsw i64 %i.cf, %wide.trip.count135  ; 3 uses
  %indvars.iv.next145 = add nuw nsw i64 %indvars.iv144, 1 ; 3 uses
  %i.ch = icmp samesign ult i64 %indvars.iv.next145, %i.ce
  br i1 %i.ch, label %.lr.ph115, label %.loopexit99

.lr.ph115:                                        ; preds = %bb.aa
  %i.ci = load ptr, ptr %i.cd, align 8, !tbaa !119
  %i.cj = getelementptr inbounds nuw i8, ptr %i.ci, i64 16
  %i.ck = load ptr, ptr %i.cj, align 8, !tbaa !188
  %i.cl = getelementptr inbounds nuw [8 x i8], ptr %i.ck, i64 %indvars.iv144
  %i.cm = load ptr, ptr %i.cl, align 8, !tbaa !189 ; 2 uses
  %min.iters.check167 = icmp ult i64 %i.cg, 4
  br i1 %min.iters.check167, label %scalar.ph166.preheader, label %vector.ph168

vector.ph168:                                     ; preds = %.lr.ph115
  %n.vec169 = and i64 %i.cg, -4                   ; 3 uses
  %i.cn = add i64 %indvars.iv137, %n.vec169
  %i.co = getelementptr inbounds nuw [8 x i8], ptr %i.cm, i64 %indvars.iv137
...
vector.body170:                                   ; preds = %vector.body170, %vector.ph168
  ...
  %vec.phi172 = phi <2 x i1> [ zeroinitializer, %vector.ph168 ], [ %i.cv, %vector.body170 ]
  %vec.phi173 = phi <2 x i1> [ zeroinitializer, %vector.ph168 ], [ %i.cw, %vector.body170 ]
  %i.cp = getelementptr inbounds nuw [8 x i8], ptr %i.co, i64 %index171 ; 2 uses
  %i.cq = getelementptr inbounds nuw i8, ptr %i.cp, i64 16
  %wide.load174 = load <2 x double>, ptr %i.cp, align 8, !tbaa !108
  %wide.load175 = load <2 x double>, ptr %i.cq, align 8, !tbaa !108
  %i.cr = tail call <2 x double> @llvm.fabs.v2f64(<2 x double> %wide.load174)
  %i.cs = tail call <2 x double> @llvm.fabs.v2f64(<2 x double> %wide.load175)
  ...
  %i.cv = or <2 x i1> %vec.phi172, %i.ct          ; 2 uses
  %i.cw = or <2 x i1> %vec.phi173, %i.cu          ; 2 uses
  %index.next176 = add nuw i64 %index171, 4       ; 2 uses
  %i.cx = icmp eq i64 %index.next176, %n.vec169
  br i1 %i.cx, label %middle.block177, label %vector.body170, !llvm.loop !228

middle.block177:                                  ; preds = %vector.body170
  %bin.rdx178 = or <2 x i1> %i.cw, %i.cv
  %bin.rdx178.fr = freeze <2 x i1> %bin.rdx178
  %i.cy = bitcast <2 x i1> %bin.rdx178.fr to i2
  %.not184 = icmp eq i2 %i.cy, 0
  %rdx.select179 = select i1 %.not184, i32 %.5118, i32 0 ; 2 uses
  %cmp.n180 = icmp eq i64 %i.cg, %n.vec169
  br i1 %cmp.n180, label %.loopexit99, label %scalar.ph166.preheader

scalar.ph166.preheader:                           ; preds = %.lr.ph115, %middle.block177
  %indvars.iv139.ph = phi i64 [ %indvars.iv137, %.lr.ph115 ], [ %i.cn, %middle.block177 ]
...
scalar.ph166:                                     ; preds = %scalar.ph166.preheader, %scalar.ph166
  ...
  %i.cz = getelementptr inbounds nuw [8 x i8], ptr %i.cm, i64 %indvars.iv139
  %i.da = load double, ptr %i.cz, align 8, !tbaa !108
  %i.db = tail call double @llvm.fabs.f64(double %i.da)
  %i.dc = fcmp ogt double %i.db, f0x3D19000000000000
  %.7 = select i1 %i.dc, i32 0, i32 %.6113        ; 2 uses
...
.lr.ph123:                                        ; preds = %bb.af
  ...
  %i.dh = load ptr, ptr %i.dg, align 8, !tbaa !120
end_hunk_0
