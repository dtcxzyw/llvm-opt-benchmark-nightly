...
bb.a:
  ...
  %i.z = load <4 x double>, ptr %i.i, align 8, !tbaa !19 ; 6 uses
  %i.aa = load double, ptr %i.o, align 8, !tbaa !19
  %i.ab = load double, ptr %i.l, align 8, !tbaa !19
  %i.ac = extractelement <4 x double> %i.z, i64 2
  %i.ad = fneg double %i.ac
  %i.ae = shufflevector <4 x double> %i.z, <4 x double> poison, <2 x i32> <i32 1, i32 3> ; 2 uses
  %i.af = fmul <2 x double> %i.ae, %i.ae
  %i.ag = shufflevector <4 x double> %i.z, <4 x double> poison, <2 x i32> <i32 0, i32 2> ; 3 uses
  ...
  %i.bc = insertelement <2 x double> %i.ag, double %i.ab, i64 1 ; 2 uses
  %i.bd = fsub <2 x double> %i.bb, %i.bc
  %i.be = load <2 x double>, ptr %i.m, align 8, !tbaa !19
  %i.bf = fadd <2 x double> %i.be, splat (double -1.000000e+00)
  %i.bg = insertelement <2 x double> %i.aj, double %i.aa, i64 1 ; 2 uses
  ...
  %i.bo = load <2 x double>, ptr %i.k, align 8, !tbaa !19
  %i.bp = fadd <2 x double> %i.bo, splat (double -1.000000e+00)
  %i.bq = fadd <2 x double> %i.bc, %i.bp
  %i.br = load <2 x double>, ptr %i.n, align 8, !tbaa !19
  %i.bs = fadd <2 x double> %i.br, splat (double -1.000000e+00)
  %i.bt = fadd <2 x double> %i.bg, %i.bs
