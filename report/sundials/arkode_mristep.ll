...
bb.p:                                             ; preds = %.thread, %bb.o
  ...
  %i.cj = load ptr, ptr %i.ci, align 8, !tbaa !120
...
bb.q:                                             ; preds = %bb.p
  %i.cl = load ptr, ptr %i.ce, align 8, !tbaa !129 ; 4 uses
...
bb.s:                                             ; preds = %bb.r
  ...
  %i.cq = load i32, ptr %i.cp, align 8, !tbaa !90
...
bb.t:                                             ; preds = %bb.s
  ...
  %i.cv = load ptr, ptr %i.cu, align 8, !tbaa !96
...
thread-pre-split:                                 ; preds = %bb.t, %bb.u, %bb.r
  %.pr = load ptr, ptr %i.ce, align 8, !tbaa !129
  br label %bb.v
...
.thread365:                                       ; preds = %bb.o, %bb.v
  ...
  %i.da = load i32, ptr %i.cz, align 8, !tbaa !130
...
bb.w:                                             ; preds = %.thread365
  ...
  %i.dc = load double, ptr %i.db, align 8, !tbaa !119
...
bb.x:                                             ; preds = %bb.w, %.thread365, %bb.v
  ...
  store i32 1, ptr %i.dg, align 8, !tbaa !130
...
bb.y:                                             ; preds = %bb.x
  ...
  %i.dk = load i32, ptr %i.dj, align 8, !tbaa !90
...
bb.af:                                            ; preds = %.lr.ph, %.thread393
  ...
  %3 = add nuw i64 %i.fk, 8                       ; 2 uses
  %i.fm = shl nuw nsw i64 %indvar, 3              ; 2 uses
  %i.fn = add nuw i64 %i.fm, 24                   ; 2 uses
  %4 = add nuw i64 %i.fm, 8                       ; 2 uses
  %i.fo = load i32, ptr %i.ec, align 8, !tbaa !77 ; 2 uses
...
bb.ag:                                            ; preds = %bb.af
  %i.fv = load ptr, ptr %i.ed, align 8, !tbaa !163
  %i.fw = load ptr, ptr %i.ee, align 8, !tbaa !120
...
bb.ai:                                            ; preds = %bb.ah
  %i.fx = load ptr, ptr %i.ef, align 8, !tbaa !70
  %i.fy = getelementptr inbounds nuw i8, ptr %i.fx, i64 24
  %i.fz = load ptr, ptr %i.fy, align 8, !tbaa !132
  %i.ga = getelementptr inbounds nuw [8 x i8], ptr %i.fz, i64 %indvars.iv422
  %i.gb = load double, ptr %i.ga, align 8, !tbaa !47
  br label %bb.aj

bb.aj:                                            ; preds = %bb.ah, %bb.ai
  %i.gc = phi double [ %i.gb, %bb.ai ], [ 1.000000e+00, %bb.ah ]
  %i.gd = load double, ptr %i.eg, align 8, !tbaa !131 ; 2 uses
  %i.ge = load double, ptr %i.eh, align 8, !tbaa !133
  %i.gf = tail call double @llvm.fmuladd.f64(double %i.gc, double %i.ge, double %i.gd) ; 2 uses
  store double %i.gf, ptr %i.ei, align 8, !tbaa !119
  %i.gg = trunc nuw nsw i64 %indvars.iv422 to i32 ; 3 uses
  store i32 %i.gg, ptr %i.f, align 4, !tbaa !113
  store i32 %i.gg, ptr %i.g, align 8, !tbaa !114
...
bb.ak:                                            ; preds = %bb.aj
  %.pre428 = load double, ptr %i.eg, align 8, !tbaa !131 ; 3 uses
  %.pre430 = load ptr, ptr %i.ee, align 8, !tbaa !120 ; 3 uses
  br i1 %i.fu, label %bb.al, label %mriStepInnerStepper_Reset.exit281.thread369

bb.al:                                            ; preds = %bb.ak
  %i.gi = load ptr, ptr %i.ej, align 8, !tbaa !52 ; 4 uses
...
bb.am:                                            ; preds = %bb.al
  ...
  %i.gl = load ptr, ptr %i.gk, align 8, !tbaa !55 ; 2 uses
...
bb.an:                                            ; preds = %bb.am
  ...
  %i.go = load ptr, ptr %i.gn, align 8, !tbaa !121 ; 2 uses
...
mriStepInnerStepper_Reset.exit281:                ; preds = %bb.an
  %i.gp = tail call i32 %i.go(ptr noundef nonnull %i.gi, double noundef %.pre428, ptr noundef %.pre430) #14, !inline_history !122 ; 2 uses
  %i.gq = getelementptr inbounds nuw i8, ptr %i.gi, i64 48
  store i32 %i.gp, ptr %i.gq, align 8, !tbaa !106
...
mriStepInnerStepper_Reset.exit281.mriStepInnerStepper_Reset.exit281.thread369_crit_edge: ; preds = %mriStepInnerStepper_Reset.exit281
  %.pre427 = load double, ptr %i.eg, align 8, !tbaa !131
  %.pre429 = load ptr, ptr %i.ee, align 8, !tbaa !120
...
mriStepInnerStepper_Reset.exit281.thread369:      ; preds = %mriStepInnerStepper_Reset.exit281.mriStepInnerStepper_Reset.exit281.thread369_crit_edge, %bb.an, %bb.ak
  ...
  %i.gt = load double, ptr %i.ei, align 8, !tbaa !119
...
bb.au:                                            ; preds = %bb.at
  %i.hn = load ptr, ptr %i.eo, align 8, !tbaa !164 ; 2 uses
  %.not250 = icmp eq ptr %i.hn, null
  br i1 %.not250, label %bb.ax, label %bb.av

bb.av:                                            ; preds = %bb.au
  %i.ho = load double, ptr %i.ei, align 8, !tbaa !119
  %i.hp = load ptr, ptr %i.en, align 8, !tbaa !147
  %i.hq = load ptr, ptr %i.ep, align 8, !tbaa !109
...
bb.ax:                                            ; preds = %bb.aw, %bb.au
  %i.ht = load ptr, ptr %i.ek, align 8, !tbaa !43 ; 8 uses
  %i.hu = load ptr, ptr %i.ee, align 8, !tbaa !120
  %i.hv = load ptr, ptr %i.el, align 8, !tbaa !45 ; 9 uses
  store ptr %i.hu, ptr %i.hv, align 8, !tbaa !107
  store <2 x double> <double 1.000000e+00, double -1.000000e+00>, ptr %i.ht, align 8, !tbaa !47
  %i.hw = load ptr, ptr %i.en, align 8, !tbaa !147
  %i.hx = getelementptr inbounds nuw i8, ptr %i.hv, i64 8
  store ptr %i.hw, ptr %i.hx, align 8, !tbaa !107
  %i.hy = load ptr, ptr %i.ef, align 8, !tbaa !70
  ...
  %i.id = load ptr, ptr %i.ic, align 8, !tbaa !158 ; 6 uses
  %i.ie = load ptr, ptr %i.em, align 8, !tbaa !95 ; 6 uses
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %i.if = load double, ptr %i.eh, align 8, !tbaa !133, !alias.scope !273
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x double>, ptr %i.ig, align 8, !tbaa !47, !alias.scope !274
  %wide.load499 = load <2 x double>, ptr %i.ih, align 8, !tbaa !47, !alias.scope !274
