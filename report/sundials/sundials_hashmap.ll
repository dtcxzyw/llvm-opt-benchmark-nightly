...
bb.j:                                             ; preds = %bb.i
  store ptr %i.q, ptr %i.f, align 8, !tbaa !15
...
bb.k:                                             ; preds = %bb.g, %bb.h, %bb.j
  ...
  store ptr null, ptr %i.u, align 8, !tbaa !20
...
._crit_edge:                                      ; preds = %bb.k
  ...
  store ptr %i.c, ptr %i.w, align 8, !tbaa !23
  br label %.thread
...
SUNStlVector_SUNHashMapKeyValue_At.exit.i:        ; preds = %.preheader.i, %bb.e
  ...
  br i1 %.not81, label %SUNHashMap_Iterate.exit.thread.thread.a, label %bb.e
...
SUNHashMap_Iterate.exit.thread.thread.a:          ; preds = %SUNStlVector_SUNHashMapKeyValue_At.exit.i
  %i.ae = icmp eq i64 %.01728.i, %.val.val
  br i1 %i.ae, label %bb.f, label %bb.w

bb.f:                                             ; preds = %SUNHashMap_Iterate.exit.thread.thread.a, %SUNHashMap_Iterate.exit
...
bb.g:                                             ; preds = %SUNHashMap_Iterate.exit, %bb.f
  %3 = phi i64 [ %i.ai, %bb.f ], [ 2, %SUNHashMap_Iterate.exit ] ; 5 uses
  %i.aj = getelementptr inbounds nuw i8, ptr %.val, i64 24 ; 2 uses
  %i.ak = load ptr, ptr %i.aj, align 8, !tbaa !18 ; 2 uses
  %i.al = icmp sgt i64 %3, -1
...
bb.k:                                             ; preds = %bb.i
  ...
  store i64 %3, ptr %i.ar, align 8, !tbaa !17
...
.lr.ph:                                           ; preds = %SUNStlVector_SUNHashMapKeyValue_New.exit, %bb.q
  ...
  %i.au = load ptr, ptr %i.d, align 8, !tbaa !23  ; 6 uses
...
bb.p:                                             ; preds = %bb.o
  store ptr %i.bi, ptr %i.bf, align 8, !tbaa !15
...
bb.q:                                             ; preds = %.lr.ph, %bb.n, %bb.p
  ...
  %exitcond91.not = icmp eq i64 %i.bo, %3
...
SUNStlVector_SUNHashMapKeyValue_At.exit58:        ; preds = %.preheader, %SUNStlVector_SUNHashMapKeyValue_PopBack.exit
  ...
  %i.br = load ptr, ptr %i.t, align 8, !tbaa !15
  %i.bs = getelementptr inbounds nuw [8 x i8], ptr %i.br, i64 %.0.i5388
  %i.bt = load ptr, ptr %i.bs, align 8, !tbaa !20 ; 5 uses
...
bb.r:                                             ; preds = %SUNStlVector_SUNHashMapKeyValue_At.exit58
  ...
  %i.bx = tail call i64 @SUNHashMap_Insert(ptr noundef nonnull %0, ptr noundef %i.bu, ptr noundef %i.bw), !inline_history !32 ; 0 uses
  %i.by = load ptr, ptr %i.bt, align 8, !tbaa !27
  tail call void @free(ptr noundef %i.by) #17, !inline_history !32
  tail call void @free(ptr noundef nonnull %i.bt) #17, !inline_history !32
...
bb.u:                                             ; preds = %bb.t
  ...
  %i.cd = load ptr, ptr %i.t, align 8, !tbaa !15
  %i.ce = getelementptr inbounds nuw [8 x i8], ptr %i.cd, i64 %i.cc
  store ptr null, ptr %i.ce, align 8, !tbaa !20
...
bb.w:                                             ; preds = %SUNHashMap_Iterate.exit.thread.thread.a, %sunHashMapIdxFromKey.exit
  %.0 = phi i64 [ %i.p, %sunHashMapIdxFromKey.exit ], [ %.01728.i, %SUNHashMap_Iterate.exit.thread.thread.a ] ; 3 uses
...
bb.y:                                             ; preds = %bb.w
  ...
  store ptr %2, ptr %i.cv, align 8, !tbaa !28
...
bb.z:                                             ; preds = %bb.y
  ...
  store ptr %i.cq, ptr %i.cy, align 8, !tbaa !20
  br label %SUNStlVector_SUNHashMapKeyValue_Set.exit
