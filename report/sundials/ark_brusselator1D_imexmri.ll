...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %4 = shufflevector <2 x double> %i.ay, <2 x double> %i.au, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %5 = shufflevector <2 x double> %i.ae, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %6 = shufflevector <2 x double> %i.ax, <2 x double> %i.bb, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.bg = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %4, <4 x double> %5, <4 x double> %6)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.az = insertelement <2 x double> %i.ay, double %i.ax, i64 1 ; 5 uses
  ...
  %4 = shufflevector <2 x double> %i.dm, <2 x double> %i.dt, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %5 = shufflevector <2 x double> %i.az, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %6 = shufflevector <2 x double> %i.dl, <2 x double> %i.cr, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %7 = shufflevector <2 x double> %i.az, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %8 = shufflevector <2 x double> %i.dj, <2 x double> %i.ds, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %9 = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %6, <4 x double> %7, <4 x double> %8)
  %i.ee = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %4, <4 x double> %5, <4 x double> %9)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %5 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cn, <2 x double> splat (double -2.000000e+00), <2 x double> %i.ct)
  %6 = fadd <2 x double> %5, %i.cz
  %7 = fsub <2 x double> %i.cz, %i.ct
  %8 = fmul <2 x double> %broadcast.splat107, %7
  %9 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %6, <2 x double> %broadcast.splat109, <2 x double> %8)
  %i.db = shufflevector <2 x double> %i.av, <2 x double> %i.bt, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.dc = shufflevector <2 x double> %i.bb, <2 x double> %i.bz, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %10 = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %i.db, <4 x double> splat (double -2.000000e+00), <4 x double> %i.dc)
  %11 = shufflevector <2 x double> %i.bl, <2 x double> %i.cf, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %12 = fadd <4 x double> %10, %11
  %13 = shufflevector <2 x double> %i.bl, <2 x double> %i.cf, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %14 = shufflevector <2 x double> %i.bb, <2 x double> %i.bz, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %15 = fsub <4 x double> %13, %14
  %16 = fmul <4 x double> %i.al, %15
  %i.dd = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %12, <4 x double> %4, <4 x double> %16)
  %i.de = shufflevector <2 x double> %9, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
