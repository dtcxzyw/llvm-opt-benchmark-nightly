...
vector.memcheck:                                  ; preds = %.lr.ph.preheader
  ...
  %scevgep68 = getelementptr nuw i8, ptr %i.f, i64 %i.n
  %scevgep69 = getelementptr i8, ptr %i.f, i64 %i.c
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load70 = load <2 x double>, ptr %i.s, align 8, !tbaa !18, !alias.scope !93
  %i.t = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %i.p ; 3 uses
  %i.u = getelementptr inbounds nuw i8, ptr %i.t, i64 16 ; 2 uses
  %wide.load71 = load <2 x double>, ptr %i.t, align 8, !tbaa !18, !alias.scope !95, !noalias !93
  %wide.load72 = load <2 x double>, ptr %i.u, align 8, !tbaa !18, !alias.scope !95, !noalias !93
  ...
  %i.x = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.w, <2 x double> %wide.load, <2 x double> %wide.load71)
  %i.y = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.w, <2 x double> %wide.load70, <2 x double> %wide.load72)
...
.lr.ph.prol.loopexit:                             ; preds = %.lr.ph.prol, %.lr.ph.preheader73
  %.04952.unr = phi i64 [ %.04952.ph, %.lr.ph.preheader73 ], [ %i.ai, %.lr.ph.prol ]
...
.lr.ph58.preheader:                               ; preds = %.lr.ph62
  ...
  %lcmp.mod75.not.not = icmp eq i64 %i.bo, 0
