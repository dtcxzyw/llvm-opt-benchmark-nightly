...
vector.memcheck:                                  ; preds = %.preheader.us
  ...
  %scevgep114 = getelementptr i8, ptr %i.bv, i64 %i.b
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load117 = load <2 x double>, ptr %i.cp, align 8, !tbaa !18, !alias.scope !34
  %i.cq = getelementptr inbounds nuw [8 x i8], ptr %i.bv, i64 %i.cn ; 3 uses
  %i.cr = getelementptr inbounds nuw i8, ptr %i.cq, i64 16 ; 2 uses
  %wide.load118 = load <2 x double>, ptr %i.cq, align 8, !tbaa !18, !alias.scope !37, !noalias !34
  %wide.load119 = load <2 x double>, ptr %i.cr, align 8, !tbaa !18, !alias.scope !37, !noalias !34
  %i.cs = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat, <2 x double> %wide.load, <2 x double> %wide.load118)
  %i.ct = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat, <2 x double> %wide.load117, <2 x double> %wide.load119)
...
.lr.ph84:                                         ; preds = %.lr.ph84.preheader134, %.lr.ph84
  %.282 = phi i64 [ %i.dg, %.lr.ph84 ], [ %.282.ph, %.lr.ph84.preheader134 ] ; 2 uses
...
.lr.ph62.i:                                       ; preds = %._crit_edge59.i.loopexit, %.lr.ph62.preheader.i
  %indvar = phi i64 [ %indvar.next, %._crit_edge59.i.loopexit ], [ 0, %.lr.ph62.preheader.i ] ; 3 uses
  %.15060.i = phi i64 [ %i.co, %._crit_edge59.i.loopexit ], [ %i.bm, %.lr.ph62.preheader.i ] ; 7 uses
  ...
  %i.bp = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %.15060.i ; 5 uses
  %.promoted.i = load double, ptr %i.bp, align 8, !tbaa !18 ; 2 uses
  %i.bq = and i64 %indvar, 1
  %lcmp.mod11.not.not = icmp eq i64 %i.bq, 0
  br i1 %lcmp.mod11.not.not, label %.lr.ph58.i.prol, label %.lr.ph58.i.prol.loopexit

.lr.ph58.i.prol:                                  ; preds = %.lr.ph62.i
  %i.br = getelementptr inbounds nuw [8 x i8], ptr %i.bo, i64 %.155.i
  %i.bs = load double, ptr %i.br, align 8, !tbaa !18
  %i.bt = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %.155.i
  %i.bu = load double, ptr %i.bt, align 8, !tbaa !18
  %i.bv = fneg double %i.bs
  %i.bw = tail call double @llvm.fmuladd.f64(double %i.bv, double %i.bu, double %.promoted.i) ; 3 uses
  store double %i.bw, ptr %i.bp, align 8, !tbaa !18
  %.1.i.prol = add nuw nsw i64 %.15060.i, 2
  br label %.lr.ph58.i.prol.loopexit

.lr.ph58.i.prol.loopexit:                         ; preds = %.lr.ph58.i.prol, %.lr.ph62.i
  %.lcssa.unr = phi double [ poison, %.lr.ph62.i ], [ %i.bw, %.lr.ph58.i.prol ]
  %.unr = phi double [ %.promoted.i, %.lr.ph62.i ], [ %i.bw, %.lr.ph58.i.prol ]
  %.156.i.unr = phi i64 [ %.155.i, %.lr.ph62.i ], [ %.1.i.prol, %.lr.ph58.i.prol ]
  %i.bx = icmp eq i64 %indvar, 0
  br i1 %i.bx, label %._crit_edge59.i.loopexit, label %.lr.ph58.i

.lr.ph58.i:                                       ; preds = %.lr.ph58.i.prol.loopexit, %.lr.ph58.i
  %i.by = phi double [ %i.ck, %.lr.ph58.i ], [ %.unr, %.lr.ph58.i.prol.loopexit ]
  %.156.i = phi i64 [ %.1.i.1, %.lr.ph58.i ], [ %.156.i.unr, %.lr.ph58.i.prol.loopexit ] ; 4 uses
  %i.bz = getelementptr inbounds nuw [8 x i8], ptr %i.bo, i64 %.156.i
  %i.ca = load double, ptr %i.bz, align 8, !tbaa !18
  %i.cb = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %.156.i
  %i.cc = load double, ptr %i.cb, align 8, !tbaa !18
  %i.cd = fneg double %i.ca
  %i.ce = tail call double @llvm.fmuladd.f64(double %i.cd, double %i.cc, double %i.by) ; 2 uses
  store double %i.ce, ptr %i.bp, align 8, !tbaa !18
  %.1.i = add nuw nsw i64 %.156.i, 1              ; 2 uses
  %i.cf = getelementptr inbounds nuw [8 x i8], ptr %i.bo, i64 %.1.i
  %i.cg = load double, ptr %i.cf, align 8, !tbaa !18
  %i.ch = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %.1.i
  %i.ci = load double, ptr %i.ch, align 8, !tbaa !18
  %i.cj = fneg double %i.cg
  %i.ck = tail call double @llvm.fmuladd.f64(double %i.cj, double %i.ci, double %i.ce) ; 3 uses
  store double %i.ck, ptr %i.bp, align 8, !tbaa !18
  %.1.i.1 = add nuw nsw i64 %.156.i, 2            ; 2 uses
  %exitcond65.not.i.1 = icmp eq i64 %.1.i.1, %i.d
  br i1 %exitcond65.not.i.1, label %._crit_edge59.i.loopexit, label %.lr.ph58.i

._crit_edge59.i.loopexit:                         ; preds = %.lr.ph58.i, %.lr.ph58.i.prol.loopexit
  %.lcssa = phi double [ %.lcssa.unr, %.lr.ph58.i.prol.loopexit ], [ %i.ck, %.lr.ph58.i ]
  %i.cl = getelementptr inbounds nuw [8 x i8], ptr %i.bo, i64 %.15060.i
  %i.cm = load double, ptr %i.cl, align 8, !tbaa !18
  %i.cn = fdiv double %.lcssa, %i.cm
  store double %i.cn, ptr %i.bp, align 8, !tbaa !18
  %i.co = add nsw i64 %.15060.i, -1
  %i.cp = icmp sgt i64 %.15060.i, 0
  %indvar.next = add i64 %indvar, 1
  br i1 %i.cp, label %.lr.ph62.i, label %SUNDlsMat_densePOTRS.exit
...
vector.memcheck:                                  ; preds = %.lr.ph.preheader
  ...
  %scevgep69 = getelementptr nuw i8, ptr %i.e, i64 %i.m
  %scevgep70 = getelementptr i8, ptr %i.e, i64 %i.c
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load71 = load <2 x double>, ptr %i.r, align 8, !tbaa !18, !alias.scope !93
  %i.s = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %i.o ; 3 uses
  %i.t = getelementptr inbounds nuw i8, ptr %i.s, i64 16 ; 2 uses
  %wide.load72 = load <2 x double>, ptr %i.s, align 8, !tbaa !18, !alias.scope !95, !noalias !93
  %wide.load73 = load <2 x double>, ptr %i.t, align 8, !tbaa !18, !alias.scope !95, !noalias !93
  ...
  %i.w = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.v, <2 x double> %wide.load, <2 x double> %wide.load72)
  %i.x = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.v, <2 x double> %wide.load71, <2 x double> %wide.load73)
...
.lr.ph.prol.loopexit:                             ; preds = %.lr.ph.prol, %.lr.ph.preheader74
  %.04952.unr = phi i64 [ %.04952.ph, %.lr.ph.preheader74 ], [ %i.ah, %.lr.ph.prol ]
...
.lr.ph58.preheader:                               ; preds = %.lr.ph62
  ...
  %lcmp.mod76.not.not = icmp eq i64 %i.bn, 0
