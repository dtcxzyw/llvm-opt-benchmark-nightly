...
._crit_edge395.split.i:                           ; preds = %._crit_edge.i, %.lr.ph394.i, %.preheader389.._crit_edge395.split_crit_edge.i
  %.pre-phi.i = phi i64 [ %.pre.i, %.preheader389.._crit_edge395.split_crit_edge.i ], [ %wide.trip.count.i.i, %.lr.ph394.i ], [ %wide.trip.count.i.i, %._crit_edge.i ] ; 142 uses
  ...
  %i.dk = sext i32 %i.s to i64                    ; 34 uses
  %i.dl = sext i32 %i.m to i64                    ; 27 uses
  %i.dm = sub nsw i64 0, %i.dl                    ; 6 uses
  %i.dn = sub nsw i64 0, %i.dk                    ; 6 uses
  ...
  %i.ef = mul i64 %i.ee, %i.dl
  %i.eg = shl nsw i64 %i.dk, 3
  %i.eh = add nuw nsw i64 %wide.trip.count449.i, 2305843009213693951
  %i.ei = mul i64 %i.eh, %i.dl
  ...
  %i.eo = mul i64 %i.en, %i.dl
  %i.ep = shl nsw i64 %i.dk, 3
  %i.eq = add nuw nsw i64 %wide.trip.count449.i, 2305843009213693951
  %i.er = mul i64 %i.eq, %i.dl
  ...
  %12 = add nsw i64 %i.hf, -1
  %diff.check521 = icmp ult i64 %12, 31
  ...
  %13 = add nsw i64 %i.hf, -1
  %diff.check499 = icmp ult i64 %13, 31
  ...
  %14 = add nsw i64 %i.hf, -1
  %diff.check461 = icmp ult i64 %14, 31
  ...
  %15 = add nsw i64 %i.hf, -1
  %diff.check440 = icmp ult i64 %15, 31
...
.lr.ph399.i:                                      ; preds = %bb.b, %._crit_edge400.i
  ...
  %i.jd = mul nsw i64 %indvars.iv451.i, %i.dk
...
bb.c:                                             ; preds = %v_sum_prods.exit.i, %.lr.ph399.i
  ...
  %i.ji = mul nsw i64 %indvars.iv446.i, %i.dl
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.jq = getelementptr inbounds nuw [8 x i8], ptr %i.jp, i64 %.pre-phi.i ; 4 uses
  %i.jr = getelementptr inbounds [8 x i8], ptr %i.jp, i64 %i.dk ; 4 uses
...
bb.e:                                             ; preds = %bb.c
  ...
  %i.lq = getelementptr inbounds nuw [8 x i8], ptr %i.lp, i64 %.pre-phi.i ; 4 uses
  %i.lr = getelementptr inbounds [8 x i8], ptr %i.lp, i64 %i.dk ; 4 uses
...
bb.f:                                             ; preds = %bb.c
  ...
  %i.nq = getelementptr inbounds [8 x i8], ptr %i.np, i64 %i.dk ; 6 uses
...
bb.g:                                             ; preds = %bb.c
  ...
  %i.ph = getelementptr inbounds nuw [8 x i8], ptr %i.pg, i64 %.pre-phi.i ; 4 uses
  %i.pi = getelementptr inbounds [8 x i8], ptr %i.pg, i64 %i.dk ; 4 uses
...
bb.h:                                             ; preds = %bb.c
  ...
  %i.rh = getelementptr inbounds nuw [8 x i8], ptr %i.rg, i64 %.pre-phi.i ; 4 uses
  %i.ri = getelementptr inbounds [8 x i8], ptr %i.rg, i64 %i.dk ; 4 uses
...
bb.i:                                             ; preds = %bb.c
  ...
  %i.th = getelementptr inbounds [8 x i8], ptr %i.tg, i64 %i.dk ; 6 uses
...
bb.j:                                             ; preds = %bb.c
  ...
  %i.uy = getelementptr inbounds nuw [8 x i8], ptr %i.ux, i64 %.pre-phi.i ; 2 uses
...
bb.k:                                             ; preds = %bb.c
  ...
  %i.vp = getelementptr inbounds nuw [8 x i8], ptr %i.vo, i64 %.pre-phi.i ; 2 uses
...
.lr.ph405.i:                                      ; preds = %.loopexit.i, %._crit_edge406.i
  ...
  %17 = sub i64 %i.wg, %16
  %scevgep416 = getelementptr i8, ptr %i.h, i64 %17
  ...
  %i.xd = mul nsw i64 %indvars.iv461.i, %i.dk
...
bb.m:                                             ; preds = %v_inc_by_prod.exit.i, %.lr.ph405.i
  ...
  %i.xi = mul nsw i64 %indvars.iv456.i, %i.dl
