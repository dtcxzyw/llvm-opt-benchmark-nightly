...
.split:                                           ; preds = %.split.preheader, %.split86
  ...
  %5 = mul i64 %indvars.iv96, %4                  ; 2 uses
...
bb.b:                                             ; preds = %.split, %._crit_edge
  ...
  %i.bt = mul i64 %indvars.iv92, %i.s             ; 3 uses
  %7 = add i64 %5, %i.bt
