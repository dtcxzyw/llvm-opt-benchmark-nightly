...
.preheader338.i.i.i:                              ; preds = %bb.ia
  ...
  %i.bfx = load <2 x double>, ptr %i.od, align 8, !tbaa !25 ; 4 uses
  %i.bfy = load <2 x double>, ptr %i.oe, align 8, !tbaa !25 ; 4 uses
  %i.bfz = load <2 x double>, ptr %i.of, align 8, !tbaa !25 ; 5 uses
  %i.bga = load <2 x double>, ptr %i.og, align 8, !tbaa !25 ; 5 uses
...
.preheader335.i.i.i.preheader:                    ; preds = %.preheader338.i.i.i
  ...
  %i.bhf = shufflevector <2 x double> %i.bfy, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.bhg = shufflevector <2 x double> %i.bfx, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.bhh = extractelement <2 x double> %i.bfx, i64 1
  ...
  %i.bhl = shufflevector <2 x double> %i.bfy, <2 x double> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  ...
  %5 = insertelement <2 x double> %i.bhl, double %i.bgk, i64 1
  %6 = insertelement <2 x double> %i.bhf, double %i.bgj, i64 0
  %7 = insertelement <2 x double> %i.bhg, double %i.bgi, i64 0
...
.preheader335.i.i.i:                              ; preds = %.preheader335.i.i.i.preheader, %.preheader.i.i133.i
  ...
  %i.bjv = fadd double %.0299376.i.i.i, %.sroa.8.0.i.i.i ; 6 uses
  ...
  %i.bkb = fmul double %i.bjv, %i.bjv
  %8 = insertelement <2 x double> poison, double %i.bjv, i64 0
  %9 = shufflevector <2 x double> %8, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %10 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %9, <2 x double> %i.bga, <2 x double> %i.bfz) ; 2 uses
  %11 = insertelement <2 x double> poison, double %i.bkb, i64 0 ; 2 uses
  %12 = insertelement <2 x double> %11, double %i.bjv, i64 1
  %13 = shufflevector <2 x double> %10, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %i.bkc = insertelement <2 x double> %13, double %i.bgl, i64 1
  %14 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %12, <2 x double> %i.bkc, <2 x double> %5) ; 2 uses
  %15 = shufflevector <2 x double> %11, <2 x double> poison, <2 x i32> zeroinitializer
  %16 = shufflevector <2 x double> %14, <2 x double> %10, <2 x i32> <i32 1, i32 2>
  %17 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %15, <2 x double> %16, <2 x double> %6)
  %18 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %9, <2 x double> %17, <2 x double> %7) ; 4 uses
  %19 = extractelement <2 x double> %18, i64 0
  store double %19, ptr %gep364.2.2.i.i.i, align 8, !tbaa !25
  %20 = extractelement <2 x double> %18, i64 1
  store double %20, ptr %gep364.2423.i.i.i, align 8, !tbaa !25
  %21 = shufflevector <2 x double> %i.bjj, <2 x double> %18, <2 x i32> <i32 3, i32 1>
  %22 = call <2 x double> @llvm.fabs.v2f64(<2 x double> %21)
  %23 = fdiv <2 x double> %22, %i.bgr             ; 2 uses
  %24 = shufflevector <2 x double> %18, <2 x double> %i.bka, <2 x i32> <i32 0, i32 2>
  %i.bkd = call <2 x double> @llvm.fabs.v2f64(<2 x double> %24)
  ...
  %i.bkg = fcmp ogt <2 x double> %23, %i.bkf
  %i.bkh = extractelement <2 x double> %i.bke, i64 1 ; 2 uses
  %i.bki = fcmp ogt double %i.bkh, %.1291.1.i.i.i
  %i.bkj = select <2 x i1> %i.bkg, <2 x double> %23, <2 x double> %i.bkf ; 2 uses
  %.1291.2.i.i.i = select i1 %i.bki, double %i.bkh, double %.1291.1.i.i.i ; 3 uses
  %25 = extractelement <2 x double> %14, i64 0
  %i.bkk = call double @llvm.fmuladd.f64(double %i.bjv, double %25, double %i.bhh) ; 2 uses
  store double %i.bkk, ptr %gep364.1.2.i.i.i, align 8, !tbaa !25
  %i.bkl = insertelement <2 x double> %i.bka, double %i.bkk, i64 0
  %i.bkm = call <2 x double> @llvm.fabs.v2f64(<2 x double> %i.bkl)
