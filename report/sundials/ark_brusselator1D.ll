...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %4 = shufflevector <2 x double> %i.at, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  ...
  %5 = shufflevector <2 x double> %i.dc, <2 x double> %i.dg, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %6 = fmul <2 x double> %i.at, %i.cl
  %7 = shufflevector <2 x double> %i.da, <2 x double> %6, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %8 = shufflevector <2 x double> %i.at, <2 x double> %broadcast.splatinsert103, <4 x i32> <i32 0, i32 1, i32 2, i32 2>
  %9 = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %5, <4 x double> %8, <4 x double> %7)
  %10 = fneg <2 x double> %i.dd
  %11 = shufflevector <2 x double> %i.dd, <2 x double> %10, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.dh = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cl, <2 x double> splat (double -2.000000e+00), <2 x double> %i.cr)
  %12 = fadd <2 x double> %i.dh, %i.cx
  %13 = fsub <2 x double> %broadcast.splat106, %i.cl
  %14 = fdiv <2 x double> %13, %broadcast.splat108
  %15 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %12, <2 x double> %broadcast.splat110, <2 x double> %14)
  %16 = fneg <2 x double> %i.cl
  %17 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %16, <2 x double> %i.at, <2 x double> %15)
  %i.di = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %11, <4 x double> %4, <4 x double> %9)
  %i.dj = shufflevector <2 x double> %17, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
