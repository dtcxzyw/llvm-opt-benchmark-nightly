...
bb.s:                                             ; preds = %bb.r
  ...
  %i.ek = load i32, ptr %i.b, align 4, !tbaa !65
...
bb.v:                                             ; preds = %bb.u, %bb.t
  %i.er = load ptr, ptr %i.e, align 8, !tbaa !29
  ...
  %i.ew = load i64, ptr %i.ev, align 8, !tbaa !58
  %i.ex = add nsw i64 %i.ew, 1
  store i64 %i.ex, ptr %i.ev, align 8, !tbaa !58
...
bb.x:                                             ; preds = %bb.v
  ...
  %i.ez = load i32, ptr %i.ey, align 8, !tbaa !32
...
bb.y:                                             ; preds = %bb.x
  ...
  store i32 1, ptr %i.b, align 4, !tbaa !65
  call void @erkStep_ApplyForcing(ptr noundef nonnull %i.e, ptr noundef nonnull %i.a, ptr noundef nonnull %i.c, i32 noundef 1, ptr noundef nonnull %i.b)
  %i.fb = load i32, ptr %i.b, align 4, !tbaa !65
...
bb.a:
  ...
  %i.e = load ptr, ptr %i.d, align 8, !tbaa !23   ; 15 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.k = load ptr, ptr %i.j, align 8, !tbaa !45   ; 9 uses
  %i.l = getelementptr inbounds nuw i8, ptr %i.e, i64 64 ; 2 uses
  %i.m = load ptr, ptr %i.l, align 8, !tbaa !47   ; 8 uses
...
bb.d:                                             ; preds = %bb.c
  store i32 1, ptr %i.o, align 8, !tbaa !53
  br label %bb.e
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.af = load i64, ptr %i.ae, align 8, !tbaa !150
  %i.ag = getelementptr inbounds nuw i8, ptr %0, i64 920 ; 2 uses
  %i.ah = load double, ptr %i.ag, align 8, !tbaa !67
...
bb.h:                                             ; preds = %bb.f
  %i.aj = load i32, ptr %i.a, align 4, !tbaa !65
  %.not157 = icmp eq i32 %i.aj, 0
  br i1 %.not157, label %bb.k, label %bb.i

bb.i:                                             ; preds = %bb.h
  %i.ak = load ptr, ptr %i.ac, align 8, !tbaa !69
  %i.al = load i64, ptr %i.ae, align 8, !tbaa !150
  %i.am = load double, ptr %i.ag, align 8, !tbaa !67
...
bb.m:                                             ; preds = %.lr.ph, %bb.ae
  %indvar = phi i64 [ 0, %.lr.ph ], [ %indvar.next, %bb.ae ] ; 5 uses
  %indvars.iv218 = phi i64 [ 1, %.lr.ph ], [ %indvars.iv.next219, %bb.ae ] ; 21 uses
  %i.bm = shl nuw nsw i64 %indvar, 3
  %3 = add nuw i64 %i.bm, 8                       ; 4 uses
  %i.bn = load double, ptr %i.at, align 8, !tbaa !67
  %i.bo = load ptr, ptr %i.g, align 8, !tbaa !35  ; 2 uses
  %i.bp = getelementptr inbounds nuw i8, ptr %i.bo, i64 24
  %i.bq = load ptr, ptr %i.bp, align 8, !tbaa !70 ; 8 uses
  %i.br = getelementptr inbounds nuw [8 x i8], ptr %i.bq, i64 %indvars.iv218
  %i.bs = load double, ptr %i.br, align 8, !tbaa !52
  %i.bt = load double, ptr %i.au, align 8, !tbaa !71
  %i.bu = call double @llvm.fmuladd.f64(double %i.bs, double %i.bt, double %i.bn)
  store double %i.bu, ptr %i.av, align 8, !tbaa !72
  %i.bv = trunc nuw nsw i64 %indvars.iv218 to i32
  store i32 %i.bv, ptr %i.n, align 8, !tbaa !66
  ...
  %i.bz = load ptr, ptr %i.by, align 8, !tbaa !74 ; 13 uses
  %i.ca = load ptr, ptr %i.aw, align 8, !tbaa !56 ; 6 uses
...
vector.memcheck286:                               ; preds = %bb.m
  %i.cb = shl nuw nsw i64 %indvar, 3
  %4 = add nuw i64 %i.cb, 8                       ; 4 uses
  %scevgep290.a = getelementptr i8, ptr %i.m, i64 %4
  %scevgep287 = getelementptr i8, ptr %i.k, i64 %4 ; 2 uses
  %scevgep289 = getelementptr i8, ptr %i.bz, i64 %4
  %scevgep291 = getelementptr i8, ptr %i.ca, i64 %4
...
vector.ph305:                                     ; preds = %vector.memcheck286
  ...
  %i.cc = load double, ptr %i.au, align 8, !tbaa !71, !alias.scope !151
...
vector.body307:                                   ; preds = %vector.body307, %vector.ph305
  ...
  %wide.load309.a = load <2 x double>, ptr %i.cd, align 8, !tbaa !52, !alias.scope !152
  %wide.load310 = load <2 x double>, ptr %i.ce, align 8, !tbaa !52, !alias.scope !152
  ...
  store <2 x double> %i.cf, ptr %i.ch, align 8, !tbaa !52, !alias.scope !153, !noalias !154
  store <2 x double> %i.cg, ptr %i.ci, align 8, !tbaa !52, !alias.scope !153, !noalias !154
  %i.cj = getelementptr inbounds nuw [8 x i8], ptr %i.ca, i64 %index308 ; 2 uses
  %i.ck = getelementptr inbounds nuw i8, ptr %i.cj, i64 16
  %wide.load313.a = load <2 x ptr>, ptr %i.cj, align 8, !tbaa !57, !alias.scope !155
  %wide.load314 = load <2 x ptr>, ptr %i.ck, align 8, !tbaa !57, !alias.scope !155
  %i.cl = getelementptr inbounds nuw [8 x i8], ptr %i.m, i64 %index308 ; 2 uses
  %i.cm = getelementptr inbounds nuw i8, ptr %i.cl, i64 16
  store <2 x ptr> %wide.load313.a, ptr %i.cl, align 8, !tbaa !57, !alias.scope !156, !noalias !155
  store <2 x ptr> %wide.load314, ptr %i.cm, align 8, !tbaa !57, !alias.scope !156, !noalias !155
  %index.next315 = add nuw i64 %index308, 4       ; 2 uses
  %i.cn = icmp eq i64 %index.next315, %n.vec306
  br i1 %i.cn, label %middle.block316, label %vector.body307, !llvm.loop !136
...
scalar.ph303.prol:                                ; preds = %scalar.ph303.preheader
  ...
  store ptr %i.cu, ptr %i.cv, align 8, !tbaa !57
...
scalar.ph303:                                     ; preds = %scalar.ph303.prol.loopexit, %scalar.ph303
  ...
  %i.df = load double, ptr %i.au, align 8, !tbaa !71
  ...
  store double %i.di, ptr %i.dj, align 8, !tbaa !52
  ...
  store ptr %i.dl, ptr %i.dm, align 8, !tbaa !57
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2 ; 2 uses
  %exitcond.not.1 = icmp eq i64 %indvars.iv.next.1, %indvars.iv218
  br i1 %exitcond.not.1, label %.loopexit319, label %scalar.ph303, !llvm.loop !137

.loopexit319:                                     ; preds = %scalar.ph303.prol.loopexit, %scalar.ph303, %middle.block316
  %indvars.iv.lcssa = phi i64 [ %ind.escape, %middle.block316 ], [ %indvars.iv.ph, %scalar.ph303.prol.loopexit ], [ %indvars.iv.next, %scalar.ph303 ] ; 2 uses
  %i.dn = trunc nuw nsw i64 %indvars.iv.lcssa to i32
  %i.do = getelementptr inbounds nuw [8 x i8], ptr %i.k, i64 %indvars.iv218
  store double 1.000000e+00, ptr %i.do, align 8, !tbaa !52
  %i.dp = load ptr, ptr %i.ax, align 8, !tbaa !68
  %i.dq = getelementptr inbounds nuw [8 x i8], ptr %i.m, i64 %indvars.iv218
  store ptr %i.dp, ptr %i.dq, align 8, !tbaa !57
  %i.dr = add nuw nsw i32 %i.dn, 2                ; 3 uses
  %i.ds = load i32, ptr %i.ay, align 8, !tbaa !32 ; 6 uses
  %i.dt = icmp sgt i32 %i.ds, 0
  br i1 %i.dt, label %.preheader, label %bb.n

.preheader:                                       ; preds = %.loopexit319
  %i.du = load ptr, ptr %i.az, align 8, !tbaa !49 ; 10 uses
  %i.dv = load ptr, ptr %i.ba, align 8, !tbaa !50 ; 10 uses
...
vector.memcheck241:                               ; preds = %.preheader
  %scevgep = getelementptr i8, ptr %i.du, i64 %3  ; 4 uses
  %scevgep242 = getelementptr i8, ptr %i.dv, i64 %3 ; 4 uses
  %scevgep244 = getelementptr i8, ptr %i.bq, i64 %3 ; 2 uses
  %scevgep245 = getelementptr i8, ptr %i.bz, i64 %3 ; 2 uses
...
vector.ph271:                                     ; preds = %vector.memcheck241
  ...
  %i.dw = load double, ptr %i.at, align 8, !tbaa !67, !alias.scope !157
  ...
  %i.dx = load double, ptr %i.au, align 8, !tbaa !71, !alias.scope !157 ; 2 uses
...
vector.body273:                                   ; preds = %vector.body273, %vector.ph271
  ...
  %wide.load275 = load <2 x double>, ptr %i.dy, align 8, !tbaa !52, !alias.scope !158
  ...
  store <2 x double> %i.dz, ptr %i.ea, align 8, !tbaa !52, !alias.scope !159, !noalias !160
  %i.eb = getelementptr inbounds nuw [8 x i8], ptr %i.bz, i64 %index274
  %wide.load278 = load <2 x double>, ptr %i.eb, align 8, !tbaa !52, !alias.scope !161
  %i.ec = fmul <2 x double> %broadcast.splat280, %wide.load278
  %i.ed = getelementptr inbounds nuw [8 x i8], ptr %i.dv, i64 %index274
  store <2 x double> %i.ec, ptr %i.ed, align 8, !tbaa !52, !alias.scope !162, !noalias !163
  %index.next281 = add nuw i64 %index274, 2       ; 2 uses
  %i.ee = icmp eq i64 %index.next281, %n.vec272
  br i1 %i.ee, label %middle.block282, label %vector.body273, !llvm.loop !144
...
scalar.ph269.prol:                                ; preds = %scalar.ph269.preheader
  ...
  store double %i.ej, ptr %i.ek, align 8, !tbaa !52
  %i.el = load double, ptr %i.au, align 8, !tbaa !71
  ...
  store double %i.eo, ptr %i.ep, align 8, !tbaa !52
...
scalar.ph269:                                     ; preds = %scalar.ph269.prol.loopexit, %scalar.ph269
  ...
  %i.er = load double, ptr %i.at, align 8, !tbaa !67
  %i.es = getelementptr inbounds nuw [8 x i8], ptr %i.bq, i64 %indvars.iv213
  %i.et = load double, ptr %i.es, align 8, !tbaa !52
  %i.eu = load double, ptr %i.au, align 8, !tbaa !71
  ...
  store double %i.ev, ptr %i.ew, align 8, !tbaa !52
  %i.ex = load double, ptr %i.au, align 8, !tbaa !71
  ...
  store double %i.fa, ptr %i.fb, align 8, !tbaa !52
  %indvars.iv.next214 = add nuw nsw i64 %indvars.iv213, 1 ; 4 uses
  %i.fc = load double, ptr %i.at, align 8, !tbaa !67
  %i.fd = getelementptr inbounds nuw [8 x i8], ptr %i.bq, i64 %indvars.iv.next214
  %i.fe = load double, ptr %i.fd, align 8, !tbaa !52
  %i.ff = load double, ptr %i.au, align 8, !tbaa !71
  ...
  store double %i.fg, ptr %i.fh, align 8, !tbaa !52
  %i.fi = load double, ptr %i.au, align 8, !tbaa !71
  %i.fj = getelementptr inbounds nuw [8 x i8], ptr %i.bz, i64 %indvars.iv.next214
  %i.fk = load double, ptr %i.fj, align 8, !tbaa !52
  %i.fl = fmul double %i.fi, %i.fk
  %i.fm = getelementptr inbounds nuw [8 x i8], ptr %i.dv, i64 %indvars.iv.next214
  store double %i.fl, ptr %i.fm, align 8, !tbaa !52
  ...
  br i1 %exitcond217.not.1, label %.lr.ph.preheader.i, label %scalar.ph269, !llvm.loop !145

.lr.ph.preheader.i:                               ; preds = %scalar.ph269.prol.loopexit, %scalar.ph269, %middle.block282
  %i.fn = load ptr, ptr %i.j, align 8, !tbaa !45  ; 5 uses
  %i.fo = load ptr, ptr %i.l, align 8, !tbaa !47  ; 5 uses
  %i.fp = load double, ptr %i.bb, align 8, !tbaa !59
  %i.fq = load double, ptr %i.bc, align 8, !tbaa !60
  %i.fr = load ptr, ptr %i.bd, align 8, !tbaa !31 ; 5 uses
  %i.fs = zext nneg i32 %i.dr to i64              ; 5 uses
...
vector.memcheck:                                  ; preds = %.lr.ph.preheader.i
  ...
  %i.fw = shl nuw nsw i64 %indvars.iv.lcssa, 3
  %op.rdx = add i64 %i.fv, 15
  %op.rdx320 = add i64 %op.rdx, %i.fw
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <2 x double> zeroinitializer, ptr %i.fy, align 8, !tbaa !52
  store <2 x double> zeroinitializer, ptr %i.fz, align 8, !tbaa !52
  %i.ga = getelementptr inbounds nuw [8 x i8], ptr %i.fr, i64 %index ; 2 uses
  %i.gb = getelementptr inbounds nuw i8, ptr %i.ga, i64 16
  %wide.load = load <2 x ptr>, ptr %i.ga, align 8, !tbaa !57
  %wide.load240 = load <2 x ptr>, ptr %i.gb, align 8, !tbaa !57
  %i.gc = getelementptr inbounds nuw [8 x i8], ptr %i.fo, i64 %i.fx ; 2 uses
  %i.gd = getelementptr inbounds nuw i8, ptr %i.gc, i64 16
  store <2 x ptr> %wide.load, ptr %i.gc, align 8, !tbaa !57
  store <2 x ptr> %wide.load240, ptr %i.gd, align 8, !tbaa !57
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader
  ...
  store double 0.000000e+00, ptr %i.gg, align 8, !tbaa !52
  %i.gh = getelementptr inbounds nuw [8 x i8], ptr %i.fr, i64 %indvars.iv.i.ph
  %i.gi = load ptr, ptr %i.gh, align 8, !tbaa !57
  %i.gj = getelementptr inbounds nuw [8 x i8], ptr %i.fo, i64 %i.gf
  store ptr %i.gi, ptr %i.gj, align 8, !tbaa !57
...
.lr.ph43.i:                                       ; preds = %._crit_edge.i, %.preheader.i
  ...
  %i.gy = load double, ptr %i.gx, align 8, !tbaa !52
...
bb.n:                                             ; preds = %erkStep_ApplyForcing.exit, %.loopexit319
  ...
  %i.hp = load ptr, ptr %i.be, align 8, !tbaa !75
...
bb.o:                                             ; preds = %bb.n
  %i.hr = load i32, ptr %i.aq, align 4, !tbaa !40
...
bb.p:                                             ; preds = %bb.o
  %i.hv = load ptr, ptr %i.bg, align 8, !tbaa !76 ; 2 uses
  %.not164 = icmp eq ptr %i.hv, null
  br i1 %.not164, label %bb.r, label %bb.q

bb.q:                                             ; preds = %bb.p
  %i.hw = load double, ptr %i.av, align 8, !tbaa !72
  %i.hx = load ptr, ptr %i.be, align 8, !tbaa !75
  %i.hy = load ptr, ptr %i.bh, align 8, !tbaa !55
...
bb.r:                                             ; preds = %bb.p, %bb.o
  %i.ia = load ptr, ptr %i.bi, align 8, !tbaa !164 ; 2 uses
  %.not165 = icmp eq ptr %i.ia, null
  br i1 %.not165, label %bb.t, label %bb.s

bb.s:                                             ; preds = %bb.r
  %i.ib = load double, ptr %i.av, align 8, !tbaa !72
  %i.ic = load ptr, ptr %i.be, align 8, !tbaa !75
  %i.id = load ptr, ptr %i.bh, align 8, !tbaa !55
...
bb.t:                                             ; preds = %bb.r, %bb.s, %bb.q
  %i.if = load ptr, ptr %i.bj, align 8, !tbaa !54 ; 2 uses
  %.not168 = icmp eq ptr %i.if, null
  br i1 %.not168, label %bb.v, label %bb.u

bb.u:                                             ; preds = %bb.t
  %i.ig = load double, ptr %i.av, align 8, !tbaa !72
  %i.ih = load ptr, ptr %i.be, align 8, !tbaa !75
  %i.ii = load ptr, ptr %i.bh, align 8, !tbaa !55
...
bb.v:                                             ; preds = %bb.u, %bb.t
  %i.ik = load ptr, ptr %i.e, align 8, !tbaa !29
  %i.il = load double, ptr %i.av, align 8, !tbaa !72
  %i.im = load ptr, ptr %i.be, align 8, !tbaa !75
  %i.in = load ptr, ptr %i.aw, align 8, !tbaa !56
  %i.io = getelementptr inbounds nuw [8 x i8], ptr %i.in, i64 %indvars.iv218
  %i.ip = load ptr, ptr %i.io, align 8, !tbaa !57
  %i.iq = load ptr, ptr %i.bh, align 8, !tbaa !55
