...
bb.a:
  %i.a = tail call ptr @N_VGetArrayPointer(ptr noundef %1) #9 ; 14 uses
...
.peel.next:                                       ; preds = %.loopexit.peel.begin, %bb.c
  %indvars.iv128 = phi i64 [ 0, %bb.c ], [ %indvars.iv.next129, %.loopexit.peel.begin ] ; 8 uses
  ...
  %4 = load <2 x double>, ptr %i.by, align 8, !tbaa !19 ; 5 uses
  %5 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ay, <2 x double> splat (double -2.000000e+00), <2 x double> %4) ; 2 uses
  %foldExtExtBinop = fadd <2 x double> %4, %5
  %i.bz = extractelement <2 x double> %foldExtExtBinop, i64 0
  %6 = fmul double %i.v, %i.bz
  %foldExtExtBinop140 = fadd <2 x double> %4, %5
  %i.ca = extractelement <2 x double> %foldExtExtBinop140, i64 1
  %7 = fmul double %i.v, %i.ca
  %8 = fsub <2 x double> %4, %4                   ; 2 uses
  %9 = extractelement <2 x double> %8, i64 0
  %i.cb = fmul double %i.x, %9
  %10 = extractelement <2 x double> %8, i64 1
  %i.cc = fmul double %i.x, %10
  %i.cd = extractelement <2 x double> %i.bw, i64 0
  %i.ce = fadd double %i.cd, %6
  ...
  %11 = trunc nuw nsw i64 %i.as to i32
...
bb.a:
  ...
  %i.b = tail call ptr @N_VGetArrayPointer(ptr noundef %0) #9 ; 15 uses
...
.peel.next:                                       ; preds = %.loopexit.peel.begin, %bb.c
  %indvars.iv134 = phi i64 [ 0, %bb.c ], [ %indvars.iv.next135, %.loopexit.peel.begin ] ; 8 uses
  ...
  %7 = tail call double @llvm.fmuladd.f64(double %i.az, double 4.660000e-16, double f0x40181FBE76C8B43A)
  %8 = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %i.ao
  %i.bg = load double, ptr %i.bb, align 8, !tbaa !19
  %9 = load <2 x double>, ptr %i.ba, align 8, !tbaa !19 ; 4 uses
  %i.bh = load <2 x double>, ptr %i.bc, align 8, !tbaa !19
  %i.bi = load <2 x double>, ptr %i.bd, align 8, !tbaa !19
  %i.bj = load <2 x double>, ptr %i.bf, align 8, !tbaa !19 ; 4 uses
  %i.bk = fneg double %7
  ...
  %i.bp = fneg double %i.bg
  %i.bq = shufflevector <2 x double> %9, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  ...
  %i.bv = shufflevector <2 x double> %9, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.ca = fmul <2 x double> %i.bz, %i.bi
  ...
  %i.cd = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cc, <2 x double> %9, <2 x double> %i.ca)
  ...
  %i.cg = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cf, <2 x double> %i.bh, <2 x double> %i.cd)
  %i.ch = fadd <2 x double> %i.bx, %i.cg
  %i.ci = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %9, <2 x double> splat (double -2.000000e+00), <2 x double> %i.bj)
  %i.cj = fadd <2 x double> %i.bj, %i.ci
  %i.ck = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.w, <2 x double> %i.cj, <2 x double> %i.ch)
  %i.cl = fsub <2 x double> %i.bj, %i.bj
  %i.cm = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.u, <2 x double> %i.cl, <2 x double> %i.ck)
  store <2 x double> %i.cm, ptr %8, align 8, !tbaa !19
