...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  %i.bf = load double, ptr %i.ak, align 8, !tbaa !26 ; 4 uses
  ...
  %i.dy = fadd double %i.dk, %i.dx                ; 3 uses
  ...
  %i.ed = insertelement <2 x double> poison, double %i.bf, i64 0 ; 2 uses
  ...
  %i.ew = insertelement <2 x double> %i.ed, double %i.dy, i64 1
