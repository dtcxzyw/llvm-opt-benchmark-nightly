...
.lr.ph162.preheader:                              ; preds = %bb.d
  ...
  %i.w = add nuw i32 %4, 1
  %wide.trip.count198 = zext i32 %i.w to i64
  br label %.lr.ph162
...
.lr.ph162:                                        ; preds = %.lr.ph162.preheader, %.lr.ph162
  %indvars.iv194 = phi i64 [ 1, %.lr.ph162.preheader ], [ %indvars.iv.next195, %.lr.ph162 ] ; 2 uses
  %i.ak = getelementptr inbounds nuw [8 x i8], ptr %6, i64 %indvars.iv194
  ...
  br i1 %exitcond199.not, label %.lr.ph164, label %.lr.ph162

.lr.ph164:                                        ; preds = %.lr.ph162, %._crit_edge165
  %indvars.iv203 = phi i64 [ %indvars.iv.next204, %._crit_edge165 ], [ %wide.trip.count, %.lr.ph162 ] ; 2 uses
  %indvars.iv.next204 = add nsw i64 %indvars.iv203, -1 ; 2 uses
  %i.am = and i64 %indvars.iv.next204, 4294967295 ; 2 uses
...
._crit_edge165:                                   ; preds = %bb.i
  %.phi.trans.insert214 = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %i.am
  %.pre215 = load ptr, ptr %.phi.trans.insert214, align 8, !tbaa !25
  %i.aq = load ptr, ptr %6, align 8, !tbaa !25    ; 2 uses
  tail call void @N_VLinearSum(double noundef %i.ap, ptr noundef %i.aq, double noundef 1.000000e+00, ptr noundef %.pre215, ptr noundef %i.aq) #4
  %i.ar = trunc nuw i64 %indvars.iv203 to i32
  %i.as = icmp sgt i32 %i.ar, 1
  br i1 %i.as, label %.lr.ph164, label %._crit_edge168

bb.i:                                             ; preds = %.lr.ph164, %bb.i
  %indvars.iv200 = phi i64 [ %wide.trip.count, %.lr.ph164 ], [ %indvars.iv.next201, %bb.i ] ; 3 uses
  %i.at = getelementptr inbounds nuw [8 x i8], ptr %6, i64 %indvars.iv200 ; 2 uses
  %i.au = load ptr, ptr %i.at, align 8, !tbaa !25 ; 2 uses
  %i.av = trunc nuw i64 %indvars.iv200 to i32     ; 2 uses
...
.lr.ph173.preheader:                              ; preds = %._crit_edge, %._crit_edge168
  ...
  %wide.trip.count211 = zext i32 %i.be to i64
  br label %.lr.ph173

.lr.ph173:                                        ; preds = %.lr.ph173.preheader, %.lr.ph173
  %indvars.iv206 = phi i64 [ 1, %.lr.ph173.preheader ], [ %indvars.iv.next207, %.lr.ph173 ] ; 3 uses
  %.0111170 = phi double [ 1.000000e+00, %.lr.ph173.preheader ], [ %i.bi, %.lr.ph173 ]
  %i.bf = trunc nuw nsw i64 %indvars.iv206 to i32
  %i.bg = uitofp nneg i32 %i.bf to double
  %i.bh = fdiv double %5, %i.bg
  %i.bi = fmul double %.0111170, %i.bh            ; 2 uses
  %i.bj = getelementptr inbounds nuw [8 x i8], ptr %6, i64 %indvars.iv206
  ...
  br i1 %exitcond212.not, label %.thread, label %.lr.ph173
