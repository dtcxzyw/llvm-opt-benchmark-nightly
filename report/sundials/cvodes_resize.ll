...
.lr.ph138:                                        ; preds = %.lr.ph138.preheader, %.lr.ph138
  ...
  %i.bl = load ptr, ptr %i.bk, align 8, !tbaa !11 ; 2 uses
...
.lr.ph173.preheader:                              ; preds = %._crit_edge, %._crit_edge168
  ...
  tail call void @N_VScale(double noundef 1.000000e+00, ptr noundef %i.bb, ptr noundef %i.bc) #4
  %i.bd = getelementptr inbounds nuw i8, ptr %6, i64 8
  %i.be = load ptr, ptr %i.bd, align 8, !tbaa !11
  tail call void @N_VScale(double noundef 1.000000e+00, ptr noundef nonnull %2, ptr noundef %i.be) #4
  %i.bf = add nuw i32 %4, 1
  %wide.trip.count215 = zext i32 %i.bf to i64
  br label %.lr.ph173

.lr.ph173:                                        ; preds = %.lr.ph173.preheader, %.lr.ph173
  %indvars.iv210 = phi i64 [ 1, %.lr.ph173.preheader ], [ %indvars.iv.next211, %.lr.ph173 ] ; 3 uses
  %.0111170 = phi double [ 1.000000e+00, %.lr.ph173.preheader ], [ %i.bj, %.lr.ph173 ]
  %i.bg = trunc nuw nsw i64 %indvars.iv210 to i32
  %i.bh = uitofp nneg i32 %i.bg to double
  %i.bi = fdiv double %5, %i.bh
  %i.bj = fmul double %.0111170, %i.bi            ; 2 uses
  %i.bk = getelementptr inbounds nuw [8 x i8], ptr %6, i64 %indvars.iv210
  %i.bl = load ptr, ptr %i.bk, align 8, !tbaa !11 ; 2 uses
  tail call void @N_VScale(double noundef %i.bj, ptr noundef %i.bl, ptr noundef %i.bl) #4
