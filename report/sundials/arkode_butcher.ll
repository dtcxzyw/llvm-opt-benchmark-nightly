...
bb.f:                                             ; preds = %bb.f, %.epil.preheader140
  %indvars.iv.i57.epil = phi i64 [ %indvars.iv.i57.epil.init, %.epil.preheader140 ], [ %indvars.iv.next.i58.epil, %bb.f ] ; 3 uses
  %i.cw = phi double [ %.epil.init144, %.epil.preheader140 ], [ %i.db, %bb.f ]
  %epil.iter142 = phi i64 [ 0, %.epil.preheader140 ], [ %epil.iter142.next, %bb.f ]
  %i.cx = getelementptr inbounds nuw [8 x i8], ptr %i.bz, i64 %indvars.iv.i57.epil
  %i.cy = load double, ptr %i.cx, align 8, !tbaa !22
  %i.cz = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %indvars.iv.i57.epil
...
arkode_butcher_vp.exit:                           ; preds = %bb.d, %.loopexit, %.lr.ph.preheader, %bb.a
  %.082 = phi i32 [ 0, %bb.a ], [ %i.dr, %.lr.ph.preheader ], [ 0, %.loopexit ], [ 0, %bb.d ]
...
.preheader.us.i.new:                              ; preds = %.preheader.us.i, %.preheader.us.i.new
  ...
  %i.bo = getelementptr inbounds nuw [8 x i8], ptr %i.am, i64 %indvars.iv.i
  ...
  br i1 %niter.ncmp.7, label %._crit_edge.us.i.unr-lcssa, label %.preheader.us.i.new

bb.l:                                             ; preds = %._crit_edge.us.i
  ...
  br i1 %exitcond30.not.i, label %.preheader.us.i2328.preheader, label %.preheader.us.i

.preheader.us.i2328.preheader:                    ; preds = %bb.l
  %xtraiter8560 = and i64 %wide.trip.count, 7     ; 3 uses
  %i.bs = icmp ult i64 %i.aj, 7
  %unroll_iter8565 = and i64 %wide.trip.count, 2147483640
  %lcmp.mod8562.not = icmp eq i64 %xtraiter8560, 0
end_hunk_0
