...
.preheader65.us.new:                              ; preds = %.preheader65.us, %.preheader65.us.new
  ...
  %i.t = getelementptr inbounds nuw [8 x i8], ptr %i.s, i64 %indvars.iv82
  %i.u = load ptr, ptr %i.t, align 8, !tbaa !50
  %i.v = getelementptr inbounds nuw [8 x i8], ptr %i.m, i64 %indvars.iv77
  store ptr %i.u, ptr %i.v, align 8, !tbaa !50
  %i.w = getelementptr inbounds nuw [8 x i8], ptr %5, i64 %indvars.iv77
  %i.x = load ptr, ptr %i.w, align 8, !tbaa !60
  %i.y = getelementptr inbounds nuw [8 x i8], ptr %i.x, i64 %indvars.iv82
...
.preheader60.us.new:                              ; preds = %.preheader60.us, %.preheader60.us.new
  ...
  br i1 %niter.ncmp.3, label %._crit_edge.us.unr-lcssa, label %.preheader60.us.new
...
._crit_edge.us.unr-lcssa:                         ; preds = %.preheader60.us.new
  br i1 %lcmp.mod.not, label %._crit_edge.us, label %.epil.preheader

.epil.preheader:                                  ; preds = %._crit_edge.us.unr-lcssa, %.preheader60.us
  %indvars.iv75.epil.init = phi i64 [ 0, %.preheader60.us ], [ %indvars.iv.next76.3, %._crit_edge.us.unr-lcssa ]
  tail call void @llvm.assume(i1 %lcmp.mod116)
  br label %bb.g

bb.g:                                             ; preds = %bb.g, %.epil.preheader
  %indvars.iv75.epil = phi i64 [ %indvars.iv75.epil.init, %.epil.preheader ], [ %indvars.iv.next76.epil, %bb.g ] ; 3 uses
  %epil.iter = phi i64 [ 0, %.epil.preheader ], [ %epil.iter.next, %bb.g ]
  %i.be = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %indvars.iv75.epil
  %i.bf = load ptr, ptr %i.be, align 8, !tbaa !60
  %i.bg = getelementptr inbounds nuw [8 x i8], ptr %i.bf, i64 %indvars.iv80
  %i.bh = load ptr, ptr %i.bg, align 8, !tbaa !50
  %i.bi = getelementptr inbounds nuw [8 x i8], ptr %i.aj, i64 %indvars.iv75.epil
  store ptr %i.bh, ptr %i.bi, align 8, !tbaa !50
  %indvars.iv.next76.epil = add nuw nsw i64 %indvars.iv75.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %._crit_edge.us, label %bb.g, !llvm.loop !64

._crit_edge.us:                                   ; preds = %bb.g, %._crit_edge.us.unr-lcssa
  %i.bj = load ptr, ptr %4, align 8, !tbaa !50
  ...
  %i.bo = getelementptr inbounds nuw [8 x i8], ptr %4, i64 %indvars.iv80
  %i.bp = load ptr, ptr %i.bo, align 8, !tbaa !50
  %i.bq = tail call i32 %i.bn(i32 noundef %1, ptr noundef %2, ptr noundef nonnull %i.aj, ptr noundef %i.bp) #14 ; 2 uses
  %.not59.us = icmp eq i32 %i.bq, 0
  br i1 %.not59.us, label %bb.f, label %._crit_edge63

bb.h:                                             ; preds = %.preheader60
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count83
  br i1 %exitcond.not, label %._crit_edge63, label %.preheader60

.preheader60:                                     ; preds = %.preheader60.lr.ph, %bb.h
  %indvars.iv = phi i64 [ %indvars.iv.next, %bb.h ], [ 0, %.preheader60.lr.ph ] ; 2 uses
  %i.br = load ptr, ptr %4, align 8, !tbaa !50
  ...
  %i.bw = getelementptr inbounds nuw [8 x i8], ptr %4, i64 %indvars.iv
  %i.bx = load ptr, ptr %i.bw, align 8, !tbaa !50
  %i.by = tail call i32 %i.bv(i32 noundef %1, ptr noundef %2, ptr noundef %i.aj, ptr noundef %i.bx) #14 ; 2 uses
  %.not59 = icmp eq i32 %i.by, 0
  br i1 %.not59, label %bb.h, label %._crit_edge63

._crit_edge63:                                    ; preds = %bb.h, %.preheader60, %bb.f, %._crit_edge.us, %bb.e
  %.1 = phi i32 [ 0, %bb.e ], [ %i.bq, %._crit_edge.us ], [ 0, %bb.f ], [ %i.by, %.preheader60 ], [ 0, %bb.h ]
  tail call void @free(ptr noundef %i.aj) #14
  br label %.loopexit

.lr.ph69.split:                                   ; preds = %.lr.ph69, %.lr.ph69.split
  %indvars.iv85 = phi i64 [ %indvars.iv.next86, %.lr.ph69.split ], [ 0, %.lr.ph69 ] ; 3 uses
  %i.bz = load ptr, ptr %4, align 8, !tbaa !50
  ...
  %i.ce = load double, ptr %2, align 8, !tbaa !48
  %i.cf = load ptr, ptr %3, align 8, !tbaa !60
  %i.cg = getelementptr inbounds nuw [8 x i8], ptr %i.cf, i64 %indvars.iv85
  %i.ch = load ptr, ptr %i.cg, align 8, !tbaa !50
  %i.ci = getelementptr inbounds nuw [8 x i8], ptr %4, i64 %indvars.iv85
  %i.cj = load ptr, ptr %i.ci, align 8, !tbaa !50
  tail call void %i.cd(double noundef %i.ce, ptr noundef %i.ch, ptr noundef %i.cj) #14
...
.loopexit:                                        ; preds = %.lr.ph69.split, %._crit_edge.us70, %.preheader, %._crit_edge63, %bb.b
  %.2 = phi i32 [ %i.f, %bb.b ], [ %.1, %._crit_edge63 ], [ 0, %.preheader ], [ 0, %._crit_edge.us70 ], [ 0, %.lr.ph69.split ]
  ret i32 %.2
}
...
bb.a:
  ...
  %i.e = tail call double %i.d(ptr noundef %0, ptr noundef %1) #14
  ret double %i.e
}
...
bb.a:
  ...
  %i.e = tail call double %i.d(ptr noundef %0) #14
  ret double %i.e
}
...
bb.a:
  ...
  %i.e = tail call double %i.d(ptr noundef %0, ptr noundef %1, ptr noundef %2) #14
  ret double %i.e
}
...
bb.a:
  ...
  %i.e = tail call i32 %i.d(ptr noundef %0, ptr noundef %1) #14
  ret i32 %i.e
}
...
bb.a:
  ...
  %i.e = tail call i32 %i.d(ptr noundef %0, ptr noundef %1, ptr noundef %2) #14
  ret i32 %i.e
}
