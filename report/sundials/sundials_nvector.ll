...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %i.h = load ptr, ptr %3, align 8, !tbaa !29
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %i.h = load ptr, ptr %2, align 8, !tbaa !29
  %i.i = getelementptr inbounds nuw i8, ptr %i.h, i64 8
  %i.j = load ptr, ptr %i.i, align 8, !tbaa !12
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  %indvars.iv = phi i64 [ 0, %.lr.ph.preheader ], [ %indvars.iv.next, %.lr.ph ] ; 4 uses
  %i.h = load ptr, ptr %1, align 8, !tbaa !29
  %i.i = getelementptr inbounds nuw i8, ptr %i.h, i64 8
  %i.j = load ptr, ptr %i.i, align 8, !tbaa !12
  ...
  store double %i.q, ptr %i.r, align 8, !tbaa !27
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %.loopexit, label %.lr.ph
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  store double %i.n, ptr %i.o, align 8, !tbaa !27
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %.loopexit, label %.lr.ph
...
.preheader65.us.new:                              ; preds = %.preheader65.us, %.preheader65.us.new
  ...
  store ptr %i.y, ptr %i.z, align 8, !tbaa !29
...
._crit_edge.us.unr-lcssa:                         ; preds = %.preheader65.us.new
  br i1 %8, label %.epil.preheader, label %._crit_edge.us
...
.epil.preheader:                                  ; preds = %._crit_edge.us.unr-lcssa, %.preheader65.us
  ...
  store ptr %i.as, ptr %i.at, align 8, !tbaa !29
  br label %._crit_edge.us

._crit_edge.us:                                   ; preds = %._crit_edge.us.unr-lcssa, %.epil.preheader
  %i.au = load ptr, ptr %3, align 8, !tbaa !29
...
bb.g:                                             ; preds = %.preheader, %bb.g
  ...
  %i.bl = load ptr, ptr %3, align 8, !tbaa !29
  ...
  %i.br = load double, ptr %i.bq, align 8, !tbaa !27
  %i.bs = load ptr, ptr %i.bk, align 8, !tbaa !29
...
bb.a:
  %i.a = load ptr, ptr %4, align 8, !tbaa !29
  %i.b = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !12   ; 2 uses
...
.lr.ph.us:                                        ; preds = %.lr.ph.us.preheader, %._crit_edge.us70
  ...
  %i.k = load ptr, ptr %4, align 8, !tbaa !29
  ...
  %i.p = load double, ptr %2, align 8, !tbaa !27
  %i.q = load ptr, ptr %3, align 8, !tbaa !33
...
bb.d:                                             ; preds = %.lr.ph.us, %bb.d
  ...
  %i.v = load ptr, ptr %4, align 8, !tbaa !29
  ...
  %i.ag = load ptr, ptr %i.t, align 8, !tbaa !29  ; 2 uses
