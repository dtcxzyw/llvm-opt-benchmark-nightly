...
bb.e:                                             ; preds = %.lr.ph156, %bb.e
  ...
  %i.co = mul nuw nsw i64 %i.ck, %i.cj
...
.lr.ph163:                                        ; preds = %.lr.ph163.preheader, %.lr.ph163
  ...
  %i.eg = mul nuw nsw i64 %i.ed, %i.eb            ; 2 uses
  %i.eh = getelementptr inbounds nuw [8 x i8], ptr %i.ec, i64 %i.eg
