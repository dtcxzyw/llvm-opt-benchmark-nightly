...
.prol.loopexit.unr-lcssa:                         ; preds = %.lr.ph
  ...
  %4 = load double, ptr %gep.prol, align 8, !tbaa !28
  %5 = getelementptr i8, ptr %gep.prol, i64 8
  %6 = load double, ptr %5, align 8, !tbaa !28
  %7 = insertelement <2 x double> poison, double %6, i64 0
  %8 = shufflevector <2 x double> %7, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ad = fmul <2 x double> %i.t, %8
  %9 = insertelement <2 x double> poison, double %4, i64 0
  %i.ae = shufflevector <2 x double> %9, <2 x double> poison, <2 x i32> zeroinitializer
...
.lr.ph.new:                                       ; preds = %.prol.loopexit, %.lr.ph.new
  ...
  %gep = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep, i64 %i.ai ; 3 uses
  %10 = load double, ptr %gep, align 8, !tbaa !28
  %11 = getelementptr i8, ptr %gep, i64 8
  %12 = load double, ptr %11, align 8, !tbaa !28
  %13 = insertelement <2 x double> poison, double %12, i64 0
  %14 = shufflevector <2 x double> %13, <2 x double> poison, <2 x i32> zeroinitializer
  %i.aj = fmul <2 x double> %i.t, %14
  %15 = insertelement <2 x double> poison, double %10, i64 0
  %i.ak = shufflevector <2 x double> %15, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %gep.1 = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep, i64 %i.an ; 3 uses
  %16 = load double, ptr %gep.1, align 8, !tbaa !28
  %17 = getelementptr i8, ptr %gep.1, i64 8
  %18 = load double, ptr %17, align 8, !tbaa !28
  %19 = insertelement <2 x double> poison, double %18, i64 0
  %20 = shufflevector <2 x double> %19, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ao = fmul <2 x double> %i.t, %20
