...
bb.a:
  ...
  %5 = tail call double @sin(double noundef %i.o) #12 ; 4 uses
  %6 = tail call double @cos(double noundef %i.o) #12 ; 3 uses
  %7 = load double, ptr %4, align 8, !tbaa !26    ; 8 uses
  ...
  %i.ag = load double, ptr %8, align 8, !tbaa !34 ; 2 uses
  ...
  %i.bj = tail call double @llvm.fmuladd.f64(double %7, double %i.aw, double %i.ay)
  ...
  %i.bn = tail call double @llvm.fmuladd.f64(double %7, double %7, double 1.000000e+00)
  ...
  %i.cd = fmul double %7, %i.cc                   ; 2 uses
  ...
  %i.ck = fsub double %i.bu, %i.af
  %i.cl = load <2 x double>, ptr %i.ad, align 8, !tbaa !12 ; 2 uses
  ...
  %i.dp = fsub double %i.m, %6
  %i.dq = insertelement <2 x double> poison, double %6, i64 0
  ...
  %i.dz = tail call double @llvm.fmuladd.f64(double %9, double %i.y, double %i.dy)
  %i.ea = tail call double @llvm.fmuladd.f64(double %11, double %i.aa, double %i.dz)
  store double %i.ea, ptr %i.j, align 8, !tbaa !12
  %i.eb = load double, ptr %12, align 8, !tbaa !12
  %i.ec = fsub double %i.eb, %i.dw
  %i.ed = fadd double %i.y, %i.ec
  store double %i.ed, ptr %13, align 8, !tbaa !12
  %i.ee = load double, ptr %14, align 8, !tbaa !12
  %i.ef = fsub double %i.ee, %i.s
  %i.eg = tail call double @llvm.fmuladd.f64(double %5, double %i.y, double %i.ef)
  %i.eh = tail call double @llvm.fmuladd.f64(double %i.dt, double %i.aa, double %i.eg)
  store double %i.eh, ptr %15, align 8, !tbaa !12
  %i.ei = load double, ptr %16, align 8, !tbaa !12
  %i.ej = tail call double @llvm.fmuladd.f64(double %i.c, double %i.ei, double %i.dm)
  %i.ek = tail call double @llvm.fmuladd.f64(double %9, double %i.u, double %i.ej)
  %i.el = tail call double @llvm.fmuladd.f64(double %11, double %i.w, double %i.ek)
  store double %i.el, ptr %17, align 8, !tbaa !12
  %i.em = load double, ptr %18, align 8, !tbaa !12
  %i.en = tail call double @llvm.fmuladd.f64(double %i.e, double %i.em, double %i.dn)
  %i.eo = fadd double %i.u, %i.en
  store double %i.eo, ptr %19, align 8, !tbaa !12
  %i.ep = load double, ptr %20, align 8, !tbaa !12
  %i.eq = tail call double @llvm.fmuladd.f64(double %i.g, double %i.ep, double %i.do)
  %i.er = insertelement <2 x double> poison, double %5, i64 0
  %i.es = insertelement <2 x double> %i.er, double %9, i64 1
  ...
  %i.ey = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ds, <2 x double> %23, <2 x double> %i.ex)
  store <2 x double> %i.ey, ptr %21, align 8, !tbaa !12
  %i.ez = shufflevector <2 x double> %i.ds, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %i.fa = insertelement <2 x double> %i.ez, double %5, i64 1
  ...
  store <2 x double> %i.fe, ptr %24, align 8, !tbaa !12
  %i.ff = fmul double %i.ac, %i.du
  %i.fg = fneg double %i.s
  %i.fh = fmul double %6, %i.fg
