...
.lr.ph.us.preheader:                              ; preds = %.lr.ph128.split.split
  ...
  %12 = insertelement <2 x ptr> %11, ptr %scevgep244, i64 1
...
.lr.ph115.us.us:                                  ; preds = %._crit_edge116.split.us.us.us, %.lr.ph.us
  ...
  %13 = insertelement <2 x ptr> %9, ptr %scevgep243, i64 0
...
.preheader.i.i.us.us.us:                          ; preds = %._crit_edge.i.i.us.us.us, %.preheader.preheader.i.i.us.us.us
  ...
  %brmerge275 = select i1 %min.iters.check253, i1 true, i1 %.not.not
...
.lr.ph.us.preheader:                              ; preds = %.lr.ph136.split.split
  ...
  %8 = insertelement <2 x ptr> poison, ptr %i.ai, i64 0
  %9 = insertelement <2 x ptr> %8, ptr %i.au, i64 1
  %10 = insertelement <2 x ptr> poison, ptr %scevgep, i64 1
  %11 = insertelement <2 x ptr> poison, ptr %i.ai, i64 1
  %12 = insertelement <2 x ptr> poison, ptr %scevgep, i64 0
  %13 = insertelement <2 x ptr> %12, ptr %scevgep214, i64 1
...
.lr.ph123.us.us:                                  ; preds = %._crit_edge124.split.us.us.us, %.lr.ph.us
  ...
  %14 = insertelement <2 x ptr> %10, ptr %scevgep213, i64 0
  %15 = insertelement <2 x ptr> %11, ptr %i.ce, i64 0
  %16 = icmp ult <2 x ptr> %9, %14
  %17 = icmp ult <2 x ptr> %15, %13
  %18 = and <2 x i1> %17, %16
  %19 = bitcast <2 x i1> %18 to i2
  %.not = icmp eq i2 %19, 0
...
.preheader.i.i.us.us.us:                          ; preds = %._crit_edge.i.i.us.us.us, %.preheader.preheader.i.i.us.us.us
  ...
  %.not.not = xor i1 %.not, true
  %brmerge247 = select i1 %min.iters.check223, i1 true, i1 %.not.not
