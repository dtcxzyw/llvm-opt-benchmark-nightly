...
.split:                                           ; preds = %.split.preheader, %.split86
  ...
  %i.av = mul nuw nsw i64 %indvars.iv96, %i.z     ; 2 uses
  %i.aw = trunc i64 %i.av to i32                  ; 2 uses
  %i.ax = mul nuw nsw i64 %indvars.iv96, %i.y     ; 2 uses
...
bb.b:                                             ; preds = %.split, %._crit_edge
  ...
  %i.bv = mul nuw nsw i64 %indvars.iv92, %i.s     ; 3 uses
  %i.bw = add nuw i64 %i.av, %i.bv                ; 2 uses
  ...
  %i.ci = mul nuw nsw i64 %indvars.iv92, %i.s     ; 3 uses
  %i.cj = add nuw i64 %i.ax, %i.ci
...
bb.a:
  ...
  %i.ak = mul nsw i64 %i.v, 152                   ; 2 uses
  %i.al = shl nuw nsw i64 %wide.trip.count.i, 3   ; 2 uses
  %i.am = add nsw i64 %i.ak, %i.al
  %i.an = shl nsw i64 %i.w, 3
  %i.ao = shl nsw i64 %i.v, 3
  %i.ap = add nsw i64 %wide.trip.count.i, -1      ; 2 uses
  %5 = getelementptr i8, ptr %4, i64 %i.ak
  %i.aq = getelementptr i8, ptr %5, i64 %i.al
...
bb.b:                                             ; preds = %bb.a, %bb.d
  ...
  %i.bh = mul nuw nsw i64 %indvars.iv97, %i.z     ; 2 uses
  %i.bi = trunc i64 %i.bh to i32                  ; 2 uses
  %i.bj = mul nuw nsw i64 %indvars.iv97, %i.y     ; 2 uses
...
bb.c:                                             ; preds = %bb.b, %._crit_edge
  ...
  %i.cp = mul nuw nsw i64 %indvars.iv93, %wide.trip.count.i ; 3 uses
  %i.cq = add nuw i64 %i.bh, %i.cp                ; 2 uses
  ...
  %i.db = mul nuw nsw i64 %indvars.iv93, %wide.trip.count.i ; 3 uses
  %i.dc = add nuw i64 %i.bj, %i.db
