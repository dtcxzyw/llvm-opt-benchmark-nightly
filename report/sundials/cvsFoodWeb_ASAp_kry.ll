...
define internal noundef i32 @fB(double %0, ptr noundef %1, ptr noundef %2, ptr noundef %3, ptr nofree noundef captures(none) %4) #0 {
  %6 = tail call ptr @N_VGetArrayPointer(ptr noundef %1) #10 ; 5 uses
  %7 = tail call ptr @N_VGetArrayPointer(ptr noundef %2) #10 ; 25 uses
  %8 = tail call ptr @N_VGetArrayPointer(ptr noundef %3) #10 ; 4 uses
  %9 = getelementptr inbounds nuw i8, ptr %4, i64 68
  %10 = getelementptr inbounds nuw i8, ptr %4, i64 64
  %11 = load i32, ptr %10, align 8, !tbaa !26     ; 12 uses
  %12 = getelementptr inbounds nuw i8, ptr %4, i64 808
  %13 = getelementptr inbounds nuw i8, ptr %4, i64 20008 ; 3 uses
  %14 = getelementptr i8, ptr %4, i64 688         ; 3 uses
  %15 = getelementptr inbounds nuw i8, ptr %4, i64 736 ; 2 uses
  %16 = load i32, ptr %9, align 4, !tbaa !29      ; 6 uses
  ...
  %21 = sub i32 0, %16                            ; 2 uses
  %22 = getelementptr i8, ptr %4, i64 304         ; 3 uses
  %23 = getelementptr inbounds nuw i8, ptr %4, i64 592 ; 6 uses
  %24 = icmp sgt i32 %11, 0
  %25 = sub i32 0, %11                            ; 2 uses
  %.not88 = icmp slt i32 %11, 1
  %wide.trip.count.i = zext i32 %11 to i64        ; 24 uses
  %26 = add i32 %11, 1                            ; 2 uses
  %27 = sext i32 %11 to i64                       ; 4 uses
  %28 = sext i32 %16 to i64                       ; 4 uses
  %wide.trip.count = zext i32 %26 to i64          ; 4 uses
  br i1 %24, label %bb.a, label %bb.e

bb.a:                                             ; preds = %5
  %i.a = add nsw i64 %wide.trip.count, -2         ; 2 uses
  %i.b = zext i32 %16 to i64
  %scevgep = getelementptr i8, ptr %4, i64 20008
  %i.c = zext i32 %16 to i64
  ...
  %scevgep105 = getelementptr i8, ptr %8, i64 %i.f
  %i.g = getelementptr i8, ptr %4, i64 %i.d
  %scevgep107.a = getelementptr i8, ptr %i.g, i64 728
  %scevgep109.a = getelementptr i8, ptr %7, i64 %i.f
  %scevgep112 = getelementptr i8, ptr %7, i64 %i.f
  %scevgep115 = getelementptr i8, ptr %7, i64 %i.f
  %scevgep118 = getelementptr i8, ptr %7, i64 %i.f
  %scevgep121 = getelementptr i8, ptr %7, i64 %i.f
  %i.h = shl nsw i64 %28, 3
  %i.i = shl nuw nsw i64 %27, 3
  ...
  %i.m = shl nsw i64 %28, 3
  %i.n = mul nuw nsw i64 %27, 152
  %i.o = shl nuw nsw i64 %wide.trip.count.i, 3
  %i.p = add nuw nsw i64 %i.n, %i.o               ; 2 uses
  %i.q = shl nsw i64 %28, 3
  %i.r = shl nuw nsw i64 %27, 3
  ...
  %min.iters.check220 = icmp ult i32 %11, 4
  ...
  %lcmp.mod239 = trunc i32 %11 to i1
  %min.iters.check206 = icmp eq i32 %11, 1
  ...
  %min.iters.check173 = icmp ult i32 %11, 4
...
bb.b:                                             ; preds = %bb.a, %bb.d
  %indvars.iv97 = phi i64 [ %indvars.iv.next98, %bb.d ], [ 0, %bb.a ] ; 10 uses
  ...
  %scevgep191 = getelementptr i8, ptr %7, i64 %i.af
  %i.ah = add i64 %i.p, %i.af                     ; 2 uses
  %scevgep192 = getelementptr i8, ptr %7, i64 %i.ah
  %scevgep193 = getelementptr i8, ptr %6, i64 %i.af
  %scevgep194 = getelementptr i8, ptr %6, i64 %i.ah
  ...
  %i.aq = fmul double %20, %i.ap
  %i.ar = mul nsw i64 %indvars.iv97, %28
  %i.as = icmp eq i64 %indvars.iv97, 19
  %i.at = select i1 %i.as, i32 %21, i32 %16       ; 4 uses
  %i.au = icmp eq i64 %indvars.iv97, 0
  %i.av = select i1 %i.au, i32 %16, i32 %21       ; 4 uses
...
bb.c:                                             ; preds = %bb.b, %._crit_edge
  ...
  %scevgep157 = getelementptr i8, ptr %6, i64 %i.bq
  %i.br = add i64 %i.aj, %i.bp                    ; 2 uses
  %scevgep158 = getelementptr i8, ptr %6, i64 %i.br
  %scevgep159 = getelementptr i8, ptr %7, i64 %i.bq
  %scevgep160 = getelementptr i8, ptr %7, i64 %i.br
  ...
  %scevgep104 = getelementptr i8, ptr %8, i64 %i.bv ; 7 uses
  ...
  %scevgep114.a = getelementptr i8, ptr %7, i64 %i.bz
  ...
  %scevgep117 = getelementptr i8, ptr %7, i64 %i.cd
  %scevgep119 = getelementptr i8, ptr %scevgep118, i64 %i.cd
  %scevgep120 = getelementptr i8, ptr %7, i64 %i.bv
  ...
  %i.cn = fmul double %18, %i.cm
  %i.co = mul nuw nsw i64 %indvars.iv93, %27
  %i.cp = add nsw i64 %i.co, %i.ar                ; 5 uses
  %i.cq = getelementptr inbounds [8 x i8], ptr %6, i64 %i.cp ; 6 uses
  %i.cr = getelementptr inbounds [8 x i8], ptr %7, i64 %i.cp ; 5 uses
  %i.cs = getelementptr inbounds [8 x i8], ptr %12, i64 %i.cp ; 13 uses
  %i.ct = getelementptr inbounds [8 x i8], ptr %13, i64 %i.cp ; 8 uses
  %i.cu = tail call double @llvm.fmuladd.f64(double %i.cn, double %i.aq, double 1.000000e+00) ; 6 uses
  br i1 %min.iters.check220, label %.lr.ph.i.preheader236, label %.lr.ph.i.preheader

.lr.ph.i.preheader:                               ; preds = %bb.c
  %i.cv = mul i64 %i.r, %indvars.iv93
  %op.rdx233.reass = add i64 %i.cv, %invariant.op
  %diff.check = icmp ult i64 %op.rdx233.reass, 31
  br i1 %diff.check, label %.lr.ph.i.preheader236, label %vector.ph221
...
vector.body225:                                   ; preds = %vector.body225, %vector.ph221
  ...
  %i.cw = getelementptr inbounds nuw [8 x i8], ptr %23, i64 %index226 ; 2 uses
...
.lr.ph.i.preheader236:                            ; preds = %.lr.ph.i.preheader, %bb.c, %middle.block230
  %indvars.iv.i.ph = phi i64 [ 0, %.lr.ph.i.preheader ], [ 0, %bb.c ], [ %n.vec222, %middle.block230 ] ; 3 uses
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader236, %.lr.ph.i.prol
  ...
  %i.de = getelementptr inbounds nuw [8 x i8], ptr %23, i64 %indvars.iv.i.prol
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  %i.dj = getelementptr inbounds nuw [8 x i8], ptr %23, i64 %indvars.iv.i
  ...
  %i.dn = getelementptr inbounds nuw [8 x i8], ptr %23, i64 %indvars.iv.next.i
  ...
  %i.dr = getelementptr inbounds nuw [8 x i8], ptr %23, i64 %indvars.iv.next.i.1
  ...
  %i.dv = getelementptr inbounds nuw [8 x i8], ptr %23, i64 %indvars.iv.next.i.2
...
.preheader60.i:                                   ; preds = %.preheader60.i.preheader, %._crit_edge.i
  ...
  %invariant.gep.i = getelementptr inbounds nuw [8 x i8], ptr %22, i64 %indvars.iv79.i ; 3 uses
...
.preheader.i.preheader:                           ; preds = %.lr.ph67.i.prol.loopexit, %.lr.ph67.i, %middle.block215
  ...
  %bound1162 = icmp ult ptr %22, %scevgep155
...
.preheader.i:                                     ; preds = %.preheader.i.preheader, %._crit_edge70.i
  ...
  %i.fy = getelementptr inbounds nuw [48 x i8], ptr %22, i64 %indvars.iv94.i ; 4 uses
...
WebRatesB.exit:                                   ; preds = %._crit_edge70.i
  ...
  %i.hm = select i1 %i.hl, i32 %25, i32 %11       ; 4 uses
  %i.hn = icmp eq i64 %indvars.iv93, 0
  %i.ho = select i1 %i.hn, i32 %11, i32 %25       ; 4 uses
...
vector.memcheck:                                  ; preds = %vector.scevcheck
  ...
  %scevgep108 = getelementptr i8, ptr %7, i64 %i.ik
  ...
  %scevgep111 = getelementptr i8, ptr %7, i64 %i.in
  ...
  %bound0123 = icmp ult ptr %14, %scevgep106
...
vector.body:                                      ; preds = %vector.memcheck, %vector.body
  ...
  %i.iz = getelementptr inbounds [8 x i8], ptr %7, i64 %i.iy
  ...
  %i.jd = getelementptr inbounds [8 x i8], ptr %7, i64 %i.jc
  ...
  %i.jm = getelementptr inbounds [8 x i8], ptr %14, i64 %index
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %i.lf = getelementptr inbounds [8 x i8], ptr %13, i64 %i.jx
  %i.lg = load double, ptr %i.lf, align 8, !tbaa !24
  %i.lh = fsub double %i.le, %i.lg
  %i.li = getelementptr inbounds [8 x i8], ptr %8, i64 %i.jx
...
._crit_edge:                                      ; preds = %scalar.ph, %middle.block, %WebRatesB.exit
