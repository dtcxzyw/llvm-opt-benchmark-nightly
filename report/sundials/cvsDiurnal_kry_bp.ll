...
bb.a:
  %i.a = tail call ptr @N_VGetArrayPointer(ptr noundef %1) #10 ; 13 uses
...
.peel.next:                                       ; preds = %.loopexit.peel.begin, %bb.c
  %indvars.iv128 = phi i64 [ 0, %bb.c ], [ %indvars.iv.next129, %.loopexit.peel.begin ] ; 7 uses
  ...
  %invariant.gep136 = getelementptr [8 x i8], ptr %i.a, i64 %i.ao ; 2 uses
  %i.cn = getelementptr [8 x i8], ptr %i.a, i64 %i.ar ; 2 uses
  %i.co = getelementptr [8 x i8], ptr %i.a, i64 %i.ao ; 2 uses
  %i.cp = getelementptr [8 x i8], ptr %i.a, i64 %i.ar ; 2 uses
...
bb.d:                                             ; preds = %.peel.next, %bb.d
  ...
  %gep135 = getelementptr [8 x i8], ptr %invariant.gep.a, i64 %i.cu
  %i.cw = load double, ptr %gep135, align 8, !tbaa !14
  %gep137 = getelementptr [8 x i8], ptr %invariant.gep134, i64 %i.cr
  ...
  %i.eb = getelementptr [8 x i8], ptr %invariant.gep136, i64 %i.ea
  %i.ec = load double, ptr %i.eb, align 8, !tbaa !14 ; 2 uses
  %i.ed = getelementptr [8 x i8], ptr %i.cn, i64 %i.ea
  %i.ee = load double, ptr %i.ed, align 8, !tbaa !14 ; 2 uses
  %i.ef = shl i32 %i.dx, 1
  %i.eg = add i32 %i.ef, 2
  %i.eh = sext i32 %i.eg to i64                   ; 2 uses
  %i.ei = getelementptr [8 x i8], ptr %i.co, i64 %i.eh
  %i.ej = load double, ptr %i.ei, align 8, !tbaa !14 ; 2 uses
  %i.ek = getelementptr [8 x i8], ptr %i.cp, i64 %i.eh
...
.loopexit.peel.begin:                             ; preds = %bb.d
  ...
  %gep135.peel = getelementptr i8, ptr %invariant.gep.a, i64 152
  %i.fn = load double, ptr %gep135.peel, align 8, !tbaa !14
  %gep137.peel = getelementptr i8, ptr %invariant.gep134, i64 144
  ...
  %i.go = getelementptr i8, ptr %invariant.gep136, i64 128
