...
check_retval.exit117.thread:                      ; preds = %check_retval.exit115.preheader
  %i.ns = load ptr, ptr @stderr, align 8, !tbaa !21
...
check_retval.exit119:                             ; preds = %check_retval.exit117.preheader
  %i.nu = load ptr, ptr @stderr, align 8, !tbaa !21
...
check_retval.exit121:                             ; preds = %bb.x
  %i.ny = load ptr, ptr @stderr, align 8, !tbaa !21
...
check_retval.exit123:                             ; preds = %bb.y
  %i.oc = load ptr, ptr @stderr, align 8, !tbaa !21
...
check_retval.exit125:                             ; preds = %bb.z
  %i.og = load ptr, ptr @stderr, align 8, !tbaa !21
...
check_retval.exit127:                             ; preds = %bb.aa
  %i.ol = load ptr, ptr @stderr, align 8, !tbaa !21
...
check_retval.exit129:                             ; preds = %bb.ad
  %i.os = load ptr, ptr @stderr, align 8, !tbaa !21
...
bb.ae:                                            ; preds = %bb.ad
  %i.ou = load double, ptr %i.c, align 8, !tbaa !19
...
check_retval.exit131:                             ; preds = %bb.af
  %i.ox = load ptr, ptr @stderr, align 8, !tbaa !21
...
bb.a:
  ...
  %i.f = load double, ptr %i.e, align 8, !tbaa !19 ; 3 uses
  %i.g = getelementptr inbounds nuw i8, ptr %i.c, i64 16
  %i.h = load double, ptr %i.g, align 8, !tbaa !19 ; 4 uses
  %i.i = getelementptr inbounds nuw i8, ptr %i.c, i64 24
  %i.j = load <2 x double>, ptr %i.i, align 8, !tbaa !19
...
bb.c:                                             ; preds = %bb.a, %bb.b
  ...
  store double %.sink, ptr %i.x, align 8, !tbaa !26
  %i.y = getelementptr inbounds nuw i8, ptr %3, i64 5432
  %i.z = load double, ptr %i.y, align 8, !tbaa !22 ; 2 uses
  %i.aa = getelementptr inbounds nuw i8, ptr %3, i64 5456
  %i.ab = load double, ptr %i.aa, align 8, !tbaa !27 ; 2 uses
  %i.ac = getelementptr inbounds nuw i8, ptr %3, i64 5440
  %i.ad = load double, ptr %i.ac, align 8, !tbaa !28 ; 6 uses
  %i.ae = getelementptr inbounds nuw i8, ptr %3, i64 5448
  %i.af = load double, ptr %i.ae, align 8, !tbaa !39 ; 6 uses
...
.peel.next:                                       ; preds = %.loopexit.peel.begin, %bb.c
  ...
  %4 = fmul double %i.ab, %i.ap                   ; 5 uses
  %5 = fmul double %i.ab, %i.ar                   ; 2 uses
  %i.bf = load <2 x double>, ptr %i.bc, align 8, !tbaa !19 ; 5 uses
  ...
  %i.bt = load <2 x double>, ptr %i.bd, align 8, !tbaa !19
  %i.bu = load <2 x double>, ptr %i.be, align 8, !tbaa !19
  ...
  %i.cd = load double, ptr %i.cc, align 8, !tbaa !19 ; 4 uses
  ...
  %i.ci = load double, ptr %i.ch, align 8, !tbaa !19 ; 4 uses
  ...
  store double %i.cz, ptr %i.da, align 8, !tbaa !19
  ...
  %9 = insertelement <2 x double> %i.ah, double %5, i64 1 ; 2 uses
...
bb.d:                                             ; preds = %.peel.next, %bb.d
  ...
  %i.do = load double, ptr %gep, align 8, !tbaa !19
  %gep146 = getelementptr [8 x i8], ptr %invariant.gep145, i64 %i.dn
  %i.dp = load double, ptr %gep146, align 8, !tbaa !19
  %gep148 = getelementptr [8 x i8], ptr %invariant.gep147, i64 %i.dk
  %i.dq = load <2 x double>, ptr %i.dm, align 8, !tbaa !19 ; 4 uses
  ...
  %i.ei = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %9, <2 x double> %i.ef, <2 x double> %i.eh) ; 2 uses
  ...
  store double %i.fz, ptr %i.ga, align 8, !tbaa !19
  ...
  store double %i.ge, ptr %gep154, align 8, !tbaa !19
...
.loopexit.peel.begin:                             ; preds = %bb.d
  ...
  %i.gh = load double, ptr %gep.peel, align 8, !tbaa !19
  %gep146.peel = getelementptr i8, ptr %invariant.gep145, i64 232
  %i.gi = load double, ptr %gep146.peel, align 8, !tbaa !19
  %gep148.peel = getelementptr i8, ptr %invariant.gep147, i64 224
  %i.gj = load <2 x double>, ptr %i.gg, align 8, !tbaa !19 ; 4 uses
  ...
  %i.hb = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %9, <2 x double> %i.gy, <2 x double> %i.ha) ; 2 uses
  ...
  %i.hi = fmul double %4, %i.hh
  %i.hj = getelementptr i8, ptr %i.dh, i64 208
  %i.hk = load double, ptr %i.hj, align 8, !tbaa !19 ; 2 uses
  %i.hl = getelementptr i8, ptr %i.di, i64 208
  %i.hm = load double, ptr %i.hl, align 8, !tbaa !19 ; 2 uses
  ...
  %i.hs = load double, ptr %i.hr, align 8, !tbaa !19 ; 2 uses
  ...
  store double %i.il, ptr %i.im, align 8, !tbaa !19
  ...
  store double %i.iq, ptr %i.ir, align 8, !tbaa !19
...
bb.a:
  ...
  %i.f = load <2 x double>, ptr %i.e, align 8, !tbaa !19 ; 4 uses
...
.preheader106:                                    ; preds = %bb.a, %.preheader106
  ...
  %i.j = load ptr, ptr %invariant.gep, align 8, !tbaa !12
  %i.k = load ptr, ptr %invariant.gep109, align 8, !tbaa !12
  ...
  %i.l = load ptr, ptr %gep.1, align 8, !tbaa !12
  %gep110.1 = getelementptr inbounds nuw i8, ptr %invariant.gep109, i64 120
  %i.m = load ptr, ptr %gep110.1, align 8, !tbaa !12
  ...
  %i.n = load ptr, ptr %gep.2, align 8, !tbaa !12
  %gep110.2 = getelementptr inbounds nuw i8, ptr %invariant.gep109, i64 240
  %i.o = load ptr, ptr %gep110.2, align 8, !tbaa !12
  ...
  %i.p = load ptr, ptr %gep.3, align 8, !tbaa !12
  %gep110.3 = getelementptr inbounds nuw i8, ptr %invariant.gep109, i64 360
  %i.q = load ptr, ptr %gep110.3, align 8, !tbaa !12
  ...
  %i.r = load ptr, ptr %gep.4, align 8, !tbaa !12
  %gep110.4 = getelementptr inbounds nuw i8, ptr %invariant.gep109, i64 480
  %i.s = load ptr, ptr %gep110.4, align 8, !tbaa !12
  ...
  %i.t = load ptr, ptr %gep.5, align 8, !tbaa !12
  %gep110.5 = getelementptr inbounds nuw i8, ptr %invariant.gep109, i64 600
  %i.u = load ptr, ptr %gep110.5, align 8, !tbaa !12
  ...
  %i.v = load ptr, ptr %gep.6, align 8, !tbaa !12
  %gep110.6 = getelementptr inbounds nuw i8, ptr %invariant.gep109, i64 720
  %i.w = load ptr, ptr %gep110.6, align 8, !tbaa !12
  ...
  %i.x = load ptr, ptr %gep.7, align 8, !tbaa !12
  %gep110.7 = getelementptr inbounds nuw i8, ptr %invariant.gep109, i64 840
  %i.y = load ptr, ptr %gep110.7, align 8, !tbaa !12
  ...
  %i.z = load ptr, ptr %gep.8, align 8, !tbaa !12
  %gep110.8 = getelementptr inbounds nuw i8, ptr %invariant.gep109, i64 960
  %i.aa = load ptr, ptr %gep110.8, align 8, !tbaa !12
  ...
  %i.ab = load ptr, ptr %gep.9, align 8, !tbaa !12
  %gep110.9 = getelementptr inbounds nuw i8, ptr %invariant.gep109, i64 1080
  %i.ac = load ptr, ptr %gep110.9, align 8, !tbaa !12
  ...
  %i.ad = load ptr, ptr %gep.10, align 8, !tbaa !12
  %gep110.10 = getelementptr inbounds nuw i8, ptr %invariant.gep109, i64 1200
  %i.ae = load ptr, ptr %gep110.10, align 8, !tbaa !12
  ...
  %i.af = load ptr, ptr %gep.11, align 8, !tbaa !12
  %gep110.11 = getelementptr inbounds nuw i8, ptr %invariant.gep109, i64 1320
  %i.ag = load ptr, ptr %gep110.11, align 8, !tbaa !12
  ...
  %i.ah = load ptr, ptr %gep.12, align 8, !tbaa !12
  %gep110.12 = getelementptr inbounds nuw i8, ptr %invariant.gep109, i64 1440
  %i.ai = load ptr, ptr %gep110.12, align 8, !tbaa !12
  ...
  %i.aj = load ptr, ptr %gep.13, align 8, !tbaa !12
  %gep110.13 = getelementptr inbounds nuw i8, ptr %invariant.gep109, i64 1560
  %i.ak = load ptr, ptr %gep110.13, align 8, !tbaa !12
  ...
  %i.al = load ptr, ptr %gep.14, align 8, !tbaa !12
  %gep110.14 = getelementptr inbounds nuw i8, ptr %invariant.gep109, i64 1680
  %i.am = load ptr, ptr %gep110.14, align 8, !tbaa !12
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.ao = load double, ptr %i.an, align 8, !tbaa !26 ; 2 uses
  %i.ap = getelementptr inbounds nuw i8, ptr %6, i64 5432
  %i.aq = load double, ptr %i.ap, align 8, !tbaa !22 ; 2 uses
  %i.ar = getelementptr inbounds nuw i8, ptr %6, i64 5456
  %i.as = load double, ptr %i.ar, align 8, !tbaa !27 ; 2 uses
  %i.at = getelementptr inbounds nuw i8, ptr %6, i64 5440
  %i.au = load double, ptr %i.at, align 8, !tbaa !28
...
bb.d:                                             ; preds = %bb.c, %bb.d
  ...
  %i.bv = load double, ptr %gep, align 8, !tbaa !19
