...
bb.a:
  %i.a = tail call ptr @N_VGetArrayPointer(ptr noundef %1) #11 ; 13 uses
...
.peel.next:                                       ; preds = %.loopexit.peel.begin, %bb.c
  %indvars.iv139 = phi i64 [ 0, %bb.c ], [ %indvars.iv.next140, %.loopexit.peel.begin ] ; 7 uses
  ...
  %invariant.gep145 = getelementptr [8 x i8], ptr %i.a, i64 %i.bc ; 2 uses
  %invariant.gep147 = getelementptr [8 x i8], ptr %i.a, i64 %i.ay ; 2 uses
  %i.cx = getelementptr [8 x i8], ptr %i.a, i64 %i.bb ; 2 uses
  %i.cy = getelementptr [8 x i8], ptr %i.a, i64 %i.ay ; 2 uses
  %i.cz = getelementptr [8 x i8], ptr %i.a, i64 %i.bb ; 2 uses
...
bb.d:                                             ; preds = %.peel.next, %bb.d
  ...
  %gep146 = getelementptr [8 x i8], ptr %invariant.gep.a, i64 %i.de
  %i.dg = load double, ptr %gep146, align 8, !tbaa !22
  %gep148 = getelementptr [8 x i8], ptr %invariant.gep145, i64 %i.db
  ...
  %i.el = getelementptr [8 x i8], ptr %invariant.gep147, i64 %i.ek
  %i.em = load double, ptr %i.el, align 8, !tbaa !22 ; 2 uses
  %i.en = getelementptr [8 x i8], ptr %i.cx, i64 %i.ek
  %i.eo = load double, ptr %i.en, align 8, !tbaa !22 ; 2 uses
  %i.ep = shl i32 %i.eh, 1
  %i.eq = add i32 %i.ep, 2
  %i.er = sext i32 %i.eq to i64                   ; 2 uses
  %i.es = getelementptr [8 x i8], ptr %i.cy, i64 %i.er
  %i.et = load double, ptr %i.es, align 8, !tbaa !22 ; 2 uses
  %i.eu = getelementptr [8 x i8], ptr %i.cz, i64 %i.er
...
.loopexit.peel.begin:                             ; preds = %bb.d
  ...
  %gep146.peel = getelementptr i8, ptr %invariant.gep.a, i64 232
  %i.fx = load double, ptr %gep146.peel, align 8, !tbaa !22
  %gep148.peel = getelementptr i8, ptr %invariant.gep145, i64 224
  ...
  %i.gy = getelementptr i8, ptr %invariant.gep147, i64 208
