...
bb.d:                                             ; preds = %.lr.ph, %bb.d
  %indvars.iv = phi i64 [ %i.t, %.lr.ph ], [ %indvars.iv.next, %bb.d ] ; 4 uses
  %indvars.iv.next = add nsw i64 %indvars.iv, -1  ; 4 uses
  %i.u = getelementptr inbounds nuw [8 x i8], ptr %5, i64 %indvars.iv.next
  %i.v = load double, ptr %i.u, align 8, !tbaa !13 ; 2 uses
  %i.w = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv.next
  %i.x = load ptr, ptr %i.w, align 8, !tbaa !11
  %i.y = getelementptr inbounds [8 x i8], ptr %i.x, i64 %i.s
  store double %i.v, ptr %i.y, align 8, !tbaa !13
  %i.z = fneg double %i.v
  %i.aa = getelementptr inbounds nuw [8 x i8], ptr %5, i64 %indvars.iv
  store double %i.z, ptr %i.aa, align 8, !tbaa !13
  %i.ab = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %indvars.iv.next
...
._crit_edge:                                      ; preds = %bb.d, %bb.c
  ...
  %i.af = load ptr, ptr %i.g, align 8, !tbaa !8   ; 2 uses
  store ptr %i.af, ptr %6, align 8, !tbaa !8
  %i.ag = tail call i32 @N_VLinearCombination(i32 noundef %i.e, ptr noundef nonnull %5, ptr noundef nonnull %6, ptr noundef %i.af) #7 ; 0 uses
  %i.ah = load ptr, ptr %i.g, align 8, !tbaa !8   ; 2 uses
...
bb.e:                                             ; preds = %._crit_edge
  %i.ak = load ptr, ptr %i.g, align 8, !tbaa !8   ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  store double 1.000000e+00, ptr %5, align 8, !tbaa !13
  %i.at = load ptr, ptr %i.g, align 8, !tbaa !8   ; 2 uses
  store ptr %i.at, ptr %6, align 8, !tbaa !8
...
bb.h:                                             ; preds = %.lr.ph108, %bb.h
  ...
  store double %i.be, ptr %i.bc, align 8, !tbaa !13
  %i.bf = load double, ptr %i.ay, align 8, !tbaa !13
  %i.bg = fneg double %i.bf
  store double %i.bg, ptr %i.ay, align 8, !tbaa !13
...
._crit_edge109:                                   ; preds = %._crit_edge109.loopexit, %bb.g
  ...
  %i.bn = load ptr, ptr %i.g, align 8, !tbaa !8   ; 2 uses
...
bb.i:                                             ; preds = %._crit_edge109
  %i.bq = load ptr, ptr %i.g, align 8, !tbaa !8   ; 2 uses
...
bb.j:                                             ; preds = %._crit_edge109, %bb.i
  ...
  store double %i.bt, ptr %4, align 8, !tbaa !13
  br label %bb.k
