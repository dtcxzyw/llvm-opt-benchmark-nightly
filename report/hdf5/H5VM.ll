...
begin_hunk_0_@H5VM_hyper_eq:bb.a
...
.lr.ph.preheader.i:                               ; preds = %bb.d
  ...
  %indvars.iv.next.i24 = add nsw i64 %i.g, -1     ; 4 uses
  %i.h = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %indvars.iv.next.i24
  %i.i = load i64, ptr %i.h, align 8, !tbaa !8
  %i.j = icmp eq i64 %i.i, 1
  br i1 %i.j, label %.lr.ph.preheader, label %H5VM__stride_optimize1.exit

.lr.ph.preheader:                                 ; preds = %.lr.ph.preheader.i
  %indvars.i2949 = trunc i64 %indvars.iv.next.i24 to i32 ; 2 uses
  %i.k = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %indvars.iv.next.i24
  %i.l = load i64, ptr %i.k, align 8, !tbaa !8    ; 2 uses
  %cond.i50 = icmp eq i32 %indvars.i2949, 0
  br i1 %cond.i50, label %.lr.ph45.thread.i, label %.lr.ph.i

.lr.ph:                                           ; preds = %.lr.ph.i
  %indvars.i29 = trunc i64 %indvars.iv.next.i to i32 ; 2 uses
  %i.m = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %i.v
  %i.n = load i64, ptr %i.m, align 8, !tbaa !8
  %i.o = mul i64 %i.n, %i.p                       ; 2 uses
  %cond.i = icmp eq i32 %indvars.i29, 0
  br i1 %cond.i, label %.lr.ph45.thread.i, label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.lr.ph.preheader, %.lr.ph
  %i.p = phi i64 [ %i.o, %.lr.ph ], [ %i.l, %.lr.ph.preheader ] ; 4 uses
  %indvars.i2953 = phi i32 [ %indvars.i29, %.lr.ph ], [ %indvars.i2949, %.lr.ph.preheader ]
  %indvars.iv.i2752 = phi i64 [ %indvars.iv.next.i2851, %.lr.ph ], [ %i.g, %.lr.ph.preheader ]
  %indvars.iv.next.i2851 = phi i64 [ %indvars.iv.next.i, %.lr.ph ], [ %indvars.iv.next.i24, %.lr.ph.preheader ] ; 3 uses
  %i.q = add nsw i64 %indvars.iv.i2752, 4294967294
  %i.r = and i64 %i.q, 4294967295
  %i.s = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %i.r ; 2 uses
  %i.t = load i64, ptr %i.s, align 8, !tbaa !8
  %i.u = add i64 %i.t, %i.p
  store i64 %i.u, ptr %i.s, align 8, !tbaa !8
  %indvars.iv.next.i = add nsw i64 %indvars.iv.next.i2851, -1 ; 3 uses
  %i.v = and i64 %indvars.iv.next.i, 4294967295   ; 2 uses
  %i.w = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %i.v
  %i.x = load i64, ptr %i.w, align 8, !tbaa !8    ; 2 uses
  %.not19.i = icmp ne i64 %i.x, 0
  %i.y = icmp eq i64 %i.x, %i.p
  %or.cond = select i1 %.not19.i, i1 %i.y, i1 false
  br i1 %or.cond, label %.lr.ph, label %H5VM__stride_optimize1.exit.loopexit

H5VM__stride_optimize1.exit.loopexit:             ; preds = %.lr.ph.i
  %.pre = and i64 %indvars.iv.next.i2851, 4294967295
...
H5VM__stride_optimize1.exit:                      ; preds = %H5VM__stride_optimize1.exit.loopexit, %.lr.ph.preheader.i
  %.pre-phi = phi i64 [ %.pre, %H5VM__stride_optimize1.exit.loopexit ], [ %i.g, %.lr.ph.preheader.i ]
  %.014.lcssa = phi i32 [ %indvars.i2953, %H5VM__stride_optimize1.exit.loopexit ], [ %0, %.lr.ph.preheader.i ] ; 4 uses
  %.0.lcssa = phi i64 [ %i.p, %H5VM__stride_optimize1.exit.loopexit ], [ 1, %.lr.ph.preheader.i ] ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #8
  %i.z = shl nuw nsw i64 %.pre-phi, 3
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 16 %i.a, ptr nonnull readonly align 16 %i.b, i64 %i.z, i1 false)
  %i.aa = add i32 %.014.lcssa, -1
  %xtraiter = and i32 %.014.lcssa, 7              ; 3 uses
  %i.ab = icmp ult i32 %i.aa, 7
  br i1 %i.ab, label %.lr.ph.i.i.epil.preheader, label %H5VM__stride_optimize1.exit.new
...
.lr.ph45.thread.i:                                ; preds = %.lr.ph, %.lr.ph.preheader, %bb.d
  %.1.ph = phi i64 [ 1, %bb.d ], [ %i.l, %.lr.ph.preheader ], [ %i.o, %.lr.ph ]
  %i.ac = getelementptr inbounds nuw i8, ptr %4, i64 %i.f
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #8
  %i.ad = trunc i32 %5 to i8
  br label %.lr.ph45.split.i

.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i, %H5VM__stride_optimize1.exit.new
  %.011.i.i = phi i64 [ 1, %H5VM__stride_optimize1.exit.new ], [ %i.bb, %.lr.ph.i.i ]
  %.0610.i.i = phi ptr [ %i.b, %H5VM__stride_optimize1.exit.new ], [ %i.az, %.lr.ph.i.i ] ; 9 uses
  %niter = phi i32 [ 0, %H5VM__stride_optimize1.exit.new ], [ %niter.next.7, %.lr.ph.i.i ]
  %i.ae = getelementptr inbounds nuw i8, ptr %.0610.i.i, i64 8
  %i.af = load i64, ptr %.0610.i.i, align 8, !tbaa !8
  %i.ag = mul i64 %i.af, %.011.i.i
  %i.ah = getelementptr inbounds nuw i8, ptr %.0610.i.i, i64 16
  %i.ai = load i64, ptr %i.ae, align 8, !tbaa !8
  %i.aj = mul i64 %i.ai, %i.ag
  %i.ak = getelementptr inbounds nuw i8, ptr %.0610.i.i, i64 24
  %i.al = load i64, ptr %i.ah, align 8, !tbaa !8
  %i.am = mul i64 %i.al, %i.aj
  %i.an = getelementptr inbounds nuw i8, ptr %.0610.i.i, i64 32
  %i.ao = load i64, ptr %i.ak, align 8, !tbaa !8
  %i.ap = mul i64 %i.ao, %i.am
  %i.aq = getelementptr inbounds nuw i8, ptr %.0610.i.i, i64 40
  %i.ar = load i64, ptr %i.an, align 8, !tbaa !8
  %i.as = mul i64 %i.ar, %i.ap
  %i.at = getelementptr inbounds nuw i8, ptr %.0610.i.i, i64 48
  %i.au = load i64, ptr %i.aq, align 8, !tbaa !8
  %i.av = mul i64 %i.au, %i.as
  %i.aw = getelementptr inbounds nuw i8, ptr %.0610.i.i, i64 56
  %i.ax = load i64, ptr %i.at, align 8, !tbaa !8
  %i.ay = mul i64 %i.ax, %i.av
  %i.az = getelementptr inbounds nuw i8, ptr %.0610.i.i, i64 64 ; 2 uses
  %i.ba = load i64, ptr %i.aw, align 8, !tbaa !8
  %i.bb = mul i64 %i.ba, %i.ay                    ; 3 uses
  %niter.next.7 = add i32 %niter, 8               ; 2 uses
  %niter.ncmp.7 = icmp eq i32 %niter.next.7, %unroll_iter
  br i1 %niter.ncmp.7, label %H5VM_vector_reduce_product.exit.i.unr-lcssa, label %.lr.ph.i.i, !llvm.loop !13
...
.lr.ph.i.i.epil.preheader:                        ; preds = %H5VM_vector_reduce_product.exit.i.unr-lcssa, %H5VM__stride_optimize1.exit
  %.011.i.i.epil.init = phi i64 [ 1, %H5VM__stride_optimize1.exit ], [ %i.bb, %H5VM_vector_reduce_product.exit.i.unr-lcssa ]
  %.0610.i.i.epil.init = phi ptr [ %i.b, %H5VM__stride_optimize1.exit ], [ %i.az, %H5VM_vector_reduce_product.exit.i.unr-lcssa ]
  %lcmp.mod61 = icmp ne i32 %xtraiter, 0
  tail call void @llvm.assume(i1 %lcmp.mod61)
  br label %.lr.ph.i.i.epil

.lr.ph.i.i.epil:                                  ; preds = %.lr.ph.i.i.epil, %.lr.ph.i.i.epil.preheader
  %.011.i.i.epil = phi i64 [ %i.be, %.lr.ph.i.i.epil ], [ %.011.i.i.epil.init, %.lr.ph.i.i.epil.preheader ]
  %.0610.i.i.epil = phi ptr [ %i.bc, %.lr.ph.i.i.epil ], [ %.0610.i.i.epil.init, %.lr.ph.i.i.epil.preheader ] ; 2 uses
  %epil.iter = phi i32 [ %epil.iter.next, %.lr.ph.i.i.epil ], [ 0, %.lr.ph.i.i.epil.preheader ]
  %i.bc = getelementptr inbounds nuw i8, ptr %.0610.i.i.epil, i64 8
  %i.bd = load i64, ptr %.0610.i.i.epil, align 8, !tbaa !8
  %i.be = mul i64 %i.bd, %.011.i.i.epil           ; 2 uses
  %epil.iter.next = add i32 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %H5VM_vector_reduce_product.exit.i, label %.lr.ph.i.i.epil, !llvm.loop !14

H5VM_vector_reduce_product.exit.i:                ; preds = %.lr.ph.i.i.epil, %H5VM_vector_reduce_product.exit.i.unr-lcssa
  %.lcssa54 = phi i64 [ %i.bb, %H5VM_vector_reduce_product.exit.i.unr-lcssa ], [ %i.be, %.lr.ph.i.i.epil ] ; 2 uses
  %6 = getelementptr inbounds nuw i8, ptr %4, i64 %i.f ; 2 uses
  %.not47.i = icmp eq i64 %.lcssa54, 0
  br i1 %.not47.i, label %H5VM_stride_fill.exit, label %.lr.ph45.i

.lr.ph45.i:                                       ; preds = %H5VM_vector_reduce_product.exit.i
  %i.bf = trunc i32 %5 to i8                      ; 2 uses
  %.02340.i = add i32 %.014.lcssa, -1             ; 2 uses
  %i.bg = icmp sgt i32 %.02340.i, -1
  br i1 %i.bg, label %.lr.ph.us.i.preheader, label %.lr.ph45.split.i

.lr.ph.us.i.preheader:                            ; preds = %.lr.ph45.i
  %7 = zext nneg i32 %.02340.i to i64
  br label %.lr.ph.us.i

.lr.ph.us.i:                                      ; preds = %.lr.ph.us.i.preheader, %._crit_edge.us.i
  %.02444.us.i = phi i64 [ %i.bq, %._crit_edge.us.i ], [ 0, %.lr.ph.us.i.preheader ]
  %.02543.us.i = phi ptr [ %i.bj, %._crit_edge.us.i ], [ %6, %.lr.ph.us.i.preheader ] ; 2 uses
  tail call void @llvm.memset.p0.i64(ptr align 1 %.02543.us.i, i8 %i.bf, i64 %.0.lcssa, i1 false)
  br label %bb.e

bb.e:                                             ; preds = %bb.f, %.lr.ph.us.i
  %indvars.iv = phi i64 [ %indvars.iv.next, %bb.f ], [ %7, %.lr.ph.us.i ] ; 5 uses
  %.12641.us.i = phi ptr [ %i.bj, %bb.f ], [ %.02543.us.i, %.lr.ph.us.i ]
  %i.bh = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %indvars.iv
  %i.bi = load i64, ptr %i.bh, align 8, !tbaa !8
  %i.bj = getelementptr inbounds nuw i8, ptr %.12641.us.i, i64 %i.bi ; 2 uses
  %i.bk = getelementptr inbounds nuw [8 x i8], ptr %i.a, i64 %indvars.iv ; 3 uses
  %i.bl = load i64, ptr %i.bk, align 8, !tbaa !8
  %i.bm = add i64 %i.bl, -1                       ; 2 uses
  store i64 %i.bm, ptr %i.bk, align 8, !tbaa !8
  %.not30.us.i = icmp eq i64 %i.bm, 0
  br i1 %.not30.us.i, label %bb.f, label %._crit_edge.us.i

bb.f:                                             ; preds = %bb.e
  %i.bn = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %indvars.iv
  %i.bo = load i64, ptr %i.bn, align 8, !tbaa !8
  store i64 %i.bo, ptr %i.bk, align 8, !tbaa !8
  %indvars.iv.next = add nsw i64 %indvars.iv, -1
  %i.bp = icmp sgt i64 %indvars.iv, 0
  br i1 %i.bp, label %bb.e, label %._crit_edge.us.i, !llvm.loop !16

._crit_edge.us.i:                                 ; preds = %bb.f, %bb.e
  %i.bq = add nuw i64 %.02444.us.i, 1             ; 2 uses
  %exitcond.not.i = icmp eq i64 %i.bq, %.lcssa54
  br i1 %exitcond.not.i, label %H5VM_stride_fill.exit, label %.lr.ph.us.i, !llvm.loop !17

.lr.ph45.split.i:                                 ; preds = %.lr.ph45.i, %.lr.ph45.thread.i
  %i.br = phi ptr [ %i.ac, %.lr.ph45.thread.i ], [ %6, %.lr.ph45.i ]
  %.118 = phi i64 [ %.1.ph, %.lr.ph45.thread.i ], [ %.0.lcssa, %.lr.ph45.i ]
  %i.bs = phi i8 [ %i.ad, %.lr.ph45.thread.i ], [ %i.bf, %.lr.ph45.i ]
  tail call void @llvm.memset.p0.i64(ptr align 1 %i.br, i8 %i.bs, i64 %.118, i1 false)
...
.lr.ph.i:                                         ; preds = %.lr.ph.i, %.lr.ph.i.preheader.new
  ...
  %niter.ncmp.7 = icmp eq i32 %niter.next.7, %unroll_iter
  br i1 %niter.ncmp.7, label %H5VM_vector_reduce_product.exit.loopexit.unr-lcssa, label %.lr.ph.i, !llvm.loop !13
...
.lr.ph.i.epil:                                    ; preds = %.lr.ph.i.epil, %.lr.ph.i.epil.preheader
  ...
  %epil.iter.next = add i32 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %H5VM_vector_reduce_product.exit, label %.lr.ph.i.epil, !llvm.loop !18
...
bb.c:                                             ; preds = %bb.b
  ...
  br i1 %i.as, label %bb.b, label %._crit_edge.us, !llvm.loop !16

._crit_edge.us:                                   ; preds = %bb.b, %bb.c
  %i.at = add nuw i64 %.02444.us, 1               ; 2 uses
  %exitcond.not = icmp eq i64 %i.at, %phi.call
  br i1 %exitcond.not, label %._crit_edge46, label %.lr.ph.us, !llvm.loop !17
...
bb.ak:                                            ; preds = %bb.ai, %bb.aj
  ...
  br i1 %i.fi, label %.lr.ph, label %._crit_edge, !llvm.loop !19
...
.lr.ph206:                                        ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  %i.ip = phi i64 [ %indvars.iv.next219, %.lr.ph.i ], [ %i.h, %.lr.ph.i.preheader ] ; 5 uses
  %i.iq = phi i64 [ %i.iw, %.lr.ph.i ], [ 1, %.lr.ph.i.preheader ] ; 3 uses
  %.0163204 = phi i32 [ %8, %.lr.ph.i ], [ %0, %.lr.ph.i.preheader ] ; 2 uses
  %i.ir = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %i.ip
  %i.is = load i64, ptr %i.ir, align 8, !tbaa !8
  %i.it = icmp eq i64 %i.is, %i.iq
  br i1 %i.it, label %bb.av, label %.loopexit

bb.av:                                            ; preds = %.lr.ph206
  %i.iu = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %i.ip
  %i.iv = load i64, ptr %i.iu, align 8, !tbaa !8
  %i.iw = mul i64 %i.iv, %i.iq                    ; 6 uses
  %.not142.i = icmp eq i64 %i.ip, 0
...
.lr.ph.i:                                         ; preds = %bb.av
  ...
  %indvars.iv.next219 = add nsw i64 %i.ip, -1     ; 2 uses
  %i.jf = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %indvars.iv.next219
  %i.jg = load i64, ptr %i.jf, align 8, !tbaa !8
  %i.jh = icmp eq i64 %i.jg, %i.iw
  %8 = trunc nuw i64 %i.ip to i32                 ; 2 uses
  br i1 %i.jh, label %.lr.ph206, label %.loopexit, !llvm.loop !20
...
.loopexit:                                        ; preds = %.lr.ph.i, %.lr.ph206, %.lr.ph.i.preheader, %bb.al, %bb.an, %bb.am, %bb.aq, %bb.ap, %bb.ao, %bb.au, %bb.at, %bb.as, %bb.ar
  ...
  %.1162.ph = phi i64 [ 1, %bb.ar ], [ 1, %bb.al ], [ %i.hk, %bb.as ], [ %i.hv, %bb.at ], [ %i.ih, %bb.au ], [ 1, %bb.ao ], [ 1, %.lr.ph.i.preheader ], [ %i.gk, %bb.ap ], [ %i.gv, %bb.aq ], [ 1, %bb.am ], [ %i.fw, %bb.an ], [ %i.iw, %.lr.ph.i ], [ %i.iq, %.lr.ph206 ] ; 6 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #8
...
.lr.ph.i.i.epil:                                  ; preds = %.lr.ph.i.i.epil, %.lr.ph.i.i.epil.preheader
  ...
  %epil.iter.next = add i32 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %H5VM_vector_reduce_product.exit.i, label %.lr.ph.i.i.epil, !llvm.loop !21
...
.lr.ph60.i:                                       ; preds = %H5VM_vector_reduce_product.exit.i
  ...
  br i1 %i.kr, label %.lr.ph.us.i.preheader, label %.lr.ph60.split.i.preheader
...
.lr.ph.us.i.preheader:                            ; preds = %.lr.ph60.i
  %9 = zext nneg i32 %.03152.i to i64
  br label %.lr.ph.us.i

.lr.ph.us.i:                                      ; preds = %.lr.ph.us.i.preheader, %._crit_edge.us.i
  %.03259.us.i = phi i64 [ %i.lf, %._crit_edge.us.i ], [ 0, %.lr.ph.us.i.preheader ]
  %.03358.us.i = phi ptr [ %i.kv, %._crit_edge.us.i ], [ %i.kq, %.lr.ph.us.i.preheader ] ; 2 uses
  %.03557.us.i = phi ptr [ %i.ky, %._crit_edge.us.i ], [ %i.kp, %.lr.ph.us.i.preheader ] ; 2 uses
...
bb.aw:                                            ; preds = %bb.ax, %.lr.ph.us.i
  %indvars.iv221 = phi i64 [ %indvars.iv.next222, %bb.ax ], [ %9, %.lr.ph.us.i ] ; 6 uses
  %.13454.us.i = phi ptr [ %i.kv, %bb.ax ], [ %.03358.us.i, %.lr.ph.us.i ]
  %.13653.us.i = phi ptr [ %i.ky, %bb.ax ], [ %.03557.us.i, %.lr.ph.us.i ]
  %i.kt = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %indvars.iv221
  %i.ku = load i64, ptr %i.kt, align 8, !tbaa !8
  %i.kv = getelementptr inbounds nuw i8, ptr %.13454.us.i, i64 %i.ku ; 2 uses
  %i.kw = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %indvars.iv221
  %i.kx = load i64, ptr %i.kw, align 8, !tbaa !8
  %i.ky = getelementptr inbounds nuw i8, ptr %.13653.us.i, i64 %i.kx ; 2 uses
  %i.kz = getelementptr inbounds nuw [8 x i8], ptr %i.a, i64 %indvars.iv221 ; 3 uses
...
bb.ax:                                            ; preds = %bb.aw
  %i.lc = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %indvars.iv221
  ...
  %i.le = icmp sgt i64 %indvars.iv221, 0
  br i1 %i.le, label %bb.aw, label %._crit_edge.us.i, !llvm.loop !22

._crit_edge.us.i:                                 ; preds = %bb.ax, %bb.aw
  %i.lf = add nuw i64 %.03259.us.i, 1             ; 2 uses
  %exitcond65.not.i = icmp eq i64 %i.lf, %.lcssa262
  br i1 %exitcond65.not.i, label %H5VM_stride_copy.exit, label %.lr.ph.us.i, !llvm.loop !23
...
.lr.ph60.split.i:                                 ; preds = %.lr.ph60.split.i, %.lr.ph60.split.i.preheader.new
  ...
  br i1 %niter273.ncmp.3, label %H5VM_stride_copy.exit.loopexit261.unr-lcssa, label %.lr.ph60.split.i, !llvm.loop !23
...
.lr.ph60.split.i.epil:                            ; preds = %.lr.ph60.split.i.epil, %.lr.ph60.split.i.epil.preheader
  ...
  br i1 %epil.iter269.cmp.not, label %H5VM_stride_copy.exit, label %.lr.ph60.split.i.epil, !llvm.loop !24
...
.lr.ph.i:                                         ; preds = %.lr.ph.i, %.split.new
  ...
  %niter.next.7 = add nuw i32 %niter, 8           ; 2 uses
  %niter.ncmp.7 = icmp eq i32 %niter.next.7, %unroll_iter
  br i1 %niter.ncmp.7, label %H5VM_vector_reduce_product.exit.unr-lcssa, label %.lr.ph.i, !llvm.loop !13
...
.lr.ph.i.epil:                                    ; preds = %.lr.ph.i.epil, %.lr.ph.i.epil.preheader
  ...
  %epil.iter.next = add i32 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %H5VM_vector_reduce_product.exit, label %.lr.ph.i.epil, !llvm.loop !25
...
bb.d:                                             ; preds = %bb.c
  ...
  br i1 %i.at, label %bb.c, label %._crit_edge.us, !llvm.loop !22
...
.lr.ph60.split:                                   ; preds = %.lr.ph60.split, %.lr.ph60.split.preheader.new
  ...
  br i1 %niter87.ncmp.3, label %.loopexit.loopexit78.unr-lcssa, label %.lr.ph60.split, !llvm.loop !23
