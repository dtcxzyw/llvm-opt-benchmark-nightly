...
.lr.ph:                                           ; preds = %.lr.ph.i
  ...
  %i.o = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %indvars.iv.next
  %i.p = load i64, ptr %i.o, align 8, !tbaa !8
  %i.q = mul i64 %i.p, %i.r                       ; 2 uses
  %.not20.i = icmp eq i64 %indvars.iv.next, 0
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.lr.ph, %.lr.ph
  ...
  %indvars.iv54 = phi i64 [ %i.h, %.lr.ph.i.lr.ph ], [ %indvars.iv.next, %.lr.ph ] ; 2 uses
  ...
  %indvars.iv.next = add nsw i64 %indvars.iv54, -1 ; 4 uses
  %i.x = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %indvars.iv.next
  ...
  br i1 %or.cond, label %.lr.ph, label %H5VM__stride_optimize1.exit.loopexit, !llvm.loop !13

H5VM__stride_optimize1.exit.loopexit:             ; preds = %.lr.ph.i
  %6 = trunc nuw i64 %indvars.iv54 to i32
...
H5VM__stride_optimize1.exit:                      ; preds = %H5VM__stride_optimize1.exit.loopexit, %.lr.ph.i.preheader
  %.014.lcssa = phi i32 [ %0, %.lr.ph.i.preheader ], [ %6, %H5VM__stride_optimize1.exit.loopexit ] ; 5 uses
  %.0.lcssa = phi i64 [ 1, %.lr.ph.i.preheader ], [ %i.r, %H5VM__stride_optimize1.exit.loopexit ] ; 2 uses
...
H5VM_vector_reduce_product.exit.i:                ; preds = %.lr.ph.i.i.epil, %H5VM_vector_reduce_product.exit.i.unr-lcssa
  ...
  %7 = getelementptr inbounds nuw i8, ptr %4, i64 %i.f ; 2 uses
...
.lr.ph45.i:                                       ; preds = %H5VM_vector_reduce_product.exit.i
  ...
  br i1 %i.bi, label %.lr.ph.us.i.preheader, label %.lr.ph45.split.i

.lr.ph.us.i.preheader:                            ; preds = %.lr.ph45.i
  %8 = zext nneg i32 %.02340.i to i64
  br label %.lr.ph.us.i

.lr.ph.us.i:                                      ; preds = %.lr.ph.us.i.preheader, %._crit_edge.us.i
  %.02444.us.i = phi i64 [ %i.bs, %._crit_edge.us.i ], [ 0, %.lr.ph.us.i.preheader ]
  %.02543.us.i = phi ptr [ %i.bl, %._crit_edge.us.i ], [ %7, %.lr.ph.us.i.preheader ] ; 2 uses
  tail call void @llvm.memset.p0.i64(ptr align 1 %.02543.us.i, i8 %i.bh, i64 %.0.lcssa, i1 false)
  br label %bb.e

bb.e:                                             ; preds = %bb.f, %.lr.ph.us.i
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %bb.f ], [ %8, %.lr.ph.us.i ] ; 5 uses
  %.12641.us.i = phi ptr [ %i.bl, %bb.f ], [ %.02543.us.i, %.lr.ph.us.i ]
  %i.bj = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %indvars.iv37
  %i.bk = load i64, ptr %i.bj, align 8, !tbaa !8
  %i.bl = getelementptr inbounds nuw i8, ptr %.12641.us.i, i64 %i.bk ; 2 uses
  %i.bm = getelementptr inbounds nuw [8 x i8], ptr %i.a, i64 %indvars.iv37 ; 3 uses
...
bb.f:                                             ; preds = %bb.e
  %i.bp = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %indvars.iv37
  %i.bq = load i64, ptr %i.bp, align 8, !tbaa !8
  store i64 %i.bq, ptr %i.bm, align 8, !tbaa !8
  %indvars.iv.next38 = add nsw i64 %indvars.iv37, -1
  %i.br = icmp sgt i64 %indvars.iv37, 0
...
.lr.ph45.split.i:                                 ; preds = %.lr.ph45.i, %.lr.ph45.thread.i
  %i.bt = phi ptr [ %i.ae, %.lr.ph45.thread.i ], [ %7, %.lr.ph45.i ]
