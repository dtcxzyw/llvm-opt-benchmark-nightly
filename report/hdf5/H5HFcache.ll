...
bb.j:                                             ; preds = %bb.h, %bb.i
  ...
  %narrow = phi i64 [ %i.ag, %bb.h ], [ 4, %bb.i ]
  ...
  %3 = getelementptr i8, ptr %i.ah, i64 %narrow
  %4 = getelementptr i8, ptr %3, i64 %i.ak
  %5 = getelementptr i8, ptr %4, i64 %i.an        ; 4 uses
  %i.ao = getelementptr i8, ptr %5, i64 1         ; 3 uses
  %i.ap = load i16, ptr %i.ao, align 1            ; 3 uses
  %i.aq = zext i16 %i.ap to i32
  %i.ar = trunc i16 %i.ap to i8
  %i.as = getelementptr i8, ptr %5, i64 2
  %i.at = lshr i16 %i.ap, 8
  %i.au = trunc nuw i16 %i.at to i8
  %i.av = getelementptr i8, ptr %5, i64 3         ; 2 uses
  %i.aw = load i8, ptr %i.av, align 1, !tbaa !19  ; 2 uses
  %i.ax = zext i8 %i.aw to i32
  %i.ay = shl nuw nsw i32 %i.ax, 16
  %i.az = getelementptr i8, ptr %5, i64 4         ; 2 uses
