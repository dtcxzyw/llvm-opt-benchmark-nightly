Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/hdf5/original/H5Tinit_float?download=true
...
.preheader.i.1.1:                                 ; preds = %H5T__byte_cmp.exit, %.preheader.i.3
  %.1202.ph = phi i32 [ -1, %.preheader.i.3 ], [ 0, %H5T__byte_cmp.exit ]
...
.preheader.i.preheader.2:                         ; preds = %.preheader.i.1.1, %H5T__byte_cmp.exit.1
  %.1202.1.ph = phi i32 [ %.1202.ph, %.preheader.i.1.1 ], [ 1, %H5T__byte_cmp.exit.1 ] ; 2 uses
