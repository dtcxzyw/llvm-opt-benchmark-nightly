begin_hunk_0
  ...
  %.not72.us.i.us.i.i693 = icmp eq i64 %.sroa.442.0.copyload.i.i.i, 0
  br label %481
...
498:                                              ; preds = %517
  %499 = add nuw nsw i64 %.sroa.04.0.i.us.i.i.i687, 1 ; 2 uses
...
.preheader75.us.i.i.i.preheader:                  ; preds = %498, %496
  ...
  br i1 %501, label %.lr.ph689, label %.loopexit.i.us.i.i.i

.preheader75.us.i.i.i:                            ; preds = %508
  %502 = icmp ult i64 %486, %503
  br i1 %502, label %.lr.ph689, label %.loopexit.i.us.i.i.i

.lr.ph689:                                        ; preds = %.preheader75.us.i.i.i.preheader, %.preheader75.us.i.i.i
  %.sroa.2.0.i.us.i.i.i688 = phi i64 [ %503, %.preheader75.us.i.i.i ], [ %.sroa.442.0.copyload.i.i.i, %.preheader75.us.i.i.i.preheader ]
  %503 = add i64 %.sroa.2.0.i.us.i.i.i688, -1     ; 6 uses
...
.lr.ph:                                           ; preds = %496, %498
  %.sroa.04.0.i.us.i.i.i687 = phi i64 [ %499, %498 ], [ %.sroa.0.0.i.i.us.i.i.i, %496 ] ; 4 uses
  %515 = add i64 %.sroa.04.0.i.us.i.i.i687, %488  ; 2 uses
  %516 = icmp ult i64 %515, %.sroa.1351.0.copyload.i.i.i
  br i1 %516, label %517, label %.split135.us.i.i.i

517:                                              ; preds = %.lr.ph
  %518 = getelementptr inbounds nuw i8, ptr %.sroa.14.0.copyload.i.i.i, i64 %.sroa.04.0.i.us.i.i.i687
...
522:                                              ; preds = %517
  ...
  %524 = add i64 %523, %.sroa.04.0.i.us.i.i.i687
  br label %.sink.split.i.us.i.i.i
...
.preheader74.us.i.i.i.preheader:                  ; preds = %.lr.ph.i46.us.i.i.i
  br i1 %480, label %.lr.ph692, label %.preheader.us.i.preheader.i.i

.preheader74.us.i.i.i:                            ; preds = %567
  %539 = add nuw nsw i64 %.sroa.04.0.i49.us.i.i.i691, 1 ; 2 uses
  %540 = icmp ult i64 %539, %.sroa.15.0.copyload.i.i.i
  br i1 %540, label %.lr.ph692, label %.preheader.us.i.preheader.i.i
...
.preheader.us.i.us.i.i.preheader:                 ; preds = %.preheader.us.i.preheader.i.i
  br i1 %.not72.us.i.us.i.i693, label %.loopexit.i.us.i.i.i, label %.lr.ph695

.preheader.us.i.us.i.i:                           ; preds = %544
  %.not72.us.i.us.i.i = icmp eq i64 %541, 0
  br i1 %.not72.us.i.us.i.i, label %.loopexit.i.us.i.i.i, label %.lr.ph695

.lr.ph695:                                        ; preds = %.preheader.us.i.us.i.i.preheader, %.preheader.us.i.us.i.i
  %.sroa.2.0.i50.us.i.us.i.i694 = phi i64 [ %541, %.preheader.us.i.us.i.i ], [ %.sroa.442.0.copyload.i.i.i, %.preheader.us.i.us.i.i.preheader ]
  %541 = add i64 %.sroa.2.0.i50.us.i.us.i.i694, -1 ; 4 uses
...
.lr.ph692:                                        ; preds = %.preheader74.us.i.i.i.preheader, %.preheader74.us.i.i.i
  %.sroa.04.0.i49.us.i.i.i691 = phi i64 [ %539, %.preheader74.us.i.i.i ], [ %.sroa.442.0.copyload.i.i.i, %.preheader74.us.i.i.i.preheader ] ; 4 uses
  %565 = add i64 %.sroa.04.0.i49.us.i.i.i691, %531 ; 2 uses
  %566 = icmp ult i64 %565, %.sroa.1351.0.copyload.i.i.i
  br i1 %566, label %567, label %.split147.us.i.i.i

567:                                              ; preds = %.lr.ph692
  %568 = getelementptr inbounds nuw i8, ptr %.sroa.14.0.copyload.i.i.i, i64 %.sroa.04.0.i49.us.i.i.i691
...
572:                                              ; preds = %567
  ...
  %574 = add i64 %573, %.sroa.04.0.i49.us.i.i.i691
  br label %577
...
.split147.us.i.i.i:                               ; preds = %.lr.ph692
...
.split.us.invoke.i.i.i:                           ; preds = %.preheader.us.i.preheader.split.i.i, %505, %.lr.ph689, %.lr.ph695, %.split135.us.i.i.i, %.split147.us.i.i.i
  %754 = phi i64 [ %umax.i52.i.i.i, %.split147.us.i.i.i ], [ %542, %.lr.ph695 ], [ %umax.i.i.i.i, %.split135.us.i.i.i ], [ %506, %505 ], [ %503, %.lr.ph689 ], [ %479, %.preheader.us.i.preheader.split.i.i ]
  %755 = phi i64 [ %.sroa.1351.0.copyload.i.i.i, %.split147.us.i.i.i ], [ %.sroa.1351.0.copyload.i.i.i, %.lr.ph695 ], [ %.sroa.1351.0.copyload.i.i.i, %.split135.us.i.i.i ], [ %.sroa.1351.0.copyload.i.i.i, %505 ], [ %.sroa.15.0.copyload.i.i.i, %.lr.ph689 ], [ %.sroa.15.0.copyload.i.i.i, %.preheader.us.i.preheader.split.i.i ]
  %756 = phi ptr [ @3, %.split147.us.i.i.i ], [ @2, %.lr.ph695 ], [ @3, %.split135.us.i.i.i ], [ @2, %505 ], [ @1, %.lr.ph689 ], [ @1, %.preheader.us.i.preheader.split.i.i ]
...
begin_hunk_8
  ...
  invoke void @_RNvXCsjPLGVgcokxX_22deltalake_catalog_glueNtNtCs14kWLkQVSKO_14deltalake_core12data_catalog16DataCatalogErrorINtNtCsbvkFyIu7lgC_4core7convert4FromNtB2_9GlueErrorE4from(ptr noalias noundef nonnull sret([40 x i8]) align 8 captures(none) dereferenceable(40) %44, ptr noalias noundef nonnull align 8 captures(address) dereferenceable(152) %45)
          to label %_RNvXs1_NtCsbvkFyIu7lgC_4core7convertNtCsjPLGVgcokxX_22deltalake_catalog_glue9GlueErrorINtB5_4IntoNtNtCs14kWLkQVSKO_14deltalake_core12data_catalog16DataCatalogErrorE4intoBA_.exit unwind label %.thread614
...
.thread512:                                       ; preds = %.thread614, %.thread504, %1308, %.thread515, %1134
  %.pn117.pn = phi { ptr, i32 } [ %.pn117, %1308 ], [ %.pn85617, %1134 ], [ %.pn83, %.thread504 ], [ %.pn85509518, %.thread515 ], [ %1093, %.thread614 ]
...
1134:                                             ; preds = %.thread614, %1090
  %.pn85617 = phi { ptr, i32 } [ %1093, %.thread614 ], [ %.pn77, %1090 ]
