...
bb.f:                                             ; preds = %.sink.split
  ...
  %i.aa = load ptr, ptr %7, align 8, !tbaa !27    ; 2 uses
...
bb.g:                                             ; preds = %.lr.ph, %_ZN8facebook4yoga18LayoutableChildrenINS0_4NodeEE8IteratorD2Ev.exit
  %i.ah = phi i64 [ %i.ab, %.lr.ph ], [ %i.de, %_ZN8facebook4yoga18LayoutableChildrenINS0_4NodeEE8IteratorD2Ev.exit ] ; 3 uses
  %i.ai = phi ptr [ %i.aa, %.lr.ph ], [ %i.dd, %_ZN8facebook4yoga18LayoutableChildrenINS0_4NodeEE8IteratorD2Ev.exit ] ; 2 uses
  ...
  %i.am = load ptr, ptr %i.aj, align 8, !tbaa !15 ; 2 uses
...
bb.i:                                             ; preds = %bb.g
  ...
  %i.as = load ptr, ptr %i.ar, align 8, !tbaa !28 ; 12 uses
...
bb.n:                                             ; preds = %switch.lookup421
  ...
  store i64 %8, ptr %i.bn, align 8, !tbaa !88
...
bb.o:                                             ; preds = %bb.n
  ...
  %.sroa.0.0.copyload = load float, ptr %i.bs, align 4, !tbaa !89
...
bb.w:                                             ; preds = %bb.v
  ...
  %i.ck = load float, ptr %i.bs, align 4, !tbaa !90
...
bb.y:                                             ; preds = %bb.x
  store ptr %i.as, ptr %.sroa.14.0276, align 8, !tbaa !28
...
_ZNKSt6vectorIPN8facebook4yoga4NodeESaIS3_EE12_M_check_lenEmPKc.exit.i.i: ; preds = %bb.z
  %i.cr = ashr exact i64 %i.cp, 3
  %mul2.i.i = ashr exact i64 %i.cp, 2
  %10 = call i64 @llvm.umax.i64(i64 %mul2.i.i, i64 1) ; 2 uses
  %i.cs = icmp ult i64 %10, %i.cr
  %i.ct = call i64 @llvm.umin.i64(i64 %10, i64 1152921504606846975)
  %i.cu = select i1 %i.cs, i64 1152921504606846975, i64 %i.ct ; 2 uses
  %i.cv = shl nuw nsw i64 %i.cu, 3
  %i.cw = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.cv) #10
...
.noexc117:                                        ; preds = %_ZNKSt6vectorIPN8facebook4yoga4NodeESaIS3_EE12_M_check_lenEmPKc.exit.i.i
  ...
  store ptr %i.as, ptr %i.cx, align 8, !tbaa !28
  %i.cy = icmp sgt i64 %i.cp, 0
  br i1 %i.cy, label %bb.ab, label %_ZNSt6vectorIPN8facebook4yoga4NodeESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit16.i.i

bb.ab:                                            ; preds = %.noexc117
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.cw, ptr align 8 %.sroa.0147.0275, i64 %i.cp, i1 false)
...
bb.ad:                                            ; preds = %bb.i, %bb.j, %bb.y, %_ZNSt6vectorIPN8facebook4yoga4NodeESaIS3_EE17_M_realloc_insertIJRKS3_EEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i
  %.sroa.0147.1.ph = phi ptr [ %.sroa.0147.0275, %bb.y ], [ %i.cw, %_ZNSt6vectorIPN8facebook4yoga4NodeESaIS3_EE17_M_realloc_insertIJRKS3_EEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i ], [ %.sroa.0147.0275, %bb.j ], [ %.sroa.0147.0275, %bb.i ] ; 3 uses
  %.sroa.14.1.ph = phi ptr [ %i.cm, %bb.y ], [ %i.cz, %_ZNSt6vectorIPN8facebook4yoga4NodeESaIS3_EE17_M_realloc_insertIJRKS3_EEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i ], [ %.sroa.14.0276, %bb.j ], [ %.sroa.14.0276, %bb.i ] ; 2 uses
  %.sroa.22.1.ph = phi ptr [ %.sroa.22.0277, %bb.y ], [ %i.da, %_ZNSt6vectorIPN8facebook4yoga4NodeESaIS3_EE17_M_realloc_insertIJRKS3_EEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i ], [ %.sroa.22.0277, %bb.j ], [ %.sroa.22.0277, %bb.i ] ; 3 uses
...
bb.ae:                                            ; preds = %bb.ad
  %i.db = load ptr, ptr %i.ae, align 8, !tbaa !30 ; 2 uses
  %.not12.i.i.i = icmp eq ptr %i.db, null
...
.lr.ph.i.i.i:                                     ; preds = %bb.ae, %.lr.ph.i.i.i
  %.013.i.i.i = phi ptr [ %i.dc, %.lr.ph.i.i.i ], [ %i.db, %bb.ae ] ; 2 uses
  %i.dc = load ptr, ptr %.013.i.i.i, align 8, !tbaa !30 ; 2 uses
  call void @_ZdlPvm(ptr noundef nonnull %.013.i.i.i, i64 noundef 24) #11
  %.not.i.i.i118 = icmp eq ptr %i.dc, null
  br i1 %.not.i.i.i118, label %_ZN8facebook4yoga18LayoutableChildrenINS0_4NodeEE8IteratorD2Ev.exit, label %.lr.ph.i.i.i, !llvm.loop !0

_ZN8facebook4yoga18LayoutableChildrenINS0_4NodeEE8IteratorD2Ev.exit: ; preds = %.lr.ph.i.i.i, %bb.ae
  %i.dd = load ptr, ptr %7, align 8, !tbaa !27    ; 2 uses
  %.not.i = icmp ne ptr %i.dd, null
  %i.de = load i64, ptr %i.z, align 8             ; 2 uses
  %i.df = icmp ne i64 %i.de, 0
  %i.dg = select i1 %.not.i, i1 true, i1 %i.df
  br i1 %i.dg, label %bb.g, label %_ZNSt6vectorIPN8facebook4yoga4NodeESaIS3_EED2Ev.exit, !llvm.loop !40
...
_ZNSt6vectorIPN8facebook4yoga4NodeESaIS3_EED2Ev.exit: ; preds = %_ZN8facebook4yoga18LayoutableChildrenINS0_4NodeEE8IteratorD2Ev.exit, %bb.p, %bb.f
  ...
  %i.dh = fcmp ogt float %.079.lcssa, 0.000000e+00
  %i.di = fcmp olt float %.079.lcssa, 1.000000e+00
  %or.cond3 = and i1 %i.dh, %i.di
  %spec.store.select = select i1 %or.cond3, float 1.000000e+00, float %.079.lcssa
  %i.dj = fcmp ogt float %.074.lcssa, 0.000000e+00
  %i.dk = fcmp olt float %.074.lcssa, 1.000000e+00
  %or.cond5 = and i1 %i.dj, %i.dk
  %spec.store.select6 = select i1 %or.cond5, float 1.000000e+00, float %.074.lcssa
  store ptr %.sroa.0147.0.lcssa, ptr %0, align 8, !tbaa !15
  %i.dl = getelementptr inbounds nuw i8, ptr %0, i64 8
  store ptr %.sroa.14.0.lcssa, ptr %i.dl, align 8, !tbaa !14
  %i.dm = getelementptr inbounds nuw i8, ptr %0, i64 16
  store ptr %.sroa.22.0.lcssa, ptr %i.dm, align 8, !tbaa !91
  %i.dn = getelementptr inbounds nuw i8, ptr %0, i64 24
  store float %.084.lcssa, ptr %i.dn, align 8, !tbaa !94
  %i.do = getelementptr inbounds nuw i8, ptr %0, i64 32
  store i64 %.473, ptr %i.do, align 8, !tbaa !95
  %i.dp = getelementptr inbounds nuw i8, ptr %0, i64 40
  store float %spec.store.select, ptr %i.dp, align 8, !tbaa !96
  %i.dq = getelementptr inbounds nuw i8, ptr %0, i64 44
  store float %spec.store.select6, ptr %i.dq, align 4, !tbaa !97
  %i.dr = getelementptr inbounds nuw i8, ptr %0, i64 48
  store <2 x float> zeroinitializer, ptr %i.dr, align 8, !tbaa !89
  %i.ds = getelementptr inbounds nuw i8, ptr %0, i64 56
  store float 0.000000e+00, ptr %i.ds, align 8, !tbaa !98
  ret void
...
bb.af:                                            ; preds = %_ZN8facebook4yoga18LayoutableChildrenINS0_4NodeEE8IteratorD2Ev.exit129
  %i.dt = ptrtoint ptr %.sroa.22.4 to i64
  %i.du = ptrtoint ptr %.sroa.0147.4 to i64
  %i.dv = sub i64 %i.dt, %i.du
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0147.4, i64 noundef %i.dv) #11
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = load i16, ptr %i.c, align 1, !tbaa !18   ; 2 uses
  %i.e = and i16 %i.d, 7
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.g = load i16, ptr %i.f, align 1, !tbaa !18   ; 2 uses
  %i.h = and i16 %i.g, 7
...
_ZNK8facebook4yoga5Style13computeMarginENS0_12PhysicalEdgeENS0_9DirectionE.exit.thread29: ; preds = %bb.c
  ...
  %i.j = load i16, ptr %i.i, align 1, !tbaa !18   ; 2 uses
  %i.k = and i16 %i.j, 7
...
_ZNK8facebook4yoga5Style13computeMarginENS0_12PhysicalEdgeENS0_9DirectionE.exit.thread: ; preds = %bb.c, %bb.b, %_ZNK8facebook4yoga5Style13computeMarginENS0_12PhysicalEdgeENS0_9DirectionE.exit.thread29
  ...
  %i.o = load i16, ptr %i.n, align 1, !tbaa !18   ; 2 uses
  %i.p = and i16 %i.o, 7
...
bb.d:                                             ; preds = %_ZNK8facebook4yoga5Style13computeMarginENS0_12PhysicalEdgeENS0_9DirectionE.exit.thread
  ...
  %i.r = load i16, ptr %i.q, align 1, !tbaa !18   ; 2 uses
  %i.s = and i16 %i.r, 7
...
bb.f:                                             ; preds = %bb.a
  ...
  %i.y = load i16, ptr %i.x, align 1, !tbaa !18
  %i.z = and i16 %i.y, 7
  ...
  %.sroa.0.0.pre.i11.i = load i16, ptr %.sroa.0.0.in.i.i, align 1, !tbaa !32
  ...
  %i.ag = load i16, ptr %i.af, align 1, !tbaa !18
  %i.ah = and i16 %i.ag, 7
...
_ZNK8facebook4yoga5Style15computeLeftEdgeERKSt5arrayINS0_16StyleValueHandleELm9EENS0_9DirectionE.exit.sink.split.i10: ; preds = %bb.f, %bb.e
  ...
  %.sroa.0.0.pre.i11.i12 = load i16, ptr %spec.select.i10.sink.i11, align 1, !tbaa !32
...
bb.d:                                             ; preds = %bb.c
  ...
  %.sroa.0.0.pre.i11.i82 = load i16, ptr %.sroa.0.0.in.i.i81, align 1, !tbaa !32
  ...
  %.sroa.0.0.pre.i11.i76 = load i16, ptr %.sroa.0.0.in.i.i, align 1, !tbaa !32
  ...
  %.sroa.0.0.pre.i11.i74 = load i16, ptr %.sroa.0.0.in.i16.i73, align 1, !tbaa !32
  ...
  %.sroa.0.0.pre.i11.i = load i16, ptr %.sroa.0.0.in.i16.i, align 1, !tbaa !32
...
bb.ai:                                            ; preds = %bb.ah, %bb.ag, %_ZNK8facebook4yoga5Style14computePaddingENS0_12PhysicalEdgeENS0_9DirectionE.exit159
  ...
  %i.km = load i16, ptr %i.kk, align 1, !tbaa !18 ; 2 uses
  %i.kn = and i16 %i.km, 7
...
bb.aj:                                            ; preds = %bb.ai
  ...
  %i.kp = load i16, ptr %i.ko, align 1, !tbaa !18
  %i.kq = and i16 %i.kp, 7
  ...
  %.sroa.0.0.pre.i11.i149 = load i16, ptr %spec.select.i.i148, align 1, !tbaa !32
...
bb.ak:                                            ; preds = %_ZNK8facebook4yoga5Style13computeBorderENS0_12PhysicalEdgeENS0_9DirectionE.exit151.thread, %_ZNK8facebook4yoga5Style13computeBorderENS0_12PhysicalEdgeENS0_9DirectionE.exit151
  ...
  %i.kz = load i16, ptr %i.ky, align 1, !tbaa !18 ; 2 uses
  %i.la = and i16 %i.kz, 7
...
bb.al:                                            ; preds = %_ZNK8facebook4yoga5Style13computeBorderENS0_12PhysicalEdgeENS0_9DirectionE.exit151.thread194, %_ZNK8facebook4yoga5Style13computeBorderENS0_12PhysicalEdgeENS0_9DirectionE.exit151
  ...
  %i.lh = load i16, ptr %i.lg, align 1, !tbaa !18 ; 2 uses
  %i.li = and i16 %i.lh, 7
...
bb.am:                                            ; preds = %bb.al, %bb.ak, %_ZNK8facebook4yoga5Style13computeBorderENS0_12PhysicalEdgeENS0_9DirectionE.exit151
  ...
  %i.lp = load i16, ptr %i.lo, align 1, !tbaa !18 ; 2 uses
  %i.lq = and i16 %i.lp, 7
...
bb.an:                                            ; preds = %bb.am
  ...
  %i.ls = load i16, ptr %i.lr, align 1, !tbaa !18
  %i.lt = and i16 %i.ls, 7
  ...
  %.sroa.0.0.pre.i11.i141 = load i16, ptr %spec.select.i10.i140, align 1, !tbaa !32
...
bb.ao:                                            ; preds = %_ZNK8facebook4yoga5Style14computePaddingENS0_12PhysicalEdgeENS0_9DirectionE.exit143.thread, %_ZNK8facebook4yoga5Style14computePaddingENS0_12PhysicalEdgeENS0_9DirectionE.exit143
  ...
  %i.mc = load i16, ptr %i.mb, align 1, !tbaa !18 ; 2 uses
  %i.md = and i16 %i.mc, 7
...
bb.ap:                                            ; preds = %_ZNK8facebook4yoga5Style14computePaddingENS0_12PhysicalEdgeENS0_9DirectionE.exit143.thread201, %_ZNK8facebook4yoga5Style14computePaddingENS0_12PhysicalEdgeENS0_9DirectionE.exit143
  ...
  %i.mh = load i16, ptr %i.mg, align 1, !tbaa !18 ; 2 uses
  %i.mi = and i16 %i.mh, 7
...
bb.aq:                                            ; preds = %bb.ap, %bb.ao, %_ZNK8facebook4yoga5Style14computePaddingENS0_12PhysicalEdgeENS0_9DirectionE.exit143
  ...
  %i.mm = load i16, ptr %i.ml, align 1, !tbaa !18 ; 2 uses
  %i.mn = and i16 %i.mm, 7
...
bb.ar:                                            ; preds = %bb.aq
  ...
  %i.mp = load i16, ptr %i.mo, align 1, !tbaa !18
  %i.mq = and i16 %i.mp, 7
  ...
  %.sroa.0.0.pre.i11.i133 = load i16, ptr %spec.select.i10.i132, align 1, !tbaa !32
...
tailrecurse.i.i:                                  ; preds = %.lr.ph.i.i
  ...
  tail call void @_ZdlPvm(ptr noundef nonnull %i.y, i64 noundef 24) #11, !inline_history !100
...
_ZNK8facebook4yoga5Style15computeLeftEdgeERKSt5arrayINS0_16StyleValueHandleELm9EENS0_9DirectionE.exit.sink.split: ; preds = %bb.g, %bb.m, %bb.f, %bb.l
  ...
  %.sroa.0.0.pre.i11 = load i16, ptr %spec.select.i10.sink, align 1, !tbaa !32
...
!57 = !{!"p1 _ZTSN8facebook4yoga13GridTrackSizeE", !10, i64 0}
!58 = !{!"_ZTSNSt12_Vector_baseIN8facebook4yoga13GridTrackSizeESaIS2_EE17_Vector_impl_dataE", !57, i64 0, !57, i64 8, !57, i64 16}
!59 = !{!"_ZTSNSt12_Vector_baseIN8facebook4yoga13GridTrackSizeESaIS2_EE12_Vector_implE", !58, i64 0}
!60 = !{!"_ZTSSt12_Vector_baseIN8facebook4yoga13GridTrackSizeESaIS2_EE", !59, i64 0}
!61 = !{!"_ZTSSt6vectorIN8facebook4yoga13GridTrackSizeESaIS2_EE", !60, i64 0}
!62 = !{!"_ZTSN8facebook4yoga12GridLineTypeE", !6, i64 0}
!63 = !{!"_ZTSN8facebook4yoga8GridLineE", !62, i64 0, !7, i64 4}
!64 = !{!"_ZTSSt5arrayIjLm4EE", !6, i64 0}
!65 = !{!"_ZTSSt12_Base_bitsetILm1EE", !20, i64 0}
!66 = !{!"_ZTSSt6bitsetILm4EE", !65, i64 0}
!67 = !{!"_ZTSSt10_Head_baseILm0EPN8facebook4yoga16SmallValueBufferILm4EE8OverflowELb0EE", !29, i64 0}
...
!73 = !{!"_ZTSN8facebook4yoga16SmallValueBufferILm4EEE", !16, i64 0, !64, i64 4, !66, i64 24, !72, i64 32}
!74 = !{!"_ZTSN8facebook4yoga14StyleValuePoolE", !73, i64 0}
!75 = !{!"_ZTSN8facebook4yoga5StyleE", !45, i64 0, !46, i64 0, !47, i64 0, !47, i64 1, !47, i64 1, !48, i64 2, !48, i64 2, !48, i64 3, !49, i64 3, !50, i64 3, !51, i64 4, !52, i64 4, !53, i64 4, !17, i64 5, !17, i64 7, !17, i64 9, !17, i64 11, !54, i64 13, !54, i64 31, !54, i64 49, !54, i64 67, !55, i64 85, !56, i64 91, !56, i64 95, !56, i64 99, !17, i64 103, !61, i64 112, !61, i64 136, !61, i64 160, !61, i64 184, !63, i64 208, !63, i64 216, !63, i64 224, !63, i64 232, !74, i64 240}
!76 = !{!"_ZTSSt5arrayIN8facebook4yoga17CachedMeasurementELm8EE", !6, i64 0}
!77 = !{!"_ZTSN8facebook4yoga10SizingModeE", !6, i64 0}
!78 = !{!"_ZTSN8facebook4yoga17CachedMeasurementE", !43, i64 0, !43, i64 4, !77, i64 8, !77, i64 12, !43, i64 16, !43, i64 20}
!79 = !{!"_ZTSSt5arrayIfLm2EE", !6, i64 0}
!80 = !{!"_ZTSSt5arrayIfLm4EE", !6, i64 0}
!81 = !{!"_ZTSN8facebook4yoga13LayoutResultsE", !7, i64 0, !44, i64 4, !44, i64 8, !7, i64 12, !7, i64 16, !45, i64 20, !7, i64 24, !76, i64 28, !78, i64 220, !45, i64 244, !41, i64 244, !79, i64 248, !79, i64 256, !79, i64 264, !80, i64 272, !80, i64 288, !80, i64 304, !80, i64 320}
!82 = !{!"_ZTSNSt12_Vector_baseIPN8facebook4yoga4NodeESaIS3_EE12_Vector_implE", !13, i64 0}
...
!87 = !{!"_ZTSN8facebook4yoga4NodeE", !41, i64 0, !41, i64 0, !41, i64 0, !41, i64 0, !42, i64 0, !10, i64 8, !10, i64 16, !10, i64 24, !44, i64 32, !44, i64 36, !10, i64 40, !10, i64 48, !75, i64 56, !81, i64 336, !20, i64 672, !20, i64 680, !19, i64 688, !84, i64 696, !85, i64 720, !86, i64 728}
!88 = !{!87, !20, i64 672}
!89 = !{!43, !43, i64 0}
!90 = !{!44, !43, i64 0}
!91 = !{!13, !12, i64 16}
!92 = !{!"_ZTSN8facebook4yoga21FlexLineRunningLayoutE", !43, i64 0, !43, i64 4, !43, i64 8, !43, i64 12, !43, i64 16}
!93 = !{!"_ZTSN8facebook4yoga8FlexLineE", !84, i64 0, !43, i64 24, !20, i64 32, !92, i64 40}
!94 = !{!93, !43, i64 24}
!95 = !{!93, !20, i64 32}
!96 = !{!92, !43, i64 0}
!97 = !{!92, !43, i64 4}
