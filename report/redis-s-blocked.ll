...
define dso_local void @blockClient(ptr noundef %0, i32 noundef %1) local_unnamed_addr #0 {
  ...
  %4 = load i64, ptr %3, align 8, !tbaa !45       ; [#uses=1 type=i64]
  %.fr15 = freeze i64 %4                          ; [#uses=3 type=i64]
  %5 = and i64 %.fr15, 2                          ; [#uses=1 type=i64]
  %.not16 = icmp eq i64 %5, 0                     ; [#uses=1 type=i1]
...
switch.edge:                                      ; preds = %switch.early.test, %2, %switch.early.test, %switch.early.test, %switch.early.test
  %6 = or i64 %.fr15, 16                          ; [#uses=1 type=i64]
  ...
  %8 = and i64 %.fr15, 134217728                  ; [#uses=1 type=i64]
...
begin_hunk_2
  ...
  %wide.trip.count62 = zext nneg i32 %3 to i64    ; [#uses=2 type=i64]
  br i1 %.not48, label %.lr.ph.split.us, label %.lr.ph.split

.lr.ph.split.us:                                  ; preds = %.lr.ph, %42
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %42 ], [ 0, %.lr.ph ] ; [#uses=2 type=i64]
  %17 = load ptr, ptr %15, align 8, !tbaa !40     ; [#uses=1 type=ptr]
  %18 = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %indvars.iv59 ; [#uses=4 type=ptr]
...
42:                                               ; preds = %37, %.lr.ph.split.us
  %indvars.iv.next60 = add nuw nsw i64 %indvars.iv59, 1 ; [#uses=2 type=i64]
  %exitcond63.not = icmp eq i64 %indvars.iv.next60, %wide.trip.count62 ; [#uses=1 type=i1]
...
78:                                               ; preds = %75, %73, %.lr.ph.split
  ...
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count62 ; [#uses=1 type=i1]
...
._crit_edge:                                      ; preds = %78, %42, %13
  ...
  %80 = load i64, ptr %8, align 8, !tbaa !45      ; [#uses=1 type=i64]
  %.fr15.i = freeze i64 %80                       ; [#uses=6 type=i64]
  br i1 %.not45, label %.split, label %.split40

.split:                                           ; preds = %._crit_edge
  %81 = or i64 %.fr15.i, 16                       ; [#uses=1 type=i64]
  ...
  %83 = and i64 %.fr15.i, 134217728               ; [#uses=1 type=i64]
...
.split40:                                         ; preds = %._crit_edge
  %89 = or i64 %.fr15.i, 1073741824               ; [#uses=1 type=i64]
  store i64 %89, ptr %8, align 8, !tbaa !45
  %90 = and i64 %.fr15.i, 2                       ; [#uses=1 type=i64]
  %.not16.i51 = icmp eq i64 %90, 0                ; [#uses=1 type=i1]
...
switch.edge.i53:                                  ; preds = %switch.early.test.i52, %switch.early.test.i52, %switch.early.test.i52, %.split40
  %91 = or i64 %.fr15.i, 1073741840               ; [#uses=1 type=i64]
  ...
  %93 = and i64 %.fr15.i, 134217728               ; [#uses=1 type=i64]
  %.not.i54 = icmp eq i64 %93, 0                  ; [#uses=1 type=i1]
...
begin_hunk_7
  ...
  %12 = load i64, ptr %11, align 8, !tbaa !45     ; [#uses=1 type=i64]
  %.fr15.i = freeze i64 %12                       ; [#uses=3 type=i64]
  %13 = and i64 %.fr15.i, 2                       ; [#uses=1 type=i64]
  %.not16.i = icmp eq i64 %13, 0                  ; [#uses=1 type=i1]
...
switch.edge.i:                                    ; preds = %4
  %14 = or i64 %.fr15.i, 16                       ; [#uses=1 type=i64]
  ...
  %16 = and i64 %.fr15.i, 134217728               ; [#uses=1 type=i64]
...
begin_hunk_9
  ...
  %14 = load i64, ptr %13, align 8, !tbaa !45     ; [#uses=1 type=i64]
  %.fr15.i = freeze i64 %14                       ; [#uses=3 type=i64]
  %15 = and i64 %.fr15.i, 2                       ; [#uses=1 type=i64]
  %.not16.i = icmp eq i64 %15, 0                  ; [#uses=1 type=i1]
  br i1 %.not16.i, label %switch.edge.i, label %switch.early.test.i
...
switch.edge.i:                                    ; preds = %5
  %16 = or i64 %.fr15.i, 16                       ; [#uses=1 type=i64]
  ...
  %18 = and i64 %.fr15.i, 134217728               ; [#uses=1 type=i64]
...
begin_hunk_11
  ...
  %8 = load i64, ptr %7, align 8, !tbaa !45       ; [#uses=1 type=i64]
  %.fr15.i = freeze i64 %8                        ; [#uses=2 type=i64]
  %9 = or i64 %.fr15.i, 16                        ; [#uses=1 type=i64]
  ...
  %11 = and i64 %.fr15.i, 134217728               ; [#uses=1 type=i64]
...
begin_hunk_12
  ...
  %4 = load i64, ptr %3, align 8, !tbaa !45       ; [#uses=1 type=i64]
  %.fr15.i.i = freeze i64 %4                      ; [#uses=2 type=i64]
  %5 = or i64 %.fr15.i.i, 16                      ; [#uses=1 type=i64]
  ...
  %7 = and i64 %.fr15.i.i, 134217728              ; [#uses=1 type=i64]
...
define dso_local void @blockClientShutdown(ptr noundef %0) local_unnamed_addr #0 {
  ...
  %3 = load i64, ptr %2, align 8, !tbaa !45       ; [#uses=1 type=i64]
  %.fr15.i = freeze i64 %3                        ; [#uses=3 type=i64]
  %4 = and i64 %.fr15.i, 2                        ; [#uses=1 type=i64]
  %.not16.i = icmp eq i64 %4, 0                   ; [#uses=1 type=i1]
  br i1 %.not16.i, label %switch.edge.i, label %switch.early.test.i
...
switch.edge.i:                                    ; preds = %1
  %5 = or i64 %.fr15.i, 16                        ; [#uses=1 type=i64]
  store i64 %5, ptr %2, align 8, !tbaa !45
  %6 = getelementptr inbounds nuw i8, ptr %0, i64 592 ; [#uses=1 type=ptr]
  store i32 9, ptr %6, align 8, !tbaa !13
  %7 = and i64 %.fr15.i, 134217728                ; [#uses=1 type=i64]
