...
bb.d:                                             ; preds = %.lr.ph, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit
  %.270.a = phi i32 [ %.1, %.lr.ph ], [ %i.bw, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit ]
  %.sroa.0.069 = phi i8 [ %.sroa.0.0.extract.trunc, %.lr.ph ], [ %5, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit ] ; 5 uses
  %.sroa.8.068 = phi i8 [ %.sroa.8.0.extract.trunc, %.lr.ph ], [ %6, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit ] ; 5 uses
  %3 = zext nneg i8 %.sroa.0.069 to i32
  %i.v = shl nuw i32 1, %3                        ; 2 uses
  %4 = zext nneg i8 %.sroa.8.068 to i32
  %i.w = shl nuw i32 1, %4                        ; 2 uses
...
_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit: ; preds = %bb.h, %bb.i
  ...
  %5 = add nsw i8 %.sroa.0.069, -1
  %6 = add nsw i8 %.sroa.8.068, -1
  %i.bw = add nsw i32 %.270.a, -1                 ; 2 uses
  %i.bx = icmp ne i32 %i.bw, 0
  %i.by = icmp sgt i8 %.sroa.0.069, 1
  %or.cond = select i1 %i.bx, i1 %i.by, i1 false
  %i.bz = icmp sgt i8 %.sroa.8.068, 1
