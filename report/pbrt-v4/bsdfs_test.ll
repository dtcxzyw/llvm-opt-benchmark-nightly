...
bb.k:                                             ; preds = %bb.m, %bb.j
  ...
  %.080 = phi double [ %i.aa, %bb.j ], [ %2, %bb.m ]
  ...
  %2 = fadd double %.080, 2.000000e+00            ; 2 uses
  %3 = uitofp nneg i32 %i.aj to double
  %4 = fmul double %i.ak, %3
  %i.al = insertelement <2 x double> poison, double %2, i64 0
  %i.am = shufflevector <2 x double> %i.al, <2 x double> poison, <2 x i32> zeroinitializer
  %i.an = fmul <2 x double> %i.am, %i.ah
  %i.ao = insertelement <2 x double> poison, double %4, i64 0
...
bb.ad:                                            ; preds = %_ZN7testing15AssertionResultD2Ev.exit159.i, %_ZNKSt8functionIFPN4pbrt4BSDFERKNS0_18SurfaceInteractionEN4pstd3pmr21polymorphic_allocatorISt4byteEEEEclES5_SA_.exit.i
  ...
  %27 = fmul float %i.em, %sqrt.i.i.i             ; 2 uses
  %i.en = call noundef float @sinf(float noundef %i.el) #31
  %28 = fmul float %i.en, %sqrt.i.i.i             ; 2 uses
  ...
  %29 = fmul float %.sroa.238.0.copyload.i.i.i, %27
  ...
  %30 = fmul float %.sroa.228.0.copyload.i.i.i, %28
  %31 = fadd float %29, %30
  ...
  %i.eo = insertelement <2 x float> poison, float %27, i64 0
  ...
  %i.er = shufflevector <2 x float> %32, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.ez = fadd float %i.ex, %31                   ; 3 uses
...
bb.a:
  ...
  %6 = alloca %"class.pstd::optional", align 8    ; 8 uses
  ...
  %.sroa.8.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %6, i64 28
...
bb.f:                                             ; preds = %bb.d, %bb.h
  ...
  %i.cf = load i8, ptr %10, align 4, !tbaa !39, !range !42, !noundef !43
  %i.cg = trunc nuw i8 %i.cf to i1
  br i1 %i.cg, label %bb.g, label %bb.h

bb.g:                                             ; preds = %bb.f
  %.val57 = load float, ptr %i.c, align 8, !tbaa !68 ; 3 uses
  %11 = fmul float %.val57, %.val57
  %.sroa.8.0.copyload.i.a = load <2 x float>, ptr %6, align 8
  %i.ch = load <2 x float>, ptr %i.d, align 8, !tbaa !100
  %12 = call noundef float @llvm.fabs.f32(float %.val57)
  %13 = load float, ptr %.sroa.8.0..sroa_idx.i, align 4, !tbaa !300
