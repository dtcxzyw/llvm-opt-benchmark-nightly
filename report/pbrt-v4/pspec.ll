...
bb.a:
  ...
  %i.d = load i32, ptr %i.c, align 4, !tbaa !145  ; 7 uses
...
_ZN4pbrt9BlueNoiseEiNS_6Point2IiEE.exit10:        ; preds = %._crit_edge
  ...
  %1 = urem i32 %i.d, 48
  %i.cg = and i64 %.sroa.02.0.copyload, 127       ; 2 uses
  %2 = and i64 %.sroa.3.0.extract.shift.i, 127    ; 2 uses
  %i.ch = zext nneg i32 %1 to i64
  %i.ci = getelementptr inbounds nuw [32768 x i8], ptr @_ZN4pbrt17BlueNoiseTexturesE, i64 %i.ch
  %i.cj = getelementptr inbounds nuw [256 x i8], ptr %i.ci, i64 %i.cg
  %i.ck = getelementptr inbounds nuw [2 x i8], ptr %i.cj, i64 %2
  %i.cl = load i16, ptr %i.ck, align 2, !tbaa !59
  %3 = add nuw nsw i32 %i.d, 1
  %4 = urem i32 %3, 48
  %i.cm = zext nneg i32 %4 to i64
  %i.cn = getelementptr inbounds nuw [32768 x i8], ptr @_ZN4pbrt17BlueNoiseTexturesE, i64 %i.cm
  %i.co = getelementptr inbounds nuw [256 x i8], ptr %i.cn, i64 %i.cg
  %i.cp = getelementptr inbounds nuw [2 x i8], ptr %i.co, i64 %2
