...
.preheader29:                                     ; preds = %bb.bk, %.preheader29
  ...
  %6 = trunc nuw i32 %i.ma to i16                 ; 2 uses
  %7 = lshr i16 %6, 10
  %i.mb = and i16 %7, 31
  ...
  %9 = shufflevector <2 x i16> %8, <2 x i16> poison, <2 x i32> zeroinitializer
  %10 = lshr <2 x i16> %9, <i16 5, i16 0>
  %i.me = and <2 x i16> %10, splat (i16 31)
...
bb.ci:                                            ; preds = %bb.cg
  %i.ph = tail call fastcc noundef i32 @_ZL13stbi__get16leP13stbi__context(ptr noundef nonnull %0)
  %11 = trunc nuw i32 %i.ph to i16                ; 2 uses
  %12 = lshr i16 %11, 10
  %i.pi = and i16 %12, 31
  ...
  %13 = insertelement <2 x i16> poison, i16 %11, i64 0
  %14 = shufflevector <2 x i16> %13, <2 x i16> poison, <2 x i32> zeroinitializer
  %15 = lshr <2 x i16> %14, <i16 5, i16 0>
  %i.pl = and <2 x i16> %15, splat (i16 31)
