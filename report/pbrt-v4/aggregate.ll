...
_ZN4pstd8optionalIN4pbrt18RayMajorantSegmentEEptEv.exit134.i.i: ; preds = %.noexc168.i.i
  ...
  %.sroa.04.0.copyload.i.i317 = load <2 x float>, ptr %i.bhn, align 4 ; 2 uses
  ...
  %24 = shufflevector <2 x float> %.sroa.04.0.copyload.i.i317, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  ...
  store <4 x float> %i.bxx, ptr %.sroa.018.0.copyload.i260, align 4, !tbaa !53
