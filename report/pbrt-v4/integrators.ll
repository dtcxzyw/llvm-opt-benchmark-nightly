...
_ZN4pbrt3RGBixEi.exit.2:
  ...
  %3 = load float, ptr %i.bh, align 4, !tbaa !189
  %.sroa.0.0.vec.extract = extractelement <2 x float> %i.aw, i64 0 ; 3 uses
  %4 = fmul float %3, %.sroa.0.0.vec.extract
  %5 = fadd float %4, 0.000000e+00
  %i.bi = getelementptr inbounds nuw i8, ptr %0, i64 104
  %6 = load float, ptr %i.bi, align 8, !tbaa !189
  %.sroa.0.4.vec.extract = extractelement <2 x float> %i.aw, i64 1 ; 3 uses
  %7 = fmul float %6, %.sroa.0.4.vec.extract
  %8 = fadd float %5, %7
  %9 = getelementptr inbounds nuw i8, ptr %0, i64 108
  %10 = load float, ptr %9, align 4, !tbaa !189
  %11 = fmul float %10, %i.bg
  %12 = fadd float %8, %11
  %.sroa.014.i.4.vec.insert.i = insertelement <2 x float> poison, float %12, i64 0
  %13 = getelementptr inbounds nuw i8, ptr %0, i64 112
  %14 = load float, ptr %13, align 8, !tbaa !189
  %15 = fmul float %.sroa.0.0.vec.extract, %14
  %16 = fadd float %15, 0.000000e+00
  %i.bj = getelementptr inbounds nuw i8, ptr %0, i64 116
  %17 = load float, ptr %i.bj, align 4, !tbaa !189
  %18 = fmul float %.sroa.0.4.vec.extract, %17
  %19 = fadd float %18, %16
  %20 = getelementptr inbounds nuw i8, ptr %0, i64 120
  %21 = load float, ptr %20, align 8, !tbaa !189
  %22 = fmul float %21, %i.bg
  %23 = fadd float %22, %19
  %.sroa.014.i.4.vec.insert10.i = insertelement <2 x float> %.sroa.014.i.4.vec.insert.i, float %23, i64 1
  %24 = getelementptr inbounds nuw i8, ptr %0, i64 124
  %25 = load float, ptr %24, align 4, !tbaa !189
  %26 = fmul float %.sroa.0.0.vec.extract, %25
  %i.bk = fadd float %26, 0.000000e+00
  %27 = getelementptr inbounds nuw i8, ptr %0, i64 128
  %28 = load float, ptr %27, align 8, !tbaa !189
  %29 = fmul float %.sroa.0.4.vec.extract, %28
  %i.bl = fadd float %29, %i.bk
...
_ZN4pbrt3RGBixEi.exit.2:
  ...
  %4 = fmul float %3, %.sroa.0.0.vec.extract
  %5 = fadd float %4, 0.000000e+00
  %i.bi = getelementptr inbounds nuw i8, ptr %0, i64 840
  %6 = load float, ptr %i.bi, align 8, !tbaa !189
  %.sroa.0.4.vec.extract = extractelement <2 x float> %i.aw, i64 1 ; 3 uses
  %7 = fmul float %6, %.sroa.0.4.vec.extract
  %8 = fadd float %5, %7
  %9 = getelementptr inbounds nuw i8, ptr %0, i64 844
  %10 = load float, ptr %9, align 4, !tbaa !189
  %11 = fmul float %10, %i.bg
  %12 = fadd float %8, %11
  %.sroa.014.i.4.vec.insert.i = insertelement <2 x float> poison, float %12, i64 0
  ...
  %15 = fmul float %.sroa.0.0.vec.extract, %14
  %16 = fadd float %15, 0.000000e+00
  %i.bj = getelementptr inbounds nuw i8, ptr %0, i64 852
  %17 = load float, ptr %i.bj, align 4, !tbaa !189
  %18 = fmul float %.sroa.0.4.vec.extract, %17
  %19 = fadd float %18, %16
  ...
  %23 = fadd float %22, %19
  %.sroa.014.i.4.vec.insert10.i = insertelement <2 x float> %.sroa.014.i.4.vec.insert.i, float %23, i64 1
  %24 = getelementptr inbounds nuw i8, ptr %0, i64 860
  %25 = load float, ptr %24, align 4, !tbaa !189
  %26 = fmul float %.sroa.0.0.vec.extract, %25
  %i.bk = fadd float %26, 0.000000e+00
