...
bb.cy:                                            ; preds = %bb.cx, %bb.cw, %_ZN4pbrt7FastExpEf.exit.2.i.i.i256.i.i.i
  ...
  %29 = extractelement <4 x float> %i.bld, i64 3
...
_ZN4pstd8optionalIN4pbrt18RayMajorantSegmentEEptEv.exit135.i.i.i.i.i: ; preds = %.noexc169.i.i.i.i.i
  ...
  %.sroa.04.0.copyload.i.i272.i.i.i = load <2 x float>, ptr %i.fg, align 4 ; 2 uses
  %.sroa.25.0.copyload.i.i273.i.i.i = load <2 x float>, ptr %.sroa.6.0..sroa_idx.i.i105.i.i232.i.i.i, align 4, !tbaa !47
  %.sroa.0.0.vec.extract.i.i136.i.i274.i.i.i = extractelement <2 x float> %.sroa.04.0.copyload.i.i272.i.i.i, i64 0 ; 2 uses
  ...
  %30 = fmul float %29, %.sroa.0.0.vec.extract.i.i136.i.i274.i.i.i
  %31 = fadd float %i.bux, %i.bvi
  %32 = shufflevector <2 x float> %i.bnp, <2 x float> %i.bnq, <4 x i32> <i32 1, i32 0, i32 3, i32 2>
  %33 = insertelement <4 x float> poison, float %31, i64 0
  %i.bvo = shufflevector <4 x float> %33, <4 x float> poison, <4 x i32> zeroinitializer ; 2 uses
  %i.bvp = fmul <4 x float> %32, %i.bvo
...
_ZN4pstd8optionalIN4pbrt18RayMajorantSegmentEEptEv.exit134.i.i: ; preds = %.noexc168.i.i
  ...
  %.sroa.04.0.copyload.i.i321 = load <2 x float>, ptr %i.bhn, align 4
  ...
  store <4 x float> %27, ptr %.sroa.018.0.copyload.i263, align 4, !tbaa !189
...
.loopexit.loopexit.i.i.i:                         ; preds = %bb.a
  ...
  %.sroa.0.0.copyload.i.i.i.i = load <2 x float>, ptr %i.aj, align 8
  ...
  %2 = fadd float %.sroa.8.0.copyload.i.i.i.i, %i.ai
  %3 = load float, ptr %i.o, align 8, !tbaa !554  ; 2 uses
  %4 = insertelement <2 x i32> poison, i32 %i.ad, i64 0
  %5 = insertelement <2 x i32> %4, i32 %i.af, i64 1
  %6 = bitcast <2 x i32> %5 to <2 x float>
  %7 = fadd <2 x float> %.sroa.0.0.copyload.i.i.i.i, %6
  %i.ak = fmul float %3, %3                       ; 2 uses
  %i.al = fmul float %i.ab, %i.ab                 ; 2 uses
  %8 = insertelement <2 x float> poison, float %i.al, i64 0
  %9 = shufflevector <2 x float> %8, <2 x float> poison, <2 x i32> zeroinitializer
  %10 = fmul <2 x float> %9, %7
  %11 = fmul float %i.al, %2
  %.sroa.0.0.vec.insert.i51.i.i.i = insertelement <2 x float> poison, float %i.ak, i64 0
  %12 = shufflevector <2 x float> %.sroa.0.0.vec.insert.i51.i.i.i, <2 x float> poison, <2 x i32> zeroinitializer
  %13 = fdiv <2 x float> %10, %12
  %i.am = fdiv float %11, %i.ak
  store <2 x float> %13, ptr %i.aj, align 8
