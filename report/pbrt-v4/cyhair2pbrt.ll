...
_ZN6cyhairL22CamullRomToCubicBezierEPNS_5real3EPKS0_ii.exit: ; preds = %bb.v, %bb.w
  ...
  %7 = load float, ptr %i.fx, align 4, !tbaa !11  ; 2 uses
  %8 = load float, ptr %i.fw, align 8, !tbaa !11  ; 2 uses
  %9 = load float, ptr %i.fv, align 4, !tbaa !11  ; 2 uses
  ...
  %i.hw = fmul float %.sroa.17.0, %9
  %i.hx = insertelement <2 x float> poison, float %9, i64 0
