...
bb.w:                                             ; preds = %bb.v
  ...
  %.sroa.9343.0..sroa_idx.a = getelementptr i8, ptr %i.dq, i64 -12
  %.sroa.9343.0.copyload = load float, ptr %.sroa.9343.0..sroa_idx.a, align 4, !tbaa !11
  %.sroa.13349.0..sroa_idx = getelementptr i8, ptr %i.dq, i64 -8
  %7 = load <2 x float>, ptr %.sroa.13349.0..sroa_idx, align 4, !tbaa !11
...
_ZN6cyhairL22CamullRomToCubicBezierEPNS_5real3EPKS0_ii.exit: ; preds = %bb.v, %bb.w
  ...
  %.sroa.0338.0 = phi float [ %.sroa.9343.0.copyload, %bb.w ], [ 0.000000e+00, %bb.v ] ; 4 uses
  %_ZN6cyhairL6toC2B1E.sink.i = phi ptr [ @_ZN6cyhairL5toC2BE, %bb.w ], [ @_ZN6cyhairL6toC2B0E, %bb.v ] ; 16 uses
  %8 = phi <2 x float> [ %7, %bb.w ], [ zeroinitializer, %bb.v ] ; 3 uses
  ...
  %.sroa.43.0.in = getelementptr i8, ptr %.sroa.17.0.in, i64 16
  %.sroa.39.0.in = getelementptr i8, ptr %.sroa.17.0.in, i64 12
  %.sroa.32.0.in = getelementptr inbounds nuw i8, ptr %.sroa.17.0.in, i64 4
  %.sroa.32.0 = load float, ptr %.sroa.39.0.in, align 4, !tbaa !11 ; 4 uses
  %.sroa.17.0 = load float, ptr %.sroa.17.0.in, align 4, !tbaa !11 ; 4 uses
  %.sroa.43.0 = load float, ptr %_ZN6cyhairL6toC2B1E.sink.i, align 16, !tbaa !11 ; 3 uses
  %9 = fmul float %.sroa.0338.0, %.sroa.43.0
  %10 = extractelement <2 x float> %8, i64 0      ; 3 uses
  %11 = fmul float %10, %.sroa.43.0
  %12 = extractelement <2 x float> %8, i64 1      ; 3 uses
  %13 = fmul float %12, %.sroa.43.0
  %14 = getelementptr inbounds nuw i8, ptr %_ZN6cyhairL6toC2B1E.sink.i, i64 4
  %15 = load float, ptr %14, align 4, !tbaa !11   ; 3 uses
  %i.dr = fmul float %.sroa.17.0, %15
  %16 = fadd float %9, %i.dr
  %i.ds = getelementptr inbounds nuw i8, ptr %_ZN6cyhairL6toC2B1E.sink.i, i64 8
  %i.dt = load float, ptr %i.ds, align 8, !tbaa !11 ; 3 uses
  %i.du = fmul float %.sroa.32.0, %i.dt
  %17 = fadd float %16, %i.du
  %18 = getelementptr inbounds nuw i8, ptr %_ZN6cyhairL6toC2B1E.sink.i, i64 12
  %19 = load float, ptr %18, align 4, !tbaa !11   ; 3 uses
  %20 = fmul float %.sroa.47.0, %19
  %i.dv = fadd float %17, %20
  %i.dw = getelementptr inbounds nuw i8, ptr %_ZN6cyhairL6toC2B1E.sink.i, i64 16
  %i.dx = load float, ptr %i.dw, align 16, !tbaa !11 ; 3 uses
  %i.dy = fmul float %.sroa.0338.0, %i.dx
  %i.dz = fmul float %10, %i.dx
  %i.ea = fmul float %12, %i.dx
  %21 = getelementptr inbounds nuw i8, ptr %_ZN6cyhairL6toC2B1E.sink.i, i64 20
  %22 = load float, ptr %21, align 4, !tbaa !11   ; 3 uses
  %23 = fmul float %.sroa.17.0, %22
  %i.eb = fadd float %i.dy, %23
  %i.ec = getelementptr inbounds nuw i8, ptr %_ZN6cyhairL6toC2B1E.sink.i, i64 24
  %i.ed = load float, ptr %i.ec, align 8, !tbaa !11 ; 3 uses
  %i.ee = fmul float %.sroa.32.0, %i.ed
  %24 = fadd float %i.eb, %i.ee
  %25 = getelementptr inbounds nuw i8, ptr %_ZN6cyhairL6toC2B1E.sink.i, i64 28
  %26 = load float, ptr %25, align 4, !tbaa !11   ; 3 uses
  %27 = fmul float %.sroa.47.0, %26
  %i.ef = fadd float %24, %27
  %i.eg = getelementptr inbounds nuw i8, ptr %_ZN6cyhairL6toC2B1E.sink.i, i64 32
  %i.eh = load float, ptr %i.eg, align 16, !tbaa !11 ; 3 uses
  %i.ei = fmul float %.sroa.0338.0, %i.eh
  %i.ej = fmul float %10, %i.eh
  %i.ek = fmul float %12, %i.eh
  %i.el = getelementptr inbounds nuw i8, ptr %_ZN6cyhairL6toC2B1E.sink.i, i64 36
  %i.em = load float, ptr %i.el, align 4, !tbaa !11 ; 3 uses
  %i.en = fmul float %.sroa.17.0, %i.em
  %28 = fadd float %i.ei, %i.en
  %29 = getelementptr inbounds nuw i8, ptr %_ZN6cyhairL6toC2B1E.sink.i, i64 40
  %30 = load float, ptr %29, align 8, !tbaa !11   ; 3 uses
  %31 = fmul float %.sroa.32.0, %30
  %i.eo = fadd float %28, %31
  %i.ep = getelementptr inbounds nuw i8, ptr %_ZN6cyhairL6toC2B1E.sink.i, i64 44
  %i.eq = load float, ptr %i.ep, align 4, !tbaa !11 ; 3 uses
  %i.er = fmul float %.sroa.47.0, %i.eq
  %32 = fadd float %i.eo, %i.er
  %33 = getelementptr inbounds nuw i8, ptr %_ZN6cyhairL6toC2B1E.sink.i, i64 48
  %34 = getelementptr inbounds nuw i8, ptr %_ZN6cyhairL6toC2B1E.sink.i, i64 52
  %35 = getelementptr inbounds nuw i8, ptr %_ZN6cyhairL6toC2B1E.sink.i, i64 56
  %36 = getelementptr inbounds nuw i8, ptr %_ZN6cyhairL6toC2B1E.sink.i, i64 60
  %37 = load <2 x float>, ptr %.sroa.53.0.in, align 4, !tbaa !11 ; 3 uses
  %38 = load <2 x float>, ptr %.sroa.43.0.in, align 4, !tbaa !11 ; 3 uses
  %39 = load <2 x float>, ptr %.sroa.32.0.in, align 4, !tbaa !11 ; 3 uses
  %40 = extractelement <2 x float> %39, i64 0     ; 3 uses
  %i.es = fmul float %40, %15
  %41 = extractelement <2 x float> %39, i64 1     ; 3 uses
  %i.et = fmul float %41, %15
  %i.eu = fadd float %11, %i.es
  %i.ev = fadd float %13, %i.et
  %42 = extractelement <2 x float> %38, i64 0     ; 3 uses
  %43 = fmul float %42, %i.dt
  %44 = extractelement <2 x float> %38, i64 1     ; 3 uses
  %i.ew = fmul float %44, %i.dt
  %45 = fadd float %i.eu, %43
  %46 = fadd float %i.ev, %i.ew
  %47 = extractelement <2 x float> %37, i64 0     ; 3 uses
  %i.ex = fmul float %47, %19
  %48 = extractelement <2 x float> %37, i64 1     ; 3 uses
  %49 = fmul float %48, %19
  %50 = fadd float %45, %i.ex
  %51 = fadd float %46, %49
  %i.ey = fmul float %40, %22
  %i.ez = fmul float %41, %22
  %i.fa = fadd float %i.dz, %i.ey
  %i.fb = fadd float %i.ea, %i.ez
  %52 = fmul float %42, %i.ed
  %53 = fmul float %44, %i.ed
  %54 = fadd float %i.fa, %52
  %55 = fadd float %i.fb, %53
  %i.fc = fmul float %47, %26
  %i.fd = fmul float %48, %26
  %i.fe = fadd float %54, %i.fc
  %i.ff = fadd float %55, %i.fd
  %56 = fmul float %40, %i.em
  %57 = fmul float %41, %i.em
  %58 = fadd float %i.ej, %56
  %59 = fadd float %i.ek, %57
  %i.fg = fmul float %42, %30
  %i.fh = fmul float %44, %30
  %i.fi = fadd float %58, %i.fg
  %i.fj = fadd float %59, %i.fh
  %60 = fmul float %47, %i.eq
  %61 = fmul float %48, %i.eq
  %62 = fadd float %i.fi, %60
  %63 = fadd float %i.fj, %61
  %64 = load float, ptr %36, align 4, !tbaa !11   ; 2 uses
  %65 = load float, ptr %35, align 8, !tbaa !11   ; 2 uses
  %66 = load float, ptr %34, align 4, !tbaa !11   ; 2 uses
  %i.fk = load float, ptr %33, align 16, !tbaa !11 ; 2 uses
  %i.fl = fmul float %.sroa.0338.0, %i.fk
  %67 = insertelement <2 x float> poison, float %i.fk, i64 0
  %68 = shufflevector <2 x float> %67, <2 x float> poison, <2 x i32> zeroinitializer
  %69 = fmul <2 x float> %8, %68
  %70 = fmul float %.sroa.17.0, %66
  %71 = insertelement <2 x float> poison, float %66, i64 0
  %72 = shufflevector <2 x float> %71, <2 x float> poison, <2 x i32> zeroinitializer
  %73 = fmul <2 x float> %39, %72
  %74 = fadd float %i.fl, %70
  %75 = fadd <2 x float> %69, %73
  %i.fm = fmul float %.sroa.32.0, %65
  %76 = insertelement <2 x float> poison, float %65, i64 0
  %77 = shufflevector <2 x float> %76, <2 x float> poison, <2 x i32> zeroinitializer
  %78 = fmul <2 x float> %38, %77
  %79 = fadd float %74, %i.fm
  %80 = fadd <2 x float> %75, %78
  %i.fn = fmul float %.sroa.47.0, %64
  %81 = insertelement <2 x float> poison, float %64, i64 0
  %82 = shufflevector <2 x float> %81, <2 x float> poison, <2 x i32> zeroinitializer
  %83 = fmul <2 x float> %37, %82
  %i.fo = fadd float %79, %i.fn
  %84 = fadd <2 x float> %80, %83                 ; 2 uses
  %i.fp = load float, ptr %3, align 4, !tbaa !11
  %i.fq = fmul float %i.fp, %i.dv
