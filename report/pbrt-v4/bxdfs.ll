...
bb.e:                                             ; preds = %bb.d
  ...
  %14 = fmul float %i.bo, %i.eb                   ; 4 uses
  %15 = fmul float %.sroa.speculated, %14
  %16 = fmul float %.sroa.speculated.1, %14
  %17 = fmul float %.sroa.speculated.2, %14
  %i.ec = fmul float %.sroa.speculated.3, %14
  ...
  %i.ej = fmul float %.sroa.7.0, %i.ei            ; 4 uses
  %18 = fdiv float %15, %i.ej
  %i.ek = insertelement <2 x float> poison, float %18, i64 0
  %19 = fdiv float %16, %i.ej
  %i.el = insertelement <2 x float> %i.ek, float %19, i64 1
  %20 = fdiv float %17, %i.ej
  %i.em = insertelement <2 x float> poison, float %20, i64 0
  %21 = fdiv float %i.ec, %i.ej
  %i.en = insertelement <2 x float> %i.em, float %21, i64 1
  br label %bb.f

bb.f:                                             ; preds = %bb.d, %bb.a, %bb.e
  %.sroa.0134.0 = phi <2 x float> [ zeroinitializer, %bb.a ], [ %i.el, %bb.e ], [ zeroinitializer, %bb.d ]
  %.sroa.6.0 = phi <2 x float> [ zeroinitializer, %bb.a ], [ %i.en, %bb.e ], [ zeroinitializer, %bb.d ]
...
bb.b:                                             ; preds = %.lr.ph, %bb.f
  ...
  %.sroa.015.0.copyload = load <2 x float>, ptr %i.s, align 4 ; 5 uses
  %.sroa.0.0.vec.extract.i29 = extractelement <2 x float> %.sroa.015.0.copyload, i64 0 ; 2 uses
...
bb.d:                                             ; preds = %_ZN4pstd8optionalIN4pbrt10BSDFSampleEEptEv.exit
  ...
  %i.aq = insertelement <2 x float> %.sroa.015.0.copyload, float %.sroa.26.0.copyload, i64 1
  %10 = call <2 x float> @llvm.fabs.v2f32(<2 x float> %i.aq) ; 2 uses
  %11 = shufflevector <2 x float> %10, <2 x float> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  %12 = fmul <2 x float> %11, %.sroa.6.0.copyload.i
  %i.ar = shufflevector <2 x float> %10, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.as = fmul <2 x float> %i.ar, %12
  ...
  %13 = fmul <2 x float> %11, %.sroa.0.0.copyload.i
  %i.aw = fmul <2 x float> %i.ar, %13
  %14 = fdiv <2 x float> %i.aw, %i.au
  %15 = fadd <2 x float> %.sroa.074.094, %14
  %i.ax = fadd <2 x float> %.sroa.10.093, %i.av
  br label %bb.e
