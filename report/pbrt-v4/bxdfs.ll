...
bb.d:                                             ; preds = %_ZN4pstd8optionalIN4pbrt10BSDFSampleEEptEv.exit
  ...
  %13 = fdiv <2 x float> %i.as, %i.au
  %i.av = fmul <2 x float> %11, %.sroa.0.0.copyload.i
  %14 = fmul <2 x float> %i.ar, %i.av
  %i.aw = fdiv <2 x float> %14, %i.au
  %i.ax = fadd <2 x float> %.sroa.074.094, %i.aw
  %i.ay = fadd <2 x float> %.sroa.10.093, %13
  br label %bb.e
