...
_ZN4pbrt12FrDielectricEff.exit.i:                 ; preds = %bb.b, %bb.a
  ...
  %6 = fsub <4 x float> splat (float 1.000000e+00), %i.ck ; 5 uses
  ...
  %or.cond14.i.i = select i1 %or.cond.i.i, i1 true, i1 %12
  %13 = extractelement <4 x float> %6, i64 3
  %14 = fcmp une float %13, 0.000000e+00
  %or.cond17.i.i = select i1 %or.cond14.i.i, i1 true, i1 %14 ; 2 uses
  ...
  %.sroa.6.0.copyload.i.i = select i1 %or.cond17.i.i, <2 x float> %i.cp, <2 x float> zeroinitializer
  %.sroa.0.0.copyload.i.i = select i1 %or.cond17.i.i, <2 x float> %i.co, <2 x float> zeroinitializer
...
_ZN4pbrt12FrDielectricEff.exit.i:                 ; preds = %bb.b, %cdce.end
  ...
  %i.cd = fsub <4 x float> splat (float 1.000000e+00), %i.cc ; 5 uses
  %2 = extractelement <4 x float> %i.cd, i64 0
  %3 = fcmp une float %2, 0.000000e+00
  %4 = extractelement <4 x float> %i.cd, i64 1
  %5 = fcmp une float %4, 0.000000e+00
  %or.cond.i.i = or i1 %3, %5
  %6 = extractelement <4 x float> %i.cd, i64 2
  %7 = fcmp une float %6, 0.000000e+00
  %or.cond14.i.i = or i1 %or.cond.i.i, %7
  %8 = extractelement <4 x float> %i.cd, i64 3
  %9 = fcmp une float %8, 0.000000e+00
  %or.cond17.i.i = or i1 %or.cond14.i.i, %9       ; 2 uses
  ...
  %.sroa.40.0 = select i1 %or.cond17.i.i, <2 x float> %i.ci, <2 x float> zeroinitializer ; 2 uses
  %.sroa.34.0 = select i1 %or.cond17.i.i, <2 x float> %i.ch, <2 x float> zeroinitializer ; 2 uses
