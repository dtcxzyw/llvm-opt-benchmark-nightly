...
bb.e:                                             ; preds = %bb.d
  ...
  %i.ek = insertelement <2 x float> %11, float %i.aw, i64 1 ; 2 uses
  %12 = fcmp ogt <2 x float> %i.ek, zeroinitializer
  %13 = select <2 x i1> %12, <2 x float> %i.ek, <2 x float> zeroinitializer
  %i.el = insertelement <2 x float> poison, float %i.ec, i64 0
  %14 = shufflevector <2 x float> %i.el, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %15 = fmul <2 x float> %13, %14
  %i.em = insertelement <2 x float> poison, float %i.ej, i64 0
  %16 = shufflevector <2 x float> %i.em, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %17 = fdiv <2 x float> %15, %16
  %18 = insertelement <2 x float> poison, float %i.bb, i64 0
  %i.en = insertelement <2 x float> %18, float %i.bg, i64 1 ; 2 uses
  %19 = fcmp ogt <2 x float> %i.en, zeroinitializer
  %20 = select <2 x i1> %19, <2 x float> %i.en, <2 x float> zeroinitializer
