...
bb.e:                                             ; preds = %bb.d
  ...
  %.sroa.0.0.vec.insert.i104 = insertelement <2 x float> poison, float %18, i64 0
  %19 = fdiv float %16, %i.ej
  %.sroa.0.4.vec.insert.i106 = insertelement <2 x float> %.sroa.0.0.vec.insert.i104, float %19, i64 1
  %20 = fdiv float %17, %i.ej
  %.sroa.8.8.vec.insert.i = insertelement <2 x float> poison, float %20, i64 0
  %21 = fdiv float %i.ec, %i.ej
  %.sroa.8.12.vec.insert.i = insertelement <2 x float> %.sroa.8.8.vec.insert.i, float %21, i64 1
  br label %bb.f
