...
bb.e:                                             ; preds = %bb.d
  ...
  %foldExtExtBinop155 = fmul <4 x float> %foldExtExtBinop154, %i.dx
  %11 = extractelement <4 x float> %foldExtExtBinop155, i64 1
  %12 = extractelement <4 x float> %i.dx, i64 0
  %13 = tail call noundef float @llvm.fma.f32(float %i.ch, float %12, float %11)
  %foldExtExtBinop158 = fmul <4 x float> %foldExtExtBinop156, %i.dx
  %i.dy = extractelement <4 x float> %foldExtExtBinop158, i64 3
  %i.dz = extractelement <4 x float> %i.dx, i64 2
  %i.ea = tail call noundef float @llvm.fma.f32(float %i.cs, float %i.dz, float %i.dy)
  ...
  %14 = extractelement <2 x float> %foldExtExtBinop160, i64 0
  %i.eb = fmul float %14, %i.ea
  %15 = insertelement <2 x float> poison, float %i.bb, i64 0
  %16 = insertelement <2 x float> %15, float %i.bg, i64 1 ; 2 uses
  %17 = fcmp ogt <2 x float> %16, zeroinitializer
  %18 = select <2 x i1> %17, <2 x float> %16, <2 x float> zeroinitializer
  %19 = insertelement <2 x float> poison, float %i.ar, i64 0
  %20 = insertelement <2 x float> %19, float %i.aw, i64 1 ; 2 uses
  %21 = fcmp ogt <2 x float> %20, zeroinitializer
  %22 = select <2 x i1> %21, <2 x float> %20, <2 x float> zeroinitializer
  %23 = fmul float %i.eb, 4.000000e+00
  ...
  %i.ed = fmul float %.sroa.7.0, %23
  %i.ee = fmul float %i.ec, %13
  %24 = insertelement <2 x float> poison, float %i.ee, i64 0
  %25 = shufflevector <2 x float> %24, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %26 = fmul <2 x float> %22, %25
  %27 = fmul <2 x float> %18, %25
  %.sroa.0.4.vec.insert.i106 = insertelement <2 x float> poison, float %i.ed, i64 0
  %28 = shufflevector <2 x float> %.sroa.0.4.vec.insert.i106, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %29 = fdiv <2 x float> %26, %28
  %30 = fdiv <2 x float> %27, %28
  br label %bb.f

bb.f:                                             ; preds = %bb.d, %bb.a, %bb.e
  %.sroa.0134.0 = phi <2 x float> [ zeroinitializer, %bb.a ], [ %29, %bb.e ], [ zeroinitializer, %bb.d ]
  %.sroa.6.0 = phi <2 x float> [ zeroinitializer, %bb.a ], [ %30, %bb.e ], [ zeroinitializer, %bb.d ]
