...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.ap, label %middle.block, label %vector.body, !llvm.loop !677
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.as, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !678
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph
  ...
  br i1 %.not19.i, label %.loopexit, label %vec.epilog.scalar.ph, !llvm.loop !679
...
_Z18lodepng_chunk_nextPhS_.exit:                  ; preds = %.loopexit, %bb.j, %._crit_edge.i
  ...
  br i1 %i.ci, label %bb.b, label %_Z20lodepng_chunk_appendPPhPmPKh.exit.thread, !llvm.loop !680
