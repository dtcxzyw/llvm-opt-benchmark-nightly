...
_ZNK4pbrt6MIPMap15LevelResolutionEi.exit:         ; preds = %bb.d
  ...
  %6 = fmul float %i.au, 2.000000e+00
  %7 = fmul <2 x float> %2, %i.x
  %8 = fadd <2 x float> %7, splat (float -5.000000e-01) ; 4 uses
...
.lr.ph.preheader:                                 ; preds = %.lr.ph163
  %i.br = extractelement <2 x float> %8, i64 1
  %i.bs = extractelement <2 x float> %8, i64 0
  br label %.lr.ph
...
_ZNK4pbrt6MIPMap15LevelResolutionEi.exit:         ; preds = %bb.d
  ...
  %6 = fmul float %i.at, 2.000000e+00
  %7 = fmul <2 x float> %2, %i.w
  %8 = fadd <2 x float> %7, splat (float -5.000000e-01) ; 4 uses
...
.lr.ph.preheader:                                 ; preds = %.lr.ph454
  %i.bq = extractelement <2 x float> %8, i64 1
  %i.br = extractelement <2 x float> %8, i64 0
  br label %.lr.ph
