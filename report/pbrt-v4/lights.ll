...
bb.a:
  ...
  %.sroa.0.sroa.2.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %1, i64 4 ; 2 uses
  %.sroa.0.sroa.3.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %1, i64 8
  %.sroa.0.sroa.4.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %1, i64 12 ; 2 uses
  %.sroa.0.sroa.5.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %1, i64 16 ; 2 uses
  %.sroa.0.sroa.5.0.copyload.i = load float, ptr %.sroa.0.sroa.5.0..sroa_idx.i, align 4
  %.sroa.0.sroa.6.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %1, i64 20 ; 2 uses
  %.sroa.0.sroa.6.0.copyload.i = load float, ptr %.sroa.0.sroa.6.0..sroa_idx.i, align 4
...
bb.f:                                             ; preds = %_ZNK4pbrt6Tuple3INS_7Normal3EfEneENS1_IfEE.exit.thread
  ...
  %7 = load <2 x float>, ptr %.sroa.0.sroa.4.0..sroa_idx.i, align 4 ; 3 uses
  %8 = call <6 x float> @llvm.masked.load.v6f32.p0(ptr nonnull align 4 %1, <6 x i1> <i1 true, i1 true, i1 true, i1 false, i1 false, i1 true>, <6 x float> poison) ; 4 uses
  %9 = shufflevector <6 x float> %8, <6 x float> poison, <2 x i32> <i32 poison, i32 2>
  %10 = shufflevector <2 x float> %9, <2 x float> <float 1.000000e+00, float poison>, <4 x i32> <i32 1, i32 2, i32 1, i32 1>
  %11 = shufflevector <2 x float> %7, <2 x float> <float -0.000000e+00, float poison>, <4 x i32> <i32 0, i32 2, i32 0, i32 0>
  %12 = fadd <4 x float> %10, %11
  %13 = shufflevector <2 x float> %7, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 0, i32 0>
  %14 = shufflevector <6 x float> %8, <6 x float> poison, <4 x i32> <i32 5, i32 2, i32 2, i32 2>
  %15 = fadd <4 x float> %13, %14
  %16 = shufflevector <2 x float> %7, <2 x float> poison, <6 x i32> <i32 poison, i32 1, i32 poison, i32 poison, i32 poison, i32 poison>
  %17 = shufflevector <6 x float> %16, <6 x float> %8, <4 x i32> <i32 6, i32 1, i32 6, i32 6>
  %18 = shufflevector <6 x float> %8, <6 x float> poison, <4 x i32> <i32 1, i32 5, i32 1, i32 1>
  %19 = fadd <4 x float> %17, %18
  %20 = fmul <4 x float> %12, <float 5.000000e-01, float 0.000000e+00, float 5.000000e-01, float 5.000000e-01> ; 3 uses
  %21 = fmul <4 x float> %19, splat (float 5.000000e-01) ; 3 uses
  %22 = fmul <4 x float> %15, splat (float 5.000000e-01)
  %23 = shufflevector <2 x float> %i.ez, <2 x float> %i.fe, <4 x i32> <i32 1, i32 3, i32 poison, i32 poison>
  %24 = shufflevector <2 x float> %i.fc, <2 x float> poison, <4 x i32> <i32 poison, i32 1, i32 poison, i32 poison>
  %25 = shufflevector <4 x float> %23, <4 x float> %24, <4 x i32> <i32 0, i32 1, i32 5, i32 poison>
  %26 = shufflevector <2 x float> %i.fg, <2 x float> poison, <4 x i32> <i32 poison, i32 1, i32 poison, i32 poison>
  %27 = shufflevector <4 x float> %25, <4 x float> %26, <4 x i32> <i32 0, i32 1, i32 2, i32 5> ; 2 uses
  %28 = shufflevector <4 x float> %20, <4 x float> %21, <4 x i32> <i32 0, i32 5, i32 5, i32 5>
  %29 = fsub <4 x float> %27, %28                 ; 2 uses
  %30 = shufflevector <4 x float> %29, <4 x float> poison, <2 x i32> <i32 2, i32 3> ; 2 uses
  %i.fu = fmul <2 x float> %30, %30
  %i.fv = shufflevector <2 x float> %i.ez, <2 x float> %i.ey, <4 x i32> <i32 0, i32 2, i32 poison, i32 poison>
  %i.fw = shufflevector <2 x float> %i.fa, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 4 uses
  %i.fx = shufflevector <4 x float> %i.fv, <4 x float> %i.fw, <4 x i32> <i32 0, i32 0, i32 1, i32 4> ; 2 uses
  %31 = shufflevector <4 x float> %21, <4 x float> poison, <4 x i32> zeroinitializer
  %i.fy = fsub <4 x float> %i.fx, %31
  %i.fz = shufflevector <2 x float> %i.ez, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 2 uses
  %32 = shufflevector <4 x float> <float poison, float -0.000000e+00, float poison, float poison>, <4 x float> %i.fz, <4 x i32> <i32 5, i32 1, i32 poison, i32 poison>
  %i.ga = shufflevector <2 x float> %i.ey, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 3 uses
  %i.gb = shufflevector <4 x float> %32, <4 x float> %i.ga, <4 x i32> <i32 0, i32 1, i32 5, i32 poison>
  %i.gc = shufflevector <4 x float> %i.gb, <4 x float> %i.fw, <4 x i32> <i32 0, i32 1, i32 2, i32 5>
  %i.gd = fsub <4 x float> %i.gc, %20
  %33 = shufflevector <4 x float> <float poison, float 1.000000e+00, float poison, float poison>, <4 x float> %i.fz, <4 x i32> <i32 5, i32 1, i32 poison, i32 poison>
  %i.ge = shufflevector <4 x float> %33, <4 x float> %i.ga, <4 x i32> <i32 0, i32 1, i32 5, i32 poison>
  %i.gf = shufflevector <4 x float> %i.ge, <4 x float> %i.fw, <4 x i32> <i32 0, i32 1, i32 2, i32 5>
  %i.gg = fsub <4 x float> %i.gf, %20
  %34 = shufflevector <4 x float> %27, <4 x float> %i.ga, <4 x i32> <i32 1, i32 0, i32 5, i32 poison>
  %35 = shufflevector <4 x float> %34, <4 x float> %i.fw, <4 x i32> <i32 0, i32 1, i32 2, i32 5> ; 2 uses
  %36 = fsub <4 x float> %35, %22
  %37 = fmul <4 x float> %i.gd, %i.gg
  %38 = shufflevector <4 x float> %i.fx, <4 x float> %35, <4 x i32> <i32 0, i32 4, i32 2, i32 3>
  %i.gh = fsub <4 x float> %38, %21               ; 2 uses
  %i.gi = fmul <4 x float> %i.gh, %i.gh           ; 2 uses
  %i.gj = fadd <4 x float> %i.gi, %37             ; 2 uses
  %39 = shufflevector <4 x float> %i.gi, <4 x float> %i.gj, <4 x i32> <i32 1, i32 4, i32 poison, i32 poison>
  %i.gk = shufflevector <2 x float> %i.fu, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.gl = shufflevector <4 x float> %39, <4 x float> %i.gk, <4 x i32> <i32 0, i32 1, i32 4, i32 5>
  ...
  %i.gv = fdiv <4 x float> %36, %i.gn             ; 2 uses
  ...
  %40 = shufflevector <2 x float> %i.ha, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 0, i32 0>
  %i.hb = shufflevector <2 x float> %i.gs, <2 x float> poison, <4 x i32> <i32 poison, i32 poison, i32 0, i32 1>
  %i.hc = insertelement <4 x float> %i.hb, float %i.gy, i64 0
  %i.hd = insertelement <4 x float> %i.hc, float %i.gx, i64 1 ; 2 uses
  %i.he = call <4 x float> @llvm.fma.v4f32(<4 x float> %40, <4 x float> %i.gv, <4 x float> %i.hd)
  %i.hf = insertelement <2 x float> %.sroa.031.0.copyload, float %.sroa.232.0.copyload, i64 0
  %41 = shufflevector <2 x float> %i.hf, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 0, i32 0>
  ...
  %i.hj = call <4 x float> @llvm.fma.v4f32(<4 x float> %41, <4 x float> %i.go, <4 x float> %i.hi)
