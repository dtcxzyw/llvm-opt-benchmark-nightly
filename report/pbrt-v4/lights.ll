...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %.sroa.5.8.vec.extract.i.i = extractelement <2 x float> %.sroa.4.0.copyload.i, i64 0 ; 2 uses
...
._crit_edge:                                      ; preds = %bb.b, %.._crit_edge_crit_edge
  ...
  %.sroa.4.0.copyload.i22 = load <2 x float>, ptr %.sroa.4.0..sroa_idx.i21, align 4
  %.sroa.5.8.vec.extract.i.i23 = extractelement <2 x float> %.sroa.4.0.copyload.i22, i64 0 ; 2 uses
  %i.ar = tail call noundef float @_ZNK4pbrt15SummedAreaTable6LookupEff(ptr noundef nonnull align 8 dereferenceable(32) %.pre, float noundef %.sroa.5.8.vec.extract.i.i23, float noundef %.0.lcssa)
  ...
  %i.au = tail call noundef float @_ZNK4pbrt15SummedAreaTable6LookupEff(ptr noundef nonnull align 8 dereferenceable(32) %.pre, float noundef %.sroa.5.8.vec.extract.i.i23, float noundef %.sroa.0.4.vec.extract.i.i25)
  ...
  %.sroa.4.0.copyload.i29 = load <2 x float>, ptr %.sroa.4.0..sroa_idx.i21, align 4
  %.sroa.5.8.vec.extract.i.i30 = extractelement <2 x float> %.sroa.4.0.copyload.i29, i64 0 ; 2 uses
  ...
  %i.bd = tail call noundef float @_ZNK4pbrt15SummedAreaTable6LookupEff(ptr noundef nonnull align 8 dereferenceable(32) %.pre, float noundef %.sroa.5.8.vec.extract.i.i30, float noundef %.018.lcssa)
  ...
  %i.bk = tail call noundef float @_ZNK4pbrt15SummedAreaTable6LookupEff(ptr noundef nonnull align 8 dereferenceable(32) %.pre, float noundef %.sroa.5.8.vec.extract.i.i30, float noundef %.sroa.0.4.vec.extract.i.i32)
  %i.bl = fpext float %i.bk to double
  ...
  %.sroa.4.0.copyload.i36 = load <2 x float>, ptr %.sroa.4.0..sroa_idx.i21, align 4
  %.sroa.5.8.vec.extract.i.i37 = extractelement <2 x float> %.sroa.4.0.copyload.i36, i64 0 ; 2 uses
  %i.by = tail call noundef float @_ZNK4pbrt15SummedAreaTable6LookupEff(ptr noundef nonnull align 8 dereferenceable(32) %.pre, float noundef %.sroa.5.8.vec.extract.i.i37, float noundef %.0.lcssa)
  ...
  %i.ci = tail call noundef float @_ZNK4pbrt15SummedAreaTable6LookupEff(ptr noundef nonnull align 8 dereferenceable(32) %.pre, float noundef %.sroa.5.8.vec.extract.i.i37, float noundef %.sroa.0.4.vec.extract.i.i39)
