...
bb.e:                                             ; preds = %.preheader358, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175
  ...
  %.promoted389 = phi ptr [ %9, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175 ], [ %.promoted385, %.preheader358 ] ; 9 uses
  %.0134 = phi i64 [ %.5139, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175 ], [ 0, %.preheader358 ] ; 5 uses
  %.0128 = phi i32 [ %.7, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175 ], [ 0, %.preheader358 ] ; 6 uses
...
bb.l:                                             ; preds = %bb.k
  ...
  br label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175.sink.split, !llvm.loop !60
...
_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175: ; preds = %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175.sink.split, %switch.early.test353, %bb.ad, %bb.ac, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit224, %.split299
  %9 = phi ptr [ %i.dv, %switch.early.test353 ], [ %i.dv, %bb.ac ], [ %i.dv, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit224 ], [ %i.dq, %.split299 ], [ %i.dv, %bb.ad ], [ %.sink, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175.sink.split ] ; 2 uses
  %.5139 = phi i64 [ %i.bb, %switch.early.test353 ], [ %i.bb, %bb.ac ], [ %i.bb, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit224 ], [ %i.bb, %.split299 ], [ %i.bb, %bb.ad ], [ %.5139.ph511, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175.sink.split ]
  %.7 = phi i32 [ %spec.select148, %switch.early.test353 ], [ %spec.select148, %bb.ac ], [ %spec.select148, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit224 ], [ %spec.select148, %.split299 ], [ %spec.select148, %bb.ad ], [ %.7.ph512, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175.sink.split ]
  %.5 = phi i8 [ %.0123, %switch.early.test353 ], [ %.0123, %bb.ac ], [ %.0123, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit224 ], [ %.0123, %.split299 ], [ %.0123, %bb.ad ], [ %.5.ph, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175.sink.split ]
  %.pre = load i8, ptr %9, align 1, !tbaa !24
  br label %bb.e
