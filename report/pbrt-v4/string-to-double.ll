...
.split110:                                        ; preds = %bb.r
  ...
  store ptr %i.ck, ptr %i.a, align 8, !tbaa !41
  %i.cl = icmp eq ptr %i.ck, %1
  br i1 %i.cl, label %_ZN17double_conversionL7isDigitEii.exit82, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit64.threadthread-pre-split

bb.s:                                             ; preds = %bb.r
  %i.cm = add nsw i16 %i.cj, -97
  %or.cond21.i.i54 = icmp ult i16 %i.cm, 6
  %i.cn = getelementptr inbounds nuw i8, ptr %i.ci, i64 2 ; 7 uses
  store ptr %i.cn, ptr %i.a, align 8, !tbaa !41
...
_ZN17double_conversionL7isDigitEii.exit.thread.i58: ; preds = %bb.s
  br i1 %i.co, label %_ZN17double_conversionL7isDigitEii.exit82, label %bb.t

bb.t:                                             ; preds = %_ZN17double_conversionL7isDigitEii.exit.thread.i58
  %i.cp = getelementptr inbounds nuw i8, ptr %i.ci, i64 4 ; 4 uses
  %i.cq = icmp eq ptr %i.cp, %1
  br i1 %i.cq, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit64.threadthread-pre-split, label %bb.u

bb.u:                                             ; preds = %bb.t
  %i.cr = load i16, ptr %i.cn, align 2, !tbaa !42 ; 2 uses
  %i.cs = icmp eq i16 %i.cr, %2
  br i1 %i.cs, label %bb.v, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit64.thread

bb.v:                                             ; preds = %bb.u
  %i.ct = load i16, ptr %i.cp, align 2, !tbaa !42
  %.fr181 = freeze i16 %i.ct                      ; 2 uses
  %i.cu = add i16 %.fr181, -48
  %or.cond19.i26.i60 = icmp ult i16 %i.cu, 10
  br i1 %or.cond19.i26.i60, label %_ZN17double_conversionL7isDigitEii.exit30.thread.i63, label %switch.early.test134

switch.early.test134:                             ; preds = %bb.v
  switch i16 %.fr181, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit64.threadthread-pre-split [
...
_ZN17double_conversionL7isDigitEii.exit30.thread.i63: ; preds = %switch.early.test134, %switch.early.test134, %switch.early.test134, %switch.early.test134, %switch.early.test134, %switch.early.test134, %switch.early.test134, %switch.early.test134, %switch.early.test134, %switch.early.test134, %switch.early.test134, %switch.early.test134, %bb.v
  store ptr %i.cp, ptr %i.a, align 8, !tbaa !41
  br label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit64.threadthread-pre-split

_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit64: ; preds = %bb.s
  br i1 %i.co, label %_ZN17double_conversionL7isDigitEii.exit82, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit64.threadthread-pre-split

_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit64.threadthread-pre-split: ; preds = %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit64, %.split110, %bb.t, %_ZN17double_conversionL7isDigitEii.exit30.thread.i63, %switch.early.test134
  %.ph = phi ptr [ %i.cn, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit64 ], [ %i.ck, %.split110 ], [ %i.cn, %bb.t ], [ %i.cp, %_ZN17double_conversionL7isDigitEii.exit30.thread.i63 ], [ %i.cn, %switch.early.test134 ] ; 2 uses
  %.pr = load i16, ptr %.ph, align 2, !tbaa !42
  br label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit64.thread

_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit64.thread: ; preds = %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit64.threadthread-pre-split, %bb.u
  %i.cv = phi i16 [ %.pr, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit64.threadthread-pre-split ], [ %i.cr, %bb.u ]
  %i.cw = phi ptr [ %.ph, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit64.threadthread-pre-split ], [ %i.cn, %bb.u ] ; 2 uses
  switch i16 %i.cv, label %bb.x [
    i16 43, label %bb.w
    i16 45, label %bb.w
  ]

bb.w:                                             ; preds = %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit64.thread, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit64.thread
  %i.cx = getelementptr inbounds nuw i8, ptr %i.cw, i64 2 ; 3 uses
  store ptr %i.cx, ptr %i.a, align 8, !tbaa !41
  %i.cy = icmp eq ptr %i.cx, %1
  br i1 %i.cy, label %_ZN17double_conversionL7isDigitEii.exit82, label %bb.x

bb.x:                                             ; preds = %bb.w, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit64.thread
  %i.cz = phi ptr [ %i.cx, %bb.w ], [ %i.cw, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit64.thread ]
  %i.da = load i16, ptr %i.cz, align 2, !tbaa !42
  %i.db = add i16 %i.da, -48
  %or.cond19.i79 = icmp ult i16 %i.db, 10
  br i1 %or.cond19.i79, label %bb.y, label %_ZN17double_conversionL7isDigitEii.exit82

bb.y:                                             ; preds = %bb.x
  %i.dc = call fastcc noundef zeroext i1 @_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_(ptr noundef %i.a, i16 noundef zeroext %2, i32 noundef 16, ptr %1)
  br i1 %i.dc, label %_ZN17double_conversionL7isDigitEii.exit82, label %.preheader

.preheader:                                       ; preds = %bb.y
  %.promoted170 = load ptr, ptr %i.a, align 8, !tbaa !41 ; 4 uses
  %i.dd = load i16, ptr %.promoted170, align 2, !tbaa !42
  %i.de = add i16 %i.dd, -48
  %or.cond19.i84172 = icmp ult i16 %i.de, 10
  br i1 %or.cond19.i84172, label %.lr.ph, label %_ZN17double_conversionL7isDigitEii.exit87
...
.split113.us:                                     ; preds = %.lr.ph, %.backedge.us
  ...
  br i1 %i.dh, label %_ZN17double_conversionL7isDigitEii.exit82, label %.backedge.us

.backedge.us:                                     ; preds = %.split113.us
  %i.di = load i16, ptr %i.dg, align 2, !tbaa !42
  %i.dj = add i16 %i.di, -48
  %or.cond19.i84.us = icmp ult i16 %i.dj, 10
  br i1 %or.cond19.i84.us, label %.split113.us, label %_ZN17double_conversionL7isDigitEii.exit87, !llvm.loop !74
...
.lr.ph.split:                                     ; preds = %.lr.ph, %.backedge
  ...
  br i1 %i.dm, label %_ZN17double_conversionL7isDigitEii.exit82, label %bb.z

.backedge:                                        ; preds = %bb.ab, %switch.early.test135, %switch.early.test135, %switch.early.test135, %switch.early.test135, %switch.early.test135, %switch.early.test135, %switch.early.test135, %switch.early.test135, %switch.early.test135, %switch.early.test135, %switch.early.test135, %switch.early.test135, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit100
  %i.dn = phi ptr [ %i.dl, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit100 ], [ %i.dq, %bb.ab ], [ %i.dq, %switch.early.test135 ], [ %i.dq, %switch.early.test135 ], [ %i.dq, %switch.early.test135 ], [ %i.dq, %switch.early.test135 ], [ %i.dq, %switch.early.test135 ], [ %i.dq, %switch.early.test135 ], [ %i.dq, %switch.early.test135 ], [ %i.dq, %switch.early.test135 ], [ %i.dq, %switch.early.test135 ], [ %i.dq, %switch.early.test135 ], [ %i.dq, %switch.early.test135 ], [ %i.dq, %switch.early.test135 ] ; 3 uses
  %i.do = load i16, ptr %i.dn, align 2, !tbaa !42
  %i.dp = add i16 %i.do, -48
  %or.cond19.i84 = icmp ult i16 %i.dp, 10
  br i1 %or.cond19.i84, label %.lr.ph.split, label %_ZN17double_conversionL7isDigitEii.exit87, !llvm.loop !74

bb.z:                                             ; preds = %.lr.ph.split
  %i.dq = getelementptr inbounds nuw i8, ptr %i.dk, i64 4 ; 15 uses
  %i.dr = icmp eq ptr %i.dq, %1
  br i1 %i.dr, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit100, label %bb.aa

bb.aa:                                            ; preds = %bb.z
  %i.ds = load i16, ptr %i.dl, align 2, !tbaa !42
  %i.dt = icmp eq i16 %i.ds, %2
  br i1 %i.dt, label %bb.ab, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit100
...
_ZN17double_conversionL7isDigitEii.exit.thread.i: ; preds = %.lr.ph, %.backedge361
  ...
  store ptr %i.l, ptr %0, align 8, !tbaa !41
  %i.m = icmp eq ptr %i.l, %1
  br i1 %i.m, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit.thread, label %12

.backedge361thread-pre-split:                     ; preds = %_ZN17double_conversionL7isDigitEii.exit30.thread.i, %switch.early.test, %12
  %.ph = phi ptr [ %i.l, %12 ], [ %i.l, %switch.early.test ], [ %13, %_ZN17double_conversionL7isDigitEii.exit30.thread.i ] ; 2 uses
  %.pr = load i16, ptr %.ph, align 2, !tbaa !42
...
.backedge361:                                     ; preds = %.backedge361thread-pre-split, %bb.b
  ...
  br i1 %i.n, label %_ZN17double_conversionL7isDigitEii.exit.thread.i, label %.preheader359, !llvm.loop !75

12:                                               ; preds = %_ZN17double_conversionL7isDigitEii.exit.thread.i
  %13 = getelementptr inbounds nuw i8, ptr %i.k, i64 4 ; 4 uses
  %14 = icmp eq ptr %13, %1
  br i1 %14, label %.backedge361thread-pre-split, label %bb.b

bb.b:                                             ; preds = %12
  %i.o = load i16, ptr %i.l, align 2, !tbaa !42   ; 2 uses
  %i.p = icmp eq i16 %i.o, %3
  br i1 %i.p, label %bb.c, label %.backedge361

bb.c:                                             ; preds = %bb.b
  %i.q = load i16, ptr %13, align 2, !tbaa !42
...
_ZN17double_conversionL7isDigitEii.exit30.thread.i: ; preds = %switch.early.test, %switch.early.test, %switch.early.test, %switch.early.test, %switch.early.test, %switch.early.test, %switch.early.test, %switch.early.test, %switch.early.test, %switch.early.test, %switch.early.test, %switch.early.test, %bb.c
...
bb.d:                                             ; preds = %.preheader359, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit177
  %i.t = phi i16 [ %.pre, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit177 ], [ %9, %.preheader359 ]
  %.promoted392 = phi ptr [ %i.cz, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit177 ], [ %.promoted388, %.preheader359 ] ; 9 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  br i1 %.not.i, label %bb.f, label %_ZN17double_conversionL24IsCharacterDigitForRadixEiic.exit

_ZN17double_conversionL24IsCharacterDigitForRadixEiic.exit: ; preds = %bb.e
  %i.y = icmp ult i16 %i.u, 103
  br i1 %i.y, label %bb.j, label %_ZN17double_conversionL24IsCharacterDigitForRadixEiic.exit164.thread284

bb.f:                                             ; preds = %bb.e
  %i.z = add nsw i16 %i.u, -65
  %or.cond327 = icmp ult i16 %i.z, 6
  br i1 %or.cond327, label %bb.j, label %_ZN17double_conversionL24IsCharacterDigitForRadixEiic.exit164.thread284

_ZN17double_conversionL24IsCharacterDigitForRadixEiic.exit164.thread284: ; preds = %bb.f, %_ZN17double_conversionL24IsCharacterDigitForRadixEiic.exit
  br i1 %4, label %bb.g, label %.critedge

bb.g:                                             ; preds = %_ZN17double_conversionL24IsCharacterDigitForRadixEiic.exit164.thread284
...
.critedge:                                        ; preds = %bb.g, %_ZN17double_conversionL24IsCharacterDigitForRadixEiic.exit164.thread284
...
.lr.ph.i:                                         ; preds = %.critedge, %bb.i
  ...
  %i.ac = load i16, ptr %i.ab, align 2, !tbaa !42
  %i.ad = zext i16 %i.ac to i32
  %i.ae = tail call fastcc noundef zeroext i1 @_ZN17double_conversionL12isWhitespaceEi(i32 noundef %i.ad)
  br i1 %i.ae, label %bb.i, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit177.thread313

bb.i:                                             ; preds = %.lr.ph.i
  %i.af = getelementptr inbounds nuw i8, ptr %i.ab, i64 2 ; 4 uses
  store ptr %i.af, ptr %0, align 8, !tbaa !41
...
bb.j:                                             ; preds = %bb.f, %_ZN17double_conversionL24IsCharacterDigitForRadixEiic.exit, %bb.d
  %.sink.a = phi i64 [ -87, %_ZN17double_conversionL24IsCharacterDigitForRadixEiic.exit ], [ -48, %bb.d ], [ -55, %bb.f ]
...
.lr.ph391:                                        ; preds = %.preheader, %.lr.ph391
  ...
  br i1 %i.aq, label %.lr.ph391, label %._crit_edge, !llvm.loop !77
...
bb.k:                                             ; preds = %_ZN17double_conversionL7isDigitEii.exit.thread, %._crit_edge
  %.fr402 = phi i16 [ %i.u, %._crit_edge ], [ %.fr404, %_ZN17double_conversionL7isDigitEii.exit.thread ] ; 2 uses
  %i.ax = phi ptr [ %.promoted392, %._crit_edge ], [ %i.bp, %_ZN17double_conversionL7isDigitEii.exit.thread ] ; 4 uses
  %.2130 = phi i32 [ %i.aw, %._crit_edge ], [ %spec.select151, %_ZN17double_conversionL7isDigitEii.exit.thread ] ; 3 uses
...
.split291:                                        ; preds = %bb.k
  ...
  store ptr %i.ay, ptr %0, align 8, !tbaa !41
  %i.az = icmp eq ptr %i.ay, %1
  br i1 %i.az, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit190.thread289, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit190.thread
...
_ZN17double_conversionL7isDigitEii.exit.thread.i184: ; preds = %switch.early.test351, %switch.early.test351, %switch.early.test351, %switch.early.test351, %switch.early.test351, %switch.early.test351, %switch.early.test351, %switch.early.test351, %switch.early.test351, %switch.early.test351, %switch.early.test351, %switch.early.test351, %bb.l
  %i.ba = getelementptr inbounds nuw i8, ptr %i.ax, i64 2 ; 7 uses
  store ptr %i.ba, ptr %0, align 8, !tbaa !41
  %i.bb = icmp eq ptr %i.ba, %1
  br i1 %i.bb, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit190.thread289, label %bb.m

bb.m:                                             ; preds = %_ZN17double_conversionL7isDigitEii.exit.thread.i184
  %i.bc = getelementptr inbounds nuw i8, ptr %i.ax, i64 4 ; 4 uses
  %i.bd = icmp eq ptr %i.bc, %1
  br i1 %i.bd, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit190.thread, label %bb.n

bb.n:                                             ; preds = %bb.m
  %i.be = load i16, ptr %i.ba, align 2, !tbaa !42
  %i.bf = icmp eq i16 %i.be, %3
  br i1 %i.bf, label %bb.o, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit190.thread

bb.o:                                             ; preds = %bb.n
  %i.bg = load i16, ptr %i.bc, align 2, !tbaa !42
...
_ZN17double_conversionL7isDigitEii.exit30.thread.i189: ; preds = %switch.early.test352, %switch.early.test352, %switch.early.test352, %switch.early.test352, %switch.early.test352, %switch.early.test352, %switch.early.test352, %switch.early.test352, %switch.early.test352, %switch.early.test352, %switch.early.test352, %switch.early.test352, %bb.o
  store ptr %i.bc, ptr %0, align 8, !tbaa !41
...
_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit190: ; preds = %switch.early.test351
  ...
  store ptr %i.bi, ptr %0, align 8, !tbaa !41
  %i.bj = icmp eq ptr %i.bi, %1
  br i1 %i.bj, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit190.thread289, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit190.thread

_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit190.thread: ; preds = %switch.early.test352, %bb.n, %_ZN17double_conversionL7isDigitEii.exit30.thread.i189, %bb.m, %.split291, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit190
  %i.bk = phi ptr [ %i.ba, %switch.early.test352 ], [ %i.ba, %bb.n ], [ %i.bc, %_ZN17double_conversionL7isDigitEii.exit30.thread.i189 ], [ %i.ba, %bb.m ], [ %i.ay, %.split291 ], [ %i.bi, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit190 ] ; 4 uses
  br i1 %4, label %bb.p, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit203thread-pre-split

bb.p:                                             ; preds = %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit190.thread
  %i.bl = load i16, ptr %i.bk, align 2, !tbaa !42 ; 2 uses
  %i.bm = icmp eq i16 %i.bl, 46
  br i1 %i.bm, label %bb.q, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit203
...
_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit203thread-pre-split: ; preds = %bb.q, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit190.thread
  %.ph483 = phi ptr [ %i.bk, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit190.thread ], [ %i.bn, %bb.q ] ; 2 uses
  %.2125.ph = phi i8 [ %.1124, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit190.thread ], [ 1, %bb.q ]
  %.pr484 = load i16, ptr %.ph483, align 2, !tbaa !42
  br label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit203

_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit203: ; preds = %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit203thread-pre-split, %bb.p
  %i.bo = phi i16 [ %.pr484, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit203thread-pre-split ], [ %i.bl, %bb.p ]
  %i.bp = phi ptr [ %.ph483, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit203thread-pre-split ], [ %i.bk, %bb.p ] ; 2 uses
  %.2125 = phi i8 [ %.2125.ph, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit203thread-pre-split ], [ %.1124, %bb.p ] ; 2 uses
  %.fr404 = freeze i16 %i.bo                      ; 4 uses
  %i.bq = add i16 %.fr404, -48
  %or.cond19.i = icmp ult i16 %i.bq, 10
end_hunk_0
begin_hunk_1_@_ZN17double_conversionL17RadixStringToIeeeILi4EPKtEEdPT0_S3_btbbdbPb:bb.a
  br i1 %i.co, label %_ZN17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S3_.exit.thread, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit177
...
bb.x:                                             ; preds = %bb.w
  ...
  store ptr %i.cr, ptr %0, align 8, !tbaa !41
...
_ZN17double_conversionL7isDigitEii.exit.thread.i220: ; preds = %bb.x
  br i1 %i.cs, label %_ZN17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S3_.exit.thread, label %bb.y

bb.y:                                             ; preds = %_ZN17double_conversionL7isDigitEii.exit.thread.i220
  %i.ct = getelementptr inbounds nuw i8, ptr %.promoted392, i64 4 ; 15 uses
  %i.cu = icmp eq ptr %i.ct, %1
  br i1 %i.cu, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit177, label %bb.z

bb.z:                                             ; preds = %bb.y
  %i.cv = load i16, ptr %i.cr, align 2, !tbaa !42
  %i.cw = icmp eq i16 %i.cv, %3
  br i1 %i.cw, label %bb.aa, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit177

bb.aa:                                            ; preds = %bb.z
  %i.cx = load i16, ptr %i.ct, align 2, !tbaa !42
...
_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit226: ; preds = %bb.x
  br i1 %i.cs, label %_ZN17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S3_.exit.thread, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit177

_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit177.sink.split: ; preds = %bb.aa, %switch.early.test354, %switch.early.test354, %switch.early.test354, %switch.early.test354, %switch.early.test354, %switch.early.test354, %switch.early.test354, %switch.early.test354, %switch.early.test354, %switch.early.test354, %switch.early.test354, %switch.early.test354, %bb.h
  ...
  store ptr %.sink528, ptr %0, align 8, !tbaa !41
  br label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit177

_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit177: ; preds = %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit177.sink.split, %switch.early.test354, %bb.z, %bb.y, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit226, %.split301
  %i.cz = phi ptr [ %i.cr, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit226 ], [ %i.cr, %switch.early.test354 ], [ %i.cr, %bb.z ], [ %i.cn, %.split301 ], [ %i.cr, %bb.y ], [ %.sink528, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit177.sink.split ] ; 2 uses
  %.5139 = phi i64 [ %i.ak, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit226 ], [ %i.ak, %switch.early.test354 ], [ %i.ak, %bb.z ], [ %i.ak, %.split301 ], [ %i.ak, %bb.y ], [ %.5139.ph526, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit177.sink.split ]
  %.7 = phi i32 [ %spec.select150, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit226 ], [ %spec.select150, %switch.early.test354 ], [ %spec.select150, %bb.z ], [ %spec.select150, %.split301 ], [ %spec.select150, %bb.y ], [ %.7.ph527, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit177.sink.split ]
  %.5 = phi i8 [ %.0123, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit226 ], [ %.0123, %switch.early.test354 ], [ %.0123, %bb.z ], [ %.0123, %.split301 ], [ %.0123, %bb.y ], [ %.5.ph, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit177.sink.split ]
  %.pre = load i16, ptr %i.cz, align 2, !tbaa !42
  br label %bb.d
...
_ZN17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S3_.exit.thread: ; preds = %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit226, %.split301, %_ZN17double_conversionL7isDigitEii.exit.thread.i220, %bb.i, %.critedge, %bb.v
  %i.da = phi ptr [ %.promoted392, %.critedge ], [ %i.af, %bb.i ], [ %i.ca, %bb.v ], [ %i.cn, %.split301 ], [ %i.cr, %_ZN17double_conversionL7isDigitEii.exit.thread.i220 ], [ %i.cr, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit226 ]
  %.5139.ph = phi i64 [ %.0134, %.critedge ], [ %.0134, %bb.i ], [ %.2136, %bb.v ], [ %i.ak, %_ZN17double_conversionL7isDigitEii.exit.thread.i220 ], [ %i.ak, %.split301 ], [ %i.ak, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit226 ] ; 2 uses
  %.7.ph = phi i32 [ %.0128, %.critedge ], [ %.0128, %bb.i ], [ %.4132, %bb.v ], [ %spec.select150, %_ZN17double_conversionL7isDigitEii.exit.thread.i220 ], [ %spec.select150, %.split301 ], [ %spec.select150, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit226 ] ; 2 uses
  store i8 0, ptr %8, align 1, !tbaa !38
  br i1 %4, label %bb.ab, label %bb.al

bb.ab:                                            ; preds = %.thread319, %_ZN17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S3_.exit.thread
  %i.db = phi ptr [ %.promoted392, %.thread319 ], [ %i.da, %_ZN17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S3_.exit.thread ] ; 5 uses
...
bb.ad:                                            ; preds = %bb.ab
  %i.dd = load i16, ptr %i.db, align 2, !tbaa !42
...
_ZN17double_conversionL7isDigitEii.exit.thread.i233: ; preds = %switch.early.test355, %switch.early.test355, %switch.early.test355, %switch.early.test355, %switch.early.test355, %switch.early.test355, %switch.early.test355, %switch.early.test355, %switch.early.test355, %switch.early.test355, %switch.early.test355, %switch.early.test355, %bb.ad
  ...
  store ptr %i.dg, ptr %0, align 8, !tbaa !41
  %i.dh = icmp eq ptr %i.dg, %1
  br i1 %i.dh, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit239thread-pre-split, label %bb.ae

bb.ae:                                            ; preds = %_ZN17double_conversionL7isDigitEii.exit.thread.i233
  %i.di = getelementptr inbounds nuw i8, ptr %i.db, i64 4 ; 15 uses
  %i.dj = icmp eq ptr %i.di, %1
  br i1 %i.dj, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit239thread-pre-split, label %bb.af

bb.af:                                            ; preds = %bb.ae
  %i.dk = load i16, ptr %i.dg, align 2, !tbaa !42 ; 2 uses
  %i.dl = icmp eq i16 %i.dk, %3
  br i1 %i.dl, label %bb.ag, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit239

bb.ag:                                            ; preds = %bb.af
  %i.dm = load i16, ptr %i.di, align 2, !tbaa !42
...
_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit239thread-pre-split.sink.split: ; preds = %bb.ag, %switch.early.test356, %switch.early.test356, %switch.early.test356, %switch.early.test356, %switch.early.test356, %switch.early.test356, %switch.early.test356, %switch.early.test356, %switch.early.test356, %switch.early.test356, %switch.early.test356, %switch.early.test356, %bb.ac, %_ZN17double_conversionL7isDigitEii.exit.thread1.i231
  %.sink529 = phi ptr [ %i.dc, %bb.ac ], [ %i.df, %_ZN17double_conversionL7isDigitEii.exit.thread1.i231 ], [ %i.di, %switch.early.test356 ], [ %i.di, %switch.early.test356 ], [ %i.di, %switch.early.test356 ], [ %i.di, %switch.early.test356 ], [ %i.di, %switch.early.test356 ], [ %i.di, %switch.early.test356 ], [ %i.di, %switch.early.test356 ], [ %i.di, %switch.early.test356 ], [ %i.di, %switch.early.test356 ], [ %i.di, %switch.early.test356 ], [ %i.di, %switch.early.test356 ], [ %i.di, %switch.early.test356 ], [ %i.di, %bb.ag ] ; 2 uses
  store ptr %.sink529, ptr %0, align 8, !tbaa !41
  br label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit239thread-pre-split

_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit239thread-pre-split: ; preds = %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit239thread-pre-split.sink.split, %bb.ae, %_ZN17double_conversionL7isDigitEii.exit.thread.i233, %switch.early.test356
  %.ph485 = phi ptr [ %i.dg, %switch.early.test356 ], [ %i.dg, %bb.ae ], [ %i.dg, %_ZN17double_conversionL7isDigitEii.exit.thread.i233 ], [ %.sink529, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit239thread-pre-split.sink.split ] ; 2 uses
  %.pr486 = load i16, ptr %.ph485, align 2, !tbaa !42
  br label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit239

_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit239: ; preds = %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit239thread-pre-split, %bb.af
  %i.do = phi i16 [ %.pr486, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit239thread-pre-split ], [ %i.dk, %bb.af ]
  %i.dp = phi ptr [ %.ph485, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit239thread-pre-split ], [ %i.dg, %bb.af ] ; 2 uses
  switch i16 %i.do, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit252 [
    i16 43, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit252.sink.split
    i16 45, label %bb.ah
  ]

bb.ah:                                            ; preds = %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit239
  br label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit252.sink.split

_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit252.sink.split: ; preds = %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit239, %bb.ah
  %.0115.ph = phi i1 [ true, %bb.ah ], [ false, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit239 ]
  %i.dq = getelementptr inbounds nuw i8, ptr %i.dp, i64 2 ; 2 uses
  store ptr %i.dq, ptr %0, align 8, !tbaa !41
...
_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit252: ; preds = %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit252.sink.split, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit239
  %.promoted393 = phi ptr [ %i.dp, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit239 ], [ %i.dq, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit252.sink.split ] ; 2 uses
  ...
  %i.dr = load i16, ptr %.promoted393, align 2, !tbaa !42 ; 2 uses
...
.lr.ph396:                                        ; preds = %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit252, %.backedge
  %i.dt = phi i16 [ %i.ee, %.backedge ], [ %i.dr, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit252 ]
  %.0111395 = phi i32 [ %.1112, %.backedge ], [ 0, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit252 ] ; 3 uses
  %i.du = phi ptr [ %i.ed, %.backedge ], [ %.promoted393, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit252 ] ; 2 uses
  ...
  store ptr %i.eb, ptr %0, align 8, !tbaa !41
  %i.ec = icmp eq ptr %i.eb, %1                   ; 2 uses
  br i1 %i.i, label %.split326, label %_ZN17double_conversionL7isDigitEii.exit.thread.i273

.split326:                                        ; preds = %.lr.ph396
  br i1 %i.ec, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit279.thread, label %.backedge

.backedge:                                        ; preds = %bb.aj, %bb.ai, %switch.early.test357, %.split326, %_ZN17double_conversionL7isDigitEii.exit30.thread.i278.a
  %i.ed = phi ptr [ %i.eb, %.split326 ], [ %i.eb, %bb.aj ], [ %i.eg, %_ZN17double_conversionL7isDigitEii.exit30.thread.i278.a ], [ %i.eb, %switch.early.test357 ], [ %i.eb, %bb.ai ] ; 2 uses
  %i.ee = load i16, ptr %i.ed, align 2, !tbaa !42 ; 2 uses
  %i.ef = add i16 %i.ee, -48
  %or.cond.i266 = icmp ult i16 %i.ef, 10
  br i1 %or.cond.i266, label %.lr.ph396, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit279.thread, !llvm.loop !79

_ZN17double_conversionL7isDigitEii.exit.thread.i273: ; preds = %.lr.ph396
  br i1 %i.ec, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit279.thread, label %bb.ai

bb.ai:                                            ; preds = %_ZN17double_conversionL7isDigitEii.exit.thread.i273
  %i.eg = getelementptr inbounds nuw i8, ptr %i.du, i64 4 ; 4 uses
  %i.eh = icmp eq ptr %i.eg, %1
  br i1 %i.eh, label %.backedge, label %bb.aj

bb.aj:                                            ; preds = %bb.ai
  %i.ei = load i16, ptr %i.eb, align 2, !tbaa !42
  %i.ej = icmp eq i16 %i.ei, %3
  br i1 %i.ej, label %bb.ak, label %.backedge

bb.ak:                                            ; preds = %bb.aj
  %i.ek = load i16, ptr %i.eg, align 2, !tbaa !42
  %.fr408 = freeze i16 %i.ek                      ; 2 uses
  %i.el = add i16 %.fr408, -48
  %or.cond19.i26.i275 = icmp ult i16 %i.el, 10
  br i1 %or.cond19.i26.i275, label %_ZN17double_conversionL7isDigitEii.exit30.thread.i278.a, label %switch.early.test357

switch.early.test357:                             ; preds = %bb.ak
  switch i16 %.fr408, label %.backedge [
    i16 102, label %_ZN17double_conversionL7isDigitEii.exit30.thread.i278.a
    i16 101, label %_ZN17double_conversionL7isDigitEii.exit30.thread.i278.a
    i16 100, label %_ZN17double_conversionL7isDigitEii.exit30.thread.i278.a
    i16 99, label %_ZN17double_conversionL7isDigitEii.exit30.thread.i278.a
    i16 98, label %_ZN17double_conversionL7isDigitEii.exit30.thread.i278.a
    i16 97, label %_ZN17double_conversionL7isDigitEii.exit30.thread.i278.a
    i16 70, label %_ZN17double_conversionL7isDigitEii.exit30.thread.i278.a
    i16 69, label %_ZN17double_conversionL7isDigitEii.exit30.thread.i278.a
    i16 68, label %_ZN17double_conversionL7isDigitEii.exit30.thread.i278.a
    i16 67, label %_ZN17double_conversionL7isDigitEii.exit30.thread.i278.a
    i16 66, label %_ZN17double_conversionL7isDigitEii.exit30.thread.i278.a
    i16 65, label %_ZN17double_conversionL7isDigitEii.exit30.thread.i278.a
  ]

_ZN17double_conversionL7isDigitEii.exit30.thread.i278.a: ; preds = %switch.early.test357, %switch.early.test357, %switch.early.test357, %switch.early.test357, %switch.early.test357, %switch.early.test357, %switch.early.test357, %switch.early.test357, %switch.early.test357, %switch.early.test357, %switch.early.test357, %switch.early.test357, %bb.ak
  store ptr %i.eg, ptr %0, align 8, !tbaa !41
  br label %.backedge

_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit279.thread: ; preds = %.backedge, %.split326, %_ZN17double_conversionL7isDigitEii.exit.thread.i273, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit252
  %.2113 = phi i32 [ 0, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit252 ], [ %.1112, %_ZN17double_conversionL7isDigitEii.exit.thread.i273 ], [ %.1112, %.split326 ], [ %.1112, %.backedge ] ; 2 uses
  %i.em = sub nsw i32 0, %.2113
  %spec.select153 = select i1 %.0115, i32 %i.em, i32 %.2113
  %i.en = add nsw i32 %spec.select153, %.7.ph324
  br label %bb.al

bb.al:                                            ; preds = %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit279.thread, %_ZN17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S3_.exit.thread
  %.5139.ph322 = phi i64 [ %.5139.ph323, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit279.thread ], [ %.5139.ph, %_ZN17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S3_.exit.thread ] ; 6 uses
  %.8 = phi i32 [ %i.en, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit279.thread ], [ %.7.ph, %_ZN17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S3_.exit.thread ] ; 3 uses
...
bb.an:                                            ; preds = %bb.am
  br i1 %i.ep, label %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit177.thread313, label %bb.ao
...
._crit_edge.i.i:                                  ; preds = %.lr.ph.i.i, %bb.aq
  ...
  br i1 %i.ew, label %_ZN17double_conversion6DoubleC2ENS_5DiyFpE.exit, label %bb.ar

bb.ar:                                            ; preds = %._crit_edge.i.i
  %i.ex = icmp slt i32 %.015.lcssa.i.i, -1074
  br i1 %i.ex, label %_ZN17double_conversion6DoubleC2ENS_5DiyFpE.exit, label %.preheader.i.i
...
_ZN17double_conversion6DoubleC2ENS_5DiyFpE.exit:  ; preds = %._crit_edge.i.i, %bb.ar, %._crit_edge26.i.i
...
_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit177.thread313: ; preds = %.lr.ph.i, %.lr.ph.i208, %bb.an, %_ZN17double_conversion6DoubleC2ENS_5DiyFpE.exit, %bb.ap, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit.thread
  %.4 = phi double [ %i.s, %_ZN17double_conversionL7AdvanceIPKtEEbPT_tiRS3_.exit.thread ], [ -0.000000e+00, %bb.an ], [ %i.fq, %_ZN17double_conversion6DoubleC2ENS_5DiyFpE.exit ], [ %i.er, %bb.ap ], [ %6, %.lr.ph.i208 ], [ %6, %.lr.ph.i ]
  ret double %.4
}
...
!19 = !{!"double", !11, i64 0}
!20 = !{!"short", !11, i64 0}
!21 = !{!"_ZTSN17double_conversion23StringToDoubleConverterE", !12, i64 0, !19, i64 8, !19, i64 16, !16, i64 24, !16, i64 32, !20, i64 40}
!22 = !{!21, !12, i64 0}
!23 = !{!21, !19, i64 8}
!24 = !{!11, !11, i64 0}
...
!55 = distinct !{!55, !25}
!56 = distinct !{!56, !25, !43}
!57 = distinct !{!57, !25, !43}
!58 = distinct !{!58, !25}
!59 = distinct !{!59, !25}
!60 = distinct !{!60, !25}
!61 = distinct !{!61, !25}
...
!69 = distinct !{!69, !25}
!70 = distinct !{!70, !25, !43}
!71 = distinct !{!71, !25, !43}
!72 = distinct !{!72, !25, !43}
!73 = distinct !{!73, !25, !43}
!74 = distinct !{!74, !25}
!75 = distinct !{!75, !25}
!76 = distinct !{!76, !25}
!77 = distinct !{!77, !25}
