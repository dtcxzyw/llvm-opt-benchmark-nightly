...
begin_hunk_0_@_ZNK17double_conversion23StringToDoubleConverter12StringToIeeeIPKcEEdT_ibPi:bb.a
  ...
  store i32 %i.cj, ptr %4, align 4, !tbaa !18
  br i1 %.0180, label %.thread, label %bb.w

bb.w:                                             ; preds = %_ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit252
  br label %.thread

bb.x:                                             ; preds = %_ZN17double_conversion12_GLOBAL__N_121ConsumeFirstCharacterEcPKcb.exit._crit_edge, %bb.j
  %.pre549 = phi ptr [ %.pre549.pre, %_ZN17double_conversion12_GLOBAL__N_121ConsumeFirstCharacterEcPKcb.exit._crit_edge ], [ %i.at, %bb.j ] ; 2 uses
...
bb.y:                                             ; preds = %bb.x
  %i.cm = load i8, ptr %.pre549, align 1, !tbaa !24 ; 2 uses
  br i1 %i.p, label %bb.z, label %_ZN17double_conversion12_GLOBAL__N_121ConsumeFirstCharacterEcPKcb.exit256

bb.z:                                             ; preds = %bb.y
  %i.cn = load atomic i8, ptr @_ZGVZN17double_conversion12_GLOBAL__N_17ToLowerEcE5cType acquire, align 8
  %i.co = icmp eq i8 %i.cn, 0
  br i1 %i.co, label %bb.aa, label %_ZN17double_conversion12_GLOBAL__N_17ToLowerEc.exit.i254, !prof !28

bb.aa:                                            ; preds = %bb.z
  %i.cp = tail call i32 @__cxa_guard_acquire(ptr nonnull @_ZGVZN17double_conversion12_GLOBAL__N_17ToLowerEcE5cType) #8
...
bb.ad:                                            ; preds = %bb.ac
  store ptr %i.cr, ptr @_ZZN17double_conversion12_GLOBAL__N_17ToLowerEcE5cType, align 8, !tbaa !30
...
_ZN17double_conversion12_GLOBAL__N_17ToLowerEc.exit.i254: ; preds = %bb.ad, %bb.aa, %bb.z
  %i.ct = load ptr, ptr @_ZZN17double_conversion12_GLOBAL__N_17ToLowerEcE5cType, align 8, !tbaa !30, !nonnull !31, !align !32 ; 2 uses
...
_ZN17double_conversion12_GLOBAL__N_121ConsumeFirstCharacterEcPKcb.exit256: ; preds = %bb.y, %_ZN17double_conversion12_GLOBAL__N_17ToLowerEc.exit.i254
  %.sink.i253 = phi i8 [ %i.cx, %_ZN17double_conversion12_GLOBAL__N_17ToLowerEc.exit.i254 ], [ %i.cm, %bb.y ]
  %i.cy = load i8, ptr %i.cl, align 1, !tbaa !24
  %i.cz = icmp eq i8 %.sink.i253, %i.cy
  br i1 %i.cz, label %bb.af, label %_ZN17double_conversion12_GLOBAL__N_121ConsumeFirstCharacterEcPKcb.exit256._crit_edge
...
_ZN17double_conversion12_GLOBAL__N_121ConsumeFirstCharacterEcPKcb.exit256._crit_edge: ; preds = %_ZN17double_conversion12_GLOBAL__N_121ConsumeFirstCharacterEcPKcb.exit256
  %.pre548 = load ptr, ptr %i.b, align 8, !tbaa !17
  br label %bb.al

bb.af:                                            ; preds = %_ZN17double_conversion12_GLOBAL__N_121ConsumeFirstCharacterEcPKcb.exit256
  %i.da = load ptr, ptr %i.ck, align 8, !tbaa !35
  %i.db = call fastcc noundef zeroext i1 @_ZN17double_conversion12_GLOBAL__N_116ConsumeSubStringIPKcEEbPT_S4_S3_b(ptr noundef %i.b, ptr noundef nonnull %i.h, ptr noundef %i.da, i1 noundef zeroext %i.p)
  br i1 %i.db, label %bb.ah, label %bb.ag

bb.ag:                                            ; preds = %bb.af
  %i.dc = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.dd = load double, ptr %i.dc, align 8, !tbaa !26
  br label %.thread
...
bb.ai:                                            ; preds = %bb.ah
  ...
  %i.dh = load double, ptr %i.dg, align 8, !tbaa !26
  br label %.thread

bb.aj:                                            ; preds = %bb.ah
  %.promoted.i257535 = ptrtoaddr ptr %i.df to i64
  %or.cond402 = select i1 %i.k, i1 true, i1 %.not222
  br i1 %or.cond402, label %_ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit264, label %.lr.ph.i259.preheader

.lr.ph.i259.preheader:                            ; preds = %bb.aj
  %i.di = load i8, ptr %i.df, align 1, !tbaa !24
  %i.dj = sext i8 %i.di to i32
  %i.dk = tail call fastcc noundef zeroext i1 @_ZN17double_conversionL12isWhitespaceEi(i32 noundef %i.dj)
...
.lr.ph442.preheader:                              ; preds = %.lr.ph.i259.preheader
  ...
  br i1 %.not.not.i263683, label %_ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit264, label %.lr.ph.i259.lr.ph, !llvm.loop !0
...
.lr.ph.i259:                                      ; preds = %.lr.ph.i259.lr.ph, %.lr.ph442
  ...
  %i.dp = load i8, ptr %i.do, align 1, !tbaa !24
  %i.dq = sext i8 %i.dp to i32
  %i.dr = tail call fastcc noundef zeroext i1 @_ZN17double_conversionL12isWhitespaceEi(i32 noundef %i.dq)
...
.lr.ph442:                                        ; preds = %.lr.ph.i259
  ...
  br i1 %.not.not.i263, label %.lr.ph442._ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit264.loopexit_crit_edge, label %.lr.ph.i259, !llvm.loop !0

.lr.ph.i259._crit_edge:                           ; preds = %.lr.ph.i259, %.lr.ph.i259.preheader
  %i.dt = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.du = load double, ptr %i.dt, align 8, !tbaa !26
  br label %.thread

.lr.ph442._ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit264.loopexit_crit_edge: ; preds = %.lr.ph442
  br label %_ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit264, !llvm.loop !0

_ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit264: ; preds = %.lr.ph442.preheader, %.lr.ph442._ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit264.loopexit_crit_edge, %bb.aj
  %i.dv = phi ptr [ %i.df, %bb.aj ], [ %scevgep536, %.lr.ph442._ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit264.loopexit_crit_edge ], [ %scevgep536, %.lr.ph442.preheader ]
  %i.dw = ptrtoint ptr %i.dv to i64
  %i.dx = ptrtoint ptr %1 to i64
  %i.dy = sub i64 %i.dw, %i.dx
  %i.dz = trunc i64 %i.dy to i32
  store i32 %i.dz, ptr %4, align 4, !tbaa !18
  br i1 %.0180, label %.thread, label %bb.ak

bb.ak:                                            ; preds = %_ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit264
  br label %.thread

bb.al:                                            ; preds = %_ZN17double_conversion12_GLOBAL__N_121ConsumeFirstCharacterEcPKcb.exit256._crit_edge, %bb.x
  %i.ea = phi ptr [ %.pre548, %_ZN17double_conversion12_GLOBAL__N_121ConsumeFirstCharacterEcPKcb.exit256._crit_edge ], [ %.pre549, %bb.x ] ; 4 uses
...
bb.am:                                            ; preds = %bb.al
  ...
  %i.ee = load i16, ptr %i.ed, align 8, !tbaa !36 ; 3 uses
  %i.ef = zext i16 %i.ee to i32                   ; 2 uses
  %i.eg = icmp eq i16 %i.ee, 0                    ; 2 uses
  %i.eh = getelementptr inbounds nuw i8, ptr %i.ea, i64 1 ; 7 uses
  store ptr %i.eh, ptr %i.b, align 8, !tbaa !17
  %i.ei = icmp eq ptr %i.eh, %i.h                 ; 2 uses
  br i1 %i.eg, label %.split, label %_ZN17double_conversionL7isDigitEii.exit.thread.i

.split:                                           ; preds = %bb.am
  br i1 %i.ei, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit.thread356, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit.threadthread-pre-split

_ZN17double_conversionL7isDigitEii.exit.thread.i: ; preds = %bb.am
  br i1 %i.ei, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit.thread356, label %bb.an

bb.an:                                            ; preds = %_ZN17double_conversionL7isDigitEii.exit.thread.i
  %i.ej = getelementptr inbounds nuw i8, ptr %i.ea, i64 2 ; 4 uses
  %i.ek = icmp eq ptr %i.ej, %i.h
  br i1 %i.ek, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit.threadthread-pre-split, label %bb.ao

bb.ao:                                            ; preds = %bb.an
  %i.el = load i8, ptr %i.eh, align 1, !tbaa !24  ; 2 uses
  %i.em = sext i8 %i.el to i32
  %i.en = icmp eq i32 %i.em, %i.ef
  br i1 %i.en, label %bb.ap, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit.thread

bb.ap:                                            ; preds = %bb.ao
  %i.eo = load i8, ptr %i.ej, align 1, !tbaa !24  ; 2 uses
...
_ZN17double_conversionL7isDigitEii.exit30.thread.i: ; preds = %bb.ap
  store ptr %i.ej, ptr %i.b, align 8, !tbaa !17
  br label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit.threadthread-pre-split

_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit.thread356: ; preds = %_ZN17double_conversionL7isDigitEii.exit.thread.i, %.split
  store i32 %2, ptr %4, align 4, !tbaa !18
  %i.es = select i1 %.0180, double -0.000000e+00, double 0.000000e+00
  br label %.thread

_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit.threadthread-pre-split: ; preds = %.split, %bb.an, %_ZN17double_conversionL7isDigitEii.exit30.thread.i, %bb.ap
  %.promoted448.ph = phi ptr [ %i.eh, %.split ], [ %i.eh, %bb.an ], [ %i.ej, %_ZN17double_conversionL7isDigitEii.exit30.thread.i ], [ %i.eh, %bb.ap ] ; 2 uses
  %.pre550.pr = load i8, ptr %.promoted448.ph, align 1, !tbaa !24
  br label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit.thread

_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit.thread: ; preds = %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit.threadthread-pre-split, %bb.ao
  %.pre550 = phi i8 [ %.pre550.pr, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit.threadthread-pre-split ], [ %i.el, %bb.ao ] ; 2 uses
  %.promoted448 = phi ptr [ %.promoted448.ph, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit.threadthread-pre-split ], [ %i.eh, %bb.ao ] ; 6 uses
  %i.et = load i32, ptr %0, align 8, !tbaa !22    ; 3 uses
...
bb.aq:                                            ; preds = %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit.thread
  switch i8 %.pre550, label %bb.ax [
    i8 120, label %bb.ar
    i8 88, label %bb.ar
  ]
...
bb.ar:                                            ; preds = %bb.aq, %bb.aq
  ...
  store ptr %i.ew, ptr %i.b, align 8, !tbaa !17
...
bb.au:                                            ; preds = %bb.at
  %i.fa = tail call fastcc noundef zeroext i1 @_ZN17double_conversionL16IsHexFloatStringIPKcEEbT_S3_tb(ptr noundef nonnull %i.ew, ptr noundef nonnull %i.h, i16 noundef zeroext %i.ee, i1 noundef zeroext %i.k)
  br i1 %i.fa, label %_ZN17double_conversionL7isDigitEii.exit.thread, label %.thread358

.thread358:                                       ; preds = %bb.at, %bb.au
  %i.fb = load i8, ptr %i.ew, align 1, !tbaa !24  ; 3 uses
  ...
  br i1 %i.ff, label %_ZN17double_conversionL7isDigitEii.exit.thread, label %switch.early.test

switch.early.test:                                ; preds = %.thread358
  %switch.tableidx = add i8 %i.fb, -65            ; 2 uses
  %i.fg = icmp ult i8 %switch.tableidx, 38
  br i1 %i.fg, label %switch.hole_check, label %_ZN17double_conversionL7isDigitEii.exit.thread359

_ZN17double_conversionL7isDigitEii.exit.thread359: ; preds = %switch.hole_check, %switch.early.test
  %i.fh = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.fi = load double, ptr %i.fh, align 8, !tbaa !26
  br label %.thread
...
switch.hole_check:                                ; preds = %switch.early.test
  ...
  br i1 %switch.lobit, label %_ZN17double_conversionL7isDigitEii.exit.thread, label %_ZN17double_conversionL7isDigitEii.exit.thread359

_ZN17double_conversionL7isDigitEii.exit.thread:   ; preds = %switch.hole_check, %.thread358, %bb.au
  %i.fj = phi i1 [ false, %.thread358 ], [ true, %bb.au ], [ false, %switch.hole_check ]
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c) #8
  %i.fk = load i16, ptr %i.ed, align 8, !tbaa !36
  %i.fl = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.fm = load double, ptr %i.fl, align 8, !tbaa !26
  %i.fn = call fastcc noundef double @_ZN17double_conversionL17RadixStringToIeeeILi4EPKcEEdPT0_S3_btbbdbPb(ptr noundef %i.b, ptr noundef nonnull %i.h, i1 noundef zeroext %.0180, i16 noundef zeroext %i.fk, i1 noundef zeroext %i.fj, i1 noundef zeroext %i.k, double noundef %i.fm, i1 noundef zeroext %3, ptr noundef %i.c)
  %i.fo = load i8, ptr %i.c, align 1, !tbaa !38, !range !39, !noundef !31
  %i.fp = trunc nuw i8 %i.fo to i1
  br i1 %i.fp, label %bb.aw, label %bb.av

bb.av:                                            ; preds = %_ZN17double_conversionL7isDigitEii.exit.thread
  ...
  br i1 %or.cond404, label %_ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit272, label %.lr.ph.i267.preheader

.lr.ph.i267.preheader:                            ; preds = %bb.av
  %i.fq = load i8, ptr %.promoted.i265, align 1, !tbaa !24
  %i.fr = sext i8 %i.fq to i32
  %i.fs = tail call fastcc noundef zeroext i1 @_ZN17double_conversionL12isWhitespaceEi(i32 noundef %i.fr)
  br i1 %i.fs, label %.lr.ph445.preheader, label %_ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit272
...
.lr.ph445.preheader:                              ; preds = %.lr.ph.i267.preheader
  ...
  br i1 %.not.not.i271684, label %._ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit272.loopexit_crit_edge, label %.lr.ph.i267.lr.ph, !llvm.loop !0
...
.lr.ph.i267:                                      ; preds = %.lr.ph.i267.lr.ph, %.lr.ph445
  ...
  %i.fz = tail call fastcc noundef zeroext i1 @_ZN17double_conversionL12isWhitespaceEi(i32 noundef %i.fy)
  br i1 %i.fz, label %.lr.ph445, label %_ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit272, !llvm.loop !0

.lr.ph445:                                        ; preds = %.lr.ph.i267
  %i.ga = getelementptr inbounds nuw i8, ptr %i.fw, i64 1 ; 2 uses
  %.not.not.i271 = icmp eq ptr %i.ga, %i.h
  br i1 %.not.not.i271, label %.lr.ph445.._ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit272.loopexit_crit_edge_crit_edge, label %.lr.ph.i267, !llvm.loop !0

.lr.ph445.._ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit272.loopexit_crit_edge_crit_edge: ; preds = %.lr.ph445
  br label %._ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit272.loopexit_crit_edge, !llvm.loop !0

._ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit272.loopexit_crit_edge: ; preds = %.lr.ph445.._ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit272.loopexit_crit_edge_crit_edge, %.lr.ph445.preheader
  br label %_ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit272, !llvm.loop !0

_ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit272: ; preds = %.lr.ph.i267, %.lr.ph.i267.preheader, %._ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit272.loopexit_crit_edge, %bb.av
  %i.gb = phi ptr [ %.promoted.i265, %bb.av ], [ %.promoted.i265, %.lr.ph.i267.preheader ], [ %scevgep538, %._ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit272.loopexit_crit_edge ], [ %i.fw, %.lr.ph.i267 ]
  %i.gc = ptrtoint ptr %i.gb to i64
  %i.gd = ptrtoint ptr %1 to i64
  %i.ge = sub i64 %i.gc, %i.gd
  %i.gf = trunc i64 %i.ge to i32
  store i32 %i.gf, ptr %4, align 4, !tbaa !18
  br label %bb.aw
...
.split361.us.preheader:                           ; preds = %.lr.ph450
  ...
  %5 = sub i64 %i.gh, %.promoted448539
  %scevgep540 = getelementptr i8, ptr %.promoted448, i64 %5 ; 2 uses
  %i.gi = getelementptr inbounds nuw i8, ptr %.promoted448, i64 1 ; 2 uses
  %i.gj = icmp eq ptr %i.gi, %i.h
  br i1 %i.gj, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit281.thread, label %.backedge415.us

.split361.us:                                     ; preds = %.backedge415.us
  %i.gk = getelementptr inbounds nuw i8, ptr %i.gm, i64 1 ; 2 uses
  %i.gl = icmp eq ptr %i.gk, %i.h
  br i1 %i.gl, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit281.thread, label %.backedge415.us, !llvm.loop !44
...
.backedge415.us:                                  ; preds = %.split361.us.preheader, %.split361.us
  ...
  br i1 %i.go, label %.split361.us, label %._crit_edge, !llvm.loop !44
...
_ZN17double_conversionL7isDigitEii.exit.thread.i277: ; preds = %.lr.ph450, %.backedge415
  ...
  br i1 %i.gr, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit281.thread, label %bb.ay

.backedge415:                                     ; preds = %bb.az, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit281.thread.loopexit650
  %i.gs = phi i8 [ %.pre551.pre, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit281.thread.loopexit650 ], [ %i.gz, %bb.az ]
  %i.gt = phi ptr [ %i.gq, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit281.thread.loopexit650 ], [ %i.gv, %bb.az ] ; 2 uses
  %i.gu = icmp eq i8 %i.gs, 48
  br i1 %i.gu, label %_ZN17double_conversionL7isDigitEii.exit.thread.i277, label %._crit_edge, !llvm.loop !44
...
bb.ay:                                            ; preds = %_ZN17double_conversionL7isDigitEii.exit.thread.i277
  ...
  %.pre551.pre = load i8, ptr %i.gq, align 1, !tbaa !24 ; 2 uses
  %i.gx = sext i8 %.pre551.pre to i32
  %i.gy = icmp eq i32 %i.gx, %i.ef
  %or.cond648 = select i1 %i.gw, i1 %i.gy, i1 false
  br i1 %or.cond648, label %bb.az, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit281.thread.loopexit650

bb.az:                                            ; preds = %bb.ay
  %i.gz = load i8, ptr %i.gv, align 1, !tbaa !24  ; 3 uses
  ...
  br i1 %or.cond19.i26.i279, label %.backedge415, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit281.thread.loopexit650

_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit281.thread.loopexit650: ; preds = %bb.az, %bb.ay
...
_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit281.thread: ; preds = %_ZN17double_conversionL7isDigitEii.exit.thread.i277, %.split361.us, %.split361.us.preheader
  %.us-phi = phi ptr [ %scevgep540, %.split361.us.preheader ], [ %scevgep540, %.split361.us ], [ %i.gq, %_ZN17double_conversionL7isDigitEii.exit.thread.i277 ]
  %6 = ptrtoint ptr %.us-phi to i64
  %i.hd = ptrtoint ptr %1 to i64
  %i.he = sub i64 %6, %i.hd
  %i.hf = trunc i64 %i.he to i32
  store i32 %i.hf, ptr %4, align 4, !tbaa !18
  %i.hg = select i1 %.0180, double -0.000000e+00, double 0.000000e+00
  br label %.thread

._crit_edge:                                      ; preds = %.backedge415, %.backedge415.us, %bb.ax
  %.lcssa449 = phi ptr [ %.promoted448, %bb.ax ], [ %i.gm, %.backedge415.us ], [ %i.gt, %.backedge415 ] ; 2 uses
...
.critedge227:                                     ; preds = %bb.al, %._crit_edge
  ...
  %i.hk = load i8, ptr %.promoted455, align 1, !tbaa !24 ; 3 uses
  %i.hl = add i8 %i.hk, -48
...
.lr.ph463:                                        ; preds = %.critedge227
  ...
  %i.hn = load i16, ptr %i.hm, align 8, !tbaa !36 ; 2 uses
...
bb.bb:                                            ; preds = %bb.ba
  ...
  store i8 %i.hq, ptr %i.hv, align 1, !tbaa !24
...
bb.be:                                            ; preds = %bb.bd
  %i.ib = load i8, ptr %i.hr, align 1, !tbaa !24
...
.split364:                                        ; preds = %bb.bf
  ...
  br i1 %i.ig, label %_ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit315.sink.split, label %.backedge414

.backedge414:                                     ; preds = %bb.bj, %.split364, %.split365, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit290
  %i.ih = phi ptr [ %i.if, %.split364 ], [ %i.io, %.split365 ], [ %i.io, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit290 ], [ %i.iq, %bb.bj ] ; 3 uses
  %i.ii = load i8, ptr %i.ih, align 1, !tbaa !24  ; 3 uses
  %i.ij = add i8 %i.ii, -48
  %or.cond228 = icmp ult i8 %i.ij, 10
  br i1 %or.cond228, label %bb.ba, label %.critedge, !llvm.loop !45

bb.bg:                                            ; preds = %bb.bf
  %i.ik = load i8, ptr %i.hr, align 1, !tbaa !24  ; 2 uses
...
.split365:                                        ; preds = %bb.bg
  br i1 %i.ip, label %_ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit315.sink.split, label %.backedge414

_ZN17double_conversionL7isDigitEii.exit.thread.i286: ; preds = %bb.bg
  br i1 %i.ip, label %_ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit315.sink.split, label %bb.bh
...
bb.bh:                                            ; preds = %_ZN17double_conversionL7isDigitEii.exit.thread.i286
  ...
  br i1 %i.ir, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit290, label %bb.bi

bb.bi:                                            ; preds = %bb.bh
  %i.is = load i8, ptr %i.io, align 1, !tbaa !24
  %i.it = sext i8 %i.is to i32
  %i.iu = icmp eq i32 %i.it, %i.ho
  br i1 %i.iu, label %bb.bj, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit290

bb.bj:                                            ; preds = %bb.bi
  %i.iv = load i8, ptr %i.iq, align 1, !tbaa !24  ; 2 uses
...
bb.bm:                                            ; preds = %bb.bk
  br i1 %i.jb, label %_ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit315.thread, label %bb.bn

bb.bn:                                            ; preds = %bb.bm
  %i.je = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.jf = load i16, ptr %i.je, align 8, !tbaa !36 ; 4 uses
  %i.jg = call fastcc noundef zeroext i1 @_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_(ptr noundef %i.b, i16 noundef zeroext %i.jf, i32 noundef 10, ptr nonnull %i.h)
...
bb.bp:                                            ; preds = %bb.bo
  ...
  %i.jj = load double, ptr %i.ji, align 8, !tbaa !26
  br label %.thread370

bb.bq:                                            ; preds = %bb.bn
  %.promoted474.pre = load ptr, ptr %i.b, align 8, !tbaa !17 ; 2 uses
  %i.jk = load i8, ptr %.promoted474.pre, align 1, !tbaa !24 ; 2 uses
...
.lr.ph472:                                        ; preds = %bb.bq, %bb.bs
  ...
  %i.jm = call fastcc noundef zeroext i1 @_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_(ptr noundef %i.b, i16 noundef zeroext %i.jf, i32 noundef 10, ptr nonnull %i.h)
  br i1 %i.jm, label %bb.br, label %bb.bs

bb.br:                                            ; preds = %.lr.ph472
  %i.jn = load ptr, ptr %i.b, align 8, !tbaa !17
  %i.jo = ptrtoint ptr %i.jn to i64
  %i.jp = ptrtoint ptr %1 to i64
  %i.jq = sub i64 %i.jo, %i.jp
  %i.jr = trunc i64 %i.jq to i32
  store i32 %i.jr, ptr %4, align 4, !tbaa !18
  %i.js = select i1 %.0180, double -0.000000e+00, double 0.000000e+00
  br label %.thread370

bb.bs:                                            ; preds = %.lr.ph472
  %i.jt = add nsw i32 %.0157471, -1               ; 2 uses
  %i.ju = load ptr, ptr %i.b, align 8, !tbaa !17  ; 2 uses
  %i.jv = load i8, ptr %i.ju, align 1, !tbaa !24  ; 2 uses
  %i.jw = icmp eq i8 %i.jv, 48
  br i1 %i.jw, label %.lr.ph472, label %.loopexit, !llvm.loop !46
