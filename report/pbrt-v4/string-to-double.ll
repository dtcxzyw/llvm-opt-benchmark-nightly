...
begin_hunk_0_@_ZN17double_conversionL16IsHexFloatStringIPKcEEbT_S3_tb:.peel.begin
_ZN17double_conversionL7isDigitEii.exit.thread.i58: ; preds = %bb.x
  br i1 %i.cx, label %_ZN17double_conversionL7isDigitEii.exit82, label %bb.y

bb.y:                                             ; preds = %_ZN17double_conversionL7isDigitEii.exit.thread.i58
  %i.cy = getelementptr inbounds nuw i8, ptr %i.cr, i64 2 ; 4 uses
  %i.cz = icmp eq ptr %i.cy, %1
  br i1 %i.cz, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit64.threadthread-pre-split, label %bb.z

bb.z:                                             ; preds = %bb.y
  %i.da = load i8, ptr %i.cw, align 1, !tbaa !24  ; 2 uses
  %i.db = sext i8 %i.da to i32
  %i.dc = icmp eq i32 %i.db, %i.c
  br i1 %i.dc, label %bb.aa, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit64.thread

bb.aa:                                            ; preds = %bb.z
  %i.dd = load i8, ptr %i.cy, align 1, !tbaa !24  ; 3 uses
  ...
  br i1 %i.dh, label %_ZN17double_conversionL7isDigitEii.exit30.thread.i63, label %switch.early.test134

switch.early.test134:                             ; preds = %bb.aa
  switch i8 %i.dd, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit64.threadthread-pre-split [
...
_ZN17double_conversionL7isDigitEii.exit30.thread.i63: ; preds = %switch.early.test134, %switch.early.test134, %switch.early.test134, %switch.early.test134, %switch.early.test134, %switch.early.test134, %switch.early.test134, %switch.early.test134, %switch.early.test134, %switch.early.test134, %switch.early.test134, %switch.early.test134, %bb.aa
  store ptr %i.cy, ptr %i.a, align 8, !tbaa !17
  br label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit64.threadthread-pre-split

_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit64: ; preds = %bb.x
  br i1 %i.cx, label %_ZN17double_conversionL7isDigitEii.exit82, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit64.threadthread-pre-split

_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit64.threadthread-pre-split: ; preds = %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit64, %.split113, %bb.y, %_ZN17double_conversionL7isDigitEii.exit30.thread.i63, %switch.early.test134
  %.ph250 = phi ptr [ %i.cw, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit64 ], [ %i.ct, %.split113 ], [ %i.cw, %bb.y ], [ %i.cy, %_ZN17double_conversionL7isDigitEii.exit30.thread.i63 ], [ %i.cw, %switch.early.test134 ] ; 2 uses
  %.pr = load i8, ptr %.ph250, align 1, !tbaa !24
  br label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit64.thread

_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit64.thread: ; preds = %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit64.threadthread-pre-split, %bb.z
  %i.di = phi i8 [ %.pr, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit64.threadthread-pre-split ], [ %i.da, %bb.z ]
  %i.dj = phi ptr [ %.ph250, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit64.threadthread-pre-split ], [ %i.cw, %bb.z ] ; 2 uses
  switch i8 %i.di, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit77.thread [
    i8 43, label %bb.ab
    i8 45, label %bb.ab
  ]

bb.ab:                                            ; preds = %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit64.thread, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit64.thread
  %i.dk = getelementptr inbounds nuw i8, ptr %i.dj, i64 1 ; 3 uses
  store ptr %i.dk, ptr %i.a, align 8, !tbaa !17
  %i.dl = icmp eq ptr %i.dk, %1
  br i1 %i.dl, label %_ZN17double_conversionL7isDigitEii.exit82, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit77.thread

_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit77.thread: ; preds = %bb.ab, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit64.thread
  %i.dm = phi ptr [ %i.dk, %bb.ab ], [ %i.dj, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit64.thread ]
  %i.dn = load i8, ptr %i.dm, align 1, !tbaa !24  ; 2 uses
  ...
  br i1 %or.cond19.i79, label %bb.ac, label %_ZN17double_conversionL7isDigitEii.exit82

bb.ac:                                            ; preds = %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit77.thread
  %i.dr = call fastcc noundef zeroext i1 @_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_(ptr noundef %i.a, i16 noundef zeroext %2, i32 noundef 16, ptr %1)
  br i1 %i.dr, label %_ZN17double_conversionL7isDigitEii.exit82, label %.preheader

.preheader:                                       ; preds = %bb.ac
  %.promoted156 = load ptr, ptr %i.a, align 8, !tbaa !17 ; 4 uses
  %i.ds = load i8, ptr %.promoted156, align 1, !tbaa !24 ; 2 uses
  ...
  br i1 %or.cond19.i84159, label %.lr.ph, label %_ZN17double_conversionL7isDigitEii.exit87

.lr.ph:                                           ; preds = %.preheader
  br i1 %i.b, label %.split119.us.preheader, label %_ZN17double_conversionL7isDigitEii.exit.thread.i94

.split119.us.preheader:                           ; preds = %.lr.ph
  %i.dw = getelementptr inbounds nuw i8, ptr %.promoted156, i64 1 ; 2 uses
  %i.dx = icmp eq ptr %i.dw, %1
  br i1 %i.dx, label %_ZN17double_conversionL7isDigitEii.exit82, label %.backedge.us

.split119.us:                                     ; preds = %.backedge.us
  %i.dy = getelementptr inbounds nuw i8, ptr %i.ea, i64 1 ; 2 uses
  %i.dz = icmp eq ptr %i.dy, %1
  br i1 %i.dz, label %_ZN17double_conversionL7isDigitEii.exit82, label %.backedge.us, !llvm.loop !58

.backedge.us:                                     ; preds = %.split119.us.preheader, %.split119.us
  %i.ea = phi ptr [ %i.dy, %.split119.us ], [ %i.dw, %.split119.us.preheader ] ; 3 uses
  %i.eb = load i8, ptr %i.ea, align 1, !tbaa !24  ; 2 uses
  ...
  br i1 %or.cond19.i84.us, label %.split119.us, label %_ZN17double_conversionL7isDigitEii.exit87, !llvm.loop !58
...
_ZN17double_conversionL7isDigitEii.exit.thread.i94: ; preds = %.lr.ph, %.backedge
  ...
  br i1 %i.eh, label %_ZN17double_conversionL7isDigitEii.exit82, label %bb.ad

.backedge:                                        ; preds = %bb.ae, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit100
  %.pre-phi190 = phi i32 [ %i.eq, %bb.ae ], [ %.pre189, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit100 ]
  %i.ei = phi i8 [ %i.eo, %bb.ae ], [ %.pre.pre, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit100 ]
  %i.ej = phi ptr [ %i.el, %bb.ae ], [ %i.eg, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit100 ] ; 2 uses
  %or.cond.i83 = icmp ult i32 %.pre-phi190, 10
  %i.ek = icmp ult i8 %i.ei, 58
  %or.cond19.i84 = and i1 %i.ek, %or.cond.i83
  br i1 %or.cond19.i84, label %_ZN17double_conversionL7isDigitEii.exit.thread.i94, label %_ZN17double_conversionL7isDigitEii.exit87, !llvm.loop !58

bb.ad:                                            ; preds = %_ZN17double_conversionL7isDigitEii.exit.thread.i94
  %i.el = getelementptr inbounds nuw i8, ptr %i.ef, i64 2 ; 15 uses
  %i.em = icmp ne ptr %i.el, %1
  %.pre.pre = load i8, ptr %i.eg, align 1, !tbaa !24 ; 2 uses
  %.pre195 = sext i8 %.pre.pre to i32             ; 2 uses
  %i.en = icmp eq i32 %.pre195, %i.c
  %or.cond269 = select i1 %i.em, i1 %i.en, i1 false
  br i1 %or.cond269, label %bb.ae, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit100

bb.ae:                                            ; preds = %bb.ad
  %i.eo = load i8, ptr %i.el, align 1, !tbaa !24  ; 4 uses
...
switch.early.test135:                             ; preds = %bb.ae
  switch i8 %i.eo, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit100 [
...
_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit100: ; preds = %bb.ad, %switch.early.test135
  %.pre189 = add nsw i32 %.pre195, -48
  br label %.backedge

_ZN17double_conversionL7isDigitEii.exit87:        ; preds = %switch.early.test135, %switch.early.test135, %switch.early.test135, %switch.early.test135, %switch.early.test135, %switch.early.test135, %switch.early.test135, %switch.early.test135, %switch.early.test135, %switch.early.test135, %switch.early.test135, %switch.early.test135, %.backedge, %.backedge.us, %.preheader
  ...
  br i1 %or.cond136, label %_ZN17double_conversionL7isDigitEii.exit82, label %.lr.ph.i

.lr.ph.i:                                         ; preds = %_ZN17double_conversionL7isDigitEii.exit87, %bb.af
  %i.et = phi ptr [ %i.ex, %bb.af ], [ %.lcssa157, %_ZN17double_conversionL7isDigitEii.exit87 ] ; 2 uses
  %i.eu = load i8, ptr %i.et, align 1, !tbaa !24
  %i.ev = sext i8 %i.eu to i32
  %i.ew = tail call fastcc noundef zeroext i1 @_ZN17double_conversionL12isWhitespaceEi(i32 noundef %i.ev) ; 3 uses
  br i1 %i.ew, label %bb.af, label %_ZN17double_conversionL7isDigitEii.exit82

bb.af:                                            ; preds = %.lr.ph.i
  %i.ex = getelementptr inbounds nuw i8, ptr %i.et, i64 1 ; 3 uses
  store ptr %i.ex, ptr %i.a, align 8, !tbaa !17
  %.not.not.i = icmp eq ptr %i.ex, %1
  br i1 %.not.not.i, label %_ZN17double_conversionL7isDigitEii.exit82, label %.lr.ph.i, !llvm.loop !0

_ZN17double_conversionL7isDigitEii.exit82:        ; preds = %_ZN17double_conversionL7isDigitEii.exit.thread.i, %.split, %_ZN17double_conversionL7isDigitEii.exit.thread.i45, %.split109, %_ZN17double_conversionL7isDigitEii.exit.thread.i94, %.split119.us, %bb.af, %.lr.ph.i, %.split119.us.preheader, %_ZN17double_conversionL7isDigitEii.exit.thread.i.peel, %.split.peel, %_ZN17double_conversionL7isDigitEii.exit.thread.i45.peel, %.split109.peel, %bb.ab, %.loopexit, %_ZN17double_conversionL7isDigitEii.exit.thread.i58, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit77.thread, %.split113, %_ZN17double_conversionL7isDigitEii.exit38.thread105, %.split104, %_ZN17double_conversionL7isDigitEii.exit87, %bb.ac, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit64, %bb.v, %bb.u, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit33
  %.010 = phi i1 [ false, %.loopexit ], [ false, %_ZN17double_conversionL7isDigitEii.exit.thread.i45.peel ], [ false, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit33 ], [ false, %bb.u ], [ false, %bb.v ], [ false, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit64 ], [ false, %bb.ab ], [ true, %bb.ac ], [ false, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit77.thread ], [ false, %_ZN17double_conversionL7isDigitEii.exit.thread.i.peel ], [ true, %_ZN17double_conversionL7isDigitEii.exit87 ], [ false, %.split113 ], [ false, %_ZN17double_conversionL7isDigitEii.exit.thread.i58 ], [ false, %_ZN17double_conversionL7isDigitEii.exit38.thread105 ], [ true, %.split119.us ], [ false, %.split104 ], [ false, %_ZN17double_conversionL7isDigitEii.exit.thread.i45 ], [ false, %.split.peel ], [ true, %.split119.us.preheader ], [ false, %.split109.peel ], [ %i.ew, %bb.af ], [ true, %_ZN17double_conversionL7isDigitEii.exit.thread.i94 ], [ %i.ew, %.lr.ph.i ], [ false, %.split109 ], [ false, %.split ], [ false, %_ZN17double_conversionL7isDigitEii.exit.thread.i ]
...
bb.a:
  ...
  %.promoted = load ptr, ptr %0, align 8, !tbaa !17 ; 4 uses
  %i.a = load i8, ptr %.promoted, align 1, !tbaa !24 ; 2 uses
...
.lr.ph:                                           ; preds = %bb.a
  %i.d = icmp eq i16 %3, 0
  br i1 %i.d, label %.split.us.preheader, label %_ZN17double_conversionL7isDigitEii.exit.thread.i
...
.split.us.preheader:                              ; preds = %.lr.ph
  ...
  br i1 %i.f, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit.thread, label %.backedge360.us
...
.split.us:                                        ; preds = %.backedge360.us
  ...
  br i1 %i.h, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit.thread, label %.backedge360.us, !llvm.loop !59
...
.backedge360.us:                                  ; preds = %.split.us.preheader, %.split.us
  ...
  br i1 %i.k, label %.split.us, label %.preheader358, !llvm.loop !59
...
_ZN17double_conversionL7isDigitEii.exit.thread.i: ; preds = %.lr.ph, %.backedge360
  ...
  br i1 %i.q, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit.thread, label %bb.b

.backedge360thread-pre-split:                     ; preds = %_ZN17double_conversionL7isDigitEii.exit30.thread.i, %switch.early.test, %bb.b
  %.ph = phi ptr [ %i.p, %bb.b ], [ %i.p, %switch.early.test ], [ %i.u, %_ZN17double_conversionL7isDigitEii.exit30.thread.i ] ; 2 uses
  %.pr = load i8, ptr %.ph, align 1, !tbaa !24
...
.backedge360:                                     ; preds = %.backedge360thread-pre-split, %bb.c
  ...
  br i1 %i.t, label %_ZN17double_conversionL7isDigitEii.exit.thread.i, label %.preheader358, !llvm.loop !59
...
bb.c:                                             ; preds = %bb.b
  %i.w = load i8, ptr %i.p, align 1, !tbaa !24    ; 2 uses
  %i.x = sext i8 %i.w to i32
  %i.y = icmp eq i32 %i.x, %i.c
  br i1 %i.y, label %bb.d, label %.backedge360

bb.d:                                             ; preds = %bb.c
  %i.z = load i8, ptr %i.u, align 1, !tbaa !24    ; 3 uses
...
bb.e:                                             ; preds = %.preheader358, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175
  ...
  %.promoted389 = phi ptr [ %24, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175 ], [ %.promoted385, %.preheader358 ] ; 10 uses
...
9:                                                ; preds = %bb.k
  ...
  br i1 %i.m, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175.sink.split, label %11, !llvm.loop !60

11:                                               ; preds = %9
  store ptr %10, ptr %0, align 8, !tbaa !17
  %12 = icmp ne ptr %10, %1
  %or.cond512.not = select i1 %or.cond.i160, i1 %12, i1 false
  br i1 %or.cond512.not, label %bb.l, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175, !llvm.loop !60

bb.l:                                             ; preds = %11
  %i.as = getelementptr inbounds nuw i8, ptr %.promoted389, i64 2 ; 15 uses
  %13 = icmp eq ptr %i.as, %1
  br i1 %13, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175, label %14, !llvm.loop !60

14:                                               ; preds = %bb.l
  %15 = load i8, ptr %10, align 1, !tbaa !24
  %16 = sext i8 %15 to i32
  %17 = icmp eq i32 %i.c, %16
  br i1 %17, label %18, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175, !llvm.loop !60

18:                                               ; preds = %14
  %19 = load i8, ptr %i.as, align 1, !tbaa !24    ; 3 uses
  ...
  br i1 %23, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175.sink.split, label %switch.early.test349, !llvm.loop !60

switch.early.test349:                             ; preds = %18
  switch i8 %19, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175 [
...
.lr.ph.i:                                         ; preds = %.critedge, %bb.m
  ...
  %i.aw = tail call fastcc noundef zeroext i1 @_ZN17double_conversionL12isWhitespaceEi(i32 noundef %i.av)
  br i1 %i.aw, label %bb.m, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175.thread311

bb.m:                                             ; preds = %.lr.ph.i
  %i.ax = getelementptr inbounds nuw i8, ptr %i.at, i64 1 ; 4 uses
  store ptr %i.ax, ptr %0, align 8, !tbaa !17
...
.lr.ph388:                                        ; preds = %.preheader, %.lr.ph388
  ...
  br i1 %i.bh, label %.lr.ph388, label %._crit_edge, !llvm.loop !61
...
bb.o:                                             ; preds = %_ZN17double_conversionL7isDigitEii.exit.thread, %._crit_edge
  %i.bo = phi i8 [ %i.af, %._crit_edge ], [ %i.co, %_ZN17double_conversionL7isDigitEii.exit.thread ] ; 3 uses
  %i.bp = phi ptr [ %.promoted389, %._crit_edge ], [ %i.cp, %_ZN17double_conversionL7isDigitEii.exit.thread ] ; 4 uses
  %.2130 = phi i32 [ %i.bn, %._crit_edge ], [ %spec.select149, %_ZN17double_conversionL7isDigitEii.exit.thread ] ; 3 uses
...
.split289:                                        ; preds = %bb.o
  ...
  store ptr %i.bq, ptr %0, align 8, !tbaa !17
  %i.br = icmp eq ptr %i.bq, %1
  br i1 %i.br, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit188.thread287, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit188.thread
...
bb.p:                                             ; preds = %bb.o
  ...
  br i1 %i.bv, label %_ZN17double_conversionL7isDigitEii.exit.thread.i182, label %switch.early.test350

switch.early.test350:                             ; preds = %bb.p
  switch i8 %i.bo, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit188 [
...
_ZN17double_conversionL7isDigitEii.exit.thread.i182: ; preds = %switch.early.test350, %switch.early.test350, %switch.early.test350, %switch.early.test350, %switch.early.test350, %switch.early.test350, %switch.early.test350, %switch.early.test350, %switch.early.test350, %switch.early.test350, %switch.early.test350, %switch.early.test350, %bb.p
  %i.bw = getelementptr inbounds nuw i8, ptr %i.bp, i64 1 ; 7 uses
  store ptr %i.bw, ptr %0, align 8, !tbaa !17
  %i.bx = icmp eq ptr %i.bw, %1
  br i1 %i.bx, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit188.thread287, label %bb.q

bb.q:                                             ; preds = %_ZN17double_conversionL7isDigitEii.exit.thread.i182
  %i.by = getelementptr inbounds nuw i8, ptr %i.bp, i64 2 ; 4 uses
  %i.bz = icmp eq ptr %i.by, %1
  br i1 %i.bz, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit188.thread, label %bb.r

bb.r:                                             ; preds = %bb.q
  %i.ca = load i8, ptr %i.bw, align 1, !tbaa !24
  %i.cb = sext i8 %i.ca to i32
  %i.cc = icmp eq i32 %i.c, %i.cb
  br i1 %i.cc, label %bb.s, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit188.thread

bb.s:                                             ; preds = %bb.r
  %i.cd = load i8, ptr %i.by, align 1, !tbaa !24  ; 3 uses
  ...
  br i1 %i.ch, label %_ZN17double_conversionL7isDigitEii.exit30.thread.i187, label %switch.early.test351

switch.early.test351:                             ; preds = %bb.s
  switch i8 %i.cd, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit188.thread [
...
_ZN17double_conversionL7isDigitEii.exit30.thread.i187: ; preds = %switch.early.test351, %switch.early.test351, %switch.early.test351, %switch.early.test351, %switch.early.test351, %switch.early.test351, %switch.early.test351, %switch.early.test351, %switch.early.test351, %switch.early.test351, %switch.early.test351, %switch.early.test351, %bb.s
  store ptr %i.by, ptr %0, align 8, !tbaa !17
...
_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit188: ; preds = %switch.early.test350
  ...
  store ptr %i.ci, ptr %0, align 8, !tbaa !17
  %i.cj = icmp eq ptr %i.ci, %1
  br i1 %i.cj, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit188.thread287, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit188.thread

_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit188.thread: ; preds = %switch.early.test351, %bb.r, %_ZN17double_conversionL7isDigitEii.exit30.thread.i187, %bb.q, %.split289, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit188
  %i.ck = phi ptr [ %i.bw, %switch.early.test351 ], [ %i.bw, %bb.r ], [ %i.by, %_ZN17double_conversionL7isDigitEii.exit30.thread.i187 ], [ %i.bw, %bb.q ], [ %i.bq, %.split289 ], [ %i.ci, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit188 ] ; 4 uses
  br i1 %4, label %bb.t, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit201thread-pre-split

bb.t:                                             ; preds = %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit188.thread
  %i.cl = load i8, ptr %i.ck, align 1, !tbaa !24  ; 2 uses
  %i.cm = icmp eq i8 %i.cl, 46
  br i1 %i.cm, label %bb.u, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit201

bb.u:                                             ; preds = %bb.t
  %i.cn = getelementptr inbounds nuw i8, ptr %i.ck, i64 1 ; 2 uses
  store ptr %i.cn, ptr %0, align 8, !tbaa !17
  br label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit201thread-pre-split

_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit201thread-pre-split: ; preds = %bb.u, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit188.thread
  %.ph470 = phi ptr [ %i.ck, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit188.thread ], [ %i.cn, %bb.u ] ; 2 uses
  %.2125.ph = phi i8 [ %.1124, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit188.thread ], [ 1, %bb.u ]
  %.pr471 = load i8, ptr %.ph470, align 1, !tbaa !24
  br label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit201

_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit201: ; preds = %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit201thread-pre-split, %bb.t
  %i.co = phi i8 [ %.pr471, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit201thread-pre-split ], [ %i.cl, %bb.t ] ; 5 uses
  %i.cp = phi ptr [ %.ph470, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit201thread-pre-split ], [ %i.ck, %bb.t ] ; 2 uses
  %.2125 = phi i8 [ %.2125.ph, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit201thread-pre-split ], [ %.1124, %bb.t ] ; 2 uses
  ...
  br i1 %i.ct, label %_ZN17double_conversionL7isDigitEii.exit.thread, label %switch.early.test352

switch.early.test352:                             ; preds = %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit201
  switch i8 %i.co, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit188.thread287 [
...
_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit188.thread287: ; preds = %switch.early.test352, %_ZN17double_conversionL7isDigitEii.exit.thread.i182, %.split289, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit188
  %.promoted.i204 = phi ptr [ %i.cp, %switch.early.test352 ], [ %i.bw, %_ZN17double_conversionL7isDigitEii.exit.thread.i182 ], [ %i.bq, %.split289 ], [ %i.ci, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit188 ] ; 3 uses
...
.lr.ph.i206:                                      ; preds = %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit188.thread287, %bb.v
  %i.cy = phi ptr [ %i.dc, %bb.v ], [ %.promoted.i204, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit188.thread287 ] ; 2 uses
  %i.cz = load i8, ptr %i.cy, align 1, !tbaa !24
  %i.da = sext i8 %i.cz to i32
  %i.db = tail call fastcc noundef zeroext i1 @_ZN17double_conversionL12isWhitespaceEi(i32 noundef %i.da)
  br i1 %i.db, label %bb.v, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175.thread311

bb.v:                                             ; preds = %.lr.ph.i206
  %i.dc = getelementptr inbounds nuw i8, ptr %i.cy, i64 1 ; 4 uses
  store ptr %i.dc, ptr %0, align 8, !tbaa !17
...
_ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit211: ; preds = %bb.v, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit188.thread287
  %i.dd = phi ptr [ %.promoted.i204, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit188.thread287 ], [ %i.dc, %bb.v ]
  %i.de = add nsw i32 %.0117.lcssa, -1
  %i.df = shl nuw i32 1, %i.de                    ; 2 uses
  %i.dg = icmp sgt i32 %i.bk, %i.df
  br i1 %i.dg, label %bb.w, label %bb.x

bb.w:                                             ; preds = %_ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit211
  %i.dh = add nsw i64 %i.bm, 1
  br label %bb.z

bb.x:                                             ; preds = %_ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit211
...
.split299:                                        ; preds = %bb.aa
  ...
  store ptr %i.dq, ptr %0, align 8, !tbaa !17
  %i.dr = icmp eq ptr %i.dq, %1
  br i1 %i.dr, label %_ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit.thread, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175
...
bb.ab:                                            ; preds = %bb.aa
  ...
  store ptr %i.dv, ptr %0, align 8, !tbaa !17
...
_ZN17double_conversionL7isDigitEii.exit.thread.i218: ; preds = %bb.ab
  br i1 %i.dw, label %_ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit.thread, label %bb.ac

bb.ac:                                            ; preds = %_ZN17double_conversionL7isDigitEii.exit.thread.i218
  %i.dx = getelementptr inbounds nuw i8, ptr %.promoted389, i64 2 ; 15 uses
  %i.dy = icmp eq ptr %i.dx, %1
  br i1 %i.dy, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175, label %bb.ad

bb.ad:                                            ; preds = %bb.ac
  %i.dz = load i8, ptr %i.dv, align 1, !tbaa !24
  %i.ea = sext i8 %i.dz to i32
  %i.eb = icmp eq i32 %i.c, %i.ea
  br i1 %i.eb, label %bb.ae, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175

bb.ae:                                            ; preds = %bb.ad
  %i.ec = load i8, ptr %i.dx, align 1, !tbaa !24  ; 3 uses
  ...
  br i1 %i.eg, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175.sink.split, label %switch.early.test353

switch.early.test353:                             ; preds = %bb.ae
  switch i8 %i.ec, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175 [
    i8 102, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175.sink.split
    i8 101, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175.sink.split
    i8 100, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175.sink.split
    i8 99, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175.sink.split
...
_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit224: ; preds = %bb.ab
  br i1 %i.dw, label %_ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit.thread, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175
...
_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175: ; preds = %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175.sink.split, %11, %switch.early.test353, %switch.early.test349, %bb.ad, %bb.ac, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit224, %.split299, %14, %bb.l
  %24 = phi ptr [ %10, %14 ], [ %10, %switch.early.test349 ], [ %i.dv, %bb.ac ], [ %i.dq, %.split299 ], [ %i.dv, %bb.ad ], [ %i.dv, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit224 ], [ %10, %11 ], [ %10, %bb.l ], [ %i.dv, %switch.early.test353 ], [ %.sink, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175.sink.split ] ; 2 uses
  %.5139 = phi i64 [ %.0134, %14 ], [ %.0134, %switch.early.test349 ], [ %i.bb, %bb.ac ], [ %i.bb, %.split299 ], [ %i.bb, %bb.ad ], [ %i.bb, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit224 ], [ %.0134, %11 ], [ %.0134, %bb.l ], [ %i.bb, %switch.early.test353 ], [ %.5139.ph516, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175.sink.split ]
  %.7 = phi i32 [ %.0128, %14 ], [ %.0128, %switch.early.test349 ], [ %spec.select148, %bb.ac ], [ %spec.select148, %.split299 ], [ %spec.select148, %bb.ad ], [ %spec.select148, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit224 ], [ %.0128, %11 ], [ %.0128, %bb.l ], [ %spec.select148, %switch.early.test353 ], [ %.7.ph517, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175.sink.split ]
  %.5 = phi i8 [ 1, %14 ], [ 1, %switch.early.test349 ], [ %.0123, %bb.ac ], [ %.0123, %.split299 ], [ %.0123, %bb.ad ], [ %.0123, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit224 ], [ 1, %11 ], [ 1, %bb.l ], [ %.0123, %switch.early.test353 ], [ %.5.ph, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit175.sink.split ]
  %.pre = load i8, ptr %24, align 1, !tbaa !24
  br label %bb.e
...
_ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit.thread: ; preds = %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit224, %.split299, %_ZN17double_conversionL7isDigitEii.exit.thread.i218, %bb.m, %.critedge, %bb.z
  %i.eh = phi ptr [ %.promoted389, %.critedge ], [ %i.ax, %bb.m ], [ %i.dd, %bb.z ], [ %i.dq, %.split299 ], [ %i.dv, %_ZN17double_conversionL7isDigitEii.exit.thread.i218 ], [ %i.dv, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit224 ]
  %.5139.ph = phi i64 [ %.0134, %.critedge ], [ %.0134, %bb.m ], [ %.2136, %bb.z ], [ %i.bb, %_ZN17double_conversionL7isDigitEii.exit.thread.i218 ], [ %i.bb, %.split299 ], [ %i.bb, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit224 ] ; 2 uses
  %.7.ph = phi i32 [ %.0128, %.critedge ], [ %.0128, %bb.m ], [ %.4132, %bb.z ], [ %spec.select148, %_ZN17double_conversionL7isDigitEii.exit.thread.i218 ], [ %spec.select148, %.split299 ], [ %spec.select148, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit224 ] ; 2 uses
  store i8 0, ptr %8, align 1, !tbaa !38
  br i1 %4, label %bb.af, label %bb.ap

bb.af:                                            ; preds = %.thread317, %_ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit.thread
  %i.ei = phi ptr [ %.promoted389, %.thread317 ], [ %i.eh, %_ZN17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S3_.exit.thread ] ; 5 uses
...
bb.ah:                                            ; preds = %bb.af
  %i.ek = load i8, ptr %i.ei, align 1, !tbaa !24  ; 3 uses
  ...
  br i1 %i.eo, label %_ZN17double_conversionL7isDigitEii.exit.thread.i231, label %switch.early.test354

switch.early.test354:                             ; preds = %bb.ah
  switch i8 %i.ek, label %_ZN17double_conversionL7isDigitEii.exit.thread1.i229 [
...
_ZN17double_conversionL7isDigitEii.exit.thread.i231: ; preds = %switch.early.test354, %switch.early.test354, %switch.early.test354, %switch.early.test354, %switch.early.test354, %switch.early.test354, %switch.early.test354, %switch.early.test354, %switch.early.test354, %switch.early.test354, %switch.early.test354, %switch.early.test354, %bb.ah
  %i.eq = getelementptr inbounds nuw i8, ptr %i.ei, i64 1 ; 7 uses
  store ptr %i.eq, ptr %0, align 8, !tbaa !17
  %i.er = icmp eq ptr %i.eq, %1
  br i1 %i.er, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit237thread-pre-split, label %bb.ai

bb.ai:                                            ; preds = %_ZN17double_conversionL7isDigitEii.exit.thread.i231
  %i.es = getelementptr inbounds nuw i8, ptr %i.ei, i64 2 ; 15 uses
  %i.et = icmp eq ptr %i.es, %1
  br i1 %i.et, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit237thread-pre-split, label %bb.aj

bb.aj:                                            ; preds = %bb.ai
  %i.eu = load i8, ptr %i.eq, align 1, !tbaa !24  ; 2 uses
  %i.ev = sext i8 %i.eu to i32
  %i.ew = icmp eq i32 %i.c, %i.ev
  br i1 %i.ew, label %bb.ak, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit237

bb.ak:                                            ; preds = %bb.aj
  %i.ex = load i8, ptr %i.es, align 1, !tbaa !24  ; 3 uses
  ...
  br i1 %i.fb, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit237thread-pre-split.sink.split, label %switch.early.test355

switch.early.test355:                             ; preds = %bb.ak
  switch i8 %i.ex, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit237thread-pre-split [
...
_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit237thread-pre-split.sink.split: ; preds = %bb.ak, %switch.early.test355, %switch.early.test355, %switch.early.test355, %switch.early.test355, %switch.early.test355, %switch.early.test355, %switch.early.test355, %switch.early.test355, %switch.early.test355, %switch.early.test355, %switch.early.test355, %switch.early.test355, %bb.ag, %_ZN17double_conversionL7isDigitEii.exit.thread1.i229
  %.sink518 = phi ptr [ %i.ej, %bb.ag ], [ %i.ep, %_ZN17double_conversionL7isDigitEii.exit.thread1.i229 ], [ %i.es, %switch.early.test355 ], [ %i.es, %switch.early.test355 ], [ %i.es, %switch.early.test355 ], [ %i.es, %switch.early.test355 ], [ %i.es, %switch.early.test355 ], [ %i.es, %switch.early.test355 ], [ %i.es, %switch.early.test355 ], [ %i.es, %switch.early.test355 ], [ %i.es, %switch.early.test355 ], [ %i.es, %switch.early.test355 ], [ %i.es, %switch.early.test355 ], [ %i.es, %switch.early.test355 ], [ %i.es, %bb.ak ] ; 2 uses
  store ptr %.sink518, ptr %0, align 8, !tbaa !17
  br label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit237thread-pre-split

_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit237thread-pre-split: ; preds = %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit237thread-pre-split.sink.split, %bb.ai, %_ZN17double_conversionL7isDigitEii.exit.thread.i231, %switch.early.test355
  %.ph472 = phi ptr [ %i.eq, %switch.early.test355 ], [ %i.eq, %bb.ai ], [ %i.eq, %_ZN17double_conversionL7isDigitEii.exit.thread.i231 ], [ %.sink518, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit237thread-pre-split.sink.split ] ; 2 uses
  %.pr473 = load i8, ptr %.ph472, align 1, !tbaa !24
  br label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit237

_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit237: ; preds = %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit237thread-pre-split, %bb.aj
  %i.fc = phi i8 [ %.pr473, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit237thread-pre-split ], [ %i.eu, %bb.aj ]
  %i.fd = phi ptr [ %.ph472, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit237thread-pre-split ], [ %i.eq, %bb.aj ] ; 2 uses
  switch i8 %i.fc, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit250 [
    i8 43, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit250.sink.split
    i8 45, label %bb.al
  ]

bb.al:                                            ; preds = %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit237
  br label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit250.sink.split

_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit250.sink.split: ; preds = %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit237, %bb.al
  %.0115.ph = phi i1 [ true, %bb.al ], [ false, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit237 ]
  %i.fe = getelementptr inbounds nuw i8, ptr %i.fd, i64 1 ; 2 uses
  store ptr %i.fe, ptr %0, align 8, !tbaa !17
  br label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit250

_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit250: ; preds = %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit250.sink.split, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit237
  %.promoted390 = phi ptr [ %i.fd, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit237 ], [ %i.fe, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit250.sink.split ] ; 2 uses
  %.0115 = phi i1 [ false, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit237 ], [ %.0115.ph, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit250.sink.split ]
  %i.ff = load i8, ptr %.promoted390, align 1, !tbaa !24
  %i.fg = sext i8 %i.ff to i32                    ; 2 uses
  %i.fh = add nsw i32 %i.fg, -48
  %or.cond.i264391 = icmp ult i32 %i.fh, 10
  br i1 %or.cond.i264391, label %.lr.ph393, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit277.thread

.lr.ph393:                                        ; preds = %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit250, %.backedge
  %i.fi = phi i32 [ %i.ft, %.backedge ], [ %i.fg, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit250 ]
  %.0111392 = phi i32 [ %.1112, %.backedge ], [ 0, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit250 ] ; 3 uses
  %i.fj = phi ptr [ %i.fr, %.backedge ], [ %.promoted390, %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit250 ] ; 2 uses
  ...
  store ptr %i.fp, ptr %0, align 8, !tbaa !17
  %i.fq = icmp eq ptr %i.fp, %1                   ; 2 uses
  br i1 %i.m, label %.split324, label %_ZN17double_conversionL7isDigitEii.exit.thread.i271

.split324:                                        ; preds = %.lr.ph393
  br i1 %i.fq, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit277.thread, label %.backedge

.backedge:                                        ; preds = %bb.an, %bb.am, %switch.early.test356, %.split324, %_ZN17double_conversionL7isDigitEii.exit30.thread.i276
  %i.fr = phi ptr [ %i.fp, %.split324 ], [ %i.fv, %_ZN17double_conversionL7isDigitEii.exit30.thread.i276 ], [ %i.fp, %switch.early.test356 ], [ %i.fp, %bb.am ], [ %i.fp, %bb.an ] ; 2 uses
  ...
  br i1 %or.cond.i264, label %.lr.ph393, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit277.thread, !llvm.loop !63

_ZN17double_conversionL7isDigitEii.exit.thread.i271: ; preds = %.lr.ph393
  br i1 %i.fq, label %_ZN17double_conversionL7AdvanceIPKcEEbPT_tiRS3_.exit277.thread, label %bb.am

bb.am:                                            ; preds = %_ZN17double_conversionL7isDigitEii.exit.thread.i271
  %i.fv = getelementptr inbounds nuw i8, ptr %i.fj, i64 2 ; 4 uses
  %i.fw = icmp eq ptr %i.fv, %1
  br i1 %i.fw, label %.backedge, label %bb.an

bb.an:                                            ; preds = %bb.am
  %i.fx = load i8, ptr %i.fp, align 1, !tbaa !24
  %i.fy = sext i8 %i.fx to i32
  %i.fz = icmp eq i32 %i.c, %i.fy
  br i1 %i.fz, label %bb.ao, label %.backedge

bb.ao:                                            ; preds = %bb.an
  %i.ga = load i8, ptr %i.fv, align 1, !tbaa !24  ; 3 uses
  ...
  br i1 %i.ge, label %_ZN17double_conversionL7isDigitEii.exit30.thread.i276, label %switch.early.test356

switch.early.test356:                             ; preds = %bb.ao
  switch i8 %i.ga, label %.backedge [
    i8 102, label %_ZN17double_conversionL7isDigitEii.exit30.thread.i276
    i8 101, label %_ZN17double_conversionL7isDigitEii.exit30.thread.i276
    i8 100, label %_ZN17double_conversionL7isDigitEii.exit30.thread.i276
    i8 99, label %_ZN17double_conversionL7isDigitEii.exit30.thread.i276
    i8 98, label %_ZN17double_conversionL7isDigitEii.exit30.thread.i276
    i8 97, label %_ZN17double_conversionL7isDigitEii.exit30.thread.i276
    i8 70, label %_ZN17double_conversionL7isDigitEii.exit30.thread.i276
    i8 69, label %_ZN17double_conversionL7isDigitEii.exit30.thread.i276
    i8 68, label %_ZN17double_conversionL7isDigitEii.exit30.thread.i276
    i8 67, label %_ZN17double_conversionL7isDigitEii.exit30.thread.i276
    i8 66, label %_ZN17double_conversionL7isDigitEii.exit30.thread.i276
    i8 65, label %_ZN17double_conversionL7isDigitEii.exit30.thread.i276
  ]

_ZN17double_conversionL7isDigitEii.exit30.thread.i276: ; preds = %switch.early.test356, %switch.early.test356, %switch.early.test356, %switch.early.test356, %switch.early.test356, %switch.early.test356, %switch.early.test356, %switch.early.test356, %switch.early.test356, %switch.early.test356, %switch.early.test356, %switch.early.test356, %bb.ao
  store ptr %i.fv, ptr %0, align 8, !tbaa !17
end_hunk_0
