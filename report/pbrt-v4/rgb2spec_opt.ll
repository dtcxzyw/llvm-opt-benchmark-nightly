...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i, %.lr.ph.preheader.i.i.i
  ...
  %2 = fsub double %i.bo, %i.br
  %3 = fmul double %i.av, f0x3ED2FCC27D8F32A0
  %i.bs = insertelement <2 x double> poison, double %3, i64 0
  %i.bt = insertelement <2 x double> %i.bs, double %2, i64 1
...
.lr.ph68.i.i.i:                                   ; preds = %.lr.ph68.i.i.i.preheader, %.lr.ph68.i.i.i
  ...
  %4 = fsub double %i.dt, %i.dw
  %5 = fmul double %i.da, f0x3ED2FCC27D8F32A0
  %i.dx = insertelement <2 x double> poison, double %5, i64 0
  %i.dy = insertelement <2 x double> %i.dx, double %4, i64 1
