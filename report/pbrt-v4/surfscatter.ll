...
bb.a:
  ...
  %.sroa.081.0.copyload = load <2 x float>, ptr %i.n, align 4 ; 8 uses
  %.sroa.282.0.copyload = load float, ptr %.sroa.282.0..sroa_idx, align 4 ; 5 uses
  ...
  %.sroa.073.0.copyload = load <2 x float>, ptr %i.m, align 4 ; 6 uses
  ...
  %4 = insertelement <2 x float> poison, float %.sroa.274.0.copyload, i64 0
  %5 = shufflevector <2 x float> %.sroa.073.0.copyload, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %i.do = insertelement <2 x float> %5, float %.sroa.274.0.copyload, i64 0
  ...
  %sqrt.i.i140 = tail call noundef float @llvm.sqrt.f32(float %i.dn) ; 2 uses
  %i.ed = insertelement <2 x float> poison, float %sqrt.i.i140, i64 0
  %i.ee = shufflevector <2 x float> %i.ed, <2 x float> poison, <2 x i32> zeroinitializer ; 3 uses
  %i.ef = fdiv <2 x float> %.sroa.081.0.copyload, %i.ee ; 6 uses
  %6 = fdiv float %.sroa.282.0.copyload, %sqrt.i.i140 ; 3 uses
  %7 = extractelement <2 x float> %i.ef, i64 1
  %8 = extractelement <2 x float> %i.ef, i64 0    ; 2 uses
  %9 = insertelement <2 x float> %4, float %6, i64 1 ; 2 uses
  %10 = shufflevector <2 x float> %i.ef, <2 x float> %.sroa.073.0.copyload, <2 x i32> <i32 1, i32 2>
  %i.eg = fmul <2 x float> %9, %10                ; 2 uses
  %i.eh = fneg <2 x float> %i.eg
  %11 = shufflevector <2 x float> %.sroa.073.0.copyload, <2 x float> %i.ef, <2 x i32> <i32 1, i32 2>
  %12 = shufflevector <2 x float> %9, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %i.ei = tail call <2 x float> @llvm.fma.v2f32(<2 x float> %11, <2 x float> %12, <2 x float> %i.eh)
  %13 = shufflevector <2 x float> %i.ef, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %14 = insertelement <2 x float> %13, float %6, i64 1
  %15 = tail call <2 x float> @llvm.fma.v2f32(<2 x float> %i.dp, <2 x float> %14, <2 x float> %i.eg)
  %16 = fadd <2 x float> %i.ei, %15
  %17 = fmul float %.sroa.01.4.vec.extract.i, %8  ; 2 uses
  %18 = fneg float %17
  %i.ej = tail call noundef float @llvm.fma.f32(float %.sroa.01.0.vec.extract.i, float %7, float %18)
  %i.ek = tail call noundef float @llvm.fma.f32(float %i.dq, float %8, float %17)
  %i.el = fadd float %i.ej, %i.ek
  %i.em = fmul <2 x float> %i.ef, %i.dr
  %i.en = fmul float %6, %i.ds
  %i.eo = fmul <2 x float> %16, %i.dt
