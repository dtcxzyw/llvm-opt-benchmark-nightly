...
bb.a:
  ...
  %8 = alloca %"class.pbrt::Transform", align 8   ; 17 uses
...
_ZN4pstd5arrayIN4pbrt6Point3IfEELi4EEC2ESt16initializer_listIS3_E.exit: ; preds = %bb.c, %_ZNK4pbrt9TransformclERKNS_3RayEPf.exit
  ...
  %i.em = getelementptr inbounds nuw i8, ptr %8, i64 16
  %i.en = getelementptr inbounds nuw i8, ptr %8, i64 24
  %i.eo = getelementptr inbounds nuw i8, ptr %8, i64 28
  ...
  %14 = load <4 x float>, ptr %12, align 4
  %i.ht = fmul <2 x float> %i.fx, %i.hs
  %i.hu = fmul <2 x float> %i.fz, %i.hr
  %i.hv = fadd <2 x float> %i.ht, %i.hu
  %i.hw = shufflevector <4 x float> %13, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.hx = fmul <2 x float> %i.hw, %i.gd
  %i.hy = fadd <2 x float> %i.hv, %i.hx
  %15 = shufflevector <4 x float> %14, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.hz = fadd <2 x float> %15, %i.hy             ; 2 uses
  ...
  %i.if = fadd <2 x float> %15, %i.ie             ; 2 uses
  ...
  %i.io = load <2 x float>, ptr %i.em, align 8, !tbaa !28 ; 3 uses
  %i.ip = shufflevector <2 x float> %i.io, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %16 = load <4 x float>, ptr %i.en, align 8
  %17 = load <4 x float>, ptr %i.eo, align 4
  %i.iq = fmul <2 x float> %i.fx, %i.ip
  %i.ir = fmul <2 x float> %i.fz, %i.io
  %i.is = fadd <2 x float> %i.iq, %i.ir
  %i.it = shufflevector <4 x float> %16, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.iu = fmul <2 x float> %i.it, %i.gd
  %i.iv = fadd <2 x float> %i.is, %i.iu
  %18 = shufflevector <4 x float> %17, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.iw = fadd <2 x float> %18, %i.iv             ; 2 uses
  ...
  %i.jc = fadd <2 x float> %18, %i.jb             ; 2 uses
