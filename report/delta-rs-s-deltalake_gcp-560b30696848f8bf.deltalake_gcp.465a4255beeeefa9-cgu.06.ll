...
begin_hunk_1
  ...
  %.val.i.i.i.i = load i8, ptr %1, align 1, !range !25, !alias.scope !19, !noalias !16 ; [#uses=4 type=i8]
  %16 = icmp samesign ult i8 %.val.i.i.i.i, 18    ; [#uses=1 type=i1]
  br i1 %16, label %.split.i, label %.split.us.i

.split.us.i:                                      ; preds = %6, %23
  %.sroa.9.0.i.us.i = phi i64 [ %24, %23 ], [ 0, %6 ] ; [#uses=1 type=i64]
  %.pn.i.us.i = phi i64 [ %25, %23 ], [ %8, %6 ]  ; [#uses=1 type=i64]
  %.sroa.01.0.i.us.i = and i64 %.pn.i.us.i, %12   ; [#uses=4 type=i64]
  %17 = getelementptr inbounds nuw i8, ptr %13, i64 %.sroa.01.0.i.us.i ; [#uses=1 type=ptr]
  %.sroa.0.0.copyload.i22.us.i = load <16 x i8>, ptr %17, align 1, !noalias !26 ; [#uses=2 type=<16 x i8>]
  %18 = icmp eq <16 x i8> %.sroa.0.0.copyload.i22.us.i, %15 ; [#uses=1 type=<16 x i1>]
  %19 = bitcast <16 x i1> %18 to i16              ; [#uses=3 type=i16]
  %.not.i.not28.us.i = icmp eq i16 %19, 0         ; [#uses=1 type=i1]
...
._crit_edge.split.us.us.i:                        ; preds = %_RNCINvMs6_NtCs3gpiEk3WpjL_9hashbrown3rawINtB8_8RawTableTNtNtNtCsjyY8HP3IvQ6_12object_store3gcp7builder15GoogleConfigKeyNtNtCs6Po7BT7Nknu_5alloc6string6StringEE4findNCINvNtBa_3map14equivalent_keyBS_BS_B1T_E0E0Cs62u4JVtZyFF_13deltalake_gcp.exit.thread.us.us.i, %.split.us.i
  %20 = icmp eq <16 x i8> %.sroa.0.0.copyload.i22.us.i, splat (i8 -1) ; [#uses=1 type=<16 x i1>]
  %21 = bitcast <16 x i1> %20 to i16              ; [#uses=1 type=i16]
  %22 = icmp eq i16 %21, 0                        ; [#uses=1 type=i1]
...
23:                                               ; preds = %._crit_edge.split.us.us.i
  %24 = add i64 %.sroa.9.0.i.us.i, 16             ; [#uses=2 type=i64]
  %25 = add i64 %.sroa.01.0.i.us.i, %24           ; [#uses=1 type=i64]
  br label %.split.us.i

.lr.ph.us.i:                                      ; preds = %.split.us.i
  %26 = tail call range(i16 0, 17) i16 @llvm.cttz.i16(i16 %19, i1 true) ; [#uses=1 type=i16]
  %27 = zext nneg i16 %26 to i64                  ; [#uses=1 type=i64]
  %28 = add i64 %.sroa.01.0.i.us.i, %27           ; [#uses=1 type=i64]
  %29 = and i64 %28, %12                          ; [#uses=1 type=i64]
  %30 = sub nsw i64 0, %29                        ; [#uses=2 type=i64]
  %31 = getelementptr inbounds [32 x i8], ptr %13, i64 %30 ; [#uses=1 type=ptr]
  %32 = getelementptr inbounds i8, ptr %31, i64 -32 ; [#uses=1 type=ptr]
  %.val2.i.us40.us.i = load i8, ptr %32, align 1, !range !25, !alias.scope !30, !noalias !33, !noundef !9 ; [#uses=1 type=i8]
  %33 = icmp eq i8 %.val2.i.us40.us.i, %.val.i.i.i.i ; [#uses=1 type=i1]
...
34:                                               ; preds = %_RNCINvMs6_NtCs3gpiEk3WpjL_9hashbrown3rawINtB8_8RawTableTNtNtNtCsjyY8HP3IvQ6_12object_store3gcp7builder15GoogleConfigKeyNtNtCs6Po7BT7Nknu_5alloc6string6StringEE4findNCINvNtBa_3map14equivalent_keyBS_BS_B1T_E0E0Cs62u4JVtZyFF_13deltalake_gcp.exit.thread.us.us.i
  %35 = tail call range(i16 0, 17) i16 @llvm.cttz.i16(i16 %44, i1 true) ; [#uses=1 type=i16]
  %36 = zext nneg i16 %35 to i64                  ; [#uses=1 type=i64]
  %37 = add i64 %.sroa.01.0.i.us.i, %36           ; [#uses=1 type=i64]
  %38 = and i64 %37, %12                          ; [#uses=1 type=i64]
  %39 = sub nsw i64 0, %38                        ; [#uses=2 type=i64]
  %40 = getelementptr inbounds [32 x i8], ptr %13, i64 %39 ; [#uses=1 type=ptr]
  %41 = getelementptr inbounds i8, ptr %40, i64 -32 ; [#uses=1 type=ptr]
  %.val2.i.us.us.i = load i8, ptr %41, align 1, !range !25, !alias.scope !30, !noalias !33, !noundef !9 ; [#uses=1 type=i8]
  %42 = icmp eq i8 %.val2.i.us.us.i, %.val.i.i.i.i ; [#uses=1 type=i1]
...
_RNCINvMs6_NtCs3gpiEk3WpjL_9hashbrown3rawINtB8_8RawTableTNtNtNtCsjyY8HP3IvQ6_12object_store3gcp7builder15GoogleConfigKeyNtNtCs6Po7BT7Nknu_5alloc6string6StringEE4findNCINvNtBa_3map14equivalent_keyBS_BS_B1T_E0E0Cs62u4JVtZyFF_13deltalake_gcp.exit.thread.us.us.i: ; preds = %.lr.ph.us.i, %34
  %.sroa.06.0.i29.us42.us.i = phi i16 [ %44, %34 ], [ %19, %.lr.ph.us.i ] ; [#uses=2 type=i16]
  %43 = add i16 %.sroa.06.0.i29.us42.us.i, -1     ; [#uses=1 type=i16]
  %44 = and i16 %43, %.sroa.06.0.i29.us42.us.i    ; [#uses=3 type=i16]
  %.not.i.not.us.us.i = icmp eq i16 %44, 0        ; [#uses=1 type=i1]
  br i1 %.not.i.not.us.us.i, label %._crit_edge.split.us.us.i, label %34

.split.i:                                         ; preds = %6, %61
  %.sroa.9.0.i.i = phi i64 [ %62, %61 ], [ 0, %6 ] ; [#uses=1 type=i64]
  %.pn.i.i = phi i64 [ %63, %61 ], [ %8, %6 ]     ; [#uses=1 type=i64]
  %.sroa.01.0.i.i = and i64 %.pn.i.i, %12         ; [#uses=3 type=i64]
  %45 = getelementptr inbounds nuw i8, ptr %13, i64 %.sroa.01.0.i.i ; [#uses=1 type=ptr]
  %.sroa.0.0.copyload.i22.i = load <16 x i8>, ptr %45, align 1, !noalias !26 ; [#uses=2 type=<16 x i8>]
  %46 = icmp eq <16 x i8> %.sroa.0.0.copyload.i22.i, %15 ; [#uses=1 type=<16 x i1>]
  %47 = bitcast <16 x i1> %46 to i16              ; [#uses=2 type=i16]
  %.not.i.not28.i = icmp eq i16 %47, 0            ; [#uses=1 type=i1]
...
.lr.ph.i:                                         ; preds = %.split.i, %_RNCINvMs6_NtCs3gpiEk3WpjL_9hashbrown3rawINtB8_8RawTableTNtNtNtCsjyY8HP3IvQ6_12object_store3gcp7builder15GoogleConfigKeyNtNtCs6Po7BT7Nknu_5alloc6string6StringEE4findNCINvNtBa_3map14equivalent_keyBS_BS_B1T_E0E0Cs62u4JVtZyFF_13deltalake_gcp.exit.thread.i
  %.sroa.06.0.i29.i = phi i16 [ %60, %_RNCINvMs6_NtCs3gpiEk3WpjL_9hashbrown3rawINtB8_8RawTableTNtNtNtCsjyY8HP3IvQ6_12object_store3gcp7builder15GoogleConfigKeyNtNtCs6Po7BT7Nknu_5alloc6string6StringEE4findNCINvNtBa_3map14equivalent_keyBS_BS_B1T_E0E0Cs62u4JVtZyFF_13deltalake_gcp.exit.thread.i ], [ %47, %.split.i ] ; [#uses=3 type=i16]
  %48 = tail call range(i16 0, 17) i16 @llvm.cttz.i16(i16 %.sroa.06.0.i29.i, i1 true) ; [#uses=1 type=i16]
  %49 = zext nneg i16 %48 to i64                  ; [#uses=1 type=i64]
  %50 = add i64 %.sroa.01.0.i.i, %49              ; [#uses=1 type=i64]
  %51 = and i64 %50, %12                          ; [#uses=1 type=i64]
  %52 = sub nsw i64 0, %51                        ; [#uses=2 type=i64]
  %53 = getelementptr inbounds [32 x i8], ptr %13, i64 %52 ; [#uses=1 type=ptr]
  %54 = getelementptr inbounds i8, ptr %53, i64 -32 ; [#uses=1 type=ptr]
  %.val2.i.i = load i8, ptr %54, align 1, !range !25, !alias.scope !30, !noalias !33, !noundef !9 ; [#uses=1 type=i8]
  %55 = icmp eq i8 %.val.i.i.i.i, %.val2.i.i      ; [#uses=1 type=i1]
...
._crit_edge.split.i:                              ; preds = %_RNCINvMs6_NtCs3gpiEk3WpjL_9hashbrown3rawINtB8_8RawTableTNtNtNtCsjyY8HP3IvQ6_12object_store3gcp7builder15GoogleConfigKeyNtNtCs6Po7BT7Nknu_5alloc6string6StringEE4findNCINvNtBa_3map14equivalent_keyBS_BS_B1T_E0E0Cs62u4JVtZyFF_13deltalake_gcp.exit.thread.i, %.split.i
  %56 = icmp eq <16 x i8> %.sroa.0.0.copyload.i22.i, splat (i8 -1) ; [#uses=1 type=<16 x i1>]
  %57 = bitcast <16 x i1> %56 to i16              ; [#uses=1 type=i16]
  %58 = icmp eq i16 %57, 0                        ; [#uses=1 type=i1]
...
_RNCINvMs6_NtCs3gpiEk3WpjL_9hashbrown3rawINtB8_8RawTableTNtNtNtCsjyY8HP3IvQ6_12object_store3gcp7builder15GoogleConfigKeyNtNtCs6Po7BT7Nknu_5alloc6string6StringEE4findNCINvNtBa_3map14equivalent_keyBS_BS_B1T_E0E0Cs62u4JVtZyFF_13deltalake_gcp.exit.thread.i: ; preds = %.lr.ph.i
  %59 = add i16 %.sroa.06.0.i29.i, -1             ; [#uses=1 type=i16]
  %60 = and i16 %59, %.sroa.06.0.i29.i            ; [#uses=2 type=i16]
  %.not.i.not.i = icmp eq i16 %60, 0              ; [#uses=1 type=i1]
  br i1 %.not.i.not.i, label %._crit_edge.split.i, label %.lr.ph.i

61:                                               ; preds = %._crit_edge.split.i
  %62 = add i64 %.sroa.9.0.i.i, 16                ; [#uses=2 type=i64]
  %63 = add i64 %.sroa.01.0.i.i, %62              ; [#uses=1 type=i64]
  br label %.split.i

_RNvMsa_NtCs3gpiEk3WpjL_9hashbrown3rawNtB5_13RawTableInner10find_inner.exit.thread.i: ; preds = %.lr.ph.us.i, %34, %.lr.ph.i
  %.pre-phi = phi i64 [ %39, %34 ], [ %52, %.lr.ph.i ], [ %30, %.lr.ph.us.i ] ; [#uses=1 type=i64]
  %64 = getelementptr inbounds [32 x i8], ptr %13, i64 %.pre-phi ; [#uses=1 type=ptr]
...
_RINvMs6_NtCs3gpiEk3WpjL_9hashbrown3rawINtB6_8RawTableTNtNtNtCsjyY8HP3IvQ6_12object_store3gcp7builder15GoogleConfigKeyNtNtCs6Po7BT7Nknu_5alloc6string6StringEE4findNCINvNtB8_3map14equivalent_keyBQ_BQ_B1R_E0ECs62u4JVtZyFF_13deltalake_gcp.exit: ; preds = %._crit_edge.split.us.us.i, %._crit_edge.split.i, %_RNvMsa_NtCs3gpiEk3WpjL_9hashbrown3rawNtB5_13RawTableInner10find_inner.exit.thread.i
  %65 = phi ptr [ %64, %_RNvMsa_NtCs3gpiEk3WpjL_9hashbrown3rawNtB5_13RawTableInner10find_inner.exit.thread.i ], [ null, %._crit_edge.split.i ], [ null, %._crit_edge.split.us.us.i ] ; [#uses=2 type=ptr]
  %.not = icmp eq ptr %65, null                   ; [#uses=1 type=i1]
  %66 = getelementptr inbounds i8, ptr %65, i64 -24 ; [#uses=1 type=ptr]
  %.sroa.0.1 = select i1 %.not, ptr null, ptr %66 ; [#uses=1 type=ptr]
  br label %67
