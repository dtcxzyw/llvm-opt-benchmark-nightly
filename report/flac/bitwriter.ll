...
.thread268:                                       ; preds = %bb.an, %bb.as, %bb.at, %bb.aq, %bb.au
  ...
  %.in309.in = lshr i32 %2, 6
  %.in309 = and i32 %.in309.in, 63
...
.thread285:                                       ; preds = %bb.bs, %bb.bx, %bb.by, %bb.bv, %bb.bz
  ...
  %3 = trunc nuw i64 %1 to i32                    ; 3 uses
  %.in.in = lshr i32 %3, 12
  %.in = and i32 %.in.in, 63
...
bb.cj:                                            ; preds = %.thread292, %bb.ci
  ...
  %.in307.in = lshr i32 %3, 6
  %.in307 = and i32 %.in307.in, 63
...
bb.dd:                                            ; preds = %bb.dc
  ...
  %4 = trunc nuw nsw i64 %1 to i32                ; 4 uses
  %5 = lshr i32 %4, 18
  %i.we = and i32 %5, 63
...
bb.df:                                            ; preds = %bb.de
  ...
  %8 = trunc nuw nsw i64 %1 to i32                ; 5 uses
  %9 = lshr i32 %8, 24
  %i.wz = and i32 %9, 63
