...
bb.gn:                                            ; preds = %.lr.ph706, %bb.hd
  %i.xt = phi i64 [ 0, %.lr.ph706 ], [ %indvars.iv.next730, %bb.hd ] ; 2 uses
...
bb.hd:                                            ; preds = %bb.gn, %bb.go, %bb.gp, %bb.gq, %bb.gr, %bb.gu, %bb.gv, %bb.gw, %bb.gx, %bb.gy, %bb.gz, %bb.ha, %bb.hb, %bb.hc
  %indvars.iv.next730 = add nuw i64 %i.xt, 1      ; 2 uses
  %i.aag = icmp ugt i64 %i.xq, %indvars.iv.next730
...
.epil.preheader567:                               ; preds = %._crit_edge86.unr-lcssa, %.lr.ph85
  ...
  %i.qo = add nuw i32 %.025582.epil.init, 1
  ...
  %i.qv = add nuw i32 %.025582.epil.init, 2
...
.epil.preheader:                                  ; preds = %._crit_edge72.unr-lcssa, %.lr.ph71
  ...
  %i.uc = add nuw i32 %.024169.epil.init, 1
  ...
  %i.uk = add nuw i32 %.024169.epil.init, 2
