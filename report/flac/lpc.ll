...
.preheader155.preheader:                          ; preds = %bb.c
  ...
  %4 = fpext reassoc nsz arcp float %i.cy to double ; 7 uses
  %5 = load <2 x float>, ptr %i.cp, align 4, !tbaa !10
  %i.cz = load <2 x float>, ptr %i.cq, align 4, !tbaa !10
  %i.da = fpext <2 x float> %5 to <2 x double>    ; 6 uses
  %i.db = extractelement <2 x double> %i.da, i64 0 ; 2 uses
  %i.dc = fmul reassoc nsz arcp double %i.db, %4
  ...
  %6 = fmul reassoc nsz arcp double %i.dk, %4
  ...
  %i.dp = fmul reassoc nsz arcp double %i.do, %4
  ...
  %7 = fmul reassoc nsz arcp double %i.dt, %4
  ...
  %i.dx = fmul reassoc nsz arcp double %i.dw, %4
  %i.dy = shufflevector <2 x double> %i.du, <2 x double> poison, <2 x i32> <i32 1, i32 1> ; 4 uses
  %i.dz = insertelement <2 x double> %i.df, double %4, i64 0 ; 2 uses
  ...
  %i.fe = insertelement <2 x double> %i.da, double %4, i64 1
...
.preheader167.preheader:                          ; preds = %bb.d
  ...
  %8 = insertelement <2 x double> %i.ly, double 0.000000e+00, i64 1
  %9 = tail call reassoc nsz arcp <2 x double> @llvm.fmuladd.v2f64(<2 x double> %8, <2 x double> %i.kv, <2 x double> %i.kn)
  %10 = shufflevector <2 x double> %9, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %11 = load <2 x float>, ptr %i.jc, align 4, !tbaa !10
  %12 = fpext <2 x float> %i.lx to <2 x double>   ; 4 uses
  %i.ma = shufflevector <2 x double> %12, <2 x double> poison, <2 x i32> zeroinitializer ; 5 uses
  %i.mb = tail call reassoc nsz arcp <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ma, <2 x double> %i.km, <2 x double> %10)
  %i.mc = load <2 x float>, ptr %i.je, align 4, !tbaa !10
  %i.md = fpext <2 x float> %11 to <2 x double>   ; 4 uses
  ...
  %13 = insertelement <2 x double> %i.md, double -0.000000e+00, i64 1
  %14 = tail call reassoc nsz arcp <2 x double> @llvm.fmuladd.v2f64(<2 x double> %13, <2 x double> %i.lf, <2 x double> %i.la)
  %15 = shufflevector <2 x double> %14, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %16 = load <2 x float>, ptr %i.jf, align 4, !tbaa !10
  %17 = fpext <2 x float> %i.mc to <2 x double>   ; 3 uses
  %i.mg = shufflevector <2 x double> %17, <2 x double> poison, <2 x i32> zeroinitializer ; 6 uses
  %i.mh = tail call reassoc nsz arcp <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.mg, <2 x double> %i.ke, <2 x double> %i.mf)
  %i.mi = tail call reassoc nsz arcp <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.mg, <2 x double> %i.km, <2 x double> %15)
  %i.mj = load <2 x float>, ptr %i.jj, align 4, !tbaa !10
  %i.mk = fpext <2 x float> %16 to <2 x double>   ; 4 uses
  ...
  %18 = insertelement <2 x double> %i.mk, double 0.000000e+00, i64 1
  %19 = tail call reassoc nsz arcp <2 x double> @llvm.fmuladd.v2f64(<2 x double> %18, <2 x double> %i.lk, <2 x double> %i.lj)
  %20 = load <2 x float>, ptr %i.jk, align 4, !tbaa !10
  %21 = fpext <2 x float> %i.mj to <2 x double>   ; 3 uses
  %22 = shufflevector <2 x double> %21, <2 x double> poison, <2 x i32> zeroinitializer ; 7 uses
  %23 = tail call reassoc nsz arcp <2 x double> @llvm.fmuladd.v2f64(<2 x double> %22, <2 x double> %i.kq, <2 x double> %i.mm)
  %i.mo = tail call reassoc nsz arcp <2 x double> @llvm.fmuladd.v2f64(<2 x double> %22, <2 x double> %i.le, <2 x double> %i.mn)
  %i.mp = tail call reassoc nsz arcp <2 x double> @llvm.fmuladd.v2f64(<2 x double> %22, <2 x double> %i.ll, <2 x double> %19)
  %24 = fpext <2 x float> %20 to <2 x double>     ; 5 uses
  %i.mq = shufflevector <2 x double> %24, <2 x double> poison, <2 x i32> zeroinitializer ; 7 uses
  %i.mr = tail call reassoc nsz arcp <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.mq, <2 x double> %i.ks, <2 x double> %23)
  %i.ms = tail call reassoc nsz arcp <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.mq, <2 x double> %i.lg, <2 x double> %i.mo)
  %i.mt = tail call reassoc nsz arcp <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.mq, <2 x double> %i.lm, <2 x double> %i.mp)
  %i.mu = shufflevector <2 x double> %24, <2 x double> poison, <2 x i32> <i32 1, i32 1> ; 3 uses
  ...
  %25 = fpext reassoc nsz arcp float %i.nb to double ; 7 uses
  %26 = load <2 x float>, ptr %i.in, align 4, !tbaa !10
  %i.nc = fpext <2 x float> %26 to <2 x double>   ; 12 uses
  %i.nd = shufflevector <2 x double> %i.nc, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %i.ne = extractelement <2 x double> %i.nc, i64 0 ; 2 uses
  %27 = fmul reassoc nsz arcp double %i.ne, %25
  %i.nf = extractelement <2 x double> %i.nc, i64 1
  %i.ng = fmul reassoc nsz arcp double %i.nf, %25
  %i.nh = fmul reassoc nsz arcp double %i.jp, %25
  %i.ni = fmul reassoc nsz arcp double %i.lq, %25
  %i.nj = insertelement <2 x double> %i.nc, double %25, i64 1
  ...
  %i.nu = tail call reassoc nsz arcp <2 x double> @llvm.fmuladd.v2f64(<2 x double> %22, <2 x double> %i.ky, <2 x double> %i.nt)
  ...
  %i.nx = fmul reassoc nsz arcp double %i.nw, %25
  %i.ny = insertelement <2 x double> %i.mx, double %25, i64 1 ; 2 uses
  ...
  %i.oi = insertelement <2 x double> %i.od, double %27, i64 0
  ...
  %i.or = insertelement <2 x double> %i.oq, double %i.nx, i64 1
  ...
  %i.pi = tail call reassoc nsz arcp <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.me, <2 x double> %12, <2 x double> %i.pe)
  ...
  %i.pn = shufflevector <2 x double> %12, <2 x double> %i.ly, <2 x i32> <i32 0, i32 2>
  ...
  %i.pq = tail call reassoc nsz arcp <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ml, <2 x double> %17, <2 x double> %i.pm)
  %i.pr = shufflevector <2 x double> %i.md, <2 x double> %12, <2 x i32> <i32 0, i32 2>
  ...
  %i.pu = tail call reassoc nsz arcp <2 x double> @llvm.fmuladd.v2f64(<2 x double> %22, <2 x double> %i.mk, <2 x double> %i.pq)
  %i.pv = shufflevector <2 x double> %17, <2 x double> %i.kb, <2 x i32> <i32 0, i32 2>
  %i.pw = tail call reassoc nsz arcp <2 x double> @llvm.fmuladd.v2f64(<2 x double> %22, <2 x double> %i.pv, <2 x double> %i.ps)
  %i.px = tail call reassoc nsz arcp <2 x double> @llvm.fmuladd.v2f64(<2 x double> %22, <2 x double> %i.jy, <2 x double> %i.pt)
  %i.py = tail call reassoc nsz arcp <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.mq, <2 x double> %21, <2 x double> %i.pu)
  ...
  %i.qc = tail call reassoc nsz arcp <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.mu, <2 x double> %24, <2 x double> %i.py)
  %i.qd = shufflevector <2 x double> %i.qc, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  store <2 x double> %i.qd, ptr %3, align 8, !tbaa !17
  %i.qe = insertelement <2 x double> %21, double %i.my, i64 1
  ...
  %i.qg = shufflevector <2 x double> %24, <2 x double> poison, <2 x i32> <i32 1, i32 1> ; 5 uses
  ...
  %i.qw = insertelement <2 x double> %24, double -0.000000e+00, i64 1
...
.preheader161.preheader:                          ; preds = %bb.d
  ...
  %i.th = fpext <2 x float> %i.tg to <2 x double> ; 13 uses
  %i.ti = extractelement <2 x double> %i.th, i64 1
  %i.tj = fpext <2 x float> %i.te to <2 x double> ; 4 uses
  %28 = shufflevector <2 x double> %i.th, <2 x double> %i.ru, <2 x i32> <i32 1, i32 2>
  %i.tk = shufflevector <2 x double> %i.th, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %29 = fmul reassoc nsz arcp <2 x double> %28, %i.tk ; 2 uses
  %i.tl = fmul reassoc nsz arcp <2 x double> %i.rx, %i.th
  %i.tm = insertelement <2 x double> poison, double %i.rh, i64 0
  %30 = shufflevector <2 x double> %i.tm, <2 x double> %i.tl, <2 x i32> <i32 0, i32 2>
  %i.tn = tail call reassoc nsz arcp <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.sb, <2 x double> %i.th, <2 x double> %30)
  ...
  %foldExtExtBinop522 = fmul reassoc nsz arcp <2 x double> %i.sm, %i.th
  %31 = extractelement <2 x double> %foldExtExtBinop522, i64 0
  ...
  %32 = shufflevector <2 x double> %29, <2 x double> %i.tv, <2 x i32> <i32 0, i32 3>
  %i.ty = tail call reassoc nsz arcp <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.tw, <2 x double> %i.tx, <2 x double> %32)
  ...
  %i.ub = tail call reassoc nsz arcp double @llvm.fmuladd.f64(double %i.so, double %i.ti, double %31)
  ...
  %33 = shufflevector <2 x double> %29, <2 x double> %i.tv, <2 x i32> <i32 1, i32 2>
