...
bb.h:                                             ; preds = %.preheader52, %bb.h
  ...
  %3 = uitofp nsz nneg i32 %i.av to double
  %4 = sitofp reassoc nsz arcp i32 %i.ay to double
  %i.az = insertelement <2 x double> poison, double %3, i64 0
  %i.ba = insertelement <2 x double> %i.az, double %4, i64 1
...
bb.j:                                             ; preds = %.preheader, %bb.j
  ...
  %5 = uitofp nsz nneg i32 %i.ce to double
  %6 = sitofp reassoc nsz arcp i32 %i.ch to double
  %i.ci = insertelement <2 x double> poison, double %5, i64 0
  %i.cj = insertelement <2 x double> %i.ci, double %6, i64 1
