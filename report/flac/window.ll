...
scalar.ph73:                                      ; preds = %scalar.ph73.preheader, %scalar.ph73
  ...
  %i.am = uitofp nsz nneg i32 %i.al to float
...
scalar.ph103:                                     ; preds = %scalar.ph103.preheader, %scalar.ph103
  ...
  %i.bi = uitofp nsz nneg i32 %i.bh to float
...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %i.f = uitofp nsz nneg i32 %i.e to float
...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %i.h = uitofp nsz nneg i32 %i.g to double
...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  %indvars.iv = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next, %bb.b ] ; 3 uses
  %i.g = trunc nuw nsw i64 %indvars.iv to i32
  %i.h = uitofp nsz nneg i32 %i.g to double       ; 2 uses
...
.lr.ph:                                           ; preds = %.lr.ph.preheader18, %.lr.ph
  ...
  %i.q = uitofp nsz nneg i32 %i.p to double
...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %i.k = uitofp nsz nneg i32 %i.j to double
...
bb.c:                                             ; preds = %.lr.ph24, %bb.c
  ...
  %i.s = uitofp nsz nneg i32 %i.r to double
...
bb.b:                                             ; preds = %bb.b, %.lr.ph.new
  ...
  %i.p = uitofp nsz nneg i32 %i.o to double
...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %i.i = uitofp nsz nneg i32 %i.h to double       ; 2 uses
...
bb.h:                                             ; preds = %.preheader52, %bb.h
  ...
  %i.ba = uitofp nsz nneg i32 %i.av to double
...
bb.j:                                             ; preds = %.preheader, %bb.j
  ...
  %i.cl = uitofp nsz nneg i32 %i.cg to double
...
.epil.preheader:                                  ; preds = %FLAC__window_rectangle.exit.loopexit99.unr-lcssa, %.lr.ph.i32
  ...
  %i.db = uitofp nsz nneg i32 %i.da to double
...
.epil.preheader341:                               ; preds = %.preheader96.loopexit.unr-lcssa, %.lr.ph127
  ...
  %i.dj = uitofp nsz nneg i32 %.0.i71126.epil.init to double
...
bb.g:                                             ; preds = %bb.g, %.lr.ph127.new
  ...
  %i.ec = uitofp nsz nneg i32 %.0.i71126 to double
  ...
  %i.ek = uitofp nsz nneg i32 %i.ej to double
...
.epil.preheader351:                               ; preds = %.preheader91.loopexit.unr-lcssa, %.lr.ph147
  ...
  %i.gx = uitofp nsz nneg i32 %.0.i79146.epil.init to double
...
bb.k:                                             ; preds = %bb.k, %.lr.ph147.new
  ...
  %i.hq = uitofp nsz nneg i32 %.0.i79146 to double
  ...
  %i.hy = uitofp nsz nneg i32 %i.hx to double
...
.epil.preheader361:                               ; preds = %.preheader86.loopexit.unr-lcssa, %.lr.ph167
  ...
  %i.kk = uitofp nsz nneg i32 %.0166.epil.init to double
...
bb.n:                                             ; preds = %bb.n, %.lr.ph167.new
  ...
  %i.ld = uitofp nsz nneg i32 %.0166 to double
  ...
  %i.ll = uitofp nsz nneg i32 %i.lk to double
...
.epil.preheader:                                  ; preds = %.preheader103.loopexit.unr-lcssa, %.lr.ph
  ...
  %i.w = uitofp nsz nneg i32 %.0109.epil.init to double
  %i.x = fmul reassoc nnan nsz arcp double %i.w, f0x400921FB54442D18
...
bb.e:                                             ; preds = %bb.e, %.lr.ph.new
  ...
  %i.ak = uitofp nsz nneg i32 %.0109 to double
  ...
  %i.as = uitofp nsz nneg i32 %i.ar to double
...
.epil.preheader190:                               ; preds = %.preheader99.loopexit.unr-lcssa, %.lr.ph126
  ...
  %i.dh = uitofp nsz nneg i32 %.2125.epil.init to double
...
bb.g:                                             ; preds = %bb.g, %.lr.ph126.new
  ...
  %i.eb = uitofp nsz nneg i32 %.2125 to double
  ...
  %i.ej = uitofp nsz nneg i32 %i.ei to double
