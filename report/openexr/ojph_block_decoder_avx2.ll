...
bb.bt:                                            ; preds = %bb.bs, %bb.br
  ...
  %16 = shufflevector <8 x i16> %i.ane, <8 x i16> %i.ani, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  ...
  %17 = shufflevector <8 x i16> %i.anm, <8 x i16> %i.anq, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %.inner1680 = or <16 x i16> %17, %16            ; 2 uses
  %i.anr = add <16 x i16> %.inner1680, splat (i16 -1)
  ...
  %.inner1681 = select <16 x i1> %.not1705, <16 x i16> zeroinitializer, <16 x i16> %.inner1680
...
bb.cc:                                            ; preds = %bb.cb, %bb.ca
  ...
  %18 = shufflevector <8 x i16> %i.avf, <8 x i16> %i.avj, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  ...
  %19 = shufflevector <8 x i16> %i.avn, <8 x i16> %i.avr, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %.inner1695 = or <16 x i16> %19, %18            ; 2 uses
  %i.avs = add <16 x i16> %.inner1695, splat (i16 -1)
  ...
  %.inner1695.a = select <16 x i1> %.not1706, <16 x i16> zeroinitializer, <16 x i16> %.inner1695
