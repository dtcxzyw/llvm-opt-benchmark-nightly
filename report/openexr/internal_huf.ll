...
._crit_edge.i:                                    ; preds = %.lr.ph248.i.prol.loopexit, %.lr.ph248.i, %.lr.ph252.i
  ...
  %i.fa = sub nuw nsw i64 %.pre179, %indvars.iv296.i
  %i.fb = shl i64 2, %i.fa
...
bb.x:                                             ; preds = %bb.w
  ...
  %i.dq = sub nuw nsw i32 %.10200, %i.dk
...
bb.ap:                                            ; preds = %bb.ao
  ...
  %i.hf = sub nuw nsw i32 %.14204, %i.gz
...
bb.m:                                             ; preds = %._crit_edge
  ...
  %i.cf = sub nuw nsw i32 %.5211.lcssa, %i.br     ; 5 uses
