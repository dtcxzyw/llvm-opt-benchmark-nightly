...
bb.i:                                             ; preds = %bb.h
  ...
  %.not230.i = icmp samesign ugt i32 %i.i, %i.k   ; 2 uses
  br i1 %.not230.i, label %.critedge.preheader.i, label %.lr.ph.i
...
.lr.ph.i:                                         ; preds = %bb.i, %bb.y
  ...
  %.0131234.i = phi i64 [ %i.dp, %bb.y ], [ %i.aa, %bb.i ] ; 4 uses
  %.0190233.i = phi i32 [ %.2192.i, %bb.y ], [ 0, %bb.i ] ; 3 uses
  %.0193232.i = phi i64 [ %.2195.i, %bb.y ], [ 0, %bb.i ] ; 2 uses
  %.0198231.i = phi ptr [ %.2200.i, %bb.y ], [ %i.p, %bb.i ] ; 3 uses
  %.not149.i = icmp ult ptr %.0198231.i, %i.z
...
bb.k:                                             ; preds = %.lr.ph.i
  %i.bs = icmp slt i32 %.0190233.i, 6
  br i1 %i.bs, label %.lr.ph.i.i, label %fasthuf_read_bits.exit.i

.lr.ph.i.i:                                       ; preds = %bb.k, %.lr.ph.i.i
  %i.bt = phi ptr [ %i.bx, %.lr.ph.i.i ], [ %.0198231.i, %bb.k ] ; 2 uses
  %i.bu = phi i64 [ %i.ca, %.lr.ph.i.i ], [ %.0193232.i, %bb.k ]
  %i.bv = phi i32 [ %i.cb, %.lr.ph.i.i ], [ %.0190233.i, %bb.k ] ; 2 uses
  %i.bw = shl i64 %i.bu, 8
...
bb.s:                                             ; preds = %bb.r
  %.not150.i = icmp ult ptr %.6204.i, %i.z
...
fasthuf_read_bits.exit169.i:                      ; preds = %.lr.ph.i167.i, %bb.u
  ...
  %i.dg = add nuw nsw i64 %.0131234.i, 5
  %i.dh = add nuw nsw i64 %i.dg, %i.df
  br label %bb.w

bb.v:                                             ; preds = %bb.r
  %i.di = add i64 %.0131234.i, -58
  %i.dj = add i64 %i.di, %i.cg
  br label %bb.w

bb.w:                                             ; preds = %bb.v, %fasthuf_read_bits.exit169.i, %bb.q
  %i.dk = phi i8 [ %i.cq, %bb.q ], [ %i.bq, %fasthuf_read_bits.exit169.i ], [ %i.bq, %bb.v ]
  %i.dl = phi i8 [ %i.cm, %bb.q ], [ %i.br, %fasthuf_read_bits.exit169.i ], [ %i.br, %bb.v ]
  %.1199.i = phi ptr [ %.6204.i, %bb.q ], [ %.7205.i, %fasthuf_read_bits.exit169.i ], [ %.6204.i, %bb.v ]
  %.1194.i = phi i64 [ %.5.i, %bb.q ], [ %.6.i, %fasthuf_read_bits.exit169.i ], [ %.5.i, %bb.v ]
  %.1191.i = phi i32 [ %i.cd, %bb.q ], [ %i.dc, %fasthuf_read_bits.exit169.i ], [ %i.cd, %bb.v ]
  %.1132.i = phi i64 [ %.0131234.i, %bb.q ], [ %i.dh, %fasthuf_read_bits.exit169.i ], [ %i.dj, %bb.v ] ; 2 uses
...
bb.y:                                             ; preds = %bb.w, %bb.l
  ...
  %.2200.i = phi ptr [ %.6204.i, %bb.l ], [ %.1199.i, %bb.w ]
  %.2195.i = phi i64 [ %.5.i, %bb.l ], [ %.1194.i, %bb.w ]
  %.2192.i = phi i32 [ %i.cd, %bb.l ], [ %.1191.i, %bb.w ]
  %.2.i = phi i64 [ %.0131234.i, %bb.l ], [ %.1132.i, %bb.w ] ; 2 uses
...
bb.aa:                                            ; preds = %.critedge.preheader.i
  ...
  %.not154237.i = icmp ugt i8 %i.dq, %i.dr        ; 3 uses
  %.pre181 = zext i8 %i.dr to i64                 ; 16 uses
  br i1 %.not154237.i, label %._crit_edge250.i, label %.lr.ph239.preheader.i

.lr.ph239.preheader.i:                            ; preds = %bb.aa
  ...
  br i1 %min.iters.check258, label %.lr.ph239.i.preheader.a, label %vector.ph259

vector.ph259:                                     ; preds = %.lr.ph239.preheader.i
...
middle.block266:                                  ; preds = %vector.body263
  ...
  br i1 %cmp.n267, label %.lr.ph249.i.preheader, label %.lr.ph239.i.preheader.a

.lr.ph239.i.preheader.a:                          ; preds = %.lr.ph239.preheader.i, %middle.block266
  %indvars.iv.i.ph = phi i64 [ %i.ds, %.lr.ph239.preheader.i ], [ %i.dv, %middle.block266 ]
  br label %.lr.ph239.i.a

.lr.ph249.i.preheader:                            ; preds = %.lr.ph239.i.a, %middle.block266
  %i.ef = sub nsw i64 %i.ds, %.pre181
  br label %.lr.ph249.i

.lr.ph239.i.a:                                    ; preds = %.lr.ph239.i.preheader.a, %.lr.ph239.i.a
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %.lr.ph239.i.a ], [ %indvars.iv.i.ph, %.lr.ph239.i.preheader.a ] ; 5 uses
  ...
  br i1 %exitcond.not.i, label %.lr.ph249.i.preheader, label %.lr.ph239.i.a, !llvm.loop !74

._crit_edge250.i:                                 ; preds = %._crit_edge.i, %bb.aa
  %i.eo = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %.pre181
  store i64 0, ptr %i.eo, align 8, !tbaa !10
  %.not156.not251.i = icmp ugt i8 %i.dr, %i.dq
  br i1 %.not156.not251.i, label %.lr.ph254.preheader.i, label %.preheader208.i

.lr.ph254.preheader.i:                            ; preds = %._crit_edge250.i
  ...
  br i1 %i.es, label %.lr.ph254.i.epil.preheader, label %.lr.ph254.preheader.i.new

.lr.ph254.preheader.i.new:                        ; preds = %.lr.ph254.preheader.i
  %unroll_iter = and i64 %i.eq, -4
  br label %.lr.ph254.i

.lr.ph249.i:                                      ; preds = %.lr.ph249.i.preheader, %._crit_edge.i
  %indvar = phi i64 [ 0, %.lr.ph249.i.preheader ], [ %indvar.next, %._crit_edge.i ] ; 3 uses
  %indvars.iv293.i = phi i64 [ %i.ds, %.lr.ph249.i.preheader ], [ %indvars.iv.next294.i, %._crit_edge.i ] ; 5 uses
  %indvars.iv.next294.i = add nuw nsw i64 %indvars.iv293.i, 1 ; 3 uses
  %.not161242.not.i = icmp samesign ult i64 %indvars.iv293.i, %.pre181
  br i1 %.not161242.not.i, label %.lr.ph245.i.preheader, label %._crit_edge.i

.lr.ph245.i.preheader:                            ; preds = %.lr.ph249.i
  ...
  br i1 %lcmp.mod310.not, label %.lr.ph245.i.prol.loopexit, label %.lr.ph245.i.prol

.lr.ph245.i.prol:                                 ; preds = %.lr.ph245.i.preheader, %.lr.ph245.i.prol
  %indvars.iv288.i.prol = phi i64 [ %indvars.iv.next289.i.prol, %.lr.ph245.i.prol ], [ %indvars.iv.next294.i, %.lr.ph245.i.preheader ] ; 2 uses
  %.0125243.i.prol = phi double [ %i.ex, %.lr.ph245.i.prol ], [ 0.000000e+00, %.lr.ph245.i.preheader ]
  %prol.iter311 = phi i64 [ %prol.iter311.next, %.lr.ph245.i.prol ], [ 0, %.lr.ph245.i.preheader ]
  %i.ev = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %indvars.iv288.i.prol
  %i.ew = load double, ptr %i.ev, align 8, !tbaa !69
  %i.ex = fadd double %.0125243.i.prol, %i.ew     ; 3 uses
  %indvars.iv.next289.i.prol = add nuw nsw i64 %indvars.iv288.i.prol, 1 ; 2 uses
  %prol.iter311.next = add i64 %prol.iter311, 1   ; 2 uses
  %prol.iter311.cmp.not = icmp eq i64 %prol.iter311.next, %xtraiter309
  br i1 %prol.iter311.cmp.not, label %.lr.ph245.i.prol.loopexit, label %.lr.ph245.i.prol, !llvm.loop !75

.lr.ph245.i.prol.loopexit:                        ; preds = %.lr.ph245.i.prol, %.lr.ph245.i.preheader
  %.lcssa298.unr = phi double [ poison, %.lr.ph245.i.preheader ], [ %i.ex, %.lr.ph245.i.prol ]
  %indvars.iv288.i.unr = phi i64 [ %indvars.iv.next294.i, %.lr.ph245.i.preheader ], [ %indvars.iv.next289.i.prol, %.lr.ph245.i.prol ]
  %.0125243.i.unr = phi double [ 0.000000e+00, %.lr.ph245.i.preheader ], [ %i.ex, %.lr.ph245.i.prol ]
  %i.ey = add i64 %i.ef, %indvar
  %i.ez = icmp ugt i64 %i.ey, -8
  br i1 %i.ez, label %._crit_edge.i, label %.lr.ph245.i
...
._crit_edge.i:                                    ; preds = %.lr.ph245.i.prol.loopexit, %.lr.ph245.i, %.lr.ph249.i
  ...
  %i.fg = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %indvars.iv293.i
  store i64 %i.ff, ptr %i.fg, align 8, !tbaa !10
  %exitcond297.not.i = icmp eq i64 %indvars.iv293.i, %.pre181
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond297.not.i, label %._crit_edge250.i, label %.lr.ph249.i, !llvm.loop !76

.lr.ph245.i:                                      ; preds = %.lr.ph245.i.prol.loopexit, %.lr.ph245.i
  %indvars.iv288.i = phi i64 [ %indvars.iv.next289.i.7, %.lr.ph245.i ], [ %indvars.iv288.i.unr, %.lr.ph245.i.prol.loopexit ] ; 9 uses
  %.0125243.i = phi double [ %i.gk, %.lr.ph245.i ], [ %.0125243.i.unr, %.lr.ph245.i.prol.loopexit ]
  %i.fh = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %indvars.iv288.i
  %i.fi = load double, ptr %i.fh, align 8, !tbaa !69
  %i.fj = fadd double %.0125243.i, %i.fi
  %i.fk = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %indvars.iv288.i
  %i.fl = getelementptr inbounds nuw i8, ptr %i.fk, i64 8
  %i.fm = load double, ptr %i.fl, align 8, !tbaa !69
  %i.fn = fadd double %i.fj, %i.fm
  %i.fo = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %indvars.iv288.i
  %i.fp = getelementptr inbounds nuw i8, ptr %i.fo, i64 16
  %i.fq = load double, ptr %i.fp, align 8, !tbaa !69
  %i.fr = fadd double %i.fn, %i.fq
  %i.fs = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %indvars.iv288.i
  %i.ft = getelementptr inbounds nuw i8, ptr %i.fs, i64 24
  %i.fu = load double, ptr %i.ft, align 8, !tbaa !69
  %i.fv = fadd double %i.fr, %i.fu
  %i.fw = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %indvars.iv288.i
  %i.fx = getelementptr inbounds nuw i8, ptr %i.fw, i64 32
  %i.fy = load double, ptr %i.fx, align 8, !tbaa !69
  %i.fz = fadd double %i.fv, %i.fy
  %i.ga = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %indvars.iv288.i
  %i.gb = getelementptr inbounds nuw i8, ptr %i.ga, i64 40
  %i.gc = load double, ptr %i.gb, align 8, !tbaa !69
  %i.gd = fadd double %i.fz, %i.gc
  %i.ge = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %indvars.iv288.i
  %i.gf = getelementptr inbounds nuw i8, ptr %i.ge, i64 48
  %i.gg = load double, ptr %i.gf, align 8, !tbaa !69
  %i.gh = fadd double %i.gd, %i.gg
  %indvars.iv.next289.i.6 = add nuw nsw i64 %indvars.iv288.i, 7 ; 2 uses
  %i.gi = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %indvars.iv.next289.i.6
  %i.gj = load double, ptr %i.gi, align 8, !tbaa !69
  %i.gk = fadd double %i.gh, %i.gj                ; 2 uses
  %indvars.iv.next289.i.7 = add nuw nsw i64 %indvars.iv288.i, 8
  %exitcond292.not.i.7 = icmp eq i64 %indvars.iv.next289.i.6, %.pre181
  br i1 %exitcond292.not.i.7, label %._crit_edge.i, label %.lr.ph245.i, !llvm.loop !77

.preheader208.i.loopexit.unr-lcssa:               ; preds = %.lr.ph254.i
  %lcmp.mod313.not = icmp eq i64 %xtraiter312, 0
  br i1 %lcmp.mod313.not, label %.preheader208.i, label %.lr.ph254.i.epil.preheader

.lr.ph254.i.epil.preheader:                       ; preds = %.preheader208.i.loopexit.unr-lcssa, %.lr.ph254.preheader.i
  %.epil.init = phi i64 [ 0, %.lr.ph254.preheader.i ], [ %i.hf, %.preheader208.i.loopexit.unr-lcssa ]
  %indvars.iv298.i.epil.init = phi i64 [ %.pre181, %.lr.ph254.preheader.i ], [ %indvars.iv.next299.i.3, %.preheader208.i.loopexit.unr-lcssa ]
  %lcmp.mod314 = icmp ne i64 %xtraiter312, 0
  tail call void @llvm.assume(i1 %lcmp.mod314)
  br label %.lr.ph254.i.epil

.lr.ph254.i.epil:                                 ; preds = %.lr.ph254.i.epil, %.lr.ph254.i.epil.preheader
  %i.gl = phi i64 [ %.epil.init, %.lr.ph254.i.epil.preheader ], [ %i.go, %.lr.ph254.i.epil ]
  %indvars.iv298.i.epil = phi i64 [ %indvars.iv298.i.epil.init, %.lr.ph254.i.epil.preheader ], [ %indvars.iv.next299.i.epil, %.lr.ph254.i.epil ] ; 2 uses
  %epil.iter = phi i64 [ 0, %.lr.ph254.i.epil.preheader ], [ %epil.iter.next, %.lr.ph254.i.epil ]
  %indvars.iv.next299.i.epil = add nsw i64 %indvars.iv298.i.epil, -1 ; 2 uses
  %i.gm = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %indvars.iv298.i.epil
  %i.gn = load i64, ptr %i.gm, align 8, !tbaa !10
  %i.go = add i64 %i.gn, %i.gl                    ; 2 uses
  %i.gp = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %indvars.iv.next299.i.epil
  store i64 %i.go, ptr %i.gp, align 8, !tbaa !10
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter312
  br i1 %epil.iter.cmp.not, label %.preheader208.i, label %.lr.ph254.i.epil, !llvm.loop !78

.preheader208.i:                                  ; preds = %.preheader208.i.loopexit.unr-lcssa, %.lr.ph254.i.epil, %._crit_edge250.i
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(472) %i.e, i8 -1, i64 472, i1 false), !tbaa !10
  br i1 %.not154237.i, label %._crit_edge259.i, label %.lr.ph258.preheader.i

.lr.ph254.i:                                      ; preds = %.lr.ph254.i, %.lr.ph254.preheader.i.new
  %i.gq = phi i64 [ 0, %.lr.ph254.preheader.i.new ], [ %i.hf, %.lr.ph254.i ]
  %indvars.iv298.i = phi i64 [ %.pre181, %.lr.ph254.preheader.i.new ], [ %indvars.iv.next299.i.3, %.lr.ph254.i ] ; 5 uses
  %niter = phi i64 [ 0, %.lr.ph254.preheader.i.new ], [ %niter.next.3, %.lr.ph254.i ]
  %indvars.iv.next299.i = add nsw i64 %indvars.iv298.i, -1 ; 2 uses
  %i.gr = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %indvars.iv298.i
  %i.gs = load i64, ptr %i.gr, align 8, !tbaa !10
  %i.gt = add i64 %i.gs, %i.gq                    ; 2 uses
  %i.gu = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %indvars.iv.next299.i
  store i64 %i.gt, ptr %i.gu, align 8, !tbaa !10
  %indvars.iv.next299.i.1 = add nsw i64 %indvars.iv298.i, -2 ; 2 uses
  %i.gv = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %indvars.iv.next299.i
  %i.gw = load i64, ptr %i.gv, align 8, !tbaa !10
  %i.gx = add i64 %i.gw, %i.gt                    ; 2 uses
  %i.gy = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %indvars.iv.next299.i.1
  store i64 %i.gx, ptr %i.gy, align 8, !tbaa !10
  %indvars.iv.next299.i.2 = add nsw i64 %indvars.iv298.i, -3 ; 2 uses
  %i.gz = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %indvars.iv.next299.i.1
  %i.ha = load i64, ptr %i.gz, align 8, !tbaa !10
  %i.hb = add i64 %i.ha, %i.gx                    ; 2 uses
  %i.hc = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %indvars.iv.next299.i.2
  store i64 %i.hb, ptr %i.hc, align 8, !tbaa !10
  %indvars.iv.next299.i.3 = add nsw i64 %indvars.iv298.i, -4 ; 3 uses
  %i.hd = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %indvars.iv.next299.i.2
  %i.he = load i64, ptr %i.hd, align 8, !tbaa !10
  %i.hf = add i64 %i.he, %i.hb                    ; 3 uses
  %i.hg = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %indvars.iv.next299.i.3
  store i64 %i.hf, ptr %i.hg, align 8, !tbaa !10
  %niter.next.3 = add i64 %niter, 4               ; 2 uses
  %niter.ncmp.3.not = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3.not, label %.preheader208.i.loopexit.unr-lcssa, label %.lr.ph254.i, !llvm.loop !79

.lr.ph258.preheader.i:                            ; preds = %.preheader208.i
  %i.hh = zext i8 %i.dq to i64
  %i.hi = shl nuw nsw i64 %i.hh, 3                ; 2 uses
  %scevgep.i = getelementptr i8, ptr %i.e, i64 %i.hi
  %scevgep304.i = getelementptr i8, ptr %i.c, i64 %i.hi
  %narrow.i = sub nuw i8 %i.dr, %i.dq
  %i.hj = zext i8 %narrow.i to i64
  %i.hk = shl nuw nsw i64 %i.hj, 3
  %i.hl = add nuw nsw i64 %i.hk, 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep.i, ptr noundef nonnull align 8 dereferenceable(1) %scevgep304.i, i64 %i.hl, i1 false), !tbaa !10
  br label %._crit_edge259.i

._crit_edge259.i:                                 ; preds = %.lr.ph258.preheader.i, %.preheader208.i
  br i1 %.not230.i, label %.critedge164.i, label %.lr.ph266.i

.lr.ph266.i:                                      ; preds = %._crit_edge259.i
  %i.hm = zext nneg i32 %i.bo to i64
  %i.hn = getelementptr inbounds nuw i8, ptr %5, i64 12
  br label %bb.ab

bb.ab:                                            ; preds = %bb.aj, %.lr.ph266.i
  %.0264.i = phi i64 [ %i.aa, %.lr.ph266.i ], [ %i.ja, %bb.aj ] ; 5 uses
  %.3263.i = phi i32 [ 0, %.lr.ph266.i ], [ %.4.i, %bb.aj ] ; 3 uses
  %.3196262.i = phi i64 [ 0, %.lr.ph266.i ], [ %.4197.i, %bb.aj ] ; 2 uses
  %.3201261.i = phi ptr [ %i.p, %.lr.ph266.i ], [ %.4202.i, %bb.aj ] ; 2 uses
  %i.ho = icmp slt i32 %.3263.i, 6
  br i1 %i.ho, label %.lr.ph.i172.i, label %fasthuf_read_bits.exit174.i

.lr.ph.i172.i:                                    ; preds = %bb.ab, %.lr.ph.i172.i
  %i.hp = phi ptr [ %i.ht, %.lr.ph.i172.i ], [ %.3201261.i, %bb.ab ] ; 2 uses
  %i.hq = phi i64 [ %i.hw, %.lr.ph.i172.i ], [ %.3196262.i, %bb.ab ]
  %i.hr = phi i32 [ %i.hx, %.lr.ph.i172.i ], [ %.3263.i, %bb.ab ] ; 2 uses
  %i.hs = shl i64 %i.hq, 8
...
bb.ac:                                            ; preds = %fasthuf_read_bits.exit174.i
...
bb.af:                                            ; preds = %bb.ad
  %i.ih = trunc nuw nsw i64 %.0264.i to i32
...
bb.ag:                                            ; preds = %fasthuf_read_bits.exit174.i
...
fasthuf_read_bits.exit179.i:                      ; preds = %.lr.ph.i177.i, %bb.ah
  ...
  %i.iw = add nuw nsw i64 %.0264.i, 5
  %i.ix = add nuw nsw i64 %i.iw, %i.iv
  br label %bb.aj

bb.ai:                                            ; preds = %bb.ag
  %i.iy = add i64 %.0264.i, -58
  %i.iz = add i64 %i.iy, %i.ic
  br label %bb.aj

bb.aj:                                            ; preds = %bb.ai, %fasthuf_read_bits.exit179.i, %bb.af, %bb.ac
  %.4202.i = phi ptr [ %.8206.i, %bb.ac ], [ %.8206.i, %bb.af ], [ %.9.i, %fasthuf_read_bits.exit179.i ], [ %.8206.i, %bb.ai ] ; 2 uses
  %.4197.i = phi i64 [ %.7.i, %bb.ac ], [ %.7.i, %bb.af ], [ %.8.i, %fasthuf_read_bits.exit179.i ], [ %.7.i, %bb.ai ]
  %.4.i = phi i32 [ %i.hz, %bb.ac ], [ %i.hz, %bb.af ], [ %i.is, %fasthuf_read_bits.exit179.i ], [ %i.hz, %bb.ai ]
  %.1.i = phi i64 [ %.0264.i, %bb.ac ], [ %.0264.i, %bb.af ], [ %i.ix, %fasthuf_read_bits.exit179.i ], [ %i.iz, %bb.ai ] ; 2 uses
...
.critedge164.i:                                   ; preds = %bb.aj, %._crit_edge259.i
  %.3201.lcssa.i = phi ptr [ %i.p, %._crit_edge259.i ], [ %.4202.i, %bb.aj ] ; 2 uses
...
scalar.ph269:                                     ; preds = %vector.body271
  ...
  br i1 %.not154237.i, label %vector.body283, label %.lr.ph.preheader.i.i
...
bb.am:                                            ; preds = %bb.ap, %.lr.ph.i180.i
  %indvars.iv106.i.i = phi i64 [ %i.ko, %.lr.ph.i180.i ], [ %indvars.iv.next107.i.i, %bb.ap ] ; 6 uses
...
.critedge84.i.i:                                  ; preds = %bb.ap, %bb.aq
  ...
  br i1 %exitcond110.i.i, label %.critedge86.preheader.i.i, label %.lr.ph.i180.i, !llvm.loop !84
...
hufCanonicalCodeTable.exit.i:                     ; preds = %bb.bb
  %i.sy = ptrtoint ptr %.066.lcssa.i to i64
...
hufUnpackEncTable.exit:                           ; preds = %bb.av, %bb.ax, %getBits.exit49.i, %bb.az, %hufCanonicalCodeTable.exit.i
  %.1 = phi ptr [ %.066.lcssa.i, %hufCanonicalCodeTable.exit.i ], [ %i.p, %bb.az ], [ %i.p, %getBits.exit49.i ], [ %i.p, %bb.ax ], [ %i.p, %bb.av ]
  %.0 = phi i64 [ %i.ta, %hufCanonicalCodeTable.exit.i ], [ %i.nt, %bb.az ], [ %i.nt, %getBits.exit49.i ], [ %i.nt, %bb.ax ], [ %i.nt, %bb.av ]
  %i.tb = shl i64 %.0, 3
