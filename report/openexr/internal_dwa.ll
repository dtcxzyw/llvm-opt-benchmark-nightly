...
._crit_edge:                                      ; preds = %bb.x, %.preheader
  %.0128.lcssa = phi i64 [ 0, %.preheader ], [ %i.ga, %bb.x ] ; 2 uses
...
bb.h:                                             ; preds = %Classifier_match.exit.thread.us.i, %CscPrefixMap_find.exit.us.i
  %.086120.us.i = phi i64 [ 0, %CscPrefixMap_find.exit.us.i ], [ %i.co, %Classifier_match.exit.thread.us.i ] ; 2 uses
  %i.bz = getelementptr inbounds nuw [24 x i8], ptr %i.aw, i64 %.086120.us.i ; 5 uses
...
Classifier_match.exit.thread.us.i:                ; preds = %bb.m, %bb.l, %Classifier_match.exit.us.i, %bb.h
  %i.co = add nuw i64 %.086120.us.i, 1            ; 2 uses
...
bb.x:                                             ; preds = %.lr.ph, %bb.x
  %.0126199 = phi i64 [ 0, %.lr.ph ], [ %i.gb, %bb.x ] ; 2 uses
  %.0128198 = phi i64 [ 0, %.lr.ph ], [ %i.ga, %bb.x ]
  %i.fx = getelementptr inbounds nuw [24 x i8], ptr %i.z, i64 %.0126199
  %.val = load ptr, ptr %i.fx, align 8, !tbaa !87
  %i.fy = tail call i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %.val) #23
  %i.fz = add i64 %.0128198, 3
  %i.ga = add i64 %i.fz, %i.fy                    ; 2 uses
  %i.gb = add nuw i64 %.0126199, 1                ; 2 uses
...
bb.y:                                             ; preds = %.lr.ph211, %bb.ac
  ...
  %.1129209 = phi i64 [ %.0128.lcssa, %.lr.ph211 ], [ %.3131.ph, %bb.ac ] ; 3 uses
  %.0133208 = phi i64 [ 0, %.lr.ph211 ], [ %.2135.ph, %bb.ac ] ; 3 uses
  %.0137207 = phi i64 [ 0, %.lr.ph211 ], [ %.2139.ph, %bb.ac ] ; 3 uses
  %.0141206 = phi i64 [ 0, %.lr.ph211 ], [ %.2143.ph, %bb.ac ] ; 3 uses
...
bb.z:                                             ; preds = %bb.y
  ...
  %i.gn = add i64 %i.gm, %.1129209
  %i.go = add i64 %.0133208, 1
...
bb.ac:                                            ; preds = %bb.ab, %bb.aa, %bb.z
  ...
  %.2143.ph = phi i64 [ %i.gz, %bb.ab ], [ %.0141206, %bb.aa ], [ %.0141206, %bb.z ] ; 2 uses
  %.2139.ph = phi i64 [ %.0137207, %bb.ab ], [ %i.gt, %bb.aa ], [ %.0137207, %bb.z ] ; 2 uses
  %.2135.ph = phi i64 [ %.0133208, %bb.ab ], [ %.0133208, %bb.aa ], [ %i.go, %bb.z ] ; 2 uses
  %.3131.ph = phi i64 [ %.1129209, %bb.ab ], [ %.1129209, %bb.aa ], [ %i.gn, %bb.z ] ; 2 uses
...
._crit_edge212:                                   ; preds = %bb.ac, %DwaCompressor_classifyChannels.exit
  ...
  %.0141.lcssa = phi i64 [ 0, %DwaCompressor_classifyChannels.exit ], [ %.2143.ph, %bb.ac ]
  %.0137.lcssa = phi i64 [ 0, %DwaCompressor_classifyChannels.exit ], [ %.2139.ph, %bb.ac ] ; 5 uses
  %.0133.lcssa = phi i64 [ 0, %DwaCompressor_classifyChannels.exit ], [ %.2135.ph, %bb.ac ] ; 2 uses
  %.1129.lcssa = phi i64 [ %.0128.lcssa, %DwaCompressor_classifyChannels.exit ], [ %.3131.ph, %bb.ac ]
  %i.hf = tail call i64 @exr_compress_max_buffer_size(i64 noundef %.0137.lcssa) #21
  %i.hg = tail call i64 @exr_compress_max_buffer_size(i64 noundef %.0141.lcssa) #21
  %i.hh = mul i64 %.0133.lcssa, %i.s              ; 4 uses
  %i.hi = tail call i64 @exr_compress_max_buffer_size(i64 noundef %i.hh) #21
  %i.hj = add i64 %.1129.lcssa, 88
  %i.hk = add i64 %i.hj, %i.hf
  %i.hl = add i64 %i.hk, %i.hg
  %i.hm = add i64 %i.hl, %i.hi
  store i64 %i.hm, ptr %1, align 8, !tbaa !78
  %i.hn = mul i64 %.0133.lcssa, %i.r              ; 3 uses
