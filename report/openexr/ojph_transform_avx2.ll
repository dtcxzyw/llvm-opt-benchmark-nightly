...
bb.g:                                             ; preds = %bb.f, %bb.d, %bb.b
  ...
  %7 = load i16, ptr %6, align 4, !tbaa !11       ; 3 uses
  %8 = sext i16 %7 to i32
  %i.r = getelementptr inbounds nuw i8, ptr %0, i64 2
  %9 = load i16, ptr %i.r, align 2, !tbaa !11     ; 2 uses
  %10 = sext i16 %9 to i32
  %i.s = load i8, ptr %0, align 4, !tbaa !11      ; 4 uses
  %11 = insertelement <8 x i32> poison, i32 %8, i64 0
  %i.t = shufflevector <8 x i32> %11, <8 x i32> poison, <8 x i32> zeroinitializer ; 6 uses
  %12 = insertelement <8 x i32> poison, i32 %10, i64 0
  %13 = shufflevector <8 x i32> %12, <8 x i32> poison, <8 x i32> zeroinitializer ; 18 uses
  %i.u = icmp eq i16 %7, 1
...
bb.i:                                             ; preds = %bb.g
  %i.cs = icmp eq i16 %7, -1                      ; 2 uses
  %i.ct = icmp eq i16 %9, 1
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader
  ...
  %i.il = mul <8 x i32> %i.ik, %i.t
  %i.im = add <8 x i32> %i.il, %13
...
.lr.ph32.i.prol:                                  ; preds = %.lr.ph32.i.preheader
  ...
  %i.ja = mul <8 x i32> %i.iz, %i.t
  %i.jb = add <8 x i32> %i.ja, %13
...
.lr.ph32.i:                                       ; preds = %.lr.ph32.i.prol.loopexit, %.lr.ph32.i
  ...
  %i.jn = mul <8 x i32> %i.jm, %i.t
  %i.jo = add <8 x i32> %i.jn, %13
  ...
  %i.jy = mul <8 x i32> %i.jx, %i.t
  %i.jz = add <8 x i32> %i.jy, %13
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  %i.kl = mul <8 x i32> %i.kk, %i.t
  %i.km = add <8 x i32> %i.kl, %13
  ...
  %i.kw = mul <8 x i32> %i.kv, %i.t
  %i.kx = add <8 x i32> %i.kw, %13
