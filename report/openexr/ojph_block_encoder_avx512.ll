...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  %11 = lshr <16 x i32> %i.fz, splat (i32 1)
  %12 = and <16 x i32> %11, splat (i32 1)
  %13 = sub nuw nsw <16 x i32> %i.fg, %12
  ...
  %14 = lshr <16 x i32> %i.fz, splat (i32 2)
  %15 = and <16 x i32> %14, splat (i32 1)
  %16 = sub nuw nsw <16 x i32> %i.fg, %15
  ...
  %17 = lshr <16 x i32> %i.fz, splat (i32 3)
  %18 = and <16 x i32> %17, splat (i32 1)
  %19 = sub nuw nsw <16 x i32> %i.fg, %18
