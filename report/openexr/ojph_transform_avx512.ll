...
bb.a:
  ...
  %7 = load i16, ptr %6, align 4, !tbaa !8        ; 3 uses
  %8 = sext i16 %7 to i32
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 2
  %9 = load i16, ptr %i.a, align 2, !tbaa !8      ; 2 uses
  %10 = sext i16 %9 to i32
  %i.b = load i8, ptr %0, align 4, !tbaa !8       ; 4 uses
  %11 = insertelement <16 x i32> poison, i32 %8, i64 0
  %12 = shufflevector <16 x i32> %11, <16 x i32> poison, <16 x i32> zeroinitializer ; 6 uses
  %13 = insertelement <16 x i32> poison, i32 %10, i64 0
  %i.c = shufflevector <16 x i32> %13, <16 x i32> poison, <16 x i32> zeroinitializer ; 18 uses
...
bb.c:                                             ; preds = %bb.a
  %i.ch = icmp eq i16 %7, -1                      ; 2 uses
  %i.ci = icmp eq i16 %9, 1
