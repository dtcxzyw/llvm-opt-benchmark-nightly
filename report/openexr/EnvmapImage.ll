...
bb.m:                                             ; preds = %_ZNK9Imath_3_24Vec3IfE10normalizedEv.exit60, %_ZNK9Imath_3_24Vec3IfE10normalizedEv.exit
  ...
  %i.ce = fneg float %i.bz
  %9 = extractelement <2 x float> %i.cd, i64 1
  %i.cf = fmul float %9, %i.ce
  %10 = fneg float %.sroa.10.0
  %i.cg = fmul float %i.ca, %10
  ...
  %i.cj = insertelement <2 x float> poison, float %i.cf, i64 0
  %i.ck = insertelement <2 x float> %i.cj, float %i.cg, i64 1
