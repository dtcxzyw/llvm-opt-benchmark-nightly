...
bb.ce:                                            ; preds = %bb.k
  %i.qc = add i64 %i.bt, %.0185323                ; 2 uses
...
bb.cf:                                            ; preds = %bb.ce
  ...
  %i.qf = getelementptr inbounds nuw i8, ptr %.0190322, i64 %i.bt
  %i.qg = getelementptr inbounds nuw i8, ptr %.2183324, i64 %i.bt
  br label %.thread234

select.unfold:                                    ; preds = %..thread_crit_edge.us, %.lr.ph317, %.preheader261
  %.1191.lcssa = phi ptr [ %.0190322, %.preheader261 ], [ %.0190322, %.lr.ph317 ], [ %i.om, %..thread_crit_edge.us ]
  %.1186.lcssa = phi i64 [ %.0185323, %.preheader261 ], [ %.0185323, %.lr.ph317 ], [ %i.oj, %..thread_crit_edge.us ]
  %i.qh = getelementptr inbounds nuw i8, ptr %.2183324, i64 %i.bt
  br label %.thread234

.thread234:                                       ; preds = %select.unfold, %bb.cf, %bb.j
  %.3184241 = phi ptr [ %.2183324, %bb.j ], [ %i.qg, %bb.cf ], [ %i.qh, %select.unfold ]
  %.5240 = phi i64 [ %.0185323, %bb.j ], [ %i.qc, %bb.cf ], [ %.1186.lcssa, %select.unfold ] ; 3 uses
  %.5195239 = phi ptr [ %.0190322, %bb.j ], [ %i.qf, %bb.cf ], [ %.1191.lcssa, %select.unfold ]
...
.thread249.thread:                                ; preds = %._crit_edge300, %bb.cg, %.thread249
  %.7 = phi i64 [ %i.qo, %bb.cg ], [ %.5240, %.thread249 ], [ 0, %._crit_edge300 ]
  %i.qp = getelementptr inbounds nuw i8, ptr %0, i64 176
  store i64 %.7, ptr %i.qp, align 8, !tbaa !43
  br label %.thread247
...
bb.d:                                             ; preds = %.lr.ph.us, %bb.q
  ...
  %.0160342.us = phi ptr [ %i.af, %.lr.ph.us ], [ %i.kn, %bb.q ] ; 3 uses
  %.0161341.us = phi ptr [ %i.ae, %.lr.ph.us ], [ %i.km, %bb.q ] ; 2 uses
...
bb.q:                                             ; preds = %bb.p, %bb.o, %bb.n
  %i.km = getelementptr inbounds nuw i8, ptr %.0161341.us, i64 8
...
bb.r:                                             ; preds = %bb.c
  %i.ks = add i64 %i.x, %.0151359                 ; 2 uses
...
bb.s:                                             ; preds = %bb.r
  ...
  %i.ku = getelementptr inbounds nuw i8, ptr %.0171356, i64 %i.x
  %i.kv = getelementptr inbounds nuw i8, ptr %.0163357, i64 %i.x
  br label %.thread298
...
select.unfold:                                    ; preds = %._crit_edge.us, %.lr.ph351, %.preheader
  ...
  %i.kw = getelementptr inbounds nuw i8, ptr %.0163357, i64 %i.x
  br label %.thread298

.thread298:                                       ; preds = %select.unfold, %bb.s, %bb.b
  %.5156305 = phi i64 [ %.0151359, %bb.b ], [ %i.ks, %bb.s ], [ %.1152.lcssa, %select.unfold ]
  %.1164304 = phi ptr [ %.0163357, %bb.b ], [ %i.kv, %bb.s ], [ %i.kw, %select.unfold ]
  %.5176303 = phi ptr [ %.0171356, %bb.b ], [ %i.ku, %bb.s ], [ %.1172.lcssa, %select.unfold ]
...
bb.t:                                             ; preds = %.lr.ph371, %.critedge
  ...
  %.0146370 = phi i32 [ 0, %.lr.ph371 ], [ %i.ml, %.critedge ] ; 4 uses
...
.lr.ph365:                                        ; preds = %.lr.ph365.preheader, %bb.aa
  ...
  %.2165362 = phi ptr [ %i.lf, %.lr.ph365.preheader ], [ %.3166.ph, %bb.aa ] ; 4 uses
...
bb.w:                                             ; preds = %bb.v
  %i.lz = getelementptr inbounds nuw i8, ptr %.2165362, i64 %i.lt
  br label %bb.aa

bb.x:                                             ; preds = %bb.v
  %i.ma = udiv i32 %.0146370, %i.lw
  br label %bb.y

bb.y:                                             ; preds = %bb.u, %bb.x
  %.pn201.in = phi i32 [ %i.ma, %bb.x ], [ %.0146370, %bb.u ]
  %i.mb = add i64 %i.lr, %.7363                   ; 2 uses
...
bb.z:                                             ; preds = %bb.y
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %.1168361, ptr align 1 %.0162, i64 %i.lr, i1 false)
  %i.md = getelementptr inbounds nuw i8, ptr %.1168361, i64 %i.lr
  %i.me = getelementptr inbounds nuw i8, ptr %.2165362, i64 %i.lt
  %.pre = load i16, ptr %i.d, align 8, !tbaa !44
  br label %bb.aa

bb.aa:                                            ; preds = %bb.z, %bb.w, %.lr.ph365
  %i.mf = phi i16 [ %i.lg, %.lr.ph365 ], [ %i.lg, %bb.w ], [ %.pre, %bb.z ] ; 4 uses
  %.2169.ph = phi ptr [ %.1168361, %.lr.ph365 ], [ %.1168361, %bb.w ], [ %i.md, %bb.z ] ; 2 uses
  %.3166.ph = phi ptr [ %.2165362, %.lr.ph365 ], [ %i.lz, %bb.w ], [ %i.me, %bb.z ]
  %.8.ph = phi i64 [ %.7363, %.lr.ph365 ], [ %.7363, %bb.w ], [ %i.mb, %bb.z ] ; 2 uses
...
.critedge:                                        ; preds = %.critedge.loopexit, %bb.t
  ...
  %i.ml = add nuw nsw i32 %.0146370, 1            ; 2 uses
