...
bb.ca:                                            ; preds = %bb.ca, %.preheader76.preheader.i.us
  ...
  %4 = add nsw i32 %.065.i.us, 2                  ; 7 uses
  %5 = lshr i32 %3, %4
  %6 = and i32 %5, 1
  %7 = add nsw i32 %3, %i.in
  %8 = add nsw i32 %7, %6
  %9 = ashr i32 %8, %4                            ; 3 uses
  %10 = lshr i32 %i.hk, %4
  %11 = and i32 %10, 1
  %12 = add nsw i32 %i.hk, %i.in
  %i.io = add nsw i32 %12, %11
  %13 = ashr i32 %i.io, %4
  %i.ip = lshr i32 %i.hn, %4
  %i.iq = and i32 %i.ip, 1
  %i.ir = add nsw i32 %i.hn, %i.in
  %i.is = add nsw i32 %i.ir, %i.iq
  %i.it = ashr i32 %i.is, %4                      ; 3 uses
  %14 = sub nsw i32 %9, %i.it                     ; 2 uses
  %15 = add nsw i32 %14, 32                       ; 3 uses
  %i.iu = insertelement <4 x i32> poison, i32 %4, i64 0 ; 2 uses
  ...
  %i.jy = sub nsw i32 %i.it, %i.jx                ; 2 uses
  ...
  %i.kd = sub nsw i32 %9, %i.kc
  %i.ke = add nsw i32 %i.kd, 32                   ; 3 uses
  %18 = shufflevector <4 x i32> %i.jh, <4 x i32> %i.jk, <4 x i32> <i32 1, i32 2, i32 4, i32 5>
  %19 = shufflevector <4 x i32> %i.jp, <4 x i32> poison, <8 x i32> <i32 poison, i32 poison, i32 poison, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %20 = shufflevector <4 x i32> %i.jp, <4 x i32> %18, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  ...
  %i.kh = shufflevector <8 x i32> %i.kg, <8 x i32> %19, <8 x i32> <i32 0, i32 1, i32 11, i32 poison, i32 poison, i32 poison, i32 6, i32 7>
  %i.ki = insertelement <8 x i32> %i.kh, i32 %13, i64 3
  ...
  %i.kn = extractelement <4 x i32> %i.jk, i64 2   ; 2 uses
  %i.ko = extractelement <4 x i32> %i.jk, i64 3   ; 2 uses
  ...
  %21 = shufflevector <8 x i32> %i.km, <8 x i32> %i.kp, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 8, i32 9>
  %22 = tail call i32 @llvm.vector.reduce.smin.v8i32(<8 x i32> %21)
  %23 = tail call i32 @llvm.smin.i32(i32 %22, i32 %i.kn)
  %24 = tail call i32 @llvm.smin.i32(i32 %i.ko, i32 %15)
  %25 = tail call i32 @llvm.smin.i32(i32 %i.jz, i32 %i.kb)
  %26 = tail call i32 @llvm.smin.i32(i32 %i.ke, i32 %17)
  %i.kq = tail call i32 @llvm.smin.i32(i32 %23, i32 %24)
  %i.kr = tail call i32 @llvm.smin.i32(i32 %25, i32 %26)
  %i.ks = tail call i32 @llvm.smin.i32(i32 %i.kq, i32 %i.kr) ; 2 uses
  %i.kt = tail call i32 @llvm.vector.reduce.smax.v8i32(<8 x i32> %i.km)
  %i.ku = tail call i32 @llvm.smax.i32(i32 %i.kt, i32 %15)
  %i.kv = tail call i32 @llvm.smax.i32(i32 %i.jz, i32 %i.kb)
  %i.kw = tail call i32 @llvm.smax.i32(i32 %i.ke, i32 %17)
