...
.critedge.preheader:                              ; preds = %.thread298, %bb.a
  %i.g = phi i16 [ %i.e, %bb.a ], [ %i.kx, %.thread298 ] ; 2 uses
...
bb.b:                                             ; preds = %.lr.ph, %.thread298
  %indvars.iv379.a = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next380.a, %.thread298 ] ; 2 uses
...
.lr.ph.us:                                        ; preds = %.lr.ph.us.preheader, %._crit_edge.us
  %indvars.iv376 = phi i64 [ 0, %.lr.ph.us.preheader ], [ %indvars.iv.next377.a, %._crit_edge.us ] ; 5 uses
  ...
  %i.ai = icmp slt i64 %indvars.iv376, %invariant.op483.a
...
bb.d:                                             ; preds = %.lr.ph.us, %bb.q
  ...
  %.0154345.us = phi i32 [ 0, %.lr.ph.us ], [ %9, %bb.q ] ; 3 uses
  %.2174344.us = phi i64 [ %.1173348.us, %.lr.ph.us ], [ %.3175.us, %bb.q ] ; 2 uses
  %.0183343.us = phi ptr [ %i.ah, %.lr.ph.us ], [ %i.kp, %bb.q ] ; 2 uses
  %.0184342.us = phi ptr [ %i.ag, %.lr.ph.us ], [ %i.ko, %bb.q ] ; 3 uses
  %.0185341.us = phi ptr [ %i.af, %.lr.ph.us ], [ %i.kn, %bb.q ] ; 3 uses
  %.0186340.us = phi ptr [ %i.ae, %.lr.ph.us ], [ %i.km, %bb.q ] ; 2 uses
...
bb.k:                                             ; preds = %bb.j, %bb.i
  %5 = or disjoint i32 %.0154345.us, 3
  %i.kl = icmp slt i32 %5, %i.o
  %6 = sub nuw nsw i32 %i.o, %.0154345.us
  %7 = shl nuw i32 %6, 1
  %narrow = select i1 %i.kl, i32 8, i32 %7
  %8 = zext i32 %narrow to i64                    ; 6 uses
  call void @llvm.memcpy.p0.p0.i64(ptr align 2 %.0186340.us, ptr nonnull align 16 %i.a, i64 %8, i1 false)
...
bb.m:                                             ; preds = %bb.l
  call void @llvm.memcpy.p0.p0.i64(ptr align 2 %.0185341.us, ptr nonnull align 8 %.8..8..8..sroa_idx, i64 %8, i1 false)
  br label %bb.n
...
bb.o:                                             ; preds = %bb.n
  call void @llvm.memcpy.p0.p0.i64(ptr align 2 %.0184342.us, ptr nonnull align 16 %.16..16..16..sroa_idx, i64 %8, i1 false)
  br label %bb.q

bb.p:                                             ; preds = %bb.k
  call void @llvm.memcpy.p0.p0.i64(ptr align 2 %.0185341.us, ptr nonnull align 8 %.8..8..8..sroa_idx494, i64 %8, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr align 2 %.0184342.us, ptr nonnull align 16 %.16..16..16..sroa_idx500, i64 %8, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr align 2 %.0183343.us, ptr nonnull align 8 %.24..24..24..sroa_idx, i64 %8, i1 false)
  br label %bb.q

bb.q:                                             ; preds = %bb.p, %bb.o, %bb.n
  %i.km = getelementptr inbounds nuw i8, ptr %.0186340.us, i64 8
  %i.kn = getelementptr inbounds nuw i8, ptr %.0185341.us, i64 8
  %i.ko = getelementptr inbounds nuw i8, ptr %.0184342.us, i64 8
  %i.kp = getelementptr inbounds nuw i8, ptr %.0183343.us, i64 8
  %9 = add nuw nsw i32 %.0154345.us, 4            ; 2 uses
  %.not198.us = icmp slt i32 %9, %i.o
  br i1 %.not198.us, label %bb.d, label %._crit_edge.us, !llvm.loop !51

._crit_edge.us:                                   ; preds = %bb.q
  %indvars.iv.next377.a = add nuw nsw i64 %indvars.iv376, 4 ; 2 uses
  %i.kq = trunc nuw i64 %indvars.iv.next377.a to i32
  %i.kr = icmp sgt i32 %i.q, %i.kq
  br i1 %i.kr, label %.lr.ph.us, label %select.unfold, !llvm.loop !52

bb.r:                                             ; preds = %bb.c
  %i.ks = add i64 %i.x, %.0172356                 ; 2 uses
  %i.kt = icmp ugt i64 %i.ks, %2
  br i1 %i.kt, label %.thread306, label %bb.s

bb.s:                                             ; preds = %bb.r
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %.0160358, ptr align 1 %.0147360, i64 %i.x, i1 false)
  %i.ku = getelementptr inbounds nuw i8, ptr %.0147360, i64 %i.x
  %i.kv = getelementptr inbounds nuw i8, ptr %.0160358, i64 %i.x
  br label %.thread298
...
select.unfold:                                    ; preds = %._crit_edge.us, %.lr.ph351, %.preheader
  ...
  %i.kw = getelementptr inbounds nuw i8, ptr %.0160358, i64 %i.x
  br label %.thread298

.thread298:                                       ; preds = %select.unfold, %bb.s, %bb.b
  %.5152305 = phi ptr [ %.0147360, %bb.b ], [ %i.ku, %bb.s ], [ %.1148.lcssa, %select.unfold ]
  %.1161304 = phi ptr [ %.0160358, %bb.b ], [ %i.kv, %bb.s ], [ %i.kw, %select.unfold ]
  %.5177303 = phi i64 [ %.0172356, %bb.b ], [ %i.ks, %bb.s ], [ %.1173.lcssa, %select.unfold ]
  %indvars.iv.next380.a = add nuw nsw i64 %indvars.iv379.a, 1 ; 2 uses
  %i.kx = load i16, ptr %i.d, align 8, !tbaa !44  ; 2 uses
  %i.ky = sext i16 %i.kx to i64
  %.not199 = icmp slt i64 %indvars.iv.next380.a, %i.ky
  br i1 %.not199, label %bb.b, label %.critedge.preheader, !llvm.loop !53

bb.t:                                             ; preds = %.lr.ph371, %.critedge
  %i.kz = phi i32 [ %i.i, %.lr.ph371 ], [ %i.mi, %.critedge ]
  %i.la = phi i16 [ %i.g, %.lr.ph371 ], [ %i.mj, %.critedge ] ; 2 uses
  %i.lb = phi i16 [ %i.g, %.lr.ph371 ], [ %i.mk, %.critedge ] ; 2 uses
  %.0153370 = phi i32 [ 0, %.lr.ph371 ], [ %i.ml, %.critedge ] ; 4 uses
  %.0155369 = phi ptr [ %3, %.lr.ph371 ], [ %.1156.lcssa, %.critedge ] ; 2 uses
  %.6178368 = phi i64 [ 0, %.lr.ph371 ], [ %.7179.lcssa, %.critedge ] ; 2 uses
  %i.lc = load i32, ptr %i.j, align 8, !tbaa !54
  %i.ld = add nsw i32 %i.lc, %.0153370
  %i.le = icmp sgt i16 %i.lb, 0
  br i1 %i.le, label %.lr.ph365.preheader, label %.critedge

.lr.ph365.preheader:                              ; preds = %bb.t
  %i.lf = load ptr, ptr %i.b, align 8, !tbaa !49
  br label %.lr.ph365

.lr.ph365:                                        ; preds = %.lr.ph365.preheader, %bb.aa
  %i.lg = phi i16 [ %i.la, %.lr.ph365.preheader ], [ %i.mf, %bb.aa ] ; 2 uses
  ...
  %.2162362 = phi ptr [ %i.lf, %.lr.ph365.preheader ], [ %.3163.ph, %bb.aa ] ; 4 uses
  %.7179361 = phi i64 [ %.6178368, %.lr.ph365.preheader ], [ %.8180.ph, %bb.aa ] ; 3 uses
  %i.lh = load ptr, ptr %i.k, align 8, !tbaa !46
  %i.li = getelementptr inbounds nuw [48 x i8], ptr %i.lh, i64 %indvars.iv382 ; 4 uses
  ...
  %i.lm = load i32, ptr %i.ll, align 8, !tbaa !28
  %i.ln = sext i32 %i.lk to i64
  %i.lo = getelementptr inbounds nuw i8, ptr %i.li, i64 25
  %i.lp = load i8, ptr %i.lo, align 1, !tbaa !29
  %i.lq = sext i8 %i.lp to i64
  %i.lr = mul nsw i64 %i.lq, %i.ln                ; 5 uses
  %i.ls = sext i32 %i.lm to i64
  %i.lt = mul i64 %i.lr, %i.ls                    ; 3 uses
  %i.lu = icmp eq i64 %i.lt, 0
  br i1 %i.lu, label %bb.aa, label %bb.u

bb.u:                                             ; preds = %.lr.ph365
  %i.lv = getelementptr inbounds nuw i8, ptr %i.li, i64 20
  %i.lw = load i32, ptr %i.lv, align 4, !tbaa !30 ; 3 uses
  %i.lx = icmp sgt i32 %i.lw, 1
  br i1 %i.lx, label %bb.v, label %bb.y

bb.v:                                             ; preds = %bb.u
  %i.ly = srem i32 %i.ld, %i.lw
  %.not200 = icmp eq i32 %i.ly, 0
  br i1 %.not200, label %bb.x, label %bb.w

bb.w:                                             ; preds = %bb.v
  %i.lz = getelementptr inbounds nuw i8, ptr %.2162362, i64 %i.lt
  br label %bb.aa

bb.x:                                             ; preds = %bb.v
  %i.ma = udiv i32 %.0153370, %i.lw
  br label %bb.y

bb.y:                                             ; preds = %bb.u, %bb.x
  %.pn201.in = phi i32 [ %i.ma, %bb.x ], [ %.0153370, %bb.u ]
  %i.mb = add i64 %i.lr, %.7179361                ; 2 uses
  %i.mc = icmp ugt i64 %i.mb, %4
  br i1 %i.mc, label %.thread306, label %bb.z

bb.z:                                             ; preds = %bb.y
  %.pn201 = zext i32 %.pn201.in to i64
  %.pn = mul i64 %i.lr, %.pn201
  %.0182 = getelementptr inbounds nuw i8, ptr %.2162362, i64 %.pn
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %.1156363, ptr align 1 %.0182, i64 %i.lr, i1 false)
  %i.md = getelementptr inbounds nuw i8, ptr %.1156363, i64 %i.lr
  %i.me = getelementptr inbounds nuw i8, ptr %.2162362, i64 %i.lt
  %.pre = load i16, ptr %i.d, align 8, !tbaa !44
  br label %bb.aa

bb.aa:                                            ; preds = %bb.z, %bb.w, %.lr.ph365
  %i.mf = phi i16 [ %i.lg, %.lr.ph365 ], [ %i.lg, %bb.w ], [ %.pre, %bb.z ] ; 4 uses
  %.8180.ph = phi i64 [ %.7179361, %.lr.ph365 ], [ %.7179361, %bb.w ], [ %i.mb, %bb.z ] ; 2 uses
  %.3163.ph = phi ptr [ %.2162362, %.lr.ph365 ], [ %i.lz, %bb.w ], [ %i.me, %bb.z ]
  %.2157.ph = phi ptr [ %.1156363, %.lr.ph365 ], [ %.1156363, %bb.w ], [ %i.md, %bb.z ] ; 2 uses
  %indvars.iv.next383 = add nuw nsw i64 %indvars.iv382, 1 ; 2 uses
  %i.mg = sext i16 %i.mf to i64
  %i.mh = icmp slt i64 %indvars.iv.next383, %i.mg
  br i1 %i.mh, label %.lr.ph365, label %.critedge.loopexit, !llvm.loop !55
...
.critedge:                                        ; preds = %.critedge.loopexit, %bb.t
  %i.mi = phi i32 [ %i.kz, %bb.t ], [ %.pre465, %.critedge.loopexit ] ; 2 uses
  %i.mj = phi i16 [ %i.la, %bb.t ], [ %i.mf, %.critedge.loopexit ]
  %i.mk = phi i16 [ %i.lb, %bb.t ], [ %i.mf, %.critedge.loopexit ]
  %.7179.lcssa = phi i64 [ %.6178368, %bb.t ], [ %.8180.ph, %.critedge.loopexit ]
  %.1156.lcssa = phi ptr [ %.0155369, %bb.t ], [ %.2157.ph, %.critedge.loopexit ]
  %i.ml = add nuw nsw i32 %.0153370, 1            ; 2 uses
  %.not202 = icmp slt i32 %i.ml, %i.mi
  br i1 %.not202, label %bb.t, label %.critedge206, !llvm.loop !56

.critedge206:                                     ; preds = %.critedge, %.critedge.preheader
  %i.mm = getelementptr inbounds nuw i8, ptr %0, i64 104
  store i64 %4, ptr %i.mm, align 8, !tbaa !57
  br label %.thread306
