...
matchfinder_init_sse2.exit:                       ; preds = %matchfinder_init_sse2.exit.preheader, %bb.ar
  ...
  store i32 0, ptr %.ptr192, align 4, !tbaa !50
  br label %bb.c
...
.unr-lcssa:                                       ; preds = %.new533, %.prol.loopexit
  ...
  %i.aba = load <4 x i32>, ptr %i.ag, align 4, !tbaa !9
  store <4 x i32> %i.aba, ptr %i.ao, align 4, !tbaa !31
  %i.abb = load <4 x i32>, ptr %i.ai, align 4, !tbaa !9
  store <4 x i32> %i.abb, ptr %i.ap, align 4, !tbaa !31
  %i.abc = load <2 x i32>, ptr %i.ak, align 4, !tbaa !9
  store <2 x i32> %i.abc, ptr %i.aq, align 4, !tbaa !31
  %i.abd = load i32, ptr %i.am, align 4, !tbaa !99
  store i32 %i.abd, ptr %i.ar, align 8, !tbaa !31
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(40) %i.ag, i8 0, i64 40, i1 false), !tbaa !9
...
.lr.ph968.preheader:                              ; preds = %bb.az
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(144) %0, i8 8, i64 144, i1 false), !tbaa !31
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(112) %scevgep, i8 9, i64 112, i1 false), !tbaa !31
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(24) %scevgep1043, i8 7, i64 24, i1 false), !tbaa !31
  store i64 578721382704613384, ptr %scevgep1045, align 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(32) %scevgep1047, i8 5, i64 32, i1 false), !tbaa !31
  br label %.thread843
...
bb.bm:                                            ; preds = %._crit_edge1055, %bb.bl
  ...
  %i.nz = getelementptr inbounds nuw [4 x i8], ptr %i.o, i64 %i.ny
end_hunk_4
begin_hunk_5_@deflate_decompress_bmi2:bb.a
  %i.xj = getelementptr inbounds nuw [4 x i8], ptr %i.o, i64 %i.xi
  %i.xk = load i32, ptr %i.xj, align 4, !tbaa !9  ; 4 uses
  %i.xl = and i32 %i.xk, 32768
  %.not777 = icmp eq i32 %i.xl, 0
  br i1 %.not777, label %bb.dd, label %bb.dc, !prof !57
...
bb.dd:                                            ; preds = %bb.dc, %bb.db
  ...
  br i1 %.not780, label %.thread836, label %iter.check, !prof !53
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %next.gep, align 1, !tbaa !31
  %wide.load1149 = load <16 x i8>, ptr %i.ze, align 1, !tbaa !31
  %i.zf = getelementptr i8, ptr %next.gep1148, i64 16
  store <16 x i8> %wide.load, ptr %next.gep1148, align 1, !tbaa !31
  store <16 x i8> %wide.load1149, ptr %i.zf, align 1, !tbaa !31
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load1155 = load <4 x i8>, ptr %next.gep1153, align 1, !tbaa !31
  store <4 x i8> %wide.load1155, ptr %next.gep1154, align 1, !tbaa !31
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph
  ...
  %i.zl = load i8, ptr %.0578, align 1, !tbaa !31
  %i.zm = getelementptr inbounds nuw i8, ptr %.0, i64 1 ; 2 uses
  store i8 %i.zl, ptr %.0, align 1, !tbaa !31
...
bb.de:                                            ; preds = %.thread869
  ...
  br i1 %.not781, label %.thread836, label %bb.df, !prof !53
...
bb.dg:                                            ; preds = %bb.df
  ...
  store i64 %i.zu, ptr %5, align 8, !tbaa !114
  br label %bb.dh
...
bb.di:                                            ; preds = %bb.dh
  ...
  store i64 %i.zw, ptr %6, align 8, !tbaa !114
  br label %bb.dk
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  ...
  %i.i = add i32 %i.h, 1
  store i32 %i.i, ptr %i.g, align 4, !tbaa !9
  ...
  %i.ad = add i32 %i.ac, 1
  store i32 %i.ad, ptr %i.ab, align 4, !tbaa !9
...
.lr.ph.epil:                                      ; preds = %.lr.ph.epil, %.lr.ph.epil.preheader
  ...
  %i.aj = add i32 %i.ai, 1
  store i32 %i.aj, ptr %i.ah, align 4, !tbaa !9
...
bb.b:                                             ; preds = %.critedge
  ...
  store i32 %i.an, ptr %7, align 4, !tbaa !9
  br label %bb.c

bb.c:                                             ; preds = %bb.b, %.critedge
  %.0186 = phi i32 [ %i.an, %bb.b ], [ %4, %.critedge ] ; 12 uses
  store i32 0, ptr %i.b, align 16, !tbaa !9
  %i.ao = load i32, ptr %i.a, align 16, !tbaa !9  ; 3 uses
  %i.ap = getelementptr inbounds nuw i8, ptr %i.b, i64 4
  store i32 %i.ao, ptr %i.ap, align 4, !tbaa !9
...
.lr.ph239:                                        ; preds = %.lr.ph239, %.lr.ph239.preheader.new
  ...
  %.0152238 = phi i32 [ 0, %.lr.ph239.preheader.new ], [ %i.bf, %.lr.ph239 ]
  ...
  %i.av = load i32, ptr %i.au, align 4, !tbaa !9  ; 2 uses
  ...
  %i.az = load i32, ptr %i.ay, align 4, !tbaa !9  ; 2 uses
  ...
  br i1 %niter377.ncmp.1, label %._crit_edge.loopexit.unr-lcssa, label %.lr.ph239, !llvm.loop !341
...
.lr.ph239.epil.preheader:                         ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph239.preheader
  ...
  %.0152238.epil.init = phi i32 [ 0, %.lr.ph239.preheader ], [ %i.bf, %._crit_edge.loopexit.unr-lcssa ]
  ...
  store i32 %i.bi, ptr %i.bk, align 4, !tbaa !9
  %i.bl = shl i32 %.0152238.epil.init, 1
...
._crit_edge:                                      ; preds = %bb.c, %._crit_edge.loopexit
  %.1160.lcssa = phi i64 [ %i.bo, %._crit_edge.loopexit ], [ 1, %bb.c ]
  %.0152.lcssa = phi i32 [ %i.bn, %._crit_edge.loopexit ], [ 0, %bb.c ]
  %i.bp = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %.1160.lcssa
  %i.bq = load i32, ptr %i.bp, align 4, !tbaa !9
  %i.br = add i32 %i.bq, %.0152.lcssa             ; 4 uses
...
.lr.ph243:                                        ; preds = %.lr.ph243, %.lr.ph243.preheader.new
  ...
  br i1 %niter383.ncmp.1, label %._crit_edge244.loopexit.unr-lcssa, label %.lr.ph243, !llvm.loop !342
...
.lr.ph243.epil.preheader:                         ; preds = %._crit_edge244.loopexit.unr-lcssa, %.lr.ph243.preheader
  ...
  %i.cr = add i32 %i.cq, 1
  store i32 %i.cr, ptr %i.cp, align 4, !tbaa !9
...
._crit_edge244.loopexit:                          ; preds = %._crit_edge244.loopexit.unr-lcssa, %.lr.ph243.epil.preheader
  %.pre301 = load i32, ptr %i.b, align 16, !tbaa !9
...
._crit_edge244:                                   ; preds = %._crit_edge244.loopexit, %._crit_edge
  ...
  br i1 %i.cy, label %.thread212, label %bb.d, !prof !53

bb.d:                                             ; preds = %._crit_edge244
  %i.cz = icmp ult i32 %i.br, %i.cx
  br i1 %i.cz, label %bb.e, label %.preheader220, !prof !53
...
bb.h:                                             ; preds = %bb.e, %bb.g
  %.2174 = phi i64 [ %i.di, %bb.g ], [ 0, %bb.e ]
  %i.dj = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %.2174
  %i.dk = load i32, ptr %i.dj, align 4, !tbaa !9
  %i.dl = add i32 %i.dk, 257
  br label %bb.i

bb.i:                                             ; preds = %bb.h, %bb.i
  %.0143271 = phi i32 [ 0, %bb.h ], [ %i.do, %bb.i ] ; 2 uses
  %i.dm = zext i32 %.0143271 to i64
  %i.dn = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %i.dm
  store i32 %i.dl, ptr %i.dn, align 4, !tbaa !9
  %i.do = add i32 %.0143271, 1                    ; 2 uses
  %.0143.highbits = lshr i32 %i.do, %.0186
  %i.dp = icmp eq i32 %.0143.highbits, 0
  br i1 %i.dp, label %bb.i, label %.thread212, !llvm.loop !343
end_hunk_5
