...
bb.j:                                             ; preds = %bb.i, %bb.f
  %i.ei = phi <16 x i32> [ %i.eg, %bb.i ], [ %i.di, %bb.f ] ; 2 uses
  %i.ej = phi <16 x i32> [ %i.ef, %bb.i ], [ %i.dj, %bb.f ] ; 2 uses
  %.7 = phi ptr [ %i.eh, %bb.i ], [ %.5, %bb.f ]
  %3 = shufflevector <16 x i32> %i.ej, <16 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %4 = shufflevector <16 x i32> %i.ej, <16 x i32> poison, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %5 = add <8 x i32> %3, %4
  %6 = shufflevector <16 x i32> %i.ei, <16 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %7 = shufflevector <16 x i32> %i.ei, <16 x i32> poison, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %8 = add <8 x i32> %6, %7
  %i.ek = tail call i32 @llvm.vector.reduce.add.v8i32(<8 x i32> %5)
  %i.el = add i32 %i.ek, %.2182202
  %i.em = tail call i32 @llvm.vector.reduce.add.v8i32(<8 x i32> %8)
...
bb.j:                                             ; preds = %bb.i, %bb.f
  %i.ei = phi <8 x i32> [ %i.eg, %bb.i ], [ %i.di, %bb.f ] ; 2 uses
  %i.ej = phi <8 x i32> [ %i.ef, %bb.i ], [ %i.dj, %bb.f ] ; 2 uses
  %.7 = phi ptr [ %i.eh, %bb.i ], [ %.5, %bb.f ]
  %3 = shufflevector <8 x i32> %i.ej, <8 x i32> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %4 = shufflevector <8 x i32> %i.ej, <8 x i32> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %5 = add <4 x i32> %3, %4
  %6 = shufflevector <8 x i32> %i.ei, <8 x i32> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %7 = shufflevector <8 x i32> %i.ei, <8 x i32> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %8 = add <4 x i32> %6, %7
  %i.ek = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %5)
  %i.el = add i32 %i.ek, %.2182202
  %i.em = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %8)
  %i.en = add i32 %i.as, %i.em
  %i.eo = urem i32 %i.el, 65521                   ; 2 uses
  %i.ep = urem i32 %i.en, 65521                   ; 2 uses
  %.not164 = icmp eq i64 %i.at, 0
...
bb.j:                                             ; preds = %bb.i, %bb.f
  %i.ef = phi <8 x i32> [ %i.ed, %bb.i ], [ %i.dj, %bb.f ] ; 2 uses
  %i.eg = phi <8 x i32> [ %i.ec, %bb.i ], [ %i.dk, %bb.f ] ; 2 uses
  %.7 = phi ptr [ %i.ee, %bb.i ], [ %.5, %bb.f ]
  %3 = shufflevector <8 x i32> %i.eg, <8 x i32> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %4 = shufflevector <8 x i32> %i.eg, <8 x i32> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %5 = add <4 x i32> %3, %4
  %6 = shufflevector <8 x i32> %i.ef, <8 x i32> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %7 = shufflevector <8 x i32> %i.ef, <8 x i32> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %8 = add <4 x i32> %6, %7
  %i.eh = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %5)
  %i.ei = add i32 %i.eh, %.2183204
  %i.ej = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %8)
