...
._crit_edge:                                      ; preds = %bb.a, %bb.b
  ...
  %3 = fadd float %i.k, %i.o                      ; 2 uses
  %i.u = load <2 x float>, ptr %i.p, align 4, !tbaa !8 ; 5 uses
  %i.v = load float, ptr %i.q, align 4, !tbaa !15 ; 4 uses
  %4 = load <4 x float>, ptr %1, align 4, !tbaa !8 ; 4 uses
  %5 = load float, ptr %i.s, align 4, !tbaa !16   ; 3 uses
  %i.w = load float, ptr %i.r, align 4, !tbaa !17 ; 4 uses
  %i.x = load float, ptr %i.t, align 4, !tbaa !18 ; 3 uses
  %6 = fsub float %5, %i.x                        ; 2 uses
  %7 = extractelement <2 x float> %i.u, i64 0     ; 3 uses
  %8 = fmul float %7, %6
  %9 = shufflevector <4 x float> %4, <4 x float> poison, <2 x i32> <i32 3, i32 1> ; 3 uses
  %10 = shufflevector <2 x float> %i.u, <2 x float> poison, <4 x i32> <i32 poison, i32 1, i32 poison, i32 poison>
  %11 = shufflevector <4 x float> %10, <4 x float> %4, <2 x i32> <i32 1, i32 5>
  %12 = shufflevector <2 x float> %9, <2 x float> %i.u, <2 x i32> <i32 0, i32 3>
  %13 = fsub <2 x float> %11, %12                 ; 3 uses
  %14 = extractelement <2 x float> %13, i64 0
  %15 = extractelement <4 x float> %4, i64 0      ; 4 uses
  %16 = tail call float @llvm.fmuladd.f32(float %15, float %14, float %8)
  %17 = extractelement <2 x float> %13, i64 1
  %18 = tail call float @llvm.fmuladd.f32(float %i.w, float %17, float %16) ; 3 uses
  %19 = fadd float %i.v, -1.000000e+00
  %20 = fmul float %i.v, %3
  %21 = tail call float @llvm.fmuladd.f32(float %2, float %19, float %20) ; 2 uses
  %22 = fneg float %21
  %23 = shufflevector <4 x float> %4, <4 x float> poison, <2 x i32> <i32 2, i32 0>
  %24 = insertelement <2 x float> poison, float %22, i64 0
  %25 = insertelement <2 x float> %24, float %21, i64 1
  %26 = fmul <2 x float> %23, %25
  %27 = insertelement <2 x float> poison, float %i.k, i64 0
  %28 = shufflevector <2 x float> %27, <2 x float> poison, <2 x i32> zeroinitializer
  %29 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %28, <2 x float> %13, <2 x float> %26)
  %30 = fadd <2 x float> %9, splat (float -1.000000e+00)
  %i.y = insertelement <2 x float> poison, float %3, i64 0
  %31 = shufflevector <2 x float> %i.y, <2 x float> poison, <2 x i32> zeroinitializer
  %32 = fmul <2 x float> %9, %31
  %i.z = insertelement <2 x float> poison, float %2, i64 0
  %i.aa = shufflevector <2 x float> %i.z, <2 x float> poison, <2 x i32> zeroinitializer
  %33 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.aa, <2 x float> %30, <2 x float> %32) ; 3 uses
  %34 = fneg <2 x float> %i.u
  %35 = shufflevector <2 x float> %i.u, <2 x float> %34, <2 x i32> <i32 0, i32 2>
  %36 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %35, <2 x float> %33, <2 x float> %29) ; 3 uses
  %37 = extractelement <2 x float> %33, i64 0
  %38 = fneg float %37
  %39 = fmul float %15, %38
  %40 = tail call float @llvm.fmuladd.f32(float %i.k, float %6, float %39)
  %41 = extractelement <2 x float> %33, i64 1
  %42 = tail call float @llvm.fmuladd.f32(float %i.w, float %41, float %40) ; 2 uses
  %i.ab = tail call noundef float @llvm.fabs.f32(float %18) ; 2 uses
  %i.ac = fcmp olt float %i.ab, 1.000000e+00
  br i1 %i.ac, label %bb.f, label %bb.j

bb.f:                                             ; preds = %._crit_edge
  %i.ad = extractelement <2 x float> %36, i64 0
...
bb.j:                                             ; preds = %bb.f, %._crit_edge
  %i.ao = insertelement <2 x float> poison, float %18, i64 0
  %i.ap = shufflevector <2 x float> %i.ao, <2 x float> poison, <2 x i32> zeroinitializer
  %i.aq = fdiv <2 x float> %36, %i.ap             ; 2 uses
  %43 = fdiv float %42, %18                       ; 3 uses
