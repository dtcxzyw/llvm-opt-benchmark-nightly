...
._crit_edge:                                      ; preds = %bb.a, %bb.b
  ...
  %3 = load float, ptr %i.p, align 4, !tbaa !16   ; 5 uses
  %i.u = getelementptr inbounds nuw i8, ptr %1, i64 4
  %4 = fneg float %3
  %i.v = load float, ptr %1, align 4, !tbaa !17   ; 4 uses
  %5 = load float, ptr %i.u, align 4, !tbaa !18   ; 6 uses
  %i.w = load <2 x float>, ptr %i.s, align 4, !tbaa !9 ; 4 uses
  %i.x = load float, ptr %i.t, align 4, !tbaa !19 ; 4 uses
...
bb.f:                                             ; preds = %bb.d
  ...
  %2 = load float, ptr %i.d, align 4, !tbaa !9    ; 3 uses
