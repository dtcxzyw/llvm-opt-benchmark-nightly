Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/openexr/original/ImfChromaticities?download=true
...
bb.a:
  %i.a = load <2 x float>, ptr %1, align 4, !tbaa !9
  store <2 x float> %i.a, ptr %0, align 4, !tbaa !9
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.c = load <2 x float>, ptr %2, align 4, !tbaa !9
  store <2 x float> %i.c, ptr %i.b, align 4, !tbaa !9
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.e = load <2 x float>, ptr %3, align 4, !tbaa !9
  store <2 x float> %i.e, ptr %i.d, align 4, !tbaa !9
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.g = load <2 x float>, ptr %4, align 4, !tbaa !9
  store <2 x float> %i.g, ptr %i.f, align 4, !tbaa !9
  ret void
}
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.l = load float, ptr %i.j, align 4, !tbaa !11
  %i.m = load float, ptr %i.k, align 4, !tbaa !11
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.w = load float, ptr %i.u, align 4, !tbaa !11
  %i.x = load float, ptr %i.v, align 4, !tbaa !11
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.ah = load float, ptr %i.af, align 4, !tbaa !11
  %i.ai = load float, ptr %i.ag, align 4, !tbaa !11
...
bb.a:
  ...
  %i.c = load float, ptr %i.b, align 4, !tbaa !13 ; 4 uses
...
._crit_edge:                                      ; preds = %bb.a, %bb.b
  ...
  %i.r = load float, ptr %i.q, align 4, !tbaa !15 ; 5 uses
  ...
  %i.w = load <2 x float>, ptr %i.s, align 4, !tbaa !9 ; 4 uses
  %i.x = load float, ptr %i.u, align 4, !tbaa !17 ; 6 uses
  ...
  %i.ad = extractelement <2 x float> %i.w, i64 0  ; 3 uses
  %5 = fadd float %i.x, -1.000000e+00
  %6 = load float, ptr %i.p, align 4, !tbaa !18   ; 5 uses
  %7 = fneg float %6
  %8 = load float, ptr %i.t, align 4, !tbaa !19   ; 4 uses
  %9 = fsub float %i.r, %8                        ; 2 uses
  %i.ae = fmul float %6, %3
  %10 = tail call float @llvm.fmuladd.f32(float %i.v, float %9, float %i.ae)
  %11 = tail call float @llvm.fmuladd.f32(float %i.ad, float %4, float %10) ; 3 uses
  %i.af = fadd float %i.k, %i.o                   ; 2 uses
  %12 = fmul float %i.x, %i.af
  ...
  %i.ah = insertelement <2 x float> %i.ag, float %8, i64 1 ; 2 uses
  ...
  %foldExtExtBinop = fmul <2 x float> %i.w, %i.ap
  %i.aq = extractelement <2 x float> %foldExtExtBinop, i64 0
  %i.ar = tail call float @llvm.fmuladd.f32(float %i.k, float %9, float %i.aq)
  %15 = shufflevector <2 x float> %i.ao, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %16 = insertelement <2 x float> %15, float %5, i64 1
  %17 = insertelement <2 x float> poison, float %i.ar, i64 0
  %18 = insertelement <2 x float> %17, float %12, i64 1
  %19 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %14, <2 x float> %16, <2 x float> %18) ; 3 uses
  ...
  %20 = shufflevector <2 x float> %i.ap, <2 x float> %i.ao, <2 x i32> <i32 1, i32 2>
  %i.au = fmul <2 x float> %i.at, %20
  ...
  %i.ay = insertelement <2 x float> %i.w, float %7, i64 1
  %21 = shufflevector <2 x float> %19, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.az = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ay, <2 x float> %21, <2 x float> %i.ax) ; 3 uses
  %i.ba = tail call noundef float @llvm.fabs.f32(float %11) ; 2 uses
  %i.bb = fcmp olt float %i.ba, 1.000000e+00
  br i1 %i.bb, label %bb.f, label %bb.j

bb.f:                                             ; preds = %._crit_edge
  %22 = extractelement <2 x float> %19, i64 0
  %i.bc = tail call noundef float @llvm.fabs.f32(float %22)
...
bb.j:                                             ; preds = %bb.f, %._crit_edge
  ...
  %i.bn = fdiv float %23, %11                     ; 3 uses
  %i.bo = insertelement <2 x float> poison, float %11, i64 0
  ...
  store float %i.bz, ptr %0, align 4, !tbaa !9
  %i.ca = fmul float %i.x, %i.bn
  store float %i.ca, ptr %i.br, align 4, !tbaa !9
  %i.cb = fsub float 1.000000e+00, %i.v
  %i.cc = fsub float %i.cb, %i.x
  %i.cd = fmul float %i.cc, %i.bn
  %i.ce = getelementptr inbounds nuw i8, ptr %0, i64 8
  store float %i.cd, ptr %i.ce, align 4, !tbaa !9
  %i.cf = extractelement <2 x float> %i.bq, i64 1 ; 3 uses
  %i.cg = fmul float %i.ad, %i.cf
  %i.ch = getelementptr inbounds nuw i8, ptr %0, i64 16
  store float %i.cg, ptr %i.ch, align 4, !tbaa !9
  %i.ci = fmul float %8, %i.cf
  store float %i.ci, ptr %i.bs, align 4, !tbaa !9
  %i.cj = fsub float 1.000000e+00, %i.ad
  %i.ck = fsub float %i.cj, %8
  %i.cl = fmul float %i.ck, %i.cf
  store float %i.cl, ptr %i.bu, align 4, !tbaa !9
  %i.cm = extractelement <2 x float> %i.bq, i64 0 ; 3 uses
  %i.cn = fmul float %6, %i.cm
  %i.co = getelementptr inbounds nuw i8, ptr %0, i64 32
  store float %i.cn, ptr %i.co, align 4, !tbaa !9
  %i.cp = fmul float %i.r, %i.cm
  %i.cq = getelementptr inbounds nuw i8, ptr %0, i64 36
  store float %i.cp, ptr %i.cq, align 4, !tbaa !9
  %i.cr = fsub float 1.000000e+00, %6
  %i.cs = fsub float %i.cr, %i.r
  %i.ct = fmul float %i.cs, %i.cm
  store float %i.ct, ptr %i.bv, align 4, !tbaa !9
  ret void
...
bb.f:                                             ; preds = %bb.d
  ...
  %i.u = load float, ptr %1, align 4, !tbaa !9    ; 3 uses
  %i.v = load float, ptr %i.h, align 4, !tbaa !9  ; 3 uses
  %i.w = load <2 x float>, ptr %i.p, align 4, !tbaa !9 ; 4 uses
  %i.x = load float, ptr %i.s, align 4, !tbaa !9  ; 2 uses
  %i.y = fneg float %i.x                          ; 2 uses
  %i.z = load <2 x float>, ptr %i.t, align 4, !tbaa !9 ; 5 uses
  %i.aa = shufflevector <2 x float> %i.z, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 3 uses
  %i.ab = load <2 x float>, ptr %i.r, align 4, !tbaa !9 ; 5 uses
  %i.ac = load float, ptr %i.q, align 4, !tbaa !9 ; 2 uses
  %i.ad = shufflevector <2 x float> %i.ab, <2 x float> %i.z, <2 x i32> <i32 1, i32 3>
  %i.ae = fneg <2 x float> %i.ad                  ; 3 uses
  %2 = extractelement <2 x float> %i.ab, i64 0
  %3 = extractelement <2 x float> %i.w, i64 0
  %4 = shufflevector <2 x float> %i.z, <2 x float> %i.w, <2 x i32> <i32 0, i32 2> ; 2 uses
  %5 = fmul <2 x float> %4, %i.ae
  %i.af = shufflevector <2 x float> %i.ab, <2 x float> %i.w, <2 x i32> <i32 0, i32 3>
  %i.ag = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.aa, <2 x float> %i.af, <2 x float> %5) ; 2 uses
  %6 = load float, ptr %i.d, align 4, !tbaa !9    ; 3 uses
  %7 = shufflevector <2 x float> %i.ab, <2 x float> %i.ae, <2 x i32> <i32 0, i32 2>
  %i.ah = insertelement <2 x float> poison, float %i.y, i64 0
  %i.ai = insertelement <2 x float> %i.ah, float %6, i64 1
  %i.aj = fmul <2 x float> %7, %i.ai
  %i.ak = insertelement <2 x float> %i.w, float %i.v, i64 1
  %i.al = insertelement <2 x float> poison, float %i.ac, i64 0
  %i.am = insertelement <2 x float> %i.al, float %i.x, i64 1
  %i.an = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ak, <2 x float> %i.am, <2 x float> %i.aj) ; 4 uses
  %8 = insertelement <2 x float> poison, float %i.v, i64 0
  %i.ao = insertelement <2 x float> %8, float %i.u, i64 1 ; 2 uses
  %9 = shufflevector <2 x float> %i.ae, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %i.ap = insertelement <2 x float> %9, float %i.y, i64 1
  %i.aq = fmul <2 x float> %i.ao, %i.ap
  %10 = extractelement <2 x float> %i.z, i64 1
  %i.ar = insertelement <2 x float> poison, float %i.u, i64 0
  %i.as = insertelement <2 x float> %i.ar, float %6, i64 1 ; 2 uses
  %i.at = insertelement <2 x float> %i.z, float %i.ac, i64 0
  %i.au = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.as, <2 x float> %i.at, <2 x float> %i.aq) ; 2 uses
  %i.av = fneg float %3
  %11 = fmul float %i.v, %i.av
  %12 = tail call float @llvm.fmuladd.f32(float %6, float %2, float %11) ; 3 uses
  %13 = shufflevector <2 x float> %i.ab, <2 x float> %i.aa, <2 x i32> <i32 0, i32 3>
  %14 = fneg <2 x float> %13
  %15 = fmul <2 x float> %i.as, %14
  %16 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ao, <2 x float> %4, <2 x float> %15) ; 3 uses
  %foldExtExtBinop = fmul <2 x float> %i.aa, %i.an
  ...
  %i.az = tail call float @llvm.fmuladd.f32(float %10, float %12, float %i.ay) ; 4 uses
...
.preheader:                                       ; preds = %bb.f
  ...
  %i.bf = shufflevector <2 x float> %i.au, <2 x float> %16, <4 x i32> <i32 0, i32 1, i32 poison, i32 2>
  ...
  %i.bi = shufflevector <2 x float> %i.an, <2 x float> poison, <8 x i32> <i32 0, i32 poison, i32 poison, i32 1, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.bj = shufflevector <8 x float> %i.bi, <8 x float> %i.bh, <8 x i32> <i32 0, i32 9, i32 10, i32 3, i32 12, i32 13, i32 poison, i32 15>
  %i.bk = insertelement <8 x float> %i.bj, float %12, i64 6
  ...
  %i.bp = extractelement <2 x float> %16, i64 1
...
bb.g:                                             ; preds = %.preheader
  store float 1.000000e+00, ptr %0, align 4, !tbaa !9
  ...
  store float 1.000000e+00, ptr %i.bw, align 4, !tbaa !9
  ...
  store float 1.000000e+00, ptr %i.ca, align 4, !tbaa !9
  br label %bb.h

.critedge29:                                      ; preds = %.preheader, %bb.f
  %i.cb = load float, ptr %i.l, align 4, !tbaa !9
  ...
  %i.ci = shufflevector <2 x float> %i.an, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 2 uses
  ...
  store <4 x float> %i.co, ptr %0, align 4, !tbaa !9
  ...
  %i.cr = shufflevector <2 x float> %i.au, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.cs = shufflevector <4 x float> %i.cq, <4 x float> %i.cr, <4 x i32> <i32 0, i32 4, i32 5, i32 3>
  %i.ct = fdiv <4 x float> %i.cs, %i.cn           ; 3 uses
  store <4 x float> %i.ct, ptr %i.cp, align 4, !tbaa !9
  %i.cu = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.cv = insertelement <4 x float> <float poison, float poison, float poison, float 0.000000e+00>, float %12, i64 0
  %i.cw = shufflevector <2 x float> %16, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.cx = shufflevector <4 x float> %i.cv, <4 x float> %i.cw, <4 x i32> <i32 0, i32 4, i32 5, i32 3>
  %i.cy = fdiv <4 x float> %i.cx, %i.cn           ; 2 uses
  store <4 x float> %i.cy, ptr %i.cu, align 4, !tbaa !9
  ...
  store <4 x float> %i.do, ptr %i.cz, align 4, !tbaa !9
  br label %bb.h
...
.lr.ph.preheader:
  %2 = alloca %"class.Imath_3_2::Matrix44", align 16 ; 45 uses
  %3 = alloca %"class.Imath_3_2::Matrix44", align 16 ; 88 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #10
  store float 1.000000e+00, ptr %2, align 16, !tbaa !9
  ...
  store float 1.000000e+00, ptr %i.d, align 8, !tbaa !9
  ...
  store float 1.000000e+00, ptr %i.f, align 4, !tbaa !9
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #10
  %i.g = load <4 x float>, ptr %1, align 4, !tbaa !9
  store <4 x float> %i.g, ptr %3, align 16, !tbaa !9
  %i.h = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.i = getelementptr inbounds nuw i8, ptr %3, i64 16
  %i.j = load <4 x float>, ptr %i.h, align 4, !tbaa !9
  store <4 x float> %i.j, ptr %i.i, align 16, !tbaa !9
  %i.k = getelementptr inbounds nuw i8, ptr %1, i64 32
  %i.l = getelementptr inbounds nuw i8, ptr %3, i64 32
  %i.m = load <4 x float>, ptr %i.k, align 4, !tbaa !9
  store <4 x float> %i.m, ptr %i.l, align 16, !tbaa !9
  %i.n = getelementptr inbounds nuw i8, ptr %1, i64 48
  %i.o = getelementptr inbounds nuw i8, ptr %3, i64 48
  %i.p = load <4 x float>, ptr %i.n, align 4, !tbaa !9
  store <4 x float> %i.p, ptr %i.o, align 16, !tbaa !9
  %gep.1 = getelementptr inbounds nuw i8, ptr %3, i64 32
  %i.q = load float, ptr %gep.1, align 16, !tbaa !9 ; 3 uses
  ...
  %i.t = load float, ptr %gep, align 16, !tbaa !9 ; 3 uses
  %i.u = fcmp olt float %i.t, 0.000000e+00
  %i.v = fneg float %i.t
  %.094 = select i1 %i.u, float %i.v, float %i.t  ; 2 uses
  %i.w = load float, ptr %3, align 16, !tbaa !9   ; 3 uses
  ...
  %i.ab = load float, ptr %gep.2, align 16, !tbaa !9 ; 3 uses
...
.preheader112.1:                                  ; preds = %bb.a
  ...
  %i.am = load <4 x float>, ptr %i.ir, align 16, !tbaa !9
  %i.an = load <4 x float>, ptr %i.aj, align 16, !tbaa !9
  store <4 x float> %i.an, ptr %i.ir, align 16, !tbaa !9
  store <4 x float> %i.am, ptr %i.aj, align 16, !tbaa !9
  %i.ao = load <4 x float>, ptr %i.ak, align 16, !tbaa !9
  %i.ap = load <4 x float>, ptr %i.al, align 16, !tbaa !9
  store <4 x float> %i.ap, ptr %i.ak, align 16, !tbaa !9
  store <4 x float> %i.ao, ptr %i.al, align 16, !tbaa !9
  br label %.lr.ph122.1
...
.lr.ph122.1:                                      ; preds = %.preheader112.1, %bb.a
  ...
  %i.at = load float, ptr %i.as, align 4, !tbaa !9
  %i.au = load float, ptr %i.is, align 4, !tbaa !9
  %i.av = fneg float %i.at
  %i.aw = fdiv float %i.av, %i.au
  %i.ax = getelementptr inbounds nuw i8, ptr %2, i64 32 ; 2 uses
  %i.ay = load <4 x float>, ptr %i.ir, align 16, !tbaa !9
  %i.az = load <4 x float>, ptr %i.ar, align 16, !tbaa !9
  ...
  store <4 x float> %i.bc, ptr %i.ar, align 16, !tbaa !9
  %i.bd = load <4 x float>, ptr %i.aq, align 16, !tbaa !9
  %i.be = load <4 x float>, ptr %i.ax, align 16, !tbaa !9
  %i.bf = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.bb, <4 x float> %i.bd, <4 x float> %i.be)
  store <4 x float> %i.bf, ptr %i.ax, align 16, !tbaa !9
  ...
  %i.bj = load float, ptr %i.is, align 4, !tbaa !9
  %i.bk = fneg float %i.bi
  %i.bl = fdiv float %i.bk, %i.bj
  %i.bm = getelementptr inbounds nuw i8, ptr %2, i64 48 ; 2 uses
  %i.bn = load <4 x float>, ptr %i.ir, align 16, !tbaa !9
  %i.bo = load <4 x float>, ptr %i.bg, align 16, !tbaa !9
  ...
  store <4 x float> %i.br, ptr %i.bg, align 16, !tbaa !9
  %i.bs = load <4 x float>, ptr %i.aq, align 16, !tbaa !9
  %i.bt = load <4 x float>, ptr %i.bm, align 16, !tbaa !9
  %i.bu = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.bq, <4 x float> %i.bs, <4 x float> %i.bt)
  store <4 x float> %i.bu, ptr %i.bm, align 16, !tbaa !9
  %i.bv = getelementptr inbounds nuw i8, ptr %3, i64 32 ; 3 uses
  %i.bw = getelementptr inbounds nuw i8, ptr %3, i64 40 ; 2 uses
  %i.bx = load float, ptr %i.bw, align 8, !tbaa !9 ; 3 uses
  ...
  %i.ca = load float, ptr %gep.2179, align 8, !tbaa !9 ; 3 uses
...
.preheader112.2:                                  ; preds = %bb.b
  ...
  %i.ci = load <4 x float>, ptr %i.bv, align 16, !tbaa !9
  %i.cj = load <4 x float>, ptr %i.cf, align 16, !tbaa !9
  store <4 x float> %i.cj, ptr %i.bv, align 16, !tbaa !9
  store <4 x float> %i.ci, ptr %i.cf, align 16, !tbaa !9
  %i.ck = load <4 x float>, ptr %i.cg, align 16, !tbaa !9
  %i.cl = load <4 x float>, ptr %i.ch, align 16, !tbaa !9
  store <4 x float> %i.cl, ptr %i.cg, align 16, !tbaa !9
  store <4 x float> %i.ck, ptr %i.ch, align 16, !tbaa !9
  br label %.lr.ph122.2
...
.lr.ph122.2:                                      ; preds = %bb.b, %.preheader112.2
  ...
  %i.cq = load float, ptr %i.bw, align 8, !tbaa !9
  %i.cr = fneg float %i.cp
  %i.cs = fdiv float %i.cr, %i.cq
  %i.ct = getelementptr inbounds nuw i8, ptr %2, i64 48 ; 2 uses
  %i.cu = load <4 x float>, ptr %i.bv, align 16, !tbaa !9
  %i.cv = load <4 x float>, ptr %i.cn, align 16, !tbaa !9
  ...
  store <4 x float> %i.cy, ptr %i.cn, align 16, !tbaa !9
  %i.cz = load <4 x float>, ptr %i.cm, align 16, !tbaa !9
  %i.da = load <4 x float>, ptr %i.ct, align 16, !tbaa !9
  %i.db = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.cx, <4 x float> %i.cz, <4 x float> %i.da)
  store <4 x float> %i.db, ptr %i.ct, align 16, !tbaa !9
end_hunk_0
...
.preheader110.1:                                  ; preds = %.preheader110.lr.ph
  ...
  %i.jp = load <4 x float>, ptr %i.gl, align 16, !tbaa !9
  ...
  store <4 x float> %i.js, ptr %i.gl, align 16, !tbaa !9
  %i.jt = load <4 x float>, ptr %i.jl, align 16, !tbaa !9
  %i.ju = fdiv <4 x float> %i.jt, %i.jr
  store <4 x float> %i.ju, ptr %i.jl, align 16, !tbaa !9
  %i.jv = getelementptr inbounds nuw i8, ptr %3, i64 8
  %i.jw = load float, ptr %i.jv, align 8, !tbaa !9
  %i.jx = fneg float %i.jw                        ; 5 uses
  %i.jy = load float, ptr %i.gl, align 16, !tbaa !9
  %i.jz = load float, ptr %3, align 16, !tbaa !9
  %i.ka = tail call float @llvm.fmuladd.f32(float %i.jx, float %i.jy, float %i.jz)
  store float %i.ka, ptr %3, align 16, !tbaa !9
  %i.kb = load float, ptr %i.jm, align 4, !tbaa !9
  %i.kc = getelementptr inbounds nuw i8, ptr %3, i64 4 ; 2 uses
  %i.kd = load float, ptr %i.kc, align 4, !tbaa !9
  %i.ke = tail call float @llvm.fmuladd.f32(float %i.jx, float %i.kb, float %i.kd)
  store float %i.ke, ptr %i.kc, align 4, !tbaa !9
  %i.kf = load float, ptr %i.jn, align 8, !tbaa !9
  %i.kg = getelementptr inbounds nuw i8, ptr %3, i64 8 ; 2 uses
  %i.kh = load float, ptr %i.kg, align 8, !tbaa !9
  %i.ki = tail call float @llvm.fmuladd.f32(float %i.jx, float %i.kf, float %i.kh)
  store float %i.ki, ptr %i.kg, align 8, !tbaa !9
  %i.kj = load float, ptr %i.jo, align 4, !tbaa !9
  %i.kk = getelementptr inbounds nuw i8, ptr %3, i64 12 ; 2 uses
  %i.kl = load float, ptr %i.kk, align 4, !tbaa !9
  %i.km = tail call float @llvm.fmuladd.f32(float %i.jx, float %i.kj, float %i.kl)
  store float %i.km, ptr %i.kk, align 4, !tbaa !9
  %i.kn = load <4 x float>, ptr %i.jl, align 16, !tbaa !9
  %i.ko = load <4 x float>, ptr %2, align 16, !tbaa !9
  ...
  store float %i.ll, ptr %i.lj, align 4, !tbaa !9
  %i.lm = load <4 x float>, ptr %i.jl, align 16, !tbaa !9
  %i.ln = load <4 x float>, ptr %i.kw, align 16, !tbaa !9
...
.preheader110.2:                                  ; preds = %.preheader110.1
  ...
  %i.lz = load <4 x float>, ptr %i.lr, align 16, !tbaa !9
  ...
  store <4 x float> %i.mc, ptr %i.lr, align 16, !tbaa !9
  %i.md = load <4 x float>, ptr %i.lv, align 16, !tbaa !9
  %i.me = fdiv <4 x float> %i.md, %i.mb
  store <4 x float> %i.me, ptr %i.lv, align 16, !tbaa !9
  %i.mf = getelementptr inbounds nuw i8, ptr %3, i64 4
  %i.mg = load float, ptr %i.mf, align 4, !tbaa !9
  %i.mh = fneg float %i.mg                        ; 5 uses
  %i.mi = load float, ptr %i.lr, align 16, !tbaa !9
  %i.mj = load float, ptr %3, align 16, !tbaa !9
  %i.mk = tail call float @llvm.fmuladd.f32(float %i.mh, float %i.mi, float %i.mj)
  store float %i.mk, ptr %3, align 16, !tbaa !9
  %i.ml = load float, ptr %i.lw, align 4, !tbaa !9
  %i.mm = getelementptr inbounds nuw i8, ptr %3, i64 4 ; 2 uses
  %i.mn = load float, ptr %i.mm, align 4, !tbaa !9
  %i.mo = tail call float @llvm.fmuladd.f32(float %i.mh, float %i.ml, float %i.mn)
  store float %i.mo, ptr %i.mm, align 4, !tbaa !9
  %i.mp = load float, ptr %i.lx, align 8, !tbaa !9
  %i.mq = getelementptr inbounds nuw i8, ptr %3, i64 8 ; 2 uses
  %i.mr = load float, ptr %i.mq, align 8, !tbaa !9
  %i.ms = tail call float @llvm.fmuladd.f32(float %i.mh, float %i.mp, float %i.mr)
  store float %i.ms, ptr %i.mq, align 8, !tbaa !9
  %i.mt = load float, ptr %i.ly, align 4, !tbaa !9
  %i.mu = getelementptr inbounds nuw i8, ptr %3, i64 12 ; 2 uses
  %i.mv = load float, ptr %i.mu, align 4, !tbaa !9
  %i.mw = tail call float @llvm.fmuladd.f32(float %i.mh, float %i.mt, float %i.mv)
  store float %i.mw, ptr %i.mu, align 4, !tbaa !9
  %i.mx = load <4 x float>, ptr %i.lv, align 16, !tbaa !9
  %i.my = load <4 x float>, ptr %2, align 16, !tbaa !9
  ...
  store <4 x float> %i.nb, ptr %2, align 16, !tbaa !9
  %i.nc = load float, ptr %3, align 16, !tbaa !9  ; 2 uses
  %i.nd = fcmp une float %i.nc, 0.000000e+00
  br i1 %i.nd, label %.preheader110.3, label %.thread109

.preheader110.3:                                  ; preds = %.preheader110.2
  %i.ne = load <4 x float>, ptr %3, align 16, !tbaa !9
  ...
  store <4 x float> %i.nh, ptr %3, align 16, !tbaa !9
  %i.ni = load <4 x float>, ptr %2, align 16, !tbaa !9
  %i.nj = fdiv <4 x float> %i.ni, %i.ng
  store <4 x float> %i.nj, ptr %2, align 16, !tbaa !9
  %i.nk = load <4 x float>, ptr %2, align 16, !tbaa !9
  store <4 x float> %i.nk, ptr %0, align 4, !tbaa !9
  %i.nl = getelementptr inbounds nuw i8, ptr %2, i64 16
  %i.nm = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.nn = load <4 x float>, ptr %i.nl, align 16, !tbaa !9
  store <4 x float> %i.nn, ptr %i.nm, align 4, !tbaa !9
  %i.no = getelementptr inbounds nuw i8, ptr %2, i64 32
  %i.np = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.nq = load <4 x float>, ptr %i.no, align 16, !tbaa !9
  store <4 x float> %i.nq, ptr %i.np, align 4, !tbaa !9
  %i.nr = getelementptr inbounds nuw i8, ptr %2, i64 48
  %i.ns = getelementptr inbounds nuw i8, ptr %0, i64 48
  %i.nt = load <4 x float>, ptr %i.nr, align 16, !tbaa !9
  store <4 x float> %i.nt, ptr %i.ns, align 4, !tbaa !9
  br label %bb.d
...
!8 = !{!"float", !4, i64 0}
!9 = !{!8, !8, i64 0}
!10 = !{!"_ZTSN9Imath_3_24Vec2IfEE", !8, i64 0, !8, i64 4}
!11 = !{!10, !8, i64 0}
!12 = !{!"_ZTSN7Imf_3_414ChromaticitiesE", !10, i64 0, !10, i64 8, !10, i64 16, !10, i64 24}
!13 = !{!12, !8, i64 28}
!14 = !{!12, !8, i64 24}
!15 = !{!12, !8, i64 20}
!16 = !{!12, !8, i64 0}
