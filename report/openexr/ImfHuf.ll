...
bb.w:                                             ; preds = %bb.v
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(524296) %i.ah, i8 0, i64 524296, i1 false)
  %.not72.i = icmp samesign ugt i32 %i.f, %i.h    ; 2 uses
  br i1 %.not72.i, label %._crit_edge79.i, label %.lr.ph78.i

.lr.ph78.i:                                       ; preds = %bb.w
  %i.al = add nsw i32 %1, -20
  %i.am = zext nneg i32 %i.al to i64              ; 2 uses
  %i.an = add nuw nsw i32 %i.h, 1                 ; 2 uses
  br label %bb.x

bb.x:                                             ; preds = %bb.al, %.lr.ph78.i
  %.03076.i = phi i32 [ %i.f, %.lr.ph78.i ], [ %i.db, %bb.al ] ; 5 uses
  %.04775.i = phi i32 [ 0, %.lr.ph78.i ], [ %.148.i, %bb.al ] ; 3 uses
  %.04974.i = phi i64 [ 0, %.lr.ph78.i ], [ %.150.i, %bb.al ] ; 2 uses
  %.05373.i = phi ptr [ %i.n, %.lr.ph78.i ], [ %.154.i, %bb.al ] ; 3 uses
  %i.ao = ptrtoint ptr %.05373.i to i64
...
bb.aa:                                            ; preds = %bb.x
  %i.at = icmp slt i32 %.04775.i, 6
  br i1 %i.at, label %.lr.ph.i.i, label %_ZN7Imf_3_412_GLOBAL__N_17getBitsEiRmRiRPKc.exit.i

.lr.ph.i.i:                                       ; preds = %bb.aa, %.lr.ph.i.i
  %i.au = phi ptr [ %i.ay, %.lr.ph.i.i ], [ %.05373.i, %bb.aa ] ; 2 uses
  %i.av = phi i64 [ %i.bb, %.lr.ph.i.i ], [ %.04974.i, %bb.aa ]
  %i.aw = phi i32 [ %i.bc, %.lr.ph.i.i ], [ %.04775.i, %bb.aa ] ; 2 uses
  %i.ax = shl i64 %i.av, 8
  %i.ay = getelementptr inbounds nuw i8, ptr %i.au, i64 1 ; 2 uses
  %i.az = load i8, ptr %i.au, align 1, !tbaa !31
  %i.ba = zext i8 %i.az to i64
  %i.bb = or disjoint i64 %i.ax, %i.ba            ; 2 uses
  %i.bc = add nsw i32 %i.aw, 8                    ; 2 uses
  %i.bd = icmp slt i32 %i.aw, -2
...
_ZN7Imf_3_412_GLOBAL__N_17getBitsEiRmRiRPKc.exit.i: ; preds = %.lr.ph.i.i, %bb.aa
  ...
  %i.bi = sext i32 %.03076.i to i64               ; 4 uses
...
bb.ab:                                            ; preds = %_ZN7Imf_3_412_GLOBAL__N_17getBitsEiRmRiRPKc.exit.i
  %i.bl = ptrtoint ptr %.255.i to i64
...
_ZN7Imf_3_412_GLOBAL__N_17getBitsEiRmRiRPKc.exit40.i: ; preds = %.lr.ph.i38.i, %bb.ae
  ...
  %i.cc = add i32 %.03076.i, 6
  %i.cd = add i32 %i.cc, %i.cb
  %i.ce = icmp sgt i32 %i.cd, %i.an
  br i1 %i.ce, label %bb.af, label %.preheader.preheader.i

.preheader.preheader.i:                           ; preds = %_ZN7Imf_3_412_GLOBAL__N_17getBitsEiRmRiRPKc.exit40.i
  %i.cf = shl nsw i64 %i.bi, 3
  %scevgep88.i = getelementptr i8, ptr %i.ah, i64 %i.cf
  %i.cg = and i64 %i.bz, 255                      ; 2 uses
  %i.ch = shl nuw nsw i64 %i.cg, 3
  %i.ci = add nuw nsw i64 %i.ch, 48
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep88.i, i8 0, i64 %i.ci, i1 false), !tbaa !10
  %i.cj = add nsw i64 %i.bi, 5
  %i.ck = add nsw i64 %i.cj, %i.cg
  %i.cl = trunc nsw i64 %i.ck to i32
  br label %bb.al

bb.af:                                            ; preds = %_ZN7Imf_3_412_GLOBAL__N_17getBitsEiRmRiRPKc.exit40.i
...
._crit_edge.i:                                    ; preds = %bb.ai
  ...
  %i.cz = add i32 %.03076.i, -58
  %i.da = add i32 %i.cz, %i.cp
  br label %bb.al

bb.al:                                            ; preds = %._crit_edge.i, %bb.ah, %.preheader.preheader.i
  %.154.i = phi ptr [ %.356.i, %.preheader.preheader.i ], [ %.255.i, %._crit_edge.i ], [ %.255.i, %bb.ah ] ; 2 uses
  %.150.i = phi i64 [ %.352.i, %.preheader.preheader.i ], [ %.251.i, %._crit_edge.i ], [ %.251.i, %bb.ah ]
  %.148.i = phi i32 [ %i.bx, %.preheader.preheader.i ], [ %i.be, %._crit_edge.i ], [ %i.be, %bb.ah ]
  %.3.i = phi i32 [ %i.cl, %.preheader.preheader.i ], [ %i.da, %._crit_edge.i ], [ %.03076.i, %bb.ah ] ; 2 uses
  %i.db = add nsw i32 %.3.i, 1
  %.not.not.i = icmp slt i32 %.3.i, %i.h
  br i1 %.not.not.i, label %bb.x, label %._crit_edge79.i, !llvm.loop !39

._crit_edge79.i:                                  ; preds = %bb.al, %bb.w
  %i.dc = phi ptr [ %i.n, %bb.w ], [ %.154.i, %bb.al ] ; 5 uses
...
.preheader28.i.i:                                 ; preds = %.preheader28.i.i.1, %._crit_edge79.i
  %indvars.iv.i.i = phi i64 [ 0, %._crit_edge79.i ], [ %indvars.iv.next.i.i.3, %.preheader28.i.i.1 ] ; 6 uses
...
.invoke224:                                       ; preds = %bb.ap, %bb.ds, %bb.dq, %bb.do, %bb.dj, %bb.dg, %bb.da, %.thread.thread.i, %bb.cv, %bb.cq, %bb.cn, %bb.cg, %bb.cd, %bb.by, %bb.bv, %bb.bp, %bb.bl, %bb.bb, %bb.ax
  %i.ex = phi ptr [ %i.qp, %bb.ds ], [ %i.qi, %bb.dq ], [ %i.fo, %bb.ax ], [ %i.fw, %bb.bb ], [ %i.id, %bb.bl ], [ %i.jf, %bb.bp ], [ %i.jx, %bb.bv ], [ %i.kb, %bb.by ], [ %i.kx, %bb.cd ], [ %i.lb, %bb.cg ], [ %i.mt, %bb.cn ], [ %i.mx, %bb.cq ], [ %i.nt, %bb.cv ], [ %i.nw, %.thread.thread.i ], [ %i.oo, %bb.da ], [ %i.pg, %bb.dg ], [ %i.pk, %bb.dj ], [ %i.qg, %bb.do ], [ %i.ew, %bb.ap ]
