...
bb.b:                                             ; preds = %bb.a
  ...
  %i.p = shufflevector <8 x float> %i.o, <8 x float> poison, <8 x i32> zeroinitializer
  %.not = icmp eq i32 %i.h, 0
  br i1 %.not, label %_ZN4ojph5localL18avx_multiply_constEPffi.exit, label %.lr.ph.i

.lr.ph.i:                                         ; preds = %bb.b, %.lr.ph.i
  %.09.i = phi ptr [ %i.t, %.lr.ph.i ], [ %i.e, %bb.b ] ; 3 uses
  %.078.i = phi i32 [ %i.s, %.lr.ph.i ], [ %i.h, %bb.b ] ; 2 uses
  %i.q = load <8 x float>, ptr %.09.i, align 32, !tbaa !8
  %i.r = fmul <8 x float> %i.p, %i.q
  store <8 x float> %i.r, ptr %.09.i, align 32, !tbaa !8
  %i.s = add nsw i32 %.078.i, -8
  %i.t = getelementptr inbounds nuw i8, ptr %.09.i, i64 32
  %6 = icmp samesign ugt i32 %.078.i, 8
  br i1 %6, label %.lr.ph.i, label %_ZN4ojph5localL18avx_multiply_constEPffi.exit, !llvm.loop !13

_ZN4ojph5localL18avx_multiply_constEPffi.exit:    ; preds = %.lr.ph.i, %bb.b
  %i.u = insertelement <8 x float> poison, float %i.n, i64 0
  %i.v = shufflevector <8 x float> %i.u, <8 x float> poison, <8 x i32> zeroinitializer
  %.not100 = icmp eq i32 %i.k, 0
  br i1 %.not100, label %_ZN4ojph5localL18avx_multiply_constEPffi.exit98, label %.lr.ph.i95

.lr.ph.i95:                                       ; preds = %_ZN4ojph5localL18avx_multiply_constEPffi.exit, %.lr.ph.i95
  %.09.i96 = phi ptr [ %i.z, %.lr.ph.i95 ], [ %i.c, %_ZN4ojph5localL18avx_multiply_constEPffi.exit ] ; 3 uses
  %.078.i97 = phi i32 [ %i.y, %.lr.ph.i95 ], [ %i.k, %_ZN4ojph5localL18avx_multiply_constEPffi.exit ] ; 2 uses
  %i.w = load <8 x float>, ptr %.09.i96, align 32, !tbaa !8
  %i.x = fmul <8 x float> %i.v, %i.w
  store <8 x float> %i.x, ptr %.09.i96, align 32, !tbaa !8
  %i.y = add nsw i32 %.078.i97, -8
  %i.z = getelementptr inbounds nuw i8, ptr %.09.i96, i64 32
  %7 = icmp samesign ugt i32 %.078.i97, 8
  br i1 %7, label %.lr.ph.i95, label %_ZN4ojph5localL18avx_multiply_constEPffi.exit98, !llvm.loop !13

_ZN4ojph5localL18avx_multiply_constEPffi.exit98:  ; preds = %.lr.ph.i95, %_ZN4ojph5localL18avx_multiply_constEPffi.exit
...
.lr.ph.i99:                                       ; preds = %.lr.ph.i99.prol.loopexit, %.lr.ph.i99
  ...
  br i1 %i.bl, label %.lr.ph.i99, label %_ZN4ojph5localL16avx_interleave32EPfS1_S1_i.exit, !llvm.loop !30
