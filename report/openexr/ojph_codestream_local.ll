...
.lr.ph:                                           ; preds = %bb.g, %.lr.ph
  %.0237272 = phi i32 [ %i.aa, %.lr.ph ], [ 0, %bb.g ] ; 2 uses
  %.0238271 = phi i1 [ %.1239.in, %.lr.ph ], [ true, %bb.g ]
  %.0240270 = phi i1 [ %i.z, %.lr.ph ], [ true, %bb.g ]
  %i.x = call i64 @_ZNK4ojph9param_siz16get_downsamplingEj(ptr noundef nonnull align 8 dereferenceable(8) %1, i32 noundef %.0237272) ; 2 uses
  %i.y = icmp eq i64 %i.x, 4294967297
  %i.z = and i1 %.0240270, %i.y                   ; 2 uses
  %.pn = icmp eq i64 %i.x, 4294967297
  %.1239.in = select i1 %.pn, i1 %.0238271, i1 false ; 2 uses
...
.lr.ph:                                           ; preds = %bb.g, %.lr.ph
  ...
  %.087111 = phi i32 [ %i.y, %.lr.ph ], [ 0, %bb.g ] ; 2 uses
  %i.v = call i64 @_ZNK4ojph9param_siz16get_downsamplingEj(ptr noundef nonnull align 8 dereferenceable(8) %1, i32 noundef %.087111) ; 2 uses
  %i.w = icmp eq i64 %i.v, 4294967297
  %i.x = and i1 %.0113, %i.w                      ; 2 uses
  %.pn = icmp eq i64 %i.v, 4294967297
  %.1.in = select i1 %.pn, i1 %.086112, i1 false  ; 2 uses
