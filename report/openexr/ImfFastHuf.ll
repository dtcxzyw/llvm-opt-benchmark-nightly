...
bb.n:                                             ; preds = %_ZN7Imf_3_414FastHufDecoder8readBitsEiRmRiRPKc.exit132
...
bb.r:                                             ; preds = %_ZN7Imf_3_414FastHufDecoder8readBitsEiRmRiRPKc.exit132
...
bb.ab:                                            ; preds = %bb.aa
  store i64 %i.ct, ptr %.sroa.9.0208, align 8, !tbaa !17
...
bb.af:                                            ; preds = %_ZNSt6vectorImSaImEE11_S_relocateEPmS2_S2_RS0_.exit16.i.i.i
  ...
  %.pre.pre = load i8, ptr %i.f, align 8, !tbaa !14
...
bb.ak:                                            ; preds = %bb.y, %bb.aj, %bb.z, %bb.r
  ...
  br i1 %.not, label %.preheader166.loopexit, label %bb.b, !llvm.loop !23
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ec = add nuw i64 %index, %i.dy               ; 2 uses
  %i.ed = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %i.ec
  %wide.load = load <2 x i64>, ptr %i.ed, align 8, !tbaa !17
  ...
  store <2 x double> %i.ei, ptr %i.ej, align 8, !tbaa !24
  %index.next = add nuw i64 %index, 2             ; 2 uses
  %vec.ind.next = add nuw nsw <2 x i64> %vec.ind, splat (i64 2)
  %i.ek = icmp eq i64 %index.next, %n.vec
  br i1 %i.ek, label %middle.block, label %vector.body, !llvm.loop !26
...
.lr.ph218:                                        ; preds = %.lr.ph218.preheader403, %.lr.ph218
  ...
  store double %i.ew, ptr %i.ex, align 8, !tbaa !24
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %.lr.ph227.preheader, label %.lr.ph218, !llvm.loop !29
...
.lr.ph223.prol:                                   ; preds = %.lr.ph223.preheader, %.lr.ph223.prol
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph223.prol.loopexit, label %.lr.ph223.prol, !llvm.loop !30
...
._crit_edge:                                      ; preds = %.lr.ph223.prol.loopexit, %.lr.ph223, %.lr.ph227
  ...
  br i1 %exitcond276.not, label %._crit_edge228, label %.lr.ph227, !llvm.loop !32
...
.lr.ph223:                                        ; preds = %.lr.ph223.prol.loopexit, %.lr.ph223
  ...
  br i1 %exitcond271.not.7, label %._crit_edge, label %.lr.ph223, !llvm.loop !33

._crit_edge228:                                   ; preds = %._crit_edge, %bb.al
  tail call void @_ZdaPv(ptr noundef nonnull %i.ag) #18
  %i.gq = load i8, ptr %i.g, align 1, !tbaa !15   ; 4 uses
  %i.gr = zext i8 %i.gq to i64                    ; 5 uses
  %i.gs = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %i.gr
  store i64 0, ptr %i.gs, align 8, !tbaa !17
  %i.gt = load i8, ptr %i.f, align 8, !tbaa !14   ; 5 uses
...
.lr.ph232.epil:                                   ; preds = %.lr.ph232.epil, %.lr.ph232.epil.preheader
  ...
  store i64 %i.hb, ptr %i.hc, align 8, !tbaa !17
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter428
  br i1 %epil.iter.cmp.not, label %._crit_edge233, label %.lr.ph232.epil, !llvm.loop !34

._crit_edge233:                                   ; preds = %._crit_edge233.loopexit.unr-lcssa, %.lr.ph232.epil, %._crit_edge228
  %i.hd = load i32, ptr %i.e, align 4, !tbaa !13  ; 2 uses
...
.lr.ph232:                                        ; preds = %.lr.ph232, %.lr.ph232.preheader.new
  ...
  store i64 %i.hm, ptr %i.hn, align 8, !tbaa !17
  ...
  %i.hx = load i64, ptr %i.hw, align 8, !tbaa !17
  %i.hy = add i64 %i.hx, %i.hu                    ; 3 uses
  %i.hz = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %indvars.iv.next278.3
  store i64 %i.hy, ptr %i.hz, align 8, !tbaa !17
  %niter.next.3 = add i64 %niter, 4               ; 2 uses
  %niter.ncmp.3.not = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3.not, label %._crit_edge233.loopexit.unr-lcssa, label %.lr.ph232, !llvm.loop !35

.preheader164:                                    ; preds = %._crit_edge233
  store ptr %i.hi, ptr %i.h, align 8, !tbaa !16
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d) #15
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(472) %i.d, i8 -1, i64 472, i1 false), !tbaa !17
...
.lr.ph238.preheader:                              ; preds = %.preheader164
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep, ptr noundef nonnull align 8 dereferenceable(1) %scevgep283, i64 %i.ie, i1 false), !tbaa !17
  br label %.preheader
...
._crit_edge242:                                   ; preds = %bb.as, %.preheader
  invoke void @_ZN7Imf_3_414FastHufDecoder11buildTablesEPmS1_(ptr noundef nonnull align 8 dereferenceable(21456) %0, ptr noundef nonnull %i.a, ptr noundef nonnull %i.b)
...
.lr.ph241:                                        ; preds = %.preheader, %bb.as
  ...
  %i.ig = load i64, ptr %.sroa.0137.0240, align 8, !tbaa !17 ; 2 uses
