...
iter.check:                                       ; preds = %.preheader529.lr.ph.split, %._crit_edge539
  %.0262540 = phi i32 [ 0, %.preheader529.lr.ph.split ], [ %i.bex, %._crit_edge539 ] ; 18 uses
  ...
  %i.nw = mul i32 %i.ll, %.0262540                ; 3 uses
  %i.nx = mul i32 %i.ln, %.0262540                ; 3 uses
  %i.ny = mul i32 %i.lp, %i.ns                    ; 50 uses
  %i.nz = mul i32 %i.lp, %i.nu                    ; 50 uses
  %i.oa = mul i32 %i.lr, %.0262540                ; 3 uses
  %i.ob = mul i32 %i.lt, %.0262540                ; 3 uses
  br i1 %min.iters.check, label %vec.epilog.scalar.ph.preheader, label %vector.scevcheck

vector.scevcheck:                                 ; preds = %iter.check
  %i.oc = mul i32 %i.mi, %.0262540                ; 4 uses
  %i.od = add i32 %i.lp, %i.oc
  %i.oe = mul i32 %i.mh, %.0262540                ; 4 uses
  %i.of = add i32 %i.li, %i.oe
  %8 = mul i32 %i.lt, %.0262540
  %9 = mul i32 %i.lr, %.0262540
  %10 = mul i32 %i.ln, %.0262540
  %11 = mul i32 %i.ll, %.0262540
  %i.og = xor i32 %11, -1
