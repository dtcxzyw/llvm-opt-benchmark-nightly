...
.preheader529.lr.ph.split:                        ; preds = %.preheader529.lr.ph
  ...
  %i.mg = add nsw i64 %wide.trip.count, -1        ; 14 uses
  %i.mh = shl i32 %i.li, 1
  %i.mi = shl i32 %i.lp, 1
  ...
  %8 = trunc i64 %i.mg to i32
  %i.mo = trunc i64 %i.mg to i32
  %i.mp = icmp ugt i64 %i.mg, 4294967295
  %9 = trunc i64 %i.mg to i32
  %10 = trunc i64 %i.mg to i32
  %i.mq = trunc i64 %i.mg to i32
  %mul.result = shl i32 %i.mq, 1
  %i.mr = icmp ugt i64 %i.mg, 2147483647
  %11 = trunc i64 %i.mg to i32
  %mul.result671 = shl i32 %11, 1
  %12 = trunc i64 %i.mg to i32
  %mul.result674 = shl i32 %12, 1
  %13 = trunc i64 %i.mg to i32
  %mul.result677 = shl i32 %13, 1
  %14 = trunc i64 %i.mg to i32
  %mul.result680 = shl i32 %14, 1
  %15 = trunc i64 %i.mg to i32
  %mul.result683 = shl i32 %15, 1
  %16 = trunc i64 %i.mg to i32
  %mul.result686 = shl i32 %16, 1
  %17 = trunc i64 %i.mg to i32
  %mul.result689 = shl i32 %17, 1
...
vector.scevcheck:                                 ; preds = %iter.check
  ...
  %i.oi = xor i32 %i.oh, -1
  %i.oj = icmp ult i32 %i.oi, %8
  %i.ok = xor i32 %i.og, -1
  %i.ol = icmp ult i32 %i.ok, %i.mo
  %i.om = or i1 %i.ol, %i.mp
  %i.on = xor i32 %i.of, -1
  %i.oo = icmp ult i32 %i.on, %9
  %i.op = xor i32 %i.oe, -1
  ...
  %i.ou = xor i32 %i.oc, -2
  %i.ov = icmp ult i32 %i.ou, %mul.result671
  %i.ow = xor i32 %i.od, -1
  %i.ox = icmp ugt i32 %mul.result674, %i.ow
  %i.oy = add i32 %i.li, %i.oc
  %i.oz = sub i32 -2, %i.oy
  %i.pa = icmp ult i32 %i.oz, %mul.result677
  %i.pb = xor i32 %i.oa, -1
  %i.pc = icmp ugt i32 %mul.result680, %i.pb
  %i.pd = xor i32 %i.oa, -2
  %i.pe = icmp ult i32 %i.pd, %mul.result683
  %i.pf = xor i32 %i.ob, -1
  %i.pg = icmp ugt i32 %mul.result686, %i.pf
  %i.ph = add i32 %i.lp, %i.oa
  %i.pi = sub i32 -2, %i.ph
  %i.pj = icmp ult i32 %i.pi, %mul.result689
