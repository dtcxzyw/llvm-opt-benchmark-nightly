...
.lr.ph.i:                                         ; preds = %.preheader.i, %.lr.ph.i
  ...
  store ptr inttoptr (i64 2147483647 to ptr), ptr %i.bb, align 8, !tbaa !36
...
bb.g:                                             ; preds = %bb.g, %.lr.ph29.i.new
  ...
  %i.be = sub nuw i32 %spec.select, %i.bd
  ...
  %i.bl = sub nuw i32 %spec.select, %i.bk
  ...
  %i.bs = sub nuw i32 %spec.select, %i.br
  ...
  %i.bw = load ptr, ptr %i.bv, align 8, !tbaa !36
  ...
  %i.bz = sub nuw i32 %spec.select, %i.by
...
bb.h:                                             ; preds = %bb.h, %.epil.preheader
  ...
  %i.cg = sub nuw i32 %spec.select, %i.cf
...
_ZN4ojph5local8tag_tree4initEPhPjjNS_4sizeEi.exit: ; preds = %bb.h, %_ZN4ojph5local8tag_tree4initEPhPjjNS_4sizeEi.exit.unr-lcssa
  ...
  %i.co = load ptr, ptr %0, align 8, !tbaa !34
...
vector.body845:                                   ; preds = %vector.body845, %vector.ph843
  ...
  %wide.load847 = load <2 x i32>, ptr %i.cq, align 4, !tbaa !35
  %wide.load848 = load <2 x i32>, ptr %i.cr, align 4, !tbaa !35
  ...
  store <2 x ptr> %wide.gep849, ptr %i.cu, align 8, !tbaa !36
  store <2 x ptr> %wide.gep850, ptr %i.cv, align 8, !tbaa !36
  %index.next851 = add nuw i64 %index846, 4       ; 2 uses
  %i.cw = icmp eq i64 %index.next851, %n.vec844
  br i1 %i.cw, label %middle.block852, label %vector.body845, !llvm.loop !68
...
scalar.ph841:                                     ; preds = %scalar.ph841.preheader, %scalar.ph841
  ...
  store ptr %i.da, ptr %i.db, align 8, !tbaa !36
...
.lr.ph.i293:                                      ; preds = %.preheader.i286, %.lr.ph.i293
  ...
  store ptr inttoptr (i64 2147483647 to ptr), ptr %i.de, align 8, !tbaa !36
...
bb.i:                                             ; preds = %bb.i, %.lr.ph29.i288.new
  ...
  %i.dh = sub nuw i32 %spec.select, %i.dg
  ...
  %i.do = sub nuw i32 %spec.select, %i.dn
  ...
  %i.dv = sub nuw i32 %spec.select, %i.du
  ...
  %i.ec = sub nuw i32 %spec.select, %i.eb
...
_ZN4ojph5local8tag_tree4initEPhPjjNS_4sizeEi.exit298: ; preds = %bb.j, %_ZN4ojph5local8tag_tree4initEPhPjjNS_4sizeEi.exit298.unr-lcssa
  ...
  %i.eq = load ptr, ptr %i.ep, align 8, !tbaa !36 ; 2 uses
  store i8 0, ptr %i.eq, align 1, !tbaa !41
  store i32 %i.aq, ptr %i.h, align 8, !tbaa !43
  %i.er = load ptr, ptr %0, align 8, !tbaa !34
...
vector.body831:                                   ; preds = %vector.body831, %vector.ph829
  ...
  %wide.load833 = load <2 x i32>, ptr %i.et, align 4, !tbaa !35
  %wide.load834 = load <2 x i32>, ptr %i.eu, align 4, !tbaa !35
  ...
  store <2 x ptr> %wide.gep835, ptr %i.ex, align 8, !tbaa !36
...
.lr.ph.i:                                         ; preds = %.preheader.i, %.lr.ph.i
  ...
  store ptr inttoptr (i64 2147483647 to ptr), ptr %i.ei, align 8, !tbaa !36
  %indvars.iv.next34.i = add nuw nsw i64 %indvars.iv33.i, 1 ; 2 uses
...
bb.ab:                                            ; preds = %bb.ab, %.lr.ph29.i.new
  ...
  %i.el = sub nuw i32 %spec.select, %i.ek
  ...
  %i.es = sub nuw i32 %spec.select, %i.er
  ...
  %i.ez = sub nuw i32 %spec.select, %i.ey
  ...
  %i.fg = sub nuw i32 %spec.select, %i.ff
...
bb.ac:                                            ; preds = %bb.ac, %.epil.preheader
  ...
  %i.fn = sub nuw i32 %spec.select, %i.fm
  %i.fo = shl nuw nsw i32 %i.fn, 1
...
_ZN4ojph5local8tag_tree4initEPhPjjNS_4sizeEi.exit: ; preds = %bb.ac, %_ZN4ojph5local8tag_tree4initEPhPjjNS_4sizeEi.exit.unr-lcssa
  ...
  %i.fv = load ptr, ptr %0, align 8, !tbaa !34
...
vector.body678:                                   ; preds = %vector.body678, %vector.ph676
  ...
  %wide.load680 = load <2 x i32>, ptr %i.fx, align 4, !tbaa !35
  %wide.load681 = load <2 x i32>, ptr %i.fy, align 4, !tbaa !35
  ...
  store <2 x ptr> %wide.gep682, ptr %i.gb, align 8, !tbaa !36
  store <2 x ptr> %wide.gep683, ptr %i.gc, align 8, !tbaa !36
  %index.next684 = add nuw i64 %index679, 4       ; 2 uses
  %i.gd = icmp eq i64 %index.next684, %n.vec677
  br i1 %i.gd, label %middle.block685, label %vector.body678, !llvm.loop !127
...
scalar.ph674:                                     ; preds = %scalar.ph674.preheader, %scalar.ph674
  ...
  %i.gf = load i32, ptr %i.ge, align 4, !tbaa !35
  ...
  store ptr %i.gh, ptr %i.gi, align 8, !tbaa !36
...
.lr.ph.i235:                                      ; preds = %.preheader.i228, %.lr.ph.i235
  ...
  store ptr inttoptr (i64 2147483647 to ptr), ptr %i.gl, align 8, !tbaa !36
...
bb.ad:                                            ; preds = %bb.ad, %.lr.ph29.i230.new
  ...
  %i.go = sub nuw i32 %spec.select, %i.gn
  %i.gp = shl nuw nsw i32 %i.go, 1
  %i.gq = shl nuw i32 1, %i.gp
  %i.gr = getelementptr inbounds nuw [8 x i8], ptr %i.bp, i64 %indvars.iv37.i232
  %i.gs = load ptr, ptr %i.gr, align 8, !tbaa !36
  ...
  %i.gv = sub nuw i32 %spec.select, %i.gu
  ...
  %i.hc = sub nuw i32 %spec.select, %i.hb
  ...
  %i.hg = load ptr, ptr %i.hf, align 8, !tbaa !36
  ...
  %i.hj = sub nuw i32 %spec.select, %i.hi
  ...
  %i.hn = load ptr, ptr %i.hm, align 8, !tbaa !36
...
bb.ae:                                            ; preds = %bb.ae, %.epil.preheader715
  ...
  %i.hq = sub nuw i32 %spec.select, %i.hp
...
_ZN4ojph5local8tag_tree4initEPhPjjNS_4sizeEi.exit240: ; preds = %bb.ae, %_ZN4ojph5local8tag_tree4initEPhPjjNS_4sizeEi.exit240.unr-lcssa
  ...
  store i8 0, ptr %i.hx, align 1, !tbaa !41
  %i.hy = load ptr, ptr %0, align 8, !tbaa !34
...
vector.body664:                                   ; preds = %vector.body664, %vector.ph662
  ...
  %wide.load666 = load <2 x i32>, ptr %i.ia, align 4, !tbaa !35
  %wide.load667 = load <2 x i32>, ptr %i.ib, align 4, !tbaa !35
  ...
  store <2 x ptr> %wide.gep668, ptr %i.ie, align 8, !tbaa !36
