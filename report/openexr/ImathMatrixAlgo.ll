...
.preheader227:                                    ; preds = %.preheader227, %.preheader227.preheader.new
  %.084244 = phi i64 [ 0, %.preheader227.preheader.new ], [ %i.az, %.preheader227 ] ; 4 uses
  ...
  %10 = or disjoint i64 %.084244, 1               ; 2 uses
  %11 = getelementptr inbounds nuw [24 x i8], ptr %1, i64 %10 ; 2 uses
  ...
  %i.ar = getelementptr inbounds nuw [24 x i8], ptr %2, i64 %10 ; 2 uses
  %i.as = load <2 x double>, ptr %i.ar, align 8, !tbaa !8
