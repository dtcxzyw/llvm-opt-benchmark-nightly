...
bb.a:
  ...
  %7 = alloca %"class.Imath_3_2::Matrix33", align 8 ; 11 uses
...
.loopexit224:                                     ; preds = %.preheader225, %.preheader223
  ...
  %i.gf = getelementptr inbounds nuw i8, ptr %7, i64 24
  %i.gg = getelementptr inbounds nuw i8, ptr %7, i64 48
  ...
  %i.gk = load double, ptr %i.gf, align 8, !tbaa !9, !noalias !29
  ...
  %10 = load <2 x double>, ptr %i.gg, align 8, !tbaa !9, !noalias !29 ; 3 uses
  ...
  %i.hj = fmul <2 x double> %11, %i.hi
  %i.hk = shufflevector <2 x double> %i.hb, <2 x double> %i.hh, <2 x i32> <i32 0, i32 2>
  %i.hl = shufflevector <2 x double> %10, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  ...
  %i.ii = insertelement <2 x double> %i.hl, double %i.gh, i64 0
...
.loopexit224:                                     ; preds = %.preheader225, %.preheader223
  ...
  %i.ft = getelementptr inbounds nuw i8, ptr %7, i64 48
  ...
  %i.fx = load double, ptr %i.fs, align 8, !tbaa !9, !noalias !42
  ...
  %10 = load <2 x double>, ptr %i.ft, align 8, !tbaa !9, !noalias !42 ; 3 uses
  ...
  %i.gw = fmul <2 x double> %11, %i.gv
  %i.gx = shufflevector <2 x double> %i.go, <2 x double> %i.gu, <2 x i32> <i32 0, i32 2>
  %i.gy = shufflevector <2 x double> %10, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  ...
  %i.hv = insertelement <2 x double> %i.gy, double %i.fu, i64 0
