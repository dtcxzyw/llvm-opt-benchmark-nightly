...
bb.d:                                             ; preds = %.thread.i.i, %bb.c
  ...
  %7 = insertelement <2 x double> poison, double %i.eg, i64 0
  %i.eh = insertelement <2 x double> %7, double %i.ef, i64 1
  %i.ei = insertelement <2 x double> poison, double %6, i64 0
  %i.ej = shufflevector <2 x double> %i.ei, <2 x double> poison, <2 x i32> zeroinitializer
  %8 = load double, ptr %i.ao, align 8, !tbaa !8
  %i.ek = load double, ptr %i.s, align 8, !tbaa !8 ; 2 uses
  %i.el = fneg double %i.ek
  %9 = insertelement <2 x double> poison, double %i.el, i64 0
  %i.em = insertelement <2 x double> %9, double %i.ek, i64 1
  %i.en = insertelement <2 x double> poison, double %8, i64 0
  %i.eo = shufflevector <2 x double> %i.en, <2 x double> poison, <2 x i32> zeroinitializer
  %10 = load double, ptr %i.ap, align 8, !tbaa !8
  ...
  %i.fj = fmul <2 x double> %i.fi, %i.eh
  ...
  %i.fm = fmul <2 x double> %i.fi, %i.em
  ...
  %i.fr = shufflevector <2 x double> %11, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.fz = shufflevector <2 x double> %13, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %14 = load double, ptr %i.ar, align 8, !tbaa !8
  ...
  %i.gi = shufflevector <2 x double> %15, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %16 = load double, ptr %i.as, align 8, !tbaa !8
  ...
  %i.gr = shufflevector <2 x double> %17, <2 x double> poison, <2 x i32> zeroinitializer
...
bb.f:                                             ; preds = %.thread.i88.i, %bb.e
  ...
  %18 = load double, ptr %i.as, align 8, !tbaa !8
  ...
  %i.mu = insertelement <2 x double> %19, double %i.lw, i64 1
...
_ZN9Imath_3_212_GLOBAL__N_122twoSidedJacobiRotationIdLi1ELi2ELi0EEEbRNS_8Matrix33IT_EES5_S5_S3_.exit.thread.i: ; preds = %.thread.i105.i, %bb.g
  ...
  %20 = load double, ptr %i.r, align 8, !tbaa !8
  ...
  %i.qo = shufflevector <2 x double> %21, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %22 = load double, ptr %i.s, align 8, !tbaa !8
  ...
  %i.qv = shufflevector <2 x double> %23, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %24 = load double, ptr %i.aq, align 8, !tbaa !8
  ...
  %i.rc = shufflevector <2 x double> %25, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %26 = load double, ptr %i.v, align 8, !tbaa !8
  ...
  %i.rk = shufflevector <2 x double> %27, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %28 = load double, ptr %i.w, align 8, !tbaa !8
  ...
  %i.rt = shufflevector <2 x double> %29, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %30 = load double, ptr %i.at, align 8, !tbaa !8
  ...
  %i.sc = shufflevector <2 x double> %31, <2 x double> poison, <2 x i32> zeroinitializer
...
bb.c:                                             ; preds = %.thread.i.i, %bb.b
  ...
  %6 = load float, ptr %1, align 4, !tbaa !27
  ...
  %i.ec = shufflevector <2 x float> %7, <2 x float> poison, <2 x i32> zeroinitializer
  %8 = load float, ptr %i.t, align 4, !tbaa !27
  %i.ed = load float, ptr %i.u, align 4, !tbaa !27 ; 2 uses
  %i.ee = fneg float %i.ed
  %9 = insertelement <2 x float> poison, float %i.ee, i64 0
  %i.ef = insertelement <2 x float> %9, float %i.ed, i64 1
  %i.eg = insertelement <2 x float> poison, float %8, i64 0
  ...
  %10 = load float, ptr %3, align 4, !tbaa !27
  ...
  %i.fp = shufflevector <2 x float> %11, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %12 = load float, ptr %i.ab, align 4, !tbaa !27
  ...
  %i.fy = shufflevector <2 x float> %13, <2 x float> poison, <2 x i32> zeroinitializer
...
_ZN9Imath_3_212_GLOBAL__N_122twoSidedJacobiRotationIfLi1ELi2ELi0EEEbRNS_8Matrix33IT_EES5_S5_S3_.exit.thread.i: ; preds = %.thread.i105.i, %bb.f
  ...
  %14 = load float, ptr %i.r, align 4, !tbaa !27
  ...
  %i.pg = shufflevector <2 x float> %15, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %16 = load float, ptr %i.u, align 4, !tbaa !27
  ...
  %i.pn = shufflevector <2 x float> %17, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %18 = load float, ptr %i.z, align 4, !tbaa !27
  ...
  %i.qe = shufflevector <2 x float> %19, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %20 = load float, ptr %i.ac, align 4, !tbaa !27
  ...
  %i.qn = shufflevector <2 x float> %21, <2 x float> poison, <2 x i32> zeroinitializer
