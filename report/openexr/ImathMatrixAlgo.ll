...
.loopexit224:                                     ; preds = %.preheader225, %.preheader223
  ...
  %i.gj = load double, ptr %i.gi, align 8, !tbaa !8, !noalias !17 ; 3 uses
  ...
  %i.hl = fmul double %i.gj, %i.hc
  %10 = load double, ptr %i.gh, align 8, !tbaa !8, !noalias !17 ; 2 uses
  %11 = load double, ptr %i.gb, align 8, !tbaa !8, !noalias !17 ; 2 uses
  ...
  %i.hr = insertelement <2 x double> poison, double %11, i64 0
  ...
  %i.ip = call double @llvm.fmuladd.f64(double %i.hy, double %11, double %i.io) ; 3 uses
...
.loopexit224:                                     ; preds = %.preheader225, %.preheader223
  ...
  %i.fw = load double, ptr %i.fv, align 8, !tbaa !8, !noalias !35 ; 3 uses
  ...
  %i.gy = fmul double %i.fw, %i.gp
  %10 = load double, ptr %i.fu, align 8, !tbaa !8, !noalias !35 ; 2 uses
  %11 = load double, ptr %i.fo, align 8, !tbaa !8, !noalias !35 ; 2 uses
  ...
  %i.he = insertelement <2 x double> poison, double %11, i64 0
  ...
  %i.ic = call double @llvm.fmuladd.f64(double %i.hl, double %11, double %i.ib) ; 3 uses
