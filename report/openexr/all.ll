...
bb.d:                                             ; preds = %bb.c
  ...
  %6 = fdiv float %i.t, %.sroa.speculated
  %7 = select i1 %i.v, float %6, float 1.000000e+00
  ...
  %8 = fdiv float %i.g, %i.w
  %9 = select i1 %or.cond49, float %8, float 1.000000e+00
  %i.aa = fmul float %3, %7
  %i.ab = tail call float @llvm.fmuladd.f32(float %1, float %i.q, float %i.aa)
  %i.ac = fmul float %i.ab, %9
  br label %bb.e
