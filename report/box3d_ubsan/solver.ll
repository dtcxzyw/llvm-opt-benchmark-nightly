...
bb.ae:                                            ; preds = %bb.ac
  ...
  %i.co = load float, ptr %i.cn, align 8, !tbaa !371 ; 10 uses
...
.lr.ph217.preheader:                              ; preds = %.lr.ph.split.split.preheader.i
  ...
  %i.do = shufflevector <2 x float> %i.dn, <2 x float> poison, <2 x i32> zeroinitializer ; 4 uses
...
bb.ap:                                            ; preds = %bb.ao, %bb.an
  ...
  %4 = fmul float %i.co, %i.fi                    ; 2 uses
  %5 = getelementptr inbounds nuw i8, ptr %i.eg, i64 80
  %6 = fmul float %i.co, %i.fm                    ; 2 uses
  %.sroa.0178.0.copyload.i = load <2 x float>, ptr %5, align 4
  ...
  %7 = fmul float %4, %.sroa.2179.0.copyload.i
  %i.fn = fmul float %.sroa.4231.0.copyload.i, %6
  %8 = fadd float %i.fn, %7
  %9 = insertelement <2 x float> poison, float %4, i64 0
  %10 = shufflevector <2 x float> %9, <2 x float> poison, <2 x i32> zeroinitializer
  %11 = fmul <2 x float> %10, %.sroa.0178.0.copyload.i
  %12 = insertelement <2 x float> poison, float %6, i64 0
  %i.fo = shufflevector <2 x float> %12, <2 x float> poison, <2 x i32> zeroinitializer
  %i.fp = fmul <2 x float> %.sroa.0230.0.copyload.i, %i.fo
  %i.fq = fadd <2 x float> %i.fp, %11
