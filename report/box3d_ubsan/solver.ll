...
bb.aw:                                            ; preds = %bb.av, %bb.as, %bb.at, %bb.au
  ...
  %i.px = load <2 x float>, ptr %i.dp, align 4    ; 6 uses
  ...
  %foldExtExtBinop7301 = fmul <2 x float> %i.px, %i.px
  %shift7303 = shufflevector <2 x float> %i.px, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop7304 = fmul <2 x float> %i.px, %shift7303 ; 2 uses
  %shift7306 = shufflevector <2 x float> %i.pw, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %i.qj = fmul <2 x float> %i.pw, %shift7306      ; 2 uses
  %6 = shufflevector <2 x float> %i.qf, <2 x float> %i.qg, <2 x i32> <i32 3, i32 0>
  %7 = fmul <2 x float> %6, splat (float 2.000000e+00) ; 8 uses
  %foldExtExtBinop7309 = fadd <2 x float> %i.qj, %foldExtExtBinop7304
  %foldExtExtBinop7311 = fsub <2 x float> %i.qj, %foldExtExtBinop7304
  %8 = shufflevector <2 x float> %foldExtExtBinop7309, <2 x float> %foldExtExtBinop7311, <2 x i32> <i32 0, i32 2>
  %i.qk = fmul <2 x float> %8, splat (float 2.000000e+00) ; 8 uses
  %9 = shufflevector <2 x float> %foldExtExtBinop7301, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ql = fadd <2 x float> %i.pz, %9
  ...
  %foldExtExtBinop7304.a = fmul <2 x float> %7, %.sroa.5483.0.copyload
  %i.sl = shufflevector <2 x float> %foldExtExtBinop7304.a, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %foldExtExtBinop7306 = fmul <2 x float> %.sroa.0481.0.copyload, %7
  %i.sm = shufflevector <2 x float> %foldExtExtBinop7306, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %i.sn = shufflevector <2 x float> %.sroa.0481.0.copyload, <2 x float> %7, <4 x i32> <i32 poison, i32 1, i32 3, i32 1>
  %i.so = insertelement <4 x float> %i.sn, float -0.000000e+00, i64 0
  %i.sp = shufflevector <2 x float> %7, <2 x float> %.sroa.5483.0.copyload, <4 x i32> <i32 poison, i32 1, i32 3, i32 1>
  ...
  %i.tf = shufflevector <2 x float> %7, <2 x float> %i.qn, <4 x i32> <i32 0, i32 3, i32 2, i32 0>
  %i.tg = fmul <4 x float> %i.tf, %i.td
  %i.th = shufflevector <2 x float> %7, <2 x float> %i.qk, <4 x i32> <i32 1, i32 3, i32 2, i32 1>
  ...
  %i.tu = fmul <2 x float> %7, %i.qw
  %i.tv = shufflevector <2 x float> %7, <2 x float> poison, <2 x i32> <i32 1, i32 0>
