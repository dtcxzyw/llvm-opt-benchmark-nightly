...
bb.r:                                             ; preds = %bb.q
  ...
  %3 = shufflevector <3 x float> %i.mm, <3 x float> poison, <3 x i32> <i32 1, i32 2, i32 0> ; 2 uses
  %4 = shufflevector <4 x float> %i.gu, <4 x float> poison, <3 x i32> <i32 1, i32 2, i32 0>
  %5 = fmul <3 x float> %3, %4
  ...
  %i.nb = shufflevector <4 x float> %i.hr, <4 x float> poison, <3 x i32> <i32 2, i32 0, i32 1>
  %i.nc = fmul <3 x float> %i.mm, %i.nb
  %6 = shufflevector <4 x float> %i.hr, <4 x float> poison, <3 x i32> <i32 1, i32 2, i32 0>
  %i.nd = fmul <3 x float> %3, %6
