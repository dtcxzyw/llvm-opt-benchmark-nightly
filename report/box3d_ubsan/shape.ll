...
bb.r:                                             ; preds = %bb.p
  ...
  %.sroa.6570.0.copyload = load <2 x float>, ptr %.sroa.6570.0..sroa_idx, align 8 ; 8 uses
  %.sroa.2.8.vec.extract65.i.i.a = extractelement <2 x float> %.sroa.6570.0.copyload, i64 0
  %.sroa.09.0.vec.extract.i.i.i = extractelement <2 x float> %.sroa.5569.0.copyload, i64 0
  %i.bt = fneg float %.sroa.2.8.vec.extract65.i.i.a
  ...
  %i.bu = fmul float %.sroa.4568.0.copyload, %.sroa.09.0.vec.extract.i.i.i
  ...
  %14 = shufflevector <2 x float> %.sroa.5569.0.copyload, <2 x float> %.sroa.6570.0.copyload, <4 x i32> <i32 poison, i32 0, i32 3, i32 2>
  %15 = insertelement <4 x float> %14, float %i.eg, i64 0
  %16 = shufflevector <2 x float> %.sroa.5569.0.copyload, <2 x float> %.sroa.6570.0.copyload, <4 x i32> <i32 poison, i32 1, i32 poison, i32 2>
  %17 = insertelement <4 x float> %16, float 5.000000e-01, i64 0
  %18 = insertelement <4 x float> %17, float %i.bt, i64 2
  %19 = fmul <4 x float> %15, %18                 ; 5 uses
  %i.eh = extractelement <4 x float> %19, i64 1   ; 2 uses
  %20 = extractelement <4 x float> %19, i64 2     ; 2 uses
  %i.ei = fadd float %i.eh, %20
  %i.ej = fsub float %i.eh, %20
  ...
  %21 = shufflevector <4 x float> %19, <4 x float> poison, <2 x i32> <i32 3, i32 3>
  %i.en = fadd <2 x float> %i.ed, %21
  ...
  %i.gc = shufflevector <4 x float> %19, <4 x float> poison, <2 x i32> zeroinitializer
  %i.gd = fmul <2 x float> %i.gc, %i.fn
  %i.ge = fadd <2 x float> %i.gd, %i.gb           ; 2 uses
  %22 = extractelement <4 x float> %19, i64 0
  %i.gf = fmul float %22, %i.fq
...
bb.ag:                                            ; preds = %b3MakeShapeProxy.exit232
  ...
  %i.ir = load <2 x float>, ptr %i.iq, align 4    ; 24 uses
  %i.is = getelementptr inbounds nuw i8, ptr %3, i64 44
  %i.it = load <2 x float>, ptr %i.is, align 4    ; 11 uses
  ...
  %.sroa.2.8.vec.extract65.i233.a = extractelement <2 x float> %i.it, i64 0
  %.sroa.09.4.vec.extract13.i.i234 = extractelement <2 x float> %i.ir, i64 1 ; 4 uses
  %.sroa.09.0.vec.extract.i.i237 = extractelement <2 x float> %i.ir, i64 0 ; 2 uses
  ...
  %i.jg = fmul float %.sroa.09.0.vec.extract.i.i237, %.sroa.280.0.copyload
  ...
  %i.mu = fmul float %.sroa.09.4.vec.extract13.i.i234, %i.mt
  ...
  %i.no = fmul float %.sroa.09.4.vec.extract13.i.i234, %i.ng
  ...
  %i.py = fmul float %.sroa.09.4.vec.extract13.i.i234, %i.px
  ...
  %i.qs = fmul float %.sroa.09.4.vec.extract13.i.i234, %i.qk
  ...
  %i.rg = fneg float %.sroa.2.8.vec.extract65.i233.a
  ...
  %i.rh = fmul float %.sroa.09.0.vec.extract.i.i237, %i.ms
  ...
  %23 = shufflevector <2 x float> %i.ir, <2 x float> %i.it, <4 x i32> <i32 poison, i32 0, i32 3, i32 2>
  %24 = insertelement <4 x float> %23, float %i.tp, i64 0
  %25 = shufflevector <2 x float> %i.ir, <2 x float> %i.it, <4 x i32> <i32 poison, i32 1, i32 poison, i32 2>
  %26 = insertelement <4 x float> %25, float 5.000000e-01, i64 0
  %27 = insertelement <4 x float> %26, float %i.rg, i64 2
  %28 = fmul <4 x float> %24, %27                 ; 5 uses
  %29 = extractelement <4 x float> %28, i64 1     ; 2 uses
  %30 = extractelement <4 x float> %28, i64 2     ; 2 uses
  %i.tq = fadd float %29, %30
  %i.tr = fsub float %29, %30
  ...
  %31 = shufflevector <4 x float> %28, <4 x float> poison, <2 x i32> <i32 3, i32 3>
  %i.tv = fadd <2 x float> %i.tm, %31
...
bb.l:                                             ; preds = %bb.c
  ...
  %.sroa.5326.0.copyload = load <2 x float>, ptr %.sroa.5326.0..sroa_idx, align 4 ; 19 uses
  ...
  %.sroa.0.4.vec.extract8.i.i17.i = extractelement <2 x float> %.sroa.5326.0.copyload, i64 1 ; 2 uses
  %i.an = fmul float %.sroa.2.8.vec.extract65.i.i, %.sroa.0.4.vec.extract8.i.i17.i
  %.sroa.0.0.vec.extract.i.i18.i = extractelement <2 x float> %.sroa.5326.0.copyload, i64 0 ; 2 uses
  %.sroa.3.12.vec.extract53.i.i = extractelement <2 x float> %.sroa.6327.0.copyload, i64 1 ; 2 uses
  ...
  %foldExtExtBinop381 = fsub <2 x float> %i.md, %i.mb
  %11 = extractelement <2 x float> %foldExtExtBinop381, i64 0
  %i.mg = fmul float %11, 2.000000e+00            ; 3 uses
  %12 = fsub float %.sroa.9.0.copyload, %.sroa.5294.0.copyload
  %13 = shufflevector <2 x float> %.sroa.5326.0.copyload, <2 x float> %.sroa.6327.0.copyload, <4 x i32> <i32 poison, i32 0, i32 3, i32 2>
  %14 = insertelement <4 x float> %13, float %12, i64 0
  %15 = shufflevector <2 x float> %.sroa.5326.0.copyload, <2 x float> %.sroa.6327.0.copyload, <4 x i32> <i32 poison, i32 1, i32 poison, i32 2>
  %16 = insertelement <4 x float> %15, float 5.000000e-01, i64 0
  %17 = insertelement <4 x float> %16, float %i.ka, i64 2
  %18 = fmul <4 x float> %14, %17                 ; 5 uses
  %19 = extractelement <4 x float> %18, i64 1     ; 2 uses
  %20 = extractelement <4 x float> %18, i64 2     ; 2 uses
  %21 = fadd float %19, %20
  %22 = fsub float %19, %20
  %23 = insertelement <2 x float> poison, float %22, i64 0
  %24 = insertelement <2 x float> %23, float %21, i64 1
  %25 = fmul <2 x float> %24, splat (float 2.000000e+00) ; 3 uses
  %26 = shufflevector <4 x float> %18, <4 x float> poison, <2 x i32> <i32 3, i32 3>
  %27 = fadd <2 x float> %i.mf, %26
  %28 = fmul <2 x float> %27, splat (float 2.000000e+00)
  %i.mh = fsub <2 x float> splat (float 1.000000e+00), %28 ; 3 uses
  %foldExtExtBinop383 = fadd <2 x float> %i.md, %i.mb
  %29 = extractelement <2 x float> %foldExtExtBinop383, i64 1
  %30 = fmul float %29, 2.000000e+00              ; 3 uses
  %31 = fadd <2 x float> %i.md, %i.mb
  %32 = fsub <2 x float> %i.md, %i.mb
  %33 = shufflevector <2 x float> %31, <2 x float> %32, <2 x i32> <i32 0, i32 3>
  %34 = fmul <2 x float> %33, splat (float 2.000000e+00) ; 3 uses
  %35 = call reassoc float @llvm.vector.reduce.fadd.v2f32(float -0.000000e+00, <2 x float> %i.me)
  %36 = fmul float %35, 2.000000e+00
  %37 = fsub float 1.000000e+00, %36              ; 3 uses
  %38 = fcmp olt float %i.mg, 0.000000e+00
  %39 = fneg float %i.mg
  %40 = select i1 %38, float %39, float %i.mg
  %41 = fcmp olt <2 x float> %25, zeroinitializer
  %42 = fneg <2 x float> %25
  %43 = select <2 x i1> %41, <2 x float> %42, <2 x float> %25
  %44 = fcmp olt <2 x float> %i.mh, zeroinitializer
  %45 = fneg <2 x float> %i.mh
  %46 = select <2 x i1> %44, <2 x float> %45, <2 x float> %i.mh
  %47 = fcmp olt float %30, 0.000000e+00
  %48 = fneg float %30
  %49 = select i1 %47, float %48, float %30
  %i.mi = fcmp olt <2 x float> %34, zeroinitializer
  %i.mj = fneg <2 x float> %34
  %i.mk = select <2 x i1> %i.mi, <2 x float> %i.mj, <2 x float> %34
  %i.ml = fcmp olt float %37, 0.000000e+00
  %i.mm = fneg float %37
  %i.mn = select i1 %i.ml, float %i.mm, float %37
  %50 = fsub <2 x float> %.sroa.7295.0.copyload, %.sroa.0292.0.copyload
  %51 = fmul <2 x float> %50, splat (float 5.000000e-01) ; 4 uses
  %52 = shufflevector <2 x float> %51, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %53 = extractelement <2 x float> %51, i64 0
  %54 = fmul float %40, %53
  %i.mo = extractelement <2 x float> %51, i64 1
  %55 = fmul float %49, %i.mo
  %56 = fadd float %54, %55
  %i.mp = fmul <2 x float> %43, %52
  %57 = fmul <2 x float> %46, %51
  %58 = fadd <2 x float> %i.mp, %57
  %i.mq = shufflevector <4 x float> %18, <4 x float> poison, <2 x i32> zeroinitializer
  %i.mr = fmul <2 x float> %i.mk, %i.mq
  %i.ms = fadd <2 x float> %i.mr, %58             ; 2 uses
  %59 = extractelement <4 x float> %18, i64 0
  %i.mt = fmul float %i.mn, %59
  %i.mu = fadd float %i.mt, %56                   ; 2 uses
