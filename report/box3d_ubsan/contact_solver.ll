...
.lr.ph:                                           ; preds = %bb.z
  ...
  %4 = shufflevector <2 x float> %.sroa.0560.0.copyload, <2 x float> poison, <3 x i32> <i32 1, i32 0, i32 poison>
  %5 = insertelement <3 x float> %4, float %.sroa.6563.0.copyload, i64 2
...
bb.aa:                                            ; preds = %.lr.ph, %bb.ai
  ...
  %.sroa.10656.12554 = phi float [ %.sroa.10656.02572, %.lr.ph ], [ %15, %bb.ai ] ; 2 uses
  %.sroa.0651.12553 = phi <2 x float> [ %.sroa.0651.02571, %.lr.ph ], [ %12, %bb.ai ] ; 3 uses
...
bb.ai:                                            ; preds = %bb.ag, %bb.ah, %bb.af
  ...
  %6 = insertelement <3 x float> poison, float %i.kr, i64 0
  %7 = shufflevector <3 x float> %6, <3 x float> poison, <3 x i32> zeroinitializer
  %8 = fmul <3 x float> %5, %7                    ; 5 uses
  %9 = shufflevector <3 x float> %8, <3 x float> poison, <2 x i32> <i32 0, i32 1> ; 2 uses
  %10 = fmul <2 x float> %i.ej, %9
  %11 = shufflevector <2 x float> %10, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %12 = fsub <2 x float> %.sroa.0651.12553, %11   ; 2 uses
  %13 = extractelement <3 x float> %8, i64 2      ; 2 uses
  %14 = fmul float %i.bl, %13
  %15 = fsub float %.sroa.10656.12554, %14        ; 2 uses
  %16 = shufflevector <3 x float> %8, <3 x float> poison, <2 x i32> <i32 2, i32 2> ; 2 uses
  %17 = fmul <2 x float> %i.ig, %16
  %18 = shufflevector <3 x float> %8, <3 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.kx = fmul <2 x float> %i.jv, %18
  %i.ky = fsub <2 x float> %17, %i.kx             ; 3 uses
  %19 = shufflevector <3 x float> %8, <3 x float> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  %20 = fmul <2 x float> %i.jv, %19
  %i.kz = fmul <2 x float> %i.jr, %16
  %i.la = fsub <2 x float> %20, %i.kz             ; 3 uses
  %i.lb = fmul <2 x float> %i.jr, %18
  %i.lc = fmul <2 x float> %i.ig, %19
  ...
  %i.ls = fmul <2 x float> %i.eg, %9
  %21 = shufflevector <2 x float> %i.ls, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %i.lt = fadd <2 x float> %.sroa.0623.12549, %21 ; 2 uses
  %i.lu = fmul float %i.bq, %13
...
._crit_edge:                                      ; preds = %bb.ai, %bb.z
  ...
  %.sroa.0651.1.lcssa = phi <2 x float> [ %.sroa.0651.02571, %bb.z ], [ %12, %bb.ai ] ; 3 uses
  %.sroa.10656.1.lcssa = phi float [ %.sroa.10656.02572, %bb.z ], [ %15, %bb.ai ] ; 3 uses
