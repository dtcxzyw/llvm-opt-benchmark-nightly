...
bb.s:                                             ; preds = %bb.q
  ...
  %i.bc = load <2 x float>, ptr %i.bb, align 4    ; 13 uses
  ...
  %.sroa.2.8.vec.extract65.i = extractelement <2 x float> %i.be, i64 0
  %.sroa.09.4.vec.extract13.i.i = extractelement <2 x float> %i.bc, i64 1 ; 2 uses
  %i.bf = shufflevector <2 x float> %.sroa.024.0.copyload, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %8 = extractelement <2 x float> %.sroa.024.0.copyload, i64 1
  %.sroa.0.0.vec.extract.i.i = extractelement <2 x float> %.sroa.024.0.copyload, i64 0
  %.sroa.09.0.vec.extract.i.i = extractelement <2 x float> %i.bc, i64 0
  %.sroa.2.12.vec.extract.i = extractelement <2 x float> %i.be, i64 1 ; 2 uses
  ...
  %i.cc = fadd float %.sroa.9.8.vec.extract, %i.cb
...
bb.ah:                                            ; preds = %bb.af
  ...
  %9 = fmul float %.sroa.09.4.vec.extract13.i.i, %.sroa.2.12.vec.extract.i ; 2 uses
  %10 = fmul float %.sroa.09.4.vec.extract13.i.i, %.sroa.2.8.vec.extract65.i ; 2 uses
  %11 = fmul float %.sroa.09.0.vec.extract.i.i, %.sroa.2.12.vec.extract.i ; 2 uses
  %foldExtExtBinop88.a = fmul <2 x float> %i.bc, %i.be
  %12 = extractelement <2 x float> %foldExtExtBinop88.a, i64 0 ; 2 uses
  %13 = shufflevector <2 x float> %i.bc, <2 x float> %i.be, <3 x i32> <i32 0, i32 3, i32 2>
  %14 = shufflevector <2 x float> %i.bc, <2 x float> %i.be, <3 x i32> <i32 1, i32 2, i32 2>
  %15 = fmul <3 x float> %13, %14                 ; 3 uses
  %i.du = fmul <2 x float> %i.bc, %i.bc           ; 2 uses
  %16 = shufflevector <2 x float> %i.du, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %17 = fsub float %12, %9
  %18 = fmul float %17, 2.000000e+00
  %19 = fadd float %10, %11
  %20 = fmul float %19, 2.000000e+00
  %21 = shufflevector <3 x float> %15, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %22 = fadd <2 x float> %16, %21
  %23 = fmul <2 x float> %22, splat (float 2.000000e+00)
  %24 = extractelement <3 x float> %15, i64 0     ; 2 uses
  %25 = extractelement <3 x float> %15, i64 1     ; 2 uses
  %26 = fadd float %24, %25
  %27 = fsub float %24, %25
  ...
  %31 = fsub <2 x float> splat (float 1.000000e+00), %23
  %32 = fsub float %10, %11
  %33 = fadd float %12, %9
  %34 = insertelement <2 x float> poison, float %33, i64 0
  %35 = insertelement <2 x float> %34, float %32, i64 1
  %36 = fmul <2 x float> %35, splat (float 2.000000e+00)
  %foldExtExtBinop91 = fadd <2 x float> %i.du, %16
  %i.dv = extractelement <2 x float> %foldExtExtBinop91, i64 0
...
bb.ao:                                            ; preds = %bb.am
  ...
  %i.fo = fmul <2 x float> %36, %i.fn
  %i.fp = shufflevector <2 x float> %.sroa.012.0.copyload.i, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %i.fq = fmul <2 x float> %30, %i.fp
  %i.fr = fmul <2 x float> %31, %.sroa.012.0.copyload.i
...
bb.bm:                                            ; preds = %bb.bl
  ...
  %i.kl = fmul float %.sroa.9.8.vec.extract, %i.kg
...
bb.a:
  ...
  %.sroa.5111.0.copyload = load <2 x float>, ptr %.sroa.5111.0..sroa_idx, align 4 ; 13 uses
  ...
  %.sroa.2.8.vec.extract65.i.i = extractelement <2 x float> %.sroa.6112.0.copyload, i64 0 ; 2 uses
  %.sroa.09.0.vec.extract.i.i.i = extractelement <2 x float> %.sroa.5111.0.copyload, i64 0 ; 2 uses
...
bb.e:                                             ; preds = %bb.a
  %.sroa.2.12.vec.extract.i.i = extractelement <2 x float> %.sroa.6112.0.copyload, i64 1 ; 2 uses
  %.sroa.09.4.vec.extract13.i.i.i = extractelement <2 x float> %.sroa.5111.0.copyload, i64 1 ; 2 uses
  ...
  %7 = shufflevector <2 x float> %.sroa.5111.0.copyload, <2 x float> %.sroa.6112.0.copyload, <3 x i32> <i32 0, i32 3, i32 2>
  %8 = shufflevector <2 x float> %.sroa.5111.0.copyload, <2 x float> %.sroa.6112.0.copyload, <3 x i32> <i32 1, i32 2, i32 2>
  ...
  %i.av = fadd <2 x float> %i.aq, %10
  %i.aw = fmul <2 x float> %i.av, splat (float 2.000000e+00)
  %11 = extractelement <3 x float> %9, i64 0      ; 2 uses
  %12 = extractelement <3 x float> %9, i64 1      ; 2 uses
  %i.ax = fadd float %11, %12
  %i.ay = fsub float %11, %12
