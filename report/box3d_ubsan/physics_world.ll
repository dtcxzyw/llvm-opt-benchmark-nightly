...
.split.1:                                         ; preds = %bb.i
  ...
  %11 = fcmp olt <2 x float> %.sroa.035.0.copyload, %.sroa.033.0.copyload
  %12 = select <2 x i1> %11, <2 x float> %.sroa.035.0.copyload, <2 x float> %.sroa.033.0.copyload
  %13 = fcmp olt float %.sroa.236.0.copyload, %.sroa.234.0.copyload
  %i.aj = select i1 %13, float %.sroa.236.0.copyload, float %.sroa.234.0.copyload
  %14 = fcmp ogt float %.sroa.07.0.vec.extract.i, %.sroa.0.0.vec.extract.i
  %15 = select i1 %14, float %.sroa.07.0.vec.extract.i, float %.sroa.0.0.vec.extract.i
  %i.ak = shufflevector <2 x float> %12, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.al = insertelement <4 x float> %i.ak, float %i.aj, i64 2
  %i.am = insertelement <4 x float> %i.al, float %15, i64 3 ; 2 uses
...
b3MakeAABB.exit:                                  ; preds = %bb.i
  ...
  %.sroa.0.4.vec.extract4.i = extractelement <2 x float> %1, i64 1
  %13 = fcmp olt <2 x float> %.sroa.0.0.copyload, %.sroa.5.12.copyload
  %14 = select <2 x i1> %13, <2 x float> %.sroa.0.0.copyload, <2 x float> %.sroa.5.12.copyload
  %15 = fcmp olt float %.sroa.4.0.copyload, %.sroa.7.12.copyload
  %i.av = select i1 %15, float %.sroa.4.0.copyload, float %.sroa.7.12.copyload
  %16 = fcmp ogt float %.sroa.07.0.vec.extract.i57.i, %.sroa.0.0.vec.extract.i.i
  %17 = select i1 %16, float %.sroa.07.0.vec.extract.i57.i, float %.sroa.0.0.vec.extract.i.i
  %i.aw = shufflevector <2 x float> %14, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.ax = insertelement <4 x float> %i.aw, float %i.av, i64 2
  %i.ay = insertelement <4 x float> %i.ax, float %17, i64 3 ; 2 uses
...
bb.l:                                             ; preds = %bb.j
  ...
  %8 = fsub <2 x float> %.sroa.0126.0.copyload, %i.bc ; 4 uses
  %9 = load float, ptr %i.ax, align 8, !tbaa !278
  %i.bd = fsub float %.sroa.2127.0.copyload, %9   ; 3 uses
  %i.be = shufflevector <2 x float> %8, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
...
bb.u:                                             ; preds = %bb.t, %bb.s
  ...
  %10 = extractelement <2 x float> %foldExtExtBinop236, i64 0
  %i.eg = extractelement <2 x float> %i.ee, i64 0
  %i.eh = fmul float %.sroa.9.0, %i.eg
  %11 = fsub float %10, %i.eh
  ...
  %i.eu = insertelement <2 x float> %i.et, float %11, i64 0
...
bb.ci:                                            ; preds = %bb.ch
  ...
  %6 = fmul float %.sroa.32.8.vec.extract.i, %.sroa.01.4.vec.extract.i355
  %i.pf = fmul float %.sroa.01.4.vec.extract.i, %.sroa.32.8.vec.extract.i357
  %i.pg = shufflevector <2 x float> %i.om, <2 x float> %i.ol, <2 x i32> <i32 0, i32 2>
  %i.ph = fmul <2 x float> %i.oc, %i.pg           ; 2 uses
  %7 = shufflevector <2 x float> %i.od, <2 x float> %i.oc, <2 x i32> <i32 0, i32 2> ; 3 uses
  %8 = fmul <2 x float> %7, %i.ol                 ; 2 uses
  %i.pi = shufflevector <2 x float> %i.ph, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %i.pj = insertelement <2 x float> %i.pi, float %6, i64 0
  %i.pk = shufflevector <2 x float> %8, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %i.pl = insertelement <2 x float> %i.pk, float %i.pf, i64 0
  %i.pm = fsub <2 x float> %i.pj, %i.pl
  %i.pn = fsub <2 x float> %i.ph, %8
  ...
  %i.qp = fmul <2 x float> %7, %i.qo
  %i.qq = fmul <2 x float> %7, %i.ql
...
bb.cn:                                            ; preds = %bb.cm
  ...
  %i.so = fsub <2 x float> %i.sk, %i.sn
  %9 = fmul <2 x float> %i.py, %i.ry              ; 2 uses
  %shift10017 = shufflevector <2 x float> %9, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop10018 = fsub <2 x float> %9, %shift10017
  ...
  %11 = select <2 x i1> %i.sx, <2 x float> %i.sy, <2 x float> %10 ; 3 uses
  %12 = fcmp olt float %i.sw, 0.000000e+00
  %13 = fneg float %i.sw
  %i.sz = select i1 %12, float %13, float %i.sw   ; 2 uses
  ...
  %foldExtExtBinop10026 = fmul <2 x float> %11, %shift10025
  %i.tc = extractelement <2 x float> %foldExtExtBinop10026, i64 0
  %i.td = fadd float %i.tb, %i.tc                 ; 2 uses
  %i.te = fmul <2 x float> %11, %i.sh
  %i.tf = shufflevector <2 x float> %11, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
...
bb.co:                                            ; preds = %bb.cn
  ...
  %shift10032 = shufflevector <2 x float> %i.od, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop10033 = fmul <2 x float> %shift10032, %i.og
  %14 = extractelement <2 x float> %foldExtExtBinop10033, i64 0
  ...
  %shift10042 = shufflevector <2 x float> %i.om, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop10043 = fmul <2 x float> %shift10042, %i.op
  %15 = extractelement <2 x float> %foldExtExtBinop10043, i64 0
  ...
  %16 = fsub float %i.tw, %i.tx
  %i.up = fsub <2 x float> %i.uo, %i.ty
  %17 = fsub float %16, %14
  %18 = fadd <2 x float> %i.ua, %i.up             ; 7 uses
  ...
  %19 = fsub float %i.ue, %i.uf
  %i.uv = fsub <2 x float> %i.uu, %i.ug
  %i.uw = fadd <2 x float> %i.ui, %i.uv           ; 7 uses
  %shift10048 = shufflevector <2 x float> %18, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop10049 = fmul <2 x float> %18, %shift10048
  %20 = extractelement <2 x float> %foldExtExtBinop10049, i64 0 ; 2 uses
  %foldExtExtBinop10049.a = fmul <2 x float> %18, %18
  %21 = shufflevector <2 x float> %foldExtExtBinop10049.a, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 3 uses
  ...
  %22 = fsub float %19, %15
  %23 = shufflevector <2 x float> %21, <2 x float> %i.va, <4 x i32> <i32 poison, i32 1, i32 poison, i32 3>
  %24 = shufflevector <4 x float> %i.ub, <4 x float> %23, <4 x i32> <i32 0, i32 5, i32 poison, i32 7>
  %25 = shufflevector <4 x float> %24, <4 x float> %i.uj, <4 x i32> <i32 0, i32 1, i32 4, i32 3>
  %26 = shufflevector <2 x float> %21, <2 x float> %i.va, <4 x i32> <i32 poison, i32 0, i32 poison, i32 2>
  %27 = insertelement <4 x float> %26, float %17, i64 0
  %28 = insertelement <4 x float> %27, float %22, i64 2
  %i.vb = fadd <4 x float> %25, %28               ; 6 uses
  %i.vc = shufflevector <4 x float> %i.vb, <4 x float> poison, <2 x i32> zeroinitializer
  %i.vd = fmul <2 x float> %i.vc, %18             ; 4 uses
  %i.ve = extractelement <4 x float> %i.vb, i64 0
  %29 = shufflevector <4 x float> %i.vb, <4 x float> <float poison, float 2.000000e+00, float poison, float 2.000000e+00>, <4 x i32> <i32 0, i32 5, i32 2, i32 7>
  %i.vf = fmul <4 x float> %i.vb, %29             ; 4 uses
  %i.vg = shufflevector <4 x float> %i.vf, <4 x float> poison, <2 x i32> zeroinitializer
  %i.vh = fadd <2 x float> %i.vg, %21
  ...
  %30 = shufflevector <4 x float> %i.vb, <4 x float> poison, <2 x i32> <i32 2, i32 2>
  %i.vm = fmul <2 x float> %30, %i.uw             ; 4 uses
  %31 = extractelement <4 x float> %i.vb, i64 2
  %32 = shufflevector <4 x float> %i.vf, <4 x float> poison, <2 x i32> <i32 2, i32 2>
  %i.vn = fadd <2 x float> %32, %i.va
  ...
  %foldExtExtBinop10054 = fmul <2 x float> %i.vt, %18 ; 2 uses
  %i.vv = shufflevector <2 x float> %18, <2 x float> %i.uw, <2 x i32> <i32 1, i32 3>
  ...
  %i.wc = fmul float %i.ve, %i.vu                 ; 2 uses
  %i.wd = fadd float %i.wc, %20
  ...
  %33 = fsub float %20, %i.wc
  %i.wi = insertelement <2 x float> poison, float %33, i64 0
  ...
  %34 = fmul float %31, %i.vy                     ; 2 uses
  %35 = fadd float %34, %i.uy
  %i.wr = extractelement <2 x float> %i.wf, i64 1
  %i.ws = fmul float %i.wr, 2.000000e+00          ; 5 uses
  %36 = fsub float %i.uy, %34
  %i.wt = insertelement <2 x float> poison, float %36, i64 0
  %i.wu = insertelement <2 x float> %i.wt, float %35, i64 1
...
.thread558:                                       ; preds = %bb.ch, %bb.cg, %bb.cf, %bb.cm, %bb.cn
  ...
  %37 = shufflevector <2 x float> %.sroa.6527.0.copyload, <2 x float> %.sroa.7.0.copyload, <4 x i32> <i32 1, i32 2, i32 2, i32 0>
  %38 = shufflevector <2 x float> %.sroa.8522.0.copyload, <2 x float> %.sroa.6520.0.copyload, <4 x i32> <i32 0, i32 3, i32 2, i32 0>
  %i.agr = fmul <4 x float> %37, %38              ; 2 uses
  %39 = shufflevector <4 x float> %i.agr, <4 x float> poison, <2 x i32> <i32 0, i32 2>
  %40 = shufflevector <4 x float> %i.agr, <4 x float> poison, <2 x i32> <i32 1, i32 3>
  %i.ags = fsub <2 x float> %39, %40
