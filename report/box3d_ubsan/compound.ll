...
bb.i:                                             ; preds = %bb.g
  ...
  br i1 %i.ae, label %bb.ht, label %bb.j
...
bb.j:                                             ; preds = %bb.i
  ...
  %.fr2360 = freeze ptr %i.am                     ; 11 uses
  ...
  %.fr2366 = freeze ptr %i.aq                     ; 12 uses
...
.lr.ph.split:                                     ; preds = %bb.j
  ...
  %.fr2345 = freeze ptr %i.ay                     ; 3 uses
  %i.az = ptrtoint ptr %.fr2345 to i64, !nosanitize !9 ; 3 uses
  %.not2346 = icmp eq ptr %.fr2345, null, !nosanitize !9
  br i1 %.not2346, label %.split1883, label %.lr.ph.split.split.preheader, !prof !20
...
.lr.ph1888:                                       ; preds = %b3MaterialMap_reserve.exit
  ...
  %.not2348 = icmp eq ptr %.fr, null
  %i.br = ptrtoint ptr %i.bn to i64               ; 3 uses
  %i.bs = icmp ne ptr %i.bn, null                 ; 2 uses
  br i1 %.not2348, label %.split1900, label %.lr.ph1888.split, !prof !20
...
.lr.ph.split.split:                               ; preds = %.lr.ph.split.split.preheader, %bb.k
  ...
  %i.bt = getelementptr inbounds nuw [64 x i8], ptr %.fr2345, i64 %indvars.iv ; 2 uses
  %i.bu = shl nuw nsw i64 %indvars.iv, 6
  %i.bv = add i64 %i.bu, %i.az, !nosanitize !9    ; 2 uses
  %.not2347 = icmp ult i64 %i.bv, %i.az, !nosanitize !9
  br i1 %.not2347, label %.split.us, label %bb.n, !prof !20, !nosanitize !9
...
._crit_edge.loopexit:                             ; preds = %bb.ae
  %i.cf = trunc nuw nsw i64 %indvars.iv.next3744 to i32
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %b3MaterialMap_reserve.exit
  ...
  %.fr2354 = freeze ptr %i.ch                     ; 13 uses
  %i.ci = icmp sgt i32 %i.aj, 0                   ; 2 uses
  br i1 %i.ci, label %.split1907.preheader, label %bb.bk

.lr.ph1888.split:                                 ; preds = %.lr.ph1888, %bb.ae
  %indvars.iv3743 = phi i64 [ %indvars.iv.next3744, %bb.ae ], [ 0, %.lr.ph1888 ] ; 6 uses
  %.03421886 = phi i32 [ %.1343, %bb.ae ], [ 0, %.lr.ph1888 ] ; 7 uses
  %i.cj = load ptr, ptr %0, align 8, !tbaa !170   ; 3 uses
  %i.ck = getelementptr inbounds nuw [72 x i8], ptr %i.cj, i64 %indvars.iv3743 ; 4 uses
  %i.cl = mul nuw nsw i64 %indvars.iv3743, 72
...
bb.q:                                             ; preds = %.lr.ph1888.split
  %i.ct = getelementptr inbounds nuw [32 x i8], ptr %.fr, i64 %indvars.iv3743 ; 3 uses
  %i.cu = shl nuw nsw i64 %indvars.iv3743, 5
  %i.cv = add i64 %i.cu, %i.bq, !nosanitize !9    ; 2 uses
  %.not2349 = icmp ult i64 %i.cv, %i.bq, !nosanitize !9
  br i1 %.not2349, label %.split1896.us, label %bb.r, !prof !20, !nosanitize !9
...
bb.ae:                                            ; preds = %bb.w, %bb.ad
  ...
  %i.eg = call i32 @b3DynamicTree_CreateProxy(ptr noundef nonnull %1, ptr noundef nonnull byval(%struct.b3AABB) align 8 %4, i64 noundef -1, i64 noundef %indvars.iv3743) #13 ; 0 uses
  %indvars.iv.next3744 = add nuw nsw i64 %indvars.iv3743, 1 ; 3 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #13
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #13
  %i.eh = load i32, ptr %i.h, align 8, !tbaa !163
  %i.ei = sext i32 %i.eh to i64
  %i.ej = icmp slt i64 %indvars.iv.next3744, %i.ei
...
.split1907.preheader:                             ; preds = %._crit_edge
  ...
  %i.em = ptrtoint ptr %.fr2360 to i64            ; 3 uses
  %i.en = icmp ne ptr %.fr2360, null              ; 2 uses
  %i.eo = ptrtoint ptr %i.bn to i64               ; 3 uses
  %i.ep = icmp ne ptr %i.bn, null                 ; 2 uses
  %i.eq = ptrtoint ptr %.fr2354 to i64            ; 3 uses
  %i.er = icmp ne ptr %.fr2354, null              ; 2 uses
  %i.es = zext nneg i32 %.0347.lcssa to i64
  %i.et = add nuw i32 %.0347.lcssa, %i.aj
  %i.eu = sub nuw nsw i32 2147483647, %.0347.lcssa
  %wide.trip.count3755 = zext nneg i32 %i.eu to i64
  %wide.trip.count3757 = zext nneg i32 %i.aj to i64
  br label %.split1907
...
.split1907:                                       ; preds = %.split1907.preheader, %bb.bj
  %indvars.iv3750 = phi i64 [ %i.es, %.split1907.preheader ], [ %indvars.iv.next3751, %bb.bj ] ; 3 uses
  %indvars.iv3748 = phi i64 [ 0, %.split1907.preheader ], [ %indvars.iv.next3749, %bb.bj ] ; 6 uses
  ...
  %i.ew = getelementptr inbounds nuw [80 x i8], ptr %i.ev, i64 %indvars.iv3748 ; 4 uses
  %i.ex = mul nuw nsw i64 %indvars.iv3748, 80
...
bb.aj:                                            ; preds = %bb.ah
  ...
  %i.fl = call i32 @b3DynamicTree_CreateProxy(ptr noundef nonnull %1, ptr noundef nonnull byval(%struct.b3AABB) align 8 %6, i64 noundef -1, i64 noundef %indvars.iv3750) #13 ; 0 uses
  %indvars.iv.next3751 = add nuw nsw i64 %indvars.iv3750, 1
  %exitcond3756 = icmp eq i64 %indvars.iv3748, %wide.trip.count3755
  br i1 %exitcond3756, label %bb.ak, label %bb.al, !prof !20, !nosanitize !9

bb.ak:                                            ; preds = %bb.aj
  call void @__ubsan_handle_add_overflow_abort(ptr nonnull @63, i64 %indvars.iv3750, i64 1) #12, !nosanitize !9
  unreachable, !nosanitize !9
...
bb.bq:                                            ; preds = %bb.bo
  ...
  %indvars.iv.next3767 = add nsw i64 %indvars.iv3766, 1
...
bb.bu:                                            ; preds = %b3MaterialMap_get_or_insert.exit.us.us.us
  ...
  %.not2350 = icmp ult i64 %i.ln, %i.kf, !nosanitize !9
  br i1 %.not2350, label %.split1931.us, label %bb.bv, !prof !20, !nosanitize !9
...
bb.cn:                                            ; preds = %bb.cl
  ...
  br i1 %i.pi, label %bb.cp, label %bb.co, !prof !10, !nosanitize !9
...
bb.cp:                                            ; preds = %bb.cn
  ...
  %i.pm = getelementptr inbounds nuw [64 x i8], ptr %i.pl, i64 %indvars.iv3764 ; 2 uses
  ...
  br i1 %i.pt, label %bb.cr, label %bb.cq, !prof !10, !nosanitize !9
...
bb.cr:                                            ; preds = %bb.cp
  ...
  br i1 %i.px, label %bb.ct, label %bb.cs, !prof !10, !nosanitize !9
...
bb.ct:                                            ; preds = %bb.cr
  ...
  %i.qa = icmp eq i32 %i.ok, %.03352207
  br i1 %i.qa, label %bb.cu, label %bb.db

bb.cu:                                            ; preds = %bb.ct
  %i.qb = sext i32 %.03352207 to i64              ; 2 uses
  %i.qc = getelementptr inbounds [16 x i8], ptr %.fr2357, i64 %i.qb ; 3 uses
  ...
  %i.qi = icmp slt i32 %.03352207, 0
  %i.qj = xor i1 %i.qi, %i.qh
  %i.qk = and i1 %i.qg, %i.qj, !nosanitize !9
  br i1 %i.qk, label %bb.cw, label %bb.cv, !prof !10, !nosanitize !9
...
bb.cw:                                            ; preds = %bb.cu
  ...
  br i1 %i.qo, label %bb.cy, label %bb.cx, !prof !10, !nosanitize !9
...
bb.cy:                                            ; preds = %bb.cw
  ...
  %i.qq = call { i32, i1 } @llvm.sadd.with.overflow.i32(i32 %.03352207, i32 1), !nosanitize !9 ; 2 uses
  %i.qr = extractvalue { i32, i1 } %i.qq, 1, !nosanitize !9
  br i1 %i.qr, label %bb.cz, label %bb.da, !prof !20, !nosanitize !9

bb.cz:                                            ; preds = %bb.cy
  %i.qs = zext nneg i32 %.03352207 to i64, !nosanitize !9
...
bb.db:                                            ; preds = %bb.da, %bb.ct
  %.1336 = phi i32 [ %i.qt, %bb.da ], [ %.03352207, %bb.ct ] ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %12) #13
  call void @llvm.lifetime.end.p0(ptr nonnull %10) #13
  %indvars.iv.next3765 = add i64 %indvars.iv3764, 1 ; 2 uses
  %exitcond3772.not = icmp eq i64 %indvars.iv.next3765, %wide.trip.count3771
  br i1 %exitcond3772.not, label %._crit_edge2210, label %.lr.ph2209.split, !llvm.loop !149

bb.dc:                                            ; preds = %b3MeshMap_cleanup.exit, %bb.bk
  ...
  br i1 %i.qv, label %.lr.ph2218, label %._crit_edge2219

.lr.ph2218:                                       ; preds = %bb.dc
  %i.qw = getelementptr inbounds nuw i8, ptr %0, i64 48
  %i.qx = ptrtoint ptr %.fr2351 to i64            ; 3 uses
  %i.qy = ptrtoint ptr %i.bn to i64               ; 3 uses
  %i.qz = icmp ne ptr %i.bn, null                 ; 2 uses
  %.not2352 = icmp eq ptr %.fr2351, null
  br i1 %.not2352, label %.split2230, label %.lr.ph2218.split.split.preheader, !prof !20

.lr.ph2218.split.split.preheader:                 ; preds = %.lr.ph2218
  %smax3775 = call i32 @llvm.smax.i32(i32 %i.aj, i32 0)
  %15 = add i32 %.0347.lcssa, %smax3775
  %smax3776 = call i32 @llvm.smax.i32(i32 %i.an, i32 0)
  %16 = add i32 %15, %smax3776
  %17 = sext i32 %16 to i64
  br label %.lr.ph2218.split.split

._crit_edge2219:                                  ; preds = %bb.dt, %bb.dc
  %.9.lcssa = phi i32 [ %.8, %bb.dc ], [ %.10, %bb.dt ] ; 2 uses
  ...
  br i1 %i.rt, label %.lr.ph2236, label %._crit_edge2237

.lr.ph2236:                                       ; preds = %._crit_edge2219
  %i.ru = ptrtoint ptr %.fr2354 to i64, !nosanitize !9 ; 3 uses
  %.not2355 = icmp eq ptr %.fr2354, null, !nosanitize !9
  br i1 %.not2355, label %.split2244, label %.lr.ph2236.split.preheader, !prof !20

.lr.ph2236.split.preheader:                       ; preds = %.lr.ph2236
  %wide.trip.count3785 = zext nneg i32 %.2340 to i64
  br label %.lr.ph2236.split

.lr.ph2218.split.split:                           ; preds = %.lr.ph2218.split.split.preheader, %bb.dt
  %indvars.iv3775 = phi i64 [ %17, %.lr.ph2218.split.split.preheader ], [ %indvars.iv.next3776, %bb.dt ] ; 3 uses
  %indvars.iv3773 = phi i64 [ 0, %.lr.ph2218.split.split.preheader ], [ %indvars.iv.next3774, %bb.dt ] ; 5 uses
  %.92215 = phi i32 [ %.8, %.lr.ph2218.split.split.preheader ], [ %.10, %bb.dt ] ; 7 uses
  %i.rv = load ptr, ptr %i.qw, align 8, !tbaa !189 ; 3 uses
  %i.rw = getelementptr inbounds nuw [56 x i8], ptr %i.rv, i64 %indvars.iv3773 ; 4 uses
  %i.rx = mul nuw nsw i64 %indvars.iv3773, 56
  ...
  br i1 %i.se, label %bb.dd, label %.split2222.us, !prof !10, !nosanitize !9

.split2222.us:                                    ; preds = %.lr.ph2218.split.split
  call void @__ubsan_handle_pointer_overflow_abort(ptr nonnull @104, i64 %i.ry, i64 %i.rz) #12, !nosanitize !9
  unreachable, !nosanitize !9

bb.dd:                                            ; preds = %.lr.ph2218.split.split
  %i.sf = getelementptr inbounds nuw [20 x i8], ptr %.fr2351, i64 %indvars.iv3773 ; 3 uses
  %i.sg = mul nuw nsw i64 %indvars.iv3773, 20
  %i.sh = add i64 %i.sg, %i.qx, !nosanitize !9    ; 2 uses
  %.not2353 = icmp ult i64 %i.sh, %i.qx, !nosanitize !9
  br i1 %.not2353, label %.split2226.us, label %bb.de, !prof !20, !nosanitize !9

.split2226.us:                                    ; preds = %bb.dd
...
bb.de:                                            ; preds = %bb.dd
  ...
  br i1 %i.sk, label %bb.df, label %.split2230, !prof !10, !nosanitize !9

.split2230:                                       ; preds = %bb.de, %.lr.ph2218
  %.us-phi2231 = phi i64 [ 0, %.lr.ph2218 ], [ %i.si, %bb.de ]
  call void @__ubsan_handle_type_mismatch_v1_abort(ptr nonnull @107, i64 %.us-phi2231) #12, !nosanitize !9
  unreachable, !nosanitize !9
...
bb.df:                                            ; preds = %bb.de
  ...
  br i1 %i.so, label %bb.dh, label %bb.dg, !prof !10, !nosanitize !9
...
bb.dh:                                            ; preds = %bb.df
  ...
  call fastcc void @b3MaterialMap_get_or_insert(ptr dead_on_unwind noalias writable align 8 %13, ptr noundef %2, ptr noundef nonnull %i.sp, i32 noundef %.92215)
  ...
  br i1 %i.sv, label %bb.dj, label %bb.di, !prof !10, !nosanitize !9
...
bb.dj:                                            ; preds = %bb.dh
  ...
  %i.sz = icmp eq i32 %i.sy, %.92215
  br i1 %i.sz, label %bb.dk, label %bb.dr

bb.dk:                                            ; preds = %bb.dj
  %i.ta = sext i32 %.92215 to i64                 ; 2 uses
  ...
  %i.th = icmp slt i32 %.92215, 0
  %i.ti = xor i1 %i.th, %i.tg
  %i.tj = and i1 %i.tf, %i.ti, !nosanitize !9
  br i1 %i.tj, label %bb.dm, label %bb.dl, !prof !10, !nosanitize !9
...
bb.dm:                                            ; preds = %bb.dk
  ...
  br i1 %i.tn, label %bb.do, label %bb.dn, !prof !10, !nosanitize !9
...
bb.do:                                            ; preds = %bb.dm
  ...
  %i.to = call { i32, i1 } @llvm.sadd.with.overflow.i32(i32 %.92215, i32 1), !nosanitize !9 ; 2 uses
  %i.tp = extractvalue { i32, i1 } %i.to, 1, !nosanitize !9
  br i1 %i.tp, label %bb.dp, label %bb.dq, !prof !20, !nosanitize !9

bb.dp:                                            ; preds = %bb.do
  %i.tq = zext nneg i32 %.92215 to i64, !nosanitize !9
...
bb.dr:                                            ; preds = %bb.dq, %bb.dj
  %.10 = phi i32 [ %i.tr, %bb.dq ], [ %.92215, %bb.dj ] ; 2 uses
  ...
  %i.ts = call i32 @b3DynamicTree_CreateProxy(ptr noundef nonnull %1, ptr noundef nonnull byval(%struct.b3AABB) align 8 %14, i64 noundef -1, i64 noundef %indvars.iv3775) #13 ; 0 uses
  %exitcond3781 = icmp eq i64 %indvars.iv3775, 2147483647
  br i1 %exitcond3781, label %bb.ds, label %bb.dt, !prof !20, !nosanitize !9
...
bb.dt:                                            ; preds = %bb.dr
  ...
  %indvars.iv.next3774 = add nuw nsw i64 %indvars.iv3773, 1 ; 2 uses
  %i.tt = load i32, ptr %i.q, align 8, !tbaa !165
  %i.tu = sext i32 %i.tt to i64
  %i.tv = icmp slt i64 %indvars.iv.next3774, %i.tu
  br i1 %i.tv, label %.lr.ph2218.split.split, label %._crit_edge2219, !llvm.loop !150

._crit_edge2237:                                  ; preds = %bb.dx, %._crit_edge2219
  %.0330.lcssa = phi i64 [ %i.rs, %._crit_edge2219 ], [ %i.uv, %bb.dx ] ; 3 uses
  %i.tw = trunc i64 %.0330.lcssa to i32
  %i.tx = add nsw i64 %i.ap, 4
  %i.ty = and i64 %i.tx, -8
  %i.tz = add i64 %.0330.lcssa, %i.ty             ; 2 uses
  %i.ua = icmp sgt i32 %.2, 0                     ; 2 uses
  br i1 %i.ua, label %.lr.ph2250, label %._crit_edge2251

.lr.ph2250:                                       ; preds = %._crit_edge2237
  %i.ub = ptrtoint ptr %.fr2357 to i64, !nosanitize !9 ; 3 uses
  %.not2358 = icmp eq ptr %.fr2357, null, !nosanitize !9
  br i1 %.not2358, label %.split2258, label %.lr.ph2250.split.preheader, !prof !20

.lr.ph2250.split.preheader:                       ; preds = %.lr.ph2250
  %wide.trip.count3790 = zext nneg i32 %.2 to i64
  br label %.lr.ph2250.split

.lr.ph2236.split:                                 ; preds = %.lr.ph2236.split.preheader, %bb.dx
  %indvars.iv3782 = phi i64 [ 0, %.lr.ph2236.split.preheader ], [ %indvars.iv.next3783, %bb.dx ] ; 3 uses
  %.03302233 = phi i64 [ %i.rs, %.lr.ph2236.split.preheader ], [ %i.uv, %bb.dx ] ; 2 uses
  %i.uc = trunc i64 %.03302233 to i32
  %i.ud = getelementptr inbounds nuw [16 x i8], ptr %.fr2354, i64 %indvars.iv3782 ; 3 uses
  %i.ue = shl nuw nsw i64 %indvars.iv3782, 4
  %i.uf = add i64 %i.ue, %i.ru, !nosanitize !9    ; 2 uses
  %.not2356 = icmp ult i64 %i.uf, %i.ru, !nosanitize !9
  br i1 %.not2356, label %.split2240.us, label %bb.du, !prof !20, !nosanitize !9

.split2240.us:                                    ; preds = %.lr.ph2236.split
  call void @__ubsan_handle_pointer_overflow_abort(ptr nonnull @115, i64 %i.ru, i64 %i.uf) #12, !nosanitize !9
  unreachable, !nosanitize !9

bb.du:                                            ; preds = %.lr.ph2236.split
  %i.ug = ptrtoint ptr %i.ud to i64, !nosanitize !9 ; 2 uses
  %i.uh = and i64 %i.ug, 7, !nosanitize !9
  %i.ui = icmp eq i64 %i.uh, 0, !nosanitize !9
  br i1 %i.ui, label %bb.dv, label %.split2244, !prof !10, !nosanitize !9

.split2244:                                       ; preds = %bb.du, %.lr.ph2236
  %.us-phi2245 = phi i64 [ 0, %.lr.ph2236 ], [ %i.ug, %bb.du ]
  call void @__ubsan_handle_type_mismatch_v1_abort(ptr nonnull @116, i64 %.us-phi2245) #12, !nosanitize !9
  unreachable, !nosanitize !9
...
bb.dv:                                            ; preds = %bb.du
  ...
  br i1 %i.up, label %bb.dx, label %bb.dw, !prof !10, !nosanitize !9
...
bb.dx:                                            ; preds = %bb.dv
  ...
  %indvars.iv.next3783 = add nuw nsw i64 %indvars.iv3782, 1 ; 2 uses
  %i.ur = load i32, ptr %i.uq, align 4, !tbaa !192
  %i.us = sext i32 %i.ur to i64
  %i.ut = add nsw i64 %i.us, 7
  %i.uu = and i64 %i.ut, -8
  %i.uv = add i64 %i.uu, %.03302233               ; 2 uses
  %exitcond3786.not = icmp eq i64 %indvars.iv.next3783, %wide.trip.count3785
  br i1 %exitcond3786.not, label %._crit_edge2237, label %.lr.ph2236.split, !llvm.loop !151

._crit_edge2251:                                  ; preds = %bb.eb, %._crit_edge2237
  %.1.lcssa = phi i64 [ %i.tz, %._crit_edge2237 ], [ %i.vx, %bb.eb ] ; 2 uses
  ...
  br i1 %.not, label %bb.ec, label %bb.ed, !prof !20, !nosanitize !9

.lr.ph2250.split:                                 ; preds = %.lr.ph2250.split.preheader, %bb.eb
  %indvars.iv3787 = phi i64 [ 0, %.lr.ph2250.split.preheader ], [ %indvars.iv.next3788, %bb.eb ] ; 3 uses
  %.12247 = phi i64 [ %i.tz, %.lr.ph2250.split.preheader ], [ %i.vx, %bb.eb ] ; 2 uses
  %i.ve = trunc i64 %.12247 to i32
  %i.vf = getelementptr inbounds nuw [16 x i8], ptr %.fr2357, i64 %indvars.iv3787 ; 3 uses
  %i.vg = shl nuw nsw i64 %indvars.iv3787, 4
  %i.vh = add i64 %i.vg, %i.ub, !nosanitize !9    ; 2 uses
  %.not2359 = icmp ult i64 %i.vh, %i.ub, !nosanitize !9
  br i1 %.not2359, label %.split2254.us, label %bb.dy, !prof !20, !nosanitize !9

.split2254.us:                                    ; preds = %.lr.ph2250.split
  call void @__ubsan_handle_pointer_overflow_abort(ptr nonnull @119, i64 %i.ub, i64 %i.vh) #12, !nosanitize !9
  unreachable, !nosanitize !9

bb.dy:                                            ; preds = %.lr.ph2250.split
  %i.vi = ptrtoint ptr %i.vf to i64, !nosanitize !9 ; 2 uses
  %i.vj = and i64 %i.vi, 7, !nosanitize !9
  %i.vk = icmp eq i64 %i.vj, 0, !nosanitize !9
  br i1 %i.vk, label %bb.dz, label %.split2258, !prof !10, !nosanitize !9

.split2258:                                       ; preds = %bb.dy, %.lr.ph2250
  %.us-phi2259 = phi i64 [ 0, %.lr.ph2250 ], [ %i.vi, %bb.dy ]
  call void @__ubsan_handle_type_mismatch_v1_abort(ptr nonnull @120, i64 %.us-phi2259) #12, !nosanitize !9
  unreachable, !nosanitize !9
...
bb.dz:                                            ; preds = %bb.dy
  ...
  br i1 %i.vr, label %bb.eb, label %bb.ea, !prof !10, !nosanitize !9
...
bb.ed:                                            ; preds = %._crit_edge2251
  ...
  br i1 %i.wa, label %bb.ef, label %bb.ee, !prof !10, !nosanitize !9
...
bb.ef:                                            ; preds = %bb.ed
  ...
  br i1 %i.wu, label %bb.eg, label %b3GetCompoundNodes.exit, !prof !20, !nosanitize !9
end_hunk_1
...
!175 = !{!174, !31, i64 0}
!176 = !{!"", !31, i64 0, !6, i64 8}
!177 = !{!176, !6, i64 8}
!178 = !{!"b3SharedHull", !31, i64 0, !6, i64 8}
end_hunk_2
