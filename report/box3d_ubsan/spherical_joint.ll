...
bb.c:                                             ; preds = %bb.a
  ...
  %i.g = extractelement <2 x float> %foldExtExtBinop691, i64 0 ; 8 uses
  ...
  %i.aa = fadd <2 x float> %i.z, %i.v             ; 28 uses
  ...
  %i.az = fadd <2 x float> %i.h, %i.aw            ; 18 uses
...
bb.h:                                             ; preds = %bb.f, %bb.e
  %i.bq = extractelement <2 x float> %i.ab, i64 1 ; 17 uses
  ...
  %i.bx = extractelement <2 x float> %i.aa, i64 0 ; 7 uses
  %i.by = extractelement <2 x float> %i.aa, i64 1 ; 9 uses
  ...
  %i.cr = shufflevector <2 x float> %i.aa, <2 x float> %i.ab, <2 x i32> <i32 1, i32 3> ; 13 uses
...
bb.ao:                                            ; preds = %bb.an
  ...
  %i.ry = fmul float %i.bb, %.sroa.0.4.vec.extract.i492 ; 3 uses
  ...
  %i.se = fmul float %i.g, %i.sb                  ; 3 uses
  %i.sf = extractelement <2 x float> %i.az, i64 0
  %i.sg = extractelement <2 x float> %i.az, i64 1
  %5 = insertelement <2 x float> poison, float %i.ry, i64 0
  %6 = shufflevector <2 x float> %5, <2 x float> poison, <2 x i32> zeroinitializer
  %7 = insertelement <2 x float> poison, float %i.se, i64 0
  br label %bb.ap
...
bb.ap:                                            ; preds = %bb.ao, %bb.av
  ...
  %8 = shufflevector <2 x float> %i.sq, <2 x float> %i.sr, <2 x i32> <i32 0, i32 3>
  %9 = fmul <2 x float> %6, %8                    ; 5 uses
...
bb.as:                                            ; preds = %bb.aq, %bb.ap
  %foldExtExtBinop781 = fmul <2 x float> %foldExtExtBinop691, %9
  %shift783 = shufflevector <2 x float> %9, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop784 = fmul <2 x float> %foldExtExtBinop691, %shift783
  %10 = fmul <2 x float> %i.cr, %9                ; 2 uses
  %11 = fmul <2 x float> %i.aa, %9                ; 2 uses
  %12 = shufflevector <2 x float> %10, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %13 = insertelement <2 x float> %12, float %i.sc, i64 1
  %14 = fsub <2 x float> %13, %11
  %15 = shufflevector <2 x float> %11, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %16 = insertelement <2 x float> %15, float %i.sd, i64 0
  %17 = fsub <2 x float> %10, %16
  %18 = shufflevector <2 x float> %7, <2 x float> %foldExtExtBinop781, <2 x i32> <i32 0, i32 2>
  %19 = fadd <2 x float> %18, %14                 ; 2 uses
  %20 = insertelement <2 x float> %foldExtExtBinop784, float %i.se, i64 1
  %21 = fadd <2 x float> %20, %17                 ; 2 uses
  %22 = fmul <2 x float> %i.aa, %19
  %23 = fmul <2 x float> %i.cr, %21
  %24 = fsub <2 x float> %22, %23
  %25 = extractelement <2 x float> %21, i64 0
  %i.te = fmul float %i.bq, %25
  %shift786 = shufflevector <2 x float> %19, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop787 = fmul <2 x float> %i.aa, %shift786
  %26 = extractelement <2 x float> %foldExtExtBinop787, i64 0
  %27 = fsub float %i.te, %26
  %28 = fmul <2 x float> %24, splat (float 2.000000e+00)
  %29 = fadd <2 x float> %9, %28
  %30 = fmul float %27, 2.000000e+00
  %i.tf = fadd float %i.sb, %30
  %31 = fadd <2 x float> %i.az, %29               ; 2 uses
  %i.tg = fadd float %i.ba, %i.tf                 ; 2 uses
  %i.th = load ptr, ptr %i.bu, align 8, !tbaa !170
  tail call void %i.sw(<2 x float> %i.az, float %i.ba, <2 x float> %31, float %i.tg, i32 noundef 65535, ptr noundef %i.th) #7
...
bb.av:                                            ; preds = %bb.at, %bb.as
  ...
  tail call void %i.ti(<2 x float> %31, float %i.tg, <2 x float> %.sroa.09.4.vec.insert.i519, float %i.ut, i32 noundef 65535, ptr noundef %i.uu) #7
