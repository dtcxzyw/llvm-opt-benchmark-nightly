...
b3Normalize.exit:                                 ; preds = %bb.o
  ...
  %i.de = fadd <2 x float> %.sroa.0827.0.copyload, %i.dc ; 18 uses
  ...
  %i.en = fadd <4 x float> %i.dv, %i.em           ; 25 uses
...
bb.z:                                             ; preds = %bb.x
  ...
  %i.jj = fmul <2 x float> %.sroa.07.0.i, %i.ji   ; 6 uses
  ...
  %4 = shufflevector <2 x float> %i.jj, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %5 = fmul <2 x float> %i.de, %4                 ; 2 uses
  %shift1718 = shufflevector <2 x float> %5, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop1719 = fsub <2 x float> %5, %shift1718 ; 2 uses
  %6 = shufflevector <2 x float> %foldExtExtBinop1719, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %7 = shufflevector <4 x float> %i.en, <4 x float> poison, <2 x i32> <i32 0, i32 2>
  %i.jn = fmul <2 x float> %7, %i.jj              ; 2 uses
  %shift1721 = shufflevector <2 x float> %i.jn, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop1722 = fsub <2 x float> %shift1721, %i.jn ; 2 uses
  %8 = shufflevector <2 x float> %foldExtExtBinop1722, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %i.jo = insertelement <4 x float> poison, float %.sroa.5.0.i, i64 0
  %9 = insertelement <4 x float> %i.jo, float %.sroa.43.0.copyload, i64 2
  %i.jp = insertelement <4 x float> %9, float %.sroa.431676.0.copyload, i64 3
  %i.jq = insertelement <4 x float> poison, float %i.jg, i64 0
  %10 = shufflevector <4 x float> %i.jq, <4 x float> %8, <4 x i32> <i32 0, i32 poison, i32 4, i32 poison>
  %11 = shufflevector <4 x float> %10, <4 x float> %6, <4 x i32> <i32 0, i32 poison, i32 2, i32 4>
  %12 = fmul <4 x float> %i.jp, %11               ; 2 uses
  %13 = shufflevector <4 x float> %12, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 2, i32 3> ; 2 uses
  %14 = shufflevector <4 x float> %i.en, <4 x float> %i.hq, <2 x i32> <i32 0, i32 5>
  %i.jr = shufflevector <4 x float> %12, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.js = fmul <2 x float> %14, %i.jr
  ...
  %15 = shufflevector <2 x float> %i.jj, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.jv = fmul <2 x float> %i.ju, %15
  %i.jw = fsub <2 x float> %i.js, %i.jv           ; 3 uses
  %16 = shufflevector <2 x float> %i.jj, <2 x float> poison, <2 x i32> zeroinitializer
  %i.jx = fmul <2 x float> %i.ju, %16
  %17 = shufflevector <4 x float> %i.en, <4 x float> %i.hq, <2 x i32> <i32 2, i32 4>
  %i.jy = fmul <2 x float> %17, %i.jr
  ...
  %18 = shufflevector <2 x float> %foldExtExtBinop1719, <2 x float> poison, <2 x i32> zeroinitializer
  %i.kq = fmul <2 x float> %i.m, %18
...
bb.aj:                                            ; preds = %bb.ag, %bb.ai, %bb.ah
  ...
  %i.oo = shufflevector <4 x float> %i.en, <4 x float> %i.lr, <2 x i32> <i32 2, i32 4> ; 3 uses
  %i.op = shufflevector <2 x float> %i.ok, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.oq = fmul <2 x float> %i.oo, %i.op
  %i.or = shufflevector <4 x float> %i.en, <4 x float> %i.lr, <2 x i32> <i32 0, i32 5> ; 3 uses
  ...
  %i.ox = insertelement <4 x float> %i.ow, float %.sroa.431676.0.copyload, i64 3 ; 2 uses
  %i.oy = shufflevector <4 x float> %i.ox, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 2, i32 3>
...
bb.ap:                                            ; preds = %bb.am, %bb.ao, %bb.an
  ...
  %i.tq = fmul <2 x float> %.sroa.07.0.i, %i.tp   ; 6 uses
  %i.tr = fmul <2 x float> %i.ol, %i.tq
  %i.ts = fsub <2 x float> %i.on, %i.tr
  %19 = shufflevector <2 x float> %i.tq, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %i.tt = fmul <2 x float> %i.de, %19             ; 2 uses
  %shift1740 = shufflevector <2 x float> %i.tt, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop1741 = fsub <2 x float> %i.tt, %shift1740 ; 2 uses
  %20 = shufflevector <2 x float> %foldExtExtBinop1741, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %i.tu = fmul <2 x float> %i.px, %i.tq
  %21 = fadd <2 x float> %i.pz, %i.tu
  %22 = shufflevector <4 x float> %i.en, <4 x float> poison, <2 x i32> <i32 0, i32 2>
  %i.tv = fmul <2 x float> %22, %i.tq             ; 2 uses
  %shift1743 = shufflevector <2 x float> %i.tv, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop1744 = fsub <2 x float> %shift1743, %i.tv ; 2 uses
  %23 = shufflevector <2 x float> %foldExtExtBinop1744, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %i.tw = insertelement <4 x float> poison, float %i.tn, i64 0
  %24 = shufflevector <4 x float> %i.tw, <4 x float> %23, <4 x i32> <i32 0, i32 poison, i32 4, i32 poison>
  %25 = shufflevector <4 x float> %24, <4 x float> %20, <4 x i32> <i32 0, i32 poison, i32 2, i32 4>
  %i.tx = fmul <4 x float> %i.ox, %25             ; 2 uses
  %26 = shufflevector <4 x float> %i.tx, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 2, i32 3> ; 2 uses
  ...
  %27 = shufflevector <2 x float> %i.tq, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.uc = fmul <2 x float> %i.ub, %27
  %i.ud = fsub <2 x float> %i.tz, %i.uc           ; 3 uses
  %28 = shufflevector <2 x float> %i.tq, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ue = fmul <2 x float> %i.ub, %28
  ...
  %i.ul = fadd <4 x float> %i.uk, %26
  %i.um = fmul <4 x float> %i.uk, %26
  %i.un = shufflevector <4 x float> %i.um, <4 x float> %i.ul, <4 x i32> <i32 0, i32 1, i32 6, i32 7> ; 2 uses
  %29 = shufflevector <2 x float> %foldExtExtBinop1741, <2 x float> poison, <2 x i32> zeroinitializer
  %i.uo = fmul <2 x float> %i.m, %29
...
bb.aq:                                            ; preds = %bb.ap, %bb.ac
  ...
  %.sroa.0854.1 = phi <2 x float> [ %21, %bb.ap ], [ %.sroa.0854.0, %bb.ac ] ; 4 uses
