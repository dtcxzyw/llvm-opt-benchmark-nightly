...
.preheader.us.us:                                 ; preds = %._crit_edge, %bb.e
  ...
  %.048128.us.us = phi i32 [ %i.au, %bb.e ], [ 0, %._crit_edge ] ; 2 uses
  br label %bb.b

bb.b:                                             ; preds = %bb.d, %.preheader.us.us
  %indvars.iv203 = phi i64 [ %indvars.iv.next204, %bb.d ], [ 0, %.preheader.us.us ] ; 3 uses
  %.sroa.7.1101.us133.us = phi float [ %i.an, %bb.d ], [ %.sroa.7.0130.us.us, %.preheader.us.us ] ; 2 uses
  %.sroa.028.1100.us134.us = phi <2 x float> [ %i.ar, %bb.d ], [ %.sroa.028.0129.us.us, %.preheader.us.us ] ; 2 uses
  %.04999.us135.us = phi float [ %i.as, %bb.d ], [ 0.000000e+00, %.preheader.us.us ]
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.v = fmul float %.sroa.7.1101.us133.us, %.sroa.1.8.vec.extract.i.us.us
  %i.w = fmul <2 x float> %.sroa.028.1100.us134.us, %i.o ; 2 uses
  ...
  %i.an = fadd float %.sroa.7.1101.us133.us, %i.am ; 3 uses
  ...
  %i.ar = fadd <2 x float> %.sroa.028.1100.us134.us, %i.aq ; 3 uses
  %i.as = fadd float %.04999.us135.us, %i.al      ; 2 uses
  %exitcond207.not = icmp eq i64 %indvars.iv.next204, %wide.trip.count206
  br i1 %exitcond207.not, label %._crit_edge103.us.us, label %bb.b, !llvm.loop !19

._crit_edge103.us.us:                             ; preds = %bb.d
  %i.at = fcmp olt float %i.as, %i.h
  br i1 %i.at, label %.split153.us.loopexit, label %bb.e

bb.e:                                             ; preds = %._crit_edge103.us.us
  %i.au = add nuw nsw i32 %.048128.us.us, 1       ; 2 uses
  %exitcond208.not = icmp eq i32 %i.au, 20
  br i1 %exitcond208.not, label %.split153.us.loopexit, label %.preheader.us.us, !llvm.loop !20

.lr.ph.split:                                     ; preds = %.lr.ph.split.preheader, %bb.g
  %indvars.iv = phi i64 [ 0, %.lr.ph.split.preheader ], [ %indvars.iv.next, %bb.g ] ; 3 uses
  %i.av = getelementptr inbounds nuw [28 x i8], ptr %2, i64 %indvars.iv ; 2 uses
  %i.aw = mul nuw nsw i64 %indvars.iv, 28
  %i.ax = add i64 %i.aw, %i.f, !nosanitize !9     ; 2 uses
  %.not173 = icmp ult i64 %i.ax, %i.f, !nosanitize !9
  br i1 %.not173, label %.split.us, label %bb.f, !prof !10, !nosanitize !9

.split.us:                                        ; preds = %.lr.ph.split
  tail call void @__ubsan_handle_pointer_overflow_abort(ptr nonnull @0, i64 %i.f, i64 %i.ax) #4, !nosanitize !9
  unreachable, !nosanitize !9

bb.f:                                             ; preds = %.lr.ph.split
  %i.ay = ptrtoint ptr %i.av to i64, !nosanitize !9 ; 2 uses
  %i.az = and i64 %i.ay, 3, !nosanitize !9
  %i.ba = icmp eq i64 %i.az, 0, !nosanitize !9
  br i1 %i.ba, label %bb.g, label %.split96, !prof !11, !nosanitize !9

.split96:                                         ; preds = %bb.f, %.lr.ph
  %.us-phi97 = phi i64 [ 0, %.lr.ph ], [ %i.ay, %bb.f ]
...
bb.g:                                             ; preds = %bb.f
  ...
  store float 0.000000e+00, ptr %i.bb, align 4, !tbaa !17
...
.split153.us:                                     ; preds = %._crit_edge.thread, %.split153.us.loopexit
  %.us-phi154 = phi i64 [ %i.e, %._crit_edge.thread ], [ %i.bd, %.split153.us.loopexit ]
  %.us-phi155 = phi <2 x float> [ %0, %._crit_edge.thread ], [ %i.ar, %.split153.us.loopexit ]
  %.us-phi156 = phi float [ %1, %._crit_edge.thread ], [ %i.an, %.split153.us.loopexit ]
  %.fca.0.insert = insertvalue { <2 x float>, i64 } poison, <2 x float> %.us-phi155, 0
  %i.be = bitcast float %.us-phi156 to i32
  %.sroa.245.8.insert.ext = zext i32 %i.be to i64
  %.sroa.245.8.insert.insert = or disjoint i64 %.us-phi154, %.sroa.245.8.insert.ext
