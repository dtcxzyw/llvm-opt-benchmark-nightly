...
bb.g:                                             ; preds = %bb.e
  ...
  %.sroa.71297.0.copyload = load <2 x float>, ptr %.sroa.71297.0..sroa_idx, align 4 ; 13 uses
...
b3AABB_Contains.exit.thread.i:                    ; preds = %bb.i
  ...
  %.sroa.2.12.vec.extract.i.i.i = extractelement <2 x float> %.sroa.71297.0.copyload, i64 1
  ...
  %foldExtExtBinop20405 = fmul <2 x float> %.sroa.71297.0.copyload, %.sroa.71297.0.copyload
  %25 = fmul float %.sroa.2.12.vec.extract.i.i.i, %i.bm ; 2 uses
  %shift20407 = shufflevector <2 x float> %.sroa.61296.0.copyload, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop20408 = fmul <2 x float> %.sroa.61296.0.copyload, %shift20407
  %i.dz = extractelement <2 x float> %foldExtExtBinop20408, i64 0 ; 2 uses
  %26 = fmul float %i.dy, 5.000000e-01            ; 2 uses
  %i.ea = fadd float %i.dz, %25
  %i.eb = fsub float %i.dz, %25
  ...
  %27 = shufflevector <2 x float> %foldExtExtBinop20405, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ef = fadd <2 x float> %i.dv, %27
  ...
  %i.fu = shufflevector <2 x float> %28, <2 x float> poison, <2 x i32> zeroinitializer
  %i.fv = fmul <2 x float> %i.ff, %i.fu
  %i.fw = fadd <2 x float> %i.fv, %i.ft           ; 2 uses
  %i.fx = fmul float %i.fi, %26
