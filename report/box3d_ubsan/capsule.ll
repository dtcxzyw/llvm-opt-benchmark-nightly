...
bb.g:                                             ; preds = %bb.e
  ...
  %i.ag = fsub <2 x float> %.sroa.0241.0.copyload, %.sroa.0308.0.copyload ; 6 uses
  ...
  %i.al = fmul <2 x float> %i.i, %i.ak            ; 8 uses
  %i.am = fmul float %i.k, %i.ai                  ; 8 uses
  %i.an = extractelement <2 x float> %i.al, i64 0 ; 2 uses
  %i.ao = extractelement <2 x float> %i.ag, i64 0 ; 2 uses
  %foldExtExtBinop611 = fmul <2 x float> %i.al, %i.ag
  %i.ap = extractelement <2 x float> %foldExtExtBinop611, i64 0
  %i.aq = extractelement <2 x float> %i.al, i64 1 ; 3 uses
  %i.ar = extractelement <2 x float> %i.ag, i64 1 ; 4 uses
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.ck = fmul <2 x float> %.sroa.0150.0.copyload, %i.cj ; 6 uses
...
bb.r:                                             ; preds = %bb.o
  ...
  %7 = extractelement <2 x float> %i.ck, i64 0
  %foldExtExtBinop628 = fmul <2 x float> %i.ag, %i.ck
  %8 = extractelement <2 x float> %foldExtExtBinop628, i64 0
  %i.ei = extractelement <2 x float> %i.ck, i64 1 ; 2 uses
  %i.ej = fmul float %i.ar, %i.ei
  %i.ek = fadd float %8, %i.ej
  %i.el = fmul float %i.ah, %i.cl
  %9 = fadd float %i.el, %i.ek                    ; 2 uses
  %i.em = fmul float %i.dd, %9
  %i.en = fsub float %i.av, %i.em
  %10 = fmul float %i.en, %i.eh                   ; 3 uses
  %i.eo = fmul float %i.av, %i.dd
  %11 = fsub float %i.eo, %9
  %12 = fmul float %11, %i.eh                     ; 4 uses
  %13 = fmul float %i.an, %10
  %14 = fmul float %i.aq, %10
  %i.ep = fmul float %i.am, %10
  %15 = fmul float %7, %12
  %16 = fadd float %i.ao, %15
  %17 = fmul float %i.ei, %12
  %18 = fadd float %i.ar, %17
  %i.eq = fmul float %i.cl, %12
  %i.er = fadd float %i.ah, %i.eq
  %19 = fsub float %16, %13                       ; 2 uses
  %i.es = fsub float %18, %14                     ; 2 uses
  %20 = fsub float %i.er, %i.ep                   ; 2 uses
  %21 = fmul float %19, %19
  %22 = fmul float %i.es, %i.es
  %23 = fadd float %21, %22
  %i.et = fmul float %20, %20
  %i.eu = fadd float %i.et, %23                   ; 2 uses
