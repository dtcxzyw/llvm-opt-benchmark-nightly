...
bb.l:                                             ; preds = %bb.k
  ...
  %.sroa.6235.sroa.4.0.copyload = load <2 x float>, ptr %.sroa.6235.sroa.4.0..sroa.6235.0..sroa_idx.sroa_idx, align 4 ; 8 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #10
  %.sroa.2.8.vec.extract65.i.i.a = extractelement <2 x float> %.sroa.6235.sroa.4.0.copyload, i64 0
  %.sroa.09.0.vec.extract.i.i.i = extractelement <2 x float> %.sroa.6235.sroa.0.0.copyload, i64 0
  %i.ao = fneg float %.sroa.2.8.vec.extract65.i.i.a
  ...
  %i.as = fmul float %.sroa.5234.0.copyload, %.sroa.09.0.vec.extract.i.i.i
  ...
  %5 = shufflevector <2 x float> %.sroa.6235.sroa.0.0.copyload, <2 x float> %.sroa.6235.sroa.4.0.copyload, <4 x i32> <i32 poison, i32 0, i32 3, i32 2>
  %6 = insertelement <4 x float> %5, float %i.dc, i64 0
  %7 = shufflevector <2 x float> %.sroa.6235.sroa.0.0.copyload, <2 x float> %.sroa.6235.sroa.4.0.copyload, <4 x i32> <i32 poison, i32 1, i32 poison, i32 2>
  %8 = insertelement <4 x float> %7, float 5.000000e-01, i64 0
  %9 = insertelement <4 x float> %8, float %i.ao, i64 2
  %10 = fmul <4 x float> %6, %9                   ; 5 uses
  %i.dd = extractelement <4 x float> %10, i64 1   ; 2 uses
  %11 = extractelement <4 x float> %10, i64 2     ; 2 uses
  %i.de = fadd float %i.dd, %11
  %i.df = fsub float %i.dd, %11
  ...
  %12 = shufflevector <4 x float> %10, <4 x float> poison, <2 x i32> <i32 3, i32 3>
  %i.dj = fadd <2 x float> %i.cz, %12
