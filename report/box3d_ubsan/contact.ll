...
bb.a:
  ...
  %.sroa.7.0.copyload = load <2 x float>, ptr %.sroa.7.0..sroa_idx, align 4 ; 15 uses
...
b3Bump.exit.i:                                    ; preds = %bb.s, %bb.l
  ...
  %14 = extractelement <2 x float> %.sroa.8.0.copyload, i64 1 ; 3 uses
  %.sroa.4.8.vec.extract60.i.i = extractelement <2 x float> %.sroa.8.0.copyload, i64 0 ; 2 uses
  %.sroa.0.4.vec.extract8.i.i.i = extractelement <2 x float> %.sroa.7.0.copyload, i64 1 ; 4 uses
  %.sroa.0.0.vec.extract.i.i.i = extractelement <2 x float> %.sroa.7.0.copyload, i64 0 ; 2 uses
...
bb.bk:                                            ; preds = %bb.bi
  ...
  %15 = fmul float %.sroa.0.0.vec.extract.i.i.i, %.sroa.0.4.vec.extract8.i.i.i ; 2 uses
  %foldExtExtBinop700 = fmul <2 x float> %.sroa.8.0.copyload, %.sroa.8.0.copyload
  %i.ja = fmul <2 x float> %.sroa.7.0.copyload, %.sroa.7.0.copyload ; 3 uses
  %i.jb = fmul float %.sroa.4.8.vec.extract60.i.i, %14 ; 2 uses
  %16 = fsub float %i.iz, %i.iw
  %i.jc = fmul float %16, 2.000000e+00            ; 6 uses
  %17 = fadd float %i.ix, %i.iy
  %18 = fmul float %17, 2.000000e+00              ; 6 uses
  %i.jd = fadd float %15, %i.jb
  %i.je = fsub float %15, %i.jb
  ...
  %19 = shufflevector <2 x float> %foldExtExtBinop700, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ji = fadd <2 x float> %i.ja, %19
  ...
  %i.ju = fmul float %i.jc, %.sroa.0.0.vec.extract.i.i
  %i.jv = fmul float %18, %.sroa.0.4.vec.extract.i.i
...
bb.cn:                                            ; preds = %.lr.ph.i
  ...
  %i.nr = fmul float %i.jc, %.sroa.0.0.vec.extract.i154.i
  %i.ns = fmul float %18, %.sroa.0.4.vec.extract.i155.i
...
bb.cr:                                            ; preds = %bb.cq
  ...
  %i.pi = fmul float %i.jc, %.sroa.0.0.vec.extract.i154.i.1
  %i.pj = fmul float %18, %.sroa.0.4.vec.extract.i155.i.1
...
bb.cv:                                            ; preds = %bb.cu
  ...
  %i.qz = fmul float %i.jc, %.sroa.0.0.vec.extract.i154.i.2
  %i.ra = fmul float %18, %.sroa.0.4.vec.extract.i155.i.2
...
bb.cz:                                            ; preds = %bb.cy
  ...
  %i.sq = fmul float %i.jc, %.sroa.0.0.vec.extract.i154.i.3
  %i.sr = fmul float %18, %.sroa.0.4.vec.extract.i155.i.3
...
bb.dd:                                            ; preds = %bb.dc
  ...
  %i.uh = fmul float %i.jc, %.sroa.0.0.vec.extract.i154.i.4
  %i.ui = fmul float %18, %.sroa.0.4.vec.extract.i155.i.4
