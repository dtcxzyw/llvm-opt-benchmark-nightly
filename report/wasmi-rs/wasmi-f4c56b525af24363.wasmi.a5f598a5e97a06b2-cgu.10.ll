...
bb.a:
  ...
  store i16 %i.b, ptr %.sroa.89.0..sroa_idx, align 1, !alias.scope !54
  %.sroa.910.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 12
  store i16 %i.c, ptr %.sroa.910.0..sroa_idx, align 1, !alias.scope !54
  %.sroa.1011.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 14
  store i16 %i.e, ptr %.sroa.1011.0..sroa_idx, align 1, !alias.scope !54
  ret void
}
