...
begin_hunk_0_@_RINvMs1_NtCs5zeGauAcNNa_10wasmi_core4simdNtNtB8_5value4V12815pairwise_binaryasNvNvB6_31i16x8_relaxed_dot_i8x16_i7x16_s3dotECsefoF4u9kbII_5wasmi:bb.a
...
bb.a:
  ...
  %i.a = lshr i16 %.sroa.0.0.extract.trunc.i, 8
  %i.b = insertelement <8 x i16> poison, i16 %.sroa.0.0.extract.trunc.i, i64 0
  %i.c = insertelement <8 x i16> %i.b, i16 %i.a, i64 1
  %i.d = insertelement <8 x i16> %i.c, i16 %.sroa.3.0.extract.trunc.i, i64 2
  %i.e = insertelement <8 x i16> %i.d, i16 %.sroa.4.0.extract.trunc.i, i64 3
  %i.f = insertelement <8 x i16> %i.e, i16 %.sroa.5.0.extract.trunc.i, i64 4
  %i.g = insertelement <8 x i16> %i.f, i16 %.sroa.6.0.extract.trunc.i, i64 5
  %i.h = insertelement <8 x i16> %i.g, i16 %.sroa.7.0.extract.trunc.i, i64 6
  %i.i = insertelement <8 x i16> %i.h, i16 %.sroa.8.0.extract.trunc.i, i64 7
  %i.j = and <8 x i16> %i.i, <i16 255, i16 -1, i16 255, i16 255, i16 255, i16 255, i16 255, i16 -1>
  store <8 x i16> %i.j, ptr %0, align 1, !alias.scope !58
  ret void
}
...
bb.a:
  ...
  %i.a = lshr i32 %.sroa.0.0.extract.trunc.i, 16
  %.sroa.3.0.extract.shift.i = lshr i64 %1, 32
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind nonlazybind willreturn memory(none) uwtable
define hidden noundef float @_RINvNtCs5zeGauAcNNa_10wasmi_core4simd11neg_mul_addfECsefoF4u9kbII_5wasmi(float noundef %0, float noundef %1, float noundef %2) unnamed_addr #2 personality ptr @rust_eh_personality {
bb.a:
  %i.a = fneg float %0
  %i.b = tail call noundef float @llvm.fma.f32(float %i.a, float %1, float %2)
  ret float %i.b
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind nonlazybind willreturn memory(none) uwtable
define hidden noundef double @_RINvNtCs5zeGauAcNNa_10wasmi_core4simd4pmaxdECsefoF4u9kbII_5wasmi(double noundef %0, double noundef %1) unnamed_addr #2 personality ptr @rust_eh_personality {
bb.a:
  %i.a = fcmp olt double %0, %1
  %. = select i1 %i.a, double %1, double %0
  ret double %.
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind nonlazybind willreturn memory(none) uwtable
define hidden noundef float @_RINvNtCs5zeGauAcNNa_10wasmi_core4simd4pmaxfECsefoF4u9kbII_5wasmi(float noundef %0, float noundef %1) unnamed_addr #2 personality ptr @rust_eh_personality {
end_hunk_0
