...
bb.a:
  ...
  %i.u = load i32, ptr %i.t, align 8, !range !1547, !noundef !8
...
bb.q:                                             ; preds = %bb.p
  ...
  %i.ay = load i8, ptr %i.ax, align 1, !noalias !4456, !noundef !8
...
_RNvMs_NtNtCsileJQcQObtj_7hir_def5attrs4docsNtB4_4Docs19remove_last_newline.exit: ; preds = %_RNvMNtCsbSS6DM8SDEO_5alloc6stringNtB2_6String8truncate.exit.i
  %i.ba = load i64, ptr %i.j, align 8, !range !312, !alias.scope !4457, !noundef !8
  %i.bb = load i64, ptr %.sroa.516.0..sroa_idx, align 8, !alias.scope !4457, !noundef !8 ; 2 uses
...
bb.s:                                             ; preds = %.noexc35, %_RNvMs_NtNtCsileJQcQObtj_7hir_def5attrs4docsNtB4_4Docs19remove_last_newline.exit
  %i.bf = load i64, ptr %i.n, align 8, !range !312, !alias.scope !4457, !noundef !8
  %i.bg = load i64, ptr %.sroa.5.0..sroa_idx, align 8, !alias.scope !4457, !noundef !8 ; 2 uses
...
bb.t:                                             ; preds = %_RNvMs_NtNtCsileJQcQObtj_7hir_def5attrs4docsNtB4_4Docs13shrink_to_fit.exit
  ...
  call void @_RNvCsiZ68L5R9VjM_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #48, !noalias !4460
  %i.bp = call noundef align 8 dereferenceable_or_null(104) ptr @_RNvCsiZ68L5R9VjM_7___rustc12___rust_alloc(i64 noundef range(i64 16, 105) 104, i64 noundef 8) #48, !noalias !4460 ; 3 uses
