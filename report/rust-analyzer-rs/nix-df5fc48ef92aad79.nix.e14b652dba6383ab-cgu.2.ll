...
switch.lookup:
  ...
  %i.b = zext i8 %switch.load to i64
  %switch.gep1 = getelementptr inbounds nuw [8 x i8], ptr @switch.table._RNvNtCsjleIA2Nr5aN_3nix5errno4desc.24, i64 %trunc
