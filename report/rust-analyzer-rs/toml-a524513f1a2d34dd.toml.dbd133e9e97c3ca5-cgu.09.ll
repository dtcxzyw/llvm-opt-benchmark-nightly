Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/rust-analyzer-rs/original/toml-a524513f1a2d34dd.toml.dbd133e9e97c3ca5-cgu.09?download=true
...
bb.b:                                             ; preds = %.lr.ph, %_RINvMsi_NtNtNtCsbSS6DM8SDEO_5alloc11collections5btree3mapINtB6_8BTreeMapNtNtBc_6string6StringNtNtCsiS54oC2UhYT_4toml5value5ValueE7get_muteEB1x_.exit
  %.sroa.0.097 = phi ptr [ %0, %.lr.ph ], [ %i.az, %_RINvMsi_NtNtNtCsbSS6DM8SDEO_5alloc11collections5btree3mapINtB6_8BTreeMapNtNtBc_6string6StringNtNtCsiS54oC2UhYT_4toml5value5ValueE7get_muteEB1x_.exit ] ; 4 uses
  %.sroa.012.096 = phi ptr [ %1, %.lr.ph ], [ %i.l, %_RINvMsi_NtNtNtCsbSS6DM8SDEO_5alloc11collections5btree3mapINtB6_8BTreeMapNtNtBc_6string6StringNtNtCsiS54oC2UhYT_4toml5value5ValueE7get_muteEB1x_.exit ] ; 3 uses
  ...
  %i.l = getelementptr inbounds nuw i8, ptr %.sroa.012.096, i64 16 ; 2 uses
  %i.m = load ptr, ptr %.sroa.012.096, align 8, !nonnull !4, !noundef !4 ; 3 uses
  %i.n = getelementptr inbounds nuw i8, ptr %.sroa.012.096, i64 8
  %i.o = load i64, ptr %i.n, align 8, !noundef !4 ; 9 uses
  %i.p = getelementptr inbounds nuw i8, ptr %.sroa.0.097, i64 26
...
bb.c:                                             ; preds = %bb.b
  %i.s = getelementptr inbounds nuw i8, ptr %.sroa.0.097, i64 16
...
bb.e:                                             ; preds = %bb.c
  %i.u = getelementptr inbounds nuw i8, ptr %.sroa.0.097, i64 8
...
bb.f:                                             ; preds = %bb.b, %bb.e
  ...
  %.sroa.0.1 = phi ptr [ %i.x, %bb.e ], [ %.sroa.0.097, %bb.b ] ; 11 uses
