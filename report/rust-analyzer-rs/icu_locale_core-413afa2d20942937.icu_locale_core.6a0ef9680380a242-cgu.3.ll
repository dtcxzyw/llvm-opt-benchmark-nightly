...
bb.e:                                             ; preds = %.lr.ph, %bb.h
  ...
  %i.m = call i64 @_RNvMs1_NtCs96xUavsWfLi_15icu_locale_core7subtagsNtB5_6Subtag13try_from_utf8(ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %i.j, i64 noundef %i.l) ; 5 uses
...
bb.h:                                             ; preds = %3, %bb.k, %bb.g
  %.sroa.0.1..sroa.0.1..sroa.0.1..sroa.0.1..sroa.0.1.120 = phi i8 [ %5, %bb.k ], [ %.sroa.067.0.extract.trunc, %3 ], [ %.sroa.0.1..sroa.0.1..sroa.0.1..sroa.0.1..sroa.0.1., %bb.g ]
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.t = lshr i64 %.sroa.0.1..sroa.0.1..sroa.030.0.copyload, 8
  %5 = trunc i64 %i.t to i8
  br label %bb.h
