...
.backedge.i.i.i:                                  ; preds = %_RNvMsG_NtCsbSS6DM8SDEO_5alloc3vecINtB5_3VecNtNtCsuAhG64lL82_9text_size4size8TextSizeE4pushCs2wU4RHBJEmX_10line_index.exit.i.i.i, %bb.j, %_RNvXs2_NtNtCshzWfHUSfYae_4core3str6traitseINtNtNtB9_3ops5index5IndexINtNtBJ_5range9RangeFromjEE5indexCs2wU4RHBJEmX_10line_index.exit19.i.i.i
  %.sroa.04.0.be.i.i.i = phi i64 [ %i.as, %_RNvXs2_NtNtCshzWfHUSfYae_4core3str6traitseINtNtNtB9_3ops5index5IndexINtNtBJ_5range9RangeFromjEE5indexCs2wU4RHBJEmX_10line_index.exit19.i.i.i ], [ 0, %bb.j ], [ 0, %_RNvMsG_NtCsbSS6DM8SDEO_5alloc3vecINtB5_3VecNtNtCsuAhG64lL82_9text_size4size8TextSizeE4pushCs2wU4RHBJEmX_10line_index.exit.i.i.i ] ; 2 uses
...
.lr.ph.i.i.i:                                     ; preds = %_RNvMsG_NtCsbSS6DM8SDEO_5alloc3vecINtB5_3VecNtNtCsuAhG64lL82_9text_size4size8TextSizeE4pushCs2wU4RHBJEmX_10line_index.exit.i.i.i, %bb.l
  %i.ay = phi i64 [ %i.bf, %_RNvMsG_NtCsbSS6DM8SDEO_5alloc3vecINtB5_3VecNtNtCsuAhG64lL82_9text_size4size8TextSizeE4pushCs2wU4RHBJEmX_10line_index.exit.i.i.i ], [ %.pre.i.i.i, %bb.l ] ; 3 uses
  %i.az = phi i32 [ %i.bi, %_RNvMsG_NtCsbSS6DM8SDEO_5alloc3vecINtB5_3VecNtNtCsuAhG64lL82_9text_size4size8TextSizeE4pushCs2wU4RHBJEmX_10line_index.exit.i.i.i ], [ %i.ax, %bb.l ] ; 2 uses
  %.sroa.02.049.i.i.i = phi i32 [ %i.bh, %_RNvMsG_NtCsbSS6DM8SDEO_5alloc3vecINtB5_3VecNtNtCsuAhG64lL82_9text_size4size8TextSizeE4pushCs2wU4RHBJEmX_10line_index.exit.i.i.i ], [ %i.aw, %bb.l ]
  %i.ba = add i32 %4, %i.az
  %i.bb = load i64, ptr %i.g, align 8, !range !10, !alias.scope !252, !noalias !253, !noundef !4
  %i.bc = icmp eq i64 %i.ay, %i.bb
  br i1 %i.bc, label %bb.m, label %_RNvMsG_NtCsbSS6DM8SDEO_5alloc3vecINtB5_3VecNtNtCsuAhG64lL82_9text_size4size8TextSizeE4pushCs2wU4RHBJEmX_10line_index.exit.i.i.i
...
_RNvCs2wU4RHBJEmX_10line_index19analyze_source_file.exit: ; preds = %bb.o
  ...
  %i.bn = invoke { ptr, i64 } @_RNvMs_NtCsbSS6DM8SDEO_5alloc3vecINtB4_3VecNtNtCsuAhG64lL82_9text_size4size8TextSizeE16into_boxed_sliceCs2wU4RHBJEmX_10line_index(ptr noalias nofree noundef nonnull align 8 captures(address) dereferenceable(24) %i.j)
