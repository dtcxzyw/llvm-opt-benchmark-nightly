...
.lr.ph103:                                        ; preds = %bb.g, %_RINvNtNtNtNtCshzWfHUSfYae_4core5slice4sort6stable5drift13logical_mergeTNtNtCslLuZgPVt6hg_3ide18view_memory_layout15FieldOrTupleIdxNtCs8Xq8PKFYOms_3hir4TypeENCINvMNtCsbSS6DM8SDEO_5alloc5sliceSB16_11sort_by_keyyNCNvNvB19_18view_memory_layout11read_layouts0_0E0EB1b_.exit
  ...
  br i1 %.not28, label %._crit_edge, label %bb.ae
...
._crit_edge:                                      ; preds = %_RINvNtNtNtNtCshzWfHUSfYae_4core5slice4sort6stable5drift13logical_mergeTNtNtCslLuZgPVt6hg_3ide18view_memory_layout15FieldOrTupleIdxNtCs8Xq8PKFYOms_3hir4TypeENCINvMNtCsbSS6DM8SDEO_5alloc5sliceSB16_11sort_by_keyyNCNvNvB19_18view_memory_layout11read_layouts0_0E0EB1b_.exit, %.lr.ph103, %bb.g
  ...
  br i1 %i.q, label %bb.al, label %bb.am

bb.ae:                                            ; preds = %.lr.ph103
...
_RINvNtNtNtNtCshzWfHUSfYae_4core5slice4sort6stable5drift13logical_mergeTNtNtCslLuZgPVt6hg_3ide18view_memory_layout15FieldOrTupleIdxNtCs8Xq8PKFYOms_3hir4TypeENCINvMNtCsbSS6DM8SDEO_5alloc5sliceSB16_11sort_by_keyyNCNvNvB19_18view_memory_layout11read_layouts0_0E0EB1b_.exit: ; preds = %bb.ag, %bb.ak
  %.sroa.0.0.i = phi i64 [ %i.em, %bb.ak ], [ %i.dz, %bb.ag ] ; 2 uses
...
.lr.ph38.i:                                       ; preds = %._crit_edge.i, %.lr.ph38.i
  ...
  %.val.i = load i32, ptr %.sroa.9.235.i, align 4, !range !335, !alias.scope !512, !noalias !515, !noundef !19 ; 2 uses
  ...
  %i.br = load i64, ptr %.sroa.9.235.i, align 4, !alias.scope !512, !noalias !533
...
vector.body293:                                   ; preds = %vector.body293, %vector.ph290
  ...
  %wide.load295 = load <2 x i64>, ptr %i.cg, align 4, !alias.scope !515, !noalias !512
  %wide.load296 = load <2 x i64>, ptr %i.ch, align 4, !alias.scope !515, !noalias !512
  ...
  store <2 x i64> %reverse297, ptr %i.cf, align 4, !alias.scope !512, !noalias !515
  store <2 x i64> %reverse298, ptr %i.ci, align 4, !alias.scope !512, !noalias !515
  %index.next299 = add nuw i64 %index294, 4       ; 2 uses
  %i.cj = icmp eq i64 %index.next299, %n.vec292
  br i1 %i.cj, label %middle.block300, label %vector.body293, !llvm.loop !542
...
bb.t:                                             ; preds = %bb.t, %.lr.ph.i68
  ...
  %.val29.i73 = load i32, ptr %.sroa.9.130.i71, align 4, !range !335, !alias.scope !550, !noalias !553, !noundef !19 ; 2 uses
  ...
  %i.de = load i64, ptr %.sroa.9.130.i71, align 4, !alias.scope !550, !noalias !555
