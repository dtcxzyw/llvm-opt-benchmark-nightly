...
bb.m:                                             ; preds = %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport17import_on_the_flys1_0E0B1R_.exit.i, %.lr.ph.i
  %.sroa.5.111.i = phi ptr [ %.sroa.5.0.i, %.lr.ph.i ], [ %i.bz, %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport17import_on_the_flys1_0E0B1R_.exit.i ] ; 11 uses
  %.sroa.11.110.i = phi i64 [ %.sroa.11.0.i, %.lr.ph.i ], [ %i.by, %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport17import_on_the_flys1_0E0B1R_.exit.i ] ; 2 uses
  %.sroa.19.19.i = phi ptr [ %.sroa.19.0.i, %.lr.ph.i ], [ %i.bv, %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport17import_on_the_flys1_0E0B1R_.exit.i ]
  ...
  %i.ak = call noundef i64 @_RNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport34compute_fuzzy_completion_order_key(ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(88) %.sroa.5.111.i, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %i.ah, i64 noundef %i.aj, ptr noalias nofree noundef nonnull align 8 dereferenceable(24) %.val1.i.i), !noalias !217 ; 2 uses
...
bb.n:                                             ; preds = %bb.m
  %i.aq = getelementptr inbounds nuw i8, ptr %.sroa.5.111.i, i64 24
...
bb.p:                                             ; preds = %bb.o
  %i.av = getelementptr inbounds nuw i8, ptr %.sroa.5.111.i, i64 25
...
bb.q:                                             ; preds = %bb.o
  %i.az = getelementptr inbounds nuw i8, ptr %.sroa.5.111.i, i64 28
...
bb.r:                                             ; preds = %bb.q
  %i.be = getelementptr inbounds nuw i8, ptr %.sroa.5.111.i, i64 32
...
_RNvXsk_NtCs33K2ylI4knu_10hir_expand8mod_pathNtB5_8PathKindNtNtCshzWfHUSfYae_4core3cmp3Ord3cmp.exit.thread.i.i.i: ; preds = %_RNvXsk_NtCs33K2ylI4knu_10hir_expand8mod_pathNtB5_8PathKindNtNtCshzWfHUSfYae_4core3cmp3Ord3cmp.exit.i.i.i, %bb.o
  ...
  %i.bj = getelementptr inbounds nuw i8, ptr %.sroa.5.111.i, i64 16
  %i.bk = load i64, ptr %i.bj, align 8, !alias.scope !234, !noalias !237, !noundef !4 ; 2 uses
  %i.bl = icmp ugt i64 %i.bk, 1                   ; 2 uses
  %i.bm = load ptr, ptr %.sroa.5.111.i, align 8, !alias.scope !234, !noalias !237, !nonnull !4
  %i.bn = getelementptr inbounds nuw i8, ptr %.sroa.5.111.i, i64 8
  %i.bo = load i64, ptr %i.bn, align 8, !alias.scope !234, !noalias !237
  %.sink11.i.i.i.i.i = select i1 %i.bl, ptr %i.bm, ptr %.sroa.5.111.i
...
_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport17import_on_the_flys1_0E0B1R_.exit.i: ; preds = %_RNvXsk_NtCs33K2ylI4knu_10hir_expand8mod_pathNtB5_8PathKindNtNtCshzWfHUSfYae_4core3cmp3Ord3cmp.exit.thread.i.i.i, %_RNvXsk_NtCs33K2ylI4knu_10hir_expand8mod_pathNtB5_8PathKindNtNtCshzWfHUSfYae_4core3cmp3Ord3cmp.exit.i.i.i, %bb.m
  ...
  %i.bv = getelementptr inbounds i8, ptr %.sroa.19.19.i, i64 -88 ; 3 uses
  %.sroa.01.0.i.i = select i1 %i.bu, ptr %2, ptr %i.bv
  %i.bw = getelementptr inbounds nuw [88 x i8], ptr %.sroa.01.0.i.i, i64 %.sroa.11.110.i
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(88) %i.bw, ptr noundef nonnull align 8 dereferenceable(88) %.sroa.5.111.i, i64 88, i1 false), !alias.scope !244, !noalias !245
  %i.bx = zext i1 %i.bu to i64
  %i.by = add i64 %.sroa.11.110.i, %i.bx          ; 2 uses
  %i.bz = getelementptr inbounds nuw i8, ptr %.sroa.5.111.i, i64 88 ; 3 uses
...
bb.z:                                             ; preds = %bb.af, %bb.x
  %.sroa.19.0.i43 = phi ptr [ %i.cw, %bb.x ], [ %i.fc, %bb.af ] ; 2 uses
  %.sroa.11.0.i44 = phi i64 [ 0, %bb.x ], [ %i.fe, %bb.af ] ; 2 uses
  %.sroa.5.0.i45 = phi ptr [ %.sroa.0.0.ph107, %bb.x ], [ %i.ff, %bb.af ] ; 3 uses
  ...
  %i.de = icmp ult ptr %.sroa.5.0.i45, %i.dd
...
._crit_edge.i47:                                  ; preds = %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport17import_on_the_flys1_0E0B1R_.exit.i61, %bb.z
  %.sroa.19.1.lcssa.i48 = phi ptr [ %.sroa.19.0.i43, %bb.z ], [ %i.ew, %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport17import_on_the_flys1_0E0B1R_.exit.i61 ]
  %.sroa.11.1.lcssa.i49 = phi i64 [ %.sroa.11.0.i44, %bb.z ], [ %i.ez, %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport17import_on_the_flys1_0E0B1R_.exit.i61 ] ; 10 uses
  %.sroa.5.1.lcssa.i50 = phi ptr [ %.sroa.5.0.i45, %bb.z ], [ %i.fa, %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport17import_on_the_flys1_0E0B1R_.exit.i61 ] ; 2 uses
...
.lr.ph.i55:                                       ; preds = %bb.z, %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport17import_on_the_flys1_0E0B1R_.exit.i61
  %.sroa.5.111.i56 = phi ptr [ %i.fa, %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport17import_on_the_flys1_0E0B1R_.exit.i61 ], [ %.sroa.5.0.i45, %bb.z ] ; 11 uses
  %.sroa.11.110.i57 = phi i64 [ %i.ez, %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport17import_on_the_flys1_0E0B1R_.exit.i61 ], [ %.sroa.11.0.i44, %bb.z ] ; 2 uses
  %.sroa.19.19.i58 = phi ptr [ %i.ew, %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport17import_on_the_flys1_0E0B1R_.exit.i61 ], [ %.sroa.19.0.i43, %bb.z ]
  ...
  %i.do = call noundef i64 @_RNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport34compute_fuzzy_completion_order_key(ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(88) %.sroa.5.111.i56, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %i.dm, i64 noundef %i.dn, ptr noalias nofree noundef nonnull align 8 dereferenceable(24) %.val1.i.i60), !noalias !258 ; 2 uses
...
bb.aa:                                            ; preds = %.lr.ph.i55
  %i.dr = getelementptr inbounds nuw i8, ptr %.sroa.5.111.i56, i64 24
...
bb.ac:                                            ; preds = %bb.ab
  ...
  %i.dx = getelementptr inbounds nuw i8, ptr %.sroa.5.111.i56, i64 25
...
bb.ad:                                            ; preds = %bb.ab
  ...
  %i.eb = getelementptr inbounds nuw i8, ptr %.sroa.5.111.i56, i64 28
...
bb.ae:                                            ; preds = %bb.ad
  ...
  %i.eg = getelementptr inbounds nuw i8, ptr %.sroa.5.111.i56, i64 32
...
_RNvXsk_NtCs33K2ylI4knu_10hir_expand8mod_pathNtB5_8PathKindNtNtCshzWfHUSfYae_4core3cmp3Ord3cmp.exit.thread.i.i.i66: ; preds = %_RNvXsk_NtCs33K2ylI4knu_10hir_expand8mod_pathNtB5_8PathKindNtNtCshzWfHUSfYae_4core3cmp3Ord3cmp.exit.i.i.i64, %bb.ab
  ...
  %i.eo = getelementptr inbounds nuw i8, ptr %.sroa.5.111.i56, i64 16
  %i.ep = load i64, ptr %i.eo, align 8, !alias.scope !297, !noalias !300, !noundef !4 ; 2 uses
  %i.eq = icmp ugt i64 %i.ep, 1                   ; 2 uses
  %i.er = load ptr, ptr %.sroa.5.111.i56, align 8, !alias.scope !297, !noalias !300, !nonnull !4
  %i.es = getelementptr inbounds nuw i8, ptr %.sroa.5.111.i56, i64 8
  %i.et = load i64, ptr %i.es, align 8, !alias.scope !297, !noalias !300
  %.sink11.i1.i.i.i.i69 = select i1 %i.eq, ptr %i.er, ptr %.sroa.5.111.i56
...
_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport17import_on_the_flys1_0E0B1R_.exit.i61: ; preds = %_RNvXsk_NtCs33K2ylI4knu_10hir_expand8mod_pathNtB5_8PathKindNtNtCshzWfHUSfYae_4core3cmp3Ord3cmp.exit.thread.i.i.i66, %_RNvXsk_NtCs33K2ylI4knu_10hir_expand8mod_pathNtB5_8PathKindNtNtCshzWfHUSfYae_4core3cmp3Ord3cmp.exit.i.i.i64, %.lr.ph.i55
  ...
  %i.ew = getelementptr inbounds i8, ptr %.sroa.19.19.i58, i64 -88 ; 3 uses
  %.sroa.01.0.i.i63 = select i1 %i.ev, ptr %2, ptr %i.ew
  %i.ex = getelementptr inbounds nuw [88 x i8], ptr %.sroa.01.0.i.i63, i64 %.sroa.11.110.i57
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(88) %i.ex, ptr noundef nonnull align 8 dereferenceable(88) %.sroa.5.111.i56, i64 88, i1 false), !alias.scope !302, !noalias !303
  %i.ey = zext i1 %i.ev to i64
  %i.ez = add i64 %.sroa.11.110.i57, %i.ey        ; 2 uses
  %i.fa = getelementptr inbounds nuw i8, ptr %.sroa.5.111.i56, i64 88 ; 3 uses
  %i.fb = icmp ult ptr %i.fa, %i.dd
  br i1 %i.fb, label %.lr.ph.i55, label %._crit_edge.i47

bb.af:                                            ; preds = %._crit_edge.i47
  %i.fc = getelementptr inbounds i8, ptr %.sroa.19.1.lcssa.i48, i64 -88
  %i.fd = getelementptr inbounds nuw [88 x i8], ptr %2, i64 %.sroa.11.1.lcssa.i49
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(88) %i.fd, ptr noundef nonnull align 8 dereferenceable(88) %.sroa.5.1.lcssa.i50, i64 88, i1 false), !alias.scope !302, !noalias !306
  %i.fe = add i64 %.sroa.11.1.lcssa.i49, 1
  %i.ff = getelementptr inbounds nuw i8, ptr %.sroa.5.1.lcssa.i50, i64 88
  br label %bb.z

bb.ag:                                            ; preds = %._crit_edge.i47
  %i.fg = mul nuw nsw i64 %.sroa.11.1.lcssa.i49, 88
  ...
  %i.fh = sub i64 %.sroa.16.0100232, %.sroa.11.1.lcssa.i49 ; 6 uses
  %.not18.i51 = icmp eq i64 %.sroa.16.0100232, %.sroa.11.1.lcssa.i49
  %i.fi = getelementptr [88 x i8], ptr %.sroa.0.0.ph107, i64 %.sroa.11.1.lcssa.i49 ; 4 uses
  br i1 %.not18.i51, label %.outer.thread, label %.lr.ph16.i52.preheader

.lr.ph16.i52.preheader:                           ; preds = %bb.ag
  %.neg307 = add i64 %.sroa.11.1.lcssa.i49, 1
...
_RINvNtNtNtNtCshzWfHUSfYae_4core5slice4sort6stable9quicksort16stable_partitionNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImportNCINvB2_9quicksortB1d_NCINvMNtCsbSS6DM8SDEO_5alloc5sliceSB1d_7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport17import_on_the_flys1_0E0E0EB3v_.exit: ; preds = %_RINvNtNtNtNtCshzWfHUSfYae_4core5slice4sort6stable9quicksort16stable_partitionNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImportNCINvB2_9quicksortB1d_NCINvMNtCsbSS6DM8SDEO_5alloc5sliceSB1d_7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport17import_on_the_flys1_0E0E0EB3v_.exit.unr-lcssa, %.lr.ph16.i52.epil.preheader
  %i.fv = icmp ugt i64 %.sroa.11.1.lcssa.i49, %.sroa.16.0100232
...
.outer:                                           ; preds = %_RINvNtNtNtNtCshzWfHUSfYae_4core5slice4sort6stable9quicksort16stable_partitionNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImportNCINvB2_9quicksortB1d_NCINvMNtCsbSS6DM8SDEO_5alloc5sliceSB1d_7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport17import_on_the_flys1_0E0E0EB3v_.exit
  %i.fw = getelementptr inbounds nuw [88 x i8], ptr %.sroa.0.0.ph107, i64 %.sroa.11.1.lcssa.i49 ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a)
  %i.fx = icmp ult i64 %i.fh, 33
  br i1 %i.fx, label %.outer._crit_edge, label %.lr.ph

bb.ah:                                            ; preds = %_RINvNtNtNtNtCshzWfHUSfYae_4core5slice4sort6stable9quicksort16stable_partitionNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImportNCINvB2_9quicksortB1d_NCINvMNtCsbSS6DM8SDEO_5alloc5sliceSB1d_7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport17import_on_the_flys1_0E0E0EB3v_.exit
  call void @_RNvNtNtCshzWfHUSfYae_4core5slice5index16slice_index_fail(i64 noundef %.sroa.11.1.lcssa.i49, i64 noundef %.sroa.16.0100232, i64 noundef %.sroa.16.0100232, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @9) #27
  unreachable
}
...
bb.m:                                             ; preds = %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport22import_on_the_fly_pat_s0_0E0B1R_.exit.i, %.lr.ph.i
  %.sroa.5.111.i = phi ptr [ %.sroa.5.0.i, %.lr.ph.i ], [ %i.bz, %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport22import_on_the_fly_pat_s0_0E0B1R_.exit.i ] ; 11 uses
  %.sroa.11.110.i = phi i64 [ %.sroa.11.0.i, %.lr.ph.i ], [ %i.by, %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport22import_on_the_fly_pat_s0_0E0B1R_.exit.i ] ; 2 uses
  %.sroa.19.19.i = phi ptr [ %.sroa.19.0.i, %.lr.ph.i ], [ %i.bv, %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport22import_on_the_fly_pat_s0_0E0B1R_.exit.i ]
  ...
  %i.ak = call noundef i64 @_RNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport34compute_fuzzy_completion_order_key(ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(88) %.sroa.5.111.i, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %i.ah, i64 noundef %i.aj, ptr noalias nofree noundef nonnull align 8 dereferenceable(24) %.val1.i.i), !noalias !331 ; 2 uses
...
_RNvXsk_NtCs33K2ylI4knu_10hir_expand8mod_pathNtB5_8PathKindNtNtCshzWfHUSfYae_4core3cmp3Ord3cmp.exit.thread.i.i.i: ; preds = %_RNvXsk_NtCs33K2ylI4knu_10hir_expand8mod_pathNtB5_8PathKindNtNtCshzWfHUSfYae_4core3cmp3Ord3cmp.exit.i.i.i, %bb.o
  ...
  %i.bl = icmp ugt i64 %i.bk, 1                   ; 2 uses
  %i.bm = load ptr, ptr %.sroa.5.111.i, align 8, !alias.scope !347, !noalias !350, !nonnull !4
  %i.bn = getelementptr inbounds nuw i8, ptr %.sroa.5.111.i, i64 8
...
_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport22import_on_the_fly_pat_s0_0E0B1R_.exit.i: ; preds = %_RNvXsk_NtCs33K2ylI4knu_10hir_expand8mod_pathNtB5_8PathKindNtNtCshzWfHUSfYae_4core3cmp3Ord3cmp.exit.thread.i.i.i, %_RNvXsk_NtCs33K2ylI4knu_10hir_expand8mod_pathNtB5_8PathKindNtNtCshzWfHUSfYae_4core3cmp3Ord3cmp.exit.i.i.i, %bb.m
  ...
  %.sroa.01.0.i.i = select i1 %i.bu, ptr %2, ptr %i.bv
  %i.bw = getelementptr inbounds nuw [88 x i8], ptr %.sroa.01.0.i.i, i64 %.sroa.11.110.i
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(88) %i.bw, ptr noundef nonnull align 8 dereferenceable(88) %.sroa.5.111.i, i64 88, i1 false), !alias.scope !357, !noalias !358
  %i.bx = zext i1 %i.bu to i64
  %i.by = add i64 %.sroa.11.110.i, %i.bx          ; 2 uses
  %i.bz = getelementptr inbounds nuw i8, ptr %.sroa.5.111.i, i64 88 ; 3 uses
  %i.ca = icmp ult ptr %i.bz, %i.ad
...
._crit_edge.i47:                                  ; preds = %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport22import_on_the_fly_pat_s0_0E0B1R_.exit.i61, %bb.z
  %.sroa.19.1.lcssa.i48 = phi ptr [ %.sroa.19.0.i43, %bb.z ], [ %i.ew, %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport22import_on_the_fly_pat_s0_0E0B1R_.exit.i61 ]
  %.sroa.11.1.lcssa.i49 = phi i64 [ %.sroa.11.0.i44, %bb.z ], [ %i.ez, %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport22import_on_the_fly_pat_s0_0E0B1R_.exit.i61 ] ; 10 uses
  %.sroa.5.1.lcssa.i50 = phi ptr [ %.sroa.5.0.i45, %bb.z ], [ %i.fa, %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport22import_on_the_fly_pat_s0_0E0B1R_.exit.i61 ] ; 2 uses
  %i.df = icmp eq i64 %.sroa.0.0.i46, %.sroa.16.0100232
  br i1 %i.df, label %bb.ag, label %bb.af
...
.lr.ph.i55:                                       ; preds = %bb.z, %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport22import_on_the_fly_pat_s0_0E0B1R_.exit.i61
  %.sroa.5.111.i56 = phi ptr [ %i.fa, %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport22import_on_the_fly_pat_s0_0E0B1R_.exit.i61 ], [ %.sroa.5.0.i45, %bb.z ] ; 11 uses
  %.sroa.11.110.i57 = phi i64 [ %i.ez, %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport22import_on_the_fly_pat_s0_0E0B1R_.exit.i61 ], [ %.sroa.11.0.i44, %bb.z ] ; 2 uses
  %.sroa.19.19.i58 = phi ptr [ %i.ew, %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport22import_on_the_fly_pat_s0_0E0B1R_.exit.i61 ], [ %.sroa.19.0.i43, %bb.z ]
...
_RNvXsk_NtCs33K2ylI4knu_10hir_expand8mod_pathNtB5_8PathKindNtNtCshzWfHUSfYae_4core3cmp3Ord3cmp.exit.thread.i.i.i66: ; preds = %_RNvXsk_NtCs33K2ylI4knu_10hir_expand8mod_pathNtB5_8PathKindNtNtCshzWfHUSfYae_4core3cmp3Ord3cmp.exit.i.i.i64, %bb.ab
  ...
  %i.eq = icmp ugt i64 %i.ep, 1                   ; 2 uses
  %i.er = load ptr, ptr %.sroa.5.111.i56, align 8, !alias.scope !410, !noalias !413, !nonnull !4
  %i.es = getelementptr inbounds nuw i8, ptr %.sroa.5.111.i56, i64 8
...
_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport22import_on_the_fly_pat_s0_0E0B1R_.exit.i61: ; preds = %_RNvXsk_NtCs33K2ylI4knu_10hir_expand8mod_pathNtB5_8PathKindNtNtCshzWfHUSfYae_4core3cmp3Ord3cmp.exit.thread.i.i.i66, %_RNvXsk_NtCs33K2ylI4knu_10hir_expand8mod_pathNtB5_8PathKindNtNtCshzWfHUSfYae_4core3cmp3Ord3cmp.exit.i.i.i64, %.lr.ph.i55
  ...
  %.sroa.01.0.i.i63 = select i1 %i.ev, ptr %2, ptr %i.ew
  %i.ex = getelementptr inbounds nuw [88 x i8], ptr %.sroa.01.0.i.i63, i64 %.sroa.11.110.i57
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(88) %i.ex, ptr noundef nonnull align 8 dereferenceable(88) %.sroa.5.111.i56, i64 88, i1 false), !alias.scope !415, !noalias !416
  %i.ey = zext i1 %i.ev to i64
  %i.ez = add i64 %.sroa.11.110.i57, %i.ey        ; 2 uses
  %i.fa = getelementptr inbounds nuw i8, ptr %.sroa.5.111.i56, i64 88 ; 3 uses
  %i.fb = icmp ult ptr %i.fa, %i.dd
...
bb.af:                                            ; preds = %._crit_edge.i47
  %i.fc = getelementptr inbounds i8, ptr %.sroa.19.1.lcssa.i48, i64 -88
  %i.fd = getelementptr inbounds nuw [88 x i8], ptr %2, i64 %.sroa.11.1.lcssa.i49
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(88) %i.fd, ptr noundef nonnull align 8 dereferenceable(88) %.sroa.5.1.lcssa.i50, i64 88, i1 false), !alias.scope !415, !noalias !419
  %i.fe = add i64 %.sroa.11.1.lcssa.i49, 1
  %i.ff = getelementptr inbounds nuw i8, ptr %.sroa.5.1.lcssa.i50, i64 88
  br label %bb.z
...
bb.m:                                             ; preds = %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport24import_on_the_fly_methods0_0E0B1R_.exit.i, %.lr.ph.i
  %.sroa.5.111.i = phi ptr [ %.sroa.5.0.i, %.lr.ph.i ], [ %i.bz, %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport24import_on_the_fly_methods0_0E0B1R_.exit.i ] ; 11 uses
  %.sroa.11.110.i = phi i64 [ %.sroa.11.0.i, %.lr.ph.i ], [ %i.by, %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport24import_on_the_fly_methods0_0E0B1R_.exit.i ] ; 2 uses
  %.sroa.19.19.i = phi ptr [ %.sroa.19.0.i, %.lr.ph.i ], [ %i.bv, %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport24import_on_the_fly_methods0_0E0B1R_.exit.i ]
  ...
  %i.ak = call noundef i64 @_RNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport34compute_fuzzy_completion_order_key(ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(88) %.sroa.5.111.i, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %i.ah, i64 noundef %i.aj, ptr noalias nofree noundef nonnull align 8 dereferenceable(24) %.val1.i.i), !noalias !444 ; 2 uses
...
_RNvXsk_NtCs33K2ylI4knu_10hir_expand8mod_pathNtB5_8PathKindNtNtCshzWfHUSfYae_4core3cmp3Ord3cmp.exit.thread.i.i.i: ; preds = %_RNvXsk_NtCs33K2ylI4knu_10hir_expand8mod_pathNtB5_8PathKindNtNtCshzWfHUSfYae_4core3cmp3Ord3cmp.exit.i.i.i, %bb.o
  ...
  %i.bl = icmp ugt i64 %i.bk, 1                   ; 2 uses
  %i.bm = load ptr, ptr %.sroa.5.111.i, align 8, !alias.scope !460, !noalias !463, !nonnull !4
  %i.bn = getelementptr inbounds nuw i8, ptr %.sroa.5.111.i, i64 8
...
_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport24import_on_the_fly_methods0_0E0B1R_.exit.i: ; preds = %_RNvXsk_NtCs33K2ylI4knu_10hir_expand8mod_pathNtB5_8PathKindNtNtCshzWfHUSfYae_4core3cmp3Ord3cmp.exit.thread.i.i.i, %_RNvXsk_NtCs33K2ylI4knu_10hir_expand8mod_pathNtB5_8PathKindNtNtCshzWfHUSfYae_4core3cmp3Ord3cmp.exit.i.i.i, %bb.m
  ...
  %.sroa.01.0.i.i = select i1 %i.bu, ptr %2, ptr %i.bv
  %i.bw = getelementptr inbounds nuw [88 x i8], ptr %.sroa.01.0.i.i, i64 %.sroa.11.110.i
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(88) %i.bw, ptr noundef nonnull align 8 dereferenceable(88) %.sroa.5.111.i, i64 88, i1 false), !alias.scope !470, !noalias !471
  %i.bx = zext i1 %i.bu to i64
  %i.by = add i64 %.sroa.11.110.i, %i.bx          ; 2 uses
  %i.bz = getelementptr inbounds nuw i8, ptr %.sroa.5.111.i, i64 88 ; 3 uses
  %i.ca = icmp ult ptr %i.bz, %i.ad
...
._crit_edge.i47:                                  ; preds = %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport24import_on_the_fly_methods0_0E0B1R_.exit.i61, %bb.z
  %.sroa.19.1.lcssa.i48 = phi ptr [ %.sroa.19.0.i43, %bb.z ], [ %i.ew, %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport24import_on_the_fly_methods0_0E0B1R_.exit.i61 ]
  %.sroa.11.1.lcssa.i49 = phi i64 [ %.sroa.11.0.i44, %bb.z ], [ %i.ez, %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport24import_on_the_fly_methods0_0E0B1R_.exit.i61 ] ; 10 uses
  %.sroa.5.1.lcssa.i50 = phi ptr [ %.sroa.5.0.i45, %bb.z ], [ %i.fa, %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport24import_on_the_fly_methods0_0E0B1R_.exit.i61 ] ; 2 uses
  %i.df = icmp eq i64 %.sroa.0.0.i46, %.sroa.16.0100232
  br i1 %i.df, label %bb.ag, label %bb.af
...
.lr.ph.i55:                                       ; preds = %bb.z, %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport24import_on_the_fly_methods0_0E0B1R_.exit.i61
  %.sroa.5.111.i56 = phi ptr [ %i.fa, %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport24import_on_the_fly_methods0_0E0B1R_.exit.i61 ], [ %.sroa.5.0.i45, %bb.z ] ; 11 uses
  %.sroa.11.110.i57 = phi i64 [ %i.ez, %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport24import_on_the_fly_methods0_0E0B1R_.exit.i61 ], [ %.sroa.11.0.i44, %bb.z ] ; 2 uses
  %.sroa.19.19.i58 = phi ptr [ %i.ew, %_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport24import_on_the_fly_methods0_0E0B1R_.exit.i61 ], [ %.sroa.19.0.i43, %bb.z ]
...
_RNvXsk_NtCs33K2ylI4knu_10hir_expand8mod_pathNtB5_8PathKindNtNtCshzWfHUSfYae_4core3cmp3Ord3cmp.exit.thread.i.i.i66: ; preds = %_RNvXsk_NtCs33K2ylI4knu_10hir_expand8mod_pathNtB5_8PathKindNtNtCshzWfHUSfYae_4core3cmp3Ord3cmp.exit.i.i.i64, %bb.ab
  ...
  %i.eq = icmp ugt i64 %i.ep, 1                   ; 2 uses
  %i.er = load ptr, ptr %.sroa.5.111.i56, align 8, !alias.scope !523, !noalias !526, !nonnull !4
  %i.es = getelementptr inbounds nuw i8, ptr %.sroa.5.111.i56, i64 8
...
_RNCINvMNtCsbSS6DM8SDEO_5alloc5sliceSNtNtNtCs6oosyzwIepl_6ide_db7imports13import_assets13LocatedImport7sort_byNCNvNtNtCsf8NQSppxkmK_14ide_completion11completions9flyimport24import_on_the_fly_methods0_0E0B1R_.exit.i61: ; preds = %_RNvXsk_NtCs33K2ylI4knu_10hir_expand8mod_pathNtB5_8PathKindNtNtCshzWfHUSfYae_4core3cmp3Ord3cmp.exit.thread.i.i.i66, %_RNvXsk_NtCs33K2ylI4knu_10hir_expand8mod_pathNtB5_8PathKindNtNtCshzWfHUSfYae_4core3cmp3Ord3cmp.exit.i.i.i64, %.lr.ph.i55
  ...
  %.sroa.01.0.i.i63 = select i1 %i.ev, ptr %2, ptr %i.ew
  %i.ex = getelementptr inbounds nuw [88 x i8], ptr %.sroa.01.0.i.i63, i64 %.sroa.11.110.i57
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(88) %i.ex, ptr noundef nonnull align 8 dereferenceable(88) %.sroa.5.111.i56, i64 88, i1 false), !alias.scope !528, !noalias !529
  %i.ey = zext i1 %i.ev to i64
  %i.ez = add i64 %.sroa.11.110.i57, %i.ey        ; 2 uses
  %i.fa = getelementptr inbounds nuw i8, ptr %.sroa.5.111.i56, i64 88 ; 3 uses
  %i.fb = icmp ult ptr %i.fa, %i.dd
...
bb.af:                                            ; preds = %._crit_edge.i47
  %i.fc = getelementptr inbounds i8, ptr %.sroa.19.1.lcssa.i48, i64 -88
  %i.fd = getelementptr inbounds nuw [88 x i8], ptr %2, i64 %.sroa.11.1.lcssa.i49
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(88) %i.fd, ptr noundef nonnull align 8 dereferenceable(88) %.sroa.5.1.lcssa.i50, i64 88, i1 false), !alias.scope !528, !noalias !532
  %i.fe = add i64 %.sroa.11.1.lcssa.i49, 1
  %i.ff = getelementptr inbounds nuw i8, ptr %.sroa.5.1.lcssa.i50, i64 88
  br label %bb.z
...
bb.y:                                             ; preds = %_RINvNtNtNtNtCshzWfHUSfYae_4core5slice4sort6stable9quicksort16stable_partitionTRNtNtCs33K2ylI4knu_10hir_expand4name4NameRNtCs8Xq8PKFYOms_3hir5LocalENCINvB2_9quicksortB1d_NCINvMNtCsbSS6DM8SDEO_5alloc5sliceSB1d_11sort_by_keyB1f_NCNvNtNtCsf8NQSppxkmK_14ide_completion6render8function12ref_of_param0E0E0EB3J_.exit
  call void @_RNvNtNtCshzWfHUSfYae_4core5slice5index16slice_index_fail(i64 noundef %.sroa.27.2.lcssa.i51, i64 noundef %.sroa.16.0112262, i64 noundef %.sroa.16.0112262, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @9) #27
  unreachable
}
