...
bb.c:                                             ; preds = %bb.a, %bb.b
  ...
  %5 = icmp slt i64 %spec.select.i.i, 0
  %6 = icmp samesign ult i8 %.sroa.0.0.val18, %.sroa.04.0.val20
  %spec.select.i = select i1 %i.aj, i1 %6, i1 %5  ; 2 uses
  ...
  %7 = icmp slt i64 %spec.select.i.i22, 0
  %8 = icmp samesign ult i8 %.sroa.0.0.val18, %.sroa.08.0.val16
  %spec.select.i23 = select i1 %i.ax, i1 %8, i1 %7
...
bb.d:                                             ; preds = %bb.c
  ...
  %9 = icmp slt i64 %spec.select.i.i25, 0
  %10 = icmp samesign ult i8 %.sroa.04.0.val20, %.sroa.08.0.val16
  %spec.select.i26 = select i1 %i.bd, i1 %10, i1 %9
