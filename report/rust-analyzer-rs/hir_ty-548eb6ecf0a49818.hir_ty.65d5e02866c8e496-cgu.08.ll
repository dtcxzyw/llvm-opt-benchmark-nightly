...
bb.a:
  ...
  %i.f = load ptr, ptr %2, align 8, !nonnull !18, !noundef !18
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a)
  store ptr %i.g, ptr %i.a, align 8, !noalias !7222
  %.sroa.0.0.copyload.i = load i32, ptr %i.g, align 8, !noalias !7222 ; 2 uses
  %.sroa.55.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.g, i64 16
  %.sroa.55.0.copyload.i = load i32, ptr %.sroa.55.0..sroa_idx.i, align 8, !noalias !7222
...
bb.b:                                             ; preds = %bb.a
  ...
  %.sroa.7.0.copyload.i = load i32, ptr %.sroa.7.0..sroa_idx.i, align 8, !noalias !7222
  %.sroa.6.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.g, i64 20
  %.sroa.6.0.copyload.i = load i32, ptr %.sroa.6.0..sroa_idx.i, align 4, !noalias !7222
...
bb.h:                                             ; preds = %bb.g
  %i.q = load i32, ptr %i.c, align 4, !range !40, !noundef !18
...
bb.a:
  ...
  %i.c = load ptr, ptr %0, align 8, !nonnull !18, !noundef !18 ; 3 uses
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.e = load ptr, ptr %i.d, align 8, !nonnull !18, !align !26, !noundef !18 ; 3 uses
  ...
  %i.h = load i32, ptr %i.g, align 4, !range !53, !noundef !18
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.k = load i32, ptr %i.j, align 4, !range !35, !noundef !18 ; 2 uses
  %i.l = getelementptr inbounds nuw i8, ptr %i.f, i64 24
  %i.m = load i32, ptr %i.l, align 4, !noundef !18 ; 2 uses
  ...
  %i.v = load i64, ptr %i.u, align 8, !noundef !18 ; 2 uses
  ...
  %i.z = load i64, ptr %i.y, align 8, !noundef !18 ; 3 uses
  %i.aa = sub nuw i64 %i.z, %i.x
  %.not = icmp ugt i64 %i.x, %i.z
  br i1 %.not, label %bb.d, label %bb.c, !prof !74
...
bb.e:                                             ; preds = %bb.c
  ...
  %.sroa.62.0.copyload = load ptr, ptr %.sroa.62.0..sroa_idx, align 8, !nonnull !18, !noundef !18 ; 4 uses
  %i.ag = getelementptr inbounds nuw i8, ptr %.sroa.62.0.copyload, i64 8
  %i.ah = load i64, ptr %i.ag, align 8, !noundef !18
...
bb.a:
  ...
  %.sroa.0.0.copyload = load ptr, ptr %i.c, align 8, !nonnull !18, !noundef !18 ; 2 uses
  %.sroa.5.0..sroa_idx = getelementptr inbounds nuw i8, ptr %1, i64 24
  %.sroa.5.0.copyload = load ptr, ptr %.sroa.5.0..sroa_idx, align 8, !nonnull !18, !noundef !18 ; 2 uses
  ...
  %i.f = load i32, ptr %i.e, align 4, !range !53, !noundef !18
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.m = load ptr, ptr %i.l, align 8, !noundef !18
...
bb.d:                                             ; preds = %bb.b
  ...
  %i.p = load i32, ptr %i.a, align 8, !range !54, !noundef !18 ; 2 uses
...
bb.d:                                             ; preds = %bb.b
  ...
  %i.k = load i32, ptr %i.j, align 4, !range !35, !noundef !18
  %i.l = getelementptr inbounds nuw i8, ptr %i.i, i64 20
  %i.m = load i32, ptr %i.l, align 4, !noundef !18
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b)
  br label %bb.f

bb.e:                                             ; preds = %bb.b
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a)
  store i32 %.sroa.5.sroa.10.0.copyload, ptr %i.a, align 4, !noalias !7225
  %i.n = getelementptr inbounds nuw i8, ptr %i.a, i64 4
  store i32 %.sroa.5.sroa.16.0.copyload, ptr %i.n, align 4, !noalias !7225
...
bb.a:
  ...
  %i.h = load i32, ptr %i.g, align 8, !range !35, !noundef !18
