Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/rust-analyzer-rs/original/clap_builder-30cbe4f1c73b6c1c.clap_builder.7b6dbbbaa4b59d1c-cgu.01?download=true
...
_RNvXs4_NtNtCsbSS6DM8SDEO_5alloc3vec9into_iterINtB5_8IntoIterNtNtNtCscAsMj0W7j8b_3std3ffi6os_str8OsStringENtNtNtNtCshzWfHUSfYae_4core4iter6traits8iterator8Iterator4nextCsaB0tVqiIPBo_12clap_builder.exit.i: ; preds = %_RNvXs4_NtNtCsbSS6DM8SDEO_5alloc3vec9into_iterINtB5_8IntoIterNtNtNtCscAsMj0W7j8b_3std3ffi6os_str8OsStringENtNtNtNtCshzWfHUSfYae_4core4iter6traits8iterator8Iterator4nextCsaB0tVqiIPBo_12clap_builder.exit.i.lr.ph, %_RINvNtCshzWfHUSfYae_4core3ptr9drop_glueNtNtNtCscAsMj0W7j8b_3std3ffi6os_str8OsStringECsaB0tVqiIPBo_12clap_builder.exit
  ...
  store ptr %i.hm, ptr %.sroa.030.sroa.2.0..sroa_idx, align 8, !alias.scope !704, !noalias !705
  %.sroa.0.0.copyload1.i = load i64, ptr %i.hl, align 8, !noalias !706 ; 2 uses
...
bb.ce:                                            ; preds = %_RNvXs4_NtNtCsbSS6DM8SDEO_5alloc3vec9into_iterINtB5_8IntoIterNtNtNtCscAsMj0W7j8b_3std3ffi6os_str8OsStringENtNtNtNtCshzWfHUSfYae_4core4iter6traits8iterator8Iterator4nextCsaB0tVqiIPBo_12clap_builder.exit.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.9, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.7.0..sroa_idx2.i, i64 16, i1 false), !noalias !702
  %i.ho = load i64, ptr %.sroa.2.0..sroa_idx, align 8, !alias.scope !702, !noalias !707, !noundef !4 ; 3 uses
  %i.hp = add i64 %i.ho, 1
  store i64 %i.hp, ptr %.sroa.2.0..sroa_idx, align 8, !alias.scope !702, !noalias !707
  ...
  %i.hq = load ptr, ptr %.sroa.9.8..sroa_idx, align 8, !nonnull !4, !noundef !4
  %i.hr = load i64, ptr %i.hj, align 8, !noundef !4
...
bb.ch:                                            ; preds = %bb.cg
  %i.hu = load ptr, ptr %i.hk, align 8, !nonnull !4, !align !16, !noundef !4 ; 2 uses
  %i.hv = getelementptr inbounds nuw i8, ptr %i.hu, i64 676
  %i.hw = load i32, ptr %i.hv, align 4, !noundef !4
...
bb.ci:                                            ; preds = %bb.cm, %bb.co, %bb.cg
  ...
  %i.hy = load i64, ptr %i.hb, align 8, !alias.scope !708, !noalias !709, !noundef !4 ; 3 uses
  %i.hz = load i64, ptr %i.bh, align 8, !range !12, !alias.scope !708, !noalias !709, !noundef !4
...
bb.cj:                                            ; preds = %bb.ci
  invoke void @_RNvMs4_NtCsbSS6DM8SDEO_5alloc7raw_vecINtB5_6RawVecNtNtNtCscAsMj0W7j8b_3std3ffi6os_str8OsStringE8grow_oneBS_(ptr noalias nofree noundef nonnull align 8 dereferenceable(24) %i.bh)
          to label %bb.ct unwind label %bb.ck, !noalias !709
...
bb.cm:                                            ; preds = %bb.ch
  ...
  %i.ie = load i32, ptr %i.id, align 8, !noundef !4
...
bb.cn:                                            ; preds = %bb.co, %bb.cm
  ...
  %i.ii = load ptr, ptr %.sroa.9.8..sroa_idx, align 8, !nonnull !4, !noundef !4
  %i.ij = load i64, ptr %i.hj, align 8, !noundef !4
...
_RINvNtCshzWfHUSfYae_4core3ptr9drop_glueNtNtNtCscAsMj0W7j8b_3std3ffi6os_str8OsStringECsaB0tVqiIPBo_12clap_builder.exit: ; preds = %_RINvNtCshzWfHUSfYae_4core3ptr9drop_glueNtNtNtNtCscAsMj0W7j8b_3std3sys6os_str5bytes3BufECsaB0tVqiIPBo_12clap_builder.exit.i, %bb.ct
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.9)
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.9)
  %i.im = load ptr, ptr %.sroa.030.sroa.4.0..sroa_idx, align 8, !alias.scope !710, !noalias !705, !nonnull !4, !noundef !4
  %i.in = load ptr, ptr %.sroa.030.sroa.2.0..sroa_idx, align 8, !alias.scope !710, !noalias !705, !nonnull !4, !noundef !4 ; 2 uses
...
bb.ct:                                            ; preds = %bb.cj, %bb.ci
  %i.ip = load ptr, ptr %i.ha, align 8, !alias.scope !708, !noalias !709, !nonnull !4, !noundef !4
  ...
  %i.ir = add i64 %i.hy, 1
  store i64 %i.ir, ptr %i.hb, align 8, !alias.scope !708, !noalias !709
...
bb.cx:                                            ; preds = %_RINvNtCshzWfHUSfYae_4core3ptr9drop_glueINtNtNtNtB4_4iter8adapters9enumerate9EnumerateINtNtNtCsbSS6DM8SDEO_5alloc3vec9into_iter8IntoIterNtNtNtCscAsMj0W7j8b_3std3ffi6os_str8OsStringEEECsaB0tVqiIPBo_12clap_builder.exit188, %bb.by, %bb.bx, %bb.bl, %bb.bo
  ...
  %i.iv = load i8, ptr %i.iu, align 4, !range !22, !noundef !4 ; 2 uses
...
bb.cy:                                            ; preds = %bb.cx
  br i1 %.not303, label %switch.early.test, label %bb.dh
...
bb.cz:                                            ; preds = %bb.cx
  br i1 %.not303, label %switch.early.test170, label %bb.ef
...
bb.da:                                            ; preds = %bb.cx
  ...
  %i.iw = load i64, ptr %i.eo, align 8, !noundef !4 ; 2 uses
...
bb.db:                                            ; preds = %bb.cx
  ...
  %i.iz = load i64, ptr %i.eo, align 8, !noundef !4 ; 2 uses
...
bb.dc:                                            ; preds = %bb.cx
  ...
  %i.jc = load i64, ptr %i.eo, align 8, !noundef !4 ; 2 uses
...
bb.dd:                                            ; preds = %bb.cx
  ...
  %i.jh = load ptr, ptr %i.jg, align 8, !nonnull !4, !align !16, !noundef !4
...
.noexc194:                                        ; preds = %bb.dd
  %i.ji = load ptr, ptr %i.jg, align 8, !nonnull !4, !align !16, !noundef !4
...
bb.de:                                            ; preds = %bb.cx
  ...
  %i.jl = load ptr, ptr %i.jk, align 8, !nonnull !4, !align !16, !noundef !4
...
.noexc196:                                        ; preds = %bb.de
  %i.jm = load ptr, ptr %i.jk, align 8, !nonnull !4, !align !16, !noundef !4
...
bb.df:                                            ; preds = %bb.cx
  ...
  %i.jp = load ptr, ptr %i.jo, align 8, !nonnull !4, !align !16, !noundef !4
...
.noexc199:                                        ; preds = %bb.df
  %i.jq = load ptr, ptr %i.jo, align 8, !nonnull !4, !align !16, !noundef !4
...
bb.dg:                                            ; preds = %bb.cx
  ...
  %i.ju = load ptr, ptr %i.jt, align 8, !nonnull !4, !align !16, !noundef !4
...
.noexc202:                                        ; preds = %bb.dg
  %i.jv = load ptr, ptr %i.jt, align 8, !nonnull !4, !align !16, !noundef !4
...
bb.di:                                            ; preds = %switch.early.test
  ...
  %i.ka = load i64, ptr %i.jz, align 8, !noundef !4
  %i.kb = add i64 %i.ka, 1
...
bb.dk:                                            ; preds = %bb.dj
  ...
  %i.kd = load ptr, ptr %i.kc, align 8, !nonnull !4, !align !16, !noundef !4 ; 2 uses
  %i.ke = getelementptr inbounds nuw i8, ptr %i.kd, i64 676
  %i.kf = load i32, ptr %i.ke, align 4, !noundef !4
  %i.kg = and i32 %i.kf, 8
...
bb.dm:                                            ; preds = %bb.dk
  ...
  %i.ki = load i32, ptr %i.kh, align 8, !noundef !4
  %i.kj = and i32 %i.ki, 8
...
bb.dn:                                            ; preds = %bb.dm
  ...
  %i.kl = load ptr, ptr %i.kk, align 8, !nonnull !4, !noundef !4
  %i.km = getelementptr inbounds nuw i8, ptr %4, i64 144
  %i.kn = load i64, ptr %i.km, align 8, !noundef !4
...
bb.dp:                                            ; preds = %bb.do
  %i.kp = load ptr, ptr %i.kc, align 8, !nonnull !4, !align !16, !noundef !4
...
bb.du:                                            ; preds = %bb.ds
  ...
  %i.kv = load ptr, ptr %i.kc, align 8, !nonnull !4, !align !16, !noundef !4
