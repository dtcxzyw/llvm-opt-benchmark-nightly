Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/rust-analyzer-rs/original/pulldown_cmark-f34de3d7b7a1c862.pulldown_cmark.897fb7e230ac415f-cgu.0?download=true
...
begin_hunk_0_@_RNvNtCsbNU0JlWw3cF_14pulldown_cmark9firstpass14run_first_pass:bb.a
  ...
  br i1 %i.op, label %bb.bs, label %.invoke2774.i
...
bb.bt:                                            ; preds = %bb.bs
  %i.ov = load i8, ptr %i.ca, align 4, !range !84, !alias.scope !211, !noalias !202, !noundef !5
...
.noexc44.i:                                       ; preds = %.noexc43.i
  ...
  br i1 %i.pc, label %.invoke2775.i, label %.lr.ph.i.i.i, !prof !124
...
.noexc46.i:                                       ; preds = %.noexc45.i
  ...
  br i1 %i.pi, label %.invoke2775.i, label %.lr.ph212.i.i, !prof !124
...
bb.bz:                                            ; preds = %bb.by
  ...
  br i1 %i.pz, label %.invoke2775.i, label %bb.ca, !prof !58
...
.noexc53.i:                                       ; preds = %.noexc52.i
  ...
  br i1 %i.qj, label %.invoke2775.i, label %.lr.ph212.i.i, !prof !141
...
bb.cc:                                            ; preds = %bb.cb
  ...
  br i1 %i.ql, label %bb.cd, label %.invoke2774.i
...
bb.cd:                                            ; preds = %bb.cc
  ...
  br i1 %i.qq, label %bb.ce, label %.invoke2774.i
...
bb.cf:                                            ; preds = %.noexc40.i
  ...
  br i1 %i.qu, label %bb.cg, label %.invoke2774.i
...
bb.ci:                                            ; preds = %.noexc59.i
  ...
  br i1 %i.rg, label %.invoke2775.i, label %.lr.ph.i105.i.i, !prof !124
...
.noexc61.i:                                       ; preds = %.noexc60.i
  ...
  br i1 %i.rt, label %.invoke2775.i, label %bb.cj, !prof !58
...
.noexc64.i:                                       ; preds = %.noexc63.i
  ...
  br i1 %i.sr, label %.invoke2775.i, label %bb.cp, !prof !58
...
.noexc70.i:                                       ; preds = %_RNvNtNtCshzWfHUSfYae_4core3str7pattern13simd_contains.exit.i.i.i.i
  ...
  %i.ud = load i64, ptr %i.ah, align 8, !range !102, !alias.scope !274, !noalias !277, !noundef !5
  %i.ue = trunc nuw i64 %i.ud to i1
  br i1 %i.ue, label %bb.dk, label %.preheader.i3.i.i.i.i

.preheader.i3.i.i.i.i:                            ; preds = %.noexc70.i
  %i.uf = load i8, ptr %i.dg, align 2, !range !84, !alias.scope !279, !noalias !282, !noundef !5
...
.lr.ph1505:                                       ; preds = %.preheader36.i.i.i.i.i.i.preheader, %.preheader36.i.i.i.i.i.i
  ...
  br i1 %i.yg, label %bb.dv, label %.invoke2774.i
...
.preheader.i10.i.i.i.i.i:                         ; preds = %.preheader35.i.i.i.i.i.i.preheader, %.preheader35.i.i.i.i.i.i
  ...
  br i1 %.not34.i.i.i.i.i.i, label %_RNvXsv_NtNtCshzWfHUSfYae_4core3str7patternNtB5_11StrSearcherNtB5_8Searcher10next_match.exit.i.i.i.i, label %.invoke2774.i
