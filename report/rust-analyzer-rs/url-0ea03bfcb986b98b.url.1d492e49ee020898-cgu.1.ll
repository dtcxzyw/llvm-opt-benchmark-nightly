...
.loopexit.sink.split:                             ; preds = %.split.thread.i, %.split.i, %bb.z, %.noexc41, %._crit_edge.thread236.i, %bb.i, %bb.o
  ...
  store ptr %.sroa.38.0152.i.sink, ptr %.sroa.1375, align 8, !alias.scope !582, !noalias !585
  br label %.loopexit
...
bb.ak:                                            ; preds = %bb.aj
  ...
  invoke void @_RNvMs8_NtCs2vT3jxLudSK_3url6parserNtB5_6Parser10parse_host(ptr noalias nofree noundef nonnull sret([40 x i8]) align 8 captures(address) dereferenceable(40) %i.f, ptr noundef nonnull %.sroa.1375.0..sroa.1375.0..sroa.1375.0..sroa.1375.8., ptr noundef %.sroa.22.0..sroa.22.0..sroa.22.0..sroa.22.16..sroa.6.0.copyload27, i8 noundef range(i8 0, 3) %4)
