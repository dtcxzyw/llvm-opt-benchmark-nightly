...
bb.ff:                                            ; preds = %bb.fd
  %i.ur = load ptr, ptr %i.dt, align 8, !nonnull !5, !noundef !5 ; 2 uses
...
bb.fg:                                            ; preds = %bb.fk, %bb.ff
  ...
  %i.ut = load i64, ptr %i.du, align 8, !alias.scope !596, !noalias !597, !noundef !5 ; 3 uses
  %i.uu = load i64, ptr %i.dr, align 8, !range !12, !alias.scope !596, !noalias !597, !noundef !5
...
bb.fh:                                            ; preds = %bb.fg
  invoke void @_RNvMs4_NtCsbSS6DM8SDEO_5alloc7raw_vecINtB5_6RawVecNtNtB7_6string6StringE8grow_oneCscAsMj0W7j8b_3std(ptr noalias nofree noundef nonnull align 8 dereferenceable(24) %i.dr)
          to label %bb.fl unwind label %bb.fi, !noalias !597
...
bb.fl:                                            ; preds = %bb.fh, %bb.fg
  %i.uy = load ptr, ptr %i.dv, align 8, !alias.scope !596, !noalias !597, !nonnull !5, !noundef !5
  ...
  %i.va = add i64 %i.ut, 1
  store i64 %i.va, ptr %i.du, align 8, !alias.scope !596, !noalias !597
...
bb.fm:                                            ; preds = %bb.fl
  ...
  store ptr %i.ul, ptr %i.dw, align 8, !alias.scope !600, !noalias !601
  store i64 %i.um, ptr %i.dx, align 8, !alias.scope !600, !noalias !601
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.dy, i8 0, i64 16, i1 false), !alias.scope !600, !noalias !601
...
bb.c:                                             ; preds = %bb.a
  ...
  br i1 %i.j, label %.lr.ph, label %_RNvNtNtCshzWfHUSfYae_4core3str7pattern13simd_contains.exit

bb.d:                                             ; preds = %.lr.ph
  %i.k = icmp ult i64 %i.i, %i.x
  br i1 %i.k, label %.lr.ph.1, label %_RNvNtNtCshzWfHUSfYae_4core3str7pattern13simd_contains.exit

.lr.ph.1:                                         ; preds = %bb.d
  %i.l = add nsw i64 %1, -2                       ; 3 uses
  %i.m = getelementptr inbounds nuw i8, ptr %0, i64 %i.l
  %i.n = load i8, ptr %i.m, align 1, !alias.scope !623, !noalias !625, !noundef !5 ; 2 uses
  %.not.i.not.i.i.1 = icmp eq i8 %i.n, %i.g
  br i1 %.not.i.not.i.i.1, label %bb.e, label %bb.h

bb.e:                                             ; preds = %.lr.ph.1
  %i.o = icmp ult i64 %i.i, %i.l
  br i1 %i.o, label %.lr.ph.2, label %_RNvNtNtCshzWfHUSfYae_4core3str7pattern13simd_contains.exit

.lr.ph.2:                                         ; preds = %bb.e
  %i.p = add nsw i64 %1, -3                       ; 3 uses
  %i.q = getelementptr inbounds nuw i8, ptr %0, i64 %i.p
  %i.r = load i8, ptr %i.q, align 1, !alias.scope !623, !noalias !625, !noundef !5 ; 2 uses
  %.not.i.not.i.i.2 = icmp eq i8 %i.r, %i.g
  br i1 %.not.i.not.i.i.2, label %bb.f, label %bb.h

bb.f:                                             ; preds = %.lr.ph.2
  %i.s = icmp ult i64 %i.i, %i.p
  br i1 %i.s, label %.lr.ph.3, label %_RNvNtNtCshzWfHUSfYae_4core3str7pattern13simd_contains.exit

.lr.ph.3:                                         ; preds = %bb.f
  %i.t = add nsw i64 %1, -4                       ; 4 uses
  %i.u = icmp samesign ugt i64 %1, 3
  br i1 %i.u, label %_RNCINvNvNtNtNtNtCshzWfHUSfYae_4core4iter6traits12double_ended19DoubleEndedIterator5rfind5checkjNCNvNtNtBe_3str7pattern13simd_contains0E0CsbXLDOPgjE5X_10test_utils.exit.i.i.3, label %bb.g
...
_RNCINvNvNtNtNtNtCshzWfHUSfYae_4core4iter6traits12double_ended19DoubleEndedIterator5rfind5checkjNCNvNtNtBe_3str7pattern13simd_contains0E0CsbXLDOPgjE5X_10test_utils.exit.i.i.3: ; preds = %.lr.ph.3
  %4 = getelementptr inbounds nuw i8, ptr %0, i64 %i.t
  %5 = load i8, ptr %4, align 1, !alias.scope !623, !noalias !625, !noundef !5 ; 2 uses
  %.not.i.not.i.i.3 = icmp eq i8 %5, %i.g
  br i1 %.not.i.not.i.i.3, label %6, label %bb.h

6:                                                ; preds = %_RNCINvNvNtNtNtNtCshzWfHUSfYae_4core4iter6traits12double_ended19DoubleEndedIterator5rfind5checkjNCNvNtNtBe_3str7pattern13simd_contains0E0CsbXLDOPgjE5X_10test_utils.exit.i.i.3
  %7 = icmp ult i64 %i.i, %i.t
  br i1 %7, label %.lr.ph.4, label %_RNvNtNtCshzWfHUSfYae_4core3str7pattern13simd_contains.exit

.lr.ph.4:                                         ; preds = %6
  %8 = add nsw i64 %1, -5                         ; 3 uses
  %.not = icmp eq i64 %1, 4
  br i1 %.not, label %bb.g, label %_RNCINvNvNtNtNtNtCshzWfHUSfYae_4core4iter6traits12double_ended19DoubleEndedIterator5rfind5checkjNCNvNtNtBe_3str7pattern13simd_contains0E0CsbXLDOPgjE5X_10test_utils.exit.i.i.4
...
_RNCINvNvNtNtNtNtCshzWfHUSfYae_4core4iter6traits12double_ended19DoubleEndedIterator5rfind5checkjNCNvNtNtBe_3str7pattern13simd_contains0E0CsbXLDOPgjE5X_10test_utils.exit.i.i.4: ; preds = %.lr.ph.4
  ...
  %i.w = load i8, ptr %i.v, align 1, !alias.scope !623, !noalias !625, !noundef !5 ; 2 uses
  %.not.i.not.i.i.4 = icmp eq i8 %i.w, %i.g
  br i1 %.not.i.not.i.i.4, label %_RNvNtNtCshzWfHUSfYae_4core3str7pattern13simd_contains.exit, label %bb.h

.lr.ph:                                           ; preds = %bb.c
  %i.x = add nsw i64 %1, -1                       ; 3 uses
  %i.y = getelementptr inbounds nuw i8, ptr %0, i64 %i.x
  %i.z = load i8, ptr %i.y, align 1, !alias.scope !623, !noalias !625, !noundef !5 ; 2 uses
  %.not.i.not.i.i = icmp eq i8 %i.z, %i.g
  br i1 %.not.i.not.i.i, label %bb.d, label %bb.h

bb.g:                                             ; preds = %.lr.ph.4, %.lr.ph.3
  %.lcssa39 = phi i64 [ %8, %.lr.ph.4 ], [ %i.t, %.lr.ph.3 ]
  tail call void @_RNvNtCshzWfHUSfYae_4core9panicking18panic_bounds_check(i64 noundef %.lcssa39, i64 noundef range(i64 3, 6) %1, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @6) #22, !noalias !626
  unreachable

bb.h:                                             ; preds = %_RNCINvNvNtNtNtNtCshzWfHUSfYae_4core4iter6traits12double_ended19DoubleEndedIterator5rfind5checkjNCNvNtNtBe_3str7pattern13simd_contains0E0CsbXLDOPgjE5X_10test_utils.exit.i.i.4, %_RNCINvNvNtNtNtNtCshzWfHUSfYae_4core4iter6traits12double_ended19DoubleEndedIterator5rfind5checkjNCNvNtNtBe_3str7pattern13simd_contains0E0CsbXLDOPgjE5X_10test_utils.exit.i.i.3, %.lr.ph.2, %.lr.ph.1, %.lr.ph
  %.lcssa42 = phi i8 [ %i.z, %.lr.ph ], [ %i.n, %.lr.ph.1 ], [ %i.r, %.lr.ph.2 ], [ %5, %_RNCINvNvNtNtNtNtCshzWfHUSfYae_4core4iter6traits12double_ended19DoubleEndedIterator5rfind5checkjNCNvNtNtBe_3str7pattern13simd_contains0E0CsbXLDOPgjE5X_10test_utils.exit.i.i.3 ], [ %i.w, %_RNCINvNvNtNtNtNtCshzWfHUSfYae_4core4iter6traits12double_ended19DoubleEndedIterator5rfind5checkjNCNvNtNtBe_3str7pattern13simd_contains0E0CsbXLDOPgjE5X_10test_utils.exit.i.i.4 ]
  %.lcssa40 = phi i64 [ %i.x, %.lr.ph ], [ %i.l, %.lr.ph.1 ], [ %i.p, %.lr.ph.2 ], [ %i.t, %_RNCINvNvNtNtNtNtCshzWfHUSfYae_4core4iter6traits12double_ended19DoubleEndedIterator5rfind5checkjNCNvNtNtBe_3str7pattern13simd_contains0E0CsbXLDOPgjE5X_10test_utils.exit.i.i.3 ], [ %8, %_RNCINvNvNtNtNtNtCshzWfHUSfYae_4core4iter6traits12double_ended19DoubleEndedIterator5rfind5checkjNCNvNtNtBe_3str7pattern13simd_contains0E0CsbXLDOPgjE5X_10test_utils.exit.i.i.4 ] ; 6 uses
...
.lr.ph.split.us.i.i:                              ; preds = %bb.h
  %bcmp.i.i.us22.i.i = tail call i32 @bcmp(ptr noundef nonnull readonly dereferenceable(1) %2, ptr noundef nonnull readonly dereferenceable(1) %0, i64 range(i64 3, 6) %1), !alias.scope !627, !noalias !628
...
.split.us.i.i:                                    ; preds = %_RNCINvNvNtNtNtNtCshzWfHUSfYae_4core4iter6traits8iterator8Iterator3any5checkRShNCNvNtNtBe_3str7pattern13simd_containss_0E0CsbXLDOPgjE5X_10test_utils.exit.backedge.us.i.i.preheader, %_RNCINvNvNtNtNtNtCshzWfHUSfYae_4core4iter6traits8iterator8Iterator3any5checkRShNCNvNtNtBe_3str7pattern13simd_containss_0E0CsbXLDOPgjE5X_10test_utils.exit.backedge.us.i.i
  ...
  %bcmp.i.i.us.i.i = tail call i32 @bcmp(ptr noundef nonnull readonly dereferenceable(1) %i.af, ptr noundef nonnull readonly dereferenceable(1) %0, i64 range(i64 3, 6) %1), !alias.scope !627, !noalias !628
...
bb.i:                                             ; preds = %bb.h
  ...
  store ptr %2, ptr %i.a, align 8, !noalias !627
  %i.an = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  store i64 %3, ptr %i.an, align 8, !noalias !627
  %i.ao = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  store ptr %i.am, ptr %i.ao, align 8, !noalias !627
  %i.ap = getelementptr inbounds nuw i8, ptr %i.a, i64 24
  store i64 %i.h, ptr %i.ap, align 8, !noalias !627
...
.lr.ph.i:                                         ; preds = %bb.i, %bb.m
  %.sroa.06.097.i = phi i64 [ %i.cl, %bb.m ], [ 0, %bb.i ] ; 6 uses
  %i.au = getelementptr inbounds nuw i8, ptr %2, i64 %.sroa.06.097.i ; 5 uses
  %.sroa.0.0.copyload.i.i = load <16 x i8>, ptr %i.au, align 1, !alias.scope !624, !noalias !629
  %i.av = getelementptr inbounds nuw i8, ptr %i.au, i64 %.lcssa40
  %.sroa.01.0.copyload.i.i = load <16 x i8>, ptr %i.av, align 1, !alias.scope !624, !noalias !629
  ...
  %.sroa.0.0.copyload.i.1.i = load <16 x i8>, ptr %i.ba, align 1, !alias.scope !624, !noalias !629
  %i.bb = getelementptr inbounds nuw i8, ptr %i.ba, i64 %.lcssa40
  %.sroa.01.0.copyload.i.1.i = load <16 x i8>, ptr %i.bb, align 1, !alias.scope !624, !noalias !629
  ...
  %.sroa.0.0.copyload.i.2.i = load <16 x i8>, ptr %i.bg, align 1, !alias.scope !624, !noalias !629
  %i.bh = getelementptr inbounds nuw i8, ptr %i.bg, i64 %.lcssa40
  %.sroa.01.0.copyload.i.2.i = load <16 x i8>, ptr %i.bh, align 1, !alias.scope !624, !noalias !629
  ...
  %.sroa.0.0.copyload.i.3.i = load <16 x i8>, ptr %i.bm, align 1, !alias.scope !624, !noalias !629
  %i.bn = getelementptr inbounds nuw i8, ptr %i.bm, i64 %.lcssa40
  %.sroa.01.0.copyload.i.3.i = load <16 x i8>, ptr %i.bn, align 1, !alias.scope !624, !noalias !629
...
.preheader90.2.i:                                 ; preds = %bb.j, %.preheader90.1.i
  %.sroa.014.2.1.i = phi i8 [ %.sroa.014.2.i, %.preheader90.1.i ], [ %i.by, %bb.j ] ; 3 uses
  %i.bz = icmp eq i16 %i.bl, 0
  br i1 %i.bz, label %.preheader90.3.i, label %bb.k
...
.preheader90.3.i:                                 ; preds = %bb.k, %.preheader90.2.i
  %.sroa.014.2.2.i = phi i8 [ %.sroa.014.2.1.i, %.preheader90.2.i ], [ %i.ce, %bb.k ] ; 3 uses
...
bb.m:                                             ; preds = %bb.l, %.preheader90.3.i
  %.sroa.014.2.3.i = phi i8 [ %.sroa.014.2.2.i, %.preheader90.3.i ], [ %i.ck, %bb.l ] ; 2 uses
...
._crit_edge.i:                                    ; preds = %bb.o, %.preheader.i
  ...
  %.sroa.0.0.copyload.i57.i = load <16 x i8>, ptr %i.ct, align 1, !alias.scope !624, !noalias !630
  %i.cu = getelementptr inbounds nuw i8, ptr %i.ct, i64 %.lcssa40
  %.sroa.01.0.copyload.i58.i = load <16 x i8>, ptr %i.cu, align 1, !alias.scope !624, !noalias !630
...
.lr.ph101.i:                                      ; preds = %.preheader.i, %bb.o
  %.sroa.06.1100.i = phi i64 [ %i.dh, %bb.o ], [ %.sroa.06.0.lcssa.i, %.preheader.i ] ; 3 uses
  %i.da = getelementptr inbounds nuw i8, ptr %2, i64 %.sroa.06.1100.i ; 2 uses
  %.sroa.0.0.copyload.i59.i = load <16 x i8>, ptr %i.da, align 1, !alias.scope !624, !noalias !631
  %i.db = getelementptr inbounds nuw i8, ptr %i.da, i64 %.lcssa40
  %.sroa.01.0.copyload.i60.i = load <16 x i8>, ptr %i.db, align 1, !alias.scope !624, !noalias !631
...
bb.o:                                             ; preds = %bb.p, %.lr.ph101.i
  %.sroa.014.4.i = phi i8 [ 0, %.lr.ph101.i ], [ %i.dm, %bb.p ] ; 2 uses
...
_RNvNtNtCshzWfHUSfYae_4core3str7pattern13simd_contains.exit: ; preds = %bb.d, %bb.e, %bb.f, %6, %_RNCINvNvNtNtNtNtCshzWfHUSfYae_4core4iter6traits12double_ended19DoubleEndedIterator5rfind5checkjNCNvNtNtBe_3str7pattern13simd_contains0E0CsbXLDOPgjE5X_10test_utils.exit.i.i.4, %bb.c
  ...
  %i.dq = load i64, ptr %i.c, align 8, !range !7, !noundef !5
...
bb.a:
  %i.a = load i64, ptr %1, align 8, !range !7, !noundef !5
...
.preheader:                                       ; preds = %bb.a
  ...
  %i.e = load i8, ptr %i.d, align 2, !range !6, !alias.scope !654, !noalias !655, !noundef !5
...
.lr.ph:                                           ; preds = %.preheader
  ...
  %i.i = load ptr, ptr %i.h, align 8, !alias.scope !654, !noalias !655, !nonnull !5, !noundef !5 ; 5 uses
  %i.j = getelementptr inbounds nuw i8, ptr %1, i64 80
  %i.k = load i64, ptr %i.j, align 8, !alias.scope !654, !noalias !655, !noundef !5 ; 16 uses
  %.promoted52 = load i8, ptr %i.g, align 8, !alias.scope !654, !noalias !655 ; 4 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.p = load i8, ptr %i.o, align 1, !alias.scope !657, !noalias !658, !noundef !5
...
bb.e:                                             ; preds = %bb.d
  %i.t = load i8, ptr %i.r, align 1, !noalias !659, !noundef !5 ; 5 uses
...
_RNvXs2J_NtNtCshzWfHUSfYae_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits8iterator8Iterator4nextCsbXLDOPgjE5X_10test_utils.exit12.i.i.peel: ; preds = %bb.e
  ...
  %i.aa = load i8, ptr %i.v, align 1, !noalias !659, !noundef !5
...
_RNvXs2J_NtNtCshzWfHUSfYae_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits8iterator8Iterator4nextCsbXLDOPgjE5X_10test_utils.exit14.i.i.peel: ; preds = %_RNvXs2J_NtNtCshzWfHUSfYae_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits8iterator8Iterator4nextCsbXLDOPgjE5X_10test_utils.exit12.i.i.peel
  ...
  %i.aj = load i8, ptr %i.ag, align 1, !noalias !659, !noundef !5
...
_RNvXs2J_NtNtCshzWfHUSfYae_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits8iterator8Iterator4nextCsbXLDOPgjE5X_10test_utils.exit16.i.i.peel: ; preds = %_RNvXs2J_NtNtCshzWfHUSfYae_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits8iterator8Iterator4nextCsbXLDOPgjE5X_10test_utils.exit14.i.i.peel
  ...
  %i.au = load i8, ptr %i.ar, align 1, !noalias !659, !noundef !5
...
_RNvXsv_NtNtCshzWfHUSfYae_4core3str7patternNtB5_11StrSearcherNtB5_8Searcher4next.exit.peel: ; preds = %bb.j, %bb.i, %bb.h
  ...
  store i64 %i.bh, ptr %i.c, align 8, !alias.scope !656, !noalias !655
...
bb.m:                                             ; preds = %bb.l
  %i.cj = load i8, ptr %i.bk, align 1, !alias.scope !657, !noalias !660, !noundef !5
...
bb.o:                                             ; preds = %bb.n
  %i.cl = load i8, ptr %i.bl, align 1, !noalias !661, !noundef !5 ; 5 uses
...
_RNvXs2J_NtNtCshzWfHUSfYae_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits8iterator8Iterator4nextCsbXLDOPgjE5X_10test_utils.exit12.i.i: ; preds = %bb.o
  ...
  %i.cp = load i8, ptr %i.bn, align 1, !noalias !661, !noundef !5
