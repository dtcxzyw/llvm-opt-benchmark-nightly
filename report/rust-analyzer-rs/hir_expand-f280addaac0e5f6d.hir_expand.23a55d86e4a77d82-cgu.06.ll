...
.lr.ph.i.i84.preheader:                           ; preds = %bb.k
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(40) %i.a, ptr noundef nonnull align 8 dereferenceable(40) %.sroa.362.0..sroa_idx, i64 40, i1 false), !noalias !1155
  invoke void @_RNvMsc_NtCs4dcH4YgJDq_2tt7storageNtB5_17TopSubtreeBuilder4push(ptr noalias nofree noundef nonnull align 8 dereferenceable(168) %i.k, ptr noalias nofree noundef nonnull readonly align 8 captures(none) dereferenceable(40) %i.a)
          to label %.noexc.i86 unwind label %bb.l, !noalias !1152
...
.noexc.i86:                                       ; preds = %.lr.ph.i.i84.preheader
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !1154
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(40) %i.a, ptr noundef nonnull align 8 dereferenceable(40) %i.aq, i64 40, i1 false), !noalias !1155
  invoke void @_RNvMsc_NtCs4dcH4YgJDq_2tt7storageNtB5_17TopSubtreeBuilder4push(ptr noalias nofree noundef nonnull align 8 dereferenceable(168) %i.k, ptr noalias nofree noundef nonnull readonly align 8 captures(none) dereferenceable(40) %i.a)
          to label %.noexc.i86.1 unwind label %bb.l, !noalias !1152

.noexc.i86.1:                                     ; preds = %.noexc.i86
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !1154
  store i64 2, ptr %i.f, align 8, !alias.scope !1156, !noalias !1157
...
bb.l:                                             ; preds = %.noexc.i86, %.lr.ph.i.i84.preheader
  ...
  %i.ar = landingpad { ptr, i32 }
          cleanup
  store i64 %.lcssa, ptr %i.f, align 8, !alias.scope !1156, !noalias !1157
...
bb.a:
  ...
  %i.r = load i64, ptr %i.n, align 8, !range !18, !alias.scope !1200, !noalias !1201, !noundef !6
...
bb.b:                                             ; preds = %_RINvNtCshzWfHUSfYae_4core3ptr9drop_glueNtNtCs4dcH4YgJDq_2tt4iter9TtElementECs33K2ylI4knu_10hir_expand.exit.i, %.lr.ph.i
  %i.w = load i8, ptr %i.s, align 4, !range !21, !alias.scope !1200, !noalias !1201, !noundef !6
...
bb.c:                                             ; preds = %bb.b
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.m), !noalias !1202
  invoke void @_RNvYQNtNtCs4dcH4YgJDq_2tt4iter6TtIterNtCscFGNKo4Sl5v_9itertools9Itertools11exactly_oneCs33K2ylI4knu_10hir_expand(ptr noalias nofree noundef nonnull sret([184 x i8]) align 8 captures(none) dereferenceable(184) %i.m, ptr noalias nofree noundef nonnull align 8 dereferenceable(88) %i.n)
          to label %bb.d unwind label %.loopexit.i, !noalias !1201
...
.body.i:                                          ; preds = %bb.al, %.body72.i, %bb.n, %.lr.ph.split.i.i.i.i.i.i.i, %.lr.ph.i.i.i.i.i.i.i, %bb.f, %.loopexit.split-lp.i, %.loopexit.i
  ...
  %i.x = load i64, ptr %i.n, align 8, !range !18, !alias.scope !1200, !noalias !1201, !noundef !6
...
bb.d:                                             ; preds = %bb.c
  %i.z = load i64, ptr %i.m, align 8, !range !1203, !noalias !1202, !noundef !6 ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %.sroa.44.0.copyload = load i64, ptr %i.t, align 8, !noalias !1202 ; 2 uses
  %.sroa.44.sroa.0.0.extract.trunc = trunc i64 %.sroa.44.0.copyload to i32
  %.sroa.6.0.copyload = load ptr, ptr %.sroa.434.0..sroa_idx.i, align 8, !noalias !1202 ; 2 uses
  %.sroa.8.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.m, i64 24
  %.sroa.8.0.copyload = load ptr, ptr %.sroa.8.0..sroa_idx, align 8, !noalias !1202
  %.sroa.96.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.m, i64 88
  %.sroa.96.0.copyload = load i64, ptr %.sroa.96.0..sroa_idx, align 8, !noalias !1202 ; 2 uses
  %.sroa.11.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.m, i64 96
  %.sroa.11.0.copyload = load i32, ptr %.sroa.11.0..sroa_idx, align 8, !noalias !1202 ; 2 uses
  %.sroa.138.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.m, i64 104
  %.sroa.138.0.copyload = load ptr, ptr %.sroa.138.0..sroa_idx, align 8, !noalias !1202 ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.g), !noalias !1202
  invoke void @_RNvMCsdovh4xi6v3I_4spanNtB2_4Span5cover(ptr noalias nofree noundef nonnull sret([20 x i8]) align 4 captures(none) dereferenceable(20) %i.g, ptr noalias nofree noundef nonnull readonly align 4 captures(none) dereferenceable(20) %i.aa, ptr noalias nofree noundef nonnull readonly align 4 captures(none) dereferenceable(20) %i.ab)
          to label %bb.g unwind label %bb.f, !noalias !1204
...
bb.f:                                             ; preds = %bb.e
  ...
  invoke fastcc void @_RINvNtCshzWfHUSfYae_4core3ptr9drop_glueINtNtCscFGNKo4Sl5v_9itertools15exactly_one_err15ExactlyOneErrorQNtNtCs4dcH4YgJDq_2tt4iter6TtIterEECs33K2ylI4knu_10hir_expand(ptr noalias nofree noundef nonnull readonly align 8 dereferenceable(184) %i.m) #30
          to label %.body.i unwind label %bb.k, !noalias !1201
...
bb.h:                                             ; preds = %bb.g
  invoke fastcc void @_RINvNtCshzWfHUSfYae_4core3ptr9drop_glueNtCs4dcH4YgJDq_2tt4LeafECs33K2ylI4knu_10hir_expand(i32 %.sroa.44.sroa.0.0.extract.trunc, ptr %.sroa.6.0.copyload)
          to label %_RINvNtCshzWfHUSfYae_4core3ptr9drop_glueNtNtCs4dcH4YgJDq_2tt4iter9TtElementECs33K2ylI4knu_10hir_expand.exit.i.i.i.i.i.i.i unwind label %.lr.ph.i.i.i.i.i.i.i, !noalias !1205
...
.lr.ph.split.i.i.i.i.i.i.i:                       ; preds = %.lr.ph.i.i.i.i.i.i.i
  invoke fastcc void @_RINvNtCshzWfHUSfYae_4core3ptr9drop_glueNtCs4dcH4YgJDq_2tt4LeafECs33K2ylI4knu_10hir_expand(i32 %.sroa.11.0.copyload, ptr %.sroa.138.0.copyload)
          to label %.body.i unwind label %bb.i, !noalias !1205

bb.i:                                             ; preds = %.lr.ph.split.i.i.i.i.i.i.i
  %i.ag = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCshzWfHUSfYae_4core9panicking16panic_in_cleanup() #27, !noalias !1205
  unreachable
...
_RINvNtCshzWfHUSfYae_4core3ptr9drop_glueANtNtCs4dcH4YgJDq_2tt4iter9TtElementj2_ECs33K2ylI4knu_10hir_expand.exit.sink.split.i.i.i.i.i: ; preds = %bb.j, %_RINvNtCshzWfHUSfYae_4core3ptr9drop_glueNtNtCs4dcH4YgJDq_2tt4iter9TtElementECs33K2ylI4knu_10hir_expand.exit.i.i.i.i.i.i.i
  ...
  invoke fastcc void @_RINvNtCshzWfHUSfYae_4core3ptr9drop_glueNtCs4dcH4YgJDq_2tt4LeafECs33K2ylI4knu_10hir_expand(i32 %.sink2.i.i.i.i.sroa.phi.i.sroa.speculated, ptr %.sink1.i.i.i.i.sroa.phi.i.sroa.speculated)
          to label %_RNCNCNvNtNtCs33K2ylI4knu_10hir_expand7builtin8fn_macro12parse_string00B9_.exit.i unwind label %.loopexit.split-lp.i, !noalias !1201

bb.k:                                             ; preds = %bb.f
  %i.aj = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCshzWfHUSfYae_4core9panicking16panic_in_cleanup() #27, !noalias !1206
  unreachable

bb.l:                                             ; preds = %bb.d
  %.sroa.033.0.copyload.i = load i64, ptr %i.t, align 8, !noalias !1202 ; 3 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(20) %.sroa.613.i, ptr noundef nonnull align 8 dereferenceable(20) %.sroa.434.0..sroa_idx.i, i64 20, i1 false), !noalias !1202
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(60) %.sroa.4.i, ptr noundef nonnull align 4 dereferenceable(60) %.sroa.535.0..sroa_idx.i, i64 60, i1 false), !noalias !1202
  call void @llvm.lifetime.end.p0(ptr nonnull %i.m), !noalias !1202
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(20) %.sroa.6.i, ptr noundef nonnull align 8 dereferenceable(20) %.sroa.613.i, i64 20, i1 false), !noalias !1202
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.613.i)
  %i.ak = load i64, ptr %i.n, align 8, !range !18, !alias.scope !1207, !noalias !1201, !noundef !6
...
bb.m:                                             ; preds = %bb.l
  %.val.i.i = load i32, ptr %i.u, align 8, !range !11, !alias.scope !1207, !noalias !1201, !noundef !6
  %.val1.i.i = load ptr, ptr %i.v, align 8, !alias.scope !1207, !noalias !1201
  invoke fastcc void @_RINvNtCshzWfHUSfYae_4core3ptr9drop_glueNtCs4dcH4YgJDq_2tt4LeafECs33K2ylI4knu_10hir_expand(i32 %.val.i.i, ptr %.val1.i.i)
          to label %_RINvNtCshzWfHUSfYae_4core3ptr9drop_glueNtNtCs4dcH4YgJDq_2tt4iter9TtElementECs33K2ylI4knu_10hir_expand.exit.i unwind label %bb.n, !noalias !1201

bb.n:                                             ; preds = %bb.m
  %i.am = landingpad { ptr, i32 }
          cleanup
  store i64 %.sroa.033.0.copyload.i, ptr %i.n, align 8, !alias.scope !1200, !noalias !1201
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(20) %i.u, ptr noundef nonnull align 8 dereferenceable(20) %.sroa.6.i, i64 20, i1 false), !noalias !1201
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(60) %.sroa.4.0..sroa_idx20.i, ptr noundef nonnull align 4 dereferenceable(60) %.sroa.4.i, i64 60, i1 false), !noalias !1201
  br label %.body.i
...
_RNCNCNvNtNtCs33K2ylI4knu_10hir_expand7builtin8fn_macro12parse_string00B9_.exit.i: ; preds = %bb.g, %_RINvNtCshzWfHUSfYae_4core3ptr9drop_glueANtNtCs4dcH4YgJDq_2tt4iter9TtElementj2_ECs33K2ylI4knu_10hir_expand.exit.sink.split.i.i.i.i.i, %bb.j, %_RINvNtCshzWfHUSfYae_4core3ptr9drop_glueNtNtCs4dcH4YgJDq_2tt4iter9TtElementECs33K2ylI4knu_10hir_expand.exit.i.i.i.i.i.i.i
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(20) %.sroa.613.i, ptr noundef nonnull align 4 dereferenceable(20) %i.g, i64 20, i1 false), !noalias !1202
  call void @llvm.lifetime.end.p0(ptr nonnull %i.g), !noalias !1202
  call void @llvm.lifetime.end.p0(ptr nonnull %i.m), !noalias !1202
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(20) %.sroa.6.i, ptr noundef nonnull align 8 dereferenceable(20) %.sroa.613.i, i64 20, i1 false), !noalias !1202
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.613.i)
  ...
  %i.an = load i64, ptr %i.n, align 8, !range !18, !alias.scope !1210, !noalias !1201, !noundef !6
...
bb.o:                                             ; preds = %_RNCNCNvNtNtCs33K2ylI4knu_10hir_expand7builtin8fn_macro12parse_string00B9_.exit.i
  %.val.i.i.i = load i32, ptr %i.u, align 8, !range !11, !alias.scope !1210, !noalias !1201, !noundef !6
  %.val1.i.i.i = load ptr, ptr %i.v, align 8, !alias.scope !1210, !noalias !1201
  call fastcc void @_RINvNtCshzWfHUSfYae_4core3ptr9drop_glueNtCs4dcH4YgJDq_2tt4LeafECs33K2ylI4knu_10hir_expand(i32 %.val.i.i.i, ptr %.val1.i.i.i), !noalias !1211
...
bb.p:                                             ; preds = %bb.b
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %i.f, ptr noundef nonnull align 4 dereferenceable(20) %i.ap, i64 20, i1 false), !noalias !1201
  %i.aq = getelementptr inbounds nuw i8, ptr %i.n, i64 64
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %i.e, ptr noundef nonnull align 8 dereferenceable(20) %i.aq, i64 20, i1 false), !noalias !1201
  call void @llvm.lifetime.start.p0(ptr nonnull %i.h), !noalias !1202
  invoke void @_RNvMCsdovh4xi6v3I_4spanNtB2_4Span5cover(ptr noalias nofree noundef nonnull sret([20 x i8]) align 4 captures(none) dereferenceable(20) %i.h, ptr noalias nofree noundef nonnull readonly align 4 captures(none) dereferenceable(20) %i.f, ptr noalias nofree noundef nonnull readonly align 4 captures(none) dereferenceable(20) %i.e)
          to label %bb.aq unwind label %.loopexit.split-lp.i, !noalias !1201
...
._crit_edge.i:                                    ; preds = %_RINvNtCshzWfHUSfYae_4core3ptr9drop_glueNtNtCs4dcH4YgJDq_2tt4iter9TtElementECs33K2ylI4knu_10hir_expand.exit.i, %bb.a
  ...
  %i.as = load i32, ptr %i.ar, align 8, !range !11, !alias.scope !1200, !noalias !1201, !noundef !6
...
bb.q:                                             ; preds = %._crit_edge.i
  ...
  %i.aw = load i8, ptr %i.av, align 1, !range !25, !alias.scope !1200, !noalias !1201, !noundef !6
...
bb.r:                                             ; preds = %bb.q, %._crit_edge.i
  call void @llvm.lifetime.start.p0(ptr nonnull %i.i), !noalias !1202
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(40) %i.i, ptr noundef nonnull align 8 dereferenceable(40) %i.ar, i64 40, i1 false), !noalias !1201
  %i.ax = load i32, ptr %i.i, align 8, !range !11, !noalias !1202, !noundef !6 ; 2 uses
  ...
  %.val55.i = load ptr, ptr %.sroa.gep, align 8, !noalias !1202
  invoke fastcc void @_RINvNtCshzWfHUSfYae_4core3ptr9drop_glueNtCs4dcH4YgJDq_2tt4LeafECs33K2ylI4knu_10hir_expand(i32 %i.ax, ptr %.val55.i)
          to label %bb.ap unwind label %.loopexit.split-lp.i, !noalias !1201

bb.s:                                             ; preds = %bb.q
  call void @llvm.lifetime.start.p0(ptr nonnull %i.l)
  %i.az = getelementptr inbounds nuw i8, ptr %i.n, i64 24
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %i.l, ptr noundef nonnull align 8 dereferenceable(20) %i.az, i64 20, i1 false), !noalias !1201
  %.sroa.0.0.copyload.i = load ptr, ptr %i.au, align 8, !alias.scope !1200, !noalias !1201, !nonnull !6, !noundef !6 ; 4 uses
  %.sroa.685.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.n, i64 44
  %.sroa.685.0.copyload.i = load i8, ptr %.sroa.685.0..sroa_idx.i, align 4, !alias.scope !1200, !noalias !1201 ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.k), !noalias !1202
  ...
  %i.be = load ptr, ptr %i.bd, align 8, !noalias !1212, !nonnull !6, !noundef !6 ; 3 uses
  %i.bf = getelementptr inbounds nuw i8, ptr %i.bd, i64 8
  %i.bg = load i64, ptr %i.bf, align 8, !noalias !1212, !noundef !6 ; 4 uses
...
bb.u:                                             ; preds = %bb.t
  ...
  %i.bm = load i8, ptr %i.bl, align 1, !alias.scope !1213, !noalias !1214, !noundef !6
...
bb.v:                                             ; preds = %bb.u, %.split3.i.i.i
  invoke void @_RNvNtCshzWfHUSfYae_4core3str16slice_error_fail(ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %i.be, i64 noundef %i.bg, i64 noundef 0, i64 noundef %i.bi, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @1) #32
          to label %.noexc61.i unwind label %bb.aa, !noalias !1201
...
bb.w:                                             ; preds = %bb.q
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %i.j, ptr noundef nonnull align 8 dereferenceable(20) %i.bo, i64 20, i1 false), !noalias !1201
  %.sroa.086.0.copyload.i = load ptr, ptr %i.au, align 8, !alias.scope !1200, !noalias !1201, !nonnull !6, !noundef !6 ; 4 uses
  %.sroa.688.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.n, i64 44
  %.sroa.688.0.copyload.i = load i8, ptr %.sroa.688.0..sroa_idx.i, align 4, !alias.scope !1200, !noalias !1201 ; 2 uses
  ...
  %i.bt = load ptr, ptr %i.bs, align 8, !noalias !1215, !nonnull !6, !noundef !6 ; 3 uses
  %i.bu = getelementptr inbounds nuw i8, ptr %i.bs, i64 8
  %i.bv = load i64, ptr %i.bu, align 8, !noalias !1215, !noundef !6 ; 4 uses
...
bb.y:                                             ; preds = %bb.x
  ...
  %i.cb = load i8, ptr %i.ca, align 1, !alias.scope !1216, !noalias !1217, !noundef !6
...
bb.z:                                             ; preds = %bb.y, %.split3.i.i63.i
  invoke void @_RNvNtCshzWfHUSfYae_4core3str16slice_error_fail(ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %i.bt, i64 noundef %i.bv, i64 noundef 0, i64 noundef %i.bx, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @1) #32
          to label %.noexc70.i unwind label %bb.al, !noalias !1201
...
.body72.i:                                        ; preds = %bb.af, %bb.ac, %bb.aa
  ...
  invoke fastcc void @_RINvNtCshzWfHUSfYae_4core3ptr9drop_glueNtCs4dcH4YgJDq_2tt7LiteralECs33K2ylI4knu_10hir_expand(ptr nonnull %.sroa.0.0.copyload.i) #30
          to label %.body.i unwind label %bb.ak, !noalias !1201
...
_RNvMsb_Cs4dcH4YgJDq_2ttNtB5_7Literal15text_and_suffix.exit.i: ; preds = %bb.u, %.split3.i.i.i, %bb.s
  invoke fastcc void @_RNvNtNtCs33K2ylI4knu_10hir_expand7builtin8fn_macro12unescape_str(ptr noalias nofree noundef align 8 captures(none) dereferenceable(24) %i.k, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %i.be, i64 noundef %i.bi)
          to label %bb.ab unwind label %bb.aa, !noalias !1201
...
bb.ab:                                            ; preds = %_RNvMsb_Cs4dcH4YgJDq_2ttNtB5_7Literal15text_and_suffix.exit.i
  ...
  %i.cf = load ptr, ptr %i.ce, align 8, !noalias !1202, !nonnull !6
