...
bb.i:                                             ; preds = %.preheader.i
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.x, ptr nonnull readonly align 1 %i.b, i64 %.sroa.0.0.copyload.i, i1 false)
...
.preheader.i:                                     ; preds = %_RNvMse_NtNtCshzWfHUSfYae_4core3num7nonzeroINtB5_7NonZerojE13new_uncheckedCs9dV2ZPf2jOH_6semver.exit.i, %.preheader.i
  %.sroa.06.011.i = phi i64 [ %i.w, %.preheader.i ], [ %.sroa.0.0.copyload.i, %_RNvMse_NtNtCshzWfHUSfYae_4core3num7nonzeroINtB5_7NonZerojE13new_uncheckedCs9dV2ZPf2jOH_6semver.exit.i ] ; 2 uses
  %.sroa.03.010.i = phi ptr [ %i.x, %.preheader.i ], [ %i.n, %_RNvMse_NtNtCshzWfHUSfYae_4core3num7nonzeroINtB5_7NonZerojE13new_uncheckedCs9dV2ZPf2jOH_6semver.exit.i ] ; 2 uses
  %i.u = trunc i64 %.sroa.06.011.i to i8
  %i.v = or i8 %i.u, -128
  store i8 %i.v, ptr %.sroa.03.010.i, align 1
  %i.w = lshr i64 %.sroa.06.011.i, 7              ; 2 uses
  %i.x = getelementptr inbounds nuw i8, ptr %.sroa.03.010.i, i64 1 ; 2 uses
...
_RNvMNtCs9dV2ZPf2jOH_6semver10identifierNtB2_10Identifier13new_unchecked.exit: ; preds = %bb.c, %bb.e, %bb.i
  %.sroa.0.0.i = phi i64 [ %i.t, %bb.i ], [ %.sroa.0.i.0..sroa.0.i.0..sroa.0.i.0..sroa.0.0..sroa.0.0..sroa.0.0..sroa.02.0.copyload.i, %bb.e ], [ -1, %bb.c ]
...
bb.i:                                             ; preds = %.loopexit, %bb.c
  ...
  %.lcssa.ph.ph = phi ptr [ %i.h, %bb.c ], [ %i.ae, %.loopexit ] ; 2 uses
  %i.af = load i8, ptr %.lcssa.ph.ph, align 1
  %i.ag = icmp slt i8 %i.af, -64
...
_RNvXs2_NtNtCshzWfHUSfYae_4core3str6traitseINtNtNtB9_3ops5index5IndexINtNtBJ_5range9RangeFromjEE5indexCs9dV2ZPf2jOH_6semver.exit61: ; preds = %.split.i.i.i, %bb.i
  ...
  store i64 %i.ah, ptr %.sroa.327.0..sroa_idx, align 8
  br label %bb.g
