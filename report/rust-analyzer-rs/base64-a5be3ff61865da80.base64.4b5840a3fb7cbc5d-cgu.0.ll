...
.preheader.i:                                     ; preds = %_RNvNtNtNtCs6t3BXPRE3GP_6base646engine15general_purpose6decode18complete_quads_len.exit.i
  %.not.i.i1119.i = icmp eq i64 %i.x, 0
  br i1 %.not.i.i1119.i, label %._crit_edge.i, label %.lr.ph.preheader.i
...
.lr.ph.i:                                         ; preds = %bb.cl, %.lr.ph.preheader.i
  %.sroa.0116.01122.i = phi ptr [ %i.z, %bb.cl ], [ %2, %.lr.ph.preheader.i ] ; 33 uses
  %.sroa.6117.01121.i = phi i64 [ %i.aa, %bb.cl ], [ %i.x, %.lr.ph.preheader.i ]
  %.sroa.13.01120.i = phi i64 [ %i.ab, %bb.cl ], [ 0, %.lr.ph.preheader.i ] ; 14 uses
  %i.z = getelementptr inbounds nuw i8, ptr %.sroa.0116.01122.i, i64 32
  %i.aa = add i64 %.sroa.6117.01121.i, -32        ; 2 uses
  %i.ab = add nuw nsw i64 %.sroa.13.01120.i, 1
  %i.ac = mul nuw nsw i64 %.sroa.13.01120.i, 24   ; 2 uses
  %exitcond.i = icmp eq i64 %.sroa.13.01120.i, %i.y
...
bb.l:                                             ; preds = %bb.j
  ...
  %.not.i.i1031130.i = icmp eq i64 %i.ai, 0
  br i1 %.not.i.i1031130.i, label %._crit_edge1136.i, label %.lr.ph1135.preheader.i

.lr.ph1135.preheader.i:                           ; preds = %bb.l
  %i.aj = getelementptr inbounds nuw i8, ptr %2, i64 %i.x
  br label %.lr.ph1135.i

.lr.ph1135.i:                                     ; preds = %bb.av, %.lr.ph1135.preheader.i
  %.sroa.13146.01133.i = phi i64 [ %i.am, %bb.av ], [ 0, %.lr.ph1135.preheader.i ] ; 6 uses
  %.sroa.6142.01132.i = phi i64 [ %i.al, %bb.av ], [ %i.ai, %.lr.ph1135.preheader.i ]
  %.sroa.0141.01131.i = phi ptr [ %i.ak, %bb.av ], [ %i.aj, %.lr.ph1135.preheader.i ] ; 5 uses
  %i.ak = getelementptr inbounds nuw i8, ptr %.sroa.0141.01131.i, i64 4
  %i.al = add i64 %.sroa.6142.01132.i, -4         ; 2 uses
  %i.am = add nuw nsw i64 %.sroa.13146.01133.i, 1
  %i.an = mul nuw i64 %.sroa.13146.01133.i, 3     ; 3 uses
  %i.ao = add nuw i64 %i.an, 3                    ; 2 uses
  %.not37.i = icmp ugt i64 %i.ao, %i.ag
  br i1 %.not37.i, label %bb.am, label %bb.an, !prof !87

._crit_edge1136.i:                                ; preds = %bb.av, %bb.l
...
_RNvXs_NtNtNtCshzWfHUSfYae_4core4iter8adapters9enumerateINtB4_9EnumerateINtNtNtBa_5slice4iter4IterhEENtNtNtB8_6traits8iterator8Iterator4nextCs6t3BXPRE3GP_6base64.exit.lr.ph.preheader.i.i: ; preds = %._crit_edge1136.i
...
_RNvXs_NtNtNtCshzWfHUSfYae_4core4iter8adapters9enumerateINtB4_9EnumerateINtNtNtBa_5slice4iter4IterhEENtNtNtB8_6traits8iterator8Iterator4nextCs6t3BXPRE3GP_6base64.exit.thread.i.i: ; preds = %._crit_edge1136.i
...
_RNvXs_NtNtNtCshzWfHUSfYae_4core4iter8adapters9enumerateINtB4_9EnumerateINtNtNtBa_5slice4iter4IterhEENtNtNtB8_6traits8iterator8Iterator4nextCs6t3BXPRE3GP_6base64.exit.thread.i.thread.i: ; preds = %_RNvXs_NtNtNtCshzWfHUSfYae_4core4iter8adapters9enumerateINtB4_9EnumerateINtNtNtBa_5slice4iter4IterhEENtNtNtB8_6traits8iterator8Iterator4nextCs6t3BXPRE3GP_6base64.exit.thread.i.i, %.outer.i.i
  %.sroa.04.0.ph.lcssa143.i302.i = phi i64 [ 1, %.outer.i.i ], [ 0, %_RNvXs_NtNtNtCshzWfHUSfYae_4core4iter8adapters9enumerateINtB4_9EnumerateINtNtNtBa_5slice4iter4IterhEENtNtNtB8_6traits8iterator8Iterator4nextCs6t3BXPRE3GP_6base64.exit.thread.i.i ]
  %i.ax = add nuw i64 %.sroa.04.0.ph.lcssa143.i302.i, %i.l
...
.loopexit1941.i:                                  ; preds = %_RNvXs_NtNtNtCshzWfHUSfYae_4core4iter8adapters9enumerateINtB4_9EnumerateINtNtNtBa_5slice4iter4IterhEENtNtNtB8_6traits8iterator8Iterator4nextCs6t3BXPRE3GP_6base64.exit.3.i.i, %_RNvXs_NtNtNtCshzWfHUSfYae_4core4iter8adapters9enumerateINtB4_9EnumerateINtNtNtBa_5slice4iter4IterhEENtNtNtB8_6traits8iterator8Iterator4nextCs6t3BXPRE3GP_6base64.exit.2.i.i, %..loopexit1941.i_crit_edge
  %.pre-phi = phi i64 [ %.pre, %..loopexit1941.i_crit_edge ], [ %i.dg, %_RNvXs_NtNtNtCshzWfHUSfYae_4core4iter8adapters9enumerateINtB4_9EnumerateINtNtNtBa_5slice4iter4IterhEENtNtNtB8_6traits8iterator8Iterator4nextCs6t3BXPRE3GP_6base64.exit.2.i.i ], [ %i.du, %_RNvXs_NtNtNtCshzWfHUSfYae_4core4iter8adapters9enumerateINtB4_9EnumerateINtNtNtBa_5slice4iter4IterhEENtNtNtB8_6traits8iterator8Iterator4nextCs6t3BXPRE3GP_6base64.exit.3.i.i ]
...
_RNvXs_NtNtNtCshzWfHUSfYae_4core4iter8adapters9enumerateINtB4_9EnumerateINtNtNtBa_5slice4iter4IterhEENtNtNtB8_6traits8iterator8Iterator4nextCs6t3BXPRE3GP_6base64.exit.2.i.i: ; preds = %bb.ac, %bb.ae
  ...
  br i1 %i.dp, label %bb.ad, label %.loopexit1941.i
...
bb.ad:                                            ; preds = %_RNvXs_NtNtNtCshzWfHUSfYae_4core4iter8adapters9enumerateINtB4_9EnumerateINtNtNtBa_5slice4iter4IterhEENtNtNtB8_6traits8iterator8Iterator4nextCs6t3BXPRE3GP_6base64.exit.2.i.i
  %exitcond1872.i = icmp eq i64 %.sroa.011.0151.2.i.i, -2
  br i1 %exitcond1872.i, label %.loopexit211.i.i, label %bb.ae
...
_RNvXs_NtNtNtCshzWfHUSfYae_4core4iter8adapters9enumerateINtB4_9EnumerateINtNtNtBa_5slice4iter4IterhEENtNtNtB8_6traits8iterator8Iterator4nextCs6t3BXPRE3GP_6base64.exit.3.i.i: ; preds = %bb.af, %bb.ah
  ...
  br i1 %i.ef, label %bb.ag, label %.loopexit1941.i
...
10:                                               ; preds = %_RNvXs_NtNtNtCshzWfHUSfYae_4core4iter8adapters9enumerateINtB4_9EnumerateINtNtNtBa_5slice4iter4IterhEENtNtNtB8_6traits8iterator8Iterator4nextCs6t3BXPRE3GP_6base64.exit.4.i.i
  ...
  br i1 %11, label %.thread318.i.i, label %..loopexit1941.i_crit_edge

..loopexit1941.i_crit_edge:                       ; preds = %10
...
bb.an:                                            ; preds = %.lr.ph1135.i
  %i.fc = getelementptr inbounds nuw i8, ptr %i.ah, i64 %i.an
  tail call void @llvm.experimental.noalias.scope.decl(metadata !109)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !112)
  %i.fd = load i8, ptr %.sroa.0141.01131.i, align 1, !alias.scope !114, !noalias !115, !noundef !8 ; 2 uses
...
bb.ao:                                            ; preds = %bb.an
  %i.fi = getelementptr inbounds nuw i8, ptr %.sroa.0141.01131.i, i64 1
...
bb.ap:                                            ; preds = %bb.ao
  %i.fo = shl i64 %.sroa.13146.01133.i, 2
  %i.fp = add i64 %i.fo, %i.x
  %i.fq = or disjoint i64 %i.fp, 1
  br label %bb.au

bb.aq:                                            ; preds = %bb.ao
  %i.fr = getelementptr inbounds nuw i8, ptr %.sroa.0141.01131.i, i64 2
...
bb.ar:                                            ; preds = %bb.aq
  %i.fx = shl i64 %.sroa.13146.01133.i, 2
  %i.fy = add i64 %i.fx, %i.x
  %i.fz = or disjoint i64 %i.fy, 2
  br label %bb.au

bb.as:                                            ; preds = %bb.aq
  %i.ga = getelementptr inbounds nuw i8, ptr %.sroa.0141.01131.i, i64 3
...
bb.at:                                            ; preds = %bb.as
  %i.gg = shl i64 %.sroa.13146.01133.i, 2
  %i.gh = add i64 %i.gg, %i.x
  %i.gi = or disjoint i64 %i.gh, 3
  br label %bb.au

.loopexit.i:                                      ; preds = %bb.an
  %i.gj = shl i64 %.sroa.13146.01133.i, 2
  %i.gk = add i64 %i.gj, %i.x
  br label %bb.au

bb.au:                                            ; preds = %.loopexit.i, %bb.at, %bb.ar, %bb.ap
  %.sroa.10151.1.ph.i = phi i8 [ %i.fj, %bb.ap ], [ %i.gb, %bb.at ], [ %i.fs, %bb.ar ], [ %i.fd, %.loopexit.i ]
  %.sroa.14153.1.ph.i = phi i64 [ %i.fq, %bb.ap ], [ %i.gi, %bb.at ], [ %i.fz, %bb.ar ], [ %i.gk, %.loopexit.i ]
  ...
  store i8 %.sroa.10151.1.ph.i, ptr %.sroa.4269.0..sroa_idx.i, align 1, !alias.scope !66, !noalias !86
  %.sroa.6271.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %0, i64 16
  store i64 %.sroa.14153.1.ph.i, ptr %.sroa.6271.0..sroa_idx.i, align 8, !alias.scope !66, !noalias !86
  store i64 2, ptr %0, align 8, !alias.scope !66, !noalias !86
  br label %_RNvNtNtNtCs6t3BXPRE3GP_6base646engine15general_purpose6decode13decode_helper.exit
...
bb.av:                                            ; preds = %bb.as
  ...
  br i1 %.not.i.i103.i, label %._crit_edge1136.i, label %.lr.ph1135.i
...
bb.ax:                                            ; preds = %.lr.ph.i
  ...
  %i.hb = load i8, ptr %.sroa.0116.01122.i, align 1, !alias.scope !131, !noalias !132, !noundef !8 ; 2 uses
  ...
  br i1 %i.hf, label %.loopexit343.i, label %bb.ay

bb.ay:                                            ; preds = %bb.ax
  %i.hg = getelementptr inbounds nuw i8, ptr %.sroa.0116.01122.i, i64 1
...
bb.az:                                            ; preds = %bb.ay
  %i.hm = getelementptr inbounds nuw i8, ptr %.sroa.0116.01122.i, i64 2
...
bb.ba:                                            ; preds = %bb.ay
  %i.hs = shl i64 %.sroa.13.01120.i, 5
  %i.ht = or disjoint i64 %i.hs, 1
  br label %bb.bm

bb.bb:                                            ; preds = %bb.az
  %i.hu = getelementptr inbounds nuw i8, ptr %.sroa.0116.01122.i, i64 3
...
bb.bc:                                            ; preds = %bb.az
  %i.ia = shl i64 %.sroa.13.01120.i, 5
  %i.ib = or disjoint i64 %i.ia, 2
  br label %bb.bm

bb.bd:                                            ; preds = %bb.bb
  %i.ic = getelementptr inbounds nuw i8, ptr %.sroa.0116.01122.i, i64 4
...
bb.be:                                            ; preds = %bb.bb
  %i.ii = shl i64 %.sroa.13.01120.i, 5
  %i.ij = or disjoint i64 %i.ii, 3
  br label %bb.bm

bb.bf:                                            ; preds = %bb.bd
  %i.ik = getelementptr inbounds nuw i8, ptr %.sroa.0116.01122.i, i64 5
...
bb.bg:                                            ; preds = %bb.bd
  %i.iq = shl i64 %.sroa.13.01120.i, 5
  %i.ir = or disjoint i64 %i.iq, 4
  br label %bb.bm

bb.bh:                                            ; preds = %bb.bf
  %i.is = getelementptr inbounds nuw i8, ptr %.sroa.0116.01122.i, i64 6
...
bb.bi:                                            ; preds = %bb.bf
  %i.iy = shl i64 %.sroa.13.01120.i, 5
  %i.iz = or disjoint i64 %i.iy, 5
  br label %bb.bm

bb.bj:                                            ; preds = %bb.bh
  %i.ja = getelementptr inbounds nuw i8, ptr %.sroa.0116.01122.i, i64 7
end_hunk_0
