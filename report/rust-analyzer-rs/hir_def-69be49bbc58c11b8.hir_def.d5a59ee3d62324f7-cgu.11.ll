...
bb.g:                                             ; preds = %.lr.ph.i
  %i.p = getelementptr inbounds nuw i8, ptr %.tr16.i, i64 16
  %i.q = load i64, ptr %i.p, align 8, !noalias !5995, !noundef !19 ; 2 uses
  %i.r = getelementptr inbounds nuw i8, ptr %.tr717.i, i64 16
  %i.s = load i64, ptr %i.r, align 8, !noalias !5998, !noundef !19
  %i.t = icmp eq i64 %i.q, %i.s
  br i1 %i.t, label %bb.h, label %_RNvXsd_NtCs4kMRW8zVVbM_3cfg8cfg_exprNtB5_7CfgExprNtNtCshzWfHUSfYae_4core3cmp9PartialEq2eq.exit

bb.h:                                             ; preds = %bb.g
  %i.u = getelementptr inbounds nuw i8, ptr %.tr717.i, i64 8
  %i.v = load ptr, ptr %i.u, align 8, !noalias !5998, !nonnull !19, !noundef !19
  %i.w = getelementptr inbounds nuw i8, ptr %.tr16.i, i64 8
  %i.x = load ptr, ptr %i.w, align 8, !noalias !5995, !nonnull !19, !noundef !19
  %i.y = tail call noundef zeroext i1 @_RNvXs2_NtNtCshzWfHUSfYae_4core5slice3cmpNtNtCs4kMRW8zVVbM_3cfg8cfg_expr7CfgExprINtB5_14SlicePartialEqBC_E17equal_same_lengthCsileJQcQObtj_7hir_def(ptr noundef nonnull %i.x, ptr noundef nonnull %i.v, i64 noundef %i.q), !noalias !6000, !inline_history !6001
  br label %_RNvXsd_NtCs4kMRW8zVVbM_3cfg8cfg_exprNtB5_7CfgExprNtNtCshzWfHUSfYae_4core3cmp9PartialEq2eq.exit

bb.i:                                             ; preds = %.lr.ph.i
  %i.z = getelementptr inbounds nuw i8, ptr %.tr16.i, i64 16
  %i.aa = load i64, ptr %i.z, align 8, !noalias !5995, !noundef !19 ; 2 uses
  %i.ab = getelementptr inbounds nuw i8, ptr %.tr717.i, i64 16
  %i.ac = load i64, ptr %i.ab, align 8, !noalias !5998, !noundef !19
  %i.ad = icmp eq i64 %i.aa, %i.ac
  br i1 %i.ad, label %bb.j, label %_RNvXsd_NtCs4kMRW8zVVbM_3cfg8cfg_exprNtB5_7CfgExprNtNtCshzWfHUSfYae_4core3cmp9PartialEq2eq.exit

bb.j:                                             ; preds = %bb.i
  %i.ae = getelementptr inbounds nuw i8, ptr %.tr717.i, i64 8
  %i.af = load ptr, ptr %i.ae, align 8, !noalias !5998, !nonnull !19, !noundef !19
  %i.ag = getelementptr inbounds nuw i8, ptr %.tr16.i, i64 8
  %i.ah = load ptr, ptr %i.ag, align 8, !noalias !5995, !nonnull !19, !noundef !19
  %i.ai = tail call noundef zeroext i1 @_RNvXs2_NtNtCshzWfHUSfYae_4core5slice3cmpNtNtCs4kMRW8zVVbM_3cfg8cfg_expr7CfgExprINtB5_14SlicePartialEqBC_E17equal_same_lengthCsileJQcQObtj_7hir_def(ptr noundef nonnull %i.ah, ptr noundef nonnull %i.af, i64 noundef %i.aa), !noalias !6000, !inline_history !6001
  br label %_RNvXsd_NtCs4kMRW8zVVbM_3cfg8cfg_exprNtB5_7CfgExprNtNtCshzWfHUSfYae_4core3cmp9PartialEq2eq.exit
}
