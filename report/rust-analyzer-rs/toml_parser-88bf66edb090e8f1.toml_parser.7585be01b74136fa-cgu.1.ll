...
bb.b:                                             ; preds = %.lr.ph, %bb.t
  %.sroa.0.070 = phi ptr [ %0, %.lr.ph ], [ %.sroa.0.1, %bb.t ] ; 9 uses
  %.sroa.14.069 = phi i64 [ %1, %.lr.ph ], [ %.sroa.14.1, %bb.t ] ; 8 uses
  %i.m = getelementptr inbounds nuw i8, ptr %.sroa.0.070, i64 %.sroa.14.069
  %i.n = ptrtoint ptr %.sroa.0.070 to i64
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %bb.b, %bb.c
  %.sroa.02.08.i = phi i64 [ %i.q, %bb.c ], [ 0, %bb.b ] ; 3 uses
  %i.o = phi ptr [ %i.p, %bb.c ], [ %.sroa.0.070, %bb.b ] ; 2 uses
...
bb.d:                                             ; preds = %.lr.ph.i
  %i.u = icmp ult i64 %.sroa.02.08.i, %.sroa.14.069
...
_RNvNtCsil5KYoyU2ra_6winnow6stream6memmem.exit:   ; preds = %bb.c, %bb.d
  %.sroa.021.0 = phi i64 [ %.sroa.02.08.i, %bb.d ], [ %.sroa.14.069, %bb.c ] ; 10 uses
...
bb.e:                                             ; preds = %_RNvNtCsil5KYoyU2ra_6winnow6stream6memmem.exit
  %.not.i = icmp ult i64 %.sroa.021.0, %.sroa.14.069
  br i1 %.not.i, label %bb.f, label %.split3.i

.split3.i:                                        ; preds = %bb.e
  %i.y = icmp eq i64 %.sroa.021.0, %.sroa.14.069
  br i1 %i.y, label %.split.i, label %_RNvMNtCshzWfHUSfYae_4core3stre16split_at_checked.exit.thread

bb.f:                                             ; preds = %bb.e
  %i.z = getelementptr inbounds nuw i8, ptr %.sroa.0.070, i64 %.sroa.021.0
...
.split.i:                                         ; preds = %bb.f, %.split3.i
  %i.ac = getelementptr inbounds nuw i8, ptr %.sroa.0.070, i64 %.sroa.021.0
  %i.ad = sub i64 %.sroa.14.069, %.sroa.021.0
...
_RNvMNtCshzWfHUSfYae_4core3stre16split_at_checked.exit: ; preds = %.split.i, %_RNvNtCsil5KYoyU2ra_6winnow6stream6memmem.exit
  %.sroa.9.0 = phi i64 [ %.sroa.14.069, %_RNvNtCsil5KYoyU2ra_6winnow6stream6memmem.exit ], [ %i.ad, %.split.i ] ; 5 uses
  %.sroa.7.0 = phi ptr [ %.sroa.0.070, %_RNvNtCsil5KYoyU2ra_6winnow6stream6memmem.exit ], [ %i.ac, %.split.i ] ; 5 uses
...
_RNvMNtCshzWfHUSfYae_4core3stre16split_at_checked.exit.thread: ; preds = %.split3.i, %bb.f
  call void @_RNvNtCshzWfHUSfYae_4core3str16slice_error_fail(ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %.sroa.0.070, i64 noundef %.sroa.14.069, i64 noundef 0, i64 noundef %.sroa.021.0, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @57) #10
  unreachable

bb.g:                                             ; preds = %_RNvMNtCshzWfHUSfYae_4core3stre16split_at_checked.exit
  %.not.i60 = icmp ugt i64 %.sroa.9.0, 1
  br i1 %.not.i60, label %bb.h, label %.split3.i61

.split3.i61:                                      ; preds = %bb.g
  %i.ae = icmp eq i64 %.sroa.9.0, 1
  br i1 %i.ae, label %bb.j, label %bb.k

bb.h:                                             ; preds = %bb.g
  %i.af = getelementptr inbounds nuw i8, ptr %.sroa.7.0, i64 1
...
bb.i:                                             ; preds = %bb.q, %bb.r, %_RNvMNtCshzWfHUSfYae_4core3stre16split_at_checked.exit
  %.sroa.14.1 = phi i64 [ %i.aj, %bb.r ], [ %i.aj, %bb.q ], [ %.sroa.9.0, %_RNvMNtCshzWfHUSfYae_4core3stre16split_at_checked.exit ] ; 2 uses
  %.sroa.0.1 = phi ptr [ %i.ai, %bb.r ], [ %i.ai, %bb.q ], [ %.sroa.7.0, %_RNvMNtCshzWfHUSfYae_4core3stre16split_at_checked.exit ]
  br i1 %i.x, label %bb.t, label %bb.s

bb.j:                                             ; preds = %bb.h, %.split3.i61
  %i.ai = getelementptr inbounds nuw i8, ptr %.sroa.7.0, i64 1 ; 3 uses
  %i.aj = add i64 %.sroa.9.0, -1                  ; 3 uses
  br i1 %i.x, label %bb.m, label %bb.l

bb.k:                                             ; preds = %bb.h, %.split3.i61
  call void @_RNvNtCshzWfHUSfYae_4core3str16slice_error_fail(ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %.sroa.7.0, i64 noundef %.sroa.9.0, i64 noundef 0, i64 noundef 1, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @57) #10
  unreachable
...
bb.n:                                             ; preds = %bb.l
  ...
  %or.cond29.i.i.i.not54 = or i1 %i.e, %i.at
  %.sroa.01.0.in.i.not = and i1 %spec.select.i.i, %or.cond29.i.i.i.not54
  br label %bb.p
...
bb.q:                                             ; preds = %bb.p
  ...
  %or.cond29.i.i.i71.not57 = or i1 %i.e, %i.ay
  %.sroa.01.0.in.i72.not = and i1 %spec.select.i.i70, %or.cond29.i.i.i71.not57
...
bb.s:                                             ; preds = %bb.i
  %i.ba = call noundef zeroext i1 %.32.val(ptr noundef nonnull %4, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %.sroa.0.070, i64 noundef %.sroa.021.0) #9
