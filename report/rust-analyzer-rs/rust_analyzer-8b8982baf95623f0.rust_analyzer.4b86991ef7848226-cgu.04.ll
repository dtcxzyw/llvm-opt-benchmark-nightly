...
.lr.ph.i:                                         ; preds = %bb.l, %.lr.ph.i
  ...
  %.val29.i = load i32, ptr %.sroa.9.131.i, align 4, !range !1334, !alias.scope !1340, !noalias !1343, !noundef !4 ; 2 uses
  ...
  %i.av = load i64, ptr %.sroa.9.131.i, align 4, !alias.scope !1340, !noalias !1345
  ...
  %.sroa.01.0.i.i.a = select i1 %19, ptr %2, ptr %20
  %i.aw = getelementptr inbounds nuw [8 x i8], ptr %.sroa.01.0.i.i.a, i64 %13
  ...
  %.sroa.01.0.i33.i = select i1 %27, ptr %2, ptr %28
  %i.az = getelementptr inbounds nuw [8 x i8], ptr %.sroa.01.0.i33.i, i64 %i.ay
