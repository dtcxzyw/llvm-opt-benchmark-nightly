...
bb.cs:                                            ; preds = %bb.ct, %bb.cq
  ...
  %.sroa.021.0.i = zext i8 %.sroa.021.0.in.i to i64
  ...
  %4 = shl nuw nsw i64 %.sroa.021.0.i, 2
  %.sroa.023.0..sroa_stride.i = and i64 %4, 60
  %.sroa.023.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr @57, i64 %.sroa.023.0..sroa_stride.i
  %i.qd = load i32, ptr %.sroa.023.0..sroa_idx.i, align 4, !noalias !325
...
bb.ec:                                            ; preds = %bb.eb, %bb.ea
  ...
  %i.ahy = load i8, ptr %i.ahx, align 1, !noalias !415
