...
bb.b:                                             ; preds = %.split, %.split2
  ...
  %i.q = insertelement <2 x i16> poison, i16 %.sink10.in.in, i64 0
  %i.r = insertelement <2 x i16> %i.q, i16 %.sink.in.in, i64 1
  %i.s = add nuw nsw <2 x i16> %i.r, splat (i16 1)
  %i.t = zext nneg <2 x i16> %i.s to <2 x i32>
  store <2 x i32> %i.t, ptr %i.p, align 8
  ret void
}
...
bb.f:                                             ; preds = %_RNvXs9_NtCsbSS6DM8SDEO_5alloc5boxedINtB5_3BoxNtNtNtCsjkkKzr5dxZe_11miniz_oxide7deflate4core12HuffmanOxideENtNtCshzWfHUSfYae_4core7default7Default7defaultBN_.exit
  ...
  %.lhs.trunc.i = add nuw nsw i16 %i.k, 2
  %i.l = udiv i16 %.lhs.trunc1.i, 3
  %i.m = udiv i16 %.lhs.trunc.i, 3
  %i.n = insertelement <2 x i16> poison, i16 %i.m, i64 0
  %i.o = insertelement <2 x i16> %i.n, i16 %i.l, i64 1
  %i.p = add nuw nsw <2 x i16> %i.o, splat (i16 1)
  %i.q = zext nneg <2 x i16> %i.p to <2 x i32>
  store <2 x i32> %i.q, ptr %i.i, align 8, !alias.scope !12
  %i.r = getelementptr inbounds nuw i8, ptr %i.a, i64 32
  %i.s = getelementptr inbounds nuw i8, ptr %i.a, i64 64
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.r, i8 0, i64 32, i1 false), !alias.scope !12
  store i8 32, ptr %i.s, align 8, !alias.scope !12
  ...
  %i.t = getelementptr inbounds nuw i8, ptr %0, i64 65640
  ...
  store i8 %i.h, ptr %.sroa.14.0..sroa_idx, align 2
  %.sroa.15.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 65707
  store i8 0, ptr %.sroa.15.0..sroa_idx, align 1
  %i.u = getelementptr inbounds nuw i8, ptr %0, i64 65632
  store ptr %_RNvCsiZ68L5R9VjM_7___rustc19___rust_alloc_zeroed.i, ptr %i.u, align 8
  %i.v = getelementptr inbounds nuw i8, ptr %0, i64 65560
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(72) %i.v, ptr noundef nonnull align 8 dereferenceable(72) %i.a, i64 72, i1 false)
