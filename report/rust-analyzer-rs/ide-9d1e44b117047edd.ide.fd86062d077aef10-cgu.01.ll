...
bb.q:                                             ; preds = %.lr.ph.i
  ...
  %.val4.i = load ptr, ptr %2, align 8, !noalias !5649 ; 3 uses
  %.val.i.a = load ptr, ptr %i.cp, align 8, !noalias !5652, !noundef !4 ; 2 uses
  %3 = getelementptr inbounds nuw i8, ptr %.tr717.i, i64 16
  %.val5.i = load ptr, ptr %3, align 8, !noalias !5652 ; 3 uses
  %i.cq = icmp ne ptr %.val.i, null               ; 2 uses
  %i.cr = icmp eq ptr %.val.i.a, null             ; 3 uses
  %not..i.i = xor i1 %i.cr, true
  %i.cs = xor i1 %i.cq, %i.cr
  br i1 %i.cs, label %bb.r, label %_RNvXsk_NtCslLuZgPVt6hg_3ide9runnablesNtB5_12RunnableKindNtNtCshzWfHUSfYae_4core3cmp9PartialEq2eq.exit.thread

bb.r:                                             ; preds = %bb.q
  br i1 %i.cq, label %.split16, label %_RNvXsd_NtCs4kMRW8zVVbM_3cfg8cfg_exprNtB5_7CfgExprNtNtCshzWfHUSfYae_4core3cmp9PartialEq2eq.exit

.split16:                                         ; preds = %bb.r
  tail call void @llvm.assume(i1 %not..i.i)
  %4 = icmp eq ptr %.val.i, %.val.i.a
  %i.ct = icmp eq ptr %.val4.i, %.val5.i
  %spec.select.i.i = select i1 %4, i1 %i.ct, i1 false
...
bb.s:                                             ; preds = %.lr.ph.i
  %i.cu = getelementptr inbounds nuw i8, ptr %.tr16.i, i64 16
  %i.cv = load i64, ptr %i.cu, align 8, !noalias !5649, !noundef !4 ; 2 uses
  %i.cw = getelementptr inbounds nuw i8, ptr %.tr717.i, i64 16
  %i.cx = load i64, ptr %i.cw, align 8, !noalias !5652, !noundef !4
  %i.cy = icmp eq i64 %i.cv, %i.cx
  br i1 %i.cy, label %.split17, label %_RNvXsk_NtCslLuZgPVt6hg_3ide9runnablesNtB5_12RunnableKindNtNtCshzWfHUSfYae_4core3cmp9PartialEq2eq.exit.thread

.split17:                                         ; preds = %bb.s
  %i.cz = getelementptr inbounds nuw i8, ptr %.tr717.i, i64 8
  %i.da = load ptr, ptr %i.cz, align 8, !noalias !5652, !nonnull !4, !noundef !4
  %i.db = getelementptr inbounds nuw i8, ptr %.tr16.i, i64 8
  %i.dc = load ptr, ptr %i.db, align 8, !noalias !5649, !nonnull !4, !noundef !4
  %i.dd = tail call noundef zeroext i1 @_RNvXs2_NtNtCshzWfHUSfYae_4core5slice3cmpNtNtCs4kMRW8zVVbM_3cfg8cfg_expr7CfgExprINtB5_14SlicePartialEqBC_E17equal_same_lengthCslLuZgPVt6hg_3ide(ptr noundef nonnull %i.dc, ptr noundef nonnull %i.da, i64 noundef %i.cv), !noalias !5654, !inline_history !5655
  br i1 %i.dd, label %_RNvXsd_NtCs4kMRW8zVVbM_3cfg8cfg_exprNtB5_7CfgExprNtNtCshzWfHUSfYae_4core3cmp9PartialEq2eq.exit.thread13, label %_RNvXsk_NtCslLuZgPVt6hg_3ide9runnablesNtB5_12RunnableKindNtNtCshzWfHUSfYae_4core3cmp9PartialEq2eq.exit.thread

bb.t:                                             ; preds = %.lr.ph.i
  %i.de = getelementptr inbounds nuw i8, ptr %.tr16.i, i64 16
  %i.df = load i64, ptr %i.de, align 8, !noalias !5649, !noundef !4 ; 2 uses
  %i.dg = getelementptr inbounds nuw i8, ptr %.tr717.i, i64 16
  %i.dh = load i64, ptr %i.dg, align 8, !noalias !5652, !noundef !4
  %i.di = icmp eq i64 %i.df, %i.dh
  br i1 %i.di, label %.split15, label %_RNvXsk_NtCslLuZgPVt6hg_3ide9runnablesNtB5_12RunnableKindNtNtCshzWfHUSfYae_4core3cmp9PartialEq2eq.exit.thread

.split15:                                         ; preds = %bb.t
  %i.dj = getelementptr inbounds nuw i8, ptr %.tr717.i, i64 8
  %i.dk = load ptr, ptr %i.dj, align 8, !noalias !5652, !nonnull !4, !noundef !4
  %i.dl = getelementptr inbounds nuw i8, ptr %.tr16.i, i64 8
  %i.dm = load ptr, ptr %i.dl, align 8, !noalias !5649, !nonnull !4, !noundef !4
  %i.dn = tail call noundef zeroext i1 @_RNvXs2_NtNtCshzWfHUSfYae_4core5slice3cmpNtNtCs4kMRW8zVVbM_3cfg8cfg_expr7CfgExprINtB5_14SlicePartialEqBC_E17equal_same_lengthCslLuZgPVt6hg_3ide(ptr noundef nonnull %i.dm, ptr noundef nonnull %i.dk, i64 noundef %i.df), !noalias !5654, !inline_history !5655
  br i1 %i.dn, label %_RNvXsd_NtCs4kMRW8zVVbM_3cfg8cfg_exprNtB5_7CfgExprNtNtCshzWfHUSfYae_4core3cmp9PartialEq2eq.exit.thread13, label %_RNvXsk_NtCslLuZgPVt6hg_3ide9runnablesNtB5_12RunnableKindNtNtCshzWfHUSfYae_4core3cmp9PartialEq2eq.exit.thread
...
_RNvXsd_NtCs4kMRW8zVVbM_3cfg8cfg_exprNtB5_7CfgExprNtNtCshzWfHUSfYae_4core3cmp9PartialEq2eq.exit: ; preds = %bb.r
  ...
  br i1 %5, label %_RNvXsd_NtCs4kMRW8zVVbM_3cfg8cfg_exprNtB5_7CfgExprNtNtCshzWfHUSfYae_4core3cmp9PartialEq2eq.exit.thread13, label %_RNvXsk_NtCslLuZgPVt6hg_3ide9runnablesNtB5_12RunnableKindNtNtCshzWfHUSfYae_4core3cmp9PartialEq2eq.exit.thread
...
_RNvXsd_NtCs4kMRW8zVVbM_3cfg8cfg_exprNtB5_7CfgExprNtNtCshzWfHUSfYae_4core3cmp9PartialEq2eq.exit.thread13: ; preds = %.lr.ph.i, %.split17, %.split16, %.split15, %_RNvXsd_NtCs4kMRW8zVVbM_3cfg8cfg_exprNtB5_7CfgExprNtNtCshzWfHUSfYae_4core3cmp9PartialEq2eq.exit, %bb.p
  %i.do = getelementptr inbounds nuw i8, ptr %0, i64 145
  %i.dp = load i8, ptr %i.do, align 1, !range !5618, !noundef !4
  %i.dq = getelementptr inbounds nuw i8, ptr %1, i64 145
  %i.dr = load i8, ptr %i.dq, align 1, !range !5618, !noundef !4
  %i.ds = icmp eq i8 %i.dp, %i.dr
  br i1 %i.ds, label %bb.u, label %_RNvXsk_NtCslLuZgPVt6hg_3ide9runnablesNtB5_12RunnableKindNtNtCshzWfHUSfYae_4core3cmp9PartialEq2eq.exit.thread
