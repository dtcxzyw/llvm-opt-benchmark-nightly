...
begin_hunk_0_@tg3json__stringify_value_ex:bb.a
  ...
  %i.lp = load ptr, ptr %i.kz, align 8, !tbaa !26
  %i.lq = getelementptr inbounds nuw [24 x i8], ptr %i.lp, i64 %.298252 ; 2 uses
  %i.lr = load ptr, ptr %i.lq, align 8, !tbaa !40
  store ptr %i.lr, ptr %i.lg, align 8, !tbaa !26
  %i.ls = getelementptr inbounds nuw i8, ptr %i.lq, i64 8
  %i.lt = load i64, ptr %i.ls, align 8, !tbaa !43
  store i64 %i.lt, ptr %i.lh, align 8, !tbaa !26
  %i.lu = call fastcc i32 @tg3json__stringify_value_ex(ptr noundef %0, ptr noundef nonnull %4, i32 noundef %2, i32 noundef %i.ld)
  %.not115 = icmp eq i32 %i.lu, 0
  br i1 %.not115, label %.critedge138, label %bb.bp

bb.bp:                                            ; preds = %tg3json__indent.exit154
  %i.lv = tail call fastcc i32 @tg3json__buf_putc(ptr noundef %0, i8 noundef signext 58)
  %.not116 = icmp eq i32 %i.lv, 0
  br i1 %.not116, label %.critedge138, label %bb.bq

bb.bq:                                            ; preds = %bb.bp
  br i1 %i.lc, label %bb.br, label %bb.bs

bb.br:                                            ; preds = %bb.bq
  %i.lw = tail call fastcc i32 @tg3json__buf_putc(ptr noundef %0, i8 noundef signext 32)
  %.not117 = icmp eq i32 %i.lw, 0
  br i1 %.not117, label %.critedge138, label %bb.bs

bb.bs:                                            ; preds = %bb.br, %bb.bq
  %i.lx = load ptr, ptr %i.kz, align 8, !tbaa !26
  %i.ly = getelementptr inbounds nuw [24 x i8], ptr %i.lx, i64 %.298252
  %i.lz = getelementptr inbounds nuw i8, ptr %i.ly, i64 16
  %i.ma = load ptr, ptr %i.lz, align 8, !tbaa !44
  %i.mb = tail call fastcc i32 @tg3json__stringify_value_ex(ptr noundef %0, ptr noundef %i.ma, i32 noundef %2, i32 noundef %i.ld)
  %.not118.not = icmp eq i32 %i.mb, 0
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #28
  br i1 %.not118.not, label %tg3json__indent.exit.thread, label %bb.bj

._crit_edge:                                      ; preds = %bb.bj
  %i.mc = icmp eq i64 %i.lj, 0
  %i.md = icmp slt i32 %2, 1
  %or.cond139 = or i1 %i.md, %i.mc
  br i1 %or.cond139, label %._crit_edge.thread, label %bb.bt

bb.bt:                                            ; preds = %._crit_edge
  %i.me = tail call fastcc i32 @tg3json__indent(ptr noundef %0, i32 noundef %2, i32 noundef %3)
  %.not111 = icmp eq i32 %i.me, 0
...
._crit_edge.thread:                               ; preds = %.preheader233, %bb.bt, %._crit_edge
  %i.mf = tail call fastcc i32 @tg3json__buf_putc(ptr noundef %0, i8 noundef signext 125)
...
tg3json__indent.exit.thread:                      ; preds = %bb.bs, %bb.bf, %tg3json__indent.exit, %bb.bd, %.lr.ph.i145, %bb.aq, %bb.ar, %bb.as, %bb.at, %bb.au, %bb.av, %bb.aw, %bb.ay, %bb.az, %bb.am, %bb.a, %bb.bt, %.critedge138, %bb.bi, %bb.bh, %bb.ba, %bb.ao, %bb.d, %bb.e, %._crit_edge.thread, %._crit_edge255.thread, %._crit_edge259, %bb.an, %tg3json__itoa.exit, %bb.b
  %.5 = phi i32 [ 0, %bb.bt ], [ %i.h, %bb.b ], [ 0, %bb.bh ], [ %i.az, %tg3json__itoa.exit ], [ %i.iu, %bb.an ], [ %i.is, %bb.am ], [ 0, %bb.ao ], [ %i.kb, %._crit_edge259 ], [ %i.l, %bb.e ], [ 0, %bb.a ], [ 0, %bb.aq ], [ 0, %bb.ba ], [ %i.kx, %._crit_edge255.thread ], [ 0, %bb.bf ], [ 0, %bb.bi ], [ 0, %.lr.ph.i145 ], [ %i.mf, %._crit_edge.thread ], [ 0, %.critedge138 ], [ %i.k, %bb.d ], [ 0, %bb.az ], [ 0, %bb.ay ], [ 0, %bb.aw ], [ 0, %bb.av ], [ 0, %bb.au ], [ 0, %bb.at ], [ 0, %bb.as ], [ 0, %bb.ar ], [ 0, %bb.bd ], [ 0, %tg3json__indent.exit ], [ 0, %bb.bs ]
...
end_hunk_2
begin_hunk_3_@tg3_parse_file:bb.a
  br label %bb.k
...
end_hunk_3
begin_hunk_4_@tg3_write_to_memory:bb.a
