...
.lr.ph:                                           ; preds = %bb.d
  ...
  %.promoted92 = load ptr, ptr %i.y, align 8
  br label %bb.e

bb.e:                                             ; preds = %.lr.ph, %.tg3json__init_value.exit_crit_edge.i.i
  %.pre.i.i94 = phi ptr [ %.promoted92, %.lr.ph ], [ %.pre.i.i93, %.tg3json__init_value.exit_crit_edge.i.i ] ; 12 uses
...
bb.ae:                                            ; preds = %._crit_edge.i.i.i
  ...
  %i.cx = call ptr @realloc(ptr noundef %.pre.i.i94, i64 noundef %i.cw) #29 ; 2 uses
...
.tg3json__init_value.exit_crit_edge.i.i:          ; preds = %bb.ae, %bb.ab
  %.pre.i.i93 = phi ptr [ %.pre.i.i94, %bb.ab ], [ %i.cx, %bb.ae ] ; 3 uses
  %i.cy = getelementptr inbounds nuw [24 x i8], ptr %.pre.i.i93, i64 %16
