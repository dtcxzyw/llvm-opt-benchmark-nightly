...
.preheader.i.i.a:                                 ; preds = %.preheader.i.i.a, %.preheader19.i.preheader.i
  ...
  br i1 %.not.i.i, label %iter.check320, label %.preheader.i.i.a, !llvm.loop !556
...
vector.body311:                                   ; preds = %vector.body311, %vector.ph309
  ...
  br i1 %i.bz, label %middle.block317, label %vector.body311, !llvm.loop !557
...
vec.epilog.vector.body326:                        ; preds = %vec.epilog.vector.body326, %vec.epilog.ph324
  ...
  br i1 %i.cf, label %vec.epilog.middle.block331, label %vec.epilog.vector.body326, !llvm.loop !558
