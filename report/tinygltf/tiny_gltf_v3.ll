...
vector.main.loop.iter.check:                      ; preds = %iter.check
  %min.iters.check335 = icmp ult i32 %6, 31
  br i1 %min.iters.check335, label %vec.epilog.ph, label %vector.ph

vector.ph:                                        ; preds = %vector.main.loop.iter.check
  %i.y = and i64 %8, 24
  %n.vec = and i64 %8, 8589934560                 ; 5 uses
  %9 = sub i64 %indvars.iv35.i, %n.vec
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec339 = and i64 %8, 8589934584              ; 4 uses
  %10 = sub i64 %indvars.iv35.i, %n.vec339
...
vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n345 = icmp eq i64 %8, %n.vec339
...
.preheader.i.preheader:                           ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv37.i.ph = phi i64 [ %indvars.iv35.i, %iter.check ], [ %9, %vec.epilog.iter.check ], [ %10, %vec.epilog.middle.block ]
...
.preheader.i:                                     ; preds = %.preheader.i.preheader, %.preheader.i
  ...
  %.12431.i = phi ptr [ %i.ap, %.preheader.i ], [ %.12431.i.ph, %.preheader.i.preheader ] ; 2 uses
  ...
  br i1 %12, label %.preheader.i, label %.loopexit, !llvm.loop !71
...
tg3json__itoa.exit:                               ; preds = %bb.h, %.loopexit
  ...
  %i.aq = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %i.f) #31
...
.preheader19.i.i:                                 ; preds = %.preheader19.i.i, %.preheader19.i.preheader.i
  ...
  br i1 %.not.i.i, label %.preheader.i.i, label %.preheader19.i.i, !llvm.loop !543
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i
  ...
  br i1 %.not18.i.i, label %tg3json__write_exp.exit, label %.lr.ph.i.i, !llvm.loop !544
...
vector.body250:                                   ; preds = %vector.body250, %vector.ph248
  ...
  br i1 %i.db, label %middle.block256, label %vector.body250, !llvm.loop !545
...
vec.epilog.iter.check261:                         ; preds = %middle.block256
  ...
  br i1 %min.epilog.iters.check262, label %.lr.ph98.preheader, label %vec.epilog.ph263, !prof !546
...
vec.epilog.vector.body265:                        ; preds = %vec.epilog.vector.body265, %vec.epilog.ph263
  ...
  br i1 %i.de, label %vec.epilog.middle.block270, label %vec.epilog.vector.body265, !llvm.loop !547
...
.lr.ph98.prol:                                    ; preds = %.lr.ph98.preheader, %.lr.ph98.prol
  ...
  br i1 %prol.iter353.cmp.not, label %.lr.ph98.prol.loopexit, label %.lr.ph98.prol, !llvm.loop !548
...
.lr.ph98:                                         ; preds = %.lr.ph98.prol.loopexit, %.lr.ph98
  ...
  br i1 %exitcond134.not.7, label %.preheader, label %.lr.ph98, !llvm.loop !549
...
vector.body181:                                   ; preds = %vector.body181, %vector.ph179
  ...
  br i1 %i.ez, label %middle.block187, label %vector.body181, !llvm.loop !550
...
vec.epilog.iter.check194:                         ; preds = %middle.block187
  ...
  br i1 %min.epilog.iters.check195, label %.preheader79.preheader, label %vec.epilog.ph196, !prof !546
...
vec.epilog.vector.body198:                        ; preds = %vec.epilog.vector.body198, %vec.epilog.ph196
  ...
  br i1 %i.fd, label %vec.epilog.middle.block203, label %vec.epilog.vector.body198, !llvm.loop !551
...
.preheader79.prol:                                ; preds = %.preheader79.preheader, %.preheader79.prol
  ...
  br i1 %prol.iter350.cmp.not, label %.preheader79.prol.loopexit, label %.preheader79.prol, !llvm.loop !552
...
.preheader79:                                     ; preds = %.preheader79.prol.loopexit, %.preheader79
  ...
  br i1 %exitcond123.not.3, label %.loopexit335.loopexit.unr-lcssa, label %.preheader79, !llvm.loop !553
...
iter.check228:                                    ; preds = %.loopexit335
  ...
  %min.iters.check213 = icmp ult i32 %narrow, 8
...
vector.body218:                                   ; preds = %vector.body218, %vector.ph216
  ...
  br i1 %i.gk, label %middle.block224, label %vector.body218, !llvm.loop !554

middle.block224:                                  ; preds = %vector.body218
  %cmp.n225 = icmp eq i64 %n.vec217, %5
...
vec.epilog.ph232:                                 ; preds = %vector.main.loop.iter.check214, %vec.epilog.iter.check230
  ...
  %n.vec233 = and i64 %5, 2147483640              ; 4 uses
...
vec.epilog.vector.body234:                        ; preds = %vec.epilog.vector.body234, %vec.epilog.ph232
  ...
  br i1 %i.gp, label %vec.epilog.middle.block239, label %vec.epilog.vector.body234, !llvm.loop !555

vec.epilog.middle.block239:                       ; preds = %vec.epilog.vector.body234
  %cmp.n240 = icmp eq i64 %n.vec233, %5
...
.lr.ph94:                                         ; preds = %.lr.ph94.preheader, %.lr.ph94
  ...
  %6 = trunc nuw i64 %indvars.iv.next128 to i32
  %7 = icmp sgt i32 %2, %6
  br i1 %7, label %.lr.ph94, label %.loopexit76, !llvm.loop !556
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.hf, label %middle.block, label %vector.body, !llvm.loop !557
...
vec.epilog.iter.check:                            ; preds = %middle.block
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph87.preheader, label %vec.epilog.ph, !prof !546
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.hi, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !558
...
.lr.ph87.prol:                                    ; preds = %.lr.ph87.preheader, %.lr.ph87.prol
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph87.prol.loopexit, label %.lr.ph87.prol, !llvm.loop !559
...
.lr.ph87:                                         ; preds = %.lr.ph87.prol.loopexit, %.lr.ph87
  ...
  br i1 %exitcond.not.7, label %.loopexit76, label %.lr.ph87, !llvm.loop !560
...
begin_hunk_2_@tg3__serialize_int_array:bb.a
  %.not26.i.i.i.i.i = icmp eq ptr %i.o, null
  br i1 %.not26.i.i.i.i.i, label %tg3__json_from_int_array.exit.thread, label %.tg3json__init_value.exit_crit_edge.i.i.i.i

tg3__json_from_int_array.exit.thread:             ; preds = %._crit_edge.i.i.i.i.i, %bb.e
  store i64 %i.f, ptr %i.e, align 8
  store ptr %.pre.i.i.i.i14, ptr %i.d, align 8
  call void @tg3json_value_free(ptr noundef nonnull %4)
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #28
  br label %tg3__json_set_take.exit.sink.split

.tg3json__init_value.exit_crit_edge.i.i.i.i:      ; preds = %bb.e
  %i.p = getelementptr inbounds nuw [24 x i8], ptr %i.o, i64 %i.f
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.p, ptr noundef nonnull align 8 dereferenceable(24) %4, i64 24, i1 false), !tbaa.struct !35
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #28
  %exitcond.not.i = icmp eq i64 %i.j, %wide.trip.count.i
  br i1 %exitcond.not.i, label %tg3__json_from_int_array.exit, label %bb.c, !llvm.loop !604

tg3__json_from_int_array.exit:                    ; preds = %.tg3json__init_value.exit_crit_edge.i.i.i.i
  store i64 %wide.trip.count.i, ptr %i.e, align 8
  store ptr %i.o, ptr %i.d, align 8
  %.not.i.i = icmp eq ptr %1, null
  br i1 %.not.i.i, label %tg3__json_set_take.exit.sink.split, label %tg3json_object_set_take.exit.i

tg3json_object_set_take.exit.i:                   ; preds = %tg3__json_from_int_array.exit
  %i.q = tail call i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %1) #31
  %i.r = call i32 @tg3json_object_set_take_n(ptr noundef nonnull %0, ptr noundef nonnull readonly %1, i64 noundef %i.q, ptr noundef nonnull %5)
...
; Function Attrs: nounwind memory(readwrite, target_mem: none) uwtable
define internal fastcc range(i32 0, 2) i32 @tg3__serialize_double(ptr nofree noundef nonnull captures(address_is_null) %0, ptr nofree noundef readonly captures(address_is_null) %1, double noundef %2, double noundef nofpclass(nan inf zero sub nnorm) %3, i32 noundef %4) unnamed_addr #0 {
bb.a:
  %5 = alloca %struct.tg3json_value, align 8      ; 7 uses
  %i.a = fsub double %2, %3
...
bb.b:                                             ; preds = %bb.a
  ...
  store double %2, ptr %i.e, align 8, !tbaa !26
  %.not.i.i.i = icmp eq ptr %1, null
  br i1 %.not.i.i.i, label %tg3json_object_set_take.exit.thread.i.i, label %tg3json_object_set_take.exit.i.i

tg3json_object_set_take.exit.i.i:                 ; preds = %bb.b
  %i.f = tail call i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %1) #31
  %i.g = call i32 @tg3json_object_set_take_n(ptr noundef nonnull %0, ptr noundef nonnull readonly %1, i64 noundef %i.f, ptr noundef nonnull %5)
...
; Function Attrs: nounwind memory(readwrite, target_mem: none) uwtable
define internal fastcc range(i32 0, 2) i32 @tg3__serialize_texture_info(ptr nofree noundef nonnull captures(address_is_null) %0, ptr nofree noundef readonly captures(address_is_null) %1, ptr nofree noundef readonly captures(address_is_null) %2, i32 noundef %3) unnamed_addr #0 {
bb.a:
  %4 = alloca %struct.tg3json_value, align 8      ; 8 uses
  %5 = alloca %struct.tg3json_value, align 8      ; 8 uses
  %6 = alloca %struct.tg3json_value, align 8      ; 10 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #28
  %i.a = load i32, ptr %2, align 8, !tbaa !278    ; 2 uses
  %i.b = icmp slt i32 %i.a, 0
  br i1 %i.b, label %tg3__json_set_take.exit, label %bb.b
...
bb.b:                                             ; preds = %bb.a
  ...
  store i64 %i.c, ptr %i.d, align 8, !tbaa !26
  %i.e = call i32 @tg3json_object_set_take_n(ptr noundef nonnull %6, ptr noundef nonnull readonly @.str.158, i64 noundef 5, ptr noundef nonnull %5)
  %.not.i.i = icmp eq i32 %i.e, 0
  br i1 %.not.i.i, label %tg3__json_set_int.exit.thread, label %bb.c

tg3__json_set_int.exit.thread:                    ; preds = %bb.b
  call void @tg3json_value_free(ptr noundef nonnull %5)
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #28
  br label %bb.f
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.g = load i32, ptr %i.f, align 4, !tbaa !605  ; 2 uses
  %i.h = or i32 %i.g, %3
  %or.cond.i.not = icmp eq i32 %i.h, 0
  br i1 %or.cond.i.not, label %tg3__serialize_int.exit.thread, label %bb.d
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.k = call i32 @tg3json_object_set_take_n(ptr noundef nonnull %6, ptr noundef nonnull readonly @.str.159, i64 noundef 8, ptr noundef nonnull %4)
  %.not.i.i.i = icmp eq i32 %i.k, 0
  br i1 %.not.i.i.i, label %tg3__serialize_int.exit.thread16, label %tg3__serialize_int.exit

tg3__serialize_int.exit.thread16:                 ; preds = %bb.d
  call void @tg3json_value_free(ptr noundef nonnull %4)
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #28
  br label %bb.f

tg3__serialize_int.exit:                          ; preds = %bb.d
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #28
  br label %tg3__serialize_int.exit.thread

tg3__serialize_int.exit.thread:                   ; preds = %bb.c, %tg3__serialize_int.exit
  %i.l = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.m = call fastcc i32 @tg3__serialize_extras_ext(ptr noundef %6, ptr noundef nonnull %i.l)
  %.not8 = icmp eq i32 %i.m, 0
  br i1 %.not8, label %bb.f, label %bb.e

bb.e:                                             ; preds = %tg3__serialize_int.exit.thread
  %.not.i.i10 = icmp eq ptr %1, null
  br i1 %.not.i.i10, label %tg3__json_set_take.exit.thread, label %tg3json_object_set_take.exit.i

tg3json_object_set_take.exit.i:                   ; preds = %bb.e
  %i.n = call i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %1) #31
  %i.o = call i32 @tg3json_object_set_take_n(ptr noundef nonnull %0, ptr noundef nonnull readonly %1, i64 noundef %i.n, ptr noundef nonnull %6)
  %.not.i = icmp eq i32 %i.o, 0
  br i1 %.not.i, label %tg3__json_set_take.exit.thread, label %tg3__json_set_take.exit

tg3__json_set_take.exit.thread:                   ; preds = %bb.e, %tg3json_object_set_take.exit.i
  call void @tg3json_value_free(ptr noundef nonnull %6)
  br label %bb.f

bb.f:                                             ; preds = %tg3__json_set_take.exit.thread, %tg3__serialize_int.exit.thread16, %tg3__json_set_int.exit.thread, %tg3__serialize_int.exit.thread
  call void @tg3json_value_free(ptr noundef nonnull %6)
  br label %tg3__json_set_take.exit

tg3__json_set_take.exit:                          ; preds = %tg3json_object_set_take.exit.i, %bb.a, %bb.f
  %.0 = phi i32 [ 0, %bb.f ], [ 1, %bb.a ], [ 1, %tg3json_object_set_take.exit.i ]
...
!82 = distinct !{!82, !31}
!83 = !{!84, !7, i64 16}
!84 = !{!"tg3_error_stack", !85, i64 0, !7, i64 8, !7, i64 12, !7, i64 16}
!85 = !{!"p1 _ZTS15tg3_error_entry", !12, i64 0}
!86 = !{!84, !7, i64 8}
!87 = !{!84, !85, i64 0}
!88 = !{!89, !7, i64 0}
!89 = !{!"tg3_parse_options", !7, i64 0, !7, i64 4, !90, i64 8, !92, i64 64, !93, i64 120, !94, i64 144, !95, i64 168, !12, i64 176, !12, i64 184, !7, i64 192, !7, i64 196, !7, i64 200, !7, i64 204, !7, i64 208, !7, i64 212, !7, i64 216, !15, i64 224}
!90 = !{!"tg3_memory_config", !15, i64 0, !15, i64 8, !7, i64 16, !91, i64 24}
!91 = !{!"tg3_allocator", !12, i64 0, !12, i64 8, !12, i64 16, !12, i64 24}
!92 = !{!"tg3_fs_callbacks", !12, i64 0, !12, i64 8, !12, i64 16, !12, i64 24, !12, i64 32, !12, i64 40, !12, i64 48}
!93 = !{!"tg3_uri_callbacks", !12, i64 0, !12, i64 8, !12, i64 16}
!94 = !{!"tg3_image_callbacks", !12, i64 0, !12, i64 8, !12, i64 16}
!95 = !{!"p1 _ZTS20tg3_stream_callbacks", !12, i64 0}
!96 = !{!89, !7, i64 4}
!97 = !{!89, !15, i64 8}
!98 = !{!89, !7, i64 24}
!99 = !{!89, !15, i64 224}
!100 = !{!89, !7, i64 216}
!101 = !{!102, !7, i64 0}
!102 = !{!"tg3_write_options", !7, i64 0, !7, i64 4, !7, i64 8, !7, i64 12, !7, i64 16, !92, i64 24, !93, i64 80, !90, i64 104}
!103 = !{!102, !15, i64 104}
!104 = !{!102, !7, i64 120}
!105 = !{!106, !7, i64 40}
!106 = !{!"tg3_buffer_view", !107, i64 0, !7, i64 16, !15, i64 24, !15, i64 32, !7, i64 40, !7, i64 44, !7, i64 48, !108, i64 56}
!107 = !{!"tg3_str", !11, i64 0, !7, i64 8}
!108 = !{!"tg3_extras_ext", !109, i64 0, !110, i64 8, !7, i64 16, !107, i64 24, !107, i64 40}
!109 = !{!"p1 _ZTS9tg3_value", !12, i64 0}
!110 = !{!"p1 _ZTS13tg3_extension", !12, i64 0}
!111 = !{!112, !7, i64 36}
!112 = !{!"tg3_accessor", !107, i64 0, !7, i64 16, !15, i64 24, !7, i64 32, !7, i64 36, !15, i64 40, !7, i64 48, !113, i64 56, !7, i64 64, !113, i64 72, !7, i64 80, !114, i64 88, !108, i64 296}
!113 = !{!"p1 double", !12, i64 0}
!114 = !{!"tg3_accessor_sparse", !7, i64 0, !7, i64 4, !115, i64 8, !116, i64 80, !108, i64 152}
!115 = !{!"tg3_accessor_sparse_indices", !15, i64 0, !7, i64 8, !7, i64 12, !108, i64 16}
!116 = !{!"tg3_accessor_sparse_values", !7, i64 0, !15, i64 8, !108, i64 16}
!117 = !{!112, !7, i64 48}
!118 = !{!119, !7, i64 260}
!119 = !{!"tg3_model", !120, i64 0, !121, i64 8, !7, i64 16, !122, i64 24, !7, i64 32, !123, i64 40, !7, i64 48, !124, i64 56, !7, i64 64, !125, i64 72, !7, i64 80, !126, i64 88, !7, i64 96, !127, i64 104, !7, i64 112, !128, i64 120, !7, i64 128, !129, i64 136, !7, i64 144, !130, i64 152, !7, i64 160, !131, i64 168, !7, i64 176, !132, i64 184, !7, i64 192, !133, i64 200, !7, i64 208, !134, i64 216, !7, i64 224, !135, i64 232, !7, i64 240, !136, i64 248, !7, i64 256, !7, i64 260, !137, i64 264, !7, i64 272, !137, i64 280, !7, i64 288, !138, i64 296, !108, i64 416}
!120 = !{!"p1 _ZTS9tg3_arena", !12, i64 0}
!121 = !{!"p1 _ZTS12tg3_accessor", !12, i64 0}
!122 = !{!"p1 _ZTS13tg3_animation", !12, i64 0}
!123 = !{!"p1 _ZTS10tg3_buffer", !12, i64 0}
!124 = !{!"p1 _ZTS15tg3_buffer_view", !12, i64 0}
!125 = !{!"p1 _ZTS12tg3_material", !12, i64 0}
!126 = !{!"p1 _ZTS8tg3_mesh", !12, i64 0}
!127 = !{!"p1 _ZTS8tg3_node", !12, i64 0}
!128 = !{!"p1 _ZTS11tg3_texture", !12, i64 0}
!129 = !{!"p1 _ZTS9tg3_image", !12, i64 0}
!130 = !{!"p1 _ZTS8tg3_skin", !12, i64 0}
!131 = !{!"p1 _ZTS11tg3_sampler", !12, i64 0}
!132 = !{!"p1 _ZTS10tg3_camera", !12, i64 0}
!133 = !{!"p1 _ZTS9tg3_scene", !12, i64 0}
!134 = !{!"p1 _ZTS9tg3_light", !12, i64 0}
!135 = !{!"p1 _ZTS17tg3_audio_emitter", !12, i64 0}
!136 = !{!"p1 _ZTS16tg3_audio_source", !12, i64 0}
!137 = !{!"p1 _ZTS7tg3_str", !12, i64 0}
!138 = !{!"tg3_asset", !107, i64 0, !107, i64 16, !107, i64 32, !107, i64 48, !108, i64 64}
!139 = !{!90, !12, i64 24}
!140 = distinct !{null}
!141 = !{!84, !7, i64 12}
!142 = !{!143, !7, i64 0}
!143 = !{!"tg3_error_entry", !7, i64 0, !7, i64 4, !11, i64 8, !11, i64 16, !15, i64 24}
!144 = !{!143, !7, i64 4}
!145 = !{!143, !11, i64 8}
!146 = !{!143, !11, i64 16}
!147 = !{!143, !15, i64 24}
...
!150 = !{!90, !15, i64 8}
!151 = !{!152, !15, i64 40}
!152 = !{!"tg3_arena", !153, i64 0, !153, i64 8, !15, i64 16, !15, i64 24, !15, i64 32, !15, i64 40, !91, i64 48}
!153 = !{!"p1 _ZTS16tg3__arena_block", !12, i64 0}
!154 = !{!152, !15, i64 24}
!155 = !{!152, !15, i64 32}
!156 = !{!119, !120, i64 0}
!157 = !{!18, !15, i64 8}
