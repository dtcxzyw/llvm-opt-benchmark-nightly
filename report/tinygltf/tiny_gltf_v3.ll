...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %.not.i13.i.i.i, label %tg3__serialize_str.exit.thread34, label %bb.c
...
tg3json_object_set_take.exit.thread.i.i.i:        ; preds = %bb.c
  call void @tg3json_value_free(ptr noundef nonnull %11)
  br label %tg3__serialize_str.exit.thread34

tg3__serialize_str.exit.thread34:                 ; preds = %tg3json_object_set_take.exit.thread.i.i.i, %bb.b
  call void @llvm.lifetime.end.p0(ptr nonnull %11) #28
  br label %bb.ai
...
._crit_edge:                                      ; preds = %.tg3json__init_value.exit_crit_edge.i.i
  ...
  store ptr %.pre.i.i94, ptr %i.y, align 8
  ...
  %.not.i30 = icmp eq i32 %i.dc, 0
  br i1 %.not.i30, label %bb.ag, label %tg3__json_set_take.exit
...
bb.ai:                                            ; preds = %bb.af, %tg3__serialize_str.exit.thread34, %tg3__json_set_take.exit, %bb.ah, %bb.ag
  call void @tg3json_value_free(ptr noundef nonnull %2)
  br label %bb.aj
