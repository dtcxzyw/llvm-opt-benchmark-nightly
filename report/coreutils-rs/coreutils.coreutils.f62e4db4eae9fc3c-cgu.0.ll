...
begin_hunk_0_@_RINvCsgzkSwV7OBv7_7uu_head6uumainINtNtNtNtCs6JMX4GRUq9U_4core4iter8adapters5chain5ChainINtNtNtCs7tKScEop1B6_5alloc3vec9into_iter8IntoIterNtNtNtCs2vKOLqTMYjT_3std3ffi6os_str8OsStringEINtNtBA_6cloned6ClonedINtNtNtBE_5slice4iter4IterB2b_EEEECsl8pJiQOn4hA_9coreutils:bb.a
  ...
  %.val1.i.i = load ptr, ptr %i.ks, align 8, !alias.scope !15174, !nonnull !12, !noundef !12
  call void @_RNvCsjSVV5GABoor_7___rustc14___rust_dealloc(ptr noundef nonnull %.val1.i.i, i64 noundef %.val.i.i, i64 noundef range(i64 1, -9223372036854775807) 1) #45, !noalias !15174
...
_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueNtNtCs7tKScEop1B6_5alloc6string6StringECsl8pJiQOn4hA_9coreutils.exit: ; preds = %bb.cs, %bb.ct
  ...
  call void @llvm.experimental.noalias.scope.decl(metadata !15175)
  %i.kt = load ptr, ptr %i.hv, align 8, !alias.scope !15175, !nonnull !12, !align !23, !noundef !12 ; 3 uses
  %i.ku = load ptr, ptr %i.kt, align 8, !invariant.load !12, !noalias !15175 ; 2 uses
...
bb.cu:                                            ; preds = %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueNtNtCs7tKScEop1B6_5alloc6string6StringECsl8pJiQOn4hA_9coreutils.exit
  %i.kv = load ptr, ptr %i.aq, align 8, !alias.scope !15175, !nonnull !12, !noundef !12
  call void %i.ku(ptr noundef nonnull %i.kv) #51, !noalias !15175, !inline_history !24
  br label %bb.cv
...
bb.cv:                                            ; preds = %bb.cu, %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueNtNtCs7tKScEop1B6_5alloc6string6StringECsl8pJiQOn4hA_9coreutils.exit
  ...
  %i.kx = load i64, ptr %i.kw, align 8, !range !19, !invariant.load !12, !noalias !15175 ; 2 uses
...
_RNvXs_NtCs7tKScEop1B6_5alloc5allocNtB4_6GlobalNtNtCs6JMX4GRUq9U_4core5alloc9Allocator10deallocate.exit.i.i: ; preds = %bb.cv
  %.val.i = load ptr, ptr %i.aq, align 8, !alias.scope !15175, !nonnull !12, !noundef !12
  %i.kz = getelementptr inbounds nuw i8, ptr %i.kt, i64 16
  %i.la = load i64, ptr %i.kz, align 8, !range !25, !invariant.load !12, !noalias !15175
  call void @_RNvCsjSVV5GABoor_7___rustc14___rust_dealloc(ptr noundef nonnull %.val.i, i64 noundef %i.kx, i64 noundef range(i64 1, -9223372036854775807) %i.la) #45, !noalias !15175
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  br i1 %.not.i, label %_RNvMNtCs6JMX4GRUq9U_4core6resultINtB2_6ResultuNtNtNtCsqsXNUdQJE7_3nix5errno6consts5ErrnoE6expectCsl8pJiQOn4hA_9coreutils.exit, label %bb.d, !prof !11

bb.d:                                             ; preds = %bb.c
  call void @llvm.lifetime.start.p0(ptr nonnull %i.y), !noalias !15317
  store i32 %i.an, ptr %i.y, align 4, !noalias !15317
...
_RNvMNtCs6JMX4GRUq9U_4core6resultINtB2_6ResultuNtNtNtCsqsXNUdQJE7_3nix5errno6consts5ErrnoE6expectCsl8pJiQOn4hA_9coreutils.exit: ; preds = %bb.c
  call void @llvm.lifetime.start.p0(ptr nonnull %i.x), !noalias !15318
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.w), !noalias !15318
  %i.ao = getelementptr inbounds nuw i8, ptr %i.x, i64 8 ; 3 uses
  %i.ap = load ptr, ptr %i.ao, align 8, !noalias !15318, !nonnull !12, !noundef !12 ; 3 uses
  %i.aq = getelementptr inbounds nuw i8, ptr %i.x, i64 16 ; 3 uses
  %i.ar = load i64, ptr %i.aq, align 8, !noalias !15318, !noundef !12 ; 3 uses
  call void @_RNvCshDScVpnq8df_5uu_pr18recreate_arguments(ptr noalias nofree noundef nonnull sret([24 x i8]) align 8 captures(address) dereferenceable(24) %i.w, ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) %i.ap, i64 noundef %i.ar) #45, !noalias !15318
  call void @llvm.lifetime.start.p0(ptr nonnull %i.v), !noalias !15318
  call void @_RNvCshDScVpnq8df_5uu_pr6uu_app(ptr noalias nofree noundef nonnull sret([712 x i8]) align 8 captures(none) dereferenceable(712) %i.v) #45, !noalias !15318
  call void @llvm.lifetime.start.p0(ptr nonnull %i.u), !noalias !15318
  call void @llvm.lifetime.start.p0(ptr nonnull %i.t), !noalias !15318
  ...
  %i.as = load i64, ptr %i.t, align 8, !range !13, !noalias !15318, !noundef !12 ; 2 uses
  %i.at = icmp eq i64 %i.as, -1
  %i.au = getelementptr inbounds nuw i8, ptr %i.t, i64 8
  %i.av = load ptr, ptr %i.au, align 8, !noalias !15318 ; 2 uses
  %i.aw = getelementptr inbounds nuw i8, ptr %i.t, i64 16
  %i.ax = load ptr, ptr %i.aw, align 8, !noalias !15318 ; 2 uses
...
bb.e:                                             ; preds = %_RNvMNtCs6JMX4GRUq9U_4core6resultINtB2_6ResultuNtNtNtCsqsXNUdQJE7_3nix5errno6consts5ErrnoE6expectCsl8pJiQOn4hA_9coreutils.exit
  call void @llvm.lifetime.end.p0(ptr nonnull %i.t), !noalias !15318
  br label %bb.ao
...
bb.f:                                             ; preds = %_RNvMNtCs6JMX4GRUq9U_4core6resultINtB2_6ResultuNtNtNtCsqsXNUdQJE7_3nix5errno6consts5ErrnoE6expectCsl8pJiQOn4hA_9coreutils.exit
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.610.0..sroa_idx.i, ptr noundef nonnull align 8 dereferenceable(32) %.sroa.632.0..sroa_idx.i, i64 32, i1 false), !noalias !15318
  call void @llvm.lifetime.end.p0(ptr nonnull %i.t), !noalias !15318
  store i64 %i.as, ptr %i.u, align 8, !noalias !15318
  %.sroa.4.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.u, i64 8
  store ptr %i.av, ptr %.sroa.4.0..sroa_idx.i, align 8, !noalias !15318
  %.sroa.59.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.u, i64 16
  store ptr %i.ax, ptr %.sroa.59.0..sroa_idx.i, align 8, !noalias !15318
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.6.i)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.m), !noalias !15318
  call fastcc void @_RINvMs0_NtNtNtCsgNwXemyrBWj_12clap_builder6parser7matches11arg_matchesNtB6_10ArgMatches12try_get_manyNtNtCs7tKScEop1B6_5alloc6string6StringECsl8pJiQOn4hA_9coreutils(ptr noalias nofree noundef align 8 captures(none) dereferenceable(72) %i.m, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(56) %i.u, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) @403, i64 noundef 5) #45, !noalias !15318
  call void @llvm.experimental.noalias.scope.decl(metadata !15319)
  call void @llvm.experimental.noalias.scope.decl(metadata !15320)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.k), !noalias !15318
  store ptr @403, ptr %i.k, align 8, !noalias !15321
  %i.ay = getelementptr inbounds nuw i8, ptr %i.k, i64 8
  store i64 5, ptr %i.ay, align 8, !noalias !15321
  call void @llvm.lifetime.start.p0(ptr nonnull %i.j), !noalias !15321
  %i.az = load i64, ptr %i.m, align 8, !range !16, !alias.scope !15320, !noalias !15322, !noundef !12
  %i.ba = trunc nuw i64 %i.az to i1
  %i.bb = getelementptr inbounds nuw i8, ptr %i.m, i64 8 ; 2 uses
  br i1 %i.ba, label %bb.g, label %_RINvMNtNtCsgNwXemyrBWj_12clap_builder6parser5errorNtB3_12MatchesError6unwrapINtNtCs6JMX4GRUq9U_4core6option6OptionINtNtNtB5_7matches11arg_matches9ValuesRefNtNtCs7tKScEop1B6_5alloc6string6StringEEECsl8pJiQOn4hA_9coreutils.exit.i, !prof !18

bb.g:                                             ; preds = %bb.f
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(40) %i.j, ptr noundef nonnull readonly align 8 dereferenceable(40) %i.bb, i64 40, i1 false), !noalias !15322
  call void @llvm.lifetime.start.p0(ptr nonnull %i.i), !noalias !15321
  store ptr %i.k, ptr %i.i, align 8, !noalias !15321
  %.sroa.42.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.i, i64 8
  store ptr @_RNvXs1i_NtCs6JMX4GRUq9U_4core3fmtReNtB6_7Display3fmtCsl8pJiQOn4hA_9coreutils, ptr %.sroa.42.0..sroa_idx.i.i, align 8, !noalias !15321
  %i.bc = getelementptr inbounds nuw i8, ptr %i.i, i64 16
  store ptr %i.j, ptr %i.bc, align 8, !noalias !15321
  %.sroa.46.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.i, i64 24
  store ptr @_RNvXs0_NtNtCsgNwXemyrBWj_12clap_builder6parser5errorNtB5_12MatchesErrorNtNtCs6JMX4GRUq9U_4core3fmt7Display3fmt, ptr %.sroa.46.0..sroa_idx.i.i, align 8, !noalias !15321
  call void @_RNvNtCs6JMX4GRUq9U_4core9panicking9panic_fmt(ptr noundef nonnull @226, ptr noundef nonnull %i.i, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @228) #50, !noalias !15323
  unreachable
...
_RINvMNtNtCsgNwXemyrBWj_12clap_builder6parser5errorNtB3_12MatchesError6unwrapINtNtCs6JMX4GRUq9U_4core6option6OptionINtNtNtB5_7matches11arg_matches9ValuesRefNtNtCs7tKScEop1B6_5alloc6string6StringEEECsl8pJiQOn4hA_9coreutils.exit.i: ; preds = %bb.f
  %.sroa.0.0.copyload68.i = load ptr, ptr %i.bb, align 8, !alias.scope !15324, !noalias !15325 ; 2 uses
  %.sroa.6.0..sroa_idx69.i = getelementptr inbounds nuw i8, ptr %i.m, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(56) %.sroa.6.i, ptr noundef nonnull align 8 dereferenceable(56) %.sroa.6.0..sroa_idx69.i, i64 56, i1 false), !alias.scope !15324, !noalias !15325
  call void @llvm.lifetime.end.p0(ptr nonnull %i.j), !noalias !15321
  call void @llvm.lifetime.end.p0(ptr nonnull %i.k), !noalias !15318
  call void @llvm.lifetime.end.p0(ptr nonnull %i.m), !noalias !15318
  %.not.i28 = icmp eq ptr %.sroa.0.0.copyload68.i, null
  br i1 %.not.i28, label %bb.i, label %bb.h, !prof !18
...
bb.h:                                             ; preds = %_RINvMNtNtCsgNwXemyrBWj_12clap_builder6parser5errorNtB3_12MatchesError6unwrapINtNtCs6JMX4GRUq9U_4core6option6OptionINtNtNtB5_7matches11arg_matches9ValuesRefNtNtCs7tKScEop1B6_5alloc6string6StringEEECsl8pJiQOn4hA_9coreutils.exit.i
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.h), !noalias !15326
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(56) %.sroa.495.0..sroa_idx.i, ptr noundef nonnull align 8 dereferenceable(56) %.sroa.6.i, i64 56, i1 false), !noalias !15318
  call void @llvm.lifetime.start.p0(ptr nonnull %i.l), !noalias !15318
  store ptr %.sroa.0.0.copyload68.i, ptr %i.h, align 8, !noalias !15327
  call fastcc void @_RNvXNtNtCs7tKScEop1B6_5alloc3vec21spec_from_iter_nestedINtB4_3VecReEINtB2_18SpecFromIterNestedB11_INtNtNtNtCs6JMX4GRUq9U_4core4iter8adapters3map3MapINtNtNtNtCsgNwXemyrBWj_12clap_builder6parser7matches11arg_matches9ValuesRefNtNtB6_6string6StringENvMB3B_B3z_6as_strEE9from_iterCsl8pJiQOn4hA_9coreutils(ptr noalias nofree noundef nonnull align 8 captures(none) dereferenceable(24) %i.l, ptr noalias nofree noundef align 8 captures(address) dereferenceable(64) %i.h) #45, !noalias !15328
  call void @llvm.lifetime.end.p0(ptr nonnull %i.h), !noalias !15326
  %.sroa.018.0.copyload.i = load i64, ptr %i.l, align 8, !noalias !15318 ; 4 uses
  %.sroa.419.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.l, i64 8
  %.sroa.419.0.copyload.i = load ptr, ptr %.sroa.419.0..sroa_idx.i, align 8, !noalias !15318 ; 5 uses
  %.sroa.520.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.l, i64 16
  %.sroa.520.0.copyload.i = load i64, ptr %.sroa.520.0..sroa_idx.i, align 8, !noalias !15318 ; 8 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.l), !noalias !15318
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.6.i)
  %i.bd = call noundef zeroext i1 @_RNvMNtNtNtCsgNwXemyrBWj_12clap_builder6parser7matches11arg_matchesNtB2_10ArgMatches8get_flag(ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(56) %i.u, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) @602, i64 noundef 5) #45, !noalias !15318
...
bb.i:                                             ; preds = %_RINvMNtNtCsgNwXemyrBWj_12clap_builder6parser5errorNtB3_12MatchesError6unwrapINtNtCs6JMX4GRUq9U_4core6option6OptionINtNtNtB5_7matches11arg_matches9ValuesRefNtNtCs7tKScEop1B6_5alloc6string6StringEEECsl8pJiQOn4hA_9coreutils.exit.i
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.6.i)
  call void @_RNvNtCs6JMX4GRUq9U_4core6option13unwrap_failed(ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @628) #50, !noalias !15318
  unreachable
...
bb.j:                                             ; preds = %bb.h
  ...
  br i1 %or.cond.i.i.i.i.i, label %bb.m, label %bb.k, !prof !27
...
bb.l:                                             ; preds = %bb.k
  call void @_RNvCsjSVV5GABoor_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #45, !noalias !15329
  %i.bj = call noundef align 8 ptr @_RNvCsjSVV5GABoor_7___rustc12___rust_alloc(i64 noundef range(i64 0, -9223372036854775808) %i.bh, i64 noundef range(i64 1, 9) 8) #45, !noalias !15329 ; 3 uses
...
bb.m:                                             ; preds = %bb.l, %bb.j
  ...
  call void @_RNvNtCs7tKScEop1B6_5alloc7raw_vec12handle_error(i64 noundef %.sroa.4.0.ph.i.i.i.i, i64 %.sroa.10.0.ph.i.i.i.i) #52, !noalias !15330
  unreachable
...
_RNCINvNtNtNtCs6JMX4GRUq9U_4core4iter8adapters3map8map_foldReINtNtCs7tKScEop1B6_5alloc3vec3VecBU_EuNCINvNvCshDScVpnq8df_5uu_pr6uumain6uumainINtNtB6_5chain5ChainINtNtBZ_9into_iter8IntoIterNtNtNtCs2vKOLqTMYjT_3std3ffi6os_str8OsStringEINtNtB6_6cloned6ClonedINtNtNtBa_5slice4iter4IterB2Y_EEEEs_0NCINvNvNtNtNtB8_6traits8iterator8Iterator8for_each4callBW_NCINvMsk_BZ_IBX_BW_E14extend_trustedINtB4_3MapIB2y_BU_EB1y_EE0E0E0Csl8pJiQOn4hA_9coreutils.exit.i.i.i.i.i.i.i.i: ; preds = %.lr.ph.i.i.i.i.i.i.i.i
  ...
  store ptr %i.bn, ptr %i.bq, align 8, !noalias !15332
  %i.bt = getelementptr inbounds nuw i8, ptr %i.bq, i64 8
  store i64 %i.bp, ptr %i.bt, align 8, !noalias !15333
  %i.bu = getelementptr inbounds nuw [24 x i8], ptr %i.bj, i64 %i.bl ; 3 uses
  store i64 1, ptr %i.bu, align 8, !noalias !15334
  %.sroa.42.0..sroa_idx.i.i.i.i.i.i.i.i.i = getelementptr inbounds nuw i8, ptr %i.bu, i64 8
  store ptr %i.bq, ptr %.sroa.42.0..sroa_idx.i.i.i.i.i.i.i.i.i, align 8, !noalias !15334
  %.sroa.53.0..sroa_idx.i.i.i.i.i.i.i.i.i = getelementptr inbounds nuw i8, ptr %i.bu, i64 16
  store i64 1, ptr %.sroa.53.0..sroa_idx.i.i.i.i.i.i.i.i.i, align 8, !noalias !15334
...
bb.o:                                             ; preds = %._crit_edge.i.i.i.i.i.i.i.i
  ...
  call void @_RNvCsjSVV5GABoor_7___rustc14___rust_dealloc(ptr noundef nonnull %.sroa.419.0.copyload.i, i64 noundef %i.bx, i64 noundef range(i64 1, -9223372036854775807) 8) #45, !noalias !15331
...
bb.p:                                             ; preds = %bb.h
  call void @_RNvCsjSVV5GABoor_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #45, !noalias !15318
  %i.by = call noundef align 8 dereferenceable_or_null(24) ptr @_RNvCsjSVV5GABoor_7___rustc12___rust_alloc(i64 noundef 24, i64 noundef range(i64 1, -9223372036854775807) 8) #45, !noalias !15318 ; 5 uses
  %i.bz = icmp eq ptr %i.by, null
  br i1 %i.bz, label %bb.q, label %_RNvNtCs7tKScEop1B6_5alloc5boxed14box_new_uninit.exit.i, !prof !15

bb.q:                                             ; preds = %bb.p
  call void @_RNvNtCs7tKScEop1B6_5alloc5alloc18handle_alloc_error(i64 noundef 8, i64 noundef 24) #52, !noalias !15318
  unreachable

_RNvNtCs7tKScEop1B6_5alloc5boxed14box_new_uninit.exit.i: ; preds = %bb.p
  store i64 %.sroa.018.0.copyload.i, ptr %i.by, align 8, !noalias !15318
  %.sroa.613.0..sroa_idx14.i = getelementptr inbounds nuw i8, ptr %i.by, i64 8
  store ptr %.sroa.419.0.copyload.i, ptr %.sroa.613.0..sroa_idx14.i, align 8, !noalias !15318
  %.sroa.7.0..sroa_idx16.i = getelementptr inbounds nuw i8, ptr %i.by, i64 16
  store i64 %.sroa.520.0.copyload.i, ptr %.sroa.7.0..sroa_idx16.i, align 8, !noalias !15318
  br label %_RNvXs_NtNtCs7tKScEop1B6_5alloc3vec16in_place_collectINtB6_3VecIBP_ReEEINtNtB6_14spec_from_iter12SpecFromIterBY_INtNtNtNtCs6JMX4GRUq9U_4core4iter8adapters3map3MapINtNtB6_9into_iter8IntoIterB12_ENCINvNvCshDScVpnq8df_5uu_pr6uumain6uumainINtNtB1Q_5chain5ChainIB2A_NtNtNtCs2vKOLqTMYjT_3std3ffi6os_str8OsStringEINtNtB1Q_6cloned6ClonedINtNtNtB1U_5slice4iter4IterB4a_EEEEs_0EE9from_iterCsl8pJiQOn4hA_9coreutils.exit.i
...
_RNvXs_NtNtCs7tKScEop1B6_5alloc3vec16in_place_collectINtB6_3VecIBP_ReEEINtNtB6_14spec_from_iter12SpecFromIterBY_INtNtNtNtCs6JMX4GRUq9U_4core4iter8adapters3map3MapINtNtB6_9into_iter8IntoIterB12_ENCINvNvCshDScVpnq8df_5uu_pr6uumain6uumainINtNtB1Q_5chain5ChainIB2A_NtNtNtCs2vKOLqTMYjT_3std3ffi6os_str8OsStringEINtNtB1Q_6cloned6ClonedINtNtNtB1U_5slice4iter4IterB4a_EEEEs_0EE9from_iterCsl8pJiQOn4hA_9coreutils.exit.i: ; preds = %_RNvNtCs7tKScEop1B6_5alloc5boxed14box_new_uninit.exit.i, %bb.o, %._crit_edge.i.i.i.i.i.i.i.i
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.s), !noalias !15318
  call void @_RNvCshDScVpnq8df_5uu_pr26parse_column_page_operands(ptr noalias nofree noundef nonnull sret([48 x i8]) align 8 captures(none) dereferenceable(48) %i.s, ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) %i.ap, i64 noundef %i.ar) #45, !noalias !15318
...
_RNvXs4_NtNtCs7tKScEop1B6_5alloc3vec9into_iterINtB5_8IntoIterINtB7_3VecReEENtNtNtNtCs6JMX4GRUq9U_4core4iter6traits8iterator8Iterator4nextCsl8pJiQOn4hA_9coreutils.exit.i: ; preds = %_RNvXs_NtNtCs7tKScEop1B6_5alloc3vec16in_place_collectINtB6_3VecIBP_ReEEINtNtB6_14spec_from_iter12SpecFromIterBY_INtNtNtNtCs6JMX4GRUq9U_4core4iter8adapters3map3MapINtNtB6_9into_iter8IntoIterB12_ENCINvNvCshDScVpnq8df_5uu_pr6uumain6uumainINtNtB1Q_5chain5ChainIB2A_NtNtNtCs2vKOLqTMYjT_3std3ffi6os_str8OsStringEINtNtB1Q_6cloned6ClonedINtNtNtB1U_5slice4iter4IterB4a_EEEEs_0EE9from_iterCsl8pJiQOn4hA_9coreutils.exit.i, %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueINtNtCs7tKScEop1B6_5alloc3vec3VecReEECsl8pJiQOn4hA_9coreutils.exit.i
  ...
  %.sroa.078.0.copyload79.i = load i64, ptr %.sroa.676.0112.i, align 8, !noalias !15335 ; 5 uses
  %.sroa.880.0..sroa.676.8..sroa_idx.i = getelementptr inbounds nuw i8, ptr %.sroa.676.0112.i, i64 8
  %.sroa.880.sroa.0.0.copyload.i = load ptr, ptr %.sroa.880.0..sroa.676.8..sroa_idx.i, align 8, !noalias !15335 ; 7 uses
  %.sroa.880.sroa.6.0..sroa.880.0..sroa.676.8..sroa_idx.sroa_idx.i = getelementptr inbounds nuw i8, ptr %.sroa.676.0112.i, i64 16
  %.sroa.880.sroa.6.0.copyload.i = load i64, ptr %.sroa.880.sroa.6.0..sroa.880.0..sroa.676.8..sroa_idx.sroa_idx.i, align 8, !noalias !15335 ; 3 uses
...
bb.r:                                             ; preds = %_RNvXs4_NtNtCs7tKScEop1B6_5alloc3vec9into_iterINtB5_8IntoIterINtB7_3VecReEENtNtNtNtCs6JMX4GRUq9U_4core4iter6traits8iterator8Iterator4nextCsl8pJiQOn4hA_9coreutils.exit.i
  call void @llvm.lifetime.start.p0(ptr nonnull %i.r), !noalias !15318
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.880.sroa.0.0.copyload.i) ]
  call void @_RNvCshDScVpnq8df_5uu_pr13build_options(ptr noalias nofree noundef nonnull sret([320 x i8]) align 8 captures(none) dereferenceable(320) %i.r, ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(56) %i.u, ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) %.sroa.880.sroa.0.0.copyload.i, i64 noundef %.sroa.880.sroa.6.0.copyload.i, ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(48) %i.s) #45, !noalias !15318
  call void @llvm.lifetime.start.p0(ptr nonnull %i.q), !noalias !15318
  %i.ce = load i64, ptr %i.r, align 8, !range !26, !noalias !15318, !noundef !12
...
_RNvXs4_NtNtCs7tKScEop1B6_5alloc3vec9into_iterINtB5_8IntoIterINtB7_3VecReEENtNtNtNtCs6JMX4GRUq9U_4core4iter6traits8iterator8Iterator4nextCsl8pJiQOn4hA_9coreutils.exit.thread.i: ; preds = %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueINtNtCs7tKScEop1B6_5alloc3vec3VecReEECsl8pJiQOn4hA_9coreutils.exit.i, %_RNvXs4_NtNtCs7tKScEop1B6_5alloc3vec9into_iterINtB5_8IntoIterINtB7_3VecReEENtNtNtNtCs6JMX4GRUq9U_4core4iter6traits8iterator8Iterator4nextCsl8pJiQOn4hA_9coreutils.exit.i, %_RNvXs_NtNtCs7tKScEop1B6_5alloc3vec16in_place_collectINtB6_3VecIBP_ReEEINtNtB6_14spec_from_iter12SpecFromIterBY_INtNtNtNtCs6JMX4GRUq9U_4core4iter8adapters3map3MapINtNtB6_9into_iter8IntoIterB12_ENCINvNvCshDScVpnq8df_5uu_pr6uumain6uumainINtNtB1Q_5chain5ChainIB2A_NtNtNtCs2vKOLqTMYjT_3std3ffi6os_str8OsStringEINtNtB1Q_6cloned6ClonedINtNtNtB1U_5slice4iter4IterB4a_EEEEs_0EE9from_iterCsl8pJiQOn4hA_9coreutils.exit.i
  ...
  call void @llvm.experimental.noalias.scope.decl(metadata !15336)
...
.lr.ph.i.i.i.i:                                   ; preds = %_RNvXs4_NtNtCs7tKScEop1B6_5alloc3vec9into_iterINtB5_8IntoIterINtB7_3VecReEENtNtNtNtCs6JMX4GRUq9U_4core4iter6traits8iterator8Iterator4nextCsl8pJiQOn4hA_9coreutils.exit.thread.i, %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueINtNtCs7tKScEop1B6_5alloc3vec3VecReEECsl8pJiQOn4hA_9coreutils.exit.i.i.i.i
  ...
  %.val.i.i.i.i = load i64, ptr %i.cl, align 8, !range !19, !alias.scope !15336, !noalias !15337, !noundef !12 ; 2 uses
...
bb.s:                                             ; preds = %.lr.ph.i.i.i.i
  ...
  %.val3.i.i.i.i = load ptr, ptr %i.co, align 8, !alias.scope !15336, !noalias !15337, !nonnull !12, !noundef !12
  %i.cp = shl nuw i64 %.val.i.i.i.i, 4
  call void @_RNvCsjSVV5GABoor_7___rustc14___rust_dealloc(ptr noundef nonnull %.val3.i.i.i.i, i64 noundef %i.cp, i64 noundef range(i64 1, -9223372036854775807) 8) #45, !noalias !15338
...
bb.t:                                             ; preds = %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueSINtNtCs7tKScEop1B6_5alloc3vec3VecReEECsl8pJiQOn4hA_9coreutils.exit.i.i.i
  ...
  call void @_RNvCsjSVV5GABoor_7___rustc14___rust_dealloc(ptr noundef nonnull %.sroa.671.0.i, i64 noundef %i.cs, i64 noundef range(i64 1, -9223372036854775807) 8) #45, !noalias !15337
...
_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueINtNtNtCs7tKScEop1B6_5alloc3vec9into_iter8IntoIterINtBG_3VecReEEECsl8pJiQOn4hA_9coreutils.exit.i: ; preds = %bb.t, %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueSINtNtCs7tKScEop1B6_5alloc3vec3VecReEECsl8pJiQOn4hA_9coreutils.exit.i.i.i
  ...
  call void @llvm.experimental.noalias.scope.decl(metadata !15340)
  %i.ct = load i64, ptr %i.s, align 8, !range !13, !alias.scope !15341, !noalias !15318, !noundef !12 ; 3 uses
...
bb.u:                                             ; preds = %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueINtNtNtCs7tKScEop1B6_5alloc3vec9into_iter8IntoIterINtBG_3VecReEEECsl8pJiQOn4hA_9coreutils.exit.i
  call void @llvm.experimental.noalias.scope.decl(metadata !15342)
  call void @llvm.experimental.noalias.scope.decl(metadata !15343)
...
bb.v:                                             ; preds = %bb.u
  ...
  %.val1.i.i.i.i.i = load ptr, ptr %i.cw, align 8, !alias.scope !15344, !noalias !15318, !nonnull !12, !noundef !12
  call void @_RNvCsjSVV5GABoor_7___rustc14___rust_dealloc(ptr noundef nonnull %.val1.i.i.i.i.i, i64 noundef %i.ct, i64 noundef range(i64 1, -9223372036854775807) 1) #45, !noalias !15345
...
_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueINtNtB4_6option6OptionNtNtCs7tKScEop1B6_5alloc6string6StringEECsl8pJiQOn4hA_9coreutils.exit.i.i: ; preds = %bb.v, %bb.u, %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueINtNtNtCs7tKScEop1B6_5alloc3vec9into_iter8IntoIterINtBG_3VecReEEECsl8pJiQOn4hA_9coreutils.exit.i
  ...
  call void @llvm.experimental.noalias.scope.decl(metadata !15346)
  %i.cy = load i64, ptr %i.cx, align 8, !range !13, !alias.scope !15347, !noalias !15318, !noundef !12 ; 3 uses
...
bb.w:                                             ; preds = %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueINtNtB4_6option6OptionNtNtCs7tKScEop1B6_5alloc6string6StringEECsl8pJiQOn4hA_9coreutils.exit.i.i
  call void @llvm.experimental.noalias.scope.decl(metadata !15348)
  call void @llvm.experimental.noalias.scope.decl(metadata !15349)
...
bb.x:                                             ; preds = %bb.w
  ...
  %.val1.i.i.i1.i.i = load ptr, ptr %i.db, align 8, !alias.scope !15350, !noalias !15318, !nonnull !12, !noundef !12
  call void @_RNvCsjSVV5GABoor_7___rustc14___rust_dealloc(ptr noundef nonnull %.val1.i.i.i1.i.i, i64 noundef %i.cy, i64 noundef range(i64 1, -9223372036854775807) 1) #45, !noalias !15351
...
_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueNtCshDScVpnq8df_5uu_pr18ColumnPageOperandsECsl8pJiQOn4hA_9coreutils.exit.i: ; preds = %bb.x, %bb.w, %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueINtNtB4_6option6OptionNtNtCs7tKScEop1B6_5alloc6string6StringEECsl8pJiQOn4hA_9coreutils.exit.i.i
  call void @llvm.lifetime.end.p0(ptr nonnull %i.s), !noalias !15318
  call fastcc void @_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueNtNtNtNtCsgNwXemyrBWj_12clap_builder6parser7matches11arg_matches10ArgMatchesECsl8pJiQOn4hA_9coreutils(ptr noalias nofree noundef align 8 dereferenceable(56) %i.u) #45, !noalias !15318
  call void @llvm.lifetime.end.p0(ptr nonnull %i.u), !noalias !15318
  call void @llvm.lifetime.end.p0(ptr nonnull %i.v), !noalias !15318
  call void @llvm.lifetime.end.p0(ptr nonnull %i.w), !noalias !15318
  call void @llvm.experimental.noalias.scope.decl(metadata !15352)
  %.val.i.i = load ptr, ptr %i.ao, align 8, !alias.scope !15352, !noalias !15318, !nonnull !12, !noundef !12 ; 2 uses
  %.val1.i.i = load i64, ptr %i.aq, align 8, !alias.scope !15352, !noalias !15318, !noundef !12 ; 2 uses
