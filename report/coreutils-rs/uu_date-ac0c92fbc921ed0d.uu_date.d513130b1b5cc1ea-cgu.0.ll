...
_RNvNtNtCs6JMX4GRUq9U_4core3str6traits11check_range.exit51.thread: ; preds = %bb.h, %_RNvNtNtCs6JMX4GRUq9U_4core3str6traits11check_range.exit51
  ...
  %i.ae = getelementptr inbounds nuw i8, ptr %1, i64 %.sroa.01.083117120 ; 3 uses
...
bb.j:                                             ; preds = %_RNvNtNtCs6JMX4GRUq9U_4core3str6traits11check_range.exit51.thread
  %i.af = load i8, ptr %i.ae, align 1, !alias.scope !4567, !noalias !4570, !noundef !10 ; 2 uses
...
thread-pre-split.i:                               ; preds = %_RNvNtNtCs6JMX4GRUq9U_4core3str6traits11check_range.exit51.thread
  %.pr.i = load i8, ptr %i.ae, align 1, !alias.scope !4567, !noalias !4570
  br label %bb.k

bb.k:                                             ; preds = %thread-pre-split.i, %bb.j
  %i.ag = phi i8 [ %.pr.i, %thread-pre-split.i ], [ %i.af, %bb.j ]
  %cond.i = icmp eq i8 %i.ag, 43                  ; 2 uses
  %i.ah = sext i1 %cond.i to i64
  %.sroa.15.0.i = add nsw i64 %i.ad, %i.ah        ; 4 uses
  %.sroa.0.0.idx.i = zext i1 %cond.i to i64
  %.sroa.0.0.i55 = getelementptr inbounds nuw i8, ptr %i.ae, i64 %.sroa.0.0.idx.i ; 2 uses
  %i.ai = icmp samesign ult i64 %.sroa.15.0.i, 17
  br i1 %i.ai, label %.preheader.i, label %.preheader56.i.preheader
...
.preheader56.i:                                   ; preds = %bb.l
  %i.aj = getelementptr inbounds nuw i8, ptr %.sroa.0.1.i56134, i64 1
  %i.ak = add nsw i64 %.sroa.15.1.i133, -1        ; 2 uses
  %.not52.i = icmp eq i64 %i.ak, 0
...
.preheader56.i.preheader:                         ; preds = %bb.k, %.preheader56.i
  %.sroa.0.1.i56134 = phi ptr [ %i.aj, %.preheader56.i ], [ %.sroa.0.0.i55, %bb.k ] ; 2 uses
  %.sroa.15.1.i133 = phi i64 [ %i.ak, %.preheader56.i ], [ %.sroa.15.0.i, %bb.k ]
  %.sroa.042.0.i132 = phi i64 [ %i.at, %.preheader56.i ], [ 0, %bb.k ]
  %i.al = tail call { i64, i1 } @llvm.umul.with.overflow.i64(i64 %.sroa.042.0.i132, i64 10) ; 2 uses
  %i.am = extractvalue { i64, i1 } %i.al, 1
  br i1 %i.am, label %_RNvMsv_NtCs6JMX4GRUq9U_4core3numj27from_ascii_bytes_radix_impl.exit, label %bb.l, !prof !215

bb.l:                                             ; preds = %.preheader56.i.preheader
  %i.an = extractvalue { i64, i1 } %i.al, 0       ; 2 uses
  %i.ao = load i8, ptr %.sroa.0.1.i56134, align 1, !alias.scope !4567, !noalias !4570, !noundef !10
  ...
  %or.cond75 = select i1 %i.ar, i1 true, i1 %i.au, !prof !445
...
.lr.ph.i57:                                       ; preds = %.preheader.i, %bb.m
  %.sroa.0.269.i = phi ptr [ %i.bb, %bb.m ], [ %.sroa.0.0.i55, %.preheader.i ] ; 2 uses
  %.sroa.15.268.i = phi i64 [ %i.ba, %bb.m ], [ %.sroa.15.0.i, %.preheader.i ]
  %.sroa.042.267.i = phi i64 [ %i.bd, %bb.m ], [ 0, %.preheader.i ]
  %i.av = load i8, ptr %.sroa.0.269.i, align 1, !alias.scope !4567, !noalias !4570, !noundef !10
  %i.aw = zext i8 %i.av to i32
  %i.ax = add nsw i32 %i.aw, -48                  ; 2 uses
  %i.ay = icmp ult i32 %i.ax, 10
  br i1 %i.ay, label %bb.m, label %_RNvMsv_NtCs6JMX4GRUq9U_4core3numj27from_ascii_bytes_radix_impl.exit

bb.m:                                             ; preds = %.lr.ph.i57
  %i.az = mul i64 %.sroa.042.267.i, 10
  %i.ba = add nsw i64 %.sroa.15.268.i, -1         ; 2 uses
  %i.bb = getelementptr inbounds nuw i8, ptr %.sroa.0.269.i, i64 1
  %i.bc = zext nneg i32 %i.ax to i64
  %i.bd = add i64 %i.az, %i.bc                    ; 2 uses
  %.not53.i = icmp eq i64 %i.ba, 0
...
.lr.ph92:                                         ; preds = %_RNvMsv_NtCs6JMX4GRUq9U_4core3numj27from_ascii_bytes_radix_impl.exit
  %i.be = getelementptr inbounds nuw i8, ptr %1, i64 %.sroa.01.1.lcssa122
  %i.bf = load i8, ptr %i.be, align 1, !noundef !10 ; 2 uses
  %i.bg = icmp eq i8 %i.bf, 58
  br i1 %i.bg, label %bb.n, label %.critedge43

bb.n:                                             ; preds = %.lr.ph92
  %i.bh = add i64 %.sroa.01.1.lcssa122, 1         ; 3 uses
  %exitcond103.not = icmp eq i64 %i.bh, %2
...
.lr.ph92.1:                                       ; preds = %bb.n
  ...
  %i.bj = load i8, ptr %i.bi, align 1, !noundef !10 ; 2 uses
  %i.bk = icmp eq i8 %i.bj, 58
  br i1 %i.bk, label %bb.o, label %.critedge43

bb.o:                                             ; preds = %.lr.ph92.1
  %i.bl = add i64 %.sroa.01.1.lcssa122, 2         ; 3 uses
  %exitcond103.not.1 = icmp eq i64 %i.bl, %2
...
.lr.ph92.2:                                       ; preds = %bb.o
  ...
  %i.bn = load i8, ptr %i.bm, align 1, !noundef !10 ; 2 uses
  %i.bo = icmp eq i8 %i.bn, 58
  br i1 %i.bo, label %bb.p, label %.critedge43

bb.p:                                             ; preds = %.lr.ph92.2
  %i.bp = add i64 %.sroa.01.1.lcssa122, 3         ; 3 uses
  %exitcond103.not.2 = icmp eq i64 %i.bp, %2
...
.lr.ph92.3:                                       ; preds = %bb.p
  ...
  %i.br = load i8, ptr %i.bq, align 1, !noundef !10
  br label %.critedge43

.critedge43:                                      ; preds = %.lr.ph92.3, %.lr.ph92.2, %.lr.ph92.1, %.lr.ph92
  %.sroa.01.291.lcssa = phi i64 [ %.sroa.01.1.lcssa122, %.lr.ph92 ], [ %i.bh, %.lr.ph92.1 ], [ %i.bl, %.lr.ph92.2 ], [ %i.bp, %.lr.ph92.3 ]
  %.lcssa = phi i8 [ %i.bf, %.lr.ph92 ], [ %i.bj, %.lr.ph92.1 ], [ %i.bn, %.lr.ph92.2 ], [ %i.br, %.lr.ph92.3 ]
...
_RNvNtNtCs6JMX4GRUq9U_4core3str6traits11check_range.exit.thread: ; preds = %bb.q, %6, %_RNvNtNtCs6JMX4GRUq9U_4core3str6traits11check_range.exit
  ...
  store ptr %i.cc, ptr %.sroa.7.0..sroa_idx, align 8
