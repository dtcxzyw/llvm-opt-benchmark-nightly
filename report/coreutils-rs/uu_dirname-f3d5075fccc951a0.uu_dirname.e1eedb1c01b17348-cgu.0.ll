Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/coreutils-rs/original/uu_dirname-f3d5075fccc951a0.uu_dirname.e1eedb1c01b17348-cgu.0?download=true
...
.lr.ph:                                           ; preds = %_RINvXs2J_NtNtCs6JMX4GRUq9U_4core5slice4iterINtB7_4IterhENtNtNtNtBb_4iter6traits8iterator8Iterator3allNCNvCsjoDrDr40csK_10uu_dirname27dirname_string_manipulation0EB1F_.exit.preheader, %_RINvXs2J_NtNtCs6JMX4GRUq9U_4core5slice4iterINtB7_4IterhENtNtNtNtBb_4iter6traits8iterator8Iterator3allNCNvCsjoDrDr40csK_10uu_dirname27dirname_string_manipulation0EB1F_.exit
  %.sroa.21.099 = phi i64 [ %i.am, %_RINvXs2J_NtNtCs6JMX4GRUq9U_4core5slice4iterINtB7_4IterhENtNtNtNtBb_4iter6traits8iterator8Iterator3allNCNvCsjoDrDr40csK_10uu_dirname27dirname_string_manipulation0EB1F_.exit ], [ %1, %_RINvXs2J_NtNtCs6JMX4GRUq9U_4core5slice4iterINtB7_4IterhENtNtNtNtBb_4iter6traits8iterator8Iterator3allNCNvCsjoDrDr40csK_10uu_dirname27dirname_string_manipulation0EB1F_.exit.preheader ] ; 5 uses
...
bb.e:                                             ; preds = %.lr.ph
  %i.t = add nsw i64 %.sroa.21.099, -2            ; 3 uses
  %i.u = getelementptr inbounds nuw i8, ptr %0, i64 %i.t
  %i.v = load i8, ptr %i.u, align 1, !noundef !7
  %i.w = icmp eq i8 %i.v, 47
  br i1 %i.w, label %.preheader.split.preheader, label %.loopexit

.preheader.split.preheader:                       ; preds = %bb.e
  %cond140 = icmp eq i64 %i.t, 0
...
.lr.ph142:                                        ; preds = %.preheader.split.preheader, %.preheader.split
  %.sroa.051.0141 = phi i64 [ %i.x, %.preheader.split ], [ %i.t, %.preheader.split.preheader ] ; 2 uses
  %i.x = add nsw i64 %.sroa.051.0141, -1          ; 3 uses
  %i.y = getelementptr inbounds nuw i8, ptr %0, i64 %i.x
  %i.z = load i8, ptr %i.y, align 1, !noundef !7
  %i.aa = icmp eq i8 %i.z, 47
  br i1 %i.aa, label %.preheader.split, label %_RINvXs2J_NtNtCs6JMX4GRUq9U_4core5slice4iterINtB7_4IterhENtNtNtNtBb_4iter6traits8iterator8Iterator3allNCNvCsjoDrDr40csK_10uu_dirname27dirname_string_manipulation0EB1F_.exit.thread
...
.lr.ph101:                                        ; preds = %.preheader91, %bb.h
  %.sroa.16.0100 = phi i64 [ %i.ai, %bb.h ], [ %i.r, %.preheader91 ] ; 3 uses
  %i.ae = getelementptr i8, ptr %0, i64 %.sroa.16.0100
  %i.af = getelementptr i8, ptr %i.ae, i64 -1
  %.val3.i83 = load i8, ptr %i.af, align 1, !alias.scope !15
  %i.ag = icmp eq i8 %.val3.i83, 47
  br i1 %i.ag, label %bb.h, label %_RINvXs2J_NtNtCs6JMX4GRUq9U_4core5slice4iterINtB7_4IterhENtNtNtNtBb_4iter6traits8iterator8Iterator3allNCNvCsjoDrDr40csK_10uu_dirname27dirname_string_manipulation0EB1F_.exit.thread
...
bb.h:                                             ; preds = %.lr.ph101
  %i.ai = add nsw i64 %.sroa.16.0100, -1          ; 2 uses
...
_RINvXs2J_NtNtCs6JMX4GRUq9U_4core5slice4iterINtB7_4IterhENtNtNtNtBb_4iter6traits8iterator8Iterator3allNCNvCsjoDrDr40csK_10uu_dirname27dirname_string_manipulation0EB1F_.exit: ; preds = %.lr.ph
  %i.am = add nsw i64 %.sroa.21.099, -1           ; 2 uses
...
_RINvMs0_NtNtCsgNwXemyrBWj_12clap_builder7builder7commandNtB6_7Command5aboutNtNtCs7tKScEop1B6_5alloc6string6StringECsjoDrDr40csK_10uu_dirname.exit:
  ...
  store ptr %.sroa.5.i11.sroa.0.0, ptr %.sroa.6.sroa.4.0..sroa.6.0..sroa_idx65.sroa_idx, align 8, !alias.scope !56, !noalias !50
  %.sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx = getelementptr inbounds nuw i8, ptr %i.j, i64 480
  store i64 %.sroa.5.i11.sroa.4.0, ptr %.sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx, align 8, !alias.scope !56, !noalias !50
  %.sroa.6.sroa.5.sroa.0.sroa.2.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx = getelementptr inbounds nuw i8, ptr %i.j, i64 488
  store i64 -1, ptr %.sroa.6.sroa.5.sroa.0.sroa.2.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx, align 8, !alias.scope !56, !noalias !50
  %.sroa.6.sroa.5.sroa.0.sroa.4.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx = getelementptr inbounds nuw i8, ptr %i.j, i64 512
  store i64 -1, ptr %.sroa.6.sroa.5.sroa.0.sroa.4.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx, align 8, !alias.scope !56, !noalias !50
  %.sroa.6.sroa.5.sroa.2.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx = getelementptr inbounds nuw i8, ptr %i.j, i64 536
  store i64 %.sroa.0.0.copyload.i5, ptr %.sroa.6.sroa.5.sroa.2.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx, align 8, !alias.scope !56, !noalias !50
  %.sroa.6.sroa.5.sroa.3.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx = getelementptr inbounds nuw i8, ptr %i.j, i64 544
  store ptr %.sroa.5.i4.sroa.0.0, ptr %.sroa.6.sroa.5.sroa.3.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx, align 8, !alias.scope !56, !noalias !50
  %.sroa.6.sroa.5.sroa.4.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx = getelementptr inbounds nuw i8, ptr %i.j, i64 552
  store i64 %.sroa.5.i4.sroa.4.0, ptr %.sroa.6.sroa.5.sroa.4.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx, align 8, !alias.scope !56, !noalias !50
  %.sroa.6.sroa.5.sroa.4.sroa.2.0..sroa.6.sroa.5.sroa.4.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx.sroa_idx = getelementptr inbounds nuw i8, ptr %i.j, i64 560
  store ptr @6, ptr %.sroa.6.sroa.5.sroa.4.sroa.2.0..sroa.6.sroa.5.sroa.4.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx.sroa_idx, align 8, !alias.scope !56, !noalias !50
  %.sroa.6.sroa.5.sroa.4.sroa.3.0..sroa.6.sroa.5.sroa.4.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx.sroa_idx = getelementptr inbounds nuw i8, ptr %i.j, i64 568
  store i64 7, ptr %.sroa.6.sroa.5.sroa.4.sroa.3.0..sroa.6.sroa.5.sroa.4.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx.sroa_idx, align 8, !alias.scope !56, !noalias !50
  %.sroa.6.sroa.5.sroa.4.sroa.4.0..sroa.6.sroa.5.sroa.4.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx.sroa_idx = getelementptr inbounds nuw i8, ptr %i.j, i64 576
  store ptr null, ptr %.sroa.6.sroa.5.sroa.4.sroa.4.0..sroa.6.sroa.5.sroa.4.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx.sroa_idx, align 8, !alias.scope !56, !noalias !50
  %.sroa.6.sroa.5.sroa.4.sroa.6.0..sroa.6.sroa.5.sroa.4.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx.sroa_idx = getelementptr inbounds nuw i8, ptr %i.j, i64 592
  store ptr null, ptr %.sroa.6.sroa.5.sroa.4.sroa.6.0..sroa.6.sroa.5.sroa.4.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx.sroa_idx, align 8, !alias.scope !56, !noalias !50
  %.sroa.6.sroa.5.sroa.5.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx = getelementptr inbounds nuw i8, ptr %i.j, i64 608
  store ptr @8, ptr %.sroa.6.sroa.5.sroa.5.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx, align 8, !alias.scope !56, !noalias !50
  %.sroa.6.sroa.5.sroa.6.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx = getelementptr inbounds nuw i8, ptr %i.j, i64 616
  store i64 25, ptr %.sroa.6.sroa.5.sroa.6.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx, align 8, !alias.scope !56, !noalias !50
  %.sroa.6.sroa.5.sroa.7.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx = getelementptr inbounds nuw i8, ptr %i.j, i64 624
  store ptr null, ptr %.sroa.6.sroa.5.sroa.7.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx, align 8, !alias.scope !56, !noalias !50
  %.sroa.6.sroa.5.sroa.7.sroa.3.0..sroa.6.sroa.5.sroa.7.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx.sroa_idx = getelementptr inbounds nuw i8, ptr %i.j, i64 640
  store ptr null, ptr %.sroa.6.sroa.5.sroa.7.sroa.3.0..sroa.6.sroa.5.sroa.7.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx.sroa_idx, align 8, !alias.scope !56, !noalias !50
  %.sroa.6.sroa.5.sroa.7.sroa.5.0..sroa.6.sroa.5.sroa.7.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx.sroa_idx = getelementptr inbounds nuw i8, ptr %i.j, i64 656
  store ptr null, ptr %.sroa.6.sroa.5.sroa.7.sroa.5.0..sroa.6.sroa.5.sroa.7.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx.sroa_idx, align 8, !alias.scope !56, !noalias !50
  %.sroa.6.sroa.5.sroa.7.sroa.7.0..sroa.6.sroa.5.sroa.7.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx.sroa_idx = getelementptr inbounds nuw i8, ptr %i.j, i64 672
  store ptr null, ptr %.sroa.6.sroa.5.sroa.7.sroa.7.0..sroa.6.sroa.5.sroa.7.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx.sroa_idx, align 8, !alias.scope !56, !noalias !50
  %.sroa.6.sroa.5.sroa.7.sroa.9.0..sroa.6.sroa.5.sroa.7.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx.sroa_idx = getelementptr inbounds nuw i8, ptr %i.j, i64 688
  store ptr null, ptr %.sroa.6.sroa.5.sroa.7.sroa.9.0..sroa.6.sroa.5.sroa.7.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx.sroa_idx, align 8, !alias.scope !56, !noalias !50
  %.sroa.6.sroa.5.sroa.7.sroa.10.0..sroa.6.sroa.5.sroa.7.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx.sroa_idx = getelementptr inbounds nuw i8, ptr %i.j, i64 696
  store <4 x i32> <i32 -1, i32 136, i32 136, i32 0>, ptr %.sroa.6.sroa.5.sroa.7.sroa.10.0..sroa.6.sroa.5.sroa.7.0..sroa.6.sroa.5.0..sroa.6.0..sroa_idx65.sroa_idx.sroa_idx.sroa_idx, align 8, !alias.scope !56, !noalias !50
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c)
  call void @_RNvNtNtCsh036I4OHgIr_6uucore4mods6locale11get_message(ptr noalias nofree noundef nonnull sret([24 x i8]) align 8 captures(address) dereferenceable(24) %i.c, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) @12, i64 noundef 17) #12
  %.sroa.0239.0.copyload = load i64, ptr %i.c, align 8
  %.sroa.2240.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.c, i64 8
  %.sroa.2240.0.copyload = load ptr, ptr %.sroa.2240.0..sroa_idx, align 8
  %.sroa.3241.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.c, i64 16
  %.sroa.3241.0.copyload = load i64, ptr %.sroa.3241.0..sroa_idx, align 8
end_hunk_0
