...
bb.a:
  %.val = load i64, ptr %0, align 8, !range !137, !noundef !4 ; 2 uses
...
_RNvXs_NtCs7tKScEop1B6_5alloc5allocNtB4_6GlobalNtNtCs6JMX4GRUq9U_4core5alloc9Allocator10deallocate.exit.i.i.i.i.i.i: ; preds = %bb.a
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 8
  %.val1 = load ptr, ptr %i.b, align 8, !nonnull !4, !noundef !4
  tail call void @_RNvCsjSVV5GABoor_7___rustc14___rust_dealloc(ptr noundef nonnull %.val1, i64 noundef %.val, i64 noundef range(i64 1, -9223372036854775807) 1) #19, !noalias !138
...
_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueINtNtCs7tKScEop1B6_5alloc6borrow3CoweEECs86MjTkXjVIv_8uu_rmdir.exit: ; preds = %bb.a, %_RNvXs_NtCs7tKScEop1B6_5alloc5allocNtB4_6GlobalNtNtCs6JMX4GRUq9U_4core5alloc9Allocator10deallocate.exit.i.i.i.i.i.i
  ...
  %i.d = load i64, ptr %i.c, align 8, !range !140, !alias.scope !139, !noundef !4 ; 3 uses
...
bb.b:                                             ; preds = %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueINtNtCs7tKScEop1B6_5alloc6borrow3CoweEECs86MjTkXjVIv_8uu_rmdir.exit
  ...
  %.val.i = load i64, ptr %i.i, align 8, !range !137, !alias.scope !139, !noundef !4 ; 2 uses
...
_RNvXs_NtCs7tKScEop1B6_5alloc5allocNtB4_6GlobalNtNtCs6JMX4GRUq9U_4core5alloc9Allocator10deallocate.exit.i.i.i.i.i.i.i: ; preds = %bb.b
  ...
  %.val1.i = load ptr, ptr %i.k, align 8, !alias.scope !139, !nonnull !4, !noundef !4
  tail call void @_RNvCsjSVV5GABoor_7___rustc14___rust_dealloc(ptr noundef nonnull %.val1.i, i64 noundef %.val.i, i64 noundef range(i64 1, -9223372036854775807) 1) #19, !noalias !141
...
bb.c:                                             ; preds = %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueINtNtCs7tKScEop1B6_5alloc6borrow3CoweEECs86MjTkXjVIv_8uu_rmdir.exit
  ...
  %.val2.i = load i64, ptr %i.l, align 8, !range !137, !alias.scope !139, !noundef !4 ; 2 uses
...
_RNvXs_NtCs7tKScEop1B6_5alloc5allocNtB4_6GlobalNtNtCs6JMX4GRUq9U_4core5alloc9Allocator10deallocate.exit.i.i.i.i.i.i.i.i.i: ; preds = %bb.c
  ...
  %.val3.i = load ptr, ptr %i.n, align 8, !alias.scope !139, !nonnull !4, !noundef !4
  tail call void @_RNvCsjSVV5GABoor_7___rustc14___rust_dealloc(ptr noundef nonnull %.val3.i, i64 noundef %.val2.i, i64 noundef range(i64 1, -9223372036854775807) 1) #19, !noalias !142
  br label %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueNtNtCsiMbvvWBbXLn_13fluent_bundle5types11FluentValueECs86MjTkXjVIv_8uu_rmdir.exit
...
bb.d:                                             ; preds = %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueINtNtCs7tKScEop1B6_5alloc6borrow3CoweEECs86MjTkXjVIv_8uu_rmdir.exit
  ...
  %.val4.i = load ptr, ptr %i.o, align 8, !alias.scope !139 ; 4 uses
  %i.p = getelementptr inbounds nuw i8, ptr %0, i64 40
  %.val5.i = load ptr, ptr %i.p, align 8, !alias.scope !139, !nonnull !4, !align !143, !noundef !4 ; 3 uses
  %i.q = load ptr, ptr %.val5.i, align 8, !invariant.load !4, !noalias !139 ; 2 uses
  %.not.i.i = icmp eq ptr %i.q, null
  br i1 %.not.i.i, label %bb.f, label %bb.e

bb.e:                                             ; preds = %bb.d
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.val4.i) ]
  tail call void %i.q(ptr noundef nonnull %.val4.i) #21, !noalias !139, !inline_history !136
  br label %bb.f

bb.f:                                             ; preds = %bb.e, %bb.d
  %i.r = getelementptr inbounds nuw i8, ptr %.val5.i, i64 8
  %i.s = load i64, ptr %i.r, align 8, !range !5, !invariant.load !4, !noalias !139 ; 2 uses
...
_RNvXs_NtCs7tKScEop1B6_5alloc5allocNtB4_6GlobalNtNtCs6JMX4GRUq9U_4core5alloc9Allocator10deallocate.exit.i.i.i: ; preds = %bb.f
  ...
  %i.v = load i64, ptr %i.u, align 8, !range !144, !invariant.load !4, !noalias !139
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.val4.i) ]
  tail call void @_RNvCsjSVV5GABoor_7___rustc14___rust_dealloc(ptr noundef nonnull %.val4.i, i64 noundef %i.s, i64 noundef range(i64 1, -9223372036854775807) %i.v) #19, !noalias !139
  br label %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueNtNtCsiMbvvWBbXLn_13fluent_bundle5types11FluentValueECs86MjTkXjVIv_8uu_rmdir.exit
...
bb.b:                                             ; preds = %bb.a
  %i.d = load i64, ptr %0, align 8, !range !5, !alias.scope !147, !noundef !4 ; 2 uses
  ...
  %.val13.i = load ptr, ptr %i.f, align 8, !alias.scope !147
  ...
  %i.g = load i64, ptr %i.a, align 8, !range !6, !noalias !147, !noundef !4
  %i.h = trunc nuw i64 %i.g to i1
  %i.i = getelementptr inbounds nuw i8, ptr %i.a, i64 8 ; 2 uses
  br i1 %i.h, label %bb.c, label %bb.e

bb.c:                                             ; preds = %bb.b
  %i.j = load i64, ptr %i.i, align 8, !range !148, !noalias !147, !noundef !4
  %i.k = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  %i.l = load i64, ptr %i.k, align 8, !noalias !147
...
bb.e:                                             ; preds = %bb.b
  %i.m = load ptr, ptr %i.i, align 8, !noalias !147, !nonnull !4, !noundef !4
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !147
  store ptr %i.m, ptr %i.f, align 8, !alias.scope !147
  %i.n = icmp sgt i64 %..i14.i, -1
  tail call void @llvm.assume(i1 %i.n)
  store i64 %..i14.i, ptr %0, align 8, !alias.scope !147
  ret void
}
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.r = load i64, ptr %i.c, align 8, !range !6, !noalias !184, !noundef !4 ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.t = load ptr, ptr %i.s, align 8, !alias.scope !187, !noalias !184, !noundef !4 ; 2 uses
...
bb.h:                                             ; preds = %bb.g
  fence acquire
  call void @_RNvMsn_NtCs7tKScEop1B6_5alloc4syncINtB5_3ArcNtNtNtNtCs2vKOLqTMYjT_3std3sys2fs4unix12InnerReadDirE9drop_slowBO_(ptr noalias nofree noundef nonnull align 8 dereferenceable(40) %i.s) #18, !noalias !184
...
_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueINtNtCs7tKScEop1B6_5alloc4sync3ArcNtNtNtNtCs2vKOLqTMYjT_3std3sys2fs4unix12InnerReadDirEECs86MjTkXjVIv_8uu_rmdir.exit.i.i.i.i.i.i.i: ; preds = %bb.h, %bb.g
  ...
  %.val.i.i.i.i.i.i.i = load ptr, ptr %i.w, align 8, !alias.scope !191, !noalias !184, !nonnull !4, !noundef !4 ; 2 uses
  %i.x = getelementptr inbounds nuw i8, ptr %i.c, i64 24
  %.val1.i.i.i.i.i.i.i = load i64, ptr %i.x, align 8, !alias.scope !191, !noalias !184, !noundef !4 ; 2 uses
...
bb.i:                                             ; preds = %bb.f
  ...
  %.val.i.i.i.i.i = load ptr, ptr %i.z, align 8, !alias.scope !187, !noalias !184, !nonnull !4, !noundef !4 ; 3 uses
...
bb.k:                                             ; preds = %bb.i
  ...
  store ptr %i.af, ptr %i.ag, align 8, !alias.scope !193, !noalias !192
  store i8 3, ptr %i.b, align 8, !alias.scope !193, !noalias !192
  call void @_RNvXsd_NtNtCs6JMX4GRUq9U_4core2io5errorNtB5_11CustomOwnerNtNtNtB9_3ops4drop4Drop4drop(ptr noalias nofree noundef nonnull align 8 dereferenceable(8) %i.ag) #19, !noalias !192
  br label %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueNtNtNtB4_2io5error5ErrorECs86MjTkXjVIv_8uu_rmdir.exit.i.i.i.i.i
...
_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueINtNtB4_6option6OptionINtNtB4_6result6ResultNtNtCs2vKOLqTMYjT_3std2fs8DirEntryNtNtNtB4_2io5error5ErrorEEECs86MjTkXjVIv_8uu_rmdir.exit.i.i.i: ; preds = %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueNtNtNtB4_2io5error5ErrorECs86MjTkXjVIv_8uu_rmdir.exit.i.i.i.i.i, %_RNvXs_NtCs7tKScEop1B6_5alloc5allocNtB4_6GlobalNtNtCs6JMX4GRUq9U_4core5alloc9Allocator10deallocate.exit.i.i.i.i.i.i.i.i.i.i, %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueINtNtCs7tKScEop1B6_5alloc4sync3ArcNtNtNtNtCs2vKOLqTMYjT_3std3sys2fs4unix12InnerReadDirEECs86MjTkXjVIv_8uu_rmdir.exit.i.i.i.i.i.i.i, %bb.e
  ...
  %i.ah = load ptr, ptr %i.d, align 8, !alias.scope !198, !noalias !184, !nonnull !4, !noundef !4
  %i.ai = atomicrmw sub ptr %i.ah, i64 1 release, align 8, !noalias !199
...
bb.o:                                             ; preds = %.thread.i.i
  ...
  store ptr %i.ap, ptr %i.aq, align 8, !alias.scope !201, !noalias !200
  store i8 3, ptr %i.a, align 8, !alias.scope !201, !noalias !200
  call void @_RNvXsd_NtNtCs6JMX4GRUq9U_4core2io5errorNtB5_11CustomOwnerNtNtNtB9_3ops4drop4Drop4drop(ptr noalias nofree noundef nonnull align 8 dereferenceable(8) %i.aq) #19, !noalias !200
  br label %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueINtNtB4_6result6ResultNtNtCs2vKOLqTMYjT_3std2fs7ReadDirNtNtNtB4_2io5error5ErrorEECs86MjTkXjVIv_8uu_rmdir.exit.i.i
