...
.lr.ph.i:                                         ; preds = %.preheader8.split, %bb.d
  %.sroa.04.027.i = phi ptr [ %i.aj, %bb.d ], [ %i.f, %.preheader8.split ] ; 2 uses
  %.sroa.08.026.i = phi ptr [ %i.ai, %bb.d ], [ %i.ae, %.preheader8.split ] ; 2 uses
  %.sroa.011.0.copyload.i = load i32, ptr %.sroa.08.026.i, align 1, !alias.scope !244, !noalias !247
  %.sroa.012.0.copyload.i = load i32, ptr %.sroa.04.027.i, align 1, !alias.scope !247, !noalias !244
...
bb.d:                                             ; preds = %.lr.ph.i
  %i.ai = getelementptr inbounds nuw i8, ptr %.sroa.08.026.i, i64 4 ; 2 uses
  %i.aj = getelementptr inbounds nuw i8, ptr %.sroa.04.027.i, i64 4
