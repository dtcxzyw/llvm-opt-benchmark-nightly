...
.lr.ph.i:                                         ; preds = %.preheader8.split, %bb.d
  %.sroa.08.027.i = phi ptr [ %i.aj, %bb.d ], [ %i.f, %.preheader8.split ] ; 2 uses
  %.sroa.04.026.i = phi ptr [ %i.ai, %bb.d ], [ %i.ae, %.preheader8.split ] ; 2 uses
  %.sroa.011.0.copyload.i = load i32, ptr %.sroa.04.026.i, align 1, !alias.scope !244, !noalias !247
  %.sroa.012.0.copyload.i = load i32, ptr %.sroa.08.027.i, align 1, !alias.scope !247, !noalias !244
...
bb.d:                                             ; preds = %.lr.ph.i
  %i.ai = getelementptr inbounds nuw i8, ptr %.sroa.04.026.i, i64 4 ; 2 uses
  %i.aj = getelementptr inbounds nuw i8, ptr %.sroa.08.027.i, i64 4
...
begin_hunk_2_@_RNvMs5_CsgN7rS7e43TA_7uu_moreNtB5_5Pager14process_events:bb.a
  %i.gg = call i64 @llvm.usub.sat.i64(i64 %i.bh, i64 1) ; 2 uses
  store i64 %i.gg, ptr %i.k, align 8, !alias.scope !793
...
bb.am:                                            ; preds = %bb.ba, %bb.az, %bb.az, %bb.an
  %i.gh = load i8, ptr %i.j, align 8, !range !173, !noundef !4
  %i.gi = trunc nuw i8 %i.gh to i1
  br i1 %i.gi, label %.loopexit, label %bb.bb
...
bb.ao:                                            ; preds = %bb.ba, %bb.an
  ...
  %i.gj = load i64, ptr %i.k, align 8, !noundef !4
  %i.gk = call i64 @llvm.usub.sat.i64(i64 %i.gj, i64 1)
  store i64 %i.gk, ptr %i.k, align 8
  br label %_RNvMs5_CsgN7rS7e43TA_7uu_moreNtB5_5Pager7page_up.exit

bb.ap:                                            ; preds = %bb.m
  %i.gl = extractvalue { ptr, ptr } %i.at, 1      ; 2 uses
...
.loopexit:                                        ; preds = %bb.n, %bb.am, %bb.ap, %bb.d
  %.sroa.8.0 = phi ptr [ %i.af, %bb.d ], [ %i.gl, %bb.ap ], [ undef, %bb.am ], [ undef, %bb.n ]
  %.sroa.0.0 = phi ptr [ %i.ae, %bb.d ], [ %i.au, %bb.ap ], [ null, %bb.am ], [ null, %bb.n ]
  %i.gm = insertvalue { ptr, ptr } poison, ptr %.sroa.0.0, 0
  %i.gn = insertvalue { ptr, ptr } %i.gm, ptr %.sroa.8.0, 1
...
_RNvMs5_CsgN7rS7e43TA_7uu_moreNtB5_5Pager7page_up.exit: ; preds = %_RINvMNtCs6JMX4GRUq9U_4core3stre12trim_matchesNvMNtNtB5_4char7methodsc13is_whitespaceECsgN7rS7e43TA_7uu_more.exit.thread.i, %_RINvMNtCs6JMX4GRUq9U_4core3stre12trim_matchesNvMNtNtB5_4char7methodsc13is_whitespaceECsgN7rS7e43TA_7uu_more.exit.i, %bb.o, %bb.g, %bb.bd, %bb.bc, %bb.bb, %bb.ar, %bb.ao
  ...
  %i.go = load i64, ptr %i.q, align 8, !range !229, !alias.scope !829, !noundef !4
  %i.gp = icmp eq i64 %i.go, 0
  br i1 %i.gp, label %bb.as, label %_RNvMs5_CsgN7rS7e43TA_7uu_moreNtB5_5Pager14update_display.exit.thread
...
bb.au:                                            ; preds = %bb.as
  %i.gq = call fastcc { i64, ptr } @_RINvXs0_NtCsfxi9wTnNW09_9crossterm7commandNtCsgN7rS7e43TA_7uu_more10OutputTypeNtB6_17ExecutableCommand7executeNtNtB8_6cursor6MoveToEBG_(ptr noalias nofree noundef align 8 dereferenceable(16) %i.q) #26 ; 2 uses
  %i.gr = extractvalue { i64, ptr } %i.gq, 0
  %i.gs = extractvalue { i64, ptr } %i.gq, 1      ; 3 uses
  %i.gt = trunc nuw i64 %i.gr to i1
  br i1 %i.gt, label %_RNvMs5_CsgN7rS7e43TA_7uu_moreNtB5_5Pager14update_display.exit, label %bb.ay

bb.av:                                            ; preds = %bb.at
  %i.gu = call fastcc noundef ptr @_RNvYNtCsgN7rS7e43TA_7uu_more10OutputTypeNtNtNtCs6JMX4GRUq9U_4core2io5write5Write9write_allB4_(ptr noalias nofree noundef nonnull align 8 dereferenceable(16) %i.q, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) @38, i64 noundef range(i64 0, -9223372036854775808) 4) #26, !noalias !832 ; 2 uses
  %.not.i.not.i.i = icmp eq ptr %i.gu, null
...
_RINvXs0_NtCsfxi9wTnNW09_9crossterm7commandNtCsgN7rS7e43TA_7uu_more10OutputTypeNtB6_17ExecutableCommand7executeNtNtB8_8terminal5ClearEBG_.exit.i: ; preds = %bb.av
  %i.gv = call noundef ptr @_RNvXse_NtNtCs2vKOLqTMYjT_3std2io5stdioNtB5_6StdoutNtNtNtCs6JMX4GRUq9U_4core2io5write5Write5flush(ptr noalias nofree noundef nonnull align 8 dereferenceable(8) %i.u) #26 ; 2 uses
  %.not.i.not.i = icmp eq ptr %i.gv, null
...
bb.aw:                                            ; preds = %_RINvXs0_NtCsfxi9wTnNW09_9crossterm7commandNtCsgN7rS7e43TA_7uu_more10OutputTypeNtB6_17ExecutableCommand7executeNtNtB8_8terminal5ClearEBG_.exit.i
  %i.gw = call fastcc { i64, ptr } @_RINvXs0_NtCsfxi9wTnNW09_9crossterm7commandNtCsgN7rS7e43TA_7uu_more10OutputTypeNtB6_17ExecutableCommand7executeNtNtB8_6cursor6MoveToEBG_(ptr noalias nofree noundef align 8 dereferenceable(16) %i.q) #26 ; 2 uses
  %i.gx = extractvalue { i64, ptr } %i.gw, 0
  %i.gy = trunc nuw i64 %i.gx to i1
  br i1 %i.gy, label %bb.ax, label %_RNvMs5_CsgN7rS7e43TA_7uu_moreNtB5_5Pager14update_display.exit.thread

bb.ax:                                            ; preds = %bb.aw
  %i.gz = extractvalue { i64, ptr } %i.gw, 1
  br label %_RNvMs5_CsgN7rS7e43TA_7uu_moreNtB5_5Pager14update_display.exit

bb.ay:                                            ; preds = %bb.au
  %i.ha = call fastcc noundef ptr @_RNvYNtCsgN7rS7e43TA_7uu_more10OutputTypeNtNtNtCs6JMX4GRUq9U_4core2io5write5Write9write_allB4_(ptr noalias nofree noundef nonnull align 8 dereferenceable(16) %i.gs, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) @39, i64 noundef range(i64 0, -9223372036854775808) 3) #26, !noalias !837 ; 2 uses
  %.not.i.not.i30.i = icmp eq ptr %i.ha, null
...
_RINvXs0_NtCsfxi9wTnNW09_9crossterm7commandNtCsgN7rS7e43TA_7uu_more10OutputTypeNtB6_17ExecutableCommand7executeNtNtB8_8terminal5ClearEBG_.exit36.i: ; preds = %bb.ay
  ...
  %i.hc = call noundef ptr @_RNvXse_NtNtCs2vKOLqTMYjT_3std2io5stdioNtB5_6StdoutNtNtNtCs6JMX4GRUq9U_4core2io5write5Write5flush(ptr noalias nofree noundef nonnull align 8 dereferenceable(8) %i.hb) #26 ; 2 uses
  %.not.i33.not.i = icmp eq ptr %i.hc, null
...
_RNvMs5_CsgN7rS7e43TA_7uu_moreNtB5_5Pager14update_display.exit: ; preds = %bb.au, %bb.av, %_RINvXs0_NtCsfxi9wTnNW09_9crossterm7commandNtCsgN7rS7e43TA_7uu_more10OutputTypeNtB6_17ExecutableCommand7executeNtNtB8_8terminal5ClearEBG_.exit.i, %bb.ax, %bb.ay, %_RINvXs0_NtCsfxi9wTnNW09_9crossterm7commandNtCsgN7rS7e43TA_7uu_more10OutputTypeNtB6_17ExecutableCommand7executeNtNtB8_8terminal5ClearEBG_.exit36.i
  %.sink.sink.i = phi ptr [ %i.gu, %bb.av ], [ %i.gz, %bb.ax ], [ %i.gv, %_RINvXs0_NtCsfxi9wTnNW09_9crossterm7commandNtCsgN7rS7e43TA_7uu_more10OutputTypeNtB6_17ExecutableCommand7executeNtNtB8_8terminal5ClearEBG_.exit.i ], [ %i.gs, %bb.au ], [ %i.hc, %_RINvXs0_NtCsfxi9wTnNW09_9crossterm7commandNtCsgN7rS7e43TA_7uu_more10OutputTypeNtB6_17ExecutableCommand7executeNtNtB8_8terminal5ClearEBG_.exit36.i ], [ %i.ha, %bb.ay ]
  %i.hd = call { ptr, ptr } @_RNvXsf_NtNtCsh036I4OHgIr_6uucore4mods5errorINtNtCs7tKScEop1B6_5alloc5boxed3BoxDNtB5_6UErrorEL_EINtNtCs6JMX4GRUq9U_4core7convert4FromNtNtNtB1A_2io5error5ErrorE4from(ptr noundef nonnull %.sink.sink.i) #26 ; 2 uses
  %.sroa.0.1.i = extractvalue { ptr, ptr } %i.hd, 0
  %.not61 = icmp eq ptr %.sroa.0.1.i, null
  br i1 %.not61, label %_RNvMs5_CsgN7rS7e43TA_7uu_moreNtB5_5Pager14update_display.exit.thread, label %.loopexit119
...
bb.bb:                                            ; preds = %bb.am
  %i.he = load i64, ptr %i.k, align 8, !noundef !4
  %i.hf = load i64, ptr %i.i, align 8, !noundef !4
  %i.hg = call i64 @llvm.uadd.sat.i64(i64 %i.he, i64 %i.hf)
  store i64 %i.hg, ptr %i.k, align 8
  br label %_RNvMs5_CsgN7rS7e43TA_7uu_moreNtB5_5Pager7page_up.exit

bb.bc:                                            ; preds = %bb.n
  %i.hh = load i64, ptr %i.k, align 8, !noundef !4
  %i.hi = call i64 @llvm.uadd.sat.i64(i64 %i.hh, i64 1)
  store i64 %i.hi, ptr %i.k, align 8
  br label %_RNvMs5_CsgN7rS7e43TA_7uu_moreNtB5_5Pager7page_up.exit

bb.bd:                                            ; preds = %bb.g
  %i.hj = call i16 @llvm.usub.sat.i16(i16 %.sroa.3.0.extract.trunc, i16 1)
...
_RNvMs5_CsgN7rS7e43TA_7uu_moreNtB5_5Pager14update_display.exit.thread: ; preds = %bb.aw, %_RINvXs0_NtCsfxi9wTnNW09_9crossterm7commandNtCsgN7rS7e43TA_7uu_more10OutputTypeNtB6_17ExecutableCommand7executeNtNtB8_8terminal5ClearEBG_.exit36.i, %_RNvMs5_CsgN7rS7e43TA_7uu_moreNtB5_5Pager7page_up.exit, %bb.at, %_RNvMs5_CsgN7rS7e43TA_7uu_moreNtB5_5Pager14update_display.exit
  %i.hl = call fastcc { ptr, ptr } @_RNvMs5_CsgN7rS7e43TA_7uu_moreNtB5_5Pager4draw(ptr noalias nofree noundef align 8 dereferenceable(184) %0, i32 noundef %.sroa.043.0) #26 ; 2 uses
  %i.hm = extractvalue { ptr, ptr } %i.hl, 0
  %.not62 = icmp eq ptr %i.hm, null
  br i1 %.not62, label %.backedge, label %.loopexit119

.loopexit119:                                     ; preds = %_RNvMs5_CsgN7rS7e43TA_7uu_moreNtB5_5Pager14update_display.exit.thread, %_RNvMs5_CsgN7rS7e43TA_7uu_moreNtB5_5Pager14update_display.exit, %.loopexit, %._crit_edge
  %.merged = phi { ptr, ptr } [ %i.x, %._crit_edge ], [ %i.gn, %.loopexit ], [ %i.hl, %_RNvMs5_CsgN7rS7e43TA_7uu_moreNtB5_5Pager14update_display.exit.thread ], [ %i.hd, %_RNvMs5_CsgN7rS7e43TA_7uu_moreNtB5_5Pager14update_display.exit ]
  ret { ptr, ptr } %.merged
}
...
bb.c:                                             ; preds = %.lr.ph, %_RNvMsG_NtCs7tKScEop1B6_5alloc3vecINtB5_3VecNtNtB7_6string6StringE8push_mutCsgN7rS7e43TA_7uu_more.exit
  %.sroa.10.059 = phi i64 [ undef, %.lr.ph ], [ %.sroa.10.1.ph53, %_RNvMsG_NtCs7tKScEop1B6_5alloc3vecINtB5_3VecNtNtB7_6string6StringE8push_mutCsgN7rS7e43TA_7uu_more.exit ]
...
_RNvXs_NtCs7tKScEop1B6_5alloc5allocNtB4_6GlobalNtNtCs6JMX4GRUq9U_4core5alloc9Allocator8allocate.exit.i: ; preds = %bb.x
  ...
  %i.cz = call noundef ptr @_RNvCsjSVV5GABoor_7___rustc12___rust_alloc(i64 noundef range(i64 0, -9223372036854775808) %i.cx, i64 noundef range(i64 1, 9) 1) #26, !noalias !874 ; 4 uses
...
_RNvMs5_NtCs7tKScEop1B6_5alloc7raw_vecNtB5_11RawVecInner15try_allocate_inCsgN7rS7e43TA_7uu_more.exit: ; preds = %_RINvMNtCs6JMX4GRUq9U_4core3stre16trim_end_matchesNvMNtNtB5_4char7methodsc13is_whitespaceECsgN7rS7e43TA_7uu_more.exit, %_RNvXs_NtCs7tKScEop1B6_5alloc5allocNtB4_6GlobalNtNtCs6JMX4GRUq9U_4core5alloc9Allocator8allocate.exit.i
  ...
  %.sroa.10.1 = phi i64 [ %i.cx, %_RNvXs_NtCs7tKScEop1B6_5alloc5allocNtB4_6GlobalNtNtCs6JMX4GRUq9U_4core5alloc9Allocator8allocate.exit.i ], [ %.sroa.10.059, %_RINvMNtCs6JMX4GRUq9U_4core3stre16trim_end_matchesNvMNtNtB5_4char7methodsc13is_whitespaceECsgN7rS7e43TA_7uu_more.exit ]
  call void @_RNvNtCs7tKScEop1B6_5alloc7raw_vec12handle_error(i64 noundef %.sroa.4.0, i64 %.sroa.10.1) #29
  unreachable
...
.thread47:                                        ; preds = %bb.w, %bb.x, %_RNvMsG_NtCs7tKScEop1B6_5alloc3vecINtB5_3VecyE8push_mutCsgN7rS7e43TA_7uu_more.exit, %bb.aa
  ...
  %.sroa.10.1.ph53 = phi i64 [ %3, %bb.aa ], [ 1, %_RNvMsG_NtCs7tKScEop1B6_5alloc3vecINtB5_3VecyE8push_mutCsgN7rS7e43TA_7uu_more.exit ], [ 1, %bb.x ], [ 1, %bb.w ]
...
_RNvMs5_CsgN7rS7e43TA_7uu_moreNtB5_5Pager10clear_line.exit.thread.i: ; preds = %_RNvMs5_CsgN7rS7e43TA_7uu_moreNtB5_5Pager10clear_line.exit.i, %bb.a
  ...
  %.not111.i = icmp eq i64 %i.av, 0
  br i1 %.not111.i, label %_RNvMs5_CsgN7rS7e43TA_7uu_moreNtB5_5Pager10draw_lines.exit.thread, label %.lr.ph.lr.ph.i
...
.lr.ph.i:                                         ; preds = %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueNtNtCs7tKScEop1B6_5alloc6string6StringECsgN7rS7e43TA_7uu_more.exit49.i, %.lr.ph.lr.ph.i
  %.sroa.04.0.ph107.i = phi i64 [ 0, %.lr.ph.lr.ph.i ], [ %i.go, %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueNtNtCs7tKScEop1B6_5alloc6string6StringECsgN7rS7e43TA_7uu_more.exit49.i ] ; 4 uses
  %.sroa.08.0.ph106.i = phi i64 [ %i.aw, %.lr.ph.lr.ph.i ], [ %i.gp, %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueNtNtCs7tKScEop1B6_5alloc6string6StringECsgN7rS7e43TA_7uu_more.exit49.i ]
  br label %bb.c

bb.c:                                             ; preds = %bb.i, %.lr.ph.i
  %.sroa.08.0103.i = phi i64 [ %.sroa.08.0.ph106.i, %.lr.ph.i ], [ %i.cn, %bb.i ] ; 9 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.am), !noalias !959
  call fastcc void @_RNvMs5_CsgN7rS7e43TA_7uu_moreNtB5_5Pager15read_until_line(ptr noalias nofree noundef align 8 captures(none) dereferenceable(16) %i.am, ptr noalias nofree noundef nonnull align 8 dereferenceable(184) %0, i64 noundef %.sroa.08.0103.i) #26
...
.loopexit63.i:                                    ; preds = %bb.d
  ...
  %i.bn = call i64 @llvm.usub.sat.i64(i64 %.sroa.08.0103.i, i64 %i.bm)
  store i64 %i.bn, ptr %i.at, align 8, !alias.scope !959
  %i.bo = icmp ult i64 %.sroa.04.0.ph107.i, %i.bm
  br i1 %i.bo, label %.lr.ph110.i, label %_RNvMs5_CsgN7rS7e43TA_7uu_moreNtB5_5Pager10draw_lines.exit.thread
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.bx = getelementptr [24 x i8], ptr %i.bw, i64 %.sroa.08.0103.i ; 2 uses
...
bb.g:                                             ; preds = %.lr.ph110.i
  %i.cg = add nuw i64 %.sroa.04.1109.i, 1         ; 2 uses
  %i.ch = load i64, ptr %i.au, align 8, !alias.scope !959, !noundef !4 ; 2 uses
  %i.ci = icmp ult i64 %i.cg, %i.ch
  br i1 %i.ci, label %.lr.ph110.i, label %_RNvMs5_CsgN7rS7e43TA_7uu_moreNtB5_5Pager10draw_lines.exit.thread

.lr.ph110.i:                                      ; preds = %.loopexit63.i, %bb.g
  %.sroa.04.1109.i = phi i64 [ %i.cg, %bb.g ], [ %.sroa.04.0.ph107.i, %.loopexit63.i ]
...
bb.i:                                             ; preds = %_RNvMs5_CsgN7rS7e43TA_7uu_moreNtB5_5Pager19should_squeeze_line.exit.i
  ...
  %i.cn = add nuw i64 %.sroa.08.0103.i, 1
  %i.co = load i64, ptr %i.au, align 8, !alias.scope !959, !noundef !4 ; 2 uses
  %i.cp = icmp ult i64 %.sroa.04.0.ph107.i, %i.co
...
bb.j:                                             ; preds = %_RNvMs5_CsgN7rS7e43TA_7uu_moreNtB5_5Pager19should_squeeze_line.exit.thread.i._crit_edge, %_RNvMs5_CsgN7rS7e43TA_7uu_moreNtB5_5Pager19should_squeeze_line.exit.thread.thread.i
  ...
  %i.cr = getelementptr inbounds nuw [24 x i8], ptr %i.cq, i64 %.sroa.08.0103.i
...
bb.k:                                             ; preds = %_RNvMs5_CsgN7rS7e43TA_7uu_moreNtB5_5Pager19should_squeeze_line.exit.thread.i
  call void @_RNvNtCs6JMX4GRUq9U_4core9panicking18panic_bounds_check(i64 noundef %.sroa.08.0103.i, i64 noundef %i.bu, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @88) #27
  unreachable
...
.split.i.i:                                       ; preds = %bb.l
  ...
  %.pre158.i = load i64, ptr %.sroa.6.0..sroa_idx.i.i, align 8, !noalias !959
...
_RNvMs5_CsgN7rS7e43TA_7uu_moreNtB5_5Pager14highlight_text.exit.i: ; preds = %_RNvMs5_NtCs7tKScEop1B6_5alloc7raw_vecNtB5_11RawVecInner15try_allocate_inCsgN7rS7e43TA_7uu_more.exit.thread8.i.i, %.split.i.i
  %i.da = phi i64 [ %.pre158.i, %.split.i.i ], [ %i.cu, %_RNvMs5_NtCs7tKScEop1B6_5alloc7raw_vecNtB5_11RawVecInner15try_allocate_inCsgN7rS7e43TA_7uu_more.exit.thread8.i.i ] ; 7 uses
