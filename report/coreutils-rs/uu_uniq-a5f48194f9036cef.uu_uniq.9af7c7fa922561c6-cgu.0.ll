...
begin_hunk_0_@_RNvCsdiTcXS7gKpe_7uu_uniq10opt_parsed:bb.a
  ...
  call fastcc void @_RINvMs0_NtNtNtCsgNwXemyrBWj_12clap_builder6parser7matches11arg_matchesNtB6_10ArgMatches11try_get_oneNtNtCs7tKScEop1B6_5alloc6string6StringECsdiTcXS7gKpe_7uu_uniq(ptr noalias nofree noundef align 8 captures(none) dereferenceable(40) %i.h, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(56) %3, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %1, i64 noundef %2) #23
  tail call void @llvm.experimental.noalias.scope.decl(metadata !357)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.f)
  store ptr %1, ptr %i.f, align 8, !noalias !358
  %i.p = getelementptr inbounds nuw i8, ptr %i.f, i64 8
  store i64 %2, ptr %i.p, align 8, !noalias !358
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e), !noalias !358
  %i.q = load i64, ptr %i.h, align 8, !range !18, !alias.scope !357, !noalias !359, !noundef !5
  %.not.i = icmp eq i64 %i.q, 2
  br i1 %.not.i, label %_RINvMNtNtCsgNwXemyrBWj_12clap_builder6parser5errorNtB3_12MatchesError6unwrapINtNtCs6JMX4GRUq9U_4core6option6OptionRNtNtCs7tKScEop1B6_5alloc6string6StringEECsdiTcXS7gKpe_7uu_uniq.exit, label %bb.b, !prof !9

bb.b:                                             ; preds = %bb.a
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(40) %i.e, ptr noundef nonnull readonly align 8 dereferenceable(40) %i.h, i64 40, i1 false), !noalias !359
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d), !noalias !358
  store ptr %i.f, ptr %i.d, align 8, !noalias !358
  %.sroa.42.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.d, i64 8
  store ptr @_RNvXs1i_NtCs6JMX4GRUq9U_4core3fmtReNtB6_7Display3fmtCsdiTcXS7gKpe_7uu_uniq, ptr %.sroa.42.0..sroa_idx.i, align 8, !noalias !358
  %i.r = getelementptr inbounds nuw i8, ptr %i.d, i64 16
  store ptr %i.e, ptr %i.r, align 8, !noalias !358
  %.sroa.46.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.d, i64 24
  store ptr @_RNvXs0_NtNtCsgNwXemyrBWj_12clap_builder6parser5errorNtB5_12MatchesErrorNtNtCs6JMX4GRUq9U_4core3fmt7Display3fmt, ptr %.sroa.46.0..sroa_idx.i, align 8, !noalias !358
  call void @_RNvNtCs6JMX4GRUq9U_4core9panicking9panic_fmt(ptr noundef nonnull @5, ptr noundef nonnull %i.d, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @7) #24, !noalias !357
  unreachable

_RINvMNtNtCsgNwXemyrBWj_12clap_builder6parser5errorNtB3_12MatchesError6unwrapINtNtCs6JMX4GRUq9U_4core6option6OptionRNtNtCs7tKScEop1B6_5alloc6string6StringEECsdiTcXS7gKpe_7uu_uniq.exit: ; preds = %bb.a
  %i.s = getelementptr inbounds nuw i8, ptr %i.h, i64 8
  %i.t = load ptr, ptr %i.s, align 8, !alias.scope !357, !noalias !359, !align !7, !noundef !5 ; 3 uses
...
bb.c:                                             ; preds = %_RINvMNtNtCsgNwXemyrBWj_12clap_builder6parser5errorNtB3_12MatchesError6unwrapINtNtCs6JMX4GRUq9U_4core6option6OptionRNtNtCs7tKScEop1B6_5alloc6string6StringEECsdiTcXS7gKpe_7uu_uniq.exit
  ...
  switch i64 %i.x, label %thread-pre-split.i [
    i64 0, label %.loopexit126
    i64 1, label %bb.d
  ]

bb.d:                                             ; preds = %bb.c
  %i.y = load i8, ptr %i.v, align 1, !alias.scope !360, !noalias !361, !noundef !5 ; 2 uses
  switch i8 %i.y, label %bb.e [
    i8 43, label %.loopexit126
...
bb.q:                                             ; preds = %thread-pre-split.i17
  ...
  %i.bk = add nsw i64 %2, -1                      ; 3 uses
  %i.bl = icmp samesign ult i64 %2, 17
  br i1 %i.bl, label %.preheader114.i, label %.lr.ph.i13
...
.lr.ph141.i:                                      ; preds = %.preheader114.i, %bb.u
  %.sroa.0.2140.i = phi ptr [ %i.cf, %bb.u ], [ %i.bj, %.preheader114.i ] ; 2 uses
  %.sroa.26.2139.i = phi i64 [ %i.ce, %bb.u ], [ %i.bk, %.preheader114.i ]
  %.sroa.084.2138.i = phi i64 [ %i.ch, %bb.u ], [ 0, %.preheader114.i ]
...
_RNvMsr_NtCs6JMX4GRUq9U_4core3numx27from_ascii_bytes_radix_impl.exit: ; preds = %bb.t, %bb.u, %bb.y, %bb.z, %.preheader.i16, %.preheader114.i
  %.sroa.1561.0 = phi i64 [ %i.ch, %bb.u ], [ 0, %.preheader114.i ], [ %i.de, %bb.z ], [ 0, %.preheader.i16 ], [ %i.cv, %bb.y ], [ %i.by, %bb.t ]
