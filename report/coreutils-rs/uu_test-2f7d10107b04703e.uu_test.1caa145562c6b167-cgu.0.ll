...
bb.ak:                                            ; preds = %bb.aq, %bb.ap, %_RNvXs8_NtNtCs2vKOLqTMYjT_3std3ffi6os_strNtB5_8OsStringNtNtCs6JMX4GRUq9U_4core3cmp9PartialEq2eq.exit347, %_RNvXs8_NtNtCs2vKOLqTMYjT_3std3ffi6os_strNtB5_8OsStringNtNtCs6JMX4GRUq9U_4core3cmp9PartialEq2eq.exit
  ...
  %i.cm = icmp eq i64 %.sroa.4642.0.copyload, 0
...
bb.al:                                            ; preds = %bb.ak
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.5643.0.copyload) ]
  tail call void @_RNvCsjSVV5GABoor_7___rustc14___rust_dealloc(ptr noundef nonnull %.sroa.5643.0.copyload, i64 noundef %.sroa.4642.0.copyload, i64 noundef range(i64 1, -9223372036854775807) 1) #21
...
_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueNtNtNtCs2vKOLqTMYjT_3std3ffi6os_str8OsStringECs2szWGFz6wmN_7uu_test.exit348: ; preds = %bb.ak, %bb.al
  %i.cn = icmp eq i64 %.sroa.4637.0.copyload, 0
...
bb.am:                                            ; preds = %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueNtNtNtCs2vKOLqTMYjT_3std3ffi6os_str8OsStringECs2szWGFz6wmN_7uu_test.exit348
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.5638.0.copyload) ]
  tail call void @_RNvCsjSVV5GABoor_7___rustc14___rust_dealloc(ptr noundef nonnull %.sroa.5638.0.copyload, i64 noundef %.sroa.4637.0.copyload, i64 noundef range(i64 1, -9223372036854775807) 1) #21
...
bb.ap:                                            ; preds = %bb.ao
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.5643.0.copyload) ]
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.5638.0.copyload) ]
  %spec.store.select.i = tail call i64 @llvm.umin.i64(i64 %.sroa.6644.0.copyload, i64 %.sroa.6639.0.copyload)
  %i.cq = tail call i32 @memcmp(ptr nonnull readonly %.sroa.5643.0.copyload, ptr nonnull readonly %.sroa.5638.0.copyload, i64 %spec.store.select.i), !alias.scope !209 ; 2 uses
  %i.cr = sext i32 %i.cq to i64
  %i.cs = icmp eq i32 %i.cq, 0
  %i.ct = sub i64 %.sroa.6644.0.copyload, %.sroa.6639.0.copyload
...
bb.aq:                                            ; preds = %bb.ao
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.5643.0.copyload) ]
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.5638.0.copyload) ]
  %spec.store.select.i351 = tail call i64 @llvm.umin.i64(i64 %.sroa.6644.0.copyload, i64 %.sroa.6639.0.copyload)
  %i.cw = tail call i32 @memcmp(ptr nonnull readonly %.sroa.5643.0.copyload, ptr nonnull readonly %.sroa.5638.0.copyload, i64 %spec.store.select.i351), !alias.scope !213 ; 2 uses
  %i.cx = sext i32 %i.cw to i64
  %i.cy = icmp eq i32 %i.cw, 0
  %i.cz = sub i64 %.sroa.6644.0.copyload, %.sroa.6639.0.copyload
...
bb.ar:                                            ; preds = %bb.y
  ...
  %.sroa.0631.0.copyload = load i64, ptr %i.df, align 8
  %.sroa.4632.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.df, i64 8
  %.sroa.4632.0.copyload = load i64, ptr %.sroa.4632.0..sroa_idx, align 8 ; 4 uses
  %.sroa.5633.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.df, i64 16
  %.sroa.5633.0.copyload = load ptr, ptr %.sroa.5633.0..sroa_idx, align 8 ; 5 uses
  %.sroa.6634.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.df, i64 24
  %.sroa.6634.0.copyload = load i64, ptr %.sroa.6634.0..sroa_idx, align 8 ; 2 uses
  %i.dg = icmp eq i64 %.sroa.0631.0.copyload, 3
  br i1 %i.dg, label %bb.as, label %.thread561, !prof !208

.thread561:                                       ; preds = %bb.y, %bb.ar
...
bb.as:                                            ; preds = %bb.ar
  ...
  br i1 %i.dh, label %.thread563, label %bb.at
...
bb.at:                                            ; preds = %bb.as
  ...
  %.sroa.0646.0.copyload = load i64, ptr %i.dk, align 8
  %.sroa.4647.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.dk, i64 8
  %.sroa.4647.0.copyload = load i64, ptr %.sroa.4647.0..sroa_idx, align 8 ; 4 uses
  %.sroa.5648.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.dk, i64 16
  %.sroa.5648.0.copyload = load ptr, ptr %.sroa.5648.0..sroa_idx, align 8 ; 5 uses
  %.sroa.6649.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.dk, i64 24
  %.sroa.6649.0.copyload = load i64, ptr %.sroa.6649.0..sroa_idx, align 8 ; 2 uses
  %i.dl = icmp eq i64 %.sroa.0646.0.copyload, 3
  br i1 %i.dl, label %bb.au, label %.thread563, !prof !208

.thread563:                                       ; preds = %bb.as, %bb.at
...
bb.au:                                            ; preds = %bb.at
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.5648.0.copyload) ]
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.5633.0.copyload) ]
  ...
  call fastcc void @_RNvMCs2szWGFz6wmN_7uu_testNtB2_7Integer5parse(ptr noalias nofree noundef align 8 captures(none) dereferenceable(24) %i.m, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %.sroa.5648.0.copyload, i64 noundef %.sroa.6649.0.copyload) #21, !noalias !223
...
bb.av:                                            ; preds = %bb.au
  ...
  call fastcc void @_RNvMCs2szWGFz6wmN_7uu_testNtB2_7Integer5parse(ptr noalias nofree noundef align 8 captures(none) dereferenceable(24) %i.l, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %.sroa.5633.0.copyload, i64 noundef %.sroa.6634.0.copyload) #21, !noalias !225
...
bb.aw:                                            ; preds = %bb.au
  ...
  store ptr %.sroa.5648.0.copyload, ptr %.sroa.435.0..sroa_idx.i, align 8, !noalias !217
  %.sroa.5.0..sroa_idx.i355 = getelementptr inbounds nuw i8, ptr %i.j, i64 16
  store i64 %.sroa.6649.0.copyload, ptr %.sroa.5.0..sroa_idx.i355, align 8, !noalias !217
...
bb.bc:                                            ; preds = %bb.bb
  ...
  %i.dz = tail call i8 @llvm.scmp.i8.i32(i32 %i.dy, i32 0)
  br label %bb.bd
...
bb.be:                                            ; preds = %bb.av
  ...
  store ptr %.sroa.5633.0.copyload, ptr %.sroa.445.0..sroa_idx.i, align 8, !noalias !217
  %.sroa.546.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.i, i64 16
  store i64 %.sroa.6634.0.copyload, ptr %.sroa.546.0..sroa_idx.i, align 8, !noalias !217
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.p = tail call i8 @llvm.scmp.i8.i32(i32 %i.o, i32 0)
  br label %bb.f
...
declare noalias noundef ptr @_RNvCsjSVV5GABoor_7___rustc12___rust_alloc(i64 noundef, i64 allocalign noundef range(i64 1, -9223372036854775807)) unnamed_addr #15
...
; Function Attrs: nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none)
declare { i64, i1 } @llvm.ssub.with.overflow.i64(i64, i64) #16
...
attributes #15 = { nounwind nonlazybind allockind("alloc,uninitialized,aligned") allocsize(0) uwtable "alloc-family"="__rust_alloc" "alloc-variant-zeroed"="_RNvCsjSVV5GABoor_7___rustc19___rust_alloc_zeroed" "probe-stack"="inline-asm" "target-cpu"="x86-64" }
