...
bb.cl:                                            ; preds = %bb.i
  ...
  %i.ii = load i64, ptr %i.p, align 8, !range !10, !noundef !4
  %i.ij = trunc nuw i64 %i.ii to i1
  br i1 %i.ij, label %bb.cx, label %bb.cy, !prof !13
...
bb.cy:                                            ; preds = %bb.cl
  ...
  %i.je = load ptr, ptr %i.jd, align 8, !nonnull !4, !noundef !4 ; 20 uses
  %i.jf = getelementptr inbounds nuw i8, ptr %i.p, i64 16
  %i.jg = load i64, ptr %i.jf, align 8, !noundef !4
  call void @llvm.lifetime.end.p0(ptr nonnull %i.p)
  %i.jh = load i64, ptr %i.y, align 8, !noundef !4 ; 3 uses
...
bb.cz:                                            ; preds = %bb.cy
  ...
  %i.jk = load i64, ptr %1, align 8, !range !5, !noundef !4
  %i.jl = icmp samesign ult i64 %i.jj, %i.jk
  tail call void @llvm.assume(i1 %i.jl)
  %i.jm = load ptr, ptr %i.ae, align 8, !nonnull !4, !noundef !4
  ...
  br i1 %i.jp, label %bb.da, label %.thread590, !prof !236
...
bb.da:                                            ; preds = %bb.cz
  ...
  br i1 %cond, label %bb.db, label %bb.en, !prof !254
...
bb.eh:                                            ; preds = %bb.eg
  ...
  %i.ob = load i64, ptr %i.t, align 8, !range !12, !noundef !4 ; 2 uses
...
bb.em:                                            ; preds = %bb.ek
  ...
  br i1 %i.ov, label %bb.eo, label %bb.en, !prof !255
...
bb.b:                                             ; preds = %bb.a
  ...
  call void @_RNvNtNtCs2vKOLqTMYjT_3std3sys2fs8metadata(ptr noalias nofree noundef nonnull sret([176 x i8]) align 8 captures(address) dereferenceable(176) %i.c, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %0, i64 noundef %1) #21, !noalias !279
  %i.j = load i64, ptr %i.c, align 8, !range !14, !noalias !278, !noundef !4 ; 2 uses
  %i.k = icmp eq i64 %i.j, 2
  %i.l = getelementptr inbounds nuw i8, ptr %i.c, i64 8
  %i.m = load ptr, ptr %i.l, align 8, !noalias !280
...
bb.c:                                             ; preds = %bb.b
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(160) %.sroa.15, ptr noundef nonnull align 8 dereferenceable(160) %.sroa.15.0..sroa_idx7, i64 160, i1 false), !noalias !280
...
bb.d:                                             ; preds = %bb.a
  ...
  call void @_RNvNtNtCs2vKOLqTMYjT_3std3sys2fs16symlink_metadata(ptr noalias nofree noundef nonnull sret([176 x i8]) align 8 captures(address) dereferenceable(176) %i.b, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %0, i64 noundef %1) #21, !noalias !282
  %i.n = load i64, ptr %i.b, align 8, !range !14, !noalias !281, !noundef !4 ; 2 uses
  %i.o = icmp eq i64 %i.n, 2
  %i.p = getelementptr inbounds nuw i8, ptr %i.b, i64 8
  %i.q = load ptr, ptr %i.p, align 8, !noalias !283
...
bb.e:                                             ; preds = %bb.d
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(160) %.sroa.15, ptr noundef nonnull align 8 dereferenceable(160) %.sroa.15.0..sroa_idx8, i64 160, i1 false), !noalias !283
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.t = load i32, ptr %i.s, align 8, !noundef !4 ; 13 uses
...
bb.k:                                             ; preds = %bb.g
  ...
  %i.ab = load i32, ptr %i.aa, align 8, !range !15, !alias.scope !284, !noalias !285, !noundef !4 ; 2 uses
  %i.ac = icmp eq i32 %i.ab, -1
  br i1 %i.ac, label %bb.l, label %_RNvMNtCs6JMX4GRUq9U_4core6resultINtB2_6ResultNtNtCs2vKOLqTMYjT_3std4time10SystemTimeNtNtNtB4_2io5error5ErrorE6unwrapCs2szWGFz6wmN_7uu_test.exit4, !prof !13

bb.l:                                             ; preds = %bb.k
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d), !noalias !286
  %i.ad = load ptr, ptr %i.g, align 8, !alias.scope !284, !noalias !285, !nonnull !4, !noundef !4
  store ptr %i.ad, ptr %i.d, align 8, !noalias !286
  call void @_RNvNtCs6JMX4GRUq9U_4core6result13unwrap_failed(ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) @33, i64 noundef 43, ptr noundef nonnull %i.d, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) @32, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @15) #22, !noalias !284
  unreachable
...
_RNvMNtCs6JMX4GRUq9U_4core6resultINtB2_6ResultNtNtCs2vKOLqTMYjT_3std4time10SystemTimeNtNtNtB4_2io5error5ErrorE6unwrapCs2szWGFz6wmN_7uu_test.exit4: ; preds = %bb.k
  %i.ae = load i64, ptr %i.g, align 8, !alias.scope !284, !noalias !285, !noundef !4 ; 2 uses
  ...
  %i.ag = load i32, ptr %i.af, align 8, !range !15, !alias.scope !287, !noalias !288, !noundef !4 ; 2 uses
  %i.ah = icmp eq i32 %i.ag, -1
  br i1 %i.ah, label %bb.m, label %_RNvMNtCs6JMX4GRUq9U_4core6resultINtB2_6ResultNtNtCs2vKOLqTMYjT_3std4time10SystemTimeNtNtNtB4_2io5error5ErrorE6unwrapCs2szWGFz6wmN_7uu_test.exit, !prof !13
...
bb.m:                                             ; preds = %_RNvMNtCs6JMX4GRUq9U_4core6resultINtB2_6ResultNtNtCs2vKOLqTMYjT_3std4time10SystemTimeNtNtNtB4_2io5error5ErrorE6unwrapCs2szWGFz6wmN_7uu_test.exit4
  ...
  %i.ai = load ptr, ptr %i.f, align 8, !alias.scope !287, !noalias !288, !nonnull !4, !noundef !4
  store ptr %i.ai, ptr %i.e, align 8, !noalias !289
  call void @_RNvNtCs6JMX4GRUq9U_4core6result13unwrap_failed(ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) @33, i64 noundef 43, ptr noundef nonnull %i.e, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) @32, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @16) #22, !noalias !287
  unreachable
...
_RNvMNtCs6JMX4GRUq9U_4core6resultINtB2_6ResultNtNtCs2vKOLqTMYjT_3std4time10SystemTimeNtNtNtB4_2io5error5ErrorE6unwrapCs2szWGFz6wmN_7uu_test.exit: ; preds = %_RNvMNtCs6JMX4GRUq9U_4core6resultINtB2_6ResultNtNtCs2vKOLqTMYjT_3std4time10SystemTimeNtNtNtB4_2io5error5ErrorE6unwrapCs2szWGFz6wmN_7uu_test.exit4
  %i.aj = load i64, ptr %i.f, align 8, !alias.scope !287, !noalias !288, !noundef !4 ; 2 uses
...
bb.p:                                             ; preds = %bb.g
  ...
  %i.as = load i32, ptr %i.ar, align 8, !noundef !4
