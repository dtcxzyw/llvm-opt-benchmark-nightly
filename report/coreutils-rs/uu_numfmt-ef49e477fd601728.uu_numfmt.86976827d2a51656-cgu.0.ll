...
._crit_edge69:                                    ; preds = %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueNtNtCs7tKScEop1B6_5alloc6string6StringECsbyqtxyC5WYI_9uu_numfmt.exit, %._crit_edge
  ...
  %i.cg = load ptr, ptr %i.g, align 8, !noundef !4 ; 2 uses
...
bb.i:                                             ; preds = %bb.f, %bb.h, %bb.g
  ...
  %i.cm = load i64, ptr %i.i, align 8, !range !5, !alias.scope !1900, !noundef !4
  %i.cn = sub nsw i64 %i.cm, %i.x
  %i.co = icmp ugt i64 %.sroa.0.0.i28, %i.cn
  br i1 %i.co, label %bb.j, label %_RNvMs_NtCs7tKScEop1B6_5alloc3vecINtB4_3VechE7reserveCsbyqtxyC5WYI_9uu_numfmt.exit.i29, !prof !15
...
_RNvMs_NtCs7tKScEop1B6_5alloc3vecINtB4_3VechE7reserveCsbyqtxyC5WYI_9uu_numfmt.exit.i29: ; preds = %bb.j, %bb.i
  %i.cp = load ptr, ptr %.sroa.4.0..sroa_idx, align 8, !alias.scope !1899, !nonnull !4, !noundef !4 ; 2 uses
...
bb.o:                                             ; preds = %bb.n
  ...
  store i8 %i.dk, ptr %i.cq, align 1, !noalias !1899
  %i.dl = getelementptr inbounds nuw i8, ptr %i.cq, i64 1
  store i8 %i.cy, ptr %i.dl, align 1, !noalias !1899
  %i.dm = getelementptr inbounds nuw i8, ptr %i.cq, i64 2
  store i8 %i.cu, ptr %i.dm, align 1, !noalias !1899
  br label %_RNvMNtCs7tKScEop1B6_5alloc6stringNtB2_6String4push.exit

bb.p:                                             ; preds = %bb.n
  store i8 %i.df, ptr %i.cq, align 1, !noalias !1899
  %i.dn = getelementptr inbounds nuw i8, ptr %i.cq, i64 1
  store i8 %i.dc, ptr %i.dn, align 1, !noalias !1899
  %i.do = getelementptr inbounds nuw i8, ptr %i.cq, i64 2
  store i8 %i.cy, ptr %i.do, align 1, !noalias !1899
  %i.dp = getelementptr inbounds nuw i8, ptr %i.cq, i64 3
  store i8 %i.cu, ptr %i.dp, align 1, !noalias !1899
  br label %_RNvMNtCs7tKScEop1B6_5alloc6stringNtB2_6String4push.exit
...
_RNvMNtCs7tKScEop1B6_5alloc6stringNtB2_6String4push.exit: ; preds = %bb.l, %bb.m, %bb.o, %bb.p
  ...
  store i64 %i.dq, ptr %.sroa.5.0..sroa_idx, align 8, !alias.scope !1899
...
.split22:                                         ; preds = %bb.r
  ...
  %.sroa.4.0.copyload = load ptr, ptr %.sroa.4.0..sroa_idx38, align 8, !nonnull !4, !noundef !4 ; 2 uses
  ...
  %i.du = load i64, ptr %i.i, align 8, !range !5, !alias.scope !1902, !noundef !4
  %i.dv = sub i64 %i.du, %i.x
  %i.dw = icmp ugt i64 %.sroa.6.0.copyload, %i.dv
  br i1 %i.dw, label %_RNvMs_NtCs7tKScEop1B6_5alloc3vecINtB4_3VechE7reserveCsbyqtxyC5WYI_9uu_numfmt.exit.thread.i32, label %_RNvMs_NtCs7tKScEop1B6_5alloc3vecINtB4_3VechE7reserveCsbyqtxyC5WYI_9uu_numfmt.exit.i30, !prof !15
...
_RNvMs_NtCs7tKScEop1B6_5alloc3vecINtB4_3VechE7reserveCsbyqtxyC5WYI_9uu_numfmt.exit.thread.i32: ; preds = %.split22
  ...
  %i.dx = load i64, ptr %.sroa.5.0..sroa_idx, align 8, !alias.scope !1901, !noundef !4 ; 2 uses
  %i.dy = icmp sgt i64 %i.dx, -1
  call void @llvm.assume(i1 %i.dy)
  %.pre = load ptr, ptr %.sroa.4.0..sroa_idx, align 8, !alias.scope !1901
  br label %bb.s
...
bb.s:                                             ; preds = %_RNvMs_NtCs7tKScEop1B6_5alloc3vecINtB4_3VechE7reserveCsbyqtxyC5WYI_9uu_numfmt.exit.i30, %_RNvMs_NtCs7tKScEop1B6_5alloc3vecINtB4_3VechE7reserveCsbyqtxyC5WYI_9uu_numfmt.exit.thread.i32
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.ec, ptr nonnull readonly align 1 %.sroa.4.0.copyload, i64 %.sroa.6.0.copyload, i1 false), !noalias !1901
...
_RNvMs_NtCs7tKScEop1B6_5alloc3vecINtB4_3VechE15append_elementsCsbyqtxyC5WYI_9uu_numfmt.exit33: ; preds = %_RNvMs_NtCs7tKScEop1B6_5alloc3vecINtB4_3VechE7reserveCsbyqtxyC5WYI_9uu_numfmt.exit.i30, %bb.s
  ...
  store i64 %i.ef, ptr %.sroa.5.0..sroa_idx, align 8, !alias.scope !1901
...
bb.t:                                             ; preds = %_RNvMs_NtCs7tKScEop1B6_5alloc3vecINtB4_3VechE15append_elementsCsbyqtxyC5WYI_9uu_numfmt.exit33
  call void @_RNvCsjSVV5GABoor_7___rustc14___rust_dealloc(ptr noundef nonnull %.sroa.4.0.copyload, i64 noundef %.sroa.037.0.copyload, i64 noundef range(i64 1, -9223372036854775807) 1) #26, !noalias !1903
  br label %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueNtNtCs7tKScEop1B6_5alloc6string6StringECsbyqtxyC5WYI_9uu_numfmt.exit36
...
bb.a:
  ...
  %.sroa.2.i.i = alloca double, align 8           ; 5 uses
  %.sroa.7.i.i = alloca double, align 8           ; 5 uses
  %.sroa.12.i.i = alloca double, align 8          ; 5 uses
  %.sroa.17.i.i = alloca double, align 8          ; 5 uses
  %.sroa.22.i.i = alloca double, align 8          ; 5 uses
  %.sroa.27.i.i = alloca double, align 8          ; 5 uses
  %.sroa.32.i.i = alloca double, align 8          ; 5 uses
  %.sroa.37.i.i = alloca double, align 8          ; 5 uses
  %.sroa.42.i.i = alloca double, align 8          ; 5 uses
  %.sroa.47.i.i = alloca double, align 8          ; 5 uses
  ...
  %i.bo = load i64, ptr %i.bn, align 8, !range !16, !noundef !4
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.bq = load i64, ptr %i.bp, align 8, !noundef !4 ; 4 uses
...
_RNvMNtCs6JMX4GRUq9U_4core5sliceSh9ends_withCsbyqtxyC5WYI_9uu_numfmt.exit: ; preds = %bb.b
  ...
  %bcmp.i.i = tail call i32 @bcmp(ptr nonnull readonly %i.bs, ptr nonnull readonly %i.bu, i64 range(i64 0, -9223372036854775808) %i.bq), !alias.scope !2049
...
_RNvMNtCs6JMX4GRUq9U_4core5sliceSh9ends_withCsbyqtxyC5WYI_9uu_numfmt.exit.thread: ; preds = %_RNvMNtCs6JMX4GRUq9U_4core5sliceSh9ends_withCsbyqtxyC5WYI_9uu_numfmt.exit, %bb.b, %bb.a
  ...
  %i.by = load i64, ptr %i.bx, align 8, !range !14, !noundef !4
...
bb.d:                                             ; preds = %_RNvMNtCs6JMX4GRUq9U_4core5sliceSh9ends_withCsbyqtxyC5WYI_9uu_numfmt.exit.thread
  ...
  %i.cd = load i8, ptr %i.cc, align 1, !range !22, !noundef !4 ; 2 uses
...
_RNvNtCsbyqtxyC5WYI_9uu_numfmt6format24parse_implicit_precision.exit: ; preds = %_RNCINvNvXs0_NtNtNtCs6JMX4GRUq9U_4core4iter8adapters10take_whileINtBa_9TakeWhileppENtNtNtBe_6traits8iterator8Iterator8try_fold5checkcjINtNtNtBg_3ops9try_trait17NeverShortCircuitjENvMNtNtBg_4char7methodsc14is_ascii_digitNCINvMB2a_B27_10wrap_mut_2jcNCNvYIB10_NtNtNtBg_3str4iter5CharsB2Q_EB1i_5count0E0E0CsbyqtxyC5WYI_9uu_numfmt.exit.i.i.i.i, %bb.p, %bb.n, %_RINvMNtCs6JMX4GRUq9U_4core3stre10split_onceReECsbyqtxyC5WYI_9uu_numfmt.exit.thread.i, %bb.l, %bb.j, %bb.d, %bb.c
  ...
  %i.ch = load i64, ptr %i.bm, align 16, !range !6, !noundef !4 ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.cn = load i8, ptr %i.cm, align 1, !noalias !2050, !noundef !4 ; 3 uses
...
_RNvXs2K_NtNtCs6JMX4GRUq9U_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits12double_ended19DoubleEndedIterator9next_backCsbyqtxyC5WYI_9uu_numfmt.exit17.i: ; preds = %bb.f
  ...
  %i.cr = load i8, ptr %i.cq, align 1, !noalias !2050, !noundef !4 ; 3 uses
  %i.cs = and i8 %i.cr, 31
...
_RNvXs2K_NtNtCs6JMX4GRUq9U_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits12double_ended19DoubleEndedIterator9next_backCsbyqtxyC5WYI_9uu_numfmt.exit19.i: ; preds = %_RNvXs2K_NtNtCs6JMX4GRUq9U_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits12double_ended19DoubleEndedIterator9next_backCsbyqtxyC5WYI_9uu_numfmt.exit17.i
  ...
  %i.cy = load i8, ptr %i.cx, align 1, !noalias !2050, !noundef !4 ; 3 uses
  %i.cz = and i8 %i.cy, 15
...
_RNvXs2K_NtNtCs6JMX4GRUq9U_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits12double_ended19DoubleEndedIterator9next_backCsbyqtxyC5WYI_9uu_numfmt.exit21.i: ; preds = %_RNvXs2K_NtNtCs6JMX4GRUq9U_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits12double_ended19DoubleEndedIterator9next_backCsbyqtxyC5WYI_9uu_numfmt.exit19.i
  ...
  %i.di = load i8, ptr %i.dh, align 1, !noalias !2050, !noundef !4
  %i.dj = and i8 %i.di, 7
...
bb.m:                                             ; preds = %bb.e, %bb.k, %bb.l
  ...
  %i.dy = tail call { ptr, i64 } @_RNvNtNtNtCsh036I4OHgIr_6uucore8features4i18n7decimal24locale_decimal_separator() #26, !noalias !2051 ; 2 uses
  %i.dz = extractvalue { ptr, i64 } %i.dy, 0
  %i.ea = extractvalue { ptr, i64 } %i.dy, 1
  call void @llvm.lifetime.start.p0(ptr nonnull %i.bb), !noalias !2052
  call void @llvm.lifetime.start.p0(ptr nonnull %i.ba), !noalias !2052
  call void @_RNvMsu_NtNtCs6JMX4GRUq9U_4core3str7patternNtB5_11StrSearcher3new(ptr noalias nofree noundef nonnull sret([104 x i8]) align 8 captures(none) dereferenceable(104) %i.ba, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %1, i64 noundef %.sroa.7.0, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %i.dz, i64 noundef %i.ea) #26, !noalias !2053
end_hunk_0
