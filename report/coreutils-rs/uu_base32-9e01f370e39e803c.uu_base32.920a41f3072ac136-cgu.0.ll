...
_RNvXs_NtCs7tKScEop1B6_5alloc5allocNtB4_6GlobalNtNtCs6JMX4GRUq9U_4core5alloc9Allocator8allocate.exit.i: ; preds = %bb.f
  tail call void @_RNvCsjSVV5GABoor_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #23, !noalias !984
  %i.p = tail call noundef ptr @_RNvCsjSVV5GABoor_7___rustc12___rust_alloc(i64 noundef range(i64 0, -9223372036854775808) %i.k, i64 noundef range(i64 1, 9) 1) #23, !noalias !984 ; 3 uses
...
._crit_edge:                                      ; preds = %bb.al, %bb.j
  ...
  call void @_RNvCsjSVV5GABoor_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #23, !noalias !985
  %i.af = call noundef align 8 dereferenceable_or_null(32) ptr @_RNvCsjSVV5GABoor_7___rustc12___rust_alloc(i64 noundef range(i64 0, -9223372036854775808) 32, i64 noundef range(i64 1, 9) 8) #23, !noalias !985 ; 4 uses
  %i.ag = icmp eq ptr %i.af, null
  br i1 %i.ag, label %bb.k, label %_RNvNtCs7tKScEop1B6_5alloc5boxed14box_new_uninit.exit, !prof !24

bb.k:                                             ; preds = %._crit_edge
  call void @_RNvNtCs7tKScEop1B6_5alloc5alloc18handle_alloc_error(i64 noundef 8, i64 noundef 32) #26, !noalias !985
  unreachable
...
bb.m:                                             ; preds = %_RNvNtCs7tKScEop1B6_5alloc5boxed14box_new_uninit.exit
  ...
  store ptr %i.am, ptr %i.an, align 8, !alias.scope !987, !noalias !986
  store i8 3, ptr %i.a, align 8, !alias.scope !987, !noalias !986
  call void @_RNvXsd_NtNtCs6JMX4GRUq9U_4core2io5errorNtB5_11CustomOwnerNtNtNtB9_3ops4drop4Drop4drop(ptr noalias nofree noundef nonnull align 8 dereferenceable(8) %i.an) #23, !noalias !986
  br label %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueNtNtNtB4_2io5error5ErrorECscxmO3cvmuC8_9uu_base32.exit
...
_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueINtNtB4_6option6OptionNtNtNtCscxmO3cvmuC8_9uu_base3211base_common11fast_encode12LineWrappingEEB13_.exit105.sink.split: ; preds = %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueINtNtNtCs7tKScEop1B6_5alloc11collections9vec_deque8VecDequehEECscxmO3cvmuC8_9uu_base32.exit, %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueINtNtNtCs7tKScEop1B6_5alloc11collections9vec_deque8VecDequehEECscxmO3cvmuC8_9uu_base32.exit102
  ...
  %.val100 = load ptr, ptr %i.bh, align 8, !nonnull !9, !noundef !9
...
bb.w:                                             ; preds = %bb.an, %bb.ap, %bb.ae, %bb.ac, %bb.s, %bb.q, %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueNtNtNtB4_2io5error5ErrorECscxmO3cvmuC8_9uu_base32.exit
  ...
  %.val = load i64, ptr %i.e, align 8, !range !10, !noundef !9 ; 2 uses
...
bb.z:                                             ; preds = %bb.p
  ...
  %i.bo = load i64, ptr %i.e, align 8, !range !10, !alias.scope !989, !noundef !9
...
_RNvMs_NtCs7tKScEop1B6_5alloc3vecINtB4_3VechE7reserveCscxmO3cvmuC8_9uu_base32.exit.thread.i: ; preds = %bb.z
  ...
  %i.br = load i64, ptr %i.s, align 8, !alias.scope !988, !noundef !9 ; 2 uses
  %i.bs = icmp sgt i64 %i.br, -1
  call void @llvm.assume(i1 %i.bs)
  %.pre = load ptr, ptr %i.r, align 8, !alias.scope !988
  br label %bb.aa
...
bb.aa:                                            ; preds = %_RNvMs_NtCs7tKScEop1B6_5alloc3vecINtB4_3VechE7reserveCscxmO3cvmuC8_9uu_base32.exit.i, %_RNvMs_NtCs7tKScEop1B6_5alloc3vecINtB4_3VechE7reserveCscxmO3cvmuC8_9uu_base32.exit.thread.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.bv, ptr nonnull readonly align 1 %i.ar, i64 %..i, i1 false), !noalias !988
...
_RNvMs_NtCs7tKScEop1B6_5alloc3vecINtB4_3VechE15append_elementsCscxmO3cvmuC8_9uu_base32.exit: ; preds = %_RNvMs_NtCs7tKScEop1B6_5alloc3vecINtB4_3VechE7reserveCscxmO3cvmuC8_9uu_base32.exit.i, %bb.aa
  ...
  store i64 %i.by, ptr %i.s, align 8, !alias.scope !988
...
bb.ab:                                            ; preds = %_RNvMs_NtCs7tKScEop1B6_5alloc3vecINtB4_3VechE15append_elementsCscxmO3cvmuC8_9uu_base32.exit
  ...
  %i.cc = call { ptr, ptr } %.val89(ptr noundef nonnull %4, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %i.cb, i64 noundef range(i64 0, -9223372036854775808) %i.k, ptr noalias nofree noundef nonnull align 8 dereferenceable(32) %i.f) #25, !inline_history !979 ; 2 uses
...
bb.ak:                                            ; preds = %bb.ai
  %i.cu = call { ptr, ptr } %.val89(ptr noundef nonnull %4, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %.sroa.043.0, i64 noundef range(i64 0, -9223372036854775808) %i.k, ptr noalias nofree noundef nonnull align 8 dereferenceable(32) %i.f) #25, !inline_history !979 ; 2 uses
...
bb.am:                                            ; preds = %bb.ag
  ...
  %i.dc = load i64, ptr %i.e, align 8, !range !10, !alias.scope !991, !noundef !9
...
_RNvMs_NtCs7tKScEop1B6_5alloc3vecINtB4_3VechE7reserveCscxmO3cvmuC8_9uu_base32.exit.thread.i112: ; preds = %bb.am
  ...
  %i.df = load i64, ptr %i.s, align 8, !alias.scope !990, !noundef !9
...
_RNvMs_NtCs7tKScEop1B6_5alloc3vecINtB4_3VechE15append_elementsCscxmO3cvmuC8_9uu_base32.exit113: ; preds = %bb.am, %_RNvMs_NtCs7tKScEop1B6_5alloc3vecINtB4_3VechE7reserveCscxmO3cvmuC8_9uu_base32.exit.thread.i112
  ...
  %i.dh = load ptr, ptr %i.r, align 8, !alias.scope !990, !nonnull !9, !noundef !9 ; 2 uses
  %i.di = getelementptr inbounds nuw i8, ptr %i.dh, i64 %.sink172
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.di, ptr nonnull readonly align 1 %i.db, i64 %gepdiff, i1 false), !noalias !990
  %i.dj = add i64 %.sink172, %gepdiff             ; 3 uses
  store i64 %i.dj, ptr %i.s, align 8, !alias.scope !990
  br label %bb.al
