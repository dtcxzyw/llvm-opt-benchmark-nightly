...
_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueNtNtCs2vKOLqTMYjT_3std4path7PathBufECsfvoB946XvKl_8uu_mkdir.exit: ; preds = %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueNtNtCs2vKOLqTMYjT_3std4path7PathBufECsfvoB946XvKl_8uu_mkdir.exit.backedge, %bb.a
  ...
  %.sroa.10.0 = phi ptr [ %.sroa.10.0.copyload, %bb.a ], [ %.sroa.10.189, %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueNtNtCs2vKOLqTMYjT_3std4path7PathBufECsfvoB946XvKl_8uu_mkdir.exit.backedge ] ; 3 uses
  ...
  %.sroa.4.0 = phi ptr [ %.sroa.4.0.copyload, %bb.a ], [ %.sroa.4.186, %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueNtNtCs2vKOLqTMYjT_3std4path7PathBufECsfvoB946XvKl_8uu_mkdir.exit.backedge ] ; 2 uses
  ...
  %.not.i.i.i92 = icmp eq ptr %.sroa.7.0, null
  %i.o = icmp eq ptr %.sroa.7.0, %.sroa.10.0
  %or.cond93 = select i1 %.not.i.i.i92, i1 true, i1 %i.o
  br i1 %or.cond93, label %select.unfold.i.i, label %.loopexit
...
select.unfold.i.i:                                ; preds = %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueNtNtCs2vKOLqTMYjT_3std4path7PathBufECsfvoB946XvKl_8uu_mkdir.exit, %bb.b
  %.sroa.4.195 = phi ptr [ %i.q, %bb.b ], [ %.sroa.4.0, %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueNtNtCs2vKOLqTMYjT_3std4path7PathBufECsfvoB946XvKl_8uu_mkdir.exit ] ; 6 uses
  %.sroa.10.194 = phi ptr [ %i.t, %bb.b ], [ %.sroa.10.0, %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueNtNtCs2vKOLqTMYjT_3std4path7PathBufECsfvoB946XvKl_8uu_mkdir.exit ]
  %.not.i5.i.i = icmp eq ptr %.sroa.4.195, null
  %i.p = icmp eq ptr %.sroa.4.195, %.sroa.6.0.copyload
  %or.cond.i.i.i = select i1 %.not.i5.i.i, i1 true, i1 %i.p
  br i1 %or.cond.i.i.i, label %bb.c, label %bb.b

bb.b:                                             ; preds = %select.unfold.i.i
  %i.q = getelementptr inbounds nuw i8, ptr %.sroa.4.195, i64 24 ; 2 uses
  %i.r = getelementptr i8, ptr %.sroa.4.195, i64 8
  %.val.i.i = load ptr, ptr %i.r, align 8, !noalias !231, !nonnull !4, !noundef !4 ; 2 uses
  %i.s = getelementptr i8, ptr %.sroa.4.195, i64 16
...
bb.d:                                             ; preds = %.loopexit, %.sink.split.i8.i.i
  %.sroa.10.189 = phi ptr [ %.sroa.10.194, %.sink.split.i8.i.i ], [ %.sroa.10.1.lcssa, %.loopexit ]
  %.sroa.4.186 = phi ptr [ %.sroa.4.195, %.sink.split.i8.i.i ], [ %.sroa.4.1.lcssa, %.loopexit ]
