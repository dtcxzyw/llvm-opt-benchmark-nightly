...
bb.c:                                             ; preds = %bb.a
  ...
  call void @_RNvNtNtCsh036I4OHgIr_6uucore4mods5error11strip_errno(ptr noalias nofree noundef nonnull sret([24 x i8]) align 8 captures(none) dereferenceable(24) %i.o, ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(8) %i.u) #23
  call void @llvm.lifetime.start.p0(ptr nonnull %i.n)
  store ptr %i.o, ptr %i.n, align 8
  %.sroa.45.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.n, i64 8
  store ptr @_RNvXsq_NtCs7tKScEop1B6_5alloc6stringNtB5_6StringNtNtCs6JMX4GRUq9U_4core3fmt7Display3fmt, ptr %.sroa.45.0..sroa_idx, align 8
  %i.v = load ptr, ptr %1, align 8, !nonnull !8, !noundef !8
  %i.w = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.x = load ptr, ptr %i.w, align 8, !nonnull !8, !align !17, !noundef !8
  %i.y = call noundef zeroext i1 @_RNvNtCs6JMX4GRUq9U_4core3fmt5write(ptr noundef nonnull %i.v, ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(48) %i.x, ptr noundef nonnull @28, ptr noundef nonnull %i.n) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %i.n)
  %.val110 = load i64, ptr %i.o, align 8, !range !11, !noundef !8 ; 2 uses
  %i.z = icmp eq i64 %.val110, 0
  br i1 %i.z, label %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueNtNtCs7tKScEop1B6_5alloc6string6StringECskBwnbTnIhiv_6uu_cat.exit, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.aa = getelementptr inbounds nuw i8, ptr %i.o, i64 8
  %.val111 = load ptr, ptr %i.aa, align 8, !nonnull !8, !noundef !8
  call void @_RNvCsjSVV5GABoor_7___rustc14___rust_dealloc(ptr noundef nonnull %.val111, i64 noundef %.val110, i64 noundef range(i64 1, -9223372036854775807) 1) #23
  br label %_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueNtNtCs7tKScEop1B6_5alloc6string6StringECskBwnbTnIhiv_6uu_cat.exit

_RINvNtCs6JMX4GRUq9U_4core3ptr9drop_glueNtNtCs7tKScEop1B6_5alloc6string6StringECskBwnbTnIhiv_6uu_cat.exit: ; preds = %bb.c, %bb.d
...
bb.e:                                             ; preds = %bb.a
  ...
  %.sroa.5.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.l, i64 16 ; 6 uses
  store i64 0, ptr %.sroa.5.0..sroa_idx, align 8
  %i.ab = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.ac = load ptr, ptr %i.ab, align 8, !nonnull !8, !noundef !8
  %i.ad = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.ae = load i64, ptr %i.ad, align 8, !noundef !8 ; 18 uses
  %.not.i = icmp slt i64 %i.ae, 0
  br i1 %.not.i, label %bb.p, label %bb.f, !prof !19
