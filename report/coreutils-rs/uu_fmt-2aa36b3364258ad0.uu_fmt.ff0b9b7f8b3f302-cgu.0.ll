...
_RNvMsr_NtCs6JMX4GRUq9U_4core3numx27from_ascii_bytes_radix_impl.exit326: ; preds = %bb.co, %bb.cp, %bb.ct, %bb.cu, %.preheader.i317
  %.sroa.15416.0 = phi i64 [ %i.om, %bb.ct ], [ %i.ny, %bb.cp ], [ %i.ov, %bb.cu ], [ 0, %.preheader.i317 ], [ %i.np, %bb.co ]
