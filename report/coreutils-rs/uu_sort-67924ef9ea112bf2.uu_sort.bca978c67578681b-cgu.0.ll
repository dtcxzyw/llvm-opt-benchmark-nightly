...
begin_hunk_0_@_RNvCsgcf5BHVXlUt_7uu_sort10compare_by:bb.a
  ...
  %i.du = load i64, ptr %i.dt, align 8, !range !540, !noundef !5
...
bb.au:                                            ; preds = %bb.am
  %i.hn = call fastcc { i8, i64 } @_RNvCsgcf5BHVXlUt_7uu_sort11month_parse(ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %.sroa.039.0, i64 noundef range(i64 0, -9223372036854775808) %.sroa.10.0) #34, !noalias !9485
  %i.ho = extractvalue { i8, i64 } %i.hn, 0
  %i.hp = call fastcc { i8, i64 } @_RNvCsgcf5BHVXlUt_7uu_sort11month_parse(ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %.sroa.054.0, i64 noundef range(i64 0, -9223372036854775808) %.sroa.1062.0) #34, !noalias !9488
...
bb.ba:                                            ; preds = %bb.ay
  ...
  %i.io = load i8, ptr %i.in, align 8, !range !69, !noalias !9490, !noundef !5 ; 5 uses
  %i.ip = getelementptr inbounds nuw i8, ptr %i.il, i64 8
  %i.iq = load i8, ptr %i.ip, align 8, !range !69, !noalias !9490, !noundef !5 ; 2 uses
  %.not.i = icmp eq i8 %i.io, %i.iq
  br i1 %.not.i, label %bb.bb, label %bb.bc

bb.bb:                                            ; preds = %bb.ba
  %i.ir = load i64, ptr %i.ik, align 8, !noalias !9490, !noundef !5 ; 2 uses
  %i.is = load i64, ptr %i.il, align 8, !noalias !9490, !noundef !5 ; 2 uses
...
.lr.ph869:                                        ; preds = %bb.bg, %bb.bh
  ...
  %.val.i = load i8, ptr %.sroa.0179.1866, align 1, !noalias !9494, !noundef !5 ; 3 uses
...
.lr.ph878:                                        ; preds = %_RINvYINtNtNtCs6JMX4GRUq9U_4core5slice4iter4IterhENtNtNtNtBa_4iter6traits8iterator8Iterator8try_folduNCINvNtNtBR_8adapters6copied13copy_try_foldhuINtNtNtBa_3ops12control_flow11ControlFlowhENCINvNvBL_4find5checkhQNvMs4_NtBa_3numh14is_ascii_digitE0E0B2j_ECsgcf5BHVXlUt_7uu_sort.exit, %bb.bi
  ...
  %.val.i154 = load i8, ptr %i.jf, align 1, !noalias !9497, !noundef !5 ; 4 uses
...
.lr.ph889:                                        ; preds = %.preheader.preheader, %.preheader
  ...
  %.val.i159 = load i8, ptr %i.jk, align 1, !noalias !9500, !noundef !5
...
.lr.ph887:                                        ; preds = %.preheader216.preheader, %.preheader216
  ...
  %.val.i162 = load i8, ptr %i.jp, align 1, !noalias !9503, !noundef !5
...
bb.ca:                                            ; preds = %bb.bz
  %i.kq = load i64, ptr %i.jv, align 8, !noalias !9510, !noundef !5 ; 2 uses
  %i.kr = load i64, ptr %i.jw, align 8, !noalias !9510, !noundef !5 ; 2 uses
...
.lr.ph845:                                        ; preds = %bb.ce, %bb.cf
  ...
  %.val.i.i = load i8, ptr %.sroa.0.1.i842, align 1, !noalias !9514, !noundef !5 ; 3 uses
...
.lr.ph853:                                        ; preds = %_RINvYINtNtNtCs6JMX4GRUq9U_4core5slice4iter4IterhENtNtNtNtBa_4iter6traits8iterator8Iterator8try_folduNCINvNtNtBR_8adapters6copied13copy_try_foldhuINtNtNtBa_3ops12control_flow11ControlFlowhENCINvNvBL_4find5checkhQNvMs4_NtBa_3numh14is_ascii_digitE0E0B2j_ECsgcf5BHVXlUt_7uu_sort.exit.i, %bb.cg
  ...
  %.val.i28.i = load i8, ptr %i.lb, align 1, !noalias !9517, !noundef !5 ; 4 uses
...
.lr.ph864:                                        ; preds = %.preheader.i.preheader, %.preheader.i
  ...
  %.val.i33.i = load i8, ptr %i.lg, align 1, !noalias !9520, !noundef !5
...
.lr.ph862:                                        ; preds = %.preheader49.i.preheader, %.preheader49.i
  ...
  %.val.i36.i = load i8, ptr %i.ll, align 1, !noalias !9523, !noundef !5
...
bb.cr:                                            ; preds = %bb.cp
  ...
  call void @llvm.experimental.noalias.scope.decl(metadata !9529)
  %i.lx = load i64, ptr %i.lu, align 8, !range !1782, !alias.scope !9526, !noalias !9529, !noundef !5 ; 2 uses
  ...
  %i.mc = load i64, ptr %i.lv, align 8, !range !1782, !alias.scope !9529, !noalias !9526, !noundef !5 ; 2 uses
...
bb.ct:                                            ; preds = %bb.cr
  ...
  %i.ml = load i8, ptr %i.mk, align 8, !range !187, !alias.scope !9526, !noalias !9529, !noundef !5 ; 6 uses
  %i.mm = getelementptr inbounds nuw i8, ptr %i.lu, i64 32
  %i.mn = load i64, ptr %i.mm, align 8, !alias.scope !9526, !noalias !9529, !noundef !5 ; 3 uses
  %i.mo = getelementptr inbounds nuw i8, ptr %i.lv, i64 24
  %i.mp = load i8, ptr %i.mo, align 8, !range !187, !alias.scope !9529, !noalias !9526, !noundef !5 ; 2 uses
  %i.mq = getelementptr inbounds nuw i8, ptr %i.lv, i64 32
  %i.mr = load i64, ptr %i.mq, align 8, !alias.scope !9529, !noalias !9526, !noundef !5 ; 3 uses
...
bb.cz:                                            ; preds = %bb.cx
  %i.nd = call noundef i8 @_RNvNtCs50dz3u0MOxO_10bigdecimal8impl_cmp23compare_scaled_biguints(ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(40) %i.lv, ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(40) %i.lu, i64 noundef %i.mx) #34, !noalias !9531
...
bb.dc:                                            ; preds = %bb.cy, %bb.cv
  ...
  %i.ng = call noundef i8 @_RNvNtCs50dz3u0MOxO_10bigdecimal8impl_cmp23compare_scaled_biguints(ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(40) %i.lu, ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(40) %i.lv, i64 noundef %.sink.i34.i.i) #34, !noalias !9531 ; 2 uses
...
bb.df:                                            ; preds = %bb.de
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !9535
  store ptr %.sroa.039.0, ptr %i.b, align 8, !noalias !9535
  store i64 %.sroa.10.0, ptr %i.fi, align 8, !noalias !9535
  store ptr %i.c, ptr %i.fj, align 8, !noalias !9535
  store i64 16, ptr %i.fk, align 8, !noalias !9535
  %i.ni = call fastcc noundef i64 @_RINvCsgcf5BHVXlUt_7uu_sort8get_hashTRShBy_EEB2_(ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) %i.b) #34, !noalias !9540
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !9535
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !9535
  store ptr %.sroa.054.0, ptr %i.a, align 8, !noalias !9535
  store i64 %.sroa.1062.0, ptr %i.fl, align 8, !noalias !9535
  store ptr %i.c, ptr %i.fm, align 8, !noalias !9535
  store i64 16, ptr %i.fn, align 8, !noalias !9535
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !9535
