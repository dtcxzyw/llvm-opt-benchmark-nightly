Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/sdl/original/SDL_pen?download=true
...
FindPenByInstanceId.exit:                         ; preds = %bb.c
  ...
  %or.cond78 = select i1 %3, i1 %i.o, i1 false
  br i1 %or.cond78, label %.thread, label %bb.d
...
bb.e:                                             ; preds = %.thread, %bb.d
  %.191 = phi i32 [ %i.p, %.thread ], [ %spec.select85, %bb.d ]
...
bb.h:                                             ; preds = %bb.f, %bb.g
  ...
  store i32 %.191, ptr %i.aa, align 8
