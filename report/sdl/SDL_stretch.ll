...
.lr.ph85.i:                                       ; preds = %bb.a
  ...
  %2 = getelementptr i8, ptr %.24.val, i64 %i.s
  %scevgep3 = getelementptr i8, ptr %2, i64 %i.n
  %3 = add nsw i64 %i.s, %i.n
  %i.be = add nsw i64 %3, 4                       ; 2 uses
...
vector.memcheck:                                  ; preds = %.lr.ph.i
  ...
  %i.cp = add nsw i64 %i.bx, %i.cb                ; 2 uses
