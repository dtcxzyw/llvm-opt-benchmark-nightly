...
.lr.ph.preheader.i.i:                             ; preds = %bb.p, %bb.o
  %.093.i.i.a = phi i32 [ %i.bs, %bb.p ], [ %i.bn, %bb.o ]
  %wide.trip.count.i.i = zext nneg i32 %.093.i.i.a to i64
  br label %.lr.ph.i.i
...
.lr.ph.preheader.1.i.i:                           ; preds = %bb.s, %bb.r
  %.093.1.i.i = phi i32 [ %i.cc, %bb.s ], [ %i.bx, %bb.r ]
  %wide.trip.count.1.i.i = zext nneg i32 %.093.1.i.i to i64
...
.lr.ph.preheader.2.i.i:                           ; preds = %bb.v, %bb.u
  %.093.2.i.i = phi i32 [ %i.cm, %bb.v ], [ %i.ch, %bb.u ]
  %wide.trip.count.2.i.i = zext nneg i32 %.093.2.i.i to i64
...
.lr.ph.preheader.3.i.i:                           ; preds = %bb.y, %bb.x
  %.093.3.i.i = phi i32 [ %i.cw, %bb.y ], [ %i.cr, %bb.x ]
  %wide.trip.count.3.i.i = zext nneg i32 %.093.3.i.i to i64
...
.lr.ph.preheader.4.i.i:                           ; preds = %bb.ab, %bb.aa
  %.093.4.i.i = phi i32 [ %i.dg, %bb.ab ], [ %i.db, %bb.aa ]
  %wide.trip.count.4.i.i = zext nneg i32 %.093.4.i.i to i64
...
bb.ag:                                            ; preds = %bb.af, %bb.ae
  %.091.i.i = phi i16 [ %i.dw, %bb.ae ], [ %i.dz, %bb.af ]
...
bb.f:                                             ; preds = %bb.e
  ...
  %.0183.a = select i1 %i.bs, i8 %switch.masked, i8 0
  tail call void @SDL_SendJoystickHat(i64 noundef %i.c, ptr noundef nonnull %0, i8 noundef zeroext 0, i8 noundef zeroext %.0183.a) #8
  br label %bb.g
...
bb.t:                                             ; preds = %bb.r, %bb.q, %bb.s
  ...
  %.0181 = zext nneg i8 %.0181.shrunk to i32
  tail call void @SDL_SendJoystickPowerInfo(ptr noundef nonnull %0, i32 noundef %.0182, i32 noundef %.0181) #8
  br label %bb.u
