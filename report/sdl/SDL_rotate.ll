...
bb.a:
  ...
  %13 = insertelement <2 x double> poison, double %i.c, i64 0
  %14 = shufflevector <2 x double> %13, <2 x double> poison, <2 x i32> zeroinitializer ; 3 uses
  %i.o = fmul <2 x double> %14, %i.l              ; 2 uses
  %i.p = insertelement <2 x double> poison, double %i.b, i64 0
  %i.q = shufflevector <2 x double> %i.p, <2 x double> poison, <2 x i32> zeroinitializer ; 3 uses
  %15 = shufflevector <2 x double> %12, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.r = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.q, <2 x double> %15, <2 x double> %i.o)
  %16 = fadd <2 x double> %i.r, %i.k              ; 4 uses
  %17 = shufflevector <2 x double> %12, <2 x double> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  %18 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.q, <2 x double> %17, <2 x double> %i.o)
  %i.s = fadd <2 x double> %18, %i.k              ; 4 uses
  %19 = fneg <2 x double> %i.l
  %20 = fmul <2 x double> %i.q, %19               ; 2 uses
  %i.t = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %14, <2 x double> %15, <2 x double> %20)
  %21 = fadd <2 x double> %i.t, %i.n              ; 4 uses
  %22 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %14, <2 x double> %17, <2 x double> %20)
  %i.u = fadd <2 x double> %22, %i.n              ; 4 uses
  %i.v = fcmp olt <2 x double> %21, %i.u
  %i.w = select <2 x i1> %i.v, <2 x double> %21, <2 x double> %i.u ; 2 uses
  %i.x = fcmp ogt <2 x double> %21, %i.u
  %i.y = select <2 x i1> %i.x, <2 x double> %21, <2 x double> %i.u ; 2 uses
  %i.z = fcmp olt <2 x double> %16, %i.s
  %i.aa = select <2 x i1> %i.z, <2 x double> %16, <2 x double> %i.s ; 2 uses
  ...
  %i.ai = fcmp ogt <2 x double> %16, %i.s
  %i.aj = select <2 x i1> %i.ai, <2 x double> %16, <2 x double> %i.s ; 2 uses
