...
bb.a:
  ...
  %10 = fadd <2 x double> %9, splat (double -5.000000e-01) ; 2 uses
  %i.i = insertelement <2 x double> %10, double 5.000000e-01, i64 0
  ...
  %11 = shufflevector <2 x double> <double 5.000000e-01, double poison>, <2 x double> %10, <2 x i32> <i32 0, i32 2>
  %i.m = insertelement <2 x double> poison, double %i.e, i64 0
  %i.n = shufflevector <2 x double> %i.m, <2 x double> poison, <2 x i32> zeroinitializer ; 3 uses
  %12 = fsub <2 x double> %11, %i.n               ; 2 uses
  ...
  %13 = fmul <2 x double> %i.p, %i.l              ; 2 uses
  %i.q = insertelement <2 x double> poison, double %i.b, i64 0
  %i.r = shufflevector <2 x double> %i.q, <2 x double> poison, <2 x i32> zeroinitializer ; 3 uses
  %14 = shufflevector <2 x double> %12, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %15 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.r, <2 x double> %14, <2 x double> %13)
  %16 = fadd <2 x double> %15, %i.k               ; 4 uses
  %17 = shufflevector <2 x double> %12, <2 x double> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  %i.s = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.r, <2 x double> %17, <2 x double> %13)
  %i.t = fadd <2 x double> %i.s, %i.k             ; 4 uses
  %i.u = fneg <2 x double> %i.l
  %i.v = fmul <2 x double> %i.r, %i.u             ; 2 uses
  %i.w = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.p, <2 x double> %14, <2 x double> %i.v)
  %i.x = fadd <2 x double> %i.w, %i.n             ; 4 uses
  %i.y = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.p, <2 x double> %17, <2 x double> %i.v)
  %i.z = fadd <2 x double> %i.y, %i.n             ; 4 uses
  ...
  %i.ae = fcmp olt <2 x double> %16, %i.t
  %i.af = select <2 x i1> %i.ae, <2 x double> %16, <2 x double> %i.t ; 2 uses
  ...
  %i.an = fcmp ogt <2 x double> %16, %i.t
  %i.ao = select <2 x i1> %i.an, <2 x double> %16, <2 x double> %i.t ; 2 uses
...
.lr.ph70.i:                                       ; preds = %get_colorkey.exit.i
  ...
  %9 = shufflevector <2 x double> %i.fw, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %10 = fptosi <2 x double> %9 to <2 x i32>
  %i.gj = sitofp <2 x i32> %10 to <2 x double>
...
.lr.ph70.split.i.preheader:                       ; preds = %.lr.ph70.i
  ...
  %i.gq = shufflevector <2 x double> %i.gi, <2 x double> %i.gp, <2 x i32> <i32 1, i32 2>
...
.lr.ph.i93:                                       ; preds = %.lr.ph70.split.i
  ...
  %i.gx = sitofp <2 x i32> %i.gw to <2 x double>  ; 2 uses
  %11 = extractelement <2 x double> %i.gx, i64 1
  %12 = fadd double %11, %i.gv
  %i.gy = insertelement <2 x double> %i.gx, double %12, i64 1
  %i.gz = fadd <2 x double> %i.gy, splat (double 5.000000e-01)
  %i.ha = load <2 x float>, ptr %8, align 4
  %i.hb = fpext <2 x float> %i.ha to <2 x double>
  %i.hc = fsub <2 x double> %i.gz, %i.hb          ; 2 uses
...
.lr.ph.split.us.i:                                ; preds = %.lr.ph.i93, %bb.ac
  ...
  %i.hm = extractelement <2 x i32> %i.hl, i64 1
  %i.hn = ashr i32 %i.hm, 16                      ; 2 uses
  %i.ho = extractelement <2 x i32> %i.hl, i64 0
...
.lr.ph.split.i:                                   ; preds = %.lr.ph.i93, %bb.af
  ...
  %i.im = extractelement <2 x i32> %i.il, i64 1
  %i.in = ashr i32 %i.im, 16                      ; 2 uses
  %i.io = extractelement <2 x i32> %i.il, i64 0
...
.lr.ph257.i:                                      ; preds = %.preheader249.i
  ...
  %13 = shufflevector <2 x i32> %i.og, <2 x i32> poison, <2 x i32> <i32 1, i32 0>
  %i.ok = sitofp <2 x i32> %13 to <2 x double>
...
.lr.ph257.split.i.preheader:                      ; preds = %.lr.ph257.i
  ...
  %i.oq = shufflevector <2 x double> %i.oj, <2 x double> %i.op, <2 x i32> <i32 1, i32 2>
...
.lr.ph269.i:                                      ; preds = %.preheader.i
  ...
  %14 = shufflevector <2 x i32> %i.og, <2 x i32> poison, <2 x i32> <i32 1, i32 0>
  %i.os = sitofp <2 x i32> %14 to <2 x double>
...
.lr.ph269.split.i.preheader:                      ; preds = %.lr.ph269.i
  ...
  %i.oy = shufflevector <2 x double> %i.or, <2 x double> %i.ox, <2 x i32> <i32 1, i32 2>
...
.lr.ph.i136:                                      ; preds = %bb.aw, %.lr.ph.preheader.i
  ...
  %i.pv = extractelement <2 x i32> %i.pu, i64 1
  %i.pw = ashr i32 %i.pv, 16                      ; 2 uses
  %i.px = extractelement <2 x i32> %i.pu, i64 0
...
bb.av:                                            ; preds = %bb.au, %bb.at
  ...
  %15 = shufflevector <2 x i32> %i.rh, <2 x i32> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1> ; 2 uses
  %i.rn = mul nsw <4 x i32> %i.rm, %15
  ...
  %16 = shufflevector <2 x i32> %i.rh, <2 x i32> poison, <4 x i32> zeroinitializer
  %i.rx = mul nsw <4 x i32> %i.rw, %16
...
.lr.ph269.split.i:                                ; preds = %.lr.ph269.split.i.preheader, %._crit_edge264.i
  ...
  %i.sr = sitofp <2 x i32> %i.sq to <2 x double>  ; 2 uses
  %i.ss = uitofp nneg i32 %.0234268.i to double
  %17 = extractelement <2 x double> %i.sr, i64 1
  %18 = fadd double %17, %i.ss
  %i.st = insertelement <2 x double> %i.sr, double %18, i64 1
  %i.su = fadd <2 x double> %i.st, splat (double 5.000000e-01)
  %i.sv = load <2 x float>, ptr %8, align 4
  %i.sw = fpext <2 x float> %i.sv to <2 x double>
  %i.sx = fsub <2 x double> %i.su, %i.sw          ; 2 uses
...
.lr.ph263.split.us.split.us.i:                    ; preds = %.lr.ph263.split.us.i, %bb.az
  ...
  %i.ti = extractelement <2 x i32> %i.th, i64 1
  %i.tj = ashr i32 %i.ti, 16                      ; 2 uses
  %i.tk = extractelement <2 x i32> %i.th, i64 0
...
.lr.ph263.split.us.split.i:                       ; preds = %.lr.ph263.split.us.i, %bb.bc
  ...
  %i.ug = extractelement <2 x i32> %i.uf, i64 1
  %i.uh = ashr i32 %i.ug, 16                      ; 2 uses
  %i.ui = extractelement <2 x i32> %i.uf, i64 0
...
.lr.ph263.split.i:                                ; preds = %.lr.ph263.i, %bb.bf
  ...
  %i.vh = extractelement <2 x i32> %i.vg, i64 1
  %i.vi = ashr i32 %i.vh, 16                      ; 2 uses
  %i.vj = extractelement <2 x i32> %i.vg, i64 0
