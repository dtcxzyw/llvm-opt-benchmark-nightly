...
inline.NumDeleted: 5
begin_hunk_0_@SDL_ResumeHaptic_REAL:bb.a
  br label %bb.f
...
bb.d:                                             ; preds = %bb.c
  ...
  store i32 5000, ptr %i.o, align 4
  %i.p = getelementptr inbounds nuw i8, ptr %0, i64 94
  store i16 0, ptr %i.p, align 2
  br label %bb.h

bb.e:                                             ; preds = %bb.c
  %i.q = and i32 %i.j, 2048
...
bb.f:                                             ; preds = %bb.e
  ...
  store i32 5000, ptr %i.r, align 4
  %i.s = getelementptr inbounds nuw i8, ptr %0, i64 64
  store i16 16384, ptr %i.s, align 8
  br label %bb.h

bb.g:                                             ; preds = %bb.e
  %i.t = tail call zeroext i1 (ptr, ...) @SDL_SetError_REAL(ptr noundef nonnull @.str.19) #8
  br label %bb.i

bb.h:                                             ; preds = %bb.f, %bb.d
  %.sink28 = phi i64 [ 66, %bb.f ], [ 98, %bb.d ]
  %.sink = phi i16 [ 16384, %bb.f ], [ 0, %bb.d ]
  %i.u = getelementptr inbounds nuw i8, ptr %0, i64 %.sink28
  store i16 %.sink, ptr %i.u, align 2
  %i.v = tail call i32 @SDL_CreateHapticEffect_REAL(ptr noundef nonnull %0, ptr noundef nonnull %i.a) ; 2 uses
...
bb.i:                                             ; preds = %bb.h, %SDL_ObjectValid.exit.thread, %bb.g, %SDL_ObjectValid.exit.thread24
  %.0 = phi i1 [ false, %SDL_ObjectValid.exit.thread24 ], [ %i.w, %bb.h ], [ true, %SDL_ObjectValid.exit.thread ], [ %i.t, %bb.g ]
  ret i1 %.0
}
...
.sink.split:                                      ; preds = %bb.g, %bb.h
  ...
  %i.p = getelementptr inbounds nuw i8, ptr %0, i64 %.sink31
  store i32 %2, ptr %i.p, align 4
  br label %bb.i

bb.i:                                             ; preds = %.sink.split, %bb.f
  %i.q = tail call zeroext i1 @SDL_UpdateHapticEffect_REAL(ptr noundef nonnull %0, i32 noundef %i.f, ptr noundef nonnull %i.k)
  br i1 %i.q, label %bb.j, label %bb.k

bb.j:                                             ; preds = %bb.i
  %i.r = load i32, ptr %i.e, align 4
  %i.s = tail call zeroext i1 @SDL_RunHapticEffect_REAL(ptr noundef nonnull %0, i32 noundef %i.r, i32 noundef 1)
  br label %bb.k

bb.k:                                             ; preds = %bb.i, %bb.j, %bb.c, %SDL_ObjectValid.exit.thread26
  %.0 = phi i1 [ %i.h, %bb.c ], [ %i.s, %bb.j ], [ false, %SDL_ObjectValid.exit.thread26 ], [ false, %bb.i ]
  ret i1 %.0
}
