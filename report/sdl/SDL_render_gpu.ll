...
switch.edge:                                      ; preds = %bb.b, %bb.c, %bb.b, %bb.b, %bb.b, %bb.d
  ...
  %i.r = getelementptr inbounds nuw i8, ptr %2, i64 12 ; 3 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  %5 = load <2 x i32>, ptr %i.p, align 4
  %6 = add nsw <2 x i32> %5, splat (i32 1)
  %7 = sdiv <2 x i32> %6, splat (i32 2)           ; 2 uses
  %8 = extractelement <2 x i32> %7, i64 0
  %9 = extractelement <2 x i32> %7, i64 1
  %i.bz = tail call fastcc zeroext i1 @GPU_UpdateTextureInternal(ptr noundef nonnull %i.b, ptr noundef %i.g, ptr noundef %i.bu, i32 noundef %i.j, i32 noundef %i.bw, i32 noundef %i.by, i32 noundef %8, i32 noundef %9, ptr noundef %i.bg, i32 noundef %i.ax)
