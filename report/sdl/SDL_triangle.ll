...
bb.a:
  ...
  %.sroa.19.0.extract.shift = lshr i32 %6, 24     ; 3 uses
  %.sroa.19.0.extract.trunc = zext nneg i32 %.sroa.19.0.extract.shift to i64 ; 4 uses
  %.sroa.6.0.extract.shift = lshr i32 %7, 8       ; 5 uses
  %.sroa.11.0.extract.shift = lshr i32 %7, 16     ; 5 uses
  %.sroa.16.0.extract.shift = lshr i32 %7, 24     ; 2 uses
  %.sroa.16.0.extract.trunc = zext nneg i32 %.sroa.16.0.extract.shift to i64 ; 4 uses
...
bb.ay:                                            ; preds = %bb.ax
  ...
  %i.qu = mul nsw i64 %.06271142, %.sroa.19.0.extract.trunc
  %i.qv = add nsw i64 %i.qu, %i.qt
  %i.qw = mul nsw i64 %.06261143, %.sroa.16.0.extract.trunc
...
bb.bb:                                            ; preds = %bb.ba
  ...
  %i.sz = mul nsw i64 %.06191131, %.sroa.19.0.extract.trunc
  %i.ta = add nsw i64 %i.sz, %i.sy
  %i.tb = mul nsw i64 %.06181132, %.sroa.16.0.extract.trunc
...
bb.be:                                            ; preds = %bb.bd
  ...
  %i.vg = mul nsw i64 %.05831120, %.sroa.19.0.extract.trunc
  %i.vh = add nsw i64 %i.vg, %i.vf
  %i.vi = mul nsw i64 %.05821121, %.sroa.16.0.extract.trunc
...
bb.bh:                                            ; preds = %bb.bg
  ...
  %i.xl = mul nsw i64 %.05691111, %.sroa.19.0.extract.trunc
  %i.xm = add nsw i64 %i.xl, %i.xk
  %i.xn = mul nsw i64 %.05681112, %.sroa.16.0.extract.trunc
...
bb.a:
  ...
  %.sroa.4542.0.extract.trunc = zext nneg i32 %.sroa.4542.0.extract.shift to i64
  %.sroa.2536.0.extract.shift = lshr i32 %21, 8
  %.sroa.3537.0.extract.shift = lshr i32 %21, 16
  %.sroa.4538.0.extract.shift = lshr i32 %21, 24
  %.sroa.4538.0.extract.trunc = zext nneg i32 %.sroa.4538.0.extract.shift to i64
