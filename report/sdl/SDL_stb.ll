...
bb.be:                                            ; preds = %.lr.ph292.i.i.i
  ...
  %i.nw = mul nuw nsw i32 %i.ng, %.0206299.i.i.i
...
.lr.ph.i51.i.i:                                   ; preds = %.preheader264.i.i.i, %bb.ei
  ...
  %i.abh = mul nuw nsw i32 %i.abg, %.0199284.i.i.i
...
stbi__mad3sizes_valid.exit.i.i:                   ; preds = %stbi__mul2sizes_valid.exit12.i.i.i, %bb.hq
  %i.aub = mul nuw nsw i32 %.pre580.i, %i.atx     ; 2 uses
...
stbi__mul2sizes_valid.exit.thread15.i.i.i.i.i.i:  ; preds = %stbi__mul2sizes_valid.exit.i.i.i.i.i.i, %bb.ln
  %i.awz = mul nuw nsw i32 %i.awv, %i.awt         ; 3 uses
...
stbi__malloc_mad3.exit.i.i.i.i:                   ; preds = %stbi__mul2sizes_valid.exit12.i.i.i.i.i.i, %bb.lo
  %i.axd = mul nuw nsw i32 %i.awr, %i.awz
...
begin_hunk_9_@stbi__create_png_image_raw:bb.a
  %.4396 = phi i8 [ %i.rt, %.lr.ph397.1 ], [ 0, %.lr.ph397.preheader ]
  %.2241395 = phi ptr [ %i.rs, %.lr.ph397.1 ], [ %i.dp, %.lr.ph397.preheader ] ; 3 uses
  %.4246394 = phi ptr [ %.5247, %.lr.ph397.1 ], [ %i.dg, %.lr.ph397.preheader ] ; 3 uses
  %.2267393 = phi i32 [ %i.ru, %.lr.ph397.1 ], [ 0, %.lr.ph397.preheader ] ; 2 uses
  %niter796 = phi i32 [ %niter796.next.1, %.lr.ph397.1 ], [ 0, %.lr.ph397.preheader ]
  %i.rl = and i32 %.2267393, 6
  %i.rm = icmp eq i32 %i.rl, 0
  br i1 %i.rm, label %bb.x, label %.lr.ph397.1

bb.x:                                             ; preds = %.lr.ph397
  %i.rn = getelementptr inbounds nuw i8, ptr %.4246394, i64 1
  %i.ro = load i8, ptr %.4246394, align 1
  br label %.lr.ph397.1

.lr.ph397.1:                                      ; preds = %bb.x, %.lr.ph397
  %.5247 = phi ptr [ %i.rn, %bb.x ], [ %.4246394, %.lr.ph397 ] ; 2 uses
  %.5 = phi i8 [ %i.ro, %bb.x ], [ %.4396, %.lr.ph397 ] ; 3 uses
  %isneg = icmp slt i8 %.5, 0
  %i.rp = select i1 %isneg, i8 %i.qo, i8 0
  %i.rq = getelementptr inbounds nuw i8, ptr %.2241395, i64 1
  store i8 %i.rp, ptr %.2241395, align 1
  %.mask = and i8 %.5, 64
  %isneg.1.not = icmp eq i8 %.mask, 0
  %i.rr = select i1 %isneg.1.not, i8 0, i8 %i.qo
  %i.rs = getelementptr inbounds nuw i8, ptr %.2241395, i64 2 ; 2 uses
  store i8 %i.rr, ptr %i.rq, align 1
  %i.rt = shl i8 %.5, 2                           ; 2 uses
  %i.ru = add nuw i32 %.2267393, 2                ; 2 uses
...
.lr.ph397.epil.preheader:                         ; preds = %.loopexit335.loopexit.unr-lcssa, %.lr.ph397.preheader
  %.4396.epil.init = phi i8 [ 0, %.lr.ph397.preheader ], [ %i.rt, %.loopexit335.loopexit.unr-lcssa ]
  %.2241395.epil.init = phi ptr [ %i.dp, %.lr.ph397.preheader ], [ %i.rs, %.loopexit335.loopexit.unr-lcssa ]
  %.4246394.epil.init = phi ptr [ %i.dg, %.lr.ph397.preheader ], [ %.5247, %.loopexit335.loopexit.unr-lcssa ]
  %.2267393.epil.init = phi i32 [ 0, %.lr.ph397.preheader ], [ %i.ru, %.loopexit335.loopexit.unr-lcssa ]
  tail call void @llvm.assume(i1 %lcmp.mod794)
  %i.rv = and i32 %.2267393.epil.init, 7
  %i.rw = icmp eq i32 %i.rv, 0
  br i1 %i.rw, label %bb.y, label %.loopexit335.loopexit.epilog-lcssa

bb.y:                                             ; preds = %.lr.ph397.epil.preheader
  %i.rx = load i8, ptr %.4246394.epil.init, align 1
  br label %.loopexit335.loopexit.epilog-lcssa

.loopexit335.loopexit.epilog-lcssa:               ; preds = %bb.y, %.lr.ph397.epil.preheader
  %.5.epil = phi i8 [ %i.rx, %bb.y ], [ %.4396.epil.init, %.lr.ph397.epil.preheader ]
  %isneg.epil = icmp slt i8 %.5.epil, 0
  %i.ry = select i1 %isneg.epil, i8 %i.qo, i8 0
  store i8 %i.ry, ptr %.2241395.epil.init, align 1
...
.lr.ph392.epil.preheader:                         ; preds = %.loopexit335.loopexit739.unr-lcssa, %.lr.ph392.preheader
  %.0239390.epil.init = phi ptr [ %i.dp, %.lr.ph392.preheader ], [ %i.qw, %.loopexit335.loopexit739.unr-lcssa ]
  %.0242389.epil.init = phi ptr [ %i.dg, %.lr.ph392.preheader ], [ %i.qp, %.loopexit335.loopexit739.unr-lcssa ]
  %.0265388.epil.init = phi i32 [ 0, %.lr.ph392.preheader ], [ %i.qx, %.loopexit335.loopexit739.unr-lcssa ]
  tail call void @llvm.assume(i1 %lcmp.mod788)
  %i.rz = and i32 %.0265388.epil.init, 1
  %i.sa = icmp eq i32 %i.rz, 0
  br i1 %i.sa, label %bb.z, label %.loopexit335.loopexit739.epilog-lcssa

bb.z:                                             ; preds = %.lr.ph392.epil.preheader
  %i.sb = load i8, ptr %.0242389.epil.init, align 1
  %i.sc = lshr i8 %i.sb, 4
  %i.sd = mul i8 %i.sc, %i.qo
  br label %.loopexit335.loopexit739.epilog-lcssa

.loopexit335.loopexit739.epilog-lcssa:            ; preds = %bb.z, %.lr.ph392.epil.preheader
  %.1237.epil = phi i8 [ %i.sd, %bb.z ], [ 0, %.lr.ph392.epil.preheader ]
...
.lr.ph387.epil.preheader:                         ; preds = %.loopexit335.loopexit740.unr-lcssa, %.lr.ph387.preheader
  %.2238386.epil.init = phi i8 [ 0, %.lr.ph387.preheader ], [ %i.rj, %.loopexit335.loopexit740.unr-lcssa ]
  %.1240385.epil.init = phi ptr [ %i.dp, %.lr.ph387.preheader ], [ %i.ri, %.loopexit335.loopexit740.unr-lcssa ]
  %.2244384.epil.init = phi ptr [ %i.dg, %.lr.ph387.preheader ], [ %.3245, %.loopexit335.loopexit740.unr-lcssa ]
  %.1266383.epil.init = phi i32 [ 0, %.lr.ph387.preheader ], [ %i.rk, %.loopexit335.loopexit740.unr-lcssa ]
  tail call void @llvm.assume(i1 %lcmp.mod782)
  %i.se = and i32 %.1266383.epil.init, 3
  %i.sf = icmp eq i32 %i.se, 0
  br i1 %i.sf, label %bb.aa, label %.loopexit335.loopexit740.epilog-lcssa
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  %i.ts = shl nuw nsw i64 %indvars.iv.i, 2
  ...
  %i.ue = shl nuw nsw i64 %indvars.iv.next.i, 2
...
.lr.ph32.i314.preheader741:                       ; preds = %vector.memcheck, %.lr.ph32.i314.preheader, %middle.block
  ...
  %xtraiter776 = and i64 %i.vi, 3                 ; 2 uses
...
.lr.ph.i308:                                      ; preds = %.lr.ph.i308.prol.loopexit, %.lr.ph.i308
  ...
  %i.wj = shl nuw nsw i64 %indvars.iv.i309, 2
  ...
  %i.wv = shl nuw nsw i64 %indvars.iv.next.i310, 2
...
.lr.ph378:                                        ; preds = %.lr.ph378.preheader, %.lr.ph378
  %.1377 = phi ptr [ %i.zj, %.lr.ph378 ], [ %i.dp, %.lr.ph378.preheader ] ; 5 uses
  %.1250376 = phi ptr [ %i.zk, %.lr.ph378 ], [ %i.dg, %.lr.ph378.preheader ] ; 5 uses
  %niter = phi i32 [ %niter.next.1, %.lr.ph378 ], [ 0, %.lr.ph378.preheader ]
  %i.yr = load i8, ptr %.1250376, align 1
  ...
  store i16 %i.yx, ptr %.1377, align 2
  %i.yy = getelementptr inbounds nuw i8, ptr %.1377, i64 2
  store i16 -1, ptr %i.yy, align 2
...
.lr.ph374:                                        ; preds = %.preheader346, %.lr.ph374
  %.2373 = phi ptr [ %i.aam, %.lr.ph374 ], [ %i.dp, %.preheader346 ] ; 5 uses
  %.2251372 = phi ptr [ %i.aan, %.lr.ph374 ], [ %i.dg, %.preheader346 ] ; 7 uses
  %.5270371 = phi i32 [ %i.aal, %.lr.ph374 ], [ 0, %.preheader346 ]
  %i.zl = load i8, ptr %.2251372, align 1
  ...
  store i16 %i.zr, ptr %.2373, align 2
  ...
  store i16 %i.zz, ptr %i.aaa, align 2
  ...
  store i16 %i.aai, ptr %i.aaj, align 2
...
.lr.ph382.epil.preheader:                         ; preds = %.loopexit.loopexit744.unr-lcssa, %.lr.ph382.preheader
  %.0381.epil.init = phi ptr [ %i.dp, %.lr.ph382.preheader ], [ %i.yp, %.loopexit.loopexit744.unr-lcssa ]
  %.0249380.epil.init = phi ptr [ %i.dg, %.lr.ph382.preheader ], [ %i.yq, %.loopexit.loopexit744.unr-lcssa ]
...
.lr.ph382.epil:                                   ; preds = %.lr.ph382.epil, %.lr.ph382.epil.preheader
  ...
  %i.aao = load i8, ptr %.0249380.epil, align 1
  ...
  store i16 %i.aau, ptr %.0381.epil, align 2
...
.lr.ph378.epil.preheader:                         ; preds = %.loopexit.loopexit745.unr-lcssa, %.lr.ph378.preheader
  %.1377.epil.init = phi ptr [ %i.dp, %.lr.ph378.preheader ], [ %i.zj, %.loopexit.loopexit745.unr-lcssa ] ; 2 uses
  %.1250376.epil.init = phi ptr [ %i.dg, %.lr.ph378.preheader ], [ %i.zk, %.loopexit.loopexit745.unr-lcssa ] ; 2 uses
  tail call void @llvm.assume(i1 %lcmp.mod767)
  %i.aax = load i8, ptr %.1250376.epil.init, align 1
