...
.lr.ph148.split.us.i:                             ; preds = %.lr.ph148.split.us.i.prol.loopexit, %.lr.ph148.split.us.i
  ...
  br i1 %i.aqn, label %.lr.ph148.split.us.i, label %._crit_edge149.split.us.i, !llvm.loop !322
...
bb.et:                                            ; preds = %bb.es, %.lr.ph148.split.i
  ...
  br i1 %i.aqz, label %.lr.ph148.split.i, label %tdefl_compress_lz_codes.exit, !llvm.loop !323
