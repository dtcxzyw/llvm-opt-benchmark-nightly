...
bb.b:                                             ; preds = %._crit_edge194
  ...
  %7 = and i32 %i.ga, 1047552
  %8 = and i32 %i.ga, 1023
  %9 = and i32 %i.ga, 1072693248
  %10 = and i32 %i.gc, 1047552
  %11 = and i32 %i.gc, 1023
  %12 = and i32 %i.gc, 1072693248
  ...
  %17 = lshr i32 %14, 1
  %18 = lshr i32 %15, 21
  %19 = uitofp nneg i32 %16 to float
  %20 = uitofp nneg i32 %17 to float
  ...
  %i.gl = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.gk, <2 x float> %25, <2 x float> %i.gj)
  %i.gm = shufflevector <2 x float> %i.gg, <2 x float> %i.gf, <2 x i32> <i32 0, i32 3>
  %26 = insertelement <2 x float> poison, float %21, i64 0
  %i.gn = shufflevector <2 x float> %26, <2 x float> poison, <2 x i32> zeroinitializer
