...
scalar.ph59:                                      ; preds = %scalar.ph59.preheader, %scalar.ph59
  ...
  %7 = getelementptr inbounds nuw i8, ptr %.1163.lcssa, i64 %.idx ; 2 uses
  %i.jk = getelementptr inbounds nuw i8, ptr %7, i64 4
  %i.jl = getelementptr inbounds nuw i8, ptr %.3204, i64 4 ; 2 uses
  %8 = load i32, ptr %7, align 4                  ; 3 uses
  %9 = load i32, ptr %i.jk, align 4               ; 3 uses
  %10 = and i32 %8, 1047552
  %11 = and i32 %9, 1023
  %12 = and i32 %8, 1072693248
  %13 = and i32 %9, 1047552
  %14 = and i32 %8, 1023
  %15 = and i32 %9, 1072693248
  %16 = add nuw nsw i32 %13, %10
  %17 = add nuw nsw i32 %11, %14
  ...
  %i.jm = fmul <2 x float> %i.jh, %26
  %27 = insertelement <2 x float> poison, float %23, i64 0
  %28 = shufflevector <2 x float> %27, <2 x float> poison, <2 x i32> zeroinitializer
  %i.jn = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ji, <2 x float> %28, <2 x float> %i.jm)
  %29 = insertelement <2 x float> poison, float %24, i64 0
  %i.jo = shufflevector <2 x float> %29, <2 x float> poison, <2 x i32> zeroinitializer
