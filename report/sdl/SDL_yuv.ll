...
bb.cr:                                            ; preds = %._crit_edge1469
  ...
  %i.axh = load i32, ptr %i.axe, align 4
  %8 = insertelement <3 x i32> poison, i32 %i.axh, i64 0
  %9 = shufflevector <3 x i32> %8, <3 x i32> poison, <3 x i32> zeroinitializer
  %10 = lshr <3 x i32> %9, <i32 0, i32 16, i32 8>
  %11 = and <3 x i32> %10, splat (i32 255)
  %12 = uitofp nneg <3 x i32> %11 to <3 x float>  ; 6 uses
  ...
  %13 = shufflevector <3 x float> %12, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %i.axn = fmul <2 x float> %i.axm, %13
  %i.axo = shufflevector <4 x float> %i.axi, <4 x float> poison, <2 x i32> <i32 0, i32 3>
  %14 = shufflevector <3 x float> %12, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.axp = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.axo, <2 x float> %14, <2 x float> %i.axn)
  %i.axq = shufflevector <2 x float> %i.axk, <2 x float> %i.axj, <2 x i32> <i32 0, i32 3>
  %i.axr = shufflevector <3 x float> %12, <3 x float> poison, <2 x i32> zeroinitializer
...
bb.cu:                                            ; preds = %bb.ct, %bb.cs, %bb.cr
  ...
  %i.ayl = fmul float %i.ayk, %15
  %16 = extractelement <3 x float> %12, i64 1
  %i.aym = tail call float @llvm.fmuladd.f32(float %i.ayj, float %16, float %i.ayl)
  %i.ayn = load float, ptr %i.aqr, align 4
  %17 = extractelement <3 x float> %12, i64 0
  %i.ayo = tail call float @llvm.fmuladd.f32(float %i.ayn, float %17, float %i.aym)
...
bb.df:                                            ; preds = %._crit_edge1460
  ...
  %18 = insertelement <3 x i32> poison, i32 %i.bfg, i64 0
  %19 = insertelement <3 x i32> %18, i32 %i.bfi, i64 1
  %20 = insertelement <3 x i32> %19, i32 %i.bfh, i64 2
  %21 = and <3 x i32> %20, splat (i32 255)
  %22 = uitofp nneg <3 x i32> %21 to <3 x float>  ; 6 uses
  %23 = extractelement <3 x float> %22, i64 2
  %i.bfj = fmul float %i.bfe, %23
  %24 = extractelement <3 x float> %22, i64 1
  %i.bfk = tail call float @llvm.fmuladd.f32(float %i.bfd, float %24, float %i.bfj)
  %25 = extractelement <3 x float> %22, i64 0
  %i.bfl = tail call float @llvm.fmuladd.f32(float %i.bff, float %25, float %i.bfk)
...
bb.di:                                            ; preds = %bb.dh, %bb.dg, %bb.df
  ...
  %26 = shufflevector <3 x float> %22, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %i.bgb = fmul <2 x float> %i.bga, %26
  %i.bgc = shufflevector <2 x float> %i.bfy, <2 x float> %i.bfz, <2 x i32> <i32 0, i32 2>
  %27 = shufflevector <3 x float> %22, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.bgd = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bgc, <2 x float> %27, <2 x float> %i.bgb)
  %i.bge = insertelement <2 x float> poison, float %i.bfu, i64 0
  %i.bgf = insertelement <2 x float> %i.bge, float %i.bfx, i64 1
  %i.bgg = shufflevector <3 x float> %22, <3 x float> poison, <2 x i32> zeroinitializer
  %i.bgh = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bgf, <2 x float> %i.bgg, <2 x float> %i.bgd)
...
bb.dt:                                            ; preds = %._crit_edge
  ...
  %28 = insertelement <3 x i32> poison, i32 %i.bni, i64 0
  %29 = insertelement <3 x i32> %28, i32 %i.bnk, i64 1
  %30 = insertelement <3 x i32> %29, i32 %i.bnj, i64 2
  %31 = and <3 x i32> %30, splat (i32 255)
  %32 = load <2 x float>, ptr %i.aou, align 4     ; 2 uses
  %33 = uitofp nneg <3 x i32> %31 to <3 x float>  ; 6 uses
  %i.bnl = load <2 x float>, ptr %i.aox, align 4  ; 2 uses
  %i.bnm = shufflevector <2 x float> %32, <2 x float> %i.bnl, <2 x i32> <i32 1, i32 3>
  %34 = shufflevector <3 x float> %33, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %i.bnn = fmul <2 x float> %i.bnm, %34
  %i.bno = shufflevector <2 x float> %32, <2 x float> %i.bnl, <2 x i32> <i32 0, i32 2>
  %35 = shufflevector <3 x float> %33, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.bnp = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bno, <2 x float> %35, <2 x float> %i.bnn)
  %i.bnq = insertelement <2 x float> poison, float %i.bne, i64 0
  %i.bnr = insertelement <2 x float> %i.bnq, float %i.bnh, i64 1
  %i.bns = shufflevector <3 x float> %33, <3 x float> poison, <2 x i32> zeroinitializer
  %i.bnt = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bnr, <2 x float> %i.bns, <2 x float> %i.bnp)
...
bb.dw:                                            ; preds = %bb.dv, %bb.du, %bb.dt
  ...
  %36 = extractelement <3 x float> %33, i64 2
  ...
  %38 = extractelement <3 x float> %33, i64 0
