...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ci = shufflevector <4 x float> %i.ap, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  ...
  %i.cq = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %3, <8 x float> splat (float f0x3D430C31), <8 x float> %i.cp)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.de = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %4, <8 x float> splat (float f0x3D23D70B), <8 x float> %i.dd)
  %i.df = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %3, <8 x float> splat (float 4.310400e-01), <8 x float> %i.de)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.dg = shufflevector <4 x float> %i.bb, <4 x float> %i.bn, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.dh = shufflevector <4 x float> %i.ap, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  ...
  %i.dq = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %4, <8 x float> splat (float f0x3D0D3DCB), <8 x float> %i.dp)
  %i.dr = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %3, <8 x float> splat (float f0x3EDDF5F9), <8 x float> %i.dq)
