...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %5 = fmul <8 x float> %4, splat (float f0x3D70F0F1)
  ...
  %i.aw = insertelement <4 x float> %i.av, float %i.as, i64 2
  %i.ax = insertelement <4 x float> %i.aw, float %i.at, i64 3
  %6 = shufflevector <4 x float> %i.al, <4 x float> %i.ax, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  ...
  %i.bw = shufflevector <4 x float> %i.bj, <4 x float> %i.bv, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.bx = fmul <8 x float> %i.bw, splat (float f0x3F70F0F1)
  %i.by = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %6, <8 x float> splat (float f0x3F70F0F1), <8 x float> %5)
  %i.bz = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %3, <8 x float> splat (float f0x3D70F0F1), <8 x float> %i.bx)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.bj = insertelement <4 x float> %i.bi, float %i.bf, i64 3
  %5 = shufflevector <4 x float> %i.ad, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %6 = fmul <8 x float> %5, splat (float 2.290000e-01)
  ...
  %i.bu = insertelement <4 x float> %i.bt, float %i.bq, i64 2
  %i.bv = insertelement <4 x float> %i.bu, float %i.br, i64 3
  %7 = shufflevector <4 x float> %i.bj, <4 x float> %i.bv, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %8 = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %7, <8 x float> splat (float 3.240000e-01), <8 x float> %6)
  %9 = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %3, <8 x float> <float 2.770000e-01, float 2.770000e-01, float 2.770000e-01, float 2.770000e-01, float 1.700000e-01, float 1.700000e-01, float 1.700000e-01, float 1.700000e-01>, <8 x float> %8)
  ...
  %i.ci = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %4, <8 x float> <float 1.700000e-01, float 1.700000e-01, float 1.700000e-01, float 1.700000e-01, float 2.770000e-01, float 2.770000e-01, float 2.770000e-01, float 2.770000e-01>, <8 x float> %9)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ao = insertelement <4 x float> %i.an, float %i.ak, i64 2
  %i.ap = insertelement <4 x float> %i.ao, float %i.al, i64 3
  %3 = shufflevector <4 x float> %i.ap, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3> ; 2 uses
  ...
  %i.ax = insertelement <4 x float> %i.aw, float %i.at, i64 3
  %4 = shufflevector <4 x float> %i.ad, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %5 = fmul <8 x float> %4, splat (float f0x3EC9DFD1)
  ...
  %i.bi = insertelement <4 x float> %i.bh, float %i.be, i64 2
  %i.bj = insertelement <4 x float> %i.bi, float %i.bf, i64 3
  %6 = shufflevector <4 x float> %i.ax, <4 x float> %i.bj, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %7 = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %6, <8 x float> splat (float f0x3F0EDF55), <8 x float> %5)
  ...
  %i.ci = shufflevector <4 x float> %i.bv, <4 x float> %i.ch, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.cj = fmul <8 x float> %i.ci, splat (float f0x3F0EDF55)
  %i.ck = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %3, <8 x float> splat (float f0x3D430C31), <8 x float> %7)
  %i.cl = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %3, <8 x float> splat (float f0x3D430C31), <8 x float> %i.cj)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.al = insertelement <4 x float> %i.ak, float %i.ah, i64 3
  %3 = shufflevector <4 x float> %i.ad, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %4 = fmul <8 x float> %3, splat (float 4.140000e-01)
  %i.am = getelementptr inbounds nuw i8, ptr %next.gep24, i64 4
  ...
  %i.aw = insertelement <4 x float> %i.av, float %i.as, i64 2
  %i.ax = insertelement <4 x float> %i.aw, float %i.at, i64 3
  %5 = shufflevector <4 x float> %i.al, <4 x float> %i.ax, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.ay = getelementptr inbounds nuw i8, ptr %next.gep24, i64 12
  ...
  %i.ck = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %5, <8 x float> splat (float 5.860000e-01), <8 x float> %4)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %5 = shufflevector <4 x float> %i.bn, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  ...
  %7 = fmul <8 x float> %6, splat (float 1.890000e-01)
  ...
  %i.cg = insertelement <4 x float> %i.cf, float %i.cc, i64 2
  %i.ch = insertelement <4 x float> %i.cg, float %i.cd, i64 3
  %8 = shufflevector <4 x float> %i.bv, <4 x float> %i.ch, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %9 = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %8, <8 x float> splat (float 2.680000e-01), <8 x float> %7)
  %10 = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %3, <8 x float> splat (float 1.890000e-01), <8 x float> %9)
  ...
  %i.cu = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %5, <8 x float> <float 1.090000e-01, float 1.090000e-01, float 1.090000e-01, float 1.090000e-01, float 2.450000e-01, float 2.450000e-01, float 2.450000e-01, float 2.450000e-01>, <8 x float> %11)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.by = insertelement <4 x float> %i.bx, float %i.bu, i64 2
  %i.bz = insertelement <4 x float> %i.by, float %i.bv, i64 3
  %4 = shufflevector <4 x float> %i.bn, <4 x float> %i.bz, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7> ; 2 uses
  ...
  %i.cv = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.cu, <8 x float> splat (float 4.636800e-01), <8 x float> %6)
  %i.cw = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %3, <8 x float> splat (float f0x3D23D70B), <8 x float> %i.cv)
  %7 = shufflevector <4 x float> %i.ap, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %i.cx = shufflevector <4 x float> %i.bb, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %8 = fmul <8 x float> %i.cx, splat (float 3.273600e-01)
  %9 = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %7, <8 x float> splat (float f0x3D23D70B), <8 x float> %8)
  %i.cy = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %4, <8 x float> splat (float 1.689600e-01), <8 x float> %i.cw)
  %i.cz = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %4, <8 x float> splat (float 4.310400e-01), <8 x float> %9)
  %interleaved.vec = shufflevector <8 x float> %i.cy, <8 x float> %i.cz, <16 x i32> <i32 0, i32 4, i32 8, i32 12, i32 1, i32 5, i32 9, i32 13, i32 2, i32 6, i32 10, i32 14, i32 3, i32 7, i32 11, i32 15>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.bv = insertelement <4 x float> %i.bu, float %i.br, i64 3
  %4 = shufflevector <4 x float> %i.ad, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %5 = fmul <8 x float> %4, splat (float 3.410000e-01)
  ...
  %7 = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %6, <8 x float> splat (float 4.830000e-01), <8 x float> %5)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.by = insertelement <4 x float> %i.bx, float %i.bu, i64 2
  %i.bz = insertelement <4 x float> %i.by, float %i.bv, i64 3
  %6 = shufflevector <4 x float> %i.bz, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  ...
  %8 = fmul <8 x float> %7, splat (float 1.610000e-01)
  ...
  %i.cs = insertelement <4 x float> %i.cr, float %i.co, i64 2
  %i.ct = insertelement <4 x float> %i.cs, float %i.cp, i64 3
  %9 = shufflevector <4 x float> %i.ch, <4 x float> %i.ct, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %10 = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %9, <8 x float> splat (float 2.270000e-01), <8 x float> %8)
  %11 = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %3, <8 x float> <float 1.940000e-01, float 1.940000e-01, float 1.940000e-01, float 1.940000e-01, float 1.190000e-01, float 1.190000e-01, float 1.190000e-01, float 1.190000e-01>, <8 x float> %10)
  %12 = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %4, <8 x float> <float 1.190000e-01, float 1.190000e-01, float 1.190000e-01, float 1.190000e-01, float 1.940000e-01, float 1.940000e-01, float 1.940000e-01, float 1.940000e-01>, <8 x float> %11)
  %13 = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %5, <8 x float> <float 2.080000e-01, float 2.080000e-01, float 2.080000e-01, float 2.080000e-01, float 9.200000e-02, float 9.200000e-02, float 9.200000e-02, float 9.200000e-02>, <8 x float> %12)
  ...
  %i.dg = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %6, <8 x float> <float 9.200000e-02, float 9.200000e-02, float 9.200000e-02, float 9.200000e-02, float 2.080000e-01, float 2.080000e-01, float 2.080000e-01, float 2.080000e-01>, <8 x float> %13)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.bm = insertelement <4 x float> %i.bl, float %i.bi, i64 2
  %i.bn = insertelement <4 x float> %i.bm, float %i.bj, i64 3
  %4 = shufflevector <4 x float> %i.bb, <4 x float> %i.bn, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7> ; 2 uses
  ...
  %i.bv = insertelement <4 x float> %i.bu, float %i.br, i64 3
  %5 = shufflevector <4 x float> %i.ad, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %6 = fmul <8 x float> %5, splat (float f0x3EA89253)
  ...
  %8 = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %7, <8 x float> splat (float f0x3EEEC4C0), <8 x float> %6)
  %9 = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %3, <8 x float> splat (float f0x3D0D3DCB), <8 x float> %8)
  ...
  %i.dg = shufflevector <4 x float> %i.ct, <4 x float> %i.df, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.dh = fmul <8 x float> %i.dg, splat (float f0x3EEEC4C0)
  %i.di = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %3, <8 x float> splat (float f0x3D0D3DCB), <8 x float> %i.dh)
  %i.dj = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %4, <8 x float> splat (float f0x3E2E0267), <8 x float> %9)
  %i.dk = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %4, <8 x float> splat (float f0x3EDDF5F9), <8 x float> %i.di)
  %interleaved.vec = shufflevector <8 x float> %i.dj, <8 x float> %i.dk, <16 x i32> <i32 0, i32 4, i32 8, i32 12, i32 1, i32 5, i32 9, i32 13, i32 2, i32 6, i32 10, i32 14, i32 3, i32 7, i32 11, i32 15>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.bu = insertelement <4 x float> %i.bt, float %i.bq, i64 2
  %i.bv = insertelement <4 x float> %i.bu, float %i.br, i64 3
  %6 = shufflevector <4 x float> %i.bj, <4 x float> %i.bv, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %7 = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %6, <8 x float> splat (float 4.830000e-01), <8 x float> %5)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ct = insertelement <4 x float> %i.cs, float %i.cp, i64 2
  %i.cu = insertelement <4 x float> %i.ct, float %i.cq, i64 3
  %4 = shufflevector <4 x float> %i.ap, <4 x float> %i.cu, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %5 = fmul <8 x float> %4, <float 2.880000e-01, float 2.880000e-01, float 2.880000e-01, float 2.880000e-01, float 5.410000e-01, float 5.410000e-01, float 5.410000e-01, float 5.410000e-01>
  ...
  %i.dl = shufflevector <4 x float> %i.bw, <4 x float> %i.ci, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.dm = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %3, <8 x float> <float 2.880000e-01, float 2.880000e-01, float 2.880000e-01, float 2.880000e-01, float 4.590000e-01, float 4.590000e-01, float 4.590000e-01, float 4.590000e-01>, <8 x float> %5)
  %i.dn = shufflevector <8 x float> %i.dk, <8 x float> %i.dl, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
