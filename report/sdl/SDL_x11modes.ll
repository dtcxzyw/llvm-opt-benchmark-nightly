...
bb.n:                                             ; preds = %bb.m
  ...
  %3 = load i32, ptr %i.bg, align 8
  %i.bh = load ptr, ptr %i.w, align 8
  %i.bi = load i32, ptr %i.d, align 8
  %i.bj = sext i32 %i.bi to i64
  %i.bk = getelementptr inbounds [128 x i8], ptr %i.bh, i64 %i.bj ; 4 uses
  %i.bl = getelementptr inbounds nuw i8, ptr %i.bk, i64 32
  %4 = load i32, ptr %i.bl, align 8
  %5 = mul nsw i32 %4, %3
  %i.bm = getelementptr inbounds nuw i8, ptr %i.bk, i64 24
  %6 = load i32, ptr %i.bm, align 8
  %7 = sdiv i32 %5, %6
  %i.bn = getelementptr inbounds nuw i8, ptr %2, i64 12 ; 2 uses
  %8 = load i32, ptr %i.bn, align 4
  %9 = getelementptr inbounds nuw i8, ptr %i.bk, i64 36
  %10 = load i32, ptr %9, align 4
  %11 = mul nsw i32 %10, %8
  %12 = getelementptr inbounds nuw i8, ptr %i.bk, i64 28
  ...
  tail call void %i.bs(ptr noundef nonnull %i.s, i64 noundef %i.by, i32 noundef %i.bz, i32 noundef %i.ca, i32 noundef %7, i32 noundef %14) #8
