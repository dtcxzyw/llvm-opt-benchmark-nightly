...
.lr.ph748:                                        ; preds = %bb.b
  ...
  %7 = insertelement <4 x i32> poison, i32 %i.b, i64 0
...
bb.c:                                             ; preds = %.lr.ph748.split, %bb.f
  ...
  %9 = load <4 x i8>, ptr %.1, align 4
  %10 = zext <4 x i8> %9 to <4 x i32>
  %11 = mul nuw nsw <4 x i32> %8, %10
  %i.bc = udiv <4 x i32> %11, splat (i32 255)
...
bb.d:                                             ; preds = %.lr.ph748.split, %bb.c
  ...
  %12 = load <4 x i8>, ptr %.2, align 4
  %13 = zext <4 x i8> %12 to <4 x i32>
  %14 = mul nuw nsw <4 x i32> %8, %13
  %i.bh = udiv <4 x i32> %14, splat (i32 255)
...
bb.e:                                             ; preds = %.lr.ph748.split, %bb.d
  ...
  %15 = load <4 x i8>, ptr %.3, align 4
  %16 = zext <4 x i8> %15 to <4 x i32>
  %17 = mul nuw nsw <4 x i32> %8, %16
  %i.bm = udiv <4 x i32> %17, splat (i32 255)
...
bb.f:                                             ; preds = %.lr.ph748.split, %bb.e
  ...
  %18 = load <4 x i8>, ptr %.4, align 4
  %19 = zext <4 x i8> %18 to <4 x i32>
  %20 = mul nuw nsw <4 x i32> %8, %19
  %i.br = udiv <4 x i32> %20, splat (i32 255)
...
.lr.ph745:                                        ; preds = %bb.h
  ...
  %21 = insertelement <4 x i32> poison, i32 %i.b, i64 0
  %22 = shufflevector <4 x i32> %21, <4 x i32> poison, <4 x i32> zeroinitializer ; 4 uses
...
bb.j:                                             ; preds = %bb.i, %bb.m
  ...
  %23 = load <4 x i8>, ptr %.1620, align 4
  %24 = zext <4 x i8> %23 to <4 x i32>
  %25 = mul nuw nsw <4 x i32> %22, %24
  %i.dw = udiv <4 x i32> %25, splat (i32 255)
...
bb.k:                                             ; preds = %bb.i, %bb.j
  ...
  %26 = load <4 x i8>, ptr %.2621, align 4
  %27 = zext <4 x i8> %26 to <4 x i32>
  %28 = mul nuw nsw <4 x i32> %22, %27
  %i.eb = udiv <4 x i32> %28, splat (i32 255)
...
bb.l:                                             ; preds = %bb.i, %bb.k
  ...
  %29 = load <4 x i8>, ptr %.3622, align 4
  %30 = zext <4 x i8> %29 to <4 x i32>
  %31 = mul nuw nsw <4 x i32> %22, %30
  %i.eg = udiv <4 x i32> %31, splat (i32 255)
...
bb.m:                                             ; preds = %bb.i, %bb.l
  ...
  %32 = load <4 x i8>, ptr %.4623, align 4
  %33 = zext <4 x i8> %32 to <4 x i32>
  %34 = mul nuw nsw <4 x i32> %22, %33
  %i.el = udiv <4 x i32> %34, splat (i32 255)
