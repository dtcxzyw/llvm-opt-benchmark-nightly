...
.lr.ph674:                                        ; preds = %bb.o
  ...
  %i.om = and i32 %i.oi, 3
  %7 = zext i8 %3 to i16                          ; 4 uses
  %8 = zext i8 %4 to i16                          ; 4 uses
  %9 = zext i8 %5 to i16                          ; 4 uses
  %10 = sext i32 %i.oj to i64
  br label %bb.p
...
bb.q:                                             ; preds = %bb.p, %bb.t
  ...
  %13 = zext i8 %i.pe to i16
  %14 = add nuw nsw i16 %11, %7
  %spec.store.select31 = tail call i16 @llvm.umin.i16(i16 %14, i16 255)
  %15 = add nuw nsw i16 %12, %8
  %spec.store.select10 = tail call i16 @llvm.umin.i16(i16 %15, i16 255)
  %16 = add nuw nsw i16 %13, %9
  %spec.store.select43 = tail call i16 @llvm.umin.i16(i16 %16, i16 255)
  %17 = shl nuw nsw i16 %spec.store.select31, 7
  %18 = and i16 %17, 31744
  %19 = shl nuw nsw i16 %spec.store.select10, 2
  %20 = and i16 %19, 992
  %21 = or disjoint i16 %20, %18
  %22 = lshr i16 %spec.store.select43, 3
  %i.pf = or disjoint i16 %21, %22
...
bb.r:                                             ; preds = %bb.p, %bb.q
  ...
  %25 = zext i8 %i.px to i16
  %26 = add nuw nsw i16 %23, %7
  %spec.store.select11 = tail call i16 @llvm.umin.i16(i16 %26, i16 255)
  %27 = add nuw nsw i16 %24, %8
  %spec.store.select32 = tail call i16 @llvm.umin.i16(i16 %27, i16 255)
  %28 = add nuw nsw i16 %25, %9
  %spec.store.select12 = tail call i16 @llvm.umin.i16(i16 %28, i16 255)
  %29 = shl nuw nsw i16 %spec.store.select11, 7
  %30 = and i16 %29, 31744
  %31 = shl nuw nsw i16 %spec.store.select32, 2
  %32 = and i16 %31, 992
  %33 = or disjoint i16 %32, %30
  %34 = lshr i16 %spec.store.select12, 3
  %i.py = or disjoint i16 %33, %34
...
bb.s:                                             ; preds = %bb.p, %bb.r
  ...
  %37 = zext i8 %i.qq to i16
  %38 = add nuw nsw i16 %35, %7
  %spec.store.select13 = tail call i16 @llvm.umin.i16(i16 %38, i16 255)
  %39 = add nuw nsw i16 %36, %8
  %spec.store.select33 = tail call i16 @llvm.umin.i16(i16 %39, i16 255)
  %40 = add nuw nsw i16 %37, %9
  %spec.store.select14 = tail call i16 @llvm.umin.i16(i16 %40, i16 255)
  %41 = shl nuw nsw i16 %spec.store.select13, 7
  %42 = and i16 %41, 31744
  %43 = shl nuw nsw i16 %spec.store.select33, 2
  %44 = and i16 %43, 992
  %45 = or disjoint i16 %44, %42
  %46 = lshr i16 %spec.store.select14, 3
  %i.qr = or disjoint i16 %45, %46
...
bb.t:                                             ; preds = %bb.p, %bb.s
  ...
  %49 = zext i8 %i.rj to i16
  %50 = add nuw nsw i16 %47, %7
  %spec.store.select15 = tail call i16 @llvm.umin.i16(i16 %50, i16 255)
  %51 = add nuw nsw i16 %48, %8
  %spec.store.select34 = tail call i16 @llvm.umin.i16(i16 %51, i16 255)
  %52 = add nuw nsw i16 %49, %9
  %spec.store.select16 = tail call i16 @llvm.umin.i16(i16 %52, i16 255)
  %53 = shl nuw nsw i16 %spec.store.select15, 7
  %54 = and i16 %53, 31744
  %55 = shl nuw nsw i16 %spec.store.select34, 2
  %56 = and i16 %55, 992
  %57 = or disjoint i16 %56, %54
  %58 = lshr i16 %spec.store.select16, 3
  %i.rk = or disjoint i16 %57, %58
...
bb.u:                                             ; preds = %bb.t
  %i.ro = getelementptr inbounds [2 x i8], ptr %i.rl, i64 %10
...
bb.q:                                             ; preds = %bb.p, %bb.t
  ...
  %12 = zext i8 %i.pv to i16
  %13 = add nuw nsw i16 %10, %7
  %spec.store.select31 = tail call i16 @llvm.umin.i16(i16 %13, i16 255)
  %14 = add nuw nsw i16 %11, %8
  %spec.store.select10 = tail call i16 @llvm.umin.i16(i16 %14, i16 255)
  %15 = add nuw nsw i16 %12, %9
  %spec.store.select43 = tail call i16 @llvm.umin.i16(i16 %15, i16 255)
  %16 = shl nuw i16 %spec.store.select31, 8
  %17 = and i16 %16, -2048
  %i.pw = shl nuw nsw i16 %spec.store.select10, 3
  %18 = and i16 %i.pw, 2016
  %19 = or disjoint i16 %18, %17
  %20 = lshr i16 %spec.store.select43, 3
  %i.px = or disjoint i16 %19, %20
...
bb.r:                                             ; preds = %bb.p, %bb.q
  ...
  %23 = zext i8 %i.qp to i16
  %24 = add nuw nsw i16 %21, %7
  %spec.store.select11 = tail call i16 @llvm.umin.i16(i16 %24, i16 255)
  %25 = add nuw nsw i16 %22, %8
  %spec.store.select32 = tail call i16 @llvm.umin.i16(i16 %25, i16 255)
  %26 = add nuw nsw i16 %23, %9
  %spec.store.select12 = tail call i16 @llvm.umin.i16(i16 %26, i16 255)
  %27 = shl nuw i16 %spec.store.select11, 8
  %28 = and i16 %27, -2048
  %i.qq = shl nuw nsw i16 %spec.store.select32, 3
  %29 = and i16 %i.qq, 2016
  %30 = or disjoint i16 %29, %28
  %31 = lshr i16 %spec.store.select12, 3
  %i.qr = or disjoint i16 %30, %31
...
bb.s:                                             ; preds = %bb.p, %bb.r
  ...
  %i.rf = load i8, ptr %i.re, align 1
  %33 = zext i8 %i.rf to i16
  %i.rg = and i32 %i.qv, 31
  %i.rh = zext nneg i32 %i.rg to i64
  %i.ri = getelementptr inbounds nuw i8, ptr %i.qt, i64 %i.rh
  %i.rj = load i8, ptr %i.ri, align 1
  %34 = zext i8 %i.rj to i16
  %35 = add nuw nsw i16 %32, %7
  %spec.store.select13 = tail call i16 @llvm.umin.i16(i16 %35, i16 255)
  %36 = add nuw nsw i16 %33, %8
  %spec.store.select33 = tail call i16 @llvm.umin.i16(i16 %36, i16 255)
  %37 = add nuw nsw i16 %34, %9
  %spec.store.select14 = tail call i16 @llvm.umin.i16(i16 %37, i16 255)
  %38 = shl nuw i16 %spec.store.select13, 8
  %39 = and i16 %38, -2048
  %i.rk = shl nuw nsw i16 %spec.store.select33, 3
  %40 = and i16 %i.rk, 2016
  %41 = or disjoint i16 %40, %39
  %42 = lshr i16 %spec.store.select14, 3
  %i.rl = or disjoint i16 %41, %42
...
bb.t:                                             ; preds = %bb.p, %bb.s
  ...
  %45 = zext i8 %i.sd to i16
  %46 = add nuw nsw i16 %43, %7
  %spec.store.select15 = tail call i16 @llvm.umin.i16(i16 %46, i16 255)
  %47 = add nuw nsw i16 %44, %8
  %spec.store.select34 = tail call i16 @llvm.umin.i16(i16 %47, i16 255)
  %48 = add nuw nsw i16 %45, %9
  %spec.store.select16 = tail call i16 @llvm.umin.i16(i16 %48, i16 255)
  %49 = shl nuw i16 %spec.store.select15, 8
  %50 = and i16 %49, -2048
  %i.se = shl nuw nsw i16 %spec.store.select34, 3
  %51 = and i16 %i.se, 2016
  %52 = or disjoint i16 %51, %50
  %53 = lshr i16 %spec.store.select16, 3
  %i.sf = or disjoint i16 %52, %53
...
.lr.ph2122:                                       ; preds = %bb.p
  ...
  %7 = zext i8 %3 to i32                          ; 4 uses
  %8 = zext i8 %4 to i32                          ; 4 uses
...
bb.r:                                             ; preds = %bb.q, %bb.u
  ...
  %12 = zext i8 %i.zz to i32
  %13 = add nuw nsw i32 %10, %7
  %spec.store.select60 = tail call i32 @llvm.umin.i32(i32 %13, i32 255)
  %14 = add nuw nsw i32 %11, %8
  %spec.store.select10 = tail call i32 @llvm.umin.i32(i32 %14, i32 255)
  %15 = add nuw nsw i32 %12, %9
  %spec.store.select84 = tail call i32 @llvm.umin.i32(i32 %15, i32 255)
...
bb.s:                                             ; preds = %bb.q, %bb.r
  ...
  %18 = zext i8 %i.acd to i32
  %19 = add nuw nsw i32 %16, %7
  %spec.store.select11 = tail call i32 @llvm.umin.i32(i32 %19, i32 255)
  %20 = add nuw nsw i32 %17, %8
  %spec.store.select61 = tail call i32 @llvm.umin.i32(i32 %20, i32 255)
  %21 = add nuw nsw i32 %18, %9
  %spec.store.select12 = tail call i32 @llvm.umin.i32(i32 %21, i32 255)
...
bb.t:                                             ; preds = %bb.q, %bb.s
  ...
  %24 = zext i8 %i.aeh to i32
  %25 = add nuw nsw i32 %22, %7
  %spec.store.select13 = tail call i32 @llvm.umin.i32(i32 %25, i32 255)
  %26 = add nuw nsw i32 %23, %8
  %spec.store.select62 = tail call i32 @llvm.umin.i32(i32 %26, i32 255)
  %27 = add nuw nsw i32 %24, %9
  %spec.store.select14 = tail call i32 @llvm.umin.i32(i32 %27, i32 255)
...
bb.u:                                             ; preds = %bb.q, %bb.t
  ...
  %30 = zext i8 %i.agl to i32
  %31 = add nuw nsw i32 %28, %7
  %spec.store.select15 = tail call i32 @llvm.umin.i32(i32 %31, i32 255)
  %32 = add nuw nsw i32 %29, %8
  %spec.store.select63 = tail call i32 @llvm.umin.i32(i32 %32, i32 255)
  %33 = add nuw nsw i32 %30, %9
  %spec.store.select16 = tail call i32 @llvm.umin.i32(i32 %33, i32 255)
...
.lr.ph2104:                                       ; preds = %bb.bg
  ...
  %34 = zext i8 %3 to i32                         ; 4 uses
  %35 = zext i8 %4 to i32                         ; 4 uses
  %36 = zext i8 %5 to i32                         ; 4 uses
...
bb.bi:                                            ; preds = %bb.bh, %bb.bl
  ...
  %39 = zext i8 %i.ckv to i32
  %40 = add nuw nsw i32 %37, %34
  %spec.store.select72 = tail call i32 @llvm.umin.i32(i32 %40, i32 255)
  %41 = add nuw nsw i32 %38, %35
  %spec.store.select39 = tail call i32 @llvm.umin.i32(i32 %41, i32 255)
  %42 = add nuw nsw i32 %39, %36
  %spec.store.select90 = tail call i32 @llvm.umin.i32(i32 %42, i32 255)
...
bb.bj:                                            ; preds = %bb.bh, %bb.bi
  ...
  %45 = zext i8 %i.cmx to i32
  %46 = add nuw nsw i32 %43, %34
  %spec.store.select40 = tail call i32 @llvm.umin.i32(i32 %46, i32 255)
  %47 = add nuw nsw i32 %44, %35
  %spec.store.select73 = tail call i32 @llvm.umin.i32(i32 %47, i32 255)
  %48 = add nuw nsw i32 %45, %36
  %spec.store.select41 = tail call i32 @llvm.umin.i32(i32 %48, i32 255)
...
bb.bk:                                            ; preds = %bb.bh, %bb.bj
  ...
  %51 = zext i8 %i.coz to i32
  %52 = add nuw nsw i32 %49, %34
  %spec.store.select42 = tail call i32 @llvm.umin.i32(i32 %52, i32 255)
  %53 = add nuw nsw i32 %50, %35
  %spec.store.select74 = tail call i32 @llvm.umin.i32(i32 %53, i32 255)
  %54 = add nuw nsw i32 %51, %36
  %spec.store.select43 = tail call i32 @llvm.umin.i32(i32 %54, i32 255)
...
bb.bl:                                            ; preds = %bb.bh, %bb.bk
  ...
  %57 = zext i8 %i.crb to i32
  %58 = add nuw nsw i32 %55, %34
  %spec.store.select44 = tail call i32 @llvm.umin.i32(i32 %58, i32 255)
  %59 = add nuw nsw i32 %56, %35
  %spec.store.select75 = tail call i32 @llvm.umin.i32(i32 %59, i32 255)
  %60 = add nuw nsw i32 %57, %36
  %spec.store.select45 = tail call i32 @llvm.umin.i32(i32 %60, i32 255)
...
bb.r:                                             ; preds = %bb.q, %bb.u
  ...
  %13 = add nuw nsw i32 %10, %7
  %spec.store.select31 = tail call i32 @llvm.umin.i32(i32 %13, i32 255)
  %14 = add nuw nsw i32 %11, %8
  %spec.store.select10 = tail call i32 @llvm.umin.i32(i32 %14, i32 255)
  %15 = add nuw nsw i32 %12, %9
  %spec.store.select43 = tail call i32 @llvm.umin.i32(i32 %15, i32 255)
...
bb.s:                                             ; preds = %bb.q, %bb.r
  ...
  %spec.store.select11 = tail call i32 @llvm.umin.i32(i32 %19, i32 255)
  %20 = add nuw nsw i32 %17, %8
  %spec.store.select32 = tail call i32 @llvm.umin.i32(i32 %20, i32 255)
  %21 = add nuw nsw i32 %18, %9
  %spec.store.select12 = tail call i32 @llvm.umin.i32(i32 %21, i32 255)
...
bb.t:                                             ; preds = %bb.q, %bb.s
  ...
  %spec.store.select13 = tail call i32 @llvm.umin.i32(i32 %25, i32 255)
  %26 = add nuw nsw i32 %23, %8
  %spec.store.select33 = tail call i32 @llvm.umin.i32(i32 %26, i32 255)
  %27 = add nuw nsw i32 %24, %9
  %spec.store.select14 = tail call i32 @llvm.umin.i32(i32 %27, i32 255)
...
bb.u:                                             ; preds = %bb.q, %bb.t
  ...
  %spec.store.select15 = tail call i32 @llvm.umin.i32(i32 %31, i32 255)
  %32 = add nuw nsw i32 %29, %8
  %spec.store.select34 = tail call i32 @llvm.umin.i32(i32 %32, i32 255)
  %33 = add nuw nsw i32 %30, %9
  %spec.store.select16 = tail call i32 @llvm.umin.i32(i32 %33, i32 255)
