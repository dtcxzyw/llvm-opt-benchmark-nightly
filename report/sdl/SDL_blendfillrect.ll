...
.lr.ph748:                                        ; preds = %bb.b
  ...
  %7 = insertelement <2 x i8> poison, i8 %4, i64 0 ; 2 uses
  %8 = insertelement <2 x i8> %7, i8 %3, i64 1
  %9 = insertelement <2 x i8> poison, i8 %5, i64 0 ; 2 uses
  %10 = insertelement <2 x i8> %9, i8 %3, i64 1
  %i.ag = sext i32 %i.ab to i64
  %11 = insertelement <4 x i32> poison, i32 %i.af, i64 2
  %i.ah = insertelement <4 x i32> %11, i32 %i.a, i64 3 ; 2 uses
  %12 = insertelement <2 x i8> %7, i8 %5, i64 1   ; 2 uses
  %13 = shufflevector <2 x i8> %12, <2 x i8> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %14 = zext <4 x i8> %13 to <4 x i32>
  %15 = shufflevector <4 x i32> %i.ah, <4 x i32> %14, <4 x i32> <i32 5, i32 4, i32 2, i32 3>
  %16 = shufflevector <2 x i8> %12, <2 x i8> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %17 = zext <4 x i8> %16 to <4 x i32>
  %18 = shufflevector <4 x i32> %i.ah, <4 x i32> %17, <4 x i32> <i32 5, i32 4, i32 2, i32 3>
  %19 = shufflevector <2 x i8> %10, <2 x i8> poison, <4 x i32> <i32 0, i32 poison, i32 1, i32 poison>
  %20 = insertelement <4 x i8> %19, i8 %4, i64 1
  %21 = insertelement <4 x i8> %20, i8 %6, i64 3
  %i.ai = zext <4 x i8> %21 to <4 x i32>
  %22 = shufflevector <2 x i8> %9, <2 x i8> %8, <4 x i32> <i32 0, i32 2, i32 3, i32 poison>
  %23 = insertelement <4 x i8> %22, i8 %6, i64 3
...
bb.c:                                             ; preds = %.lr.ph748.split, %bb.f
  ...
  %26 = and i32 %i.ak, 255
  %i.ap = mul nuw nsw i32 %i.al, %i.b
  %i.aq = mul nuw nsw i32 %i.an, %i.b
  %i.ar = mul nuw nsw i32 %i.ao, %i.b
  %i.as = mul nuw nsw i32 %26, %i.b
  %27 = insertelement <4 x i32> poison, i32 %i.as, i64 0
  %28 = insertelement <4 x i32> %27, i32 %i.ar, i64 1
  %29 = insertelement <4 x i32> %28, i32 %i.aq, i64 2
  %30 = insertelement <4 x i32> %29, i32 %i.ap, i64 3
  %31 = udiv <4 x i32> %30, splat (i32 255)
  %32 = add nuw nsw <4 x i32> %31, %15
  %33 = shl <4 x i32> %32, <i32 0, i32 8, i32 16, i32 24>
...
bb.d:                                             ; preds = %.lr.ph748.split, %bb.c
  ...
  %36 = and i32 %i.au, 255
  %i.az = mul nuw nsw i32 %i.av, %i.b
  %i.ba = mul nuw nsw i32 %i.ax, %i.b
  %i.bb = mul nuw nsw i32 %i.ay, %i.b
  %i.bc = mul nuw nsw i32 %36, %i.b
  %37 = insertelement <4 x i32> poison, i32 %i.bc, i64 0
  %38 = insertelement <4 x i32> %37, i32 %i.bb, i64 1
  %39 = insertelement <4 x i32> %38, i32 %i.ba, i64 2
  %40 = insertelement <4 x i32> %39, i32 %i.az, i64 3
  %41 = udiv <4 x i32> %40, splat (i32 255)
  %42 = add nuw nsw <4 x i32> %41, %18
  %43 = shl <4 x i32> %42, <i32 0, i32 8, i32 16, i32 24>
  %44 = tail call i32 @llvm.vector.reduce.or.v4i32(<4 x i32> %43)
...
bb.e:                                             ; preds = %.lr.ph748.split, %bb.d
  ...
  %46 = and i32 %i.be, 255
  %i.bj = mul nuw nsw i32 %i.bf, %i.b
  %i.bk = mul nuw nsw i32 %i.bh, %i.b
  %i.bl = mul nuw nsw i32 %i.bi, %i.b
  %i.bm = mul nuw nsw i32 %46, %i.b
  %47 = insertelement <4 x i32> poison, i32 %i.bm, i64 0
  %48 = insertelement <4 x i32> %47, i32 %i.bl, i64 1
  %49 = insertelement <4 x i32> %48, i32 %i.bk, i64 2
  %50 = insertelement <4 x i32> %49, i32 %i.bj, i64 3
  %51 = udiv <4 x i32> %50, splat (i32 255)
  %52 = add nuw nsw <4 x i32> %51, %i.ai
  %53 = shl <4 x i32> %52, <i32 0, i32 8, i32 16, i32 24>
  %54 = tail call i32 @llvm.vector.reduce.or.v4i32(<4 x i32> %53)
...
bb.f:                                             ; preds = %.lr.ph748.split, %bb.e
  ...
  %i.ce = add nuw nsw <4 x i32> %i.cd, %24
