...
.lr.ph680.split:                                  ; preds = %.lr.ph680, %bb.g
  ...
  switch i32 %i.ae, label %.lr.ph680.split.unreachabledefault [
    i32 0, label %bb.c
    i32 3, label %bb.d
    i32 2, label %bb.e
    i32 1, label %bb.f
...
bb.w:                                             ; preds = %.lr.ph671, %bb.ab
  ...
  switch i32 %i.uo, label %default.unreachable [
    i32 0, label %bb.x
    i32 3, label %bb.y
    i32 2, label %bb.z
    i32 1, label %bb.aa
...
bb.ad:                                            ; preds = %.lr.ph, %bb.ai
  ...
  switch i32 %i.aav, label %default.unreachable [
    i32 0, label %bb.ae
    i32 3, label %bb.af
    i32 2, label %bb.ag
    i32 1, label %bb.ah
...
bb.ak:                                            ; preds = %.lr.ph683, %bb.ap
  ...
  switch i32 %i.aix, label %default.unreachable [
    i32 0, label %bb.al
    i32 3, label %bb.am
    i32 2, label %bb.an
    i32 1, label %bb.ao
...
bb.w:                                             ; preds = %.lr.ph671, %bb.ab
  ...
  switch i32 %i.ve, label %default.unreachable [
    i32 0, label %bb.x
    i32 3, label %bb.y
    i32 2, label %bb.z
    i32 1, label %bb.aa
...
bb.ad:                                            ; preds = %.lr.ph, %bb.ai
  ...
  switch i32 %i.abl, label %default.unreachable [
    i32 0, label %bb.ae
    i32 3, label %bb.af
    i32 2, label %bb.ag
    i32 1, label %bb.ah
...
bb.ak:                                            ; preds = %.lr.ph683, %bb.ap
  ...
  switch i32 %i.akd, label %default.unreachable [
    i32 0, label %bb.al
    i32 3, label %bb.am
    i32 2, label %bb.an
    i32 1, label %bb.ao
...
.lr.ph704.split:                                  ; preds = %.lr.ph704, %bb.g
  ...
  switch i32 %i.ae, label %.lr.ph704.split.unreachabledefault [
    i32 0, label %bb.c
    i32 3, label %bb.d
    i32 2, label %bb.e
    i32 1, label %bb.f
...
bb.i:                                             ; preds = %.lr.ph701, %bb.n
  ...
  switch i32 %i.eo, label %default.unreachable [
    i32 0, label %bb.j
    i32 3, label %bb.k
    i32 2, label %bb.l
    i32 1, label %bb.m
...
bb.p:                                             ; preds = %.lr.ph698, %bb.u
  ...
  switch i32 %i.iy, label %default.unreachable [
    i32 0, label %bb.q
    i32 3, label %bb.r
    i32 2, label %bb.s
    i32 1, label %bb.t
...
bb.ad:                                            ; preds = %.lr.ph, %bb.ai
  ...
  switch i32 %i.qi, label %default.unreachable [
    i32 0, label %bb.ae
    i32 3, label %bb.af
    i32 2, label %bb.ag
    i32 1, label %bb.ah
...
bb.i:                                             ; preds = %.lr.ph745, %bb.n
  ...
  switch i32 %i.fg, label %default.unreachable [
    i32 0, label %bb.j
    i32 3, label %bb.k
    i32 2, label %bb.l
    i32 1, label %bb.m
...
bb.p:                                             ; preds = %.lr.ph742, %bb.u
  ...
  switch i32 %i.km, label %default.unreachable [
    i32 0, label %bb.q
    i32 3, label %bb.r
    i32 2, label %bb.s
    i32 1, label %bb.t
...
bb.w:                                             ; preds = %.lr.ph739, %bb.ab
  ...
  switch i32 %i.og, label %default.unreachable [
    i32 0, label %bb.x
    i32 3, label %bb.y
    i32 2, label %bb.z
    i32 1, label %bb.aa
...
bb.ad:                                            ; preds = %.lr.ph, %bb.ai
  ...
  switch i32 %i.sm, label %default.unreachable [
    i32 0, label %bb.ae
    i32 3, label %bb.af
    i32 2, label %bb.ag
    i32 1, label %bb.ah
...
bb.ak:                                            ; preds = %.lr.ph751, %bb.ap
  ...
  switch i32 %i.yc, label %default.unreachable [
    i32 0, label %bb.al
    i32 3, label %bb.am
    i32 2, label %bb.an
    i32 1, label %bb.ao
...
.lr.ph2128.split:                                 ; preds = %.lr.ph2128, %bb.h
  ...
  switch i32 %i.ad, label %.lr.ph2128.split.unreachabledefault [
    i32 0, label %bb.d
    i32 3, label %bb.e
    i32 2, label %bb.f
    i32 1, label %bb.g
...
default.unreachable:                              ; preds = %bb.bv, %bb.bo, %bb.bh, %bb.ba, %bb.at, %bb.cc, %bb.ae, %bb.x, %bb.q, %bb.j, %bb.al
  unreachable
...
bb.j:                                             ; preds = %.lr.ph2125, %bb.o
  ...
  switch i32 %i.mc, label %default.unreachable [
    i32 0, label %bb.k
    i32 3, label %bb.l
    i32 2, label %bb.m
    i32 1, label %bb.n
...
bb.x:                                             ; preds = %.lr.ph2119, %bb.ac
  ...
  switch i32 %i.ajc, label %default.unreachable [
    i32 0, label %bb.y
    i32 3, label %bb.z
    i32 2, label %bb.aa
    i32 1, label %bb.ab
...
bb.ae:                                            ; preds = %.lr.ph2116, %bb.aj
  ...
  switch i32 %i.aud, label %default.unreachable [
    i32 0, label %bb.af
    i32 3, label %bb.ag
    i32 2, label %bb.ah
    i32 1, label %bb.ai
...
bb.al:                                            ; preds = %.lr.ph2131, %bb.aq
  ...
  switch i32 %i.bha, label %default.unreachable [
    i32 0, label %bb.am
    i32 3, label %bb.an
    i32 2, label %bb.ao
    i32 1, label %bb.ap
...
bb.at:                                            ; preds = %.lr.ph2110, %bb.ay
  ...
  switch i32 %i.bmr, label %default.unreachable [
    i32 0, label %bb.au
    i32 3, label %bb.av
    i32 2, label %bb.aw
    i32 1, label %bb.ax
...
bb.ba:                                            ; preds = %.lr.ph2107, %bb.bf
  ...
  switch i32 %i.byi, label %default.unreachable [
    i32 0, label %bb.bb
    i32 3, label %bb.bc
    i32 2, label %bb.bd
    i32 1, label %bb.be
...
bb.bh:                                            ; preds = %.lr.ph2104, %bb.bm
  ...
  switch i32 %i.cjz, label %default.unreachable [
    i32 0, label %bb.bi
    i32 3, label %bb.bj
    i32 2, label %bb.bk
    i32 1, label %bb.bl
...
bb.bo:                                            ; preds = %.lr.ph2101, %bb.bt
  ...
  switch i32 %i.cus, label %default.unreachable [
    i32 0, label %bb.bp
    i32 3, label %bb.bq
    i32 2, label %bb.br
    i32 1, label %bb.bs
...
bb.bv:                                            ; preds = %.lr.ph, %bb.ca
  ...
  switch i32 %i.dfl, label %default.unreachable [
    i32 0, label %bb.bw
    i32 3, label %bb.bx
    i32 2, label %bb.by
    i32 1, label %bb.bz
...
bb.cc:                                            ; preds = %.lr.ph2113, %bb.ch
  ...
  switch i32 %i.dsa, label %default.unreachable [
    i32 0, label %bb.cd
    i32 3, label %bb.ce
    i32 2, label %bb.cf
    i32 1, label %bb.cg
...
.lr.ph1185.split:                                 ; preds = %.lr.ph1185, %bb.h
  ...
  switch i32 %i.ad, label %.lr.ph1185.split.unreachabledefault [
    i32 0, label %bb.d
    i32 3, label %bb.e
    i32 2, label %bb.f
    i32 1, label %bb.g
...
default.unreachable:                              ; preds = %bb.ae, %bb.x, %bb.q, %bb.j, %bb.al
  unreachable
...
bb.x:                                             ; preds = %.lr.ph1176, %bb.ac
  ...
  switch i32 %i.aqs, label %default.unreachable [
    i32 0, label %bb.y
    i32 3, label %bb.z
    i32 2, label %bb.aa
    i32 1, label %bb.ab
...
bb.ae:                                            ; preds = %.lr.ph, %bb.aj
  ...
  switch i32 %i.bdz, label %default.unreachable [
    i32 0, label %bb.af
    i32 3, label %bb.ag
    i32 2, label %bb.ah
    i32 1, label %bb.ai
...
bb.al:                                            ; preds = %.lr.ph1188, %bb.aq
  ...
  switch i32 %i.btc, label %default.unreachable [
    i32 0, label %bb.am
    i32 3, label %bb.an
    i32 2, label %bb.ao
    i32 1, label %bb.ap
