...
vector.body230:                                   ; preds = %vector.body230, %vector.ph228
  ...
  br i1 %i.cx, label %._crit_edge91.i, label %vector.body230, !llvm.loop !171
...
.lr.ph90.i:                                       ; preds = %.lr.ph90.i.preheader244, %.lr.ph90.i
  ...
  br i1 %i.dc, label %.lr.ph90.i, label %._crit_edge91.i, !llvm.loop !172
...
vector.body195:                                   ; preds = %vector.body195, %vector.ph193
  ...
  br i1 %i.dn, label %middle.block201, label %vector.body195, !llvm.loop !173
...
vec.epilog.vector.body211:                        ; preds = %vec.epilog.vector.body211, %vec.epilog.ph209
  ...
  br i1 %i.dq, label %vec.epilog.middle.block217, label %vec.epilog.vector.body211, !llvm.loop !174
...
.lr.ph.i79.i:                                     ; preds = %.lr.ph.i79.i.preheader, %.lr.ph.i79.i
  ...
  %i.ds = load i8, ptr %.08.i80.i, align 1, !tbaa !16
  %i.dt = getelementptr inbounds nuw i8, ptr %.057.i81.i, i64 1 ; 2 uses
  store i8 %i.ds, ptr %.057.i81.i, align 1, !tbaa !16
...
.thread71:                                        ; preds = %.lr.ph.i79.i, %.lr.ph.i.i, %middle.block201, %vec.epilog.middle.block217, %middle.block, %vec.epilog.middle.block, %bb.u, %._crit_edge91.i, %bb.q, %bb.p, %._crit_edge.i
  %i.du = load ptr, ptr %i.t, align 8, !tbaa !61
  %i.dv = getelementptr inbounds nuw i8, ptr %i.du, i64 %spec.select57
  store ptr %i.dv, ptr %i.t, align 8, !tbaa !61
  %i.dw = load i64, ptr %i.l, align 8, !tbaa !62
  %i.dx = sub i64 %i.dw, %spec.select57           ; 3 uses
  store i64 %i.dx, ptr %i.l, align 8, !tbaa !62
  %i.dy = add i64 %spec.select57, %.2.ph107
  %i.dz = load i64, ptr %i.b, align 8, !tbaa !63
  %i.ea = add i64 %i.dz, %spec.select57
  store i64 %i.ea, ptr %i.b, align 8, !tbaa !63
  br label %.outer

bb.v:                                             ; preds = %bb.i
  store ptr %i.at, ptr %i.h, align 8, !tbaa !57
  %i.eb = load ptr, ptr %i.at, align 8, !tbaa !59
  store ptr %i.eb, ptr %i.t, align 8, !tbaa !61
  %i.ec = getelementptr inbounds nuw i8, ptr %i.ar, i64 24
  %i.ed = load i64, ptr %i.ec, align 8, !tbaa !60 ; 4 uses
  store i64 %i.ed, ptr %i.l, align 8, !tbaa !62
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.bb, label %._crit_edge91, label %vector.body, !llvm.loop !185
...
.lr.ph90:                                         ; preds = %.lr.ph90.preheader178, %.lr.ph90
  ...
  br i1 %i.bg, label %.lr.ph90, label %._crit_edge91, !llvm.loop !186
...
vector.body122:                                   ; preds = %vector.body122, %vector.ph120
  ...
  br i1 %i.bq, label %middle.block128, label %vector.body122, !llvm.loop !187
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.bt, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !188
...
.lr.ph.i79:                                       ; preds = %.lr.ph.i79.preheader, %.lr.ph.i79
  ...
  %i.bv = load i8, ptr %.08.i80, align 1, !tbaa !16
  %i.bw = getelementptr inbounds nuw i8, ptr %.057.i81, i64 1 ; 2 uses
  store i8 %i.bv, ptr %.057.i81, align 1, !tbaa !16
