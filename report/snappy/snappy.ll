...
begin_hunk_0_@_ZN6snappy17SnappyIOVecWriter6AppendEPKcmPPc:bb.a
  %i.u = getelementptr inbounds nuw i8, ptr %i.t, i64 %.sroa.speculated.i
  store ptr %i.u, ptr %i.i, align 8, !tbaa !61
  %i.v = load i64, ptr %i.h, align 8, !tbaa !62
  %i.w = sub i64 %i.v, %.sroa.speculated.i        ; 2 uses
  store i64 %i.w, ptr %i.h, align 8, !tbaa !62
  %i.x = load i64, ptr %i.a, align 8, !tbaa !63
  ...
  br i1 %.not.i, label %_ZN6snappy17SnappyIOVecWriter13AppendNoCheckEPKcm.exit, label %bb.c, !llvm.loop !5
...
.lr.ph.preheader:                                 ; preds = %bb.b
  ...
  %i.m = load i64, ptr %i.l, align 8, !tbaa !62   ; 3 uses
  %i.n = sub i64 %i.k, %i.m
  br label %.lr.ph
...
bb.d:                                             ; preds = %.lr.ph
  ...
  br i1 %.not50, label %.loopexit, label %.lr.ph, !llvm.loop !164
...
.lr.ph88.split:                                   ; preds = %.outer, %.lr.ph88.lr.ph
  ...
  %.promoted = load ptr, ptr %i.h, align 8, !tbaa !57 ; 2 uses
  %.not53100 = icmp eq ptr %.134.ph105, %.promoted
  br i1 %.not53100, label %.lr.ph101, label %.split.us

.split.us:                                        ; preds = %bb.v, %.lr.ph88.split
  %.pre.i = phi i64 [ %.pre.i131, %.lr.ph88.split ], [ %i.ef, %bb.v ] ; 2 uses
  %.promoted102123 = phi i64 [ %.promoted102, %.lr.ph88.split ], [ %i.ef, %bb.v ]
...
.lr.ph.i:                                         ; preds = %.split.us
  %i.x = load ptr, ptr %.134.ph105, align 8, !tbaa !59
...
._crit_edge21.i:                                  ; preds = %bb.e
  %.pre22.i = load ptr, ptr %i.t, align 8, !tbaa !61
  br label %bb.h

bb.f:                                             ; preds = %bb.e
  %i.aa = load ptr, ptr %i.h, align 8, !tbaa !57  ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  store ptr %i.ab, ptr %i.h, align 8, !tbaa !57
  %i.ad = load ptr, ptr %i.ab, align 8, !tbaa !59 ; 2 uses
  store ptr %i.ad, ptr %i.t, align 8, !tbaa !61
  %i.ae = getelementptr inbounds nuw i8, ptr %i.aa, i64 24
  %i.af = load i64, ptr %i.ae, align 8, !tbaa !60 ; 2 uses
  store i64 %i.af, ptr %i.l, align 8, !tbaa !62
  br label %bb.h
...
bb.h:                                             ; preds = %bb.g, %._crit_edge21.i
  ...
  %i.ai = load ptr, ptr %i.t, align 8, !tbaa !61
  %i.aj = getelementptr inbounds nuw i8, ptr %i.ai, i64 %.sroa.speculated.i
  store ptr %i.aj, ptr %i.t, align 8, !tbaa !61
  %i.ak = load i64, ptr %i.l, align 8, !tbaa !62
  %i.al = sub i64 %i.ak, %.sroa.speculated.i      ; 4 uses
  store i64 %i.al, ptr %i.l, align 8, !tbaa !62
  %i.am = load i64, ptr %i.b, align 8, !tbaa !63
  %i.an = add i64 %i.am, %.sroa.speculated.i
  store i64 %i.an, ptr %i.b, align 8, !tbaa !63
  ...
  br i1 %.not.i, label %_ZN6snappy17SnappyIOVecWriter13AppendNoCheckEPKcm.exit, label %bb.e, !llvm.loop !5
...
.lr.ph101:                                        ; preds = %.lr.ph88.split, %bb.v
  %i.aq = phi i64 [ %i.ef, %bb.v ], [ %.promoted102, %.lr.ph88.split ] ; 7 uses
...
.split94.us:                                      ; preds = %.lr.ph101
  ...
  %i.av = load ptr, ptr %.134.ph105, align 8, !tbaa !59 ; 2 uses
  %i.aw = getelementptr inbounds nuw i8, ptr %i.av, i64 %.2.ph107 ; 20 uses
  %i.ax = load ptr, ptr %i.t, align 8, !tbaa !61  ; 10 uses
...
bb.j:                                             ; preds = %.split94.us
  ...
  br i1 %.not.i58, label %iter.check, label %.lr.ph.i59, !prof !29
...
vector.body:                                      ; preds = %vector.ph, %vector.body
  ...
  store <16 x i8> %wide.load, ptr %next.gep175, align 1, !tbaa !16
  %index.next = add nuw i64 %index, 16            ; 2 uses
  %i.bi = icmp eq i64 %index.next, %n.vec
  br i1 %i.bi, label %middle.block, label %vector.body, !llvm.loop !165
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load181 = load <4 x i8>, ptr %next.gep179, align 1, !tbaa !16
  store <4 x i8> %wide.load181, ptr %next.gep180, align 1, !tbaa !16
  %index.next182 = add nuw i64 %index178, 4       ; 2 uses
  %i.bl = icmp eq i64 %index.next182, %n.vec177
  br i1 %i.bl, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !166
...
.lr.ph.i59:                                       ; preds = %bb.j, %.lr.ph.i59
  ...
  br i1 %i.bo, label %.lr.ph.i59, label %._crit_edge.i, !llvm.loop !6

._crit_edge.i:                                    ; preds = %.lr.ph.i59
  %.not67.i = icmp ult ptr %i.bm, %i.ay
  br i1 %.not67.i, label %bb.k, label %.thread71, !prof !29
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i
  ...
  %i.bq = load i8, ptr %.08.i.i, align 1, !tbaa !16
  %i.br = getelementptr inbounds nuw i8, ptr %.057.i.i, i64 1 ; 2 uses
  store i8 %i.bq, ptr %.057.i.i, align 1, !tbaa !16
  %exitcond.not.i.i = icmp eq ptr %i.br, %i.ay
  br i1 %exitcond.not.i.i, label %.thread71, label %.lr.ph.i.i, !llvm.loop !167
...
bb.k:                                             ; preds = %._crit_edge.i, %.split94.us
  ...
  br i1 %.not68.i, label %bb.r, label %bb.l, !prof !29
...
.lr.ph90.i.preheader:                             ; preds = %bb.r
  ...
  %i.co = sub i64 %i.cn, %.157.i222               ; 3 uses
  %i.cp = lshr i64 %i.co, 4
  %min.iters.check227 = icmp ult i64 %i.co, 80
...
.lr.ph:                                           ; preds = %bb.b, %.lr.ph
  ...
  br i1 %i.j, label %.lr.ph, label %._crit_edge, !llvm.loop !6
...
vector.body149:                                   ; preds = %vector.ph147, %vector.body149
  ...
  br i1 %i.q, label %middle.block155, label %vector.body149, !llvm.loop !179
...
vec.epilog.vector.body166:                        ; preds = %vec.epilog.vector.body166, %vec.epilog.ph164
  ...
  br i1 %i.t, label %vec.epilog.middle.block172, label %vec.epilog.vector.body166, !llvm.loop !180
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  ...
  %i.v = load i8, ptr %.08.i, align 1, !tbaa !16
  %i.w = getelementptr inbounds nuw i8, ptr %.057.i, i64 1 ; 2 uses
  store i8 %i.v, ptr %.057.i, align 1, !tbaa !16
...
.lr.ph90.preheader:                               ; preds = %bb.k
  %i.ar = add i64 %i.b, -17
  %i.as = sub i64 %i.ar, %.157110                 ; 3 uses
  %i.at = lshr i64 %i.as, 4
  %min.iters.check = icmp ult i64 %i.as, 208
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep112 = getelementptr i8, ptr %.157, i64 %i.bc
  ...
  %i.bd = icmp eq i64 %index, %i.at
  br i1 %i.bd, label %._crit_edge91, label %vector.body, !llvm.loop !185

._crit_edge91:                                    ; preds = %vector.body, %.lr.ph90, %bb.k
  %.2.lcssa = phi ptr [ %.157, %bb.k ], [ %i.bg, %.lr.ph90 ], [ %i.bb, %vector.body ] ; 5 uses
  %.054.lcssa = phi ptr [ %0, %bb.k ], [ %i.bh, %.lr.ph90 ], [ %i.ba, %vector.body ] ; 3 uses
...
.lr.ph90:                                         ; preds = %.lr.ph90.preheader178, %.lr.ph90
  %.05488 = phi ptr [ %i.bh, %.lr.ph90 ], [ %0, %.lr.ph90.preheader178 ] ; 3 uses
  %.287 = phi ptr [ %i.bg, %.lr.ph90 ], [ %.157, %.lr.ph90.preheader178 ] ; 3 uses
  %.val4.i77 = load i64, ptr %.05488, align 1
  store i64 %.val4.i77, ptr %.287, align 1
  %i.be = getelementptr inbounds nuw i8, ptr %.05488, i64 8
  ...
  %i.bh = getelementptr inbounds nuw i8, ptr %.05488, i64 16 ; 2 uses
  %i.bi = icmp ult ptr %i.bg, %i.ap
  br i1 %i.bi, label %.lr.ph90, label %._crit_edge91, !llvm.loop !186
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.bk = getelementptr inbounds nuw i8, ptr %.054.lcssa, i64 8
  %i.bl = getelementptr inbounds nuw i8, ptr %.2.lcssa, i64 8
  br label %bb.n

bb.n:                                             ; preds = %bb.m, %bb.l
  %.3 = phi ptr [ %i.bl, %bb.m ], [ %.2.lcssa, %bb.l ] ; 7 uses
  %.155 = phi ptr [ %i.bk, %bb.m ], [ %.054.lcssa, %bb.l ] ; 6 uses
  %i.bm = icmp ult ptr %.3, %2
  br i1 %i.bm, label %iter.check, label %_ZN6snappy12_GLOBAL__N_119IncrementalCopySlowEPKcPcS3_.exit
...
vector.main.loop.iter.check:                      ; preds = %iter.check
  %min.iters.check119 = icmp ult i64 %i.bn, 16
  br i1 %min.iters.check119, label %vec.epilog.ph, label %vector.ph120

vector.ph120:                                     ; preds = %vector.main.loop.iter.check
  %i.bp = and i64 %i.bn, 12
  %n.vec121 = and i64 %i.bn, -16                  ; 5 uses
  %i.bq = getelementptr i8, ptr %.155, i64 %n.vec121
  %i.br = getelementptr i8, ptr %.3, i64 %n.vec121
...
vector.body122:                                   ; preds = %vector.ph120, %vector.body122
  ...
  %i.bs = icmp eq i64 %index.next127, %n.vec121
  br i1 %i.bs, label %middle.block128, label %vector.body122, !llvm.loop !187

middle.block128:                                  ; preds = %vector.body122
  %cmp.n129 = icmp eq i64 %i.bn, %n.vec121
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec132 = and i64 %i.bn, -4                   ; 4 uses
  %i.bt = getelementptr i8, ptr %.155, i64 %n.vec132
  %i.bu = getelementptr i8, ptr %.3, i64 %n.vec132
  br label %vec.epilog.vector.body
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.bv = icmp eq i64 %index.next137, %n.vec132
  br i1 %i.bv, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !188

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n138 = icmp eq i64 %i.bn, %n.vec132
...
.lr.ph.i79.preheader:                             ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %.08.i80.ph = phi ptr [ %.155, %iter.check ], [ %i.bq, %vec.epilog.iter.check ], [ %i.bt, %vec.epilog.middle.block ]
  %.057.i81.ph = phi ptr [ %.3, %iter.check ], [ %i.br, %vec.epilog.iter.check ], [ %i.bu, %vec.epilog.middle.block ]
  br label %.lr.ph.i79

.lr.ph.i79:                                       ; preds = %.lr.ph.i79.preheader, %.lr.ph.i79
  %.08.i80 = phi ptr [ %i.bw, %.lr.ph.i79 ], [ %.08.i80.ph, %.lr.ph.i79.preheader ] ; 2 uses
  %.057.i81 = phi ptr [ %i.by, %.lr.ph.i79 ], [ %.057.i81.ph, %.lr.ph.i79.preheader ] ; 2 uses
  %i.bw = getelementptr inbounds nuw i8, ptr %.08.i80, i64 1
  %i.bx = load i8, ptr %.08.i80, align 1, !tbaa !16
  %i.by = getelementptr inbounds nuw i8, ptr %.057.i81, i64 1 ; 2 uses
  store i8 %i.bx, ptr %.057.i81, align 1, !tbaa !16
  %exitcond.not.i82 = icmp eq ptr %i.by, %2
