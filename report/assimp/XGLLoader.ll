...
.lr.ph.i.i.i.i.i219.preheader:                    ; preds = %.noexc226
  ...
  %21 = add i64 %i.kr, -8
  %22 = sub i64 %21, %i.ks                        ; 2 uses
  %i.lf = lshr i64 %22, 3
  %i.lg = add nuw nsw i64 %i.lf, 1                ; 2 uses
  %min.iters.check = icmp ult i64 %22, 24
  %i.lh = sub i64 %i.ks, %i.le
  %diff.check = icmp ugt i64 %i.lh, -32
...
vector.ph:                                        ; preds = %.lr.ph.i.i.i.i.i219.preheader
  ...
  %i.li = shl i64 %n.vec, 3                       ; 2 uses
  %i.lj = getelementptr i8, ptr %i.lb, i64 %i.li  ; 2 uses
  %i.lk = getelementptr i8, ptr %i.kq, i64 %i.li
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.ll = shl i64 %index, 3                       ; 2 uses
  %next.gep = getelementptr i8, ptr %i.lb, i64 %i.ll ; 2 uses
  %next.gep719 = getelementptr i8, ptr %i.kq, i64 %i.ll ; 2 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !67)
  call void @llvm.experimental.noalias.scope.decl(metadata !70)
  %i.lm = getelementptr i8, ptr %next.gep719, i64 16
  %wide.load = load <2 x i64>, ptr %next.gep719, align 4, !alias.scope !70, !noalias !67
  %wide.load720 = load <2 x i64>, ptr %i.lm, align 4, !alias.scope !70, !noalias !67
  %i.ln = getelementptr i8, ptr %next.gep, i64 16
  store <2 x i64> %wide.load, ptr %next.gep, align 4, !alias.scope !67, !noalias !70
  store <2 x i64> %wide.load720, ptr %i.ln, align 4, !alias.scope !67, !noalias !70
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.lo = icmp eq i64 %index.next, %n.vec
  br i1 %i.lo, label %middle.block, label %vector.body, !llvm.loop !72
...
.lr.ph.i.i.i.i.i219.preheader722:                 ; preds = %.lr.ph.i.i.i.i.i219.preheader, %middle.block
  %.012.i.i.i.i.i220.ph = phi ptr [ %i.lb, %.lr.ph.i.i.i.i.i219.preheader ], [ %i.lj, %middle.block ]
  %.0911.i.i.i.i.i221.ph = phi ptr [ %i.kq, %.lr.ph.i.i.i.i.i219.preheader ], [ %i.lk, %middle.block ]
  br label %.lr.ph.i.i.i.i.i219

.lr.ph.i.i.i.i.i219:                              ; preds = %.lr.ph.i.i.i.i.i219.preheader722, %.lr.ph.i.i.i.i.i219
  %.012.i.i.i.i.i220 = phi ptr [ %i.lr, %.lr.ph.i.i.i.i.i219 ], [ %.012.i.i.i.i.i220.ph, %.lr.ph.i.i.i.i.i219.preheader722 ] ; 2 uses
  %.0911.i.i.i.i.i221 = phi ptr [ %i.lq, %.lr.ph.i.i.i.i.i219 ], [ %.0911.i.i.i.i.i221.ph, %.lr.ph.i.i.i.i.i219.preheader722 ] ; 2 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !67)
  call void @llvm.experimental.noalias.scope.decl(metadata !70)
  %i.lp = load i64, ptr %.0911.i.i.i.i.i221, align 4, !alias.scope !70, !noalias !67
  store i64 %i.lp, ptr %.012.i.i.i.i.i220, align 4, !alias.scope !67, !noalias !70
  %i.lq = getelementptr inbounds nuw i8, ptr %.0911.i.i.i.i.i221, i64 8 ; 2 uses
  %i.lr = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i.i220, i64 8 ; 2 uses
  %.not.i.i.i.i.i222 = icmp eq ptr %i.lq, %i.kl
...
_ZNSt6vectorI10aiVector2tIfESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit22.i.i: ; preds = %.lr.ph.i.i.i.i.i219, %middle.block, %.noexc226
  %.0.lcssa.i.i.i.i.i223 = phi ptr [ %i.lb, %.noexc226 ], [ %i.lj, %middle.block ], [ %i.lr, %.lr.ph.i.i.i.i.i219 ]
  %i.ls = getelementptr inbounds nuw i8, ptr %.0.lcssa.i.i.i.i.i223, i64 8
...
_ZNSt6vectorI10aiVector2tIfESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i: ; preds = %bb.da, %_ZNSt6vectorI10aiVector2tIfESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit22.i.i
  ...
  store ptr %i.ls, ptr %i.hq, align 8
  %i.lt = getelementptr inbounds nuw [8 x i8], ptr %i.lb, i64 %i.kz
  store ptr %i.lt, ptr %i.hr, align 8
  br label %_ZNSt6vectorI10aiVector2tIfESaIS1_EE9push_backERKS1_.exit
...
_ZNSt6vectorI10aiVector2tIfESaIS1_EE9push_backERKS1_.exit: ; preds = %_ZNSt6vectorI10aiVector2tIfESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i, %bb.cy, %_ZNSt6vectorI10aiVector3tIfESaIS1_EE9push_backERKS1_.exit214
  %i.lu = load i32, ptr %i.hu, align 8
  %i.lv = or i32 %i.lu, %i.ht
  store i32 %i.lv, ptr %i.hu, align 8
...
_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit179.thread249: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit170, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.thread, %_ZN6Assimp12LogFunctionsINS_11XGLImporterEE7LogWarnIJRA33_KcEEEvDpOT_.exit, %_ZN6Assimp12LogFunctionsINS_11XGLImporterEE7LogWarnIJRA34_KcEEEvDpOT_.exit, %_ZNSt6vectorIjSaIjEE9push_backERKj.exit, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit179, %_ZN6Assimp12LogFunctionsINS_11XGLImporterEE7LogWarnIJRA33_KcEEEvDpOT_.exit153
  ...
  %i.lw = load ptr, ptr %13, align 8              ; 2 uses
  %i.lx = icmp eq ptr %i.lw, %i.ao
  br i1 %i.lx, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit229, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i227
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i227: ; preds = %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit179.thread249
  %i.ly = load i64, ptr %i.ao, align 8
  %i.lz = add i64 %i.ly, 1
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit229: ; preds = %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit179.thread249, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i227
  ...
  %i.ma = invoke noundef nonnull align 8 dereferenceable(16) ptr @_ZN4pugi17xml_node_iteratorppEv(ptr noundef nonnull align 8 dereferenceable(16) %11)
...
bb.dc:                                            ; preds = %.body, %bb.bl, %bb.ay, %bb.ak, %bb.w
  ...
  %i.mb = load ptr, ptr %13, align 8              ; 2 uses
  %i.mc = icmp eq ptr %i.mb, %i.ao
  br i1 %i.mc, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit232, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i230

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i230: ; preds = %bb.dc
  %i.md = load i64, ptr %i.ao, align 8
  %i.me = add i64 %i.md, 1
...
bb.de:                                            ; preds = %bb.f
  %i.mf = invoke noundef nonnull align 8 dereferenceable(104) ptr @_ZNSt3mapIjN6Assimp11XGLImporter16TempMaterialMeshESt4lessIjESaISt4pairIKjS2_EEEixERS6_(ptr noundef nonnull align 8 dereferenceable(48) %9, ptr noundef nonnull align 4 dereferenceable(4) %i.i)
          to label %bb.df unwind label %bb.dg

bb.df:                                            ; preds = %bb.de
  %i.mg = getelementptr inbounds nuw i8, ptr %i.mf, i64 100
...
bb.dh:                                            ; preds = %bb.df, %bb.f
  %i.mi = getelementptr inbounds nuw i8, ptr %20, i64 8 ; 4 uses
  store i32 0, ptr %i.mi, align 8
  %i.mj = getelementptr inbounds nuw i8, ptr %20, i64 16 ; 3 uses
  store ptr null, ptr %i.mj, align 8
  %i.mk = getelementptr inbounds nuw i8, ptr %20, i64 24 ; 2 uses
  store ptr %i.mi, ptr %i.mk, align 8
  %i.ml = getelementptr inbounds nuw i8, ptr %20, i64 32 ; 2 uses
  store ptr %i.mi, ptr %i.ml, align 8
  %i.mm = getelementptr inbounds nuw i8, ptr %20, i64 40 ; 2 uses
  store i64 0, ptr %i.mm, align 8
  %i.mn = load ptr, ptr %i.ae, align 8            ; 2 uses
  %.not.i.i = icmp eq ptr %i.mn, null
...
bb.di:                                            ; preds = %bb.dh
  ...
  %i.mo = invoke noundef ptr @_ZNSt8_Rb_treeIjSt4pairIKjN6Assimp11XGLImporter16TempMaterialMeshEESt10_Select1stIS5_ESt4lessIjESaIS5_EE7_M_copyILb0ENSB_11_Alloc_nodeEEEPSt13_Rb_tree_nodeIS5_ESG_PSt18_Rb_tree_node_baseRT0_(ptr noundef nonnull align 8 dereferenceable(48) %20, ptr noundef nonnull %i.mn, ptr noundef nonnull %i.mi, ptr noundef nonnull align 8 dereferenceable(8) %3)
          to label %.noexc.i.i233 unwind label %bb.g ; 3 uses

.noexc.i.i233:                                    ; preds = %bb.di, %.noexc.i.i233
  %.0.i.i.i.i.i.i = phi ptr [ %i.mq, %.noexc.i.i233 ], [ %i.mo, %bb.di ] ; 2 uses
  %i.mp = getelementptr inbounds nuw i8, ptr %.0.i.i.i.i.i.i, i64 16
...
_ZNSt8_Rb_treeIjSt4pairIKjN6Assimp11XGLImporter16TempMaterialMeshEESt10_Select1stIS5_ESt4lessIjESaIS5_EE10_S_minimumEPSt18_Rb_tree_node_base.exit.i.i.i.i: ; preds = %.noexc.i.i233
  store ptr %.0.i.i.i.i.i.i, ptr %i.mk, align 8
  br label %bb.dj
...
bb.dj:                                            ; preds = %bb.dj, %_ZNSt8_Rb_treeIjSt4pairIKjN6Assimp11XGLImporter16TempMaterialMeshEESt10_Select1stIS5_ESt4lessIjESaIS5_EE10_S_minimumEPSt18_Rb_tree_node_base.exit.i.i.i.i
  %.0.i.i7.i.i.i.i = phi ptr [ %i.mo, %_ZNSt8_Rb_treeIjSt4pairIKjN6Assimp11XGLImporter16TempMaterialMeshEESt10_Select1stIS5_ESt4lessIjESaIS5_EE10_S_minimumEPSt18_Rb_tree_node_base.exit.i.i.i.i ], [ %i.ms, %bb.dj ] ; 2 uses
  %i.mr = getelementptr inbounds nuw i8, ptr %.0.i.i7.i.i.i.i, i64 24
  %i.ms = load ptr, ptr %i.mr, align 8            ; 2 uses
  %.not.i.i8.i.i.i.i = icmp eq ptr %i.ms, null
  br i1 %.not.i.i8.i.i.i.i, label %bb.dk, label %bb.dj, !llvm.loop !78

bb.dk:                                            ; preds = %bb.dj
  store ptr %.0.i.i7.i.i.i.i, ptr %i.ml, align 8
  %i.mt = load i64, ptr %i.ah, align 8
  store i64 %i.mt, ptr %i.mm, align 8
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #26
  store ptr %i.mo, ptr %i.mj, align 8
...
_ZNSt3mapIjN6Assimp11XGLImporter16TempMaterialMeshESt4lessIjESaISt4pairIKjS2_EEEC2ERKS9_.exit: ; preds = %bb.dk, %bb.dh
  %i.mu = load i32, ptr %i.i, align 4
  invoke void @_ZN6Assimp11XGLImporter18AppendOutputMeshesESt3mapIjNS0_16TempMaterialMeshESt4lessIjESaISt4pairIKjS2_EEERNS0_9TempScopeEj(ptr nonnull align 8 poison, ptr noundef nonnull %20, ptr noundef nonnull align 8 dereferenceable(152) %2, i32 noundef %i.mu)
end_hunk_1
...
.body:                                            ; preds = %bb.q, %bb.k, %bb.h
  %.pn = phi { ptr, i32 } [ %i.t, %bb.h ], [ %i.ao, %bb.q ], [ %i.ad, %bb.k ]
  %.030 = extractvalue { ptr, i32 } %.pn, 0
  %i.ap = tail call ptr @__cxa_begin_catch(ptr %.030) #26 ; 0 uses
  invoke void @_ZNSt8_Rb_treeIjSt4pairIKjN6Assimp11XGLImporter16TempMaterialMeshEESt10_Select1stIS5_ESt4lessIjESaIS5_EE8_M_eraseEPSt13_Rb_tree_nodeIS5_E(ptr noundef nonnull align 8 dereferenceable(48) %0, ptr noundef nonnull %i.b)
...
.noexc31:                                         ; preds = %_ZNSt15__new_allocatorI10aiVector2tIfEE8allocateEmPKv.exit.i.i.i.i, %.loopexit39
  ...
  %i.ay = load ptr, ptr %i.al, align 8            ; 5 uses
