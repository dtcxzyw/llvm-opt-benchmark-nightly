...
.lr.ph441:                                        ; preds = %.lr.ph441.preheader, %.lr.ph441
  ...
  %scevgep1251 = getelementptr i8, ptr %.sroa.0151.0, i64 %i.gp
...
.lr.ph443:                                        ; preds = %.lr.ph443.preheader, %.lr.ph443
  ...
  %scevgep1253 = getelementptr i8, ptr %.sroa.0166.0, i64 %i.hf
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.n
  %lsr.iv = phi i64 [ 0, %.lr.ph.preheader ], [ %lsr.iv.next, %bb.n ] ; 3 uses
...
.loopexit.loopexit:                               ; preds = %.loopexit.loopexitsplit, %.lr.ph..loopexit.loopexit_crit_edge
  %.1.ph = phi i32 [ %tmp, %.lr.ph..loopexit.loopexit_crit_edge ], [ 0, %.loopexit.loopexitsplit ]
  br label %.loopexit
