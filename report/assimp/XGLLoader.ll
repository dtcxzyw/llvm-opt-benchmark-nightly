...
begin_hunk_0_@_ZN6Assimp11XGLImporter9ReadTrafoERN4pugi8xml_nodeE:bb.a
  ...
  %.0.lcssa = phi float [ 1.000000e+00, %bb.b ], [ %.1, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit68 ] ; 3 uses
...
begin_hunk_1_@_ZN6Assimp11XGLImporter9ReadTrafoERN4pugi8xml_nodeE:bb.a
  ...
  %9 = insertelement <2 x float> poison, float %.0.lcssa, i64 0
  %10 = shufflevector <2 x float> %9, <2 x float> poison, <2 x i32> zeroinitializer
  %11 = insertelement <2 x float> poison, float %i.eq, i64 0
  %12 = insertelement <2 x float> %11, float %.sroa.22.2, i64 1
  %13 = fmul <2 x float> %10, %12
  store <2 x float> %13, ptr %i.ez, align 4
