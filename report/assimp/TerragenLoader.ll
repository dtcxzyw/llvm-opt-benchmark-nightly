...
.invoke355:                                       ; preds = %bb.bq, %bb.bx, %bb.bu
  ...
  invoke void @__cxa_throw(ptr nonnull %i.fk, ptr nonnull @_ZTI17DeadlyImportError, ptr nonnull @_ZNSt13runtime_errorD2Ev) #20
          to label %.cont356 unwind label %.loopexit.split-lp
...
bb.bx:                                            ; preds = %bb.bw
  ...
  invoke void @_ZN17DeadlyImportErrorC2EPKc(ptr noundef nonnull align 8 dereferenceable(16) %i.fo, ptr noundef nonnull @.str.21)
          to label %.invoke355 unwind label %bb.by
...
.preheader.preheader:                             ; preds = %.loopexit, %.loopexit279
...
.preheader:                                       ; preds = %.preheader.preheader, %._crit_edge.us
  %indvars.iv317 = phi i64 [ 0, %.preheader.preheader ], [ %indvars.iv.next318, %._crit_edge.us ] ; 3 uses
  %.0143304 = phi i32 [ 0, %.preheader.preheader ], [ %i.km, %._crit_edge.us ]
  %.1151302 = phi ptr [ %.0150, %.preheader.preheader ], [ %.3153, %._crit_edge.us ]
  %.0154301 = phi ptr [ %i.hj, %.preheader.preheader ], [ %i.jp, %._crit_edge.us ]
  %.0156300 = phi ptr [ %i.gf, %.preheader.preheader ], [ %i.kn, %._crit_edge.us ]
...
bb.ck:                                            ; preds = %.preheader, %bb.cn
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next, %bb.cn ] ; 5 uses
  %.1144295 = phi i32 [ %.0143304, %.preheader ], [ %i.km, %bb.cn ] ; 5 uses
  %.2152294 = phi ptr [ %.1151302, %.preheader ], [ %.3153, %bb.cn ] ; 14 uses
  %.1155293 = phi ptr [ %.0154301, %.preheader ], [ %i.jp, %bb.cn ] ; 13 uses
  %.1157292 = phi ptr [ %.0156300, %.preheader ], [ %i.kn, %bb.cn ] ; 3 uses
  ...
  %i.iw = getelementptr inbounds nuw i8, ptr %.1155293, i64 12
  store float %i.iq, ptr %.1155293, align 4
  ...
  store float %i.iv, ptr %.sroa.5272.0..1155.sroa_idx, align 4
  ...
  %i.jc = getelementptr inbounds nuw i8, ptr %.1155293, i64 24
  ...
  store float %i.jb, ptr %.sroa.5269.0..sroa_idx, align 4
  ...
  %i.jj = getelementptr inbounds nuw i8, ptr %.1155293, i64 36
  ...
  store float %i.ji, ptr %.sroa.5266.0..sroa_idx, align 4
  ...
  %i.jp = getelementptr inbounds nuw i8, ptr %.1155293, i64 48 ; 2 uses
  ...
  store float %i.jo, ptr %.sroa.5263.0..sroa_idx, align 4
...
bb.cl:                                            ; preds = %bb.ck
  ...
  %i.jt = getelementptr inbounds nuw i8, ptr %.2152294, i64 12
  store float %i.js, ptr %.2152294, align 4
  ...
  %i.ju = getelementptr inbounds nuw i8, ptr %.2152294, i64 24
  ...
  %i.jz = getelementptr inbounds nuw i8, ptr %.2152294, i64 36
  ...
  %i.ka = getelementptr inbounds nuw i8, ptr %.2152294, i64 48
...
bb.cm:                                            ; preds = %bb.cl, %bb.ck
  %.3153 = phi ptr [ %i.ka, %bb.cl ], [ %.2152294, %bb.ck ] ; 2 uses
...
._crit_edge.us:                                   ; preds = %bb.cn
  %exitcond323.not = icmp eq i64 %indvars.iv.next318, %wide.trip.count320
  br i1 %exitcond323.not, label %._crit_edge305, label %.preheader, !llvm.loop !10
...
_ZN6Assimp12StreamReaderILb0ELb0EE6IncPtrEl.exit251: ; preds = %._ZN6Assimp12StreamReaderILb0ELb0EE6IncPtrEl.exit251_crit_edge, %bb.cq
  %.pre-phi = phi i64 [ %.pre322, %._ZN6Assimp12StreamReaderILb0ELb0EE6IncPtrEl.exit251_crit_edge ], [ %i.kr, %bb.cq ]
...
bb.cw:                                            ; preds = %_ZN6Assimp12StreamReaderILb0ELb0EE6IncPtrEl.exit251.thread
  ...
  invoke void @_ZN17DeadlyImportErrorC2EPKc(ptr noundef nonnull align 8 dereferenceable(16) %i.ll, ptr noundef nonnull @.str.22)
          to label %.invoke351 unwind label %bb.cx
