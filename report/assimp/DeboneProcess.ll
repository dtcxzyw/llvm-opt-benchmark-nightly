...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi.a = phi <2 x i32> [ <i32 0, i32 1>, %vector.ph ], [ %vec.ind.next, %vector.body ] ; 3 uses
  %vec.phi484 = phi <2 x i32> [ zeroinitializer, %vector.ph ], [ %i.bd, %vector.body ]
  %vec.ind = phi <2 x i32> [ zeroinitializer, %vector.ph ], [ %i.be, %vector.body ]
  %step.add = add nuw <2 x i32> %vec.phi.a, splat (i32 2)
  ...
  %i.ar = and <2 x i32> %vec.phi.a, splat (i32 63)
...
begin_hunk_1_@_ZN6Assimp13DeboneProcess7ExecuteEP7aiScene:bb.a
  ...
  %i.bd = add <2 x i32> %i.ba, %vec.phi484        ; 2 uses
  %i.be = add <2 x i32> %i.bc, %vec.ind           ; 2 uses
  %index.next = add nuw i32 %index, 4             ; 2 uses
  %vec.ind.next = add nuw <2 x i32> %vec.phi.a, splat (i32 4)
...
.lr.ph257.preheader546:                           ; preds = %.lr.ph257.preheader, %middle.block
  %.052256.ph = phi i32 [ 0, %.lr.ph257.preheader ], [ %n.vec, %middle.block ]
  %.056255.ph = phi i32 [ 0, %.lr.ph257.preheader ], [ %i.bg, %middle.block ]
  br label %.lr.ph257
...
.lr.ph257:                                        ; preds = %.lr.ph257.preheader546, %.lr.ph257
  %.052256 = phi i32 [ %i.bq, %.lr.ph257 ], [ %.052256.ph, %.lr.ph257.preheader546 ] ; 3 uses
  %.056255 = phi i32 [ %spec.select, %.lr.ph257 ], [ %.056255.ph, %.lr.ph257.preheader546 ]
  %i.bi = lshr i32 %.052256, 6
  %.zext180 = zext nneg i32 %i.bi to i64
  %i.bj = getelementptr inbounds nuw [8 x i8], ptr %i.j, i64 %.zext180
  %i.bk = and i32 %.052256, 63
  %i.bl = zext nneg i32 %i.bk to i64
  %i.bm = load i64, ptr %i.bj, align 8
  %i.bn = lshr i64 %i.bm, %i.bl
  %i.bo = trunc i64 %i.bn to i32
  %i.bp = and i32 %i.bo, 1
  %spec.select = add nuw nsw i32 %i.bp, %.056255  ; 2 uses
  %i.bq = add nuw i32 %.052256, 1                 ; 2 uses
...
._crit_edge275:                                   ; preds = %._crit_edge275.loopexit, %_ZNSt6vectorIS_ISt4pairIjP6aiNodeESaIS3_EESaIS5_EE6resizeEm.exit
  %.sroa.26.0.lcssa.a = phi ptr [ null, %_ZNSt6vectorIS_ISt4pairIjP6aiNodeESaIS3_EESaIS5_EE6resizeEm.exit ], [ %.sroa.26.2.a, %._crit_edge275.loopexit ] ; 6 uses
  %.sroa.14.0.lcssa = phi i64 [ 0, %_ZNSt6vectorIS_ISt4pairIjP6aiNodeESaIS3_EESaIS5_EE6resizeEm.exit ], [ %i.cq, %._crit_edge275.loopexit ]
  %.sroa.0143.0.lcssa = phi ptr [ null, %_ZNSt6vectorIS_ISt4pairIjP6aiNodeESaIS3_EESaIS5_EE6resizeEm.exit ], [ %.sroa.0143.2, %._crit_edge275.loopexit ] ; 2 uses
  %i.cr = ptrtoint ptr %.sroa.26.0.lcssa.a to i64 ; 2 uses
...
bb.n:                                             ; preds = %.lr.ph274, %_ZNSt6vectorISt4pairIP6aiMeshPK6aiBoneESaIS6_EED2Ev.exit
  ...
  %.sroa.0143.0272 = phi ptr [ null, %.lr.ph274 ], [ %.sroa.0143.2, %_ZNSt6vectorISt4pairIP6aiMeshPK6aiBoneESaIS6_EED2Ev.exit ] ; 5 uses
  %.sroa.14.0271 = phi ptr [ null, %.lr.ph274 ], [ %.sroa.14.2, %_ZNSt6vectorISt4pairIP6aiMeshPK6aiBoneESaIS6_EED2Ev.exit ] ; 5 uses
  %.sroa.26.0270 = phi ptr [ null, %.lr.ph274 ], [ %.sroa.26.2.a, %_ZNSt6vectorISt4pairIP6aiMeshPK6aiBoneESaIS6_EED2Ev.exit ] ; 8 uses
...
begin_hunk_7_@_ZN6Assimp13DeboneProcess7ExecuteEP7aiScene:bb.a
  ...
  %.sroa.0143.1262 = phi ptr [ %.sroa.0143.5, %_ZNSt6vectorIP6aiMeshSaIS1_EE12emplace_backIJRS1_EEES5_DpOT_.exit ], [ %.sroa.0143.0272, %.lr.ph265.preheader ] ; 5 uses
  %.sroa.14.1261 = phi ptr [ %.sroa.14.3, %_ZNSt6vectorIP6aiMeshSaIS1_EE12emplace_backIJRS1_EEES5_DpOT_.exit ], [ %.sroa.14.0271, %.lr.ph265.preheader ] ; 4 uses
  %.sroa.26.1260 = phi ptr [ %.sroa.26.5.a, %_ZNSt6vectorIP6aiMeshSaIS1_EE12emplace_backIJRS1_EEES5_DpOT_.exit ], [ %.sroa.26.0270, %.lr.ph265.preheader ] ; 8 uses
...
_ZN6aiNode8FindNodeERK8aiString.exit:             ; preds = %.lr.ph265, %bb.q
  ...
  %i.dw = ptrtoint ptr %.sroa.26.1260 to i64
...
_ZNSt6vectorISt4pairIjP6aiNodeESaIS3_EE12emplace_backIJRS3_EEES7_DpOT_.exit: ; preds = %_ZNSt6vectorISt4pairIjP6aiNodeESaIS3_EE17_M_realloc_insertIJRS3_EEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i, %bb.r
  %.not.i93 = icmp eq ptr %.sroa.14.1261, %.sroa.0143.1262
...
bb.w:                                             ; preds = %_ZNSt6vectorISt4pairIjP6aiNodeESaIS3_EE12emplace_backIJRS3_EEES7_DpOT_.exit
  ...
  br i1 %i.fa, label %bb.t, label %_ZNKSt6vectorIP6aiMeshSaIS1_EE12_M_check_lenEmPKc.exit.i.i
...
bb.x:                                             ; preds = %.noexc97
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.fg, ptr align 8 %.sroa.26.1260, i64 %i.dx, i1 false)
...
_ZNSt6vectorIP6aiMeshSaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i: ; preds = %bb.x, %.noexc97
  %.not.i17.i.i = icmp eq ptr %.sroa.26.1260, null
...
bb.y:                                             ; preds = %_ZNSt6vectorIP6aiMeshSaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.26.1260, i64 noundef %i.dx) #22
...
_ZNSt6vectorIP6aiMeshSaIS1_EE12emplace_backIJRS1_EEES5_DpOT_.exit: ; preds = %_ZNSt6vectorIP6aiMeshSaIS1_EE17_M_realloc_insertIJRS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i, %bb.v
  %.sroa.26.5.a = phi ptr [ %i.fg, %_ZNSt6vectorIP6aiMeshSaIS1_EE17_M_realloc_insertIJRS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i ], [ %.sroa.26.1260, %bb.v ] ; 4 uses
  ...
  %.sroa.0143.5 = phi ptr [ %i.fk, %_ZNSt6vectorIP6aiMeshSaIS1_EE17_M_realloc_insertIJRS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i ], [ %.sroa.0143.1262, %bb.v ] ; 4 uses
...
.thread355:                                       ; preds = %bb.ae, %bb.af, %bb.z, %.loopexit.split-lp, %.loopexit
  ...
  %.sroa.26.1213 = phi ptr [ %.sroa.26.5.a, %bb.ae ], [ %.sroa.26.5.a, %bb.af ], [ %.sroa.26.1260, %bb.z ], [ %.sroa.26.1260, %.loopexit ], [ %.sroa.26.1260, %.loopexit.split-lp ]
...
begin_hunk_16_@_ZN6Assimp13DeboneProcess7ExecuteEP7aiScene:bb.a
  ...
  %i.gm = ptrtoint ptr %.sroa.26.0270 to i64
...
_ZNSt6vectorISt4pairIjP6aiNodeESaIS3_EE12emplace_backIJjS2_EEERS3_DpOT_.exit: ; preds = %_ZNSt6vectorISt4pairIjP6aiNodeESaIS3_EE17_M_realloc_insertIJjS2_EEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i, %bb.aj
  %.not.i110 = icmp eq ptr %.sroa.14.0271, %.sroa.0143.0272
...
bb.aq:                                            ; preds = %.noexc117
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.hw, ptr align 8 %.sroa.26.0270, i64 %i.gn, i1 false)
...
_ZNSt6vectorIP6aiMeshSaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i114: ; preds = %bb.aq, %.noexc117
  ...
  %.not.i17.i.i115 = icmp eq ptr %.sroa.26.0270, null
...
bb.ar:                                            ; preds = %_ZNSt6vectorIP6aiMeshSaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i114
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.26.0270, i64 noundef %i.gn) #22
...
_ZNSt6vectorIP6aiMeshSaIS1_EE9push_backERKS1_.exit: ; preds = %_ZNSt6vectorIP6aiMeshSaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i, %bb.an, %bb.ai
  %.sroa.26.2.a = phi ptr [ %.sroa.26.5.a, %bb.ai ], [ %i.hw, %_ZNSt6vectorIP6aiMeshSaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i ], [ %.sroa.26.0270, %bb.an ] ; 2 uses
  ...
  %.sroa.0143.2 = phi ptr [ %.sroa.0143.5, %bb.ai ], [ %i.ia, %_ZNSt6vectorIP6aiMeshSaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i ], [ %.sroa.0143.0272, %bb.an ] ; 2 uses
...
bb.au:                                            ; preds = %.thread355, %bb.at
  ...
  %.sroa.26.3360 = phi ptr [ %.sroa.26.1213, %.thread355 ], [ %.sroa.26.0270, %bb.at ]
...
_ZNSt6vectorISt4pairIP6aiMeshPK6aiBoneESaIS6_EED2Ev.exit120: ; preds = %bb.at, %bb.au
  ...
  %.sroa.26.3361 = phi ptr [ %.sroa.26.0270, %bb.at ], [ %.sroa.26.3360, %bb.au ]
...
bb.ay:                                            ; preds = %bb.ax
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.is, ptr align 8 %.sroa.26.0.lcssa.a, i64 %i.cs, i1 false)
...
bb.ba:                                            ; preds = %bb.az
  %i.iv = load ptr, ptr %.sroa.26.0.lcssa.a, align 8
...
bb.bb:                                            ; preds = %_ZSt4copyIN9__gnu_cxx17__normal_iteratorIPP6aiMeshSt6vectorIS3_SaIS3_EEEES4_ET0_T_SA_S9_.exit
  %.not.i.i.i121 = icmp eq ptr %.sroa.26.0.lcssa.a, null
  br i1 %.not.i.i.i121, label %.critedge, label %bb.bc

bb.bc:                                            ; preds = %bb.bb
  %i.iy = ptrtoint ptr %.sroa.0143.0.lcssa to i64
  %i.iz = sub i64 %i.iy, %i.cr
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.26.0.lcssa.a, i64 noundef %i.iz) #22
  br label %.critedge
...
bb.be:                                            ; preds = %bb.bd, %_ZNSt6vectorISt4pairIP6aiMeshPK6aiBoneESaIS6_EED2Ev.exit120
  %.sroa.26.4.a = phi ptr [ %.sroa.26.3361, %_ZNSt6vectorISt4pairIP6aiMeshPK6aiBoneESaIS6_EED2Ev.exit120 ], [ %.sroa.26.0.lcssa.a, %bb.bd ] ; 3 uses
  %.sroa.0143.4 = phi ptr [ %.sroa.0143.3363, %_ZNSt6vectorISt4pairIP6aiMeshPK6aiBoneESaIS6_EED2Ev.exit120 ], [ %.sroa.0143.0.lcssa, %bb.bd ]
  %.pn68.pn = phi { ptr, i32 } [ %.pn68365, %_ZNSt6vectorISt4pairIP6aiMeshPK6aiBoneESaIS6_EED2Ev.exit120 ], [ %i.ja, %bb.bd ] ; 2 uses
  %.not.i.i.i122 = icmp eq ptr %.sroa.26.4.a, null
  br i1 %.not.i.i.i122, label %_ZNSt13_Bvector_baseISaIbEED2Ev.exit126, label %bb.bf

bb.bf:                                            ; preds = %bb.be
  %i.jb = ptrtoint ptr %.sroa.0143.4 to i64
  %i.jc = ptrtoint ptr %.sroa.26.4.a to i64
  %i.jd = sub i64 %i.jb, %i.jc
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.26.4.a, i64 noundef %i.jd) #22
...
.lr.ph:                                           ; preds = %_ZNSt10_HashtableIPK6aiBoneS2_SaIS2_ENSt8__detail9_IdentityESt8equal_toIS2_ESt4hashIS2_ENS4_18_Mod_range_hashingENS4_20_Default_ranged_hashENS4_20_Prime_rehash_policyENS4_17_Hashtable_traitsILb0ELb1ELb1EEEE19_M_allocate_bucketsEm.exit, %bb.h
  %.031 = phi i64 [ %.1, %bb.h ], [ 0, %_ZNSt10_HashtableIPK6aiBoneS2_SaIS2_ENSt8__detail9_IdentityESt8equal_toIS2_ESt4hashIS2_ENS4_18_Mod_range_hashingENS4_20_Default_ranged_hashENS4_20_Prime_rehash_policyENS4_17_Hashtable_traitsILb0ELb1ELb1EEEE19_M_allocate_bucketsEm.exit ] ; 2 uses
  %.02530 = phi ptr [ %i.i, %bb.h ], [ %i.h, %_ZNSt10_HashtableIPK6aiBoneS2_SaIS2_ENSt8__detail9_IdentityESt8equal_toIS2_ESt4hashIS2_ENS4_18_Mod_range_hashingENS4_20_Default_ranged_hashENS4_20_Prime_rehash_policyENS4_17_Hashtable_traitsILb0ELb1ELb1EEEE19_M_allocate_bucketsEm.exit ] ; 8 uses
