...
._crit_edge:                                      ; preds = %bb.e, %.preheader
  %.lcssa25 = phi ptr [ %i.d, %.preheader ], [ %i.z, %bb.e ] ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.ai = tail call noalias noundef nonnull dereferenceable(16) ptr @_Znwm(i64 noundef 16) #11 ; 5 uses
  invoke void @_ZN10aiMaterialC1Ev(ptr noundef nonnull align 8 dereferenceable(16) %i.ai)
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %bb.g
  ...
  store float 6.000000e-01, ptr %i.aq, align 8
  %i.ar = call noundef i32 @_ZN10aiMaterial17AddBinaryPropertyEPKvjPKcjj18aiPropertyTypeInfo(ptr noundef nonnull align 8 dereferenceable(16) %i.ai, ptr noundef nonnull %2, i32 noundef 12, ptr noundef nonnull @.str, i32 noundef 0, i32 noundef 0, i32 noundef 1) ; 0 uses
  store i32 15, ptr %1, align 4
  %i.as = getelementptr inbounds nuw i8, ptr %1, i64 4
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(15) %i.as, ptr noundef nonnull align 1 dereferenceable(15) @.str.1, i64 15, i1 false)
  %i.at = getelementptr inbounds nuw i8, ptr %1, i64 19
  store i8 0, ptr %i.at, align 1
  %i.au = call noundef i32 @_ZN10aiMaterial11AddPropertyEPK8aiStringPKcjj(ptr noundef nonnull align 8 dereferenceable(16) %i.ai, ptr noundef nonnull %1, ptr noundef nonnull @.str.2, i32 noundef 0, i32 noundef 0) ; 0 uses
  %i.av = call noundef ptr @_ZN6Assimp13DefaultLogger3getEv()
  call void @_ZN6Assimp6Logger5debugEPKc(ptr noundef nonnull align 8 dereferenceable(12) %i.av, ptr noundef nonnull @.str.3)
  %i.aw = load ptr, ptr %0, align 8               ; 3 uses
...
._crit_edge31:                                    ; preds = %bb.j, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  %.lcssa = phi ptr [ %i.aw, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit ], [ %i.bm, %bb.j ]
  %i.az = getelementptr inbounds nuw i8, ptr %.lcssa, i64 32 ; 2 uses
...
bb.h:                                             ; preds = %bb.g
  %i.bc = landingpad { ptr, i32 }
          cleanup
  tail call void @_ZdlPvm(ptr noundef nonnull %i.ai, i64 noundef 16) #13
  call void @llvm.lifetime.end.p0(ptr nonnull %1) #12
  resume { ptr, i32 } %i.bc

.lr.ph30:                                         ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit, %bb.j
  %i.bd = phi ptr [ %i.bm, %bb.j ], [ %i.aw, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit ] ; 3 uses
  ...
  %i.bg = getelementptr inbounds nuw [8 x i8], ptr %i.bf, i64 %indvars.iv42
...
bb.i:                                             ; preds = %.lr.ph30
  ...
  %i.bl = getelementptr inbounds nuw i8, ptr %i.bh, i64 232
  store i32 %i.bk, ptr %i.bl, align 8
  %.pre46 = load ptr, ptr %0, align 8
  br label %bb.j

bb.j:                                             ; preds = %.lr.ph30, %bb.i
  %i.bm = phi ptr [ %i.bd, %.lr.ph30 ], [ %.pre46, %bb.i ] ; 3 uses
  %indvars.iv.next43 = add nuw nsw i64 %indvars.iv42, 1 ; 2 uses
  %i.bn = getelementptr inbounds nuw i8, ptr %i.bm, i64 16
  %i.bo = load i32, ptr %i.bn, align 8
  %i.bp = zext i32 %i.bo to i64
  %i.bq = icmp samesign ult i64 %indvars.iv.next43, %i.bp
  br i1 %i.bq, label %.lr.ph30, label %._crit_edge31, !llvm.loop !6
...
; Function Attrs: mustprogress uwtable
define void @_ZN6Assimp17ScenePreprocessor11ProcessMeshEP6aiMesh(ptr nonnull readnone align 8 captures(none) %0, ptr noundef captures(none) %1) local_unnamed_addr #2 align 2 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %1, i64 112
  %i.b = getelementptr inbounds nuw i8, ptr %1, i64 176
  %i.c = getelementptr inbounds nuw i8, ptr %1, i64 4 ; 5 uses
  br label %bb.c
...
bb.k:                                             ; preds = %bb.j
  %i.bn = getelementptr inbounds nuw i8, ptr %1, i64 40 ; 3 uses
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.bs = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %i.br) #11 ; 2 uses
  %i.bt = icmp eq i32 %i.bp, 0
  br i1 %i.bt, label %.loopexit75, label %.lr.ph96.preheader
...
.loopexit75:                                      ; preds = %.lr.ph96.preheader, %bb.l
  store ptr %i.bs, ptr %i.bn, align 8
  %2 = load i32, ptr %i.c, align 4
  %.not98 = icmp eq i32 %2, 0
  br i1 %.not98, label %.loopexit, label %.lr.ph96

.lr.ph96:                                         ; preds = %.loopexit75, %.lr.ph96
  %indvars.iv106 = phi i64 [ %indvars.iv.next107, %.lr.ph96 ], [ 0, %.loopexit75 ] ; 4 uses
...
.loopexit:                                        ; preds = %.lr.ph96, %.loopexit75, %bb.k, %bb.j, %.loopexit76
  ret void
}
...
.preheader.loopexit.unr-lcssa:                    ; preds = %bb.d
  ...
  br i1 %lcmp.mod181.not, label %.preheader, label %.epil.preheader179

.epil.preheader179:                               ; preds = %.preheader.loopexit.unr-lcssa, %.lr.ph124
  %indvars.iv144.epil.init = phi i64 [ 0, %.lr.ph124 ], [ %indvars.iv.next145.1, %.preheader.loopexit.unr-lcssa ]
  %.2122.epil.init = phi double [ %.1.lcssa, %.lr.ph124 ], [ %.sroa.speculated104.1, %.preheader.loopexit.unr-lcssa ] ; 2 uses
  %.2112121.epil.init = phi double [ %.1111.lcssa, %.lr.ph124 ], [ %.sroa.speculated91.1, %.preheader.loopexit.unr-lcssa ] ; 2 uses
  %lcmp.mod184 = trunc i32 %i.y to i1
  call void @llvm.assume(i1 %lcmp.mod184)
  %i.al = getelementptr inbounds nuw [24 x i8], ptr %i.aa, i64 %indvars.iv144.epil.init
  %i.am = load double, ptr %i.al, align 8         ; 4 uses
  %i.an = fcmp olt double %i.am, %.2122.epil.init
  %.sroa.speculated104.epil = select i1 %i.an, double %i.am, double %.2122.epil.init
  %i.ao = fcmp olt double %.2112121.epil.init, %i.am
  %.sroa.speculated91.epil = select i1 %i.ao, double %i.am, double %.2112121.epil.init
  br label %.preheader

.preheader:                                       ; preds = %.epil.preheader179, %.preheader.loopexit.unr-lcssa, %.preheader115
  %.2112.lcssa = phi double [ %.1111.lcssa, %.preheader115 ], [ %.sroa.speculated91.1, %.preheader.loopexit.unr-lcssa ], [ %.sroa.speculated91.epil, %.epil.preheader179 ] ; 3 uses
  %.2.lcssa = phi double [ %.1.lcssa, %.preheader115 ], [ %.sroa.speculated104.1, %.preheader.loopexit.unr-lcssa ], [ %.sroa.speculated104.epil, %.epil.preheader179 ] ; 3 uses
  %i.ap = getelementptr inbounds nuw i8, ptr %i.l, i64 1040
  %i.aq = load i32, ptr %i.ap, align 8            ; 4 uses
  %.not142 = icmp eq i32 %i.aq, 0
  br i1 %.not142, label %.loopexit.thread, label %.lr.ph130

.loopexit.thread:                                 ; preds = %.preheader
  %i.ar = getelementptr inbounds nuw i8, ptr %i.l, i64 1040
  br label %bb.h

.lr.ph130:                                        ; preds = %.preheader
  %i.as = getelementptr inbounds nuw i8, ptr %i.l, i64 1048
  %i.at = load ptr, ptr %i.as, align 8            ; 3 uses
  %wide.trip.count152 = zext i32 %i.aq to i64     ; 2 uses
  %xtraiter188 = and i64 %wide.trip.count152, 1
  %i.au = icmp eq i32 %i.aq, 1
  br i1 %i.au, label %.epil.preheader187, label %.lr.ph130.new

.lr.ph130.new:                                    ; preds = %.lr.ph130
  %unroll_iter193 = and i64 %wide.trip.count152, 4294967294
  br label %bb.e

bb.d:                                             ; preds = %bb.d, %.lr.ph124.new
  %indvars.iv144 = phi i64 [ 0, %.lr.ph124.new ], [ %indvars.iv.next145.1, %bb.d ] ; 3 uses
  %.2122 = phi double [ %.1.lcssa, %.lr.ph124.new ], [ %.sroa.speculated104.1, %bb.d ] ; 2 uses
  %.2112121 = phi double [ %.1111.lcssa, %.lr.ph124.new ], [ %.sroa.speculated91.1, %bb.d ] ; 2 uses
  %niter186 = phi i64 [ 0, %.lr.ph124.new ], [ %niter186.next.1, %bb.d ]
  %i.av = getelementptr inbounds nuw [24 x i8], ptr %i.aa, i64 %indvars.iv144
  %i.aw = load double, ptr %i.av, align 8         ; 4 uses
  %i.ax = fcmp olt double %i.aw, %.2122
  %.sroa.speculated104 = select i1 %i.ax, double %i.aw, double %.2122 ; 2 uses
  %i.ay = fcmp olt double %.2112121, %i.aw
  %.sroa.speculated91 = select i1 %i.ay, double %i.aw, double %.2112121 ; 2 uses
  %i.az = getelementptr inbounds nuw [24 x i8], ptr %i.aa, i64 %indvars.iv144
  %i.ba = getelementptr inbounds nuw i8, ptr %i.az, i64 24
  %i.bb = load double, ptr %i.ba, align 8         ; 4 uses
  %i.bc = fcmp olt double %i.bb, %.sroa.speculated104
  %.sroa.speculated104.1 = select i1 %i.bc, double %i.bb, double %.sroa.speculated104 ; 3 uses
  %i.bd = fcmp olt double %.sroa.speculated91, %i.bb
  %.sroa.speculated91.1 = select i1 %i.bd, double %i.bb, double %.sroa.speculated91 ; 3 uses
  ...
  br i1 %niter186.ncmp.1, label %.preheader.loopexit.unr-lcssa, label %bb.d, !llvm.loop !16

bb.e:                                             ; preds = %bb.e, %.lr.ph130.new
  %indvars.iv149 = phi i64 [ 0, %.lr.ph130.new ], [ %indvars.iv.next150.1, %bb.e ] ; 3 uses
  %.3128 = phi double [ %.2.lcssa, %.lr.ph130.new ], [ %.sroa.speculated101.1, %bb.e ] ; 2 uses
  %.3113127 = phi double [ %.2112.lcssa, %.lr.ph130.new ], [ %.sroa.speculated88.1, %bb.e ] ; 2 uses
  %niter194 = phi i64 [ 0, %.lr.ph130.new ], [ %niter194.next.1, %bb.e ]
  %i.be = getelementptr inbounds nuw [32 x i8], ptr %i.at, i64 %indvars.iv149
  %i.bf = load double, ptr %i.be, align 8         ; 4 uses
  %i.bg = fcmp olt double %i.bf, %.3128
  %.sroa.speculated101 = select i1 %i.bg, double %i.bf, double %.3128 ; 2 uses
  %i.bh = fcmp olt double %.3113127, %i.bf
  %.sroa.speculated88 = select i1 %i.bh, double %i.bf, double %.3113127 ; 2 uses
  %i.bi = getelementptr inbounds nuw [32 x i8], ptr %i.at, i64 %indvars.iv149
