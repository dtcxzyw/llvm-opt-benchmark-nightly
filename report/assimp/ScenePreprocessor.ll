...
bb.f:                                             ; preds = %bb.e
  ...
  %4 = extractelement <2 x float> %i.ev, i64 1
  %5 = fadd float %4, %.sroa.17.0
  %6 = extractelement <2 x float> %i.ev, i64 0
  %7 = fadd float %.sroa.1260.0, %6
  ...
  %8 = insertelement <4 x float> %i.fz, float %5, i64 2
  %9 = insertelement <4 x float> %8, float %7, i64 3 ; 2 uses
  %i.ga = fdiv <4 x float> %9, %i.fw
  %i.gb = fmul <4 x float> %9, %i.fw
