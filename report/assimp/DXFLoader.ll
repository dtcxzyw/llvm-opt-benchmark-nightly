...
bb.y:                                             ; preds = %._crit_edge149, %bb.u, %bb.v, %bb.w, %bb.x
  ...
  %5 = load float, ptr %.sroa.0121.0139, align 8  ; 3 uses
  %6 = load float, ptr %i.aw, align 4             ; 2 uses
  %i.ct = load float, ptr %i.ax, align 8          ; 2 uses
  %7 = fmul float %6, 0.000000e+00                ; 2 uses
  %8 = fadd float %5, %7
  %i.cu = tail call float @llvm.fmuladd.f32(float %5, float 0.000000e+00, float %6)
  %9 = tail call float @llvm.fmuladd.f32(float %i.cs, float 0.000000e+00, float 0.000000e+00) ; 5 uses
  %10 = tail call float @llvm.fmuladd.f32(float %i.cs, float 0.000000e+00, float 1.000000e+00) ; 4 uses
  %11 = tail call float @llvm.fmuladd.f32(float %5, float 0.000000e+00, float %7)
  %12 = fadd float %i.ct, %11
  %13 = fsub float %12, %i.ca                     ; 4 uses
  %14 = load float, ptr %i.au, align 4            ; 2 uses
  %i.cv = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cr, <2 x float> zeroinitializer, <2 x float> zeroinitializer) ; 4 uses
  %i.cw = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cr, <2 x float> zeroinitializer, <2 x float> <float 1.000000e+00, float 0.000000e+00>) ; 3 uses
  %15 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cr, <2 x float> zeroinitializer, <2 x float> <float 0.000000e+00, float 1.000000e+00>) ; 2 uses
  ...
  %i.cz = insertelement <2 x float> poison, float %8, i64 0
  %i.da = insertelement <2 x float> %i.cz, float %i.cu, i64 1
  ...
  %i.dd = fmul <2 x float> %15, zeroinitializer   ; 2 uses
  ...
  %i.dg = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.df, <2 x float> %i.cw, <2 x float> %i.dd)
  %i.dh = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cv, <2 x float> zeroinitializer, <2 x float> %i.dg)
  ...
  %i.dk = fmul <2 x float> %15, %i.dj
  %i.dl = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cw, <2 x float> zeroinitializer, <2 x float> %i.dk)
  %i.dm = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cv, <2 x float> zeroinitializer, <2 x float> %i.dl)
  %i.dn = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cw, <2 x float> zeroinitializer, <2 x float> %i.dd) ; 2 uses
  %i.do = insertelement <2 x float> poison, float %14, i64 0
  %i.dp = shufflevector <2 x float> %i.do, <2 x float> poison, <2 x i32> zeroinitializer
  %i.dq = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.dp, <2 x float> %i.cv, <2 x float> %i.dn)
  %i.dr = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cv, <2 x float> zeroinitializer, <2 x float> %i.dn)
  ...
  %i.dw = fmul float %9, 0.000000e+00             ; 2 uses
  %i.dx = tail call float @llvm.fmuladd.f32(float %.pre148, float %9, float %i.dw)
  %i.dy = tail call float @llvm.fmuladd.f32(float %10, float 0.000000e+00, float %i.dx)
  %i.dz = tail call float @llvm.fmuladd.f32(float %13, float 0.000000e+00, float %i.dy)
  %i.ea = fmul float %9, %i.cq
  %i.eb = tail call float @llvm.fmuladd.f32(float %9, float 0.000000e+00, float %i.ea)
  %i.ec = tail call float @llvm.fmuladd.f32(float %10, float 0.000000e+00, float %i.eb)
  %i.ed = tail call float @llvm.fmuladd.f32(float %13, float 0.000000e+00, float %i.ec)
  %i.ee = tail call float @llvm.fmuladd.f32(float %9, float 0.000000e+00, float %i.dw) ; 2 uses
  %i.ef = tail call float @llvm.fmuladd.f32(float %14, float %10, float %i.ee)
  %16 = insertelement <2 x float> poison, float %13, i64 0
  %17 = insertelement <2 x float> %16, float %10, i64 1
  %18 = insertelement <2 x float> poison, float %i.ef, i64 0
  %19 = insertelement <2 x float> %18, float %i.ee, i64 1
  %20 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %17, <2 x float> zeroinitializer, <2 x float> %19) ; 2 uses
  %21 = extractelement <2 x float> %20, i64 1
  %i.eg = fadd float %21, %13
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  %.sroa.066.0135 = phi ptr [ %i.fj, %.lr.ph ], [ %i.en, %.lr.ph.preheader ] ; 5 uses
  ...
  %i.fh = tail call float @llvm.fmuladd.f32(float %22, float %i.eu, float %i.fg)
