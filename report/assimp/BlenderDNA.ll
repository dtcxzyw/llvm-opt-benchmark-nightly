...
bb.a:
  %4 = alloca %"class.std::shared_ptr.45", align 16 ; 4 uses
...
_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i: ; preds = %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.thread.i.i.i.i.i.i, %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i.i
  ...
  %.19.i.i.i = select i1 %i.n, ptr %.0811.i.i.i, ptr %.012.i.i.i ; 8 uses
...
bb.d:                                             ; preds = %_ZNKSt3mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIMN6Assimp7Blender9StructureEKFSt10shared_ptrINS8_8ElemBaseEEvEMS9_KFvSC_RKNS8_12FileDatabaseEEESt4lessIS5_ESaIS6_IKS5_SK_EEE4findERSN_.exit
  ...
  %.unpack = load i64, ptr %i.x, align 8          ; 3 uses
  %.elt7 = getelementptr inbounds nuw i8, ptr %.19.i.i.i, i64 72
  %.unpack8 = load i64, ptr %.elt7, align 8
  %i.y = getelementptr inbounds i8, ptr %2, i64 %.unpack8 ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.ad = load ptr, ptr %i.ac, align 8, !nosanitize !3
  br label %bb.g
...
bb.g:                                             ; preds = %bb.f, %bb.e
  %i.af = phi ptr [ %i.ad, %bb.e ], [ %i.ae, %bb.f ]
  tail call void %i.af(ptr dead_on_unwind writable sret(%"class.std::shared_ptr.45") align 8 %0, ptr noundef nonnull align 8 dereferenceable(120) %i.y)
  %i.ag = getelementptr inbounds nuw i8, ptr %.19.i.i.i, i64 80
  %.unpack9 = load i64, ptr %i.ag, align 8        ; 3 uses
  %.elt10 = getelementptr inbounds nuw i8, ptr %.19.i.i.i, i64 88
  %.unpack11 = load i64, ptr %.elt10, align 8
  %i.ah = getelementptr inbounds i8, ptr %2, i64 %.unpack11 ; 2 uses
  %i.ai = and i64 %.unpack9, 1
  %.not12 = icmp eq i64 %i.ai, 0
  br i1 %.not12, label %bb.i, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.aj = load ptr, ptr %i.ah, align 8
  %i.ak = getelementptr i8, ptr %i.aj, i64 %.unpack9
  %i.al = getelementptr i8, ptr %i.ak, i64 -1
  %i.am = load ptr, ptr %i.al, align 8, !nosanitize !3
  br label %bb.j

bb.i:                                             ; preds = %bb.g
  %i.an = inttoptr i64 %.unpack9 to ptr
  br label %bb.j
...
bb.j:                                             ; preds = %bb.i, %bb.h
  ...
  %i.as = load <2 x ptr>, ptr %0, align 8
  store <2 x ptr> %i.as, ptr %4, align 16
  %.not.i.i.i13 = icmp eq ptr %i.ar, null
  br i1 %.not.i.i.i13, label %_ZNSt10shared_ptrIN6Assimp7Blender8ElemBaseEEC2ERKS3_.exit, label %bb.k
...
_ZNSt10shared_ptrIN6Assimp7Blender8ElemBaseEEC2ERKS3_.exit: ; preds = %bb.j, %bb.l, %bb.m
  invoke void %i.ao(ptr noundef nonnull align 8 dereferenceable(120) %i.ah, ptr noundef nonnull %4, ptr noundef nonnull align 8 dereferenceable(232) %3)
          to label %bb.n unwind label %bb.u

bb.n:                                             ; preds = %_ZNSt10shared_ptrIN6Assimp7Blender8ElemBaseEEC2ERKS3_.exit
  %i.ay = load ptr, ptr %i.ap, align 8            ; 8 uses
  %.not.i.i = icmp eq ptr %i.ay, null
  br i1 %.not.i.i, label %_ZNSt12__shared_ptrIN6Assimp7Blender8ElemBaseELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit, label %bb.o
...
bb.p:                                             ; preds = %bb.o
  ...
  call void %i.bg(ptr noundef nonnull align 8 dereferenceable(16) %i.ay) #20, !inline_history !41
  %i.bh = load ptr, ptr %i.ay, align 8
  %i.bi = getelementptr inbounds nuw i8, ptr %i.bh, i64 24
  %i.bj = load ptr, ptr %i.bi, align 8
  call void %i.bj(ptr noundef nonnull align 8 dereferenceable(16) %i.ay) #20, !inline_history !41
  br label %_ZNSt12__shared_ptrIN6Assimp7Blender8ElemBaseELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit
...
bb.r:                                             ; preds = %bb.q
  ...
  store i32 %i.bl, ptr %i.az, align 4
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i: ; preds = %bb.s, %bb.r
  %.0.i.i.i.i = phi i32 [ %i.bc, %bb.r ], [ %i.bm, %bb.s ]
  %i.bn = icmp eq i32 %.0.i.i.i.i, 1
  br i1 %i.bn, label %bb.t, label %_ZNSt12__shared_ptrIN6Assimp7Blender8ElemBaseELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit, !prof !20
...
bb.u:                                             ; preds = %_ZNSt10shared_ptrIN6Assimp7Blender8ElemBaseEEC2ERKS3_.exit
  %i.bo = landingpad { ptr, i32 }
          cleanup
  call void @_ZNSt12__shared_ptrIN6Assimp7Blender8ElemBaseELN9__gnu_cxx12_Lock_policyE2EED2Ev(ptr noundef nonnull align 8 dereferenceable(16) %4) #20
  call void @_ZNSt12__shared_ptrIN6Assimp7Blender8ElemBaseELN9__gnu_cxx12_Lock_policyE2EED2Ev(ptr noundef nonnull align 8 dereferenceable(16) %0) #20
  resume { ptr, i32 } %i.bo

_ZNSt12__shared_ptrIN6Assimp7Blender8ElemBaseELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit: ; preds = %bb.t, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i, %bb.p, %bb.n, %_ZNKSt3mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIMN6Assimp7Blender9StructureEKFSt10shared_ptrINS8_8ElemBaseEEvEMS9_KFvSC_RKNS8_12FileDatabaseEEESt4lessIS5_ESaIS6_IKS5_SK_EEE4findERSN_.exit.thread
  ret void
}
...
bb.c:                                             ; preds = %bb.b
  ...
  tail call void %i.j(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #20, !inline_history !42
  %i.k = load ptr, ptr %i.b, align 8
  %i.l = getelementptr inbounds nuw i8, ptr %i.k, i64 24
  %i.m = load ptr, ptr %i.l, align 8
  tail call void %i.m(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #20, !inline_history !42
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i: ; preds = %bb.f, %bb.e
  ...
  br i1 %i.q, label %bb.g, label %_ZNSt14__shared_countILN9__gnu_cxx12_Lock_policyE2EED2Ev.exit, !prof !20
