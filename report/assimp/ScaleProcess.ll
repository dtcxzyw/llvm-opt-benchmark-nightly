...
bb.h:                                             ; preds = %.lr.ph169, %bb.h
  ...
  %i.ci = load float, ptr %i.s, align 4, !noalias !14 ; 4 uses
  ...
  %i.cu = load <2 x float>, ptr %i.r, align 4, !noalias !14 ; 8 uses
  %i.cv = shufflevector <2 x float> %i.cu, <2 x float> poison, <3 x i32> <i32 0, i32 poison, i32 poison>
  %5 = shufflevector <2 x float> %i.cu, <2 x float> poison, <3 x i32> <i32 0, i32 poison, i32 poison>
  %i.cw = shufflevector <2 x float> %i.cu, <2 x float> poison, <3 x i32> <i32 poison, i32 1, i32 poison>
  %i.cx = extractelement <2 x float> %i.cu, i64 1 ; 3 uses
  %i.cy = fmul float %i.cx, %i.cj
  %i.cz = shufflevector <3 x float> %i.ct, <3 x float> %i.cw, <3 x i32> <i32 0, i32 1, i32 4> ; 4 uses
  ...
  %6 = shufflevector <2 x float> %i.cu, <2 x float> poison, <3 x i32> <i32 0, i32 1, i32 poison>
  %7 = shufflevector <3 x float> %i.cz, <3 x float> <float poison, float poison, float -2.000000e+00>, <3 x i32> <i32 2, i32 1, i32 5>
  ...
  %i.dp = shufflevector <3 x float> %i.do, <3 x float> %5, <3 x i32> <i32 0, i32 3, i32 poison>
  ...
  %i.dv = shufflevector <3 x float> %6, <3 x float> %i.du, <3 x i32> <i32 0, i32 1, i32 3>
  %i.dw = call <3 x float> @llvm.fmuladd.v3f32(<3 x float> %i.dv, <3 x float> %7, <3 x float> %i.di) ; 2 uses
  %i.dx = fmul <3 x float> %i.dw, <float 2.000000e+00, float 2.000000e+00, float 1.000000e+00> ; 2 uses
  %8 = shufflevector <3 x float> %i.cv, <3 x float> %i.cz, <3 x i32> <i32 0, i32 poison, i32 5>
  %9 = shufflevector <3 x float> %8, <3 x float> %i.du, <3 x i32> <i32 0, i32 4, i32 2>
  %10 = shufflevector <3 x float> %i.cz, <3 x float> <float poison, float -2.000000e+00, float poison>, <3 x i32> <i32 1, i32 4, i32 1>
  ...
  %i.ea = call <3 x float> @llvm.fmuladd.v3f32(<3 x float> %9, <3 x float> %10, <3 x float> %i.dz) ; 3 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.l = load float, ptr %i.f, align 4, !noalias !18 ; 4 uses
  ...
  %i.w = insertelement <3 x float> <float -2.000000e+00, float poison, float poison>, float %i.l, i64 1 ; 2 uses
  %i.x = load <2 x float>, ptr %i.e, align 4, !noalias !18 ; 8 uses
  %i.y = shufflevector <2 x float> %i.x, <2 x float> poison, <3 x i32> <i32 poison, i32 1, i32 poison>
  %5 = shufflevector <2 x float> %i.x, <2 x float> poison, <3 x i32> <i32 0, i32 1, i32 poison>
  %6 = shufflevector <2 x float> %i.x, <2 x float> poison, <3 x i32> <i32 1, i32 0, i32 0> ; 2 uses
  %7 = shufflevector <3 x float> %6, <3 x float> <float poison, float 1.000000e+00, float 1.000000e+00>, <3 x i32> <i32 0, i32 4, i32 5>
  %i.z = extractelement <2 x float> %i.x, i64 1
  %i.aa = fmul float %i.z, %i.m
  %i.ab = shufflevector <3 x float> %i.w, <3 x float> %i.y, <3 x i32> <i32 0, i32 1, i32 4> ; 2 uses
  ...
  %8 = shufflevector <3 x float> %i.ab, <3 x float> <float poison, float poison, float -2.000000e+00>, <3 x i32> <i32 2, i32 1, i32 5>
  ...
  %i.aq = call <3 x float> @llvm.fmuladd.v3f32(<3 x float> %6, <3 x float> %7, <3 x float> %i.ap)
  ...
  %i.av = shufflevector <3 x float> %5, <3 x float> %i.au, <3 x i32> <i32 0, i32 1, i32 3>
  %i.aw = call <3 x float> @llvm.fmuladd.v3f32(<3 x float> %i.av, <3 x float> %8, <3 x float> %i.ak) ; 2 uses
  %i.ax = fmul <3 x float> %i.aw, <float 2.000000e+00, float 2.000000e+00, float 1.000000e+00> ; 2 uses
  %9 = shufflevector <2 x float> %i.x, <2 x float> poison, <3 x i32> <i32 0, i32 poison, i32 1>
  %10 = shufflevector <3 x float> %9, <3 x float> %i.au, <3 x i32> <i32 0, i32 4, i32 2>
  %11 = shufflevector <3 x float> %i.w, <3 x float> <float poison, float -2.000000e+00, float poison>, <3 x i32> <i32 1, i32 4, i32 1>
  ...
  %i.ba = call <3 x float> @llvm.fmuladd.v3f32(<3 x float> %10, <3 x float> %11, <3 x float> %i.az) ; 3 uses
