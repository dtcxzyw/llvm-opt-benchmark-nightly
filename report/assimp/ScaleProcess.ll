...
bb.h:                                             ; preds = %.lr.ph169, %bb.h
  ...
  %6 = load float, ptr %i.a, align 8              ; 3 uses
  %7 = load float, ptr %2, align 8
  %8 = fmul float %6, %7                          ; 4 uses
  %9 = load float, ptr %5, align 4
  %10 = fmul float %6, %9                         ; 4 uses
  %i.ce = load float, ptr %i.n, align 8
  %11 = fmul float %6, %i.ce                      ; 4 uses
  ...
  %12 = extractelement <4 x float> %i.cs, i64 2
  %13 = fmul float %12, 2.000000e+00              ; 2 uses
  ...
  %i.dm = extractelement <4 x float> %i.dl, i64 1
  %i.dn = fmul float %i.dm, 2.000000e+00          ; 4 uses
  %i.do = extractelement <4 x float> %i.dl, i64 2
  %i.dp = fmul float %i.do, 2.000000e+00          ; 4 uses
  %i.dq = extractelement <4 x float> %i.dl, i64 3
  %i.dr = call float @llvm.fmuladd.f32(float %i.dq, float -2.000000e+00, float 1.000000e+00) ; 4 uses
  %14 = fmul float %13, 0.000000e+00              ; 2 uses
  %15 = fadd float %i.cu, %14
  %16 = call float @llvm.fmuladd.f32(float %i.dn, float 0.000000e+00, float %15)
  %17 = call float @llvm.fmuladd.f32(float %8, float 0.000000e+00, float %16)
  %i.ds = extractelement <4 x float> %i.dl, i64 0
  %18 = fmul <2 x float> %i.db, <float 2.000000e+00, float 0.000000e+00> ; 4 uses
  %19 = fadd float %8, 0.000000e+00
  %i.dt = call float @llvm.fmuladd.f32(float %i.cu, float 0.000000e+00, float %13)
  %20 = call float @llvm.fmuladd.f32(float %i.dn, float 0.000000e+00, float %i.dt)
  %i.du = call float @llvm.fmuladd.f32(float %10, float 0.000000e+00, float %20)
  %21 = extractelement <2 x float> %i.db, i64 1
  %22 = fadd float %10, 0.000000e+00
  %i.dv = call float @llvm.fmuladd.f32(float %i.cu, float 0.000000e+00, float %14) ; 2 uses
  %23 = fadd float %i.dn, %i.dv
  %i.dw = call float @llvm.fmuladd.f32(float %11, float 0.000000e+00, float %23)
  %i.dx = fadd float %11, 0.000000e+00
  %i.dy = call float @llvm.fmuladd.f32(float %i.dn, float 0.000000e+00, float %i.dv)
  %i.dz = fadd float %i.dy, 0.000000e+00
  %i.ea = extractelement <2 x float> %18, i64 0
  %i.eb = shufflevector <2 x float> %18, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 2 uses
  ...
  %i.ei = call float @llvm.fmuladd.f32(float %i.dp, float 0.000000e+00, float %i.eh)
  %i.ej = call float @llvm.fmuladd.f32(float %8, float 0.000000e+00, float %i.ei)
  %shift = shufflevector <2 x float> %18, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop215 = fadd <2 x float> %18, %shift
  %i.ek = extractelement <2 x float> %foldExtExtBinop215, i64 0
  %i.el = call float @llvm.fmuladd.f32(float %i.dr, float 0.000000e+00, float %i.ek)
  %i.em = call float @llvm.fmuladd.f32(float %8, float 0.000000e+00, float %i.el)
  %i.en = call float @llvm.fmuladd.f32(float %i.eg, float 0.000000e+00, float %i.ds)
  %i.eo = call float @llvm.fmuladd.f32(float %i.dp, float 0.000000e+00, float %i.en)
  %i.ep = call float @llvm.fmuladd.f32(float %10, float 0.000000e+00, float %i.eo)
  %i.eq = call float @llvm.fmuladd.f32(float %i.ea, float 0.000000e+00, float %21)
  %i.er = call float @llvm.fmuladd.f32(float %i.dr, float 0.000000e+00, float %i.eq)
  %i.es = call float @llvm.fmuladd.f32(float %10, float 0.000000e+00, float %i.er)
  %i.et = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ed, <2 x float> zeroinitializer, <2 x float> %i.ef) ; 2 uses
  %i.eu = insertelement <2 x float> poison, float %i.dp, i64 0
  ...
  %i.ex = insertelement <4 x float> <float poison, float poison, float 0.000000e+00, float 0.000000e+00>, float %i.dp, i64 0
  %i.ey = insertelement <4 x float> %i.ex, float %i.dr, i64 1
  ...
  %i.fc = call float @llvm.fmuladd.f32(float %11, float 0.000000e+00, float %i.fb)
  %i.fd = extractelement <4 x float> %i.fa, i64 1
  %i.fe = call float @llvm.fmuladd.f32(float %11, float 0.000000e+00, float %i.fd)
  ...
  %i.fm = insertelement <4 x float> poison, float %17, i64 0
  ...
  %i.fw = insertelement <4 x float> poison, float %i.du, i64 0
  ...
  %i.gf = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %25, <4 x float> <float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 1.000000e+00>, <4 x float> %i.ge)
  %26 = insertelement <4 x float> poison, float %22, i64 0
  %27 = shufflevector <4 x float> %26, <4 x float> poison, <4 x i32> zeroinitializer
  %i.gg = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %27, <4 x float> <float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 1.000000e+00>, <4 x float> %i.gd)
...
bb.b:                                             ; preds = %bb.a
  ...
  %5 = load float, ptr %i.g, align 8              ; 2 uses
  %i.h = load float, ptr %i.a, align 8
  %6 = fmul float %5, %i.h                        ; 4 uses
  ...
  %7 = extractelement <4 x float> %i.v, i64 2
  %8 = fmul float %7, 2.000000e+00                ; 2 uses
  ...
  %9 = call float @llvm.fmuladd.f32(float %i.x, float 0.000000e+00, float %8)
  %10 = extractelement <2 x float> %i.ae, i64 1
  %i.av = load <2 x float>, ptr %2, align 8
  %11 = shufflevector <4 x float> %i.ao, <4 x float> poison, <4 x i32> <i32 poison, i32 poison, i32 poison, i32 1>
  %i.aw = insertelement <4 x float> %11, float %8, i64 0
  %12 = insertelement <4 x float> %i.aw, float %5, i64 1
  %13 = shufflevector <4 x float> %12, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 3>
  ...
  %i.az = fmul <4 x float> %13, %i.ay             ; 5 uses
  ...
  %14 = call float @llvm.fmuladd.f32(float %i.bg, float 0.000000e+00, float %9)
  %15 = extractelement <4 x float> %i.az, i64 2   ; 3 uses
  %i.bk = call float @llvm.fmuladd.f32(float %15, float 0.000000e+00, float %14)
  %i.bl = extractelement <4 x float> %i.be, i64 3
  %i.bm = call float @llvm.fmuladd.f32(float %6, float 0.000000e+00, float %i.bl)
  %i.bn = call float @llvm.fmuladd.f32(float %i.bg, float 0.000000e+00, float %i.bb)
  ...
  %i.bw = insertelement <4 x float> %i.bv, float %6, i64 0
  ...
  %i.cj = call float @llvm.fmuladd.f32(float %15, float 0.000000e+00, float %i.ci)
  %i.ck = call float @llvm.fmuladd.f32(float %i.bo, float 0.000000e+00, float %10)
  %i.cl = call float @llvm.fmuladd.f32(float %i.as, float 0.000000e+00, float %i.ck)
  %i.cm = call float @llvm.fmuladd.f32(float %15, float 0.000000e+00, float %i.cl)
  ...
  %i.cw = call float @llvm.fmuladd.f32(float %6, float 0.000000e+00, float %i.cv)
  %i.cx = extractelement <4 x float> %i.cu, i64 1
  %i.cy = call float @llvm.fmuladd.f32(float %6, float 0.000000e+00, float %i.cx)
  ...
  %i.ds = insertelement <4 x float> poison, float %i.bk, i64 0
  ...
  %i.ei = insertelement <4 x float> poison, float %i.bm, i64 0
