...
bb.a:
  ...
  %4 = alloca %class.aiQuaterniont, align 16      ; 8 uses
...
bb.h:                                             ; preds = %.lr.ph169, %bb.h
  ...
  %i.ci = load float, ptr %5, align 4
  %i.cj = fmul float %i.cf, %i.ci                 ; 4 uses
  %i.ck = load float, ptr %i.n, align 8
  ...
  %i.cq = load float, ptr %i.s, align 4, !noalias !8 ; 5 uses
  %6 = fmul float %i.cq, %i.cq                    ; 2 uses
  ...
  %i.cv = load <2 x float>, ptr %i.q, align 4, !noalias !8 ; 3 uses
  %7 = load float, ptr %i.r, align 8, !noalias !8 ; 4 uses
  %8 = call float @llvm.fmuladd.f32(float %7, float %7, float %6)
  %9 = extractelement <2 x float> %i.cv, i64 0    ; 4 uses
  %10 = call float @llvm.fmuladd.f32(float %9, float %7, float %i.ct)
  %11 = call float @llvm.fmuladd.f32(float %9, float %7, float %i.cu)
  %12 = fmul float %11, 2.000000e+00              ; 2 uses
  %i.cw = call float @llvm.fmuladd.f32(float %9, float %9, float %6)
  %13 = shufflevector <2 x float> %i.cv, <2 x float> poison, <4 x i32> <i32 poison, i32 0, i32 1, i32 0>
  %14 = insertelement <4 x float> %13, float 1.000000e+00, i64 0
  %15 = shufflevector <4 x float> %i.cp, <4 x float> <float 1.000000e+00, float poison, float poison, float poison>, <4 x i32> <i32 4, i32 poison, i32 poison, i32 0>
  %16 = insertelement <4 x float> poison, float %i.cs, i64 0
  %17 = shufflevector <4 x float> %16, <4 x float> poison, <4 x i32> <i32 poison, i32 0, i32 0, i32 poison>
  %18 = shufflevector <4 x float> %15, <4 x float> %17, <4 x i32> <i32 0, i32 5, i32 6, i32 3>
  %19 = fmul <4 x float> %14, %18
  %20 = shufflevector <2 x float> %i.cv, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.cx = insertelement <4 x float> poison, float %i.cw, i64 0
  %21 = shufflevector <4 x float> %20, <4 x float> %i.cx, <4 x i32> <i32 4, i32 1, i32 0, i32 1>
  %22 = insertelement <4 x float> <float -2.000000e+00, float poison, float poison, float poison>, float %i.cq, i64 1
  %23 = shufflevector <4 x float> %22, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 1>
  %i.cy = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %21, <4 x float> %23, <4 x float> %19) ; 4 uses
  ...
  %i.dp = call float @llvm.fmuladd.f32(float %8, float -2.000000e+00, float 1.000000e+00) ; 3 uses
  %i.dq = fmul float %10, 2.000000e+00            ; 3 uses
  %i.dr = fmul float %i.db, 2.000000e+00          ; 4 uses
  %i.ds = fmul float %i.dc, 2.000000e+00          ; 4 uses
  %i.dt = fmul float %12, 0.000000e+00            ; 2 uses
  ...
  %i.eb = call float @llvm.fmuladd.f32(float %i.dp, float 0.000000e+00, float %12)
  ...
  %.sroa.4124.0.copyload = load float, ptr %i.o, align 4 ; 3 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.v = load float, ptr %i.f, align 4, !noalias !16 ; 5 uses
  %6 = fmul float %i.v, %i.v                      ; 2 uses
  %i.w = extractelement <4 x float> %i.u, i64 0   ; 2 uses
  %i.x = fneg float %i.w                          ; 2 uses
  %i.y = fmul float %i.v, %i.x
  %i.z = fmul float %i.v, %i.w
  %i.aa = load <2 x float>, ptr %5, align 4, !noalias !16 ; 3 uses
  %7 = load float, ptr %i.e, align 8, !noalias !16 ; 4 uses
  %8 = call float @llvm.fmuladd.f32(float %7, float %7, float %6)
  %9 = extractelement <2 x float> %i.aa, i64 0    ; 4 uses
  %10 = call float @llvm.fmuladd.f32(float %9, float %7, float %i.y)
  %11 = call float @llvm.fmuladd.f32(float %9, float %7, float %i.z)
  %12 = fmul float %11, 2.000000e+00              ; 2 uses
  %i.ab = call float @llvm.fmuladd.f32(float %9, float %9, float %6)
  %13 = shufflevector <2 x float> %i.aa, <2 x float> poison, <4 x i32> <i32 poison, i32 0, i32 1, i32 0>
  %14 = insertelement <4 x float> %13, float 1.000000e+00, i64 0
  %15 = shufflevector <4 x float> %i.u, <4 x float> <float 1.000000e+00, float poison, float poison, float poison>, <4 x i32> <i32 4, i32 poison, i32 poison, i32 0>
  %16 = insertelement <4 x float> poison, float %i.x, i64 0
  %17 = shufflevector <4 x float> %16, <4 x float> poison, <4 x i32> <i32 poison, i32 0, i32 0, i32 poison>
  %18 = shufflevector <4 x float> %15, <4 x float> %17, <4 x i32> <i32 0, i32 5, i32 6, i32 3>
  %19 = fmul <4 x float> %14, %18
  %20 = shufflevector <2 x float> %i.aa, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.ac = insertelement <4 x float> poison, float %i.ab, i64 0
  %21 = shufflevector <4 x float> %20, <4 x float> %i.ac, <4 x i32> <i32 4, i32 1, i32 0, i32 1>
  %22 = insertelement <4 x float> <float -2.000000e+00, float poison, float poison, float poison>, float %i.v, i64 1
  %23 = shufflevector <4 x float> %22, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 1>
  %i.ad = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %21, <4 x float> %23, <4 x float> %19) ; 4 uses
  ...
  %i.au = call float @llvm.fmuladd.f32(float %8, float -2.000000e+00, float 1.000000e+00) ; 3 uses
  %i.av = fmul float %10, 2.000000e+00            ; 3 uses
  %i.aw = fmul float %i.ag, 2.000000e+00          ; 4 uses
  %i.ax = fmul float %i.ah, 2.000000e+00          ; 4 uses
  %i.ay = fmul float %12, 0.000000e+00            ; 2 uses
  ...
  %i.bg = call float @llvm.fmuladd.f32(float %i.au, float 0.000000e+00, float %12)
