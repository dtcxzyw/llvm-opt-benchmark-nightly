...
.lr.ph89:                                         ; preds = %._crit_edge, %.lr.ph89
  %.06081 = phi i64 [ %i.cn, %.lr.ph89 ], [ 0, %._crit_edge ] ; 2 uses
  ...
  %i.cn = add nuw i64 %.06081, 1                  ; 2 uses
  %exitcond107.not = icmp eq i64 %i.cn, %i.h
...
begin_hunk_4_@_ZNK6Assimp21BlenderTessellatorP2T13FindLLSQPlaneERKSt6vectorINS_7Blender8PointP2TESaIS3_EE:bb.a
  ...
  %i.ct = shufflevector <4 x float> %4, <4 x float> poison, <4 x i32> <i32 3, i32 poison, i32 3, i32 poison>
  ...
  %i.da = shufflevector <4 x float> %4, <4 x float> poison, <4 x i32> <i32 1, i32 2, i32 1, i32 2>
  %i.db = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %4, <4 x float> %i.da, <4 x float> %i.cz)
  ...
  %i.dh = shufflevector <2 x float> %5, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %i.di = shufflevector <4 x float> %i.dh, <4 x float> %4, <4 x i32> <i32 0, i32 0, i32 4, i32 6>
  ...
  %i.dn = shufflevector <4 x float> %4, <4 x float> poison, <4 x i32> <i32 1, i32 3, i32 3, i32 poison>
  %i.do = shufflevector <2 x float> %5, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 2 uses
  %i.dp = shufflevector <4 x float> %i.dn, <4 x float> %i.do, <4 x i32> <i32 0, i32 1, i32 2, i32 5>
  %i.dq = shufflevector <4 x float> %i.do, <4 x float> %4, <4 x i32> <i32 1, i32 1, i32 6, i32 7>
