...
.lr.ph89:                                         ; preds = %.lr.ph89, %.lr.ph89.preheader.new
  ...
  %niter143 = phi i64 [ 0, %.lr.ph89.preheader.new ], [ %niter143.next.1, %.lr.ph89 ]
  ...
  br i1 %niter143.ncmp.1, label %._crit_edge90.loopexit.unr-lcssa, label %.lr.ph89, !llvm.loop !17
...
begin_hunk_4_@_ZNK6Assimp21BlenderTessellatorP2T13FindLLSQPlaneERKSt6vectorINS_7Blender8PointP2TESaIS3_EE:bb.a
  ...
  %i.cs = shufflevector <4 x float> %17, <4 x float> poison, <4 x i32> <i32 3, i32 poison, i32 3, i32 poison>
  ...
  %i.cz = shufflevector <4 x float> %17, <4 x float> poison, <4 x i32> <i32 1, i32 2, i32 1, i32 2>
  %i.da = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %17, <4 x float> %i.cz, <4 x float> %i.cy)
  ...
  %i.dg = shufflevector <2 x float> %18, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %i.dh = shufflevector <4 x float> %i.dg, <4 x float> %17, <4 x i32> <i32 0, i32 0, i32 4, i32 6>
  ...
  %i.dm = shufflevector <4 x float> %17, <4 x float> poison, <4 x i32> <i32 1, i32 3, i32 3, i32 poison>
  %i.dn = shufflevector <2 x float> %18, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 2 uses
  %i.do = shufflevector <4 x float> %i.dm, <4 x float> %i.dn, <4 x i32> <i32 0, i32 1, i32 2, i32 5>
  %i.dp = shufflevector <4 x float> %i.dn, <4 x float> %17, <4 x i32> <i32 1, i32 1, i32 6, i32 7>
