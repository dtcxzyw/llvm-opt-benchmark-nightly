...
begin_hunk_0_@_ZNSt12__shared_ptrIN6Assimp7Blender8ElemBaseELN9__gnu_cxx12_Lock_policyE2EE5resetIS2_PFvPS2_EEENSt9enable_ifIXsr21__sp_is_constructibleIS2_T_EE5valueEvE4typeEPSB_T0_:bb.a
  ...
  tail call void %i.u(ptr noundef nonnull align 8 dereferenceable(16) %i.m) #23, !inline_history !14
  %i.v = load ptr, ptr %i.m, align 8
  %i.w = getelementptr inbounds nuw i8, ptr %i.v, i64 24
  %i.x = load ptr, ptr %i.w, align 8
  tail call void %i.x(ptr noundef nonnull align 8 dereferenceable(16) %i.m) #23, !inline_history !14
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i: ; preds = %bb.l, %bb.k
  ...
  br i1 %i.ab, label %bb.m, label %_ZNSt12__shared_ptrIN6Assimp7Blender8ElemBaseELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit, !prof !15
...
_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.thread9.us: ; preds = %bb.b, %.lr.ph.split.us
  ...
  br i1 %.not.us, label %_ZNSt10shared_ptrIN6Assimp7Blender15CustomDataLayerEEC2ERKS3_.exit, label %.lr.ph.split.us, !llvm.loop !16
...
_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.thread9: ; preds = %bb.c, %.lr.ph.split, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit
  ...
  br i1 %.not, label %_ZNSt10shared_ptrIN6Assimp7Blender15CustomDataLayerEEC2ERKS3_.exit, label %.lr.ph.split, !llvm.loop !16
...
bb.a:
  ...
  %i.d = load ptr, ptr %i.c, align 8, !noalias !17 ; 3 uses
...
.lr.ph.i:                                         ; preds = %bb.a
  ...
  %i.f = load i64, ptr %i.e, align 8, !noalias !17
  %.fr18.i = freeze i64 %i.f                      ; 3 uses
  %i.g = icmp eq i64 %.fr18.i, 0
  %i.h = load ptr, ptr %2, align 8, !noalias !17
...
.lr.ph.split.us.i:                                ; preds = %.lr.ph.i, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.thread9.us.i
  ...
  %i.i = load ptr, ptr %.sroa.04.013.us.i, align 8, !noalias !17 ; 3 uses
  %i.j = getelementptr inbounds nuw i8, ptr %i.i, i64 16
  %i.k = load i32, ptr %i.j, align 8, !noalias !17
...
bb.b:                                             ; preds = %.lr.ph.split.us.i
  ...
  %char0.i = load i8, ptr %i.m, align 1, !noalias !17
...
_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.thread9.us.i: ; preds = %bb.b, %.lr.ph.split.us.i
  ...
  br i1 %.not.us.i, label %_ZNSt12__shared_ptrIN6Assimp7Blender15CustomDataLayerELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit, label %.lr.ph.split.us.i, !llvm.loop !16
...
.lr.ph.split.i:                                   ; preds = %.lr.ph.i, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.thread9.i
  ...
  %i.p = load ptr, ptr %.sroa.04.013.i, align 8, !noalias !17 ; 3 uses
  %i.q = getelementptr inbounds nuw i8, ptr %i.p, i64 16
  %i.r = load i32, ptr %i.q, align 8, !noalias !17
...
bb.c:                                             ; preds = %.lr.ph.split.i
  ...
  %i.u = tail call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %i.t) #23, !noalias !17
...
_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.i: ; preds = %bb.c
  %bcmp.i.i = tail call i32 @bcmp(ptr %i.h, ptr nonnull %i.t, i64 %.fr18.i), !noalias !17
...
begin_hunk_5_@_ZN6Assimp7Blender22getCustomDataLayerDataERKNS0_10CustomDataENS0_14CustomDataTypeERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE:bb.a
  ...
  %i.y = load ptr, ptr %i.x, align 8, !noalias !17 ; 9 uses
...
bb.d:                                             ; preds = %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.thread.i
  ...
  %i.aa = load i8, ptr @__libc_single_threaded, align 1, !noalias !17
  %.not.i.i.i.i.i = icmp eq i8 %i.aa, 0
  br i1 %.not.i.i.i.i.i, label %bb.f, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.ab = load i32, ptr %i.z, align 4, !noalias !17
  %i.ac = add nsw i32 %i.ab, 1
  store i32 %i.ac, ptr %i.z, align 4, !noalias !17
  br label %bb.g

bb.f:                                             ; preds = %bb.d
  %i.ad = atomicrmw volatile add ptr %i.z, i32 1 acq_rel, align 4, !noalias !17 ; 0 uses
  br label %bb.g
...
_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.thread9.i: ; preds = %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.i, %bb.c, %.lr.ph.split.i
  ...
  br i1 %.not.i, label %_ZNSt12__shared_ptrIN6Assimp7Blender15CustomDataLayerELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit, label %.lr.ph.split.i, !llvm.loop !16
...
begin_hunk_6_@_ZN6Assimp7Blender22getCustomDataLayerDataERKNS0_10CustomDataENS0_14CustomDataTypeERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE:bb.a
  ...
  tail call void %i.aq(ptr noundef nonnull align 8 dereferenceable(16) %i.y) #23, !inline_history !20
  %i.ar = load ptr, ptr %i.y, align 8
  %i.as = getelementptr inbounds nuw i8, ptr %i.ar, i64 24
  %i.at = load ptr, ptr %i.as, align 8
  tail call void %i.at(ptr noundef nonnull align 8 dereferenceable(16) %i.y) #23, !inline_history !20
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i: ; preds = %bb.k, %bb.j
  ...
  br i1 %i.ax, label %bb.l, label %_ZNSt12__shared_ptrIN6Assimp7Blender15CustomDataLayerELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit, !prof !15
...
begin_hunk_8_@_ZN6Assimp9Formatter15basic_formatterIcSt11char_traitsIcESaIcEEC2EOS5_:bb.a
  ...
  store ptr %i.a, ptr %2, align 8, !alias.scope !30
  %i.b = getelementptr inbounds nuw i8, ptr %2, i64 8 ; 2 uses
  store i64 0, ptr %i.b, align 8, !alias.scope !30
  store i8 0, ptr %i.a, align 8, !alias.scope !30
  %i.c = getelementptr inbounds nuw i8, ptr %1, i64 48
  %i.d = load ptr, ptr %i.c, align 8, !noalias !30 ; 3 uses
  %.not.i.not.i.i.i = icmp eq ptr %i.d, null
  %i.e = getelementptr inbounds nuw i8, ptr %1, i64 32
  %i.f = load ptr, ptr %i.e, align 8, !noalias !30 ; 2 uses
...
begin_hunk_11_@_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE24_M_release_last_use_coldEv:bb.a
  ...
  tail call void %i.c(ptr noundef nonnull align 8 dereferenceable(16) %0) #23, !inline_history !31
...
begin_hunk_12_@_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE24_M_release_last_use_coldEv:bb.a
  ...
  tail call void %i.l(ptr noundef nonnull align 8 dereferenceable(16) %0) #23, !inline_history !31
...
!16 = distinct !{!16, !4}
!17 = !{!18}
!18 = distinct !{!18, !19, !"_ZN6Assimp7Blender18getCustomDataLayerERKNS0_10CustomDataENS0_14CustomDataTypeERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE: argument 0"}
!19 = distinct !{!19, !"_ZN6Assimp7Blender18getCustomDataLayerERKNS0_10CustomDataENS0_14CustomDataTypeERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE"}
