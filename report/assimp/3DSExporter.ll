...
_ZNSt3mapIPK6aiNode12aiMatrix4x4tIfESt4lessIS2_ESaISt4pairIKS2_S4_EEEixERS8_.exit: ; preds = %bb.c, %.critedge.i
  ...
  %6 = load <16 x float>, ptr %i.o, align 4
  br label %bb.d

bb.d:                                             ; preds = %bb.a, %_ZNSt3mapIPK6aiNode12aiMatrix4x4tIfESt4lessIS2_ESaISt4pairIKS2_S4_EEEixERS8_.exit
  %7 = phi <16 x float> [ %6, %_ZNSt3mapIPK6aiNode12aiMatrix4x4tIfESt4lessIS2_ESaISt4pairIKS2_S4_EEEixERS8_.exit ], [ <float 1.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 1.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 1.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 1.000000e+00>, %bb.a ] ; 16 uses
  %i.p = getelementptr inbounds nuw i8, ptr %0, i64 1028
  %i.q = getelementptr inbounds nuw i8, ptr %0, i64 1044
  %i.r = getelementptr inbounds nuw i8, ptr %0, i64 1060
  %i.s = getelementptr inbounds nuw i8, ptr %0, i64 1076
  %i.t = load <4 x float>, ptr %i.p, align 4      ; 4 uses
  %i.u = load <4 x float>, ptr %i.q, align 4      ; 4 uses
  %i.v = shufflevector <16 x float> %7, <16 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %i.w = fmul <4 x float> %i.v, %i.u
  %i.x = shufflevector <16 x float> %7, <16 x float> poison, <4 x i32> zeroinitializer
  %i.y = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.t, <4 x float> %i.x, <4 x float> %i.w)
  %i.z = load <4 x float>, ptr %i.r, align 4      ; 4 uses
  %i.aa = shufflevector <16 x float> %7, <16 x float> poison, <4 x i32> <i32 2, i32 2, i32 2, i32 2>
  %i.ab = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.z, <4 x float> %i.aa, <4 x float> %i.y)
  %i.ac = load <4 x float>, ptr %i.s, align 4     ; 4 uses
  %i.ad = shufflevector <16 x float> %7, <16 x float> poison, <4 x i32> <i32 3, i32 3, i32 3, i32 3>
  %i.ae = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ac, <4 x float> %i.ad, <4 x float> %i.ab)
  %8 = shufflevector <16 x float> %7, <16 x float> poison, <4 x i32> <i32 5, i32 5, i32 5, i32 5>
  %i.af = fmul <4 x float> %8, %i.u
  %9 = shufflevector <16 x float> %7, <16 x float> poison, <4 x i32> <i32 4, i32 4, i32 4, i32 4>
  %i.ag = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.t, <4 x float> %9, <4 x float> %i.af)
  %10 = shufflevector <16 x float> %7, <16 x float> poison, <4 x i32> <i32 6, i32 6, i32 6, i32 6>
  %i.ah = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.z, <4 x float> %10, <4 x float> %i.ag)
  %11 = shufflevector <16 x float> %7, <16 x float> poison, <4 x i32> <i32 7, i32 7, i32 7, i32 7>
  %i.ai = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ac, <4 x float> %11, <4 x float> %i.ah)
  %12 = shufflevector <16 x float> %7, <16 x float> poison, <4 x i32> <i32 9, i32 9, i32 9, i32 9>
  %i.aj = fmul <4 x float> %12, %i.u
  %13 = shufflevector <16 x float> %7, <16 x float> poison, <4 x i32> <i32 8, i32 8, i32 8, i32 8>
  %i.ak = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.t, <4 x float> %13, <4 x float> %i.aj)
  %14 = shufflevector <16 x float> %7, <16 x float> poison, <4 x i32> <i32 10, i32 10, i32 10, i32 10>
  %i.al = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.z, <4 x float> %14, <4 x float> %i.ak)
  %15 = shufflevector <16 x float> %7, <16 x float> poison, <4 x i32> <i32 11, i32 11, i32 11, i32 11>
  %i.am = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ac, <4 x float> %15, <4 x float> %i.al)
  %16 = shufflevector <16 x float> %7, <16 x float> poison, <4 x i32> <i32 13, i32 13, i32 13, i32 13>
  %i.an = fmul <4 x float> %16, %i.u
  %17 = shufflevector <16 x float> %7, <16 x float> poison, <4 x i32> <i32 12, i32 12, i32 12, i32 12>
  %i.ao = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.t, <4 x float> %17, <4 x float> %i.an)
  %18 = shufflevector <16 x float> %7, <16 x float> poison, <4 x i32> <i32 14, i32 14, i32 14, i32 14>
  %i.ap = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.z, <4 x float> %18, <4 x float> %i.ao)
  %19 = shufflevector <16 x float> %7, <16 x float> poison, <4 x i32> <i32 15, i32 15, i32 15, i32 15>
  %i.aq = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ac, <4 x float> %19, <4 x float> %i.ap)
  ...
  %.not10.i.i.i.i6 = icmp eq ptr %i.as, null
  br i1 %.not10.i.i.i.i6, label %.critedge.i17, label %.lr.ph.i.i.i.i7

.lr.ph.i.i.i.i7:                                  ; preds = %bb.d, %.lr.ph.i.i.i.i7
  %.012.i.i.i.i8 = phi ptr [ %.1.i.i.i.i13, %.lr.ph.i.i.i.i7 ], [ %i.as, %bb.d ] ; 3 uses
  %.0811.i.i.i.i9 = phi ptr [ %.19.i.i.i.i10, %.lr.ph.i.i.i.i7 ], [ %i.at, %bb.d ]
  %i.au = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i8, i64 32
  %i.av = load ptr, ptr %i.au, align 8
  %i.aw = icmp ult ptr %i.av, %0                  ; 2 uses
  %.19.i.i.i.i10 = select i1 %i.aw, ptr %.0811.i.i.i.i9, ptr %.012.i.i.i.i8 ; 6 uses
  %.1.in.v.i.i.i.i11 = select i1 %i.aw, i64 24, i64 16
...
_ZNSt3mapIPK6aiNode12aiMatrix4x4tIfESt4lessIS2_ESaISt4pairIKS2_S4_EEE11lower_boundERS8_.exit.i15: ; preds = %.lr.ph.i.i.i.i7
  %i.ax = icmp eq ptr %.19.i.i.i.i10, %i.at
  br i1 %i.ax, label %.critedge.i17, label %bb.e

bb.e:                                             ; preds = %_ZNSt3mapIPK6aiNode12aiMatrix4x4tIfESt4lessIS2_ESaISt4pairIKS2_S4_EEE11lower_boundERS8_.exit.i15
  %i.ay = getelementptr inbounds nuw i8, ptr %.19.i.i.i.i10, i64 32
  %i.az = load ptr, ptr %i.ay, align 8
  %i.ba = icmp ult ptr %0, %i.az
  br i1 %i.ba, label %.critedge.i17, label %_ZNSt3mapIPK6aiNode12aiMatrix4x4tIfESt4lessIS2_ESaISt4pairIKS2_S4_EEEixERS8_.exit19
...
.critedge.i17:                                    ; preds = %bb.e, %_ZNSt3mapIPK6aiNode12aiMatrix4x4tIfESt4lessIS2_ESaISt4pairIKS2_S4_EEE11lower_boundERS8_.exit.i15, %bb.d
  %.08.lcssa.i.i.i11.i18 = phi ptr [ %.19.i.i.i.i10, %bb.e ], [ %.19.i.i.i.i10, %_ZNSt3mapIPK6aiNode12aiMatrix4x4tIfESt4lessIS2_ESaISt4pairIKS2_S4_EEE11lower_boundERS8_.exit.i15 ], [ %i.at, %bb.d ]
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #21
  store ptr %i.a, ptr %2, align 8
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #21
  %i.bb = call ptr @_ZNSt8_Rb_treeIPK6aiNodeSt4pairIKS2_12aiMatrix4x4tIfEESt10_Select1stIS7_ESt4lessIS2_ESaIS7_EE22_M_emplace_hint_uniqueIJRKSt21piecewise_construct_tSt5tupleIJRS4_EESI_IJEEEEESt17_Rb_tree_iteratorIS7_ESt23_Rb_tree_const_iteratorIS7_EDpOT_(ptr noundef nonnull align 8 dereferenceable(48) %1, ptr %.08.lcssa.i.i.i11.i18, ptr noundef nonnull align 1 dereferenceable(1) @_ZSt19piecewise_construct, ptr noundef nonnull align 8 dereferenceable(8) %2, ptr noundef nonnull align 1 dereferenceable(1) %3)
...
_ZNSt3mapIPK6aiNode12aiMatrix4x4tIfESt4lessIS2_ESaISt4pairIKS2_S4_EEEixERS8_.exit19: ; preds = %bb.e, %.critedge.i17
  %.sroa.06.0.i16 = phi ptr [ %i.bb, %.critedge.i17 ], [ %.19.i.i.i.i10, %bb.e ] ; 4 uses
  %i.bc = getelementptr inbounds nuw i8, ptr %.sroa.06.0.i16, i64 40
  store <4 x float> %i.ae, ptr %i.bc, align 4
  %.sroa.12.0..sroa_idx = getelementptr inbounds nuw i8, ptr %.sroa.06.0.i16, i64 56
  store <4 x float> %i.ai, ptr %.sroa.12.0..sroa_idx, align 4
  %.sroa.20.0..sroa_idx = getelementptr inbounds nuw i8, ptr %.sroa.06.0.i16, i64 72
  store <4 x float> %i.am, ptr %.sroa.20.0..sroa_idx, align 4
  %.sroa.28.0..sroa_idx = getelementptr inbounds nuw i8, ptr %.sroa.06.0.i16, i64 88
  store <4 x float> %i.aq, ptr %.sroa.28.0..sroa_idx, align 4
  %i.bd = load ptr, ptr %i.a, align 8             ; 2 uses
  %i.be = getelementptr inbounds nuw i8, ptr %i.bd, i64 1104
...
.lr.ph:                                           ; preds = %_ZNSt3mapIPK6aiNode12aiMatrix4x4tIfESt4lessIS2_ESaISt4pairIKS2_S4_EEEixERS8_.exit19, %.lr.ph
  ...
  %i.bg = phi ptr [ %i.bl, %.lr.ph ], [ %i.bd, %_ZNSt3mapIPK6aiNode12aiMatrix4x4tIfESt4lessIS2_ESaISt4pairIKS2_S4_EEEixERS8_.exit19 ]
  %i.bh = getelementptr inbounds nuw i8, ptr %i.bg, i64 1112
  %i.bi = load ptr, ptr %i.bh, align 8
  %i.bj = getelementptr inbounds nuw [8 x i8], ptr %i.bi, i64 %indvars.iv
  %i.bk = load ptr, ptr %i.bj, align 8
  call fastcc void @_ZN6Assimp12_GLOBAL__N_113CollectTrafosEPK6aiNodeRSt3mapIS3_12aiMatrix4x4tIfESt4lessIS3_ESaISt4pairIKS3_S6_EEE(ptr noundef %i.bk, ptr noundef nonnull align 8 dereferenceable(48) %1)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.bl = load ptr, ptr %i.a, align 8             ; 2 uses
  %i.bm = getelementptr inbounds nuw i8, ptr %i.bl, i64 1104
