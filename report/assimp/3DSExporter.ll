...
_ZNSt3mapIPK6aiNode12aiMatrix4x4tIfESt4lessIS2_ESaISt4pairIKS2_S4_EEEixERS8_.exit: ; preds = %bb.c, %.critedge.i
  ...
  %i.o = getelementptr inbounds nuw i8, ptr %.sroa.06.0.i, i64 88
  %10 = load <4 x float>, ptr %i.o, align 4
  br label %bb.d
...
bb.d:                                             ; preds = %bb.a, %_ZNSt3mapIPK6aiNode12aiMatrix4x4tIfESt4lessIS2_ESaISt4pairIKS2_S4_EEEixERS8_.exit
  ...
  %i.v = shufflevector <4 x float> %11, <4 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %i.w = fmul <4 x float> %i.v, %i.u
  %i.x = shufflevector <4 x float> %11, <4 x float> poison, <4 x i32> zeroinitializer
  %i.y = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.t, <4 x float> %i.x, <4 x float> %i.w)
  %i.z = load <4 x float>, ptr %i.r, align 4      ; 4 uses
  %i.aa = shufflevector <4 x float> %11, <4 x float> poison, <4 x i32> <i32 2, i32 2, i32 2, i32 2>
  ...
  %i.ad = shufflevector <4 x float> %11, <4 x float> poison, <4 x i32> <i32 3, i32 3, i32 3, i32 3>
