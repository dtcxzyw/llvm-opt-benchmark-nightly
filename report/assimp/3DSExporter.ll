...
_ZNSt3mapIPK6aiNode12aiMatrix4x4tIfESt4lessIS2_ESaISt4pairIKS2_S4_EEEixERS8_.exit: ; preds = %bb.c, %.critedge.i
  ...
  %.sroa.21.0..sroa_idx = getelementptr inbounds nuw i8, ptr %.sroa.06.0.i, i64 40
  %6 = load <16 x float>, ptr %.sroa.21.0..sroa_idx, align 4
  br label %bb.d
...
bb.d:                                             ; preds = %bb.a, %_ZNSt3mapIPK6aiNode12aiMatrix4x4tIfESt4lessIS2_ESaISt4pairIKS2_S4_EEEixERS8_.exit
  ...
  %i.u = shufflevector <16 x float> %7, <16 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %i.v = fmul <4 x float> %i.u, %i.t
  %i.w = shufflevector <16 x float> %7, <16 x float> poison, <4 x i32> zeroinitializer
  %i.x = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.s, <4 x float> %i.w, <4 x float> %i.v)
  %i.y = load <4 x float>, ptr %i.q, align 4      ; 4 uses
  %i.z = shufflevector <16 x float> %7, <16 x float> poison, <4 x i32> <i32 2, i32 2, i32 2, i32 2>
  ...
  %i.ac = shufflevector <16 x float> %7, <16 x float> poison, <4 x i32> <i32 3, i32 3, i32 3, i32 3>
