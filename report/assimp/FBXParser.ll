...
bb.a:
  ...
  %i.d = load ptr, ptr %i.c, align 8, !noalias !131 ; 3 uses
  %.not5.i.i = icmp eq ptr %i.d, null
  br i1 %.not5.i.i, label %bb.d, label %bb.b

bb.b:                                             ; preds = %bb.a
  %2 = getelementptr inbounds nuw i8, ptr %1, i64 32
  %3 = load ptr, ptr %2, align 8, !noalias !131   ; 2 uses
  %4 = icmp ugt ptr %i.d, %3
  %.08.i.i.i = select i1 %4, ptr %i.d, ptr %3
...
bb.a:
  ...
  %i.c = getelementptr inbounds nuw i8, ptr %1, i64 48
  %i.d = load ptr, ptr %i.c, align 8, !noalias !141 ; 3 uses
  %.not5.i.i.i = icmp eq ptr %i.d, null
  br i1 %.not5.i.i.i, label %bb.d, label %bb.b

bb.b:                                             ; preds = %bb.a
  %3 = getelementptr inbounds nuw i8, ptr %1, i64 32
  %4 = load ptr, ptr %3, align 8, !noalias !141   ; 2 uses
...
bb.a:
  ...
  %i.f = load ptr, ptr %i.e, align 8, !noalias !155 ; 3 uses
  %.not5.i.i.i.i = icmp eq ptr %i.f, null
  br i1 %.not5.i.i.i.i, label %bb.d, label %bb.b

bb.b:                                             ; preds = %bb.a
  %5 = getelementptr inbounds nuw i8, ptr %4, i64 32
  %6 = load ptr, ptr %5, align 8, !noalias !155   ; 2 uses
...
bb.a:
  ...
  %i.e = getelementptr inbounds nuw i8, ptr %4, i64 48
  %i.f = load ptr, ptr %i.e, align 8, !noalias !173 ; 3 uses
  %.not5.i.i.i.i = icmp eq ptr %i.f, null
  br i1 %.not5.i.i.i.i, label %bb.d, label %bb.b

bb.b:                                             ; preds = %bb.a
  %5 = getelementptr inbounds nuw i8, ptr %4, i64 32
  %6 = load ptr, ptr %5, align 8, !noalias !173   ; 2 uses
  %7 = icmp ugt ptr %i.f, %6
  %.08.i.i.i.i.i = select i1 %7, ptr %i.f, ptr %6
  %i.g = getelementptr inbounds nuw i8, ptr %4, i64 40
