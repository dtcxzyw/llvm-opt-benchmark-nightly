...
.lr.ph:                                           ; preds = %bb.ae, %bb.af
  %.sroa.0149.0159 = phi ptr [ %i.eb, %bb.af ], [ %i.dy, %bb.ae ] ; 3 uses
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.0149.0159) ]
...
bb.t:                                             ; preds = %.lr.ph, %_ZNSt6vectorIPKN6Assimp3FBX7ClusterESaIS4_EE9push_backERKS4_.exit
  %.sroa.044.050 = phi ptr [ %i.bp, %.lr.ph ], [ %i.cv, %_ZNSt6vectorIPKN6Assimp3FBX7ClusterESaIS4_EE9push_backERKS4_.exit ] ; 3 uses
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.044.050) ]
...
.lr.ph:                                           ; preds = %_ZNSt13unordered_setIPKN6Assimp3FBX17BlendShapeChannelESt4hashIS4_ESt8equal_toIS4_ESaIS4_EE7reserveEm.exit, %bb.n
  %.sroa.027.032 = phi ptr [ %i.av, %bb.n ], [ %i.y, %_ZNSt13unordered_setIPKN6Assimp3FBX17BlendShapeChannelESt4hashIS4_ESt8equal_toIS4_ESaIS4_EE7reserveEm.exit ] ; 3 uses
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.027.032) ]
...
.lr.ph:                                           ; preds = %_ZNSt13unordered_setIPKN6Assimp3FBX13ShapeGeometryESt4hashIS4_ESt8equal_toIS4_ESaIS4_EE7reserveEm.exit, %bb.x
  %.sroa.096.0103 = phi ptr [ %i.cz, %bb.x ], [ %i.cc, %_ZNSt13unordered_setIPKN6Assimp3FBX13ShapeGeometryESt4hashIS4_ESt8equal_toIS4_ESaIS4_EE7reserveEm.exit ] ; 3 uses
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.096.0103) ]
