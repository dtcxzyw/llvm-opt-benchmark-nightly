...
bb.n:                                             ; preds = %.lr.ph, %bb.n
  ...
  %i.dv = load float, ptr %i.dr, align 4, !noalias !64 ; 4 uses
  ...
  %i.ed = load <2 x float>, ptr %i.dt, align 4, !noalias !64 ; 6 uses
  %6 = extractelement <2 x float> %i.ed, i64 1
  ...
  %7 = fmul float %6, %i.dv
  %8 = extractelement <4 x float> %i.eb, i64 0
  %9 = fmul float %8, %i.dw
  %10 = insertelement <2 x float> %i.ed, float %i.dv, i64 1
  %11 = shufflevector <4 x float> %i.eb, <4 x float> poison, <2 x i32> zeroinitializer ; 3 uses
  %12 = insertelement <2 x float> %11, float %i.dw, i64 0
  %i.ei = fmul <2 x float> %10, %12
  %13 = fmul <2 x float> %i.ed, %i.ed             ; 2 uses
  %14 = extractelement <2 x float> %13, i64 1
  %15 = call float @llvm.fmuladd.f32(float %i.ee, float %i.ee, float %14)
  %i.ej = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %11, <2 x float> %11, <2 x float> %13)
  ...
  %i.em = insertelement <4 x float> %i.el, float %15, i64 0
  ...
  %16 = insertelement <4 x float> <float poison, float 1.000000e+00, float poison, float poison>, float %7, i64 0
  %17 = insertelement <4 x float> %16, float %9, i64 2
  %i.fa = shufflevector <4 x float> %17, <4 x float> %i.es, <4 x i32> <i32 0, i32 1, i32 2, i32 4>
  ...
  %18 = shufflevector <2 x float> %i.ei, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %19 = insertelement <4 x float> %18, float 1.000000e+00, i64 2
  %i.fi = shufflevector <4 x float> %19, <4 x float> %i.es, <4 x i32> <i32 0, i32 1, i32 2, i32 5>
...
bb.a:
  ...
  %i.v = load <2 x float>, ptr %i.c, align 4, !noalias !81 ; 3 uses
  %i.w = load float, ptr %i.d, align 4, !noalias !81 ; 5 uses
  %2 = insertelement <2 x float> poison, float %i.w, i64 0
  %3 = insertelement <2 x float> %2, float %i.f, i64 1
  %4 = shufflevector <2 x float> %i.v, <2 x float> poison, <2 x i32> <i32 poison, i32 0> ; 2 uses
  %5 = insertelement <2 x float> %4, float %i.g, i64 0
  ...
  %8 = shufflevector <4 x float> %i.o, <4 x float> %7, <4 x i32> <i32 0, i32 4, i32 5, i32 3>
  ...
  %i.ap = insertelement <2 x float> %4, float %i.w, i64 0 ; 2 uses
  ...
  %i.bc = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.m, <4 x float> %i.bb, <4 x float> %8)
