...
bb.a:
  ...
  %5 = alloca %class.aiMatrix4x4t, align 16       ; 19 uses
...
.lr.ph:                                           ; preds = %bb.m
  ...
  %i.dd = getelementptr inbounds nuw i8, ptr %5, i64 20
  %i.de = getelementptr inbounds nuw i8, ptr %5, i64 24
  %i.df = getelementptr inbounds nuw i8, ptr %5, i64 28
  %i.dg = getelementptr inbounds nuw i8, ptr %5, i64 32 ; 2 uses
  ...
  %i.dk = getelementptr inbounds nuw i8, ptr %5, i64 48 ; 2 uses
  %i.dl = getelementptr inbounds nuw i8, ptr %5, i64 52
  %i.dm = getelementptr inbounds nuw i8, ptr %5, i64 56
  br label %bb.n
...
bb.n:                                             ; preds = %.lr.ph, %bb.n
  ...
  %i.ge = load float, ptr %i.db, align 8
  %i.gf = load float, ptr %i.da, align 4
  ...
  %i.gz = load <4 x float>, ptr %i.dc, align 16   ; 4 uses
  %i.ha = load float, ptr %i.df, align 4
  %i.hb = load float, ptr %i.de, align 8
  %i.hc = load float, ptr %i.dd, align 4          ; 4 uses
  ...
  store <4 x float> %i.hw, ptr %i.dc, align 16
  %i.hx = load <4 x float>, ptr %i.dg, align 16   ; 4 uses
  %i.hy = load float, ptr %i.dj, align 4
  %i.hz = load float, ptr %i.di, align 8
  %i.ia = load float, ptr %i.dh, align 4          ; 4 uses
  ...
  store <4 x float> %i.is, ptr %i.dg, align 16
  %i.it = load <4 x float>, ptr %i.dk, align 16   ; 6 uses
  %i.iu = load float, ptr %i.dm, align 8
  %i.iv = load float, ptr %i.dl, align 4
  %i.iw = fmul float %i.eb, %i.iv
  %i.ix = extractelement <4 x float> %i.it, i64 0
  %i.iy = call float @llvm.fmuladd.f32(float %i.dx, float %i.ix, float %i.iw)
  %i.iz = call float @llvm.fmuladd.f32(float %i.ef, float %i.iu, float %i.iy)
  %6 = shufflevector <4 x float> %i.it, <4 x float> poison, <4 x i32> <i32 poison, i32 poison, i32 1, i32 3>
  %7 = insertelement <4 x float> %6, float %i.fx, i64 0
  %8 = insertelement <4 x float> %7, float %i.fy, i64 1 ; 2 uses
  %9 = shufflevector <4 x float> %i.it, <4 x float> poison, <4 x i32> <i32 1, i32 1, i32 poison, i32 poison>
  %10 = insertelement <4 x float> %9, float %i.fz, i64 2
  %i.ja = insertelement <4 x float> %10, float %i.iz, i64 3 ; 2 uses
  %11 = fmul <4 x float> %8, %i.ja
  %12 = fadd <4 x float> %8, %i.ja
  %13 = shufflevector <4 x float> %11, <4 x float> %12, <4 x i32> <i32 0, i32 1, i32 2, i32 7>
  %14 = shufflevector <4 x float> %i.it, <4 x float> <float poison, float -0.000000e+00, float poison, float poison>, <4 x i32> <i32 0, i32 0, i32 0, i32 5>
  %i.jb = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.hl, <4 x float> %14, <4 x float> %13)
  ...
  store <4 x float> %i.jf, ptr %i.dk, align 16
