...
begin_hunk_0_@_ZN6Assimp4Ogre20VertexAnimationTrack28ConvertToAssimpAnimationNodeEPNS0_8SkeletonE:bb.a
  ...
  %i.ee = load float, ptr %i.ed, align 4, !noalias !69 ; 2 uses
...
begin_hunk_1_@_ZN6Assimp4Ogre20VertexAnimationTrack28ConvertToAssimpAnimationNodeEPNS0_8SkeletonE:bb.a
  ...
  %6 = insertelement <4 x float> <float poison, float poison, float 1.000000e+00, float poison>, float %i.ee, i64 0
  %i.gd = insertelement <4 x float> %6, float %i.fk, i64 3
  %7 = shufflevector <4 x float> %i.gd, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 2, i32 3>
  %8 = shufflevector <2 x float> %i.ft, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %9 = insertelement <4 x float> %8, float %i.fy, i64 2
  %i.ge = insertelement <4 x float> %9, float %i.ee, i64 3
...
begin_hunk_2_@_ZN6Assimp4Ogre4Bone34CalculateWorldMatrixAndDefaultPoseEPNS0_8SkeletonE:bb.a
  ...
  %4 = insertelement <4 x float> <float poison, float 1.000000e+00, float poison, float poison>, float %i.be, i64 0
  %5 = shufflevector <4 x float> %4, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
  %6 = shufflevector <2 x float> %i.ai, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.bi = insertelement <4 x float> %6, float %i.al, i64 2
  %7 = insertelement <4 x float> %i.bi, float %i.bh, i64 3
  %i.bj = fmul <4 x float> %5, %7
  ...
  %8 = insertelement <4 x float> <float poison, float 1.000000e+00, float poison, float poison>, float %i.bl, i64 0
  %9 = shufflevector <4 x float> %8, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
  %10 = shufflevector <2 x float> %i.aq, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.bp = insertelement <4 x float> %10, float %i.at, i64 2
  %11 = insertelement <4 x float> %i.bp, float %i.bo, i64 3
  %i.bq = fmul <4 x float> %9, %11
...
begin_hunk_3_@_ZN6Assimp4Ogre4Bone34CalculateWorldMatrixAndDefaultPoseEPNS0_8SkeletonE:bb.a
  ...
  %12 = insertelement <4 x float> <float poison, float 1.000000e+00, float poison, float poison>, float %i.dm, i64 0
  %13 = shufflevector <4 x float> %12, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
  %14 = shufflevector <2 x float> %i.cq, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.dq = insertelement <4 x float> %14, float %i.ct, i64 2
  %15 = insertelement <4 x float> %i.dq, float %i.dp, i64 3
  %i.dr = fmul <4 x float> %13, %15
  ...
  %16 = insertelement <4 x float> <float poison, float 1.000000e+00, float poison, float poison>, float %i.dt, i64 0
  %17 = shufflevector <4 x float> %16, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
  %18 = shufflevector <2 x float> %i.cy, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.dx = insertelement <4 x float> %18, float %i.db, i64 2
  %19 = insertelement <4 x float> %i.dx, float %i.dw, i64 3
  %i.dy = fmul <4 x float> %17, %19
...
begin_hunk_4_@_ZN6Assimp4Ogre4Bone34CalculateWorldMatrixAndDefaultPoseEPNS0_8SkeletonE:bb.a
  ...
  %20 = insertelement <4 x float> <float poison, float 1.000000e+00, float poison, float poison>, float %i.hw, i64 0
  %21 = shufflevector <4 x float> %20, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
  %22 = shufflevector <2 x float> %i.hi, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.il = insertelement <4 x float> %22, float %i.hl, i64 2
  %23 = insertelement <4 x float> %i.il, float %i.ik, i64 3
  %i.im = fmul <4 x float> %21, %23
  ...
  %24 = insertelement <4 x float> <float poison, float 1.000000e+00, float poison, float poison>, float %i.hz, i64 0
  %25 = shufflevector <4 x float> %24, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
  %26 = shufflevector <2 x float> %i.hq, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.io = insertelement <4 x float> %26, float %i.ht, i64 2
  %27 = insertelement <4 x float> %i.io, float %i.in, i64 3
  %i.ip = fmul <4 x float> %25, %27
...
begin_hunk_5_@_ZN6Assimp4Ogre17TransformKeyFrame9TransformEv:bb.a
  ...
  %2 = insertelement <4 x float> <float poison, float 1.000000e+00, float poison, float poison>, float %i.ax, i64 0
  %3 = shufflevector <4 x float> %2, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
  %4 = shufflevector <2 x float> %i.ab, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.bb = insertelement <4 x float> %4, float %i.ae, i64 2
  %5 = insertelement <4 x float> %i.bb, float %i.ba, i64 3
  %i.bc = fmul <4 x float> %3, %5
  ...
  %i.bh = load float, ptr %i.bg, align 4
  %6 = insertelement <4 x float> <float poison, float 1.000000e+00, float poison, float poison>, float %i.be, i64 0
  %7 = shufflevector <4 x float> %6, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
  %8 = shufflevector <2 x float> %i.aj, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.bi = insertelement <4 x float> %8, float %i.am, i64 2
  %9 = insertelement <4 x float> %i.bi, float %i.bh, i64 3
  %i.bj = fmul <4 x float> %7, %9
