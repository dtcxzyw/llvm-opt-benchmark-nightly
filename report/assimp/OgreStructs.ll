...
bb.b:                                             ; preds = %bb.a
  ...
  %4 = tail call float @llvm.fmuladd.f32(float %i.ac, float %i.s, float %i.ab)
  %i.af = insertelement <2 x float> poison, float %4, i64 0
  %i.ag = insertelement <2 x float> %i.af, float %i.ae, i64 1
  %i.ah = fmul <2 x float> %i.ag, <float 2.000000e+00, float 1.000000e+00>
  %i.ai = fmul float %i.ac, %i.n
  %i.aj = tail call float @llvm.fmuladd.f32(float %i.s, float %i.p, float %i.ai)
  %i.ak = fmul float %i.aj, 2.000000e+00
  %5 = fmul <2 x float> %i.r, %i.w
  %6 = shufflevector <2 x float> %5, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %7 = shufflevector <2 x float> %i.o, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %8 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.r, <2 x float> %7, <2 x float> %6)
  %9 = fmul <2 x float> %8, splat (float 2.000000e+00)
  %10 = fmul float %i.s, %i.s
  %11 = tail call float @llvm.fmuladd.f32(float %i.ac, float %i.ac, float %10)
  ...
  %13 = insertelement <4 x float> %i.bb, float %i.ak, i64 2
  %i.bc = insertelement <4 x float> %13, float %i.ay, i64 3
  ...
  %i.bl = shufflevector <2 x float> %9, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %14 = insertelement <4 x float> %i.bl, float %12, i64 2
  %i.bm = insertelement <4 x float> %14, float %i.bi, i64 3
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.br = load float, ptr %i.i, align 4, !noalias !75 ; 3 uses
  %i.bs = fneg float %i.br                        ; 2 uses
  %i.bt = load <2 x float>, ptr %i.k, align 4, !noalias !75 ; 4 uses
  %i.bu = extractelement <2 x float> %i.bt, i64 1 ; 4 uses
  %i.bv = fmul float %i.bu, %i.bu                 ; 2 uses
  %i.bw = load <2 x float>, ptr %i.l, align 8, !noalias !75 ; 6 uses
  %i.bx = extractelement <2 x float> %i.bw, i64 1 ; 6 uses
  ...
  %i.cb = insertelement <2 x float> %i.ca, float %i.bs, i64 1 ; 2 uses
  ...
  %i.ch = extractelement <2 x float> %i.bw, i64 0 ; 6 uses
  %i.ci = tail call float @llvm.fmuladd.f32(float %i.ch, float %i.ch, float %i.bv)
  %i.cj = tail call float @llvm.fmuladd.f32(float %i.ci, float -2.000000e+00, float 1.000000e+00)
  %15 = tail call float @llvm.fmuladd.f32(float %i.ch, float %i.bx, float %i.cg)
  %i.ck = insertelement <2 x float> poison, float %15, i64 0
  %i.cl = insertelement <2 x float> %i.ck, float %i.cj, i64 1
  %i.cm = fmul <2 x float> %i.cl, <float 2.000000e+00, float 1.000000e+00>
  %i.cn = fmul float %i.ch, %i.bs
  %i.co = tail call float @llvm.fmuladd.f32(float %i.bx, float %i.bu, float %i.cn)
  %i.cp = fmul float %i.co, 2.000000e+00
  %16 = fmul <2 x float> %i.bw, %i.cb
  %17 = shufflevector <2 x float> %16, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %18 = shufflevector <2 x float> %i.bt, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %19 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bw, <2 x float> %18, <2 x float> %17)
  %20 = fmul <2 x float> %19, splat (float 2.000000e+00)
  %21 = fmul float %i.bx, %i.bx
  %22 = tail call float @llvm.fmuladd.f32(float %i.ch, float %i.ch, float %21)
  ...
  %24 = insertelement <4 x float> %i.dg, float %i.cp, i64 2
  %i.dh = insertelement <4 x float> %24, float %i.dd, i64 3
  ...
  %i.dq = shufflevector <2 x float> %20, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %25 = insertelement <4 x float> %i.dq, float %23, i64 2
  %i.dr = insertelement <4 x float> %25, float %i.dn, i64 3
...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  %i.gg = load float, ptr %i.gc, align 4, !noalias !78 ; 3 uses
  %i.gh = fneg float %i.gg                        ; 2 uses
  %i.gi = load <2 x float>, ptr %i.ge, align 4, !noalias !78 ; 4 uses
  %i.gj = extractelement <2 x float> %i.gi, i64 1 ; 4 uses
  %i.gk = fmul float %i.gj, %i.gj                 ; 2 uses
  %i.gl = load <2 x float>, ptr %i.gf, align 8, !noalias !78 ; 6 uses
  %i.gm = extractelement <2 x float> %i.gl, i64 1 ; 6 uses
  ...
  %i.gq = insertelement <2 x float> %i.gp, float %i.gh, i64 1 ; 2 uses
  ...
  %i.gw = extractelement <2 x float> %i.gl, i64 0 ; 6 uses
  %i.gx = call float @llvm.fmuladd.f32(float %i.gw, float %i.gw, float %i.gk)
  %i.gy = call float @llvm.fmuladd.f32(float %i.gx, float -2.000000e+00, float 1.000000e+00)
  %26 = call float @llvm.fmuladd.f32(float %i.gw, float %i.gm, float %i.gv)
  %i.gz = insertelement <2 x float> poison, float %26, i64 0
  %i.ha = insertelement <2 x float> %i.gz, float %i.gy, i64 1
  %i.hb = fmul <2 x float> %i.ha, <float 2.000000e+00, float 1.000000e+00>
  %i.hc = fmul float %i.gw, %i.gh
  %i.hd = call float @llvm.fmuladd.f32(float %i.gm, float %i.gj, float %i.hc)
  %i.he = fmul float %i.hd, 2.000000e+00
  %27 = fmul <2 x float> %i.gl, %i.gq
  %28 = shufflevector <2 x float> %27, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %29 = shufflevector <2 x float> %i.gi, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %30 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.gl, <2 x float> %29, <2 x float> %28)
  %31 = fmul <2 x float> %30, splat (float 2.000000e+00)
  %32 = fmul float %i.gm, %i.gm
  %33 = call float @llvm.fmuladd.f32(float %i.gw, float %i.gw, float %32)
  %34 = call float @llvm.fmuladd.f32(float %33, float -2.000000e+00, float 1.000000e+00)
  ...
  %35 = insertelement <4 x float> %i.hy, float %i.he, i64 2
  %i.hz = insertelement <4 x float> %35, float %i.hv, i64 3
  ...
  %i.ie = shufflevector <2 x float> %31, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %36 = insertelement <4 x float> %i.ie, float %34, i64 2
  %i.if = insertelement <4 x float> %36, float %i.ib, i64 3
...
bb.a:
  ...
  %i.f = load float, ptr %i.b, align 4, !noalias !81 ; 3 uses
  %i.g = fneg float %i.f                          ; 2 uses
  %i.h = load <2 x float>, ptr %i.d, align 4, !noalias !81 ; 4 uses
  %i.i = extractelement <2 x float> %i.h, i64 1   ; 4 uses
  %i.j = fmul float %i.i, %i.i                    ; 2 uses
  %i.k = load <2 x float>, ptr %i.e, align 4, !noalias !81 ; 6 uses
  %i.l = extractelement <2 x float> %i.k, i64 1   ; 6 uses
  ...
  %i.p = insertelement <2 x float> %i.o, float %i.g, i64 1 ; 2 uses
  ...
  %i.v = extractelement <2 x float> %i.k, i64 0   ; 6 uses
  %i.w = tail call float @llvm.fmuladd.f32(float %i.v, float %i.v, float %i.j)
  %i.x = tail call float @llvm.fmuladd.f32(float %i.w, float -2.000000e+00, float 1.000000e+00)
  %2 = tail call float @llvm.fmuladd.f32(float %i.v, float %i.l, float %i.u)
  %i.y = insertelement <2 x float> poison, float %2, i64 0
  %i.z = insertelement <2 x float> %i.y, float %i.x, i64 1
  %i.aa = fmul <2 x float> %i.z, <float 2.000000e+00, float 1.000000e+00>
  %i.ab = fmul float %i.v, %i.g
  %i.ac = tail call float @llvm.fmuladd.f32(float %i.l, float %i.i, float %i.ab)
  %i.ad = fmul float %i.ac, 2.000000e+00
  %3 = fmul <2 x float> %i.k, %i.p
  %4 = shufflevector <2 x float> %3, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %5 = shufflevector <2 x float> %i.h, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %6 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.k, <2 x float> %5, <2 x float> %4)
  %7 = fmul <2 x float> %6, splat (float 2.000000e+00)
  %8 = fmul float %i.l, %i.l
  %9 = tail call float @llvm.fmuladd.f32(float %i.v, float %i.v, float %8)
  ...
  %11 = insertelement <4 x float> %i.au, float %i.ad, i64 2
  %i.av = insertelement <4 x float> %11, float %i.ar, i64 3
  ...
  %i.be = shufflevector <2 x float> %7, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %12 = insertelement <4 x float> %i.be, float %10, i64 2
  %i.bf = insertelement <4 x float> %12, float %i.bb, i64 3
