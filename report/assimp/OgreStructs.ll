...
begin_hunk_0_@_ZN6Assimp4Ogre20VertexAnimationTrack28ConvertToAssimpAnimationNodeEPNS0_8SkeletonE:bb.a
  ...
  %i.gk = load float, ptr %5, align 4             ; 3 uses
...
begin_hunk_2_@_ZN6Assimp4Ogre20VertexAnimationTrack28ConvertToAssimpAnimationNodeEPNS0_8SkeletonE:bb.a
  ...
  %6 = shufflevector <2 x float> %i.go, <2 x float> %i.hf, <4 x i32> <i32 0, i32 poison, i32 2, i32 poison>
  %7 = insertelement <4 x float> %6, float %i.gk, i64 1
  %8 = shufflevector <4 x float> %7, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 2>
...
begin_hunk_3_@_ZN6Assimp4Ogre20VertexAnimationTrack28ConvertToAssimpAnimationNodeEPNS0_8SkeletonE:bb.a
  ...
  %9 = shufflevector <2 x float> %i.hf, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 poison> ; 2 uses
...
begin_hunk_4_@_ZN6Assimp4Ogre20VertexAnimationTrack28ConvertToAssimpAnimationNodeEPNS0_8SkeletonE:bb.a
  ...
  %i.iw = insertelement <4 x float> %i.iv, float %i.eg, i64 1
  %10 = shufflevector <4 x float> %i.iw, <4 x float> %i.io, <4 x i32> <i32 0, i32 0, i32 1, i32 5>
  %i.ix = shufflevector <4 x float> <float 0.000000e+00, float 0.000000e+00, float poison, float 0.000000e+00>, <4 x float> %9, <4 x i32> <i32 0, i32 1, i32 6, i32 3>
...
begin_hunk_5_@_ZN6Assimp4Ogre20VertexAnimationTrack28ConvertToAssimpAnimationNodeEPNS0_8SkeletonE:bb.a
  ...
  %i.jw = insertelement <4 x float> %i.jv, float %i.eg, i64 1
  %11 = shufflevector <4 x float> %i.jw, <4 x float> %i.jo, <4 x i32> <i32 0, i32 0, i32 1, i32 5>
