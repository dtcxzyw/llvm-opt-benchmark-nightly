...
bb.c:                                             ; preds = %bb.b, %bb.b
  ...
  %.not6468 = icmp eq ptr %i.k, %1
  br i1 %.not6468, label %._crit_edge, label %.lr.ph.preheader

.lr.ph.preheader:                                 ; preds = %bb.c
  %i.l = sub i64 %i.a, %.0.lcssa.i104
  %scevgep = getelementptr i8, ptr %.0.lcssa.i, i64 %i.l
  %i.m = trunc i64 %i.a to i32
  %i.n = add i32 %i.m, -2
  %i.o = trunc i64 %.0.lcssa.i104 to i32
  %i.p = sub i32 %i.n, %i.o
  br label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.d
  %.04770 = phi i32 [ %i.r, %bb.d ], [ 0, %.lr.ph.preheader ] ; 9 uses
  %.05369 = phi ptr [ %i.s, %bb.d ], [ %i.k, %.lr.ph.preheader ] ; 10 uses
  %i.q = load i8, ptr %.05369, align 1
...
.critedge:                                        ; preds = %bb.d, %.lr.ph, %.lr.ph, %.lr.ph, %.lr.ph, %.lr.ph, %.lr.ph, %.lr.ph, %.lr.ph
  ...
  %.047.lcssa = phi i32 [ %.04770, %.lr.ph ], [ %i.p, %bb.d ], [ %.04770, %.lr.ph ], [ %.04770, %.lr.ph ], [ %.04770, %.lr.ph ], [ %.04770, %.lr.ph ], [ %.04770, %.lr.ph ], [ %.04770, %.lr.ph ], [ %.04770, %.lr.ph ] ; 2 uses
  %i.t = icmp sgt i32 %.047.lcssa, 0
  br i1 %i.t, label %.lr.ph99, label %._crit_edge
...
._crit_edge:                                      ; preds = %bb.c, %._crit_edge.loopexit, %.critedge
  %.053.lcssa112 = phi ptr [ %.053.lcssa, %.critedge ], [ %.053.lcssa, %._crit_edge.loopexit ], [ %i.k, %bb.c ] ; 2 uses
  %.044.lcssa = phi i64 [ 0, %.critedge ], [ %i.ag, %._crit_edge.loopexit ], [ 0, %bb.c ]
  %i.ah = tail call noundef ptr @_ZN10ODDLParser14ValueAllocator13allocPrimDataENS_5Value9ValueTypeEm(i32 noundef 8, i64 noundef 1) ; 3 uses
  store ptr %i.ah, ptr %2, align 8
  %.not65 = icmp eq ptr %i.ah, null
  br i1 %.not65, label %bb.g, label %bb.f

bb.f:                                             ; preds = %._crit_edge
  tail call void @_ZN10ODDLParser5Value16setUnsignedInt64Em(ptr noundef nonnull align 8 dereferenceable(32) %i.ah, i64 noundef %.044.lcssa)
  br label %bb.g

bb.g:                                             ; preds = %._crit_edge, %bb.f, %bb.b, %_ZN10ODDLParser16lookForNextTokenIcEEPT_S2_S2_.exit, %bb.a
  %.4 = phi ptr [ %i.i, %bb.b ], [ %0, %bb.a ], [ %.0.lcssa.i, %_ZN10ODDLParser16lookForNextTokenIcEEPT_S2_S2_.exit ], [ %.053.lcssa112, %._crit_edge ], [ %.053.lcssa112, %bb.f ]
  ret ptr %.4
}
