...
begin_hunk_0_@_ZN6Assimp12AC3DImporter20ConvertObjectSectionERNS0_6ObjectERSt6vectorIP6aiMeshSaIS5_EERS3_IP10aiMaterialSaISA_EERKS3_INS0_8MaterialESaISE_EEP6aiNode:bb.a
  ...
  store i32 %.8590, ptr %i.yl, align 4
...
_ZN6AssimpL19buildBacksideOfFaceERK6aiFaceRPS0_RP10aiVector3tIfEPKS6_S8_SA_Rj.exit402: ; preds = %bb.dp, %_ZN6AssimpL16flipWindingOrderER6aiFace.exit.loopexit.i396, %_ZN6AssimpL16flipWindingOrderER6aiFace.exit.thread.i398, %bb.dj
  ...
  %.3585 = phi i32 [ %i.tt, %bb.dj ], [ %i.tt, %_ZN6AssimpL16flipWindingOrderER6aiFace.exit.loopexit.i396 ], [ %i.tt, %_ZN6AssimpL16flipWindingOrderER6aiFace.exit.thread.i398 ], [ %i.yj, %bb.dp ] ; 2 uses
  %.4581 = phi ptr [ %i.wz, %bb.dj ], [ %i.wz, %_ZN6AssimpL16flipWindingOrderER6aiFace.exit.loopexit.i396 ], [ %i.wz, %_ZN6AssimpL16flipWindingOrderER6aiFace.exit.thread.i398 ], [ %i.yc, %bb.dp ] ; 2 uses
  %.2 = phi ptr [ %i.tm, %bb.dj ], [ %i.xi, %_ZN6AssimpL16flipWindingOrderER6aiFace.exit.loopexit.i396 ], [ %i.xi, %_ZN6AssimpL16flipWindingOrderER6aiFace.exit.thread.i398 ], [ %i.xi, %bb.dp ] ; 2 uses
...
bb.dr:                                            ; preds = %.lr.ph719, %bb.ed
  %.0261717 = phi i32 [ 0, %.lr.ph719 ], [ %i.aav, %bb.ed ] ; 2 uses
  %.sroa.0512.1716 = phi ptr [ %i.yz, %.lr.ph719 ], [ %.sroa.0512.2, %bb.ed ] ; 5 uses
  %.3715 = phi ptr [ %.0576728, %.lr.ph719 ], [ %i.zl, %bb.ed ] ; 3 uses
  %.5714 = phi ptr [ %.0577727, %.lr.ph719 ], [ %i.aao, %bb.ed ] ; 3 uses
  %.4586713 = phi i32 [ %.0582726, %.lr.ph719 ], [ %i.zp, %bb.ed ] ; 3 uses
  %.10602712 = phi ptr [ %.1593725, %.lr.ph719 ], [ %.12, %bb.ed ] ; 4 uses
  %i.zl = getelementptr inbounds nuw i8, ptr %.3715, i64 16 ; 2 uses
  store i32 2, ptr %.3715, align 8
...
bb.ds:                                            ; preds = %bb.dr
  %i.zn = getelementptr inbounds nuw i8, ptr %.3715, i64 8 ; 2 uses
  store ptr %i.zm, ptr %i.zn, align 8
  %i.zo = add i32 %.4586713, 1
  store i32 %.4586713, ptr %i.zm, align 4
  %i.zp = add i32 %.4586713, 2                    ; 2 uses
...
bb.dw:                                            ; preds = %bb.ds
  ...
  %i.aaa = getelementptr inbounds nuw i8, ptr %.5714, i64 12
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %.5714, ptr noundef nonnull align 4 dereferenceable(12) %i.zz, i64 12, i1 false)
  %.not297 = icmp eq ptr %.10602712, null
...
bb.dx:                                            ; preds = %bb.dw
  ...
  store float %i.aac, ptr %.10602712, align 4
  %i.aad = getelementptr inbounds nuw i8, ptr %.sroa.0512.1716, i64 8
  %i.aae = load float, ptr %i.aad, align 4
  %i.aaf = getelementptr inbounds nuw i8, ptr %.10602712, i64 4
  store float %i.aae, ptr %i.aaf, align 4
  %i.aag = getelementptr inbounds nuw i8, ptr %.10602712, i64 12
  br label %bb.dy

bb.dy:                                            ; preds = %bb.dx, %bb.dw
  %.11 = phi ptr [ null, %bb.dw ], [ %i.aag, %bb.dx ] ; 4 uses
  %i.aah = icmp eq i32 %i.zk, %.0261717
...
bb.eb:                                            ; preds = %bb.ea, %bb.dz
  ...
  %i.aao = getelementptr inbounds nuw i8, ptr %.5714, i64 24 ; 2 uses
...
bb.ed:                                            ; preds = %bb.ec, %bb.eb
  ...
  %i.aav = add nuw i32 %.0261717, 1               ; 2 uses
...
_ZN6AssimpL19buildBacksideOfFaceERK6aiFaceRPS0_RP10aiVector3tIfEPKS6_S8_SA_Rj.exit: ; preds = %_ZN6AssimpL19buildBacksideOfFaceERK6aiFaceRPS0_RP10aiVector3tIfEPKS6_S8_SA_Rj.exit402, %bb.cv, %bb.ed, %.preheader, %bb.dq, %_ZN6AssimpL16flipWindingOrderER6aiFace.exit.loopexit.i, %_ZN6AssimpL16flipWindingOrderER6aiFace.exit.thread.i, %._crit_edge708, %bb.cf, %bb.cd
  %.13 = phi ptr [ %.2594.lcssa, %_ZN6AssimpL16flipWindingOrderER6aiFace.exit.thread.i ], [ %.1593725, %bb.cf ], [ %.2594.lcssa, %._crit_edge708 ], [ %.1593725, %bb.cd ], [ %.12, %bb.ed ], [ %.2594.lcssa, %_ZN6AssimpL16flipWindingOrderER6aiFace.exit.loopexit.i ], [ %.15, %bb.cv ], [ %.1593725, %bb.dq ], [ %.1593725, %.preheader ], [ %.9601, %_ZN6AssimpL19buildBacksideOfFaceERK6aiFaceRPS0_RP10aiVector3tIfEPKS6_S8_SA_Rj.exit402 ]
  %.5587 = phi i32 [ %.1583.lcssa, %_ZN6AssimpL16flipWindingOrderER6aiFace.exit.thread.i ], [ %.0582726, %bb.cf ], [ %.1583.lcssa, %._crit_edge708 ], [ %.0582726, %bb.cd ], [ %i.zp, %bb.ed ], [ %.1583.lcssa, %_ZN6AssimpL16flipWindingOrderER6aiFace.exit.loopexit.i ], [ %i.ta, %bb.cv ], [ %.0582726, %bb.dq ], [ %.0582726, %.preheader ], [ %.3585, %_ZN6AssimpL19buildBacksideOfFaceERK6aiFaceRPS0_RP10aiVector3tIfEPKS6_S8_SA_Rj.exit402 ]
  %.6 = phi ptr [ %.1578.lcssa, %_ZN6AssimpL16flipWindingOrderER6aiFace.exit.thread.i ], [ %.0577727, %bb.cf ], [ %.1578.lcssa, %._crit_edge708 ], [ %.0577727, %bb.cd ], [ %i.aao, %bb.ed ], [ %.1578.lcssa, %_ZN6AssimpL16flipWindingOrderER6aiFace.exit.loopexit.i ], [ %i.st, %bb.cv ], [ %.0577727, %bb.dq ], [ %.0577727, %.preheader ], [ %.4581, %_ZN6AssimpL19buildBacksideOfFaceERK6aiFaceRPS0_RP10aiVector3tIfEPKS6_S8_SA_Rj.exit402 ]
  %.4 = phi ptr [ %i.rz, %_ZN6AssimpL16flipWindingOrderER6aiFace.exit.thread.i ], [ %i.pw, %bb.cf ], [ %i.pw, %._crit_edge708 ], [ %.0576728, %bb.cd ], [ %i.zl, %bb.ed ], [ %i.rz, %_ZN6AssimpL16flipWindingOrderER6aiFace.exit.loopexit.i ], [ %i.rz, %bb.cv ], [ %.0576728, %bb.dq ], [ %.0576728, %.preheader ], [ %.2, %_ZN6AssimpL19buildBacksideOfFaceERK6aiFaceRPS0_RP10aiVector3tIfEPKS6_S8_SA_Rj.exit402 ]
