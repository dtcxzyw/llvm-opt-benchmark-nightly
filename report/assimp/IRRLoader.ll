...
bb.bm:                                            ; preds = %.lr.ph566, %bb.bm
  ...
  %i.sb = fmul float %i.rn, 2.000000e+00          ; 4 uses
  ...
  %4 = insertelement <2 x float> poison, float %i.sb, i64 0
  %5 = shufflevector <2 x float> %4, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %6 = insertelement <2 x float> %5, float %i.se, i64 1
