...
begin_hunk_0_@_ZNK6Assimp11X3DImporter40PostprocessHelper_Matrix_GlobalToCurrentEv:bb.a
  ...
  %i.z = extractelement <4 x float> %i.cy, i64 0
  %i.aa = extractelement <4 x float> %i.cy, i64 2
  %i.ab = extractelement <4 x float> %i.cc, i64 0
...
begin_hunk_1_@_ZNK6Assimp11X3DImporter40PostprocessHelper_Matrix_GlobalToCurrentEv:bb.a
  ...
  store float %i.z, ptr %.sroa.21.0..sroa_idx35, align 4
  store float %i.ab, ptr %.sroa.23.0..sroa_idx37, align 4
  store float %i.cz, ptr %.sroa.29.0..sroa_idx43, align 4
  store float %i.cd, ptr %.sroa.31.0..sroa_idx45, align 4
...
begin_hunk_2_@_ZNK6Assimp11X3DImporter40PostprocessHelper_Matrix_GlobalToCurrentEv:bb.a
  ...
  %i.at = phi <4 x float> [ <float 1.000000e+00, float 0.000000e+00, float 0.000000e+00, float 1.000000e+00>, %.lr.ph ], [ %i.db, %bb.e ] ; 4 uses
  ...
  %i.ax = phi <2 x float> [ zeroinitializer, %.lr.ph ], [ %18, %bb.e ] ; 2 uses
  %i.ay = phi <2 x float> [ <float 0.000000e+00, float 1.000000e+00>, %.lr.ph ], [ %19, %bb.e ] ; 2 uses
...
begin_hunk_4_@_ZNK6Assimp11X3DImporter40PostprocessHelper_Matrix_GlobalToCurrentEv:bb.a
  ...
  %3 = shufflevector <4 x float> %i.bi, <4 x float> poison, <2 x i32> zeroinitializer
  %4 = fmul <2 x float> %i.ay, %3
  %5 = shufflevector <4 x float> %i.bj, <4 x float> poison, <2 x i32> zeroinitializer
  %6 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %5, <2 x float> %i.ax, <2 x float> %4)
  %7 = shufflevector <4 x float> %i.bi, <4 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.bw = fmul <2 x float> %i.ay, %7
  %8 = shufflevector <4 x float> %i.bj, <4 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.bx = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %8, <2 x float> %i.ax, <2 x float> %i.bw)
  %i.by = shufflevector <4 x float> %i.bk, <4 x float> poison, <2 x i32> <i32 1, i32 1>
  %9 = shufflevector <4 x float> %i.at, <4 x float> poison, <2 x i32> <i32 0, i32 2>
  %10 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.by, <2 x float> %9, <2 x float> %i.bx)
  %11 = fmul float %i.aq, %i.br
  %12 = call float @llvm.fmuladd.f32(float %i.bs, float %i.ar, float %11)
  %13 = fmul float %i.aq, %i.bt
  %14 = call float @llvm.fmuladd.f32(float %i.bu, float %i.ar, float %13)
  %15 = call float @llvm.fmuladd.f32(float %i.bv, float %i.ap, float %14)
  %i.bz = shufflevector <2 x float> %i.bh, <2 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %i.ca = insertelement <4 x float> poison, float %15, i64 0
  %i.cb = shufflevector <2 x float> %10, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %16 = shufflevector <4 x float> %i.cb, <4 x float> %i.ca, <4 x i32> <i32 0, i32 4, i32 1, i32 0>
  %i.cc = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.bz, <4 x float> %i.as, <4 x float> %16) ; 5 uses
  %i.cd = extractelement <4 x float> %i.cc, i64 1 ; 2 uses
  ...
  %i.cj = shufflevector <2 x float> %6, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %17 = shufflevector <4 x float> %i.cj, <4 x float> %i.ci, <4 x i32> <i32 0, i32 4, i32 1, i32 0>
  %i.ck = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ch, <4 x float> %i.at, <4 x float> %17)
...
begin_hunk_5_@_ZNK6Assimp11X3DImporter40PostprocessHelper_Matrix_GlobalToCurrentEv:bb.a
  ...
  %i.cz = extractelement <4 x float> %i.cy, i64 1 ; 2 uses
  ...
  %18 = shufflevector <4 x float> %i.cy, <4 x float> poison, <2 x i32> <i32 0, i32 2>
  %19 = shufflevector <4 x float> %i.cc, <4 x float> poison, <2 x i32> <i32 0, i32 2>
...
bb.a:
  %2 = insertelement <6 x i32> poison, i32 %1, i64 0 ; 2 uses
  %3 = shufflevector <6 x i32> %2, <6 x i32> poison, <6 x i32> zeroinitializer
  %4 = add <6 x i32> %3, <i32 -7, i32 -15, i32 -19, i32 -24, i32 -11, i32 -31>
  %5 = shufflevector <6 x i32> %2, <6 x i32> poison, <2 x i32> zeroinitializer
  %6 = icmp eq <2 x i32> %5, <i32 18, i32 14>
  %7 = icmp ult <6 x i32> %4, <i32 4, i32 3, i32 2, i32 7, i32 3, i32 2>
  %8 = shufflevector <6 x i1> %7, <6 x i1> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 poison, i32 poison>
  %9 = shufflevector <2 x i1> %6, <2 x i1> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %10 = shufflevector <8 x i1> %8, <8 x i1> %9, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 8, i32 9>
  %i.a = icmp eq i32 %1, 33
  %i.b = bitcast <8 x i1> %10 to i8
