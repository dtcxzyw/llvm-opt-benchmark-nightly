...
bb.l:                                             ; preds = %_ZNK6Assimp21SharedPostProcessInfo11GetPropertyISt6vectorISt4pairINS_11SpatialSortEfESaIS5_EEEEbPKcRPT_.exit
  ...
  %i.dm = getelementptr inbounds nuw [64 x i8], ptr %i.dl, i64 %i.dk ; 3 uses
...
.thread:                                          ; preds = %.noexc, %._crit_edge, %_ZNK6Assimp21SharedPostProcessInfo11GetPropertyISt6vectorISt4pairINS_11SpatialSortEfESaIS5_EEEEbPKcRPT_.exit
...
begin_hunk_1_@_ZN6Assimp23GenVertexNormalsProcess20GenMeshVertexNormalsEP6aiMeshj:bb.a
  ...
  %i.fv = getelementptr inbounds nuw [4 x i8], ptr %i.fb, i64 %i.ft ; 2 uses
...
.lr.ph249:                                        ; preds = %_ZN10aiVector3tIfE13NormalizeSafeEv.exit152, %.lr.ph249
  ...
  %i.go = getelementptr inbounds nuw [4 x i8], ptr %i.fb, i64 %i.gn ; 2 uses
...
begin_hunk_3_@_ZN6Assimp23GenVertexNormalsProcess20GenMeshVertexNormalsEP6aiMeshj:bb.a
  ...
  %i.ih = getelementptr inbounds nuw [4 x i8], ptr %i.ho, i64 %i.if ; 2 uses
