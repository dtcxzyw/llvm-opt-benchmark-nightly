...
bb.ar:                                            ; preds = %_ZNSt6vectorIP10aiNodeAnimSaIS1_EE7reserveEm.exit, %.critedge
  %.sroa.20.0.a = phi ptr [ %i.di, %_ZNSt6vectorIP10aiNodeAnimSaIS1_EE7reserveEm.exit ], [ %.sroa.20.4.a, %.critedge ] ; 9 uses
  %.sroa.12.0 = phi ptr [ %i.dg, %_ZNSt6vectorIP10aiNodeAnimSaIS1_EE7reserveEm.exit ], [ %.sroa.12.2, %.critedge ] ; 4 uses
  %.sroa.0309.0 = phi ptr [ %i.dg, %_ZNSt6vectorIP10aiNodeAnimSaIS1_EE7reserveEm.exit ], [ %.sroa.0309.4, %.critedge ] ; 12 uses
...
begin_hunk_1_@_ZN6Assimp11CSMImporter14InternReadFileERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEP7aiScenePNS_8IOSystemE:._crit_edge.i.i
  ...
  %.not.i.i221 = icmp eq ptr %.sroa.12.0, %.sroa.20.0.a
...
bb.bb:                                            ; preds = %bb.az
  %i.dx = ptrtoint ptr %.sroa.20.0.a to i64
  %i.dy = ptrtoint ptr %.sroa.0309.0 to i64
...
bb.bd:                                            ; preds = %.noexc223
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.eh, ptr align 8 %.sroa.0309.0, i64 %i.dz, i1 false)
...
_ZNSt6vectorIP10aiNodeAnimSaIS1_EE17_M_realloc_insertIJS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i: ; preds = %bb.bd, %.noexc223
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0309.0, i64 noundef %i.dz) #22
...
_ZNSt6vectorIP10aiNodeAnimSaIS1_EE9push_backEOS1_.exit: ; preds = %_ZNSt6vectorIP10aiNodeAnimSaIS1_EE17_M_realloc_insertIJS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i, %bb.ba
  ...
  %.sroa.20.4.a = phi ptr [ %i.ek, %_ZNSt6vectorIP10aiNodeAnimSaIS1_EE17_M_realloc_insertIJS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i ], [ %.sroa.20.0.a, %bb.ba ]
  ...
  %.sroa.0309.4 = phi ptr [ %i.eh, %_ZNSt6vectorIP10aiNodeAnimSaIS1_EE17_M_realloc_insertIJS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i ], [ %.sroa.0309.0, %bb.ba ]
...
bb.bg:                                            ; preds = %.loopexit431.a
  ...
  %i.er = ptrtoint ptr %.sroa.0309.0 to i64       ; 2 uses
...
begin_hunk_6_@_ZN6Assimp11CSMImporter14InternReadFileERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEP7aiScenePNS_8IOSystemE:._crit_edge.i.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %i.fa, ptr nonnull align 8 %.sroa.0309.0, i64 %i.fe, i1 false)
  %i.ff = ptrtoint ptr %.sroa.20.0.a to i64
  %i.fg = sub i64 %i.ff, %i.er
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0309.0, i64 noundef %i.fg) #22
...
bb.bm:                                            ; preds = %.loopexit436.a, %.loopexit.split-lp437, %.loopexit446, %.loopexit.split-lp447, %bb.bj
  %.sroa.20.2.a = phi ptr [ %.sroa.20.0.a, %.loopexit.split-lp447 ], [ %.sroa.20.0.a, %bb.bj ], [ %.sroa.20.1.ph.a, %.loopexit446 ], [ %.sroa.20.0.a, %.loopexit436.a ], [ %.sroa.20.0.a, %.loopexit.split-lp437 ]
  %.sroa.0309.2 = phi ptr [ %.sroa.0309.0, %.loopexit.split-lp447 ], [ %.sroa.0309.0, %bb.bj ], [ %.sroa.0309.1.ph, %.loopexit446 ], [ %.sroa.0309.0, %.loopexit436.a ], [ %.sroa.0309.0, %.loopexit.split-lp437 ] ; 3 uses
  ...
  %.not.i.i.i224 = icmp eq ptr %.sroa.0309.2, null
  br i1 %.not.i.i.i224, label %_ZNSt6vectorIP10aiNodeAnimSaIS1_EED2Ev.exit225, label %.thread

.thread:                                          ; preds = %bb.bm
  %i.fh = ptrtoint ptr %.sroa.20.2.a to i64
  %i.fi = ptrtoint ptr %.sroa.0309.2 to i64
  %i.fj = sub i64 %i.fh, %i.fi
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0309.2, i64 noundef %i.fj) #22
...
begin_hunk_7_@_ZN6Assimp11CSMImporter14InternReadFileERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEP7aiScenePNS_8IOSystemE:._crit_edge.i.i
  ...
  %.0111 = phi i32 [ %i.jb, %._crit_edge ], [ 0, %.loopexit434.preheader ] ; 2 uses
  %.1107 = phi i32 [ %spec.select, %._crit_edge ], [ %.1107.ph, %.loopexit434.preheader ] ; 5 uses
...
begin_hunk_9_@_ZN6Assimp11CSMImporter14InternReadFileERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEP7aiScenePNS_8IOSystemE:._crit_edge.i.i
  ...
  %i.iz = icmp eq i32 %.0111, %.1107
  %i.ja = zext i1 %i.iz to i32
  %spec.select = shl i32 %.1107, %i.ja
  %i.jb = add i32 %.0111, 1
