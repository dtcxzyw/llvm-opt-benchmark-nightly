...
bb.gs:                                            ; preds = %bb.gp, %bb.gq, %bb.gr
  %14 = load <4 x float>, ptr %i.aga, align 8
  %15 = load <4 x float>, ptr %i.agb, align 4
  %16 = load <4 x float>, ptr %i.ahi, align 8
  %17 = load <4 x float>, ptr %i.aho, align 4
  %18 = load <4 x float>, ptr %i.ahu, align 8
  %19 = load <4 x float>, ptr %i.agc, align 4
  %20 = load <4 x float>, ptr %i.agd, align 8
  %21 = load <4 x float>, ptr %i.aik, align 4
  %22 = load <4 x float>, ptr %i.aiq, align 8
  %23 = load <4 x float>, ptr %i.aiw, align 4
  %24 = load <4 x float>, ptr %i.age, align 8
  %25 = load <4 x float>, ptr %i.agf, align 4
  %i.akf = getelementptr inbounds nuw i8, ptr %i.afz, i64 1104 ; 2 uses
  %26 = load <4 x float>, ptr %i.akf, align 8
  ...
  %i.akp = shufflevector <4 x float> %15, <4 x float> poison, <4 x i32> zeroinitializer
  %i.akq = fmul <4 x float> %i.akm, %i.akp
  %i.akr = shufflevector <4 x float> %14, <4 x float> poison, <4 x i32> zeroinitializer
  %i.aks = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.akl, <4 x float> %i.akr, <4 x float> %i.akq)
  %i.akt = shufflevector <4 x float> %16, <4 x float> poison, <4 x i32> zeroinitializer
  %i.aku = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.akn, <4 x float> %i.akt, <4 x float> %i.aks)
  %i.akv = shufflevector <4 x float> %17, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.akx = shufflevector <4 x float> %19, <4 x float> poison, <4 x i32> zeroinitializer
  %i.aky = fmul <4 x float> %i.akm, %i.akx
  %i.akz = shufflevector <4 x float> %18, <4 x float> poison, <4 x i32> zeroinitializer
  %i.ala = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.akl, <4 x float> %i.akz, <4 x float> %i.aky)
  %i.alb = shufflevector <4 x float> %20, <4 x float> poison, <4 x i32> zeroinitializer
  %i.alc = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.akn, <4 x float> %i.alb, <4 x float> %i.ala)
  %i.ald = shufflevector <4 x float> %21, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.alf = shufflevector <4 x float> %23, <4 x float> poison, <4 x i32> zeroinitializer
  %i.alg = fmul <4 x float> %i.akm, %i.alf
  %i.alh = shufflevector <4 x float> %22, <4 x float> poison, <4 x i32> zeroinitializer
  %i.ali = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.akl, <4 x float> %i.alh, <4 x float> %i.alg)
  %i.alj = shufflevector <4 x float> %24, <4 x float> poison, <4 x i32> zeroinitializer
  %i.alk = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.akn, <4 x float> %i.alj, <4 x float> %i.ali)
  %i.all = shufflevector <4 x float> %25, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.alq = shufflevector <4 x float> %26, <4 x float> poison, <4 x i32> zeroinitializer
