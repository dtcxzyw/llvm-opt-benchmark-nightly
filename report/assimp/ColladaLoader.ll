...
bb.z:                                             ; preds = %bb.y
  %i.hk = load ptr, ptr %i.fh, align 8            ; 16 uses
  %i.hl = getelementptr inbounds nuw i8, ptr %i.hk, i64 1028 ; 2 uses
  %i.hm = load float, ptr %i.hl, align 4
  %6 = getelementptr inbounds nuw i8, ptr %i.hk, i64 1032
  %7 = getelementptr inbounds nuw i8, ptr %i.hk, i64 1036
  %i.hn = getelementptr inbounds nuw i8, ptr %i.hk, i64 1040
  %i.ho = getelementptr inbounds nuw i8, ptr %i.hk, i64 1044 ; 2 uses
  %i.hp = load float, ptr %i.ho, align 4
  %8 = getelementptr inbounds nuw i8, ptr %i.hk, i64 1048
  %9 = getelementptr inbounds nuw i8, ptr %i.hk, i64 1052
  %i.hq = getelementptr inbounds nuw i8, ptr %i.hk, i64 1056
  %i.hr = getelementptr inbounds nuw i8, ptr %i.hk, i64 1060 ; 2 uses
  %i.hs = load float, ptr %i.hr, align 4
  %10 = getelementptr inbounds nuw i8, ptr %i.hk, i64 1064
  %11 = getelementptr inbounds nuw i8, ptr %i.hk, i64 1068
  %i.ht = getelementptr inbounds nuw i8, ptr %i.hk, i64 1072
  %i.hu = getelementptr inbounds nuw i8, ptr %i.hk, i64 1076 ; 2 uses
  %i.hv = load float, ptr %i.hu, align 4
  %12 = getelementptr inbounds nuw i8, ptr %i.hk, i64 1080
  %13 = getelementptr inbounds nuw i8, ptr %i.hk, i64 1084
  %i.hw = getelementptr inbounds nuw i8, ptr %i.hk, i64 1088
  %14 = load float, ptr %6, align 4
  %15 = load float, ptr %7, align 4
  %16 = load float, ptr %i.hn, align 4
  %17 = insertelement <4 x float> poison, float %14, i64 0
  %i.hx = shufflevector <4 x float> %17, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.id = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %19, <4 x float> <float 0.000000e+00, float 0.000000e+00, float 1.000000e+00, float 0.000000e+00>, <4 x float> %i.ic)
  %20 = insertelement <4 x float> poison, float %16, i64 0
  %21 = shufflevector <4 x float> %20, <4 x float> poison, <4 x i32> zeroinitializer
  %i.ie = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %21, <4 x float> <float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 1.000000e+00>, <4 x float> %i.id)
  store <4 x float> %i.ie, ptr %i.hl, align 4
  %22 = load float, ptr %8, align 4
  %23 = load float, ptr %9, align 4
  %24 = load float, ptr %i.hq, align 4
  %25 = insertelement <4 x float> poison, float %22, i64 0
  %i.if = shufflevector <4 x float> %25, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.il = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %27, <4 x float> <float 0.000000e+00, float 0.000000e+00, float 1.000000e+00, float 0.000000e+00>, <4 x float> %i.ik)
  %28 = insertelement <4 x float> poison, float %24, i64 0
  %29 = shufflevector <4 x float> %28, <4 x float> poison, <4 x i32> zeroinitializer
  %i.im = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %29, <4 x float> <float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 1.000000e+00>, <4 x float> %i.il)
  store <4 x float> %i.im, ptr %i.ho, align 4
  %30 = load float, ptr %10, align 4
  %31 = load float, ptr %11, align 4
  %32 = load float, ptr %i.ht, align 4
  %33 = insertelement <4 x float> poison, float %30, i64 0
  %i.in = shufflevector <4 x float> %33, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %34 = insertelement <4 x float> poison, float %31, i64 0
  %35 = shufflevector <4 x float> %34, <4 x float> poison, <4 x i32> zeroinitializer
  %i.it = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %35, <4 x float> <float 0.000000e+00, float 0.000000e+00, float 1.000000e+00, float 0.000000e+00>, <4 x float> %i.is)
  %36 = insertelement <4 x float> poison, float %32, i64 0
  %37 = shufflevector <4 x float> %36, <4 x float> poison, <4 x i32> zeroinitializer
  %i.iu = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %37, <4 x float> <float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 1.000000e+00>, <4 x float> %i.it)
  store <4 x float> %i.iu, ptr %i.hr, align 4
  %38 = load float, ptr %12, align 4
  %39 = load float, ptr %13, align 4
  %40 = load float, ptr %i.hw, align 4
  %41 = insertelement <4 x float> poison, float %38, i64 0
  %i.iv = shufflevector <4 x float> %41, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %42 = insertelement <4 x float> poison, float %39, i64 0
  %43 = shufflevector <4 x float> %42, <4 x float> poison, <4 x i32> zeroinitializer
  %i.jb = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %43, <4 x float> <float 0.000000e+00, float 0.000000e+00, float 1.000000e+00, float 0.000000e+00>, <4 x float> %i.ja)
  %44 = insertelement <4 x float> poison, float %40, i64 0
  %45 = shufflevector <4 x float> %44, <4 x float> poison, <4 x i32> zeroinitializer
  %i.jc = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %45, <4 x float> <float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 1.000000e+00>, <4 x float> %i.jb)
