...
.lr.ph.i.preheader:                               ; preds = %bb.f
  ...
  br i1 %min.iters.check, label %.lr.ph.i.preheader1558, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi1425 = phi <2 x i64> [ zeroinitializer, %vector.ph ], [ %i.ay, %vector.body ]
  ...
  %wide.load1426 = load <2 x i64>, ptr %i.au, align 8
  %i.av = freeze <2 x i64> %wide.load
  %i.aw = freeze <2 x i64> %wide.load1426
  %i.ax = add <2 x i64> %i.av, %vec.phi           ; 2 uses
  %i.ay = add <2 x i64> %i.aw, %vec.phi1425       ; 2 uses
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPKmSt6vectorImSaImEEEEmET0_T_S9_S8_.exit, label %.lr.ph.i.preheader1558

.lr.ph.i.preheader1558:                           ; preds = %.lr.ph.i.preheader, %middle.block
  %.07.i.ph = phi i64 [ 0, %.lr.ph.i.preheader ], [ %i.ba, %middle.block ]
  %.sroa.02.06.i.ph = phi ptr [ %i.ak, %.lr.ph.i.preheader ], [ %i.as, %middle.block ]
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader1558, %.lr.ph.i
  %.07.i = phi i64 [ %i.bc, %.lr.ph.i ], [ %.07.i.ph, %.lr.ph.i.preheader1558 ]
  %.sroa.02.06.i = phi ptr [ %i.bd, %.lr.ph.i ], [ %.sroa.02.06.i.ph, %.lr.ph.i.preheader1558 ] ; 2 uses
...
bb.g:                                             ; preds = %_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPKmSt6vectorImSaImEEEEmET0_T_S9_S8_.exit
  ...
  br i1 %i.bk, label %.thread1174, label %.loopexit709

.thread1174:                                      ; preds = %bb.g
...
_ZSt4copyIN9__gnu_cxx17__normal_iteratorIPK10aiVector3tIfESt6vectorIS3_SaIS3_EEEEPS3_ET0_T_SC_SB_.exit: ; preds = %.thread1174, %bb.j, %bb.i, %bb.h
  %i.bs = phi i1 [ false, %bb.j ], [ false, %bb.i ], [ true, %bb.h ], [ false, %.thread1174 ] ; 14 uses
...
_ZNSt6vectorIP10aiAnimMeshSaIS1_EED2Ev.exit:      ; preds = %._crit_edge897, %._crit_edge950.thread, %._crit_edge950, %bb.ea, %._crit_edge930
  %.sroa.0623.0.lcssa1193 = phi ptr [ %.sroa.0623.2, %._crit_edge930 ], [ %.sroa.0623.2, %._crit_edge950.thread ], [ %.sroa.0623.2, %._crit_edge950 ], [ %.sroa.0623.2, %bb.ea ], [ null, %._crit_edge897 ] ; 14 uses
  %.sroa.20636.0.lcssa1191 = phi ptr [ %.sroa.20636.2, %._crit_edge930 ], [ %.sroa.20636.2, %._crit_edge950.thread ], [ %.sroa.20636.2, %._crit_edge950 ], [ %.sroa.20636.2, %bb.ea ], [ null, %._crit_edge897 ] ; 12 uses
  %.sroa.0613.0.lcssa1189 = phi ptr [ %.sroa.0613.2, %._crit_edge930 ], [ %.sroa.0613.2, %._crit_edge950.thread ], [ %.sroa.0613.2, %._crit_edge950 ], [ %.sroa.0613.2, %bb.ea ], [ null, %._crit_edge897 ] ; 14 uses
  %.sroa.15620.0.lcssa1187 = phi ptr [ %.sroa.15620.2, %._crit_edge930 ], [ %.sroa.15620.2, %._crit_edge950.thread ], [ %.sroa.15620.2, %._crit_edge950 ], [ %.sroa.15620.2, %bb.ea ], [ null, %._crit_edge897 ] ; 12 uses
...
_ZNSt12_Vector_baseISt6vectorI14aiVertexWeightSaIS1_EESaIS3_EEC2EmRKS4_.exit.thread.i: ; preds = %_ZNSt6vectorIS_I14aiVertexWeightSaIS0_EESaIS2_EE17_S_check_init_lenEmRKS3_.exit.i, %.noexc523
  %.pre1094 = phi ptr [ %i.zc, %.noexc523 ], [ null, %_ZNSt6vectorIS_I14aiVertexWeightSaIS0_EESaIS2_EE17_S_check_init_lenEmRKS3_.exit.i ] ; 3 uses
  %.sink.i = phi ptr [ %i.zd, %.noexc523 ], [ null, %_ZNSt6vectorIS_I14aiVertexWeightSaIS0_EESaIS2_EE17_S_check_init_lenEmRKS3_.exit.i ]
  %i.ze = phi ptr [ %scevgep.i.i.i.i.i, %.noexc523 ], [ null, %_ZNSt6vectorIS_I14aiVertexWeightSaIS0_EESaIS2_EE17_S_check_init_lenEmRKS3_.exit.i ] ; 3 uses
  %i.zf = getelementptr inbounds nuw i8, ptr %8, i64 8 ; 2 uses
  %i.zg = getelementptr inbounds nuw i8, ptr %8, i64 16 ; 2 uses
  store ptr %.sink.i, ptr %i.zg, align 8
  store ptr %i.ze, ptr %i.zf, align 8
  ...
  %.not1173 = icmp eq ptr %i.zj, %i.zk
  br i1 %.not1173, label %_ZNSt6vectorIN9__gnu_cxx17__normal_iteratorIPKSt4pairImmES_IS3_SaIS3_EEEESaIS8_EE6resizeEmRKS8_.exit.thread, label %bb.fr
...
_ZNSt6vectorIN9__gnu_cxx17__normal_iteratorIPKSt4pairImmES_IS3_SaIS3_EEEESaIS8_EE6resizeEmRKS8_.exit: ; preds = %bb.fr
  %.pre1091 = load ptr, ptr %i.zi, align 8
  %.pre1092 = load ptr, ptr %i.zh, align 8
  %i.zs = icmp eq ptr %.pre1091, %.pre1092
  call void @llvm.lifetime.end.p0(ptr nonnull %10) #26
  br i1 %i.zs, label %.preheader, label %.lr.ph953.preheader
...
.preheader:                                       ; preds = %.lr.ph953, %_ZNSt6vectorIN9__gnu_cxx17__normal_iteratorIPKSt4pairImmES_IS3_SaIS3_EEEESaIS8_EE6resizeEmRKS8_.exit.thread, %_ZNSt6vectorIN9__gnu_cxx17__normal_iteratorIPKSt4pairImmES_IS3_SaIS3_EEEESaIS8_EE6resizeEmRKS8_.exit
  ...
  br i1 %i.zu, label %.lr.ph960, label %._crit_edge961
...
.lr.ph953:                                        ; preds = %.lr.ph953.preheader, %.lr.ph953
  %.0370952 = phi i64 [ %i.aaj, %.lr.ph953 ], [ 0, %.lr.ph953.preheader ] ; 3 uses
  %.sroa.0577.0951 = phi ptr [ %i.aai, %.lr.ph953 ], [ %i.zt, %.lr.ph953.preheader ] ; 2 uses
  %i.aac = load ptr, ptr %9, align 8
  %i.aad = getelementptr inbounds nuw [8 x i8], ptr %i.aac, i64 %.0370952
  %i.aae = ptrtoint ptr %.sroa.0577.0951 to i64
  store i64 %i.aae, ptr %i.aad, align 8
  %i.aaf = load ptr, ptr %i.zh, align 8           ; 2 uses
  %i.aag = getelementptr inbounds nuw [8 x i8], ptr %i.aaf, i64 %.0370952
  %i.aah = load i64, ptr %i.aag, align 8
  %i.aai = getelementptr inbounds [16 x i8], ptr %.sroa.0577.0951, i64 %i.aah
  %i.aaj = add nuw i64 %.0370952, 1               ; 2 uses
  ...
  br i1 %i.aap, label %.lr.ph953, label %.preheader, !llvm.loop !92

._crit_edge961:                                   ; preds = %._crit_edge958, %.preheader
  %.not674962 = icmp eq ptr %.pre1094, %i.ze
...
.lr.ph966:                                        ; preds = %._crit_edge961
  ...
  %i.aat = load i8, ptr %i.aas, align 1, !range !9
  %i.aau = xor i8 %i.aat, 1
  %i.aav = zext nneg i8 %i.aau to i64
  br label %bb.gc

bb.fu:                                            ; preds = %.lr.ph960, %._crit_edge958
  %.0369959 = phi i64 [ %5, %.lr.ph960 ], [ %i.abi, %._crit_edge958 ] ; 3 uses
  %i.aaw = load ptr, ptr %i.zv, align 8
  %i.aax = getelementptr inbounds nuw [8 x i8], ptr %i.aaw, i64 %.0369959
  %i.aay = load i64, ptr %i.aax, align 8          ; 2 uses
  %i.aaz = load ptr, ptr %i.zh, align 8
  %i.aba = getelementptr inbounds nuw [8 x i8], ptr %i.aaz, i64 %i.aay
  %i.abb = load i64, ptr %i.aba, align 8          ; 2 uses
  %.not979 = icmp eq i64 %i.abb, 0
  br i1 %.not979, label %._crit_edge958, label %.lr.ph957

.lr.ph957:                                        ; preds = %bb.fu
  %i.abc = load ptr, ptr %9, align 8
  %i.abd = getelementptr inbounds nuw [8 x i8], ptr %i.abc, i64 %i.aay
  %i.abe = load i64, ptr %i.abd, align 8
  %i.abf = inttoptr i64 %i.abe to ptr
  %i.abg = sub nuw i64 %.0369959, %5
  %i.abh = trunc i64 %i.abg to i32                ; 2 uses
  br label %bb.fv

._crit_edge958:                                   ; preds = %_ZNSt6vectorI14aiVertexWeightSaIS0_EE9push_backERKS0_.exit, %bb.fu
  %i.abi = add nuw i64 %.0369959, 1               ; 2 uses
  %exitcond1088.not = icmp eq i64 %i.abi, %i.cb
...
bb.fv:                                            ; preds = %.lr.ph957, %_ZNSt6vectorI14aiVertexWeightSaIS0_EE9push_backERKS0_.exit
  %.0364955 = phi i64 [ 0, %.lr.ph957 ], [ %i.adg, %_ZNSt6vectorI14aiVertexWeightSaIS0_EE9push_backERKS0_.exit ]
  %.sroa.0574.0954 = phi ptr [ %i.abf, %.lr.ph957 ], [ %i.adh, %_ZNSt6vectorI14aiVertexWeightSaIS0_EE9push_backERKS0_.exit ] ; 3 uses
  %i.abj = load i64, ptr %.sroa.0574.0954, align 8
  %i.abk = load ptr, ptr %i.zw, align 8           ; 2 uses
  %i.abl = load ptr, ptr %i.zx, align 8
  %i.abm = icmp eq ptr %i.abk, %i.abl
  br i1 %i.abm, label %.thread, label %bb.fw

bb.fw:                                            ; preds = %bb.fv
  %i.abn = getelementptr inbounds nuw i8, ptr %.sroa.0574.0954, i64 8
  %i.abo = load i64, ptr %i.abn, align 8
  %.val = load i64, ptr %i.zy, align 8
  %.val446 = load i64, ptr %i.zz, align 8
  %i.abp = mul i64 %.val446, %i.abo
  %i.abq = getelementptr [4 x i8], ptr %i.abk, i64 %i.abp
  %i.abr = getelementptr [4 x i8], ptr %i.abq, i64 %.val
  %i.abs = load float, ptr %i.abr, align 4        ; 2 uses
  %i.abt = fcmp ogt float %i.abs, 0.000000e+00
  br i1 %i.abt, label %.thread, label %_ZNSt6vectorI14aiVertexWeightSaIS0_EE9push_backERKS0_.exit

.thread:                                          ; preds = %bb.fv, %bb.fw
  %.0361660 = phi float [ %i.abs, %bb.fw ], [ 1.000000e+00, %bb.fv ] ; 2 uses
  %i.abu = getelementptr inbounds nuw [24 x i8], ptr %.pre1094, i64 %i.abj ; 4 uses
  %i.abv = getelementptr inbounds nuw i8, ptr %i.abu, i64 8 ; 4 uses
  %i.abw = load ptr, ptr %i.abv, align 8          ; 6 uses
  %i.abx = getelementptr inbounds nuw i8, ptr %i.abu, i64 16 ; 2 uses
  %i.aby = load ptr, ptr %i.abx, align 8
  %.not.i526 = icmp eq ptr %i.abw, %i.aby
  br i1 %.not.i526, label %bb.fy, label %bb.fx

bb.fx:                                            ; preds = %.thread
  store i32 %i.abh, ptr %i.abw, align 4
  %.sroa_idx568 = getelementptr inbounds nuw i8, ptr %i.abw, i64 4
  store float %.0361660, ptr %.sroa_idx568, align 4
  %i.abz = load ptr, ptr %i.abv, align 8
  %i.aca = getelementptr inbounds nuw i8, ptr %i.abz, i64 8
  store ptr %i.aca, ptr %i.abv, align 8
  br label %_ZNSt6vectorI14aiVertexWeightSaIS0_EE9push_backERKS0_.exit

bb.fy:                                            ; preds = %.thread
  %i.acb = load ptr, ptr %i.abu, align 8          ; 7 uses
  %i.acc = ptrtoint ptr %i.abw to i64             ; 2 uses
  %i.acd = ptrtoint ptr %i.acb to i64             ; 3 uses
  %i.ace = sub i64 %i.acc, %i.acd                 ; 4 uses
  %i.acf = icmp eq i64 %i.ace, 9223372036854775800
  br i1 %i.acf, label %bb.fz, label %_ZNKSt6vectorI14aiVertexWeightSaIS0_EE12_M_check_lenEmPKc.exit.i.i
...
_ZNKSt6vectorI14aiVertexWeightSaIS0_EE12_M_check_lenEmPKc.exit.i.i: ; preds = %bb.fy
  %i.acg = ashr exact i64 %i.ace, 3               ; 3 uses
  %.sroa.speculated.i.i.i527 = call i64 @llvm.umax.i64(i64 %i.acg, i64 1)
  %i.ach = add nsw i64 %.sroa.speculated.i.i.i527, %i.acg ; 2 uses
  %i.aci = icmp ult i64 %i.ach, %i.acg
  %i.acj = call i64 @llvm.umin.i64(i64 %i.ach, i64 1152921504606846975)
  %i.ack = select i1 %i.aci, i64 1152921504606846975, i64 %i.acj ; 3 uses
  %.not.i.i.i528 = icmp ne i64 %i.ack, 0
  call void @llvm.assume(i1 %.not.i.i.i528)
  %i.acl = shl nuw nsw i64 %i.ack, 3
  %i.acm = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.acl) #30
...
.noexc531:                                        ; preds = %_ZNKSt6vectorI14aiVertexWeightSaIS0_EE12_M_check_lenEmPKc.exit.i.i
  %i.acn = getelementptr inbounds nuw i8, ptr %i.acm, i64 %i.ace ; 2 uses
  store i32 %i.abh, ptr %i.acn, align 4
  %.sroa_idx570 = getelementptr inbounds nuw i8, ptr %i.acn, i64 4
  store float %.0361660, ptr %.sroa_idx570, align 4
  %.not10.i.i.i.i.i = icmp eq ptr %i.acb, %i.abw
...
.lr.ph.i.i.i.i.i.preheader:                       ; preds = %.noexc531
  %i.aco = ptrtoaddr ptr %i.acm to i64
  %i.acp = sub i64 %i.acc, %i.acd
  %i.acq = add i64 %i.acp, -8                     ; 2 uses
  %i.acr = lshr i64 %i.acq, 3
  %i.acs = add nuw nsw i64 %i.acr, 1              ; 2 uses
  %min.iters.check1428 = icmp ult i64 %i.acq, 24
  %i.act = sub i64 %i.aco, %i.acd
  %diff.check = icmp ult i64 %i.act, 32
  %or.cond = or i1 %min.iters.check1428, %diff.check
  br i1 %or.cond, label %.lr.ph.i.i.i.i.i.preheader1445, label %vector.ph1429

vector.ph1429:                                    ; preds = %.lr.ph.i.i.i.i.i.preheader
  %n.vec1431 = and i64 %i.acs, 4611686018427387900 ; 3 uses
  %i.acu = shl i64 %n.vec1431, 3                  ; 2 uses
  %i.acv = getelementptr i8, ptr %i.acm, i64 %i.acu ; 2 uses
  %i.acw = getelementptr i8, ptr %i.acb, i64 %i.acu
  br label %vector.body1432

vector.body1432:                                  ; preds = %vector.body1432, %vector.ph1429
  %index1433 = phi i64 [ 0, %vector.ph1429 ], [ %index.next1438, %vector.body1432 ] ; 2 uses
  %i.acx = shl i64 %index1433, 3                  ; 2 uses
  %next.gep1434.a = getelementptr i8, ptr %i.acm, i64 %i.acx ; 2 uses
  %next.gep1435 = getelementptr i8, ptr %i.acb, i64 %i.acx ; 2 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !94)
  call void @llvm.experimental.noalias.scope.decl(metadata !97)
  %i.acy = getelementptr i8, ptr %next.gep1435, i64 16
  %wide.load1436.a = load <2 x i64>, ptr %next.gep1435, align 4, !alias.scope !97, !noalias !94
  %wide.load1437 = load <2 x i64>, ptr %i.acy, align 4, !alias.scope !97, !noalias !94
  %i.acz = getelementptr i8, ptr %next.gep1434.a, i64 16
  store <2 x i64> %wide.load1436.a, ptr %next.gep1434.a, align 4, !alias.scope !94, !noalias !97
  store <2 x i64> %wide.load1437, ptr %i.acz, align 4, !alias.scope !94, !noalias !97
  %index.next1438 = add nuw i64 %index1433, 4     ; 2 uses
  %i.ada = icmp eq i64 %index.next1438, %n.vec1431
  br i1 %i.ada, label %middle.block1439, label %vector.body1432, !llvm.loop !99

middle.block1439:                                 ; preds = %vector.body1432
  %cmp.n1440 = icmp eq i64 %i.acs, %n.vec1431
  br i1 %cmp.n1440, label %_ZNSt6vectorI14aiVertexWeightSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit22.i.i, label %.lr.ph.i.i.i.i.i.preheader1445

.lr.ph.i.i.i.i.i.preheader1445:                   ; preds = %.lr.ph.i.i.i.i.i.preheader, %middle.block1439
  %.012.i.i.i.i.i.ph = phi ptr [ %i.acm, %.lr.ph.i.i.i.i.i.preheader ], [ %i.acv, %middle.block1439 ]
  %.0911.i.i.i.i.i.ph = phi ptr [ %i.acb, %.lr.ph.i.i.i.i.i.preheader ], [ %i.acw, %middle.block1439 ]
  br label %.lr.ph.i.i.i.i.i

.lr.ph.i.i.i.i.i:                                 ; preds = %.lr.ph.i.i.i.i.i.preheader1445, %.lr.ph.i.i.i.i.i
  %.012.i.i.i.i.i = phi ptr [ %i.add, %.lr.ph.i.i.i.i.i ], [ %.012.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.preheader1445 ] ; 2 uses
  %.0911.i.i.i.i.i = phi ptr [ %i.adc, %.lr.ph.i.i.i.i.i ], [ %.0911.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.preheader1445 ] ; 2 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !94)
  call void @llvm.experimental.noalias.scope.decl(metadata !97)
  %i.adb = load i64, ptr %.0911.i.i.i.i.i, align 4, !alias.scope !97, !noalias !94
  store i64 %i.adb, ptr %.012.i.i.i.i.i, align 4, !alias.scope !94, !noalias !97
  %i.adc = getelementptr inbounds nuw i8, ptr %.0911.i.i.i.i.i, i64 8 ; 2 uses
  %i.add = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i.i, i64 8 ; 2 uses
  %.not.i.i.i.i.i = icmp eq ptr %i.adc, %i.abw
...
_ZNSt6vectorI14aiVertexWeightSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit22.i.i: ; preds = %.lr.ph.i.i.i.i.i, %middle.block1439, %.noexc531
  %.0.lcssa.i.i.i.i.i529 = phi ptr [ %i.acm, %.noexc531 ], [ %i.acv, %middle.block1439 ], [ %i.add, %.lr.ph.i.i.i.i.i ]
  %i.ade = getelementptr inbounds nuw i8, ptr %.0.lcssa.i.i.i.i.i529, i64 8
  %.not.i23.i.i = icmp eq ptr %i.acb, null
...
bb.ga:                                            ; preds = %_ZNSt6vectorI14aiVertexWeightSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit22.i.i
  call void @_ZdlPvm(ptr noundef nonnull %i.acb, i64 noundef %i.ace) #27
...
_ZNSt6vectorI14aiVertexWeightSaIS0_EE17_M_realloc_insertIJRKS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i: ; preds = %bb.ga, %_ZNSt6vectorI14aiVertexWeightSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit22.i.i
  store ptr %i.acm, ptr %i.abu, align 8
  store ptr %i.ade, ptr %i.abv, align 8
  %i.adf = getelementptr inbounds nuw [8 x i8], ptr %i.acm, i64 %i.ack
  store ptr %i.adf, ptr %i.abx, align 8
  br label %_ZNSt6vectorI14aiVertexWeightSaIS0_EE9push_backERKS0_.exit
...
_ZNSt6vectorI14aiVertexWeightSaIS0_EE9push_backERKS0_.exit: ; preds = %bb.fx, %_ZNSt6vectorI14aiVertexWeightSaIS0_EE17_M_realloc_insertIJRKS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i, %bb.fw
  %i.adg = add nuw i64 %.0364955, 1               ; 2 uses
  %i.adh = getelementptr inbounds nuw i8, ptr %.sroa.0574.0954, i64 16
  %exitcond1087.not = icmp eq i64 %i.adg, %i.abb
  br i1 %exitcond1087.not, label %._crit_edge958, label %bb.fv, !llvm.loop !101

._crit_edge967:                                   ; preds = %bb.gc
  %i.adi = trunc i64 %.1360 to i32
  %i.adj = load ptr, ptr %7, align 8              ; 2 uses
  %i.adk = getelementptr inbounds nuw i8, ptr %i.adj, i64 216
  store i32 %i.adi, ptr %i.adk, align 8
  %i.adl = icmp ugt i64 %.1360, 2305843009213693951
  %i.adm = shl i64 %.1360, 3
  %spec.select = select i1 %i.adl, i64 -1, i64 %i.adm
  br label %bb.gb

bb.gb:                                            ; preds = %._crit_edge967, %._crit_edge967.thread
  %i.adn = phi ptr [ %i.aaq, %._crit_edge967.thread ], [ %i.adj, %._crit_edge967 ]
  %i.ado = phi i64 [ 0, %._crit_edge967.thread ], [ %spec.select, %._crit_edge967 ]
  %i.adp = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %i.ado) #30
          to label %bb.gd unwind label %bb.gh

bb.gc:                                            ; preds = %.lr.ph966, %bb.gc
  %.0359964 = phi i64 [ 0, %.lr.ph966 ], [ %.1360, %bb.gc ]
  %.sroa.0565.0963 = phi ptr [ %.pre1094, %.lr.ph966 ], [ %i.adu, %bb.gc ] ; 3 uses
  %i.adq = load ptr, ptr %.sroa.0565.0963, align 8
  %i.adr = getelementptr inbounds nuw i8, ptr %.sroa.0565.0963, i64 8
  %i.ads = load ptr, ptr %i.adr, align 8
  %i.adt = icmp eq ptr %i.adq, %i.ads
  %not.or.cond = select i1 %i.adt, i64 %i.aav, i64 1
  %not.or.cond.fr = freeze i64 %not.or.cond
  %.1360 = add i64 %not.or.cond.fr, %.0359964     ; 4 uses
  %i.adu = getelementptr inbounds nuw i8, ptr %.sroa.0565.0963, i64 24 ; 2 uses
  %.not674 = icmp eq ptr %i.adu, %i.ze
  br i1 %.not674, label %._crit_edge967, label %bb.gc

bb.gd:                                            ; preds = %bb.gb
  %i.adv = getelementptr inbounds nuw i8, ptr %i.adn, i64 224
  store ptr %i.adp, ptr %i.adv, align 8
...
._crit_edge973:                                   ; preds = %bb.hg, %bb.gd
  ...
  %.not.i.i.i532 = icmp eq ptr %i.aen, null
...
_ZNSt6vectorIN9__gnu_cxx17__normal_iteratorIPKSt4pairImmES_IS3_SaIS3_EEEESaIS8_EED2Ev.exit: ; preds = %._crit_edge973, %bb.ge
  ...
  %.not4.i.i.i = icmp eq ptr %14, %i.aet
...
.lr.ph.i.i.i:                                     ; preds = %_ZNSt6vectorIN9__gnu_cxx17__normal_iteratorIPKSt4pairImmES_IS3_SaIS3_EEEESaIS8_EED2Ev.exit, %_ZSt8_DestroyISt6vectorI14aiVertexWeightSaIS1_EEEvPT_.exit.i.i.i
  %.05.i.i.i = phi ptr [ %i.afa, %_ZSt8_DestroyISt6vectorI14aiVertexWeightSaIS1_EEEvPT_.exit.i.i.i ], [ %14, %_ZNSt6vectorIN9__gnu_cxx17__normal_iteratorIPKSt4pairImmES_IS3_SaIS3_EEEESaIS8_EED2Ev.exit ] ; 3 uses
  %i.aeu = load ptr, ptr %.05.i.i.i, align 8      ; 3 uses
  %.not.i.i.i.i.i.i.i533 = icmp eq ptr %i.aeu, null
...
_ZSt8_DestroyISt6vectorI14aiVertexWeightSaIS1_EEEvPT_.exit.i.i.i: ; preds = %bb.gf, %.lr.ph.i.i.i
  ...
  %.not.i.i.i534 = icmp eq ptr %i.afa, %i.aet
...
bb.gg:                                            ; preds = %_ZSt8_DestroyIPSt6vectorI14aiVertexWeightSaIS1_EES3_EvT_S5_RSaIT0_E.exit.i
  ...
  %i.afd = ptrtoint ptr %14 to i64
  %i.afe = sub i64 %i.afc, %i.afd
  call void @_ZdlPvm(ptr noundef nonnull %14, i64 noundef %i.afe) #27
...
bb.gi:                                            ; preds = %.lr.ph972, %bb.hg
  %.0355970 = phi i64 [ 0, %.lr.ph972 ], [ %i.anv, %bb.hg ] ; 15 uses
  %.0355970.a = phi i64 [ 0, %.lr.ph972 ], [ %.1357, %bb.hg ] ; 3 uses
  %15 = load ptr, ptr %8, align 8
  %i.afg = getelementptr inbounds nuw [24 x i8], ptr %15, i64 %.0355970 ; 4 uses
  ...
  %i.afk = icmp eq ptr %i.afh, %i.afj
  %i.afl = load i8, ptr %i.adw, align 1, !range !9
  %i.afm = trunc nuw i8 %i.afl to i1
  %or.cond445 = select i1 %i.afk, i1 %i.afm, i1 false
  br i1 %or.cond445, label %bb.hg, label %bb.gj

bb.gj:                                            ; preds = %bb.gi
  %i.afn = invoke noalias noundef nonnull dereferenceable(1120) ptr @_Znwm(i64 noundef 1120) #30
          to label %bb.gk unwind label %bb.gy     ; 24 uses

bb.gk:                                            ; preds = %bb.gj
  %i.afo = getelementptr inbounds nuw i8, ptr %i.afn, i64 1056 ; 4 uses
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1120) %i.afn, i8 0, i64 1056, i1 false)
  store float 1.000000e+00, ptr %i.afo, align 4
  %i.afp = getelementptr inbounds nuw i8, ptr %i.afn, i64 1060 ; 3 uses
  %i.afq = getelementptr inbounds nuw i8, ptr %i.afn, i64 1076 ; 2 uses
  ...
  %i.afr = getelementptr inbounds nuw i8, ptr %i.afn, i64 1080 ; 2 uses
  %i.afs = getelementptr inbounds nuw i8, ptr %i.afn, i64 1096 ; 2 uses
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.afr, i8 0, i64 16, i1 false)
  store float 1.000000e+00, ptr %i.afs, align 4
  %i.aft = getelementptr inbounds nuw i8, ptr %i.afn, i64 1100 ; 2 uses
  %i.afu = getelementptr inbounds nuw i8, ptr %i.afn, i64 1116 ; 2 uses
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %i.aft, i8 0, i64 16, i1 false)
  store float 1.000000e+00, ptr %i.afu, align 4
  %i.afv = load i64, ptr %i.adx, align 8
  %i.afw = mul i64 %i.afv, %.0355970
  %i.afx = load i64, ptr %i.ady, align 8
  %i.afy = load ptr, ptr %i.ys, align 8
  %i.afz = getelementptr [32 x i8], ptr %i.afy, i64 %i.afw
  %i.aga = getelementptr [32 x i8], ptr %i.afz, i64 %i.afx ; 2 uses
  %i.agb = getelementptr inbounds nuw i8, ptr %i.aga, i64 8
  %i.agc = load i64, ptr %i.agb, align 8          ; 4 uses
  %i.agd = icmp ugt i64 %i.agc, 1023
  br i1 %i.agd, label %_ZN8aiStringaSERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE.exit535, label %bb.gl

bb.gl:                                            ; preds = %bb.gk
  %i.age = trunc nuw nsw i64 %i.agc to i32
  store i32 %i.age, ptr %i.afn, align 4
  %i.agf = getelementptr inbounds nuw i8, ptr %i.afn, i64 4 ; 2 uses
  %i.agg = load ptr, ptr %i.aga, align 8
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %i.agf, ptr align 1 %i.agg, i64 %i.agc, i1 false)
  %i.agh = getelementptr inbounds nuw i8, ptr %i.agf, i64 %i.agc
  store i8 0, ptr %i.agh, align 1
...
_ZN8aiStringaSERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE.exit535: ; preds = %bb.gk, %bb.gl
  %.val481 = load i64, ptr %i.adz, align 8
  %.val482 = load i64, ptr %i.aea, align 8
  %.val483 = load ptr, ptr %i.aeb, align 8
  %i.agi = mul i64 %.val482, %.0355970
  %i.agj = getelementptr [4 x i8], ptr %.val483, i64 %i.agi
  %i.agk = getelementptr [4 x i8], ptr %i.agj, i64 %.val481
  %i.agl = load float, ptr %i.agk, align 4
  store float %i.agl, ptr %i.afo, align 8
  %.val478 = load i64, ptr %i.adz, align 8
  %.val479 = load i64, ptr %i.aea, align 8
  %.val480 = load ptr, ptr %i.aeb, align 8
  %i.agm = mul i64 %.val479, %.0355970
  %i.agn = getelementptr [4 x i8], ptr %.val480, i64 %i.agm
  %i.ago = getelementptr [4 x i8], ptr %i.agn, i64 %.val478
  %i.agp = getelementptr i8, ptr %i.ago, i64 4
  %i.agq = load float, ptr %i.agp, align 4
  store float %i.agq, ptr %i.afp, align 4
  %.val475 = load i64, ptr %i.adz, align 8
  %.val476 = load i64, ptr %i.aea, align 8
  %.val477 = load ptr, ptr %i.aeb, align 8
  %i.agr = mul i64 %.val476, %.0355970
  %i.ags = getelementptr [4 x i8], ptr %.val477, i64 %i.agr
  %i.agt = getelementptr [4 x i8], ptr %i.ags, i64 %.val475
  %i.agu = getelementptr i8, ptr %i.agt, i64 8
  %i.agv = load float, ptr %i.agu, align 4        ; 2 uses
  %i.agw = getelementptr inbounds nuw i8, ptr %i.afn, i64 1064
  store float %i.agv, ptr %i.agw, align 8
  %.val472 = load i64, ptr %i.adz, align 8
  %.val473 = load i64, ptr %i.aea, align 8
  %.val474 = load ptr, ptr %i.aeb, align 8
  %i.agx = mul i64 %.val473, %.0355970
  %i.agy = getelementptr [4 x i8], ptr %.val474, i64 %i.agx
  %i.agz = getelementptr [4 x i8], ptr %i.agy, i64 %.val472
  %i.aha = getelementptr i8, ptr %i.agz, i64 12
  %i.ahb = load float, ptr %i.aha, align 4        ; 2 uses
  %i.ahc = getelementptr inbounds nuw i8, ptr %i.afn, i64 1068
  store float %i.ahb, ptr %i.ahc, align 4
  %.val469 = load i64, ptr %i.adz, align 8
  %.val470 = load i64, ptr %i.aea, align 8
  %.val471 = load ptr, ptr %i.aeb, align 8
  %i.ahd = mul i64 %.val470, %.0355970
  %i.ahe = getelementptr [4 x i8], ptr %.val471, i64 %i.ahd
  %i.ahf = getelementptr [4 x i8], ptr %i.ahe, i64 %.val469
  %i.ahg = getelementptr i8, ptr %i.ahf, i64 16
  %i.ahh = load float, ptr %i.ahg, align 4        ; 2 uses
  %i.ahi = getelementptr inbounds nuw i8, ptr %i.afn, i64 1072 ; 2 uses
  store float %i.ahh, ptr %i.ahi, align 8
  %.val466 = load i64, ptr %i.adz, align 8
  %.val467 = load i64, ptr %i.aea, align 8
  %.val468 = load ptr, ptr %i.aeb, align 8
  %i.ahj = mul i64 %.val467, %.0355970
  %i.ahk = getelementptr [4 x i8], ptr %.val468, i64 %i.ahj
  %i.ahl = getelementptr [4 x i8], ptr %i.ahk, i64 %.val466
  %i.ahm = getelementptr i8, ptr %i.ahl, i64 20
  %i.ahn = load float, ptr %i.ahm, align 4        ; 2 uses
  store float %i.ahn, ptr %i.afq, align 4
  %.val463 = load i64, ptr %i.adz, align 8
  %.val464 = load i64, ptr %i.aea, align 8
  %.val465 = load ptr, ptr %i.aeb, align 8
  %i.aho = mul i64 %.val464, %.0355970
  %i.ahp = getelementptr [4 x i8], ptr %.val465, i64 %i.aho
  %i.ahq = getelementptr [4 x i8], ptr %i.ahp, i64 %.val463
  %i.ahr = getelementptr i8, ptr %i.ahq, i64 24
  %i.ahs = load float, ptr %i.ahr, align 4        ; 2 uses
  store float %i.ahs, ptr %i.afr, align 8
  %.val460 = load i64, ptr %i.adz, align 8
  %.val461 = load i64, ptr %i.aea, align 8
  %.val462 = load ptr, ptr %i.aeb, align 8
  %i.aht = mul i64 %.val461, %.0355970
  %i.ahu = getelementptr [4 x i8], ptr %.val462, i64 %i.aht
  %i.ahv = getelementptr [4 x i8], ptr %i.ahu, i64 %.val460
  %i.ahw = getelementptr i8, ptr %i.ahv, i64 28
  %i.ahx = load float, ptr %i.ahw, align 4        ; 2 uses
  %i.ahy = getelementptr inbounds nuw i8, ptr %i.afn, i64 1084
  store float %i.ahx, ptr %i.ahy, align 4
  %.val457 = load i64, ptr %i.adz, align 8
  %.val458 = load i64, ptr %i.aea, align 8
  %.val459 = load ptr, ptr %i.aeb, align 8
  %i.ahz = mul i64 %.val458, %.0355970
  %i.aia = getelementptr [4 x i8], ptr %.val459, i64 %i.ahz
  %i.aib = getelementptr [4 x i8], ptr %i.aia, i64 %.val457
  %i.aic = getelementptr i8, ptr %i.aib, i64 32
  %i.aid = load float, ptr %i.aic, align 4        ; 2 uses
  %i.aie = getelementptr inbounds nuw i8, ptr %i.afn, i64 1088 ; 2 uses
  store float %i.aid, ptr %i.aie, align 8
  %.val454 = load i64, ptr %i.adz, align 8
  %.val455 = load i64, ptr %i.aea, align 8
  %.val456 = load ptr, ptr %i.aeb, align 8
  %i.aif = mul i64 %.val455, %.0355970
  %i.aig = getelementptr [4 x i8], ptr %.val456, i64 %i.aif
  %i.aih = getelementptr [4 x i8], ptr %i.aig, i64 %.val454
  %i.aii = getelementptr i8, ptr %i.aih, i64 36
  %i.aij = load float, ptr %i.aii, align 4        ; 2 uses
  %i.aik = getelementptr inbounds nuw i8, ptr %i.afn, i64 1092
  store float %i.aij, ptr %i.aik, align 4
  %.val451 = load i64, ptr %i.adz, align 8
  %.val452 = load i64, ptr %i.aea, align 8
  %.val453 = load ptr, ptr %i.aeb, align 8
  %i.ail = mul i64 %.val452, %.0355970
  %i.aim = getelementptr [4 x i8], ptr %.val453, i64 %i.ail
  %i.ain = getelementptr [4 x i8], ptr %i.aim, i64 %.val451
  %i.aio = getelementptr i8, ptr %i.ain, i64 40
  %i.aip = load float, ptr %i.aio, align 4        ; 2 uses
  store float %i.aip, ptr %i.afs, align 8
  %.val448 = load i64, ptr %i.adz, align 8
  %.val449 = load i64, ptr %i.aea, align 8
  %.val450 = load ptr, ptr %i.aeb, align 8
  %i.aiq = mul i64 %.val449, %.0355970
  %i.air = getelementptr [4 x i8], ptr %.val450, i64 %i.aiq
  %i.ais = getelementptr [4 x i8], ptr %i.air, i64 %.val448
  %i.ait = getelementptr i8, ptr %i.ais, i64 44
  %i.aiu = load float, ptr %i.ait, align 4        ; 2 uses
  store float %i.aiu, ptr %i.aft, align 4
  %i.aiv = load ptr, ptr %i.afi, align 8
  %i.aiw = load ptr, ptr %i.afg, align 8
  %i.aix = ptrtoint ptr %i.aiv to i64
  %i.aiy = ptrtoint ptr %i.aiw to i64
  %i.aiz = sub i64 %i.aix, %i.aiy
  %i.aja = ashr exact i64 %i.aiz, 3               ; 2 uses
  %i.ajb = trunc i64 %i.aja to i32
  %i.ajc = getelementptr inbounds nuw i8, ptr %i.afn, i64 1028
  store i32 %i.ajb, ptr %i.ajc, align 4
  %i.ajd = and i64 %i.aja, 4294967295             ; 2 uses
  %i.aje = shl nuw nsw i64 %i.ajd, 3              ; 2 uses
  %i.ajf = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %i.aje) #30
...
bb.gm:                                            ; preds = %_ZN8aiStringaSERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE.exit535
  %i.ajg = icmp eq i64 %i.ajd, 0
  br i1 %i.ajg, label %.loopexit, label %.loopexit.loopexit

.loopexit.loopexit:                               ; preds = %bb.gm
  call void @llvm.memset.p0.i64(ptr nonnull align 4 %i.ajf, i8 0, i64 %i.aje, i1 false)
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %bb.gm
  %i.ajh = getelementptr inbounds nuw i8, ptr %i.afn, i64 1048
  store ptr %i.ajf, ptr %i.ajh, align 8
  %i.aji = load ptr, ptr %i.afg, align 8          ; 3 uses
  %i.ajj = load ptr, ptr %i.afi, align 8
  %i.ajk = ptrtoint ptr %i.ajj to i64
  %i.ajl = ptrtoint ptr %i.aji to i64
  %i.ajm = sub i64 %i.ajk, %i.ajl                 ; 3 uses
  %i.ajn = icmp sgt i64 %i.ajm, 8
  br i1 %i.ajn, label %bb.gn, label %bb.go, !prof !14

bb.gn:                                            ; preds = %.loopexit
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 4 %i.ajf, ptr align 4 %i.aji, i64 %i.ajm, i1 false)
  br label %bb.gq

bb.go:                                            ; preds = %.loopexit
  %i.ajo = icmp eq i64 %i.ajm, 8
  br i1 %i.ajo, label %bb.gp, label %bb.gq

bb.gp:                                            ; preds = %bb.go
  %i.ajp = load i64, ptr %i.aji, align 4
  store i64 %i.ajp, ptr %i.ajf, align 4
  br label %bb.gq

bb.gq:                                            ; preds = %bb.gn, %bb.go, %bb.gp
  %i.ajq = load <4 x float>, ptr %i.afo, align 8
  %i.ajr = load <4 x float>, ptr %i.afp, align 4
  %i.ajs = getelementptr inbounds nuw i8, ptr %i.afn, i64 1104 ; 2 uses
  %i.ajt = load <4 x float>, ptr %i.ajs, align 8
  %i.aju = getelementptr inbounds nuw i8, ptr %i.afn, i64 1108
  %i.ajv = load float, ptr %i.aju, align 4
  %i.ajw = getelementptr inbounds nuw i8, ptr %i.afn, i64 1112
  %i.ajx = load float, ptr %i.ajw, align 8
  %i.ajy = load float, ptr %i.afu, align 4
  %i.ajz = load <4 x float>, ptr %i.aec, align 8  ; 4 uses
  ...
  %i.akd = shufflevector <4 x float> %i.ajr, <4 x float> poison, <4 x i32> zeroinitializer
  %i.ake = fmul <4 x float> %i.aka, %i.akd
  %i.akf = shufflevector <4 x float> %i.ajq, <4 x float> poison, <4 x i32> zeroinitializer
  %i.akg = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ajz, <4 x float> %i.akf, <4 x float> %i.ake)
  %i.akh = insertelement <4 x float> poison, float %i.agv, i64 0
  %i.aki = shufflevector <4 x float> %i.akh, <4 x float> poison, <4 x i32> zeroinitializer
  %i.akj = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.akb, <4 x float> %i.aki, <4 x float> %i.akg)
  %i.akk = insertelement <4 x float> poison, float %i.ahb, i64 0
  %i.akl = shufflevector <4 x float> %i.akk, <4 x float> poison, <4 x i32> zeroinitializer
  %i.akm = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.akc, <4 x float> %i.akl, <4 x float> %i.akj)
  store <4 x float> %i.akm, ptr %i.afo, align 8
  %i.akn = insertelement <4 x float> poison, float %i.ahn, i64 0
  %i.ako = shufflevector <4 x float> %i.akn, <4 x float> poison, <4 x i32> zeroinitializer
  %i.akp = fmul <4 x float> %i.aka, %i.ako
  %i.akq = insertelement <4 x float> poison, float %i.ahh, i64 0
  %i.akr = shufflevector <4 x float> %i.akq, <4 x float> poison, <4 x i32> zeroinitializer
  %i.aks = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ajz, <4 x float> %i.akr, <4 x float> %i.akp)
  %i.akt = insertelement <4 x float> poison, float %i.ahs, i64 0
  %i.aku = shufflevector <4 x float> %i.akt, <4 x float> poison, <4 x i32> zeroinitializer
  %i.akv = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.akb, <4 x float> %i.aku, <4 x float> %i.aks)
  %i.akw = insertelement <4 x float> poison, float %i.ahx, i64 0
  %i.akx = shufflevector <4 x float> %i.akw, <4 x float> poison, <4 x i32> zeroinitializer
  %i.aky = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.akc, <4 x float> %i.akx, <4 x float> %i.akv)
  store <4 x float> %i.aky, ptr %i.ahi, align 8
  %i.akz = insertelement <4 x float> poison, float %i.aij, i64 0
  %i.ala = shufflevector <4 x float> %i.akz, <4 x float> poison, <4 x i32> zeroinitializer
  %i.alb = fmul <4 x float> %i.aka, %i.ala
  %i.alc = insertelement <4 x float> poison, float %i.aid, i64 0
  %i.ald = shufflevector <4 x float> %i.alc, <4 x float> poison, <4 x i32> zeroinitializer
  %i.ale = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ajz, <4 x float> %i.ald, <4 x float> %i.alb)
  %i.alf = insertelement <4 x float> poison, float %i.aip, i64 0
  %i.alg = shufflevector <4 x float> %i.alf, <4 x float> poison, <4 x i32> zeroinitializer
  %i.alh = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.akb, <4 x float> %i.alg, <4 x float> %i.ale)
  %i.ali = insertelement <4 x float> poison, float %i.aiu, i64 0
  %i.alj = shufflevector <4 x float> %i.ali, <4 x float> poison, <4 x i32> zeroinitializer
  %i.alk = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.akc, <4 x float> %i.alj, <4 x float> %i.alh)
  store <4 x float> %i.alk, ptr %i.aie, align 8
  %i.all = insertelement <4 x float> poison, float %i.ajv, i64 0
  %i.alm = shufflevector <4 x float> %i.all, <4 x float> poison, <4 x i32> zeroinitializer
  %i.aln = fmul <4 x float> %i.aka, %i.alm
  %i.alo = shufflevector <4 x float> %i.ajt, <4 x float> poison, <4 x i32> zeroinitializer
  %i.alp = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ajz, <4 x float> %i.alo, <4 x float> %i.aln)
  %i.alq = insertelement <4 x float> poison, float %i.ajx, i64 0
  %i.alr = shufflevector <4 x float> %i.alq, <4 x float> poison, <4 x i32> zeroinitializer
  %i.als = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.akb, <4 x float> %i.alr, <4 x float> %i.alp)
  %i.alt = insertelement <4 x float> poison, float %i.ajy, i64 0
  %i.alu = shufflevector <4 x float> %i.alt, <4 x float> poison, <4 x i32> zeroinitializer
  %i.alv = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.akc, <4 x float> %i.alu, <4 x float> %i.als)
  store <4 x float> %i.alv, ptr %i.ajs, align 8
  %i.alw = load ptr, ptr %i.aeg, align 8
  call void @llvm.lifetime.start.p0(ptr nonnull %11) #26
  %i.alx = getelementptr inbounds nuw i8, ptr %i.afn, i64 4 ; 9 uses
  store ptr %i.aeh, ptr %11, align 8
  %i.aly = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %i.alx) #26 ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #26
  store i64 %i.aly, ptr %i.b, align 8
  %i.alz = icmp ugt i64 %i.aly, 15
  br i1 %i.alz, label %.noexc.i, label %._crit_edge.i.i

.noexc.i:                                         ; preds = %bb.gq
  %i.ama = invoke noundef ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm(ptr noundef nonnull align 8 dereferenceable(32) %11, ptr noundef nonnull align 8 dereferenceable(8) %i.b, i64 noundef 0)
...
.noexc536:                                        ; preds = %.noexc.i
  store ptr %i.ama, ptr %11, align 8
  %i.amb = load i64, ptr %i.b, align 8
  store i64 %i.amb, ptr %i.aeh, align 8
  br label %._crit_edge.i.i

._crit_edge.i.i:                                  ; preds = %.noexc536, %bb.gq
  %i.amc = phi ptr [ %i.ama, %.noexc536 ], [ %i.aeh, %bb.gq ] ; 2 uses
  switch i64 %i.aly, label %bb.gs [
    i64 1, label %bb.gr
    i64 0, label %bb.gt
  ]

bb.gr:                                            ; preds = %._crit_edge.i.i
  %i.amd = load i8, ptr %i.alx, align 4
  store i8 %i.amd, ptr %i.amc, align 1
  br label %bb.gt

bb.gs:                                            ; preds = %._crit_edge.i.i
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %i.amc, ptr nonnull align 1 %i.alx, i64 %i.aly, i1 false)
  br label %bb.gt

bb.gt:                                            ; preds = %bb.gs, %bb.gr, %._crit_edge.i.i
  %i.ame = load i64, ptr %i.b, align 8            ; 2 uses
  store i64 %i.ame, ptr %i.aei, align 8
  %i.amf = load ptr, ptr %11, align 8
  %i.amg = getelementptr inbounds nuw i8, ptr %i.amf, i64 %i.ame
  store i8 0, ptr %i.amg, align 1
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #26
  %i.amh = call noundef ptr @_ZNK6Assimp13ColladaLoader8FindNodeEPKNS_7Collada4NodeERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(ptr noundef nonnull align 8 dereferenceable(384) %0, ptr noundef %i.alw, ptr noundef nonnull align 8 dereferenceable(32) %11) ; 2 uses
  %i.ami = load ptr, ptr %11, align 8             ; 2 uses
  %i.amj = icmp eq ptr %i.ami, %i.aeh
  br i1 %i.amj, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %bb.gt
  %i.amk = load i64, ptr %i.aeh, align 8
  %i.aml = add i64 %i.amk, 1
  call void @_ZdlPvm(ptr noundef %i.ami, i64 noundef %i.aml) #27
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %bb.gt, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i
  ...
  %i.amm = icmp eq ptr %i.amh, null
  br i1 %i.amm, label %bb.gu, label %.thread661

bb.gu:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  %i.amn = load ptr, ptr %i.aeg, align 8
  call void @llvm.lifetime.start.p0(ptr nonnull %12) #26
  store ptr %i.aej, ptr %12, align 8
  %i.amo = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %i.alx) #26 ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #26
  store i64 %i.amo, ptr %i.a, align 8
  %i.amp = icmp ugt i64 %i.amo, 15
  br i1 %i.amp, label %.noexc.i538, label %._crit_edge.i.i537

.noexc.i538:                                      ; preds = %bb.gu
  %i.amq = invoke noundef ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm(ptr noundef nonnull align 8 dereferenceable(32) %12, ptr noundef nonnull align 8 dereferenceable(8) %i.a, i64 noundef 0)
...
.noexc539:                                        ; preds = %.noexc.i538
  store ptr %i.amq, ptr %12, align 8
  %i.amr = load i64, ptr %i.a, align 8
  store i64 %i.amr, ptr %i.aej, align 8
  br label %._crit_edge.i.i537

._crit_edge.i.i537:                               ; preds = %.noexc539, %bb.gu
  %i.ams = phi ptr [ %i.amq, %.noexc539 ], [ %i.aej, %bb.gu ] ; 2 uses
  switch i64 %i.amo, label %bb.gw [
    i64 1, label %bb.gv
    i64 0, label %bb.gx
  ]

bb.gv:                                            ; preds = %._crit_edge.i.i537
  %i.amt = load i8, ptr %i.alx, align 4
  store i8 %i.amt, ptr %i.ams, align 1
  br label %bb.gx

bb.gw:                                            ; preds = %._crit_edge.i.i537
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %i.ams, ptr nonnull align 1 %i.alx, i64 %i.amo, i1 false)
  br label %bb.gx

bb.gx:                                            ; preds = %bb.gw, %bb.gv, %._crit_edge.i.i537
  %i.amu = load i64, ptr %i.a, align 8            ; 2 uses
  store i64 %i.amu, ptr %i.aek, align 8
  %i.amv = load ptr, ptr %12, align 8
  %i.amw = getelementptr inbounds nuw i8, ptr %i.amv, i64 %i.amu
  store i8 0, ptr %i.amw, align 1
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #26
  %i.amx = call noundef ptr @_ZNK6Assimp13ColladaLoader13FindNodeBySIDEPKNS_7Collada4NodeERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(ptr noundef nonnull align 8 dereferenceable(384) %0, ptr noundef %i.amn, ptr noundef nonnull align 8 dereferenceable(32) %12) ; 2 uses
  %i.amy = load ptr, ptr %12, align 8             ; 2 uses
  %i.amz = icmp eq ptr %i.amy, %i.aej
  br i1 %i.amz, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i542, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i541

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i541: ; preds = %bb.gx
  %i.ana = load i64, ptr %i.aej, align 8
  %i.anb = add i64 %i.ana, 1
  call void @_ZdlPvm(ptr noundef %i.amy, i64 noundef %i.anb) #27
...
.thread661:                                       ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i542
  %.0664 = phi ptr [ %i.amx, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i542 ], [ %i.amh, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit ]
...
bb.gz:                                            ; preds = %.thread661
  %i.anf = load i64, ptr %i.ael, align 8          ; 5 uses
  %i.ang = icmp ugt i64 %i.anf, 1023
  %.pre1095 = load ptr, ptr %13, align 8          ; 3 uses
  br i1 %i.ang, label %_ZN8aiString3SetERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE.exit, label %bb.ha

bb.ha:                                            ; preds = %bb.gz
  %i.anh = trunc nuw nsw i64 %i.anf to i32
  store i32 %i.anh, ptr %i.afn, align 8
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %i.alx, ptr align 1 %.pre1095, i64 %i.anf, i1 false)
  %i.ani = getelementptr inbounds nuw i8, ptr %i.alx, i64 %i.anf
  store i8 0, ptr %i.ani, align 1
  br label %_ZN8aiString3SetERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE.exit

_ZN8aiString3SetERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE.exit: ; preds = %bb.gz, %bb.ha
  %i.anj = icmp eq ptr %.pre1095, %i.aem
  br i1 %i.anj, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i551, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i550
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i550: ; preds = %_ZN8aiString3SetERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE.exit
  %i.anl = load i64, ptr %i.aem, align 8
  %i.anm = add i64 %i.anl, 1
  call void @_ZdlPvm(ptr noundef %.pre1095, i64 noundef %i.anm) #27
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit552
...
bb.hc:                                            ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i542
  %i.ano = invoke noundef ptr @_ZN6Assimp13DefaultLogger3getEv()
          to label %bb.hd unwind label %bb.he

bb.hd:                                            ; preds = %bb.hc
  invoke void @_ZN6Assimp6Logger4warnIJRA75_KcRA1024_cRA3_S2_EEEvDpOT_(ptr noundef nonnull align 8 dereferenceable(12) %i.ano, ptr noundef nonnull align 1 dereferenceable(75) @.str.25, ptr noundef nonnull align 1 dereferenceable(1024) %i.alx, ptr noundef nonnull align 1 dereferenceable(3) @.str.26)
...
bb.hf:                                            ; preds = %bb.hd, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit552
  %i.anq = load ptr, ptr %7, align 8
  %i.anr = getelementptr inbounds nuw i8, ptr %i.anq, i64 224
  %i.ans = load ptr, ptr %i.anr, align 8
  %i.ant = add i64 %.0355970.a, 1
  %i.anu = getelementptr inbounds nuw [8 x i8], ptr %i.ans, i64 %.0355970.a
  store ptr %i.afn, ptr %i.anu, align 8
  br label %bb.hg

bb.hg:                                            ; preds = %bb.gi, %bb.hf
  %.1357 = phi i64 [ %.0355970.a, %bb.gi ], [ %i.ant, %bb.hf ]
  %i.anv = add nuw i64 %.0355970, 1               ; 2 uses
  %exitcond1089.not = icmp eq i64 %i.anv, %i.yz
...
bb.hh:                                            ; preds = %.loopexit680, %.loopexit.split-lp, %bb.gy, %bb.gh, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit546, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit549, %bb.hb, %bb.he, %bb.ft
  %.pn409.pn = phi { ptr, i32 } [ %i.aab, %bb.ft ], [ %i.ane, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit549 ], [ %i.aff, %bb.gh ], [ %i.anc, %bb.gy ], [ %i.and, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit546 ], [ %i.ann, %bb.hb ], [ %i.anp, %bb.he ], [ %lpad.loopexit, %.loopexit680 ], [ %lpad.loopexit.split-lp, %.loopexit.split-lp ]
  %i.anw = load ptr, ptr %9, align 8              ; 3 uses
  %.not.i.i.i553 = icmp eq ptr %i.anw, null
...
bb.hi:                                            ; preds = %bb.hh
  %i.anx = getelementptr inbounds nuw i8, ptr %9, i64 16
  %i.any = load ptr, ptr %i.anx, align 8
  %i.anz = ptrtoint ptr %i.any to i64
  %i.aoa = ptrtoint ptr %i.anw to i64
  %i.aob = sub i64 %i.anz, %i.aoa
  call void @_ZdlPvm(ptr noundef nonnull %i.anw, i64 noundef %i.aob) #27
...
bb.hj:                                            ; preds = %_ZNSt6vectorIN9__gnu_cxx17__normal_iteratorIPKSt4pairImmES_IS3_SaIS3_EEEESaIS8_EED2Ev.exit554, %bb.fs
  %.pn409.pn.pn = phi { ptr, i32 } [ %.pn409.pn, %_ZNSt6vectorIN9__gnu_cxx17__normal_iteratorIPKSt4pairImmES_IS3_SaIS3_EEEESaIS8_EED2Ev.exit554 ], [ %i.aaa, %bb.fs ]
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #26
  br label %.body

bb.hk:                                            ; preds = %_ZNSt6vectorIS_I14aiVertexWeightSaIS0_EESaIS2_EED2Ev.exit, %bb.en, %_ZNSt6vectorIP10aiAnimMeshSaIS1_EED2Ev.exit
  %i.aoc = load ptr, ptr %7, align 8              ; 2 uses
  store ptr null, ptr %7, align 8
  %.not.i.i.i555 = icmp eq ptr %.sroa.0613.0.lcssa1189, null
  br i1 %.not.i.i.i555, label %_ZNSt6vectorIfSaIfEED2Ev.exit, label %bb.hl

bb.hl:                                            ; preds = %bb.hk
  %i.aod = ptrtoint ptr %.sroa.15620.0.lcssa1187 to i64
  %i.aoe = ptrtoint ptr %.sroa.0613.0.lcssa1189 to i64
  %i.aof = sub i64 %i.aod, %i.aoe
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0613.0.lcssa1189, i64 noundef %i.aof) #27
  br label %_ZNSt6vectorIfSaIfEED2Ev.exit

_ZNSt6vectorIfSaIfEED2Ev.exit:                    ; preds = %bb.hk, %bb.hl
  %.not.i.i.i556 = icmp eq ptr %.sroa.0623.0.lcssa1193, null
  br i1 %.not.i.i.i556, label %_ZNSt6vectorIP6aiMeshSaIS1_EED2Ev.exit, label %bb.hm

bb.hm:                                            ; preds = %_ZNSt6vectorIfSaIfEED2Ev.exit
  %i.aog = ptrtoint ptr %.sroa.20636.0.lcssa1191 to i64
  %i.aoh = ptrtoint ptr %.sroa.0623.0.lcssa1193 to i64
  %i.aoi = sub i64 %i.aog, %i.aoh
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0623.0.lcssa1193, i64 noundef %i.aoi) #27
...
.body:                                            ; preds = %.loopexit687, %.loopexit.split-lp688, %.loopexit692, %.loopexit.split-lp693, %.loopexit697, %.loopexit.split-lp698, %bb.em, %bb.el, %bb.co, %bb.cq, %bb.cs, %bb.cv, %bb.cr, %bb.cp, %bb.dh, %bb.dg, %bb.da, %bb.ew, %bb.ey, %bb.fa, %bb.fb, %bb.fj, %bb.fk, %bb.fo, %bb.hj, %bb.fi, %bb.ez, %bb.ex
  %.sroa.15620.4 = phi ptr [ %.sroa.15620.0921, %bb.da ], [ %.sroa.15620.0.lcssa1187, %bb.fj ], [ %.sroa.15620.0.lcssa1187, %bb.fk ], [ %.sroa.15620.0.lcssa1187, %bb.hj ], [ %.sroa.15620.0.lcssa1187, %bb.fo ], [ %.sroa.15620.0.lcssa1187, %bb.fi ], [ %.sroa.15620.0.lcssa1187, %bb.fa ], [ %.sroa.15620.0.lcssa1187, %bb.fb ], [ %.sroa.15620.0.lcssa1187, %bb.ez ], [ %.sroa.15620.0.lcssa1187, %bb.ey ], [ %.sroa.15620.0.lcssa1187, %bb.ex ], [ %.sroa.15620.0.lcssa1187, %bb.ew ], [ %.sroa.15620.2, %bb.em ], [ %.sroa.15620.0921, %bb.cv ], [ %.sroa.15620.0921, %bb.co ], [ %.sroa.15620.0921, %.loopexit.split-lp693 ], [ %.sroa.15620.0921, %bb.cs ], [ %.sroa.15620.0921, %bb.cr ], [ %.sroa.15620.0921, %bb.cq ], [ %.sroa.15620.0921, %bb.cp ], [ %.sroa.15620.0921, %.loopexit.split-lp698 ], [ %.sroa.15620.0921, %bb.dh ], [ %.sroa.15620.0921, %bb.dg ], [ %.sroa.15620.2, %bb.el ], [ %.sroa.15620.0921, %.loopexit697 ], [ %.sroa.15620.0921, %.loopexit692 ], [ %.sroa.10.1912, %.loopexit687 ], [ %.sroa.10.1912, %.loopexit.split-lp688 ]
  %.sroa.0613.4 = phi ptr [ %.sroa.0613.0923, %bb.da ], [ %.sroa.0613.0.lcssa1189, %bb.fj ], [ %.sroa.0613.0.lcssa1189, %bb.fk ], [ %.sroa.0613.0.lcssa1189, %bb.hj ], [ %.sroa.0613.0.lcssa1189, %bb.fo ], [ %.sroa.0613.0.lcssa1189, %bb.fi ], [ %.sroa.0613.0.lcssa1189, %bb.fa ], [ %.sroa.0613.0.lcssa1189, %bb.fb ], [ %.sroa.0613.0.lcssa1189, %bb.ez ], [ %.sroa.0613.0.lcssa1189, %bb.ey ], [ %.sroa.0613.0.lcssa1189, %bb.ex ], [ %.sroa.0613.0.lcssa1189, %bb.ew ], [ %.sroa.0613.2, %bb.em ], [ %.sroa.0613.0923, %bb.cv ], [ %.sroa.0613.0923, %bb.co ], [ %.sroa.0613.0923, %.loopexit.split-lp693 ], [ %.sroa.0613.0923, %bb.cs ], [ %.sroa.0613.0923, %bb.cr ], [ %.sroa.0613.0923, %bb.cq ], [ %.sroa.0613.0923, %bb.cp ], [ %.sroa.0613.0923, %.loopexit.split-lp698 ], [ %.sroa.0613.0923, %bb.dh ], [ %.sroa.0613.0923, %bb.dg ], [ %.sroa.0613.2, %bb.el ], [ %.sroa.0613.0923, %.loopexit697 ], [ %.sroa.0613.0923, %.loopexit692 ], [ %.sroa.0613.1913, %.loopexit687 ], [ %.sroa.0613.1913, %.loopexit.split-lp688 ] ; 3 uses
  %.sroa.20636.4 = phi ptr [ %.sroa.20636.1900, %bb.da ], [ %.sroa.20636.0.lcssa1191, %bb.fj ], [ %.sroa.20636.0.lcssa1191, %bb.fk ], [ %.sroa.20636.0.lcssa1191, %bb.hj ], [ %.sroa.20636.0.lcssa1191, %bb.fo ], [ %.sroa.20636.0.lcssa1191, %bb.fi ], [ %.sroa.20636.0.lcssa1191, %bb.fa ], [ %.sroa.20636.0.lcssa1191, %bb.fb ], [ %.sroa.20636.0.lcssa1191, %bb.ez ], [ %.sroa.20636.0.lcssa1191, %bb.ey ], [ %.sroa.20636.0.lcssa1191, %bb.ex ], [ %.sroa.20636.0.lcssa1191, %bb.ew ], [ %.sroa.20636.2, %bb.em ], [ %.sroa.20636.0924, %bb.cv ], [ %.sroa.20636.0924, %bb.co ], [ %.sroa.20636.19001002, %.loopexit.split-lp693 ], [ %.sroa.20636.0924, %bb.cs ], [ %.sroa.20636.0924, %bb.cr ], [ %.sroa.20636.0924, %bb.cq ], [ %.sroa.20636.0924, %bb.cp ], [ %.sroa.20636.0924, %.loopexit.split-lp698 ], [ %.sroa.20636.1900, %bb.dh ], [ %.sroa.20636.1900, %bb.dg ], [ %.sroa.20636.2, %bb.el ], [ %.sroa.20636.0924, %.loopexit697 ], [ %.sroa.20636.1900.lcssa996, %.loopexit692 ], [ %.sroa.20636.1.lcssa, %.loopexit687 ], [ %.sroa.20636.1.lcssa, %.loopexit.split-lp688 ]
  %.sroa.0623.4 = phi ptr [ %.sroa.0623.1902, %bb.da ], [ %.sroa.0623.0.lcssa1193, %bb.fj ], [ %.sroa.0623.0.lcssa1193, %bb.fk ], [ %.sroa.0623.0.lcssa1193, %bb.hj ], [ %.sroa.0623.0.lcssa1193, %bb.fo ], [ %.sroa.0623.0.lcssa1193, %bb.fi ], [ %.sroa.0623.0.lcssa1193, %bb.fa ], [ %.sroa.0623.0.lcssa1193, %bb.fb ], [ %.sroa.0623.0.lcssa1193, %bb.ez ], [ %.sroa.0623.0.lcssa1193, %bb.ey ], [ %.sroa.0623.0.lcssa1193, %bb.ex ], [ %.sroa.0623.0.lcssa1193, %bb.ew ], [ %.sroa.0623.2, %bb.em ], [ %.sroa.0623.0926, %bb.cv ], [ %.sroa.0623.0926, %bb.co ], [ %.sroa.0623.1902, %.loopexit.split-lp693 ], [ %.sroa.0623.0926, %bb.cs ], [ %.sroa.0623.0926, %bb.cr ], [ %.sroa.0623.0926, %bb.cq ], [ %.sroa.0623.0926, %bb.cp ], [ %.sroa.0623.0926, %.loopexit.split-lp698 ], [ %.sroa.0623.1902, %bb.dh ], [ %.sroa.0623.1902, %bb.dg ], [ %.sroa.0623.2, %bb.el ], [ %.sroa.0623.0926, %.loopexit697 ], [ %.sroa.0623.1902, %.loopexit692 ], [ %.sroa.0623.1.lcssa, %.loopexit687 ], [ %.sroa.0623.1.lcssa, %.loopexit.split-lp688 ] ; 3 uses
...
bb.hn:                                            ; preds = %.body
  %i.aoj = ptrtoint ptr %.sroa.15620.4 to i64
  %i.aok = ptrtoint ptr %.sroa.0613.4 to i64
  %i.aol = sub i64 %i.aoj, %i.aok
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0613.4, i64 noundef %i.aol) #27
...
bb.ho:                                            ; preds = %_ZNSt6vectorIfSaIfEED2Ev.exit558
  %i.aom = ptrtoint ptr %.sroa.20636.4 to i64
  %i.aon = ptrtoint ptr %.sroa.0623.4 to i64
  %i.aoo = sub i64 %i.aom, %i.aon
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0623.4, i64 noundef %i.aoo) #27
...
_ZNSt10unique_ptrI6aiMeshSt14default_deleteIS0_EED2Ev.exit: ; preds = %_ZN8aiStringaSERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE.exit, %_ZNSt6vectorIP6aiMeshSaIS1_EED2Ev.exit, %_ZNKSt14default_deleteI6aiMeshEclEPS0_.exit.i
  %.0323667 = phi ptr [ %i.aoc, %_ZNKSt14default_deleteI6aiMeshEclEPS0_.exit.i ], [ %i.aoc, %_ZNSt6vectorIP6aiMeshSaIS1_EED2Ev.exit ], [ %i.c, %_ZN8aiStringaSERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE.exit ]
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #26
  ret ptr %.0323667
