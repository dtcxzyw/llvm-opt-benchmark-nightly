...
begin_hunk_0_@_ZN6Assimp13ColladaLoader14InternReadFileERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEP7aiScenePNS_8IOSystemE:bb.a
  ...
  %6 = shufflevector <2 x float> %i.hh, <2 x float> poison, <3 x i32> <i32 1, i32 0, i32 poison>
  %7 = insertelement <3 x float> %6, float %i.fv, i64 2
  %8 = shufflevector <3 x float> %7, <3 x float> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 2>
  ...
  %i.hr = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %8, <4 x float> zeroinitializer, <4 x float> %i.hq)
