...
begin_hunk_0_@_ZN6Assimp4D3DS4NodeC2ERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE:bb.a
...
._crit_edge:                                      ; preds = %bb.b
  ...
  %.phi.trans.insert9 = getelementptr inbounds nuw i8, ptr %.pre, i64 24
  %.pre10.a = load ptr, ptr %.phi.trans.insert9, align 8
  %.pre11.a = ptrtoint ptr %.pre8 to i64
  %.pre12 = ptrtoint ptr %.pre10.a to i64
  %.pre14 = sub i64 %.pre11.a, %.pre12
...
end_hunk_0
begin_hunk_1_@_ZN6Assimp19Discreet3DSImporter16ParseEditorChunkEv:bb.a
bb.c:                                             ; preds = %bb.b
...
bb.b:                                             ; preds = %.lr.ph, %bb.ay
  ...
  br i1 %i.ac, label %._crit_edge60, label %bb.c, !llvm.loop !22

._crit_edge60:                                    ; preds = %bb.b
  %.phi.trans.insert = getelementptr inbounds nuw i8, ptr %.pre, i64 40
  %.pre61 = load ptr, ptr %.phi.trans.insert, align 8
  %.phi.trans.insert62 = getelementptr inbounds nuw i8, ptr %.pre, i64 24
  %.pre63.a = load ptr, ptr %.phi.trans.insert62, align 8
  %.pre64.a = ptrtoint ptr %.pre61 to i64
  %.pre65 = ptrtoint ptr %.pre63.a to i64
  %.pre67 = sub i64 %.pre64.a, %.pre65
...
bb.i:                                             ; preds = %_ZN6Assimp12StreamReaderILb0ELb0EE12SetReadLimitEj.exit
  ...
  br i1 %i.bh, label %._crit_edge53, label %_ZN6Assimp12StreamReaderILb0ELb0EE5GetI1Ev.exit

._crit_edge53:                                    ; preds = %bb.i, %bb.l
...
_ZN6Assimp12StreamReaderILb0ELb0EE5GetI1Ev.exit:  ; preds = %bb.i, %bb.l
  ...
  %.01752 = phi i32 [ %i.bo, %bb.l ], [ 0, %bb.i ] ; 2 uses
...
bb.l:                                             ; preds = %_ZN6Assimp12StreamReaderILb0ELb0EE5GetI1Ev.exit
  ...
  br i1 %i.bv, label %._crit_edge53, label %_ZN6Assimp12StreamReaderILb0ELb0EE5GetI1Ev.exit, !llvm.loop !23

bb.m:                                             ; preds = %_ZN6Assimp12StreamReaderILb0ELb0EE5GetI1Ev.exit
  call void @_ZN6Assimp19Discreet3DSImporter10ParseChunkEPKcj(ptr noundef nonnull align 8 dereferenceable(168) %0, ptr noundef %i.bd, i32 noundef %.01752)
  br label %bb.as
...
end_hunk_1
begin_hunk_2_@_ZN6Assimp19Discreet3DSImporter16ParseObjectChunkEv:bb.a
...
bb.am:                                            ; preds = %.loopexit.split-lp, %.loopexit46
...
bb.b:                                             ; preds = %.lr.ph, %bb.ck
  ...
  %.pre123.a = load ptr, ptr %i.d, align 8        ; 7 uses
  br i1 %i.af, label %._crit_edge, label %bb.c, !llvm.loop !29

._crit_edge:                                      ; preds = %bb.b
  %.phi.trans.insert = getelementptr inbounds nuw i8, ptr %.pre123.a, i64 40
  %.pre124 = load ptr, ptr %.phi.trans.insert, align 8
  %.phi.trans.insert125 = getelementptr inbounds nuw i8, ptr %.pre123.a, i64 24
  %.pre126.a = load ptr, ptr %.phi.trans.insert125, align 8
  %.pre127.a = ptrtoint ptr %.pre124 to i64
  %.pre128 = ptrtoint ptr %.pre126.a to i64
  %.pre130 = sub i64 %.pre127.a, %.pre128
  br label %bb.ck, !llvm.loop !29

bb.c:                                             ; preds = %bb.b
  %i.ag = getelementptr inbounds nuw i8, ptr %.pre123.a, i64 24
  %i.ah = load ptr, ptr %i.ag, align 8
  %i.ai = getelementptr inbounds nuw i8, ptr %.pre123.a, i64 16
  ...
  %i.ap = getelementptr inbounds nuw i8, ptr %.pre123.a, i64 40 ; 3 uses
  %i.aq = load ptr, ptr %i.ap, align 8
  %i.ar = icmp eq i32 %i.ao, -1
  br i1 %i.ar, label %bb.d, label %bb.e

bb.d:                                             ; preds = %bb.c
  %i.as = getelementptr inbounds nuw i8, ptr %.pre123.a, i64 32
...
bb.e:                                             ; preds = %bb.c
  ...
  %i.aw = getelementptr inbounds nuw i8, ptr %.pre123.a, i64 32
  %i.ax = load ptr, ptr %i.aw, align 8
...
bb.f:                                             ; preds = %bb.e
end_hunk_2
begin_hunk_3_@_ZN6Assimp19Discreet3DSImporter10ParseChunkEPKcj:bb.a
...
bb.cl:                                            ; preds = %bb.bu, %bb.am, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit30
  %.pn.pn = phi { ptr, i32 } [ %.pn, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit30 ], [ %lpad.phi110, %bb.am ], [ %lpad.phi, %bb.bu ]
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #28
  br label %common.resume
...
bb.b:                                             ; preds = %.lr.ph, %bb.bd
  ...
  %.pre = load ptr, ptr %i.b, align 8             ; 7 uses
  br i1 %i.s, label %._crit_edge65, label %bb.c, !llvm.loop !39

._crit_edge65:                                    ; preds = %bb.b
  %.phi.trans.insert = getelementptr inbounds nuw i8, ptr %.pre, i64 40
  %.pre66 = load ptr, ptr %.phi.trans.insert, align 8
  %.phi.trans.insert67 = getelementptr inbounds nuw i8, ptr %.pre, i64 24
  %.pre68.a = load ptr, ptr %.phi.trans.insert67, align 8
  %.pre69.a = ptrtoint ptr %.pre66 to i64
  %.pre70 = ptrtoint ptr %.pre68.a to i64
  %.pre72 = sub i64 %.pre69.a, %.pre70
...
common.resume:                                    ; preds = %bb.bc, %bb.al, %bb.k, %bb.h
  ...
  call void @__cxa_free_exception(ptr nonnull %.sink) #28
end_hunk_3
begin_hunk_4_@_ZN6Assimp19Discreet3DSImporter18ParseMaterialChunkEv:bb.a
...
end_hunk_4
begin_hunk_5_@_ZN6Assimp19Discreet3DSImporter14ParseMeshChunkEv:bb.a
...
_ZN6Assimp12StreamReaderILb0ELb0EE6IncPtrEl.exit._crit_edge: ; preds = %_ZN6Assimp12StreamReaderILb0ELb0EE6IncPtrEl.exit, %_ZNSt6vectorIN6Assimp4D3DS4FaceESaIS2_EE7reserveEm.exit
  %.lcssa195 = phi ptr [ %i.nj, %_ZNSt6vectorIN6Assimp4D3DS4FaceESaIS2_EE7reserveEm.exit ], [ %i.nl, %_ZN6Assimp12StreamReaderILb0ELb0EE6IncPtrEl.exit ]
  %i.qc = getelementptr inbounds i8, ptr %i.aq, i64 -88 ; 2 uses
  %i.qd = load ptr, ptr %i.mo, align 8
  %i.qe = ptrtoint ptr %.lcssa195 to i64
...
bb.dg:                                            ; preds = %._crit_edge, %_ZN6Assimp12StreamReaderILb0ELb0EE12SetReadLimitEj.exit99
  ...
  br i1 %i.sg, label %.loopexit116, label %bb.b

.loopexit116:                                     ; preds = %bb.dg, %bb.a, %.thread
  ret void
}
...
._crit_edge:                                      ; preds = %bb.b
  ...
  %.phi.trans.insert35 = getelementptr inbounds nuw i8, ptr %.pre, i64 24
  %.pre36.a = load ptr, ptr %.phi.trans.insert35, align 8
  %.pre37.a = ptrtoint ptr %.pre34 to i64
  %.pre38 = ptrtoint ptr %.pre36.a to i64
  %.pre40 = sub i64 %.pre37.a, %.pre38
...
bb.q:                                             ; preds = %bb.p
end_hunk_5
begin_hunk_6_@_ZN6Assimp19Discreet3DSImporter15ParseLightChunkEv:bb.a
...
._crit_edge:                                      ; preds = %bb.b
  ...
  %.phi.trans.insert12 = getelementptr inbounds nuw i8, ptr %.pre, i64 24
  %.pre13.a = load ptr, ptr %.phi.trans.insert12, align 8
  %.pre14.a = ptrtoint ptr %.pre11 to i64
  %.pre15 = ptrtoint ptr %.pre13.a to i64
  %.pre17 = sub i64 %.pre14.a, %.pre15
...
bb.a:
  ...
  br i1 %i.m, label %.loopexit, label %.lr.ph479
...
bb.b:                                             ; preds = %.lr.ph479, %bb.hi
  ...
  %.pre511 = load ptr, ptr %i.c, align 8          ; 7 uses
  br i1 %i.y, label %._crit_edge512, label %bb.c, !llvm.loop !77

._crit_edge512:                                   ; preds = %bb.b
  %.phi.trans.insert = getelementptr inbounds nuw i8, ptr %.pre511, i64 40
  %.pre513 = load ptr, ptr %.phi.trans.insert, align 8
  %.phi.trans.insert514 = getelementptr inbounds nuw i8, ptr %.pre511, i64 24
  %.pre515 = load ptr, ptr %.phi.trans.insert514, align 8
  %.pre520.a = ptrtoint ptr %.pre513 to i64
  %.pre521 = ptrtoint ptr %.pre515 to i64
  %.pre523 = sub i64 %.pre520.a, %.pre521
  br label %bb.hi, !llvm.loop !77

bb.c:                                             ; preds = %bb.b
  %i.z = getelementptr inbounds nuw i8, ptr %.pre511, i64 24
  %i.aa = load ptr, ptr %i.z, align 8
  %i.ab = getelementptr inbounds nuw i8, ptr %.pre511, i64 16
  ...
  %i.ai = getelementptr inbounds nuw i8, ptr %.pre511, i64 40 ; 3 uses
  %i.aj = load ptr, ptr %i.ai, align 8
  %i.ak = icmp eq i32 %i.ah, -1
  br i1 %i.ak, label %bb.d, label %bb.e

bb.d:                                             ; preds = %bb.c
  %i.al = getelementptr inbounds nuw i8, ptr %.pre511, i64 32
...
bb.e:                                             ; preds = %bb.c
  ...
  %i.ap = getelementptr inbounds nuw i8, ptr %.pre511, i64 32
  %i.aq = load ptr, ptr %i.ap, align 8
...
bb.i:                                             ; preds = %_ZN6Assimp12StreamReaderILb0ELb0EE12SetReadLimitEj.exit
  ...
  %i.bc = load ptr, ptr %i.bb, align 8
  %i.bd = icmp ugt ptr %i.ba, %i.bc
  br i1 %i.bd, label %._crit_edge476, label %_ZN6Assimp12StreamReaderILb0ELb0EE5GetI1Ev.exit

._crit_edge476:                                   ; preds = %bb.i, %bb.l
...
_ZN6Assimp12StreamReaderILb0ELb0EE5GetI1Ev.exit:  ; preds = %bb.i, %bb.l
  ...
  %.0126475 = phi i32 [ %i.bk, %bb.l ], [ 0, %bb.i ] ; 5 uses
...
bb.l:                                             ; preds = %_ZN6Assimp12StreamReaderILb0ELb0EE5GetI1Ev.exit
  ...
  br i1 %i.br, label %._crit_edge476, label %_ZN6Assimp12StreamReaderILb0ELb0EE5GetI1Ev.exit, !llvm.loop !78

bb.m:                                             ; preds = %_ZN6Assimp12StreamReaderILb0ELb0EE5GetI1Ev.exit
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #28
  %i.bs = zext i32 %.0126475 to i64               ; 2 uses
  store ptr %i.s, ptr %3, align 8
  %i.bt = icmp eq ptr %i.az, null
  %i.bu = icmp ne i32 %.0126475, 0
...
bb.o:                                             ; preds = %bb.m
  ...
  %i.bv = icmp ugt i32 %.0126475, 15
  br i1 %i.bv, label %.noexc.i, label %._crit_edge.i.i

end_hunk_6
begin_hunk_7_@_ZN6Assimp19Discreet3DSImporter19ParseHierarchyChunkEt:bb.a
...
_ZNSt6vectorI11aiVectorKeySaIS0_EE9push_backERKS0_.exit292: ; preds = %bb.gv, %_ZNSt6vectorI11aiVectorKeySaIS0_EE17_M_realloc_insertIJRKS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i291
  ...
  %i.adp = add nuw i32 %.0134459, 1               ; 2 uses
...
end_hunk_7
begin_hunk_8_@_ZN6Assimp19Discreet3DSImporter14ParseFaceChunkEv:bb.a
  %.not4752 = icmp eq ptr %i.cg, %i.ci
  br i1 %.not4752, label %.thread, label %.lr.ph

.lr.ph:                                           ; preds = %bb.u, %bb.x
  %.02554 = phi i32 [ %i.da, %bb.x ], [ 0, %bb.u ] ; 3 uses
  %.sroa.036.053 = phi ptr [ %i.cz, %bb.x ], [ %i.cg, %bb.u ] ; 3 uses
  %i.cj = getelementptr inbounds nuw i8, ptr %.sroa.036.053, i64 16
  %i.ck = load i64, ptr %i.cj, align 8
  %.not30 = icmp eq i64 %i.ck, 0
  br i1 %.not30, label %bb.x, label %bb.v

bb.v:                                             ; preds = %.lr.ph
  %i.cl = getelementptr inbounds nuw i8, ptr %.sroa.036.053, i64 8
...
bb.x:                                             ; preds = %.lr.ph, %_ZN6Assimp14ASSIMP_stricmpEPKcS1_.exit
  %i.cz = getelementptr inbounds nuw i8, ptr %.sroa.036.053, i64 696 ; 2 uses
  %i.da = add i32 %.02554, 1
...
bb.y:                                             ; preds = %_ZN6Assimp14ASSIMP_stricmpEPKcS1_.exit
  %i.db = icmp eq i32 %.02554, -842150451
...
bb.z:                                             ; preds = %.thread, %bb.y
  %.02643 = phi i32 [ -842150451, %.thread ], [ %.02554, %bb.y ]
...
_ZN6Assimp12StreamReaderILb0ELb0EE5GetI2Ev.exit:  ; preds = %bb.z
  ...
  %.not63 = icmp eq i16 %i.dm, 0
  br i1 %.not63, label %._crit_edge, label %.lr.ph56

.lr.ph56:                                         ; preds = %_ZN6Assimp12StreamReaderILb0ELb0EE5GetI2Ev.exit
...
bb.ad:                                            ; preds = %.lr.ph56, %bb.aj
  %.02455 = phi i32 [ 0, %.lr.ph56 ], [ %i.ej, %bb.aj ]
...
bb.aj:                                            ; preds = %bb.ai, %bb.ah
  %i.ej = add nuw nsw i32 %.02455, 1              ; 2 uses
...
bb.ap:                                            ; preds = %._crit_edge66, %_ZN6Assimp12StreamReaderILb0ELb0EE12SetReadLimitEj.exit35
  ...
  br i1 %i.fn, label %.loopexit49, label %bb.b

.loopexit49:                                      ; preds = %bb.ap, %bb.a, %.thread45
  ret void
}
...
bb.a:
  %i.a = alloca i64, align 8                      ; 6 uses
end_hunk_8
begin_hunk_9_@_ZN6Assimp19Discreet3DSImporter17ParseTextureChunkEPNS_4D3DS7TextureE:bb.a
