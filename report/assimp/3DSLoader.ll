...
bb.a:
  ...
  %i.f = load ptr, ptr %i.e, align 8              ; 16 uses
  ...
  %i.m = getelementptr inbounds nuw i8, ptr %i.f, i64 1044 ; 2 uses
  %i.n = load float, ptr %i.m, align 4            ; 2 uses
  %i.o = getelementptr inbounds nuw i8, ptr %i.f, i64 1048
  %i.p = load float, ptr %i.o, align 4            ; 2 uses
  %2 = getelementptr inbounds nuw i8, ptr %i.f, i64 1052
  %i.q = getelementptr inbounds nuw i8, ptr %i.f, i64 1056
  %i.r = getelementptr inbounds nuw i8, ptr %i.f, i64 1060 ; 2 uses
  %i.s = load float, ptr %i.r, align 4            ; 2 uses
  %i.t = getelementptr inbounds nuw i8, ptr %i.f, i64 1064
  %i.u = load float, ptr %i.t, align 4            ; 2 uses
  %3 = getelementptr inbounds nuw i8, ptr %i.f, i64 1068
  %i.v = getelementptr inbounds nuw i8, ptr %i.f, i64 1072
  %i.w = getelementptr inbounds nuw i8, ptr %i.f, i64 1076 ; 2 uses
  %i.x = load float, ptr %i.w, align 4            ; 2 uses
  %i.y = getelementptr inbounds nuw i8, ptr %i.f, i64 1080
  %i.z = load float, ptr %i.y, align 4            ; 2 uses
  %i.aa = getelementptr inbounds nuw i8, ptr %i.f, i64 1084
  %i.ab = getelementptr inbounds nuw i8, ptr %i.f, i64 1088
  %4 = fmul float %i.j, 0.000000e+00              ; 2 uses
  %i.ac = load <2 x float>, ptr %i.k, align 4     ; 3 uses
  %i.ad = load float, ptr %i.l, align 4
  %5 = fmul float %storemerge, %i.j
  ...
  %8 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ae, <2 x float> %i.ag, <2 x float> %7)
  %i.ah = tail call float @llvm.fmuladd.f32(float %i.h, float 0.000000e+00, float %4) ; 2 uses
  %9 = extractelement <2 x float> %i.ac, i64 0
  %i.ai = tail call float @llvm.fmuladd.f32(float %9, float 0.000000e+00, float %i.ah)
  %10 = fadd float %i.ad, %i.ai
  %11 = insertelement <4 x float> <float 0.000000e+00, float 0.000000e+00, float poison, float -0.000000e+00>, float %storemerge, i64 2 ; 4 uses
  %12 = shufflevector <2 x float> %i.ac, <2 x float> <float poison, float 0.000000e+00>, <4 x i32> <i32 0, i32 0, i32 0, i32 3>
  %13 = insertelement <4 x float> poison, float %i.ah, i64 2
  ...
  %17 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %11, <4 x float> %12, <4 x float> %16)
  %18 = shufflevector <2 x float> %i.ac, <2 x float> <float poison, float -0.000000e+00>, <4 x i32> <i32 1, i32 1, i32 1, i32 3>
  %19 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %18, <4 x float> zeroinitializer, <4 x float> %17)
  store <4 x float> %19, ptr %i.g, align 4
  %20 = fmul float %i.p, 0.000000e+00             ; 2 uses
  %21 = load <2 x float>, ptr %2, align 4         ; 3 uses
  %22 = load float, ptr %i.q, align 4
  %23 = fmul float %storemerge, %i.p
  %24 = insertelement <2 x float> poison, float %i.n, i64 0
  %25 = shufflevector <2 x float> %24, <2 x float> poison, <2 x i32> zeroinitializer
  %i.aj = insertelement <2 x float> poison, float %20, i64 0
  %26 = insertelement <2 x float> %i.aj, float %23, i64 1
  %i.ak = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ae, <2 x float> %25, <2 x float> %26)
  %27 = tail call float @llvm.fmuladd.f32(float %i.n, float 0.000000e+00, float %20) ; 2 uses
  %28 = extractelement <2 x float> %21, i64 0
  %29 = tail call float @llvm.fmuladd.f32(float %28, float 0.000000e+00, float %27)
  %30 = fadd float %22, %29
  %31 = shufflevector <2 x float> %21, <2 x float> <float poison, float 0.000000e+00>, <4 x i32> <i32 0, i32 0, i32 0, i32 3>
  %32 = insertelement <4 x float> poison, float %27, i64 2
  %i.al = insertelement <4 x float> %32, float %30, i64 3
  %33 = shufflevector <2 x float> %i.ak, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %34 = shufflevector <4 x float> %33, <4 x float> %i.al, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %35 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %11, <4 x float> %31, <4 x float> %34)
  %36 = shufflevector <2 x float> %21, <2 x float> <float poison, float -0.000000e+00>, <4 x i32> <i32 1, i32 1, i32 1, i32 3>
  %37 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %36, <4 x float> zeroinitializer, <4 x float> %35)
  store <4 x float> %37, ptr %i.m, align 4
  %38 = fmul float %i.u, 0.000000e+00             ; 2 uses
  %39 = load <2 x float>, ptr %3, align 4         ; 3 uses
  %40 = load float, ptr %i.v, align 4
  %41 = fmul float %storemerge, %i.u
  ...
  %i.ao = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ae, <2 x float> %i.an, <2 x float> %43)
  %44 = tail call float @llvm.fmuladd.f32(float %i.s, float 0.000000e+00, float %38) ; 2 uses
  %45 = extractelement <2 x float> %39, i64 0
  %46 = tail call float @llvm.fmuladd.f32(float %45, float 0.000000e+00, float %44)
  %47 = fadd float %40, %46
  %48 = shufflevector <2 x float> %39, <2 x float> <float poison, float 0.000000e+00>, <4 x i32> <i32 0, i32 0, i32 0, i32 3>
  %49 = insertelement <4 x float> poison, float %44, i64 2
  %50 = insertelement <4 x float> %49, float %47, i64 3
  %51 = shufflevector <2 x float> %i.ao, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %52 = shufflevector <4 x float> %51, <4 x float> %50, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %i.ap = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %11, <4 x float> %48, <4 x float> %52)
  %53 = shufflevector <2 x float> %39, <2 x float> <float poison, float -0.000000e+00>, <4 x i32> <i32 1, i32 1, i32 1, i32 3>
  %54 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %53, <4 x float> zeroinitializer, <4 x float> %i.ap)
  store <4 x float> %54, ptr %i.r, align 4
  %55 = fmul float %i.z, 0.000000e+00             ; 2 uses
  %56 = load <2 x float>, ptr %i.aa, align 4      ; 3 uses
  %57 = load float, ptr %i.ab, align 4
  %58 = fmul float %storemerge, %i.z
  ...
  %i.as = insertelement <2 x float> poison, float %55, i64 0
  %59 = insertelement <2 x float> %i.as, float %58, i64 1
  %i.at = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ae, <2 x float> %i.ar, <2 x float> %59)
  %60 = tail call float @llvm.fmuladd.f32(float %i.x, float 0.000000e+00, float %55) ; 2 uses
  %61 = extractelement <2 x float> %56, i64 0
  %62 = tail call float @llvm.fmuladd.f32(float %61, float 0.000000e+00, float %60)
  %63 = fadd float %57, %62
  %64 = shufflevector <2 x float> %56, <2 x float> <float poison, float 0.000000e+00>, <4 x i32> <i32 0, i32 0, i32 0, i32 3>
  %65 = insertelement <4 x float> poison, float %60, i64 2
  %66 = insertelement <4 x float> %65, float %63, i64 3
  %67 = shufflevector <2 x float> %i.at, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %68 = shufflevector <4 x float> %67, <4 x float> %66, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %i.au = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %11, <4 x float> %64, <4 x float> %68)
  %69 = shufflevector <2 x float> %56, <2 x float> <float poison, float -0.000000e+00>, <4 x i32> <i32 1, i32 1, i32 1, i32 3>
  %70 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %69, <4 x float> zeroinitializer, <4 x float> %i.au)
  store <4 x float> %70, ptr %i.w, align 4
  ret void
}
...
_ZN13aiQuaterniontIfEC2E10aiVector3tIfEf.exit:    ; preds = %_ZN6Assimp12StreamReaderILb0ELb0EE5GetF4Ev.exit62, %_ZN10aiVector3tIfEdVEf.exit.i.i
  ...
  %i.lp = fmul <2 x float> %i.lh, %i.lo           ; 8 uses
  %i.lq = extractelement <2 x float> %i.lp, i64 1 ; 3 uses
  %i.lr = extractelement <2 x float> %i.lp, i64 0
  %i.ls = call float @llvm.fmuladd.f32(float %i.lr, float %i.lq, float %i.lm)
  %9 = shufflevector <2 x float> %i.lp, <2 x float> <float poison, float -2.000000e+00>, <2 x i32> <i32 1, i32 3>
  %i.lt = insertelement <2 x float> <float poison, float 1.000000e+00>, float %8, i64 0
  %i.lu = insertelement <2 x float> poison, float %7, i64 0
  ...
  %10 = shufflevector <2 x float> %i.lp, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 0> ; 3 uses
  %i.mc = insertelement <4 x float> %10, float %i.ll, i64 0
  %i.md = insertelement <4 x float> %10, float %i.ll, i64 0
  %i.me = insertelement <4 x float> %i.md, float %7, i64 1
  %11 = insertelement <4 x float> %i.me, float %i.lk, i64 3
  %i.mf = fmul <4 x float> %i.mc, %11             ; 2 uses
  %12 = extractelement <4 x float> %i.mf, i64 0
  %13 = call float @llvm.fmuladd.f32(float %i.lq, float %i.lq, float %12)
  ...
  %16 = insertelement <2 x float> %15, float %i.ls, i64 1
  %17 = fmul <2 x float> %16, <float 1.000000e+00, float 2.000000e+00>
  %18 = shufflevector <2 x float> %i.lp, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
  ...
  %i.mi = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %18, <4 x float> %i.mh, <4 x float> %i.mf) ; 4 uses
  %19 = shufflevector <4 x float> %10, <4 x float> %i.mi, <2 x i32> <i32 0, i32 4>
  %20 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %19, <2 x float> %9, <2 x float> %i.lt)
  %i.mj = fmul <2 x float> %20, <float 2.000000e+00, float 1.000000e+00>
  ...
  %i.mq = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %17, <2 x float> zeroinitializer, <2 x float> %i.mj)
