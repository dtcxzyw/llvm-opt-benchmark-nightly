...
bb.b:                                             ; preds = %.lr.ph, %bb.e
  ...
  %i.l = invoke noalias noundef nonnull dereferenceable(24) ptr @_Znwm(i64 noundef 24) #12
...
bb.c:                                             ; preds = %.noexc
  ...
  %i.u = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %i.t) #12
          to label %.noexc.i unwind label %bb.d   ; 3 uses

.noexc.i:                                         ; preds = %bb.c
  %i.v = getelementptr inbounds nuw i8, ptr %i.l, i64 16
  store ptr %i.u, ptr %i.v, align 8
  %i.w = tail call ptr @strncpy(ptr noundef nonnull %i.u, ptr noundef readonly %i.p, i64 noundef %i.r) #13 ; 0 uses
