...
bb.m:                                             ; preds = %bb.i
  ...
  %i.cf = getelementptr inbounds nuw [12 x i8], ptr %i.ca, i64 %i.ce ; 2 uses
  ...
  %27 = fmul float %26, %i.cx
  %28 = extractelement <2 x float> %16, i64 1
  %29 = extractelement <2 x float> %21, i64 0
  %i.cy = call float @llvm.fmuladd.f32(float %28, float %29, float %27) ; 4 uses
  ...
  %i.cz = call float @llvm.fmuladd.f32(float %31, float %31, float %30)
...
_ZN10aiVector3tIfEdVEf.exit.i:                    ; preds = %bb.m
  ...
  %.sroa.0108.0.vec.insert = insertelement <2 x float> poison, float %i.dc, i64 0
  %32 = shufflevector <2 x float> %.sroa.0108.0.vec.insert, <2 x float> poison, <2 x i32> zeroinitializer
