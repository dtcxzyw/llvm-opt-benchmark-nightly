...
bb.d:                                             ; preds = %bb.c
  ...
  %5 = call float @llvm.fmuladd.f32(float %i.ak, float -2.000000e+00, float 1.000000e+00) ; 3 uses
  %i.ay = shufflevector <4 x float> %i.ag, <4 x float> %i.ax, <4 x i32> <i32 2, i32 1, i32 6, i32 poison>
  %i.az = insertelement <4 x float> %i.ay, float %5, i64 3
  ...
  %i.bl = call float @llvm.fmuladd.f32(float %5, float 0.000000e+00, float %i.bk)
  ...
  %i.bs = call float @llvm.fmuladd.f32(float %5, float 0.000000e+00, float %i.br) ; 2 uses
  ...
  %i.cm = shufflevector <2 x float> %i.cl, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 1> ; 2 uses
  ...
  %i.eb = extractelement <2 x float> %i.ck, i64 0
  ...
  %i.er = call float @llvm.fmuladd.f32(float %.fca.1.extract, float %i.eb, float %i.eq)
  ...
  %6 = shufflevector <4 x float> %i.by, <4 x float> %i.cm, <2 x i32> <i32 0, i32 5>
  %7 = shufflevector <4 x float> %i.ep, <4 x float> poison, <2 x i32> <i32 poison, i32 3>
  %8 = insertelement <2 x float> %7, float %i.er, i64 0
  %9 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %6, <2 x float> zeroinitializer, <2 x float> %8) ; 2 uses
...
_ZNSt6vectorIP6aiNodeSaIS1_EE9push_backERKS1_.exit: ; preds = %_ZNSt6vectorIP6aiNodeSaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i, %bb.g
  ...
  store float %11, ptr %.sroa.34.0..sroa_idx, align 4
