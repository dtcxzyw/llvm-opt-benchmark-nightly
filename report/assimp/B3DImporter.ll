...
bb.d:                                             ; preds = %bb.c
  ...
  %i.h = fneg float %.sroa.0216.0.vec.extract     ; 2 uses
  %i.i = shufflevector <2 x float> %i.e, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.j = shufflevector <4 x float> %i.i, <4 x float> <float 1.000000e+00, float poison, float poison, float poison>, <4 x i32> <i32 4, i32 1, i32 0, i32 1>
  %i.k = shufflevector <2 x float> %i.d, <2 x float> poison, <4 x i32> <i32 poison, i32 poison, i32 0, i32 0>
  %i.l = insertelement <4 x float> %i.k, float 1.000000e+00, i64 0 ; 2 uses
  %i.m = insertelement <4 x float> %i.l, float %i.h, i64 1
  %i.n = fmul <4 x float> %i.j, %i.m
  %i.o = insertelement <2 x float> %i.d, float %i.g, i64 0
  %i.p = shufflevector <2 x float> %i.o, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 1>
  %i.q = shufflevector <2 x float> %i.e, <2 x float> poison, <4 x i32> <i32 poison, i32 0, i32 1, i32 0>
  %i.r = insertelement <4 x float> %i.q, float -2.000000e+00, i64 0
  %i.s = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.p, <4 x float> %i.r, <4 x float> %i.n) ; 3 uses
  %i.t = extractelement <4 x float> %i.s, i64 3
  %i.u = fmul float %i.t, 2.000000e+00            ; 2 uses
  %i.v = call float @llvm.fmuladd.f32(float %.sroa.0216.4.vec.extract, float %.sroa.0216.4.vec.extract, float %i.f)
  %i.w = shufflevector <2 x float> %i.d, <2 x float> %i.e, <4 x i32> <i32 poison, i32 1, i32 2, i32 1>
  %i.x = insertelement <4 x float> %i.w, float 1.000000e+00, i64 0
  %i.y = insertelement <4 x float> poison, float %i.h, i64 0
  %i.z = shufflevector <4 x float> %i.y, <4 x float> poison, <4 x i32> <i32 poison, i32 0, i32 0, i32 poison>
  %i.aa = shufflevector <4 x float> %i.l, <4 x float> %i.z, <4 x i32> <i32 0, i32 5, i32 6, i32 3>
  %i.ab = fmul <4 x float> %i.x, %i.aa
  %i.ac = shufflevector <2 x float> %i.e, <2 x float> %i.d, <4 x i32> <i32 poison, i32 0, i32 3, i32 0>
  %i.ad = insertelement <4 x float> %i.ac, float %i.v, i64 0
  %i.ae = shufflevector <2 x float> %i.e, <2 x float> <float -2.000000e+00, float poison>, <4 x i32> <i32 2, i32 1, i32 1, i32 1>
  %i.af = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ad, <4 x float> %i.ae, <4 x float> %i.ab) ; 4 uses
  %i.ag = extractelement <4 x float> %i.af, i64 1
  %i.ah = fmul float %i.ag, 2.000000e+00          ; 2 uses
  %i.ai = extractelement <4 x float> %i.af, i64 3
  %i.aj = fmul float %i.ai, 2.000000e+00          ; 4 uses
  %foldExtExtBinop515 = fmul <2 x float> %i.e, %i.e
  %i.ak = extractelement <2 x float> %foldExtExtBinop515, i64 0
  %i.al = call float @llvm.fmuladd.f32(float %.sroa.0216.4.vec.extract, float %.sroa.0216.4.vec.extract, float %i.ak)
  %i.am = call float @llvm.fmuladd.f32(float %i.al, float -2.000000e+00, float 1.000000e+00) ; 4 uses
  %i.an = fmul float %i.u, 0.000000e+00           ; 2 uses
  %i.ao = extractelement <4 x float> %i.s, i64 0  ; 3 uses
  %i.ap = fadd float %i.ao, %i.an
  %i.aq = extractelement <4 x float> %i.af, i64 0 ; 2 uses
  %i.ar = fmul float %i.aq, 0.000000e+00          ; 2 uses
  %i.as = fmul float %i.ah, 0.000000e+00          ; 2 uses
  %i.at = fadd float %.sroa.0220.0.vec.extract, 0.000000e+00 ; 3 uses
  %i.au = call float @llvm.fmuladd.f32(float %i.ao, float 0.000000e+00, float %i.u)
  %i.av = fadd float %.sroa.0220.4.vec.extract, 0.000000e+00 ; 3 uses
  %i.aw = call float @llvm.fmuladd.f32(float %i.ao, float 0.000000e+00, float %i.an) ; 2 uses
  %i.ax = shufflevector <4 x float> %i.s, <4 x float> %i.af, <4 x i32> <i32 poison, i32 1, i32 2, i32 6>
  %i.ay = insertelement <4 x float> %i.ax, float %.fca.1.extract3, i64 0
  %i.az = fmul <4 x float> %i.ay, <float 1.000000e+00, float 2.000000e+00, float 2.000000e+00, float 2.000000e+00> ; 4 uses
  %i.ba = extractelement <4 x float> %i.az, i64 3 ; 3 uses
  %i.bb = call float @llvm.fmuladd.f32(float %i.ba, float 0.000000e+00, float %i.ap)
  %i.bc = call float @llvm.fmuladd.f32(float %.sroa.0220.0.vec.extract, float 0.000000e+00, float %i.bb) ; 2 uses
  %i.bd = extractelement <4 x float> %i.az, i64 1 ; 2 uses
  %i.be = fadd float %i.bd, %i.ar
  %i.bf = call float @llvm.fmuladd.f32(float %i.aj, float 0.000000e+00, float %i.be)
end_hunk_3
...
_ZN8aiStringaSERKS_.exit:                         ; preds = %bb.ac, %_ZNSt10unique_ptrI10aiNodeAnimSt14default_deleteIS0_EE5resetEPS0_.exit, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit46.thread
  %i.ka = phi ptr [ %i.jr, %bb.ac ], [ %i.jr, %_ZNSt10unique_ptrI10aiNodeAnimSt14default_deleteIS0_EE5resetEPS0_.exit ], [ %i.jq, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit46.thread ]
  invoke void @_ZN6Assimp11B3DImporter8ReadKEYSEP10aiNodeAnim(ptr noundef nonnull align 8 dereferenceable(312) %0, ptr noundef nonnull %i.ka)
...
_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit46.thread225: ; preds = %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit44.thread224
  %i.kb = load i32, ptr %i.hf, align 1
  %i.kc = icmp ne i32 %i.kb, 1162104654
  %i.kd = zext i1 %i.kc to i32
  %i.ke = icmp eq i32 %i.kd, 0
  br i1 %i.ke, label %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit48.thread, label %_ZNSt6vectorIP6aiNodeSaIS1_EE9push_backERKS1_.exit58
...
_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit48.thread: ; preds = %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit46.thread225
  %i.kf = invoke noundef ptr @_ZN6Assimp11B3DImporter8ReadNODEEP6aiNode(ptr noundef nonnull align 8 dereferenceable(312) %0, ptr noundef nonnull %i.fq)
...
bb.ae:                                            ; preds = %bb.ad
  store ptr %i.kf, ptr %.sroa.10.0316, align 8
  %i.kg = getelementptr inbounds nuw i8, ptr %.sroa.10.0316, i64 8
  br label %_ZNSt6vectorIP6aiNodeSaIS1_EE9push_backERKS1_.exit58

bb.af:                                            ; preds = %bb.ad
  %i.kh = ptrtoint ptr %.sroa.16.0317 to i64
  %i.ki = ptrtoint ptr %.sroa.0.0315 to i64
  %i.kj = sub i64 %i.kh, %i.ki                    ; 6 uses
  %i.kk = icmp eq i64 %i.kj, 9223372036854775800
  br i1 %i.kk, label %bb.ag, label %_ZNKSt6vectorIP6aiNodeSaIS1_EE12_M_check_lenEmPKc.exit.i.i50
...
_ZNKSt6vectorIP6aiNodeSaIS1_EE12_M_check_lenEmPKc.exit.i.i50: ; preds = %bb.af
  ...
  %.sroa.speculated.i.i.i51 = call i64 @llvm.umax.i64(i64 %i.kl, i64 1)
  %i.km = add nsw i64 %.sroa.speculated.i.i.i51, %i.kl ; 2 uses
  %i.kn = icmp ult i64 %i.km, %i.kl
  %i.ko = call i64 @llvm.umin.i64(i64 %i.km, i64 1152921504606846975)
  %i.kp = select i1 %i.kn, i64 1152921504606846975, i64 %i.ko ; 3 uses
  %.not.i.i.i52 = icmp ne i64 %i.kp, 0
...
.noexc57:                                         ; preds = %_ZNKSt6vectorIP6aiNodeSaIS1_EE12_M_check_lenEmPKc.exit.i.i50
  ...
  store ptr %i.kf, ptr %i.ks, align 8
  %i.kt = icmp sgt i64 %i.kj, 0
  br i1 %i.kt, label %bb.ah, label %_ZNSt6vectorIP6aiNodeSaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i53

bb.ah:                                            ; preds = %.noexc57
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.kr, ptr align 8 %.sroa.0.0315, i64 %i.kj, i1 false)
...
bb.ai:                                            ; preds = %_ZNSt6vectorIP6aiNodeSaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i53
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0.0315, i64 noundef %i.kj) #25
...
_ZNSt6vectorIP6aiNodeSaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i55: ; preds = %bb.ai, %_ZNSt6vectorIP6aiNodeSaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i53
  %i.kv = getelementptr inbounds nuw [8 x i8], ptr %i.kr, i64 %i.kp
  br label %_ZNSt6vectorIP6aiNodeSaIS1_EE9push_backERKS1_.exit58
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %_ZNSt6vectorIP6aiNodeSaIS1_EE9push_backERKS1_.exit58
  %i.lb = load i64, ptr %i.hd, align 8
  %i.lc = add i64 %i.lb, 1
  call void @_ZdlPvm(ptr noundef %i.kz, i64 noundef %i.lc) #25
  %.pre = load ptr, ptr %i.gp, align 8
  %.pre361 = load i64, ptr %i.gq, align 8
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %_ZNSt6vectorIP6aiNodeSaIS1_EE9push_backERKS1_.exit58, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i
  %i.ld = phi i64 [ %.pre361, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i ], [ %i.ky, %_ZNSt6vectorIP6aiNodeSaIS1_EE9push_backERKS1_.exit58 ]
  %i.le = phi ptr [ %.pre, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i ], [ %i.kx, %_ZNSt6vectorIP6aiNodeSaIS1_EE9push_backERKS1_.exit58 ]
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #24
  %i.lf = getelementptr inbounds i8, ptr %i.le, i64 -8
  %i.lg = load i64, ptr %i.lf, align 8
  %.not = icmp eq i64 %i.lg, %i.ld
...
bb.aj:                                            ; preds = %.loopexit232, %.loopexit.split-lp233, %.loopexit, %.loopexit.split-lp, %bb.v, %bb.u
  ...
  %.pn.pn = phi { ptr, i32 } [ %lpad.loopexit.split-lp, %.loopexit.split-lp ], [ %i.ig, %bb.v ], [ %i.if, %bb.u ], [ %lpad.loopexit, %.loopexit ], [ %lpad.loopexit234, %.loopexit232 ], [ %lpad.loopexit.split-lp235, %.loopexit.split-lp233 ] ; 2 uses
  %i.lh = load ptr, ptr %4, align 8               ; 2 uses
  %i.li = icmp eq ptr %i.lh, %i.hd
  br i1 %i.li, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit61, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i59

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i59: ; preds = %bb.aj
  %i.lj = load i64, ptr %i.hd, align 8
  %i.lk = add i64 %i.lj, 1
  call void @_ZdlPvm(ptr noundef %i.lh, i64 noundef %i.lk) #25
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit61: ; preds = %bb.aj, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i59, %bb.t
  ...
  %.pn.pn.pn = phi { ptr, i32 } [ %i.ie, %bb.t ], [ %.pn.pn, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i59 ], [ %.pn.pn, %bb.aj ]
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #24
  br label %bb.ay

._crit_edge:                                      ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  %.pre362 = load ptr, ptr %3, align 8            ; 2 uses
  %i.ll = ptrtoint ptr %.pre362 to i64            ; 2 uses
  %i.lm = icmp eq ptr %.pre362, null
  br i1 %i.lm, label %_ZNSt6vectorISt10unique_ptrI10aiNodeAnimSt14default_deleteIS1_EESaIS4_EE12emplace_backIJS4_EEERS4_DpOT_.exit, label %bb.ak

bb.ak:                                            ; preds = %._crit_edge
  %i.ln = getelementptr inbounds nuw i8, ptr %0, i64 264 ; 2 uses
  %i.lo = getelementptr inbounds nuw i8, ptr %0, i64 272 ; 4 uses
  %i.lp = load ptr, ptr %i.lo, align 8            ; 5 uses
  %i.lq = getelementptr inbounds nuw i8, ptr %0, i64 280 ; 3 uses
  %i.lr = load ptr, ptr %i.lq, align 8
  %.not.i62 = icmp eq ptr %i.lp, %i.lr
  br i1 %.not.i62, label %bb.am, label %bb.al

bb.al:                                            ; preds = %bb.ak
  store i64 %i.ll, ptr %i.lp, align 8
  store ptr null, ptr %3, align 8
  %i.ls = load ptr, ptr %i.lo, align 8
  %i.lt = getelementptr inbounds nuw i8, ptr %i.ls, i64 8
  store ptr %i.lt, ptr %i.lo, align 8
  br label %_ZNSt6vectorISt10unique_ptrI10aiNodeAnimSt14default_deleteIS1_EESaIS4_EE12emplace_backIJS4_EEERS4_DpOT_.exit

bb.am:                                            ; preds = %bb.ak
  %i.lu = load ptr, ptr %i.ln, align 8            ; 10 uses
  %i.lv = ptrtoint ptr %i.lp to i64               ; 3 uses
  %i.lw = ptrtoint ptr %i.lu to i64               ; 4 uses
  %i.lx = sub i64 %i.lv, %i.lw                    ; 3 uses
  %i.ly = icmp eq i64 %i.lx, 9223372036854775800
  br i1 %i.ly, label %bb.an, label %_ZNKSt6vectorISt10unique_ptrI10aiNodeAnimSt14default_deleteIS1_EESaIS4_EE12_M_check_lenEmPKc.exit.i
...
_ZNKSt6vectorISt10unique_ptrI10aiNodeAnimSt14default_deleteIS1_EESaIS4_EE12_M_check_lenEmPKc.exit.i: ; preds = %bb.am
  ...
  %.sroa.speculated.i.i = call i64 @llvm.umax.i64(i64 %i.lz, i64 1)
  %i.ma = add nsw i64 %.sroa.speculated.i.i, %i.lz ; 2 uses
  ...
  %.not.i.i81 = icmp ne i64 %i.md, 0
  call void @llvm.assume(i1 %.not.i.i81)
  %i.me = shl nuw nsw i64 %i.md, 3
  %i.mf = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.me) #27
...
.noexc83:                                         ; preds = %_ZNKSt6vectorISt10unique_ptrI10aiNodeAnimSt14default_deleteIS1_EESaIS4_EE12_M_check_lenEmPKc.exit.i
  %i.mg = getelementptr inbounds nuw i8, ptr %i.mf, i64 %i.lx
  store i64 %i.ll, ptr %i.mg, align 8
  store ptr null, ptr %3, align 8
  %.not10.i.i.i.i = icmp eq ptr %i.lu, %i.lp
...
.lr.ph.i.i.i.i.preheader:                         ; preds = %.noexc83
  ...
  br i1 %min.iters.check, label %.lr.ph.i.i.i.i.preheader519, label %vector.memcheck

vector.memcheck:                                  ; preds = %.lr.ph.i.i.i.i.preheader
  %i.mj = add i64 %i.lv, -8
  %i.mk = sub i64 %i.mj, %i.lw
  %i.ml = and i64 %i.mk, -8
  %i.mm = add i64 %i.ml, 8                        ; 2 uses
  %scevgep = getelementptr i8, ptr %i.mf, i64 %i.mm
  %scevgep510 = getelementptr i8, ptr %i.lu, i64 %i.mm
  %bound0 = icmp ult ptr %i.mf, %scevgep510
  %bound1 = icmp ult ptr %i.lu, %scevgep
  %found.conflict = and i1 %bound0, %bound1
  br i1 %found.conflict, label %.lr.ph.i.i.i.i.preheader519, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %i.mi, 4611686018427387900     ; 3 uses
  %i.mn = shl i64 %n.vec, 3                       ; 2 uses
  %i.mo = getelementptr i8, ptr %i.mf, i64 %i.mn  ; 2 uses
  %i.mp = getelementptr i8, ptr %i.lu, i64 %i.mn
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.mq = shl i64 %index, 3                       ; 2 uses
  %next.gep = getelementptr i8, ptr %i.mf, i64 %i.mq ; 2 uses
  %next.gep511 = getelementptr i8, ptr %i.lu, i64 %i.mq ; 4 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !126)
  call void @llvm.experimental.noalias.scope.decl(metadata !129)
  %i.mr = getelementptr i8, ptr %next.gep511, i64 16
  %wide.load = load <2 x i64>, ptr %next.gep511, align 8, !alias.scope !131, !noalias !126
  %wide.load512 = load <2 x i64>, ptr %i.mr, align 8, !alias.scope !131, !noalias !126
  %i.ms = getelementptr i8, ptr %next.gep, i64 16
  store <2 x i64> %wide.load, ptr %next.gep, align 8, !alias.scope !134, !noalias !131
  store <2 x i64> %wide.load512, ptr %i.ms, align 8, !alias.scope !134, !noalias !131
  %i.mt = getelementptr i8, ptr %next.gep511, i64 16
  store <2 x ptr> splat (ptr null), ptr %next.gep511, align 8, !alias.scope !131, !noalias !126
  store <2 x ptr> splat (ptr null), ptr %i.mt, align 8, !alias.scope !131, !noalias !126
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.mu = icmp eq i64 %index.next, %n.vec
  br i1 %i.mu, label %middle.block, label %vector.body, !llvm.loop !136

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %i.mi, %n.vec
  br i1 %cmp.n, label %_ZNSt6vectorISt10unique_ptrI10aiNodeAnimSt14default_deleteIS1_EESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit22.i, label %.lr.ph.i.i.i.i.preheader519

.lr.ph.i.i.i.i.preheader519:                      ; preds = %vector.memcheck, %.lr.ph.i.i.i.i.preheader, %middle.block
  %.012.i.i.i.i.ph = phi ptr [ %i.mf, %vector.memcheck ], [ %i.mf, %.lr.ph.i.i.i.i.preheader ], [ %i.mo, %middle.block ]
  %.0911.i.i.i.i.ph = phi ptr [ %i.lu, %vector.memcheck ], [ %i.lu, %.lr.ph.i.i.i.i.preheader ], [ %i.mp, %middle.block ]
  br label %.lr.ph.i.i.i.i

.lr.ph.i.i.i.i:                                   ; preds = %.lr.ph.i.i.i.i.preheader519, %.lr.ph.i.i.i.i
  %.012.i.i.i.i = phi ptr [ %i.mx, %.lr.ph.i.i.i.i ], [ %.012.i.i.i.i.ph, %.lr.ph.i.i.i.i.preheader519 ] ; 2 uses
  %.0911.i.i.i.i = phi ptr [ %i.mw, %.lr.ph.i.i.i.i ], [ %.0911.i.i.i.i.ph, %.lr.ph.i.i.i.i.preheader519 ] ; 3 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !126)
  call void @llvm.experimental.noalias.scope.decl(metadata !129)
  %i.mv = load i64, ptr %.0911.i.i.i.i, align 8, !alias.scope !129, !noalias !126
  store i64 %i.mv, ptr %.012.i.i.i.i, align 8, !alias.scope !126, !noalias !129
  store ptr null, ptr %.0911.i.i.i.i, align 8, !alias.scope !129, !noalias !126
  %i.mw = getelementptr inbounds nuw i8, ptr %.0911.i.i.i.i, i64 8 ; 2 uses
  %i.mx = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i, i64 8 ; 2 uses
  %.not.i.i.i.i = icmp eq ptr %i.mw, %i.lp
...
_ZNSt6vectorISt10unique_ptrI10aiNodeAnimSt14default_deleteIS1_EESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit22.i: ; preds = %.lr.ph.i.i.i.i, %middle.block, %.noexc83
  %.0.lcssa.i.i.i.i = phi ptr [ %i.mf, %.noexc83 ], [ %i.mo, %middle.block ], [ %i.mx, %.lr.ph.i.i.i.i ]
  %i.my = getelementptr inbounds nuw i8, ptr %.0.lcssa.i.i.i.i, i64 8
  %.not.i23.i = icmp eq ptr %i.lu, null
...
bb.ao:                                            ; preds = %_ZNSt6vectorISt10unique_ptrI10aiNodeAnimSt14default_deleteIS1_EESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit22.i
  %i.mz = load ptr, ptr %i.lq, align 8
  %i.na = ptrtoint ptr %i.mz to i64
  %i.nb = sub i64 %i.na, %i.lw
  call void @_ZdlPvm(ptr noundef nonnull %i.lu, i64 noundef %i.nb) #25
  br label %.noexc63
...
.noexc63:                                         ; preds = %bb.ao, %_ZNSt6vectorISt10unique_ptrI10aiNodeAnimSt14default_deleteIS1_EESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit22.i
  store ptr %i.mf, ptr %i.ln, align 8
  store ptr %i.my, ptr %i.lo, align 8
  %i.nc = getelementptr inbounds nuw [8 x i8], ptr %i.mf, i64 %i.md
...
_ZNSt6vectorISt10unique_ptrI10aiNodeAnimSt14default_deleteIS1_EESaIS4_EE12emplace_backIJS4_EEERS4_DpOT_.exit: ; preds = %.noexc63, %bb.al, %._crit_edge
  %i.ne = ptrtoint ptr %.sroa.10101.2 to i64
  %i.nf = ptrtoint ptr %.sroa.096.2 to i64        ; 2 uses
  %i.ng = sub i64 %i.ne, %i.nf                    ; 3 uses
  %i.nh = lshr exact i64 %i.ng, 2
  %i.ni = trunc i64 %i.nh to i32
  %i.nj = getelementptr inbounds nuw i8, ptr %i.fq, i64 1120
  store i32 %i.ni, ptr %i.nj, align 8
  %i.nk = icmp eq ptr %.sroa.096.2, %.sroa.10101.2
  br i1 %i.nk, label %_ZN6Assimp11B3DImporter8to_arrayIjEEPT_RKSt6vectorIS2_SaIS2_EE.exit, label %.lr.ph.preheader.i
...
.lr.ph.preheader.i:                               ; preds = %_ZNSt6vectorISt10unique_ptrI10aiNodeAnimSt14default_deleteIS1_EESaIS4_EE12emplace_backIJS4_EEERS4_DpOT_.exit
  %i.nl = call i64 @llvm.smax.i64(i64 %i.ng, i64 -1)
  %i.nm = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %i.nl) #27
          to label %.noexc64 unwind label %bb.ap  ; 2 uses

.noexc64:                                         ; preds = %.lr.ph.preheader.i
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %i.nm, ptr align 4 %.sroa.096.2, i64 %i.ng, i1 false)
...
_ZN6Assimp11B3DImporter8to_arrayIjEEPT_RKSt6vectorIS2_SaIS2_EE.exit: ; preds = %.noexc64, %_ZNSt6vectorISt10unique_ptrI10aiNodeAnimSt14default_deleteIS1_EESaIS4_EE12emplace_backIJS4_EEERS4_DpOT_.exit
  %.010.i = phi ptr [ null, %_ZNSt6vectorISt10unique_ptrI10aiNodeAnimSt14default_deleteIS1_EESaIS4_EE12emplace_backIJS4_EEERS4_DpOT_.exit ], [ %i.nm, %.noexc64 ]
  %i.nn = getelementptr inbounds nuw i8, ptr %i.fq, i64 1128
  store ptr %.010.i, ptr %i.nn, align 8
  %i.no = ptrtoint ptr %.sroa.10.1 to i64
  %i.np = ptrtoint ptr %.sroa.0.1 to i64          ; 2 uses
  %i.nq = sub i64 %i.no, %i.np                    ; 3 uses
  %i.nr = lshr exact i64 %i.nq, 3
  %i.ns = trunc i64 %i.nr to i32
  %i.nt = getelementptr inbounds nuw i8, ptr %i.fq, i64 1104
  store i32 %i.ns, ptr %i.nt, align 8
  %i.nu = icmp eq ptr %.sroa.0.1, %.sroa.10.1
  br i1 %i.nu, label %_ZN6Assimp11B3DImporter8to_arrayIP6aiNodeEEPT_RKSt6vectorIS4_SaIS4_EE.exit, label %.lr.ph.preheader.i65

.lr.ph.preheader.i65:                             ; preds = %_ZN6Assimp11B3DImporter8to_arrayIjEEPT_RKSt6vectorIS2_SaIS2_EE.exit
  %i.nv = call i64 @llvm.smax.i64(i64 %i.nq, i64 -1)
...
.noexc67:                                         ; preds = %.lr.ph.preheader.i65
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %i.nw, ptr align 8 %.sroa.0.1, i64 %i.nq, i1 false)
...
_ZN6Assimp11B3DImporter8to_arrayIP6aiNodeEEPT_RKSt6vectorIS4_SaIS4_EE.exit: ; preds = %.noexc67, %_ZN6Assimp11B3DImporter8to_arrayIjEEPT_RKSt6vectorIS2_SaIS2_EE.exit
  %.010.i66 = phi ptr [ null, %_ZN6Assimp11B3DImporter8to_arrayIjEEPT_RKSt6vectorIS2_SaIS2_EE.exit ], [ %i.nw, %.noexc67 ]
  %i.nx = getelementptr inbounds nuw i8, ptr %i.fq, i64 1112
  store ptr %.010.i66, ptr %i.nx, align 8
...
bb.aq:                                            ; preds = %_ZN6Assimp11B3DImporter8to_arrayIP6aiNodeEEPT_RKSt6vectorIS4_SaIS4_EE.exit
  %i.ny = ptrtoint ptr %.sroa.16.1 to i64
  %i.nz = sub i64 %i.ny, %i.np
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0.1, i64 noundef %i.nz) #25
...
bb.ar:                                            ; preds = %_ZNSt6vectorIP6aiNodeSaIS1_EED2Ev.exit
  %i.oa = ptrtoint ptr %.sroa.16105.2 to i64
  %i.ob = sub i64 %i.oa, %i.nf
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.096.2, i64 noundef %i.ob) #25
...
_ZNSt6vectorIjSaIjEED2Ev.exit:                    ; preds = %_ZNSt6vectorIP6aiNodeSaIS1_EED2Ev.exit.thread, %_ZNSt6vectorIP6aiNodeSaIS1_EED2Ev.exit, %bb.ar
  %i.oc = load ptr, ptr %3, align 8               ; 5 uses
  %.not.i70 = icmp eq ptr %i.oc, null
...
bb.as:                                            ; preds = %_ZNSt6vectorIjSaIjEED2Ev.exit
  %i.od = getelementptr inbounds nuw i8, ptr %i.oc, i64 1032
...
bb.au:                                            ; preds = %bb.at, %bb.as
  %i.og = getelementptr inbounds nuw i8, ptr %i.oc, i64 1048
  %i.oh = load ptr, ptr %i.og, align 8            ; 2 uses
  %i.oi = icmp eq ptr %i.oh, null
  br i1 %i.oi, label %bb.aw, label %bb.av

bb.av:                                            ; preds = %bb.au
  call void @_ZdaPv(ptr noundef nonnull %i.oh) #25
  br label %bb.aw

bb.aw:                                            ; preds = %bb.av, %bb.au
  %i.oj = getelementptr inbounds nuw i8, ptr %i.oc, i64 1064
  %i.ok = load ptr, ptr %i.oj, align 8            ; 2 uses
  %i.ol = icmp eq ptr %i.ok, null
  br i1 %i.ol, label %_ZNKSt14default_deleteI10aiNodeAnimEclEPS0_.exit.i, label %bb.ax

bb.ax:                                            ; preds = %bb.aw
  call void @_ZdaPv(ptr noundef nonnull %i.ok) #25
...
_ZNKSt14default_deleteI10aiNodeAnimEclEPS0_.exit.i: ; preds = %bb.ax, %bb.aw
  call void @_ZdlPvm(ptr noundef nonnull %i.oc, i64 noundef 1080) #25
...
_ZNSt10unique_ptrI10aiNodeAnimSt14default_deleteIS0_EED2Ev.exit: ; preds = %_ZNSt6vectorIjSaIjEED2Ev.exit, %_ZNKSt14default_deleteI10aiNodeAnimEclEPS0_.exit.i
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #24
  %i.om = load ptr, ptr %2, align 8               ; 2 uses
  %i.on = getelementptr inbounds nuw i8, ptr %2, i64 16 ; 2 uses
end_hunk_4
