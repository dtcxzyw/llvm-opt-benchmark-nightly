...
bb.p:                                             ; preds = %.lr.ph, %bb.p
  ...
  %22 = getelementptr inbounds nuw i8, ptr %.sroa.0604.0780, i64 8
  %i.fl = getelementptr inbounds nuw i8, ptr %.sroa.0604.0780, i64 16 ; 2 uses
  %23 = load double, ptr %22, align 8, !noalias !198 ; 2 uses
  %24 = load double, ptr %.sroa.0604.0780, align 8, !noalias !198 ; 2 uses
  %i.fm = load double, ptr %i.fl, align 8, !noalias !198 ; 2 uses
  %25 = insertelement <2 x double> poison, double %23, i64 0
  %26 = shufflevector <2 x double> %25, <2 x double> poison, <2 x i32> zeroinitializer
  %i.fn = fmul <2 x double> %26, %i.du
  %27 = insertelement <2 x double> poison, double %24, i64 0
  %i.fo = shufflevector <2 x double> %27, <2 x double> poison, <2 x i32> zeroinitializer
  %i.fp = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.dw, <2 x double> %i.fo, <2 x double> %i.fn)
  %28 = insertelement <2 x double> poison, double %i.fm, i64 0
  %29 = shufflevector <2 x double> %28, <2 x double> poison, <2 x i32> zeroinitializer
  %30 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.dt, <2 x double> %29, <2 x double> %i.fp)
  %31 = fadd <2 x double> %30, %i.dv              ; 5 uses
  %i.fq = fmul double %23, %i.dq
  %i.fr = call double @llvm.fmuladd.f64(double %i.do, double %24, double %i.fq)
  %i.fs = call double @llvm.fmuladd.f64(double %i.dr, double %i.fm, double %i.fr)
  %i.ft = fadd double %i.ds, %i.fs                ; 5 uses
  store <2 x double> %31, ptr %.sroa.0604.0780, align 8
  store double %i.ft, ptr %i.fl, align 8
  %i.fu = fcmp olt <2 x double> %31, %i.fj
  %i.fv = select <2 x i1> %i.fu, <2 x double> %31, <2 x double> %i.fj ; 3 uses
  %i.fw = fcmp olt double %i.ft, %.sroa.12621.0784
  %i.fx = select i1 %i.fw, double %i.ft, double %.sroa.12621.0784 ; 2 uses
  %i.fy = fcmp olt <2 x double> %i.fk, %31
  %i.fz = select <2 x i1> %i.fy, <2 x double> %31, <2 x double> %i.fk ; 3 uses
