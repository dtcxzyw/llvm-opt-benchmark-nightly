...
bb.ag:                                            ; preds = %bb.af
  ...
  %.sroa.0634.0.copyload = load <3 x double>, ptr %i.gj, align 8
  ...
  store <3 x double> %.sroa.0634.0.copyload, ptr %i.if, align 8
  br label %bb.ah
...
bb.am:                                            ; preds = %.lr.ph490.us, %bb.am
  ...
  %i.ja = getelementptr [24 x i8], ptr %i.ke, i64 %indvars.iv ; 3 uses
  ...
  %i.jg = getelementptr inbounds nuw i8, ptr %i.ja, i64 16
  %i.jh = load double, ptr %i.jg, align 8
  %i.ji = fptrunc double %i.jh to float
  %i.jj = fsub float %i.jc, %i.jv                 ; 2 uses
  %i.jk = fsub float %i.jf, %i.jy                 ; 2 uses
  %i.jl = fsub float %i.ji, %i.kb                 ; 2 uses
  %i.jm = fmul float %i.jk, %i.jk
  %i.jn = call float @llvm.fmuladd.f32(float %i.jj, float %i.jj, float %i.jm)
  %i.jo = call noundef float @llvm.fmuladd.f32(float %i.jl, float %i.jl, float %i.jn) ; 2 uses
  %i.jp = fcmp olt float %i.jo, %.0136486.us      ; 2 uses
  %.1137.us = select i1 %i.jp, float %i.jo, float %.0136486.us
  %i.jq = trunc nuw i64 %indvars.iv to i32
  %.1134.us = select i1 %i.jp, i32 %i.jq, i32 %.0133488.us ; 3 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond537.not = icmp eq i64 %indvars.iv.next, %i.ad
  br i1 %exitcond537.not, label %.preheader.us, label %bb.am, !llvm.loop !105

.preheader.us:                                    ; preds = %bb.am
  %i.jr = getelementptr [24 x i8], ptr %.sroa.0353.1.lcssa597, i64 %i.kd ; 2 uses
  br label %bb.s
...
.lr.ph.preheader:                                 ; preds = %.loopexit397
  ...
  %i.nv = extractelement <2 x double> %i.ni, i64 1
  br label %.lr.ph
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %_ZNSt6vectorI10aiVector3tIdESaIS1_EE9push_backEOS1_.exit
  %.0131455 = phi i32 [ %i.oq, %_ZNSt6vectorI10aiVector3tIdESaIS1_EE9push_backEOS1_.exit ], [ 0, %.lr.ph.preheader ]
...
bb.ar:                                            ; preds = %.lr.ph
  %i.ob = ptrtoint ptr %.sroa.16.1453 to i64
  %i.oc = ptrtoint ptr %.sroa.0353.2454 to i64
  %i.od = sub i64 %i.ob, %i.oc                    ; 4 uses
  %i.oe = icmp eq i64 %i.od, 9223372036854775800
  br i1 %i.oe, label %bb.as, label %_ZNKSt6vectorI10aiVector3tIdESaIS1_EE12_M_check_lenEmPKc.exit.i.i.i
...
_ZNKSt6vectorI10aiVector3tIdESaIS1_EE12_M_check_lenEmPKc.exit.i.i.i: ; preds = %bb.ar
  %i.of = sdiv exact i64 %i.od, 24                ; 3 uses
  %.sroa.speculated.i.i.i.i = call i64 @llvm.umax.i64(i64 %i.of, i64 1)
  %i.og = add nsw i64 %.sroa.speculated.i.i.i.i, %i.of ; 2 uses
  %i.oh = icmp ult i64 %i.og, %i.of
  %i.oi = call i64 @llvm.umin.i64(i64 %i.og, i64 384307168202282325)
  %i.oj = select i1 %i.oh, i64 384307168202282325, i64 %i.oi ; 3 uses
  %.not.i.i.i.i182 = icmp ne i64 %i.oj, 0
  call void @llvm.assume(i1 %.not.i.i.i.i182)
  %i.ok = mul nuw nsw i64 %i.oj, 24
  %i.ol = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.ok) #28
...
.lr.ph.i.i.i.i.i.i:                               ; preds = %.noexc184, %.lr.ph.i.i.i.i.i.i
  %.012.i.i.i.i.i.i = phi ptr [ %i.oo, %.lr.ph.i.i.i.i.i.i ], [ %i.ol, %.noexc184 ] ; 2 uses
  %.0911.i.i.i.i.i.i = phi ptr [ %i.on, %.lr.ph.i.i.i.i.i.i ], [ %.sroa.0353.2454, %.noexc184 ] ; 2 uses
  ...
  %i.on = getelementptr inbounds nuw i8, ptr %.0911.i.i.i.i.i.i, i64 24 ; 2 uses
  %i.oo = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i.i.i, i64 24 ; 2 uses
  %.not.i.i.i.i.i.i = icmp eq ptr %i.on, %.sroa.16.1453
...
_ZNSt6vectorI10aiVector3tIdESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit22.i.i.i: ; preds = %.lr.ph.i.i.i.i.i.i, %.noexc184
  %.0.lcssa.i.i.i.i.i.i = phi ptr [ %i.ol, %.noexc184 ], [ %i.oo, %.lr.ph.i.i.i.i.i.i ]
...
bb.at:                                            ; preds = %_ZNSt6vectorI10aiVector3tIdESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit22.i.i.i
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0353.2454, i64 noundef %i.od) #29
...
_ZNSt6vectorI10aiVector3tIdESaIS1_EE17_M_realloc_insertIJS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i: ; preds = %bb.at, %_ZNSt6vectorI10aiVector3tIdESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit22.i.i.i
  %i.op = getelementptr inbounds nuw [24 x i8], ptr %i.ol, i64 %i.oj
  br label %_ZNSt6vectorI10aiVector3tIdESaIS1_EE9push_backEOS1_.exit
...
_ZNSt6vectorI10aiVector3tIdESaIS1_EE9push_backEOS1_.exit: ; preds = %_ZNSt6vectorI10aiVector3tIdESaIS1_EE17_M_realloc_insertIJS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i, %bb.aq
  %.sroa.22.7 = phi ptr [ %i.op, %_ZNSt6vectorI10aiVector3tIdESaIS1_EE17_M_realloc_insertIJS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i ], [ %.sroa.22.2452, %bb.aq ] ; 2 uses
  ...
  %.sroa.0353.7 = phi ptr [ %i.ol, %_ZNSt6vectorI10aiVector3tIdESaIS1_EE17_M_realloc_insertIJS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i ], [ %.sroa.0353.2454, %bb.aq ] ; 2 uses
  %.sroa.16.3 = getelementptr inbounds nuw i8, ptr %.0.lcssa.i.i.i.i.i.i.pn, i64 24 ; 2 uses
  %i.oq = add nuw i32 %.0131455, 1                ; 2 uses
  %i.or = insertelement <2 x double> poison, double %.sroa.14.1450, i64 0
  %i.os = shufflevector <2 x double> %i.or, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ot = fmul <2 x double> %i.nq, %i.os
  %i.ou = fmul double %i.ns, %.sroa.14.1450
  %i.ov = shufflevector <2 x double> %i.nz, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ow = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.nm, <2 x double> %i.ov, <2 x double> %i.ot) ; 2 uses
  %i.ox = shufflevector <2 x double> %i.ow, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
  %i.oy = insertelement <2 x double> %i.ox, double %i.ou, i64 0
