...
bb.v:                                             ; preds = %_ZNSt12_Vector_baseIjSaIjEE13_M_deallocateEPjm.exit.i, %bb.s
  ...
  %7 = call double @llvm.fmuladd.f64(double %i.eh, double %i.ea, double %i.ec) ; 3 uses
  ...
  %i.eu = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.eq, <2 x double> %i.er, <2 x double> %i.et) ; 4 uses
  %i.ev = extractelement <2 x double> %i.eu, i64 1 ; 2 uses
  %i.ew = call double @llvm.fmuladd.f64(double %i.ed, double %i.dz, double %i.dw) ; 2 uses
  %8 = fmul double %i.ej, 0.000000e+00            ; 2 uses
  %9 = extractelement <2 x double> %i.ei, i64 1   ; 3 uses
  %10 = fadd double %9, %8
  %11 = extractelement <2 x double> %i.eo, i64 0
  %i.ex = extractelement <2 x double> %i.eo, i64 1
  %12 = fmul double %i.ex, 0.000000e+00           ; 2 uses
  %13 = fadd double %i.ev, %12
  %14 = call double @llvm.fmuladd.f64(double %9, double 0.000000e+00, double %i.ej)
  %i.ey = shufflevector <2 x double> %i.eu, <2 x double> poison, <2 x i32> zeroinitializer
  %15 = insertelement <2 x double> poison, double %10, i64 0
  %16 = insertelement <2 x double> %15, double %14, i64 1
  %17 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ey, <2 x double> zeroinitializer, <2 x double> %16)
  %18 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.p, <2 x double> zeroinitializer, <2 x double> %17) ; 4 uses
  %i.ez = insertelement <2 x double> poison, double %i.ew, i64 0
  %19 = shufflevector <2 x double> %i.ez, <2 x double> poison, <2 x i32> zeroinitializer
  %i.fa = insertelement <2 x double> %i.eu, double %7, i64 0
  %20 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.fa, <2 x double> zeroinitializer, <2 x double> %i.eo) ; 2 uses
  %21 = shufflevector <2 x double> %i.ei, <2 x double> poison, <2 x i32> zeroinitializer
  %i.fb = insertelement <2 x double> %20, double %13, i64 0
  %i.fc = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %21, <2 x double> zeroinitializer, <2 x double> %i.fb)
  %i.fd = call double @llvm.fmuladd.f64(double %9, double 0.000000e+00, double %8)
  %22 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.p, <2 x double> zeroinitializer, <2 x double> %i.fc) ; 4 uses
  %23 = extractelement <2 x double> %i.eu, i64 0
  %i.fe = fmul double %11, 0.000000e+00           ; 2 uses
  %i.ff = fadd double %23, %i.fd
  %i.fg = fadd double %7, %i.fe
  %i.fh = insertelement <2 x double> poison, double %i.fg, i64 0
  %24 = shufflevector <2 x double> %i.fh, <2 x double> %20, <2 x i32> <i32 0, i32 2>
  %i.fi = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %19, <2 x double> zeroinitializer, <2 x double> %24)
  %i.fj = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.p, <2 x double> zeroinitializer, <2 x double> %i.fi) ; 3 uses
  %25 = insertelement <2 x double> poison, double %i.r, i64 0
  %i.fk = insertelement <2 x double> %25, double %7, i64 1
  ...
  %26 = extractelement <2 x double> %i.fn, i64 1
  %27 = fadd double %i.ew, %26
  %28 = call double @llvm.fmuladd.f64(double %i.r, double 0.000000e+00, double %27) ; 3 uses
  %29 = call double @llvm.fmuladd.f64(double %i.ev, double 0.000000e+00, double %12)
  %i.fo = extractelement <2 x double> %i.ei, i64 0
  %30 = fadd double %i.fo, %29
  %i.fp = call double @llvm.fmuladd.f64(double %i.r, double 0.000000e+00, double %30) ; 4 uses
  %i.fq = fmul <2 x double> %i.fj, zeroinitializer ; 2 uses
  %i.fr = fadd <2 x double> %18, %i.fq
  %i.fs = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %22, <2 x double> zeroinitializer, <2 x double> %i.fr)
  %i.ft = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %18, <2 x double> zeroinitializer, <2 x double> %i.fj)
  %i.fu = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %22, <2 x double> zeroinitializer, <2 x double> %i.ft)
  %i.fv = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %18, <2 x double> zeroinitializer, <2 x double> %i.fq)
  %i.fw = fadd <2 x double> %22, %i.fv
  ...
  %i.fz = fmul <2 x double> %i.fj, %i.fy
  ...
  %i.gc = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.gb, <2 x double> %18, <2 x double> %i.fz)
  ...
  %i.gf = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ge, <2 x double> %22, <2 x double> %i.gc)
  ...
  %i.gk = fmul double %28, 0.000000e+00           ; 2 uses
  %i.gl = extractelement <2 x double> %i.fn, i64 0 ; 4 uses
  ...
  %i.gp = call double @llvm.fmuladd.f64(double %i.gl, double 0.000000e+00, double %28)
