...
._crit_edge:                                      ; preds = %_ZNSt6vectorI10aiVector3tIdESaIS1_EE9push_backEOS1_.exit, %.loopexit397
  ...
  %exitcond535.not = icmp eq i64 %i.nf, %i.ac
...
._crit_edge497:                                   ; preds = %._crit_edge494.us, %.lr.ph496, %.preheader391
  %.sroa.0353.1.lcssa598 = phi ptr [ %.sroa.0353.1.lcssa597, %.lr.ph496 ], [ %.sroa.0353.2.lcssa, %.preheader391 ], [ %.sroa.0353.1.lcssa597, %._crit_edge494.us ] ; 3 uses
  %.sroa.22.1.lcssa596 = phi ptr [ %.sroa.22.1.lcssa595, %.lr.ph496 ], [ %.sroa.22.2.lcssa, %.preheader391 ], [ %.sroa.22.1.lcssa595, %._crit_edge494.us ] ; 3 uses
