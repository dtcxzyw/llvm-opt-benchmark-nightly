...
bb.i:                                             ; preds = %unz64local_getLong.exit226, %unz64local_getLong.exit226.thread
  %.sroa.11.0353 = phi i64 [ 0, %unz64local_getLong.exit226 ], [ %i.db, %unz64local_getLong.exit226.thread ] ; 2 uses
  %i.dg = phi i32 [ %spec.select485, %unz64local_getLong.exit226 ], [ %i.ct, %unz64local_getLong.exit226.thread ] ; 2 uses
  %i.dh = trunc nuw i64 %.sroa.11.0353 to i32     ; 6 uses
  %9 = lshr i32 %i.dh, 16
  %10 = and i32 %9, 31
  %11 = lshr i32 %i.dh, 21
  %i.di = and i32 %11, 15
