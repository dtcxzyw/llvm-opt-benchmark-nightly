...
bb.af:                                            ; preds = %_ZNK6Assimp21SharedPostProcessInfo11GetPropertyISt6vectorISt4pairINS_11SpatialSortEfESaIS5_EEEEbPKcRPT_.exit
  ...
  %i.jb = getelementptr inbounds nuw [64 x i8], ptr %i.ja, i64 %i.iz ; 3 uses
...
.thread:                                          ; preds = %.noexc317, %bb.ab, %_ZNK6Assimp21SharedPostProcessInfo11GetPropertyISt6vectorISt4pairINS_11SpatialSortEfESaIS5_EEEEbPKcRPT_.exit
...
begin_hunk_1_@_ZN6Assimp19CalcTangentsProcess11ProcessMeshEP6aiMeshj:bb.a
  ...
  %i.mx = getelementptr inbounds nuw [4 x i8], ptr %i.mu, i64 %i.mw ; 2 uses
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %i.mx) ]
