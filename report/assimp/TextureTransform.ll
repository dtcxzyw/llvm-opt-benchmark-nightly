...
.lr.ph676:                                        ; preds = %._crit_edge631
  ...
  %i.bc = getelementptr inbounds nuw i8, ptr %i.g, i64 2
  %i.bd = getelementptr inbounds nuw i8, ptr %i.g, i64 3
  %i.be = getelementptr inbounds nuw i8, ptr %i.g, i64 4
  %i.bf = getelementptr inbounds nuw i8, ptr %i.g, i64 5
  %i.bg = getelementptr inbounds nuw i8, ptr %i.g, i64 6
  %i.bh = getelementptr inbounds nuw i8, ptr %i.g, i64 7
  br label %bb.aq

bb.b:                                             ; preds = %.lr.ph630, %._crit_edge628
  %i.bi = phi i32 [ %i.al, %.lr.ph630 ], [ %i.bo, %._crit_edge628 ]
  %indvars.iv706 = phi i64 [ 0, %.lr.ph630 ], [ %indvars.iv.next707, %._crit_edge628 ] ; 8 uses
  %i.bj = load ptr, ptr %i.am, align 8
  %i.bk = getelementptr inbounds nuw [8 x i8], ptr %i.bj, i64 %indvars.iv706
  %i.bl = load ptr, ptr %i.bk, align 8            ; 6 uses
  %i.bm = getelementptr inbounds nuw i8, ptr %i.bl, i64 8 ; 7 uses
  %i.bn = load i32, ptr %i.bm, align 8
  %.not680 = icmp eq i32 %i.bn, 0
...
bb.c:                                             ; preds = %.lr.ph627
  ...
  %i.bw = getelementptr inbounds nuw i8, ptr %i.bt, i64 1028 ; 2 uses
  %i.bx = load i32, ptr %i.bw, align 4            ; 2 uses
  %i.by = getelementptr inbounds nuw i8, ptr %i.bt, i64 1032 ; 2 uses
  %i.bz = load i32, ptr %i.by, align 8            ; 2 uses
  %i.ca = load i32, ptr %i.bm, align 8
  %.not681 = icmp eq i32 %i.ca, 0
...
._crit_edge608:                                   ; preds = %bb.o, %bb.c
  ...
  %i.cb = load i32, ptr %i.ay, align 8            ; 3 uses
  %i.cc = and i32 %i.cb, 2
  %.not260 = icmp eq i32 %i.cc, 0
  br i1 %.not260, label %bb.p, label %bb.q

.lr.ph607:                                        ; preds = %bb.c, %bb.o
  %.0206605 = phi i32 [ %i.dq, %bb.o ], [ 0, %bb.c ] ; 9 uses
  %.sroa.0532.0604 = phi ptr [ %.sroa.0532.1, %bb.o ], [ null, %bb.c ] ; 6 uses
  %i.cd = load ptr, ptr %i.bl, align 8
  %i.ce = zext i32 %.0206605 to i64               ; 2 uses
  %i.cf = getelementptr inbounds nuw [8 x i8], ptr %i.cd, i64 %i.ce
  %i.cg = load ptr, ptr %i.cf, align 8            ; 8 uses
  %i.ch = getelementptr inbounds nuw i8, ptr %i.cg, i64 1028
  %i.ci = load i32, ptr %i.ch, align 4
  %i.cj = load i32, ptr %i.bw, align 4
  %.not273 = icmp eq i32 %i.ci, %i.cj
  br i1 %.not273, label %bb.d, label %bb.o

bb.d:                                             ; preds = %.lr.ph607
  %i.ck = getelementptr inbounds nuw i8, ptr %i.cg, i64 1032
  %i.cl = load i32, ptr %i.ck, align 8
  %i.cm = load i32, ptr %i.by, align 8
  %.not274 = icmp eq i32 %i.cl, %i.cm
  br i1 %.not274, label %bb.e, label %bb.o

bb.e:                                             ; preds = %bb.d
  %i.cn = getelementptr inbounds nuw i8, ptr %i.cg, i64 4 ; 4 uses
  %i.co = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %i.cn, ptr noundef nonnull dereferenceable(12) @.str.9) #20
  %.not275 = icmp eq i32 %i.co, 0
  br i1 %.not275, label %bb.f, label %bb.g

bb.f:                                             ; preds = %bb.e
  %i.cp = getelementptr inbounds nuw i8, ptr %i.cg, i64 1048
  %i.cq = load ptr, ptr %i.cp, align 8            ; 2 uses
  %i.cr = load i32, ptr %i.cq, align 4
  store i32 %i.cr, ptr %i.ax, align 4
  br label %bb.o

bb.g:                                             ; preds = %bb.e
  %i.cs = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %i.cn, ptr noundef nonnull dereferenceable(14) @.str.12) #20
  %.not276 = icmp eq i32 %i.cs, 0
  br i1 %.not276, label %bb.h, label %bb.i

bb.h:                                             ; preds = %bb.g
  %i.ct = getelementptr inbounds nuw i8, ptr %i.cg, i64 1048
  %i.cu = load ptr, ptr %i.ct, align 8
  %i.cv = load i32, ptr %i.cu, align 4
  store i32 %i.cv, ptr %i.aw, align 8
  br label %bb.o

bb.i:                                             ; preds = %bb.g
  %i.cw = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %i.cn, ptr noundef nonnull dereferenceable(14) @.str.13) #20
  %.not277 = icmp eq i32 %i.cw, 0
  br i1 %.not277, label %bb.j, label %bb.k

bb.j:                                             ; preds = %bb.i
  %i.cx = getelementptr inbounds nuw i8, ptr %i.cg, i64 1048
  %i.cy = load ptr, ptr %i.cx, align 8
  %i.cz = load i32, ptr %i.cy, align 4
  store i32 %i.cz, ptr %i.av, align 4
  br label %bb.o

bb.k:                                             ; preds = %bb.i
  %i.da = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %i.cn, ptr noundef nonnull dereferenceable(13) @.str.14) #20
  %.not278 = icmp eq i32 %i.da, 0
  br i1 %.not278, label %bb.l, label %bb.o

bb.l:                                             ; preds = %bb.k
  %i.db = getelementptr inbounds nuw i8, ptr %i.cg, i64 1048 ; 2 uses
  %i.dc = load ptr, ptr %i.db, align 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(20) %2, ptr noundef nonnull align 1 dereferenceable(20) %i.dc, i64 20, i1 false)
  %i.dd = load i32, ptr %i.bm, align 8
  %i.de = add i32 %i.dd, -1                       ; 2 uses
  store i32 %i.de, ptr %i.bm, align 8
  %i.df = icmp ult i32 %.0206605, %i.de
  br i1 %i.df, label %.lr.ph, label %._crit_edge

.lr.ph:                                           ; preds = %bb.l, %.lr.ph
  %indvars.iv = phi i64 [ %indvars.iv.next, %.lr.ph ], [ %i.ce, %bb.l ] ; 2 uses
  %i.dg = load ptr, ptr %i.bl, align 8            ; 2 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 3 uses
  %i.dh = getelementptr inbounds nuw [8 x i8], ptr %i.dg, i64 %indvars.iv.next
  %i.di = load ptr, ptr %i.dh, align 8
  %i.dj = getelementptr inbounds nuw [8 x i8], ptr %i.dg, i64 %indvars.iv
  store ptr %i.di, ptr %i.dj, align 8
  %i.dk = load i32, ptr %i.bm, align 8
  %i.dl = zext i32 %i.dk to i64
  %i.dm = icmp samesign ult i64 %indvars.iv.next, %i.dl
  br i1 %i.dm, label %.lr.ph, label %._crit_edge, !llvm.loop !22

._crit_edge:                                      ; preds = %.lr.ph, %bb.l
  %i.dn = load ptr, ptr %i.db, align 8            ; 2 uses
  %i.do = icmp eq ptr %i.dn, null
  br i1 %i.do, label %bb.n, label %bb.m

bb.m:                                             ; preds = %._crit_edge
  call void @_ZdaPv(ptr noundef nonnull %i.dn) #18
  br label %bb.n

bb.n:                                             ; preds = %bb.m, %._crit_edge
  call void @_ZdlPvm(ptr noundef nonnull %i.cg, i64 noundef 1056) #18
  %i.dp = add i32 %.0206605, -1
  br label %bb.o

bb.o:                                             ; preds = %bb.f, %bb.j, %bb.n, %bb.k, %bb.h, %.lr.ph607, %bb.d
  %.sroa.0532.1 = phi ptr [ %i.cq, %bb.f ], [ %.sroa.0532.0604, %bb.h ], [ %.sroa.0532.0604, %bb.j ], [ %.sroa.0532.0604, %bb.n ], [ %.sroa.0532.0604, %bb.k ], [ %.sroa.0532.0604, %bb.d ], [ %.sroa.0532.0604, %.lr.ph607 ] ; 2 uses
  %.2208 = phi i32 [ %.0206605, %bb.f ], [ %.0206605, %bb.h ], [ %.0206605, %bb.j ], [ %i.dp, %bb.n ], [ %.0206605, %bb.k ], [ %.0206605, %bb.d ], [ %.0206605, %.lr.ph607 ]
  %i.dq = add i32 %.2208, 1                       ; 2 uses
  %i.dr = load i32, ptr %i.bm, align 8
  %i.ds = icmp ult i32 %i.dq, %i.dr
  br i1 %i.ds, label %.lr.ph607, label %._crit_edge608, !llvm.loop !23
...
bb.v:                                             ; preds = %bb.u
  %i.dv = load i32, ptr %i.ax, align 4
  %.sroa.speculated = call i32 @llvm.umin.i32(i32 %i.dv, i32 7)
  store i32 %.sroa.speculated, ptr %i.ax, align 4
  %i.dw = load i32, ptr %i.l, align 8             ; 3 uses
  %.not682 = icmp eq i32 %i.dw, 0
  br i1 %.not682, label %.critedge280, label %.lr.ph612

.lr.ph612:                                        ; preds = %bb.v
  %i.dx = load ptr, ptr %i.az, align 8            ; 5 uses
  %wide.trip.count = zext i32 %i.dw to i64        ; 2 uses
  %xtraiter861 = and i64 %wide.trip.count, 3      ; 3 uses
  %i.dy = icmp ult i32 %i.dw, 4
  br i1 %i.dy, label %.epil.preheader, label %.lr.ph612.new
