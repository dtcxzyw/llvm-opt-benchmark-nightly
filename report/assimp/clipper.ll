...
begin_hunk_0_@_ZNK10ClipperLib7Clipper14IsContributingERKNS_5TEdgeE:bb.a
  ...
  %.val = load i32, ptr %3, align 4               ; 3 uses
  %.val36 = load i32, ptr %2, align 8             ; 3 uses
...
bb.ab:                                            ; preds = %bb.z, %bb.aa, %bb.u, %bb.x, %bb.w
  ...
  %i.bz = getelementptr inbounds nuw i8, ptr %0, i64 124
  %.val = load i32, ptr %i.bz, align 4            ; 4 uses
  %.val223 = load i32, ptr %i.by, align 8         ; 4 uses
  %.0188 = select i1 %i.bx, i32 %.val, i32 %.val223
  %.0190 = select i1 %i.bx, i32 %.val223, i32 %.val
  %4 = load i32, ptr %i.n, align 8                ; 3 uses
  %5 = icmp eq i32 %4, 0                          ; 2 uses
  %.0187 = select i1 %5, i32 %.val, i32 %.val223
  %.0189 = select i1 %5, i32 %.val223, i32 %.val
  %i.ca = getelementptr inbounds nuw i8, ptr %1, i64 68
  %i.cb = load i32, ptr %i.ca, align 4            ; 3 uses
  switch i32 %.0190, label %bb.ae [
    i32 2, label %bb.ac
    i32 3, label %bb.ad
  ]
end_hunk_5
...
begin_hunk_8_@_ZN10ClipperLib7Clipper10JoinPointsEPNS_4JoinEPNS_6OutRecES4_:bb.a
  ...
  br i1 %or.cond302, label %.critedge4.preheader, label %bb.i, !llvm.loop !152

.critedge4.preheader:                             ; preds = %bb.i
  %4 = getelementptr inbounds nuw i8, ptr %.0248, i64 16
  br label %.critedge4

.critedge4:                                       ; preds = %.critedge4.preheader, %.critedge4
  %.1250 = phi ptr [ %i.bj, %.critedge4 ], [ %i.a, %.critedge4.preheader ] ; 5 uses
...
.critedge6:                                       ; preds = %.critedge4
  %5 = getelementptr inbounds nuw i8, ptr %.1250, i64 16
...
begin_hunk_10_@_ZN10ClipperLib7Clipper10JoinPointsEPNS_4JoinEPNS_6OutRecES4_:bb.a
  ...
  br i1 %or.cond307, label %.critedge8.preheader, label %.preheader334, !llvm.loop !154

.critedge8.preheader:                             ; preds = %.preheader334
  %6 = getelementptr inbounds nuw i8, ptr %.0254, i64 16
  br label %.critedge8

.critedge8:                                       ; preds = %.critedge8.preheader, %.critedge8
  %.1256 = phi ptr [ %i.bv, %.critedge8 ], [ %i.c, %.critedge8.preheader ] ; 4 uses
...
.critedge10:                                      ; preds = %.critedge8
  %7 = getelementptr inbounds nuw i8, ptr %.1256, i64 16
...
bb.u:                                             ; preds = %bb.s
  ...
  %or.cond313 = or i1 %.not293, %.not294
  br i1 %or.cond313, label %8, label %bb.v

8:                                                ; preds = %bb.u
  br label %bb.v

bb.v:                                             ; preds = %bb.u, %bb.t, %8, %bb.r
  %.sroa.8.0.in = phi ptr [ %7, %8 ], [ %4, %bb.r ], [ %6, %bb.t ], [ %5, %bb.u ]
  %.sroa.0.0 = phi i64 [ %i.ce, %8 ], [ %i.cb, %bb.r ], [ %i.cd, %bb.t ], [ %i.cc, %bb.u ]
  %.0260.in = phi i1 [ %i.cg, %8 ], [ %i.ci, %bb.r ], [ %i.cj, %bb.t ], [ %i.cf, %bb.u ]
