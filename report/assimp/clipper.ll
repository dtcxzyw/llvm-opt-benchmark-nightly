...
_ZNSt6vectorIS_IN10ClipperLib8IntPointESaIS1_EESaIS3_EE7reserveEm.exit162: ; preds = %bb.y, %_ZNSt12_Vector_baseISt6vectorIN10ClipperLib8IntPointESaIS2_EESaIS4_EE13_M_deallocateEPS4_m.exit.i159
  ...
  %.not314 = icmp eq i64 %i.hg, 0
  br i1 %.not314, label %._crit_edge308, label %.preheader.lr.ph

.preheader.lr.ph:                                 ; preds = %_ZNSt6vectorIS_IN10ClipperLib8IntPointESaIS1_EESaIS3_EE7reserveEm.exit162
  %.not315 = icmp eq ptr %i.b, %i.c
  %i.hh = getelementptr inbounds nuw i8, ptr %8, i64 16 ; 7 uses
  %i.hi = getelementptr inbounds nuw i8, ptr %8, i64 8 ; 9 uses
  br i1 %.not315, label %._crit_edge308, label %.preheader

.preheader:                                       ; preds = %.preheader.lr.ph, %._crit_edge306.us
  %.065307 = phi i64 [ %i.hj, %._crit_edge306.us ], [ 0, %.preheader.lr.ph ] ; 2 uses
  %i.hj = add nuw i64 %.065307, 1                 ; 3 uses
  br label %_ZNSt12_Vector_baseIN10ClipperLib8IntPointESaIS1_EE11_M_allocateEm.exit.i164
...
_ZNSt12_Vector_baseIN10ClipperLib8IntPointESaIS1_EE11_M_allocateEm.exit.i164: ; preds = %.preheader, %_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EED2Ev.exit247
  %.0305 = phi i64 [ 0, %.preheader ], [ %i.ia, %_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EED2Ev.exit247 ] ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %8) #30
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %8, i8 0, i64 24, i1 false)
  %i.hk = invoke noalias noundef nonnull dereferenceable(64) ptr @_Znwm(i64 noundef 64) #32
          to label %_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EE9push_backERKS1_.exit195 unwind label %.loopexit.split.us ; 7 uses
...
_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EE9push_backERKS1_.exit195: ; preds = %_ZNSt12_Vector_baseIN10ClipperLib8IntPointESaIS1_EE11_M_allocateEm.exit.i164
  ...
  %i.hm = urem i64 %.065307, %i.n                 ; 2 uses
  %i.hn = load ptr, ptr %5, align 8               ; 2 uses
  %i.ho = urem i64 %.0305, %i.g                   ; 2 uses
  ...
  %i.ia = add nuw i64 %.0305, 1                   ; 3 uses
  ...
  %.not.i196 = icmp eq ptr %i.hx, %.pre332
  br i1 %.not.i196, label %bb.ab, label %bb.aa

bb.aa:                                            ; preds = %_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EE9push_backERKS1_.exit195
...
bb.ab:                                            ; preds = %_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EE9push_backERKS1_.exit195
  %i.if = load ptr, ptr %8, align 8               ; 5 uses
  %i.ig = ptrtoint ptr %.pre332 to i64
  %i.ih = ptrtoint ptr %i.if to i64
  %i.ii = sub i64 %i.ig, %i.ih                    ; 4 uses
  %i.ij = icmp eq i64 %i.ii, 9223372036854775792
  br i1 %i.ij, label %.split316.us.invoke, label %_ZNKSt6vectorIN10ClipperLib8IntPointESaIS1_EE12_M_check_lenEmPKc.exit.i.i197

_ZNKSt6vectorIN10ClipperLib8IntPointESaIS1_EE12_M_check_lenEmPKc.exit.i.i197: ; preds = %bb.ab
  %i.ik = ashr exact i64 %i.ii, 4                 ; 3 uses
  %.sroa.speculated.i.i.i198 = call i64 @llvm.umax.i64(i64 %i.ik, i64 1)
  %i.il = add nsw i64 %.sroa.speculated.i.i.i198, %i.ik ; 2 uses
  ...
  %.not.i.i.i199 = icmp ne i64 %i.io, 0
  ...
  %i.iq = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.ip) #32
          to label %.noexc210 unwind label %.loopexit.split.us ; 5 uses
...
.noexc210:                                        ; preds = %_ZNKSt6vectorIN10ClipperLib8IntPointESaIS1_EE12_M_check_lenEmPKc.exit.i.i197
  ...
  %.not10.i.i.i.i.i200 = icmp eq ptr %i.if, %.pre332
...
.lr.ph.i.i.i.i.i201:                              ; preds = %.noexc210, %.lr.ph.i.i.i.i.i201
  %.012.i.i.i.i.i202 = phi ptr [ %i.it, %.lr.ph.i.i.i.i.i201 ], [ %i.iq, %.noexc210 ] ; 2 uses
  %.0911.i.i.i.i.i203 = phi ptr [ %i.is, %.lr.ph.i.i.i.i.i201 ], [ %i.if, %.noexc210 ] ; 2 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.012.i.i.i.i.i202, ptr noundef nonnull align 8 dereferenceable(16) %.0911.i.i.i.i.i203, i64 16, i1 false), !alias.scope !307
  %i.is = getelementptr inbounds nuw i8, ptr %.0911.i.i.i.i.i203, i64 16 ; 2 uses
  %i.it = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i.i202, i64 16 ; 2 uses
  %.not.i.i.i.i.i204 = icmp eq ptr %i.is, %.pre332
...
_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit22.i.i205: ; preds = %.lr.ph.i.i.i.i.i201, %.noexc210
  %.0.lcssa.i.i.i.i.i206 = phi ptr [ %i.iq, %.noexc210 ], [ %i.it, %.lr.ph.i.i.i.i.i201 ]
  %i.iu = getelementptr inbounds nuw i8, ptr %.0.lcssa.i.i.i.i.i206, i64 16 ; 2 uses
  %.not.i23.i.i207 = icmp eq ptr %i.if, null
  br i1 %.not.i23.i.i207, label %_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i208, label %bb.ac

bb.ac:                                            ; preds = %_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit22.i.i205
...
_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i208: ; preds = %bb.ac, %_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit22.i.i205
  %.pre333 = phi ptr [ %.pre333.pre, %bb.ac ], [ %i.hy, %_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit22.i.i205 ]
...
_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EE9push_backERKS1_.exit211: ; preds = %_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i208, %bb.aa
  %i.iw = phi ptr [ %i.iv, %_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i208 ], [ %.pre334, %bb.aa ] ; 4 uses
  %i.ix = phi ptr [ %i.iu, %_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i208 ], [ %i.ie, %bb.aa ] ; 3 uses
  %i.iy = phi ptr [ %.pre333, %_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i208 ], [ %i.hy, %bb.aa ]
  ...
  %.not.i212 = icmp eq ptr %i.ix, %i.iw
  br i1 %.not.i212, label %bb.ae, label %bb.ad

bb.ad:                                            ; preds = %_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EE9push_backERKS1_.exit211
...
bb.ae:                                            ; preds = %_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EE9push_backERKS1_.exit211
  ...
  br i1 %i.jh, label %.split316.us.invoke, label %_ZNKSt6vectorIN10ClipperLib8IntPointESaIS1_EE12_M_check_lenEmPKc.exit.i.i213

_ZNKSt6vectorIN10ClipperLib8IntPointESaIS1_EE12_M_check_lenEmPKc.exit.i.i213: ; preds = %bb.ae
  %i.ji = ashr exact i64 %i.jg, 4                 ; 3 uses
  %.sroa.speculated.i.i.i214 = call i64 @llvm.umax.i64(i64 %i.ji, i64 1)
  %i.jj = add nsw i64 %.sroa.speculated.i.i.i214, %i.ji ; 2 uses
  ...
  %.not.i.i.i215 = icmp ne i64 %i.jm, 0
  ...
  %i.jo = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.jn) #32
          to label %.noexc226 unwind label %.loopexit.split.us ; 6 uses
...
.noexc226:                                        ; preds = %_ZNKSt6vectorIN10ClipperLib8IntPointESaIS1_EE12_M_check_lenEmPKc.exit.i.i213
  ...
  %.not10.i.i.i.i.i216 = icmp eq ptr %i.jd, %i.iw
...
.lr.ph.i.i.i.i.i217:                              ; preds = %.noexc226, %.lr.ph.i.i.i.i.i217
  %.012.i.i.i.i.i218 = phi ptr [ %i.jr, %.lr.ph.i.i.i.i.i217 ], [ %i.jo, %.noexc226 ] ; 2 uses
  %.0911.i.i.i.i.i219 = phi ptr [ %i.jq, %.lr.ph.i.i.i.i.i217 ], [ %i.jd, %.noexc226 ] ; 2 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.012.i.i.i.i.i218, ptr noundef nonnull align 8 dereferenceable(16) %.0911.i.i.i.i.i219, i64 16, i1 false), !alias.scope !311
  %i.jq = getelementptr inbounds nuw i8, ptr %.0911.i.i.i.i.i219, i64 16 ; 2 uses
  %i.jr = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i.i218, i64 16 ; 2 uses
  %.not.i.i.i.i.i220 = icmp eq ptr %i.jq, %i.iw
...
_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit22.i.i221: ; preds = %.lr.ph.i.i.i.i.i217, %.noexc226
  %.0.lcssa.i.i.i.i.i222 = phi ptr [ %i.jo, %.noexc226 ], [ %i.jr, %.lr.ph.i.i.i.i.i217 ]
  %i.js = getelementptr inbounds nuw i8, ptr %.0.lcssa.i.i.i.i.i222, i64 16 ; 2 uses
  %.not.i23.i.i223 = icmp eq ptr %i.jd, null
  br i1 %.not.i23.i.i223, label %_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i224, label %bb.af

bb.af:                                            ; preds = %_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit22.i.i221
...
_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i224: ; preds = %bb.af, %_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit22.i.i221
...
_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EE9push_backERKS1_.exit227: ; preds = %_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i224, %bb.ad
  %i.ju = phi ptr [ %i.jo, %_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i224 ], [ %.pre335, %bb.ad ] ; 6 uses
  %i.jv = phi ptr [ %i.js, %_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i224 ], [ %i.jc, %bb.ad ] ; 3 uses
  ...
  br i1 %i.kb, label %_ZN10ClipperLib11ReversePathERSt6vectorINS_8IntPointESaIS1_EE.exit, label %bb.ag

bb.ag:                                            ; preds = %_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EE9push_backERKS1_.exit227
  %i.kc = add nsw i64 %i.jz, -1
  %wide.trip.count.i.i = and i64 %i.jz, 2147483647
  br label %bb.ah

bb.ah:                                            ; preds = %bb.ah, %bb.ag
  %indvars.iv.i.i = phi i64 [ 0, %bb.ag ], [ %indvars.iv.next.i.i, %bb.ah ] ; 3 uses
  %.023.i.i = phi i64 [ %i.kc, %bb.ag ], [ %indvars.iv.i.i, %bb.ah ]
  %.01821.i.i = phi double [ 0.000000e+00, %bb.ag ], [ %i.ks, %bb.ah ]
  %sext.i.i = shl i64 %.023.i.i, 32
  %i.kd = ashr exact i64 %sext.i.i, 28
  %i.ke = getelementptr inbounds nuw i8, ptr %i.ju, i64 %i.kd ; 2 uses
  %i.kf = load i64, ptr %i.ke, align 8
  %i.kg = sitofp i64 %i.kf to double
  %i.kh = getelementptr inbounds nuw [16 x i8], ptr %i.ju, i64 %indvars.iv.i.i ; 2 uses
  ...
  %i.ks = call double @llvm.fmuladd.f64(double %i.kk, double %i.kr, double %.01821.i.i) ; 2 uses
  %indvars.iv.next.i.i = add nuw nsw i64 %indvars.iv.i.i, 1 ; 2 uses
  %exitcond.not.i.i = icmp eq i64 %indvars.iv.next.i.i, %wide.trip.count.i.i
  br i1 %exitcond.not.i.i, label %_ZN10ClipperLib11OrientationERKSt6vectorINS_8IntPointESaIS1_EE.exit, label %bb.ah, !llvm.loop !8

_ZN10ClipperLib11OrientationERKSt6vectorINS_8IntPointESaIS1_EE.exit: ; preds = %bb.ah
  %i.kt = fmul double %i.ks, -5.000000e-01
  %i.ku = fcmp ult double %i.kt, 0.000000e+00
  br i1 %i.ku, label %bb.ai, label %_ZN10ClipperLib11ReversePathERSt6vectorINS_8IntPointESaIS1_EE.exit

bb.ai:                                            ; preds = %_ZN10ClipperLib11OrientationERKSt6vectorINS_8IntPointESaIS1_EE.exit
  %i.kv = icmp ne ptr %i.ju, %i.jv
  %.sroa.0.08.i.i.i = getelementptr inbounds i8, ptr %i.jv, i64 -16 ; 2 uses
  %i.kw = icmp ult ptr %i.ju, %.sroa.0.08.i.i.i
  %or.cond.i.i.i = select i1 %i.kv, i1 %i.kw, i1 false
  br i1 %or.cond.i.i.i, label %.lr.ph.i.i.i228, label %_ZN10ClipperLib11ReversePathERSt6vectorINS_8IntPointESaIS1_EE.exit

.lr.ph.i.i.i228:                                  ; preds = %bb.ai, %.lr.ph.i.i.i228
  %.sroa.0.010.i.i.i = phi ptr [ %.sroa.0.0.i.i.i, %.lr.ph.i.i.i228 ], [ %.sroa.0.08.i.i.i, %bb.ai ] ; 3 uses
  %.sroa.05.09.i.i.i = phi ptr [ %i.kx, %.lr.ph.i.i.i228 ], [ %i.ju, %bb.ai ] ; 3 uses
  ...
  %i.kx = getelementptr inbounds nuw i8, ptr %.sroa.05.09.i.i.i, i64 16 ; 2 uses
  %.sroa.0.0.i.i.i = getelementptr inbounds i8, ptr %.sroa.0.010.i.i.i, i64 -16 ; 2 uses
  %i.ky = icmp ult ptr %i.kx, %.sroa.0.0.i.i.i
  br i1 %i.ky, label %.lr.ph.i.i.i228, label %_ZN10ClipperLib11ReversePathERSt6vectorINS_8IntPointESaIS1_EE.exit, !llvm.loop !170

_ZN10ClipperLib11ReversePathERSt6vectorINS_8IntPointESaIS1_EE.exit: ; preds = %.lr.ph.i.i.i228, %bb.ai, %_ZN10ClipperLib11OrientationERKSt6vectorINS_8IntPointESaIS1_EE.exit, %_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EE9push_backERKS1_.exit227
  %i.kz = load ptr, ptr %i.fs, align 8            ; 6 uses
  %i.la = load ptr, ptr %i.gg, align 8
  %.not.i231 = icmp eq ptr %i.kz, %i.la
  br i1 %.not.i231, label %bb.al, label %bb.aj

bb.aj:                                            ; preds = %_ZN10ClipperLib11ReversePathERSt6vectorINS_8IntPointESaIS1_EE.exit
  ...
  %.not.i.i.i.i.i232 = icmp eq ptr %i.lb, %i.lc
  br i1 %.not.i.i.i.i.i232, label %.noexc243, label %bb.ak

bb.ak:                                            ; preds = %bb.aj
  %i.lg = icmp ugt i64 %i.lf, 9223372036854775792
  br i1 %i.lg, label %.noexc.i.i.i241, label %_ZNSt15__new_allocatorIN10ClipperLib8IntPointEE8allocateEmPKv.exit.i.i.i.i.i233, !prof !60

_ZNSt15__new_allocatorIN10ClipperLib8IntPointEE8allocateEmPKv.exit.i.i.i.i.i233: ; preds = %bb.ak
  %i.lh = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.lf) #32
          to label %.noexc243 unwind label %.loopexit.split.us

.noexc243:                                        ; preds = %_ZNSt15__new_allocatorIN10ClipperLib8IntPointEE8allocateEmPKv.exit.i.i.i.i.i233, %bb.aj
  %i.li = phi ptr [ null, %bb.aj ], [ %i.lh, %_ZNSt15__new_allocatorIN10ClipperLib8IntPointEE8allocateEmPKv.exit.i.i.i.i.i233 ] ; 5 uses
  ...
  %.not7.i.i.i.i.i.i234 = icmp eq ptr %i.lm, %i.ln
...
.lr.ph.i.i.i.i.i.i235:                            ; preds = %.noexc243, %.lr.ph.i.i.i.i.i.i235
  %.09.i.i.i.i.i.i236 = phi ptr [ %i.lp, %.lr.ph.i.i.i.i.i.i235 ], [ %i.li, %.noexc243 ] ; 2 uses
  %.sroa.04.08.i.i.i.i.i.i237 = phi ptr [ %i.lo, %.lr.ph.i.i.i.i.i.i235 ], [ %i.lm, %.noexc243 ] ; 2 uses
  ...
  %i.lo = getelementptr inbounds nuw i8, ptr %.sroa.04.08.i.i.i.i.i.i237, i64 16 ; 2 uses
  %i.lp = getelementptr inbounds nuw i8, ptr %.09.i.i.i.i.i.i236, i64 16 ; 2 uses
  %.not.i.i.i.i.i.i238 = icmp eq ptr %i.lo, %i.ln
...
_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EEC2ERKS3_.exit.i239: ; preds = %.lr.ph.i.i.i.i.i.i235, %.noexc243
  %.0.lcssa.i.i.i.i.i.i240 = phi ptr [ %i.li, %.noexc243 ], [ %i.lp, %.lr.ph.i.i.i.i.i.i235 ]
  store ptr %.0.lcssa.i.i.i.i.i.i240, ptr %i.lj, align 8
...
bb.al:                                            ; preds = %_ZN10ClipperLib11ReversePathERSt6vectorINS_8IntPointESaIS1_EE.exit
  invoke void @_ZNSt6vectorIS_IN10ClipperLib8IntPointESaIS1_EESaIS3_EE17_M_realloc_insertIJRKS3_EEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_(ptr noundef nonnull align 8 dereferenceable(24) %2, ptr %i.kz, ptr noundef nonnull align 8 dereferenceable(24) %8)
          to label %._ZNSt6vectorIS_IN10ClipperLib8IntPointESaIS1_EESaIS3_EE9push_backERKS3_.exit245_crit_edge unwind label %.loopexit.split.us

._ZNSt6vectorIS_IN10ClipperLib8IntPointESaIS1_EESaIS3_EE9push_backERKS3_.exit245_crit_edge: ; preds = %bb.al
...
_ZNSt6vectorIS_IN10ClipperLib8IntPointESaIS1_EESaIS3_EE9push_backERKS3_.exit245: ; preds = %._ZNSt6vectorIS_IN10ClipperLib8IntPointESaIS1_EESaIS3_EE9push_backERKS3_.exit245_crit_edge, %_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EEC2ERKS3_.exit.i239
  %i.ls = phi ptr [ %.pre336, %._ZNSt6vectorIS_IN10ClipperLib8IntPointESaIS1_EESaIS3_EE9push_backERKS3_.exit245_crit_edge ], [ %i.lm, %_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EEC2ERKS3_.exit.i239 ] ; 3 uses
  %.not.i.i.i246 = icmp eq ptr %i.ls, null
  br i1 %.not.i.i.i246, label %_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EED2Ev.exit247, label %bb.am

bb.am:                                            ; preds = %_ZNSt6vectorIS_IN10ClipperLib8IntPointESaIS1_EESaIS3_EE9push_backERKS3_.exit245
...
_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EED2Ev.exit247: ; preds = %bb.am, %_ZNSt6vectorIS_IN10ClipperLib8IntPointESaIS1_EESaIS3_EE9push_backERKS3_.exit245
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #30
  %exitcond329.not = icmp eq i64 %i.ia, %i.g
  br i1 %exitcond329.not, label %._crit_edge306.us, label %_ZNSt12_Vector_baseIN10ClipperLib8IntPointESaIS1_EE11_M_allocateEm.exit.i164, !llvm.loop !315

._crit_edge306.us:                                ; preds = %_ZNSt6vectorIN10ClipperLib8IntPointESaIS1_EED2Ev.exit247
  %exitcond344.not = icmp eq i64 %i.hj, %i.hg
  br i1 %exitcond344.not, label %._crit_edge308, label %.preheader, !llvm.loop !316

.loopexit.split.us:                               ; preds = %bb.al, %_ZNSt15__new_allocatorIN10ClipperLib8IntPointEE8allocateEmPKv.exit.i.i.i.i.i233, %_ZNKSt6vectorIN10ClipperLib8IntPointESaIS1_EE12_M_check_lenEmPKc.exit.i.i213, %_ZNKSt6vectorIN10ClipperLib8IntPointESaIS1_EE12_M_check_lenEmPKc.exit.i.i197, %_ZNSt12_Vector_baseIN10ClipperLib8IntPointESaIS1_EE11_M_allocateEm.exit.i164
...
.lr.ph.i.i.i:                                     ; preds = %._crit_edge308, %_ZSt8_DestroyISt6vectorIN10ClipperLib8IntPointESaIS2_EEEvPT_.exit.i.i.i
  %.05.i.i.i = phi ptr [ %19, %_ZSt8_DestroyISt6vectorIN10ClipperLib8IntPointESaIS2_EEEvPT_.exit.i.i.i ], [ %9, %._crit_edge308 ] ; 3 uses
...
_ZSt8_DestroyIPSt6vectorIN10ClipperLib8IntPointESaIS2_EES4_EvT_S6_RSaIT0_E.exit.i: ; preds = %_ZSt8_DestroyIPSt6vectorIN10ClipperLib8IntPointESaIS2_EES4_EvT_S6_RSaIT0_E.exitthread-pre-split.i, %._crit_edge308
  %20 = phi ptr [ %.pr.i, %_ZSt8_DestroyIPSt6vectorIN10ClipperLib8IntPointESaIS2_EES4_EvT_S6_RSaIT0_E.exitthread-pre-split.i ], [ %9, %._crit_edge308 ] ; 3 uses
...
26:                                               ; preds = %.loopexit.split-lp, %.loopexit.split.us
...
!307 = !{!308, !310}
!308 = distinct !{!308, !309, !"_ZSt19__relocate_object_aIN10ClipperLib8IntPointES1_SaIS1_EEvPT_PT0_RT1_: argument 0"}
!309 = distinct !{!309, !"_ZSt19__relocate_object_aIN10ClipperLib8IntPointES1_SaIS1_EEvPT_PT0_RT1_"}
!310 = distinct !{!310, !309, !"_ZSt19__relocate_object_aIN10ClipperLib8IntPointES1_SaIS1_EEvPT_PT0_RT1_: argument 1"}
!311 = !{!312, !314}
!312 = distinct !{!312, !313, !"_ZSt19__relocate_object_aIN10ClipperLib8IntPointES1_SaIS1_EEvPT_PT0_RT1_: argument 0"}
!313 = distinct !{!313, !"_ZSt19__relocate_object_aIN10ClipperLib8IntPointES1_SaIS1_EEvPT_PT0_RT1_"}
!314 = distinct !{!314, !313, !"_ZSt19__relocate_object_aIN10ClipperLib8IntPointES1_SaIS1_EEvPT_PT0_RT1_: argument 1"}
!315 = distinct !{!315, !4}
!316 = distinct !{!316, !4}
!317 = distinct !{!317, !4}
!318 = distinct !{!318, !4}
