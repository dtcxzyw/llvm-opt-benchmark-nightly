...
bb.bj:                                            ; preds = %bb.be
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %11, ptr noundef nonnull align 8 dereferenceable(16) %i.kx, i64 16, i1 false)
...
._crit_edge1234:                                  ; preds = %_ZNSt6vectorI9aiColor4tIfESaIS1_EE9push_backERKS1_.exit, %bb.bj
  %.sroa.45.5.lcssa = phi ptr [ %.sroa.45.31242, %bb.bj ], [ %.sroa.45.19, %_ZNSt6vectorI9aiColor4tIfESaIS1_EE9push_backERKS1_.exit ]
  %.sroa.0440.5.lcssa = phi ptr [ %.sroa.0440.31243, %bb.bj ], [ %.sroa.0440.18, %_ZNSt6vectorI9aiColor4tIfESaIS1_EE9push_backERKS1_.exit ]
  %.sroa.18.2.lcssa = phi ptr [ %.sroa.18.11244, %bb.bj ], [ %.sroa.18.10, %_ZNSt6vectorI9aiColor4tIfESaIS1_EE9push_backERKS1_.exit ]
  %.sroa.37.5.lcssa = phi ptr [ %.sroa.37.31245, %bb.bj ], [ %.sroa.37.18, %_ZNSt6vectorI9aiColor4tIfESaIS1_EE9push_backERKS1_.exit ]
  %.sroa.22.2.lcssa = phi ptr [ %.sroa.22.11246, %bb.bj ], [ %.sroa.22.11, %_ZNSt6vectorI9aiColor4tIfESaIS1_EE9push_backERKS1_.exit ]
  %.sroa.0485.5.lcssa = phi ptr [ %.sroa.0485.31247, %bb.bj ], [ %.sroa.0485.19, %_ZNSt6vectorI9aiColor4tIfESaIS1_EE9push_backERKS1_.exit ]
...
.noexc289:                                        ; preds = %_ZNKSt6vectorI9aiColor4tIfESaIS1_EE12_M_check_lenEmPKc.exit.i.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %i.mj, ptr noundef nonnull align 4 dereferenceable(16) %11, i64 16, i1 false)
...
begin_hunk_9_@_ZN6Assimp11AMFImporter24Postprocess_BuildMeshSetERK7AMFMeshRKSt6vectorI10aiVector3tIfESaIS6_EERKS4_IP8AMFColorSaISC_EEPKSB_RS4_IP6aiMeshSaISK_EER6aiNode:bb.a
  ...
  br i1 %i.mu, label %bb.bk, label %._crit_edge1234, !llvm.loop !70
...
12:                                               ; preds = %.loopexit587.a, %.loopexit.split-lp588, %bb.bi, %bb.bh
  %.sroa.45.7 = phi ptr [ %.sroa.45.31242, %bb.bi ], [ %.sroa.45.31242, %bb.bh ], [ %.sroa.45.6.ph, %.loopexit587.a ], [ %.sroa.45.6.ph589, %.loopexit.split-lp588 ]
  %.sroa.0440.6 = phi ptr [ %.sroa.0440.31243, %bb.bi ], [ %.sroa.0440.31243, %bb.bh ], [ %.sroa.0440.51225, %.loopexit587.a ], [ %.sroa.0440.51225, %.loopexit.split-lp588 ]
  %.sroa.37.6 = phi ptr [ %.sroa.37.31245, %bb.bi ], [ %.sroa.37.31245, %bb.bh ], [ %.sroa.37.51227, %.loopexit587.a ], [ %.sroa.37.51227, %.loopexit.split-lp588 ]
  %.sroa.0485.7 = phi ptr [ %.sroa.0485.31247, %bb.bi ], [ %.sroa.0485.31247, %bb.bh ], [ %.sroa.0485.6.ph, %.loopexit587.a ], [ %.sroa.0485.6.ph590, %.loopexit.split-lp588 ]
  %.pn157 = phi { ptr, i32 } [ %i.kw, %bb.bi ], [ %i.kv, %bb.bh ], [ %lpad.loopexit591, %.loopexit587.a ], [ %lpad.loopexit.split-lp592, %.loopexit.split-lp588 ]
  call void @llvm.lifetime.end.p0(ptr nonnull %11)
  br label %.loopexit.split-lp599

bb.bu:                                            ; preds = %._crit_edge1234, %.lr.ph1250
...
.loopexit.split-lp599:                            ; preds = %.loopexit620, %.loopexit.split-lp621, %.loopexit584, %.loopexit.split-lp, %.loopexit615, %.loopexit.split-lp616, %.loopexit603, %.loopexit.split-lp604, %.loopexit598.a, %.loopexit.split-lp599.loopexit.split-lp, %.loopexit.split-lp599.loopexit, %bb.ak, %bb.de, %bb.do, %12, %bb.aj
  %.sroa.45.15 = phi ptr [ %.sroa.45.0, %bb.aj ], [ %.sroa.45.18, %.loopexit.split-lp604 ], [ %.sroa.45.7, %12 ], [ %.sroa.45.14, %bb.de ], [ %.sroa.45.12.ph585, %.loopexit.split-lp ], [ %.sroa.45.14, %bb.do ], [ %.sroa.45.10.lcssa, %.loopexit.split-lp616 ], [ %.sroa.45.1.ph.ph, %.loopexit.split-lp599.loopexit.split-lp ], [ %.sroa.45.17, %bb.ak ], [ %.sroa.22.01208, %.loopexit598.a ], [ %.sroa.0485.16572, %.loopexit.split-lp599.loopexit ], [ %.sroa.45.18, %.loopexit603 ], [ %.sroa.45.9.ph, %.loopexit615 ], [ %.sroa.45.12.ph, %.loopexit584 ], [ %.sroa.45.14, %.loopexit620 ], [ %.sroa.45.14, %.loopexit.split-lp621 ]
  %.sroa.0464.3 = phi ptr [ %.sroa.0464.0, %bb.aj ], [ null, %.loopexit.split-lp604 ], [ null, %12 ], [ %.sroa.0464.2, %bb.de ], [ %.sroa.0464.4, %.loopexit.split-lp ], [ %.sroa.0464.2, %bb.do ], [ %.sroa.0464.4, %.loopexit.split-lp616 ], [ null, %.loopexit.split-lp599.loopexit.split-lp ], [ null, %bb.ak ], [ null, %.loopexit598.a ], [ null, %.loopexit.split-lp599.loopexit ], [ null, %.loopexit603 ], [ %.sroa.0464.1.ph, %.loopexit615 ], [ %.sroa.0464.4, %.loopexit584 ], [ %.sroa.0464.2, %.loopexit620 ], [ %.sroa.0464.2, %.loopexit.split-lp621 ] ; 3 uses
  %.sroa.31.3 = phi ptr [ %.sroa.31.0, %bb.aj ], [ null, %.loopexit.split-lp604 ], [ null, %12 ], [ %.sroa.31.2, %bb.de ], [ %.sroa.17.1, %.loopexit.split-lp ], [ %.sroa.31.2, %bb.do ], [ %.sroa.17.1, %.loopexit.split-lp616 ], [ null, %.loopexit.split-lp599.loopexit.split-lp ], [ null, %bb.ak ], [ null, %.loopexit598.a ], [ null, %.loopexit.split-lp599.loopexit ], [ null, %.loopexit603 ], [ %.sroa.31.1.ph, %.loopexit615 ], [ %.sroa.17.1, %.loopexit584 ], [ %.sroa.31.2, %.loopexit620 ], [ %.sroa.31.2, %.loopexit.split-lp621 ]
  %.sroa.0440.14 = phi ptr [ %.sroa.0440.0, %bb.aj ], [ %.sroa.0440.21201, %.loopexit.split-lp604 ], [ %.sroa.0440.6, %12 ], [ %.sroa.0440.13, %bb.de ], [ %.sroa.0440.11.ph, %.loopexit.split-lp ], [ %.sroa.0440.13, %bb.do ], [ %.sroa.0440.9.lcssa, %.loopexit.split-lp616 ], [ %.sroa.0440.1.ph.ph, %.loopexit.split-lp599.loopexit.split-lp ], [ %.sroa.0440.15, %bb.ak ], [ %.sroa.0440.21201, %.loopexit598.a ], [ %.sroa.0440.15, %.loopexit.split-lp599.loopexit ], [ %.sroa.0440.21201, %.loopexit603 ], [ %.sroa.0440.8.ph, %.loopexit615 ], [ %.sroa.0440.101262, %.loopexit584 ], [ %.sroa.0440.13, %.loopexit620 ], [ %.sroa.0440.13, %.loopexit.split-lp621 ] ; 3 uses
  %.sroa.37.14 = phi ptr [ %.sroa.37.0, %bb.aj ], [ %.sroa.18.01207, %.loopexit.split-lp604 ], [ %.sroa.37.6, %12 ], [ %.sroa.37.13, %bb.de ], [ %.sroa.37.11.ph, %.loopexit.split-lp ], [ %.sroa.37.13, %bb.do ], [ %.sroa.37.9.lcssa, %.loopexit.split-lp616 ], [ %.sroa.37.1.ph.ph, %.loopexit.split-lp599.loopexit.split-lp ], [ %.sroa.37.15.lcssa1535, %bb.ak ], [ %.sroa.37.21203, %.loopexit598.a ], [ %.sroa.37.15, %.loopexit.split-lp599.loopexit ], [ %.sroa.37.21203.lcssa1356, %.loopexit603 ], [ %.sroa.37.8.ph, %.loopexit615 ], [ %.sroa.37.101264, %.loopexit584 ], [ %.sroa.37.13, %.loopexit620 ], [ %.sroa.37.13, %.loopexit.split-lp621 ]
  %.sroa.0485.15 = phi ptr [ %.sroa.0485.0, %bb.aj ], [ %.sroa.0485.18, %.loopexit.split-lp604 ], [ %.sroa.0485.7, %12 ], [ %.sroa.0485.14, %bb.de ], [ %.sroa.0485.12.ph586, %.loopexit.split-lp ], [ %.sroa.0485.14, %bb.do ], [ %.sroa.0485.10.lcssa, %.loopexit.split-lp616 ], [ %.sroa.0485.1.ph.ph, %.loopexit.split-lp599.loopexit.split-lp ], [ %.sroa.0485.17, %bb.ak ], [ %.sroa.0485.21206, %.loopexit598.a ], [ %.sroa.0485.16572, %.loopexit.split-lp599.loopexit ], [ %.sroa.0485.18, %.loopexit603 ], [ %.sroa.0485.9.ph, %.loopexit615 ], [ %.sroa.0485.12.ph, %.loopexit584 ], [ %.sroa.0485.14, %.loopexit620 ], [ %.sroa.0485.14, %.loopexit.split-lp621 ] ; 3 uses
  %.pn157.pn = phi { ptr, i32 } [ %i.gd, %bb.aj ], [ %lpad.loopexit.split-lp606, %.loopexit.split-lp604 ], [ %.pn157, %12 ], [ %i.sy, %bb.de ], [ %lpad.loopexit.split-lp, %.loopexit.split-lp ], [ %i.ui, %bb.do ], [ %lpad.loopexit.split-lp618, %.loopexit.split-lp616 ], [ %lpad.loopexit.split-lp613, %.loopexit.split-lp599.loopexit.split-lp ], [ %i.ge, %bb.ak ], [ %lpad.loopexit600, %.loopexit598.a ], [ %lpad.loopexit612, %.loopexit.split-lp599.loopexit ], [ %lpad.loopexit605, %.loopexit603 ], [ %lpad.loopexit617, %.loopexit615 ], [ %lpad.loopexit, %.loopexit584 ], [ %lpad.loopexit622, %.loopexit620 ], [ %lpad.loopexit.split-lp623, %.loopexit.split-lp621 ] ; 2 uses
