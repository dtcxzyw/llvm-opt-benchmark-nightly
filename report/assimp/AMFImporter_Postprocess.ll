...
bb.bj:                                            ; preds = %bb.be
  ...
  %.sroa.0.0.copyload = load <16 x i8>, ptr %i.kx, align 8 ; 2 uses
...
bb.bq:                                            ; preds = %_ZNSt6vectorI10aiVector3tIfESaIS1_EE9push_backERKS1_.exit277
  store <16 x i8> %.sroa.0.0.copyload, ptr %.sroa.18.21226, align 4
...
.noexc289:                                        ; preds = %_ZNKSt6vectorI9aiColor4tIfESaIS1_EE12_M_check_lenEmPKc.exit.i.i
  ...
  store <16 x i8> %.sroa.0.0.copyload, ptr %i.mj, align 4
