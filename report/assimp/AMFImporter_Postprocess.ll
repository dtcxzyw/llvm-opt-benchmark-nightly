...
.lr.ph1250:                                       ; preds = %"_ZZN6Assimp11AMFImporter24Postprocess_BuildMeshSetERK7AMFMeshRKSt6vectorI10aiVector3tIfESaIS6_EERKS4_IP8AMFColorSaISC_EEPKSB_RS4_IP6aiMeshSaISK_EER6aiNodeENK3$_0clERKNSt7__cxx114listINS0_12SComplexFaceESaIST_EEEPKm.exit212.thread", %bb.bv
  ...
  %.sroa.0485.31247 = phi ptr [ %.sroa.0488.8, %bb.bv ], [ %.sroa.0485.2676, %"_ZZN6Assimp11AMFImporter24Postprocess_BuildMeshSetERK7AMFMeshRKSt6vectorI10aiVector3tIfESaIS6_EERKS4_IP8AMFColorSaISC_EEPKSB_RS4_IP6aiMeshSaISK_EER6aiNodeENK3$_0clERKNSt7__cxx114listINS0_12SComplexFaceESaIST_EEEPKm.exit212.thread" ] ; 6 uses
  ...
  %.sroa.0440.31243 = phi ptr [ %.sroa.0443.7, %bb.bv ], [ %.sroa.0440.2692, %"_ZZN6Assimp11AMFImporter24Postprocess_BuildMeshSetERK7AMFMeshRKSt6vectorI10aiVector3tIfESaIS6_EERKS4_IP8AMFColorSaISC_EEPKSB_RS4_IP6aiMeshSaISK_EER6aiNodeENK3$_0clERKNSt7__cxx114listINS0_12SComplexFaceESaIST_EEEPKm.exit212.thread" ] ; 5 uses
...
bb.bk:                                            ; preds = %bb.bf
  ...
  %.sroa.0422.0.copyload = load <4 x float>, ptr %i.jf, align 8 ; 2 uses
  %i.jg = load i32, ptr %i.iw, align 8
  %.not1318 = icmp eq i32 %i.jg, 0
  br i1 %.not1318, label %bb.bv, label %.lr.ph1233
...
.noexc289:                                        ; preds = %_ZNKSt6vectorI9aiColor4tIfESaIS1_EE12_M_check_lenEmPKc.exit.i.i
  ...
  store <4 x float> %.sroa.0422.0.copyload, ptr %i.kr, align 4
...
begin_hunk_9
  ...
  br i1 %i.lc, label %bb.bl, label %bb.bv, !llvm.loop !66
...
bb.bv:                                            ; preds = %_ZNSt6vectorI9aiColor4tIfESaIS1_EE9push_backERKS1_.exit, %bb.bk, %.lr.ph1250
  %.sroa.45.8 = phi ptr [ %.sroa.45.31242, %.lr.ph1250 ], [ %.sroa.45.31242, %bb.bk ], [ %.sroa.45.19, %_ZNSt6vectorI9aiColor4tIfESaIS1_EE9push_backERKS1_.exit ] ; 2 uses
  %.sroa.0443.7 = phi ptr [ %.sroa.0440.31243, %.lr.ph1250 ], [ %.sroa.0440.31243, %bb.bk ], [ %.sroa.0440.18, %_ZNSt6vectorI9aiColor4tIfESaIS1_EE9push_backERKS1_.exit ] ; 2 uses
  %.sroa.18.3 = phi ptr [ %.sroa.18.11244, %.lr.ph1250 ], [ %.sroa.18.11244, %bb.bk ], [ %.sroa.18.10, %_ZNSt6vectorI9aiColor4tIfESaIS1_EE9push_backERKS1_.exit ] ; 2 uses
  %.sroa.37.7 = phi ptr [ %.sroa.37.31245, %.lr.ph1250 ], [ %.sroa.37.31245, %bb.bk ], [ %.sroa.37.18, %_ZNSt6vectorI9aiColor4tIfESaIS1_EE9push_backERKS1_.exit ] ; 2 uses
  %.sroa.22.3 = phi ptr [ %.sroa.22.11246, %.lr.ph1250 ], [ %.sroa.22.11246, %bb.bk ], [ %.sroa.22.11, %_ZNSt6vectorI9aiColor4tIfESaIS1_EE9push_backERKS1_.exit ] ; 2 uses
  %.sroa.0488.8 = phi ptr [ %.sroa.0485.31247, %.lr.ph1250 ], [ %.sroa.0485.31247, %bb.bk ], [ %.sroa.0485.19, %_ZNSt6vectorI9aiColor4tIfESaIS1_EE9push_backERKS1_.exit ] ; 2 uses
...
.loopexit.split-lp599:                            ; preds = %.loopexit620, %.loopexit.split-lp621, %.loopexit584, %.loopexit.split-lp, %.loopexit615, %.loopexit.split-lp616, %.loopexit587.a, %.loopexit.split-lp588, %.loopexit603, %.loopexit.split-lp604, %.loopexit598.a, %.loopexit.split-lp599.loopexit.split-lp, %.loopexit.split-lp599.loopexit, %bb.bi, %bb.bj, %bb.al, %bb.df, %bb.dp, %bb.ak
  %.sroa.45.15 = phi ptr [ %.sroa.45.0, %bb.ak ], [ %.sroa.45.6.ph589, %.loopexit.split-lp588 ], [ %.sroa.45.1.ph.ph, %.loopexit.split-lp599.loopexit.split-lp ], [ %.sroa.45.14, %bb.df ], [ %.sroa.45.12.ph585, %.loopexit.split-lp ], [ %.sroa.45.14, %bb.dp ], [ %.sroa.45.10.lcssa, %.loopexit.split-lp616 ], [ %.sroa.45.18, %.loopexit.split-lp604 ], [ %.sroa.45.17, %bb.al ], [ %.sroa.45.31242, %bb.bj ], [ %.sroa.45.31242, %bb.bi ], [ %.sroa.22.01208, %.loopexit598.a ], [ %.sroa.0485.16572, %.loopexit.split-lp599.loopexit ], [ %.sroa.45.18, %.loopexit603 ], [ %.sroa.45.6.ph, %.loopexit587.a ], [ %.sroa.45.9.ph, %.loopexit615 ], [ %.sroa.45.12.ph, %.loopexit584 ], [ %.sroa.45.14, %.loopexit620 ], [ %.sroa.45.14, %.loopexit.split-lp621 ]
  %.sroa.0467.3 = phi ptr [ %.sroa.0464.0, %bb.ak ], [ null, %.loopexit.split-lp588 ], [ null, %.loopexit.split-lp599.loopexit.split-lp ], [ %.sroa.0464.2, %bb.df ], [ %.sroa.0464.4, %.loopexit.split-lp ], [ %.sroa.0464.2, %bb.dp ], [ %.sroa.0464.4, %.loopexit.split-lp616 ], [ null, %.loopexit.split-lp604 ], [ null, %bb.al ], [ null, %bb.bj ], [ null, %bb.bi ], [ null, %.loopexit598.a ], [ null, %.loopexit.split-lp599.loopexit ], [ null, %.loopexit603 ], [ null, %.loopexit587.a ], [ %.sroa.0464.1.ph, %.loopexit615 ], [ %.sroa.0464.4, %.loopexit584 ], [ %.sroa.0464.2, %.loopexit620 ], [ %.sroa.0464.2, %.loopexit.split-lp621 ] ; 3 uses
  %.sroa.31.3 = phi ptr [ %.sroa.31.0, %bb.ak ], [ null, %.loopexit.split-lp588 ], [ null, %.loopexit.split-lp599.loopexit.split-lp ], [ %.sroa.31.2, %bb.df ], [ %.sroa.17.1, %.loopexit.split-lp ], [ %.sroa.31.2, %bb.dp ], [ %.sroa.17.1, %.loopexit.split-lp616 ], [ null, %.loopexit.split-lp604 ], [ null, %bb.al ], [ null, %bb.bj ], [ null, %bb.bi ], [ null, %.loopexit598.a ], [ null, %.loopexit.split-lp599.loopexit ], [ null, %.loopexit603 ], [ null, %.loopexit587.a ], [ %.sroa.31.1.ph, %.loopexit615 ], [ %.sroa.17.1, %.loopexit584 ], [ %.sroa.31.2, %.loopexit620 ], [ %.sroa.31.2, %.loopexit.split-lp621 ]
  %.sroa.0443.14 = phi ptr [ %.sroa.0440.0, %bb.ak ], [ %.sroa.0440.51225, %.loopexit.split-lp588 ], [ %.sroa.0440.1.ph.ph, %.loopexit.split-lp599.loopexit.split-lp ], [ %.sroa.0440.13, %bb.df ], [ %.sroa.0440.11.ph, %.loopexit.split-lp ], [ %.sroa.0440.13, %bb.dp ], [ %.sroa.0440.9.lcssa, %.loopexit.split-lp616 ], [ %.sroa.0440.21201, %.loopexit.split-lp604 ], [ %.sroa.0440.15, %bb.al ], [ %.sroa.0440.31243, %bb.bj ], [ %.sroa.0440.31243, %bb.bi ], [ %.sroa.0440.21201, %.loopexit598.a ], [ %.sroa.0440.15, %.loopexit.split-lp599.loopexit ], [ %.sroa.0440.21201, %.loopexit603 ], [ %.sroa.0440.51225, %.loopexit587.a ], [ %.sroa.0440.8.ph, %.loopexit615 ], [ %.sroa.0440.101262, %.loopexit584 ], [ %.sroa.0440.13, %.loopexit620 ], [ %.sroa.0440.13, %.loopexit.split-lp621 ] ; 3 uses
  %.sroa.37.14 = phi ptr [ %.sroa.37.0, %bb.ak ], [ %.sroa.37.51227, %.loopexit.split-lp588 ], [ %.sroa.37.1.ph.ph, %.loopexit.split-lp599.loopexit.split-lp ], [ %.sroa.37.13, %bb.df ], [ %.sroa.37.11.ph, %.loopexit.split-lp ], [ %.sroa.37.13, %bb.dp ], [ %.sroa.37.9.lcssa, %.loopexit.split-lp616 ], [ %.sroa.18.01207, %.loopexit.split-lp604 ], [ %.sroa.37.15.lcssa1535, %bb.al ], [ %.sroa.37.31245, %bb.bj ], [ %.sroa.37.31245, %bb.bi ], [ %.sroa.37.21203, %.loopexit598.a ], [ %.sroa.37.15, %.loopexit.split-lp599.loopexit ], [ %.sroa.37.21203.lcssa1356, %.loopexit603 ], [ %.sroa.37.51227, %.loopexit587.a ], [ %.sroa.37.8.ph, %.loopexit615 ], [ %.sroa.37.101264, %.loopexit584 ], [ %.sroa.37.13, %.loopexit620 ], [ %.sroa.37.13, %.loopexit.split-lp621 ]
  %.sroa.0488.15 = phi ptr [ %.sroa.0485.0, %bb.ak ], [ %.sroa.0485.6.ph590, %.loopexit.split-lp588 ], [ %.sroa.0485.1.ph.ph, %.loopexit.split-lp599.loopexit.split-lp ], [ %.sroa.0485.14, %bb.df ], [ %.sroa.0485.12.ph586, %.loopexit.split-lp ], [ %.sroa.0485.14, %bb.dp ], [ %.sroa.0485.10.lcssa, %.loopexit.split-lp616 ], [ %.sroa.0485.18, %.loopexit.split-lp604 ], [ %.sroa.0485.17, %bb.al ], [ %.sroa.0485.31247, %bb.bj ], [ %.sroa.0485.31247, %bb.bi ], [ %.sroa.0485.21206, %.loopexit598.a ], [ %.sroa.0485.16572, %.loopexit.split-lp599.loopexit ], [ %.sroa.0485.18, %.loopexit603 ], [ %.sroa.0485.6.ph, %.loopexit587.a ], [ %.sroa.0485.9.ph, %.loopexit615 ], [ %.sroa.0485.12.ph, %.loopexit584 ], [ %.sroa.0485.14, %.loopexit620 ], [ %.sroa.0485.14, %.loopexit.split-lp621 ] ; 3 uses
  %.pn157.pn = phi { ptr, i32 } [ %i.fj, %bb.ak ], [ %lpad.loopexit.split-lp592, %.loopexit.split-lp588 ], [ %lpad.loopexit.split-lp613, %.loopexit.split-lp599.loopexit.split-lp ], [ %i.rg, %bb.df ], [ %lpad.loopexit.split-lp, %.loopexit.split-lp ], [ %i.sq, %bb.dp ], [ %lpad.loopexit.split-lp618, %.loopexit.split-lp616 ], [ %lpad.loopexit.split-lp606, %.loopexit.split-lp604 ], [ %i.fk, %bb.al ], [ %i.je, %bb.bj ], [ %i.jd, %bb.bi ], [ %lpad.loopexit600, %.loopexit598.a ], [ %lpad.loopexit612, %.loopexit.split-lp599.loopexit ], [ %lpad.loopexit605, %.loopexit603 ], [ %lpad.loopexit591, %.loopexit587.a ], [ %lpad.loopexit617, %.loopexit615 ], [ %lpad.loopexit, %.loopexit584 ], [ %lpad.loopexit622, %.loopexit620 ], [ %lpad.loopexit.split-lp623, %.loopexit.split-lp621 ] ; 2 uses
...
bb.dq:                                            ; preds = %.loopexit.split-lp599
  ...
  %i.ss = ptrtoint ptr %.sroa.0443.14 to i64
  %i.st = sub i64 %i.sr, %i.ss
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0443.14, i64 noundef %i.st) #24
...
bb.dr:                                            ; preds = %_ZNSt6vectorI9aiColor4tIfESaIS1_EED2Ev.exit355
  ...
  %i.sv = ptrtoint ptr %.sroa.0467.3 to i64
  %i.sw = sub i64 %i.su, %i.sv
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0467.3, i64 noundef %i.sw) #24
...
bb.ds:                                            ; preds = %_ZNSt6vectorI10aiVector3tIfESaIS1_EED2Ev.exit357
  ...
  %i.sy = ptrtoint ptr %.sroa.0488.15 to i64
  %i.sz = sub i64 %i.sx, %i.sy
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0488.15, i64 noundef %i.sz) #24
