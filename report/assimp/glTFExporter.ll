...
.preheader:                                       ; preds = %bb.a
  ...
  br i1 %.not147, label %._crit_edge129, label %.lr.ph128.preheader
...
.lr.ph125:                                        ; preds = %.lr.ph125.preheader, %bb.e
  %.098123 = phi i32 [ %i.ae, %bb.e ], [ %i.x, %.lr.ph125.preheader ] ; 3 uses
  %i.y = zext nneg i32 %.098123 to i64
...
bb.i:                                             ; preds = %._crit_edge
  %i.at = icmp slt i32 %3, 2
  br i1 %i.at, label %.loopexit143, label %.lr.ph121.preheader

.lr.ph121.preheader:                              ; preds = %bb.i
  %i.au = add nuw nsw i32 %3, 1
  br label %.lr.ph121

bb.j:                                             ; preds = %.lr.ph121
  %i.av = add nsw i32 %.0119, -1
  %i.aw = icmp slt i32 %.0119, 4
  br i1 %i.aw, label %.loopexit143, label %.lr.ph121, !llvm.loop !225

.lr.ph121:                                        ; preds = %.lr.ph121.preheader, %bb.j
  %.0119 = phi i32 [ %i.av, %bb.j ], [ %i.au, %.lr.ph121.preheader ] ; 3 uses
  %i.ax = zext nneg i32 %.0119 to i64             ; 2 uses
...
.loopexit:                                        ; preds = %.lr.ph121
  %i.ba = getelementptr inbounds nuw i8, ptr %0, i64 %i.ax
  %i.bb = getelementptr inbounds nuw i8, ptr %i.ba, i64 1
  br label %_ZN9rapidjson8internal13WriteExponentEiPc.exit

.loopexit143:                                     ; preds = %bb.j, %bb.i
...
_ZN9rapidjson8internal13WriteExponentEiPc.exit:   ; preds = %.loopexit143, %.loopexit, %bb.ab, %bb.aa, %bb.y, %bb.u, %bb.t, %bb.r, %.thread, %bb.k, %bb.m, %bb.f, %._crit_edge126, %._crit_edge129
  %.3 = phi ptr [ %i.m, %._crit_edge129 ], [ %i.af, %._crit_edge126 ], [ %i.ad, %.thread ], [ %i.ai, %bb.f ], [ %i.cq, %bb.u ], [ %i.bk, %bb.m ], [ %i.eb, %bb.ab ], [ %i.bf, %bb.k ], [ %i.ce, %bb.r ], [ %i.cn, %bb.t ], [ %i.dp, %bb.y ], [ %i.dy, %bb.aa ], [ %i.bc, %.loopexit143 ], [ %i.bb, %.loopexit ]
  ret ptr %.3
}
