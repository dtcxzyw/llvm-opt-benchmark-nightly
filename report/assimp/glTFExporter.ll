...
begin_hunk_0_@_ZN9rapidjson8internal5StackINS_12CrtAllocatorEE6ExpandINS_6WriterINS_19GenericStringBufferINS_4UTF8IcEES2_EES8_S8_S2_Lj0EE5LevelEEEvm:bb.a
  %.0 = phi i64 [ %i.p, %bb.e ], [ %i.h, %bb.d ]
  %i.r = getelementptr inbounds nuw i8, ptr %0, i64 24 ; 2 uses
  %i.s = load ptr, ptr %i.r, align 8
  %i.t = ptrtoint ptr %i.s to i64
  %i.u = sub i64 %i.t, %.pre-phi                  ; 2 uses
  %i.v = shl i64 %1, 4
  %i.w = add i64 %i.u, %i.v
  %spec.select = tail call i64 @llvm.umax.i64(i64 %.0, i64 %i.w) ; 3 uses
  %i.x = icmp eq i64 %spec.select, 0
...
bb.h:                                             ; preds = %bb.f
  %i.y = tail call ptr @realloc(ptr noundef %i.q, i64 noundef %spec.select) #37
  br label %_ZN9rapidjson8internal5StackINS_12CrtAllocatorEE6ResizeEm.exit

_ZN9rapidjson8internal5StackINS_12CrtAllocatorEE6ResizeEm.exit: ; preds = %bb.g, %bb.h
  %.0.i.i = phi ptr [ null, %bb.g ], [ %i.y, %bb.h ] ; 3 uses
  %i.z = getelementptr inbounds nuw i8, ptr %0, i64 32
  store ptr %.0.i.i, ptr %i.a, align 8
  %i.aa = getelementptr inbounds nuw i8, ptr %.0.i.i, i64 %i.u
  store ptr %i.aa, ptr %i.r, align 8
  %i.ab = getelementptr inbounds nuw i8, ptr %.0.i.i, i64 %spec.select
  store ptr %i.ab, ptr %i.z, align 8
  ret void
}

; Function Attrs: mustprogress uwtable
define linkonce_odr hidden noundef zeroext i1 @_ZN9rapidjson6WriterINS_19GenericStringBufferINS_4UTF8IcEENS_12CrtAllocatorEEES3_S3_S4_Lj0EE11WriteStringEPKcj(ptr noundef nonnull align 8 dereferenceable(61) %0, ptr noundef %1, i32 noundef %2) local_unnamed_addr #3 comdat align 2 {
bb.a:
  ...
  br i1 %i.l, label %bb.b, label %_ZN9rapidjson10PutReserveINS_4UTF8IcEENS_12CrtAllocatorEEEvRNS_19GenericStringBufferIT_T0_EEm.exit, !prof !6

bb.b:                                             ; preds = %bb.a
  tail call void @_ZN9rapidjson8internal5StackINS_12CrtAllocatorEE6ExpandIcEEvm(ptr noundef nonnull align 8 dereferenceable(48) %i.a, i64 noundef %i.d)
  %.pre = load ptr, ptr %0, align 8               ; 2 uses
  %.phi.trans.insert = getelementptr inbounds nuw i8, ptr %.pre, i64 24
  %.pre16 = load ptr, ptr %.phi.trans.insert, align 8
  br label %_ZN9rapidjson10PutReserveINS_4UTF8IcEENS_12CrtAllocatorEEEvRNS_19GenericStringBufferIT_T0_EEm.exit

_ZN9rapidjson10PutReserveINS_4UTF8IcEENS_12CrtAllocatorEEEvRNS_19GenericStringBufferIT_T0_EEm.exit: ; preds = %bb.a, %bb.b
  %i.m = phi ptr [ %i.h, %bb.a ], [ %.pre16, %bb.b ] ; 2 uses
  %i.n = phi ptr [ %i.a, %bb.a ], [ %.pre, %bb.b ]
...
.lr.ph:                                           ; preds = %_ZN9rapidjson10PutReserveINS_4UTF8IcEENS_12CrtAllocatorEEEvRNS_19GenericStringBufferIT_T0_EEm.exit, %.critedge
  %.sroa.0.014 = phi ptr [ %.sroa.0.1, %.critedge ], [ %1, %_ZN9rapidjson10PutReserveINS_4UTF8IcEENS_12CrtAllocatorEEEvRNS_19GenericStringBufferIT_T0_EEm.exit ] ; 2 uses
  %i.s = load i8, ptr %.sroa.0.014, align 1       ; 3 uses
  %i.t = zext i8 %i.s to i64
  %i.u = getelementptr inbounds nuw i8, ptr @_ZZN9rapidjson6WriterINS_19GenericStringBufferINS_4UTF8IcEENS_12CrtAllocatorEEES3_S3_S4_Lj0EE11WriteStringEPKcjE6escape, i64 %i.t
  ...
  br i1 %.not, label %bb.e, label %bb.c, !prof !219

bb.c:                                             ; preds = %.lr.ph
  store i8 92, ptr %i.y, align 1
  ...
  store i8 %i.v, ptr %i.ac, align 1
  %i.ae = icmp eq i8 %i.v, 117
  br i1 %i.ae, label %bb.d, label %.critedge
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.ao = zext i8 %i.s to i32                     ; 2 uses
  %i.ap = lshr i32 %i.ao, 4
  %i.aq = zext nneg i32 %i.ap to i64
  %i.ar = getelementptr inbounds nuw i8, ptr @_ZZN9rapidjson6WriterINS_19GenericStringBufferINS_4UTF8IcEENS_12CrtAllocatorEEES3_S3_S4_Lj0EE11WriteStringEPKcjE9hexDigits, i64 %i.aq
  ...
  %i.ax = and i32 %i.ao, 15
  %i.ay = zext nneg i32 %i.ax to i64
  %i.az = getelementptr inbounds nuw i8, ptr @_ZZN9rapidjson6WriterINS_19GenericStringBufferINS_4UTF8IcEENS_12CrtAllocatorEEES3_S3_S4_Lj0EE11WriteStringEPKcjE9hexDigits, i64 %i.ay
  %i.ba = load i8, ptr %i.az, align 1
  %i.bb = getelementptr inbounds nuw i8, ptr %i.aw, i64 24 ; 2 uses
...
bb.e:                                             ; preds = %.lr.ph
  store i8 %i.s, ptr %i.y, align 1
  br label %.critedge, !llvm.loop !222

.critedge:                                        ; preds = %bb.e, %bb.c, %bb.d
  %.sroa.0.1 = getelementptr inbounds nuw i8, ptr %.sroa.0.014, i64 1 ; 2 uses
  %i.be = ptrtoint ptr %.sroa.0.1 to i64
  %i.bf = sub i64 %i.be, %i.r
  %i.bg = icmp ult i64 %i.bf, %i.q
  br i1 %i.bg, label %.lr.ph, label %._crit_edge

._crit_edge:                                      ; preds = %.critedge, %_ZN9rapidjson10PutReserveINS_4UTF8IcEENS_12CrtAllocatorEEEvRNS_19GenericStringBufferIT_T0_EEm.exit
  ...
  store i8 34, ptr %i.bj, align 1
  ret i1 true
}

; Function Attrs: inlinehint mustprogress uwtable
define linkonce_odr hidden void @_ZN9rapidjson8internal6Grisu2EdPcPiS2_(double noundef %0, ptr noundef %1, ptr noundef %2, ptr noundef %3) local_unnamed_addr #5 comdat {
bb.a:
  %4 = alloca %"struct.rapidjson::internal::DiyFp", align 8 ; 5 uses
  %5 = alloca %"struct.rapidjson::internal::DiyFp", align 8 ; 5 uses
  %i.a = bitcast double %0 to i64                 ; 2 uses
  %i.b = lshr i64 %i.a, 52
  %i.c = trunc nuw nsw i64 %i.b to i32
  %i.d = and i32 %i.c, 2047                       ; 2 uses
  %i.e = and i64 %i.a, 4503599627370495           ; 2 uses
  %.not.i = icmp eq i32 %i.d, 0                   ; 3 uses
  %i.f = or disjoint i64 %i.e, 4503599627370496
  %i.g = add nsw i32 %i.d, -1075
  %.sink6.i = select i1 %.not.i, i64 %i.e, i64 %i.f ; 4 uses
  %.sink.i = select i1 %.not.i, i32 -1074, i32 %i.g ; 3 uses
  %i.h = shl nuw nsw i64 %.sink6.i, 1             ; 2 uses
  %i.i = or disjoint i64 %i.h, 1                  ; 2 uses
  %i.j = add nsw i32 %.sink.i, -1                 ; 3 uses
  br i1 %.not.i, label %.lr.ph.i.i, label %_ZNK9rapidjson8internal5DiyFp20NormalizedBoundariesEPS1_S2_.exit

.lr.ph.i.i:                                       ; preds = %bb.a, %.lr.ph.i.i
  %.sroa.7.06.i.i = phi i32 [ %i.l, %.lr.ph.i.i ], [ %i.j, %bb.a ]
  %.sroa.0.05.i.i = phi i64 [ %i.k, %.lr.ph.i.i ], [ %i.i, %bb.a ] ; 2 uses
  %i.k = shl i64 %.sroa.0.05.i.i, 1               ; 2 uses
  %i.l = add nsw i32 %.sroa.7.06.i.i, -1          ; 2 uses
  %i.m = and i64 %.sroa.0.05.i.i, 4503599627370496
  %.not.i.i = icmp eq i64 %i.m, 0
  br i1 %.not.i.i, label %.lr.ph.i.i, label %_ZNK9rapidjson8internal5DiyFp20NormalizedBoundariesEPS1_S2_.exit, !llvm.loop !223
...
_ZNK9rapidjson8internal5DiyFp20NormalizedBoundariesEPS1_S2_.exit: ; preds = %.lr.ph.i.i, %bb.a
  ...
  %.sroa.7.0.lcssa.i.i = phi i32 [ %i.j, %bb.a ], [ %i.l, %.lr.ph.i.i ] ; 3 uses
  ...
  %.neg44 = add nsw i32 %.sroa.7.0.i, 10
  %i.r = sub i32 %.neg44, %.sroa.7.0.lcssa.i.i
  %i.s = zext nneg i32 %i.r to i64
  %i.t = shl i64 %.sroa.0.0.i, %i.s               ; 2 uses
  %i.u = sub nsw i32 -51, %.sroa.7.0.lcssa.i.i
  %i.v = sitofp i32 %i.u to double
  %i.w = tail call double @llvm.fmuladd.f64(double %i.v, double f0x3FD34413509F79FE, double 3.470000e+02) ; 2 uses
  %i.x = fptosi double %i.w to i32                ; 2 uses
  %i.y = sitofp i32 %i.x to double
  %i.z = fcmp ogt double %i.w, %i.y
  %i.aa = zext i1 %i.z to i32
  %.0.i = add nsw i32 %i.aa, %i.x
  %i.ab = ashr i32 %.0.i, 3
  %i.ac = add nsw i32 %i.ab, 1                    ; 2 uses
  %i.ad = shl nuw i32 %i.ac, 3
  %i.ae = sub nsw i32 348, %i.ad
  store i32 %i.ae, ptr %3, align 4
  %i.af = zext i32 %i.ac to i64                   ; 2 uses
  %i.ag = getelementptr inbounds nuw [8 x i8], ptr @_ZZN9rapidjson8internal21GetCachedPowerByIndexEmE15kCachedPowers_F, i64 %i.af
  %i.ah = load i64, ptr %i.ag, align 8            ; 2 uses
  %i.ai = getelementptr inbounds nuw [2 x i8], ptr @_ZZN9rapidjson8internal21GetCachedPowerByIndexEmE15kCachedPowers_E, i64 %i.af
  %i.aj = load i16, ptr %i.ai, align 2
  %i.ak = sext i16 %i.aj to i32                   ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #30
  %i.al = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %.sink6.i, i1 true) ; 2 uses
  %i.am = trunc nuw nsw i64 %i.al to i32
  %i.an = shl i64 %.sink6.i, %i.al                ; 2 uses
  %i.ao = lshr i64 %i.an, 32                      ; 2 uses
  %i.ap = and i64 %i.an, 4294967294               ; 2 uses
  %i.aq = lshr i64 %i.ah, 32                      ; 6 uses
...
end_hunk_0
begin_hunk_1_@_ZN5o3dgc13SC3DMCDecoderItE16DecodeFloatArrayEPfmmmPKfS4_mRKNS_14IndexedFaceSetItEERNS_25O3DGCSC3DMCPredictionModeERKNS_12BinaryStreamE:bb.a
...
.lr.ph47.preheader.i:                             ; preds = %bb.bj
  %i.ig = mul nuw nsw i64 %.02543.i, 280
...
vector.body:                                      ; preds = %vector.memcheck, %vector.body
  ...
  br i1 %i.ju, label %middle.block, label %vector.body, !llvm.loop !387
...
.lr.ph47.preheader.i347:                          ; preds = %bb.bn
  %i.lt = mul nuw nsw i64 %.02543.i337, 280
...
.lr.ph47.preheader.i347.1:                        ; preds = %bb.bs
  %i.nb = mul nuw nsw i64 %.02543.i337.1, 280
...
.lr.ph47.preheader.i347.2:                        ; preds = %bb.bw
  %i.oh = mul nuw nsw i64 %.02543.i337.2, 280
...
end_hunk_1
begin_hunk_2_@_ZN5o3dgc13SC3DMCDecoderItE14DecodeIntArrayEPlmmmRKNS_14IndexedFaceSetItEERNS_25O3DGCSC3DMCPredictionModeERKNS_12BinaryStreamE:bb.a
...
.lr.ph47.preheader.i:                             ; preds = %bb.y
  %i.cm = mul nuw nsw i64 %.02543.i, 280
...
.lr.ph47.preheader.i.1:                           ; preds = %bb.ad
  %i.dt = mul nuw nsw i64 %.02543.i.1, 280
...
.lr.ph47.preheader.i.2:                           ; preds = %bb.ah
  %i.ey = mul nuw nsw i64 %.02543.i.2, 280
