...
_ZNSt6vectorIN10glTFCommon3RefIN4glTF4NodeEEESaIS4_EE9push_backERKS4_.exit: ; preds = %bb.f, %_ZNSt6vectorIN10glTFCommon3RefIN4glTF4NodeEEESaIS4_EE17_M_realloc_insertIJRKS4_EEEvN9__gnu_cxx17__normal_iteratorIPS4_S6_EEDpOT_.exit.i
  ...
  %.sroa.6144.sroa.0.0.copyload = load <16 x i8>, ptr %.sroa.6144.0..sroa_idx, align 4 ; 2 uses
  ...
  %.sroa.8151.sroa.0.0.copyload = load <16 x i8>, ptr %.sroa.8151.0..sroa_idx, align 4 ; 2 uses
  ...
  %.sroa.10.sroa.0.0.copyload = load <16 x i8>, ptr %.sroa.10.0..sroa_idx, align 4 ; 2 uses
...
bb.j:                                             ; preds = %_ZNSt6vectorIN10glTFCommon3RefIN4glTF4NodeEEESaIS4_EE9push_backERKS4_.exit
  ...
  store <16 x i8> %.sroa.6144.sroa.0.0.copyload, ptr %.sroa.6144.0..sroa_idx145, align 4
  ...
  store <16 x i8> %.sroa.8151.sroa.0.0.copyload, ptr %.sroa.8151.0..sroa_idx152, align 4
  ...
  store <16 x i8> %.sroa.10.sroa.0.0.copyload, ptr %.sroa.10.0..sroa_idx158, align 4
...
_ZNKSt6vectorI12aiMatrix4x4tIfESaIS1_EE12_M_check_lenEmPKc.exit.i.i: ; preds = %bb.k
  ...
  store <16 x i8> %.sroa.6144.sroa.0.0.copyload, ptr %.sroa.6144.0..sroa_idx146, align 4
  ...
  store <16 x i8> %.sroa.8151.sroa.0.0.copyload, ptr %.sroa.8151.0..sroa_idx153, align 4
  ...
  store <16 x i8> %.sroa.10.sroa.0.0.copyload, ptr %.sroa.10.0..sroa_idx159, align 4
