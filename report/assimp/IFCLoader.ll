...
bb.gx:                                            ; preds = %_ZNSt6vectorIP6aiMeshSaIS1_EE5clearEv.exit, %_ZSt8_DestroyIPP10aiMaterialS1_EvT_S3_RSaIT0_E.exit.i.i
  ...
  %27 = insertelement <2 x double> %i.afw, double %i.afa, i64 1
  %28 = fptrunc <2 x double> %27 to <2 x float>   ; 5 uses
  %i.agc = insertelement <2 x double> %i.afy, double %i.afc, i64 1
  %i.agd = fptrunc <2 x double> %i.agc to <2 x float> ; 5 uses
  %29 = insertelement <2 x double> %i.aga, double %i.afe, i64 1
  %30 = fptrunc <2 x double> %29 to <2 x float>   ; 5 uses
  %31 = fadd float %i.aex, 0.000000e+00           ; 11 uses
  %i.age = insertelement <2 x double> %i.agb, double %i.aez, i64 1
  %i.agf = fptrunc <2 x double> %i.age to <2 x float> ; 5 uses
  %32 = extractelement <2 x float> %i.agf, i64 1
  %33 = insertelement <2 x float> <float 0.000000e+00, float poison>, float %i.aeq, i64 1 ; 8 uses
  ...
  %i.agg = extractelement <2 x float> %i.agf, i64 0
  %38 = fptrunc double %i.afu to float            ; 4 uses
  %39 = fmul float %i.aeq, %i.afh                 ; 2 uses
  %40 = fadd float %i.aeo, 0.000000e+00           ; 6 uses
  %i.agh = insertelement <2 x float> <float 0.000000e+00, float poison>, float %40, i64 1 ; 3 uses
  %41 = fmul float %i.aes, %i.afh
  %42 = call float @llvm.fmuladd.f32(float %32, float %40, float %39)
  %43 = fptrunc double %i.afq to float            ; 4 uses
  %44 = fmul float %i.aeq, %i.afj                 ; 2 uses
  %45 = fmul float %i.aes, %i.afj
  %i.agi = call float @llvm.fmuladd.f32(float %43, float %31, float %42)
  %i.agj = insertelement <2 x float> poison, float %i.agi, i64 0
  %i.agk = insertelement <2 x float> %i.agj, float %44, i64 1
  %i.agl = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %28, <2 x float> %i.agh, <2 x float> %i.agk) ; 2 uses
  %i.agm = extractelement <2 x float> %i.agl, i64 1
  %46 = fptrunc double %i.afs to float            ; 4 uses
  %47 = fmul float %i.aeq, %i.afl                 ; 2 uses
  %48 = fmul float %i.aes, %i.afl
  %i.agn = call float @llvm.fmuladd.f32(float %46, float %31, float %i.agm)
  %i.ago = insertelement <2 x float> poison, float %i.agn, i64 0
  %i.agp = insertelement <2 x float> %i.ago, float %47, i64 1
  %i.agq = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.agd, <2 x float> %i.agh, <2 x float> %i.agp) ; 2 uses
  %i.agr = extractelement <2 x float> %i.agq, i64 1
  %49 = fmul float %i.aet, %i.afo
  %50 = fmul float %i.aes, %i.afo
  %51 = fptrunc double %i.aft to float            ; 4 uses
  %52 = fmul float %i.aeq, %i.afo                 ; 2 uses
  %53 = fmul float %i.aet, %i.afl
  %54 = fmul float %i.aet, %i.afj
  %55 = fadd float %i.aey, 0.000000e+00           ; 4 uses
  %i.ags = fmul float %i.aet, %i.afh
  %56 = call float @llvm.fmuladd.f32(float %51, float %31, float %i.agr)
  %i.agt = insertelement <2 x float> poison, float %56, i64 0
  %i.agu = insertelement <2 x float> %i.agt, float %52, i64 1
  %i.agv = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %30, <2 x float> %i.agh, <2 x float> %i.agu) ; 2 uses
  %i.agw = extractelement <2 x float> %i.agv, i64 1
  %i.agx = call float @llvm.fmuladd.f32(float %38, float %31, float %i.agw)
  %i.agy = insertelement <2 x float> poison, float %i.agx, i64 0
  %i.agz = insertelement <2 x float> %i.agy, float %41, i64 1
  %i.aha = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.agf, <2 x float> %33, <2 x float> %i.agz) ; 2 uses
  %i.ahb = extractelement <2 x float> %i.aha, i64 1
  %i.ahc = call float @llvm.fmuladd.f32(float %43, float %40, float %i.ahb)
  %57 = insertelement <2 x float> poison, float %i.ahc, i64 0
  %58 = insertelement <2 x float> %57, float %45, i64 1
  %59 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %28, <2 x float> %33, <2 x float> %58) ; 2 uses
  %i.ahd = extractelement <2 x float> %59, i64 1
  %60 = call float @llvm.fmuladd.f32(float %46, float %40, float %i.ahd)
  %i.ahe = insertelement <2 x float> poison, float %60, i64 0
  %i.ahf = insertelement <2 x float> %i.ahe, float %48, i64 1
  %i.ahg = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.agd, <2 x float> %33, <2 x float> %i.ahf) ; 2 uses
  %i.ahh = extractelement <2 x float> %i.ahg, i64 1
  %i.ahi = call float @llvm.fmuladd.f32(float %51, float %40, float %i.ahh)
  %61 = insertelement <2 x float> poison, float %i.ahi, i64 0
  %62 = insertelement <2 x float> %61, float %50, i64 1
  %63 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %30, <2 x float> %33, <2 x float> %62) ; 2 uses
  %i.ahj = extractelement <2 x float> %63, i64 1
  %64 = call float @llvm.fmuladd.f32(float %38, float %40, float %i.ahj)
  %i.ahk = insertelement <2 x float> poison, float %64, i64 0
  %i.ahl = insertelement <2 x float> %i.ahk, float %i.ags, i64 1
  %i.ahm = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.agf, <2 x float> %33, <2 x float> %i.ahl) ; 2 uses
  %i.ahn = extractelement <2 x float> %i.ahm, i64 1
  %i.aho = call float @llvm.fmuladd.f32(float %43, float %55, float %i.ahn)
  %i.ahp = insertelement <2 x float> poison, float %i.aho, i64 0
  %i.ahq = insertelement <2 x float> %i.ahp, float %54, i64 1
  %i.ahr = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %28, <2 x float> %33, <2 x float> %i.ahq) ; 2 uses
  %i.ahs = extractelement <2 x float> %i.ahr, i64 1
  %i.aht = call float @llvm.fmuladd.f32(float %46, float %55, float %i.ahs)
  %i.ahu = insertelement <2 x float> poison, float %i.aht, i64 0
  %i.ahv = insertelement <2 x float> %i.ahu, float %53, i64 1
  %i.ahw = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.agd, <2 x float> %33, <2 x float> %i.ahv) ; 2 uses
  %i.ahx = extractelement <2 x float> %i.ahw, i64 1
  %i.ahy = call float @llvm.fmuladd.f32(float %51, float %55, float %i.ahx)
  %i.ahz = insertelement <2 x float> poison, float %i.ahy, i64 0
  %i.aia = insertelement <2 x float> %i.ahz, float %49, i64 1
  %i.aib = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %30, <2 x float> %33, <2 x float> %i.aia) ; 2 uses
  %i.aic = extractelement <2 x float> %i.aib, i64 1
  %i.aid = call float @llvm.fmuladd.f32(float %38, float %55, float %i.aic)
  %i.aie = insertelement <2 x float> <float 0.000000e+00, float poison>, float %31, i64 1
  %i.aif = insertelement <2 x float> poison, float %i.aid, i64 0
  %i.aig = insertelement <2 x float> %i.aif, float %39, i64 1
  %i.aih = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.agf, <2 x float> %i.aie, <2 x float> %i.aig) ; 2 uses
  %i.aii = extractelement <2 x float> %i.aih, i64 1
  %i.aij = call float @llvm.fmuladd.f32(float %43, float %31, float %i.aii)
  %i.aik = fadd float %i.aij, %34
  %i.ail = call float @llvm.fmuladd.f32(float %35, float %31, float %44)
  %i.aim = insertelement <2 x float> %i.agd, float %46, i64 0
  %i.ain = insertelement <2 x float> poison, float %31, i64 0
  ...
  %i.aiq = insertelement <2 x float> %i.aip, float %47, i64 1
  %i.air = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.aim, <2 x float> %i.aio, <2 x float> %i.aiq) ; 2 uses
  %foldExtExtBinop = fadd <2 x float> %i.air, %i.agd
  %i.ais = extractelement <2 x float> %i.air, i64 1
  %i.ait = call float @llvm.fmuladd.f32(float %51, float %31, float %i.ais)
  %i.aiu = fadd float %i.ait, %36
  %i.aiv = call float @llvm.fmuladd.f32(float %37, float %31, float %52)
  %i.aiw = call float @llvm.fmuladd.f32(float %38, float %31, float %i.aiv)
  %i.aix = fadd float %i.aiw, %i.agg
  ...
  %i.ajg = shufflevector <2 x float> %i.agq, <2 x float> poison, <4 x i32> zeroinitializer
  %i.ajh = fmul <4 x float> %i.ajg, %i.ajf
  %i.aji = shufflevector <2 x float> %i.agl, <2 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.ajl = shufflevector <2 x float> %i.agv, <2 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.ajo = shufflevector <2 x float> %i.aha, <2 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.ajq = shufflevector <2 x float> %i.ahg, <2 x float> poison, <4 x i32> zeroinitializer
  %i.ajr = fmul <4 x float> %i.ajq, %i.ajf
  %i.ajs = shufflevector <2 x float> %59, <2 x float> poison, <4 x i32> zeroinitializer
  %i.ajt = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.aje, <4 x float> %i.ajs, <4 x float> %i.ajr)
  %i.aju = shufflevector <2 x float> %63, <2 x float> poison, <4 x i32> zeroinitializer
