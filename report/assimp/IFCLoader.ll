...
.loopexit.i.i:                                    ; preds = %bb.jb, %bb.iz, %bb.iy
  %42 = load <4 x float>, ptr %i.aex, align 4
  %43 = load <4 x float>, ptr %.sroa.789.0..sroa_idx90.i.i, align 8
  %44 = load <4 x float>, ptr %.sroa.992.0..sroa_idx93.i.i, align 4
  %45 = load <4 x float>, ptr %.sroa.1195.0..sroa_idx96.i.i, align 8
  %46 = load <4 x float>, ptr %.sroa.1398.0..sroa_idx99.i.i, align 4
  %47 = load <4 x float>, ptr %.sroa.15101.0..sroa_idx102.i.i, align 8
  %48 = load <4 x float>, ptr %.sroa.17104.0..sroa_idx105.i.i, align 4
  %49 = load <4 x float>, ptr %.sroa.19107.0..sroa_idx108.i.i, align 8
  %50 = load <4 x float>, ptr %.sroa.21110.0..sroa_idx111.i.i, align 4
  %51 = load <4 x float>, ptr %.sroa.23113.0..sroa_idx114.i.i, align 8
  %52 = load <4 x float>, ptr %.sroa.25116.0..sroa_idx117.i.i, align 4
  %53 = load <4 x float>, ptr %.sroa.27119.0..sroa_idx120.i.i, align 8
  %54 = load <4 x float>, ptr %.sroa.29122.0..sroa_idx123.i.i, align 4
  %55 = load <4 x float>, ptr %.sroa.31125.0..sroa_idx126.i.i, align 8
  %56 = load <4 x float>, ptr %.sroa.33128.0..sroa_idx129.i.i, align 4
  %57 = load <4 x float>, ptr %.sroa.35.0..sroa_idx131.i.i, align 8
  ...
  %i.apl = shufflevector <4 x float> %43, <4 x float> poison, <4 x i32> zeroinitializer
  %i.apm = fmul <4 x float> %i.apl, %i.apg
  %i.apn = shufflevector <4 x float> %42, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.apt = shufflevector <4 x float> %47, <4 x float> poison, <4 x i32> zeroinitializer
  %i.apu = fmul <4 x float> %i.apt, %i.apg
  %i.apv = shufflevector <4 x float> %46, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.aqb = shufflevector <4 x float> %51, <4 x float> poison, <4 x i32> zeroinitializer
  %i.aqc = fmul <4 x float> %i.aqb, %i.apg
  %i.aqd = shufflevector <4 x float> %50, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.aqj = shufflevector <4 x float> %55, <4 x float> poison, <4 x i32> zeroinitializer
  %i.aqk = fmul <4 x float> %i.aqj, %i.apg
  %i.aql = shufflevector <4 x float> %54, <4 x float> poison, <4 x i32> zeroinitializer
