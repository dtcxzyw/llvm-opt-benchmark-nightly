...
vector.ph612:                                     ; preds = %.lr.ph.i.i.i.i.preheader
  %n.vec614 = and i64 %i.iu, 4611686018427387900  ; 4 uses
  %i.iw = shl i64 %n.vec614, 3
  %i.ix = getelementptr i8, ptr %i.ip, i64 %i.iw
  %1 = shl i64 %n.vec614, 3
  %i.iy = getelementptr i8, ptr %i.ie, i64 %1
  br label %vector.body615

vector.body615:                                   ; preds = %vector.body615, %vector.ph612
  %index616 = phi i64 [ 0, %vector.ph612 ], [ %index.next623, %vector.body615 ] ; 3 uses
  %offset.idx617 = shl i64 %index616, 3
  %next.gep618 = getelementptr i8, ptr %i.ip, i64 %offset.idx617 ; 2 uses
  %offset.idx619 = shl i64 %index616, 3
  %next.gep620 = getelementptr i8, ptr %i.ie, i64 %offset.idx619 ; 2 uses
...
vector.ph592:                                     ; preds = %.lr.ph.i.i.i.i.i.preheader
  %n.vec594 = and i64 %i.sb, 4611686018427387900  ; 4 uses
  %i.sd = shl i64 %n.vec594, 3
  %i.se = getelementptr i8, ptr %i.rt, i64 %i.sd  ; 2 uses
  %2 = shl i64 %n.vec594, 3
  %i.sf = getelementptr i8, ptr %i.ri, i64 %2
  br label %vector.body595

vector.body595:                                   ; preds = %vector.body595, %vector.ph592
  %index596 = phi i64 [ 0, %vector.ph592 ], [ %index.next603, %vector.body595 ] ; 3 uses
  %offset.idx597 = shl i64 %index596, 3
  %next.gep598 = getelementptr i8, ptr %i.rt, i64 %offset.idx597 ; 2 uses
  %offset.idx599 = shl i64 %index596, 3
  %next.gep600 = getelementptr i8, ptr %i.ri, i64 %offset.idx599 ; 2 uses
...
vector.ph576:                                     ; preds = %.lr.ph.i.i.i.i.i209.preheader
  %n.vec578 = and i64 %i.ve, 4611686018427387900  ; 4 uses
  %i.vg = shl i64 %n.vec578, 3
  %i.vh = getelementptr i8, ptr %i.ux, i64 %i.vg  ; 2 uses
  %3 = shl i64 %n.vec578, 3
  %i.vi = getelementptr i8, ptr %i.um, i64 %3
  br label %vector.body579

vector.body579:                                   ; preds = %vector.body579, %vector.ph576
  %index580 = phi i64 [ 0, %vector.ph576 ], [ %index.next584, %vector.body579 ] ; 3 uses
  %offset.idx = shl i64 %index580, 3
  %next.gep = getelementptr i8, ptr %i.ux, i64 %offset.idx ; 2 uses
  %offset.idx581 = shl i64 %index580, 3
  %next.gep582 = getelementptr i8, ptr %i.um, i64 %offset.idx581 ; 2 uses
...
vector.ph183:                                     ; preds = %.lr.ph.i.i.i.i.i.preheader
  %n.vec185 = and i64 %i.r, 4611686018427387900   ; 4 uses
  %i.s = shl i64 %n.vec185, 3
  %i.t = getelementptr i8, ptr %i.d, i64 %i.s
  %4 = shl i64 %n.vec185, 3
  %i.u = getelementptr i8, ptr %i.o, i64 %4
  br label %vector.body186

vector.body186:                                   ; preds = %vector.body186, %vector.ph183
  %index187 = phi i64 [ 0, %vector.ph183 ], [ %index.next194, %vector.body186 ] ; 3 uses
  %offset.idx188 = shl i64 %index187, 3
  %next.gep189 = getelementptr i8, ptr %i.d, i64 %offset.idx188 ; 2 uses
  %offset.idx190 = shl i64 %index187, 3
  %next.gep191 = getelementptr i8, ptr %i.o, i64 %offset.idx190 ; 2 uses
...
vector.ph222:                                     ; preds = %vector.memcheck199
  %n.vec224 = and i64 %i.af, 9223372036854775806  ; 4 uses
  %i.ao = and i64 %i.af, 1
  %i.ap = mul i64 %n.vec224, -8
  %i.aq = getelementptr i8, ptr %i.d, i64 %i.ap
  %5 = mul i64 %n.vec224, -8
  %i.ar = getelementptr i8, ptr %i.o, i64 %5
  br label %vector.body225

vector.body225:                                   ; preds = %vector.body225, %vector.ph222
  %index226 = phi i64 [ 0, %vector.ph222 ], [ %index.next236, %vector.body225 ] ; 3 uses
  %offset.idx227 = mul i64 %index226, -8
  %next.gep228 = getelementptr i8, ptr %i.d, i64 %offset.idx227
  %offset.idx229 = mul i64 %index226, -8
  %next.gep230 = getelementptr i8, ptr %i.o, i64 %offset.idx229
...
vector.ph146:                                     ; preds = %.lr.ph.i.i.i.i.i71.preheader
  %n.vec148 = and i64 %i.ca, 4611686018427387900  ; 4 uses
  %i.cc = shl i64 %n.vec148, 3
  %i.cd = getelementptr i8, ptr %i.bv, i64 %i.cc
  %6 = shl i64 %n.vec148, 3
  %i.ce = getelementptr i8, ptr %1, i64 %6
  br label %vector.body149

vector.body149:                                   ; preds = %vector.body149, %vector.ph146
  %index150 = phi i64 [ 0, %vector.ph146 ], [ %index.next156, %vector.body149 ] ; 3 uses
  %offset.idx151 = shl i64 %index150, 3
  %next.gep152.a = getelementptr i8, ptr %i.bv, i64 %offset.idx151 ; 2 uses
  %offset.idx153 = shl i64 %index150, 3
  %next.gep154 = getelementptr i8, ptr %1, i64 %offset.idx153 ; 2 uses
...
vector.ph288:                                     ; preds = %.lr.ph.i.i.i.i.i90.preheader
  %n.vec290 = and i64 %i.ex, 4611686018427387900  ; 4 uses
  %i.ez = shl i64 %n.vec290, 3
  %i.fa = getelementptr i8, ptr %i.dm, i64 %i.ez  ; 2 uses
  %7 = shl i64 %n.vec290, 3
  %i.fb = getelementptr i8, ptr %i.cy, i64 %7
...
vector.body291:                                   ; preds = %vector.body291, %vector.ph288
  ...
  %next.gep296 = getelementptr i8, ptr %i.cy, i64 %offset.idx295 ; 2 uses
...
vector.ph309:                                     ; preds = %vector.memcheck304
  %n.vec311 = and i64 %i.fm, 4611686018427387900  ; 4 uses
  %i.fq = shl i64 %n.vec311, 3
  %i.fr = getelementptr i8, ptr %i.fi, i64 %i.fq  ; 2 uses
  %8 = shl i64 %n.vec311, 3
  %i.fs = getelementptr i8, ptr %1, i64 %8
  br label %vector.body312

vector.body312:                                   ; preds = %vector.body312, %vector.ph309
  %index313 = phi i64 [ 0, %vector.ph309 ], [ %index.next320, %vector.body312 ] ; 3 uses
  %offset.idx314 = shl i64 %index313, 3
  %next.gep315 = getelementptr i8, ptr %i.fi, i64 %offset.idx314 ; 2 uses
  %offset.idx316 = shl i64 %index313, 3
  %next.gep317 = getelementptr i8, ptr %1, i64 %offset.idx316 ; 2 uses
