...
bb.a:
  ...
  %3 = load ptr, ptr %i.c, align 8, !noalias !67  ; 3 uses
  %.not.i.not.i.i.i = icmp eq ptr %3, null
  %4 = getelementptr inbounds nuw i8, ptr %1, i64 32
  %i.d = load ptr, ptr %4, align 8, !noalias !67  ; 2 uses
...
bb.a:
  ...
  %6 = load ptr, ptr %5, align 8, !noalias !80    ; 3 uses
  %.not.i.not.i.i.i.i = icmp eq ptr %6, null
  %i.e = getelementptr inbounds nuw i8, ptr %4, i64 32
  %i.f = load ptr, ptr %i.e, align 8, !noalias !80 ; 2 uses
...
bb.a:
  ...
  %5 = getelementptr inbounds nuw i8, ptr %4, i64 48
  %6 = load ptr, ptr %5, align 8, !noalias !93    ; 3 uses
  %.not.i.not.i.i.i.i = icmp eq ptr %6, null
  %i.e = getelementptr inbounds nuw i8, ptr %4, i64 32
  %i.f = load ptr, ptr %i.e, align 8, !noalias !93 ; 2 uses
  %7 = icmp ugt ptr %6, %i.f
  %.08.i.i.i.i.i = select i1 %7, ptr %6, ptr %i.f ; 2 uses
  %.not5.i.i.i.i = icmp eq ptr %.08.i.i.i.i.i, null
  %.not.i.i.i.i = select i1 %.not.i.not.i.i.i.i, i1 true, i1 %.not5.i.i.i.i
...
bb.a:
  ...
  %5 = getelementptr inbounds nuw i8, ptr %4, i64 48
  %6 = load ptr, ptr %5, align 8, !noalias !112   ; 3 uses
  %.not.i.not.i.i.i.i = icmp eq ptr %6, null
  %i.e = getelementptr inbounds nuw i8, ptr %4, i64 32
  %i.f = load ptr, ptr %i.e, align 8, !noalias !112 ; 2 uses
  %7 = icmp ugt ptr %6, %i.f
  %.08.i.i.i.i.i = select i1 %7, ptr %6, ptr %i.f ; 2 uses
  %.not5.i.i.i.i = icmp eq ptr %.08.i.i.i.i.i, null
  %.not.i.i.i.i = select i1 %.not.i.not.i.i.i.i, i1 true, i1 %.not5.i.i.i.i
