Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/assimp/original/VertexTriangleAdjacency?download=true
inline.NumInlined: 3
inline.NumDeleted: 1
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  %.062106 = phi ptr [ %1, %.lr.ph.preheader.new ], [ %i.v, %.lr.ph ] ; 3 uses
  %.096105 = phi i32 [ 0, %.lr.ph.preheader.new ], [ %.sroa.speculated.1, %.lr.ph ]
  %niter = phi i64 [ 0, %.lr.ph.preheader.new ], [ %niter.next.1, %.lr.ph ]
  %i.h = getelementptr inbounds nuw i8, ptr %.062106, i64 8
  ...
  %i.o = getelementptr inbounds nuw i8, ptr %.062106, i64 24
  ...
  %i.v = getelementptr inbounds nuw i8, ptr %.062106, i64 32 ; 2 uses
...
.lr.ph.epil.preheader:                            ; preds = %.loopexit.loopexit.unr-lcssa, %.lr.ph.preheader
  %.062106.epil.init = phi ptr [ %1, %.lr.ph.preheader ], [ %i.v, %.loopexit.loopexit.unr-lcssa ]
  ...
  %i.x = getelementptr inbounds nuw i8, ptr %.062106.epil.init, i64 8
...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  %.061 = phi ptr [ %i.ai, %bb.b ], [ %i.at, %bb.c ] ; 6 uses
  store ptr %i.ax, ptr %0, align 8
  %i.ay = zext i32 %.197 to i64                   ; 2 uses
  %.idx124 = shl nuw nsw i64 %i.ay, 2
  %i.az = getelementptr inbounds nuw i8, ptr %.061, i64 %.idx124
...
.lr.ph109:                                        ; preds = %bb.d, %.thread98
  %.060108 = phi ptr [ %i.bx, %.thread98 ], [ %1, %bb.d ] ; 3 uses
  %i.bc = load i32, ptr %.060108, align 8         ; 3 uses
  %i.bd = getelementptr inbounds nuw i8, ptr %.060108, i64 8
...
bb.e:                                             ; preds = %.lr.ph109
  ...
  %i.bh = getelementptr inbounds nuw [4 x i8], ptr %.061, i64 %i.bg ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.bn = getelementptr inbounds nuw [4 x i8], ptr %.061, i64 %i.bm ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.bu = getelementptr inbounds nuw [4 x i8], ptr %.061, i64 %i.bt ; 2 uses
...
.thread98:                                        ; preds = %.lr.ph109, %bb.e, %bb.g, %bb.f
  %i.bx = getelementptr inbounds nuw i8, ptr %.060108, i64 16 ; 2 uses
...
.lr.ph115.epil.preheader:                         ; preds = %._crit_edge116.unr-lcssa, %.lr.ph115.preheader
  %.057113.epil.init = phi ptr [ %.061, %.lr.ph115.preheader ], [ %i.dk, %._crit_edge116.unr-lcssa ]
  %.058112.epil.init = phi ptr [ %i.ax, %.lr.ph115.preheader ], [ %i.dl, %._crit_edge116.unr-lcssa ]
  %.059111.epil.init = phi i32 [ 0, %.lr.ph115.preheader ], [ %i.dj, %._crit_edge116.unr-lcssa ]
...
.lr.ph115.epil:                                   ; preds = %.lr.ph115.epil, %.lr.ph115.epil.preheader
  %.057113.epil = phi ptr [ %i.ca, %.lr.ph115.epil ], [ %.057113.epil.init, %.lr.ph115.epil.preheader ] ; 2 uses
  %.058112.epil = phi ptr [ %i.cb, %.lr.ph115.epil ], [ %.058112.epil.init, %.lr.ph115.epil.preheader ] ; 2 uses
  %.059111.epil = phi i32 [ %i.bz, %.lr.ph115.epil ], [ %.059111.epil.init, %.lr.ph115.epil.preheader ] ; 2 uses
  %epil.iter = phi i64 [ %epil.iter.next, %.lr.ph115.epil ], [ 0, %.lr.ph115.epil.preheader ]
  %i.by = load i32, ptr %.057113.epil, align 4
  %i.bz = add i32 %i.by, %.059111.epil            ; 2 uses
  store i32 %.059111.epil, ptr %.058112.epil, align 4
  %i.ca = getelementptr inbounds nuw i8, ptr %.057113.epil, i64 4
  %i.cb = getelementptr inbounds nuw i8, ptr %.058112.epil, i64 4
...
.lr.ph115:                                        ; preds = %.lr.ph115, %.lr.ph115.preheader.new
  %.057113 = phi ptr [ %.061, %.lr.ph115.preheader.new ], [ %i.dk, %.lr.ph115 ] ; 9 uses
  %.058112 = phi ptr [ %i.ax, %.lr.ph115.preheader.new ], [ %i.dl, %.lr.ph115 ] ; 9 uses
  %.059111 = phi i32 [ 0, %.lr.ph115.preheader.new ], [ %i.dj, %.lr.ph115 ] ; 2 uses
  %niter136 = phi i64 [ 0, %.lr.ph115.preheader.new ], [ %niter136.next.7, %.lr.ph115 ]
  %i.cg = load i32, ptr %.057113, align 4
  %i.ch = add i32 %i.cg, %.059111                 ; 2 uses
  store i32 %.059111, ptr %.058112, align 4
  %i.ci = getelementptr inbounds nuw i8, ptr %.057113, i64 4
  %i.cj = getelementptr inbounds nuw i8, ptr %.058112, i64 4
  %i.ck = load i32, ptr %i.ci, align 4
  %i.cl = add i32 %i.ck, %i.ch                    ; 2 uses
  store i32 %i.ch, ptr %i.cj, align 4
  %i.cm = getelementptr inbounds nuw i8, ptr %.057113, i64 8
  %i.cn = getelementptr inbounds nuw i8, ptr %.058112, i64 8
  %i.co = load i32, ptr %i.cm, align 4
  %i.cp = add i32 %i.co, %i.cl                    ; 2 uses
  store i32 %i.cl, ptr %i.cn, align 4
  %i.cq = getelementptr inbounds nuw i8, ptr %.057113, i64 12
  %i.cr = getelementptr inbounds nuw i8, ptr %.058112, i64 12
  %i.cs = load i32, ptr %i.cq, align 4
  %i.ct = add i32 %i.cs, %i.cp                    ; 2 uses
  store i32 %i.cp, ptr %i.cr, align 4
  %i.cu = getelementptr inbounds nuw i8, ptr %.057113, i64 16
  %i.cv = getelementptr inbounds nuw i8, ptr %.058112, i64 16
  %i.cw = load i32, ptr %i.cu, align 4
  %i.cx = add i32 %i.cw, %i.ct                    ; 2 uses
  store i32 %i.ct, ptr %i.cv, align 4
  %i.cy = getelementptr inbounds nuw i8, ptr %.057113, i64 20
  %i.cz = getelementptr inbounds nuw i8, ptr %.058112, i64 20
  %i.da = load i32, ptr %i.cy, align 4
  %i.db = add i32 %i.da, %i.cx                    ; 2 uses
  store i32 %i.cx, ptr %i.cz, align 4
  %i.dc = getelementptr inbounds nuw i8, ptr %.057113, i64 24
  %i.dd = getelementptr inbounds nuw i8, ptr %.058112, i64 24
  %i.de = load i32, ptr %i.dc, align 4
  %i.df = add i32 %i.de, %i.db                    ; 2 uses
  store i32 %i.db, ptr %i.dd, align 4
  %i.dg = getelementptr inbounds nuw i8, ptr %.057113, i64 28
  %i.dh = getelementptr inbounds nuw i8, ptr %.058112, i64 28
  %i.di = load i32, ptr %i.dg, align 4
  %i.dj = add i32 %i.di, %i.df                    ; 3 uses
  store i32 %i.df, ptr %i.dh, align 4
  %i.dk = getelementptr inbounds nuw i8, ptr %.057113, i64 32 ; 2 uses
  %i.dl = getelementptr inbounds nuw i8, ptr %.058112, i64 32 ; 2 uses
...
.lr.ph122:                                        ; preds = %._crit_edge116, %.thread101
  %.0120 = phi ptr [ %i.er, %.thread101 ], [ %1, %._crit_edge116 ] ; 3 uses
  %.1119 = phi i32 [ %i.es, %.thread101 ], [ 0, %._crit_edge116 ] ; 4 uses
  %i.dn = load i32, ptr %.0120, align 8           ; 3 uses
  %i.do = getelementptr inbounds nuw i8, ptr %.0120, i64 8
...
.thread101:                                       ; preds = %.lr.ph122, %bb.h, %bb.j, %bb.i
  %i.er = getelementptr inbounds nuw i8, ptr %.0120, i64 16 ; 2 uses
...
define void @_ZN6Assimp23VertexTriangleAdjacencyD2Ev(ptr nofree noundef nonnull readonly align 8 captures(none) dead_on_return(28) dereferenceable(28) %0) unnamed_addr #3 align 2 {
bb.a:
