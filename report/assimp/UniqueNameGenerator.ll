...
bb.d:                                             ; preds = %.lr.ph, %_ZNSt6vectorImSaImEE9push_backERKm.exit
  %i.ay = phi ptr [ %i.aj, %.lr.ph ], [ %i.hk, %_ZNSt6vectorImSaImEE9push_backERKm.exit ]
  %storemerge265 = phi i64 [ 0, %.lr.ph ], [ %i.hi, %_ZNSt6vectorImSaImEE9push_backERKm.exit ] ; 9 uses
...
._crit_edge.i.i.i:                                ; preds = %.noexc44, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EESA_.exit.thread168
  %i.ci = phi ptr [ %i.cg, %.noexc44 ], [ %i.ak, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EESA_.exit.thread168 ] ; 2 uses
...
bb.o:                                             ; preds = %bb.n, %bb.m, %._crit_edge.i.i.i
  ...
  br i1 %i.cp, label %bb.p, label %._crit_edge338
...
bb.p:                                             ; preds = %bb.o
  ...
  %.pre339 = load ptr, ptr %6, align 8            ; 3 uses
  br i1 %i.cq, label %bb.r, label %bb.q

bb.q:                                             ; preds = %bb.p
  %i.cr = load ptr, ptr %3, align 8
  %bcmp.i45 = call i32 @bcmp(ptr %.pre339, ptr %i.cr, i64 %i.cn)
  %i.cs = icmp eq i32 %bcmp.i45, 0
  br label %bb.r

bb.r:                                             ; preds = %._crit_edge338, %bb.p, %bb.q
  %i.ct = phi ptr [ %.pre339, %bb.p ], [ %.pre339, %bb.q ], [ %.pre, %._crit_edge338 ] ; 2 uses
  %.ph = phi i1 [ true, %bb.p ], [ %i.cs, %bb.q ], [ false, %._crit_edge338 ]
...
bb.t:                                             ; preds = %.critedge.thread
  %i.cz = ptrtoint ptr %.sroa.9.0258 to i64
  %i.da = ptrtoint ptr %.sroa.0150.0259 to i64
...
.noexc55:                                         ; preds = %_ZNKSt6vectorImSaImEE12_M_check_lenEmPKc.exit.i.i48
  ...
  store i64 %storemerge265, ptr %i.dk, align 8
  %i.dl = icmp sgt i64 %i.db, 0
  br i1 %i.dl, label %bb.v, label %_ZNSt6vectorImSaImEE11_S_relocateEPmS2_S2_RS0_.exit16.i.i51

bb.v:                                             ; preds = %.noexc55
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.dj, ptr align 8 %.sroa.0150.0259, i64 %i.db, i1 false)
...
bb.w:                                             ; preds = %_ZNSt6vectorImSaImEE11_S_relocateEPmS2_S2_RS0_.exit16.i.i51
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0150.0259, i64 noundef %i.db) #23
...
bb.bk:                                            ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit23.thread25.i87
  store ptr %i.je, ptr %10, align 8
  store i64 %i.jt, ptr %i.hr, align 8
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit94: ; preds = %bb.bg, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_S_copyEPcPKcm.exit.i90, %bb.bk, %bb.bl
  %i.jx = phi ptr [ %.pre.i91, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_S_copyEPcPKcm.exit.i90 ], [ %i.je, %bb.bk ], [ %i.hr, %bb.bl ], [ %i.jh, %bb.bg ]
  store i64 0, ptr %i.hs, align 8
  store i8 0, ptr %i.jx, align 1
  %i.jy = load ptr, ptr %10, align 8              ; 2 uses
  %i.jz = icmp eq ptr %i.jy, %i.hr
  br i1 %i.jz, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit97, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i95
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i95: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit94
  ...
  %i.kb = add i64 %i.ka, 1
  call void @_ZdlPvm(ptr noundef %i.jy, i64 noundef %i.kb) #23
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit97: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit94, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i95
  ...
  %i.kc = getelementptr inbounds nuw i8, ptr %.sroa.0127.0283, i64 8 ; 2 uses
  %.not186 = icmp eq ptr %i.kc, %.sroa.10.0.lcssa
  br i1 %.not186, label %.loopexit, label %bb.be, !llvm.loop !19
...
bb.bn:                                            ; preds = %.lr.ph288, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit109
  %.0287 = phi i64 [ 0, %.lr.ph288 ], [ %i.li, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit109 ] ; 2 uses
  %.sroa.0123.0286 = phi ptr [ %.sroa.0158.0.lcssa, %.lr.ph288 ], [ %i.lh, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit109 ] ; 2 uses
  ...
  %i.ke = getelementptr i8, ptr %.val37, i64 32
  %.val37.val = load ptr, ptr %i.ke, align 8, !noalias !20
  %i.kf = getelementptr i8, ptr %.val37, i64 40
  %.val37.val40 = load i64, ptr %i.kf, align 8, !noalias !20
  invoke fastcc void @"_ZZN6Assimp3MDL8HalfLife19UniqueNameGenerator11make_uniqueERSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS9_EEENK3$_1clB5cxx11ERKS9_m"(ptr dead_on_unwind noalias writable align 8 %11, ptr %.val37.val, i64 %.val37.val40, ptr %.val38, i64 %.val39, i64 noundef %.0287)
          to label %bb.bo unwind label %bb.bv

bb.bo:                                            ; preds = %bb.bn
  %i.kg = load i64, ptr %.sroa.0123.0286, align 8
  %i.kh = load ptr, ptr %1, align 8
  %i.ki = getelementptr inbounds nuw [32 x i8], ptr %i.kh, i64 %i.kg ; 9 uses
  %i.kj = load ptr, ptr %i.ki, align 8            ; 6 uses
  %i.kk = getelementptr inbounds nuw i8, ptr %i.ki, i64 16 ; 4 uses
  %i.kl = icmp eq ptr %i.kj, %i.kk
  %i.km = load ptr, ptr %11, align 8              ; 6 uses
  %i.kn = icmp eq ptr %i.km, %i.ht                ; 2 uses
  br i1 %i.kl, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i104, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i98

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i104: ; preds = %bb.bo
  br i1 %i.kn, label %bb.bp, label %.thread.i105

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i98: ; preds = %bb.bo
  br i1 %i.kn, label %bb.bp, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit23.thread25.i99
...
.thread.i105:                                     ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i104
  %i.kv = getelementptr inbounds nuw i8, ptr %i.ki, i64 8
  store ptr %i.km, ptr %i.ki, align 8
  %i.kw = load i64, ptr %i.hu, align 8
  store i64 %i.kw, ptr %i.kv, align 8
  %i.kx = load i64, ptr %i.ht, align 8
  store i64 %i.kx, ptr %i.kk, align 8
  br label %bb.bu
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit23.thread25.i99: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i98
  %i.ky = load i64, ptr %i.kk, align 8
  store ptr %i.km, ptr %i.ki, align 8
  %i.kz = load i64, ptr %i.hu, align 8
  %i.la = getelementptr inbounds nuw i8, ptr %i.ki, i64 8
  store i64 %i.kz, ptr %i.la, align 8
  %i.lb = load i64, ptr %i.ht, align 8
  store i64 %i.lb, ptr %i.kk, align 8
  %.not.i100 = icmp eq ptr %i.kj, null
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit106: ; preds = %bb.bp, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_S_copyEPcPKcm.exit.i102, %bb.bt, %bb.bu
  %i.lc = phi ptr [ %.pre.i103, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_S_copyEPcPKcm.exit.i102 ], [ %i.kj, %bb.bt ], [ %i.ht, %bb.bu ], [ %i.km, %bb.bp ]
  store i64 0, ptr %i.hu, align 8
  store i8 0, ptr %i.lc, align 1
  %i.ld = load ptr, ptr %11, align 8              ; 2 uses
  %i.le = icmp eq ptr %i.ld, %i.ht
  br i1 %i.le, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit109, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i107
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i107: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit106
  %i.lf = load i64, ptr %i.ht, align 8
  %i.lg = add i64 %i.lf, 1
  call void @_ZdlPvm(ptr noundef %i.ld, i64 noundef %i.lg) #23
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit109: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit106, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i107
  ...
  %i.lh = getelementptr inbounds nuw i8, ptr %.sroa.0123.0286, i64 8 ; 2 uses
  %i.li = add i64 %.0287, 1
  %.not187 = icmp eq ptr %i.lh, %.sroa.10.0.lcssa
  br i1 %.not187, label %.loopexit, label %bb.bn, !llvm.loop !23
...
.loopexit:                                        ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit97, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit109, %.preheader189, %.preheader
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #22
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #22
  %i.lk = load ptr, ptr %3, align 8               ; 2 uses
  %i.ll = icmp eq ptr %i.lk, %i.p
  br i1 %i.ll, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit112, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i110

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i110: ; preds = %.loopexit
  %i.lm = load i64, ptr %i.p, align 8
  %i.ln = add i64 %i.lm, 1
  call void @_ZdlPvm(ptr noundef %i.lk, i64 noundef %i.ln) #23
...
bb.bw:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit112
  %i.lo = ptrtoint ptr %.sroa.14.0.lcssa to i64
  %i.lp = sub i64 %i.lo, %i.hq
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0150.0.lcssa, i64 noundef %i.lp) #23
  br label %_ZNSt6vectorImSaImEED2Ev.exit

_ZNSt6vectorImSaImEED2Ev.exit:                    ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit112, %bb.bw
  %.not.i.i.i114 = icmp eq ptr %.sroa.0158.0.lcssa, null
  br i1 %.not.i.i.i114, label %_ZNSt6vectorImSaImEED2Ev.exit115, label %bb.bx

bb.bx:                                            ; preds = %_ZNSt6vectorImSaImEED2Ev.exit
  %i.lq = ptrtoint ptr %.sroa.16.0.lcssa to i64
  %i.lr = ptrtoint ptr %.sroa.0158.0.lcssa to i64
  %i.ls = sub i64 %i.lq, %i.lr
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0158.0.lcssa, i64 noundef %i.ls) #23
...
bb.by:                                            ; preds = %.loopexit191, %.loopexit.split-lp, %_ZZN6Assimp3MDL8HalfLife19UniqueNameGenerator11make_uniqueERSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS9_EEEN13DuplicateInfoD2Ev.exit80, %bb.x, %bb.bv, %bb.bm, %bb.bd
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #22
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #22
  %i.lt = load ptr, ptr %3, align 8               ; 2 uses
  %i.lu = icmp eq ptr %i.lt, %i.p
  br i1 %i.lu, label %.body, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i116
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i116: ; preds = %bb.by
  ...
  %i.lw = add i64 %i.lv, 1
  call void @_ZdlPvm(ptr noundef %i.lt, i64 noundef %i.lw) #23
  br label %.body
...
_ZNSt6vectorImSaImEED2Ev.exit120.thread:          ; preds = %bb.c, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #22
  %.val41175 = load ptr, ptr %i.e, align 8
  call fastcc void @_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_ZN6Assimp3MDL8HalfLife19UniqueNameGenerator11make_uniqueERSt6vectorIS5_SaIS5_EEE13DuplicateInfoESt10_Select1stISH_ESt4lessIS5_ESaISH_EE8_M_eraseEPSt13_Rb_tree_nodeISH_E(ptr noundef %.val41175)
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #22
...
bb.bz:                                            ; preds = %.body
  %i.lx = ptrtoint ptr %.sroa.14.5 to i64
  %i.ly = ptrtoint ptr %.sroa.0150.5 to i64
  %i.lz = sub i64 %i.lx, %i.ly
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0150.5, i64 noundef %i.lz) #23
  br label %_ZNSt6vectorImSaImEED2Ev.exit120

_ZNSt6vectorImSaImEED2Ev.exit120:                 ; preds = %.body, %bb.bz
  %.not.i.i.i121 = icmp eq ptr %.sroa.0158.0209, null
  br i1 %.not.i.i.i121, label %_ZNSt6vectorImSaImEED2Ev.exit122, label %bb.ca

bb.ca:                                            ; preds = %_ZNSt6vectorImSaImEED2Ev.exit120
  %i.ma = ptrtoint ptr %.sroa.16.0228 to i64
  %i.mb = ptrtoint ptr %.sroa.0158.0209 to i64
  %i.mc = sub i64 %i.ma, %i.mb
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0158.0209, i64 noundef %i.mc) #23
  br label %_ZNSt6vectorImSaImEED2Ev.exit122

_ZNSt6vectorImSaImEED2Ev.exit122:                 ; preds = %_ZNSt6vectorImSaImEED2Ev.exit120.thread, %_ZNSt6vectorImSaImEED2Ev.exit120, %bb.ca
  %.pn26.pn.pn179184 = phi { ptr, i32 } [ %i.aa, %_ZNSt6vectorImSaImEED2Ev.exit120.thread ], [ %.pn26.pn, %_ZNSt6vectorImSaImEED2Ev.exit120 ], [ %.pn26.pn, %bb.ca ]
  resume { ptr, i32 } %.pn26.pn.pn179184
}
...
.noexc.i.i.i.i.i.i.i:                             ; preds = %.critedge
  %i.aa = invoke noundef ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm(ptr noundef nonnull align 8 dereferenceable(64) %i.x, ptr noundef nonnull align 8 dereferenceable(8) %i.a, i64 noundef 0)
