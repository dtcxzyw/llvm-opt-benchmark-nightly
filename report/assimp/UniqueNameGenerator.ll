...
bb.d:                                             ; preds = %.lr.ph, %_ZNSt6vectorImSaImEE9push_backERKm.exit
  ...
  %.sroa.9.0260 = phi ptr [ null, %.lr.ph ], [ %.sroa.9.2, %_ZNSt6vectorImSaImEE9push_backERKm.exit ] ; 10 uses
  %.sroa.14.0259 = phi ptr [ null, %.lr.ph ], [ %.sroa.14.3.a, %_ZNSt6vectorImSaImEE9push_backERKm.exit ] ; 6 uses
...
.loopexit193:                                     ; preds = %bb.at, %_ZNKSt6vectorImSaImEE12_M_check_lenEmPKc.exit.i.i, %_ZNKSt6vectorImSaImEE12_M_check_lenEmPKc.exit.i.i48, %bb.au
  ...
  %.sroa.14.1.ph = phi ptr [ %.sroa.9.1, %bb.at ], [ %.sroa.9.0260, %_ZNKSt6vectorImSaImEE12_M_check_lenEmPKc.exit.i.i ], [ %.sroa.9.0260, %_ZNKSt6vectorImSaImEE12_M_check_lenEmPKc.exit.i.i48 ], [ %.sroa.9.1, %bb.au ]
...
.critedge.thread:                                 ; preds = %bb.l, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EESA_.exit, %.critedge
  %.not.i47 = icmp eq ptr %.sroa.14.0259, %.sroa.9.0260
  br i1 %.not.i47, label %bb.t, label %bb.s

bb.s:                                             ; preds = %.critedge.thread
  store i64 %storemerge267, ptr %.sroa.14.0259, align 8
  %i.cy = getelementptr inbounds nuw i8, ptr %.sroa.14.0259, i64 8
...
_ZNSt6vectorImSaImEE9push_backERKm.exit56:        ; preds = %_ZNSt6vectorImSaImEE17_M_realloc_insertIJRKmEEEvN9__gnu_cxx17__normal_iteratorIPmS1_EEDpOT_.exit.i53, %bb.s, %.critedge
  %.sroa.14.2.a = phi ptr [ %.sroa.14.0259, %.critedge ], [ %i.dm, %_ZNSt6vectorImSaImEE17_M_realloc_insertIJRKmEEEvN9__gnu_cxx17__normal_iteratorIPmS1_EEDpOT_.exit.i53 ], [ %i.cy, %bb.s ] ; 2 uses
  %.sroa.9.1 = phi ptr [ %.sroa.9.0260, %.critedge ], [ %i.dn, %_ZNSt6vectorImSaImEE17_M_realloc_insertIJRKmEEEvN9__gnu_cxx17__normal_iteratorIPmS1_EEDpOT_.exit.i53 ], [ %.sroa.9.0260, %bb.s ] ; 5 uses
...
bb.by:                                            ; preds = %.loopexit193, %.loopexit.split-lp, %_ZZN6Assimp3MDL8HalfLife19UniqueNameGenerator11make_uniqueERSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS9_EEEN13DuplicateInfoD2Ev.exit80, %bb.x, %bb.bv, %bb.bm, %bb.bd
  ...
  %.sroa.14.5 = phi ptr [ %.sroa.14.0.lcssa, %bb.bm ], [ %.sroa.14.0.lcssa, %bb.bd ], [ %.sroa.14.0.lcssa, %bb.bv ], [ %.sroa.9.0260, %bb.x ], [ %.sroa.9.1, %_ZZN6Assimp3MDL8HalfLife19UniqueNameGenerator11make_uniqueERSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS9_EEEN13DuplicateInfoD2Ev.exit80 ], [ %.sroa.14.1.ph, %.loopexit193 ], [ %.sroa.9.0260, %.loopexit.split-lp ]
