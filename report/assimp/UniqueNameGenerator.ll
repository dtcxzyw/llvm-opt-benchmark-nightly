...
._crit_edge.loopexit:                             ; preds = %_ZNSt6vectorImSaImEE9push_backERKm.exit
  %i.av = icmp eq ptr %.sroa.9.2, %.sroa.0151.3
  br label %._crit_edge
...
begin_hunk_1_@_ZN6Assimp3MDL8HalfLife19UniqueNameGenerator11make_uniqueERSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS9_EE:bb.a
  ...
  %.sroa.9.0259 = phi ptr [ null, %.lr.ph ], [ %.sroa.9.2, %_ZNSt6vectorImSaImEE9push_backERKm.exit ] ; 9 uses
  %.sroa.14.0258 = phi ptr [ null, %.lr.ph ], [ %.sroa.14.3.a, %_ZNSt6vectorImSaImEE9push_backERKm.exit ] ; 8 uses
...
.loopexit192:                                     ; preds = %bb.as, %_ZNKSt6vectorImSaImEE12_M_check_lenEmPKc.exit.i.i, %_ZNKSt6vectorImSaImEE12_M_check_lenEmPKc.exit.i.i48, %bb.at
  ...
  %.sroa.14.1.ph = phi ptr [ %.sroa.14.2.a, %bb.as ], [ %.sroa.14.0258, %_ZNKSt6vectorImSaImEE12_M_check_lenEmPKc.exit.i.i ], [ %.sroa.9.0259, %_ZNKSt6vectorImSaImEE12_M_check_lenEmPKc.exit.i.i48 ], [ %.sroa.14.2.a, %bb.at ]
...
.loopexit.split-lp:                               ; preds = %bb.h, %bb.u
  ...
  %.sroa.14.0258308 = phi ptr [ %.sroa.14.0258, %bb.h ], [ %.sroa.9.0259, %bb.u ]
...
.critedge.thread:                                 ; preds = %bb.l, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EESA_.exit, %.critedge
  %.not.i47 = icmp eq ptr %.sroa.9.0259, %.sroa.14.0258
  br i1 %.not.i47, label %bb.t, label %bb.s

bb.s:                                             ; preds = %.critedge.thread
  store i64 %storemerge266, ptr %.sroa.9.0259, align 8
  %i.cx = getelementptr inbounds nuw i8, ptr %.sroa.9.0259, i64 8
...
_ZNSt6vectorImSaImEE9push_backERKm.exit56:        ; preds = %_ZNSt6vectorImSaImEE17_M_realloc_insertIJRKmEEEvN9__gnu_cxx17__normal_iteratorIPmS1_EEDpOT_.exit.i53, %bb.s, %.critedge
  %.sroa.14.2.a = phi ptr [ %.sroa.14.0258, %.critedge ], [ %i.dm, %_ZNSt6vectorImSaImEE17_M_realloc_insertIJRKmEEEvN9__gnu_cxx17__normal_iteratorIPmS1_EEDpOT_.exit.i53 ], [ %.sroa.14.0258, %bb.s ] ; 5 uses
  %.sroa.9.1 = phi ptr [ %.sroa.9.0259, %.critedge ], [ %i.dl, %_ZNSt6vectorImSaImEE17_M_realloc_insertIJRKmEEEvN9__gnu_cxx17__normal_iteratorIPmS1_EEDpOT_.exit.i53 ], [ %i.cx, %bb.s ] ; 2 uses
...
bb.bx:                                            ; preds = %.loopexit192, %.loopexit.split-lp, %_ZZN6Assimp3MDL8HalfLife19UniqueNameGenerator11make_uniqueERSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS9_EEEN13DuplicateInfoD2Ev.exit81, %bb.x, %bb.bu, %bb.bl, %bb.bc
  ...
  %.sroa.14.5 = phi ptr [ %.sroa.14.0.lcssa, %bb.bl ], [ %.sroa.14.0.lcssa, %bb.bc ], [ %.sroa.14.0.lcssa, %bb.bu ], [ %.sroa.14.0258, %bb.x ], [ %.sroa.14.2.a, %_ZZN6Assimp3MDL8HalfLife19UniqueNameGenerator11make_uniqueERSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS9_EEEN13DuplicateInfoD2Ev.exit81 ], [ %.sroa.14.1.ph, %.loopexit192 ], [ %.sroa.14.0258308, %.loopexit.split-lp ]
