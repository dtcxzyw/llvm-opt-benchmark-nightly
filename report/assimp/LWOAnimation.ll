...
begin_hunk_0_@_ZN6Assimp3LWO12AnimResolver18ExtractAnimChannelEPP10aiNodeAnimj:bb.a
  ...
  %i.fj = sdiv exact i64 %i.fi, 24                ; 3 uses
...
bb.ak:                                            ; preds = %bb.aj
  ...
  %6 = add nuw nsw i64 %i.fm, 576460752303423487
  %7 = and i64 %6, 576460752303423487
  %xtraiter = and i64 %i.fj, 7                    ; 2 uses
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %.prol.loopexit, label %.prol.preheader

.prol.preheader:                                  ; preds = %bb.ak, %.prol.preheader
  %8 = phi ptr [ %11, %.prol.preheader ], [ %i.fo, %bb.ak ] ; 4 uses
  %prol.iter = phi i64 [ %prol.iter.next, %.prol.preheader ], [ 0, %bb.ak ]
  ...
  %11 = getelementptr inbounds nuw i8, ptr %8, i64 32 ; 2 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.prol.loopexit, label %.prol.preheader, !llvm.loop !36

.prol.loopexit:                                   ; preds = %.prol.preheader, %bb.ak
  %.unr = phi ptr [ %i.fo, %bb.ak ], [ %11, %.prol.preheader ]
  %12 = icmp samesign ult i64 %7, 7
  br i1 %12, label %.loopexit131, label %bb.al

bb.al:                                            ; preds = %.prol.loopexit, %bb.al
  %i.fr = phi ptr [ %i.fu, %bb.al ], [ %.unr, %.prol.loopexit ] ; 25 uses
  store double 0.000000e+00, ptr %i.fr, align 8
  %13 = getelementptr inbounds nuw i8, ptr %i.fr, i64 8
  store <4 x float> <float 1.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00>, ptr %13, align 8
  %14 = getelementptr inbounds nuw i8, ptr %i.fr, i64 24
  store i32 1, ptr %14, align 8
  %15 = getelementptr inbounds nuw i8, ptr %i.fr, i64 32
  store double 0.000000e+00, ptr %15, align 8
  %16 = getelementptr inbounds nuw i8, ptr %i.fr, i64 40
  store <4 x float> <float 1.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00>, ptr %16, align 8
  %17 = getelementptr inbounds nuw i8, ptr %i.fr, i64 56
  store i32 1, ptr %17, align 8
  %18 = getelementptr inbounds nuw i8, ptr %i.fr, i64 64
  store double 0.000000e+00, ptr %18, align 8
  %19 = getelementptr inbounds nuw i8, ptr %i.fr, i64 72
  store <4 x float> <float 1.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00>, ptr %19, align 8
  %20 = getelementptr inbounds nuw i8, ptr %i.fr, i64 88
  store i32 1, ptr %20, align 8
  %21 = getelementptr inbounds nuw i8, ptr %i.fr, i64 96
  store double 0.000000e+00, ptr %21, align 8
  %22 = getelementptr inbounds nuw i8, ptr %i.fr, i64 104
  store <4 x float> <float 1.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00>, ptr %22, align 8
  %23 = getelementptr inbounds nuw i8, ptr %i.fr, i64 120
  store i32 1, ptr %23, align 8
  %24 = getelementptr inbounds nuw i8, ptr %i.fr, i64 128
  store double 0.000000e+00, ptr %24, align 8
  %25 = getelementptr inbounds nuw i8, ptr %i.fr, i64 136
  store <4 x float> <float 1.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00>, ptr %25, align 8
  %26 = getelementptr inbounds nuw i8, ptr %i.fr, i64 152
  store i32 1, ptr %26, align 8
  %27 = getelementptr inbounds nuw i8, ptr %i.fr, i64 160
  store double 0.000000e+00, ptr %27, align 8
  %28 = getelementptr inbounds nuw i8, ptr %i.fr, i64 168
  store <4 x float> <float 1.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00>, ptr %28, align 8
  %29 = getelementptr inbounds nuw i8, ptr %i.fr, i64 184
  store i32 1, ptr %29, align 8
  %30 = getelementptr inbounds nuw i8, ptr %i.fr, i64 192
  store double 0.000000e+00, ptr %30, align 8
  %31 = getelementptr inbounds nuw i8, ptr %i.fr, i64 200
  store <4 x float> <float 1.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00>, ptr %31, align 8
  %32 = getelementptr inbounds nuw i8, ptr %i.fr, i64 216
  store i32 1, ptr %32, align 8
  %33 = getelementptr inbounds nuw i8, ptr %i.fr, i64 224
  store double 0.000000e+00, ptr %33, align 8
  %i.fs = getelementptr inbounds nuw i8, ptr %i.fr, i64 232
  store <4 x float> <float 1.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00>, ptr %i.fs, align 8
  %i.ft = getelementptr inbounds nuw i8, ptr %i.fr, i64 248
  store i32 1, ptr %i.ft, align 8
  %i.fu = getelementptr inbounds nuw i8, ptr %i.fr, i64 256 ; 2 uses
  %i.fv = icmp eq ptr %i.fu, %i.fq
  br i1 %i.fv, label %.loopexit131, label %bb.al

.loopexit131:                                     ; preds = %.prol.loopexit, %bb.al, %bb.aj
...
begin_hunk_2_@_ZN6Assimp3LWO12AnimResolver18ExtractAnimChannelEPP10aiNodeAnimj:bb.a
  ...
  br i1 %i.jj, label %.lr.ph, label %._crit_edge.thread, !llvm.loop !38
