...
bb.u:                                             ; preds = %bb.t, %bb.s
  ...
  %2 = insertelement <2 x float> <float 0.000000e+00, float poison>, float %.sroa.5186.0, i64 1 ; 4 uses
  %3 = insertelement <2 x float> poison, float %i.dt, i64 0
  %4 = shufflevector <2 x float> %2, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 0>
  %i.in = shufflevector <2 x float> %3, <2 x float> poison, <4 x i32> zeroinitializer
  %i.io = fmul <4 x float> %4, %i.in
  ...
  %5 = insertelement <2 x float> poison, float %i.ge, i64 0
  %6 = shufflevector <2 x float> %2, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 0>
  %i.ja = shufflevector <2 x float> %5, <2 x float> poison, <4 x i32> zeroinitializer
  %i.jb = fmul <4 x float> %6, %i.ja
  ...
  %7 = insertelement <2 x float> poison, float %i.ht, i64 0
  %8 = shufflevector <2 x float> %2, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 0>
  %i.jk = shufflevector <2 x float> %7, <2 x float> poison, <4 x i32> zeroinitializer
  %i.jl = fmul <4 x float> %8, %i.jk
  ...
  %i.jx = fmul <2 x float> %2, %i.jw              ; 2 uses
