...
bb.u:                                             ; preds = %bb.t, %bb.s
  ...
  %2 = insertelement <4 x float> <float 0.000000e+00, float poison, float 1.000000e+00, float 0.000000e+00>, float %.scalar, i64 1
  %i.bp = insertelement <4 x float> poison, float %.sroa.0182.0, i64 0
  %i.bq = insertelement <4 x float> %i.bp, float %i.bl, i64 1
  %i.br = insertelement <4 x float> %i.bq, float %.sroa.5183.0, i64 2
  %i.bs = insertelement <4 x float> %i.br, float %i.bm, i64 3
  %i.bt = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.bs, <4 x float> zeroinitializer, <4 x float> %2) ; 4 uses
  ...
  %i.cr = fadd float %.sroa.0182.0, 0.000000e+00  ; 4 uses
  %3 = fadd float %i.bx, %i.cq
  %4 = extractelement <4 x float> %i.cj, i64 3    ; 4 uses
  %i.cs = tail call float @llvm.fmuladd.f32(float %4, float 0.000000e+00, float %3)
  %i.ct = tail call float @llvm.fmuladd.f32(float %i.cr, float 0.000000e+00, float %i.cs) ; 3 uses
  %i.cu = tail call float @llvm.fmuladd.f32(float %i.cq, float 0.000000e+00, float %i.by)
  %i.cv = tail call float @llvm.fmuladd.f32(float %i.bj, float %4, float %i.cu)
  %i.cw = tail call float @llvm.fmuladd.f32(float %i.cr, float 0.000000e+00, float %i.cv) ; 3 uses
  %i.cx = tail call float @llvm.fmuladd.f32(float %i.cq, float 0.000000e+00, float %i.bz)
  %i.cy = tail call float @llvm.fmuladd.f32(float %i.cq, float 0.000000e+00, float %i.bx)
  %i.cz = tail call float @llvm.fmuladd.f32(float %4, float 0.000000e+00, float %i.cy)
  %5 = fadd float %i.cr, %i.cz                    ; 4 uses
  %6 = fmul float %i.bg, %i.cw
  %i.da = tail call float @llvm.fmuladd.f32(float %i.bf, float %i.ct, float %6)
  %7 = fmul float %i.cw, 0.000000e+00
  %8 = tail call float @llvm.fmuladd.f32(float %i.bi, float %4, float %i.cx)
  %9 = insertelement <2 x float> poison, float %i.cr, i64 0
  %10 = insertelement <2 x float> %9, float %i.ct, i64 1
  %11 = insertelement <2 x float> poison, float %8, i64 0
  %12 = insertelement <2 x float> %11, float %7, i64 1
  %13 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %10, <2 x float> zeroinitializer, <2 x float> %12) ; 2 uses
  %i.db = extractelement <2 x float> %13, i64 0   ; 4 uses
  %14 = tail call float @llvm.fmuladd.f32(float %i.db, float 0.000000e+00, float %i.da)
  %i.dc = tail call float @llvm.fmuladd.f32(float %5, float 0.000000e+00, float %14)
  %i.dd = fmul float %i.bf, %i.cw
  %i.de = tail call float @llvm.fmuladd.f32(float %i.bh, float %i.ct, float %i.dd)
  %15 = tail call float @llvm.fmuladd.f32(float %i.db, float 0.000000e+00, float %i.de)
  %16 = tail call float @llvm.fmuladd.f32(float %5, float 0.000000e+00, float %15)
  %17 = extractelement <2 x float> %13, i64 1     ; 2 uses
  %18 = fadd float %i.db, %17
  %i.df = tail call float @llvm.fmuladd.f32(float %5, float 0.000000e+00, float %18)
  %i.dg = tail call float @llvm.fmuladd.f32(float %i.db, float 0.000000e+00, float %17)
  %19 = fadd float %5, %i.dg
  %20 = tail call float @llvm.fmuladd.f32(float %i.bl, float 0.000000e+00, float 0.000000e+00) ; 2 uses
  %21 = tail call float @llvm.fmuladd.f32(float %.sroa.5183.0, float 0.000000e+00, float %i.ck) ; 4 uses
  %22 = fadd float %.sroa.5183.0, 0.000000e+00    ; 4 uses
  %23 = fsub float %20, %i.bm
  %i.dh = tail call float @llvm.fmuladd.f32(float %i.bn, float 0.000000e+00, float %20) ; 2 uses
  %i.di = tail call float @llvm.fmuladd.f32(float %.sroa.5183.0, float 0.000000e+00, float %i.dh) ; 4 uses
  %24 = shufflevector <4 x float> %i.cj, <4 x float> poison, <4 x i32> <i32 poison, i32 0, i32 poison, i32 poison>
  %25 = insertelement <4 x float> %24, float %i.di, i64 0
  %26 = insertelement <4 x float> %25, float %i.dh, i64 2
  %27 = fadd <4 x float> %26, <float -0.000000e+00, float 0.000000e+00, float 0.000000e+00, float poison> ; 4 uses
  %28 = shufflevector <4 x float> %27, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 2>
  %29 = fmul float %i.bj, -0.000000e+00
  %30 = fmul float %i.bi, 0.000000e+00
  %31 = fmul float %i.ca, 0.000000e+00            ; 2 uses
  %32 = fadd float %31, %i.di
  %33 = tail call float @llvm.fmuladd.f32(float %21, float 0.000000e+00, float %32)
  %34 = tail call float @llvm.fmuladd.f32(float %22, float 0.000000e+00, float %33) ; 3 uses
  %35 = tail call float @llvm.fmuladd.f32(float %i.di, float 0.000000e+00, float %i.cb)
  %i.dj = tail call float @llvm.fmuladd.f32(float %i.bj, float %21, float %35)
  %i.dk = tail call float @llvm.fmuladd.f32(float %22, float 0.000000e+00, float %i.dj) ; 3 uses
  %i.dl = tail call float @llvm.fmuladd.f32(float %i.di, float 0.000000e+00, float %i.cc)
  %i.dm = insertelement <4 x float> poison, float %31, i64 0
  %i.dn = shufflevector <4 x float> %i.dm, <4 x float> %27, <4 x i32> <i32 0, i32 6, i32 poison, i32 poison>
  %36 = insertelement <4 x float> %i.dn, float %30, i64 2
  %37 = insertelement <4 x float> %36, float %29, i64 3
  %i.do = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %28, <4 x float> zeroinitializer, <4 x float> %37) ; 4 uses
  %i.dp = extractelement <4 x float> %i.do, i64 0
  %i.dq = tail call float @llvm.fmuladd.f32(float %21, float 0.000000e+00, float %i.dp)
  %i.dr = fadd float %22, %i.dq                   ; 4 uses
  %i.ds = extractelement <4 x float> %i.do, i64 1
  %i.dt = fadd float %i.ds, 0.000000e+00          ; 3 uses
  %i.du = extractelement <4 x float> %i.do, i64 2
  %i.dv = extractelement <4 x float> %27, i64 1   ; 3 uses
  ...
  %i.eb = extractelement <4 x float> %27, i64 2
  ...
  %38 = fmul float %i.bg, %i.dk
  %i.ef = tail call float @llvm.fmuladd.f32(float %i.bf, float %34, float %38)
  %i.eg = fmul float %i.dk, 0.000000e+00
  %i.eh = tail call float @llvm.fmuladd.f32(float %i.bi, float %21, float %i.dl)
  %i.ei = insertelement <2 x float> poison, float %22, i64 0
  %i.ej = insertelement <2 x float> %i.ei, float %34, i64 1
  ...
  %i.eq = fmul float %i.bf, %i.dk
  %i.er = tail call float @llvm.fmuladd.f32(float %i.bh, float %34, float %i.eq)
  ...
  %i.fd = insertelement <4 x float> %i.fc, float %23, i64 3
  ...
  %i.hi = insertelement <4 x float> poison, float %i.dc, i64 0
  ...
  %i.hm = insertelement <4 x float> poison, float %i.df, i64 0
  ...
  %i.hp = insertelement <4 x float> poison, float %19, i64 0
