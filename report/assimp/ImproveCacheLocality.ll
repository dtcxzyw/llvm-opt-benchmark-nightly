...
bb.s:                                             ; preds = %_ZNSt6vectorIjSaIjEE6resizeEm.exit160, %.loopexit363
  ...
  %.0119457 = phi i32 [ 1, %_ZNSt6vectorIjSaIjEE6resizeEm.exit160 ], [ %.2121, %.loopexit363 ] ; 4 uses
...
bb.ak:                                            ; preds = %bb.al
  %4 = icmp slt i64 %indvars.iv.next477, %i.ht
  br i1 %4, label %bb.al, label %.loopexit363.thread, !llvm.loop !15
