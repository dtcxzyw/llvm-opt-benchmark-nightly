...
begin_hunk_1_@_ZN6Assimp3IFC16ProjectOntoPlaneERSt6vectorI10aiVector2tIdESaIS3_EERKNS0_8TempMeshERbR10aiVector3tIdE:bb.a
  ...
  %6 = load <3 x double>, ptr %5, align 8         ; 6 uses
  %7 = shufflevector <3 x double> %6, <3 x double> poison, <6 x i32> <i32 0, i32 1, i32 2, i32 0, i32 1, i32 2>
  %8 = load double, ptr %i.k, align 8
  %9 = load <3 x double>, ptr %i.l, align 8       ; 4 uses
  %10 = shufflevector <3 x double> %9, <3 x double> poison, <6 x i32> <i32 0, i32 1, i32 2, i32 0, i32 1, i32 2>
  %11 = load <3 x double>, ptr %i.m, align 8      ; 5 uses
  %12 = shufflevector <3 x double> %11, <3 x double> poison, <6 x i32> <i32 0, i32 1, i32 2, i32 0, i32 1, i32 2>
...
.lr.ph.preheader:                                 ; preds = %_ZNSt6vectorI10aiVector2tIdESaIS1_EE7reserveEm.exit
  %i.az = extractelement <3 x double> %11, i64 0
  %13 = extractelement <3 x double> %11, i64 2
  %14 = shufflevector <3 x double> %6, <3 x double> %9, <2 x i32> <i32 1, i32 4>
  %15 = shufflevector <3 x double> %6, <3 x double> %9, <2 x i32> <i32 0, i32 3>
  %16 = shufflevector <3 x double> %6, <3 x double> %9, <2 x i32> <i32 2, i32 5>
  br label %.lr.ph
...
begin_hunk_3_@_ZN6Assimp3IFC16ProjectOntoPlaneERSt6vectorI10aiVector2tIdESaIS3_EERKNS0_8TempMeshERbR10aiVector3tIdE:bb.a
  ...
  %i.cp = fmul double %i.o, %i.cm
  %i.cq = call double @llvm.fmuladd.f64(double %i.az, double %i.ck, double %i.cp)
...
begin_hunk_4_@_ZN6Assimp3IFC16ProjectOntoPlaneERSt6vectorI10aiVector2tIdESaIS3_EERKNS0_8TempMeshERbR10aiVector3tIdE:bb.a
  ...
  %i.dc = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %16, <2 x double> %i.db, <2 x double> %i.cz) ; 3 uses
...
begin_hunk_5_@_ZN6Assimp3IFC16ProjectOntoPlaneERSt6vectorI10aiVector2tIdESaIS3_EERKNS0_8TempMeshERbR10aiVector3tIdE:bb.a
  ...
  %17 = shufflevector <2 x double> %i.ee, <2 x double> poison, <6 x i32> <i32 0, i32 0, i32 0, i32 1, i32 1, i32 1> ; 2 uses
  %18 = shufflevector <6 x double> <double 0.000000e+00, double 0.000000e+00, double 0.000000e+00, double poison, double poison, double poison>, <6 x double> %17, <6 x i32> <i32 0, i32 1, i32 2, i32 9, i32 10, i32 11>
  %i.en = fmul <6 x double> %10, %18              ; 4 uses
  ...
  %19 = shufflevector <6 x double> %12, <6 x double> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 poison, i32 poison>
  %20 = shufflevector <6 x double> %7, <6 x double> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 poison, i32 poison>
  %21 = shufflevector <6 x double> %17, <6 x double> <double poison, double poison, double poison, double 0.000000e+00, double 0.000000e+00, double 0.000000e+00>, <8 x i32> <i32 0, i32 1, i32 2, i32 9, i32 10, i32 11, i32 poison, i32 poison>
  %i.et = shufflevector <6 x double> %i.en, <6 x double> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 poison, i32 poison>
  %i.eu = call <8 x double> @llvm.fmuladd.v8f64(<8 x double> %20, <8 x double> %21, <8 x double> %i.et)
  %i.ev = call <8 x double> @llvm.fmuladd.v8f64(<8 x double> %19, <8 x double> <double 0.000000e+00, double 0.000000e+00, double 0.000000e+00, double 0.000000e+00, double 0.000000e+00, double 0.000000e+00, double undef, double undef>, <8 x double> %i.eu)
  ...
  %i.ey = extractelement <3 x double> %6, i64 0
  %i.ez = extractelement <6 x double> %i.en, i64 0
  %i.fa = call double @llvm.fmuladd.f64(double %i.ey, double 0.000000e+00, double %i.ez) ; 2 uses
  %22 = extractelement <3 x double> %11, i64 0    ; 2 uses
  %i.fb = fadd double %i.fa, %22
  %i.fc = call double @llvm.fmuladd.f64(double %i.eh, double 0.000000e+00, double %i.fb)
  %i.fd = extractelement <6 x double> %i.en, i64 1
  %i.fe = call double @llvm.fmuladd.f64(double %8, double 0.000000e+00, double %i.fd) ; 2 uses
  %23 = fadd double %i.fe, %i.o
  %24 = call double @llvm.fmuladd.f64(double %i.eh, double 0.000000e+00, double %23)
  %25 = extractelement <3 x double> %6, i64 2
  %i.ff = extractelement <6 x double> %i.en, i64 2
  %i.fg = call double @llvm.fmuladd.f64(double %25, double 0.000000e+00, double %i.ff) ; 2 uses
  %26 = extractelement <3 x double> %11, i64 2    ; 2 uses
  %i.fh = fadd double %i.fg, %26
  %i.fi = call double @llvm.fmuladd.f64(double %i.eh, double 0.000000e+00, double %i.fh)
  %i.fj = call double @llvm.fmuladd.f64(double %22, double 0.000000e+00, double %i.fa)
  %i.fk = call double @llvm.fmuladd.f64(double %i.o, double 0.000000e+00, double %i.fe)
  %i.fl = fadd double %i.fk, 0.000000e+00
  %i.fm = call double @llvm.fmuladd.f64(double %26, double 0.000000e+00, double %i.fg)
  ...
  store double %24, ptr %.sroa.39.0..sroa_idx, align 8
