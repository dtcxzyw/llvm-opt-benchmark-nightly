...
bb.y:                                             ; preds = %.lr.ph, %_ZNSt6vectorI10aiVector2tIdESaIS1_EE12emplace_backIJRdS5_EEERS1_DpOT_.exit
  ...
  %15 = load <3 x double>, ptr %i.em, align 8, !noalias !324 ; 3 uses
  ...
  %i.iq = fmul <2 x double> %16, %i.ip
  %i.ir = shufflevector <3 x double> %15, <3 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.iv = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %17, <2 x double> %i.iu, <2 x double> %i.it) ; 3 uses
