...
bb.y:                                             ; preds = %.lr.ph, %_ZNSt6vectorI10aiVector2tIdESaIS1_EE12emplace_backIJRdS5_EEERS1_DpOT_.exit
  ...
  %15 = getelementptr inbounds nuw i8, ptr %.sroa.0112.0132, i64 8
  %i.hk = load <4 x double>, ptr %i.ej, align 8, !noalias !324 ; 2 uses
  %i.hl = load double, ptr %i.ek, align 8, !noalias !324
  %16 = shufflevector <4 x double> %i.hk, <4 x double> poison, <2 x i32> <i32 0, i32 3> ; 2 uses
  %17 = shufflevector <4 x double> %i.hk, <4 x double> poison, <2 x i32> <i32 1, i32 2> ; 2 uses
  %18 = insertelement <2 x double> %17, double %i.ei, i64 0 ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %14) #27
  %19 = load double, ptr %15, align 8, !noalias !324
  %20 = load <3 x double>, ptr %.sroa.0112.0132, align 8, !noalias !324 ; 6 uses
  %21 = load <2 x double>, ptr %i.el, align 8, !noalias !324 ; 3 uses
  %22 = shufflevector <3 x double> %20, <3 x double> poison, <2 x i32> <i32 1, i32 1>
  %23 = fmul <2 x double> %22, %16
  %24 = shufflevector <3 x double> %20, <3 x double> poison, <2 x i32> zeroinitializer
  %25 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %18, <2 x double> %24, <2 x double> %23)
  %26 = shufflevector <2 x double> %17, <2 x double> %21, <2 x i32> <i32 0, i32 3>
  %27 = shufflevector <3 x double> %20, <3 x double> poison, <2 x i32> <i32 2, i32 2>
  %i.hm = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %26, <2 x double> %27, <2 x double> %25)
  store <2 x double> %i.hm, ptr %13, align 16, !alias.scope !324
  %28 = load <2 x double>, ptr %i.ep, align 8, !noalias !325 ; 2 uses
  %29 = shufflevector <2 x double> %28, <2 x double> poison, <3 x i32> <i32 poison, i32 0, i32 poison>
  %30 = insertelement <3 x double> %29, double %i.eo, i64 0
  %31 = shufflevector <2 x double> %28, <2 x double> poison, <3 x i32> <i32 poison, i32 1, i32 poison>
  %32 = shufflevector <3 x double> %30, <3 x double> %31, <3 x i32> <i32 0, i32 1, i32 4>
  %33 = fadd <3 x double> %20, %32                ; 5 uses
  %34 = shufflevector <2 x double> %16, <2 x double> %21, <2 x i32> <i32 0, i32 2>
  %35 = shufflevector <3 x double> %33, <3 x double> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  %i.hn = fmul <2 x double> %34, %35
  %i.ho = shufflevector <3 x double> %33, <3 x double> poison, <2 x i32> zeroinitializer
  %i.hp = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %18, <2 x double> %i.ho, <2 x double> %i.hn)
  %i.hq = insertelement <2 x double> %21, double %i.hl, i64 0
  %36 = shufflevector <3 x double> %33, <3 x double> poison, <2 x i32> <i32 2, i32 2>
  %i.hr = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.hq, <2 x double> %36, <2 x double> %i.hp)
  store <2 x double> %i.hr, ptr %14, align 16, !alias.scope !329
  %i.hs = load <3 x double>, ptr %i.em, align 8, !noalias !324 ; 3 uses
  %37 = shufflevector <3 x double> %i.hs, <3 x double> poison, <2 x i32> <i32 1, i32 1>
  %38 = insertelement <2 x double> %35, double %19, i64 0
  %i.ht = fmul <2 x double> %37, %38
  %i.hu = shufflevector <3 x double> %i.hs, <3 x double> poison, <2 x i32> zeroinitializer
  %39 = shufflevector <3 x double> %20, <3 x double> %33, <2 x i32> <i32 0, i32 3>
  %i.hv = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.hu, <2 x double> %39, <2 x double> %i.ht)
  %i.hw = shufflevector <3 x double> %i.hs, <3 x double> poison, <2 x i32> <i32 2, i32 2>
  %40 = shufflevector <3 x double> %20, <3 x double> %33, <2 x i32> <i32 2, i32 5>
  %i.hx = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.hw, <2 x double> %40, <2 x double> %i.hv) ; 3 uses
...
bb.af:                                            ; preds = %_ZNSt7__cxx1118basic_stringstreamIcSt11char_traitsIcESaIcEED1Ev.exit230
  ...
  %i.jd = getelementptr inbounds nuw [24 x i8], ptr %i.jc, i64 %.0111738 ; 3 uses
  %24 = getelementptr inbounds nuw i8, ptr %i.jd, i64 8
  %25 = getelementptr inbounds nuw i8, ptr %i.jd, i64 16
  %i.je = load double, ptr %24, align 8, !noalias !395 ; 2 uses
  %26 = load double, ptr %i.jd, align 8, !noalias !395 ; 2 uses
  %27 = load double, ptr %25, align 8, !noalias !395 ; 2 uses
  %28 = fmul double %i.je, %i.at
  %29 = call double @llvm.fmuladd.f64(double %i.ap, double %26, double %28)
  %i.jf = call double @llvm.fmuladd.f64(double %i.ax, double %27, double %29) ; 2 uses
...
.lr.ph734.preheader:                              ; preds = %bb.af
  ...
  %30 = insertelement <2 x double> poison, double %i.je, i64 0
  %31 = shufflevector <2 x double> %30, <2 x double> poison, <2 x i32> zeroinitializer
  %i.jk = fmul <2 x double> %i.eo, %31
  %32 = insertelement <2 x double> poison, double %26, i64 0
  %i.jl = shufflevector <2 x double> %32, <2 x double> poison, <2 x i32> zeroinitializer
  %i.jm = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.em, <2 x double> %i.jl, <2 x double> %i.jk)
  %33 = insertelement <2 x double> poison, double %27, i64 0
  %34 = shufflevector <2 x double> %33, <2 x double> poison, <2 x i32> zeroinitializer
  %i.jn = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ek, <2 x double> %34, <2 x double> %i.jm) ; 2 uses
...
.lr.ph734:                                        ; preds = %.lr.ph734.preheader, %_ZNSt5dequeISt4pairI10aiVector2tIdES2_ESaIS3_EE9push_backERKS3_.exit265
  ...
  %i.js = phi <2 x double> [ %44, %_ZNSt5dequeISt4pairI10aiVector2tIdES2_ESaIS3_EE9push_backERKS3_.exit265 ], [ %i.jn, %.lr.ph734.preheader ] ; 4 uses
  ...
  %i.jw = getelementptr inbounds nuw [24 x i8], ptr %i.jv, i64 %.0118733 ; 3 uses
  %35 = getelementptr inbounds nuw i8, ptr %i.jw, i64 8
  %36 = getelementptr inbounds nuw i8, ptr %i.jw, i64 16
  %37 = load double, ptr %35, align 8, !noalias !396 ; 2 uses
  %38 = load double, ptr %i.jw, align 8, !noalias !396 ; 2 uses
  %i.jx = load double, ptr %36, align 8, !noalias !396 ; 2 uses
  %39 = insertelement <2 x double> poison, double %37, i64 0
  %40 = shufflevector <2 x double> %39, <2 x double> poison, <2 x i32> zeroinitializer
  %i.jy = fmul <2 x double> %i.eo, %40
  %41 = insertelement <2 x double> poison, double %38, i64 0
  %i.jz = shufflevector <2 x double> %41, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ka = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.em, <2 x double> %i.jz, <2 x double> %i.jy)
  %42 = insertelement <2 x double> poison, double %i.jx, i64 0
  %43 = shufflevector <2 x double> %42, <2 x double> poison, <2 x i32> zeroinitializer
  %44 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ek, <2 x double> %43, <2 x double> %i.ka) ; 3 uses
  %i.kb = fmul double %i.at, %37
  %i.kc = call double @llvm.fmuladd.f64(double %i.ap, double %38, double %i.kb)
  %i.kd = call double @llvm.fmuladd.f64(double %i.ax, double %i.jx, double %i.kc) ; 4 uses
...
bb.ai:                                            ; preds = %.lr.ph734, %bb.ah
  %i.kr = phi <2 x double> [ %i.kq, %bb.ah ], [ %44, %.lr.ph734 ] ; 5 uses
