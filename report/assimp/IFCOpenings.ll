...
.lr.ph:                                           ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit193.preheader, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit219
  ...
  %24 = getelementptr inbounds nuw i8, ptr %i.fr, i64 8
  %i.fs = load double, ptr %24, align 8, !noalias !349 ; 3 uses
  %i.ft = getelementptr inbounds nuw i8, ptr %i.fr, i64 16
  %25 = fmul double %i.fs, %i.at
  %26 = load double, ptr %i.fr, align 8, !noalias !349 ; 3 uses
  %i.fu = load double, ptr %i.ft, align 8, !noalias !349 ; 3 uses
  %i.fv = fmul double %i.fs, %i.ag
  %i.fw = call double @llvm.fmuladd.f64(double %i.ac, double %26, double %i.fv)
  %i.fx = insertelement <2 x double> poison, double %i.fu, i64 0
  %i.fy = insertelement <2 x double> %i.fx, double %26, i64 1
  %i.fz = insertelement <2 x double> poison, double %i.fw, i64 0
  %i.ga = insertelement <2 x double> %i.fz, double %25, i64 1
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit205: ; preds = %.lr.ph
  %i.gf = fmul double %i.t, %i.fs
  %i.gg = call double @llvm.fmuladd.f64(double %i.p, double %26, double %i.gf)
