...
.lr.ph658:                                        ; preds = %bb.cu
  %18 = load <8 x double>, ptr %9, align 8, !noalias !257 ; 12 uses
  %19 = getelementptr inbounds nuw i8, ptr %9, i64 64
  %20 = load double, ptr %19, align 8, !noalias !257 ; 2 uses
  %i.ua = getelementptr inbounds nuw i8, ptr %9, i64 72
  %i.ub = load double, ptr %i.ua, align 8, !noalias !257 ; 2 uses
  %i.uc = getelementptr inbounds nuw i8, ptr %9, i64 80
  %i.ud = load double, ptr %i.uc, align 8, !noalias !257 ; 2 uses
  %i.ue = getelementptr inbounds nuw i8, ptr %9, i64 88
  %i.uf = load double, ptr %i.ue, align 8, !noalias !257 ; 2 uses
  %21 = ptrtoint ptr %i.tz to i64
  %22 = ptrtoint ptr %i.tx to i64
  %23 = sub i64 %21, %22
  %24 = add i64 %23, -24                          ; 2 uses
  %i.ug = udiv i64 %24, 24
...
vector.ph:                                        ; preds = %.lr.ph658
  ...
  %broadcast.splat = shufflevector <8 x double> %18, <8 x double> poison, <2 x i32> zeroinitializer
  %broadcast.splat1099 = shufflevector <8 x double> %18, <8 x double> poison, <2 x i32> <i32 1, i32 1>
  %broadcast.splat1101 = shufflevector <8 x double> %18, <8 x double> poison, <2 x i32> <i32 2, i32 2>
  %broadcast.splat1103 = shufflevector <8 x double> %18, <8 x double> poison, <2 x i32> <i32 3, i32 3>
  %broadcast.splat1105 = shufflevector <8 x double> %18, <8 x double> poison, <2 x i32> <i32 4, i32 4>
  %broadcast.splat1107 = shufflevector <8 x double> %18, <8 x double> poison, <2 x i32> <i32 5, i32 5>
  %broadcast.splat1109 = shufflevector <8 x double> %18, <8 x double> poison, <2 x i32> <i32 6, i32 6>
  %broadcast.splat1111 = shufflevector <8 x double> %18, <8 x double> poison, <2 x i32> <i32 7, i32 7>
  %broadcast.splatinsert1112 = insertelement <2 x double> poison, double %20, i64 0
  %broadcast.splat1113 = shufflevector <2 x double> %broadcast.splatinsert1112, <2 x double> poison, <2 x i32> zeroinitializer
  %broadcast.splatinsert1114 = insertelement <2 x double> poison, double %i.ub, i64 0
  %broadcast.splat1115 = shufflevector <2 x double> %broadcast.splatinsert1114, <2 x double> poison, <2 x i32> zeroinitializer
  %broadcast.splatinsert1116 = insertelement <2 x double> poison, double %i.ud, i64 0
  %broadcast.splat1117 = shufflevector <2 x double> %broadcast.splatinsert1116, <2 x double> poison, <2 x i32> zeroinitializer
  %broadcast.splatinsert1118 = insertelement <2 x double> poison, double %i.uf, i64 0
...
scalar.ph.preheader:                              ; preds = %.lr.ph658, %middle.block
  ...
  %i.vr = shufflevector <8 x double> %18, <8 x double> poison, <2 x i32> <i32 1, i32 5>
  %i.vs = shufflevector <8 x double> %18, <8 x double> poison, <2 x i32> <i32 0, i32 4>
  %i.vt = shufflevector <8 x double> %18, <8 x double> poison, <2 x i32> <i32 2, i32 6>
  %i.vu = shufflevector <8 x double> %18, <8 x double> poison, <2 x i32> <i32 3, i32 7>
  br label %scalar.ph
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %i.wa = fmul double %i.vx, %i.ub
  %i.wb = call double @llvm.fmuladd.f64(double %20, double %i.vv, double %i.wa)
  %i.wc = call double @llvm.fmuladd.f64(double %i.ud, double %i.vz, double %i.wb)
  %i.wd = fadd double %i.uf, %i.wc
