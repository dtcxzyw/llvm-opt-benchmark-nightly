...
bb.a:
  ...
  %i.j = load double, ptr %i.i, align 8           ; 11 uses
  ...
  %i.r = load double, ptr %i.f, align 8           ; 7 uses
  ...
  %i.aw = load <2 x double>, ptr %i.g, align 8    ; 8 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.ej = shufflevector <3 x double> %i.ei, <3 x double> %i.w, <3 x i32> <i32 0, i32 3, i32 5>
  ...
  %i.fm = shufflevector <3 x double> %i.fk, <3 x double> %i.fl, <3 x i32> <i32 0, i32 1, i32 4>
  %i.fn = fmul <3 x double> %i.fm, %i.ek
  %i.fo = shufflevector <3 x double> %i.w, <3 x double> %i.q, <3 x i32> <i32 0, i32 2, i32 5>
  %1 = shufflevector <2 x double> %i.aw, <2 x double> poison, <3 x i32> <i32 1, i32 poison, i32 poison>
  %2 = insertelement <3 x double> %1, double %i.r, i64 1
  %3 = insertelement <3 x double> %2, double %i.j, i64 2
  %i.fp = tail call <3 x double> @llvm.fmuladd.v3f64(<3 x double> %i.fo, <3 x double> %3, <3 x double> %i.fn) ; 4 uses
