...
.lr.ph473:                                        ; preds = %bb.au
  ...
  %9 = getelementptr inbounds nuw i8, ptr %i.mg, i64 1052 ; 2 uses
...
bb.av:                                            ; preds = %.lr.ph473, %._crit_edge469
  ...
  %i.nx = load float, ptr %i.mt, align 8          ; 4 uses
  %11 = load float, ptr %i.mk, align 4            ; 4 uses
  %12 = load float, ptr %i.ml, align 8            ; 4 uses
  %13 = load float, ptr %i.mw, align 4            ; 4 uses
  %14 = fmul float %11, %12                       ; 3 uses
  %i.ny = fmul float %14, %i.nj
  %i.nz = fmul float %14, %i.nl
  %i.oa = fmul float %i.nz, %i.nn
  %i.ob = call float @llvm.fmuladd.f32(float %i.ny, float %i.nk, float %i.oa)
  %i.oc = fmul float %11, %10                     ; 2 uses
  ...
  %i.oh = fmul float %11, %i.nr                   ; 2 uses
  ...
  %i.om = fmul float %10, %i.nx                   ; 3 uses
  ...
  %i.ow = fmul float %i.nx, %13                   ; 2 uses
  ...
  %i.pb = load float, ptr %i.mx, align 4          ; 4 uses
  ...
  %i.ph = fmul float %13, %i.pb                   ; 3 uses
  ...
  %i.pm = fmul float %12, %i.pb                   ; 2 uses
  ...
  %i.ps = fmul float %13, %i.pr                   ; 2 uses
  ...
  %i.px = fmul float %12, %i.pr                   ; 2 uses
  ...
  %i.qc = fmul float %10, %i.pr                   ; 2 uses
...
._crit_edge514:                                   ; preds = %bb.aw
  %.pre517 = load float, ptr %i.mx, align 4       ; 2 uses
  %.pre516 = load float, ptr %i.mt, align 8       ; 2 uses
  %.pre515 = load float, ptr %i.mk, align 4       ; 3 uses
  %.pre519 = load float, ptr %i.ml, align 8       ; 2 uses
  %.pre518 = load float, ptr %i.mw, align 4       ; 2 uses
  %.pre520 = load float, ptr %9, align 4          ; 3 uses
...
bb.ay:                                            ; preds = %._crit_edge514, %bb.av
  ...
  %.pre-phi538 = phi float [ %.pre537, %._crit_edge514 ], [ %14, %bb.av ]
  ...
  %i.qm = phi float [ %.pre520, %._crit_edge514 ], [ %10, %bb.av ] ; 3 uses
  %i.qn = phi float [ %.pre519, %._crit_edge514 ], [ %12, %bb.av ] ; 3 uses
  %i.qo = phi float [ %.pre518, %._crit_edge514 ], [ %13, %bb.av ] ; 2 uses
  %i.qp = phi float [ %.pre517, %._crit_edge514 ], [ %i.pb, %bb.av ] ; 3 uses
  %i.qq = phi float [ %.pre516, %._crit_edge514 ], [ %i.nx, %bb.av ] ; 3 uses
  %i.qr = phi float [ %.pre515, %._crit_edge514 ], [ %11, %bb.av ] ; 3 uses
...
bb.az:                                            ; preds = %bb.ay
  ...
  %15 = insertelement <2 x float> poison, float %i.qp, i64 0
  %16 = insertelement <2 x float> %15, float %i.qm, i64 1 ; 2 uses
  ...
  %17 = call float @llvm.fmuladd.f32(float %i.qr, float %i.qm, float %i.rk)
  %18 = fmul float %17, %i.rg
  %19 = insertelement <2 x float> poison, float %i.qq, i64 0
  %i.rl = insertelement <2 x float> %19, float %i.qn, i64 1 ; 2 uses
  %i.rm = insertelement <2 x float> poison, float %i.qj, i64 0
  %20 = shufflevector <2 x float> %i.rm, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %21 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.rl, <2 x float> %20, <2 x float> %i.rf)
  %22 = insertelement <2 x float> poison, float %i.rg, i64 0
  %23 = insertelement <2 x float> %22, float %i.rc, i64 1 ; 3 uses
  %24 = fmul <2 x float> %21, %23
  %25 = insertelement <2 x float> poison, float %i.rj, i64 0
  %26 = shufflevector <2 x float> %25, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.rn = fmul <2 x float> %16, %26
  %i.ro = insertelement <2 x float> poison, float %i.qr, i64 0
  %27 = insertelement <2 x float> %i.ro, float %i.qo, i64 1 ; 2 uses
  %i.rp = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %27, <2 x float> %20, <2 x float> %i.rn)
  %28 = shufflevector <2 x float> %23, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %29 = fmul <2 x float> %i.rp, %28
  %30 = fmul <2 x float> %i.rl, %26
  %i.rq = insertelement <2 x float> poison, float %i.qk, i64 0
  %31 = shufflevector <2 x float> %i.rq, <2 x float> poison, <2 x i32> zeroinitializer
  %i.rr = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %27, <2 x float> %31, <2 x float> %30)
  %32 = fmul <2 x float> %i.rr, %23
  %33 = call float @llvm.fmuladd.f32(float %i.qr, float %i.qn, float %i.qv)
  %34 = fmul float %33, %i.rc
...
_ZN12aiMatrix3x3tIfE7InverseEv.exit:              ; preds = %bb.az, %bb.ay
  ...
  %storemerge20.i = phi float [ %18, %bb.az ], [ +qnan, %bb.ay ] ; 3 uses
  %storemerge.i = phi float [ %34, %bb.az ], [ +qnan, %bb.ay ] ; 3 uses
  %i.rs = phi <2 x float> [ %32, %bb.az ], [ splat (float +qnan), %bb.ay ] ; 3 uses
  %i.rt = phi <2 x float> [ %24, %bb.az ], [ splat (float +qnan), %bb.ay ] ; 3 uses
  %i.ru = phi <2 x float> [ %29, %bb.az ], [ splat (float +qnan), %bb.ay ] ; 3 uses
...
bb.bb:                                            ; preds = %bb.ba
  ...
  %i.tx = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.rt, <2 x float> %i.tw, <2 x float> %i.tu)
  ...
  %i.ua = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.rs, <2 x float> %i.tz, <2 x float> %i.tx)
  %i.ub = shufflevector <2 x float> %i.ua, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %i.uc = fmul float %storemerge20.i, %i.tp
  %i.ud = call float @llvm.fmuladd.f32(float %storemerge23.i, float %i.tn, float %i.uc)
  %i.ue = call float @llvm.fmuladd.f32(float %storemerge.i, float %i.tr, float %i.ud)
...
bb.bd:                                            ; preds = %_ZNK6aiMesh24HasTangentsAndBitangentsEv.exit
  ...
  %i.us = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.rt, <2 x float> %i.ur, <2 x float> %i.up)
  ...
  %i.uv = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.rs, <2 x float> %i.uu, <2 x float> %i.us)
  %i.uw = shufflevector <2 x float> %i.uv, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %i.ux = fmul float %storemerge20.i, %i.uk
  %i.uy = call float @llvm.fmuladd.f32(float %storemerge23.i, float %i.ui, float %i.ux)
  %i.uz = call float @llvm.fmuladd.f32(float %storemerge.i, float %i.um, float %i.uy)
  ...
  %i.vm = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.rt, <2 x float> %i.vl, <2 x float> %i.vj)
  ...
  %i.vp = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.rs, <2 x float> %i.vo, <2 x float> %i.vm)
  %i.vq = shufflevector <2 x float> %i.vp, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %i.vr = fmul float %storemerge20.i, %i.ve
  %i.vs = call float @llvm.fmuladd.f32(float %storemerge23.i, float %i.vc, float %i.vr)
  %i.vt = call float @llvm.fmuladd.f32(float %storemerge.i, float %i.vg, float %i.vs)
