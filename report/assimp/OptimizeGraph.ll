...
.critedge131.thread:                              ; preds = %._crit_edge444, %bb.al, %bb.ab, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit219
  %.390 = phi ptr [ %.087451, %bb.ab ], [ %i.gm, %bb.al ], [ %.087451, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit219 ], [ %.087451, %._crit_edge444 ]
...
bb.ap:                                            ; preds = %bb.ao, %.critedge131.thread
  ...
  %.491 = phi ptr [ %.390, %.critedge131.thread ], [ %.087451, %bb.ao ] ; 7 uses
  %.not429 = icmp eq ptr %.sroa.0339.3, %3
  br i1 %.not429, label %._crit_edge454, label %bb.ab

bb.aq:                                            ; preds = %._crit_edge454
  %i.kz = getelementptr inbounds nuw i8, ptr %.491, i64 4
  ...
  store i32 %i.ld, ptr %.491, align 8
...
.lr.ph461:                                        ; preds = %bb.aq, %.lr.ph461
  ...
  %.078458 = phi i32 [ %i.li, %.lr.ph461 ], [ 0, %bb.aq ]
  ...
  %i.li = add i32 %i.lh, %.078458                 ; 4 uses
...
bb.ar:                                            ; preds = %._crit_edge462
  %i.lj = getelementptr inbounds nuw i8, ptr %.491, i64 1120 ; 5 uses
...
.lr.ph466:                                        ; preds = %.preheader436
  %i.lq = getelementptr inbounds nuw i8, ptr %.491, i64 1128
  br label %bb.at

.preheader435:                                    ; preds = %bb.at, %.preheader436
  %.077.lcssa = phi ptr [ %i.lo, %.preheader436 ], [ %i.lw, %bb.at ]
...
bb.at:                                            ; preds = %.lr.ph466, %bb.at
  ...
  %.077464 = phi ptr [ %i.lo, %.lr.ph466 ], [ %i.lw, %bb.at ] ; 2 uses
  ...
  %i.lw = getelementptr inbounds nuw i8, ptr %.077464, i64 4 ; 2 uses
  store i32 %i.lv, ptr %.077464, align 4
...
._crit_edge482:                                   ; preds = %._crit_edge475, %.preheader435
  %i.ma = getelementptr inbounds nuw i8, ptr %.491, i64 1128 ; 2 uses
...
bb.au:                                            ; preds = %.lr.ph481, %._crit_edge475
  ...
  %.1479 = phi ptr [ %.077.lcssa, %.lr.ph481 ], [ %.2.lcssa, %._crit_edge475 ] ; 2 uses
...
bb.av:                                            ; preds = %.lr.ph474, %._crit_edge470
  ...
  %.2471 = phi ptr [ %.1479, %.lr.ph474 ], [ %i.nd, %._crit_edge470 ] ; 2 uses
  ...
  %i.oi = fmul float %10, %i.np                   ; 2 uses
  ...
  %i.ox = fmul float %i.nv, %12                   ; 2 uses
  ...
  %i.pi = fmul float %12, %i.pc                   ; 3 uses
  ...
  %i.pt = fmul float %12, %i.ps                   ; 2 uses
  ...
  %14 = shufflevector <2 x float> %9, <2 x float> %11, <2 x i32> <i32 0, i32 2>
...
._crit_edge516:                                   ; preds = %bb.aw
  ...
  %15 = load <2 x float>, ptr %i.mi, align 4      ; 3 uses
  %16 = extractelement <2 x float> %15, i64 0     ; 2 uses
  %.pre518 = load float, ptr %i.mr, align 8       ; 3 uses
  %17 = load <2 x float>, ptr %i.mu, align 4      ; 2 uses
  %18 = extractelement <2 x float> %17, i64 0     ; 2 uses
  %i.qm = load <2 x float>, ptr %i.mj, align 8    ; 6 uses
  %i.qn = extractelement <2 x float> %i.qm, i64 1 ; 3 uses
  %i.qo = extractelement <2 x float> %i.qm, i64 0
  %.pre523 = load float, ptr %i.mt, align 4
  %.pre524 = load float, ptr %i.mp, align 8       ; 2 uses
  %.pre525 = load float, ptr %i.mk, align 4
  %foldExtExtBinop602 = fmul <2 x float> %15, %i.qm
  %.pre538 = extractelement <2 x float> %foldExtExtBinop602, i64 0
  %.pre540 = fmul float %16, %i.qn
  %.pre542 = fneg float %.pre524                  ; 2 uses
  %.pre544 = fmul float %.pre540, %.pre542
  %.pre546 = fmul float %.pre518, %i.qn
  %.pre548 = fmul float %.pre519, %18
  %19 = shufflevector <2 x float> %15, <2 x float> %17, <2 x i32> <i32 0, i32 2>
...
bb.ay:                                            ; preds = %._crit_edge516, %bb.av
  ...
  %.pre-phi539 = phi float [ %.pre538, %._crit_edge516 ], [ %13, %bb.av ]
  ...
  %i.qy = phi float [ %18, %._crit_edge516 ], [ %12, %bb.av ]
  %i.qz = phi float [ %.pre519, %._crit_edge516 ], [ %i.pc, %bb.av ] ; 2 uses
  %i.ra = phi float [ %.pre518, %._crit_edge516 ], [ %i.nv, %bb.av ] ; 2 uses
  %i.rb = phi float [ %16, %._crit_edge516 ], [ %10, %bb.av ]
  %i.rc = phi <2 x float> [ %19, %._crit_edge516 ], [ %14, %bb.av ] ; 2 uses
