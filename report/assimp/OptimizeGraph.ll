...
begin_hunk_0_@_ZN6Assimp20OptimizeGraphProcess18CollectNewChildrenEP6aiNodeRNSt7__cxx114listIS2_SaIS2_EEE:bb.a
  ...
  %9 = shufflevector <2 x float> %i.oc, <2 x float> poison, <3 x i32> <i32 1, i32 poison, i32 0>
  %10 = insertelement <3 x float> %9, float %i.no, i64 1
  %i.qs = insertelement <4 x float> poison, float %i.pk, i64 0
  %i.qt = insertelement <4 x float> %i.qs, float %i.oa, i64 1
  %i.qu = insertelement <4 x float> %i.qt, float %i.nx, i64 2
  %11 = shufflevector <4 x float> %i.qu, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 2>
...
begin_hunk_1_@_ZN6Assimp20OptimizeGraphProcess18CollectNewChildrenEP6aiNodeRNSt7__cxx114listIS2_SaIS2_EEE:bb.a
  ...
  %12 = shufflevector <2 x float> %i.qz, <2 x float> poison, <3 x i32> <i32 1, i32 poison, i32 0>
  %13 = insertelement <3 x float> %12, float %.pre520, i64 1
  %i.rc = insertelement <4 x float> poison, float %.pre517, i64 0
  %i.rd = insertelement <4 x float> %i.rc, float %.pre519, i64 1
  %i.re = insertelement <4 x float> %i.rd, float %.pre516, i64 2
  %14 = shufflevector <4 x float> %i.re, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 2>
  br label %bb.ay
...
begin_hunk_2_@_ZN6Assimp20OptimizeGraphProcess18CollectNewChildrenEP6aiNodeRNSt7__cxx114listIS2_SaIS2_EEE:bb.a
  ...
  %15 = phi <3 x float> [ %13, %._crit_edge514 ], [ %10, %bb.av ] ; 3 uses
  %i.ro = phi <4 x float> [ %14, %._crit_edge514 ], [ %11, %bb.av ] ; 2 uses
  %i.rp = extractelement <3 x float> %15, i64 0   ; 2 uses
...
bb.az:                                            ; preds = %bb.ay
  %i.sa = shufflevector <3 x float> %15, <3 x float> poison, <8 x i32> <i32 0, i32 0, i32 1, i32 0, i32 0, i32 1, i32 2, i32 2>
  ...
  %16 = shufflevector <3 x float> %15, <3 x float> poison, <4 x i32> <i32 poison, i32 1, i32 poison, i32 poison>
  %i.sg = shufflevector <4 x float> %16, <4 x float> %i.ro, <8 x i32> <i32 1, i32 4, i32 poison, i32 1, i32 poison, i32 poison, i32 poison, i32 poison>
