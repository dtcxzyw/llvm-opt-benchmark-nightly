...
bb.z:                                             ; preds = %.lr.ph94
  %i.gc = load i8, ptr %i.ga, align 1
  store i8 %i.gc, ptr %i.fz, align 1
  %i.gd = load ptr, ptr %i.p, align 8
  %i.ge = getelementptr inbounds nuw i8, ptr %i.gd, i64 1 ; 2 uses
  store ptr %i.ge, ptr %i.p, align 8
  br label %_ZNSt6vectorIhSaIhEE9push_backERKh.exit67

bb.aa:                                            ; preds = %.lr.ph94
  %i.gf = load ptr, ptr %2, align 8               ; 4 uses
  %i.gg = ptrtoint ptr %i.fz to i64
  %i.gh = ptrtoint ptr %i.gf to i64               ; 2 uses
  %i.gi = sub i64 %i.gg, %i.gh                    ; 7 uses
  %i.gj = icmp eq i64 %i.gi, 9223372036854775807
  br i1 %i.gj, label %bb.ab, label %_ZNKSt6vectorIhSaIhEE12_M_check_lenEmPKc.exit.i.i59
...
_ZNKSt6vectorIhSaIhEE12_M_check_lenEmPKc.exit.i.i59: ; preds = %bb.aa
  %.sroa.speculated.i.i.i60 = call i64 @llvm.umax.i64(i64 %i.gi, i64 1)
  %i.gk = add i64 %.sroa.speculated.i.i.i60, %i.gi ; 2 uses
  %i.gl = icmp ult i64 %i.gk, %i.gi
  %i.gm = call i64 @llvm.umin.i64(i64 %i.gk, i64 9223372036854775807)
  %i.gn = select i1 %i.gl, i64 9223372036854775807, i64 %i.gm ; 3 uses
  %.not.i.i.i61 = icmp ne i64 %i.gn, 0
  call void @llvm.assume(i1 %.not.i.i.i61)
  %i.go = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.gn) #25
          to label %.noexc66 unwind label %.loopexit71 ; 4 uses

.noexc66:                                         ; preds = %_ZNKSt6vectorIhSaIhEE12_M_check_lenEmPKc.exit.i.i59
  %i.gp = getelementptr inbounds nuw i8, ptr %i.go, i64 %i.gi ; 2 uses
  %i.gq = load i8, ptr %i.ga, align 1
  store i8 %i.gq, ptr %i.gp, align 1
  %i.gr = icmp sgt i64 %i.gi, 0
  br i1 %i.gr, label %bb.ac, label %_ZNSt6vectorIhSaIhEE11_S_relocateEPhS2_S2_RS0_.exit16.i.i62

bb.ac:                                            ; preds = %.noexc66
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 1 %i.go, ptr align 1 %i.gf, i64 %i.gi, i1 false)
...
_ZNSt6vectorIhSaIhEE11_S_relocateEPhS2_S2_RS0_.exit16.i.i62: ; preds = %bb.ac, %.noexc66
  %i.gs = getelementptr inbounds nuw i8, ptr %i.gp, i64 1 ; 2 uses
  %.not.i17.i.i63 = icmp eq ptr %i.gf, null
...
bb.ad:                                            ; preds = %_ZNSt6vectorIhSaIhEE11_S_relocateEPhS2_S2_RS0_.exit16.i.i62
  %i.gt = load ptr, ptr %i.v, align 8
  %i.gu = ptrtoint ptr %i.gt to i64
  %i.gv = sub i64 %i.gu, %i.gh
  call void @_ZdlPvm(ptr noundef nonnull %i.gf, i64 noundef %i.gv) #23
...
_ZNSt6vectorIhSaIhEE17_M_realloc_insertIJRKhEEEvN9__gnu_cxx17__normal_iteratorIPhS1_EEDpOT_.exit.i64: ; preds = %bb.ad, %_ZNSt6vectorIhSaIhEE11_S_relocateEPhS2_S2_RS0_.exit16.i.i62
  store ptr %i.go, ptr %2, align 8
  store ptr %i.gs, ptr %i.p, align 8
  %i.gw = getelementptr inbounds nuw i8, ptr %i.go, i64 %i.gn
  store ptr %i.gw, ptr %i.v, align 8
  br label %_ZNSt6vectorIhSaIhEE9push_backERKh.exit67
...
bb.ae:                                            ; preds = %.loopexit71, %.loopexit.split-lp, %.loopexit74, %.loopexit.split-lp75, %bb.d, %bb.c
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #22
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #22
  %i.hc = load ptr, ptr %3, align 8               ; 2 uses
  %i.hd = icmp eq ptr %i.hc, %i.d
  br i1 %i.hd, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit70, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i68

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i68: ; preds = %bb.ae
  %i.he = load i64, ptr %i.d, align 8
  %i.hf = add i64 %i.he, 1
