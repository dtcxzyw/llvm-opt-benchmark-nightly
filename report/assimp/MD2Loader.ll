...
@_ZL11g_avNormals = internal unnamed_addr constant [162 x [3 x float]] [[3 x float] [float -5.257310e-01, float 0.000000e+00, float 8.506510e-01], [3 x float] [float -4.428630e-01, float 2.388560e-01, float 8.641880e-01], [3 x float] [float -2.952420e-01, float 0.000000e+00, float f0x3F74969A], [3 x float] [float -3.090170e-01, float 5.000000e-01, float 8.090170e-01], [3 x float] [float -1.624600e-01, float 2.628660e-01, float 9.510560e-01], [3 x float] [float 0.000000e+00, float 0.000000e+00, float 1.000000e+00], [3 x float] [float 0.000000e+00, float 8.506510e-01, float 5.257310e-01], [3 x float] [float -1.476210e-01, float f0x3F3770EF, float 6.817180e-01], [3 x float] [float 1.476210e-01, float f0x3F3770EF, float 6.817180e-01], [3 x float] [float 0.000000e+00, float 5.257310e-01, float 8.506510e-01], [3 x float] [float 3.090170e-01, float 5.000000e-01, float 8.090170e-01], [3 x float] [float 5.257310e-01, float 0.000000e+00, float 8.506510e-01], [3 x float] [float 2.952420e-01, float 0.000000e+00, float f0x3F74969A], [3 x float] [float 4.428630e-01, float 2.388560e-01, float 8.641880e-01], [3 x float] [float 1.624600e-01, float 2.628660e-01, float 9.510560e-01], [3 x float] [float -6.817180e-01, float 1.476210e-01, float f0x3F3770EF], [3 x float] [float -8.090170e-01, float 3.090170e-01, float 5.000000e-01], [3 x float] [float -5.877850e-01, float 4.253250e-01, float f0x3F302D49], [3 x float] [float -8.506510e-01, float 5.257310e-01, float 0.000000e+00], [3 x float] [float -8.641880e-01, float 4.428630e-01, float 2.388560e-01], [3 x float] [float f0xBF3770EF, float 6.817180e-01, float 1.476210e-01], [3 x float] [float f0xBF302D49, float 5.877850e-01, float 4.253250e-01], [3 x float] [float -5.000000e-01, float 8.090170e-01, float 3.090170e-01], [3 x float] [float -2.388560e-01, float 8.641880e-01, float 4.428630e-01], [3 x float] [float -4.253250e-01, float f0x3F302D49, float 5.877850e-01], [3 x float] [float f0xBF3770EF, float 6.817180e-01, float -1.476210e-01], [3 x float] [float -5.000000e-01, float 8.090170e-01, float -3.090170e-01], [3 x float] [float -5.257310e-01, float 8.506510e-01, float 0.000000e+00], [3 x float] [float 0.000000e+00, float 8.506510e-01, float -5.257310e-01], [3 x float] [float -2.388560e-01, float 8.641880e-01, float -4.428630e-01], [3 x float] [float 0.000000e+00, float f0x3F74969A, float -2.952420e-01], [3 x float] [float -2.628660e-01, float 9.510560e-01, float -1.624600e-01], [3 x float] [float 0.000000e+00, float 1.000000e+00, float 0.000000e+00], [3 x float] [float 0.000000e+00, float f0x3F74969A, float 2.952420e-01], [3 x float] [float -2.628660e-01, float 9.510560e-01, float 1.624600e-01], [3 x float] [float 2.388560e-01, float 8.641880e-01, float 4.428630e-01], [3 x float] [float 2.628660e-01, float 9.510560e-01, float 1.624600e-01], [3 x float] [float 5.000000e-01, float 8.090170e-01, float 3.090170e-01], [3 x float] [float 2.388560e-01, float 8.641880e-01, float -4.428630e-01], [3 x float] [float 2.628660e-01, float 9.510560e-01, float -1.624600e-01], [3 x float] [float 5.000000e-01, float 8.090170e-01, float -3.090170e-01], [3 x float] [float 8.506510e-01, float 5.257310e-01, float 0.000000e+00], [3 x float] [float f0x3F3770EF, float 6.817180e-01, float 1.476210e-01], [3 x float] [float f0x3F3770EF, float 6.817180e-01, float -1.476210e-01], [3 x float] [float 5.257310e-01, float 8.506510e-01, float 0.000000e+00], [3 x float] [float 4.253250e-01, float f0x3F302D49, float 5.877850e-01], [3 x float] [float 8.641880e-01, float 4.428630e-01, float 2.388560e-01], [3 x float] [float f0x3F302D49, float 5.877850e-01, float 4.253250e-01], [3 x float] [float 8.090170e-01, float 3.090170e-01, float 5.000000e-01], [3 x float] [float 6.817180e-01, float 1.476210e-01, float f0x3F3770EF], [3 x float] [float 5.877850e-01, float 4.253250e-01, float f0x3F302D49], [3 x float] [float f0x3F74969A, float 2.952420e-01, float 0.000000e+00], [3 x float] [float 1.000000e+00, float 0.000000e+00, float 0.000000e+00], [3 x float] [float 9.510560e-01, float 1.624600e-01, float 2.628660e-01], [3 x float] [float 8.506510e-01, float -5.257310e-01, float 0.000000e+00], [3 x float] [float f0x3F74969A, float -2.952420e-01, float 0.000000e+00], [3 x float] [float 8.641880e-01, float -4.428630e-01, float 2.388560e-01], [3 x float] [float 9.510560e-01, float -1.624600e-01, float 2.628660e-01], [3 x float] [float 8.090170e-01, float -3.090170e-01, float 5.000000e-01], [3 x float] [float 6.817180e-01, float -1.476210e-01, float f0x3F3770EF], [3 x float] [float 8.506510e-01, float 0.000000e+00, float 5.257310e-01], [3 x float] [float 8.641880e-01, float 4.428630e-01, float -2.388560e-01], [3 x float] [float 8.090170e-01, float 3.090170e-01, float -5.000000e-01], [3 x float] [float 9.510560e-01, float 1.624600e-01, float -2.628660e-01], [3 x float] [float 5.257310e-01, float 0.000000e+00, float -8.506510e-01], [3 x float] [float 6.817180e-01, float 1.476210e-01, float f0xBF3770EF], [3 x float] [float 6.817180e-01, float -1.476210e-01, float f0xBF3770EF], [3 x float] [float 8.506510e-01, float 0.000000e+00, float -5.257310e-01], [3 x float] [float 8.090170e-01, float -3.090170e-01, float -5.000000e-01], [3 x float] [float 8.641880e-01, float -4.428630e-01, float -2.388560e-01], [3 x float] [float 9.510560e-01, float -1.624600e-01, float -2.628660e-01], [3 x float] [float 1.476210e-01, float f0x3F3770EF, float -6.817180e-01], [3 x float] [float 3.090170e-01, float 5.000000e-01, float -8.090170e-01], [3 x float] [float 4.253250e-01, float f0x3F302D49, float -5.877850e-01], [3 x float] [float 4.428630e-01, float 2.388560e-01, float -8.641880e-01], [3 x float] [float 5.877850e-01, float 4.253250e-01, float f0xBF302D49], [3 x float] [float f0x3F302D49, float 5.877850e-01, float -4.253250e-01], [3 x float] [float -1.476210e-01, float f0x3F3770EF, float -6.817180e-01], [3 x float] [float -3.090170e-01, float 5.000000e-01, float -8.090170e-01], [3 x float] [float 0.000000e+00, float 5.257310e-01, float -8.506510e-01], [3 x float] [float -5.257310e-01, float 0.000000e+00, float -8.506510e-01], [3 x float] [float -4.428630e-01, float 2.388560e-01, float -8.641880e-01], [3 x float] [float -2.952420e-01, float 0.000000e+00, float f0xBF74969A], [3 x float] [float -1.624600e-01, float 2.628660e-01, float -9.510560e-01], [3 x float] [float 0.000000e+00, float 0.000000e+00, float -1.000000e+00], [3 x float] [float 2.952420e-01, float 0.000000e+00, float f0xBF74969A], [3 x float] [float 1.624600e-01, float 2.628660e-01, float -9.510560e-01], [3 x float] [float -4.428630e-01, float -2.388560e-01, float -8.641880e-01], [3 x float] [float -3.090170e-01, float -5.000000e-01, float -8.090170e-01], [3 x float] [float -1.624600e-01, float -2.628660e-01, float -9.510560e-01], [3 x float] [float 0.000000e+00, float -8.506510e-01, float -5.257310e-01], [3 x float] [float -1.476210e-01, float f0xBF3770EF, float -6.817180e-01], [3 x float] [float 1.476210e-01, float f0xBF3770EF, float -6.817180e-01], [3 x float] [float 0.000000e+00, float -5.257310e-01, float -8.506510e-01], [3 x float] [float 3.090170e-01, float -5.000000e-01, float -8.090170e-01], [3 x float] [float 4.428630e-01, float -2.388560e-01, float -8.641880e-01], [3 x float] [float 1.624600e-01, float -2.628660e-01, float -9.510560e-01], [3 x float] [float 2.388560e-01, float -8.641880e-01, float -4.428630e-01], [3 x float] [float 5.000000e-01, float -8.090170e-01, float -3.090170e-01], [3 x float] [float 4.253250e-01, float f0xBF302D49, float -5.877850e-01], [3 x float] [float f0x3F3770EF, float -6.817180e-01, float -1.476210e-01], [3 x float] [float f0x3F302D49, float -5.877850e-01, float -4.253250e-01], [3 x float] [float 5.877850e-01, float -4.253250e-01, float f0xBF302D49], [3 x float] [float 0.000000e+00, float f0xBF74969A, float -2.952420e-01], [3 x float] [float 0.000000e+00, float -1.000000e+00, float 0.000000e+00], [3 x float] [float 2.628660e-01, float -9.510560e-01, float -1.624600e-01], [3 x float] [float 0.000000e+00, float -8.506510e-01, float 5.257310e-01], [3 x float] [float 0.000000e+00, float f0xBF74969A, float 2.952420e-01], [3 x float] [float 2.388560e-01, float -8.641880e-01, float 4.428630e-01], [3 x float] [float 2.628660e-01, float -9.510560e-01, float 1.624600e-01], [3 x float] [float 5.000000e-01, float -8.090170e-01, float 3.090170e-01], [3 x float] [float f0x3F3770EF, float -6.817180e-01, float 1.476210e-01], [3 x float] [float 5.257310e-01, float -8.506510e-01, float 0.000000e+00], [3 x float] [float -2.388560e-01, float -8.641880e-01, float -4.428630e-01], [3 x float] [float -5.000000e-01, float -8.090170e-01, float -3.090170e-01], [3 x float] [float -2.628660e-01, float -9.510560e-01, float -1.624600e-01], [3 x float] [float -8.506510e-01, float -5.257310e-01, float 0.000000e+00], [3 x float] [float f0xBF3770EF, float -6.817180e-01, float -1.476210e-01], [3 x float] [float f0xBF3770EF, float -6.817180e-01, float 1.476210e-01], [3 x float] [float -5.257310e-01, float -8.506510e-01, float 0.000000e+00], [3 x float] [float -5.000000e-01, float -8.090170e-01, float 3.090170e-01], [3 x float] [float -2.388560e-01, float -8.641880e-01, float 4.428630e-01], [3 x float] [float -2.628660e-01, float -9.510560e-01, float 1.624600e-01], [3 x float] [float -8.641880e-01, float -4.428630e-01, float 2.388560e-01], [3 x float] [float -8.090170e-01, float -3.090170e-01, float 5.000000e-01], [3 x float] [float f0xBF302D49, float -5.877850e-01, float 4.253250e-01], [3 x float] [float -6.817180e-01, float -1.476210e-01, float f0x3F3770EF], [3 x float] [float -4.428630e-01, float -2.388560e-01, float 8.641880e-01], [3 x float] [float -5.877850e-01, float -4.253250e-01, float f0x3F302D49], [3 x float] [float -3.090170e-01, float -5.000000e-01, float 8.090170e-01], [3 x float] [float -1.476210e-01, float f0xBF3770EF, float 6.817180e-01], [3 x float] [float -4.253250e-01, float f0xBF302D49, float 5.877850e-01], [3 x float] [float -1.624600e-01, float -2.628660e-01, float 9.510560e-01], [3 x float] [float 4.428630e-01, float -2.388560e-01, float 8.641880e-01], [3 x float] [float 1.624600e-01, float -2.628660e-01, float 9.510560e-01], [3 x float] [float 3.090170e-01, float -5.000000e-01, float 8.090170e-01], [3 x float] [float 1.476210e-01, float f0xBF3770EF, float 6.817180e-01], [3 x float] [float 0.000000e+00, float -5.257310e-01, float 8.506510e-01], [3 x float] [float 4.253250e-01, float f0xBF302D49, float 5.877850e-01], [3 x float] [float 5.877850e-01, float -4.253250e-01, float f0x3F302D49], [3 x float] [float f0x3F302D49, float -5.877850e-01, float 4.253250e-01], [3 x float] [float f0xBF74969A, float 2.952420e-01, float 0.000000e+00], [3 x float] [float -9.510560e-01, float 1.624600e-01, float 2.628660e-01], [3 x float] [float -1.000000e+00, float 0.000000e+00, float 0.000000e+00], [3 x float] [float -8.506510e-01, float 0.000000e+00, float 5.257310e-01], [3 x float] [float f0xBF74969A, float -2.952420e-01, float 0.000000e+00], [3 x float] [float -9.510560e-01, float -1.624600e-01, float 2.628660e-01], [3 x float] [float -8.641880e-01, float 4.428630e-01, float -2.388560e-01], [3 x float] [float -9.510560e-01, float 1.624600e-01, float -2.628660e-01], [3 x float] [float -8.090170e-01, float 3.090170e-01, float -5.000000e-01], [3 x float] [float -8.641880e-01, float -4.428630e-01, float -2.388560e-01], [3 x float] [float -9.510560e-01, float -1.624600e-01, float -2.628660e-01], [3 x float] [float -8.090170e-01, float -3.090170e-01, float -5.000000e-01], [3 x float] [float -6.817180e-01, float 1.476210e-01, float f0xBF3770EF], [3 x float] [float -6.817180e-01, float -1.476210e-01, float f0xBF3770EF], [3 x float] [float -8.506510e-01, float 0.000000e+00, float -5.257310e-01], [3 x float] [float f0xBF302D49, float 5.877850e-01, float -4.253250e-01], [3 x float] [float -5.877850e-01, float 4.253250e-01, float f0xBF302D49], [3 x float] [float -4.253250e-01, float f0x3F302D49, float -5.877850e-01], [3 x float] [float -4.253250e-01, float f0xBF302D49, float -5.877850e-01], [3 x float] [float -5.877850e-01, float -4.253250e-01, float f0xBF302D49], [3 x float] [float f0xBF302D49, float -5.877850e-01, float -4.253250e-01]], align 16
...
@_ZL4desc = internal constant %struct.aiImporterDesc { ptr @.str.38, ptr @.str.22, ptr @.str.22, ptr @.str.22, i32 2, i32 0, i32 0, i32 0, i32 0, ptr @.str.39 }, align 8
...
@.str.29 = private unnamed_addr constant [51 x i8] c"Texture file name is too long. It will be skipped.\00", align 1
@.str.30 = private unnamed_addr constant [55 x i8] c"Texture file name has zero length. It will be skipped.\00", align 1
@.str.31 = private unnamed_addr constant [16 x i8] c"DefaultMaterial\00", align 1
@.str.32 = private unnamed_addr constant [10 x i8] c"?mat.name\00", align 1
@.str.33 = private unnamed_addr constant [19 x i8] c"$texture_dummy.bmp\00", align 1
@.str.34 = private unnamed_addr constant [31 x i8] c"MD2: No valid skin width given\00", align 1
@.str.35 = private unnamed_addr constant [32 x i8] c"MD2: No valid skin height given\00", align 1
@.str.36 = private unnamed_addr constant [47 x i8] c"MD2: Vertex index is outside the allowed range\00", align 1
@.str.37 = private unnamed_addr constant [43 x i8] c"MD2: UV index is outside the allowed range\00", align 1
...
@.str.38 = private unnamed_addr constant [23 x i8] c"Quake II Mesh Importer\00", align 1
@.str.39 = private unnamed_addr constant [4 x i8] c"md2\00", align 1
...
bb.b:                                             ; preds = %bb.a
  ...
  tail call void @_ZN6Assimp6Logger4warnEPKc(ptr noundef nonnull align 8 dereferenceable(12) %i.b, ptr noundef nonnull @.str)
  br label %bb.c

bb.c:                                             ; preds = %bb.b, %bb.a
  %.0 = phi i8 [ -95, %bb.b ], [ %0, %bb.a ]
  %i.c = zext i8 %.0 to i64
  %i.d = getelementptr inbounds nuw [12 x i8], ptr @_ZL11g_avNormals, i64 %i.c
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %1, ptr noundef nonnull align 4 dereferenceable(12) %i.d, i64 12, i1 false)
  ret void
}
...
bb.b:                                             ; preds = %bb.a
  %i.d = tail call noundef i32 @_ZNK6Assimp8Importer18GetPropertyIntegerEPKci(ptr noundef nonnull align 8 dereferenceable(8) %1, ptr noundef nonnull @.str.2, i32 noundef 0)
...
bb.a:
  ...
  switch i32 %i.c, label %bb.b [
    i32 1229213746, label %bb.g
    i32 844121161, label %bb.g
  ]
...
bb.b:                                             ; preds = %bb.a
  ...
  invoke void @_Z18ai_str_toprintableB5cxx11PKcic(ptr dead_on_unwind nonnull writable sret(%"class.std::__cxx11::basic_string") align 8 %1, ptr noundef %i.e, i32 noundef 4, i8 noundef signext 63)
          to label %bb.c unwind label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.thread

bb.c:                                             ; preds = %bb.b
  invoke void @_ZN17DeadlyImportErrorC2IJRA46_KcNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEEEDpOT_(ptr noundef nonnull align 8 dereferenceable(16) %i.d, ptr noundef nonnull align 1 dereferenceable(46) @.str.5, ptr noundef nonnull align 8 dereferenceable(32) %1)
          to label %bb.d unwind label %bb.e

bb.d:                                             ; preds = %bb.c
  invoke void @__cxa_throw(ptr nonnull %i.d, ptr nonnull @_ZTI17DeadlyImportError, ptr nonnull @_ZNSt13runtime_errorD2Ev) #17
          to label %bb.bd unwind label %bb.e
...
bb.e:                                             ; preds = %bb.d, %bb.c
  %.04 = phi i1 [ false, %bb.d ], [ true, %bb.c ] ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %bb.e
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %1) #16
  br i1 %.04, label %bb.f, label %bb.bc
...
bb.f:                                             ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.thread, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  %.pn2429 = phi { ptr, i32 } [ %i.f, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.thread ], [ %i.g, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit ], [ %i.g, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i ]
  call void @__cxa_free_exception(ptr %i.d) #16
  br label %bb.bc

bb.g:                                             ; preds = %bb.a, %bb.a
  %i.m = getelementptr inbounds nuw i8, ptr %i.b, i64 4
  %i.n = load i32, ptr %i.m, align 1
  %.not17 = icmp eq i32 %i.n, 8
  br i1 %.not17, label %bb.i, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.o = tail call noundef ptr @_ZN6Assimp13DefaultLogger3getEv()
  tail call void @_ZN6Assimp6Logger4warnEPKc(ptr noundef nonnull align 8 dereferenceable(12) %i.o, ptr noundef nonnull @.str.6)
  %.pre = load ptr, ptr %i.a, align 8
  br label %bb.i

bb.i:                                             ; preds = %bb.h, %bb.g
  %i.p = phi ptr [ %.pre, %bb.h ], [ %i.b, %bb.g ] ; 11 uses
  %i.q = getelementptr inbounds nuw i8, ptr %i.p, i64 40
  %i.r = load i32, ptr %i.q, align 1              ; 4 uses
  %i.s = icmp eq i32 %i.r, 0
  br i1 %i.s, label %bb.j, label %bb.m

bb.j:                                             ; preds = %bb.i
  %i.t = tail call ptr @__cxa_allocate_exception(i64 16) #16 ; 3 uses
  invoke void @_ZN17DeadlyImportErrorC2EPKc(ptr noundef nonnull align 8 dereferenceable(16) %i.t, ptr noundef nonnull @.str.7)
          to label %bb.k unwind label %bb.l

bb.k:                                             ; preds = %bb.j
  tail call void @__cxa_throw(ptr nonnull %i.t, ptr nonnull @_ZTI17DeadlyImportError, ptr nonnull @_ZNSt13runtime_errorD2Ev) #17
  unreachable

bb.l:                                             ; preds = %bb.j
  %i.u = landingpad { ptr, i32 }
          cleanup
  tail call void @__cxa_free_exception(ptr nonnull %i.t) #16
  br label %bb.bc
...
bb.n:                                             ; preds = %bb.m
  %i.aa = tail call ptr @__cxa_allocate_exception(i64 16) #16 ; 3 uses
  invoke void @_ZN17DeadlyImportErrorC2EPKc(ptr noundef nonnull align 8 dereferenceable(16) %i.aa, ptr noundef nonnull @.str.8)
          to label %bb.o unwind label %bb.p

bb.o:                                             ; preds = %bb.n
  tail call void @__cxa_throw(ptr nonnull %i.aa, ptr nonnull @_ZTI17DeadlyImportError, ptr nonnull @_ZNSt13runtime_errorD2Ev) #17
  unreachable

bb.p:                                             ; preds = %bb.n
  %i.ab = landingpad { ptr, i32 }
          cleanup
  tail call void @__cxa_free_exception(ptr nonnull %i.aa) #16
  br label %bb.bc

bb.q:                                             ; preds = %bb.m
  %i.ac = getelementptr inbounds nuw i8, ptr %i.p, i64 20
  %i.ad = load i32, ptr %i.ac, align 1            ; 3 uses
  %i.ae = icmp ugt i32 %i.ad, 4194304
  br i1 %i.ae, label %bb.r, label %bb.u

bb.r:                                             ; preds = %bb.q
  %i.af = tail call ptr @__cxa_allocate_exception(i64 16) #16 ; 3 uses
  invoke void @_ZN17DeadlyImportErrorC2EPKc(ptr noundef nonnull align 8 dereferenceable(16) %i.af, ptr noundef nonnull @.str.9)
          to label %bb.s unwind label %bb.t

bb.s:                                             ; preds = %bb.r
  tail call void @__cxa_throw(ptr nonnull %i.af, ptr nonnull @_ZTI17DeadlyImportError, ptr nonnull @_ZNSt13runtime_errorD2Ev) #17
  unreachable

bb.t:                                             ; preds = %bb.r
  %i.ag = landingpad { ptr, i32 }
          cleanup
  tail call void @__cxa_free_exception(ptr nonnull %i.af) #16
  br label %bb.bc

bb.u:                                             ; preds = %bb.q
  %i.ah = getelementptr inbounds nuw i8, ptr %i.p, i64 24
  %i.ai = load i32, ptr %i.ah, align 1            ; 2 uses
  %i.aj = icmp ugt i32 %i.ai, 67108864
  br i1 %i.aj, label %bb.v, label %bb.y

bb.v:                                             ; preds = %bb.u
  %i.ak = tail call ptr @__cxa_allocate_exception(i64 16) #16 ; 3 uses
  invoke void @_ZN17DeadlyImportErrorC2EPKc(ptr noundef nonnull align 8 dereferenceable(16) %i.ak, ptr noundef nonnull @.str.10)
          to label %bb.w unwind label %bb.x

bb.w:                                             ; preds = %bb.v
  tail call void @__cxa_throw(ptr nonnull %i.ak, ptr nonnull @_ZTI17DeadlyImportError, ptr nonnull @_ZNSt13runtime_errorD2Ev) #17
  unreachable
...
bb.y:                                             ; preds = %bb.u
  %i.am = getelementptr inbounds nuw i8, ptr %i.p, i64 28
  %i.an = load i32, ptr %i.am, align 1            ; 2 uses
  %i.ao = icmp ugt i32 %i.an, 67108864
  br i1 %i.ao, label %bb.z, label %bb.ac

bb.z:                                             ; preds = %bb.y
  %i.ap = tail call ptr @__cxa_allocate_exception(i64 16) #16 ; 3 uses
  invoke void @_ZN17DeadlyImportErrorC2EPKc(ptr noundef nonnull align 8 dereferenceable(16) %i.ap, ptr noundef nonnull @.str.11)
          to label %bb.aa unwind label %bb.ab

bb.aa:                                            ; preds = %bb.z
  tail call void @__cxa_throw(ptr nonnull %i.ap, ptr nonnull @_ZTI17DeadlyImportError, ptr nonnull @_ZNSt13runtime_errorD2Ev) #17
  unreachable

bb.ab:                                            ; preds = %bb.z
  %i.aq = landingpad { ptr, i32 }
          cleanup
  tail call void @__cxa_free_exception(ptr nonnull %i.ap) #16
  br label %bb.bc

bb.ac:                                            ; preds = %bb.y
  %i.ar = getelementptr inbounds nuw i8, ptr %i.p, i64 32
  %i.as = load i32, ptr %i.ar, align 1            ; 2 uses
  %i.at = icmp ugt i32 %i.as, 22369621
end_hunk_0
