...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %i.p = getelementptr inbounds nuw [12 x i8], ptr %i.o, i64 %indvars.iv ; 3 uses
  %i.q = load float, ptr %3, align 4
  %i.r = load float, ptr %i.p, align 4            ; 3 uses
  %i.s = load float, ptr %i.d, align 4
  %i.t = getelementptr inbounds nuw i8, ptr %i.p, i64 4
  %i.u = load float, ptr %i.t, align 4            ; 3 uses
  %i.v = fmul float %i.s, %i.u
  %i.w = tail call float @llvm.fmuladd.f32(float %i.q, float %i.r, float %i.v)
  %i.x = load float, ptr %i.e, align 4
  %i.y = getelementptr inbounds nuw i8, ptr %i.p, i64 8
  %i.z = load float, ptr %i.y, align 4            ; 3 uses
  %i.aa = tail call float @llvm.fmuladd.f32(float %i.x, float %i.z, float %i.w)
  %i.ab = load float, ptr %i.f, align 4
  %i.ac = fadd float %i.aa, %i.ab                 ; 4 uses
  %i.ad = load float, ptr %i.g, align 4
  %i.ae = load float, ptr %i.h, align 4
  %i.af = fmul float %i.u, %i.ae
  %i.ag = tail call float @llvm.fmuladd.f32(float %i.ad, float %i.r, float %i.af)
  %i.ah = load float, ptr %i.i, align 4
  %i.ai = tail call float @llvm.fmuladd.f32(float %i.ah, float %i.z, float %i.ag)
  %i.aj = load float, ptr %i.j, align 4
  %i.ak = fadd float %i.aj, %i.ai                 ; 4 uses
  %i.al = load float, ptr %i.k, align 4
  %i.am = load float, ptr %i.l, align 4
  %i.an = fmul float %i.u, %i.am
  %i.ao = tail call float @llvm.fmuladd.f32(float %i.al, float %i.r, float %i.an)
  %i.ap = load float, ptr %i.m, align 4
  %i.aq = tail call float @llvm.fmuladd.f32(float %i.ap, float %i.z, float %i.ao)
  %i.ar = load float, ptr %i.n, align 4
  %i.as = fadd float %i.ar, %i.aq                 ; 4 uses
  %i.at = load float, ptr %1, align 4             ; 2 uses
  %i.au = fcmp olt float %i.at, %i.ac
  %i.av = select i1 %i.au, float %i.at, float %i.ac
  %i.aw = load float, ptr %.sroa.438.0..sroa_idx, align 4 ; 2 uses
  %i.ax = fcmp olt float %i.aw, %i.ak
  %i.ay = select i1 %i.ax, float %i.aw, float %i.ak
  %i.az = load float, ptr %.sroa.539.0..sroa_idx, align 4 ; 2 uses
  %i.ba = fcmp olt float %i.az, %i.as
  %i.bb = select i1 %i.ba, float %i.az, float %i.as
  %.sroa.0.0.vec.insert.i22 = insertelement <2 x float> poison, float %i.av, i64 0
  %.sroa.0.4.vec.insert.i23 = insertelement <2 x float> %.sroa.0.0.vec.insert.i22, float %i.ay, i64 1
  store <2 x float> %.sroa.0.4.vec.insert.i23, ptr %1, align 4
  store float %i.bb, ptr %.sroa.539.0..sroa_idx, align 4
  %i.bc = load float, ptr %2, align 4             ; 2 uses
  %i.bd = fcmp olt float %i.ac, %i.bc
  %i.be = select i1 %i.bd, float %i.bc, float %i.ac
  %i.bf = load float, ptr %.sroa.4.0..sroa_idx36, align 4 ; 2 uses
  %i.bg = fcmp olt float %i.ak, %i.bf
  %i.bh = select i1 %i.bg, float %i.bf, float %i.ak
  %i.bi = load float, ptr %.sroa.5.0..sroa_idx, align 4 ; 2 uses
  %i.bj = fcmp olt float %i.as, %i.bi
  %i.bk = select i1 %i.bj, float %i.bi, float %i.as
  %.sroa.0.0.vec.insert.i26 = insertelement <2 x float> poison, float %i.be, i64 0
  %.sroa.0.4.vec.insert.i27 = insertelement <2 x float> %.sroa.0.0.vec.insert.i26, float %i.bh, i64 1
  store <2 x float> %.sroa.0.4.vec.insert.i27, ptr %2, align 4
  store float %i.bk, ptr %.sroa.5.0..sroa_idx, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.bl = load i32, ptr %i.a, align 4
  %i.bm = zext i32 %i.bl to i64
  %i.bn = icmp samesign ult i64 %indvars.iv.next, %i.bm
  br i1 %i.bn, label %bb.b, label %._crit_edge, !llvm.loop !11
}
...
bb.j:                                             ; preds = %bb.i, %bb.h
  ...
  %.sroa.046.0.vec.extract53 = extractelement <2 x float> %.sroa.046.2, i64 0 ; 3 uses
