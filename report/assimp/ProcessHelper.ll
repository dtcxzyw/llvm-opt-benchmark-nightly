...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %7 = load float, ptr %i.i, align 4              ; 2 uses
  %i.n = load float, ptr %5, align 4              ; 2 uses
  ...
  %11 = insertelement <2 x float> poison, float %i.n, i64 0
  %12 = shufflevector <2 x float> %11, <2 x float> poison, <2 x i32> zeroinitializer
  %i.v = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.u, <2 x float> %12, <2 x float> %i.t)
  %i.w = shufflevector <8 x float> %i.o, <8 x float> poison, <2 x i32> <i32 3, i32 7>
  %i.x = fadd <2 x float> %i.v, %i.w              ; 4 uses
  %i.y = fmul float %6, %i.k
  %i.z = tail call float @llvm.fmuladd.f32(float %i.j, float %7, float %i.y)
  %i.aa = tail call float @llvm.fmuladd.f32(float %i.l, float %i.n, float %i.z)
...
bb.b:                                             ; preds = %bb.b, %.lr.ph.i
  ...
  %i.s = getelementptr inbounds nuw [12 x i8], ptr %i.h, i64 %indvars.iv.i ; 3 uses
  %3 = getelementptr inbounds nuw i8, ptr %i.s, i64 4
  %4 = getelementptr inbounds nuw i8, ptr %i.s, i64 8
  %5 = load float, ptr %3, align 4                ; 2 uses
  %6 = load float, ptr %i.s, align 4              ; 2 uses
  %i.t = load float, ptr %4, align 4              ; 2 uses
  %7 = insertelement <2 x float> poison, float %5, i64 0
  %8 = shufflevector <2 x float> %7, <2 x float> poison, <2 x i32> zeroinitializer
  %i.u = fmul <2 x float> %8, %i.q
  %9 = insertelement <2 x float> poison, float %6, i64 0
  %i.v = shufflevector <2 x float> %9, <2 x float> poison, <2 x i32> zeroinitializer
  %i.w = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.p, <2 x float> %i.v, <2 x float> %i.u)
  %10 = insertelement <2 x float> poison, float %i.t, i64 0
  %11 = shufflevector <2 x float> %10, <2 x float> poison, <2 x i32> zeroinitializer
  %12 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.o, <2 x float> %11, <2 x float> %i.w)
  %13 = fadd <2 x float> %12, %i.r                ; 4 uses
  %i.x = fmul float %5, %i.k
  %i.y = tail call float @llvm.fmuladd.f32(float %i.j, float %6, float %i.x)
  %i.z = tail call float @llvm.fmuladd.f32(float %i.l, float %i.t, float %i.y)
  %i.aa = fadd float %i.m, %i.z                   ; 4 uses
  %i.ab = fcmp olt <2 x float> %.sroa.014.0, %13
  %i.ac = select <2 x i1> %i.ab, <2 x float> %.sroa.014.0, <2 x float> %13 ; 2 uses
  %i.ad = fcmp olt float %.sroa.1125.0, %i.aa
  %i.ae = select i1 %i.ad, float %.sroa.1125.0, float %i.aa ; 2 uses
  %i.af = fcmp olt <2 x float> %13, %.sroa.0.0
  %i.ag = select <2 x i1> %i.af, <2 x float> %.sroa.0.0, <2 x float> %13 ; 2 uses
