...
bb.ak:                                            ; preds = %bb.ai, %bb.ah, %bb.ag, %bb.af, %bb.ae, %bb.ad, %bb.ac, %bb.ab
  %.1.i.ph.peel = phi i64 [ 6, %bb.ah ], [ 5, %bb.ag ], [ 4, %bb.af ], [ 3, %bb.ae ], [ 2, %bb.ad ], [ 1, %bb.ac ], [ 0, %bb.ab ], [ 7, %bb.ai ]
  %.1.i.ph.peel.a = phi i32 [ 6, %bb.ah ], [ 5, %bb.ag ], [ 4, %bb.af ], [ 3, %bb.ae ], [ 2, %bb.ad ], [ 1, %bb.ac ], [ 0, %bb.ab ], [ 7, %bb.ai ]
...
begin_hunk_1_@_ZN6Assimp23ComputeUVMappingProcess7ExecuteEP7aiScene:bb.a
  ...
  %i.dl = getelementptr inbounds nuw [8 x i8], ptr %i.cl, i64 %.1.i.ph.peel
...
bb.bc:                                            ; preds = %bb.ba, %bb.at, %bb.au, %bb.av, %bb.aw, %bb.ax, %bb.ay, %bb.az
  %.1.i.ph = phi i64 [ 6, %bb.az ], [ 5, %bb.ay ], [ 4, %bb.ax ], [ 3, %bb.aw ], [ 2, %bb.av ], [ 1, %bb.au ], [ 0, %bb.at ], [ 7, %bb.ba ]
  %.1.i.ph.a = phi i32 [ 6, %bb.az ], [ 5, %bb.ay ], [ 4, %bb.ax ], [ 3, %bb.aw ], [ 2, %bb.av ], [ 1, %bb.au ], [ 0, %bb.at ], [ 7, %bb.ba ] ; 2 uses
...
begin_hunk_3_@_ZN6Assimp23ComputeUVMappingProcess7ExecuteEP7aiScene:bb.a
  ...
  %i.fe = getelementptr inbounds nuw [8 x i8], ptr %i.ee, i64 %.1.i.ph
