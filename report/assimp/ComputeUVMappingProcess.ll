...
bb.k:                                             ; preds = %.lr.ph61, %bb.k
  ...
  %i.do = getelementptr inbounds nuw [12 x i8], ptr %i.dn, i64 %indvars.iv74
  %i.dp = getelementptr inbounds nuw [12 x i8], ptr %3, i64 %indvars.iv74 ; 2 uses
  %9 = load <3 x float>, ptr %i.do, align 4       ; 3 uses
  %10 = shufflevector <3 x float> %9, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.dq = fmul <2 x float> %10, %i.dl
  %i.dr = shufflevector <3 x float> %9, <3 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.dt = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.dj, <2 x float> %11, <2 x float> %i.ds)
