...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSERKS4_.exit: ; preds = %bb.m, %bb.l
  %10 = load float, ptr %7, align 8               ; 2 uses
  %11 = fmul float %10, -5.000000e-01             ; 2 uses
  %12 = fmul float %10, 5.000000e-01              ; 2 uses
  %13 = load float, ptr %9, align 4               ; 2 uses
  %14 = fmul float %13, -5.000000e-01             ; 2 uses
  %15 = fmul float %13, 5.000000e-01              ; 2 uses
...
bb.n:                                             ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSERKS4_.exit
  ...
  store float %14, ptr %i.as, align 4
...
bb.o:                                             ; preds = %bb.n
  ...
  store float %12, ptr %i.ax, align 4
  %16 = getelementptr inbounds nuw i8, ptr %i.aw, i64 20
...
bb.p:                                             ; preds = %bb.o
  ...
  store float %11, ptr %i.bc, align 4
...
bb.q:                                             ; preds = %bb.p
  ...
  store float %11, ptr %i.bi, align 4
  %17 = getelementptr inbounds nuw i8, ptr %i.bh, i64 20
