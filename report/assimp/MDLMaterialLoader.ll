...
_ZN6Assimp11MDLImporter11FreePaletteEPKh.exit:    ; preds = %._crit_edge, %bb.g
  %i.am = getelementptr inbounds nuw i8, ptr %0, i64 136 ; 5 uses
...
.critedge:                                        ; preds = %bb.c
  ...
  %i.p = getelementptr inbounds nuw i8, ptr %0, i64 136 ; 7 uses
...
bb.a:
  ...
  %i.c = tail call noalias noundef nonnull dereferenceable(1064) ptr @_Znwm(i64 noundef 1064) #22 ; 11 uses
...
begin_hunk_5_@_ZN6Assimp11MDLImporter23CreateTexture_3DGS_MDL5EPKhjPj:bb.a
  ...
  %5 = zext i32 %4 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.p, ptr nonnull align 1 %i.e, i64 %5, i1 false)
...
bb.d:                                             ; preds = %.thread47, %bb.c
  %i.u = getelementptr inbounds nuw i8, ptr %0, i64 136 ; 7 uses
...
bb.l:                                             ; preds = %bb.i
  %i.n = invoke noalias noundef nonnull dereferenceable(1064) ptr @_Znwm(i64 noundef 1064) #22
          to label %_ZNSt10unique_ptrI9aiTextureSt14default_deleteIS0_EE5resetEPS0_.exit unwind label %bb.h ; 11 uses
...
bb.n:                                             ; preds = %bb.m
  ...
  %12 = load i32, ptr %i.n, align 8
  %13 = zext i32 %12 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.y, ptr nonnull align 1 %1, i64 %13, i1 false)
...
bb.bp:                                            ; preds = %bb.bo
  %i.rq = getelementptr inbounds nuw i8, ptr %0, i64 136 ; 8 uses
...
bb.bv:                                            ; preds = %bb.br
  %i.sm = getelementptr inbounds nuw i8, ptr %i.sc, i64 72
...
bb.bw:                                            ; preds = %bb.bv
  %14 = load ptr, ptr %i.rq, align 8
  %15 = getelementptr inbounds nuw i8, ptr %14, i64 72
  store ptr %i.sr, ptr %15, align 8
...
bb.g:                                             ; preds = %_ZNSt6vectorIP10aiMaterialSaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i
  %5 = load ptr, ptr %i.e, align 8
  %6 = ptrtoint ptr %5 to i64
  %7 = sub i64 %6, %i.k
  tail call void @_ZdlPvm(ptr noundef nonnull %i.i, i64 noundef %7) #21
