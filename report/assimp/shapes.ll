...
bb.a:
  ...
  %4 = load double, ptr %1, align 8               ; 2 uses
  ...
  %i.m = shufflevector <2 x double> %5, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %8 = fsub <2 x double> %i.o, %7                 ; 4 uses
  %i.p = fsub double %i.g, %4                     ; 4 uses
  %i.q = fsub double %i.i, %3                     ; 4 uses
  %i.r = fmul <2 x double> %8, %8
  ...
  %i.v = extractelement <2 x double> %8, i64 1    ; 2 uses
  %i.w = fneg double %i.v
  ...
  %i.af = extractelement <2 x double> %8, i64 0
...
.preheader:                                       ; preds = %bb.b
  ...
  %1 = getelementptr inbounds nuw i8, ptr %i.v, i64 8
  %2 = load double, ptr %1, align 8               ; 2 uses
  %3 = load double, ptr %i.v, align 8             ; 2 uses
  ...
  %i.x = shufflevector <2 x double> %4, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %7 = fsub <2 x double> %i.z, %6                 ; 4 uses
  %i.aa = fsub double %i.s, %3                    ; 4 uses
  %i.ab = fsub double %i.u, %2                    ; 4 uses
  %i.ac = fmul <2 x double> %7, %7
  ...
  %i.ag = extractelement <2 x double> %7, i64 1   ; 2 uses
  ...
  %i.aq = extractelement <2 x double> %7, i64 0
...
bb.c:                                             ; preds = %.preheader
  ...
  %8 = getelementptr inbounds nuw i8, ptr %i.ba, i64 8
  %9 = load double, ptr %8, align 8               ; 2 uses
  %10 = load double, ptr %i.ba, align 8           ; 2 uses
  %11 = insertelement <2 x double> poison, double %10, i64 0
  %12 = shufflevector <2 x double> %11, <2 x double> poison, <2 x i32> zeroinitializer
  %i.bb = fsub <2 x double> %i.w, %12             ; 4 uses
  %13 = insertelement <2 x double> poison, double %9, i64 0
  %14 = shufflevector <2 x double> %13, <2 x double> poison, <2 x i32> zeroinitializer
  %15 = fsub <2 x double> %i.z, %14               ; 4 uses
  %16 = fsub double %i.s, %10                     ; 4 uses
  %i.bc = fsub double %i.u, %9                    ; 4 uses
  %i.bd = fmul <2 x double> %15, %15
  %i.be = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bb, <2 x double> %i.bb, <2 x double> %i.bd) ; 2 uses
  %i.bf = fmul double %i.bc, %i.bc
  %i.bg = tail call double @llvm.fmuladd.f64(double %16, double %16, double %i.bf) ; 2 uses
  %i.bh = extractelement <2 x double> %15, i64 1  ; 2 uses
  ...
  %i.bm = extractelement <2 x double> %i.bb, i64 1
  %i.bn = fneg double %i.bm                       ; 2 uses
  %i.bo = fmul double %i.bg, %i.bn
  %i.bp = tail call double @llvm.fmuladd.f64(double %16, double %i.bk, double %i.bo)
  %i.bq = fneg double %i.bp
  %i.br = extractelement <2 x double> %15, i64 0
  %i.bs = fmul double %i.br, %i.bq
  %i.bt = extractelement <2 x double> %i.bb, i64 0
  %i.bu = tail call double @llvm.fmuladd.f64(double %i.bt, double %i.bl, double %i.bs)
  %i.bv = fmul double %i.bc, %i.bn
  %i.bw = tail call double @llvm.fmuladd.f64(double %16, double %i.bh, double %i.bv)
...
bb.d:                                             ; preds = %bb.c
  ...
  %17 = getelementptr inbounds nuw i8, ptr %i.cb, i64 8
  %18 = load double, ptr %17, align 8             ; 2 uses
  %19 = load double, ptr %i.cb, align 8           ; 2 uses
  %20 = insertelement <2 x double> poison, double %19, i64 0
  %i.cc = shufflevector <2 x double> %20, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %23 = fsub <2 x double> %i.ce, %22              ; 4 uses
  %i.cf = fsub double %i.s, %19                   ; 4 uses
  %i.cg = fsub double %i.u, %18                   ; 4 uses
  %i.ch = fmul <2 x double> %23, %23
  ...
  %i.cl = extractelement <2 x double> %23, i64 1  ; 2 uses
  ...
  %i.cv = extractelement <2 x double> %23, i64 0
