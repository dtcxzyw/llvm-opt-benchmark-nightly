...
bb.eq:                                            ; preds = %bb.es, %bb.ep
  %.0.i.i = phi ptr [ %i.rn, %bb.ep ], [ %i.rr, %bb.es ] ; 4 uses
...
._crit_edge1302:                                  ; preds = %bb.eq
  %.0.i.i.lcssa.a = phi ptr [ %.0.i.i, %bb.eq ]
  br label %bb.et

bb.et:                                            ; preds = %split.a, %._crit_edge1302
  %.0.lcssa.i.i = phi ptr [ %.0.i.i.lcssa.a, %._crit_edge1302 ], [ %scevgep.i.i, %split.a ] ; 8 uses
...
bb.ev:                                            ; preds = %bb.ex, %bb.eu
  %.0.i.i459 = phi ptr [ %i.rv, %bb.eu ], [ %i.rz, %bb.ex ] ; 4 uses
...
._crit_edge1304:                                  ; preds = %bb.ev
  %.0.i.i459.lcssa.a = phi ptr [ %.0.i.i459, %bb.ev ]
  br label %bb.ey

bb.ey:                                            ; preds = %split1305, %._crit_edge1304
  %.0.lcssa.i.i461 = phi ptr [ %.0.i.i459.lcssa.a, %._crit_edge1304 ], [ %scevgep.i.i458, %split1305 ] ; 5 uses
...
bb.go:                                            ; preds = %bb.gq, %bb.gn
  %.0.i.i513 = phi ptr [ %i.wq, %bb.gn ], [ %i.wu, %bb.gq ] ; 4 uses
...
._crit_edge1307:                                  ; preds = %bb.go
  %.0.i.i513.lcssa.a = phi ptr [ %.0.i.i513, %bb.go ]
  br label %bb.gr

bb.gr:                                            ; preds = %split1308, %._crit_edge1307
  %.0.lcssa.i.i515 = phi ptr [ %.0.i.i513.lcssa.a, %._crit_edge1307 ], [ %scevgep.i.i512, %split1308 ] ; 8 uses
...
bb.hl:                                            ; preds = %.lr.ph875, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EESA_.exit.thread780
  %.sroa.0683.0874 = phi ptr [ %i.zg, %.lr.ph875 ], [ %i.zt, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EESA_.exit.thread780 ] ; 5 uses
...
._ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EESA_.exit.thread_crit_edge: ; preds = %bb.hm
  %.sroa.0683.0874.lcssa1310 = phi ptr [ %.sroa.0683.0874, %bb.hm ]
  br label %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EESA_.exit.thread
...
_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EESA_.exit.thread: ; preds = %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EESA_.exit.threadsplit, %._ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EESA_.exit.thread_crit_edge
  %.sroa.0683.0874.lcssa = phi ptr [ %.sroa.0683.0874.lcssa1310, %._ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EESA_.exit.thread_crit_edge ], [ %.sroa.0683.0874.lcssa1311, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EESA_.exit.threadsplit ]
