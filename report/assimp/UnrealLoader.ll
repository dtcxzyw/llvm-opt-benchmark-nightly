...
bb.id:                                            ; preds = %.lr.ph887, %bb.ik
  %.sroa.0657.0885 = phi ptr [ %i.jj, %.lr.ph887 ], [ %i.adw, %bb.ik ] ; 4 uses
  %.sroa.21.0884 = phi ptr [ %i.ach, %.lr.ph887 ], [ %.sroa.0657.2, %bb.ik ] ; 6 uses
  %.sroa.0654.0883 = phi ptr [ %i.acg, %.lr.ph887 ], [ %.sroa.21.1, %bb.ik ] ; 7 uses
  %.sroa.31.0882 = phi ptr [ %i.acg, %.lr.ph887 ], [ %.sroa.31.2.a, %bb.ik ] ; 8 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %26) #26
  %i.aco = getelementptr inbounds nuw i8, ptr %.sroa.0657.0885, i64 6
  %i.acp = load i8, ptr %i.aco, align 2
  %i.acq = sext i8 %i.acp to i32
  store i32 %i.acq, ptr %26, align 4
  %i.acr = getelementptr inbounds nuw i8, ptr %.sroa.0657.0885, i64 14
  %i.acs = load i8, ptr %i.acr, align 2
  %i.act = zext i8 %i.acs to i32
  store i32 %i.act, ptr %i.aci, align 4
  store i32 0, ptr %i.acj, align 4
  %i.acu = invoke ptr @_ZSt9__find_ifIN9__gnu_cxx17__normal_iteratorIPN6Assimp6Unreal7TempMatESt6vectorIS4_SaIS4_EEEENS0_5__ops16_Iter_equals_valIKS4_EEET_SE_SE_T0_St26random_access_iterator_tag(ptr %.sroa.31.0882, ptr %.sroa.0654.0883, ptr nonnull align 4 dereferenceable(12) %26)
...
_ZSt4findIN9__gnu_cxx17__normal_iteratorIPN6Assimp6Unreal7TempMatESt6vectorIS4_SaIS4_EEEES4_ET_SA_SA_RKT0_.exit: ; preds = %bb.id
  %i.acv = icmp eq ptr %i.acu, %.sroa.0654.0883
  %i.acw = ptrtoint ptr %.sroa.31.0882 to i64     ; 2 uses
  %i.acx = getelementptr inbounds nuw i8, ptr %.sroa.0657.0885, i64 16 ; 2 uses
...
bb.ie:                                            ; preds = %_ZSt4findIN9__gnu_cxx17__normal_iteratorIPN6Assimp6Unreal7TempMatESt6vectorIS4_SaIS4_EEEES4_ET_SA_SA_RKT0_.exit
  %i.acy = ptrtoint ptr %.sroa.0654.0883 to i64
  ...
  %.not.i560 = icmp eq ptr %.sroa.0654.0883, %.sroa.21.0884
  br i1 %.not.i560, label %bb.ig, label %bb.if

bb.if:                                            ; preds = %bb.ie
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %.sroa.0654.0883, ptr noundef nonnull align 4 dereferenceable(12) %26, i64 12, i1 false)
...
.noexc564:                                        ; preds = %_ZNKSt6vectorIN6Assimp6Unreal7TempMatESaIS2_EE12_M_check_lenEmPKc.exit.i.i
  ...
  %.not10.i.i.i.i.i = icmp eq ptr %.sroa.31.0882, %.sroa.21.0884
...
.lr.ph.i.i.i.i.i:                                 ; preds = %.noexc564, %.lr.ph.i.i.i.i.i
  ...
  %.0911.i.i.i.i.i = phi ptr [ %i.adk, %.lr.ph.i.i.i.i.i ], [ %.sroa.31.0882, %.noexc564 ] ; 2 uses
...
_ZNSt6vectorIN6Assimp6Unreal7TempMatESaIS2_EE17_M_realloc_insertIJRKS2_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i: ; preds = %.lr.ph.i.i.i.i.i, %.noexc564
  ...
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.31.0882, i64 noundef %i.acz) #28
...
_ZNSt6vectorIN6Assimp6Unreal7TempMatESaIS2_EE9push_backERKS2_.exit: ; preds = %_ZNSt6vectorIN6Assimp6Unreal7TempMatESaIS2_EE17_M_realloc_insertIJRKS2_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i, %bb.if
  %.sroa.31.5.a = phi ptr [ %i.adi, %_ZNSt6vectorIN6Assimp6Unreal7TempMatESaIS2_EE17_M_realloc_insertIJRKS2_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i ], [ %.sroa.31.0882, %bb.if ]
  %.0.lcssa.i.i.i.i.i562.pn = phi ptr [ %.0.lcssa.i.i.i.i.i562, %_ZNSt6vectorIN6Assimp6Unreal7TempMatESaIS2_EE17_M_realloc_insertIJRKS2_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i ], [ %.sroa.0654.0883, %bb.if ]
  %.sroa.0657.5 = phi ptr [ %i.adm, %_ZNSt6vectorIN6Assimp6Unreal7TempMatESaIS2_EE17_M_realloc_insertIJRKS2_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i ], [ %.sroa.21.0884, %bb.if ]
...
bb.ik:                                            ; preds = %bb.ij, %_ZNSt6vectorIN6Assimp6Unreal7TempMatESaIS2_EE9push_backERKS2_.exit
  %.sroa.31.2.a = phi ptr [ %.sroa.31.5.a, %_ZNSt6vectorIN6Assimp6Unreal7TempMatESaIS2_EE9push_backERKS2_.exit ], [ %.sroa.31.0882, %bb.ij ] ; 18 uses
  %.sroa.21.1 = phi ptr [ %.sroa.21.3, %_ZNSt6vectorIN6Assimp6Unreal7TempMatESaIS2_EE9push_backERKS2_.exit ], [ %.sroa.0654.0883, %bb.ij ] ; 2 uses
  %.sroa.0657.2 = phi ptr [ %.sroa.0657.5, %_ZNSt6vectorIN6Assimp6Unreal7TempMatESaIS2_EE9push_backERKS2_.exit ], [ %.sroa.21.0884, %bb.ij ] ; 14 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %26) #26
  %i.adw = getelementptr inbounds nuw i8, ptr %.sroa.0657.0885, i64 20 ; 2 uses
...
.lr.ph901:                                        ; preds = %.loopexit
  ...
  %i.aeo = ptrtoint ptr %.sroa.31.2.a to i64
  br label %bb.ju
...
begin_hunk_7_@_ZN6Assimp14UnrealImporter14InternReadFileERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEP7aiScenePNS_8IOSystemE:bb.a
  ...
  %i.aey = getelementptr inbounds nuw [12 x i8], ptr %.sroa.31.2.a, i64 %indvars.iv ; 5 uses
...
begin_hunk_8_@_ZN6Assimp14UnrealImporter14InternReadFileERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEP7aiScenePNS_8IOSystemE:bb.a
  ...
  %i.aiv = invoke ptr @_ZSt9__find_ifIN9__gnu_cxx17__normal_iteratorIPN6Assimp6Unreal7TempMatESt6vectorIS4_SaIS4_EEEENS0_5__ops16_Iter_equals_valIKS4_EEET_SE_SE_T0_St26random_access_iterator_tag(ptr %.sroa.31.2.a, ptr %.sroa.21.1, ptr nonnull align 4 dereferenceable(12) %29)
...
_ZNSt6vectorIN6Assimp6Unreal7TempMatESaIS2_EED2Ev.exit: ; preds = %bb.jz
  ...
  %i.aml = ptrtoint ptr %.sroa.0657.2 to i64
  %i.amm = ptrtoint ptr %.sroa.31.2.a to i64
  %i.amn = sub i64 %i.aml, %i.amm
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.31.2.a, i64 noundef %i.amn) #28
...
bb.ku:                                            ; preds = %bb.ja, %bb.jt, %bb.kt, %bb.jy, %bb.in, %bb.ii, %bb.ic
  %.sroa.31.3.a = phi ptr [ %.sroa.31.1.a, %bb.ic ], [ %.sroa.31.0882, %bb.ii ], [ %.sroa.31.2.a, %bb.in ], [ %.sroa.31.2.a, %bb.jt ], [ %.sroa.31.2.a, %bb.ja ], [ %.sroa.31.2.a, %bb.jy ], [ %.sroa.31.2.a, %bb.kt ] ; 2 uses
  %.sroa.0657.3 = phi ptr [ %.sroa.0657.1, %bb.ic ], [ %.sroa.21.0884, %bb.ii ], [ %.sroa.0657.2, %bb.in ], [ %.sroa.0657.2, %bb.jt ], [ %.sroa.0657.2, %bb.ja ], [ %.sroa.0657.2, %bb.jy ], [ %.sroa.0657.2, %bb.kt ]
  %.pn227 = phi { ptr, i32 } [ %i.acn, %bb.ic ], [ %lpad.phi, %bb.ii ], [ %i.ady, %bb.in ], [ %.pn222, %bb.jt ], [ %i.ahh, %bb.ja ], [ %.pn214, %bb.jy ], [ %.pn212, %bb.kt ] ; 2 uses
  %.not.i.i.i606 = icmp eq ptr %.sroa.31.3.a, null
...
.thread785:                                       ; preds = %bb.jb, %bb.jc, %bb.jd, %bb.ku
  ...
  %.sroa.0657.3791 = phi ptr [ %.sroa.0657.3, %bb.ku ], [ %.sroa.0657.2, %bb.jc ], [ %.sroa.0657.2, %bb.jd ], [ %.sroa.0657.2, %bb.jb ]
  %.sroa.31.3790 = phi ptr [ %.sroa.31.3.a, %bb.ku ], [ %.sroa.31.2.a, %bb.jc ], [ %.sroa.31.2.a, %bb.jd ], [ %.sroa.31.2.a, %bb.jb ] ; 2 uses
  %i.apq = ptrtoint ptr %.sroa.0657.3791 to i64
  %i.apr = ptrtoint ptr %.sroa.31.3790 to i64
  %i.aps = sub i64 %i.apq, %i.apr
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.31.3790, i64 noundef %i.aps) #28
