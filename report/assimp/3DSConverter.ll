...
.lr.ph411:                                        ; preds = %.lr.ph411.preheader, %.lr.ph411
  ...
  %7 = load float, ptr %.0218409, align 4         ; 2 uses
  %i.cv = getelementptr inbounds nuw i8, ptr %.0218409, i64 4
  %8 = load float, ptr %i.cv, align 4             ; 2 uses
  %9 = getelementptr inbounds nuw i8, ptr %.0218409, i64 8 ; 2 uses
  %i.cw = load float, ptr %9, align 4             ; 2 uses
  ...
  %13 = insertelement <2 x float> poison, float %i.cw, i64 0
  %14 = shufflevector <2 x float> %13, <2 x float> poison, <2 x i32> zeroinitializer
  %i.de = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.dd, <2 x float> %14, <2 x float> %i.dc)
  ...
  %i.dj = fmul float %8, %i.di
  %i.dk = call float @llvm.fmuladd.f32(float %i.dh, float %7, float %i.dj)
  %i.dl = load float, ptr %i.bu, align 4
  %i.dm = call float @llvm.fmuladd.f32(float %i.dl, float %i.cw, float %i.dk)
  %i.dn = load float, ptr %i.bv, align 4
  %i.do = fadd float %i.dn, %i.dm
  store <2 x float> %i.dg, ptr %.0218409, align 4
  store float %i.do, ptr %9, align 4
  %15 = load float, ptr %.0221408, align 4        ; 2 uses
  %i.dp = getelementptr inbounds nuw i8, ptr %.0221408, i64 4
  %i.dq = load float, ptr %i.dp, align 4          ; 2 uses
  %16 = getelementptr inbounds nuw i8, ptr %.0221408, i64 8 ; 2 uses
  %i.dr = load float, ptr %16, align 4            ; 2 uses
  ...
  %i.dv = insertelement <2 x float> poison, float %15, i64 0
  ...
  %i.ed = call float @llvm.fmuladd.f32(float %.sroa.8335.0.copyload, float %15, float %i.ec)
  ...
  store float %i.ef, ptr %16, align 4
