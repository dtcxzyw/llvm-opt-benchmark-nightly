...
._crit_edge426:                                   ; preds = %.lr.ph425
  ...
  %i.lm = load <2 x float>, ptr %.phi.trans.insert, align 4, !noalias !32 ; 6 uses
  %.pre468 = load float, ptr %.phi.trans.insert467, align 4, !noalias !32 ; 5 uses
  %i.ln = fmul float %.pre468, %.pre468           ; 2 uses
  %i.lo = fmul float %.pre468, %i.ld
  %7 = fmul float %.pre468, %.pre472
  %8 = extractelement <2 x float> %i.lm, i64 0    ; 3 uses
  %9 = call float @llvm.fmuladd.f32(float %8, float %8, float %i.ln)
  %10 = fmul float %8, %.pre472
  %i.lp = insertelement <4 x float> %i.lj, float %9, i64 0
  ...
  %11 = insertelement <4 x float> <float 1.000000e+00, float poison, float poison, float 1.000000e+00>, float %i.lo, i64 1
  %12 = insertelement <4 x float> %11, float %10, i64 2
  %i.ls = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.lh, <4 x float> %i.lr, <4 x float> %12)
  ...
  %i.lz = insertelement <4 x float> <float poison, float 1.000000e+00, float poison, float 1.000000e+00>, float %7, i64 0
  ...
  %13 = insertelement <2 x float> poison, float %.pre468, i64 0
  %i.ml = shufflevector <2 x float> %13, <2 x float> poison, <2 x i32> zeroinitializer
