...
.lr.ph407:                                        ; preds = %.lr.ph407.preheader, %.lr.ph407
  ...
  %i.cv = load float, ptr %5, align 4
  %14 = load float, ptr %.0217405, align 4        ; 3 uses
  %i.cw = load float, ptr %7, align 4
  %i.cx = getelementptr inbounds nuw i8, ptr %.0217405, i64 4
  %i.cy = load float, ptr %i.cx, align 4          ; 3 uses
  %15 = fmul float %i.cw, %i.cy
  %16 = call float @llvm.fmuladd.f32(float %i.cv, float %14, float %15)
  %17 = load float, ptr %8, align 4
  %18 = getelementptr inbounds nuw i8, ptr %.0217405, i64 8 ; 2 uses
  %19 = load float, ptr %18, align 4              ; 3 uses
  %20 = call float @llvm.fmuladd.f32(float %17, float %19, float %16)
  ...
  %25 = fmul float %i.cy, %24
  %26 = call float @llvm.fmuladd.f32(float %23, float %14, float %25)
  %27 = load float, ptr %12, align 4
  %28 = call float @llvm.fmuladd.f32(float %27, float %19, float %26)
  ...
  %i.dc = call float @llvm.fmuladd.f32(float %i.cz, float %14, float %i.db)
  %i.dd = load float, ptr %i.bu, align 4
  %i.de = call float @llvm.fmuladd.f32(float %i.dd, float %19, float %i.dc)
  %i.df = load float, ptr %i.bv, align 4
  %i.dg = fadd float %i.df, %i.de
  store <2 x float> %.sroa.0.4.vec.insert.i, ptr %.0217405, align 4
  store float %i.dg, ptr %18, align 4
...
.lr.ph439.peel.next:                              ; preds = %_ZN13aiQuaterniontIfE9NormalizeEv.exit.peel, %_ZN13aiQuaterniontIfE9NormalizeEv.exit
  ...
  %.sroa.13.0435 = phi <2 x float> [ %.sroa.13.1, %_ZN13aiQuaterniontIfE9NormalizeEv.exit ], [ %.sroa.13.1.peel, %_ZN13aiQuaterniontIfE9NormalizeEv.exit.peel ] ; 6 uses
  %i.yb = load ptr, ptr %i.kj, align 8
  %i.yc = getelementptr inbounds nuw [32 x i8], ptr %i.yb, i64 %indvars.iv458 ; 4 uses
  %.sroa.13.12.vec.extract = extractelement <2 x float> %.sroa.13.0435, i64 1
  %31 = getelementptr inbounds nuw i8, ptr %i.yc, i64 12
  %i.yd = getelementptr inbounds nuw i8, ptr %i.yc, i64 16
  %.sroa.13.8.vec.extract = extractelement <2 x float> %.sroa.13.0435, i64 0
  %i.ye = getelementptr inbounds nuw i8, ptr %i.yc, i64 8
  %32 = load float, ptr %i.ye, align 4            ; 3 uses
  %i.yf = load <2 x float>, ptr %31, align 4      ; 6 uses
  %33 = load <2 x float>, ptr %i.yd, align 4      ; 4 uses
  %34 = fneg float %.sroa.13.8.vec.extract
  %i.yg = shufflevector <2 x float> %.sroa.0.0369436, <2 x float> %.sroa.13.0435, <2 x i32> <i32 1, i32 2>
  %i.yh = fneg <2 x float> %i.yg
  %35 = insertelement <2 x float> poison, float %32, i64 0
  %i.yi = shufflevector <2 x float> %35, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.yl = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.yk, <2 x float> %33, <2 x float> %i.yj)
  %i.ym = shufflevector <2 x float> %.sroa.13.0435, <2 x float> %.sroa.0.0369436, <2 x i32> <i32 1, i32 3>
  %36 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ym, <2 x float> %i.yf, <2 x float> %i.yl)
  %i.yn = shufflevector <2 x float> %33, <2 x float> %i.yf, <2 x i32> <i32 1, i32 2>
  %i.yo = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.yh, <2 x float> %i.yn, <2 x float> %36) ; 5 uses
  %37 = fneg float %.sroa.13.12.vec.extract
  %38 = extractelement <2 x float> %i.yf, i64 0
  %39 = fneg float %38
  ...
  %i.yq = fmul <2 x float> %i.yp, %41
  %42 = shufflevector <2 x float> %i.yf, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %43 = insertelement <2 x float> %42, float %32, i64 0
  %i.yr = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.yk, <2 x float> %43, <2 x float> %i.yq)
  %44 = shufflevector <2 x float> %.sroa.13.0435, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %45 = insertelement <2 x float> %44, float %34, i64 0
  %46 = shufflevector <2 x float> %i.yf, <2 x float> %33, <2 x i32> <i32 1, i32 3>
  %i.ys = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %45, <2 x float> %46, <2 x float> %i.yr)
  %i.yt = insertelement <2 x float> poison, float %37, i64 0
  %i.yu = shufflevector <2 x float> %i.yt, <2 x float> poison, <2 x i32> zeroinitializer
  %47 = shufflevector <2 x float> %33, <2 x float> %i.yf, <2 x i32> <i32 1, i32 3>
  %i.yv = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.yu, <2 x float> %47, <2 x float> %i.ys) ; 3 uses
  ...
  %foldExtExtBinop551 = fmul <2 x float> %i.yo, %i.yo
  %i.yz = extractelement <2 x float> %foldExtExtBinop551, i64 0
  %i.za = extractelement <2 x float> %i.yv, i64 1 ; 3 uses
  %i.zb = call float @llvm.fmuladd.f32(float %i.za, float %i.za, float %i.yz)
  %i.zc = extractelement <2 x float> %i.yo, i64 1 ; 2 uses
  %i.zd = call float @llvm.fmuladd.f32(float %i.zc, float %i.zc, float %i.zb)
  %i.ze = extractelement <2 x float> %i.yv, i64 0 ; 3 uses
...
bb.bl:                                            ; preds = %.lr.ph439.peel.next
  ...
  %i.zh = fdiv float 1.000000e+00, %sqrt.i        ; 3 uses
  %48 = fmul float %i.za, %i.zh
  ...
  %i.zk = fmul <2 x float> %i.yo, %i.zj
  %49 = fmul float %i.ze, %i.zh
  %50 = insertelement <2 x float> poison, float %49, i64 0
  %.sroa.0.0.vec.insert283 = insertelement <2 x float> %50, float %48, i64 1
  br label %_ZN13aiQuaterniontIfE9NormalizeEv.exit

_ZN13aiQuaterniontIfE9NormalizeEv.exit:           ; preds = %bb.bl, %.lr.ph439.peel.next
  %.sroa.13.1 = phi <2 x float> [ %i.zk, %bb.bl ], [ %i.yo, %.lr.ph439.peel.next ] ; 2 uses
  %.sroa.0.1 = phi <2 x float> [ %.sroa.0.0.vec.insert283, %bb.bl ], [ %i.yv, %.lr.ph439.peel.next ] ; 2 uses
