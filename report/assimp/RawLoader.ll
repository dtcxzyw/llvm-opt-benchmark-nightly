...
bb.p:                                             ; preds = %bb.r, %_ZN6Assimp9IsLineEndIcEEbT_.exit.thread.i
  %.2 = phi ptr [ %.1.lcssa, %_ZN6Assimp9IsLineEndIcEEbT_.exit.thread.i ], [ %i.dd, %bb.r ] ; 6 uses
...
._ZN6Assimp11GetNextLineIcEEbRPKT_PS1_.exit.split.preheader_crit_edge: ; preds = %bb.q
  %.2.lcssa1150 = phi ptr [ %.2, %bb.q ]
  %.2.lcssa1150.a = phi ptr [ %.2, %bb.q ]        ; 0 uses
  br label %_ZN6Assimp11GetNextLineIcEEbRPKT_PS1_.exit.split.preheader
...
_ZN6Assimp11GetNextLineIcEEbRPKT_PS1_.exit.split.preheader: ; preds = %_ZN6Assimp11GetNextLineIcEEbRPKT_PS1_.exit.split.preheadersplit, %._ZN6Assimp11GetNextLineIcEEbRPKT_PS1_.exit.split.preheader_crit_edge
  %.2.lcssa = phi ptr [ %.2.lcssa1150, %._ZN6Assimp11GetNextLineIcEEbRPKT_PS1_.exit.split.preheader_crit_edge ], [ %.2.lcssa1149, %_ZN6Assimp11GetNextLineIcEEbRPKT_PS1_.exit.split.preheadersplit ] ; 2 uses
...
bb.di:                                            ; preds = %.lr.ph608, %bb.dl
  %.sroa.0483.0606 = phi ptr [ %i.il, %.lr.ph608 ], [ %i.it, %bb.dl ] ; 6 uses
...
..loopexit548.loopexit_crit_edge:                 ; preds = %bb.dj
  %.sroa.0483.0606.lcssa1154 = phi ptr [ %.sroa.0483.0606, %bb.dj ]
  %.sroa.0483.0606.lcssa1153 = phi ptr [ %.sroa.0483.0606, %bb.dj ] ; 0 uses
  br label %.loopexit548.loopexit

.loopexit548.loopexit:                            ; preds = %.loopexit548.loopexitsplit, %..loopexit548.loopexit_crit_edge
  %.sroa.0483.0606.lcssa = phi ptr [ %.sroa.0483.0606.lcssa1154, %..loopexit548.loopexit_crit_edge ], [ %.sroa.0483.0606.lcssa1154.a, %.loopexit548.loopexitsplit ]
