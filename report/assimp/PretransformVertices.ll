...
._crit_edge692:                                   ; preds = %bb.da, %bb.cz
  %.sroa.0471.1.lcssa = phi <2 x float> [ %.sroa.0471.0697, %bb.cz ], [ %i.zw, %bb.da ] ; 3 uses
  ...
  %.sroa.14.1.lcssa = phi float [ %.sroa.14.0700, %bb.cz ], [ %i.zt, %bb.da ] ; 3 uses
...
._crit_edge703:                                   ; preds = %._crit_edge692
  %i.aab = fsub float %.sroa.12.1.lcssa, %.sroa.14.1.lcssa ; 3 uses
  %i.aac = fsub <2 x float> %.sroa.0459.1.lcssa, %.sroa.0471.1.lcssa ; 3 uses
  %i.aad = fmul <2 x float> %i.aac, splat (float 5.000000e-01)
  %i.aae = fmul float %i.aab, 5.000000e-01
  %i.aaf = fadd <2 x float> %.sroa.0471.1.lcssa, %i.aad
  %i.aag = fadd float %.sroa.14.1.lcssa, %i.aae
