...
._crit_edge692:                                   ; preds = %bb.cy, %bb.cx
  %.sroa.0471.1.lcssa = phi <2 x float> [ %.sroa.0471.0697, %bb.cx ], [ %i.aam, %bb.cy ] ; 2 uses
  ...
  %.sroa.14.1.lcssa = phi float [ %.sroa.14.0700, %bb.cx ], [ %i.aaj, %bb.cy ] ; 2 uses
...
._crit_edge703:                                   ; preds = %._crit_edge692, %.preheader
  ...
  %i.aar = fsub float %.sroa.12.0.lcssa, %.sroa.14.0.lcssa ; 3 uses
  %i.aas = fsub <2 x float> %.sroa.0459.0.lcssa, %.sroa.0471.0.lcssa ; 3 uses
  %i.aat = fmul <2 x float> %i.aas, splat (float 5.000000e-01)
  %i.aau = fmul float %i.aar, 5.000000e-01
  %i.aav = fadd <2 x float> %.sroa.0471.0.lcssa, %i.aat
  %i.aaw = fadd float %.sroa.14.0.lcssa, %i.aau
