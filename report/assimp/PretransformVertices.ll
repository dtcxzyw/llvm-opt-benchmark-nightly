...
bb.c:                                             ; preds = %bb.b
  ...
  %.sroa.0530.0.copyload531 = load float, ptr %i.s, align 4
  %.sroa.6532.0..sroa_idx533 = getelementptr inbounds nuw i8, ptr %0, i64 32
  %.sroa.6532.0.copyload534 = load float, ptr %.sroa.6532.0..sroa_idx533, align 8
  %.sroa.8535.0..sroa_idx536 = getelementptr inbounds nuw i8, ptr %0, i64 36
  %.sroa.8535.0.copyload537 = load float, ptr %.sroa.8535.0..sroa_idx536, align 4
  %.sroa.10538.0..sroa_idx539 = getelementptr inbounds nuw i8, ptr %0, i64 40
  %.sroa.10538.0.copyload540 = load float, ptr %.sroa.10538.0..sroa_idx539, align 8
  %.sroa.12541.0..sroa_idx542 = getelementptr inbounds nuw i8, ptr %0, i64 44
  %.sroa.12541.0.copyload543 = load float, ptr %.sroa.12541.0..sroa_idx542, align 4
  %.sroa.14544.0..sroa_idx545 = getelementptr inbounds nuw i8, ptr %0, i64 48
  %.sroa.14544.0.copyload546 = load float, ptr %.sroa.14544.0..sroa_idx545, align 8
  %.sroa.16547.0..sroa_idx548 = getelementptr inbounds nuw i8, ptr %0, i64 52
  %.sroa.16547.0.copyload549 = load float, ptr %.sroa.16547.0..sroa_idx548, align 4
  %.sroa.18550.0..sroa_idx551 = getelementptr inbounds nuw i8, ptr %0, i64 56
  %.sroa.18550.0.copyload552 = load float, ptr %.sroa.18550.0..sroa_idx551, align 8
  %.sroa.20.0..sroa_idx553 = getelementptr inbounds nuw i8, ptr %0, i64 60
  %.sroa.20.0.copyload554 = load float, ptr %.sroa.20.0..sroa_idx553, align 4
  %.sroa.22.0..sroa_idx555 = getelementptr inbounds nuw i8, ptr %0, i64 64
  %.sroa.22.0.copyload556 = load float, ptr %.sroa.22.0..sroa_idx555, align 8
  %.sroa.24.0..sroa_idx557 = getelementptr inbounds nuw i8, ptr %0, i64 68
  %.sroa.24.0.copyload558 = load float, ptr %.sroa.24.0..sroa_idx557, align 4
  %.sroa.26.0..sroa_idx559 = getelementptr inbounds nuw i8, ptr %0, i64 72
  %.sroa.26.0.copyload560 = load float, ptr %.sroa.26.0..sroa_idx559, align 8
  %.sroa.28.0..sroa_idx561 = getelementptr inbounds nuw i8, ptr %0, i64 76
  %.sroa.28.0.copyload562 = load float, ptr %.sroa.28.0..sroa_idx561, align 4
  ...
  %5 = insertelement <4 x float> poison, float %.sroa.6532.0.copyload534, i64 0
  %i.z = shufflevector <4 x float> %5, <4 x float> poison, <4 x i32> zeroinitializer
  %i.aa = fmul <4 x float> %i.z, %i.y
  %6 = insertelement <4 x float> poison, float %.sroa.0530.0.copyload531, i64 0
  %i.ab = shufflevector <4 x float> %6, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %7 = insertelement <4 x float> poison, float %.sroa.8535.0.copyload537, i64 0
  ...
  %8 = insertelement <4 x float> poison, float %.sroa.10538.0.copyload540, i64 0
  ...
  %9 = insertelement <4 x float> poison, float %.sroa.14544.0.copyload546, i64 0
  %i.aj = shufflevector <4 x float> %9, <4 x float> poison, <4 x i32> zeroinitializer
  %i.ak = fmul <4 x float> %i.aj, %i.y
  %10 = insertelement <4 x float> poison, float %.sroa.12541.0.copyload543, i64 0
  %i.al = shufflevector <4 x float> %10, <4 x float> poison, <4 x i32> zeroinitializer
  %i.am = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.x, <4 x float> %i.al, <4 x float> %i.ak)
  %11 = insertelement <4 x float> poison, float %.sroa.16547.0.copyload549, i64 0
  ...
  %12 = insertelement <4 x float> poison, float %.sroa.18550.0.copyload552, i64 0
  ...
  %13 = insertelement <4 x float> poison, float %.sroa.22.0.copyload556, i64 0
  %i.ar = shufflevector <4 x float> %13, <4 x float> poison, <4 x i32> zeroinitializer
  %i.as = fmul <4 x float> %i.ar, %i.y
  %14 = insertelement <4 x float> poison, float %.sroa.20.0.copyload554, i64 0
  %i.at = shufflevector <4 x float> %14, <4 x float> poison, <4 x i32> zeroinitializer
  %i.au = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.x, <4 x float> %i.at, <4 x float> %i.as)
  %15 = insertelement <4 x float> poison, float %.sroa.24.0.copyload558, i64 0
  ...
  %16 = insertelement <4 x float> poison, float %.sroa.26.0.copyload560, i64 0
  ...
  %17 = insertelement <4 x float> poison, float %.sroa.28.0.copyload562, i64 0
