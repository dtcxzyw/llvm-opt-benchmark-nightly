...
bb.a:
  ...
  br i1 %i.e, label %bb.b, label %bb.bg
...
bb.c:                                             ; preds = %bb.b, %_ZNSt6vectorISt4pairIP6aiMeshjESaIS3_EE12emplace_backIJRS2_RjEEERS3_DpOT_.exit
  %indvars.iv = phi i32 [ 0, %bb.b ], [ %indvars.iv.next, %_ZNSt6vectorISt4pairIP6aiMeshjESaIS3_EE12emplace_backIJRS2_RjEEERS3_DpOT_.exit ] ; 2 uses
...
thread-pre-split:                                 ; preds = %_ZN8aiStringaSERKS_.exit, %bb.e
  %i.bo = phi i32 [ %.reass, %bb.e ], [ %i.k, %_ZN8aiStringaSERKS_.exit ] ; 6 uses
...
.lr.ph:                                           ; preds = %.loopexit278
  %i.cy = load ptr, ptr %i.p, align 8             ; 5 uses
  %i.cz = zext i32 %indvars.iv to i64             ; 2 uses
  %i.da = add i32 %i.bo, -1
  %xtraiter468 = and i32 %i.bo, 3                 ; 3 uses
  %i.db = icmp ult i32 %i.da, 3
  br i1 %i.db, label %.epil.preheader, label %.lr.ph.new

.lr.ph.new:                                       ; preds = %.lr.ph
  %unroll_iter = and i32 %i.bo, -4
  br label %bb.h

._crit_edge.loopexit.unr-lcssa:                   ; preds = %bb.h
  %lcmp.mod469.not = icmp eq i32 %xtraiter468, 0
  br i1 %lcmp.mod469.not, label %._crit_edge, label %.epil.preheader

.epil.preheader:                                  ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph
  %indvars.iv354.epil.init = phi i64 [ %i.cz, %.lr.ph ], [ %indvars.iv.next355.3, %._crit_edge.loopexit.unr-lcssa ]
  %.0120299.epil.init = phi i32 [ 0, %.lr.ph ], [ %i.dh, %._crit_edge.loopexit.unr-lcssa ]
  %lcmp.mod471 = icmp ne i32 %xtraiter468, 0
  tail call void @llvm.assume(i1 %lcmp.mod471)
  br label %bb.g

bb.g:                                             ; preds = %bb.g, %.epil.preheader
  %indvars.iv354.epil = phi i64 [ %indvars.iv354.epil.init, %.epil.preheader ], [ %indvars.iv.next355.epil, %bb.g ] ; 2 uses
  %.0120299.epil = phi i32 [ %.0120299.epil.init, %.epil.preheader ], [ %4, %bb.g ]
  %epil.iter = phi i32 [ 0, %.epil.preheader ], [ %epil.iter.next, %bb.g ]
  %i.dc = getelementptr inbounds nuw [16 x i8], ptr %i.cy, i64 %indvars.iv354.epil
  %i.dd = load i32, ptr %i.dc, align 8
  %.fr.epil = freeze i32 %i.dd
  %4 = add i32 %.fr.epil, %.0120299.epil          ; 2 uses
  %indvars.iv.next355.epil = add nuw nsw i64 %indvars.iv354.epil, 1
  %epil.iter.next = add i32 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.next, %xtraiter468
  br i1 %epil.iter.cmp.not, label %._crit_edge, label %bb.g, !llvm.loop !8

._crit_edge:                                      ; preds = %._crit_edge.loopexit.unr-lcssa, %bb.g, %.loopexit278
  %.0120.lcssa = phi i32 [ 0, %.loopexit278 ], [ %i.dh, %._crit_edge.loopexit.unr-lcssa ], [ %4, %bb.g ] ; 8 uses
...
bb.h:                                             ; preds = %bb.h, %.lr.ph.new
  %indvars.iv354 = phi i64 [ %i.cz, %.lr.ph.new ], [ %indvars.iv.next355.3, %bb.h ] ; 5 uses
  %.0120299 = phi i32 [ 0, %.lr.ph.new ], [ %i.dh, %bb.h ]
  %niter = phi i32 [ 0, %.lr.ph.new ], [ %niter.next.3, %bb.h ]
  %5 = getelementptr inbounds nuw [16 x i8], ptr %i.cy, i64 %indvars.iv354
  %6 = load i32, ptr %5, align 8
  %.fr = freeze i32 %6
  %7 = add i32 %.fr, %.0120299
  %8 = getelementptr inbounds nuw [16 x i8], ptr %i.cy, i64 %indvars.iv354
  %9 = getelementptr inbounds nuw i8, ptr %8, i64 16
  %10 = load i32, ptr %9, align 8
  %.fr.1 = freeze i32 %10
  %11 = add i32 %.fr.1, %7
  %12 = getelementptr inbounds nuw [16 x i8], ptr %i.cy, i64 %indvars.iv354
  %13 = getelementptr inbounds nuw i8, ptr %12, i64 32
  %14 = load i32, ptr %13, align 8
  %.fr.2 = freeze i32 %14
  %15 = add i32 %.fr.2, %11
  %i.df = getelementptr inbounds nuw [16 x i8], ptr %i.cy, i64 %indvars.iv354
  %16 = getelementptr inbounds nuw i8, ptr %i.df, i64 48
  %i.dg = load i32, ptr %16, align 8
  %.fr.3 = freeze i32 %i.dg
  %i.dh = add i32 %.fr.3, %15                     ; 3 uses
  %indvars.iv.next355.3 = add nuw nsw i64 %indvars.iv354, 4 ; 2 uses
  %niter.next.3 = add i32 %niter, 4               ; 2 uses
  %niter.ncmp.3 = icmp eq i32 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %._crit_edge.loopexit.unr-lcssa, label %bb.h, !llvm.loop !9
...
.loopexit277.loopexit:                            ; preds = %bb.i
...
.loopexit277:                                     ; preds = %.loopexit277.loopexit, %bb.i
  store ptr %i.dk, ptr %i.ba, align 8
  br label %bb.j

bb.j:                                             ; preds = %.loopexit277, %._crit_edge
...
.loopexit276.loopexit:                            ; preds = %bb.k
...
bb.l:                                             ; preds = %.loopexit276, %bb.j
  ...
  br i1 %brmerge.not, label %bb.m, label %_ZNK6aiMesh24HasTangentsAndBitangentsEv.exit.thread
...
.loopexit275.loopexit:                            ; preds = %bb.m
...
_ZNK6aiMesh24HasTangentsAndBitangentsEv.exit.thread: ; preds = %bb.l, %.loopexit275
  ...
  %i.fa = load i32, ptr %i.v, align 4
  store i32 %i.fa, ptr %i.et, align 4
  %i.fb = load ptr, ptr %i.w, align 8
  %.not.i147 = icmp ne ptr %i.fb, null
  %i.fc = select i1 %.not.i147, i1 %i.ds, i1 false
  br i1 %i.fc, label %bb.n, label %_ZNK6aiMesh16HasTextureCoordsEj.exit.1

bb.n:                                             ; preds = %_ZNK6aiMesh24HasTangentsAndBitangentsEv.exit.thread
...
_ZNK6aiMesh16HasTextureCoordsEj.exit.1:           ; preds = %_ZNK6aiMesh24HasTangentsAndBitangentsEv.exit.thread, %.loopexit273
  ...
  br i1 %i.fh, label %bb.o, label %_ZNK6aiMesh16HasTextureCoordsEj.exit.2

bb.o:                                             ; preds = %_ZNK6aiMesh16HasTextureCoordsEj.exit.1
...
_ZNK6aiMesh16HasTextureCoordsEj.exit.2:           ; preds = %.loopexit273.1, %_ZNK6aiMesh16HasTextureCoordsEj.exit.1
  %i.fk = load i32, ptr %i.ae, align 4
  %i.fl = getelementptr inbounds nuw i8, ptr %i.ax, i64 184
  store i32 %i.fk, ptr %i.fl, align 4
  %i.fm = load ptr, ptr %i.af, align 8
  %.not.i147.2 = icmp ne ptr %i.fm, null
  %i.fn = select i1 %.not.i147.2, i1 %i.ds, i1 false
  br i1 %i.fn, label %bb.p, label %_ZNK6aiMesh16HasTextureCoordsEj.exit.3

bb.p:                                             ; preds = %_ZNK6aiMesh16HasTextureCoordsEj.exit.2
...
_ZNK6aiMesh16HasTextureCoordsEj.exit.3:           ; preds = %.loopexit273.2, %_ZNK6aiMesh16HasTextureCoordsEj.exit.2
  ...
  br i1 %i.ft, label %bb.q, label %_ZNK6aiMesh16HasTextureCoordsEj.exit.4

bb.q:                                             ; preds = %_ZNK6aiMesh16HasTextureCoordsEj.exit.3
...
_ZNK6aiMesh16HasTextureCoordsEj.exit.4:           ; preds = %.loopexit273.3, %_ZNK6aiMesh16HasTextureCoordsEj.exit.3
  %i.fw = load i32, ptr %i.ai, align 4
  ...
  br i1 %i.fz, label %bb.r, label %_ZNK6aiMesh16HasTextureCoordsEj.exit.5

bb.r:                                             ; preds = %_ZNK6aiMesh16HasTextureCoordsEj.exit.4
...
_ZNK6aiMesh15HasVertexColorsEj.exit.2:            ; preds = %.loopexit272.1, %_ZNK6aiMesh15HasVertexColorsEj.exit.1
  ...
  br i1 %i.he, label %bb.x, label %_ZNK6aiMesh15HasVertexColorsEj.exit.3

bb.x:                                             ; preds = %_ZNK6aiMesh15HasVertexColorsEj.exit.2
...
_ZNK6aiMesh15HasVertexColorsEj.exit.3:            ; preds = %.loopexit272.2, %_ZNK6aiMesh15HasVertexColorsEj.exit.2
  ...
  br i1 %i.hi, label %bb.y, label %_ZNK6aiMesh15HasVertexColorsEj.exit.4

bb.y:                                             ; preds = %_ZNK6aiMesh15HasVertexColorsEj.exit.3
...
_ZNK6aiMesh15HasVertexColorsEj.exit.4:            ; preds = %.loopexit272.3, %_ZNK6aiMesh15HasVertexColorsEj.exit.3
  ...
  br i1 %i.hm, label %bb.z, label %_ZNK6aiMesh15HasVertexColorsEj.exit.5

bb.z:                                             ; preds = %_ZNK6aiMesh15HasVertexColorsEj.exit.4
...
_ZNK6aiMesh15HasVertexColorsEj.exit.5:            ; preds = %.loopexit272.4, %_ZNK6aiMesh15HasVertexColorsEj.exit.4
  ...
  br i1 %i.hq, label %bb.aa, label %_ZNK6aiMesh15HasVertexColorsEj.exit.6

bb.aa:                                            ; preds = %_ZNK6aiMesh15HasVertexColorsEj.exit.5
...
_ZNK6aiMesh15HasVertexColorsEj.exit.6:            ; preds = %.loopexit272.5, %_ZNK6aiMesh15HasVertexColorsEj.exit.5
  ...
  br i1 %i.hu, label %bb.ab, label %_ZNK6aiMesh15HasVertexColorsEj.exit.7

bb.ab:                                            ; preds = %_ZNK6aiMesh15HasVertexColorsEj.exit.6
...
_ZNK6aiMesh15HasVertexColorsEj.exit.7:            ; preds = %.loopexit272.6, %_ZNK6aiMesh15HasVertexColorsEj.exit.6
  ...
  br i1 %i.hy, label %bb.ac, label %bb.ad

bb.ac:                                            ; preds = %_ZNK6aiMesh15HasVertexColorsEj.exit.7
...
_ZNSt6vectorI14aiVertexWeightSaIS0_EED2Ev.exit:   ; preds = %._crit_edge315, %bb.ad
...
._crit_edge329:                                   ; preds = %._crit_edge324, %_ZNSt6vectorI14aiVertexWeightSaIS0_EED2Ev.exit
  ...
  br i1 %.not.i159, label %bb.af, label %bb.ae

bb.ae:                                            ; preds = %._crit_edge329
...
bb.af:                                            ; preds = %._crit_edge329
  ...
  br i1 %i.ji, label %bb.ag, label %_ZNKSt6vectorISt4pairIP6aiMeshjESaIS3_EE12_M_check_lenEmPKc.exit.i.i

bb.ag:                                            ; preds = %bb.af
  tail call void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.11) #18
  unreachable

_ZNKSt6vectorISt4pairIP6aiMeshjESaIS3_EE12_M_check_lenEmPKc.exit.i.i: ; preds = %bb.af
...
.lr.ph.i.i.i.i.i163:                              ; preds = %_ZNKSt6vectorISt4pairIP6aiMeshjESaIS3_EE12_M_check_lenEmPKc.exit.i.i, %.lr.ph.i.i.i.i.i163
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.012.i.i.i.i.i164, ptr noundef nonnull align 8 dereferenceable(16) %.0911.i.i.i.i.i165, i64 16, i1 false), !alias.scope !10
  ...
  br i1 %.not.i.i.i.i.i166, label %_ZNSt6vectorISt4pairIP6aiMeshjESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit33.i.i, label %.lr.ph.i.i.i.i.i163, !llvm.loop !14
...
_ZNSt6vectorISt4pairIP6aiMeshjESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit33.i.i: ; preds = %.lr.ph.i.i.i.i.i163, %_ZNKSt6vectorISt4pairIP6aiMeshjESaIS3_EE12_M_check_lenEmPKc.exit.i.i
  ...
  br i1 %.not.i34.i.i, label %_ZNSt6vectorISt4pairIP6aiMeshjESaIS3_EE17_M_realloc_insertIJRS2_RjEEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i, label %bb.ah

bb.ah:                                            ; preds = %_ZNSt6vectorISt4pairIP6aiMeshjESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit33.i.i
...
_ZNSt6vectorISt4pairIP6aiMeshjESaIS3_EE17_M_realloc_insertIJRS2_RjEEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i: ; preds = %bb.ah, %_ZNSt6vectorISt4pairIP6aiMeshjESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit33.i.i
...
_ZNSt6vectorISt4pairIP6aiMeshjESaIS3_EE12emplace_backIJRS2_RjEEERS3_DpOT_.exit: ; preds = %bb.ae, %_ZNSt6vectorISt4pairIP6aiMeshjESaIS3_EE17_M_realloc_insertIJRS2_RjEEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i
  %i.jw = add nuw i32 %.0118330, 1                ; 2 uses
  %i.jx = icmp ult i32 %i.jw, %i.j
  %indvars.iv.next = add i32 %indvars.iv, %i.k
  br i1 %i.jx, label %bb.c, label %bb.bf, !llvm.loop !15

bb.ai:                                            ; preds = %.lr.ph328, %._crit_edge324
  ...
  br i1 %i.kt, label %switch.lookup, label %bb.aj
...
.lr.ph323.preheader:                              ; preds = %switch.lookup, %bb.aj
  br label %.lr.ph323

switch.lookup:                                    ; preds = %bb.ai
  %i.kv = zext nneg i32 %switch.tableidx to i64
  %switch.gep = getelementptr inbounds nuw [4 x i8], ptr @switch.table._ZN6Assimp30SplitLargeMeshesProcess_Vertex9SplitMeshEjP6aiMeshRSt6vectorISt4pairIS2_jESaIS5_EE, i64 %i.kv
  %switch.load = load i32, ptr %switch.gep, align 4
  %i.kw = or i32 %i.ks, %switch.load
  store i32 %i.kw, ptr %i.ax, align 8
  br label %.lr.ph323.preheader

._crit_edge324:                                   ; preds = %_ZNK6aiMesh15HasVertexColorsEj.exit178.7.thread, %bb.aj
  %.1.lcssa = phi i32 [ %.0125326, %bb.aj ], [ %i.lc, %_ZNK6aiMesh15HasVertexColorsEj.exit178.7.thread ]
  ...
  br i1 %i.kz, label %bb.ai, label %._crit_edge329, !llvm.loop !16
...
.lr.ph323:                                        ; preds = %.lr.ph323.preheader, %_ZNK6aiMesh15HasVertexColorsEj.exit178.7.thread
  ...
  br i1 %.not143, label %bb.al, label %bb.ak

bb.ak:                                            ; preds = %.lr.ph323
...
bb.an:                                            ; preds = %bb.am, %bb.al
  %.pre386 = phi i32 [ %.pre386.pre, %bb.am ], [ %i.ll, %bb.al ] ; 2 uses
...
_ZNK6aiMesh24HasTangentsAndBitangentsEv.exit172:  ; preds = %bb.an
  %.not270 = icmp eq i32 %.pre386, 0
  br i1 %.not270, label %_ZNK6aiMesh15HasVertexColorsEj.exit178.7.thread, label %bb.ao

bb.ao:                                            ; preds = %_ZNK6aiMesh24HasTangentsAndBitangentsEv.exit172
...
_ZNK6aiMesh24HasTangentsAndBitangentsEv.exit172.thread: ; preds = %bb.an, %bb.ao
  %i.me = phi i32 [ %.pre386, %bb.an ], [ %.pre, %bb.ao ] ; 2 uses
  ...
  br i1 %i.mj, label %bb.ap, label %_ZNK6aiMesh16HasTextureCoordsEj.exit175.1

bb.ap:                                            ; preds = %_ZNK6aiMesh24HasTangentsAndBitangentsEv.exit172.thread
...
_ZNK6aiMesh16HasTextureCoordsEj.exit175.1:        ; preds = %_ZNK6aiMesh24HasTangentsAndBitangentsEv.exit172.thread, %bb.ap
  %i.mn = phi i32 [ %i.me, %_ZNK6aiMesh24HasTangentsAndBitangentsEv.exit172.thread ], [ %.pre387, %bb.ap ] ; 2 uses
  ...
  br i1 %i.mq, label %bb.aq, label %_ZNK6aiMesh16HasTextureCoordsEj.exit175.2

bb.aq:                                            ; preds = %_ZNK6aiMesh16HasTextureCoordsEj.exit175.1
...
_ZNK6aiMesh16HasTextureCoordsEj.exit175.2:        ; preds = %bb.aq, %_ZNK6aiMesh16HasTextureCoordsEj.exit175.1
  %i.mu = phi i32 [ %.pre388, %bb.aq ], [ %i.mn, %_ZNK6aiMesh16HasTextureCoordsEj.exit175.1 ] ; 2 uses
  ...
  br i1 %i.mx, label %bb.ar, label %_ZNK6aiMesh16HasTextureCoordsEj.exit175.3

bb.ar:                                            ; preds = %_ZNK6aiMesh16HasTextureCoordsEj.exit175.2
...
_ZNK6aiMesh16HasTextureCoordsEj.exit175.3:        ; preds = %bb.ar, %_ZNK6aiMesh16HasTextureCoordsEj.exit175.2
  %i.nb = phi i32 [ %.pre389, %bb.ar ], [ %i.mu, %_ZNK6aiMesh16HasTextureCoordsEj.exit175.2 ] ; 2 uses
  ...
  br i1 %i.ne, label %bb.as, label %_ZNK6aiMesh16HasTextureCoordsEj.exit175.4

bb.as:                                            ; preds = %_ZNK6aiMesh16HasTextureCoordsEj.exit175.3
...
_ZNK6aiMesh16HasTextureCoordsEj.exit175.4:        ; preds = %bb.as, %_ZNK6aiMesh16HasTextureCoordsEj.exit175.3
  %i.ni = phi i32 [ %.pre390, %bb.as ], [ %i.nb, %_ZNK6aiMesh16HasTextureCoordsEj.exit175.3 ] ; 2 uses
  ...
  br i1 %i.nl, label %bb.at, label %_ZNK6aiMesh16HasTextureCoordsEj.exit175.5

bb.at:                                            ; preds = %_ZNK6aiMesh16HasTextureCoordsEj.exit175.4
...
_ZNK6aiMesh16HasTextureCoordsEj.exit175.5:        ; preds = %bb.at, %_ZNK6aiMesh16HasTextureCoordsEj.exit175.4
  %i.np = phi i32 [ %.pre391, %bb.at ], [ %i.ni, %_ZNK6aiMesh16HasTextureCoordsEj.exit175.4 ] ; 2 uses
  ...
  br i1 %i.ns, label %bb.au, label %_ZNK6aiMesh16HasTextureCoordsEj.exit175.6

bb.au:                                            ; preds = %_ZNK6aiMesh16HasTextureCoordsEj.exit175.5
...
_ZNK6aiMesh16HasTextureCoordsEj.exit175.6:        ; preds = %bb.au, %_ZNK6aiMesh16HasTextureCoordsEj.exit175.5
  %i.nw = phi i32 [ %.pre392, %bb.au ], [ %i.np, %_ZNK6aiMesh16HasTextureCoordsEj.exit175.5 ] ; 2 uses
  ...
  br i1 %i.nz, label %bb.av, label %_ZNK6aiMesh16HasTextureCoordsEj.exit175.7

bb.av:                                            ; preds = %_ZNK6aiMesh16HasTextureCoordsEj.exit175.6
...
_ZNK6aiMesh16HasTextureCoordsEj.exit175.7:        ; preds = %bb.av, %_ZNK6aiMesh16HasTextureCoordsEj.exit175.6
  %i.od = phi i32 [ %.pre393, %bb.av ], [ %i.nw, %_ZNK6aiMesh16HasTextureCoordsEj.exit175.6 ] ; 2 uses
  ...
  br i1 %i.og, label %bb.aw, label %.preheader

bb.aw:                                            ; preds = %_ZNK6aiMesh16HasTextureCoordsEj.exit175.7
...
.preheader:                                       ; preds = %bb.aw, %_ZNK6aiMesh16HasTextureCoordsEj.exit175.7
  %i.ok = phi i32 [ %.pre394, %bb.aw ], [ %i.od, %_ZNK6aiMesh16HasTextureCoordsEj.exit175.7 ] ; 2 uses
  ...
  br i1 %i.on, label %bb.ax, label %_ZNK6aiMesh15HasVertexColorsEj.exit178.1
...
_ZNK6aiMesh15HasVertexColorsEj.exit178.1:         ; preds = %.preheader, %bb.ax
  %i.or = phi i32 [ %i.ok, %.preheader ], [ %.pre395, %bb.ax ] ; 2 uses
  ...
  br i1 %i.ou, label %bb.ay, label %_ZNK6aiMesh15HasVertexColorsEj.exit178.2

bb.ay:                                            ; preds = %_ZNK6aiMesh15HasVertexColorsEj.exit178.1
...
_ZNK6aiMesh15HasVertexColorsEj.exit178.2:         ; preds = %bb.ay, %_ZNK6aiMesh15HasVertexColorsEj.exit178.1
  %i.oy = phi i32 [ %.pre396, %bb.ay ], [ %i.or, %_ZNK6aiMesh15HasVertexColorsEj.exit178.1 ] ; 2 uses
  ...
  br i1 %i.pb, label %bb.az, label %_ZNK6aiMesh15HasVertexColorsEj.exit178.3

bb.az:                                            ; preds = %_ZNK6aiMesh15HasVertexColorsEj.exit178.2
...
_ZNK6aiMesh15HasVertexColorsEj.exit178.3:         ; preds = %bb.az, %_ZNK6aiMesh15HasVertexColorsEj.exit178.2
  %i.pf = phi i32 [ %.pre397, %bb.az ], [ %i.oy, %_ZNK6aiMesh15HasVertexColorsEj.exit178.2 ] ; 2 uses
  ...
  br i1 %i.pi, label %bb.ba, label %_ZNK6aiMesh15HasVertexColorsEj.exit178.4

bb.ba:                                            ; preds = %_ZNK6aiMesh15HasVertexColorsEj.exit178.3
...
_ZNK6aiMesh15HasVertexColorsEj.exit178.4:         ; preds = %bb.ba, %_ZNK6aiMesh15HasVertexColorsEj.exit178.3
  %i.pm = phi i32 [ %.pre398, %bb.ba ], [ %i.pf, %_ZNK6aiMesh15HasVertexColorsEj.exit178.3 ] ; 2 uses
  ...
  br i1 %i.pp, label %bb.bb, label %_ZNK6aiMesh15HasVertexColorsEj.exit178.5

bb.bb:                                            ; preds = %_ZNK6aiMesh15HasVertexColorsEj.exit178.4
...
_ZNK6aiMesh15HasVertexColorsEj.exit178.5:         ; preds = %bb.bb, %_ZNK6aiMesh15HasVertexColorsEj.exit178.4
  %i.pt = phi i32 [ %.pre399, %bb.bb ], [ %i.pm, %_ZNK6aiMesh15HasVertexColorsEj.exit178.4 ] ; 2 uses
  ...
  br i1 %i.pw, label %bb.bc, label %_ZNK6aiMesh15HasVertexColorsEj.exit178.6

bb.bc:                                            ; preds = %_ZNK6aiMesh15HasVertexColorsEj.exit178.5
...
_ZNK6aiMesh15HasVertexColorsEj.exit178.6:         ; preds = %bb.bc, %_ZNK6aiMesh15HasVertexColorsEj.exit178.5
  %i.qa = phi i32 [ %.pre400, %bb.bc ], [ %i.pt, %_ZNK6aiMesh15HasVertexColorsEj.exit178.5 ] ; 2 uses
  ...
  br i1 %i.qd, label %bb.bd, label %_ZNK6aiMesh15HasVertexColorsEj.exit178.7

bb.bd:                                            ; preds = %_ZNK6aiMesh15HasVertexColorsEj.exit178.6
...
_ZNK6aiMesh15HasVertexColorsEj.exit178.7:         ; preds = %bb.bd, %_ZNK6aiMesh15HasVertexColorsEj.exit178.6
  %i.qh = phi i32 [ %.pre401, %bb.bd ], [ %i.qa, %_ZNK6aiMesh15HasVertexColorsEj.exit178.6 ]
  ...
  br i1 %i.qk, label %bb.be, label %_ZNK6aiMesh15HasVertexColorsEj.exit178.7.thread

bb.be:                                            ; preds = %_ZNK6aiMesh15HasVertexColorsEj.exit178.7
...
_ZNK6aiMesh15HasVertexColorsEj.exit178.7.thread:  ; preds = %_ZNK6aiMesh24HasTangentsAndBitangentsEv.exit172, %bb.be, %_ZNK6aiMesh15HasVertexColorsEj.exit178.7
  %indvars.iv.next380 = add nuw nsw i64 %indvars.iv379, 1 ; 2 uses
  %exitcond382.not = icmp eq i64 %indvars.iv.next380, %i.km
  br i1 %exitcond382.not, label %._crit_edge324, label %.lr.ph323, !llvm.loop !17

bb.bf:                                            ; preds = %_ZNSt6vectorISt4pairIP6aiMeshjESaIS3_EE12emplace_backIJRS2_RjEEERS3_DpOT_.exit
...
bb.bg:                                            ; preds = %bb.a
  ...
  br i1 %.not.i179, label %bb.bi, label %bb.bh
...
bb.bi:                                            ; preds = %bb.bg
  ...
  br i1 %i.qz, label %bb.bj, label %_ZNKSt6vectorISt4pairIP6aiMeshjESaIS3_EE12_M_check_lenEmPKc.exit.i.i180

bb.bj:                                            ; preds = %bb.bi
  tail call void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.11) #18
  unreachable

_ZNKSt6vectorISt4pairIP6aiMeshjESaIS3_EE12_M_check_lenEmPKc.exit.i.i180: ; preds = %bb.bi
...
.lr.ph.i.i.i.i.i184:                              ; preds = %_ZNKSt6vectorISt4pairIP6aiMeshjESaIS3_EE12_M_check_lenEmPKc.exit.i.i180, %.lr.ph.i.i.i.i.i184
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.012.i.i.i.i.i185, ptr noundef nonnull align 8 dereferenceable(16) %.0911.i.i.i.i.i186, i64 16, i1 false), !alias.scope !18
  ...
  br i1 %.not.i.i.i.i.i187, label %_ZNSt6vectorISt4pairIP6aiMeshjESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit33.i.i188, label %.lr.ph.i.i.i.i.i184, !llvm.loop !14
...
_ZNSt6vectorISt4pairIP6aiMeshjESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit33.i.i188: ; preds = %.lr.ph.i.i.i.i.i184, %_ZNKSt6vectorISt4pairIP6aiMeshjESaIS3_EE12_M_check_lenEmPKc.exit.i.i180
  ...
  br i1 %.not.i34.i.i190, label %_ZNSt6vectorISt4pairIP6aiMeshjESaIS3_EE17_M_realloc_insertIJRS2_RjEEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i191, label %bb.bk

bb.bk:                                            ; preds = %_ZNSt6vectorISt4pairIP6aiMeshjESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit33.i.i188
...
_ZNSt6vectorISt4pairIP6aiMeshjESaIS3_EE17_M_realloc_insertIJRS2_RjEEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i191: ; preds = %bb.bk, %_ZNSt6vectorISt4pairIP6aiMeshjESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit33.i.i188
...
_ZNSt6vectorISt4pairIP6aiMeshjESaIS3_EE12emplace_backIJRS2_RjEEERS3_DpOT_.exit192: ; preds = %_ZNSt6vectorISt4pairIP6aiMeshjESaIS3_EE17_M_realloc_insertIJRS2_RjEEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i191, %bb.bh, %bb.bf
  ret void
}
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.preheader52
  ...
  %i.w = icmp samesign ult i64 %indvars.iv.next, %i.v
  br i1 %i.w, label %.preheader52, label %._crit_edge77, !llvm.loop !22
...
_ZNSt6vectorIjSaIjEE9push_backERKj.exit:          ; preds = %_ZNSt6vectorIjSaIjEE17_M_realloc_insertIJRKjEEEvN9__gnu_cxx17__normal_iteratorIPjS1_EEDpOT_.exit.i, %bb.f, %.lr.ph
  ...
  br i1 %i.be, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !23
...
.lr.ph83:                                         ; preds = %bb.m, %.lr.ph83
  ...
  br i1 %i.bv, label %.lr.ph83, label %.preheader, !llvm.loop !24
...
bb.p:                                             ; preds = %bb.o
  ...
  br i1 %i.cd, label %bb.o, label %._crit_edge86, !llvm.loop !25
...
bb.ba:                                            ; preds = %_ZNSt13unordered_setIPK6aiBoneSt4hashIS2_ESt8equal_toIS2_ESaIS2_EE6insertERKS2_.exit, %.lr.ph
  ...
  br i1 %i.dg, label %.lr.ph, label %._crit_edge, !llvm.loop !26
...
.lr.ph.i.i.i.i:                                   ; preds = %bb.bf, %.lr.ph.i.i.i.i
  ...
  br i1 %.not.i.i.i.i, label %_ZNSt10_HashtableIPK6aiBoneS2_SaIS2_ENSt8__detail9_IdentityESt8equal_toIS2_ESt4hashIS2_ENS4_18_Mod_range_hashingENS4_20_Default_ranged_hashENS4_20_Prime_rehash_policyENS4_17_Hashtable_traitsILb0ELb1ELb1EEEE5clearEv.exit.i.i, label %.lr.ph.i.i.i.i, !llvm.loop !27
...
bb.bk:                                            ; preds = %.lr.ph58, %bb.bj
  ...
  br i1 %i.el, label %.lr.ph58, label %._crit_edge59, !llvm.loop !28
...
bb.c:                                             ; preds = %bb.d
  ...
  br i1 %exitcond.not, label %.lr.ph44, label %bb.d, !llvm.loop !29
...
.critedge:                                        ; preds = %bb.e
  ...
  br i1 %i.ab, label %bb.e, label %.critedge._crit_edge.loopexit, !llvm.loop !30
...
.lr.ph46:                                         ; preds = %bb.j, %.lr.ph46
  ...
  br i1 %i.av, label %.lr.ph46, label %._crit_edge, !llvm.loop !31
...
bb.bf:                                            ; preds = %bb.bf, %.epil.preheader
  ...
  br i1 %epil.iter.cmp.not, label %._crit_edge, label %bb.bf, !llvm.loop !32
...
bb.bg:                                            ; preds = %bb.bg, %.lr.ph333.new
  ...
  br i1 %niter.ncmp.3, label %._crit_edge.loopexit.unr-lcssa, label %bb.bg, !llvm.loop !33
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load495 = load <2 x i64>, ptr %i.uc, align 4, !alias.scope !37, !noalias !34
  %i.ud = getelementptr i8, ptr %next.gep, i64 16
  store <2 x i64> %wide.load, ptr %next.gep, align 4, !alias.scope !34, !noalias !37
  store <2 x i64> %wide.load495, ptr %i.ud, align 4, !alias.scope !34, !noalias !37
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ue = icmp eq i64 %index.next, %n.vec
  br i1 %i.ue, label %middle.block, label %vector.body, !llvm.loop !39
...
.lr.ph.i.i.i.i.i.i:                               ; preds = %.lr.ph.i.i.i.i.i.i.preheader497, %.lr.ph.i.i.i.i.i.i
  ...
  call void @llvm.experimental.noalias.scope.decl(metadata !34)
  call void @llvm.experimental.noalias.scope.decl(metadata !37)
  %i.uf = load i64, ptr %.0911.i.i.i.i.i.i, align 4, !alias.scope !37, !noalias !34
  store i64 %i.uf, ptr %.012.i.i.i.i.i.i, align 4, !alias.scope !34, !noalias !37
...
.lr.ph.i.i.i.i.i:                                 ; preds = %.noexc186, %.lr.ph.i.i.i.i.i
  ...
  br i1 %.not.i.i.i.i.i, label %_ZNSt6vectorISt4pairIP6aiMeshjESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit33.i.i, label %.lr.ph.i.i.i.i.i, !llvm.loop !14
...
.lr.ph.i.i.i.i.i199:                              ; preds = %_ZNKSt6vectorISt4pairIP6aiMeshjESaIS3_EE12_M_check_lenEmPKc.exit.i.i195, %.lr.ph.i.i.i.i.i199
  ...
  br i1 %.not.i.i.i.i.i202, label %_ZNSt6vectorISt4pairIP6aiMeshjESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit33.i.i203, label %.lr.ph.i.i.i.i.i199, !llvm.loop !14
...
!9 = distinct !{!9, !4}
!10 = !{!11, !13}
!11 = distinct !{!11, !12, !"_ZSt19__relocate_object_aISt4pairIP6aiMeshjES3_SaIS3_EEvPT_PT0_RT1_: argument 0"}
!12 = distinct !{!12, !"_ZSt19__relocate_object_aISt4pairIP6aiMeshjES3_SaIS3_EEvPT_PT0_RT1_"}
!13 = distinct !{!13, !12, !"_ZSt19__relocate_object_aISt4pairIP6aiMeshjES3_SaIS3_EEvPT_PT0_RT1_: argument 1"}
!14 = distinct !{!14, !4}
!15 = distinct !{!15, !4}
!16 = distinct !{!16, !4}
!17 = distinct !{!17, !4}
!18 = !{!19, !21}
!19 = distinct !{!19, !20, !"_ZSt19__relocate_object_aISt4pairIP6aiMeshjES3_SaIS3_EEvPT_PT0_RT1_: argument 0"}
!20 = distinct !{!20, !"_ZSt19__relocate_object_aISt4pairIP6aiMeshjES3_SaIS3_EEvPT_PT0_RT1_"}
!21 = distinct !{!21, !20, !"_ZSt19__relocate_object_aISt4pairIP6aiMeshjES3_SaIS3_EEvPT_PT0_RT1_: argument 1"}
!22 = distinct !{!22, !4}
!23 = distinct !{!23, !4}
!24 = distinct !{!24, !4}
!25 = distinct !{!25, !4}
...
!33 = distinct !{!33, !4}
!34 = !{!35}
!35 = distinct !{!35, !36, !"_ZSt19__relocate_object_aI14aiVertexWeightS0_SaIS0_EEvPT_PT0_RT1_: argument 0"}
!36 = distinct !{!36, !"_ZSt19__relocate_object_aI14aiVertexWeightS0_SaIS0_EEvPT_PT0_RT1_"}
!37 = !{!38}
!38 = distinct !{!38, !36, !"_ZSt19__relocate_object_aI14aiVertexWeightS0_SaIS0_EEvPT_PT0_RT1_: argument 1"}
!39 = distinct !{!39, !4, !40, !41}
...
!61 = distinct !{!61, !4, !40, !41}
!62 = distinct !{!62, !4, !41, !40}
!63 = distinct !{!63, !4, !40, !41}
!64 = distinct !{!64, !4, !41, !40}
!65 = distinct !{!65, !4, !40, !41}
!66 = distinct !{!66, !4, !41, !40}
!67 = distinct !{!67, !4, !40, !41}
!68 = distinct !{!68, !4, !41, !40}
!69 = distinct !{!69, !4}
end_hunk_5
