...
.lr.ph:                                           ; preds = %.loopexit278
  ...
  %i.db = icmp ult i32 %4, 8
  br i1 %i.db, label %scalar.ph.preheader, label %.epil.preheader

.epil.preheader:                                  ; preds = %.lr.ph
  %5 = zext i32 %4 to i64
...
bb.g:                                             ; preds = %bb.g, %.epil.preheader
  %indvars.iv354.epil = phi i64 [ 0, %.epil.preheader ], [ %index.next, %bb.g ] ; 2 uses
  %vec.phi = phi <4 x i32> [ zeroinitializer, %.epil.preheader ], [ %42, %bb.g ]
  %vec.phi465 = phi <4 x i32> [ zeroinitializer, %.epil.preheader ], [ %43, %bb.g ]
  %10 = add i64 %indvars.iv354.epil, %i.cz        ; 8 uses
  ...
  %i.dc = getelementptr [16 x i8], ptr %i.cy, i64 %10
  %24 = getelementptr i8, ptr %i.dc, i64 112
  ...
  %39 = insertelement <4 x i32> %38, i32 %i.dd, i64 3
  %40 = freeze <4 x i32> %32
  %41 = freeze <4 x i32> %39
  %42 = add <4 x i32> %40, %vec.phi               ; 2 uses
  %43 = add <4 x i32> %41, %vec.phi465            ; 2 uses
  %index.next = add nuw i64 %indvars.iv354.epil, 8 ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %index.next, %n.vec
  br i1 %epil.iter.cmp.not, label %middle.block, label %bb.g, !llvm.loop !8

middle.block:                                     ; preds = %bb.g
...
._crit_edge:                                      ; preds = %bb.h, %.loopexit278
  %.0120.lcssa = phi i32 [ 0, %.loopexit278 ], [ %i.dh, %bb.h ] ; 8 uses
  store i32 %.0120.lcssa, ptr %i.ay, align 4
  %i.de = load ptr, ptr %i.q, align 8
  %.not = icmp eq ptr %i.de, null
  br i1 %.not, label %bb.j, label %bb.i

bb.h:                                             ; preds = %scalar.ph.preheader, %bb.h
  %indvars.iv354 = phi i64 [ %indvars.iv.next355.3, %bb.h ], [ %indvars.iv354.ph, %scalar.ph.preheader ] ; 2 uses
  %niter = phi i32 [ %i.dh, %bb.h ], [ %.0120299.ph, %scalar.ph.preheader ]
  %i.df = getelementptr inbounds nuw [16 x i8], ptr %i.cy, i64 %indvars.iv354
  %i.dg = load i32, ptr %i.df, align 8
  %.fr.3 = freeze i32 %i.dg
  %i.dh = add i32 %.fr.3, %niter                  ; 2 uses
  %indvars.iv.next355.3 = add nuw nsw i64 %indvars.iv354, 1 ; 2 uses
  %lftr.wideiv = trunc i64 %indvars.iv.next355.3 to i32
  %niter.ncmp.3 = icmp eq i32 %i.da, %lftr.wideiv
  br i1 %niter.ncmp.3, label %._crit_edge, label %bb.h, !llvm.loop !11
...
_ZNSt6vectorISt4pairIP6aiMeshjESaIS3_EE12emplace_backIJRS2_RjEEERS3_DpOT_.exit: ; preds = %bb.ae, %_ZNSt6vectorISt4pairIP6aiMeshjESaIS3_EE17_M_realloc_insertIJRS2_RjEEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i
  ...
  br i1 %i.jx, label %bb.c, label %bb.bf, !llvm.loop !17
...
._crit_edge324:                                   ; preds = %_ZNK6aiMesh15HasVertexColorsEj.exit178.7.thread, %bb.aj
  ...
  br i1 %i.kz, label %bb.ai, label %._crit_edge329, !llvm.loop !18
