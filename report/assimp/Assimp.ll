...
_ZN12aiMatrix3x3tIfEixEj.exit.2:                  ; preds = %bb.d, %bb.c, %bb.e
  ...
  %3 = extractelement <2 x float> %i.ag, i64 1
  %4 = extractelement <2 x float> %i.ag, i64 0    ; 4 uses
  %5 = shufflevector <2 x float> %i.ag, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %i.al = insertelement <2 x float> %5, float %.sroa.0.0, i64 0
  %6 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %i.h, i64 0
  %7 = fsub <2 x float> %i.al, %6                 ; 6 uses
  %8 = shufflevector <2 x float> %7, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
  %9 = extractelement <2 x float> %7, i64 0
  %10 = shufflevector <4 x float> %i.af, <4 x float> %i.ah, <2 x i32> <i32 2, i32 4> ; 2 uses
  %11 = fmul <2 x float> %10, %10
  %12 = shufflevector <2 x float> %7, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %13 = shufflevector <4 x float> %i.af, <4 x float> %12, <2 x i32> <i32 1, i32 4> ; 2 uses
  %14 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %13, <2 x float> %13, <2 x float> %11)
  %15 = shufflevector <4 x float> %i.af, <4 x float> %i.ah, <2 x i32> <i32 0, i32 5> ; 2 uses
  %16 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %15, <2 x float> %15, <2 x float> %14)
  %17 = fdiv <2 x float> splat (float 2.000000e+00), %16 ; 3 uses
  %18 = extractelement <2 x float> %17, i64 0     ; 2 uses
  %i.am = fneg float %18                          ; 2 uses
  %19 = extractelement <2 x float> %17, i64 1     ; 2 uses
  %i.an = fmul float %18, %19
  %20 = fmul float %i.ai, %4
  %21 = tail call float @llvm.fmuladd.f32(float %i.aj, float %9, float %20)
  %i.ao = tail call noundef float @llvm.fmuladd.f32(float %i.ak, float %3, float %21)
  %i.ap = fmul float %i.ao, %i.an                 ; 2 uses
  %22 = shufflevector <4 x float> %i.af, <4 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 2>
  %23 = insertelement <4 x float> poison, float %i.am, i64 0
  %24 = shufflevector <4 x float> %23, <4 x float> poison, <4 x i32> zeroinitializer ; 2 uses
  %25 = fmul <4 x float> %22, %24
  %26 = shufflevector <2 x float> %17, <2 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1> ; 2 uses
  %27 = shufflevector <2 x float> %7, <2 x float> %i.ag, <4 x i32> <i32 0, i32 0, i32 0, i32 2>
  %28 = fmul <4 x float> %26, %27
  %29 = shufflevector <2 x float> %i.ag, <2 x float> %7, <4 x i32> <i32 1, i32 2, i32 0, i32 2>
  %30 = fneg <4 x float> %29
  %31 = fmul <4 x float> %28, %30
  %32 = shufflevector <4 x float> %i.af, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 1> ; 2 uses
  %33 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %25, <4 x float> %32, <4 x float> %31)
  %34 = insertelement <4 x float> poison, float %i.ap, i64 0
  %35 = shufflevector <4 x float> %34, <4 x float> poison, <4 x i32> zeroinitializer ; 2 uses
  %36 = fmul <4 x float> %35, %8
  %37 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %36, <4 x float> %32, <4 x float> %33)
  %38 = shufflevector <4 x float> %37, <4 x float> poison, <4 x i32> <i32 1, i32 2, i32 0, i32 3>
  store <4 x float> %38, ptr %2, align 4
  %39 = load float, ptr %2, align 4
  %40 = fadd float %39, 1.000000e+00
  store float %40, ptr %2, align 4
  %41 = fmul float %i.ai, %i.am
  %42 = fmul float %19, %4
  %43 = fneg float %4
  %44 = fmul float %42, %43
  %45 = tail call float @llvm.fmuladd.f32(float %41, float %i.ai, float %44)
  %46 = fmul float %i.ap, %4
  %47 = tail call float @llvm.fmuladd.f32(float %46, float %i.ai, float %45)
  ...
  %i.au = fmul <4 x float> %i.at, %24
  %i.av = fmul <4 x float> %26, %i.ah
  %48 = shufflevector <2 x float> %i.ag, <2 x float> %7, <4 x i32> <i32 1, i32 2, i32 0, i32 1>
  %i.aw = fneg <4 x float> %48
  %i.ax = fmul <4 x float> %i.av, %i.aw
  %i.ay = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.au, <4 x float> %i.af, <4 x float> %i.ax)
  %i.az = fmul <4 x float> %35, %i.ah
