...
begin_hunk_0_@_ZL26stbi__create_png_image_rawP9stbi__pngPhjijjii:bb.a
  ...
  %n.vec509 = and i64 %i.bm, 4294967288           ; 4 uses
  %i.cj = shl nuw nsw i64 %n.vec509, 1            ; 2 uses
...
vector.ph507:                                     ; preds = %.lr.ph382.preheader
  ...
  %i.xn = getelementptr i8, ptr %i.ed, i64 %i.cj
  br label %vector.body510

vector.body510:                                   ; preds = %vector.body510, %vector.ph507
  %index511 = phi i64 [ 0, %vector.ph507 ], [ %index.next522, %vector.body510 ] ; 2 uses
  %offset.idx512 = shl i64 %index511, 1           ; 9 uses
  %next.gep = getelementptr i8, ptr %i.em, i64 %offset.idx512
  %next.gep514.a = getelementptr i8, ptr %i.ed, i64 %offset.idx512 ; 2 uses
  %i.xo = getelementptr i8, ptr %i.ed, i64 %offset.idx512 ; 2 uses
  %next.gep515.a = getelementptr i8, ptr %i.xo, i64 2
  %i.xp = getelementptr i8, ptr %i.ed, i64 %offset.idx512 ; 2 uses
  %next.gep516.a = getelementptr i8, ptr %i.xp, i64 4
  %i.xq = getelementptr i8, ptr %i.ed, i64 %offset.idx512 ; 2 uses
  %next.gep517.a = getelementptr i8, ptr %i.xq, i64 6
  %i.xr = getelementptr i8, ptr %i.ed, i64 %offset.idx512 ; 2 uses
  %next.gep518.a = getelementptr i8, ptr %i.xr, i64 8
  %i.xs = getelementptr i8, ptr %i.ed, i64 %offset.idx512 ; 2 uses
  %next.gep519.a = getelementptr i8, ptr %i.xs, i64 10
  %i.xt = getelementptr i8, ptr %i.ed, i64 %offset.idx512 ; 2 uses
  %next.gep520 = getelementptr i8, ptr %i.xt, i64 12
  %i.xu = getelementptr i8, ptr %i.ed, i64 %offset.idx512 ; 2 uses
