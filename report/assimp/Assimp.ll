...
begin_hunk_0_@aiIdentityMatrix4:bb.a
bb.a:
  ...
  ret void
end_hunk_0
begin_hunk_1_@aiMatrix4FromMatrix3:bb.a
  ...
  ret void
end_hunk_1
begin_hunk_2_@aiMatrix4RotationX:bb.a
bb.a:
  store float 1.000000e+00, ptr %0, align 4
...
end_hunk_2
begin_hunk_3_@aiMatrix4RotationY
...
bb.a:
  ...
  %i.a = tail call noundef float @cosf(float noundef %1) #47 ; 2 uses
end_hunk_3
begin_hunk_4_@aiMatrix4RotationY:bb.a
...
bb.a:
  ...
  %i.a = tail call noundef float @cosf(float noundef %1) #47 ; 2 uses
end_hunk_4
begin_hunk_5_@aiMatrix4Translation:bb.a
bb.a:
  store float 1.000000e+00, ptr %0, align 4
  %.sroa.4.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %0, i64 4
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %.sroa.4.0..sroa_idx.i, i8 0, i64 16, i1 false)
...
end_hunk_5
begin_hunk_6_@aiMatrix4Scaling:bb.a
bb.a:
  store float 1.000000e+00, ptr %0, align 4
  %.sroa.4.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %0, i64 4
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %.sroa.4.0..sroa_idx.i, i8 0, i64 16, i1 false)
  ...
  %i.a = load float, ptr %1, align 4
end_hunk_6
begin_hunk_7_@aiMatrix4FromTo:bb.a
