...
begin_hunk_0_@aiMultiplyMatrix3:bb.a
  ...
  %i.f = load float, ptr %.sroa.10.0..sroa_idx8, align 4
  %6 = load <2 x float>, ptr %.sroa.12.0..sroa_idx10, align 4 ; 2 uses
  %7 = load <4 x float>, ptr %1, align 4, !noalias !12 ; 3 uses
  %i.g = load float, ptr %i.a, align 4, !noalias !12
  %8 = load <4 x float>, ptr %i.d, align 4, !noalias !12 ; 3 uses
  %i.h = load float, ptr %2, align 4, !noalias !12 ; 2 uses
  %i.i = shufflevector <2 x float> %6, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 2 uses
  %i.j = shufflevector <4 x float> %5, <4 x float> %i.i, <4 x i32> <i32 1, i32 1, i32 1, i32 4>
  %9 = shufflevector <4 x float> %7, <4 x float> %8, <4 x i32> <i32 3, i32 4, i32 5, i32 3>
  %10 = fmul <4 x float> %i.j, %9
  ...
  %i.k = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %11, <4 x float> %12, <4 x float> %10)
  ...
  %15 = shufflevector <4 x float> %5, <4 x float> %i.i, <4 x i32> <i32 2, i32 2, i32 2, i32 5>
  %16 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %14, <4 x float> %15, <4 x float> %i.k)
  ...
  %20 = shufflevector <4 x float> %i.l, <4 x float> poison, <2 x i32> <i32 poison, i32 2>
  ...
  %23 = insertelement <4 x float> %22, float %i.g, i64 1
  %i.m = insertelement <4 x float> %23, float %i.h, i64 2
  %24 = fmul <4 x float> %21, %i.m
  ...
  %i.o = insertelement <2 x float> %i.n, float %i.f, i64 0
  %i.p = shufflevector <2 x float> %i.o, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %i.q = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %26, <4 x float> %i.p, <4 x float> %24)
  ...
  %i.s = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %31, <4 x float> %i.r, <4 x float> %i.q)
  %i.t = fmul float %.sroa.18.0.copyload17, %i.h
  %i.u = tail call float @llvm.fmuladd.f32(float %18, float %.sroa.16.0.copyload15, float %i.t)
  %i.v = tail call float @llvm.fmuladd.f32(float %4, float %.sroa.20.0.copyload19, float %i.u)
