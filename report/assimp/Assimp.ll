...
bb.a:
  ...
  %4 = load float, ptr %3, align 4                ; 4 uses
  %5 = load float, ptr %i.l, align 4              ; 4 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %8 = insertelement <4 x float> %i.ax, float %6, i64 2
  %9 = insertelement <4 x float> %8, float %7, i64 3 ; 2 uses
  %i.ay = fdiv <4 x float> %9, %i.au
  %i.az = fmul <4 x float> %9, %i.au
...
bb.f:                                             ; preds = %bb.e
  ...
  %10 = fadd float %5, %i.m
  %11 = fadd float %i.q, %i.s
  %i.bh = fsub float %4, %i.t
  %i.bi = insertelement <4 x float> <float poison, float poison, float 2.500000e-01, float poison>, float %i.bh, i64 0
  %12 = insertelement <4 x float> %i.bi, float %10, i64 1
  %13 = insertelement <4 x float> %12, float %11, i64 3 ; 2 uses
  ...
  %i.bl = fdiv <4 x float> %13, %i.bk
  %i.bm = fmul <4 x float> %13, %i.bk
...
bb.g:                                             ; preds = %bb.e
  ...
  %i.bt = fadd float %4, %i.t
  %i.bu = fadd float %i.q, %i.s
  %i.bv = fsub float %i.m, %5
