...
; Function Attrs: mustprogress uwtable
define hidden noundef ptr @assimp_stbi_loadf_from_memory(ptr noundef %0, i32 noundef %1, ptr noundef captures(none) %2, ptr noundef captures(none) %3, ptr noundef captures(address_is_null) %4, i32 noundef %5) local_unnamed_addr #2 {
bb.a:
  %6 = alloca %struct.stbi__context, align 8      ; 10 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #47
  %i.a = getelementptr inbounds nuw i8, ptr %6, i64 16
...
; Function Attrs: mustprogress uwtable
define internal fastcc noundef ptr @_ZL16stbi__loadf_mainP13stbi__contextPiS1_S1_i(ptr noundef nonnull %0, ptr noundef captures(none) %1, ptr noundef captures(none) %2, ptr noundef captures(address_is_null) %3, i32 noundef %4) unnamed_addr #2 {
bb.a:
...
.preheader48.lr.ph.i:                             ; preds = %bb.g
  ...
  %i.y = load float, ptr @_ZL15stbi__l2h_gamma, align 4 ; 3 uses
  %i.z = load float, ptr @_ZL15stbi__l2h_scale, align 4 ; 3 uses
...
.preheader48.us.i:                                ; preds = %._crit_edge.us.i, %.preheader48.us.preheader.i
  ...
  %i.ac = mul nsw i64 %indvars.iv55.i, %i.aa      ; 3 uses
  br i1 %i.ab, label %.epil.preheader, label %.preheader48.us.i.new
...
.preheader48.us.i.new:                            ; preds = %.preheader48.us.i, %.preheader48.us.i.new
  ...
  %i.ai = tail call noundef float @powf(float noundef %i.ah, float noundef %i.y) #47
  %i.aj = fmul float %i.z, %i.ai
  %i.ak = getelementptr inbounds [4 x i8], ptr %i.r, i64 %i.ad
  store float %i.aj, ptr %i.ak, align 4
  %indvars.iv.next.i = or disjoint i64 %indvars.iv.i, 1
  %i.al = add nsw i64 %indvars.iv.next.i, %i.ac   ; 2 uses
  %i.am = getelementptr inbounds i8, ptr %i.a, i64 %i.al
  %i.an = load i8, ptr %i.am, align 1
  %i.ao = uitofp i8 %i.an to float
  %i.ap = fdiv float %i.ao, 2.550000e+02
  %i.aq = tail call noundef float @powf(float noundef %i.ap, float noundef %i.y) #47
  %i.ar = fmul float %i.z, %i.aq
  %i.as = getelementptr inbounds [4 x i8], ptr %i.r, i64 %i.al
...
.epil.preheader:                                  ; preds = %._crit_edge.us.i.unr-lcssa, %.preheader48.us.i
  ...
  %i.at = add nsw i64 %indvars.iv.i.epil.init, %i.ac ; 2 uses
  %i.au = getelementptr inbounds i8, ptr %i.a, i64 %i.at
  %i.av = load i8, ptr %i.au, align 1
  %i.aw = uitofp i8 %i.av to float
  %i.ax = fdiv float %i.aw, 2.550000e+02
  %i.ay = tail call noundef float @powf(float noundef %i.ax, float noundef %i.y) #47
  %i.az = fmul float %i.z, %i.ay
  %i.ba = getelementptr inbounds [4 x i8], ptr %i.r, i64 %i.at
...
.lr.ph.i:                                         ; preds = %.lr.ph.i, %.lr.ph.preheader.i.new
  ...
  %i.be = mul nsw i64 %indvars.iv60.i, %i.bb
  %i.bf = add nsw i64 %i.be, %i.bc                ; 2 uses
  %i.bg = getelementptr inbounds i8, ptr %i.a, i64 %i.bf
  %i.bh = load i8, ptr %i.bg, align 1
  %i.bi = uitofp i8 %i.bh to float
  %i.bj = fdiv float %i.bi, 2.550000e+02
  %i.bk = getelementptr inbounds [4 x i8], ptr %i.r, i64 %i.bf
  store float %i.bj, ptr %i.bk, align 4
  %indvars.iv.next61.i = or disjoint i64 %indvars.iv60.i, 1
  %i.bl = mul nsw i64 %indvars.iv.next61.i, %i.bb
  %i.bm = add nsw i64 %i.bl, %i.bc                ; 2 uses
  %i.bn = getelementptr inbounds i8, ptr %i.a, i64 %i.bm
  %i.bo = load i8, ptr %i.bn, align 1
  %i.bp = uitofp i8 %i.bo to float
  %i.bq = fdiv float %i.bp, 2.550000e+02
  %i.br = getelementptr inbounds [4 x i8], ptr %i.r, i64 %i.bm
...
.lr.ph.i.epil.preheader:                          ; preds = %.loopexit.i.loopexit.unr-lcssa, %.lr.ph.preheader.i
  ...
  %i.bs = mul nsw i64 %indvars.iv60.i.epil.init, %i.bb
  %i.bt = add nsw i64 %i.bs, %i.bc                ; 2 uses
  %i.bu = getelementptr inbounds i8, ptr %i.a, i64 %i.bt
  %i.bv = load i8, ptr %i.bu, align 1
  %i.bw = uitofp i8 %i.bv to float
  %i.bx = fdiv float %i.bw, 2.550000e+02
  %i.by = getelementptr inbounds [4 x i8], ptr %i.r, i64 %i.bt
...
bb.h:                                             ; preds = %bb.a
  %i.bz = tail call align 8 ptr @llvm.threadlocal.address.p0(ptr align 8 @_ZL22stbi__g_failure_reason)
  store ptr @.str.5, ptr %i.bz, align 8
  br label %_ZL16stbi__ldr_to_hdrPhiii.exit
