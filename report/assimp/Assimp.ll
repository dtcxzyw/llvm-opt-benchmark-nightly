...
_ZN12aiMatrix3x3tIfEixEj.exit.2:                  ; preds = %bb.d, %bb.c, %bb.e
  ...
  %i.ag = fsub <2 x float> %i.aa, %i.g            ; 6 uses
  ...
  %i.aq = fsub <2 x float> %i.ao, %i.ap           ; 5 uses
  %i.ar = shufflevector <2 x float> %i.aq, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1> ; 2 uses
