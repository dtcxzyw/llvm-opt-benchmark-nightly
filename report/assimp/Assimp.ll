...
begin_hunk_0_@aiMultiplyMatrix3:bb.a
  ...
  %.sroa.10.0.copyload9.a = load float, ptr %i.c, align 4, !noalias !12
  ...
  %i.f = load float, ptr %i.d, align 4, !noalias !12
  ...
  %i.g = load float, ptr %i.e, align 4, !noalias !12
  %i.h = shufflevector <2 x float> %3, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 2 uses
  %i.i = shufflevector <4 x float> %2, <4 x float> %i.h, <4 x i32> <i32 1, i32 1, i32 1, i32 4>
  %10 = fmul <4 x float> %i.i, %7
  ...
  %13 = shufflevector <4 x float> %2, <4 x float> %i.h, <4 x i32> <i32 2, i32 2, i32 2, i32 5>
  %i.j = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %9, <4 x float> %13, <4 x float> %12)
  ...
  %19 = insertelement <4 x float> %18, float %i.f, i64 3 ; 2 uses
  %20 = shufflevector <4 x float> %19, <4 x float> %i.k, <4 x i32> <i32 3, i32 6, i32 poison, i32 6>
  ...
  %i.l = insertelement <4 x float> poison, float %.sroa.10.0.copyload9.a, i64 0
  %24 = shufflevector <4 x float> %i.l, <4 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 0>
  ...
  %i.n = insertelement <2 x float> %i.m, float %.sroa.10.0.copyload9, i64 0
  %i.o = shufflevector <2 x float> %i.n, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %i.p = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %25, <4 x float> %i.o, <4 x float> %22)
  %26 = shufflevector <3 x float> %8, <3 x float> poison, <4 x i32> <i32 poison, i32 0, i32 2, i32 poison>
  %27 = insertelement <4 x float> poison, float %i.g, i64 0
  ...
  %i.r = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %29, <4 x float> %i.q, <4 x float> %i.p)
  %i.s = fmul float %.sroa.18.0.copyload17, %14
  %i.t = tail call float @llvm.fmuladd.f32(float %15, float %.sroa.16.0.copyload15, float %i.s)
  %i.u = tail call float @llvm.fmuladd.f32(float %16, float %.sroa.20.0.copyload19, float %i.t)
