...
bb.a:
  ...
  %i.b = load <2 x float>, ptr %0, align 4        ; 8 uses
  %i.c = extractelement <2 x float> %i.b, i64 1   ; 2 uses
  %4 = extractelement <2 x float> %i.b, i64 0
  %i.d = load float, ptr %i.a, align 4            ; 7 uses
  %i.e = load <2 x float>, ptr %3, align 4        ; 4 uses
  %i.f = load float, ptr %1, align 4              ; 4 uses
  %i.g = extractelement <2 x float> %i.e, i64 0   ; 2 uses
  %i.h = fmul float %i.c, %i.g
  %5 = tail call float @llvm.fmuladd.f32(float %4, float %i.f, float %i.h)
  %6 = extractelement <2 x float> %i.e, i64 1     ; 3 uses
  %i.i = tail call noundef float @llvm.fmuladd.f32(float %i.d, float %6, float %5) ; 4 uses
  %i.j = tail call float @llvm.fabs.f32(float %i.i)
  %i.k = fcmp ogt float %i.j, f0x3F7FFF58
  br i1 %i.k, label %bb.b, label %bb.f

bb.b:                                             ; preds = %bb.a
  %7 = fcmp ogt <2 x float> %i.b, zeroinitializer
  %8 = fneg <2 x float> %i.b
  %9 = select <2 x i1> %7, <2 x float> %i.b, <2 x float> %8 ; 2 uses
  %i.l = fcmp ogt float %i.d, 0.000000e+00
  %i.m = fneg float %i.d
  %i.n = select i1 %i.l, float %i.d, float %i.m   ; 2 uses
  %10 = extractelement <2 x float> %9, i64 0      ; 2 uses
  %11 = extractelement <2 x float> %9, i64 1      ; 2 uses
  %i.o = fcmp olt float %10, %11
  br i1 %i.o, label %bb.c, label %bb.e

bb.c:                                             ; preds = %bb.b
  %i.p = fcmp olt float %10, %i.n
...
_ZN12aiMatrix3x3tIfEixEj.exit.2:                  ; preds = %bb.d, %bb.c, %bb.e
  ...
  %i.r = phi <2 x float> [ <float 1.000000e+00, float 0.000000e+00>, %bb.e ], [ <float 0.000000e+00, float 1.000000e+00>, %bb.d ], [ zeroinitializer, %bb.c ]
  %12 = phi <4 x float> [ <float 0.000000e+00, float 0.000000e+00, float 1.000000e+00, float 0.000000e+00>, %bb.e ], [ <float 1.000000e+00, float 0.000000e+00, float 0.000000e+00, float 1.000000e+00>, %bb.d ], [ <float 0.000000e+00, float 1.000000e+00, float 0.000000e+00, float 0.000000e+00>, %bb.c ]
  %i.s = insertelement <4 x float> poison, float %i.d, i64 0
  %13 = shufflevector <2 x float> %i.b, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %14 = shufflevector <4 x float> %i.s, <4 x float> %13, <4 x i32> <i32 0, i32 4, i32 5, i32 0>
  %15 = fsub <4 x float> %12, %14                 ; 11 uses
  %16 = fsub float %.sroa.0.0, %i.f               ; 9 uses
  %17 = fsub <2 x float> %i.r, %i.e               ; 5 uses
  %18 = shufflevector <2 x float> %17, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 1> ; 5 uses
  %i.t = extractelement <4 x float> %15, i64 1    ; 4 uses
  %i.u = extractelement <4 x float> %15, i64 0
  %i.v = extractelement <2 x float> %17, i64 1
  %19 = shufflevector <4 x float> %15, <4 x float> %18, <2 x i32> <i32 2, i32 4> ; 2 uses
  %i.w = fmul <2 x float> %19, %19
  %20 = shufflevector <4 x float> %15, <4 x float> poison, <2 x i32> <i32 1, i32 poison>
  %21 = insertelement <2 x float> %20, float %16, i64 1 ; 2 uses
  %22 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %21, <2 x float> %21, <2 x float> %i.w)
  %23 = shufflevector <4 x float> %15, <4 x float> %18, <2 x i32> <i32 0, i32 5> ; 2 uses
  %i.x = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %23, <2 x float> %23, <2 x float> %22)
  %i.y = fdiv <2 x float> splat (float 2.000000e+00), %i.x ; 3 uses
  ...
  %foldExtExtBinop = fmul <4 x float> %shift, %18
  %24 = extractelement <4 x float> %foldExtExtBinop, i64 0
  %i.ac = tail call float @llvm.fmuladd.f32(float %i.t, float %16, float %24)
  %i.ad = tail call noundef float @llvm.fmuladd.f32(float %i.u, float %i.v, float %i.ac)
  %i.ae = fmul float %i.ad, %i.ab                 ; 2 uses
  %i.af = fneg float %i.z                         ; 2 uses
  %i.ag = fmul float %i.t, %i.af
  %i.ah = fmul float %i.aa, %16
  %25 = fneg float %16
  %i.ai = fmul float %i.ah, %25
  %i.aj = tail call float @llvm.fmuladd.f32(float %i.ag, float %i.t, float %i.ai)
  %i.ak = fmul float %i.ae, %16
  ...
  %i.an = shufflevector <4 x float> %15, <4 x float> poison, <4 x i32> <i32 1, i32 2, i32 1, i32 2>
  %i.ao = insertelement <4 x float> poison, float %i.af, i64 0
  %i.ap = shufflevector <4 x float> %i.ao, <4 x float> poison, <4 x i32> zeroinitializer ; 2 uses
  %i.aq = fmul <4 x float> %i.an, %i.ap
  %i.ar = shufflevector <2 x float> %i.y, <2 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1> ; 2 uses
  %27 = shufflevector <2 x float> %17, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 0> ; 2 uses
  %i.as = insertelement <4 x float> poison, float %16, i64 0
  %28 = shufflevector <4 x float> %i.as, <4 x float> poison, <4 x i32> <i32 0, i32 poison, i32 0, i32 poison>
  %29 = shufflevector <4 x float> %28, <4 x float> %27, <4 x i32> <i32 0, i32 5, i32 2, i32 7>
  %30 = fmul <4 x float> %i.ar, %29
  %i.at = insertelement <4 x float> %27, float %16, i64 1
  %31 = fneg <4 x float> %i.at
  %i.au = fmul <4 x float> %30, %31
  %32 = shufflevector <4 x float> %15, <4 x float> poison, <4 x i32> <i32 2, i32 1, i32 0, i32 2> ; 2 uses
  %33 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.aq, <4 x float> %32, <4 x float> %i.au)
  %34 = insertelement <4 x float> poison, float %i.ae, i64 0
  %35 = shufflevector <4 x float> %34, <4 x float> poison, <4 x i32> zeroinitializer ; 2 uses
  %36 = shufflevector <2 x float> %17, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %i.av = insertelement <2 x float> %36, float %16, i64 0
  %37 = shufflevector <2 x float> %i.av, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %i.aw = fmul <4 x float> %35, %37
  %38 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.aw, <4 x float> %32, <4 x float> %33)
  %39 = shufflevector <4 x float> %38, <4 x float> poison, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x float> %39, ptr %26, align 4
  %40 = getelementptr inbounds nuw i8, ptr %2, i64 20
  %41 = getelementptr inbounds nuw i8, ptr %2, i64 16 ; 2 uses
  %42 = load float, ptr %41, align 4
  %i.ax = fadd float %42, 1.000000e+00
  store float %i.ax, ptr %41, align 4
  %43 = shufflevector <4 x float> %15, <4 x float> poison, <4 x i32> <i32 2, i32 0, i32 0, i32 0>
  %i.ay = fmul <4 x float> %43, %i.ap
  %44 = fmul <4 x float> %i.ar, %18
  %45 = shufflevector <2 x float> %17, <2 x float> poison, <4 x i32> <i32 1, i32 poison, i32 0, i32 1>
  %46 = insertelement <4 x float> %45, float %16, i64 1
  %47 = fneg <4 x float> %46
  %i.az = fmul <4 x float> %44, %47
  %i.ba = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ay, <4 x float> %15, <4 x float> %i.az)
  %48 = fmul <4 x float> %35, %18
  %49 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %48, <4 x float> %15, <4 x float> %i.ba)
  %50 = fadd <4 x float> %49, <float -0.000000e+00, float -0.000000e+00, float -0.000000e+00, float 1.000000e+00>
  store <4 x float> %50, ptr %40, align 4
  br label %.loopexit

bb.f:                                             ; preds = %bb.a
  %i.bb = fneg float %i.g
  %i.bc = fmul float %i.d, %i.bb
  %i.bd = tail call float @llvm.fmuladd.f32(float %i.c, float %6, float %i.bc) ; 4 uses
  ...
  %i.bk = insertelement <2 x float> %53, float %51, i64 1
  %54 = fmul <2 x float> %i.b, %i.bk
  %55 = shufflevector <2 x float> %i.b, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %56 = insertelement <2 x float> %55, float %i.d, i64 0
  %57 = shufflevector <2 x float> %i.e, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %58 = insertelement <2 x float> %57, float %i.f, i64 0
  %i.bl = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %56, <2 x float> %58, <2 x float> %54) ; 7 uses
...
bb.a:
  ...
  %4 = load float, ptr %i.c, align 4, !noalias !19 ; 7 uses
  %i.d = load float, ptr %2, align 4, !noalias !19 ; 4 uses
  %i.e = fneg float %i.d                          ; 2 uses
  %5 = fmul float %4, %i.e
  %6 = fmul float %4, %i.d
  %7 = load <2 x float>, ptr %i.a, align 4, !noalias !19 ; 5 uses
  %8 = extractelement <2 x float> %7, i64 0       ; 4 uses
  %i.f = load float, ptr %i.b, align 4, !noalias !19 ; 6 uses
  %9 = fmul float %i.f, %i.f                      ; 2 uses
  ...
  %12 = insertelement <2 x float> poison, float %i.f, i64 0 ; 2 uses
  %13 = insertelement <2 x float> %12, float %i.d, i64 1
  %14 = shufflevector <2 x float> %7, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %15 = insertelement <2 x float> %14, float %i.e, i64 0 ; 2 uses
  ...
  %19 = insertelement <2 x float> %7, float %i.f, i64 1
  %20 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %18, <2 x float> %19, <2 x float> %16)
  %21 = fmul <2 x float> %20, splat (float 2.000000e+00)
  %22 = fmul float %i.f, %i.d
  %23 = tail call float @llvm.fmuladd.f32(float %4, float %8, float %22)
  %24 = fmul float %23, 2.000000e+00
  %25 = tail call float @llvm.fmuladd.f32(float %4, float %4, float %9)
  %26 = tail call float @llvm.fmuladd.f32(float %8, float %i.f, float %5)
  %27 = tail call float @llvm.fmuladd.f32(float %25, float -2.000000e+00, float 1.000000e+00)
  %28 = insertelement <2 x float> poison, float %27, i64 0
  %i.g = insertelement <2 x float> %28, float %26, i64 1
  %i.h = fmul <2 x float> %i.g, <float 1.000000e+00, float 2.000000e+00>
  %29 = fmul <2 x float> %14, %15
  %i.i = insertelement <2 x float> %12, float %4, i64 1
  %i.j = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %18, <2 x float> %i.i, <2 x float> %29) ; 2 uses
  %30 = extractelement <2 x float> %i.j, i64 0
  %31 = fmul float %30, 2.000000e+00
  %32 = shufflevector <2 x float> %7, <2 x float> %i.j, <2 x i32> <i32 0, i32 3>
  %33 = shufflevector <2 x float> %7, <2 x float> <float poison, float -2.000000e+00>, <2 x i32> <i32 1, i32 3>
  %34 = insertelement <2 x float> <float poison, float 1.000000e+00>, float %6, i64 0
  %35 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %32, <2 x float> %33, <2 x float> %34)
  %i.k = fmul <2 x float> %35, <float 2.000000e+00, float 1.000000e+00>
  ...
  %i.l = insertelement <4 x float> poison, float %11, i64 0
  %44 = shufflevector <2 x float> %21, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %45 = shufflevector <4 x float> %i.l, <4 x float> %44, <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
  %46 = insertelement <4 x float> %45, float %43, i64 3
  %47 = insertelement <4 x float> <float poison, float 1.000000e+00, float poison, float poison>, float %36, i64 0
  %48 = shufflevector <4 x float> %47, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
  %i.m = fmul <4 x float> %46, %48
  %.sroa.7.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 16
  %49 = load float, ptr %39, align 4
  %50 = insertelement <4 x float> <float poison, float 1.000000e+00, float poison, float poison>, float %38, i64 0
  %51 = shufflevector <4 x float> %50, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
  %52 = insertelement <4 x float> poison, float %24, i64 0
  %i.n = shufflevector <2 x float> %i.h, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.o = shufflevector <4 x float> %52, <4 x float> %i.n, <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
  %i.p = insertelement <4 x float> %i.o, float %49, i64 3
  %i.q = fmul <4 x float> %51, %i.p
  %.sroa.11.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 32
  %53 = load float, ptr %42, align 4
  %i.r = insertelement <4 x float> <float poison, float 1.000000e+00, float poison, float poison>, float %41, i64 0
  %54 = shufflevector <4 x float> %i.r, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
  %55 = insertelement <4 x float> poison, float %31, i64 0
  %56 = shufflevector <2 x float> %i.k, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %57 = shufflevector <4 x float> %55, <4 x float> %56, <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
  %i.s = insertelement <4 x float> %57, float %53, i64 3
  %i.t = fmul <4 x float> %54, %i.s
  store <4 x float> %i.m, ptr %0, align 4
  store <4 x float> %i.q, ptr %.sroa.7.0..sroa_idx, align 4
...
bb.a:
  ...
  %3 = fsub float 1.000000e+00, %i.a              ; 2 uses
  %i.c = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.d = load float, ptr %i.c, align 4            ; 6 uses
  %i.e = fmul float %i.b, %i.d                    ; 2 uses
  %i.f = fneg float %i.e
  %4 = load <2 x float>, ptr %1, align 4          ; 5 uses
  %5 = extractelement <2 x float> %4, i64 0
  %6 = insertelement <2 x float> poison, float %i.a, i64 0
  %7 = insertelement <2 x float> %6, float %i.f, i64 1
  ...
  %12 = fmul <2 x float> %11, %4                  ; 5 uses
  %13 = shufflevector <2 x float> %12, <2 x float> poison, <2 x i32> zeroinitializer
  %14 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %13, <2 x float> %4, <2 x float> %7)
  store <2 x float> %14, ptr %0, align 4
  %15 = extractelement <2 x float> %12, i64 0
  %16 = tail call float @llvm.fmuladd.f32(float %15, float %i.d, float %9)
  store float %16, ptr %i.g, align 4
  %17 = shufflevector <2 x float> %4, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.i = insertelement <2 x float> poison, float %i.e, i64 0
  %i.j = insertelement <2 x float> %i.i, float %i.a, i64 1
  %i.k = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %12, <2 x float> %17, <2 x float> %i.j)
  store <2 x float> %i.k, ptr %i.h, align 4
  %18 = fmul float %i.b, %5                       ; 2 uses
  %19 = fneg float %18
  %20 = extractelement <2 x float> %12, i64 1
  %21 = tail call float @llvm.fmuladd.f32(float %20, float %i.d, float %19)
  %22 = getelementptr inbounds nuw i8, ptr %0, i64 24
  store float %21, ptr %22, align 4
  %23 = fneg float %9
  %24 = getelementptr inbounds nuw i8, ptr %0, i64 32
  %25 = insertelement <2 x float> poison, float %i.d, i64 0
  %26 = shufflevector <2 x float> %25, <2 x float> poison, <2 x i32> zeroinitializer
  %27 = insertelement <2 x float> poison, float %23, i64 0
  %28 = insertelement <2 x float> %27, float %18, i64 1
  %29 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %12, <2 x float> %26, <2 x float> %28)
  store <2 x float> %29, ptr %24, align 4
  %30 = fmul float %3, %i.d
  %31 = tail call float @llvm.fmuladd.f32(float %30, float %i.d, float %i.a)
