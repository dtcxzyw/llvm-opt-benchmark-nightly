...
bb.av:                                            ; preds = %bb.cd, %.preheader.i42.i
  %.051171.i.i = phi i32 [ 0, %.preheader.i42.i ], [ %.354.i.i, %bb.cd ] ; 6 uses
...
bb.cd:                                            ; preds = %bb.cc, %bb.bm
  ...
  %.354.i.i.a = phi i32 [ %.046.i.i, %bb.cc ], [ 1, %bb.bm ]
  %.354.i.i = add nsw i32 %.354.i.i.a, %.051171.i.i ; 3 uses
...
bb.fl:                                            ; preds = %bb.fn, %.preheader100.i
  ...
  %.076106.i = phi ptr [ %i.uc, %.preheader100.i ], [ %.379100.i, %bb.fn ] ; 3 uses
  %.080105.i = phi i32 [ %i.ts, %.preheader100.i ], [ %.38399.i, %bb.fn ] ; 3 uses
...
bb.fn:                                            ; preds = %._crit_edge103.i, %bb.fl
  %.379100.i = phi ptr [ %i.xn, %._crit_edge103.i ], [ %.076106.i, %bb.fl ]
  %.38399.i = phi i32 [ %i.xo, %._crit_edge103.i ], [ %.080105.i, %bb.fl ]
...
.thread399:                                       ; preds = %bb.er, %_ZL17stbi__malloc_mad3iiii.exit.thread.i, %.thread.i353, %bb.cc, %bb.ck, %bb.cn, %bb.be, %bb.cp, %bb.ch, %bb.cf, %bb.cd, %bb.cb, %bb.by, %bb.br, %bb.bk, %bb.bi, %bb.bg, %bb.fa, %bb.fd, %bb.gb, %bb.fb, %assimp_stbi_zlib_decode_malloc_guesssize_headerflag.exit, %_ZL22stbi__create_png_imageP9stbi__pngPhjiiii.exit, %assimp_stbi_zlib_decode_malloc_guesssize_headerflag.exit.thread, %_ZL24stbi__expand_png_paletteP9stbi__pngPhii.exit.thread, %bb.eo, %bb.el, %.thread382, %_ZL10stbi__getnP13stbi__contextPhi.exit.thread, %bb.en, %bb.eq, %bb.ej, %bb.ec, %bb.eg, %bb.ee, %bb.dv, %bb.dt, %bb.dr, %bb.do, %bb.dm, %bb.cv, %bb.ct, %bb.cr, %bb.gf, %bb.gd, %_ZL22stbi__check_png_headerP13stbi__context.exit.thread, %_ZL22stbi__check_png_headerP13stbi__context.exit
  %.7 = phi i32 [ 0, %_ZL22stbi__check_png_headerP13stbi__context.exit.thread ], [ 1, %_ZL22stbi__check_png_headerP13stbi__context.exit ], [ 0, %bb.cc ], [ 0, %assimp_stbi_zlib_decode_malloc_guesssize_headerflag.exit.thread ], [ 0, %_ZL24stbi__expand_png_paletteP9stbi__pngPhii.exit.thread ], [ 0, %_ZL22stbi__create_png_imageP9stbi__pngPhjiiii.exit ], [ 1, %bb.gb ], [ 1, %bb.fb ], [ 0, %bb.fd ], [ 0, %assimp_stbi_zlib_decode_malloc_guesssize_headerflag.exit ], [ 0, %bb.fa ], [ 1, %bb.eo ], [ 0, %bb.el ], [ 0, %.thread382 ], [ 0, %_ZL10stbi__getnP13stbi__contextPhi.exit.thread ], [ 1, %bb.en ], [ 0, %bb.eq ], [ 0, %_ZL17stbi__malloc_mad3iiii.exit.thread.i ], [ 0, %bb.ej ], [ 0, %bb.ec ], [ 1, %bb.eg ], [ 0, %bb.ee ], [ 0, %bb.dv ], [ 0, %bb.dt ], [ 1, %bb.dr ], [ 0, %bb.do ], [ 0, %bb.dm ], [ 0, %bb.cv ], [ 0, %bb.ct ], [ 0, %bb.cr ], [ 0, %bb.gd ], [ 0, %bb.gf ], [ 0, %bb.bg ], [ 0, %bb.bi ], [ 0, %bb.bk ], [ 0, %bb.br ], [ 0, %bb.by ], [ 0, %bb.cb ], [ 0, %bb.cd ], [ 0, %bb.cf ], [ 0, %bb.ch ], [ 0, %bb.cp ], [ 0, %bb.be ], [ 0, %bb.cn ], [ 0, %bb.ck ], [ 0, %.thread.i353 ], [ 0, %bb.er ]
