...
begin_hunk_1_@_Z18SetGenericPropertyIiEbRSt3mapIjT_St4lessIjESaISt4pairIKjS1_EEEPKcRKS1_:bb.a
  ...
  %i.ac = getelementptr inbounds nuw i8, ptr %.05463.i, i64 8 ; 3 uses
...
.lr.ph.i.epil.preheader:                          ; preds = %bb.b, %._crit_edge.i.loopexit.unr-lcssa
  %.05463.i.epil.init = phi ptr [ %1, %bb.b ], [ %i.ac, %._crit_edge.i.loopexit.unr-lcssa ] ; 3 uses
...
begin_hunk_3_@_Z18SetGenericPropertyIiEbRSt3mapIjT_St4lessIjESaISt4pairIKjS1_EEEPKcRKS1_:bb.a
  ...
  %3 = getelementptr inbounds nuw i8, ptr %.05463.i.epil.init, i64 4
...
._crit_edge.i:                                    ; preds = %.lr.ph.i.epil.preheader, %._crit_edge.i.loopexit.unr-lcssa, %bb.b
  %.055.lcssa.i = phi i32 [ 0, %bb.b ], [ %i.ae, %._crit_edge.i.loopexit.unr-lcssa ], [ %i.ar, %.lr.ph.i.epil.preheader ] ; 4 uses
  %.054.lcssa.i = phi ptr [ %1, %bb.b ], [ %i.ac, %._crit_edge.i.loopexit.unr-lcssa ], [ %3, %.lr.ph.i.epil.preheader ] ; 4 uses
...
begin_hunk_9_@_Z18SetGenericPropertyINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEbRSt3mapIjT_St4lessIjESaISt4pairIKjS7_EEEPKcRKS7_:bb.a
  ...
  %i.ad = getelementptr inbounds nuw i8, ptr %.05463.i, i64 8 ; 3 uses
...
.lr.ph.i.epil.preheader:                          ; preds = %bb.b, %._crit_edge.i.loopexit.unr-lcssa
  %.05463.i.epil.init = phi ptr [ %1, %bb.b ], [ %i.ad, %._crit_edge.i.loopexit.unr-lcssa ] ; 3 uses
...
begin_hunk_11_@_Z18SetGenericPropertyINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEbRSt3mapIjT_St4lessIjESaISt4pairIKjS7_EEEPKcRKS7_:bb.a
  ...
  %4 = getelementptr inbounds nuw i8, ptr %.05463.i.epil.init, i64 4
  %i.ar = lshr i32 %i.aq, 11
  %i.as = add i32 %i.ar, %i.aq
  br label %._crit_edge.i

._crit_edge.i:                                    ; preds = %.lr.ph.i.epil.preheader, %._crit_edge.i.loopexit.unr-lcssa, %bb.b
  %.055.lcssa.i = phi i32 [ 0, %bb.b ], [ %i.af, %._crit_edge.i.loopexit.unr-lcssa ], [ %i.as, %.lr.ph.i.epil.preheader ] ; 4 uses
  %.054.lcssa.i = phi ptr [ %1, %bb.b ], [ %i.ad, %._crit_edge.i.loopexit.unr-lcssa ], [ %4, %.lr.ph.i.epil.preheader ] ; 4 uses
