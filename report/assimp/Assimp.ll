...
begin_hunk_0_@_ZL28stbi__compute_transparency16P9stbi__pngPti:bb.a
  ...
  %3 = getelementptr i8, ptr %.24.val, i64 %2
  %4 = trunc i64 %n.vec to i32
  %5 = load i16, ptr %0, align 2, !alias.scope !174
...
.lr.ph7.preheader7:                               ; preds = %vector.body, %vector.memcheck, %.lr.ph7.preheader
  %.06.ph = phi ptr [ %.24.val, %vector.memcheck ], [ %.24.val, %.lr.ph7.preheader ], [ %3, %vector.body ] ; 2 uses
  %.0225.ph = phi i32 [ 0, %vector.memcheck ], [ 0, %.lr.ph7.preheader ], [ %4, %vector.body ] ; 4 uses
