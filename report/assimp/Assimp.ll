...
define hidden range(i32 0, 2) i32 @assimp_stbi_info_from_file(ptr noundef %0, ptr nofree noundef writeonly captures(address_is_null) %1, ptr nofree noundef writeonly captures(address_is_null) %2, ptr nofree noundef writeonly captures(address_is_null) %3) local_unnamed_addr #2 {
bb.a:
...
; Function Attrs: mustprogress uwtable
define hidden range(i32 0, 2) i32 @assimp_stbi_is_16_bit(ptr nofree noundef readonly captures(none) %0) local_unnamed_addr #2 {
bb.a:
...
; Function Attrs: mustprogress uwtable
define hidden range(i32 0, 2) i32 @assimp_stbi_info_from_memory(ptr noundef %0, i32 noundef %1, ptr nofree noundef writeonly captures(address_is_null) %2, ptr nofree noundef writeonly captures(address_is_null) %3, ptr nofree noundef writeonly captures(address_is_null) %4) local_unnamed_addr #2 {
bb.a:
...
; Function Attrs: mustprogress uwtable
define hidden range(i32 0, 2) i32 @assimp_stbi_info_from_callbacks(ptr nofree noundef readonly captures(none) %0, ptr noundef %1, ptr nofree noundef writeonly captures(address_is_null) %2, ptr nofree noundef writeonly captures(address_is_null) %3, ptr nofree noundef writeonly captures(address_is_null) %4) local_unnamed_addr #2 {
bb.a:
  %5 = alloca %struct.stbi__png, align 8          ; 9 uses
...
; Function Attrs: mustprogress uwtable
define hidden range(i32 0, 2) i32 @assimp_stbi_is_16_bit_from_callbacks(ptr nofree noundef readonly captures(none) %0, ptr noundef %1) local_unnamed_addr #2 {
bb.a:
  %2 = alloca %struct.stbi__png, align 8          ; 6 uses
