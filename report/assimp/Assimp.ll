...
bb.a:
  ...
  %i.b = getelementptr inbounds nuw i8, ptr %1, i64 4
  %2 = load float, ptr %1, align 4, !noalias !16  ; 3 uses
  %3 = fneg float %2
  %4 = load float, ptr %i.a, align 4, !noalias !16 ; 3 uses
  %5 = insertelement <4 x float> <float 1.000000e+00, float poison, float poison, float poison>, float %4, i64 1
  %6 = insertelement <4 x float> <float 1.000000e+00, float poison, float poison, float poison>, float %3, i64 1 ; 2 uses
  %7 = insertelement <4 x float> %6, float %2, i64 2
  %8 = shufflevector <4 x float> %7, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 2>
  %.sroa.7.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 16
  %9 = insertelement <4 x float> <float poison, float 1.000000e+00, float 1.000000e+00, float -0.000000e+00>, float %4, i64 0 ; 2 uses
  %10 = insertelement <4 x float> <float poison, float -0.000000e+00, float -0.000000e+00, float 1.000000e+00>, float %4, i64 0
  %11 = fmul <4 x float> %9, %10                  ; 2 uses
  %12 = load <2 x float>, ptr %i.b, align 4, !noalias !16 ; 2 uses
  %13 = shufflevector <2 x float> %12, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1> ; 8 uses
  %14 = shufflevector <4 x float> <float poison, float -0.000000e+00, float -0.000000e+00, float 0.000000e+00>, <4 x float> %13, <4 x i32> <i32 5, i32 1, i32 2, i32 3> ; 2 uses
  ...
  %16 = shufflevector <4 x float> %11, <4 x float> %13, <4 x i32> <i32 0, i32 4, i32 4, i32 4>
  %17 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %14, <4 x float> %15, <4 x float> %16)
  %18 = shufflevector <4 x float> %5, <4 x float> %13, <4 x i32> <i32 0, i32 1, i32 5, i32 poison> ; 2 uses
  %19 = shufflevector <4 x float> %18, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 1>
  %i.c = fmul <4 x float> %19, %8
  %20 = shufflevector <4 x float> %18, <4 x float> <float -2.000000e+00, float poison, float poison, float poison>, <4 x i32> <i32 4, i32 2, i32 1, i32 2>
  %i.d = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %17, <4 x float> %20, <4 x float> %i.c)
  %i.e = fmul <4 x float> %i.d, <float 1.000000e+00, float 2.000000e+00, float 2.000000e+00, float 2.000000e+00>
  %21 = shufflevector <4 x float> %13, <4 x float> <float poison, float 1.000000e+00, float 1.000000e+00, float 1.000000e+00>, <4 x i32> <i32 0, i32 5, i32 6, i32 7>
  %22 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %13, <4 x float> %21, <4 x float> %11)
  %23 = shufflevector <4 x float> %13, <4 x float> <float 1.000000e+00, float poison, float poison, float poison>, <4 x i32> <i32 4, i32 0, i32 1, i32 0>
  %24 = insertelement <4 x float> %6, float %2, i64 3
  %25 = shufflevector <4 x float> %24, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 3>
  %26 = fmul <4 x float> %23, %25
  %27 = shufflevector <4 x float> %9, <4 x float> <float -2.000000e+00, float poison, float poison, float poison>, <4 x i32> <i32 4, i32 0, i32 0, i32 0>
  %28 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %22, <4 x float> %27, <4 x float> %26)
  %29 = fmul <4 x float> %28, <float 1.000000e+00, float 2.000000e+00, float 2.000000e+00, float 2.000000e+00>
  %foldExtExtBinop = fmul <4 x float> %13, %13
  %30 = extractelement <4 x float> %foldExtExtBinop, i64 1
  %31 = extractelement <2 x float> %12, i64 0     ; 2 uses
  %i.f = tail call float @llvm.fmuladd.f32(float %31, float %31, float %30)
  %i.g = tail call float @llvm.fmuladd.f32(float %i.f, float -2.000000e+00, float 1.000000e+00)
  store <4 x float> %i.e, ptr %0, align 4
  store <4 x float> %29, ptr %.sroa.7.0..sroa_idx, align 4
  %.sroa.11.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 32
...
bb.a:
  ...
  %i.i = getelementptr inbounds nuw i8, ptr %0, i64 8
  %1 = load float, ptr %i.a, align 4              ; 5 uses
  %2 = load float, ptr %i.c, align 4              ; 6 uses
  %i.j = load <2 x float>, ptr %i.d, align 4      ; 2 uses
  %i.k = load float, ptr %i.b, align 4            ; 2 uses
  %i.l = extractelement <2 x float> %i.j, i64 0   ; 2 uses
  %i.m = fneg float %i.l                          ; 3 uses
  %3 = load <4 x float>, ptr %0, align 4          ; 6 uses
  %i.n = load float, ptr %i.h, align 4            ; 2 uses
  %i.o = load float, ptr %i.i, align 4            ; 3 uses
  %4 = load float, ptr %i.e, align 4              ; 2 uses
  %i.p = extractelement <4 x float> %3, i64 0     ; 3 uses
  %5 = fmul float %i.p, %1
  %i.q = fmul float %i.p, %2
...
bb.b:                                             ; preds = %bb.a
  ...
  %6 = fmul float %2, %i.ag
  %7 = fmul float %i.o, %i.m
  %8 = fmul float %2, %i.m
  %i.ah = insertelement <4 x float> poison, float %1, i64 0
  %9 = shufflevector <4 x float> %i.ah, <4 x float> %3, <4 x i32> <i32 0, i32 poison, i32 5, i32 7>
  %10 = shufflevector <2 x float> %i.j, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 4 uses
  %11 = shufflevector <4 x float> %9, <4 x float> %10, <4 x i32> <i32 0, i32 5, i32 2, i32 3>
  %12 = shufflevector <4 x float> %3, <4 x float> %10, <4 x i32> <i32 5, i32 1, i32 poison, i32 poison>
  %13 = insertelement <4 x float> %12, float %2, i64 2
  ...
  %16 = insertelement <4 x float> %15, float %7, i64 1
  %17 = insertelement <4 x float> %16, float %i.ab, i64 2
  %18 = insertelement <4 x float> %17, float %6, i64 3
  %i.ai = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %11, <4 x float> %14, <4 x float> %18)
  ...
  %19 = shufflevector <4 x float> %3, <4 x float> poison, <3 x i32> <i32 2, i32 poison, i32 1>
  %20 = insertelement <3 x float> %19, float %1, i64 1
  %21 = shufflevector <3 x float> %20, <3 x float> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 2>
  ...
  %i.aq = fmul <4 x float> %21, %i.ap
  %22 = shufflevector <4 x float> %10, <4 x float> %3, <4 x i32> <i32 1, i32 poison, i32 7, i32 4>
  %23 = insertelement <4 x float> %22, float %2, i64 1
  %24 = shufflevector <4 x float> %3, <4 x float> %10, <4 x i32> <i32 0, i32 0, i32 4, i32 4>
  %i.ar = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %23, <4 x float> %24, <4 x float> %i.aq)
  %i.as = fmul <4 x float> %i.ar, %i.al
  %i.at = tail call float @llvm.fmuladd.f32(float %i.p, float %1, float %i.w)
