...
begin_hunk_1_@_ZNK12aiMatrix4x4tIfE18DecomposeNoScalingER13aiQuaterniontIfER10aiVector3tIfE:bb.a
  ...
  %3 = fmul float %i.ad, 2.000000e+00
  %4 = insertelement <4 x float> poison, float %3, i64 0 ; 2 uses
  %i.ah = insertelement <4 x float> %4, float %i.ag, i64 1
  %i.ai = insertelement <4 x float> %i.ah, float %i.af, i64 2
  %i.aj = insertelement <4 x float> %i.ai, float %i.ae, i64 3 ; 2 uses
  %5 = shufflevector <4 x float> %4, <4 x float> <float 2.500000e-01, float poison, float poison, float poison>, <4 x i32> <i32 4, i32 0, i32 0, i32 0> ; 2 uses
  %i.ak = fmul <4 x float> %i.aj, %5
  %i.al = fdiv <4 x float> %i.aj, %5
