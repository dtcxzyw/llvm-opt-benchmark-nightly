...
assimp_stbi_zlib_decode_malloc_guesssize_headerflag.exit: ; preds = %bb.ff
  ...
  br i1 %i.tt, label %.thread400, label %bb.fh
...
.preheader.i.new:                                 ; preds = %.preheader.i.a, %.preheader.i.new
  %indvars.iv.i351 = phi i64 [ %indvars.iv.next.i352.1, %.preheader.i.new ], [ 0, %.preheader.i.a ] ; 4 uses
  %niter = phi i64 [ %niter.next.1, %.preheader.i.new ], [ 0, %.preheader.i.a ]
...
.epil.preheader:                                  ; preds = %._crit_edge.i.unr-lcssa, %.preheader.i.a
  %indvars.iv.i351.epil.init = phi i64 [ 0, %.preheader.i.a ], [ %indvars.iv.next.i352.1, %._crit_edge.i.unr-lcssa ] ; 2 uses
...
bb.fn:                                            ; preds = %._crit_edge103.split.i, %bb.fl
  %.383.i = phi i32 [ %.080105.i, %bb.fl ], [ %i.xo, %._crit_edge103.split.i ]
  ...
  br i1 %exitcond.not.i350, label %_ZL22stbi__create_png_imageP9stbi__pngPhjiiii.exit.thread394, label %bb.fl, !llvm.loop !170

_ZL22stbi__create_png_imageP9stbi__pngPhjiiii.exit.thread394: ; preds = %bb.fn
...
_ZL22stbi__create_png_imageP9stbi__pngPhjiiii.exit: ; preds = %bb.fh
  ...
  br i1 %.not267, label %.thread400, label %bb.fo

bb.fo:                                            ; preds = %_ZL22stbi__create_png_imageP9stbi__pngPhjiiii.exit.thread394, %_ZL22stbi__create_png_imageP9stbi__pngPhjiiii.exit
