...
.preheader.lr.ph:                                 ; preds = %.loopexit
  ...
  br i1 %.not64, label %._crit_edge62.split, label %.preheader.us.preheader
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge
  %.04161.us = phi i32 [ %3, %._crit_edge ], [ 0, %.preheader.us.preheader ] ; 2 uses
  %.04260.us = phi ptr [ %i.bz, %._crit_edge ], [ %i.aw, %.preheader.us.preheader ]
  %.04359.us = phi ptr [ %i.by, %._crit_edge ], [ %i.bf, %.preheader.us.preheader ]
  %.04558.us = phi ptr [ %i.bx, %._crit_edge ], [ %i.be, %.preheader.us.preheader ]
  %i.bg = uitofp i32 %.04161.us to float
  br label %bb.b
...
._crit_edge:                                      ; preds = %bb.b
  %3 = add nuw i32 %.04161.us, 1                  ; 2 uses
  %exitcond68.not = icmp eq i32 %3, %i.at
  br i1 %exitcond68.not, label %._crit_edge62.split, label %.preheader.us, !llvm.loop !5

bb.b:                                             ; preds = %.preheader.us, %bb.b
  %.04055.us = phi i32 [ 0, %.preheader.us ], [ %i.ca, %bb.b ] ; 2 uses
  %.154.us = phi ptr [ %.04260.us, %.preheader.us ], [ %i.bz, %bb.b ] ; 3 uses
  %.14453.us = phi ptr [ %.04359.us, %.preheader.us ], [ %i.by, %bb.b ] ; 2 uses
  %.14652.us = phi ptr [ %.04558.us, %.preheader.us ], [ %i.bx, %bb.b ] ; 4 uses
  %i.bh = uitofp i32 %.04055.us to float
  %i.bi = load float, ptr %i.bc, align 1
  %i.bj = fmul float %i.bi, %i.bh
  store float %i.bj, ptr %.14652.us, align 4
  %i.bk = load float, ptr %i.bd, align 1
  %i.bl = fmul float %i.bk, %i.bg
  %i.bm = getelementptr inbounds nuw i8, ptr %.14652.us, i64 4
  store float %i.bl, ptr %i.bm, align 4
  %i.bn = load i16, ptr %.154.us, align 1
  ...
  %i.bu = getelementptr inbounds nuw i8, ptr %.14652.us, i64 8
  store float %i.bt, ptr %i.bu, align 4
  %i.bv = getelementptr inbounds nuw i8, ptr %.154.us, i64 2
  %i.bw = load i8, ptr %i.bv, align 1
  tail call void @_ZN6Assimp3MD217LookupNormalIndexEhR10aiVector3tIfE(i8 noundef zeroext %i.bw, ptr noundef nonnull align 4 dereferenceable(12) %.14453.us)
  %i.bx = getelementptr inbounds nuw i8, ptr %.14652.us, i64 12 ; 2 uses
  %i.by = getelementptr inbounds nuw i8, ptr %.14453.us, i64 12 ; 2 uses
  %i.bz = getelementptr inbounds nuw i8, ptr %.154.us, i64 4 ; 2 uses
  %i.ca = add nuw i32 %.04055.us, 1               ; 2 uses
...
.split.us.i:                                      ; preds = %bb.c
  ...
  %broadcast.splatinsert83 = insertelement <4 x float> poison, float %i.cq, i64 0
...
.preheader.us.i:                                  ; preds = %._crit_edge.i, %.split.us.i
  %.02330.us.i = phi i32 [ 0, %.split.us.i ], [ %4, %._crit_edge.i ] ; 2 uses
  %.02429.us.i = phi ptr [ %i.cg, %.split.us.i ], [ %.lcssa, %._crit_edge.i ] ; 3 uses
  %i.cu = uitofp i32 %.02330.us.i to float
  %i.cv = fmul float %i.cm, %i.cu                 ; 2 uses
  br i1 %min.iters.check, label %scalar.ph.preheader, label %vector.ph

vector.ph:                                        ; preds = %.preheader.us.i
  %i.cw = getelementptr i8, ptr %.02429.us.i, i64 %i.ct ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep = getelementptr i8, ptr %.02429.us.i, i64 %i.cx
  %i.cy = uitofp <4 x i32> %vec.ind to <4 x float>
  %i.cz = fmul <4 x float> %broadcast.splat84, %i.cy
...
scalar.ph.preheader:                              ; preds = %.preheader.us.i, %middle.block
  %.028.us.i.ph = phi i32 [ 0, %.preheader.us.i ], [ %i.cs, %middle.block ]
  %.127.us.i.ph = phi ptr [ %.02429.us.i, %.preheader.us.i ], [ %i.cw, %middle.block ]
...
._crit_edge.i:                                    ; preds = %scalar.ph, %middle.block
  ...
  %4 = add nuw i32 %.02330.us.i, 1                ; 2 uses
  %exitcond31.not.i = icmp eq i32 %4, %i.at
  br i1 %exitcond31.not.i, label %_ZN6Assimp11HMPImporter21GenerateTextureCoordsEjj.exit, label %.preheader.us.i, !llvm.loop !11

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %.028.us.i = phi i32 [ %i.dg, %scalar.ph ], [ %.028.us.i.ph, %scalar.ph.preheader ] ; 2 uses
  %.127.us.i = phi ptr [ %i.dh, %scalar.ph ], [ %.127.us.i.ph, %scalar.ph.preheader ] ; 3 uses
  %i.dd = getelementptr inbounds nuw i8, ptr %.127.us.i, i64 4
  %i.de = uitofp i32 %.028.us.i to float
  %i.df = fmul float %i.cq, %i.de
  store float %i.df, ptr %.127.us.i, align 4
  store <2 x float> %i.dc, ptr %i.dd, align 4
  %i.dg = add nuw i32 %.028.us.i, 1               ; 2 uses
  %i.dh = getelementptr inbounds nuw i8, ptr %.127.us.i, i64 12 ; 2 uses
...
.loopexit:                                        ; preds = %.loopexit55.thread, %.loopexit.loopexit
  ...
  br i1 %.not67, label %_ZN10aiVector3tIfEdVEf.exit.i.us.preheader, label %.preheader.lr.ph
...
.preheader.lr.ph:                                 ; preds = %.loopexit
  ...
  br i1 %.not68, label %_ZN10aiVector3tIfEdVEf.exit.i.us.preheader, label %.preheader.us.preheader
...
.preheader.us.preheader:                          ; preds = %.preheader.lr.ph
  ...
  %scevgep88.a = getelementptr i8, ptr %i.c, i64 44 ; 2 uses
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge
  %.04565.us = phi i32 [ %3, %._crit_edge ], [ 0, %.preheader.us.preheader ] ; 2 uses
  %.04664.us = phi ptr [ %i.fl, %._crit_edge ], [ %i.aw, %.preheader.us.preheader ] ; 10 uses
  %.04763.us = phi ptr [ %i.fk, %._crit_edge ], [ %i.bf, %.preheader.us.preheader ] ; 11 uses
  %.04962.us = phi ptr [ %i.fj, %._crit_edge ], [ %i.be, %.preheader.us.preheader ] ; 8 uses
  %i.br = uitofp i32 %.04565.us to float          ; 2 uses
  br i1 %min.iters.check, label %_ZN10aiVector3tIfEdVEf.exit.i.preheader, label %vector.memcheck

_ZN10aiVector3tIfEdVEf.exit.i.preheader:          ; preds = %vector.body, %vector.memcheck, %.preheader.us
  %.04459.ph = phi i32 [ 0, %vector.memcheck ], [ 0, %.preheader.us ], [ %i.bo, %vector.body ]
  %.158.ph = phi ptr [ %.04664.us, %vector.memcheck ], [ %.04664.us, %.preheader.us ], [ %i.bt, %vector.body ]
  %.14857.ph = phi ptr [ %.04763.us, %vector.memcheck ], [ %.04763.us, %.preheader.us ], [ %i.bu, %vector.body ]
  %.15056.ph = phi ptr [ %.04962.us, %vector.memcheck ], [ %.04962.us, %.preheader.us ], [ %i.bv, %vector.body ]
  br label %_ZN10aiVector3tIfEdVEf.exit.i.us

vector.memcheck:                                  ; preds = %.preheader.us
  %scevgep = getelementptr i8, ptr %.04962.us, i64 %i.bj ; 3 uses
  %scevgep87 = getelementptr i8, ptr %.04763.us, i64 %i.bj ; 3 uses
  %i.bs = getelementptr i8, ptr %.04664.us, i64 %i.bk
  %scevgep89 = getelementptr i8, ptr %i.bs, i64 4 ; 2 uses
  %bound0 = icmp ult ptr %.04962.us, %scevgep87
  %bound1 = icmp ult ptr %.04763.us, %scevgep
  %found.conflict = and i1 %bound0, %bound1
  %bound090 = icmp ult ptr %.04962.us, %scevgep88.a
  %bound191 = icmp ult ptr %i.bc, %scevgep
  %found.conflict92 = and i1 %bound090, %bound191
  %conflict.rdx = or i1 %found.conflict, %found.conflict92
  %bound093 = icmp ult ptr %.04962.us, %scevgep89
  %bound194 = icmp ult ptr %.04664.us, %scevgep
  %found.conflict95 = and i1 %bound093, %bound194
  %conflict.rdx96 = or i1 %conflict.rdx, %found.conflict95
  %bound097 = icmp ult ptr %.04763.us, %scevgep88.a
  %bound198 = icmp ult ptr %i.bc, %scevgep87
  %found.conflict99 = and i1 %bound097, %bound198
  %conflict.rdx100 = or i1 %conflict.rdx96, %found.conflict99
  %bound0101 = icmp ult ptr %.04763.us, %scevgep89
  %bound1102 = icmp ult ptr %.04664.us, %scevgep87
  %found.conflict103 = and i1 %bound0101, %bound1102
  %conflict.rdx104 = or i1 %conflict.rdx100, %found.conflict103
  br i1 %conflict.rdx104, label %_ZN10aiVector3tIfEdVEf.exit.i.preheader, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %i.bt = getelementptr i8, ptr %.04664.us, i64 %i.bp
  %i.bu = getelementptr i8, ptr %.04763.us, i64 %i.bq
  %i.bv = getelementptr i8, ptr %.04962.us, i64 %i.bq
  ...
  %broadcast.splatinsert115 = insertelement <4 x float> poison, float %i.by, i64 0
  ...
  %broadcast.splatinsert113 = insertelement <4 x float> poison, float %i.bz, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep = getelementptr i8, ptr %.04664.us, i64 %i.ca ; 3 uses
  %i.cb = getelementptr i8, ptr %.04664.us, i64 %i.ca ; 2 uses
  %i.cc = getelementptr i8, ptr %.04664.us, i64 %i.ca ; 2 uses
  %i.cd = getelementptr i8, ptr %.04664.us, i64 %i.ca ; 2 uses
  %i.ce = mul i64 %index, 12                      ; 5 uses
  %next.gep108.a = getelementptr i8, ptr %.04763.us, i64 %i.ce ; 2 uses
  %i.cf = getelementptr i8, ptr %.04763.us, i64 %i.ce
  %next.gep109.a = getelementptr i8, ptr %i.cf, i64 12
  %i.cg = getelementptr i8, ptr %.04763.us, i64 %i.ce
  %next.gep110.a = getelementptr i8, ptr %i.cg, i64 24
  %i.ch = getelementptr i8, ptr %.04763.us, i64 %i.ce
  %next.gep111.a = getelementptr i8, ptr %i.ch, i64 36
  %next.gep112 = getelementptr i8, ptr %.04962.us, i64 %i.ce
  ...
  %i.cn = fmul <4 x float> %broadcast.splat114, %i.cm
  %i.co = fmul <4 x float> %i.cn, splat (float 8.000000e+00)
  %i.cp = shufflevector <4 x float> %i.cj, <4 x float> %broadcast.splat116, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  ...
  store float %i.de, ptr %next.gep108.a, align 4, !alias.scope !22, !noalias !23
  store float %i.df, ptr %next.gep109.a, align 4, !alias.scope !22, !noalias !23
  store float %i.dg, ptr %next.gep110.a, align 4, !alias.scope !22, !noalias !23
  store float %i.dh, ptr %next.gep111.a, align 4, !alias.scope !22, !noalias !23
  ...
  %interleaved.vec117 = shufflevector <8 x float> %i.ec, <8 x float> %i.ed, <12 x i32> <i32 0, i32 4, i32 8, i32 1, i32 5, i32 9, i32 2, i32 6, i32 10, i32 3, i32 7, i32 11>
  store <12 x float> %interleaved.vec117, ptr %next.gep108.a, align 4, !alias.scope !22, !noalias !23
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %vec.ind.next = add nuw <4 x i32> %vec.ind, splat (i32 4)
  %i.ee = icmp eq i64 %index.next, %n.vec
  br i1 %i.ee, label %_ZN10aiVector3tIfEdVEf.exit.i.preheader, label %vector.body, !llvm.loop !24

_ZN10aiVector3tIfEdVEf.exit.i.us.preheader:       ; preds = %._crit_edge, %.preheader.lr.ph, %.loopexit
  %1 = getelementptr inbounds nuw i8, ptr %i.c, i64 48
  %2 = load i32, ptr %1, align 1
  %.not = icmp eq i32 %2, 0
  br i1 %.not, label %_ZN6Assimp11HMPImporter21GenerateTextureCoordsEjj.exit, label %bb.b

._crit_edge:                                      ; preds = %_ZN10aiVector3tIfEdVEf.exit.i.us
  %3 = add nuw i32 %.04565.us, 1                  ; 2 uses
  %exitcond72.not = icmp eq i32 %3, %i.at
  br i1 %exitcond72.not, label %_ZN10aiVector3tIfEdVEf.exit.i.us.preheader, label %.preheader.us, !llvm.loop !25

_ZN10aiVector3tIfEdVEf.exit.i.us:                 ; preds = %_ZN10aiVector3tIfEdVEf.exit.i.preheader, %_ZN10aiVector3tIfEdVEf.exit.i.us
  %.04459.us = phi i32 [ %i.fm, %_ZN10aiVector3tIfEdVEf.exit.i.us ], [ %.04459.ph, %_ZN10aiVector3tIfEdVEf.exit.i.preheader ] ; 2 uses
  %.158.us = phi ptr [ %i.fl, %_ZN10aiVector3tIfEdVEf.exit.i.us ], [ %.158.ph, %_ZN10aiVector3tIfEdVEf.exit.i.preheader ] ; 4 uses
  %.14857.us = phi ptr [ %i.fk, %_ZN10aiVector3tIfEdVEf.exit.i.us ], [ %.14857.ph, %_ZN10aiVector3tIfEdVEf.exit.i.preheader ] ; 5 uses
  %.15056.us = phi ptr [ %i.fj, %_ZN10aiVector3tIfEdVEf.exit.i.us ], [ %.15056.ph, %_ZN10aiVector3tIfEdVEf.exit.i.preheader ] ; 4 uses
  %i.ef = uitofp i32 %.04459.us to float
  %i.eg = load float, ptr %i.bc, align 1
  %i.eh = fmul float %i.eg, %i.ef
  store float %i.eh, ptr %.15056.us, align 4
  %i.ei = load float, ptr %i.bd, align 1
  %i.ej = fmul float %i.ei, %i.br
  %i.ek = getelementptr inbounds nuw i8, ptr %.15056.us, i64 4
  store float %i.ej, ptr %i.ek, align 4
  %i.el = load i16, ptr %.158.us, align 1
  ...
  %i.es = getelementptr inbounds nuw i8, ptr %.15056.us, i64 8
  store float %i.er, ptr %i.es, align 4
  %i.et = getelementptr inbounds nuw i8, ptr %.158.us, i64 2
  %i.eu = load i8, ptr %i.et, align 1
  %i.ev = sitofp i8 %i.eu to float
  %i.ew = fmul nnan float %i.ev, 7.812500e-03     ; 4 uses
  store float %i.ew, ptr %.14857.us, align 4
  %i.ex = getelementptr inbounds nuw i8, ptr %.158.us, i64 3
  %i.ey = load i8, ptr %i.ex, align 1
  %i.ez = sitofp i8 %i.ey to float
  %i.fa = fmul nnan float %i.ez, 7.812500e-03     ; 3 uses
  %i.fb = getelementptr inbounds nuw i8, ptr %.14857.us, i64 4
  %i.fc = getelementptr inbounds nuw i8, ptr %.14857.us, i64 8
  ...
  %sqrt.i.i.us = tail call noundef float @llvm.sqrt.f32(float %i.ff)
  %i.fg = fdiv float 1.000000e+00, %sqrt.i.i.us   ; 3 uses
  %i.fh = fmul float %i.ew, %i.fg
  store float %i.fh, ptr %.14857.us, align 4
  %i.fi = fmul float %i.fa, %i.fg
  store float %i.fi, ptr %i.fb, align 4
  store float %i.fg, ptr %i.fc, align 4
  %i.fj = getelementptr inbounds nuw i8, ptr %.15056.us, i64 12 ; 2 uses
  %i.fk = getelementptr inbounds nuw i8, ptr %.14857.us, i64 12 ; 2 uses
  %i.fl = getelementptr inbounds nuw i8, ptr %.158.us, i64 4 ; 2 uses
  %i.fm = add nuw i32 %.04459.us, 1               ; 2 uses
  %exitcond.not = icmp eq i32 %i.fm, %i.au
  br i1 %exitcond.not, label %._crit_edge, label %_ZN10aiVector3tIfEdVEf.exit.i.us, !llvm.loop !26

bb.b:                                             ; preds = %_ZN10aiVector3tIfEdVEf.exit.i.us.preheader
...
.split.us.i:                                      ; preds = %bb.b
  ...
  %min.iters.check122 = icmp ult i32 %i.au, 4
  %n.vec125 = and i64 %i.gd, 4294967292           ; 4 uses
  %i.ge = trunc nuw i64 %n.vec125 to i32
  %i.gf = mul nuw nsw i64 %n.vec125, 12
  %broadcast.splatinsert128 = insertelement <4 x float> poison, float %i.gc, i64 0
  %broadcast.splat129 = shufflevector <4 x float> %broadcast.splatinsert128, <4 x float> poison, <4 x i32> zeroinitializer
  %cmp.n = icmp eq i64 %n.vec125, %i.gd
  br label %.preheader.us.i

.preheader.us.i:                                  ; preds = %._crit_edge.i, %.split.us.i
  %.02330.us.i = phi i32 [ 0, %.split.us.i ], [ %4, %._crit_edge.i ] ; 2 uses
  %.02429.us.i = phi ptr [ %i.fs, %.split.us.i ], [ %.lcssa, %._crit_edge.i ] ; 3 uses
  %i.gg = uitofp i32 %.02330.us.i to float
  %i.gh = fmul float %i.fy, %i.gg                 ; 2 uses
  br i1 %min.iters.check122, label %scalar.ph121.preheader, label %vector.ph123

vector.ph123:                                     ; preds = %.preheader.us.i
  %i.gi = getelementptr i8, ptr %.02429.us.i, i64 %i.gf ; 2 uses
  %broadcast.splatinsert126 = insertelement <4 x float> poison, float %i.gh, i64 0
...
vector.body130:                                   ; preds = %vector.body130, %vector.ph123
  %index131 = phi i64 [ 0, %vector.ph123 ], [ %index.next135, %vector.body130 ] ; 2 uses
  %vec.ind132 = phi <4 x i32> [ <i32 0, i32 1, i32 2, i32 3>, %vector.ph123 ], [ %vec.ind.next136, %vector.body130 ] ; 2 uses
  %i.gj = mul i64 %index131, 12
  %next.gep133 = getelementptr i8, ptr %.02429.us.i, i64 %i.gj
  %i.gk = uitofp <4 x i32> %vec.ind132 to <4 x float>
  %i.gl = fmul <4 x float> %broadcast.splat129, %i.gk
  %i.gm = shufflevector <4 x float> %i.gl, <4 x float> %broadcast.splat127, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %interleaved.vec134 = shufflevector <8 x float> %i.gm, <8 x float> <float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float poison, float poison, float poison, float poison>, <12 x i32> <i32 0, i32 4, i32 8, i32 1, i32 5, i32 9, i32 2, i32 6, i32 10, i32 3, i32 7, i32 11>
  store <12 x float> %interleaved.vec134, ptr %next.gep133, align 4
  %index.next135 = add nuw i64 %index131, 4       ; 2 uses
  %vec.ind.next136 = add nuw <4 x i32> %vec.ind132, splat (i32 4)
  %i.gn = icmp eq i64 %index.next135, %n.vec125
  br i1 %i.gn, label %middle.block137, label %vector.body130, !llvm.loop !27

middle.block137:                                  ; preds = %vector.body130
  br i1 %cmp.n, label %._crit_edge.i, label %scalar.ph121.preheader

scalar.ph121.preheader:                           ; preds = %.preheader.us.i, %middle.block137
  %.028.us.i.ph = phi i32 [ 0, %.preheader.us.i ], [ %i.ge, %middle.block137 ]
  %.127.us.i.ph = phi ptr [ %.02429.us.i, %.preheader.us.i ], [ %i.gi, %middle.block137 ]
  %i.go = insertelement <2 x float> <float poison, float 0.000000e+00>, float %i.gh, i64 0
  br label %scalar.ph121

._crit_edge.i:                                    ; preds = %scalar.ph121, %middle.block137
  %.lcssa = phi ptr [ %i.gi, %middle.block137 ], [ %i.gt, %scalar.ph121 ]
  %4 = add nuw i32 %.02330.us.i, 1                ; 2 uses
  %exitcond31.not.i = icmp eq i32 %4, %i.at
  br i1 %exitcond31.not.i, label %_ZN6Assimp11HMPImporter21GenerateTextureCoordsEjj.exit, label %.preheader.us.i, !llvm.loop !11

scalar.ph121:                                     ; preds = %scalar.ph121.preheader, %scalar.ph121
  %.028.us.i = phi i32 [ %i.gs, %scalar.ph121 ], [ %.028.us.i.ph, %scalar.ph121.preheader ] ; 2 uses
  %.127.us.i = phi ptr [ %i.gt, %scalar.ph121 ], [ %.127.us.i.ph, %scalar.ph121.preheader ] ; 3 uses
  %i.gp = getelementptr inbounds nuw i8, ptr %.127.us.i, i64 4
  %i.gq = uitofp i32 %.028.us.i to float
  %i.gr = fmul float %i.gc, %i.gq
  store float %i.gr, ptr %.127.us.i, align 4
  store <2 x float> %i.go, ptr %i.gp, align 4
  %i.gs = add nuw i32 %.028.us.i, 1               ; 2 uses
  %i.gt = getelementptr inbounds nuw i8, ptr %.127.us.i, i64 12 ; 2 uses
  %exitcond.not.i = icmp eq i32 %i.gs, %i.au
  br i1 %exitcond.not.i, label %._crit_edge.i, label %scalar.ph121, !llvm.loop !28

_ZN6Assimp11HMPImporter21GenerateTextureCoordsEjj.exit: ; preds = %._crit_edge.i, %bb.b, %_ZN10aiVector3tIfEdVEf.exit.i.us.preheader
  tail call void @_ZN6Assimp11HMPImporter20CreateOutputFaceListEjj(ptr noundef nonnull align 8 dereferenceable(159) %0, i32 noundef %i.au, i32 noundef %i.at)
...
.preheader.us:                                    ; preds = %.split.us, %._crit_edge
  %.02330.us = phi i32 [ 0, %.split.us ], [ %3, %._crit_edge ] ; 2 uses
  %.02429.us = phi ptr [ %i.g, %.split.us ], [ %.lcssa, %._crit_edge ] ; 3 uses
  %i.v = uitofp i32 %.02330.us to float
  %i.w = fmul float %i.n, %i.v                    ; 2 uses
  br i1 %min.iters.check, label %scalar.ph.preheader, label %vector.ph

vector.ph:                                        ; preds = %.preheader.us
  %i.x = getelementptr i8, ptr %.02429.us, i64 %i.u ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep = getelementptr i8, ptr %.02429.us, i64 %i.y
...
scalar.ph.preheader:                              ; preds = %.preheader.us, %middle.block
  %.028.us.ph = phi i32 [ 0, %.preheader.us ], [ %i.t, %middle.block ]
  %.127.us.ph = phi ptr [ %.02429.us, %.preheader.us ], [ %i.x, %middle.block ]
...
._crit_edge:                                      ; preds = %scalar.ph, %middle.block
  ...
  %3 = add nuw i32 %.02330.us, 1                  ; 2 uses
  %exitcond31.not = icmp eq i32 %3, %2
  br i1 %exitcond31.not, label %.loopexit, label %.preheader.us, !llvm.loop !11

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %.028.us = phi i32 [ %i.ah, %scalar.ph ], [ %.028.us.ph, %scalar.ph.preheader ] ; 2 uses
  %.127.us = phi ptr [ %i.ai, %scalar.ph ], [ %.127.us.ph, %scalar.ph.preheader ] ; 3 uses
  %i.ae = getelementptr inbounds nuw i8, ptr %.127.us, i64 4
  %i.af = uitofp i32 %.028.us to float
  %i.ag = fmul float %i.r, %i.af
  store float %i.ag, ptr %.127.us, align 4
  store <2 x float> %i.ad, ptr %i.ae, align 4
  %i.ah = add nuw i32 %.028.us, 1                 ; 2 uses
  %i.ai = getelementptr inbounds nuw i8, ptr %.127.us, i64 12 ; 2 uses
...
.loopexit131.thread:                              ; preds = %.loopexit133
  ...
  %.not172 = icmp eq ptr %i.bi, null
  br i1 %.not172, label %.loopexit130, label %.loopexit130.loopexit
...
.lr.ph152:                                        ; preds = %.loopexit130
  ...
  br i1 %.not154, label %._crit_edge.split, label %.lr.ph.us.preheader

.lr.ph.us.preheader:                              ; preds = %.lr.ph152
  %wide.trip.count162 = zext i32 %i.g to i64
  %wide.trip.count = zext i32 %i.f to i64
  br label %.lr.ph.us

..loopexit129_crit_edge:                          ; preds = %.loopexit.us
  %exitcond162.not = icmp eq i64 %indvars.iv.next160, %wide.trip.count162
  br i1 %exitcond162.not, label %._crit_edge.split, label %.lr.ph.us, !llvm.loop !37
...
.lr.ph.us:                                        ; preds = %.lr.ph.us.preheader, %..loopexit129_crit_edge
  %indvars.iv159 = phi i64 [ 0, %.lr.ph.us.preheader ], [ %indvars.iv.next160, %..loopexit129_crit_edge ] ; 2 uses
  %.0100151.us = phi ptr [ %i.n, %.lr.ph.us.preheader ], [ %i.eb, %..loopexit129_crit_edge ]
  %.0101150.us = phi ptr [ %i.at, %.lr.ph.us.preheader ], [ %.2.us, %..loopexit129_crit_edge ]
  %.0104148.us = phi i32 [ 0, %.lr.ph.us.preheader ], [ %.3.us, %..loopexit129_crit_edge ]
  %.0107147.us = phi ptr [ %i.bq, %.lr.ph.us.preheader ], [ %.2109.us, %..loopexit129_crit_edge ]
  %.0110146.us = phi ptr [ %i.br, %.lr.ph.us.preheader ], [ %.3113.us, %..loopexit129_crit_edge ]
  %i.bu = trunc nuw i64 %indvars.iv159 to i32
  %i.bv = mul i32 %1, %i.bu
  %i.bw = zext i32 %i.bv to i64
  %indvars.iv.next160 = add nuw nsw i64 %indvars.iv159, 1 ; 3 uses
  %i.bx = trunc nuw i64 %indvars.iv.next160 to i32
  %i.by = mul i32 %1, %i.bx
  %i.bz = zext i32 %i.by to i64
  br label %bb.d

bb.d:                                             ; preds = %.lr.ph.us, %.loopexit.us
  %indvars.iv = phi i64 [ 0, %.lr.ph.us ], [ %indvars.iv.next, %.loopexit.us ] ; 3 uses
  %.1140.us = phi ptr [ %.0100151.us, %.lr.ph.us ], [ %i.eb, %.loopexit.us ] ; 3 uses
  %.1102139.us = phi ptr [ %.0101150.us, %.lr.ph.us ], [ %.2.us, %.loopexit.us ] ; 7 uses
  %.1105138.us = phi i32 [ %.0104148.us, %.lr.ph.us ], [ %.3.us, %.loopexit.us ] ; 7 uses
  %.1108137.us = phi ptr [ %.0107147.us, %.lr.ph.us ], [ %.2109.us, %.loopexit.us ] ; 7 uses
  %.1111136.us = phi ptr [ %.0110146.us, %.lr.ph.us ], [ %.3113.us, %.loopexit.us ] ; 8 uses
  store i32 4, ptr %.1140.us, align 8
  %i.ca = tail call noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #21
  %i.cb = getelementptr inbounds nuw i8, ptr %.1140.us, i64 8 ; 5 uses
  store ptr %i.ca, ptr %i.cb, align 8
  %i.cc = add nuw nsw i64 %indvars.iv, %i.bw      ; 4 uses
  %i.cd = add nuw nsw i64 %i.cc, 1                ; 4 uses
  %.not126.us = icmp samesign ult i64 %i.cd, %i.ar
  br i1 %.not126.us, label %bb.e, label %.loopexit.us

bb.e:                                             ; preds = %bb.d
  %i.ce = add nuw nsw i64 %indvars.iv, %i.bz      ; 4 uses
  %i.cf = add nuw nsw i64 %i.ce, 1                ; 4 uses
  %.not127.us = icmp samesign ult i64 %i.cf, %i.ar
  br i1 %.not127.us, label %bb.f, label %.loopexit.us

bb.f:                                             ; preds = %bb.e
  %i.cg = load ptr, ptr %i.bs, align 8
  %i.ch = getelementptr inbounds nuw [12 x i8], ptr %i.cg, i64 %i.cc
  %i.ci = getelementptr inbounds nuw i8, ptr %.1102139.us, i64 12
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %.1102139.us, ptr noundef nonnull align 4 dereferenceable(12) %i.ch, i64 12, i1 false)
  %i.cj = load ptr, ptr %i.bs, align 8
  %i.ck = getelementptr inbounds nuw [12 x i8], ptr %i.cj, i64 %i.ce
  %i.cl = getelementptr inbounds nuw i8, ptr %.1102139.us, i64 24
  ...
  %i.co = getelementptr inbounds nuw i8, ptr %.1102139.us, i64 36
  ...
  %i.cr = getelementptr inbounds nuw i8, ptr %.1102139.us, i64 48
  ...
  %i.cu = getelementptr inbounds nuw i8, ptr %.1108137.us, i64 12
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %.1108137.us, ptr noundef nonnull align 4 dereferenceable(12) %i.ct, i64 12, i1 false)
  %i.cv = load ptr, ptr %i.bt, align 8
  %i.cw = getelementptr inbounds nuw [12 x i8], ptr %i.cv, i64 %i.ce
  %i.cx = getelementptr inbounds nuw i8, ptr %.1108137.us, i64 24
  ...
  %i.da = getelementptr inbounds nuw i8, ptr %.1108137.us, i64 36
  ...
  %i.dd = getelementptr inbounds nuw i8, ptr %.1108137.us, i64 48
  ...
  %.not128.us = icmp eq ptr %i.de, null
  br i1 %.not128.us, label %.loopexit.us.loopexit, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.df = getelementptr inbounds nuw [12 x i8], ptr %i.de, i64 %i.cc
  %i.dg = getelementptr inbounds nuw i8, ptr %.1111136.us, i64 12
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %.1111136.us, ptr noundef nonnull align 4 dereferenceable(12) %i.df, i64 12, i1 false)
  %i.dh = load ptr, ptr %i.bp, align 8
  %i.di = getelementptr inbounds nuw [12 x i8], ptr %i.dh, i64 %i.ce
  %i.dj = getelementptr inbounds nuw i8, ptr %.1111136.us, i64 24
  ...
  %i.dm = getelementptr inbounds nuw i8, ptr %.1111136.us, i64 36
  ...
  %i.dp = getelementptr inbounds nuw i8, ptr %.1111136.us, i64 48
...
.loopexit.us.loopexit:                            ; preds = %bb.g, %bb.f
  %.2112.us = phi ptr [ %i.dp, %bb.g ], [ %.1111136.us, %bb.f ]
  %i.dq = add i32 %.1105138.us, 1
  %i.dr = load ptr, ptr %i.cb, align 8
  store i32 %.1105138.us, ptr %i.dr, align 4
  %i.ds = add i32 %.1105138.us, 2
  %i.dt = load ptr, ptr %i.cb, align 8
  %i.du = getelementptr inbounds nuw i8, ptr %i.dt, i64 4
  store i32 %i.dq, ptr %i.du, align 4
  %i.dv = add i32 %.1105138.us, 3
  %i.dw = load ptr, ptr %i.cb, align 8
  %i.dx = getelementptr inbounds nuw i8, ptr %i.dw, i64 8
  store i32 %i.ds, ptr %i.dx, align 4
  %i.dy = add i32 %.1105138.us, 4
  %i.dz = load ptr, ptr %i.cb, align 8
  %i.ea = getelementptr inbounds nuw i8, ptr %i.dz, i64 12
  store i32 %i.dv, ptr %i.ea, align 4
  br label %.loopexit.us

.loopexit.us:                                     ; preds = %.loopexit.us.loopexit, %bb.e, %bb.d
  %.3113.us = phi ptr [ %.1111136.us, %bb.d ], [ %.1111136.us, %bb.e ], [ %.2112.us, %.loopexit.us.loopexit ] ; 2 uses
  %.2109.us = phi ptr [ %.1108137.us, %bb.d ], [ %.1108137.us, %bb.e ], [ %i.dd, %.loopexit.us.loopexit ] ; 2 uses
  %.3.us = phi i32 [ %.1105138.us, %bb.d ], [ %.1105138.us, %bb.e ], [ %i.dy, %.loopexit.us.loopexit ] ; 2 uses
  %.2.us = phi ptr [ %.1102139.us, %bb.d ], [ %.1102139.us, %bb.e ], [ %i.cr, %.loopexit.us.loopexit ] ; 2 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.eb = getelementptr inbounds nuw i8, ptr %.1140.us, i64 16 ; 2 uses
