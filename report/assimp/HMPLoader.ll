...
.preheader.lr.ph:                                 ; preds = %.loopexit
  ...
  %i.bc = getelementptr i8, ptr %i.c, i64 36      ; 5 uses
...
vector.ph:                                        ; preds = %vector.memcheck
  %1 = load float, ptr %i.bc, align 1, !alias.scope !13 ; 2 uses
  %broadcast.splatinsert113 = insertelement <4 x float> poison, float %1, i64 0
  %broadcast.splat114 = shufflevector <4 x float> %broadcast.splatinsert113, <4 x float> poison, <4 x i32> zeroinitializer
  %i.bt = load float, ptr %i.bd, align 1, !alias.scope !13
  %broadcast.splatinsert = insertelement <4 x float> poison, float %1, i64 0
  %broadcast.splat = shufflevector <4 x float> %broadcast.splatinsert, <4 x float> poison, <4 x i32> zeroinitializer
  %2 = getelementptr i8, ptr %.04664.us, i64 %i.bp
  %3 = getelementptr i8, ptr %.04763.us, i64 %i.bq
  %4 = getelementptr i8, ptr %.04962.us, i64 %i.bq
  %5 = fmul float %i.bt, %i.br
  %broadcast.splatinsert115.a = insertelement <4 x float> poison, float %5, i64 0
...
begin_hunk_2_@_ZN6Assimp11HMPImporter19InternReadFile_HMP7Ev:bb.a
  ...
  %i.ch = fmul <4 x float> %broadcast.splat114, %i.cg
  %i.ci = fmul <4 x float> %i.ch, splat (float 8.000000e+00)
  %i.cj = shufflevector <4 x float> %i.cd, <4 x float> %broadcast.splat116.a, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
...
_ZN10aiVector3tIfEdVEf.exit.i.us.preheader:       ; preds = %vector.body, %vector.memcheck, %.preheader.us
  ...
  %.158.us.ph = phi ptr [ %.04664.us, %vector.memcheck ], [ %.04664.us, %.preheader.us ], [ %2, %vector.body ]
  %.14857.us.ph = phi ptr [ %.04763.us, %vector.memcheck ], [ %.04763.us, %.preheader.us ], [ %3, %vector.body ]
  %.15056.us.ph = phi ptr [ %.04962.us, %vector.memcheck ], [ %.04962.us, %.preheader.us ], [ %4, %vector.body ]
