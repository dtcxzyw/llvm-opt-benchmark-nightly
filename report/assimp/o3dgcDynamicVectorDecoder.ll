...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.prol, %.preheader.i.prol
  ...
  br i1 %i.ac, label %.lr.ph.i.prol, label %._crit_edge.i.loopexit.prol, !llvm.loop !2

._crit_edge.i.loopexit.prol:                      ; preds = %.lr.ph.i.prol
  %i.ad = add nuw nsw i64 %i.t, 1
  br label %.preheader.i.prol.loopexit

.preheader.i.prol.loopexit:                       ; preds = %._crit_edge.i.loopexit.prol, %.preheader.i.preheader
  %.01519.in.i.unr = phi i64 [ %i.t, %.preheader.i.preheader ], [ %.01519.i.prol, %._crit_edge.i.loopexit.prol ]
  %.01418.i.unr = phi i64 [ %i.t, %.preheader.i.preheader ], [ %i.ad, %._crit_edge.i.loopexit.prol ]
  %i.ae = sub nsw i64 0, %i.v
  %i.af = icmp eq i64 %i.r, %i.ae
  br i1 %i.af, label %_ZN5o3dgc5MergeEPll.exit, label %.preheader.i

.preheader.i:                                     ; preds = %.preheader.i.prol.loopexit, %._crit_edge.i.loopexit.1
  %.01519.in.i = phi i64 [ %.01519.i.1, %._crit_edge.i.loopexit.1 ], [ %.01519.in.i.unr, %.preheader.i.prol.loopexit ] ; 3 uses
  %.01418.i = phi i64 [ %i.ak, %._crit_edge.i.loopexit.1 ], [ %.01418.i.unr, %.preheader.i.prol.loopexit ] ; 3 uses
...
.lr.ph.i.1:                                       ; preds = %.lr.ph.i.1, %._crit_edge.i.loopexit
  %.016.i.1 = phi i64 [ %i.aj, %.lr.ph.i.1 ], [ %.01519.i.1, %._crit_edge.i.loopexit ] ; 2 uses
  ...
  br i1 %.not, label %._crit_edge.i.loopexit.1, label %.lr.ph.i.1, !llvm.loop !2

._crit_edge.i.loopexit.1:                         ; preds = %.lr.ph.i.1
  %i.ak = add nuw nsw i64 %.01418.i, 2
  %i.al = icmp sgt i64 %.01519.in.i, 3
  br i1 %i.al, label %.preheader.i, label %_ZN5o3dgc5MergeEPll.exit, !llvm.loop !3
...
.lr.ph.i:                                         ; preds = %.preheader.i, %.lr.ph.i
  ...
  br i1 %i.aq, label %.lr.ph.i, label %._crit_edge.i.loopexit, !llvm.loop !2

_ZN5o3dgc5MergeEPll.exit:                         ; preds = %.preheader.i.prol.loopexit, %._crit_edge.i.loopexit.1, %bb.b
...
.lr.ph.i25:                                       ; preds = %_ZN5o3dgc5MergeEPll.exit, %.lr.ph.i25
  ...
  br i1 %i.bi, label %.lr.ph.i25, label %._crit_edge.i24, !llvm.loop !0
...
.lr.ph.i28:                                       ; preds = %_ZN5o3dgc7IUpdateEPll.exit, %.lr.ph.i28
  ...
  br i1 %i.cc, label %.lr.ph.i28, label %._crit_edge.i26, !llvm.loop !1
...
._crit_edge:                                      ; preds = %._crit_edge.unr-lcssa, %.epil.preheader
  ...
  br i1 %exitcond39.not, label %._crit_edge37.split, label %.lr.ph, !llvm.loop !4
...
.lr.ph.new:                                       ; preds = %.lr.ph, %.lr.ph.new
  ...
  %i.av = load float, ptr %i.s, align 4
  %i.aw = tail call float @llvm.fmuladd.f32(float %i.au, float %.028, float %i.av)
  %i.ax = mul i64 %i.ap, %4
  %gep.1 = getelementptr [4 x i8], ptr %invariant.gep, i64 %i.ax
  store float %i.aw, ptr %gep.1, align 4
  %i.ay = add nuw i64 %.033, 2                    ; 2 uses
