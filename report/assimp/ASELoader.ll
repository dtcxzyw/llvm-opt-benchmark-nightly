...
vector.ph317:                                     ; preds = %vector.memcheck309
  %n.vec319 = and i64 %i.nh, 9223372036854775804  ; 3 uses
  %i.ob = and i64 %i.nh, 3
  %i.oc = shl i64 %n.vec319, 3                    ; 2 uses
...
vector.body320:                                   ; preds = %vector.body320, %vector.ph317
  %index321 = phi i64 [ 0, %vector.ph317 ], [ %index.next336, %vector.body320 ] ; 2 uses
  %offset.idx322 = shl i64 %index321, 3           ; 3 uses
  %7 = or disjoint i64 %offset.idx322, 16         ; 2 uses
  %next.gep324 = getelementptr i8, ptr %i.nk, i64 %offset.idx322
  %next.gep326 = getelementptr i8, ptr %i.nk, i64 %7
  %i.of = getelementptr i8, ptr %i.nd, i64 %offset.idx322
  %next.gep327 = getelementptr i8, ptr %i.nd, i64 %7
  %wide.vec328342 = load <4 x float>, ptr %i.of, align 4, !alias.scope !24
  %wide.vec331343 = load <4 x float>, ptr %next.gep327, align 4, !alias.scope !24
  store <4 x float> %wide.vec328342, ptr %next.gep324, align 4, !alias.scope !27, !noalias !24
  store <4 x float> %wide.vec331343, ptr %next.gep326, align 4, !alias.scope !27, !noalias !24
...
vector.ph287:                                     ; preds = %vector.memcheck283
  %n.vec289 = and i64 %i.op, 9223372036854775804  ; 3 uses
  %i.or = and i64 %i.op, 3
  %i.os = shl i64 %n.vec289, 3                    ; 2 uses
  %i.ot = getelementptr i8, ptr %i.nk, i64 %i.os
  %i.ou = getelementptr i8, ptr %i.nd, i64 %i.os
  br label %vector.body290

vector.body290:                                   ; preds = %vector.body290, %vector.ph287
  %index291 = phi i64 [ 0, %vector.ph287 ], [ %index.next303, %vector.body290 ] ; 2 uses
  %offset.idx292 = shl i64 %index291, 3           ; 3 uses
  %8 = or disjoint i64 %offset.idx292, 16         ; 2 uses
  %next.gep294.a = getelementptr i8, ptr %i.nk, i64 %offset.idx292
  %next.gep296 = getelementptr i8, ptr %i.nk, i64 %8
  %i.ov = getelementptr i8, ptr %i.nd, i64 %offset.idx292
  %next.gep297 = getelementptr i8, ptr %i.nd, i64 %8
  %wide.vec344 = load <4 x float>, ptr %i.ov, align 4, !alias.scope !33
  %wide.vec299345 = load <4 x float>, ptr %next.gep297, align 4, !alias.scope !33
  store <4 x float> %wide.vec344, ptr %next.gep294.a, align 4, !alias.scope !36, !noalias !33
  store <4 x float> %wide.vec299345, ptr %next.gep296, align 4, !alias.scope !36, !noalias !33
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep280 = getelementptr i8, ptr %i.pk, i64 %offset.idx ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep679 = getelementptr i8, ptr %i.kt, i64 %offset.idx ; 2 uses
...
vector.ph686:                                     ; preds = %.lr.ph.i.i.i.i.i319.preheader
  %n.vec688 = and i64 %i.aky, 4611686018427387900 ; 3 uses
  %i.ala = shl i64 %n.vec688, 3                   ; 2 uses
  %i.alb = getelementptr i8, ptr %i.aks, i64 %i.ala ; 2 uses
  %i.alc = getelementptr i8, ptr %i.akh, i64 %i.ala
  br label %vector.body689

vector.body689:                                   ; preds = %vector.body689, %vector.ph686
  %index690 = phi i64 [ 0, %vector.ph686 ], [ %index.next697, %vector.body689 ] ; 2 uses
  %offset.idx691 = shl i64 %index690, 3           ; 2 uses
  %next.gep692 = getelementptr i8, ptr %i.aks, i64 %offset.idx691 ; 2 uses
  %next.gep694 = getelementptr i8, ptr %i.akh, i64 %offset.idx691 ; 2 uses
