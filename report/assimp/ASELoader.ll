...
.lr.ph85:                                         ; preds = %._crit_edge68, %._crit_edge81
  ...
  %.05883 = phi i32 [ %i.da, %._crit_edge81 ], [ 0, %._crit_edge68 ]
  %.05982 = phi i32 [ %.2.lcssa, %._crit_edge81 ], [ 0, %._crit_edge68 ] ; 4 uses
...
bb.i:                                             ; preds = %bb.h
  store i32 %.05982, ptr %i.ck, align 8
...
bb.k:                                             ; preds = %._crit_edge72, %.lr.ph85
  %.1 = phi i32 [ %i.ce, %._crit_edge72 ], [ %.05982, %.lr.ph85 ] ; 2 uses
...
._crit_edge282:                                   ; preds = %_ZStneIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.thread, %bb.a
  %.sroa.20.0.lcssa.a = phi ptr [ null, %bb.a ], [ %.sroa.20.1.a, %_ZStneIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.thread ] ; 6 uses
  ...
  %.sroa.0152.0.lcssa = phi ptr [ null, %bb.a ], [ %.sroa.0152.1, %_ZStneIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.thread ] ; 2 uses
  %i.n = ptrtoint ptr %.sroa.12.0.lcssa to i64
  %i.o = ptrtoint ptr %.sroa.20.0.lcssa.a to i64  ; 2 uses
  %i.p = sub i64 %i.n, %i.o
...
bb.b:                                             ; preds = %.lr.ph281, %_ZStneIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.thread
  %.sroa.0152.0279 = phi ptr [ %i.e, %.lr.ph281 ], [ %i.ia, %_ZStneIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.thread ] ; 2 uses
  %.sroa.12.0278 = phi ptr [ null, %.lr.ph281 ], [ %.sroa.0152.1, %_ZStneIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.thread ] ; 10 uses
  %.sroa.20.0277 = phi ptr [ null, %.lr.ph281 ], [ %.sroa.12.1, %_ZStneIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.thread ] ; 7 uses
  %.sroa.0148.0276 = phi ptr [ null, %.lr.ph281 ], [ %.sroa.20.1.a, %_ZStneIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.thread ] ; 12 uses
  %i.t = load ptr, ptr %.sroa.0152.0279, align 8  ; 17 uses
...
bb.h:                                             ; preds = %bb.g
  %.not.i.i = icmp eq ptr %.sroa.20.0277, %.sroa.12.0278
  br i1 %.not.i.i, label %bb.j, label %bb.i

bb.i:                                             ; preds = %bb.h
  store ptr %i.ae, ptr %.sroa.20.0277, align 8
  br label %_ZNSt6vectorIP6aiNodeSaIS1_EE9push_backEOS1_.exit

bb.j:                                             ; preds = %bb.h
  %i.af = ptrtoint ptr %.sroa.12.0278 to i64
  %i.ag = ptrtoint ptr %.sroa.0148.0276 to i64
...
bb.l:                                             ; preds = %.noexc89
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.ap, ptr align 8 %.sroa.0148.0276, i64 %i.ah, i1 false)
...
_ZNSt6vectorIP6aiNodeSaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i.i: ; preds = %bb.l, %.noexc89
  %.not.i17.i.i.i = icmp eq ptr %.sroa.0148.0276, null
...
bb.m:                                             ; preds = %_ZNSt6vectorIP6aiNodeSaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i.i
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0148.0276, i64 noundef %i.ah) #24
...
_ZNSt6vectorIP6aiNodeSaIS1_EE9push_backEOS1_.exit: ; preds = %_ZNSt6vectorIP6aiNodeSaIS1_EE17_M_realloc_insertIJS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i, %bb.i
  ...
  %.sroa.20.4.a = phi ptr [ %i.ap, %_ZNSt6vectorIP6aiNodeSaIS1_EE17_M_realloc_insertIJS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i ], [ %.sroa.0148.0276, %bb.i ] ; 3 uses
  %.pn = phi ptr [ %i.aq, %_ZNSt6vectorIP6aiNodeSaIS1_EE17_M_realloc_insertIJS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i ], [ %.sroa.20.0277, %bb.i ]
  %.sroa.0152.4 = phi ptr [ %i.as, %_ZNSt6vectorIP6aiNodeSaIS1_EE17_M_realloc_insertIJS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i ], [ %.sroa.12.0278, %bb.i ] ; 3 uses
...
_ZStneIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.thread: ; preds = %bb.d, %bb.e, %bb.c, %_ZStneIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit, %bb.au
  %.sroa.20.1.a = phi ptr [ %.sroa.20.4.a, %bb.au ], [ %.sroa.0148.0276, %bb.e ], [ %.sroa.0148.0276, %_ZStneIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit ], [ %.sroa.0148.0276, %bb.c ], [ %.sroa.0148.0276, %bb.d ] ; 2 uses
  %.sroa.12.1 = phi ptr [ %.sroa.12.2, %bb.au ], [ %.sroa.20.0277, %bb.e ], [ %.sroa.20.0277, %_ZStneIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit ], [ %.sroa.20.0277, %bb.c ], [ %.sroa.20.0277, %bb.d ] ; 2 uses
  %.sroa.0152.1 = phi ptr [ %.sroa.0152.4, %bb.au ], [ %.sroa.12.0278, %bb.e ], [ %.sroa.12.0278, %_ZStneIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit ], [ %.sroa.12.0278, %bb.c ], [ %.sroa.12.0278, %bb.d ] ; 2 uses
  %i.ia = getelementptr inbounds nuw i8, ptr %.sroa.0152.0279, i64 8 ; 2 uses
...
bb.ax:                                            ; preds = %bb.aw
  ...
  %.not289 = icmp eq ptr %.sroa.12.0.lcssa, %.sroa.20.0.lcssa.a
...
.lr.ph287:                                        ; preds = %bb.ax, %.lr.ph287
  ...
  %i.ij = getelementptr inbounds nuw [8 x i8], ptr %.sroa.20.0.lcssa.a, i64 %i.ii
...
.loopexit:                                        ; preds = %bb.ax, %._crit_edge282
  %.not.i.i.i = icmp eq ptr %.sroa.20.0.lcssa.a, null
...
.loopexit.thread:                                 ; preds = %.lr.ph287, %.loopexit
  %i.iq = ptrtoint ptr %.sroa.0152.0.lcssa to i64
  %i.ir = sub i64 %i.iq, %i.o
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.20.0.lcssa.a, i64 noundef %i.ir) #24
...
bb.az:                                            ; preds = %.loopexit181, %.loopexit.split-lp, %bb.av, %bb.aa, %bb.z, %bb.ay
  %.sroa.20.3.a = phi ptr [ %.sroa.20.0.lcssa.a, %bb.ay ], [ %.sroa.0148.0276, %bb.z ], [ %.sroa.20.4.a, %bb.aa ], [ %.sroa.20.4.a, %bb.av ], [ %.sroa.0148.0276, %.loopexit181 ], [ %.sroa.0148.0276, %.loopexit.split-lp ] ; 3 uses
  %.sroa.0152.3 = phi ptr [ %.sroa.0152.0.lcssa, %bb.ay ], [ %.sroa.12.0278, %bb.z ], [ %.sroa.0152.4, %bb.aa ], [ %.sroa.0152.4, %bb.av ], [ %.sroa.12.0278, %.loopexit181 ], [ %.sroa.12.0278, %.loopexit.split-lp ]
  ...
  %.not.i.i.i111 = icmp eq ptr %.sroa.20.3.a, null
  br i1 %.not.i.i.i111, label %_ZNSt6vectorIP6aiNodeSaIS1_EED2Ev.exit112, label %.thread168

.thread168:                                       ; preds = %bb.az
  %i.is = ptrtoint ptr %.sroa.0152.3 to i64
  %i.it = ptrtoint ptr %.sroa.20.3.a to i64
  %i.iu = sub i64 %i.is, %i.it
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.20.3.a, i64 noundef %i.iu) #24
...
_ZNSt6vectorIbSaIbEEC2EmRKbRKS0_.exit:            ; preds = %.noexc115, %bb.l
  %.sroa.0157.0.a = phi ptr [ null, %bb.l ], [ %i.fr, %.noexc115 ] ; 4 uses
  %.sroa.15163.0 = phi ptr [ null, %bb.l ], [ %i.fp, %.noexc115 ] ; 10 uses
...
begin_hunk_17_@_Z34ComputeNormalsWithSmoothingsGroupsIN6Assimp3ASE4FaceEEvR23MeshWithSmoothingGroupsIT_E:bb.a
  ...
  %i.gd = getelementptr inbounds nuw [8 x i8], ptr %.sroa.15163.0, i64 %.zext
...
begin_hunk_18_@_Z34ComputeNormalsWithSmoothingsGroupsIN6Assimp3ASE4FaceEEvR23MeshWithSmoothingGroupsIT_E:bb.a
  ...
  %i.hz = getelementptr inbounds nuw [8 x i8], ptr %.sroa.15163.0, i64 %.zext207 ; 2 uses
...
begin_hunk_19_@_Z34ComputeNormalsWithSmoothingsGroupsIN6Assimp3ASE4FaceEEvR23MeshWithSmoothingGroupsIT_E:bb.a
  ...
  %i.ij = getelementptr inbounds nuw [8 x i8], ptr %.sroa.15163.0, i64 %.zext.1
...
begin_hunk_20_@_Z34ComputeNormalsWithSmoothingsGroupsIN6Assimp3ASE4FaceEEvR23MeshWithSmoothingGroupsIT_E:bb.a
  ...
  %i.jx = getelementptr inbounds nuw [8 x i8], ptr %.sroa.15163.0, i64 %.zext207.1 ; 2 uses
...
begin_hunk_21_@_Z34ComputeNormalsWithSmoothingsGroupsIN6Assimp3ASE4FaceEEvR23MeshWithSmoothingGroupsIT_E:bb.a
  ...
  %i.kh = getelementptr inbounds nuw [8 x i8], ptr %.sroa.15163.0, i64 %.zext.2
...
begin_hunk_22_@_Z34ComputeNormalsWithSmoothingsGroupsIN6Assimp3ASE4FaceEEvR23MeshWithSmoothingGroupsIT_E:bb.a
  ...
  %i.lu = getelementptr inbounds nuw [8 x i8], ptr %.sroa.15163.0, i64 %.zext207.2 ; 2 uses
...
bb.ac:                                            ; preds = %._crit_edge252
  %.not.i.i124 = icmp eq ptr %.sroa.15163.0, null
  br i1 %.not.i.i124, label %_ZNSt13_Bvector_baseISaIbEED2Ev.exit, label %bb.ad

bb.ad:                                            ; preds = %bb.ac
  %i.mf = ptrtoint ptr %.sroa.0157.0.a to i64
  %i.mg = ptrtoint ptr %.sroa.15163.0 to i64
  %i.mh = sub i64 %i.mf, %i.mg                    ; 2 uses
  %i.mi = ashr exact i64 %i.mh, 3
  %i.mj = sub nsw i64 0, %i.mi
  %i.mk = getelementptr inbounds [8 x i8], ptr %.sroa.0157.0.a, i64 %i.mj
...
bb.ag:                                            ; preds = %._crit_edge252
  %i.my = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %.not.i.i126 = icmp eq ptr %.sroa.15163.0, null
...
bb.ah:                                            ; preds = %.thread, %bb.ag
  ...
  %i.mz = ptrtoint ptr %.sroa.0157.0.a to i64
  %i.na = ptrtoint ptr %.sroa.15163.0 to i64
  %i.nb = sub i64 %i.mz, %i.na                    ; 2 uses
  %i.nc = ashr exact i64 %i.nb, 3
  %i.nd = sub nsw i64 0, %i.nc
  %i.ne = getelementptr inbounds [8 x i8], ptr %.sroa.0157.0.a, i64 %i.nd
