...
.lr.ph69:                                         ; preds = %bb.g, %.lr.ph69
  ...
  %i.bg = getelementptr inbounds nuw i8, ptr %.04867, i64 8 ; 2 uses
  %5 = load float, ptr %4, align 4                ; 2 uses
  %6 = load float, ptr %.04867, align 4           ; 2 uses
  ...
  %i.bm = shufflevector <2 x float> %9, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %10 = insertelement <2 x float> poison, float %i.bh, i64 0
  %11 = shufflevector <2 x float> %10, <2 x float> poison, <2 x i32> zeroinitializer
  %i.bp = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bo, <2 x float> %11, <2 x float> %i.bn)
  ...
  %i.bv = call float @llvm.fmuladd.f32(float %i.bs, float %6, float %i.bu)
  %i.bw = load float, ptr %i.ah, align 4
  %i.bx = call float @llvm.fmuladd.f32(float %i.bw, float %i.bh, float %i.bv)
