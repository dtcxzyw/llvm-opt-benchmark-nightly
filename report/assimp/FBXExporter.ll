...
bb.n:                                             ; preds = %bb.m
  %i.be = sub nuw i64 %i.ax, %i.bc                ; 5 uses
  ...
  %3 = sub nuw nsw i64 9223372036854775807, %i.bc
...
bb.n:                                             ; preds = %_ZNSt12__shared_ptrIN6Assimp8IOStreamELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit
  %i.cr = sub nuw i64 %i.ck, %i.cp                ; 5 uses
  ...
  %3 = sub nuw nsw i64 9223372036854775807, %i.cp
...
bb.u:                                             ; preds = %bb.t
  %i.cj = sub nuw i64 %i.cc, %i.ch                ; 5 uses
  ...
  %6 = sub nuw nsw i64 9223372036854775807, %i.ch
...
begin_hunk_9_@"_ZZN6Assimp11FBXExporter12WriteObjectsEvENK3$_0clEPK6aiNode":bb.a
  ...
  %78 = sub nuw nsw i64 2305843009213693951, %i.gs ; 2 uses
