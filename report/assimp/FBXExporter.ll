...
begin_hunk_1
  ...
  %i.i = zext i32 %spec.select.i.i to i64         ; 6 uses
  ...
  %.not.i3.i = icmp eq i32 %i.k, 0                ; 2 uses
  br i1 %.not.i3.i, label %.thread30, label %.lr.ph.i.i
...
.thread30:                                        ; preds = %_ZNK8aiStringeqERKS_.exit.thread.i.i, %bb.b, %bb.d
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #32
...
begin_hunk_3
  ...
  br i1 %.not.i3.i, label %_ZNK10aiMetadata3GetIfEEbRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEERT_.exit.thread, label %.lr.ph.i.i18

.lr.ph.i.i18:                                     ; preds = %.thread30
  %6 = getelementptr inbounds nuw i8, ptr %i.b, i64 8
  %7 = load ptr, ptr %6, align 8
  %wide.trip.count.i.i19 = zext i32 %i.k to i64
  br label %bb.f

bb.f:                                             ; preds = %_ZNK8aiStringeqERKS_.exit.thread.i.i21, %.lr.ph.i.i18
  %indvars.iv.i.i20 = phi i64 [ 0, %.lr.ph.i.i18 ], [ %indvars.iv.next.i.i22, %_ZNK8aiStringeqERKS_.exit.thread.i.i21 ] ; 3 uses
...
_ZNK10aiMetadata3GetIfEEbRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEERT_.exit.thread: ; preds = %_ZNK8aiStringeqERKS_.exit.thread.i.i21, %bb.g, %.thread30
