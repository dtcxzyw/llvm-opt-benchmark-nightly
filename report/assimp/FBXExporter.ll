...
bb.r:                                             ; preds = %.lr.ph2433, %_ZNSt3mapI10aiVector3tIfEmSt4lessIS1_ESaISt4pairIKS1_mEEED2Ev.exit
  ...
  %.sroa.01381.02430 = phi ptr [ null, %.lr.ph2433 ], [ %.sroa.01381.6, %_ZNSt3mapI10aiVector3tIfEmSt4lessIS1_ESaISt4pairIKS1_mEEED2Ev.exit ] ; 15 uses
  %.sroa.18.02429 = phi ptr [ null, %.lr.ph2433 ], [ %.sroa.18.3, %_ZNSt3mapI10aiVector3tIfEmSt4lessIS1_ESaISt4pairIKS1_mEEED2Ev.exit ] ; 10 uses
  ...
  %i.gp = ptrtoint ptr %.sroa.18.02429 to i64     ; 2 uses
  %i.gq = ptrtoint ptr %.sroa.01381.02430 to i64  ; 2 uses
...
.lr.ph.i.preheader:                               ; preds = %_ZNSt6vectorIiSaIiEE6resizeEm.exit
  %78 = ptrtoaddr ptr %.sroa.18.6 to i64
  %79 = ptrtoaddr ptr %.sroa.01381.02430 to i64
  %80 = ptrtoaddr ptr %.sroa.01381.11 to i64
  %81 = ptrtoaddr ptr %.sroa.18.02429 to i64
  %i.mr = add i64 %78, %79
  %i.ms = add i64 %80, %81
