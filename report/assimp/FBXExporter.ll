...
._crit_edge.i.i2519:                              ; preds = %._crit_edge.i.i2519.loopexit, %bb.uh
  ...
  %.sroa.215503.0.lcssa = phi ptr [ null, %bb.uh ], [ %.sroa.215504.1, %._crit_edge.i.i2519.loopexit ] ; 2 uses
...
begin_hunk_1_@_ZN6Assimp11FBXExporter12WriteObjectsEv:bb.a
  ...
  %.sroa.215503.013860 = phi ptr [ null, %.lr.ph13867 ], [ %.sroa.215504.1, %_ZNSt6vectorIfSaIfEE9push_backERKf.exit2606 ] ; 12 uses
...
_ZNSt6vectorIfSaIfEE9push_backERKf.exit2606:      ; preds = %bb.wf, %_ZNSt6vectorIfSaIfEE17_M_realloc_insertIJfEEEvN9__gnu_cxx17__normal_iteratorIPfS1_EEDpOT_.exit.i.i2628, %bb.vp, %_ZNSt6vectorIfSaIfEE17_M_realloc_insertIJRKfEEEvN9__gnu_cxx17__normal_iteratorIPfS1_EEDpOT_.exit.i2603
  ...
  %.sroa.215503.1 = phi ptr [ %.sroa.215503.3, %bb.vp ], [ %i.dzt, %_ZNSt6vectorIfSaIfEE17_M_realloc_insertIJRKfEEEvN9__gnu_cxx17__normal_iteratorIPfS1_EEDpOT_.exit.i2603 ], [ %i.ebl, %_ZNSt6vectorIfSaIfEE17_M_realloc_insertIJfEEEvN9__gnu_cxx17__normal_iteratorIPfS1_EEDpOT_.exit.i.i2628 ], [ %.sroa.215503.6, %bb.wf ]
  ...
  %.sroa.215504.1 = getelementptr inbounds nuw i8, ptr %.sroa.215503.1, i64 4 ; 2 uses
...
bb.y:                                             ; preds = %bb.x, %_ZNKSt4lessI10aiVector3tIfEEclERKS1_S4_.exit.i.i.i, %bb.w, %bb.u
  ...
  %.pn.i.i.i = phi i64 [ 24, %bb.x ], [ 16, %bb.w ], [ 16, %bb.u ], [ 16, %_ZNKSt4lessI10aiVector3tIfEEclERKS1_S4_.exit.i.i.i ]
  %i.hx = getelementptr inbounds nuw i8, ptr %.012.i.i.i, i64 %.pn.i.i.i
...
bb.an:                                            ; preds = %bb.am, %_ZNKSt4lessI10aiVector3tIfEEclERKS1_S4_.exit.i.i.i.i, %bb.al, %bb.aj
  ...
  %.pn.i.i.i.i = phi i64 [ 24, %bb.am ], [ 16, %bb.al ], [ 16, %bb.aj ], [ 16, %_ZNKSt4lessI10aiVector3tIfEEclERKS1_S4_.exit.i.i.i.i ]
  %i.jo = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i, i64 %.pn.i.i.i.i
...
_ZNSt6vectorIiSaIiEE9push_backEOi.exit:           ; preds = %bb.aw, %_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i.i, %bb.at
  ...
  %.sroa.18.2.a = phi ptr [ %.pn1421, %bb.at ], [ %i.lf, %_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i.i ], [ %.sroa.18.12366, %bb.aw ]
  ...
  %.sroa.18.2 = getelementptr inbounds nuw i8, ptr %.sroa.18.2.a, i64 4 ; 2 uses
...
bb.em:                                            ; preds = %bb.er, %.lr.ph.i.i.i536
  ...
  %.0811.i.i.i538 = phi ptr [ %i.es, %.lr.ph.i.i.i536 ], [ %.19.i.i.i539, %bb.er ]
...
bb.er:                                            ; preds = %bb.eq, %_ZNKSt4lessI10aiVector3tIfEEclERKS1_S4_.exit.i.i.i545, %bb.ep, %bb.en
  %.19.i.i.i539 = phi ptr [ %.0811.i.i.i538, %bb.eq ], [ %.012.i.i.i537, %bb.ep ], [ %.012.i.i.i537, %bb.en ], [ %.012.i.i.i537, %_ZNKSt4lessI10aiVector3tIfEEclERKS1_S4_.exit.i.i.i545 ] ; 6 uses
  %.pn.i.i.i540 = phi i64 [ 24, %bb.eq ], [ 16, %bb.ep ], [ 16, %bb.en ], [ 16, %_ZNKSt4lessI10aiVector3tIfEEclERKS1_S4_.exit.i.i.i545 ]
  %i.afm = getelementptr inbounds nuw i8, ptr %.012.i.i.i537, i64 %.pn.i.i.i540
...
_ZNSt8_Rb_treeI10aiVector3tIfESt4pairIKS1_iESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE14_M_lower_boundEPSt13_Rb_tree_nodeIS4_EPSt18_Rb_tree_node_baseRS3_.exit.i.i: ; preds = %bb.er
  %i.afn = icmp eq ptr %.19.i.i.i539, %i.es
...
bb.es:                                            ; preds = %_ZNSt8_Rb_treeI10aiVector3tIfESt4pairIKS1_iESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE14_M_lower_boundEPSt13_Rb_tree_nodeIS4_EPSt18_Rb_tree_node_baseRS3_.exit.i.i
  %i.afo = getelementptr inbounds nuw i8, ptr %.19.i.i.i539, i64 32
...
bb.eu:                                            ; preds = %bb.es
  %i.afs = getelementptr inbounds nuw i8, ptr %.19.i.i.i539, i64 36
...
bb.ev:                                            ; preds = %bb.eu
  %i.afv = getelementptr inbounds nuw i8, ptr %.19.i.i.i539, i64 40
...
bb.fa:                                            ; preds = %bb.ez, %_ZNKSt4lessI10aiVector3tIfEEclERKS1_S4_.exit.i.i.i.i558, %bb.ey, %bb.ew
  ...
  %.pn.i.i.i.i552 = phi i64 [ 24, %bb.ez ], [ 16, %bb.ey ], [ 16, %bb.ew ], [ 16, %_ZNKSt4lessI10aiVector3tIfEEclERKS1_S4_.exit.i.i.i.i558 ]
  %i.agk = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i548, i64 %.pn.i.i.i.i552
...
bb.gb:                                            ; preds = %_ZNKSt4lessI10aiVector3tIfEEclERKS1_S4_.exit.i.i544, %bb.ev, %bb.et
  %i.ajs = getelementptr inbounds nuw i8, ptr %.19.i.i.i539, i64 44 ; 2 uses
