...
begin_hunk_0_@_ZN6Assimp22FindDegeneratesProcess13ExecuteOnMeshEP6aiMesh:bb.a
  ...
  %indvars.iv197 = phi i64 [ 0, %.lr.ph178 ], [ %indvars.iv.next198.pre-phi, %.thread145 ] ; 4 uses
...
.thread:                                          ; preds = %bb.n, %._crit_edge.i.i.i.i, %.loopexit
  %i.ax = icmp ugt i32 %i.ad, 4
  %i.ay = trunc nuw i64 %indvars.iv197 to i32     ; 2 uses
  %i.az = add i32 %i.ay, 2
  %.sroa.speculated = call i32 @llvm.umin.i32(i32 %i.az, i32 %i.ad)
  %.0 = select i1 %i.ax, i32 %.sroa.speculated, i32 %i.ad ; 2 uses
  %3 = add nuw nsw i64 %indvars.iv197, 1          ; 4 uses
  %4 = zext i32 %.0 to i64
  %.not112167 = icmp samesign ult i64 %3, %4
...
bb.o:                                             ; preds = %.lr.ph172, %_ZNK10aiVector3tIfEeqERKS0_.exit.thread
  ...
  %.094.in170 = phi i32 [ %i.ay, %.lr.ph172 ], [ %.195, %_ZNK10aiVector3tIfEeqERKS0_.exit.thread ]
  %.1103169 = phi i1 [ %.0102174, %.lr.ph172 ], [ %.3105, %_ZNK10aiVector3tIfEeqERKS0_.exit.thread ] ; 4 uses
  %.1139168 = phi i32 [ %.0, %.lr.ph172 ], [ %.2, %_ZNK10aiVector3tIfEeqERKS0_.exit.thread ] ; 4 uses
