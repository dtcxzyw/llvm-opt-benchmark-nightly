...
_ZN12aiMatrix4x4tIfEixEj.exit268:                 ; preds = %.lr.ph1326, %bb.at
  ...
  %.sroa.7752.0.copyload = load float, ptr %.sroa.7752.0..sroa_idx, align 4 ; 4 uses
  ...
  %i.ln = load <2 x float>, ptr %.sroa.5750.0..sroa_idx, align 4 ; 8 uses
  %i.lo = shufflevector <2 x float> %i.ln, <2 x float> poison, <3 x i32> <i32 0, i32 poison, i32 poison>
  %36 = shufflevector <2 x float> %i.ln, <2 x float> poison, <3 x i32> <i32 0, i32 poison, i32 poison>
  %i.lp = shufflevector <2 x float> %i.ln, <2 x float> poison, <3 x i32> <i32 poison, i32 1, i32 poison>
  %i.lq = extractelement <2 x float> %i.ln, i64 1 ; 3 uses
  %i.lr = fmul float %.sroa.0749.0.copyload, %i.lq
  %i.ls = shufflevector <3 x float> %i.lm, <3 x float> %i.lp, <3 x i32> <i32 0, i32 1, i32 4> ; 4 uses
  ...
  %37 = shufflevector <2 x float> %i.ln, <2 x float> poison, <3 x i32> <i32 0, i32 1, i32 poison>
  %38 = shufflevector <3 x float> %i.ls, <3 x float> <float poison, float poison, float -2.000000e+00>, <3 x i32> <i32 2, i32 1, i32 5>
  ...
  %i.mk = shufflevector <3 x float> %i.mj, <3 x float> %36, <3 x i32> <i32 0, i32 3, i32 poison>
  ...
  %i.mq = shufflevector <3 x float> %37, <3 x float> %i.mp, <3 x i32> <i32 0, i32 1, i32 3>
  %i.mr = call <3 x float> @llvm.fmuladd.v3f32(<3 x float> %i.mq, <3 x float> %38, <3 x float> %i.mb) ; 2 uses
  %i.ms = fmul <3 x float> %i.mr, <float 2.000000e+00, float 2.000000e+00, float 1.000000e+00> ; 2 uses
  %39 = shufflevector <3 x float> %i.lo, <3 x float> %i.ls, <3 x i32> <i32 0, i32 poison, i32 5>
  %40 = shufflevector <3 x float> %39, <3 x float> %i.mp, <3 x i32> <i32 0, i32 4, i32 2>
  %41 = shufflevector <3 x float> %i.ls, <3 x float> <float poison, float -2.000000e+00, float poison>, <3 x i32> <i32 1, i32 4, i32 1>
  ...
  %i.mv = call <3 x float> @llvm.fmuladd.v3f32(<3 x float> %40, <3 x float> %41, <3 x float> %i.mu) ; 3 uses
