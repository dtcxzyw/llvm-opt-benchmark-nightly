...
bb.e:                                             ; preds = %bb.d, %bb.c
  %i.h = getelementptr inbounds nuw i8, ptr %i.e, i64 4 ; 5 uses
...
begin_hunk_3_@_ZN6Assimp19ComputeMaterialHashEPK10aiMaterialb:bb.a
  ...
  %i.bb = getelementptr inbounds nuw i8, ptr %.05463.i, i64 8
  %i.bc = lshr i32 %i.ba, 11
  %i.bd = add i32 %i.bc, %i.ba                    ; 2 uses
  %i.be = add nsw i32 %.15761.i, -2               ; 2 uses
  %.not.i.1 = icmp eq i32 %i.be, 0
  br i1 %.not.i.1, label %._crit_edge.loopexit.i, label %.lr.ph.i, !llvm.loop !24

._crit_edge.loopexit.i:                           ; preds = %.lr.ph.i, %.lr.ph.i.prol.loopexit
  %.lcssa = phi i32 [ %.lcssa.unr, %.lr.ph.i.prol.loopexit ], [ %i.bd, %.lr.ph.i ]
  %2 = add nsw i32 %i.n, -1
  %3 = zext nneg i32 %2 to i64
  %4 = shl nuw nsw i64 %3, 2
  %5 = getelementptr i8, ptr %i.h, i64 %4
  %scevgep.i = getelementptr i8, ptr %5, i64 4
  br label %._crit_edge.i

._crit_edge.i:                                    ; preds = %._crit_edge.loopexit.i, %bb.g
  %.055.lcssa.i = phi i32 [ %.070, %bb.g ], [ %.lcssa, %._crit_edge.loopexit.i ] ; 4 uses
  %.054.lcssa.i = phi ptr [ %i.h, %bb.g ], [ %scevgep.i, %._crit_edge.loopexit.i ] ; 4 uses
...
begin_hunk_4_@_ZN6Assimp19ComputeMaterialHashEPK10aiMaterialb:bb.a
  ...
  %i.ct = load ptr, ptr %i.cs, align 8            ; 8 uses
...
bb.m:                                             ; preds = %bb.l, %bb.k
  ...
  %i.db = lshr i32 %.056.i21, 2                   ; 5 uses
...
begin_hunk_6_@_ZN6Assimp19ComputeMaterialHashEPK10aiMaterialb:bb.a
  ...
  %i.dn = getelementptr inbounds nuw i8, ptr %i.ct, i64 4
...
.lr.ph.i23.prol.loopexit:                         ; preds = %.lr.ph.i23.prol, %.lr.ph.i23.preheader
  ...
  br i1 %i.dr, label %._crit_edge.loopexit.i28, label %.lr.ph.i23
...
begin_hunk_7_@_ZN6Assimp19ComputeMaterialHashEPK10aiMaterialb:bb.a
  ...
  %i.ep = getelementptr inbounds nuw i8, ptr %.05463.i24, i64 8
  %i.eq = lshr i32 %i.eo, 11
  %i.er = add i32 %i.eq, %i.eo                    ; 2 uses
  %i.es = add nsw i32 %.15761.i26, -2             ; 2 uses
  %.not.i27.1 = icmp eq i32 %i.es, 0
  br i1 %.not.i27.1, label %._crit_edge.loopexit.i28, label %.lr.ph.i23, !llvm.loop !24

._crit_edge.loopexit.i28:                         ; preds = %.lr.ph.i23, %.lr.ph.i23.prol.loopexit
  %.lcssa88 = phi i32 [ %.lcssa91.unr, %.lr.ph.i23.prol.loopexit ], [ %i.er, %.lr.ph.i23 ]
  %6 = add nsw i32 %i.db, -1
  %7 = zext nneg i32 %6 to i64
  %8 = shl nuw nsw i64 %7, 2
  %9 = getelementptr i8, ptr %i.ct, i64 %8
  %scevgep.i29 = getelementptr i8, ptr %9, i64 4
  br label %._crit_edge.i28

._crit_edge.i28:                                  ; preds = %._crit_edge.loopexit.i28, %bb.m
  %.055.lcssa.i31 = phi i32 [ %i.cr, %bb.m ], [ %.lcssa88, %._crit_edge.loopexit.i28 ] ; 4 uses
  %.054.lcssa.i32 = phi ptr [ %i.ct, %bb.m ], [ %scevgep.i29, %._crit_edge.loopexit.i28 ] ; 4 uses
...
bb.n:                                             ; preds = %._crit_edge.i28
  %i.et = load i16, ptr %.054.lcssa.i32, align 1
  %i.eu = zext i16 %i.et to i32
  %i.ev = add i32 %.055.lcssa.i31, %i.eu          ; 2 uses
  %i.ew = shl i32 %i.ev, 16
  %i.ex = getelementptr inbounds nuw i8, ptr %.054.lcssa.i32, i64 2
...
bb.o:                                             ; preds = %._crit_edge.i28
  %i.fg = load i16, ptr %.054.lcssa.i32, align 1
  %i.fh = zext i16 %i.fg to i32
  %i.fi = add i32 %.055.lcssa.i31, %i.fh          ; 2 uses
...
bb.p:                                             ; preds = %._crit_edge.i28
  %i.fn = load i8, ptr %.054.lcssa.i32, align 1
  %i.fo = sext i8 %i.fn to i32
  %i.fp = add i32 %.055.lcssa.i31, %i.fo          ; 2 uses
...
bb.q:                                             ; preds = %bb.p, %bb.o, %bb.n, %._crit_edge.i28
  %.1.i31 = phi i32 [ %.055.lcssa.i31, %._crit_edge.i28 ], [ %i.ff, %bb.n ], [ %i.fm, %bb.o ], [ %i.ft, %bb.p ] ; 2 uses
