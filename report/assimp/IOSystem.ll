...
bb.c:                                             ; preds = %bb.b
  %i.h = tail call i32 @__cxa_guard_acquire(ptr nonnull @_ZGVZNK6Assimp8IOSystem16CurrentDirectoryB5cxx11EvE5DummyB5cxx11) #4
...
begin_hunk_1_@_ZNK6Assimp8IOSystem16CurrentDirectoryB5cxx11Ev:bb.a
  ...
  %i.i = tail call i32 @__cxa_atexit(ptr nonnull @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev, ptr nonnull @_ZZNK6Assimp8IOSystem16CurrentDirectoryB5cxx11EvE5DummyB5cxx11, ptr nonnull @__dso_handle) #4 ; 0 uses
  tail call void @__cxa_guard_release(ptr nonnull @_ZGVZNK6Assimp8IOSystem16CurrentDirectoryB5cxx11EvE5DummyB5cxx11) #4
  br label %bb.f
