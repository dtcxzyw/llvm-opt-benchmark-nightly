...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.k
  %.0.idx76 = phi i64 [ %.0.add, %bb.k ], [ %.add, %.lr.ph.preheader ] ; 4 uses
...
.lr.ph..critedge_crit_edge:                       ; preds = %.lr.ph
  %.0.idx76.lcssa.a = phi i64 [ %.0.idx76, %.lr.ph ] ; 2 uses
  %scevgep94 = getelementptr i8, ptr %4, i64 %.0.idx76.lcssa.a
  br label %.critedge

.critedge:                                        ; preds = %.critedgesplit, %.lr.ph..critedge_crit_edge
  %.0.idx.lcssa = phi i64 [ %.0.idx76.lcssa.a, %.lr.ph..critedge_crit_edge ], [ %i.bd, %.critedgesplit ] ; 3 uses
  %.0.ptr.lcssa = phi ptr [ %scevgep94, %.lr.ph..critedge_crit_edge ], [ %scevgep, %.critedgesplit ] ; 3 uses
