...
bb.s:                                             ; preds = %bb.r
  ...
  %i.cg = sub i64 %.1163302.us, %i.by             ; 2 uses
...
bb.w:                                             ; preds = %bb.v
  ...
  %i.cu = sub i64 %.1163302, %i.cl                ; 2 uses
...
bb.ad:                                            ; preds = %bb.ac
  ...
  %i.gc = sub i64 %.0313628, %i.fl                ; 2 uses
...
zip_file_move.exit.i:                             ; preds = %bb.k
  ...
  %i.bs = sub nsw i64 %.02536.i, %i.bl            ; 2 uses
  %i.bt = add nuw nsw i64 %i.bl, %.037.i          ; 2 uses
  %3 = icmp sgt i64 %i.bs, 0
  br i1 %3, label %.lr.ph.i, label %zip_file_move.exit.thread.i
