...
begin_hunk_13_@_ZN6Assimp23FlipWindingOrderProcess11ProcessMeshEP6aiMesh:bb.a
  ...
  %.sroa.0.0.copyload = load <4 x float>, ptr %i.ek, align 4
  ...
  store <4 x float> %.sroa.0.0.copyload, ptr %i.ep, align 4
...
begin_hunk_20_@_ZN6Assimp23FlipWindingOrderProcess11ProcessMeshEP6aiMesh:bb.a
  ...
  %.sroa.0.0.copyload198 = load <4 x float>, ptr %i.gv, align 4
  ...
  store <4 x float> %.sroa.0.0.copyload198, ptr %i.ha, align 4
