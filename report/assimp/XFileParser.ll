...
bb.am:                                            ; preds = %.loopexit, %.loopexit.split-lp, %bb.af, %bb.ag, %bb.ae
  %.sroa.0.1 = phi ptr [ null, %bb.ae ], [ %i.cm, %bb.af ], [ %i.cm, %bb.ag ], [ %i.cm, %.loopexit.split-lp ], [ %i.cm, %.loopexit ]
  %.sroa.14.1 = phi ptr [ null, %bb.ae ], [ %i.cq, %bb.af ], [ %i.cq, %bb.ag ], [ %i.cq, %.loopexit.split-lp ], [ %i.cq, %.loopexit ]
  %.pn.pn.pn = phi { ptr, i32 } [ %i.di, %bb.ae ], [ %i.dj, %bb.af ], [ %i.dk, %bb.ag ], [ %lpad.loopexit.split-lp, %.loopexit.split-lp ], [ %lpad.loopexit, %.loopexit ]
