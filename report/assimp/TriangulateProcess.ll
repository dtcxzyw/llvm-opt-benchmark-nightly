...
bb.b:                                             ; preds = %bb.a
  ...
  %2 = load double, ptr %i.ar, align 8
  %i.as = getelementptr inbounds nuw i8, ptr %0, i64 56
  %i.at = load double, ptr %i.as, align 8         ; 2 uses
  %i.au = fsub double %i.af, %i.at
  %3 = insertelement <2 x double> poison, double %i.aq, i64 0
  %i.av = insertelement <2 x double> %3, double %i.au, i64 1
  %i.aw = insertelement <2 x double> poison, double %2, i64 0
  %i.ax = shufflevector <2 x double> %i.aw, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
