...
bb.a:
  ...
  %i.h = load double, ptr %i.g, align 8           ; 7 uses
  ...
  %i.p = load double, ptr %i.o, align 8           ; 7 uses
...
bb.b:                                             ; preds = %bb.a
  %i.y = fcmp olt double %i.k, %i.m
  %i.z = select i1 %i.y, double %i.k, double %i.m ; 2 uses
  %i.aa = fcmp olt double %i.z, %i.p
  %2 = select i1 %i.aa, double %i.z, double %i.p
  %i.ab = fcmp olt double %i.s, %i.f
  %i.ac = select i1 %i.ab, double %i.s, double %i.f ; 2 uses
  %i.ad = fcmp olt double %i.ac, %i.h
  %3 = select i1 %i.ad, double %i.ac, double %i.h
  %i.ae = fcmp olt double %i.m, %i.k
  %i.af = select i1 %i.ae, double %i.k, double %i.m ; 2 uses
  %i.ag = fcmp olt double %i.p, %i.af
  %4 = select i1 %i.ag, double %i.af, double %i.p
  %i.ah = fcmp olt double %i.f, %i.s
  %i.ai = select i1 %i.ah, double %i.s, double %i.f ; 2 uses
  %i.aj = fcmp olt double %i.h, %i.ai
  %5 = select i1 %i.aj, double %i.ai, double %i.h
