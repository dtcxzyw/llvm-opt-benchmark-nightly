...
bb.b:                                             ; preds = %.lr.ph220, %_ZNSt6vectorISt4pairIm10aiVector3tIdEESaIS3_EE12emplace_backIJRmRKS2_EEERS3_DpOT_.exit
  ...
  %i.cj = load <2 x double>, ptr %i.cd, align 8, !noalias !80 ; 4 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %6 = tail call double @llvm.fmuladd.f64(double %i.cl, double %i.cl, double %i.cw)
  %7 = insertelement <2 x double> poison, double %i.ct, i64 0
  %8 = shufflevector <2 x double> %7, <2 x double> %i.cj, <2 x i32> <i32 0, i32 2>
  %i.dd = insertelement <2 x double> poison, double %i.cv, i64 0
  %i.de = insertelement <2 x double> %i.dd, double %i.cx, i64 1
  %9 = fsub <2 x double> %8, %i.de                ; 4 uses
  %10 = insertelement <2 x double> %9, double %i.as, i64 1
  %11 = insertelement <2 x double> poison, double %6, i64 0
  %12 = insertelement <2 x double> %11, double %i.dc, i64 1
  %13 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %9, <2 x double> %10, <2 x double> %12) ; 2 uses
  %i.df = insertelement <2 x double> %13, double 1.000000e+00, i64 0
  %i.dg = insertelement <2 x double> %13, double %i.cp, i64 1
  %14 = fdiv <2 x double> %i.df, %i.dg            ; 3 uses
  %15 = load double, ptr %i.av, align 8, !noalias !83
  %16 = load double, ptr %1, align 8              ; 2 uses
  %17 = extractelement <2 x double> %i.cj, i64 0  ; 4 uses
  %18 = fsub double %16, %17
  %19 = load double, ptr %i.ao, align 8           ; 2 uses
  %20 = fsub double %19, %i.cz
  %i.dh = insertelement <2 x double> poison, double %i.db, i64 0
  %i.di = insertelement <2 x double> %i.dh, double %20, i64 1
  %i.dj = fmul <2 x double> %i.ck, %i.di
  %i.dk = shufflevector <2 x double> %i.dj, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %21 = insertelement <2 x double> %9, double %18, i64 0
  %i.dl = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %21, <2 x double> %i.ck, <2 x double> %i.dk) ; 2 uses
  ...
  %i.dt = fadd double %15, %i.dq                  ; 2 uses
  %i.du = extractelement <2 x double> %14, i64 0  ; 3 uses
  %foldExtExtBinop = fmul <2 x double> %14, %i.dl
  ...
  %22 = extractelement <2 x double> %9, i64 0     ; 2 uses
  %23 = fmul double %22, %.sroa.speculated
  %i.ea = fadd double %17, %i.dy
  %i.eb = fadd double %i.cz, %i.dz
  %i.ec = fadd double %i.cv, %23                  ; 2 uses
  %i.ed = fsub double %i.ea, %16                  ; 2 uses
  %i.ee = fsub double %i.eb, %19                  ; 2 uses
...
bb.n:                                             ; preds = %bb.d
  ...
  %i.gv = extractelement <2 x double> %14, i64 1  ; 2 uses
...
.lr.ph967.preheader:                              ; preds = %.critedge8
  %19 = insertelement <2 x double> poison, double %i.als, i64 0
  %20 = insertelement <2 x double> %19, double %i.aly, i64 1
  %21 = insertelement <2 x double> poison, double %i.amc, i64 0
  %22 = insertelement <2 x double> %21, double %i.amg, i64 1
...
.lr.ph967:                                        ; preds = %.lr.ph967.preheader, %.critedge10
  ...
  %i.ano = load double, ptr %i.ann, align 8, !noalias !199 ; 2 uses
  ...
  %i.anu = load double, ptr %i.ant, align 8, !noalias !199 ; 2 uses
  %23 = fmul double %i.alz, %i.anq
  %24 = insertelement <2 x double> poison, double %i.anu, i64 0
  %25 = insertelement <2 x double> %24, double %i.ano, i64 1 ; 2 uses
  %26 = insertelement <2 x double> poison, double %i.ans, i64 0
  %27 = insertelement <2 x double> %26, double %23, i64 1
  %28 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %20, <2 x double> %25, <2 x double> %27) ; 2 uses
  %29 = extractelement <2 x double> %28, i64 0
  %i.anv = fadd double %i.alw, %29
  %i.anw = fmul double %i.amh, %i.anq
  %30 = shufflevector <2 x double> %28, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %31 = insertelement <2 x double> %30, double %i.anw, i64 1
  %32 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %22, <2 x double> %25, <2 x double> %31) ; 2 uses
  %33 = extractelement <2 x double> %32, i64 0
  %34 = fadd double %i.ame, %33
  %i.anx = fsub double %i.anv, %i.amo             ; 2 uses
  %35 = fsub double %34, %i.amq                   ; 2 uses
  %36 = fmul double %i.ald, %35
  %i.any = insertelement <2 x double> %i.anj, double %i.anx, i64 1
  %i.anz = insertelement <2 x double> %i.ank, double %i.anu, i64 0
  %37 = shufflevector <2 x double> %32, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %i.aoa = insertelement <2 x double> %37, double %36, i64 1
...
bb.dr:                                            ; preds = %.lr.ph967
  ...
  %i.aom = fsub double %i.anx, %i.aoj             ; 2 uses
  %i.aon = fsub double %35, %i.aok                ; 2 uses
