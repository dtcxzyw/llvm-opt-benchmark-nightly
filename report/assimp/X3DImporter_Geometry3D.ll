...
.lr.ph1014:                                       ; preds = %.lr.ph1014.preheader, %.lr.ph1014
  ...
  %i.ahy = getelementptr inbounds nuw [8 x i8], ptr %i.ahx, i64 %.02281012
  %20 = load <2 x float>, ptr %i.ahy, align 4     ; 3 uses
  %i.ahz = shufflevector <2 x float> %20, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %22 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %21, <2 x float> zeroinitializer, <2 x float> %i.aia)
  %23 = fadd <2 x float> %22, zeroinitializer
  %24 = extractelement <2 x float> %i.aia, i64 1
  %i.aib = extractelement <2 x float> %20, i64 1
  %i.aic = call float @llvm.fmuladd.f32(float %i.ahl, float %i.aib, float %24)
  ...
  store <2 x float> %23, ptr %i.aif, align 4
  ...
  %25 = getelementptr inbounds nuw i8, ptr %i.aih, i64 24
  %26 = getelementptr inbounds nuw i8, ptr %i.aih, i64 32
  %27 = load float, ptr %26, align 4
  %i.aiq = getelementptr inbounds nuw i8, ptr %i.ail, i64 8
  %28 = load ptr, ptr %15, align 8
  %29 = getelementptr inbounds nuw [12 x i8], ptr %28, i64 %.02301016 ; 2 uses
  %30 = load <2 x float>, ptr %i.aih, align 4
  %31 = load <3 x float>, ptr %i.ail, align 4     ; 5 uses
  %32 = load float, ptr %i.aip, align 4
  %33 = shufflevector <3 x float> %31, <3 x float> poison, <2 x i32> zeroinitializer
  %34 = fmul <2 x float> %30, %33
  %35 = extractelement <3 x float> %31, i64 0
  %36 = fmul float %i.aij, %35
  %37 = load <2 x float>, ptr %i.aim, align 4
  %38 = shufflevector <3 x float> %31, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.air = fmul <2 x float> %37, %38
  %39 = fmul float %i.aio, %32
  %40 = load <2 x float>, ptr %25, align 4
  %41 = shufflevector <3 x float> %31, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %i.ais = fmul <2 x float> %40, %41
  %42 = extractelement <3 x float> %31, i64 2
  %43 = fmul float %27, %42
  %44 = fadd <2 x float> %34, %i.air
  %45 = fadd float %36, %39
  %i.ait = fadd <2 x float> %44, %i.ais
  %46 = fadd float %45, %43
  %i.aiu = load <2 x float>, ptr %29, align 4
  %i.aiv = fadd <2 x float> %i.ait, %i.aiu
  %i.aiw = getelementptr inbounds nuw i8, ptr %29, i64 8
  %i.aix = load float, ptr %i.aiw, align 4
  %i.aiy = fadd float %46, %i.aix
  store <2 x float> %i.aiv, ptr %i.ail, align 4
  store float %i.aiy, ptr %i.aiq, align 4
