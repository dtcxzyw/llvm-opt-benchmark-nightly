...
.noexc312:                                        ; preds = %_ZNKSt6vectorIfSaIfEE12_M_check_lenEmPKc.exit.i.i305
  %i.fx = getelementptr inbounds i8, ptr %i.fw, i64 %i.fo ; 2 uses
  store float %.sroa.7851.0, ptr %i.fx, align 4
  %i.fy = icmp sgt i64 %i.fo, 0
  br i1 %i.fy, label %bb.av, label %_ZNSt6vectorIfSaIfEE11_S_relocateEPfS2_S2_RS0_.exit16.i.i308

bb.av:                                            ; preds = %.noexc312
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 4 %i.fw, ptr align 4 %i.fl, i64 %i.fo, i1 false)
  br label %_ZNSt6vectorIfSaIfEE11_S_relocateEPfS2_S2_RS0_.exit16.i.i308

_ZNSt6vectorIfSaIfEE11_S_relocateEPfS2_S2_RS0_.exit16.i.i308: ; preds = %bb.av, %.noexc312
  %i.fz = getelementptr inbounds nuw i8, ptr %i.fx, i64 4 ; 2 uses
  %.not.i17.i.i309 = icmp eq ptr %i.fl, null
  br i1 %.not.i17.i.i309, label %_ZNSt6vectorIfSaIfEE17_M_realloc_insertIJRKfEEEvN9__gnu_cxx17__normal_iteratorIPfS1_EEDpOT_.exit.i310, label %bb.aw

bb.aw:                                            ; preds = %_ZNSt6vectorIfSaIfEE11_S_relocateEPfS2_S2_RS0_.exit16.i.i308
  call void @_ZdlPvm(ptr noundef nonnull %i.fl, i64 noundef %i.fo) #22
  br label %_ZNSt6vectorIfSaIfEE17_M_realloc_insertIJRKfEEEvN9__gnu_cxx17__normal_iteratorIPfS1_EEDpOT_.exit.i310

_ZNSt6vectorIfSaIfEE17_M_realloc_insertIJRKfEEEvN9__gnu_cxx17__normal_iteratorIPfS1_EEDpOT_.exit.i310: ; preds = %bb.aw, %_ZNSt6vectorIfSaIfEE11_S_relocateEPfS2_S2_RS0_.exit16.i.i308
  store ptr %i.fw, ptr %13, align 8
  store ptr %i.fz, ptr %i.da, align 8
  %i.ga = getelementptr inbounds nuw [4 x i8], ptr %i.fw, i64 %i.fu ; 2 uses
  store ptr %i.ga, ptr %i.dy, align 8
  br label %_ZNSt6vectorIfSaIfEE9push_backERKf.exit313

_ZNSt6vectorIfSaIfEE9push_backERKf.exit313:       ; preds = %_ZNSt6vectorIfSaIfEE17_M_realloc_insertIJRKfEEEvN9__gnu_cxx17__normal_iteratorIPfS1_EEDpOT_.exit.i310, %bb.at
  %i.gb = phi ptr [ %i.ga, %_ZNSt6vectorIfSaIfEE17_M_realloc_insertIJRKfEEEvN9__gnu_cxx17__normal_iteratorIPfS1_EEDpOT_.exit.i310 ], [ %.pre1073, %bb.at ] ; 2 uses
  %i.gc = phi ptr [ %i.fz, %_ZNSt6vectorIfSaIfEE17_M_realloc_insertIJRKfEEEvN9__gnu_cxx17__normal_iteratorIPfS1_EEDpOT_.exit.i310 ], [ %i.fk, %bb.at ] ; 2 uses
  %.not.i314 = icmp eq ptr %i.gc, %i.gb
  br i1 %.not.i314, label %bb.ay, label %bb.ax

bb.ax:                                            ; preds = %_ZNSt6vectorIfSaIfEE9push_backERKf.exit313
  store float %.sroa.11853.0, ptr %i.gc, align 4
  %i.gd = load ptr, ptr %i.da, align 8
  %i.ge = getelementptr inbounds nuw i8, ptr %i.gd, i64 4 ; 2 uses
  store ptr %i.ge, ptr %i.da, align 8
  %.pre1074 = load ptr, ptr %i.dy, align 8
  br label %_ZNSt6vectorIfSaIfEE9push_backERKf.exit323

bb.ay:                                            ; preds = %_ZNSt6vectorIfSaIfEE9push_backERKf.exit313
  %i.gf = load ptr, ptr %13, align 8              ; 4 uses
  %i.gg = ptrtoint ptr %i.gb to i64
  %i.gh = ptrtoint ptr %i.gf to i64
  %i.gi = sub i64 %i.gg, %i.gh                    ; 6 uses
  %i.gj = icmp eq i64 %i.gi, 9223372036854775804
  br i1 %i.gj, label %.invoke, label %_ZNKSt6vectorIfSaIfEE12_M_check_lenEmPKc.exit.i.i315

_ZNKSt6vectorIfSaIfEE12_M_check_lenEmPKc.exit.i.i315: ; preds = %bb.ay
  %i.gk = ashr exact i64 %i.gi, 2                 ; 3 uses
  %.sroa.speculated.i.i.i316 = call i64 @llvm.umax.i64(i64 %i.gk, i64 1)
  %i.gl = add nsw i64 %.sroa.speculated.i.i.i316, %i.gk ; 2 uses
  %i.gm = icmp ult i64 %i.gl, %i.gk
  %i.gn = call i64 @llvm.umin.i64(i64 %i.gl, i64 2305843009213693951)
  %i.go = select i1 %i.gm, i64 2305843009213693951, i64 %i.gn ; 3 uses
  %.not.i.i.i317 = icmp ne i64 %i.go, 0
  call void @llvm.assume(i1 %.not.i.i.i317)
  %i.gp = shl nuw nsw i64 %i.go, 2
  %i.gq = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.gp) #21
          to label %.noexc322 unwind label %.loopexit984 ; 4 uses

.noexc322:                                        ; preds = %_ZNKSt6vectorIfSaIfEE12_M_check_lenEmPKc.exit.i.i315
...
.lr.ph.i.i.i.i.preheader:                         ; preds = %.noexc336
  ...
  br i1 %or.cond, label %.lr.ph.i.i.i.i.preheader1432, label %vector.ph
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %_ZNSt6vectorI10aiVector2tIfESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit.i, label %.lr.ph.i.i.i.i.preheader1432

.lr.ph.i.i.i.i.preheader1432:                     ; preds = %.lr.ph.i.i.i.i.preheader, %middle.block
...
.lr.ph.i.i.i.i:                                   ; preds = %.lr.ph.i.i.i.i.preheader1432, %.lr.ph.i.i.i.i
  %.012.i.i.i.i = phi ptr [ %i.jq, %.lr.ph.i.i.i.i ], [ %.012.i.i.i.i.ph, %.lr.ph.i.i.i.i.preheader1432 ] ; 2 uses
  %.0911.i.i.i.i = phi ptr [ %i.jp, %.lr.ph.i.i.i.i ], [ %.0911.i.i.i.i.ph, %.lr.ph.i.i.i.i.preheader1432 ] ; 2 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !20)
  call void @llvm.experimental.noalias.scope.decl(metadata !23)
...
.lr.ph.i.i.i.i.i342.preheader:                    ; preds = %.noexc347
  ...
  br i1 %or.cond1408, label %.lr.ph.i.i.i.i.i342.preheader1430, label %vector.ph1394
...
middle.block1404:                                 ; preds = %vector.body1397
  ...
  br i1 %cmp.n1405, label %_ZNSt6vectorI10aiVector2tIfESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit22.i.i, label %.lr.ph.i.i.i.i.i342.preheader1430

.lr.ph.i.i.i.i.i342.preheader1430:                ; preds = %.lr.ph.i.i.i.i.i342.preheader, %middle.block1404
...
.lr.ph.i.i.i.i.i342:                              ; preds = %.lr.ph.i.i.i.i.i342.preheader1430, %.lr.ph.i.i.i.i.i342
  %.012.i.i.i.i.i343 = phi ptr [ %i.lb, %.lr.ph.i.i.i.i.i342 ], [ %.012.i.i.i.i.i343.ph, %.lr.ph.i.i.i.i.i342.preheader1430 ] ; 2 uses
  %.0911.i.i.i.i.i344 = phi ptr [ %i.la, %.lr.ph.i.i.i.i.i342 ], [ %.0911.i.i.i.i.i344.ph, %.lr.ph.i.i.i.i.i342.preheader1430 ] ; 2 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !29)
  call void @llvm.experimental.noalias.scope.decl(metadata !32)
