...
bb.co:                                            ; preds = %_ZN10aiVector3tIfEdVEf.exit.i.i, %bb.cn
  %.sroa.13.1.i = phi float [ %.sroa.13.0.i, %bb.cn ], [ %i.rt, %_ZN10aiVector3tIfEdVEf.exit.i.i ] ; 5 uses
  %.sroa.0.1.i = phi <2 x float> [ %i.rj, %bb.cn ], [ %i.rs, %_ZN10aiVector3tIfEdVEf.exit.i.i ] ; 6 uses
...
bb.cy:                                            ; preds = %_ZNK10aiVector3tIfE5EqualERKS0_f.exit137.thread.i, %_ZN10aiVector3tIfEdVEf.exit.i.i372
  %.sroa.015.3.i = phi <2 x float> [ %i.xr, %_ZNK10aiVector3tIfE5EqualERKS0_f.exit137.thread.i ], [ %i.ya, %_ZN10aiVector3tIfEdVEf.exit.i.i372 ] ; 6 uses
  ...
  %.sroa.0797.4.vec.extract = extractelement <2 x float> %.sroa.0.1.i, i64 1 ; 4 uses
  %.sroa.0791.4.vec.extract = extractelement <2 x float> %.sroa.015.3.i, i64 1
  %.sroa.0791.0.vec.extract = extractelement <2 x float> %.sroa.015.3.i, i64 0
  %.sroa.0797.0.vec.extract = extractelement <2 x float> %.sroa.0.1.i, i64 0
  %20 = shufflevector <2 x float> %.sroa.015.3.i, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
...
bb.cz:                                            ; preds = %_ZN10aiVector3tIfEdVEf.exit.i, %bb.cy
  %.sroa.9.0 = phi float [ %i.yn, %bb.cy ], [ %i.yx, %_ZN10aiVector3tIfEdVEf.exit.i ] ; 2 uses
  ...
  %i.zd = load <2 x float>, ptr %i.yz, align 4    ; 5 uses
  ...
  %i.zi = extractelement <2 x float> %i.zd, i64 1
  ...
  %21 = shufflevector <4 x float> %i.aac, <4 x float> poison, <4 x i32> <i32 poison, i32 poison, i32 poison, i32 2>
  %i.aah = insertelement <4 x float> %21, float %i.aad, i64 0
  %22 = shufflevector <2 x float> %i.ze, <2 x float> %.sroa.0753.0, <4 x i32> <i32 1, i32 2, i32 2, i32 2>
  %23 = load ptr, ptr %16, align 8
  %24 = getelementptr inbounds nuw [36 x i8], ptr %23, i64 %.02271005
  %25 = shufflevector <2 x float> %i.zo, <2 x float> poison, <2 x i32> zeroinitializer
  %26 = insertelement <2 x float> poison, float %i.zj, i64 0
  %27 = insertelement <2 x float> %26, float %i.zr, i64 1
  %28 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %25, <2 x float> %i.zd, <2 x float> %27)
  %29 = shufflevector <2 x float> %28, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 3 uses
  %30 = shufflevector <4 x float> %i.aah, <4 x float> %29, <4 x i32> <i32 0, i32 4, i32 5, i32 3>
  %31 = shufflevector <2 x float> %.sroa.0.1.i, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %32 = shufflevector <4 x float> %i.aac, <4 x float> %31, <4 x i32> <i32 1, i32 poison, i32 4, i32 4>
  %i.aai = insertelement <4 x float> poison, float %.sroa.9.0, i64 0
  %i.aaj = shufflevector <4 x float> %i.aai, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 poison, i32 poison>
  %33 = shufflevector <4 x float> %i.aaj, <4 x float> %29, <4 x i32> <i32 0, i32 1, i32 4, i32 5>
  %34 = extractelement <4 x float> %i.aac, i64 0
  %35 = extractelement <4 x float> %i.aac, i64 3
  %36 = fmul float %.sroa.0797.4.vec.extract, %35
  %i.aak = shufflevector <2 x float> %i.zo, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %37 = shufflevector <4 x float> %i.aac, <4 x float> %i.aak, <4 x i32> <i32 2, i32 4, i32 0, i32 3>
  %38 = shufflevector <2 x float> %.sroa.0.1.i, <2 x float> %i.zd, <4 x i32> <i32 0, i32 3, i32 poison, i32 poison>
  ...
  %40 = insertelement <4 x float> <float poison, float poison, float -0.000000e+00, float -0.000000e+00>, float %36, i64 0
  %i.aal = insertelement <4 x float> %40, float %i.zs, i64 1
  %41 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %37, <4 x float> %39, <4 x float> %i.aal) ; 3 uses
  %42 = shufflevector <4 x float> %i.aag, <4 x float> %41, <4 x i32> <i32 0, i32 5, i32 2, i32 3>
  %43 = fmul <4 x float> %i.aae, %42
  %44 = extractelement <4 x float> %41, i64 1
  %45 = fmul float %.sroa.0797.4.vec.extract, %44
  %46 = fmul float %.sroa.0797.4.vec.extract, %34
  %i.aam = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %30, <4 x float> %22, <4 x float> %43) ; 5 uses
  %i.aan = extractelement <4 x float> %i.aam, i64 1
  %47 = call float @llvm.fmuladd.f32(float %i.zu, float %.sroa.9.0, float %i.aan)
  %48 = fadd float %47, 0.000000e+00
  %i.aao = extractelement <4 x float> %i.aam, i64 0
  %49 = shufflevector <4 x float> %32, <4 x float> %i.aam, <4 x i32> <i32 0, i32 4, i32 2, i32 3>
  %50 = shufflevector <4 x float> %i.aam, <4 x float> poison, <4 x i32> <i32 2, i32 3, i32 poison, i32 poison>
  %51 = insertelement <4 x float> %50, float %45, i64 2
  %i.aap = insertelement <4 x float> %51, float %46, i64 3
  %i.aaq = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %49, <4 x float> %33, <4 x float> %i.aap) ; 4 uses
  %52 = extractelement <4 x float> %i.aaq, i64 0
  %53 = fadd float %52, 0.000000e+00
  %i.aar = extractelement <4 x float> %i.aaq, i64 1
  %54 = fadd float %i.aar, 0.000000e+00
  ...
  store float %53, ptr %i.aau, align 4
  ...
  store float %54, ptr %i.aax, align 4
  %i.aay = extractelement <4 x float> %i.aaq, i64 2
  %55 = call float @llvm.fmuladd.f32(float %i.zu, float %.sroa.13.1.i, float %i.aay)
  %56 = fadd float %55, 0.000000e+00
  %57 = shufflevector <2 x float> %.sroa.015.3.i, <2 x float> <float 1.000000e+00, float poison>, <4 x i32> <i32 2, i32 1, i32 1, i32 1>
  %58 = fmul <4 x float> %57, %41
  %59 = shufflevector <4 x float> %i.aam, <4 x float> %29, <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
  %60 = shufflevector <4 x float> %59, <4 x float> %i.aac, <4 x i32> <i32 0, i32 1, i32 2, i32 6>
  %61 = insertelement <2 x float> %20, float %.sroa.13.1.i, i64 0
  %62 = shufflevector <2 x float> %61, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 1>
  %63 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %60, <4 x float> %62, <4 x float> %58) ; 2 uses
  %64 = load ptr, ptr %16, align 8
  %65 = getelementptr inbounds nuw [36 x i8], ptr %64, i64 %.02271005
  %66 = getelementptr inbounds nuw i8, ptr %65, i64 12
  store float %56, ptr %66, align 4
  %67 = load ptr, ptr %16, align 8
  %68 = getelementptr inbounds nuw [36 x i8], ptr %67, i64 %.02271005
  %69 = getelementptr inbounds nuw i8, ptr %68, i64 16
  %70 = shufflevector <4 x float> %i.aac, <4 x float> <float poison, float 0.000000e+00, float poison, float poison>, <4 x i32> <i32 1, i32 5, i32 poison, i32 1>
  %i.aaz = insertelement <4 x float> %70, float %i.zu, i64 2
  %i.aba = insertelement <4 x float> <float poison, float -0.000000e+00, float poison, float poison>, float %.sroa.13.1.i, i64 0
  %i.abb = insertelement <4 x float> %i.aba, float %.sroa.31.3.i, i64 2
  %71 = shufflevector <4 x float> %i.abb, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 2>
  %72 = shufflevector <4 x float> %i.aaq, <4 x float> %63, <4 x i32> <i32 3, i32 4, i32 5, i32 6>
  %i.abc = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.aaz, <4 x float> %71, <4 x float> %72)
  %i.abd = fadd <4 x float> %i.abc, zeroinitializer ; 4 uses
  %i.abe = extractelement <4 x float> %i.abd, i64 0
  store float %i.abe, ptr %69, align 4
  ...
  %i.abi = extractelement <4 x float> %i.abd, i64 1
  store float %i.abi, ptr %i.abh, align 4
  %73 = extractelement <4 x float> %63, i64 3
  %i.abj = call float @llvm.fmuladd.f32(float %i.aao, float %.sroa.31.3.i, float %73)
  ...
  %i.abo = extractelement <4 x float> %i.abd, i64 2
