...
.lr.ph1014:                                       ; preds = %.lr.ph1014.preheader, %.lr.ph1014
  ...
  %i.agw = getelementptr inbounds nuw [8 x i8], ptr %i.agv, i64 %.02281012
  %20 = load <2 x float>, ptr %i.agw, align 4     ; 3 uses
  %i.agx = shufflevector <2 x float> %20, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %22 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %21, <2 x float> zeroinitializer, <2 x float> %i.agy)
  %23 = fadd <2 x float> %22, zeroinitializer
  %24 = extractelement <2 x float> %i.agy, i64 1
  %i.agz = extractelement <2 x float> %20, i64 1
  %i.aha = call float @llvm.fmuladd.f32(float %i.agj, float %i.agz, float %24)
  ...
  store <2 x float> %23, ptr %i.ahd, align 4
  ...
  %i.ahr = getelementptr inbounds nuw i8, ptr %i.ahj, i64 8
  ...
  %25 = load <3 x float>, ptr %i.ahj, align 4     ; 5 uses
  %i.ahv = load float, ptr %i.ahn, align 4
  %i.ahw = shufflevector <3 x float> %25, <3 x float> poison, <2 x i32> zeroinitializer
  %i.ahx = fmul <2 x float> %i.ahu, %i.ahw
  %26 = extractelement <3 x float> %25, i64 0
  %27 = fmul float %i.ahh, %26
  %28 = load <2 x float>, ptr %i.ahk, align 4
  %29 = shufflevector <3 x float> %25, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.ahy = fmul <2 x float> %28, %29
  %i.ahz = fmul float %i.ahm, %i.ahv
  %i.aia = load <2 x float>, ptr %i.aho, align 4
  %30 = shufflevector <3 x float> %25, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %31 = fmul <2 x float> %i.aia, %30
  %32 = extractelement <3 x float> %25, i64 2
  %i.aib = fmul float %i.ahq, %32
  %i.aic = fadd <2 x float> %i.ahx, %i.ahy
  %i.aid = fadd float %27, %i.ahz
  %i.aie = fadd <2 x float> %i.aic, %31
