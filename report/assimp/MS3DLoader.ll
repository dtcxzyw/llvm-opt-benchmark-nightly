...
begin_hunk_1_@_ZN6Assimp12MS3DImporter14InternReadFileERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEP7aiScenePNS_8IOSystemE:._crit_edge.i.i
  ...
  %22 = insertelement <4 x float> %i.brz, float %i.brq, i64 1 ; 2 uses
  %i.bsa = shufflevector <4 x float> %22, <4 x float> %i.bry, <4 x i32> <i32 0, i32 1, i32 4, i32 5> ; 2 uses
  %23 = shufflevector <4 x float> %22, <4 x float> <float poison, float 2.500000e-01, float poison, float poison>, <4 x i32> <i32 1, i32 5, i32 1, i32 1> ; 2 uses
