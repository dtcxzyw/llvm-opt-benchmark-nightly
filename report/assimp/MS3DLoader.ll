...
bb.od:                                            ; preds = %.lr.ph1281, %_ZN13aiQuaterniontIfEC2ERK12aiMatrix3x3tIfE.exit
  ...
  %i.bnc = call noundef float @cosf(float noundef %i.bmz) #24 ; 5 uses
  %i.bnd = call noundef float @sinf(float noundef %i.bmz) #24 ; 5 uses
  %i.bne = call noundef float @cosf(float noundef %i.bna) #24 ; 4 uses
  %i.bnf = call noundef float @sinf(float noundef %i.bna) #24 ; 3 uses
  %i.bng = call noundef float @cosf(float noundef %i.bnb) #24 ; 4 uses
  %i.bnh = call noundef float @sinf(float noundef %i.bnb) #24 ; 4 uses
  %i.bni = fmul float %i.bnf, %i.bng              ; 2 uses
  %i.bnj = fneg float %i.bnc
  %i.bnk = fmul float %i.bnf, %i.bnh              ; 2 uses
  ...
  %i.bnv = call noundef float @cosf(float noundef %i.bnq) #24 ; 2 uses
  ...
  %i.boe = fmul float %i.bnd, %i.bne              ; 2 uses
  %i.bof = fmul float %i.bnc, %i.bne              ; 3 uses
  %i.bog = fmul float %i.bnv, %i.bny              ; 3 uses
  %i.boh = fmul float %i.bne, %i.bnh              ; 3 uses
  %22 = fmul float %i.bnd, %i.bnk
  %23 = fmul float %i.bnh, %i.bnj
  %24 = call float @llvm.fmuladd.f32(float %i.bng, float %i.bnc, float %22) ; 3 uses
  %25 = call float @llvm.fmuladd.f32(float %i.bni, float %i.bnd, float %23) ; 3 uses
  %26 = fmul float %i.bng, %i.bnl
  %27 = fmul float %i.bnc, %i.bni
  %i.boi = insertelement <2 x float> poison, float %i.bnh, i64 0
  %i.boj = insertelement <2 x float> %i.boi, float %i.bnk, i64 1
  %i.bok = insertelement <2 x float> poison, float %i.bnd, i64 0
  %i.bol = insertelement <2 x float> %i.bok, float %i.bnc, i64 1
  %i.bom = insertelement <2 x float> poison, float %27, i64 0
  %i.bon = insertelement <2 x float> %i.bom, float %26, i64 1
  %i.boo = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.boj, <2 x float> %i.bol, <2 x float> %i.bon) ; 5 uses
  %i.bop = fmul float %25, %i.bog
  ...
  %i.bpl = insertelement <2 x float> poison, float %i.bnv, i64 0 ; 2 uses
  ...
  %30 = extractelement <2 x float> %i.bpj, i64 0
  %31 = fmul float %24, %30
  %i.bpp = insertelement <2 x float> %i.bpj, float %i.bog, i64 1
  %i.bpq = fmul <2 x float> %29, %i.bpp
  %i.bpr = extractelement <2 x float> %i.bpb, i64 1
  %i.bps = extractelement <2 x float> %i.bpb, i64 0
  %i.bpt = call float @llvm.fmuladd.f32(float %i.bps, float %i.boh, float %31)
  %i.bpu = insertelement <2 x float> %i.bpn, float %i.bod, i64 1
  %32 = insertelement <2 x float> poison, float %i.boe, i64 0 ; 2 uses
  %i.bpv = insertelement <2 x float> %32, float %24, i64 1
  %33 = fmul <2 x float> %i.bpv, %i.bpj
  %34 = insertelement <2 x float> poison, float %i.bnm, i64 0
  %i.bpw = insertelement <2 x float> %34, float %i.boh, i64 1
  %35 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bpb, <2 x float> %i.bpw, <2 x float> %33)
  %i.bpx = insertelement <2 x float> %i.boo, float %i.bof, i64 0
  %i.bpy = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bpn, <2 x float> %i.bpx, <2 x float> %35) ; 4 uses
  %36 = extractelement <2 x float> %i.bpn, i64 1
  %37 = insertelement <2 x float> %i.bpl, float %i.bne, i64 1
  %38 = insertelement <2 x float> poison, float %i.bnx, i64 0
  %i.bpz = insertelement <2 x float> %38, float %i.bng, i64 1
  %39 = fmul <2 x float> %37, %i.bpz              ; 5 uses
  %40 = extractelement <2 x float> %39, i64 0
  %i.bqa = extractelement <2 x float> %39, i64 1
  %41 = call float @llvm.fmuladd.f32(float %40, float %i.bqa, float %i.bop)
  %42 = call float @llvm.fmuladd.f32(float %i.bod, float %i.boq, float %41) ; 2 uses
  %43 = fadd float %42, 0.000000e+00              ; 4 uses
  %44 = shufflevector <2 x float> %39, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %45 = insertelement <2 x float> %44, float %i.boh, i64 1
  %i.bqb = insertelement <2 x float> %32, float %25, i64 1
  %i.bqc = insertelement <2 x float> %i.bpj, float %i.bog, i64 0
  %i.bqd = fmul <2 x float> %i.bqb, %i.bqc
  %i.bqe = insertelement <2 x float> %i.bpb, float %i.bnm, i64 0
  %46 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %39, <2 x float> %i.bqe, <2 x float> %i.bqd)
  %47 = shufflevector <2 x float> %i.bpb, <2 x float> %39, <2 x i32> <i32 0, i32 2>
  %48 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %47, <2 x float> %45, <2 x float> %i.bpq)
  %i.bqf = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bpu, <2 x float> %i.boo, <2 x float> %48)
  %49 = fadd <2 x float> %i.bqf, zeroinitializer  ; 6 uses
  ...
  %i.bqj = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bqg, <2 x float> %i.bqi, <2 x float> %46)
  ...
  %i.bqs = call float @llvm.fmuladd.f32(float %36, float %i.bof, float %i.bqr)
  %i.bqt = fadd float %i.bqs, 0.000000e+00        ; 4 uses
  %i.bqu = fadd <2 x float> %i.bpy, zeroinitializer ; 2 uses
  %i.bqv = extractelement <2 x float> %i.bqu, i64 1 ; 4 uses
  %i.bqw = fadd float %43, %i.bqv
...
bb.oe:                                            ; preds = %bb.od
  ...
  %i.bre = shufflevector <2 x float> %49, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
...
bb.og:                                            ; preds = %bb.of
  ...
  %i.bsc = shufflevector <2 x float> %49, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 poison, i32 poison>
