...
begin_hunk_0_@_ZN6Assimp12MS3DImporter18CollectChildJointsERKSt6vectorINS0_9TempJointESaIS2_EERS1_IbSaIbEEP6aiNodeRK12aiMatrix4x4tIfE:bb.a
  ...
  %i.do = load float, ptr %6, align 4             ; 3 uses
...
begin_hunk_1_@_ZN6Assimp12MS3DImporter18CollectChildJointsERKSt6vectorINS0_9TempJointESaIS2_EERS1_IbSaIbEEP6aiNodeRK12aiMatrix4x4tIfE:bb.a
  ...
  %i.hh = insertelement <2 x float> poison, float %i.do, i64 0
  ...
  %i.hm = load <2 x float>, ptr %i.z, align 4     ; 4 uses
  ...
  %8 = shufflevector <2 x float> %i.gy, <2 x float> %i.hm, <4 x i32> <i32 0, i32 poison, i32 2, i32 poison>
  %9 = insertelement <4 x float> %8, float %i.do, i64 1
  %10 = shufflevector <4 x float> %9, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 2>
...
begin_hunk_2_@_ZN6Assimp12MS3DImporter18CollectChildJointsERKSt6vectorINS0_9TempJointESaIS2_EERS1_IbSaIbEEP6aiNodeRK12aiMatrix4x4tIfE:bb.a
  ...
  %11 = shufflevector <2 x float> %i.hm, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %i.ja = shufflevector <4 x float> %11, <4 x float> %i.gu, <4 x i32> <i32 poison, i32 poison, i32 0, i32 6>
