...
.lr.ph416:                                        ; preds = %bb.a, %.thread307
  %i.d = phi i64 [ %i.nu, %.thread307 ], [ %i.c, %bb.a ]
  ...
  %invariant.op779 = sub i64 4, %.0146.ph637
  br label %bb.b

bb.b:                                             ; preds = %.lr.ph416, %bb.ci
  %i.i = phi i64 [ %i.d, %.lr.ph416 ], [ %i.nt, %bb.ci ] ; 4 uses
...
.lr.ph.i:                                         ; preds = %_ZN6Assimp17HexOctetToDecimalEPKc.exit
  ...
  %i.bh = load i64, ptr %i.b, align 8             ; 3 uses
  %i.bi = icmp ugt i64 %.0146.ph637, %i.bh
  br i1 %i.bi, label %bb.r, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5eraseEmm.exit190

bb.r:                                             ; preds = %.lr.ph.i
  call void (ptr, ...) @_ZSt24__throw_out_of_range_fmtPKcz(ptr noundef nonnull @.str.1, ptr noundef nonnull @.str, i64 noundef %.0146.ph637, i64 noundef %i.bh) #11
  unreachable

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5eraseEmm.exit190: ; preds = %.lr.ph.i
  %i.bj = sub nuw i64 %i.bh, %.0146.ph637
  %spec.select.i.i189 = call noundef i64 @llvm.umin.i64(i64 %i.bj, i64 5)
  ...
  %i.bk = load i64, ptr %i.b, align 8             ; 2 uses
  %i.bl = icmp ugt i64 %.0146.ph637, %i.bk
  br i1 %i.bl, label %bb.s, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6insertEmPKcm.exit

bb.s:                                             ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5eraseEmm.exit190
  call void (ptr, ...) @_ZSt24__throw_out_of_range_fmtPKcz(ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.3, i64 noundef %.0146.ph637, i64 noundef %i.bk) #11
  unreachable
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6insertEmPKcm.exit: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5eraseEmm.exit190
  %i.bm = call noundef nonnull align 8 dereferenceable(32) ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_replaceEmmPKcm(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %.0146.ph637, i64 noundef 0, ptr noundef nonnull %i.a, i64 noundef 0) ; 0 uses
...
bb.u:                                             ; preds = %bb.t
  %i.bn = getelementptr i8, ptr %i.k, i64 1
  %i.bo = load i8, ptr %i.bn, align 1
  %i.bp = icmp eq i8 %i.bo, 88
  br i1 %i.bp, label %bb.v, label %.thread307

bb.v:                                             ; preds = %bb.u
  %i.bq = getelementptr i8, ptr %i.k, i64 2
  %i.br = load i8, ptr %i.bq, align 1             ; 3 uses
  %i.bs = add i8 %i.br, -48
  %or.cond = icmp ult i8 %i.bs, 10
  br i1 %or.cond, label %bb.w, label %.thread307

bb.w:                                             ; preds = %bb.v
  switch i8 %i.br, label %.critedge [
    i8 50, label %bb.x
    i8 52, label %bb.x
  ]

bb.x:                                             ; preds = %bb.w, %bb.w
  %i.bt = getelementptr inbounds nuw i8, ptr %i.j, i64 %i.e
  %i.bu = load i8, ptr %i.bt, align 1
  %i.bv = icmp eq i8 %i.bu, 92
  br i1 %i.bv, label %bb.y, label %.thread307

bb.y:                                             ; preds = %bb.x
  %i.bw = add i64 %i.i, -3                        ; 3 uses
  %i.bx = icmp ult i64 %i.h, %i.bw
  br i1 %i.bx, label %.lr.ph, label %._crit_edge

.lr.ph:                                           ; preds = %bb.y, %bb.ac
  %.0153401 = phi i64 [ %i.ck, %bb.ac ], [ %i.h, %bb.y ] ; 3 uses
  %i.by = getelementptr i8, ptr %i.j, i64 %.0153401 ; 4 uses
...
bb.z:                                             ; preds = %.lr.ph
  ...
  %i.cd = icmp eq i8 %i.cc, 88
  br i1 %i.cd, label %bb.aa, label %bb.ac

bb.aa:                                            ; preds = %bb.z
  %i.ce = getelementptr i8, ptr %i.by, i64 2
  %i.cf = load i8, ptr %i.ce, align 1
  %i.cg = icmp eq i8 %i.cf, 48
  br i1 %i.cg, label %bb.ab, label %bb.ac

bb.ab:                                            ; preds = %bb.aa
  %i.ch = getelementptr i8, ptr %i.by, i64 3
  %i.ci = load i8, ptr %i.ch, align 1
  %i.cj = icmp eq i8 %i.ci, 92
  br i1 %i.cj, label %._crit_edge, label %bb.ac

bb.ac:                                            ; preds = %.lr.ph, %bb.z, %bb.aa, %bb.ab
  %i.ck = add i64 %.0153401, 1                    ; 2 uses
  %exitcond.not = icmp eq i64 %i.ck, %i.bw
...
._crit_edge:                                      ; preds = %bb.ab, %bb.y
  ...
  %i.cl = icmp eq i64 %.0153.lcssa, %i.bw
  br i1 %i.cl, label %.critedge, label %bb.ad

bb.ad:                                            ; preds = %._crit_edge
  %i.cm = icmp eq i64 %.0153.lcssa, %i.h
  br i1 %i.cm, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5eraseEmm.exit192, label %bb.ae

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5eraseEmm.exit192: ; preds = %bb.ad
  %i.cn = sub nuw i64 %i.i, %.0146.ph637
  %spec.select.i.i191 = call noundef i64 @llvm.umin.i64(i64 %i.cn, i64 8)
...
bb.ae:                                            ; preds = %bb.ad
  switch i8 %i.br, label %.thread307 [
    i8 50, label %bb.af
    i8 52, label %bb.ba
  ]

bb.af:                                            ; preds = %bb.ae
  %i.co = sub i64 %.0153.lcssa, %i.h              ; 6 uses
  %i.cp = and i64 %i.co, 3
  %.not181 = icmp eq i64 %i.cp, 0
  br i1 %.not181, label %.lr.ph412.preheader, label %.critedge

.lr.ph412.preheader:                              ; preds = %bb.af
  %i.cq = lshr exact i64 %i.co, 2                 ; 5 uses
  %i.cr = lshr exact i64 %i.co, 1
  %i.cs = call noalias noundef nonnull ptr @_Znam(i64 noundef %i.cr) #13 ; 9 uses
  %i.ct = getelementptr i8, ptr %i.j, i64 %i.h    ; 12 uses
  %min.iters.check = icmp ult i64 %i.co, 32
  br i1 %min.iters.check, label %.lr.ph412.preheader657, label %vector.memcheck

vector.memcheck:                                  ; preds = %.lr.ph412.preheader
  %i.cu = lshr exact i64 %i.co, 1
  %scevgep = getelementptr i8, ptr %i.cs, i64 %i.cu
  %scevgep639 = getelementptr i8, ptr %i.j, i64 4
  %scevgep640 = getelementptr i8, ptr %scevgep639, i64 %.0146.ph637
  %scevgep641 = getelementptr i8, ptr %scevgep640, i64 %i.co
  %bound0 = icmp ult ptr %i.cs, %scevgep641
  %bound1 = icmp ult ptr %i.ct, %scevgep
  %found.conflict = and i1 %bound0, %bound1
  br i1 %found.conflict, label %.lr.ph412.preheader657, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %i.cq, 4611686018427387896     ; 4 uses
  %i.cv = shl nuw i64 %n.vec, 2
  %i.cw = getelementptr i8, ptr %i.ct, i64 %i.cv
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 3 uses
  %i.cx = shl i64 %index, 2                       ; 8 uses
  %next.gep = getelementptr i8, ptr %i.ct, i64 %i.cx ; 4 uses
  %i.cy = getelementptr i8, ptr %i.ct, i64 %i.cx  ; 4 uses
  %next.gep642 = getelementptr i8, ptr %i.cy, i64 4
  %i.cz = getelementptr i8, ptr %i.ct, i64 %i.cx  ; 4 uses
  %next.gep643 = getelementptr i8, ptr %i.cz, i64 8
  %i.da = getelementptr i8, ptr %i.ct, i64 %i.cx  ; 4 uses
  %next.gep644 = getelementptr i8, ptr %i.da, i64 12
  %i.db = getelementptr i8, ptr %i.ct, i64 %i.cx  ; 4 uses
  %next.gep645 = getelementptr i8, ptr %i.db, i64 16
  %i.dc = getelementptr i8, ptr %i.ct, i64 %i.cx  ; 4 uses
  %next.gep646 = getelementptr i8, ptr %i.dc, i64 20
  %i.dd = getelementptr i8, ptr %i.ct, i64 %i.cx  ; 4 uses
  %next.gep647 = getelementptr i8, ptr %i.dd, i64 24
  %i.de = getelementptr i8, ptr %i.ct, i64 %i.cx  ; 4 uses
  %next.gep648 = getelementptr i8, ptr %i.de, i64 28
  %i.df = load i8, ptr %next.gep, align 1, !alias.scope !6
  %i.dg = load i8, ptr %next.gep642, align 1, !alias.scope !6
  %i.dh = load i8, ptr %next.gep643, align 1, !alias.scope !6
  %i.di = load i8, ptr %next.gep644, align 1, !alias.scope !6
  %i.dj = load i8, ptr %next.gep645, align 1, !alias.scope !6
  %i.dk = load i8, ptr %next.gep646, align 1, !alias.scope !6
  %i.dl = load i8, ptr %next.gep647, align 1, !alias.scope !6
  %i.dm = load i8, ptr %next.gep648, align 1, !alias.scope !6
  ...
  %i.du = insertelement <8 x i8> %i.dt, i8 %i.dm, i64 7 ; 6 uses
  %i.dv = add <8 x i8> %i.du, splat (i8 -58)
  %i.dw = icmp ult <8 x i8> %i.dv, splat (i8 -10)
  %i.dx = add <8 x i8> %i.du, splat (i8 -65)
  %i.dy = icmp ult <8 x i8> %i.dx, splat (i8 6)
  %i.dz = add <8 x i8> %i.du, splat (i8 9)
  %i.ea = select <8 x i1> %i.dy, <8 x i8> %i.dz, <8 x i8> splat (i8 15)
  %i.eb = add <8 x i8> %i.du, splat (i8 -97)
  %i.ec = icmp ult <8 x i8> %i.eb, splat (i8 6)
  %i.ed = add <8 x i8> %i.du, splat (i8 9)
  %predphi = select <8 x i1> %i.ec, <8 x i8> %i.ed, <8 x i8> %i.ea
  %predphi649 = select <8 x i1> %i.dw, <8 x i8> %predphi, <8 x i8> %i.du
  %i.ee = getelementptr inbounds nuw i8, ptr %next.gep, i64 1
  %i.ef = getelementptr i8, ptr %i.cy, i64 5
  %i.eg = getelementptr i8, ptr %i.cz, i64 9
  %i.eh = getelementptr i8, ptr %i.da, i64 13
  %i.ei = getelementptr i8, ptr %i.db, i64 17
  %i.ej = getelementptr i8, ptr %i.dc, i64 21
  %i.ek = getelementptr i8, ptr %i.dd, i64 25
  %i.el = getelementptr i8, ptr %i.de, i64 29
  %i.em = load i8, ptr %i.ee, align 1, !alias.scope !6
  %i.en = load i8, ptr %i.ef, align 1, !alias.scope !6
  %i.eo = load i8, ptr %i.eg, align 1, !alias.scope !6
