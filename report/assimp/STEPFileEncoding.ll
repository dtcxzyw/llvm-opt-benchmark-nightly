...
.lr.ph416:                                        ; preds = %bb.a, %.thread307
  %i.d = phi i64 [ %i.vg, %.thread307 ], [ %i.c, %bb.a ]
  ...
  %i.h = add i64 %.0146.ph637, 4                  ; 9 uses
  %invariant.op = sub i64 4, %.0146.ph637
  %invariant.op820 = sub i64 4, %.0146.ph637
  br label %bb.b
...
.lr.ph.i:                                         ; preds = %_ZN6Assimp17HexOctetToDecimalEPKc.exit
  ...
  %i.bl = icmp ugt i64 %.0146.ph637, %i.bk
  br i1 %i.bl, label %bb.r, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5eraseEmm.exit190

bb.r:                                             ; preds = %.lr.ph.i
  call void (ptr, ...) @_ZSt24__throw_out_of_range_fmtPKcz(ptr noundef nonnull @.str.1, ptr noundef nonnull @.str, i64 noundef %.0146.ph637, i64 noundef %i.bk) #11
  unreachable

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5eraseEmm.exit190: ; preds = %.lr.ph.i
  %i.bm = sub nuw i64 %i.bk, %.0146.ph637
  %spec.select.i.i189 = call noundef i64 @llvm.umin.i64(i64 %i.bm, i64 5)
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8_M_eraseEmm(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %.0146.ph637, i64 noundef %spec.select.i.i189)
  %i.bn = load i64, ptr %i.b, align 8             ; 2 uses
  %i.bo = icmp ugt i64 %.0146.ph637, %i.bn
...
bb.s:                                             ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5eraseEmm.exit190
  call void (ptr, ...) @_ZSt24__throw_out_of_range_fmtPKcz(ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.3, i64 noundef %.0146.ph637, i64 noundef %i.bn) #11
  unreachable
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6insertEmPKcm.exit: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5eraseEmm.exit190
  %i.bp = call noundef nonnull align 8 dereferenceable(32) ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_replaceEmmPKcm(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %.0146.ph637, i64 noundef 0, ptr noundef nonnull %i.a, i64 noundef 0) ; 0 uses
...
.lr.ph:                                           ; preds = %bb.y, %bb.ac
  %.0153401 = phi i64 [ %i.cn, %bb.ac ], [ %i.h, %bb.y ] ; 3 uses
  %i.cb = getelementptr i8, ptr %i.j, i64 %.0153401 ; 4 uses
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5eraseEmm.exit192: ; preds = %bb.ad
  %i.cq = sub nuw i64 %i.i, %.0146.ph637
  %spec.select.i.i191 = call noundef i64 @llvm.umin.i64(i64 %i.cq, i64 8)
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8_M_eraseEmm(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %.0146.ph637, i64 noundef %spec.select.i.i191)
...
bb.af:                                            ; preds = %bb.ae
  %i.cr = sub i64 %.0153.lcssa, %i.h              ; 6 uses
  %i.cs = and i64 %i.cr, 3
...
vector.memcheck:                                  ; preds = %.lr.ph412.preheader
  ...
  br i1 %found.conflict, label %.lr.ph412.preheader697, label %vector.ph
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %._crit_edge413, label %.lr.ph412.preheader697

.lr.ph412.preheader697:                           ; preds = %vector.memcheck, %.lr.ph412.preheader, %middle.block
  %.0156410.ph = phi ptr [ %i.cw, %vector.memcheck ], [ %i.cw, %.lr.ph412.preheader ], [ %i.cz, %middle.block ]
  %.0157409.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %.lr.ph412.preheader ], [ %n.vec, %middle.block ]
  br label %.lr.ph412
...
.lr.ph412:                                        ; preds = %.lr.ph412.preheader697, %bb.at
  %.0156410 = phi ptr [ %i.jz, %bb.at ], [ %.0156410.ph, %.lr.ph412.preheader697 ] ; 5 uses
  %.0157409 = phi i64 [ %i.jy, %bb.at ], [ %.0157409.ph, %.lr.ph412.preheader697 ] ; 2 uses
  %i.io = load i8, ptr %.0156410, align 1         ; 5 uses
...
_ZN6Assimp17HexDigitToDecimalEc.exit.i197:        ; preds = %bb.ai, %bb.ah, %.lr.ph412
  ...
  %i.iu = getelementptr inbounds nuw i8, ptr %.0156410, i64 1
...
bb.am:                                            ; preds = %bb.al, %bb.ak, %_ZN6Assimp17HexDigitToDecimalEc.exit.i197
  ...
  %i.jd = getelementptr inbounds nuw i8, ptr %.0156410, i64 2
...
_ZN6Assimp17HexDigitToDecimalEc.exit.i209:        ; preds = %bb.ap, %bb.ao, %bb.am
  ...
  %i.jk = getelementptr inbounds nuw i8, ptr %.0156410, i64 3
...
bb.at:                                            ; preds = %bb.as, %bb.ar, %_ZN6Assimp17HexDigitToDecimalEc.exit.i209
  ...
  %i.jx = getelementptr inbounds nuw [2 x i8], ptr %i.cv, i64 %.0157409
  store i16 %i.jw, ptr %i.jx, align 2
  %i.jy = add nuw nsw i64 %.0157409, 1            ; 2 uses
  %i.jz = getelementptr inbounds nuw i8, ptr %.0156410, i64 4
...
bb.av:                                            ; preds = %bb.au
  %.reass573.reass = add i64 %.0153.lcssa, %invariant.op820
  %i.kc = invoke noundef nonnull align 8 dereferenceable(32) ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5eraseEmm(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %.0146.ph637, i64 noundef %.reass573.reass)
          to label %bb.aw unwind label %bb.az     ; 0 uses

bb.aw:                                            ; preds = %bb.av
  %i.kd = invoke noundef nonnull align 8 dereferenceable(32) ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6insertEmPKcm(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %.0146.ph637, ptr noundef nonnull %i.in, i64 noundef 0)
...
vector.body670:                                   ; preds = %vector.body670, %vector.ph667
  ...
  %i.kq = shl i64 %index671, 3                    ; 4 uses
  %next.gep672 = getelementptr i8, ptr %i.km, i64 %i.kq ; 8 uses
  %i.kr = getelementptr i8, ptr %i.km, i64 %i.kq  ; 8 uses
  %next.gep673 = getelementptr i8, ptr %i.kr, i64 8
  %i.ks = getelementptr i8, ptr %i.km, i64 %i.kq  ; 8 uses
  %next.gep674 = getelementptr i8, ptr %i.ks, i64 16
  %i.kt = getelementptr i8, ptr %i.km, i64 %i.kq  ; 8 uses
  %next.gep675 = getelementptr i8, ptr %i.kt, i64 24
  %i.ku = load i8, ptr %next.gep672, align 1, !alias.scope !15
  %i.kv = load i8, ptr %next.gep673, align 1, !alias.scope !15
  %i.kw = load i8, ptr %next.gep674, align 1, !alias.scope !15
  %i.kx = load i8, ptr %next.gep675, align 1, !alias.scope !15
  %i.ky = insertelement <4 x i8> poison, i8 %i.ku, i64 0
  %i.kz = insertelement <4 x i8> %i.ky, i8 %i.kv, i64 1
  %i.la = insertelement <4 x i8> %i.kz, i8 %i.kw, i64 2
  %i.lb = insertelement <4 x i8> %i.la, i8 %i.kx, i64 3 ; 6 uses
  %i.lc = add <4 x i8> %i.lb, splat (i8 -58)
  %i.ld = icmp ult <4 x i8> %i.lc, splat (i8 -10)
  %i.le = add <4 x i8> %i.lb, splat (i8 -65)
  %i.lf = icmp ult <4 x i8> %i.le, splat (i8 6)
  %i.lg = add <4 x i8> %i.lb, splat (i8 9)
  %i.lh = select <4 x i1> %i.lf, <4 x i8> %i.lg, <4 x i8> splat (i8 15)
  %i.li = add <4 x i8> %i.lb, splat (i8 -97)
  %i.lj = icmp ult <4 x i8> %i.li, splat (i8 6)
  %i.lk = add <4 x i8> %i.lb, splat (i8 9)
  %predphi676 = select <4 x i1> %i.lj, <4 x i8> %i.lk, <4 x i8> %i.lh
  %predphi677 = select <4 x i1> %i.ld, <4 x i8> %predphi676, <4 x i8> %i.lb
  %i.ll = getelementptr inbounds nuw i8, ptr %next.gep672, i64 1
  %i.lm = getelementptr i8, ptr %i.kr, i64 9
  %i.ln = getelementptr i8, ptr %i.ks, i64 17
  %i.lo = getelementptr i8, ptr %i.kt, i64 25
  %i.lp = load i8, ptr %i.ll, align 1, !alias.scope !15
  %i.lq = load i8, ptr %i.lm, align 1, !alias.scope !15
  %i.lr = load i8, ptr %i.ln, align 1, !alias.scope !15
  %i.ls = load i8, ptr %i.lo, align 1, !alias.scope !15
  %i.lt = insertelement <4 x i8> poison, i8 %i.lp, i64 0
  %i.lu = insertelement <4 x i8> %i.lt, i8 %i.lq, i64 1
  %i.lv = insertelement <4 x i8> %i.lu, i8 %i.lr, i64 2
  %i.lw = insertelement <4 x i8> %i.lv, i8 %i.ls, i64 3 ; 5 uses
  %i.lx = add <4 x i8> %i.lw, splat (i8 -48)      ; 2 uses
  %i.ly = icmp ugt <4 x i8> %i.lx, splat (i8 9)
  %i.lz = add <4 x i8> %i.lw, splat (i8 -65)
  %i.ma = icmp ult <4 x i8> %i.lz, splat (i8 6)
  %i.mb = add <4 x i8> %i.lw, splat (i8 -55)
  %i.mc = select <4 x i1> %i.ma, <4 x i8> %i.mb, <4 x i8> splat (i8 -1)
  %i.md = add <4 x i8> %i.lw, splat (i8 -97)
  %i.me = icmp ult <4 x i8> %i.md, splat (i8 6)
  %i.mf = add nsw <4 x i8> %i.lw, splat (i8 -87)
  %predphi678 = select <4 x i1> %i.me, <4 x i8> %i.mf, <4 x i8> %i.mc
  %predphi679 = select <4 x i1> %i.ly, <4 x i8> %predphi678, <4 x i8> %i.lx
  %i.mg = shl <4 x i8> %predphi677, splat (i8 4)
  %i.mh = add <4 x i8> %predphi679, %i.mg
  %i.mi = getelementptr inbounds nuw i8, ptr %next.gep672, i64 2
  %i.mj = getelementptr i8, ptr %i.kr, i64 10
  %i.mk = getelementptr i8, ptr %i.ks, i64 18
  %i.ml = getelementptr i8, ptr %i.kt, i64 26
  %i.mm = load i8, ptr %i.mi, align 1, !alias.scope !15
  %i.mn = load i8, ptr %i.mj, align 1, !alias.scope !15
  %i.mo = load i8, ptr %i.mk, align 1, !alias.scope !15
  %i.mp = load i8, ptr %i.ml, align 1, !alias.scope !15
  %i.mq = insertelement <4 x i8> poison, i8 %i.mm, i64 0
  %i.mr = insertelement <4 x i8> %i.mq, i8 %i.mn, i64 1
  %i.ms = insertelement <4 x i8> %i.mr, i8 %i.mo, i64 2
  %i.mt = insertelement <4 x i8> %i.ms, i8 %i.mp, i64 3 ; 6 uses
  %i.mu = add <4 x i8> %i.mt, splat (i8 -58)
  %i.mv = icmp ult <4 x i8> %i.mu, splat (i8 -10)
  %i.mw = add <4 x i8> %i.mt, splat (i8 -65)
  %i.mx = icmp ult <4 x i8> %i.mw, splat (i8 6)
  %i.my = add <4 x i8> %i.mt, splat (i8 9)
  %i.mz = select <4 x i1> %i.mx, <4 x i8> %i.my, <4 x i8> splat (i8 15)
  %i.na = add <4 x i8> %i.mt, splat (i8 -97)
  %i.nb = icmp ult <4 x i8> %i.na, splat (i8 6)
  %i.nc = add <4 x i8> %i.mt, splat (i8 9)
  %predphi680 = select <4 x i1> %i.nb, <4 x i8> %i.nc, <4 x i8> %i.mz
  %predphi681 = select <4 x i1> %i.mv, <4 x i8> %predphi680, <4 x i8> %i.mt
  %i.nd = getelementptr inbounds nuw i8, ptr %next.gep672, i64 3
  %i.ne = getelementptr i8, ptr %i.kr, i64 11
  %i.nf = getelementptr i8, ptr %i.ks, i64 19
  %i.ng = getelementptr i8, ptr %i.kt, i64 27
  %i.nh = load i8, ptr %i.nd, align 1, !alias.scope !15
  %i.ni = load i8, ptr %i.ne, align 1, !alias.scope !15
  %i.nj = load i8, ptr %i.nf, align 1, !alias.scope !15
  %i.nk = load i8, ptr %i.ng, align 1, !alias.scope !15
  ...
  %i.no = insertelement <4 x i8> %i.nn, i8 %i.nk, i64 3 ; 5 uses
  %i.np = add <4 x i8> %i.no, splat (i8 -48)      ; 2 uses
  %i.nq = icmp ugt <4 x i8> %i.np, splat (i8 9)
  %i.nr = add <4 x i8> %i.no, splat (i8 -65)
  %i.ns = icmp ult <4 x i8> %i.nr, splat (i8 6)
  %i.nt = add <4 x i8> %i.no, splat (i8 -55)
  %i.nu = select <4 x i1> %i.ns, <4 x i8> %i.nt, <4 x i8> splat (i8 -1)
  %i.nv = add <4 x i8> %i.no, splat (i8 -97)
  %i.nw = icmp ult <4 x i8> %i.nv, splat (i8 6)
  %i.nx = add nsw <4 x i8> %i.no, splat (i8 -87)
  %predphi682 = select <4 x i1> %i.nw, <4 x i8> %i.nx, <4 x i8> %i.nu
  %predphi683 = select <4 x i1> %i.nq, <4 x i8> %predphi682, <4 x i8> %i.np
  %i.ny = shl <4 x i8> %predphi681, splat (i8 4)
  %i.nz = add <4 x i8> %predphi683, %i.ny
  %i.oa = getelementptr inbounds nuw i8, ptr %next.gep672, i64 4
  %i.ob = getelementptr i8, ptr %i.kr, i64 12
  %i.oc = getelementptr i8, ptr %i.ks, i64 20
  %i.od = getelementptr i8, ptr %i.kt, i64 28
  %i.oe = load i8, ptr %i.oa, align 1, !alias.scope !15
  %i.of = load i8, ptr %i.ob, align 1, !alias.scope !15
  %i.og = load i8, ptr %i.oc, align 1, !alias.scope !15
  %i.oh = load i8, ptr %i.od, align 1, !alias.scope !15
  %i.oi = insertelement <4 x i8> poison, i8 %i.oe, i64 0
  %i.oj = insertelement <4 x i8> %i.oi, i8 %i.of, i64 1
  %i.ok = insertelement <4 x i8> %i.oj, i8 %i.og, i64 2
  %i.ol = insertelement <4 x i8> %i.ok, i8 %i.oh, i64 3 ; 6 uses
  %i.om = add <4 x i8> %i.ol, splat (i8 -58)
  %i.on = icmp ult <4 x i8> %i.om, splat (i8 -10)
  %i.oo = add <4 x i8> %i.ol, splat (i8 -65)
  %i.op = icmp ult <4 x i8> %i.oo, splat (i8 6)
  %i.oq = add <4 x i8> %i.ol, splat (i8 9)
  %i.or = select <4 x i1> %i.op, <4 x i8> %i.oq, <4 x i8> splat (i8 15)
  %i.os = add <4 x i8> %i.ol, splat (i8 -97)
  %i.ot = icmp ult <4 x i8> %i.os, splat (i8 6)
  %i.ou = add <4 x i8> %i.ol, splat (i8 9)
  %predphi684 = select <4 x i1> %i.ot, <4 x i8> %i.ou, <4 x i8> %i.or
  %predphi685 = select <4 x i1> %i.on, <4 x i8> %predphi684, <4 x i8> %i.ol
  %i.ov = getelementptr inbounds nuw i8, ptr %next.gep672, i64 5
  %i.ow = getelementptr i8, ptr %i.kr, i64 13
  %i.ox = getelementptr i8, ptr %i.ks, i64 21
  %i.oy = getelementptr i8, ptr %i.kt, i64 29
  %i.oz = load i8, ptr %i.ov, align 1, !alias.scope !15
  %i.pa = load i8, ptr %i.ow, align 1, !alias.scope !15
  %i.pb = load i8, ptr %i.ox, align 1, !alias.scope !15
  %i.pc = load i8, ptr %i.oy, align 1, !alias.scope !15
  %i.pd = insertelement <4 x i8> poison, i8 %i.oz, i64 0
  %i.pe = insertelement <4 x i8> %i.pd, i8 %i.pa, i64 1
  %i.pf = insertelement <4 x i8> %i.pe, i8 %i.pb, i64 2
  %i.pg = insertelement <4 x i8> %i.pf, i8 %i.pc, i64 3 ; 5 uses
  %i.ph = add <4 x i8> %i.pg, splat (i8 -48)      ; 2 uses
  %i.pi = icmp ugt <4 x i8> %i.ph, splat (i8 9)
  %i.pj = add <4 x i8> %i.pg, splat (i8 -65)
  %i.pk = icmp ult <4 x i8> %i.pj, splat (i8 6)
  %i.pl = add <4 x i8> %i.pg, splat (i8 -55)
  %i.pm = select <4 x i1> %i.pk, <4 x i8> %i.pl, <4 x i8> splat (i8 -1)
  %i.pn = add <4 x i8> %i.pg, splat (i8 -97)
  %i.po = icmp ult <4 x i8> %i.pn, splat (i8 6)
  %i.pp = add nsw <4 x i8> %i.pg, splat (i8 -87)
  %predphi686 = select <4 x i1> %i.po, <4 x i8> %i.pp, <4 x i8> %i.pm
  %predphi687 = select <4 x i1> %i.pi, <4 x i8> %predphi686, <4 x i8> %i.ph
  %i.pq = shl <4 x i8> %predphi685, splat (i8 4)
  %i.pr = add <4 x i8> %predphi687, %i.pq
  %i.ps = getelementptr inbounds nuw i8, ptr %next.gep672, i64 6
  %i.pt = getelementptr i8, ptr %i.kr, i64 14
  %i.pu = getelementptr i8, ptr %i.ks, i64 22
  %i.pv = getelementptr i8, ptr %i.kt, i64 30
  %i.pw = load i8, ptr %i.ps, align 1, !alias.scope !15
  %i.px = load i8, ptr %i.pt, align 1, !alias.scope !15
  %i.py = load i8, ptr %i.pu, align 1, !alias.scope !15
  %i.pz = load i8, ptr %i.pv, align 1, !alias.scope !15
  %i.qa = insertelement <4 x i8> poison, i8 %i.pw, i64 0
  %i.qb = insertelement <4 x i8> %i.qa, i8 %i.px, i64 1
  %i.qc = insertelement <4 x i8> %i.qb, i8 %i.py, i64 2
  %i.qd = insertelement <4 x i8> %i.qc, i8 %i.pz, i64 3 ; 6 uses
  %i.qe = add <4 x i8> %i.qd, splat (i8 -58)
  %i.qf = icmp ult <4 x i8> %i.qe, splat (i8 -10)
  %i.qg = add <4 x i8> %i.qd, splat (i8 -65)
  %i.qh = icmp ult <4 x i8> %i.qg, splat (i8 6)
  %i.qi = add <4 x i8> %i.qd, splat (i8 9)
  %i.qj = select <4 x i1> %i.qh, <4 x i8> %i.qi, <4 x i8> splat (i8 15)
  %i.qk = add <4 x i8> %i.qd, splat (i8 -97)
  %i.ql = icmp ult <4 x i8> %i.qk, splat (i8 6)
  %i.qm = add <4 x i8> %i.qd, splat (i8 9)
  %predphi688 = select <4 x i1> %i.ql, <4 x i8> %i.qm, <4 x i8> %i.qj
  %predphi689 = select <4 x i1> %i.qf, <4 x i8> %predphi688, <4 x i8> %i.qd
  %i.qn = getelementptr inbounds nuw i8, ptr %next.gep672, i64 7
  %i.qo = getelementptr i8, ptr %i.kr, i64 15
  %i.qp = getelementptr i8, ptr %i.ks, i64 23
  %i.qq = getelementptr i8, ptr %i.kt, i64 31
  %i.qr = load i8, ptr %i.qn, align 1, !alias.scope !15
  %i.qs = load i8, ptr %i.qo, align 1, !alias.scope !15
  %i.qt = load i8, ptr %i.qp, align 1, !alias.scope !15
  %i.qu = load i8, ptr %i.qq, align 1, !alias.scope !15
  ...
  %i.qy = insertelement <4 x i8> %i.qx, i8 %i.qu, i64 3 ; 5 uses
  %i.qz = add <4 x i8> %i.qy, splat (i8 -48)      ; 2 uses
  %i.ra = icmp ugt <4 x i8> %i.qz, splat (i8 9)
end_hunk_0
