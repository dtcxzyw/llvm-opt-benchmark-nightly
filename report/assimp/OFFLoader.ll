...
bb.ed:                                            ; preds = %bb.ec
  %i.iz = getelementptr inbounds nuw i8, ptr %2, i64 24 ; 2 uses
...
bb.ee:                                            ; preds = %bb.ed
  ...
  %7 = load ptr, ptr %i.iz, align 8
  store ptr %i.ja, ptr %7, align 8
...
bb.hd:                                            ; preds = %bb.ib
  %i.pt = invoke noalias noundef nonnull dereferenceable(1144) ptr @_Znwm(i64 noundef 1144) #20
          to label %bb.ic unwind label %bb.ii     ; 7 uses
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit548: ; preds = %bb.ic
  %i.sb = getelementptr inbounds nuw i8, ptr %2, i64 8 ; 3 uses
  ...
  %i.sf = invoke noalias noundef nonnull dereferenceable(4) ptr @_Znam(i64 noundef 4) #20
          to label %bb.id unwind label %bb.ii

bb.id:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit548
  %8 = load ptr, ptr %i.sb, align 8
  %i.sg = getelementptr inbounds nuw i8, ptr %8, i64 1128
  store ptr %i.sf, ptr %i.sg, align 8
  %9 = load ptr, ptr %i.sb, align 8
