...
.epilog-lcssa:                                    ; preds = %bb.c, %.unr-lcssa
  %i.h = getelementptr inbounds nuw i8, ptr %0, i64 1104 ; 6 uses
...
bb.i:                                             ; preds = %.epilog-lcssa
  ...
  %3 = load i32, ptr %i.h, align 8                ; 2 uses
  %4 = zext i32 %3 to i64
  %5 = shl nuw nsw i64 %4, 3
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %i.aa, ptr align 8 %i.ac, i64 %5, i1 false)
...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  %6 = load i32, ptr %i.h, align 8                ; 2 uses
  %7 = zext i32 %6 to i64                         ; 2 uses
  %8 = shl nuw nsw i64 %7, 3
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %i.ai, ptr nonnull align 8 %i.aa, i64 %8, i1 false)
  %i.aj = getelementptr inbounds nuw [8 x i8], ptr %i.ai, i64 %7
