...
begin_hunk_0_@_ZN6Assimp11PLYImporter14InternReadFileERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEP7aiScenePNS_8IOSystemE:._crit_edge.i.i
  ...
  %i.y = invoke noalias noundef nonnull dereferenceable(1048576) ptr @_Znwm(i64 noundef 1048576) #23
          to label %bb.l unwind label %.thread151 ; 3 uses

.thread151:                                       ; preds = %_ZNKSt6vectorIcSaIcEE12_M_check_lenEmPKc.exit.i.i
...
_ZNKSt14default_deleteIN6Assimp8IOStreamEEclEPS1_.exit.i120: ; preds = %bb.cl, %bb.k, %bb.j, %.thread151
  %.pn74.pn150 = phi { ptr, i32 } [ %11, %.thread151 ], [ %.pn70.pn, %bb.cl ], [ %i.s, %bb.j ], [ %i.t, %bb.k ]
