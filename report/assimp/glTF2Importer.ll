...
bb.ah:                                            ; preds = %bb.ad
  %.not334 = icmp eq i64 %sext, -4294967296
  br i1 %.not334, label %bb.ai, label %.thread336

.thread336:                                       ; preds = %.thread, %bb.ah
...
_ZNSt6vectorIN10glTFCommon3RefIN5glTF28AccessorEEESaIS4_EE6resizeEm.exit: ; preds = %.thread336, %bb.ai, %_ZSt8_DestroyIPN10glTFCommon3RefIN5glTF28AccessorEEES4_EvT_S6_RSaIT0_E.exit.i.i
  %i.hn = phi i64 [ %i.hk, %.thread336 ], [ -1, %_ZSt8_DestroyIPN10glTFCommon3RefIN5glTF28AccessorEEES4_EvT_S6_RSaIT0_E.exit.i.i ], [ -1, %bb.ai ]
...
bb.aj:                                            ; preds = %.lr.ph, %_ZN5glTF212_GLOBAL__N_115GetAttribVectorERNS_4Mesh9PrimitiveEPKcRPSt6vectorIN10glTFCommon3RefINS_8AccessorEEESaISA_EERi.exit
  ...
  %i.hu = getelementptr inbounds nuw i8, ptr %.0126225, i64 32 ; 2 uses
  ...
  br i1 %.not147, label %.loopexit223, label %.lr.ph, !llvm.loop !850
...
bb.al:                                            ; preds = %.lr.ph231, %.loopexit220
  %i.ii = phi i32 [ %i.ig, %.lr.ph231 ], [ %i.nq, %.loopexit220 ] ; 2 uses
  %.0125229 = phi i32 [ 0, %.lr.ph231 ], [ %i.nr, %.loopexit220 ] ; 3 uses
...
.lr.ph228:                                        ; preds = %bb.am
  ...
  %i.iy = sext i32 %.0125229 to i64               ; 3 uses
  br label %bb.an
...
bb.an:                                            ; preds = %.lr.ph228, %_ZN5glTF212_GLOBAL__N_121GetAttribTargetVectorERNS_4Mesh9PrimitiveEiPKcRPSt6vectorIN10glTFCommon3RefINS_8AccessorEEESaISA_EERi.exit
  %i.iz = phi i32 [ %i.it, %.lr.ph228 ], [ %i.ni, %_ZN5glTF212_GLOBAL__N_121GetAttribTargetVectorERNS_4Mesh9PrimitiveEiPKcRPSt6vectorIN10glTFCommon3RefINS_8AccessorEEESaISA_EERi.exit ] ; 2 uses
  %i.ja = phi ptr [ %i.iu, %.lr.ph228 ], [ %i.nj, %_ZN5glTF212_GLOBAL__N_121GetAttribTargetVectorERNS_4Mesh9PrimitiveEiPKcRPSt6vectorIN10glTFCommon3RefINS_8AccessorEEESaISA_EERi.exit ] ; 2 uses
  %.0124227 = phi ptr [ %i.ix, %.lr.ph228 ], [ %i.nk, %_ZN5glTF212_GLOBAL__N_121GetAttribTargetVectorERNS_4Mesh9PrimitiveEiPKcRPSt6vectorIN10glTFCommon3RefINS_8AccessorEEESaISA_EERi.exit ] ; 6 uses
...
bb.av:                                            ; preds = %bb.au
  ...
  %i.kd = call i64 @__isoc23_strtol(ptr noundef nonnull %i.kc, ptr noundef null, i32 noundef 10) #34, !inline_history !849
...
.lr.ph.i.i.i.i188.prol:                           ; preds = %.lr.ph.i.i.i.i188.preheader, %.lr.ph.i.i.i.i188.prol
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.i.i188.prol.loopexit, label %.lr.ph.i.i.i.i188.prol, !llvm.loop !851
...
.lr.ph.i.i.i30.i.prol:                            ; preds = %_ZNKSt6vectorIN10glTFCommon3RefIN5glTF28AccessorEEESaIS4_EE12_M_check_lenEmPKc.exit.i, %.lr.ph.i.i.i30.i.prol
  ...
  br i1 %prol.iter340.cmp.not, label %.lr.ph.i.i.i30.i.prol.loopexit, label %.lr.ph.i.i.i30.i.prol, !llvm.loop !852
...
.lr.ph.i.i.i30.i:                                 ; preds = %.lr.ph.i.i.i30.i.prol.loopexit, %.lr.ph.i.i.i30.i
  ...
  br i1 %.not.i.i.i33.i.7, label %_ZSt27__uninitialized_default_n_aIPN10glTFCommon3RefIN5glTF28AccessorEEEmS4_ET_S6_T0_RSaIT1_E.exit35.i, label %.lr.ph.i.i.i30.i, !llvm.loop !34
...
.lr.ph.i.i.i37.i:                                 ; preds = %_ZSt27__uninitialized_default_n_aIPN10glTFCommon3RefIN5glTF28AccessorEEEmS4_ET_S6_T0_RSaIT1_E.exit35.i, %.lr.ph.i.i.i37.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.012.i.i.i.i, ptr noundef nonnull align 8 dereferenceable(16) %.0911.i.i.i.i, i64 16, i1 false), !alias.scope !862
  ...
  br i1 %.not.i.i.i38.i, label %_ZNSt6vectorIN10glTFCommon3RefIN5glTF28AccessorEEESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit.i, label %.lr.ph.i.i.i37.i, !llvm.loop !35
...
bb.bb:                                            ; preds = %_ZNSt6vectorIN10glTFCommon3RefIN5glTF28AccessorEEESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit.i
  %i.mx = load ptr, ptr %i.kp, align 8
  %i.my = ptrtoint ptr %i.mx to i64
  %i.mz = sub i64 %i.my, %i.kk
  call void @_ZdlPvm(ptr noundef nonnull %i.ki, i64 noundef %i.mz) #35
...
bb.bc:                                            ; preds = %bb.ax
  %i.nc = icmp ult i64 %i.kn, %i.km
  br i1 %i.nc, label %bb.bd, label %_ZNSt6vectorIN10glTFCommon3RefIN5glTF28AccessorEEESaIS4_EE6resizeEm.exit169

bb.bd:                                            ; preds = %bb.bc
  %i.nd = getelementptr inbounds nuw [16 x i8], ptr %i.ki, i64 %i.kn ; 2 uses
  %.not.i.i167 = icmp eq ptr %i.kh, %i.nd
...
_ZNSt6vectorIN10glTFCommon3RefIN5glTF28AccessorEEESaIS4_EE6resizeEm.exit169: ; preds = %_ZSt8_DestroyIPN10glTFCommon3RefIN5glTF28AccessorEEES4_EvT_S6_RSaIT0_E.exit.i.i168, %bb.bd, %bb.bc, %_ZSt27__uninitialized_default_n_aIPN10glTFCommon3RefIN5glTF28AccessorEEEmS4_ET_S6_T0_RSaIT1_E.exit.i, %_ZNSt12_Vector_baseIN10glTFCommon3RefIN5glTF28AccessorEEESaIS4_EE13_M_deallocateEPS4_m.exit41.i, %bb.aw
  ...
  %.fca.1.extract = extractvalue { ptr, i32 } %i.nf, 1
  %i.ng = load ptr, ptr %.0196.ph, align 8
  %i.nh = getelementptr inbounds nuw [16 x i8], ptr %i.ng, i64 %i.kf ; 2 uses
  store ptr %.fca.0.extract, ptr %i.nh, align 8
  %.sroa.4.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.nh, i64 8
...
_ZN5glTF212_GLOBAL__N_121GetAttribTargetVectorERNS_4Mesh9PrimitiveEiPKcRPSt6vectorIN10glTFCommon3RefINS_8AccessorEEESaISA_EERi.exit: ; preds = %_ZNSt6vectorIN10glTFCommon3RefIN5glTF28AccessorEEESaIS4_EE6resizeEm.exit169, %bb.as, %bb.an
  %i.ni = phi i32 [ %.pre254, %_ZNSt6vectorIN10glTFCommon3RefIN5glTF28AccessorEEESaIS4_EE6resizeEm.exit169 ], [ %i.iz, %bb.as ], [ %i.iz, %bb.an ] ; 2 uses
  %i.nj = phi ptr [ %.pre253, %_ZNSt6vectorIN10glTFCommon3RefIN5glTF28AccessorEEESaIS4_EE6resizeEm.exit169 ], [ %i.ja, %bb.as ], [ %i.ja, %bb.an ] ; 2 uses
  %i.nk = getelementptr inbounds nuw i8, ptr %.0124227, i64 32 ; 2 uses
  %i.nl = ptrtoint ptr %i.nj to i64
  %i.nm = and i64 %i.nl, 281474976710655
  %i.nn = inttoptr i64 %i.nm to ptr
  %i.no = zext i32 %i.ni to i64
  %i.np = getelementptr inbounds nuw [32 x i8], ptr %i.nn, i64 %i.no
  %.not151 = icmp eq ptr %i.nk, %i.np
  br i1 %.not151, label %.loopexit220.loopexit, label %bb.an, !llvm.loop !856
...
.loopexit220:                                     ; preds = %.loopexit220.loopexit, %bb.am, %bb.al
  %i.nq = phi i32 [ %.pre255, %.loopexit220.loopexit ], [ %i.ii, %bb.am ], [ %i.ii, %bb.al ] ; 2 uses
  %i.nr = add nuw i32 %.0125229, 1                ; 2 uses
  %i.ns = icmp ult i32 %i.nr, %i.nq
  br i1 %i.ns, label %bb.al, label %.loopexit222, !llvm.loop !857

.loopexit222:                                     ; preds = %.loopexit220, %bb.ak, %.loopexit223
  %i.nt = load ptr, ptr %i.cv, align 8
  %i.nu = load ptr, ptr %i.cw, align 8
  %i.nv = icmp eq ptr %i.nt, %i.nu
  br i1 %i.nv, label %bb.be, label %.loopexit221

bb.be:                                            ; preds = %.loopexit222
  %i.nw = load ptr, ptr %i.bn, align 8
  %i.nx = load ptr, ptr %i.bp, align 8
  %i.ny = call noundef ptr @_ZN10glTFCommon19FindObjectInContextERN9rapidjson12GenericValueINS0_4UTF8IcEENS0_19MemoryPoolAllocatorINS0_12CrtAllocatorEEEEEPKcSA_SA_(ptr noundef nonnull align 8 dereferenceable(16) %i.dd, ptr noundef nonnull @.str.202, ptr noundef %i.nw, ptr noundef %i.nx) ; 2 uses
  %.not149 = icmp eq ptr %i.ny, null
  br i1 %.not149, label %.loopexit221, label %bb.bf

bb.bf:                                            ; preds = %bb.be
  %i.nz = load ptr, ptr %i.bn, align 8
  %i.oa = load ptr, ptr %i.bp, align 8
  %i.ob = call noundef ptr @_ZN10glTFCommon18FindArrayInContextERN9rapidjson12GenericValueINS0_4UTF8IcEENS0_19MemoryPoolAllocatorINS0_12CrtAllocatorEEEEEPKcSA_SA_(ptr noundef nonnull align 8 dereferenceable(16) %i.ny, ptr noundef nonnull @.str.201, ptr noundef %i.nz, ptr noundef %i.oa) ; 5 uses
  %.not150 = icmp eq ptr %i.ob, null
  br i1 %.not150, label %.loopexit221, label %bb.bg

bb.bg:                                            ; preds = %bb.bf
  %i.oc = load i32, ptr %i.ob, align 8
  %i.od = zext i32 %i.oc to i64                   ; 4 uses
  %i.oe = load ptr, ptr %i.cw, align 8            ; 3 uses
  %i.of = load ptr, ptr %i.cv, align 8            ; 2 uses
  %i.og = ptrtoint ptr %i.oe to i64
  %i.oh = ptrtoint ptr %i.of to i64
  %i.oi = sub i64 %i.og, %i.oh
  %i.oj = ashr exact i64 %i.oi, 5                 ; 3 uses
  %i.ok = icmp ult i64 %i.oj, %i.od
  br i1 %i.ok, label %bb.bh, label %bb.bi

bb.bh:                                            ; preds = %bb.bg
  %i.ol = sub nuw nsw i64 %i.od, %i.oj
  call void @_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE17_M_default_appendEm(ptr noundef nonnull align 8 dereferenceable(24) %i.cv, i64 noundef %i.ol)
  br label %_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE6resizeEm.exit

bb.bi:                                            ; preds = %bb.bg
  %i.om = icmp ugt i64 %i.oj, %i.od
  br i1 %i.om, label %bb.bj, label %_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE6resizeEm.exit

bb.bj:                                            ; preds = %bb.bi
  %i.on = getelementptr inbounds nuw [32 x i8], ptr %i.of, i64 %i.od ; 3 uses
  %.not.i.i170 = icmp eq ptr %i.oe, %i.on
...
.lr.ph.i.i.i.i171:                                ; preds = %bb.bj, %_ZSt8_DestroyINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEvPT_.exit.i.i.i.i
  %.05.i.i.i.i172 = phi ptr [ %i.ot, %_ZSt8_DestroyINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEvPT_.exit.i.i.i.i ], [ %i.on, %bb.bj ] ; 3 uses
  %i.oo = load ptr, ptr %.05.i.i.i.i172, align 8  ; 2 uses
  %i.op = getelementptr inbounds nuw i8, ptr %.05.i.i.i.i172, i64 16 ; 2 uses
  %i.oq = icmp eq ptr %i.oo, %i.op
  br i1 %i.oq, label %_ZSt8_DestroyINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEvPT_.exit.i.i.i.i, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i.i

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i.i: ; preds = %.lr.ph.i.i.i.i171
  %i.or = load i64, ptr %i.op, align 8
  %i.os = add i64 %i.or, 1
  call void @_ZdlPvm(ptr noundef %i.oo, i64 noundef %i.os) #35
...
_ZSt8_DestroyINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEvPT_.exit.i.i.i.i: ; preds = %.lr.ph.i.i.i.i171, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i.i
  %i.ot = getelementptr inbounds nuw i8, ptr %.05.i.i.i.i172, i64 32 ; 2 uses
  %.not.i.i.i.i173 = icmp eq ptr %i.ot, %i.oe
  br i1 %.not.i.i.i.i173, label %_ZSt8_DestroyIPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES5_EvT_S7_RSaIT0_E.exit.i.i, label %.lr.ph.i.i.i.i171, !llvm.loop !36
...
_ZSt8_DestroyIPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES5_EvT_S7_RSaIT0_E.exit.i.i: ; preds = %_ZSt8_DestroyINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEvPT_.exit.i.i.i.i
  store ptr %i.on, ptr %i.cw, align 8
  br label %_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE6resizeEm.exit
...
_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE6resizeEm.exit: ; preds = %bb.bh, %bb.bi, %bb.bj, %_ZSt8_DestroyIPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES5_EvT_S7_RSaIT0_E.exit.i.i
  %i.ou = load i32, ptr %i.ob, align 8            ; 2 uses
  %.not242 = icmp eq i32 %i.ou, 0
...
.lr.ph233:                                        ; preds = %_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE6resizeEm.exit
  %i.ov = getelementptr inbounds nuw i8, ptr %i.ob, i64 8
  br label %bb.bk

bb.bk:                                            ; preds = %.lr.ph233, %bb.bm
  %i.ow = phi i32 [ %i.ou, %.lr.ph233 ], [ %i.ps, %bb.bm ]
  %indvars.iv = phi i64 [ 0, %.lr.ph233 ], [ %indvars.iv.next, %bb.bm ] ; 3 uses
  %i.ox = load ptr, ptr %i.ov, align 8
  %i.oy = ptrtoint ptr %i.ox to i64
  %i.oz = and i64 %i.oy, 281474976710655
  %i.pa = inttoptr i64 %i.oz to ptr
  %i.pb = getelementptr inbounds nuw [16 x i8], ptr %i.pa, i64 %indvars.iv ; 3 uses
  %i.pc = getelementptr inbounds nuw i8, ptr %i.pb, i64 14
  %i.pd = load i16, ptr %i.pc, align 2            ; 2 uses
  %i.pe = and i16 %i.pd, 1024
  %.not216 = icmp eq i16 %i.pe, 0
  br i1 %.not216, label %bb.bm, label %bb.bl

bb.bl:                                            ; preds = %bb.bk
  %i.pf = and i16 %i.pd, 4096
  %.not.i.i174 = icmp eq i16 %i.pf, 0
  %i.pg = getelementptr inbounds nuw i8, ptr %i.pb, i64 8
  %i.ph = load ptr, ptr %i.pg, align 8
  %i.pi = ptrtoint ptr %i.ph to i64
  %i.pj = and i64 %i.pi, 281474976710655
  %i.pk = inttoptr i64 %i.pj to ptr
  %i.pl = select i1 %.not.i.i174, ptr %i.pk, ptr %i.pb ; 2 uses
  %i.pm = load ptr, ptr %i.cv, align 8
  %i.pn = getelementptr inbounds nuw [32 x i8], ptr %i.pm, i64 %indvars.iv ; 2 uses
  %i.po = getelementptr inbounds nuw i8, ptr %i.pn, i64 8
  %i.pp = load i64, ptr %i.po, align 8
  %i.pq = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %i.pl) #34
  %i.pr = call noundef nonnull align 8 dereferenceable(32) ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_replaceEmmPKcm(ptr noundef nonnull align 8 dereferenceable(32) %i.pn, i64 noundef 0, i64 noundef %i.pp, ptr noundef nonnull %i.pl, i64 noundef %i.pq) ; 0 uses
  %.pre256 = load i32, ptr %i.ob, align 8
  br label %bb.bm

bb.bm:                                            ; preds = %bb.bl, %bb.bk
  %i.ps = phi i32 [ %.pre256, %bb.bl ], [ %i.ow, %bb.bk ] ; 2 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.pt = zext i32 %i.ps to i64
  %i.pu = icmp samesign ult i64 %indvars.iv.next, %i.pt
  br i1 %i.pu, label %bb.bk, label %.loopexit221, !llvm.loop !858
...
.loopexit221:                                     ; preds = %bb.bm, %_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE6resizeEm.exit, %bb.be, %bb.bf, %.loopexit222
  %i.pv = add i32 %i.cx, 1                        ; 3 uses
  store i32 %i.pv, ptr %i.a, align 4
  %i.pw = load i32, ptr %i.br, align 8
  %i.px = icmp ult i32 %i.pv, %i.pw
  br i1 %i.px, label %bb.j, label %._crit_edge, !llvm.loop !859
...
bb.bn:                                            ; preds = %._crit_edge, %_ZN10glTFCommon10FindMemberERN9rapidjson12GenericValueINS0_4UTF8IcEENS0_19MemoryPoolAllocatorINS0_12CrtAllocatorEEEEEPKc.exit.thread
  %i.py = load ptr, ptr %i.bn, align 8
  %i.pz = load ptr, ptr %i.bp, align 8
  %i.qa = call noundef ptr @_ZN10glTFCommon18FindArrayInContextERN9rapidjson12GenericValueINS0_4UTF8IcEENS0_19MemoryPoolAllocatorINS0_12CrtAllocatorEEEEEPKcSA_SA_(ptr noundef nonnull align 8 dereferenceable(16) %1, ptr noundef nonnull @.str.111, ptr noundef %i.py, ptr noundef %i.pz) ; 5 uses
  %.not141 = icmp eq ptr %i.qa, null
  br i1 %.not141, label %.loopexit219, label %bb.bo

bb.bo:                                            ; preds = %bb.bn
  %i.qb = getelementptr inbounds nuw i8, ptr %0, i64 288 ; 3 uses
  %i.qc = load i32, ptr %i.qa, align 8
  %i.qd = zext i32 %i.qc to i64                   ; 4 uses
  %i.qe = getelementptr inbounds nuw i8, ptr %0, i64 296 ; 2 uses
  %i.qf = load ptr, ptr %i.qe, align 8            ; 2 uses
  %i.qg = load ptr, ptr %i.qb, align 8            ; 2 uses
  %i.qh = ptrtoint ptr %i.qf to i64
  %i.qi = ptrtoint ptr %i.qg to i64
  %i.qj = sub i64 %i.qh, %i.qi
  %i.qk = ashr exact i64 %i.qj, 2                 ; 3 uses
  %i.ql = icmp ult i64 %i.qk, %i.qd
  br i1 %i.ql, label %bb.bp, label %bb.bq

bb.bp:                                            ; preds = %bb.bo
  %i.qm = sub nuw nsw i64 %i.qd, %i.qk
  call void @_ZNSt6vectorIfSaIfEE17_M_default_appendEm(ptr noundef nonnull align 8 dereferenceable(24) %i.qb, i64 noundef %i.qm)
  br label %_ZNSt6vectorIfSaIfEE6resizeEm.exit

bb.bq:                                            ; preds = %bb.bo
  %i.qn = icmp ugt i64 %i.qk, %i.qd
  br i1 %i.qn, label %bb.br, label %_ZNSt6vectorIfSaIfEE6resizeEm.exit

bb.br:                                            ; preds = %bb.bq
  %i.qo = getelementptr inbounds nuw [4 x i8], ptr %i.qg, i64 %i.qd ; 2 uses
  %.not.i.i175 = icmp eq ptr %i.qf, %i.qo
