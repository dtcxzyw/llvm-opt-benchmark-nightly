...
bb.d:                                             ; preds = %bb.c
  ...
  %2 = load <2 x float>, ptr %.sroa.8143.0..sroa_idx144, align 4 ; 3 uses
  %3 = fmul float %.sroa.6140.0.copyload142, 0.000000e+00 ; 2 uses
  %4 = fadd float %.sroa.0138.0.copyload139, %3
  %5 = shufflevector <2 x float> %2, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %6 = insertelement <2 x float> poison, float %4, i64 0
  %7 = insertelement <2 x float> %6, float %i.bf, i64 1
  %i.bg = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %5, <2 x float> zeroinitializer, <2 x float> %7)
  %i.bh = insertelement <2 x float> %5, float %.sroa.0138.0.copyload139, i64 0
  %i.bi = insertelement <2 x float> <float 0.000000e+00, float poison>, float %i.be, i64 1 ; 4 uses
  %i.bj = insertelement <2 x float> poison, float %3, i64 0
  %8 = shufflevector <2 x float> %2, <2 x float> poison, <4 x i32> <i32 poison, i32 1, i32 poison, i32 poison>
  %9 = shufflevector <4 x float> %8, <4 x float> <float poison, float -0.000000e+00, float poison, float poison>, <4 x i32> <i32 1, i32 1, i32 1, i32 5>
  ...
  %10 = tail call float @llvm.fmuladd.f32(float %.sroa.12149.0.copyload151, float 0.000000e+00, float %.sroa.14152.0.copyload154)
  %11 = load <2 x float>, ptr %.sroa.16155.0..sroa_idx156, align 4 ; 3 uses
  %12 = fmul float %.sroa.14152.0.copyload154, 0.000000e+00 ; 2 uses
  %13 = fadd float %.sroa.12149.0.copyload151, %12
  %14 = shufflevector <2 x float> %11, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %15 = insertelement <2 x float> poison, float %13, i64 0
  %16 = insertelement <2 x float> %15, float %10, i64 1
  %17 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %14, <2 x float> zeroinitializer, <2 x float> %16)
  %18 = insertelement <2 x float> %14, float %.sroa.12149.0.copyload151, i64 0
  %i.bk = insertelement <2 x float> poison, float %12, i64 0
  %19 = shufflevector <2 x float> %11, <2 x float> poison, <4 x i32> <i32 poison, i32 1, i32 poison, i32 poison>
  %20 = shufflevector <4 x float> %19, <4 x float> <float poison, float -0.000000e+00, float poison, float poison>, <4 x i32> <i32 1, i32 1, i32 1, i32 5>
  %.sroa.22164.0.copyload166 = load float, ptr %.sroa.22164.0..sroa_idx165, align 4 ; 3 uses
  %.sroa.20161.0.copyload163 = load float, ptr %.sroa.20161.0..sroa_idx162, align 4 ; 4 uses
  %i.bl = tail call float @llvm.fmuladd.f32(float %.sroa.20161.0.copyload163, float 0.000000e+00, float %.sroa.22164.0.copyload166)
  %i.bm = load <2 x float>, ptr %.sroa.24167.0..sroa_idx168, align 4 ; 3 uses
  %21 = fmul float %.sroa.22164.0.copyload166, 0.000000e+00 ; 2 uses
  %22 = fadd float %.sroa.20161.0.copyload163, %21
  %23 = shufflevector <2 x float> %i.bm, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.bn = insertelement <2 x float> poison, float %22, i64 0
  %i.bo = insertelement <2 x float> %i.bn, float %i.bl, i64 1
  %i.bp = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %23, <2 x float> zeroinitializer, <2 x float> %i.bo)
  %24 = insertelement <2 x float> %23, float %.sroa.20161.0.copyload163, i64 0
  ...
  %26 = tail call float @llvm.fmuladd.f32(float %.sroa.28173.0.copyload175, float 0.000000e+00, float %.sroa.30176.0.copyload178)
  %27 = load <2 x float>, ptr %.sroa.32179.0..sroa_idx180, align 4 ; 3 uses
  %i.bs = load float, ptr %i.bc, align 8          ; 4 uses
  %28 = load float, ptr %i.bb, align 4            ; 4 uses
  %29 = fmul float %i.bs, %.sroa.6140.0.copyload142
  %i.bt = tail call float @llvm.fmuladd.f32(float %28, float %.sroa.0138.0.copyload139, float %29)
  %i.bu = insertelement <2 x float> %i.bj, float %i.bt, i64 1
  %30 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bh, <2 x float> %i.bi, <2 x float> %i.bu)
  %31 = fadd <2 x float> %2, %30
  %32 = shufflevector <2 x float> %i.bg, <2 x float> %31, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %33 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %9, <4 x float> zeroinitializer, <4 x float> %32)
  store <4 x float> %33, ptr %0, align 4
  %34 = fmul float %i.bs, %.sroa.14152.0.copyload154
  %35 = tail call float @llvm.fmuladd.f32(float %28, float %.sroa.12149.0.copyload151, float %34)
  %i.bv = insertelement <2 x float> %i.bk, float %35, i64 1
  %i.bw = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %18, <2 x float> %i.bi, <2 x float> %i.bv)
  %i.bx = fadd <2 x float> %11, %i.bw
  %36 = shufflevector <2 x float> %17, <2 x float> %i.bx, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %37 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %20, <4 x float> zeroinitializer, <4 x float> %36)
  store <4 x float> %37, ptr %.sroa.12149.0..sroa_idx150, align 4
  %38 = fmul float %i.bs, %.sroa.22164.0.copyload166
  %39 = tail call float @llvm.fmuladd.f32(float %28, float %.sroa.20161.0.copyload163, float %38)
  %40 = insertelement <2 x float> %25, float %39, i64 1
  %41 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %24, <2 x float> %i.bi, <2 x float> %40)
  %42 = fadd <2 x float> %i.bm, %41
  %43 = shufflevector <2 x float> %i.bp, <2 x float> %42, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %44 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.br, <4 x float> zeroinitializer, <4 x float> %43)
  store <4 x float> %44, ptr %.sroa.20161.0..sroa_idx162, align 4
  %45 = fmul float %i.bs, %.sroa.30176.0.copyload178
  %i.by = fmul float %.sroa.30176.0.copyload178, 0.000000e+00 ; 2 uses
  %46 = fadd float %.sroa.28173.0.copyload175, %i.by
  %47 = shufflevector <2 x float> %27, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %48 = insertelement <2 x float> poison, float %46, i64 0
  %49 = insertelement <2 x float> %48, float %26, i64 1
  %i.bz = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %47, <2 x float> zeroinitializer, <2 x float> %49)
  %50 = tail call float @llvm.fmuladd.f32(float %28, float %.sroa.28173.0.copyload175, float %45)
  %i.ca = insertelement <2 x float> %47, float %.sroa.28173.0.copyload175, i64 0
  %i.cb = insertelement <2 x float> poison, float %i.by, i64 0
  %i.cc = insertelement <2 x float> %i.cb, float %50, i64 1
  %i.cd = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ca, <2 x float> %i.bi, <2 x float> %i.cc)
  %i.ce = fadd <2 x float> %27, %i.cd
  %i.cf = shufflevector <2 x float> %27, <2 x float> poison, <4 x i32> <i32 poison, i32 1, i32 poison, i32 poison>
