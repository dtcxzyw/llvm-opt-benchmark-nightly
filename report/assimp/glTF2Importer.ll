...
bb.f:                                             ; preds = %bb.e
  ...
  %i.eo = getelementptr inbounds nuw i8, ptr %1, i64 408
  %2 = load float, ptr %i.eo, align 8             ; 3 uses
  %3 = fneg float %2                              ; 2 uses
  ...
  %.sroa.34131.0.copyload133.a = load float, ptr %.sroa.34131.0..sroa_idx132, align 4
  %i.fc = load <2 x float>, ptr %i.em, align 4    ; 4 uses
  %4 = shufflevector <2 x float> %i.fc, <2 x float> poison, <4 x i32> <i32 poison, i32 0, i32 0, i32 poison>
  %5 = shufflevector <4 x float> <float -2.000000e+00, float poison, float poison, float 0.000000e+00>, <4 x float> %4, <4 x i32> <i32 0, i32 5, i32 6, i32 3>
  %6 = shufflevector <2 x float> %i.fc, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 poison> ; 3 uses
  %7 = insertelement <4 x float> %6, float -0.000000e+00, i64 3
  %8 = shufflevector <4 x float> %6, <4 x float> <float poison, float -2.000000e+00, float poison, float 0.000000e+00>, <4 x i32> <i32 0, i32 5, i32 2, i32 7>
  %9 = load <2 x float>, ptr %i.en, align 8       ; 6 uses
  %10 = shufflevector <2 x float> %i.fc, <2 x float> %9, <4 x i32> <i32 0, i32 0, i32 3, i32 3>
  %11 = insertelement <4 x float> poison, float %3, i64 0
  %i.fd = insertelement <4 x float> %11, float %2, i64 1
  %12 = shufflevector <4 x float> %i.fd, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %13 = fmul <4 x float> %10, %12                 ; 3 uses
  %14 = fmul <2 x float> %9, %9                   ; 2 uses
  %i.fe = extractelement <2 x float> %14, i64 1
  %15 = extractelement <2 x float> %9, i64 0      ; 2 uses
  %16 = tail call float @llvm.fmuladd.f32(float %15, float %15, float %i.fe)
  %i.ff = insertelement <4 x float> %7, float %16, i64 0
  %17 = shufflevector <2 x float> %9, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 2 uses
  %18 = shufflevector <4 x float> %i.ff, <4 x float> %17, <4 x i32> <i32 0, i32 1, i32 5, i32 3> ; 2 uses
  %19 = shufflevector <4 x float> <float 1.000000e+00, float poison, float poison, float 1.000000e+00>, <4 x float> %13, <4 x i32> <i32 0, i32 6, i32 poison, i32 3>
  %20 = shufflevector <4 x float> %18, <4 x float> <float poison, float poison, float poison, float -0.000000e+00>, <4 x i32> <i32 1, i32 poison, i32 2, i32 7>
  %21 = shufflevector <2 x float> %i.fc, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %22 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %21, <2 x float> %21, <2 x float> %14)
  %23 = shufflevector <2 x float> %22, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 2 uses
  %24 = shufflevector <4 x float> %20, <4 x float> %23, <4 x i32> <i32 0, i32 5, i32 2, i32 3>
  %25 = shufflevector <4 x float> <float poison, float 1.000000e+00, float poison, float 1.000000e+00>, <4 x float> %13, <4 x i32> <i32 7, i32 1, i32 4, i32 3>
  %26 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %8, <4 x float> %24, <4 x float> %25) ; 2 uses
  %27 = fmul <4 x float> %26, <float 2.000000e+00, float 1.000000e+00, float 2.000000e+00, float 0.000000e+00> ; 2 uses
  %28 = insertelement <4 x float> poison, float %2, i64 0
  %29 = insertelement <4 x float> %28, float %3, i64 1
  %30 = shufflevector <2 x float> %9, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 poison, i32 poison>
  %31 = fmul <4 x float> %30, %29                 ; 2 uses
  %32 = shufflevector <4 x float> %19, <4 x float> %31, <4 x i32> <i32 0, i32 1, i32 4, i32 3>
  %i.fg = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %5, <4 x float> %18, <4 x float> %32) ; 2 uses
  %i.fh = fmul <4 x float> %i.fg, <float 1.000000e+00, float 2.000000e+00, float 2.000000e+00, float 0.000000e+00> ; 2 uses
  %i.fi = shufflevector <4 x float> %6, <4 x float> <float poison, float poison, float -2.000000e+00, float 0.000000e+00>, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %33 = shufflevector <4 x float> %17, <4 x float> <float poison, float poison, float poison, float -0.000000e+00>, <4 x i32> <i32 1, i32 1, i32 poison, i32 7>
  %34 = shufflevector <4 x float> %33, <4 x float> %23, <4 x i32> <i32 0, i32 1, i32 4, i32 3>
  %35 = shufflevector <4 x float> <float poison, float poison, float 1.000000e+00, float 1.000000e+00>, <4 x float> %31, <4 x i32> <i32 5, i32 poison, i32 2, i32 3>
  %36 = shufflevector <4 x float> %35, <4 x float> %13, <4 x i32> <i32 0, i32 5, i32 2, i32 3>
  %i.fj = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.fi, <4 x float> %34, <4 x float> %36) ; 2 uses
  ...
  %i.fm = fmul <4 x float> %i.fl, %27
  %i.fn = shufflevector <4 x float> %i.ep, <4 x float> poison, <4 x i32> zeroinitializer
  %i.fo = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.fh, <4 x float> %i.fn, <4 x float> %i.fm)
  ...
  %i.fu = shufflevector <4 x float> %27, <4 x float> %26, <4 x i32> <i32 0, i32 5, i32 2, i32 poison>
  ...
  %i.fy = shufflevector <4 x float> %i.fg, <4 x float> %i.fh, <4 x i32> <i32 0, i32 5, i32 6, i32 poison>
  ...
  %i.gx = insertelement <4 x float> poison, float %.sroa.34131.0.copyload133.a, i64 0
