...
bb.d:                                             ; preds = %bb.c
  ...
  %2 = load <2 x float>, ptr %i.bb, align 4
  %i.be = load <4 x float>, ptr %0, align 4       ; 4 uses
  %3 = shufflevector <2 x float> %2, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 0> ; 3 uses
  %4 = shufflevector <4 x float> <float 0.000000e+00, float 1.000000e+00, float 0.000000e+00, float poison>, <4 x float> %3, <4 x i32> <i32 0, i32 1, i32 2, i32 5>
  %5 = shufflevector <4 x float> %i.be, <4 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %6 = fmul <4 x float> %4, %5
  %7 = shufflevector <4 x float> <float 1.000000e+00, float 0.000000e+00, float 0.000000e+00, float poison>, <4 x float> %3, <4 x i32> <i32 0, i32 1, i32 2, i32 4>
  %i.bf = shufflevector <4 x float> %i.be, <4 x float> poison, <4 x i32> zeroinitializer
  %8 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %7, <4 x float> %i.bf, <4 x float> %6)
  %9 = shufflevector <4 x float> %i.be, <4 x float> poison, <4 x i32> <i32 2, i32 2, i32 2, i32 2>
  %10 = shufflevector <4 x float> %i.be, <4 x float> poison, <4 x i32> <i32 3, i32 3, i32 3, i32 3>
  %11 = load <4 x float>, ptr %.sroa.12149.0..sroa_idx150, align 4 ; 4 uses
  %i.bg = load <2 x float>, ptr %i.bc, align 8
  %i.bh = load float, ptr %i.bd, align 4
  %12 = shufflevector <2 x float> %i.bg, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 0> ; 3 uses
  %13 = shufflevector <4 x float> <float 0.000000e+00, float 1.000000e+00, float 0.000000e+00, float poison>, <4 x float> %12, <4 x i32> <i32 0, i32 1, i32 2, i32 4>
  %14 = shufflevector <4 x float> %11, <4 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %15 = fmul <4 x float> %13, %14
  %16 = shufflevector <4 x float> <float 1.000000e+00, float 0.000000e+00, float 0.000000e+00, float poison>, <4 x float> %3, <4 x i32> <i32 0, i32 1, i32 2, i32 7> ; 3 uses
  %17 = shufflevector <4 x float> %11, <4 x float> poison, <4 x i32> zeroinitializer
  %18 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %16, <4 x float> %17, <4 x float> %15)
  %i.bi = shufflevector <4 x float> <float 0.000000e+00, float 0.000000e+00, float 1.000000e+00, float poison>, <4 x float> %12, <4 x i32> <i32 0, i32 1, i32 2, i32 5> ; 2 uses
  %i.bj = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.bi, <4 x float> %9, <4 x float> %8)
  %19 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %10, <4 x float> <float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 1.000000e+00>, <4 x float> %i.bj)
  %20 = shufflevector <4 x float> %11, <4 x float> poison, <4 x i32> <i32 2, i32 2, i32 2, i32 2>
  %21 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.bi, <4 x float> %20, <4 x float> %18)
  %22 = shufflevector <4 x float> %11, <4 x float> poison, <4 x i32> <i32 3, i32 3, i32 3, i32 3>
  %23 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %22, <4 x float> <float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 1.000000e+00>, <4 x float> %21)
  store <4 x float> %19, ptr %0, align 4
  store <4 x float> %23, ptr %.sroa.12149.0..sroa_idx150, align 4
  %24 = load <4 x float>, ptr %.sroa.20161.0..sroa_idx162, align 4 ; 4 uses
  %25 = shufflevector <4 x float> <float 0.000000e+00, float 1.000000e+00, float 0.000000e+00, float poison>, <4 x float> %12, <4 x i32> <i32 0, i32 1, i32 2, i32 7> ; 2 uses
  %26 = shufflevector <4 x float> %24, <4 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %27 = fmul <4 x float> %25, %26
  %28 = shufflevector <4 x float> %24, <4 x float> poison, <4 x i32> zeroinitializer
  %i.bk = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %16, <4 x float> %28, <4 x float> %27)
  %29 = insertelement <4 x float> <float 0.000000e+00, float 0.000000e+00, float 1.000000e+00, float poison>, float %i.bh, i64 3 ; 2 uses
  %30 = shufflevector <4 x float> %24, <4 x float> poison, <4 x i32> <i32 2, i32 2, i32 2, i32 2>
  %i.bl = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %29, <4 x float> %30, <4 x float> %i.bk)
  %31 = shufflevector <4 x float> %24, <4 x float> poison, <4 x i32> <i32 3, i32 3, i32 3, i32 3>
  %i.bm = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %31, <4 x float> <float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 1.000000e+00>, <4 x float> %i.bl)
  store <4 x float> %i.bm, ptr %.sroa.20161.0..sroa_idx162, align 4
  %32 = load <4 x float>, ptr %.sroa.28173.0..sroa_idx174, align 4 ; 4 uses
  %33 = shufflevector <4 x float> %32, <4 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %34 = fmul <4 x float> %25, %33
  %35 = shufflevector <4 x float> %32, <4 x float> poison, <4 x i32> zeroinitializer
  %i.bn = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %16, <4 x float> %35, <4 x float> %34)
  %36 = shufflevector <4 x float> %32, <4 x float> poison, <4 x i32> <i32 2, i32 2, i32 2, i32 2>
  %i.bo = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %29, <4 x float> %36, <4 x float> %i.bn)
  %37 = shufflevector <4 x float> %32, <4 x float> poison, <4 x i32> <i32 3, i32 3, i32 3, i32 3>
  %38 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %37, <4 x float> <float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 1.000000e+00>, <4 x float> %i.bo)
  store <4 x float> %38, ptr %.sroa.28173.0..sroa_idx174, align 4
  br label %bb.e
