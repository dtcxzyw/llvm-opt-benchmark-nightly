...
bb.d:                                             ; preds = %bb.c
  ...
  %2 = load float, ptr %i.bc, align 8
  %3 = insertelement <2 x float> %i.bs, float 0.000000e+00, i64 0
  %4 = shufflevector <2 x float> %i.bs, <2 x float> <float 0.000000e+00, float poison>, <2 x i32> <i32 2, i32 0> ; 4 uses
  %i.bt = insertelement <2 x float> <float 0.000000e+00, float poison>, float %2, i64 1 ; 3 uses
  %5 = load <2 x float>, ptr %.sroa.28173.0..sroa_idx174, align 4 ; 4 uses
  %6 = shufflevector <2 x float> %5, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %7 = fmul <2 x float> %6, %3                    ; 2 uses
  %8 = shufflevector <2 x float> %5, <2 x float> poison, <2 x i32> zeroinitializer
  %i.bu = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %8, <2 x float> %4, <2 x float> %7)
  ...
  %i.bx = fmul <2 x float> %i.bw, %i.bt           ; 2 uses
  %9 = load <2 x float>, ptr %.sroa.12149.0..sroa_idx150, align 4 ; 4 uses
  %10 = shufflevector <2 x float> %9, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %i.by = load <2 x float>, ptr %0, align 4       ; 4 uses
  %i.bz = shufflevector <2 x float> %i.by, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %11 = shufflevector <2 x float> %5, <2 x float> %i.bv, <4 x i32> <i32 0, i32 2, i32 poison, i32 poison> ; 2 uses
  %12 = shufflevector <2 x float> %9, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 2 uses
  %13 = shufflevector <4 x float> %11, <4 x float> %12, <4 x i32> <i32 0, i32 1, i32 4, i32 poison>
  %14 = shufflevector <2 x float> %i.by, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 2 uses
  %15 = shufflevector <4 x float> %13, <4 x float> %14, <4 x i32> <i32 0, i32 1, i32 2, i32 4>
  %16 = shufflevector <2 x float> %5, <2 x float> %i.bv, <4 x i32> <i32 1, i32 3, i32 poison, i32 poison>
  %17 = shufflevector <4 x float> %16, <4 x float> %12, <4 x i32> <i32 0, i32 1, i32 5, i32 poison>
  %18 = shufflevector <4 x float> %17, <4 x float> %14, <4 x i32> <i32 0, i32 1, i32 2, i32 5>
  %19 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %15, <4 x float> zeroinitializer, <4 x float> %18) ; 4 uses
  %20 = shufflevector <2 x float> %i.bv, <2 x float> poison, <2 x i32> zeroinitializer
  %21 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %4, <2 x float> %20, <2 x float> %i.bx)
  %22 = shufflevector <2 x float> %9, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %23 = fmul <2 x float> %22, %i.bt               ; 2 uses
  %24 = shufflevector <2 x float> %23, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %25 = shufflevector <2 x float> %9, <2 x float> poison, <2 x i32> zeroinitializer
  %26 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %4, <2 x float> %25, <2 x float> %23)
  %27 = shufflevector <2 x float> %i.by, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %28 = fmul <2 x float> %27, %i.bt               ; 2 uses
  %29 = shufflevector <2 x float> %28, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %30 = shufflevector <4 x float> %11, <4 x float> %10, <4 x i32> <i32 0, i32 1, i32 4, i32 poison>
  %31 = shufflevector <4 x float> %30, <4 x float> %i.bz, <4 x i32> <i32 0, i32 1, i32 2, i32 4>
  %32 = shufflevector <2 x float> %7, <2 x float> %i.bx, <4 x i32> <i32 0, i32 2, i32 poison, i32 poison>
  %33 = shufflevector <4 x float> %32, <4 x float> %24, <4 x i32> <i32 0, i32 1, i32 4, i32 poison>
  %34 = shufflevector <4 x float> %33, <4 x float> %29, <4 x i32> <i32 0, i32 1, i32 2, i32 4>
  %35 = fadd <4 x float> %31, %34                 ; 4 uses
  %i.ca = shufflevector <4 x float> %35, <4 x float> %19, <4 x i32> <i32 1, i32 5, i32 poison, i32 poison>
  %i.cb = shufflevector <4 x float> %35, <4 x float> %19, <4 x i32> <i32 2, i32 6, i32 poison, i32 poison>
  %i.cc = shufflevector <4 x float> %35, <4 x float> %19, <4 x i32> <i32 3, i32 7, i32 poison, i32 poison>
  %i.cd = shufflevector <2 x float> %i.by, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ce = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %4, <2 x float> %i.cd, <2 x float> %28)
  ...
  %i.cj = shufflevector <2 x float> %26, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  ...
  %i.cn = shufflevector <2 x float> %21, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  ...
  %i.ct = shufflevector <4 x float> %35, <4 x float> %19, <4 x i32> <i32 0, i32 4, i32 poison, i32 poison>
