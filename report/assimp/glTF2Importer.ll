...
.lr.ph356:                                        ; preds = %_ZNK10glTFCommon3RefIN5glTF24SkinEEcvbEv.exit
  ...
  %wide.trip.count456 = zext nneg i32 %i.fx to i64
  br label %bb.ae
...
bb.ae:                                            ; preds = %.lr.ph356, %_ZNSt6vectorIS_I14aiVertexWeightSaIS0_EESaIS2_EED2Ev.exit
  %indvars.iv453 = phi i64 [ 0, %.lr.ph356 ], [ %indvars.iv.next454, %_ZNSt6vectorIS_I14aiVertexWeightSaIS0_EESaIS2_EED2Ev.exit ] ; 3 uses
  %i.hb = load ptr, ptr %i.fo, align 8
  %i.hc = getelementptr inbounds nuw [4 x i8], ptr %i.hb, i64 %i.fu
  %i.hd = load i32, ptr %i.hc, align 4
  %i.he = trunc nuw nsw i64 %indvars.iv453 to i32
...
_ZNSt12_Vector_baseISt6vectorI14aiVertexWeightSaIS1_EESaIS3_EEC2EmRKS4_.exit.thread.i: ; preds = %bb.ae, %.noexc158
  ...
  %i.ix = getelementptr inbounds nuw [264 x i8], ptr %i.iw, i64 %indvars.iv453 ; 4 uses
...
._crit_edge.i:                                    ; preds = %_ZN5glTF28Accessor11ExtractDataIZL24BuildVertexWeightMappingRNS_4Mesh9PrimitiveERSt6vectorIS5_I14aiVertexWeightSaIS6_EESaIS8_EEPS5_IjSaIjEEE7WeightsEEmRPT_PKSD_.exit.i
  ...
  %.pre368.i.a = load ptr, ptr %.pre.i, align 8
  %.phi.trans.insert.i = getelementptr inbounds nuw i8, ptr %.pre.i, i64 8
  %.pre369.i.a = load i32, ptr %.phi.trans.insert.i, align 8
  %.pre370.i = load ptr, ptr %.pre368.i.a, align 8
  %.phi.trans.insert371.i.a = zext i32 %.pre369.i.a to i64
  %.phi.trans.insert372.i = getelementptr inbounds nuw [8 x i8], ptr %.pre370.i, i64 %.phi.trans.insert371.i.a
  %.pre373.i = load ptr, ptr %.phi.trans.insert372.i, align 8 ; 2 uses
  %.phi.trans.insert376.i = getelementptr inbounds nuw i8, ptr %.pre373.i, i64 288
  %.pre377.i.a = load i32, ptr %.phi.trans.insert376.i, align 8 ; 3 uses
  %.phi.trans.insert374.i = getelementptr inbounds nuw i8, ptr %.pre373.i, i64 304
  %.pre375.i = load i32, ptr %.phi.trans.insert374.i, align 8
  %i.kh = zext i32 %.pre375.i to i64
  ...
  %switch.tableidx = add i32 %.pre377.i.a, -5120  ; 2 uses
  %i.kl = icmp ult i32 %switch.tableidx, 7
  %switch.maskindex = trunc i32 %.pre377.i.a to i8
  %switch.shifted = lshr i8 111, %switch.maskindex
  %switch.lobit = trunc i8 %switch.shifted to i1
  %or.cond833 = select i1 %i.kl, i1 %switch.lobit, i1 false
  br i1 %or.cond833, label %switch.lookup, label %bb.ah
...
bb.ah:                                            ; preds = %._crit_edge.i
  ...
  invoke void @_Z12ai_to_stringIN5glTF213ComponentTypeEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEET_(ptr dead_on_unwind nonnull writable sret(%"class.std::__cxx11::basic_string") align 8 %18, i32 noundef %.pre377.i.a)
...
.lr.ph110.i186.i.preheader:                       ; preds = %.preheader.i184.i
  %xtraiter957 = and i64 %i.aes, 3                ; 3 uses
...
.lr.ph110.i186.i.preheader.new:                   ; preds = %.lr.ph110.i186.i.preheader
  %unroll_iter960 = and i64 %i.aes, -4
...
.lr.ph110.i186.i:                                 ; preds = %.lr.ph110.i186.i, %.lr.ph110.i186.i.preheader.new
  ...
  %niter961 = phi i64 [ 0, %.lr.ph110.i186.i.preheader.new ], [ %niter961.next.3, %.lr.ph110.i186.i ]
  ...
  %niter961.next.3 = add i64 %niter961, 4         ; 2 uses
  %niter961.ncmp.3 = icmp eq i64 %niter961.next.3, %unroll_iter960
  br i1 %niter961.ncmp.3, label %_ZN5glTF28Accessor11ExtractDataIZL24BuildVertexWeightMappingRNS_4Mesh9PrimitiveERSt6vectorIS5_I14aiVertexWeightSaIS6_EESaIS8_EEPS5_IjSaIjEEE9Indices16EEmRPT_PKSD_.exit.i.loopexit.unr-lcssa, label %.lr.ph110.i186.i, !llvm.loop !138
...
_ZN5glTF28Accessor11ExtractDataIZL24BuildVertexWeightMappingRNS_4Mesh9PrimitiveERSt6vectorIS5_I14aiVertexWeightSaIS6_EESaIS8_EEPS5_IjSaIjEEE9Indices16EEmRPT_PKSD_.exit.i.loopexit.unr-lcssa: ; preds = %.lr.ph110.i186.i
  %lcmp.mod958.not = icmp eq i64 %xtraiter957, 0
  br i1 %lcmp.mod958.not, label %_ZN5glTF28Accessor11ExtractDataIZL24BuildVertexWeightMappingRNS_4Mesh9PrimitiveERSt6vectorIS5_I14aiVertexWeightSaIS6_EESaIS8_EEPS5_IjSaIjEEE9Indices16EEmRPT_PKSD_.exit.i, label %.lr.ph110.i186.i.epil.preheader
...
.lr.ph110.i186.i.epil.preheader:                  ; preds = %_ZN5glTF28Accessor11ExtractDataIZL24BuildVertexWeightMappingRNS_4Mesh9PrimitiveERSt6vectorIS5_I14aiVertexWeightSaIS6_EESaIS8_EEPS5_IjSaIjEEE9Indices16EEmRPT_PKSD_.exit.i.loopexit.unr-lcssa, %.lr.ph110.i186.i.preheader
  ...
  %lcmp.mod959 = icmp ne i64 %xtraiter957, 0
...
.lr.ph110.i186.i.epil:                            ; preds = %.lr.ph110.i186.i.epil, %.lr.ph110.i186.i.epil.preheader
  ...
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter957
...
.loopexit.i:                                      ; preds = %_ZN5glTF28Accessor11ExtractDataIZL24BuildVertexWeightMappingRNS_4Mesh9PrimitiveERSt6vectorIS5_I14aiVertexWeightSaIS6_EESaIS8_EEPS5_IjSaIjEEE9Indices16EEmRPT_PKSD_.exit.i, %_ZN5glTF28Accessor11ExtractDataIZL24BuildVertexWeightMappingRNS_4Mesh9PrimitiveERSt6vectorIS5_I14aiVertexWeightSaIS6_EESaIS8_EEPS5_IjSaIjEEE8Indices8EEmRPT_PKSD_.exit.i, %bb.el, %bb.cm
  ...
  %i.aju = icmp eq ptr %.082.i, null              ; 2 uses
  %i.ajv = load ptr, ptr %i.ja, align 8
  %i.ajw = load ptr, ptr %i.iy, align 8
...
.preheader226.lr.ph.i:                            ; preds = %.loopexit.i
  ...
  br i1 %.not299.i, label %.lr.ph293.i.preheader, label %.preheader226.i.preheader

.lr.ph293.i.preheader:                            ; preds = %.preheader.i, %.preheader226.lr.ph.i
...
.preheader226.i:                                  ; preds = %.preheader226.i.preheader, %._crit_edge290.us.i
  %i.ajy = phi ptr [ %i.ans, %._crit_edge290.us.i ], [ %i.il, %.preheader226.i.preheader ]
  %.079291.i = phi i64 [ %28, %._crit_edge290.us.i ], [ 0, %.preheader226.i.preheader ] ; 4 uses
  ...
  br label %.preheader225.us.i

bb.gk:                                            ; preds = %_ZNSt6vectorI14aiVertexWeightSaIS0_EE12emplace_backIJjRKfEEERS0_DpOT_.exit.i
  %i.akc = add nuw i64 %.078289.us.i, 1           ; 2 uses
  %exitcond367.not.i = icmp eq i64 %i.akc, %i.ol
  br i1 %exitcond367.not.i, label %._crit_edge290.us.i, label %.preheader225.us.i, !llvm.loop !141

bb.gl:                                            ; preds = %.preheader225.us.i, %_ZNSt6vectorI14aiVertexWeightSaIS0_EE12emplace_backIJjRKfEEERS0_DpOT_.exit.i
  %i.akd = phi ptr [ %26, %.preheader225.us.i ], [ %i.ans, %_ZNSt6vectorI14aiVertexWeightSaIS0_EE12emplace_backIJjRKfEEERS0_DpOT_.exit.i ] ; 5 uses
  %indvars.iv.i = phi i64 [ 0, %.preheader225.us.i ], [ %indvars.iv.next.i, %_ZNSt6vectorI14aiVertexWeightSaIS0_EE12emplace_backIJjRKfEEERS0_DpOT_.exit.i ] ; 4 uses
  br i1 %i.ajt, label %bb.gn, label %bb.gm

bb.gm:                                            ; preds = %bb.gl
  %i.ake = load ptr, ptr %i.aka, align 8
  %i.akf = getelementptr inbounds nuw [4 x i8], ptr %i.ake, i64 %.078289.us.i
...
bb.gn:                                            ; preds = %bb.gl
  ...
  %i.akk = getelementptr inbounds nuw [8 x i8], ptr %i.akj, i64 %.078289.us.i
...
bb.go:                                            ; preds = %bb.gn, %bb.gm
  ...
  %i.akq = getelementptr inbounds nuw [16 x i8], ptr %i.akp, i64 %.078289.us.i
  ...
  br i1 %i.akt, label %bb.gp, label %_ZNSt6vectorI14aiVertexWeightSaIS0_EE12emplace_backIJjRKfEEERS0_DpOT_.exit.i
...
bb.gp:                                            ; preds = %bb.go
  ...
  br i1 %i.akx, label %bb.gq, label %_ZNSt6vectorI14aiVertexWeightSaIS0_EE12emplace_backIJjRKfEEERS0_DpOT_.exit.i
...
bb.gq:                                            ; preds = %bb.gp
  ...
  br i1 %i.alf, label %_ZNSt12_Vector_baseI14aiVertexWeightSaIS0_EE11_M_allocateEm.exit.i.i, label %_ZNSt6vectorI14aiVertexWeightSaIS0_EE7reserveEm.exit.i

_ZNSt12_Vector_baseI14aiVertexWeightSaIS0_EE11_M_allocateEm.exit.i.i: ; preds = %bb.gq
...
.noexc171:                                        ; preds = %_ZNSt12_Vector_baseI14aiVertexWeightSaIS0_EE11_M_allocateEm.exit.i.i
  %.not10.i.i.i.i.i = icmp eq ptr %i.alb, %i.alh
  br i1 %.not10.i.i.i.i.i, label %_ZNSt6vectorI14aiVertexWeightSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit.i.i, label %.lr.ph.i.i.i.i.i.preheader

.lr.ph.i.i.i.i.i.preheader:                       ; preds = %.noexc171
  ...
  %min.iters.check818 = icmp ult i64 %i.aln, 24
  %i.alq = sub i64 %i.all, %i.ald
  %diff.check816 = icmp ult i64 %i.alq, 32
  %or.cond864 = or i1 %min.iters.check818, %diff.check816
  br i1 %or.cond864, label %.lr.ph.i.i.i.i.i.preheader867, label %vector.ph819

vector.ph819:                                     ; preds = %.lr.ph.i.i.i.i.i.preheader
  %n.vec821 = and i64 %i.alp, 4611686018427387900 ; 3 uses
  %i.alr = shl i64 %n.vec821, 3                   ; 2 uses
  %i.als = getelementptr i8, ptr %i.alk, i64 %i.alr
  %i.alt = getelementptr i8, ptr %i.alb, i64 %i.alr
  br label %vector.body822

vector.body822:                                   ; preds = %vector.body822, %vector.ph819
  %index823 = phi i64 [ 0, %vector.ph819 ], [ %index.next828, %vector.body822 ] ; 2 uses
  %i.alu = shl i64 %index823, 3                   ; 2 uses
  %next.gep824 = getelementptr i8, ptr %i.alk, i64 %i.alu ; 2 uses
  %next.gep825 = getelementptr i8, ptr %i.alb, i64 %i.alu ; 2 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !142)
  call void @llvm.experimental.noalias.scope.decl(metadata !145)
  %i.alv = getelementptr i8, ptr %next.gep825, i64 16
  %wide.load826 = load <2 x i64>, ptr %next.gep825, align 4, !alias.scope !145, !noalias !142
  %wide.load827 = load <2 x i64>, ptr %i.alv, align 4, !alias.scope !145, !noalias !142
  %i.alw = getelementptr i8, ptr %next.gep824, i64 16
  store <2 x i64> %wide.load826, ptr %next.gep824, align 4, !alias.scope !142, !noalias !145
  store <2 x i64> %wide.load827, ptr %i.alw, align 4, !alias.scope !142, !noalias !145
  %index.next828 = add nuw i64 %index823, 4       ; 2 uses
  %i.alx = icmp eq i64 %index.next828, %n.vec821
  br i1 %i.alx, label %middle.block829, label %vector.body822, !llvm.loop !147

middle.block829:                                  ; preds = %vector.body822
  %cmp.n830 = icmp eq i64 %i.alp, %n.vec821
  br i1 %cmp.n830, label %_ZNSt6vectorI14aiVertexWeightSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit.i.i, label %.lr.ph.i.i.i.i.i.preheader867

.lr.ph.i.i.i.i.i.preheader867:                    ; preds = %.lr.ph.i.i.i.i.i.preheader, %middle.block829
  %.012.i.i.i.i.i.ph = phi ptr [ %i.alk, %.lr.ph.i.i.i.i.i.preheader ], [ %i.als, %middle.block829 ]
  %.0911.i.i.i.i.i.ph = phi ptr [ %i.alb, %.lr.ph.i.i.i.i.i.preheader ], [ %i.alt, %middle.block829 ]
  br label %.lr.ph.i.i.i.i.i

.lr.ph.i.i.i.i.i:                                 ; preds = %.lr.ph.i.i.i.i.i.preheader867, %.lr.ph.i.i.i.i.i
  %.012.i.i.i.i.i = phi ptr [ %i.ama, %.lr.ph.i.i.i.i.i ], [ %.012.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.preheader867 ] ; 2 uses
  %.0911.i.i.i.i.i = phi ptr [ %i.alz, %.lr.ph.i.i.i.i.i ], [ %.0911.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.preheader867 ] ; 2 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !142)
  call void @llvm.experimental.noalias.scope.decl(metadata !145)
  %i.aly = load i64, ptr %.0911.i.i.i.i.i, align 4, !alias.scope !145, !noalias !142
  store i64 %i.aly, ptr %.012.i.i.i.i.i, align 4, !alias.scope !142, !noalias !145
  %i.alz = getelementptr inbounds nuw i8, ptr %.0911.i.i.i.i.i, i64 8 ; 2 uses
  %i.ama = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i.i, i64 8
  %.not.i.i.i.i.i = icmp eq ptr %i.alz, %i.alh
  br i1 %.not.i.i.i.i.i, label %_ZNSt6vectorI14aiVertexWeightSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit.i.i, label %.lr.ph.i.i.i.i.i, !llvm.loop !148

_ZNSt6vectorI14aiVertexWeightSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit.i.i: ; preds = %.lr.ph.i.i.i.i.i, %middle.block829, %.noexc171
  %.not.i8.i.i = icmp eq ptr %i.alb, null
  br i1 %.not.i8.i.i, label %_ZNSt12_Vector_baseI14aiVertexWeightSaIS0_EE13_M_deallocateEPS0_m.exit.i.i, label %bb.gr

bb.gr:                                            ; preds = %_ZNSt6vectorI14aiVertexWeightSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit.i.i
  call void @_ZdlPvm(ptr noundef nonnull %i.alb, i64 noundef %i.ale) #35
  br label %_ZNSt12_Vector_baseI14aiVertexWeightSaIS0_EE13_M_deallocateEPS0_m.exit.i.i

_ZNSt12_Vector_baseI14aiVertexWeightSaIS0_EE13_M_deallocateEPS0_m.exit.i.i: ; preds = %bb.gr, %_ZNSt6vectorI14aiVertexWeightSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit.i.i
  ...
  %.pre378.i = load ptr, ptr %21, align 8         ; 2 uses
  %.phi.trans.insert379.i.a = getelementptr inbounds nuw [24 x i8], ptr %.pre378.i, i64 %i.ako
  %.phi.trans.insert380.i = getelementptr inbounds nuw i8, ptr %.phi.trans.insert379.i.a, i64 16
  %.pre381.i = load ptr, ptr %.phi.trans.insert380.i, align 8
  br label %_ZNSt6vectorI14aiVertexWeightSaIS0_EE7reserveEm.exit.i

_ZNSt6vectorI14aiVertexWeightSaIS0_EE7reserveEm.exit.i: ; preds = %_ZNSt12_Vector_baseI14aiVertexWeightSaIS0_EE13_M_deallocateEPS0_m.exit.i.i, %bb.gq
  %i.amd = phi ptr [ %.pre378.i, %_ZNSt12_Vector_baseI14aiVertexWeightSaIS0_EE13_M_deallocateEPS0_m.exit.i.i ], [ %i.akd, %bb.gq ] ; 3 uses
  %i.ame = phi ptr [ %.pre381.i, %_ZNSt12_Vector_baseI14aiVertexWeightSaIS0_EE13_M_deallocateEPS0_m.exit.i.i ], [ %i.ala, %bb.gq ] ; 4 uses
  ...
  %.not.i221.i = icmp eq ptr %i.amh, %i.ame
  br i1 %.not.i221.i, label %bb.gt, label %bb.gs

bb.gs:                                            ; preds = %_ZNSt6vectorI14aiVertexWeightSaIS0_EE7reserveEm.exit.i
  store i32 %27, ptr %i.amh, align 4
  ...
  br label %_ZNSt6vectorI14aiVertexWeightSaIS0_EE12emplace_backIJjRKfEEERS0_DpOT_.exit.i

bb.gt:                                            ; preds = %_ZNSt6vectorI14aiVertexWeightSaIS0_EE7reserveEm.exit.i
  ...
  br i1 %i.amq, label %.split.us.i, label %_ZNKSt6vectorI14aiVertexWeightSaIS0_EE12_M_check_lenEmPKc.exit.i.i.i

_ZNKSt6vectorI14aiVertexWeightSaIS0_EE12_M_check_lenEmPKc.exit.i.i.i: ; preds = %bb.gt
  %i.amr = ashr exact i64 %i.amp, 3               ; 3 uses
  %.sroa.speculated.i.i.i.i = call i64 @llvm.umax.i64(i64 %i.amr, i64 1)
  %i.ams = add nsw i64 %.sroa.speculated.i.i.i.i, %i.amr ; 2 uses
  ...
  %.not.i.i.i222.i = icmp ne i64 %i.amv, 0
  ...
  %i.amx = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.amw) #37
          to label %.noexc173.a unwind label %.loopexit236 ; 8 uses

.noexc173.a:                                      ; preds = %_ZNKSt6vectorI14aiVertexWeightSaIS0_EE12_M_check_lenEmPKc.exit.i.i.i
  %i.amy = getelementptr inbounds nuw i8, ptr %i.amx, i64 %i.amp ; 2 uses
  store i32 %27, ptr %i.amy, align 4
  %i.amz = getelementptr inbounds nuw i8, ptr %i.amy, i64 4
  store float %i.aks, ptr %i.amz, align 4
  %.not10.i.i.i.i.i.i = icmp eq ptr %i.amm, %i.ame
  br i1 %.not10.i.i.i.i.i.i, label %_ZNSt6vectorI14aiVertexWeightSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit33.i.i.i, label %.lr.ph.i.i.i.i.i.i.preheader

.lr.ph.i.i.i.i.i.i.preheader:                     ; preds = %.noexc173.a
  %i.ana = ptrtoaddr ptr %i.amx to i64
  %i.anb = sub i64 %i.amn, %i.amo
  %i.anc = add i64 %i.anb, -8                     ; 2 uses
  ...
  %or.cond865 = or i1 %min.iters.check, %diff.check
  br i1 %or.cond865, label %.lr.ph.i.i.i.i.i.i.preheader866, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep812 = getelementptr i8, ptr %i.amm, i64 %i.anj ; 2 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !149)
  call void @llvm.experimental.noalias.scope.decl(metadata !152)
  %i.ank = getelementptr i8, ptr %next.gep812, i64 16
  %wide.load = load <2 x i64>, ptr %next.gep812, align 4, !alias.scope !152, !noalias !149
  %wide.load813 = load <2 x i64>, ptr %i.ank, align 4, !alias.scope !152, !noalias !149
  %i.anl = getelementptr i8, ptr %next.gep, i64 16
  store <2 x i64> %wide.load, ptr %next.gep, align 4, !alias.scope !149, !noalias !152
  store <2 x i64> %wide.load813, ptr %i.anl, align 4, !alias.scope !149, !noalias !152
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.anm = icmp eq i64 %index.next, %n.vec
  br i1 %i.anm, label %middle.block, label %vector.body, !llvm.loop !154

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %i.ane, %n.vec
  br i1 %cmp.n, label %_ZNSt6vectorI14aiVertexWeightSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit33.i.i.i, label %.lr.ph.i.i.i.i.i.i.preheader866

.lr.ph.i.i.i.i.i.i.preheader866:                  ; preds = %.lr.ph.i.i.i.i.i.i.preheader, %middle.block
  %.012.i.i.i.i.i.i.ph = phi ptr [ %i.amx, %.lr.ph.i.i.i.i.i.i.preheader ], [ %i.anh, %middle.block ]
  %.0911.i.i.i.i.i.i.ph = phi ptr [ %i.amm, %.lr.ph.i.i.i.i.i.i.preheader ], [ %i.ani, %middle.block ]
  br label %.lr.ph.i.i.i.i.i.i

.lr.ph.i.i.i.i.i.i:                               ; preds = %.lr.ph.i.i.i.i.i.i.preheader866, %.lr.ph.i.i.i.i.i.i
  %.012.i.i.i.i.i.i = phi ptr [ %i.anp, %.lr.ph.i.i.i.i.i.i ], [ %.012.i.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.i.preheader866 ] ; 2 uses
  %.0911.i.i.i.i.i.i = phi ptr [ %i.ano, %.lr.ph.i.i.i.i.i.i ], [ %.0911.i.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.i.preheader866 ] ; 2 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !149)
  call void @llvm.experimental.noalias.scope.decl(metadata !152)
  %i.ann = load i64, ptr %.0911.i.i.i.i.i.i, align 4, !alias.scope !152, !noalias !149
  store i64 %i.ann, ptr %.012.i.i.i.i.i.i, align 4, !alias.scope !149, !noalias !152
  %i.ano = getelementptr inbounds nuw i8, ptr %.0911.i.i.i.i.i.i, i64 8 ; 2 uses
  %i.anp = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i.i.i, i64 8 ; 2 uses
  %.not.i.i.i.i.i.i = icmp eq ptr %i.ano, %i.ame
  br i1 %.not.i.i.i.i.i.i, label %_ZNSt6vectorI14aiVertexWeightSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit33.i.i.i, label %.lr.ph.i.i.i.i.i.i, !llvm.loop !155

_ZNSt6vectorI14aiVertexWeightSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit33.i.i.i: ; preds = %.lr.ph.i.i.i.i.i.i, %middle.block, %.noexc173.a
  %.0.lcssa.i.i.i.i.i.i = phi ptr [ %i.amx, %.noexc173.a ], [ %i.anh, %middle.block ], [ %i.anp, %.lr.ph.i.i.i.i.i.i ]
  %i.anq = getelementptr inbounds nuw i8, ptr %.0.lcssa.i.i.i.i.i.i, i64 8
  %.not.i34.i.i.i = icmp eq ptr %i.amm, null
  br i1 %.not.i34.i.i.i, label %_ZNSt6vectorI14aiVertexWeightSaIS0_EE17_M_realloc_insertIJjRKfEEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i.i, label %bb.gu

bb.gu:                                            ; preds = %_ZNSt6vectorI14aiVertexWeightSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit33.i.i.i
  call void @_ZdlPvm(ptr noundef nonnull %i.amm, i64 noundef %i.amp) #35
  br label %_ZNSt6vectorI14aiVertexWeightSaIS0_EE17_M_realloc_insertIJjRKfEEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i.i

_ZNSt6vectorI14aiVertexWeightSaIS0_EE17_M_realloc_insertIJjRKfEEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i.i: ; preds = %bb.gu, %_ZNSt6vectorI14aiVertexWeightSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit33.i.i.i
...
_ZNSt6vectorI14aiVertexWeightSaIS0_EE12emplace_backIJjRKfEEERS0_DpOT_.exit.i: ; preds = %_ZNSt6vectorI14aiVertexWeightSaIS0_EE17_M_realloc_insertIJjRKfEEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i.i, %bb.gs, %bb.gp, %bb.go
  %i.ans = phi ptr [ %i.amd, %_ZNSt6vectorI14aiVertexWeightSaIS0_EE17_M_realloc_insertIJjRKfEEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i.i ], [ %i.amd, %bb.gs ], [ %i.akd, %bb.gp ], [ %i.akd, %bb.go ] ; 3 uses
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, 4
  br i1 %exitcond.not.i, label %bb.gk, label %bb.gl, !llvm.loop !156

.preheader225.us.i:                               ; preds = %bb.gk, %.preheader226.i
  %26 = phi ptr [ %i.ajy, %.preheader226.i ], [ %i.ans, %bb.gk ]
  %.078289.us.i = phi i64 [ 0, %.preheader226.i ], [ %i.akc, %bb.gk ] ; 5 uses
  %27 = trunc i64 %.078289.us.i to i32            ; 2 uses
  br label %bb.gl

._crit_edge290.us.i:                              ; preds = %bb.gk
  %28 = add nuw i64 %.079291.i, 1                 ; 2 uses
  %29 = load ptr, ptr %i.ja, align 8              ; 2 uses
  %30 = load ptr, ptr %i.iy, align 8              ; 2 uses
  %31 = ptrtoint ptr %29 to i64
  %32 = ptrtoint ptr %30 to i64
  %33 = sub i64 %31, %32
  %34 = ashr exact i64 %33, 4
  %35 = icmp ult i64 %28, %34
  br i1 %35, label %.preheader226.i, label %.preheader.i, !llvm.loop !157

.preheader.i:                                     ; preds = %._crit_edge290.us.i
  %36 = icmp eq ptr %29, %30
  br i1 %36, label %._crit_edge294.i, label %.lr.ph293.i.preheader

.split.us.i:                                      ; preds = %bb.gt
...
.noexc173:                                        ; preds = %.split.us.i
  unreachable

.lr.ph293.split.i:                                ; preds = %.lr.ph293.i.preheader, %bb.hb
  %.0292.i = phi i64 [ %i.aoc, %bb.hb ], [ 0, %.lr.ph293.i.preheader ] ; 4 uses
  ...
  br i1 %i.anv, label %37, label %bb.gv

bb.gv:                                            ; preds = %.lr.ph293.split.i
  call void @_ZdaPv(ptr noundef nonnull %i.anu) #35
  br label %37

37:                                               ; preds = %bb.gv, %.lr.ph293.split.i
  br i1 %i.ajt, label %bb.gy, label %bb.gw
...
bb.hb:                                            ; preds = %bb.ha, %bb.gz, %bb.gy
  ...
  br i1 %i.aoj, label %.lr.ph293.split.i, label %._crit_edge294.i, !llvm.loop !158

._crit_edge294.i:                                 ; preds = %bb.hb, %.preheader.i, %.loopexit.i
  call void @_ZdaPv(ptr noundef nonnull %i.kf) #35
  br i1 %i.ajt, label %bb.hd, label %bb.hc

bb.hc:                                            ; preds = %._crit_edge294.i
...
.preheader240:                                    ; preds = %_ZSt4fillIPP6aiBoneDnEvT_S3_RKT0_.exit
  %.not361 = icmp eq i32 %i.ia, 0
  br i1 %.not361, label %._crit_edge, label %.lr.ph354.preheader

.lr.ph354.preheader:                              ; preds = %.preheader240
...
.loopexit236:                                     ; preds = %_ZNSt12_Vector_baseI14aiVertexWeightSaIS0_EE11_M_allocateEm.exit.i.i, %_ZNKSt6vectorI14aiVertexWeightSaIS0_EE12_M_check_lenEmPKc.exit.i.i.i
  %lpad.loopexit = landingpad { ptr, i32 }
          catch ptr null
  br label %.body

.loopexit.split-lp.loopexit:                      ; preds = %_ZN5glTF28Accessor14GetMaxByteSizeEv.exit.i101.i, %switch.lookup846
  %lpad.loopexit247 = landingpad { ptr, i32 }
          catch ptr null
  br label %.body

.loopexit.split-lp.loopexit.split-lp.loopexit:    ; preds = %switch.lookup856, %_ZN5glTF28Accessor14GetMaxByteSizeEv.exit.i165.i
  %lpad.loopexit250 = landingpad { ptr, i32 }
          catch ptr null
  br label %.body

.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit: ; preds = %_ZN5glTF28Accessor14GetMaxByteSizeEv.exit.i.i, %switch.lookup836
...
.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp: ; preds = %.split.us.i
...
.lr.ph354:                                        ; preds = %.lr.ph354.preheader, %bb.ic
  %indvars.iv450 = phi i64 [ 0, %.lr.ph354.preheader ], [ %indvars.iv.next451, %bb.ic ] ; 6 uses
  %i.api = load ptr, ptr %21, align 8
  %i.apj = getelementptr inbounds nuw [24 x i8], ptr %i.api, i64 %indvars.iv450 ; 3 uses
...
bb.hi:                                            ; preds = %.lr.ph354
  ...
  %i.aqa = getelementptr inbounds nuw [16 x i8], ptr %i.apz, i64 %indvars.iv450 ; 2 uses
...
bb.hr:                                            ; preds = %bb.hq, %bb.ho, %bb.hn
  ...
  %i.aqu = trunc nuw i64 %indvars.iv450 to i32    ; 3 uses
...
!141 = distinct !{!141, !4}
!142 = !{!143}
!143 = distinct !{!143, !144, !"_ZSt19__relocate_object_aI14aiVertexWeightS0_SaIS0_EEvPT_PT0_RT1_: argument 0"}
!144 = distinct !{!144, !"_ZSt19__relocate_object_aI14aiVertexWeightS0_SaIS0_EEvPT_PT0_RT1_"}
!145 = !{!146}
!146 = distinct !{!146, !144, !"_ZSt19__relocate_object_aI14aiVertexWeightS0_SaIS0_EEvPT_PT0_RT1_: argument 1"}
!147 = distinct !{!147, !4, !29, !30}
!148 = distinct !{!148, !4, !29}
!149 = !{!150}
!150 = distinct !{!150, !151, !"_ZSt19__relocate_object_aI14aiVertexWeightS0_SaIS0_EEvPT_PT0_RT1_: argument 0"}
!151 = distinct !{!151, !"_ZSt19__relocate_object_aI14aiVertexWeightS0_SaIS0_EEvPT_PT0_RT1_"}
!152 = !{!153}
!153 = distinct !{!153, !151, !"_ZSt19__relocate_object_aI14aiVertexWeightS0_SaIS0_EEvPT_PT0_RT1_: argument 1"}
!154 = distinct !{!154, !4, !29, !30}
!155 = distinct !{!155, !4, !29}
!156 = distinct !{!156, !4}
!157 = distinct !{!157, !4}
!158 = distinct !{!158, !4}
