...
begin_hunk_0_@_ZL16GetNodeTransformR12aiMatrix4x4tIfERKN5glTF24NodeE:bb.a
  ...
  %i.dj = insertelement <4 x float> %i.di, float %i.bg, i64 2
  %2 = shufflevector <4 x float> %i.dj, <4 x float> %i.cy, <4 x i32> <i32 0, i32 0, i32 2, i32 5>
...
begin_hunk_1_@_ZL16GetNodeTransformR12aiMatrix4x4tIfERKN5glTF24NodeE:bb.a
  ...
  %i.ei = insertelement <4 x float> %i.eh, float %i.bg, i64 2
  %3 = shufflevector <4 x float> %i.ei, <4 x float> %i.dx, <4 x i32> <i32 0, i32 0, i32 2, i32 5>
...
bb.f:                                             ; preds = %bb.e
  ...
  %.sroa.087.0.copyload88 = load float, ptr %0, align 4 ; 2 uses
...
begin_hunk_3_@_ZL16GetNodeTransformR12aiMatrix4x4tIfERKN5glTF24NodeE:bb.a
  ...
  %i.go = insertelement <2 x float> poison, float %.sroa.087.0.copyload88, i64 0 ; 2 uses
  ...
  %4 = shufflevector <2 x float> %i.ge, <2 x float> %i.go, <4 x i32> <i32 0, i32 0, i32 2, i32 poison>
  %5 = shufflevector <2 x float> %i.gf, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 poison> ; 2 uses
  %6 = shufflevector <4 x float> %4, <4 x float> %5, <4 x i32> <i32 0, i32 1, i32 2, i32 4>
...
begin_hunk_4_@_ZL16GetNodeTransformR12aiMatrix4x4tIfERKN5glTF24NodeE:bb.a
  ...
  %7 = shufflevector <2 x float> %i.gf, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 poison, i32 poison>
  ...
  %i.ht = insertelement <4 x float> %5, float %.sroa.18107.0.copyload109, i64 0
...
begin_hunk_5_@_ZL16GetNodeTransformR12aiMatrix4x4tIfERKN5glTF24NodeE:bb.a
  ...
  %8 = shufflevector <2 x float> %i.mh, <2 x float> poison, <4 x i32> <i32 1, i32 1, i32 0, i32 poison>
  %9 = insertelement <4 x float> %8, float %.sroa.34.0.copyload51, i64 3
  ...
  %i.mr = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %9, <4 x float> zeroinitializer, <4 x float> %i.mq)
