...
._crit_edge308.loopexit:                          ; preds = %bb.aj
  %i.jb = extractelement <2 x float> %i.qh, i64 1
  %i.jc = extractelement <2 x float> %i.qh, i64 0
  %i.jd = extractelement <2 x float> %i.qi, i64 0
  %i.je = extractelement <2 x float> %i.qi, i64 1
  br label %._crit_edge308

._crit_edge308:                                   ; preds = %._crit_edge308.loopexit, %.preheader
  %.sroa.0173.0.lcssa.a = phi float [ 1.000000e+00, %.preheader ], [ %.sroa.0173.1, %._crit_edge308.loopexit ] ; 6 uses
  %.sroa.44.0.lcssa.a = phi float [ 1.000000e+00, %.preheader ], [ %i.jd, %._crit_edge308.loopexit ] ; 6 uses
  ...
  %i.jg = phi <2 x float> [ zeroinitializer, %.preheader ], [ %i.qg, %._crit_edge308.loopexit ] ; 7 uses
  %i.jh = trunc nuw i64 %indvars.iv332 to i32
  %i.ji = uitofp i32 %i.jh to double
  store double %i.ji, ptr %.0107318, align 8
  %i.jj = fadd float %.sroa.0173.0.lcssa.a, %.sroa.44.0.lcssa.a
...
bb.aa:                                            ; preds = %._crit_edge308
  %i.ka = fcmp ogt float %.sroa.0173.0.lcssa.a, %.sroa.44.0.lcssa.a
  %i.kb = fcmp ogt float %.sroa.0173.0.lcssa.a, %.sroa.85.0.lcssa
  %or.cond.i = and i1 %i.ka, %i.kb
  br i1 %or.cond.i, label %bb.ab, label %bb.ac

bb.ab:                                            ; preds = %bb.aa
  %i.kc = fadd float %.sroa.0173.0.lcssa.a, 1.000000e+00
  %i.kd = fsub float %i.kc, %.sroa.44.0.lcssa.a
...
bb.ac:                                            ; preds = %bb.aa
  %i.kr = fcmp ogt float %.sroa.44.0.lcssa.a, %.sroa.85.0.lcssa
  br i1 %i.kr, label %bb.ad, label %bb.ae

bb.ad:                                            ; preds = %bb.ac
  %i.ks = fadd float %.sroa.44.0.lcssa.a, 1.000000e+00
  %i.kt = fsub float %i.ks, %.sroa.0173.0.lcssa.a
...
bb.ae:                                            ; preds = %bb.ac
  ...
  %i.lj = fsub float %i.li, %.sroa.0173.0.lcssa.a
  %i.lk = fsub float %i.lj, %.sroa.44.0.lcssa.a
...
begin_hunk_4_@_ZN6Assimp9BVHLoader15CreateAnimationEP7aiScene:_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  ...
  %i.lz = phi <2 x float> [ <float 0.000000e+00, float 1.000000e+00>, %.lr.ph307 ], [ %i.qh, %bb.aj ] ; 10 uses
  %i.ma = phi <2 x float> [ zeroinitializer, %.lr.ph307 ], [ %i.qg, %bb.aj ] ; 10 uses
  %i.mb = phi <2 x float> [ <float 1.000000e+00, float 0.000000e+00>, %.lr.ph307 ], [ %i.qi, %bb.aj ] ; 9 uses
  %i.mc = phi <2 x float> [ zeroinitializer, %.lr.ph307 ], [ %i.qf, %bb.aj ] ; 7 uses
...
bb.aj:                                            ; preds = %bb.ag, %bb.ah, %bb.ai, %bb.af
  ...
  %i.qf = phi <2 x float> [ %i.mc, %bb.af ], [ %i.nj, %bb.ag ], [ %i.on, %bb.ah ], [ %i.qe, %bb.ai ] ; 2 uses
  %i.qg = phi <2 x float> [ %i.ma, %bb.af ], [ %i.no, %bb.ag ], [ %i.ou, %bb.ah ], [ %i.qb, %bb.ai ] ; 2 uses
  %i.qh = phi <2 x float> [ %i.lz, %bb.af ], [ %i.nq, %bb.ag ], [ %i.ov, %bb.ah ], [ %i.qc, %bb.ai ] ; 3 uses
  %i.qi = phi <2 x float> [ %i.mb, %bb.af ], [ %i.na, %bb.ag ], [ %i.oc, %bb.ah ], [ %i.pv, %bb.ai ] ; 3 uses
...
bb.m:                                             ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit57, %_ZNSt6vectorIN6Assimp9BVHLoader4NodeESaIS2_EE12emplace_backIJRP6aiNodeEEERS2_DpOT_.exit
  %.sroa.24.0.a = phi ptr [ null, %_ZNSt6vectorIN6Assimp9BVHLoader4NodeESaIS2_EE12emplace_backIJRP6aiNodeEEERS2_DpOT_.exit ], [ %.sroa.24.1.a, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit57 ] ; 10 uses
  %.sroa.13.0 = phi ptr [ null, %_ZNSt6vectorIN6Assimp9BVHLoader4NodeESaIS2_EE12emplace_backIJRP6aiNodeEEERS2_DpOT_.exit ], [ %.sroa.13.1, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit57 ] ; 9 uses
  %.sroa.0.0 = phi ptr [ null, %_ZNSt6vectorIN6Assimp9BVHLoader4NodeESaIS2_EE12emplace_backIJRP6aiNodeEEERS2_DpOT_.exit ], [ %.sroa.0.1, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit57 ] ; 14 uses
...
begin_hunk_7_@_ZN6Assimp9BVHLoader8ReadNodeEv:bb.a
  ...
  %.not.i34 = icmp eq ptr %.sroa.13.0, %.sroa.24.0.a
...
bb.t:                                             ; preds = %bb.r
  %i.be = ptrtoint ptr %.sroa.24.0.a to i64
  %i.bf = ptrtoint ptr %.sroa.0.0 to i64
...
bb.v:                                             ; preds = %.noexc36
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.bo, ptr align 8 %.sroa.0.0, i64 %i.bg, i1 false)
...
bb.w:                                             ; preds = %_ZNSt6vectorIP6aiNodeSaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0.0, i64 noundef %i.bg) #26
...
begin_hunk_11_@_ZN6Assimp9BVHLoader8ReadNodeEv:bb.a
  ...
  %.not.i43 = icmp eq ptr %.sroa.13.0, %.sroa.24.0.a
...
bb.ah:                                            ; preds = %bb.af
  %i.cy = ptrtoint ptr %.sroa.24.0.a to i64
  %i.cz = ptrtoint ptr %.sroa.0.0 to i64
...
bb.aj:                                            ; preds = %.noexc51
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.di, ptr align 8 %.sroa.0.0, i64 %i.da, i1 false)
...
_ZNSt6vectorIP6aiNodeSaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i47: ; preds = %bb.aj, %.noexc51
  ...
  %.not.i17.i.i48 = icmp eq ptr %.sroa.0.0, null
...
bb.ak:                                            ; preds = %_ZNSt6vectorIP6aiNodeSaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i47
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0.0, i64 noundef %i.da) #26
...
bb.an:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit57
  ...
  %i.dy = ptrtoint ptr %.sroa.0.1 to i64          ; 2 uses
  %i.dz = sub i64 %i.dx, %i.dy                    ; 5 uses
  %.not = icmp eq ptr %.sroa.13.1, %.sroa.0.1
...
bb.aq:                                            ; preds = %bb.ap
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.ee, ptr align 8 %.sroa.0.1, i64 %i.dz, i1 false)
...
bb.as:                                            ; preds = %bb.ar
  %i.ei = load ptr, ptr %.sroa.0.1, align 8
...
bb.au:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit63
  %i.eo = ptrtoint ptr %.sroa.24.1.a to i64
  %i.ep = sub i64 %i.eo, %i.dy
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0.1, i64 noundef %i.ep) #26
...
bb.av:                                            ; preds = %bb.at, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit60
  %.sroa.24.2.a = phi ptr [ %.sroa.24.1.a, %bb.at ], [ %.sroa.24.0.a, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit60 ]
  %.sroa.0.2 = phi ptr [ %.sroa.0.1, %bb.at ], [ %.sroa.0.0, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit60 ] ; 3 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i72: ; preds = %bb.av, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i71
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #25
  %.not.i.i.i74 = icmp eq ptr %.sroa.0.2, null
...
bb.aw:                                            ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i72
  %i.fe = ptrtoint ptr %.sroa.24.2.a to i64
  %i.ff = ptrtoint ptr %.sroa.0.2 to i64
  %i.fg = sub i64 %i.fe, %i.ff
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0.2, i64 noundef %i.fg) #26
