...
bb.af:                                            ; preds = %.lr.ph307, %bb.aj
  ...
  %.sroa.0173.0297.a = phi float [ 1.000000e+00, %.lr.ph307 ], [ %.sroa.0173.1, %bb.aj ] ; 8 uses
  %4 = phi <2 x float> [ <float 0.000000e+00, float 1.000000e+00>, %.lr.ph307 ], [ %i.qb, %bb.aj ] ; 10 uses
  %i.lz = phi <2 x float> [ zeroinitializer, %.lr.ph307 ], [ %i.qa, %bb.aj ] ; 10 uses
  %i.ma = phi <2 x float> [ <float 1.000000e+00, float 0.000000e+00>, %.lr.ph307 ], [ %i.qc, %bb.aj ] ; 9 uses
  %i.mb = phi <2 x float> [ zeroinitializer, %.lr.ph307 ], [ %i.pz, %bb.aj ] ; 7 uses
  %5 = extractelement <2 x float> %i.mb, i64 1    ; 5 uses
  %i.mc = extractelement <2 x float> %i.mb, i64 0 ; 5 uses
...
bb.ag:                                            ; preds = %bb.af
  ...
  %i.mo = fmul float %i.mc, 0.000000e+00
  %i.mp = fadd float %.sroa.0173.0297.a, %i.mo
  %i.mq = call float @llvm.fmuladd.f32(float %5, float 0.000000e+00, float %i.mp)
  %i.mr = fmul <2 x float> %i.ma, zeroinitializer
  ...
  %i.mu = fmul <2 x float> %i.ma, %i.mt
  %i.mv = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.lz, <2 x float> zeroinitializer, <2 x float> %i.mu)
  ...
  %i.my = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.mx, <2 x float> %4, <2 x float> %i.mv)
  %i.mz = shufflevector <2 x float> %i.mb, <2 x float> poison, <2 x i32> zeroinitializer
  %i.na = insertelement <2 x float> %i.ms, float %i.mn, i64 1 ; 2 uses
  %i.nb = fmul <2 x float> %i.mz, %i.na
  %i.nc = insertelement <2 x float> poison, float %.sroa.0173.0297.a, i64 0
  ...
  %i.ng = shufflevector <2 x float> %i.mb, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.nh = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.nf, <2 x float> %i.ng, <2 x float> %i.ne)
  %i.ni = fadd <2 x float> %i.lz, %i.mr
  %i.nj = shufflevector <2 x float> %i.na, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.nk = fmul <2 x float> %i.ma, %i.nj
  %i.nl = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.lz, <2 x float> zeroinitializer, <2 x float> %i.nk)
  %i.nm = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %4, <2 x float> zeroinitializer, <2 x float> %i.ni)
  %i.nn = shufflevector <2 x float> %i.nf, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.no = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.nn, <2 x float> %4, <2 x float> %i.nl)
  br label %bb.aj
...
bb.ah:                                            ; preds = %bb.af
  ...
  %i.ny = fmul <2 x float> %i.ma, zeroinitializer ; 2 uses
  %i.nz = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.lz, <2 x float> zeroinitializer, <2 x float> %i.ma)
  %i.oa = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %4, <2 x float> zeroinitializer, <2 x float> %i.nz)
  %i.ob = fmul float %i.mc, 0.000000e+00          ; 2 uses
  %i.oc = call float @llvm.fmuladd.f32(float %i.nv, float %.sroa.0173.0297.a, float %i.ob)
  %i.od = call float @llvm.fmuladd.f32(float %i.nx, float %5, float %i.oc)
  %i.oe = insertelement <2 x float> <float 0.000000e+00, float poison>, float %i.nw, i64 1 ; 2 uses
  %i.of = insertelement <2 x float> poison, float %.sroa.0173.0297.a, i64 0
  %i.og = shufflevector <2 x float> %i.of, <2 x float> poison, <2 x i32> zeroinitializer
  %i.oh = insertelement <2 x float> %i.mb, float %i.ob, i64 1
  ...
  %i.ok = shufflevector <2 x float> %i.mb, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  ...
  %i.on = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.om, <2 x float> %i.lz, <2 x float> %i.ny)
  %i.oo = shufflevector <2 x float> %i.oe, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.op = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.oo, <2 x float> %i.lz, <2 x float> %i.ny)
  ...
  %i.os = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.or, <2 x float> %4, <2 x float> %i.on)
  %i.ot = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.om, <2 x float> %4, <2 x float> %i.op)
  br label %bb.aj
...
bb.ai:                                            ; preds = %bb.af
  ...
  %i.pd = fmul float %i.mc, %i.pb
  %i.pe = call float @llvm.fmuladd.f32(float %i.pa, float %.sroa.0173.0297.a, float %i.pd)
  %i.pf = call float @llvm.fmuladd.f32(float %5, float 0.000000e+00, float %i.pe)
  %i.pg = fmul float %i.mc, %i.pa
  %i.ph = call float @llvm.fmuladd.f32(float %i.pc, float %.sroa.0173.0297.a, float %i.pg)
  %6 = call float @llvm.fmuladd.f32(float %5, float 0.000000e+00, float %i.ph)
  %7 = fmul float %i.mc, 0.000000e+00
  %8 = call float @llvm.fmuladd.f32(float %.sroa.0173.0297.a, float 0.000000e+00, float %7)
  %i.pi = fadd float %5, %8
  %i.pj = fmul <2 x float> %i.ma, zeroinitializer
  ...
  %i.pp = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.po, <2 x float> %i.lz, <2 x float> %i.pm)
  %i.pq = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %4, <2 x float> zeroinitializer, <2 x float> %i.pp)
  ...
  %i.pt = fmul <2 x float> %i.ma, %i.ps
  %i.pu = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.pl, <2 x float> %i.lz, <2 x float> %i.pt)
  %i.pv = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.lz, <2 x float> zeroinitializer, <2 x float> %i.pj)
  %i.pw = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %4, <2 x float> zeroinitializer, <2 x float> %i.pu)
  %i.px = fadd <2 x float> %4, %i.pv
  %9 = insertelement <2 x float> poison, float %6, i64 0
  %i.py = insertelement <2 x float> %9, float %i.pi, i64 1
  br label %bb.aj

bb.aj:                                            ; preds = %bb.ag, %bb.ah, %bb.ai, %bb.af
  %.sroa.0173.1 = phi float [ %.sroa.0173.0297.a, %bb.af ], [ %i.mq, %bb.ag ], [ %i.od, %bb.ah ], [ %i.pf, %bb.ai ] ; 2 uses
  %i.pz = phi <2 x float> [ %i.mb, %bb.af ], [ %i.nh, %bb.ag ], [ %i.ol, %bb.ah ], [ %i.py, %bb.ai ] ; 2 uses
  %i.qa = phi <2 x float> [ %i.lz, %bb.af ], [ %i.nm, %bb.ag ], [ %i.os, %bb.ah ], [ %i.pw, %bb.ai ] ; 2 uses
  %i.qb = phi <2 x float> [ %4, %bb.af ], [ %i.no, %bb.ag ], [ %i.ot, %bb.ah ], [ %i.px, %bb.ai ] ; 3 uses
  %i.qc = phi <2 x float> [ %i.ma, %bb.af ], [ %i.my, %bb.ag ], [ %i.oa, %bb.ah ], [ %i.pq, %bb.ai ] ; 3 uses
