...
bb.af:                                            ; preds = %.lr.ph307, %bb.aj
  ...
  %.sroa.11177.0298 = phi float [ 1.000000e+00, %.lr.ph307 ], [ %.sroa.0173.1, %bb.aj ] ; 8 uses
...
bb.ag:                                            ; preds = %bb.af
  ...
  %i.mp = fadd float %.sroa.11177.0298, %i.mo
  ...
  %i.nc = insertelement <2 x float> poison, float %.sroa.11177.0298, i64 0
...
bb.ah:                                            ; preds = %bb.af
  ...
  %i.oc = call float @llvm.fmuladd.f32(float %i.nv, float %.sroa.11177.0298, float %i.ob)
  ...
  %i.of = insertelement <2 x float> poison, float %.sroa.11177.0298, i64 0
...
bb.ai:                                            ; preds = %bb.af
  ...
  %i.pe = call float @llvm.fmuladd.f32(float %i.pa, float %.sroa.11177.0298, float %i.pd)
  %i.pf = call float @llvm.fmuladd.f32(float %5, float 0.000000e+00, float %i.pe)
  %i.pg = fmul float %i.mc, %i.pa
  %i.ph = call float @llvm.fmuladd.f32(float %i.pc, float %.sroa.11177.0298, float %i.pg)
  %6 = call float @llvm.fmuladd.f32(float %5, float 0.000000e+00, float %i.ph)
  %7 = fmul float %i.mc, 0.000000e+00
  %8 = call float @llvm.fmuladd.f32(float %.sroa.11177.0298, float 0.000000e+00, float %7)
  %i.pi = fadd float %5, %8
...
bb.aj:                                            ; preds = %bb.ag, %bb.ah, %bb.ai, %bb.af
  %.sroa.0173.1 = phi float [ %.sroa.11177.0298, %bb.af ], [ %i.mq, %bb.ag ], [ %i.od, %bb.ah ], [ %i.pf, %bb.ai ] ; 2 uses
