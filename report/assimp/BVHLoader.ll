...
bb.ag:                                            ; preds = %.lr.ph309, %bb.ak
  ...
  %.sroa.0173.0307 = phi float [ 1.000000e+00, %.lr.ph309 ], [ %.sroa.0173.1, %bb.ak ] ; 8 uses
  ...
  %i.mn = phi <2 x float> [ zeroinitializer, %.lr.ph309 ], [ %i.qh, %bb.ak ] ; 7 uses
  %4 = extractelement <2 x float> %i.mn, i64 1    ; 5 uses
  %i.mo = extractelement <2 x float> %i.mn, i64 0 ; 5 uses
...
bb.ah:                                            ; preds = %bb.ag
  ...
  %i.na = fmul float %i.mo, 0.000000e+00
  %i.nb = fadd float %.sroa.0173.0307, %i.na
  %i.nc = call float @llvm.fmuladd.f32(float %4, float 0.000000e+00, float %i.nb)
...
bb.ai:                                            ; preds = %bb.ag
  ...
  %i.on = fmul float %i.mo, 0.000000e+00          ; 2 uses
  %i.oo = call float @llvm.fmuladd.f32(float %i.oh, float %.sroa.0173.0307, float %i.on)
  %i.op = call float @llvm.fmuladd.f32(float %i.oj, float %4, float %i.oo)
...
bb.aj:                                            ; preds = %bb.ag
  ...
  %5 = fmul float %i.mo, %i.pn
  %6 = call float @llvm.fmuladd.f32(float %i.pm, float %.sroa.0173.0307, float %5)
  %7 = call float @llvm.fmuladd.f32(float %4, float 0.000000e+00, float %6)
  %i.pp = fmul float %i.mo, %i.pm
  %i.pq = call float @llvm.fmuladd.f32(float %i.po, float %.sroa.0173.0307, float %i.pp)
  %8 = fmul float %i.mo, 0.000000e+00
  %i.pr = call float @llvm.fmuladd.f32(float %.sroa.0173.0307, float 0.000000e+00, float %8)
  ...
  %9 = call float @llvm.fmuladd.f32(float %4, float 0.000000e+00, float %i.pq)
  %10 = fadd float %4, %i.pr
  %i.qa = insertelement <2 x float> poison, float %i.pn, i64 0
  %i.qb = shufflevector <2 x float> %i.qa, <2 x float> poison, <2 x i32> zeroinitializer
  %11 = fmul <2 x float> %i.mm, %i.qb
  %i.qc = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.pu, <2 x float> %i.ml, <2 x float> %11)
  %12 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ml, <2 x float> zeroinitializer, <2 x float> %i.ps)
  %i.qd = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.mk, <2 x float> zeroinitializer, <2 x float> %i.qc)
  %13 = fadd <2 x float> %i.mk, %12
...
bb.ak:                                            ; preds = %bb.ah, %bb.ai, %bb.aj, %bb.ag
  %.sroa.0173.1 = phi float [ %.sroa.0173.0307, %bb.ag ], [ %i.nc, %bb.ah ], [ %i.op, %bb.ai ], [ %7, %bb.aj ] ; 2 uses
  %i.qe = phi <2 x float> [ %i.ml, %bb.ag ], [ %i.ny, %bb.ah ], [ %i.pe, %bb.ai ], [ %i.qd, %bb.aj ] ; 2 uses
  %i.qf = phi <2 x float> [ %i.mk, %bb.ag ], [ %i.oa, %bb.ah ], [ %i.pf, %bb.ai ], [ %13, %bb.aj ] ; 2 uses
  %i.qg = phi <2 x float> [ %i.mm, %bb.ag ], [ %i.nk, %bb.ah ], [ %i.om, %bb.ai ], [ %i.pz, %bb.aj ] ; 3 uses
  %i.qh = phi <2 x float> [ %i.mn, %bb.ag ], [ %i.nt, %bb.ah ], [ %i.ox, %bb.ai ], [ %15, %bb.aj ] ; 2 uses
