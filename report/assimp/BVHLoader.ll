...
bb.af:                                            ; preds = %.lr.ph307, %bb.aj
  ...
  %.sroa.0173.0297.a = phi float [ 0.000000e+00, %.lr.ph307 ], [ %13, %bb.aj ] ; 7 uses
  ...
  %5 = insertelement <2 x float> %4, float %.sroa.0173.0297.a, i64 0 ; 2 uses
...
bb.ag:                                            ; preds = %bb.af
  %6 = insertelement <2 x float> poison, float %.sroa.0173.0297.a, i64 0
  ...
  %i.mo = fmul float %.sroa.0173.0297.a, 0.000000e+00
...
bb.ah:                                            ; preds = %bb.af
  ...
  %i.ob = fmul float %.sroa.0173.0297.a, 0.000000e+00 ; 2 uses
...
bb.ai:                                            ; preds = %bb.af
  ...
  %i.pd = fmul float %.sroa.0173.0297.a, %i.pb
  ...
  %i.pg = fmul float %.sroa.0173.0297.a, %i.pa
  %i.ph = call float @llvm.fmuladd.f32(float %i.pc, float %.sroa.0173.0297, float %i.pg)
  %7 = fmul float %.sroa.0173.0297.a, 0.000000e+00
