...
bb.a:
  %.sroa.15 = alloca <{ [42 x i32], i32, i32, i32 }>, align 8 ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.15)
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(180) %.sroa.15, i8 0, i64 180, i1 false)
...
_ZN6Assimp7Blender10CustomDataD2Ev.exit:          ; preds = %_ZSt8_DestroyIPSt10shared_ptrIN6Assimp7Blender15CustomDataLayerEES4_EvT_S6_RSaIT0_E.exit.i.i.i.i.i, %bb.h
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(180) %i.ac, ptr noundef nonnull align 8 dereferenceable(180) %.sroa.15, i64 180, i1 false)
...
bb.a:
  %.sroa.15.i = alloca <{ [42 x i32], i32, i32, i32 }>, align 8 ; 4 uses
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(180) %.sroa.15.i, i8 0, i64 180, i1 false)
...
_ZN6Assimp7Blender9Structure19_defaultInitializerILi0EEclINS0_10CustomDataEEEvRT_PKc.exit: ; preds = %_ZSt8_DestroyIPSt10shared_ptrIN6Assimp7Blender15CustomDataLayerEES4_EvT_S6_RSaIT0_E.exit.i.i.i.i.i.i, %bb.h
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(180) %i.ad, ptr noundef nonnull align 8 dereferenceable(180) %.sroa.15.i, i64 180, i1 false)
