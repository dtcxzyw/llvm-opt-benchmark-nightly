...
bb.af:                                            ; preds = %.lr.ph1022, %bb.al
  ...
  %i.mi = getelementptr inbounds nuw [12 x i8], ptr %i.mh, i64 %indvars.iv1138 ; 6 uses
...
bb.ah:                                            ; preds = %_ZNSt13unordered_mapIP10aiVector3tIfEiSt4hashIS2_ESt8equal_toIS2_ESaISt4pairIKS2_iEEE4findERS8_.exit459
  ...
  %4 = load <3 x float>, ptr %i.mi, align 4       ; 5 uses
  %i.nk = load float, ptr %i.mi, align 4
  %5 = extractelement <3 x float> %4, i64 1
  %i.nl = fmul float %i.nh, %5
  %i.nm = call float @llvm.fmuladd.f32(float %i.ng, float %i.nk, float %i.nl)
  %6 = extractelement <3 x float> %4, i64 2
  %i.nn = call float @llvm.fmuladd.f32(float %i.ni, float %6, float %i.nm)
  %i.no = fadd float %i.nn, %i.nj
  %i.np = load <8 x float>, ptr %i.md, align 4    ; 4 uses
  %7 = shufflevector <3 x float> %4, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.nq = shufflevector <8 x float> %i.np, <8 x float> poison, <2 x i32> <i32 1, i32 5>
  %i.nr = fmul <2 x float> %7, %i.nq
  %i.ns = shufflevector <8 x float> %i.np, <8 x float> poison, <2 x i32> <i32 0, i32 4>
  %i.nt = shufflevector <3 x float> %4, <3 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.nw = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.nv, <2 x float> %8, <2 x float> %i.nu)
