...
.lr.ph212:                                        ; preds = %_ZNSt6vectorIP6aiNodeSaIS1_EE9push_backERKS1_.exit, %bb.ai
  ...
  %i.ec = invoke noalias noundef nonnull dereferenceable(1144) ptr @_Znwm(i64 noundef 1144) #26
          to label %bb.r unwind label %bb.z       ; 9 uses
...
bb.s:                                             ; preds = %bb.r
  ...
  %i.ep = call noundef float @sinf(float noundef %i.eo) #23 ; 2 uses
  %i.eq = call noundef float @cosf(float noundef %i.eo) #23 ; 2 uses
  ...
  %i.ev = call noundef float @sinf(float noundef %i.eu) #23 ; 3 uses
  %i.ew = call noundef float @cosf(float noundef %i.eu) #23 ; 3 uses
  %3 = fmul float %i.eq, %i.ew
  %4 = fmul float %i.ep, %i.ev
  %5 = fneg float %i.et
  %i.ex = getelementptr inbounds nuw i8, ptr %i.eh, i64 64
  %i.ey = getelementptr inbounds nuw i8, ptr %i.eh, i64 68
  %6 = getelementptr inbounds nuw i8, ptr %i.eh, i64 72
  %i.ez = getelementptr inbounds nuw i8, ptr %i.ec, i64 1028 ; 3 uses
  %7 = load float, ptr %i.ex, align 1
  %.sroa.8.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.ec, i64 1044 ; 2 uses
  %8 = load float, ptr %i.ey, align 1
  %.sroa.12.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.ec, i64 1060 ; 2 uses
  %9 = load float, ptr %6, align 1
  %i.fa = fmul float %4, %5
  %i.fb = call float @llvm.fmuladd.f32(float %3, float %i.es, float %i.fa) ; 8 uses
  %i.fc = fmul float %i.fb, %i.fb                 ; 2 uses
  %10 = insertelement <2 x float> poison, float %i.ep, i64 0
  %11 = insertelement <2 x float> %10, float %i.eq, i64 1 ; 2 uses
  %12 = insertelement <2 x float> poison, float %i.es, i64 0
  %13 = insertelement <2 x float> %12, float %i.ev, i64 1 ; 2 uses
  ...
  %17 = fneg float %16
  %18 = fmul float %i.ew, %17
  %i.fd = insertelement <2 x float> poison, float %i.ew, i64 0
  %i.fe = insertelement <2 x float> %i.fd, float %i.et, i64 1 ; 2 uses
  %19 = fmul <2 x float> %11, %i.fe               ; 2 uses
  %20 = fmul <2 x float> %15, %13
  %21 = shufflevector <2 x float> %i.fe, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %i.ff = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %21, <2 x float> %19, <2 x float> %20) ; 6 uses
  %22 = extractelement <2 x float> %i.ff, i64 0   ; 6 uses
  %23 = extractelement <2 x float> %i.ff, i64 1   ; 4 uses
  %24 = fneg float %23                            ; 3 uses
  %i.fg = fmul float %i.fb, %24
  %25 = fmul float %23, %i.fb
  %26 = extractelement <2 x float> %19, i64 1
  %i.fh = call float @llvm.fmuladd.f32(float %i.ev, float %26, float %18) ; 10 uses
  %27 = fmul float %i.fh, %24
  %28 = fmul float %23, %i.fh
  %foldExtExtBinop = fmul <2 x float> %i.ff, %i.ff
  %29 = extractelement <2 x float> %foldExtExtBinop, i64 0
  %30 = call float @llvm.fmuladd.f32(float %i.fh, float %i.fh, float %29)
  %31 = call float @llvm.fmuladd.f32(float %22, float %22, float %i.fc)
  %32 = fmul float %23, %22
  %33 = call float @llvm.fmuladd.f32(float %i.fh, float %i.fb, float %32)
  %34 = call float @llvm.fmuladd.f32(float %i.fh, float %22, float %i.fg)
  %i.fi = call float @llvm.fmuladd.f32(float %31, float -2.000000e+00, float 1.000000e+00)
  %i.fj = insertelement <4 x float> poison, float %i.fi, i64 0
  %i.fk = insertelement <4 x float> %i.fj, float %34, i64 1
  %35 = insertelement <4 x float> %i.fk, float %33, i64 2
  %36 = insertelement <4 x float> %35, float %7, i64 3
  %i.fl = fmul <4 x float> %36, <float 1.000000e+00, float 2.000000e+00, float 2.000000e+00, float 1.000000e+00>
  %i.fm = call float @llvm.fmuladd.f32(float %i.fh, float %i.fh, float %i.fc)
  %i.fn = call float @llvm.fmuladd.f32(float %22, float %i.fb, float %27)
  %37 = insertelement <2 x float> poison, float %i.fh, i64 0
  %38 = insertelement <2 x float> %37, float %i.fm, i64 1
  %39 = insertelement <2 x float> %i.ff, float -2.000000e+00, i64 1
  %40 = insertelement <2 x float> <float poison, float 1.000000e+00>, float %25, i64 0
  %41 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %38, <2 x float> %39, <2 x float> %40)
  %42 = shufflevector <2 x float> %41, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %43 = insertelement <4 x float> %42, float %i.fn, i64 2
  %44 = insertelement <4 x float> %43, float %8, i64 3
  %45 = fmul <4 x float> %44, <float 2.000000e+00, float 1.000000e+00, float 2.000000e+00, float 1.000000e+00>
  %46 = fmul float %22, %24
  %i.fo = insertelement <2 x float> %i.ff, float %30, i64 1
  %i.fp = insertelement <2 x float> <float poison, float -2.000000e+00>, float %i.fb, i64 0
  %i.fq = insertelement <2 x float> <float poison, float 1.000000e+00>, float %28, i64 0
  %i.fr = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.fo, <2 x float> %i.fp, <2 x float> %i.fq)
  %47 = call float @llvm.fmuladd.f32(float %i.fh, float %i.fb, float %46)
  %i.fs = insertelement <4 x float> poison, float %47, i64 0
  %i.ft = shufflevector <2 x float> %i.fr, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %48 = shufflevector <4 x float> %i.fs, <4 x float> %i.ft, <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
  %49 = insertelement <4 x float> %48, float %9, i64 3
  %50 = fmul <4 x float> %49, <float 2.000000e+00, float 2.000000e+00, float 1.000000e+00, float 1.000000e+00>
  store <4 x float> %i.fl, ptr %i.ez, align 4
  store <4 x float> %45, ptr %.sroa.8.0..sroa_idx, align 4
  store <4 x float> %50, ptr %.sroa.12.0..sroa_idx, align 4
