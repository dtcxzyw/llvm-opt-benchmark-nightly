...
.lr.ph2311:                                       ; preds = %.lr.ph2311.preheader, %_ZNSt6vectorIN6Assimp3MDL8HalfLife11HL1MeshFaceESaIS3_EE9push_backEOS3_.exit542
  ...
  %.sroa.19.52308 = phi ptr [ %.sroa.19.9, %.lr.ph2311.preheader ], [ %.sroa.19.6, %_ZNSt6vectorIN6Assimp3MDL8HalfLife11HL1MeshFaceESaIS3_EE9push_backEOS3_.exit542 ] ; 15 uses
...
_ZNSt6vectorIN6Assimp3MDL8HalfLife11HL1MeshFaceESaIS3_EE9push_backEOS3_.exit542: ; preds = %bb.fv, %_ZNSt6vectorIN6Assimp3MDL8HalfLife11HL1MeshFaceESaIS3_EE17_M_realloc_insertIJS3_EEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i.i549, %bb.fp, %_ZNSt6vectorIN6Assimp3MDL8HalfLife11HL1MeshFaceESaIS3_EE17_M_realloc_insertIJS3_EEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i.i539
  ...
  %.sroa.19.6.a = phi ptr [ %.sroa.19.52308, %bb.fp ], [ %i.asr, %_ZNSt6vectorIN6Assimp3MDL8HalfLife11HL1MeshFaceESaIS3_EE17_M_realloc_insertIJS3_EEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i.i539 ], [ %i.ati, %_ZNSt6vectorIN6Assimp3MDL8HalfLife11HL1MeshFaceESaIS3_EE17_M_realloc_insertIJS3_EEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i.i549 ], [ %.sroa.19.52308, %bb.fv ]
  ...
  %.sroa.19.6 = getelementptr inbounds nuw i8, ptr %.sroa.19.6.a, i64 6 ; 2 uses
...
.loopexit804:                                     ; preds = %_ZNSt6vectorIN6Assimp3MDL8HalfLife11HL1MeshFaceESaIS3_EE9push_backEOS3_.exit542, %_ZNSt6vectorIN6Assimp3MDL8HalfLife11HL1MeshFaceESaIS3_EE9push_backEOS3_.exit, %.preheader806, %.preheader
  ...
  %.sroa.19.7 = phi ptr [ %.sroa.19.10, %_ZNSt6vectorIN6Assimp3MDL8HalfLife11HL1MeshFaceESaIS3_EE9push_backEOS3_.exit ], [ %.sroa.19.9, %.preheader ], [ %.sroa.19.9, %.preheader806 ], [ %.sroa.19.6, %_ZNSt6vectorIN6Assimp3MDL8HalfLife11HL1MeshFaceESaIS3_EE9push_backEOS3_.exit542 ] ; 2 uses
...
bb.ae:                                            ; preds = %.lr.ph159, %_ZN13aiQuaterniontIfE9NormalizeEv.exit
  ...
  %i.kn = getelementptr inbounds nuw [24 x i8], ptr %i.km, i64 %indvars.iv187 ; 10 uses
...
begin_hunk_7_@_ZN6Assimp3MDL8HalfLife12HL1MDLLoader15read_animationsEv:bb.a
  ...
  br i1 %.not114, label %_ZN10aiVector3tIfEixEj.exit118._ZN10aiVector3tIfEixEj.exit134_crit_edge, label %_ZN10aiVector3tIfEixEj.exit120

_ZN10aiVector3tIfEixEj.exit118._ZN10aiVector3tIfEixEj.exit134_crit_edge: ; preds = %_ZN10aiVector3tIfEixEj.exit118
  %.0.i133.phi.trans.insert = getelementptr inbounds nuw i8, ptr %i.kn, i64 8
  %.pre204 = load float, ptr %.0.i133.phi.trans.insert, align 4
...
_ZN10aiVector3tIfEixEj.exit120:                   ; preds = %_ZN10aiVector3tIfEixEj.exit118
  ...
  %.0.i119 = getelementptr inbounds nuw i8, ptr %i.kn, i64 8
...
begin_hunk_8_@_ZN6Assimp3MDL8HalfLife12HL1MDLLoader15read_animationsEv:bb.a
  ...
  %storemerge.i131 = fmul float %i.mb, %.pn.i130  ; 2 uses
  store float %storemerge.i131, ptr %.0.i119, align 4
  br label %_ZN10aiVector3tIfEixEj.exit134

_ZN10aiVector3tIfEixEj.exit134:                   ; preds = %_ZN10aiVector3tIfEixEj.exit118._ZN10aiVector3tIfEixEj.exit134_crit_edge, %_ZN6Assimp3MDL8HalfLife12HL1MDLLoader18extract_anim_valueEPKNS1_13AnimValue_HL1EifRf.exit132
  %1 = phi float [ %.pre204, %_ZN10aiVector3tIfEixEj.exit118._ZN10aiVector3tIfEixEj.exit134_crit_edge ], [ %storemerge.i131, %_ZN6Assimp3MDL8HalfLife12HL1MDLLoader18extract_anim_valueEPKNS1_13AnimValue_HL1EifRf.exit132 ]
  %i.my = load float, ptr %i.jo, align 1
  %.0.i133 = getelementptr inbounds nuw i8, ptr %i.kn, i64 8
  %i.mz = fadd float %i.my, %1
  store float %i.mz, ptr %.0.i133, align 4
...
begin_hunk_9_@_ZN6Assimp3MDL8HalfLife12HL1MDLLoader15read_animationsEv:bb.a
  ...
  br i1 %.not114.1, label %_ZN10aiVector3tIfEixEj.exit118.1._ZN10aiVector3tIfEixEj.exit134.1_crit_edge, label %_ZN10aiVector3tIfEixEj.exit120.1

_ZN10aiVector3tIfEixEj.exit118.1._ZN10aiVector3tIfEixEj.exit134.1_crit_edge: ; preds = %_ZN10aiVector3tIfEixEj.exit118.1
  %.0.i133.1.phi.trans.insert = getelementptr inbounds nuw i8, ptr %i.kn, i64 12
  %.pre205 = load float, ptr %.0.i133.1.phi.trans.insert, align 4
...
_ZN10aiVector3tIfEixEj.exit120.1:                 ; preds = %_ZN10aiVector3tIfEixEj.exit118.1
  ...
  %.0.i119.1 = getelementptr inbounds nuw i8, ptr %i.kn, i64 12
...
begin_hunk_10_@_ZN6Assimp3MDL8HalfLife12HL1MDLLoader15read_animationsEv:bb.a
  ...
  %storemerge.i131.1 = fmul float %i.of, %.pn.i130.1 ; 2 uses
  store float %storemerge.i131.1, ptr %.0.i119.1, align 4
  br label %_ZN10aiVector3tIfEixEj.exit134.1

_ZN10aiVector3tIfEixEj.exit134.1:                 ; preds = %_ZN10aiVector3tIfEixEj.exit118.1._ZN10aiVector3tIfEixEj.exit134.1_crit_edge, %_ZN6Assimp3MDL8HalfLife12HL1MDLLoader18extract_anim_valueEPKNS1_13AnimValue_HL1EifRf.exit132.1
  %2 = phi float [ %.pre205, %_ZN10aiVector3tIfEixEj.exit118.1._ZN10aiVector3tIfEixEj.exit134.1_crit_edge ], [ %storemerge.i131.1, %_ZN6Assimp3MDL8HalfLife12HL1MDLLoader18extract_anim_valueEPKNS1_13AnimValue_HL1EifRf.exit132.1 ]
  %i.pc = load float, ptr %i.jy, align 1
  %.0.i133.1 = getelementptr inbounds nuw i8, ptr %i.kn, i64 12
  %i.pd = fadd float %i.pc, %2
  store float %i.pd, ptr %.0.i133.1, align 4
...
begin_hunk_11_@_ZN6Assimp3MDL8HalfLife12HL1MDLLoader15read_animationsEv:bb.a
  ...
  br i1 %.not114.2, label %_ZN10aiVector3tIfEixEj.exit118.2._ZN10aiVector3tIfEixEj.exit134.2_crit_edge, label %_ZN10aiVector3tIfEixEj.exit120.2

_ZN10aiVector3tIfEixEj.exit118.2._ZN10aiVector3tIfEixEj.exit134.2_crit_edge: ; preds = %_ZN10aiVector3tIfEixEj.exit118.2
  %.0.i133.2.phi.trans.insert = getelementptr inbounds nuw i8, ptr %i.kn, i64 16
  %.pre206 = load float, ptr %.0.i133.2.phi.trans.insert, align 4
  %.pre208 = trunc nuw nsw i64 %indvars.iv187 to i32
...
_ZN10aiVector3tIfEixEj.exit120.2:                 ; preds = %_ZN10aiVector3tIfEixEj.exit118.2
  ...
  %.0.i119.2 = getelementptr inbounds nuw i8, ptr %i.kn, i64 16
  ...
  %i.qn = trunc nuw nsw i64 %indvars.iv187 to i32 ; 3 uses
...
begin_hunk_12_@_ZN6Assimp3MDL8HalfLife12HL1MDLLoader15read_animationsEv:bb.a
  ...
  %storemerge.i131.2 = fmul float %i.qj, %.pn.i130.2 ; 2 uses
  store float %storemerge.i131.2, ptr %.0.i119.2, align 4
  br label %_ZN10aiVector3tIfEixEj.exit134.2

_ZN10aiVector3tIfEixEj.exit134.2:                 ; preds = %_ZN10aiVector3tIfEixEj.exit118.2._ZN10aiVector3tIfEixEj.exit134.2_crit_edge, %_ZN6Assimp3MDL8HalfLife12HL1MDLLoader18extract_anim_valueEPKNS1_13AnimValue_HL1EifRf.exit132.2
  %.pre-phi = phi i32 [ %.pre208, %_ZN10aiVector3tIfEixEj.exit118.2._ZN10aiVector3tIfEixEj.exit134.2_crit_edge ], [ %i.qn, %_ZN6Assimp3MDL8HalfLife12HL1MDLLoader18extract_anim_valueEPKNS1_13AnimValue_HL1EifRf.exit132.2 ]
  %3 = phi float [ %.pre206, %_ZN10aiVector3tIfEixEj.exit118.2._ZN10aiVector3tIfEixEj.exit134.2_crit_edge ], [ %storemerge.i131.2, %_ZN6Assimp3MDL8HalfLife12HL1MDLLoader18extract_anim_valueEPKNS1_13AnimValue_HL1EifRf.exit132.2 ]
  %i.rg = load float, ptr %i.ke, align 1
  %.0.i133.2 = getelementptr inbounds nuw i8, ptr %i.kn, i64 16
  %i.rh = fadd float %i.rg, %3
  store float %i.rh, ptr %.0.i133.2, align 4
  %i.ri = getelementptr inbounds nuw [32 x i8], ptr %i.ko, i64 %indvars.iv187 ; 2 uses
  %i.rj = uitofp nneg i32 %.pre-phi to double     ; 2 uses
