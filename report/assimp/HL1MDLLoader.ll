...
bb.s:                                             ; preds = %bb.r
  ...
  %i.fx = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.fw, <2 x float> %i.fu, <2 x float> %i.fv) ; 7 uses
  %i.fy = extractelement <2 x float> %i.fx, i64 1 ; 3 uses
  %i.fz = fneg float %i.fy
  %i.ga = extractelement <2 x float> %i.fu, i64 1
  %3 = shufflevector <2 x float> %i.fx, <2 x float> poison, <4 x i32> <i32 poison, i32 0, i32 0, i32 1> ; 2 uses
  %4 = shufflevector <2 x float> %i.fx, <2 x float> poison, <4 x i32> <i32 poison, i32 0, i32 poison, i32 0> ; 2 uses
  %5 = shufflevector <2 x float> %i.fx, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %i.gb = fmul float %i.fb, %i.fc
  %i.gc = fmul float %i.ez, %i.fr
  %i.gd = call float @llvm.fmuladd.f32(float %i.ey, float %i.ga, float %i.gc) ; 4 uses
  %6 = call float @llvm.fmuladd.f32(float %i.fa, float %i.ev, float %i.gb) ; 5 uses
  %7 = fmul float %i.fy, %i.gd
  %8 = fmul float %i.fy, %6
  %9 = insertelement <4 x float> poison, float %6, i64 0
  %10 = shufflevector <4 x float> %9, <4 x float> poison, <4 x i32> <i32 0, i32 poison, i32 0, i32 poison>
  %11 = shufflevector <4 x float> %10, <4 x float> %3, <4 x i32> <i32 0, i32 5, i32 2, i32 7> ; 3 uses
  %12 = shufflevector <4 x float> %4, <4 x float> %11, <4 x i32> <i32 4, i32 1, i32 4, i32 3>
  %13 = fmul <4 x float> %11, %12
  %14 = insertelement <4 x float> %4, float 1.000000e+00, i64 1
  %i.ge = insertelement <4 x float> %14, float %6, i64 0
  %i.gf = insertelement <4 x float> %i.ge, float %i.gd, i64 2 ; 2 uses
  %i.gg = insertelement <4 x float> <float poison, float 1.000000e+00, float poison, float poison>, float %i.fz, i64 0
  %15 = shufflevector <4 x float> %i.gg, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 0>
  %16 = fmul <4 x float> %i.gf, %15
  %17 = insertelement <2 x float> %5, float %i.gd, i64 0 ; 2 uses
  %18 = shufflevector <2 x float> %17, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 0>
  %19 = shufflevector <2 x float> %17, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %20 = shufflevector <4 x float> %19, <4 x float> %11, <4 x i32> <i32 0, i32 0, i32 poison, i32 4>
  %21 = shufflevector <4 x float> %20, <4 x float> %3, <4 x i32> <i32 0, i32 1, i32 6, i32 3>
  %22 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %18, <4 x float> %21, <4 x float> %13) ; 4 uses
  %23 = shufflevector <4 x float> %i.gf, <4 x float> <float poison, float -2.000000e+00, float poison, float poison>, <4 x i32> <i32 2, i32 5, i32 0, i32 2>
  %24 = shufflevector <2 x float> %i.fx, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %25 = shufflevector <4 x float> %24, <4 x float> %22, <4 x i32> <i32 0, i32 6, i32 0, i32 poison>
  %i.gh = insertelement <4 x float> %25, float %6, i64 3
  %26 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %23, <4 x float> %i.gh, <4 x float> %16) ; 3 uses
  %27 = shufflevector <4 x float> %26, <4 x float> %22, <4 x i32> <i32 1, i32 0, i32 7, i32 poison>
  %28 = insertelement <4 x float> %27, float %i.fh, i64 3
  %29 = fmul <4 x float> %28, <float 1.000000e+00, float 2.000000e+00, float 2.000000e+00, float 1.000000e+00>
  %30 = insertelement <4 x float> poison, float %i.gd, i64 0
  %31 = shufflevector <4 x float> %30, <4 x float> %22, <2 x i32> <i32 0, i32 4>
  %i.gi = insertelement <2 x float> %i.fx, float -2.000000e+00, i64 1
  %i.gj = insertelement <2 x float> <float poison, float 1.000000e+00>, float %8, i64 0
  %i.gk = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %31, <2 x float> %i.gi, <2 x float> %i.gj)
  %i.gl = shufflevector <2 x float> %i.gk, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %32 = shufflevector <4 x float> %i.gl, <4 x float> %26, <4 x i32> <i32 0, i32 1, i32 6, i32 poison>
  %i.gm = insertelement <4 x float> %32, float %i.fi, i64 3
  %i.gn = fmul <4 x float> %i.gm, <float 2.000000e+00, float 1.000000e+00, float 2.000000e+00, float 1.000000e+00>
  %33 = shufflevector <2 x float> %i.fx, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %34 = shufflevector <4 x float> %33, <4 x float> %22, <2 x i32> <i32 0, i32 5>
  %i.go = insertelement <2 x float> <float poison, float -2.000000e+00>, float %6, i64 0
  %35 = insertelement <2 x float> <float poison, float 1.000000e+00>, float %7, i64 0
  %36 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %34, <2 x float> %i.go, <2 x float> %35)
  %37 = shufflevector <4 x float> %26, <4 x float> poison, <4 x i32> <i32 3, i32 poison, i32 poison, i32 poison>
  %i.gp = shufflevector <2 x float> %36, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.gq = shufflevector <4 x float> %37, <4 x float> %i.gp, <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
  ...
  store <4 x float> %29, ptr %i.fg, align 4
