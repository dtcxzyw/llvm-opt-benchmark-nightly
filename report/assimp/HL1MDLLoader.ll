...
bb.s:                                             ; preds = %bb.r
  ...
  %4 = fneg float %i.fp
  %i.fq = insertelement <2 x float> poison, float %i.ez, i64 0
  ...
  %i.fv = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.fu, <2 x float> %i.fs, <2 x float> %i.ft) ; 7 uses
  %i.fw = extractelement <2 x float> %i.fv, i64 1 ; 3 uses
  %5 = fneg float %i.fw
  %6 = extractelement <2 x float> %i.fs, i64 1
  %7 = shufflevector <2 x float> %i.fv, <2 x float> poison, <4 x i32> <i32 poison, i32 0, i32 0, i32 1> ; 2 uses
  %8 = shufflevector <2 x float> %i.fv, <2 x float> poison, <4 x i32> <i32 poison, i32 0, i32 poison, i32 0> ; 2 uses
  %9 = shufflevector <2 x float> %i.fv, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %10 = fmul float %i.fb, %3
  %11 = fmul float %i.ez, %4
  %12 = call float @llvm.fmuladd.f32(float %i.ey, float %6, float %11) ; 4 uses
  %13 = call float @llvm.fmuladd.f32(float %i.fa, float %i.ev, float %10) ; 5 uses
  %14 = fmul float %i.fw, %12
  %15 = fmul float %i.fw, %13
  %16 = insertelement <4 x float> poison, float %13, i64 0
  %17 = shufflevector <4 x float> %16, <4 x float> poison, <4 x i32> <i32 0, i32 poison, i32 0, i32 poison>
  %18 = shufflevector <4 x float> %17, <4 x float> %7, <4 x i32> <i32 0, i32 5, i32 2, i32 7> ; 3 uses
  %19 = shufflevector <4 x float> %8, <4 x float> %18, <4 x i32> <i32 4, i32 1, i32 4, i32 3>
  %20 = fmul <4 x float> %18, %19
  %21 = insertelement <4 x float> %8, float 1.000000e+00, i64 1
  %22 = insertelement <4 x float> %21, float %13, i64 0
  %23 = insertelement <4 x float> %22, float %12, i64 2 ; 2 uses
  %24 = insertelement <4 x float> <float poison, float 1.000000e+00, float poison, float poison>, float %5, i64 0
  %25 = shufflevector <4 x float> %24, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 0>
  %26 = fmul <4 x float> %23, %25
  %27 = insertelement <2 x float> %9, float %12, i64 0 ; 2 uses
  %28 = shufflevector <2 x float> %27, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 0>
  %29 = shufflevector <2 x float> %27, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %30 = shufflevector <4 x float> %29, <4 x float> %18, <4 x i32> <i32 0, i32 0, i32 poison, i32 4>
  %31 = shufflevector <4 x float> %30, <4 x float> %7, <4 x i32> <i32 0, i32 1, i32 6, i32 3>
  %32 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %28, <4 x float> %31, <4 x float> %20) ; 4 uses
  %33 = shufflevector <4 x float> %23, <4 x float> <float poison, float -2.000000e+00, float poison, float poison>, <4 x i32> <i32 2, i32 5, i32 0, i32 2>
  %34 = shufflevector <2 x float> %i.fv, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %35 = shufflevector <4 x float> %34, <4 x float> %32, <4 x i32> <i32 0, i32 6, i32 0, i32 poison>
  %36 = insertelement <4 x float> %35, float %13, i64 3
  %37 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %33, <4 x float> %36, <4 x float> %26) ; 3 uses
  %38 = shufflevector <4 x float> %37, <4 x float> %32, <4 x i32> <i32 1, i32 0, i32 7, i32 poison>
  %39 = insertelement <4 x float> %38, float %i.fg, i64 3
  %40 = fmul <4 x float> %39, <float 1.000000e+00, float 2.000000e+00, float 2.000000e+00, float 1.000000e+00>
  %i.fx = insertelement <4 x float> poison, float %12, i64 0
  %41 = shufflevector <4 x float> %i.fx, <4 x float> %32, <2 x i32> <i32 0, i32 4>
  %i.fy = insertelement <2 x float> %i.fv, float -2.000000e+00, i64 1
  %i.fz = insertelement <2 x float> <float poison, float 1.000000e+00>, float %15, i64 0
  %i.ga = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %41, <2 x float> %i.fy, <2 x float> %i.fz)
  %i.gb = shufflevector <2 x float> %i.ga, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %42 = shufflevector <4 x float> %i.gb, <4 x float> %37, <4 x i32> <i32 0, i32 1, i32 6, i32 poison>
  %i.gc = insertelement <4 x float> %42, float %i.fh, i64 3
  %i.gd = fmul <4 x float> %i.gc, <float 2.000000e+00, float 1.000000e+00, float 2.000000e+00, float 1.000000e+00>
  %43 = shufflevector <2 x float> %i.fv, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %44 = shufflevector <4 x float> %43, <4 x float> %32, <2 x i32> <i32 0, i32 5>
  %45 = insertelement <2 x float> <float poison, float -2.000000e+00>, float %13, i64 0
  %i.ge = insertelement <2 x float> <float poison, float 1.000000e+00>, float %14, i64 0
  %i.gf = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %44, <2 x float> %45, <2 x float> %i.ge)
  %46 = shufflevector <4 x float> %37, <4 x float> poison, <4 x i32> <i32 3, i32 poison, i32 poison, i32 poison>
  %i.gg = shufflevector <2 x float> %i.gf, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.gh = shufflevector <4 x float> %46, <4 x float> %i.gg, <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
  ...
  store <4 x float> %40, ptr %i.ff, align 4
...
.lr.ph2308:                                       ; preds = %.lr.ph2308.preheader, %.lr.ph2308
  ...
  %i.acn = load float, ptr %i.acl, align 4        ; 2 uses
  %i.aco = load float, ptr %i.ace, align 4        ; 2 uses
  ...
  %i.acw = insertelement <2 x float> poison, float %i.aco, i64 0
  ...
  %i.adj = fmul float %i.acn, %i.adi
  %i.adk = call float @llvm.fmuladd.f32(float %i.adg, float %i.aco, float %i.adj)
...
bb.cy:                                            ; preds = %.lr.ph2310
  ...
  %i.afg = load float, ptr %i.aeu, align 4        ; 2 uses
  %i.afh = load float, ptr %i.aeb, align 4        ; 2 uses
  %i.afi = load float, ptr %i.aev, align 4        ; 2 uses
  %i.afj = insertelement <2 x float> poison, float %i.afg, i64 0
  %i.afk = shufflevector <2 x float> %i.afj, <2 x float> poison, <2 x i32> zeroinitializer
  %i.afl = fmul <2 x float> %i.aey, %i.afk
  %i.afm = insertelement <2 x float> poison, float %i.afh, i64 0
  ...
  %i.aft = fmul float %i.aej, %i.afg
  %i.afu = call float @llvm.fmuladd.f32(float %i.aeg, float %i.afh, float %i.aft)
