...
.lr.ph2308:                                       ; preds = %.lr.ph2308.preheader, %.lr.ph2308
  ...
  %32 = getelementptr inbounds nuw i8, ptr %i.acj, i64 8
  %33 = getelementptr inbounds nuw i8, ptr %i.ace, i64 4
  %i.ack = getelementptr inbounds nuw i8, ptr %i.ace, i64 8
  %34 = load float, ptr %33, align 4              ; 2 uses
  %35 = load float, ptr %i.ace, align 4           ; 2 uses
  %i.acl = load float, ptr %i.ack, align 4        ; 2 uses
  %i.acm = load <8 x float>, ptr %32, align 4     ; 4 uses
  ...
  %39 = insertelement <2 x float> poison, float %i.acl, i64 0
  %40 = shufflevector <2 x float> %39, <2 x float> poison, <2 x i32> zeroinitializer
  %i.act = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.acs, <2 x float> %40, <2 x float> %i.acr)
  ...
  %i.ada = fmul float %34, %i.acz
  %i.adb = call float @llvm.fmuladd.f32(float %i.acx, float %35, float %i.ada)
  %i.adc = getelementptr inbounds nuw i8, ptr %i.acj, i64 48
  %i.add = load float, ptr %i.adc, align 4
  %i.ade = call float @llvm.fmuladd.f32(float %i.add, float %i.acl, float %i.adb)
...
bb.cy:                                            ; preds = %.lr.ph2310
  %i.ads = getelementptr inbounds nuw [12 x i8], ptr %i.zl, i64 %.02562309 ; 3 uses
  ...
  %41 = getelementptr inbounds nuw i8, ptr %i.ads, i64 4
  %42 = getelementptr inbounds nuw i8, ptr %i.ads, i64 8
  ...
  %43 = load float, ptr %41, align 4              ; 2 uses
  %44 = load float, ptr %i.ads, align 4           ; 2 uses
  %i.aev = load float, ptr %42, align 4           ; 2 uses
  %45 = insertelement <2 x float> poison, float %43, i64 0
  %46 = shufflevector <2 x float> %45, <2 x float> poison, <2 x i32> zeroinitializer
  %i.aew = fmul <2 x float> %i.aen, %46
  %47 = insertelement <2 x float> poison, float %44, i64 0
  %i.aex = shufflevector <2 x float> %47, <2 x float> poison, <2 x i32> zeroinitializer
  %i.aey = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.aem, <2 x float> %i.aex, <2 x float> %i.aew)
  %48 = insertelement <2 x float> poison, float %i.aev, i64 0
  %49 = shufflevector <2 x float> %48, <2 x float> poison, <2 x i32> zeroinitializer
  %50 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.aep, <2 x float> %49, <2 x float> %i.aey)
  %51 = fadd <2 x float> %i.aes, %50
  %i.aez = fmul float %i.aea, %43
  %i.afa = call float @llvm.fmuladd.f32(float %i.adx, float %44, float %i.aez)
  %i.afb = call float @llvm.fmuladd.f32(float %.sroa.14.0.copyload, float %i.aev, float %i.afa)
  %i.afc = fadd float %i.aej, %i.afb
  %i.afd = getelementptr inbounds nuw [12 x i8], ptr %.sroa.0759.3, i64 %.02562309 ; 2 uses
  store <2 x float> %51, ptr %i.afd, align 4
