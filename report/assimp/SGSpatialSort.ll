...
bb.e:                                             ; preds = %_ZNSt6vectorIN6Assimp13SGSpatialSort5EntryESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit35.i.i
  ...
  %6 = sub i64 %5, %i.z
  tail call void @_ZdlPvm(ptr noundef nonnull %i.x, i64 noundef %6) #13
...
.preheader:                                       ; preds = %.critedge2
  %i.bo = getelementptr inbounds nuw i8, ptr %4, i64 16 ; 3 uses
  br label %bb.g
...
bb.o:                                             ; preds = %_ZNSt6vectorIjSaIjEE11_S_relocateEPjS2_S2_RS0_.exit16.i.i
  %6 = load ptr, ptr %i.bo, align 8
  %7 = ptrtoint ptr %6 to i64
  %8 = sub i64 %7, %i.cs
  tail call void @_ZdlPvm(ptr noundef nonnull %i.cq, i64 noundef %8) #13
...
bb.w:                                             ; preds = %_ZNSt6vectorIjSaIjEE11_S_relocateEPjS2_S2_RS0_.exit16.i.i74
  %9 = load ptr, ptr %i.dk, align 8
  %10 = ptrtoint ptr %9 to i64
  %11 = sub i64 %10, %i.el
  tail call void @_ZdlPvm(ptr noundef nonnull %i.ej, i64 noundef %11) #13
...
bb.ad:                                            ; preds = %_ZNSt6vectorIjSaIjEE11_S_relocateEPjS2_S2_RS0_.exit16.i.i86
  %12 = load ptr, ptr %i.dk, align 8
  %13 = ptrtoint ptr %12 to i64
  %14 = sub i64 %13, %i.gg
  tail call void @_ZdlPvm(ptr noundef nonnull %i.ge, i64 noundef %14) #13
