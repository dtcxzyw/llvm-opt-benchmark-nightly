...
bb.ah:                                            ; preds = %bb.ag
  ...
  %.sroa.6.sroa.0.0.copyload = load <4 x float>, ptr %.sroa.6.0..sroa_idx, align 4
  %.sroa.7.0.copyload = load float, ptr %.sroa.7.0..sroa_idx, align 4
  %.sroa.8.sroa.0.0.copyload = load <4 x float>, ptr %.sroa.8.0..sroa_idx, align 4
  %.sroa.9.0.copyload = load float, ptr %.sroa.9.0..sroa_idx, align 4
  %.sroa.10.sroa.0.0.copyload = load <4 x float>, ptr %.sroa.10.0..sroa_idx, align 4
...
bb.am:                                            ; preds = %bb.ah, %bb.af
  %.sroa.6.sroa.0.0 = phi <4 x float> [ zeroinitializer, %bb.af ], [ %.sroa.6.sroa.0.0.copyload, %bb.ah ]
  %.sroa.8.sroa.0.0 = phi <4 x float> [ zeroinitializer, %bb.af ], [ %.sroa.8.sroa.0.0.copyload, %bb.ah ]
  %.sroa.10.sroa.0.0 = phi <4 x float> [ zeroinitializer, %bb.af ], [ %.sroa.10.sroa.0.0.copyload, %bb.ah ]
  %.sroa.0182.0 = phi float [ 1.000000e+00, %bb.af ], [ %.sroa.0182.0.copyload, %bb.ah ]
  %.sroa.7.0 = phi float [ 1.000000e+00, %bb.af ], [ %.sroa.7.0.copyload, %bb.ah ]
  %.sroa.9.0 = phi float [ 1.000000e+00, %bb.af ], [ %.sroa.9.0.copyload, %bb.ah ]
  %.sroa.11.0 = phi float [ 1.000000e+00, %bb.af ], [ %.sroa.11.0.copyload, %bb.ah ]
  %i.gg = load ptr, ptr %i.i, align 8
  store float %.sroa.0182.0, ptr %20, align 8
  store <4 x float> %.sroa.6.sroa.0.0, ptr %.sroa.6.0..sroa_idx184, align 4
  store float %.sroa.7.0, ptr %.sroa.7.0..sroa_idx185, align 4
  store <4 x float> %.sroa.8.sroa.0.0, ptr %.sroa.8.0..sroa_idx187, align 8
  store float %.sroa.9.0, ptr %.sroa.9.0..sroa_idx188, align 8
  store <4 x float> %.sroa.10.sroa.0.0, ptr %.sroa.10.0..sroa_idx190, align 4
...
bb.bz:                                            ; preds = %bb.by
  ...
  %.sroa.6238.sroa.0.0.copyload = load <4 x float>, ptr %.sroa.6238.0..sroa_idx, align 4
  %.sroa.7.0.copyload = load float, ptr %.sroa.7.0..sroa_idx, align 4
  %.sroa.8.sroa.0.0.copyload = load <4 x float>, ptr %.sroa.8.0..sroa_idx, align 4
  %.sroa.9.0.copyload = load float, ptr %.sroa.9.0..sroa_idx, align 4
  %.sroa.10.sroa.0.0.copyload = load <4 x float>, ptr %.sroa.10.0..sroa_idx, align 4
...
._crit_edge.i.i196:                               ; preds = %bb.bz, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit192
  %.sroa.6238.sroa.0.0 = phi <4 x float> [ zeroinitializer, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit192 ], [ %.sroa.6238.sroa.0.0.copyload, %bb.bz ] ; 2 uses
  %.sroa.8.sroa.0.0 = phi <4 x float> [ zeroinitializer, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit192 ], [ %.sroa.8.sroa.0.0.copyload, %bb.bz ] ; 2 uses
  %.sroa.10.sroa.0.0 = phi <4 x float> [ zeroinitializer, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit192 ], [ %.sroa.10.sroa.0.0.copyload, %bb.bz ] ; 2 uses
  %.sroa.0236.0 = phi float [ 1.000000e+00, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit192 ], [ %.sroa.0236.0.copyload, %bb.bz ] ; 2 uses
  %.sroa.7.0 = phi float [ 1.000000e+00, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit192 ], [ %.sroa.7.0.copyload, %bb.bz ] ; 2 uses
  %.sroa.9.0 = phi float [ 1.000000e+00, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit192 ], [ %.sroa.9.0.copyload, %bb.bz ] ; 2 uses
  %.sroa.11.0 = phi float [ 1.000000e+00, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit192 ], [ %.sroa.11.0.copyload, %bb.bz ] ; 2 uses
...
begin_hunk_10_@_ZN6Assimp4D3MF13XmlSerializer10ReadObjectERN4pugi8xml_nodeE:._crit_edge.i.i
  ...
  store <4 x float> %.sroa.6238.sroa.0.0, ptr %.sroa.6.sroa.6.0..sroa.6.0..sroa_idx.sroa_idx, align 4
  ...
  store <4 x float> %.sroa.8.sroa.0.0, ptr %.sroa.6.sroa.8.0..sroa.6.0..sroa_idx.sroa_idx, align 4
  ...
  store <4 x float> %.sroa.10.sroa.0.0, ptr %.sroa.6.sroa.10.0..sroa.6.0..sroa_idx.sroa_idx, align 4
...
begin_hunk_11_@_ZN6Assimp4D3MF13XmlSerializer10ReadObjectERN4pugi8xml_nodeE:._crit_edge.i.i
  ...
  store <4 x float> %.sroa.6238.sroa.0.0, ptr %.sroa.6.sroa.6.0..sroa.6.0..sroa_idx233.sroa_idx, align 4
  ...
  store <4 x float> %.sroa.8.sroa.0.0, ptr %.sroa.6.sroa.8.0..sroa.6.0..sroa_idx233.sroa_idx, align 4
  ...
  store <4 x float> %.sroa.10.sroa.0.0, ptr %.sroa.6.sroa.10.0..sroa.6.0..sroa_idx233.sroa_idx, align 4
