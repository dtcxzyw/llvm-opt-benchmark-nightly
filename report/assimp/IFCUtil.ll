...
bb.j:                                             ; preds = %bb.h, %bb.i, %bb.g
  %i.bd = phi double [ 1.000000e+00, %bb.h ], [ %.pre105, %bb.i ], [ 1.000000e+00, %bb.g ] ; 5 uses
  ...
  %i.bf = load double, ptr %i.ad, align 8         ; 3 uses
  %5 = load double, ptr %2, align 8               ; 4 uses
  store double %5, ptr %0, align 8
  %i.bg = getelementptr inbounds nuw i8, ptr %0, i64 32 ; 2 uses
  store double %i.bf, ptr %i.bg, align 8
  %i.bh = load double, ptr %i.ae, align 8         ; 5 uses
  %6 = getelementptr inbounds nuw i8, ptr %0, i64 64 ; 2 uses
  store double %i.bh, ptr %6, align 8
  %7 = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.bi = load double, ptr %i.af, align 8         ; 3 uses
  %8 = load double, ptr %3, align 16              ; 4 uses
...
bb.s:                                             ; preds = %bb.r, %bb.q, %bb.p, %bb.o
  ...
  %9 = fmul double %i.bi, 0.000000e+00            ; 2 uses
  %10 = fadd double %8, %9
  ...
  %i.cw = insertelement <2 x double> %i.cv, double %i.bk, i64 1
  ...
  %i.dh = load double, ptr %i.dg, align 8         ; 4 uses
  %i.di = getelementptr inbounds nuw i8, ptr %0, i64 120
  %i.dj = tail call double @llvm.fmuladd.f64(double %5, double 0.000000e+00, double %i.bf)
  %i.dk = tail call double @llvm.fmuladd.f64(double %i.bh, double 0.000000e+00, double %i.dj)
  ...
  %i.dm = tail call double @llvm.fmuladd.f64(double %8, double 0.000000e+00, double %i.bi)
  ...
  %i.dq = insertelement <2 x double> <double poison, double 0.000000e+00>, double %.sroa.6102.0..sroa.6102.0..sroa.6102.0..sroa.6102.8., i64 0 ; 2 uses
  ...
  %11 = extractelement <2 x double> %i.ds, i64 1
  %12 = load double, ptr %i.df, align 8           ; 2 uses
  %i.dt = tail call double @llvm.fmuladd.f64(double %i.bd, double 0.000000e+00, double %11)
  %13 = insertelement <2 x double> poison, double %i.dt, i64 0
  %14 = insertelement <2 x double> %13, double %12, i64 1
  %i.du = fmul double %i.bp, 0.000000e+00         ; 2 uses
  %i.dv = fadd double %i.bn, %i.du
  %i.dw = insertelement <2 x double> <double poison, double 0.000000e+00>, double %.sroa.8103.0..sroa.8103.0..sroa.8103.0..sroa.8103.16., i64 0 ; 2 uses
  %15 = fmul double %12, 0.000000e+00             ; 2 uses
  %16 = fadd double %i.de, %15
  %i.dx = fmul double %i.bf, 0.000000e+00         ; 2 uses
  %i.dy = fadd double %5, %i.dx
  %i.dz = tail call double @llvm.fmuladd.f64(double %i.bh, double 0.000000e+00, double %i.dy)
  %17 = insertelement <2 x double> poison, double %i.dz, i64 0
  %18 = insertelement <2 x double> %17, double %10, i64 1
  %i.ea = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cu, <2 x double> %i.cw, <2 x double> %18) ; 3 uses
  %19 = shufflevector <2 x double> %i.ea, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %20 = tail call double @llvm.fmuladd.f64(double %5, double 0.000000e+00, double %i.dx) ; 2 uses
  %i.eb = fadd double %i.bh, %20
  ...
  %21 = insertelement <2 x double> %19, double %i.dv, i64 1
  %22 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.da, <2 x double> %i.db, <2 x double> %21) ; 2 uses
  %23 = insertelement <2 x double> poison, double %.sroa.8103.0..sroa.8103.0..sroa.8103.0..sroa.8103.16., i64 0
  %24 = insertelement <2 x double> %23, double %i.bh, i64 1
  %25 = tail call double @llvm.fmuladd.f64(double %8, double 0.000000e+00, double %9) ; 2 uses
  %i.ed = fadd double %i.bk, %25
  %i.ee = insertelement <2 x double> poison, double %i.ed, i64 0
  %i.ef = insertelement <2 x double> %i.ee, double %i.du, i64 1
  %i.eg = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.dp, <2 x double> %i.dw, <2 x double> %i.ef) ; 3 uses
  ...
  %i.ek = insertelement <2 x double> %i.ej, double %15, i64 1
  %i.el = insertelement <2 x double> poison, double %i.bk, i64 0
  %i.em = insertelement <2 x double> %i.el, double %i.bd, i64 1
  %26 = insertelement <2 x double> %i.eg, double %25, i64 0
  %27 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.em, <2 x double> zeroinitializer, <2 x double> %26) ; 2 uses
  %i.en = extractelement <2 x double> %27, i64 0
  %i.eo = fadd double %i.en, %i.cy
  %i.ep = insertelement <2 x double> <double 0.000000e+00, double poison>, double %.sroa.684.0, i64 1 ; 4 uses
  %i.eq = shufflevector <2 x double> %22, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.et = shufflevector <2 x double> %i.ea, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.ew = extractelement <2 x double> %i.ea, i64 0
  %i.ex = load <2 x double>, ptr %i.dc, align 8   ; 5 uses
  %28 = insertelement <2 x double> %i.ex, double %i.de, i64 1 ; 2 uses
  %29 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %28, <2 x double> %i.dq, <2 x double> %14) ; 4 uses
  %30 = extractelement <2 x double> %29, i64 1
  %i.ey = extractelement <2 x double> %i.ex, i64 1
  %31 = tail call double @llvm.fmuladd.f64(double %i.dh, double 0.000000e+00, double %16)
  %i.ez = shufflevector <2 x double> %i.cv, <2 x double> poison, <2 x i32> zeroinitializer
  %i.fa = shufflevector <2 x double> %22, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %i.fb = insertelement <2 x double> %i.fa, double %31, i64 1
  %i.fc = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ex, <2 x double> %i.ez, <2 x double> %i.fb) ; 5 uses
  %32 = shufflevector <2 x double> <double poison, double 0.000000e+00>, <2 x double> %i.ex, <2 x i32> <i32 3, i32 1>
  %i.fd = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %28, <2 x double> %i.dw, <2 x double> %i.ek) ; 4 uses
  %i.fe = extractelement <2 x double> %i.fd, i64 1 ; 2 uses
  %i.ff = fadd double %i.dh, %i.fe
  %33 = insertelement <2 x double> poison, double %i.ff, i64 0
  %34 = insertelement <2 x double> %33, double %20, i64 1
  %i.fg = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %32, <2 x double> %24, <2 x double> %34) ; 4 uses
  %35 = extractelement <2 x double> %i.fg, i64 1
  %36 = fadd double %35, %i.ct                    ; 2 uses
  ...
  %37 = shufflevector <2 x double> %29, <2 x double> poison, <2 x i32> zeroinitializer
  %i.fy = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %37, <2 x double> zeroinitializer, <2 x double> %i.fx)
  %38 = extractelement <2 x double> %i.fu, i64 0
  %39 = extractelement <2 x double> %29, i64 0
  %40 = tail call double @llvm.fmuladd.f64(double %i.dh, double 0.000000e+00, double %30)
  %41 = tail call double @llvm.fmuladd.f64(double %i.ey, double %.sroa.6102.0..sroa.6102.0..sroa.6102.0..sroa.6102.8., double %40) ; 3 uses
  %42 = insertelement <2 x double> poison, double %41, i64 0
  %43 = shufflevector <2 x double> %42, <2 x double> poison, <2 x i32> zeroinitializer
  %i.fz = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %43, <2 x double> zeroinitializer, <2 x double> %i.fy)
  %i.ga = tail call double @llvm.fmuladd.f64(double %i.dl, double 0.000000e+00, double %38) ; 2 uses
  %i.gb = tail call double @llvm.fmuladd.f64(double %.sroa.985.0, double %39, double %i.ga)
  %i.gc = insertelement <2 x double> %29, double %41, i64 1
  %i.gd = insertelement <2 x double> poison, double %i.ga, i64 0
  %44 = insertelement <2 x double> %i.gd, double %i.gb, i64 1
  %45 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.gc, <2 x double> zeroinitializer, <2 x double> %44) ; 2 uses
  %46 = extractelement <2 x double> %45, i64 0
  %47 = fadd double %46, %41
  store <2 x double> %i.fz, ptr %i.bg, align 8
  %i.ge = extractelement <2 x double> %45, i64 1
  store double %i.ge, ptr %i.bo, align 8
  store double %47, ptr %i.df, align 8
  ...
  %48 = shufflevector <2 x double> %i.fg, <2 x double> poison, <2 x i32> zeroinitializer
  %49 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %48, <2 x double> zeroinitializer, <2 x double> %i.gl)
  %50 = extractelement <2 x double> %i.gg, i64 0
  %i.gm = extractelement <2 x double> %i.fd, i64 0
  %51 = tail call double @llvm.fmuladd.f64(double %i.ec, double 0.000000e+00, double %50) ; 2 uses
  %i.gn = tail call double @llvm.fmuladd.f64(double %.sroa.985.0, double %i.gm, double %51)
  %52 = shufflevector <2 x double> %i.fg, <2 x double> %i.fd, <2 x i32> <i32 0, i32 2>
  %53 = insertelement <2 x double> poison, double %i.gn, i64 0
  %54 = insertelement <2 x double> %53, double %51, i64 1
  %55 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %52, <2 x double> zeroinitializer, <2 x double> %54) ; 2 uses
  %shift111 = shufflevector <2 x double> %55, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop112 = fadd <2 x double> %shift111, %i.fg
  %56 = extractelement <2 x double> %foldExtExtBinop112, i64 0
  store <2 x double> %49, ptr %6, align 8
  %57 = extractelement <2 x double> %55, i64 0
  store double %57, ptr %i.bq, align 8
  store double %56, ptr %i.dg, align 8
  ...
  %i.gr = insertelement <2 x double> poison, double %36, i64 0
  ...
  %58 = tail call double @llvm.fmuladd.f64(double %i.dh, double 0.000000e+00, double %i.fe)
  %59 = shufflevector <2 x double> %27, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %60 = insertelement <2 x double> %59, double %58, i64 1
  %i.gv = fadd <2 x double> %i.ex, %60            ; 5 uses
  ...
  %i.ha = tail call double @llvm.fmuladd.f64(double %36, double 0.000000e+00, double %i.gu) ; 2 uses
