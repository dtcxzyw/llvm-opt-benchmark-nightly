...
vector.memcheck:                                  ; preds = %.lr.ph.i
  %i.w = add i64 %i.g, -24
  %i.x = sub i64 %i.w, %i.d
  %.fr = freeze i64 %i.x                          ; 2 uses
  %i.y = urem i64 %.fr, 24
  %i.z = sub nuw i64 %.fr, %i.y
  %i.aa = getelementptr i8, ptr %i.c, i64 %i.z
  %scevgep = getelementptr i8, ptr %i.aa, i64 24
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %i.ad = load <2 x double>, ptr %1, align 8
  %broadcast.splat18 = shufflevector <2 x double> %i.ad, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ae = load <2 x double>, ptr %i.h, align 8
  %broadcast.splat = shufflevector <2 x double> %i.ae, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %broadcast.splat24 = shufflevector <2 x double> %i.ai, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %broadcast.splat32 = shufflevector <2 x double> %i.am, <2 x double> poison, <2 x i32> zeroinitializer
  %i.an = load <2 x double>, ptr %i.q, align 8
  %broadcast.splat36 = shufflevector <2 x double> %i.an, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ao = load <2 x double>, ptr %i.r, align 8
  %broadcast.splat38 = shufflevector <2 x double> %i.ao, <2 x double> poison, <2 x i32> zeroinitializer
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.ap = mul i64 %index, 24                      ; 2 uses
  %next.gep = getelementptr i8, ptr %i.c, i64 %i.ap ; 4 uses
  %i.aq = getelementptr i8, ptr %i.c, i64 %i.ap   ; 3 uses
  %next.gep16 = getelementptr i8, ptr %i.aq, i64 24
  %i.ar = load double, ptr %next.gep, align 8, !alias.scope !3, !noalias !6
  %i.as = load double, ptr %next.gep16, align 8, !alias.scope !3, !noalias !6
  %i.at = insertelement <2 x double> poison, double %i.ar, i64 0
  %i.au = insertelement <2 x double> %i.at, double %i.as, i64 1 ; 3 uses
  %i.av = getelementptr inbounds nuw i8, ptr %next.gep, i64 8
  %i.aw = getelementptr i8, ptr %i.aq, i64 32
  %i.ax = load double, ptr %i.av, align 8, !alias.scope !3, !noalias !6
  %i.ay = load double, ptr %i.aw, align 8, !alias.scope !3, !noalias !6
  %i.az = insertelement <2 x double> poison, double %i.ax, i64 0
  %i.ba = insertelement <2 x double> %i.az, double %i.ay, i64 1 ; 3 uses
  %i.bb = fmul <2 x double> %broadcast.splat, %i.ba
  %i.bc = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat18, <2 x double> %i.au, <2 x double> %i.bb)
  %i.bd = getelementptr inbounds nuw i8, ptr %next.gep, i64 16
  %i.be = getelementptr i8, ptr %i.aq, i64 40
  %i.bf = load double, ptr %i.bd, align 8, !alias.scope !3, !noalias !6
  %i.bg = load double, ptr %i.be, align 8, !alias.scope !3, !noalias !6
  %i.bh = insertelement <2 x double> poison, double %i.bf, i64 0
  %i.bi = insertelement <2 x double> %i.bh, double %i.bg, i64 1 ; 3 uses
  %i.bj = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat20, <2 x double> %i.bi, <2 x double> %i.bc)
  %i.bk = fmul <2 x double> %i.ba, %broadcast.splat24
  %i.bl = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat26, <2 x double> %i.au, <2 x double> %i.bk)
  %i.bm = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat28, <2 x double> %i.bi, <2 x double> %i.bl)
  %i.bn = fmul <2 x double> %i.ba, %broadcast.splat32
  %i.bo = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat34, <2 x double> %i.au, <2 x double> %i.bn)
  %i.bp = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat36, <2 x double> %i.bi, <2 x double> %i.bo)
  %i.bq = fadd <2 x double> %broadcast.splat38, %i.bp
  %i.br = shufflevector <2 x double> %i.bj, <2 x double> %i.ak, <4 x i32> <i32 0, i32 1, i32 2, i32 2>
  %i.bs = shufflevector <2 x double> %i.ag, <2 x double> %i.bm, <4 x i32> <i32 0, i32 0, i32 2, i32 3>
  %i.bt = fadd <4 x double> %i.br, %i.bs
  %i.bu = shufflevector <2 x double> %i.bq, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %interleaved.vec = shufflevector <4 x double> %i.bt, <4 x double> %i.bu, <6 x i32> <i32 0, i32 2, i32 4, i32 1, i32 3, i32 5>
  store <6 x double> %interleaved.vec, ptr %next.gep, align 8, !alias.scope !3, !noalias !10
  %index.next = add nuw i64 %index, 2             ; 2 uses
  %i.bv = icmp eq i64 %index.next, %n.vec
  br i1 %i.bv, label %middle.block, label %vector.body, !llvm.loop !11
...
scalar.ph.preheader:                              ; preds = %vector.memcheck, %.lr.ph.i, %middle.block
  %.sroa.05.09.i.ph = phi ptr [ %i.c, %vector.memcheck ], [ %i.c, %.lr.ph.i ], [ %i.ac, %middle.block ]
  br label %scalar.ph

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %.sroa.05.09.i = phi ptr [ %i.cy, %scalar.ph ], [ %.sroa.05.09.i.ph, %scalar.ph.preheader ] ; 5 uses
  %i.bw = load double, ptr %.sroa.05.09.i, align 8, !noalias !14 ; 2 uses
  %i.bx = getelementptr inbounds nuw i8, ptr %.sroa.05.09.i, i64 8
  %i.by = load double, ptr %i.bx, align 8, !noalias !14 ; 2 uses
  %i.bz = getelementptr inbounds nuw i8, ptr %.sroa.05.09.i, i64 16 ; 2 uses
  %i.ca = load double, ptr %i.bz, align 8, !noalias !14 ; 2 uses
  %i.cb = load double, ptr %i.o, align 8, !noalias !14
  %i.cc = load double, ptr %i.p, align 8, !noalias !14
  %i.cd = fmul double %i.by, %i.cc
  %i.ce = tail call double @llvm.fmuladd.f64(double %i.cb, double %i.bw, double %i.cd)
  %i.cf = load double, ptr %i.q, align 8, !noalias !14
  %i.cg = tail call double @llvm.fmuladd.f64(double %i.cf, double %i.ca, double %i.ce)
  %i.ch = load double, ptr %i.r, align 8, !noalias !14
  %i.ci = fadd double %i.ch, %i.cg
  %i.cj = load <8 x double>, ptr %1, align 8, !noalias !14 ; 4 uses
  %i.ck = insertelement <2 x double> poison, double %i.by, i64 0
  %i.cl = shufflevector <2 x double> %i.ck, <2 x double> poison, <2 x i32> zeroinitializer
  %i.cm = shufflevector <8 x double> %i.cj, <8 x double> poison, <2 x i32> <i32 1, i32 5>
  %i.cn = fmul <2 x double> %i.cl, %i.cm
  %i.co = shufflevector <8 x double> %i.cj, <8 x double> poison, <2 x i32> <i32 0, i32 4>
  ...
  %i.cs = shufflevector <8 x double> %i.cj, <8 x double> poison, <2 x i32> <i32 2, i32 6>
  %i.ct = insertelement <2 x double> poison, double %i.ca, i64 0
  %i.cu = shufflevector <2 x double> %i.ct, <2 x double> poison, <2 x i32> zeroinitializer
  %i.cv = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cs, <2 x double> %i.cu, <2 x double> %i.cr)
  %i.cw = shufflevector <8 x double> %i.cj, <8 x double> poison, <2 x i32> <i32 3, i32 7>
  %i.cx = fadd <2 x double> %i.cv, %i.cw
  store <2 x double> %i.cx, ptr %.sroa.05.09.i, align 8
  store double %i.ci, ptr %i.bz, align 8
  %i.cy = getelementptr inbounds nuw i8, ptr %.sroa.05.09.i, i64 24 ; 2 uses
  %.not.i = icmp eq ptr %i.cy, %i.f
...
bb.c:                                             ; preds = %_ZN6Assimp3IFC8TempMesh9TransformERK12aiMatrix4x4tIdE.exit
  %i.db = load ptr, ptr %i.da, align 8            ; 9 uses
  %i.dc = ptrtoaddr ptr %i.db to i64              ; 2 uses
...
.lr.ph.i5:                                        ; preds = %bb.c
  ...
  %i.do = getelementptr inbounds nuw i8, ptr %1, i64 72 ; 2 uses
  %i.dp = getelementptr inbounds nuw i8, ptr %1, i64 80 ; 2 uses
  %i.dq = getelementptr inbounds nuw i8, ptr %1, i64 88 ; 2 uses
  %i.dr = sub i64 %i.df, %i.dc
...
vector.memcheck39:                                ; preds = %.lr.ph.i5
  %i.dv = add i64 %i.df, -24
  %i.dw = sub i64 %i.dv, %i.dc
  %.fr83 = freeze i64 %i.dw                       ; 2 uses
  %i.dx = urem i64 %.fr83, 24
  %i.dy = sub nuw i64 %.fr83, %i.dx
  %i.dz = getelementptr i8, ptr %i.db, i64 %i.dy
  %scevgep40 = getelementptr i8, ptr %i.dz, i64 24
  %scevgep41 = getelementptr inbounds nuw i8, ptr %1, i64 96
  %bound042 = icmp ult ptr %i.db, %scevgep41
...
vector.ph47:                                      ; preds = %vector.memcheck39
  %n.vec49 = and i64 %i.du, 2305843009213693950   ; 3 uses
  %i.ea = mul i64 %n.vec49, 24
  %i.eb = getelementptr i8, ptr %i.db, i64 %i.ea
  %i.ec = load <2 x double>, ptr %1, align 8
  %broadcast.splat57 = shufflevector <2 x double> %i.ec, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ed = load <2 x double>, ptr %i.dg, align 8
  %broadcast.splat55 = shufflevector <2 x double> %i.ed, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ee = load <2 x double>, ptr %i.dh, align 8
  %broadcast.splat59 = shufflevector <2 x double> %i.ee, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ef = load <2 x double>, ptr %i.di, align 8
  %i.eg = load <2 x double>, ptr %i.dj, align 8
  %broadcast.splat65 = shufflevector <2 x double> %i.eg, <2 x double> poison, <2 x i32> zeroinitializer
  %i.eh = load <2 x double>, ptr %i.dk, align 8
  %broadcast.splat63 = shufflevector <2 x double> %i.eh, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ei = load <2 x double>, ptr %i.dl, align 8
  %broadcast.splat67 = shufflevector <2 x double> %i.ei, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ej = load <2 x double>, ptr %i.dm, align 8
  %i.ek = load <2 x double>, ptr %i.dn, align 8
  %broadcast.splat73 = shufflevector <2 x double> %i.ek, <2 x double> poison, <2 x i32> zeroinitializer
  %i.el = load <2 x double>, ptr %i.do, align 8
  %broadcast.splat71 = shufflevector <2 x double> %i.el, <2 x double> poison, <2 x i32> zeroinitializer
  %i.em = load <2 x double>, ptr %i.dp, align 8
  %broadcast.splat75 = shufflevector <2 x double> %i.em, <2 x double> poison, <2 x i32> zeroinitializer
  %i.en = load <2 x double>, ptr %i.dq, align 8
  %broadcast.splat77 = shufflevector <2 x double> %i.en, <2 x double> poison, <2 x i32> zeroinitializer
...
vector.body50:                                    ; preds = %vector.body50, %vector.ph47
  ...
  %i.eo = mul i64 %index51, 24                    ; 2 uses
  %next.gep52 = getelementptr i8, ptr %i.db, i64 %i.eo ; 4 uses
  %i.ep = getelementptr i8, ptr %i.db, i64 %i.eo  ; 3 uses
  %next.gep53 = getelementptr i8, ptr %i.ep, i64 24
  %i.eq = load double, ptr %next.gep52, align 8, !alias.scope !16, !noalias !19
  %i.er = load double, ptr %next.gep53, align 8, !alias.scope !16, !noalias !19
  %i.es = insertelement <2 x double> poison, double %i.eq, i64 0
  %i.et = insertelement <2 x double> %i.es, double %i.er, i64 1 ; 3 uses
  %i.eu = getelementptr inbounds nuw i8, ptr %next.gep52, i64 8
  %i.ev = getelementptr i8, ptr %i.ep, i64 32
  %i.ew = load double, ptr %i.eu, align 8, !alias.scope !16, !noalias !19
  %i.ex = load double, ptr %i.ev, align 8, !alias.scope !16, !noalias !19
  %i.ey = insertelement <2 x double> poison, double %i.ew, i64 0
  %i.ez = insertelement <2 x double> %i.ey, double %i.ex, i64 1 ; 3 uses
  %i.fa = fmul <2 x double> %broadcast.splat55, %i.ez
  %i.fb = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat57, <2 x double> %i.et, <2 x double> %i.fa)
  %i.fc = getelementptr inbounds nuw i8, ptr %next.gep52, i64 16
  %i.fd = getelementptr i8, ptr %i.ep, i64 40
  %i.fe = load double, ptr %i.fc, align 8, !alias.scope !16, !noalias !19
  %i.ff = load double, ptr %i.fd, align 8, !alias.scope !16, !noalias !19
  %i.fg = insertelement <2 x double> poison, double %i.fe, i64 0
  %i.fh = insertelement <2 x double> %i.fg, double %i.ff, i64 1 ; 3 uses
  %i.fi = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat59, <2 x double> %i.fh, <2 x double> %i.fb)
  %i.fj = fmul <2 x double> %i.ez, %broadcast.splat63
  %i.fk = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat65, <2 x double> %i.et, <2 x double> %i.fj)
  %i.fl = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat67, <2 x double> %i.fh, <2 x double> %i.fk)
  %i.fm = fmul <2 x double> %i.ez, %broadcast.splat71
  %i.fn = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat73, <2 x double> %i.et, <2 x double> %i.fm)
  %i.fo = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat75, <2 x double> %i.fh, <2 x double> %i.fn)
  %i.fp = fadd <2 x double> %broadcast.splat77, %i.fo
  %i.fq = shufflevector <2 x double> %i.fi, <2 x double> %i.ej, <4 x i32> <i32 0, i32 1, i32 2, i32 2>
  %i.fr = shufflevector <2 x double> %i.ef, <2 x double> %i.fl, <4 x i32> <i32 0, i32 0, i32 2, i32 3>
  %i.fs = fadd <4 x double> %i.fq, %i.fr
  %i.ft = shufflevector <2 x double> %i.fp, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %interleaved.vec78 = shufflevector <4 x double> %i.fs, <4 x double> %i.ft, <6 x i32> <i32 0, i32 2, i32 4, i32 1, i32 3, i32 5>
  ...
  %i.fu = icmp eq i64 %index.next79, %n.vec49
  br i1 %i.fu, label %middle.block80, label %vector.body50, !llvm.loop !24

middle.block80:                                   ; preds = %vector.body50
  %cmp.n81 = icmp eq i64 %i.du, %n.vec49
...
scalar.ph45.preheader:                            ; preds = %vector.memcheck39, %.lr.ph.i5, %middle.block80
  %.sroa.05.09.i6.ph = phi ptr [ %i.db, %vector.memcheck39 ], [ %i.db, %.lr.ph.i5 ], [ %i.eb, %middle.block80 ]
  br label %scalar.ph45

scalar.ph45:                                      ; preds = %scalar.ph45.preheader, %scalar.ph45
  %.sroa.05.09.i6 = phi ptr [ %i.gx, %scalar.ph45 ], [ %.sroa.05.09.i6.ph, %scalar.ph45.preheader ] ; 5 uses
  %i.fv = load double, ptr %.sroa.05.09.i6, align 8, !noalias !25 ; 2 uses
  %i.fw = getelementptr inbounds nuw i8, ptr %.sroa.05.09.i6, i64 8
  %i.fx = load double, ptr %i.fw, align 8, !noalias !25 ; 2 uses
  %i.fy = getelementptr inbounds nuw i8, ptr %.sroa.05.09.i6, i64 16 ; 2 uses
  %i.fz = load double, ptr %i.fy, align 8, !noalias !25 ; 2 uses
  %i.ga = load double, ptr %i.dn, align 8, !noalias !25
  %i.gb = load double, ptr %i.do, align 8, !noalias !25
  %i.gc = fmul double %i.fx, %i.gb
  %i.gd = tail call double @llvm.fmuladd.f64(double %i.ga, double %i.fv, double %i.gc)
  %i.ge = load double, ptr %i.dp, align 8, !noalias !25
  %i.gf = tail call double @llvm.fmuladd.f64(double %i.ge, double %i.fz, double %i.gd)
  %i.gg = load double, ptr %i.dq, align 8, !noalias !25
  %i.gh = fadd double %i.gg, %i.gf
  %i.gi = load <8 x double>, ptr %1, align 8, !noalias !25 ; 4 uses
  ...
  %i.gl = shufflevector <8 x double> %i.gi, <8 x double> poison, <2 x i32> <i32 1, i32 5>
  %i.gm = fmul <2 x double> %i.gk, %i.gl
  %i.gn = shufflevector <8 x double> %i.gi, <8 x double> poison, <2 x i32> <i32 0, i32 4>
  ...
  %i.gr = shufflevector <8 x double> %i.gi, <8 x double> poison, <2 x i32> <i32 2, i32 6>
  ...
  %i.gu = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.gr, <2 x double> %i.gt, <2 x double> %i.gq)
  %i.gv = shufflevector <8 x double> %i.gi, <8 x double> poison, <2 x i32> <i32 3, i32 7>
  %i.gw = fadd <2 x double> %i.gu, %i.gv
  store <2 x double> %i.gw, ptr %.sroa.05.09.i6, align 8
  store double %i.gh, ptr %i.fy, align 8
  %i.gx = getelementptr inbounds nuw i8, ptr %.sroa.05.09.i6, i64 24 ; 2 uses
  %.not.i7 = icmp eq ptr %i.gx, %i.de
...
_ZN6Assimp3IFC8TempMesh9TransformERK12aiMatrix4x4tIdE.exit8: ; preds = %scalar.ph45, %middle.block80, %bb.c, %_ZN6Assimp3IFC8TempMesh9TransformERK12aiMatrix4x4tIdE.exit
  ...
  %i.gz = load <2 x double>, ptr %i.gy, align 8
  %i.ha = getelementptr inbounds nuw i8, ptr %1, i64 32
  %i.hb = getelementptr inbounds nuw i8, ptr %1, i64 48
  ...
  %i.hh = getelementptr inbounds nuw i8, ptr %1, i64 80
  %i.hi = load double, ptr %i.hh, align 8
  ...
  %i.ho = load double, ptr %i.hn, align 8, !noalias !27 ; 2 uses
  %i.hp = fmul double %i.hg, %i.hm
  %i.hq = tail call double @llvm.fmuladd.f64(double %i.he, double %i.hk, double %i.hp)
  %i.hr = tail call double @llvm.fmuladd.f64(double %i.hi, double %i.ho, double %i.hq)
  %i.hs = load <2 x double>, ptr %1, align 8      ; 2 uses
  %i.ht = load <2 x double>, ptr %i.ha, align 8   ; 2 uses
  %i.hu = shufflevector <2 x double> %i.hs, <2 x double> %i.ht, <2 x i32> <i32 1, i32 3>
  %i.hv = insertelement <2 x double> poison, double %i.hm, i64 0
  %i.hw = shufflevector <2 x double> %i.hv, <2 x double> poison, <2 x i32> zeroinitializer
  %i.hx = fmul <2 x double> %i.hu, %i.hw
  %i.hy = shufflevector <2 x double> %i.hs, <2 x double> %i.ht, <2 x i32> <i32 0, i32 2>
  ...
  %i.ic = insertelement <2 x double> %i.gz, double %i.hc, i64 1
  %i.id = insertelement <2 x double> poison, double %i.ho, i64 0
  %i.ie = shufflevector <2 x double> %i.id, <2 x double> poison, <2 x i32> zeroinitializer
  %i.if = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ic, <2 x double> %i.ie, <2 x double> %i.ib)
  store <2 x double> %i.if, ptr %i.hj, align 8
  store double %i.hr, ptr %i.hn, align 8
  ret void
}
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %broadcast.splat14 = shufflevector <2 x double> %i.ab, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %broadcast.splat16 = shufflevector <2 x double> %i.ad, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ae = load <2 x double>, ptr %i.h, align 8
  %i.af = load <2 x double>, ptr %i.i, align 8
  %broadcast.splat22 = shufflevector <2 x double> %i.af, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ag = load <2 x double>, ptr %i.j, align 8
  %broadcast.splat20 = shufflevector <2 x double> %i.ag, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ah = load <2 x double>, ptr %i.k, align 8
  %broadcast.splat24 = shufflevector <2 x double> %i.ah, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ai = load <2 x double>, ptr %i.l, align 8
  %i.aj = load <2 x double>, ptr %i.m, align 8
  %broadcast.splat30 = shufflevector <2 x double> %i.aj, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ak = load <2 x double>, ptr %i.n, align 8
  %broadcast.splat28 = shufflevector <2 x double> %i.ak, <2 x double> poison, <2 x i32> zeroinitializer
  %i.al = load <2 x double>, ptr %i.o, align 8
  %broadcast.splat32 = shufflevector <2 x double> %i.al, <2 x double> poison, <2 x i32> zeroinitializer
  %i.am = load <2 x double>, ptr %i.p, align 8
  %broadcast.splat34 = shufflevector <2 x double> %i.am, <2 x double> poison, <2 x i32> zeroinitializer
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.an = mul i64 %index, 24                      ; 2 uses
  %next.gep = getelementptr i8, ptr %i.a, i64 %i.an ; 4 uses
  %i.ao = getelementptr i8, ptr %i.a, i64 %i.an   ; 3 uses
  %next.gep12 = getelementptr i8, ptr %i.ao, i64 24
  %i.ap = load double, ptr %next.gep, align 8, !alias.scope !30, !noalias !33
  %i.aq = load double, ptr %next.gep12, align 8, !alias.scope !30, !noalias !33
  ...
  %i.aw = load double, ptr %i.au, align 8, !alias.scope !30, !noalias !33
  ...
  %i.ba = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat14, <2 x double> %i.as, <2 x double> %i.az)
  ...
  %i.be = load double, ptr %i.bc, align 8, !alias.scope !30, !noalias !33
  %i.bf = insertelement <2 x double> poison, double %i.bd, i64 0
  %i.bg = insertelement <2 x double> %i.bf, double %i.be, i64 1 ; 3 uses
  %i.bh = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat16, <2 x double> %i.bg, <2 x double> %i.ba)
  %i.bi = fmul <2 x double> %i.ay, %broadcast.splat20
  %i.bj = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat22, <2 x double> %i.as, <2 x double> %i.bi)
  %i.bk = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat24, <2 x double> %i.bg, <2 x double> %i.bj)
  %i.bl = fmul <2 x double> %i.ay, %broadcast.splat28
  %i.bm = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat30, <2 x double> %i.as, <2 x double> %i.bl)
  %i.bn = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat32, <2 x double> %i.bg, <2 x double> %i.bm)
  %i.bo = fadd <2 x double> %broadcast.splat34, %i.bn
  ...
  br i1 %i.bt, label %middle.block, label %vector.body, !llvm.loop !38
...
scalar.ph.preheader:                              ; preds = %vector.memcheck, %.lr.ph, %middle.block
  %.sroa.05.09.ph = phi ptr [ %i.a, %vector.memcheck ], [ %i.a, %.lr.ph ], [ %i.aa, %middle.block ]
  br label %scalar.ph
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %.sroa.05.09 = phi ptr [ %i.cw, %scalar.ph ], [ %.sroa.05.09.ph, %scalar.ph.preheader ] ; 5 uses
  %i.bu = load double, ptr %.sroa.05.09, align 8, !noalias !39 ; 2 uses
  %i.bv = getelementptr inbounds nuw i8, ptr %.sroa.05.09, i64 8
  %i.bw = load double, ptr %i.bv, align 8, !noalias !39 ; 2 uses
  %i.bx = getelementptr inbounds nuw i8, ptr %.sroa.05.09, i64 16 ; 2 uses
  %i.by = load double, ptr %i.bx, align 8, !noalias !39 ; 2 uses
  %i.bz = load double, ptr %i.m, align 8, !noalias !39
  %i.ca = load double, ptr %i.n, align 8, !noalias !39
  %i.cb = fmul double %i.bw, %i.ca
  %i.cc = tail call double @llvm.fmuladd.f64(double %i.bz, double %i.bu, double %i.cb)
  %i.cd = load double, ptr %i.o, align 8, !noalias !39
  %i.ce = tail call double @llvm.fmuladd.f64(double %i.cd, double %i.by, double %i.cc)
  %i.cf = load double, ptr %i.p, align 8, !noalias !39
  %i.cg = fadd double %i.cf, %i.ce
  %i.ch = load <8 x double>, ptr %1, align 8, !noalias !39 ; 4 uses
  ...
  store <2 x double> %i.cv, ptr %.sroa.05.09, align 8
  store double %i.cg, ptr %i.bx, align 8
  %i.cw = getelementptr inbounds nuw i8, ptr %.sroa.05.09, i64 24 ; 2 uses
