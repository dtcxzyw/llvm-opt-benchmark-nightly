...
define hidden void @_ZN6Assimp3IFC11TempOpening9TransformERK12aiMatrix4x4tIdE(ptr nofree noundef nonnull align 8 captures(none) dereferenceable(88) %0, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(128) %1) local_unnamed_addr #0 align 2 {
bb.a:
...
vector.memcheck:                                  ; preds = %.lr.ph.i
  ...
  %i.w = urem i64 %.fr, 24
  %i.x = sub nuw i64 %.fr, %i.w
  %i.y = getelementptr i8, ptr %i.c, i64 %i.x
  %scevgep = getelementptr i8, ptr %i.y, i64 24
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %i.z = mul i64 %n.vec, 24
  %i.aa = getelementptr i8, ptr %i.c, i64 %i.z
  %i.ab = load <2 x double>, ptr %1, align 8
  %broadcast.splat18 = shufflevector <2 x double> %i.ab, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ac = load <2 x double>, ptr %i.f, align 8
  %broadcast.splat = shufflevector <2 x double> %i.ac, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ad = load <2 x double>, ptr %i.g, align 8
  %broadcast.splat20 = shufflevector <2 x double> %i.ad, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ae = load <2 x double>, ptr %i.h, align 8
  %i.af = load <2 x double>, ptr %i.i, align 8
  %broadcast.splat26 = shufflevector <2 x double> %i.af, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ag = load <2 x double>, ptr %i.j, align 8
  ...
  %broadcast.splat28 = shufflevector <2 x double> %i.ah, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ai = load <2 x double>, ptr %i.l, align 8
  %i.aj = load <2 x double>, ptr %i.m, align 8
  %broadcast.splat34 = shufflevector <2 x double> %i.aj, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ak = load <2 x double>, ptr %i.n, align 8
  %broadcast.splat32 = shufflevector <2 x double> %i.ak, <2 x double> poison, <2 x i32> zeroinitializer
  %i.al = load <2 x double>, ptr %i.o, align 8
  %broadcast.splat36 = shufflevector <2 x double> %i.al, <2 x double> poison, <2 x i32> zeroinitializer
  %i.am = load <2 x double>, ptr %i.p, align 8
  %broadcast.splat38 = shufflevector <2 x double> %i.am, <2 x double> poison, <2 x i32> zeroinitializer
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.an = mul i64 %index, 24                      ; 2 uses
  %next.gep = getelementptr i8, ptr %i.c, i64 %i.an ; 4 uses
  %i.ao = getelementptr i8, ptr %i.c, i64 %i.an   ; 3 uses
  %next.gep16 = getelementptr i8, ptr %i.ao, i64 24
  %i.ap = load double, ptr %next.gep, align 8, !alias.scope !3, !noalias !6
  %i.aq = load double, ptr %next.gep16, align 8, !alias.scope !3, !noalias !6
  %i.ar = insertelement <2 x double> poison, double %i.ap, i64 0
  %i.as = insertelement <2 x double> %i.ar, double %i.aq, i64 1 ; 3 uses
  %i.at = getelementptr inbounds nuw i8, ptr %next.gep, i64 8
  %i.au = getelementptr i8, ptr %i.ao, i64 32
  %i.av = load double, ptr %i.at, align 8, !alias.scope !3, !noalias !6
  %i.aw = load double, ptr %i.au, align 8, !alias.scope !3, !noalias !6
  %i.ax = insertelement <2 x double> poison, double %i.av, i64 0
  %i.ay = insertelement <2 x double> %i.ax, double %i.aw, i64 1 ; 3 uses
  %i.az = fmul <2 x double> %broadcast.splat, %i.ay
  %i.ba = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat18, <2 x double> %i.as, <2 x double> %i.az)
  %i.bb = getelementptr inbounds nuw i8, ptr %next.gep, i64 16
  %i.bc = getelementptr i8, ptr %i.ao, i64 40
  %i.bd = load double, ptr %i.bb, align 8, !alias.scope !3, !noalias !6
  %i.be = load double, ptr %i.bc, align 8, !alias.scope !3, !noalias !6
  %i.bf = insertelement <2 x double> poison, double %i.bd, i64 0
  %i.bg = insertelement <2 x double> %i.bf, double %i.be, i64 1 ; 3 uses
  %i.bh = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat20, <2 x double> %i.bg, <2 x double> %i.ba)
  %i.bi = fmul <2 x double> %i.ay, %broadcast.splat24
  %i.bj = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat26, <2 x double> %i.as, <2 x double> %i.bi)
  %i.bk = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat28, <2 x double> %i.bg, <2 x double> %i.bj)
  %i.bl = fmul <2 x double> %i.ay, %broadcast.splat32
  %i.bm = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat34, <2 x double> %i.as, <2 x double> %i.bl)
  %i.bn = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat36, <2 x double> %i.bg, <2 x double> %i.bm)
  %i.bo = fadd <2 x double> %broadcast.splat38, %i.bn
  %i.bp = shufflevector <2 x double> %i.bh, <2 x double> %i.ai, <4 x i32> <i32 0, i32 1, i32 2, i32 2>
  %i.bq = shufflevector <2 x double> %i.ae, <2 x double> %i.bk, <4 x i32> <i32 0, i32 0, i32 2, i32 3>
  %i.br = fadd <4 x double> %i.bp, %i.bq
  %i.bs = shufflevector <2 x double> %i.bo, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %interleaved.vec = shufflevector <4 x double> %i.br, <4 x double> %i.bs, <6 x i32> <i32 0, i32 2, i32 4, i32 1, i32 3, i32 5>
  store <6 x double> %interleaved.vec, ptr %next.gep, align 8, !alias.scope !3, !noalias !10
  %index.next = add nuw i64 %index, 2             ; 2 uses
  %i.bt = icmp eq i64 %index.next, %n.vec
  br i1 %i.bt, label %middle.block, label %vector.body, !llvm.loop !11
...
scalar.ph.preheader:                              ; preds = %vector.memcheck, %.lr.ph.i, %middle.block
  %.sroa.05.09.i.ph = phi ptr [ %i.c, %vector.memcheck ], [ %i.c, %.lr.ph.i ], [ %i.aa, %middle.block ]
  br label %scalar.ph

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %.sroa.05.09.i = phi ptr [ %i.cw, %scalar.ph ], [ %.sroa.05.09.i.ph, %scalar.ph.preheader ] ; 5 uses
  %i.bu = load double, ptr %.sroa.05.09.i, align 8, !noalias !14 ; 2 uses
  %i.bv = getelementptr inbounds nuw i8, ptr %.sroa.05.09.i, i64 8
  %i.bw = load double, ptr %i.bv, align 8, !noalias !14 ; 2 uses
  %i.bx = getelementptr inbounds nuw i8, ptr %.sroa.05.09.i, i64 16 ; 2 uses
  %i.by = load double, ptr %i.bx, align 8, !noalias !14 ; 2 uses
  %i.bz = load double, ptr %i.m, align 8, !noalias !14
  %i.ca = load double, ptr %i.n, align 8, !noalias !14
  %i.cb = fmul double %i.bw, %i.ca
  %i.cc = tail call double @llvm.fmuladd.f64(double %i.bz, double %i.bu, double %i.cb)
  %i.cd = load double, ptr %i.o, align 8, !noalias !14
  %i.ce = tail call double @llvm.fmuladd.f64(double %i.cd, double %i.by, double %i.cc)
  %i.cf = load double, ptr %i.p, align 8, !noalias !14
  %i.cg = fadd double %i.cf, %i.ce
  %i.ch = load <8 x double>, ptr %1, align 8, !noalias !14 ; 4 uses
  %i.ci = insertelement <2 x double> poison, double %i.bw, i64 0
  %i.cj = shufflevector <2 x double> %i.ci, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ck = shufflevector <8 x double> %i.ch, <8 x double> poison, <2 x i32> <i32 1, i32 5>
  %i.cl = fmul <2 x double> %i.cj, %i.ck
  %i.cm = shufflevector <8 x double> %i.ch, <8 x double> poison, <2 x i32> <i32 0, i32 4>
  ...
  %i.cp = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cm, <2 x double> %i.co, <2 x double> %i.cl)
  %i.cq = shufflevector <8 x double> %i.ch, <8 x double> poison, <2 x i32> <i32 2, i32 6>
  ...
  %i.ct = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cq, <2 x double> %i.cs, <2 x double> %i.cp)
  %i.cu = shufflevector <8 x double> %i.ch, <8 x double> poison, <2 x i32> <i32 3, i32 7>
  %i.cv = fadd <2 x double> %i.ct, %i.cu
  store <2 x double> %i.cv, ptr %.sroa.05.09.i, align 8
  store double %i.cg, ptr %i.bx, align 8
  %i.cw = getelementptr inbounds nuw i8, ptr %.sroa.05.09.i, i64 24 ; 2 uses
  %.not.i = icmp eq ptr %i.cw, %i.e
  br i1 %.not.i, label %_ZN6Assimp3IFC8TempMesh9TransformERK12aiMatrix4x4tIdE.exit, label %scalar.ph, !llvm.loop !15

_ZN6Assimp3IFC8TempMesh9TransformERK12aiMatrix4x4tIdE.exit: ; preds = %scalar.ph, %middle.block, %bb.b, %bb.a
  %i.cx = getelementptr inbounds nuw i8, ptr %0, i64 48
  %i.cy = load ptr, ptr %i.cx, align 8            ; 3 uses
  %.not9 = icmp eq ptr %i.cy, null
...
.lr.ph.i5:                                        ; preds = %bb.c
  ...
  %i.dj = getelementptr inbounds nuw i8, ptr %1, i64 64 ; 2 uses
  ...
  %min.iters.check46 = icmp ult i64 %i.do, 24
  br i1 %min.iters.check46, label %scalar.ph45.preheader, label %vector.memcheck39

vector.memcheck39:                                ; preds = %.lr.ph.i5
  %i.dr = add i64 %7, -24
  %i.ds = sub i64 %i.dr, %6
  %.fr83 = freeze i64 %i.ds                       ; 2 uses
  %i.dt = urem i64 %.fr83, 24
  %i.du = sub nuw i64 %.fr83, %i.dt
  %i.dv = getelementptr i8, ptr %i.cz, i64 %i.du
  %scevgep40 = getelementptr i8, ptr %i.dv, i64 24
  %scevgep41 = getelementptr inbounds nuw i8, ptr %1, i64 96
  %bound042 = icmp ult ptr %i.cz, %scevgep41
...
vector.ph47:                                      ; preds = %vector.memcheck39
  %n.vec49 = and i64 %i.dq, 2305843009213693950   ; 3 uses
  %i.dw = mul i64 %n.vec49, 24
  %i.dx = getelementptr i8, ptr %i.cz, i64 %i.dw
  %i.dy = load <2 x double>, ptr %1, align 8
  %broadcast.splat57 = shufflevector <2 x double> %i.dy, <2 x double> poison, <2 x i32> zeroinitializer
  %i.dz = load <2 x double>, ptr %i.dc, align 8
  %broadcast.splat55 = shufflevector <2 x double> %i.dz, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ea = load <2 x double>, ptr %i.dd, align 8
  %broadcast.splat59 = shufflevector <2 x double> %i.ea, <2 x double> poison, <2 x i32> zeroinitializer
  %i.eb = load <2 x double>, ptr %i.de, align 8
  %i.ec = load <2 x double>, ptr %i.df, align 8
  %broadcast.splat65 = shufflevector <2 x double> %i.ec, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ed = load <2 x double>, ptr %i.dg, align 8
  ...
  %broadcast.splat67 = shufflevector <2 x double> %i.ee, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ef = load <2 x double>, ptr %i.di, align 8
  %i.eg = load <2 x double>, ptr %i.dj, align 8
  %broadcast.splat73 = shufflevector <2 x double> %i.eg, <2 x double> poison, <2 x i32> zeroinitializer
  %i.eh = load <2 x double>, ptr %i.dk, align 8
  %broadcast.splat71 = shufflevector <2 x double> %i.eh, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ei = load <2 x double>, ptr %i.dl, align 8
  %broadcast.splat75 = shufflevector <2 x double> %i.ei, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ej = load <2 x double>, ptr %i.dm, align 8
  %broadcast.splat77 = shufflevector <2 x double> %i.ej, <2 x double> poison, <2 x i32> zeroinitializer
  br label %vector.body50

vector.body50:                                    ; preds = %vector.body50, %vector.ph47
  %index51 = phi i64 [ 0, %vector.ph47 ], [ %index.next79, %vector.body50 ] ; 2 uses
  %i.ek = mul i64 %index51, 24                    ; 2 uses
  %next.gep52 = getelementptr i8, ptr %i.cz, i64 %i.ek ; 4 uses
  %i.el = getelementptr i8, ptr %i.cz, i64 %i.ek  ; 3 uses
  %next.gep53 = getelementptr i8, ptr %i.el, i64 24
  %i.em = load double, ptr %next.gep52, align 8, !alias.scope !16, !noalias !19
  %i.en = load double, ptr %next.gep53, align 8, !alias.scope !16, !noalias !19
  %i.eo = insertelement <2 x double> poison, double %i.em, i64 0
  %i.ep = insertelement <2 x double> %i.eo, double %i.en, i64 1 ; 3 uses
  %i.eq = getelementptr inbounds nuw i8, ptr %next.gep52, i64 8
  %i.er = getelementptr i8, ptr %i.el, i64 32
  %i.es = load double, ptr %i.eq, align 8, !alias.scope !16, !noalias !19
  %i.et = load double, ptr %i.er, align 8, !alias.scope !16, !noalias !19
  %i.eu = insertelement <2 x double> poison, double %i.es, i64 0
  %i.ev = insertelement <2 x double> %i.eu, double %i.et, i64 1 ; 3 uses
  %i.ew = fmul <2 x double> %broadcast.splat55, %i.ev
  %i.ex = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat57, <2 x double> %i.ep, <2 x double> %i.ew)
  %i.ey = getelementptr inbounds nuw i8, ptr %next.gep52, i64 16
  %i.ez = getelementptr i8, ptr %i.el, i64 40
  %i.fa = load double, ptr %i.ey, align 8, !alias.scope !16, !noalias !19
  %i.fb = load double, ptr %i.ez, align 8, !alias.scope !16, !noalias !19
  %i.fc = insertelement <2 x double> poison, double %i.fa, i64 0
  %i.fd = insertelement <2 x double> %i.fc, double %i.fb, i64 1 ; 3 uses
  %i.fe = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat59, <2 x double> %i.fd, <2 x double> %i.ex)
  %i.ff = fmul <2 x double> %i.ev, %broadcast.splat63
  %i.fg = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat65, <2 x double> %i.ep, <2 x double> %i.ff)
  %i.fh = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat67, <2 x double> %i.fd, <2 x double> %i.fg)
  %i.fi = fmul <2 x double> %i.ev, %broadcast.splat71
  %i.fj = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat73, <2 x double> %i.ep, <2 x double> %i.fi)
  %i.fk = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat75, <2 x double> %i.fd, <2 x double> %i.fj)
  %i.fl = fadd <2 x double> %broadcast.splat77, %i.fk
  %i.fm = shufflevector <2 x double> %i.fe, <2 x double> %i.ef, <4 x i32> <i32 0, i32 1, i32 2, i32 2>
  %i.fn = shufflevector <2 x double> %i.eb, <2 x double> %i.fh, <4 x i32> <i32 0, i32 0, i32 2, i32 3>
  %i.fo = fadd <4 x double> %i.fm, %i.fn
  %i.fp = shufflevector <2 x double> %i.fl, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %interleaved.vec78 = shufflevector <4 x double> %i.fo, <4 x double> %i.fp, <6 x i32> <i32 0, i32 2, i32 4, i32 1, i32 3, i32 5>
  store <6 x double> %interleaved.vec78, ptr %next.gep52, align 8, !alias.scope !16, !noalias !23
  %index.next79 = add nuw i64 %index51, 2         ; 2 uses
  %i.fq = icmp eq i64 %index.next79, %n.vec49
  br i1 %i.fq, label %middle.block80, label %vector.body50, !llvm.loop !24

middle.block80:                                   ; preds = %vector.body50
  %cmp.n81 = icmp eq i64 %i.dq, %n.vec49
...
scalar.ph45.preheader:                            ; preds = %vector.memcheck39, %.lr.ph.i5, %middle.block80
  %.sroa.05.09.i6.ph = phi ptr [ %i.cz, %vector.memcheck39 ], [ %i.cz, %.lr.ph.i5 ], [ %i.dx, %middle.block80 ]
  br label %scalar.ph45

scalar.ph45:                                      ; preds = %scalar.ph45.preheader, %scalar.ph45
  %.sroa.05.09.i6 = phi ptr [ %i.gt, %scalar.ph45 ], [ %.sroa.05.09.i6.ph, %scalar.ph45.preheader ] ; 5 uses
  %i.fr = load double, ptr %.sroa.05.09.i6, align 8, !noalias !25 ; 2 uses
  %i.fs = getelementptr inbounds nuw i8, ptr %.sroa.05.09.i6, i64 8
  %i.ft = load double, ptr %i.fs, align 8, !noalias !25 ; 2 uses
  %i.fu = getelementptr inbounds nuw i8, ptr %.sroa.05.09.i6, i64 16 ; 2 uses
  %i.fv = load double, ptr %i.fu, align 8, !noalias !25 ; 2 uses
  %i.fw = load double, ptr %i.dj, align 8, !noalias !25
  %i.fx = load double, ptr %i.dk, align 8, !noalias !25
  %i.fy = fmul double %i.ft, %i.fx
  %i.fz = tail call double @llvm.fmuladd.f64(double %i.fw, double %i.fr, double %i.fy)
  %i.ga = load double, ptr %i.dl, align 8, !noalias !25
  %i.gb = tail call double @llvm.fmuladd.f64(double %i.ga, double %i.fv, double %i.fz)
  %i.gc = load double, ptr %i.dm, align 8, !noalias !25
  %i.gd = fadd double %i.gc, %i.gb
  %i.ge = load <8 x double>, ptr %1, align 8, !noalias !25 ; 4 uses
  %i.gf = insertelement <2 x double> poison, double %i.ft, i64 0
  %i.gg = shufflevector <2 x double> %i.gf, <2 x double> poison, <2 x i32> zeroinitializer
  %i.gh = shufflevector <8 x double> %i.ge, <8 x double> poison, <2 x i32> <i32 1, i32 5>
  %i.gi = fmul <2 x double> %i.gg, %i.gh
  %i.gj = shufflevector <8 x double> %i.ge, <8 x double> poison, <2 x i32> <i32 0, i32 4>
  %i.gk = insertelement <2 x double> poison, double %i.fr, i64 0
  %i.gl = shufflevector <2 x double> %i.gk, <2 x double> poison, <2 x i32> zeroinitializer
  %i.gm = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.gj, <2 x double> %i.gl, <2 x double> %i.gi)
  %i.gn = shufflevector <8 x double> %i.ge, <8 x double> poison, <2 x i32> <i32 2, i32 6>
  %i.go = insertelement <2 x double> poison, double %i.fv, i64 0
  %i.gp = shufflevector <2 x double> %i.go, <2 x double> poison, <2 x i32> zeroinitializer
  %i.gq = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.gn, <2 x double> %i.gp, <2 x double> %i.gm)
  %i.gr = shufflevector <8 x double> %i.ge, <8 x double> poison, <2 x i32> <i32 3, i32 7>
  %i.gs = fadd <2 x double> %i.gq, %i.gr
  store <2 x double> %i.gs, ptr %.sroa.05.09.i6, align 8
  store double %i.gd, ptr %i.fu, align 8
  %i.gt = getelementptr inbounds nuw i8, ptr %.sroa.05.09.i6, i64 24 ; 2 uses
  %.not.i7 = icmp eq ptr %i.gt, %i.db
  br i1 %.not.i7, label %_ZN6Assimp3IFC8TempMesh9TransformERK12aiMatrix4x4tIdE.exit8, label %scalar.ph45, !llvm.loop !26

_ZN6Assimp3IFC8TempMesh9TransformERK12aiMatrix4x4tIdE.exit8: ; preds = %scalar.ph45, %middle.block80, %bb.c, %_ZN6Assimp3IFC8TempMesh9TransformERK12aiMatrix4x4tIdE.exit
  %i.gu = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.gv = load <2 x double>, ptr %i.gu, align 8
  ...
  %i.ha = load double, ptr %i.gz, align 8
  %i.hb = getelementptr inbounds nuw i8, ptr %1, i64 72
  %i.hc = load double, ptr %i.hb, align 8
  %i.hd = getelementptr inbounds nuw i8, ptr %1, i64 80
  %i.he = load double, ptr %i.hd, align 8
  %i.hf = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
  %i.hg = load double, ptr %i.hf, align 8, !noalias !27 ; 2 uses
  %i.hh = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.hi = load double, ptr %i.hh, align 8, !noalias !27 ; 2 uses
  %i.hj = getelementptr inbounds nuw i8, ptr %0, i64 24 ; 2 uses
  %i.hk = load double, ptr %i.hj, align 8, !noalias !27 ; 2 uses
  %i.hl = fmul double %i.hc, %i.hi
  %i.hm = tail call double @llvm.fmuladd.f64(double %i.ha, double %i.hg, double %i.hl)
  %i.hn = tail call double @llvm.fmuladd.f64(double %i.he, double %i.hk, double %i.hm)
  %i.ho = load <2 x double>, ptr %1, align 8      ; 2 uses
  %i.hp = load <2 x double>, ptr %i.gw, align 8   ; 2 uses
  %i.hq = shufflevector <2 x double> %i.ho, <2 x double> %i.hp, <2 x i32> <i32 1, i32 3>
  ...
  %i.hu = shufflevector <2 x double> %i.ho, <2 x double> %i.hp, <2 x i32> <i32 0, i32 2>
  %i.hv = insertelement <2 x double> poison, double %i.hg, i64 0
  %i.hw = shufflevector <2 x double> %i.hv, <2 x double> poison, <2 x i32> zeroinitializer
  %i.hx = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.hu, <2 x double> %i.hw, <2 x double> %i.ht)
  %i.hy = insertelement <2 x double> %i.gv, double %i.gy, i64 1
  %i.hz = insertelement <2 x double> poison, double %i.hk, i64 0
  %i.ia = shufflevector <2 x double> %i.hz, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ib = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.hy, <2 x double> %i.ia, <2 x double> %i.hx)
  store <2 x double> %i.ib, ptr %i.hf, align 8
  store double %i.hn, ptr %i.hj, align 8
  ret void
}
...
vector.memcheck:                                  ; preds = %.lr.ph
  ...
  %i.u = urem i64 %.fr, 24
  %i.v = sub nuw i64 %.fr, %i.u
  %i.w = getelementptr i8, ptr %i.a, i64 %i.v
  %scevgep = getelementptr i8, ptr %i.w, i64 24
...
vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %i.r, 2305843009213693950      ; 3 uses
  %i.x = mul i64 %n.vec, 24
  %i.y = getelementptr i8, ptr %i.a, i64 %i.x
  %i.z = load <2 x double>, ptr %1, align 8
  %broadcast.splat14 = shufflevector <2 x double> %i.z, <2 x double> poison, <2 x i32> zeroinitializer
  %i.aa = load <2 x double>, ptr %i.d, align 8
  %broadcast.splat = shufflevector <2 x double> %i.aa, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ab = load <2 x double>, ptr %i.e, align 8
  %broadcast.splat16 = shufflevector <2 x double> %i.ab, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ac = load <2 x double>, ptr %i.f, align 8
  %i.ad = load <2 x double>, ptr %i.g, align 8
  %broadcast.splat22 = shufflevector <2 x double> %i.ad, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ae = load <2 x double>, ptr %i.h, align 8
  %broadcast.splat20 = shufflevector <2 x double> %i.ae, <2 x double> poison, <2 x i32> zeroinitializer
  %i.af = load <2 x double>, ptr %i.i, align 8
  %broadcast.splat24 = shufflevector <2 x double> %i.af, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ag = load <2 x double>, ptr %i.j, align 8
  %i.ah = load <2 x double>, ptr %i.k, align 8
  %broadcast.splat30 = shufflevector <2 x double> %i.ah, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ai = load <2 x double>, ptr %i.l, align 8
  %broadcast.splat28 = shufflevector <2 x double> %i.ai, <2 x double> poison, <2 x i32> zeroinitializer
  %i.aj = load <2 x double>, ptr %i.m, align 8
  %broadcast.splat32 = shufflevector <2 x double> %i.aj, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ak = load <2 x double>, ptr %i.n, align 8
  %broadcast.splat34 = shufflevector <2 x double> %i.ak, <2 x double> poison, <2 x i32> zeroinitializer
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.al = mul i64 %index, 24                      ; 2 uses
  %next.gep = getelementptr i8, ptr %i.a, i64 %i.al ; 4 uses
  %i.am = getelementptr i8, ptr %i.a, i64 %i.al   ; 3 uses
  %next.gep12 = getelementptr i8, ptr %i.am, i64 24
  %i.an = load double, ptr %next.gep, align 8, !alias.scope !30, !noalias !33
  %i.ao = load double, ptr %next.gep12, align 8, !alias.scope !30, !noalias !33
  %i.ap = insertelement <2 x double> poison, double %i.an, i64 0
  %i.aq = insertelement <2 x double> %i.ap, double %i.ao, i64 1 ; 3 uses
  ...
  %i.au = load double, ptr %i.as, align 8, !alias.scope !30, !noalias !33
  %i.av = insertelement <2 x double> poison, double %i.at, i64 0
  %i.aw = insertelement <2 x double> %i.av, double %i.au, i64 1 ; 3 uses
  %i.ax = fmul <2 x double> %broadcast.splat, %i.aw
  %i.ay = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat14, <2 x double> %i.aq, <2 x double> %i.ax)
  %i.az = getelementptr inbounds nuw i8, ptr %next.gep, i64 16
  %i.ba = getelementptr i8, ptr %i.am, i64 40
  %i.bb = load double, ptr %i.az, align 8, !alias.scope !30, !noalias !33
  %i.bc = load double, ptr %i.ba, align 8, !alias.scope !30, !noalias !33
  %i.bd = insertelement <2 x double> poison, double %i.bb, i64 0
  %i.be = insertelement <2 x double> %i.bd, double %i.bc, i64 1 ; 3 uses
  %i.bf = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat16, <2 x double> %i.be, <2 x double> %i.ay)
  %i.bg = fmul <2 x double> %i.aw, %broadcast.splat20
  %i.bh = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat22, <2 x double> %i.aq, <2 x double> %i.bg)
  %i.bi = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat24, <2 x double> %i.be, <2 x double> %i.bh)
  %i.bj = fmul <2 x double> %i.aw, %broadcast.splat28
  %i.bk = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat30, <2 x double> %i.aq, <2 x double> %i.bj)
  %i.bl = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat32, <2 x double> %i.be, <2 x double> %i.bk)
  %i.bm = fadd <2 x double> %broadcast.splat34, %i.bl
  %i.bn = shufflevector <2 x double> %i.bf, <2 x double> %i.ag, <4 x i32> <i32 0, i32 1, i32 2, i32 2>
  %i.bo = shufflevector <2 x double> %i.ac, <2 x double> %i.bi, <4 x i32> <i32 0, i32 0, i32 2, i32 3>
  %i.bp = fadd <4 x double> %i.bn, %i.bo
  %i.bq = shufflevector <2 x double> %i.bm, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %interleaved.vec = shufflevector <4 x double> %i.bp, <4 x double> %i.bq, <6 x i32> <i32 0, i32 2, i32 4, i32 1, i32 3, i32 5>
  store <6 x double> %interleaved.vec, ptr %next.gep, align 8, !alias.scope !30, !noalias !37
  %index.next = add nuw i64 %index, 2             ; 2 uses
  %i.br = icmp eq i64 %index.next, %n.vec
  br i1 %i.br, label %middle.block, label %vector.body, !llvm.loop !38
...
scalar.ph.preheader:                              ; preds = %vector.memcheck, %.lr.ph, %middle.block
  %.sroa.05.09.ph = phi ptr [ %i.a, %vector.memcheck ], [ %i.a, %.lr.ph ], [ %i.y, %middle.block ]
  br label %scalar.ph
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %.sroa.05.09 = phi ptr [ %i.cu, %scalar.ph ], [ %.sroa.05.09.ph, %scalar.ph.preheader ] ; 5 uses
  %i.bs = load double, ptr %.sroa.05.09, align 8, !noalias !39 ; 2 uses
  %i.bt = getelementptr inbounds nuw i8, ptr %.sroa.05.09, i64 8
  %i.bu = load double, ptr %i.bt, align 8, !noalias !39 ; 2 uses
  %i.bv = getelementptr inbounds nuw i8, ptr %.sroa.05.09, i64 16 ; 2 uses
  %i.bw = load double, ptr %i.bv, align 8, !noalias !39 ; 2 uses
  %i.bx = load double, ptr %i.k, align 8, !noalias !39
  %i.by = load double, ptr %i.l, align 8, !noalias !39
  %i.bz = fmul double %i.bu, %i.by
  %i.ca = tail call double @llvm.fmuladd.f64(double %i.bx, double %i.bs, double %i.bz)
  %i.cb = load double, ptr %i.m, align 8, !noalias !39
  %i.cc = tail call double @llvm.fmuladd.f64(double %i.cb, double %i.bw, double %i.ca)
  %i.cd = load double, ptr %i.n, align 8, !noalias !39
  %i.ce = fadd double %i.cd, %i.cc
  %i.cf = load <8 x double>, ptr %1, align 8, !noalias !39 ; 4 uses
  ...
  %i.ci = shufflevector <8 x double> %i.cf, <8 x double> poison, <2 x i32> <i32 1, i32 5>
  %i.cj = fmul <2 x double> %i.ch, %i.ci
  %i.ck = shufflevector <8 x double> %i.cf, <8 x double> poison, <2 x i32> <i32 0, i32 4>
  %i.cl = insertelement <2 x double> poison, double %i.bs, i64 0
  %i.cm = shufflevector <2 x double> %i.cl, <2 x double> poison, <2 x i32> zeroinitializer
  %i.cn = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ck, <2 x double> %i.cm, <2 x double> %i.cj)
  %i.co = shufflevector <8 x double> %i.cf, <8 x double> poison, <2 x i32> <i32 2, i32 6>
  %i.cp = insertelement <2 x double> poison, double %i.bw, i64 0
  %i.cq = shufflevector <2 x double> %i.cp, <2 x double> poison, <2 x i32> zeroinitializer
  %i.cr = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.co, <2 x double> %i.cq, <2 x double> %i.cn)
  %i.cs = shufflevector <8 x double> %i.cf, <8 x double> poison, <2 x i32> <i32 3, i32 7>
  %i.ct = fadd <2 x double> %i.cr, %i.cs
  store <2 x double> %i.ct, ptr %.sroa.05.09, align 8
  store double %i.ce, ptr %i.bv, align 8
  %i.cu = getelementptr inbounds nuw i8, ptr %.sroa.05.09, i64 24 ; 2 uses
  %.not = icmp eq ptr %i.cu, %i.c
  br i1 %.not, label %._crit_edge, label %scalar.ph, !llvm.loop !40
}
...
define hidden noundef ptr @_ZN6Assimp3IFC8TempMesh6ToMeshEv(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(48) %0) local_unnamed_addr #2 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.e = tail call noalias noundef nonnull dereferenceable(1320) ptr @_Znwm(i64 noundef 1320) #26 ; 11 uses
  ...
  %i.j = getelementptr inbounds nuw i8, ptr %i.e, i64 1272
  %i.k = getelementptr inbounds nuw i8, ptr %i.e, i64 1312
  store ptr null, ptr %i.k, align 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(204) %i.h, i8 0, i64 204, i1 false)
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1044) %i.i, i8 0, i64 1044, i1 false)
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(36) %i.j, i8 0, i64 36, i1 false)
  ...
  store i32 %i.p, ptr %i.f, align 4
  %i.q = and i64 %i.o, 4294967295
  %i.r = mul nuw nsw i64 %i.q, 12                 ; 2 uses
  %i.s = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %i.r) #26
          to label %bb.c unwind label %bb.f       ; 3 uses

bb.c:                                             ; preds = %bb.b
  %i.t = icmp eq i32 %i.p, 0
  br i1 %i.t, label %.loopexit29, label %.loopexit29.loopexit

.loopexit29.loopexit:                             ; preds = %bb.c
...
.loopexit29:                                      ; preds = %.loopexit29.loopexit, %bb.c
  store ptr %i.s, ptr %i.h, align 8
  %i.y = icmp sgt i64 %i.n, 0
  br i1 %i.y, label %.lr.ph.preheader.i.i.i.i.i, label %_ZSt4copyIN9__gnu_cxx17__normal_iteratorIP10aiVector3tIdESt6vectorIS3_SaIS3_EEEEPS2_IfEET0_T_SC_SB_.exit

.lr.ph.preheader.i.i.i.i.i:                       ; preds = %.loopexit29
end_hunk_0
begin_hunk_1_@_ZN6Assimp3IFC8TempMesh17RemoveDegeneratesEv:bb.a
.lr.ph:                                           ; preds = %bb.b
...
._crit_edge:                                      ; preds = %_ZNSt6vectorI10aiVector3tIdESaIS1_EE5eraseEN9__gnu_cxx17__normal_iteratorIPKS1_S3_EES8_.exit
  br i1 %.112, label %bb.p, label %_ZN6Assimp12LogFunctionsINS_11IFCImporterEE15LogVerboseDebugIJRA26_KcEEEvDpOT_.exit.thread

bb.c:                                             ; preds = %.lr.ph, %_ZNSt6vectorI10aiVector3tIdESaIS1_EE5eraseEN9__gnu_cxx17__normal_iteratorIPKS1_S3_EES8_.exit
  %i.h = phi ptr [ %i.e, %.lr.ph ], [ %i.be, %_ZNSt6vectorI10aiVector3tIdESaIS1_EE5eraseEN9__gnu_cxx17__normal_iteratorIPKS1_S3_EES8_.exit ] ; 2 uses
  %.01139 = phi i1 [ false, %.lr.ph ], [ %.112, %_ZNSt6vectorI10aiVector3tIdESaIS1_EE5eraseEN9__gnu_cxx17__normal_iteratorIPKS1_S3_EES8_.exit ]
  %.01338 = phi i64 [ 0, %.lr.ph ], [ %i.bd, %_ZNSt6vectorI10aiVector3tIdESaIS1_EE5eraseEN9__gnu_cxx17__normal_iteratorIPKS1_S3_EES8_.exit ] ; 2 uses
  %.sroa.032.037 = phi ptr [ %i.f, %.lr.ph ], [ %.sroa.032.1, %_ZNSt6vectorI10aiVector3tIdESaIS1_EE5eraseEN9__gnu_cxx17__normal_iteratorIPKS1_S3_EES8_.exit ] ; 3 uses
  %.sroa.028.036 = phi ptr [ %i.c, %.lr.ph ], [ %.sroa.028.1, %_ZNSt6vectorI10aiVector3tIdESaIS1_EE5eraseEN9__gnu_cxx17__normal_iteratorIPKS1_S3_EES8_.exit ] ; 3 uses
  %i.i = load i32, ptr %.sroa.028.036, align 4    ; 3 uses
  %i.j = getelementptr inbounds nuw [24 x i8], ptr %.pre40, i64 %.01338 ; 3 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  br i1 %i.ac, label %bb.f, label %bb.g, !prof !58
...
bb.k:                                             ; preds = %bb.j
  ...
  br i1 %i.au, label %bb.l, label %bb.m, !prof !58
...
_ZNSt6vectorI10aiVector3tIdESaIS1_EE5eraseEN9__gnu_cxx17__normal_iteratorIPKS1_S3_EES8_.exit: ; preds = %bb.i, %_ZSt4moveIN9__gnu_cxx17__normal_iteratorIP10aiVector3tIdESt6vectorIS3_SaIS3_EEEES8_ET0_T_SA_S9_.exit.i.i, %_ZSt8_DestroyIP10aiVector3tIdES1_EvT_S3_RSaIT0_E.exit.i.i.i, %bb.o
  ...
  %.112 = phi i1 [ %.01139, %bb.o ], [ true, %_ZSt8_DestroyIP10aiVector3tIdES1_EvT_S3_RSaIT0_E.exit.i.i.i ], [ true, %_ZSt4moveIN9__gnu_cxx17__normal_iteratorIP10aiVector3tIdESt6vectorIS3_SaIS3_EEEES8_ET0_T_SA_S9_.exit.i.i ], [ true, %bb.i ] ; 2 uses
  %i.bd = add i64 %.01338, 1
  %i.be = load ptr, ptr %i.d, align 8             ; 2 uses
  %.not = icmp eq ptr %.sroa.028.1, %i.be
  br i1 %.not, label %._crit_edge, label %bb.c, !llvm.loop !59
...
bb.s:                                             ; preds = %.thread, %bb.r
  %.pn.pn.pn54 = phi { ptr, i32 } [ %i.bi, %.thread ], [ %i.bo, %bb.r ]
...
_ZNSt6vectorI10aiVector3tIdESaIS1_EED2Ev.exit23:  ; preds = %bb.r, %bb.s
  %.pn.pn.pn55 = phi { ptr, i32 } [ %i.bo, %bb.r ], [ %.pn.pn.pn54, %bb.s ]
  call void @llvm.lifetime.end.p0(ptr nonnull %1) #25
...
bb.a:
  ...
  %i.e = load ptr, ptr %i.d, align 8              ; 4 uses
  %.not94103 = icmp eq ptr %i.c, %i.e             ; 2 uses
  br i1 %.not94103, label %_ZNSt6vectorIdSaIdEE17_S_check_init_lenEmRKS0_.exit.i, label %.lr.ph

.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  %.0105 = phi i64 [ %.sroa.speculated, %.lr.ph ], [ 0, %bb.a ]
  %.sroa.080.0104 = phi ptr [ %i.h, %.lr.ph ], [ %i.c, %bb.a ] ; 2 uses
  %i.f = load i32, ptr %.sroa.080.0104, align 4
  %i.g = zext i32 %i.f to i64
  %.sroa.speculated = tail call i64 @llvm.umax.i64(i64 %.0105, i64 %i.g) ; 2 uses
  %i.h = getelementptr inbounds nuw i8, ptr %.sroa.080.0104, i64 4 ; 2 uses
  %.not94 = icmp eq ptr %i.h, %i.e
  br i1 %.not94, label %_ZNSt6vectorIdSaIdEE17_S_check_init_lenEmRKS0_.exit.i, label %.lr.ph, !llvm.loop !60
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi159 = phi <4 x i32> [ zeroinitializer, %vector.ph ], [ %i.az, %vector.body ]
  ...
  %wide.load160 = load <4 x i32>, ptr %i.ax, align 4
  %i.ay = add <4 x i32> %wide.load, %vec.phi      ; 2 uses
  %i.az = add <4 x i32> %wide.load160, %vec.phi159 ; 2 uses
...
.lr.ph.i.preheader164:                            ; preds = %.lr.ph.i.preheader, %middle.block
  %.07.i.ph = phi i32 [ 0, %.lr.ph.i.preheader ], [ %i.bb, %middle.block ]
  %.sroa.02.06.i.ph = phi ptr [ %i.an, %.lr.ph.i.preheader ], [ %i.av, %middle.block ]
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader164, %.lr.ph.i
  %.07.i = phi i32 [ %i.bd, %.lr.ph.i ], [ %.07.i.ph, %.lr.ph.i.preheader164 ]
  %.sroa.02.06.i = phi ptr [ %i.be, %.lr.ph.i ], [ %.sroa.02.06.i.ph, %.lr.ph.i.preheader164 ] ; 2 uses
  %i.bc = load i32, ptr %.sroa.02.06.i, align 4
  %i.bd = add i32 %i.bc, %.07.i                   ; 2 uses
  %i.be = getelementptr inbounds nuw i8, ptr %.sroa.02.06.i, i64 4 ; 2 uses
  %.not.i = icmp eq ptr %i.be, %i.c
...
_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPKjSt6vectorIjSaIjEEEEiET0_T_S9_S8_.exit.loopexit: ; preds = %.lr.ph.i, %middle.block
  %.lcssa158 = phi i32 [ %i.bb, %middle.block ], [ %i.bd, %.lr.ph.i ]
  %i.bf = sext i32 %.lcssa158 to i64
...
_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPKjSt6vectorIjSaIjEEEEiET0_T_S9_S8_.exit: ; preds = %_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPKjSt6vectorIjSaIjEEEEiET0_T_S9_S8_.exit.loopexit, %_ZNSt6vectorI10aiVector3tIdESaIS1_EE7reserveEm.exit
  %.0.lcssa.i = phi i64 [ 0, %_ZNSt6vectorI10aiVector3tIdESaIS1_EE7reserveEm.exit ], [ %i.bf, %_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPKjSt6vectorIjSaIjEEEEiET0_T_S9_S8_.exit.loopexit ]
...
.lr.ph113:                                        ; preds = %_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPKjSt6vectorIjSaIjEEEEiET0_T_S9_S8_.exit
  %i.bg = getelementptr inbounds nuw i8, ptr %i.k, i64 16 ; 4 uses
  %i.bh = getelementptr inbounds nuw i8, ptr %i.k, i64 32 ; 2 uses
  %i.bi = getelementptr inbounds nuw i8, ptr %i.k, i64 40
  %i.bj = getelementptr inbounds nuw i8, ptr %i.k, i64 48
  %i.bk = getelementptr inbounds nuw i8, ptr %i.k, i64 80
  %i.bl = getelementptr inbounds nuw i8, ptr %i.k, i64 72
  %i.bm = getelementptr inbounds nuw i8, ptr %i.k, i64 64
  br label %bb.e

bb.e:                                             ; preds = %.lr.ph113, %_ZNSt6vectorI10aiVector3tIdESaIS1_EE12emplace_backIJEEERS1_DpOT_.exit
  %.032111 = phi i64 [ %.0.lcssa.i, %.lr.ph113 ], [ %i.gi, %_ZNSt6vectorI10aiVector3tIdESaIS1_EE12emplace_backIJEEERS1_DpOT_.exit ] ; 2 uses
  %.sroa.080.1110 = phi ptr [ %i.c, %.lr.ph113 ], [ %i.gf, %_ZNSt6vectorI10aiVector3tIdESaIS1_EE12emplace_backIJEEERS1_DpOT_.exit ] ; 4 uses
  %i.bn = load i32, ptr %.sroa.080.1110, align 4  ; 4 uses
  %.not = icmp eq i32 %i.bn, 0
  br i1 %.not, label %bb.f, label %.lr.ph108

.lr.ph108:                                        ; preds = %bb.e
  %i.bo = load ptr, ptr %0, align 8
  %i.bp = getelementptr [24 x i8], ptr %i.bo, i64 %.032111 ; 3 uses
  %i.bq = zext i32 %i.bn to i64                   ; 2 uses
  %xtraiter = and i64 %i.bq, 1
  %i.br = icmp eq i32 %i.bn, 1
  br i1 %i.br, label %.epil.preheader, label %.lr.ph108.new

.lr.ph108.new:                                    ; preds = %.lr.ph108
  %unroll_iter = and i64 %i.bq, 4294967294
  br label %bb.n

bb.f:                                             ; preds = %bb.e
  %i.bs = load ptr, ptr %i.n, align 8             ; 5 uses
  %i.bt = load ptr, ptr %i.ab, align 8
...
_ZNKSt6vectorI10aiVector3tIdESaIS1_EE12_M_check_lenEmPKc.exit.i.i: ; preds = %bb.h
  %i.cb = sdiv exact i64 %i.bz, 24                ; 3 uses
  ...
  %i.ce = tail call i64 @llvm.umin.i64(i64 %i.cc, i64 384307168202282325)
  %i.cf = select i1 %i.cd, i64 384307168202282325, i64 %i.ce ; 3 uses
  %.not.i.i.i = icmp ne i64 %i.cf, 0
  tail call void @llvm.assume(i1 %.not.i.i.i)
  %i.cg = mul nuw nsw i64 %i.cf, 24
  %i.ch = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.cg) #26
...
.noexc44:                                         ; preds = %_ZNKSt6vectorI10aiVector3tIdESaIS1_EE12_M_check_lenEmPKc.exit.i.i
  ...
  %.not10.i.i.i.i.i = icmp eq ptr %i.bw, %i.bs
...
.lr.ph.i.i.i.i.i:                                 ; preds = %.noexc44, %.lr.ph.i.i.i.i.i
  %.012.i.i.i.i.i = phi ptr [ %i.ck, %.lr.ph.i.i.i.i.i ], [ %i.ch, %.noexc44 ] ; 2 uses
  %.0911.i.i.i.i.i = phi ptr [ %i.cj, %.lr.ph.i.i.i.i.i ], [ %i.bw, %.noexc44 ] ; 2 uses
  ...
  %i.cj = getelementptr inbounds nuw i8, ptr %.0911.i.i.i.i.i, i64 24 ; 2 uses
  %i.ck = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i.i, i64 24 ; 2 uses
  %.not.i.i.i.i.i = icmp eq ptr %i.cj, %i.bs
...
_ZNSt6vectorI10aiVector3tIdESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit21.i.i: ; preds = %.lr.ph.i.i.i.i.i, %.noexc44
  %.0.lcssa.i.i.i.i.i = phi ptr [ %i.ch, %.noexc44 ], [ %i.ck, %.lr.ph.i.i.i.i.i ]
  %i.cl = getelementptr inbounds nuw i8, ptr %.0.lcssa.i.i.i.i.i, i64 24
  %.not.i22.i.i = icmp eq ptr %i.bw, null
...
bb.i:                                             ; preds = %_ZNSt6vectorI10aiVector3tIdESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit21.i.i
  tail call void @_ZdlPvm(ptr noundef nonnull %i.bw, i64 noundef %i.bz) #27
...
_ZNSt6vectorI10aiVector3tIdESaIS1_EE17_M_realloc_insertIJEEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i: ; preds = %bb.i, %_ZNSt6vectorI10aiVector3tIdESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit21.i.i
  store ptr %i.ch, ptr %1, align 8
  store ptr %i.cl, ptr %i.n, align 8
  %i.cm = getelementptr inbounds nuw [24 x i8], ptr %i.ch, i64 %i.cf
  store ptr %i.cm, ptr %i.ab, align 8
  br label %_ZNSt6vectorI10aiVector3tIdESaIS1_EE12emplace_backIJEEERS1_DpOT_.exit
...
.epil.preheader:                                  ; preds = %._crit_edge.unr-lcssa, %.lr.ph108
  %.033107.epil.init = phi i64 [ 0, %.lr.ph108 ], [ %i.em, %._crit_edge.unr-lcssa ]
  %.034106.epil.init = phi i64 [ 0, %.lr.ph108 ], [ %i.en, %._crit_edge.unr-lcssa ]
  %lcmp.mod168 = trunc i32 %i.bn to i1
  tail call void @llvm.assume(i1 %lcmp.mod168)
  %i.co = getelementptr [24 x i8], ptr %i.bp, i64 %.034106.epil.init ; 3 uses
  %i.cp = load double, ptr %i.co, align 8
  %i.cq = getelementptr inbounds nuw [8 x i8], ptr %i.k, i64 %.033107.epil.init ; 3 uses
...
._crit_edge:                                      ; preds = %._crit_edge.unr-lcssa, %.epil.preheader
  %i.cx = load ptr, ptr %i.n, align 8             ; 5 uses
  %i.cy = load ptr, ptr %i.ab, align 8
end_hunk_1
