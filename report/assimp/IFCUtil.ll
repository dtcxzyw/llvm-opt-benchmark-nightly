...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %2 = mul i64 %n.vec, 24
  %3 = getelementptr i8, ptr %i.c, i64 %2
  ...
  %i.af = load <2 x double>, ptr %i.k, align 8
...
begin_hunk_1_@_ZN6Assimp3IFC11TempOpening9TransformERK12aiMatrix4x4tIdE:bb.a
  ...
  %i.ay = fmul <2 x double> %broadcast.splat32.a, %i.ax
  %i.az = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat36.a, <2 x double> %i.ar, <2 x double> %i.ay)
  ...
  %i.bg = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat34.a, <2 x double> %i.bf, <2 x double> %i.az)
  %i.bh = fmul <2 x double> %i.ax, %broadcast.splat24
  %i.bi = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat28.a, <2 x double> %i.ar, <2 x double> %i.bh)
  %i.bj = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat26, <2 x double> %i.bf, <2 x double> %i.bi)
  %i.bk = fmul <2 x double> %i.ax, %broadcast.splat
  %i.bl = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat20, <2 x double> %i.ar, <2 x double> %i.bk)
  %i.bm = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat18, <2 x double> %i.bf, <2 x double> %i.bl)
  %i.bn = fadd <2 x double> %broadcast.splat38, %i.bm
  %i.bo = shufflevector <2 x double> %i.bg, <2 x double> %i.ai, <4 x i32> <i32 0, i32 1, i32 2, i32 2>
  %i.bp = shufflevector <2 x double> %i.ae, <2 x double> %i.bj, <4 x i32> <i32 0, i32 0, i32 2, i32 3>
...
scalar.ph.preheader:                              ; preds = %vector.memcheck, %.lr.ph.i, %middle.block
  %.sroa.05.09.i.ph = phi ptr [ %i.c, %vector.memcheck ], [ %i.c, %.lr.ph.i ], [ %3, %middle.block ]
  br label %scalar.ph
...
begin_hunk_4_@_ZN6Assimp3IFC11TempOpening9TransformERK12aiMatrix4x4tIdE:bb.a
  ...
  %i.ev = fmul <2 x double> %broadcast.splat71.a, %i.eu
  %i.ew = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat75.a, <2 x double> %i.eo, <2 x double> %i.ev)
  ...
  %i.fd = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat73.a, <2 x double> %i.fc, <2 x double> %i.ew)
  %i.fe = fmul <2 x double> %i.eu, %broadcast.splat63
  %i.ff = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat67.a, <2 x double> %i.eo, <2 x double> %i.fe)
  %i.fg = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat65, <2 x double> %i.fc, <2 x double> %i.ff)
  %i.fh = fmul <2 x double> %i.eu, %broadcast.splat55
  %i.fi = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat59, <2 x double> %i.eo, <2 x double> %i.fh)
  %i.fj = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat57, <2 x double> %i.fc, <2 x double> %i.fi)
  %i.fk = fadd <2 x double> %broadcast.splat77, %i.fj
  %i.fl = shufflevector <2 x double> %i.fd, <2 x double> %i.ef, <4 x i32> <i32 0, i32 1, i32 2, i32 2>
  %i.fm = shufflevector <2 x double> %i.eb, <2 x double> %i.fg, <4 x i32> <i32 0, i32 0, i32 2, i32 3>
...
scalar.ph45.preheader:                            ; preds = %vector.memcheck39, %.lr.ph.i5, %middle.block80
  %.sroa.05.09.i6.ph = phi ptr [ %i.cz, %vector.memcheck39 ], [ %i.cz, %.lr.ph.i5 ], [ %6, %middle.block80 ]
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %4 = load <2 x double>, ptr %i.p, align 8
  %broadcast.splat34 = shufflevector <2 x double> %4, <2 x double> poison, <2 x i32> zeroinitializer
  br label %vector.body
...
begin_hunk_7_@_ZN6Assimp3IFC8TempMesh9TransformERK12aiMatrix4x4tIdE:bb.a
  ...
  %i.aw = fmul <2 x double> %broadcast.splat28.a, %i.av
  %i.ax = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat32.a, <2 x double> %i.ap, <2 x double> %i.aw)
  ...
  %i.be = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat30.a, <2 x double> %i.bd, <2 x double> %i.ax)
  %i.bf = fmul <2 x double> %i.av, %broadcast.splat20
  %i.bg = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat24.a, <2 x double> %i.ap, <2 x double> %i.bf)
  %i.bh = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat22, <2 x double> %i.bd, <2 x double> %i.bg)
  %i.bi = fmul <2 x double> %i.av, %broadcast.splat
  %i.bj = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat16, <2 x double> %i.ap, <2 x double> %i.bi)
  %i.bk = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat14, <2 x double> %i.bd, <2 x double> %i.bj)
  %i.bl = fadd <2 x double> %broadcast.splat34, %i.bk
  %i.bm = shufflevector <2 x double> %i.be, <2 x double> %i.ag, <4 x i32> <i32 0, i32 1, i32 2, i32 2>
  %i.bn = shufflevector <2 x double> %i.ac, <2 x double> %i.bh, <4 x i32> <i32 0, i32 0, i32 2, i32 3>
...
scalar.ph.preheader:                              ; preds = %vector.memcheck, %.lr.ph, %middle.block
  %.sroa.05.09.ph = phi ptr [ %i.a, %vector.memcheck ], [ %i.a, %.lr.ph ], [ %3, %middle.block ]
  br label %scalar.ph
