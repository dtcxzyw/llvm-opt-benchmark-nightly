...
bb.c:                                             ; preds = %_ZN6Assimp3IFC8TempMesh9TransformERK12aiMatrix4x4tIdE.exit
  %i.cz = load ptr, ptr %i.cy, align 8            ; 9 uses
  %4 = ptrtoaddr ptr %i.cz to i64                 ; 2 uses
  %i.da = getelementptr inbounds nuw i8, ptr %i.cy, i64 8
  %i.db = load ptr, ptr %i.da, align 8            ; 3 uses
  %5 = ptrtoaddr ptr %i.db to i64                 ; 2 uses
...
.lr.ph.i.preheader:                               ; preds = %_ZNSt6vectorI10aiVector3tIdESaIS1_EE7reserveEm.exit
  ...
  br i1 %min.iters.check, label %.lr.ph.i.preheader165, label %vector.ph
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPKjSt6vectorIjSaIjEEEEiET0_T_S9_S8_.exit.loopexit, label %.lr.ph.i.preheader165
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader165, %.lr.ph.i
  %.07.i = phi i32 [ %i.bd, %.lr.ph.i ], [ %.07.i.ph, %.lr.ph.i.preheader165 ]
  %.sroa.02.06.i = phi ptr [ %i.be, %.lr.ph.i ], [ %.sroa.02.06.i.ph, %.lr.ph.i.preheader165 ] ; 2 uses
...
.epil.preheader:                                  ; preds = %._crit_edge.unr-lcssa, %.lr.ph108
  ...
  %lcmp.mod169 = trunc i32 %i.bn to i1
