Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/assimp/original/FBXMeshGeometry?download=true
inline.NumInlined: 1884
...
begin_hunk_0_@_ZN6Assimp3FBX22ResolveVertexDataArrayI10aiVector3tIfEEEvRSt6vectorIT_SaIS5_EERKNS0_5ScopeERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESJ_PKcSL_mRKS4_IjSaIjEESP_SP_:bb.a
  ...
  %i.qp = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %5) #24 ; 4 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i313: ; preds = %bb.dt
  ...
  %i.rd = add i64 %i.rc, 1
  call void @_ZdlPvm(ptr noundef %i.ra, i64 noundef %i.rd) #25
...
bb.dv:                                            ; preds = %bb.du
  call void @llvm.lifetime.end.p0(ptr nonnull %i.w) #24
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i316: ; preds = %bb.dx
  ...
  %i.rt = add i64 %i.rs, 1
  call void @_ZdlPvm(ptr noundef %i.rq, i64 noundef %i.rt) #25
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit318
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i319: ; preds = %bb.dz
  ...
  %i.rz = add i64 %i.ry, 1
  call void @_ZdlPvm(ptr noundef %i.rw, i64 noundef %i.rz) #25
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit321
...
bb.ee:                                            ; preds = %bb.ed
  call void @llvm.lifetime.end.p0(ptr nonnull %i.x) #24
...
bb.ei:                                            ; preds = %.lr.ph, %bb.eu
  %.0370 = phi i32 [ 0, %.lr.ph ], [ %.1, %bb.eu ] ; 3 uses
...
bb.eo:                                            ; preds = %bb.en
  invoke void @_ZN6Assimp3FBX4Util8DOMErrorERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPKNS0_7ElementE(ptr noundef nonnull align 8 dereferenceable(32) %28, ptr noundef nonnull %i.st) #26
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i322: ; preds = %bb.es
  ...
  %i.tb = add i64 %i.ta, 1
  call void @_ZdlPvm(ptr noundef %i.sx, i64 noundef %i.tb) #25
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit324
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i325: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit324
  ...
  %i.tg = add i64 %i.tf, 1
  call void @_ZdlPvm(ptr noundef %i.tc, i64 noundef %i.tg) #25
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit327
...
bb.ev:                                            ; preds = %.loopexit367
  ...
  call void @_ZdlPvm(ptr noundef nonnull %i.tm, i64 noundef %i.tr) #25
...
bb.ew:                                            ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit329
  ...
  call void @_ZdlPvm(ptr noundef nonnull %i.ts, i64 noundef %i.tx) #25
...
bb.ey:                                            ; preds = %bb.ex
  ...
  call void @_ZdlPvm(ptr noundef nonnull %i.ty, i64 noundef %i.ud) #25
...
bb.fa:                                            ; preds = %bb.ez
  ...
  call void @_ZdlPvm(ptr noundef nonnull %i.ue, i64 noundef %i.uj) #25
...
bb.fc:                                            ; preds = %.critedge
  ...
  call void @_ZdlPvm(ptr noundef nonnull %.pre398, i64 noundef %i.ur) #25
