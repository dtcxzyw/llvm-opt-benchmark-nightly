...
_ZN6Assimp14StackAllocator8AllocateEm.exit:       ; preds = %bb.ap, %_ZNSt6vectorIPhSaIS0_EE17_M_realloc_insertIJRS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i.i, %bb.au
  %storemerge.i = phi i64 [ %i.di, %bb.au ], [ 40, %bb.ap ], [ 40, %_ZNSt6vectorIPhSaIS0_EE17_M_realloc_insertIJRS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i.i ]
  %.0.i186 = phi ptr [ %i.ep, %bb.au ], [ %i.dn, %bb.ap ], [ %i.dn, %_ZNSt6vectorIPhSaIS0_EE17_M_realloc_insertIJRS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i.i ] ; 7 uses
...
_ZN6Assimp14StackAllocator8AllocateEm.exit210:    ; preds = %bb.df, %_ZNSt6vectorIPhSaIS0_EE17_M_realloc_insertIJRS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i.i209, %bb.dk
  %storemerge.i200 = phi i64 [ %i.lj, %bb.dk ], [ 40, %bb.df ], [ 40, %_ZNSt6vectorIPhSaIS0_EE17_M_realloc_insertIJRS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i.i209 ]
  %.0.i201 = phi ptr [ %i.mm, %bb.dk ], [ %i.lo, %bb.df ], [ %i.lo, %_ZNSt6vectorIPhSaIS0_EE17_M_realloc_insertIJRS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i.i209 ] ; 7 uses
...
_ZN6Assimp14StackAllocator8AllocateEm.exit230:    ; preds = %bb.ds, %_ZNSt6vectorIPhSaIS0_EE17_M_realloc_insertIJRS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i.i229, %bb.dx
  %storemerge.i220 = phi i64 [ %i.nq, %bb.dx ], [ 40, %bb.ds ], [ 40, %_ZNSt6vectorIPhSaIS0_EE17_M_realloc_insertIJRS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i.i229 ]
  %.0.i221 = phi ptr [ %i.ot, %bb.dx ], [ %i.nv, %bb.ds ], [ %i.nv, %_ZNSt6vectorIPhSaIS0_EE17_M_realloc_insertIJRS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i.i229 ] ; 7 uses
...
_ZN6Assimp14StackAllocator8AllocateEm.exit258:    ; preds = %bb.er, %_ZNSt6vectorIPhSaIS0_EE17_M_realloc_insertIJRS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i.i257, %bb.ew
  %storemerge.i248 = phi i64 [ %i.qx, %bb.ew ], [ 40, %bb.er ], [ 40, %_ZNSt6vectorIPhSaIS0_EE17_M_realloc_insertIJRS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i.i257 ]
  %.0.i249 = phi ptr [ %i.se, %bb.ew ], [ %i.rc, %bb.er ], [ %i.rc, %_ZNSt6vectorIPhSaIS0_EE17_M_realloc_insertIJRS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i.i257 ] ; 7 uses
...
_ZN6Assimp14StackAllocator8AllocateEm.exit279:    ; preds = %bb.fe, %_ZNSt6vectorIPhSaIS0_EE17_M_realloc_insertIJRS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i.i278, %bb.fj
  %storemerge.i269 = phi i64 [ %i.tx, %bb.fj ], [ 40, %bb.fe ], [ 40, %_ZNSt6vectorIPhSaIS0_EE17_M_realloc_insertIJRS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i.i278 ]
  %.0.i270 = phi ptr [ %i.ve, %bb.fj ], [ %i.uc, %bb.fe ], [ %i.uc, %_ZNSt6vectorIPhSaIS0_EE17_M_realloc_insertIJRS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i.i278 ] ; 7 uses
