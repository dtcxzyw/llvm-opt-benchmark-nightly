...
begin_hunk_0_@_ZN6Assimp12PbrtExporter20WriteWorldDefinitionEv:bb.a
  ...
  %2 = alloca %"class.std::function", align 16    ; 13 uses
...
begin_hunk_1_@_ZN6Assimp12PbrtExporter20WriteWorldDefinitionEv:bb.a
  ...
  store ptr @"_ZNSt17_Function_handlerIFvP6aiNodeEZN6Assimp12PbrtExporter20WriteWorldDefinitionEvE3$_0E10_M_managerERSt9_Any_dataRKS7_St18_Manager_operation", ptr %i.h, align 16
...
bb.b:                                             ; preds = %.noexc, %.lr.ph.i.i.i.i
  ...
  %i.r = load ptr, ptr %2, align 16, !nonnull !52, !align !63
...
bb.c:                                             ; preds = %.noexc66, %.lr.ph13.i.i.i.i
  ...
  %i.ab = load ptr, ptr %6, align 8, !nonnull !52, !align !63 ; 3 uses
...
bb.o:                                             ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit37
  %i.bv = load ptr, ptr %i.h, align 16            ; 2 uses
...
.loopexit.split-lp:                               ; preds = %.loopexit, %.loopexit.split-lp.loopexit.split-lp, %.loopexit.split-lp.loopexit, %bb.h, %bb.m
  ...
  %i.cc = load ptr, ptr %i.h, align 16            ; 2 uses
