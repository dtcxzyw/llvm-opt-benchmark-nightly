...
bb.j:                                             ; preds = %bb.i, %bb.h
  ...
  %i.cg = load <2 x float>, ptr %2, align 8       ; 2 uses
  %i.ch = load float, ptr %i.bk, align 4          ; 3 uses
  %i.ci = load <2 x float>, ptr %i.bp, align 8    ; 2 uses
  %i.cj = load float, ptr %i.bq, align 4          ; 3 uses
  ...
  %i.en = load float, ptr %i.ce, align 4          ; 3 uses
  %i.eo = load float, ptr %i.cd, align 4          ; 2 uses
  %i.ep = load float, ptr %i.cf, align 4          ; 2 uses
  %3 = fmul float %i.cj, %i.en
  %4 = fmul float %i.ch, %i.en
  %5 = shufflevector <2 x float> %i.cg, <2 x float> %i.ci, <2 x i32> <i32 0, i32 2>
  %6 = insertelement <2 x float> poison, float %i.eo, i64 0
  %7 = shufflevector <2 x float> %6, <2 x float> poison, <2 x i32> zeroinitializer
  %i.eq = insertelement <2 x float> poison, float %4, i64 0
  %8 = insertelement <2 x float> %i.eq, float %3, i64 1
  %i.er = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %5, <2 x float> %7, <2 x float> %8)
