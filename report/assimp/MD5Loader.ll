...
_ZN6Assimp3MD517ConvertQuaternionERK10aiVector3tIfER13aiQuaterniontIfE.exit: ; preds = %bb.j, %bb.k
  ...
  %8 = insertelement <4 x float> %i.cu, float %6, i64 0
  ...
  %9 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.cq, <4 x float> %8, <4 x float> %i.cw)
  %10 = fmul <4 x float> %9, <float 1.000000e+00, float 2.000000e+00, float 2.000000e+00, float 0.000000e+00>
  store <4 x float> %10, ptr %i.co, align 4
  ...
  %i.db = insertelement <4 x float> <float poison, float 1.000000e+00, float poison, float 1.000000e+00>, float %i.cj, i64 0
  %i.dc = insertelement <4 x float> %i.db, float %i.ck, i64 2
  %i.dd = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.cz, <4 x float> %i.da, <4 x float> %i.dc)
  %i.de = fmul <4 x float> %i.dd, <float 2.000000e+00, float 1.000000e+00, float 2.000000e+00, float 0.000000e+00>
  store <4 x float> %i.de, ptr %.sroa.7.0..sroa_idx, align 4
...
bb.m:                                             ; preds = %_ZNK8aiStringneERKS_.exit
  ...
  %i.cj = load float, ptr %i.ci, align 4, !noalias !64 ; 6 uses
  ...
  %i.co = load <2 x float>, ptr %i.ck, align 4, !noalias !64 ; 5 uses
  ...
  %6 = insertelement <2 x float> poison, float %i.bz, i64 0
  ...
  %i.da = insertelement <4 x float> %i.cz, float %i.cj, i64 0
  %8 = insertelement <4 x float> %i.da, float %i.cm, i64 2
  %9 = shufflevector <4 x float> %8, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 0>
  %i.db = insertelement <4 x float> poison, float %i.cj, i64 0
  %i.dc = insertelement <4 x float> %i.db, float %i.cl, i64 1
  %10 = shufflevector <4 x float> %i.dc, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 0>
  %i.dd = fmul <4 x float> %9, %10
  %11 = shufflevector <2 x float> %i.co, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 1, i32 0> ; 2 uses
  %12 = insertelement <4 x float> %i.cz, float %i.cj, i64 1
  %i.de = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %11, <4 x float> %12, <4 x float> %i.dd) ; 4 uses
  %i.df = extractelement <4 x float> %i.de, i64 0
  %13 = tail call float @llvm.fmuladd.f32(float %i.df, float -2.000000e+00, float 1.000000e+00) ; 3 uses
  %14 = extractelement <4 x float> %i.de, i64 1
  %15 = fmul float %14, 2.000000e+00              ; 3 uses
  %i.dg = extractelement <4 x float> %i.de, i64 2
  %i.dh = fmul float %i.dg, 2.000000e+00          ; 3 uses
  %16 = shufflevector <2 x float> %i.co, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 1> ; 2 uses
  %17 = shufflevector <4 x float> %16, <4 x float> <float poison, float 1.000000e+00, float poison, float poison>, <4 x i32> <i32 0, i32 5, i32 poison, i32 1> ; 2 uses
  %18 = insertelement <4 x float> %17, float %i.cj, i64 2
  %19 = insertelement <4 x float> %17, float %i.cm, i64 0
  %20 = insertelement <4 x float> %19, float %i.cl, i64 2
  %21 = fmul <4 x float> %18, %20
  %22 = shufflevector <4 x float> %16, <4 x float> %i.de, <4 x i32> <i32 1, i32 7, i32 0, i32 0>
  %23 = insertelement <4 x float> %11, float -2.000000e+00, i64 1
  %24 = insertelement <4 x float> %23, float %i.cj, i64 0
  %25 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %22, <4 x float> %24, <4 x float> %21) ; 5 uses
  %26 = extractelement <4 x float> %25, i64 0
  %27 = fmul float %26, 2.000000e+00              ; 2 uses
  %28 = extractelement <4 x float> %25, i64 2
  %29 = fmul float %28, 2.000000e+00              ; 2 uses
  %30 = extractelement <4 x float> %25, i64 1
  %i.di = tail call float @llvm.fmuladd.f32(float %i.dh, float 0.000000e+00, float %30)
  %i.dj = tail call float @llvm.fmuladd.f32(float %13, float 0.000000e+00, float %29)
  %31 = insertelement <2 x float> poison, float %i.dj, i64 0
  %32 = insertelement <2 x float> %31, float %i.di, i64 1
  %33 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cw, <2 x float> zeroinitializer, <2 x float> %32)
  %34 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %7, <2 x float> zeroinitializer, <2 x float> %33)
  %35 = tail call float @llvm.fmuladd.f32(float %15, float 0.000000e+00, float %27)
  %36 = shufflevector <4 x float> %25, <4 x float> poison, <4 x i32> <i32 poison, i32 poison, i32 1, i32 poison>
  %37 = insertelement <4 x float> poison, float %i.bz, i64 0
  %38 = insertelement <4 x float> %37, float %15, i64 1
  %39 = insertelement <4 x float> %38, float %i.dh, i64 2
  %40 = insertelement <4 x float> %39, float %13, i64 3
  %i.dk = insertelement <2 x float> poison, float %i.cf, i64 0
  %41 = shufflevector <2 x float> %i.dk, <2 x float> poison, <2 x i32> zeroinitializer
  %42 = shufflevector <4 x float> %25, <4 x float> <float -0.000000e+00, float poison, float -0.000000e+00, float -0.000000e+00>, <4 x i32> <i32 4, i32 3, i32 6, i32 7>
  %43 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %42, <4 x float> <float 0.000000e+00, float -2.000000e+00, float 0.000000e+00, float 0.000000e+00>, <4 x float> <float -0.000000e+00, float 1.000000e+00, float -0.000000e+00, float -0.000000e+00>) ; 3 uses
  %i.dl = extractelement <4 x float> %43, i64 1   ; 2 uses
  %i.dm = tail call float @llvm.fmuladd.f32(float %i.dl, float 0.000000e+00, float %35)
  %44 = insertelement <4 x float> %36, float %i.dm, i64 0
  %45 = insertelement <4 x float> %44, float %27, i64 1
  %46 = insertelement <4 x float> %45, float %29, i64 3
  %47 = fmul <4 x float> %46, <float 1.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00> ; 4 uses
  %48 = extractelement <4 x float> %47, i64 2
  %49 = fadd float %48, %i.dh
  ...
  %i.dn = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cw, <2 x float> zeroinitializer, <2 x float> %53)
  %i.do = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cy, <2 x float> zeroinitializer, <2 x float> %i.dn)
  %54 = extractelement <4 x float> %47, i64 1
  %55 = fadd float %15, %54
  %56 = tail call float @llvm.fmuladd.f32(float %i.dl, float 0.000000e+00, float %55)
  %57 = tail call float @llvm.fmuladd.f32(float %i.bw, float 0.000000e+00, float %56)
  %58 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %40, <4 x float> zeroinitializer, <4 x float> %47) ; 3 uses
  %59 = shufflevector <4 x float> %58, <4 x float> poison, <2 x i32> <i32 3, i32 2>
  %60 = fadd <2 x float> %i.cw, %59
  %i.dp = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %41, <2 x float> zeroinitializer, <2 x float> %60)
  %61 = shufflevector <4 x float> %58, <4 x float> poison, <4 x i32> <i32 1, i32 1, i32 2, i32 3>
  %62 = fadd <4 x float> %43, %61
  %63 = shufflevector <2 x float> %i.cw, <2 x float> poison, <4 x i32> <i32 poison, i32 poison, i32 1, i32 0>
  %64 = shufflevector <4 x float> %63, <4 x float> %43, <4 x i32> <i32 5, i32 poison, i32 2, i32 3>
  %i.dq = insertelement <4 x float> %64, float %i.cf, i64 1
  %65 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.dq, <4 x float> zeroinitializer, <4 x float> %62) ; 2 uses
  %66 = shufflevector <4 x float> %i.cn, <4 x float> %65, <4 x i32> <i32 0, i32 7, i32 6, i32 4>
  %i.dr = fadd <4 x float> %66, zeroinitializer
  store <2 x float> %i.do, ptr %i.bv, align 4
  store float %57, ptr %.sroa.864.0..sroa_idx65, align 4
  store <2 x float> %34, ptr %.sroa.1270.0..sroa_idx71, align 4
  %67 = extractelement <4 x float> %58, i64 0
  store float %67, ptr %.sroa.6.0..sroa_idx.i, align 4
  store <2 x float> %i.dp, ptr %.sroa.2082.0..sroa_idx83, align 4
  %68 = extractelement <4 x float> %65, i64 1
  store float %68, ptr %.sroa.7.0..sroa_idx.i, align 4
