...
bb.j:                                             ; preds = %bb.i
  ...
  %i.bs = extractelement <2 x float> %i.br, i64 0 ; 5 uses
...
_ZN6Assimp3MD517ConvertQuaternionERK10aiVector3tIfER13aiQuaterniontIfE.exit: ; preds = %bb.j, %bb.k
  ...
  %i.cz = fmul float %i.bv, %i.bv
  %5 = shufflevector <2 x float> %i.bu, <2 x float> %i.br, <2 x i32> <i32 0, i32 2> ; 3 uses
  ...
  %9 = shufflevector <2 x float> %8, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 2 uses
  %10 = shufflevector <4 x float> %i.da, <4 x float> %9, <4 x i32> <i32 0, i32 5, i32 poison, i32 3>
  %i.db = shufflevector <4 x float> %10, <4 x float> %i.cv, <4 x i32> <i32 0, i32 1, i32 4, i32 3>
  ...
  %11 = shufflevector <4 x float> %9, <4 x float> %i.cw, <4 x i32> <i32 0, i32 5, i32 6, i32 7>
  %i.dh = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.cs, <4 x float> %11, <4 x float> %i.cy)
