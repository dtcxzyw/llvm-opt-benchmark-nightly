...
tailrecurse.i:                                    ; preds = %bb.c, %tailrecurse._crit_edge
  ...
  tail call void @_ZN3p2t5Sweep4FillERNS_12SweepContextERNS_4NodeE(ptr noundef nonnull align 8 dereferenceable(24) %0, ptr noundef nonnull align 8 dereferenceable(200) %1, ptr noundef nonnull align 8 dereferenceable(40) %i.an), !inline_history !14
...
tailrecurse.i:                                    ; preds = %bb.e, %bb.c
  ...
  tail call void @_ZN3p2t5Sweep4FillERNS_12SweepContextERNS_4NodeE(ptr noundef nonnull align 8 dereferenceable(24) %0, ptr noundef nonnull align 8 dereferenceable(200) %1, ptr noundef nonnull align 8 dereferenceable(40) %i.aa), !inline_history !15
...
tailrecurse.i:                                    ; preds = %bb.c, %tailrecurse._crit_edge
  ...
  tail call void @_ZN3p2t5Sweep4FillERNS_12SweepContextERNS_4NodeE(ptr noundef nonnull align 8 dereferenceable(24) %0, ptr noundef nonnull align 8 dereferenceable(200) %1, ptr noundef nonnull align 8 dereferenceable(40) %i.ag), !inline_history !15
