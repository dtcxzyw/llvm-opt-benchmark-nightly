...
begin_hunk_0_@_ZNK3p2t5Sweep8IncircleERKNS_5PointES3_S3_S3_:bb.a
...
.thread36:                                        ; preds = %bb.f, %bb.d, %bb.g
  ...
  %..i = select i1 %i.bo, i64 24, i64 40
  %i.bp = getelementptr inbounds nuw i8, ptr %1, i64 %..i
  %i.bq = load ptr, ptr %i.bp, align 8
  %i.br = load ptr, ptr %i.bq, align 8
  %i.bs = getelementptr inbounds nuw i8, ptr %i.br, i64 8
  %i.bt = load double, ptr %i.bs, align 8
  %i.bu = fsub double %i.bt, %i.bm
  %i.bv = load double, ptr %i.b, align 8
  %i.bw = fcmp ogt double %i.bv, %i.bu
