...
.lr.ph:                                           ; preds = %_ZN6Assimp7Collada25MakeColladaAssimpMetaKeysB5cxx11Ev.exit, %_ZN6Assimp7Collada11ToCamelCaseERNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE.exit
  %.sroa.05.09 = phi ptr [ %i.ap, %_ZN6Assimp7Collada11ToCamelCaseERNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE.exit ], [ %i.i, %_ZN6Assimp7Collada25MakeColladaAssimpMetaKeysB5cxx11Ev.exit ] ; 7 uses
...
.lr.ph.i:                                         ; preds = %bb.e, %bb.i
  ...
  %.sroa.09.023.i = phi ptr [ %.sroa.09.1.i, %bb.i ], [ %i.r, %bb.e ] ; 4 uses
...
.lr.ph:                                           ; preds = %bb.b, %bb.f
  ...
  %.sroa.09.023 = phi ptr [ %.sroa.09.1, %bb.f ], [ %i.i, %bb.b ] ; 4 uses
