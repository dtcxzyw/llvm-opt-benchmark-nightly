...
.lr.ph7.i:                                        ; preds = %._crit_edge, %.critedge.i
  %.0166.i = phi ptr [ %.016.i, %.critedge.i ], [ %.0164.i, %._crit_edge ] ; 3 uses
...
.lr.ph.i28:                                       ; preds = %.lr.ph7.i, %bb.k
  ...
  br i1 %i.ao, label %bb.k, label %.critedge.i
...
bb.k:                                             ; preds = %.lr.ph.i28
  ...
  br i1 %i.ap, label %.lr.ph.i28, label %.critedge.i, !llvm.loop !385

.critedge.i:                                      ; preds = %.lr.ph.i28, %bb.k
