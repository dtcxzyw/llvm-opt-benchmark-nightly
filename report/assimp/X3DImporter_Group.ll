...
bb.ad:                                            ; preds = %bb.ac, %bb.ab
  ...
  %10 = shufflevector <2 x float> %i.br, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 poison> ; 2 uses
  ...
  %i.fs = extractelement <2 x float> %i.br, i64 0
  ...
  %i.fx = insertelement <4 x float> poison, float %i.fu, i64 0
  %i.fy = insertelement <4 x float> poison, float %i.fq, i64 0
  ...
  %i.gk = insertelement <2 x float> %i.gj, float %i.fv, i64 0
  ...
  %11 = extractelement <2 x float> %i.gd, i64 1   ; 6 uses
  %i.gs = call float @llvm.fmuladd.f32(float %i.fw, float %11, float %i.ew)
  %12 = extractelement <2 x float> %i.gg, i64 0   ; 3 uses
  %i.gt = call float @llvm.fmuladd.f32(float %i.fw, float %12, float %i.gn)
  %i.gu = call float @llvm.fmuladd.f32(float %i.cs, float %11, float %i.gs)
  ...
  %i.hg = call float @llvm.fmuladd.f32(float %11, float 0.000000e+00, float %i.ft)
  %i.hh = call float @llvm.fmuladd.f32(float %12, float 0.000000e+00, float %i.gf)
  %13 = extractelement <2 x float> %i.he, i64 0
  %14 = fmul float %13, 0.000000e+00
  %15 = extractelement <2 x float> %i.he, i64 1   ; 3 uses
  %16 = fmul float %15, 0.000000e+00
  %17 = insertelement <4 x float> %10, float %i.gz, i64 1
  %18 = insertelement <4 x float> %17, float %i.gx, i64 3
  %19 = insertelement <4 x float> %i.fx, float %14, i64 1
  %20 = insertelement <4 x float> %19, float %16, i64 3
  %21 = shufflevector <4 x float> %20, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 3>
  %22 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %18, <4 x float> zeroinitializer, <4 x float> %21) ; 2 uses
  %i.hi = extractelement <4 x float> %22, i64 0
  %23 = fadd float %i.fq, %i.hi
  %i.hj = fmul float %i.ge, %i.ct
  %24 = call float @llvm.fmuladd.f32(float %i.ev, float %11, float %i.cw)
  %25 = call float @llvm.fmuladd.f32(float %i.ev, float %12, float %i.hj)
  %i.hk = call float @llvm.fmuladd.f32(float %i.cu, float %11, float %24)
  %26 = call float @llvm.fmuladd.f32(float %i.cu, float %i.ge, float %25)
  %27 = call float @llvm.fmuladd.f32(float %i.gw, float 0.000000e+00, float %i.hk) ; 4 uses
  %i.hl = call float @llvm.fmuladd.f32(float %i.gy, float 0.000000e+00, float %26) ; 4 uses
  %28 = call float @llvm.fmuladd.f32(float %11, float 0.000000e+00, float %i.hg)
  %29 = call float @llvm.fmuladd.f32(float %i.ge, float 0.000000e+00, float %i.hh)
  %i.hm = insertelement <4 x float> %i.fy, float %i.hl, i64 1
  %i.hn = insertelement <4 x float> %i.hm, float %27, i64 3
  %30 = shufflevector <4 x float> %i.hn, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 3>
  %31 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %30, <4 x float> zeroinitializer, <4 x float> %22)
  %i.ho = fadd float %28, %i.gw                   ; 4 uses
  %i.hp = fadd float %29, %i.gy                   ; 4 uses
  %i.hq = fmul float %i.fi, %15
  ...
  %i.hw = call float @llvm.fmuladd.f32(float %i.fk, float %27, float %i.hr)
  %i.hx = call float @llvm.fmuladd.f32(float %i.fk, float %i.hl, float %i.hv)
  ...
  %i.ia = fadd <4 x float> %i.hz, %31             ; 6 uses
  ...
  %i.ie = call float @llvm.fmuladd.f32(float %i.ga, float %i.hl, float %i.id)
  ...
  %i.ij = call float @llvm.fmuladd.f32(float %i.fz, float %27, float %i.ig)
  %i.ik = call float @llvm.fmuladd.f32(float %i.fz, float %i.hl, float %i.ii)
  ...
  %i.in = fmul float %i.fn, %15
  %i.io = call float @llvm.fmuladd.f32(float %i.fo, float %i.gx, float %i.in)
  %i.ip = call float @llvm.fmuladd.f32(float %i.ga, float %27, float %i.io)
  ...
  %i.ld = fadd float %i.bq, %23                   ; 2 uses
