...
.lr.ph306:                                        ; preds = %_ZNKSt18unordered_multimapImmSt4hashImESt8equal_toImESaISt4pairIKmmEEE11equal_rangeERS5_.exit, %.loopexit280
  %.sroa.0232.0305 = phi ptr [ %i.oh, %.loopexit280 ], [ %.sroa.06.1.i.i.i, %_ZNKSt18unordered_multimapImmSt4hashImESt8equal_toImESaISt4pairIKmmEEE11equal_rangeERS5_.exit ] ; 2 uses
...
_ZNK6Assimp4STEP10LazyObject5ToPtrINS_3IFC10Schema_2x313IfcStyledItemEEEPKT_v.exit: ; preds = %_ZNK6Assimp4STEP2DB9GetObjectEm.exit, %bb.k
  %i.aw = phi ptr [ %.pre.i.i, %bb.k ], [ %i.av, %_ZNK6Assimp4STEP2DB9GetObjectEm.exit ]
  %i.ax = tail call noundef ptr @__dynamic_cast(ptr nonnull %i.aw, ptr nonnull @_ZTIN6Assimp4STEP6ObjectE, ptr nonnull @_ZTIN6Assimp3IFC10Schema_2x313IfcStyledItemE, i64 -1) #17 ; 3 uses
  %.not79 = icmp eq ptr %i.ax, null
  br i1 %.not79, label %.loopexit280, label %bb.l

bb.l:                                             ; preds = %_ZNK6Assimp4STEP10LazyObject5ToPtrINS_3IFC10Schema_2x313IfcStyledItemEEEPKT_v.exit
  %i.ay = getelementptr inbounds nuw i8, ptr %i.ax, i64 48
  %i.az = load ptr, ptr %i.ay, align 8            ; 2 uses
  %i.ba = getelementptr inbounds nuw i8, ptr %i.ax, i64 56
  %i.bb = load ptr, ptr %i.ba, align 8            ; 2 uses
  %.not275301 = icmp eq ptr %i.az, %i.bb
  br i1 %.not275301, label %.loopexit280, label %.lr.ph303

.lr.ph303:                                        ; preds = %bb.l, %.thread250
  %.sroa.0229.0302 = phi ptr [ %i.og, %.thread250 ], [ %i.az, %bb.l ] ; 2 uses
  %i.bc = load ptr, ptr %.sroa.0229.0302, align 8 ; 3 uses
  %i.bd = icmp eq ptr %i.bc, null
  br i1 %i.bd, label %bb.m, label %bb.r

bb.m:                                             ; preds = %.lr.ph303
  %i.be = tail call ptr @__cxa_allocate_exception(i64 16) #17 ; 3 uses
  ...
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2IS3_EEPKcRKS3_(ptr noundef nonnull align 8 dereferenceable(32) %13, ptr noundef nonnull @.str.14, ptr noundef nonnull align 1 dereferenceable(1) %14)
          to label %bb.n unwind label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.thread.i

bb.n:                                             ; preds = %bb.m
  invoke void @_ZN6Assimp4STEP9TypeErrorC1ERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmm(ptr noundef nonnull align 8 dereferenceable(16) %i.be, ptr noundef nonnull align 8 dereferenceable(32) %13, i64 noundef -1, i64 noundef 1152921504606846975)
          to label %bb.o unwind label %bb.p

bb.o:                                             ; preds = %bb.n
  invoke void @__cxa_throw(ptr nonnull %i.be, ptr nonnull @_ZTIN6Assimp4STEP9TypeErrorE, ptr nonnull @_ZNSt13runtime_errorD2Ev) #18
...
bb.p:                                             ; preds = %bb.o, %bb.n
  %.0.i87 = phi i1 [ false, %bb.o ], [ true, %bb.n ] ; 2 uses
  %i.bg = landingpad { ptr, i32 }
          cleanup                                 ; 4 uses
  %i.bh = load ptr, ptr %13, align 8              ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i: ; preds = %bb.p
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %14) #17
  call void @llvm.lifetime.end.p0(ptr nonnull %13) #17
  br i1 %.0.i87, label %bb.q, label %common.resume
...
bb.q:                                             ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.i, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.thread.i
  %.pn10.i = phi { ptr, i32 } [ %i.bf, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.thread.i ], [ %i.bg, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.i ], [ %i.bg, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i ]
  call void @__cxa_free_exception(ptr %i.be) #17
  br label %common.resume

bb.r:                                             ; preds = %.lr.ph303
  %i.bm = getelementptr inbounds nuw i8, ptr %i.bc, i64 32 ; 2 uses
  %i.bn = load ptr, ptr %i.bm, align 8            ; 2 uses
  %.not.i.i.i86 = icmp eq ptr %i.bn, null
  br i1 %.not.i.i.i86, label %bb.s, label %_ZNK6Assimp4STEP10LazyObjectdeEv.exit.i.i

bb.s:                                             ; preds = %bb.r
  tail call void @_ZNK6Assimp4STEP10LazyObject8LazyInitEv(ptr noundef nonnull align 8 dereferenceable(40) %i.bc)
  %.pre.i.i.i = load ptr, ptr %i.bm, align 8
  br label %_ZNK6Assimp4STEP10LazyObjectdeEv.exit.i.i

_ZNK6Assimp4STEP10LazyObjectdeEv.exit.i.i:        ; preds = %bb.s, %bb.r
  %i.bo = phi ptr [ %.pre.i.i.i, %bb.s ], [ %i.bn, %bb.r ]
  %i.bp = tail call ptr @__dynamic_cast(ptr nonnull %i.bo, ptr nonnull @_ZTIN6Assimp4STEP6ObjectE, ptr nonnull @_ZTIN6Assimp3IFC10Schema_2x330IfcPresentationStyleAssignmentE, i64 -1) #17 ; 3 uses
  %i.bq = icmp eq ptr %i.bp, null
  br i1 %i.bq, label %bb.t, label %_ZNK6Assimp4STEP4LazyINS_3IFC10Schema_2x330IfcPresentationStyleAssignmentEEcvRKS4_Ev.exit

bb.t:                                             ; preds = %_ZNK6Assimp4STEP10LazyObjectdeEv.exit.i.i
  tail call void @__cxa_bad_cast() #18
  unreachable

common.resume:                                    ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit146, %bb.cx, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i173, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.i174, %bb.z, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.i, %bb.q
  %common.resume.op = phi { ptr, i32 } [ %i.co, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i173 ], [ %i.bg, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i ], [ %i.bg, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.i ], [ %.pn10.i, %bb.q ], [ %.pn16.i, %bb.z ], [ %i.co, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.i174 ], [ %.pn81.pn.pn, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit146 ], [ %.pn.pn.pn, %bb.cx ]
...
_ZNK6Assimp4STEP4LazyINS_3IFC10Schema_2x330IfcPresentationStyleAssignmentEEcvRKS4_Ev.exit: ; preds = %_ZNK6Assimp4STEP10LazyObjectdeEv.exit.i.i
  ...
  %.not276299 = icmp eq ptr %i.bs, %i.bu
  br i1 %.not276299, label %.thread250, label %.lr.ph

.lr.ph:                                           ; preds = %_ZNK6Assimp4STEP4LazyINS_3IFC10Schema_2x330IfcPresentationStyleAssignmentEEcvRKS4_Ev.exit, %.thread
  %.sroa.0225.0300 = phi ptr [ %i.of, %.thread ], [ %i.bs, %_ZNK6Assimp4STEP4LazyINS_3IFC10Schema_2x330IfcPresentationStyleAssignmentEEcvRKS4_Ev.exit ] ; 2 uses
  %i.bv = load ptr, ptr %.sroa.0225.0300, align 8
  %i.bw = tail call noundef ptr @__dynamic_cast(ptr nonnull align 8 dereferenceable(8) %i.bv, ptr nonnull @_ZTIN6Assimp4STEP7EXPRESS8DataTypeE, ptr nonnull @_ZTIN6Assimp4STEP7EXPRESS6ENTITYE, i64 0) #17 ; 2 uses
  %.not.i = icmp eq ptr %i.bw, null
  br i1 %.not.i, label %.thread, label %bb.v

bb.v:                                             ; preds = %.lr.ph
  %i.bx = load ptr, ptr %i.k, align 8, !nonnull !3, !align !4 ; 2 uses
  %i.by = getelementptr inbounds nuw i8, ptr %i.bw, i64 8
  %i.bz = load i64, ptr %i.by, align 8            ; 3 uses
  %i.ca = getelementptr inbounds nuw i8, ptr %i.bx, i64 112
  %i.cb = load ptr, ptr %i.ca, align 8            ; 2 uses
  %i.cc = getelementptr inbounds nuw i8, ptr %i.bx, i64 104 ; 2 uses
  %.not10.i.i.i.i.i = icmp eq ptr %i.cb, null
  br i1 %.not10.i.i.i.i.i, label %_ZNK6Assimp4STEP2DB9GetObjectEm.exit.thread.i, label %.lr.ph.i.i.i.i.i168

.lr.ph.i.i.i.i.i168:                              ; preds = %bb.v, %.lr.ph.i.i.i.i.i168
  %.012.i.i.i.i.i = phi ptr [ %.1.i.i.i.i.i, %.lr.ph.i.i.i.i.i168 ], [ %i.cb, %bb.v ] ; 3 uses
  %.0811.i.i.i.i.i = phi ptr [ %.19.i.i.i.i.i, %.lr.ph.i.i.i.i.i168 ], [ %i.cc, %bb.v ]
  %i.cd = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i.i, i64 32
  %i.ce = load i64, ptr %i.cd, align 8
  %i.cf = icmp ult i64 %i.ce, %i.bz               ; 2 uses
  %.19.i.i.i.i.i = select i1 %i.cf, ptr %.0811.i.i.i.i.i, ptr %.012.i.i.i.i.i ; 4 uses
  %.1.in.v.i.i.i.i.i = select i1 %i.cf, i64 24, i64 16
  %.1.in.i.i.i.i.i = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i.i, i64 %.1.in.v.i.i.i.i.i
  %.1.i.i.i.i.i = load ptr, ptr %.1.in.i.i.i.i.i, align 8 ; 2 uses
  %.not.i.i.i.i.i169 = icmp eq ptr %.1.i.i.i.i.i, null
  br i1 %.not.i.i.i.i.i169, label %_ZNKSt8_Rb_treeImSt4pairIKmPKN6Assimp4STEP10LazyObjectEESt10_Select1stIS7_ESt4lessImESaIS7_EE14_M_lower_boundEPKSt13_Rb_tree_nodeIS7_EPKSt18_Rb_tree_node_baseRS1_.exit.i.i.i.i, label %.lr.ph.i.i.i.i.i168, !llvm.loop !9

_ZNKSt8_Rb_treeImSt4pairIKmPKN6Assimp4STEP10LazyObjectEESt10_Select1stIS7_ESt4lessImESaIS7_EE14_M_lower_boundEPKSt13_Rb_tree_nodeIS7_EPKSt18_Rb_tree_node_baseRS1_.exit.i.i.i.i: ; preds = %.lr.ph.i.i.i.i.i168
  %i.cg = icmp eq ptr %.19.i.i.i.i.i, %i.cc
  br i1 %i.cg, label %_ZNK6Assimp4STEP2DB9GetObjectEm.exit.thread.i, label %_ZNKSt3mapImPKN6Assimp4STEP10LazyObjectESt4lessImESaISt4pairIKmS4_EEE4findERS8_.exit.i.i
...
_ZNKSt3mapImPKN6Assimp4STEP10LazyObjectESt4lessImESaISt4pairIKmS4_EEE4findERS8_.exit.i.i: ; preds = %_ZNKSt8_Rb_treeImSt4pairIKmPKN6Assimp4STEP10LazyObjectEESt10_Select1stIS7_ESt4lessImESaIS7_EE14_M_lower_boundEPKSt13_Rb_tree_nodeIS7_EPKSt18_Rb_tree_node_baseRS1_.exit.i.i.i.i
  %i.ch = getelementptr inbounds nuw i8, ptr %.19.i.i.i.i.i, i64 32
  %i.ci = load i64, ptr %i.ch, align 8
  %i.cj = icmp ult i64 %i.bz, %i.ci
  br i1 %i.cj, label %_ZNK6Assimp4STEP2DB9GetObjectEm.exit.thread.i, label %_ZNK6Assimp4STEP2DB9GetObjectEm.exit.i
...
_ZNK6Assimp4STEP2DB9GetObjectEm.exit.i:           ; preds = %_ZNKSt3mapImPKN6Assimp4STEP10LazyObjectESt4lessImESaISt4pairIKmS4_EEE4findERS8_.exit.i.i
  %i.ck = getelementptr inbounds nuw i8, ptr %.19.i.i.i.i.i, i64 40
  %i.cl = load ptr, ptr %i.ck, align 8            ; 3 uses
  %.not.i170 = icmp eq ptr %i.cl, null
...
_ZNK6Assimp4STEP2DB9GetObjectEm.exit.thread.i:    ; preds = %_ZNK6Assimp4STEP2DB9GetObjectEm.exit.i, %_ZNKSt3mapImPKN6Assimp4STEP10LazyObjectESt4lessImESaISt4pairIKmS4_EEE4findERS8_.exit.i.i, %_ZNKSt8_Rb_treeImSt4pairIKmPKN6Assimp4STEP10LazyObjectEESt10_Select1stIS7_ESt4lessImESaIS7_EE14_M_lower_boundEPKSt13_Rb_tree_nodeIS7_EPKSt18_Rb_tree_node_baseRS1_.exit.i.i.i.i, %bb.v
  %i.cm = tail call ptr @__cxa_allocate_exception(i64 16) #17 ; 3 uses
  ...
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2IS3_EEPKcRKS3_(ptr noundef nonnull align 8 dereferenceable(32) %7, ptr noundef nonnull @.str.13, ptr noundef nonnull align 1 dereferenceable(1) %8)
          to label %bb.w unwind label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.thread.i171

bb.w:                                             ; preds = %_ZNK6Assimp4STEP2DB9GetObjectEm.exit.thread.i
  invoke void @_ZN6Assimp4STEP9TypeErrorC1ERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEmm(ptr noundef nonnull align 8 dereferenceable(16) %i.cm, ptr noundef nonnull align 8 dereferenceable(32) %7, i64 noundef %i.bz, i64 noundef 1152921504606846975)
          to label %bb.x unwind label %bb.y

bb.x:                                             ; preds = %bb.w
  invoke void @__cxa_throw(ptr nonnull %i.cm, ptr nonnull @_ZTIN6Assimp4STEP9TypeErrorE, ptr nonnull @_ZNSt13runtime_errorD2Ev) #18
...
bb.y:                                             ; preds = %bb.x, %bb.w
  %.0.i172 = phi i1 [ false, %bb.x ], [ true, %bb.w ] ; 2 uses
  %i.co = landingpad { ptr, i32 }
          cleanup                                 ; 4 uses
  %i.cp = load ptr, ptr %7, align 8               ; 2 uses
  %i.cq = getelementptr inbounds nuw i8, ptr %7, i64 16 ; 2 uses
  %i.cr = icmp eq ptr %i.cp, %i.cq
  br i1 %i.cr, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.i174, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i173

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i173: ; preds = %bb.y
  %i.cs = load i64, ptr %i.cq, align 8
  %i.ct = add i64 %i.cs, 1
  call void @_ZdlPvm(ptr noundef %i.cp, i64 noundef %i.ct) #19
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #17
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #17
  br i1 %.0.i172, label %bb.z, label %common.resume

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.i174: ; preds = %bb.y
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #17
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #17
  br i1 %.0.i172, label %bb.z, label %common.resume

bb.z:                                             ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.i174, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i173, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.thread.i171
  %.pn16.i = phi { ptr, i32 } [ %i.cn, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.thread.i171 ], [ %i.co, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.i174 ], [ %i.co, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i173 ]
end_hunk_0
