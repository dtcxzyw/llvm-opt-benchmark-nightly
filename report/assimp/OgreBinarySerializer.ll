Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/assimp/original/OgreBinarySerializer?download=true
...
.lr.ph192:                                        ; preds = %bb.b
  ...
  %i.y = getelementptr inbounds nuw i8, ptr %4, i64 24 ; 5 uses
...
bb.c:                                             ; preds = %.lr.ph192, %bb.bz
  %i.ah = phi ptr [ %i.q, %.lr.ph192 ], [ %i.jy, %bb.bz ] ; 3 uses
  %i.ai = phi ptr [ %i.p, %.lr.ph192 ], [ %i.ka, %bb.bz ] ; 4 uses
  %i.aj = phi ptr [ %i.m, %.lr.ph192 ], [ %i.jz, %bb.bz ] ; 3 uses
...
.invoke:                                          ; preds = %bb.au, %bb.bn
  %i.es = phi ptr [ %i.ib, %bb.bn ], [ %i.er, %bb.au ]
...
.lr.ph:                                           ; preds = %.preheader, %bb.bl
  ...
  %i.fs = phi ptr [ %i.hv, %bb.bl ], [ %i.fj, %.preheader ]
...
bb.bi:                                            ; preds = %_ZNSt6vectorIN6Assimp4Ogre7PoseRefESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit16.i.i
  %i.hf = load ptr, ptr %i.y, align 8
  %i.hg = ptrtoint ptr %i.hf to i64
  %i.hh = sub i64 %i.hg, %i.gs
  call void @_ZdlPvm(ptr noundef nonnull %i.gq, i64 noundef %i.hh) #24
...
_ZNSt6vectorIN6Assimp4Ogre7PoseRefESaIS2_EE17_M_realloc_insertIJRKS2_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i: ; preds = %bb.bi, %_ZNSt6vectorIN6Assimp4Ogre7PoseRefESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit16.i.i
  ...
  %i.hi = getelementptr inbounds nuw [8 x i8], ptr %i.hb, i64 %i.gz
  store ptr %i.hi, ptr %i.y, align 8
  br label %bb.bj
...
bb.bj:                                            ; preds = %bb.be, %_ZNSt6vectorIN6Assimp4Ogre7PoseRefESaIS2_EE17_M_realloc_insertIJRKS2_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i
  %i.hj = load ptr, ptr %i.a, align 8             ; 2 uses
  ...
  br i1 %i.hs, label %_ZN6Assimp4Ogre20OgreBinarySerializer14RollbackHeaderEv.exit, label %bb.bk

bb.bk:                                            ; preds = %bb.bj
  %i.ht = invoke noundef zeroext i16 @_ZN6Assimp4Ogre20OgreBinarySerializer10ReadHeaderEb(ptr noundef nonnull align 8 dereferenceable(20) %0, i1 noundef zeroext true)
...
bb.bl:                                            ; preds = %bb.bk
  ...
  %i.hu = icmp eq i64 %.pre273, 0                 ; 2 uses
  %i.hv = getelementptr inbounds nuw i8, ptr %.pre, i64 24 ; 2 uses
  %i.hw = icmp ne i16 %i.ht, -12013
  %.not29 = or i1 %i.hw, %i.hu
  br i1 %.not29, label %._crit_edge, label %.lr.ph, !llvm.loop !36

._crit_edge:                                      ; preds = %bb.bl, %.preheader
  %.1.lcssa = phi i16 [ %i.ff, %.preheader ], [ %i.ht, %bb.bl ] ; 2 uses
  %.lcssa109 = phi ptr [ %i.fg, %.preheader ], [ %.pre, %bb.bl ]
  %.lcssa104 = phi ptr [ %i.fj, %.preheader ], [ %i.hv, %bb.bl ]
  %.lcssa99 = phi ptr [ %i.fk, %.preheader ], [ %.pre255.a, %bb.bl ]
  %.lcssa = phi i1 [ %i.fp, %.preheader ], [ %i.hu, %bb.bl ]
  br i1 %.lcssa, label %_ZN6Assimp4Ogre20OgreBinarySerializer14RollbackHeaderEv.exit, label %bb.bm

bb.bm:                                            ; preds = %._crit_edge
  %i.hx = getelementptr inbounds i8, ptr %.lcssa99, i64 -6 ; 2 uses
  store ptr %i.hx, ptr %.lcssa104, align 8
  %i.hy = getelementptr inbounds nuw i8, ptr %.lcssa109, i64 40
  %i.hz = load ptr, ptr %i.hy, align 8
  %i.ia = icmp ugt ptr %i.hx, %i.hz
  br i1 %i.ia, label %bb.bn, label %_ZN6Assimp4Ogre20OgreBinarySerializer14RollbackHeaderEv.exit

bb.bn:                                            ; preds = %bb.bm
  %i.ib = call ptr @__cxa_allocate_exception(i64 16) #21 ; 3 uses
  invoke void @_ZN17DeadlyImportErrorC2EPKc(ptr noundef nonnull align 8 dereferenceable(16) %i.ib, ptr noundef nonnull @.str.72)
          to label %.invoke unwind label %bb.bo

bb.bo:                                            ; preds = %bb.bn
  %i.ic = landingpad { ptr, i32 }
          cleanup
  call void @__cxa_free_exception(ptr nonnull %i.ib) #21
  br label %.body51
...
_ZN6Assimp4Ogre20OgreBinarySerializer14RollbackHeaderEv.exit: ; preds = %bb.bj, %bb.bm, %._crit_edge, %bb.aw
  ...
  %i.id = load ptr, ptr %i.z, align 8             ; 6 uses
  %i.ie = load ptr, ptr %i.aa, align 8
  %.not.i68 = icmp eq ptr %i.id, %i.ie
  br i1 %.not.i68, label %bb.bu, label %bb.bp

bb.bp:                                            ; preds = %_ZN6Assimp4Ogre20OgreBinarySerializer14RollbackHeaderEv.exit
  %i.if = load float, ptr %4, align 8
  store float %i.if, ptr %i.id, align 8
  %i.ig = getelementptr inbounds nuw i8, ptr %i.id, i64 8 ; 2 uses
  %i.ih = load ptr, ptr %i.x, align 8             ; 2 uses
  %i.ii = load ptr, ptr %i.w, align 8             ; 2 uses
  ...
  %.not.i.i.i.i.i.i69 = icmp eq ptr %i.ih, %i.ii
  br i1 %.not.i.i.i.i.i.i69, label %.noexc71, label %bb.bq

bb.bq:                                            ; preds = %bb.bp
  %i.im = icmp ugt i64 %i.il, 9223372036854775800
  br i1 %i.im, label %.noexc.i.i.i.i, label %_ZNSt15__new_allocatorIN6Assimp4Ogre7PoseRefEE8allocateEmPKv.exit.i.i.i.i.i.i, !prof !11
...
_ZNSt15__new_allocatorIN6Assimp4Ogre7PoseRefEE8allocateEmPKv.exit.i.i.i.i.i.i: ; preds = %bb.bq
  %i.in = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.il) #23
...
.noexc71:                                         ; preds = %_ZNSt15__new_allocatorIN6Assimp4Ogre7PoseRefEE8allocateEmPKv.exit.i.i.i.i.i.i, %bb.bp
  %i.io = phi ptr [ null, %bb.bp ], [ %i.in, %_ZNSt15__new_allocatorIN6Assimp4Ogre7PoseRefEE8allocateEmPKv.exit.i.i.i.i.i.i ] ; 6 uses
  store ptr %i.io, ptr %i.ig, align 8
  %i.ip = getelementptr inbounds nuw i8, ptr %i.id, i64 16 ; 2 uses
  store ptr %i.io, ptr %i.ip, align 8
  %i.iq = getelementptr inbounds nuw i8, ptr %i.io, i64 %i.il
  %i.ir = getelementptr inbounds nuw i8, ptr %i.id, i64 24
  store ptr %i.iq, ptr %i.ir, align 8
  %i.is = load ptr, ptr %i.w, align 8             ; 4 uses
  %i.it = load ptr, ptr %i.x, align 8
  %i.iu = ptrtoint ptr %i.it to i64
  %i.iv = ptrtoint ptr %i.is to i64
  %i.iw = sub i64 %i.iu, %i.iv                    ; 4 uses
  %i.ix = icmp sgt i64 %i.iw, 8
  br i1 %i.ix, label %bb.br, label %bb.bs, !prof !37

bb.br:                                            ; preds = %.noexc71
  call void @llvm.memmove.p0.p0.i64(ptr align 4 %i.io, ptr align 4 %i.is, i64 %i.iw, i1 false)
  br label %_ZN6Assimp4Ogre12PoseKeyFrameC2ERKS1_.exit.i

bb.bs:                                            ; preds = %.noexc71
  %i.iy = icmp eq i64 %i.iw, 8
  br i1 %i.iy, label %bb.bt, label %_ZN6Assimp4Ogre12PoseKeyFrameC2ERKS1_.exit.i

bb.bt:                                            ; preds = %bb.bs
  %i.iz = load i64, ptr %i.is, align 4
  store i64 %i.iz, ptr %i.io, align 4
  br label %_ZN6Assimp4Ogre12PoseKeyFrameC2ERKS1_.exit.i

_ZN6Assimp4Ogre12PoseKeyFrameC2ERKS1_.exit.i:     ; preds = %bb.bt, %bb.bs, %bb.br
  %i.ja = getelementptr inbounds i8, ptr %i.io, i64 %i.iw
  store ptr %i.ja, ptr %i.ip, align 8
  %i.jb = load ptr, ptr %i.z, align 8
  %i.jc = getelementptr inbounds nuw i8, ptr %i.jb, i64 32
  store ptr %i.jc, ptr %i.z, align 8
...
bb.bu:                                            ; preds = %_ZN6Assimp4Ogre20OgreBinarySerializer14RollbackHeaderEv.exit
  invoke void @_ZNSt6vectorIN6Assimp4Ogre12PoseKeyFrameESaIS2_EE17_M_realloc_insertIJRKS2_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_(ptr noundef nonnull align 8 dereferenceable(24) %i.ab, ptr %i.id, ptr noundef nonnull align 8 dereferenceable(32) %4)
...
_ZNSt6vectorIN6Assimp4Ogre12PoseKeyFrameESaIS2_EE9push_backERKS2_.exit: ; preds = %._ZNSt6vectorIN6Assimp4Ogre12PoseKeyFrameESaIS2_EE9push_backERKS2_.exit_crit_edge, %_ZN6Assimp4Ogre12PoseKeyFrameC2ERKS1_.exit.i
  %i.jd = phi ptr [ %.pre256, %._ZNSt6vectorIN6Assimp4Ogre12PoseKeyFrameESaIS2_EE9push_backERKS2_.exit_crit_edge ], [ %i.is, %_ZN6Assimp4Ogre12PoseKeyFrameC2ERKS1_.exit.i ] ; 3 uses
  %.not.i.i.i.i73 = icmp eq ptr %i.jd, null
...
bb.bv:                                            ; preds = %_ZNSt6vectorIN6Assimp4Ogre12PoseKeyFrameESaIS2_EE9push_backERKS2_.exit
  %i.je = load ptr, ptr %i.y, align 8
  %i.jf = ptrtoint ptr %i.je to i64
  %i.jg = ptrtoint ptr %i.jd to i64
  %i.jh = sub i64 %i.jf, %i.jg
  call void @_ZdlPvm(ptr noundef nonnull %i.jd, i64 noundef %i.jh) #24
...
.body51:                                          ; preds = %.loopexit, %.loopexit.split-lp, %.loopexit85, %.loopexit.split-lp86, %bb.az, %bb.bc, %bb.av, %bb.bo
  %.pn = phi { ptr, i32 } [ %i.ic, %bb.bo ], [ %i.et, %bb.av ], [ %i.gk, %bb.bc ], [ %i.ga, %bb.az ], [ %lpad.loopexit.split-lp88, %.loopexit.split-lp86 ], [ %lpad.loopexit87, %.loopexit85 ], [ %lpad.loopexit, %.loopexit ], [ %lpad.loopexit.split-lp, %.loopexit.split-lp ]
  %i.ji = load ptr, ptr %i.w, align 8             ; 3 uses
  %.not.i.i.i.i74 = icmp eq ptr %i.ji, null
  br i1 %.not.i.i.i.i74, label %_ZN6Assimp4Ogre12PoseKeyFrameD2Ev.exit75, label %bb.bw

bb.bw:                                            ; preds = %.body51
  %i.jj = load ptr, ptr %i.y, align 8
...
bb.bx:                                            ; preds = %_ZN6Assimp4Ogre12PoseKeyFrameD2Ev.exit, %_ZN6Assimp4Ogre13MorphKeyFrameD2Ev.exit
  ...
  %i.jn = load ptr, ptr %i.a, align 8             ; 3 uses
  ...
  br i1 %i.jw, label %bb.bz, label %bb.by

bb.by:                                            ; preds = %bb.bx
  %i.jx = call noundef zeroext i16 @_ZN6Assimp4Ogre20OgreBinarySerializer10ReadHeaderEb(ptr noundef nonnull align 8 dereferenceable(20) %0, i1 noundef zeroext true)
...
bb.bz:                                            ; preds = %bb.by, %bb.bx
  %.pre-phi266 = phi i64 [ %.pre265, %bb.by ], [ %i.ju, %bb.bx ]
  %i.jy = phi ptr [ %.pre261, %bb.by ], [ %i.jr, %bb.bx ]
  %i.jz = phi ptr [ %.pre257, %bb.by ], [ %i.jn, %bb.bx ] ; 2 uses
  %.5 = phi i16 [ %i.jx, %bb.by ], [ %.4, %bb.bx ]
  %i.ka = getelementptr inbounds nuw i8, ptr %i.jz, i64 24
  %i.kb = and i64 %.pre-phi266, 4294967295
  %i.kc = icmp eq i64 %i.kb, 0
  br i1 %i.kc, label %_ZN6Assimp4Ogre20OgreBinarySerializer14RollbackHeaderEv.exit76, label %bb.c, !llvm.loop !38

.critedge:                                        ; preds = %bb.c
  %i.kd = getelementptr inbounds i8, ptr %i.ah, i64 -6 ; 2 uses
  store ptr %i.kd, ptr %i.ai, align 8
  %i.ke = getelementptr inbounds nuw i8, ptr %i.aj, i64 40
  %i.kf = load ptr, ptr %i.ke, align 8
  %i.kg = icmp ugt ptr %i.kd, %i.kf
  br i1 %i.kg, label %bb.ca, label %_ZN6Assimp4Ogre20OgreBinarySerializer14RollbackHeaderEv.exit76

bb.ca:                                            ; preds = %.critedge
  %i.kh = call ptr @__cxa_allocate_exception(i64 16) #21 ; 3 uses
  invoke void @_ZN17DeadlyImportErrorC2EPKc(ptr noundef nonnull align 8 dereferenceable(16) %i.kh, ptr noundef nonnull @.str.72)
          to label %bb.cb unwind label %bb.cc

bb.cb:                                            ; preds = %bb.ca
  call void @__cxa_throw(ptr nonnull %i.kh, ptr nonnull @_ZTI17DeadlyImportError, ptr nonnull @_ZNSt13runtime_errorD2Ev) #22
  unreachable

common.resume:                                    ; preds = %.body, %_ZN6Assimp4Ogre12PoseKeyFrameD2Ev.exit75, %bb.cc
  %common.resume.op = phi { ptr, i32 } [ %i.ki, %bb.cc ], [ %.pn31.pn.pn.pn, %.body ], [ %.pn, %_ZN6Assimp4Ogre12PoseKeyFrameD2Ev.exit75 ]
  resume { ptr, i32 } %common.resume.op

bb.cc:                                            ; preds = %bb.ca
  %i.ki = landingpad { ptr, i32 }
          cleanup
  call void @__cxa_free_exception(ptr nonnull %i.kh) #21
  br label %common.resume
