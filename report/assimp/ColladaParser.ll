...
bb.c:                                             ; preds = %bb.b
  ...
  %3 = load <2 x float>, ptr %i.ak, align 8       ; 6 uses
  %foldExtExtBinop = fmul <2 x float> %3, %3
  %i.am = extractelement <2 x float> %foldExtExtBinop, i64 0
  %i.an = tail call float @llvm.fmuladd.f32(float %i.al, float %i.al, float %i.am)
  %i.ao = extractelement <2 x float> %3, i64 1    ; 2 uses
  ...
  %5 = insertelement <2 x float> %4, float %i.al, i64 1 ; 2 uses
...
_ZN10aiVector3tIfEdVEf.exit.i:                    ; preds = %bb.c
  ...
  %6 = insertelement <2 x float> poison, float %i.ar, i64 0
...
_ZN10aiVector3tIfE9NormalizeEv.exit:              ; preds = %bb.c, %_ZN10aiVector3tIfEdVEf.exit.i
  %10 = phi <2 x float> [ %5, %bb.c ], [ %8, %_ZN10aiVector3tIfEdVEf.exit.i ] ; 4 uses
  %11 = phi <2 x float> [ %3, %bb.c ], [ %9, %_ZN10aiVector3tIfEdVEf.exit.i ] ; 3 uses
...
_ZN10aiVector3tIfE9NormalizeEv.exit46:            ; preds = %_ZN10aiVector3tIfE9NormalizeEv.exit, %_ZN10aiVector3tIfEdVEf.exit.i44
  ...
  %i.be = extractelement <2 x float> %.sroa.0120.0, i64 1
  %12 = fneg <2 x float> %11
  %i.bf = extractelement <2 x float> %.sroa.0120.0, i64 0
  ...
  %i.bi = fmul <2 x float> %i.bh, %12
  %i.bj = insertelement <2 x float> %i.bg, float %.sroa.8123.0, i64 1
  %13 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bj, <2 x float> %10, <2 x float> %i.bi) ; 5 uses
  %14 = extractelement <2 x float> %10, i64 1
  %i.bk = fneg float %14
  %i.bl = fmul float %i.be, %i.bk
  %15 = extractelement <2 x float> %11, i64 0
  %i.bm = tail call float @llvm.fmuladd.f32(float %i.bf, float %15, float %i.bl) ; 4 uses
  %foldExtExtBinop205 = fmul <2 x float> %13, %13
  %i.bn = extractelement <2 x float> %foldExtExtBinop205, i64 1
  %i.bo = extractelement <2 x float> %13, i64 0   ; 2 uses
...
_ZN10aiVector3tIfE9NormalizeEv.exit53:            ; preds = %_ZN10aiVector3tIfE9NormalizeEv.exit46, %_ZN10aiVector3tIfEdVEf.exit.i51
  %.sroa.0112.0 = phi <2 x float> [ %13, %_ZN10aiVector3tIfE9NormalizeEv.exit46 ], [ %i.bv, %_ZN10aiVector3tIfEdVEf.exit.i51 ] ; 2 uses
  ...
  %16 = shufflevector <2 x float> %11, <2 x float> poison, <4 x i32> zeroinitializer
  %i.ca = fmul <4 x float> %16, %i.y
  ...
  %17 = shufflevector <2 x float> %10, <2 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %i.cl = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %17, <4 x float> %i.x, <4 x float> %i.ca)
  %18 = shufflevector <2 x float> %10, <2 x float> poison, <4 x i32> zeroinitializer
  %i.cm = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %18, <4 x float> %i.w, <4 x float> %i.cl)
