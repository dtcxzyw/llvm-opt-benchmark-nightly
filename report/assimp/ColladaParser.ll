...
_ZN10aiVector3tIfE9NormalizeEv.exit46:            ; preds = %_ZN10aiVector3tIfE9NormalizeEv.exit, %_ZN10aiVector3tIfEdVEf.exit.i44
  %.sroa.0120.0 = phi <2 x float> [ %i.bb, %_ZN10aiVector3tIfE9NormalizeEv.exit ], [ %i.bl, %_ZN10aiVector3tIfEdVEf.exit.i44 ] ; 4 uses
...
_ZN10aiVector3tIfE9NormalizeEv.exit53:            ; preds = %_ZN10aiVector3tIfE9NormalizeEv.exit46, %_ZN10aiVector3tIfEdVEf.exit.i51
  ...
  %3 = shufflevector <2 x float> %.sroa.0120.0, <2 x float> poison, <3 x i32> <i32 0, i32 1, i32 poison>
  %4 = insertelement <3 x float> %3, float %.sroa.8123.0, i64 2
  %5 = fneg <3 x float> %4                        ; 3 uses
  ...
  %6 = shufflevector <3 x float> %5, <3 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %i.cz = fmul <4 x float> %i.y, %6
  %i.da = shufflevector <3 x float> %5, <3 x float> poison, <4 x i32> zeroinitializer
  %i.db = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.da, <4 x float> %i.x, <4 x float> %i.cz)
  %7 = shufflevector <3 x float> %5, <3 x float> poison, <4 x i32> <i32 2, i32 2, i32 2, i32 2>
  %i.dc = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %7, <4 x float> %i.w, <4 x float> %i.db)
