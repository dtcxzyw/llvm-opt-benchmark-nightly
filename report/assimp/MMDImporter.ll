...
begin_hunk_1
  ...
  %i.agc = invoke noalias noundef nonnull dereferenceable(1120) ptr @_Znwm(i64 noundef 1120) #26
          to label %bb.cu unwind label %bb.cz     ; 15 uses
...
begin_hunk_2
  ...
  %i.agi = getelementptr inbounds nuw i8, ptr %i.agc, i64 1100 ; 3 uses
...
begin_hunk_3
  ...
  store <4 x float> zeroinitializer, ptr %i.age, align 4
  store float 1.000000e+00, ptr %i.agf, align 4
  store <4 x float> zeroinitializer, ptr %i.agg, align 4
  store float 1.000000e+00, ptr %i.agh, align 4
  store <4 x float> zeroinitializer, ptr %i.agi, align 4
  store float 1.000000e+00, ptr %i.agj, align 4
