...
bb.b:                                             ; preds = %bb.a
  ...
  %2 = load i32, ptr %i.c, align 8
  %3 = zext i32 %2 to i64
  %i.h = shl nuw nsw i64 %3, 2
  %i.i = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %i.h) #21
          to label %.preheader287 unwind label %bb.c ; 6 uses

.preheader287:                                    ; preds = %bb.b
  %4 = load i32, ptr %i.c, align 8
  %.not330 = icmp eq i32 %4, 0
  br i1 %.not330, label %bb.bz, label %.lr.ph322

.lr.ph322:                                        ; preds = %.preheader287
...
bb.bz:                                            ; preds = %.preheader287, %._crit_edge323
