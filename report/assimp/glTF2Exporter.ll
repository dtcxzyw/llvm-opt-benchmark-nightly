...
bb.a:
  ...
  %4 = load <4 x float>, ptr %i.n, align 4
  %5 = shufflevector <4 x float> %4, <4 x float> poison, <2 x i32> <i32 0, i32 poison> ; 2 uses
  %i.o = getelementptr inbounds nuw i8, ptr %0, i64 24 ; 2 uses
  %i.p = load float, ptr %i.o, align 4            ; 3 uses
  %i.q = getelementptr inbounds nuw i8, ptr %0, i64 40 ; 2 uses
  %6 = load float, ptr %i.q, align 4              ; 3 uses
  %7 = getelementptr inbounds nuw i8, ptr %1, i64 4
  %i.r = load float, ptr %i.k, align 4            ; 4 uses
  %8 = load float, ptr %0, align 4                ; 3 uses
  %9 = load float, ptr %i.l, align 4              ; 4 uses
  %10 = load float, ptr %i.c, align 4             ; 2 uses
  %11 = load float, ptr %i.m, align 4             ; 4 uses
  %12 = load float, ptr %i.g, align 4             ; 3 uses
  %13 = fmul float %9, %9
  %14 = insertelement <2 x float> poison, float %i.p, i64 0
  %15 = insertelement <2 x float> %14, float %10, i64 1 ; 2 uses
  %16 = fmul <2 x float> %15, %15
  %i.s = tail call float @llvm.fmuladd.f32(float %i.r, float %i.r, float %13)
  %17 = insertelement <2 x float> %5, float %8, i64 1 ; 2 uses
  %18 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %17, <2 x float> %17, <2 x float> %16)
  %i.t = tail call noundef float @llvm.fmuladd.f32(float %11, float %11, float %i.s)
  %19 = insertelement <2 x float> poison, float %6, i64 0
  %20 = insertelement <2 x float> %19, float %12, i64 1 ; 2 uses
...
._crit_edge:                                      ; preds = %bb.a
  ...
  %25 = insertelement <2 x float> %22, float %.pre, i64 1
  br label %bb.c

bb.b:                                             ; preds = %bb.a
  %26 = fneg <2 x float> %22                      ; 3 uses
  %i.dd = fneg float %sqrt.i32                    ; 2 uses
  %27 = shufflevector <2 x float> %26, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %.sroa.0.0.vec.insert.i = insertelement <2 x float> %27, float %i.dd, i64 1
  store <2 x float> %.sroa.0.0.vec.insert.i, ptr %1, align 4
  %28 = extractelement <2 x float> %26, i64 0
  store float %28, ptr %i.u, align 4
  br label %bb.c

bb.c:                                             ; preds = %._crit_edge, %bb.b
  %i.de = phi float [ %sqrt.i32, %._crit_edge ], [ %i.dd, %bb.b ] ; 2 uses
  %29 = phi <2 x float> [ %25, %._crit_edge ], [ %26, %bb.b ] ; 2 uses
  %30 = fcmp une <2 x float> %29, zeroinitializer ; 3 uses
  %31 = fdiv <2 x float> splat (float 1.000000e+00), %29 ; 3 uses
  %i.df = extractelement <2 x float> %31, i64 1   ; 2 uses
  %i.dg = fmul float %8, %i.df
  %32 = extractelement <2 x i1> %30, i64 1        ; 2 uses
  %.sroa.1260.0.a = select i1 %32, float %i.dg, float %8 ; 6 uses
  %i.dh = fcmp une float %i.de, 0.000000e+00      ; 3 uses
  %i.di = fdiv float 1.000000e+00, %i.de          ; 3 uses
  %33 = fmul float %9, %i.di
  %i.dj = fmul float %11, %i.di
  %.sroa.22.0 = select i1 %i.dh, float %33, float %9 ; 6 uses
  %.sroa.27.0 = select i1 %i.dh, float %i.dj, float %11 ; 4 uses
  %34 = insertelement <2 x float> %5, float %10, i64 1 ; 2 uses
  %35 = fmul <2 x float> %34, %31
  %36 = fmul float %i.r, %i.di
  %37 = fmul float %12, %i.df
  %.sroa.27.0.a = select i1 %32, float %37, float %12 ; 4 uses
  %.sroa.17.0 = select i1 %i.dh, float %36, float %i.r ; 4 uses
  %38 = extractelement <2 x float> %31, i64 0     ; 2 uses
  %i.dk = fmul float %i.p, %38
  %i.dl = fmul float %6, %38
  %39 = select <2 x i1> %30, <2 x float> %35, <2 x float> %34 ; 7 uses
  %40 = extractelement <2 x i1> %30, i64 0        ; 2 uses
  %.sroa.37.0 = select i1 %40, float %i.dk, float %i.p ; 4 uses
  %.sroa.42.0 = select i1 %40, float %i.dl, float %6 ; 6 uses
  %i.dm = fadd float %.sroa.1260.0.a, %.sroa.22.0
...
bb.d:                                             ; preds = %bb.c
  ...
  %41 = insertelement <2 x float> poison, float %.sroa.27.0.a, i64 0
  %42 = insertelement <2 x float> %41, float %.sroa.17.0, i64 1
  ...
  %i.dt = fsub float %.sroa.27.0, %.sroa.37.0
  ...
  %45 = shufflevector <4 x float> %i.dv, <4 x float> %44, <4 x i32> <i32 0, i32 1, i32 4, i32 5> ; 2 uses
  %i.dw = fmul <4 x float> %45, %i.ds
  %i.dx = fdiv <4 x float> %45, %i.ds
...
bb.e:                                             ; preds = %bb.c
  %i.dz = fcmp ogt float %.sroa.1260.0.a, %.sroa.22.0
  %i.ea = fcmp ogt float %.sroa.1260.0.a, %.sroa.42.0
  %or.cond.i = and i1 %i.dz, %i.ea
  br i1 %or.cond.i, label %bb.f, label %bb.g

bb.f:                                             ; preds = %bb.e
  %i.eb = fadd float %.sroa.1260.0.a, 1.000000e+00
  ...
  %i.eh = fadd float %46, %.sroa.17.0
  %47 = extractelement <2 x float> %39, i64 0
  %i.ei = fadd float %.sroa.27.0.a, %47
  %i.ej = fsub float %.sroa.27.0, %.sroa.37.0
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.et = fsub float %i.es, %.sroa.1260.0.a
  ...
  %i.ex = fadd float %48, %.sroa.17.0
  %i.ey = fadd float %.sroa.27.0, %.sroa.37.0
  %49 = extractelement <2 x float> %39, i64 0
  %i.ez = fsub float %49, %.sroa.27.0.a
...
bb.i:                                             ; preds = %bb.g
  ...
  %i.fj = fsub float %i.fi, %.sroa.1260.0.a
  ...
  %i.fn = fadd float %.sroa.27.0.a, %50
  %i.fo = fadd float %.sroa.27.0, %.sroa.37.0
  %51 = extractelement <2 x float> %39, i64 1
  %i.fp = fsub float %51, %.sroa.17.0
