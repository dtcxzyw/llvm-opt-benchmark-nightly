...
bb.cg:                                            ; preds = %_ZNK6aiMesh19GetNumColorChannelsEv.exit
  %i.ya = load i32, ptr %i.fy, align 8            ; 2 uses
...
_ZNSt6vectorIjSaIjEE6resizeEm.exit:               ; preds = %.noexc658, %_ZSt6fill_nIPjmjET_S1_T0_RKT1_.exit.loopexit.i.i.i30.i
  ...
  %.pre1002 = load i32, ptr %i.fy, align 8
  %i.zx = icmp eq i32 %.pre1002, 0
  br i1 %i.zx, label %._crit_edge912.split, label %.preheader772.lr.ph

.preheader772.lr.ph:                              ; preds = %bb.co, %_ZNSt6vectorIjSaIjEE6resizeEm.exit
  %.sroa.12.01130 = phi i64 [ %i.zw, %_ZNSt6vectorIjSaIjEE6resizeEm.exit ], [ 0, %bb.co ] ; 2 uses
  %.sroa.0686.11128 = phi ptr [ %i.zr, %_ZNSt6vectorIjSaIjEE6resizeEm.exit ], [ null, %bb.co ] ; 3 uses
  %i.zy = zext i32 %i.zn to i64                   ; 3 uses
  %.not942 = icmp eq i32 %i.zn, 0
  br i1 %.not942, label %._crit_edge912.split, label %.preheader772.preheader

.preheader772.preheader:                          ; preds = %.preheader772.lr.ph
  %xtraiter = and i64 %i.zy, 1
  %16 = icmp eq i32 %i.zn, 1
  %unroll_iter = and i64 %i.zy, 4294967294
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  %lcmp.mod1187 = trunc i32 %i.zn to i1
  br label %.preheader772

.preheader772:                                    ; preds = %.preheader772.preheader, %._crit_edge910
  %.0338911 = phi i64 [ %17, %._crit_edge910 ], [ 0, %.preheader772.preheader ] ; 5 uses
  %i.zz = mul nuw i64 %.0338911, %i.zy
  %i.aaa = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0686.11128, i64 %i.zz ; 3 uses
  br i1 %16, label %.epil.preheader, label %.preheader772.new

._crit_edge912.split:                             ; preds = %._crit_edge910, %.preheader772.lr.ph, %_ZNSt6vectorIjSaIjEE6resizeEm.exit
  %.sroa.12.01131 = phi i64 [ %i.zw, %_ZNSt6vectorIjSaIjEE6resizeEm.exit ], [ %.sroa.12.01130, %.preheader772.lr.ph ], [ %.sroa.12.01130, %._crit_edge910 ]
  %.sroa.0686.11129 = phi ptr [ %i.zr, %_ZNSt6vectorIjSaIjEE6resizeEm.exit ], [ %.sroa.0686.11128, %.preheader772.lr.ph ], [ %.sroa.0686.11128, %._crit_edge910 ] ; 4 uses
  %i.aab = load ptr, ptr %i.af, align 8
  %i.aac = ptrtoint ptr %.sroa.0686.11129 to i64
  %i.aad = sub i64 %.sroa.12.01131, %i.aac        ; 3 uses
  %i.aae = ashr exact i64 %i.aad, 2
  %i.aaf = invoke { ptr, i32 } @_Z10ExportDataRN5glTF25AssetERNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEERN10glTFCommon3RefINS_6BufferEEEmPvNS_10AttribType5ValueESG_NS_13ComponentTypeENS_16BufferViewTargetE(ptr noundef nonnull align 8 dereferenceable(3624) %i.aab, ptr noundef nonnull align 8 dereferenceable(32) %11, ptr noundef nonnull align 8 dereferenceable(12) %5, i64 noundef %i.aae, ptr noundef nonnull %.sroa.0686.11129, i32 noundef 0, i32 noundef 0, i32 noundef 5125, i32 noundef 34963)
...
._crit_edge910.unr-lcssa:                         ; preds = %.preheader772.new
  br i1 %lcmp.mod.not, label %._crit_edge910, label %.epil.preheader

.epil.preheader:                                  ; preds = %._crit_edge910.unr-lcssa, %.preheader772
  %.0339908.epil.init = phi i64 [ 0, %.preheader772 ], [ %i.abf, %._crit_edge910.unr-lcssa ] ; 2 uses
  call void @llvm.assume(i1 %lcmp.mod1187)
  %i.aah = load ptr, ptr %i.zl, align 8
  %i.aai = getelementptr inbounds nuw [16 x i8], ptr %i.aah, i64 %.0338911
  %i.aaj = getelementptr inbounds nuw i8, ptr %i.aai, i64 8
  %i.aak = load ptr, ptr %i.aaj, align 8
  %i.aal = getelementptr inbounds nuw [4 x i8], ptr %i.aak, i64 %.0339908.epil.init
  %i.aam = load i32, ptr %i.aal, align 4
  %i.aan = getelementptr inbounds nuw [4 x i8], ptr %i.aaa, i64 %.0339908.epil.init
  store i32 %i.aam, ptr %i.aan, align 4
  br label %._crit_edge910

._crit_edge910:                                   ; preds = %._crit_edge910.unr-lcssa, %.epil.preheader
  %17 = add nuw nsw i64 %.0338911, 1              ; 2 uses
  %18 = load i32, ptr %i.fy, align 8
  %i.aao = zext i32 %18 to i64
  %i.aap = icmp samesign ult i64 %17, %i.aao
  br i1 %i.aap, label %.preheader772, label %._crit_edge912.split, !llvm.loop !67

.preheader772.new:                                ; preds = %.preheader772, %.preheader772.new
  %.0339908 = phi i64 [ %i.abf, %.preheader772.new ], [ 0, %.preheader772 ] ; 4 uses
  %niter = phi i64 [ %niter.next.1, %.preheader772.new ], [ 0, %.preheader772 ]
  %i.aaq = load ptr, ptr %i.zl, align 8
  %i.aar = getelementptr inbounds nuw [16 x i8], ptr %i.aaq, i64 %.0338911
  %i.aas = getelementptr inbounds nuw i8, ptr %i.aar, i64 8
  %i.aat = load ptr, ptr %i.aas, align 8
  %i.aau = getelementptr inbounds nuw [4 x i8], ptr %i.aat, i64 %.0339908
  %i.aav = load i32, ptr %i.aau, align 4
  %i.aaw = getelementptr inbounds nuw [4 x i8], ptr %i.aaa, i64 %.0339908
  store i32 %i.aav, ptr %i.aaw, align 4
  %i.aax = or disjoint i64 %.0339908, 1           ; 2 uses
  %i.aay = load ptr, ptr %i.zl, align 8
  %i.aaz = getelementptr inbounds nuw [16 x i8], ptr %i.aay, i64 %.0338911
  %i.aba = getelementptr inbounds nuw i8, ptr %i.aaz, i64 8
  %i.abb = load ptr, ptr %i.aba, align 8
  %i.abc = getelementptr inbounds nuw [4 x i8], ptr %i.abb, i64 %i.aax
  %i.abd = load i32, ptr %i.abc, align 4
  %i.abe = getelementptr inbounds nuw [4 x i8], ptr %i.aaa, i64 %i.aax
  store i32 %i.abd, ptr %i.abe, align 4
  %i.abf = add nuw nsw i64 %.0339908, 2           ; 2 uses
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge910.unr-lcssa, label %.preheader772.new, !llvm.loop !68

_ZNSt6vectorIjSaIjEED2Ev.exit:                    ; preds = %._crit_edge912.split
  %.fca.0.extract107 = extractvalue { ptr, i32 } %i.aaf, 0
  %.fca.1.extract108 = extractvalue { ptr, i32 } %i.aaf, 1
  %i.abg = getelementptr inbounds i8, ptr %i.lt, i64 -64
  store ptr %.fca.0.extract107, ptr %i.abg, align 8
  ...
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0686.11129, i64 noundef %i.aad) #32
  br label %bb.cq

bb.cp:                                            ; preds = %._crit_edge912.split
...
bb.cq:                                            ; preds = %_ZNSt6vectorIjSaIjEED2Ev.exit, %bb.cg
  %i.abi = load i32, ptr %i.fx, align 8           ; 2 uses
  %switch.selectcmp = icmp eq i32 %i.abi, 2
  %switch.select = select i1 %switch.selectcmp, i32 1, i32 4
  %switch.selectcmp1149 = icmp eq i32 %i.abi, 1
  %switch.select1150 = select i1 %switch.selectcmp1149, i32 0, i32 %switch.select
  store i32 %switch.select1150, ptr %i.lu, align 8
  %i.abj = getelementptr inbounds nuw i8, ptr %i.fx, i64 224
  %i.abk = load ptr, ptr %i.abj, align 8
  %.not.i528 = icmp ne ptr %i.abk, null
  %i.abl = getelementptr inbounds nuw i8, ptr %i.fx, i64 216
  %i.abm = load i32, ptr %i.abl, align 8
  %i.abn = icmp ne i32 %i.abm, 0
  %i.abo = select i1 %.not.i528, i1 %i.abn, i1 false
  br i1 %i.abo, label %bb.cr, label %bb.cw

bb.cr:                                            ; preds = %bb.cq
  %i.abp = load ptr, ptr %i.fo, align 8
  %i.abq = invoke noundef zeroext i1 @_ZNK6Assimp16ExportProperties15HasPropertyBoolEPKc(ptr noundef nonnull align 8 dereferenceable(240) %i.abp, ptr noundef nonnull @.str.61)
          to label %bb.cs unwind label %bb.cv

bb.cs:                                            ; preds = %bb.cr
  br i1 %i.abq, label %bb.ct, label %bb.cu

bb.ct:                                            ; preds = %bb.cs
  %i.abr = load ptr, ptr %i.fo, align 8
  %i.abs = invoke noundef i32 @_ZNK6Assimp16ExportProperties18GetPropertyIntegerEPKci(ptr noundef nonnull align 8 dereferenceable(240) %i.abr, ptr noundef nonnull @.str.61, i32 noundef 0)
...
_ZNK6Assimp16ExportProperties15GetPropertyBoolEPKcb.exit: ; preds = %bb.ct
  %i.abt = icmp ne i32 %i.abs, 0
  br label %bb.cu

bb.cu:                                            ; preds = %_ZNK6Assimp16ExportProperties15GetPropertyBoolEPKcb.exit, %bb.cs
  %i.abu = phi i1 [ false, %bb.cs ], [ %i.abt, %_ZNK6Assimp16ExportProperties15GetPropertyBoolEPKcb.exit ]
  %i.abv = load ptr, ptr %i.af, align 8
  invoke void @_Z10ExportSkinRN5glTF25AssetEPK6aiMeshRN10glTFCommon3RefINS_4MeshEEERNS6_INS_6BufferEEERNS6_INS_4SkinEEERSt6vectorI12aiMatrix4x4tIfESaISI_EEb(ptr noundef nonnull align 8 dereferenceable(3624) %i.abv, ptr noundef nonnull %i.fx, ptr noundef nonnull align 8 dereferenceable(12) %12, ptr noundef nonnull align 8 dereferenceable(12) %5, ptr noundef nonnull align 8 dereferenceable(12) %6, ptr noundef nonnull align 8 dereferenceable(24) %9, i1 noundef zeroext %i.abu)
...
bb.cw:                                            ; preds = %bb.cu, %bb.cq
  %i.abx = getelementptr inbounds nuw i8, ptr %i.fx, i64 1264 ; 4 uses
  %i.aby = load i32, ptr %i.abx, align 8
  %.not365 = icmp eq i32 %i.aby, 0
  br i1 %.not365, label %.loopexit775, label %bb.cx

bb.cx:                                            ; preds = %bb.cw
  %i.abz = load ptr, ptr %i.fo, align 8
  %i.aca = invoke noundef zeroext i1 @_ZNK6Assimp16ExportProperties15HasPropertyBoolEPKc(ptr noundef nonnull align 8 dereferenceable(240) %i.abz, ptr noundef nonnull @.str.62)
          to label %bb.cy unwind label %bb.dh

bb.cy:                                            ; preds = %bb.cx
  br i1 %i.aca, label %bb.cz, label %bb.da

bb.cz:                                            ; preds = %bb.cy
  %i.acb = load ptr, ptr %i.fo, align 8
  %i.acc = invoke noundef i32 @_ZNK6Assimp16ExportProperties18GetPropertyIntegerEPKci(ptr noundef nonnull align 8 dereferenceable(240) %i.acb, ptr noundef nonnull @.str.62, i32 noundef 0)
...
bb.da:                                            ; preds = %_ZNK6Assimp16ExportProperties15GetPropertyBoolEPKcb.exit531, %bb.cy
  %i.ace = phi i1 [ false, %bb.cy ], [ %i.acd, %_ZNK6Assimp16ExportProperties15GetPropertyBoolEPKcb.exit531 ] ; 2 uses
  %i.acf = load ptr, ptr %i.fo, align 8
  %i.acg = invoke noundef zeroext i1 @_ZNK6Assimp16ExportProperties15HasPropertyBoolEPKc(ptr noundef nonnull align 8 dereferenceable(240) %i.acf, ptr noundef nonnull @.str.63)
          to label %bb.db unwind label %bb.di

bb.db:                                            ; preds = %bb.da
  br i1 %i.acg, label %bb.dc, label %bb.dd

bb.dc:                                            ; preds = %bb.db
  %i.ach = load ptr, ptr %i.fo, align 8
  %i.aci = invoke noundef i32 @_ZNK6Assimp16ExportProperties18GetPropertyIntegerEPKci(ptr noundef nonnull align 8 dereferenceable(240) %i.ach, ptr noundef nonnull @.str.63, i32 noundef 0)
...
bb.dd:                                            ; preds = %_ZNK6Assimp16ExportProperties15GetPropertyBoolEPKcb.exit533, %bb.db
  %i.ack = phi i1 [ false, %bb.db ], [ %i.acj, %_ZNK6Assimp16ExportProperties15GetPropertyBoolEPKcb.exit533 ]
  %i.acl = load ptr, ptr %i.fo, align 8
  %i.acm = invoke noundef zeroext i1 @_ZNK6Assimp16ExportProperties15HasPropertyBoolEPKc(ptr noundef nonnull align 8 dereferenceable(240) %i.acl, ptr noundef nonnull @.str.64)
          to label %bb.de unwind label %bb.dj

bb.de:                                            ; preds = %bb.dd
  br i1 %i.acm, label %bb.df, label %bb.dg

bb.df:                                            ; preds = %bb.de
  %i.acn = load ptr, ptr %i.fo, align 8
  %i.aco = invoke noundef i32 @_ZNK6Assimp16ExportProperties18GetPropertyIntegerEPKci(ptr noundef nonnull align 8 dereferenceable(240) %i.acn, ptr noundef nonnull @.str.64, i32 noundef 0)
...
bb.dg:                                            ; preds = %_ZNK6Assimp16ExportProperties15GetPropertyBoolEPKcb.exit535, %bb.de
  %i.acq = phi i1 [ false, %bb.de ], [ %i.acp, %_ZNK6Assimp16ExportProperties15GetPropertyBoolEPKcb.exit535 ]
  %i.acr = getelementptr inbounds i8, ptr %i.lt, i64 -32 ; 3 uses
  %i.acs = load i32, ptr %i.abx, align 8
  %i.act = zext i32 %i.acs to i64
  invoke void @_ZNSt6vectorIN5glTF24Mesh9Primitive6TargetESaIS3_EE6resizeEm(ptr noundef nonnull align 8 dereferenceable(24) %i.acr, i64 noundef %i.act)
          to label %.preheader774 unwind label %bb.dj

.preheader774:                                    ; preds = %bb.dg
  %i.acu = load i32, ptr %i.abx, align 8
  %.not943 = icmp eq i32 %i.acu, 0
  br i1 %.not943, label %.loopexit775, label %.lr.ph924

.lr.ph924:                                        ; preds = %.preheader774
  %i.acv = getelementptr inbounds nuw i8, ptr %i.fx, i64 1272
  br label %bb.dk
...
bb.dk:                                            ; preds = %.lr.ph924, %bb.es
  ...
  %i.acz = load ptr, ptr %i.acv, align 8
  %i.ada = getelementptr inbounds nuw [8 x i8], ptr %i.acz, i64 %indvars.iv987
  %i.adb = load ptr, ptr %i.ada, align 8          ; 5 uses
  br i1 %i.acq, label %bb.dl, label %_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE12emplace_backIJRA1024_cEEERS5_DpOT_.exit

bb.dl:                                            ; preds = %bb.dk
  %i.adc = load ptr, ptr %.fca.0.extract206, align 8
  %i.add = getelementptr inbounds nuw [8 x i8], ptr %i.adc, i64 %i.hp
  %i.ade = load ptr, ptr %i.add, align 8          ; 3 uses
  %i.adf = getelementptr inbounds nuw i8, ptr %i.adb, i64 4 ; 4 uses
  %i.adg = getelementptr inbounds nuw i8, ptr %i.ade, i64 320 ; 3 uses
  %i.adh = load ptr, ptr %i.adg, align 8          ; 8 uses
  %i.adi = getelementptr inbounds nuw i8, ptr %i.ade, i64 328
  %i.adj = load ptr, ptr %i.adi, align 8
  %.not.i536 = icmp eq ptr %i.adh, %i.adj
  br i1 %.not.i536, label %bb.dp, label %bb.dm

bb.dm:                                            ; preds = %bb.dl
  %i.adk = getelementptr inbounds nuw i8, ptr %i.adh, i64 16 ; 3 uses
  store ptr %i.adk, ptr %i.adh, align 8
  %i.adl = call noundef i64 @strlen(ptr noundef nonnull align 1 dereferenceable(1024) %i.adf) #31 ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #31
  store i64 %i.adl, ptr %i.b, align 8
  %i.adm = icmp ugt i64 %i.adl, 15
  br i1 %i.adm, label %.noexc.i.i, label %._crit_edge.i.i.i537

.noexc.i.i:                                       ; preds = %bb.dm
  %i.adn = invoke noundef ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm(ptr noundef nonnull align 8 dereferenceable(32) %i.adh, ptr noundef nonnull align 8 dereferenceable(8) %i.b, i64 noundef 0)
          to label %.noexc538 unwind label %bb.dq ; 2 uses

.noexc538:                                        ; preds = %.noexc.i.i
  store ptr %i.adn, ptr %i.adh, align 8
  %i.ado = load i64, ptr %i.b, align 8
  store i64 %i.ado, ptr %i.adk, align 8
  br label %._crit_edge.i.i.i537

._crit_edge.i.i.i537:                             ; preds = %.noexc538, %bb.dm
  %i.adp = phi ptr [ %i.adn, %.noexc538 ], [ %i.adk, %bb.dm ] ; 2 uses
  switch i64 %i.adl, label %bb.do [
    i64 1, label %bb.dn
...
bb.dn:                                            ; preds = %._crit_edge.i.i.i537
  %i.adq = load i8, ptr %i.adf, align 1
  store i8 %i.adq, ptr %i.adp, align 1
...
bb.do:                                            ; preds = %._crit_edge.i.i.i537
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %i.adp, ptr nonnull align 1 dereferenceable(1024) %i.adf, i64 %i.adl, i1 false)
  br label %_ZNSt15__new_allocatorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEE9constructIS5_JRA1024_cEEEvPT_DpOT0_.exit.i
...
_ZNSt15__new_allocatorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEE9constructIS5_JRA1024_cEEEvPT_DpOT0_.exit.i: ; preds = %bb.do, %bb.dn, %._crit_edge.i.i.i537
  %i.adr = load i64, ptr %i.b, align 8            ; 2 uses
  %i.ads = getelementptr inbounds nuw i8, ptr %i.adh, i64 8
  store i64 %i.adr, ptr %i.ads, align 8
  %i.adt = load ptr, ptr %i.adh, align 8
  %i.adu = getelementptr inbounds nuw i8, ptr %i.adt, i64 %i.adr
  store i8 0, ptr %i.adu, align 1
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #31
  %i.adv = load ptr, ptr %i.adg, align 8
end_hunk_0
...
bb.a:
  %.not = icmp eq i32 %5, 0
  br i1 %.not, label %._crit_edge55.split, label %.lr.ph
...
._crit_edge:                                      ; preds = %_ZNSt6vectorIdSaIdEE9push_backEOd.exit36
  ...
  br i1 %.not56, label %._crit_edge55.split, label %.preheader.preheader
...
_ZNSt6vectorIdSaIdEE9push_backEOd.exit36:         ; preds = %bb.h, %_ZNSt6vectorIdSaIdEE17_M_realloc_insertIJdEEEvN9__gnu_cxx17__normal_iteratorIPdS1_EEDpOT_.exit.i.i35
  ...
  br i1 %exitcond.not, label %._crit_edge, label %bb.b, !llvm.loop !551

.preheader:                                       ; preds = %.preheader.preheader, %._crit_edge53
  %.02654 = phi ptr [ %6, %._crit_edge53 ], [ %2, %.preheader.preheader ] ; 2 uses
  br label %8

._crit_edge53:                                    ; preds = %29
  %6 = getelementptr inbounds nuw [2 x i8], ptr %.02654, i64 %i.b ; 2 uses
  %7 = icmp ult ptr %6, %i.d
  br i1 %7, label %.preheader, label %._crit_edge55.split, !llvm.loop !552

8:                                                ; preds = %.preheader, %29
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next, %29 ] ; 4 uses
  %9 = getelementptr inbounds nuw [2 x i8], ptr %.02654, i64 %indvars.iv
  %10 = load i16, ptr %9, align 2
  %11 = sitofp i16 %10 to double                  ; 4 uses
  %12 = load ptr, ptr %0, align 8
  %13 = getelementptr inbounds nuw [8 x i8], ptr %12, i64 %i.e
  %14 = load ptr, ptr %13, align 8                ; 2 uses
  %15 = getelementptr inbounds nuw i8, ptr %14, i64 336
  %16 = load ptr, ptr %15, align 8
  %17 = getelementptr inbounds nuw [8 x i8], ptr %16, i64 %indvars.iv ; 2 uses
...
21:                                               ; preds = %20, %8
  %22 = phi ptr [ %.pre60, %20 ], [ %14, %8 ]
  %23 = getelementptr inbounds nuw i8, ptr %22, i64 312
  %24 = load ptr, ptr %23, align 8
  %25 = getelementptr inbounds nuw [8 x i8], ptr %24, i64 %indvars.iv ; 2 uses
...
29:                                               ; preds = %21, %28
  ...
  br i1 %exitcond59.not, label %._crit_edge53, label %8, !llvm.loop !553
...
_ZNSt6vectorIdSaIdEE9push_backEOd.exit36:         ; preds = %bb.h, %_ZNSt6vectorIdSaIdEE17_M_realloc_insertIJdEEEvN9__gnu_cxx17__normal_iteratorIPdS1_EEDpOT_.exit.i.i35
  %i.bf = add nuw i32 %.050, 1                    ; 2 uses
  %exitcond.not = icmp eq i32 %i.bf, %5
  br i1 %exitcond.not, label %._crit_edge, label %bb.b, !llvm.loop !554
...
._crit_edge53:                                    ; preds = %29
  %6 = getelementptr inbounds nuw [2 x i8], ptr %.02654, i64 %i.b ; 2 uses
  %7 = icmp ult ptr %6, %i.d
  br i1 %7, label %.preheader, label %._crit_edge55.split, !llvm.loop !555

8:                                                ; preds = %.preheader, %29
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next, %29 ] ; 4 uses
  %9 = getelementptr inbounds nuw [2 x i8], ptr %.02654, i64 %indvars.iv
  %10 = load i16, ptr %9, align 2
  %11 = uitofp i16 %10 to double                  ; 4 uses
  %12 = load ptr, ptr %0, align 8
  %13 = getelementptr inbounds nuw [8 x i8], ptr %12, i64 %i.e
  %14 = load ptr, ptr %13, align 8                ; 2 uses
  %15 = getelementptr inbounds nuw i8, ptr %14, i64 336
...
29:                                               ; preds = %21, %28
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond59.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond59.not, label %._crit_edge53, label %8, !llvm.loop !556
...
_ZNSt6vectorIdSaIdEE9push_backEOd.exit36:         ; preds = %bb.h, %_ZNSt6vectorIdSaIdEE17_M_realloc_insertIJdEEEvN9__gnu_cxx17__normal_iteratorIPdS1_EEDpOT_.exit.i.i35
  %i.bf = add nuw i32 %.050, 1                    ; 2 uses
  %exitcond.not = icmp eq i32 %i.bf, %5
  br i1 %exitcond.not, label %._crit_edge, label %bb.b, !llvm.loop !557
...
._crit_edge53:                                    ; preds = %29
  %6 = getelementptr inbounds nuw [4 x i8], ptr %.02654, i64 %i.b ; 2 uses
  %7 = icmp ult ptr %6, %i.d
  br i1 %7, label %.preheader, label %._crit_edge55.split, !llvm.loop !558

8:                                                ; preds = %.preheader, %29
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next, %29 ] ; 4 uses
  %9 = getelementptr inbounds nuw [4 x i8], ptr %.02654, i64 %indvars.iv
  %10 = load i32, ptr %9, align 4
  %11 = uitofp i32 %10 to double                  ; 4 uses
  %12 = load ptr, ptr %0, align 8
  %13 = getelementptr inbounds nuw [8 x i8], ptr %12, i64 %i.e
  %14 = load ptr, ptr %13, align 8                ; 2 uses
  %15 = getelementptr inbounds nuw i8, ptr %14, i64 336
...
29:                                               ; preds = %21, %28
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond59.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond59.not, label %._crit_edge53, label %8, !llvm.loop !559
...
._crit_edge53:                                    ; preds = %32
  %6 = getelementptr inbounds nuw [4 x i8], ptr %.02654, i64 %i.b ; 2 uses
  %7 = icmp ult ptr %6, %i.d
  br i1 %7, label %.preheader, label %._crit_edge55.split, !llvm.loop !561

8:                                                ; preds = %.preheader, %32
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next, %32 ] ; 4 uses
  %9 = getelementptr inbounds nuw [4 x i8], ptr %.02654, i64 %indvars.iv
  %10 = load float, ptr %9, align 4
  %11 = fpext float %10 to double                 ; 5 uses
...
14:                                               ; preds = %8
  ...
  %16 = getelementptr inbounds nuw [8 x i8], ptr %15, i64 %i.e
  %17 = load ptr, ptr %16, align 8                ; 2 uses
  %18 = getelementptr inbounds nuw i8, ptr %17, i64 336
  %19 = load ptr, ptr %18, align 8
  %20 = getelementptr inbounds nuw [8 x i8], ptr %19, i64 %indvars.iv ; 2 uses
...
24:                                               ; preds = %23, %14
  %25 = phi ptr [ %.pre60, %23 ], [ %17, %14 ]
  %26 = getelementptr inbounds nuw i8, ptr %25, i64 312
  %27 = load ptr, ptr %26, align 8
  %28 = getelementptr inbounds nuw [8 x i8], ptr %27, i64 %indvars.iv ; 2 uses
...
32:                                               ; preds = %24, %31, %8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond59.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond59.not, label %._crit_edge53, label %8, !llvm.loop !562
...
_ZNSt6vectorIdSaIdEE9push_backEOd.exit36:         ; preds = %bb.h, %_ZNSt6vectorIdSaIdEE17_M_realloc_insertIJdEEEvN9__gnu_cxx17__normal_iteratorIPdS1_EEDpOT_.exit.i.i35
  %i.bf = add nuw i32 %.050, 1                    ; 2 uses
  %exitcond.not = icmp eq i32 %i.bf, %5
  br i1 %exitcond.not, label %._crit_edge, label %bb.b, !llvm.loop !563
...
._crit_edge53:                                    ; preds = %29
  %6 = getelementptr inbounds nuw i8, ptr %.02654, i64 %i.b ; 2 uses
  %7 = icmp ult ptr %6, %i.d
  br i1 %7, label %.preheader, label %._crit_edge55.split, !llvm.loop !564

8:                                                ; preds = %.preheader, %29
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next, %29 ] ; 4 uses
  %9 = getelementptr inbounds nuw i8, ptr %.02654, i64 %indvars.iv
  %10 = load i8, ptr %9, align 1
  %11 = sitofp i8 %10 to double                   ; 4 uses
  %12 = load ptr, ptr %0, align 8
  %13 = getelementptr inbounds nuw [8 x i8], ptr %12, i64 %i.e
  %14 = load ptr, ptr %13, align 8                ; 2 uses
  %15 = getelementptr inbounds nuw i8, ptr %14, i64 336
...
29:                                               ; preds = %21, %28
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond59.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond59.not, label %._crit_edge53, label %8, !llvm.loop !565
...
_ZNSt6vectorIdSaIdEE9push_backEOd.exit36:         ; preds = %bb.h, %_ZNSt6vectorIdSaIdEE17_M_realloc_insertIJdEEEvN9__gnu_cxx17__normal_iteratorIPdS1_EEDpOT_.exit.i.i35
  %i.bf = add nuw i32 %.050, 1                    ; 2 uses
  %exitcond.not = icmp eq i32 %i.bf, %5
  br i1 %exitcond.not, label %._crit_edge, label %bb.b, !llvm.loop !566
...
._crit_edge53:                                    ; preds = %29
  %6 = getelementptr inbounds nuw i8, ptr %.02654, i64 %i.b ; 2 uses
  %7 = icmp ult ptr %6, %i.d
  br i1 %7, label %.preheader, label %._crit_edge55.split, !llvm.loop !567

8:                                                ; preds = %.preheader, %29
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next, %29 ] ; 4 uses
  %9 = getelementptr inbounds nuw i8, ptr %.02654, i64 %indvars.iv
  %10 = load i8, ptr %9, align 1
  %11 = uitofp i8 %10 to double                   ; 4 uses
  %12 = load ptr, ptr %0, align 8
  %13 = getelementptr inbounds nuw [8 x i8], ptr %12, i64 %i.e
  %14 = load ptr, ptr %13, align 8                ; 2 uses
  %15 = getelementptr inbounds nuw i8, ptr %14, i64 336
...
29:                                               ; preds = %21, %28
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond59.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond59.not, label %._crit_edge53, label %8, !llvm.loop !568
