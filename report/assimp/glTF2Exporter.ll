...
begin_hunk_1_@_ZN9rapidjson8internal6Grisu2EdPcPiS2_:bb.a
  ...
  %6 = add nsw i32 %.sink.i, 64
  %7 = sub nsw i32 %6, %i.am
  %i.bi = add nsw i32 %7, %i.ak
...
begin_hunk_2_@_ZN9rapidjson8internal6Grisu2EdPcPiS2_:bb.a
  ...
  %i.bs = add nuw nsw i64 %i.bq, 2147483648
  %i.bt = add nuw nsw i64 %i.bs, %i.bp
  %i.bu = add nuw nsw i64 %i.bt, %i.br
  ...
  %i.cb = add i32 %.sroa.7.0.lcssa.i.i, 54
  %i.cc = add i32 %i.cb, %i.ak
...
begin_hunk_3_@_ZN9rapidjson8internal6Grisu2EdPcPiS2_:bb.a
  ...
  %i.cm = add nuw nsw i64 %i.ck, 2147483648
