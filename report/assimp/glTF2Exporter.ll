...
.preheader772.lr.ph:                              ; preds = %bb.co, %_ZNSt6vectorIjSaIjEE6resizeEm.exit
  %.sroa.12.01132 = phi i64 [ %i.zw, %_ZNSt6vectorIjSaIjEE6resizeEm.exit ], [ 0, %bb.co ] ; 2 uses
  %.sroa.0686.11130 = phi ptr [ %i.zr, %_ZNSt6vectorIjSaIjEE6resizeEm.exit ], [ null, %bb.co ] ; 3 uses
  %i.zx = zext i32 %i.zn to i64                   ; 3 uses
  %.not942 = icmp eq i32 %i.zn, 0
  br i1 %.not942, label %._crit_edge912, label %.preheader772.a

.preheader772.a:                                  ; preds = %.preheader772.lr.ph
...
.lr.ph909:                                        ; preds = %.preheader772.a, %._crit_edge910
  %.0338911 = phi i64 [ %17, %._crit_edge910 ], [ 0, %.preheader772.a ] ; 5 uses
  %i.zy = mul nuw i64 %.0338911, %i.zx
  %i.zz = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0686.11130, i64 %i.zy ; 3 uses
  br i1 %16, label %.epil.preheader, label %.lr.ph909.new

._crit_edge912:                                   ; preds = %._crit_edge910, %.preheader772.lr.ph, %_ZNSt6vectorIjSaIjEE6resizeEm.exit
  %.sroa.12.01131 = phi i64 [ %i.zw, %_ZNSt6vectorIjSaIjEE6resizeEm.exit ], [ %.sroa.12.01132, %.preheader772.lr.ph ], [ %.sroa.12.01132, %._crit_edge910 ]
  %.sroa.0686.11129 = phi ptr [ %i.zr, %_ZNSt6vectorIjSaIjEE6resizeEm.exit ], [ %.sroa.0686.11130, %.preheader772.lr.ph ], [ %.sroa.0686.11130, %._crit_edge910 ] ; 4 uses
  %i.aaa = load ptr, ptr %i.af, align 8
  %i.aab = ptrtoint ptr %.sroa.0686.11129 to i64
  %i.aac = sub i64 %.sroa.12.01131, %i.aab        ; 3 uses
  %i.aad = ashr exact i64 %i.aac, 2
  %i.aae = invoke { ptr, i32 } @_Z10ExportDataRN5glTF25AssetERNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEERN10glTFCommon3RefINS_6BufferEEEmPvNS_10AttribType5ValueESG_NS_13ComponentTypeENS_16BufferViewTargetE(ptr noundef nonnull align 8 dereferenceable(3624) %i.aaa, ptr noundef nonnull align 8 dereferenceable(32) %11, ptr noundef nonnull align 8 dereferenceable(12) %5, i64 noundef %i.aad, ptr noundef nonnull %.sroa.0686.11129, i32 noundef 0, i32 noundef 0, i32 noundef 5125, i32 noundef 34963)
...
._crit_edge910:                                   ; preds = %._crit_edge910.loopexit.unr-lcssa, %.epil.preheader
  %17 = add nuw nsw i64 %.0338911, 1              ; 2 uses
  %18 = load i32, ptr %i.fy, align 8
  %i.aan = zext i32 %18 to i64
  %i.aao = icmp samesign ult i64 %17, %i.aan
  br i1 %i.aao, label %.lr.ph909, label %._crit_edge912, !llvm.loop !67
...
_ZNSt6vectorIjSaIjEED2Ev.exit:                    ; preds = %._crit_edge912
  ...
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0686.11129, i64 noundef %i.aac) #32
  br label %bb.cq
...
.preheader:                                       ; preds = %.preheader.us.preheader, %._crit_edge53
  %.02654 = phi ptr [ %6, %._crit_edge53 ], [ %2, %.preheader.us.preheader ] ; 2 uses
  br label %8

._crit_edge53:                                    ; preds = %29
  %6 = getelementptr inbounds nuw [2 x i8], ptr %.02654, i64 %i.b ; 2 uses
  %7 = icmp ult ptr %6, %i.d
  br i1 %7, label %.preheader, label %._crit_edge55, !llvm.loop !552
...
._crit_edge55:                                    ; preds = %._crit_edge53, %bb.a, %._crit_edge
  ret void
}
...
._crit_edge53:                                    ; preds = %29
  %6 = getelementptr inbounds nuw [2 x i8], ptr %.02654, i64 %i.b ; 2 uses
  %7 = icmp ult ptr %6, %i.d
  br i1 %7, label %.preheader, label %._crit_edge55, !llvm.loop !555
...
._crit_edge53:                                    ; preds = %29
  ...
  %7 = icmp ult ptr %6, %i.d
  br i1 %7, label %.preheader, label %._crit_edge55, !llvm.loop !558
...
._crit_edge53:                                    ; preds = %32
  %6 = getelementptr inbounds nuw [4 x i8], ptr %.02654, i64 %i.b ; 2 uses
  %7 = icmp ult ptr %6, %i.d
  br i1 %7, label %.preheader, label %._crit_edge55, !llvm.loop !561
...
._crit_edge53:                                    ; preds = %29
  ...
  %7 = icmp ult ptr %6, %i.d
  br i1 %7, label %.preheader, label %._crit_edge55, !llvm.loop !564
...
._crit_edge53:                                    ; preds = %29
  %6 = getelementptr inbounds nuw i8, ptr %.02654, i64 %i.b ; 2 uses
  %7 = icmp ult ptr %6, %i.d
  br i1 %7, label %.preheader, label %._crit_edge55, !llvm.loop !567
