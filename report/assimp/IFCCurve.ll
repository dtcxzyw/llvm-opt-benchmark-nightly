...
bb.a:
  ...
  %16 = alloca %class.aiVector3t, align 8         ; 8 uses
...
bb.c:                                             ; preds = %bb.b
  %i.m = tail call noalias noundef nonnull dereferenceable(48) ptr @_Znwm(i64 noundef 48) #31 ; 10 uses
  ...
  %i.q = getelementptr inbounds nuw i8, ptr %i.l, i64 80 ; 2 uses
...
bb.e:                                             ; preds = %bb.c
  ...
  br i1 %.not28.i, label %_ZNSt6vectorI10aiVector3tIdESaIS1_EE7reserveEm.exit.i, label %_ZNSt12_Vector_baseI10aiVector3tIdESaIS1_EE11_M_allocateEm.exit.i.i
...
_ZNSt12_Vector_baseI10aiVector3tIdESaIS1_EE11_M_allocateEm.exit.i.i: ; preds = %bb.e
  ...
  %i.ab = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.aa) #31
          to label %.lr.ph.i.a unwind label %.thread313 ; 4 uses

.lr.ph.i.a:                                       ; preds = %_ZNSt12_Vector_baseI10aiVector3tIdESaIS1_EE11_M_allocateEm.exit.i.i
  ...
  %.pre20.i = load ptr, ptr %i.r, align 8
  br label %_ZNSt6vectorI10aiVector3tIdESaIS1_EE7reserveEm.exit.i

_ZNSt6vectorI10aiVector3tIdESaIS1_EE7reserveEm.exit.i: ; preds = %.lr.ph.i.a, %bb.e
  %17 = phi ptr [ %i.ab, %.lr.ph.i.a ], [ null, %bb.e ]
  %18 = phi ptr [ %.pre20.i, %.lr.ph.i.a ], [ %i.s, %bb.e ] ; 2 uses
  %19 = phi ptr [ %.pre.i, %.lr.ph.i.a ], [ %i.t, %bb.e ] ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %16) #30
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %16, i8 0, i64 24, i1 false)
  %.not18.i = icmp eq ptr %19, %18
  br i1 %.not18.i, label %.thread164, label %.lr.ph.i

.thread164:                                       ; preds = %_ZNSt6vectorI10aiVector3tIdESaIS1_EE7reserveEm.exit.i
...
.lr.ph.i:                                         ; preds = %_ZNSt6vectorI10aiVector3tIdESaIS1_EE7reserveEm.exit.i
  %20 = getelementptr inbounds nuw i8, ptr %i.m, i64 32 ; 3 uses
  br label %bb.f
...
bb.f:                                             ; preds = %_ZNSt6vectorI10aiVector3tIdESaIS1_EE9push_backERKS1_.exit.i, %.lr.ph.i
  %i.af = phi ptr [ %17, %.lr.ph.i ], [ %i.bb, %_ZNSt6vectorI10aiVector3tIdESaIS1_EE9push_backERKS1_.exit.i ] ; 5 uses
  %.sroa.015.019.i = phi ptr [ %19, %.lr.ph.i ], [ %i.bc, %_ZNSt6vectorI10aiVector3tIdESaIS1_EE9push_backERKS1_.exit.i ] ; 2 uses
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.ai = load ptr, ptr %20, align 8
  %i.aj = getelementptr inbounds nuw i8, ptr %i.ai, i64 24 ; 2 uses
  store ptr %i.aj, ptr %20, align 8
...
_ZNKSt6vectorI10aiVector3tIdESaIS1_EE12_M_check_lenEmPKc.exit.i.i.i: ; preds = %bb.j
  %i.ap = sdiv exact i64 %i.an, 24                ; 3 uses
  ...
  %i.as = call i64 @llvm.umin.i64(i64 %i.aq, i64 384307168202282325)
  %i.at = select i1 %i.ar, i64 384307168202282325, i64 %i.as ; 3 uses
...
.noexc13.i:                                       ; preds = %_ZNKSt6vectorI10aiVector3tIdESaIS1_EE12_M_check_lenEmPKc.exit.i.i.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.aw, ptr noundef nonnull align 8 dereferenceable(24) %16, i64 24, i1 false)
...
.lr.ph.i.i.i.i.i.i:                               ; preds = %.noexc13.i, %.lr.ph.i.i.i.i.i.i
  %.012.i.i.i.i.i.i = phi ptr [ %i.ay, %.lr.ph.i.i.i.i.i.i ], [ %i.av, %.noexc13.i ] ; 2 uses
  %.0911.i.i.i.i.i.i = phi ptr [ %i.ax, %.lr.ph.i.i.i.i.i.i ], [ %i.ak, %.noexc13.i ] ; 2 uses
  ...
  %i.ax = getelementptr inbounds nuw i8, ptr %.0911.i.i.i.i.i.i, i64 24 ; 2 uses
  %i.ay = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i.i.i, i64 24 ; 2 uses
  %.not.i.i.i.i.i.i = icmp eq ptr %i.ax, %i.af
...
_ZNSt6vectorI10aiVector3tIdESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit22.i.i.i: ; preds = %.lr.ph.i.i.i.i.i.i, %.noexc13.i
  %.0.lcssa.i.i.i.i.i.i = phi ptr [ %i.av, %.noexc13.i ], [ %i.ay, %.lr.ph.i.i.i.i.i.i ]
  %i.az = getelementptr inbounds nuw i8, ptr %.0.lcssa.i.i.i.i.i.i, i64 24 ; 2 uses
...
_ZNSt6vectorI10aiVector3tIdESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i: ; preds = %bb.l, %_ZNSt6vectorI10aiVector3tIdESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit22.i.i.i
  store ptr %i.av, ptr %i.p, align 8
  store ptr %i.az, ptr %20, align 8
  %i.ba = getelementptr inbounds nuw [24 x i8], ptr %i.av, i64 %i.at
...
_ZNSt6vectorI10aiVector3tIdESaIS1_EE9push_backERKS1_.exit.i: ; preds = %_ZNSt6vectorI10aiVector3tIdESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i, %bb.i
  %i.bb = phi ptr [ %i.az, %_ZNSt6vectorI10aiVector3tIdESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i ], [ %i.aj, %bb.i ]
  %i.bc = getelementptr inbounds nuw i8, ptr %.sroa.015.019.i, i64 8 ; 2 uses
  %.not.i = icmp eq ptr %i.bc, %18
...
bb.n:                                             ; preds = %bb.m
  ...
  call void @_ZdlPvm(ptr noundef nonnull %.pre, i64 noundef %i.bg) #33
  br label %.body
...
.thread:                                          ; preds = %bb.b
  %i.bh = tail call noundef ptr @__dynamic_cast(ptr nonnull align 8 dereferenceable(24) %i.j, ptr nonnull @_ZTIN6Assimp4STEP6ObjectE, ptr nonnull @_ZTIN6Assimp3IFC10Schema_2x315IfcTrimmedCurveE, i64 -1) #30 ; 9 uses
  %.not49.not = icmp eq ptr %i.bh, null
  br i1 %.not49.not, label %.thread190, label %.noexc

.noexc:                                           ; preds = %.thread
  %i.bi = tail call noalias noundef nonnull dereferenceable(72) ptr @_Znwm(i64 noundef 72) #31 ; 14 uses
  %i.bj = getelementptr inbounds nuw i8, ptr %i.bi, i64 8
  store ptr %i.bh, ptr %i.bj, align 8
  %i.bk = getelementptr inbounds nuw i8, ptr %i.bi, i64 16
  store ptr %1, ptr %i.bk, align 8
  store ptr getelementptr inbounds nuw inrange(-16, 64) (i8, ptr @_ZTVN6Assimp3IFC12_GLOBAL__N_112TrimmedCurveE, i64 16), ptr %i.bi, align 8
  %i.bl = getelementptr inbounds nuw i8, ptr %i.bi, i64 24 ; 7 uses
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.bl, i8 0, i64 16, i1 false)
  %i.bm = getelementptr inbounds nuw i8, ptr %i.bi, i64 56 ; 6 uses
  %i.bn = getelementptr inbounds nuw i8, ptr %i.bh, i64 80
  %i.bo = invoke noundef nonnull align 8 dereferenceable(41) ptr @_ZNK6Assimp4STEP4LazyINS_3IFC10Schema_2x38IfcCurveEEcvRKS4_Ev(ptr noundef nonnull align 8 dereferenceable(8) %i.bn)
          to label %bb.p unwind label %bb.y, !inline_history !9

bb.p:                                             ; preds = %.noexc
  %i.bp = invoke noundef ptr @_ZN6Assimp3IFC5Curve7ConvertERKNS0_10Schema_2x38IfcCurveERNS0_14ConversionDataE(ptr noundef nonnull align 8 dereferenceable(41) %i.bo, ptr noundef nonnull align 8 dereferenceable(392) %1)
          to label %bb.q unwind label %bb.y, !inline_history !9 ; 5 uses

bb.q:                                             ; preds = %bb.p
  store ptr %i.bp, ptr %i.bm, align 8
  %i.bq = getelementptr inbounds nuw i8, ptr %i.bi, i64 64 ; 2 uses
  store ptr null, ptr %i.bq, align 8
  %i.br = invoke noalias noundef nonnull dereferenceable(24) ptr @_Znwm(i64 noundef 24) #31
...
bb.r:                                             ; preds = %bb.q
  ...
  %i.bu = tail call ptr @__cxa_begin_catch(ptr %i.bt) #30 ; 0 uses
  %i.bv = icmp eq ptr %i.bp, null
...
bb.s:                                             ; preds = %bb.r
  ...
  tail call void %i.by(ptr noundef nonnull align 8 dead_on_return(24) dereferenceable(24) %i.bp) #30, !inline_history !10
  br label %bb.t
...
bb.v:                                             ; preds = %bb.u
  ...
  tail call void @__clang_call_terminate(ptr %i.cb) #34
  unreachable
...
bb.x:                                             ; preds = %bb.q
  ...
  %i.cd = getelementptr inbounds nuw i8, ptr %i.br, i64 12
  store i32 1, ptr %i.cd, align 4
  store ptr getelementptr inbounds nuw inrange(-16, 40) (i8, ptr @_ZTVSt15_Sp_counted_ptrIPN6Assimp3IFC5CurveELN9__gnu_cxx12_Lock_policyE2EE, i64 16), ptr %i.br, align 8
  %i.ce = getelementptr inbounds nuw i8, ptr %i.br, i64 16
  store ptr %i.bp, ptr %i.ce, align 8
  store ptr %i.br, ptr %i.bq, align 8
  call void @llvm.lifetime.start.p0(ptr nonnull %10) #30
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %10, i8 0, i64 24, i1 false)
  %i.cf = getelementptr inbounds nuw i8, ptr %i.bh, i64 88
  %i.cg = load ptr, ptr %i.cf, align 8            ; 2 uses
  %i.ch = getelementptr inbounds nuw i8, ptr %i.bh, i64 96
  %i.ci = load ptr, ptr %i.ch, align 8            ; 3 uses
  %.not202223 = icmp eq ptr %i.cg, %i.ci
...
.outer326:                                        ; preds = %_ZNK6Assimp4STEP7EXPRESS8DataType16ResolveSelectPtrINS_3IFC10Schema_2x317IfcCartesianPointEEEPKT_RKNS0_2DBE.exit103.thread.thread, %.lr.ph
  ...
  %.sroa.0155.0224.ph = phi ptr [ %i.cz, %_ZNK6Assimp4STEP7EXPRESS8DataType16ResolveSelectPtrINS_3IFC10Schema_2x317IfcCartesianPointEEEPKT_RKNS0_2DBE.exit103.thread.thread ], [ %i.cg, %.lr.ph ]
  br label %bb.z
...
bb.z:                                             ; preds = %.outer326, %_ZNK6Assimp4STEP7EXPRESS8DataType16ResolveSelectPtrINS_3IFC10Schema_2x317IfcCartesianPointEEEPKT_RKNS0_2DBE.exit103.thread
  %.sroa.0155.0224 = phi ptr [ %i.cy, %_ZNK6Assimp4STEP7EXPRESS8DataType16ResolveSelectPtrINS_3IFC10Schema_2x317IfcCartesianPointEEEPKT_RKNS0_2DBE.exit103.thread ], [ %.sroa.0155.0224.ph, %.outer326 ] ; 3 uses
  %i.cl = load ptr, ptr %.sroa.0155.0224, align 8 ; 2 uses
  %i.cm = call noundef ptr @__dynamic_cast(ptr nonnull align 8 dereferenceable(8) %i.cl, ptr nonnull @_ZTIN6Assimp4STEP7EXPRESS8DataTypeE, ptr nonnull @_ZTIN6Assimp4STEP7EXPRESS17PrimitiveDataTypeIdEE, i64 0) #30 ; 2 uses
  %.not.i62 = icmp eq ptr %i.cm, null
  br i1 %.not.i62, label %bb.aa, label %.thread171

bb.aa:                                            ; preds = %bb.z
  %i.cn = call noundef ptr @__dynamic_cast(ptr nonnull align 8 dereferenceable(8) %i.cl, ptr nonnull @_ZTIN6Assimp4STEP7EXPRESS8DataTypeE, ptr nonnull @_ZTIN6Assimp4STEP7EXPRESS6ENTITYE, i64 0) #30 ; 2 uses
  %.not.i97 = icmp eq ptr %i.cn, null
...
bb.ab:                                            ; preds = %bb.aa
  %i.co = load ptr, ptr %i.cj, align 8, !nonnull !11, !align !12
  %i.cp = getelementptr inbounds nuw i8, ptr %i.cn, i64 8
  %i.cq = load i64, ptr %i.cp, align 8
  %i.cr = invoke noundef nonnull align 8 dereferenceable(40) ptr @_ZNK6Assimp4STEP2DB13MustGetObjectEm(ptr noundef nonnull align 8 dereferenceable(392) %i.co, i64 noundef %i.cq)
...
.noexc101:                                        ; preds = %bb.ab
  ...
  %.not.i.i.i98 = icmp eq ptr %i.ct, null
...
bb.ac:                                            ; preds = %.noexc101
  invoke void @_ZNK6Assimp4STEP10LazyObject8LazyInitEv(ptr noundef nonnull align 8 dereferenceable(40) %i.cr)
          to label %.noexc102 unwind label %.loopexit327

.noexc102:                                        ; preds = %bb.ac
  %.pre.i.i.i100 = load ptr, ptr %i.cs, align 8
...
_ZNK6Assimp4STEP7EXPRESS8DataType16ResolveSelectPtrINS_3IFC10Schema_2x317IfcCartesianPointEEEPKT_RKNS0_2DBE.exit103: ; preds = %.noexc101, %.noexc102
  %i.cu = phi ptr [ %.pre.i.i.i100, %.noexc102 ], [ %i.ct, %.noexc101 ]
  %i.cv = call noundef ptr @__dynamic_cast(ptr nonnull align 8 dereferenceable(24) %i.cu, ptr nonnull @_ZTIN6Assimp4STEP6ObjectE, ptr nonnull @_ZTIN6Assimp3IFC10Schema_2x317IfcCartesianPointE, i64 -1) #30 ; 2 uses
  %.not67.i = icmp eq ptr %i.cv, null
...
bb.ad:                                            ; preds = %_ZNK6Assimp4STEP7EXPRESS8DataType16ResolveSelectPtrINS_3IFC10Schema_2x317IfcCartesianPointEEEPKT_RKNS0_2DBE.exit103
  invoke void @_ZN6Assimp3IFC21ConvertCartesianPointER10aiVector3tIdERKNS0_10Schema_2x317IfcCartesianPointE(ptr noundef nonnull align 8 dereferenceable(24) %10, ptr noundef nonnull align 8 dereferenceable(88) %i.cv)
...
.thread171:                                       ; preds = %bb.z
  ...
  store double %i.cx, ptr %i.bl, align 8
  br label %bb.ak

_ZNK6Assimp4STEP7EXPRESS8DataType16ResolveSelectPtrINS_3IFC10Schema_2x317IfcCartesianPointEEEPKT_RKNS0_2DBE.exit103.thread: ; preds = %bb.aa, %_ZNK6Assimp4STEP7EXPRESS8DataType16ResolveSelectPtrINS_3IFC10Schema_2x317IfcCartesianPointEEEPKT_RKNS0_2DBE.exit103
  %i.cy = getelementptr inbounds nuw i8, ptr %.sroa.0155.0224, i64 16 ; 2 uses
  %.not202 = icmp eq ptr %i.cy, %i.ci
  br i1 %.not202, label %._crit_edge, label %bb.z

_ZNK6Assimp4STEP7EXPRESS8DataType16ResolveSelectPtrINS_3IFC10Schema_2x317IfcCartesianPointEEEPKT_RKNS0_2DBE.exit103.thread.thread: ; preds = %bb.ad
  %i.cz = getelementptr inbounds nuw i8, ptr %.sroa.0155.0224, i64 16 ; 2 uses
end_hunk_0
begin_hunk_1_@_ZN6Assimp3IFC5Curve7ConvertERKNS0_10Schema_2x38IfcCurveERNS0_14ConversionDataE:bb.a
  %i.of = getelementptr inbounds nuw i8, ptr %i.oc, i64 24 ; 2 uses
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(96) %i.of, i8 0, i64 96, i1 false)
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #30
  store double 1.000000e+00, ptr %3, align 8
  %i.og = getelementptr inbounds nuw i8, ptr %3, i64 8 ; 2 uses
  %i.oh = getelementptr inbounds nuw i8, ptr %3, i64 40 ; 2 uses
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.og, i8 0, i64 32, i1 false)
  store double 1.000000e+00, ptr %i.oh, align 8
  %i.oi = getelementptr inbounds nuw i8, ptr %3, i64 48 ; 2 uses
  %i.oj = getelementptr inbounds nuw i8, ptr %3, i64 80 ; 2 uses
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.oi, i8 0, i64 32, i1 false)
  store double 1.000000e+00, ptr %i.oj, align 8
  %i.ok = getelementptr inbounds nuw i8, ptr %3, i64 88 ; 2 uses
  %i.ol = getelementptr inbounds nuw i8, ptr %3, i64 120
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.ok, i8 0, i64 32, i1 false)
  store double 1.000000e+00, ptr %i.ol, align 8
  %i.om = getelementptr inbounds nuw i8, ptr %i.ob, i64 64
  %i.on = load ptr, ptr %i.om, align 8
  invoke void @_ZN6Assimp3IFC20ConvertAxisPlacementER12aiMatrix4x4tIdERKNS_4STEP7EXPRESS8DataTypeERNS0_14ConversionDataE(ptr noundef nonnull align 8 dereferenceable(128) %3, ptr noundef nonnull align 8 dereferenceable(8) %i.on, ptr noundef nonnull align 8 dereferenceable(392) %1)
          to label %bb.dv unwind label %bb.du

bb.du:                                            ; preds = %bb.dt
  %i.oo = landingpad { ptr, i32 }
          cleanup
  call void @_ZdlPvm(ptr noundef nonnull %i.oc, i64 noundef 128) #33
  br label %bb.ec

bb.dv:                                            ; preds = %bb.dt
  %scevgep.i.i = getelementptr inbounds nuw i8, ptr %i.oc, i64 48
  %i.op = getelementptr inbounds nuw i8, ptr %3, i64 24
  %i.oq = load double, ptr %i.op, align 8
  %i.or = getelementptr inbounds nuw i8, ptr %3, i64 56
  %i.os = load double, ptr %i.or, align 8
  %i.ot = load double, ptr %i.ok, align 8
  store double %i.oq, ptr %i.of, align 8
  %.sroa.415.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.oc, i64 32
  store double %i.os, ptr %.sroa.415.0..sroa_idx.i.i, align 8
  %.sroa.516.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.oc, i64 40
  store double %i.ot, ptr %.sroa.516.0..sroa_idx.i.i, align 8
  %i.ou = load double, ptr %3, align 8
  %i.ov = getelementptr inbounds nuw i8, ptr %3, i64 32
  %i.ow = load double, ptr %i.ov, align 8
  %i.ox = getelementptr inbounds nuw i8, ptr %3, i64 64
  %i.oy = load double, ptr %i.ox, align 8
  store double %i.ou, ptr %scevgep.i.i, align 8
  %.sroa.412.0..ptr7.sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.oc, i64 56
  store double %i.ow, ptr %.sroa.412.0..ptr7.sroa_idx.i.i, align 8
  %.sroa.513.0..ptr7.sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.oc, i64 64
  store double %i.oy, ptr %.sroa.513.0..ptr7.sroa_idx.i.i, align 8
  %i.oz = load double, ptr %i.og, align 8
  %i.pa = load double, ptr %i.oh, align 8
  %i.pb = getelementptr inbounds nuw i8, ptr %3, i64 72
  %i.pc = load double, ptr %i.pb, align 8
  %i.pd = getelementptr inbounds nuw i8, ptr %i.oc, i64 72
  store double %i.oz, ptr %i.pd, align 8
  %.sroa.49.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.oc, i64 80
  store double %i.pa, ptr %.sroa.49.0..sroa_idx.i.i, align 8
  %.sroa.510.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.oc, i64 88
  store double %i.pc, ptr %.sroa.510.0..sroa_idx.i.i, align 8
  %i.pe = getelementptr inbounds nuw i8, ptr %3, i64 16
  %i.pf = load double, ptr %i.pe, align 8
  %i.pg = load double, ptr %i.oi, align 8
  %i.ph = load double, ptr %i.oj, align 8
  %i.pi = getelementptr inbounds nuw i8, ptr %i.oc, i64 96
  store double %i.pf, ptr %i.pi, align 8
  %.sroa.4.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.oc, i64 104
  store double %i.pg, ptr %.sroa.4.0..sroa_idx.i.i, align 8
  %.sroa.5.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.oc, i64 112
  store double %i.ph, ptr %.sroa.5.0..sroa_idx.i.i, align 8
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #30
  store ptr getelementptr inbounds nuw inrange(-16, 64) (i8, ptr @_ZTVN6Assimp3IFC12_GLOBAL__N_16CircleE, i64 16), ptr %i.oc, align 8
  %i.pj = getelementptr inbounds nuw i8, ptr %i.oc, i64 120
  store ptr %i.ob, ptr %i.pj, align 8
  br label %_ZN6Assimp3IFC12_GLOBAL__N_114CompositeCurveC2ERKNS0_10Schema_2x317IfcCompositeCurveERNS0_14ConversionDataE.exit

bb.dw:                                            ; preds = %bb.ds
  %i.pk = tail call noundef ptr @__dynamic_cast(ptr nonnull align 8 dereferenceable(24) %i.j, ptr nonnull @_ZTIN6Assimp4STEP6ObjectE, ptr nonnull @_ZTIN6Assimp3IFC10Schema_2x310IfcEllipseE, i64 -1) #30 ; 4 uses
  %.not53.not = icmp eq ptr %i.pk, null
  br i1 %.not53.not, label %.thread200, label %bb.dx

bb.dx:                                            ; preds = %bb.dw
  %i.pl = tail call noalias noundef nonnull dereferenceable(128) ptr @_Znwm(i64 noundef 128) #31 ; 19 uses
  ...
  store ptr %1, ptr %i.pn, align 8
  store ptr getelementptr inbounds nuw inrange(-16, 64) (i8, ptr @_ZTVN6Assimp3IFC12_GLOBAL__N_15ConicE, i64 16), ptr %i.pl, align 8
  %i.po = getelementptr inbounds nuw i8, ptr %i.pl, i64 24 ; 2 uses
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(96) %i.po, i8 0, i64 96, i1 false)
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #30
  store double 1.000000e+00, ptr %2, align 8
  %i.pp = getelementptr inbounds nuw i8, ptr %2, i64 8 ; 2 uses
  %i.pq = getelementptr inbounds nuw i8, ptr %2, i64 40 ; 2 uses
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.pp, i8 0, i64 32, i1 false)
  store double 1.000000e+00, ptr %i.pq, align 8
  %i.pr = getelementptr inbounds nuw i8, ptr %2, i64 48 ; 2 uses
  %i.ps = getelementptr inbounds nuw i8, ptr %2, i64 80 ; 2 uses
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.pr, i8 0, i64 32, i1 false)
  store double 1.000000e+00, ptr %i.ps, align 8
  %i.pt = getelementptr inbounds nuw i8, ptr %2, i64 88 ; 2 uses
  %i.pu = getelementptr inbounds nuw i8, ptr %2, i64 120
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.pt, i8 0, i64 32, i1 false)
  store double 1.000000e+00, ptr %i.pu, align 8
  %i.pv = getelementptr inbounds nuw i8, ptr %i.pk, i64 64
  %i.pw = load ptr, ptr %i.pv, align 8
  invoke void @_ZN6Assimp3IFC20ConvertAxisPlacementER12aiMatrix4x4tIdERKNS_4STEP7EXPRESS8DataTypeERNS0_14ConversionDataE(ptr noundef nonnull align 8 dereferenceable(128) %2, ptr noundef nonnull align 8 dereferenceable(8) %i.pw, ptr noundef nonnull align 8 dereferenceable(392) %1)
          to label %bb.dz unwind label %bb.dy

bb.dy:                                            ; preds = %bb.dx
  %i.px = landingpad { ptr, i32 }
          cleanup
  call void @_ZdlPvm(ptr noundef nonnull %i.pl, i64 noundef 128) #33
  br label %bb.ec

bb.dz:                                            ; preds = %bb.dx
  %scevgep.i.i72 = getelementptr inbounds nuw i8, ptr %i.pl, i64 48
  %i.py = getelementptr inbounds nuw i8, ptr %2, i64 24
  %i.pz = load double, ptr %i.py, align 8
  %i.qa = getelementptr inbounds nuw i8, ptr %2, i64 56
  %i.qb = load double, ptr %i.qa, align 8
  %i.qc = load double, ptr %i.pt, align 8
  store double %i.pz, ptr %i.po, align 8
  %.sroa.415.0..sroa_idx.i.i73 = getelementptr inbounds nuw i8, ptr %i.pl, i64 32
  store double %i.qb, ptr %.sroa.415.0..sroa_idx.i.i73, align 8
  %.sroa.516.0..sroa_idx.i.i74 = getelementptr inbounds nuw i8, ptr %i.pl, i64 40
  store double %i.qc, ptr %.sroa.516.0..sroa_idx.i.i74, align 8
  %i.qd = load double, ptr %2, align 8
  %i.qe = getelementptr inbounds nuw i8, ptr %2, i64 32
  %i.qf = load double, ptr %i.qe, align 8
  %i.qg = getelementptr inbounds nuw i8, ptr %2, i64 64
  %i.qh = load double, ptr %i.qg, align 8
  store double %i.qd, ptr %scevgep.i.i72, align 8
  %.sroa.412.0..ptr7.sroa_idx.i.i75 = getelementptr inbounds nuw i8, ptr %i.pl, i64 56
  store double %i.qf, ptr %.sroa.412.0..ptr7.sroa_idx.i.i75, align 8
  %.sroa.513.0..ptr7.sroa_idx.i.i76 = getelementptr inbounds nuw i8, ptr %i.pl, i64 64
  store double %i.qh, ptr %.sroa.513.0..ptr7.sroa_idx.i.i76, align 8
  %i.qi = load double, ptr %i.pp, align 8
  %i.qj = load double, ptr %i.pq, align 8
  %i.qk = getelementptr inbounds nuw i8, ptr %2, i64 72
  %i.ql = load double, ptr %i.qk, align 8
  %i.qm = getelementptr inbounds nuw i8, ptr %i.pl, i64 72
  store double %i.qi, ptr %i.qm, align 8
  %.sroa.49.0..sroa_idx.i.i77 = getelementptr inbounds nuw i8, ptr %i.pl, i64 80
  store double %i.qj, ptr %.sroa.49.0..sroa_idx.i.i77, align 8
  %.sroa.510.0..sroa_idx.i.i78 = getelementptr inbounds nuw i8, ptr %i.pl, i64 88
  store double %i.ql, ptr %.sroa.510.0..sroa_idx.i.i78, align 8
  %i.qn = getelementptr inbounds nuw i8, ptr %2, i64 16
  %i.qo = load double, ptr %i.qn, align 8
  %i.qp = load double, ptr %i.pr, align 8
  %i.qq = load double, ptr %i.ps, align 8
  %i.qr = getelementptr inbounds nuw i8, ptr %i.pl, i64 96
  store double %i.qo, ptr %i.qr, align 8
  %.sroa.4.0..sroa_idx.i.i79 = getelementptr inbounds nuw i8, ptr %i.pl, i64 104
  store double %i.qp, ptr %.sroa.4.0..sroa_idx.i.i79, align 8
  %.sroa.5.0..sroa_idx.i.i80 = getelementptr inbounds nuw i8, ptr %i.pl, i64 112
  store double %i.qq, ptr %.sroa.5.0..sroa_idx.i.i80, align 8
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #30
  store ptr getelementptr inbounds nuw inrange(-16, 64) (i8, ptr @_ZTVN6Assimp3IFC12_GLOBAL__N_17EllipseE, i64 16), ptr %i.pl, align 8
  %i.qs = getelementptr inbounds nuw i8, ptr %i.pl, i64 120
  store ptr %i.pk, ptr %i.qs, align 8
  br label %_ZN6Assimp3IFC12_GLOBAL__N_114CompositeCurveC2ERKNS0_10Schema_2x317IfcCompositeCurveERNS0_14ConversionDataE.exit

.thread200:                                       ; preds = %bb.dw, %_ZN6Assimp3IFC12_GLOBAL__N_114CompositeCurveC2ERKNS0_10Schema_2x317IfcCompositeCurveERNS0_14ConversionDataE.exit.thread
  %i.qt = tail call noundef ptr @__dynamic_cast(ptr nonnull align 8 dereferenceable(24) %i.j, ptr nonnull @_ZTIN6Assimp4STEP6ObjectE, ptr nonnull @_ZTIN6Assimp3IFC10Schema_2x37IfcLineE, i64 -1) #30 ; 4 uses
  %.not54.not = icmp eq ptr %i.qt, null
  br i1 %.not54.not, label %_ZN6Assimp3IFC12_GLOBAL__N_114CompositeCurveC2ERKNS0_10Schema_2x317IfcCompositeCurveERNS0_14ConversionDataE.exit, label %bb.ea

bb.ea:                                            ; preds = %.thread200
  %i.qu = tail call noalias noundef nonnull dereferenceable(72) ptr @_Znwm(i64 noundef 72) #31 ; 7 uses
  %i.qv = getelementptr inbounds nuw i8, ptr %i.qu, i64 8
  store ptr %i.qt, ptr %i.qv, align 8
  %i.qw = getelementptr inbounds nuw i8, ptr %i.qu, i64 16
  store ptr %1, ptr %i.qw, align 8
  store ptr getelementptr inbounds nuw inrange(-16, 64) (i8, ptr @_ZTVN6Assimp3IFC12_GLOBAL__N_14LineE, i64 16), ptr %i.qu, align 8
  %i.qx = getelementptr inbounds nuw i8, ptr %i.qu, i64 24 ; 2 uses
  %i.qy = getelementptr inbounds nuw i8, ptr %i.qu, i64 48
  %i.qz = getelementptr inbounds nuw i8, ptr %i.qt, i64 64
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %i.qx, i8 0, i64 48, i1 false)
  %i.ra = invoke noundef nonnull align 8 dereferenceable(88) ptr @_ZNK6Assimp4STEP4LazyINS_3IFC10Schema_2x317IfcCartesianPointEEcvRKS4_Ev(ptr noundef nonnull align 8 dereferenceable(8) %i.qz)
          to label %.noexc82 unwind label %bb.eb

.noexc82:                                         ; preds = %bb.ea
  invoke void @_ZN6Assimp3IFC21ConvertCartesianPointER10aiVector3tIdERKNS0_10Schema_2x317IfcCartesianPointE(ptr noundef nonnull align 8 dereferenceable(24) %i.qx, ptr noundef nonnull align 8 dereferenceable(88) %i.ra)
          to label %.noexc83 unwind label %bb.eb

.noexc83:                                         ; preds = %.noexc82
  %i.rb = getelementptr inbounds nuw i8, ptr %i.qt, i64 72
  %i.rc = invoke noundef nonnull align 8 dereferenceable(64) ptr @_ZNK6Assimp4STEP4LazyINS_3IFC10Schema_2x39IfcVectorEEcvRKS4_Ev(ptr noundef nonnull align 8 dereferenceable(8) %i.rb)
          to label %.noexc84 unwind label %bb.eb

.noexc84:                                         ; preds = %.noexc83
  invoke void @_ZN6Assimp3IFC13ConvertVectorER10aiVector3tIdERKNS0_10Schema_2x39IfcVectorE(ptr noundef nonnull align 8 dereferenceable(24) %i.qy, ptr noundef nonnull align 8 dereferenceable(64) %i.rc)
          to label %_ZN6Assimp3IFC12_GLOBAL__N_114CompositeCurveC2ERKNS0_10Schema_2x317IfcCompositeCurveERNS0_14ConversionDataE.exit unwind label %bb.eb

bb.eb:                                            ; preds = %.noexc84, %.noexc83, %.noexc82, %bb.ea
  %i.rd = landingpad { ptr, i32 }
          cleanup
  tail call void @_ZdlPvm(ptr noundef nonnull %i.qu, i64 noundef 72) #33
  br label %bb.ec

_ZN6Assimp3IFC12_GLOBAL__N_114CompositeCurveC2ERKNS0_10Schema_2x317IfcCompositeCurveERNS0_14ConversionDataE.exit: ; preds = %.thread200, %.noexc84, %._crit_edge237, %bb.bk, %bb.o, %bb.dz, %bb.dv, %.thread164
  %.8 = phi ptr [ %i.m, %bb.o ], [ %i.ha, %._crit_edge237 ], [ %i.pl, %bb.dz ], [ %i.oc, %bb.dv ], [ %i.m, %.thread164 ], [ %i.bi, %bb.bk ], [ null, %.thread200 ], [ %i.qu, %.noexc84 ]
  ret ptr %.8

bb.ec:                                            ; preds = %bb.eb, %bb.dy, %bb.du, %.body69, %.body63, %.body
  %.pn = phi { ptr, i32 } [ %i.rd, %bb.eb ], [ %i.px, %bb.dy ], [ %i.oo, %bb.du ], [ %.pn29.pn.pn.pn.i, %.body69 ], [ %eh.lpad-body64, %.body63 ], [ %.pn.i316, %.body ]
  resume { ptr, i32 } %.pn
}
...
; Function Attrs: mustprogress uwtable
define hidden noundef double @_ZNK6Assimp3IFC5Curve23GetParametricRangeDeltaEv(ptr noundef nonnull align 8 dereferenceable(24) %0) local_unnamed_addr #0 align 2 {
bb.a:
...
; Function Attrs: mustprogress uwtable
define hidden noundef double @_ZN6Assimp3IFC15RecursiveSearchEPKNS0_5CurveERK10aiVector3tIdEddjdjj(ptr noundef %0, ptr noundef nonnull readonly align 8 captures(none) dereferenceable(24) %1, double noundef %2, double noundef %3, i32 noundef %4, double noundef %5, i32 noundef %6, i32 noundef %7) local_unnamed_addr #0 {
bb.a:
  %8 = alloca %class.aiVector3t, align 8          ; 6 uses
  %9 = alloca %class.aiVector3t, align 8          ; 6 uses
  %i.a = fsub double %3, %2
  %i.b = uitofp i32 %4 to double
...
._crit_edge:                                      ; preds = %bb.e, %bb.a
  %.sroa.0.0.lcssa = phi double [ +inf, %bb.a ], [ %.sroa.0.1, %bb.e ]
  %.sroa.016.0.lcssa = phi double [ %2, %bb.a ], [ %.sroa.016.1, %bb.e ] ; 8 uses
  %.sroa.12.0.lcssa = phi double [ %3, %bb.a ], [ %.sroa.12.1, %bb.e ] ; 5 uses
  %i.h = fsub double %2, %.sroa.016.0.lcssa
  %i.i = call double @llvm.fabs.f64(double %i.h)
  %i.j = fcmp uge double %i.i, %5
  %.not = icmp ult i32 %6, %7
  %or.cond = and i1 %.not, %i.j
  br i1 %or.cond, label %bb.f, label %bb.j

bb.b:                                             ; preds = %.lr.ph, %bb.e
  %.sroa.12.067 = phi double [ %3, %.lr.ph ], [ %.sroa.12.1, %bb.e ]
  %.sroa.016.066 = phi double [ %2, %.lr.ph ], [ %.sroa.016.1, %bb.e ] ; 3 uses
  %.sroa.7.065 = phi double [ +inf, %.lr.ph ], [ %.sroa.7.1, %bb.e ] ; 2 uses
  %.05164 = phi i32 [ 0, %.lr.ph ], [ %i.ab, %bb.e ]
  %.05263 = phi double [ %2, %.lr.ph ], [ %i.ac, %bb.e ] ; 4 uses
  %.sroa.0.062 = phi double [ +inf, %.lr.ph ], [ %.sroa.0.1, %bb.e ] ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %8) #30
  %i.k = load ptr, ptr %0, align 8
  %i.l = getelementptr inbounds nuw i8, ptr %i.k, i64 24
  %i.m = load ptr, ptr %i.l, align 8
  call void %i.m(ptr dead_on_unwind nonnull writable sret(%class.aiVector3t) align 8 %8, ptr noundef nonnull align 8 dereferenceable(24) %0, double noundef %.05263)
  %i.n = load double, ptr %8, align 8, !noalias !26
  %i.o = load double, ptr %1, align 8, !noalias !26
  %i.p = fsub double %i.n, %i.o                   ; 2 uses
  %i.q = load double, ptr %i.d, align 8, !noalias !26
  %i.r = load double, ptr %i.e, align 8, !noalias !26
  %i.s = fsub double %i.q, %i.r                   ; 2 uses
  %i.t = load double, ptr %i.f, align 8, !noalias !26
  %i.u = load double, ptr %i.g, align 8, !noalias !26
  %i.v = fsub double %i.t, %i.u                   ; 2 uses
  %i.w = fmul double %i.s, %i.s
  %i.x = call double @llvm.fmuladd.f64(double %i.p, double %i.p, double %i.w)
  %i.y = call noundef double @llvm.fmuladd.f64(double %i.v, double %i.v, double %i.x) ; 4 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #30
  %i.z = fcmp olt double %i.y, %.sroa.0.062
  br i1 %i.z, label %bb.e, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.aa = fcmp olt double %i.y, %.sroa.7.065
...
bb.e:                                             ; preds = %bb.b, %bb.c, %bb.d
  %.sroa.0.1 = phi double [ %.sroa.0.062, %bb.c ], [ %.sroa.0.062, %bb.d ], [ %i.y, %bb.b ] ; 2 uses
  %.sroa.7.1 = phi double [ %.sroa.7.065, %bb.c ], [ %i.y, %bb.d ], [ %.sroa.0.062, %bb.b ]
  %.sroa.016.1 = phi double [ %.sroa.016.066, %bb.c ], [ %.sroa.016.066, %bb.d ], [ %.05263, %bb.b ] ; 2 uses
  %.sroa.12.1 = phi double [ %.sroa.12.067, %bb.c ], [ %.05263, %bb.d ], [ %.sroa.016.066, %bb.b ] ; 2 uses
  %i.ab = add nuw i32 %.05164, 1                  ; 2 uses
