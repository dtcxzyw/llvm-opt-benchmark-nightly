...
bb.g:                                             ; preds = %bb.f
  ...
  %9 = load <2 x float>, ptr %i.af, align 4       ; 7 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  %foldExtExtBinop = fsub <2 x float> %shift, %9
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.bv = shufflevector <2 x float> %i.ap, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %12 = shufflevector <2 x float> %i.br, <2 x float> %9, <4 x i32> <i32 0, i32 2, i32 poison, i32 poison>
  %13 = fadd <4 x float> %i.bv, %12
  %i.bw = shufflevector <4 x float> %i.bu, <4 x float> %13, <4 x i32> <i32 0, i32 1, i32 4, i32 5> ; 2 uses
...
bb.l:                                             ; preds = %bb.k
  ...
  %14 = extractelement <2 x float> %i.ap, i64 0
  %15 = fadd float %14, %i.am
  %16 = extractelement <2 x float> %9, i64 1
  %17 = fadd float %i.ao, %16
  %shift75 = shufflevector <2 x float> %i.ap, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop76 = fsub <2 x float> %shift75, %9
  %18 = extractelement <2 x float> %foldExtExtBinop76, i64 0
  %i.cg = insertelement <4 x float> <float poison, float poison, float 2.500000e-01, float poison>, float %18, i64 0
  %19 = insertelement <4 x float> %i.cg, float %15, i64 1
  %20 = insertelement <4 x float> %19, float %17, i64 3 ; 2 uses
  ...
  %i.cj = fdiv <4 x float> %20, %i.ci
  %i.ck = fmul <4 x float> %20, %i.ci
...
bb.m:                                             ; preds = %bb.k
  ...
  %21 = shufflevector <2 x float> %i.ap, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %22 = insertelement <2 x float> %21, float %i.ao, i64 1
  %23 = fadd <2 x float> %22, %9
  ...
  %24 = shufflevector <2 x float> %23, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %25 = shufflevector <4 x float> %i.ct, <4 x float> %24, <4 x i32> <i32 0, i32 4, i32 5, i32 3> ; 2 uses
  ...
  %i.cw = fdiv <4 x float> %25, %i.cv
  %i.cx = fmul <4 x float> %25, %i.cv
