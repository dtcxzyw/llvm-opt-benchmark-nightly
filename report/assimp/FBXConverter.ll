...
_ZNSt12_Vector_baseIlSaIlEE11_M_allocateEm.exit.i: ; preds = %bb.b
  %4 = shl nuw nsw i64 %.sroa.speculated, 3
  %5 = tail call noalias noundef nonnull ptr @_Znwm(i64 noundef %4) #31 ; 4 uses
  %6 = getelementptr inbounds nuw i8, ptr %0, i64 8
  store ptr %5, ptr %0, align 8
  store ptr %5, ptr %6, align 8
  %i.h = getelementptr inbounds nuw [8 x i8], ptr %5, i64 %.sroa.speculated ; 2 uses
...
_ZNSt6vectorIlSaIlEE7reserveEm.exit:              ; preds = %.thread, %_ZNSt12_Vector_baseIlSaIlEE11_M_allocateEm.exit.i, %bb.b
  ...
  %.promoted88 = phi ptr [ %5, %_ZNSt12_Vector_baseIlSaIlEE11_M_allocateEm.exit.i ], [ null, %bb.b ], [ null, %.thread ] ; 4 uses
