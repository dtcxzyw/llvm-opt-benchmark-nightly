...
.lr.ph.i.preheader:                               ; preds = %.noexc268
  ...
  br i1 %or.cond, label %.lr.ph.i.preheader1110, label %vector.ph
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %_ZNSt3mapIP6aiMeshPSt6vectorIP14aiSkeletonBoneSaIS4_EESt4lessIS1_ESaISt4pairIKS1_S7_EEE4findERSB_.exit.thread.i, label %.lr.ph.i.preheader1110

.lr.ph.i.preheader1110:                           ; preds = %.lr.ph.i.preheader, %middle.block
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader1110, %.lr.ph.i
  %.02240.i = phi i64 [ %i.qg, %.lr.ph.i ], [ %.02240.i.ph, %.lr.ph.i.preheader1110 ] ; 2 uses
  %.sroa.024.039.i = phi ptr [ %i.qh, %.lr.ph.i ], [ %.sroa.024.039.i.ph, %.lr.ph.i.preheader1110 ] ; 2 uses
