...
_ZNSt6vectorIlSaIlEE7reserveEm.exit:              ; preds = %.thread, %_ZNSt12_Vector_baseIlSaIlEE11_M_allocateEm.exit.i, %bb.b
  ...
  %.promoted88 = phi ptr [ %i.j, %_ZNSt12_Vector_baseIlSaIlEE11_M_allocateEm.exit.i ], [ null, %bb.b ], [ null, %.thread ] ; 5 uses
  %.promoted = phi ptr [ %i.k, %_ZNSt12_Vector_baseIlSaIlEE11_M_allocateEm.exit.i ], [ null, %bb.b ], [ null, %.thread ] ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #28
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %3, i8 0, i64 24, i1 false)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #28
  store i32 0, ptr %i.a, align 4
  %.not132 = icmp eq ptr %i.d, %i.b
  br i1 %.not132, label %._crit_edge79.thread.critedge, label %bb.c
...
begin_hunk_4
  ...
  %i.ab = call i64 @llvm.umax.i64(i64 %.pre111, i64 1) ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #28
  %4 = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
  br i1 %i.aa, label %._crit_edge79.thread, label %.lr.ph78

.lr.ph78.loopexit:                                ; preds = %.critedge
  br label %.lr.ph78, !llvm.loop !388

.lr.ph78:                                         ; preds = %._ZNSt6vectorIjSaIjEE6resizeEmRKj.exit_crit_edge101, %.lr.ph78.loopexit
  %i.ac = phi ptr [ %i.bs, %.lr.ph78.loopexit ], [ %.promoted, %._ZNSt6vectorIjSaIjEE6resizeEmRKj.exit_crit_edge101 ] ; 5 uses
  %i.ad = phi ptr [ %i.br, %.lr.ph78.loopexit ], [ %.promoted88, %._ZNSt6vectorIjSaIjEE6resizeEmRKj.exit_crit_edge101 ] ; 10 uses
  %i.ae = phi ptr [ %i.bq, %.lr.ph78.loopexit ], [ %.promoted88, %._ZNSt6vectorIjSaIjEE6resizeEmRKj.exit_crit_edge101 ] ; 6 uses
...
_ZNSt6vectorIlSaIlEE2atEm.exit46:                 ; preds = %bb.f, %bb.e
  ...
  %exitcond.not = icmp eq i64 %i.az, %i.ab
...
.critedge:                                        ; preds = %.lr.ph82, %.lr.ph82.preheader, %..critedge.loopexit_crit_edge, %.lr.ph85
  ...
  %exitcond100.not = icmp eq i64 %i.dg, %i.ab
...
._crit_edge79.thread.critedge:                    ; preds = %_ZNSt6vectorIlSaIlEE7reserveEm.exit
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #28
  br label %._crit_edge79.thread

._crit_edge79.thread:                             ; preds = %._crit_edge79, %._crit_edge79.thread.critedge, %._ZNSt6vectorIjSaIjEE6resizeEmRKj.exit_crit_edge101
  %.lcssa152 = phi ptr [ %.promoted88, %._ZNSt6vectorIjSaIjEE6resizeEmRKj.exit_crit_edge101 ], [ %.promoted88, %._crit_edge79.thread.critedge ], [ %i.ad, %._crit_edge79 ]
  %.lcssa = phi ptr [ %.promoted, %._ZNSt6vectorIjSaIjEE6resizeEmRKj.exit_crit_edge101 ], [ %.promoted, %._crit_edge79.thread.critedge ], [ %i.ac, %._crit_edge79 ]
