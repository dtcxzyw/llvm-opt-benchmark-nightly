...
bb.cq:                                            ; preds = %.lr.ph434, %bb.cr
  ...
  %i.acl = load float, ptr %i.ack, align 4, !noalias !387 ; 4 uses
  ...
  %i.acv = insertelement <3 x float> <float -2.000000e+00, float poison, float poison>, float %i.acl, i64 1 ; 2 uses
  %i.acw = load <2 x float>, ptr %i.acm, align 4, !noalias !387 ; 8 uses
  %i.acx = shufflevector <2 x float> %i.acw, <2 x float> poison, <3 x i32> <i32 poison, i32 1, i32 poison>
  %28 = shufflevector <2 x float> %i.acw, <2 x float> poison, <3 x i32> <i32 0, i32 1, i32 poison>
  %29 = shufflevector <2 x float> %i.acw, <2 x float> poison, <3 x i32> <i32 1, i32 0, i32 0> ; 2 uses
  %30 = shufflevector <3 x float> %29, <3 x float> <float poison, float 1.000000e+00, float 1.000000e+00>, <3 x i32> <i32 0, i32 4, i32 5>
  %i.acy = extractelement <2 x float> %i.acw, i64 1
  %i.acz = fmul float %i.acy, %i.acn
  %i.ada = shufflevector <3 x float> %i.acv, <3 x float> %i.acx, <3 x i32> <i32 0, i32 1, i32 4> ; 2 uses
  ...
  %31 = shufflevector <3 x float> %i.ada, <3 x float> <float poison, float poison, float -2.000000e+00>, <3 x i32> <i32 2, i32 1, i32 5>
  ...
  %i.adp = call <3 x float> @llvm.fmuladd.v3f32(<3 x float> %29, <3 x float> %30, <3 x float> %i.ado)
  ...
  %i.adu = shufflevector <3 x float> %28, <3 x float> %i.adt, <3 x i32> <i32 0, i32 1, i32 3>
  %i.adv = call <3 x float> @llvm.fmuladd.v3f32(<3 x float> %i.adu, <3 x float> %31, <3 x float> %i.adj) ; 2 uses
  %i.adw = fmul <3 x float> %i.adv, <float 2.000000e+00, float 2.000000e+00, float 1.000000e+00> ; 2 uses
  %32 = shufflevector <2 x float> %i.acw, <2 x float> poison, <3 x i32> <i32 0, i32 poison, i32 1>
  %33 = shufflevector <3 x float> %32, <3 x float> %i.adt, <3 x i32> <i32 0, i32 4, i32 2>
  %34 = shufflevector <3 x float> %i.acv, <3 x float> <float poison, float -2.000000e+00, float poison>, <3 x i32> <i32 1, i32 4, i32 1>
  ...
  %i.adz = call <3 x float> @llvm.fmuladd.v3f32(<3 x float> %33, <3 x float> %34, <3 x float> %i.ady) ; 3 uses
