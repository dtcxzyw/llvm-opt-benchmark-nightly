...
vector.memcheck:                                  ; preds = %bb.aj
  ...
  %scevgep272 = getelementptr i8, ptr %scevgep271, i64 %i.ds
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %i.dv = getelementptr i8, ptr %.sroa.092.2, i64 %i.dt
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.dw = shl i64 %index, 2                       ; 2 uses
  %next.gep = getelementptr i8, ptr %i.dk, i64 %i.dw ; 3 uses
  %next.gep273 = getelementptr i8, ptr %.sroa.092.2, i64 %i.dw ; 3 uses
  %i.dx = getelementptr i8, ptr %next.gep273, i64 16 ; 2 uses
  %wide.load = load <4 x i32>, ptr %next.gep273, align 4, !alias.scope !108, !noalias !111
  %wide.load274 = load <4 x i32>, ptr %i.dx, align 4, !alias.scope !108, !noalias !111
  %i.dy = getelementptr i8, ptr %next.gep, i64 16 ; 2 uses
  %wide.load275 = load <4 x i32>, ptr %next.gep, align 4, !alias.scope !111
  %wide.load276 = load <4 x i32>, ptr %i.dy, align 4, !alias.scope !111
  store <4 x i32> %wide.load275, ptr %next.gep273, align 4, !alias.scope !108, !noalias !111
  store <4 x i32> %wide.load276, ptr %i.dx, align 4, !alias.scope !108, !noalias !111
  store <4 x i32> %wide.load, ptr %next.gep, align 4, !alias.scope !111
  store <4 x i32> %wide.load274, ptr %i.dy, align 4, !alias.scope !111
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.dz = icmp eq i64 %index.next, %n.vec
  br i1 %i.dz, label %middle.block, label %vector.body, !llvm.loop !113
...
.lr.ph.i.preheader:                               ; preds = %vector.memcheck, %bb.aj, %middle.block
  %.07.i.ph = phi ptr [ %i.dk, %vector.memcheck ], [ %i.dk, %bb.aj ], [ %i.du, %middle.block ]
  %.sroa.03.06.i.ph = phi ptr [ %.sroa.092.2, %vector.memcheck ], [ %.sroa.092.2, %bb.aj ], [ %i.dv, %middle.block ]
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  %.07.i = phi ptr [ %i.ed, %.lr.ph.i ], [ %.07.i.ph, %.lr.ph.i.preheader ] ; 3 uses
  %.sroa.03.06.i = phi ptr [ %i.ec, %.lr.ph.i ], [ %.sroa.03.06.i.ph, %.lr.ph.i.preheader ] ; 3 uses
  %i.ea = load i32, ptr %.sroa.03.06.i, align 4
  %i.eb = load i32, ptr %.07.i, align 4
  store i32 %i.eb, ptr %.sroa.03.06.i, align 4
  store i32 %i.ea, ptr %.07.i, align 4
  %i.ec = getelementptr inbounds nuw i8, ptr %.sroa.03.06.i, i64 4 ; 2 uses
  %i.ed = getelementptr inbounds nuw i8, ptr %.07.i, i64 4
  %.not.i = icmp eq ptr %i.ec, %.sroa.16.1
...
bb.ak:                                            ; preds = %_ZSt11swap_rangesIN9__gnu_cxx17__normal_iteratorIPjSt6vectorIjSaIjEEEES2_ET0_T_S8_S7_.exit
  %i.ee = ptrtoint ptr %.sroa.30.2 to i64
  %i.ef = sub i64 %i.ee, %i.t
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.092.2, i64 noundef %i.ef) #29
...
bb.am:                                            ; preds = %bb.al
  %i.eg = ptrtoint ptr %.sroa.30.4 to i64
  %i.eh = ptrtoint ptr %.sroa.092.4 to i64
  %i.ei = sub i64 %i.eg, %i.eh
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.092.4, i64 noundef %i.ei) #29
...
.lr.ph690:                                        ; preds = %bb.bm
  ...
  br label %bb.bn
end_hunk_2
begin_hunk_3_@_ZN6Assimp3FBX12FBXConverter14ConvertWeightsEP6aiMeshRKNS0_12MeshGeometryERK12aiMatrix4x4tIfEP6aiNodejPSt6vectorIjSaIjEE:bb.a
  %i.eg = ashr exact i64 %i.ef, 2                 ; 2 uses
  %i.eh = icmp sgt i64 %i.eg, 0
  br i1 %i.eh, label %_ZSt9__advanceIN9__gnu_cxx17__normal_iteratorIPjSt6vectorIjSaIjEEEElEvRT_T0_St26random_access_iterator_tag.exit.lr.ph.i.i, label %.loopexit
...
vector.memcheck:                                  ; preds = %bb.as
  %i.gw = add i64 %i.gk, -8
  %i.gx = sub i64 %i.gw, %i.gl
  %i.gy = and i64 %i.gx, -8
  %i.gz = add i64 %i.gy, 8                        ; 2 uses
  %scevgep = getelementptr i8, ptr %i.z, i64 %i.gz
  %scevgep308 = getelementptr i8, ptr %i.gq, i64 %i.gz
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %i.ha = shl i64 %n.vec, 3                       ; 2 uses
  %i.hb = getelementptr i8, ptr %i.gq, i64 %i.ha
  %i.hc = getelementptr i8, ptr %i.z, i64 %i.ha
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.hd = shl i64 %index, 3                       ; 2 uses
  %next.gep = getelementptr i8, ptr %i.gq, i64 %i.hd ; 3 uses
  %next.gep309 = getelementptr i8, ptr %i.z, i64 %i.hd ; 3 uses
  %i.he = getelementptr i8, ptr %next.gep309, i64 16 ; 2 uses
  %wide.load = load <2 x ptr>, ptr %next.gep309, align 8, !alias.scope !175, !noalias !178
  %wide.load310 = load <2 x ptr>, ptr %i.he, align 8, !alias.scope !175, !noalias !178
  %i.hf = getelementptr i8, ptr %next.gep, i64 16 ; 2 uses
  %wide.load311 = load <2 x ptr>, ptr %next.gep, align 8, !alias.scope !178
  %wide.load312 = load <2 x ptr>, ptr %i.hf, align 8, !alias.scope !178
  store <2 x ptr> %wide.load311, ptr %next.gep309, align 8, !alias.scope !175, !noalias !178
  store <2 x ptr> %wide.load312, ptr %i.he, align 8, !alias.scope !175, !noalias !178
  store <2 x ptr> %wide.load, ptr %next.gep, align 8, !alias.scope !178
  store <2 x ptr> %wide.load310, ptr %i.hf, align 8, !alias.scope !178
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.hg = icmp eq i64 %index.next, %n.vec
  br i1 %i.hg, label %middle.block, label %vector.body, !llvm.loop !180
...
.lr.ph.i.preheader:                               ; preds = %vector.memcheck, %bb.as, %middle.block
  %.07.i.ph = phi ptr [ %i.gq, %vector.memcheck ], [ %i.gq, %bb.as ], [ %i.hb, %middle.block ]
  %.sroa.03.06.i.ph = phi ptr [ %i.z, %vector.memcheck ], [ %i.z, %bb.as ], [ %i.hc, %middle.block ]
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  %.07.i = phi ptr [ %i.hk, %.lr.ph.i ], [ %.07.i.ph, %.lr.ph.i.preheader ] ; 3 uses
  %.sroa.03.06.i = phi ptr [ %i.hj, %.lr.ph.i ], [ %.sroa.03.06.i.ph, %.lr.ph.i.preheader ] ; 3 uses
  %i.hh = load ptr, ptr %.sroa.03.06.i, align 8
  %i.hi = load ptr, ptr %.07.i, align 8
  store ptr %i.hi, ptr %.sroa.03.06.i, align 8
  store ptr %i.hh, ptr %.07.i, align 8
  %i.hj = getelementptr inbounds nuw i8, ptr %.sroa.03.06.i, i64 8 ; 2 uses
  %i.hk = getelementptr inbounds nuw i8, ptr %.07.i, i64 8
  %.not.i94 = icmp eq ptr %i.hj, %i.ab
...
bb.at:                                            ; preds = %_ZSt11swap_rangesIN9__gnu_cxx17__normal_iteratorIPP6aiBoneSt6vectorIS3_SaIS3_EEEES4_ET0_T_SA_S9_.exit
  %i.hl = getelementptr inbounds nuw i8, ptr %10, i64 16
  %i.hm = load ptr, ptr %i.hl, align 8
  %i.hn = ptrtoint ptr %i.hm to i64
  %i.ho = ptrtoint ptr %i.z to i64
  %i.hp = sub i64 %i.hn, %i.ho
  call void @_ZdlPvm(ptr noundef nonnull %i.z, i64 noundef %i.hp) #29
...
_ZNSt6vectorIP6aiBoneSaIS1_EED2Ev.exit:           ; preds = %_ZSt11swap_rangesIN9__gnu_cxx17__normal_iteratorIPP6aiBoneSt6vectorIS3_SaIS3_EEEES4_ET0_T_SA_S9_.exit, %bb.at
  call void @llvm.lifetime.end.p0(ptr nonnull %10) #27
  %i.hq = load ptr, ptr %9, align 8               ; 3 uses
  %.not.i.i.i96 = icmp eq ptr %i.hq, null
...
bb.aw:                                            ; preds = %_ZNSt6vectorImSaImEED2Ev.exit98
  ...
  %i.if = ptrtoint ptr %i.p to i64
  %i.ig = sub i64 %i.ie, %i.if
  call void @_ZdlPvm(ptr noundef nonnull %i.p, i64 noundef %i.ig) #29
...
bb.ay:                                            ; preds = %._crit_edge195, %bb.ap, %bb.ax
  %i.ii = phi ptr [ %i.p, %bb.ax ], [ %i.ga, %._crit_edge195 ], [ %i.ga, %bb.ap ]
  %i.ij = phi ptr [ %i.z, %bb.ax ], [ %.pre, %._crit_edge195 ], [ %i.ge, %bb.ap ] ; 3 uses
  %.merged63 = phi { ptr, i32 } [ %i.ih, %bb.ax ], [ %.pn58.pn.pn.pn, %._crit_edge195 ], [ %i.gh, %bb.ap ]
  %.not.i.i.i101 = icmp eq ptr %i.ij, null
  br i1 %.not.i.i.i101, label %bb.ba, label %bb.az

bb.az:                                            ; preds = %bb.ay
  %i.ik = getelementptr inbounds nuw i8, ptr %10, i64 16
  %i.il = load ptr, ptr %i.ik, align 8
  %i.im = ptrtoint ptr %i.il to i64
  %i.in = ptrtoint ptr %i.ij to i64
  %i.io = sub i64 %i.im, %i.in
  call void @_ZdlPvm(ptr noundef nonnull %i.ij, i64 noundef %i.io) #29
  br label %bb.ba
...
bb.bb:                                            ; preds = %bb.ba
  ...
  %i.is = ptrtoint ptr %.pr to i64
  %i.it = sub i64 %i.ir, %i.is
  call void @_ZdlPvm(ptr noundef nonnull %.pr, i64 noundef %i.it) #29
...
bb.bd:                                            ; preds = %_ZNSt6vectorImSaImEED2Ev.exit106
  ...
  %i.je = ptrtoint ptr %i.iv to i64
  %i.jf = sub i64 %i.jd, %i.je
  call void @_ZdlPvm(ptr noundef nonnull %i.iv, i64 noundef %i.jf) #29
...
.thread.i.i:                                      ; preds = %bb.bs, %bb.br
  %i.lk = phi i1 [ %i.lj, %bb.bs ], [ true, %bb.br ]
  call void @_ZSt29_Rb_tree_insert_and_rebalancebPSt18_Rb_tree_node_baseS0_RS_(i1 noundef zeroext %i.lk, ptr noundef nonnull %i.kz, ptr noundef nonnull %i.le, ptr noundef nonnull align 8 dereferenceable(32) %i.fn) #27
  %i.ll = load i64, ptr %i.fr, align 8
  %i.lm = add i64 %i.ll, 1
...
vector.memcheck:                                  ; preds = %bb.cl
  %i.nl = add i64 %i.ml, -8
  %i.nm = sub i64 %i.nl, %i.mm
  %i.nn = and i64 %i.nm, -8
  %i.no = add i64 %i.nn, 8                        ; 2 uses
  %scevgep = getelementptr i8, ptr %.pre423, i64 %i.no
  %scevgep527 = getelementptr i8, ptr %i.nh, i64 %i.no
...
vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %i.nk, 4611686018427387900     ; 3 uses
  %i.np = shl i64 %n.vec, 3                       ; 2 uses
  %i.nq = getelementptr i8, ptr %i.nh, i64 %i.np
  %i.nr = getelementptr i8, ptr %.pre423, i64 %i.np
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.ns = shl i64 %index, 3                       ; 2 uses
  %next.gep = getelementptr i8, ptr %i.nh, i64 %i.ns ; 3 uses
  %next.gep528 = getelementptr i8, ptr %.pre423, i64 %i.ns ; 3 uses
  %i.nt = getelementptr i8, ptr %next.gep528, i64 16 ; 2 uses
  %wide.load = load <2 x ptr>, ptr %next.gep528, align 8, !alias.scope !316, !noalias !319
  %wide.load529 = load <2 x ptr>, ptr %i.nt, align 8, !alias.scope !316, !noalias !319
  %i.nu = getelementptr i8, ptr %next.gep, i64 16 ; 2 uses
  %wide.load530 = load <2 x ptr>, ptr %next.gep, align 8, !alias.scope !319
  %wide.load531 = load <2 x ptr>, ptr %i.nu, align 8, !alias.scope !319
  store <2 x ptr> %wide.load530, ptr %next.gep528, align 8, !alias.scope !316, !noalias !319
  store <2 x ptr> %wide.load531, ptr %i.nt, align 8, !alias.scope !316, !noalias !319
  store <2 x ptr> %wide.load, ptr %next.gep, align 8, !alias.scope !319
  store <2 x ptr> %wide.load529, ptr %i.nu, align 8, !alias.scope !319
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.nv = icmp eq i64 %index.next, %n.vec
  br i1 %i.nv, label %middle.block, label %vector.body, !llvm.loop !321
...
.lr.ph.i.preheader:                               ; preds = %vector.memcheck, %bb.cl, %middle.block
  %.07.i.ph = phi ptr [ %i.nh, %vector.memcheck ], [ %i.nh, %bb.cl ], [ %i.nq, %middle.block ]
  %.sroa.03.06.i.ph = phi ptr [ %.pre423, %vector.memcheck ], [ %.pre423, %bb.cl ], [ %i.nr, %middle.block ]
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  %.07.i = phi ptr [ %i.nz, %.lr.ph.i ], [ %.07.i.ph, %.lr.ph.i.preheader ] ; 3 uses
  %.sroa.03.06.i = phi ptr [ %i.ny, %.lr.ph.i ], [ %.sroa.03.06.i.ph, %.lr.ph.i.preheader ] ; 3 uses
  %i.nw = load ptr, ptr %.sroa.03.06.i, align 8
  %i.nx = load ptr, ptr %.07.i, align 8
  store ptr %i.nx, ptr %.sroa.03.06.i, align 8
  store ptr %i.nw, ptr %.07.i, align 8
  %i.ny = getelementptr inbounds nuw i8, ptr %.sroa.03.06.i, i64 8 ; 2 uses
  %i.nz = getelementptr inbounds nuw i8, ptr %.07.i, i64 8
  %.not.i247 = icmp eq ptr %i.ny, %.pre422
...
bb.cm:                                            ; preds = %.noexc255, %.noexc254, %bb.dd, %bb.dc, %bb.ck
  %i.oa = phi ptr [ %i.nd, %.noexc255 ], [ %i.nd, %.noexc254 ], [ %i.nd, %bb.dd ], [ %i.nd, %bb.dc ], [ %.pre423, %bb.ck ]
...
_ZSt11swap_rangesIN9__gnu_cxx17__normal_iteratorIPP10aiNodeAnimSt6vectorIS3_SaIS3_EEEES4_ET0_T_SA_S9_.exit.thread: ; preds = %._crit_edge347.thread, %_ZSt11swap_rangesIN9__gnu_cxx17__normal_iteratorIPP10aiNodeAnimSt6vectorIS3_SaIS3_EEEES4_ET0_T_SA_S9_.exit
  %i.oc = phi i64 [ %i.mm, %_ZSt11swap_rangesIN9__gnu_cxx17__normal_iteratorIPP10aiNodeAnimSt6vectorIS3_SaIS3_EEEES4_ET0_T_SA_S9_.exit ], [ %i.nc, %._crit_edge347.thread ] ; 2 uses
  %i.od = phi ptr [ %.pre423, %_ZSt11swap_rangesIN9__gnu_cxx17__normal_iteratorIPP10aiNodeAnimSt6vectorIS3_SaIS3_EEEES4_ET0_T_SA_S9_.exit ], [ %i.nd, %._crit_edge347.thread ] ; 6 uses
  %i.oe = phi i64 [ %.pr, %_ZSt11swap_rangesIN9__gnu_cxx17__normal_iteratorIPP10aiNodeAnimSt6vectorIS3_SaIS3_EEEES4_ET0_T_SA_S9_.exit ], [ %i.ne, %._crit_edge347.thread ] ; 2 uses
  %i.of = shl i64 %i.oe, 3
  %i.og = and i64 %i.of, 34359738360
  %i.oh = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %i.og) #30
...
bb.cn:                                            ; preds = %_ZSt11swap_rangesIN9__gnu_cxx17__normal_iteratorIPP10aiNodeAnimSt6vectorIS3_SaIS3_EEEES4_ET0_T_SA_S9_.exit.thread
  ...
  store ptr %i.oh, ptr %i.x, align 8
  store i32 %i.oi, ptr %i.w, align 8
  %i.oj = load ptr, ptr %i.fu, align 8            ; 2 uses
  %.not320358 = icmp eq ptr %i.oj, %i.fs
  br i1 %.not320358, label %.loopexit325, label %.lr.ph362

.lr.ph362:                                        ; preds = %bb.cn
  %i.ok = getelementptr inbounds nuw i8, ptr %0, i64 480
  br label %bb.cp
...
bb.cp:                                            ; preds = %.lr.ph362, %._crit_edge357
  %.0139360 = phi i32 [ 0, %.lr.ph362 ], [ %i.qc, %._crit_edge357 ] ; 2 uses
  %.sroa.0277.0359 = phi ptr [ %i.oj, %.lr.ph362 ], [ %i.qf, %._crit_edge357 ] ; 4 uses
  %i.om = getelementptr inbounds nuw i8, ptr %.sroa.0277.0359, i64 32
  %i.on = getelementptr inbounds nuw i8, ptr %.sroa.0277.0359, i64 64
  %i.oo = load ptr, ptr %i.on, align 8            ; 3 uses
  %i.op = getelementptr inbounds nuw i8, ptr %i.oo, i64 40
  %i.oq = load i64, ptr %i.op, align 8            ; 3 uses
  %i.or = invoke noalias noundef nonnull dereferenceable(1040) ptr @_Znwm(i64 noundef 1040) #30
...
bb.cq:                                            ; preds = %bb.cp
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1040) %i.or, i8 0, i64 1040, i1 false)
  %i.ot = getelementptr inbounds nuw i8, ptr %.sroa.0277.0359, i64 40
  %i.ou = load i64, ptr %i.ot, align 8            ; 4 uses
  %i.ov = icmp ugt i64 %i.ou, 1023
  br i1 %i.ov, label %_ZN8aiString3SetERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE.exit248, label %bb.cr

bb.cr:                                            ; preds = %bb.cq
  %i.ow = trunc nuw nsw i64 %i.ou to i32
  store i32 %i.ow, ptr %i.or, align 4
  %i.ox = getelementptr inbounds nuw i8, ptr %i.or, i64 4 ; 2 uses
  %i.oy = load ptr, ptr %i.om, align 8
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %i.ox, ptr align 1 %i.oy, i64 %i.ou, i1 false)
  %i.oz = getelementptr inbounds nuw i8, ptr %i.ox, i64 %i.ou
  store i8 0, ptr %i.oz, align 1
...
_ZN8aiString3SetERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE.exit248: ; preds = %bb.cq, %bb.cr
  %i.pa = getelementptr inbounds nuw i8, ptr %i.or, i64 1028
  store i32 %i.os, ptr %i.pa, align 4
  %i.pb = and i64 %i.oq, 4294967295               ; 5 uses
  %i.pc = shl nuw nsw i64 %i.pb, 5
  %i.pd = or disjoint i64 %i.pc, 8
  %i.pe = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %i.pd) #30
...
bb.cs:                                            ; preds = %_ZN8aiString3SetERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE.exit248
  store i64 %i.pb, ptr %i.pe, align 16
  %i.pf = getelementptr inbounds nuw i8, ptr %i.pe, i64 8 ; 4 uses
  %i.pg = icmp eq i64 %i.pb, 0
  br i1 %i.pg, label %.loopexit, label %bb.ct

bb.ct:                                            ; preds = %bb.cs
  %i.ph = getelementptr inbounds nuw [32 x i8], ptr %i.pf, i64 %i.pb
  %i.pi = add nuw nsw i64 %i.pb, 576460752303423487
  %i.pj = and i64 %i.pi, 576460752303423487
  %xtraiter = and i64 %i.oq, 7                    ; 2 uses
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %.prol.loopexit, label %.prol.preheader

.prol.preheader:                                  ; preds = %bb.ct, %.prol.preheader
  %i.pk = phi ptr [ %i.pl, %.prol.preheader ], [ %i.pf, %bb.ct ] ; 2 uses
  %prol.iter = phi i64 [ %prol.iter.next, %.prol.preheader ], [ 0, %bb.ct ]
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(28) %i.pk, i8 0, i64 28, i1 false)
...
.prol.loopexit:                                   ; preds = %.prol.preheader, %bb.ct
  %.unr = phi ptr [ %i.pf, %bb.ct ], [ %i.pl, %.prol.preheader ]
  %i.pm = icmp samesign ult i64 %i.pj, 7
  br i1 %i.pm, label %.loopexit, label %.new

.new:                                             ; preds = %.prol.loopexit, %.new
  %i.pn = phi ptr [ %i.pv, %.new ], [ %.unr, %.prol.loopexit ] ; 9 uses
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(28) %i.pn, i8 0, i64 28, i1 false)
  %i.po = getelementptr inbounds nuw i8, ptr %i.pn, i64 32
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(28) %i.po, i8 0, i64 28, i1 false)
  %i.pp = getelementptr inbounds nuw i8, ptr %i.pn, i64 64
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(28) %i.pp, i8 0, i64 28, i1 false)
  %i.pq = getelementptr inbounds nuw i8, ptr %i.pn, i64 96
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(28) %i.pq, i8 0, i64 28, i1 false)
  %i.pr = getelementptr inbounds nuw i8, ptr %i.pn, i64 128
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(28) %i.pr, i8 0, i64 28, i1 false)
  %i.ps = getelementptr inbounds nuw i8, ptr %i.pn, i64 160
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(28) %i.ps, i8 0, i64 28, i1 false)
  %i.pt = getelementptr inbounds nuw i8, ptr %i.pn, i64 192
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(28) %i.pt, i8 0, i64 28, i1 false)
  %i.pu = getelementptr inbounds nuw i8, ptr %i.pn, i64 224
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(28) %i.pu, i8 0, i64 28, i1 false)
  %i.pv = getelementptr inbounds nuw i8, ptr %i.pn, i64 256 ; 2 uses
  %i.pw = icmp eq ptr %i.pv, %i.ph
  br i1 %i.pw, label %.loopexit, label %.new

.loopexit:                                        ; preds = %.prol.loopexit, %.new, %bb.cs
  %i.px = getelementptr inbounds nuw i8, ptr %i.or, i64 1032 ; 7 uses
  store ptr %i.pf, ptr %i.px, align 8
  %i.py = getelementptr inbounds nuw i8, ptr %i.oo, i64 24
  %i.pz = load ptr, ptr %i.py, align 8            ; 2 uses
  %i.qa = getelementptr inbounds nuw i8, ptr %i.oo, i64 8 ; 2 uses
  %.not321352 = icmp eq ptr %i.pz, %i.qa
  br i1 %.not321352, label %._crit_edge357, label %.lr.ph356

._crit_edge357:                                   ; preds = %._crit_edge351, %.loopexit
  %i.qb = load ptr, ptr %i.x, align 8
  %i.qc = add i32 %.0139360, 1
end_hunk_4
begin_hunk_5_@_ZNSt15_Sp_counted_ptrIPSt6vectorIfSaIfEELN9__gnu_cxx12_Lock_policyE2EE10_M_destroyEv:bb.a
}

; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr noundef ptr @_ZNSt15_Sp_counted_ptrIPSt6vectorIfSaIfEELN9__gnu_cxx12_Lock_policyE2EE14_M_get_deleterERKSt9type_info(ptr noundef nonnull align 8 dereferenceable(24) %0, ptr noundef nonnull align 8 dereferenceable(16) %1) unnamed_addr #6 comdat align 2 {
bb.a:
  ret ptr null
}
...
vector.body132:                                   ; preds = %vector.body132, %vector.ph127
  ...
  br i1 %i.al, label %middle.block136, label %vector.body132, !llvm.loop !761
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.preheader, %.lr.ph.i.i.i
  ...
  br i1 %.not.i.i.i, label %_ZSt4fillIPjjEvT_S1_RKT0_.exit, label %.lr.ph.i.i.i, !llvm.loop !762
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.az, label %middle.block, label %vector.body, !llvm.loop !763
...
.lr.ph.i.i.i.i.i.i.i:                             ; preds = %.lr.ph.i.i.i.i.i.i.i.preheader, %.lr.ph.i.i.i.i.i.i.i
  ...
  br i1 %.not.i.i.i.i.i.i.i, label %_ZSt24__uninitialized_fill_n_aIPjmjjET_S1_T0_RKT1_RSaIT2_E.exit, label %.lr.ph.i.i.i.i.i.i.i, !llvm.loop !764
...
_ZSt24__uninitialized_fill_n_aIPjmjjET_S1_T0_RKT1_RSaIT2_E.exit: ; preds = %.lr.ph.i.i.i.i.i.i.i, %middle.block, %bb.l
  ...
  br i1 %i.bb, label %bb.n, label %bb.o, !prof !127
...
vector.body118:                                   ; preds = %vector.body118, %vector.ph113
  ...
  br i1 %i.bm, label %middle.block122, label %vector.body118, !llvm.loop !765
...
.lr.ph.i.i.i71:                                   ; preds = %.lr.ph.i.i.i71.preheader153, %.lr.ph.i.i.i71
  ...
  br i1 %.not.i.i.i73, label %_ZSt4fillIPjjEvT_S1_RKT0_.exit, label %.lr.ph.i.i.i71, !llvm.loop !766
...
bb.r:                                             ; preds = %bb.q
  tail call void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.231) #31
  unreachable
...
vector.body146:                                   ; preds = %vector.body146, %vector.ph141
  ...
  br i1 %i.cn, label %middle.block150, label %vector.body146, !llvm.loop !767
...
.lr.ph.i.i.i.i.i.i.i76:                           ; preds = %.lr.ph.i.i.i.i.i.i.i76.preheader, %.lr.ph.i.i.i.i.i.i.i76
  ...
  br i1 %.not.i.i.i.i.i.i.i78, label %_ZSt24__uninitialized_fill_n_aIPjmjjET_S1_T0_RKT1_RSaIT2_E.exit80, label %.lr.ph.i.i.i.i.i.i.i76, !llvm.loop !768
...
_ZSt24__uninitialized_fill_n_aIPjmjjET_S1_T0_RKT1_RSaIT2_E.exit80: ; preds = %.lr.ph.i.i.i.i.i.i.i76, %middle.block150
  ...
  br i1 %i.cp, label %bb.u, label %bb.v, !prof !127
...
_ZSt34__uninitialized_move_if_noexcept_aIPjS0_SaIjEET0_T_S3_S2_RT1_.exit: ; preds = %bb.w, %bb.v, %bb.u
  ...
  br i1 %i.cu, label %bb.x, label %bb.y, !prof !127
