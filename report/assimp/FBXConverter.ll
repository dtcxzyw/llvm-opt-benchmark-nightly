...
bb.s:                                             ; preds = %bb.r
  %5 = load <4 x float>, ptr %3, align 4
  %6 = load <4 x float>, ptr %.sroa.4.0..sroa_idx, align 4
  %.sroa.871.0..sroa_idx72 = getelementptr inbounds nuw i8, ptr %3, i64 8
  %7 = load <4 x float>, ptr %.sroa.871.0..sroa_idx72, align 4
  %.sroa.1074.0..sroa_idx75 = getelementptr inbounds nuw i8, ptr %3, i64 12
  %8 = load <4 x float>, ptr %.sroa.1074.0..sroa_idx75, align 4
  %.sroa.1277.0..sroa_idx78 = getelementptr inbounds nuw i8, ptr %3, i64 16 ; 2 uses
  %9 = load <4 x float>, ptr %.sroa.1277.0..sroa_idx78, align 4
  %10 = load <4 x float>, ptr %.sroa.5.0..sroa_idx, align 4
  %11 = load <4 x float>, ptr %.sroa.6158.0..sroa_idx, align 4
  %.sroa.1886.0..sroa_idx87 = getelementptr inbounds nuw i8, ptr %3, i64 28
  %12 = load <4 x float>, ptr %.sroa.1886.0..sroa_idx87, align 4
  %.sroa.2089.0..sroa_idx90 = getelementptr inbounds nuw i8, ptr %3, i64 32 ; 2 uses
  %13 = load <4 x float>, ptr %.sroa.2089.0..sroa_idx90, align 4
  %.sroa.2292.0..sroa_idx93 = getelementptr inbounds nuw i8, ptr %3, i64 36
  %14 = load <4 x float>, ptr %.sroa.2292.0..sroa_idx93, align 4
  %15 = load <4 x float>, ptr %.sroa.7.0..sroa_idx, align 4
  %16 = load <4 x float>, ptr %.sroa.8159.0..sroa_idx, align 4
  %.sroa.28101.0..sroa_idx102 = getelementptr inbounds nuw i8, ptr %3, i64 48 ; 2 uses
  %17 = load <4 x float>, ptr %.sroa.28101.0..sroa_idx102, align 4
  ...
  %i.bi = shufflevector <4 x float> %6, <4 x float> poison, <4 x i32> zeroinitializer
  %i.bj = fmul <4 x float> %i.bi, %i.bh
  %i.bk = shufflevector <4 x float> %5, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.bs = shufflevector <4 x float> %10, <4 x float> poison, <4 x i32> zeroinitializer
  %i.bt = fmul <4 x float> %i.bs, %i.bh
  %i.bu = shufflevector <4 x float> %9, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.ca = shufflevector <4 x float> %14, <4 x float> poison, <4 x i32> zeroinitializer
  %i.cb = fmul <4 x float> %i.ca, %i.bh
  %i.cc = shufflevector <4 x float> %13, <4 x float> poison, <4 x i32> zeroinitializer
...
bb.u:                                             ; preds = %bb.t
  %18 = load <4 x float>, ptr %3, align 4
  %19 = load <4 x float>, ptr %.sroa.4.0..sroa_idx, align 4
  %.sroa.8.0..sroa_idx38 = getelementptr inbounds nuw i8, ptr %3, i64 8
  %20 = load <4 x float>, ptr %.sroa.8.0..sroa_idx38, align 4
  %.sroa.10.0..sroa_idx40 = getelementptr inbounds nuw i8, ptr %3, i64 12
  %21 = load <4 x float>, ptr %.sroa.10.0..sroa_idx40, align 4
  %.sroa.12.0..sroa_idx42 = getelementptr inbounds nuw i8, ptr %3, i64 16 ; 2 uses
  %22 = load <4 x float>, ptr %.sroa.12.0..sroa_idx42, align 4
  %23 = load <4 x float>, ptr %.sroa.5.0..sroa_idx, align 4
  %24 = load <4 x float>, ptr %.sroa.6158.0..sroa_idx, align 4
  %.sroa.18.0..sroa_idx48 = getelementptr inbounds nuw i8, ptr %3, i64 28
  %25 = load <4 x float>, ptr %.sroa.18.0..sroa_idx48, align 4
  %.sroa.20.0..sroa_idx50 = getelementptr inbounds nuw i8, ptr %3, i64 32 ; 2 uses
  %26 = load <4 x float>, ptr %.sroa.20.0..sroa_idx50, align 4
  %.sroa.22.0..sroa_idx52 = getelementptr inbounds nuw i8, ptr %3, i64 36
  %27 = load <4 x float>, ptr %.sroa.22.0..sroa_idx52, align 4
  %28 = load <4 x float>, ptr %.sroa.7.0..sroa_idx, align 4
  %29 = load <4 x float>, ptr %.sroa.8159.0..sroa_idx, align 4
  %.sroa.28.0..sroa_idx58 = getelementptr inbounds nuw i8, ptr %3, i64 48 ; 2 uses
  %30 = load <4 x float>, ptr %.sroa.28.0..sroa_idx58, align 4
  ...
  %i.da = shufflevector <4 x float> %19, <4 x float> poison, <4 x i32> zeroinitializer
  %i.db = fmul <4 x float> %i.da, %i.cz
  %i.dc = shufflevector <4 x float> %18, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.dk = shufflevector <4 x float> %23, <4 x float> poison, <4 x i32> zeroinitializer
  %i.dl = fmul <4 x float> %i.dk, %i.cz
  %i.dm = shufflevector <4 x float> %22, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.ds = shufflevector <4 x float> %27, <4 x float> poison, <4 x i32> zeroinitializer
  %i.dt = fmul <4 x float> %i.ds, %i.cz
  %i.du = shufflevector <4 x float> %26, <4 x float> poison, <4 x i32> zeroinitializer
...
bb.q:                                             ; preds = %bb.p
  ...
  %12 = load <4 x float>, ptr %i.bn, align 8
  %13 = load <4 x float>, ptr %i.bz, align 4
  %.sroa.9.0..sroa_idx66 = getelementptr inbounds nuw i8, ptr %i.bm, i64 1064
  %14 = load <4 x float>, ptr %.sroa.9.0..sroa_idx66, align 8
  %.sroa.11.0..sroa_idx68 = getelementptr inbounds nuw i8, ptr %i.bm, i64 1068
  %15 = load <4 x float>, ptr %.sroa.11.0..sroa_idx68, align 4
  %.sroa.13.0..sroa_idx70 = getelementptr inbounds nuw i8, ptr %i.bm, i64 1072 ; 2 uses
  %16 = load <4 x float>, ptr %.sroa.13.0..sroa_idx70, align 8
  %17 = load <4 x float>, ptr %i.by, align 4
  %18 = load <4 x float>, ptr %i.bx, align 8
  %.sroa.19.0..sroa_idx76 = getelementptr inbounds nuw i8, ptr %i.bm, i64 1084
  %19 = load <4 x float>, ptr %.sroa.19.0..sroa_idx76, align 4
  %.sroa.21.0..sroa_idx78 = getelementptr inbounds nuw i8, ptr %i.bm, i64 1088 ; 2 uses
  %20 = load <4 x float>, ptr %.sroa.21.0..sroa_idx78, align 8
  %.sroa.23.0..sroa_idx80 = getelementptr inbounds nuw i8, ptr %i.bm, i64 1092
  %21 = load <4 x float>, ptr %.sroa.23.0..sroa_idx80, align 4
  %22 = load <4 x float>, ptr %i.bw, align 8
  %23 = load <4 x float>, ptr %i.bv, align 4
  %.sroa.29.0..sroa_idx86 = getelementptr inbounds nuw i8, ptr %i.bm, i64 1104 ; 2 uses
  %24 = load <4 x float>, ptr %.sroa.29.0..sroa_idx86, align 8
  ...
  %i.ce = shufflevector <4 x float> %13, <4 x float> poison, <4 x i32> zeroinitializer
  %i.cf = fmul <4 x float> %i.cb, %i.ce
  %i.cg = shufflevector <4 x float> %12, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.cm = shufflevector <4 x float> %17, <4 x float> poison, <4 x i32> zeroinitializer
  %i.cn = fmul <4 x float> %i.cb, %i.cm
  %i.co = shufflevector <4 x float> %16, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.cu = shufflevector <4 x float> %21, <4 x float> poison, <4 x i32> zeroinitializer
  %i.cv = fmul <4 x float> %i.cb, %i.cu
  %i.cw = shufflevector <4 x float> %20, <4 x float> poison, <4 x i32> zeroinitializer
...
bb.de:                                            ; preds = %.loopexit326
  ...
  %17 = load <2 x double>, ptr %i.tm, align 8
  ...
  %i.tr = shufflevector <2 x double> %17, <2 x double> poison, <2 x i32> zeroinitializer
