...
_ZN10aiVector3tIfEixEj.exit37.i:                  ; preds = %bb.ad, %bb.ac, %_ZN10aiVector3tIfEixEj.exit35.i, %_ZN10aiVector3tIfEixEj.exit35.thread.i
  ...
  %4 = fmul float %.sroa.869.i.0..sroa.869.i.0..sroa.869.i.0..sroa.869.0..sroa.869.0..sroa.869.8..i, %i.eb
  ...
  %5 = insertelement <4 x float> poison, float %i.ei, i64 0
  %6 = insertelement <4 x float> %5, float %i.eh, i64 1
  %i.en = insertelement <4 x float> %6, float %4, i64 2
  %i.eo = insertelement <4 x float> %i.en, float %i.eg, i64 3
  %7 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.el, <4 x float> %i.em, <4 x float> %i.eo)
  ...
  %8 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.er, <4 x float> %i.es, <4 x float> %7)
  ...
  %9 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.et, <4 x float> zeroinitializer, <4 x float> %8)
  store <4 x float> %9, ptr %i.di, align 4
  ...
  %10 = fmul float %.sroa.869.i.0..sroa.869.i.0..sroa.869.i.0..sroa.869.0..sroa.869.0..sroa.869.8..i, %i.ex
  ...
  %11 = insertelement <4 x float> %i.fh, float %10, i64 2
  %12 = insertelement <4 x float> %11, float %i.fc, i64 3
  %13 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.el, <4 x float> %i.ff, <4 x float> %12)
  %14 = shufflevector <4 x float> %i.eu, <4 x float> <float poison, float -0.000000e+00, float poison, float poison>, <4 x i32> <i32 2, i32 2, i32 2, i32 5>
  %15 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.er, <4 x float> %14, <4 x float> %13)
  %16 = shufflevector <4 x float> %i.eu, <4 x float> <float poison, float -0.000000e+00, float poison, float poison>, <4 x i32> <i32 3, i32 3, i32 3, i32 5>
  %17 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %16, <4 x float> zeroinitializer, <4 x float> %15)
  store <4 x float> %17, ptr %i.dm, align 4
  %18 = load <4 x float>, ptr %i.dq, align 4      ; 4 uses
  %19 = load float, ptr %i.dt, align 4
  %20 = load float, ptr %i.ds, align 4
  %21 = load float, ptr %i.dr, align 4            ; 4 uses
  %i.fi = fmul float %21, 0.000000e+00
  %22 = extractelement <4 x float> %18, i64 0
  %23 = tail call float @llvm.fmuladd.f32(float %22, float 0.000000e+00, float %i.fi)
  %24 = tail call float @llvm.fmuladd.f32(float %20, float 0.000000e+00, float %23)
  %25 = fadd float %19, %24
  %i.fj = fmul float %.sroa.869.i.0..sroa.869.i.0..sroa.869.i.0..sroa.869.0..sroa.869.0..sroa.869.8..i, %21
  %26 = fmul float %.sroa.568.i.0..sroa.568.i.0..sroa.568.i.0..sroa.568.0..sroa.568.0..sroa.568.4..i, %21
  %27 = fmul float %.sroa.067.i.0..sroa.067.i.0..sroa.067.i.0..sroa.067.0..sroa.067.0..sroa.067.0..i, %21
  %28 = shufflevector <4 x float> %18, <4 x float> <float poison, float -0.000000e+00, float poison, float poison>, <4 x i32> <i32 0, i32 0, i32 0, i32 5>
  %29 = insertelement <4 x float> poison, float %27, i64 0
  %30 = insertelement <4 x float> %29, float %26, i64 1
  %i.fk = insertelement <4 x float> %30, float %i.fj, i64 2
  %i.fl = insertelement <4 x float> %i.fk, float %25, i64 3
  %i.fm = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.el, <4 x float> %28, <4 x float> %i.fl)
  %31 = shufflevector <4 x float> %18, <4 x float> <float poison, float -0.000000e+00, float poison, float poison>, <4 x i32> <i32 2, i32 2, i32 2, i32 5>
  %i.fn = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.er, <4 x float> %31, <4 x float> %i.fm)
  %32 = shufflevector <4 x float> %18, <4 x float> <float poison, float -0.000000e+00, float poison, float poison>, <4 x i32> <i32 3, i32 3, i32 3, i32 5>
  %33 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %32, <4 x float> zeroinitializer, <4 x float> %i.fn)
  store <4 x float> %33, ptr %i.dq, align 4
  %34 = load <4 x float>, ptr %i.du, align 4      ; 4 uses
  %35 = load float, ptr %i.dx, align 4
  %36 = load float, ptr %i.dw, align 4
  %37 = load float, ptr %i.dv, align 4            ; 4 uses
  ...
  %41 = tail call float @llvm.fmuladd.f32(float %36, float 0.000000e+00, float %40)
  %i.fo = fadd float %35, %41
  %i.fp = fmul float %.sroa.869.i.0..sroa.869.i.0..sroa.869.i.0..sroa.869.0..sroa.869.0..sroa.869.8..i, %37
  %i.fq = fmul float %.sroa.568.i.0..sroa.568.i.0..sroa.568.i.0..sroa.568.0..sroa.568.0..sroa.568.4..i, %37
  %i.fr = fmul float %.sroa.067.i.0..sroa.067.i.0..sroa.067.i.0..sroa.067.0..sroa.067.0..sroa.067.0..i, %37
  %i.fs = shufflevector <4 x float> %34, <4 x float> <float poison, float -0.000000e+00, float poison, float poison>, <4 x i32> <i32 0, i32 0, i32 0, i32 5>
  ...
  %i.fy = shufflevector <4 x float> %34, <4 x float> <float poison, float -0.000000e+00, float poison, float poison>, <4 x i32> <i32 2, i32 2, i32 2, i32 5>
  %i.fz = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.er, <4 x float> %i.fy, <4 x float> %i.fx)
  %i.ga = shufflevector <4 x float> %34, <4 x float> <float poison, float -0.000000e+00, float poison, float poison>, <4 x i32> <i32 3, i32 3, i32 3, i32 5>
...
bb.cq:                                            ; preds = %.lr.ph433, %bb.cr
  ...
  %i.acf = getelementptr inbounds nuw [32 x i8], ptr %i.fr, i64 %.0165431 ; 4 uses
  ...
  %28 = getelementptr inbounds nuw i8, ptr %i.acf, i64 16
  ...
  %i.adb = load float, ptr %i.acq, align 4, !noalias !370 ; 5 uses
  %29 = fmul float %i.adb, %i.adb                 ; 2 uses
  ...
  %30 = load float, ptr %28, align 4, !noalias !370 ; 4 uses
  %31 = call float @llvm.fmuladd.f32(float %30, float %30, float %29)
  %32 = extractelement <2 x float> %i.adg, i64 0  ; 4 uses
  %33 = call float @llvm.fmuladd.f32(float %32, float %30, float %i.ade)
  %34 = call float @llvm.fmuladd.f32(float %32, float %30, float %i.adf)
  %35 = fmul float %34, 2.000000e+00              ; 2 uses
  %i.adh = call float @llvm.fmuladd.f32(float %32, float %32, float %29)
  %36 = shufflevector <2 x float> %i.adg, <2 x float> poison, <4 x i32> <i32 poison, i32 0, i32 1, i32 0>
  %37 = insertelement <4 x float> %36, float 1.000000e+00, i64 0
  %38 = shufflevector <4 x float> %i.ada, <4 x float> <float 1.000000e+00, float poison, float poison, float poison>, <4 x i32> <i32 4, i32 poison, i32 poison, i32 0>
  %39 = insertelement <4 x float> poison, float %i.add, i64 0
  %40 = shufflevector <4 x float> %39, <4 x float> poison, <4 x i32> <i32 poison, i32 0, i32 0, i32 poison>
  %41 = shufflevector <4 x float> %38, <4 x float> %40, <4 x i32> <i32 0, i32 5, i32 6, i32 3>
  %42 = fmul <4 x float> %37, %41
  %43 = shufflevector <2 x float> %i.adg, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.adi = insertelement <4 x float> poison, float %i.adh, i64 0
  %44 = shufflevector <4 x float> %43, <4 x float> %i.adi, <4 x i32> <i32 4, i32 1, i32 0, i32 1>
  %45 = insertelement <4 x float> <float -2.000000e+00, float poison, float poison, float poison>, float %i.adb, i64 1
  %46 = shufflevector <4 x float> %45, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 1>
  %i.adj = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %44, <4 x float> %46, <4 x float> %42) ; 4 uses
  ...
  %i.aea = call float @llvm.fmuladd.f32(float %31, float -2.000000e+00, float 1.000000e+00) ; 3 uses
  %i.aeb = fmul float %33, 2.000000e+00           ; 3 uses
  %i.aec = fmul float %i.ado, 2.000000e+00        ; 4 uses
  %i.aed = fmul float %35, 0.000000e+00           ; 2 uses
  ...
  %i.ael = call float @llvm.fmuladd.f32(float %i.aea, float 0.000000e+00, float %35)
