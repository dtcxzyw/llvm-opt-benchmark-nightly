...
_ZN10aiVector3tIfE13NormalizeSafeEv.exit:         ; preds = %_ZN10aiVector3tIfEdVEf.exit.i, %bb.d, %bb.c
  ...
  %i.bc = phi <2 x float> [ zeroinitializer, %bb.c ], [ %i.ag, %_ZN10aiVector3tIfEdVEf.exit.i ], [ %.lcssa58, %bb.d ]
  ...
  %2 = fpext <2 x float> %i.bc to <2 x double>    ; 2 uses
  ...
  %i.bg = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo9_M_insertIdEERSoT_(ptr noundef nonnull align 8 dereferenceable(8) %i.be, double noundef %4) ; 2 uses
