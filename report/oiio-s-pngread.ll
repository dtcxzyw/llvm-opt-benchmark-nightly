begin_hunk_0
  ...
  %.fr = freeze i32 %15                           ; [#uses=1 type=i32]
  br label %22
...
22:                                               ; preds = %19
  ...
  %24 = load i32, ptr %23, align 4, !tbaa !119    ; [#uses=1 type=i32]
  %.fr236 = freeze i32 %24                        ; [#uses=4 type=i32]
  %25 = and i32 %.fr236, 1                        ; [#uses=1 type=i32]
  %26 = and i32 %.fr236, 5                        ; [#uses=1 type=i32]
...
.loopexit:                                        ; preds = %._crit_edge, %._crit_edge231, %128, %.preheader, %47
  ...
  %exitcond241.not = icmp eq i32 %178, %.0173     ; [#uses=1 type=i1]
  br i1 %exitcond241.not, label %.loopexit211, label %44, !llvm.loop !207
...
begin_hunk_4
  ...
  %185 = trunc i32 %.fr236 to i1                  ; [#uses=1 type=i1]
  %186 = add nuw nsw i32 %25, 1                   ; [#uses=7 type=i32]
  %187 = and i32 %.fr236, 33                      ; [#uses=1 type=i32]
...
.loopexit212.us:                                  ; preds = %._crit_edge.split.us.us.us, %226, %196
  ...
  %exitcond240.not = icmp eq i32 %228, %.0173     ; [#uses=1 type=i1]
...
.lr.ph218.us:                                     ; preds = %226
  ...
  %.pre242 = load ptr, ptr %190, align 8, !tbaa !175 ; [#uses=1 type=ptr]
  %230 = icmp samesign ult i64 %.0180.us, %189    ; [#uses=1 type=i1]
  br label %231

231:                                              ; preds = %._crit_edge.split.us.us.us, %.lr.ph218.us
  %232 = phi ptr [ %.pre242, %.lr.ph218.us ], [ %237, %._crit_edge.split.us.us.us ] ; [#uses=1 type=ptr]
