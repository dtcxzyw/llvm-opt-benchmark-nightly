...
bb.bw:                                            ; preds = %_RNvNtNtCsa9sSWSfjDbm_4jiff4util5parse3i64.exit53
  %i.eq = zext nneg i8 %narrow714.a to i64
  %i.er = tail call noundef zeroext i1 @_RNvMNtCs3oUPovFnLWP_4core5sliceSh11starts_withCsa9sSWSfjDbm_4jiff(ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %.ptr533, i64 noundef %i.dz, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) @28, i64 noundef 1), !noalias !220 ; 3 uses
  br i1 %i.er, label %_RNvMs5_NtNtNtCsa9sSWSfjDbm_4jiff3fmt8temporal6parserNtB5_14DateTimeParser20parse_time_separator.exit139.i, label %bb.bx

bb.bx:                                            ; preds = %bb.bw
  %i.es = icmp samesign ult i64 %.sroa.9176.0, 7
  br i1 %i.es, label %_RNvMNtCs3oUPovFnLWP_4core6resultINtB2_6ResultNtNtNtCsa9sSWSfjDbm_4jiff5civil4time4TimeNtNtBN_5error5ErrorE6unwrapBN_.exit133.i.i, label %.preheader543.preheader

.preheader543.preheader:                          ; preds = %bb.bx
  %.val.i.i.i = load i8, ptr %.ptr533, align 1, !noalias !221, !noundef !4
  %i.et = add i8 %.val.i.i.i, -48
  %.sroa.0.0.i.i.i.i.i = icmp ult i8 %i.et, 10
...
.preheader543.1:                                  ; preds = %.preheader543.preheader
  ...
  %i.eu = add i8 %.val.i.i.i.1, -48
  %.sroa.0.0.i.i.i.i.i.1 = icmp ult i8 %i.eu, 10
...
_RNvMs5_NtNtNtCsa9sSWSfjDbm_4jiff3fmt8temporal6parserNtB5_14DateTimeParser20parse_time_separator.exit139.i: ; preds = %bb.bw
  %i.ev = tail call { ptr, i64 } @_RINvMNtCs3oUPovFnLWP_4core5sliceSh12strip_prefixAhj1_ECsa9sSWSfjDbm_4jiff(ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %.ptr533, i64 noundef range(i64 0, -9223372036854775808) %i.dz, ptr noalias nofree noundef readonly captures(address, read_provenance) dereferenceable(1) @28), !noalias !222 ; 2 uses
  %i.ew = extractvalue { ptr, i64 } %i.ev, 0      ; 2 uses
  %.not.i135.i.not = icmp eq ptr %i.ew, null
...
bb.by:                                            ; preds = %_RNvMs5_NtNtNtCsa9sSWSfjDbm_4jiff3fmt8temporal6parserNtB5_14DateTimeParser20parse_time_separator.exit139.i
  %i.ex = extractvalue { ptr, i64 } %i.ev, 1      ; 2 uses
  %i.ey = icmp samesign ult i64 %i.ex, 2
  br i1 %i.ey, label %bb.cc, label %.thread636

.thread636:                                       ; preds = %.preheader543.1, %bb.by
  %.sroa.5214.0634640 = phi i64 [ %i.ex, %bb.by ], [ %i.dz, %.preheader543.1 ] ; 2 uses
  %.sroa.0213.0635639 = phi ptr [ %i.ew, %bb.by ], [ %.ptr533, %.preheader543.1 ] ; 4 uses
  %.ptr539 = getelementptr inbounds nuw i8, ptr %.sroa.0213.0635639, i64 2 ; 4 uses
  %i.ez = add nsw i64 %.sroa.5214.0634640, -2     ; 3 uses
  %i.fa = load i8, ptr %.sroa.0213.0635639, align 1, !alias.scope !223, !noalias !224, !noundef !4 ; 2 uses
  %i.fb = add i8 %i.fa, -48                       ; 2 uses
  %or.cond.i48 = icmp ult i8 %i.fb, 10
...
bb.bz:                                            ; preds = %.thread636
  ...
  %i.fc = load i8, ptr %.sroa.0.0.i47.ptr.1, align 1, !alias.scope !223, !noalias !224, !noundef !4 ; 2 uses
  %i.fd = add i8 %i.fc, -48                       ; 2 uses
  %or.cond.i48.1 = icmp ult i8 %i.fd, 10
...
_RNvNtNtCsa9sSWSfjDbm_4jiff4util5parse3i64.exit49: ; preds = %bb.bz
  %narrow622.a = mul nuw nsw i8 %i.fb, 10
  %narrow715.a = add nuw i8 %narrow622.a, %i.fd   ; 3 uses
  %i.fe = zext i8 %narrow715.a to i64
  %or.cond530 = icmp ugt i8 %narrow715.a, 59
  br i1 %or.cond530, label %bb.cb, label %bb.ci

bb.ca:                                            ; preds = %bb.bz, %.thread636
  %.lcssa569 = phi i8 [ %i.fa, %.thread636 ], [ %i.fc, %bb.bz ]
  %i.ff = tail call noundef ptr @_RNvXs1_NtNtCsa9sSWSfjDbm_4jiff5error4utilNtB7_5ErrorINtNtCs3oUPovFnLWP_4core7convert4FromNtB5_13ParseIntErrorE4from(i8 noundef 1, i8 %.lcssa569) #16, !noalias !225
  br label %bb.cd

bb.cb:                                            ; preds = %_RNvNtNtCsa9sSWSfjDbm_4jiff4util5parse3i64.exit49
  %i.fg = tail call noundef i8 @_RNvXsw_NtNtCsa9sSWSfjDbm_4jiff4util1bNtB5_6MinuteNtNtCsb09rMIQFAXO_9jiff_core6bounds6Bounds5error() #16, !noalias !225
  %i.fh = tail call noundef ptr @_RNvXNtNtCsa9sSWSfjDbm_4jiff4util1bNtNtB6_5error5ErrorINtNtCs3oUPovFnLWP_4core7convert4FromNtB2_11BoundsErrorE4from(i8 noundef %i.fg), !noalias !225
  br label %bb.cd

bb.cc:                                            ; preds = %bb.by
  %i.fi = tail call noundef ptr @_RNvXs_NtNtNtCsa9sSWSfjDbm_4jiff5error3fmt8temporalNtB8_5ErrorINtNtCs3oUPovFnLWP_4core7convert4FromNtB4_5ErrorE4from(i64 21) #16, !noalias !226
  br label %bb.dd

bb.cd:                                            ; preds = %bb.cb, %bb.ca
  %.sroa.7298.0.ph = phi ptr [ %i.fh, %bb.cb ], [ %i.ff, %bb.ca ] ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !227
  store ptr %.sroa.7298.0.ph, ptr %i.b, align 8, !noalias !227
  %i.fj = invoke noundef ptr @_RNvXNtNtNtCsa9sSWSfjDbm_4jiff5error3fmt8temporalNtB2_5ErrorNtB6_9IntoError10into_error(i64 46)
...
bb.ce:                                            ; preds = %bb.cd
  %i.fk = landingpad { ptr, i32 }
          cleanup                                 ; 3 uses
  %i.fl = icmp eq ptr %.sroa.7298.0.ph, null
  br i1 %i.fl, label %common.resume, label %bb.cf

bb.cf:                                            ; preds = %bb.ce
  %i.fm = atomicrmw sub ptr %.sroa.7298.0.ph, i64 1 release, align 8, !noalias !228
  %i.fn = icmp eq i64 %i.fm, 1
  br i1 %i.fn, label %bb.cg, label %common.resume
...
_RNCINvXsk_NtCsa9sSWSfjDbm_4jiff5errorINtNtCs3oUPovFnLWP_4core6result6ResultaNtB8_5ErrorEINtB8_12ErrorContextaB1c_E7contextNtNtNtB8_3fmt8temporal5ErrorE0Ba_.exit105: ; preds = %bb.cd
  %i.fp = tail call noundef ptr @_RNvMs_NtCsa9sSWSfjDbm_4jiff5errorNtB4_5Error12context_impl(ptr noundef %.sroa.7298.0.ph, ptr noundef %i.fj), !noalias !227
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !227
  br label %bb.dd

bb.ci:                                            ; preds = %_RNvNtNtCsa9sSWSfjDbm_4jiff4util5parse3i64.exit49
  %i.fq = zext nneg i8 %narrow715.a to i64
  br i1 %i.er, label %_RNvMs5_NtNtNtCsa9sSWSfjDbm_4jiff3fmt8temporal6parserNtB5_14DateTimeParser20parse_time_separator.exit.i, label %bb.cj

bb.cj:                                            ; preds = %bb.ci
  %i.fr = icmp slt i64 %.sroa.5214.0634640, 4
  br i1 %i.fr, label %_RNvMNtCs3oUPovFnLWP_4core6resultINtB2_6ResultNtNtNtCsa9sSWSfjDbm_4jiff5civil4time4TimeNtNtBN_5error5ErrorE6unwrapBN_.exit131.i.i, label %.preheader.preheader

.preheader.preheader:                             ; preds = %bb.cj
  %.val.i.i.i114 = load i8, ptr %.ptr539, align 1, !noalias !229, !noundef !4
  %i.fs = add i8 %.val.i.i.i114, -48
  %.sroa.0.0.i.i.i.i.i115 = icmp ult i8 %i.fs, 10
...
.preheader.1:                                     ; preds = %.preheader.preheader
  ...
  %i.ft = add i8 %.val.i.i.i114.1, -48
  %.sroa.0.0.i.i.i.i.i115.1 = icmp ult i8 %i.ft, 10
...
_RNvMs5_NtNtNtCsa9sSWSfjDbm_4jiff3fmt8temporal6parserNtB5_14DateTimeParser20parse_time_separator.exit.i: ; preds = %bb.ci
  %i.fu = tail call { ptr, i64 } @_RINvMNtCs3oUPovFnLWP_4core5sliceSh12strip_prefixAhj1_ECsa9sSWSfjDbm_4jiff(ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %.ptr539, i64 noundef range(i64 0, -9223372036854775808) %i.ez, ptr noalias nofree noundef readonly captures(address, read_provenance) dereferenceable(1) @28), !noalias !230 ; 2 uses
  %i.fv = extractvalue { ptr, i64 } %i.fu, 0      ; 2 uses
  %.not.i134.i.not = icmp eq ptr %i.fv, null
...
_RNvMNtCs3oUPovFnLWP_4core6resultINtB2_6ResultNtNtNtCsa9sSWSfjDbm_4jiff5civil4time4TimeNtNtBN_5error5ErrorE6unwrapBN_.exit131.i.i: ; preds = %.preheader.preheader, %.preheader.1, %bb.cj, %_RNvMs5_NtNtNtCsa9sSWSfjDbm_4jiff3fmt8temporal6parserNtB5_14DateTimeParser20parse_time_separator.exit.i
  %i.fw = shl nuw nsw i64 %i.fe, 40
  %i.fx = shl nuw nsw i64 %i.ee, 32
  %.sroa.4241.sroa.0.4.insert.shift = or disjoint i64 %i.fw, %i.fx ; 2 uses
...
bb.ck:                                            ; preds = %_RNvMs5_NtNtNtCsa9sSWSfjDbm_4jiff3fmt8temporal6parserNtB5_14DateTimeParser20parse_time_separator.exit.i
  %i.fy = extractvalue { ptr, i64 } %i.fu, 1      ; 2 uses
  %i.fz = icmp samesign ult i64 %i.fy, 2
  br i1 %i.fz, label %bb.co, label %.thread652

.thread652:                                       ; preds = %.preheader.1, %bb.ck
  %.sroa.5234.0650656 = phi i64 [ %i.fy, %bb.ck ], [ %i.ez, %.preheader.1 ] ; 2 uses
  %.sroa.0233.0651655 = phi ptr [ %i.fv, %bb.ck ], [ %.ptr539, %.preheader.1 ] ; 4 uses
  %i.ga = getelementptr inbounds nuw i8, ptr %.sroa.0233.0651655, i64 2 ; 3 uses
  %i.gb = add nsw i64 %.sroa.5234.0650656, -2     ; 2 uses
  %i.gc = load i8, ptr %.sroa.0233.0651655, align 1, !alias.scope !231, !noalias !232, !noundef !4 ; 2 uses
  %i.gd = add i8 %i.gc, -48                       ; 2 uses
  %or.cond.i44 = icmp ult i8 %i.gd, 10
...
bb.cl:                                            ; preds = %.thread652
  ...
  %i.ge = load i8, ptr %.sroa.0.0.i43.ptr.1, align 1, !alias.scope !231, !noalias !232, !noundef !4 ; 2 uses
  %i.gf = add i8 %i.ge, -48                       ; 2 uses
  %or.cond.i44.1 = icmp ult i8 %i.gf, 10
...
_RNvNtNtCsa9sSWSfjDbm_4jiff4util5parse3i64.exit45: ; preds = %bb.cl
  %narrow623 = mul nuw nsw i8 %i.gd, 10
  %narrow716 = add nuw i8 %narrow623, %i.gf       ; 3 uses
  %or.cond531 = icmp ugt i8 %narrow716, 60
  br i1 %or.cond531, label %bb.cn, label %bb.cq

bb.cm:                                            ; preds = %bb.cl, %.thread652
  %.lcssa = phi i8 [ %i.gc, %.thread652 ], [ %i.ge, %bb.cl ]
  %i.gg = tail call noundef ptr @_RNvXs1_NtNtCsa9sSWSfjDbm_4jiff5error4utilNtB7_5ErrorINtNtCs3oUPovFnLWP_4core7convert4FromNtB5_13ParseIntErrorE4from(i8 noundef 1, i8 %.lcssa) #16, !noalias !233
  br label %bb.cp

bb.cn:                                            ; preds = %_RNvNtNtCsa9sSWSfjDbm_4jiff4util5parse3i64.exit45
  %i.gh = tail call noundef i8 @_RNvXsq_NtNtCsa9sSWSfjDbm_4jiff4util1bNtB5_10LeapSecondNtNtCsb09rMIQFAXO_9jiff_core6bounds6Bounds5error() #16, !noalias !233
  %i.gi = tail call noundef ptr @_RNvXNtNtCsa9sSWSfjDbm_4jiff4util1bNtNtB6_5error5ErrorINtNtCs3oUPovFnLWP_4core7convert4FromNtB2_11BoundsErrorE4from(i8 noundef %i.gh), !noalias !233
  br label %bb.cp

bb.co:                                            ; preds = %bb.ck
  %i.gj = tail call noundef ptr @_RNvXs_NtNtNtCsa9sSWSfjDbm_4jiff5error3fmt8temporalNtB8_5ErrorINtNtCs3oUPovFnLWP_4core7convert4FromNtB4_5ErrorE4from(i64 23) #16, !noalias !234
  br label %bb.dd

bb.cp:                                            ; preds = %bb.cn, %bb.cm
  %.sroa.7312.0.ph = phi ptr [ %i.gi, %bb.cn ], [ %i.gg, %bb.cm ]
  %i.gk = tail call fastcc noundef ptr @_RNCINvXsk_NtCsa9sSWSfjDbm_4jiff5errorINtNtCs3oUPovFnLWP_4core6result6ResultaNtB8_5ErrorEINtB8_12ErrorContextaB1c_E7contextNtNtNtB8_3fmt8temporal5ErrorE0Ba_(i64 48, ptr noundef %.sroa.7312.0.ph) #18, !noalias !235
  br label %bb.dd

bb.cq:                                            ; preds = %_RNvNtNtCsa9sSWSfjDbm_4jiff4util5parse3i64.exit45
  %i.gl = icmp eq i8 %narrow716, 60
  %spec.store.select.i.i.i = select i1 %i.gl, i8 59, i8 %narrow716 ; 2 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !236)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !237)
  %i.gm = icmp eq i64 %i.gb, 0
  br i1 %i.gm, label %.thread475, label %bb.cr
...
.thread475:                                       ; preds = %bb.cr, %bb.cq
  ...
  store ptr %i.ga, ptr %.sroa.5.0..sroa_idx.i, align 8, !alias.scope !236, !noalias !238
...
bb.cr:                                            ; preds = %bb.cq
  %i.gn = load i8, ptr %i.ga, align 1, !alias.scope !237, !noalias !239, !noundef !4
  switch i8 %i.gn, label %.thread475 [
