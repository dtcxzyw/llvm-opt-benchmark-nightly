...
bb.p:                                             ; preds = %bb.o
  %i.ay = getelementptr i8, ptr %i.ah, i64 -1
  %i.az = load i8, ptr %i.ay, align 1, !noalias !84, !noundef !4
  %i.ba = zext i8 %i.az to i64                    ; 3 uses
  %i.bb = icmp ugt i64 %.sroa.6.0.i, %i.ba
  br i1 %i.bb, label %_RNvMNtNtNtCsb09rMIQFAXO_9jiff_core2tz4tzif5queryNtB4_8TimeZone15local_time_type.exit50, label %bb.q

bb.q:                                             ; preds = %bb.p
  tail call void @_RNvNtCs3oUPovFnLWP_4core9panicking18panic_bounds_check(i64 noundef %i.ba, i64 noundef %.sroa.6.0.i, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @8) #17, !noalias !84
  unreachable

_RNvMNtNtNtCsb09rMIQFAXO_9jiff_core2tz4tzif5queryNtB4_8TimeZone15local_time_type.exit50: ; preds = %bb.p
  %i.bc = getelementptr inbounds nuw [8 x i8], ptr %.sroa.0.0.i, i64 %i.ba
  %i.bd = load i32, ptr %i.bc, align 4, !noundef !4
  %i.be = getelementptr inbounds nuw i8, ptr %0, i64 12
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %i.be, ptr noundef nonnull align 4 dereferenceable(12) %2, i64 12, i1 false)
  store i32 1, ptr %0, align 4
  %.sroa.428.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 4
  store i32 %i.bd, ptr %.sroa.428.0..sroa_idx, align 4
  %.sroa.5.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i32 %i.ao, ptr %.sroa.5.0..sroa_idx, align 4
  br label %bb.ab

bb.r:                                             ; preds = %bb.o
  tail call void @_RNvNtCs3oUPovFnLWP_4core6option13unwrap_failed(ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @22) #17
  unreachable

bb.s:                                             ; preds = %bb.k
  %i.bf = getelementptr inbounds nuw [8 x i8], ptr %.sroa.03.0, i64 %.sroa.015.0
  %i.bg = load i64, ptr %i.bf, align 8, !noundef !4
  %i.bh = icmp slt i64 %i.q, %i.bg
  br i1 %i.bh, label %bb.u, label %bb.l

bb.t:                                             ; preds = %bb.k
  tail call void @_RNvNtCs3oUPovFnLWP_4core9panicking18panic_bounds_check(i64 noundef %.sroa.015.0, i64 noundef %.sroa.6.0, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @23) #17
  unreachable

bb.u:                                             ; preds = %bb.s
  %i.bi = icmp eq i64 %.sroa.015.0, 0
  br i1 %i.bi, label %bb.x, label %bb.v, !prof !16

bb.v:                                             ; preds = %bb.u
  %i.bj = getelementptr i8, ptr %i.ah, i64 -1
  %i.bk = load i8, ptr %i.bj, align 1, !noalias !87, !noundef !4
...
bb.w:                                             ; preds = %bb.v
  tail call void @_RNvNtCs3oUPovFnLWP_4core9panicking18panic_bounds_check(i64 noundef %i.bl, i64 noundef %.sroa.6.0.i, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @8) #17, !noalias !87
  unreachable
...
bb.y:                                             ; preds = %bb.l
  ...
  %i.br = load i8, ptr %i.bq, align 8, !range !22, !noundef !4
...
bb.a:
  ...
  br i1 %or.cond.i, label %_RNvMs2_NtNtCsb09rMIQFAXO_9jiff_core2tz4tzifNtB5_9Timestamp21to_standard_timestamp.exit, label %bb.b, !prof !35
...
_RNvMs2_NtNtCsb09rMIQFAXO_9jiff_core2tz4tzifNtB5_9Timestamp21to_standard_timestamp.exit: ; preds = %bb.a
  ...
  br i1 %or.cond.i1, label %bb.d, label %bb.c, !prof !35

bb.c:                                             ; preds = %_RNvMs2_NtNtCsb09rMIQFAXO_9jiff_core2tz4tzifNtB5_9Timestamp21to_standard_timestamp.exit
  tail call void @_RNvNtCs3oUPovFnLWP_4core9panicking9panic_fmt(ptr noundef nonnull @2, ptr noundef nonnull inttoptr (i64 55 to ptr), ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @4) #17, !noalias !90
  unreachable
...
_RNvMNtNtCsb09rMIQFAXO_9jiff_core2tz6offsetNtB2_6Offset11to_datetime.exit: ; preds = %bb.d, %bb.e, %bb.f
  ...
  %i.w = mul nuw nsw i64 %i.v, 2939745            ; 2 uses
  %i.x = trunc i64 %i.w to i32                    ; 2 uses
  %i.y = udiv i32 %i.x, 11758980
  %i.z = mul nuw nsw i32 %i.y, 2141
  %i.aa = add nuw nsw i32 %i.z, 197913            ; 3 uses
  %.lhs.trunc.i.i = trunc i32 %i.aa to i16
  %i.ab = udiv i16 %.lhs.trunc.i.i, 2141
  %i.ac = icmp ugt i32 %i.x, -696719417           ; 2 uses
  %i.ad = and i32 %i.aa, 4128768
  %i.ae = add nuw nsw i32 %i.ad, 15990784
  %.sroa.2.0.insert.ext.i.i = select i1 %i.ac, i32 %i.ae, i32 %i.aa
  %i.af = udiv i32 %i.s, 146097
  %i.ag = mul nuw nsw i32 %i.af, 100
  %i.ah = add nuw nsw i32 %i.ag, 32736
  %i.ai = lshr i64 %i.w, 32
  %i.aj = trunc nuw nsw i64 %i.ai to i32
  %i.ak = add nuw nsw i32 %i.ah, %i.aj
  %i.al = zext i1 %i.ac to i32
  %i.am = add nuw nsw i32 %i.ak, %i.al
  %.sroa.6.8.extract.trunc = zext nneg i32 %i.am to i64
...
bb.a:
  %i.a = load i64, ptr %0, align 8, !range !93, !noundef !4
  ...
  br i1 %.not, label %bb.c, label %bb.b, !prof !94
...
bb.a:
  ...
  %or.cond = select i1 %i.c, i1 true, i1 %.not, !prof !95
  br i1 %or.cond, label %bb.g, label %bb.b, !prof !95
...
bb.a:
  ...
  %i.b = add nuw i64 %1, 1
  %i.c = load i64, ptr %0, align 8, !range !93, !noundef !4 ; 2 uses
  ...
  call fastcc void @_RNvMs5_NtCs1xwejQucwHj_5alloc7raw_vecNtB5_11RawVecInner11finish_growCsb09rMIQFAXO_9jiff_core(ptr noalias nofree noundef align 8 captures(none) dereferenceable(24) %i.a, i64 %i.c, ptr %.val13, i64 noundef %..i14, i64 noundef %2, i64 noundef %3)
  %i.f = load i64, ptr %i.a, align 8, !range !96, !noundef !4
...
bb.c:                                             ; preds = %bb.a
  %i.k = load i64, ptr %i.h, align 8, !range !97, !noundef !4
