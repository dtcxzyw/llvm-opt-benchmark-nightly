...
_RNvMNtNtCsb09rMIQFAXO_9jiff_core2tz6offsetNtB2_6Offset11to_datetime.exit: ; preds = %bb.d, %bb.e, %bb.f
  ...
  %2 = mul nuw nsw i32 %i.ai, 100
  %3 = add nuw nsw i32 %2, 32736
  %4 = lshr i64 %i.z, 32
  %5 = trunc nuw nsw i64 %4 to i32
  %i.aj = add nuw nsw i32 %3, %5
  %6 = zext i1 %i.af to i32
  %7 = add nuw nsw i32 %i.aj, %6
  %.sroa.6.8.extract.trunc = zext nneg i32 %7 to i64
