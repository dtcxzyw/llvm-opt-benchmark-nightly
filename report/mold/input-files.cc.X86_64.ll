...
bb.w:                                             ; preds = %bb.w, %.lr.ph.i.new
  ...
  %i.ej = load i8, ptr %gep.i, align 1, !tbaa !77
  %5 = zext i8 %i.ej to i64                       ; 2 uses
  %6 = lshr i64 %5, 1
  %7 = and i64 %6, 15
  %8 = lshr i64 %5, 5
  %9 = and i64 %8, 3
  %i.ek = shl nuw nsw i64 %7, %9
  ...
  %i.en = load i8, ptr %gep.i.1, align 1, !tbaa !77
  %10 = zext i8 %i.en to i64                      ; 2 uses
  %11 = lshr i64 %10, 1
  %12 = and i64 %11, 15
  %13 = lshr i64 %10, 5
  %14 = and i64 %13, 3
  %i.eo = shl nuw nsw i64 %12, %14
...
.epil.preheader:                                  ; preds = %_ZN4moldL21sframe_fre_block_sizeINS_6X86_64EEElSt17basic_string_viewIcSt11char_traitsIcEEl.exit.loopexit.unr-lcssa, %.lr.ph.i
  ...
  %i.er = load i8, ptr %gep.i.epil, align 1, !tbaa !77
  %15 = zext i8 %i.er to i64                      ; 2 uses
  %16 = lshr i64 %15, 1
  %17 = and i64 %16, 15
  %18 = lshr i64 %15, 5
  %19 = and i64 %18, 3
  %i.es = shl nuw nsw i64 %17, %19
