...
begin_hunk_0_@request_finished:bb.a
  %i.bi = load ptr, ptr %i.aw, align 8
  store ptr null, ptr %i.bi, align 8
  %i.bj = load ptr, ptr %i.aw, align 8            ; 2 uses
  %i.bk = getelementptr inbounds nuw i8, ptr %i.bj, i64 16
  %i.bl = load i32, ptr %i.bk, align 8
  %.not44 = icmp eq i32 %i.bl, 0
  br i1 %.not44, label %bb.v, label %bb.w

bb.v:                                             ; preds = %search_request_finished.exit
  tail call void @event_mm_free_(ptr noundef nonnull %i.bj) #19
  br label %bb.w

bb.w:                                             ; preds = %bb.v, %search_request_finished.exit
...
bb.y:                                             ; preds = %bb.w, %bb.x, %bb.o
  tail call void @event_mm_free_(ptr noundef nonnull %0) #19
  tail call fastcc void @evdns_requests_pump_waiting_queue(ptr noundef nonnull %i.b)
  %i.bm = load ptr, ptr %i.d, align 8             ; 2 uses
...
bb.z:                                             ; preds = %bb.y
  ...
  %i.bo = tail call i32 %i.bn(i32 noundef 0, ptr noundef nonnull %i.bm) #19 ; 0 uses
  br label %bb.aa
...
define ptr @evdns_base_resolve_ipv4(ptr noundef %0, ptr noundef %1, i32 noundef %2, ptr noundef %3, ptr noundef %4) local_unnamed_addr #3 {
bb.a:
  tail call void (i32, ptr, ...) @evdns_log_(i32 noundef 0, ptr noundef nonnull @.str.3, ptr noundef %1)
  %i.a = tail call ptr @event_mm_calloc_(i64 noundef 1, i64 noundef 48) #19 ; 6 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.f = tail call i32 %i.e(i32 noundef 0, ptr noundef nonnull %i.d) #19 ; 0 uses
  br label %bb.d

bb.d:                                             ; preds = %bb.c, %bb.b
  %i.g = and i32 %2, 1
  %.not29 = icmp eq i32 %i.g, 0
  br i1 %.not29, label %bb.m, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.h = tail call fastcc ptr @request_new(ptr noundef nonnull %0, ptr noundef nonnull %i.a, i32 noundef 1, ptr noundef %1, ptr noundef %3, ptr noundef %4) ; 23 uses
  %.not30 = icmp eq ptr %i.h, null
  br i1 %.not30, label %request_submit.exit, label %bb.f
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.n = getelementptr inbounds nuw i8, ptr %i.h, i64 192
  %i.o = load i16, ptr %i.n, align 8
  %i.p = zext i16 %i.o to i32
  %i.q = getelementptr inbounds nuw i8, ptr %i.j, i64 24
  %i.r = load i32, ptr %i.q, align 8
  %i.s = srem i32 %i.p, %i.r
  %i.t = zext nneg i32 %i.s to i64
  %i.u = getelementptr inbounds nuw [8 x i8], ptr %i.m, i64 %i.t ; 3 uses
