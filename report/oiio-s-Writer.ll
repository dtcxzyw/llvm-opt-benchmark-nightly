...
_ZNSt6vectorIhSaIhEEC2EmRKhRKS0_.exit:            ; preds = %.noexc, %14
  ...
  %.sroa.019.0 = phi ptr [ %16, %.noexc ], [ null, %14 ] ; [#uses=5 type=ptr]
  ...
  %24 = invoke noundef i64 %23(ptr noundef nonnull align 8 dereferenceable(16) %20, ptr noundef nonnull %.sroa.019.0, i64 noundef %15)
          to label %_ZNSt6vectorIhSaIhEED2Ev.exit unwind label %_ZNSt6vectorIhSaIhEED2Ev.exit18 ; [#uses=1 type=i64]
...
_ZNSt6vectorIhSaIhEED2Ev.exit:                    ; preds = %_ZNSt6vectorIhSaIhEEC2EmRKhRKS0_.exit
  ...
  %27 = ptrtoint ptr %.sroa.019.0 to i64          ; [#uses=1 type=i64]
  %28 = sub i64 %.sroa.12.0, %27                  ; [#uses=1 type=i64]
  tail call void @_ZdlPvm(ptr noundef nonnull %.sroa.019.0, i64 noundef %28) #17
  br i1 %.not, label %32, label %33

_ZNSt6vectorIhSaIhEED2Ev.exit18:                  ; preds = %_ZNSt6vectorIhSaIhEEC2EmRKhRKS0_.exit
  %29 = landingpad { ptr, i32 }
          cleanup                                 ; [#uses=1 type={ ptr, i32 }]
  %30 = ptrtoint ptr %.sroa.019.0 to i64          ; [#uses=1 type=i64]
  %31 = sub i64 %.sroa.12.0, %30                  ; [#uses=1 type=i64]
  tail call void @_ZdlPvm(ptr noundef nonnull %.sroa.019.0, i64 noundef %31) #17
  resume { ptr, i32 } %29
...
11:                                               ; preds = %_ZNK3dpx13GenericHeader15ImageDescriptorEi.exit
  ...
  %13 = load i64, ptr %12, align 8, !tbaa !25     ; [#uses=3 type=i64]
  %14 = add i64 %13, 8191                         ; [#uses=2 type=i64]
  %15 = srem i64 %14, 8192                        ; [#uses=1 type=i64]
  %16 = sub i64 %14, %15                          ; [#uses=2 type=i64]
  %sext.i = shl i64 %16, 32                       ; [#uses=1 type=i64]
  %17 = ashr exact i64 %sext.i, 32                ; [#uses=1 type=i64]
  %18 = sub i64 %16, %13                          ; [#uses=2 type=i64]
...
begin_hunk_3
  ...
  %28 = invoke noundef i64 %27(ptr noundef nonnull align 8 dereferenceable(16) %24, ptr noundef nonnull %22, i64 noundef %21)
          to label %_ZNSt6vectorIhSaIhEED2Ev.exit.i unwind label %_ZNSt6vectorIhSaIhEED2Ev.exit18.i ; [#uses=1 type=i64]
...
_ZNSt6vectorIhSaIhEED2Ev.exit18.i:                ; preds = %.noexc.i
...
_ZN3dpx13GenericHeader13SetDataOffsetEij.exit:    ; preds = %_ZNSt6vectorIhSaIhEED2Ev.exit.i._ZN3dpx13GenericHeader13SetDataOffsetEij.exit_crit_edge, %11
  %32 = phi i64 [ %.pre, %_ZNSt6vectorIhSaIhEED2Ev.exit.i._ZN3dpx13GenericHeader13SetDataOffsetEij.exit_crit_edge ], [ %13, %11 ] ; [#uses=2 type=i64]
...
12:                                               ; preds = %_ZNK3dpx13GenericHeader15ImageDescriptorEi.exit
  ...
  %14 = load i64, ptr %13, align 8, !tbaa !25     ; [#uses=2 type=i64]
  %15 = add i64 %14, 8191                         ; [#uses=2 type=i64]
  %16 = srem i64 %15, 8192                        ; [#uses=1 type=i64]
  %17 = sub i64 %15, %16                          ; [#uses=2 type=i64]
  %sext.i = shl i64 %17, 32                       ; [#uses=1 type=i64]
  %18 = ashr exact i64 %sext.i, 32                ; [#uses=1 type=i64]
  %19 = sub i64 %17, %14                          ; [#uses=2 type=i64]
