...
tailrecurse:                                      ; preds = %._crit_edge48.loopexit, %3
  %.tr = phi i32 [ %0, %3 ], [ %47, %._crit_edge48.loopexit ] ; 2 uses
...
40:                                               ; preds = %33, %29
  %.0 = phi i32 [ %.tr67, %29 ], [ %39, %33 ]     ; 5 uses
...
.lr.ph.us.us:                                     ; preds = %.lr.ph47.split.us, %._crit_edge.us.us
  ...
  %.03744.us.us = phi ptr [ %59, %._crit_edge.us.us ], [ %46, %.lr.ph47.split.us ] ; 2 uses
  %49 = load ptr, ptr @stdout, align 8, !tbaa !56
...
51:                                               ; preds = %.lr.ph.us.us, %51
  ...
  %52 = load ptr, ptr @stdout, align 8, !tbaa !56
  %53 = tail call noundef i32 @putc(i32 noundef 32, ptr noundef %52)
  %54 = add nuw nsw i32 %.03443.us.us, 1          ; 2 uses
...
.lr.ph47.split.us.split:                          ; preds = %.lr.ph47.split.us, %.lr.ph47.split.us.split
  ...
  %.03744.us = phi ptr [ %66, %.lr.ph47.split.us.split ], [ %46, %.lr.ph47.split.us ] ; 2 uses
  %60 = load ptr, ptr @stdout, align 8, !tbaa !56
