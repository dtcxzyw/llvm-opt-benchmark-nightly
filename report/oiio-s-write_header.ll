begin_hunk_0
  ...
  %.262 = select i1 %.not46.i, i32 %spec.select, i32 %54 ; [#uses=1 type=i32]
  %.262.fr = freeze i32 %.262                     ; [#uses=2 type=i32]
  store i32 20000630, ptr %2, align 4, !tbaa !3
  %55 = getelementptr inbounds nuw i8, ptr %2, i64 4 ; [#uses=1 type=ptr]
  store i32 %.262.fr, ptr %55, align 4, !tbaa !3
...
begin_hunk_1
  ...
  %63 = and i32 %.262.fr, 6144                    ; [#uses=1 type=i32]
...
.preheader75.split.us:                            ; preds = %.preheader75, %.thread67.us
  %indvars.iv123 = phi i64 [ %indvars.iv.next124, %.thread67.us ], [ 0, %.preheader75 ] ; [#uses=3 type=i64]
  %65 = load i32, ptr %60, align 4, !tbaa !24     ; [#uses=1 type=i32]
  %66 = sext i32 %65 to i64                       ; [#uses=1 type=i64]
  %67 = icmp slt i64 %indvars.iv123, %66          ; [#uses=1 type=i1]
  br i1 %67, label %68, label %.critedge

68:                                               ; preds = %.preheader75.split.us
  %69 = load ptr, ptr %61, align 8, !tbaa !25     ; [#uses=1 type=ptr]
  %70 = getelementptr inbounds nuw [8 x i8], ptr %69, i64 %indvars.iv123 ; [#uses=1 type=ptr]
...
76:                                               ; preds = %80
  %indvars.iv.next121 = add nuw nsw i64 %indvars.iv120, 1 ; [#uses=2 type=i64]
  %77 = load i32, ptr %73, align 8, !tbaa !29     ; [#uses=1 type=i32]
  %78 = sext i32 %77 to i64                       ; [#uses=1 type=i64]
  %79 = icmp slt i64 %indvars.iv.next121, %78     ; [#uses=1 type=i1]
  br i1 %79, label %80, label %.thread67.us, !llvm.loop !48

80:                                               ; preds = %.lr.ph87.us, %76
  %indvars.iv120 = phi i64 [ 0, %.lr.ph87.us ], [ %indvars.iv.next121, %76 ] ; [#uses=2 type=i64]
  %81 = load ptr, ptr %108, align 8, !tbaa !30    ; [#uses=1 type=ptr]
  %82 = getelementptr inbounds nuw [8 x i8], ptr %81, i64 %indvars.iv120 ; [#uses=1 type=ptr]
...
begin_hunk_3
  ...
  %indvars.iv.next124 = add nuw nsw i64 %indvars.iv123, 1 ; [#uses=1 type=i64]
...
89:                                               ; preds = %select.unfold.us.us, %.lr.ph.us
  ...
  %indvars.iv117 = phi i64 [ %indvars.iv.next118, %select.unfold.us.us ], [ 0, %.lr.ph.us ] ; [#uses=2 type=i64]
  %91 = load ptr, ptr %88, align 8, !tbaa !50     ; [#uses=1 type=ptr]
  %92 = getelementptr inbounds nuw [8 x i8], ptr %91, i64 %indvars.iv117 ; [#uses=1 type=ptr]
...
select.unfold.us.us:                              ; preds = %.select.unfold.us.us_crit_edge, %100, %96
  ...
  %indvars.iv.next118 = add nuw nsw i64 %indvars.iv117, 1 ; [#uses=2 type=i64]
  %106 = sext i32 %105 to i64                     ; [#uses=1 type=i64]
  %107 = icmp slt i64 %indvars.iv.next118, %106   ; [#uses=1 type=i1]
...
.preheader75.split:                               ; preds = %.preheader75, %.thread67
  %indvars.iv114 = phi i64 [ %indvars.iv.next115, %.thread67 ], [ 0, %.preheader75 ] ; [#uses=3 type=i64]
  %109 = load i32, ptr %60, align 4, !tbaa !24    ; [#uses=1 type=i32]
  %110 = sext i32 %109 to i64                     ; [#uses=1 type=i64]
  %111 = icmp slt i64 %indvars.iv114, %110        ; [#uses=1 type=i1]
  br i1 %111, label %112, label %.critedge

112:                                              ; preds = %.preheader75.split
  %113 = load ptr, ptr %61, align 8, !tbaa !25    ; [#uses=1 type=ptr]
  %114 = getelementptr inbounds nuw [8 x i8], ptr %113, i64 %indvars.iv114 ; [#uses=1 type=ptr]
...
130:                                              ; preds = %134
  %indvars.iv.next112 = add nuw nsw i64 %indvars.iv111, 1 ; [#uses=2 type=i64]
  %131 = load i32, ptr %117, align 8, !tbaa !29   ; [#uses=1 type=i32]
  %132 = sext i32 %131 to i64                     ; [#uses=1 type=i64]
  %133 = icmp slt i64 %indvars.iv.next112, %132   ; [#uses=1 type=i1]
  br i1 %133, label %134, label %.thread67, !llvm.loop !48

134:                                              ; preds = %.lr.ph87, %130
  %indvars.iv111 = phi i64 [ 0, %.lr.ph87 ], [ %indvars.iv.next112, %130 ] ; [#uses=2 type=i64]
  %135 = load ptr, ptr %121, align 8, !tbaa !30   ; [#uses=1 type=ptr]
  %136 = getelementptr inbounds nuw [8 x i8], ptr %135, i64 %indvars.iv111 ; [#uses=1 type=ptr]
...
begin_hunk_8
  ...
  %indvars.iv.next115 = add nuw nsw i64 %indvars.iv114, 1 ; [#uses=1 type=i64]
