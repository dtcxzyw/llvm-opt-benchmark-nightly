begin_hunk_0
  ...
  %40 = mul i32 %39, %37                          ; [#uses=7 type=i32]
  ...
  %47 = call ptr %46(ptr noundef nonnull %0, i32 noundef 1, i32 noundef %40, i32 noundef 1) #11 ; [#uses=5 type=ptr]
...
.lr.ph:                                           ; preds = %.preheader60
  %55 = sext i32 %40 to i64                       ; [#uses=1 type=i64]
  br label %81
...
.lr.ph64:                                         ; preds = %.preheader
  %56 = icmp sgt i32 %40, 0                       ; [#uses=1 type=i1]
  %57 = sext i32 %40 to i64                       ; [#uses=1 type=i64]
...
.lr.ph63.us.preheader:                            ; preds = %.lr.ph64
  %wide.trip.count = zext nneg i32 %40 to i64     ; [#uses=6 type=i64]
  %min.iters.check = icmp ult i32 %40, 4          ; [#uses=1 type=i1]
  %min.iters.check3 = icmp ult i32 %40, 16        ; [#uses=1 type=i1]
