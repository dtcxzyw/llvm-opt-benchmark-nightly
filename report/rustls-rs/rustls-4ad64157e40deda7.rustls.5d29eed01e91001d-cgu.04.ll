...
bb.a:
  ...
  %i.b = load i64, ptr %i.a, align 8, !alias.scope !1430, !noundef !6 ; 3 uses
  %i.c = getelementptr inbounds nuw i8, ptr %1, i64 16 ; 2 uses
  %i.d = load i64, ptr %i.c, align 8, !alias.scope !1430, !noundef !6 ; 5 uses
  %i.e = sub i64 %i.b, %i.d
...
bb.b:                                             ; preds = %bb.a
  ...
  store i64 %i.g, ptr %i.c, align 8, !alias.scope !1430
  %i.h = icmp ugt i64 %i.d, -4
  %.not.i = icmp ugt i64 %i.g, %i.b
  %or.cond.i = or i1 %i.h, %.not.i
  br i1 %or.cond.i, label %bb.c, label %bb.e, !prof !20

bb.c:                                             ; preds = %bb.b
  tail call void @_RNvNtNtCsj6eKBz9Db1c_4core5slice5index16slice_index_fail(i64 noundef %i.d, i64 noundef %i.g, i64 noundef %i.b, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @8) #30, !noalias !1430
  unreachable
...
bb.e:                                             ; preds = %bb.b
  %i.i = load ptr, ptr %1, align 8, !alias.scope !1430, !nonnull !6, !noundef !6
  %i.j = getelementptr inbounds nuw i8, ptr %i.i, i64 %i.d ; 2 uses
  %i.k = load i8, ptr %i.j, align 1, !noundef !6
...
bb.a:
  %i.a = load i32, ptr %0, align 4, !noundef !6
  ...
  %i.d = load i64, ptr %i.c, align 8, !alias.scope !1433, !noundef !6 ; 2 uses
  %i.e = icmp sgt i64 %i.d, -1
  tail call void @llvm.assume(i1 %i.e)
  %i.f = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.g = load ptr, ptr %i.f, align 8, !alias.scope !1433, !nonnull !6, !noundef !6
  ...
  %.pre.i = load i64, ptr %i.c, align 8, !alias.scope !1433
  %i.i = add i64 %.pre.i, 3
  store i64 %i.i, ptr %i.c, align 8, !alias.scope !1433
  ret void
}
...
bb.a:
  ...
  %i.h = load i16, ptr %i.g, align 8, !range !31, !noundef !6 ; 2 uses
  ...
  %i.l = load i8, ptr %i.k, align 4, !range !26, !noundef !6
  %i.m = getelementptr inbounds nuw i8, ptr %1, i64 8
  %.val = load ptr, ptr %i.m, align 8, !nonnull !6, !noundef !6 ; 3 uses
  %i.n = getelementptr inbounds nuw i8, ptr %1, i64 16
  %.val11 = load i64, ptr %i.n, align 8, !noundef !6 ; 3 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d), !noalias !1448
  store ptr %.val, ptr %i.d, align 8, !alias.scope !1449, !noalias !1450
  %i.o = getelementptr inbounds nuw i8, ptr %i.d, i64 8
  store i64 %.val11, ptr %i.o, align 8, !alias.scope !1449, !noalias !1450
  %i.p = getelementptr inbounds nuw i8, ptr %i.d, i64 16
  store i64 0, ptr %i.p, align 8, !alias.scope !1449, !noalias !1450
...
.thread:                                          ; preds = %bb.a
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d), !noalias !1448
  br label %bb.o
...
bb.c:                                             ; preds = %bb.a
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !1448
...
.noexc:                                           ; preds = %bb.c
  %i.r = load i8, ptr %i.a, align 8, !range !21, !noalias !1448, !noundef !6
  %.not13.i = icmp eq i8 %i.r, -1
  br i1 %.not13.i, label %bb.g, label %bb.f

bb.d:                                             ; preds = %bb.a
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c), !noalias !1448
...
.noexc12:                                         ; preds = %bb.d
  %i.s = load i8, ptr %i.c, align 8, !range !21, !noalias !1448, !noundef !6
  %.not.i = icmp eq i8 %i.s, -1
  br i1 %.not.i, label %bb.i, label %bb.h

bb.e:                                             ; preds = %bb.a
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !1448
...
.noexc13:                                         ; preds = %bb.e
  %i.t = load i64, ptr %i.b, align 8, !range !22, !noalias !1448, !noundef !6 ; 2 uses
...
bb.f:                                             ; preds = %.noexc
  %.sroa.10.8.copyload22 = load i64, ptr %i.a, align 8, !noalias !1451 ; 3 uses
  %.sroa.10.sroa.0.sroa.0.0.extract.trunc59 = trunc i64 %.sroa.10.8.copyload22 to i8
  %2 = lshr i64 %.sroa.10.8.copyload22, 8
  %.sroa.10.sroa.0.sroa.12.0.extract.trunc71 = trunc i64 %2 to i24
  ...
  %.sroa.19.8.copyload29 = load i64, ptr %.sroa.19.8..sroa_idx28, align 8, !noalias !1451
  %.sroa.21.8..sroa_idx35 = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  %.sroa.21.8.copyload36 = load i64, ptr %.sroa.21.8..sroa_idx35, align 8, !noalias !1451
  br label %bb.g
...
bb.g:                                             ; preds = %bb.f, %.noexc
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !1448
  br label %bb.n

bb.h:                                             ; preds = %.noexc12
  %.sroa.10.8.copyload21 = load i64, ptr %i.c, align 8, !noalias !1451 ; 3 uses
  %.sroa.10.sroa.0.sroa.0.0.extract.trunc58 = trunc i64 %.sroa.10.8.copyload21 to i8
  %3 = lshr i64 %.sroa.10.8.copyload21, 8
  %.sroa.10.sroa.0.sroa.12.0.extract.trunc69 = trunc i64 %3 to i24
  ...
  %.sroa.19.8.copyload27 = load i64, ptr %.sroa.19.8..sroa_idx26, align 8, !noalias !1451
  %.sroa.21.8..sroa_idx33 = getelementptr inbounds nuw i8, ptr %i.c, i64 16
  %.sroa.21.8.copyload34 = load i64, ptr %.sroa.21.8..sroa_idx33, align 8, !noalias !1451
  br label %bb.j

bb.i:                                             ; preds = %.noexc12
  %i.x = getelementptr inbounds nuw i8, ptr %i.c, i64 1
  %.sroa.06.0.copyload.i = load i32, ptr %i.x, align 1, !noalias !1448 ; 2 uses
  %.sroa.10.sroa.0.sroa.0.0.extract.trunc = trunc i32 %.sroa.06.0.copyload.i to i8
  %.sroa.10.sroa.0.sroa.12.0.extract.shift = lshr i32 %.sroa.06.0.copyload.i, 8
  %.sroa.10.sroa.0.sroa.12.0.extract.trunc = trunc nuw i32 %.sroa.10.sroa.0.sroa.12.0.extract.shift to i24
  br label %bb.j

bb.j:                                             ; preds = %bb.i, %bb.h
  %.sroa.10.sroa.0.sroa.12.sroa.0.1 = phi i24 [ %.sroa.10.sroa.0.sroa.12.0.extract.trunc, %bb.i ], [ %.sroa.10.sroa.0.sroa.12.0.extract.trunc69, %bb.h ]
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c), !noalias !1448
  br label %bb.n

bb.k:                                             ; preds = %.noexc13
  %.sroa.10.8.copyload20 = load i64, ptr %i.v, align 8, !noalias !1451
  %.sroa.19.8..sroa_idx24 = getelementptr inbounds nuw i8, ptr %i.b, i64 16
  %.sroa.19.8.copyload25 = load i64, ptr %.sroa.19.8..sroa_idx24, align 8, !noalias !1451
  %.sroa.21.8..sroa_idx31 = getelementptr inbounds nuw i8, ptr %i.b, i64 24
  %.sroa.21.8.copyload32 = load i64, ptr %.sroa.21.8..sroa_idx31, align 8, !noalias !1451
  br label %bb.m

bb.l:                                             ; preds = %.noexc13
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(128) %.sroa.23, ptr noundef nonnull align 8 dereferenceable(128) %i.v, i64 128, i1 false), !noalias !1451
...
bb.m:                                             ; preds = %bb.l, %bb.k
  ...
  %.sroa.10.sroa.0.sroa.12.sroa.0.0.in = lshr i64 %.sroa.10.sroa.0.sroa.12.sroa.0.0.in.in.in, 8
  %.sroa.10.sroa.0.sroa.12.sroa.0.0 = trunc i64 %.sroa.10.sroa.0.sroa.12.sroa.0.0.in to i24
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !1448
  br label %bb.n
...
bb.o:                                             ; preds = %.thread, %bb.n
  ...
  %.sroa.21.3100 = phi i64 [ undef, %.thread ], [ %.sroa.21.3, %bb.n ]
  ...
  %i.ab = load i64, ptr %1, align 8, !range !5, !alias.scope !1452, !noundef !6
...
bb.s:                                             ; preds = %.thread102, %bb.n
  ...
  %.sroa.21.3112 = phi i64 [ %.val11, %.thread102 ], [ %.sroa.21.3, %bb.n ]
...
bb.t:                                             ; preds = %bb.s
  ...
  %i.af = load i64, ptr %1, align 8, !range !5, !alias.scope !1453, !noundef !6
...
bb.a:
  ...
  %i.a = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.b = load i64, ptr %i.a, align 8, !alias.scope !1456, !noundef !6 ; 3 uses
  %i.c = getelementptr inbounds nuw i8, ptr %1, i64 16 ; 2 uses
  %i.d = load i64, ptr %i.c, align 8, !alias.scope !1456, !noundef !6 ; 5 uses
  %i.e = sub i64 %i.b, %i.d
...
bb.b:                                             ; preds = %bb.a
  ...
  store i64 %i.g, ptr %i.c, align 8, !alias.scope !1456
...
bb.c:                                             ; preds = %bb.b
  tail call void @_RNvNtNtCsj6eKBz9Db1c_4core5slice5index16slice_index_fail(i64 noundef %i.d, i64 noundef %i.g, i64 noundef %i.b, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @8) #30, !noalias !1456
  unreachable
...
bb.e:                                             ; preds = %bb.b
  %i.i = load ptr, ptr %1, align 8, !alias.scope !1456, !nonnull !6, !noundef !6
...
bb.a:
  ...
  %i.f = load i16, ptr %i.e, align 2, !range !31, !noundef !6 ; 2 uses
  %i.g = getelementptr inbounds nuw i8, ptr %1, i64 20
  %i.h = load i16, ptr %i.g, align 4              ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.23)
  %i.i = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.j = load i8, ptr %i.i, align 8, !range !26, !noundef !6
  %i.k = load ptr, ptr %1, align 8, !nonnull !6, !noundef !6 ; 3 uses
  %i.l = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.m = load i64, ptr %i.l, align 8, !noundef !6 ; 3 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d), !noalias !1463
  store ptr %i.k, ptr %i.d, align 8, !alias.scope !1464, !noalias !1465
  %i.n = getelementptr inbounds nuw i8, ptr %i.d, i64 8
  store i64 %i.m, ptr %i.n, align 8, !alias.scope !1464, !noalias !1465
  %i.o = getelementptr inbounds nuw i8, ptr %i.d, i64 16
  store i64 0, ptr %i.o, align 8, !alias.scope !1464, !noalias !1465
...
_RNvMNtNtCs7ZUl82OSlxp_6rustls4msgs7messageNtB2_14MessagePayload3new.exit.thread: ; preds = %bb.a
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d), !noalias !1463
  br label %bb.m
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.p = load i8, ptr %i.a, align 8, !range !21, !noalias !1463, !noundef !6
  %.not13.i = icmp eq i8 %i.p, -1
  br i1 %.not13.i, label %bb.f, label %bb.e

bb.c:                                             ; preds = %bb.a
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c), !noalias !1463
  ...
  %i.q = load i8, ptr %i.c, align 8, !range !21, !noalias !1463, !noundef !6
...
bb.d:                                             ; preds = %bb.a
  ...
  %i.r = load i64, ptr %i.b, align 8, !range !22, !noalias !1463, !noundef !6 ; 2 uses
...
bb.e:                                             ; preds = %bb.b
  ...
  %2 = lshr i64 %.sroa.10.8.copyload12, 8
  %.sroa.10.sroa.0.sroa.12.0.extract.trunc61 = trunc i64 %2 to i24
...
bb.g:                                             ; preds = %bb.c
  ...
  %3 = lshr i64 %.sroa.10.8.copyload11, 8
  %.sroa.10.sroa.0.sroa.12.0.extract.trunc59 = trunc i64 %3 to i24
...
bb.h:                                             ; preds = %bb.c
  ...
  %.sroa.06.0.copyload.i = load i32, ptr %i.v, align 1, !noalias !1463 ; 2 uses
  %.sroa.10.sroa.0.sroa.0.0.extract.trunc = trunc i32 %.sroa.06.0.copyload.i to i8
  %.sroa.10.sroa.0.sroa.12.0.extract.shift = lshr i32 %.sroa.06.0.copyload.i, 8
  %.sroa.10.sroa.0.sroa.12.0.extract.trunc = trunc nuw i32 %.sroa.10.sroa.0.sroa.12.0.extract.shift to i24
  br label %bb.i
...
bb.i:                                             ; preds = %bb.h, %bb.g
  %.sroa.10.sroa.0.sroa.12.sroa.0.1 = phi i24 [ %.sroa.10.sroa.0.sroa.12.0.extract.trunc, %bb.h ], [ %.sroa.10.sroa.0.sroa.12.0.extract.trunc59, %bb.g ]
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c), !noalias !1463
  br label %_RNvMNtNtCs7ZUl82OSlxp_6rustls4msgs7messageNtB2_14MessagePayload3new.exit
...
bb.m:                                             ; preds = %_RNvMNtNtCs7ZUl82OSlxp_6rustls4msgs7messageNtB2_14MessagePayload3new.exit.thread, %_RNvMNtNtCs7ZUl82OSlxp_6rustls4msgs7messageNtB2_14MessagePayload3new.exit
  ...
  %.sroa.21.390 = phi i64 [ undef, %_RNvMNtNtCs7ZUl82OSlxp_6rustls4msgs7messageNtB2_14MessagePayload3new.exit.thread ], [ %.sroa.21.3, %_RNvMNtNtCs7ZUl82OSlxp_6rustls4msgs7messageNtB2_14MessagePayload3new.exit ]
...
bb.n:                                             ; preds = %_RNvMNtNtCs7ZUl82OSlxp_6rustls4msgs7messageNtB2_14MessagePayload3new.exit.thread92, %_RNvMNtNtCs7ZUl82OSlxp_6rustls4msgs7messageNtB2_14MessagePayload3new.exit
  ...
  %.sroa.21.3102 = phi i64 [ %i.m, %_RNvMNtNtCs7ZUl82OSlxp_6rustls4msgs7messageNtB2_14MessagePayload3new.exit.thread92 ], [ %.sroa.21.3, %_RNvMNtNtCs7ZUl82OSlxp_6rustls4msgs7messageNtB2_14MessagePayload3new.exit ]
...
bb.a:
  ...
  %i.d = load i64, ptr %0, align 8, !range !5, !noundef !6 ; 2 uses
  %.not = icmp eq i64 %i.d, -1
  %i.e = load i64, ptr %1, align 8, !range !5
...
bb.c:                                             ; preds = %bb.a
  ...
  call void @_RNvXsb_NtCs4wP2HXfJTCR_5alloc3vecINtB5_3VecNtCseO5Jl7W60Eg_16rustls_pki_types14CertificateDerENtNtCsj6eKBz9Db1c_4core5clone5Clone5cloneCs7ZUl82OSlxp_6rustls(ptr noalias nofree noundef nonnull sret([24 x i8]) align 8 captures(address) dereferenceable(24) %i.a, ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %1), !noalias !1474
...
.body.i:                                          ; preds = %bb.f, %bb.d
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %0, ptr noundef nonnull align 8 dereferenceable(24) %i.a, i64 24, i1 false), !noalias !1475
...
_RNvYNtNtNtCs7ZUl82OSlxp_6rustls4msgs9handshake16CertificateChainNtNtCsj6eKBz9Db1c_4core5clone5Clone10clone_fromB8_.exit: ; preds = %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCs4wP2HXfJTCR_5alloc3vec3VecNtCseO5Jl7W60Eg_16rustls_pki_types14CertificateDerEECs7ZUl82OSlxp_6rustls.exit.i.i
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %0, ptr noundef nonnull align 8 dereferenceable(24) %i.a, i64 24, i1 false), !noalias !1475
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !1473
  br label %bb.g
...
bb.h:                                             ; preds = %bb.b
  ...
  %.pre = load i64, ptr %0, align 8, !range !5, !alias.scope !1476
  br label %bb.i
