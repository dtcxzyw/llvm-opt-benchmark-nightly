...
.body233:                                         ; preds = %bb.bu, %bb.cd, %bb.by, %bb.bz, %bb.cf, %bb.go, %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueNtNtCsl0TPHHzpGH6_5bytes9bytes_mut8BytesMutECs5MfxasYgTEl_11hickory_net.exit305, %.body217
  %.pn124.pn = phi { ptr, i32 } [ %.pn26, %.body217 ], [ %.pn116.pn.pn.pn.pn, %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueNtNtCsl0TPHHzpGH6_5bytes9bytes_mut8BytesMutECs5MfxasYgTEl_11hickory_net.exit305 ], [ %i.qu, %bb.go ], [ %i.hk, %bb.bu ], [ %i.hn, %bb.by ], [ %i.hn, %bb.bz ], [ %i.hv, %bb.cd ], [ %i.hx, %bb.cf ]
...
_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCs4okMlIQ9Z13_2h26client16ReadySendRequestNtNtCsl0TPHHzpGH6_5bytes5bytes5BytesEECs5MfxasYgTEl_11hickory_net.exit229: ; preds = %bb.l, %bb.bm, %bb.br, %bb.g, %bb.ga, %bb.gd, %bb.gz, %bb.be
  %.pn143.pn.pn = phi { ptr, i32 } [ %.pn88, %bb.ga ], [ %i.rm, %bb.gz ], [ %.pn134.pn, %bb.be ], [ %i.qb, %bb.gd ], [ %.pn143, %bb.bm ], [ %i.ck, %bb.l ], [ %i.cd, %bb.g ], [ %i.cd, %bb.br ] ; 2 uses
...
.preheader56.i.i.i.i.preheader:                   ; preds = %thread-pre-split.i.i.i.i, %.preheader56.i.i.i.i
  %.sroa.0.1.i.i.i.i1013 = phi ptr [ %i.jt, %.preheader56.i.i.i.i ], [ %.sroa.0.0.i.i.i.i, %thread-pre-split.i.i.i.i ] ; 2 uses
  %.sroa.15.1.i.i.i.i1012 = phi i64 [ %i.ju, %.preheader56.i.i.i.i ], [ %.sroa.15.0.i.i.i.i, %thread-pre-split.i.i.i.i ]
  %.sroa.042.0.i.i.i.i1011 = phi i64 [ %i.kf, %.preheader56.i.i.i.i ], [ 0, %thread-pre-split.i.i.i.i ]
  %i.jt = getelementptr inbounds nuw i8, ptr %.sroa.0.1.i.i.i.i1013, i64 1
  %i.ju = add nsw i64 %.sroa.15.1.i.i.i.i1012, -1 ; 2 uses
  %i.jv = call { i64, i1 } @llvm.umul.with.overflow.i64(i64 %.sroa.042.0.i.i.i.i1011, i64 10) ; 2 uses
  %i.jw = extractvalue { i64, i1 } %i.jv, 0       ; 2 uses
  %i.jx = extractvalue { i64, i1 } %i.jv, 1
  %i.jy = load i8, ptr %.sroa.0.1.i.i.i.i1013, align 1, !alias.scope !708, !noalias !717, !noundef !5 ; 2 uses
...
.loopexit964:                                     ; preds = %.preheader56.i.i.i.i, %bb.dg, %bb.cw, %.preheader.i.i.i.i
  %.sroa.9452.0.ph = phi i64 [ %i.kp, %bb.dg ], [ undef, %bb.cw ], [ 0, %.preheader.i.i.i.i ], [ %i.kf, %.preheader56.i.i.i.i ] ; 2 uses
  %.sroa.0451.0.ph = phi i64 [ 1, %bb.dg ], [ 0, %bb.cw ], [ 1, %.preheader.i.i.i.i ], [ 1, %.preheader56.i.i.i.i ] ; 2 uses
...
_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueNtNtCsl0TPHHzpGH6_5bytes9bytes_mut8BytesMutECs5MfxasYgTEl_11hickory_net.exit305: ; preds = %bb.dh, %bb.da, %bb.cv, %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueNtNtCsl0TPHHzpGH6_5bytes5bytes5BytesECs5MfxasYgTEl_11hickory_net.exit, %bb.cn, %bb.cp, %bb.ct, %bb.di, %bb.gn
  %.pn116.pn.pn.pn.pn = phi { ptr, i32 } [ %i.jc, %bb.ct ], [ %i.qt, %bb.gn ], [ %i.it, %bb.cn ], [ %i.ky, %bb.di ], [ %i.iv, %bb.cp ], [ %.pn111.pn.pn.pn, %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueNtNtCsl0TPHHzpGH6_5bytes5bytes5BytesECs5MfxasYgTEl_11hickory_net.exit ], [ %i.kr, %bb.dh ], [ %i.je, %bb.cv ], [ %i.jp, %bb.da ]
...
_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueNtNtCsl0TPHHzpGH6_5bytes9bytes_mut8BytesMutECs5MfxasYgTEl_11hickory_net.exit: ; preds = %bb.dj, %bb.dk, %bb.et
  %.sroa.15.4 = phi i8 [ %.sroa.15.5, %bb.et ], [ 5, %bb.dk ], [ 5, %bb.dj ]
  %.sroa.49.4 = phi i64 [ %.sroa.49.5, %bb.et ], [ %.sroa.14474.sroa.0.0.copyload, %bb.dk ], [ %.sroa.16.sroa.0.0.copyload, %bb.dj ]
  %.sroa.53.4 = phi ptr [ %.sroa.53.5, %bb.et ], [ %.sroa.14474.sroa.5.0.copyload, %bb.dk ], [ %.sroa.16.sroa.7.0.copyload, %bb.dj ]
  %i.le = phi <2 x i64> [ %i.nk, %bb.et ], [ %i.ld, %bb.dk ], [ %i.la, %bb.dj ]
...
bb.dn:                                            ; preds = %.thread, %bb.dm
  %3 = phi ptr [ %i.ng, %.thread ], [ %i.lg, %bb.dm ]
  %.sroa.7521.sroa.12.1997 = phi ptr [ %.sroa.7521.sroa.12.0, %.thread ], [ undef, %bb.dm ]
  %i.lh = getelementptr inbounds nuw i8, ptr %1, i64 400
  %i.li = load ptr, ptr %i.lh, align 8, !noalias !733, !nonnull !5, !align !141, !noundef !5
  %i.lj = getelementptr inbounds nuw i8, ptr %1, i64 408
  store ptr %i.li, ptr %i.lj, align 8, !noalias !733
  br label %bb.dq
...
bb.dq:                                            ; preds = %bb.dn, %bb.dm
  %4 = phi ptr [ %3, %bb.dn ], [ %i.lg, %bb.dm ]  ; 2 uses
  %.sroa.7521.sroa.12.1996 = phi ptr [ %.sroa.7521.sroa.12.1997, %bb.dn ], [ undef, %bb.dm ]
  %i.lk = getelementptr inbounds nuw i8, ptr %1, i64 408
  invoke void @_RNvXs_Cs4okMlIQ9Z13_2h2INtB4_6PollFnNCNCNvMs1_NtB4_5shareNtBI_10RecvStream4data00ENtNtNtCsj6eKBz9Db1c_4core6future6future6Future4pollCs5MfxasYgTEl_11hickory_net(ptr noalias nofree noundef nonnull sret([40 x i8]) align 8 captures(address) dereferenceable(40) %i.ax, ptr noalias nofree noundef nonnull align 8 dereferenceable(8) %i.lk, ptr noalias nofree noundef nonnull align 8 dereferenceable(32) %2)
...
bb.dt:                                            ; preds = %bb.dq
  %i.ln = load i8, ptr %i.ax, align 8, !range !738, !alias.scope !737, !noalias !739, !noundef !5 ; 3 uses
  %i.lo = icmp eq i8 %i.ln, -3                    ; 2 uses
  %spec.select.i264 = select i1 %i.lo, i8 3, i8 1
  store i8 %spec.select.i264, ptr %4, align 8, !noalias !733
  br i1 %i.lo, label %bb.du, label %bb.dv
...
bb.dv:                                            ; preds = %bb.dt
  ...
  %.sroa.37.sroa.5.0.copyload = load ptr, ptr %.sroa.37.sroa.5.0..sroa.37.0..sroa_idx.sroa_idx, align 8 ; 5 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ax)
  switch i8 %i.ln, label %bb.dw [
    i8 -2, label %bb.ed
    i8 -1, label %.noexc
  ]
...
bb.dw:                                            ; preds = %bb.dv
  ...
  store i8 %i.ln, ptr %i.g, align 8, !noalias !744
...
_RINvMNtCsj6eKBz9Db1c_4core6optionINtB3_6OptionReE11map_or_elseNtNtCs4wP2HXfJTCR_5alloc6string6StringNCNvNtB12_3fmt6format0NvYeNtNtB12_6borrow7ToOwned8to_ownedECs5MfxasYgTEl_11hickory_net.exit.i.i272: ; preds = %bb.dw
  ...
  %i.lq = load <2 x ptr>, ptr %i.f, align 16, !noalias !751
  ...
  %i.lr = load i8, ptr %i.g, align 8, !range !289, !alias.scope !758, !noalias !750, !noundef !5
  switch i8 %i.lr, label %bb.dy [
    i8 0, label %bb.es
    i8 1, label %bb.eb
    i8 2, label %bb.es
    i8 3, label %bb.es
...
bb.dy:                                            ; preds = %_RINvMNtCsj6eKBz9Db1c_4core6optionINtB3_6OptionReE11map_or_elseNtNtCs4wP2HXfJTCR_5alloc6string6StringNCNvNtB12_3fmt6format0NvYeNtNtB12_6borrow7ToOwned8to_ownedECs5MfxasYgTEl_11hickory_net.exit.i.i272
  ...
  %i.ls = ptrtoint ptr %.val.i.i.i.i275 to i64    ; 2 uses
  %i.lt = and i64 %i.ls, 3
  switch i64 %i.lt, label %default.unreachable994 [
...
bb.dz:                                            ; preds = %bb.dy
  %i.lu = icmp ult ptr %.val.i.i.i.i275, inttoptr (i64 188978561024 to ptr)
  %i.lv = and i64 %i.ls, 1095216660480
  %i.lw = icmp ne i64 %i.lv, 1095216660480
...
bb.ea:                                            ; preds = %bb.dy
  %i.lx = getelementptr i8, ptr %.val.i.i.i.i275, i64 -1 ; 2 uses
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %i.lx) ]
  %i.ly = getelementptr inbounds nuw i8, ptr %i.d, i64 8 ; 2 uses
  store ptr %i.lx, ptr %i.ly, align 8, !alias.scope !760, !noalias !759
  store i8 3, ptr %i.d, align 8, !alias.scope !760, !noalias !759
  invoke void @_RNvXsd_NtNtCsj6eKBz9Db1c_4core2io5errorNtB5_11CustomOwnerNtNtNtB9_3ops4drop4Drop4drop(ptr noalias nofree noundef nonnull align 8 dereferenceable(8) %i.ly)
...
bb.eb:                                            ; preds = %_RINvMNtCsj6eKBz9Db1c_4core6optionINtB3_6OptionReE11map_or_elseNtNtCs4wP2HXfJTCR_5alloc6string6StringNCNvNtB12_3fmt6format0NvYeNtNtB12_6borrow7ToOwned8to_ownedECs5MfxasYgTEl_11hickory_net.exit.i.i272
  ...
  %i.lz = load ptr, ptr %.sroa.8500.sroa.10.0..sroa.8500.0..sroa_idx.sroa_idx, align 8, !alias.scope !769, !noalias !750, !noundef !5
  %i.ma = load ptr, ptr %.sroa.8500.sroa.7.0..sroa.8500.0..sroa_idx.sroa_idx, align 8, !alias.scope !769, !noalias !750, !nonnull !5, !align !141, !noundef !5
  %i.mb = getelementptr inbounds nuw i8, ptr %i.ma, i64 32
  %i.mc = load ptr, ptr %i.mb, align 8, !noalias !770, !nonnull !5, !noundef !5
  %i.md = load ptr, ptr %.sroa.8500.sroa.8.0..sroa.8500.0..sroa_idx.sroa_idx, align 8, !alias.scope !769, !noalias !750, !noundef !5
  %i.me = load i64, ptr %.sroa.8500.sroa.9.0..sroa.8500.0..sroa_idx.sroa_idx, align 8, !alias.scope !769, !noalias !750, !noundef !5
  invoke void %i.mc(ptr noundef %i.lz, ptr noundef %i.md, i64 noundef %i.me)
...
bb.ed:                                            ; preds = %bb.dv
  ...
  %i.mg = trunc nuw i64 %.pre979 to i1
  br i1 %i.mg, label %.thread998, label %bb.ey
...
.noexc:                                           ; preds = %bb.dv
  %i.mi = load atomic i64, ptr @_RNvNtCsjpgBhlqJ253_12tracing_core8metadata9MAX_LEVEL monotonic, align 8
  %.off962 = add i64 %i.mi, -2
  %switch963 = icmp ult i64 %.off962, 4
  br i1 %switch963, label %.critedge158, label %bb.ef

bb.ef:                                            ; preds = %.noexc
  %i.mj = load atomic i8, ptr getelementptr inbounds nuw (i8, ptr @_RNvNCNvNtCs5MfxasYgTEl_11hickory_net2h24send0s0_10___CALLSITE, i64 16) monotonic, align 8 ; 2 uses
  %i.mk = icmp ult i8 %i.mj, 3
  br i1 %i.mk, label %bb.ei, label %bb.eg, !prof !540

bb.eg:                                            ; preds = %bb.ef
  %i.ml = invoke noundef i8 @_RNvMNtCsjpgBhlqJ253_12tracing_core8callsiteNtB2_15DefaultCallsite8register(ptr noundef nonnull align 8 @_RNvNCNvNtCs5MfxasYgTEl_11hickory_net2h24send0s0_10___CALLSITE) #21
...
bb.ei:                                            ; preds = %bb.eg, %bb.ef
  %.sroa.0.0.i283 = phi i8 [ %i.mj, %bb.ef ], [ %i.ml, %bb.eg ] ; 2 uses
  %i.mn = icmp eq i8 %.sroa.0.0.i283, 0
  br i1 %i.mn, label %.critedge158, label %bb.ek
...
bb.ek:                                            ; preds = %bb.ei
  %i.mp = load ptr, ptr @_RNvNCNvNtCs5MfxasYgTEl_11hickory_net2h24send0s0_10___CALLSITE, align 8, !nonnull !5, !align !141, !noundef !5
  %i.mq = invoke noundef zeroext i1 @_RNvNtCsiIyHGM5EznH_7tracing15___macro_support12___is_enabled(ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(120) %i.mp, i8 noundef %.sroa.0.0.i283)
          to label %bb.el unwind label %bb.ej

bb.el:                                            ; preds = %bb.ek
  br i1 %i.mq, label %bb.em, label %.critedge158

.critedge158:                                     ; preds = %.noexc, %bb.ei, %_RNCNCNvNtCs5MfxasYgTEl_11hickory_net2h24send0s9_0B7_.exit, %bb.el
  %i.mr = getelementptr inbounds nuw i8, ptr %1, i64 440
  ...
  invoke void @_RINvXsm_NtCsl0TPHHzpGH6_5bytes9bytes_mutNtB6_8BytesMutINtNtNtNtCsj6eKBz9Db1c_4core4iter6traits7collect6ExtendhE6extendNtNtB8_5bytes5BytesECs5MfxasYgTEl_11hickory_net(ptr noalias nofree noundef nonnull align 8 dereferenceable(32) %i.mr, ptr noalias nofree noundef nonnull align 8 captures(address) dereferenceable(32) %i.ar)
          to label %bb.ep unwind label %bb.eo

bb.em:                                            ; preds = %bb.el
  call void @llvm.lifetime.start.p0(ptr nonnull %i.aw)
  %i.ms = load ptr, ptr @_RNvNCNvNtCs5MfxasYgTEl_11hickory_net2h24send0s0_10___CALLSITE, align 8, !nonnull !5, !align !141, !noundef !5 ; 2 uses
  ...
  %i.mu = getelementptr inbounds nuw i8, ptr %i.au, i64 8
  store ptr %i.as, ptr %i.mu, align 8
  store ptr %i.au, ptr %i.av, align 8
  %i.mv = getelementptr inbounds nuw i8, ptr %i.av, i64 8
  store ptr @11, ptr %i.mv, align 8
  ...
  store ptr %i.mt, ptr %.sroa.9544.0..sroa_idx, align 8
  invoke void @_RNvMNtCsjpgBhlqJ253_12tracing_core5eventNtB2_5Event8dispatch(ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(120) %i.ms, ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(32) %i.aw)
...
bb.ep:                                            ; preds = %.critedge158
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ar)
  %i.my = getelementptr inbounds nuw i8, ptr %1, i64 424
  %i.mz = load i64, ptr %i.my, align 8, !range !546, !noundef !5
  %i.na = trunc nuw i64 %i.mz to i1
  br i1 %i.na, label %bb.eq, label %.thread

bb.eq:                                            ; preds = %bb.ep
  %i.nb = getelementptr inbounds nuw i8, ptr %1, i64 432
  %i.nc = load i64, ptr %i.nb, align 8, !noundef !5
  %i.nd = getelementptr i8, ptr %1, i64 448
  %.val179 = load i64, ptr %i.nd, align 8, !noundef !5
  %.not60 = icmp ult i64 %.val179, %i.nc
  br i1 %.not60, label %.thread, label %.thread998

.thread:                                          ; preds = %bb.ep, %bb.eq, %.loopexit964
  %.sroa.7521.sroa.12.0 = phi ptr [ undef, %.loopexit964 ], [ %.sroa.37.sroa.5.0.copyload, %bb.eq ], [ %.sroa.37.sroa.5.0.copyload, %bb.ep ]
  %i.ne = getelementptr inbounds nuw i8, ptr %1, i64 584
  %i.nf = getelementptr inbounds nuw i8, ptr %1, i64 400
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.ax)
  %i.ng = getelementptr inbounds nuw i8, ptr %1, i64 416
  br label %bb.dn

bb.er:                                            ; preds = %bb.en, %bb.ej, %bb.eh
  %.pn58.ph = phi { ptr, i32 } [ %i.mm, %bb.eh ], [ %i.mw, %bb.en ], [ %i.mo, %bb.ej ]
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.37.sroa.2.0.copyload) ]
  %i.nh = getelementptr inbounds nuw i8, ptr %.sroa.37.sroa.2.0.copyload, i64 32
  %i.ni = load ptr, ptr %i.nh, align 8, !noalias !772, !nonnull !5, !noundef !5
  invoke void %i.ni(ptr noundef %.sroa.37.sroa.5.0.copyload, ptr noundef %.sroa.37.sroa.3.0.copyload, i64 noundef %.sroa.37.sroa.4.0.copyload)
...
bb.es:                                            ; preds = %_RINvMNtCsj6eKBz9Db1c_4core6optionINtB3_6OptionReE11map_or_elseNtNtCs4wP2HXfJTCR_5alloc6string6StringNCNvNtB12_3fmt6format0NvYeNtNtB12_6borrow7ToOwned8to_ownedECs5MfxasYgTEl_11hickory_net.exit.i.i272, %_RINvMNtCsj6eKBz9Db1c_4core6optionINtB3_6OptionReE11map_or_elseNtNtCs4wP2HXfJTCR_5alloc6string6StringNCNvNtB12_3fmt6format0NvYeNtNtB12_6borrow7ToOwned8to_ownedECs5MfxasYgTEl_11hickory_net.exit.i.i272, %_RINvMNtCsj6eKBz9Db1c_4core6optionINtB3_6OptionReE11map_or_elseNtNtCs4wP2HXfJTCR_5alloc6string6StringNCNvNtB12_3fmt6format0NvYeNtNtB12_6borrow7ToOwned8to_ownedECs5MfxasYgTEl_11hickory_net.exit.i.i272, %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueNtNtNtB4_2io5error5ErrorECs5MfxasYgTEl_11hickory_net.exit.i.i.i.i276, %bb.eb
  ...
  %i.nj = ptrtoint <2 x ptr> %i.lq to <2 x i64>
  br label %bb.et
...
bb.et:                                            ; preds = %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCs4wP2HXfJTCR_5alloc6borrow3CoweEECs5MfxasYgTEl_11hickory_net.exit, %bb.gk, %bb.ex, %bb.es
  ...
  %.sroa.53.5 = phi ptr [ %.sroa.53.7, %bb.gk ], [ undef, %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCs4wP2HXfJTCR_5alloc6borrow3CoweEECs5MfxasYgTEl_11hickory_net.exit ], [ undef, %bb.ex ], [ %.sroa.7521.sroa.12.1996, %bb.es ]
  %i.nk = phi <2 x i64> [ %i.qp, %bb.gk ], [ %i.ob, %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCs4wP2HXfJTCR_5alloc6borrow3CoweEECs5MfxasYgTEl_11hickory_net.exit ], [ %i.nr, %bb.ex ], [ %i.nj, %bb.es ]
  %i.nl = getelementptr inbounds nuw i8, ptr %1, i64 440
  invoke void @_RNvXs0_NtCsl0TPHHzpGH6_5bytes9bytes_mutNtB5_8BytesMutNtNtNtCsj6eKBz9Db1c_4core3ops4drop4Drop4drop(ptr noalias nofree noundef nonnull align 8 dereferenceable(32) %i.nl)
...
.thread998:                                       ; preds = %bb.eq, %bb.ed
  %i.nm = getelementptr inbounds nuw i8, ptr %1, i64 432
  call void @llvm.lifetime.start.p0(ptr nonnull %i.aq)
  %i.nn = load i64, ptr %i.nm, align 8, !noundef !5 ; 2 uses
  store i64 %i.nn, ptr %i.aq, align 8
  %i.no = getelementptr i8, ptr %1, i64 448
  %.val178 = load i64, ptr %i.no, align 8, !noundef !5 ; 2 uses
  %.not61 = icmp eq i64 %.val178, %i.nn
  br i1 %.not61, label %bb.eu, label %bb.ev

bb.eu:                                            ; preds = %.thread998
  call void @llvm.lifetime.end.p0(ptr nonnull %i.aq)
  br label %bb.ey

bb.ev:                                            ; preds = %.thread998
  ...
  %i.np = getelementptr inbounds nuw i8, ptr %i.an, i64 16
  store ptr %i.ao, ptr %i.np, align 8
...
bb.ex:                                            ; preds = %bb.ev
  call void @llvm.lifetime.end.p0(ptr nonnull %i.an)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ao)
  %i.nr = load <2 x i64>, ptr %i.ap, align 16, !alias.scope !777
...
_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueNtNtCsl0TPHHzpGH6_5bytes5bytes5BytesECs5MfxasYgTEl_11hickory_net.exit: ; preds = %bb.eo, %bb.er, %bb.dx, %bb.ee, %.body267, %.body318, %bb.gl, %bb.ew
  %.pn111.pn.pn.pn = phi { ptr, i32 } [ %.pn73, %.body318 ], [ %i.nq, %bb.ew ], [ %.pn98.pn, %bb.gl ], [ %.pn49, %.body267 ], [ %.pn58.ph, %bb.er ], [ %i.mx, %bb.eo ], [ %i.mh, %bb.ee ], [ %i.lp, %bb.dx ]
  %i.ns = getelementptr inbounds nuw i8, ptr %1, i64 440
  invoke void @_RNvXs0_NtCsl0TPHHzpGH6_5bytes9bytes_mutNtB5_8BytesMutNtNtNtCsj6eKBz9Db1c_4core3ops4drop4Drop4drop(ptr noalias nofree noundef nonnull align 8 dereferenceable(32) %i.ns)
...
bb.ey:                                            ; preds = %bb.eu, %bb.ed
  %i.nt = getelementptr inbounds nuw i8, ptr %1, i64 472 ; 3 uses
  %i.nu = getelementptr i8, ptr %1, i64 576       ; 2 uses
  %.val181 = load i16, ptr %i.nu, align 8, !range !781, !noundef !5
  %i.nv = add i16 %.val181, -200
  %spec.select.i.i = icmp ult i16 %i.nv, 100
  br i1 %spec.select.i.i, label %bb.fi, label %bb.ez

bb.ez:                                            ; preds = %bb.ey
  call void @llvm.lifetime.start.p0(ptr nonnull %i.am)
  %i.nw = getelementptr inbounds nuw i8, ptr %1, i64 440
  %.val183 = load ptr, ptr %i.nw, align 8, !nonnull !5, !noundef !5
  %i.nx = getelementptr i8, ptr %1, i64 448
  %.val184 = load i64, ptr %i.nx, align 8, !noundef !5
...
bb.fb:                                            ; preds = %bb.ez
  ...
  %.val180 = load i16, ptr %i.nu, align 8, !range !781, !noundef !5
  ...
  %i.nz = getelementptr inbounds nuw i8, ptr %i.aj, i64 16
  store ptr %i.am, ptr %i.nz, align 8
...
bb.fd:                                            ; preds = %bb.fb
  call void @llvm.lifetime.end.p0(ptr nonnull %i.aj)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ak)
  %i.ob = load <2 x i64>, ptr %i.al, align 16, !alias.scope !782
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.al)
  %i.oc = load i64, ptr %i.am, align 8, !range !4, !alias.scope !786, !noundef !5
  %i.od = icmp eq i64 %i.oc, -1
  br i1 %i.od, label %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCs4wP2HXfJTCR_5alloc6borrow3CoweEECs5MfxasYgTEl_11hickory_net.exit, label %bb.fe
...
.body318:                                         ; preds = %bb.fh, %bb.ff, %bb.fa, %bb.fc
  %.pn73 = phi { ptr, i32 } [ %i.oe, %bb.ff ], [ %i.oa, %bb.fc ], [ %i.ny, %bb.fa ], [ %i.og, %bb.fh ]
...
bb.fi:                                            ; preds = %bb.ey
  ...
  %i.oh = invoke noundef align 8 ptr @_RINvMs0_NtNtCsjSDXC2TkEdJ_4http6header3mapNtB6_9HeaderMap3getNtNtB8_4name10HeaderNameECs5MfxasYgTEl_11hickory_net(ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(96) %i.nt, ptr noalias nofree noundef nonnull align 8 captures(address) dereferenceable(32) %i.ac)
...
bb.fk:                                            ; preds = %bb.fi
  ...
  %i.oj = getelementptr inbounds nuw i8, ptr %i.c, i64 1
  %i.ok = getelementptr inbounds nuw i8, ptr %i.c, i64 24
  %.not.i321 = icmp eq ptr %i.oh, null
  br i1 %.not.i321, label %.thread954, label %bb.fl

bb.fl:                                            ; preds = %bb.fk
  %i.ol = getelementptr i8, ptr %i.oh, i64 8
  %.val.i322 = load ptr, ptr %i.ol, align 8, !noalias !789, !nonnull !5, !noundef !5 ; 4 uses
  %i.om = getelementptr i8, ptr %i.oh, i64 16
  %.val2.i323 = load i64, ptr %i.om, align 8, !noalias !789, !noundef !5 ; 3 uses
  %i.on = getelementptr inbounds nuw i8, ptr %.val.i322, i64 %.val2.i323
  %i.oo = icmp samesign eq i64 %.val2.i323, 0
  br i1 %i.oo, label %_RNvMNtCsj6eKBz9Db1c_4core6optionINtB2_6OptionINtNtB4_6result6ResultReNtNtCs5MfxasYgTEl_11hickory_net5error8NetErrorEE9unwrap_orB19_.exit, label %.lr.ph.i.i.i324

bb.fm:                                            ; preds = %.lr.ph.i.i.i324
  %i.op = getelementptr inbounds nuw i8, ptr %.sroa.02.01.i.i.i325, i64 1 ; 2 uses
  %i.oq = icmp eq ptr %i.op, %i.on
...
.lr.ph.i.i.i324:                                  ; preds = %bb.fl, %bb.fm
  %.sroa.02.01.i.i.i325 = phi ptr [ %i.op, %bb.fm ], [ %.val.i322, %bb.fl ] ; 2 uses
  %i.or = load i8, ptr %.sroa.02.01.i.i.i325, align 1, !noalias !792, !noundef !5 ; 2 uses
  %i.os = add i8 %i.or, -32
  %or.cond.i.i.i326 = icmp ult i8 %i.os, 95
  %i.ot = icmp eq i8 %i.or, 9
  %or.cond1.i.i.i327 = or i1 %i.ot, %or.cond.i.i.i326
...
_RNvMNtNtCsjSDXC2TkEdJ_4http6header5valueNtB2_11HeaderValue6to_str.exit.thread.i.i: ; preds = %.lr.ph.i.i.i324
  ...
  %i.ou = getelementptr inbounds nuw i8, ptr %i.c, i64 8 ; 2 uses
  invoke void @_RNvNvNtCs4wP2HXfJTCR_5alloc3fmt6format12format_inner(ptr noalias nofree noundef nonnull sret([24 x i8]) align 8 captures(none) dereferenceable(24) %i.ou, ptr noundef nonnull @0, ptr noundef nonnull %i.b)
...
.noexc330:                                        ; preds = %_RNvMNtNtCsjSDXC2TkEdJ_4http6header5valueNtB2_11HeaderValue6to_str.exit.thread.i.i
  ...
  %.sroa.55.0.copyload7.i = load ptr, ptr %i.ou, align 8, !noalias !789
...
bb.fn:                                            ; preds = %bb.fo, %bb.fj
  %.pn75 = phi { ptr, i32 } [ %i.ov, %bb.fo ], [ %i.oi, %bb.fj ]
...
.thread954:                                       ; preds = %bb.fk
  ...
  %i.ow = getelementptr inbounds nuw i8, ptr %i.ai, i64 8
  store i64 23, ptr %i.ow, align 8
...
_RNvMNtCsj6eKBz9Db1c_4core6optionINtB2_6OptionINtNtB4_6result6ResultReNtNtCs5MfxasYgTEl_11hickory_net5error8NetErrorEE9unwrap_orB19_.exit: ; preds = %bb.fm, %bb.fl, %.noexc330
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(7) %.sroa.8576, ptr noundef nonnull align 1 dereferenceable(7) %i.oj, i64 7, i1 false)
  %.sroa.14591.sroa.0.0.copyload = load i64, ptr %i.ok, align 8
...
bb.fp:                                            ; preds = %_RNvMNtCsj6eKBz9Db1c_4core6optionINtB2_6OptionINtNtB4_6result6ResultReNtNtCs5MfxasYgTEl_11hickory_net5error8NetErrorEE9unwrap_orB19_.exit
  ...
  %i.ox = getelementptr inbounds nuw i8, ptr %i.ai, i64 8
  store i64 %.sroa.6.0.i, ptr %i.ox, align 8
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.55.0.i) ]
  %i.oy = icmp eq i64 %.sroa.6.0.i, 23
  br i1 %i.oy, label %_RNvXs7_NtNtCsj6eKBz9Db1c_4core3cmp5implsReNtB7_9PartialEq2neCs5MfxasYgTEl_11hickory_net.exit, label %_RNvXs7_NtNtCsj6eKBz9Db1c_4core3cmp5implsReNtB7_9PartialEq2neCs5MfxasYgTEl_11hickory_net.exit.thread

_RNvXs7_NtNtCsj6eKBz9Db1c_4core3cmp5implsReNtB7_9PartialEq2neCs5MfxasYgTEl_11hickory_net.exit: ; preds = %bb.fp, %.thread954
  %.sroa.9578.0942957 = phi ptr [ @18, %.thread954 ], [ %.sroa.55.0.i, %bb.fp ] ; 2 uses
  %i.oz = load i128, ptr %.sroa.9578.0942957, align 1
  %i.pa = xor i128 %i.oz, 60414612951604675997867365337498939489
  %i.pb = getelementptr i8, ptr %.sroa.9578.0942957, i64 7
  %i.pc = load i128, ptr %i.pb, align 1
  %i.pd = xor i128 %i.pc, 134788810691389226975056672626085685620
  %i.pe = or i128 %i.pa, %i.pd
  %i.pf = icmp ne i128 %i.pe, 0
  %i.pg = zext i1 %i.pf to i32
  %.not959 = icmp eq i32 %i.pg, 0
...
bb.fq:                                            ; preds = %_RNvXs7_NtNtCsj6eKBz9Db1c_4core3cmp5implsReNtB7_9PartialEq2neCs5MfxasYgTEl_11hickory_net.exit
  ...
  %i.ph = getelementptr inbounds nuw i8, ptr %1, i64 440 ; 3 uses
  %.val187 = load ptr, ptr %i.ph, align 8, !nonnull !5, !noundef !5
  %i.pi = getelementptr i8, ptr %1, i64 448
  %.val188 = load i64, ptr %i.pi, align 8, !noundef !5
...
bb.fr:                                            ; preds = %bb.fs, %bb.fq
  ...
  invoke void @_RNvXs0_NtCsl0TPHHzpGH6_5bytes9bytes_mutNtB5_8BytesMutNtNtNtCsj6eKBz9Db1c_4core3ops4drop4Drop4drop(ptr noalias nofree noundef nonnull align 8 dereferenceable(32) %i.ph)
...
bb.ft:                                            ; preds = %bb.fs
  ...
  %i.pk = load i64, ptr %i.af, align 8, !range !4, !alias.scope !802, !noalias !799, !noundef !5 ; 2 uses
  %i.pl = icmp eq i64 %i.pk, -1
  %i.pm = getelementptr inbounds nuw i8, ptr %i.af, i64 8 ; 2 uses
  br i1 %i.pl, label %bb.fu, label %bb.fv

bb.fu:                                            ; preds = %bb.ft
  %i.pn = load <2 x i64>, ptr %i.pm, align 8, !noalias !799
...
bb.fv:                                            ; preds = %bb.ft
  %.sroa.15.0.copyload607 = load i8, ptr %i.pm, align 8, !alias.scope !804
  ...
  %i.po = load <2 x i64>, ptr %.sroa.41.0..sroa_idx609, align 8, !alias.scope !804
...
_RINvMNtCsj6eKBz9Db1c_4core6resultINtB3_6ResultNtNtNtCsjXdHNeFfodD_13hickory_proto2op12dns_response11DnsResponseNtNtBO_5error10ProtoErrorE7map_errNtNtCs5MfxasYgTEl_11hickory_net5error8NetErrorNvYB2j_INtNtB5_7convert4FromB1L_E4fromEB2n_.exit: ; preds = %bb.fv, %bb.fu
  ...
  %i.pp = phi <2 x i64> [ %i.pn, %bb.fu ], [ %i.po, %bb.fv ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.af)
  invoke void @_RNvXs0_NtCsl0TPHHzpGH6_5bytes9bytes_mutNtB5_8BytesMutNtNtNtCsj6eKBz9Db1c_4core3ops4drop4Drop4drop(ptr noalias nofree noundef nonnull align 8 dereferenceable(32) %i.ph)
...
_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueNtNtCsl0TPHHzpGH6_5bytes9bytes_mut8BytesMutECs5MfxasYgTEl_11hickory_net.exit340: ; preds = %bb.fr, %bb.fw
  %.pn84 = phi { ptr, i32 } [ %i.pq, %bb.fw ], [ %i.pj, %bb.fr ]
  invoke fastcc void @_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCsjSDXC2TkEdJ_4http8response8ResponseNtNtCs4okMlIQ9Z13_2h25share10RecvStreamEECs5MfxasYgTEl_11hickory_net(ptr noalias nofree noundef align 8 dereferenceable(128) %i.nt) #18
...
_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueNtNtCsl0TPHHzpGH6_5bytes9bytes_mut8BytesMutECs5MfxasYgTEl_11hickory_net.exit342: ; preds = %_RINvMNtCsj6eKBz9Db1c_4core6resultINtB3_6ResultNtNtNtCsjXdHNeFfodD_13hickory_proto2op12dns_response11DnsResponseNtNtBO_5error10ProtoErrorE7map_errNtNtCs5MfxasYgTEl_11hickory_net5error8NetErrorNvYB2j_INtNtB5_7convert4FromB1L_E4fromEB2n_.exit
  invoke fastcc void @_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCsjSDXC2TkEdJ_4http8response8ResponseNtNtCs4okMlIQ9Z13_2h25share10RecvStreamEECs5MfxasYgTEl_11hickory_net(ptr noalias nofree noundef align 8 dereferenceable(128) %i.nt)
...
bb.fx:                                            ; preds = %bb.fy, %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueNtNtCsl0TPHHzpGH6_5bytes9bytes_mut8BytesMutECs5MfxasYgTEl_11hickory_net.exit340
  %.pn86 = phi { ptr, i32 } [ %i.ps, %bb.fy ], [ %.pn84, %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueNtNtCsl0TPHHzpGH6_5bytes9bytes_mut8BytesMutECs5MfxasYgTEl_11hickory_net.exit340 ]
  %i.pr = getelementptr inbounds nuw i8, ptr %1, i64 360
  invoke fastcc void @_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCs4okMlIQ9Z13_2h25share10SendStreamNtNtCsl0TPHHzpGH6_5bytes5bytes5BytesEECs5MfxasYgTEl_11hickory_net(ptr noalias nofree noundef align 8 dereferenceable(24) %i.pr) #18
...
bb.fz:                                            ; preds = %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueNtNtCsl0TPHHzpGH6_5bytes9bytes_mut8BytesMutECs5MfxasYgTEl_11hickory_net.exit342
  ...
  invoke fastcc void @_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCs4okMlIQ9Z13_2h25share10SendStreamNtNtCsl0TPHHzpGH6_5bytes5bytes5BytesEECs5MfxasYgTEl_11hickory_net(ptr noalias nofree noundef align 8 dereferenceable(24) %i.pt)
          to label %bb.gc unwind label %bb.gb

bb.ga:                                            ; preds = %bb.gb, %bb.fx
  %.pn88 = phi { ptr, i32 } [ %i.px, %bb.gb ], [ %.pn86, %bb.fx ]
  %i.pu = getelementptr inbounds nuw i8, ptr %1, i64 392
  store i8 0, ptr %i.pu, align 8
  call void @llvm.lifetime.end.p0(ptr nonnull %i.bh)
  %i.pv = getelementptr inbounds nuw i8, ptr %1, i64 394
  store i8 0, ptr %i.pv, align 2
  %i.pw = getelementptr inbounds nuw i8, ptr %1, i64 32
  invoke fastcc void @_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCs4okMlIQ9Z13_2h26client11SendRequestNtNtCsl0TPHHzpGH6_5bytes5bytes5BytesEECs5MfxasYgTEl_11hickory_net(ptr noalias nofree noundef align 8 dereferenceable(32) %i.pw) #18
          to label %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCs4okMlIQ9Z13_2h26client16ReadySendRequestNtNtCsl0TPHHzpGH6_5bytes5bytes5BytesEECs5MfxasYgTEl_11hickory_net.exit229 unwind label %bb.bq
...
bb.gc:                                            ; preds = %bb.fz
  %i.py = getelementptr inbounds nuw i8, ptr %1, i64 392
  store i8 0, ptr %i.py, align 8
  call void @llvm.lifetime.end.p0(ptr nonnull %i.bh)
  %i.pz = getelementptr inbounds nuw i8, ptr %1, i64 394
  store i8 0, ptr %i.pz, align 2
  %i.qa = getelementptr inbounds nuw i8, ptr %1, i64 32
  invoke fastcc void @_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCs4okMlIQ9Z13_2h26client11SendRequestNtNtCsl0TPHHzpGH6_5bytes5bytes5BytesEECs5MfxasYgTEl_11hickory_net(ptr noalias nofree noundef align 8 dereferenceable(32) %i.qa)
...
bb.ge:                                            ; preds = %bb.gc
  %i.qc = getelementptr inbounds nuw i8, ptr %1, i64 352 ; 2 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !805)
  call void @llvm.experimental.noalias.scope.decl(metadata !808)
  %i.qd = load ptr, ptr %i.qc, align 8, !alias.scope !811, !nonnull !5, !noundef !5
  %i.qe = atomicrmw sub ptr %i.qd, i64 1 release, align 8, !noalias !811
  %i.qf = icmp eq i64 %i.qe, 1
  br i1 %i.qf, label %bb.gf, label %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCs4wP2HXfJTCR_5alloc4sync3ArcNtNtCs5MfxasYgTEl_11hickory_net4http14RequestContextEEB1d_.exit344

bb.gf:                                            ; preds = %bb.ge
  fence acquire
  invoke void @_RNvMsn_NtCs4wP2HXfJTCR_5alloc4syncINtB5_3ArcNtNtCs5MfxasYgTEl_11hickory_net4http14RequestContextE9drop_slowBK_(ptr noalias nofree noundef nonnull align 8 dereferenceable(8) %i.qc) #21
...
_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCs4wP2HXfJTCR_5alloc4sync3ArcNtNtCs5MfxasYgTEl_11hickory_net4http14RequestContextEEB1d_.exit231: ; preds = %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCs4okMlIQ9Z13_2h26client16ReadySendRequestNtNtCsl0TPHHzpGH6_5bytes5bytes5BytesEECs5MfxasYgTEl_11hickory_net.exit229, %bb.bs, %bb.gg
  %.pn147 = phi { ptr, i32 } [ %i.qj, %bb.gg ], [ %.pn143.pn.pn, %bb.bs ], [ %.pn143.pn.pn, %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCs4okMlIQ9Z13_2h26client16ReadySendRequestNtNtCsl0TPHHzpGH6_5bytes5bytes5BytesEECs5MfxasYgTEl_11hickory_net.exit229 ] ; 2 uses
  %i.qg = getelementptr inbounds nuw i8, ptr %1, i64 393
  %i.qh = load i8, ptr %i.qg, align 1, !range !271, !noundef !5
  %i.qi = trunc nuw i8 %i.qh to i1
  br i1 %i.qi, label %bb.he, label %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueNtNtCsl0TPHHzpGH6_5bytes5bytes5BytesECs5MfxasYgTEl_11hickory_net.exit354
...
_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCs4wP2HXfJTCR_5alloc4sync3ArcNtNtCs5MfxasYgTEl_11hickory_net4http14RequestContextEEB1d_.exit344: ; preds = %bb.ge, %bb.gf
  %i.qk = getelementptr inbounds nuw i8, ptr %1, i64 393
...
bb.gh:                                            ; preds = %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueNtNtCsl0TPHHzpGH6_5bytes5bytes5BytesECs5MfxasYgTEl_11hickory_net.exit352, %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCs4wP2HXfJTCR_5alloc4sync3ArcNtNtCs5MfxasYgTEl_11hickory_net4http14RequestContextEEB1d_.exit344
  %.sroa.0604.6.a = phi i64 [ -1, %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueNtNtCsl0TPHHzpGH6_5bytes5bytes5BytesECs5MfxasYgTEl_11hickory_net.exit352 ], [ %i.pk, %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCs4wP2HXfJTCR_5alloc4sync3ArcNtNtCs5MfxasYgTEl_11hickory_net4http14RequestContextEEB1d_.exit344 ]
  ...
  %.sroa.49.6 = phi i64 [ %.sroa.49.2, %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueNtNtCsl0TPHHzpGH6_5bytes5bytes5BytesECs5MfxasYgTEl_11hickory_net.exit352 ], [ %.sroa.49.8, %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCs4wP2HXfJTCR_5alloc4sync3ArcNtNtCs5MfxasYgTEl_11hickory_net4http14RequestContextEEB1d_.exit344 ]
  ...
  %i.ql = phi <2 x i64> [ %i.gz, %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueNtNtCsl0TPHHzpGH6_5bytes5bytes5BytesECs5MfxasYgTEl_11hickory_net.exit352 ], [ %i.pp, %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCs4wP2HXfJTCR_5alloc4sync3ArcNtNtCs5MfxasYgTEl_11hickory_net4http14RequestContextEEB1d_.exit344 ]
  store i64 %.sroa.0604.6.a, ptr %0, align 8
  ...
  store <2 x i64> %i.ql, ptr %.sroa.41.0..sroa_idx, align 8
  %.sroa.49.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 32
  store i64 %.sroa.49.6, ptr %.sroa.49.0..sroa_idx, align 8
...
_RNvXs7_NtNtCsj6eKBz9Db1c_4core3cmp5implsReNtB7_9PartialEq2neCs5MfxasYgTEl_11hickory_net.exit.thread: ; preds = %bb.fp, %_RNvXs7_NtNtCsj6eKBz9Db1c_4core3cmp5implsReNtB7_9PartialEq2neCs5MfxasYgTEl_11hickory_net.exit
  ...
  %i.qm = getelementptr inbounds nuw i8, ptr %i.ag, i64 16
  store ptr %i.ai, ptr %i.qm, align 8
...
bb.gj:                                            ; preds = %_RNvXs7_NtNtCsj6eKBz9Db1c_4core3cmp5implsReNtB7_9PartialEq2neCs5MfxasYgTEl_11hickory_net.exit.thread
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ag)
  %i.qo = load <2 x i64>, ptr %i.ah, align 16, !alias.scope !812
...
bb.gk:                                            ; preds = %bb.gm, %bb.gj
  ...
  %i.qp = phi <2 x i64> [ %i.qo, %bb.gj ], [ %i.qs, %bb.gm ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ai)
  br label %bb.et

bb.gl:                                            ; preds = %bb.gi, %bb.fn
  %.pn98.pn = phi { ptr, i32 } [ %.pn75, %bb.fn ], [ %i.qn, %bb.gi ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ai)
  br label %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueNtNtCsl0TPHHzpGH6_5bytes5bytes5BytesECs5MfxasYgTEl_11hickory_net.exit
...
bb.gm:                                            ; preds = %_RNvMNtCsj6eKBz9Db1c_4core6optionINtB2_6OptionINtNtB4_6result6ResultReNtNtCs5MfxasYgTEl_11hickory_net5error8NetErrorEE9unwrap_orB19_.exit
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.8576)
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.13584.sroa.8)
  %i.qq = ptrtoint ptr %.sroa.55.0.i to i64
  %i.qr = insertelement <2 x i64> poison, i64 %i.qq, i64 0
  %i.qs = insertelement <2 x i64> %i.qr, i64 %.sroa.6.0.i, i64 1
  br label %bb.gk
...
bb.gp:                                            ; preds = %bb.gq, %.body233
  %.pn127 = phi { ptr, i32 } [ %i.qy, %bb.gq ], [ %.pn124.pn, %.body233 ] ; 2 uses
  %i.qv = getelementptr inbounds nuw i8, ptr %1, i64 392
  %i.qw = load i8, ptr %i.qv, align 8, !range !271, !noundef !5
  %i.qx = trunc nuw i8 %i.qw to i1
  br i1 %i.qx, label %bb.hc, label %.body348
...
bb.gr:                                            ; preds = %bb.az
  %i.qz = getelementptr inbounds nuw i8, ptr %1, i64 392 ; 2 uses
  %i.ra = load i8, ptr %i.qz, align 8, !range !271, !noundef !5
  %i.rb = trunc nuw i8 %i.ra to i1
  br i1 %i.rb, label %bb.gs, label %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueNtNtCs4okMlIQ9Z13_2h26client14ResponseFutureECs5MfxasYgTEl_11hickory_net.exit350
...
bb.gt:                                            ; preds = %bb.gs
  ...
  %i.rd = load ptr, ptr %i.bh, align 16, !alias.scope !822, !nonnull !5, !noundef !5
  %i.re = atomicrmw sub ptr %i.rd, i64 1 release, align 8, !noalias !827
  %i.rf = icmp eq i64 %i.re, 1
  br i1 %i.rf, label %bb.gu, label %.body348
...
bb.gv:                                            ; preds = %bb.gs
  ...
  %i.rg = load ptr, ptr %i.bh, align 16, !alias.scope !834, !nonnull !5, !noundef !5
  %i.rh = atomicrmw sub ptr %i.rg, i64 1 release, align 8, !noalias !835
  %i.ri = icmp eq i64 %i.rh, 1
  br i1 %i.ri, label %bb.gw, label %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueNtNtCs4okMlIQ9Z13_2h26client14ResponseFutureECs5MfxasYgTEl_11hickory_net.exit350
...
.body348:                                         ; preds = %bb.gy, %bb.gu, %bb.gt, %bb.hc, %bb.gp
  %.pn129 = phi { ptr, i32 } [ %.pn127, %bb.gp ], [ %.pn127, %bb.hc ], [ %i.rl, %bb.gy ], [ %i.rc, %bb.gu ], [ %i.rc, %bb.gt ]
  %i.rk = getelementptr inbounds nuw i8, ptr %1, i64 392
...
_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCs4wP2HXfJTCR_5alloc4sync3ArcNtNtCs5MfxasYgTEl_11hickory_net4http14RequestContextEEB1d_.exit: ; preds = %bb.bo, %bb.bp
  %i.rn = getelementptr inbounds nuw i8, ptr %1, i64 393 ; 2 uses
  %i.ro = load i8, ptr %i.rn, align 1, !range !271, !noundef !5
  %i.rp = trunc nuw i8 %i.ro to i1
  br i1 %i.rp, label %bb.ha, label %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueNtNtCsl0TPHHzpGH6_5bytes5bytes5BytesECs5MfxasYgTEl_11hickory_net.exit352
...
bb.ha:                                            ; preds = %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCs4wP2HXfJTCR_5alloc4sync3ArcNtNtCs5MfxasYgTEl_11hickory_net4http14RequestContextEEB1d_.exit
  ...
  %i.rr = load ptr, ptr %i.rq, align 8, !alias.scope !842, !noundef !5
  %i.rs = load ptr, ptr %1, align 8, !alias.scope !842, !nonnull !5, !align !141, !noundef !5
  %i.rt = getelementptr inbounds nuw i8, ptr %i.rs, i64 32
  %i.ru = load ptr, ptr %i.rt, align 8, !noalias !842, !nonnull !5, !noundef !5
  %i.rv = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.rw = load ptr, ptr %i.rv, align 8, !alias.scope !842, !noundef !5
  %i.rx = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.ry = load i64, ptr %i.rx, align 8, !alias.scope !842, !noundef !5
  invoke void %i.ru(ptr noundef %i.rr, ptr noundef %i.rw, i64 noundef %i.ry)
...
_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueNtNtCsl0TPHHzpGH6_5bytes5bytes5BytesECs5MfxasYgTEl_11hickory_net.exit354: ; preds = %bb.he, %bb.hb, %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCs4wP2HXfJTCR_5alloc4sync3ArcNtNtCs5MfxasYgTEl_11hickory_net4http14RequestContextEEB1d_.exit231
  %.pn149 = phi { ptr, i32 } [ %i.sa, %bb.hb ], [ %.pn147, %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCs4wP2HXfJTCR_5alloc4sync3ArcNtNtCs5MfxasYgTEl_11hickory_net4http14RequestContextEEB1d_.exit231 ], [ %.pn147, %bb.he ]
  %i.rz = getelementptr inbounds nuw i8, ptr %1, i64 393
  store i8 0, ptr %i.rz, align 1
...
.body267:                                         ; preds = %bb.ds, %bb.dr
  %.pn49 = phi { ptr, i32 } [ %i.ll, %bb.dr ], [ %i.lm, %bb.ds ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ax)
  br label %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueNtNtCsl0TPHHzpGH6_5bytes5bytes5BytesECs5MfxasYgTEl_11hickory_net.exit
...
bb.hd:                                            ; preds = %bb.bc
  %i.sb = getelementptr inbounds nuw i8, ptr %1, i64 64
  invoke fastcc void @_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCsjSDXC2TkEdJ_4http7request7RequestuEECs5MfxasYgTEl_11hickory_net(ptr noalias nofree noundef align 8 dereferenceable(224) %i.sb) #18
...
bb.he:                                            ; preds = %_RINvNtCsj6eKBz9Db1c_4core3ptr9drop_glueINtNtCs4wP2HXfJTCR_5alloc4sync3ArcNtNtCs5MfxasYgTEl_11hickory_net4http14RequestContextEEB1d_.exit231
  ...
  %i.sc = getelementptr inbounds nuw i8, ptr %1, i64 24
  %i.sd = load ptr, ptr %i.sc, align 8, !alias.scope !849, !noundef !5
  %i.se = load ptr, ptr %1, align 8, !alias.scope !849, !nonnull !5, !align !141, !noundef !5
  %i.sf = getelementptr inbounds nuw i8, ptr %i.se, i64 32
  %i.sg = load ptr, ptr %i.sf, align 8, !noalias !849, !nonnull !5, !noundef !5
  %i.sh = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.si = load ptr, ptr %i.sh, align 8, !alias.scope !849, !noundef !5
  %i.sj = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.sk = load i64, ptr %i.sj, align 8, !alias.scope !849, !noundef !5
  invoke void %i.sg(ptr noundef %i.sd, ptr noundef %i.si, i64 noundef %i.sk)
