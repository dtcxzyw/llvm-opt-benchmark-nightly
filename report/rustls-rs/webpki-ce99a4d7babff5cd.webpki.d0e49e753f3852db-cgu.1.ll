...
bb.e:                                             ; preds = %bb.b
  ...
  %narrow = select i1 %.inv52, i8 2, i8 %i.c      ; 2 uses
...
bb.p:                                             ; preds = %bb.g
  ...
  %6 = icmp ne i8 %i.t, 42
  %i.u = icmp eq i8 %3, 0
  %or.cond100 = or i1 %i.u, %6
  br i1 %or.cond100, label %.loopexit, label %_RNvMs_NtCs2XfPe3Xe4Zx_9untrusted6readerNtB4_6Reader10read_bytes.exit65.preheader

.loopexit:                                        ; preds = %bb.q, %bb.g, %bb.p
  %.sroa.19.2 = phi i64 [ %.sroa.19.0, %bb.g ], [ %.sroa.19.0, %bb.p ], [ %i.x, %bb.q ] ; 4 uses
  %.sroa.030.0 = phi i64 [ 0, %bb.g ], [ 0, %bb.p ], [ %i.z, %bb.q ] ; 2 uses
...
bb.y:                                             ; preds = %bb.x
  %i.at = icmp eq i8 %narrow, 2
  br i1 %i.at, label %.critedge, label %bb.z

bb.z:                                             ; preds = %bb.y
  %i.au = getelementptr inbounds nuw i8, ptr %4, i64 %i.w
...
bb.ab:                                            ; preds = %bb.z
  %i.ay = sub i64 %i.v, %.sroa.19.2
  %i.az = add i64 %i.ay, 1
  %i.ba = icmp eq i64 %i.az, %5
  br i1 %i.ba, label %bb.ac, label %.critedge
