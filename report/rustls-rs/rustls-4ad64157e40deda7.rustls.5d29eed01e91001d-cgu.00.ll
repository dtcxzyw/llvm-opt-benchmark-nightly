...
bb.h:                                             ; preds = %bb.i, %bb.g
  ...
  %.sroa.25.sroa.0.0.insert.ext = zext nneg i8 %i.ae to i64
  %.sroa.25.sroa.0.1.insert.ext435 = zext i8 %i.ag to i64
  %.sroa.25.sroa.0.1.insert.shift436 = shl nuw nsw i64 %.sroa.25.sroa.0.1.insert.ext435, 8
  %.sroa.25.sroa.0.1.insert.insert438 = or disjoint i64 %.sroa.25.sroa.0.1.insert.shift436, %.sroa.25.sroa.0.0.insert.ext
...
bb.j:                                             ; preds = %bb.g
  ...
  %.sroa.0619.0.copyload.a = load i64, ptr %i.aw, align 8 ; 2 uses
...
bb.q:                                             ; preds = %bb.g
  ...
  %i.bh = load i64, ptr %i.q, align 8, !range !8, !noundef !5 ; 2 uses
...
bb.t:                                             ; preds = %bb.g
  ...
  %i.bo = load i64, ptr %i.l, align 8, !range !7, !noundef !5 ; 2 uses
...
bb.u:                                             ; preds = %bb.g
  ...
  %.sroa.25.8.copyload381 = load i64, ptr %i.p, align 8
...
bb.v:                                             ; preds = %bb.g
  ...
  %.sroa.25.8.copyload382 = load i64, ptr %i.f, align 8
...
bb.w:                                             ; preds = %bb.g
  ...
  %.sroa.0718.0.copyload = load i64, ptr %i.bt, align 8 ; 2 uses
...
bb.y:                                             ; preds = %bb.g
  ...
  %i.bz = load i64, ptr %i.m, align 8, !range !8, !noundef !5 ; 2 uses
...
bb.aa:                                            ; preds = %bb.s, %bb.m, %bb.i, %bb.bv, %bb.bt, %bb.br, %bb.bp, %bb.bn, %bb.bl, %bb.bh, %bb.bf, %bb.bd, %_RNvMNtCs4wP2HXfJTCR_5alloc5boxedINtB2_3BoxNtNtNtCs7ZUl82OSlxp_6rustls4msgs9handshake16ServerExtensionsE3newBK_.exit, %bb.av, %bb.at, %bb.am, %bb.ac, %bb.v, %bb.u, %bb.h
  %.sroa.25.sroa.25.sroa.0.0 = phi i64 [ %.sroa.25.sroa.0.1.insert.insert438, %bb.h ], [ %i.bz, %bb.bv ], [ %.sroa.0619.0.copyload.a, %bb.ac ], [ %.sroa.25.sroa.25.sroa.0.1.in.in, %bb.am ], [ %i.dp, %bb.av ], [ %i.dy, %bb.at ], [ undef, %bb.i ], [ %i.ef, %_RNvMNtCs4wP2HXfJTCR_5alloc5boxedINtB2_3BoxNtNtNtCs7ZUl82OSlxp_6rustls4msgs9handshake16ServerExtensionsE3newBK_.exit ], [ %i.ej, %bb.bf ], [ %.sroa.5.sroa.0.0.copyload662, %bb.bd ], [ %i.bh, %bb.bh ], [ %i.et, %bb.bn ], [ %i.eq, %bb.bl ], [ undef, %bb.m ], [ %i.bo, %bb.bp ], [ %.sroa.25.8.copyload381, %bb.u ], [ %.sroa.25.8.copyload382, %bb.v ], [ %.sroa.0718.0.copyload, %bb.br ], [ %.sroa.25.sroa.0.1.insert.insert, %bb.bt ], [ undef, %bb.s ]
  ...
  %.sroa.46.0 = phi i32 [ %.sroa.5182.sroa.3.6.copyload, %bb.h ], [ %.sroa.0696.0.copyload, %bb.bv ], [ %.sroa.4620.0.copyload, %bb.ac ], [ %.sroa.46.1, %bb.am ], [ %.sroa.0708.0.copyload, %bb.av ], [ %i.dx, %bb.at ], [ undef, %bb.i ], [ undef, %_RNvMNtCs4wP2HXfJTCR_5alloc5boxedINtB2_3BoxNtNtNtCs7ZUl82OSlxp_6rustls4msgs9handshake16ServerExtensionsE3newBK_.exit ], [ %.sroa.0654.0.copyload, %bb.bf ], [ %.sroa.5.sroa.7.0.copyload666, %bb.bd ], [ %.sroa.0678.0.copyload, %bb.bh ], [ %.sroa.0684.0.copyload, %bb.bn ], [ %.sroa.0690.0.copyload, %bb.bl ], [ undef, %bb.m ], [ %.sroa.0702.0.copyload, %bb.bp ], [ %.sroa.46.8.copyload389, %bb.u ], [ %.sroa.46.8.copyload391, %bb.v ], [ %.sroa.4719.0.copyload, %bb.br ], [ undef, %bb.bt ], [ undef, %bb.s ]
  %.sroa.0.0 = phi i64 [ -9223372036854775787, %bb.h ], [ -9223372036854775802, %bb.bv ], [ %i.au, %bb.ac ], [ %storemerge, %bb.am ], [ -9223372036854775793, %bb.av ], [ -9223372036854775794, %bb.at ], [ -9223372036854775808, %bb.i ], [ -9223372036854775792, %_RNvMNtCs4wP2HXfJTCR_5alloc5boxedINtB2_3BoxNtNtNtCs7ZUl82OSlxp_6rustls4msgs9handshake16ServerExtensionsE3newBK_.exit ], [ -9223372036854775803, %bb.bf ], [ -9223372036854775804, %bb.bd ], [ -9223372036854775801, %bb.bh ], [ -9223372036854775799, %bb.bn ], [ -9223372036854775800, %bb.bl ], [ -9223372036854775796, %bb.m ], [ -9223372036854775798, %bb.bp ], [ -9223372036854775795, %bb.u ], [ -9223372036854775790, %bb.v ], [ -9223372036854775789, %bb.br ], [ -9223372036854775791, %bb.bt ], [ -9223372036854775797, %bb.s ]
  %i.cd = phi <2 x i64> [ undef, %bb.h ], [ undef, %bb.bv ], [ %i.ci, %bb.ac ], [ %i.dl, %bb.am ], [ undef, %bb.av ], [ undef, %bb.at ], [ undef, %bb.i ], [ undef, %_RNvMNtCs4wP2HXfJTCR_5alloc5boxedINtB2_3BoxNtNtNtCs7ZUl82OSlxp_6rustls4msgs9handshake16ServerExtensionsE3newBK_.exit ], [ undef, %bb.bf ], [ undef, %bb.bd ], [ %i.ep, %bb.bh ], [ %i.ey, %bb.bn ], [ undef, %bb.bl ], [ undef, %bb.m ], [ undef, %bb.bp ], [ undef, %bb.u ], [ undef, %bb.v ], [ undef, %bb.br ], [ undef, %bb.bt ], [ undef, %bb.s ]
  ...
  store i64 %.sroa.25.sroa.25.sroa.0.0, ptr %.sroa.25.0..sroa_idx, align 8
...
bb.ab:                                            ; preds = %bb.j
  ...
  store i64 %.sroa.0619.0.copyload.a, ptr %i.ch, align 8
...
bb.ag:                                            ; preds = %bb.af
  ...
  %.sroa.0631.0.copyload.a = load i8, ptr %i.cr, align 8
  ...
  store i8 %.sroa.0631.0.copyload.a, ptr %i.cs, align 8
...
bb.am:                                            ; preds = %bb.ao, %bb.al
  %.sroa.25.sroa.25.sroa.0.1.in.in = phi i64 [ %i.dg, %bb.ao ], [ %.sroa.0625.0.copyload, %bb.al ]
  ...
  %storemerge = phi i64 [ -9223372036854775805, %bb.ao ], [ -9223372036854775806, %bb.al ]
  %i.dl = phi <2 x i64> [ %i.dn, %bb.ao ], [ %i.dk, %bb.al ]
...
bb.an:                                            ; preds = %bb.aj
  ...
  store i32 %.sroa.0639.0.copyload, ptr %i.dm, align 8
  store i64 -1, ptr %0, align 8
...
bb.ao:                                            ; preds = %bb.aj
  ...
  %i.dn = load <2 x i64>, ptr %.sroa.5228.sroa.5.0..sroa.5228.0..sroa_idx.sroa_idx, align 8
...
bb.aq:                                            ; preds = %bb.l
  ...
  %i.do = load i8, ptr %i.j, align 8, !range !302, !noundef !5 ; 2 uses
  %.not291 = icmp eq i8 %i.do, -1
...
bb.ar:                                            ; preds = %bb.l
  ...
  %i.dp = load i64, ptr %i.k, align 8, !range !7, !noundef !5 ; 2 uses
  %i.dq = icmp eq i64 %i.dp, -1
  %i.dr = getelementptr inbounds nuw i8, ptr %i.k, i64 8
  %.sroa.0708.0.copyload = load i32, ptr %i.dr, align 8 ; 2 uses
  ...
  br i1 %i.dq, label %bb.au, label %bb.av
...
bb.as:                                            ; preds = %bb.aq
  ...
  %i.dt = load <2 x i32>, ptr %.sroa.6262.0..sroa_idx, align 8
  call void @llvm.lifetime.end.p0(ptr nonnull %i.j)
  store i8 %i.do, ptr %i.ds, align 8
  store ptr %.sroa.5261.0.copyload, ptr %.sroa.5266.0..sroa_idx, align 8
  store <2 x i32> %i.dt, ptr %.sroa.6267.0..sroa_idx, align 8
  store i64 -1, ptr %0, align 8
  br label %bb.ad

bb.at:                                            ; preds = %bb.aq
  %i.du = getelementptr inbounds nuw i8, ptr %i.j, i64 8
  %i.dv = load ptr, ptr %i.du, align 8, !nonnull !5, !noundef !5
  %i.dw = getelementptr inbounds nuw i8, ptr %i.j, i64 16
  %i.dx = load i32, ptr %i.dw, align 8, !noundef !5
  call void @llvm.lifetime.end.p0(ptr nonnull %i.j)
...
bb.au:                                            ; preds = %bb.ar
  ...
  store i32 %.sroa.0708.0.copyload, ptr %i.dz, align 8
  store i64 -1, ptr %0, align 8
...
bb.aw:                                            ; preds = %bb.o
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.eb, ptr noundef nonnull align 8 dereferenceable(24) %.sroa.6152, i64 24, i1 false)
  store i64 -1, ptr %0, align 8
...
bb.ax:                                            ; preds = %bb.o
  ...
  %i.ec = invoke fastcc noundef ptr @_RNvNtCs4wP2HXfJTCR_5alloc5boxed14box_new_uninit(i64 noundef 200)
...
_RNvMNtCs4wP2HXfJTCR_5alloc5boxedINtB2_3BoxNtNtNtCs7ZUl82OSlxp_6rustls4msgs9handshake16ServerExtensionsE3newBK_.exit: ; preds = %bb.ax
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(200) %i.ec, ptr noundef nonnull align 8 dereferenceable(200) %i.h, i64 200, i1 false)
...
bb.ba:                                            ; preds = %bb.p
  ...
  %i.eg = load i64, ptr %i.a, align 8, !range !303, !noalias !305, !noundef !5
  %i.eh = trunc nuw i64 %i.eg to i1
  %i.ei = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  %.sroa.5.sroa.0.0.copyload662 = load i64, ptr %i.ei, align 8, !noalias !310 ; 2 uses
...
bb.bb:                                            ; preds = %bb.p
  ...
  %i.ej = load i64, ptr %i.r, align 8, !range !7, !noundef !5 ; 2 uses
  %i.ek = icmp eq i64 %i.ej, -1
  %i.el = getelementptr inbounds nuw i8, ptr %i.r, i64 8
  %.sroa.0654.0.copyload = load i32, ptr %i.el, align 8 ; 2 uses
...
bb.bc:                                            ; preds = %bb.ba
  ...
  store i64 %.sroa.5.sroa.0.0.copyload662, ptr %i.em, align 8
...
bb.be:                                            ; preds = %bb.bb
  ...
  store i32 %.sroa.0654.0.copyload, ptr %i.en, align 8
  store i64 -1, ptr %0, align 8
...
bb.bg:                                            ; preds = %bb.q
  ...
  store i32 %.sroa.0678.0.copyload, ptr %i.eo, align 8
  store i64 -1, ptr %0, align 8
...
bb.bh:                                            ; preds = %bb.q
  ...
  %i.ep = load <2 x i64>, ptr %.sroa.5240.sroa.5.0..sroa.5240.0..sroa_idx.sroa_idx, align 8
  call void @llvm.lifetime.end.p0(ptr nonnull %i.q)
...
bb.bi:                                            ; preds = %bb.r
  ...
  %i.eq = load i64, ptr %i.n, align 8, !range !7, !noundef !5 ; 2 uses
  %i.er = icmp eq i64 %i.eq, -1
  %i.es = getelementptr inbounds nuw i8, ptr %i.n, i64 8
  %.sroa.0690.0.copyload = load i32, ptr %i.es, align 8 ; 2 uses
  ...
  br i1 %i.er, label %bb.bk, label %bb.bl
...
bb.bj:                                            ; preds = %bb.r
  ...
  %i.et = load i64, ptr %i.o, align 8, !range !7, !noundef !5 ; 2 uses
  %i.eu = icmp eq i64 %i.et, -1
  %i.ev = getelementptr inbounds nuw i8, ptr %i.o, i64 8
  %.sroa.0684.0.copyload = load i32, ptr %i.ev, align 8 ; 2 uses
  ...
  br i1 %i.eu, label %bb.bm, label %bb.bn
...
bb.bk:                                            ; preds = %bb.bi
  ...
  store i32 %.sroa.0690.0.copyload, ptr %i.ew, align 8
  store i64 -1, ptr %0, align 8
...
bb.bm:                                            ; preds = %bb.bj
  ...
  store i32 %.sroa.0684.0.copyload, ptr %i.ex, align 8
  store i64 -1, ptr %0, align 8
...
bb.bn:                                            ; preds = %bb.bj
  ...
  %i.ey = insertelement <2 x i64> <i64 poison, i64 undef>, i64 %.sroa.5243.sroa.5.0.copyload, i64 0
  br label %bb.aa
...
bb.bo:                                            ; preds = %bb.t
  ...
  store i32 %.sroa.0702.0.copyload, ptr %i.fa, align 8
  store i64 -1, ptr %0, align 8
...
bb.bq:                                            ; preds = %bb.w
  ...
  store i64 %.sroa.0718.0.copyload, ptr %i.fb, align 8
...
bb.bs:                                            ; preds = %bb.x
  ...
  store i8 %i.bu, ptr %i.fc, align 8
...
bb.bt:                                            ; preds = %bb.x
  call void @llvm.lifetime.end.p0(ptr nonnull %i.g)
  %.sroa.25.sroa.0.0.insert.ext424 = zext nneg i8 %i.bw to i64
  %.sroa.25.sroa.0.1.insert.ext = zext i8 %i.by to i64
  %.sroa.25.sroa.0.1.insert.shift = shl nuw nsw i64 %.sroa.25.sroa.0.1.insert.ext, 8
  %.sroa.25.sroa.0.1.insert.insert = or disjoint i64 %.sroa.25.sroa.0.1.insert.shift, %.sroa.25.sroa.0.0.insert.ext424
  br label %bb.aa
...
bb.bu:                                            ; preds = %bb.y
  ...
  store i32 %.sroa.0696.0.copyload, ptr %i.fd, align 8
  store i64 -1, ptr %0, align 8
