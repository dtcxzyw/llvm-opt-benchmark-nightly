...
bb.h:                                             ; preds = %bb.i, %bb.g
  ...
  %.sroa.25.8.insert.ext = zext nneg i8 %i.ae to i64
  %.sroa.25.9.insert.ext391 = zext i8 %i.ag to i64
  %.sroa.25.9.insert.shift392 = shl nuw nsw i64 %.sroa.25.9.insert.ext391, 8
  %.sroa.25.9.insert.insert394 = or disjoint i64 %.sroa.25.9.insert.shift392, %.sroa.25.8.insert.ext
...
bb.j:                                             ; preds = %bb.g
  ...
  %.sroa.0619.0.copyload = load i64, ptr %i.aw, align 8 ; 2 uses
...
bb.aa:                                            ; preds = %bb.s, %bb.m, %bb.i, %bb.bv, %bb.bt, %bb.br, %bb.bp, %bb.bn, %bb.bl, %bb.bh, %bb.bf, %bb.bd, %_RNvMNtCs4wP2HXfJTCR_5alloc5boxedINtB2_3BoxNtNtNtCs7ZUl82OSlxp_6rustls4msgs9handshake16ServerExtensionsE3newBK_.exit, %bb.av, %bb.at, %bb.am, %bb.ac, %bb.v, %bb.u, %bb.h
  ...
  %.sroa.25.0 = phi i64 [ %.sroa.25.9.insert.insert394, %bb.h ], [ %i.bz, %bb.bv ], [ %.sroa.0619.0.copyload, %bb.ac ], [ %storemerge.a, %bb.am ], [ %i.do, %bb.av ], [ %i.dx, %bb.at ], [ undef, %bb.i ], [ %i.ee, %_RNvMNtCs4wP2HXfJTCR_5alloc5boxedINtB2_3BoxNtNtNtCs7ZUl82OSlxp_6rustls4msgs9handshake16ServerExtensionsE3newBK_.exit ], [ %i.ei, %bb.bf ], [ %.sroa.5.sroa.0.0.copyload662, %bb.bd ], [ %i.bh, %bb.bh ], [ %i.es, %bb.bn ], [ %i.ep, %bb.bl ], [ undef, %bb.m ], [ %i.bo, %bb.bp ], [ %.sroa.25.8.copyload381, %bb.u ], [ %.sroa.25.8.copyload382, %bb.v ], [ %.sroa.0718.0.copyload, %bb.br ], [ %.sroa.25.9.insert.insert, %bb.bt ], [ undef, %bb.s ]
...
bb.am:                                            ; preds = %bb.ao, %bb.al
  ...
  %storemerge.a = phi i64 [ %i.dg, %bb.ao ], [ %.sroa.0625.0.copyload, %bb.al ]
...
bb.ar:                                            ; preds = %bb.l
  ...
  %i.do = load i64, ptr %i.k, align 8, !range !7, !noundef !5 ; 2 uses
...
bb.ba:                                            ; preds = %bb.p
  ...
  %.sroa.5.sroa.0.0.copyload662 = load i64, ptr %i.eh, align 8, !noalias !310 ; 2 uses
...
bb.bb:                                            ; preds = %bb.p
  ...
  %i.ei = load i64, ptr %i.r, align 8, !range !7, !noundef !5 ; 2 uses
...
bb.bi:                                            ; preds = %bb.r
  ...
  %i.ep = load i64, ptr %i.n, align 8, !range !7, !noundef !5 ; 2 uses
...
bb.bj:                                            ; preds = %bb.r
  ...
  %i.es = load i64, ptr %i.o, align 8, !range !7, !noundef !5 ; 2 uses
...
bb.bt:                                            ; preds = %bb.x
  call void @llvm.lifetime.end.p0(ptr nonnull %i.g)
  %.sroa.25.8.insert.ext382 = zext nneg i8 %i.bw to i64
  %.sroa.25.9.insert.ext = zext i8 %i.by to i64
  %.sroa.25.9.insert.shift = shl nuw nsw i64 %.sroa.25.9.insert.ext, 8
  %.sroa.25.9.insert.insert = or disjoint i64 %.sroa.25.9.insert.shift, %.sroa.25.8.insert.ext382
  br label %bb.aa
