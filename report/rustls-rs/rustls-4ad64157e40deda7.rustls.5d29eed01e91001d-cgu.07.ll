...
bb.a:
  ...
  %.not.i = select i1 %.not, i1 true, i1 %.not.i42
...
bb.e:                                             ; preds = %.lr.ph, %_RNvMsG_NtCs4wP2HXfJTCR_5alloc3vecINtB5_3VecNtNtNtNtCs7ZUl82OSlxp_6rustls4msgs8deframer9handshake12FragmentSpanE8push_mutBN_.exit6
  ...
  %.sroa.816.047 = phi i64 [ undef, %.lr.ph ], [ %.sroa.015.0.ph, %_RNvMsG_NtCs4wP2HXfJTCR_5alloc3vecINtB5_3VecNtNtNtNtCs7ZUl82OSlxp_6rustls4msgs8deframer9handshake12FragmentSpanE8push_mutBN_.exit6 ]
  %.sroa.611.043 = phi i64 [ %i.ak, %.lr.ph ], [ %.sroa.9.0.ph, %_RNvMsG_NtCs4wP2HXfJTCR_5alloc3vecINtB5_3VecNtNtNtNtCs7ZUl82OSlxp_6rustls4msgs8deframer9handshake12FragmentSpanE8push_mutBN_.exit6 ] ; 4 uses
  %.sroa.010.045 = phi ptr [ %i.am, %.lr.ph ], [ %.sroa.010.2.ph, %_RNvMsG_NtCs4wP2HXfJTCR_5alloc3vecINtB5_3VecNtNtNtNtCs7ZUl82OSlxp_6rustls4msgs8deframer9handshake12FragmentSpanE8push_mutBN_.exit6 ] ; 4 uses
  %i.ar = icmp ult i64 %.sroa.611.043, 4
  br i1 %i.ar, label %bb.f, label %bb.g

bb.f:                                             ; preds = %bb.e
  %i.as = ptrtoint ptr %.sroa.010.045 to i64
  %i.at = sub i64 %i.as, %i.ap                    ; 2 uses
  %i.au = add i64 %i.at, %.sroa.611.043
  br label %bb.i

bb.g:                                             ; preds = %bb.e
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !107
  %i.av = getelementptr inbounds nuw i8, ptr %.sroa.010.045, i64 1
...
_RNvMNtCsj6eKBz9Db1c_4core6resultINtB2_6ResultNtNtNtCs7ZUl82OSlxp_6rustls4msgs5codec3u24NtNtBN_5error14InvalidMessageE6unwrapBN_.exit.i: ; preds = %bb.g
  %i.ax = add nsw i64 %.sroa.611.043, -4          ; 2 uses
  %i.ay = getelementptr inbounds nuw i8, ptr %.sroa.010.045, i64 4
  ...
  %.sroa.01.0.i = select i1 %i.bb, i64 %i.bd, i64 %.sroa.611.043
  %i.be = ptrtoint ptr %.sroa.010.045 to i64
  %i.bf = sub i64 %i.be, %i.ap                    ; 2 uses
  %i.bg = add i64 %i.bf, %.sroa.01.0.i
  %.pre45 = load i64, ptr %i.d, align 8, !alias.scope !117, !noalias !120
  br label %bb.i
...
bb.i:                                             ; preds = %_RNvMNtCsj6eKBz9Db1c_4core6resultINtB2_6ResultNtNtNtCs7ZUl82OSlxp_6rustls4msgs5codec3u24NtNtBN_5error14InvalidMessageE6unwrapBN_.exit.i, %bb.f
  %i.bh = phi i64 [ %i.aq, %bb.f ], [ %.pre45, %_RNvMNtCsj6eKBz9Db1c_4core6resultINtB2_6ResultNtNtNtCs7ZUl82OSlxp_6rustls4msgs5codec3u24NtNtBN_5error14InvalidMessageE6unwrapBN_.exit.i ] ; 3 uses
  ...
  %.sroa.9.0.ph = phi i64 [ 0, %bb.f ], [ %.sroa.611.1, %_RNvMNtCsj6eKBz9Db1c_4core6resultINtB2_6ResultNtNtNtCs7ZUl82OSlxp_6rustls4msgs5codec3u24NtNtBN_5error14InvalidMessageE6unwrapBN_.exit.i ] ; 2 uses
  %.sroa.816.0.ph = phi i64 [ 0, %bb.f ], [ 1, %_RNvMNtCsj6eKBz9Db1c_4core6resultINtB2_6ResultNtNtNtCs7ZUl82OSlxp_6rustls4msgs5codec3u24NtNtBN_5error14InvalidMessageE6unwrapBN_.exit.i ]
  %.sroa.015.0.ph = phi i64 [ %.sroa.816.047, %bb.f ], [ %i.ba, %_RNvMNtCsj6eKBz9Db1c_4core6resultINtB2_6ResultNtNtNtCs7ZUl82OSlxp_6rustls4msgs5codec3u24NtNtBN_5error14InvalidMessageE6unwrapBN_.exit.i ] ; 2 uses
  %.sroa.611.2.ph = phi i64 [ %i.at, %bb.f ], [ %i.bf, %_RNvMNtCsj6eKBz9Db1c_4core6resultINtB2_6ResultNtNtNtCs7ZUl82OSlxp_6rustls4msgs5codec3u24NtNtBN_5error14InvalidMessageE6unwrapBN_.exit.i ]
  %.sroa.11.1.ph = phi i64 [ %i.au, %bb.f ], [ %i.bg, %_RNvMNtCsj6eKBz9Db1c_4core6resultINtB2_6ResultNtNtNtCs7ZUl82OSlxp_6rustls4msgs5codec3u24NtNtBN_5error14InvalidMessageE6unwrapBN_.exit.i ]
...
_RNvMsG_NtCs4wP2HXfJTCR_5alloc3vecINtB5_3VecNtNtNtNtCs7ZUl82OSlxp_6rustls4msgs8deframer9handshake12FragmentSpanE8push_mutBN_.exit6: ; preds = %bb.i, %bb.j
  ...
  store i64 %.sroa.816.0.ph, ptr %i.bl, align 8
  %.sroa.419.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.bl, i64 8
  store i64 %.sroa.015.0.ph, ptr %.sroa.419.0..sroa_idx, align 8
  %.sroa.520.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.bl, i64 16
  store i64 %.sroa.611.2.ph, ptr %.sroa.520.0..sroa_idx, align 8
  %.sroa.621.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.bl, i64 24
  store i64 %.sroa.11.1.ph, ptr %.sroa.621.0..sroa_idx, align 8
  ...
  %i.bn = icmp eq i64 %.sroa.9.0.ph, 0
...
bb.f:                                             ; preds = %_RNvMs_NtCs4wP2HXfJTCR_5alloc3vecINtB4_3VecNtNtNtNtCs7ZUl82OSlxp_6rustls4msgs8deframer9handshake12FragmentSpanE10insert_mutBM_.exit.i, %.lr.ph.i
  %.sroa.013.035.i = phi i64 [ 0, %.lr.ph.i ], [ %i.bg, %_RNvMs_NtCs4wP2HXfJTCR_5alloc3vecINtB4_3VecNtNtNtNtCs7ZUl82OSlxp_6rustls4msgs8deframer9handshake12FragmentSpanE10insert_mutBM_.exit.i ] ; 2 uses
  %.sroa.5.034.i = phi ptr [ %i.ar, %.lr.ph.i ], [ %.sroa.5.1.i, %_RNvMs_NtCs4wP2HXfJTCR_5alloc3vecINtB4_3VecNtNtNtNtCs7ZUl82OSlxp_6rustls4msgs8deframer9handshake12FragmentSpanE10insert_mutBM_.exit.i ] ; 3 uses
  %.sroa.9.033.i = phi i64 [ %i.ap, %.lr.ph.i ], [ %.sroa.9.1.i, %_RNvMs_NtCs4wP2HXfJTCR_5alloc3vecINtB4_3VecNtNtNtNtCs7ZUl82OSlxp_6rustls4msgs8deframer9handshake12FragmentSpanE10insert_mutBM_.exit.i ] ; 4 uses
  %i.as = icmp ult i64 %.sroa.9.033.i, 4
  br i1 %i.as, label %bb.j, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.at = getelementptr inbounds nuw i8, ptr %.sroa.5.034.i, i64 4
  %i.au = add nsw i64 %.sroa.9.033.i, -4          ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !155
  %i.av = getelementptr inbounds nuw i8, ptr %.sroa.5.034.i, i64 1
...
bb.j:                                             ; preds = %bb.i, %_RNvMNtCsj6eKBz9Db1c_4core6resultINtB2_6ResultNtNtNtCs7ZUl82OSlxp_6rustls4msgs5codec3u24NtNtBN_5error14InvalidMessageE6unwrapBN_.exit.i.i.i, %bb.f
  ...
  %.sroa.01.0.i.sink.i.i = phi i64 [ %.sroa.9.033.i, %bb.f ], [ %i.bc, %bb.i ], [ %.sroa.9.033.i, %_RNvMNtCsj6eKBz9Db1c_4core6resultINtB2_6ResultNtNtNtCs7ZUl82OSlxp_6rustls4msgs5codec3u24NtNtBN_5error14InvalidMessageE6unwrapBN_.exit.i.i.i ]
  ...
  %i.bd = ptrtoint ptr %.sroa.5.034.i to i64
