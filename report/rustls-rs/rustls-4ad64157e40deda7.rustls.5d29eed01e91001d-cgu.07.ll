...
begin_hunk_0_@_RNvXs1_NtNtCs7ZUl82OSlxp_6rustls4msgs10fragmenterNtB5_7ChunkerNtNtNtNtCsj6eKBz9Db1c_4core4iter6traits8iterator8Iterator4next:bb.a
...
vec.epilog.scalar.ph.preheader:                   ; preds = %iter.check, %vector.memcheck, %vec.epilog.iter.check, %vec.epilog.middle.block
  ...
  %i.as = sub i64 %.val6.i.i, %.val.i.i
  %i.at = xor i64 %.sroa.0.08.i.i.ph, -1
  %i.au = add i64 %.val6.i.i, %i.at
  %xtraiter = and i64 %i.as, 1
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %vec.epilog.scalar.ph.prol.loopexit, label %vec.epilog.scalar.ph.prol

vec.epilog.scalar.ph.prol:                        ; preds = %vec.epilog.scalar.ph.preheader
  %i.av = or disjoint i64 %.sroa.0.08.i.i.ph, 1
  %i.aw = add i64 %.sroa.0.08.i.i.ph, %.val.i.i   ; 2 uses
  %i.ax = getelementptr inbounds nuw i8, ptr %.val.i.i.i, i64 %i.aw ; 2 uses
  %i.ay = getelementptr inbounds nuw i8, ptr %.val1.i.i.i, i64 %i.aw
  %.val7.i.i.prol = load i8, ptr %i.ay, align 1, !noalias !363, !noundef !4
  %i.az = load i8, ptr %i.ax, align 1, !alias.scope !366, !noalias !363, !noundef !4
  %i.ba = xor i8 %i.az, %.val7.i.i.prol
  store i8 %i.ba, ptr %i.ax, align 1, !alias.scope !366, !noalias !363
  br label %vec.epilog.scalar.ph.prol.loopexit

vec.epilog.scalar.ph.prol.loopexit:               ; preds = %vec.epilog.scalar.ph.prol, %vec.epilog.scalar.ph.preheader
  %.sroa.0.08.i.i.unr = phi i64 [ %.sroa.0.08.i.i.ph, %vec.epilog.scalar.ph.preheader ], [ %i.av, %vec.epilog.scalar.ph.prol ]
  %i.bb = icmp eq i64 %i.au, %.val.i.i
  br i1 %i.bb, label %.loopexit, label %vec.epilog.scalar.ph.preheader.new
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph, %vec.epilog.scalar.ph.preheader.new
  %.sroa.0.08.i.i = phi i64 [ %.sroa.0.08.i.i.unr, %vec.epilog.scalar.ph.preheader.new ], [ %i.bh, %vec.epilog.scalar.ph ] ; 3 uses
  %i.bc = add i64 %.sroa.0.08.i.i, %.val.i.i      ; 2 uses
  %i.bd = getelementptr inbounds nuw i8, ptr %.val.i.i.i, i64 %i.bc ; 2 uses
  %i.be = getelementptr inbounds nuw i8, ptr %.val1.i.i.i, i64 %i.bc
  %.val7.i.i = load i8, ptr %i.be, align 1, !noalias !363, !noundef !4
  %i.bf = load i8, ptr %i.bd, align 1, !alias.scope !366, !noalias !363, !noundef !4
  %i.bg = xor i8 %i.bf, %.val7.i.i
  store i8 %i.bg, ptr %i.bd, align 1, !alias.scope !366, !noalias !363
  %i.bh = add nuw i64 %.sroa.0.08.i.i, 2          ; 2 uses
  %.reass = add i64 %.sroa.0.08.i.i, %invariant.op ; 2 uses
  %i.bi = getelementptr inbounds nuw i8, ptr %.val.i.i.i, i64 %.reass ; 2 uses
  %i.bj = getelementptr inbounds nuw i8, ptr %.val1.i.i.i, i64 %.reass
  %.val7.i.i.1 = load i8, ptr %i.bj, align 1, !noalias !363, !noundef !4
  %i.bk = load i8, ptr %i.bi, align 1, !alias.scope !366, !noalias !363, !noundef !4
  %i.bl = xor i8 %i.bk, %.val7.i.i.1
  store i8 %i.bl, ptr %i.bi, align 1, !alias.scope !366, !noalias !363
  %exitcond.not.i.i.1 = icmp eq i64 %i.bh, %i.ac
...
.loopexit:                                        ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph, %middle.block, %vec.epilog.middle.block, %.noexc
  ...
  %i.bn = load i8, ptr %i.bm, align 8, !range !23, !noundef !4 ; 2 uses
  %i.bo = getelementptr inbounds nuw i8, ptr %2, i64 33
  %i.bp = load i8, ptr %i.bo, align 1             ; 2 uses
  %i.bq = getelementptr inbounds nuw i8, ptr %2, i64 34
  %i.br = load i16, ptr %i.bq, align 2, !range !24, !noundef !4 ; 2 uses
  %i.bs = getelementptr inbounds nuw i8, ptr %2, i64 36
  %i.bt = load i16, ptr %i.bs, align 4            ; 2 uses
...
bb.i:                                             ; preds = %bb.h, %bb.g, %bb.f, %bb.e, %bb.d, %.noexc24
  %.sroa.05.0.i = phi i8 [ %i.bp, %bb.h ], [ 21, %bb.d ], [ 22, %bb.e ], [ 23, %bb.f ], [ 24, %bb.g ], [ 20, %.noexc24 ]
  %i.bu = getelementptr inbounds nuw i8, ptr %i.f, i64 8
  store i8 %.sroa.05.0.i, ptr %i.bu, align 1, !noalias !367
  switch i16 %i.br, label %default.unreachable [
    i16 0, label %bb.s
    i16 1, label %bb.j
    i16 2, label %bb.k
    i16 3, label %bb.l
...
bb.s:                                             ; preds = %bb.r, %bb.q, %bb.p, %bb.o, %bb.n, %bb.m, %bb.l, %bb.k, %bb.j, %bb.i
  %.sroa.06.0.i = phi i16 [ %i.bt, %bb.r ], [ 768, %bb.j ], [ 769, %bb.k ], [ 770, %bb.l ], [ 771, %bb.m ], [ 772, %bb.n ], [ -257, %bb.o ], [ -259, %bb.p ], [ -260, %bb.q ], [ 2, %bb.i ]
  %i.bv = getelementptr inbounds nuw i8, ptr %i.f, i64 9
  invoke void @_RNvNtNtCs7ZUl82OSlxp_6rustls4msgs5codec7put_u16(i16 noundef %.sroa.06.0.i, ptr noalias nofree noundef nonnull %i.bv, i64 noundef 4)
          to label %.noexc25 unwind label %bb.am

.noexc25:                                         ; preds = %bb.s
  %i.bw = trunc i64 %.sroa.0.0 to i16
  %i.bx = getelementptr inbounds nuw i8, ptr %i.f, i64 11
  invoke void @_RNvNtNtCs7ZUl82OSlxp_6rustls4msgs5codec7put_u16(i16 noundef %i.bw, ptr noalias nofree noundef nonnull %i.bx, i64 noundef 2)
...
bb.u:                                             ; preds = %.noexc25
  ...
  %i.by = getelementptr inbounds nuw i8, ptr %i.m, i64 4
  invoke void @_RNvMs2_NtNtNtCs7ZUl82OSlxp_6rustls4msgs7message8outboundNtB5_15PrefixedPayload17extend_from_slice(ptr noalias nofree noundef nonnull align 8 dereferenceable(24) %i.n, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %i.by, i64 noundef 8)
...
bb.w:                                             ; preds = %bb.v
  ...
  %i.bz = invoke { ptr, i64 } @_RNvXs4_NtNtNtCs7ZUl82OSlxp_6rustls4msgs7message8outboundNtB5_15PrefixedPayloadINtNtCsj6eKBz9Db1c_4core7convert5AsMutShE6as_mut(ptr noalias nofree noundef nonnull align 8 dereferenceable(24) %i.n)
...
bb.x:                                             ; preds = %bb.w
  %i.ca = extractvalue { ptr, i64 } %i.bz, 1      ; 4 uses
  %i.cb = icmp ult i64 %i.ca, 8
  br i1 %i.cb, label %bb.ab, label %bb.y, !prof !15

bb.y:                                             ; preds = %bb.x
  %i.cc = add i64 %i.ca, -8                       ; 2 uses
  ...
  %.val23 = load ptr, ptr %i.ce, align 8, !nonnull !4, !noundef !4
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.02.i.i.i)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e), !noalias !368
  %i.cf = getelementptr inbounds nuw i8, ptr %i.e, i64 1 ; 2 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(12) %i.cf, ptr noundef nonnull readonly align 1 dereferenceable(12) %i.k, i64 12, i1 false), !noalias !369
  store i8 1, ptr %i.e, align 1, !noalias !368
  %i.cg = getelementptr inbounds nuw i8, ptr %.val23, i64 16
  %i.ch = load i64, ptr %i.cg, align 8, !noalias !370, !noundef !4
  %i.ci = icmp ugt i64 %i.cc, %i.ch
  br i1 %i.ci, label %_RNvMs_NtNtCs222MioR9bx1_9aws_lc_rs4aead11unbound_keyNtB4_10UnboundKey26seal_in_place_separate_tag.exit.thread.i, label %bb.z

end_hunk_0
begin_hunk_1_@_RNvXs1t_NtCs7ZUl82OSlxp_6rustls5enumsNtB6_15CertificateTypeNtNtCsj6eKBz9Db1c_4core3fmt5Debug3fmt:bb.a
...
vec.epilog.scalar.ph.preheader:                   ; preds = %iter.check, %vector.memcheck, %vec.epilog.iter.check, %vec.epilog.middle.block
  ...
  %i.ag = sub i64 %.val6.i.i, %.val.i.i
  %i.ah = xor i64 %.sroa.0.08.i.i.ph, -1
  %i.ai = add i64 %.val6.i.i, %i.ah
  %xtraiter = and i64 %i.ag, 1
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %vec.epilog.scalar.ph.prol.loopexit, label %vec.epilog.scalar.ph.prol

vec.epilog.scalar.ph.prol:                        ; preds = %vec.epilog.scalar.ph.preheader
  %i.aj = or disjoint i64 %.sroa.0.08.i.i.ph, 1
  %i.ak = add i64 %.sroa.0.08.i.i.ph, %.val.i.i   ; 2 uses
  ...
  %.val7.i.i.prol = load i8, ptr %i.am, align 1, !noalias !504, !noundef !4
  %i.an = load i8, ptr %i.al, align 1, !alias.scope !507, !noalias !504, !noundef !4
  %i.ao = xor i8 %i.an, %.val7.i.i.prol
  store i8 %i.ao, ptr %i.al, align 1, !alias.scope !507, !noalias !504
  br label %vec.epilog.scalar.ph.prol.loopexit

vec.epilog.scalar.ph.prol.loopexit:               ; preds = %vec.epilog.scalar.ph.prol, %vec.epilog.scalar.ph.preheader
  %.sroa.0.08.i.i.unr = phi i64 [ %.sroa.0.08.i.i.ph, %vec.epilog.scalar.ph.preheader ], [ %i.aj, %vec.epilog.scalar.ph.prol ]
  %i.ap = icmp eq i64 %i.ai, %.val.i.i
  br i1 %i.ap, label %_RNvMs6_NtNtCs7ZUl82OSlxp_6rustls6crypto6cipherNtB5_5Nonce12new_from_seq.exit, label %vec.epilog.scalar.ph.preheader.new
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph, %vec.epilog.scalar.ph.preheader.new
  %.sroa.0.08.i.i = phi i64 [ %.sroa.0.08.i.i.unr, %vec.epilog.scalar.ph.preheader.new ], [ %i.av, %vec.epilog.scalar.ph ] ; 3 uses
  %i.aq = add i64 %.sroa.0.08.i.i, %.val.i.i      ; 2 uses
  %i.ar = getelementptr inbounds nuw i8, ptr %.val.i.i.i, i64 %i.aq ; 2 uses
  %i.as = getelementptr inbounds nuw i8, ptr %.val1.i.i.i, i64 %i.aq
  %.val7.i.i = load i8, ptr %i.as, align 1, !noalias !504, !noundef !4
  %i.at = load i8, ptr %i.ar, align 1, !alias.scope !507, !noalias !504, !noundef !4
  %i.au = xor i8 %i.at, %.val7.i.i
  store i8 %i.au, ptr %i.ar, align 1, !alias.scope !507, !noalias !504
  %i.av = add nuw i64 %.sroa.0.08.i.i, 2          ; 2 uses
  %.reass = add i64 %.sroa.0.08.i.i, %invariant.op ; 2 uses
  %i.aw = getelementptr inbounds nuw i8, ptr %.val.i.i.i, i64 %.reass ; 2 uses
  %i.ax = getelementptr inbounds nuw i8, ptr %.val1.i.i.i, i64 %.reass
  %.val7.i.i.1 = load i8, ptr %i.ax, align 1, !noalias !504, !noundef !4
  %i.ay = load i8, ptr %i.aw, align 1, !alias.scope !507, !noalias !504, !noundef !4
  %i.az = xor i8 %i.ay, %.val7.i.i.1
  store i8 %i.az, ptr %i.aw, align 1, !alias.scope !507, !noalias !504
  %exitcond.not.i.i.1 = icmp eq i64 %i.av, %i.q
...
_RNvMs6_NtNtCs7ZUl82OSlxp_6rustls6crypto6cipherNtB5_5Nonce12new_from_seq.exit: ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph, %middle.block, %vec.epilog.middle.block, %bb.b
  ...
  %i.bb = load i8, ptr %i.ba, align 8, !range !23, !noundef !4
  %i.bc = getelementptr inbounds nuw i8, ptr %2, i64 17 ; 2 uses
  %i.bd = load i8, ptr %i.bc, align 1
  %i.be = getelementptr inbounds nuw i8, ptr %2, i64 18 ; 2 uses
  %i.bf = load i16, ptr %i.be, align 2, !range !24, !noundef !4
...
bb.h:                                             ; preds = %bb.g, %bb.f, %bb.e, %bb.d, %bb.c, %.noexc
  %.sroa.05.0.i = phi i8 [ %i.bd, %bb.g ], [ 21, %bb.c ], [ 22, %bb.d ], [ 23, %bb.e ], [ 24, %bb.f ], [ 20, %.noexc ]
  %i.bi = getelementptr inbounds nuw i8, ptr %i.b, i64 8
  store i8 %.sroa.05.0.i, ptr %i.bi, align 1, !noalias !508
...
bb.r:                                             ; preds = %bb.q, %bb.p, %bb.o, %bb.n, %bb.m, %bb.l, %bb.k, %bb.j, %bb.i, %bb.h
  %.sroa.06.0.i = phi i16 [ %i.bh, %bb.q ], [ 768, %bb.i ], [ 769, %bb.j ], [ 770, %bb.k ], [ 771, %bb.l ], [ 772, %bb.m ], [ -257, %bb.n ], [ -259, %bb.o ], [ -260, %bb.p ], [ 2, %bb.h ]
  %i.bj = getelementptr inbounds nuw i8, ptr %i.b, i64 9
  invoke void @_RNvNtNtCs7ZUl82OSlxp_6rustls4msgs5codec7put_u16(i16 noundef %.sroa.06.0.i, ptr noalias nofree noundef nonnull %i.bj, i64 noundef 4)
          to label %.noexc61 unwind label %bb.y

.noexc61:                                         ; preds = %bb.r
  %i.bk = trunc i64 %i.i to i16
  %i.bl = add i16 %i.bk, -16
  %i.bm = getelementptr inbounds nuw i8, ptr %i.b, i64 11
  invoke void @_RNvNtNtCs7ZUl82OSlxp_6rustls4msgs5codec7put_u16(i16 noundef %i.bl, ptr noalias nofree noundef nonnull %i.bm, i64 noundef 2)
...
bb.t:                                             ; preds = %.noexc61
  ...
  %i.bn = load ptr, ptr %2, align 8, !nonnull !4, !noundef !4
  %i.bo = call fastcc { ptr, i64 } @_RNvMs_NtNtCs222MioR9bx1_9aws_lc_rs4aead11unbound_keyNtB4_10UnboundKey11open_within(ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %1, ptr noalias nofree noundef align 1 captures(address) dereferenceable(12) %i.a, ptr noalias nofree noundef nonnull readonly align 1 captures(address, read_provenance) dereferenceable(13) %i.f, ptr noalias nofree noundef nonnull %i.bn, i64 noundef range(i64 0, -9223372036854775808) %i.i) ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !509
  %i.bp = extractvalue { ptr, i64 } %i.bo, 0
  %i.bq = extractvalue { ptr, i64 } %i.bo, 1      ; 2 uses
  %i.br = icmp eq ptr %i.bp, null
  br i1 %i.br, label %bb.x, label %bb.u

bb.u:                                             ; preds = %bb.t
  %i.bs = icmp ugt i64 %i.bq, 16384
  br i1 %i.bs, label %bb.x, label %bb.v

bb.v:                                             ; preds = %bb.u
  call void @_RNvMs1_NtNtNtCs7ZUl82OSlxp_6rustls4msgs7message7inboundNtB5_15BorrowedPayload8truncate(ptr noalias nofree noundef nonnull align 8 dereferenceable(16) %2, i64 noundef %i.bq)
  %i.bt = load i8, ptr %i.ba, align 8, !range !23, !noundef !4
  %i.bu = load i8, ptr %i.bc, align 1
  %i.bv = load ptr, ptr %2, align 8, !nonnull !4, !noundef !4
  %i.bw = load i64, ptr %i.h, align 8, !noundef !4
  ...
  store i64 %i.bw, ptr %.sroa.432.0..sroa_idx, align 8
  %.sroa.533.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 24
  store i8 %i.bt, ptr %.sroa.533.0..sroa_idx, align 8
  %.sroa.634.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 25
  store i8 %i.bu, ptr %.sroa.634.0..sroa_idx, align 1
  %.sroa.735.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 26
  %i.by = load <2 x i16>, ptr %i.be, align 2
  store <2 x i16> %i.by, ptr %.sroa.735.0..sroa_idx, align 2
...
.body.thread:                                     ; preds = %bb.aj, %bb.ac, %bb.x, %.body, %bb.b
  %.pn = phi { ptr, i32 } [ %i.cf, %bb.x ], [ %lpad.thr_comm.split-lp, %.body ], [ %i.u, %bb.b ], [ %lpad.thr_comm.i, %bb.ac ], [ %lpad.thr_comm, %bb.aj ]
...
vec.epilog.scalar.ph.preheader:                   ; preds = %iter.check, %vector.memcheck, %vec.epilog.iter.check, %vec.epilog.middle.block
  ...
  %i.aq = sub i64 %.val6.i.i, %.val.i.i
  %i.ar = xor i64 %.sroa.0.08.i.i.ph, -1
  %i.as = add i64 %.val6.i.i, %i.ar
  %xtraiter = and i64 %i.aq, 1
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %vec.epilog.scalar.ph.prol.loopexit, label %vec.epilog.scalar.ph.prol

vec.epilog.scalar.ph.prol:                        ; preds = %vec.epilog.scalar.ph.preheader
  %i.at = or disjoint i64 %.sroa.0.08.i.i.ph, 1
  %i.au = add i64 %.sroa.0.08.i.i.ph, %.val.i.i   ; 2 uses
  %i.av = getelementptr inbounds nuw i8, ptr %.val.i.i.i, i64 %i.au ; 2 uses
  %i.aw = getelementptr inbounds nuw i8, ptr %.val1.i.i.i, i64 %i.au
  %.val7.i.i.prol = load i8, ptr %i.aw, align 1, !noalias !548, !noundef !4
  %i.ax = load i8, ptr %i.av, align 1, !alias.scope !551, !noalias !548, !noundef !4
  %i.ay = xor i8 %i.ax, %.val7.i.i.prol
  store i8 %i.ay, ptr %i.av, align 1, !alias.scope !551, !noalias !548
  br label %vec.epilog.scalar.ph.prol.loopexit

vec.epilog.scalar.ph.prol.loopexit:               ; preds = %vec.epilog.scalar.ph.prol, %vec.epilog.scalar.ph.preheader
  %.sroa.0.08.i.i.unr = phi i64 [ %.sroa.0.08.i.i.ph, %vec.epilog.scalar.ph.preheader ], [ %i.at, %vec.epilog.scalar.ph.prol ]
  %i.az = icmp eq i64 %i.as, %.val.i.i
  br i1 %i.az, label %.loopexit, label %vec.epilog.scalar.ph.preheader.new
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph, %vec.epilog.scalar.ph.preheader.new
  %.sroa.0.08.i.i = phi i64 [ %.sroa.0.08.i.i.unr, %vec.epilog.scalar.ph.preheader.new ], [ %i.bf, %vec.epilog.scalar.ph ] ; 3 uses
  %i.ba = add i64 %.sroa.0.08.i.i, %.val.i.i      ; 2 uses
  %i.bb = getelementptr inbounds nuw i8, ptr %.val.i.i.i, i64 %i.ba ; 2 uses
  %i.bc = getelementptr inbounds nuw i8, ptr %.val1.i.i.i, i64 %i.ba
  %.val7.i.i = load i8, ptr %i.bc, align 1, !noalias !548, !noundef !4
  %i.bd = load i8, ptr %i.bb, align 1, !alias.scope !551, !noalias !548, !noundef !4
  %i.be = xor i8 %i.bd, %.val7.i.i
  store i8 %i.be, ptr %i.bb, align 1, !alias.scope !551, !noalias !548
  %i.bf = add nuw i64 %.sroa.0.08.i.i, 2          ; 2 uses
  %.reass = add i64 %.sroa.0.08.i.i, %invariant.op ; 2 uses
  %i.bg = getelementptr inbounds nuw i8, ptr %.val.i.i.i, i64 %.reass ; 2 uses
  %i.bh = getelementptr inbounds nuw i8, ptr %.val1.i.i.i, i64 %.reass
  %.val7.i.i.1 = load i8, ptr %i.bh, align 1, !noalias !548, !noundef !4
  %i.bi = load i8, ptr %i.bg, align 1, !alias.scope !551, !noalias !548, !noundef !4
  %i.bj = xor i8 %i.bi, %.val7.i.i.1
  store i8 %i.bj, ptr %i.bg, align 1, !alias.scope !551, !noalias !548
  %exitcond.not.i.i.1 = icmp eq i64 %i.bf, %i.aa
...
.loopexit:                                        ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph, %middle.block, %vec.epilog.middle.block, %.noexc
  ...
  %i.bl = load i8, ptr %i.bk, align 8, !range !23, !noundef !4 ; 2 uses
  %i.bm = getelementptr inbounds nuw i8, ptr %2, i64 33
  %i.bn = load i8, ptr %i.bm, align 1             ; 2 uses
  %i.bo = getelementptr inbounds nuw i8, ptr %2, i64 34
  %i.bp = load i16, ptr %i.bo, align 2, !range !24, !noundef !4 ; 2 uses
  %i.bq = getelementptr inbounds nuw i8, ptr %2, i64 36
...
bb.i:                                             ; preds = %bb.h, %bb.g, %bb.f, %bb.e, %bb.d, %.noexc22
  %.sroa.05.0.i = phi i8 [ %i.bn, %bb.h ], [ 21, %bb.d ], [ 22, %bb.e ], [ 23, %bb.f ], [ 24, %bb.g ], [ 20, %.noexc22 ]
  %i.bs = getelementptr inbounds nuw i8, ptr %i.f, i64 8
  store i8 %.sroa.05.0.i, ptr %i.bs, align 1, !noalias !552
  switch i16 %i.bp, label %default.unreachable [
    i16 0, label %bb.s
    i16 1, label %bb.j
    i16 2, label %bb.k
    i16 3, label %bb.l
...
bb.s:                                             ; preds = %bb.r, %bb.q, %bb.p, %bb.o, %bb.n, %bb.m, %bb.l, %bb.k, %bb.j, %bb.i
  %.sroa.06.0.i = phi i16 [ %i.br, %bb.r ], [ 768, %bb.j ], [ 769, %bb.k ], [ 770, %bb.l ], [ 771, %bb.m ], [ 772, %bb.n ], [ -257, %bb.o ], [ -259, %bb.p ], [ -260, %bb.q ], [ 2, %bb.i ]
  %i.bt = getelementptr inbounds nuw i8, ptr %i.f, i64 9
  invoke void @_RNvNtNtCs7ZUl82OSlxp_6rustls4msgs5codec7put_u16(i16 noundef %.sroa.06.0.i, ptr noalias nofree noundef nonnull %i.bt, i64 noundef 4)
          to label %.noexc23 unwind label %bb.aj

.noexc23:                                         ; preds = %bb.s
  %i.bu = trunc i64 %.sroa.0.0 to i16
  %i.bv = getelementptr inbounds nuw i8, ptr %i.f, i64 11
  invoke void @_RNvNtNtCs7ZUl82OSlxp_6rustls4msgs5codec7put_u16(i16 noundef %i.bu, ptr noalias nofree noundef nonnull %i.bv, i64 noundef 2)
...
bb.u:                                             ; preds = %bb.t
  ...
  %.val21 = load ptr, ptr %i.bx, align 8          ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e), !noalias !553
  %i.by = getelementptr inbounds nuw i8, ptr %i.e, i64 1 ; 3 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(12) %i.by, ptr noundef nonnull align 1 dereferenceable(12) %i.k, i64 12, i1 false)
  store i8 1, ptr %i.e, align 1, !noalias !553
  %i.bz = invoke { ptr, i64 } @_RNvXs4_NtNtNtCs7ZUl82OSlxp_6rustls4msgs7message8outboundNtB5_15PrefixedPayloadINtNtCsj6eKBz9Db1c_4core7convert5AsMutShE6as_mut(ptr noalias nofree noundef nonnull align 8 dereferenceable(24) %i.l)
...
bb.v:                                             ; preds = %bb.u
  ...
  %i.cb = getelementptr inbounds nuw i8, ptr %.val21, i64 16
  %i.cc = load i64, ptr %i.cb, align 8, !noalias !555, !noundef !4
  %i.cd = icmp ugt i64 %i.ca, %i.cc
  br i1 %i.cd, label %_RINvMs_NtNtCs222MioR9bx1_9aws_lc_rs4aead11unbound_keyNtB5_10UnboundKey24seal_in_place_append_tagNtNtNtNtCs7ZUl82OSlxp_6rustls4msgs7message8outbound15PrefixedPayloadEB1E_.exit.thread.i, label %bb.w
...
_RINvMs_NtNtCs222MioR9bx1_9aws_lc_rs4aead11unbound_keyNtB5_10UnboundKey24seal_in_place_append_tagNtNtNtNtCs7ZUl82OSlxp_6rustls4msgs7message8outbound15PrefixedPayloadEB1E_.exit.thread.i: ; preds = %bb.v
  invoke void @_RNvXs_NtCs222MioR9bx1_9aws_lc_rs2ivINtB4_11FixedLengthKjc_ENtNtNtCsj6eKBz9Db1c_4core3ops4drop4Drop4dropCs7ZUl82OSlxp_6rustls(ptr noalias nofree noundef nonnull dereferenceable(12) %i.by)
...
bb.w:                                             ; preds = %bb.v
  ...
  %i.ce = invoke { ptr, i64 } @_RNvXs4_NtNtNtCs7ZUl82OSlxp_6rustls4msgs7message8outboundNtB5_15PrefixedPayloadINtNtCsj6eKBz9Db1c_4core7convert5AsMutShE6as_mut(ptr noalias nofree noundef nonnull align 8 dereferenceable(24) %i.l)
...
bb.y:                                             ; preds = %bb.w
  %i.cg = extractvalue { ptr, i64 } %i.ce, 1      ; 2 uses
end_hunk_2
