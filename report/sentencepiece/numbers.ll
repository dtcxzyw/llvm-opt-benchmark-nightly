...
bb.j:                                             ; preds = %bb.h
  ...
  %3 = mul i32 %i.dw, 103
  %4 = lshr i32 %3, 10
  %5 = and i32 %4, 983055                         ; 2 uses
  %.neg.i16 = mul i32 %5, 16777206
  %6 = add i32 %.neg.i16, %i.dw
  %7 = shl i32 %6, 8
  %8 = add i32 %7, %5                             ; 3 uses
  %i.dx = icmp ne i32 %8, 0
  tail call void @llvm.assume(i1 %i.dx)
  %i.dy = tail call range(i32 0, 33) i32 @llvm.cttz.i32(i32 %8, i1 true) ; 2 uses
  %i.dz = and i32 %i.dy, 24
  %i.ea = add i32 %8, 808464432
...
bb.l:                                             ; preds = %bb.j
  ...
  %3 = lshr i32 %2, 10
  %4 = and i32 %3, 983055                         ; 2 uses
  %.neg.i23 = mul i32 %4, 16777206
  %5 = add i32 %.neg.i23, %i.ee
  %6 = shl i32 %5, 8
  %7 = add i32 %6, %4                             ; 3 uses
  %i.ef = icmp ne i32 %7, 0
  tail call void @llvm.assume(i1 %i.ef)
  %i.eg = tail call range(i32 0, 33) i32 @llvm.cttz.i32(i32 %7, i1 true) ; 2 uses
  %i.eh = and i32 %i.eg, 24
  %i.ei = add i32 %7, 808464432
