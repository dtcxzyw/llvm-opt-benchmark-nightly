...
_ZNKSt17basic_string_viewIcSt11char_traitsIcEE4findES2_m.exit.thread52: ; preds = %_ZNKSt17basic_string_viewIcSt11char_traitsIcEE13find_first_ofEPKcm.exit, %_ZNKSt17basic_string_viewIcSt11char_traitsIcEE4findES2_m.exit
  ...
  %.sroa.0.05462 = phi i64 [ %.sroa.0.0, %_ZNKSt17basic_string_viewIcSt11char_traitsIcEE4findES2_m.exit ], [ 0, %_ZNKSt17basic_string_viewIcSt11char_traitsIcEE13find_first_ofEPKcm.exit ] ; 3 uses
  %i.ag = getelementptr inbounds nuw i8, ptr %.sroa.12.076, i64 %.sroa.0.05462
  %i.ah = sub i64 %.sroa.035.077, %.sroa.0.05462
  %i.ai = add i64 %.sroa.0.05462, %.1.i.i55       ; 2 uses
