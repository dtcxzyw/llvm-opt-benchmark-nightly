...
_ZNKSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE12_M_check_lenEmPKc.exit.i: ; preds = %bb.p
  %i.bz = ashr exact i64 %i.bx, 5                 ; 3 uses
  %.sroa.speculated.i.i = call i64 @llvm.umax.i64(i64 %i.bz, i64 1)
  %7 = add nsw i64 %.sroa.speculated.i.i, %i.bz   ; 2 uses
  %i.ca = icmp ult i64 %7, %i.bz
  %i.cb = call i64 @llvm.umin.i64(i64 %7, i64 288230376151711743)
  %i.cc = select i1 %i.ca, i64 288230376151711743, i64 %i.cb ; 3 uses
  %.not.i.i81 = icmp ne i64 %i.cc, 0
