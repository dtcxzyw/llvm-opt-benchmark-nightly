...
66:                                               ; preds = %.critedge
  ...
  %68 = load i64, ptr %67, align 8, !tbaa !111    ; 2 uses
  %69 = and i64 %68, 4503599627370496
...
._crit_edge:                                      ; preds = %120
  ...
  %.pre385 = load ptr, ptr %.phi.trans.insert, align 8, !tbaa !533
  br label %123

123:                                              ; preds = %._crit_edge, %116
  %124 = phi ptr [ %.pre385, %._crit_edge ], [ %118, %116 ]
...
._crit_edge391:                                   ; preds = %127
  %.pre386.pre = load ptr, ptr %13, align 8, !tbaa !524
  br label %137
...
137:                                              ; preds = %._crit_edge391, %123, %commandCheckArity.exit
  %.pre386 = phi ptr [ %.pre386.pre, %._crit_edge391 ], [ %125, %123 ], [ %90, %commandCheckArity.exit ]
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #42
  br label %.thread347

.thread347:                                       ; preds = %.thread, %137
  %138 = phi ptr [ %14, %.thread ], [ %.pre386, %137 ] ; 2 uses
...
.thread365:                                       ; preds = %332
  ...
  %.pre387 = load i32, ptr getelementptr inbounds nuw (i8, ptr @server, i64 8160), align 8
  %334 = icmp ne i32 %.pre387, 0
...
begin_hunk_6
  ...
  %.not381 = select i1 %387, i1 %389, i1 false
...
..thread376_crit_edge:                            ; preds = %463
  %.pre388 = load i64, ptr %273, align 8, !tbaa !111
  br label %.thread376
...
.thread376:                                       ; preds = %..thread376_crit_edge, %457
  %475 = phi i64 [ %.pre388, %..thread376_crit_edge ], [ %458, %457 ]
...
._crit_edge389:                                   ; preds = %545
  %.pre390 = load i64, ptr %273, align 8, !tbaa !111
  br label %549
...
549:                                              ; preds = %._crit_edge389, %541
  %550 = phi i64 [ %.pre390, %._crit_edge389 ], [ %539, %541 ]
  %551 = and i64 %550, 8
...
begin_hunk_10
  ...
  %.not384 = select i1 %564, i1 %566, i1 false
