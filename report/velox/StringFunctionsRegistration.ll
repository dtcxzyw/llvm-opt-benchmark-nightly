...
._crit_edge154:                                   ; preds = %bb.p
  ...
  %i.bc = fcmp ogt double %i.bb, f0x3FE6666666666666
...
.lr.ph153:                                        ; preds = %._crit_edge, %bb.p
  ...
  %i.bd = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0109.0, i64 %indvars.iv177
  %i.be = load i32, ptr %i.bd, align 4, !tbaa !3
  %i.bf = icmp eq i32 %i.be, 1
  br i1 %i.bf, label %.preheader142.preheader, label %bb.p

.preheader142.preheader:                          ; preds = %.lr.ph153
  %i.bg = sext i32 %.049151 to i64
  br label %.preheader142

.preheader142:                                    ; preds = %.preheader142.preheader, %.preheader142
  %indvars.iv174 = phi i64 [ %i.bg, %.preheader142.preheader ], [ %indvars.iv.next175, %.preheader142 ] ; 4 uses
  %i.bh = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0103.0, i64 %indvars.iv174
  %i.bi = load i32, ptr %i.bh, align 4, !tbaa !3
  %i.bj = icmp eq i32 %i.bi, 0
  %indvars.iv.next175 = add nsw i64 %indvars.iv174, 1
  br i1 %i.bj, label %.preheader142, label %bb.o, !llvm.loop !4687

bb.o:                                             ; preds = %.preheader142
  %i.bk = trunc nsw i64 %indvars.iv174 to i32
  %i.bl = getelementptr inbounds nuw i8, ptr %2, i64 %indvars.iv177
  %i.bm = load i8, ptr %i.bl, align 1, !tbaa !17
  %i.bn = add nsw i32 %i.bk, 1
  %i.bo = getelementptr inbounds i8, ptr %3, i64 %indvars.iv174
  %i.bp = load i8, ptr %i.bo, align 1, !tbaa !17
  %.not = icmp eq i8 %i.bm, %i.bp
  %i.bq = fadd double %.050150, 1.000000e+00
  %spec.select = select i1 %.not, double %.050150, double %i.bq
  br label %bb.p

bb.p:                                             ; preds = %bb.o, %.lr.ph153
  %.151 = phi double [ %.050150, %.lr.ph153 ], [ %spec.select, %bb.o ] ; 2 uses
  %.2 = phi i32 [ %.049151, %.lr.ph153 ], [ %i.bn, %bb.o ]
...
.lr.ph158:                                        ; preds = %.preheader, %bb.q
  ...
  %i.br = getelementptr inbounds nuw i8, ptr %2, i64 %indvars.iv181
  %i.bs = load i8, ptr %i.br, align 1, !tbaa !17
  %i.bt = getelementptr inbounds nuw i8, ptr %3, i64 %indvars.iv181
  %i.bu = load i8, ptr %i.bt, align 1, !tbaa !17
  %i.bv = icmp eq i8 %i.bs, %i.bu
  br i1 %i.bv, label %bb.q, label %._crit_edge159.loopexit
...
._crit_edge159.loopexit:                          ; preds = %.lr.ph158, %bb.q
  ...
  %i.bw = tail call i32 @llvm.umin.i32(i32 %.0141.lcssa.ph, i32 4)
  %i.bx = uitofp nneg i32 %i.bw to double
  %i.by = fmul nnan double %i.bx, 1.000000e-01
  br label %._crit_edge159

._crit_edge159:                                   ; preds = %._crit_edge159.loopexit, %.preheader
  %.0141.lcssa = phi double [ 0.000000e+00, %.preheader ], [ %i.by, %._crit_edge159.loopexit ]
  %i.bz = fsub nnan double 1.000000e+00, %i.bb
  %i.ca = fmul double %i.bz, %.0141.lcssa
  %i.cb = fadd double %i.bb, %i.ca
  br label %bb.r

bb.r:                                             ; preds = %._crit_edge159, %._crit_edge154
  %.047 = phi double [ %i.cb, %._crit_edge159 ], [ %i.bb, %._crit_edge154 ]
  %i.cc = fmul double %.047, 1.000000e+02
  %i.cd = tail call double @llvm.round.f64(double %i.cc)
  %i.ce = fdiv double %i.cd, 1.000000e+02
  br label %._crit_edge.thread

._crit_edge.thread:                               ; preds = %_ZNSt6vectorIiSaIiEEC2EmRKiRKS0_.exit79, %._crit_edge, %bb.r
  %storemerge = phi double [ %i.ce, %bb.r ], [ 0.000000e+00, %._crit_edge ], [ 0.000000e+00, %_ZNSt6vectorIiSaIiEEC2EmRKiRKS0_.exit79 ]
...
bb.s:                                             ; preds = %._crit_edge.thread
  %i.cf = ptrtoint ptr %.sroa.0103.0 to i64
  %i.cg = sub i64 %.sroa.11.0, %i.cf
  tail call void @_ZdlPvm(ptr noundef nonnull %.sroa.0103.0, i64 noundef %i.cg) #48
...
bb.t:                                             ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit85
  %i.ch = ptrtoint ptr %.sroa.0109.0 to i64
  %i.ci = sub i64 %.sroa.11114.0, %i.ch
  tail call void @_ZdlPvm(ptr noundef nonnull %.sroa.0109.0, i64 noundef %i.ci) #48
...
.preheader142:                                    ; preds = %.preheader142.preheader, %.preheader142
  ...
  %i.bj = icmp eq i32 %i.bi, 0
  %indvars.iv.next175 = add nsw i64 %indvars.iv174, 1
  br i1 %i.bj, label %.preheader142, label %bb.o, !llvm.loop !4757

bb.o:                                             ; preds = %.preheader142
  %i.bk = trunc nsw i64 %indvars.iv174 to i32
  %i.bl = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %indvars.iv177
  %i.bm = load i32, ptr %i.bl, align 4, !tbaa !3
  %i.bn = add nsw i32 %i.bk, 1
  %i.bo = getelementptr inbounds [4 x i8], ptr %3, i64 %indvars.iv174
  %i.bp = load i32, ptr %i.bo, align 4, !tbaa !3
  %.not = icmp eq i32 %i.bm, %i.bp
  %i.bq = fadd double %.050150, 1.000000e+00
  %spec.select = select i1 %.not, double %.050150, double %i.bq
  br label %bb.p
...
.lr.ph158:                                        ; preds = %.preheader, %bb.q
  %indvars.iv181 = phi i64 [ %indvars.iv.next182, %bb.q ], [ 0, %.preheader ] ; 4 uses
  %i.br = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %indvars.iv181
  %i.bs = load i32, ptr %i.br, align 4, !tbaa !3
  %i.bt = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %indvars.iv181
