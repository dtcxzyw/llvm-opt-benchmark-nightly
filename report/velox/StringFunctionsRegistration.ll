...
.split.us:                                        ; preds = %bb.b, %bb.e
  ...
  %.062.us = phi i64 [ %i.q, %bb.e ], [ 0, %bb.b ] ; 4 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %5 = tail call i64 @llvm.smin.i64(i64 %3, i64 %.062.us)
  %i.n = sub nsw i64 %3, %5
  %i.o = call fastcc noundef i64 @_ZL23utf8proc_decompose_chariPilsS_(i32 noundef %i.j, ptr noundef %i.m, i64 noundef %i.n, i16 noundef signext %4, ptr noundef %i.b) ; 3 uses
...
.split.split.us:                                  ; preds = %.split, %bb.i
  ...
  %.062.us11 = phi i64 [ %i.ac, %bb.i ], [ 0, %.split ] ; 3 uses
...
bb.h:                                             ; preds = %bb.g
  %6 = tail call i64 @llvm.smin.i64(i64 %3, i64 %.062.us11)
  %i.z = sub nsw i64 %3, %6
  %i.aa = call fastcc noundef i64 @_ZL23utf8proc_decompose_chariPilsS_(i32 noundef %i.v, ptr noundef null, i64 noundef %i.z, i16 noundef signext %4, ptr noundef %i.b) ; 3 uses
...
.split.split:                                     ; preds = %.split, %bb.m
  ...
  %.062 = phi i64 [ %i.ap, %bb.m ], [ 0, %.split ] ; 4 uses
...
bb.l:                                             ; preds = %bb.k
  ...
  %7 = tail call i64 @llvm.smin.i64(i64 %3, i64 %.062)
  %i.am = sub nsw i64 %3, %7
  %i.an = call fastcc noundef i64 @_ZL23utf8proc_decompose_chariPilsS_(i32 noundef %i.ah, ptr noundef nonnull %i.al, i64 noundef %i.am, i16 noundef signext %4, ptr noundef %i.b) ; 3 uses
...
.split.us:                                        ; preds = %bb.c, %bb.e
  ...
  %.02328.us = phi i64 [ %i.x, %bb.e ], [ 0, %bb.c ] ; 2 uses
...
_ZL21seqindex_decode_entryPPKt.exit.us:           ; preds = %bb.d, %.split.us
  ...
  %5 = tail call i64 @llvm.smin.i64(i64 %2, i64 %.02328.us)
  %i.v = sub nsw i64 %2, %5
  %i.w = tail call fastcc noundef i64 @_ZL23utf8proc_decompose_chariPilsS_(i32 noundef %.0.i.us, ptr noundef null, i64 noundef %i.v, i16 noundef signext %3, ptr noundef %4)
...
.split:                                           ; preds = %bb.c, %bb.g
  ...
  %.02328 = phi i64 [ %i.ar, %bb.g ], [ 0, %bb.c ] ; 3 uses
...
begin_hunk_9_@_ZL30seqindex_write_char_decomposedtPilsS_:bb.a
  ...
  %6 = tail call i64 @llvm.smin.i64(i64 %2, i64 %.02328)
  %i.ap = sub nsw i64 %2, %6
  %i.aq = tail call fastcc noundef i64 @_ZL23utf8proc_decompose_chariPilsS_(i32 noundef %.0.i, ptr noundef nonnull %i.ao, i64 noundef %i.ap, i16 noundef signext %3, ptr noundef %4)
