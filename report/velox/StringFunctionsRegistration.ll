...
bb.d:                                             ; preds = %bb.c
  ...
  %5 = tail call i64 @llvm.smin.i64(i64 %.062.us, i64 %3)
  %i.n = sub nsw i64 %3, %5
...
bb.h:                                             ; preds = %bb.g
  %6 = tail call i64 @llvm.smin.i64(i64 %.062.us11, i64 %3)
  %i.z = sub nsw i64 %3, %6
...
bb.l:                                             ; preds = %bb.k
  ...
  %7 = tail call i64 @llvm.smin.i64(i64 %.062, i64 %3)
...
_ZL21seqindex_decode_entryPPKt.exit.us:           ; preds = %bb.d, %.split.us
  ...
  %5 = tail call i64 @llvm.smin.i64(i64 %.02328.us, i64 %2)
  %i.v = sub nsw i64 %2, %5
...
_ZL21seqindex_decode_entryPPKt.exit:              ; preds = %.split, %bb.f
  ...
  %6 = tail call i64 @llvm.smin.i64(i64 %.02328, i64 %2)
