...
_ZN4absl12lts_2024011613time_internal4cctz6detail12_GLOBAL__N_112FormatOffsetEPciPKc.exit: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit651, %bb.ef
  ...
  %21 = urem i32 %spec.select.i655, 60
  %22 = udiv i32 %spec.select.i655, 60
  %23 = urem i32 %22, 60
  %.lhs.trunc58.i = trunc nuw nsw i32 %21 to i8   ; 2 uses
  ...
  %.lhs.trunc.i662 = trunc nuw nsw i32 %23 to i8  ; 2 uses
...
bb.ez:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit675, %bb.et
  ...
  %24 = udiv i32 %spec.select.i679, 60
  %25 = insertelement <2 x i32> poison, i32 %spec.select.i679, i64 0
  %26 = insertelement <2 x i32> %25, i32 %24, i64 1
  %27 = urem <2 x i32> %26, splat (i32 60)        ; 3 uses
  %28 = extractelement <2 x i32> %27, i64 0       ; 2 uses
  %.not1050 = icmp eq i32 %28, 0
  br i1 %.not1050, label %bb.fa, label %.thread

.thread:                                          ; preds = %bb.ez
  %.lhs.trunc58.i690 = trunc nuw nsw i32 %28 to i8 ; 2 uses
...
bb.fb:                                            ; preds = %.thread, %bb.fa
  ...
  %30 = bitcast <2 x i32> %27 to <8 x i8>
  %.lhs.trunc.i689 = extractelement <8 x i8> %30, i64 4 ; 2 uses
...
_ZN4absl12lts_2024011613time_internal4cctz6detail12_GLOBAL__N_112FormatOffsetEPciPKc.exit788: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit771, %bb.gj
  ...
  %31 = urem i32 %spec.select.i775, 60
  %32 = udiv i32 %spec.select.i775, 60
  %33 = urem i32 %32, 60
  %.lhs.trunc58.i787 = trunc nuw nsw i32 %31 to i8 ; 2 uses
  ...
  %.lhs.trunc.i786 = trunc nuw nsw i32 %33 to i8  ; 2 uses
