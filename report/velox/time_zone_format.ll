...
.lr.ph1203:                                       ; preds = %.lr.ph, %select.unfold.backedge
  ...
  %.11717811200 = phi ptr [ %.1171.be, %select.unfold.backedge ], [ %.1171.ph824, %.lr.ph ] ; 70 uses
...
bb.p:                                             ; preds = %bb.o
  ...
  %memchr95.i.jt2 = call ptr @memchr(ptr noundef nonnull dereferenceable(1) @_ZN4absl12lts_2024011613time_internal4cctz6detail12_GLOBAL__N_17kDigitsE, i32 %21, i64 11) ; 2 uses
  %.not7396.i.jt2 = icmp eq ptr %memchr95.i.jt2, null
  br i1 %.not7396.i.jt2, label %select.unfold.i325, label %.lr.ph.i322.peel

bb.q:                                             ; preds = %bb.o
  %22 = getelementptr inbounds nuw i8, ptr %.11717811200, i64 1 ; 5 uses
  %.pre.i332 = load i8, ptr %22, align 1, !tbaa !14
  %i.bt = sext i8 %.pre.i332 to i32
  ...
  %25 = sub i32 %24, ptrtoint (ptr @_ZN4absl12lts_2024011613time_internal4cctz6detail12_GLOBAL__N_17kDigitsE to i32) ; 2 uses
  %26 = icmp sgt i32 %25, 9
  %or.cond1141 = or i1 %.not7396.i, %26
  br i1 %or.cond1141, label %select.unfold.i325, label %.fold.split.peel

.lr.ph.i322.peel:                                 ; preds = %bb.p
  ...
  br i1 %i.bx, label %select.unfold.i325, label %.lr.ph.i322.preheader.peel.newph

bb.r:                                             ; preds = %.lr.ph.i322.preheader.peel.newph
  %27 = ptrtoint ptr %memchr.i324 to i64
  %28 = trunc i64 %27 to i32
  %i.by = sub i32 %28, ptrtoint (ptr @_ZN4absl12lts_2024011613time_internal4cctz6detail12_GLOBAL__N_17kDigitsE to i32) ; 2 uses
...
.fold.split.peel:                                 ; preds = %30, %bb.q
  %.0.i3219829921000 = phi ptr [ %.11717811200, %30 ], [ %22, %bb.q ] ; 2 uses
  %.199.i.jt1993999 = phi ptr [ %35, %30 ], [ %22, %bb.q ]
  %.05397.i.jt1994998 = phi i32 [ %31, %30 ], [ 0, %bb.q ] ; 2 uses
  %32 = phi i32 [ %i.by, %30 ], [ %25, %bb.q ]    ; 2 uses
  %33 = or disjoint i32 %32, -2147483648
  %34 = icmp slt i32 %.05397.i.jt1994998, %33
  br i1 %34, label %select.unfold.i325, label %select.unfold.i325.loopexit.loopexit.split.loop.exit1460

.lr.ph.i322.preheader.peel.newph:                 ; preds = %.lr.ph.i322.peel
  %i.bz = sub nsw i32 0, %i.bw                    ; 2 uses
  %35 = getelementptr inbounds nuw i8, ptr %.11717811200, i64 1 ; 4 uses
  %36 = load i8, ptr %35, align 1, !tbaa !14
  %37 = sext i8 %36 to i32
  %memchr.i324 = call ptr @memchr(ptr noundef nonnull dereferenceable(1) @_ZN4absl12lts_2024011613time_internal4cctz6detail12_GLOBAL__N_17kDigitsE, i32 %37, i64 11) ; 2 uses
  %.not73.i = icmp eq ptr %memchr.i324, null
  br i1 %.not73.i, label %select.unfold.i325, label %bb.r

select.unfold.i325.loopexit.loopexit.split.loop.exit1460: ; preds = %.fold.split.peel
  %i.ca = sub nsw i32 %.05397.i.jt1994998, %32
  %i.cb = getelementptr inbounds nuw i8, ptr %.11717811200, i64 2
  br label %select.unfold.i325

select.unfold.i325:                               ; preds = %.lr.ph.i322.preheader.peel.newph, %bb.r, %.fold.split.peel, %.lr.ph.i322.peel, %select.unfold.i325.loopexit.loopexit.split.loop.exit1460, %bb.p, %bb.q
  %.0.i321981 = phi ptr [ %.11717811200, %bb.p ], [ %22, %bb.q ], [ %.0.i3219829921000, %.fold.split.peel ], [ %.0.i3219829921000, %select.unfold.i325.loopexit.loopexit.split.loop.exit1460 ], [ %.11717811200, %bb.r ], [ %.11717811200, %.lr.ph.i322.preheader.peel.newph ], [ %.11717811200, %.lr.ph.i322.peel ]
  %.255.ph.i326 = phi i32 [ 0, %bb.p ], [ 0, %bb.q ], [ -2147483640, %.fold.split.peel ], [ %i.ca, %select.unfold.i325.loopexit.loopexit.split.loop.exit1460 ], [ %i.bz, %bb.r ], [ %i.bz, %.lr.ph.i322.preheader.peel.newph ], [ 0, %.lr.ph.i322.peel ] ; 4 uses
  %.252.ph.not.i327 = phi i1 [ true, %bb.p ], [ true, %bb.q ], [ false, %.fold.split.peel ], [ true, %select.unfold.i325.loopexit.loopexit.split.loop.exit1460 ], [ true, %bb.r ], [ true, %.lr.ph.i322.preheader.peel.newph ], [ true, %.lr.ph.i322.peel ]
  %.3.ph.i328 = phi ptr [ %.11717811200, %bb.p ], [ %22, %bb.q ], [ %.199.i.jt1993999, %.fold.split.peel ], [ %i.cb, %select.unfold.i325.loopexit.loopexit.split.loop.exit1460 ], [ %35, %bb.r ], [ %35, %.lr.ph.i322.preheader.peel.newph ], [ %.11717811200, %.lr.ph.i322.peel ] ; 2 uses
  %i.cc = icmp ne ptr %.3.ph.i328, %.0.i321981
...
bb.e:                                             ; preds = %.fold.split
  ...
  %i.m = sub i32 %3, ptrtoint (ptr @_ZN4absl12lts_2024011613time_internal4cctz6detail12_GLOBAL__N_17kDigitsE to i32) ; 3 uses
...
.fold.split:                                      ; preds = %.fold.split.peel
  ...
  %8 = sext i8 %7 to i32
  %memchr.i = tail call ptr @memchr(ptr noundef nonnull dereferenceable(1) @_ZN4absl12lts_2024011613time_internal4cctz6detail12_GLOBAL__N_17kDigitsE, i32 %8, i64 11) ; 2 uses
