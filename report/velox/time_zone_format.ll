...
.lr.ph1317:                                       ; preds = %.lr.ph, %select.unfold.backedge
  ...
  %.11718121314 = phi ptr [ %.1171.be, %select.unfold.backedge ], [ %.1171.ph855, %.lr.ph ] ; 69 uses
...
bb.n:                                             ; preds = %bb.f
  ...
  %i.br = icmp eq i8 %i.bq, 45                    ; 3 uses
...
bb.p:                                             ; preds = %bb.n
  ...
  br i1 %.not7396.i.jt1, label %select.unfold.i325, label %.lr.ph.i322.jt1

.lr.ph.i322.jt2:                                  ; preds = %bb.o
  %i.bv = ptrtoint ptr %memchr95.i.jt2 to i64
  %i.bw = trunc i64 %i.bv to i32
  %i.bx = sub i32 %i.bw, ptrtoint (ptr @_ZN4absl12lts_2024011613time_internal4cctz6detail12_GLOBAL__N_17kDigitsE to i32) ; 2 uses
  %i.by = icmp sgt i32 %i.bx, 9
  br i1 %i.by, label %select.unfold.i325, label %.fold.split

.lr.ph.i322.jt1:                                  ; preds = %bb.p, %.fold.split
  %.048.i3211041 = phi ptr [ %.11718121314, %.fold.split ], [ %i.bt, %bb.p ] ; 2 uses
  %memchr100.i.jt1 = phi ptr [ %memchr.i324, %.fold.split ], [ %memchr95.i.jt1, %bb.p ]
  %.04299.i.jt1 = phi i32 [ %i.cd, %.fold.split ], [ 0, %bb.p ] ; 2 uses
  %.14998.i.jt1 = phi ptr [ %i.ce, %.fold.split ], [ %i.bt, %bb.p ]
  %i.bz = ptrtoint ptr %memchr100.i.jt1 to i64
  ...
  br i1 %i.cc, label %select.unfold.i325, label %.thread.a

.thread.a:                                        ; preds = %.lr.ph.i322.jt1
  %21 = mul nsw i32 %.04299.i.jt1, 10
  %22 = sub nsw i32 %21, %i.cb
  %23 = getelementptr inbounds nuw i8, ptr %.11718121314, i64 2
  br label %select.unfold.i325

.fold.split:                                      ; preds = %.lr.ph.i322.jt2
  %i.cd = sub nsw i32 0, %i.bx                    ; 2 uses
  %i.ce = getelementptr inbounds nuw i8, ptr %.11718121314, i64 1 ; 3 uses
...
select.unfold.i325:                               ; preds = %.fold.split, %.lr.ph.i322.jt1, %.lr.ph.i322.jt2, %.thread.a, %bb.o, %bb.p
  %.048.i3211040 = phi ptr [ %.11718121314, %bb.o ], [ %i.bt, %bb.p ], [ %.048.i3211041, %.lr.ph.i322.jt1 ], [ %.048.i3211041, %.thread.a ], [ %.11718121314, %.lr.ph.i322.jt2 ], [ %.11718121314, %.fold.split ]
  %.351.ph.i326 = phi ptr [ %.11718121314, %bb.o ], [ %i.bt, %bb.p ], [ %.14998.i.jt1, %.lr.ph.i322.jt1 ], [ %23, %.thread.a ], [ %.11718121314, %.lr.ph.i322.jt2 ], [ %i.ce, %.fold.split ] ; 2 uses
  %.2.ph.i328 = phi i32 [ 0, %bb.o ], [ 0, %bb.p ], [ %.04299.i.jt1, %.lr.ph.i322.jt1 ], [ %22, %.thread.a ], [ 0, %.lr.ph.i322.jt2 ], [ %i.cd, %.fold.split ] ; 3 uses
  %.not1199 = icmp eq ptr %.351.ph.i326, %.048.i3211040
  %i.ch = icmp eq i32 %.2.ph.i328, 0
  %or.cond5.not.i330 = select i1 %i.br, i1 %i.ch, i1 false
  %or.cond80.i = select i1 %.not1199, i1 true, i1 %or.cond5.not.i330
...
.lr.ph.i.jt1:                                     ; preds = %.fold.split
  ...
  %i.o = sub i32 %i.n, ptrtoint (ptr @_ZN4absl12lts_2024011613time_internal4cctz6detail12_GLOBAL__N_17kDigitsE to i32) ; 2 uses
