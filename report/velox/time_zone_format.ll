...
bb.a:
  ...
  %op.rdx = add nsw i64 %21, %reass.mul
  %op.rdx58 = add nsw i64 %op.rdx, %.sext39.neg
  %op.rdx59 = add nsw i64 %op.rdx58, %.neg17.i32.sext.neg ; 5 uses
  %i.w = icmp sgt i64 %i.d, 0
  %i.x = icmp slt i64 %op.rdx59, 0
  %or.cond = select i1 %i.w, i1 %i.x, i1 false
  br i1 %or.cond, label %bb.b, label %bb.c

bb.b:                                             ; preds = %bb.a
  %i.y = add nsw i64 %op.rdx59, 292194
  %i.z = add nsw i64 %i.d, -800
  br label %bb.e

bb.c:                                             ; preds = %bb.a
  %i.aa = icmp slt i64 %i.d, 0
  %i.ab = icmp sgt i64 %op.rdx59, 0
  %or.cond3 = select i1 %i.aa, i1 %i.ab, i1 false
  br i1 %or.cond3, label %bb.d, label %bb.e

bb.d:                                             ; preds = %bb.c
  %i.ac = add nsw i64 %op.rdx59, -292194
  %i.ad = add nsw i64 %i.d, 800
  br label %bb.e

bb.e:                                             ; preds = %bb.c, %bb.d, %bb.b
  %.025 = phi i64 [ %i.z, %bb.b ], [ %i.ad, %bb.d ], [ %i.d, %bb.c ]
  %.0 = phi i64 [ %i.y, %bb.b ], [ %i.ac, %bb.d ], [ %op.rdx59, %bb.c ]
  %i.ae = sdiv i64 %.025, 400
  %i.af = mul nsw i64 %i.ae, 146097
  %i.ag = add nsw i64 %i.af, %.0
  ret i64 %i.ag
}
