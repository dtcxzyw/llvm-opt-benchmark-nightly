...
bb.a:
  ...
  %.sroa.gep133 = getelementptr inbounds nuw i8, ptr %1, i64 4 ; 4 uses
  %i.e = add i32 %.sroa.0326.0.vec.extract333, -4 ; 4 uses
...
.lr.ph263:                                        ; preds = %bb.m
  %i.ew = icmp slt i32 %i.e, 1
  br label %bb.n

bb.n:                                             ; preds = %.lr.ph263, %.loopexit
  %indvars.iv318 = phi i64 [ 0, %.lr.ph263 ], [ %indvars.iv.next319, %.loopexit ] ; 3 uses
  %.073262 = phi ptr [ %2, %.lr.ph263 ], [ %i.gd, %.loopexit ] ; 4 uses
  %indvars323 = trunc i64 %indvars.iv318 to i32   ; 2 uses
  ...
  %i.fd = bitcast <8 x i1> %i.fc to i8
  %i.fe = zext i8 %i.fd to i32                    ; 4 uses
  %i.ff = and i32 %i.fe, 85
  %i.fg = icmp eq i32 %i.ff, 0
  br i1 %i.fg, label %.loopexit, label %.lr.ph246.a

.lr.ph246.a:                                      ; preds = %bb.n
  br i1 %i.d, label %.lr.ph246.split.us.a, label %.lr.ph246.split.a

.lr.ph246.split.us.a:                             ; preds = %.lr.ph246.a, %bb.o
  %.075245.us = phi i32 [ %i.fh, %bb.o ], [ %indvars323, %.lr.ph246.a ] ; 2 uses
  %.085244.us = phi i32 [ %6, %bb.o ], [ %i.fe, %.lr.ph246.a ] ; 2 uses
  %5 = and i32 %.085244.us, 1
  %.not90.us.a = icmp eq i32 %5, 0
  br i1 %.not90.us.a, label %bb.o, label %_ZN8facebook5velox12_GLOBAL__N_118linearSearchSimpleENS0_10StringViewEPKS2_PKii.exit

bb.o:                                             ; preds = %.lr.ph246.split.us.a
  %6 = lshr i32 %.085244.us, 2                    ; 2 uses
  %i.fh = add nuw nsw i32 %.075245.us, 1
  %.not89.us = icmp eq i32 %6, 0
  br i1 %.not89.us, label %.loopexit, label %.lr.ph246.split.us.a, !llvm.loop !46

.lr.ph246.split.a:                                ; preds = %.lr.ph246.a
  br i1 %i.c, label %.lr.ph246.split.split.us.a, label %.lr.ph246.split.split.a

.lr.ph246.split.split.us.a:                       ; preds = %.lr.ph246.split.a, %bb.p
  %.075245.us250 = phi i32 [ %9, %bb.p ], [ %indvars323, %.lr.ph246.split.a ] ; 2 uses
  %.085244.us251 = phi i32 [ %8, %bb.p ], [ %i.fe, %.lr.ph246.split.a ] ; 2 uses
  %7 = and i32 %.085244.us251, 3
  %or.cond265.a = icmp eq i32 %7, 3
  br i1 %or.cond265.a, label %_ZN8facebook5velox12_GLOBAL__N_118linearSearchSimpleENS0_10StringViewEPKS2_PKii.exit, label %bb.p

bb.p:                                             ; preds = %.lr.ph246.split.split.us.a
  %8 = lshr i32 %.085244.us251, 2                 ; 2 uses
  %9 = add nuw nsw i32 %.075245.us250, 1
  %.not89.us253 = icmp eq i32 %8, 0
  br i1 %.not89.us253, label %.loopexit, label %.lr.ph246.split.split.us.a, !llvm.loop !46

.lr.ph246.split.split.a:                          ; preds = %.lr.ph246.split.a, %bb.s
  %indvars.iv320 = phi i64 [ %indvars.iv.next321, %bb.s ], [ %indvars.iv318, %.lr.ph246.split.a ] ; 4 uses
  %.085244 = phi i32 [ %11, %bb.s ], [ %i.fe, %.lr.ph246.split.a ] ; 3 uses
  %10 = and i32 %.085244, 1
  %.not90 = icmp eq i32 %10, 0
  br i1 %.not90, label %bb.s, label %bb.q

bb.q:                                             ; preds = %.lr.ph246.split.split.a
  %i.fi = and i32 %.085244, 3
  %i.fj = icmp eq i32 %i.fi, 3
  %brmerge.a = or i1 %i.fj, %i.ew
  br i1 %brmerge.a, label %_ZN8facebook5velox12_GLOBAL__N_118linearSearchSimpleENS0_10StringViewEPKS2_PKii.exit.loopexit362.a, label %.lr.ph.i99.preheader.a

.lr.ph.i99.preheader.a:                           ; preds = %bb.q
  %i.fk = getelementptr inbounds nuw [16 x i8], ptr %.073262, i64 %indvars.iv320 ; 3 uses
...
.lr.ph.i99:                                       ; preds = %.lr.ph.i99.preheader.a, %bb.r
  ...
  %i.fs = load <32 x i8>, ptr %.01630.i101.a, align 1, !tbaa !20, !noalias !47
  %i.ft = load <32 x i8>, ptr %.01829.i102.a, align 1, !tbaa !20, !noalias !52
  %i.fu = icmp eq <32 x i8> %i.fs, %i.ft
  %i.fv = bitcast <32 x i1> %i.fu to i32          ; 2 uses
  %i.fw = icmp eq i32 %i.fv, -1
  br i1 %i.fw, label %bb.r, label %_ZN8facebook5velox4simd14memEqualUnsafeIN5xsimd4fma3INS3_4avx2EEEEEbPKvS8_i.exit104.a
...
bb.r:                                             ; preds = %.lr.ph.i99
  ...
  br i1 %i.ga, label %.lr.ph.i99, label %_ZN8facebook5velox12_GLOBAL__N_118linearSearchSimpleENS0_10StringViewEPKS2_PKii.exit.loopexit358.a

_ZN8facebook5velox4simd14memEqualUnsafeIN5xsimd4fma3INS3_4avx2EEEEEbPKvS8_i.exit104.a: ; preds = %.lr.ph.i99
  %i.gb = xor i32 %i.fv, -1
  %i.gc = tail call range(i32 0, 33) i32 @llvm.cttz.i32(i32 %i.gb, i1 true)
  %.not161.a = icmp samesign ult i32 %i.gc, %.01431.i100
  br i1 %.not161.a, label %bb.s, label %_ZN8facebook5velox12_GLOBAL__N_118linearSearchSimpleENS0_10StringViewEPKS2_PKii.exit.loopexit362.a

bb.s:                                             ; preds = %.lr.ph246.split.split.a, %_ZN8facebook5velox4simd14memEqualUnsafeIN5xsimd4fma3INS3_4avx2EEEEEbPKvS8_i.exit104.a
  %11 = lshr i32 %.085244, 2                      ; 2 uses
  %indvars.iv.next321 = add nuw nsw i64 %indvars.iv320, 1
  %.not89 = icmp eq i32 %11, 0
  br i1 %.not89, label %.loopexit, label %.lr.ph246.split.split.a, !llvm.loop !46

.loopexit:                                        ; preds = %bb.s, %bb.p, %bb.o, %bb.n
  ...
  br i1 %.not91, label %bb.n, label %.thread157, !llvm.loop !57
...
bb.v:                                             ; preds = %bb.u
  ...
  br i1 %i.gl, label %.thread.loopexit.split.loop.exit.i119.a, label %_ZNK8facebook5velox10StringVieweqERKS1_.exit25.i117
...
bb.w:                                             ; preds = %bb.u
  ...
  br i1 %i.gp, label %.thread.loopexit.split.loop.exit79.i116.a, label %_ZNK8facebook5velox10StringVieweqERKS1_.exit25.thread34.i112
...
_ZNK8facebook5velox10StringVieweqERKS1_.exit25.i117: ; preds = %bb.v
  ...
  br i1 %i.gs, label %.thread.loopexit.split.loop.exit81.i118.a, label %_ZNK8facebook5velox10StringVieweqERKS1_.exit25.thread34.i112
...
_ZNK8facebook5velox10StringVieweqERKS1_.exit25.thread34.i112: ; preds = %_ZNK8facebook5velox10StringVieweqERKS1_.exit25.i117, %bb.w, %bb.t
  ...
  br i1 %exitcond63.not.i114, label %_ZN8facebook5velox12_GLOBAL__N_118linearSearchSimpleENS0_10StringViewEPKS2_PKii.exit, label %bb.t, !llvm.loop !58

.thread.loopexit.split.loop.exit.i119.a:          ; preds = %bb.v
  %i.gt = trunc nuw nsw i64 %indvars.iv59.i110 to i32
  br label %_ZN8facebook5velox12_GLOBAL__N_118linearSearchSimpleENS0_10StringViewEPKS2_PKii.exit

.thread.loopexit.split.loop.exit79.i116.a:        ; preds = %bb.w
  %i.gu = trunc nuw nsw i64 %indvars.iv59.i110 to i32
  br label %_ZN8facebook5velox12_GLOBAL__N_118linearSearchSimpleENS0_10StringViewEPKS2_PKii.exit

.thread.loopexit.split.loop.exit81.i118.a:        ; preds = %_ZNK8facebook5velox10StringVieweqERKS1_.exit25.i117
  %i.gv = trunc nuw nsw i64 %indvars.iv59.i110 to i32
  br label %_ZN8facebook5velox12_GLOBAL__N_118linearSearchSimpleENS0_10StringViewEPKS2_PKii.exit

_ZN8facebook5velox12_GLOBAL__N_118linearSearchSimpleENS0_10StringViewEPKS2_PKii.exit.loopexit358.a: ; preds = %bb.r
  %i.gw = trunc nuw nsw i64 %indvars.iv320 to i32
  br label %_ZN8facebook5velox12_GLOBAL__N_118linearSearchSimpleENS0_10StringViewEPKS2_PKii.exit

_ZN8facebook5velox12_GLOBAL__N_118linearSearchSimpleENS0_10StringViewEPKS2_PKii.exit.loopexit362.a: ; preds = %bb.q, %_ZN8facebook5velox4simd14memEqualUnsafeIN5xsimd4fma3INS3_4avx2EEEEEbPKvS8_i.exit104.a
  %i.gx = trunc nuw nsw i64 %indvars.iv320 to i32
  br label %_ZN8facebook5velox12_GLOBAL__N_118linearSearchSimpleENS0_10StringViewEPKS2_PKii.exit

_ZN8facebook5velox12_GLOBAL__N_118linearSearchSimpleENS0_10StringViewEPKS2_PKii.exit: ; preds = %_ZNK8facebook5velox10StringVieweqERKS1_.exit.thread30.i, %.lr.ph246.split.split.us.a, %.lr.ph246.split.us.a, %_ZNK8facebook5velox10StringVieweqERKS1_.exit25.thread34.i112, %_ZN8facebook5velox12_GLOBAL__N_118linearSearchSimpleENS0_10StringViewEPKS2_PKii.exit.loopexit362.a, %_ZN8facebook5velox12_GLOBAL__N_118linearSearchSimpleENS0_10StringViewEPKS2_PKii.exit.loopexit358.a, %.thread157, %.thread.loopexit.split.loop.exit.i119.a, %.thread.loopexit.split.loop.exit79.i116.a, %.thread.loopexit.split.loop.exit81.i118.a, %_ZN8facebook5velox4simd14memEqualUnsafeIN5xsimd4fma3INS3_4avx2EEEEEbPKvS8_i.exit.thread, %.thread.loopexit69.split.loop.exit73.i, %.thread.loopexit69.split.loop.exit71.i, %.thread.loopexit69.split.loop.exit.i, %.preheader39.i, %.thread143.split.us
  %.13 = phi i32 [ -1, %_ZNK8facebook5velox10StringVieweqERKS1_.exit25.thread34.i112 ], [ %i.y, %.thread143.split.us ], [ %i.dh, %_ZN8facebook5velox4simd14memEqualUnsafeIN5xsimd4fma3INS3_4avx2EEEEEbPKvS8_i.exit.thread ], [ %i.et, %.thread.loopexit69.split.loop.exit73.i ], [ -1, %.preheader39.i ], [ %i.es, %.thread.loopexit69.split.loop.exit71.i ], [ %i.er, %.thread.loopexit69.split.loop.exit.i ], [ %i.gu, %.thread.loopexit.split.loop.exit79.i116.a ], [ %i.gw, %_ZN8facebook5velox12_GLOBAL__N_118linearSearchSimpleENS0_10StringViewEPKS2_PKii.exit.loopexit358.a ], [ %i.gv, %.thread.loopexit.split.loop.exit81.i118.a ], [ -1, %.thread157 ], [ %i.gt, %.thread.loopexit.split.loop.exit.i119.a ], [ %.075245.us250, %.lr.ph246.split.split.us.a ], [ %i.gx, %_ZN8facebook5velox12_GLOBAL__N_118linearSearchSimpleENS0_10StringViewEPKS2_PKii.exit.loopexit362.a ], [ %.075245.us, %.lr.ph246.split.us.a ], [ -1, %_ZNK8facebook5velox10StringVieweqERKS1_.exit.thread30.i ]
  ret i32 %.13
}
...
!46 = distinct !{!46, !14}
!47 = !{!48, !50}
!48 = distinct !{!48, !49, !"_ZN5xsimd6kernel14load_unalignedINS_4fma3INS_4avx2EEEhvEENS_5batchIT0_T_EEPKS6_NS0_7convertIS6_EERKNS_3avxE: argument 0"}
!49 = distinct !{!49, !"_ZN5xsimd6kernel14load_unalignedINS_4fma3INS_4avx2EEEhvEENS_5batchIT0_T_EEPKS6_NS0_7convertIS6_EERKNS_3avxE"}
!50 = distinct !{!50, !51, !"_ZN5xsimd5batchIhNS_4fma3INS_4avx2EEEE14load_unalignedIhEES4_PKT_: argument 0"}
!51 = distinct !{!51, !"_ZN5xsimd5batchIhNS_4fma3INS_4avx2EEEE14load_unalignedIhEES4_PKT_"}
!52 = !{!53, !55}
!53 = distinct !{!53, !54, !"_ZN5xsimd6kernel14load_unalignedINS_4fma3INS_4avx2EEEhvEENS_5batchIT0_T_EEPKS6_NS0_7convertIS6_EERKNS_3avxE: argument 0"}
!54 = distinct !{!54, !"_ZN5xsimd6kernel14load_unalignedINS_4fma3INS_4avx2EEEhvEENS_5batchIT0_T_EEPKS6_NS0_7convertIS6_EERKNS_3avxE"}
!55 = distinct !{!55, !56, !"_ZN5xsimd5batchIhNS_4fma3INS_4avx2EEEE14load_unalignedIhEES4_PKT_: argument 0"}
!56 = distinct !{!56, !"_ZN5xsimd5batchIhNS_4fma3INS_4avx2EEEE14load_unalignedIhEES4_PKT_"}
!57 = distinct !{!57, !14}
!58 = distinct !{!58, !14}
end_hunk_0
