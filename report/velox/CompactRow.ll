...
bb.a:
  %4 = alloca %"class.std::vector.0", align 8     ; 12 uses
...
.noexc8:                                          ; preds = %_ZNSt6vectorImSaImEE17_S_check_init_lenEmRKS0_.exit.i
  ...
  %i.j = tail call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.i) #28 ; 4 uses
...
begin_hunk_2_@_ZN8facebook5velox3row10CompactRow11deserializeERKSt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS7_EERKSt10shared_ptrIKNS0_7RowTypeEEPNS0_6memory10MemoryPoolE:bb.a
  ...
  %7 = load ptr, ptr %4, align 8, !tbaa !81       ; 3 uses
...
bb.p:                                             ; preds = %bb.o
  ...
  %i.bk = sub i64 %10, %i.bj
  call void @_ZdlPvm(ptr noundef nonnull %7, i64 noundef %i.bk) #25
