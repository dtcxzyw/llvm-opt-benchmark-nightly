...
bb.b:                                             ; preds = %bb.a
  %i.d = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.b, i1 true) ; 2 uses
  %i.e = xor i64 %i.d, 63
  %2 = lshr exact i64 -9223372036854775808, %i.d
...
bb.e:                                             ; preds = %_ZN8facebook5velox10raw_vectorIiE12allocateDataEl.exit
  %i.p = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %i.b, i1 true) ; 2 uses
  %i.q = xor i64 %i.p, 63
  %3 = lshr exact i64 -9223372036854775808, %i.p
