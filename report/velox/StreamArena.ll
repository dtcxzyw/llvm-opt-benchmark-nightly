...
_ZNSt6vectorIN8facebook5velox6memory10Allocation7PageRunESaIS4_EEaSEOS6_.exit:
  ...
  %i.m = xor i1 %i.l, %i.k
  br i1 %i.m, label %.noexc, label %bb.c, !prof !30
...
.body:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit, %bb.e
  %eh.lpad-body = phi { ptr, i32 } [ %i.z, %bb.e ], [ %i.q, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit ]
  %i.aa = extractvalue { ptr, i32 } %eh.lpad-body, 0
  call void @__clang_call_terminate(ptr %i.aa) #19
  unreachable
}
