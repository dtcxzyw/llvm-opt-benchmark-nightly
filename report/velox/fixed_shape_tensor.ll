Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/velox/original/fixed_shape_tensor?download=true
inline.NumInlined: 3518
inline.NumDeleted: 1372
loop-unroll.NumCompletelyUnrolled: 31
loop-unroll.NumRuntimeUnrolled: 1
loop-unroll.NumUnrolled: 32
begin_hunk_0_@_ZN5arrow9rapidjson8internal6Grisu2EdPcPiS3_:bb.a
  ...
  store i64 %i.cx, ptr %5, align 8, !tbaa !619
  %i.cy = add i64 %i.cx, %.neg
  call void @_ZN5arrow9rapidjson8internal8DigitGenERKNS1_5DiyFpES4_mPcPiS6_(ptr noundef nonnull align 8 dereferenceable(12) %4, ptr noundef nonnull align 8 dereferenceable(12) %5, i64 noundef %i.cy, ptr noundef %1, ptr noundef %2, ptr noundef nonnull %3)
...
define linkonce_odr noundef ptr @_ZN5arrow9rapidjson8internal8PrettifyEPciii(ptr noundef %0, i32 noundef %1, i32 noundef %2, i32 noundef %3) local_unnamed_addr #15 comdat {
bb.a:
...
.lr.ph128.preheader:                              ; preds = %.preheader
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %scevgep133, i8 48, i64 %i.i, i1 false), !tbaa !21
...
._crit_edge129:                                   ; preds = %.lr.ph128.preheader, %.preheader
  ...
  store i8 46, ptr %i.k, align 1, !tbaa !21
  %i.l = getelementptr i8, ptr %i.k, i64 1
  store i8 48, ptr %i.l, align 1, !tbaa !21
  %i.m = getelementptr i8, ptr %i.k, i64 2
  br label %_ZN5arrow9rapidjson8internal13WriteExponentEiPc.exit
...
bb.c:                                             ; preds = %bb.b
  ...
  store i8 46, ptr %i.s, align 1, !tbaa !21
  %i.v = add nsw i32 %3, %2
...
bb.e:                                             ; preds = %.lr.ph125
  ...
  br i1 %.not108, label %.lr.ph125, label %._crit_edge126, !llvm.loop !621
...
bb.h:                                             ; preds = %bb.g
  ...
  store i8 48, ptr %0, align 1, !tbaa !21
...
.lr.ph.preheader:                                 ; preds = %bb.h
  ...
  tail call void @llvm.memset.p0.i64(ptr align 1 %scevgep, i8 48, i64 %i.as, i1 false), !tbaa !21
  br label %._crit_edge
...
bb.j:                                             ; preds = %.lr.ph121
  ...
  br i1 %i.ax, label %.loopexit142, label %.lr.ph121, !llvm.loop !622
...
bb.m:                                             ; preds = %bb.l
  ...
  store i8 46, ptr %i.bi, align 1, !tbaa !21
  %i.bj = getelementptr inbounds nuw i8, ptr %0, i64 2
  store i8 48, ptr %i.bj, align 1, !tbaa !21
...
bb.o:                                             ; preds = %bb.n
  ...
  store i8 101, ptr %i.bm, align 1, !tbaa !21
...
bb.p:                                             ; preds = %bb.o
  ...
  store i8 45, ptr %i.bn, align 1, !tbaa !21
  %i.bq = sub i32 1, %i.a
  br label %bb.q
...
bb.r:                                             ; preds = %bb.q
  ...
  store i8 %i.bu, ptr %.020.i, align 1, !tbaa !21
  %i.bw = urem i32 %.0.i, 100
  %i.bx = shl nuw nsw i32 %i.bw, 1
  %i.by = zext nneg i32 %i.bx to i64
  %i.bz = getelementptr inbounds nuw i8, ptr @_ZZN5arrow9rapidjson8internal12GetDigitsLutEvE10cDigitsLut, i64 %i.by ; 2 uses
  %i.ca = load i8, ptr %i.bz, align 2, !tbaa !21
  %i.cb = getelementptr inbounds nuw i8, ptr %.020.i, i64 2
  store i8 %i.ca, ptr %i.bv, align 1, !tbaa !21
...
bb.t:                                             ; preds = %bb.s
  ...
  %i.ci = getelementptr inbounds nuw i8, ptr @_ZZN5arrow9rapidjson8internal12GetDigitsLutEvE10cDigitsLut, i64 %i.ch ; 2 uses
  %i.cj = load i8, ptr %i.ci, align 2, !tbaa !21
  %i.ck = getelementptr inbounds nuw i8, ptr %.020.i, i64 1
  store i8 %i.cj, ptr %.020.i, align 1, !tbaa !21
...
bb.u:                                             ; preds = %bb.s
  ...
  store i8 %i.cp, ptr %.020.i, align 1, !tbaa !21
  br label %_ZN5arrow9rapidjson8internal13WriteExponentEiPc.exit
...
bb.w:                                             ; preds = %bb.v
  ...
  store i8 45, ptr %i.cy, align 1, !tbaa !21
  %i.db = sub i32 1, %i.a
  br label %bb.x
...
bb.y:                                             ; preds = %bb.x
  ...
  store i8 %i.df, ptr %.020.i109, align 1, !tbaa !21
  %i.dh = urem i32 %.0.i110, 100
  %i.di = shl nuw nsw i32 %i.dh, 1
  %i.dj = zext nneg i32 %i.di to i64
  %i.dk = getelementptr inbounds nuw i8, ptr @_ZZN5arrow9rapidjson8internal12GetDigitsLutEvE10cDigitsLut, i64 %i.dj ; 2 uses
  %i.dl = load i8, ptr %i.dk, align 2, !tbaa !21
  %i.dm = getelementptr inbounds nuw i8, ptr %.020.i109, i64 2
  store i8 %i.dl, ptr %i.dg, align 1, !tbaa !21
...
bb.aa:                                            ; preds = %bb.z
  ...
  %i.dt = getelementptr inbounds nuw i8, ptr @_ZZN5arrow9rapidjson8internal12GetDigitsLutEvE10cDigitsLut, i64 %i.ds ; 2 uses
  %i.du = load i8, ptr %i.dt, align 2, !tbaa !21
  %i.dv = getelementptr inbounds nuw i8, ptr %.020.i109, i64 1
  store i8 %i.du, ptr %.020.i109, align 1, !tbaa !21
  ...
  store i8 %i.dx, ptr %i.dv, align 1, !tbaa !21
  br label %_ZN5arrow9rapidjson8internal13WriteExponentEiPc.exit
...
bb.ab:                                            ; preds = %bb.z
  ...
  store i8 %i.ea, ptr %.020.i109, align 1, !tbaa !21
  br label %_ZN5arrow9rapidjson8internal13WriteExponentEiPc.exit

_ZN5arrow9rapidjson8internal13WriteExponentEiPc.exit: ; preds = %.loopexit142, %.loopexit, %bb.ab, %bb.aa, %bb.y, %bb.u, %bb.t, %bb.r, %.thread, %bb.k, %bb.m, %bb.f, %._crit_edge126, %._crit_edge129
...
; Function Attrs: inlinehint mustprogress uwtable
define linkonce_odr void @_ZN5arrow9rapidjson8internal8DigitGenERKNS1_5DiyFpES4_mPcPiS6_(ptr noundef nonnull align 8 dereferenceable(12) %0, ptr noundef nonnull align 8 dereferenceable(12) %1, i64 noundef %2, ptr noundef %3, ptr noundef %4, ptr noundef %5) local_unnamed_addr #15 comdat {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.b = load i32, ptr %i.a, align 8, !tbaa !623
  %i.c = sub nsw i32 0, %i.b
  %i.d = zext nneg i32 %i.c to i64                ; 5 uses
  %i.e = shl nuw i64 1, %i.d                      ; 4 uses
  %i.f = load i64, ptr %1, align 8, !tbaa !619    ; 3 uses
  %i.g = load i64, ptr %0, align 8, !tbaa !619
  ...
  br i1 %i.m, label %_ZN5arrow9rapidjson8internal19CountDecimalDigit32Ej.exit, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.n = icmp ult i32 %i.j, 100
  br i1 %i.n, label %_ZN5arrow9rapidjson8internal19CountDecimalDigit32Ej.exit, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.o = icmp ult i32 %i.j, 1000
  br i1 %i.o, label %_ZN5arrow9rapidjson8internal19CountDecimalDigit32Ej.exit, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.p = icmp ult i32 %i.j, 10000
  br i1 %i.p, label %_ZN5arrow9rapidjson8internal19CountDecimalDigit32Ej.exit, label %bb.e
