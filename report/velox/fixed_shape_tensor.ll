...
bb.m:                                             ; preds = %bb.l
  %i.au = sub nuw nsw i64 %i.as, %i.z             ; 2 uses
  %i.av = icmp samesign ult i64 %i.z, 1152921504606846976
  tail call void @llvm.assume(i1 %i.av)
  %13 = icmp ugt i64 %i.as, 1152921504606846975
  br i1 %13, label %bb.n, label %_ZNKSt6vectorIlSaIlEE12_M_check_lenEmPKc.exit.i
...
begin_hunk_3_@_ZNK5arrow9extension21FixedShapeTensorArray8ToTensorEv:bb.a
  ...
  %i.ad = sub i64 %i.ab, %i.ac                    ; 11 uses
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %6, i8 0, i64 24, i1 false)
...
begin_hunk_4_@_ZNK5arrow9extension21FixedShapeTensorArray8ToTensorEv:bb.a
  ...
  %i.bl = add nsw i64 %i.bk, 1                    ; 5 uses
  %i.bm = icmp ugt i64 %i.bl, %i.ad
  br i1 %i.bm, label %bb.l, label %_ZNSt6vectorIlSaIlEE6resizeEm.exit

bb.l:                                             ; preds = %bb.k
  %i.bn = sub nuw nsw i64 %i.bl, %i.ad            ; 2 uses
  %i.bo = icmp samesign ult i64 %i.ad, 1152921504606846976
  tail call void @llvm.assume(i1 %i.bo)
  %15 = icmp ugt i64 %i.bl, 1152921504606846975
  br i1 %15, label %bb.m, label %_ZNKSt6vectorIlSaIlEE12_M_check_lenEmPKc.exit.i
