...
._crit_edge.i:                                    ; preds = %.lr.ph.i, %middle.block, %bb.a
  %.023.lcssa.i = phi ptr [ %2, %bb.a ], [ %i.s, %middle.block ], [ %i.aol, %.lr.ph.i ] ; 5 uses
...
begin_hunk_1_@_ZN5folly6detail13base64_detail21base64URLEncodeScalarEPKcS3_Pc:bb.a
  ...
  %i.aov = getelementptr inbounds nuw i8, ptr %.023.lcssa.i, i64 1
...
3:                                                ; preds = %bb.d, %bb.c
  %.sink.i.i = phi i8 [ %i.apb, %bb.c ], [ %i.apl, %bb.d ]
  %.pn.i.i = phi i64 [ 2, %bb.c ], [ 3, %bb.d ]
  store i8 %.sink.i.i, ptr %i.aov, align 1, !tbaa !18
  %.0.i.i = getelementptr inbounds nuw i8, ptr %.023.lcssa.i, i64 %.pn.i.i
  br label %_ZN5folly6detail13base64_detail16Base64ScalarImplILb1EE6encodeEPKcS5_Pc.exit

_ZN5folly6detail13base64_detail16Base64ScalarImplILb1EE6encodeEPKcS5_Pc.exit: ; preds = %3, %._crit_edge.i
  %.1.i.i = phi ptr [ %.0.i.i, %3 ], [ %.023.lcssa.i, %._crit_edge.i ]
  ret ptr %.1.i.i
}
