...
begin_hunk_0_@_ZN5folly11AsyncSocket18drainZeroCopyQueueEv:bb.a
  %i.gg = call noundef i64 %i.gf(i32 noundef 1, ptr noundef nonnull align 16 dereferenceable(64) %6, ptr noundef null) #41, !inline_history !15618 ; 0 uses
  br label %_ZNSt6vectorISt10unique_ptrIN5folly5IOBufESt14default_deleteIS2_EESaIS5_EED2Ev.exit

_ZNSt6vectorISt10unique_ptrIN5folly5IOBufESt14default_deleteIS2_EESaIS5_EED2Ev.exit: ; preds = %bb.z, %bb.aa
