...
bb.d:                                             ; preds = %bb.c
  %8 = load i32, ptr %i.r, align 1
  %9 = load i32, ptr %i.t, align 1
  %10 = tail call i32 @llvm.bswap.i32(i32 %8)
  %11 = tail call i32 @llvm.bswap.i32(i32 %9)
  %12 = tail call i32 @llvm.ucmp.i32.i32(i32 %10, i32 %11)
...
_ZNK8facebook5velox10StringViewssERKS1_.exit:     ; preds = %bb.d, %bb.f, %bb.h, %bb.i
  %.1.i.i = phi i32 [ %12, %bb.d ], [ %i.aa, %bb.f ], [ %i.ai, %bb.h ], [ %i.ap, %bb.i ]
