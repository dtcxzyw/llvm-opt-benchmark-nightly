...
.preheader67.i:                                   ; preds = %bb.s, %_ZNK8facebook5velox13DecodedVector5indexEi.exit19
  %.055.lcssa.i = phi i64 [ 0, %_ZNK8facebook5velox13DecodedVector5indexEi.exit19 ], [ %i.hz, %bb.s ] ; 2 uses
  %.0.lcssa.i = phi i64 [ 0, %_ZNK8facebook5velox13DecodedVector5indexEi.exit19 ], [ %i.ib, %bb.s ] ; 2 uses
  %i.fg = icmp ugt i64 %i.et, %.055.lcssa.i
...
bb.p:                                             ; preds = %_ZZN8facebook5velox9functions12_GLOBAL__N_118MapZipWithFunction21mergeScalarNoNullKeysILNS0_8TypeKindE0EEEiRKNS0_17SelectivityVectorERKNS2_13DecodedInputsERNS2_12MergeResultsEENKUlT_T0_E0_clIiiEEDaSE_SF_.exit.i
  ...
  %i.go = add nsw i32 %.05568.i, 1
  %i.gp = add nsw i32 %.069.i, 1
  br label %bb.s
...
bb.r:                                             ; preds = %_ZStssIiiQaant15__is_optional_vIT0_E25three_way_comparable_withIS0_T_EENSt8__detail18__cmp3way_res_implIS1_S0_E4typeERKSt8optionalIS1_ERKS0_.exit.i
  ...
  %i.hw = add nsw i32 %.069.i, 1
  br label %bb.s

bb.s:                                             ; preds = %bb.r, %bb.q, %bb.p
  %.156.i = phi i32 [ %i.go, %bb.p ], [ %i.hg, %bb.q ], [ %.05568.i, %bb.r ] ; 2 uses
  %.1.i = phi i32 [ %i.gp, %bb.p ], [ %.069.i, %bb.q ], [ %i.hw, %bb.r ] ; 2 uses
  %i.hx = load i32, ptr %i.em, align 4, !tbaa !44
  %i.hy = add nsw i32 %i.hx, 1
  store i32 %i.hy, ptr %i.em, align 4, !tbaa !44
  %i.hz = sext i32 %.156.i to i64                 ; 3 uses
  %i.ia = icmp ugt i64 %i.et, %i.hz
  %i.ib = sext i32 %.1.i to i64                   ; 3 uses
...
.preheader.i:                                     ; preds = %.lr.ph72.i, %.preheader67.i
  %i.ie = icmp ugt i64 %i.fa, %.0.lcssa.i
...
.lr.ph72.i:                                       ; preds = %.lr.ph72.i, %.lr.ph72.preheader.i
  ...
  %indvars.iv.i = phi i64 [ %.055.lcssa.i, %.lr.ph72.preheader.i ], [ %indvars.iv.next.i, %.lr.ph72.i ] ; 2 uses
...
.lr.ph74.i:                                       ; preds = %.lr.ph74.i, %.lr.ph74.preheader.i
  ...
  %indvars.iv76.i = phi i64 [ %.0.lcssa.i, %.lr.ph74.preheader.i ], [ %indvars.iv.next77.i, %.lr.ph74.i ] ; 2 uses
...
.preheader65.i:                                   ; preds = %bb.s, %_ZNK8facebook5velox13DecodedVector5indexEi.exit19
  %.055.lcssa.i = phi i64 [ 0, %_ZNK8facebook5velox13DecodedVector5indexEi.exit19 ], [ %i.ij, %bb.s ] ; 2 uses
  %.0.lcssa.i = phi i64 [ 0, %_ZNK8facebook5velox13DecodedVector5indexEi.exit19 ], [ %i.il, %bb.s ] ; 2 uses
  %i.fg = icmp ugt i64 %i.et, %.055.lcssa.i
...
bb.p:                                             ; preds = %_ZZN8facebook5velox9functions12_GLOBAL__N_118MapZipWithFunction21mergeScalarNoNullKeysILNS0_8TypeKindE0EEEiRKNS0_17SelectivityVectorERKNS2_13DecodedInputsERNS2_12MergeResultsEENKUlT_T0_E1_clIiiEEDaSE_SF_.exit.i
  ...
  %i.gy = add nsw i32 %.05566.i, 1
  %i.gz = add nsw i32 %.067.i, 1
  br label %bb.s
...
bb.r:                                             ; preds = %_ZStssIiiQaant15__is_optional_vIT0_E25three_way_comparable_withIS0_T_EENSt8__detail18__cmp3way_res_implIS1_S0_E4typeERKSt8optionalIS1_ERKS0_.exit.i
  ...
  %i.ig = add nsw i32 %.067.i, 1
  br label %bb.s

bb.s:                                             ; preds = %bb.r, %bb.q, %bb.p
  %.156.i = phi i32 [ %i.gy, %bb.p ], [ %i.hq, %bb.q ], [ %.05566.i, %bb.r ] ; 2 uses
  %.1.i = phi i32 [ %i.gz, %bb.p ], [ %.067.i, %bb.q ], [ %i.ig, %bb.r ] ; 2 uses
  %i.ih = load i32, ptr %i.em, align 4, !tbaa !44
  %i.ii = add nsw i32 %i.ih, 1
  store i32 %i.ii, ptr %i.em, align 4, !tbaa !44
  %i.ij = sext i32 %.156.i to i64                 ; 3 uses
  %i.ik = icmp ugt i64 %i.et, %i.ij
  %i.il = sext i32 %.1.i to i64                   ; 3 uses
...
.preheader.i:                                     ; preds = %.lr.ph70.i, %.preheader65.i
  %i.io = icmp ugt i64 %i.fa, %.0.lcssa.i
...
.lr.ph70.i:                                       ; preds = %.lr.ph70.i, %.lr.ph70.preheader.i
  ...
  %indvars.iv.i = phi i64 [ %.055.lcssa.i, %.lr.ph70.preheader.i ], [ %indvars.iv.next.i, %.lr.ph70.i ] ; 2 uses
...
.lr.ph72.i:                                       ; preds = %.lr.ph72.i, %.lr.ph72.preheader.i
  ...
  %indvars.iv74.i = phi i64 [ %.0.lcssa.i, %.lr.ph72.preheader.i ], [ %indvars.iv.next75.i, %.lr.ph72.i ] ; 2 uses
