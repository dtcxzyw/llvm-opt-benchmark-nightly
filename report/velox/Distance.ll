...
bb.r:                                             ; preds = %bb.q
  %i.cw = fsub <2 x double> %i.c, %i.i            ; 2 uses
  %6 = shufflevector <2 x double> %i.cw, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.cx = fmul <2 x double> %i.co, %6
  %i.cy = shufflevector <2 x double> %i.cw, <2 x double> poison, <2 x i32> zeroinitializer
  %i.cz = fmul <2 x double> %i.cr, %i.cy
  %i.da = fsub <2 x double> %i.cx, %i.cz
  %i.db = shufflevector <2 x double> %foldExtExtBinop159, <2 x double> poison, <2 x i32> zeroinitializer
  %i.dc = fdiv <2 x double> %i.da, %i.db
  %7 = shufflevector <2 x double> %i.dc, <2 x double> poison, <4 x i32> <i32 1, i32 0, i32 1, i32 0> ; 2 uses
  %i.dd = fcmp ogt <4 x double> %7, <double 1.000000e+00, double 1.000000e+00, double 0.000000e+00, double 0.000000e+00>
  %i.de = fcmp olt <4 x double> %7, <double 1.000000e+00, double 1.000000e+00, double 0.000000e+00, double 0.000000e+00>
  %i.df = shufflevector <4 x i1> %i.dd, <4 x i1> %i.de, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %i.dg = bitcast <4 x i1> %i.df to i4
  %.not = icmp eq i4 %i.dg, 0
...
_ZN4geos4geom8Envelope10intersectsERKNS0_10CoordinateES4_S4_S4_.exit.thread: ; preds = %bb.o, %bb.p, %bb.r, %bb.q, %_ZN4geos4geom8Envelope10intersectsERKNS0_10CoordinateES4_S4_S4_.exit
  %foldExtExtBinop161 = fsub <2 x double> %i.c, %i.i ; 4 uses
  %i.dh = extractelement <2 x double> %foldExtExtBinop161, i64 0
  %foldExtExtBinop163 = fsub <2 x double> %i.j, %i.i ; 5 uses
  %i.di = extractelement <2 x double> %foldExtExtBinop163, i64 0 ; 2 uses
  %foldExtExtBinop165 = fmul <2 x double> %foldExtExtBinop161, %foldExtExtBinop163
  %i.dj = extractelement <2 x double> %foldExtExtBinop165, i64 0
  %i.dk = fsub double %4, %5                      ; 4 uses
  %i.dl = fsub double %i.k, %5                    ; 6 uses
  %i.dm = fmul double %i.dk, %i.dl
  %i.dn = fadd double %i.dj, %i.dm
  %foldExtExtBinop167 = fmul <2 x double> %foldExtExtBinop163, %foldExtExtBinop163
  %i.do = extractelement <2 x double> %foldExtExtBinop167, i64 0
  %i.dp = fmul double %i.dl, %i.dl
  %i.dq = fadd double %i.do, %i.dp                ; 6 uses
  %i.dr = fdiv double %i.dn, %i.dq                ; 2 uses
...
bb.s:                                             ; preds = %_ZN4geos4geom8Envelope10intersectsERKNS0_10CoordinateES4_S4_S4_.exit.thread
  %foldExtExtBinop169 = fmul <2 x double> %foldExtExtBinop161, %foldExtExtBinop161
  %i.dt = extractelement <2 x double> %foldExtExtBinop169, i64 0
  %i.du = fmul double %i.dk, %i.dk
  %i.dv = fadd double %i.dt, %i.du
  %sqrt.i53.i77 = tail call noundef double @llvm.sqrt.f64(double %i.dv)
  br label %bb.w

bb.t:                                             ; preds = %_ZN4geos4geom8Envelope10intersectsERKNS0_10CoordinateES4_S4_S4_.exit.thread
  %i.dw = fcmp ult double %i.dr, 1.000000e+00
  br i1 %i.dw, label %bb.v, label %bb.u

bb.u:                                             ; preds = %bb.t
  %foldExtExtBinop171 = fsub <2 x double> %i.c, %i.j ; 2 uses
  %i.dx = fsub double %4, %i.k                    ; 2 uses
  %foldExtExtBinop173 = fmul <2 x double> %foldExtExtBinop171, %foldExtExtBinop171
  %i.dy = extractelement <2 x double> %foldExtExtBinop173, i64 0
  %i.dz = fmul double %i.dx, %i.dx
  %i.ea = fadd double %i.dy, %i.dz
  %sqrt.i54.i79 = tail call noundef double @llvm.sqrt.f64(double %i.ea)
  br label %bb.w

bb.v:                                             ; preds = %bb.t
  %i.eb = fsub double %5, %4
  %i.ec = fmul double %i.di, %i.eb
  %foldExtExtBinop175 = fsub <2 x double> %i.i, %i.c
  %i.ed = extractelement <2 x double> %foldExtExtBinop175, i64 0
  %i.ee = fmul double %i.ed, %i.dl
  %i.ef = fsub double %i.ec, %i.ee
  %i.eg = fdiv double %i.ef, %i.dq
  %i.eh = tail call double @llvm.fabs.f64(double %i.eg)
  %sqrt.i80 = tail call double @llvm.sqrt.f64(double %i.dq)
  %i.ei = fmul double %sqrt.i80, %i.eh
  br label %bb.w

bb.w:                                             ; preds = %bb.v, %bb.u, %bb.s
  %.1.i78 = phi double [ %i.ei, %bb.v ], [ %sqrt.i53.i77, %bb.s ], [ %sqrt.i54.i79, %bb.u ] ; 2 uses
  %foldExtExtBinop177 = fsub <2 x double> %i.d, %i.i ; 3 uses
  %foldExtExtBinop179 = fmul <2 x double> %foldExtExtBinop177, %foldExtExtBinop163
  %i.ej = extractelement <2 x double> %foldExtExtBinop179, i64 0
  %i.ek = fsub double %i.e, %5                    ; 3 uses
  %i.el = fmul double %i.ek, %i.dl
  %i.em = fadd double %i.ej, %i.el
  %i.en = fdiv double %i.em, %i.dq                ; 2 uses
  %i.eo = fcmp ugt double %i.en, 0.000000e+00
  br i1 %i.eo, label %bb.y, label %bb.x

bb.x:                                             ; preds = %bb.w
  %foldExtExtBinop181 = fmul <2 x double> %foldExtExtBinop177, %foldExtExtBinop177
  %i.ep = extractelement <2 x double> %foldExtExtBinop181, i64 0
  %i.eq = fmul double %i.ek, %i.ek
  %i.er = fadd double %i.ep, %i.eq
  %sqrt.i53.i84 = tail call noundef double @llvm.sqrt.f64(double %i.er)
  br label %bb.ab

bb.y:                                             ; preds = %bb.w
  %i.es = fcmp ult double %i.en, 1.000000e+00
  br i1 %i.es, label %bb.aa, label %bb.z

bb.z:                                             ; preds = %bb.y
  %foldExtExtBinop183 = fsub <2 x double> %i.d, %i.j ; 2 uses
  %i.et = fsub double %i.e, %i.k                  ; 2 uses
  %foldExtExtBinop185 = fmul <2 x double> %foldExtExtBinop183, %foldExtExtBinop183
  %i.eu = extractelement <2 x double> %foldExtExtBinop185, i64 0
  %i.ev = fmul double %i.et, %i.et
  %i.ew = fadd double %i.eu, %i.ev
  %sqrt.i54.i86 = tail call noundef double @llvm.sqrt.f64(double %i.ew)
  br label %bb.ab

bb.aa:                                            ; preds = %bb.y
  %i.ex = fsub double %5, %i.e
  %i.ey = fmul double %i.di, %i.ex
  %foldExtExtBinop187 = fsub <2 x double> %i.i, %i.d
  %i.ez = extractelement <2 x double> %foldExtExtBinop187, i64 0
  %i.fa = fmul double %i.ez, %i.dl
  %i.fb = fsub double %i.ey, %i.fa
  %i.fc = fdiv double %i.fb, %i.dq
  %i.fd = tail call double @llvm.fabs.f64(double %i.fc)
  %sqrt.i87 = tail call double @llvm.sqrt.f64(double %i.dq)
  %i.fe = fmul double %sqrt.i87, %i.fd
  br label %bb.ab

bb.ab:                                            ; preds = %bb.aa, %bb.z, %bb.x
  %.1.i85 = phi double [ %i.fe, %bb.aa ], [ %sqrt.i53.i84, %bb.x ], [ %sqrt.i54.i86, %bb.z ] ; 2 uses
  %foldExtExtBinop189 = fsub <2 x double> %i.i, %i.c ; 3 uses
  %foldExtExtBinop191 = fsub <2 x double> %i.d, %i.c ; 5 uses
  %i.ff = extractelement <2 x double> %foldExtExtBinop191, i64 0 ; 2 uses
  %foldExtExtBinop193 = fmul <2 x double> %foldExtExtBinop191, %foldExtExtBinop189
  %i.fg = extractelement <2 x double> %foldExtExtBinop193, i64 0
  %i.fh = fsub double %5, %4                      ; 3 uses
  %i.fi = fsub double %i.e, %4                    ; 6 uses
  %i.fj = fmul double %i.fi, %i.fh
  %i.fk = fadd double %i.fg, %i.fj
  %foldExtExtBinop195 = fmul <2 x double> %foldExtExtBinop191, %foldExtExtBinop191
  %i.fl = extractelement <2 x double> %foldExtExtBinop195, i64 0
  %i.fm = fmul double %i.fi, %i.fi
  %i.fn = fadd double %i.fl, %i.fm                ; 6 uses
  %i.fo = fdiv double %i.fk, %i.fn                ; 2 uses
  %i.fp = fcmp ugt double %i.fo, 0.000000e+00
  br i1 %i.fp, label %bb.ad, label %bb.ac

bb.ac:                                            ; preds = %bb.ab
  %foldExtExtBinop197 = fmul <2 x double> %foldExtExtBinop189, %foldExtExtBinop189
  %i.fq = extractelement <2 x double> %foldExtExtBinop197, i64 0
  %i.fr = fmul double %i.fh, %i.fh
  %i.fs = fadd double %i.fq, %i.fr
  %sqrt.i53.i91 = tail call noundef double @llvm.sqrt.f64(double %i.fs)
  br label %bb.ag

bb.ad:                                            ; preds = %bb.ab
  %i.ft = fcmp ult double %i.fo, 1.000000e+00
  br i1 %i.ft, label %bb.af, label %bb.ae

bb.ae:                                            ; preds = %bb.ad
  %foldExtExtBinop199 = fsub <2 x double> %i.i, %i.d ; 2 uses
  %i.fu = fsub double %5, %i.e                    ; 2 uses
  %foldExtExtBinop201 = fmul <2 x double> %foldExtExtBinop199, %foldExtExtBinop199
  %i.fv = extractelement <2 x double> %foldExtExtBinop201, i64 0
  %i.fw = fmul double %i.fu, %i.fu
  %i.fx = fadd double %i.fv, %i.fw
  %sqrt.i54.i93 = tail call noundef double @llvm.sqrt.f64(double %i.fx)
  br label %bb.ag

bb.af:                                            ; preds = %bb.ad
  %i.fy = fmul double %i.ff, %i.dk
  %i.fz = fmul double %i.fi, %i.dh
  %i.ga = fsub double %i.fy, %i.fz
  %i.gb = fdiv double %i.ga, %i.fn
  %i.gc = tail call double @llvm.fabs.f64(double %i.gb)
  %sqrt.i94 = tail call double @llvm.sqrt.f64(double %i.fn)
  %i.gd = fmul double %sqrt.i94, %i.gc
  br label %bb.ag

bb.ag:                                            ; preds = %bb.af, %bb.ae, %bb.ac
  %.1.i92 = phi double [ %i.gd, %bb.af ], [ %sqrt.i53.i91, %bb.ac ], [ %sqrt.i54.i93, %bb.ae ] ; 2 uses
  %foldExtExtBinop203 = fsub <2 x double> %i.j, %i.c ; 3 uses
  %foldExtExtBinop205 = fmul <2 x double> %foldExtExtBinop191, %foldExtExtBinop203
  %i.ge = extractelement <2 x double> %foldExtExtBinop205, i64 0
  %i.gf = fsub double %i.k, %4                    ; 3 uses
  %i.gg = fmul double %i.fi, %i.gf
  %i.gh = fadd double %i.ge, %i.gg
  %i.gi = fdiv double %i.gh, %i.fn                ; 2 uses
  %i.gj = fcmp ugt double %i.gi, 0.000000e+00
  br i1 %i.gj, label %bb.ai, label %bb.ah

bb.ah:                                            ; preds = %bb.ag
  %foldExtExtBinop207 = fmul <2 x double> %foldExtExtBinop203, %foldExtExtBinop203
  %i.gk = extractelement <2 x double> %foldExtExtBinop207, i64 0
  %i.gl = fmul double %i.gf, %i.gf
  %i.gm = fadd double %i.gk, %i.gl
  %sqrt.i53.i98 = tail call noundef double @llvm.sqrt.f64(double %i.gm)
  br label %_ZN4geos9algorithm8Distance14pointToSegmentERKNS_4geom10CoordinateES5_S5_.exit103

bb.ai:                                            ; preds = %bb.ag
  %i.gn = fcmp ult double %i.gi, 1.000000e+00
  br i1 %i.gn, label %bb.ak, label %bb.aj

bb.aj:                                            ; preds = %bb.ai
  %foldExtExtBinop209 = fsub <2 x double> %i.j, %i.d ; 2 uses
  %i.go = fsub double %i.k, %i.e                  ; 2 uses
  %foldExtExtBinop211 = fmul <2 x double> %foldExtExtBinop209, %foldExtExtBinop209
  %i.gp = extractelement <2 x double> %foldExtExtBinop211, i64 0
  %i.gq = fmul double %i.go, %i.go
  %i.gr = fadd double %i.gp, %i.gq
  %sqrt.i54.i100 = tail call noundef double @llvm.sqrt.f64(double %i.gr)
  br label %_ZN4geos9algorithm8Distance14pointToSegmentERKNS_4geom10CoordinateES5_S5_.exit103

bb.ak:                                            ; preds = %bb.ai
  %i.gs = fsub double %4, %i.k
  %i.gt = fmul double %i.ff, %i.gs
  %foldExtExtBinop213 = fsub <2 x double> %i.c, %i.j
  %i.gu = extractelement <2 x double> %foldExtExtBinop213, i64 0
  %i.gv = fmul double %i.fi, %i.gu
  %i.gw = fsub double %i.gt, %i.gv
  %i.gx = fdiv double %i.gw, %i.fn
  %i.gy = tail call double @llvm.fabs.f64(double %i.gx)
  %sqrt.i101 = tail call double @llvm.sqrt.f64(double %i.fn)
  %i.gz = fmul double %sqrt.i101, %i.gy
  br label %_ZN4geos9algorithm8Distance14pointToSegmentERKNS_4geom10CoordinateES5_S5_.exit103

_ZN4geos9algorithm8Distance14pointToSegmentERKNS_4geom10CoordinateES5_S5_.exit103: ; preds = %bb.ah, %bb.aj, %bb.ak
  %.1.i99 = phi double [ %i.gz, %bb.ak ], [ %sqrt.i53.i98, %bb.ah ], [ %sqrt.i54.i100, %bb.aj ] ; 2 uses
  %i.ha = fcmp olt double %.1.i99, %.1.i92
  %i.hb = select i1 %i.ha, double %.1.i99, double %.1.i92 ; 2 uses
  %i.hc = fcmp olt double %i.hb, %.1.i85
  %i.hd = select i1 %i.hc, double %i.hb, double %.1.i85 ; 2 uses
  %i.he = fcmp olt double %i.hd, %.1.i78
  %.sroa.speculated = select i1 %i.he, double %i.hd, double %.1.i78
  br label %_ZN4geos9algorithm8Distance14pointToSegmentERKNS_4geom10CoordinateES5_S5_.exit
