...
bb.i:                                             ; preds = %bb.h, %bb.g
  ...
  store i32 %i.j, ptr %i.w, align 8, !tbaa !46
  br label %bb.j
...
bb.k:                                             ; preds = %bb.d
  ...
  %i.y = load i32, ptr %i.x, align 8, !tbaa !46
...
bb.p:                                             ; preds = %ZSTD_copyUncompressedBlock.exit.i, %ZSTD_copyUncompressedBlock.exit.thread.i
  ...
  store ptr %i.ac, ptr %i.c, align 8, !tbaa !45
  br label %ZSTD_decompressContinue.exit
...
HUF_decompress.exit.i.i:                          ; preds = %bb.h
  ...
  %i.at = load i32, ptr %i.as, align 8, !tbaa !59
...
bb.l:                                             ; preds = %bb.k
  ...
  store ptr %i.bq, ptr %i.br, align 8, !tbaa !62
  %i.bs = getelementptr inbounds nuw i8, ptr %0, i64 10296
  store i64 %i.bk, ptr %i.bs, align 8, !tbaa !63
...
bb.m:                                             ; preds = %bb.j
  ...
  store ptr %i.bv, ptr %i.bw, align 8, !tbaa !62
  %i.bx = getelementptr inbounds nuw i8, ptr %0, i64 10296
  store i64 %i.bk, ptr %i.bx, align 8, !tbaa !63
...
bb.o:                                             ; preds = %bb.n
  ...
  store ptr %i.cf, ptr %i.ch, align 8, !tbaa !62
  %i.ci = getelementptr inbounds nuw i8, ptr %0, i64 10296
  store i64 %i.ce, ptr %i.ci, align 8, !tbaa !63
  br label %ZSTD_decodeLiteralsBlock.exit.thread
...
ZSTD_decodeLiteralsBlock.exit.thread25:           ; preds = %bb.c, %bb.d, %bb.e, %HUF_decompress.exit.i.i
  ...
  store ptr %i.m, ptr %i.cj, align 8, !tbaa !62
  %i.ck = getelementptr inbounds nuw i8, ptr %0, i64 10296
  store i64 131072, ptr %i.ck, align 8, !tbaa !63
...
ZSTD_decodeLiteralsBlock.exit:                    ; preds = %bb.g, %bb.i, %HUF_decompress.exit.i.i
  ...
  store ptr %i.m, ptr %i.cm, align 8, !tbaa !62
  %i.cn = getelementptr inbounds nuw i8, ptr %0, i64 10296
  store i64 %i.p, ptr %i.cn, align 8, !tbaa !63
...
bb.cd:                                            ; preds = %BIT_reloadDStream.exit.i
  ...
  %.sroa.0.0.copyload.i.i.i = load i16, ptr %i.ur, align 2, !tbaa !29
  %.sroa.4.0..sroa_idx.i.i.i = getelementptr inbounds nuw i8, ptr %i.ur, i64 2
  %.sroa.4.0.copyload.i.i.i = load i8, ptr %.sroa.4.0..sroa_idx.i.i.i, align 2, !tbaa !15 ; 3 uses
  %.sroa.5.0..sroa_idx.i.i.i = getelementptr inbounds nuw i8, ptr %i.ur, i64 3
  %.sroa.5.0.copyload.i.i.i = load i8, ptr %.sroa.5.0..sroa_idx.i.i.i, align 1, !tbaa !15
...
bb.cf:                                            ; preds = %bb.ce
  ...
  %i.vi = load i8, ptr %.sroa.81.0195.i, align 1, !tbaa !15 ; 2 uses
...
bb.ch:                                            ; preds = %bb.cg
  ...
  %.0.val84.i.i = load i8, ptr %i.vm, align 1, !tbaa !15
...
bb.cj:                                            ; preds = %bb.ci, %bb.cd
  ...
  %.sroa.0.0.copyload.i85.i.i = load i16, ptr %i.vr, align 2, !tbaa !29
  %.sroa.4.0..sroa_idx.i86.i.i = getelementptr inbounds nuw i8, ptr %i.vr, i64 2
  %.sroa.4.0.copyload.i87.i.i = load i8, ptr %.sroa.4.0..sroa_idx.i86.i.i, align 2, !tbaa !15 ; 3 uses
  %.sroa.5.0..sroa_idx.i88.i.i = getelementptr inbounds nuw i8, ptr %i.vr, i64 3
  %.sroa.5.0.copyload.i89.i.i = load i8, ptr %.sroa.5.0..sroa_idx.i88.i.i, align 1, !tbaa !15
  ...
  %i.wj = load i64, ptr %i.wi, align 8, !tbaa !14
  %i.wk = add i32 %i.wb, %spec.store.select.i.i   ; 2 uses
  %i.wl = getelementptr inbounds nuw [4 x i8], ptr %i.tm, i64 %.sroa.73.0196.i ; 3 uses
  %.sroa.0.0.copyload.i92.i.i = load i16, ptr %i.wl, align 2, !tbaa !29
  %.sroa.4.0..sroa_idx.i93.i.i = getelementptr inbounds nuw i8, ptr %i.wl, i64 2
  %.sroa.4.0.copyload.i94.i.i = load i8, ptr %.sroa.4.0..sroa_idx.i93.i.i, align 2, !tbaa !15 ; 2 uses
  %.sroa.5.0..sroa_idx.i95.i.i = getelementptr inbounds nuw i8, ptr %i.wl, i64 3
  %.sroa.5.0.copyload.i96.i.i = load i8, ptr %.sroa.5.0..sroa_idx.i95.i.i, align 1, !tbaa !15
...
bb.cl:                                            ; preds = %bb.ck
  ...
  %i.xc = load i8, ptr %.3.i.i, align 1, !tbaa !15 ; 2 uses
...
bb.cn:                                            ; preds = %bb.cm
  ...
  %.4.val83.i.i = load i8, ptr %i.xg, align 1, !tbaa !15
...
vector.body155:                                   ; preds = %vector.body155, %vector.ph153
  ...
  br i1 %i.za, label %middle.block162, label %vector.body155, !llvm.loop !49
...
.preheader.i.i:                                   ; preds = %.preheader.i.i.preheader169, %.preheader.i.i
  ...
  br i1 %i.zd, label %.preheader.i.i, label %ZSTD_wildcopy.exit.i.i, !llvm.loop !50
...
vector.body138:                                   ; preds = %vector.body138, %vector.ph136
  ...
  br i1 %i.aaz, label %middle.block145, label %vector.body138, !llvm.loop !51
...
vector.body122:                                   ; preds = %vector.body122, %vector.ph120
  ...
  br i1 %i.abn, label %middle.block129, label %vector.body122, !llvm.loop !52
...
.preheader.i:                                     ; preds = %.preheader.i.preheader166, %.preheader.i
  ...
  br i1 %i.abq, label %.preheader.i, label %ZSTD_wildcopy.exit83.i.i, !llvm.loop !53
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load105 = load <16 x i8>, ptr %i.ach, align 1, !tbaa !15
  %i.aci = getelementptr i8, ptr %next.gep104, i64 16
  store <16 x i8> %wide.load, ptr %next.gep104, align 1, !tbaa !15
  store <16 x i8> %wide.load105, ptr %i.aci, align 1, !tbaa !15
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.acj = icmp eq i64 %index.next, %n.vec
  br i1 %i.acj, label %middle.block, label %vector.body, !llvm.loop !54
...
vec.epilog.iter.check:                            ; preds = %middle.block
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph.i.i.preheader, label %vec.epilog.ph, !prof !67
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load111 = load <4 x i8>, ptr %next.gep109, align 1, !tbaa !15
  store <4 x i8> %wide.load111, ptr %next.gep110, align 1, !tbaa !15
  %index.next112 = add nuw i64 %index108, 4       ; 2 uses
  %i.acm = icmp eq i64 %index.next112, %n.vec107
  br i1 %i.acm, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !55
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i
  ...
  %i.aco = load i8, ptr %.291.i.i, align 1, !tbaa !15
  %i.acp = getelementptr inbounds nuw i8, ptr %.16990.i.i, i64 1 ; 2 uses
  store i8 %i.aco, ptr %.16990.i.i, align 1, !tbaa !15
  %i.acq = icmp ult ptr %i.acp, %i.xw
  br i1 %i.acq, label %.lr.ph.i.i, label %ZSTD_execSequence.exit.i, !llvm.loop !56
...
.preheader183.i:                                  ; preds = %.preheader183.i.preheader167, %.preheader183.i
  ...
  br i1 %i.act, label %.preheader183.i, label %ZSTD_execSequence.exit.i, !llvm.loop !57
