...
BIT_reloadDStream.exit259.i:                      ; preds = %bb.bg, %bb.bf, %bb.be, %BIT_reloadDStream.exit250.i
  ...
  br i1 %or.cond186.i, label %..critedge_crit_edge.i, label %bb.an, !llvm.loop !99

..critedge_crit_edge.i:                           ; preds = %BIT_reloadDStream.exit259.i
  store i32 %.val9.i321.i, ptr %i.mo, align 8, !tbaa !65
  store i32 %.val9.i203324.i, ptr %i.ms, align 8, !tbaa !65
  store i32 %.val9.i205327.i, ptr %i.mt, align 8, !tbaa !65
  store i32 %.val9.i207330.i, ptr %i.mu, align 8, !tbaa !65
...
BIT_endOfDStream.exit.i:                          ; preds = %.critedge.i
  ...
  %i.aah = load <2 x ptr>, ptr %i.zu, align 8, !tbaa !70 ; 2 uses
  %i.aai = load <2 x ptr>, ptr %i.zy, align 8, !tbaa !70 ; 2 uses
  %i.aaj = load <2 x ptr>, ptr %i.aac, align 8, !tbaa !70 ; 2 uses
  %i.aak = load <2 x ptr>, ptr %i.aag, align 8, !tbaa !70 ; 2 uses
...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %wide.load = load <8 x i8>, ptr %i.q, align 1, !tbaa !9, !alias.scope !100 ; 2 uses
  %wide.load78 = load <8 x i8>, ptr %6, align 1, !tbaa !9, !alias.scope !100 ; 2 uses
  ...
  store <16 x i8> %interleaved.vec, ptr %0, align 1, !tbaa !9, !alias.scope !103, !noalias !100
  ...
  store <16 x i8> %interleaved.vec81, ptr %9, align 1, !tbaa !9, !alias.scope !103, !noalias !100
...
vector.body:                                      ; preds = %vector.ph
  ...
  %wide.load.a = load <8 x i8>, ptr %i.aa, align 1, !tbaa !9, !alias.scope !100 ; 2 uses
  %wide.load78.a = load <8 x i8>, ptr %i.ab, align 1, !tbaa !9, !alias.scope !100 ; 2 uses
  ...
  store <16 x i8> %interleaved.vec.a, ptr %i.ae, align 1, !tbaa !9, !alias.scope !103, !noalias !100
  ...
  store <16 x i8> %interleaved.vec81.a, ptr %i.af, align 1, !tbaa !9, !alias.scope !103, !noalias !100
...
vector.body.2:                                    ; preds = %vector.body
  ...
  %wide.load.2 = load <8 x i8>, ptr %13, align 1, !tbaa !9, !alias.scope !100 ; 2 uses
  %wide.load78.2 = load <8 x i8>, ptr %14, align 1, !tbaa !9, !alias.scope !100 ; 2 uses
  ...
  store <16 x i8> %interleaved.vec.2, ptr %17, align 1, !tbaa !9, !alias.scope !103, !noalias !100
  ...
  store <16 x i8> %interleaved.vec81.2, ptr %18, align 1, !tbaa !9, !alias.scope !103, !noalias !100
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load85 = load <4 x i8>, ptr %i.am, align 1, !tbaa !9, !alias.scope !100 ; 2 uses
  ...
  store <8 x i8> %interleaved.vec87, ptr %i.ao, align 1, !tbaa !9, !alias.scope !103, !noalias !100
  %index.next88 = add nuw i64 %index84, 4         ; 2 uses
  %i.aq = icmp eq i64 %index.next88, %n.vec83
  br i1 %i.aq, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !105
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  br i1 %i.bc, label %.lr.ph, label %.loopexit.thread, !llvm.loop !106
...
bb.ay:                                            ; preds = %BIT_reloadDStream.exit.i.i
  ...
  br i1 %i.kl, label %BIT_reloadDStream.exit80.split.loop.exit450.i.i, label %.lr.ph.i, !llvm.loop !107
...
bb.cc:                                            ; preds = %BIT_reloadDStream.exit137.i.i
  ...
  br i1 %i.sm, label %BIT_reloadDStream.exit174.split.loop.exit490.i.i, label %.lr.ph113.i, !llvm.loop !107
...
bb.cl:                                            ; preds = %.lr.ph166
  ...
  br i1 %i.vd, label %.lr.ph166, label %._crit_edge, !llvm.loop !108
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  br i1 %i.z, label %.lr.ph, label %.preheader162, !llvm.loop !109
...
.lr.ph178:                                        ; preds = %.preheader162, %.lr.ph178
  ...
  br i1 %i.ae, label %.lr.ph178, label %._crit_edge, !llvm.loop !110
...
.lr.ph190:                                        ; preds = %bb.l, %.lr.ph190
  ...
  br i1 %i.bt, label %.lr.ph190, label %._crit_edge191, !llvm.loop !111
...
._crit_edge191:                                   ; preds = %.lr.ph190, %bb.l
  ...
  br i1 %i.cd, label %bb.c, label %.critedge, !llvm.loop !112
...
bb.e:                                             ; preds = %BIT_reloadDStream.exit
  ...
  br i1 %i.cd, label %.preheader55, label %.lr.ph5, !llvm.loop !113
...
bb.i:                                             ; preds = %BIT_reloadDStream.exit50
  ...
  br i1 %i.dq, label %BIT_reloadDStream.exit50.thread, label %.lr.ph13, !llvm.loop !114
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  br i1 %i.ec, label %.lr.ph, label %._crit_edge, !llvm.loop !115
...
bb.e:                                             ; preds = %BIT_reloadDStream.exit
  ...
  br i1 %i.cs, label %.preheader68, label %.lr.ph4, !llvm.loop !116
...
bb.i:                                             ; preds = %BIT_reloadDStream.exit62
  ...
  br i1 %i.ei, label %.preheader, label %.lr.ph12, !llvm.loop !117
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x i32> %broadcast.splat, ptr %i.l, align 4, !tbaa !9, !alias.scope !119, !noalias !122
  store <4 x i32> %broadcast.splat, ptr %i.m, align 4, !tbaa !9, !alias.scope !119, !noalias !122
  %i.n = getelementptr inbounds nuw [2 x i8], ptr %0, i64 %index ; 2 uses
  %i.o = getelementptr inbounds nuw i8, ptr %i.n, i64 8
  store <4 x i16> %broadcast.splat116, ptr %i.n, align 1, !alias.scope !122
  store <4 x i16> %broadcast.splat116, ptr %i.o, align 1, !alias.scope !122
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.p = icmp eq i64 %index.next, %n.vec
  br i1 %i.p, label %middle.block, label %vector.body, !llvm.loop !124
...
.lr.ph.prol:                                      ; preds = %.lr.ph.preheader171, %.lr.ph.prol
  ...
  store i32 %11, ptr %i.q, align 4, !tbaa !9
...
.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  ...
  store i32 %11, ptr %i.u, align 4, !tbaa !9
  ...
  store i32 %11, ptr %i.w, align 4, !tbaa !9
  ...
  store i32 %11, ptr %i.y, align 4, !tbaa !9
...
.lr.ph80.split.us:                                ; preds = %.lr.ph80.split.us.preheader, %.loopexit.us
  ...
  %i.ao = load i8, ptr %i.an, align 1, !tbaa !68  ; 2 uses
  ...
  store i8 %i.am, ptr %i.ai, align 1, !tbaa !9
...
scalar.ph151:                                     ; preds = %scalar.ph151.prol.loopexit, %scalar.ph151
  ...
  store i8 %i.ax, ptr %i.bg, align 1, !tbaa !9
  %.sroa.5.0..sroa_idx68.us.3 = getelementptr inbounds nuw i8, ptr %i.bg, i64 1
  store i8 %i.ac, ptr %.sroa.5.0..sroa_idx68.us.3, align 1, !tbaa !9
  ...
  br i1 %exitcond99.not.3, label %.loopexit.us, label %scalar.ph151, !llvm.loop !127
...
.loopexit.us:                                     ; preds = %scalar.ph151.prol.loopexit, %scalar.ph151, %middle.block167, %.lr.ph80.split.us
  ...
  br i1 %exitcond104.not, label %._crit_edge, label %.lr.ph80.split.us, !llvm.loop !128

.lr.ph78.us:                                      ; preds = %.lr.ph80.split.us
  %i.bi = load i32, ptr %13, align 4, !tbaa !9    ; 6 uses
...
vector.body162:                                   ; preds = %vector.body162, %vector.ph153
  ...
  %i.bq = add i64 %index163, %i.bj                ; 3 uses
  ...
  store <8 x i8> %interleaved.vec164, ptr %i.br, align 1, !tbaa !9, !alias.scope !129, !noalias !132
  store <8 x i8> %interleaved.vec164, ptr %i.bt, align 1, !tbaa !9, !alias.scope !129, !noalias !132
  %i.bu = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.bq ; 2 uses
  %i.bv = getelementptr inbounds nuw i8, ptr %i.bu, i64 16
  store <4 x i32> %broadcast.splat157, ptr %i.bu, align 4, !tbaa !9, !alias.scope !132
  store <4 x i32> %broadcast.splat157, ptr %i.bv, align 4, !tbaa !9, !alias.scope !132
  %index.next166 = add nuw i64 %index163, 8       ; 2 uses
  %i.bw = icmp eq i64 %index.next166, %n.vec155
  br i1 %i.bw, label %middle.block167, label %vector.body162, !llvm.loop !134
...
scalar.ph151.prol:                                ; preds = %scalar.ph151.preheader, %scalar.ph151.prol
  ...
  br i1 %prol.iter177.cmp.not, label %scalar.ph151.prol.loopexit, label %scalar.ph151.prol, !llvm.loop !135
...
.lr.ph80.split:                                   ; preds = %.lr.ph80.split.preheader, %.loopexit
  ...
  %i.cd = load i8, ptr %i.cc, align 1, !tbaa !66
  %i.ce = getelementptr inbounds nuw i8, ptr %i.cc, i64 1
  %i.cf = load i8, ptr %i.ce, align 1, !tbaa !68  ; 2 uses
  ...
  %i.cl = load i32, ptr %i.ck, align 4, !tbaa !3  ; 5 uses
  %i.cm = sub nsw i32 %2, %i.ch                   ; 2 uses
  %i.cn = shl nuw i32 1, %i.cm                    ; 2 uses
  store i8 %i.cd, ptr %i.ai, align 1, !tbaa !9
...
.lr.ph78:                                         ; preds = %bb.d
  %i.cy = load i32, ptr %13, align 4, !tbaa !9    ; 6 uses
...
vector.body136:                                   ; preds = %vector.body136, %vector.ph127
  ...
  %i.dg = add i64 %index137, %i.cz                ; 3 uses
  ...
  store <8 x i8> %interleaved.vec, ptr %i.dh, align 1, !tbaa !9, !alias.scope !136, !noalias !139
  store <8 x i8> %interleaved.vec, ptr %i.dj, align 1, !tbaa !9, !alias.scope !136, !noalias !139
  %i.dk = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.dg ; 2 uses
  %i.dl = getelementptr inbounds nuw i8, ptr %i.dk, i64 16
  store <4 x i32> %broadcast.splat131, ptr %i.dk, align 4, !tbaa !9, !alias.scope !139
  store <4 x i32> %broadcast.splat131, ptr %i.dl, align 4, !tbaa !9, !alias.scope !139
  %index.next139 = add nuw i64 %index137, 8       ; 2 uses
  %i.dm = icmp eq i64 %index.next139, %n.vec129
  br i1 %i.dm, label %middle.block140, label %vector.body136, !llvm.loop !141
...
scalar.ph125.prol:                                ; preds = %scalar.ph125.preheader, %scalar.ph125.prol
  ...
  br i1 %prol.iter174.cmp.not, label %scalar.ph125.prol.loopexit, label %scalar.ph125.prol, !llvm.loop !142
...
scalar.ph125:                                     ; preds = %scalar.ph125.prol.loopexit, %scalar.ph125
  ...
  store i8 %i.co, ptr %i.ds, align 1, !tbaa !9
  %.sroa.5.0..sroa_idx68 = getelementptr inbounds nuw i8, ptr %i.ds, i64 1
  store i8 %i.ac, ptr %.sroa.5.0..sroa_idx68, align 1, !tbaa !9
  %i.dt = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %indvars.iv85
  store i32 %i.cy, ptr %i.dt, align 4, !tbaa !9
  ...
  br i1 %exitcond89.not.3, label %.loopexit, label %scalar.ph125, !llvm.loop !143
...
bb.a:
  ...
  %.pre = load i32, ptr %i.f, align 8, !tbaa !65  ; 3 uses
...
.lr.ph5:                                          ; preds = %bb.a, %bb.e
  ...
  %i.o = load ptr, ptr %i.h, align 8, !tbaa !63   ; 6 uses
  %i.p = load ptr, ptr %i.i, align 8, !tbaa !61   ; 4 uses
...
bb.b:                                             ; preds = %.lr.ph5
  ...
  store ptr %i.u, ptr %i.h, align 8, !tbaa !63
  %i.v = and i32 %i.n, 7
  br label %BIT_reloadDStream.exit
...
bb.d:                                             ; preds = %bb.c
  ...
  store ptr %i.ai, ptr %i.h, align 8, !tbaa !63
...
BIT_reloadDStream.exit:                           ; preds = %bb.b, %bb.d
  ...
  store i32 %.val9.i, ptr %i.f, align 8, !tbaa !65
  %.val30.i.sink = load i64, ptr %.val30.i.sink.in, align 1
  store i64 %.val30.i.sink, ptr %1, align 8, !tbaa !64
...
bb.e:                                             ; preds = %BIT_reloadDStream.exit
  %.val.i62 = load i64, ptr %1, align 8, !tbaa !64
  ...
  %i.ay = load i32, ptr %i.f, align 8, !tbaa !65
  %i.az = add i32 %i.ay, %i.ax                    ; 2 uses
  store i32 %i.az, ptr %i.f, align 8, !tbaa !65
  %i.ba = getelementptr inbounds nuw i8, ptr %i.av, i64 1
  %i.bb = load i8, ptr %i.ba, align 1, !tbaa !68
  ...
  %i.bn = load i32, ptr %i.f, align 8, !tbaa !65
  %i.bo = add i32 %i.bn, %i.bm                    ; 2 uses
  store i32 %i.bo, ptr %i.f, align 8, !tbaa !65
  ...
  %i.ca = load i8, ptr %i.bz, align 1, !tbaa !66
  %i.cb = zext i8 %i.ca to i32
  %i.cc = load i32, ptr %i.f, align 8, !tbaa !65
  %i.cd = add i32 %i.cc, %i.cb                    ; 2 uses
  store i32 %i.cd, ptr %i.f, align 8, !tbaa !65
  %i.ce = getelementptr inbounds nuw i8, ptr %i.bz, i64 1
  %i.cf = load i8, ptr %i.ce, align 1, !tbaa !68
...
.lr.ph13:                                         ; preds = %.preheader86, %bb.i
  ...
  %i.cz = load ptr, ptr %i.h, align 8, !tbaa !63  ; 6 uses
  %i.da = load ptr, ptr %i.i, align 8, !tbaa !61  ; 4 uses
...
bb.f:                                             ; preds = %.lr.ph13
  ...
  store ptr %i.df, ptr %i.h, align 8, !tbaa !63
  %i.dg = and i32 %i.cy, 7
...
bb.h:                                             ; preds = %bb.g
  ...
  store ptr %i.dt, ptr %i.h, align 8, !tbaa !63
...
BIT_reloadDStream.exit77:                         ; preds = %bb.f, %bb.h
  ...
  store i32 %.val9.i79, ptr %i.f, align 8, !tbaa !65
  %.val30.i70.sink = load i64, ptr %.val30.i70.sink.in, align 1
  store i64 %.val30.i70.sink, ptr %1, align 8, !tbaa !64
...
bb.i:                                             ; preds = %BIT_reloadDStream.exit77
  %.val.i78 = load i64, ptr %1, align 8, !tbaa !64
...
.lr.ph:                                           ; preds = %.preheader85, %.lr.ph
  ...
  %.val.i80 = load i64, ptr %1, align 8, !tbaa !64
  ...
  %i.ex = load i8, ptr %i.ew, align 1, !tbaa !66
  %i.ey = zext i8 %i.ex to i32
  %i.ez = load i32, ptr %i.f, align 8, !tbaa !65
  %i.fa = add i32 %i.ez, %i.ey                    ; 3 uses
  store i32 %i.fa, ptr %i.f, align 8, !tbaa !65
  %i.fb = getelementptr inbounds nuw i8, ptr %i.ew, i64 1
  %i.fc = load i8, ptr %i.fb, align 1, !tbaa !68
...
bb.j:                                             ; preds = %.lr.ph92, %HUF_decodeLastSymbolsX6.exit
  ...
  %.val.i82 = load i64, ptr %1, align 8, !tbaa !64
  ...
  %i.fo = load i8, ptr %i.fn, align 1, !tbaa !68  ; 2 uses
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.fs = load i8, ptr %i.fm, align 1, !tbaa !66
  %i.ft = zext i8 %i.fs to i32
  %i.fu = load i32, ptr %i.f, align 8, !tbaa !65
...
bb.l:                                             ; preds = %bb.j
  ...
  %i.fx = load i32, ptr %i.f, align 8, !tbaa !65  ; 3 uses
  %i.fy = icmp ult i32 %i.fx, 64
  br i1 %i.fy, label %bb.m, label %HUF_decodeLastSymbolsX6.exit

bb.m:                                             ; preds = %bb.l
  %i.fz = load i8, ptr %i.fm, align 1, !tbaa !66
...
HUF_decodeLastSymbolsX6.exit:                     ; preds = %bb.l, %.sink.split.i
  ...
  br i1 %i.ge, label %bb.j, label %._crit_edge, !llvm.loop !147
...
!12 = !{!13, !14, i64 10264}
!13 = !{!"ZSTDv02_Dctx_s", !5, i64 0, !5, i64 4100, !5, i64 6152, !14, i64 10256, !14, i64 10264, !8, i64 10272, !4, i64 10280, !4, i64 10284, !15, i64 10288, !8, i64 10296, !5, i64 10304}
...
!105 = distinct !{!105, !36, !44, !45}
!106 = distinct !{!106, !36, !44}
!107 = distinct !{!107, !36}
!108 = distinct !{!108, !36}
!109 = distinct !{!109, !36}
!110 = distinct !{!110, !36}
...
!124 = distinct !{!124, !36, !44, !45}
!125 = distinct !{!125, !74}
!126 = distinct !{!126, !36, !44}
!127 = distinct !{!127, !36, !44}
!128 = distinct !{!128, !36}
!129 = !{!130}
...
!141 = distinct !{!141, !36, !44, !45}
!142 = distinct !{!142, !74}
!143 = distinct !{!143, !36, !44}
!144 = distinct !{!144, !36}
!145 = distinct !{!145, !36}
!146 = distinct !{!146, !36}
!147 = distinct !{!147, !36}
