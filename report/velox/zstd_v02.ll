...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load.a = load <8 x i8>, ptr %i.aa, align 1, !tbaa !9, !alias.scope !100
  %wide.load78.a = load <8 x i8>, ptr %i.ab, align 1, !tbaa !9, !alias.scope !100
  ...
  %wide.load79 = load <8 x i8>, ptr %i.aa, align 1, !tbaa !9, !alias.scope !100
  %wide.load80 = load <8 x i8>, ptr %i.ab, align 1, !tbaa !9, !alias.scope !100
  ...
  store <16 x i8> %interleaved.vec.a, ptr %8, align 1, !tbaa !9, !alias.scope !103, !noalias !100
  ...
  br i1 %i.ai, label %middle.block, label %vector.body, !llvm.loop !105
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.aq, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !106
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  br i1 %i.bc, label %.lr.ph, label %.loopexit.thread, !llvm.loop !107
...
bb.ay:                                            ; preds = %BIT_reloadDStream.exit.i.i
  ...
  br i1 %i.kl, label %BIT_reloadDStream.exit80.split.loop.exit450.i.i, label %.lr.ph.i, !llvm.loop !108
...
bb.cc:                                            ; preds = %BIT_reloadDStream.exit137.i.i
  ...
  br i1 %i.sm, label %BIT_reloadDStream.exit174.split.loop.exit490.i.i, label %.lr.ph113.i, !llvm.loop !108
...
bb.cl:                                            ; preds = %.lr.ph166
  ...
  br i1 %i.vd, label %.lr.ph166, label %._crit_edge, !llvm.loop !109
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  br i1 %i.z, label %.lr.ph, label %.preheader162, !llvm.loop !110
...
.lr.ph178:                                        ; preds = %.preheader162, %.lr.ph178
  ...
  br i1 %i.ae, label %.lr.ph178, label %._crit_edge, !llvm.loop !111
...
.lr.ph190:                                        ; preds = %bb.l, %.lr.ph190
  ...
  br i1 %i.bt, label %.lr.ph190, label %._crit_edge191, !llvm.loop !112
...
._crit_edge191:                                   ; preds = %.lr.ph190, %bb.l
  ...
  br i1 %i.cd, label %bb.c, label %.critedge, !llvm.loop !113
...
bb.e:                                             ; preds = %BIT_reloadDStream.exit
  ...
  br i1 %i.cd, label %.preheader55, label %.lr.ph5, !llvm.loop !114
...
bb.i:                                             ; preds = %BIT_reloadDStream.exit50
  ...
  br i1 %i.dq, label %BIT_reloadDStream.exit50.thread, label %.lr.ph13, !llvm.loop !115
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  br i1 %i.ec, label %.lr.ph, label %._crit_edge, !llvm.loop !116
...
bb.e:                                             ; preds = %BIT_reloadDStream.exit
  ...
  br i1 %i.cs, label %.preheader68, label %.lr.ph4, !llvm.loop !117
...
bb.i:                                             ; preds = %BIT_reloadDStream.exit62
  ...
  br i1 %i.ei, label %.preheader, label %.lr.ph12, !llvm.loop !118
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x i32> %broadcast.splat, ptr %i.l, align 4, !tbaa !9, !alias.scope !120, !noalias !123
  store <4 x i32> %broadcast.splat, ptr %i.m, align 4, !tbaa !9, !alias.scope !120, !noalias !123
  %i.n = getelementptr inbounds nuw [2 x i8], ptr %0, i64 %index ; 2 uses
  %i.o = getelementptr inbounds nuw i8, ptr %i.n, i64 8
  store <4 x i16> %broadcast.splat116, ptr %i.n, align 1, !alias.scope !123
  store <4 x i16> %broadcast.splat116, ptr %i.o, align 1, !alias.scope !123
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.p = icmp eq i64 %index.next, %n.vec
  br i1 %i.p, label %middle.block, label %vector.body, !llvm.loop !125
...
.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  ...
  br i1 %exitcond.not.3, label %.loopexit75, label %.lr.ph, !llvm.loop !127
...
scalar.ph151:                                     ; preds = %scalar.ph151.prol.loopexit, %scalar.ph151
  ...
  br i1 %exitcond99.not.3, label %.loopexit.us, label %scalar.ph151, !llvm.loop !128
...
.loopexit.us:                                     ; preds = %scalar.ph151.prol.loopexit, %scalar.ph151, %middle.block167, %.lr.ph80.split.us
  ...
  br i1 %exitcond104.not, label %._crit_edge, label %.lr.ph80.split.us, !llvm.loop !129
...
vector.body162:                                   ; preds = %vector.body162, %vector.ph153
  ...
  store <8 x i8> %interleaved.vec164, ptr %i.br, align 1, !tbaa !9, !alias.scope !130, !noalias !133
  store <8 x i8> %interleaved.vec164, ptr %i.bt, align 1, !tbaa !9, !alias.scope !130, !noalias !133
  %i.bu = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.bq ; 2 uses
  %i.bv = getelementptr inbounds nuw i8, ptr %i.bu, i64 16
  store <4 x i32> %broadcast.splat157, ptr %i.bu, align 4, !tbaa !9, !alias.scope !133
  store <4 x i32> %broadcast.splat157, ptr %i.bv, align 4, !tbaa !9, !alias.scope !133
  %index.next166 = add nuw i64 %index163, 8       ; 2 uses
  %i.bw = icmp eq i64 %index.next166, %n.vec155
  br i1 %i.bw, label %middle.block167, label %vector.body162, !llvm.loop !135
...
scalar.ph151.prol:                                ; preds = %scalar.ph151.preheader, %scalar.ph151.prol
  ...
  br i1 %prol.iter177.cmp.not, label %scalar.ph151.prol.loopexit, label %scalar.ph151.prol, !llvm.loop !136
...
vector.body136:                                   ; preds = %vector.body136, %vector.ph127
  ...
  store <8 x i8> %interleaved.vec, ptr %i.dh, align 1, !tbaa !9, !alias.scope !137, !noalias !140
  store <8 x i8> %interleaved.vec, ptr %i.dj, align 1, !tbaa !9, !alias.scope !137, !noalias !140
  %i.dk = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.dg ; 2 uses
  %i.dl = getelementptr inbounds nuw i8, ptr %i.dk, i64 16
  store <4 x i32> %broadcast.splat131, ptr %i.dk, align 4, !tbaa !9, !alias.scope !140
  store <4 x i32> %broadcast.splat131, ptr %i.dl, align 4, !tbaa !9, !alias.scope !140
  %index.next139 = add nuw i64 %index137, 8       ; 2 uses
  %i.dm = icmp eq i64 %index.next139, %n.vec129
  br i1 %i.dm, label %middle.block140, label %vector.body136, !llvm.loop !142
...
scalar.ph125.prol:                                ; preds = %scalar.ph125.preheader, %scalar.ph125.prol
  ...
  br i1 %prol.iter174.cmp.not, label %scalar.ph125.prol.loopexit, label %scalar.ph125.prol, !llvm.loop !143
...
scalar.ph125:                                     ; preds = %scalar.ph125.prol.loopexit, %scalar.ph125
  ...
  br i1 %exitcond89.not.3, label %.loopexit, label %scalar.ph125, !llvm.loop !144
...
.loopexit:                                        ; preds = %scalar.ph125.prol.loopexit, %scalar.ph125, %middle.block140, %bb.d, %bb.c
  ...
  br i1 %exitcond94.not, label %._crit_edge, label %.lr.ph80.split, !llvm.loop !129
...
bb.e:                                             ; preds = %BIT_reloadDStream.exit
  ...
  br i1 %i.cx, label %.preheader86, label %.lr.ph5, !llvm.loop !145
...
bb.i:                                             ; preds = %BIT_reloadDStream.exit77
  ...
  br i1 %i.en, label %.preheader85, label %.lr.ph13, !llvm.loop !146
...
HUF_decodeLastSymbolsX6.exit:                     ; preds = %bb.l, %.sink.split.i
  ...
  br i1 %i.ge, label %bb.j, label %._crit_edge, !llvm.loop !148
...
!106 = distinct !{!106, !36, !44, !45}
!107 = distinct !{!107, !36, !44}
!108 = distinct !{!108, !36}
!109 = distinct !{!109, !36}
!110 = distinct !{!110, !36}
!111 = distinct !{!111, !36}
...
!125 = distinct !{!125, !36, !44, !45}
!126 = distinct !{!126, !74}
!127 = distinct !{!127, !36, !44}
!128 = distinct !{!128, !36, !44}
!129 = distinct !{!129, !36}
!130 = !{!131}
...
!142 = distinct !{!142, !36, !44, !45}
!143 = distinct !{!143, !74}
!144 = distinct !{!144, !36, !44}
!145 = distinct !{!145, !36}
!146 = distinct !{!146, !36}
!147 = distinct !{!147, !36}
!148 = distinct !{!148, !36}
