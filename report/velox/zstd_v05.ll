...
bb.ac:                                            ; preds = %.thread171.i, %bb.x, %bb.w, %bb.p, %bb.k
  ...
  %i.fz = getelementptr i8, ptr %1, i64 %2        ; 5 uses
...
.lr.ph.i:                                         ; preds = %bb.cg, %FSEv05_initDState.exit92.i, %FSEv05_initDState.exit92.thread277.i
  ...
  %i.uu = getelementptr i8, ptr %i.fz, i64 -8     ; 6 uses
  ...
  %i.va = ptrtoint ptr %i.uu to i64               ; 4 uses
  %i.vb = add i64 %i.ux, 8
  %i.vc = add i64 %i.ux, 8
  %i.vd = add i64 %i.ux, 1
...
.preheader.i.preheader:                           ; preds = %bb.dl
  ...
  %i.acx = tail call i64 @llvm.umax.i64(i64 %i.va, i64 %.reass237)
...
iter.check:                                       ; preds = %bb.dm
  ...
  %umax110 = tail call i64 @llvm.umax.i64(i64 %i.va, i64 %i.adw)
...
vector.memcheck:                                  ; preds = %iter.check
  ...
  %umax107 = tail call i64 @llvm.umax.i64(i64 %i.va, i64 %i.ady)
