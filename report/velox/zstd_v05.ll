...
.preheader.i.preheader:                           ; preds = %bb.dl
  ...
  %i.acz = add i64 %i.vf, %umax129
  %umax130 = tail call i64 @llvm.umax.i64(i64 %i.vb, i64 %i.acz)
  %i.ada = add i64 %umax130, -9
  %6 = add i64 %umax129, %i.uy
  %7 = sub i64 %i.ada, %6                         ; 2 uses
  %i.adb = lshr i64 %7, 3
  %i.adc = add nuw nsw i64 %i.adb, 1              ; 2 uses
  %min.iters.check131 = icmp ult i64 %7, 72
...
vector.memcheck:                                  ; preds = %iter.check
  ...
  %i.aec = add i64 %i.vd, %umax
  %umax107 = tail call i64 @llvm.umax.i64(i64 %5, i64 %i.aec)
...
bb.dn:                                            ; preds = %bb.dk
  ...
  %8 = add i64 %i.vg, %.277.i.i
  %umin = tail call i64 @llvm.umin.i64(i64 %.074.i.i, i64 %i.aax)
  %i.aer = add i64 %8, %umin
  %umax148 = tail call i64 @llvm.umax.i64(i64 %.074.i.i, i64 %i.aax) ; 3 uses
  %i.aes = add i64 %i.aer, %umax148
  %i.aet = sub i64 %i.aes, %.074.i.i
  %i.aeu = add i64 %i.vh, %umax148
  %umax149 = tail call i64 @llvm.umax.i64(i64 %i.aet, i64 %i.aeu)
  %i.aev = add i64 %umax149, -9
  %9 = add i64 %umax148, %i.uy
  %10 = sub i64 %i.aev, %9                        ; 2 uses
  %i.aew = lshr i64 %10, 3
  %i.aex = add nuw nsw i64 %i.aew, 1              ; 2 uses
  %min.iters.check151 = icmp ult i64 %10, 72
