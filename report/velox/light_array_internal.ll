...
.lr.ph.split.i40.i.preheader:                     ; preds = %.lr.ph.split.i40.preheader.i, %vector.memcheck448, %middle.block461
  ...
  %.03.i41.i.ph = phi i32 [ 0, %vector.memcheck448 ], [ %i.on, %middle.block461 ], [ 0, %.lr.ph.split.i40.preheader.i ]
...
vector.memcheck410:                               ; preds = %.lr.ph.split.i37.preheader.i
  %i.aca = add i64 %34, %i.aby
  %i.acb = add i64 %i.abo, %33
...
.lr.ph.split.i37.i.preheader:                     ; preds = %.lr.ph.split.i37.preheader.i, %vector.memcheck410, %middle.block423
  %.ph479 = phi i64 [ 0, %vector.memcheck410 ], [ %n.vec417, %middle.block423 ], [ 0, %.lr.ph.split.i37.preheader.i ]
  %.012.i38.i.ph = phi i32 [ 0, %vector.memcheck410 ], [ %i.ym, %middle.block423 ], [ 0, %.lr.ph.split.i37.preheader.i ]
