...
BIT_reloadDStream.exit234.i:                      ; preds = %bb.bj, %bb.bi, %bb.bh, %BIT_reloadDStream.exit225.i
  ...
  br i1 %i.acf, label %bb.aq, label %._crit_edge.i21, !llvm.loop !91

._crit_edge.i21:                                  ; preds = %BIT_reloadDStream.exit234.i
  store i32 %.val9.i291.i, ptr %i.pf, align 8, !tbaa !67
  store i32 %.val9.i178294.i, ptr %i.pg, align 8, !tbaa !67
  store i32 %.val9.i180297.i, ptr %i.ph, align 8, !tbaa !67
  store i32 %.val9.i182300.i, ptr %i.pi, align 8, !tbaa !67
...
BIT_endOfDStream.exit.i:                          ; preds = %bb.bk
  ...
  %i.acw = load <2 x ptr>, ptr %i.acj, align 8, !tbaa !72 ; 2 uses
  %i.acx = load <2 x ptr>, ptr %i.acn, align 8, !tbaa !72 ; 2 uses
  %i.acy = load <2 x ptr>, ptr %i.acr, align 8, !tbaa !72 ; 2 uses
  %i.acz = load <2 x ptr>, ptr %i.acv, align 8, !tbaa !72 ; 2 uses
...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %wide.load = load <8 x i8>, ptr %i.q, align 1, !tbaa !10, !alias.scope !92 ; 2 uses
  %wide.load78 = load <8 x i8>, ptr %6, align 1, !tbaa !10, !alias.scope !92 ; 2 uses
  ...
  store <16 x i8> %interleaved.vec, ptr %0, align 1, !tbaa !10, !alias.scope !95, !noalias !92
  ...
  store <16 x i8> %interleaved.vec81, ptr %9, align 1, !tbaa !10, !alias.scope !95, !noalias !92
...
vector.body:                                      ; preds = %vector.ph
  ...
  %wide.load.a = load <8 x i8>, ptr %i.aa, align 1, !tbaa !10, !alias.scope !92 ; 2 uses
  %wide.load78.a = load <8 x i8>, ptr %i.ab, align 1, !tbaa !10, !alias.scope !92 ; 2 uses
  ...
  store <16 x i8> %interleaved.vec.a, ptr %i.ae, align 1, !tbaa !10, !alias.scope !95, !noalias !92
  ...
  store <16 x i8> %interleaved.vec81.a, ptr %i.af, align 1, !tbaa !10, !alias.scope !95, !noalias !92
...
vector.body.2:                                    ; preds = %vector.body
  ...
  %wide.load.2 = load <8 x i8>, ptr %13, align 1, !tbaa !10, !alias.scope !92 ; 2 uses
  %wide.load78.2 = load <8 x i8>, ptr %14, align 1, !tbaa !10, !alias.scope !92 ; 2 uses
  ...
  store <16 x i8> %interleaved.vec.2, ptr %17, align 1, !tbaa !10, !alias.scope !95, !noalias !92
  ...
  store <16 x i8> %interleaved.vec81.2, ptr %18, align 1, !tbaa !10, !alias.scope !95, !noalias !92
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load85 = load <4 x i8>, ptr %i.al, align 1, !tbaa !10, !alias.scope !92 ; 2 uses
  ...
  store <8 x i8> %interleaved.vec87, ptr %i.an, align 1, !tbaa !10, !alias.scope !95, !noalias !92
  %index.next88 = add nuw i64 %index84, 4         ; 2 uses
  %i.ap = icmp eq i64 %index.next88, %n.vec83
  br i1 %i.ap, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !97
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  br i1 %i.bb, label %.lr.ph, label %.loopexit.thread, !llvm.loop !98
...
bb.ay:                                            ; preds = %BIT_reloadDStream.exit.i.i
  ...
  br i1 %i.kk, label %BIT_reloadDStream.exit80.split.loop.exit450.i.i, label %.lr.ph.i, !llvm.loop !99
...
bb.cc:                                            ; preds = %BIT_reloadDStream.exit137.i.i
  ...
  br i1 %i.sl, label %BIT_reloadDStream.exit174.split.loop.exit490.i.i, label %.lr.ph113.i, !llvm.loop !99
...
bb.cl:                                            ; preds = %.lr.ph166
  ...
  br i1 %i.vc, label %.lr.ph166, label %._crit_edge, !llvm.loop !100
...
.lr.ph190:                                        ; preds = %bb.l, %.lr.ph190
  ...
  br i1 %i.bt, label %.lr.ph190, label %._crit_edge191, !llvm.loop !103
...
._crit_edge191:                                   ; preds = %.lr.ph190, %bb.l
  ...
  br i1 %i.cd, label %bb.c, label %.critedge, !llvm.loop !104
...
bb.e:                                             ; preds = %BIT_reloadDStream.exit
  ...
  br i1 %i.cd, label %.preheader55, label %.lr.ph5, !llvm.loop !105
...
bb.i:                                             ; preds = %BIT_reloadDStream.exit50
  ...
  br i1 %i.dq, label %BIT_reloadDStream.exit50.thread, label %.lr.ph13, !llvm.loop !106
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  br i1 %i.ec, label %.lr.ph, label %._crit_edge, !llvm.loop !107
...
bb.e:                                             ; preds = %BIT_reloadDStream.exit
  ...
  br i1 %i.cs, label %.preheader68, label %.lr.ph4, !llvm.loop !108
