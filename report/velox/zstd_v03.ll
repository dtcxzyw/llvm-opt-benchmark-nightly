...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load.a = load <8 x i8>, ptr %i.aa, align 1, !tbaa !10, !alias.scope !92
  %wide.load78.a = load <8 x i8>, ptr %i.ab, align 1, !tbaa !10, !alias.scope !92
  ...
  %wide.load79 = load <8 x i8>, ptr %i.aa, align 1, !tbaa !10, !alias.scope !92
  %wide.load80 = load <8 x i8>, ptr %i.ab, align 1, !tbaa !10, !alias.scope !92
  ...
  store <16 x i8> %interleaved.vec.a, ptr %7, align 1, !tbaa !10, !alias.scope !95, !noalias !92
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.ap, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !98
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  br i1 %i.bb, label %.lr.ph, label %.loopexit.thread, !llvm.loop !99
...
bb.ay:                                            ; preds = %BIT_reloadDStream.exit.i.i
  ...
  br i1 %i.kk, label %BIT_reloadDStream.exit80.split.loop.exit450.i.i, label %.lr.ph.i, !llvm.loop !100
...
bb.cc:                                            ; preds = %BIT_reloadDStream.exit137.i.i
  ...
  br i1 %i.sl, label %BIT_reloadDStream.exit174.split.loop.exit490.i.i, label %.lr.ph113.i, !llvm.loop !100
...
bb.cl:                                            ; preds = %.lr.ph166
  ...
  br i1 %i.vc, label %.lr.ph166, label %._crit_edge, !llvm.loop !101
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  br i1 %i.z, label %.lr.ph, label %.preheader162, !llvm.loop !102
...
.lr.ph178:                                        ; preds = %.preheader162, %.lr.ph178
  ...
  br i1 %i.ae, label %.lr.ph178, label %._crit_edge, !llvm.loop !103
...
.lr.ph190:                                        ; preds = %bb.l, %.lr.ph190
  ...
  br i1 %i.bt, label %.lr.ph190, label %._crit_edge191, !llvm.loop !104
...
._crit_edge191:                                   ; preds = %.lr.ph190, %bb.l
  ...
  br i1 %i.cd, label %bb.c, label %.critedge, !llvm.loop !105
...
bb.e:                                             ; preds = %BIT_reloadDStream.exit
  ...
  br i1 %i.cd, label %.preheader55, label %.lr.ph5, !llvm.loop !106
...
bb.i:                                             ; preds = %BIT_reloadDStream.exit50
  ...
  br i1 %i.dq, label %BIT_reloadDStream.exit50.thread, label %.lr.ph13, !llvm.loop !107
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  br i1 %i.ec, label %.lr.ph, label %._crit_edge, !llvm.loop !108
...
bb.e:                                             ; preds = %BIT_reloadDStream.exit
  ...
  br i1 %i.cs, label %.preheader68, label %.lr.ph4, !llvm.loop !109
...
bb.i:                                             ; preds = %BIT_reloadDStream.exit62
  ...
  br i1 %i.ei, label %.preheader, label %.lr.ph12, !llvm.loop !110
