...
bb.bz:                                            ; preds = %ZSTD_execSequence.exit.i, %.lr.ph.i
  %.060202.i = phi ptr [ %1, %.lr.ph.i ], [ %i.ach, %ZSTD_execSequence.exit.i ] ; 10 uses
...
begin_hunk_2_@ZSTD_decompressBlock:bb.a
  %i.yo = getelementptr inbounds nuw i8, ptr %.0.i.i.i, i64 8
  %i.yp = icmp ult ptr %i.yn, %i.xj
  br i1 %i.yp, label %.preheader.i.i, label %ZSTD_wildcopy.exit.i.i, !llvm.loop !46

ZSTD_wildcopy.exit.i.i:                           ; preds = %.preheader.i.i, %middle.block169
  %i.yq = sub nsw i64 0, %.058.i.i
  %i.yr = getelementptr inbounds i8, ptr %i.xj, i64 %i.yq ; 8 uses
  %i.ys = icmp ugt i64 %.058.i.i, %i.xu
  %i.yt = icmp ult ptr %i.yr, %i.co
  %or.cond.i.i16 = select i1 %i.ys, i1 true, i1 %i.yt
  br i1 %or.cond.i.i16, label %ZSTD_decompressSequences.exit, label %bb.cu

bb.cu:                                            ; preds = %ZSTD_wildcopy.exit.i.i
  %i.yu = icmp samesign ult i64 %.058.i.i, 8
  br i1 %i.yu, label %bb.cv, label %bb.cw

bb.cv:                                            ; preds = %bb.cu
  %i.yv = getelementptr inbounds nuw [4 x i8], ptr @ZSTD_execSequence.dec64table, i64 %.058.i.i
  %i.yw = load i32, ptr %i.yv, align 4, !tbaa !3
  %i.yx = load i8, ptr %i.yr, align 1, !tbaa !9
  store i8 %i.yx, ptr %i.xj, align 1, !tbaa !9
  %i.yy = getelementptr inbounds nuw i8, ptr %i.yr, i64 1
  %i.yz = load i8, ptr %i.yy, align 1, !tbaa !9
  %i.za = getelementptr inbounds nuw i8, ptr %i.xj, i64 1
  store i8 %i.yz, ptr %i.za, align 1, !tbaa !9
  %i.zb = getelementptr inbounds nuw i8, ptr %i.yr, i64 2
  %i.zc = load i8, ptr %i.zb, align 1, !tbaa !9
  %i.zd = getelementptr inbounds nuw i8, ptr %i.xj, i64 2
  store i8 %i.zc, ptr %i.zd, align 1, !tbaa !9
  %i.ze = getelementptr inbounds nuw i8, ptr %i.yr, i64 3
  %i.zf = load i8, ptr %i.ze, align 1, !tbaa !9
  %i.zg = getelementptr inbounds nuw i8, ptr %i.xj, i64 3
  store i8 %i.zf, ptr %i.zg, align 1, !tbaa !9
  %i.zh = getelementptr inbounds nuw [4 x i8], ptr @ZSTD_execSequence.dec32table, i64 %.058.i.i
  %i.zi = load i32, ptr %i.zh, align 4, !tbaa !3
  %i.zj = sext i32 %i.zi to i64
  %i.zk = getelementptr inbounds i8, ptr %i.yr, i64 %i.zj ; 2 uses
  %i.zl = getelementptr inbounds nuw i8, ptr %i.xj, i64 4
  %.val79.i.i = load i32, ptr %i.zk, align 1
  store i32 %.val79.i.i, ptr %i.zl, align 1
  %i.zm = sext i32 %i.yw to i64
  %i.zn = sub nsw i64 0, %i.zm
  %i.zo = getelementptr inbounds i8, ptr %i.zk, i64 %i.zn
  br label %bb.cx

bb.cw:                                            ; preds = %bb.cu
  %.val.i100.i = load i64, ptr %i.yr, align 1
  store i64 %.val.i100.i, ptr %i.xj, align 1
  br label %bb.cx

bb.cx:                                            ; preds = %bb.cw, %bb.cv
  %.065.i.i = phi ptr [ %i.zo, %bb.cv ], [ %i.yr, %bb.cw ] ; 2 uses
  %.065.i.i118 = ptrtoaddr ptr %.065.i.i to i64   ; 2 uses
  %i.zp = getelementptr inbounds nuw i8, ptr %i.xj, i64 8 ; 11 uses
  %i.zq = getelementptr inbounds nuw i8, ptr %.065.i.i, i64 8 ; 10 uses
  %i.zr = icmp ugt ptr %i.xk, %i.ti
  br i1 %i.zr, label %bb.cy, label %.preheader186.i.preheader

.preheader186.i.preheader:                        ; preds = %bb.cx
  %i.zs = add nsw i64 %.1.i.i, 4
  %i.zt = add nsw i64 %i.zs, %.160.i.i
  %i.zu = add i64 %i.zt, %i.xn
  %i.zv = add nsw i64 %.1.i.i, 16
  %i.zw = add i64 %i.zv, %i.xn
  %umax137 = tail call i64 @llvm.umax.i64(i64 %i.zu, i64 %i.zw)
  %i.zx = add i64 %umax137, -9
  %i.zy = add i64 %.1.i.i, %i.xn
  %i.zz = sub i64 %i.zx, %i.zy                    ; 2 uses
  %i.aaa = lshr i64 %i.zz, 3
  %i.aab = add nuw nsw i64 %i.aaa, 1              ; 2 uses
  %min.iters.check139 = icmp ult i64 %i.zz, 56
...
vector.memcheck135:                               ; preds = %.preheader186.i.preheader
  %i.aac = add i64 %.1.i.i, %i.xn
  %i.aad = sub i64 %.065.i.i118, %i.aac
  %diff.check136 = icmp ugt i64 %i.aad, -32
  br i1 %diff.check136, label %.preheader186.i.preheader174, label %vector.ph140

vector.ph140:                                     ; preds = %vector.memcheck135
  %n.vec142 = and i64 %i.aab, 4611686018427387900 ; 3 uses
  %i.aae = shl i64 %n.vec142, 3                   ; 2 uses
  %i.aaf = getelementptr i8, ptr %i.zp, i64 %i.aae
  %i.aag = getelementptr i8, ptr %i.zq, i64 %i.aae
...
vector.body143:                                   ; preds = %vector.body143, %vector.ph140
  ...
  %i.aah = shl i64 %index144, 3                   ; 2 uses
  %next.gep145 = getelementptr i8, ptr %i.zp, i64 %i.aah ; 2 uses
  %next.gep146 = getelementptr i8, ptr %i.zq, i64 %i.aah ; 2 uses
  %i.aai = getelementptr i8, ptr %next.gep146, i64 16
  %wide.load147 = load <2 x i64>, ptr %next.gep146, align 1
  %wide.load148 = load <2 x i64>, ptr %i.aai, align 1
  %i.aaj = getelementptr i8, ptr %next.gep145, i64 16
  store <2 x i64> %wide.load147, ptr %next.gep145, align 1
  store <2 x i64> %wide.load148, ptr %i.aaj, align 1
  %index.next149 = add nuw i64 %index144, 4       ; 2 uses
  %i.aak = icmp eq i64 %index.next149, %n.vec142
  br i1 %i.aak, label %middle.block150, label %vector.body143, !llvm.loop !47

middle.block150:                                  ; preds = %vector.body143
  %cmp.n151 = icmp eq i64 %i.aab, %n.vec142
...
.preheader186.i.preheader174:                     ; preds = %vector.memcheck135, %.preheader186.i.preheader, %middle.block150
  %.09.i84.i.i.ph = phi ptr [ %i.zp, %vector.memcheck135 ], [ %i.zp, %.preheader186.i.preheader ], [ %i.aaf, %middle.block150 ]
  %.0.i85.i.i.ph = phi ptr [ %i.zq, %vector.memcheck135 ], [ %i.zq, %.preheader186.i.preheader ], [ %i.aag, %middle.block150 ]
  br label %.preheader186.i

bb.cy:                                            ; preds = %bb.cx
  %i.aal = icmp ult ptr %i.zp, %i.te
  br i1 %i.aal, label %.preheader.i.preheader, label %bb.cz

.preheader.i.preheader:                           ; preds = %bb.cy
  %i.aam = add nsw i64 %.1.i.i, 16
  %i.aan = add i64 %i.aam, %i.xn
  %umax120 = tail call i64 @llvm.umax.i64(i64 %i.tj, i64 %i.aan)
  %i.aao = add i64 %umax120, -9
  %i.aap = add i64 %.1.i.i, %i.xn
  %i.aaq = sub i64 %i.aao, %i.aap                 ; 2 uses
  %i.aar = lshr i64 %i.aaq, 3
  %i.aas = add nuw nsw i64 %i.aar, 1              ; 2 uses
  %min.iters.check121 = icmp ult i64 %i.aaq, 56
...
vector.memcheck117:                               ; preds = %.preheader.i.preheader
  %i.aat = add i64 %.1.i.i, %i.xn
  %i.aau = sub i64 %.065.i.i118, %i.aat
  %diff.check119 = icmp ugt i64 %i.aau, -32
  br i1 %diff.check119, label %.preheader.i.preheader173, label %vector.ph122

vector.ph122:                                     ; preds = %vector.memcheck117
  %n.vec124 = and i64 %i.aas, 4611686018427387900 ; 3 uses
  %i.aav = shl i64 %n.vec124, 3                   ; 2 uses
  %i.aaw = getelementptr i8, ptr %i.zp, i64 %i.aav
  %i.aax = getelementptr i8, ptr %i.zq, i64 %i.aav
...
vector.body125:                                   ; preds = %vector.body125, %vector.ph122
  ...
  %i.aay = shl i64 %index126, 3                   ; 2 uses
  %next.gep127 = getelementptr i8, ptr %i.zp, i64 %i.aay ; 2 uses
  %next.gep128 = getelementptr i8, ptr %i.zq, i64 %i.aay ; 2 uses
  %i.aaz = getelementptr i8, ptr %next.gep128, i64 16
  %wide.load129 = load <2 x i64>, ptr %next.gep128, align 1
  %wide.load130 = load <2 x i64>, ptr %i.aaz, align 1
  %i.aba = getelementptr i8, ptr %next.gep127, i64 16
  store <2 x i64> %wide.load129, ptr %next.gep127, align 1
  store <2 x i64> %wide.load130, ptr %i.aba, align 1
  %index.next131 = add nuw i64 %index126, 4       ; 2 uses
  %i.abb = icmp eq i64 %index.next131, %n.vec124
  br i1 %i.abb, label %middle.block132, label %vector.body125, !llvm.loop !48

middle.block132:                                  ; preds = %vector.body125
  %cmp.n133 = icmp eq i64 %i.aas, %n.vec124
...
.preheader.i.preheader173:                        ; preds = %vector.memcheck117, %.preheader.i.preheader, %middle.block132
  %.09.i80.i.i.ph = phi ptr [ %i.zp, %vector.memcheck117 ], [ %i.zp, %.preheader.i.preheader ], [ %i.aaw, %middle.block132 ]
  %.0.i81.i.i.ph = phi ptr [ %i.zq, %vector.memcheck117 ], [ %i.zq, %.preheader.i.preheader ], [ %i.aax, %middle.block132 ]
  br label %.preheader.i

.preheader.i:                                     ; preds = %.preheader.i.preheader173, %.preheader.i
  %.09.i80.i.i = phi ptr [ %i.abc, %.preheader.i ], [ %.09.i80.i.i.ph, %.preheader.i.preheader173 ] ; 2 uses
  %.0.i81.i.i = phi ptr [ %i.abd, %.preheader.i ], [ %.0.i81.i.i.ph, %.preheader.i.preheader173 ] ; 2 uses
  %.0.val.i82.i.i = load i64, ptr %.0.i81.i.i, align 1
  store i64 %.0.val.i82.i.i, ptr %.09.i80.i.i, align 1
  %i.abc = getelementptr inbounds nuw i8, ptr %.09.i80.i.i, i64 8 ; 2 uses
  %i.abd = getelementptr inbounds nuw i8, ptr %.0.i81.i.i, i64 8
  %i.abe = icmp ult ptr %i.abc, %i.te
  br i1 %i.abe, label %.preheader.i, label %ZSTD_wildcopy.exit83.i.i, !llvm.loop !49

ZSTD_wildcopy.exit83.i.i:                         ; preds = %.preheader.i, %middle.block132
  %i.abf = ptrtoint ptr %i.zp to i64
  %i.abg = sub i64 %i.tj, %i.abf
  %i.abh = getelementptr inbounds i8, ptr %i.zq, i64 %i.abg
  br label %bb.cz

bb.cz:                                            ; preds = %ZSTD_wildcopy.exit83.i.i, %bb.cy
  %.068.i.i = phi ptr [ %i.te, %ZSTD_wildcopy.exit83.i.i ], [ %i.zp, %bb.cy ] ; 7 uses
  %.166.i.i = phi ptr [ %i.abh, %ZSTD_wildcopy.exit83.i.i ], [ %i.zq, %bb.cy ] ; 7 uses
  %.166.i.i101 = ptrtoaddr ptr %.166.i.i to i64
  %i.abi = icmp ult ptr %.068.i.i, %i.xk
  br i1 %i.abi, label %iter.check, label %ZSTD_execSequence.exit.i

iter.check:                                       ; preds = %bb.cz
  %i.abj = add nsw i64 %.1.i.i, 4
  %i.abk = add nsw i64 %i.abj, %.160.i.i
  %i.abl = add i64 %i.abk, %i.xn
  %i.abm = add nsw i64 %.1.i.i, 8
  %i.abn = add i64 %i.abm, %i.xn
  %umax102 = tail call i64 @llvm.umax.i64(i64 %i.tj, i64 %i.abn)
  %i.abo = sub i64 %i.abl, %umax102               ; 7 uses
  %min.iters.check = icmp ult i64 %i.abo, 4
  br i1 %min.iters.check, label %.lr.ph.i.i.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %iter.check
  %i.abp = add nsw i64 %.1.i.i, 8
  %i.abq = add i64 %i.abp, %i.xn
  %umax = tail call i64 @llvm.umax.i64(i64 %i.tj, i64 %i.abq)
  %i.abr = sub i64 %.166.i.i101, %umax
  %diff.check = icmp ugt i64 %i.abr, -32
  br i1 %diff.check, label %.lr.ph.i.i.preheader, label %vector.main.loop.iter.check

vector.main.loop.iter.check:                      ; preds = %vector.memcheck
  %min.iters.check103 = icmp ult i64 %i.abo, 32
  br i1 %min.iters.check103, label %vec.epilog.ph, label %vector.ph

vector.ph:                                        ; preds = %vector.main.loop.iter.check
  %n.mod.vf = and i64 %i.abo, 28
  %n.vec = and i64 %i.abo, -32                    ; 5 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load105 = load <16 x i8>, ptr %i.abu, align 1, !tbaa !9
  %i.abv = getelementptr i8, ptr %next.gep104, i64 16
  store <16 x i8> %wide.load, ptr %next.gep104, align 1, !tbaa !9
  store <16 x i8> %wide.load105, ptr %i.abv, align 1, !tbaa !9
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.abw = icmp eq i64 %index.next, %n.vec
  br i1 %i.abw, label %middle.block, label %vector.body, !llvm.loop !50
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec108 = and i64 %i.abo, -4                  ; 4 uses
  %i.abx = getelementptr i8, ptr %.166.i.i, i64 %n.vec108
  %i.aby = getelementptr i8, ptr %.068.i.i, i64 %n.vec108
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.abz = icmp eq i64 %index.next113, %n.vec108
  br i1 %i.abz, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !52

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n114 = icmp eq i64 %i.abo, %n.vec108
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i
  ...
  %i.acb = load i8, ptr %.291.i.i, align 1, !tbaa !9
  %i.acc = getelementptr inbounds nuw i8, ptr %.16990.i.i, i64 1 ; 2 uses
  store i8 %i.acb, ptr %.16990.i.i, align 1, !tbaa !9
  %i.acd = icmp ult ptr %i.acc, %i.xk
  br i1 %i.acd, label %.lr.ph.i.i, label %ZSTD_execSequence.exit.i, !llvm.loop !53

.preheader186.i:                                  ; preds = %.preheader186.i.preheader174, %.preheader186.i
  %.09.i84.i.i = phi ptr [ %i.ace, %.preheader186.i ], [ %.09.i84.i.i.ph, %.preheader186.i.preheader174 ] ; 2 uses
  %.0.i85.i.i = phi ptr [ %i.acf, %.preheader186.i ], [ %.0.i85.i.i.ph, %.preheader186.i.preheader174 ] ; 2 uses
  %.0.val.i86.i.i = load i64, ptr %.0.i85.i.i, align 1
  store i64 %.0.val.i86.i.i, ptr %.09.i84.i.i, align 1
  %i.ace = getelementptr inbounds nuw i8, ptr %.09.i84.i.i, i64 8 ; 2 uses
  %i.acf = getelementptr inbounds nuw i8, ptr %.0.i85.i.i, i64 8
  %i.acg = icmp ult ptr %i.ace, %i.xk
  br i1 %i.acg, label %.preheader186.i, label %ZSTD_execSequence.exit.i, !llvm.loop !54

ZSTD_execSequence.exit.i:                         ; preds = %.preheader186.i, %.lr.ph.i.i, %middle.block150, %middle.block, %vec.epilog.middle.block, %bb.cz
  %i.ach = getelementptr inbounds nuw i8, ptr %.060202.i, i64 %i.xm
...
BIT_reloadDStream.exit.thread.i:                  ; preds = %BIT_reloadDStream.exit.i
  ...
  %i.ack = icmp ne ptr %.sroa.42112.8.i, %.786120.i.i
...
bb.da:                                            ; preds = %BIT_reloadDStream.exit.thread.i
  %i.acl = ptrtoint ptr %.0138199.i to i64
  %i.acm = sub i64 %i.tg, %i.acl                  ; 2 uses
  %i.acn = icmp ugt ptr %.0138199.i, %i.ck
  br i1 %i.acn, label %ZSTD_decompressSequences.exit, label %bb.db

bb.db:                                            ; preds = %bb.da
  %i.aco = getelementptr inbounds nuw i8, ptr %.060202.i, i64 %i.acm ; 3 uses
...
bb.de:                                            ; preds = %bb.dd
  tail call void @llvm.memmove.p0.p0.i64(ptr align 1 %.060202.i, ptr align 1 %.0138199.i, i64 %i.acm, i1 false)
  br label %bb.df

bb.df:                                            ; preds = %bb.de, %bb.dd, %bb.dc
  %.464.i = phi ptr [ %i.aco, %bb.dd ], [ %.060202.i, %bb.dc ], [ %i.aco, %bb.de ]
  %i.acq = ptrtoint ptr %.464.i to i64
  %i.acr = ptrtoint ptr %1 to i64
