...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.bb = shl i32 %i.ba, 2
  %wide.load29 = load <8 x i32>, ptr %next.gep28, align 4, !tbaa !32
  %i.bc = sext i32 %i.bb to i64
  %i.bd = getelementptr i8, ptr %2, i64 %i.bc
  %i.be = getelementptr i8, ptr %i.bd, i64 4
  store <8 x i32> %wide.load29, ptr %i.be, align 4, !tbaa !32
  %index.next30 = add nuw i64 %index27, 8         ; 2 uses
  %i.bf = icmp eq i64 %index.next30, %n.vec26
  br i1 %i.bf, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !70
...
bb.a:
  ...
  %i.d = load ptr, ptr %i.a, align 8, !tbaa !31   ; 3 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #17, !noalias !87
  store i64 0, ptr %3, align 16, !tbaa !22, !alias.scope !88, !noalias !87
  %i.b = getelementptr inbounds nuw i8, ptr %3, i64 16
  store i32 0, ptr %i.b, align 16, !tbaa !22, !noalias !87
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #17, !noalias !87
...
bb.d:                                             ; preds = %bb.b
  %i.c = landingpad { ptr, i32 }
          cleanup
  %i.d = load ptr, ptr %4, align 8, !tbaa !28     ; 2 uses
...
bb.e:                                             ; preds = %bb.a
  ...
  %i.m = load ptr, ptr %i.j, align 8, !tbaa !31   ; 2 uses
  ...
  br i1 %.not.i, label %bb.f, label %_ZN8facebook5velox12StlAllocatorIjEC2EPNS0_19HashStringAllocatorE.exit, !prof !20
...
_ZNSt6vectorIjN8facebook5velox12StlAllocatorIjEEE17_S_check_init_lenEmRKS3_.exit.i: ; preds = %_ZN8facebook5velox12StlAllocatorIjEC2EPNS0_19HashStringAllocatorE.exit
  ...
  store i64 %i.u, ptr %5, align 8, !tbaa !21
...
.lr.ph.preheader.i.i.i:                           ; preds = %_ZNSt6vectorIjN8facebook5velox12StlAllocatorIjEEE17_S_check_init_lenEmRKS3_.exit.i
  ...
  call void @llvm.memset.p0.i64(ptr align 4 %i.w, i8 0, i64 %i.y, i1 false), !tbaa !32
...
_ZNSt6vectorIjN8facebook5velox12StlAllocatorIjEEEC2EmRKS3_.exit: ; preds = %_ZNSt12_Vector_baseIjN8facebook5velox12StlAllocatorIjEEEC2EmRKS3_.exit.thread.i, %.lr.ph.preheader.i.i.i
  ...
  store ptr %.sink.i, ptr %i.aa, align 8, !tbaa !38
  store ptr %.0.lcssa.i.i.i, ptr %i.z, align 8, !tbaa !41
...
.lr.ph:                                           ; preds = %_ZNSt6vectorIjN8facebook5velox12StlAllocatorIjEEEC2EmRKS3_.exit
  %i.ab = load ptr, ptr %i.j, align 8, !tbaa !31
...
iter.check:                                       ; preds = %.preheader64
  %i.ag = load ptr, ptr %i.j, align 8, !tbaa !31  ; 4 uses
  %i.ah = load ptr, ptr %i.v, align 8, !tbaa !31  ; 4 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <8 x i32>, ptr %gep, align 4, !tbaa !32
  %wide.load131 = load <8 x i32>, ptr %i.au, align 4, !tbaa !32
  %wide.load132 = load <8 x i32>, ptr %i.av, align 4, !tbaa !32
  %wide.load133 = load <8 x i32>, ptr %i.aw, align 4, !tbaa !32
  ...
  store <8 x i32> %wide.load, ptr %i.ax, align 4, !tbaa !32
  store <8 x i32> %wide.load131, ptr %i.ay, align 4, !tbaa !32
  store <8 x i32> %wide.load132, ptr %i.az, align 4, !tbaa !32
  store <8 x i32> %wide.load133, ptr %i.ba, align 4, !tbaa !32
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.bb = icmp eq i64 %index.next, %n.vec
  br i1 %i.bb, label %middle.block, label %vector.body, !llvm.loop !76
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load137 = load <8 x i32>, ptr %gep206, align 4, !tbaa !32
  %i.bf = getelementptr inbounds nuw [4 x i8], ptr %i.be, i64 %index136
  store <8 x i32> %wide.load137, ptr %i.bf, align 4, !tbaa !32
  %index.next138 = add nuw i64 %index136, 8       ; 2 uses
  %i.bg = icmp eq i64 %index.next138, %n.vec135
  br i1 %i.bg, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !77
...
bb.h:                                             ; preds = %.lr.ph, %bb.m
  ...
  %i.bk = load i32, ptr %i.bj, align 4, !tbaa !32 ; 4 uses
  %i.bl = lshr i32 %i.bk, 6                       ; 2 uses
  %i.bm = getelementptr inbounds [4 x i8], ptr %2, i64 %i.bh
  %i.bn = load i32, ptr %i.bm, align 4, !tbaa !32 ; 3 uses
...
bb.m:                                             ; preds = %bb.k, %bb.l, %bb.i
  ...
  store i32 %.sink, ptr %i.bz, align 4, !tbaa !32
  ...
  br i1 %i.ce, label %bb.h, label %.preheader64, !llvm.loop !78
...
iter.check160:                                    ; preds = %_ZNSt6vectorIjN8facebook5velox12StlAllocatorIjEEEC2EmRKS3_.exit, %.preheader
  ...
  %i.cg = load ptr, ptr %i.v, align 8, !tbaa !31  ; 4 uses
...
vector.body149:                                   ; preds = %vector.body149, %vector.ph147
  ...
  %wide.load151 = load <8 x i32>, ptr %i.cv, align 4, !tbaa !32
  %wide.load152 = load <8 x i32>, ptr %i.cw, align 4, !tbaa !32
  %wide.load153 = load <8 x i32>, ptr %i.cx, align 4, !tbaa !32
  %wide.load154 = load <8 x i32>, ptr %i.cy, align 4, !tbaa !32
  ...
  store <8 x i32> %wide.load151, ptr %i.cz, align 4, !tbaa !32
  store <8 x i32> %wide.load152, ptr %i.da, align 4, !tbaa !32
  store <8 x i32> %wide.load153, ptr %i.db, align 4, !tbaa !32
  store <8 x i32> %wide.load154, ptr %i.dc, align 4, !tbaa !32
  %index.next155 = add nuw i64 %index150, 32      ; 2 uses
  %i.dd = icmp eq i64 %index.next155, %n.vec148
  br i1 %i.dd, label %middle.block156, label %vector.body149, !llvm.loop !79
...
vec.epilog.iter.check162:                         ; preds = %middle.block156
  ...
  br i1 %min.epilog.iters.check163, label %vec.epilog.scalar.ph161.preheader, label %vec.epilog.ph164, !prof !36
...
vec.epilog.vector.body166:                        ; preds = %vec.epilog.vector.body166, %vec.epilog.ph164
  ...
  %wide.load168 = load <8 x i32>, ptr %i.di, align 4, !tbaa !32
  %i.dj = getelementptr inbounds nuw [4 x i8], ptr %i.dh, i64 %index167
  store <8 x i32> %wide.load168, ptr %i.dj, align 4, !tbaa !32
  %index.next169 = add nuw i64 %index167, 8       ; 2 uses
  %i.dk = icmp eq i64 %index.next169, %n.vec165
  br i1 %i.dk, label %vec.epilog.middle.block170, label %vec.epilog.vector.body166, !llvm.loop !80
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph
  ...
  store i32 %i.dm, ptr %i.dn, align 4, !tbaa !32
  %i.do = icmp ugt i64 %i.q, %indvars.iv.next86
  br i1 %i.do, label %vec.epilog.scalar.ph, label %.preheader, !llvm.loop !81
...
vec.epilog.scalar.ph161:                          ; preds = %vec.epilog.scalar.ph161.preheader, %vec.epilog.scalar.ph161
  ...
  store i32 %i.dq, ptr %i.dr, align 4, !tbaa !32
  %i.ds = icmp ugt i64 %1, %indvars.iv.next93
  br i1 %i.ds, label %vec.epilog.scalar.ph161, label %._crit_edge, !llvm.loop !82
...
._crit_edge:                                      ; preds = %vec.epilog.scalar.ph161, %middle.block156, %vec.epilog.middle.block170, %.preheader
  ...
  %i.du = load ptr, ptr %i.k, align 8, !tbaa !41  ; 2 uses
  %i.dv = load ptr, ptr %i.j, align 8, !tbaa !31  ; 2 uses
...
bb.q:                                             ; preds = %bb.p
  store ptr %i.ed, ptr %i.k, align 8, !tbaa !41
  br label %iter.check192

iter.check192:                                    ; preds = %bb.q, %bb.p, %bb.o, %bb.n
  %.pre102 = load ptr, ptr %i.v, align 8, !tbaa !31 ; 8 uses
  %i.ee = load ptr, ptr %i.j, align 8, !tbaa !31  ; 8 uses
...
vector.body182:                                   ; preds = %vector.body182, %vector.ph180
  ...
  %wide.load184 = load <8 x i32>, ptr %i.ei, align 4, !tbaa !32
  %wide.load185 = load <8 x i32>, ptr %i.ej, align 4, !tbaa !32
  %wide.load186 = load <8 x i32>, ptr %i.ek, align 4, !tbaa !32
  %wide.load187 = load <8 x i32>, ptr %i.el, align 4, !tbaa !32
  ...
  store <8 x i32> %wide.load184, ptr %i.em, align 4, !tbaa !32
  store <8 x i32> %wide.load185, ptr %i.en, align 4, !tbaa !32
  store <8 x i32> %wide.load186, ptr %i.eo, align 4, !tbaa !32
  store <8 x i32> %wide.load187, ptr %i.ep, align 4, !tbaa !32
  %index.next188 = add nuw i64 %index183, 32      ; 2 uses
  %i.eq = icmp eq i64 %index.next188, %n.vec181
  br i1 %i.eq, label %middle.block189, label %vector.body182, !llvm.loop !83
