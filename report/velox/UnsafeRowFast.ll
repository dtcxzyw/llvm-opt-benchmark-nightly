...
.loopexit:                                        ; preds = %.noexc8, %_ZNSt12_Vector_baseImSaImEEC2EmRKS0_.exit.thread.i
  ...
  %i.o = phi ptr [ null, %_ZNSt12_Vector_baseImSaImEEC2EmRKS0_.exit.thread.i ], [ %i.i, %.noexc8 ] ; 2 uses
  %i.p = getelementptr inbounds nuw i8, ptr %4, i64 8
  store ptr %i.o, ptr %i.p, align 8, !tbaa !167
...
bb.p:                                             ; preds = %bb.o
  %i.bk = ptrtoint ptr %i.o to i64
  %i.bl = ptrtoint ptr %7 to i64
  %i.bm = sub i64 %i.bk, %i.bl
  call void @_ZdlPvm(ptr noundef nonnull %7, i64 noundef %i.bm) #27
end_hunk_3
