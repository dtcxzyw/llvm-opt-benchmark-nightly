...
bb.b:                                             ; preds = %bb.a
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %2, ptr noundef nonnull align 8 dereferenceable(24) %i.b, i64 24, i1 false), !tbaa.struct !10
  br label %bb.d
...
bb.a:
  ...
  %i.b = load double, ptr %0, align 8, !tbaa !12  ; 10 uses
...
_ZNK4geos4geom11LineSegment16projectionFactorERKNS0_10CoordinateE.exit: ; preds = %bb.a, %bb.b, %bb.c
  ...
  %i.aa = load double, ptr %i.z, align 8, !tbaa !12 ; 3 uses
...
bb.a:
  ...
  %4 = load <2 x double>, ptr %0, align 8         ; 5 uses
  %i.b = load double, ptr %i.a, align 8           ; 4 uses
  %5 = extractelement <2 x double> %4, i64 0      ; 2 uses
  %6 = fcmp oeq <2 x double> %3, %4
  %7 = extractelement <2 x i1> %6, i64 0
  %8 = extractelement <2 x double> %3, i64 1      ; 3 uses
  %i.c = fcmp oeq double %8, %i.b
  %.0.i.i.i = select i1 %7, i1 %i.c, i1 false
  %.phi.trans.insert = getelementptr inbounds nuw i8, ptr %0, i64 24
  %.pre = load double, ptr %.phi.trans.insert, align 8, !tbaa !12 ; 3 uses
...
bb.b:                                             ; preds = %bb.a
  %9 = extractelement <2 x double> %3, i64 0
  %i.d = fcmp oeq double %9, %.pre
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.f = load double, ptr %i.e, align 8           ; 4 uses
  %i.g = fcmp oeq double %8, %i.f
  %.0.i.i14.i = select i1 %i.d, i1 %i.g, i1 false
...
_ZNK4geos4geom11LineSegment16projectionFactorERKNS0_10CoordinateE.exit: ; preds = %bb.b
  %i.h = fsub double %.pre, %5                    ; 4 uses
  %i.i = fsub double %i.f, %i.b                   ; 4 uses
  %i.j = fmul double %i.h, %i.h
  %i.k = fmul double %i.i, %i.i
  %i.l = fadd double %i.j, %i.k
  %foldExtExtBinop = fsub <2 x double> %3, %4
  %10 = extractelement <2 x double> %foldExtExtBinop, i64 0
  %i.m = fmul double %10, %i.h
  %i.n = fsub double %8, %i.b
  %i.o = fmul double %i.n, %i.i
  %i.p = fadd double %i.m, %i.o
  %i.q = fdiv double %i.p, %i.l                   ; 4 uses
  %i.r = fcmp ogt double %i.q, 0.000000e+00
  %i.s = fcmp olt double %i.q, 1.000000e+00
...
_ZNK4geos4geom11LineSegment7projectEdRNS0_10CoordinateE.exit: ; preds = %_ZNK4geos4geom11LineSegment16projectionFactorERKNS0_10CoordinateE.exit
  %i.t = fmul double %i.q, %i.h
  %i.u = fadd double %5, %i.t
  %i.v = fmul double %i.q, %i.i
  %i.w = fadd double %i.b, %i.v
  store double %i.u, ptr %2, align 8, !tbaa !9
  %.sroa.4.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %2, i64 8
  store double %i.w, ptr %.sroa.4.0..sroa_idx.i, align 8, !tbaa !9
...
_ZNK4geos4geom11LineSegment16projectionFactorERKNS0_10CoordinateE.exit.thread: ; preds = %._ZNK4geos4geom11LineSegment16projectionFactorERKNS0_10CoordinateE.exit.thread_crit_edge, %bb.b, %_ZNK4geos4geom11LineSegment16projectionFactorERKNS0_10CoordinateE.exit
  %i.x = phi double [ %.pre17, %._ZNK4geos4geom11LineSegment16projectionFactorERKNS0_10CoordinateE.exit.thread_crit_edge ], [ %i.f, %bb.b ], [ %i.f, %_ZNK4geos4geom11LineSegment16projectionFactorERKNS0_10CoordinateE.exit ]
  %i.y = insertelement <2 x double> %4, double %.pre, i64 1
  %i.z = shufflevector <2 x double> %3, <2 x double> poison, <2 x i32> zeroinitializer
  %i.aa = fsub <2 x double> %i.y, %i.z            ; 2 uses
  %i.ab = shufflevector <2 x double> %4, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %i.ac = insertelement <2 x double> %i.ab, double %i.x, i64 1
  %11 = shufflevector <2 x double> %3, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.ad = fsub <2 x double> %i.ac, %11            ; 2 uses
  %i.ae = fmul <2 x double> %i.aa, %i.aa
  %i.af = fmul <2 x double> %i.ad, %i.ad
  %i.ag = fadd <2 x double> %i.ae, %i.af
  ...
  %i.ai = fcmp olt <2 x double> %i.ah, %shift
...
bb.c:                                             ; preds = %_ZNK4geos4geom11LineSegment16projectionFactorERKNS0_10CoordinateE.exit.thread
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %2, ptr noundef nonnull align 8 dereferenceable(24) %0, i64 24, i1 false), !tbaa.struct !10
  br label %bb.e

bb.d:                                             ; preds = %_ZNK4geos4geom11LineSegment16projectionFactorERKNS0_10CoordinateE.exit.thread
  %i.ak = getelementptr inbounds nuw i8, ptr %0, i64 24
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %2, ptr noundef nonnull align 8 dereferenceable(24) %i.ak, i64 24, i1 false), !tbaa.struct !10
  br label %bb.e
...
bb.d:                                             ; preds = %_ZNK4geos4geom10Coordinate9compareToERKS1_.exit
  ...
  %i.m = load double, ptr %i.k, align 8, !tbaa !12 ; 2 uses
  %i.n = load double, ptr %i.l, align 8, !tbaa !12 ; 2 uses
...
._crit_edge:                                      ; preds = %bb.a
  ...
  %.pre = load double, ptr %.phi.trans.insert, align 8, !tbaa !12
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.k = load double, ptr %i.i, align 8, !tbaa !12
  %i.l = load double, ptr %i.j, align 8, !tbaa !12 ; 2 uses
...
_ZNK4geos4geom11LineSegment12intersectionERKS1_.exit:
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #15, !noalias !35
  %i.a = getelementptr inbounds nuw i8, ptr %3, i64 8
  %.ptr.i.i = getelementptr inbounds nuw i8, ptr %3, i64 48 ; 2 uses
  %i.b = getelementptr inbounds nuw i8, ptr %3, i64 64 ; 2 uses
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %.ptr.i.i, i8 0, i64 16, i1 false), !noalias !35
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %3, i8 0, i64 16, i1 false), !noalias !35
  store double +qnan, ptr %i.b, align 8, !tbaa !16, !noalias !35
  %.ptr.1.i.i = getelementptr inbounds nuw i8, ptr %3, i64 72
  %i.c = getelementptr inbounds nuw i8, ptr %3, i64 88
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %.ptr.1.i.i, i8 0, i64 16, i1 false), !noalias !35
  store double +qnan, ptr %i.c, align 8, !tbaa !16, !noalias !35
  %i.d = getelementptr inbounds nuw i8, ptr %3, i64 128
  store i8 0, ptr %i.d, align 8, !tbaa !22, !noalias !35
  %i.e = getelementptr inbounds nuw i8, ptr %1, i64 24 ; 3 uses
  %i.f = getelementptr inbounds nuw i8, ptr %2, i64 24 ; 3 uses
  call void @_ZN4geos9algorithm15LineIntersector19computeIntersectionERKNS_4geom10CoordinateES5_S5_S5_(ptr noundef nonnull align 8 dereferenceable(129) %3, ptr noundef nonnull align 8 dereferenceable(48) %1, ptr noundef nonnull align 8 dereferenceable(24) %i.e, ptr noundef nonnull align 8 dereferenceable(48) %2, ptr noundef nonnull align 8 dereferenceable(24) %i.f), !noalias !35
  %i.g = load i64, ptr %i.a, align 8, !tbaa !23, !noalias !35
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #15, !noalias !35
...
bb.b:                                             ; preds = %_ZNK4geos4geom11LineSegment12intersectionERKS1_.exit
  ...
  %.pre.i = load double, ptr %i.e, align 8, !tbaa !12 ; 13 uses
...
_ZNK4geos4geom11LineSegment12closestPointERKNS0_10CoordinateERS2_.exit: ; preds = %_ZNK4geos4geom11LineSegment7projectEdRNS0_10CoordinateE.exit.i, %bb.d, %bb.e
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %.ptr.1.i, ptr noundef nonnull align 8 dereferenceable(24) %2, i64 24, i1 false), !tbaa.struct !10
...
bb.i:                                             ; preds = %_ZNK4geos4geom11LineSegment12closestPointERKNS0_10CoordinateERS2_.exit37
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %.ptr.1.i, ptr noundef nonnull align 8 dereferenceable(24) %i.f, i64 24, i1 false), !tbaa.struct !10
  br label %bb.j
...
bb.m:                                             ; preds = %_ZNK4geos4geom11LineSegment12closestPointERKNS0_10CoordinateERS2_.exit54
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %0, ptr noundef nonnull align 8 dereferenceable(24) %1, i64 24, i1 false), !tbaa.struct !10
...
bb.r:                                             ; preds = %_ZNK4geos4geom11LineSegment12closestPointERKNS0_10CoordinateERS2_.exit71
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %0, ptr noundef nonnull align 8 dereferenceable(24) %i.e, i64 24, i1 false), !tbaa.struct !10
...
bb.a:
  ...
  store double +qnan, ptr %i.b, align 8, !tbaa !16
  ...
  store double +qnan, ptr %i.c, align 8, !tbaa !16
  %i.d = getelementptr inbounds nuw i8, ptr %3, i64 128
  ...
  %i.g = load i64, ptr %i.a, align 8, !tbaa !23
  %.not = icmp eq i64 %i.g, 0
  br i1 %.not, label %bb.c, label %bb.b

bb.b:                                             ; preds = %bb.a
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %0, ptr noundef nonnull align 8 dereferenceable(24) %.ptr.i, i64 24, i1 false), !tbaa.struct !10
  br label %bb.d

bb.c:                                             ; preds = %bb.a
  %i.h = getelementptr inbounds nuw i8, ptr %0, i64 16
  store <2 x double> splat (double +qnan), ptr %0, align 8, !tbaa !9
  store double +qnan, ptr %i.h, align 8, !tbaa !16
  br label %bb.d
