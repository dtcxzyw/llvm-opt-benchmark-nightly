...
vector.ph199:                                     ; preds = %vector.memcheck195
  ...
  %4 = load i64, ptr %3, align 4, !alias.scope !3169
  %broadcast.splatinsert205 = insertelement <2 x i64> poison, i64 %4, i64 0
  %broadcast.splat206 = shufflevector <2 x i64> %broadcast.splatinsert205, <2 x i64> poison, <2 x i32> zeroinitializer ; 2 uses
  %5 = shl i64 %n.vec201, 3
...
.lr.ph.i.i.i.i82.preheader:                       ; preds = %vector.memcheck195, %_ZNSt12_Vector_baseIN5arrow19DayTimeIntervalType15DayMillisecondsESaIS2_EE11_M_allocateEm.exit, %middle.block208
  %.09.i.i.i.i83.ph = phi ptr [ %i.cz, %vector.memcheck195 ], [ %i.cz, %_ZNSt12_Vector_baseIN5arrow19DayTimeIntervalType15DayMillisecondsESaIS2_EE11_M_allocateEm.exit ], [ %6, %middle.block208 ] ; 2 uses
  %.068.i.i.i.i84.ph = phi i64 [ %2, %vector.memcheck195 ], [ %2, %_ZNSt12_Vector_baseIN5arrow19DayTimeIntervalType15DayMillisecondsESaIS2_EE11_M_allocateEm.exit ], [ %7, %middle.block208 ] ; 4 uses
