...
_ZN8facebook5velox15ByteInputStream4readIiEET_v.exit: ; preds = %bb.b, %bb.c
  %.0.i = phi i32 [ %.0.copyload.i.i, %bb.b ], [ %i.n, %bb.c ] ; 7 uses
  %i.o = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 8 uses
  store ptr %i.o, ptr %0, align 8, !tbaa !286
  %i.p = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
  store i64 0, ptr %i.p, align 8, !tbaa !87
  store i8 0, ptr %i.o, align 8, !tbaa !40
  %i.q = sext i32 %.0.i to i64                    ; 5 uses
...
bb.f:                                             ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i.i.i.i
  %2 = icmp samesign ult i32 %.0.i, 30            ; 2 uses
  %3 = add nuw nsw i64 %i.q, 1
  %spec.select = select i1 %2, i64 31, i64 %3
  %4 = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %spec.select) #41
          to label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_S_moveEPcPKcm.exit.i.i.i.i.thread unwind label %bb.h ; 2 uses

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_S_moveEPcPKcm.exit.i.i.i.i.thread: ; preds = %bb.f
  %spec.select17 = select i1 %2, i64 30, i64 %i.q
  store ptr %4, ptr %0, align 8, !tbaa !44
  store i64 %spec.select17, ptr %i.o, align 8, !tbaa !40
  br label %bb.g
...
bb.g:                                             ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_S_moveEPcPKcm.exit.i.i.i.i.thread, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_S_moveEPcPKcm.exit.i.i.i.i
  %i.s = phi ptr [ %4, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_S_moveEPcPKcm.exit.i.i.i.i.thread ], [ %i.o, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_S_moveEPcPKcm.exit.i.i.i.i ] ; 2 uses
...
.sink.split.i.i:                                  ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_S_moveEPcPKcm.exit.i.i.i.i, %bb.g
  %i.t = phi ptr [ %i.s, %bb.g ], [ %i.o, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_S_moveEPcPKcm.exit.i.i.i.i ]
...
begin_hunk_3_@_ZN8facebook5velox10serializer6presto6detail12_GLOBAL__N_124readLengthPrefixedStringB5cxx11EPNS0_15ByteInputStreamE:bb.a
  invoke void %i.y(ptr noundef nonnull align 8 dereferenceable(16) %1, ptr noundef nonnull %i.v, i32 noundef %.0.i)
          to label %_ZN8facebook5velox15ByteInputStream9readBytesIcEEvPT_i.exit unwind label %bb.h, !inline_history !347

bb.h:                                             ; preds = %bb.f, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6resizeEm.exit, %bb.e
  %i.z = landingpad { ptr, i32 }
          cleanup
  %i.aa = load ptr, ptr %0, align 8, !tbaa !44    ; 2 uses
end_hunk_3
