...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.alq = shl i64 %index, 3
  %53 = and i64 %i.alq, 2305843009213693824
  %i.alr = getelementptr inbounds nuw i8, ptr %i.ali, i64 %53 ; 4 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.amm = shl i64 %index1290, 3
  %54 = and i64 %i.amm, 2305843009213693920
  %i.amn = getelementptr inbounds nuw i8, ptr %i.ali, i64 %54
...
vector.body71:                                    ; preds = %vector.body71, %vector.ph68
  ...
  %i.aq = shl i64 %index72, 3
  %5 = and i64 %i.aq, 2305843009213693824
  %i.ar = getelementptr inbounds nuw i8, ptr %i.l, i64 %5 ; 5 uses
...
vec.epilog.vector.body90:                         ; preds = %vec.epilog.vector.body90, %vec.epilog.ph87
  ...
  %i.bc = shl i64 %index91, 3
  %6 = and i64 %i.bc, 2305843009213693920
  %i.bd = getelementptr inbounds nuw i8, ptr %i.l, i64 %6 ; 2 uses
...
vector.body105:                                   ; preds = %vector.body105, %vector.ph102
  ...
  %7 = add i64 %i.bs, %index106
  %8 = and i64 %7, 2305843009213693944
  %i.bt = getelementptr inbounds nuw i8, ptr %i.l, i64 %8 ; 5 uses
...
vec.epilog.vector.body124:                        ; preds = %vec.epilog.vector.body124, %vec.epilog.ph121
  ...
  %9 = add i64 %i.cf, %index125
  %10 = and i64 %9, 2305843009213693944
  %i.cg = getelementptr inbounds nuw i8, ptr %i.l, i64 %10 ; 2 uses
...
vector.body139:                                   ; preds = %vector.body139, %vector.ph136
  ...
  %i.dz = shl i64 %index140, 3
  %11 = and i64 %i.dz, 2305843009213693824
  %i.ea = getelementptr inbounds nuw i8, ptr %i.l, i64 %11 ; 4 uses
...
vec.epilog.vector.body163:                        ; preds = %vec.epilog.vector.body163, %vec.epilog.ph160
  ...
  %i.ev = shl i64 %index164, 3
  %12 = and i64 %i.ev, 2305843009213693920
  %i.ew = getelementptr inbounds nuw i8, ptr %i.l, i64 %12
...
vector.body183:                                   ; preds = %vector.body183, %vector.ph180
  ...
  %i.w = shl i64 %index184, 3
  %6 = and i64 %i.w, 2305843009213693824
  %i.x = getelementptr inbounds nuw i8, ptr %3, i64 %6 ; 4 uses
...
vec.epilog.vector.body207:                        ; preds = %vec.epilog.vector.body207, %vec.epilog.ph204
  ...
  %i.as = shl i64 %index208, 3
  %7 = and i64 %i.as, 2305843009213693920
...
vector.body115:                                   ; preds = %vector.body115, %vector.ph112
  ...
  %i.eb = shl i64 %index116, 3
  %8 = and i64 %i.eb, 2305843009213693824
  %i.ec = getelementptr inbounds nuw i8, ptr %i.cy, i64 %8 ; 5 uses
...
vec.epilog.vector.body134:                        ; preds = %vec.epilog.vector.body134, %vec.epilog.ph131
  ...
  %i.en = shl i64 %index135, 3
  %9 = and i64 %i.en, 2305843009213693920
  %i.eo = getelementptr inbounds nuw i8, ptr %i.cy, i64 %9 ; 2 uses
...
vector.body149:                                   ; preds = %vector.body149, %vector.ph146
  ...
  %10 = add i64 %i.fd, %index150
  %11 = and i64 %10, 2305843009213693944
  %i.fe = getelementptr inbounds nuw i8, ptr %i.cy, i64 %11 ; 5 uses
...
vec.epilog.vector.body168:                        ; preds = %vec.epilog.vector.body168, %vec.epilog.ph165
  ...
  %12 = add i64 %i.fq, %index169
  %13 = and i64 %12, 2305843009213693944
  %i.fr = getelementptr inbounds nuw i8, ptr %i.cy, i64 %13 ; 2 uses
