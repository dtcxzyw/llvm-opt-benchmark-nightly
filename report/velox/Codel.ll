...
define { i64, i64 } @_ZNK5folly5Codel10getOptionsEv(ptr nofree noundef nonnull align 8 captures(none) dereferenceable(34) %0) local_unnamed_addr #4 align 2 {
bb.a:
...
define range(i64 -9223372036854775808, 9223372036854775807) i64 @_ZNK5folly5Codel16getSloughTimeoutENSt6chrono8durationIlSt5ratioILl1ELl1000EEEE(ptr nofree noundef nonnull readnone align 8 captures(none) dereferenceable(34) %0, i64 %1) local_unnamed_addr #5 align 2 {
bb.a:
  %i.a = shl nsw i64 %1, 1
  ret i64 %i.a
}
...
; Function Attrs: mustprogress norecurse nounwind willreturn uwtable
define noundef range(i32 -2147483648, 101) i32 @_ZN5folly5Codel7getLoadEv(ptr nofree noundef nonnull align 8 captures(none) dereferenceable(34) %0) local_unnamed_addr #3 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 24
...
; Function Attrs: mustprogress norecurse nounwind willreturn uwtable
define i64 @_ZN5folly5Codel11getMinDelayEv(ptr nofree noundef nonnull align 8 captures(none) dereferenceable(34) %0) local_unnamed_addr #3 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %i.a = load atomic i64, ptr %0 seq_cst, align 8
  ret i64 %i.a
}
...
; Function Attrs: mustprogress norecurse nounwind willreturn uwtable
define i64 @_ZN5folly5Codel15getIntervalTimeEv(ptr nofree noundef nonnull align 8 captures(none) dereferenceable(34) %0) local_unnamed_addr #3 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8
