...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %n.vec = and i64 %i.dd, 2305843009213693936     ; 5 uses
  %i.de = shl i64 %n.vec, 4
  %i.df = getelementptr i8, ptr %i.cz, i64 %i.de
  %3 = shl i64 %n.vec, 4
  %i.dg = getelementptr i8, ptr %.sroa.0.0, i64 %3
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec234 = and i64 %i.dd, 2305843009213693948  ; 4 uses
  %i.eh = shl i64 %n.vec234, 4
  %i.ei = getelementptr i8, ptr %i.cz, i64 %i.eh
  %4 = shl i64 %n.vec234, 4
  %i.ej = getelementptr i8, ptr %.sroa.0.0, i64 %4
