...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  br i1 %i.x, label %.lr.ph, label %._crit_edge, !llvm.loop !55
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ak = load i64, ptr %next.gep, align 8, !tbaa !14
  %i.al = load i64, ptr %next.gep97, align 8, !tbaa !14
...
vector.body111:                                   ; preds = %vector.body111, %vector.ph109
  ...
  %wide.load116 = load <2 x i64>, ptr %i.dw, align 8, !tbaa !14
  ...
  br i1 %i.eb, label %middle.block118, label %vector.body111, !llvm.loop !58
...
.lr.ph57:                                         ; preds = %.lr.ph57.preheader123, %.lr.ph57
  ...
  %i.ed = load i64, ptr %.156, align 8, !tbaa !14
  ...
  br i1 %i.eh, label %.lr.ph57, label %._crit_edge58, !llvm.loop !59
...
.lr.ph63:                                         ; preds = %._crit_edge58, %.lr.ph63
  ...
  br i1 %i.et, label %.lr.ph63, label %._crit_edge64, !llvm.loop !60
}
