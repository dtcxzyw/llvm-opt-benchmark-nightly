...
bb.a:
  ...
  %5 = alloca %"struct.facebook::velox::StringView", align 8 ; 8 uses
...
bb.r:                                             ; preds = %bb.o
  ...
  %.4..4..4..sroa_idx55 = getelementptr inbounds nuw i8, ptr %5, i64 4
  store i32 %i.di, ptr %.4..4..4..sroa_idx55, align 4
  %.4..4..4..sroa_idx56 = getelementptr inbounds nuw i8, ptr %5, i64 8
  store ptr %i.cp, ptr %.4..4..4..sroa_idx56, align 8, !tbaa !64
  br label %_ZN8facebook5velox10StringViewC2EPKci.exit
...
_ZN8facebook5velox10StringViewC2EPKci.exit:       ; preds = %bb.p, %bb.q, %bb.r
  ...
  %.8..8..8..fca.1.load = load ptr, ptr %.8..8..8..fca.1.gep.sroa_idx, align 8
  %.fca.1.insert = insertvalue { i64, ptr } %.fca.0.insert, ptr %.8..8..8..fca.1.load, 1
