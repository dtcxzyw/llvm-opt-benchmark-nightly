...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ds = getelementptr i8, ptr %i.dc, i64 -11
  %i.dt = getelementptr i8, ptr %i.dd, i64 -10
  %i.du = getelementptr i8, ptr %i.de, i64 -9
  %i.dv = load i32, ptr %i.dr, align 1, !alias.scope !62
  %i.dw = load i32, ptr %i.ds, align 1, !alias.scope !62
  %i.dx = load i32, ptr %i.dt, align 1, !alias.scope !62
  %i.dy = load i32, ptr %i.du, align 1, !alias.scope !62
  %i.dz = insertelement <4 x i32> poison, i32 %i.dv, i64 0
  %i.ea = insertelement <4 x i32> %i.dz, i32 %i.dw, i64 1
  %i.eb = insertelement <4 x i32> %i.ea, i32 %i.dx, i64 2
  %i.ec = insertelement <4 x i32> %i.eb, i32 %i.dy, i64 3
  %i.ed = getelementptr i8, ptr %i.db, i64 -8
  %i.ee = getelementptr i8, ptr %i.dc, i64 -7
  %i.ef = getelementptr i8, ptr %i.dd, i64 -6
  %i.eg = getelementptr i8, ptr %i.de, i64 -5
  %i.eh = load i32, ptr %i.ed, align 1, !alias.scope !62
  %i.ei = load i32, ptr %i.ee, align 1, !alias.scope !62
  %i.ej = load i32, ptr %i.ef, align 1, !alias.scope !62
  %i.ek = load i32, ptr %i.eg, align 1, !alias.scope !62
  %i.el = insertelement <4 x i32> poison, i32 %i.eh, i64 0
  %i.em = insertelement <4 x i32> %i.el, i32 %i.ei, i64 1
  %i.en = insertelement <4 x i32> %i.em, i32 %i.ej, i64 2
  %i.eo = insertelement <4 x i32> %i.en, i32 %i.ek, i64 3
  %i.ep = getelementptr i8, ptr %i.db, i64 -4
  %i.eq = getelementptr i8, ptr %i.dc, i64 -3
  %i.er = getelementptr i8, ptr %i.dd, i64 -2
  %i.es = getelementptr i8, ptr %i.de, i64 -1
  %i.et = load i32, ptr %i.ep, align 1, !alias.scope !62
  %i.eu = load i32, ptr %i.eq, align 1, !alias.scope !62
  %i.ev = load i32, ptr %i.er, align 1, !alias.scope !62
  ...
  %i.fa = insertelement <4 x i32> %i.ez, i32 %i.ew, i64 3
  %i.fb = and <4 x i32> %i.dq, %broadcast.splat
  %i.fc = and <4 x i32> %i.ec, %broadcast.splat156
  %i.fd = and <4 x i32> %i.eo, %broadcast.splat158
  %i.fe = and <4 x i32> %i.fa, %broadcast.splat160
  %i.ff = mul <4 x i32> %i.fb, splat (i32 -2048144777)
  %i.fg = add <4 x i32> %i.ff, splat (i32 606290984) ; 2 uses
  %i.fh = tail call <4 x i32> @llvm.fshl.v4i32(<4 x i32> %i.fg, <4 x i32> %i.fg, <4 x i32> splat (i32 13))
  %i.fi = mul <4 x i32> %i.fh, splat (i32 -1640531535) ; 2 uses
  %i.fj = mul <4 x i32> %i.fc, splat (i32 -2048144777)
  %i.fk = add <4 x i32> %i.fj, splat (i32 -2048144777) ; 2 uses
  %i.fl = tail call <4 x i32> @llvm.fshl.v4i32(<4 x i32> %i.fk, <4 x i32> %i.fk, <4 x i32> splat (i32 13))
  %i.fm = mul <4 x i32> %i.fl, splat (i32 -1640531535) ; 2 uses
  %i.fn = mul <4 x i32> %i.fd, splat (i32 -2048144777) ; 2 uses
  ...
  %i.fq = mul <4 x i32> %i.fe, splat (i32 -2048144777)
  %i.fr = add <4 x i32> %i.fq, splat (i32 1640531535) ; 2 uses
  %i.fs = tail call <4 x i32> @llvm.fshl.v4i32(<4 x i32> %i.fr, <4 x i32> %i.fr, <4 x i32> splat (i32 13))
  %i.ft = mul <4 x i32> %i.fs, splat (i32 -1640531535) ; 2 uses
  %i.fu = tail call <4 x i32> @llvm.fshl.v4i32(<4 x i32> %i.fi, <4 x i32> %i.fi, <4 x i32> splat (i32 1))
  %i.fv = tail call <4 x i32> @llvm.fshl.v4i32(<4 x i32> %i.fm, <4 x i32> %i.fm, <4 x i32> splat (i32 7))
  %i.fw = add <4 x i32> %i.fv, %i.fu
  %i.fx = tail call <4 x i32> @llvm.fshl.v4i32(<4 x i32> %i.fp, <4 x i32> %i.fp, <4 x i32> splat (i32 12))
  %i.fy = add <4 x i32> %i.fw, %i.fx
  %i.fz = tail call <4 x i32> @llvm.fshl.v4i32(<4 x i32> %i.ft, <4 x i32> %i.ft, <4 x i32> splat (i32 18))
  %i.ga = add <4 x i32> %i.fy, %i.fz              ; 2 uses
  %i.gb = lshr <4 x i32> %i.ga, splat (i32 15)
  %i.gc = xor <4 x i32> %i.gb, %i.ga
  %i.gd = mul <4 x i32> %i.gc, splat (i32 -2048144777) ; 2 uses
  %i.ge = lshr <4 x i32> %i.gd, splat (i32 13)
  %i.gf = xor <4 x i32> %i.ge, %i.gd
  %i.gg = mul <4 x i32> %i.gf, splat (i32 -1028477379) ; 2 uses
  %i.gh = lshr <4 x i32> %i.gg, splat (i32 16)
  %i.gi = xor <4 x i32> %i.gh, %i.gg
  %i.gj = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %index
  store <4 x i32> %i.gi, ptr %i.gj, align 4, !tbaa !3, !alias.scope !65, !noalias !62
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.gk = icmp eq i64 %index.next, %n.vec
  br i1 %i.gk, label %middle.block, label %vector.body, !llvm.loop !67
...
._crit_edge:                                      ; preds = %_ZN5arrow7compute9Hashing3218ProcessFullStripesEmPKhPjS4_S4_S4_.exit, %_ZN5arrow7compute9Hashing3218ProcessFullStripesEmPKhPjS4_S4_S4_.exit.loopexit.us, %middle.block, %_ZN5arrow8bit_util7CeilDivEll.exit
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a)
  %i.gl = icmp ult i32 %.0.lcssa, %0
  br i1 %i.gl, label %.lr.ph101, label %._crit_edge102

.lr.ph101:                                        ; preds = %._crit_edge
  %i.gm = icmp sgt i64 %i.j, 1
  %i.gn = add nsw i64 %i.j, -2
  %i.go = shl i64 %i.j, 4
  %i.gp = add i64 %i.go, -16                      ; 2 uses
  %i.gq = sub i64 %1, %i.gp
  %i.gr = zext i32 %.0.lcssa to i64
...
_ZN5arrow7compute9Hashing3218ProcessFullStripesEmPKhPjS4_S4_S4_.exit: ; preds = %_ZN5arrow7compute9Hashing3218ProcessFullStripesEmPKhPjS4_S4_S4_.exit.preheader, %_ZN5arrow7compute9Hashing3218ProcessFullStripesEmPKhPjS4_S4_S4_.exit
  ...
  %i.gs = mul i64 %1, %indvars.iv113
  %gep = getelementptr i8, ptr %invariant.gep, i64 %i.gs ; 4 uses
  %i.gt = getelementptr i8, ptr %gep, i64 -16
  %.0.copyload.i.i41 = load i32, ptr %i.gt, align 1
  %i.gu = getelementptr i8, ptr %gep, i64 -12
  %.0.copyload.i23.i = load i32, ptr %i.gu, align 1
  %i.gv = getelementptr i8, ptr %gep, i64 -8
  %.0.copyload.i24.i = load i32, ptr %i.gv, align 1
  %i.gw = getelementptr i8, ptr %gep, i64 -4
  %.0.copyload.i25.i = load i32, ptr %i.gw, align 1
  %i.gx = and i32 %.0.copyload.i.i41, %.0.copyload.i.i
  %i.gy = and i32 %.0.copyload.i23.i, %.0.copyload.i9.i
  %i.gz = and i32 %.0.copyload.i24.i, %.0.copyload.i10.i
  %i.ha = and i32 %.0.copyload.i25.i, %.0.copyload.i11.i
  %i.hb = mul i32 %i.gx, -2048144777
  %i.hc = add i32 %i.hb, 606290984                ; 2 uses
  %i.hd = tail call i32 @llvm.fshl.i32(i32 %i.hc, i32 %i.hc, i32 13)
  %i.he = mul i32 %i.hd, -1640531535              ; 2 uses
  %i.hf = mul i32 %i.gy, -2048144777
  %i.hg = add i32 %i.hf, -2048144777              ; 2 uses
  %i.hh = tail call i32 @llvm.fshl.i32(i32 %i.hg, i32 %i.hg, i32 13)
  %i.hi = mul i32 %i.hh, -1640531535              ; 2 uses
  %i.hj = mul i32 %i.gz, -2048144777              ; 2 uses
  %i.hk = tail call i32 @llvm.fshl.i32(i32 %i.hj, i32 %i.hj, i32 13)
  %i.hl = mul i32 %i.hk, -1640531535              ; 2 uses
  %i.hm = mul i32 %i.ha, -2048144777
  %i.hn = add i32 %i.hm, 1640531535               ; 2 uses
  %i.ho = tail call i32 @llvm.fshl.i32(i32 %i.hn, i32 %i.hn, i32 13)
  %i.hp = mul i32 %i.ho, -1640531535              ; 2 uses
  %i.hq = tail call i32 @llvm.fshl.i32(i32 %i.he, i32 %i.he, i32 1)
  %i.hr = tail call i32 @llvm.fshl.i32(i32 %i.hi, i32 %i.hi, i32 7)
  %i.hs = add i32 %i.hr, %i.hq
  %i.ht = tail call i32 @llvm.fshl.i32(i32 %i.hl, i32 %i.hl, i32 12)
  %i.hu = add i32 %i.hs, %i.ht
  %i.hv = tail call i32 @llvm.fshl.i32(i32 %i.hp, i32 %i.hp, i32 18)
  %i.hw = add i32 %i.hu, %i.hv                    ; 2 uses
  %i.hx = lshr i32 %i.hw, 15
  %i.hy = xor i32 %i.hx, %i.hw
  %i.hz = mul i32 %i.hy, -2048144777              ; 2 uses
  %i.ia = lshr i32 %i.hz, 13
  %i.ib = xor i32 %i.ia, %i.hz
  %i.ic = mul i32 %i.ib, -1028477379              ; 2 uses
  %i.id = lshr i32 %i.ic, 16
  %i.ie = xor i32 %i.id, %i.ic
  %i.if = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %indvars.iv113
...
bb.d:                                             ; preds = %.lr.ph101, %_ZN5arrow7compute9Hashing3218ProcessFullStripesEmPKhPjS4_S4_S4_.exit58
  %indvars.iv123 = phi i64 [ %i.gr, %.lr.ph101 ], [ %indvars.iv.next124, %_ZN5arrow7compute9Hashing3218ProcessFullStripesEmPKhPjS4_S4_S4_.exit58 ] ; 3 uses
  %i.ig = mul i64 %1, %indvars.iv123
  %i.ih = getelementptr inbounds nuw i8, ptr %2, i64 %i.ig ; 2 uses
  br i1 %i.gm, label %.lr.ph.i47, label %_ZN5arrow7compute9Hashing3218ProcessFullStripesEmPKhPjS4_S4_S4_.exit58

.lr.ph.i47:                                       ; preds = %bb.d, %.lr.ph.i47
  %.035.i48 = phi i32 [ %i.iq, %.lr.ph.i47 ], [ 606290984, %bb.d ]
  %.02434.i49 = phi i32 [ %i.iu, %.lr.ph.i47 ], [ -2048144777, %bb.d ]
  ...
  %.0.copyload.i28.i54 = load i32, ptr %i.ik, align 1
  %i.il = getelementptr inbounds nuw i8, ptr %i.ij, i64 8
  %.0.copyload.i29.i55 = load i32, ptr %i.il, align 1
  %i.im = getelementptr inbounds nuw i8, ptr %i.ij, i64 12
  %.0.copyload.i30.i56 = load i32, ptr %i.im, align 1
  %i.in = mul i32 %.0.copyload.i.i53, -2048144777
  %i.io = add i32 %i.in, %.035.i48                ; 2 uses
  %i.ip = tail call i32 @llvm.fshl.i32(i32 %i.io, i32 %i.io, i32 13)
  %i.iq = mul i32 %i.ip, -1640531535              ; 2 uses
  %i.ir = mul i32 %.0.copyload.i28.i54, -2048144777
  %i.is = add i32 %i.ir, %.02434.i49              ; 2 uses
  %i.it = tail call i32 @llvm.fshl.i32(i32 %i.is, i32 %i.is, i32 13)
  %i.iu = mul i32 %i.it, -1640531535              ; 2 uses
  %i.iv = mul i32 %.0.copyload.i29.i55, -2048144777
  %i.iw = add i32 %i.iv, %.02533.i50              ; 2 uses
  %i.ix = tail call i32 @llvm.fshl.i32(i32 %i.iw, i32 %i.iw, i32 13)
  %i.iy = mul i32 %i.ix, -1640531535              ; 2 uses
  %i.iz = mul i32 %.0.copyload.i30.i56, -2048144777
  %i.ja = add i32 %i.iz, %.02632.i51              ; 2 uses
  %i.jb = tail call i32 @llvm.fshl.i32(i32 %i.ja, i32 %i.ja, i32 13)
  %i.jc = mul i32 %i.jb, -1640531535              ; 2 uses
  %i.jd = add nuw nsw i64 %.02731.i52, 1
  %exitcond.not.i57 = icmp eq i64 %.02731.i52, %i.gn
...
_ZN5arrow7compute9Hashing3218ProcessFullStripesEmPKhPjS4_S4_S4_.exit58: ; preds = %.lr.ph.i47, %bb.d
  %.026.lcssa.i42 = phi i32 [ 1640531535, %bb.d ], [ %i.jc, %.lr.ph.i47 ]
  %.025.lcssa.i43 = phi i32 [ 0, %bb.d ], [ %i.iy, %.lr.ph.i47 ]
  %.024.lcssa.i44 = phi i32 [ -2048144777, %bb.d ], [ %i.iu, %.lr.ph.i47 ]
  %.0.lcssa.i45 = phi i32 [ 606290984, %bb.d ], [ %i.iq, %.lr.ph.i47 ]
  %i.je = getelementptr inbounds nuw i8, ptr %i.ih, i64 %i.gp
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 16 %i.a, ptr align 1 %i.je, i64 %i.gq, i1 false)
  ...
  %i.jf = and i32 %.0..0..0..0.copyload.i.i59, %.0.copyload.i.i
  %i.jg = and i32 %.4..4..4..0.copyload.i23.i60, %.0.copyload.i9.i
  %i.jh = and i32 %.8..8..8..0.copyload.i24.i61, %.0.copyload.i10.i
  %i.ji = and i32 %.12..12..12..0.copyload.i25.i62, %.0.copyload.i11.i
  %i.jj = mul i32 %i.jf, -2048144777
  %i.jk = add i32 %i.jj, %.0.lcssa.i45            ; 2 uses
  %i.jl = tail call i32 @llvm.fshl.i32(i32 %i.jk, i32 %i.jk, i32 13)
  %i.jm = mul i32 %i.jl, -1640531535              ; 2 uses
  %i.jn = mul i32 %i.jg, -2048144777
  %i.jo = add i32 %i.jn, %.024.lcssa.i44          ; 2 uses
  %i.jp = tail call i32 @llvm.fshl.i32(i32 %i.jo, i32 %i.jo, i32 13)
  %i.jq = mul i32 %i.jp, -1640531535              ; 2 uses
  %i.jr = mul i32 %i.jh, -2048144777
  %i.js = add i32 %i.jr, %.025.lcssa.i43          ; 2 uses
  %i.jt = tail call i32 @llvm.fshl.i32(i32 %i.js, i32 %i.js, i32 13)
  %i.ju = mul i32 %i.jt, -1640531535              ; 2 uses
  %i.jv = mul i32 %i.ji, -2048144777
  %i.jw = add i32 %i.jv, %.026.lcssa.i42          ; 2 uses
  %i.jx = tail call i32 @llvm.fshl.i32(i32 %i.jw, i32 %i.jw, i32 13)
  %i.jy = mul i32 %i.jx, -1640531535              ; 2 uses
  %i.jz = tail call i32 @llvm.fshl.i32(i32 %i.jm, i32 %i.jm, i32 1)
  %i.ka = tail call i32 @llvm.fshl.i32(i32 %i.jq, i32 %i.jq, i32 7)
  %i.kb = add i32 %i.ka, %i.jz
  %i.kc = tail call i32 @llvm.fshl.i32(i32 %i.ju, i32 %i.ju, i32 12)
  %i.kd = add i32 %i.kb, %i.kc
  %i.ke = tail call i32 @llvm.fshl.i32(i32 %i.jy, i32 %i.jy, i32 18)
  %i.kf = add i32 %i.kd, %i.ke                    ; 2 uses
  %i.kg = lshr i32 %i.kf, 15
  %i.kh = xor i32 %i.kg, %i.kf
  %i.ki = mul i32 %i.kh, -2048144777              ; 2 uses
  %i.kj = lshr i32 %i.ki, 13
  %i.kk = xor i32 %i.kj, %i.ki
  %i.kl = mul i32 %i.kk, -1028477379              ; 2 uses
  %i.km = lshr i32 %i.kl, 16
  %i.kn = xor i32 %i.km, %i.kl
  %i.ko = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %indvars.iv123
...
.lr.ph.i47:                                       ; preds = %bb.e, %.lr.ph.i47
  ...
  %i.dy = tail call i64 @llvm.fshl.i64(i64 %i.dx, i64 %i.dx, i64 31)
  %i.dz = mul i64 %i.dy, -7046029288634856825     ; 2 uses
  %i.ea = mul i64 %.0.copyload.i29.i55, -4417276706812531889
  %i.eb = add i64 %i.ea, %.02533.i50              ; 2 uses
  %i.ec = tail call i64 @llvm.fshl.i64(i64 %i.eb, i64 %i.eb, i64 31)
  %i.ed = mul i64 %i.ec, -7046029288634856825     ; 2 uses
  %i.ee = mul i64 %.0.copyload.i30.i56, -4417276706812531889
  %i.ef = add i64 %i.ee, %.02632.i51              ; 2 uses
  %i.eg = tail call i64 @llvm.fshl.i64(i64 %i.ef, i64 %i.ef, i64 31)
  %i.eh = mul i64 %i.eg, -7046029288634856825     ; 2 uses
  %i.ei = add nuw nsw i64 %.02731.i52, 1
  %exitcond.not.i57 = icmp eq i64 %.02731.i52, %i.v
...
_ZN5arrow7compute9Hashing6418ProcessFullStripesEmPKhPmS4_S4_S4_.exit58: ; preds = %.lr.ph.i47, %bb.e
  %.026.lcssa.i42 = phi i64 [ 7046029288634856825, %bb.e ], [ %i.eh, %.lr.ph.i47 ]
  %.025.lcssa.i43 = phi i64 [ 0, %bb.e ], [ %i.ed, %.lr.ph.i47 ]
  %.024.lcssa.i44 = phi i64 [ -4417276706812531889, %bb.e ], [ %i.dz, %.lr.ph.i47 ]
  %.0.lcssa.i45 = phi i64 [ -2239933958592612906, %bb.e ], [ %i.dv, %.lr.ph.i47 ]
  %i.ej = getelementptr inbounds nuw i8, ptr %i.dm, i64 %i.x
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 16 %i.a, ptr align 1 %i.ej, i64 %i.y, i1 false)
  ...
  %i.ek = and i64 %.0..0..0..0.copyload.i.i59, %.0.copyload.i.i
  %i.el = and i64 %.8..8..8..0.copyload.i23.i60, %.0.copyload.i9.i
  %i.em = and i64 %.16..16..16..0.copyload.i24.i61, %.0.copyload.i10.i
  %i.en = and i64 %.24..24..24..0.copyload.i25.i62, %.0.copyload.i11.i
  %i.eo = mul i64 %i.ek, -4417276706812531889
  %i.ep = add i64 %i.eo, %.0.lcssa.i45            ; 2 uses
  %i.eq = tail call i64 @llvm.fshl.i64(i64 %i.ep, i64 %i.ep, i64 31) ; 2 uses
  %i.er = mul i64 %i.eq, -7046029288634856825     ; 2 uses
  %i.es = mul i64 %i.el, -4417276706812531889
  %i.et = add i64 %i.es, %.024.lcssa.i44          ; 2 uses
  %i.eu = tail call i64 @llvm.fshl.i64(i64 %i.et, i64 %i.et, i64 31) ; 2 uses
  %i.ev = mul i64 %i.eu, -7046029288634856825     ; 2 uses
  %i.ew = mul i64 %i.em, -4417276706812531889
  %i.ex = add i64 %i.ew, %.025.lcssa.i43          ; 2 uses
  %i.ey = tail call i64 @llvm.fshl.i64(i64 %i.ex, i64 %i.ex, i64 31) ; 2 uses
  %i.ez = mul i64 %i.ey, -7046029288634856825     ; 2 uses
  %i.fa = mul i64 %i.en, -4417276706812531889
  %i.fb = add i64 %i.fa, %.026.lcssa.i42          ; 2 uses
  %i.fc = tail call i64 @llvm.fshl.i64(i64 %i.fb, i64 %i.fb, i64 31) ; 2 uses
  %i.fd = mul i64 %i.fc, -7046029288634856825     ; 2 uses
  %i.fe = tail call i64 @llvm.fshl.i64(i64 %i.er, i64 %i.er, i64 1)
  %i.ff = tail call i64 @llvm.fshl.i64(i64 %i.ev, i64 %i.ev, i64 7)
  %i.fg = add i64 %i.ff, %i.fe
  %i.fh = tail call i64 @llvm.fshl.i64(i64 %i.ez, i64 %i.ez, i64 12)
  %i.fi = add i64 %i.fg, %i.fh
  %i.fj = tail call i64 @llvm.fshl.i64(i64 %i.fd, i64 %i.fd, i64 18)
  %i.fk = add i64 %i.fi, %i.fj
  %i.fl = mul i64 %i.eq, -2381459717836149591     ; 2 uses
  %i.fm = tail call i64 @llvm.fshl.i64(i64 %i.fl, i64 %i.fl, i64 31)
  %i.fn = mul i64 %i.fm, -7046029288634856825
  %i.fo = xor i64 %i.fk, %i.fn
  %i.fp = mul i64 %i.fo, -7046029288634856825
  %i.fq = add i64 %i.fp, -8796714831421723037
  %i.fr = mul i64 %i.eu, -2381459717836149591     ; 2 uses
  %i.fs = tail call i64 @llvm.fshl.i64(i64 %i.fr, i64 %i.fr, i64 31)
  %i.ft = mul i64 %i.fs, -7046029288634856825
  %i.fu = xor i64 %i.fq, %i.ft
  %i.fv = mul i64 %i.fu, -7046029288634856825
  %i.fw = add i64 %i.fv, -8796714831421723037
  %i.fx = mul i64 %i.ey, -2381459717836149591     ; 2 uses
  %i.fy = tail call i64 @llvm.fshl.i64(i64 %i.fx, i64 %i.fx, i64 31)
  %i.fz = mul i64 %i.fy, -7046029288634856825
  %i.ga = xor i64 %i.fw, %i.fz
  %i.gb = mul i64 %i.ga, -7046029288634856825
  %i.gc = add i64 %i.gb, -8796714831421723037
  %i.gd = mul i64 %i.fc, -2381459717836149591     ; 2 uses
  %i.ge = tail call i64 @llvm.fshl.i64(i64 %i.gd, i64 %i.gd, i64 31)
  %i.gf = mul i64 %i.ge, -7046029288634856825
  %i.gg = xor i64 %i.gc, %i.gf
  %i.gh = mul i64 %i.gg, -7046029288634856825
  %i.gi = add i64 %i.gh, -8796714831421723037     ; 2 uses
  %i.gj = lshr i64 %i.gi, 33
  %i.gk = xor i64 %i.gj, %i.gi
  %i.gl = mul i64 %i.gk, -4417276706812531889     ; 2 uses
  %i.gm = lshr i64 %i.gl, 29
  %i.gn = xor i64 %i.gm, %i.gl
  %i.go = mul i64 %i.gn, 1609587929392839161      ; 2 uses
  %i.gp = lshr i64 %i.go, 32
  %i.gq = xor i64 %i.gp, %i.go
  %i.gr = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %indvars.iv116
  store i64 %i.gq, ptr %i.gr, align 8, !tbaa !15
  %indvars.iv.next117 = add nuw nsw i64 %indvars.iv116, 1 ; 2 uses
