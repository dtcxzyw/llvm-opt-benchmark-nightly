begin_hunk_0
  ...
  %.sroa.speculated = call i32 @llvm.umin.i32(i32 %i.as, i32 1024) ; 10 uses
...
begin_hunk_2
  ...
  %i.bj = trunc nsw i64 %i.ay to i32
  %i.bk = xor i32 %.0127183, -1
  %i.bl = icmp ult i32 %i.bk, %i.bj
  %i.bm = icmp ugt i64 %i.ay, 4294967295
...
begin_hunk_3
  ...
  %i.bp = trunc nsw i64 %i.ay to i32
  %i.bq = xor i32 %.0127183, -1
  %i.br = icmp ult i32 %i.bq, %i.bp
  %i.bs = icmp ugt i64 %i.ay, 4294967295
...
begin_hunk_4
  ...
  %bound1 = icmp ult ptr %i.hx, %scevgep298.a
...
begin_hunk_5
  ...
  %wide.trip.count.i65.i = zext nneg i32 %.sroa.speculated to i64 ; 37 uses
  %.not178 = icmp eq i32 %.0119173, %i.e          ; 2 uses
  %i.an = add nsw i64 %wide.trip.count.i65.i, -1  ; 4 uses
...
begin_hunk_6
  ...
  %i.be = trunc nsw i64 %i.an to i32
  %i.bf = xor i32 %.0119173, -1
  %i.bg = icmp ult i32 %i.bf, %i.be
  %i.bh = icmp ugt i64 %i.an, 4294967295
