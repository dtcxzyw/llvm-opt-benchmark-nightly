...
begin_hunk_1_@"_ZN5folly6detail14ScopeGuardImplIZNS_10Subprocess13spawnInternalESt10unique_ptrIA_PKcSt14default_deleteIS6_EES5_RNS2_7OptionsEPKSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaISI_EEPNS2_14ChildErrorInfoEE3$_0Lb1EED2Ev":bb.a
  ...
  br i1 %i.d, label %"_ZN5folly6detail14ScopeGuardImplIZNS_10Subprocess13spawnInternalESt10unique_ptrIA_PKcSt14default_deleteIS6_EES5_RNS2_7OptionsEPKSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaISI_EEPNS2_14ChildErrorInfoEE3$_0Lb1EE7executeEv.exit", label %.lr.ph.i.i

.lr.ph.i.i:                                       ; preds = %bb.b
  %.fca.1.gep.i.i = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  br label %bb.c

bb.c:                                             ; preds = %.critedge6.i.i, %.lr.ph.i.i
  %.sroa.02.05.i.i = phi ptr [ %.val.val, %.lr.ph.i.i ], [ %i.j, %.critedge6.i.i ] ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  store i64 ptrtoint (ptr @_ZN6google10LogMessage9SendToLogEv to i64), ptr %i.a, align 8, !tbaa !25
  store i64 0, ptr %.fca.1.gep.i.i, align 8, !tbaa !25
