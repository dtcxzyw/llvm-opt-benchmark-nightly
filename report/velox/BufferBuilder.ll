...
_ZNSt6vectorIPN4geos4geom8GeometryESaIS3_EE7reserveEm.exit: ; preds = %_ZNSt12_Vector_baseIPN4geos4geom8GeometryESaIS3_EE11_M_allocateEm.exit.i
  ...
  %.pre448.pre = load ptr, ptr %i.eh, align 8, !tbaa !144 ; 3 uses
  %.pre447.pre = load ptr, ptr %i.ej, align 8, !tbaa !141 ; 2 uses
  ...
  %.pre462 = ptrtoint ptr %.pre447.pre to i64
  %.pre463.a = ptrtoint ptr %.pre448.pre to i64
  %.pre465 = sub i64 %.pre462, %.pre463.a
  %i.eu = ashr exact i64 %.pre465, 3
  %i.ev = icmp eq ptr %.pre447.pre, %.pre448.pre
...
._crit_edge405:                                   ; preds = %bb.ai, %._crit_edge405.loopexit, %_ZNSt6vectorIPN4geos4geom8GeometryESaIS3_EE7reserveEm.exit
  %i.gv = phi ptr [ %.pre449, %._crit_edge405.loopexit ], [ %.pre448.pre, %_ZNSt6vectorIPN4geos4geom8GeometryESaIS3_EE7reserveEm.exit ], [ %i.el, %bb.ai ] ; 2 uses
