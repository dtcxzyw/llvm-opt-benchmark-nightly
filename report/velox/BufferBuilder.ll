...
_ZNSt6vectorIPN4geos4geom8GeometryESaIS3_EE7reserveEm.exit: ; preds = %_ZNSt12_Vector_baseIPN4geos4geom8GeometryESaIS3_EE11_M_allocateEm.exit.i
  ...
  %.pre448.pre = load ptr, ptr %i.eg, align 8, !tbaa !142 ; 3 uses
  %.pre447.pre = load ptr, ptr %i.ei, align 8, !tbaa !139 ; 2 uses
  ...
  %i.eu = icmp eq ptr %.pre447.pre, %.pre448.pre
...
._crit_edge405:                                   ; preds = %bb.ai, %._crit_edge405.loopexit, %_ZNSt6vectorIPN4geos4geom8GeometryESaIS3_EE7reserveEm.exit
  %i.gu = phi ptr [ %.pre449, %._crit_edge405.loopexit ], [ %.pre448.pre, %_ZNSt6vectorIPN4geos4geom8GeometryESaIS3_EE7reserveEm.exit ], [ %i.ek, %bb.ai ] ; 2 uses
