...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %6 = load <13 x i64>, ptr %i.bw, align 8, !tbaa !16
  %strided.vec = shufflevector <13 x i64> %6, <13 x i64> poison, <4 x i32> <i32 0, i32 4, i32 8, i32 12>
  %7 = load <13 x i64>, ptr %i.bx, align 8, !tbaa !16
  %strided.vec126 = shufflevector <13 x i64> %7, <13 x i64> poison, <4 x i32> <i32 0, i32 4, i32 8, i32 12>
  %8 = load <13 x i64>, ptr %i.by, align 8, !tbaa !16
  %strided.vec128 = shufflevector <13 x i64> %8, <13 x i64> poison, <4 x i32> <i32 0, i32 4, i32 8, i32 12>
  %9 = load <13 x i64>, ptr %i.bz, align 8, !tbaa !16
  %strided.vec130 = shufflevector <13 x i64> %9, <13 x i64> poison, <4 x i32> <i32 0, i32 4, i32 8, i32 12>
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %10 = load <13 x i64>, ptr %i.cr, align 8, !tbaa !16
  %strided.vec140 = shufflevector <13 x i64> %10, <13 x i64> poison, <4 x i32> <i32 0, i32 4, i32 8, i32 12>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %3 = load <13 x i64>, ptr %i.aj, align 8, !tbaa !16
  %strided.vec = shufflevector <13 x i64> %3, <13 x i64> poison, <4 x i32> <i32 0, i32 4, i32 8, i32 12>
  %4 = load <13 x i64>, ptr %i.ak, align 8, !tbaa !16
  %strided.vec28 = shufflevector <13 x i64> %4, <13 x i64> poison, <4 x i32> <i32 0, i32 4, i32 8, i32 12>
  %5 = load <13 x i64>, ptr %i.al, align 8, !tbaa !16
  %strided.vec30 = shufflevector <13 x i64> %5, <13 x i64> poison, <4 x i32> <i32 0, i32 4, i32 8, i32 12>
  %6 = load <13 x i64>, ptr %i.am, align 8, !tbaa !16
  %strided.vec32 = shufflevector <13 x i64> %6, <13 x i64> poison, <4 x i32> <i32 0, i32 4, i32 8, i32 12>
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %7 = load <13 x i64>, ptr %i.be, align 8, !tbaa !16
  %strided.vec42 = shufflevector <13 x i64> %7, <13 x i64> poison, <4 x i32> <i32 0, i32 4, i32 8, i32 12>
