...
bb.a:
  ...
  store ptr %i.c, ptr %3, align 8, !tbaa !356, !alias.scope !353
  %i.d = getelementptr inbounds nuw i8, ptr %3, i64 8 ; 2 uses
  store i8 0, ptr %i.d, align 8, !tbaa !359, !alias.scope !353
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #22, !noalias !353
...
begin_hunk_3
  ...
  %.not = icmp eq ptr %i.u, %i.v                  ; 2 uses
...
_ZNSt5dequeIN5folly8FunctionIFvvEEESaIS3_EE9push_backEOS3_.exit: ; preds = %_ZSt12construct_atIN5folly8FunctionIFvvEEEJS3_EEDTgsnwcvPvLi0E_T_pispclsr3stdE7declvalIT0_EEEEPS5_DpOS6_.exit.i.i, %bb.h, %bb.c
  %.04 = phi i1 [ undef, %bb.c ], [ %.not, %bb.h ], [ %.not, %_ZSt12construct_atIN5folly8FunctionIFvvEEEJS3_EEDTgsnwcvPvLi0E_T_pispclsr3stdE7declvalIT0_EEEEPS5_DpOS6_.exit.i.i ]
  ...
  br i1 %.not.i.i.i.i.i10, label %.critedge, label %bb.i, !prof !123
...
.critedge:                                        ; preds = %_ZNSt5dequeIN5folly8FunctionIFvvEEESaIS3_EE9push_backEOS3_.exit, %bb.i
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #22
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #22
  %.04.not = xor i1 %.04, true
  %brmerge = or i1 %i.q, %.04.not
  br i1 %brmerge, label %bb.k, label %_ZN5folly9LockedPtrINS_12SynchronizedINS_7futures6detail12WaitExecutor5QueueENS_15SharedMutexImplILb0EvSt6atomicNS_24SharedMutexPolicyDefaultEEEEENS_6detail22SynchronizedLockPolicyILNSB_22SynchronizedMutexLevelE1ELNSB_23SynchronizedMutexMethodE0EEEED2Ev.exit14

_ZN5folly9LockedPtrINS_12SynchronizedINS_7futures6detail12WaitExecutor5QueueENS_15SharedMutexImplILb0EvSt6atomicNS_24SharedMutexPolicyDefaultEEEEENS_6detail22SynchronizedLockPolicyILNSB_22SynchronizedMutexLevelE1ELNSB_23SynchronizedMutexMethodE0EEEED2Ev.exit14: ; preds = %.critedge
  %4 = getelementptr inbounds nuw i8, ptr %0, i64 104
  call void @_ZN5folly6fibers5Baton4postEv(ptr noundef nonnull align 8 dereferenceable(8) %4)
  br label %bb.k

bb.k:                                             ; preds = %.critedge, %_ZN5folly9LockedPtrINS_12SynchronizedINS_7futures6detail12WaitExecutor5QueueENS_15SharedMutexImplILb0EvSt6atomicNS_24SharedMutexPolicyDefaultEEEEENS_6detail22SynchronizedLockPolicyILNSB_22SynchronizedMutexLevelE1ELNSB_23SynchronizedMutexMethodE0EEEED2Ev.exit14
  ret void
}
