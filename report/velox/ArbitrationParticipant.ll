...
_ZN5folly10SemiFutureINS_4UnitEED2Ev.exit:        ; preds = %bb.c
  ...
  store ptr %i.c, ptr %10, align 8, !tbaa !203
...
bb.d:                                             ; preds = %_ZN5folly10SemiFutureINS_4UnitEED2Ev.exit
  %i.l = load ptr, ptr %10, align 8, !tbaa !203   ; 3 uses
...
bb.e:                                             ; preds = %bb.d
  %i.m = load i8, ptr %9, align 8, !tbaa !197, !range !198, !noundef !202
...
bb.f:                                             ; preds = %bb.e
  ...
  %.pre.i.i.i = load ptr, ptr %10, align 8, !tbaa !203
  br label %bb.g
