...
_ZNSt6vectorISt10shared_ptrIN8facebook5velox10BaseVectorEESaIS4_EE7reserveEm.exit: ; preds = %_ZNSt12_Vector_baseISt10shared_ptrIN8facebook5velox10BaseVectorEESaIS4_EE11_M_allocateEm.exit.i
  ...
  %.pre.pre = load i32, ptr %i.dv, align 8, !tbaa !60
  store ptr %i.eb, ptr %17, align 8, !tbaa !246
  store ptr %i.eb, ptr %i.ec, align 8, !tbaa !245
  %i.ed = getelementptr inbounds nuw [16 x i8], ptr %i.eb, i64 %i.dx
  store ptr %i.ed, ptr %i.dz, align 8, !tbaa !461
  %i.ee = icmp eq i32 %.pre.pre, 0
  br i1 %i.ee, label %.thread, label %.lr.ph
