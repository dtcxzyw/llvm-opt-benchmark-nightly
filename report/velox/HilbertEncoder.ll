...
.rtvec:                                           ; preds = %bb.a
  ...
  %3 = sitofp i32 %i.g to double
  %4 = load <4 x double>, ptr %2, align 8         ; 2 uses
  %5 = load double, ptr %i.i, align 8, !tbaa !11
  %6 = fcmp uno double %5, 0.000000e+00
  %i.j = shufflevector <4 x double> %4, <4 x double> poison, <2 x i32> <i32 1, i32 3>
  %i.k = shufflevector <4 x double> %4, <4 x double> poison, <2 x i32> <i32 0, i32 2> ; 2 uses
  %i.l = fsub <2 x double> %i.j, %i.k
  %i.m = insertelement <2 x i1> poison, i1 %6, i64 0
