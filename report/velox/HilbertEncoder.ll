Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/velox/original/HilbertEncoder?download=true
...
.rtvec:                                           ; preds = %bb.a
  ...
  %i.k = load <4 x double>, ptr %2, align 8       ; 2 uses
  %i.l = load double, ptr %i.i, align 8, !tbaa !13
  %i.m = fcmp uno double %i.l, 0.000000e+00
  %i.n = shufflevector <4 x double> %i.k, <4 x double> poison, <2 x i32> <i32 1, i32 3>
  %i.o = shufflevector <4 x double> %i.k, <4 x double> poison, <2 x i32> <i32 0, i32 2> ; 2 uses
  %i.p = fsub <2 x double> %i.n, %i.o
  %i.q = insertelement <2 x i1> poison, i1 %i.m, i64 0
  %i.r = shufflevector <2 x i1> %i.q, <2 x i1> poison, <2 x i32> zeroinitializer
  %i.s = select <2 x i1> %i.r, <2 x double> zeroinitializer, <2 x double> %i.p
  ...
  %i.w = shufflevector <2 x double> %i.o, <2 x double> %i.v, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  store <4 x double> %i.w, ptr %i.h, align 8, !tbaa !14
  br label %.rtcont

.rtscalar:                                        ; preds = %bb.a
  store i32 %1, ptr %0, align 8, !tbaa !11
  %i.x = uitofp i32 %1 to double
  %exp2.scalar = tail call double @exp2(double %i.x)
  %i.y = fptosi double %exp2.scalar to i32
  %i.z = add nsw i32 %i.y, -1
  %i.aa = load double, ptr %2, align 8, !tbaa !15 ; 2 uses
  %i.ab = getelementptr inbounds nuw i8, ptr %0, i64 8
  store double %i.aa, ptr %i.ab, align 8, !tbaa !16
  %i.ac = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.ad = load double, ptr %i.ac, align 8, !tbaa !13 ; 2 uses
  %i.ae = fcmp uno double %i.ad, 0.000000e+00     ; 2 uses
  %i.af = fsub double %i.ad, %i.aa
  %.0.i.scalar = select i1 %i.ae, double 0.000000e+00, double %i.af
  %i.ag = sitofp i32 %i.z to double               ; 2 uses
  %i.ah = fdiv double %.0.i.scalar, %i.ag
  %i.ai = getelementptr inbounds nuw i8, ptr %0, i64 24
  store double %i.ah, ptr %i.ai, align 8, !tbaa !17
  %i.aj = getelementptr inbounds nuw i8, ptr %2, i64 16
  %i.ak = load double, ptr %i.aj, align 8, !tbaa !18 ; 2 uses
  %i.al = getelementptr inbounds nuw i8, ptr %0, i64 16
  store double %i.ak, ptr %i.al, align 8, !tbaa !19
  %i.am = getelementptr inbounds nuw i8, ptr %2, i64 24
  %i.an = load double, ptr %i.am, align 8
  %i.ao = fsub double %i.an, %i.ak
  %.0.i7.scalar = select i1 %i.ae, double 0.000000e+00, double %i.ao
  %i.ap = fdiv double %.0.i7.scalar, %i.ag
...
bb.a:
  ...
  %i.j = load double, ptr %i.i, align 8, !tbaa !16 ; 2 uses
  %i.k = fcmp ogt double %i.h, %i.j
  br i1 %i.k, label %bb.b, label %bb.d

bb.b:                                             ; preds = %bb.a
  %i.l = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.m = load double, ptr %i.l, align 8, !tbaa !17 ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.ad = load double, ptr %i.ac, align 8, !tbaa !20 ; 2 uses
...
bb.g:                                             ; preds = %bb.f, %bb.e, %bb.d
  ...
  %i.ai = load i32, ptr %0, align 8, !tbaa !11
...
bb.c:                                             ; preds = %.lr.ph
  %i.o = load double, ptr %i.n, align 8, !tbaa !15 ; 2 uses
  %i.p = load double, ptr %2, align 8, !tbaa !15
  %i.q = fcmp olt double %i.o, %i.p
  br i1 %i.q, label %bb.d, label %bb.e

bb.d:                                             ; preds = %bb.c
  store double %i.o, ptr %2, align 8, !tbaa !15
  br label %bb.e
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  %i.w = load double, ptr %i.b, align 8, !tbaa !18
  %i.x = fcmp olt double %i.v, %i.w
  br i1 %i.x, label %bb.h, label %bb.i

bb.h:                                             ; preds = %bb.g
  store double %i.v, ptr %i.b, align 8, !tbaa !18
  br label %bb.i
...
.lr.ph.i.i.i.i.i:                                 ; preds = %bb.n, %_ZZN4geos5shape7fractal14HilbertEncoder4sortERSt6vectorIPNS_4geom8GeometryESaIS6_EEEN17HilbertComparatorclEPKS5_SC_.exit.i.i.i.i
  ...
  %i.bj = load double, ptr %i.ao, align 8, !tbaa !16 ; 2 uses
  %i.bk = fcmp ogt double %i.bi, %i.bj
  br i1 %i.bk, label %bb.o, label %bb.q

bb.o:                                             ; preds = %.lr.ph.i.i.i.i.i
  %i.bl = load double, ptr %i.ap, align 8, !tbaa !17 ; 2 uses
...
bb.q:                                             ; preds = %bb.p, %bb.o, %.lr.ph.i.i.i.i.i
  ...
  %i.by = load double, ptr %i.aq, align 8, !tbaa !19 ; 2 uses
...
bb.r:                                             ; preds = %bb.q
  %i.ca = load double, ptr %i.ar, align 8, !tbaa !20 ; 2 uses
...
_ZN4geos5shape7fractal14HilbertEncoder6encodeEPKNS_4geom8EnvelopeE.exit.i.i.i.i.i: ; preds = %bb.s, %bb.r, %bb.q
  ...
  %i.cf = load i32, ptr %3, align 8, !tbaa !11
  ...
  %i.ct = load double, ptr %i.ao, align 8, !tbaa !16 ; 2 uses
...
bb.t:                                             ; preds = %_ZN4geos5shape7fractal14HilbertEncoder6encodeEPKNS_4geom8EnvelopeE.exit.i.i.i.i.i
  %i.cv = load double, ptr %i.ap, align 8, !tbaa !17 ; 2 uses
...
bb.v:                                             ; preds = %bb.u, %bb.t, %_ZN4geos5shape7fractal14HilbertEncoder6encodeEPKNS_4geom8EnvelopeE.exit.i.i.i.i.i
  ...
  %i.di = load double, ptr %i.aq, align 8, !tbaa !19 ; 2 uses
...
bb.w:                                             ; preds = %bb.v
  %i.dk = load double, ptr %i.ar, align 8, !tbaa !20 ; 2 uses
...
_ZZN4geos5shape7fractal14HilbertEncoder4sortERSt6vectorIPNS_4geom8GeometryESaIS6_EEEN17HilbertComparatorclEPKS5_SC_.exit.i.i.i.i: ; preds = %bb.x, %bb.w, %bb.v
  ...
  %i.dp = load i32, ptr %3, align 8, !tbaa !11
  ...
  br i1 %i.dr, label %.lr.ph.i.i.i.i.i, label %_ZSt25__unguarded_linear_insertIN9__gnu_cxx17__normal_iteratorIPPN4geos4geom8GeometryESt6vectorIS5_SaIS5_EEEENS0_5__ops14_Val_comp_iterIZNS2_5shape7fractal14HilbertEncoder4sortERS9_E17HilbertComparatorEEEvT_T0_.exit.i.i.i.i, !llvm.loop !0
...
.lr.ph.i.i.i.i:                                   ; preds = %bb.c, %_ZZN4geos5shape7fractal14HilbertEncoder4sortERSt6vectorIPNS_4geom8GeometryESaIS6_EEEN17HilbertComparatorclEPKS5_SC_.exit15.i.i.i
  ...
  %i.ar = load double, ptr %i.g, align 8, !tbaa !16 ; 2 uses
  %i.as = fcmp ogt double %i.aq, %i.ar
  br i1 %i.as, label %bb.d, label %bb.f

bb.d:                                             ; preds = %.lr.ph.i.i.i.i
  %i.at = load double, ptr %i.h, align 8, !tbaa !17 ; 2 uses
...
bb.f:                                             ; preds = %bb.e, %bb.d, %.lr.ph.i.i.i.i
  ...
  %i.bg = load double, ptr %i.i, align 8, !tbaa !19 ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  %i.bi = load double, ptr %i.j, align 8, !tbaa !20 ; 2 uses
...
_ZN4geos5shape7fractal14HilbertEncoder6encodeEPKNS_4geom8EnvelopeE.exit.i11.i.i.i: ; preds = %bb.h, %bb.g, %bb.f
  ...
  %i.bn = load i32, ptr %3, align 8, !tbaa !11
  ...
  %i.cb = load double, ptr %i.g, align 8, !tbaa !16 ; 2 uses
...
bb.i:                                             ; preds = %_ZN4geos5shape7fractal14HilbertEncoder6encodeEPKNS_4geom8EnvelopeE.exit.i11.i.i.i
  %i.cd = load double, ptr %i.h, align 8, !tbaa !17 ; 2 uses
...
bb.k:                                             ; preds = %bb.j, %bb.i, %_ZN4geos5shape7fractal14HilbertEncoder6encodeEPKNS_4geom8EnvelopeE.exit.i11.i.i.i
  ...
  %i.cq = load double, ptr %i.i, align 8, !tbaa !19 ; 2 uses
...
bb.l:                                             ; preds = %bb.k
  %i.cs = load double, ptr %i.j, align 8, !tbaa !20 ; 2 uses
...
_ZZN4geos5shape7fractal14HilbertEncoder4sortERSt6vectorIPNS_4geom8GeometryESaIS6_EEEN17HilbertComparatorclEPKS5_SC_.exit15.i.i.i: ; preds = %bb.m, %bb.l, %bb.k
  ...
  %i.cx = load i32, ptr %3, align 8, !tbaa !11
...
.lr.ph.i.i.i.i.i:                                 ; preds = %bb.o, %bb.z
  ...
  %i.dv = load double, ptr %i.g, align 8, !tbaa !16 ; 2 uses
  %i.dw = fcmp ogt double %i.du, %i.dv
  br i1 %i.dw, label %bb.p, label %bb.r

bb.p:                                             ; preds = %.lr.ph.i.i.i.i.i
  %i.dx = load double, ptr %i.h, align 8, !tbaa !17 ; 2 uses
...
bb.r:                                             ; preds = %bb.q, %bb.p, %.lr.ph.i.i.i.i.i
  ...
  %i.ek = load double, ptr %i.i, align 8, !tbaa !19 ; 2 uses
...
bb.s:                                             ; preds = %bb.r
  %i.em = load double, ptr %i.j, align 8, !tbaa !20 ; 2 uses
...
_ZN4geos5shape7fractal14HilbertEncoder6encodeEPKNS_4geom8EnvelopeE.exit.i.i.i.i: ; preds = %bb.t, %bb.s, %bb.r
  ...
  %i.er = load i32, ptr %3, align 8, !tbaa !11
  ...
  %i.ff = load double, ptr %i.g, align 8, !tbaa !16 ; 2 uses
...
bb.u:                                             ; preds = %_ZN4geos5shape7fractal14HilbertEncoder6encodeEPKNS_4geom8EnvelopeE.exit.i.i.i.i
  %i.fh = load double, ptr %i.h, align 8, !tbaa !17 ; 2 uses
...
bb.w:                                             ; preds = %bb.v, %bb.u, %_ZN4geos5shape7fractal14HilbertEncoder6encodeEPKNS_4geom8EnvelopeE.exit.i.i.i.i
  ...
  %i.fu = load double, ptr %i.i, align 8, !tbaa !19 ; 2 uses
...
bb.x:                                             ; preds = %bb.w
  %i.fw = load double, ptr %i.j, align 8, !tbaa !20 ; 2 uses
...
_ZZN4geos5shape7fractal14HilbertEncoder4sortERSt6vectorIPNS_4geom8GeometryESaIS6_EEEN17HilbertComparatorclEPKS5_SC_.exit.i.i.i: ; preds = %bb.y, %bb.x, %bb.w
  ...
  %i.gb = load i32, ptr %3, align 8, !tbaa !11
...
.lr.ph.i.i.i28.i:                                 ; preds = %.lr.ph.i9.i, %_ZZN4geos5shape7fractal14HilbertEncoder4sortERSt6vectorIPNS_4geom8GeometryESaIS6_EEEN17HilbertComparatorclEPKS5_SC_.exit8.i.i
  ...
  %i.hm = load double, ptr %i.g, align 8, !tbaa !16 ; 2 uses
  %i.hn = fcmp ogt double %i.hl, %i.hm
  br i1 %i.hn, label %bb.aa, label %bb.ac

bb.aa:                                            ; preds = %.lr.ph.i.i.i28.i
  %i.ho = load double, ptr %i.h, align 8, !tbaa !17 ; 2 uses
...
bb.ac:                                            ; preds = %bb.ab, %bb.aa, %.lr.ph.i.i.i28.i
  ...
  %i.ib = load double, ptr %i.i, align 8, !tbaa !19 ; 2 uses
...
bb.ad:                                            ; preds = %bb.ac
  %i.id = load double, ptr %i.j, align 8, !tbaa !20 ; 2 uses
...
_ZN4geos5shape7fractal14HilbertEncoder6encodeEPKNS_4geom8EnvelopeE.exit.i4.i.i: ; preds = %bb.ae, %bb.ad, %bb.ac
  ...
  %i.ii = load i32, ptr %3, align 8, !tbaa !11
  ...
  %i.iw = load double, ptr %i.g, align 8, !tbaa !16 ; 2 uses
...
bb.af:                                            ; preds = %_ZN4geos5shape7fractal14HilbertEncoder6encodeEPKNS_4geom8EnvelopeE.exit.i4.i.i
  %i.iy = load double, ptr %i.h, align 8, !tbaa !17 ; 2 uses
...
bb.ah:                                            ; preds = %bb.ag, %bb.af, %_ZN4geos5shape7fractal14HilbertEncoder6encodeEPKNS_4geom8EnvelopeE.exit.i4.i.i
  ...
  %i.jl = load double, ptr %i.i, align 8, !tbaa !19 ; 2 uses
...
bb.ai:                                            ; preds = %bb.ah
  %i.jn = load double, ptr %i.j, align 8, !tbaa !20 ; 2 uses
...
_ZZN4geos5shape7fractal14HilbertEncoder4sortERSt6vectorIPNS_4geom8GeometryESaIS6_EEEN17HilbertComparatorclEPKS5_SC_.exit8.i.i: ; preds = %bb.aj, %bb.ai, %bb.ah
  ...
  %i.js = load i32, ptr %3, align 8, !tbaa !11
...
.thread.i.i27.i:                                  ; preds = %bb.ak
  ...
  %i.ki = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %.0.lcssa.i.i.i11.i
...
.lr.ph.i.i.i.i14.i:                               ; preds = %.lr.ph.i.i.i.i14.i.preheader, %bb.aw
  ...
  %i.kx = load double, ptr %i.g, align 8, !tbaa !16 ; 2 uses
  %i.ky = fcmp ogt double %i.kw, %i.kx
  br i1 %i.ky, label %bb.am, label %bb.ao

bb.am:                                            ; preds = %.lr.ph.i.i.i.i14.i
  %i.kz = load double, ptr %i.h, align 8, !tbaa !17 ; 2 uses
...
bb.ao:                                            ; preds = %bb.an, %bb.am, %.lr.ph.i.i.i.i14.i
  ...
  %i.lm = load double, ptr %i.i, align 8, !tbaa !19 ; 2 uses
...
bb.ap:                                            ; preds = %bb.ao
  %i.lo = load double, ptr %i.j, align 8, !tbaa !20 ; 2 uses
...
_ZN4geos5shape7fractal14HilbertEncoder6encodeEPKNS_4geom8EnvelopeE.exit.i.i19.i: ; preds = %bb.aq, %bb.ap, %bb.ao
  ...
  %i.lt = load i32, ptr %3, align 8, !tbaa !11
  ...
  %i.mh = load double, ptr %i.g, align 8, !tbaa !16 ; 2 uses
...
bb.ar:                                            ; preds = %_ZN4geos5shape7fractal14HilbertEncoder6encodeEPKNS_4geom8EnvelopeE.exit.i.i19.i
  %i.mj = load double, ptr %i.h, align 8, !tbaa !17 ; 2 uses
...
bb.at:                                            ; preds = %bb.as, %bb.ar, %_ZN4geos5shape7fractal14HilbertEncoder6encodeEPKNS_4geom8EnvelopeE.exit.i.i19.i
  ...
  %i.mw = load double, ptr %i.i, align 8, !tbaa !19 ; 2 uses
...
bb.au:                                            ; preds = %bb.at
  %i.my = load double, ptr %i.j, align 8, !tbaa !20 ; 2 uses
...
_ZZN4geos5shape7fractal14HilbertEncoder4sortERSt6vectorIPNS_4geom8GeometryESaIS6_EEEN17HilbertComparatorclEPKS5_SC_.exit.i22.i: ; preds = %bb.av, %bb.au, %bb.at
  ...
  %i.nd = load i32, ptr %3, align 8, !tbaa !11
...
bb.bi:                                            ; preds = %_ZZN4geos5shape7fractal14HilbertEncoder4sortERSt6vectorIPNS_4geom8GeometryESaIS6_EEEN17HilbertComparatorclEPKS5_SC_.exit.i.i, %bb.bh
  ...
  %i.pb = load double, ptr %i.g, align 8, !tbaa !16 ; 2 uses
  %i.pc = fcmp ogt double %i.pa, %i.pb
  br i1 %i.pc, label %bb.bj, label %bb.bl

bb.bj:                                            ; preds = %bb.bi
  %i.pd = load double, ptr %i.h, align 8, !tbaa !17 ; 2 uses
...
bb.bl:                                            ; preds = %bb.bk, %bb.bj, %bb.bi
  ...
  %i.pq = load double, ptr %i.i, align 8, !tbaa !19 ; 2 uses
...
bb.bm:                                            ; preds = %bb.bl
  %i.ps = load double, ptr %i.j, align 8, !tbaa !20 ; 2 uses
...
_ZN4geos5shape7fractal14HilbertEncoder6encodeEPKNS_4geom8EnvelopeE.exit.i.i.i: ; preds = %bb.bn, %bb.bm, %bb.bl
  ...
  %i.px = load i32, ptr %3, align 8, !tbaa !11
  ...
  %i.ql = load double, ptr %i.g, align 8, !tbaa !16 ; 2 uses
...
bb.bo:                                            ; preds = %_ZN4geos5shape7fractal14HilbertEncoder6encodeEPKNS_4geom8EnvelopeE.exit.i.i.i
  %i.qn = load double, ptr %i.h, align 8, !tbaa !17 ; 2 uses
...
bb.bq:                                            ; preds = %bb.bp, %bb.bo, %_ZN4geos5shape7fractal14HilbertEncoder6encodeEPKNS_4geom8EnvelopeE.exit.i.i.i
  ...
  %i.ra = load double, ptr %i.i, align 8, !tbaa !19 ; 2 uses
...
bb.br:                                            ; preds = %bb.bq
  %i.rc = load double, ptr %i.j, align 8, !tbaa !20 ; 2 uses
...
_ZZN4geos5shape7fractal14HilbertEncoder4sortERSt6vectorIPNS_4geom8GeometryESaIS6_EEEN17HilbertComparatorclEPKS5_SC_.exit.i.i: ; preds = %bb.bs, %bb.br, %bb.bq
  ...
  %i.rh = load i32, ptr %3, align 8, !tbaa !11
...
.preheader.i.i:                                   ; preds = %_ZZN4geos5shape7fractal14HilbertEncoder4sortERSt6vectorIPNS_4geom8GeometryESaIS6_EEEN17HilbertComparatorclEPKS5_SC_.exit.i.i, %_ZZN4geos5shape7fractal14HilbertEncoder4sortERSt6vectorIPNS_4geom8GeometryESaIS6_EEEN17HilbertComparatorclEPKS5_SC_.exit13.i.i
  ...
  %i.rz = load double, ptr %i.g, align 8, !tbaa !16 ; 2 uses
  %i.sa = fcmp ogt double %i.ry, %i.rz
  br i1 %i.sa, label %bb.bt, label %bb.bv

bb.bt:                                            ; preds = %.preheader.i.i
  %i.sb = load double, ptr %i.h, align 8, !tbaa !17 ; 2 uses
...
bb.bv:                                            ; preds = %bb.bu, %bb.bt, %.preheader.i.i
  ...
  %i.so = load double, ptr %i.i, align 8, !tbaa !19 ; 2 uses
...
bb.bw:                                            ; preds = %bb.bv
  %i.sq = load double, ptr %i.j, align 8, !tbaa !20 ; 2 uses
...
_ZN4geos5shape7fractal14HilbertEncoder6encodeEPKNS_4geom8EnvelopeE.exit.i9.i.i: ; preds = %bb.bx, %bb.bw, %bb.bv
  ...
  %i.sv = load i32, ptr %3, align 8, !tbaa !11
  ...
  %i.tj = load double, ptr %i.g, align 8, !tbaa !16 ; 2 uses
...
bb.by:                                            ; preds = %_ZN4geos5shape7fractal14HilbertEncoder6encodeEPKNS_4geom8EnvelopeE.exit.i9.i.i
  %i.tl = load double, ptr %i.h, align 8, !tbaa !17 ; 2 uses
...
bb.ca:                                            ; preds = %bb.bz, %bb.by, %_ZN4geos5shape7fractal14HilbertEncoder6encodeEPKNS_4geom8EnvelopeE.exit.i9.i.i
  ...
  %i.ty = load double, ptr %i.i, align 8, !tbaa !19 ; 2 uses
...
bb.cb:                                            ; preds = %bb.ca
  %i.ua = load double, ptr %i.j, align 8, !tbaa !20 ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.r = load double, ptr %i.q, align 8, !tbaa !17 ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.ai = load double, ptr %i.ah, align 8, !tbaa !20 ; 2 uses
...
_ZN4geos5shape7fractal14HilbertEncoder6encodeEPKNS_4geom8EnvelopeE.exit: ; preds = %bb.d, %bb.e, %bb.f
  ...
  %i.bd = load double, ptr %i.bc, align 8, !tbaa !16 ; 2 uses
...
bb.g:                                             ; preds = %_ZN4geos5shape7fractal14HilbertEncoder6encodeEPKNS_4geom8EnvelopeE.exit
  ...
  %i.bg = load double, ptr %i.bf, align 8, !tbaa !17 ; 2 uses
...
bb.i:                                             ; preds = %bb.h, %bb.g, %_ZN4geos5shape7fractal14HilbertEncoder6encodeEPKNS_4geom8EnvelopeE.exit
  ...
  %i.bu = load double, ptr %i.bt, align 8, !tbaa !19 ; 2 uses
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.bx = load double, ptr %i.bw, align 8, !tbaa !20 ; 2 uses
...
_ZN4geos5shape7fractal14HilbertEncoder6encodeEPKNS_4geom8EnvelopeE.exit5: ; preds = %bb.i, %bb.j, %bb.k
  ...
  %i.cc = load i32, ptr %i.ap, align 8, !tbaa !11
...
.lr.ph.i:                                         ; preds = %bb.g, %_ZZN4geos5shape7fractal14HilbertEncoder4sortERSt6vectorIPNS_4geom8GeometryESaIS6_EEEN17HilbertComparatorclEPKS5_SC_.exit
  ...
  %i.al = load double, ptr %i.b, align 8, !tbaa !16 ; 2 uses
  %i.am = fcmp ogt double %i.ak, %i.al
  br i1 %i.am, label %bb.h, label %bb.j

bb.h:                                             ; preds = %.lr.ph.i
  %i.an = load double, ptr %i.c, align 8, !tbaa !17 ; 2 uses
...
bb.j:                                             ; preds = %bb.i, %bb.h, %.lr.ph.i
  ...
  %i.ba = load double, ptr %i.d, align 8, !tbaa !19 ; 2 uses
...
bb.k:                                             ; preds = %bb.j
  %i.bc = load double, ptr %i.e, align 8, !tbaa !20 ; 2 uses
...
_ZN4geos5shape7fractal14HilbertEncoder6encodeEPKNS_4geom8EnvelopeE.exit.i: ; preds = %bb.l, %bb.k, %bb.j
  ...
  %i.bh = load i32, ptr %2, align 8, !tbaa !11
  ...
  %i.bv = load double, ptr %i.b, align 8, !tbaa !16 ; 2 uses
...
bb.m:                                             ; preds = %_ZN4geos5shape7fractal14HilbertEncoder6encodeEPKNS_4geom8EnvelopeE.exit.i
  %i.bx = load double, ptr %i.c, align 8, !tbaa !17 ; 2 uses
  %i.by = fcmp une double %i.bx, 0.000000e+00
...
bb.o:                                             ; preds = %bb.n, %bb.m, %_ZN4geos5shape7fractal14HilbertEncoder6encodeEPKNS_4geom8EnvelopeE.exit.i
  ...
  %i.ck = load double, ptr %i.d, align 8, !tbaa !19 ; 2 uses
...
bb.p:                                             ; preds = %bb.o
  %i.cm = load double, ptr %i.e, align 8, !tbaa !20 ; 2 uses
...
_ZZN4geos5shape7fractal14HilbertEncoder4sortERSt6vectorIPNS_4geom8GeometryESaIS6_EEEN17HilbertComparatorclEPKS5_SC_.exit: ; preds = %bb.o, %bb.p, %bb.q
  ...
  %i.cr = load i32, ptr %2, align 8, !tbaa !11
  ...
  br i1 %i.ct, label %.lr.ph.i, label %_ZSt25__unguarded_linear_insertIN9__gnu_cxx17__normal_iteratorIPPN4geos4geom8GeometryESt6vectorIS5_SaIS5_EEEENS0_5__ops14_Val_comp_iterIZNS2_5shape7fractal14HilbertEncoder4sortERS9_E17HilbertComparatorEEEvT_T0_.exit, !llvm.loop !0
...
!8 = !{!7, !6, i64 0}
!9 = !{!"double", !5, i64 0}
!10 = !{!"_ZTSN4geos5shape7fractal14HilbertEncoderE", !6, i64 0, !9, i64 8, !9, i64 16, !9, i64 24, !9, i64 32}
!11 = !{!10, !6, i64 0}
!12 = !{!"_ZTSN4geos4geom8EnvelopeE", !9, i64 0, !9, i64 8, !9, i64 16, !9, i64 24}
!13 = !{!12, !9, i64 8}
!14 = !{!9, !9, i64 0}
!15 = !{!12, !9, i64 0}
!16 = !{!10, !9, i64 8}
...
!22 = !{!"p1 _ZTSN4geos4geom8GeometryE", !21, i64 0}
!23 = !{!22, !22, i64 0}
