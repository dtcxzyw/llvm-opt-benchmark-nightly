...
._crit_edge41.thread:                             ; preds = %bb.d, %._crit_edge41
  %.028.lcssa57 = phi double [ %i.pa, %._crit_edge41 ], [ 0.000000e+00, %bb.d ]
  %i.lv = sitofp i32 %i.c to double
  %i.lw = fdiv double 1.079000e+00, %i.lv
  %i.lx = fadd double %i.lw, 1.000000e+00
  %i.ly = fdiv double 7.213000e-01, %i.lx
  br label %_ZN8facebook5velox6common3hll12_GLOBAL__N_15alphaEi.exit

_ZN8facebook5velox6common3hll12_GLOBAL__N_15alphaEi.exit: ; preds = %._crit_edge41, %bb.e, %bb.f, %._crit_edge41.thread
  %.028.lcssa56 = phi double [ %.028.lcssa57, %._crit_edge41.thread ], [ %i.pa, %bb.f ], [ %i.pa, %bb.e ], [ %i.pa, %._crit_edge41 ]
  %.0.i = phi double [ %i.ly, %._crit_edge41.thread ], [ 7.090000e-01, %bb.f ], [ 6.970000e-01, %bb.e ], [ 6.730000e-01, %._crit_edge41 ]
  %i.lz = sitofp i32 %i.c to double               ; 2 uses
  %i.ma = fmul double %.0.i, %i.lz
  %i.mb = fmul double %i.ma, %i.lz
  %i.mc = fdiv double %i.mb, %.028.lcssa56        ; 8 uses
  %i.md = sext i8 %i.a to i64
  %i.me = add nsw i64 %i.md, -4                   ; 2 uses
  %i.mf = load ptr, ptr @_ZN8facebook5velox6common3hll14BiasCorrection13kRawEstimatesE, align 8, !tbaa !80
  %i.mg = getelementptr inbounds nuw [24 x i8], ptr %i.mf, i64 %i.me ; 2 uses
  %i.mh = load ptr, ptr %i.mg, align 8, !tbaa !83 ; 6 uses
  %i.mi = load double, ptr %i.mh, align 8, !tbaa !86
  %i.mj = fcmp olt double %i.mc, %i.mi
  br i1 %i.mj, label %_ZN8facebook5velox6common3hll12_GLOBAL__N_111correctBiasEda.exit, label %bb.g

bb.g:                                             ; preds = %_ZN8facebook5velox6common3hll12_GLOBAL__N_15alphaEi.exit
  %i.mk = getelementptr inbounds nuw i8, ptr %i.mg, i64 8
  %i.ml = load ptr, ptr %i.mk, align 8, !tbaa !88
  %i.mm = ptrtoint ptr %i.ml to i64
  %i.mn = ptrtoint ptr %i.mh to i64
  %i.mo = sub i64 %i.mm, %i.mn                    ; 2 uses
  %i.mp = getelementptr i8, ptr %i.mh, i64 %i.mo
  %i.mq = getelementptr i8, ptr %i.mp, i64 -8
  %i.mr = load double, ptr %i.mq, align 8, !tbaa !86
  %i.ms = fcmp ogt double %i.mc, %i.mr
  br i1 %i.ms, label %_ZN8facebook5velox6common3hll12_GLOBAL__N_111correctBiasEda.exit, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.mt = load ptr, ptr @_ZN8facebook5velox6common3hll14BiasCorrection5kBiasE, align 8, !tbaa !80
  %i.mu = getelementptr inbounds nuw [24 x i8], ptr %i.mt, i64 %i.me ; 2 uses
  %i.mv = lshr exact i64 %i.mo, 3
  %i.mw = trunc i64 %i.mv to i32
  %i.mx = add i32 %i.mw, -1
  br label %bb.i

bb.i:                                             ; preds = %bb.m, %bb.h
  %.0177.i.i = phi i32 [ 0, %bb.h ], [ %.219.i.i, %bb.m ] ; 2 uses
  %.0206.i.i = phi i32 [ %i.mx, %bb.h ], [ %.222.i.i, %bb.m ] ; 2 uses
  %i.my = add i32 %.0206.i.i, %.0177.i.i
  %i.mz = lshr i32 %i.my, 1                       ; 3 uses
  %i.na = zext nneg i32 %i.mz to i64              ; 2 uses
  %i.nb = getelementptr inbounds nuw [8 x i8], ptr %i.mh, i64 %i.na
  %i.nc = load double, ptr %i.nb, align 8, !tbaa !86 ; 2 uses
  %i.nd = fcmp ogt double %i.mc, %i.nc
  br i1 %i.nd, label %bb.j, label %bb.k

bb.j:                                             ; preds = %bb.i
  %i.ne = add nuw nsw i32 %i.mz, 1
  br label %bb.m

bb.k:                                             ; preds = %bb.i
  %i.nf = fcmp olt double %i.mc, %i.nc
  br i1 %i.nf, label %bb.l, label %_ZN8facebook5velox6common3hll12_GLOBAL__N_16searchEdRKSt6vectorIdSaIdEE.exit.thread.i

bb.l:                                             ; preds = %bb.k
  %i.ng = add nsw i32 %i.mz, -1
  br label %bb.m

bb.m:                                             ; preds = %bb.l, %bb.j
  %.222.i.i = phi i32 [ %i.ng, %bb.l ], [ %.0206.i.i, %bb.j ] ; 2 uses
  %.219.i.i = phi i32 [ %.0177.i.i, %bb.l ], [ %i.ne, %bb.j ] ; 4 uses
  %.not.i.i = icmp ugt i32 %.219.i.i, %.222.i.i
  br i1 %.not.i.i, label %_ZN8facebook5velox6common3hll12_GLOBAL__N_16searchEdRKSt6vectorIdSaIdEE.exit.i, label %bb.i, !llvm.loop !89

_ZN8facebook5velox6common3hll12_GLOBAL__N_16searchEdRKSt6vectorIdSaIdEE.exit.thread.i: ; preds = %bb.k
  %i.nh = load ptr, ptr %i.mu, align 8, !tbaa !83
  %i.ni = getelementptr inbounds nuw [8 x i8], ptr %i.nh, i64 %i.na
  %i.nj = load double, ptr %i.ni, align 8, !tbaa !86
  br label %bb.n

_ZN8facebook5velox6common3hll12_GLOBAL__N_16searchEdRKSt6vectorIdSaIdEE.exit.i: ; preds = %bb.m
  %i.nk = add nsw i32 %.219.i.i, -1
  %i.nl = zext nneg i32 %i.nk to i64              ; 2 uses
  %i.nm = getelementptr inbounds nuw [8 x i8], ptr %i.mh, i64 %i.nl
  %i.nn = load double, ptr %i.nm, align 8, !tbaa !86 ; 2 uses
  %i.no = load ptr, ptr %i.mu, align 8, !tbaa !83 ; 2 uses
  %i.np = getelementptr inbounds nuw [8 x i8], ptr %i.no, i64 %i.nl
  %i.nq = load double, ptr %i.np, align 8, !tbaa !86 ; 2 uses
  %i.nr = zext nneg i32 %.219.i.i to i64          ; 2 uses
  %i.ns = getelementptr inbounds nuw [8 x i8], ptr %i.mh, i64 %i.nr
  %i.nt = load double, ptr %i.ns, align 8, !tbaa !86
  %i.nu = getelementptr inbounds nuw [8 x i8], ptr %i.no, i64 %i.nr
  %i.nv = load double, ptr %i.nu, align 8, !tbaa !86
  %i.nw = fsub double %i.mc, %i.nn
  %i.nx = fsub double %i.nv, %i.nq
  %i.ny = fmul double %i.nw, %i.nx
  %i.nz = fsub double %i.nt, %i.nn
  %i.oa = fdiv double %i.ny, %i.nz
  %i.ob = fadd double %i.nq, %i.oa
  br label %bb.n

bb.n:                                             ; preds = %_ZN8facebook5velox6common3hll12_GLOBAL__N_16searchEdRKSt6vectorIdSaIdEE.exit.i, %_ZN8facebook5velox6common3hll12_GLOBAL__N_16searchEdRKSt6vectorIdSaIdEE.exit.thread.i
  %.031.i = phi double [ %i.nj, %_ZN8facebook5velox6common3hll12_GLOBAL__N_16searchEdRKSt6vectorIdSaIdEE.exit.thread.i ], [ %i.ob, %_ZN8facebook5velox6common3hll12_GLOBAL__N_16searchEdRKSt6vectorIdSaIdEE.exit.i ]
  %i.oc = fsub double %i.mc, %.031.i
  br label %_ZN8facebook5velox6common3hll12_GLOBAL__N_111correctBiasEda.exit

bb.o:                                             ; preds = %.lr.ph40, %_ZNK8facebook5velox6common3hll12_GLOBAL__N_112DenseHllView8getValueEi.exit
  %.02738 = phi i32 [ 0, %.lr.ph40 ], [ %i.pb, %_ZNK8facebook5velox6common3hll12_GLOBAL__N_112DenseHllView8getValueEi.exit ] ; 4 uses
  %.02837 = phi double [ 0.000000e+00, %.lr.ph40 ], [ %i.pa, %_ZNK8facebook5velox6common3hll12_GLOBAL__N_112DenseHllView8getValueEi.exit ]
  %i.od = lshr i32 %.02738, 1
  %i.oe = zext nneg i32 %i.od to i64
  %i.of = getelementptr inbounds nuw i8, ptr %.val.i, i64 %i.oe
  %i.og = load i8, ptr %i.of, align 1, !tbaa !30
  %.tr.i.i.i = trunc i32 %.02738 to i8
  %i.oh = shl i8 %.tr.i.i.i, 2
  %i.oi = and i8 %i.oh, 4
  %i.oj = xor i8 %i.oi, 4
  %i.ok = ashr i8 %i.og, %i.oj
  %i.ol = and i8 %i.ok, 15                        ; 2 uses
  %i.om = icmp eq i8 %i.ol, 15
  %.not95 = xor i1 %i.om, true                    ; 2 uses
  %.not96 = xor i1 %i.lu, true
  %brmerge = select i1 %.not95, i1 true, i1 %.not96
  %.mux = select i1 %.not95, i8 %i.ol, i8 15
  br i1 %brmerge, label %_ZNK8facebook5velox6common3hll12_GLOBAL__N_112DenseHllView8getValueEi.exit, label %.lr.ph.i.i

bb.p:                                             ; preds = %.lr.ph.i.i
  %indvars.iv.next.i.i = add nuw nsw i64 %indvars.iv.i.i, 1 ; 2 uses
  %exitcond.not.i.i = icmp eq i64 %indvars.iv.next.i.i, %wide.trip.count.i.i
  br i1 %exitcond.not.i.i, label %_ZNK8facebook5velox6common3hll12_GLOBAL__N_112DenseHllView8getValueEi.exit, label %.lr.ph.i.i, !llvm.loop !65

.lr.ph.i.i:                                       ; preds = %bb.o, %bb.p
  %indvars.iv.i.i = phi i64 [ %indvars.iv.next.i.i, %bb.p ], [ 0, %bb.o ] ; 3 uses
  %i.on = getelementptr inbounds nuw [2 x i8], ptr %i.ls, i64 %indvars.iv.i.i
  %i.oo = load i16, ptr %i.on, align 2, !tbaa !60
  %i.op = zext i16 %i.oo to i32
  %i.oq = icmp eq i32 %.02738, %i.op
  br i1 %i.oq, label %bb.q, label %bb.p

bb.q:                                             ; preds = %.lr.ph.i.i
  %i.or = getelementptr inbounds nuw i8, ptr %i.lt, i64 %indvars.iv.i.i
  %i.os = load i8, ptr %i.or, align 1, !tbaa !30
  %i.ot = add i8 %i.os, 15
  br label %_ZNK8facebook5velox6common3hll12_GLOBAL__N_112DenseHllView8getValueEi.exit

_ZNK8facebook5velox6common3hll12_GLOBAL__N_112DenseHllView8getValueEi.exit: ; preds = %bb.p, %bb.o, %bb.q
  %.0.i32 = phi i8 [ %.mux, %bb.o ], [ %i.ot, %bb.q ], [ 15, %bb.p ]
  %i.ou = add i8 %.0.i32, %i.kg
  %i.ov = sext i8 %i.ou to i64
  %i.ow = and i64 %i.ov, 4294967295
  %i.ox = shl nuw i64 1, %i.ow
  %i.oy = sitofp i64 %i.ox to double
  %i.oz = fdiv double 1.000000e+00, %i.oy
  %i.pa = fadd double %.02837, %i.oz              ; 5 uses
  %i.pb = add nuw nsw i32 %.02738, 1              ; 2 uses
  %exitcond48.not = icmp eq i32 %i.pb, %smax47
  br i1 %exitcond48.not, label %._crit_edge41, label %bb.o, !llvm.loop !90

_ZN8facebook5velox6common3hll12_GLOBAL__N_111correctBiasEda.exit: ; preds = %bb.n, %bb.g, %_ZN8facebook5velox6common3hll12_GLOBAL__N_15alphaEi.exit, %bb.c
  %.0.i31.sink = phi double [ %i.lm, %bb.c ], [ %i.oc, %bb.n ], [ %i.mc, %bb.g ], [ %i.mc, %_ZN8facebook5velox6common3hll12_GLOBAL__N_15alphaEi.exit ]
  %i.pc = tail call double @llvm.round.f64(double %.0.i31.sink)
  %.0 = fptosi double %i.pc to i64
  ret i64 %.0
}
