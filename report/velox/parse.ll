...
bb.bk:                                            ; preds = %bb.bj
  %i.dv = load ptr, ptr %i.ae, align 8, !tbaa !167 ; 3 uses
...
bb.bs:                                            ; preds = %bb.br
  ...
  store ptr %i.ey, ptr %i.ae, align 8, !tbaa !167
...
..thread36.i_crit_edge:                           ; preds = %bb.bu
  %.pre422 = load ptr, ptr %i.ae, align 8, !tbaa !167
  br label %.thread36.i
...
bb.bx:                                            ; preds = %.thread36.i
  ...
  store ptr %i.fn, ptr %i.ae, align 8, !tbaa !167
  %i.fo = add i64 %i.fh, -1
...
.body:                                            ; preds = %.loopexit259, %.loopexit.split-lp, %bb.em, %bb.ae, %common.resume.i146, %bb.aa, %bb.cx, %bb.cu, %common.resume.i, %bb.ej, %bb.eh, %bb.eg, %bb.ef, %bb.dr, %bb.ds, %bb.di, %bb.cg, %bb.be, %bb.av, %bb.t, %bb.m, %bb.i, %bb.h
  %.pn110 = phi { ptr, i32 } [ %i.as, %bb.m ], [ %i.w, %bb.h ], [ %i.x, %bb.i ], [ %i.kd, %bb.em ], [ %i.bk, %bb.t ], [ %i.jt, %bb.eg ], [ %i.cw, %bb.av ], [ %i.di, %bb.be ], [ %.pn102, %bb.cg ], [ %i.ih, %bb.di ], [ %i.iq, %bb.dr ], [ %i.bt, %bb.aa ], [ %i.ir, %bb.ds ], [ %i.hd, %bb.cx ], [ %i.jx, %bb.ej ], [ %i.js, %bb.ef ], [ %i.ju, %bb.eh ], [ %i.by, %bb.ae ], [ %common.resume.op.i, %common.resume.i ], [ %common.resume.op.i147, %common.resume.i146 ], [ %i.gy, %bb.cu ], [ %lpad.loopexit, %.loopexit259 ], [ %lpad.loopexit.split-lp, %.loopexit.split-lp ]
