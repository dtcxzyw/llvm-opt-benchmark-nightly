...
9:                                                ; preds = %bb.ab
  %10 = invoke noalias noundef nonnull dereferenceable(40) ptr @_Znwm(i64 noundef 40) #35
...
11:                                               ; preds = %.noexc137
  %12 = landingpad { ptr, i32 }
          cleanup
  call void @_ZdlPvm(ptr noundef nonnull %10, i64 noundef 40) #32
  br label %.body
...
bb.ad:                                            ; preds = %.noexc137, %13
  %.sink541 = phi ptr [ %i.bv, %13 ], [ %10, %.noexc137 ] ; 2 uses
  %.sink = phi i32 [ %15, %13 ], [ -1, %.noexc137 ]
  %i.bw = getelementptr inbounds nuw i8, ptr %.sink541, i64 24
  store i32 %.sink, ptr %i.bw, align 8, !tbaa !26
  %i.bx = invoke noundef zeroext i1 @_ZN3re26Regexp10ParseState10PushRegexpEPS0_(ptr noundef nonnull align 8 dereferenceable(48) %6, ptr noundef nonnull %.sink541)
...
bb.bk:                                            ; preds = %bb.bj
  %i.dv = load ptr, ptr %i.ad, align 8, !tbaa !172 ; 3 uses
...
bb.bs:                                            ; preds = %bb.br
  ...
  store ptr %i.ey, ptr %i.ad, align 8, !tbaa !172
...
..thread36.i_crit_edge:                           ; preds = %bb.bu
  %.pre422 = load ptr, ptr %i.ad, align 8, !tbaa !172
  br label %.thread36.i
...
bb.bx:                                            ; preds = %.thread36.i
  ...
  store ptr %i.fn, ptr %i.ad, align 8, !tbaa !172
  %i.fo = add i64 %i.fh, -1
...
.body:                                            ; preds = %.loopexit259.a, %.loopexit.split-lp, %bb.em, %11, %common.resume.i, %bb.cu, %bb.cx, %bb.aa, %common.resume.i146, %bb.ae, %bb.ej, %bb.eh, %bb.eg, %bb.ef, %bb.dr, %bb.ds, %bb.di, %bb.cg, %bb.be, %bb.av, %bb.t, %bb.m, %bb.i, %bb.h
  %.pn110 = phi { ptr, i32 } [ %i.as, %bb.m ], [ %i.w, %bb.h ], [ %i.x, %bb.i ], [ %i.kd, %bb.em ], [ %i.bk, %bb.t ], [ %i.jt, %bb.eg ], [ %i.cw, %bb.av ], [ %i.di, %bb.be ], [ %.pn102, %bb.cg ], [ %i.ih, %bb.di ], [ %i.iq, %bb.dr ], [ %i.bt, %bb.aa ], [ %i.ir, %bb.ds ], [ %i.hd, %bb.cx ], [ %i.jx, %bb.ej ], [ %i.js, %bb.ef ], [ %i.ju, %bb.eh ], [ %12, %11 ], [ %i.by, %bb.ae ], [ %common.resume.op.i, %common.resume.i ], [ %common.resume.op.i147, %common.resume.i146 ], [ %i.gy, %bb.cu ], [ %lpad.loopexit, %.loopexit259.a ], [ %lpad.loopexit.split-lp, %.loopexit.split-lp ]
