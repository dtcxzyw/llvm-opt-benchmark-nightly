...
.lr.ph:                                           ; preds = %.loopexit, %bb.t
  ...
  %i.ap = load i8, ptr %i.ao, align 8, !tbaa !37
...
bb.p:                                             ; preds = %_ZN4absl12lts_2024011612log_internal10LogMessagelsILi11EEERS2_RAT__Kc.exit
  ...
  store ptr null, ptr %i.am, align 8, !tbaa !38
  store i8 2, ptr %i.ai, align 8, !tbaa !37
  br label %bb.t
...
bb.t:                                             ; preds = %bb.p, %bb.r, %bb.s, %.lr.ph
  ...
  br i1 %.not57, label %._crit_edge, label %.lr.ph, !llvm.loop !165
...
bb.a:
  ...
  store ptr %0, ptr %i.c, align 8, !tbaa !89
...
.noexc:                                           ; preds = %.noexc.backedge, %.noexc.preheader
  %i.i = load ptr, ptr %i.f, align 8, !tbaa !174  ; 12 uses
  ...
  %i.o = load ptr, ptr %i.m, align 8, !tbaa !92   ; 5 uses
...
bb.c:                                             ; preds = %.noexc
  %i.t = load i32, ptr %i.n, align 8, !tbaa !18   ; 2 uses
...
.preheader113:                                    ; preds = %bb.c
  %i.aa = load i32, ptr %i.k, align 8, !tbaa !18
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.ag = load ptr, ptr %i.g, align 8, !tbaa !94
  %.not.i87 = icmp eq ptr %i.i, %i.ag
  br i1 %.not.i87, label %bb.f, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.ah = load ptr, ptr %i.ae, align 8, !tbaa !89
  %i.ai = load i32, ptr %i.af, align 8, !tbaa !18
  store ptr %i.ah, ptr %i.i, align 8, !tbaa !100
  %i.aj = getelementptr inbounds nuw i8, ptr %i.i, i64 8
  store i32 %i.ai, ptr %i.aj, align 8, !tbaa !101
  ...
  store ptr %i.al, ptr %i.f, align 8, !tbaa !102
...
.preheader112:                                    ; preds = %.preheader113, %.loopexit
  ...
  %i.an = load ptr, ptr %i.j, align 8, !tbaa !89  ; 7 uses
  %i.ao = getelementptr inbounds nuw i8, ptr %.sroa.099.0134, i64 8 ; 2 uses
  %i.ap = load ptr, ptr %i.ao, align 8, !tbaa !104 ; 3 uses
...
iter.check235:                                    ; preds = %.preheader112
  ...
  %i.au = ptrtoaddr ptr %i.an to i64              ; 2 uses
  %i.av = sext i32 %.065135 to i64                ; 7 uses
  %6 = add i64 %i.au, 8
  %7 = shl nsw i64 %i.aq, 3                       ; 2 uses
  %i.aw = add i64 %6, %7
  %umax = call i64 @llvm.umax.i64(i64 %i.at, i64 %i.aw)
  %8 = xor i64 %i.au, -1
  %9 = add i64 %umax, %8
  %i.ax = sub i64 %9, %7                          ; 3 uses
...
vector.body223:                                   ; preds = %vector.body223, %vector.ph221
  ...
  %wide.load225 = load <4 x ptr>, ptr %next.gep, align 8, !tbaa !61
  %wide.load226 = load <4 x ptr>, ptr %i.bj, align 8, !tbaa !61
  %wide.load227 = load <4 x ptr>, ptr %i.bk, align 8, !tbaa !61
  ...
  store <4 x ptr> %wide.load225, ptr %gep, align 8, !tbaa !61
  store <4 x ptr> %wide.load226, ptr %i.bm, align 8, !tbaa !61
  store <4 x ptr> %wide.load227, ptr %i.bn, align 8, !tbaa !61
  ...
  br i1 %i.bp, label %middle.block230, label %vector.body223, !llvm.loop !166
...
vec.epilog.iter.check237:                         ; preds = %middle.block230
  ...
  br i1 %min.epilog.iters.check238, label %.lr.ph.preheader, label %vec.epilog.ph239, !prof !175
...
vec.epilog.vector.body241:                        ; preds = %vec.epilog.vector.body241, %vec.epilog.ph239
  ...
  %wide.load244 = load <4 x ptr>, ptr %next.gep243, align 8, !tbaa !61
  %gep279 = getelementptr [8 x i8], ptr %invariant.gep278, i64 %index242
  store <4 x ptr> %wide.load244, ptr %gep279, align 8, !tbaa !61
  %index.next245 = add nuw i64 %index242, 4       ; 2 uses
  %i.bv = icmp eq i64 %index.next245, %n.vec240
  br i1 %i.bv, label %vec.epilog.middle.block246, label %vec.epilog.vector.body241, !llvm.loop !167
...
._crit_edge137:                                   ; preds = %.loopexit, %.loopexit.thread
  ...
  %.pre162 = load ptr, ptr %i.m, align 8, !tbaa !105 ; 2 uses
  %.pre163 = load ptr, ptr %i.p, align 8, !tbaa !106
...
_ZSt8_DestroyIPN3re26SpliceES1_EvT_S3_RSaIT0_E.exit.i.i: ; preds = %.preheader113, %._crit_edge137
  ...
  store ptr %i.bx, ptr %i.p, align 8, !tbaa !106
...
_ZNSt6vectorIN3re26SpliceESaIS1_EE5clearEv.exit:  ; preds = %._crit_edge137, %_ZSt8_DestroyIPN3re26SpliceES1_EvT_S3_RSaIT0_E.exit.i.i
  ...
  store i32 %.065.lcssa178, ptr %i.k, align 8, !tbaa !18
  br label %bb.t
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  br i1 %i.cc, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !168
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.preheader112
  ...
  %i.cf = load i32, ptr %i.l, align 4, !tbaa !18
...
bb.h:                                             ; preds = %._crit_edge, %._crit_edge
  ...
  %i.cg = load ptr, ptr %.sroa.099.0134, align 8, !tbaa !107
  store ptr %i.cg, ptr %i.e, align 16, !tbaa !61
  %i.ch = load ptr, ptr %i.ao, align 8, !tbaa !104
  %i.ci = getelementptr inbounds nuw i8, ptr %.sroa.099.0134, i64 20
  %i.cj = load i32, ptr %i.ci, align 4, !tbaa !108
...
bb.j:                                             ; preds = %bb.i
  %i.cm = load ptr, ptr %i.j, align 8, !tbaa !89
  ...
  %i.cr = load i32, ptr %i.cq, align 8, !tbaa !109
...
bb.l:                                             ; preds = %._crit_edge
  %i.cu = load ptr, ptr %.sroa.099.0134, align 8, !tbaa !107
  ...
  %i.cz = load i32, ptr %i.cy, align 8, !tbaa !109
...
_ZN4absl12lts_2024011612log_internal10LogMessagelsILi16EEERS2_RAT__Kc.exit: ; preds = %bb.n
  %i.db = load i32, ptr %i.l, align 4, !tbaa !18
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b)
  store i32 %i.db, ptr %i.b, align 4, !tbaa !18
