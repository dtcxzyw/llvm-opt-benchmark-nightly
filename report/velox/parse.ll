inline.NumInlined: 1141
inline.NumDeleted: 385
begin_hunk_0_@_ZN3re222MaybeParsePerlCCEscapeEPSt17basic_string_viewIcSt11char_traitsIcEENS_6Regexp10ParseFlagsE:bb.a
  %wide.trip.count.i.i = zext nneg i32 %i.g to i64
  br label %.lr.ph.i.i

.lr.ph.i.i:                                       ; preds = %.lr.ph.preheader.i.i, %bb.e
  %indvars.iv.i.i = phi i64 [ %indvars.iv.next.i.i, %bb.e ], [ 0, %.lr.ph.preheader.i.i ] ; 2 uses
  %i.i = getelementptr inbounds nuw [48 x i8], ptr @_ZN3re211perl_groupsE, i64 %indvars.iv.i.i ; 2 uses
...
begin_hunk_1_@_ZN3re26Regexp5ParseESt17basic_string_viewIcSt11char_traitsIcEENS0_10ParseFlagsEPNS_12RegexpStatusE:bb.a
  ...
  %i.ad = getelementptr inbounds nuw i8, ptr %6, i64 44
  %i.ae = getelementptr inbounds nuw i8, ptr %4, i64 8 ; 5 uses
  br label %bb.p
...
bb.w:                                             ; preds = %bb.p
  %i.bm = load i32, ptr %6, align 8, !tbaa !7     ; 3 uses
...
bb.aa:                                            ; preds = %bb.cw, %bb.cv, %bb.ct, %bb.cs, %_ZN3re26Regexp10ParseState12PushSimpleOpENS_8RegexpOpE.exit.i148, %bb.ck, %_ZN3re26Regexp10ParseState12PushSimpleOpENS_8RegexpOpE.exit.i, %bb.ak, %bb.ad, %bb.ac, %bb.cy, %bb.ar, %bb.ap, %bb.ah, %bb.af, %8, %bb.y
...
bb.ab:                                            ; preds = %bb.x, %bb.w
  ...
  br i1 %.not106, label %8, label %bb.ac

bb.ac:                                            ; preds = %bb.ab
  %i.bv = invoke noalias noundef nonnull dereferenceable(40) ptr @_Znwm(i64 noundef 40) #35
          to label %.noexc137.a unwind label %bb.aa ; 4 uses
...
bb.ad:                                            ; preds = %.noexc137.a
  %i.bw = getelementptr inbounds nuw i8, ptr %i.bv, i64 24
  store i32 -1, ptr %i.bw, align 8, !tbaa !26
  %i.bx = invoke noundef zeroext i1 @_ZN3re26Regexp10ParseState10PushRegexpEPS0_(ptr noundef nonnull align 8 dereferenceable(48) %6, ptr noundef nonnull %i.bv)
...
begin_hunk_5_@_ZN3re26Regexp5ParseESt17basic_string_viewIcSt11char_traitsIcEENS0_10ParseFlagsEPNS_12RegexpStatusE:bb.a
  call void @_ZdlPvm(ptr noundef nonnull %i.bv, i64 noundef 40) #32
  br label %.body

8:                                                ; preds = %bb.ab
  %9 = invoke noundef zeroext i1 @_ZN3re26Regexp10ParseState11DoLeftParenESt17basic_string_viewIcSt11char_traitsIcEE(ptr noundef nonnull align 8 dereferenceable(48) %6, i64 0, ptr null)
          to label %_ZN3re26Regexp10ParseState20DoLeftParenNoCaptureEv.exit unwind label %bb.aa ; 0 uses

_ZN3re26Regexp10ParseState20DoLeftParenNoCaptureEv.exit: ; preds = %bb.ad, %8
  %i.bz = getelementptr inbounds nuw i8, ptr %i.ax, i64 1
  store ptr %i.bz, ptr %.sroa.3.0..sroa_idx, align 8, !tbaa !172
...
bb.bk:                                            ; preds = %bb.bj
  %i.dv = load ptr, ptr %i.ae, align 8, !tbaa !172 ; 3 uses
...
begin_hunk_7_@_ZN3re26Regexp5ParseESt17basic_string_viewIcSt11char_traitsIcEENS0_10ParseFlagsEPNS_12RegexpStatusE:bb.a
  br i1 %i.ew, label %.loopexit, label %.lr.ph.i.i, !llvm.loop !210

bb.br:                                            ; preds = %.lr.ph.i.i
  store ptr %i.ek, ptr %i.ae, align 8
...
bb.bs:                                            ; preds = %bb.br
  ...
  store ptr %i.ey, ptr %i.ae, align 8, !tbaa !172
  %i.ez = add i64 %i.ej, -1                       ; 3 uses
  store i64 %i.ez, ptr %4, align 8, !tbaa !171
...
..thread36.i_crit_edge:                           ; preds = %bb.bu
  %.pre422 = load ptr, ptr %i.ae, align 8, !tbaa !172
  br label %.thread36.i
...
bb.bx:                                            ; preds = %.thread36.i
  ...
  store ptr %i.fn, ptr %i.ae, align 8, !tbaa !172
  %i.fo = add i64 %i.fh, -1
  store i64 %i.fo, ptr %4, align 8, !tbaa !171
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %7, ptr noundef nonnull align 8 dereferenceable(16) %4, i64 16, i1 false), !tbaa.struct !209
end_hunk_9
...
.loopexit257:                                     ; preds = %bb.dy, %bb.dx, %.thread237, %bb.dw
  ...
  %i.jv = load i32, ptr %i.ad, align 4, !tbaa !21
...
.body:                                            ; preds = %.loopexit259.a, %.loopexit.split-lp, %bb.em, %bb.ae, %common.resume.i146, %bb.aa, %bb.cx, %bb.cu, %common.resume.i, %bb.ej, %bb.eh, %bb.eg, %bb.ef, %bb.dr, %bb.ds, %bb.di, %bb.cg, %bb.be, %bb.av, %bb.t, %bb.m, %bb.i, %bb.h
  %.pn110 = phi { ptr, i32 } [ %i.as, %bb.m ], [ %i.w, %bb.h ], [ %i.x, %bb.i ], [ %i.kd, %bb.em ], [ %i.bk, %bb.t ], [ %i.jt, %bb.eg ], [ %i.cw, %bb.av ], [ %i.di, %bb.be ], [ %.pn102, %bb.cg ], [ %i.ih, %bb.di ], [ %i.iq, %bb.dr ], [ %i.bt, %bb.aa ], [ %i.ir, %bb.ds ], [ %i.hd, %bb.cx ], [ %i.jx, %bb.ej ], [ %i.js, %bb.ef ], [ %i.ju, %bb.eh ], [ %i.by, %bb.ae ], [ %common.resume.op.i, %common.resume.i ], [ %common.resume.op.i147, %common.resume.i146 ], [ %i.gy, %bb.cu ], [ %lpad.loopexit, %.loopexit259.a ], [ %lpad.loopexit.split-lp, %.loopexit.split-lp ]
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #34
  call void @_ZN3re26Regexp10ParseStateD1Ev(ptr noundef nonnull align 8 dead_on_return(48) dereferenceable(48) %6) #34
  br label %bb.eo
end_hunk_11
