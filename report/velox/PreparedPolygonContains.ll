...
bb.a:
  ...
  store <4 x i8> <i8 0, i8 0, i8 0, i8 1>, ptr %i.b, align 8, !tbaa !11
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVN4geos4geom4prep23PreparedPolygonContainsE, i64 16), ptr %0, align 8, !tbaa !13
  ret void
}
