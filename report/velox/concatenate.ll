...
.lr.ph.i57.i:                                     ; preds = %.noexc65.i, %.lr.ph.i57.i
  %.0145.i.i = phi i64 [ %i.cui, %.lr.ph.i57.i ], [ 0, %.noexc65.i ]
  ...
  %i.cui = add nsw i64 %i.cuh, %.0145.i.i         ; 2 uses
...
_ZNK5arrow9ArrayData9GetValuesIhEEPKT_il.exit93.i.i: ; preds = %bb.aey, %bb.aex
  ...
  invoke void @_ZN5arrow8internal13TransposeIntsERKNS_8DataTypeES3_PKhPhlllPKi(ptr dead_on_unwind nonnull writable sret(%"class.arrow::Status") align 8 %20, ptr noundef nonnull align 8 dereferenceable(72) %i.ces, ptr noundef nonnull align 8 dereferenceable(72) %i.ces, ptr noundef %.0.i92.i.i, ptr noundef %.075152.i.i, i64 noundef %i.cwt, i64 noundef 0, i64 noundef %i.cwv, ptr noundef %i.cvu)
...
.lr.ph148.i.i:                                    ; preds = %.preheader141.i.i, %bb.afq
  ...
  %.067147.i.i = phi i64 [ %i.dak, %bb.afq ], [ 0, %.preheader141.i.i ] ; 4 uses
