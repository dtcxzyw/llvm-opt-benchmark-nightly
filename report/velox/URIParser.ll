...
_ZN8facebook5velox10StringViewC2EPKci.exit:       ; preds = %bb.h, %bb.i, %bb.j
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %.sroa.434.0..sroa_idx, ptr noundef nonnull align 4 dereferenceable(12) %.sroa.434, i64 12, i1 false), !tbaa.struct !14
...
bb.m:                                             ; preds = %bb.l
  ...
  br i1 %i.at, label %bb.n, label %bb.q, !prof !17

bb.n:                                             ; preds = %bb.m
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #8
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #8, !noalias !36
  store i32 %i.as, ptr %4, align 16, !tbaa !9, !noalias !36
  %i.au = getelementptr inbounds nuw i8, ptr %4, i64 16
  store i32 0, ptr %i.au, align 16, !tbaa !9, !noalias !36
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #8, !noalias !36
...
bb.p:                                             ; preds = %bb.n
  %i.av = landingpad { ptr, i32 }
          cleanup
  %i.aw = load ptr, ptr %5, align 8, !tbaa !22    ; 2 uses
...
bb.s:                                             ; preds = %bb.r
  ...
  %i.be = tail call i64 asm sideeffect "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %i.bd) #8, !srcloc !13
...
_ZN8facebook5velox10StringViewC2EPKci.exit30:     ; preds = %bb.r, %bb.s, %bb.t
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %.sroa.4.0..sroa_idx, ptr noundef nonnull align 4 dereferenceable(12) %.sroa.4, i64 12, i1 false), !tbaa.struct !14
...
bb.r:                                             ; preds = %bb.q, %_ZN8facebook5velox9functions12_GLOBAL__N_119tryConsumeIPLiteralEPKcmRi.exit.i
  ...
  br i1 %i.bw, label %bb.s, label %bb.v, !prof !17

bb.s:                                             ; preds = %bb.r
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #8
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #8, !noalias !42
  store i32 %i.bv, ptr %4, align 16, !tbaa !9, !noalias !42
  %i.bx = getelementptr inbounds nuw i8, ptr %4, i64 16
  store i32 0, ptr %i.bx, align 16, !tbaa !9, !noalias !42
  call void @_ZN3fmt3v117vformatB5cxx11ENS0_17basic_string_viewIcEENS0_17basic_format_argsINS0_7contextEEE(ptr dead_on_unwind nonnull writable sret(%"class.std::__cxx11::basic_string") align 8 %5, ptr nonnull @.str.23, i64 11, i64 17, ptr nonnull %4)
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #8, !noalias !42
  invoke void @_ZN8facebook5velox6detail14veloxCheckFailINS0_17VeloxRuntimeErrorERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEEvRKNS1_18VeloxCheckFailArgsET0_NS0_24CompileTimeStringLiteralE(ptr noundef nonnull align 8 dereferenceable(56) @_ZZN8facebook5velox10StringViewC1EPKciE18veloxCheckFailArgs_0, ptr noundef nonnull align 8 dereferenceable(32) %5, ptr nonnull @.str.23) #9
...
bb.u:                                             ; preds = %bb.s
  %i.by = landingpad { ptr, i32 }
          cleanup
  %i.bz = load ptr, ptr %5, align 8, !tbaa !22    ; 2 uses
...
bb.x:                                             ; preds = %bb.w
  ...
  %i.ch = tail call i64 asm sideeffect "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %i.cg) #8, !srcloc !13
...
_ZN8facebook5velox9functions12_GLOBAL__N_111consumeHostEPKcmRiRNS1_3URIE.exit: ; preds = %bb.w, %bb.x, %bb.y
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %.sroa.4.0..sroa_idx.i, ptr noundef nonnull align 4 dereferenceable(12) %.sroa.4.i, i64 12, i1 false), !tbaa.struct !14
