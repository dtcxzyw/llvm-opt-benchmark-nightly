...
tailrecurse:                                      ; preds = %tailrecurse.backedge, %bb.a
  ...
  %i.n = load ptr, ptr %i.m, align 8, !tbaa !99   ; 62 uses
...
bb.arr:                                           ; preds = %tailrecurse
  %i.fgb = getelementptr inbounds nuw i8, ptr %.tr1405, i64 8 ; 5 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %49) #25, !noalias !1618
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %49, i8 0, i64 16, i1 false), !noalias !1618
  call void @llvm.lifetime.start.p0(ptr nonnull %50) #25, !noalias !1618
  tail call void @llvm.experimental.noalias.scope.decl(metadata !1621)
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #25, !noalias !1624
  %i.fgc = getelementptr inbounds nuw i8, ptr %i.n, i64 40
...
_ZNSt10shared_ptrIN5arrow6BufferEEC2ERKS2_.exit.i1232: ; preds = %bb.aru, %bb.art, %bb.arr
  %i.fgo = phi ptr [ %i.n, %bb.arr ], [ %i.n, %bb.art ], [ %.pre.i1277, %bb.aru ] ; 2 uses
