...
bb.a:
  ...
  br i1 %i.b, label %.lr.ph, label %._crit_edge, !prof !11
...
bb.b:                                             ; preds = %._crit_edge
  ...
  tail call void %i.e(ptr noundef nonnull align 8 dereferenceable(8) %1), !call_target !14
...
_ZNSt13__atomic_baseIlE21compare_exchange_weakERllSt12memory_orderS2_.exit: ; preds = %bb.f
  ...
  br i1 %i.k, label %bb.f, label %._crit_edge, !prof !31, !llvm.loop !32
...
"_ZN5folly6fibers5Baton9waitFiberIZNS1_4waitEvE3$_0EEvRNS0_12FiberManagerEOT_.exit.i": ; preds = %bb.e, %bb.d
  ...
  store ptr %2, ptr %i.h, align 16, !tbaa !112
...
bb.b:                                             ; preds = %bb.a
  %i.e = cmpxchg ptr %0, i64 0, i64 -3 seq_cst seq_cst, align 8 ; 2 uses
  %i.f = extractvalue { i64, i1 } %i.e, 1
  br i1 %i.f, label %_ZNSt13__atomic_baseIlE23compare_exchange_strongERllSt12memory_orderS2_.exit, label %_ZNSt13__atomic_baseIlE23compare_exchange_strongERllSt12memory_orderS2_.exit.thread, !prof !118
...
bb.g:                                             ; preds = %bb.f
  ...
  tail call void %i.j(ptr noundef nonnull align 8 dereferenceable(8) %i.h), !call_target !14
  br label %_ZN5folly6fibers5Baton10postThreadEv.exit
...
bb.e:                                             ; preds = %_ZN5folly6detail14futexWaitUntilISt6atomicIjENSt6chrono3_V212steady_clockENS4_8durationIlSt5ratioILl1ELl1000000000EEEEEENS0_11FutexResultEPKT_jRKNS4_10time_pointIT0_T1_EEj.exit
  store i32 %i.ak, ptr %0, align 4, !tbaa !145
  br label %.thread
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.i = load ptr, ptr %i.h, align 8, !tbaa !12
  %i.j = load ptr, ptr %i.i, align 8
  tail call void %i.j(ptr noundef nonnull align 8 dereferenceable(8) %i.h), !call_target !14, !inline_history !147
  br label %_ZN5folly6fibers5Baton10postHelperEl.exit
