...
vec.epilog.vector.body:                           ; preds = %iter.check, %vec.epilog.vector.body
  ...
  %9 = getelementptr inbounds nuw i8, ptr %i.g, i64 8
  %i.h = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %index61
  %i.i = getelementptr inbounds nuw i8, ptr %i.h, i64 12
  %10 = load i32, ptr %9, align 4, !tbaa !3
  %11 = load i32, ptr %i.i, align 4, !tbaa !3
  %i.j = load <2 x i32>, ptr %8, align 4, !tbaa !3
  %i.k = sext <2 x i32> %i.j to <2 x i64>         ; 3 uses
  %12 = sext i32 %10 to i64                       ; 2 uses
  %13 = sext i32 %11 to i64                       ; 2 uses
  %14 = shufflevector <2 x i64> %i.k, <2 x i64> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %15 = insertelement <4 x i64> %14, i64 %12, i64 2
  %16 = insertelement <4 x i64> %15, i64 %13, i64 3
  %i.l = extractelement <2 x i64> %i.k, i64 0
  %i.m = lshr i64 %i.l, 6
  %i.n = extractelement <2 x i64> %i.k, i64 1
  %i.o = lshr i64 %i.n, 6
  %17 = lshr i64 %12, 6
  %i.p = lshr i64 %13, 6
  %i.q = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %i.m
  %i.r = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %i.o
  %i.s = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %17
  ...
  %i.ac = and <4 x i64> %16, splat (i64 63)
