...
vec.epilog.vector.body:                           ; preds = %iter.check, %vec.epilog.vector.body
  %index61 = phi i64 [ %index.next64, %vec.epilog.vector.body ], [ 0, %iter.check ] ; 4 uses
  ...
  %8 = load <2 x i32>, ptr %i.g, align 4, !tbaa !3
  %9 = sext <2 x i32> %8 to <2 x i64>             ; 3 uses
  %i.n = sext i32 %i.l to i64                     ; 2 uses
  %i.o = sext i32 %i.m to i64                     ; 2 uses
  %10 = shufflevector <2 x i64> %9, <2 x i64> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.p = insertelement <4 x i64> %10, i64 %i.n, i64 2
  %i.q = insertelement <4 x i64> %i.p, i64 %i.o, i64 3
  ...
  %i.s = lshr i64 %i.n, 6
  %i.t = lshr i64 %i.o, 6
  %i.u = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %12
  ...
  %i.ag = and <4 x i64> %i.q, splat (i64 63)
