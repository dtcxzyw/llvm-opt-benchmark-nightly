...
vec.epilog.vector.body:                           ; preds = %iter.check, %vec.epilog.vector.body
  %index61 = phi i64 [ %index.next64, %vec.epilog.vector.body ], [ 0, %iter.check ] ; 5 uses
  %vec.phi62 = phi <4 x i8> [ %i.am, %vec.epilog.vector.body ], [ zeroinitializer, %iter.check ]
  %vec.ind63 = phi <4 x i32> [ %vec.ind.next65, %vec.epilog.vector.body ], [ <i32 0, i32 1, i32 2, i32 3>, %iter.check ] ; 2 uses
  %8 = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %index61
  %i.g = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %index61
  %9 = getelementptr inbounds nuw i8, ptr %i.g, i64 4
  %i.h = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %index61
  %i.i = getelementptr inbounds nuw i8, ptr %i.h, i64 8
  %i.j = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %index61
  %i.k = getelementptr inbounds nuw i8, ptr %i.j, i64 12
  %10 = load i32, ptr %8, align 4, !tbaa !3
  %i.l = load i32, ptr %9, align 4, !tbaa !3
  %i.m = load i32, ptr %i.i, align 4, !tbaa !3
  %11 = load i32, ptr %i.k, align 4, !tbaa !3
  %12 = sext i32 %10 to i64                       ; 2 uses
  %i.n = sext i32 %i.l to i64                     ; 2 uses
  %i.o = sext i32 %i.m to i64                     ; 2 uses
  %13 = sext i32 %11 to i64                       ; 2 uses
  %i.p = insertelement <4 x i64> poison, i64 %12, i64 0
  %i.q = insertelement <4 x i64> %i.p, i64 %i.n, i64 1
  %14 = insertelement <4 x i64> %i.q, i64 %i.o, i64 2
  %15 = insertelement <4 x i64> %14, i64 %13, i64 3
  %16 = lshr i64 %12, 6
  %i.r = lshr i64 %i.n, 6
  %i.s = lshr i64 %i.o, 6
  %i.t = lshr i64 %13, 6
  %i.u = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %16
  %i.v = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %i.r
  %i.w = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %i.s
  %i.x = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %i.t
  %i.y = load i64, ptr %i.u, align 8, !tbaa !8
  %i.z = load i64, ptr %i.v, align 8, !tbaa !8
  %i.aa = load i64, ptr %i.w, align 8, !tbaa !8
  %i.ab = load i64, ptr %i.x, align 8, !tbaa !8
  %i.ac = insertelement <4 x i64> poison, i64 %i.y, i64 0
  %i.ad = insertelement <4 x i64> %i.ac, i64 %i.z, i64 1
  %i.ae = insertelement <4 x i64> %i.ad, i64 %i.aa, i64 2
  %i.af = insertelement <4 x i64> %i.ae, i64 %i.ab, i64 3
  %i.ag = and <4 x i64> %15, splat (i64 63)
  %i.ah = lshr <4 x i64> %i.af, %i.ag
  %i.ai = trunc <4 x i64> %i.ah to <4 x i32>
  %i.aj = and <4 x i32> %i.ai, splat (i32 1)
  %i.ak = shl nuw <4 x i32> %i.aj, %vec.ind63
  %i.al = trunc <4 x i32> %i.ak to <4 x i8>
  %i.am = or <4 x i8> %vec.phi62, %i.al           ; 2 uses
  %index.next64 = add nuw i64 %index61, 4         ; 2 uses
  %vec.ind.next65 = add <4 x i32> %vec.ind63, splat (i32 4)
  %i.an = icmp eq i64 %index.next64, %i.d
  br i1 %i.an, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !10

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %i.ao = tail call i8 @llvm.vector.reduce.or.v4i8(<4 x i8> %i.am)
  br label %._crit_edge41

._crit_edge41:                                    ; preds = %.lr.ph40, %vec.epilog.middle.block, %.preheader
  %.0.lcssa = phi i8 [ 0, %.preheader ], [ %i.ao, %vec.epilog.middle.block ], [ %i.bc, %.lr.ph40 ]
...
.lr.ph40:                                         ; preds = %iter.check, %.lr.ph40
  ...
  %.039 = phi i8 [ %i.bc, %.lr.ph40 ], [ 0, %iter.check ]
  %i.ap = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %indvars.iv50
  ...
  %i.ay = and i32 %i.ax, 1
  %i.az = trunc nuw nsw i64 %indvars.iv50 to i32
  %i.ba = shl nuw i32 %i.ay, %i.az
  %i.bb = trunc i32 %i.ba to i8
  %i.bc = or i8 %.039, %i.bb                      ; 2 uses
...
.lr.ph:                                           ; preds = %.preheader36, %.lr.ph
  ...
  %i.bd = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %indvars.iv45
  call void @llvm.experimental.noalias.scope.decl(metadata !16)
  call void @llvm.experimental.noalias.scope.decl(metadata !19)
  call void @llvm.experimental.noalias.scope.decl(metadata !22)
  %i.be = load <4 x i64>, ptr %i.bd, align 1, !tbaa !14, !noalias !25
  store <4 x i64> %i.be, ptr %4, align 32, !tbaa !14, !alias.scope !25
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #10
  %i.bf = call noundef zeroext i8 @_ZN8facebook5velox4simd11gather8BitsIN5xsimd4fma3INS3_4avx2EEEEEhPKvNS3_5batchIiT_EEiRKSA_(ptr noundef %0, ptr noundef nonnull byval(%"class.xsimd::batch") align 32 %4, i32 noundef 8, ptr noundef nonnull align 1 dereferenceable(1) %5)
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #10
  %i.bg = lshr exact i64 %indvars.iv45, 3
  %i.bh = getelementptr inbounds nuw i8, ptr %3, i64 %i.bg
  store i8 %i.bf, ptr %i.bh, align 1, !tbaa !14
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 8 ; 2 uses
  %i.bi = icmp ugt i64 %i.d, %indvars.iv.next
  %indvars.iv.next46 = add nuw nsw i64 %indvars.iv45, 8
  br i1 %i.bi, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !26

._crit_edge.loopexit:                             ; preds = %.lr.ph
  %i.bj = trunc i64 %i.d to i32
  %i.bk = add i32 %i.bj, -9
  %i.bl = and i32 %i.bk, -8
  %i.bm = add i32 %i.bl, 8
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.preheader36
  %.031.lcssa = phi i32 [ 0, %.preheader36 ], [ %i.bm, %._crit_edge.loopexit ] ; 3 uses
  %i.bn = zext nneg i32 %.031.lcssa to i64        ; 2 uses
  %.not = icmp eq i64 %i.d, %i.bn
...
bb.b:                                             ; preds = %._crit_edge
  ...
  %i.bp = load <4 x i64>, ptr %i.bo, align 1, !tbaa !14, !noalias !36
  store <4 x i64> %i.bp, ptr %6, align 32, !tbaa !14, !alias.scope !36
  %i.bq = trunc nuw i64 %i.d to i32
  %i.br = sub i32 %i.bq, %.031.lcssa
  call void @llvm.lifetime.start.p0(ptr nonnull %7) #10
  %i.bs = call noundef zeroext i8 @_ZN8facebook5velox4simd11gather8BitsIN5xsimd4fma3INS3_4avx2EEEEEhPKvNS3_5batchIiT_EEiRKSA_(ptr noundef %0, ptr noundef nonnull byval(%"class.xsimd::batch") align 32 %6, i32 noundef %i.br, ptr noundef nonnull align 1 dereferenceable(1) %7)
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #10
  %i.bt = lshr exact i32 %.031.lcssa, 3
  %i.bu = zext nneg i32 %i.bt to i64
  %i.bv = getelementptr inbounds nuw i8, ptr %3, i64 %i.bu
  store i8 %i.bs, ptr %i.bv, align 1, !tbaa !14
  br label %bb.c
