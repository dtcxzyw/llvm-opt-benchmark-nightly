...
bb.br:                                            ; preds = %bb.bq
  ...
  %.not783 = icmp ne i8 %i.os, 0                  ; 2 uses
  %brmerge = or i1 %.not783, %i.ob
...
bb.bv:                                            ; preds = %_ZN8simdjson8fallback8ondemand14value_iterator20peek_non_root_scalarEPKc.exit.i112
  ...
  %.not = icmp eq i8 %i.pk, 0                     ; 2 uses
  %brmerge1005 = or i1 %.not, %3
  %.mux1006 = select i1 %.not, i32 17, i32 0
  br i1 %brmerge1005, label %_ZN8simdjson8fallback8ondemand5array5startERNS1_14value_iteratorE.exit, label %.thread953
...
bb.as:                                            ; preds = %_ZN8facebook5velox9functions9trimTokenESt17basic_string_viewIcSt11char_traitsIcEE.exit129
  ...
  %.not432 = icmp ne i8 %i.lr, 0                  ; 2 uses
  %brmerge = or i1 %.not432, %i.kz
