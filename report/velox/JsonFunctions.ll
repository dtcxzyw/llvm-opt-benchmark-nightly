...
define noundef i32 @_ZN8facebook5velox9functions16jsonParsingErrorERKN8simdjson13padded_stringE(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(16) %0) local_unnamed_addr #2 {
bb.a:
...
bb.bc:                                            ; preds = %bb.bb
  %i.km = add nsw i64 %.370.i, 22
  %or.cond.i90 = icmp ult i64 %i.km, 45
  %i.kn = icmp ult i64 %.1591, 9007199254740992
...
_ZN8simdjson8fallback13numberparsing12_GLOBAL__N_116compute_float_64ElmbRd.exit._crit_edge: ; preds = %_ZN8simdjson8fallback13numberparsing12_GLOBAL__N_116compute_float_64ElmbRd.exit
  %.pre844 = load ptr, ptr %i.gx, align 8, !tbaa !21
  br label %bb.bj

bb.bj:                                            ; preds = %_ZN8simdjson8fallback13numberparsing12_GLOBAL__N_116compute_float_64ElmbRd.exit._crit_edge, %bb.bf, %bb.bc, %bb.bi
  %i.mn = phi ptr [ %.pre844, %_ZN8simdjson8fallback13numberparsing12_GLOBAL__N_116compute_float_64ElmbRd.exit._crit_edge ], [ %i.gy, %bb.bf ], [ %i.gy, %bb.bc ], [ %i.gy, %bb.bi ] ; 2 uses
  %i.mo = icmp eq ptr %i.mn, %i.c
  br i1 %i.mo, label %bb.bk, label %_ZN8simdjson8fallback8ondemand5array5startERNS1_14value_iteratorE.exit

bb.bk:                                            ; preds = %bb.bj
  %i.mp = getelementptr inbounds nuw i8, ptr %i.a, i64 36 ; 2 uses
  %i.mq = load i32, ptr %i.mp, align 4, !tbaa !41 ; 4 uses
  %i.mr = load i32, ptr %i.gw, align 8, !tbaa !249
  %i.ms = icmp eq i32 %i.mq, %i.mr
  tail call void @llvm.assume(i1 %i.ms)
  %i.mt = icmp sgt i32 %i.mq, 1
  tail call void @llvm.assume(i1 %i.mt)
  %i.mu = getelementptr inbounds nuw i8, ptr %i.mn, i64 4
  store ptr %i.mu, ptr %i.gx, align 8, !tbaa !21
  %i.mv = add nsw i32 %i.mq, -1
  %or.cond.i.i85 = icmp ne i32 %i.mq, 2147483647
  tail call void @llvm.assume(i1 %or.cond.i.i85)
  store i32 %i.mv, ptr %i.mp, align 4, !tbaa !41
  br label %_ZN8simdjson8fallback8ondemand5array5startERNS1_14value_iteratorE.exit

bb.bl:                                            ; preds = %bb.a
  %i.mw = getelementptr inbounds nuw i8, ptr %i.a, i64 8 ; 2 uses
  %i.mx = load ptr, ptr %i.mw, align 8, !tbaa !21, !noalias !270 ; 3 uses
  %i.my = icmp eq ptr %i.mx, %i.c
  br i1 %i.my, label %_ZN8simdjson8fallback8ondemand14value_iterator11peek_scalarEPKc.exit, label %.thread767

_ZN8simdjson8fallback8ondemand14value_iterator11peek_scalarEPKc.exit: ; preds = %bb.bl
  %i.mz = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.na = getelementptr inbounds nuw i8, ptr %i.a, i64 36 ; 2 uses
  %i.nb = load i32, ptr %i.na, align 4, !tbaa !41, !noalias !270 ; 4 uses
  %i.nc = load i32, ptr %i.mz, align 8, !tbaa !249, !noalias !270
  %i.nd = icmp eq i32 %i.nb, %i.nc
  tail call void @llvm.assume(i1 %i.nd), !noalias !270
  %i.ne = icmp sgt i32 %i.nb, 0
  tail call void @llvm.assume(i1 %i.ne), !noalias !270
  %i.nf = load i32, ptr %i.mx, align 4, !tbaa !3, !noalias !270
  %i.ng = zext i32 %i.nf to i64                   ; 2 uses
  %i.nh = getelementptr inbounds nuw i8, ptr %i.d, i64 %i.ng
  %i.ni = load i8, ptr %i.nh, align 1, !tbaa !20, !noalias !270
  %.not.i98 = icmp eq i8 %i.ni, 34
...
bb.bm:                                            ; preds = %_ZN8simdjson8fallback8ondemand14value_iterator11peek_scalarEPKc.exit
  %i.nj = getelementptr inbounds nuw i8, ptr %i.mx, i64 4
  store ptr %i.nj, ptr %i.mw, align 8, !tbaa !21, !noalias !270
  %i.nk = add nsw i32 %i.nb, -1
  %or.cond.i.i106 = icmp ne i32 %i.nb, 2147483647
  tail call void @llvm.assume(i1 %or.cond.i.i106), !noalias !270
  store i32 %i.nk, ptr %i.na, align 4, !tbaa !41, !noalias !270
  br label %.thread767

.thread767:                                       ; preds = %bb.bl, %bb.bm
  %i.nl = phi i64 [ %i.ng, %bb.bm ], [ %i.f, %bb.bl ]
  %i.nm = getelementptr inbounds nuw i8, ptr %i.d, i64 %i.nl
  %i.nn = getelementptr inbounds nuw i8, ptr %i.nm, i64 1
  %i.no = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  %i.np = load ptr, ptr %i.no, align 8, !tbaa !28, !noalias !273
  %i.nq = getelementptr inbounds nuw i8, ptr %i.a, i64 24 ; 2 uses
  %i.nr = getelementptr inbounds nuw i8, ptr %i.np, i64 8
  %i.ns = load ptr, ptr %i.nr, align 8, !tbaa !29, !noalias !276 ; 2 uses
  %i.nt = load ptr, ptr %i.nq, align 8, !tbaa !79, !noalias !276
  %i.nu = load ptr, ptr %i.ns, align 8, !tbaa !83, !noalias !276
  %i.nv = getelementptr inbounds nuw i8, ptr %i.nu, i64 32
  %i.nw = load ptr, ptr %i.nv, align 8, !noalias !276
  %i.nx = tail call noundef ptr %i.nw(ptr noundef nonnull align 8 dereferenceable(48) %i.ns, ptr noundef nonnull %i.nn, ptr noundef %i.nt, i1 noundef zeroext false) #26, !noalias !276, !inline_history !279 ; 2 uses
  %.not.i107 = icmp eq ptr %i.nx, null
...
bb.bn:                                            ; preds = %.thread767
  store ptr %i.nx, ptr %i.nq, align 8, !tbaa !79, !noalias !276
  br label %_ZN8simdjson8fallback8ondemand5array5startERNS1_14value_iteratorE.exit

bb.bo:                                            ; preds = %bb.a, %bb.a
  %i.ny = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.nz = getelementptr inbounds nuw i8, ptr %i.a, i64 8 ; 2 uses
  %i.oa = load ptr, ptr %i.nz, align 8, !tbaa !21 ; 3 uses
  %i.ob = icmp ne ptr %i.oa, %i.c                 ; 2 uses
  br i1 %i.ob, label %bb.bq, label %bb.bp

bb.bp:                                            ; preds = %bb.bo
  %i.oc = load i32, ptr %i.oa, align 4, !tbaa !3
  %i.od = zext i32 %i.oc to i64
  %i.oe = getelementptr inbounds nuw i8, ptr %i.d, i64 %i.od
  br label %bb.bq

bb.bq:                                            ; preds = %bb.bo, %bb.bp
  %.0.i.i108 = phi ptr [ %i.oe, %bb.bp ], [ %i.g, %bb.bo ] ; 3 uses
  %.0.copyload.i111 = load i32, ptr %.0.i.i108, align 1 ; 2 uses
  %i.of = xor i32 %.0.copyload.i111, 1936482662
  %i.og = getelementptr inbounds nuw i8, ptr %.0.i.i108, i64 4
  %i.oh = load i8, ptr %i.og, align 1, !tbaa !20
  %i.oi = xor i8 %i.oh, 101
  %i.oj = zext i8 %i.oi to i32
  %i.ok = or i32 %i.of, %i.oj
  %i.ol = icmp ne i32 %.0.copyload.i111, 1702195828 ; 2 uses
  %i.om = icmp ne i32 %i.ok, 0
  %or.cond.i109 = select i1 %i.ol, i1 %i.om, i1 false
  br i1 %or.cond.i109, label %_ZN8simdjson8fallback8ondemand5array5startERNS1_14value_iteratorE.exit, label %bb.br

bb.br:                                            ; preds = %bb.bq
  %i.on = select i1 %i.ol, i64 5, i64 4
  %i.oo = getelementptr inbounds nuw i8, ptr %.0.i.i108, i64 %i.on
  %i.op = load i8, ptr %i.oo, align 1, !tbaa !20
  %i.oq = zext i8 %i.op to i64
  %i.or = getelementptr inbounds nuw i8, ptr @_ZN8simdjson8internal32structural_or_whitespace_negatedE, i64 %i.oq
  %i.os = load i8, ptr %i.or, align 1, !tbaa !74, !range !26, !noundef !27
  %3 = trunc nuw i8 %i.os to i1                   ; 2 uses
  %brmerge = or i1 %i.ob, %3
...
bb.bs:                                            ; preds = %bb.br
  %i.ot = getelementptr inbounds nuw i8, ptr %i.a, i64 36 ; 2 uses
  %i.ou = load i32, ptr %i.ot, align 4, !tbaa !41 ; 4 uses
  %i.ov = load i32, ptr %i.ny, align 8, !tbaa !249
  %i.ow = icmp eq i32 %i.ou, %i.ov
  tail call void @llvm.assume(i1 %i.ow)
  %i.ox = icmp sgt i32 %i.ou, 1
  tail call void @llvm.assume(i1 %i.ox)
  %i.oy = getelementptr inbounds nuw i8, ptr %i.oa, i64 4
  store ptr %i.oy, ptr %i.nz, align 8, !tbaa !21
  %i.oz = add nsw i32 %i.ou, -1
  %or.cond.i.i.i = icmp ne i32 %i.ou, 2147483647
  tail call void @llvm.assume(i1 %or.cond.i.i.i)
  store i32 %i.oz, ptr %i.ot, align 4, !tbaa !41
  br label %_ZN8simdjson8fallback8ondemand5array5startERNS1_14value_iteratorE.exit

bb.bt:                                            ; preds = %bb.a
  %i.pa = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.pb = getelementptr inbounds nuw i8, ptr %i.a, i64 8 ; 2 uses
  %i.pc = load ptr, ptr %i.pb, align 8, !tbaa !21 ; 3 uses
  %4 = icmp eq ptr %i.pc, %i.c                    ; 2 uses
...
bb.bu:                                            ; preds = %bb.bt
  ...
  %i.pf = getelementptr inbounds nuw i8, ptr %i.d, i64 %i.pe
...
_ZN8simdjson8fallback8ondemand14value_iterator20peek_non_root_scalarEPKc.exit.i112: ; preds = %bb.bt, %bb.bu
  %.0.i.i113 = phi ptr [ %i.pf, %bb.bu ], [ %i.g, %bb.bt ] ; 2 uses
...
bb.bv:                                            ; preds = %_ZN8simdjson8fallback8ondemand14value_iterator20peek_non_root_scalarEPKc.exit.i112
  %i.pg = getelementptr inbounds nuw i8, ptr %.0.i.i113, i64 4
  %i.ph = load i8, ptr %i.pg, align 1, !tbaa !20
  %i.pi = zext i8 %i.ph to i64
  %i.pj = getelementptr inbounds nuw i8, ptr @_ZN8simdjson8internal24structural_or_whitespaceE, i64 %i.pi
  %i.pk = load i8, ptr %i.pj, align 1, !tbaa !74, !range !26, !noundef !27
  %5 = trunc nuw i8 %i.pk to i1                   ; 2 uses
  %brmerge1001.not = and i1 %4, %5
  %.mux1006 = select i1 %5, i32 0, i32 17
  br i1 %brmerge1001.not, label %.thread953, label %_ZN8simdjson8fallback8ondemand5array5startERNS1_14value_iteratorE.exit

.thread953:                                       ; preds = %bb.bv
  %i.pl = getelementptr inbounds nuw i8, ptr %i.a, i64 36 ; 2 uses
  %i.pm = load i32, ptr %i.pl, align 4, !tbaa !41 ; 4 uses
  %i.pn = load i32, ptr %i.pa, align 8, !tbaa !249
  %i.po = icmp eq i32 %i.pm, %i.pn
  tail call void @llvm.assume(i1 %i.po)
  %i.pp = icmp sgt i32 %i.pm, 1
  ...
  %or.cond.i.i.i119 = icmp ne i32 %i.pm, 2147483647
  tail call void @llvm.assume(i1 %or.cond.i.i.i119)
  store i32 %i.pr, ptr %i.pl, align 4, !tbaa !41
  br label %_ZN8simdjson8fallback8ondemand5array5startERNS1_14value_iteratorE.exit
...
; Function Attrs: mustprogress uwtable
define internal void @_ZNK8facebook5velox9functions12_GLOBAL__N_118JsonFormatFunction5applyERKNS0_17SelectivityVectorERSt6vectorISt10shared_ptrINS0_10BaseVectorEESaISA_EERKS8_IKNS0_4TypeEERNS0_4exec7EvalCtxERSA_(ptr nofree nonnull readnone align 8 captures(none) %0, ptr noundef nonnull align 8 dereferenceable(38) %1, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(24) %2, ptr nofree nonnull readnone align 8 captures(none) %3, ptr noundef nonnull align 8 dereferenceable(104) %4, ptr noundef nonnull align 8 dereferenceable(16) %5) unnamed_addr #2 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  ...
  %10 = alloca %"class.std::vector.193", align 8  ; 14 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %i.i, label %_ZNSt10lock_guardIN5folly15SharedMutexImplILb0EvSt6atomicNS0_24SharedMutexPolicyDefaultEEEEC2ERS4_.exit, label %_ZNSt13__atomic_baseIjE23compare_exchange_strongERjjSt12memory_orderS2_.exit.i.i.i, !prof !540
...
begin_hunk_4_@_ZNK8facebook5velox9functions12_GLOBAL__N_113JsonParseImpl13generateViewsILb1EN8simdjson8fallback8ondemand5valueEEENS5_10error_codeET0_:bb.a
  %.pre = load ptr, ptr %i.cf, align 8, !tbaa !21
  br label %bb.ag

bb.ag:                                            ; preds = %_ZN8simdjson8fallback13numberparsing12_GLOBAL__N_116compute_float_64ElmbRd.exit._crit_edge, %bb.ac, %bb.z, %bb.af
  %i.hv = phi ptr [ %.pre, %_ZN8simdjson8fallback13numberparsing12_GLOBAL__N_116compute_float_64ElmbRd.exit._crit_edge ], [ %i.cg, %bb.ac ], [ %i.cg, %bb.z ], [ %i.cg, %bb.af ] ; 2 uses
  %i.hw = icmp eq ptr %i.hv, %i.ch
  br i1 %i.hw, label %bb.ah, label %_ZN8simdjson8fallback8ondemand5array5startERNS1_14value_iteratorE.exit

bb.ah:                                            ; preds = %bb.ag
  %i.hx = getelementptr inbounds nuw i8, ptr %i.ce, i64 36 ; 2 uses
  %i.hy = load i32, ptr %i.hx, align 4, !tbaa !41 ; 4 uses
  %i.hz = load i32, ptr %i.cd, align 8, !tbaa !249
  %i.ia = icmp eq i32 %i.hy, %i.hz
  tail call void @llvm.assume(i1 %i.ia)
  %i.ib = icmp sgt i32 %i.hy, 1
  tail call void @llvm.assume(i1 %i.ib)
  %i.ic = getelementptr inbounds nuw i8, ptr %i.hv, i64 4
  store ptr %i.ic, ptr %i.cf, align 8, !tbaa !21
  %i.id = add nsw i32 %i.hy, -1
  %or.cond.i.i51 = icmp ne i32 %i.hy, 2147483647
  tail call void @llvm.assume(i1 %or.cond.i.i51)
  store i32 %i.id, ptr %i.hx, align 4, !tbaa !41
  br label %_ZN8simdjson8fallback8ondemand5array5startERNS1_14value_iteratorE.exit

bb.ai:                                            ; preds = %bb.a
  %i.ie = getelementptr inbounds nuw i8, ptr %0, i64 304
  %i.if = getelementptr inbounds nuw i8, ptr %i.c, i64 4
  %i.ig = load i32, ptr %i.if, align 4, !tbaa !3
  %i.ih = sub i32 %i.ig, %i.e
  %i.ii = zext i32 %i.ih to i64
  br label %bb.aj

bb.aj:                                            ; preds = %_ZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEc.exit.i117, %bb.ai
  %.0.i114 = phi i64 [ %i.ii, %bb.ai ], [ %i.ij, %_ZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEc.exit.i117 ] ; 2 uses
  %i.ij = add i64 %.0.i114, -1                    ; 2 uses
  %i.ik = getelementptr inbounds nuw i8, ptr %i.g, i64 %i.ij
  %i.il = load i8, ptr %i.ik, align 1, !tbaa !20  ; 2 uses
  %i.im = load atomic i8, ptr @_ZGVZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEcE11kAsciiCodes acquire, align 8
  %i.in = icmp eq i8 %i.im, 0
  br i1 %i.in, label %bb.ak, label %bb.al, !prof !2679

bb.ak:                                            ; preds = %bb.aj
  %i.io = tail call i32 @__cxa_guard_acquire(ptr nonnull @_ZGVZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEcE11kAsciiCodes) #26
  %.not.i.i119 = icmp eq i32 %i.io, 0
  br i1 %.not.i.i119, label %bb.al, label %.noexc.i120

.noexc.i120:                                      ; preds = %bb.ak
  store i64 8321515008, ptr @_ZZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEcE11kAsciiCodes, align 8, !tbaa !75
  %i.ip = tail call ptr @llvm.invariant.start.p0(i64 8, ptr nonnull @_ZZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEcE11kAsciiCodes) ; 0 uses
...
bb.al:                                            ; preds = %.noexc.i120, %bb.ak, %bb.aj
  %i.iq = icmp ult i8 %i.il, 33
  br i1 %i.iq, label %_ZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEc.exit.i117, label %_ZN8facebook5velox9functions9trimTokenESt17basic_string_viewIcSt11char_traitsIcEE.exit121

_ZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEc.exit.i117: ; preds = %bb.al
  %i.ir = zext nneg i8 %i.il to i64
  %i.is = load i64, ptr @_ZZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEcE11kAsciiCodes, align 8, !tbaa !75
  %i.it = shl nuw nsw i64 1, %i.ir
  %i.iu = and i64 %i.is, %i.it
  %.not.i118 = icmp eq i64 %i.iu, 0
...
_ZN8facebook5velox9functions9trimTokenESt17basic_string_viewIcSt11char_traitsIcEE.exit121: ; preds = %bb.al, %_ZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEc.exit.i117
  tail call fastcc void @_ZN8facebook5velox9functions12_GLOBAL__N_115addOrMergeViewsERSt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS7_EES7_(ptr noundef nonnull align 8 dereferenceable(24) %i.ie, i64 %.0.i114, ptr nonnull %i.g)
  %i.iv = load ptr, ptr %1, align 8, !tbaa !243, !noalias !2813 ; 6 uses
  %i.iw = getelementptr inbounds nuw i8, ptr %i.iv, i64 8 ; 2 uses
  %i.ix = load ptr, ptr %i.iw, align 8, !tbaa !21, !noalias !2813 ; 3 uses
  %i.iy = load ptr, ptr %i.b, align 8, !tbaa !245, !noalias !2813 ; 2 uses
  %i.iz = icmp eq ptr %i.ix, %i.iy
  br i1 %i.iz, label %_ZN8simdjson8fallback8ondemand14value_iterator11peek_scalarEPKc.exit, label %_ZN8simdjson8fallback8ondemand14value_iterator11peek_scalarEPKc.exit.thread
...
_ZN8simdjson8fallback8ondemand14value_iterator11peek_scalarEPKc.exit: ; preds = %_ZN8facebook5velox9functions9trimTokenESt17basic_string_viewIcSt11char_traitsIcEE.exit121
  ...
  %i.jb = getelementptr inbounds nuw i8, ptr %i.iv, i64 36 ; 2 uses
  %i.jc = load i32, ptr %i.jb, align 4, !tbaa !41, !noalias !2813 ; 4 uses
  %i.jd = load i32, ptr %i.ja, align 8, !tbaa !249, !noalias !2813
  %i.je = icmp eq i32 %i.jc, %i.jd
  tail call void @llvm.assume(i1 %i.je), !noalias !2813
  %i.jf = icmp sgt i32 %i.jc, 0
  tail call void @llvm.assume(i1 %i.jf), !noalias !2813
  %i.jg = load ptr, ptr %i.iv, align 8, !tbaa !19, !noalias !2813
  %i.jh = load i32, ptr %i.ix, align 4, !tbaa !3, !noalias !2813
  %i.ji = zext i32 %i.jh to i64
  %i.jj = getelementptr inbounds nuw i8, ptr %i.jg, i64 %i.ji ; 2 uses
  %i.jk = load i8, ptr %i.jj, align 1, !tbaa !20, !noalias !2813
  %.not.i64 = icmp eq i8 %i.jk, 34
...
_ZN8simdjson8fallback8ondemand14value_iterator11peek_scalarEPKc.exit.thread: ; preds = %_ZN8facebook5velox9functions9trimTokenESt17basic_string_viewIcSt11char_traitsIcEE.exit121
  %i.jl = load ptr, ptr %i.iv, align 8, !tbaa !19, !noalias !2813
  %i.jm = load i32, ptr %i.iy, align 4, !tbaa !3, !noalias !2813
  %i.jn = zext i32 %i.jm to i64
  %i.jo = getelementptr inbounds nuw i8, ptr %i.jl, i64 %i.jn ; 2 uses
  %i.jp = load i8, ptr %i.jo, align 1, !tbaa !20, !noalias !2813
  %.not.i64415 = icmp eq i8 %i.jp, 34
...
bb.am:                                            ; preds = %_ZN8simdjson8fallback8ondemand14value_iterator11peek_scalarEPKc.exit
  %i.jq = getelementptr inbounds nuw i8, ptr %i.ix, i64 4
  store ptr %i.jq, ptr %i.iw, align 8, !tbaa !21, !noalias !2813
  %i.jr = add nsw i32 %i.jc, -1
  %or.cond.i.i72 = icmp ne i32 %i.jc, 2147483647
  tail call void @llvm.assume(i1 %or.cond.i.i72), !noalias !2813
  store i32 %i.jr, ptr %i.jb, align 4, !tbaa !41, !noalias !2813
  br label %.thread417

.thread417:                                       ; preds = %_ZN8simdjson8fallback8ondemand14value_iterator11peek_scalarEPKc.exit.thread, %bb.am
  %.0.i71416419 = phi ptr [ %i.jj, %bb.am ], [ %i.jo, %_ZN8simdjson8fallback8ondemand14value_iterator11peek_scalarEPKc.exit.thread ]
  %i.js = getelementptr inbounds nuw i8, ptr %.0.i71416419, i64 1
  %i.jt = getelementptr inbounds nuw i8, ptr %i.iv, i64 16
  %i.ju = load ptr, ptr %i.jt, align 8, !tbaa !28, !noalias !2816
  %i.jv = getelementptr inbounds nuw i8, ptr %i.iv, i64 24 ; 2 uses
  %i.jw = getelementptr inbounds nuw i8, ptr %i.ju, i64 8
  %i.jx = load ptr, ptr %i.jw, align 8, !tbaa !29, !noalias !2819 ; 2 uses
  %i.jy = load ptr, ptr %i.jv, align 8, !tbaa !79, !noalias !2819
  %i.jz = load ptr, ptr %i.jx, align 8, !tbaa !83, !noalias !2819
  %i.ka = getelementptr inbounds nuw i8, ptr %i.jz, i64 32
  %i.kb = load ptr, ptr %i.ka, align 8, !noalias !2819
  %i.kc = tail call noundef ptr %i.kb(ptr noundef nonnull align 8 dereferenceable(48) %i.jx, ptr noundef nonnull %i.js, ptr noundef %i.jy, i1 noundef zeroext true) #26, !noalias !2819, !inline_history !279 ; 2 uses
  %.not.i73 = icmp eq ptr %i.kc, null
...
bb.an:                                            ; preds = %.thread417
  store ptr %i.kc, ptr %i.jv, align 8, !tbaa !79, !noalias !2819
  br label %_ZN8simdjson8fallback8ondemand5array5startERNS1_14value_iteratorE.exit

bb.ao:                                            ; preds = %bb.a, %bb.a
  %i.kd = getelementptr inbounds nuw i8, ptr %0, i64 304
  %i.ke = getelementptr inbounds nuw i8, ptr %i.c, i64 4
  %i.kf = load i32, ptr %i.ke, align 4, !tbaa !3
  %i.kg = sub i32 %i.kf, %i.e
  %i.kh = zext i32 %i.kg to i64
  br label %bb.ap

bb.ap:                                            ; preds = %_ZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEc.exit.i125, %bb.ao
  %.0.i122 = phi i64 [ %i.kh, %bb.ao ], [ %i.ki, %_ZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEc.exit.i125 ] ; 2 uses
  %i.ki = add i64 %.0.i122, -1                    ; 2 uses
  %i.kj = getelementptr inbounds nuw i8, ptr %i.g, i64 %i.ki
  %i.kk = load i8, ptr %i.kj, align 1, !tbaa !20  ; 2 uses
  %i.kl = load atomic i8, ptr @_ZGVZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEcE11kAsciiCodes acquire, align 8
  %i.km = icmp eq i8 %i.kl, 0
  br i1 %i.km, label %bb.aq, label %bb.ar, !prof !2679

bb.aq:                                            ; preds = %bb.ap
  %i.kn = tail call i32 @__cxa_guard_acquire(ptr nonnull @_ZGVZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEcE11kAsciiCodes) #26
  %.not.i.i127 = icmp eq i32 %i.kn, 0
  br i1 %.not.i.i127, label %bb.ar, label %.noexc.i128

.noexc.i128:                                      ; preds = %bb.aq
  store i64 8321515008, ptr @_ZZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEcE11kAsciiCodes, align 8, !tbaa !75
  %i.ko = tail call ptr @llvm.invariant.start.p0(i64 8, ptr nonnull @_ZZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEcE11kAsciiCodes) ; 0 uses
  tail call void @__cxa_guard_release(ptr nonnull @_ZGVZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEcE11kAsciiCodes) #26
  br label %bb.ar

bb.ar:                                            ; preds = %.noexc.i128, %bb.aq, %bb.ap
  %i.kp = icmp ult i8 %i.kk, 33
  br i1 %i.kp, label %_ZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEc.exit.i125, label %_ZN8facebook5velox9functions9trimTokenESt17basic_string_viewIcSt11char_traitsIcEE.exit129

_ZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEc.exit.i125: ; preds = %bb.ar
  %i.kq = zext nneg i8 %i.kk to i64
  %i.kr = load i64, ptr @_ZZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEcE11kAsciiCodes, align 8, !tbaa !75
  %i.ks = shl nuw nsw i64 1, %i.kq
  %i.kt = and i64 %i.kr, %i.ks
  %.not.i126 = icmp eq i64 %i.kt, 0
...
_ZN8facebook5velox9functions9trimTokenESt17basic_string_viewIcSt11char_traitsIcEE.exit129: ; preds = %bb.ar, %_ZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEc.exit.i125
  tail call fastcc void @_ZN8facebook5velox9functions12_GLOBAL__N_115addOrMergeViewsERSt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS7_EES7_(ptr noundef nonnull align 8 dereferenceable(24) %i.kd, i64 %.0.i122, ptr nonnull %i.g)
  %i.ku = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.kv = load ptr, ptr %1, align 8, !tbaa !243   ; 3 uses
  %i.kw = getelementptr inbounds nuw i8, ptr %i.kv, i64 8 ; 2 uses
  %i.kx = load ptr, ptr %i.kw, align 8, !tbaa !21 ; 3 uses
  %i.ky = load ptr, ptr %i.b, align 8, !tbaa !245 ; 2 uses
  %i.kz = icmp ne ptr %i.kx, %i.ky                ; 2 uses
  %spec.select548 = select i1 %i.kz, ptr %i.ky, ptr %i.kx
  %i.la = load ptr, ptr %i.kv, align 8, !tbaa !19
  %i.lb = load i32, ptr %spec.select548, align 4, !tbaa !3
  %i.lc = zext i32 %i.lb to i64
  %i.ld = getelementptr inbounds nuw i8, ptr %i.la, i64 %i.lc ; 3 uses
  %.0.copyload.i77 = load i32, ptr %i.ld, align 1 ; 2 uses
  %i.le = xor i32 %.0.copyload.i77, 1936482662
  %i.lf = getelementptr inbounds nuw i8, ptr %i.ld, i64 4
  %i.lg = load i8, ptr %i.lf, align 1, !tbaa !20
  %i.lh = xor i8 %i.lg, 101
  %i.li = zext i8 %i.lh to i32
  %i.lj = or i32 %i.le, %i.li
  %i.lk = icmp ne i32 %.0.copyload.i77, 1702195828 ; 2 uses
  %i.ll = icmp ne i32 %i.lj, 0
  %or.cond.i75 = select i1 %i.lk, i1 %i.ll, i1 false
...
bb.as:                                            ; preds = %_ZN8facebook5velox9functions9trimTokenESt17basic_string_viewIcSt11char_traitsIcEE.exit129
  %i.lm = select i1 %i.lk, i64 5, i64 4
  %i.ln = getelementptr inbounds nuw i8, ptr %i.ld, i64 %i.lm
  %i.lo = load i8, ptr %i.ln, align 1, !tbaa !20
  %i.lp = zext i8 %i.lo to i64
  %i.lq = getelementptr inbounds nuw i8, ptr @_ZN8simdjson8internal32structural_or_whitespace_negatedE, i64 %i.lp
  %i.lr = load i8, ptr %i.lq, align 1, !tbaa !74, !range !26, !noundef !27
  %4 = trunc nuw i8 %i.lr to i1                   ; 2 uses
  %brmerge = or i1 %i.kz, %4
...
bb.at:                                            ; preds = %bb.as
  %i.ls = getelementptr inbounds nuw i8, ptr %i.kv, i64 36 ; 2 uses
  %i.lt = load i32, ptr %i.ls, align 4, !tbaa !41 ; 4 uses
  %i.lu = load i32, ptr %i.ku, align 8, !tbaa !249
  %i.lv = icmp eq i32 %i.lt, %i.lu
  tail call void @llvm.assume(i1 %i.lv)
  %i.lw = icmp sgt i32 %i.lt, 1
  tail call void @llvm.assume(i1 %i.lw)
  %i.lx = getelementptr inbounds nuw i8, ptr %i.kx, i64 4
  store ptr %i.lx, ptr %i.kw, align 8, !tbaa !21
  %i.ly = add nsw i32 %i.lt, -1
  %or.cond.i.i.i = icmp ne i32 %i.lt, 2147483647
  tail call void @llvm.assume(i1 %or.cond.i.i.i)
  store i32 %i.ly, ptr %i.ls, align 4, !tbaa !41
  br label %_ZN8simdjson8fallback8ondemand5array5startERNS1_14value_iteratorE.exit

bb.au:                                            ; preds = %bb.a
  %i.lz = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.ma = getelementptr inbounds nuw i8, ptr %i.a, i64 8 ; 2 uses
  %i.mb = load ptr, ptr %i.ma, align 8, !tbaa !21 ; 3 uses
  %i.mc = icmp eq ptr %i.mb, %i.c                 ; 2 uses
  br i1 %i.mc, label %bb.av, label %_ZN8simdjson8fallback8ondemand14value_iterator20peek_non_root_scalarEPKc.exit.i78

bb.av:                                            ; preds = %bb.au
  %i.md = load i32, ptr %i.mb, align 4, !tbaa !3
  %i.me = zext i32 %i.md to i64
  %i.mf = getelementptr inbounds nuw i8, ptr %i.d, i64 %i.me
...
_ZN8simdjson8fallback8ondemand14value_iterator20peek_non_root_scalarEPKc.exit.i78: ; preds = %bb.au, %bb.av
  %.0.i.i79 = phi ptr [ %i.mf, %bb.av ], [ %i.g, %bb.au ] ; 2 uses
...
bb.aw:                                            ; preds = %_ZN8simdjson8fallback8ondemand14value_iterator20peek_non_root_scalarEPKc.exit.i78
  %i.mg = getelementptr inbounds nuw i8, ptr %.0.i.i79, i64 4
  %i.mh = load i8, ptr %i.mg, align 1, !tbaa !20
  %i.mi = zext i8 %i.mh to i64
  %i.mj = getelementptr inbounds nuw i8, ptr @_ZN8simdjson8internal24structural_or_whitespaceE, i64 %i.mi
  %i.mk = load i8, ptr %i.mj, align 1, !tbaa !74, !range !26, !noundef !27
  %5 = trunc nuw i8 %i.mk to i1
...
_ZNK8simdjson8fallback8ondemand14value_iterator10parse_nullEPKh.exit: ; preds = %bb.aw
  br i1 %i.mc, label %bb.ax, label %_ZN8simdjson8fallback8ondemand14value_iterator7is_nullEv.exit.thread

bb.ax:                                            ; preds = %_ZNK8simdjson8fallback8ondemand14value_iterator10parse_nullEPKh.exit
  %i.ml = getelementptr inbounds nuw i8, ptr %i.a, i64 36 ; 2 uses
  %i.mm = load i32, ptr %i.ml, align 4, !tbaa !41 ; 4 uses
  %i.mn = load i32, ptr %i.lz, align 8, !tbaa !249
  %i.mo = icmp eq i32 %i.mm, %i.mn
  tail call void @llvm.assume(i1 %i.mo)
  %i.mp = icmp sgt i32 %i.mm, 1
  tail call void @llvm.assume(i1 %i.mp)
  %i.mq = getelementptr inbounds nuw i8, ptr %i.mb, i64 4
  store ptr %i.mq, ptr %i.ma, align 8, !tbaa !21
  %i.mr = add nsw i32 %i.mm, -1
  %or.cond.i.i.i85 = icmp ne i32 %i.mm, 2147483647
  tail call void @llvm.assume(i1 %or.cond.i.i.i85)
  store i32 %i.mr, ptr %i.ml, align 4, !tbaa !41
...
_ZN8simdjson8fallback8ondemand14value_iterator7is_nullEv.exit: ; preds = %_ZN8simdjson8fallback8ondemand14value_iterator20peek_non_root_scalarEPKc.exit.i78
  %i.ms = and i32 %.0.copyload.i.i, 255
  %.not549 = icmp eq i32 %i.ms, 110               ; 2 uses
  %.sroa.4138.0.extract.trunc = select i1 %.not549, i32 17, i32 0
  br i1 %.not549, label %_ZN8simdjson8fallback8ondemand5array5startERNS1_14value_iteratorE.exit, label %_ZN8simdjson8fallback8ondemand14value_iterator7is_nullEv.exit.thread
...
_ZN8simdjson8fallback8ondemand14value_iterator7is_nullEv.exit.thread: ; preds = %bb.ax, %_ZNK8simdjson8fallback8ondemand14value_iterator10parse_nullEPKh.exit, %_ZN8simdjson8fallback8ondemand14value_iterator7is_nullEv.exit
  %i.mt = getelementptr inbounds nuw i8, ptr %0, i64 304
  %i.mu = load i32, ptr %i.c, align 4, !tbaa !3   ; 2 uses
  %i.mv = zext i32 %i.mu to i64
  %i.mw = getelementptr inbounds nuw i8, ptr %i.d, i64 %i.mv ; 2 uses
  %i.mx = getelementptr inbounds nuw i8, ptr %i.c, i64 4
  %i.my = load i32, ptr %i.mx, align 4, !tbaa !3
  %i.mz = sub i32 %i.my, %i.mu
...
bb.ay:                                            ; preds = %_ZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEc.exit.i133, %_ZN8simdjson8fallback8ondemand14value_iterator7is_nullEv.exit.thread
  %.0.i130 = phi i64 [ %i.na, %_ZN8simdjson8fallback8ondemand14value_iterator7is_nullEv.exit.thread ], [ %i.nb, %_ZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEc.exit.i133 ] ; 2 uses
  %i.nb = add i64 %.0.i130, -1                    ; 2 uses
  %i.nc = getelementptr inbounds nuw i8, ptr %i.mw, i64 %i.nb
  %i.nd = load i8, ptr %i.nc, align 1, !tbaa !20  ; 2 uses
  %i.ne = load atomic i8, ptr @_ZGVZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEcE11kAsciiCodes acquire, align 8
  %i.nf = icmp eq i8 %i.ne, 0
  br i1 %i.nf, label %bb.az, label %bb.ba, !prof !2679

bb.az:                                            ; preds = %bb.ay
  %i.ng = tail call i32 @__cxa_guard_acquire(ptr nonnull @_ZGVZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEcE11kAsciiCodes) #26
  %.not.i.i135 = icmp eq i32 %i.ng, 0
  br i1 %.not.i.i135, label %bb.ba, label %.noexc.i136

.noexc.i136:                                      ; preds = %bb.az
  store i64 8321515008, ptr @_ZZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEcE11kAsciiCodes, align 8, !tbaa !75
  %i.nh = tail call ptr @llvm.invariant.start.p0(i64 8, ptr nonnull @_ZZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEcE11kAsciiCodes) ; 0 uses
  tail call void @__cxa_guard_release(ptr nonnull @_ZGVZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEcE11kAsciiCodes) #26
  br label %bb.ba

bb.ba:                                            ; preds = %.noexc.i136, %bb.az, %bb.ay
  %i.ni = icmp ult i8 %i.nd, 33
  br i1 %i.ni, label %_ZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEc.exit.i133, label %_ZN8facebook5velox9functions9trimTokenESt17basic_string_viewIcSt11char_traitsIcEE.exit137

_ZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEc.exit.i133: ; preds = %bb.ba
  %i.nj = zext nneg i8 %i.nd to i64
  %i.nk = load i64, ptr @_ZZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEcE11kAsciiCodes, align 8, !tbaa !75
  %i.nl = shl nuw nsw i64 1, %i.nj
  %i.nm = and i64 %i.nk, %i.nl
  %.not.i134 = icmp eq i64 %i.nm, 0
...
_ZN8facebook5velox9functions9trimTokenESt17basic_string_viewIcSt11char_traitsIcEE.exit137: ; preds = %bb.ba, %_ZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEc.exit.i133
  tail call fastcc void @_ZN8facebook5velox9functions12_GLOBAL__N_115addOrMergeViewsERSt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS7_EES7_(ptr noundef nonnull align 8 dereferenceable(24) %i.mt, i64 %.0.i130, ptr %i.mw)
  %i.nn = select i1 %.not.i86, i32 0, i32 8
  br label %_ZN8simdjson8fallback8ondemand5array5startERNS1_14value_iteratorE.exit
...
_ZN8facebook5velox9functions9trimTokenESt17basic_string_viewIcSt11char_traitsIcEE.exit121: ; preds = %bb.al, %_ZN8facebook5velox9functions10stringImpl17isAsciiWhiteSpaceEc.exit.i117
  tail call fastcc void @_ZN8facebook5velox9functions12_GLOBAL__N_115addOrMergeViewsERSt6vectorISt17basic_string_viewIcSt11char_traitsIcEESaIS7_EES7_(ptr noundef nonnull align 8 dereferenceable(24) %i.ie, i64 %.0.i114, ptr nonnull %i.g)
  %i.iv = load ptr, ptr %1, align 8, !tbaa !243, !noalias !2895 ; 6 uses
  %i.iw = getelementptr inbounds nuw i8, ptr %i.iv, i64 8 ; 2 uses
  %i.ix = load ptr, ptr %i.iw, align 8, !tbaa !21, !noalias !2895 ; 3 uses
  %i.iy = load ptr, ptr %i.b, align 8, !tbaa !245, !noalias !2895 ; 2 uses
  %i.iz = icmp eq ptr %i.ix, %i.iy
  br i1 %i.iz, label %_ZN8simdjson8fallback8ondemand14value_iterator11peek_scalarEPKc.exit, label %_ZN8simdjson8fallback8ondemand14value_iterator11peek_scalarEPKc.exit.thread
...
_ZN8simdjson8fallback8ondemand14value_iterator11peek_scalarEPKc.exit: ; preds = %_ZN8facebook5velox9functions9trimTokenESt17basic_string_viewIcSt11char_traitsIcEE.exit121
  %i.ja = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.jb = getelementptr inbounds nuw i8, ptr %i.iv, i64 36 ; 2 uses
  %i.jc = load i32, ptr %i.jb, align 4, !tbaa !41, !noalias !2895 ; 4 uses
  %i.jd = load i32, ptr %i.ja, align 8, !tbaa !249, !noalias !2895
  %i.je = icmp eq i32 %i.jc, %i.jd
  tail call void @llvm.assume(i1 %i.je), !noalias !2895
  %i.jf = icmp sgt i32 %i.jc, 0
  tail call void @llvm.assume(i1 %i.jf), !noalias !2895
  %i.jg = load ptr, ptr %i.iv, align 8, !tbaa !19, !noalias !2895
  %i.jh = load i32, ptr %i.ix, align 4, !tbaa !3, !noalias !2895
  %i.ji = zext i32 %i.jh to i64
  %i.jj = getelementptr inbounds nuw i8, ptr %i.jg, i64 %i.ji ; 2 uses
  %i.jk = load i8, ptr %i.jj, align 1, !tbaa !20, !noalias !2895
  %.not.i64 = icmp eq i8 %i.jk, 34
  br i1 %.not.i64, label %bb.am, label %_ZN8simdjson8fallback8ondemand5array5startERNS1_14value_iteratorE.exit

_ZN8simdjson8fallback8ondemand14value_iterator11peek_scalarEPKc.exit.thread: ; preds = %_ZN8facebook5velox9functions9trimTokenESt17basic_string_viewIcSt11char_traitsIcEE.exit121
  %i.jl = load ptr, ptr %i.iv, align 8, !tbaa !19, !noalias !2895
  %i.jm = load i32, ptr %i.iy, align 4, !tbaa !3, !noalias !2895
  %i.jn = zext i32 %i.jm to i64
  %i.jo = getelementptr inbounds nuw i8, ptr %i.jl, i64 %i.jn ; 2 uses
  %i.jp = load i8, ptr %i.jo, align 1, !tbaa !20, !noalias !2895
  %.not.i64415 = icmp eq i8 %i.jp, 34
  br i1 %.not.i64415, label %.thread417, label %_ZN8simdjson8fallback8ondemand5array5startERNS1_14value_iteratorE.exit

bb.am:                                            ; preds = %_ZN8simdjson8fallback8ondemand14value_iterator11peek_scalarEPKc.exit
  %i.jq = getelementptr inbounds nuw i8, ptr %i.ix, i64 4
  store ptr %i.jq, ptr %i.iw, align 8, !tbaa !21, !noalias !2895
  %i.jr = add nsw i32 %i.jc, -1
  %or.cond.i.i72 = icmp ne i32 %i.jc, 2147483647
  tail call void @llvm.assume(i1 %or.cond.i.i72), !noalias !2895
  store i32 %i.jr, ptr %i.jb, align 4, !tbaa !41, !noalias !2895
  br label %.thread417
...
.thread417:                                       ; preds = %_ZN8simdjson8fallback8ondemand14value_iterator11peek_scalarEPKc.exit.thread, %bb.am
  ...
  %i.js = getelementptr inbounds nuw i8, ptr %.0.i71416419, i64 1
  %i.jt = getelementptr inbounds nuw i8, ptr %i.iv, i64 16
  %i.ju = load ptr, ptr %i.jt, align 8, !tbaa !28, !noalias !2898
  %i.jv = getelementptr inbounds nuw i8, ptr %i.iv, i64 24 ; 2 uses
  %i.jw = getelementptr inbounds nuw i8, ptr %i.ju, i64 8
  %i.jx = load ptr, ptr %i.jw, align 8, !tbaa !29, !noalias !2901 ; 2 uses
  %i.jy = load ptr, ptr %i.jv, align 8, !tbaa !79, !noalias !2901
  %i.jz = load ptr, ptr %i.jx, align 8, !tbaa !83, !noalias !2901
  %i.ka = getelementptr inbounds nuw i8, ptr %i.jz, i64 32
  %i.kb = load ptr, ptr %i.ka, align 8, !noalias !2901
  %i.kc = tail call noundef ptr %i.kb(ptr noundef nonnull align 8 dereferenceable(48) %i.jx, ptr noundef nonnull %i.js, ptr noundef %i.jy, i1 noundef zeroext true) #26, !noalias !2901, !inline_history !279 ; 2 uses
  %.not.i73 = icmp eq ptr %i.kc, null
  br i1 %.not.i73, label %_ZN8simdjson8fallback8ondemand5array5startERNS1_14value_iteratorE.exit, label %bb.an

bb.an:                                            ; preds = %.thread417
  store ptr %i.kc, ptr %i.jv, align 8, !tbaa !79, !noalias !2901
  br label %_ZN8simdjson8fallback8ondemand5array5startERNS1_14value_iteratorE.exit
...
; Function Attrs: mustprogress uwtable
define internal fastcc void @_ZN8facebook5velox14sortingNetworkIiZNKS0_9functions12_GLOBAL__N_113JsonParseImpl8fastSortEPKNS3_9JsonFieldEiEUliiE_EEvPT_iOT0_(ptr nofree noundef %0, i32 noundef %1, ptr nofree readonly captures(none) %.0.val) unnamed_addr #2 {
bb.a:
