...
.lr.ph:                                           ; preds = %bb.j, %bb.k
  ...
  %i.bt = load <4 x i64>, ptr %i.bs, align 1, !tbaa !20, !noalias !2229 ; 2 uses
  %i.bu = bitcast <4 x i64> %i.bt to <32 x i8>
  %i.bv = icmp ugt <32 x i8> %i.bu, splat (i8 -128)
  ...
  %59 = or <32 x i1> %i.bv, %i.bz
  %60 = sext <32 x i1> %59 to <32 x i8>
  %61 = bitcast <32 x i8> %60 to <4 x i64>        ; 2 uses
  %i.ca = call noundef i32 @llvm.x86.avx.ptestz.256(<4 x i64> %61, <4 x i64> %61)
...
.lr.ph324:                                        ; preds = %bb.gc, %bb.gd
  ...
  %i.zb = load <4 x i64>, ptr %i.za, align 1, !tbaa !20, !noalias !2279 ; 2 uses
  %i.zc = bitcast <4 x i64> %i.zb to <32 x i8>
  %i.zd = icmp ugt <32 x i8> %i.zc, splat (i8 -128)
  ...
  %62 = or <32 x i1> %i.zd, %i.zh
  %63 = sext <32 x i1> %62 to <32 x i8>
  %64 = bitcast <32 x i8> %63 to <4 x i64>        ; 2 uses
  %i.zi = call noundef i32 @llvm.x86.avx.ptestz.256(<4 x i64> %64, <4 x i64> %64)
...
.lr.ph327:                                        ; preds = %bb.gt, %bb.gu
  ...
  %i.ach = load <4 x i64>, ptr %i.acg, align 1, !tbaa !20, !noalias !2287 ; 2 uses
  %i.aci = bitcast <4 x i64> %i.ach to <32 x i8>
  %i.acj = icmp ugt <32 x i8> %i.aci, splat (i8 -128)
  ...
  %65 = or <32 x i1> %i.acj, %i.acn
  %66 = sext <32 x i1> %65 to <32 x i8>
  %67 = bitcast <32 x i8> %66 to <4 x i64>        ; 2 uses
  %i.aco = call noundef i32 @llvm.x86.avx.ptestz.256(<4 x i64> %67, <4 x i64> %67)
...
.lr.ph:                                           ; preds = %bb.a, %bb.b
  ...
  %i.r = load <4 x i64>, ptr %i.q, align 1, !tbaa !20, !noalias !2923 ; 2 uses
  %i.s = bitcast <4 x i64> %i.r to <32 x i8>
  %i.t = icmp ugt <32 x i8> %i.s, splat (i8 -128)
  ...
  %4 = or <32 x i1> %i.t, %i.x
  %5 = sext <32 x i1> %4 to <32 x i8>
  %6 = bitcast <32 x i8> %5 to <4 x i64>          ; 2 uses
  %i.y = tail call noundef i32 @llvm.x86.avx.ptestz.256(<4 x i64> %6, <4 x i64> %6)
