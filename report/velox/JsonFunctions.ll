...
begin_hunk_7
  ...
  br i1 %i.ai, label %4, label %_ZN8simdjson8fallback8ondemand14value_iterator13started_arrayEv.exit.i

4:                                                ; preds = %._crit_edge
  %5 = getelementptr inbounds nuw i8, ptr %i.z, i64 4
  store ptr %5, ptr %i.l, align 8, !tbaa !21, !noalias !2377
  br label %_ZN8simdjson8fallback8ondemand14value_iterator13started_arrayEv.exit.i

bb.e:                                             ; preds = %bb.c
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %0, i8 0, i64 16, i1 false)
  %i.aj = getelementptr inbounds nuw i8, ptr %0, i64 16
  store i32 17, ptr %i.aj, align 8, !tbaa !2210
  br label %bb.f

_ZN8simdjson8fallback8ondemand14value_iterator13started_arrayEv.exit.i: ; preds = %._crit_edge, %4
...
bb.f:                                             ; preds = %_ZN8simdjson8fallback8ondemand14value_iterator13started_arrayEv.exit.i, %bb.e
