...
bb.a:
  ...
  %3 = insertelement <2 x double> poison, double %i.a, i64 0
  %4 = insertelement <2 x double> %3, double %1, i64 1
  %5 = fmul <2 x double> %4, splat (double 0x400921FB54442D18)
  %6 = fdiv <2 x double> %5, splat (double 1.800000e+02) ; 2 uses
  %7 = extractelement <2 x double> %6, i64 0      ; 2 uses
  %8 = tail call double @sin(double noundef %7) #27, !tbaa !3
  %i.b = fmul double %8, 6.371010e+03             ; 2 uses
  %9 = extractelement <2 x double> %6, i64 1      ; 2 uses
  %i.c = tail call double @cos(double noundef %9) #27, !tbaa !3
  %i.d = fmul double %i.b, %i.c
  store double %i.d, ptr %0, align 8, !tbaa !245
  %i.e = tail call double @sin(double noundef %9) #27, !tbaa !3
  %i.f = fmul double %i.b, %i.e
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 8
  store double %i.f, ptr %i.g, align 8, !tbaa !246
  %i.h = tail call double @cos(double noundef %7) #27, !tbaa !3
