...
.lr.ph:                                           ; preds = %bb.a, %_ZN4geos4geom14CoordinateList6insertESt14_List_iteratorINS0_10CoordinateEERKS3_b.exit59
  ...
  %i.ae = load <2 x double>, ptr %.sroa.071.096, align 8, !tbaa !25 ; 6 uses
  ...
  %i.ag = load <2 x double>, ptr %i.af, align 8, !tbaa !25 ; 4 uses
...
bb.l:                                             ; preds = %bb.k
  ...
  %foldExtExtBinop110 = fsub <2 x double> %i.ag, %i.ae ; 2 uses
  %i.bk = extractelement <2 x double> %i.ae, i64 0
  %i.bl = extractelement <2 x double> %i.ae, i64 1
  %7 = extractelement <2 x double> %foldExtExtBinop110, i64 0
  %i.bm = extractelement <2 x double> %foldExtExtBinop110, i64 1
  br label %bb.m
