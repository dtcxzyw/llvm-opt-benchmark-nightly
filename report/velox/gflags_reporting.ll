...
._crit_edge.i.i:                                  ; preds = %bb.a
  %i.g = load ptr, ptr %2, align 8, !tbaa !11
  %i.h = load i64, ptr %i.c, align 8, !tbaa !19
...
bb.b:                                             ; preds = %bb.au, %._crit_edge.i.i
  ...
  %.047 = phi ptr [ %i.g, %._crit_edge.i.i ], [ %.249, %bb.au ] ; 19 uses
  %.045 = phi i32 [ %i.k, %._crit_edge.i.i ], [ %.2, %bb.au ] ; 2 uses
  %i.o = call noundef ptr @strchr(ptr noundef nonnull dereferenceable(1) %.047, i32 noundef 10) #23 ; 2 uses
  %cond = icmp eq ptr %i.o, null
  br i1 %cond, label %bb.c, label %bb.l

bb.c:                                             ; preds = %bb.b
  %i.p = add nsw i32 %i.n, %.045                  ; 5 uses
  %i.q = icmp slt i32 %i.p, 80
  br i1 %i.q, label %bb.d, label %.lr.ph

bb.d:                                             ; preds = %bb.c
  %i.r = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %.047) #22 ; 6 uses
  %i.s = load i64, ptr %i.j, align 8, !tbaa !19   ; 5 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE15_M_check_lengthEmmPKc.exit.i.i: ; preds = %bb.d
  ...
  %i.w = load ptr, ptr %0, align 8, !tbaa !11     ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE15_M_check_lengthEmmPKc.exit.i.i
  %i.z = load i64, ptr %i.i, align 8, !tbaa !16
  br label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i.i.i
...
bb.h:                                             ; preds = %bb.g
  %i.ac = load i8, ptr %.047, align 1, !tbaa !16
  store i8 %i.ac, ptr %i.ab, align 1, !tbaa !16
  br label %._crit_edge.i.i116.sink.split

bb.i:                                             ; preds = %bb.g
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %i.ab, ptr nonnull align 1 %.047, i64 %i.r, i1 false)
  br label %._crit_edge.i.i116.sink.split

bb.j:                                             ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i.i.i
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_mutateEmmPKcm(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.s, i64 noundef 0, ptr noundef nonnull %.047, i64 noundef %i.r)
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.ak = load i64, ptr %i.j, align 8, !tbaa !19  ; 5 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE15_M_check_lengthEmmPKc.exit.i: ; preds = %bb.m
  ...
  %i.ao = load ptr, ptr %0, align 8, !tbaa !11    ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE15_M_check_lengthEmmPKc.exit.i
  %i.ar = load i64, ptr %i.i, align 8, !tbaa !16
  br label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i.i
...
bb.q:                                             ; preds = %bb.p
  %i.au = load i8, ptr %.047, align 1, !tbaa !16
  store i8 %i.au, ptr %i.at, align 1, !tbaa !16
  br label %bb.t

bb.r:                                             ; preds = %bb.p
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %i.at, ptr nonnull align 1 %.047, i64 %i.aj, i1 false)
  br label %bb.t

bb.s:                                             ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i.i
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_mutateEmmPKcm(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.ak, i64 noundef 0, ptr noundef nonnull %.047, i64 noundef %i.aj)
          to label %bb.t unwind label %.loopexit212

bb.t:                                             ; preds = %bb.r, %bb.q, %bb.o, %bb.s
  store i64 %i.an, ptr %i.j, align 8, !tbaa !19
  %i.av = load ptr, ptr %0, align 8, !tbaa !11
  ...
  %.249.phi.trans.insert = getelementptr inbounds i8, ptr %.047, i64 %i.az
  %.pre = load i8, ptr %.249.phi.trans.insert, align 1, !tbaa !16
  br label %bb.as
...
bb.u:                                             ; preds = %.lr.ph, %bb.v
  ...
  %i.bi = load i16, ptr %i.bh, align 2, !tbaa !23
...
.critedge:                                        ; preds = %bb.v
  %i.bl = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %.047) #22 ; 6 uses
  %i.bm = load i64, ptr %i.j, align 8, !tbaa !19  ; 5 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE15_M_check_lengthEmmPKc.exit.i.i96: ; preds = %.critedge
  ...
  %i.bq = load ptr, ptr %0, align 8, !tbaa !11    ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i97: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE15_M_check_lengthEmmPKc.exit.i.i96
  %i.bt = load i64, ptr %i.i, align 8, !tbaa !16
  br label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i.i.i98
...
bb.z:                                             ; preds = %bb.y
  %i.bw = load i8, ptr %.047, align 1, !tbaa !16
  store i8 %i.bw, ptr %i.bv, align 1, !tbaa !16
  br label %._crit_edge.i.i116.sink.split

bb.aa:                                            ; preds = %bb.y
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %i.bv, ptr nonnull align 1 %.047, i64 %i.bl, i1 false)
  br label %._crit_edge.i.i116.sink.split

bb.ab:                                            ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i.i.i98
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_mutateEmmPKcm(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.bm, i64 noundef 0, ptr noundef nonnull %.047, i64 noundef %i.bl)
...
._crit_edge.i.i106.thread:                        ; preds = %bb.ae
  store ptr %i.cb, ptr %3, align 8, !tbaa !11
  store i64 %indvars.iv, ptr %i.l, align 8, !tbaa !16
  br label %bb.ag
...
bb.af:                                            ; preds = %._crit_edge.i.i106
  %i.cc = load i8, ptr %.047, align 1, !tbaa !16
  store i8 %i.cc, ptr %i.l, align 8, !tbaa !16
  br label %bb.ah
...
bb.ag:                                            ; preds = %._crit_edge.i.i106.thread, %._crit_edge.i.i106
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.cd, ptr nonnull align 1 %.047, i64 %indvars.iv, i1 false)
  br label %bb.ah

bb.ah:                                            ; preds = %bb.ag, %bb.af
  %i.ce = phi ptr [ %i.cd, %bb.ag ], [ %i.l, %bb.af ]
  store i64 %indvars.iv, ptr %i.m, align 8, !tbaa !19
  %i.cf = getelementptr inbounds nuw i8, ptr %i.ce, i64 %indvars.iv
  store i8 0, ptr %i.cf, align 1, !tbaa !16
  %i.cg = load ptr, ptr %3, align 8, !tbaa !11    ; 3 uses
  %i.ch = load i64, ptr %i.m, align 8, !tbaa !19  ; 6 uses
  %i.ci = load i64, ptr %i.j, align 8, !tbaa !19  ; 5 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE15_M_check_lengthEmmPKc.exit.i.i.i: ; preds = %bb.ah
  ...
  %i.cm = load ptr, ptr %0, align 8, !tbaa !11    ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE15_M_check_lengthEmmPKc.exit.i.i.i
  %i.cp = load i64, ptr %i.i, align 8, !tbaa !16
  br label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i.i.i.i
...
bb.al:                                            ; preds = %bb.ak
  %i.cs = load i8, ptr %i.cg, align 1, !tbaa !16
  store i8 %i.cs, ptr %i.cr, align 1, !tbaa !16
  br label %bb.ao
...
bb.ao:                                            ; preds = %bb.am, %bb.al, %bb.aj, %bb.an
  store i64 %i.cl, ptr %i.j, align 8, !tbaa !19
  %i.ct = load ptr, ptr %0, align 8, !tbaa !11
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %bb.ao
  %i.cx = load i64, ptr %i.l, align 8, !tbaa !16
  %i.cy = add i64 %i.cx, 1
...
bb.ap:                                            ; preds = %bb.ap, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  ...
  %i.de = getelementptr inbounds [2 x i8], ptr %i.da, i64 %i.dd
  %i.df = load i16, ptr %i.de, align 2, !tbaa !23
  %i.dg = and i16 %i.df, 8192
  %.not71 = icmp eq i16 %i.dg, 0
  %indvars.iv.next276 = add nuw nsw i64 %indvars.iv275, 1
  br i1 %.not71, label %.loopexit, label %bb.ap, !llvm.loop !27
...
bb.ar:                                            ; preds = %.loopexit.split-lp214, %.loopexit213
  ...
  %i.di = load ptr, ptr %3, align 8, !tbaa !11    ; 2 uses
  %i.dj = icmp eq ptr %i.di, %i.l
  br i1 %i.dj, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit115, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i113

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i113: ; preds = %bb.ar
  %i.dk = load i64, ptr %i.l, align 8, !tbaa !16
  %i.dl = add i64 %i.dk, 1
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit115: ; preds = %bb.ar, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i113, %bb.aq
  %.pn = phi { ptr, i32 } [ %i.dh, %bb.aq ], [ %lpad.phi217, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i113 ], [ %lpad.phi217, %bb.ar ]
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #22
  br label %bb.bp

.loopexit:                                        ; preds = %bb.ap
  %i.dm = trunc nuw i64 %indvars.iv275 to i32
  br label %bb.as

bb.as:                                            ; preds = %.loopexit, %bb.t
  %i.dn = phi i8 [ %.pre, %bb.t ], [ %i.dc, %.loopexit ]
  %.pn249 = phi i64 [ %i.az, %bb.t ], [ %indvars.iv275, %.loopexit ]
  %.pn211 = phi i32 [ %i.ay, %bb.t ], [ %i.dm, %.loopexit ]
  %.249 = getelementptr inbounds i8, ptr %.047, i64 %.pn249
  %.2 = sub nsw i32 %.045, %.pn211
  %i.do = icmp eq i8 %i.dn, 0
  br i1 %i.do, label %._crit_edge.i.i116, label %bb.at
...
._crit_edge.i.i116.sink.split:                    ; preds = %bb.aa, %bb.z, %bb.x, %bb.ab, %bb.j, %bb.f, %bb.h, %bb.i
  ...
  %.lcssa328.sink = phi i32 [ %i.p, %bb.j ], [ %i.p, %bb.i ], [ %i.p, %bb.h ], [ %i.p, %bb.f ], [ 80, %bb.ab ], [ 80, %bb.x ], [ 80, %bb.z ], [ 80, %bb.aa ]
  store i64 %.sink, ptr %i.j, align 8, !tbaa !19
  %i.dp = load ptr, ptr %0, align 8, !tbaa !11
  %i.dq = getelementptr inbounds nuw i8, ptr %i.dp, i64 %.sink
  store i8 0, ptr %i.dq, align 1, !tbaa !16
  store i32 %.lcssa328.sink, ptr %i.a, align 4, !tbaa !20
  br label %._crit_edge.i.i116

._crit_edge.i.i116:                               ; preds = %bb.as, %._crit_edge.i.i116.sink.split
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #22
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #22
  %i.dr = getelementptr inbounds nuw i8, ptr %5, i64 16 ; 14 uses
  store ptr %i.dr, ptr %5, align 8, !tbaa !18
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(6) %i.dr, ptr noundef nonnull align 1 dereferenceable(6) @.str.33, i64 6, i1 false)
  %i.ds = getelementptr inbounds nuw i8, ptr %5, i64 8 ; 5 uses
  store i64 6, ptr %i.ds, align 8, !tbaa !19
  %i.dt = getelementptr inbounds nuw i8, ptr %5, i64 22
  store i8 0, ptr %i.dt, align 2, !tbaa !16
  %i.du = getelementptr inbounds nuw i8, ptr %1, i64 32 ; 3 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !28)
  %i.dv = load ptr, ptr %i.du, align 8, !tbaa !11, !noalias !28 ; 3 uses
  %i.dw = getelementptr inbounds nuw i8, ptr %1, i64 40
  %i.dx = load i64, ptr %i.dw, align 8, !tbaa !19, !noalias !28 ; 7 uses
  %i.dy = icmp ugt i64 %i.dx, 9223372036854775801
  br i1 %i.dy, label %bb.av, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i.i.i.i126
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i.i.i.i126: ; preds = %._crit_edge.i.i116
  %i.dz = add nuw nsw i64 %i.dx, 6                ; 2 uses
  %.not.i.i.i.i127 = icmp samesign ugt i64 %i.dx, 9
...
bb.aw:                                            ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i.i.i.i126
  %.not8.i.i.i.i128 = icmp eq i64 %i.dx, 0
  br i1 %.not8.i.i.i.i128, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendERKS4_.exit.i, label %bb.ax

bb.ax:                                            ; preds = %bb.aw
  %i.ea = getelementptr inbounds nuw i8, ptr %5, i64 22 ; 2 uses
  %cond.i.i.i.i129 = icmp eq i64 %i.dx, 1
  br i1 %cond.i.i.i.i129, label %bb.ay, label %bb.az

bb.ay:                                            ; preds = %bb.ax
  %i.eb = load i8, ptr %i.dv, align 1, !tbaa !16, !noalias !28
  store i8 %i.eb, ptr %i.ea, align 2, !tbaa !16, !noalias !28
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendERKS4_.exit.i

bb.az:                                            ; preds = %bb.ax
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 2 %i.ea, ptr align 1 %i.dv, i64 %i.dx, i1 false), !noalias !28
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendERKS4_.exit.i

bb.ba:                                            ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i.i.i.i126
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_mutateEmmPKcm(ptr noundef nonnull align 8 dereferenceable(32) %5, i64 noundef 6, i64 noundef 0, ptr noundef %i.dv, i64 noundef %i.dx)
          to label %._ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendERKS4_.exit.i_crit_edge unwind label %bb.bg

._ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendERKS4_.exit.i_crit_edge: ; preds = %bb.ba
  %.pre278 = load ptr, ptr %5, align 8, !tbaa !11, !noalias !28
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendERKS4_.exit.i

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendERKS4_.exit.i: ; preds = %._ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendERKS4_.exit.i_crit_edge, %bb.az, %bb.ay, %bb.aw
  %i.ec = phi ptr [ %.pre278, %._ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendERKS4_.exit.i_crit_edge ], [ %i.dr, %bb.az ], [ %i.dr, %bb.ay ], [ %i.dr, %bb.aw ]
  store i64 %i.dz, ptr %i.ds, align 8, !tbaa !19, !noalias !28
  %i.ed = getelementptr inbounds nuw i8, ptr %i.ec, i64 %i.dz
  store i8 0, ptr %i.ed, align 1, !tbaa !16, !noalias !28
  %i.ee = getelementptr inbounds nuw i8, ptr %4, i64 16 ; 7 uses
  store ptr %i.ee, ptr %4, align 8, !tbaa !18, !alias.scope !28
  %i.ef = load ptr, ptr %5, align 8, !tbaa !11, !noalias !28 ; 2 uses
  %i.eg = icmp eq ptr %i.ef, %i.dr
  br i1 %i.eg, label %bb.bb, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i130

bb.bb:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendERKS4_.exit.i
  %i.eh = load i64, ptr %i.ds, align 8, !tbaa !19, !noalias !28 ; 3 uses
  %i.ei = icmp ult i64 %i.eh, 16
  call void @llvm.assume(i1 %i.ei)
  %i.ej = add nuw nsw i64 %i.eh, 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %i.ee, ptr noundef nonnull align 8 dereferenceable(1) %i.dr, i64 %i.ej, i1 false)
  br label %bb.bc

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i130: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendERKS4_.exit.i
  store ptr %i.ef, ptr %4, align 8, !tbaa !11, !alias.scope !28
  %i.ek = load i64, ptr %i.dr, align 8, !tbaa !16, !noalias !28
  store i64 %i.ek, ptr %i.ee, align 8, !tbaa !16, !alias.scope !28
  %.pre.i = load i64, ptr %i.ds, align 8, !tbaa !19, !noalias !28
  br label %bb.bc

bb.bc:                                            ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i130, %bb.bb
  %i.el = phi i64 [ %i.eh, %bb.bb ], [ %.pre.i, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i130 ]
  %i.em = getelementptr inbounds nuw i8, ptr %4, i64 8
  store i64 %i.el, ptr %i.em, align 8, !tbaa !19, !alias.scope !28
  store ptr %i.dr, ptr %5, align 8, !tbaa !11, !noalias !28
  store i64 0, ptr %i.ds, align 8, !tbaa !19, !noalias !28
  store i8 0, ptr %i.dr, align 8, !tbaa !16, !noalias !28
  invoke fastcc void @_ZN6googleL9AddStringERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPS5_Pi(ptr noundef nonnull align 8 dereferenceable(32) %4, ptr noundef nonnull %0, ptr noundef %i.a)
          to label %bb.bd unwind label %bb.bh

bb.bd:                                            ; preds = %bb.bc
  %i.en = load ptr, ptr %4, align 8, !tbaa !11    ; 2 uses
  %i.eo = icmp eq ptr %i.en, %i.ee
  br i1 %i.eo, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit136, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i134

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i134: ; preds = %bb.bd
  %i.ep = load i64, ptr %i.ee, align 8, !tbaa !16
  %i.eq = add i64 %i.ep, 1
  call void @_ZdlPvm(ptr noundef %i.en, i64 noundef %i.eq) #21
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit136

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit136: ; preds = %bb.bd, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i134
  %i.er = load ptr, ptr %5, align 8, !tbaa !11    ; 2 uses
  %i.es = icmp eq ptr %i.er, %i.dr
  br i1 %i.es, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit139, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i137

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i137: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit136
  %i.et = load i64, ptr %i.dr, align 8, !tbaa !16
  %i.eu = add i64 %i.et, 1
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit139: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit136, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i137
  ...
  store ptr %i.ev, ptr %7, align 8, !tbaa !18
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(7) %i.ev, ptr noundef nonnull align 1 dereferenceable(7) @.str.34, i64 7, i1 false)
  %i.ew = getelementptr inbounds nuw i8, ptr %7, i64 8
  store i64 7, ptr %i.ew, align 8, !tbaa !19
  %i.ex = getelementptr inbounds nuw i8, ptr %7, i64 23
  store i8 0, ptr %i.ex, align 1, !tbaa !16
  %i.ey = getelementptr inbounds nuw i8, ptr %1, i64 96
end_hunk_0
