...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %wide.load = load <8 x i8>, ptr %i.p, align 1, !tbaa !9, !alias.scope !109 ; 2 uses
  %wide.load78 = load <8 x i8>, ptr %6, align 1, !tbaa !9, !alias.scope !109 ; 2 uses
  ...
  store <16 x i8> %interleaved.vec, ptr %0, align 1, !tbaa !9, !alias.scope !112, !noalias !109
  ...
  store <16 x i8> %interleaved.vec81, ptr %9, align 1, !tbaa !9, !alias.scope !112, !noalias !109
  %12 = icmp eq i64 %n.vec, 16
  br i1 %12, label %middle.block, label %vector.body

vector.body:                                      ; preds = %vector.ph
  %i.z = getelementptr inbounds nuw i8, ptr %4, i64 17
  %i.aa = getelementptr inbounds nuw i8, ptr %4, i64 25
  %wide.load.a = load <8 x i8>, ptr %i.z, align 1, !tbaa !9, !alias.scope !109 ; 2 uses
  %wide.load78.a = load <8 x i8>, ptr %i.aa, align 1, !tbaa !9, !alias.scope !109 ; 2 uses
  ...
  %i.af = and <8 x i8> %wide.load.a, splat (i8 15)
  %i.ag = and <8 x i8> %wide.load78.a, splat (i8 15)
  ...
  store <16 x i8> %interleaved.vec.a, ptr %i.ad, align 1, !tbaa !9, !alias.scope !112, !noalias !109
...
vector.body.2:                                    ; preds = %vector.body
  ...
  %wide.load.2 = load <8 x i8>, ptr %13, align 1, !tbaa !9, !alias.scope !109 ; 2 uses
  %wide.load78.2 = load <8 x i8>, ptr %14, align 1, !tbaa !9, !alias.scope !109 ; 2 uses
  ...
  store <16 x i8> %interleaved.vec.2, ptr %17, align 1, !tbaa !9, !alias.scope !112, !noalias !109
  ...
  store <16 x i8> %interleaved.vec81.2, ptr %18, align 1, !tbaa !9, !alias.scope !112, !noalias !109
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.ap, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !114
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  br i1 %i.bb, label %.lr.ph, label %.loopexit.thread, !llvm.loop !115
...
bb.ai:                                            ; preds = %BIT_reloadDStream.exit.i.i
  ...
  br i1 %i.ho, label %BIT_reloadDStream.exit81.split.loop.exit451.i.i, label %.lr.ph.i, !llvm.loop !116
...
bb.bo:                                            ; preds = %BIT_reloadDStream.exit138.i.i
  ...
  br i1 %i.ps, label %BIT_reloadDStream.exit175.split.loop.exit491.i.i, label %.lr.ph107.i, !llvm.loop !116
...
bb.bx:                                            ; preds = %.lr.ph166
  ...
  br i1 %i.sj, label %.lr.ph166, label %._crit_edge, !llvm.loop !117
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  br i1 %i.z, label %.lr.ph, label %.preheader162, !llvm.loop !118
...
.lr.ph178:                                        ; preds = %.preheader162, %.lr.ph178
  ...
  br i1 %i.ae, label %.lr.ph178, label %._crit_edge, !llvm.loop !119
...
.lr.ph190:                                        ; preds = %bb.l, %.lr.ph190
  ...
  br i1 %i.bt, label %.lr.ph190, label %._crit_edge191, !llvm.loop !120
...
._crit_edge191:                                   ; preds = %.lr.ph190, %bb.l
  ...
  br i1 %i.cd, label %bb.c, label %.critedge, !llvm.loop !121
...
bb.j:                                             ; preds = %bb.i, %bb.h
  ...
  br i1 %niter.ncmp.1, label %.preheader81.preheader.unr-lcssa, label %bb.d, !llvm.loop !122
...
bb.n:                                             ; preds = %bb.n, %bb.m
  ...
  br i1 %i.bd, label %bb.n, label %bb.o, !llvm.loop !123
...
bb.p:                                             ; preds = %bb.p, %bb.o
  ...
  br i1 %i.bh, label %bb.p, label %bb.q, !llvm.loop !123

bb.q:                                             ; preds = %bb.p
  %niter115.next.1 = add i32 %niter115, 2         ; 2 uses
  %niter115.ncmp.1 = icmp eq i32 %niter115.next.1, %unroll_iter114
  br i1 %niter115.ncmp.1, label %._crit_edge.loopexit.unr-lcssa, label %bb.m, !llvm.loop !124
...
bb.r:                                             ; preds = %bb.r, %.epil.preheader109
  ...
  br i1 %i.bm, label %bb.r, label %._crit_edge, !llvm.loop !123
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit.unr-lcssa, %bb.r, %.preheader81
  ...
  br i1 %exitcond96.not, label %bb.s, label %.preheader81, !llvm.loop !125
...
.preheader:                                       ; preds = %.preheader.preheader, %.preheader
  ...
  br i1 %exitcond101.not, label %bb.t, label %.preheader, !llvm.loop !126
...
bb.e:                                             ; preds = %BIT_reloadDStream.exit
  ...
  br i1 %i.cd, label %.preheader55, label %.lr.ph5, !llvm.loop !127
...
bb.i:                                             ; preds = %BIT_reloadDStream.exit50
  ...
  br i1 %i.dq, label %BIT_reloadDStream.exit50.thread, label %.lr.ph13, !llvm.loop !128
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  br i1 %i.ec, label %.lr.ph, label %._crit_edge, !llvm.loop !129
...
bb.e:                                             ; preds = %BIT_reloadDStream.exit
  ...
  br i1 %i.cs, label %.preheader68, label %.lr.ph4, !llvm.loop !130
...
bb.i:                                             ; preds = %BIT_reloadDStream.exit62
  ...
  br i1 %i.ei, label %.preheader, label %.lr.ph12, !llvm.loop !131
