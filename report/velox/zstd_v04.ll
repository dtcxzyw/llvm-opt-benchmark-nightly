...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.aa = and i64 %index, 9223372036854775792
  %i.ab = getelementptr inbounds nuw i8, ptr %i.p, i64 %i.aa ; 3 uses
  %i.ac = getelementptr inbounds nuw i8, ptr %i.ab, i64 8 ; 2 uses
  %wide.load = load <8 x i8>, ptr %i.ab, align 1, !tbaa !9, !alias.scope !109
  %wide.load78 = load <8 x i8>, ptr %i.ac, align 1, !tbaa !9, !alias.scope !109
  %i.ad = lshr <8 x i8> %wide.load, splat (i8 4)
  %i.ae = lshr <8 x i8> %wide.load78, splat (i8 4)
  %i.af = getelementptr inbounds nuw i8, ptr %0, i64 %i.z
  %i.ag = getelementptr inbounds nuw i8, ptr %0, i64 %i.z
  %i.ah = getelementptr inbounds nuw i8, ptr %i.ag, i64 16
  %wide.load79 = load <8 x i8>, ptr %i.ab, align 1, !tbaa !9, !alias.scope !109
  %wide.load80 = load <8 x i8>, ptr %i.ac, align 1, !tbaa !9, !alias.scope !109
  ...
  store <16 x i8> %interleaved.vec, ptr %i.af, align 1, !tbaa !9, !alias.scope !112, !noalias !109
  ...
  store <16 x i8> %interleaved.vec81, ptr %i.ah, align 1, !tbaa !9, !alias.scope !112, !noalias !109
  %index.next = add nuw i64 %index, 16            ; 2 uses
  %i.ak = icmp eq i64 %index.next, %n.vec
  br i1 %i.ak, label %middle.block, label %vector.body, !llvm.loop !114
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.an = and i64 %index84, 9223372036854775804
  %i.ao = getelementptr inbounds nuw i8, ptr %i.p, i64 %i.an
  %wide.load85 = load <4 x i8>, ptr %i.ao, align 1, !tbaa !9, !alias.scope !109 ; 2 uses
  %i.ap = lshr <4 x i8> %wide.load85, splat (i8 4)
  %i.aq = getelementptr inbounds nuw i8, ptr %0, i64 %i.am
  %i.ar = and <4 x i8> %wide.load85, splat (i8 15)
  %interleaved.vec87 = shufflevector <4 x i8> %i.ap, <4 x i8> %i.ar, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
  store <8 x i8> %interleaved.vec87, ptr %i.aq, align 1, !tbaa !9, !alias.scope !112, !noalias !109
  %index.next88 = add nuw i64 %index84, 4         ; 2 uses
  %i.as = icmp eq i64 %index.next88, %n.vec83
  br i1 %i.as, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !115
...
.lr.ph.preheader:                                 ; preds = %vector.memcheck, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %.ph = phi i64 [ 0, %iter.check ], [ 0, %vector.memcheck ], [ %i.y, %vec.epilog.iter.check ], [ %i.al, %vec.epilog.middle.block ]
  br label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  %i.at = phi i64 [ %i.bd, %.lr.ph ], [ %.ph, %.lr.ph.preheader ] ; 4 uses
  %i.au = lshr exact i64 %i.at, 1
  %i.av = getelementptr inbounds nuw i8, ptr %i.p, i64 %i.au ; 2 uses
  %i.aw = load i8, ptr %i.av, align 1, !tbaa !9
  %i.ax = lshr i8 %i.aw, 4
  %i.ay = getelementptr inbounds nuw i8, ptr %0, i64 %i.at
  store i8 %i.ax, ptr %i.ay, align 1, !tbaa !9
  %i.az = load i8, ptr %i.av, align 1, !tbaa !9
  %i.ba = and i8 %i.az, 15
  %i.bb = getelementptr inbounds nuw i8, ptr %0, i64 %i.at
  %i.bc = getelementptr inbounds nuw i8, ptr %i.bb, i64 1
  store i8 %i.ba, ptr %i.bc, align 1, !tbaa !9
  %i.bd = add nuw nsw i64 %i.at, 2                ; 2 uses
  %i.be = icmp samesign ugt i64 %i.m, %i.bd
...
bb.k:                                             ; preds = %bb.j
  %i.bn = sub nsw i64 %i.f, %i.bh                 ; 13 uses
  ...
  %6 = icmp eq i64 %i.bn, 0                       ; 2 uses
  br i1 %.not.i.i, label %9, label %7

7:                                                ; preds = %bb.k
  br i1 %6, label %FSE_decompress.exit.thread, label %bb.l

bb.l:                                             ; preds = %7
  %8 = icmp ugt i64 %i.bn, 7
  br i1 %8, label %bb.m, label %bb.n
...
9:                                                ; preds = %bb.k
  br i1 %6, label %FSE_decompress.exit.thread, label %bb.aq

bb.aq:                                            ; preds = %9
  %10 = icmp ugt i64 %i.bn, 7
...
FSE_decompress.exit.thread:                       ; preds = %bb.j, %bb.g, %bb.h, %bb.i, %bb.u, %BIT_initDStream.exit.i.i, %BIT_endOfDStream.exit106.thread.i.i, %BIT_initDStream.exit111.i.i, %BIT_endOfDStream.exit201.thread.i.i, %7, %bb.m, %9, %bb.ar, %bb.az
  %.0.i.ph = phi i64 [ -1, %bb.az ], [ -1, %bb.ar ], [ -72, %9 ], [ -1, %bb.m ], [ -72, %7 ], [ %..i.i.i, %BIT_endOfDStream.exit201.thread.i.i ], [ %i.bn, %BIT_initDStream.exit111.i.i ], [ %..i23.i.i, %BIT_endOfDStream.exit106.thread.i.i ], [ %i.bn, %BIT_initDStream.exit.i.i ], [ -1, %bb.u ], [ -72, %bb.i ], [ %i.bh, %bb.h ], [ -72, %bb.g ], [ %i.bl, %bb.j ]
