...
%"struct.absl::lts_20240116::synchronization_internal::FutexTimespec" = type { i64, i64 }
%"class.absl::lts_20240116::synchronization_internal::KernelTimeout" = type { i64 }

@.str = private unnamed_addr constant [95 x i8] c"/opt-bench/work/velox/velox/build/_deps/absl-src/absl/synchronization/internal/futex_waiter.cc\00", align 1
@.str.1 = private unnamed_addr constant [38 x i8] c"Futex operation failed with error %d\0A\00", align 1

; Function Attrs: mustprogress uwtable
define noundef range(i32 -2147483647, -2147483648) i32 @_ZN4absl12lts_2024011624synchronization_internal11FutexWaiter9WaitUntilEPSt6atomicIiEiNS1_13KernelTimeoutE(ptr noundef %0, i32 noundef %1, i64 %2) local_unnamed_addr #0 align 2 {
bb.a:
  %3 = alloca %"struct.absl::lts_20240116::synchronization_internal::FutexTimespec", align 8 ; 5 uses
  %4 = alloca %"struct.absl::lts_20240116::synchronization_internal::FutexTimespec", align 8 ; 5 uses
  %5 = alloca %"class.absl::lts_20240116::synchronization_internal::KernelTimeout", align 8 ; 3 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %.not.i.i, label %_ZN4absl12lts_2024011624synchronization_internal9FutexImpl4WaitEPSt6atomicIiEi.exit, label %bb.c
...
bb.e:                                             ; preds = %bb.d
  %i.f = call { i64, i64 } @_ZNK4absl12lts_2024011624synchronization_internal13KernelTimeout20MakeRelativeTimespecEv(ptr noundef nonnull align 8 dereferenceable(8) %5) ; 2 uses
...
_ZN4absl12lts_2024011624synchronization_internal9FutexImpl19WaitRelativeTimeoutEPSt6atomicIiEiPK8timespec.exit: ; preds = %bb.e, %bb.f
  %.0.i = phi i32 [ %i.m, %bb.f ], [ 0, %bb.e ]
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #5
  br label %_ZN4absl12lts_2024011624synchronization_internal9FutexImpl4WaitEPSt6atomicIiEi.exit

bb.g:                                             ; preds = %bb.d
  %i.n = call { i64, i64 } @_ZNK4absl12lts_2024011624synchronization_internal13KernelTimeout15MakeAbsTimespecEv(ptr noundef nonnull align 8 dereferenceable(8) %5) ; 2 uses
...
_ZN4absl12lts_2024011624synchronization_internal9FutexImpl19WaitAbsoluteTimeoutEPSt6atomicIiEiPK8timespec.exit: ; preds = %bb.g, %bb.h
  %.0.i9 = phi i32 [ %i.u, %bb.h ], [ 0, %bb.g ]
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #5
  br label %_ZN4absl12lts_2024011624synchronization_internal9FutexImpl4WaitEPSt6atomicIiEi.exit

_ZN4absl12lts_2024011624synchronization_internal9FutexImpl4WaitEPSt6atomicIiEi.exit: ; preds = %bb.c, %bb.b, %_ZN4absl12lts_2024011624synchronization_internal9FutexImpl19WaitAbsoluteTimeoutEPSt6atomicIiEiPK8timespec.exit, %_ZN4absl12lts_2024011624synchronization_internal9FutexImpl19WaitRelativeTimeoutEPSt6atomicIiEiPK8timespec.exit
  %.0 = phi i32 [ %.0.i, %_ZN4absl12lts_2024011624synchronization_internal9FutexImpl19WaitRelativeTimeoutEPSt6atomicIiEiPK8timespec.exit ], [ %.0.i9, %_ZN4absl12lts_2024011624synchronization_internal9FutexImpl19WaitAbsoluteTimeoutEPSt6atomicIiEiPK8timespec.exit ], [ %i.d, %bb.c ], [ 0, %bb.b ]
  ret i32 %.0
}
...
declare { i64, i64 } @_ZNK4absl12lts_2024011624synchronization_internal13KernelTimeout20MakeRelativeTimespecEv(ptr noundef nonnull align 8 dereferenceable(8)) local_unnamed_addr #2

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(argmem: readwrite)
declare void @llvm.lifetime.end.p0(ptr captures(none)) #1

declare { i64, i64 } @_ZNK4absl12lts_2024011624synchronization_internal13KernelTimeout15MakeAbsTimespecEv(ptr noundef nonnull align 8 dereferenceable(8)) local_unnamed_addr #2

; Function Attrs: mustprogress uwtable
define noundef zeroext i1 @_ZN4absl12lts_2024011624synchronization_internal11FutexWaiter4WaitENS1_13KernelTimeoutE(ptr noundef nonnull align 4 dereferenceable(4) %0, i64 %1) local_unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  br label %bb.b
...
bb.d:                                             ; preds = %bb.c, %._crit_edge
  %i.f = tail call noundef i32 @_ZN4absl12lts_2024011624synchronization_internal11FutexWaiter9WaitUntilEPSt6atomicIiEiNS1_13KernelTimeoutE(ptr noundef nonnull %0, i32 noundef 0, i64 %1) ; 2 uses
...
declare void @_ZN4absl12lts_2024011624synchronization_internal10WaiterBase15MaybeBecomeIdleEv() local_unnamed_addr #2
...
; Function Attrs: mustprogress uwtable
define void @_ZN4absl12lts_2024011624synchronization_internal11FutexWaiter4PostEv(ptr noundef nonnull align 4 dereferenceable(4) %0) local_unnamed_addr #0 align 2 {
bb.a:
  %i.a = atomicrmw add ptr %0, i32 1 release, align 4
  %i.b = icmp eq i32 %i.a, 0
  br i1 %i.b, label %bb.b, label %_ZN4absl12lts_2024011624synchronization_internal11FutexWaiter4PokeEv.exit
...
bb.c:                                             ; preds = %_ZN4absl12lts_2024011624synchronization_internal9FutexImpl4WakeEPSt6atomicIiEi.exit.i
  ...
  tail call void (i32, ptr, i32, ptr, ...) @_ZN4absl12lts_2024011616raw_log_internal6RawLogENS0_11LogSeverityEPKciS4_z(i32 noundef 3, ptr noundef nonnull getelementptr inbounds nuw (i8, ptr @.str, i64 79), i32 noundef 103, ptr noundef nonnull @.str.1, i32 noundef %i.h)
  unreachable

_ZN4absl12lts_2024011624synchronization_internal11FutexWaiter4PokeEv.exit: ; preds = %_ZN4absl12lts_2024011624synchronization_internal9FutexImpl4WakeEPSt6atomicIiEi.exit.i, %bb.b, %bb.a
  ret void
}

; Function Attrs: mustprogress uwtable
define void @_ZN4absl12lts_2024011624synchronization_internal11FutexWaiter4PokeEv(ptr noundef nonnull align 4 dereferenceable(4) %0) local_unnamed_addr #0 align 2 {
bb.a:
...
bb.b:                                             ; preds = %_ZN4absl12lts_2024011624synchronization_internal9FutexImpl4WakeEPSt6atomicIiEi.exit
  ...
  tail call void (i32, ptr, i32, ptr, ...) @_ZN4absl12lts_2024011616raw_log_internal6RawLogENS0_11LogSeverityEPKciS4_z(i32 noundef 3, ptr noundef nonnull getelementptr inbounds nuw (i8, ptr @.str, i64 79), i32 noundef 103, ptr noundef nonnull @.str.1, i32 noundef %i.f)
  unreachable

_ZN4absl12lts_2024011624synchronization_internal9FutexImpl4WakeEPSt6atomicIiEi.exit.thread: ; preds = %bb.a, %_ZN4absl12lts_2024011624synchronization_internal9FutexImpl4WakeEPSt6atomicIiEi.exit
  ret void
}
