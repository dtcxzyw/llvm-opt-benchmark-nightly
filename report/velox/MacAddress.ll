...
begin_hunk_0_@_ZN5folly10MacAddress13setFromBinaryENS_5RangeIPKhEE:bb.a
}

; Function Attrs: mustprogress uwtable
define void @_ZNK5folly10MacAddress8toStringB5cxx11Ev(ptr dead_on_unwind noalias writable sret(%"class.std::__cxx11::basic_string") align 8 %0, ptr noundef nonnull readonly align 1 captures(none) dereferenceable(8) %1) local_unnamed_addr #2 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  ...
  %3 = tail call noalias noundef nonnull dereferenceable(31) ptr @_Znwm(i64 noundef 31) #27 ; 4 uses
...
end_hunk_0
begin_hunk_1_@_ZN5folly10MacAddress16trySetFromBinaryENS_5RangeIPKhEE:bb.a
; Function Attrs: mustprogress uwtable
...
bb.a:
  ...
  %2 = tail call noalias noundef nonnull dereferenceable(31) ptr @_Znwm(i64 noundef 31) #27 ; 6 uses
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %bb.a
  tail call void @_ZdlPvm(ptr noundef %2, i64 noundef 31) #25
  ret ptr %0
