Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/velox/original/AsyncFileWriter?download=true
...
bb.e:                                             ; preds = %._crit_edge.i.i.i.i
  %i.m = load i8, ptr %1, align 1, !tbaa !935
  store i8 %i.m, ptr %i.l, align 1, !tbaa !935
...
_ZNK5folly5RangeIPKcE3strB5cxx11Ev.exit:          ; preds = %._crit_edge.i.i.i.i, %bb.e, %bb.f
  ...
  store i64 %i.c, ptr %i.n, align 8, !tbaa !38, !alias.scope !1182
  %i.o = getelementptr inbounds nuw i8, ptr %i.l, i64 %i.c
  store i8 0, ptr %i.o, align 1, !tbaa !935
...
bb.h:                                             ; preds = %bb.g
  store ptr getelementptr inbounds nuw inrange(-16, 64) (i8, ptr @_ZTVN5folly15AsyncFileWriterE, i64 16), ptr %0, align 8, !tbaa !40
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %bb.h
  %i.s = load i64, ptr %i.d, align 8, !tbaa !935
  %i.t = add i64 %i.s, 1
...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  %i.w = load ptr, ptr %4, align 8, !tbaa !37     ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i4: ; preds = %bb.k
  %i.y = load i64, ptr %i.d, align 8, !tbaa !935
  %i.z = add i64 %i.y, 1
...
_ZN5folly14checkUnixErrorIJRA20_KcEEEvlDpOT_.exit: ; preds = %.critedge, %bb.a
  ...
  %i.e = load ptr, ptr %i.c, align 8, !tbaa !1191
  %i.f = load ptr, ptr %1, align 8, !tbaa !1192   ; 4 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec = load <16 x ptr>, ptr %i.t, align 8, !tbaa !935
  %wide.vec44 = load <16 x ptr>, ptr %i.v, align 8, !tbaa !935
  ...
  store <8 x i64> %interleaved.vec, ptr %i.w, align 8, !tbaa !935
...
.preheader:                                       ; preds = %.preheader.preheader49, %.preheader
  ...
  br i1 %or.cond, label %.preheader, label %.critedge, !llvm.loop !1184

.critedge:                                        ; preds = %.preheader
  %i.al = trunc nuw nsw i64 %indvars.iv.next to i32
  %i.am = load i32, ptr %i.d, align 8, !tbaa !933
  %i.an = call noundef i64 @_ZN5folly10writevFullEiP5ioveci(i32 noundef %i.am, ptr noundef nonnull %3, i32 noundef %i.al)
  %i.ao = icmp eq i64 %i.an, -1
  br i1 %i.ao, label %bb.b, label %_ZN5folly14checkUnixErrorIJRA20_KcEEEvlDpOT_.exit, !prof !937, !llvm.loop !1185
...
bb.d:                                             ; preds = %bb.c
  ...
  store i64 %2, ptr %i.b, align 8, !tbaa !940, !noalias !1198
  call void @llvm.experimental.noalias.scope.decl(metadata !1199)
  %i.ap = getelementptr inbounds nuw i8, ptr %4, i64 16 ; 13 uses
  store ptr %i.ap, ptr %4, align 8, !tbaa !936, !alias.scope !1200
  %i.aq = getelementptr inbounds nuw i8, ptr %4, i64 8 ; 3 uses
  store i64 0, ptr %i.aq, align 8, !tbaa !38, !alias.scope !1200
  store i8 0, ptr %i.ap, align 8, !tbaa !935, !alias.scope !1200
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #24, !noalias !1200
  store ptr %4, ptr %i.a, align 8, !tbaa !941, !noalias !1200
...
.noexc.i.i:                                       ; preds = %bb.d
  ...
  %i.at = load ptr, ptr %4, align 8, !tbaa !37
...
bb.g:                                             ; preds = %bb.e
  ...
  br i1 %i.bb, label %bb.h, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm.exit.i, !prof !937
...
.noexc27:                                         ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm.exit.i
  %i.bd = load ptr, ptr %4, align 8, !tbaa !37    ; 4 uses
  %i.be = load i64, ptr %i.aq, align 8, !tbaa !38 ; 2 uses
...
bb.i:                                             ; preds = %.noexc27
  %i.bg = load i8, ptr %i.bd, align 1, !tbaa !935
  store i8 %i.bg, ptr %i.bc, align 1, !tbaa !935
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_S_copyEPcPKcm.exit.i

bb.j:                                             ; preds = %.noexc27
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.bc, ptr align 1 %i.bd, i64 %i.bf, i1 false)
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_S_copyEPcPKcm.exit.i

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_S_copyEPcPKcm.exit.i: ; preds = %bb.j, %bb.i, %.noexc27
  %i.bh = icmp eq ptr %i.bd, %i.ap
  br i1 %i.bh, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i5.i, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i4.i
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i4.i: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_S_copyEPcPKcm.exit.i
  %i.bj = load i64, ptr %i.ap, align 8, !tbaa !935
  %i.bk = add i64 %i.bj, 1
  call void @_ZdlPvm(ptr noundef %i.bd, i64 noundef %i.bk) #25
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_disposeEv.exit.i
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_disposeEv.exit.i: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i4.i, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i5.i
  store ptr %i.bc, ptr %4, align 8, !tbaa !37
  store i64 %.0.i, ptr %i.ap, align 8, !tbaa !935
  br label %.noexc4.i.i
...
bb.k:                                             ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm.exit.i, %bb.h, %bb.f, %.noexc4.i.i, %bb.d
  %i.bl = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #24, !noalias !1200
  %i.bm = load ptr, ptr %4, align 8, !tbaa !37, !alias.scope !1200 ; 2 uses
  %i.bn = icmp eq ptr %i.bm, %i.ap
  br i1 %i.bn, label %common.resume, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i: ; preds = %bb.k
  %i.bo = load i64, ptr %i.ap, align 8, !tbaa !935, !alias.scope !1200
  %i.bp = add i64 %i.bo, 1
...
common.resume:                                    ; preds = %bb.k, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  %common.resume.op = phi { ptr, i32 } [ %i.bv, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit ], [ %i.bl, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i ], [ %i.bl, %bb.k ]
  resume { ptr, i32 } %common.resume.op

_ZN5folly15AsyncFileWriter18getNumDiscardedMsgB5cxx11Em.exit: ; preds = %.noexc4.i.i
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #24, !noalias !1200
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b)
  %i.bq = load i64, ptr %i.aq, align 8, !tbaa !38 ; 2 uses
  %i.br = icmp eq i64 %i.bq, 0
  br i1 %i.br, label %bb.n, label %bb.l

bb.l:                                             ; preds = %_ZN5folly15AsyncFileWriter18getNumDiscardedMsgB5cxx11Em.exit
  %i.bs = load i32, ptr %i.d, align 8, !tbaa !933
  %i.bt = load ptr, ptr %4, align 8, !tbaa !37
  %i.bu = invoke noundef i64 @_ZN5folly9writeFullEiPKvm(i32 noundef %i.bs, ptr noundef %i.bt, i64 noundef %i.bq)
          to label %bb.n unwind label %bb.m       ; 0 uses

bb.m:                                             ; preds = %bb.l
  %i.bv = landingpad { ptr, i32 }
          cleanup
  %i.bw = load ptr, ptr %4, align 8, !tbaa !37    ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %bb.m
  %i.by = load i64, ptr %i.ap, align 8, !tbaa !935
  %i.bz = add i64 %i.by, 1
...
bb.n:                                             ; preds = %bb.l, %_ZN5folly15AsyncFileWriter18getNumDiscardedMsgB5cxx11Em.exit
  %i.ca = load ptr, ptr %4, align 8, !tbaa !37    ; 2 uses
  %i.cb = icmp eq ptr %i.ca, %i.ap
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i21: ; preds = %bb.n
  %i.cc = load i64, ptr %i.ap, align 8, !tbaa !935
  %i.cd = add i64 %i.cc, 1
