Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/velox/original/file?download=true
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !280
  %i.c = getelementptr inbounds nuw i8, ptr %i.b, i64 16
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !295, !noalias !536
  %i.e = getelementptr inbounds nuw i8, ptr %i.d, i64 48
  %i.f = load atomic i32, ptr %i.e seq_cst, align 4, !noalias !536
...
_ZN5arrow6StatusD2Ev.exit13.thread:               ; preds = %bb.a
  store ptr null, ptr %0, align 8, !tbaa !67, !alias.scope !539
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #28
  br label %bb.b

_ZN5arrow6StatusD2Ev.exit:                        ; preds = %bb.a
  call void @_ZN5arrow6Status8FromArgsIJRA33_KcEEES0_NS_10StatusCodeEDpOT_(ptr dead_on_unwind nonnull writable sret(%"class.arrow::Status") align 8 %3, i8 noundef signext 4, ptr noundef nonnull align 1 dereferenceable(33) @.str.6)
  %.pr = load ptr, ptr %3, align 8, !tbaa !67, !noalias !542 ; 2 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !542)
  store ptr %.pr, ptr %0, align 8, !tbaa !67, !alias.scope !542
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #28
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.o = load ptr, ptr %i.a, align 8, !tbaa !280
  invoke void @_ZN5arrow2io16MemoryMappedFile9MemoryMap6ResizeEl(ptr dead_on_unwind nonnull writable sret(%"class.arrow::Status") align 8 %6, ptr noundef nonnull align 8 dereferenceable(120) %i.o, i64 noundef %2)
          to label %_ZN5arrow6StatusD2Ev.exit15 unwind label %bb.e

_ZN5arrow6StatusD2Ev.exit15:                      ; preds = %bb.c
  call void @llvm.experimental.noalias.scope.decl(metadata !548)
  %i.p = load ptr, ptr %6, align 8, !tbaa !67, !noalias !548 ; 2 uses
  store ptr %i.p, ptr %0, align 8, !tbaa !67, !alias.scope !548
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #28
  %i.q = icmp eq ptr %i.p, null
  br i1 %i.q, label %_ZN5arrow6StatusD2Ev.exit17, label %.critedge
...
_ZN5arrow6StatusD2Ev.exit17:                      ; preds = %_ZN5arrow6StatusD2Ev.exit15
  store ptr null, ptr %0, align 8, !tbaa !67, !alias.scope !551
  br label %.critedge

.critedge:                                        ; preds = %_ZN5arrow6StatusD2Ev.exit15, %_ZN5arrow6StatusD2Ev.exit17
  %i.t = load i8, ptr %i.n, align 8, !tbaa !547, !range !129, !noundef !133
  %i.u = trunc nuw i8 %i.t to i1
  br i1 %i.u, label %bb.f, label %_ZNSt11unique_lockISt5mutexED2Ev.exit

bb.f:                                             ; preds = %.critedge
  %i.v = load ptr, ptr %5, align 8, !tbaa !544    ; 2 uses
  %.not.i.i18 = icmp eq ptr %i.v, null
  br i1 %.not.i.i18, label %_ZNSt11unique_lockISt5mutexED2Ev.exit, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.w = call noundef i32 @pthread_mutex_unlock(ptr noundef nonnull align 8 dereferenceable(40) %i.v) #28 ; 0 uses
  br label %_ZNSt11unique_lockISt5mutexED2Ev.exit

_ZNSt11unique_lockISt5mutexED2Ev.exit:            ; preds = %.critedge, %bb.f, %bb.g
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #28
  %i.x = load i8, ptr %i.l, align 8, !tbaa !547, !range !129, !noundef !133
  %i.y = trunc nuw i8 %i.x to i1
  br i1 %i.y, label %bb.h, label %_ZNSt11unique_lockISt5mutexED2Ev.exit20

bb.h:                                             ; preds = %_ZNSt11unique_lockISt5mutexED2Ev.exit
  %i.z = load ptr, ptr %4, align 8, !tbaa !544    ; 2 uses
  %.not.i.i19 = icmp eq ptr %i.z, null
  br i1 %.not.i.i19, label %_ZNSt11unique_lockISt5mutexED2Ev.exit20, label %bb.i

bb.i:                                             ; preds = %bb.h
  %i.aa = call noundef i32 @pthread_mutex_unlock(ptr noundef nonnull align 8 dereferenceable(40) %i.z) #28 ; 0 uses
  br label %_ZNSt11unique_lockISt5mutexED2Ev.exit20

_ZNSt11unique_lockISt5mutexED2Ev.exit20:          ; preds = %_ZNSt11unique_lockISt5mutexED2Ev.exit, %bb.h, %bb.i
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #28
  br label %bb.o

bb.j:                                             ; preds = %bb.e, %bb.d
  %.pn = phi { ptr, i32 } [ %i.s, %bb.e ], [ %i.r, %bb.d ]
  %i.ab = load i8, ptr %i.n, align 8, !tbaa !547, !range !129, !noundef !133
  %i.ac = trunc nuw i8 %i.ab to i1
  br i1 %i.ac, label %bb.k, label %_ZNSt11unique_lockISt5mutexED2Ev.exit22

bb.k:                                             ; preds = %bb.j
  %i.ad = load ptr, ptr %5, align 8, !tbaa !544   ; 2 uses
  %.not.i.i21 = icmp eq ptr %i.ad, null
  br i1 %.not.i.i21, label %_ZNSt11unique_lockISt5mutexED2Ev.exit22, label %bb.l

bb.l:                                             ; preds = %bb.k
  %i.ae = call noundef i32 @pthread_mutex_unlock(ptr noundef nonnull align 8 dereferenceable(40) %i.ad) #28 ; 0 uses
  br label %_ZNSt11unique_lockISt5mutexED2Ev.exit22

_ZNSt11unique_lockISt5mutexED2Ev.exit22:          ; preds = %bb.j, %bb.k, %bb.l
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #28
  %i.af = load i8, ptr %i.l, align 8, !tbaa !547, !range !129, !noundef !133
  %i.ag = trunc nuw i8 %i.af to i1
  br i1 %i.ag, label %bb.m, label %_ZNSt11unique_lockISt5mutexED2Ev.exit24

bb.m:                                             ; preds = %_ZNSt11unique_lockISt5mutexED2Ev.exit22
  %i.ah = load ptr, ptr %4, align 8, !tbaa !544   ; 2 uses
  %.not.i.i23 = icmp eq ptr %i.ah, null
  br i1 %.not.i.i23, label %_ZNSt11unique_lockISt5mutexED2Ev.exit24, label %bb.n

bb.n:                                             ; preds = %bb.m
  %i.ai = call noundef i32 @pthread_mutex_unlock(ptr noundef nonnull align 8 dereferenceable(40) %i.ah) #28 ; 0 uses
  br label %_ZNSt11unique_lockISt5mutexED2Ev.exit24

_ZNSt11unique_lockISt5mutexED2Ev.exit24:          ; preds = %_ZNSt11unique_lockISt5mutexED2Ev.exit22, %bb.m, %bb.n
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #28
  resume { ptr, i32 } %.pn

bb.o:                                             ; preds = %_ZN5arrow6StatusD2Ev.exit, %_ZNSt11unique_lockISt5mutexED2Ev.exit20
  ret void
}
...
bb.a:
  %2 = alloca [2 x %"class.std::unique_lock.205"], align 16 ; 13 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #28
  store ptr %0, ptr %2, align 16, !tbaa !554
  %i.a = getelementptr inbounds nuw i8, ptr %2, i64 8
  store i8 0, ptr %i.a, align 8, !tbaa !557
  %i.b = getelementptr inbounds nuw i8, ptr %2, i64 16
  store ptr %1, ptr %i.b, align 16, !tbaa !554
  %i.c = getelementptr inbounds nuw i8, ptr %2, i64 24
  store i8 0, ptr %i.c, align 8, !tbaa !557
  br label %bb.b
...
bb.b:                                             ; preds = %bb.r, %bb.a
  ...
  %i.f = load ptr, ptr %i.e, align 16, !tbaa !554 ; 3 uses
  %.not.i = icmp eq ptr %i.f, null
  br i1 %.not.i, label %.invoke, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.g = getelementptr inbounds nuw i8, ptr %i.e, i64 8
  %i.h = load ptr, ptr %i.f, align 8, !tbaa !544  ; 2 uses
  %.not.i.i = icmp eq ptr %i.h, null
  br i1 %.not.i.i, label %.invoke, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.i = getelementptr inbounds nuw i8, ptr %i.f, i64 8 ; 2 uses
  %i.j = load i8, ptr %i.i, align 8, !tbaa !547, !range !129, !noundef !133
  %i.k = trunc nuw i8 %i.j to i1
  br i1 %i.k, label %.invoke, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.l = tail call noundef i32 @pthread_mutex_lock(ptr noundef nonnull align 8 dereferenceable(40) %i.h) #28 ; 2 uses
...
.invoke:                                          ; preds = %bb.e, %bb.d, %bb.c, %bb.b
  ...
  invoke void @_ZSt20__throw_system_errori(i32 noundef %i.m) #32
...
_ZNSt11unique_lockIS_ISt5mutexEE4lockEv.exit:     ; preds = %bb.e
  store i8 1, ptr %i.i, align 8, !tbaa !547
  store i8 1, ptr %i.g, align 8, !tbaa !557
  %i.n = xor i32 %.030, 1                         ; 2 uses
  %i.o = zext nneg i32 %i.n to i64
  %i.p = getelementptr inbounds nuw [16 x i8], ptr %2, i64 %i.o ; 2 uses
  %i.q = load ptr, ptr %i.p, align 16, !tbaa !554 ; 3 uses
...
bb.g:                                             ; preds = %_ZNSt11unique_lockIS_ISt5mutexEE4lockEv.exit
  ...
  %i.t = load i8, ptr %i.s, align 8, !tbaa !557, !range !129, !noundef !133
  %i.u = trunc nuw i8 %i.t to i1
  br i1 %i.u, label %split86.invoke, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.v = load ptr, ptr %i.q, align 8, !tbaa !544  ; 2 uses
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.x = load i8, ptr %i.w, align 8, !tbaa !547, !range !129, !noundef !133
  %i.y = trunc nuw i8 %i.x to i1
...
split86.invoke:                                   ; preds = %bb.i, %bb.h, %bb.g, %_ZNSt11unique_lockIS_ISt5mutexEE4lockEv.exit
  ...
  invoke void @_ZSt20__throw_system_errori(i32 noundef %i.z) #32
...
bb.j:                                             ; preds = %bb.i
  %i.aa = tail call noundef i32 @pthread_mutex_trylock(ptr noundef nonnull align 8 dereferenceable(40) %i.v) #28
  %.not.i.i.i42 = icmp eq i32 %i.aa, 0            ; 2 uses
  %i.ab = zext i1 %.not.i.i.i42 to i8             ; 2 uses
  store i8 %i.ab, ptr %i.w, align 8, !tbaa !547
  store i8 %i.ab, ptr %i.s, align 8, !tbaa !557
...
.preheader57:                                     ; preds = %bb.j
  ...
  %.promoted = load i8, ptr %i.ae, align 8, !tbaa !557
...
split89.invoke:                                   ; preds = %bb.m, %.preheader57
  ...
  invoke void @_ZSt20__throw_system_errori(i32 noundef 1) #32
...
bb.n:                                             ; preds = %bb.m
  %i.al = load ptr, ptr %i.ah, align 8, !tbaa !544 ; 2 uses
  %.not.i.i48 = icmp eq ptr %i.al, null
  br i1 %.not.i.i48, label %bb.q, label %bb.o

bb.o:                                             ; preds = %bb.n
  %i.am = tail call noundef i32 @pthread_mutex_unlock(ptr noundef nonnull align 8 dereferenceable(40) %i.al) #28 ; 0 uses
  store i8 0, ptr %i.ai, align 8, !tbaa !547
  br label %bb.q
...
bb.r:                                             ; preds = %bb.j, %bb.q
  ...
  %i.ar = load i8, ptr %i.aq, align 8, !tbaa !557, !range !129, !noundef !133
  %i.as = trunc nuw i8 %i.ar to i1
  br i1 %i.as, label %_ZNSt11unique_lockIS_ISt5mutexEED2Ev.exit.1, label %bb.b, !llvm.loop !558
...
bb.s:                                             ; preds = %bb.k, %bb.p, %bb.f
  ...
  %i.au = load i8, ptr %i.at, align 8, !tbaa !557, !range !129, !noundef !133
...
bb.t:                                             ; preds = %bb.s
  ...
  %i.ax = load i8, ptr %i.aw, align 8, !tbaa !547, !range !129, !noundef !133
...
bb.v:                                             ; preds = %bb.t
  %i.az = load ptr, ptr %1, align 8, !tbaa !544   ; 2 uses
  %.not.i.i.i55 = icmp eq ptr %i.az, null
  br i1 %.not.i.i.i55, label %_ZNSt11unique_lockIS_ISt5mutexEED2Ev.exit56, label %bb.w

bb.w:                                             ; preds = %bb.v
  %i.ba = tail call noundef i32 @pthread_mutex_unlock(ptr noundef nonnull align 8 dereferenceable(40) %i.az) #28 ; 0 uses
  store i8 0, ptr %i.aw, align 8, !tbaa !547
...
bb.y:                                             ; preds = %_ZNSt11unique_lockIS_ISt5mutexEED2Ev.exit56
  ...
  %i.bh = load i8, ptr %i.bg, align 8, !tbaa !547, !range !129, !noundef !133
  %i.bi = trunc nuw i8 %i.bh to i1
  br i1 %i.bi, label %bb.z, label %bb.u

bb.z:                                             ; preds = %bb.y
  %i.bj = load ptr, ptr %0, align 8, !tbaa !544   ; 2 uses
  %.not.i.i.i55.1 = icmp eq ptr %i.bj, null
  br i1 %.not.i.i.i55.1, label %_ZNSt11unique_lockIS_ISt5mutexEED2Ev.exit56.1, label %bb.aa

bb.aa:                                            ; preds = %bb.z
  %i.bk = tail call noundef i32 @pthread_mutex_unlock(ptr noundef nonnull align 8 dereferenceable(40) %i.bj) #28 ; 0 uses
  store i8 0, ptr %i.bg, align 8, !tbaa !547
...
bb.a:
  ...
  %5 = alloca %"class.std::shared_ptr.52", align 8 ; 7 uses
  %i.c = alloca ptr, align 8                      ; 5 uses
  %6 = alloca %"class.arrow::Status", align 8     ; 4 uses
  store i64 %2, ptr %i.a, align 8, !tbaa !85
  %i.d = getelementptr inbounds nuw i8, ptr %1, i64 16 ; 2 uses
  %i.e = load ptr, ptr %i.d, align 8, !tbaa !295  ; 2 uses
  %i.f = getelementptr inbounds nuw i8, ptr %i.e, i64 52
  %i.g = load i32, ptr %i.f, align 4, !tbaa !427
  %.not33 = icmp eq i32 %i.g, 0
  br i1 %.not33, label %bb.b, label %bb.c
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.i = load i64, ptr %i.h, align 8, !tbaa !333  ; 3 uses
  %i.j = getelementptr inbounds nuw i8, ptr %1, i64 48 ; 3 uses
  %i.k = load i64, ptr %i.j, align 8, !tbaa !559
...
bb.e:                                             ; preds = %bb.c
  ...
  %i.n = load ptr, ptr %i.m, align 8, !tbaa !40   ; 9 uses
