...
.backedge:                                        ; preds = %.backedge.outer, %bb.bq
  %.0226 = phi ptr [ %i.si, %bb.bq ], [ %.0226.ph, %.backedge.outer ] ; 33 uses
...
ss_compare.exit384.thread:                        ; preds = %.thread.i377, %bb.bj, %ss_compare.exit384, %bb.bk
  %.1223 = phi i32 [ %i.rl, %bb.bk ], [ %.0222545, %ss_compare.exit384 ], [ %.0222545, %bb.bj ], [ %.0222545, %.thread.i377 ] ; 6 uses
...
begin_hunk_3_@ss_swapmerge:bb.a
  ...
  br i1 %i.sb, label %middle.block, label %vector.body, !llvm.loop !197
...
.lr.ph.i386.preheader:                            ; preds = %bb.bl, %middle.block
  %.012.i.ph = phi ptr [ %i.rt, %bb.bl ], [ %i.rv, %middle.block ]
  %.0811.i.ph = phi i32 [ %.1223, %bb.bl ], [ %i.rw, %middle.block ]
  %.0910.i.ph = phi ptr [ %.0226, %bb.bl ], [ %i.ry, %middle.block ]
  br label %.lr.ph.i386
...
begin_hunk_4_@ss_swapmerge:bb.a
  ...
  br i1 %i.sh, label %.lr.ph.i386, label %ss_blockswap.exit, !llvm.loop !198
...
begin_hunk_5_@ss_swapmerge:bb.a
  ...
  br i1 %i.sq, label %.preheader, label %.loopexit.loopexit, !llvm.loop !199
...
begin_hunk_6_@ss_swapmerge:bb.a
  ...
  br i1 %i.st, label %.preheader439, label %.loopexit.loopexit550, !llvm.loop !200
