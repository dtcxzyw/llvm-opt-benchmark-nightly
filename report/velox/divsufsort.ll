...
tr_median3.exit59.i.i.i:                          ; preds = %bb.gz, %tr_median3.exit54.i.i.i
  %i.bdn = phi i32 [ %.pre66.i.i.i, %bb.gz ], [ %6, %tr_median3.exit54.i.i.i ] ; 2 uses
...
ss_median3.exit60.i:                              ; preds = %bb.ax, %ss_median3.exit55.i
  ...
  br i1 %i.wo, label %bb.ay, label %ss_median3.exit60.ss_median3.exit65_crit_edge.i
...
ss_median3.exit65.i:                              ; preds = %bb.ay, %ss_median3.exit60.ss_median3.exit65_crit_edge.i
  %i.wx = phi i8 [ %.pre75.i, %bb.ay ], [ %5, %ss_median3.exit60.ss_median3.exit65_crit_edge.i ] ; 2 uses
