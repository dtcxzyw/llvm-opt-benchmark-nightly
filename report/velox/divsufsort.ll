...
begin_hunk_0_@sort_typeBstar:.preheader340.preheader
  br i1 %i.tk, label %bb.gm, label %bb.go

bb.gm:                                            ; preds = %._crit_edge.i566.i.i
  ...
  br i1 %i.asf, label %.lr.ph.i50.i.i.i, label %tr_fixdown.exit55.i.i.i
...
bb.gn:                                            ; preds = %.lr.ph.i50.i.i.i
  ...
  br i1 %i.ava, label %.lr.ph.i50.i.i.i, label %tr_fixdown.exit55.i.i.i, !llvm.loop !81

tr_fixdown.exit55.i.i.i:                          ; preds = %bb.gn, %.lr.ph.i50.i.tr_fixdown.exit55.loopexit.i_crit_edge.i.i, %bb.gm
  %.0.lcssa.i49.i.i.i = phi i64 [ 0, %bb.gm ], [ %.pre713.i.i, %.lr.ph.i50.i.tr_fixdown.exit55.loopexit.i_crit_edge.i.i ], [ %i.aut, %bb.gn ]
  %i.avb = getelementptr inbounds nuw [4 x i8], ptr %.0455.ph.i.i, i64 %.0.lcssa.i49.i.i.i
  store i32 %i.atz, ptr %i.avb, align 4, !tbaa !3
  br label %bb.go

bb.go:                                            ; preds = %tr_fixdown.exit55.i.i.i, %._crit_edge.i566.i.i
  br i1 %i.asf, label %.lr.ph66.preheader.i.i.i, label %tr_heapsort.exit.i.i
...
.lr.ph.i57.i.preheader.i.i:                       ; preds = %.lr.ph66.preheader.i.i.i, %tr_fixdown.exit62.i.i.i
  %i.avg = phi i32 [ %i.awm, %tr_fixdown.exit62.i.i.i ], [ %i.avf, %.lr.ph66.preheader.i.i.i ] ; 2 uses
  %i.avh = phi ptr [ %i.awl, %tr_fixdown.exit62.i.i.i ], [ %i.ave, %.lr.ph66.preheader.i.i.i ]
  %i.avi = phi i32 [ %i.awk, %tr_fixdown.exit62.i.i.i ], [ %i.avd, %.lr.ph66.preheader.i.i.i ]
  %indvars.iv.next70.i623.i.i = phi i64 [ %indvars.iv.next70.i.i.i, %tr_fixdown.exit62.i.i.i ], [ %indvars.iv.next70.i621.i.i, %.lr.ph66.preheader.i.i.i ] ; 3 uses
...
tr_fixdown.exit62.thread.i.i.i:                   ; preds = %tr_fixdown.exit62.i.i.i, %.lr.ph66.preheader.i.i.i
  %.lcssa600.i.i = phi i32 [ %i.avd, %.lr.ph66.preheader.i.i.i ], [ %i.awk, %tr_fixdown.exit62.i.i.i ]
  %.lcssa.i.i = phi ptr [ %i.ave, %.lr.ph66.preheader.i.i.i ], [ %i.awl, %tr_fixdown.exit62.i.i.i ]
...
bb.gp:                                            ; preds = %.lr.ph.i57.i.i.i
  ...
  br i1 %i.awi, label %.lr.ph.i57.i.i.i, label %tr_fixdown.exit62.i.i.i, !llvm.loop !81

tr_fixdown.exit62.i.i.i:                          ; preds = %bb.gp, %.lr.ph.i57.i.tr_fixdown.exit62.i_crit_edge.i.i
  %.pre-phi716.i.i = phi i64 [ %.pre715.i.i, %.lr.ph.i57.i.tr_fixdown.exit62.i_crit_edge.i.i ], [ %i.awa, %bb.gp ]
...
tr_heapsort.exit.i.i:                             ; preds = %tr_fixdown.exit62.thread.i.i.i, %bb.go
  br i1 %i.ts, label %.lr.ph636.i.i, label %._crit_edge.thread.i.i299

.lr.ph636.i.i:                                    ; preds = %tr_heapsort.exit.i.i, %.critedge2.i.i
  %storemerge635.i.i = phi ptr [ %storemerge515.lcssa625.i.i, %.critedge2.i.i ], [ %i.tr, %tr_heapsort.exit.i.i ] ; 2 uses
...
.lr.ph.i.i302:                                    ; preds = %.lr.ph636.i.i, %bb.gq
  %storemerge515628.i.i = phi ptr [ %storemerge515.i.i, %bb.gq ], [ %storemerge515626.i.i, %.lr.ph636.i.i ] ; 4 uses
  ...
  br i1 %i.awv, label %bb.gq, label %.critedge2.i.i
...
bb.gq:                                            ; preds = %.lr.ph.i.i302
  ...
  br i1 %.not516.i.i, label %.critedge2.i.i, label %.lr.ph.i.i302, !llvm.loop !83

.critedge2.i.i:                                   ; preds = %bb.gq, %.lr.ph.i.i302, %.lr.ph636.i.i
  %storemerge515.lcssa625.i.i = phi ptr [ %storemerge515626.i.i, %.lr.ph636.i.i ], [ %storemerge515628.i.i, %.lr.ph.i.i302 ], [ %storemerge515.i.i, %bb.gq ] ; 2 uses
  %i.awx = icmp ult ptr %.0455.ph.i.i, %storemerge515.lcssa625.i.i
  br i1 %i.awx, label %.lr.ph636.i.i, label %._crit_edge.thread.i.i299, !llvm.loop !84

bb.gr:                                            ; preds = %.lr.ph646.split.i.i
...
bb.gt:                                            ; preds = %bb.gs
  ...
  br i1 %i.axw, label %bb.gu, label %tr_pivot.exit.i.i
...
bb.gw:                                            ; preds = %bb.gr
  ...
  br i1 %i.bbb, label %bb.gx, label %tr_median3.exit49.i.i.i
...
tr_median3.exit49.i.i.i:                          ; preds = %bb.gx, %bb.gw
  ...
  br i1 %i.bbz, label %bb.gy, label %tr_median3.exit54.i.i.i
...
tr_median3.exit54.i.i.i:                          ; preds = %bb.gy, %tr_median3.exit49.i.i.i
  ...
  br i1 %i.bcx, label %bb.gz, label %tr_median3.exit59.i.i.i
...
tr_median3.exit59.i.i.i:                          ; preds = %bb.gz, %tr_median3.exit54.i.i.i
  %i.bdc = phi i32 [ %.pre66.i.i.i, %bb.gz ], [ %16, %tr_median3.exit54.i.i.i ] ; 2 uses
  %.0.i56.i.i.i = phi ptr [ %spec.select22..i58.i.i.i, %bb.gz ], [ %spec.select.i55.i.i.i, %tr_median3.exit54.i.i.i ]
  ...
  br i1 %i.bdp, label %bb.ha, label %tr_pivot.exit.i.i
...
tr_pivot.exit.i.i:                                ; preds = %bb.ha, %tr_median3.exit59.i.i.i, %bb.gv, %bb.gu, %bb.gt
  %i.bdu = phi i32 [ %i.axg, %bb.gt ], [ %i.azf, %bb.gv ], [ %i.axg, %bb.gu ], [ %i.bal, %bb.ha ], [ %i.bal, %tr_median3.exit59.i.i.i ]
...
bb.hb:                                            ; preds = %bb.hc, %tr_pivot.exit.i.i
  %.0154.i.i = phi ptr [ %.0455.ph.i.i, %tr_pivot.exit.i.i ], [ %i.bea, %bb.hc ] ; 2 uses
  %i.bea = getelementptr inbounds nuw i8, ptr %.0154.i.i, i64 4 ; 9 uses
  %i.beb = icmp ult ptr %i.bea, %.0463.ph.i.i
  br i1 %i.beb, label %bb.hc, label %.critedge2.i55.i
...
bb.hc:                                            ; preds = %bb.hb
  ...
  br i1 %i.beg, label %bb.hb, label %.critedge.i58.i, !llvm.loop !42
...
.lr.ph.i59.i:                                     ; preds = %.preheader206.i.i, %bb.hf
  %i.bek = phi ptr [ %i.bes, %bb.hf ], [ %i.bei, %.preheader206.i.i ] ; 4 uses
  %.0159217.i.i = phi ptr [ %.1160.i.i, %bb.hf ], [ %i.bea, %.preheader206.i.i ] ; 5 uses
...
bb.hd:                                            ; preds = %.lr.ph.i59.i
  ...
  br i1 %i.bep, label %bb.he, label %bb.hf
...
bb.hf:                                            ; preds = %bb.he, %bb.hd
  %.1160.i.i = phi ptr [ %i.ber, %bb.he ], [ %.0159217.i.i, %bb.hd ] ; 2 uses
  %i.bes = getelementptr inbounds nuw i8, ptr %i.bek, i64 4 ; 3 uses
  %i.bet = icmp ult ptr %i.bes, %.0463.ph.i.i
  br i1 %i.bet, label %.lr.ph.i59.i, label %.critedge2.i55.i, !llvm.loop !43

.critedge2.i55.i:                                 ; preds = %bb.hb, %bb.hf, %.lr.ph.i59.i, %.preheader206.i.i, %.critedge.i58.i
  %.2161.i.i = phi ptr [ %i.bea, %.critedge.i58.i ], [ %.0159217.i.i, %.lr.ph.i59.i ], [ %i.bea, %.preheader206.i.i ], [ %.1160.i.i, %bb.hf ], [ %i.bea, %bb.hb ] ; 2 uses
  %.2156.i.i = phi ptr [ %i.bea, %.critedge.i58.i ], [ %i.bek, %.lr.ph.i59.i ], [ %i.bei, %.preheader206.i.i ], [ %i.bes, %bb.hf ], [ %i.bea, %bb.hb ] ; 6 uses
  br label %bb.hg

bb.hg:                                            ; preds = %bb.hh, %.critedge2.i55.i
  %.0149.i.i = phi ptr [ %.0463.ph.i.i, %.critedge2.i55.i ], [ %i.beu, %bb.hh ] ; 2 uses
  %i.beu = getelementptr inbounds i8, ptr %.0149.i.i, i64 -4 ; 9 uses
  %i.bev = icmp ult ptr %.2156.i.i, %i.beu
  br i1 %i.bev, label %bb.hh, label %.critedge6.i.i
...
bb.hh:                                            ; preds = %bb.hg
  ...
  br i1 %i.bfa, label %bb.hg, label %.critedge4.i.i, !llvm.loop !44
...
.lr.ph223.i.i:                                    ; preds = %.preheader.i.i298, %bb.hk
  %i.bfe = phi ptr [ %i.bfm, %bb.hk ], [ %i.bfc, %.preheader.i.i298 ] ; 4 uses
  %.0143222.i.i = phi ptr [ %.1144.i.i, %bb.hk ], [ %i.beu, %.preheader.i.i298 ] ; 5 uses
...
bb.hi:                                            ; preds = %.lr.ph223.i.i
  ...
  br i1 %i.bfj, label %bb.hj, label %bb.hk
...
bb.hk:                                            ; preds = %bb.hj, %bb.hi
  %.1144.i.i = phi ptr [ %i.bfl, %bb.hj ], [ %.0143222.i.i, %bb.hi ] ; 2 uses
  %i.bfm = getelementptr inbounds i8, ptr %i.bfe, i64 -4 ; 3 uses
  %i.bfn = icmp ult ptr %.2156.i.i, %i.bfm
  br i1 %i.bfn, label %.lr.ph223.i.i, label %.critedge6.i.i, !llvm.loop !45

.critedge6.i.i:                                   ; preds = %bb.hg, %bb.hk, %.lr.ph223.i.i, %.preheader.i.i298, %.critedge4.i.i
  %.2151.i.i = phi ptr [ %i.beu, %.critedge4.i.i ], [ %i.bfe, %.lr.ph223.i.i ], [ %i.bfc, %.preheader.i.i298 ], [ %i.bfm, %bb.hk ], [ %i.beu, %bb.hg ] ; 2 uses
  %.2145.i.i = phi ptr [ %i.beu, %.critedge4.i.i ], [ %.0143222.i.i, %.lr.ph223.i.i ], [ %i.beu, %.preheader.i.i298 ], [ %.1144.i.i, %bb.hk ], [ %i.beu, %bb.hg ] ; 2 uses
...
.lr.ph230.i.i:                                    ; preds = %.lr.ph247.i.i, %bb.hn
  %i.bft = phi ptr [ %i.bgb, %bb.hn ], [ %i.bfr, %.lr.ph247.i.i ] ; 4 uses
...
bb.hl:                                            ; preds = %.lr.ph230.i.i
  ...
  br i1 %i.bfy, label %bb.hm, label %bb.hn
...
bb.hn:                                            ; preds = %bb.hm, %bb.hl
  %.5164.i.i = phi ptr [ %i.bga, %bb.hm ], [ %.4163229.i.i, %bb.hl ] ; 2 uses
  %i.bgb = getelementptr inbounds nuw i8, ptr %i.bft, i64 4 ; 3 uses
  %i.bgc = icmp ult ptr %i.bgb, %.3152245.i.i
  br i1 %i.bgc, label %.lr.ph230.i.i, label %.critedge8.i.i, !llvm.loop !46
...
.critedge8.i.i:                                   ; preds = %bb.hn, %.lr.ph230.i.i, %.lr.ph247.i.i
  ...
  %.lcssa.i57.i = phi ptr [ %i.bfr, %.lr.ph247.i.i ], [ %i.bgb, %bb.hn ], [ %i.bft, %.lr.ph230.i.i ] ; 5 uses
...
.lr.ph237.i.i:                                    ; preds = %.critedge8.i.i, %bb.hq
  %i.bgf = phi ptr [ %i.bgn, %bb.hq ], [ %i.bgd, %.critedge8.i.i ] ; 4 uses
...
bb.ho:                                            ; preds = %.lr.ph237.i.i
  ...
  br i1 %i.bgk, label %bb.hp, label %bb.hq
...
bb.hq:                                            ; preds = %bb.hp, %bb.ho
  %.5148.i.i = phi ptr [ %i.bgm, %bb.hp ], [ %.4147236.i.i, %bb.ho ] ; 2 uses
...
bb.aa:                                            ; preds = %.lr.ph.i508
  ...
  br i1 %i.ka, label %.lr.ph.i508, label %.critedge.i506, !llvm.loop !142
...
bb.ac:                                            ; preds = %bb.ab
  ...
  br i1 %.not.i507, label %bb.ad, label %bb.ab, !llvm.loop !143
...
.critedge2.i:                                     ; preds = %bb.ab
  ...
  br i1 %i.km, label %bb.ae, label %ss_partition.exit
...
ss_partition.exit:                                ; preds = %bb.ae, %.critedge2.i, %._crit_edge653
...
bb.ah:                                            ; preds = %bb.ag
  ...
  %i.lg = getelementptr inbounds nuw [4 x i8], ptr @lg_table, i64 %i.lf
...
bb.ai:                                            ; preds = %bb.ag
  ...
  %i.lk = getelementptr inbounds nuw [4 x i8], ptr @lg_table, i64 %i.lj
  %i.ll = load i32, ptr %i.lk, align 4, !tbaa !3
  br label %ss_ilg.exit.backedge

bb.aj:                                            ; preds = %ss_partition.exit
...
bb.ak:                                            ; preds = %bb.aj
  ...
  store ptr %.3429, ptr %i.lo, align 8, !tbaa !134
  %i.lp = getelementptr inbounds nuw i8, ptr %i.lo, i64 8
  store ptr %.0419.lcssa, ptr %i.lp, align 8, !tbaa !136
  %i.lq = add nsw i32 %.0433, 1
  %i.lr = getelementptr inbounds nuw i8, ptr %i.lo, i64 16
  store i32 %i.lq, ptr %i.lr, align 8, !tbaa !137
...
bb.al:                                            ; preds = %bb.ak
  ...
  %i.lv = getelementptr inbounds nuw [4 x i8], ptr @lg_table, i64 %i.lu
...
bb.ao:                                            ; preds = %bb.an
  ...
  %i.mi = getelementptr inbounds nuw [4 x i8], ptr @lg_table, i64 %i.mh
...
bb.ap:                                            ; preds = %bb.an
  ...
  %i.mm = getelementptr inbounds nuw [4 x i8], ptr @lg_table, i64 %i.ml
  %i.mn = load i32, ptr %i.mm, align 4, !tbaa !3
  br label %ss_ilg.exit.backedge

bb.aq:                                            ; preds = %ss_heapsort.exit
...
bb.as:                                            ; preds = %bb.ar
  ...
  br i1 %i.ny, label %bb.at, label %ss_pivot.exit
...
bb.av:                                            ; preds = %bb.aq
  ...
  br i1 %i.td, label %bb.aw, label %ss_median3.exit55.i
...
ss_median3.exit55.i:                              ; preds = %bb.aw, %bb.av
  ...
  br i1 %i.uq, label %bb.ax, label %ss_median3.exit60.i
...
ss_median3.exit60.i:                              ; preds = %bb.ax, %ss_median3.exit55.i
  ...
  br i1 %i.wf, label %bb.ay, label %ss_median3.exit60.ss_median3.exit65_crit_edge.i

ss_median3.exit60.ss_median3.exit65_crit_edge.i:  ; preds = %ss_median3.exit60.i
...
ss_median3.exit65.i:                              ; preds = %bb.ay, %ss_median3.exit60.ss_median3.exit65_crit_edge.i
  %i.wn = phi i8 [ %.pre75.i, %bb.ay ], [ %14, %ss_median3.exit60.ss_median3.exit65_crit_edge.i ] ; 2 uses
  %.0.i62.i = phi ptr [ %spec.select28..i64.i, %bb.ay ], [ %spec.select.i61.i, %ss_median3.exit60.ss_median3.exit65_crit_edge.i ]
  ...
  br i1 %i.xj, label %bb.az, label %ss_pivot.exit
...
ss_pivot.exit:                                    ; preds = %bb.as, %bb.at, %bb.au, %ss_median3.exit65.i, %bb.az
  %i.xr = phi i32 [ %i.mw, %bb.as ], [ %i.qd, %bb.au ], [ %i.mw, %bb.at ], [ %i.sb, %bb.az ], [ %i.sb, %ss_median3.exit65.i ]
...
bb.ba:                                            ; preds = %bb.bb, %ss_pivot.exit
  %.0414 = phi ptr [ %.0426, %ss_pivot.exit ], [ %i.xz, %bb.bb ] ; 2 uses
...
bb.bb:                                            ; preds = %bb.ba
  ...
  br i1 %i.yi, label %bb.ba, label %.critedge, !llvm.loop !144
...
bb.be:                                            ; preds = %bb.bd, %bb.bc
  ...
  br i1 %i.yy, label %.lr.ph, label %.critedge2, !llvm.loop !145
...
bb.bg:                                            ; preds = %bb.bf
  ...
  br i1 %i.zi, label %bb.bf, label %.critedge4, !llvm.loop !146
...
bb.bj:                                            ; preds = %bb.bi, %bb.bh
  ...
  br i1 %i.zy, label %.lr.ph607, label %.critedge6, !llvm.loop !147
...
bb.bm:                                            ; preds = %bb.bl, %bb.bk
  ...
  br i1 %i.aaq, label %.lr.ph614, label %.critedge8, !llvm.loop !148
