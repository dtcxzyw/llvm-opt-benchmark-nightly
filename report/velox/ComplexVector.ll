...
bb.x:                                             ; preds = %bb.w
  ...
  %15 = ptrtoint ptr %i.cp to i64
  %i.cq = ptrtoint ptr %i.cn to i64
  %16 = sub i64 %15, %i.cq                        ; 2 uses
  ...
  %17 = ptrtoint ptr %i.ct to i64
  %i.cu = ptrtoint ptr %i.cr to i64
  %18 = sub i64 %17, %i.cu                        ; 2 uses
...
._crit_edge.i:                                    ; preds = %bb.x
  %i.cx = ashr exact i64 %16, 2                   ; 2 uses
  %i.cy = ashr exact i64 %18, 2                   ; 2 uses
...
bb.ab:                                            ; preds = %_ZNRSt8optionalIiE5valueEv.exit
  ...
  %19 = ptrtoint ptr %i.dy to i64
  %20 = sub i64 %i.ea, %19                        ; 2 uses
  %21 = load ptr, ptr %11, align 8, !tbaa !175    ; 2 uses
  %22 = load ptr, ptr %i.cs, align 8, !tbaa !219
  %23 = ptrtoint ptr %22 to i64
  %i.eb = ptrtoint ptr %21 to i64
  %i.ec = sub i64 %23, %i.eb                      ; 2 uses
  %.not.i79 = icmp eq i64 %20, %i.ec
...
._crit_edge.i88:                                  ; preds = %bb.ab
  %i.ed = ashr exact i64 %20, 2                   ; 2 uses
...
.lr.ph.i94:                                       ; preds = %bb.ac, %.lr.ph.outer.i91
  ...
  %i.eh = getelementptr inbounds nuw [4 x i8], ptr %21, i64 %indvars.iv.i95
