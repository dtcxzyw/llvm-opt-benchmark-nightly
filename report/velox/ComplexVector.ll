...
bb.e:                                             ; preds = %.backedge, %bb.d
  ...
  %.058 = phi ptr [ %0, %bb.d ], [ %.058.be, %.backedge ] ; 23 uses
  %i.ar = sub nsw i64 %.086, %.082                ; 10 uses
...
.lr.ph110.preheader.a:                            ; preds = %bb.g
  %i.az = getelementptr [4 x i8], ptr %.058, i64 %.082 ; 5 uses
  %min.iters.check = icmp ult i64 %i.ar, 16
...
begin_hunk_2_@_ZNSt3_V28__rotateIPiEET_S2_S2_S2_St26random_access_iterator_tag:bb.a
  ...
  br i1 %found.conflict, label %.lr.ph110.preheader245, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %i.ar, 9223372036854775792     ; 5 uses
...
begin_hunk_3_@_ZNSt3_V28__rotateIPiEET_S2_S2_S2_St26random_access_iterator_tag:bb.a
  ...
  br i1 %i.bj, label %middle.block.a, label %vector.body, !llvm.loop !2259

middle.block.a:                                   ; preds = %vector.body
  %cmp.n.a = icmp eq i64 %i.ar, %n.vec
  br i1 %cmp.n.a, label %._crit_edge111, label %.lr.ph110.preheader245

.lr.ph110.preheader245:                           ; preds = %vector.memcheck, %.lr.ph110.preheader.a, %middle.block.a
  %.054108.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %.lr.ph110.preheader.a ], [ %n.vec, %middle.block.a ] ; 3 uses
  %.055107.ph = phi ptr [ %i.az, %vector.memcheck ], [ %i.az, %.lr.ph110.preheader.a ], [ %i.be, %middle.block.a ] ; 2 uses
  %.159106.ph = phi ptr [ %.058, %vector.memcheck ], [ %.058, %.lr.ph110.preheader.a ], [ %i.bg, %middle.block.a ] ; 2 uses
...
begin_hunk_4_@_ZNSt3_V28__rotateIPiEET_S2_S2_S2_St26random_access_iterator_tag:bb.a
  ...
  br i1 %prol.iter254.cmp.not, label %.lr.ph110.prol.loopexit, label %.lr.ph110.prol, !llvm.loop !2260
...
._crit_edge111:                                   ; preds = %.lr.ph110.prol.loopexit, %.lr.ph110, %middle.block.a, %bb.g
  %.159.lcssa = phi ptr [ %.058, %bb.g ], [ %i.bg, %middle.block.a ], [ %.lcssa.unr, %.lr.ph110.prol.loopexit ], [ %i.ci, %.lr.ph110 ]
...
begin_hunk_6_@_ZNSt3_V28__rotateIPiEET_S2_S2_S2_St26random_access_iterator_tag:bb.a
  ...
  br i1 %exitcond119.not.3, label %._crit_edge111, label %.lr.ph110, !llvm.loop !2261
...
begin_hunk_7_@_ZNSt3_V28__rotateIPiEET_S2_S2_S2_St26random_access_iterator_tag:bb.a
  ...
  %wide.load162 = load <8 x i32>, ptr %i.dg, align 4, !tbaa !3, !alias.scope !2262, !noalias !2265
  %wide.load163 = load <8 x i32>, ptr %i.dh, align 4, !tbaa !3, !alias.scope !2262, !noalias !2265
  %i.di = getelementptr inbounds i8, ptr %next.gep159, i64 -32 ; 2 uses
  %i.dj = getelementptr inbounds i8, ptr %next.gep159, i64 -64 ; 2 uses
  %wide.load165 = load <8 x i32>, ptr %i.di, align 4, !tbaa !3, !alias.scope !2265
  %wide.load166 = load <8 x i32>, ptr %i.dj, align 4, !tbaa !3, !alias.scope !2265
  store <8 x i32> %wide.load165, ptr %i.dg, align 4, !tbaa !3, !alias.scope !2262, !noalias !2265
  store <8 x i32> %wide.load166, ptr %i.dh, align 4, !tbaa !3, !alias.scope !2262, !noalias !2265
  store <8 x i32> %wide.load162, ptr %i.di, align 4, !tbaa !3, !alias.scope !2265
  store <8 x i32> %wide.load163, ptr %i.dj, align 4, !tbaa !3, !alias.scope !2265
  %index.next173 = add nuw i64 %index157, 16      ; 2 uses
  %i.dk = icmp eq i64 %index.next173, %n.vec155
  br i1 %i.dk, label %middle.block174, label %vector.body156, !llvm.loop !2267
...
begin_hunk_8_@_ZNSt3_V28__rotateIPiEET_S2_S2_S2_St26random_access_iterator_tag:bb.a
  ...
  %wide.load183 = load <4 x i32>, ptr %i.dr, align 4, !tbaa !3, !alias.scope !2262, !noalias !2265
  %i.ds = getelementptr inbounds i8, ptr %next.gep181, i64 -16 ; 2 uses
  %wide.load185 = load <4 x i32>, ptr %i.ds, align 4, !tbaa !3, !alias.scope !2265
  store <4 x i32> %wide.load185, ptr %i.dr, align 4, !tbaa !3, !alias.scope !2262, !noalias !2265
  store <4 x i32> %wide.load183, ptr %i.ds, align 4, !tbaa !3, !alias.scope !2265
  %index.next189 = add nuw i64 %index180, 4       ; 2 uses
  %i.dt = icmp eq i64 %index.next189, %n.vec179
  br i1 %i.dt, label %vec.epilog.middle.block, label %vec.epilog.vector.body.a, !llvm.loop !2268
...
begin_hunk_9_@_ZNSt3_V28__rotateIPiEET_S2_S2_S2_St26random_access_iterator_tag:bb.a
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph.prol.loopexit, label %.lr.ph.prol, !llvm.loop !2269
...
begin_hunk_11_@_ZNSt3_V28__rotateIPiEET_S2_S2_S2_St26random_access_iterator_tag:bb.a
  ...
  br i1 %exitcond.not.3, label %._crit_edge, label %.lr.ph, !llvm.loop !2271
...
begin_hunk_12_@"_ZNSt17_Function_handlerIFvRNSt7__cxx1118basic_stringstreamIcSt11char_traitsIcESaIcEEEmEZNK8facebook5velox9MapVector8toStringEiE3$_0E9_M_invokeERKSt9_Any_dataS6_Om":bb.a
  ...
  %i.b = load ptr, ptr %0, align 8, !tbaa !2272   ; 2 uses
  ...
  %i.g = load ptr, ptr %i.f, align 8, !tbaa !2274, !nonnull !148, !align !648
  ...
  call void %i.l(ptr dead_on_unwind nonnull writable sret(%"class.std::__cxx11::basic_string") align 8 %3, ptr noundef nonnull align 8 dereferenceable(94) %i.e, i32 noundef %i.i), !inline_history !2275
...
begin_hunk_13_@"_ZNSt17_Function_handlerIFvRNSt7__cxx1118basic_stringstreamIcSt11char_traitsIcESaIcEEEmEZNK8facebook5velox9MapVector8toStringEiE3$_0E9_M_invokeERKSt9_Any_dataS6_Om":bb.a
  ...
  %i.t = load ptr, ptr %i.f, align 8, !tbaa !2274, !nonnull !148, !align !648
...
bb.d:                                             ; preds = %bb.a
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %0, ptr noundef nonnull readonly align 8 dereferenceable(16) %1, i64 16, i1 false), !tbaa.struct !2276
  br label %"_ZNSt14_Function_base13_Base_managerIZNK8facebook5velox9MapVector8toStringB5cxx11EiE3$_0E10_M_managerERSt9_Any_dataRKS6_St18_Manager_operation.exit"
...
!2260 = distinct !{!2260, !205}
!2261 = distinct !{!2261, !71, !119}
!2262 = !{!2263}
!2263 = distinct !{!2263, !2264}
!2264 = distinct !{!2264, !"LVerDomain"}
!2265 = !{!2266}
!2266 = distinct !{!2266, !2264}
!2267 = distinct !{!2267, !71, !119, !120}
!2268 = distinct !{!2268, !71, !119, !120}
!2269 = distinct !{!2269, !205}
!2270 = distinct !{!2270, !71}
!2271 = distinct !{!2271, !71, !119}
!2272 = !{!2273, !493, i64 0}
!2273 = !{!"_ZTSZNK8facebook5velox9MapVector8toStringB5cxx11EiE3$_0", !493, i64 0, !103, i64 8}
!2274 = !{!2273, !103, i64 8}
!2275 = distinct !{null, null, null}
!2276 = !{i64 0, i64 8, !518, i64 8, i64 8, !104}
end_hunk_15
