...
.outer:                                           ; preds = %.split157, %bb.a
  %.070.ph = phi i32 [ %i.ah, %.split157 ], [ 0, %bb.a ]
  %.068.ph = phi i32 [ %i.ai, %.split157 ], [ %2, %bb.a ]
  %.066.ph = phi i32 [ %i.ag, %.split157 ], [ 0, %bb.a ]
  %.064.ph = phi i32 [ %i.aj, %.split157 ], [ 0, %bb.a ]
  %.062.ph = phi i32 [ %spec.select, %.split157 ], [ 0, %bb.a ] ; 2 uses
  br label %select.unfold

select.unfold:                                    ; preds = %.thread148, %.outer
  %.070 = phi i32 [ %.070.ph, %.outer ], [ %i.ah, %.thread148 ] ; 4 uses
  %.068 = phi i32 [ %.068.ph, %.outer ], [ %i.ai, %.thread148 ] ; 4 uses
  %.066 = phi i32 [ %.066.ph, %.outer ], [ %i.ag, %.thread148 ] ; 4 uses
  %.064 = phi i32 [ %.064.ph, %.outer ], [ %i.aj, %.thread148 ] ; 5 uses
  %i.h = sub nsw i32 %.068, %.070
  %i.i = ashr i32 %i.h, 1
  %i.j = add nsw i32 %i.i, %.070                  ; 6 uses
  %i.k = tail call i32 @llvm.smin.i32(i32 %.066, i32 %.064) ; 2 uses
  ...
  br i1 %i.o, label %.lr.ph, label %.thread148
...
bb.b:                                             ; preds = %.lr.ph, %bb.d
  ...
  br i1 %i.u, label %.split152.thread.loopexit, label %bb.c
...
bb.d:                                             ; preds = %bb.c
  ...
  br i1 %exitcond.not, label %.thread148, label %bb.b, !llvm.loop !36

._crit_edge:                                      ; preds = %bb.c
  %i.ad = trunc nsw i64 %indvars.iv to i32        ; 2 uses
  %i.ae = icmp slt i32 %.fr, 0
  br i1 %i.ae, label %.split152.thread, label %.thread148

.split152.thread.loopexit:                        ; preds = %bb.b
  %i.af = trunc nsw i64 %indvars.iv to i32
  br label %.thread148

.split152.thread:                                 ; preds = %._crit_edge
  br label %.thread148

.thread148:                                       ; preds = %bb.d, %.split152.thread.loopexit, %._crit_edge, %select.unfold, %.split152.thread
  %i.ag = phi i32 [ %i.ad, %._crit_edge ], [ %.066, %.split152.thread ], [ %i.k, %select.unfold ], [ %.066, %.split152.thread.loopexit ], [ %i.n, %bb.d ] ; 3 uses
  %i.ah = phi i32 [ %i.j, %._crit_edge ], [ %.070, %.split152.thread ], [ %i.j, %select.unfold ], [ %.070, %.split152.thread.loopexit ], [ %i.j, %bb.d ] ; 6 uses
  %i.ai = phi i32 [ %.068, %._crit_edge ], [ %i.j, %.split152.thread ], [ %.068, %select.unfold ], [ %i.j, %.split152.thread.loopexit ], [ %.068, %bb.d ] ; 4 uses
  %i.aj = phi i32 [ %.064, %._crit_edge ], [ %i.ad, %.split152.thread ], [ %.064, %select.unfold ], [ %i.af, %.split152.thread.loopexit ], [ %.064, %bb.d ] ; 2 uses
  %i.ak = sub nsw i32 %i.ai, %i.ah
  %i.al = icmp slt i32 %i.ak, 2
  br i1 %i.al, label %.split157, label %select.unfold

.split157:                                        ; preds = %.thread148
  %i.am = icmp slt i32 %i.ah, 1
  %i.an = icmp ne i32 %i.ai, %i.ah
  %or.cond.not = and i1 %i.am, %i.an              ; 2 uses
  %.not81 = icmp eq i32 %.062.ph, 0
  %spec.select = select i1 %or.cond.not, i32 1, i32 %.062.ph
  %spec.select85 = select i1 %or.cond.not, i1 %.not81, i1 false
  br i1 %spec.select85, label %.outer, label %.preheader

.preheader:                                       ; preds = %.split157, %.thread
  %.272 = phi i32 [ %i.az, %.thread ], [ %i.ah, %.split157 ]
  %i.ao = sext i32 %.272 to i64
  %i.ap = getelementptr inbounds [32 x i8], ptr %1, i64 %i.ao ; 5 uses
  %i.aq = load i32, ptr %i.ap, align 8, !tbaa !33 ; 2 uses
  %.not82 = icmp slt i32 %i.ag, %i.aq
...
.outer:                                           ; preds = %.split156, %bb.a
  %.070.ph = phi i32 [ %i.an, %.split156 ], [ 0, %bb.a ]
  %.068.ph = phi i32 [ %i.ao, %.split156 ], [ %2, %bb.a ]
  %.066.ph = phi i32 [ %i.am, %.split156 ], [ 0, %bb.a ]
  %.064.ph = phi i32 [ %i.ap, %.split156 ], [ 0, %bb.a ]
  %.062.ph = phi i32 [ %spec.select, %.split156 ], [ 0, %bb.a ] ; 2 uses
  br label %select.unfold

select.unfold:                                    ; preds = %.thread147, %.outer
  %.070 = phi i32 [ %.070.ph, %.outer ], [ %i.an, %.thread147 ] ; 4 uses
  %.068 = phi i32 [ %.068.ph, %.outer ], [ %i.ao, %.thread147 ] ; 4 uses
  %.066 = phi i32 [ %.066.ph, %.outer ], [ %i.am, %.thread147 ] ; 4 uses
  %.064 = phi i32 [ %.064.ph, %.outer ], [ %i.ap, %.thread147 ] ; 5 uses
  %i.i = sub nsw i32 %.068, %.070
  %i.j = ashr i32 %i.i, 1
  %i.k = add nsw i32 %i.j, %.070                  ; 6 uses
  %i.l = tail call i32 @llvm.smin.i32(i32 %.066, i32 %.064) ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.ac = zext nneg i32 %.05889 to i64
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.ah = add nsw i32 %.05889, -1
  %i.ai = icmp sgt i32 %.05889, 0
  br i1 %i.ai, label %bb.b, label %.thread147, !llvm.loop !40
...
.split151.thread.loopexit:                        ; preds = %bb.b
...
.thread147:                                       ; preds = %bb.d, %.split151.thread.loopexit, %._crit_edge, %select.unfold, %.split151.thread
  %i.am = phi i32 [ %i.aj, %._crit_edge ], [ %.066, %.split151.thread ], [ %i.l, %select.unfold ], [ %.066, %.split151.thread.loopexit ], [ %i.o, %bb.d ] ; 3 uses
  %i.an = phi i32 [ %i.k, %._crit_edge ], [ %.070, %.split151.thread ], [ %i.k, %select.unfold ], [ %.070, %.split151.thread.loopexit ], [ %i.k, %bb.d ] ; 6 uses
  %i.ao = phi i32 [ %.068, %._crit_edge ], [ %i.k, %.split151.thread ], [ %.068, %select.unfold ], [ %i.k, %.split151.thread.loopexit ], [ %.068, %bb.d ] ; 4 uses
  %i.ap = phi i32 [ %.064, %._crit_edge ], [ %i.aj, %.split151.thread ], [ %.064, %select.unfold ], [ %i.al, %.split151.thread.loopexit ], [ %.064, %bb.d ] ; 2 uses
  %i.aq = sub nsw i32 %i.ao, %i.an
  %i.ar = icmp slt i32 %i.aq, 2
  br i1 %i.ar, label %.split156, label %select.unfold

.split156:                                        ; preds = %.thread147
  %i.as = icmp slt i32 %i.an, 1
  %i.at = icmp ne i32 %i.ao, %i.an
...
.preheader:                                       ; preds = %.split156, %.thread
  %.272 = phi i32 [ %i.bf, %.thread ], [ %i.an, %.split156 ]
  %i.au = sext i32 %.272 to i64
  %i.av = getelementptr inbounds [32 x i8], ptr %1, i64 %i.au ; 5 uses
  %i.aw = load i32, ptr %i.av, align 8, !tbaa !33 ; 2 uses
  %.not82 = icmp slt i32 %i.am, %i.aw
  br i1 %.not82, label %.thread, label %bb.e
