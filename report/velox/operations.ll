...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i160: ; preds = %bb.dc
  %i.ja = load i64, ptr %i.cc, align 8, !tbaa !18
  %i.jb = add i64 %i.ja, 1
  call void @_ZdlPvm(ptr noundef %i.iy, i64 noundef %i.jb) #32
  br label %_ZN5boost10filesystem4pathD2Ev.exit162

_ZN5boost10filesystem4pathD2Ev.exit162:           ; preds = %_ZN5boost10filesystem11path_detail13path_iteratorD2Ev.exit150, %bb.dc, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i160
  %.250194 = phi i32 [ %.149, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i160 ], [ %.149, %bb.dc ], [ 1, %_ZN5boost10filesystem11path_detail13path_iteratorD2Ev.exit150 ] ; 2 uses
  %i.jc = load ptr, ptr %8, align 8, !tbaa !15    ; 2 uses
  %i.jd = icmp eq ptr %i.jc, %i.bq
  br i1 %i.jd, label %_ZN5boost10filesystem4pathD2Ev.exit165, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i163

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i163: ; preds = %_ZN5boost10filesystem4pathD2Ev.exit162
  %i.je = load i64, ptr %i.bq, align 8, !tbaa !18
  %i.jf = add i64 %i.je, 1
  call void @_ZdlPvm(ptr noundef %i.jc, i64 noundef %i.jf) #32
  br label %_ZN5boost10filesystem4pathD2Ev.exit165

_ZN5boost10filesystem4pathD2Ev.exit165:           ; preds = %_ZN5boost10filesystem4pathD2Ev.exit162, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i163
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #28
  %cond = icmp eq i32 %.250194, 3
  br i1 %cond, label %_ZNK5boost6system10error_codecvbEv.exit77.thread, label %bb.dd

_ZN5boost10filesystem4pathD2Ev.exit159:           ; preds = %_ZN5boost10filesystem11path_detail13path_iteratorD2Ev.exit156, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i157, %bb.an, %bb.am
  %.pn64.pn.pn.pn.pn = phi { ptr, i32 } [ %i.cz, %bb.am ], [ %i.da, %bb.an ], [ %.pn64.pn.pn, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i157 ], [ %.pn64.pn.pn, %_ZN5boost10filesystem11path_detail13path_iteratorD2Ev.exit156 ] ; 2 uses
  %i.jg = load ptr, ptr %8, align 8, !tbaa !15    ; 2 uses
  %i.jh = icmp eq ptr %i.jg, %i.bq
  br i1 %i.jh, label %_ZN5boost10filesystem4pathD2Ev.exit168, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i166

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i166: ; preds = %_ZN5boost10filesystem4pathD2Ev.exit159
  %i.ji = load i64, ptr %i.bq, align 8, !tbaa !18
  %i.jj = add i64 %i.ji, 1
  call void @_ZdlPvm(ptr noundef %i.jg, i64 noundef %i.jj) #32
  br label %_ZN5boost10filesystem4pathD2Ev.exit168

_ZN5boost10filesystem4pathD2Ev.exit168:           ; preds = %_ZN5boost10filesystem4pathD2Ev.exit159, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i166, %bb.al
  %.pn64.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %i.cy, %bb.al ], [ %.pn64.pn.pn.pn.pn, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i166 ], [ %.pn64.pn.pn.pn.pn, %_ZN5boost10filesystem4pathD2Ev.exit159 ]
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #28
  br label %bb.de

bb.dd:                                            ; preds = %_ZN5boost10filesystem4pathD2Ev.exit165
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #28
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #28
  %cond1 = icmp eq i32 %.250194, 2
  br i1 %cond1, label %_ZNK5boost6system10error_codecvbEv.exit.thread, label %bb.df

bb.de:                                            ; preds = %_ZN5boost10filesystem4pathD2Ev.exit168, %bb.ab, %bb.w
  %.pn71 = phi { ptr, i32 } [ %i.bf, %bb.w ], [ %i.bn, %bb.ab ], [ %.pn64.pn.pn.pn.pn.pn, %_ZN5boost10filesystem4pathD2Ev.exit168 ]
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #28
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #28
  br label %bb.dg

bb.df:                                            ; preds = %bb.dd, %_ZNK5boost6system10error_codecvbEv.exit.thread
  %i.jk = load ptr, ptr %4, align 8, !tbaa !15    ; 2 uses
  %i.jl = icmp eq ptr %i.jk, %i.a
  br i1 %i.jl, label %_ZN5boost10filesystem4pathD2Ev.exit171, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i169

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i169: ; preds = %bb.df
  %i.jm = load i64, ptr %i.a, align 8, !tbaa !18
  %i.jn = add i64 %i.jm, 1
  call void @_ZdlPvm(ptr noundef %i.jk, i64 noundef %i.jn) #32
  br label %_ZN5boost10filesystem4pathD2Ev.exit171

_ZN5boost10filesystem4pathD2Ev.exit171:           ; preds = %bb.df, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i169
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #28
  ret void

bb.dg:                                            ; preds = %bb.de, %bb.s, %bb.r
  %.pn71.pn = phi { ptr, i32 } [ %.pn71, %bb.de ], [ %i.av, %bb.s ], [ %i.au, %bb.r ]
  %i.jo = load ptr, ptr %4, align 8, !tbaa !15    ; 2 uses
  %i.jp = icmp eq ptr %i.jo, %i.a
  br i1 %i.jp, label %_ZN5boost10filesystem4pathD2Ev.exit174, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i172

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i172: ; preds = %bb.dg
  %i.jq = load i64, ptr %i.a, align 8, !tbaa !18
  %i.jr = add i64 %i.jq, 1
  call void @_ZdlPvm(ptr noundef %i.jo, i64 noundef %i.jr) #32
  br label %_ZN5boost10filesystem4pathD2Ev.exit174

_ZN5boost10filesystem4pathD2Ev.exit174:           ; preds = %bb.dg, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i172
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #28
...
define internal fastcc void @_ZN5boost10filesystem6detail12_GLOBAL__N_111status_implERKNS0_4pathEPNS_6system10error_codeEi(ptr dead_on_unwind noalias writable writeonly align 4 captures(none) %0, ptr noundef nonnull align 8 dereferenceable(32) %1, ptr noundef %2) unnamed_addr #6 personality ptr @__gxx_personality_v0 {
bb.a:
