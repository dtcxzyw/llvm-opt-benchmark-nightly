...
_ZNKSt6vectorISt10shared_ptrIKN8facebook5velox4TypeEESaIS5_EE12_M_check_lenEmPKc.exit: ; preds = %bb.c
  ...
  %i.u = tail call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.t) #27 ; 11 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <8 x ptr> %wide.vec52, ptr %next.gep49, align 8, !tbaa !21, !alias.scope !492, !noalias !495
...
!461 = !{!"branch_weights", i32 8, i32 24}
