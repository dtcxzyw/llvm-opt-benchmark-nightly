...
bb.a:
  ...
  %or.cond5 = select i1 %or.cond, i1 %i.c, i1 false
  br i1 %or.cond5, label %6, label %10
...
bb.a:
  ...
  %i.b = load i32, ptr %i.a, align 4
  %6 = icmp eq i32 %i.b, -1
  %or.cond5.i = select i1 %or.cond.i, i1 %6, i1 false
  br i1 %or.cond5.i, label %7, label %_ZNK4geos4geom18IntersectionMatrix10isDisjointEv.exit
...
_ZNK4geos4geom18IntersectionMatrix10isDisjointEv.exit: ; preds = %bb.a, %7
  %11 = phi i1 [ true, %bb.a ], [ %10, %7 ]
  ret i1 %11
}
