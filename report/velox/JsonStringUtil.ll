...
begin_hunk_0_@_ZN8facebook5velox20normalizeForJsonCastEPKcmPc:bb.a
  %i.df = getelementptr inbounds nuw i8, ptr %.060, i64 12
  %i.dg = extractelement <4 x i8> %i.db, i64 3
  store i8 %i.dg, ptr %i.cl, align 1, !tbaa !10
  br label %_ZN8facebook5velox12_GLOBAL__N_114encodeUtf16HexEDiRPc.exit, !llvm.loop !11

bb.x:                                             ; preds = %bb.v
  %i.dh = trunc nuw i32 %i.bi to i16
  %i.di = getelementptr inbounds nuw i8, ptr %.060, i64 1
  store i8 92, ptr %.060, align 1, !tbaa !10
  %i.dj = getelementptr inbounds nuw i8, ptr %.060, i64 2
  store i8 117, ptr %i.di, align 1, !tbaa !10
  %i.dk = lshr i16 %i.dh, 12
  %i.dl = trunc nuw nsw i16 %i.dk to i8
  %i.dm = icmp samesign ult i32 %i.bi, 40960
...
bb.b:                                             ; preds = %_ZN8facebook5velox12_GLOBAL__N_112compareCharsERKSt17basic_string_viewIcSt11char_traitsIcEES7_RmS8_.exit, %bb.a
  %i.h = phi i64 [ %i.al, %_ZN8facebook5velox12_GLOBAL__N_112compareCharsERKSt17basic_string_viewIcSt11char_traitsIcEES7_RmS8_.exit ], [ 0, %bb.a ] ; 5 uses
  %i.i = phi i64 [ %i.am, %_ZN8facebook5velox12_GLOBAL__N_112compareCharsERKSt17basic_string_viewIcSt11char_traitsIcEES7_RmS8_.exit ], [ 0, %bb.a ] ; 3 uses
  %i.j = icmp uge i64 %i.i, %.sroa.speculated
  %i.k = icmp uge i64 %i.h, %.sroa.speculated
  %.not16 = select i1 %i.j, i1 true, i1 %i.k      ; 2 uses
  br i1 %.not16, label %.split.loop.exit, label %bb.c

bb.c:                                             ; preds = %bb.b
  %.val = load i64, ptr %0, align 8               ; 2 uses
  %.val17 = load ptr, ptr %i.g, align 8, !tbaa !18 ; 3 uses
  %i.l = getelementptr inbounds nuw i8, ptr %.val17, i64 %i.i ; 2 uses
...
bb.f:                                             ; preds = %bb.c
  ...
  %.phi.trans.insert2.i = getelementptr inbounds nuw i8, ptr %.pre1.i, i64 %i.h
...
_ZN8facebook5velox12_GLOBAL__N_112compareCharsERKSt17basic_string_viewIcSt11char_traitsIcEES7_RmS8_.exit: ; preds = %bb.e, %bb.i
  %i.al = phi i64 [ %.pre30, %bb.e ], [ %i.aj, %bb.i ]
  %i.am = phi i64 [ %.pre, %bb.e ], [ %i.ai, %bb.i ]
  %.033.i = phi i32 [ %i.s, %bb.e ], [ %i.ak, %bb.i ] ; 2 uses
