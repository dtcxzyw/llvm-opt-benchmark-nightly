...
bb.o:                                             ; preds = %bb.n
  %3 = getelementptr inbounds nuw i8, ptr %.060, i64 1
...
begin_hunk_2_@_ZN8facebook5velox20normalizeForJsonCastEPKcmPc:bb.a
  ...
  %4 = getelementptr inbounds nuw i8, ptr %.060, i64 2 ; 2 uses
...
bb.r:                                             ; preds = %bb.p
  ...
  store i8 48, ptr %4, align 1, !tbaa !10
...
bb.b:                                             ; preds = %.lr.ph, %.backedge
  ...
  %.0104116 = phi ptr [ %2, %.lr.ph ], [ %.0104.be, %.backedge ] ; 43 uses
...
begin_hunk_6_@_ZN8facebook5velox21normalizeForJsonParseEPKcmPc:bb.a
  ...
  %5 = getelementptr inbounds nuw i8, ptr %.0104116, i64 6
...
begin_hunk_7_@_ZN8facebook5velox21normalizeForJsonParseEPKcmPc:bb.a
  ...
  %6 = getelementptr inbounds nuw i8, ptr %.0104116, i64 12
...
begin_hunk_8_@_ZN8facebook5velox21normalizeForJsonParseEPKcmPc:bb.a
  ...
  %7 = getelementptr inbounds nuw i8, ptr %.0104116, i64 6
...
_ZN8facebook5velox12_GLOBAL__N_114encodeUtf16HexEDiRPc.exit.a: ; preds = %bb.ad, %bb.af, %bb.ag, %bb.ah, %bb.ab, %bb.aa
  %.sink133 = phi i64 [ %i.fq, %bb.ah ], [ 2, %bb.aa ], [ 3, %bb.ab ], [ 4, %bb.ag ], [ 4, %bb.af ], [ 4, %bb.ad ]
  %.4 = phi ptr [ %i.fp, %bb.ah ], [ %i.ch, %bb.aa ], [ %i.ci, %bb.ab ], [ %7, %bb.ag ], [ %6, %bb.af ], [ %5, %bb.ad ]
