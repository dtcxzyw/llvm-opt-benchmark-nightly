...
bb.d:                                             ; preds = %bb.b
  ...
  %8 = insertelement <4 x double> %i.x, double %7, i64 2
  %9 = insertelement <4 x double> %8, double %6, i64 3
  ...
  %i.aa = fmul <4 x double> %9, %i.z              ; 2 uses
