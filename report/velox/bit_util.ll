...
bb.b:                                             ; preds = %bb.a
  ...
  %i.f = srem i64 %1, 8
  %4 = trunc nsw i64 %i.f to i8
  %notmask = shl nsw i8 -1, %4                    ; 2 uses
  %5 = xor i8 %notmask, -1                        ; 2 uses
...
bb.d:                                             ; preds = %bb.b
  ...
  %i.p = and i8 %i.o, %5
  %i.q = select i1 %3, i8 %notmask, i8 0
  %i.r = or i8 %i.p, %i.q
...
bb.d:                                             ; preds = %_ZN5arrow8bit_util7RoundUpEll.exit.i
  ...
  %i.k = ashr exact i64 %sext36.i, 32             ; 2 uses
  %i.l = getelementptr inbounds i8, ptr @_ZN5arrow8bit_utilL17kPrecedingBitmaskE, i64 %i.k
  %3 = trunc i64 %i.k to i8
  %notmask39.i = shl nsw i8 -1, %3
  %i.m = getelementptr i8, ptr %i.l, i64 %2
  %i.n = load i8, ptr %i.m, align 1, !tbaa !8
  %4 = xor i8 %notmask39.i, %i.n
  %i.o = xor i8 %4, -1
  %i.p = sdiv i64 %1, 8
