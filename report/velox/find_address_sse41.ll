...
bb.d:                                             ; preds = %.lr.ph
  ...
  br i1 %i.bn, label %.lr.ph, label %._crit_edge, !llvm.loop !9
...
bb.f:                                             ; preds = %._crit_edge
  ...
  %i.ca = load <2 x i64>, ptr %i.bz, align 16, !tbaa !8
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.db = load <2 x i64>, ptr %i.da, align 16, !tbaa !8
  %i.dc = getelementptr inbounds nuw i8, ptr %i.da, i64 16
  %i.dd = load <2 x i64>, ptr %i.dc, align 16, !tbaa !8
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.ds = load <2 x i64>, ptr %i.dr, align 16, !tbaa !8
