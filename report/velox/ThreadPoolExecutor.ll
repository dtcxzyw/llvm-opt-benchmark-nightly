...
bb.e:                                             ; preds = %bb.d
  %i.p = invoke noalias noundef nonnull dereferenceable(80) ptr @_Znwm(i64 noundef 80) #39
          to label %bb.f unwind label %bb.n       ; 8 uses
...
_ZNSt10unique_ptrIN5folly18ThreadPoolExecutor4Task10ExpirationESt14default_deleteIS3_EED2Ev.exit.thread: ; preds = %bb.f
  ...
  %5 = getelementptr inbounds nuw i8, ptr %i.p, i64 72
...
_ZNSt10unique_ptrIN5folly18ThreadPoolExecutor4Task10ExpirationESt14default_deleteIS3_EED2Ev.exit: ; preds = %bb.g, %bb.h
  ...
  %.pre = load ptr, ptr %i.k, align 8, !tbaa !7608 ; 6 uses
  ...
  %6 = getelementptr inbounds nuw i8, ptr %.pre, i64 16 ; 3 uses
  %i.y = getelementptr inbounds nuw i8, ptr %.pre, i64 72 ; 2 uses
...
bb.i:                                             ; preds = %_ZNSt10unique_ptrIN5folly18ThreadPoolExecutor4Task10ExpirationESt14default_deleteIS3_EED2Ev.exit
  %i.z = tail call noundef i64 %.pre18(i32 noundef 1, ptr noundef nonnull align 16 dereferenceable(64) %6, ptr noundef null) #13, !inline_history !7610 ; 0 uses
  br label %_ZNK5folly8FunctionIFvvEE4execENS_6detail8function2OpEPNS4_4DataES7_.exit.i
...
_ZNK5folly8FunctionIFvvEE4execENS_6detail8function2OpEPNS4_4DataES7_.exit.i: ; preds = %_ZNSt10unique_ptrIN5folly18ThreadPoolExecutor4Task10ExpirationESt14default_deleteIS3_EED2Ev.exit.thread, %bb.i, %_ZNSt10unique_ptrIN5folly18ThreadPoolExecutor4Task10ExpirationESt14default_deleteIS3_EED2Ev.exit
  %i.aa = phi ptr [ %5, %_ZNSt10unique_ptrIN5folly18ThreadPoolExecutor4Task10ExpirationESt14default_deleteIS3_EED2Ev.exit.thread ], [ %i.y, %bb.i ], [ %i.y, %_ZNSt10unique_ptrIN5folly18ThreadPoolExecutor4Task10ExpirationESt14default_deleteIS3_EED2Ev.exit ]
  %i.ab = phi ptr [ %i.t, %_ZNSt10unique_ptrIN5folly18ThreadPoolExecutor4Task10ExpirationESt14default_deleteIS3_EED2Ev.exit.thread ], [ %6, %bb.i ], [ %6, %_ZNSt10unique_ptrIN5folly18ThreadPoolExecutor4Task10ExpirationESt14default_deleteIS3_EED2Ev.exit ] ; 2 uses
  %7 = phi ptr [ %i.p, %_ZNSt10unique_ptrIN5folly18ThreadPoolExecutor4Task10ExpirationESt14default_deleteIS3_EED2Ev.exit.thread ], [ %.pre, %bb.i ], [ %.pre, %_ZNSt10unique_ptrIN5folly18ThreadPoolExecutor4Task10ExpirationESt14default_deleteIS3_EED2Ev.exit ]
  %.not.i11 = icmp eq ptr %i.ab, %3
...
bb.k:                                             ; preds = %bb.j
  %i.ae = tail call noundef i64 %i.ad(i32 noundef 0, ptr noundef nonnull align 16 dereferenceable(64) %3, ptr noundef nonnull align 16 dereferenceable(64) %i.ab) #13, !inline_history !7610 ; 0 uses
...
_ZNK5folly8FunctionIFvvEE4execENS_6detail8function2OpEPNS4_4DataES7_.exit11.i: ; preds = %bb.k, %bb.j
  ...
  store ptr %i.af, ptr %i.aa, align 8, !tbaa !7588
