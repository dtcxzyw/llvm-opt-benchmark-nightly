...
bb.e:                                             ; preds = %.backedge, %bb.d
  ...
  %i.au = sub nsw i64 %.086, %.082                ; 16 uses
...
.lr.ph109.preheader.a:                            ; preds = %bb.g
  %i.bc = getelementptr i8, ptr %.058, i64 %.082  ; 7 uses
...
begin_hunk_2_@_ZNSt3_V28__rotateIPcEET_S2_S2_S2_St26random_access_iterator_tag:bb.a
  ...
  br i1 %found.conflict, label %.lr.ph109.preheader239, label %vector.main.loop.iter.check

vector.main.loop.iter.check:                      ; preds = %vector.memcheck
  %min.iters.check136 = icmp ult i64 %i.au, 64
  br i1 %min.iters.check136, label %vec.epilog.ph, label %vector.ph

vector.ph:                                        ; preds = %vector.main.loop.iter.check
  %n.mod.vf = and i64 %i.au, 56
  %n.vec = and i64 %i.au, 9223372036854775744     ; 6 uses
...
begin_hunk_3_@_ZNSt3_V28__rotateIPcEET_S2_S2_S2_St26random_access_iterator_tag:bb.a
  ...
  br i1 %i.bh, label %middle.block, label %vector.body, !llvm.loop !160
...
vec.epilog.iter.check:                            ; preds = %middle.block
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph109.preheader239, label %vec.epilog.ph, !prof !161

vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  %vec.epilog.resume.val = phi i64 [ %n.vec, %vec.epilog.iter.check ], [ 0, %vector.main.loop.iter.check ]
  %n.vec143 = and i64 %i.au, 9223372036854775800  ; 5 uses
  %3 = getelementptr i8, ptr %i.bc, i64 %n.vec143
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %next.gep145 = getelementptr i8, ptr %i.bc, i64 %index144 ; 2 uses
  %next.gep146 = getelementptr i8, ptr %.058, i64 %index144 ; 2 uses
  %wide.load147 = load <8 x i8>, ptr %next.gep146, align 1, !tbaa !12, !alias.scope !155, !noalias !158
  %wide.load148 = load <8 x i8>, ptr %next.gep145, align 1, !tbaa !12, !alias.scope !158
  store <8 x i8> %wide.load148, ptr %next.gep146, align 1, !tbaa !12, !alias.scope !155, !noalias !158
  store <8 x i8> %wide.load147, ptr %next.gep145, align 1, !tbaa !12, !alias.scope !158
  %index.next149 = add nuw i64 %index144, 8       ; 2 uses
  %5 = icmp eq i64 %index.next149, %n.vec143
  br i1 %5, label %middle.block.a, label %vec.epilog.vector.body, !llvm.loop !162

middle.block.a:                                   ; preds = %vec.epilog.vector.body
  %cmp.n.a = icmp eq i64 %i.au, %n.vec143
  br i1 %cmp.n.a, label %._crit_edge110, label %.lr.ph109.preheader239

.lr.ph109.preheader239:                           ; preds = %vector.memcheck, %.lr.ph109.preheader.a, %vec.epilog.iter.check, %middle.block.a
  %.054107.ph = phi i64 [ 0, %.lr.ph109.preheader.a ], [ 0, %vector.memcheck ], [ %n.vec, %vec.epilog.iter.check ], [ %n.vec143, %middle.block.a ] ; 3 uses
  %.055106.ph = phi ptr [ %i.bc, %.lr.ph109.preheader.a ], [ %i.bc, %vector.memcheck ], [ %i.bd, %vec.epilog.iter.check ], [ %3, %middle.block.a ] ; 2 uses
  %.159105.ph = phi ptr [ %.058, %.lr.ph109.preheader.a ], [ %.058, %vector.memcheck ], [ %i.be, %vec.epilog.iter.check ], [ %4, %middle.block.a ] ; 2 uses
...
begin_hunk_4_@_ZNSt3_V28__rotateIPcEET_S2_S2_S2_St26random_access_iterator_tag:bb.a
  ...
  br i1 %prol.iter248.cmp.not, label %.lr.ph109.prol.loopexit, label %.lr.ph109.prol, !llvm.loop !163
...
._crit_edge110:                                   ; preds = %.lr.ph109.prol.loopexit, %.lr.ph109, %middle.block, %middle.block.a, %bb.g
  %.159.lcssa = phi ptr [ %.058, %bb.g ], [ %4, %middle.block.a ], [ %i.be, %middle.block ], [ %.lcssa.unr, %.lr.ph109.prol.loopexit ], [ %i.cg, %.lr.ph109 ]
...
begin_hunk_7_@_ZNSt3_V28__rotateIPcEET_S2_S2_S2_St26random_access_iterator_tag:bb.a
  ...
  %wide.load158 = load <32 x i8>, ptr %i.da, align 1, !tbaa !12, !alias.scope !165, !noalias !168
  %wide.load159 = load <32 x i8>, ptr %i.db, align 1, !tbaa !12, !alias.scope !165, !noalias !168
  %i.dc = getelementptr inbounds i8, ptr %next.gep155, i64 -32 ; 2 uses
  %i.dd = getelementptr inbounds i8, ptr %next.gep155, i64 -64 ; 2 uses
  %wide.load161 = load <32 x i8>, ptr %i.dc, align 1, !tbaa !12, !alias.scope !168
  %wide.load162 = load <32 x i8>, ptr %i.dd, align 1, !tbaa !12, !alias.scope !168
  store <32 x i8> %wide.load161, ptr %i.da, align 1, !tbaa !12, !alias.scope !165, !noalias !168
  store <32 x i8> %wide.load162, ptr %i.db, align 1, !tbaa !12, !alias.scope !165, !noalias !168
  store <32 x i8> %wide.load158, ptr %i.dc, align 1, !tbaa !12, !alias.scope !168
  store <32 x i8> %wide.load159, ptr %i.dd, align 1, !tbaa !12, !alias.scope !168
  %index.next169 = add nuw i64 %index154, 64      ; 2 uses
  %i.de = icmp eq i64 %index.next169, %n.vec152
  br i1 %i.de, label %middle.block170, label %vector.body153, !llvm.loop !170
...
vec.epilog.iter.check.a:                          ; preds = %middle.block170
  ...
  br i1 %min.epilog.iters.check.a, label %.lr.ph.preheader, label %vec.epilog.ph.a, !prof !161
...
begin_hunk_9_@_ZNSt3_V28__rotateIPcEET_S2_S2_S2_St26random_access_iterator_tag:bb.a
  ...
  %wide.load179 = load <8 x i8>, ptr %i.dl, align 1, !tbaa !12, !alias.scope !165, !noalias !168
  %i.dm = getelementptr inbounds i8, ptr %next.gep177, i64 -8 ; 2 uses
  %wide.load181 = load <8 x i8>, ptr %i.dm, align 1, !tbaa !12, !alias.scope !168
  store <8 x i8> %wide.load181, ptr %i.dl, align 1, !tbaa !12, !alias.scope !165, !noalias !168
  store <8 x i8> %wide.load179, ptr %i.dm, align 1, !tbaa !12, !alias.scope !168
  %index.next185 = add nuw i64 %index176, 8       ; 2 uses
  %i.dn = icmp eq i64 %index.next185, %n.vec175
  br i1 %i.dn, label %vec.epilog.middle.block, label %vec.epilog.vector.body.a, !llvm.loop !171
...
begin_hunk_14_@_ZN4absl12lts_2024011619str_format_internal12_GLOBAL__N_113FloatToBufferILNS2_11FormatStyleE1EdEEbNS2_10DecomposedIT0_EEmPNS2_6BufferEPi:bb.a
  ...
  br i1 %.not58.i.3, label %_ZN4absl12lts_2024011619str_format_internal12_GLOBAL__N_117FloatToBufferImplIodLNS2_11FormatStyleE1EEEbT_imPNS2_6BufferEPi.exit, label %.lr.ph104.i, !llvm.loop !176
...
begin_hunk_18_@_ZN4absl12lts_2024011619str_format_internal12_GLOBAL__N_113FloatToBufferILNS2_11FormatStyleE1EdEEbNS2_10DecomposedIT0_EEmPNS2_6BufferEPi:bb.a
  ...
  br i1 %.not58.i59.3, label %_ZN4absl12lts_2024011619str_format_internal12_GLOBAL__N_117FloatToBufferImplIodLNS2_11FormatStyleE1EEEbT_imPNS2_6BufferEPi.exit, label %.lr.ph104.i57, !llvm.loop !180
...
!161 = !{!"branch_weights", i32 8, i32 56}
!162 = distinct !{!162, !34, !149, !150}
!163 = distinct !{!163, !41}
!164 = distinct !{!164, !34, !149}
!165 = !{!166}
...
!171 = distinct !{!171, !34, !149, !150}
!172 = distinct !{!172, !41}
!173 = distinct !{!173, !34}
!174 = distinct !{!174, !34, !149}
!175 = distinct !{!175, !41}
!176 = distinct !{!176, !34}
!177 = distinct !{!177, !34}
!178 = distinct !{!178, !34}
...
!182 = distinct !{!182, !34}
!183 = !{!184}
!184 = distinct !{!184, !185, !"_ZN4absl12lts_2024011619str_format_internal30FormatConversionSpecImplFriend13FlagsToStringB5cxx11ERKNS1_24FormatConversionSpecImplE: argument 0"}
!185 = distinct !{!185, !"_ZN4absl12lts_2024011619str_format_internal30FormatConversionSpecImplFriend13FlagsToStringB5cxx11ERKNS1_24FormatConversionSpecImplE"}
end_hunk_22
