...
bb.a:
  ...
  %.sroa.057.7.extract.shift = lshr i64 %.sroa.0.0.copyload.i, 56
  %.sroa.057.7.extract.trunc = trunc nuw i64 %.sroa.057.7.extract.shift to i8
  %i.u = getelementptr inbounds nuw i8, ptr %2, i64 7
  %i.v = load i8, ptr %i.u, align 1, !tbaa !19    ; 2 uses
  %5 = and i8 %i.v, %.sroa.057.7.extract.trunc
  ...
  %.sroa.1158.15.extract.shift = lshr i64 %.sroa.3.0.copyload.i, 56
  %.sroa.1158.15.extract.trunc = trunc nuw i64 %.sroa.1158.15.extract.shift to i8
  %i.ar = getelementptr inbounds nuw i8, ptr %2, i64 15
  %i.as = load i8, ptr %i.ar, align 1, !tbaa !19  ; 2 uses
  %6 = and i8 %i.as, %.sroa.1158.15.extract.trunc
  %.sroa.10.15.insert.ext.i = zext i8 %6 to i64
  %.sroa.10.15.insert.shift.i = shl nuw i64 %.sroa.10.15.insert.ext.i, 56
  %.sroa.10.15.insert.insert.i = or i64 %.sroa.10.14.insert.insert.i, %.sroa.10.15.insert.shift.i
  %.sroa.0.sroa.9.0.insert.ext.i = zext i8 %5 to i64
  %.sroa.0.sroa.9.0.insert.shift.i = shl nuw i64 %.sroa.0.sroa.9.0.insert.ext.i, 56
  ...
  %.sroa.0.sroa.8.0.insert.insert.i = or disjoint i64 %.sroa.0.sroa.9.0.insert.shift.i, %.sroa.0.sroa.8.0.insert.shift.i
  ...
  %.sroa.0.sroa.0.0.insert.mask.i = or disjoint i64 %.sroa.0.sroa.3.0.insert.mask.i, %.sroa.0.sroa.3.0.insert.shift.i
  %.sroa.0.sroa.0.0.insert.insert.i = or i64 %.sroa.0.sroa.0.0.insert.mask.i, %.sroa.0.sroa.0.0.insert.ext.i
  ...
  %.sroa.0.0.extract.trunc = trunc i64 %.sroa.0.0.copyload.i6 to i8
  %7 = and i8 %i.a, %.sroa.0.0.extract.trunc
  %.sroa.0.1.extract.shift = lshr i64 %.sroa.0.0.copyload.i6, 8
  %.sroa.0.1.extract.trunc.a = trunc i64 %.sroa.0.1.extract.shift to i8
  %i.au = and i8 %i.d, %.sroa.0.1.extract.trunc.a
  %.sroa.0.2.extract.shift.a = lshr i64 %.sroa.0.0.copyload.i6, 16
  %.sroa.0.2.extract.trunc.a = trunc i64 %.sroa.0.2.extract.shift.a to i8
  %i.av = and i8 %i.g, %.sroa.0.2.extract.trunc.a
  %.sroa.0.3.extract.shift.a = lshr i64 %.sroa.0.0.copyload.i6, 24
  %.sroa.0.3.extract.trunc.a = trunc i64 %.sroa.0.3.extract.shift.a to i8
  %i.aw = and i8 %i.j, %.sroa.0.3.extract.trunc.a
  %.sroa.0.4.extract.shift.a = lshr i64 %.sroa.0.0.copyload.i6, 32
  %.sroa.0.4.extract.trunc.a = trunc i64 %.sroa.0.4.extract.shift.a to i8
  %i.ax = and i8 %i.m, %.sroa.0.4.extract.trunc.a
  %.sroa.0.5.extract.shift.a = lshr i64 %.sroa.0.0.copyload.i6, 40
  %.sroa.0.5.extract.trunc.a = trunc i64 %.sroa.0.5.extract.shift.a to i8
  %i.ay = and i8 %i.p, %.sroa.0.5.extract.trunc.a
  %.sroa.0.6.extract.shift.a = lshr i64 %.sroa.0.0.copyload.i6, 48
  %.sroa.0.6.extract.trunc.a = trunc i64 %.sroa.0.6.extract.shift.a to i8
  %i.az = and i8 %i.s, %.sroa.0.6.extract.trunc.a
  %.sroa.0.7.extract.shift = lshr i64 %.sroa.0.0.copyload.i6, 56
  %.sroa.0.7.extract.trunc = trunc nuw i64 %.sroa.0.7.extract.shift to i8
  %i.ba = and i8 %i.v, %.sroa.0.7.extract.trunc
  ...
  %.sroa.11.15.extract.shift = lshr i64 %.sroa.3.0.copyload.i8, 56
  %.sroa.11.15.extract.trunc = trunc nuw i64 %.sroa.11.15.extract.shift to i8
  %8 = and i8 %i.as, %.sroa.11.15.extract.trunc
  %.sroa.10.15.insert.ext.i30 = zext i8 %8 to i64
  %.sroa.10.15.insert.shift.i31 = shl nuw i64 %.sroa.10.15.insert.ext.i30, 56
  %.sroa.10.14.insert.insert.i29 = or disjoint i64 %.sroa.10.15.insert.shift.i31, %.sroa.10.14.insert.shift.i27
  %.sroa.10.15.insert.insert.i32 = or i64 %.sroa.10.14.insert.insert.i29, %.sroa.10.14.insert.mask.i28
  %.sroa.0.sroa.9.0.insert.ext.i33 = zext i8 %i.ba to i64
  %.sroa.0.sroa.9.0.insert.shift.i34 = shl nuw i64 %.sroa.0.sroa.9.0.insert.ext.i33, 56
  %.sroa.0.sroa.8.0.insert.ext.i35 = zext i8 %i.az to i64
  %.sroa.0.sroa.8.0.insert.shift.i36 = shl nuw nsw i64 %.sroa.0.sroa.8.0.insert.ext.i35, 48
  %.sroa.0.sroa.8.0.insert.insert.i37 = or disjoint i64 %.sroa.0.sroa.9.0.insert.shift.i34, %.sroa.0.sroa.8.0.insert.shift.i36
  %.sroa.0.sroa.7.0.insert.ext.i38 = zext i8 %i.ay to i64
  ...
  %.sroa.0.sroa.6.0.insert.ext.i41 = zext i8 %i.ax to i64
  ...
  %.sroa.0.sroa.5.0.insert.ext.i44 = zext i8 %i.aw to i64
  ...
  %.sroa.0.sroa.4.0.insert.ext.i47 = zext i8 %i.av to i64
  %.sroa.0.sroa.4.0.insert.shift.i48 = shl nuw nsw i64 %.sroa.0.sroa.4.0.insert.ext.i47, 16
  %.sroa.0.sroa.3.0.insert.ext.i49 = zext i8 %i.au to i64
  ...
  %.sroa.0.sroa.0.0.insert.ext.i52 = zext i8 %7 to i64
  %.sroa.0.sroa.0.0.insert.mask.i53 = or disjoint i64 %.sroa.0.sroa.3.0.insert.mask.i51, %.sroa.0.sroa.3.0.insert.shift.i50
  %.sroa.0.sroa.0.0.insert.insert.i54 = or i64 %.sroa.0.sroa.0.0.insert.mask.i53, %.sroa.0.sroa.0.0.insert.ext.i52
...
bb.a:
  ...
  %5 = alloca %"struct.std::array", align 16      ; 4 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.q = select i1 %i.p, i64 %i.o, i64 -1         ; 2 uses
  %i.r = select i1 %i.p, i64 0, i64 %i.o          ; 2 uses
  %6 = insertelement <2 x i64> poison, i64 %i.q, i64 0
  %7 = insertelement <2 x i64> %6, i64 %i.r, i64 1
  br label %_ZN5folly11IPAddressV69fetchMaskEm.exit

_ZN5folly11IPAddressV69fetchMaskEm.exit:          ; preds = %bb.g, %bb.h
  %.sroa.4.0.i = phi i64 [ %i.r, %bb.h ], [ 0, %bb.g ] ; 2 uses
  %.sroa.0.sroa.0.0.insert.insert.i = phi i64 [ %i.q, %bb.h ], [ 0, %bb.g ] ; 2 uses
  %8 = phi <2 x i64> [ %7, %bb.h ], [ zeroinitializer, %bb.g ] ; 6 uses
  %.sroa.0.0.extract.trunc.a = trunc i64 %.sroa.0.sroa.0.0.insert.insert.i to i8
  %i.s = load i8, ptr %1, align 4, !tbaa !19
  %i.t = and i8 %i.s, %.sroa.0.0.extract.trunc.a
  %9 = lshr <2 x i64> %8, <i64 8, i64 48>
  %i.u = getelementptr inbounds nuw i8, ptr %1, i64 1
  %10 = lshr <2 x i64> %8, <i64 16, i64 40>
  %11 = lshr <2 x i64> %8, <i64 24, i64 32>
  %i.v = getelementptr inbounds nuw i8, ptr %1, i64 3
  %12 = lshr <2 x i64> %8, <i64 32, i64 24>
  %13 = lshr <2 x i64> %8, <i64 40, i64 16>
  %i.w = getelementptr inbounds nuw i8, ptr %1, i64 5
  %i.x = load i8, ptr %i.w, align 1, !tbaa !19
  %.sroa.0.6.extract.shift.a = lshr i64 %.sroa.0.sroa.0.0.insert.insert.i, 48
  %.sroa.0.6.extract.trunc.a = trunc i64 %.sroa.0.6.extract.shift.a to i8
  %i.y = getelementptr inbounds nuw i8, ptr %1, i64 6
  %i.z = load i8, ptr %i.y, align 2, !tbaa !19
  %i.aa = and i8 %i.z, %.sroa.0.6.extract.trunc.a
  %14 = lshr <2 x i64> %8, <i64 56, i64 8>
  ...
  %.sroa.11.15.extract.shift = lshr i64 %.sroa.4.0.i, 56
  %.sroa.11.15.extract.trunc = trunc nuw i64 %.sroa.11.15.extract.shift to i8
  ...
  %.sroa.10.15.insert.shift.i = shl nuw i64 %.sroa.10.15.insert.ext.i, 56
  %.sroa.0.sroa.8.0.insert.ext.i.a = zext i8 %i.aa to i64
  %.sroa.0.sroa.8.0.insert.shift.i.a = shl nuw nsw i64 %.sroa.0.sroa.8.0.insert.ext.i.a, 48
  %.sroa.0.sroa.0.0.insert.ext.i = zext i8 %i.t to i64
  %16 = load <2 x i8>, ptr %i.u, align 1, !tbaa !19 ; 2 uses
  %17 = load <2 x i8>, ptr %i.v, align 1, !tbaa !19 ; 2 uses
  %18 = trunc <2 x i64> %14 to <2 x i8>
  %19 = load <2 x i8>, ptr %i.ag, align 1, !tbaa !19 ; 2 uses
  %20 = shufflevector <2 x i8> %19, <2 x i8> poison, <2 x i32> <i32 poison, i32 0>
  %21 = insertelement <2 x i8> %20, i8 %i.ac, i64 0
  %22 = and <2 x i8> %21, %18
  %23 = trunc <2 x i64> %13 to <2 x i8>
  %24 = insertelement <2 x i8> %19, i8 %i.x, i64 0
  %25 = and <2 x i8> %24, %23
  %26 = trunc <2 x i64> %12 to <2 x i8>
  %27 = load <2 x i8>, ptr %i.ah, align 1, !tbaa !19 ; 2 uses
  %28 = shufflevector <2 x i8> %17, <2 x i8> %27, <2 x i32> <i32 1, i32 2>
  %29 = and <2 x i8> %28, %26
  %30 = trunc <2 x i64> %11 to <2 x i8>
  %31 = shufflevector <2 x i8> %17, <2 x i8> %27, <2 x i32> <i32 0, i32 3>
  %32 = and <2 x i8> %31, %30
  %33 = trunc <2 x i64> %10 to <2 x i8>
  %34 = load <2 x i8>, ptr %15, align 1, !tbaa !19 ; 2 uses
  %35 = shufflevector <2 x i8> %16, <2 x i8> %34, <2 x i32> <i32 1, i32 2>
  %36 = and <2 x i8> %35, %33
  %37 = trunc <2 x i64> %9 to <2 x i8>
  %38 = shufflevector <2 x i8> %16, <2 x i8> %34, <2 x i32> <i32 0, i32 3>
  %39 = and <2 x i8> %38, %37
  %40 = zext <2 x i8> %22 to <2 x i64>
  %41 = shl nuw <2 x i64> %40, <i64 56, i64 8>
  %42 = insertelement <2 x i64> poison, i64 %.sroa.0.sroa.8.0.insert.shift.i.a, i64 0
  %43 = insertelement <2 x i64> %42, i64 %.sroa.10.8.insert.ext.i, i64 1
  %44 = or disjoint <2 x i64> %41, %43
  %45 = zext <2 x i8> %25 to <2 x i64>
  %46 = shl nuw nsw <2 x i64> %45, <i64 40, i64 16>
  %47 = or disjoint <2 x i64> %44, %46
  %48 = zext <2 x i8> %29 to <2 x i64>
  %49 = shl nuw nsw <2 x i64> %48, <i64 32, i64 24>
  %50 = or disjoint <2 x i64> %47, %49
  %51 = zext <2 x i8> %32 to <2 x i64>
  %52 = shl nuw nsw <2 x i64> %51, <i64 24, i64 32>
  %53 = or disjoint <2 x i64> %50, %52
  %54 = zext <2 x i8> %36 to <2 x i64>
  %55 = shl nuw nsw <2 x i64> %54, <i64 16, i64 40>
  %56 = zext <2 x i8> %39 to <2 x i64>
  %57 = shl nuw nsw <2 x i64> %56, <i64 8, i64 48>
  %58 = or disjoint <2 x i64> %53, %55
  %59 = or <2 x i64> %58, %57
  %60 = insertelement <2 x i64> poison, i64 %.sroa.0.sroa.0.0.insert.ext.i, i64 0
  %61 = insertelement <2 x i64> %60, i64 %.sroa.10.15.insert.shift.i, i64 1
  %62 = or <2 x i64> %59, %61
  store <2 x i64> %62, ptr %5, align 16
