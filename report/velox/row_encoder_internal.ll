...
$_ZN5arrow8internal22ArraySpanInlineVisitorINS_10BinaryTypeEvE9VisitVoidIRZNS_7compute8internal19VarLengthKeyEncoderIS2_E6EncodeERKNS5_9ExecValueElPPhEUlSt17basic_string_viewIcSt11char_traitsIcEEE_RZNS8_6EncodeESB_lSD_EUlvE_EEvRKNS_9ArraySpanEOT_OT0_ = comdat any
...
$_ZN5arrow8internal22ArraySpanInlineVisitorINS_15LargeBinaryTypeEvE9VisitVoidIRZNS_7compute8internal19VarLengthKeyEncoderIS2_E6EncodeERKNS5_9ExecValueElPPhEUlSt17basic_string_viewIcSt11char_traitsIcEEE_RZNS8_6EncodeESB_lSD_EUlvE_EEvRKNS_9ArraySpanEOT_OT0_ = comdat any
...
define void @_ZN5arrow7compute8internal10KeyEncoder11DecodeNullsEPNS_10MemoryPoolEiPPhPSt10shared_ptrINS_6BufferEEPi(ptr dead_on_unwind noalias writable sret(%"class.arrow::Status") align 8 %0, ptr noundef %1, i32 noundef %2, ptr noundef captures(none) %3, ptr noundef captures(none) %4, ptr noundef writeonly captures(none) initializes((0, 4)) %5) local_unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
...
.epil.preheader:                                  ; preds = %._crit_edge.unr-lcssa, %.lr.ph
  ...
  %.epil.init = phi i32 [ 0, %.lr.ph ], [ %i.aa, %._crit_edge.unr-lcssa ]
  %lcmp.mod79 = trunc i32 %2 to i1
  tail call void @llvm.assume(i1 %lcmp.mod79)
  %i.c = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %indvars.iv.epil.init
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !7
  %i.e = load i8, ptr %i.d, align 1, !tbaa !10
  %i.f = icmp eq i8 %i.e, 1
  %i.g = zext i1 %i.f to i32
  %i.h = add nuw nsw i32 %.epil.init, %i.g        ; 2 uses
  store i32 %i.h, ptr %5, align 4, !tbaa !3
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.unr-lcssa, %.epil.preheader
  %.lcssa = phi i32 [ %i.aa, %._crit_edge.unr-lcssa ], [ %i.h, %.epil.preheader ]
  %.not = icmp eq i32 %.lcssa, 0
  br i1 %.not, label %.lr.ph52.preheader, label %bb.c

.lr.ph52.preheader:                               ; preds = %._crit_edge
  %wide.trip.count67 = zext nneg i32 %2 to i64
  %min.iters.check = icmp ult i32 %2, 4
  br i1 %min.iters.check, label %.lr.ph52.preheader77, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.i = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %index ; 3 uses
  %i.j = getelementptr inbounds nuw i8, ptr %i.i, i64 16 ; 2 uses
  %wide.load = load <2 x ptr>, ptr %i.i, align 8, !tbaa !7
  %wide.load76 = load <2 x ptr>, ptr %i.j, align 8, !tbaa !7
  %i.k = getelementptr inbounds nuw i8, <2 x ptr> %wide.load, i64 1
  %i.l = getelementptr inbounds nuw i8, <2 x ptr> %wide.load76, i64 1
  store <2 x ptr> %i.k, ptr %i.i, align 8, !tbaa !7
  store <2 x ptr> %i.l, ptr %i.j, align 8, !tbaa !7
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.m = icmp eq i64 %index.next, %n.vec
  br i1 %i.m, label %middle.block, label %vector.body, !llvm.loop !11

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %n.vec, %wide.trip.count
  br i1 %cmp.n, label %.loopexit, label %.lr.ph52.preheader77

.lr.ph52.preheader77:                             ; preds = %.lr.ph52.preheader, %middle.block
  %indvars.iv64.ph = phi i64 [ 0, %.lr.ph52.preheader ], [ %n.vec, %middle.block ]
  br label %.lr.ph52

bb.b:                                             ; preds = %bb.b, %.lr.ph.new
  %indvars.iv = phi i64 [ 0, %.lr.ph.new ], [ %indvars.iv.next.1, %bb.b ] ; 3 uses
  %i.n = phi i32 [ 0, %.lr.ph.new ], [ %i.aa, %bb.b ]
  ...
  %i.t = add nuw nsw i32 %i.n, %i.s               ; 2 uses
  store i32 %i.t, ptr %5, align 4, !tbaa !3
  ...
  %i.aa = add nuw nsw i32 %i.t, %i.z              ; 4 uses
  store i32 %i.aa, ptr %5, align 4, !tbaa !3
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2 ; 2 uses
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge.unr-lcssa, label %bb.b, !llvm.loop !15

bb.c:                                             ; preds = %._crit_edge
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #22
  %i.ab = zext nneg i32 %2 to i64
  call void @_ZN5arrow14AllocateBitmapElPNS_10MemoryPoolE(ptr dead_on_unwind nonnull writable sret(%"class.arrow::Result") align 8 %6, i64 noundef %i.ab, ptr noundef %1)
  %i.ac = load ptr, ptr %6, align 8, !tbaa !16
  %i.ad = icmp eq ptr %i.ac, null                 ; 2 uses
  br i1 %i.ad, label %bb.f, label %bb.d, !prof !19
...
bb.d:                                             ; preds = %bb.c
  invoke void @_ZN5arrow6StatusC2ERKS0_(ptr noundef nonnull align 8 dereferenceable(8) %0, ptr noundef nonnull align 8 dereferenceable(8) %6)
          to label %_ZN5arrow8internal21FirstTimeBitmapWriter6FinishEv.exit unwind label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.ae = landingpad { ptr, i32 }
          cleanup
  call void @_ZN5arrow6ResultISt10shared_ptrINS_6BufferEEED2Ev(ptr noundef nonnull align 8 dereferenceable(24) %6) #22
...
bb.f:                                             ; preds = %bb.c
  ...
  %i.ah = load <2 x ptr>, ptr %i.af, align 8, !tbaa !20, !noalias !21
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.af, i8 0, i64 16, i1 false)
  %i.ai = load ptr, ptr %i.ag, align 8, !tbaa !26 ; 8 uses
  store <2 x ptr> %i.ah, ptr %4, align 8, !tbaa !20
  %.not.i.i.i.i = icmp eq ptr %i.ai, null
  br i1 %.not.i.i.i.i, label %.lr.ph58.preheader, label %bb.g
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.ao = load ptr, ptr %i.ai, align 8, !tbaa !32
  %i.ap = getelementptr inbounds nuw i8, ptr %i.ao, i64 16
  %i.aq = load ptr, ptr %i.ap, align 8
  call void %i.aq(ptr noundef nonnull align 8 dereferenceable(16) %i.ai) #22, !inline_history !34
  %i.ar = load ptr, ptr %i.ai, align 8, !tbaa !32
  %i.as = getelementptr inbounds nuw i8, ptr %i.ar, i64 24
  %i.at = load ptr, ptr %i.as, align 8
  call void %i.at(ptr noundef nonnull align 8 dereferenceable(16) %i.ai) #22, !inline_history !34
  br label %.lr.ph58.preheader

bb.i:                                             ; preds = %bb.g
  %i.au = load i8, ptr @__libc_single_threaded, align 1, !tbaa !10
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i: ; preds = %bb.k, %bb.j
  %.0.i.i.i.i.i.i = phi i32 [ %i.am, %bb.j ], [ %i.aw, %bb.k ]
  %i.ax = icmp eq i32 %.0.i.i.i.i.i.i, 1
  br i1 %i.ax, label %bb.l, label %.lr.ph58.preheader, !prof !35
...
.lr.ph58.preheader:                               ; preds = %bb.f, %bb.h, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i, %bb.l
  %i.ay = load ptr, ptr %4, align 8, !tbaa !36
  %i.az = getelementptr inbounds nuw i8, ptr %i.ay, i64 16
  %i.ba = load ptr, ptr %i.az, align 8            ; 2 uses
  %wide.trip.count69 = zext nneg i32 %2 to i64
  br label %.lr.ph58

._crit_edge59:                                    ; preds = %_ZN5arrow8internal21FirstTimeBitmapWriter4NextEv.exit
  %.not75 = icmp eq i8 %.sroa.18.1, 1
  br i1 %.not75, label %_ZN5arrow8internal21FirstTimeBitmapWriter6FinishEv.exit, label %bb.m

bb.m:                                             ; preds = %._crit_edge59
  %i.bb = getelementptr inbounds i8, ptr %i.ba, i64 %.sroa.2446.1
  store i8 %.sroa.11.2, ptr %i.bb, align 1, !tbaa !10
  br label %_ZN5arrow8internal21FirstTimeBitmapWriter6FinishEv.exit

.lr.ph58:                                         ; preds = %.lr.ph58.preheader, %_ZN5arrow8internal21FirstTimeBitmapWriter4NextEv.exit
  %.sroa.5.056 = phi i64 [ %i.bi, %_ZN5arrow8internal21FirstTimeBitmapWriter4NextEv.exit ], [ 0, %.lr.ph58.preheader ] ; 2 uses
  %.sroa.11.055 = phi i8 [ %.sroa.11.2, %_ZN5arrow8internal21FirstTimeBitmapWriter4NextEv.exit ], [ 0, %.lr.ph58.preheader ]
  %.sroa.18.054 = phi i8 [ %.sroa.18.1, %_ZN5arrow8internal21FirstTimeBitmapWriter4NextEv.exit ], [ 1, %.lr.ph58.preheader ] ; 2 uses
  %.sroa.2446.053 = phi i64 [ %.sroa.2446.1, %_ZN5arrow8internal21FirstTimeBitmapWriter4NextEv.exit ], [ 0, %.lr.ph58.preheader ] ; 3 uses
  %i.bc = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %.sroa.5.056 ; 3 uses
  %i.bd = load ptr, ptr %i.bc, align 8, !tbaa !7  ; 2 uses
  %i.be = load i8, ptr %i.bd, align 1, !tbaa !10
  %i.bf = icmp eq i8 %i.be, 0
  %i.bg = select i1 %i.bf, i8 %.sroa.18.054, i8 0
  %spec.select = or i8 %i.bg, %.sroa.11.055       ; 2 uses
  %i.bh = shl i8 %.sroa.18.054, 1                 ; 2 uses
  %i.bi = add nuw nsw i64 %.sroa.5.056, 1         ; 2 uses
  %i.bj = icmp eq i8 %i.bh, 0
  br i1 %i.bj, label %bb.n, label %_ZN5arrow8internal21FirstTimeBitmapWriter4NextEv.exit

bb.n:                                             ; preds = %.lr.ph58
  %i.bk = add nsw i64 %.sroa.2446.053, 1
  %i.bl = getelementptr inbounds i8, ptr %i.ba, i64 %.sroa.2446.053
  store i8 %spec.select, ptr %i.bl, align 1, !tbaa !10
  %.pre = load ptr, ptr %i.bc, align 8, !tbaa !7
  br label %_ZN5arrow8internal21FirstTimeBitmapWriter4NextEv.exit

_ZN5arrow8internal21FirstTimeBitmapWriter4NextEv.exit: ; preds = %.lr.ph58, %bb.n
  %i.bm = phi ptr [ %.pre, %bb.n ], [ %i.bd, %.lr.ph58 ]
  %.sroa.2446.1 = phi i64 [ %i.bk, %bb.n ], [ %.sroa.2446.053, %.lr.ph58 ] ; 2 uses
  %.sroa.18.1 = phi i8 [ 1, %bb.n ], [ %i.bh, %.lr.ph58 ] ; 2 uses
  %.sroa.11.2 = phi i8 [ 0, %bb.n ], [ %spec.select, %.lr.ph58 ] ; 2 uses
  %i.bn = getelementptr inbounds nuw i8, ptr %i.bm, i64 1
  store ptr %i.bn, ptr %i.bc, align 8, !tbaa !7
  %exitcond70.not = icmp eq i64 %i.bi, %wide.trip.count69
  br i1 %exitcond70.not, label %._crit_edge59, label %.lr.ph58, !llvm.loop !39

_ZN5arrow8internal21FirstTimeBitmapWriter6FinishEv.exit: ; preds = %bb.m, %._crit_edge59, %bb.d
  %i.bo = load ptr, ptr %6, align 8, !tbaa !16
  %i.bp = icmp eq ptr %i.bo, null
  br i1 %i.bp, label %bb.o, label %_ZN5arrow6ResultISt10shared_ptrINS_6BufferEEE7DestroyEv.exit.thread.i, !prof !19

bb.o:                                             ; preds = %_ZN5arrow8internal21FirstTimeBitmapWriter6FinishEv.exit
  %i.bq = getelementptr inbounds nuw i8, ptr %6, i64 16
  %i.br = load ptr, ptr %i.bq, align 8, !tbaa !26 ; 8 uses
  %.not.i.i.i.i.i38 = icmp eq ptr %i.br, null
  br i1 %.not.i.i.i.i.i38, label %_ZN5arrow6ResultISt10shared_ptrINS_6BufferEEE7DestroyEv.exit.i, label %bb.p
...
bb.q:                                             ; preds = %bb.p
  store i32 0, ptr %i.bs, align 8, !tbaa !29
  %i.bw = getelementptr inbounds nuw i8, ptr %i.br, i64 12
  store i32 0, ptr %i.bw, align 4, !tbaa !31
  %i.bx = load ptr, ptr %i.br, align 8, !tbaa !32
  %i.by = getelementptr inbounds nuw i8, ptr %i.bx, i64 16
  %i.bz = load ptr, ptr %i.by, align 8
  call void %i.bz(ptr noundef nonnull align 8 dereferenceable(16) %i.br) #22, !inline_history !40
  %i.ca = load ptr, ptr %i.br, align 8, !tbaa !32
  %i.cb = getelementptr inbounds nuw i8, ptr %i.ca, i64 24
  %i.cc = load ptr, ptr %i.cb, align 8
  call void %i.cc(ptr noundef nonnull align 8 dereferenceable(16) %i.br) #22, !inline_history !40
  br label %_ZN5arrow6ResultISt10shared_ptrINS_6BufferEEE7DestroyEv.exit.i

bb.r:                                             ; preds = %bb.p
  %i.cd = load i8, ptr @__libc_single_threaded, align 1, !tbaa !10
  %.not.i.i.i.i.i.i = icmp eq i8 %i.cd, 0
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i: ; preds = %bb.t, %bb.s
  %.0.i.i.i.i.i.i.i = phi i32 [ %i.bv, %bb.s ], [ %i.cf, %bb.t ]
end_hunk_0
