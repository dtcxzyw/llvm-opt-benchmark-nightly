...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2ERKS4_.exit.i: ; preds = %bb.d, %bb.c, %._crit_edge.i.i.i
  %i.q = load i64, ptr %i.a, align 8, !tbaa !58   ; 2 uses
  %i.r = getelementptr inbounds nuw i8, ptr %i.d, i64 16
  store i64 %i.q, ptr %i.r, align 8, !tbaa !57
  %i.s = load ptr, ptr %i.f, align 8, !tbaa !56
  ...
  %i.y = load <2 x ptr>, ptr %i.v, align 8, !tbaa !20
  store <2 x ptr> %i.y, ptr %i.u, align 8, !tbaa !20
...
bb.e:                                             ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2ERKS4_.exit.i
  ...
  %i.aa = load i8, ptr @__libc_single_threaded, align 1, !tbaa !10
...
bb.a:
  ...
  br i1 %i.b, label %bb.b, label %_ZN5arrow6ResultISt10shared_ptrINS_6BufferEEE7DestroyEv.exit.thread, !prof !19
...
bb.d:                                             ; preds = %bb.c
  ...
  store i32 0, ptr %i.i, align 4, !tbaa !31
  %i.j = load ptr, ptr %i.d, align 8, !tbaa !32
  %i.k = getelementptr inbounds nuw i8, ptr %i.j, i64 16
  %i.l = load ptr, ptr %i.k, align 8
  tail call void %i.l(ptr noundef nonnull align 8 dereferenceable(16) %i.d) #22, !inline_history !59
  %i.m = load ptr, ptr %i.d, align 8, !tbaa !32
  %i.n = getelementptr inbounds nuw i8, ptr %i.m, i64 24
  %i.o = load ptr, ptr %i.n, align 8
  tail call void %i.o(ptr noundef nonnull align 8 dereferenceable(16) %i.d) #22, !inline_history !59
  br label %_ZN5arrow6ResultISt10shared_ptrINS_6BufferEEE7DestroyEv.exit

bb.e:                                             ; preds = %bb.c
  %i.p = load i8, ptr @__libc_single_threaded, align 1, !tbaa !10
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i: ; preds = %bb.g, %bb.f
  ...
  br i1 %i.s, label %bb.h, label %_ZN5arrow6ResultISt10shared_ptrINS_6BufferEEE7DestroyEv.exit, !prof !35
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load5 = load <4 x i32>, ptr %i.c, align 4, !tbaa !3
  %i.d = add nsw <4 x i32> %wide.load, splat (i32 2)
  %i.e = add nsw <4 x i32> %wide.load5, splat (i32 2)
  store <4 x i32> %i.d, ptr %i.b, align 4, !tbaa !3
  store <4 x i32> %i.e, ptr %i.c, align 4, !tbaa !3
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.f = icmp eq i64 %index.next, %n.vec
  br i1 %i.f, label %middle.block, label %vector.body, !llvm.loop !60
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.e = load i64, ptr %i.d, align 8, !tbaa !72   ; 3 uses
  ...
  %i.i = load ptr, ptr %i.f, align 8, !tbaa !73   ; 2 uses
  %i.j = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.k = load i64, ptr %i.j, align 8, !tbaa !76   ; 3 uses
...
.lr.ph46.i.i.i:                                   ; preds = %bb.b, %.loopexit.i.i.i
  ...
  %i.m = call i32 @_ZN5arrow8internal23OptionalBitBlockCounter9NextBlockEv(ptr noundef nonnull align 8 dereferenceable(48) %5) ; 5 uses
  %.sroa.0.0.extract.trunc.i.i.i = trunc i32 %i.m to i16 ; 7 uses
...
.preheader.i.i.i:                                 ; preds = %.lr.ph46.i.i.i
  %.sroa.0.0.extract.trunc.mask71.i.i.i = and i32 %i.m, 65535
  %6 = zext nneg i32 %.sroa.0.0.extract.trunc.mask71.i.i.i to i64
...
.lr.ph39.i.i.i:                                   ; preds = %.lr.ph39.i.i.i, %.lr.ph39.i.i.i.preheader.new
  ...
  store ptr %i.an, ptr %.5, align 8, !tbaa !7
  ...
  br i1 %niter66.ncmp.1, label %.loopexit.loopexit47.i.i.i.unr-lcssa, label %.lr.ph39.i.i.i, !llvm.loop !78
...
bb.e:                                             ; preds = %bb.d, %.lr.ph.i.i.i
  ...
  %i.bi = load ptr, ptr %.4, align 8, !tbaa !7    ; 2 uses
  %i.bj = getelementptr inbounds nuw i8, ptr %i.bi, i64 1
  store ptr %i.bj, ptr %.4, align 8, !tbaa !7
  store i8 %.sink62.i.i.i, ptr %i.bi, align 1, !tbaa !10
  %i.bk = load ptr, ptr %.4, align 8, !tbaa !7    ; 2 uses
  %i.bl = getelementptr inbounds nuw i8, ptr %i.bk, i64 1
  store ptr %i.bl, ptr %.4, align 8, !tbaa !7
  store i8 %.sink.i.i.i, ptr %i.bk, align 1, !tbaa !10
  %i.bm = add i64 %.335.i.i.i, 1                  ; 2 uses
  %exitcond.not.i.i.i = icmp eq i64 %i.bm, %i.ah
  br i1 %exitcond.not.i.i.i, label %.loopexit.i.i.i, label %.lr.ph.i.i.i, !llvm.loop !79
...
.lr.ph39.i.i.i.epil.preheader:                    ; preds = %.loopexit.loopexit47.i.i.i.unr-lcssa, %.lr.ph39.i.i.i.preheader
  ...
  %i.bp = load ptr, ptr %.5.epil.init, align 8, !tbaa !7 ; 2 uses
  %i.bq = getelementptr inbounds nuw i8, ptr %i.bp, i64 1
  store ptr %i.bq, ptr %.5.epil.init, align 8, !tbaa !7
  store i8 1, ptr %i.bp, align 1, !tbaa !10
  %i.br = load ptr, ptr %.5.epil.init, align 8, !tbaa !7 ; 2 uses
  %i.bs = getelementptr inbounds nuw i8, ptr %i.br, i64 1
  store ptr %i.bs, ptr %.5.epil.init, align 8, !tbaa !7
...
bb.f:                                             ; preds = %bb.a
  ...
  %i.bw = load i8, ptr %i.bv, align 8, !tbaa !81, !range !90, !noundef !91
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  ...
  %i.cb = load ptr, ptr %.01824, align 8, !tbaa !7 ; 2 uses
  %i.cc = getelementptr inbounds nuw i8, ptr %i.cb, i64 1
  store ptr %i.cc, ptr %.01824, align 8, !tbaa !7
  store i8 1, ptr %i.cb, align 1, !tbaa !10
  %i.cd = load ptr, ptr %.01824, align 8, !tbaa !7 ; 2 uses
  %i.ce = getelementptr inbounds nuw i8, ptr %i.cd, i64 1
  store ptr %i.ce, ptr %.01824, align 8, !tbaa !7
  store i8 0, ptr %i.cd, align 1, !tbaa !10
  %i.cf = getelementptr inbounds nuw i8, ptr %.01824, i64 16 ; 2 uses
  %i.cg = load ptr, ptr %i.ca, align 8, !tbaa !7  ; 2 uses
  %i.ch = getelementptr inbounds nuw i8, ptr %i.cg, i64 1
  store ptr %i.ch, ptr %i.ca, align 8, !tbaa !7
  store i8 1, ptr %i.cg, align 1, !tbaa !10
  %i.ci = load ptr, ptr %i.ca, align 8, !tbaa !7  ; 2 uses
  %i.cj = getelementptr inbounds nuw i8, ptr %i.ci, i64 1
  store ptr %i.cj, ptr %i.ca, align 8, !tbaa !7
  store i8 0, ptr %i.ci, align 1, !tbaa !10
  %niter.next.1 = add nuw nsw i64 %niter, 2       ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %.loopexit.loopexit54.unr-lcssa, label %.lr.ph, !llvm.loop !92

bb.g:                                             ; preds = %bb.f
  %i.ck = getelementptr inbounds nuw i8, ptr %i.b, i64 41
  %i.cl = load i8, ptr %i.ck, align 1, !tbaa !93, !range !90, !noundef !91 ; 3 uses
...
_ZNKSt14default_deleteIN5arrow6BufferEEclEPS1_.exit.i86: ; preds = %.loopexit
  ...
  call void %i.hn(ptr noundef nonnull align 8 dead_on_return(80) dereferenceable(80) %i.hk) #22, !inline_history !174
...
_ZNSt10unique_ptrIN5arrow6BufferESt14default_deleteIS1_EED2Ev.exit87: ; preds = %_ZNKSt14default_deleteIN5arrow6BufferEEclEPS1_.exit.i86, %.loopexit
  ...
  call void @_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEED2Ev(ptr noundef nonnull align 8 dereferenceable(16) %10) #22
  call void @llvm.lifetime.end.p0(ptr nonnull %10) #22
  br label %bb.bj

bb.bh:                                            ; preds = %_ZNSt10unique_ptrIN5arrow6BufferESt14default_deleteIS1_EED2Ev.exit, %bb.j
  %i.ho = load ptr, ptr %10, align 8, !tbaa !16
  %i.hp = icmp eq ptr %i.ho, null
  br i1 %i.hp, label %bb.bi, label %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.thread.i, !prof !19

bb.bi:                                            ; preds = %bb.bh
  %i.hq = getelementptr inbounds nuw i8, ptr %10, i64 8
  %i.hr = load ptr, ptr %i.hq, align 8, !tbaa !171 ; 3 uses
...
_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.i: ; preds = %bb.bi
  %i.hs = load ptr, ptr %i.hr, align 8, !tbaa !32
  %i.ht = getelementptr inbounds nuw i8, ptr %i.hs, i64 8
  %i.hu = load ptr, ptr %i.ht, align 8
  call void %i.hu(ptr noundef nonnull align 8 dead_on_return(80) dereferenceable(80) %i.hr) #22, !inline_history !175
  %.pr.pre.i = load ptr, ptr %10, align 8, !tbaa !16
  %i.hv = icmp eq ptr %.pr.pre.i, null
  br i1 %i.hv, label %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEED2Ev.exit, label %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.thread.i, !prof !41
...
_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEED2Ev.exit: ; preds = %bb.bi, %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.i, %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.thread.i
  call void @llvm.lifetime.end.p0(ptr nonnull %10) #22
  %i.hw = load ptr, ptr %9, align 8, !tbaa !171   ; 3 uses
...
_ZNKSt14default_deleteIN5arrow6BufferEEclEPS1_.exit.i90: ; preds = %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEED2Ev.exit
  ...
  call void %i.hz(ptr noundef nonnull align 8 dead_on_return(80) dereferenceable(80) %i.hw) #22, !inline_history !174
...
bb.bj:                                            ; preds = %_ZNSt10unique_ptrIN5arrow6BufferESt14default_deleteIS1_EED2Ev.exit87, %bb.k
  ...
  %i.ia = load ptr, ptr %9, align 8, !tbaa !171   ; 3 uses
...
_ZNKSt14default_deleteIN5arrow6BufferEEclEPS1_.exit.i93: ; preds = %bb.bj
  ...
  call void %i.id(ptr noundef nonnull align 8 dead_on_return(80) dereferenceable(80) %i.ia) #22, !inline_history !174
...
_ZNSt10unique_ptrIN5arrow6BufferESt14default_deleteIS1_EED2Ev.exit94: ; preds = %_ZNKSt14default_deleteIN5arrow6BufferEEclEPS1_.exit.i93, %bb.bj
  call void @llvm.lifetime.end.p0(ptr nonnull %9) #22
  call void @_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEED2Ev(ptr noundef nonnull align 8 dereferenceable(16) %8) #22
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #22
  br label %bb.bt

bb.bk:                                            ; preds = %_ZNSt10unique_ptrIN5arrow6BufferESt14default_deleteIS1_EED2Ev.exit91, %bb.f
  %i.ie = load ptr, ptr %8, align 8, !tbaa !16
  %i.if = icmp eq ptr %i.ie, null
  br i1 %i.if, label %bb.bl, label %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.thread.i95, !prof !19

bb.bl:                                            ; preds = %bb.bk
  %i.ig = getelementptr inbounds nuw i8, ptr %8, i64 8
  %i.ih = load ptr, ptr %i.ig, align 8, !tbaa !171 ; 3 uses
...
_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.i97: ; preds = %bb.bl
  ...
  call void %i.ik(ptr noundef nonnull align 8 dead_on_return(80) dereferenceable(80) %i.ih) #22, !inline_history !175
  %.pr.pre.i98 = load ptr, ptr %8, align 8, !tbaa !16
  %i.il = icmp eq ptr %.pr.pre.i98, null
  br i1 %i.il, label %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEED2Ev.exit99, label %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.thread.i95, !prof !41
...
bb.bm:                                            ; preds = %_ZN5arrow6StatusD2Ev.exit68, %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEED2Ev.exit99
  ...
  %i.in = load ptr, ptr %i.im, align 8, !tbaa !26 ; 8 uses
...
bb.bo:                                            ; preds = %bb.bn
  store i32 0, ptr %i.io, align 8, !tbaa !29
  %i.is = getelementptr inbounds nuw i8, ptr %i.in, i64 12
  store i32 0, ptr %i.is, align 4, !tbaa !31
  %i.it = load ptr, ptr %i.in, align 8, !tbaa !32
  %i.iu = getelementptr inbounds nuw i8, ptr %i.it, i64 16
  %i.iv = load ptr, ptr %i.iu, align 8
  call void %i.iv(ptr noundef nonnull align 8 dereferenceable(16) %i.in) #22, !inline_history !127
  %i.iw = load ptr, ptr %i.in, align 8, !tbaa !32
  %i.ix = getelementptr inbounds nuw i8, ptr %i.iw, i64 24
  %i.iy = load ptr, ptr %i.ix, align 8
  call void %i.iy(ptr noundef nonnull align 8 dereferenceable(16) %i.in) #22, !inline_history !127
  br label %_ZNSt12__shared_ptrIN5arrow6BufferELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit104

bb.bp:                                            ; preds = %bb.bn
  %i.iz = load i8, ptr @__libc_single_threaded, align 1, !tbaa !10
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i102: ; preds = %bb.br, %bb.bq
  ...
  br i1 %i.jc, label %bb.bs, label %_ZNSt12__shared_ptrIN5arrow6BufferELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit104, !prof !35
...
bb.bt:                                            ; preds = %bb.g, %_ZNSt10unique_ptrIN5arrow6BufferESt14default_deleteIS1_EED2Ev.exit94, %bb.d
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #22
  call void @_ZNSt12__shared_ptrIN5arrow6BufferELN9__gnu_cxx12_Lock_policyE2EED2Ev(ptr noundef nonnull align 8 dereferenceable(16) %5) #22
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #22
...
bb.a:
  ...
  %i.b = load i64, ptr %i.a, align 8, !tbaa !76   ; 4 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.j = load ptr, ptr %i.f, align 8, !tbaa !73   ; 2 uses
...
bb.c:                                             ; preds = %.loopexit.i, %.lr.ph23.i
  ...
  %.sroa.0.0.extract.trunc.i = trunc i32 %i.p to i16 ; 6 uses
...
.preheader.i:                                     ; preds = %bb.c
  %.sroa.0.0.extract.trunc.mask36.i = and i32 %i.p, 65535 ; 2 uses
  %4 = zext nneg i32 %.sroa.0.0.extract.trunc.mask36.i to i64 ; 6 uses
  %i.r = icmp sgt i16 %.sroa.0.0.extract.trunc.i, 0
  br i1 %i.r, label %.lr.ph18.i, label %.loopexit.i

.lr.ph18.i:                                       ; preds = %.preheader.i
  %i.s = load ptr, ptr %1, align 8, !tbaa !551, !nonnull !91, !align !490
  %i.t = load ptr, ptr %i.s, align 8, !tbaa !360  ; 6 uses
  %i.u = load ptr, ptr %i.m, align 8, !tbaa !553, !nonnull !91, !align !490 ; 2 uses
  %.promoted20.i = load i64, ptr %i.u, align 8, !tbaa !58 ; 5 uses
  %min.iters.check = icmp samesign ult i32 %.sroa.0.0.extract.trunc.mask36.i, 8
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %i.ae, align 4, !tbaa !3, !alias.scope !554
  %wide.load29 = load <4 x i32>, ptr %i.af, align 4, !tbaa !3, !alias.scope !554
  %i.ag = getelementptr i8, ptr %i.ae, i64 4
  %i.ah = getelementptr i8, ptr %i.ae, i64 20
  %wide.load30 = load <4 x i32>, ptr %i.ag, align 4, !tbaa !3, !alias.scope !554
  %wide.load31 = load <4 x i32>, ptr %i.ah, align 4, !tbaa !3, !alias.scope !554
  %i.ai = getelementptr [4 x i8], ptr %i.ad, i64 %index ; 3 uses
  %i.aj = getelementptr inbounds nuw i8, ptr %i.ai, i64 16 ; 2 uses
  %wide.load32 = load <4 x i32>, ptr %i.ai, align 4, !tbaa !3, !alias.scope !557, !noalias !554
  %wide.load33 = load <4 x i32>, ptr %i.aj, align 4, !tbaa !3, !alias.scope !557, !noalias !554
  ...
  store <4 x i32> %i.ao, ptr %i.ai, align 4, !tbaa !3, !alias.scope !557, !noalias !554
  store <4 x i32> %i.ap, ptr %i.aj, align 4, !tbaa !3, !alias.scope !557, !noalias !554
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.aq = icmp eq i64 %index.next, %n.vec
  br i1 %i.aq, label %middle.block, label %vector.body, !llvm.loop !559
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  br i1 %exitcond30.not.i.1, label %..loopexit_crit_edge.i, label %scalar.ph, !llvm.loop !560
...
.lr.ph14.i:                                       ; preds = %.preheader6.i
  %i.cg = load ptr, ptr %2, align 8, !tbaa !561, !nonnull !91, !align !490
  %i.ch = load ptr, ptr %i.cg, align 8, !tbaa !360 ; 2 uses
  %i.ci = load ptr, ptr %i.l, align 8, !tbaa !563, !nonnull !91, !align !490 ; 2 uses
  %.promoted.i = load i64, ptr %i.ci, align 8, !tbaa !58 ; 3 uses
...
vector.body41:                                    ; preds = %vector.body41, %vector.ph38
  ...
  br i1 %i.cp, label %middle.block46, label %vector.body41, !llvm.loop !564
...
scalar.ph36:                                      ; preds = %scalar.ph36.preheader, %scalar.ph36
  ...
  br i1 %exitcond29.not.i, label %..loopexit7_crit_edge.i, label %scalar.ph36, !llvm.loop !565
...
bb.e:                                             ; preds = %.lr.ph.i
  ...
  %i.di = load ptr, ptr %1, align 8, !tbaa !551, !nonnull !91, !align !490
  %i.dj = load ptr, ptr %i.di, align 8, !tbaa !360
  %i.dk = load ptr, ptr %i.m, align 8, !tbaa !553, !nonnull !91, !align !490 ; 2 uses
  %i.dl = load i64, ptr %i.dk, align 8, !tbaa !58 ; 2 uses
  %i.dm = add nsw i64 %i.dl, 1
  store i64 %i.dm, ptr %i.dk, align 8, !tbaa !58
...
bb.f:                                             ; preds = %.lr.ph.i
  %i.dr = load ptr, ptr %2, align 8, !tbaa !561, !nonnull !91, !align !490
  %i.ds = load ptr, ptr %i.dr, align 8, !tbaa !360
  %i.dt = load ptr, ptr %i.l, align 8, !tbaa !563, !nonnull !91, !align !490 ; 2 uses
  %i.du = load i64, ptr %i.dt, align 8, !tbaa !58 ; 2 uses
  %i.dv = add nsw i64 %i.du, 1
  store i64 %i.dv, ptr %i.dt, align 8, !tbaa !58
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  br i1 %exitcond.not.i, label %.loopexit.i, label %.lr.ph.i, !llvm.loop !566
...
..loopexit_crit_edge.i:                           ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  ...
  store i64 %.lcssa23, ptr %i.u, align 8, !tbaa !58
  br label %.loopexit.i
...
..loopexit7_crit_edge.i:                          ; preds = %scalar.ph36, %middle.block46
  ...
  store i64 %.lcssa, ptr %i.ci, align 8, !tbaa !58
  br label %.loopexit.i
...
bb.a:
  ...
  %i.c = load i64, ptr %i.b, align 8, !tbaa !76   ; 4 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.n = load ptr, ptr %i.g, align 8, !tbaa !73   ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #22
...
.lr.ph44.i:                                       ; preds = %bb.b, %.loopexit.i
  ...
  %i.p = call i32 @_ZN5arrow8internal23OptionalBitBlockCounter9NextBlockEv(ptr noundef nonnull align 8 dereferenceable(48) %3) ; 5 uses
  %.sroa.0.0.extract.trunc.i = trunc i32 %i.p to i16 ; 7 uses
  %.sroa.7.0.extract.shift.i = lshr i32 %i.p, 16  ; 2 uses
  %.sroa.7.0.extract.trunc.i = trunc nuw i32 %.sroa.7.0.extract.shift.i to i16
  %i.q = icmp eq i16 %.sroa.0.0.extract.trunc.i, %.sroa.7.0.extract.trunc.i
...
.preheader.i:                                     ; preds = %.lr.ph44.i
  %.sroa.0.0.extract.trunc.mask58.i = and i32 %i.p, 65535
  %4 = zext nneg i32 %.sroa.0.0.extract.trunc.mask58.i to i64
  %i.r = icmp sgt i16 %.sroa.0.0.extract.trunc.i, 0
...
.lr.ph41.i:                                       ; preds = %.preheader.i, %.lr.ph41.i
  ...
  %i.aa = load ptr, ptr %1, align 8, !tbaa !568, !nonnull !91, !align !490 ; 2 uses
  %i.ab = load ptr, ptr %i.aa, align 8, !tbaa !519 ; 8 uses
  %i.ac = getelementptr inbounds nuw i8, ptr %i.ab, i64 8
  store ptr %i.ac, ptr %i.aa, align 8, !tbaa !519
  %i.ad = load ptr, ptr %i.ab, align 8, !tbaa !7  ; 2 uses
  %i.ae = getelementptr inbounds nuw i8, ptr %i.ad, i64 1
  store ptr %i.ae, ptr %i.ab, align 8, !tbaa !7
  store i8 0, ptr %i.ad, align 1, !tbaa !10
  %i.af = load ptr, ptr %i.ab, align 8, !tbaa !7
  store i32 %i.y, ptr %i.af, align 1
  %i.ag = load ptr, ptr %i.ab, align 8, !tbaa !7
  %i.ah = getelementptr inbounds nuw i8, ptr %i.ag, i64 4 ; 2 uses
  store ptr %i.ah, ptr %i.ab, align 8, !tbaa !7
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.ah, ptr nonnull align 1 %i.v, i64 %i.z, i1 false)
  %i.ai = load ptr, ptr %i.ab, align 8, !tbaa !7
  %i.aj = getelementptr inbounds nuw i8, ptr %i.ai, i64 %i.z
  store ptr %i.aj, ptr %i.ab, align 8, !tbaa !7
  %i.ak = add nuw nsw i64 %.02340.i, 1            ; 2 uses
  %i.al = add nsw i64 %.139.i, 1                  ; 2 uses
  %exitcond50.not.i = icmp eq i64 %i.ak, %4
  br i1 %exitcond50.not.i, label %.loopexit.i, label %.lr.ph41.i, !llvm.loop !570
...
.lr.ph37.i:                                       ; preds = %.lr.ph37.i, %.lr.ph37.i.preheader.new
  ...
  %i.at = load ptr, ptr %2, align 8, !tbaa !571, !nonnull !91, !align !490 ; 2 uses
  %i.au = load ptr, ptr %i.at, align 8, !tbaa !519 ; 6 uses
  %i.av = getelementptr inbounds nuw i8, ptr %i.au, i64 8
  store ptr %i.av, ptr %i.at, align 8, !tbaa !519
  %i.aw = load ptr, ptr %i.au, align 8, !tbaa !7  ; 2 uses
  %i.ax = getelementptr inbounds nuw i8, ptr %i.aw, i64 1
  store ptr %i.ax, ptr %i.au, align 8, !tbaa !7
  store i8 1, ptr %i.aw, align 1, !tbaa !10
  %i.ay = load ptr, ptr %i.au, align 8, !tbaa !7
  store i32 0, ptr %i.ay, align 1
  %i.az = load ptr, ptr %i.au, align 8, !tbaa !7
  %i.ba = getelementptr inbounds nuw i8, ptr %i.az, i64 4
  store ptr %i.ba, ptr %i.au, align 8, !tbaa !7
  %i.bb = load ptr, ptr %2, align 8, !tbaa !571, !nonnull !91, !align !490 ; 2 uses
  %i.bc = load ptr, ptr %i.bb, align 8, !tbaa !519 ; 6 uses
  %i.bd = getelementptr inbounds nuw i8, ptr %i.bc, i64 8
  store ptr %i.bd, ptr %i.bb, align 8, !tbaa !519
  %i.be = load ptr, ptr %i.bc, align 8, !tbaa !7  ; 2 uses
  %i.bf = getelementptr inbounds nuw i8, ptr %i.be, i64 1
  store ptr %i.bf, ptr %i.bc, align 8, !tbaa !7
  store i8 1, ptr %i.be, align 1, !tbaa !10
  %i.bg = load ptr, ptr %i.bc, align 8, !tbaa !7
  store i32 0, ptr %i.bg, align 1
  %i.bh = load ptr, ptr %i.bc, align 8, !tbaa !7
  %i.bi = getelementptr inbounds nuw i8, ptr %i.bh, i64 4
  store ptr %i.bi, ptr %i.bc, align 8, !tbaa !7
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %.loopexit.loopexit45.i.unr-lcssa, label %.lr.ph37.i, !llvm.loop !573
...
bb.d:                                             ; preds = %.lr.ph.i
  ...
  %i.bz = load ptr, ptr %1, align 8, !tbaa !568, !nonnull !91, !align !490 ; 2 uses
  %i.ca = load ptr, ptr %i.bz, align 8, !tbaa !519 ; 7 uses
  %i.cb = getelementptr inbounds nuw i8, ptr %i.ca, i64 8
  store ptr %i.cb, ptr %i.bz, align 8, !tbaa !519
  %i.cc = load ptr, ptr %i.ca, align 8, !tbaa !7  ; 2 uses
  %i.cd = getelementptr inbounds nuw i8, ptr %i.cc, i64 1
  store ptr %i.cd, ptr %i.ca, align 8, !tbaa !7
  store i8 0, ptr %i.cc, align 1, !tbaa !10
  %i.ce = load ptr, ptr %i.ca, align 8, !tbaa !7
  store i32 %i.bx, ptr %i.ce, align 1
  %i.cf = load ptr, ptr %i.ca, align 8, !tbaa !7
  %i.cg = getelementptr inbounds nuw i8, ptr %i.cf, i64 4 ; 2 uses
  store ptr %i.cg, ptr %i.ca, align 8, !tbaa !7
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.cg, ptr nonnull align 1 %i.bu, i64 %i.by, i1 false)
  br label %bb.f

bb.e:                                             ; preds = %.lr.ph.i
  %i.ch = load ptr, ptr %2, align 8, !tbaa !571, !nonnull !91, !align !490 ; 2 uses
  %i.ci = load ptr, ptr %i.ch, align 8, !tbaa !519 ; 5 uses
  %i.cj = getelementptr inbounds nuw i8, ptr %i.ci, i64 8
  store ptr %i.cj, ptr %i.ch, align 8, !tbaa !519
  %i.ck = load ptr, ptr %i.ci, align 8, !tbaa !7  ; 2 uses
  %i.cl = getelementptr inbounds nuw i8, ptr %i.ck, i64 1
  store ptr %i.cl, ptr %i.ci, align 8, !tbaa !7
  store i8 1, ptr %i.ck, align 1, !tbaa !10
  %i.cm = load ptr, ptr %i.ci, align 8, !tbaa !7
...
bb.f:                                             ; preds = %bb.e, %bb.d
  ...
  %i.cn = load ptr, ptr %.sink.i, align 8, !tbaa !7
  %i.co = getelementptr inbounds nuw i8, ptr %i.cn, i64 %.sink57.i
  store ptr %i.co, ptr %.sink.i, align 8, !tbaa !7
  %i.cp = add i64 %.333.i, 1                      ; 2 uses
  %exitcond.not.i = icmp eq i64 %i.cp, %i.ap
  br i1 %exitcond.not.i, label %.loopexit.i, label %.lr.ph.i, !llvm.loop !574
...
.lr.ph37.i.epil.preheader:                        ; preds = %.loopexit.loopexit45.i.unr-lcssa, %.lr.ph37.i.preheader
  ...
  %i.cr = load ptr, ptr %2, align 8, !tbaa !571, !nonnull !91, !align !490 ; 2 uses
  %i.cs = load ptr, ptr %i.cr, align 8, !tbaa !519 ; 6 uses
  %i.ct = getelementptr inbounds nuw i8, ptr %i.cs, i64 8
  store ptr %i.ct, ptr %i.cr, align 8, !tbaa !519
  %i.cu = load ptr, ptr %i.cs, align 8, !tbaa !7  ; 2 uses
  %i.cv = getelementptr inbounds nuw i8, ptr %i.cu, i64 1
  store ptr %i.cv, ptr %i.cs, align 8, !tbaa !7
  store i8 1, ptr %i.cu, align 1, !tbaa !10
  %i.cw = load ptr, ptr %i.cs, align 8, !tbaa !7
  store i32 0, ptr %i.cw, align 1
  %i.cx = load ptr, ptr %i.cs, align 8, !tbaa !7
  %i.cy = getelementptr inbounds nuw i8, ptr %i.cx, i64 4
  store ptr %i.cy, ptr %i.cs, align 8, !tbaa !7
...
_ZNKSt14default_deleteIN5arrow6BufferEEclEPS1_.exit.i86: ; preds = %.loopexit
  %i.hi = load ptr, ptr %i.hh, align 8, !tbaa !32
  %i.hj = getelementptr inbounds nuw i8, ptr %i.hi, i64 8
  %i.hk = load ptr, ptr %i.hj, align 8
  call void %i.hk(ptr noundef nonnull align 8 dead_on_return(80) dereferenceable(80) %i.hh) #22, !inline_history !174
  br label %_ZNSt10unique_ptrIN5arrow6BufferESt14default_deleteIS1_EED2Ev.exit87
...
bb.bh:                                            ; preds = %_ZNSt10unique_ptrIN5arrow6BufferESt14default_deleteIS1_EED2Ev.exit, %bb.j
  %i.hl = load ptr, ptr %10, align 8, !tbaa !16
  %i.hm = icmp eq ptr %i.hl, null
  br i1 %i.hm, label %bb.bi, label %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.thread.i, !prof !19

bb.bi:                                            ; preds = %bb.bh
  %i.hn = getelementptr inbounds nuw i8, ptr %10, i64 8
  %i.ho = load ptr, ptr %i.hn, align 8, !tbaa !171 ; 3 uses
...
_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.i: ; preds = %bb.bi
  ...
  call void %i.hr(ptr noundef nonnull align 8 dead_on_return(80) dereferenceable(80) %i.ho) #22, !inline_history !175
  %.pr.pre.i = load ptr, ptr %10, align 8, !tbaa !16
  %i.hs = icmp eq ptr %.pr.pre.i, null
  br i1 %i.hs, label %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEED2Ev.exit, label %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.thread.i, !prof !41
...
_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEED2Ev.exit: ; preds = %bb.bi, %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.i, %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.thread.i
  call void @llvm.lifetime.end.p0(ptr nonnull %10) #22
  %i.ht = load ptr, ptr %9, align 8, !tbaa !171   ; 3 uses
...
_ZNKSt14default_deleteIN5arrow6BufferEEclEPS1_.exit.i90: ; preds = %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEED2Ev.exit
  ...
  call void %i.hw(ptr noundef nonnull align 8 dead_on_return(80) dereferenceable(80) %i.ht) #22, !inline_history !174
  br label %_ZNSt10unique_ptrIN5arrow6BufferESt14default_deleteIS1_EED2Ev.exit91
...
bb.bj:                                            ; preds = %_ZNSt10unique_ptrIN5arrow6BufferESt14default_deleteIS1_EED2Ev.exit87, %bb.k
  ...
  %i.hx = load ptr, ptr %9, align 8, !tbaa !171   ; 3 uses
  %.not.i92 = icmp eq ptr %i.hx, null
  br i1 %.not.i92, label %_ZNSt10unique_ptrIN5arrow6BufferESt14default_deleteIS1_EED2Ev.exit94, label %_ZNKSt14default_deleteIN5arrow6BufferEEclEPS1_.exit.i93

_ZNKSt14default_deleteIN5arrow6BufferEEclEPS1_.exit.i93: ; preds = %bb.bj
  %i.hy = load ptr, ptr %i.hx, align 8, !tbaa !32
  %i.hz = getelementptr inbounds nuw i8, ptr %i.hy, i64 8
  %i.ia = load ptr, ptr %i.hz, align 8
  call void %i.ia(ptr noundef nonnull align 8 dead_on_return(80) dereferenceable(80) %i.hx) #22, !inline_history !174
  br label %_ZNSt10unique_ptrIN5arrow6BufferESt14default_deleteIS1_EED2Ev.exit94
...
bb.bk:                                            ; preds = %_ZNSt10unique_ptrIN5arrow6BufferESt14default_deleteIS1_EED2Ev.exit91, %bb.f
  %i.ib = load ptr, ptr %8, align 8, !tbaa !16
  %i.ic = icmp eq ptr %i.ib, null
  br i1 %i.ic, label %bb.bl, label %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.thread.i95, !prof !19

bb.bl:                                            ; preds = %bb.bk
  %i.id = getelementptr inbounds nuw i8, ptr %8, i64 8
  %i.ie = load ptr, ptr %i.id, align 8, !tbaa !171 ; 3 uses
...
_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.i97: ; preds = %bb.bl
  ...
  call void %i.ih(ptr noundef nonnull align 8 dead_on_return(80) dereferenceable(80) %i.ie) #22, !inline_history !175
  %.pr.pre.i98 = load ptr, ptr %8, align 8, !tbaa !16
  %i.ii = icmp eq ptr %.pr.pre.i98, null
  br i1 %i.ii, label %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEED2Ev.exit99, label %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.thread.i95, !prof !41
...
bb.bm:                                            ; preds = %_ZN5arrow6StatusD2Ev.exit68, %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEED2Ev.exit99
  ...
  %i.ik = load ptr, ptr %i.ij, align 8, !tbaa !26 ; 8 uses
...
bb.bo:                                            ; preds = %bb.bn
  store i32 0, ptr %i.il, align 8, !tbaa !29
  %i.ip = getelementptr inbounds nuw i8, ptr %i.ik, i64 12
  store i32 0, ptr %i.ip, align 4, !tbaa !31
  %i.iq = load ptr, ptr %i.ik, align 8, !tbaa !32
  %i.ir = getelementptr inbounds nuw i8, ptr %i.iq, i64 16
  %i.is = load ptr, ptr %i.ir, align 8
  call void %i.is(ptr noundef nonnull align 8 dereferenceable(16) %i.ik) #22, !inline_history !127
  %i.it = load ptr, ptr %i.ik, align 8, !tbaa !32
  %i.iu = getelementptr inbounds nuw i8, ptr %i.it, i64 24
  %i.iv = load ptr, ptr %i.iu, align 8
  call void %i.iv(ptr noundef nonnull align 8 dereferenceable(16) %i.ik) #22, !inline_history !127
  br label %_ZNSt12__shared_ptrIN5arrow6BufferELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit104

bb.bp:                                            ; preds = %bb.bn
  %i.iw = load i8, ptr @__libc_single_threaded, align 1, !tbaa !10
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i102: ; preds = %bb.br, %bb.bq
  ...
  br i1 %i.iz, label %bb.bs, label %_ZNSt12__shared_ptrIN5arrow6BufferELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit104, !prof !35
...
.preheader.i:                                     ; preds = %bb.c
  %.sroa.0.0.extract.trunc.mask33.i = and i32 %i.p, 65535 ; 2 uses
  %4 = zext nneg i32 %.sroa.0.0.extract.trunc.mask33.i to i64 ; 6 uses
  %i.r = icmp sgt i16 %.sroa.0.0.extract.trunc.i, 0
  br i1 %i.r, label %.lr.ph17.i, label %.loopexit.i

.lr.ph17.i:                                       ; preds = %.preheader.i
  %i.s = load ptr, ptr %1, align 8, !tbaa !607, !nonnull !91, !align !490
  %i.t = load ptr, ptr %i.s, align 8, !tbaa !360  ; 4 uses
  %i.u = load ptr, ptr %i.m, align 8, !tbaa !609, !nonnull !91, !align !490 ; 7 uses
  %.promoted19.i = load i64, ptr %i.u, align 8, !tbaa !58 ; 5 uses
  %min.iters.check = icmp samesign ult i32 %.sroa.0.0.extract.trunc.mask33.i, 4
  br i1 %min.iters.check, label %scalar.ph.preheader, label %vector.memcheck
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %i.ae, align 8, !tbaa !58, !alias.scope !610
  %i.af = getelementptr i8, ptr %i.ae, i64 8
  %wide.load26 = load <2 x i64>, ptr %i.af, align 8, !tbaa !58, !alias.scope !610
...
middle.block:                                     ; preds = %vector.body
  store i64 %i.ah, ptr %i.u, align 8, !tbaa !58, !alias.scope !614, !noalias !610
  %cmp.n = icmp eq i64 %n.vec, %4
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader
  ...
  %i.ap = load i64, ptr %i.ao, align 8, !tbaa !58
  ...
  store i64 %i.at, ptr %i.u, align 8, !tbaa !58
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  %i.bh = load i64, ptr %i.bg, align 8, !tbaa !58
  %i.bi = sub nsw i64 %i.bh, %i.bf
  %i.bj = add nsw i64 %i.bd, 1                    ; 2 uses
  store i64 %i.bj, ptr %i.u, align 8, !tbaa !58
  ...
  store i64 %i.bv, ptr %i.u, align 8, !tbaa !58
  ...
  br i1 %exitcond27.not.i.1, label %.loopexit.i, label %scalar.ph, !llvm.loop !616
...
.lr.ph13.i:                                       ; preds = %.preheader5.i
  %i.cj = load ptr, ptr %2, align 8, !tbaa !617, !nonnull !91, !align !490
  %i.ck = load ptr, ptr %i.cj, align 8, !tbaa !360 ; 2 uses
  %i.cl = load ptr, ptr %i.l, align 8, !tbaa !619, !nonnull !91, !align !490 ; 2 uses
  %.promoted.i = load i64, ptr %i.cl, align 8, !tbaa !58 ; 3 uses
...
vector.body35:                                    ; preds = %vector.body35, %vector.ph32
  ...
  br i1 %i.cs, label %middle.block40, label %vector.body35, !llvm.loop !620
...
scalar.ph30:                                      ; preds = %scalar.ph30.preheader, %scalar.ph30
  ...
  br i1 %exitcond26.not.i, label %..loopexit6_crit_edge.i, label %scalar.ph30, !llvm.loop !621
...
bb.e:                                             ; preds = %.lr.ph.i
  ...
  %i.di = load i64, ptr %i.dh, align 8, !tbaa !58
  %i.dj = getelementptr i8, ptr %i.dh, i64 8
  %i.dk = load i64, ptr %i.dj, align 8, !tbaa !58
  %i.dl = sub nsw i64 %i.dk, %i.di
  %i.dm = load ptr, ptr %1, align 8, !tbaa !607, !nonnull !91, !align !490
  %i.dn = load ptr, ptr %i.dm, align 8, !tbaa !360
  %i.do = load ptr, ptr %i.m, align 8, !tbaa !609, !nonnull !91, !align !490 ; 2 uses
  %i.dp = load i64, ptr %i.do, align 8, !tbaa !58 ; 2 uses
  %i.dq = add nsw i64 %i.dp, 1
  store i64 %i.dq, ptr %i.do, align 8, !tbaa !58
...
bb.f:                                             ; preds = %.lr.ph.i
  %i.dw = load ptr, ptr %2, align 8, !tbaa !617, !nonnull !91, !align !490
  %i.dx = load ptr, ptr %i.dw, align 8, !tbaa !360
  %i.dy = load ptr, ptr %i.l, align 8, !tbaa !619, !nonnull !91, !align !490 ; 2 uses
  %i.dz = load i64, ptr %i.dy, align 8, !tbaa !58 ; 2 uses
  %i.ea = add nsw i64 %i.dz, 1
  store i64 %i.ea, ptr %i.dy, align 8, !tbaa !58
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  br i1 %exitcond.not.i, label %.loopexit.i, label %.lr.ph.i, !llvm.loop !622
...
..loopexit6_crit_edge.i:                          ; preds = %scalar.ph30, %middle.block40
  ...
  store i64 %.lcssa, ptr %i.cl, align 8, !tbaa !58
  br label %.loopexit.i
...
.lr.ph41.i:                                       ; preds = %.preheader.i, %.lr.ph41.i
  ...
  %i.t = load i64, ptr %i.s, align 8, !tbaa !58   ; 2 uses
  ...
  %i.y = load ptr, ptr %1, align 8, !tbaa !624, !nonnull !91, !align !490 ; 2 uses
  %i.z = load ptr, ptr %i.y, align 8, !tbaa !519  ; 8 uses
  %i.aa = getelementptr inbounds nuw i8, ptr %i.z, i64 8
  store ptr %i.aa, ptr %i.y, align 8, !tbaa !519
  ...
  store i8 0, ptr %i.ab, align 1, !tbaa !10
  %i.ad = load ptr, ptr %i.z, align 8, !tbaa !7
  store i64 %i.x, ptr %i.ad, align 1
  %i.ae = load ptr, ptr %i.z, align 8, !tbaa !7
...
.lr.ph37.i:                                       ; preds = %.lr.ph37.i, %.lr.ph37.i.preheader.new
  %niter = phi i64 [ 0, %.lr.ph37.i.preheader.new ], [ %niter.next.1, %.lr.ph37.i ]
  %i.ar = load ptr, ptr %2, align 8, !tbaa !627, !nonnull !91, !align !490 ; 2 uses
  %i.as = load ptr, ptr %i.ar, align 8, !tbaa !519 ; 6 uses
  %i.at = getelementptr inbounds nuw i8, ptr %i.as, i64 8
  store ptr %i.at, ptr %i.ar, align 8, !tbaa !519
  %i.au = load ptr, ptr %i.as, align 8, !tbaa !7  ; 2 uses
  %i.av = getelementptr inbounds nuw i8, ptr %i.au, i64 1
  store ptr %i.av, ptr %i.as, align 8, !tbaa !7
  store i8 1, ptr %i.au, align 1, !tbaa !10
  %i.aw = load ptr, ptr %i.as, align 8, !tbaa !7
  store i64 0, ptr %i.aw, align 1
  %i.ax = load ptr, ptr %i.as, align 8, !tbaa !7
  %i.ay = getelementptr inbounds nuw i8, ptr %i.ax, i64 8
  store ptr %i.ay, ptr %i.as, align 8, !tbaa !7
  %i.az = load ptr, ptr %2, align 8, !tbaa !627, !nonnull !91, !align !490 ; 2 uses
  %i.ba = load ptr, ptr %i.az, align 8, !tbaa !519 ; 6 uses
  %i.bb = getelementptr inbounds nuw i8, ptr %i.ba, i64 8
  store ptr %i.bb, ptr %i.az, align 8, !tbaa !519
  %i.bc = load ptr, ptr %i.ba, align 8, !tbaa !7  ; 2 uses
  %i.bd = getelementptr inbounds nuw i8, ptr %i.bc, i64 1
  store ptr %i.bd, ptr %i.ba, align 8, !tbaa !7
  store i8 1, ptr %i.bc, align 1, !tbaa !10
  %i.be = load ptr, ptr %i.ba, align 8, !tbaa !7
  store i64 0, ptr %i.be, align 1
  %i.bf = load ptr, ptr %i.ba, align 8, !tbaa !7
  %i.bg = getelementptr inbounds nuw i8, ptr %i.bf, i64 8
  store ptr %i.bg, ptr %i.ba, align 8, !tbaa !7
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %.loopexit.loopexit45.i.unr-lcssa, label %.lr.ph37.i, !llvm.loop !629
...
bb.d:                                             ; preds = %.lr.ph.i
  ...
  %i.bq = load i64, ptr %i.bp, align 8, !tbaa !58 ; 2 uses
  ...
  %i.bv = load ptr, ptr %1, align 8, !tbaa !624, !nonnull !91, !align !490 ; 2 uses
  %i.bw = load ptr, ptr %i.bv, align 8, !tbaa !519 ; 7 uses
  %i.bx = getelementptr inbounds nuw i8, ptr %i.bw, i64 8
  store ptr %i.bx, ptr %i.bv, align 8, !tbaa !519
  %i.by = load ptr, ptr %i.bw, align 8, !tbaa !7  ; 2 uses
  %i.bz = getelementptr inbounds nuw i8, ptr %i.by, i64 1
  store ptr %i.bz, ptr %i.bw, align 8, !tbaa !7
  store i8 0, ptr %i.by, align 1, !tbaa !10
  %i.ca = load ptr, ptr %i.bw, align 8, !tbaa !7
  store i64 %i.bu, ptr %i.ca, align 1
  %i.cb = load ptr, ptr %i.bw, align 8, !tbaa !7
  %i.cc = getelementptr inbounds nuw i8, ptr %i.cb, i64 8 ; 2 uses
  store ptr %i.cc, ptr %i.bw, align 8, !tbaa !7
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.cc, ptr nonnull align 1 %i.br, i64 %i.bu, i1 false)
  br label %bb.f

bb.e:                                             ; preds = %.lr.ph.i
  %i.cd = load ptr, ptr %2, align 8, !tbaa !627, !nonnull !91, !align !490 ; 2 uses
  %i.ce = load ptr, ptr %i.cd, align 8, !tbaa !519 ; 5 uses
  %i.cf = getelementptr inbounds nuw i8, ptr %i.ce, i64 8
  store ptr %i.cf, ptr %i.cd, align 8, !tbaa !519
  %i.cg = load ptr, ptr %i.ce, align 8, !tbaa !7  ; 2 uses
  %i.ch = getelementptr inbounds nuw i8, ptr %i.cg, i64 1
  store ptr %i.ch, ptr %i.ce, align 8, !tbaa !7
  store i8 1, ptr %i.cg, align 1, !tbaa !10
  %i.ci = load ptr, ptr %i.ce, align 8, !tbaa !7
...
bb.f:                                             ; preds = %bb.e, %bb.d
  ...
  %i.cj = load ptr, ptr %.sink.i, align 8, !tbaa !7
  %i.ck = getelementptr inbounds nuw i8, ptr %i.cj, i64 %.sink57.i
  store ptr %i.ck, ptr %.sink.i, align 8, !tbaa !7
  %i.cl = add i64 %.333.i, 1                      ; 2 uses
  %exitcond.not.i = icmp eq i64 %i.cl, %i.an
  br i1 %exitcond.not.i, label %.loopexit.i, label %.lr.ph.i, !llvm.loop !630
...
.lr.ph37.i.epil.preheader:                        ; preds = %.loopexit.loopexit45.i.unr-lcssa, %.lr.ph37.i.preheader
  %lcmp.mod23 = trunc i32 %i.p to i1
  call void @llvm.assume(i1 %lcmp.mod23)
  %i.cn = load ptr, ptr %2, align 8, !tbaa !627, !nonnull !91, !align !490 ; 2 uses
  %i.co = load ptr, ptr %i.cn, align 8, !tbaa !519 ; 6 uses
  %i.cp = getelementptr inbounds nuw i8, ptr %i.co, i64 8
  store ptr %i.cp, ptr %i.cn, align 8, !tbaa !519
  %i.cq = load ptr, ptr %i.co, align 8, !tbaa !7  ; 2 uses
  %i.cr = getelementptr inbounds nuw i8, ptr %i.cq, i64 1
  store ptr %i.cr, ptr %i.co, align 8, !tbaa !7
  store i8 1, ptr %i.cq, align 1, !tbaa !10
  %i.cs = load ptr, ptr %i.co, align 8, !tbaa !7
  store i64 0, ptr %i.cs, align 1
  %i.ct = load ptr, ptr %i.co, align 8, !tbaa !7
  %i.cu = getelementptr inbounds nuw i8, ptr %i.ct, i64 8
  store ptr %i.cu, ptr %i.co, align 8, !tbaa !7
  br label %.loopexit.loopexit45.i
