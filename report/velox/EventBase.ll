...
bb.a:
  ...
  %i.a = tail call noalias noundef nonnull dereferenceable(112) ptr @_Znwm(i64 noundef 112) #60 ; 8 uses
  %4 = getelementptr inbounds nuw i8, ptr %i.a, i64 8 ; 6 uses
...
_ZN5folly9EventBase20FunctionLoopCallbackC2EONS_8FunctionIFvvEEE.exit: ; preds = %bb.a, %bb.b
  ...
  store <2 x ptr> %i.l, ptr %i.b, align 8, !tbaa !14046
...
begin_hunk_2_@_ZN5folly9EventBase9runInLoopENS_8FunctionIFvvEEEb:bb.a
  ...
  store ptr %i.at, ptr %4, align 8, !tbaa !14092
  store ptr %4, ptr %i.av, align 8, !tbaa !14093
  br label %bb.q
...
begin_hunk_3_@_ZN5folly9EventBase9runInLoopENS_8FunctionIFvvEEEb:bb.a
  ...
  store ptr %i.ay, ptr %4, align 8, !tbaa !14092
  store ptr %4, ptr %i.az, align 16, !tbaa !14093
  br label %bb.q

bb.q:                                             ; preds = %bb.p, %bb.o
  %.sink = phi ptr [ %i.ba, %bb.p ], [ %i.aw, %bb.o ]
  store ptr %4, ptr %.sink, align 8, !tbaa !14092
  ret void
}
