...
begin_hunk_0_@_ZN12_GLOBAL__N_116EventBaseBackend16setEdgeTriggeredERN5folly14EventBaseEventE:bb.a
  ...
  %i.z = and i16 %i.y, 2
  %.not12 = icmp eq i16 %i.z, 0                   ; 2 uses
  %spec.store.select = select i1 %.not12, i32 -2147483648, i32 -2147483647
  %i.aa = and i16 %i.y, 4
  %.not13 = icmp eq i16 %i.aa, 0
  %4 = select i1 %.not12, i32 -2147483644, i32 -2147483643
  %spec.select = select i1 %.not13, i32 %spec.store.select, i32 %4
