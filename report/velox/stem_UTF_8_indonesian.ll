begin_hunk_0
  ...
  %i.bv = tail call fastcc i32 @r_remove_suffix(ptr noundef nonnull %0) ; 5 uses
  %cond7 = icmp sgt i32 %i.bv, 0
  %1 = icmp slt i32 %i.bv, 0
  %.3 = select i1 %1, i32 %i.bv, i32 %.1.i.ph     ; 2 uses
...
bb.q:                                             ; preds = %bb.p
  ...
  %.lobit = lshr i32 %i.bv, 31                    ; 2 uses
  %.7121 = select i1 %.not192, i32 6, i32 %.lobit
  switch i32 %.7121, label %.thread174 [
    i32 0, label %bb.r
...
.thread178:                                       ; preds = %bb.q, %bb.r, %bb.s, %bb.o
  store i32 %i.bj, ptr %i.d, align 8, !tbaa !14
  br label %r_remove_particle.exit

.thread174:                                       ; preds = %bb.s, %bb.q, %bb.n
  %.11125 = phi i32 [ %.6120, %bb.n ], [ %.lobit.a, %bb.s ], [ %.lobit, %bb.q ] ; 2 uses
  %.8 = phi i32 [ %.2, %bb.n ], [ %.5, %bb.s ], [ %.3, %bb.q ] ; 2 uses
