...
; Function Attrs: mustprogress nofree norecurse nounwind memory(readwrite, argmem: write, target_mem: none) uwtable
...
; Function Attrs: mustprogress nofree norecurse nounwind memory(readwrite, argmem: read, target_mem: none) uwtable
