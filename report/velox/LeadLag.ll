...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %n.vec = and i64 %i.ae, 67108848                ; 5 uses
  %3 = shl nuw nsw i64 %n.vec, 6
  %i.af = shl nuw nsw i64 %n.vec, 6
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec21 = and i64 %i.ae, 67108860              ; 4 uses
  %4 = shl nuw nsw i64 %n.vec21, 6
  %i.bb = shl nuw nsw i64 %n.vec21, 6
...
.lr.ph.i.i.preheader:                             ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv4.ph = phi i64 [ 0, %iter.check ], [ %3, %vec.epilog.iter.check ], [ %4, %vec.epilog.middle.block ]
