...
.outer:                                           ; preds = %_ZNSt6vectorItSaItEE9push_backERKt.exit, %bb.c
  %.sroa.31.0.ph.a = phi ptr [ %.sroa.31.1.a, %_ZNSt6vectorItSaItEE9push_backERKt.exit ], [ null, %bb.c ] ; 30 uses
  %.sroa.17.0.ph = phi ptr [ %.sroa.17.1, %_ZNSt6vectorItSaItEE9push_backERKt.exit ], [ null, %bb.c ] ; 12 uses
  %.sroa.0103.0.ph = phi ptr [ %.sroa.0103.1, %_ZNSt6vectorItSaItEE9push_backERKt.exit ], [ null, %bb.c ] ; 20 uses
  %.021.ph = phi i32 [ %i.bv, %_ZNSt6vectorItSaItEE9push_backERKt.exit ], [ %i.j, %bb.c ] ; 2 uses
  %i.s = icmp eq ptr %.sroa.31.0.ph.a, %.sroa.17.0.ph
...
bb.v:                                             ; preds = %bb.u
  %.not.i = icmp eq ptr %.sroa.17.0.ph, %.sroa.0103.0.ph
...
bb.x:                                             ; preds = %bb.v
  %i.bz = ptrtoint ptr %.sroa.17.0.ph to i64
  %i.ca = ptrtoint ptr %.sroa.31.0.ph.a to i64
...
bb.y:                                             ; preds = %.noexc57
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 2 %i.cj, ptr align 2 %.sroa.31.0.ph.a, i64 %i.cb, i1 false)
...
_ZNSt6vectorItSaItEE11_S_relocateEPtS2_S2_RS0_.exit16.i.i: ; preds = %bb.y, %.noexc57
  ...
  %.not.i17.i.i = icmp eq ptr %.sroa.31.0.ph.a, null
...
bb.z:                                             ; preds = %_ZNSt6vectorItSaItEE11_S_relocateEPtS2_S2_RS0_.exit16.i.i
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.31.0.ph.a, i64 noundef %i.cb) #30
...
.loopexit:                                        ; preds = %.split235.us, %_ZNKSt6vectorItSaItEE12_M_check_lenEmPKc.exit.i.i, %_ZNKSt6vectorItSaItEE12_M_check_lenEmPKc.exit.i.i59
  %.sroa.31.0.ph.lcssa322 = phi ptr [ %.sroa.0103.0.ph, %.split235.us ], [ %.sroa.17.0.ph, %_ZNKSt6vectorItSaItEE12_M_check_lenEmPKc.exit.i.i ], [ %.sroa.17.0.ph, %_ZNKSt6vectorItSaItEE12_M_check_lenEmPKc.exit.i.i59 ]
...
bb.ag:                                            ; preds = %bb.u, %bb.aa
  %.not.i58 = icmp eq ptr %.sroa.17.0.ph, %.sroa.0103.0.ph
...
bb.ai:                                            ; preds = %bb.ag
  %i.cw = ptrtoint ptr %.sroa.17.0.ph to i64
  %i.cx = ptrtoint ptr %.sroa.31.0.ph.a to i64
...
bb.aj:                                            ; preds = %.noexc66
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 2 %i.dg, ptr align 2 %.sroa.31.0.ph.a, i64 %i.cy, i1 false)
...
_ZNSt6vectorItSaItEE11_S_relocateEPtS2_S2_RS0_.exit16.i.i62: ; preds = %bb.aj, %.noexc66
  %.not.i17.i.i63 = icmp eq ptr %.sroa.31.0.ph.a, null
...
bb.ak:                                            ; preds = %_ZNSt6vectorItSaItEE11_S_relocateEPtS2_S2_RS0_.exit16.i.i62
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.31.0.ph.a, i64 noundef %i.cy) #30
...
_ZNSt6vectorItSaItEE9push_backERKt.exit67:        ; preds = %_ZNSt6vectorItSaItEE17_M_realloc_insertIJRKtEEEvN9__gnu_cxx17__normal_iteratorIPtS1_EEDpOT_.exit.i64, %bb.ah
  %.sroa.31.5.a = phi ptr [ %i.dg, %_ZNSt6vectorItSaItEE17_M_realloc_insertIJRKtEEEvN9__gnu_cxx17__normal_iteratorIPtS1_EEDpOT_.exit.i64 ], [ %.sroa.31.0.ph.a, %bb.ah ] ; 7 uses
  ...
  %.sroa.0103.5 = phi ptr [ %i.dj, %_ZNSt6vectorItSaItEE17_M_realloc_insertIJRKtEEEvN9__gnu_cxx17__normal_iteratorIPtS1_EEDpOT_.exit.i64 ], [ %.sroa.0103.0.ph, %bb.ah ] ; 5 uses
  %.sroa.17.3 = getelementptr inbounds nuw i8, ptr %.pn, i64 2 ; 2 uses
  %.not.i.i = icmp eq ptr %.sroa.17.3, %.sroa.0103.5
...
bb.am:                                            ; preds = %_ZNSt6vectorItSaItEE9push_backERKt.exit67
  %i.dl = ptrtoint ptr %.sroa.0103.5 to i64
  %i.dm = ptrtoint ptr %.sroa.31.5.a to i64
...
bb.ao:                                            ; preds = %.noexc69
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 2 %i.dv, ptr align 2 %.sroa.31.5.a, i64 %i.dn, i1 false)
...
_ZNSt6vectorItSaItEE11_S_relocateEPtS2_S2_RS0_.exit16.i.i.i: ; preds = %bb.ao, %.noexc69
  ...
  %.not.i17.i.i.i = icmp eq ptr %.sroa.31.5.a, null
...
bb.ap:                                            ; preds = %_ZNSt6vectorItSaItEE11_S_relocateEPtS2_S2_RS0_.exit16.i.i.i
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.31.5.a, i64 noundef %i.dn) #30
...
_ZNSt6vectorItSaItEE9push_backEOt.exit:           ; preds = %_ZNSt6vectorItSaItEE17_M_realloc_insertIJtEEEvN9__gnu_cxx17__normal_iteratorIPtS1_EEDpOT_.exit.i.i, %bb.al
  %.sroa.31.6.a = phi ptr [ %i.dv, %_ZNSt6vectorItSaItEE17_M_realloc_insertIJtEEEvN9__gnu_cxx17__normal_iteratorIPtS1_EEDpOT_.exit.i.i ], [ %.sroa.31.5.a, %bb.al ] ; 6 uses
  ...
  %.sroa.0103.6 = phi ptr [ %i.dz, %_ZNSt6vectorItSaItEE17_M_realloc_insertIJtEEEvN9__gnu_cxx17__normal_iteratorIPtS1_EEDpOT_.exit.i.i ], [ %.sroa.0103.5, %bb.al ] ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #27
  br label %bb.aq

bb.aq:                                            ; preds = %bb.aq, %_ZNSt6vectorItSaItEE9push_backEOt.exit
  %.0.i.i = phi ptr [ %.sroa.31.6.a, %_ZNSt6vectorItSaItEE9push_backEOt.exit ], [ %i.eb, %bb.aq ] ; 3 uses
...
_ZN5boost6locale4util7str_endIKtEEPT_S5_.exit.i:  ; preds = %bb.aq
  invoke void @_ZN5boost6locale4conv10utf_to_utfIctEENSt7__cxx1112basic_stringIT_St11char_traitsIS5_ESaIS5_EEEPKT0_SC_NS1_11method_typeE(ptr dead_on_unwind nonnull writable sret(%"class.std::__cxx11::basic_string") align 8 %5, ptr noundef %.sroa.31.6.a, ptr noundef nonnull %.0.i.i, i32 noundef 0)
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit76: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEpLERKS4_.exit, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i74
  ...
  %.not.i.i77 = icmp eq ptr %.sroa.17.4, %.sroa.31.6.a
  %spec.select = select i1 %.not.i.i77, ptr %.sroa.17.4, ptr %.sroa.31.6.a
  br label %_ZNSt6vectorItSaItEE9push_backERKt.exit
...
_ZNSt6vectorItSaItEE9push_backERKt.exit:          ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit76, %_ZNSt6vectorItSaItEE17_M_realloc_insertIJRKtEEEvN9__gnu_cxx17__normal_iteratorIPtS1_EEDpOT_.exit.i, %bb.w
  %.sroa.31.1.a = phi ptr [ %.sroa.31.0.ph.a, %bb.w ], [ %i.cj, %_ZNSt6vectorItSaItEE17_M_realloc_insertIJRKtEEEvN9__gnu_cxx17__normal_iteratorIPtS1_EEDpOT_.exit.i ], [ %.sroa.31.6.a, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit76 ]
  ...
  %.sroa.0103.1 = phi ptr [ %.sroa.0103.0.ph, %bb.w ], [ %i.cn, %_ZNSt6vectorItSaItEE17_M_realloc_insertIJRKtEEEvN9__gnu_cxx17__normal_iteratorIPtS1_EEDpOT_.exit.i ], [ %.sroa.0103.6, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit76 ]
...
bb.au:                                            ; preds = %.loopexit148, %.loopexit.split-lp149, %.loopexit, %.loopexit.split-lp, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit, %bb.af, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit80
  ...
  %.sroa.0103.2 = phi ptr [ %.sroa.0103.0.ph, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i ], [ %.sroa.0103.0.ph, %bb.af ], [ %.sroa.0103.0.ph, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit ], [ %.sroa.17.0.ph, %.loopexit.split-lp ], [ %.sroa.0103.6, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit80 ], [ %.sroa.31.0.ph.lcssa322, %.loopexit ], [ %.sroa.0103.5, %.loopexit148 ], [ %.sroa.0103.5, %.loopexit.split-lp149 ]
...
.split229.us:                                     ; preds = %bb.f
  %.not.i.i.i97 = icmp eq ptr %.sroa.31.0.ph.a, null
  br i1 %.not.i.i.i97, label %_ZNSt6vectorItSaItEED2Ev.exit, label %bb.bj

bb.bj:                                            ; preds = %.split229.us
  %i.gj = ptrtoint ptr %.sroa.0103.0.ph to i64
  %i.gk = ptrtoint ptr %.sroa.31.0.ph.a to i64
  %i.gl = sub i64 %i.gj, %i.gk
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.31.0.ph.a, i64 noundef %i.gl) #30
...
bb.bk:                                            ; preds = %.split, %.split.us, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i94, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i90, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i87, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit89, %bb.ba, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit96, %bb.bi, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit92, %bb.be, %bb.au
  %.sroa.31.3.a = phi ptr [ %.sroa.31.0.ph.a, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i94 ], [ %.sroa.31.0.ph.a, %bb.be ], [ %.sroa.31.0.ph.a, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit92 ], [ %.sroa.31.0.ph.a, %bb.bi ], [ %.sroa.31.0.ph.a, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit96 ], [ %.sroa.31.2.a, %bb.au ], [ %.sroa.31.0.ph.a, %bb.ba ], [ %.sroa.31.0.ph.a, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit89 ], [ %.sroa.31.0.ph.a, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i87 ], [ %.sroa.31.0.ph.a, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i90 ], [ %.sroa.31.0.ph.a, %.split ], [ %.sroa.31.0.ph.a, %.split.us ] ; 3 uses
  %.sroa.0103.3 = phi ptr [ %.sroa.0103.0.ph, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i94 ], [ %.sroa.0103.0.ph, %bb.be ], [ %.sroa.0103.0.ph, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit92 ], [ %.sroa.0103.0.ph, %bb.bi ], [ %.sroa.0103.0.ph, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit96 ], [ %.sroa.0103.2, %bb.au ], [ %.sroa.0103.0.ph, %bb.ba ], [ %.sroa.0103.0.ph, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit89 ], [ %.sroa.0103.0.ph, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i87 ], [ %.sroa.0103.0.ph, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i90 ], [ %.sroa.0103.0.ph, %.split ], [ %.sroa.0103.0.ph, %.split.us ]
  ...
  %.not.i.i.i98 = icmp eq ptr %.sroa.31.3.a, null
  br i1 %.not.i.i.i98, label %_ZNSt6vectorItSaItEED2Ev.exit99, label %bb.bl

bb.bl:                                            ; preds = %bb.bk
  %i.gm = ptrtoint ptr %.sroa.0103.3 to i64
  %i.gn = ptrtoint ptr %.sroa.31.3.a to i64
  %i.go = sub i64 %i.gm, %i.gn
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.31.3.a, i64 noundef %i.go) #30
