...
bb.b:                                             ; preds = %bb.a
  tail call void @_ZN8facebook5velox6detail14veloxCheckFailINS0_17VeloxRuntimeErrorEPKcEEvRKNS1_18VeloxCheckFailArgsET0_(ptr noundef nonnull align 8 dereferenceable(56) @_ZZN8facebook5velox9functions3sfm20SfmSketchAccumulator6sketchEvE18veloxCheckFailArgs, ptr noundef nonnull @.str.3) #14
  unreachable
...
bb.g:                                             ; preds = %bb.a
  %i.u = landingpad { ptr, i32 }
          cleanup
  call void @_ZN8facebook5velox9functions3sfm9SfmSketchD2Ev(ptr noundef nonnull align 8 dead_on_return(2584) dereferenceable(2584) %3) #15
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #15
  resume { ptr, i32 } %i.u
}
...
bb.b:                                             ; preds = %bb.a
  tail call void @_ZN8facebook5velox6detail14veloxCheckFailINS0_17VeloxRuntimeErrorEPKcEEvRKNS1_18VeloxCheckFailArgsET0_(ptr noundef nonnull align 8 dereferenceable(56) @_ZZN8facebook5velox9functions3sfm20SfmSketchAccumulator16addIndexAndZerosEiiE18veloxCheckFailArgs, ptr noundef nonnull @.str.3) #14
  unreachable
...
bb.b:                                             ; preds = %bb.a
  tail call void @_ZN8facebook5velox6detail14veloxCheckFailINS0_17VeloxRuntimeErrorEPKcEEvRKNS1_18VeloxCheckFailArgsET0_(ptr noundef nonnull align 8 dereferenceable(56) @_ZZN8facebook5velox9functions3sfm20SfmSketchAccumulator11cardinalityEvE18veloxCheckFailArgs, ptr noundef nonnull @.str.6) #14
  unreachable
...
bb.c:                                             ; preds = %bb.b
  %2 = tail call double @nextafter(double noundef 1.000000e+00, double noundef 0.000000e+00) #15, !tbaa !3
...
bb.a:
  tail call void @_ZdlPvm(ptr noundef nonnull %0, i64 noundef 2512) #17
  ret void
}
...
attributes #10 = { mustprogress nocallback nofree nounwind willreturn memory(errnomem: write) "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+avx,+avx2,+bmi2,+cmov,+crc32,+cx8,+f16c,+fma,+fxsr,+lzcnt,+mmx,+popcnt,+sse,+sse2,+sse3,+sse4.1,+sse4.2,+ssse3,+x87,+xsave" "tune-cpu"="generic" }
