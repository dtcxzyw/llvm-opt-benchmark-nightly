...
bb.i:                                             ; preds = %bb.h, %bb.h
  ...
  %.not106.not.i = icmp eq i64 %i.v, 1
  br i1 %.not106.not.i, label %_ZN8facebook5velox6StatusD2Ev.exit71, label %bb.j
...
bb.k:                                             ; preds = %bb.j
  ...
  %10 = icmp ugt i64 %i.v, 2
  br i1 %10, label %bb.l, label %.thread
