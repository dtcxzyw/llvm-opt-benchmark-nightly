...
.lr.ph57:                                         ; preds = %.preheader
  ...
  %sext79 = shl i64 %1, 28
  %13 = ashr exact i64 %sext79, 32
  %sext80 = shl i64 %2, 28
  %wide.trip.count = ashr exact i64 %sext80, 32
  br label %bb.s

bb.s:                                             ; preds = %.lr.ph57, %_ZNSt10shared_ptrIvEC2ERKS0_.exit
  %indvars.iv = phi i64 [ %13, %.lr.ph57 ], [ %indvars.iv.next, %_ZNSt10shared_ptrIvEC2ERKS0_.exit ] ; 2 uses
