...
@_ZN4geos2io6WriterC1Ev = unnamed_addr alias void (ptr), ptr @_ZN4geos2io6WriterC2Ev
...
define void @_ZN4geos2io6Writer7reserveEm(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %1) local_unnamed_addr #1 align 2 {
bb.a:
...
define noundef nonnull align 8 dereferenceable(32) ptr @_ZN4geos2io6Writer8toStringB5cxx11Ev(ptr nofree noundef nonnull readnone returned align 8 captures(ret: address, provenance) dereferenceable(32) %0) local_unnamed_addr #3 align 2 {
bb.a:
  ret ptr %0
}
