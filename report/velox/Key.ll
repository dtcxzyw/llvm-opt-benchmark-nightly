...
define noundef i32 @_ZN4geos5index8quadtree3Key16computeQuadLevelERKNS_4geom8EnvelopeE(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(32) %0) local_unnamed_addr #0 align 2 {
bb.a:
  ...
  %i.n = call double @frexp(double noundef %i.m, ptr noundef nonnull %i.a) #12 ; 0 uses
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  %i.ak = load double, ptr %i.i, align 8, !tbaa !15
  %i.al = insertelement <2 x double> %i.aj, double %i.ak, i64 1
  %i.am = insertelement <2 x double> poison, double %ldexp.i5, i64 0
  %i.an = shufflevector <2 x double> %i.am, <2 x double> poison, <2 x i32> zeroinitializer ; 3 uses
  %i.ao = fdiv <2 x double> %i.al, %i.an
  %i.ap = tail call <2 x double> @llvm.floor.v2f64(<2 x double> %i.ao)
  %i.aq = fmul <2 x double> %i.an, %i.ap          ; 5 uses
  store <2 x double> %i.aq, ptr %0, align 8, !tbaa !14
  %i.ar = fadd <2 x double> %i.an, %i.aq          ; 3 uses
  ...
  %i.av = shufflevector <2 x double> %i.ar, <2 x double> %i.aq, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  %i.aw = select <4 x i1> %i.at, <4 x double> %i.au, <4 x double> %i.av
  store <4 x double> %i.aw, ptr %i.q, align 8, !tbaa !14
  %i.ax = tail call noundef zeroext i1 @_ZNK4geos4geom8Envelope6coversERKS1_(ptr noundef nonnull align 8 dereferenceable(32) %i.q, ptr noundef nonnull align 8 dereferenceable(32) %1)
  br i1 %i.ax, label %._crit_edge, label %.lr.ph, !llvm.loop !17
...
define noundef nonnull align 8 dereferenceable(24) ptr @_ZNK4geos5index8quadtree3Key8getPointEv(ptr noundef nonnull readnone returned align 8 captures(ret: address, provenance) dereferenceable(64) %0) local_unnamed_addr #4 align 2 {
bb.a:
  ret ptr %0
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define noundef i32 @_ZNK4geos5index8quadtree3Key8getLevelEv(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(64) %0) local_unnamed_addr #5 align 2 {
bb.a:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define noundef nonnull align 8 dereferenceable(32) ptr @_ZNK4geos5index8quadtree3Key11getEnvelopeEv(ptr noundef nonnull readnone align 8 captures(ret: address, provenance) dereferenceable(64) %0) local_unnamed_addr #4 align 2 {
bb.a:
...
; Function Attrs: mustprogress uwtable
define noalias noundef nonnull ptr @_ZNK4geos5index8quadtree3Key9getCentreEv(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(64) %0) local_unnamed_addr #3 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %i.a = tail call noalias noundef nonnull dereferenceable(24) ptr @_Znwm(i64 noundef 24) #13 ; 3 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.d = load <2 x double>, ptr %i.c, align 8, !tbaa !14
  %i.e = load <4 x double>, ptr %i.b, align 8, !tbaa !14
  %i.f = shufflevector <4 x double> %i.e, <4 x double> poison, <2 x i32> <i32 0, i32 3>
  %i.g = fadd <2 x double> %i.d, %i.f
  %i.h = fmul <2 x double> %i.g, splat (double 5.000000e-01)
  store <2 x double> %i.h, ptr %i.a, align 8, !tbaa !14
  %i.i = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  store double +qnan, ptr %i.i, align 8, !tbaa !10
  ret ptr %i.a
}
...
define void @_ZN4geos5index8quadtree3Key10computeKeyEiRKNS_4geom8EnvelopeE(ptr noundef nonnull writeonly align 8 captures(none) dereferenceable(64) initializes((0, 16), (32, 64)) %0, i32 noundef %1, ptr noundef nonnull readonly align 8 captures(none) dereferenceable(32) %2) local_unnamed_addr #7 align 2 {
bb.a:
...
declare noundef zeroext i1 @_ZNK4geos4geom8Envelope6coversERKS1_(ptr noundef nonnull align 8 dereferenceable(32), ptr noundef nonnull align 8 dereferenceable(32)) local_unnamed_addr #8
...
attributes #2 = { mustprogress nocallback nofree nounwind willreturn memory(argmem: write) "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+avx,+avx2,+bmi2,+cmov,+crc32,+cx8,+f16c,+fma,+fxsr,+lzcnt,+mmx,+popcnt,+sse,+sse2,+sse3,+sse4.1,+sse4.2,+ssse3,+x87,+xsave" "tune-cpu"="generic" }
