...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  %i.ag = load i32, ptr %i.p, align 8, !tbaa !12
  %i.ah = add nsw i32 %i.ag, 1                    ; 2 uses
  store i32 %i.ah, ptr %i.p, align 8, !tbaa !12
  %ldexp.i5 = tail call double @ldexp(double 1.000000e+00, i32 %i.ah)
  %i.ai = load double, ptr %1, align 8, !tbaa !16
...
bb.a:
  ...
  %i.g = load <2 x double>, ptr %i.d, align 8, !tbaa !14
  %i.h = insertelement <2 x double> poison, double %i.c, i64 0
  %i.i = insertelement <2 x double> %i.h, double %i.f, i64 1
  %i.j = fadd <2 x double> %i.g, %i.i
  %i.k = fmul <2 x double> %i.j, splat (double 5.000000e-01)
  store <2 x double> %i.k, ptr %i.a, align 8, !tbaa !14
  %i.l = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  store double +qnan, ptr %i.l, align 8, !tbaa !10
  ret ptr %i.a
}
