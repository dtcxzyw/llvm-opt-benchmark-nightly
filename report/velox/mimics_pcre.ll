...
begin_hunk_2_@_ZN3re26Regexp6WalkerIbE12WalkInternalEPS0_bb:bb.a
  ...
  %i.dh = call noundef zeroext i1 %i.dg(ptr noundef nonnull align 8 dereferenceable(96) %0, ptr noundef nonnull %i.ag, i1 noundef zeroext %i.cy, i1 noundef zeroext %i.db, ptr noundef %i.dd, i32 noundef %.pre87) ; 3 uses
...
bb.y:                                             ; preds = %bb.n, %bb.v, %bb.x, %bb.w, %bb.i
  %.161 = phi i1 [ %i.as, %bb.i ], [ %i.dh, %bb.w ], [ %i.dh, %bb.x ], [ %i.dh, %bb.v ], [ %i.az, %bb.n ] ; 4 uses
...
begin_hunk_4_@_ZN3re26Regexp6WalkerIbE12WalkInternalEPS0_bb:bb.a
  ...
  br i1 %i.dq, label %bb.ae, label %bb.z
...
begin_hunk_5_@_ZN3re26Regexp6WalkerIbE12WalkInternalEPS0_bb:bb.a
  ...
  br i1 %i.dx, label %bb.ae, label %_ZNSt5stackIN3re29WalkStateIbEESt5dequeIS2_SaIS2_EEE3topEv.exit76
...
begin_hunk_6_@_ZN3re26Regexp6WalkerIbE12WalkInternalEPS0_bb:bb.a
  ...
  %7 = zext i1 %.161 to i8
  store i8 %7, ptr %i.ej, align 1, !tbaa !9
  br label %bb.ad
...
bb.ac:                                            ; preds = %_ZNSt5stackIN3re29WalkStateIbEESt5dequeIS2_SaIS2_EEE3topEv.exit76
  ...
  %8 = zext i1 %.161 to i8
  store i8 %8, ptr %i.ek, align 2, !tbaa !75
...
bb.ae:                                            ; preds = %_ZNSt5stackIN3re29WalkStateIbEESt5dequeIS2_SaIS2_EEE3popEv.exit, %_ZNSt5stackIN3re29WalkStateIbEESt5dequeIS2_SaIS2_EEE3popEv.exit.thread, %_ZN4absl12lts_2024011612log_internal10LogMessagelsILi10EEERS2_RAT__Kc.exit
