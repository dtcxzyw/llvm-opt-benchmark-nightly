...
bb.a:
  %4 = fmul double %0, 0x400921FB54442D18
  %5 = fdiv double %4, 1.800000e+02               ; 2 uses
  %6 = tail call double @sin(double noundef %5) #19, !tbaa !3 ; 2 uses
  %7 = tail call double @cos(double noundef %5) #19, !tbaa !3 ; 2 uses
  ...
  %8 = fmul double %2, 0x400921FB54442D18
  %9 = fdiv double %8, 1.800000e+02               ; 2 uses
  %i.d = tail call double @sin(double noundef %9) #19, !tbaa !3 ; 2 uses
  %i.e = tail call double @cos(double noundef %9) #19, !tbaa !3 ; 3 uses
...
begin_hunk_1_@_ZN8facebook5velox12BingTileType19greatCircleDistanceEdddd:bb.a
  ...
  %i.k = fmul double %7, %i.d
  %i.l = fmul double %6, %i.e
  %i.m = fmul double %i.h, %i.l
  %i.n = fsub double %i.k, %i.m                   ; 2 uses
  %i.o = fmul double %6, %i.d
  %i.p = fmul double %7, %i.e
