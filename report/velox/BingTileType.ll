...
bb.w:                                             ; preds = %bb.o
  ...
  %26 = fmul double %1, f0x400921FB54442D18
  %27 = fdiv double %26, 1.800000e+02             ; 10 uses
  %28 = fdiv double %4, 6.371010e+03              ; 8 uses
  %i.ch = call double @sin(double noundef %27) #18, !tbaa !3
  %i.ci = call double @cos(double noundef %28) #18, !tbaa !3
  %i.cj = fmul double %i.ch, %i.ci
  %i.ck = call double @cos(double noundef %27) #18, !tbaa !3
  %i.cl = call double @sin(double noundef %28) #18, !tbaa !3
...
bb.ae:                                            ; preds = %bb.x
  ...
  %i.dk = call double @sin(double noundef %27) #18, !tbaa !3
  %i.dl = call double @cos(double noundef %28) #18, !tbaa !3
  %i.dm = fmul double %i.dk, %i.dl
  %i.dn = call double @cos(double noundef %27) #18, !tbaa !3
  %i.do = call double @sin(double noundef %28) #18, !tbaa !3
...
_ZNR5folly8ExpectedImNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEE5valueEv.exit292: ; preds = %bb.af
  ...
  %i.eq = call double @sin(double noundef %28) #18, !tbaa !3
  %i.er = fneg double %i.eq
  %i.es = call double @cos(double noundef %27) #18, !tbaa !3
  %i.et = fmul double %i.es, %i.er
  %i.eu = call double @cos(double noundef %28) #18, !tbaa !3
  %i.ev = call double @sin(double noundef %27) #18, !tbaa !3 ; 2 uses
...
_ZNR5folly8ExpectedImNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEE5valueEv.exit304: ; preds = %bb.aq
  ...
  %i.ga = call double @sin(double noundef %28) #18, !tbaa !3
  %i.gb = call double @cos(double noundef %27) #18, !tbaa !3
  %i.gc = fmul double %i.ga, %i.gb
  %i.gd = call double @cos(double noundef %28) #18, !tbaa !3
  %i.ge = call double @sin(double noundef %27) #18, !tbaa !3 ; 2 uses
...
._crit_edge:                                      ; preds = %_ZNSt6vectorImSaImEE9push_backEOm.exit354, %.preheader642
  ...
  %i.kg = call double @sin(double noundef %27) #18, !tbaa !3 ; 8 uses
  %i.kh = call double @cos(double noundef %27) #18, !tbaa !3 ; 8 uses
