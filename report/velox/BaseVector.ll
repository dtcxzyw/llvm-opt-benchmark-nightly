...
.lr.ph:                                           ; preds = %_ZNSt10_HashtableIiiSaIiENSt8__detail9_IdentityESt8equal_toIiESt4hashIiENS1_18_Mod_range_hashingENS1_20_Default_ranged_hashENS1_20_Prime_rehash_policyENS1_17_Hashtable_traitsILb0ELb1ELb1EEEE19_M_allocate_bucketsEm.exit, %bb.j
  ...
  %i.i = load ptr, ptr %.02530, align 8, !tbaa !1389 ; 2 uses
...
bb.g:                                             ; preds = %.lr.ph
  ...
  store ptr %i.p, ptr %.02530, align 8, !tbaa !1389
  store ptr %.02530, ptr %i.g, align 8, !tbaa !1388
  store ptr %i.g, ptr %i.n, align 8, !tbaa !12549
  %i.q = load ptr, ptr %.02530, align 8, !tbaa !1389
  %.not28 = icmp eq ptr %i.q, null
  br i1 %.not28, label %bb.j, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.r = getelementptr inbounds nuw [8 x i8], ptr %.0.i, i64 %.031
  store ptr %.02530, ptr %i.r, align 8, !tbaa !12549
  br label %bb.j

bb.i:                                             ; preds = %.lr.ph
  %i.s = load ptr, ptr %i.o, align 8, !tbaa !1389
  store ptr %i.s, ptr %.02530, align 8, !tbaa !1389
  %i.t = load ptr, ptr %i.n, align 8, !tbaa !12549
  store ptr %.02530, ptr %i.t, align 8, !tbaa !1389
  br label %bb.j
