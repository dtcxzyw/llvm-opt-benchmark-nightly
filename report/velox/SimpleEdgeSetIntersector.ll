...
.preheader.i:                                     ; preds = %.preheader.lr.ph.i, %._crit_edge.i
  %.01416.i = phi i64 [ %i.bj, %._crit_edge.i ], [ 0, %.preheader.lr.ph.i ] ; 2 uses
  br label %bb.f

._crit_edge.i:                                    ; preds = %bb.f
  %i.bj = add nuw i64 %.01416.i, 1                ; 2 uses
  %exitcond19.not.i = icmp eq i64 %i.bj, %i.bh
  br i1 %exitcond19.not.i, label %_ZN4geos9geomgraph5index24SimpleEdgeSetIntersector17computeIntersectsEPNS0_4EdgeES4_PNS1_18SegmentIntersectorE.exit, label %.preheader.i, !llvm.loop !24

bb.f:                                             ; preds = %bb.f, %.preheader.i
  %.015.i = phi i64 [ 0, %.preheader.i ], [ %i.bk, %bb.f ] ; 2 uses
  tail call void @_ZN4geos9geomgraph5index18SegmentIntersector16addIntersectionsEPNS0_4EdgeEmS4_m(ptr noundef nonnull align 8 dereferenceable(76) %2, ptr noundef nonnull %i.am, i64 noundef %.01416.i, ptr noundef nonnull %i.aq, i64 noundef %.015.i)
  %i.bk = add nuw i64 %.015.i, 1                  ; 2 uses
  %exitcond.not.i = icmp eq i64 %i.bk, %i.bi
  br i1 %exitcond.not.i, label %._crit_edge.i, label %bb.f, !llvm.loop !22

_ZN4geos9geomgraph5index24SimpleEdgeSetIntersector17computeIntersectsEPNS0_4EdgeES4_PNS1_18SegmentIntersectorE.exit: ; preds = %._crit_edge.i, %.preheader.lr.ph.i, %bb.e, %bb.d
...
.preheader.lr.ph:                                 ; preds = %bb.a
  ...
  br i1 %.not18, label %._crit_edge17.split, label %.preheader

.preheader:                                       ; preds = %.preheader.lr.ph, %._crit_edge
  %.01416 = phi i64 [ %i.s, %._crit_edge ], [ 0, %.preheader.lr.ph ] ; 2 uses
  br label %bb.b
...
._crit_edge:                                      ; preds = %bb.b
  %i.s = add nuw i64 %.01416, 1                   ; 2 uses
  %exitcond19.not = icmp eq i64 %i.s, %i.q
  br i1 %exitcond19.not, label %._crit_edge17.split, label %.preheader, !llvm.loop !24

bb.b:                                             ; preds = %.preheader, %bb.b
  %.015 = phi i64 [ 0, %.preheader ], [ %i.t, %bb.b ] ; 2 uses
  tail call void @_ZN4geos9geomgraph5index18SegmentIntersector16addIntersectionsEPNS0_4EdgeEmS4_m(ptr noundef nonnull align 8 dereferenceable(76) %3, ptr noundef nonnull %1, i64 noundef %.01416, ptr noundef nonnull %2, i64 noundef %.015)
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %._crit_edge
  %.017 = phi i64 [ %14, %._crit_edge ], [ 0, %.lr.ph.preheader ] ; 2 uses
...
._crit_edge:                                      ; preds = %_ZN4geos9geomgraph5index24SimpleEdgeSetIntersector17computeIntersectsEPNS0_4EdgeES4_PNS1_18SegmentIntersectorE.exit
  %14 = add nuw i64 %.017, 1                      ; 2 uses
  %exitcond22.not = icmp eq i64 %14, %13
  br i1 %exitcond22.not, label %._crit_edge20.split, label %.lr.ph, !llvm.loop !28

bb.b:                                             ; preds = %.lr.ph, %_ZN4geos9geomgraph5index24SimpleEdgeSetIntersector17computeIntersectsEPNS0_4EdgeES4_PNS1_18SegmentIntersectorE.exit
  %.01516 = phi i64 [ 0, %.lr.ph ], [ %i.ah, %_ZN4geos9geomgraph5index24SimpleEdgeSetIntersector17computeIntersectsEPNS0_4EdgeES4_PNS1_18SegmentIntersectorE.exit ] ; 2 uses
...
bb.c:                                             ; preds = %bb.c, %.preheader.i
  %.015.i = phi i64 [ 0, %.preheader.i ], [ %i.ag, %bb.c ] ; 2 uses
  tail call void @_ZN4geos9geomgraph5index18SegmentIntersector16addIntersectionsEPNS0_4EdgeEmS4_m(ptr noundef nonnull align 8 dereferenceable(76) %3, ptr noundef nonnull %i.j, i64 noundef %.01416.i, ptr noundef nonnull %i.m, i64 noundef %.015.i)
  %i.ag = add nuw i64 %.015.i, 1                  ; 2 uses
  %exitcond.not.i = icmp eq i64 %i.ag, %i.ae
  br i1 %exitcond.not.i, label %._crit_edge.i, label %bb.c, !llvm.loop !22

_ZN4geos9geomgraph5index24SimpleEdgeSetIntersector17computeIntersectsEPNS0_4EdgeES4_PNS1_18SegmentIntersectorE.exit: ; preds = %._crit_edge.i, %bb.b, %.preheader.lr.ph.i
  %i.ah = add nuw i64 %.01516, 1                  ; 2 uses
  %exitcond.not = icmp eq i64 %i.ah, %9
