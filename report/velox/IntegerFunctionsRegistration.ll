...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %5 = load i64, ptr %.pre, align 8, !tbaa !131, !alias.scope !761, !noalias !764
  %i.ax = mul i64 %5, -4417276706812531889
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %6 = add nsw i64 %n.vec41, %i.al
  %7 = load i64, ptr %.pre, align 8, !tbaa !131, !alias.scope !761, !noalias !764
  %i.bq = mul i64 %7, -4417276706812531889
...
_ZN8facebook5velox6StatusD2Ev.exit18.preheader:   ; preds = %vector.memcheck, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv.ph = phi i64 [ %i.al, %iter.check ], [ %i.al, %vector.memcheck ], [ %4, %vec.epilog.iter.check ], [ %6, %vec.epilog.middle.block ]
...
begin_hunk_3_@_ZZN8facebook5velox4bits10forEachBitIZNS0_4exec7EvalCtx22applyToSelectedNoThrowIZNKS3_21SimpleFunctionAdapterINS0_4core9UDFHolderINS0_9functions22XxHash64BigIntFunctionINS3_10VectorExecEEESB_lNS0_15ConstantCheckerIJlEEEJlEEEE7iterateIJNS3_20ConstantVectorReaderIlEEEEEvRNSG_12ApplyContextEDpRT_EUlT_E1_ZNS4_22applyToSelectedNoThrowISQ_EEvRKNS0_17SelectivityVectorESP_EUlSP_E_EEvSU_SP_T0_EUlSP_E_EEvPKmiibSP_ENKUliE_clEi:bb.a
  ...
  %2 = add i64 %n.vec106, %i.p                    ; 2 uses
  %3 = load i64, ptr %.pre83, align 8, !tbaa !131, !alias.scope !790, !noalias !793
  %i.w = mul i64 %3, -4417276706812531889         ; 2 uses
...
_ZN8facebook5velox6StatusD2Ev.exit39.preheader:   ; preds = %middle.block, %vector.memcheck, %iter.check, %vec.epilog.middle.block
  %.080.ph = phi i64 [ %2, %middle.block ], [ %i.p, %vector.memcheck ], [ %i.p, %iter.check ], [ %2, %vec.epilog.middle.block ]
...
begin_hunk_7_@_ZZN8facebook5velox4bits10forEachBitIZNS0_4exec7EvalCtx22applyToSelectedNoThrowIZNKS3_21SimpleFunctionAdapterINS0_4core9UDFHolderINS0_9functions23XxHash64TinyIntFunctionINS3_10VectorExecEEESB_lNS0_15ConstantCheckerIJaEEEJaEEEE7iterateIJNS3_20ConstantVectorReaderIaEEEEEvRNSG_12ApplyContextEDpRT_EUlT_E1_ZNS4_22applyToSelectedNoThrowISQ_EEvRKNS0_17SelectivityVectorESP_EUlSP_E_EEvSU_SP_T0_EUlSP_E_EEvPKmiibSP_ENKUliE_clEi:bb.a
  ...
  %2 = add i64 %n.vec108, %i.p                    ; 2 uses
  %3 = load i8, ptr %.pre85, align 1, !tbaa !26, !alias.scope !1448, !noalias !1451 ; 2 uses
  br i1 %min.iters.check106, label %vec.epilog.ph, label %vector.ph

vector.ph:                                        ; preds = %vector.main.loop.iter.check
  %broadcast.splatinsert = insertelement <4 x i8> poison, i8 %3, i64 0
  %broadcast.splat = shufflevector <4 x i8> %broadcast.splatinsert, <4 x i8> poison, <4 x i32> zeroinitializer
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check
  %broadcast.splatinsert109 = insertelement <2 x i8> poison, i8 %3, i64 0
...
_ZN8facebook5velox6StatusD2Ev.exit39.preheader:   ; preds = %middle.block, %vector.memcheck, %iter.check, %vec.epilog.middle.block
  %.082.ph = phi i64 [ %2, %middle.block ], [ %i.p, %vector.memcheck ], [ %i.p, %iter.check ], [ %2, %vec.epilog.middle.block ]
  br label %_ZN8facebook5velox6StatusD2Ev.exit39
...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %i.ax = load i64, ptr %.pre.i, align 8, !tbaa !131, !alias.scope !1640, !noalias !1643
  %7 = load i64, ptr %.pre30.i, align 8, !tbaa !131, !alias.scope !1646, !noalias !1648
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %8 = add nsw i64 %n.vec20, %i.al
  %i.be = load i64, ptr %.pre.i, align 8, !tbaa !131, !alias.scope !1640, !noalias !1643
  %9 = load i64, ptr %.pre30.i, align 8, !tbaa !131, !alias.scope !1646, !noalias !1648
...
_ZN8facebook5velox6StatusD2Ev.exit17.i.preheader: ; preds = %vector.memcheck, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv.i.ph = phi i64 [ %i.al, %iter.check ], [ %i.al, %vector.memcheck ], [ %6, %vec.epilog.iter.check ], [ %8, %vec.epilog.middle.block ] ; 4 uses
...
_ZN8facebook5velox6StatusD2Ev.exit17.i.prol:      ; preds = %_ZN8facebook5velox6StatusD2Ev.exit17.i.preheader
  %i.bk = load i64, ptr %.pre.i, align 8, !tbaa !131, !noalias !1643
  %i.bl = load i64, ptr %.pre30.i, align 8, !tbaa !131, !noalias !1648
...
_ZN8facebook5velox6StatusD2Ev.exit17.i:           ; preds = %_ZN8facebook5velox6StatusD2Ev.exit17.i.prol.loopexit, %_ZN8facebook5velox6StatusD2Ev.exit17.i
  ...
  %i.bq = load i64, ptr %.pre.i, align 8, !tbaa !131, !noalias !1643
  %i.br = load i64, ptr %.pre30.i, align 8, !tbaa !131, !noalias !1648
  ...
  %i.bv = load i64, ptr %.pre.i, align 8, !tbaa !131, !noalias !1643
  %i.bw = load i64, ptr %.pre30.i, align 8, !tbaa !131, !noalias !1648
...
begin_hunk_15_@_ZN8facebook5velox4bits11forEachWordIZNS1_10forEachBitIZNS0_4exec7EvalCtx22applyToSelectedNoThrowIZNKS4_21SimpleFunctionAdapterINS0_4core9UDFHolderINS0_9functions19CombineHashFunctionINS4_10VectorExecEEESC_lNS0_15ConstantCheckerIJllEEEJllEEEE7iterateIJNS4_20ConstantVectorReaderIlEESK_EEEvRNSH_12ApplyContextEDpRT_EUlT_E1_ZNS5_22applyToSelectedNoThrowISR_EEvRKNS0_17SelectivityVectorESQ_EUlSQ_E_EEvSV_SQ_T0_EUlSQ_E_EEvPKmiibSQ_EUlimE_ZNS3_ISY_EEvS10_iibSQ_EUliE_EEviiSQ_SX_:bb.a
  ...
  %4 = add i64 %n.vec100, %i.ck                   ; 2 uses
  %i.cq = load i64, ptr %.pre82.i, align 8, !tbaa !131, !alias.scope !1678, !noalias !1681
  %5 = load i64, ptr %.pre84.i, align 8, !tbaa !131, !alias.scope !1684, !noalias !1686
  %i.cr = mul i64 %i.cq, 31
  %i.cs = add i64 %i.cr, %5                       ; 2 uses
...
_ZN8facebook5velox6StatusD2Ev.exit36.i.preheader: ; preds = %middle.block, %vector.memcheck, %iter.check, %vec.epilog.middle.block
  %.079.i.ph = phi i64 [ %4, %middle.block ], [ %i.ck, %vector.memcheck ], [ %i.ck, %iter.check ], [ %4, %vec.epilog.middle.block ]
...
_ZN8facebook5velox6StatusD2Ev.exit36.i:           ; preds = %_ZN8facebook5velox6StatusD2Ev.exit36.i.preheader, %_ZN8facebook5velox6StatusD2Ev.exit36.i
  ...
  %i.cy = load i64, ptr %.pre82.i, align 8, !tbaa !131, !noalias !1681
  %i.cz = load i64, ptr %.pre84.i, align 8, !tbaa !131, !noalias !1686
...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %n.vec = and i64 %i.ap, 8589934576              ; 4 uses
  %6 = add nsw i64 %n.vec, %i.al
  %7 = load i64, ptr %.pre.i, align 8, !tbaa !131, !alias.scope !1718, !noalias !1721
  %i.ax = mul i64 %7, 31
  %broadcast.splatinsert = insertelement <4 x i64> poison, i64 %i.ax, i64 0
  %broadcast.splat = shufflevector <4 x i64> %broadcast.splatinsert, <4 x i64> poison, <4 x i32> zeroinitializer ; 4 uses
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %8 = add nsw i64 %n.vec24, %i.al
  %9 = load i64, ptr %.pre.i, align 8, !tbaa !131, !alias.scope !1718, !noalias !1721
  %i.bm = mul i64 %9, 31
...
_ZN8facebook5velox6StatusD2Ev.exit14.i.preheader: ; preds = %vector.memcheck, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv.i.ph = phi i64 [ %i.al, %iter.check ], [ %i.al, %vector.memcheck ], [ %6, %vec.epilog.iter.check ], [ %8, %vec.epilog.middle.block ] ; 5 uses
...
begin_hunk_20_@_ZN8facebook5velox4bits11forEachWordIZNS1_10forEachBitIZNS0_4exec7EvalCtx22applyToSelectedNoThrowIZNKS4_21SimpleFunctionAdapterINS0_4core9UDFHolderINS0_9functions19CombineHashFunctionINS4_10VectorExecEEESC_lNS0_15ConstantCheckerIJllEEEJllEEEE7iterateIJNS4_20ConstantVectorReaderIlEENS4_16FlatVectorReaderIlEEEEEvRNSH_12ApplyContextEDpRT_EUlT_E1_ZNS5_22applyToSelectedNoThrowIST_EEvRKNS0_17SelectivityVectorESS_EUlSS_E_EEvSX_SS_T0_EUlSS_E_EEvPKmiibSS_EUlimE_ZNS3_IS10_EEvS12_iibSS_EUliE_EEviiSS_SZ_:bb.a
  ...
  %5 = load i64, ptr %.pre79.i, align 8, !tbaa !131, !alias.scope !1759, !noalias !1762
  %i.di = mul i64 %5, 31
...
_ZN8facebook5velox6StatusD2Ev.exit33.i.preheader: ; preds = %middle.block, %vector.memcheck, %vector.scevcheck, %iter.check, %vec.epilog.middle.block
  %.076.i.ph = phi i64 [ %4, %middle.block ], [ %i.cm, %vector.scevcheck ], [ %i.cm, %vector.memcheck ], [ %i.cm, %iter.check ], [ %4, %vec.epilog.middle.block ]
...
!1643 = !{!1644}
!1644 = distinct !{!1644, !1645, !"_ZNK8facebook5velox4exec21SimpleFunctionAdapterINS0_4core9UDFHolderINS0_9functions19CombineHashFunctionINS1_10VectorExecEEES7_lNS0_15ConstantCheckerIJllEEEJllEEEE14doApplyNotNullILm0ENS1_20ConstantVectorReaderIlEEJSF_ETnNSt9enable_ifIXneT_L_ZNSB_8num_argsEEEiE4typeELi0EEENS0_6StatusEmRlRbRT0_DpRKT1_: argument 0"}
!1645 = distinct !{!1645, !"_ZNK8facebook5velox4exec21SimpleFunctionAdapterINS0_4core9UDFHolderINS0_9functions19CombineHashFunctionINS1_10VectorExecEEES7_lNS0_15ConstantCheckerIJllEEEJllEEEE14doApplyNotNullILm0ENS1_20ConstantVectorReaderIlEEJSF_ETnNSt9enable_ifIXneT_L_ZNSB_8num_argsEEEiE4typeELi0EEENS0_6StatusEmRlRbRT0_DpRKT1_"}
!1646 = !{!1647}
!1647 = distinct !{!1647, !1642}
!1648 = !{!1649}
!1649 = distinct !{!1649, !1650, !"_ZNK8facebook5velox4exec21SimpleFunctionAdapterINS0_4core9UDFHolderINS0_9functions19CombineHashFunctionINS1_10VectorExecEEES7_lNS0_15ConstantCheckerIJllEEEJllEEEE14doApplyNotNullILm1EKNS1_20ConstantVectorReaderIlEEJlETnNSt9enable_ifIXneT_L_ZNSB_8num_argsEEEiE4typeELi0EEENS0_6StatusEmRlRbRT0_DpRKT1_: argument 0"}
!1650 = distinct !{!1650, !"_ZNK8facebook5velox4exec21SimpleFunctionAdapterINS0_4core9UDFHolderINS0_9functions19CombineHashFunctionINS1_10VectorExecEEES7_lNS0_15ConstantCheckerIJllEEEJllEEEE14doApplyNotNullILm1EKNS1_20ConstantVectorReaderIlEEJlETnNSt9enable_ifIXneT_L_ZNSB_8num_argsEEEiE4typeELi0EEENS0_6StatusEmRlRbRT0_DpRKT1_"}
!1651 = !{!1652}
...
!1681 = !{!1682}
!1682 = distinct !{!1682, !1683, !"_ZNK8facebook5velox4exec21SimpleFunctionAdapterINS0_4core9UDFHolderINS0_9functions19CombineHashFunctionINS1_10VectorExecEEES7_lNS0_15ConstantCheckerIJllEEEJllEEEE14doApplyNotNullILm0ENS1_20ConstantVectorReaderIlEEJSF_ETnNSt9enable_ifIXneT_L_ZNSB_8num_argsEEEiE4typeELi0EEENS0_6StatusEmRlRbRT0_DpRKT1_: argument 0"}
!1683 = distinct !{!1683, !"_ZNK8facebook5velox4exec21SimpleFunctionAdapterINS0_4core9UDFHolderINS0_9functions19CombineHashFunctionINS1_10VectorExecEEES7_lNS0_15ConstantCheckerIJllEEEJllEEEE14doApplyNotNullILm0ENS1_20ConstantVectorReaderIlEEJSF_ETnNSt9enable_ifIXneT_L_ZNSB_8num_argsEEEiE4typeELi0EEENS0_6StatusEmRlRbRT0_DpRKT1_"}
!1684 = !{!1685}
!1685 = distinct !{!1685, !1680}
!1686 = !{!1687}
!1687 = distinct !{!1687, !1688, !"_ZNK8facebook5velox4exec21SimpleFunctionAdapterINS0_4core9UDFHolderINS0_9functions19CombineHashFunctionINS1_10VectorExecEEES7_lNS0_15ConstantCheckerIJllEEEJllEEEE14doApplyNotNullILm1EKNS1_20ConstantVectorReaderIlEEJlETnNSt9enable_ifIXneT_L_ZNSB_8num_argsEEEiE4typeELi0EEENS0_6StatusEmRlRbRT0_DpRKT1_: argument 0"}
!1688 = distinct !{!1688, !"_ZNK8facebook5velox4exec21SimpleFunctionAdapterINS0_4core9UDFHolderINS0_9functions19CombineHashFunctionINS1_10VectorExecEEES7_lNS0_15ConstantCheckerIJllEEEJllEEEE14doApplyNotNullILm1EKNS1_20ConstantVectorReaderIlEEJlETnNSt9enable_ifIXneT_L_ZNSB_8num_argsEEEiE4typeELi0EEENS0_6StatusEmRlRbRT0_DpRKT1_"}
!1689 = !{!1690}
