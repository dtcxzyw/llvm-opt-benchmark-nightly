...
bb.a:
  ...
  %i.c = alloca [24 x i8], align 16               ; 11 uses
...
bb.ah:                                            ; preds = %bb.ag
  ...
  %12 = load <8 x i8>, ptr %i.cq, align 4, !tbaa !33, !noalias !285 ; 4 uses
  %13 = shufflevector <8 x i8> %12, <8 x i8> poison, <2 x i32> <i32 4, i32 0> ; 2 uses
  %14 = zext <2 x i8> %13 to <2 x i64>
  %15 = shufflevector <8 x i8> %12, <8 x i8> poison, <2 x i32> <i32 5, i32 1>
  %16 = zext <2 x i8> %15 to <2 x i64>
  %17 = shufflevector <8 x i8> %12, <8 x i8> poison, <2 x i32> <i32 6, i32 2>
  %18 = zext <2 x i8> %17 to <2 x i64>
  %19 = shl nuw nsw <2 x i64> %14, splat (i64 24)
  %20 = shl nuw nsw <2 x i64> %16, splat (i64 16)
  %21 = shl nuw nsw <2 x i64> %18, splat (i64 8)
  %22 = shufflevector <8 x i8> %12, <8 x i8> poison, <2 x i32> <i32 7, i32 3>
  %23 = zext <2 x i8> %22 to <2 x i64>
  %24 = or disjoint <2 x i64> %20, %19
  %25 = or disjoint <2 x i64> %24, %21
  %26 = or disjoint <2 x i64> %25, %23            ; 3 uses
  %27 = or disjoint <2 x i64> %26, splat (i64 -4294967296)
  %28 = icmp slt <2 x i8> %13, zeroinitializer    ; 2 uses
  %29 = select <2 x i1> %28, <2 x i64> %27, <2 x i64> %26 ; 2 uses
  %30 = extractelement <2 x i64> %29, i64 0       ; 3 uses
  %31 = extractelement <2 x i64> %29, i64 1
  %i.dm = icmp slt i64 %30, %31
  %32 = extractelement <2 x i1> %28, i64 1
  %or.cond.i.i.i.i = or i1 %32, %i.dm
  br i1 %or.cond.i.i.i.i, label %_ZNSt10unique_ptrI8_IO_FILEPFiPS0_EED2Ev.exit89.i.i.i.i, label %bb.ai

bb.ai:                                            ; preds = %bb.ah
  %33 = extractelement <2 x i64> %26, i64 1       ; 2 uses
  %i.dn = call i32 @fseek(ptr noundef nonnull %i.da, i64 noundef %33, i32 noundef 0), !noalias !285
...
bb.al:                                            ; preds = %.lr.ph.i.i.i.i
  ...
  %i.ef = add nsw i64 %.0.i76.i.i.i.i, %30        ; 2 uses
