...
bb.d:                                             ; preds = %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit32, %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit, %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.thread, %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.thread57
  ...
  %i.an = getelementptr inbounds nuw i8, ptr %.068, i64 %.pn
...
bb.i:                                             ; preds = %.lr.ph.i46.2
  ...
  br i1 %i.an, label %.lr.ph.i52, label %bb.j
...
.lr.ph.i52:                                       ; preds = %bb.i
  ...
  br i1 %.not.i54, label %.lr.ph.i52.1, label %bb.j
...
.lr.ph.i52.1:                                     ; preds = %.lr.ph.i52
  ...
  br i1 %.not.i54.1, label %.lr.ph.i52.2, label %bb.j
...
.lr.ph.i52.2:                                     ; preds = %.lr.ph.i52.1
  ...
  br i1 %.not.i54.2, label %.lr.ph.i52.3, label %bb.j
...
.lr.ph.i52.3:                                     ; preds = %.lr.ph.i52.2
  ...
  br i1 %.not.i54.3, label %.lr.ph.i52.4, label %bb.j
...
.lr.ph.i52.4:                                     ; preds = %.lr.ph.i52.3
  ...
  %spec.select = select i1 %.not.i54.4, i64 8, i64 3
  br label %bb.j

bb.j:                                             ; preds = %.lr.ph.i52.4, %.lr.ph.i52, %.lr.ph.i52.1, %.lr.ph.i52.2, %.lr.ph.i52.3, %bb.i
  %.pn = phi i64 [ 3, %bb.i ], [ 3, %.lr.ph.i52 ], [ 3, %.lr.ph.i52.3 ], [ 3, %.lr.ph.i52.1 ], [ %spec.select, %.lr.ph.i52.4 ], [ 3, %.lr.ph.i52.2 ]
  %i.bd = getelementptr inbounds nuw i8, ptr %.035, i64 %.pn
