...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %i.ci = load i64, ptr %i.cb, align 8, !tbaa !49, !alias.scope !2797
  %broadcast.splatinsert73.a = insertelement <4 x i64> poison, i64 %i.ci, i64 0
  %i.cj = load i64, ptr %.sroa.2.0..sroa_idx.i.i.us.us21, align 8, !tbaa !49, !alias.scope !2797
  %broadcast.splatinsert = insertelement <4 x i64> poison, i64 %i.cj, i64 0
  %interleaved.vec = shufflevector <4 x i64> %broadcast.splatinsert73.a, <4 x i64> %broadcast.splatinsert, <8 x i32> <i32 0, i32 4, i32 0, i32 4, i32 0, i32 4, i32 0, i32 4> ; 4 uses
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %i.ct = load i64, ptr %i.cb, align 8, !tbaa !49, !alias.scope !2797
  %broadcast.splatinsert83.a = insertelement <2 x i64> poison, i64 %i.ct, i64 0
  %i.cu = load i64, ptr %.sroa.2.0..sroa_idx.i.i.us.us21, align 8, !tbaa !49, !alias.scope !2797
  %broadcast.splatinsert81 = insertelement <2 x i64> poison, i64 %i.cu, i64 0
  %invariant.gep = getelementptr [16 x i8], ptr %i.as, i64 %i.cc
  %interleaved.vec85 = shufflevector <2 x i64> %broadcast.splatinsert83.a, <2 x i64> %broadcast.splatinsert81, <4 x i32> <i32 0, i32 2, i32 0, i32 2>
