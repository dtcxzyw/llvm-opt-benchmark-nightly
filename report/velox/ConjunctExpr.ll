...
bb.c:                                             ; preds = %.lr.ph, %bb.b
  ...
  %i.r = getelementptr inbounds nuw [24 x i8], ptr %i.m, i64 %i.q ; 2 uses
  %i.s = getelementptr inbounds nuw i8, ptr %i.r, i64 16
  %i.t = load i64, ptr %i.s, align 8, !tbaa !324
  %1 = load i32, ptr %i.n, align 4, !tbaa !3
  %2 = sext i32 %1 to i64
  %3 = getelementptr inbounds nuw [24 x i8], ptr %i.m, i64 %2 ; 2 uses
  %4 = getelementptr inbounds nuw i8, ptr %3, i64 16
  %5 = load i64, ptr %4, align 8, !tbaa !324
  %6 = load <2 x i64>, ptr %i.r, align 8, !tbaa !169 ; 2 uses
  %7 = load <2 x i64>, ptr %3, align 8, !tbaa !169 ; 2 uses
  %8 = shufflevector <2 x i64> %6, <2 x i64> %7, <2 x i32> <i32 0, i32 2> ; 2 uses
  %9 = shufflevector <2 x i64> %6, <2 x i64> %7, <2 x i32> <i32 1, i32 3> ; 2 uses
  %10 = icmp eq <2 x i64> %8, %9
  %11 = uitofp i64 %5 to float
  %12 = uitofp i64 %i.t to float
  %13 = sub <2 x i64> %8, %9
  %14 = uitofp <2 x i64> %13 to <2 x float>
  %15 = select <2 x i1> %10, <2 x float> splat (float 1.000000e+00), <2 x float> %14
  %16 = insertelement <2 x float> poison, float %12, i64 0
  %17 = insertelement <2 x float> %16, float %11, i64 1
  %18 = fdiv <2 x float> %17, %15                 ; 2 uses
  %shift = shufflevector <2 x float> %18, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %19 = fcmp ogt <2 x float> %18, %shift
  %20 = extractelement <2 x i1> %19, i64 0
  br i1 %20, label %bb.d, label %bb.b
...
bb.g:                                             ; preds = %"_ZSt25__unguarded_linear_insertIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops14_Val_comp_iterIZN8facebook5velox4exec12ConjunctExpr18maybeReorderInputsEvE3$_0EEEvT_T0_.exit.i.i.i.i", %.lr.ph.i.i.i.i
  ...
  %i.aj = getelementptr inbounds nuw [24 x i8], ptr %.val.val.i.i.i.i.i, i64 %i.ai ; 2 uses
  %i.ak = getelementptr inbounds nuw i8, ptr %i.aj, i64 16
  %i.al = load i64, ptr %i.ak, align 8, !tbaa !324
  %i.am = getelementptr inbounds i8, ptr %.sroa.0.07.i.i.i.i, i64 -4 ; 2 uses
  %21 = load i32, ptr %i.am, align 4, !tbaa !3    ; 2 uses
  %22 = sext i32 %21 to i64
  %23 = getelementptr inbounds nuw [24 x i8], ptr %.val.val.i.i.i.i.i, i64 %22 ; 2 uses
  %24 = getelementptr inbounds nuw i8, ptr %23, i64 16
  %25 = load i64, ptr %24, align 8, !tbaa !324
  %26 = load <2 x i64>, ptr %i.aj, align 8, !tbaa !169 ; 2 uses
  %27 = load <2 x i64>, ptr %23, align 8, !tbaa !169 ; 2 uses
  %28 = shufflevector <2 x i64> %26, <2 x i64> %27, <2 x i32> <i32 0, i32 2> ; 2 uses
  %29 = shufflevector <2 x i64> %26, <2 x i64> %27, <2 x i32> <i32 1, i32 3> ; 2 uses
  %30 = icmp eq <2 x i64> %28, %29
  %31 = uitofp i64 %25 to float
  %32 = uitofp i64 %i.al to float
  %33 = sub <2 x i64> %28, %29
  %34 = uitofp <2 x i64> %33 to <2 x float>
  %35 = select <2 x i1> %30, <2 x float> splat (float 1.000000e+00), <2 x float> %34
  %36 = insertelement <2 x float> poison, float %32, i64 0
  %37 = insertelement <2 x float> %36, float %31, i64 1
  %38 = fdiv <2 x float> %37, %35                 ; 3 uses
  %39 = extractelement <2 x float> %38, i64 0
  %shift21 = shufflevector <2 x float> %38, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %40 = fcmp olt <2 x float> %38, %shift21
  %41 = extractelement <2 x i1> %40, i64 0
  br i1 %41, label %.lr.ph.i.i.i.i.i, label %"_ZSt25__unguarded_linear_insertIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops14_Val_comp_iterIZN8facebook5velox4exec12ConjunctExpr18maybeReorderInputsEvE3$_0EEEvT_T0_.exit.i.i.i.i"

.lr.ph.i.i.i.i.i:                                 ; preds = %bb.g, %.lr.ph.i.i.i.i.i
  %i.an = phi i32 [ %i.ao, %.lr.ph.i.i.i.i.i ], [ %21, %bb.g ]
  %.sroa.0.012.i.i.i.i.i = phi ptr [ %.sroa.0.0.i.i.i.i.i, %.lr.ph.i.i.i.i.i ], [ %i.am, %bb.g ] ; 3 uses
  ...
  %i.bb = fcmp olt float %39, %.0.i2.i.i.i.i.i.i.i
...
.lr.ph46:                                         ; preds = %.lr.ph, %bb.b
  ...
  %i.ae = getelementptr inbounds nuw [24 x i8], ptr %.val, i64 %i.ab ; 2 uses
  %i.af = getelementptr inbounds nuw i8, ptr %i.ae, i64 16
  %i.ag = load i64, ptr %i.af, align 8, !tbaa !324
  %4 = getelementptr inbounds nuw [24 x i8], ptr %.val, i64 %i.ad ; 2 uses
  %i.ah = getelementptr inbounds nuw i8, ptr %4, i64 16
  %i.ai = load i64, ptr %i.ah, align 8, !tbaa !324
  %5 = load <2 x i64>, ptr %i.ae, align 8, !tbaa !169 ; 2 uses
  %6 = load <2 x i64>, ptr %4, align 8, !tbaa !169 ; 2 uses
  %7 = shufflevector <2 x i64> %5, <2 x i64> %6, <2 x i32> <i32 0, i32 2> ; 2 uses
  %8 = shufflevector <2 x i64> %5, <2 x i64> %6, <2 x i32> <i32 1, i32 3> ; 2 uses
  %9 = icmp eq <2 x i64> %7, %8
  %10 = uitofp i64 %i.ai to float
  %11 = uitofp i64 %i.ag to float
  %12 = sub <2 x i64> %7, %8
  %13 = uitofp <2 x i64> %12 to <2 x float>
  %14 = select <2 x i1> %9, <2 x float> splat (float 1.000000e+00), <2 x float> %13
  %15 = insertelement <2 x float> poison, float %11, i64 0
  %16 = insertelement <2 x float> %15, float %10, i64 1
  %17 = fdiv <2 x float> %16, %14                 ; 2 uses
  %18 = extractelement <2 x float> %17, i64 0     ; 3 uses
  %19 = extractelement <2 x float> %17, i64 1     ; 3 uses
  %i.aj = fcmp olt float %18, %19
...
bb.d:                                             ; preds = %.lr.ph46
  %i.ax = fcmp olt float %19, %.0.i2.i.i31.i.i
...
bb.f:                                             ; preds = %bb.d
  %i.az = fcmp olt float %18, %.0.i2.i.i31.i.i
...
bb.i:                                             ; preds = %.lr.ph46
  %i.bb = fcmp olt float %18, %.0.i2.i.i31.i.i
...
bb.k:                                             ; preds = %bb.i
  %i.bd = fcmp olt float %19, %.0.i2.i.i31.i.i
...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %i.n = getelementptr inbounds nuw [24 x i8], ptr %.val.val, i64 %i.k ; 2 uses
  %i.o = getelementptr inbounds nuw i8, ptr %i.n, i64 16
  %i.p = load i64, ptr %i.o, align 8, !tbaa !324
  %5 = getelementptr inbounds nuw [24 x i8], ptr %.val.val, i64 %i.m ; 2 uses
  %i.q = getelementptr inbounds nuw i8, ptr %5, i64 16
  %i.r = load i64, ptr %i.q, align 8, !tbaa !324
  %6 = load <2 x i64>, ptr %i.n, align 8, !tbaa !169 ; 2 uses
  %7 = load <2 x i64>, ptr %5, align 8, !tbaa !169 ; 2 uses
  %8 = shufflevector <2 x i64> %6, <2 x i64> %7, <2 x i32> <i32 0, i32 2> ; 2 uses
  %9 = shufflevector <2 x i64> %6, <2 x i64> %7, <2 x i32> <i32 1, i32 3> ; 2 uses
  %10 = icmp eq <2 x i64> %8, %9
  %11 = uitofp i64 %i.r to float
  %12 = uitofp i64 %i.p to float
  %13 = sub <2 x i64> %8, %9
  %14 = uitofp <2 x i64> %13 to <2 x float>
  %15 = select <2 x i1> %10, <2 x float> splat (float 1.000000e+00), <2 x float> %14
  %16 = insertelement <2 x float> poison, float %12, i64 0
  ...
  %18 = fdiv <2 x float> %17, %15                 ; 2 uses
  %shift = shufflevector <2 x float> %18, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %19 = fcmp olt <2 x float> %18, %shift
  %20 = extractelement <2 x i1> %19, i64 0
  %spec.select = select i1 %20, i64 %i.h, i64 %i.f ; 4 uses
...
bb.b:                                             ; preds = %.lr.ph, %_ZSt13move_backwardIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEES6_ET0_T_S8_S7_.exit
  ...
  %i.i = getelementptr inbounds nuw [24 x i8], ptr %.val.val, i64 %i.f ; 2 uses
  %i.j = getelementptr inbounds nuw i8, ptr %i.i, i64 16
  %i.k = load i64, ptr %i.j, align 8, !tbaa !324
  %3 = getelementptr inbounds nuw [24 x i8], ptr %.val.val, i64 %i.h ; 2 uses
  %i.l = getelementptr inbounds nuw i8, ptr %3, i64 16
  %i.m = load i64, ptr %i.l, align 8, !tbaa !324
  %4 = load <2 x i64>, ptr %i.i, align 8, !tbaa !169 ; 2 uses
  %5 = load <2 x i64>, ptr %3, align 8, !tbaa !169 ; 2 uses
  %6 = shufflevector <2 x i64> %4, <2 x i64> %5, <2 x i32> <i32 0, i32 2> ; 2 uses
  %7 = shufflevector <2 x i64> %4, <2 x i64> %5, <2 x i32> <i32 1, i32 3> ; 2 uses
  %8 = icmp eq <2 x i64> %6, %7
  %9 = uitofp i64 %i.m to float
  %10 = uitofp i64 %i.k to float
  %11 = sub <2 x i64> %6, %7
  %12 = uitofp <2 x i64> %11 to <2 x float>
  %13 = select <2 x i1> %8, <2 x float> splat (float 1.000000e+00), <2 x float> %12
  %14 = insertelement <2 x float> poison, float %10, i64 0
  %15 = insertelement <2 x float> %14, float %9, i64 1
  %16 = fdiv <2 x float> %15, %13                 ; 3 uses
  %17 = extractelement <2 x float> %16, i64 0     ; 2 uses
  %shift = shufflevector <2 x float> %16, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %18 = fcmp olt <2 x float> %16, %shift
  %19 = extractelement <2 x i1> %18, i64 0
  br i1 %19, label %bb.c, label %bb.g
...
bb.g:                                             ; preds = %bb.b
  ...
  %i.aj = fcmp olt float %17, %.0.i2.i.i10.i
...
.lr.ph.i:                                         ; preds = %bb.g, %.lr.ph.i
  ...
  %i.ay = fcmp olt float %17, %.0.i2.i.i.i
