...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load131 = load <2 x i64>, ptr %i.e, align 8, !tbaa !16
...
.lr.ph.preheader.i.i:                             ; preds = %bb.b
  ...
  %i.x = tail call noalias ptr @malloc(i64 noundef %i.w) #17 ; 39 uses
...
vector.body137:                                   ; preds = %vector.body137, %vector.ph134
  ...
  %wide.load141 = load <2 x i64>, ptr %i.y, align 8, !tbaa !16
  %wide.load142 = load <2 x i64>, ptr %i.z, align 8, !tbaa !16
  ...
  br i1 %i.ac, label %middle.block144, label %vector.body137, !llvm.loop !57
...
.lr.ph137.i.i:                                    ; preds = %.lr.ph137.i.i, %.lr.ph137.i.i.preheader.new
  ...
  br i1 %niter.ncmp.3, label %._crit_edge142.i.i.loopexit.unr-lcssa, label %.lr.ph137.i.i, !llvm.loop !60
...
bb.ai:                                            ; preds = %bb.ai, %bb.ah
  ...
  br i1 %i.py, label %bb.ai, label %bb.aj, !llvm.loop !73

bb.aj:                                            ; preds = %bb.ai
  %i.qa = icmp ult i32 %.0202.i.i.i, 7
  br i1 %i.qa, label %ZDICT_analyzePos.exit.thread.i.i, label %bb.ak
...
.lr.ph346.preheader.i.i.i:                        ; preds = %bb.ak
  ...
  %load_initial150 = load i32, ptr %scevgep149, align 8 ; 2 uses
  %i.qb = add nsw i64 %wide.trip.count381.i.i.i, -7 ; 3 uses
  %xtraiter186 = and i64 %i.qb, 1
...
.lr.ph346.preheader.i.i.i.new:                    ; preds = %.lr.ph346.preheader.i.i.i
  %unroll_iter190 = and i64 %i.qb, -2
  br label %.lr.ph346.i.i.i

.lr.ph346.i.i.i:                                  ; preds = %.lr.ph346.i.i.i, %.lr.ph346.preheader.i.i.i.new
  %store_forwarded151 = phi i32 [ %load_initial150, %.lr.ph346.preheader.i.i.i.new ], [ %i.qq, %.lr.ph346.i.i.i ]
  %indvars.iv376.i.i.i = phi i64 [ 7, %.lr.ph346.preheader.i.i.i.new ], [ %indvars.iv.next377.i.i.i.1, %.lr.ph346.i.i.i ] ; 5 uses
  %niter191 = phi i64 [ 0, %.lr.ph346.preheader.i.i.i.new ], [ %niter191.next.1, %.lr.ph346.i.i.i ]
  ...
  %i.qj = add i32 %i.qi, %store_forwarded151      ; 2 uses
  store i32 %i.qj, ptr %i.qd, align 4, !tbaa !8
  ...
  store i32 %i.qq, ptr %i.qk, align 4, !tbaa !8
  ...
  br i1 %niter191.ncmp.1, label %._crit_edge347.i.i.i.loopexit.unr-lcssa, label %.lr.ph346.i.i.i, !llvm.loop !74

._crit_edge347.i.i.i.loopexit.unr-lcssa:          ; preds = %.lr.ph346.i.i.i
  %lcmp.mod188.not = icmp eq i64 %xtraiter186, 0
  br i1 %lcmp.mod188.not, label %._crit_edge347.i.i.i, label %.lr.ph346.i.i.i.epil.preheader

.lr.ph346.i.i.i.epil.preheader:                   ; preds = %._crit_edge347.i.i.i.loopexit.unr-lcssa, %.lr.ph346.preheader.i.i.i
  %store_forwarded151.epil.init = phi i32 [ %load_initial150, %.lr.ph346.preheader.i.i.i ], [ %i.qq, %._crit_edge347.i.i.i.loopexit.unr-lcssa ]
  ...
  %lcmp.mod189 = trunc i64 %i.qb to i1
  ...
  %i.qx = add i32 %i.qw, %store_forwarded151.epil.init
  store i32 %i.qx, ptr %i.qr, align 4, !tbaa !8
...
._crit_edge347._crit_edge.i.i.i:                  ; preds = %._crit_edge347.i.i.i
  ...
  %.pre.i.i.i = load i32, ptr %.phi.trans.insert.i.i.i, align 4, !tbaa !8
  br label %bb.am
...
bb.al:                                            ; preds = %._crit_edge347.i.i.i
  ...
  %i.ra = load i32, ptr %i.qz, align 4, !tbaa !8  ; 3 uses
  %i.rb = uitofp i32 %i.ra to double
  %i.rc = uitofp i32 %.0202.i.i.i to double
  %i.rd = fdiv double %i.rb, %i.rc
  %i.re = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.qy, ptr noundef nonnull @.str.36, i32 noundef %i.li, i32 noundef %.0202.i.i.i, i32 noundef %i.ra, double noundef %i.rd) #19 ; 0 uses
...
bb.am:                                            ; preds = %bb.al, %._crit_edge347._crit_edge.i.i.i
  ...
  br i1 %i.ri, label %.lr.ph354.preheader.i.i.i, label %ZDICT_analyzePos.exit.i.i
...
.lr.ph354.i.i.i:                                  ; preds = %._crit_edge351.i.i.i, %.lr.ph354.preheader.i.i.i
  ...
  %i.rl = load i32, ptr %i.rk, align 4, !tbaa !8  ; 3 uses
...
bb.an:                                            ; preds = %.lr.ph354.i.i.i
  ...
  %.014.val21.i297.i.i.i = load i64, ptr %i.ro, align 1, !tbaa !16 ; 2 uses
  %.012.val22.i298.i.i.i = load i64, ptr %i.lk, align 1, !tbaa !16 ; 2 uses
...
.lr.ph.i303.i.i.i:                                ; preds = %bb.an, %.lr.ph.i303.i.i.i
  ...
  %.014.val.i306.i.i.i = load i64, ptr %i.rq, align 1, !tbaa !16 ; 2 uses
  %.012.val.i307.i.i.i = load i64, ptr %i.rp, align 1, !tbaa !16 ; 2 uses
...
._crit_edge351.i.i.i:                             ; preds = %.lr.ph350.preheader.i.i.i, %bb.ao
  ...
  br i1 %exitcond393.not.i.i.i, label %ZDICT_analyzePos.exit.i.i, label %.lr.ph354.i.i.i, !llvm.loop !75
...
.preheader.i.i.i.i:                               ; preds = %.preheader.i112.preheader.i.i, %ZDICT_removeDictItem.exit.i.i.i
  %i.sl = phi i32 [ %i.ss, %ZDICT_removeDictItem.exit.i.i.i ], [ %i.sk, %.preheader.i112.preheader.i.i ] ; 3 uses
  %i.sm = phi i64 [ %i.sq, %ZDICT_removeDictItem.exit.i.i.i ], [ %i.si, %.preheader.i112.preheader.i.i ] ; 5 uses
  %.03544.i147.i.i = phi i32 [ %i.sl, %ZDICT_removeDictItem.exit.i.i.i ], [ %i.sh, %.preheader.i112.preheader.i.i ]
  %i.sn = load i32, ptr %i.x, align 4, !tbaa !9
...
.lr.ph.preheader.i.i.i.i:                         ; preds = %.preheader.i.i.i.i
  ...
  %7 = sub nsw i64 %wide.trip.count.i.i.i.i, %i.sm
  %xtraiter192 = and i64 %7, 1
  %lcmp.mod193.not = icmp eq i64 %xtraiter192, 0
  br i1 %lcmp.mod193.not, label %.lr.ph.i.i113.i.i.prol.loopexit, label %.lr.ph.i.i113.i.i.prol

.lr.ph.i.i113.i.i.prol:                           ; preds = %.lr.ph.preheader.i.i.i.i
  %8 = getelementptr inbounds nuw [12 x i8], ptr %i.x, i64 %i.sm
  %indvars.iv.next.i.i.i.i.prol = add nuw nsw i64 %i.sm, 1 ; 2 uses
  %9 = getelementptr inbounds nuw [12 x i8], ptr %i.x, i64 %indvars.iv.next.i.i.i.i.prol
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %8, ptr noundef nonnull align 4 dereferenceable(12) %9, i64 12, i1 false), !tbaa.struct !76
...
.lr.ph.i.i113.i.i.prol.loopexit:                  ; preds = %.lr.ph.i.i113.i.i.prol, %.lr.ph.preheader.i.i.i.i
  ...
  %10 = add nsw i64 %wide.trip.count.i.i.i.i, -1
  %11 = icmp eq i64 %i.sm, %10
  br i1 %11, label %._crit_edge.loopexit.i.i.i.i, label %.lr.ph.i.i113.i.i
...
.lr.ph.i.i113.i.i:                                ; preds = %.lr.ph.i.i113.i.i.prol.loopexit, %.lr.ph.i.i113.i.i
  ...
  %12 = getelementptr inbounds nuw [12 x i8], ptr %i.x, i64 %indvars.iv.i.i.i.i
  %indvars.iv.next.i.i.i.i = add nuw nsw i64 %indvars.iv.i.i.i.i, 1 ; 2 uses
  %13 = getelementptr inbounds nuw [12 x i8], ptr %i.x, i64 %indvars.iv.next.i.i.i.i
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %12, ptr noundef nonnull align 4 dereferenceable(12) %13, i64 12, i1 false), !tbaa.struct !76
  %14 = getelementptr inbounds nuw [12 x i8], ptr %i.x, i64 %indvars.iv.next.i.i.i.i
  %indvars.iv.next.i.i.i.i.1 = add nuw nsw i64 %indvars.iv.i.i.i.i, 2 ; 3 uses
  %15 = getelementptr inbounds nuw [12 x i8], ptr %i.x, i64 %indvars.iv.next.i.i.i.i.1
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %14, ptr noundef nonnull align 4 dereferenceable(12) %15, i64 12, i1 false), !tbaa.struct !76
  %exitcond.not.i.i.i.i.1 = icmp eq i64 %indvars.iv.next.i.i.i.i.1, %wide.trip.count.i.i.i.i
  br i1 %exitcond.not.i.i.i.i.1, label %._crit_edge.loopexit.i.i.i.i, label %.lr.ph.i.i113.i.i, !llvm.loop !77
...
ZDICT_removeDictItem.exit.i.i.i:                  ; preds = %._crit_edge.loopexit.i.i.i.i, %.preheader.i.i.i.i
  ...
  %.sroa.0.0.copyload.i.i.i = load i64, ptr %i.sr, align 4
  %.sroa.2.0..sroa_idx.i.i.i = getelementptr inbounds nuw i8, ptr %i.sr, i64 8
  %.sroa.2.0.copyload.i.i.i = load i32, ptr %.sroa.2.0..sroa_idx.i.i.i, align 4
  %i.ss = tail call fastcc i32 @ZDICT_tryMerge(ptr noundef nonnull %i.x, i64 %.sroa.0.0.copyload.i.i.i, i32 %.sroa.2.0.copyload.i.i.i, i32 noundef %i.sl, ptr noundef nonnull readonly %i.o) ; 2 uses
  %.not43.i.i.i = icmp eq i32 %i.ss, 0
  br i1 %.not43.i.i.i, label %ZDICT_insertDictItem.exit.i.i, label %.preheader.i.i.i.i, !llvm.loop !78

bb.ap:                                            ; preds = %ZDICT_analyzePos.exit.i.i
  %i.st = load i32, ptr %i.x, align 4, !tbaa !9
  %spec.select.i114.i.i = tail call i32 @llvm.umin.i32(i32 %i.st, i32 %i.fv) ; 4 uses
  %.03445.i.i.i = add i32 %spec.select.i114.i.i, -1 ; 2 uses
  %i.su = zext i32 %.03445.i.i.i to i64
  ...
  br i1 %i.sy, label %.lr.ph.i116.i.i, label %._crit_edge.i115.i.i

.lr.ph.i116.i.i:                                  ; preds = %bb.ap, %.lr.ph.i116.i.i
  %i.sz = phi ptr [ %i.td, %.lr.ph.i116.i.i ], [ %i.sv, %bb.ap ]
  ...
  %i.ta = zext i32 %.034.in46.i.i.i to i64
  %i.tb = getelementptr inbounds nuw [12 x i8], ptr %i.x, i64 %i.ta
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %i.tb, ptr noundef nonnull align 4 dereferenceable(12) %i.sz, i64 12, i1 false), !tbaa.struct !76
  %.034.i.i.i = add i32 %.03447.i.i.i, -1         ; 2 uses
  %i.tc = zext i32 %.034.i.i.i to i64
  %i.td = getelementptr inbounds nuw [12 x i8], ptr %i.x, i64 %i.tc ; 2 uses
  %i.te = getelementptr inbounds nuw i8, ptr %i.td, i64 8
  %i.tf = load i32, ptr %i.te, align 4, !tbaa !12
  %i.tg = icmp ult i32 %i.tf, %i.rh
  br i1 %i.tg, label %.lr.ph.i116.i.i, label %._crit_edge.i115.i.i, !llvm.loop !79
...
._crit_edge.i115.i.i:                             ; preds = %.lr.ph.i116.i.i, %bb.ap
  ...
  %i.th = zext i32 %.034.in.lcssa.i.i.i to i64
  ...
  %i.tj = add nuw i32 %spec.select.i114.i.i, 1
  store i32 %i.tj, ptr %i.x, align 4, !tbaa !9
...
bb.au:                                            ; preds = %bb.at, %bb.as, %ZDICT_insertDictItem.exit.i.i, %ZDICT_analyzePos.exit.thread.i.i, %bb.p
  %.1102.i.i = phi i32 [ %i.ga, %bb.p ], [ %i.sd, %ZDICT_analyzePos.exit.thread.i.i ], [ %i.tk, %bb.as ], [ %i.tk, %bb.at ], [ %i.tk, %ZDICT_insertDictItem.exit.i.i ] ; 2 uses
  ...
  %i.ty = zext i32 %.1102.i.i to i64              ; 2 uses
  %i.tz = icmp samesign ugt i64 %.093.lcssa.i.i, %i.ty
  br i1 %i.tz, label %bb.o, label %ZDICT_trainBuffer_legacy.exit.loopexit.i
...
ZDICT_trainBuffer_legacy.exit.i:                  ; preds = %ZDICT_trainBuffer_legacy.exit.loopexit.i, %.thread.i.i, %bb.k, %bb.g
  ...
  %i.ua = icmp ugt i32 %.sroa.5.0.copyload, 2
...
bb.av:                                            ; preds = %ZDICT_trainBuffer_legacy.exit.i
  ...
  br i1 %i.ub, label %.lr.ph.preheader.i194.i, label %ZDICT_dictSize.exit224.thread.critedge.i
...
.lr.ph.preheader.i194.i:                          ; preds = %bb.av
  ...
  %xtraiter196 = and i64 %i.uc, 3                 ; 3 uses
...
.lr.ph.i196.i:                                    ; preds = %.lr.ph.i196.i, %.lr.ph.preheader.i194.i.new
  ...
  %niter202 = phi i64 [ 0, %.lr.ph.preheader.i194.i.new ], [ %niter202.next.3, %.lr.ph.i196.i ]
  ...
  br i1 %niter202.ncmp.3, label %.critedge.i.unr-lcssa, label %.lr.ph.i196.i, !llvm.loop !80

.critedge.i.unr-lcssa:                            ; preds = %.lr.ph.i196.i
  %lcmp.mod198.not = icmp eq i64 %xtraiter196, 0
  br i1 %lcmp.mod198.not, label %.critedge.i, label %.lr.ph.i196.i.epil.preheader
...
.lr.ph.i196.i.epil:                               ; preds = %.lr.ph.i196.i.epil, %.lr.ph.i196.i.epil.preheader
  ...
  %epil.iter197 = phi i64 [ 0, %.lr.ph.i196.i.epil.preheader ], [ %epil.iter197.next, %.lr.ph.i196.i.epil ]
  ...
  br i1 %epil.iter197.cmp.not, label %.critedge.i, label %.lr.ph.i196.i.epil, !llvm.loop !81

.critedge.i:                                      ; preds = %.lr.ph.i196.i.epil, %.critedge.i.unr-lcssa
  %.lcssa156 = phi i32 [ %i.uu, %.critedge.i.unr-lcssa ], [ %i.uy, %.lr.ph.i196.i.epil ]
  %i.uz = load ptr, ptr @stderr, align 8, !tbaa !13
  %i.va = add i32 %.pre.i, -1
  %i.vb = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.uz, ptr noundef nonnull @.str.18, i32 noundef %i.va, i32 noundef %.lcssa156) #19 ; 0 uses
  %i.vc = load ptr, ptr @stderr, align 8, !tbaa !13
  %i.vd = tail call i32 @fflush(ptr noundef %i.vc) ; 0 uses
  %i.ve = load ptr, ptr @stderr, align 8, !tbaa !13
  %i.vf = add nsw i32 %spec.select.i, -1
  %i.vg = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.ve, ptr noundef nonnull @.str.19, i32 noundef %i.vf) #19 ; 0 uses
  %i.vh = load ptr, ptr @stderr, align 8, !tbaa !13
...
bb.aw:                                            ; preds = %.lr.ph.i22
  ...
  %i.vt = load ptr, ptr @stderr, align 8, !tbaa !13
  ...
  %i.vx = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.vt, ptr noundef nonnull @.str.20, i32 noundef %i.vw, i32 noundef %i.vm, i32 noundef %i.vk, i32 noundef %i.vv) #19 ; 0 uses
  %i.vy = load ptr, ptr @stderr, align 8, !tbaa !13
...
.lr.ph.i201.i:                                    ; preds = %bb.aw, %.lr.ph.i201.i
  ...
  br i1 %exitcond.not.i204.i, label %.loopexit.i, label %.lr.ph.i201.i, !llvm.loop !82

.loopexit.i:                                      ; preds = %.lr.ph.i201.i, %bb.aw
  %i.wk = load ptr, ptr @stderr, align 8, !tbaa !13
  %i.wl = tail call i64 @fwrite(ptr nonnull @.str.21, i64 3, i64 1, ptr %i.wk) #20 ; 0 uses
  %i.wm = load ptr, ptr @stderr, align 8, !tbaa !13
  ...
  br i1 %exitcond.not.i25, label %.critedge179.i, label %.lr.ph.i22, !llvm.loop !83
...
.lr.ph.preheader.i217.i:                          ; preds = %.critedge179.i
  ...
  %xtraiter203 = and i64 %i.wp, 3                 ; 3 uses
...
.lr.ph.i219.i:                                    ; preds = %.lr.ph.i219.i, %.lr.ph.preheader.i217.i.new
  ...
  br i1 %niter209.ncmp.3, label %ZDICT_dictSize.exit224.i.unr-lcssa, label %.lr.ph.i219.i, !llvm.loop !80

ZDICT_dictSize.exit224.i.unr-lcssa:               ; preds = %.lr.ph.i219.i
  %lcmp.mod205.not = icmp eq i64 %xtraiter203, 0
  br i1 %lcmp.mod205.not, label %ZDICT_dictSize.exit224.i, label %.lr.ph.i219.i.epil.preheader
...
.lr.ph.i219.i.epil.preheader:                     ; preds = %ZDICT_dictSize.exit224.i.unr-lcssa, %.lr.ph.preheader.i217.i
  ...
  %.08.i221.i.epil.init = phi i32 [ 0, %.lr.ph.preheader.i217.i ], [ %i.xh, %ZDICT_dictSize.exit224.i.unr-lcssa ]
  %lcmp.mod207 = icmp ne i64 %xtraiter203, 0
...
.lr.ph.i219.i.epil:                               ; preds = %.lr.ph.i219.i.epil, %.lr.ph.i219.i.epil.preheader
  ...
  %epil.iter204 = phi i64 [ 0, %.lr.ph.i219.i.epil.preheader ], [ %epil.iter204.next, %.lr.ph.i219.i.epil ]
  ...
  %epil.iter204.next = add i64 %epil.iter204, 1   ; 2 uses
  %epil.iter204.cmp.not = icmp eq i64 %epil.iter204.next, %xtraiter203
  br i1 %epil.iter204.cmp.not, label %ZDICT_dictSize.exit224.i, label %.lr.ph.i219.i.epil, !llvm.loop !84

ZDICT_dictSize.exit224.i:                         ; preds = %.lr.ph.i219.i.epil, %ZDICT_dictSize.exit224.i.unr-lcssa
  %.lcssa = phi i32 [ %i.xh, %ZDICT_dictSize.exit224.i.unr-lcssa ], [ %i.xl, %.lr.ph.i219.i.epil ] ; 4 uses
...
ZDICT_dictSize.exit224.thread.critedge.i:         ; preds = %bb.av
  %i.xn = load ptr, ptr @stderr, align 8, !tbaa !13
  %i.xo = add nsw i32 %.pre.i, -1
  %i.xp = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.xn, ptr noundef nonnull @.str.18, i32 noundef %i.xo, i32 noundef 0) #19 ; 0 uses
  %i.xq = load ptr, ptr @stderr, align 8, !tbaa !13
  %i.xr = tail call i32 @fflush(ptr noundef %i.xq) ; 0 uses
  %i.xs = load ptr, ptr @stderr, align 8, !tbaa !13
  %i.xt = add nsw i32 %spec.select.i, -1
  %i.xu = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.xs, ptr noundef nonnull @.str.19, i32 noundef %i.xt) #19 ; 0 uses
  %i.xv = load ptr, ptr @stderr, align 8, !tbaa !13
...
bb.ay:                                            ; preds = %bb.ax
  %i.ya = load ptr, ptr @stderr, align 8, !tbaa !13
  %i.yb = trunc i64 %1 to i32
  %i.yc = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.ya, ptr noundef nonnull @.str.22, i32 noundef %.lcssa, i32 noundef %i.yb) #19 ; 0 uses
  %i.yd = load ptr, ptr @stderr, align 8, !tbaa !13
  %i.ye = tail call i32 @fflush(ptr noundef %i.yd) ; 0 uses
  %i.yf = mul i64 %1, 10
  %i.yg = icmp ult i64 %.lcssa128, %i.yf
  br i1 %i.yg, label %bb.az, label %bb.ba

bb.az:                                            ; preds = %bb.ay
  %i.yh = load ptr, ptr @stderr, align 8, !tbaa !13
  %i.yi = lshr i64 %.lcssa128, 20
  %i.yj = trunc i64 %i.yi to i32
  %i.yk = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.yh, ptr noundef nonnull @.str.23, i32 noundef %i.yj) #19 ; 0 uses
  %i.yl = load ptr, ptr @stderr, align 8, !tbaa !13
...
bb.bb:                                            ; preds = %bb.ba
  %i.yo = load ptr, ptr @stderr, align 8, !tbaa !13
  %i.yp = add i32 %i.ai, 1
  %i.yq = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.yo, ptr noundef nonnull @.str.24, i32 noundef %i.yp) #19 ; 0 uses
  %i.yr = load ptr, ptr @stderr, align 8, !tbaa !13
  %i.ys = tail call i32 @fflush(ptr noundef %i.yr) ; 0 uses
  %i.yt = load ptr, ptr @stderr, align 8, !tbaa !13
  %i.yu = tail call i64 @fwrite(ptr nonnull @.str.25, i64 90, i64 1, ptr %i.yt) #20 ; 0 uses
...
.preheader.i:                                     ; preds = %.critedge181.i, %.preheader.i
  ...
  br i1 %i.zc, label %.preheader.i, label %bb.bc, !llvm.loop !85

bb.bc:                                            ; preds = %.preheader.i
  br i1 %i.ax, label %.critedge183.i, label %.lr.ph261.i.preheader

.critedge183.i:                                   ; preds = %bb.bc
  %i.zd = load ptr, ptr @stderr, align 8, !tbaa !13
  %i.ze = trunc i64 %1 to i32
  %i.zf = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.zd, ptr noundef nonnull @.str.26, i32 noundef %.lcssa, i32 noundef %i.ze) #19 ; 0 uses
  %i.zg = load ptr, ptr @stderr, align 8, !tbaa !13
  %i.zh = tail call i32 @fflush(ptr noundef %i.zg) ; 0 uses
  %i.zi = load ptr, ptr @stderr, align 8, !tbaa !13
  %i.zj = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.zi, ptr noundef nonnull @.str.27, i32 noundef %.0150.i) #19 ; 0 uses
  ...
  %i.zn = tail call i64 @fwrite(ptr nonnull @.str.28, i64 54, i64 1, ptr %i.zm) #20 ; 0 uses
...
bb.bd:                                            ; preds = %.lr.ph261.i
  ...
  br i1 %exitcond293.not.i, label %.lr.ph270.preheader.i, label %.lr.ph261.i, !llvm.loop !86
...
bb.be:                                            ; preds = %.lr.ph270.i
  %i.aad = load i32, ptr %i.zx, align 4, !tbaa !9
  ...
  br i1 %exitcond298.not.i, label %._crit_edge271.i, label %.lr.ph270.i, !llvm.loop !87
...
.thread233.sink.split.i:                          ; preds = %.lr.ph.i22, %.lr.ph270.i, %._crit_edge271.i, %ZDICT_dictSize.exit224.thread.critedge.i, %ZDICT_dictSize.exit224.i, %.critedge179.i, %bb.d, %bb.c
  %.8.ph.i = phi i64 [ -1, %.lr.ph270.i ], [ -34, %ZDICT_dictSize.exit224.i ], [ -34, %bb.d ], [ %i.aah, %._crit_edge271.i ], [ -70, %bb.c ], [ -34, %ZDICT_dictSize.exit224.thread.critedge.i ], [ -34, %.critedge179.i ], [ -1, %.lr.ph.i22 ]
...
bb.a:
  ...
  store i32 8, ptr %i.a, align 4, !tbaa !88
  %i.b = getelementptr inbounds nuw i8, ptr %5, i64 12
  store i32 4, ptr %i.b, align 4, !tbaa !91
  %i.c = getelementptr inbounds nuw i8, ptr %5, i64 44
  store i32 3, ptr %i.c, align 4, !tbaa !92
...
bb.d:                                             ; preds = %.lr.ph203
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %i.ad, ptr noundef nonnull align 4 dereferenceable(12) %i.z, i64 12, i1 false), !tbaa.struct !76
  %i.ae = and i64 %indvars.iv.next225, 4294967294
  %.not249 = icmp eq i64 %i.ae, 0
  br i1 %.not249, label %.critedge, label %.lr.ph203, !llvm.loop !93
...
bb.e:                                             ; preds = %bb.b, %.lr.ph
  ...
  br i1 %exitcond.not, label %.lr.ph197, label %.lr.ph, !llvm.loop !94
...
bb.k:                                             ; preds = %.lr.ph199
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %i.bg, ptr noundef nonnull align 4 dereferenceable(12) %i.bc, i64 12, i1 false), !tbaa.struct !76
  %i.bh = and i64 %indvars.iv.next237, 4294967294
  %.not250 = icmp eq i64 %i.bh, 0
  br i1 %.not250, label %.critedge2, label %.lr.ph199, !llvm.loop !95
...
bb.l:                                             ; preds = %bb.g
  ...
  %.val166 = load i64, ptr %i.bm, align 1, !tbaa !16
  %.val = load i64, ptr %i.g, align 1, !tbaa !16
  %i.bn = icmp eq i64 %.val166, %.val
  br i1 %i.bn, label %bb.m, label %isIncluded.exit
...
bb.n:                                             ; preds = %.lr.ph.i
  ...
  br i1 %exitcond.not.i, label %isIncluded.exit.thread, label %.lr.ph.i, !llvm.loop !96
...
isIncluded.exit.thread:                           ; preds = %bb.m, %bb.n
  ...
  store i32 %.sroa.0102.sroa.0.0.extract.trunc, ptr %i.aj, align 4, !tbaa !9
...
isIncluded.exit:                                  ; preds = %.lr.ph.i, %bb.l, %bb.f
  ...
  br i1 %exitcond232.not, label %.loopexit, label %bb.f, !llvm.loop !97

.loopexit:                                        ; preds = %isIncluded.exit, %bb.a, %isIncluded.exit.thread, %.critedge2, %.critedge
  %.0 = phi i32 [ %.1.lcssa, %.critedge ], [ %.3.lcssa, %.critedge2 ], [ %.2196218, %isIncluded.exit.thread ], [ 0, %bb.a ], [ 0, %isIncluded.exit ]
  ret i32 %.0
}
...
!74 = distinct !{!74, !19}
!75 = distinct !{!75, !19}
!76 = !{i64 0, i64 4, !8, i64 4, i64 4, !8, i64 8, i64 4, !8}
!77 = distinct !{!77, !19}
!78 = distinct !{!78, !19}
!79 = distinct !{!79, !19}
!80 = distinct !{!80, !19}
...
!87 = distinct !{!87, !19}
!88 = !{!89, !5, i64 4}
!89 = !{!"", !5, i64 0, !5, i64 4, !5, i64 8, !5, i64 12, !5, i64 16, !90, i64 24, !5, i64 32, !5, i64 36, !5, i64 40, !10, i64 44}
!90 = !{!"double", !6, i64 0}
!91 = !{!89, !5, i64 12}
!92 = !{!89, !5, i64 44}
!93 = distinct !{!93, !19}
