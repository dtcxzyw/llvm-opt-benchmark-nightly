...
begin_hunk_0_@_ZSt22__move_median_to_firstIN9__gnu_cxx17__normal_iteratorIPSt5tupleIJmmmEESt6vectorIS3_SaIS3_EEEENS0_5__ops15_Iter_less_iterEEvT_SB_SB_SB_T0_:bb.a
  %i.c = load i64, ptr %i.a, align 8, !tbaa !59   ; 8 uses
  %i.d = load i64, ptr %i.b, align 8, !tbaa !59   ; 8 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.i = load i64, ptr %i.g, align 8, !tbaa !59   ; 2 uses
  %i.j = load i64, ptr %i.h, align 8, !tbaa !59   ; 2 uses
  %i.k = icmp eq i64 %i.i, %i.j
  %i.l = icmp ult i64 %i.i, %i.j
  br i1 %i.k, label %bb.c, label %_ZNK9__gnu_cxx5__ops15_Iter_less_iterclINS_17__normal_iteratorIPSt5tupleIJmmmEESt6vectorIS5_SaIS5_EEEESA_EEbT_T0_.exit

bb.c:                                             ; preds = %bb.b
  %i.m = load i64, ptr %1, align 8, !tbaa !59
  %i.n = load i64, ptr %2, align 8, !tbaa !59
...
_ZNK9__gnu_cxx5__ops15_Iter_less_iterclINS_17__normal_iteratorIPSt5tupleIJmmmEESt6vectorIS5_SaIS5_EEEESA_EEbT_T0_.exit: ; preds = %bb.a, %bb.b
  ...
  br i1 %.sroa.06.0.i.i.i, label %bb.d, label %bb.m

bb.d:                                             ; preds = %bb.c, %_ZNK9__gnu_cxx5__ops15_Iter_less_iterclINS_17__normal_iteratorIPSt5tupleIJmmmEESt6vectorIS5_SaIS5_EEEESA_EEbT_T0_.exit
  %i.p = getelementptr inbounds nuw i8, ptr %3, i64 16 ; 2 uses
  %i.q = load i64, ptr %i.p, align 8, !tbaa !59   ; 5 uses
  %i.r = icmp eq i64 %i.d, %i.q
  %i.s = icmp ult i64 %i.d, %i.q
  br i1 %i.r, label %bb.e, label %_ZNK9__gnu_cxx5__ops15_Iter_less_iterclINS_17__normal_iteratorIPSt5tupleIJmmmEESt6vectorIS5_SaIS5_EEEESA_EEbT_T0_.exit27

bb.e:                                             ; preds = %bb.d
  %i.t = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.u = getelementptr inbounds nuw i8, ptr %3, i64 8
  %i.v = load i64, ptr %i.t, align 8, !tbaa !59   ; 2 uses
  %i.w = load i64, ptr %i.u, align 8, !tbaa !59   ; 2 uses
  %i.x = icmp eq i64 %i.v, %i.w
  %i.y = icmp ult i64 %i.v, %i.w
  br i1 %i.x, label %bb.f, label %_ZNK9__gnu_cxx5__ops15_Iter_less_iterclINS_17__normal_iteratorIPSt5tupleIJmmmEESt6vectorIS5_SaIS5_EEEESA_EEbT_T0_.exit27

bb.f:                                             ; preds = %bb.e
  %i.z = load i64, ptr %2, align 8, !tbaa !59
  %i.aa = load i64, ptr %3, align 8, !tbaa !59
  %i.ab = icmp ult i64 %i.z, %i.aa
  br i1 %i.ab, label %bb.g, label %bb.h

_ZNK9__gnu_cxx5__ops15_Iter_less_iterclINS_17__normal_iteratorIPSt5tupleIJmmmEESt6vectorIS5_SaIS5_EEEESA_EEbT_T0_.exit27: ; preds = %bb.d, %bb.e
...
vector.ph:                                        ; preds = %.lr.ph.preheader.i.i.i.i.i
  ...
  %i.ac = getelementptr i8, ptr %.sroa.07.018, i64 %i.aa
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.ad = mul i64 %index, -24                     ; 2 uses
  %next.gep = getelementptr i8, ptr %i.x, i64 %i.ad
  %next.gep29 = getelementptr i8, ptr %.sroa.07.018, i64 %i.ad
  %i.ae = getelementptr inbounds i8, ptr %next.gep29, i64 -96
  %interleaved.vec = load <12 x i64>, ptr %i.ae, align 8, !tbaa !59
  %i.af = getelementptr inbounds i8, ptr %next.gep, i64 -96
  store <12 x i64> %interleaved.vec, ptr %i.af, align 8, !tbaa !59
...
.lr.ph.i.i.i.i.i.preheader:                       ; preds = %.lr.ph.preheader.i.i.i.i.i, %middle.block
  %.010.i.i.i.i.i.ph = phi i64 [ %i.y, %.lr.ph.preheader.i.i.i.i.i ], [ %i.z, %middle.block ]
  %.069.i.i.i.i.i.ph = phi ptr [ %i.x, %.lr.ph.preheader.i.i.i.i.i ], [ %i.ab, %middle.block ]
  %.078.i.i.i.i.i.ph = phi ptr [ %.sroa.07.018, %.lr.ph.preheader.i.i.i.i.i ], [ %i.ac, %middle.block ]
  br label %.lr.ph.i.i.i.i.i

.lr.ph.i.i.i.i.i:                                 ; preds = %.lr.ph.i.i.i.i.i.preheader, %.lr.ph.i.i.i.i.i
  %.010.i.i.i.i.i = phi i64 [ %i.aq, %.lr.ph.i.i.i.i.i ], [ %.010.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.preheader ] ; 2 uses
  %.069.i.i.i.i.i = phi ptr [ %i.ai, %.lr.ph.i.i.i.i.i ], [ %.069.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.preheader ] ; 3 uses
  %.078.i.i.i.i.i = phi ptr [ %i.ah, %.lr.ph.i.i.i.i.i ], [ %.078.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.preheader ] ; 3 uses
  %i.ah = getelementptr inbounds i8, ptr %.078.i.i.i.i.i, i64 -24 ; 2 uses
  %i.ai = getelementptr inbounds i8, ptr %.069.i.i.i.i.i, i64 -24 ; 2 uses
  %i.aj = getelementptr inbounds i8, ptr %.078.i.i.i.i.i, i64 -8
  %i.ak = load i64, ptr %i.aj, align 8, !tbaa !59
  %i.al = getelementptr inbounds i8, ptr %.069.i.i.i.i.i, i64 -8
  store i64 %i.ak, ptr %i.al, align 8, !tbaa !59
  %i.am = getelementptr inbounds i8, ptr %.078.i.i.i.i.i, i64 -16
  %i.an = load i64, ptr %i.am, align 8, !tbaa !59
  %i.ao = getelementptr inbounds i8, ptr %.069.i.i.i.i.i, i64 -16
  store i64 %i.an, ptr %i.ao, align 8, !tbaa !59
  %i.ap = load i64, ptr %i.ah, align 8, !tbaa !59
  store i64 %i.ap, ptr %i.ai, align 8, !tbaa !59
  %i.aq = add nsw i64 %.010.i.i.i.i.i, -1
  %i.ar = icmp samesign ugt i64 %.010.i.i.i.i.i, 1
  br i1 %i.ar, label %.lr.ph.i.i.i.i.i, label %_ZSt13move_backwardIN9__gnu_cxx17__normal_iteratorIPSt5tupleIJmmmEESt6vectorIS3_SaIS3_EEEES8_ET0_T_SA_S9_.exit, !llvm.loop !204
...
_ZNK9__gnu_cxx5__ops15_Iter_less_iterclINS_17__normal_iteratorIPSt5tupleIJmmmEESt6vectorIS5_SaIS5_EEEESA_EEbT_T0_.exit._crit_edge: ; preds = %_ZNK9__gnu_cxx5__ops15_Iter_less_iterclINS_17__normal_iteratorIPSt5tupleIJmmmEESt6vectorIS5_SaIS5_EEEESA_EEbT_T0_.exit, %bb.d
  %i.as = phi i64 [ %i.l, %bb.d ], [ %.pre, %_ZNK9__gnu_cxx5__ops15_Iter_less_iterclINS_17__normal_iteratorIPSt5tupleIJmmmEESt6vectorIS5_SaIS5_EEEESA_EEbT_T0_.exit ] ; 4 uses
  %i.at = phi i64 [ %i.p, %bb.d ], [ %.pre20, %_ZNK9__gnu_cxx5__ops15_Iter_less_iterclINS_17__normal_iteratorIPSt5tupleIJmmmEESt6vectorIS5_SaIS5_EEEESA_EEbT_T0_.exit ] ; 2 uses
  br label %bb.e
...
bb.e:                                             ; preds = %bb.h, %_ZNK9__gnu_cxx5__ops15_Iter_less_iterclINS_17__normal_iteratorIPSt5tupleIJmmmEESt6vectorIS5_SaIS5_EEEESA_EEbT_T0_.exit._crit_edge
  ...
  %i.av = load i64, ptr %i.au, align 8, !tbaa !59 ; 3 uses
  %i.aw = icmp eq i64 %i.g, %i.av
  %i.ax = icmp ult i64 %i.g, %i.av
  br i1 %i.aw, label %bb.f, label %_ZNK9__gnu_cxx5__ops14_Val_less_iterclISt5tupleIJmmmEENS_17__normal_iteratorIPS4_St6vectorIS4_SaIS4_EEEEEEbRT_T0_.exit.i
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.bb = icmp ult i64 %i.as, %i.az
  br i1 %i.ba, label %bb.g, label %_ZNK9__gnu_cxx5__ops14_Val_less_iterclISt5tupleIJmmmEENS_17__normal_iteratorIPS4_St6vectorIS4_SaIS4_EEEEEEbRT_T0_.exit.i

bb.g:                                             ; preds = %bb.f
  %i.bc = load i64, ptr %.sroa.0.0.i, align 8, !tbaa !59 ; 2 uses
  %i.bd = icmp ult i64 %i.at, %i.bc
  %i.be = insertelement <2 x i64> poison, i64 %i.bc, i64 0
  %i.bf = insertelement <2 x i64> %i.be, i64 %i.as, i64 1
  br i1 %i.bd, label %bb.h, label %_ZSt25__unguarded_linear_insertIN9__gnu_cxx17__normal_iteratorIPSt5tupleIJmmmEESt6vectorIS3_SaIS3_EEEENS0_5__ops14_Val_less_iterEEvT_T0_.exit
...
_ZNK9__gnu_cxx5__ops14_Val_less_iterclISt5tupleIJmmmEENS_17__normal_iteratorIPS4_St6vectorIS4_SaIS4_EEEEEEbRT_T0_.exit.i: ; preds = %bb.f, %bb.e
  %.sroa.06.0.i.i.i.i = phi i1 [ %i.ax, %bb.e ], [ %i.bb, %bb.f ]
...
_ZNK9__gnu_cxx5__ops14_Val_less_iterclISt5tupleIJmmmEENS_17__normal_iteratorIPS4_St6vectorIS4_SaIS4_EEEEEEbRT_T0_.exit._crit_edge.i: ; preds = %_ZNK9__gnu_cxx5__ops14_Val_less_iterclISt5tupleIJmmmEENS_17__normal_iteratorIPS4_St6vectorIS4_SaIS4_EEEEEEbRT_T0_.exit.i
  %i.bg = load <2 x i64>, ptr %.sroa.0.0.i, align 8, !tbaa !59
  br label %bb.h
...
bb.h:                                             ; preds = %_ZNK9__gnu_cxx5__ops14_Val_less_iterclISt5tupleIJmmmEENS_17__normal_iteratorIPS4_St6vectorIS4_SaIS4_EEEEEEbRT_T0_.exit._crit_edge.i, %bb.g
  %i.bh = phi <2 x i64> [ %i.bg, %_ZNK9__gnu_cxx5__ops14_Val_less_iterclISt5tupleIJmmmEENS_17__normal_iteratorIPS4_St6vectorIS4_SaIS4_EEEEEEbRT_T0_.exit._crit_edge.i ], [ %i.bf, %bb.g ]
  %i.bi = getelementptr inbounds nuw i8, ptr %.sroa.07.0.i, i64 16
  store i64 %i.av, ptr %i.bi, align 8, !tbaa !59
  store <2 x i64> %i.bh, ptr %.sroa.07.0.i, align 8, !tbaa !59
...
_ZSt25__unguarded_linear_insertIN9__gnu_cxx17__normal_iteratorIPSt5tupleIJmmmEESt6vectorIS3_SaIS3_EEEENS0_5__ops14_Val_less_iterEEvT_T0_.exit: ; preds = %bb.g, %_ZNK9__gnu_cxx5__ops14_Val_less_iterclISt5tupleIJmmmEENS_17__normal_iteratorIPS4_St6vectorIS4_SaIS4_EEEEEEbRT_T0_.exit.i
  %i.bj = getelementptr inbounds nuw i8, ptr %.sroa.07.0.i, i64 16
  store i64 %i.g, ptr %i.bj, align 8, !tbaa !59
  %i.bk = getelementptr inbounds nuw i8, ptr %.sroa.07.0.i, i64 8
  store i64 %i.as, ptr %i.bk, align 8, !tbaa !59
  store i64 %i.at, ptr %.sroa.07.0.i, align 8, !tbaa !59
  br label %bb.i
...
_ZSt19__relocate_object_aINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES5_SaIS5_EEvPT_PT0_RT1_.exit.i.i.i: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i, %bb.d
  ...
  store i8 0, ptr %i.af, align 8, !tbaa !42, !alias.scope !208, !noalias !205
...
.lr.ph.i.i.i17:                                   ; preds = %_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE11_S_relocateEPS5_S8_S8_RS6_.exit, %_ZSt19__relocate_object_aINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES5_SaIS5_EEvPT_PT0_RT1_.exit.i.i.i23
  ...
  store ptr %i.as, ptr %.012.i.i.i18, align 8, !tbaa !44, !alias.scope !212, !noalias !215
  %i.at = load ptr, ptr %.0911.i.i.i19, align 8, !tbaa !48, !alias.scope !215, !noalias !212 ; 2 uses
...
bb.e:                                             ; preds = %.lr.ph.i.i.i17
  ...
  %i.ax = load i64, ptr %i.aw, align 8, !tbaa !50, !alias.scope !215, !noalias !212 ; 3 uses
