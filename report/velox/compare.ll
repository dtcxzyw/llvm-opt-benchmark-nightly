...
bb.ba:                                            ; preds = %bb.f
  ...
  %i.fy = load i128, ptr %i.fw, align 1
  %i.fz = load i128, ptr %i.fx, align 1
...
bb.bb:                                            ; preds = %bb.f
  ...
  %i.gf = load i128, ptr %i.gd, align 1
  %i.gg = load i128, ptr %i.ge, align 1
  %i.gh = xor i128 %i.gf, %i.gg
  %i.gi = getelementptr i8, ptr %i.gd, i64 16
  %i.gj = getelementptr i8, ptr %i.ge, i64 16
  %i.gk = load i128, ptr %i.gi, align 1
  %i.gl = load i128, ptr %i.gj, align 1
