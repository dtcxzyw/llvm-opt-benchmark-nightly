...
bb.y:                                             ; preds = %bb.y, %.lr.ph112.split.new
  ...
  %.182110 = phi i64 [ %.081, %.lr.ph112.split.new ], [ %6, %bb.y ]
...
.epil.preheader:                                  ; preds = %._crit_edge.loopexit141.unr-lcssa, %.lr.ph112.split
  ...
  %.182110.epil.init = phi i64 [ %.081, %.lr.ph112.split ], [ %6, %._crit_edge.loopexit141.unr-lcssa ]
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit141.unr-lcssa, %bb.z, %.lr.ph112.split.us.epil.preheader, %._crit_edge.loopexit.unr-lcssa, %bb.x
  ...
  %.182.lcssa = phi i64 [ %.081, %bb.x ], [ %i.dz, %.lr.ph112.split.us.epil.preheader ], [ %i.cp, %._crit_edge.loopexit.unr-lcssa ], [ %6, %._crit_edge.loopexit141.unr-lcssa ], [ %i.eg, %bb.z ]
