...
internal_multialloc_arrays.exit:                  ; preds = %spin_acquire_lock.exit, %bb.i, %._crit_edge56.i, %._crit_edge50.i, %.critedge.sink.split.i
  %.3.i = phi i32 [ 0, %spin_acquire_lock.exit ], [ 0, %bb.i ], [ 1, %._crit_edge50.i ], [ 0, %._crit_edge56.i ], [ %.3.ph.i, %.critedge.sink.split.i ]
...
bb.av:                                            ; preds = %.thread502, %._crit_edge, %bb.as, %bb.k, %.critedge439, %bb.ah, %bb.ap, %bb.an, %bb.z
  %i.cw = phi ptr [ %.pre, %._crit_edge ], [ %i.u, %bb.z ], [ %i.u, %bb.an ], [ %i.u, %bb.ap ], [ %i.u, %bb.ah ], [ %i.u, %.critedge439 ], [ %i.u, %bb.k ], [ %i.u, %bb.as ], [ %i.u, %.thread502 ] ; 13 uses
  %.1330 = phi i64 [ %2, %._crit_edge ], [ %i.s, %bb.z ], [ %i.s, %bb.an ], [ %i.s, %bb.ap ], [ %i.s, %bb.ah ], [ %i.s, %.critedge439 ], [ %i.s, %bb.k ], [ %i.s, %bb.as ], [ %i.s, %.thread502 ] ; 7 uses
  %.1 = phi ptr [ %1, %._crit_edge ], [ %i.r, %bb.z ], [ %i.r, %bb.an ], [ %i.r, %bb.ap ], [ %i.r, %bb.ah ], [ %i.r, %.critedge439 ], [ %i.r, %bb.k ], [ %i.r, %bb.as ], [ %i.r, %.thread502 ] ; 34 uses
...
.critedge445:                                     ; preds = %.thread, %bb.at, %bb.d, %bb.c, %bb.cp, %bb.cv, %bb.dh, %bb.da, %bb.ay, %bb.az, %bb.bb
  ret void
}
