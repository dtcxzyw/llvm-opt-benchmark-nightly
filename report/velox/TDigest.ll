...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %5 = extractelement <4 x ptr> %vector.gep, i64 1 ; 2 uses
  %i.w = extractelement <4 x ptr> %vector.gep, i64 2 ; 2 uses
  %6 = extractelement <4 x ptr> %vector.gep, i64 3 ; 2 uses
  %7 = load ptr, ptr %i.v, align 8, !tbaa !29
  %i.x = load ptr, ptr %5, align 8, !tbaa !29
  %8 = load ptr, ptr %i.w, align 8, !tbaa !29
  %i.y = load ptr, ptr %6, align 8, !tbaa !29
  %i.z = insertelement <4 x ptr> poison, ptr %7, i64 0
  %i.aa = insertelement <4 x ptr> %i.z, ptr %i.x, i64 1
  %i.ab = insertelement <4 x ptr> %i.aa, ptr %8, i64 2
