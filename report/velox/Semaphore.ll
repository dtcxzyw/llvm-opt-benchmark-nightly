...
.from..critedge:                                  ; preds = %resume.entry
  ...
  %.reload111 = load ptr, ptr %.reload.addr110, align 16, !tbaa !455 ; 4 uses
...
.lr.ph:                                           ; preds = %bb.a, %bb.ac
  ...
  %i.j = load atomic i32, ptr %i.d acquire, align 8, !noalias !457 ; 4 uses
  store i32 %i.j, ptr %.reload.addr112, align 16, !tbaa !7, !noalias !457
...
bb.b:                                             ; preds = %.lr.ph
  ...
  %i.n = cmpxchg ptr %i.d, i32 %i.j, i32 %i.m seq_cst seq_cst, align 4, !noalias !457 ; 2 uses
...
_ZNSt13__atomic_baseIjE23compare_exchange_strongERjjSt12memory_orderS2_.exit.i.i.i.i.i.i.i: ; preds = %bb.b
  ...
  store i32 %i.p, ptr %.reload.addr112, align 16, !noalias !457
...
bb.h:                                             ; preds = %bb.g
  %.reload = load ptr, ptr %.reload.addr110, align 16, !tbaa !455
  ...
  store ptr null, ptr %i.ae, align 16, !tbaa !460
  %i.af = getelementptr inbounds nuw i8, ptr %0, i64 216
  store i8 0, ptr %i.af, align 8, !tbaa !461
  %i.ag = load ptr, ptr %i.z, align 16, !tbaa !462 ; 2 uses
...
bb.j:                                             ; preds = %bb.i
  %i.ai = load ptr, ptr %i.z, align 16, !tbaa !462
...
.from..i.i.i.i:                                   ; preds = %bb.j, %bb.i, %bb.h
  ...
  %i.ak = load i8, ptr %i.aj, align 1, !tbaa !95, !noalias !463
  %i.al = icmp eq i8 %i.ak, 2
  %i.am = zext i1 %i.al to i8
  store i8 %i.am, ptr %i.aj, align 1, !tbaa !95, !noalias !463
  %i.an = getelementptr inbounds nuw i8, ptr %0, i64 56
  %i.ao = load i64, ptr %i.an, align 8, !tbaa !106, !noalias !466
  call void @llvm.experimental.noalias.scope.decl(metadata !469)
  call void @llvm.experimental.noalias.scope.decl(metadata !472)
  %i.ap = invoke noundef ptr @folly_coro_async_malloc(i64 noundef 104)
          to label %.from.92 unwind label %_ZN5folly4coro29StackAwareViaIfAsyncAwaitableIRNS_6fibers5BatonEED2Ev.exit31.from._ZN5folly17ExecutorKeepAliveINS_8ExecutorEED2Ev.exit4.i, !noalias !469 ; 8 uses
...
.from.92:                                         ; preds = %.from..i.i.i.i
  %i.ar = or i64 %i.ao, 2
  store ptr @_ZN5folly4coro6detail12ViaCoroutineILb0EE10createImplEv.resume, ptr %i.ap, align 8, !noalias !475
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(56) %i.at, i8 0, i64 56, i1 false), !noalias !475
  %i.au = getelementptr inbounds nuw i8, ptr %i.ap, i64 88
  store ptr @_ZZN5folly4coro28ExtendedCoroutinePromiseCrtpINS0_6detail12ViaCoroutineILb0EE12promise_typeEEC1EvENUlPNS0_23ExtendedCoroutineHandle11PromiseBaseERNS_17exception_wrapperEE_8__invokeES9_SB_, ptr %i.au, align 8, !tbaa !51, !noalias !475
  ...
  store ptr %i.ap, ptr %.reload.addr113, align 16, !tbaa !55, !alias.scope !476
  ...
  store i64 %i.ar, ptr %i.as, align 8, !tbaa !106, !noalias !475
  %i.av = getelementptr inbounds nuw i8, ptr %0, i64 232
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVN5folly6fibers6detail20BatonAwaitableWaiterE, i64 16), ptr %i.av, align 8, !tbaa !117, !alias.scope !479
  %i.aw = getelementptr inbounds nuw i8, ptr %0, i64 240
  store ptr null, ptr %i.aw, align 16, !tbaa !321, !alias.scope !479
  %i.ax = getelementptr inbounds nuw i8, ptr %0, i64 248
  store ptr %.reload.addr114, ptr %i.ax, align 8, !tbaa !484, !alias.scope !479
...
bb.l:                                             ; preds = %bb.k
  ...
  invoke void %i.bd(ptr nonnull %i.bb)
          to label %.from.102 unwind label %bb.m, !inline_history !485
...
bb.t:                                             ; preds = %bb.s
  ...
  %i.bu = call noundef i64 %i.bs(i32 noundef 1, ptr noundef nonnull align 16 dereferenceable(64) %i.bt, ptr noundef null) #7, !inline_history !486 ; 0 uses
  br label %bb.u
...
bb.v:                                             ; preds = %bb.u
  call void @llvm.lifetime.start.p0(ptr nonnull %1) #7, !noalias !487
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %1) #7, !noalias !487
...
bb.y:                                             ; preds = %bb.v, %bb.w, %bb.x
  ...
  %i.cd = load i64, ptr %.reload.addr115, align 8, !noalias !493
  store i64 %i.cd, ptr %i.cc, align 8, !alias.scope !493
  store i64 0, ptr %.reload.addr115, align 8, !noalias !493
...
bb.ac:                                            ; preds = %bb.g
  ...
  br i1 %i.cl, label %.lr.ph, label %._crit_edge.from., !llvm.loop !496
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.j = tail call noundef i64 %i.h(i32 noundef 1, ptr noundef nonnull align 16 dereferenceable(64) %i.i, ptr noundef null) #7, !inline_history !486 ; 0 uses
...
bb.l:                                             ; preds = %bb.j
  ...
  %i.y = load ptr, ptr %i.x, align 8
  tail call void %i.y(ptr noundef nonnull align 8 dead_on_return(32) dereferenceable(32) %i.r) #7, !call_target !497, !inline_history !503
  br label %_ZN5folly17CancellationTokenD2Ev.exit.i.i
...
bb.n:                                             ; preds = %bb.m
  ...
  tail call void %i.ag(ptr noundef nonnull align 8 dereferenceable(8) %i.ac) #7, !call_target !119, !inline_history !504
...
!455 = !{!456, !456, i64 0}
!456 = !{!"_ZN5folly6fibers9Semaphore7co_waitEv.Frame Slot", !10, i64 0}
!457 = !{!458}
!458 = distinct !{!458, !459, !"_ZN5folly16SynchronizedBaseINS_12SynchronizedIN5boost9intrusive4listINS_6fibers9Semaphore6WaiterEJNS3_11member_hookIS7_NS3_16list_member_hookIJNS3_9link_modeILNS3_14link_mode_typeE1EEEEEEXadL_ZNS7_5hook_EEEEENS3_18constant_time_sizeILb0EEEEEENS_15SharedMutexImplILb0EvSt6atomicNS_24SharedMutexPolicyDefaultEEEEELNS_6detail22SynchronizedMutexLevelE2EE5wlockEv: argument 0"}
!459 = distinct !{!459, !"_ZN5folly16SynchronizedBaseINS_12SynchronizedIN5boost9intrusive4listINS_6fibers9Semaphore6WaiterEJNS3_11member_hookIS7_NS3_16list_member_hookIJNS3_9link_modeILNS3_14link_mode_typeE1EEEEEEXadL_ZNS7_5hook_EEEEENS3_18constant_time_sizeILb0EEEEEENS_15SharedMutexImplILb0EvSt6atomicNS_24SharedMutexPolicyDefaultEEEEELNS_6detail22SynchronizedMutexLevelE2EE5wlockEv"}
!460 = !{!76, !82, i64 96}
!461 = !{!84, !18, i64 0}
!462 = !{!80, !80, i64 0}
!463 = !{!464}
