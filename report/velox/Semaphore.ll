...
bb.e:                                             ; preds = %bb.d
  %i.g = landingpad { ptr, i32 }
          cleanup
  call void @_ZNSt10unique_ptrIN5folly7futures6detail16DeferredExecutorENS2_13UniqueDeleterEED2Ev(ptr noundef nonnull align 8 dead_on_return(8) dereferenceable(8) %1) #7
...
define noundef i64 @_ZNK5folly6fibers9Semaphore11getCapacityEv(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(40) %0) local_unnamed_addr #23 align 2 {
bb.a:
...
define noundef i64 @_ZNK5folly6fibers9Semaphore18getAvailableTokensEv(ptr nofree noundef nonnull align 8 captures(none) dereferenceable(40) %0) local_unnamed_addr #24 align 2 {
bb.a:
...
CoroEnd:
  ...
  tail call void @_ZN5folly4coro6detail12ViaCoroutineILb0EE12promise_type12FinalAwaiter13await_suspendENSt7__n486116coroutine_handleIS4_EE(ptr noundef nonnull align 1 dereferenceable(1) %.reload.addr13, ptr nonnull %0) #7
  ret void
}
...
bb.b:                                             ; preds = %bb.a
  ...
  tail call void %i.j(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #7, !call_target !154, !inline_history !303
  %i.k = load ptr, ptr %i.b, align 8, !tbaa !117
  %i.l = getelementptr inbounds nuw i8, ptr %i.k, i64 24
  %i.m = load ptr, ptr %i.l, align 8
  tail call void %i.m(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #7, !call_target !162, !inline_history !303
...
bb.d:                                             ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i
  tail call void @_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE24_M_release_last_use_coldEv(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #7, !inline_history !304
  br label %_ZNSt12__shared_ptrIN5folly14RequestContextELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i
...
_ZNSt12__shared_ptrIN5folly14RequestContextELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i: ; preds = %bb.d, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i, %bb.b, %resume.entry
  ...
  %i.s = load i64, ptr %i.r, align 8, !tbaa !106  ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  tail call void %i.y(ptr noundef nonnull align 8 dereferenceable(8) %i.u) #7, !call_target !119, !inline_history !305
...
; Function Attrs: mustprogress uwtable
define internal void @_ZN5folly6fibers9Semaphore7co_waitEv.resume(ptr noundef nonnull align 16 dereferenceable(304) %0) #0 align 2 personality ptr @__gxx_personality_v0 {
resume.entry:
  %i.a = alloca i32, align 4                      ; 4 uses
  %1 = alloca %"struct.folly::OperationCancelled", align 8 ; 5 uses
  %2 = alloca %class.anon.30, align 8             ; 4 uses
  %.reload.addr112 = getelementptr inbounds nuw i8, ptr %0, i64 112 ; 7 uses
  %.reload.addr113 = getelementptr inbounds nuw i8, ptr %0, i64 224 ; 7 uses
  %.reload.addr114 = getelementptr inbounds nuw i8, ptr %0, i64 256 ; 4 uses
  %.reload.addr115 = getelementptr inbounds nuw i8, ptr %0, i64 280 ; 3 uses
  %.reload.addr119 = getelementptr inbounds nuw i8, ptr %0, i64 297 ; 3 uses
  %.reload.addr122 = getelementptr inbounds nuw i8, ptr %0, i64 16
  %index.addr = getelementptr inbounds nuw i8, ptr %0, i64 296 ; 5 uses
  %index = load i2, ptr %index.addr, align 8
  switch i2 %index, label %unreachable [
    i2 0, label %.from..critedge
    i2 1, label %AfterCoroSuspend75
    i2 -2, label %CoroEnd
  ], !prof !455

.from..critedge:                                  ; preds = %resume.entry
  %.reload.addr110 = getelementptr inbounds nuw i8, ptr %0, i64 288 ; 2 uses
  %.reload111 = load ptr, ptr %.reload.addr110, align 16, !tbaa !456 ; 4 uses
  %i.b = getelementptr inbounds nuw i8, ptr %.reload111, i64 8 ; 4 uses
  %i.c = load atomic i64, ptr %i.b acquire, align 8
  %i.d = getelementptr inbounds nuw i8, ptr %.reload111, i64 32 ; 5 uses
  %i.e = getelementptr inbounds nuw i8, ptr %.reload111, i64 16
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 264 ; 3 uses
  %i.g = getelementptr inbounds nuw i8, ptr %.reload111, i64 24 ; 2 uses
...
bb.a:                                             ; preds = %.from._ZNSt13__atomic_baseIlE21compare_exchange_weakERllSt12memory_orderS2_.exit, %.from..critedge
  %.047 = phi i64 [ %i.c, %.from..critedge ], [ %i.cs, %.from._ZNSt13__atomic_baseIlE21compare_exchange_weakERllSt12memory_orderS2_.exit ] ; 2 uses
  %i.i = icmp eq i64 %.047, 0
  br i1 %i.i, label %.lr.ph, label %._crit_edge

.lr.ph:                                           ; preds = %bb.a, %bb.ac
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(24) %.reload.addr114, i8 0, i64 24, i1 false)
  %i.j = load atomic i32, ptr %i.d acquire, align 8, !noalias !458 ; 4 uses
  store i32 %i.j, ptr %.reload.addr112, align 16, !tbaa !7, !noalias !458
  %i.k = and i32 %i.j, -1312
  %i.l = icmp eq i32 %i.k, 0
  br i1 %i.l, label %bb.b, label %.critedge.i.i.i.i.i.i.i, !prof !20

bb.b:                                             ; preds = %.lr.ph
  %i.m = or disjoint i32 %i.j, 128
  %i.n = cmpxchg ptr %i.d, i32 %i.j, i32 %i.m seq_cst seq_cst, align 4, !noalias !458 ; 2 uses
  %i.o = extractvalue { i32, i1 } %i.n, 1
  br i1 %i.o, label %.noexc, label %_ZNSt13__atomic_baseIjE23compare_exchange_strongERjjSt12memory_orderS2_.exit.i.i.i.i.i.i.i, !prof !21
...
_ZNSt13__atomic_baseIjE23compare_exchange_strongERjjSt12memory_orderS2_.exit.i.i.i.i.i.i.i: ; preds = %bb.b
  ...
  store i32 %i.p, ptr %.reload.addr112, align 16, !noalias !458
...
.critedge.i.i.i.i.i.i.i:                          ; preds = %_ZNSt13__atomic_baseIjE23compare_exchange_strongERjjSt12memory_orderS2_.exit.i.i.i.i.i.i.i, %.lr.ph
  %i.q = invoke noundef zeroext i1 @_ZN5folly15SharedMutexImplILb0EvSt6atomicNS_24SharedMutexPolicyDefaultEE17lockExclusiveImplINS3_11WaitForeverEEEbRjjRT_(ptr noundef nonnull align 4 dereferenceable(4) %i.d, ptr noundef nonnull align 4 dereferenceable(4) %.reload.addr112, i32 noundef 224, ptr noundef nonnull align 1 dereferenceable(1) %.reload.addr113)
          to label %.noexc unwind label %.from.103 ; 0 uses

.noexc:                                           ; preds = %.critedge.i.i.i.i.i.i.i, %bb.b
  %i.r = load atomic i64, ptr %i.b acquire, align 8
  %.not.not.i = icmp eq i64 %i.r, 0               ; 2 uses
  br i1 %.not.not.i, label %bb.c, label %bb.d

bb.c:                                             ; preds = %.noexc
  %i.s = load ptr, ptr %i.g, align 8, !tbaa !25   ; 2 uses
  store ptr %i.s, ptr %i.h, align 16, !tbaa !25
  store ptr %i.e, ptr %i.f, align 8, !tbaa !22
  store ptr %i.f, ptr %i.g, align 8, !tbaa !25
  store ptr %i.f, ptr %i.s, align 8, !tbaa !22
  br label %bb.d

bb.d:                                             ; preds = %bb.c, %.noexc
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #7
  %i.t = atomicrmw and ptr %i.d, i32 -401 seq_cst, align 4 ; 2 uses
  %i.u = and i32 %i.t, -401
  store i32 %i.u, ptr %i.a, align 4, !tbaa !7
  %i.v = and i32 %i.t, 15
  %.not.i.i.i.i.i.i = icmp eq i32 %i.v, 0
  br i1 %.not.i.i.i.i.i.i, label %bb.g, label %bb.e, !prof !20

bb.e:                                             ; preds = %bb.d
  invoke void @_ZN5folly15SharedMutexImplILb0EvSt6atomicNS_24SharedMutexPolicyDefaultEE25wakeRegisteredWaitersImplERjj(ptr noundef nonnull align 4 dereferenceable(4) %i.d, ptr noundef nonnull align 4 dereferenceable(4) %i.a, i32 noundef 15)
...
.from.103:                                        ; preds = %.critedge.i.i.i.i.i.i.i
  %i.y = landingpad { ptr, i32 }
          catch ptr null
  br label %bb.ad

bb.h:                                             ; preds = %bb.g
  %.reload = load ptr, ptr %.reload.addr110, align 16, !tbaa !456
  store i8 0, ptr %.reload.addr119, align 1, !tbaa !141
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(105) %.reload.addr112, i8 0, i64 24, i1 false)
  %i.ac = getelementptr inbounds nuw i8, ptr %0, i64 192
  %i.ad = getelementptr inbounds nuw i8, ptr %0, i64 200
  store ptr %.reload, ptr %i.ab, align 16
  %.sroa.4.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 152
  store ptr %.reload.addr114, ptr %.sroa.4.0..sroa_idx, align 8
  %.sroa.5.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 160
  store ptr %.reload.addr119, ptr %.sroa.5.0..sroa_idx, align 16
  store ptr @"_ZN5folly6detail8function5call_IZNS_6fibers9Semaphore7co_waitEvE3$_0Lb1ELb0EvJEEET2_DpT3_RNS1_4DataE", ptr %i.ac, align 16, !tbaa !167
  store ptr @_ZN5folly6detail8function20DispatchSmallTrivial5exec_ILm32EEEmNS1_2OpEPNS1_4DataES6_, ptr %i.ad, align 8, !tbaa !85
  %i.ae = getelementptr inbounds nuw i8, ptr %0, i64 208
  store ptr null, ptr %i.ae, align 16, !tbaa !461
  %i.af = getelementptr inbounds nuw i8, ptr %0, i64 216
  store i8 0, ptr %i.af, align 8, !tbaa !462
  %i.ag = load ptr, ptr %i.z, align 16, !tbaa !463 ; 2 uses
  %.not.i.i = icmp eq ptr %i.ag, null
  br i1 %.not.i.i, label %.from..i.i.i.i, label %bb.i

bb.i:                                             ; preds = %bb.h
  %i.ah = call noundef zeroext i1 @_ZN5folly6detail17CancellationState14tryAddCallbackEPNS_20CancellationCallbackEb(ptr noundef nonnull align 8 dereferenceable(32) %i.ag, ptr noundef nonnull align 16 dereferenceable(105) %.reload.addr112, i1 noundef zeroext true) #7
  br i1 %i.ah, label %bb.j, label %.from..i.i.i.i

bb.j:                                             ; preds = %bb.i
  %i.ai = load ptr, ptr %i.z, align 16, !tbaa !463
  store ptr %i.ai, ptr %i.aa, align 16, !tbaa !75
  br label %.from..i.i.i.i

.from..i.i.i.i:                                   ; preds = %bb.j, %bb.i, %bb.h
  %i.aj = getelementptr inbounds nuw i8, ptr %0, i64 73 ; 2 uses
  %i.ak = load i8, ptr %i.aj, align 1, !tbaa !95, !noalias !464
  %i.al = icmp eq i8 %i.ak, 2
  %i.am = zext i1 %i.al to i8
  store i8 %i.am, ptr %i.aj, align 1, !tbaa !95, !noalias !464
  %i.an = getelementptr inbounds nuw i8, ptr %0, i64 56
  %i.ao = load i64, ptr %i.an, align 8, !tbaa !106, !noalias !467
  call void @llvm.experimental.noalias.scope.decl(metadata !470)
  call void @llvm.experimental.noalias.scope.decl(metadata !473)
  %i.ap = invoke noundef ptr @folly_coro_async_malloc(i64 noundef 104)
          to label %.from.92 unwind label %_ZN5folly4coro29StackAwareViaIfAsyncAwaitableIRNS_6fibers5BatonEED2Ev.exit31.from._ZN5folly17ExecutorKeepAliveINS_8ExecutorEED2Ev.exit4.i, !noalias !470 ; 8 uses

_ZN5folly4coro29StackAwareViaIfAsyncAwaitableIRNS_6fibers5BatonEED2Ev.exit31.from._ZN5folly17ExecutorKeepAliveINS_8ExecutorEED2Ev.exit4.i: ; preds = %.from..i.i.i.i
  %i.aq = landingpad { ptr, i32 }
          catch ptr null
  br label %.from.102

.from.92:                                         ; preds = %.from..i.i.i.i
  %i.ar = or i64 %i.ao, 2
  store ptr @_ZN5folly4coro6detail12ViaCoroutineILb0EE10createImplEv.resume, ptr %i.ap, align 8, !noalias !476
  %destroy.addr.i.i.i.i = getelementptr inbounds nuw i8, ptr %i.ap, i64 8
  store ptr @_ZN5folly4coro6detail12ViaCoroutineILb0EE10createImplEv.destroy, ptr %destroy.addr.i.i.i.i, align 8, !noalias !476
  %.reload.addr14.i.i.i.i = getelementptr inbounds nuw i8, ptr %i.ap, i64 16
  %i.as = getelementptr inbounds nuw i8, ptr %i.ap, i64 24
  %i.at = getelementptr inbounds nuw i8, ptr %i.ap, i64 32
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(56) %i.at, i8 0, i64 56, i1 false), !noalias !476
  %i.au = getelementptr inbounds nuw i8, ptr %i.ap, i64 88
  store ptr @_ZZN5folly4coro28ExtendedCoroutinePromiseCrtpINS0_6detail12ViaCoroutineILb0EE12promise_typeEEC1EvENUlPNS0_23ExtendedCoroutineHandle11PromiseBaseERNS_17exception_wrapperEE_8__invokeES9_SB_, ptr %i.au, align 8, !tbaa !51, !noalias !476
  ...
  store ptr %i.ap, ptr %.reload.addr113, align 16, !tbaa !55, !alias.scope !477
  %index.addr15.i.i.i.i = getelementptr inbounds nuw i8, ptr %i.ap, i64 96
  store i1 false, ptr %index.addr15.i.i.i.i, align 8, !noalias !476
  store i64 %i.ar, ptr %i.as, align 8, !tbaa !106, !noalias !476
  %i.av = getelementptr inbounds nuw i8, ptr %0, i64 232
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVN5folly6fibers6detail20BatonAwaitableWaiterE, i64 16), ptr %i.av, align 8, !tbaa !117, !alias.scope !480
  %i.aw = getelementptr inbounds nuw i8, ptr %0, i64 240
  store ptr null, ptr %i.aw, align 16, !tbaa !321, !alias.scope !480
  %i.ax = getelementptr inbounds nuw i8, ptr %0, i64 248
  store ptr %.reload.addr114, ptr %i.ax, align 8, !tbaa !485, !alias.scope !480
  %i.ay = load atomic i64, ptr %.reload.addr114 seq_cst, align 16
  %i.az = icmp eq i64 %i.ay, -1
  br i1 %i.az, label %AfterCoroSuspend75, label %AfterCoroSave73

AfterCoroSave73:                                  ; preds = %.from.92
  store i2 1, ptr %index.addr, align 8
  invoke void @_ZN5folly4coro17ViaIfAsyncAwaiterILb1ERNS_6fibers5BatonEE13await_suspendINS0_6detail11TaskPromiseIvEEEEvNSt7__n486116coroutine_handleIT_EE(ptr noundef nonnull align 8 dereferenceable(32) %.reload.addr113, ptr nonnull %0)
          to label %CoroEnd unwind label %bb.k

bb.k:                                             ; preds = %AfterCoroSave73
  %i.ba = landingpad { ptr, i32 }
          catch ptr null                          ; 2 uses
  %i.bb = load ptr, ptr %.reload.addr113, align 16, !tbaa !59 ; 3 uses
  %.not.i.i24 = icmp eq ptr %i.bb, null
  br i1 %.not.i.i24, label %.from.102, label %bb.l

bb.l:                                             ; preds = %bb.k
  %i.bc = getelementptr inbounds nuw i8, ptr %i.bb, i64 8
  %i.bd = load ptr, ptr %i.bc, align 8
  invoke void %i.bd(ptr nonnull %i.bb)
          to label %.from.102 unwind label %bb.m, !inline_history !486
...
AfterCoroSuspend75:                               ; preds = %resume.entry, %.from.92
  %i.bg = load ptr, ptr %.reload.addr113, align 16, !tbaa !59 ; 3 uses
  %.not.i.i25 = icmp eq ptr %i.bg, null
  br i1 %.not.i.i25, label %_ZN5folly4coro29StackAwareViaIfAsyncAwaitableIRNS_6fibers5BatonEED2Ev.exit, label %bb.n

bb.n:                                             ; preds = %AfterCoroSuspend75
  store i64 0, ptr %.reload.addr113, align 16, !tbaa !55
...
_ZN5folly4coro17ViaIfAsyncAwaiterILb1ERNS_6fibers5BatonEE12await_resumeEv.exit: ; preds = %bb.n
  %.pr = load ptr, ptr %.reload.addr113, align 16, !tbaa !59 ; 3 uses
  %.not.i.i26 = icmp eq ptr %.pr, null
  br i1 %.not.i.i26, label %_ZN5folly4coro29StackAwareViaIfAsyncAwaitableIRNS_6fibers5BatonEED2Ev.exit, label %bb.p
...
_ZN5folly4coro29StackAwareViaIfAsyncAwaitableIRNS_6fibers5BatonEED2Ev.exit: ; preds = %bb.p, %_ZN5folly4coro17ViaIfAsyncAwaiterILb1ERNS_6fibers5BatonEE12await_resumeEv.exit, %AfterCoroSuspend75
  %i.bp = getelementptr inbounds nuw i8, ptr %0, i64 128
  %i.bq = load ptr, ptr %i.bp, align 16, !tbaa !75 ; 2 uses
...
bb.r:                                             ; preds = %_ZN5folly4coro29StackAwareViaIfAsyncAwaitableIRNS_6fibers5BatonEED2Ev.exit
  call void @_ZN5folly6detail17CancellationState14removeCallbackEPNS_20CancellationCallbackE(ptr noundef nonnull align 8 dereferenceable(32) %i.bq, ptr noundef nonnull align 16 dereferenceable(105) %.reload.addr112) #7
  br label %bb.s

bb.s:                                             ; preds = %bb.r, %_ZN5folly4coro29StackAwareViaIfAsyncAwaitableIRNS_6fibers5BatonEED2Ev.exit
  %i.br = getelementptr inbounds nuw i8, ptr %0, i64 200
  %i.bs = load ptr, ptr %i.br, align 8, !tbaa !85 ; 2 uses
  %.not.i.i.i28 = icmp eq ptr %i.bs, null
  br i1 %.not.i.i.i28, label %bb.u, label %bb.t

bb.t:                                             ; preds = %bb.s
  %i.bt = getelementptr inbounds nuw i8, ptr %0, i64 144
  %i.bu = call noundef i64 %i.bs(i32 noundef 1, ptr noundef nonnull align 16 dereferenceable(64) %i.bt, ptr noundef null) #7, !inline_history !487 ; 0 uses
  br label %bb.u

bb.u:                                             ; preds = %bb.s, %bb.t
  %i.bv = load i8, ptr %.reload.addr119, align 1, !tbaa !141, !range !26, !noundef !27
  %i.bw = trunc nuw i8 %i.bv to i1
  %i.bx = getelementptr inbounds nuw i8, ptr %0, i64 96 ; 4 uses
  br i1 %i.bw, label %bb.v, label %bb.z

bb.v:                                             ; preds = %bb.u
  call void @llvm.lifetime.start.p0(ptr nonnull %1) #7, !noalias !488
  ...
  call void @_ZN5folly6detail24make_exception_ptr_with_ERKNS0_28make_exception_ptr_with_arg_EPv(ptr dead_on_unwind nonnull writable sret(%"class.std::__exception_ptr::exception_ptr") align 8 dereferenceable(8) %.reload.addr115, ptr noundef nonnull align 8 dereferenceable(32) @_ZZNK5folly26make_exception_ptr_with_fnclIZNKS0_4makeINS_18OperationCancelledEJOS3_EEEDaDpOT0_EUlvE_TnPDTclclscPDoFRT_vELDnEEEELPS3_0EEENSt15__exception_ptr13exception_ptrES9_E3arg, ptr noundef nonnull %2) #7
  call void @llvm.lifetime.end.p0(ptr nonnull %2), !noalias !488
  call void @_ZNSt9exceptionD2Ev(ptr noundef nonnull align 8 dereferenceable(8) %1) #7
  call void @llvm.lifetime.end.p0(ptr nonnull %1) #7, !noalias !488
  %i.by = load i8, ptr %i.bx, align 16, !tbaa !53, !range !26, !noundef !27
...
bb.x:                                             ; preds = %bb.w
  call void @_ZNSt15__exception_ptr13exception_ptr10_M_releaseEv(ptr noundef nonnull align 8 dereferenceable(8) %i.ca) #7
  br label %bb.y

bb.y:                                             ; preds = %bb.v, %bb.w, %bb.x
  %.reload.addr120 = getelementptr inbounds nuw i8, ptr %0, i64 298
  %i.cc = getelementptr inbounds nuw i8, ptr %0, i64 104
  call void @llvm.experimental.noalias.scope.decl(metadata !494)
  %i.cd = load i64, ptr %.reload.addr115, align 8, !noalias !494
  store i64 %i.cd, ptr %i.cc, align 8, !alias.scope !494
  store i64 0, ptr %.reload.addr115, align 8, !noalias !494
  store i8 0, ptr %i.bx, align 16, !tbaa !53
  store i2 -2, ptr %index.addr, align 8
  %i.ce = call ptr @_ZN5folly4coro6detail15TaskPromiseBase12FinalAwaiter13await_suspendINS1_11TaskPromiseIvEEEENSt7__n486116coroutine_handleIvEENS8_IT_EE(ptr noundef nonnull align 1 dereferenceable(1) %.reload.addr120, ptr nonnull %0) #7 ; 2 uses
  %i.cf = load ptr, ptr %i.ce, align 8
  musttail call void %i.cf(ptr nonnull %i.ce)
  ret void

bb.z:                                             ; preds = %bb.u
  %i.cg = load i8, ptr %i.bx, align 16, !tbaa !53, !range !26, !noundef !27
  %i.ch = trunc nuw i8 %i.cg to i1
  br i1 %i.ch, label %.thread57, label %bb.aa

bb.aa:                                            ; preds = %bb.z
  %i.ci = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  %i.cj = load ptr, ptr %i.ci, align 8, !tbaa !90
  %.not.i.i.i.i35 = icmp eq ptr %i.cj, null
  br i1 %.not.i.i.i.i35, label %_ZN5folly17exception_wrapperD2Ev.exit.i.i, label %bb.ab

bb.ab:                                            ; preds = %bb.aa
  call void @_ZNSt15__exception_ptr13exception_ptr10_M_releaseEv(ptr noundef nonnull align 8 dereferenceable(8) %i.ci) #7
  br label %_ZN5folly17exception_wrapperD2Ev.exit.i.i

_ZN5folly17exception_wrapperD2Ev.exit.i.i:        ; preds = %bb.ab, %bb.aa
  store i8 1, ptr %i.bx, align 16, !tbaa !53
  br label %.thread57

.from.102:                                        ; preds = %_ZN5folly4coro29StackAwareViaIfAsyncAwaitableIRNS_6fibers5BatonEED2Ev.exit31.from._ZN5folly17ExecutorKeepAliveINS_8ExecutorEED2Ev.exit4.i, %bb.k, %bb.l
  %.pn.pn = phi { ptr, i32 } [ %i.ba, %bb.k ], [ %i.aq, %_ZN5folly4coro29StackAwareViaIfAsyncAwaitableIRNS_6fibers5BatonEED2Ev.exit31.from._ZN5folly17ExecutorKeepAliveINS_8ExecutorEED2Ev.exit4.i ], [ %i.ba, %bb.l ]
  call void @_ZN5folly20CancellationCallbackD2Ev(ptr noundef nonnull align 16 dead_on_return(105) dereferenceable(105) %.reload.addr112) #7
  br label %bb.ad

bb.ac:                                            ; preds = %bb.g
  %i.ck = load atomic i64, ptr %i.b acquire, align 8 ; 2 uses
  %i.cl = icmp eq i64 %i.ck, 0
  br i1 %i.cl, label %.lr.ph, label %._crit_edge.from., !llvm.loop !497

._crit_edge.from.:                                ; preds = %bb.ac
  br label %._crit_edge, !llvm.loop !497

bb.ad:                                            ; preds = %.from.102, %.from.103
  %.pn20.pn.pn = phi { ptr, i32 } [ %.pn.pn, %.from.102 ], [ %i.y, %.from.103 ]
  %.4 = extractvalue { ptr, i32 } %.pn20.pn.pn, 0
  %i.cm = call ptr @__cxa_begin_catch(ptr %.4) #7 ; 0 uses
  call void @_ZN5folly4coro6detail19TaskPromiseCrtpBaseINS1_11TaskPromiseIvEEvE19unhandled_exceptionEv(ptr noundef nonnull align 8 dereferenceable(96) %.reload.addr122) #7
  invoke void @__cxa_end_catch()
          to label %.thread57 unwind label %_ZN5folly4coro6detail15TaskPromiseBasedlEPvm.exit42

.thread57:                                        ; preds = %bb.z, %_ZN5folly17exception_wrapperD2Ev.exit.i.i, %bb.ad, %.thread56, %_ZN5folly17exception_wrapperD2Ev.exit.i.i37
  %.reload.addr121 = getelementptr inbounds nuw i8, ptr %0, i64 299
  store ptr null, ptr %0, align 16
  store i2 -1, ptr %index.addr, align 8
  %i.cn = call ptr @_ZN5folly4coro6detail15TaskPromiseBase12FinalAwaiter13await_suspendINS1_11TaskPromiseIvEEEENSt7__n486116coroutine_handleIvEENS8_IT_EE(ptr noundef nonnull align 1 dereferenceable(1) %.reload.addr121, ptr nonnull %0) #7 ; 2 uses
  %i.co = load ptr, ptr %i.cn, align 8
  musttail call void %i.co(ptr nonnull %i.cn)
  ret void

._crit_edge:                                      ; preds = %bb.a, %._crit_edge.from.
  %.148.lcssa = phi i64 [ %i.ck, %._crit_edge.from. ], [ %.047, %bb.a ] ; 2 uses
  %i.cp = add nsw i64 %.148.lcssa, -1
  %i.cq = cmpxchg weak ptr %i.b, i64 %.148.lcssa, i64 %i.cp release acquire, align 8 ; 2 uses
  %i.cr = extractvalue { i64, i1 } %i.cq, 1
  br i1 %i.cr, label %.thread56, label %.from._ZNSt13__atomic_baseIlE21compare_exchange_weakERllSt12memory_orderS2_.exit
...
.thread56:                                        ; preds = %._crit_edge
  ...
  %i.cu = load i8, ptr %i.ct, align 16, !tbaa !53, !range !26, !noundef !27
  %i.cv = trunc nuw i8 %i.cu to i1
  br i1 %i.cv, label %.thread57, label %bb.ae

bb.ae:                                            ; preds = %.thread56
  %i.cw = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  %i.cx = load ptr, ptr %i.cw, align 8, !tbaa !90
  %.not.i.i.i.i36 = icmp eq ptr %i.cx, null
  br i1 %.not.i.i.i.i36, label %_ZN5folly17exception_wrapperD2Ev.exit.i.i37, label %bb.af

bb.af:                                            ; preds = %bb.ae
  call void @_ZNSt15__exception_ptr13exception_ptr10_M_releaseEv(ptr noundef nonnull align 8 dereferenceable(8) %i.cw) #7
  br label %_ZN5folly17exception_wrapperD2Ev.exit.i.i37

_ZN5folly17exception_wrapperD2Ev.exit.i.i37:      ; preds = %bb.af, %bb.ae
  store i8 1, ptr %i.ct, align 16, !tbaa !53
  br label %.thread57

CoroEnd:                                          ; preds = %AfterCoroSave73, %resume.entry
  ret void

_ZN5folly4coro6detail15TaskPromiseBasedlEPvm.exit42: ; preds = %bb.ad
...
; Function Attrs: mustprogress nounwind uwtable
define internal void @_ZN5folly6fibers9Semaphore7co_waitEv.destroy(ptr noundef nonnull align 16 dereferenceable(304) %0) #4 align 2 personality ptr @__gxx_personality_v0 {
resume.entry:
  %.reload.addr112 = getelementptr inbounds nuw i8, ptr %0, i64 112
  %.reload.addr115 = getelementptr inbounds nuw i8, ptr %0, i64 280 ; 2 uses
  %index.addr = getelementptr inbounds nuw i8, ptr %0, i64 296
  %index = load i2, ptr %index.addr, align 8
  switch i2 %index, label %unreachable [
    i2 0, label %AfterCoroSuspend
    i2 1, label %_ZN5folly4coro17ViaIfAsyncAwaiterILb1ERNS_6fibers5BatonEE12await_resumeEv.exit
    i2 -2, label %AfterCoroSuspend79
...
_ZN5folly4coro17ViaIfAsyncAwaiterILb1ERNS_6fibers5BatonEE12await_resumeEv.exit: ; preds = %resume.entry
  %.reload.addr113 = getelementptr inbounds nuw i8, ptr %0, i64 224
  %.pr = load ptr, ptr %.reload.addr113, align 16, !tbaa !59 ; 3 uses
  %.not.i.i26 = icmp eq ptr %.pr, null
  br i1 %.not.i.i26, label %_ZN5folly4coro29StackAwareViaIfAsyncAwaitableIRNS_6fibers5BatonEED2Ev.exit, label %bb.a
...
bb.c:                                             ; preds = %_ZN5folly4coro29StackAwareViaIfAsyncAwaitableIRNS_6fibers5BatonEED2Ev.exit
  tail call void @_ZN5folly6detail17CancellationState14removeCallbackEPNS_20CancellationCallbackE(ptr noundef nonnull align 8 dereferenceable(32) %i.f, ptr noundef nonnull align 16 dereferenceable(105) %.reload.addr112) #7
  br label %bb.d
...
bb.d:                                             ; preds = %bb.c, %_ZN5folly4coro29StackAwareViaIfAsyncAwaitableIRNS_6fibers5BatonEED2Ev.exit
  ...
  %.not.i.i.i28 = icmp eq ptr %i.h, null
  br i1 %.not.i.i.i28, label %AfterCoroSuspend, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.i = getelementptr inbounds nuw i8, ptr %0, i64 144
  %i.j = tail call noundef i64 %i.h(i32 noundef 1, ptr noundef nonnull align 16 dereferenceable(64) %i.i, ptr noundef null) #7, !inline_history !487 ; 0 uses
  br label %AfterCoroSuspend

AfterCoroSuspend79:                               ; preds = %resume.entry
  %i.k = load ptr, ptr %.reload.addr115, align 8, !tbaa !90
  %.not.i.i.i33 = icmp eq ptr %i.k, null
  br i1 %.not.i.i.i33, label %AfterCoroSuspend, label %bb.f

bb.f:                                             ; preds = %AfterCoroSuspend79
  tail call void @_ZNSt15__exception_ptr13exception_ptr10_M_releaseEv(ptr noundef nonnull align 8 dereferenceable(8) %.reload.addr115) #7
  br label %AfterCoroSuspend

AfterCoroSuspend:                                 ; preds = %bb.d, %bb.e, %resume.entry, %AfterCoroSuspend79, %bb.f, %resume.entry
  %i.l = getelementptr inbounds nuw i8, ptr %0, i64 96
  %i.m = load i8, ptr %i.l, align 16, !tbaa !53, !range !26, !noundef !27
...
bb.g:                                             ; preds = %AfterCoroSuspend
  ...
  %.not.i.i.i.i40 = icmp eq ptr %i.p, null
  br i1 %.not.i.i.i.i40, label %_ZN5folly3TryIvED2Ev.exit.i, label %bb.h

bb.h:                                             ; preds = %bb.g
  tail call void @_ZNSt15__exception_ptr13exception_ptr10_M_releaseEv(ptr noundef nonnull align 8 dereferenceable(8) %i.o) #7
...
bb.j:                                             ; preds = %bb.i
  %i.v = and i64 %i.t, 4
  %.not.i.i.i.i.i.i41 = icmp eq i64 %i.v, 0
  br i1 %.not.i.i.i.i.i.i41, label %bb.l, label %bb.k

bb.k:                                             ; preds = %bb.j
  tail call void @_ZN5folly6detail24MergingCancellationState7destroyEv(ptr noundef nonnull align 16 dereferenceable(40) %i.r) #7
...
bb.l:                                             ; preds = %bb.j
  ...
  %i.y = load ptr, ptr %i.x, align 8
  tail call void %i.y(ptr noundef nonnull align 8 dead_on_return(32) dereferenceable(32) %i.r) #7, !call_target !499, !inline_history !505
  br label %_ZN5folly17CancellationTokenD2Ev.exit.i.i
...
_ZN5folly17CancellationTokenD2Ev.exit.i.i:        ; preds = %bb.l, %bb.k, %bb.i, %_ZN5folly3TryIvED2Ev.exit.i
  ...
  %i.aa = load i64, ptr %i.z, align 8, !tbaa !106 ; 2 uses
...
bb.n:                                             ; preds = %bb.m
  ...
  tail call void %i.ag(ptr noundef nonnull align 8 dereferenceable(8) %i.ac) #7, !call_target !119, !inline_history !506
...
attributes #3 = { noreturn nounwind "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+avx,+avx2,+bmi2,+cmov,+crc32,+cx8,+f16c,+fma,+fxsr,+lzcnt,+mmx,+popcnt,+sse,+sse2,+sse3,+sse4.1,+sse4.2,+ssse3,+x87,+xsave" "tune-cpu"="generic" }
...
attributes #10 = { mustprogress norecurse nounwind uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+avx,+avx2,+bmi2,+cmov,+crc32,+cx8,+f16c,+fma,+fxsr,+lzcnt,+mmx,+popcnt,+sse,+sse2,+sse3,+sse4.1,+sse4.2,+ssse3,+x87,+xsave" "tune-cpu"="generic" }
attributes #11 = { mustprogress noinline uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+avx,+avx2,+bmi2,+cmov,+crc32,+cx8,+f16c,+fma,+fxsr,+lzcnt,+mmx,+popcnt,+sse,+sse2,+sse3,+sse4.1,+sse4.2,+ssse3,+x87,+xsave" "tune-cpu"="generic" }
...
attributes #22 = { nobuiltin allocsize(0) "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+avx,+avx2,+bmi2,+cmov,+crc32,+cx8,+f16c,+fma,+fxsr,+lzcnt,+mmx,+popcnt,+sse,+sse2,+sse3,+sse4.1,+sse4.2,+ssse3,+x87,+xsave" "tune-cpu"="generic" }
attributes #23 = { mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+avx,+avx2,+bmi2,+cmov,+crc32,+cx8,+f16c,+fma,+fxsr,+lzcnt,+mmx,+popcnt,+sse,+sse2,+sse3,+sse4.1,+sse4.2,+ssse3,+x87,+xsave" "tune-cpu"="generic" }
attributes #24 = { mustprogress norecurse nounwind willreturn memory(argmem: readwrite) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+avx,+avx2,+bmi2,+cmov,+crc32,+cx8,+f16c,+fma,+fxsr,+lzcnt,+mmx,+popcnt,+sse,+sse2,+sse3,+sse4.1,+sse4.2,+ssse3,+x87,+xsave" "tune-cpu"="generic" }
...
!10 = !{!"Simple C++ TBAA"}
!11 = !{!12}
!12 = distinct !{!12, !13, !"_ZN5folly16SynchronizedBaseINS_12SynchronizedIN5boost9intrusive4listINS_6fibers9Semaphore6WaiterEJNS3_11member_hookIS7_NS3_16list_member_hookIJNS3_9link_modeILNS3_14link_mode_typeE1EEEEEEXadL_ZNS7_5hook_EEEEENS3_18constant_time_sizeILb0EEEEEENS_15SharedMutexImplILb0EvSt6atomicNS_24SharedMutexPolicyDefaultEEEEELNS_6detail22SynchronizedMutexLevelE2EE5wlockEv: argument 0"}
!13 = distinct !{!13, !"_ZN5folly16SynchronizedBaseINS_12SynchronizedIN5boost9intrusive4listINS_6fibers9Semaphore6WaiterEJNS3_11member_hookIS7_NS3_16list_member_hookIJNS3_9link_modeILNS3_14link_mode_typeE1EEEEEEXadL_ZNS7_5hook_EEEEENS3_18constant_time_sizeILb0EEEEEENS_15SharedMutexImplILb0EvSt6atomicNS_24SharedMutexPolicyDefaultEEEEELNS_6detail22SynchronizedMutexLevelE2EE5wlockEv"}
!14 = !{!15, !16, i64 0}
!15 = !{!"_ZTSSt11unique_lockIN5folly15SharedMutexImplILb0EvSt6atomicNS0_24SharedMutexPolicyDefaultEEEE", !16, i64 0, !18, i64 8}
!16 = !{!"p1 _ZTSN5folly15SharedMutexImplILb0EvSt6atomicNS_24SharedMutexPolicyDefaultEEE", !17, i64 0}
...
!24 = !{!"p1 _ZTSN5boost9intrusive9list_nodeIPvEE", !17, i64 0}
!25 = !{!23, !24, i64 8}
!26 = !{i8 0, i8 2}
!27 = !{}
!28 = !{i64 12677257}
...
!37 = distinct !{!37, !30}
!38 = !{!39}
!39 = distinct !{!39, !40, !"_ZN5folly16SynchronizedBaseINS_12SynchronizedIN5boost9intrusive4listINS_6fibers9Semaphore6WaiterEJNS3_11member_hookIS7_NS3_16list_member_hookIJNS3_9link_modeILNS3_14link_mode_typeE1EEEEEEXadL_ZNS7_5hook_EEEEENS3_18constant_time_sizeILb0EEEEEENS_15SharedMutexImplILb0EvSt6atomicNS_24SharedMutexPolicyDefaultEEEEELNS_6detail22SynchronizedMutexLevelE2EE5wlockEv: argument 0"}
!40 = distinct !{!40, !"_ZN5folly16SynchronizedBaseINS_12SynchronizedIN5boost9intrusive4listINS_6fibers9Semaphore6WaiterEJNS3_11member_hookIS7_NS3_16list_member_hookIJNS3_9link_modeILNS3_14link_mode_typeE1EEEEEEXadL_ZNS7_5hook_EEEEENS3_18constant_time_sizeILb0EEEEEENS_15SharedMutexImplILb0EvSt6atomicNS_24SharedMutexPolicyDefaultEEEEELNS_6detail22SynchronizedMutexLevelE2EE5wlockEv"}
!41 = !{!42}
...
!48 = distinct !{!48, !30}
!49 = !{!50, !17, i64 0}
!50 = !{!"_ZTSNSt7__n486116coroutine_handleIN5folly4coro6detail24ScopeExitTaskPromiseBaseEEE", !17, i64 0}
!51 = !{!52, !17, i64 0}
!52 = !{!"_ZTSN5folly4coro23ExtendedCoroutineHandle11PromiseBaseE", !17, i64 0}
!53 = !{!54, !18, i64 0}
!54 = !{!"_ZTSN5folly3TryIvEE", !18, i64 0, !9, i64 8}
!55 = !{!17, !17, i64 0}
!56 = !{!57}
!57 = distinct !{!57, !58, !"_ZN5folly4coro6detail19TaskPromiseCrtpBaseINS1_11TaskPromiseIvEEvE17get_return_objectEv: argument 0"}
!58 = distinct !{!58, !"_ZN5folly4coro6detail19TaskPromiseCrtpBaseINS1_11TaskPromiseIvEEvE17get_return_objectEv"}
!59 = !{!60, !17, i64 0}
!60 = !{!"_ZTSNSt7__n486116coroutine_handleIN5folly4coro6detail12ViaCoroutineILb0EE12promise_typeEEE", !17, i64 0}
!61 = !{!62, !62, i64 0}
!62 = !{!"p1 _ZTSN5folly4coro23ExtendedCoroutineHandle11PromiseBaseE", !17, i64 0}
!63 = !{!64, !66, i64 16}
!64 = !{!"_ZTSN5folly15AsyncStackFrameE", !65, i64 0, !17, i64 8, !66, i64 16}
!65 = !{!"p1 _ZTSN5folly15AsyncStackFrameE", !17, i64 0}
!66 = !{!"p1 _ZTSN5folly14AsyncStackRootE", !17, i64 0}
!67 = !{!64, !65, i64 0}
!68 = !{!64, !17, i64 8}
!69 = !{!70, !73, i64 16}
!70 = !{!"_ZTSN5folly6fibers6detail20BatonAwaitableWaiterE", !71, i64 0, !72, i64 8, !73, i64 16}
!71 = !{!"_ZTSN5folly6fibers5Baton6WaiterE"}
!72 = !{!"_ZTSNSt7__n486116coroutine_handleIvEE", !17, i64 0}
!73 = !{!"p1 _ZTSN5folly6fibers5BatonE", !17, i64 0}
!74 = !{i64 8}
!75 = !{!76, !80, i64 16}
!76 = !{!"_ZTSN5folly20CancellationCallbackE", !77, i64 0, !78, i64 8, !80, i64 16, !81, i64 32, !82, i64 96, !83, i64 104}
!77 = !{!"p1 _ZTSN5folly20CancellationCallbackE", !17, i64 0}
!78 = !{!"p2 _ZTSN5folly20CancellationCallbackE", !79, i64 0}
!79 = !{!"any p2 pointer", !17, i64 0}
!80 = !{!"p1 _ZTSN5folly6detail17CancellationStateE", !17, i64 0}
!81 = !{!"_ZTSN5folly8FunctionIFvvEEE", !9, i64 0, !17, i64 48, !17, i64 56}
!82 = !{!"p1 bool", !17, i64 0}
!83 = !{!"_ZTSSt6atomicIbE", !84, i64 0}
!84 = !{!"_ZTSSt13__atomic_baseIbE", !18, i64 0}
!85 = !{!81, !17, i64 56}
...
!90 = !{!91, !17, i64 0}
!91 = !{!"_ZTSNSt15__exception_ptr13exception_ptrE", !17, i64 0}
!92 = !{!93}
!93 = distinct !{!93, !94, !"_ZN5folly6detail21extract_exception_ptrEONSt15__exception_ptr13exception_ptrE: argument 0"}
!94 = distinct !{!94, !"_ZN5folly6detail21extract_exception_ptrEONSt15__exception_ptr13exception_ptrE"}
!95 = !{!96, !97, i64 0}
!96 = !{!"_ZTSN5folly4coro6detail23BypassExceptionThrowingE", !97, i64 0}
!97 = !{!"_ZTSN5folly4coro6detail23BypassExceptionThrowing10BypassModeE", !9, i64 0}
!98 = !{!99}
!99 = distinct !{!99, !100, !"_ZN5folly6detail21extract_exception_ptrEONSt15__exception_ptr13exception_ptrE: argument 0"}
!100 = distinct !{!100, !"_ZN5folly6detail21extract_exception_ptrEONSt15__exception_ptr13exception_ptrE"}
!101 = !{!102}
!102 = distinct !{!102, !103, !"_ZN5folly6detail21extract_exception_ptrEONSt15__exception_ptr13exception_ptrE: argument 0"}
!103 = distinct !{!103, !"_ZN5folly6detail21extract_exception_ptrEONSt15__exception_ptr13exception_ptrE"}
!104 = !{!105, !18, i64 24}
!105 = !{!"_ZTSSt22_Optional_payload_baseISt4pairIN5folly4coro23ExtendedCoroutineHandleEPNS1_15AsyncStackFrameEEE", !9, i64 0, !18, i64 24}
!106 = !{!107, !108, i64 0}
!107 = !{!"_ZTSN5folly17ExecutorKeepAliveINS_8ExecutorEEE", !108, i64 0}
!108 = !{!"long", !9, i64 0}
!109 = !{!110}
...
!112 = !{!113, !65, i64 16}
!113 = !{!"_ZTSN5folly4coro6detail24ScopeExitTaskPromiseBaseE", !114, i64 0, !65, i64 16, !107, i64 24, !115, i64 32, !50, i64 40}
!114 = !{!"_ZTSN5folly4coro23ExtendedCoroutineHandleE", !72, i64 0, !62, i64 8}
!115 = !{!"_ZTSN5folly17exception_wrapperE", !91, i64 0}
!116 = !{!108, !108, i64 0}
!117 = !{!118, !118, i64 0}
...
!131 = distinct !{null}
!132 = !{!133, !134, i64 0}
!133 = !{!"_ZTSZN5folly6fibers9Semaphore7co_waitEvE3$_0", !134, i64 0, !135, i64 8, !82, i64 16}
!134 = !{!"p1 _ZTSN5folly6fibers9SemaphoreE", !17, i64 0}
!135 = !{!"p1 _ZTSN5folly6fibers9Semaphore6WaiterE", !17, i64 0}
!136 = !{!137}
!137 = distinct !{!137, !138, !"_ZN5folly16SynchronizedBaseINS_12SynchronizedIN5boost9intrusive4listINS_6fibers9Semaphore6WaiterEJNS3_11member_hookIS7_NS3_16list_member_hookIJNS3_9link_modeILNS3_14link_mode_typeE1EEEEEEXadL_ZNS7_5hook_EEEEENS3_18constant_time_sizeILb0EEEEEENS_15SharedMutexImplILb0EvSt6atomicNS_24SharedMutexPolicyDefaultEEEEELNS_6detail22SynchronizedMutexLevelE2EE5wlockEv: argument 0"}
!138 = distinct !{!138, !"_ZN5folly16SynchronizedBaseINS_12SynchronizedIN5boost9intrusive4listINS_6fibers9Semaphore6WaiterEJNS3_11member_hookIS7_NS3_16list_member_hookIJNS3_9link_modeILNS3_14link_mode_typeE1EEEEEEXadL_ZNS7_5hook_EEEEENS3_18constant_time_sizeILb0EEEEEENS_15SharedMutexImplILb0EvSt6atomicNS_24SharedMutexPolicyDefaultEEEEELNS_6detail22SynchronizedMutexLevelE2EE5wlockEv"}
!139 = !{!133, !135, i64 8}
!140 = !{!133, !82, i64 16}
!141 = !{!18, !18, i64 0}
!142 = !{!143}
!143 = distinct !{!143, !144, !"_ZN5boost9intrusive9list_implINS0_8mhtraitsIN5folly6fibers9Semaphore6WaiterENS0_16list_member_hookIJNS0_9link_modeILNS0_14link_mode_typeE1EEEEEEXadL_ZNS6_5hook_EEEEEmLb0EvE17erase_and_disposeINS0_6detail13null_disposerEEENS0_13list_iteratorISC_Lb0EEENSH_ISC_Lb1EEET_: argument 0"}
end_hunk_0
begin_hunk_1_@_ZN5folly6fibers9Semaphore7co_waitEv.destroy:resume.entry
...
!326 = !{!327}
!327 = distinct !{!327, !328, !"_ZSt11make_uniqueIN5folly6fibers12_GLOBAL__N_112FutureWaiterEJEENSt8__detail9_MakeUniqIT_E15__single_objectEDpOT0_: argument 0"}
!328 = distinct !{!328, !"_ZSt11make_uniqueIN5folly6fibers12_GLOBAL__N_112FutureWaiterEJEENSt8__detail9_MakeUniqIT_E15__single_objectEDpOT0_"}
!329 = !{!330, !331, i64 0}
!330 = !{!"_ZTSSt6atomicIN5folly7futures6detail5StateEE", !331, i64 0}
!331 = !{!"_ZTSN5folly7futures6detail5StateE", !9, i64 0}
!332 = !{!333, !9, i64 0}
!333 = !{!"_ZTSSt13__atomic_baseIhE", !9, i64 0}
!334 = !{!335, !336, i64 0}
!335 = !{!"_ZTSN5folly7futures6detail19KeepAliveOrDeferredE", !336, i64 0, !9, i64 8}
!336 = !{!"_ZTSN5folly7futures6detail19KeepAliveOrDeferred5StateE", !9, i64 0}
!337 = !{!338, !339, i64 8}
!338 = !{!"_ZTSN5folly7PromiseINS_4UnitEEE", !18, i64 0, !339, i64 8}
!339 = !{!"p1 _ZTSN5folly7futures6detail4CoreINS_4UnitEEE", !17, i64 0}
!340 = !{!341, !341, i64 0}
!341 = !{!"p1 _ZTSN5folly6fibers12_GLOBAL__N_112FutureWaiterE", !17, i64 0}
!342 = !{!343}
!343 = distinct !{!343, !344, !"_ZN5folly7PromiseINS_4UnitEE13getSemiFutureEv: argument 0"}
!344 = distinct !{!344, !"_ZN5folly7PromiseINS_4UnitEE13getSemiFutureEv"}
!345 = !{!338, !18, i64 0}
!346 = !{!347, !339, i64 0}
!347 = !{!"_ZTSN5folly7futures6detail10FutureBaseINS_4UnitEEE", !339, i64 0}
!348 = !{!349}
!349 = distinct !{!349, !350, !"_ZN5folly16SynchronizedBaseINS_12SynchronizedIN5boost9intrusive4listINS_6fibers9Semaphore6WaiterEJNS3_11member_hookIS7_NS3_16list_member_hookIJNS3_9link_modeILNS3_14link_mode_typeE1EEEEEEXadL_ZNS7_5hook_EEEEENS3_18constant_time_sizeILb0EEEEEENS_15SharedMutexImplILb0EvSt6atomicNS_24SharedMutexPolicyDefaultEEEEELNS_6detail22SynchronizedMutexLevelE2EE5wlockEv: argument 0"}
!350 = distinct !{!350, !"_ZN5folly16SynchronizedBaseINS_12SynchronizedIN5boost9intrusive4listINS_6fibers9Semaphore6WaiterEJNS3_11member_hookIS7_NS3_16list_member_hookIJNS3_9link_modeILNS3_14link_mode_typeE1EEEEEEXadL_ZNS7_5hook_EEEEENS3_18constant_time_sizeILb0EEEEEENS_15SharedMutexImplILb0EvSt6atomicNS_24SharedMutexPolicyDefaultEEEEELNS_6detail22SynchronizedMutexLevelE2EE5wlockEv"}
!351 = distinct !{!351, !30}
!352 = !{!353}
...
!362 = !{!359, !356, !353}
!363 = !{!364, !17, i64 48}
!364 = !{!"_ZTSN5folly8FunctionIFvRNS_7futures6detail8CoreBaseEONS_17ExecutorKeepAliveINS_8ExecutorEEEPNS_17exception_wrapperEEEE", !9, i64 0, !17, i64 48, !17, i64 56}
!365 = !{!364, !17, i64 56}
!366 = !{!367, !368, i64 0}
...
!376 = !{!"p1 omnipotent char", !17, i64 0}
!377 = !{!378}
...
!395 = !{!"p1 _ZTSN5folly13BrokenPromiseE", !17, i64 0}
...
!440 = !{!441, !441, i64 0}
!441 = !{!"p1 _ZTSN5folly7futures6detail16DeferredExecutorE", !17, i64 0}
!442 = !{!443, !108, i64 0}
!443 = !{!"_ZTSN5folly6fibers9SemaphoreE", !108, i64 0, !444, i64 8, !446, i64 16}
!444 = !{!"_ZTSSt6atomicIlE", !445, i64 0}
!445 = !{!"_ZTSSt13__atomic_baseIlE", !108, i64 0}
!446 = !{!"_ZTSN5folly12SynchronizedIN5boost9intrusive4listINS_6fibers9Semaphore6WaiterEJNS2_11member_hookIS6_NS2_16list_member_hookIJNS2_9link_modeILNS2_14link_mode_typeE1EEEEEEXadL_ZNS6_5hook_EEEEENS2_18constant_time_sizeILb0EEEEEENS_15SharedMutexImplILb0EvSt6atomicNS_24SharedMutexPolicyDefaultEEEEE", !447, i64 0, !452, i64 16}
!447 = !{!"_ZTSN5boost9intrusive4listIN5folly6fibers9Semaphore6WaiterEJNS0_11member_hookIS5_NS0_16list_member_hookIJNS0_9link_modeILNS0_14link_mode_typeE1EEEEEEXadL_ZNS5_5hook_EEEEENS0_18constant_time_sizeILb0EEEEEE", !448, i64 0}
!448 = !{!"_ZTSN5boost9intrusive9list_implINS0_8mhtraitsIN5folly6fibers9Semaphore6WaiterENS0_16list_member_hookIJNS0_9link_modeILNS0_14link_mode_typeE1EEEEEEXadL_ZNS6_5hook_EEEEEmLb0EvEE", !449, i64 0}
!449 = !{!"_ZTSN5boost9intrusive9list_implINS0_8mhtraitsIN5folly6fibers9Semaphore6WaiterENS0_16list_member_hookIJNS0_9link_modeILNS0_14link_mode_typeE1EEEEEEXadL_ZNS6_5hook_EEEEEmLb0EvE6data_tE", !450, i64 0}
!450 = !{!"_ZTSN5boost9intrusive9list_implINS0_8mhtraitsIN5folly6fibers9Semaphore6WaiterENS0_16list_member_hookIJNS0_9link_modeILNS0_14link_mode_typeE1EEEEEEXadL_ZNS6_5hook_EEEEEmLb0EvE14root_plus_sizeE", !451, i64 0}
!451 = !{!"_ZTSN5boost9intrusive6detail21default_header_holderINS0_16list_node_traitsIPvEEEE", !23, i64 0}
...
!455 = !{!"branch_weights", i32 0, i32 -645922666, i32 671087678, i32 159383105}
!456 = !{!457, !457, i64 0}
!457 = !{!"_ZN5folly6fibers9Semaphore7co_waitEv.Frame Slot", !10, i64 0}
!458 = !{!459}
!459 = distinct !{!459, !460, !"_ZN5folly16SynchronizedBaseINS_12SynchronizedIN5boost9intrusive4listINS_6fibers9Semaphore6WaiterEJNS3_11member_hookIS7_NS3_16list_member_hookIJNS3_9link_modeILNS3_14link_mode_typeE1EEEEEEXadL_ZNS7_5hook_EEEEENS3_18constant_time_sizeILb0EEEEEENS_15SharedMutexImplILb0EvSt6atomicNS_24SharedMutexPolicyDefaultEEEEELNS_6detail22SynchronizedMutexLevelE2EE5wlockEv: argument 0"}
!460 = distinct !{!460, !"_ZN5folly16SynchronizedBaseINS_12SynchronizedIN5boost9intrusive4listINS_6fibers9Semaphore6WaiterEJNS3_11member_hookIS7_NS3_16list_member_hookIJNS3_9link_modeILNS3_14link_mode_typeE1EEEEEEXadL_ZNS7_5hook_EEEEENS3_18constant_time_sizeILb0EEEEEENS_15SharedMutexImplILb0EvSt6atomicNS_24SharedMutexPolicyDefaultEEEEELNS_6detail22SynchronizedMutexLevelE2EE5wlockEv"}
!461 = !{!76, !82, i64 96}
!462 = !{!84, !18, i64 0}
!463 = !{!80, !80, i64 0}
!464 = !{!465}
!465 = distinct !{!465, !466, !"_ZN5folly4coro6detail11BasePromiseINS_4UnitEE15await_transformIRNS_6fibers5BatonETnNSt9enable_ifIXntsr5folly3extE22must_use_immediately_vIT_EEiE4typeELi0EEEDaOSA_: argument 0"}
!466 = distinct !{!466, !"_ZN5folly4coro6detail11BasePromiseINS_4UnitEE15await_transformIRNS_6fibers5BatonETnNSt9enable_ifIXntsr5folly3extE22must_use_immediately_vIT_EEiE4typeELi0EEEDaOSA_"}
!467 = !{!468, !465}
!468 = distinct !{!468, !469, !"_ZNK5folly17ExecutorKeepAliveINS_8ExecutorEE9get_aliasEv: argument 0"}
!469 = distinct !{!469, !"_ZNK5folly17ExecutorKeepAliveINS_8ExecutorEE9get_aliasEv"}
!470 = !{!471}
!471 = distinct !{!471, !472, !"_ZNO5folly4coro29StackAwareViaIfAsyncAwaitableIRNS_6fibers5BatonEEawEv: argument 0"}
!472 = distinct !{!472, !"_ZNO5folly4coro29StackAwareViaIfAsyncAwaitableIRNS_6fibers5BatonEEawEv"}
!473 = !{!474}
!474 = distinct !{!474, !475, !"_ZN5folly4coro6detail12ViaCoroutineILb0EE6createENS_17ExecutorKeepAliveINS_8ExecutorEEE: argument 0"}
!475 = distinct !{!475, !"_ZN5folly4coro6detail12ViaCoroutineILb0EE6createENS_17ExecutorKeepAliveINS_8ExecutorEEE"}
!476 = !{!474, !471}
!477 = !{!478, !474, !471}
!478 = distinct !{!478, !479, !"_ZN5folly4coro6detail12ViaCoroutineILb0EE12promise_type17get_return_objectEv: argument 0"}
!479 = distinct !{!479, !"_ZN5folly4coro6detail12ViaCoroutineILb0EE12promise_type17get_return_objectEv"}
!480 = !{!481, !483, !471}
!481 = distinct !{!481, !482, !"_ZN5folly6fibersawERNS0_5BatonE: argument 0"}
!482 = distinct !{!482, !"_ZN5folly6fibersawERNS0_5BatonE"}
!483 = distinct !{!483, !484, !"_ZNK5folly4coro14get_awaiter_fnclIRNS_6fibers5BatonETnNSt9enable_ifIXsr5folly11ConjunctionINS0_6detail27_has_free_operator_co_awaitIT_vEENS_8NegationINS7_29_has_member_operator_co_awaitIS9_vEEEEEE5valueEiE4typeELi0EEEDcOS9_: argument 0"}
!484 = distinct !{!484, !"_ZNK5folly4coro14get_awaiter_fnclIRNS_6fibers5BatonETnNSt9enable_ifIXsr5folly11ConjunctionINS0_6detail27_has_free_operator_co_awaitIT_vEENS_8NegationINS7_29_has_member_operator_co_awaitIS9_vEEEEEE5valueEiE4typeELi0EEEDcOS9_"}
!485 = !{!73, !73, i64 0}
!486 = distinct !{null}
!487 = distinct !{ptr @_ZN5folly20CancellationCallbackD2Ev, null, null}
!488 = !{!489}
!489 = distinct !{!489, !490, !"_ZNK5folly4coro14co_cancelled_tcvNS0_8co_errorEEv: argument 0"}
!490 = distinct !{!490, !"_ZNK5folly4coro14co_cancelled_tcvNS0_8co_errorEEv"}
!491 = !{!492, !489}
!492 = distinct !{!492, !493, !"_ZNK5folly26make_exception_ptr_with_fnclIZNKS0_4makeINS_18OperationCancelledEJOS3_EEEDaDpOT0_EUlvE_TnPDTclclscPDoFRT_vELDnEEEELPS3_0EEENSt15__exception_ptr13exception_ptrES9_: argument 0"}
!493 = distinct !{!493, !"_ZNK5folly26make_exception_ptr_with_fnclIZNKS0_4makeINS_18OperationCancelledEJOS3_EEEDaDpOT0_EUlvE_TnPDTclclscPDoFRT_vELDnEEEELPS3_0EEENSt15__exception_ptr13exception_ptrES9_"}
!494 = !{!495}
!495 = distinct !{!495, !496, !"_ZN5folly6detail21extract_exception_ptrEONSt15__exception_ptr13exception_ptrE: argument 0"}
!496 = distinct !{!496, !"_ZN5folly6detail21extract_exception_ptrEONSt15__exception_ptr13exception_ptrE"}
!497 = distinct !{!497, !30}
!498 = !{!"branch_weights", i32 0, i32 -645922666, i32 671087678, i32 159383105, i32 301990644}
!499 = !DISubprogram(name: "~CancellationState", linkageName: "_ZN5folly6detail17CancellationStateD4Ev", scope: !501, file: !500, line: 43, type: !502, scopeLine: 43, containingType: !501, virtualIndex: 0, flags: DIFlagProtected | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
!500 = !DIFile(filename: "_deps/folly-src/folly/CancellationToken-inl.h", directory: "/opt-bench/work/velox/velox/build", checksumkind: CSK_MD5, checksum: "0fe5390f30e4d65ce495e93960df2e48")
!501 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "CancellationState", scope: !178, file: !500, line: 33, size: 256, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: "_ZTSN5folly6detail17CancellationStateE")
!502 = !DISubroutineType(types: !503)
!503 = !{null, !504}
!504 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !501, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!505 = distinct !{null, null, null, null, null, null}
