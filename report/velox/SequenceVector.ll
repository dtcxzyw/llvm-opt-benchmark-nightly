...
bb.j:                                             ; preds = %bb.h
  %i.ak = load i8, ptr @__libc_single_threaded, align 1, !tbaa !15
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i: ; preds = %bb.l, %bb.k
  ...
  br i1 %i.an, label %bb.m, label %_ZNSt12__shared_ptrIKN8facebook5velox4TypeELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit, !prof !34
...
_ZNSt12__shared_ptrIKN8facebook5velox4TypeELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit: ; preds = %_ZN5boost13intrusive_ptrIN8facebook5velox6BufferEED2Ev.exit, %bb.i, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i, %bb.m
  store ptr getelementptr inbounds nuw inrange(-16, 400) (i8, ptr @_ZTVN8facebook5velox10FlatVectorImEE, i64 16), ptr %0, align 8, !tbaa !19
  %i.ao = getelementptr inbounds nuw i8, ptr %0, i64 136 ; 4 uses
  %i.ap = load ptr, ptr %5, align 8, !tbaa !16
  store ptr %i.ap, ptr %i.ao, align 8, !tbaa !16
  store ptr null, ptr %5, align 8, !tbaa !16
  %i.aq = getelementptr inbounds nuw i8, ptr %0, i64 144
  %i.ar = load ptr, ptr %i.ao, align 8, !tbaa !16 ; 2 uses
...
bb.o:                                             ; preds = %_ZNSt12__shared_ptrIKN8facebook5velox4TypeELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit, %bb.n
  ...
  store ptr %i.au, ptr %i.aq, align 8, !tbaa !448
  ...
  store ptr @_ZZN5folly3f146detail20getF14EmptyTagVectorEvE8instance, ptr %i.aw, align 8, !tbaa !465
  ...
  %i.ay = load <2 x ptr>, ptr %6, align 8, !tbaa !466
  store <2 x ptr> %i.ay, ptr %17, align 16, !tbaa !466
  ...
  store ptr %i.bb, ptr %i.az, align 16, !tbaa !106
...
bb.p:                                             ; preds = %bb.o
  ...
  %i.bd = load ptr, ptr %17, align 16, !tbaa !101 ; 3 uses
  %i.be = load ptr, ptr %i.bc, align 8, !tbaa !104 ; 2 uses
...
.lr.ph.i.i.i:                                     ; preds = %bb.p, %_ZSt8_DestroyIN5boost13intrusive_ptrIN8facebook5velox6BufferEEEEvPT_.exit.i.i.i
  ...
  %i.bf = load ptr, ptr %.05.i.i.i, align 8, !tbaa !16 ; 7 uses
...
.sink.split.i.i.i.i.i.i.i:                        ; preds = %bb.q
  ...
  invoke void %i.bl(ptr noundef nonnull align 8 dereferenceable(64) %i.bf)
          to label %.noexc.i.i.i.i.i.i unwind label %bb.r, !inline_history !21
...
.noexc.i.i.i.i.i.i:                               ; preds = %.sink.split.i.i.i.i.i.i.i
  ...
  %i.bo = load ptr, ptr %i.bf, align 8, !tbaa !19
  ...
  invoke void %i.bq(ptr noundef nonnull align 8 dereferenceable(64) %i.bf)
          to label %_ZSt8_DestroyIN5boost13intrusive_ptrIN8facebook5velox6BufferEEEEvPT_.exit.i.i.i unwind label %bb.r, !inline_history !21
...
_ZSt8_DestroyIN5boost13intrusive_ptrIN8facebook5velox6BufferEEEEvPT_.exit.i.i.i: ; preds = %.noexc.i.i.i.i.i.i, %bb.q, %.lr.ph.i.i.i
  ...
  br i1 %.not.i.i.i35, label %_ZSt8_DestroyIPN5boost13intrusive_ptrIN8facebook5velox6BufferEEES5_EvT_S7_RSaIT0_E.exitthread-pre-split.i, label %.lr.ph.i.i.i, !llvm.loop !105
...
_ZSt8_DestroyIPN5boost13intrusive_ptrIN8facebook5velox6BufferEEES5_EvT_S7_RSaIT0_E.exitthread-pre-split.i: ; preds = %_ZSt8_DestroyIN5boost13intrusive_ptrIN8facebook5velox6BufferEEEEvPT_.exit.i.i.i
  %.pr.i = load ptr, ptr %17, align 16, !tbaa !101
...
bb.s:                                             ; preds = %_ZSt8_DestroyIPN5boost13intrusive_ptrIN8facebook5velox6BufferEEES5_EvT_S7_RSaIT0_E.exit.i
  %i.bv = load ptr, ptr %i.az, align 16, !tbaa !106
  %i.bw = ptrtoint ptr %i.bv to i64
  %i.bx = ptrtoint ptr %i.bu to i64
  %i.by = sub i64 %i.bw, %i.bx
  call void @_ZdlPvm(ptr noundef nonnull %i.bu, i64 noundef %i.by) #36
...
_ZNSt6vectorIN5boost13intrusive_ptrIN8facebook5velox6BufferEEESaIS5_EED2Ev.exit: ; preds = %_ZSt8_DestroyIPN5boost13intrusive_ptrIN8facebook5velox6BufferEEES5_EvT_S7_RSaIT0_E.exit.i, %bb.s
  %i.bz = load ptr, ptr %i.ao, align 8, !tbaa !16 ; 5 uses
...
bb.z:                                             ; preds = %bb.t
  ...
  %i.cg = load ptr, ptr %i.cf, align 8, !tbaa !129 ; 4 uses
  %i.ch = getelementptr inbounds nuw i8, ptr %0, i64 56
  %i.ci = load i32, ptr %i.ch, align 8, !tbaa !61 ; 5 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i64>, ptr %i.cr, align 8, !tbaa !93
  %wide.load82 = load <4 x i64>, ptr %i.cs, align 8, !tbaa !93
  %wide.load83 = load <4 x i64>, ptr %i.ct, align 8, !tbaa !93
  %wide.load84 = load <4 x i64>, ptr %i.cu, align 8, !tbaa !93
  ...
  br i1 %i.dh, label %middle.block, label %vector.body, !llvm.loop !467
...
vec.epilog.iter.check:                            ; preds = %middle.block
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph.i.i.i37.preheader, label %vec.epilog.ph, !prof !440
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load92 = load <4 x i64>, ptr %i.dn, align 8, !tbaa !93
  ...
  br i1 %i.dr, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !468
...
.lr.ph.i.i.i37:                                   ; preds = %.lr.ph.i.i.i37.preheader, %.lr.ph.i.i.i37
  ...
  br i1 %.not33.i.i.i.not, label %.lr.ph.i.i.i37, label %._crit_edge.i.i.i, !llvm.loop !469
...
bb.ab:                                            ; preds = %.sink.split.i.i.i, %._crit_edge.i.i.i
  ...
  br i1 %.not26, label %.thread, label %bb.ac, !prof !470

bb.ac:                                            ; preds = %bb.ab
  %i.el = sext i32 %.3.i.i to i64
  call void @llvm.lifetime.start.p0(ptr nonnull %18) #34
  call void @llvm.lifetime.start.p0(ptr nonnull %14) #34, !noalias !471
  store i32 0, ptr %14, align 16, !tbaa !15, !alias.scope !474, !noalias !471
  %i.em = getelementptr inbounds nuw i8, ptr %14, i64 16
  store i64 %i.el, ptr %i.em, align 16, !tbaa !15, !alias.scope !474, !noalias !471
  invoke void @_ZN3fmt3v117vformatB5cxx11ENS0_17basic_string_viewIcEENS0_17basic_format_argsINS0_7contextEEE(ptr dead_on_unwind nonnull writable sret(%"class.std::__cxx11::basic_string") align 8 %18, ptr nonnull @.str.112, i64 77, i64 65, ptr nonnull %14)
          to label %bb.ad unwind label %bb.af

bb.ad:                                            ; preds = %bb.ac
  call void @llvm.lifetime.end.p0(ptr nonnull %14) #34, !noalias !471
  invoke void @_ZN8facebook5velox6detail14veloxCheckFailINS0_17VeloxRuntimeErrorERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEEvRKNS1_18VeloxCheckFailArgsET0_NS0_24CompileTimeStringLiteralE(ptr noundef nonnull align 8 dereferenceable(56) @_ZZN8facebook5velox10FlatVectorImEC1EPNS0_6memory10MemoryPoolERKSt10shared_ptrIKNS0_4TypeEEN5boost13intrusive_ptrINS0_6BufferEEEiSF_OSt6vectorISF_SaISF_EERKNS0_17SimpleVectorStatsImEESt8optionalIiESP_SO_IbESP_SP_E18veloxCheckFailArgs_1, ptr noundef nonnull align 8 dereferenceable(32) %18, ptr nonnull @.str.112) #35
...
bb.ag:                                            ; preds = %bb.ad
  %i.eo = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.ep = load ptr, ptr %18, align 8, !tbaa !69   ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %bb.ag
  %i.es = load i64, ptr %i.eq, align 8, !tbaa !15
  %i.et = add i64 %i.es, 1
  call void @_ZdlPvm(ptr noundef %i.ep, i64 noundef %i.et) #36
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
...
.critedge:                                        ; preds = %_ZNSt6vectorIN5boost13intrusive_ptrIN8facebook5velox6BufferEEESaIS5_EED2Ev.exit
  ...
  %i.ev = load i32, ptr %i.eu, align 8, !tbaa !61
  %i.ew = sext i32 %i.ev to i64
  %i.ex = shl nsw i64 %i.ew, 3                    ; 4 uses
  %i.ey = getelementptr inbounds nuw i8, ptr %i.bz, i64 32
  %i.ez = load i64, ptr %i.ey, align 8, !tbaa !120 ; 2 uses
  %.not23 = icmp ult i64 %i.ez, %i.ex
  br i1 %.not23, label %bb.ah, label %bb.an, !prof !34

bb.ah:                                            ; preds = %.critedge
  call void @llvm.lifetime.start.p0(ptr nonnull %19) #34
  call void @llvm.lifetime.start.p0(ptr nonnull %13) #34, !noalias !477
  store i64 %i.ez, ptr %13, align 16, !tbaa !15, !alias.scope !480, !noalias !477
  %i.fa = getelementptr inbounds nuw i8, ptr %13, i64 16
  store i64 %i.ex, ptr %i.fa, align 16, !tbaa !15, !alias.scope !480, !noalias !477
  invoke void @_ZN3fmt3v117vformatB5cxx11ENS0_17basic_string_viewIcEENS0_17basic_format_argsINS0_7contextEEE(ptr dead_on_unwind nonnull writable sret(%"class.std::__cxx11::basic_string") align 8 %19, ptr nonnull @.str.40, i64 11, i64 68, ptr nonnull %13)
          to label %bb.ai unwind label %bb.al

bb.ai:                                            ; preds = %bb.ah
  call void @llvm.lifetime.end.p0(ptr nonnull %13) #34, !noalias !477
  invoke void @_ZN8facebook5velox6detail14veloxCheckFailINS0_17VeloxRuntimeErrorERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEEvRKNS1_18VeloxCheckFailArgsET0_NS0_24CompileTimeStringLiteralE(ptr noundef nonnull align 8 dereferenceable(56) @_ZZN8facebook5velox10FlatVectorImEC1EPNS0_6memory10MemoryPoolERKSt10shared_ptrIKNS0_4TypeEEN5boost13intrusive_ptrINS0_6BufferEEEiSF_OSt6vectorISF_SaISF_EERKNS0_17SimpleVectorStatsImEESt8optionalIiESP_SO_IbESP_SP_E18veloxCheckFailArgs_4, ptr noundef nonnull align 8 dereferenceable(32) %19, ptr nonnull @.str.40) #35
...
bb.am:                                            ; preds = %bb.ai
  %i.fd = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.fe = load ptr, ptr %19, align 8, !tbaa !69   ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i38: ; preds = %bb.am
  %i.fh = load i64, ptr %i.ff, align 8, !tbaa !15
  %i.fi = add i64 %i.fh, 1
...
bb.an:                                            ; preds = %.critedge
  ...
  %i.fk = load i64, ptr %i.fj, align 8, !tbaa !60
  %i.fl = icmp ult i64 %i.fk, %i.ex
  br i1 %i.fl, label %bb.ao, label %.thread

bb.ao:                                            ; preds = %bb.an
  %i.fm = load ptr, ptr %i.bz, align 8, !tbaa !19
...
bb.a:
  ...
  %i.c = load <2 x ptr>, ptr %2, align 8, !tbaa !14
  store ptr null, ptr %i.b, align 8, !tbaa !13
  store <2 x ptr> %i.c, ptr %12, align 16, !tbaa !14
...
bb.g:                                             ; preds = %bb.g, %.preheader.i37
  ...
  %i.bu = load i64, ptr %i.bt, align 8, !tbaa !93
  %i.bv = getelementptr inbounds [8 x i8], ptr %i.bq, i64 %i.bs
  store i64 %i.bu, ptr %i.bv, align 8, !tbaa !93
...
.lr.ph:                                           ; preds = %_ZZN8facebook5velox4bits10forEachBitIZNS0_10FlatVectorImE18copyValuesAndNullsEPKNS0_10BaseVectorERKNS0_17SelectivityVectorEPKiEUlT_E0_EEvPKmiibSD_ENKUlimE_clEim.exit40
  %i.bz = load i8, ptr %3, align 8, !tbaa !980, !range !125, !noundef !126
  ...
  %i.ci = load ptr, ptr %i.ch, align 8, !nonnull !126, !align !246 ; 2 uses
...
.lr.ph.i:                                         ; preds = %bb.h
  ...
  %i.ct = load ptr, ptr %i.cj, align 8, !tbaa !448
  br label %bb.j
...
iter.check:                                       ; preds = %bb.i
  ...
  %i.cy = load ptr, ptr %i.ci, align 8, !tbaa !253 ; 4 uses
  %i.cz = load ptr, ptr %i.cj, align 8, !tbaa !448 ; 4 uses
...
vector.body:                                      ; preds = %vector.main.loop.iter.check, %vector.body
  ...
  %wide.load = load <4 x i64>, ptr %i.dh, align 8, !tbaa !93
  %wide.load69 = load <4 x i64>, ptr %i.di, align 8, !tbaa !93
  %wide.load70 = load <4 x i64>, ptr %i.dj, align 8, !tbaa !93
  %wide.load71 = load <4 x i64>, ptr %i.dk, align 8, !tbaa !93
  ...
  store <4 x i64> %wide.load, ptr %i.dl, align 8, !tbaa !93
  store <4 x i64> %wide.load69, ptr %i.dm, align 8, !tbaa !93
  store <4 x i64> %wide.load70, ptr %i.dn, align 8, !tbaa !93
  store <4 x i64> %wide.load71, ptr %i.do, align 8, !tbaa !93
  %index.next = add nuw i64 %index, 16            ; 2 uses
  %i.dp = icmp eq i64 %index.next, %n.vec73
  br i1 %i.dp, label %middle.block, label %vector.body, !llvm.loop !1049
...
vec.epilog.vector.body:                           ; preds = %vector.main.loop.iter.check, %vec.epilog.vector.body
  ...
  %wide.load75 = load <4 x i64>, ptr %i.dr, align 8, !tbaa !93
  %i.ds = getelementptr inbounds nuw [8 x i8], ptr %i.cz, i64 %i.dq
  store <4 x i64> %wide.load75, ptr %i.ds, align 8, !tbaa !93
  %index.next76 = add nuw i64 %index74, 4         ; 2 uses
  %i.dt = icmp eq i64 %index.next76, %n.vec73
  br i1 %i.dt, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !1050
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph
  ...
  store i64 %i.dv, ptr %i.dw, align 8, !tbaa !93
  %i.dx = add nuw i64 %.020.i, 1                  ; 2 uses
  %i.dy = icmp ult i64 %i.dx, %i.cw
  br i1 %i.dy, label %vec.epilog.scalar.ph, label %_ZZN8facebook5velox4bits10forEachBitIZNS0_10FlatVectorImE18copyValuesAndNullsEPKNS0_10BaseVectorERKNS0_17SelectivityVectorEPKiEUlT_E0_EEvPKmiibSD_ENKUliE_clEi.exit, !llvm.loop !1051
...
bb.j:                                             ; preds = %bb.j, %.lr.ph.i
  ...
  store i64 %i.ec, ptr %i.ed, align 8, !tbaa !93
...
bb.k:                                             ; preds = %._crit_edge
  ...
  %i.el = load i8, ptr %2, align 8, !tbaa !976, !range !125, !noundef !126
  %i.em = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.en = load ptr, ptr %i.em, align 8, !tbaa !979
  %i.eo = sext i32 %i.eh to i64
  %i.ep = getelementptr inbounds [8 x i8], ptr %i.en, i64 %i.eo
  %i.eq = load i64, ptr %i.ep, align 8, !tbaa !93
  %i.er = xor i8 %i.el, 1
...
.preheader.i44:                                   ; preds = %bb.k
  ...
  %i.ex = load ptr, ptr %i.ew, align 8, !tbaa !1046
  %i.ey = getelementptr inbounds nuw i8, ptr %2, i64 24
  %i.ez = load ptr, ptr %i.ey, align 8, !tbaa !1047, !nonnull !126, !align !246
  %i.fa = load ptr, ptr %i.ez, align 8, !tbaa !253
  %i.fb = sext i32 %i.d to i64
  %i.fc = getelementptr inbounds nuw i8, ptr %i.ex, i64 144
  %i.fd = load ptr, ptr %i.fc, align 8, !tbaa !448
  br label %bb.l
...
bb.d:                                             ; preds = %bb.d, %.preheader.i
  ...
  store i64 %.pre.i, ptr %gep.i, align 8, !tbaa !93
...
.preheader.i37:                                   ; preds = %bb.f
  ...
  %.pre.i39 = load i64, ptr %i.bh, align 8, !tbaa !93
  br label %bb.g
...
bb.g:                                             ; preds = %bb.g, %.preheader.i37
  ...
  store i64 %.pre.i39, ptr %gep.i41, align 8, !tbaa !93
  %i.bm = add i64 %.011.i40, -1
  %i.bn = and i64 %i.bm, %.011.i40                ; 2 uses
  %.not10.i42 = icmp eq i64 %i.bn, 0
  br i1 %.not10.i42, label %_ZZN8facebook5velox4bits10forEachBitIZNS0_10FlatVectorImE18copyValuesAndNullsEPKNS0_10BaseVectorERKNS0_17SelectivityVectorEPKiEUliE_EEvPKmiibT_ENKUlimE_clEim.exit43, label %bb.g, !llvm.loop !1060
...
iter.check:                                       ; preds = %bb.i
  ...
  %i.cn = load ptr, ptr %i.bz, align 8, !tbaa !448 ; 3 uses
  %.pre.i44 = load i64, ptr %i.by, align 8, !tbaa !93 ; 2 uses
...
vector.body:                                      ; preds = %vector.main.loop.iter.check, %vector.body
  ...
  store <4 x i64> %broadcast.splat81, ptr %i.df, align 8, !tbaa !93
  store <4 x i64> %broadcast.splat81, ptr %i.dg, align 8, !tbaa !93
  store <4 x i64> %broadcast.splat81, ptr %i.dh, align 8, !tbaa !93
  store <4 x i64> %broadcast.splat81, ptr %i.di, align 8, !tbaa !93
  %index.next = add nuw i64 %index, 16            ; 2 uses
  %i.dj = icmp eq i64 %index.next, %n.vec79
  br i1 %i.dj, label %middle.block, label %vector.body, !llvm.loop !1061
...
vec.epilog.vector.body:                           ; preds = %vector.main.loop.iter.check, %vec.epilog.vector.body
  ...
  store <4 x i64> %broadcast.splat81, ptr %i.dn, align 8, !tbaa !93
  %index.next83 = add nuw i64 %index82, 4         ; 2 uses
  %i.do = icmp eq i64 %index.next83, %n.vec79
  br i1 %i.do, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !1062
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph
  ...
  store i64 %.pre.i44, ptr %i.dq, align 8, !tbaa !93
  %i.dr = add nuw i64 %.020.i, 1                  ; 2 uses
  %i.ds = icmp ult i64 %i.dr, %i.cl
  br i1 %i.ds, label %vec.epilog.scalar.ph, label %_ZZN8facebook5velox4bits10forEachBitIZNS0_10FlatVectorImE18copyValuesAndNullsEPKNS0_10BaseVectorERKNS0_17SelectivityVectorEPKiEUliE_EEvPKmiibT_ENKUliE_clEi.exit, !llvm.loop !1063
...
bb.j:                                             ; preds = %bb.j, %.lr.ph.i
  ...
  store i64 %.pre24.i, ptr %gep.i46, align 8, !tbaa !93
  %i.du = add i64 %.01519.i, -1
  %i.dv = and i64 %i.du, %.01519.i                ; 2 uses
  %.not.i47 = icmp eq i64 %i.dv, 0
  br i1 %.not.i47, label %_ZZN8facebook5velox4bits10forEachBitIZNS0_10FlatVectorImE18copyValuesAndNullsEPKNS0_10BaseVectorERKNS0_17SelectivityVectorEPKiEUliE_EEvPKmiibT_ENKUliE_clEi.exit, label %bb.j, !llvm.loop !1064
...
.preheader.i50:                                   ; preds = %bb.k
  ...
  %.pre.i52 = load i64, ptr %i.ep, align 8, !tbaa !93
  br label %bb.l
...
bb.l:                                             ; preds = %bb.l, %.preheader.i50
  ...
  store i64 %.pre.i52, ptr %gep.i54, align 8, !tbaa !93
  %i.eu = add nsw i64 %.011.i53, -1
  %i.ev = and i64 %i.eu, %.011.i53                ; 2 uses
  %.not10.i55 = icmp eq i64 %i.ev, 0
  br i1 %.not10.i55, label %_ZZN8facebook5velox4bits10forEachBitIZNS0_10FlatVectorImE18copyValuesAndNullsEPKNS0_10BaseVectorERKNS0_17SelectivityVectorEPKiEUliE_EEvPKmiibT_ENKUlimE_clEim.exit, label %bb.l, !llvm.loop !1060
...
.preheader.i:                                     ; preds = %bb.c
  ...
  %i.ag = sext i32 %i.d to i64
  %i.ah = load ptr, ptr %i.ab, align 8, !tbaa !1111, !nonnull !126, !align !246
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.av = zext nneg i32 %i.au to i64
  %i.aw = shl i64 %i.at, %i.av
  %i.ax = load i8, ptr %2, align 8, !tbaa !558, !range !125, !noundef !126
  %i.ay = getelementptr inbounds nuw i8, ptr %2, i64 8
...
.preheader.i37:                                   ; preds = %bb.f
  ...
  %i.bl = load ptr, ptr %i.bk, align 8, !tbaa !1110
  %i.bm = getelementptr inbounds nuw i8, ptr %i.bl, i64 144
  %i.bn = load ptr, ptr %i.bm, align 8, !tbaa !448
  %i.bo = sext i32 %i.bj to i64
  %i.bp = load ptr, ptr %i.bi, align 8, !tbaa !1111, !nonnull !126, !align !246
  %i.bq = load ptr, ptr %i.bp, align 8, !tbaa !253
  br label %bb.g
...
.lr.ph:                                           ; preds = %_ZZN8facebook5velox4bits10forEachBitIZNS0_10FlatVectorImE14ensureWritableERKNS0_17SelectivityVectorEEUliE_EEvPKmiibT_ENKUlimE_clEim.exit40
  %i.bz = load i8, ptr %3, align 8, !tbaa !564, !range !125, !noundef !126
  %i.ca = getelementptr inbounds nuw i8, ptr %3, i64 8
  %i.cb = load ptr, ptr %i.ca, align 8, !tbaa !566
  %i.cc = xor i8 %i.bz, 1
  %i.cd = zext nneg i8 %i.cc to i64
  %i.ce = sub nsw i64 0, %i.cd
  %i.cf = getelementptr inbounds nuw i8, ptr %3, i64 16
  ...
  %i.cj = load ptr, ptr %i.cf, align 8, !nonnull !126, !align !246 ; 2 uses
  br label %bb.h
...
.lr.ph.i:                                         ; preds = %bb.h
  %i.cq = shl nsw i32 %i.cl, 6
  %i.cr = load ptr, ptr %i.ci, align 8, !tbaa !448
  %i.cs = sext i32 %i.cq to i64
  %i.ct = load ptr, ptr %i.cj, align 8, !tbaa !253
  br label %bb.j
...
iter.check:                                       ; preds = %bb.i
  ...
  %i.cy = load ptr, ptr %i.ci, align 8, !tbaa !448 ; 4 uses
  %i.cz = load ptr, ptr %i.cj, align 8, !tbaa !253 ; 4 uses
  %i.da = or disjoint i64 %i.cx, 1
...
vector.body:                                      ; preds = %vector.main.loop.iter.check, %vector.body
  ...
  %wide.load = load <4 x i64>, ptr %i.dr, align 8, !tbaa !93
  %wide.load69 = load <4 x i64>, ptr %i.ds, align 8, !tbaa !93
  %wide.load70 = load <4 x i64>, ptr %i.dt, align 8, !tbaa !93
  %wide.load71 = load <4 x i64>, ptr %i.du, align 8, !tbaa !93
  ...
  store <4 x i64> %wide.load, ptr %i.dv, align 8, !tbaa !93
  store <4 x i64> %wide.load69, ptr %i.dw, align 8, !tbaa !93
  store <4 x i64> %wide.load70, ptr %i.dx, align 8, !tbaa !93
  store <4 x i64> %wide.load71, ptr %i.dy, align 8, !tbaa !93
  %index.next = add nuw i64 %index, 16            ; 2 uses
  %i.dz = icmp eq i64 %index.next, %n.vec73
  br i1 %i.dz, label %middle.block, label %vector.body, !llvm.loop !1113
...
vec.epilog.vector.body:                           ; preds = %vector.main.loop.iter.check, %vec.epilog.vector.body
  ...
  %wide.load75 = load <4 x i64>, ptr %i.ed, align 8, !tbaa !93
  %i.ee = getelementptr inbounds [8 x i8], ptr %i.cz, i64 %i.ec
  store <4 x i64> %wide.load75, ptr %i.ee, align 8, !tbaa !93
  %index.next76 = add nuw i64 %index74, 4         ; 2 uses
  %i.ef = icmp eq i64 %index.next76, %n.vec73
  br i1 %i.ef, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !1114
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph
  ...
  store i64 %i.ei, ptr %i.ej, align 8, !tbaa !93
  %i.ek = add nuw i64 %.020.i, 1                  ; 2 uses
  %i.el = icmp ult i64 %i.ek, %i.cw
  br i1 %i.el, label %vec.epilog.scalar.ph, label %_ZZN8facebook5velox4bits10forEachBitIZNS0_10FlatVectorImE14ensureWritableERKNS0_17SelectivityVectorEEUliE_EEvPKmiibT_ENKUliE_clEi.exit, !llvm.loop !1115
...
bb.j:                                             ; preds = %bb.j, %.lr.ph.i
  ...
  %i.ep = load i64, ptr %i.eo, align 8, !tbaa !93
...
bb.k:                                             ; preds = %._crit_edge
  ...
  %i.ey = load i8, ptr %2, align 8, !tbaa !558, !range !125, !noundef !126
  %i.ez = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.fa = load ptr, ptr %i.ez, align 8, !tbaa !562
...
.preheader.i44:                                   ; preds = %bb.k
  ...
  %i.fl = load ptr, ptr %i.fk, align 8, !tbaa !1110
  %i.fm = getelementptr inbounds nuw i8, ptr %i.fl, i64 144
  %i.fn = load ptr, ptr %i.fm, align 8, !tbaa !448
  %i.fo = sext i32 %i.d to i64
  %i.fp = load ptr, ptr %i.fj, align 8, !tbaa !1111, !nonnull !126, !align !246
  %i.fq = load ptr, ptr %i.fp, align 8, !tbaa !253
  br label %bb.l
...
bb.l:                                             ; preds = %bb.l, %.preheader.i44
  ...
  %i.fu = load i64, ptr %i.ft, align 8, !tbaa !93
  %i.fv = getelementptr inbounds [8 x i8], ptr %i.fq, i64 %i.fs
  store i64 %i.fu, ptr %i.fv, align 8, !tbaa !93
