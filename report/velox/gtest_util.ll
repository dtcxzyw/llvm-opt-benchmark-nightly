...
; Function Attrs: mustprogress nofree nounwind memory(readwrite, argmem: read, target_mem: none) uwtable
...
attributes #16 = { mustprogress nofree nounwind memory(readwrite, argmem: read, target_mem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
