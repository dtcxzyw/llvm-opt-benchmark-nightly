...
.preheader:                                       ; preds = %.preheader.loopexit, %tailrecurse
  ...
  %1 = lshr i32 %.0.lcssa, 1
  %2 = lshr i32 %.0.lcssa, 2
  %3 = xor i32 %1, %2
  %4 = lshr i32 %.0.lcssa, 3
  %5 = xor i32 %3, %4
  %6 = lshr i32 %.0.lcssa, 4
  %7 = xor i32 %5, %6
  %8 = lshr i32 %.0.lcssa, 5
  %9 = xor i32 %7, %8
  %10 = lshr i32 %.0.lcssa, 6
  %11 = xor i32 %9, %10
  %12 = xor i32 %11, %.0.lcssa
  %i.f = trunc i32 %12 to i1
