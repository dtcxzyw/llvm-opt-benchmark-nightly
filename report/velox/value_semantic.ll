begin_hunk_0
  ...
  %8 = alloca %"class.std::__cxx11::basic_string.3", align 8 ; 24 uses
...
begin_hunk_1
  ...
  %.sink284.sroa.gep = getelementptr inbounds nuw i8, ptr %9, i64 18
  %.sink284.sroa.gep287 = getelementptr inbounds nuw i8, ptr %9, i64 17
  %.sink284.sroa.gep288 = getelementptr inbounds nuw i8, ptr %9, i64 17
  %.sink284.sroa.gep289 = getelementptr inbounds nuw i8, ptr %9, i64 17
  %.sink281.sroa.gep = getelementptr inbounds nuw i8, ptr %8, i64 18
  %.sink281.sroa.gep290 = getelementptr inbounds nuw i8, ptr %8, i64 17
  %.sink281.sroa.gep291 = getelementptr inbounds nuw i8, ptr %8, i64 17
...
begin_hunk_2
  ...
  switch i32 %i.dm, label %bb.m [
    ...
    i32 8, label %._crit_edge.i.i6.i
    i32 4096, label %._crit_edge.i.i14.i
    i32 1, label %._crit_edge.i.i22.i
  ]

._crit_edge.i.i.i:                                ; preds = %bb.l
  %.ptr272 = getelementptr inbounds nuw i8, ptr %8, i64 16 ; 2 uses
  store ptr %.ptr272, ptr %8, align 8, !tbaa !15, !alias.scope !103
  store i8 45, ptr %.ptr272, align 8, !tbaa !22, !alias.scope !103
  br label %_ZNK5boost15program_options22error_with_option_name27get_canonical_option_prefixB5cxx11Ev.exit

._crit_edge.i.i6.i:                               ; preds = %bb.l
  %.ptr273 = getelementptr inbounds nuw i8, ptr %8, i64 16 ; 2 uses
  store ptr %.ptr273, ptr %8, align 8, !tbaa !15, !alias.scope !103
  store i8 47, ptr %.ptr273, align 8, !tbaa !22, !alias.scope !103
  br label %_ZNK5boost15program_options22error_with_option_name27get_canonical_option_prefixB5cxx11Ev.exit
...
_ZNK5boost15program_options22error_with_option_name27get_canonical_option_prefixB5cxx11Ev.exit: ; preds = %._crit_edge.i.i22.i, %._crit_edge.i.i14.i, %._crit_edge.i.i6.i, %._crit_edge.i.i.i
  %.sink = phi i64 [ 2, %._crit_edge.i.i22.i ], [ 1, %._crit_edge.i.i14.i ], [ 1, %._crit_edge.i.i6.i ], [ 1, %._crit_edge.i.i.i ] ; 5 uses
  %.sink281.sroa.phi = phi ptr [ %.sink281.sroa.gep, %._crit_edge.i.i22.i ], [ %.sink281.sroa.gep290, %._crit_edge.i.i14.i ], [ %.sink281.sroa.gep291, %._crit_edge.i.i6.i ], [ %.sink281.sroa.gep292, %._crit_edge.i.i.i ]
  %i.dp = getelementptr inbounds nuw i8, ptr %8, i64 8
  store i64 %.sink, ptr %i.dp, align 8, !tbaa !21, !alias.scope !103
  store i8 0, ptr %.sink281.sroa.phi, align 1, !tbaa !22, !alias.scope !103
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEmc.exit.i: ; preds = %._crit_edge.i.i22.i187, %._crit_edge.i.i14.i188, %._crit_edge.i.i6.i189, %._crit_edge.i.i.i190
  ...
  %.sink284.sroa.phi = phi ptr [ %.sink284.sroa.gep, %._crit_edge.i.i22.i187 ], [ %.sink284.sroa.gep287, %._crit_edge.i.i14.i188 ], [ %.sink284.sroa.gep288, %._crit_edge.i.i6.i189 ], [ %.sink284.sroa.gep289, %._crit_edge.i.i.i190 ]
