...
begin_hunk_1_@_ZN5folly7futures6detail8waitImplINS_10SemiFutureImEEmEEvRT_:bb.a
  ...
  store ptr %i.c, ptr %7, align 8, !tbaa !189
...
bb.d:                                             ; preds = %bb.c
  %i.l = load ptr, ptr %7, align 8, !tbaa !189    ; 3 uses
...
bb.e:                                             ; preds = %bb.d
  %i.m = load i8, ptr %6, align 8, !tbaa !186, !range !84, !noundef !85
...
bb.f:                                             ; preds = %bb.e
  ...
  %.pre.i.i.i = load ptr, ptr %7, align 8, !tbaa !189
  br label %bb.g
