...
iter.check1460:                                   ; preds = %.noexc55.i
  ...
  %i.lo = sub i64 %i.kx, %i.lj
  %diff.check1440 = icmp ugt i64 %i.lo, -128
...
iter.check1422:                                   ; preds = %.noexc58.i
  ...
  %i.od = sub i64 %i.nm, %i.ny
  %diff.check1402 = icmp ugt i64 %i.od, -128
...
iter.check1300:                                   ; preds = %.noexc55.i260
  ...
  %i.all = sub i64 %i.aku, %i.alg
  %diff.check1280 = icmp ugt i64 %i.all, -128
...
iter.check1262:                                   ; preds = %.noexc58.i215
  ...
  %i.aoa = sub i64 %i.anj, %i.anv
  %diff.check = icmp ugt i64 %i.aoa, -128
