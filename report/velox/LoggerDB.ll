...
begin_hunk_0_@_ZN5folly18initializeLoggerDBERNS_8LoggerDBE:bb.a
  ...
  %17 = alloca %"class.std::unordered_map.90", align 8 ; 9 uses
...
begin_hunk_1_@_ZN5folly18initializeLoggerDBERNS_8LoggerDBE:bb.a
  %i.dk = load ptr, ptr %17, align 8, !tbaa !2913 ; 3 uses
  store ptr %i.dk, ptr %i.dj, align 8, !tbaa !2913
  %i.dl = getelementptr inbounds nuw i8, ptr %11, i64 64 ; 3 uses
  %i.dm = getelementptr inbounds nuw i8, ptr %17, i64 8 ; 2 uses
  %i.dn = load i64, ptr %i.dm, align 8, !tbaa !2915 ; 2 uses
  store i64 %i.dn, ptr %i.dl, align 8, !tbaa !2915
  %i.do = getelementptr inbounds nuw i8, ptr %11, i64 72 ; 4 uses
  %i.dp = getelementptr inbounds nuw i8, ptr %17, i64 16 ; 2 uses
  %i.dq = load ptr, ptr %i.dp, align 8, !tbaa !2916 ; 3 uses
  store ptr %i.dq, ptr %i.do, align 8, !tbaa !2882
  %i.dr = getelementptr inbounds nuw i8, ptr %11, i64 80
end_hunk_1
begin_hunk_2_@_ZN5folly18initializeLoggerDBERNS_8LoggerDBE:bb.a
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.du, ptr noundef nonnull align 8 dereferenceable(16) %i.dv, i64 16, i1 false), !tbaa.struct !2905
  %i.dw = getelementptr inbounds nuw i8, ptr %11, i64 104 ; 5 uses
  store ptr null, ptr %i.dw, align 8, !tbaa !2918
  %i.dx = getelementptr inbounds nuw i8, ptr %17, i64 48 ; 4 uses
...
bb.r:                                             ; preds = %bb.q, %_ZNSt13unordered_mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEN5folly16LogHandlerConfigESt4hashIS5_ESt8equal_toIS5_ESaISt4pairIKS5_S7_EEEC2EOSG_.exit.i
  ...
  br i1 %.not.i.i.i.i1.i, label %_ZNSt13unordered_mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEN5folly17LogCategoryConfigESt4hashIS5_ESt8equal_toIS5_ESaISt4pairIKS5_S7_EEED2Ev.exit, label %bb.s
...
begin_hunk_4_@_ZN5folly18initializeLoggerDBERNS_8LoggerDBE:bb.a
  ...
  store ptr %i.do, ptr %i.ee, align 8, !tbaa !2911
...
_ZNSt13unordered_mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEN5folly17LogCategoryConfigESt4hashIS5_ESt8equal_toIS5_ESaISt4pairIKS5_S7_EEED2Ev.exit: ; preds = %bb.r, %bb.s
  %22 = getelementptr inbounds nuw i8, ptr %17, i64 40
  store i64 0, ptr %22, align 8, !tbaa !2912
  store i64 1, ptr %i.dm, align 8, !tbaa !2915
  store ptr %i.dx, ptr %17, align 8, !tbaa !2913
...
end_hunk_4
begin_hunk_5_@_ZNK5folly8LoggerDB13getConfigImplEb:bb.a
  ...
  %19 = alloca %"class.std::unordered_map.90", align 8 ; 9 uses
...
begin_hunk_6_@_ZNK5folly8LoggerDB13getConfigImplEb:bb.a
  store ptr null, ptr %i.s, align 8, !tbaa !2908
  store ptr %i.s, ptr %6, align 8, !tbaa !2900
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.u, i8 0, i64 16, i1 false)
  %i.ge = load ptr, ptr %10, align 8, !tbaa !2913 ; 3 uses
  store ptr %i.ge, ptr %19, align 8, !tbaa !2913
  %i.gf = getelementptr inbounds nuw i8, ptr %19, i64 8 ; 2 uses
  %i.gg = load i64, ptr %i.ao, align 8, !tbaa !2915 ; 4 uses
  store i64 %i.gg, ptr %i.gf, align 8, !tbaa !2915
  %i.gh = getelementptr inbounds nuw i8, ptr %19, i64 16 ; 4 uses
  %i.gi = load ptr, ptr %i.ap, align 8, !tbaa !2916 ; 3 uses
  store ptr %i.gi, ptr %i.gh, align 8, !tbaa !2882
  %i.gj = getelementptr inbounds nuw i8, ptr %19, i64 24
end_hunk_6
begin_hunk_7_@_ZNK5folly8LoggerDB13getConfigImplEb:bb.a
  store i64 %i.gl, ptr %i.gj, align 8, !tbaa !2917
  %i.gm = getelementptr inbounds nuw i8, ptr %19, i64 32 ; 2 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.gm, ptr noundef nonnull align 8 dereferenceable(16) %i.aq, i64 16, i1 false), !tbaa.struct !2905
  %i.gn = getelementptr inbounds nuw i8, ptr %19, i64 48 ; 8 uses
  store ptr null, ptr %i.gn, align 8, !tbaa !2918
...
begin_hunk_8_@_ZNK5folly8LoggerDB13getConfigImplEb:bb.a
  ...
  store i64 0, ptr %i.hx, align 8, !tbaa !2912
  store i64 1, ptr %i.gf, align 8, !tbaa !2915
  store ptr %i.gn, ptr %19, align 8, !tbaa !2913
  ...
  call void @_ZNSt10_HashtableINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_N5folly16LogHandlerConfigEESaISA_ENSt8__detail10_Select1stESt8equal_toIS5_ESt4hashIS5_ENSC_18_Mod_range_hashingENSC_20_Default_ranged_hashENSC_20_Prime_rehash_policyENSC_17_Hashtable_traitsILb1ELb0ELb1EEEED2Ev(ptr noundef nonnull align 8 dereferenceable(56) %18) #16
  %20 = load ptr, ptr %i.ap, align 8, !tbaa !2916
  invoke void @_ZNSt8__detail16_Hashtable_allocISaINS_10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEN5folly17LogCategoryConfigEELb1EEEEE19_M_deallocate_nodesEPSD_(ptr noundef nonnull align 8 dereferenceable(56) %10, ptr noundef %20)
...
bb.ax:                                            ; preds = %_ZN5folly9LogConfigC2ESt13unordered_mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEENS_16LogHandlerConfigESt4hashIS7_ESt8equal_toIS7_ESaISt4pairIKS7_S8_EEES1_IS7_NS_17LogCategoryConfigESA_SC_SaISD_ISE_SI_EEE.exit
  %i.hy = landingpad { ptr, i32 }
          catch ptr null
  %i.hz = extractvalue { ptr, i32 } %i.hy, 0
  call void @__clang_call_terminate(ptr %i.hz) #31
  unreachable

_ZNSt10_HashtableINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_N5folly17LogCategoryConfigEESaISA_ENSt8__detail10_Select1stESt8equal_toIS5_ESt4hashIS5_ENSC_18_Mod_range_hashingENSC_20_Default_ranged_hashENSC_20_Prime_rehash_policyENSC_17_Hashtable_traitsILb1ELb0ELb1EEEE5clearEv.exit.i.i87: ; preds = %_ZN5folly9LogConfigC2ESt13unordered_mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEENS_16LogHandlerConfigESt4hashIS7_ESt8equal_toIS7_ESaISt4pairIKS7_S8_EEES1_IS7_NS_17LogCategoryConfigESA_SC_SaISD_ISE_SI_EEE.exit
  %i.ia = load ptr, ptr %10, align 8, !tbaa !2913
  %i.ib = load i64, ptr %i.ao, align 8, !tbaa !2915
  %i.ic = shl i64 %i.ib, 3
end_hunk_8
