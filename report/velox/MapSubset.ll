...
_ZN8facebook5velox4exec9MapWriterINS0_9TimestampENS0_7GenericINS0_12TypeVariableILm1EEELb0ELb0EEEE8add_itemEv.exit: ; preds = %_ZN8facebook5velox4exec9MapWriterINS0_9TimestampENS0_7GenericINS0_12TypeVariableILm1EEELb0ELb0EEEE25commitMostRecentChildItemEv.exit.i.i, %bb.ac
  ...
  %.sroa.8.0..sroa.4.8..sroa_idx = getelementptr inbounds nuw i8, ptr %i.gn, i64 24
  ...
  %i.go = load ptr, ptr %i.au, align 8, !tbaa !562, !noalias !10531, !nonnull !57, !align !179
  store ptr %i.go, ptr %4, align 8, !tbaa !509, !alias.scope !10531
  store <2 x ptr> %i.bf, ptr %i.bg, align 8, !tbaa !38, !alias.scope !10531
  store i32 %i.bp, ptr %i.bh, align 8, !tbaa !8188, !alias.scope !10531
  call void @_ZN8facebook5velox4exec13GenericWriter9copy_fromERKNS1_11GenericViewE(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.8.0..sroa.4.8..sroa_idx, ptr noundef nonnull align 8 dereferenceable(28) %4)
...
bb.ad:                                            ; preds = %_ZN8facebook5velox4exec9MapWriterINS0_9TimestampENS0_7GenericINS0_12TypeVariableILm1EEELb0ELb0EEEE8add_itemEv.exit, %bb.aa
  %i.gp = add nsw i64 %.0107, -1                  ; 2 uses
  %i.gq = icmp eq i64 %i.gp, 0
  br i1 %i.gq, label %.loopexit, label %_ZNK5folly3f146detail8F14TableINS1_20ValueContainerPolicyIN8facebook5velox9TimestampEvvvvEEE4findIS6_EENS1_11F14ItemIterIPNS1_8F14ChunkIS6_EEEERKT_.exit.thread
...
_ZNK5folly3f146detail8F14TableINS1_20ValueContainerPolicyIN8facebook5velox9TimestampEvvvvEEE4findIS6_EENS1_11F14ItemIterIPNS1_8F14ChunkIS6_EEEERKT_.exit.thread: ; preds = %bb.t, %bb.u, %bb.p, %_ZNK8facebook5velox4exec18IndexBasedIteratorINS1_7MapViewILb1ENS0_9TimestampENS0_7GenericINS0_12TypeVariableILm1EEELb0ELb0EEEE15ElementAccessorEEdeEv.exit, %bb.ad
  %.1.ph = phi i64 [ %i.gp, %bb.ad ], [ %.0107, %bb.p ], [ %.0107, %_ZNK8facebook5velox4exec18IndexBasedIteratorINS1_7MapViewILb1ENS0_9TimestampENS0_7GenericINS0_12TypeVariableILm1EEELb0ELb0EEEE15ElementAccessorEEdeEv.exit ], [ %.0107, %bb.u ], [ %.0107, %bb.t ]
  %indvars.iv.next = add nsw i64 %indvars.iv, 1   ; 2 uses
  %i.gr = trunc nsw i64 %indvars.iv.next to i32
  %i.gs = icmp eq i32 %i.av, %i.gr
  br i1 %i.gs, label %.loopexit, label %bb.l
