...
begin_hunk_0_@_ZN5folly22ThreadIdWorkerProvider16collectThreadIdsEv:bb.a
  ...
  %i.p = invoke noalias noundef nonnull dereferenceable(24) ptr @_Znwm(i64 noundef 24) #24
          to label %_ZNSt11shared_lockIN5folly15SharedMutexImplILb0EvSt6atomicNS0_24SharedMutexPolicyDefaultEEEED2Ev.exit unwind label %.thread ; 8 uses
...
_ZNSt12_Vector_baseIiSaIiEED2Ev.exit.i:           ; preds = %bb.i, %_ZNSt12_Vector_baseIiSaIiEE11_M_allocateEm.exit.i.i
  %6 = landingpad { ptr, i32 }
          cleanup
  %7 = load ptr, ptr %i.p, align 8, !tbaa !11
  %8 = getelementptr inbounds nuw i8, ptr %7, i64 8
  %9 = load ptr, ptr %8, align 8
  call void %9(ptr noundef nonnull align 8 dead_on_return(8) dereferenceable(8) %i.p) #12, !call_target !53, !inline_history !68
...
.loopexit:                                        ; preds = %.lr.ph.i.i.i.i.i.i.i.i.i.i, %bb.h
  ...
  store ptr %.0.lcssa.i.i.i.i.i.i.i.i.i.i, ptr %i.ay, align 8, !tbaa !69
...
begin_hunk_4_@_ZN5folly22ThreadIdWorkerProvider16collectThreadIdsEv:bb.a
  ...
  br i1 %or.cond.i.i.i27, label %_ZN5folly15SharedMutexImplILb0EvSt6atomicNS_24SharedMutexPolicyDefaultEE18unlockSharedInlineEv.exit.i.i28, label %bb.m, !prof !70
...
begin_hunk_5_@_ZN5folly22ThreadIdWorkerProvider16collectThreadIdsEv:bb.a
  ...
  br i1 %or.cond.i.i24, label %_ZN5folly15SharedMutexImplILb0EvSt6atomicNS_24SharedMutexPolicyDefaultEE18unlockSharedInlineEv.exit.i25, label %bb.p, !prof !70
...
.thread:                                          ; preds = %_ZNSt11shared_lockIN5folly15SharedMutexImplILb0EvSt6atomicNS0_24SharedMutexPolicyDefaultEEEEC2ERS4_.exit
...
_ZNSt10unique_ptrIN12_GLOBAL__N_115WorkerKeepAliveESt14default_deleteIS1_EED2Ev.exit17: ; preds = %_ZNKSt14default_deleteIN12_GLOBAL__N_115WorkerKeepAliveEEclEPS1_.exit.i16, %_ZNSt12_Vector_baseIiSaIiEED2Ev.exit.i, %.thread
  %.pn.pn.pn = phi { ptr, i32 } [ %i.bu, %.thread ], [ %6, %_ZNSt12_Vector_baseIiSaIiEED2Ev.exit.i ], [ %i.bv, %_ZNKSt14default_deleteIN12_GLOBAL__N_115WorkerKeepAliveEEclEPS1_.exit.i16 ]
...
begin_hunk_8_@_ZN5folly15SharedMutexImplILb0EvSt6atomicNS_24SharedMutexPolicyDefaultEE14lockSharedImplINS3_11WaitForeverEEEbRjPNS_16SharedMutexTokenERT_:bb.a
  ...
  br i1 %or.cond.i, label %_ZN5folly15SharedMutexImplILb0EvSt6atomicNS_24SharedMutexPolicyDefaultEE18unlockSharedInlineEv.exit, label %bb.t, !prof !70
...
begin_hunk_9_@_ZN5folly15SharedMutexImplILb0EvSt6atomicNS_24SharedMutexPolicyDefaultEE14lockSharedImplINS3_11WaitForeverEEEbRjPNS_16SharedMutexTokenERT_:bb.a
  ...
  br i1 %or.cond.i61, label %_ZN5folly15SharedMutexImplILb0EvSt6atomicNS_24SharedMutexPolicyDefaultEE18unlockSharedInlineEv.exit63, label %bb.w, !prof !70
...
!51 = !{!49, !50, i64 16}
!52 = distinct !{!52, !26}
!53 = !DISubprogram(name: "~KeepAlive", linkageName: "_ZN5folly14WorkerProvider9KeepAliveD4Ev", scope: !55, file: !54, line: 53, type: !65, scopeLine: 53, containingType: !55, virtualIndex: 0, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagPureVirtual | DISPFlagOptimized)
!54 = !DIFile(filename: "_deps/folly-src/folly/executors/QueueObserver.h", directory: "/opt-bench/work/velox/velox/build", checksumkind: CSK_MD5, checksum: "e16f968dae2b19d7fed8b6d46bb84c7f")
!55 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "KeepAlive", scope: !56, file: !54, line: 51, size: 64, flags: DIFlagPublic | DIFlagTypePassByReference | DIFlagNonTrivial, elements: !58, vtableHolder: !55, identifier: "_ZTSN5folly14WorkerProvider9KeepAliveE")
!56 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "WorkerProvider", scope: !57, file: !54, line: 41, size: 64, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: "_ZTSN5folly14WorkerProviderE")
!57 = !DINamespace(name: "folly", scope: null)
!58 = !{!59, !53}
!59 = !DIDerivedType(tag: DW_TAG_member, name: "_vptr$KeepAlive", scope: !54, file: !54, baseType: !60, size: 64, flags: DIFlagArtificial)
!60 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !61, size: 64)
!61 = !DIDerivedType(tag: DW_TAG_pointer_type, name: "__vtbl_ptr_type", baseType: !62, size: 64)
...
!73 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "WorkerKeepAlive", scope: !74, file: !72, line: 27, size: 192, flags: DIFlagTypePassByReference | DIFlagNonTrivial, elements: !75, vtableHolder: !55)
!74 = !DINamespace(scope: null)
!75 = !{!76, !77, !191, !71}
!76 = !DIDerivedType(tag: DW_TAG_inheritance, scope: !73, baseType: !55, flags: DIFlagPublic, extraData: i32 0)
...
!85 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "SharedMutexImpl<false, void, std::atomic, folly::SharedMutexPolicyDefault>", scope: !57, file: !79, line: 1435, size: 32, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: "_ZTSN5folly15SharedMutexImplILb0EvSt6atomicNS_24SharedMutexPolicyDefaultEEE")
...
!89 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "SharedMutexToken", scope: !57, file: !79, line: 242, size: 32, flags: DIFlagTypePassByValue | DIFlagNonTrivial, elements: !90, identifier: "_ZTSN5folly16SharedMutexTokenE")
!90 = !{!91, !103, !104, !108}
