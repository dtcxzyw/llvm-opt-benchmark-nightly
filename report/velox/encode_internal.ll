...
.lr.ph.split.preheader.i.i:                       ; preds = %.lr.ph.i.i
  ...
  %min.iters.check78 = icmp ult i64 %i.ab, 18
  ...
  %10 = trunc nsw i64 %n.vec81 to i32
...
.lr.ph.split.i.i:                                 ; preds = %_ZZN5arrow7compute13EncoderBinary9DecodeImpILb1EEEvjjjRKNS0_12RowTableImplEPNS0_14KeyColumnArrayEENKUlPhPKhlE_clES8_SA_l.exit.loopexit.i.i, %.lr.ph.split.preheader.i.i
  ...
  %i.ah = trunc i64 %indvars.iv.i.i to i32
  %i.ai = mul i32 %i.r, %i.ah
  %i.aj = zext i32 %i.ai to i64
  %i.ak = trunc i64 %indvars.iv.i.i to i32
  %i.al = add i32 %0, %i.ak
  %i.am = mul i32 %i.t, %i.al
  %i.an = zext i32 %i.am to i64
  %i.ao = load ptr, ptr %i.u, align 8, !tbaa !57  ; 3 uses
...
bb.f:                                             ; preds = %.lr.ph.split.i.i
  ...
  %i.aq = load i8, ptr %i.ap, align 1, !tbaa !67, !range !28, !noundef !29
  %i.ar = trunc nuw i8 %i.aq to i1
  %i.as = getelementptr inbounds nuw i8, ptr %i.ao, i64 16
  %i.at = load ptr, ptr %i.as, align 8
  %i.au = select i1 %i.ar, ptr %i.at, ptr null, !prof !78
...
_ZNK5arrow7compute12RowTableImpl4dataEi.exit.i.i: ; preds = %bb.f, %.lr.ph.split.i.i
  %.0.i.i.i = phi ptr [ %i.au, %bb.f ], [ null, %.lr.ph.split.i.i ] ; 2 uses
  %.0.i.i.i74 = ptrtoaddr ptr %.0.i.i.i to i64
  %i.av = trunc nuw i64 %indvars.iv.i.i to i32    ; 2 uses
  %i.aw = add i32 %0, %i.av
  %i.ax = mul i32 %i.aw, %i.t
  %i.ay = zext i32 %i.ax to i64
  %i.az = getelementptr inbounds nuw i8, ptr %.0.i.i.i, i64 %i.ay
  %i.ba = getelementptr inbounds nuw i8, ptr %i.az, i64 %i.v ; 2 uses
  %i.bb = load ptr, ptr %i.w, align 8, !tbaa !32  ; 2 uses
  %i.bc = ptrtoaddr ptr %i.bb to i64
  %i.bd = mul i32 %i.r, %i.av
...
vector.memcheck73:                                ; preds = %_ZNK5arrow7compute12RowTableImpl4dataEi.exit.i.i
  %i.bg = add i64 %i.bc, %i.aj
  %i.bh = add nuw i64 %i.v, %.0.i.i.i74
  %i.bi = add nuw i64 %i.bh, %i.an
  %i.bj = sub i64 %i.bi, %i.bg
  %diff.check75 = icmp ugt i64 %i.bj, -32
...
vector.body82:                                    ; preds = %vector.memcheck73, %vector.body82
  ...
  %i.bk = getelementptr inbounds nuw [8 x i8], ptr %i.bf, i64 %index83 ; 2 uses
  %i.bl = getelementptr inbounds nuw [8 x i8], ptr %i.ba, i64 %index83 ; 2 uses
  %i.bm = getelementptr inbounds nuw i8, ptr %i.bl, i64 16
  %wide.load84 = load <2 x i64>, ptr %i.bl, align 8, !tbaa !24
  %wide.load85 = load <2 x i64>, ptr %i.bm, align 8, !tbaa !24
  %i.bn = getelementptr inbounds nuw i8, ptr %i.bk, i64 16
  store <2 x i64> %wide.load84, ptr %i.bk, align 1
  store <2 x i64> %wide.load85, ptr %i.bn, align 1
  %index.next86 = add nuw i64 %index83, 4         ; 2 uses
  %i.bo = icmp eq i64 %index.next86, %n.vec81
  br i1 %i.bo, label %middle.block87, label %vector.body82, !llvm.loop !89
...
.lr.ph.split.i.i.i.preheader:                     ; preds = %_ZNK5arrow7compute12RowTableImpl4dataEi.exit.i.i, %vector.memcheck73, %middle.block87
  ...
  %.011.i.i.i.ph = phi i32 [ 0, %vector.memcheck73 ], [ %10, %middle.block87 ], [ 0, %_ZNK5arrow7compute12RowTableImpl4dataEi.exit.i.i ]
  br label %.lr.ph.split.i.i.i

.lr.ph.split.i.i.i:                               ; preds = %.lr.ph.split.i.i.i.preheader, %.lr.ph.split.i.i.i
  %i.bp = phi i64 [ %12, %.lr.ph.split.i.i.i ], [ %.ph, %.lr.ph.split.i.i.i.preheader ] ; 2 uses
  %.011.i.i.i = phi i32 [ %11, %.lr.ph.split.i.i.i ], [ %.011.i.i.i.ph, %.lr.ph.split.i.i.i.preheader ]
  %i.bq = getelementptr inbounds nuw [8 x i8], ptr %i.bf, i64 %i.bp
  %i.br = getelementptr inbounds nuw [8 x i8], ptr %i.ba, i64 %i.bp
...
bb.g:                                             ; preds = %bb.d
  %i.bt = getelementptr inbounds nuw i8, ptr %3, i64 160
...
_ZNK5arrow7compute12RowTableImpl7offsetsEv.exit.i.i: ; preds = %bb.h, %bb.g
  %.0.i.i.i.i = phi ptr [ %i.bw, %bb.h ], [ null, %bb.g ]
...
.lr.ph.i.i28:                                     ; preds = %_ZNK5arrow7compute12RowTableImpl7offsetsEv.exit.i.i
  %i.bx = getelementptr inbounds nuw i8, ptr %3, i64 168
  %i.by = zext i32 %2 to i64                      ; 2 uses
  %i.bz = getelementptr inbounds nuw i8, ptr %4, i64 32
  %i.ca = zext i32 %i.r to i64
  %i.cb = add nsw i64 %i.ca, -1
  %i.cc = sdiv i64 %i.cb, 8                       ; 2 uses
  %i.cd = icmp eq i32 %i.r, 0
  br i1 %i.cd, label %_ZN5arrow7compute13EncoderBinary9DecodeImpILb1EEEvjjjRKNS0_12RowTableImplEPNS0_14KeyColumnArrayE.exit, label %.lr.ph.split.preheader.i.i29

.lr.ph.split.preheader.i.i29:                     ; preds = %.lr.ph.i.i28
  %wide.trip.count.i.i30 = zext i32 %1 to i64
  %i.ce = add nsw i64 %i.cc, 1                    ; 4 uses
  %i.cf = call i64 @llvm.usub.sat.i64(i64 %i.ce, i64 1) ; 2 uses
  %min.iters.check = icmp ult i64 %i.ce, 18
  %i.cg = and i64 %i.cf, 4294967295
  %i.ch = icmp eq i64 %i.cg, 4294967295
  %i.ci = icmp ugt i64 %i.cf, 4294967295
  %i.cj = or i1 %i.ch, %i.ci
  %n.vec = and i64 %i.ce, -4                      ; 4 uses
...
.lr.ph.split.i.i31:                               ; preds = %_ZZN5arrow7compute13EncoderBinary9DecodeImpILb0EEEvjjjRKNS0_12RowTableImplEPNS0_14KeyColumnArrayEENKUlPhPKhlE_clES8_SA_l.exit.loopexit.i.i, %.lr.ph.split.preheader.i.i29
  ...
  %i.ck = trunc i64 %indvars.iv.i.i32 to i32
  %i.cl = mul i32 %i.r, %i.ck
  %i.cm = zext i32 %i.cl to i64
  %i.cn = load ptr, ptr %i.bx, align 8, !tbaa !57 ; 3 uses
  %.not.i.i.i33 = icmp eq ptr %i.cn, null
...
bb.i:                                             ; preds = %.lr.ph.split.i.i31
  ...
  %i.cp = load i8, ptr %i.co, align 1, !tbaa !67, !range !28, !noundef !29
  %i.cq = trunc nuw i8 %i.cp to i1
  %i.cr = getelementptr inbounds nuw i8, ptr %i.cn, i64 16
  %i.cs = load ptr, ptr %i.cr, align 8
  %i.ct = select i1 %i.cq, ptr %i.cs, ptr null, !prof !78
...
_ZNK5arrow7compute12RowTableImpl4dataEi.exit.i.i34: ; preds = %bb.i, %.lr.ph.split.i.i31
  %.0.i.i.i35 = phi ptr [ %i.ct, %bb.i ], [ null, %.lr.ph.split.i.i31 ] ; 2 uses
  %.0.i.i.i3567 = ptrtoaddr ptr %.0.i.i.i35 to i64
  %i.cu = trunc nuw i64 %indvars.iv.i.i32 to i32  ; 2 uses
  %i.cv = add i32 %0, %i.cu
  %i.cw = zext i32 %i.cv to i64
  %i.cx = getelementptr inbounds nuw [8 x i8], ptr %.0.i.i.i.i, i64 %i.cw
  %i.cy = load i64, ptr %i.cx, align 8, !tbaa !24 ; 2 uses
  %i.cz = getelementptr inbounds i8, ptr %.0.i.i.i35, i64 %i.cy
  %i.da = getelementptr inbounds nuw i8, ptr %i.cz, i64 %i.by ; 2 uses
  %i.db = load ptr, ptr %i.bz, align 8, !tbaa !32 ; 2 uses
  %i.dc = ptrtoaddr ptr %i.db to i64
  %i.dd = mul i32 %i.r, %i.cu
  %i.de = zext i32 %i.dd to i64
  %i.df = getelementptr inbounds nuw i8, ptr %i.db, i64 %i.de ; 2 uses
  %brmerge94 = select i1 %min.iters.check, i1 true, i1 %i.cj
...
vector.memcheck:                                  ; preds = %_ZNK5arrow7compute12RowTableImpl4dataEi.exit.i.i34
  %i.dg = add i64 %i.dc, %i.cm
  %i.dh = add i64 %i.cy, %i.by
  %i.di = add i64 %i.dh, %.0.i.i.i3567
...
vector.body:                                      ; preds = %vector.memcheck, %vector.body
  ...
  %i.dk = getelementptr inbounds nuw [8 x i8], ptr %i.df, i64 %index ; 2 uses
  %i.dl = getelementptr inbounds nuw [8 x i8], ptr %i.da, i64 %index ; 2 uses
  %i.dm = getelementptr inbounds nuw i8, ptr %i.dl, i64 16
  %wide.load = load <2 x i64>, ptr %i.dl, align 8, !tbaa !24
  %wide.load69 = load <2 x i64>, ptr %i.dm, align 8, !tbaa !24
  %i.dn = getelementptr inbounds nuw i8, ptr %i.dk, i64 16
  store <2 x i64> %wide.load, ptr %i.dk, align 1
  store <2 x i64> %wide.load69, ptr %i.dn, align 1
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.do = icmp eq i64 %index.next, %n.vec
  br i1 %i.do, label %middle.block, label %vector.body, !llvm.loop !94
...
.lr.ph.split.i.i.i36:                             ; preds = %.lr.ph.split.i.i.i36.preheader, %.lr.ph.split.i.i.i36
  %i.dp = phi i64 [ %15, %.lr.ph.split.i.i.i36 ], [ %.ph91, %.lr.ph.split.i.i.i36.preheader ] ; 2 uses
  %.011.i.i.i37 = phi i32 [ %14, %.lr.ph.split.i.i.i36 ], [ %.011.i.i.i37.ph, %.lr.ph.split.i.i.i36.preheader ]
  %i.dq = getelementptr inbounds nuw [8 x i8], ptr %i.df, i64 %i.dp
  %i.dr = getelementptr inbounds nuw [8 x i8], ptr %i.da, i64 %i.dp
  ...
  %.not.i15.i.i38 = icmp samesign ult i64 %i.cc, %15
...
_ZN5arrow7compute13EncoderBinary9DecodeImpILb1EEEvjjjRKNS0_12RowTableImplEPNS0_14KeyColumnArrayE.exit: ; preds = %_ZZN5arrow7compute13EncoderBinary9DecodeImpILb0EEEvjjjRKNS0_12RowTableImplEPNS0_14KeyColumnArrayEENKUlPhPKhlE_clES8_SA_l.exit.loopexit.i.i, %_ZZN5arrow7compute13EncoderBinary9DecodeImpILb1EEEvjjjRKNS0_12RowTableImplEPNS0_14KeyColumnArrayEENKUlPhPKhlE_clES8_SA_l.exit.loopexit.i.i, %.lr.ph.i.i28, %_ZNK5arrow7compute12RowTableImpl7offsetsEv.exit.i.i, %.lr.ph.i.i, %bb.e
  %i.dt = load i8, ptr %i.a, align 4, !tbaa !26, !range !28, !noundef !29
  %i.du = trunc nuw i8 %i.dt to i1
  %i.dv = load i32, ptr %i.n, align 4
  %i.dw = icmp eq i32 %i.dv, 0
  %or.cond.i.i41 = select i1 %i.du, i1 %i.dw, i1 false
...
_ZN5arrow7compute14EncoderInteger13UsesTransformERKNS0_14KeyColumnArrayE.exit42: ; preds = %_ZN5arrow7compute13EncoderBinary9DecodeImpILb1EEEvjjjRKNS0_12RowTableImplEPNS0_14KeyColumnArrayE.exit
  %i.dx = load i8, ptr %i.b, align 1, !tbaa !41, !range !28, !noundef !29
  %i.dy = trunc nuw i8 %i.dx to i1
  br i1 %i.dy, label %_ZN5arrow7compute14EncoderInteger10PostDecodeERKNS0_14KeyColumnArrayEPS2_PNS0_12LightContextE.exit, label %_ZN5arrow7compute14EncoderInteger9IsBooleanERKNS0_17KeyColumnMetadataE.exit.i
...
_ZN5arrow7compute14EncoderInteger9IsBooleanERKNS0_17KeyColumnMetadataE.exit.i: ; preds = %_ZN5arrow7compute14EncoderInteger13UsesTransformERKNS0_14KeyColumnArrayE.exit42
  ...
  %.val5.i = load ptr, ptr %i.dz, align 8, !tbaa !32
  %i.ea = getelementptr i8, ptr %4, i64 68
  %.val6.i = load i32, ptr %i.ea, align 4, !tbaa !3
  %.val7.i = load i64, ptr %5, align 8, !tbaa !34
  %i.eb = trunc i64 %.sroa.549.0 to i32
  call void @_ZN5arrow4util8bit_util13bytes_to_bitsEliPKhPhi(i64 noundef %.val7.i, i32 noundef %i.eb, ptr noundef %.sroa.4.0, ptr noundef %.val5.i, i32 noundef %.val6.i)
  br label %_ZN5arrow7compute14EncoderInteger10PostDecodeERKNS0_14KeyColumnArrayEPS2_PNS0_12LightContextE.exit
...
_ZNK5arrow7compute12RowTableImpl4dataEi.exit25.i.i: ; preds = %bb.e, %_ZNK5arrow7compute12RowTableImpl4dataEi.exit.thread.i.i
  ...
  %.0.i24.i.i35 = ptrtoaddr ptr %.0.i24.i.i to i64
...
.lr.ph.split.i.i.i.preheader:                     ; preds = %_ZNK5arrow7compute12RowTableImpl4dataEi.exit25.i.i
  ...
  %min.iters.check39 = icmp ult i64 %i.az, 26
  br i1 %min.iters.check39, label %.lr.ph.split.i.i.i.preheader52, label %vector.scevcheck32

vector.scevcheck32:                               ; preds = %.lr.ph.split.i.i.i.preheader
  ...
  br i1 %i.bf, label %.lr.ph.split.i.i.i.preheader52, label %vector.memcheck34

vector.memcheck34:                                ; preds = %vector.scevcheck32
  %i.bg = add i64 %i.as, %i.at
  %i.bh = add i64 %i.r, %.0.i24.i.i35
  %i.bi = add i64 %i.bh, %i.ao
  %i.bj = sub i64 %i.bi, %i.bg
  %diff.check36 = icmp ugt i64 %i.bj, -32
  br i1 %diff.check36, label %.lr.ph.split.i.i.i.preheader52, label %vector.ph40

vector.ph40:                                      ; preds = %vector.memcheck34
  %n.vec42 = and i64 %i.az, -4                    ; 4 uses
  %6 = trunc nsw i64 %n.vec42 to i32
  br label %vector.body43

vector.body43:                                    ; preds = %vector.body43, %vector.ph40
  %index44 = phi i64 [ 0, %vector.ph40 ], [ %index.next47, %vector.body43 ] ; 3 uses
  %i.bk = getelementptr inbounds nuw [8 x i8], ptr %i.au, i64 %index44 ; 2 uses
  %i.bl = getelementptr inbounds nuw [8 x i8], ptr %i.aq, i64 %index44 ; 2 uses
  %i.bm = getelementptr inbounds nuw i8, ptr %i.bl, i64 16
  %wide.load45 = load <2 x i64>, ptr %i.bl, align 8, !tbaa !24
  %wide.load46 = load <2 x i64>, ptr %i.bm, align 8, !tbaa !24
  %i.bn = getelementptr inbounds nuw i8, ptr %i.bk, i64 16
  store <2 x i64> %wide.load45, ptr %i.bk, align 1
  store <2 x i64> %wide.load46, ptr %i.bn, align 1
  %index.next47 = add nuw i64 %index44, 4         ; 2 uses
  %i.bo = icmp eq i64 %index.next47, %n.vec42
  br i1 %i.bo, label %middle.block48, label %vector.body43, !llvm.loop !114

middle.block48:                                   ; preds = %vector.body43
  %cmp.n49 = icmp eq i64 %i.az, %n.vec42
  br i1 %cmp.n49, label %_ZZN5arrow7compute16EncoderVarBinary9DecodeImpILb1EEEvjjjRKNS0_12RowTableImplEPNS0_14KeyColumnArrayEENKUlPhPKhlE_clES8_SA_l.exit.i.i, label %.lr.ph.split.i.i.i.preheader52

.lr.ph.split.i.i.i.preheader52:                   ; preds = %vector.memcheck34, %vector.scevcheck32, %.lr.ph.split.i.i.i.preheader, %middle.block48
  %.ph = phi i64 [ 0, %vector.memcheck34 ], [ 0, %vector.scevcheck32 ], [ 0, %.lr.ph.split.i.i.i.preheader ], [ %n.vec42, %middle.block48 ]
  %.011.i.i.i.ph = phi i32 [ 0, %vector.memcheck34 ], [ 0, %vector.scevcheck32 ], [ 0, %.lr.ph.split.i.i.i.preheader ], [ %6, %middle.block48 ]
  br label %.lr.ph.split.i.i.i

.lr.ph.split.i.i.i:                               ; preds = %.lr.ph.split.i.i.i.preheader52, %.lr.ph.split.i.i.i
  %i.bp = phi i64 [ %8, %.lr.ph.split.i.i.i ], [ %.ph, %.lr.ph.split.i.i.i.preheader52 ] ; 2 uses
  %.011.i.i.i = phi i32 [ %7, %.lr.ph.split.i.i.i ], [ %.011.i.i.i.ph, %.lr.ph.split.i.i.i.preheader52 ]
...
_ZZN5arrow7compute16EncoderVarBinary9DecodeImpILb1EEEvjjjRKNS0_12RowTableImplEPNS0_14KeyColumnArrayEENKUlPhPKhlE_clES8_SA_l.exit.i.i: ; preds = %.lr.ph.split.i.i.i, %middle.block48, %_ZNK5arrow7compute12RowTableImpl4dataEi.exit25.i.i
  %exitcond.not.i.i = icmp eq i64 %indvars.iv.next.i.i, %wide.trip.count.i.i
...
.lr.ph.split.i.i.i18.preheader:                   ; preds = %_ZNK5arrow7compute12RowTableImpl4dataEi.exit.i.i
  ...
  br i1 %min.iters.check, label %.lr.ph.split.i.i.i18.preheader53, label %vector.scevcheck
...
vector.scevcheck:                                 ; preds = %.lr.ph.split.i.i.i18.preheader
  ...
  br i1 %i.dw, label %.lr.ph.split.i.i.i18.preheader53, label %vector.memcheck
...
vector.memcheck:                                  ; preds = %vector.scevcheck
  ...
  br i1 %diff.check, label %.lr.ph.split.i.i.i18.preheader53, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load30 = load <2 x i64>, ptr %i.ed, align 8, !tbaa !24
  %i.ee = getelementptr inbounds nuw i8, ptr %i.eb, i64 16
  store <2 x i64> %wide.load, ptr %i.eb, align 1
  store <2 x i64> %wide.load30, ptr %i.ee, align 1
  %index.next = add nuw i64 %index, 4             ; 2 uses
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %_ZZN5arrow7compute16EncoderVarBinary9DecodeImpILb0EEEvjjjRKNS0_12RowTableImplEPNS0_14KeyColumnArrayEENKUlPhPKhlE_clES8_SA_l.exit.i.i, label %.lr.ph.split.i.i.i18.preheader53

.lr.ph.split.i.i.i18.preheader53:                 ; preds = %vector.memcheck, %vector.scevcheck, %.lr.ph.split.i.i.i18.preheader, %middle.block
  %.ph54 = phi i64 [ 0, %vector.memcheck ], [ 0, %vector.scevcheck ], [ 0, %.lr.ph.split.i.i.i18.preheader ], [ %n.vec, %middle.block ]
...
.lr.ph.split.i.i.i18:                             ; preds = %.lr.ph.split.i.i.i18.preheader53, %.lr.ph.split.i.i.i18
  %i.eg = phi i64 [ %11, %.lr.ph.split.i.i.i18 ], [ %.ph54, %.lr.ph.split.i.i.i18.preheader53 ] ; 2 uses
  %.011.i.i.i19 = phi i32 [ %10, %.lr.ph.split.i.i.i18 ], [ %.011.i.i.i19.ph, %.lr.ph.split.i.i.i18.preheader53 ]
