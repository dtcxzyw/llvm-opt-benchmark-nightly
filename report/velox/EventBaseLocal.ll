...
_ZN5folly3f146detail11F14ItemIterIPNS1_8F14ChunkIPNS_9EventBaseEEEE17precheckedAdvanceEv.exit.i: ; preds = %thread-pre-split.i.i, %bb.e
...
_ZN5folly3f146detail8F14TableINS1_20ValueContainerPolicyIPNS_9EventBaseEvvvvEEE29adjustSizeAndBeginBeforeEraseENS1_11F14ItemIterIPNS1_8F14ChunkIS5_EEEE.exit: ; preds = %bb.b, %_ZN5folly3f146detail11F14ItemIterIPNS1_8F14ChunkIPNS_9EventBaseEEEE17precheckedAdvanceEv.exit.i
  %.neg.i.i.i.pre-phi = phi i64 [ %.pre, %bb.b ], [ %.neg.i.i.i.i, %_ZN5folly3f146detail11F14ItemIterIPNS1_8F14ChunkIPNS_9EventBaseEEEE17precheckedAdvanceEv.exit.i ]
...
_ZN5folly3f146detail11F14ItemIterIPNS1_8F14ChunkIPNS_6detail18EventBaseLocalBaseEEEE17precheckedAdvanceEv.exit.i: ; preds = %thread-pre-split.i.i, %bb.e
  %.sroa.01.1.i = phi ptr [ %i.ae, %bb.e ], [ %i.q, %thread-pre-split.i.i ]
  %.sroa.7.1.i = phi i64 [ %i.ab, %bb.e ], [ %i.p, %thread-pre-split.i.i ]
  %i.af = and i64 %.sroa.7.1.i, 255               ; 2 uses
  %i.ag = icmp samesign ult i64 %i.af, 16
...
_ZN5folly3f146detail8F14TableINS1_20ValueContainerPolicyIPNS_6detail18EventBaseLocalBaseEvvvvEEE29adjustSizeAndBeginBeforeEraseENS1_11F14ItemIterIPNS1_8F14ChunkIS6_EEEE.exit: ; preds = %bb.b, %_ZN5folly3f146detail11F14ItemIterIPNS1_8F14ChunkIPNS_6detail18EventBaseLocalBaseEEEE17precheckedAdvanceEv.exit.i
  %.neg.i.i.i.pre-phi = phi i64 [ %.pre, %bb.b ], [ %.neg.i.i.i.i, %_ZN5folly3f146detail11F14ItemIterIPNS1_8F14ChunkIPNS_6detail18EventBaseLocalBaseEEEE17precheckedAdvanceEv.exit.i ]
  %5 = getelementptr inbounds i8, ptr %1, i64 -16
  %i.ak = getelementptr inbounds i8, ptr %5, i64 %.neg.i.i.i.pre-phi ; 4 uses
  %i.al = getelementptr inbounds nuw i8, ptr %i.ak, i64 %2 ; 2 uses
  %i.am = load i8, ptr %i.al, align 1, !tbaa !36
