...
bb.q:                                             ; preds = %bb.o
  ...
  %13 = fmul double %0, %0                        ; 6 uses
  %14 = fmul double %0, %13                       ; 2 uses
  %i.cc = fadd nnan double %0, -2.000000e+00
  %i.cd = fmul nnan double %0, 6.000000e+00
  %15 = fsub double %13, %i.cd
  %i.ce = fadd double %15, 7.000000e+00
  %i.cf = fmul nnan double %13, 1.100000e+01
  %i.cg = fmul nnan double %0, 1.100000e+01
  %16 = fadd nnan double %i.cg, -1.700000e+01
  %i.ch = fmul nnan double %13, 3.000000e+00
  %i.ci = fmul nnan double %0, 1.300000e+01
  %17 = fsub double %i.ci, %i.ch
  %18 = fadd double %17, -1.300000e+01
  %i.cj = fmul double %14, 2.000000e+00
  %i.ck = fmul nnan double %13, 2.500000e+01
  %i.cl = fsub double %i.cj, %i.ck
  %i.cm = fmul nnan double %0, 7.200000e+01
  %i.cn = fadd double %i.cm, %i.cl
  %i.co = fadd double %i.cn, -6.100000e+01
  %i.cp = fmul double %14, 2.500000e+01
  %i.cq = fmul nnan double %13, 1.950000e+02
  %19 = fsub double %i.cp, %i.cq
  %i.cr = fmul nnan double %0, 4.770000e+02
  %i.cs = fadd double %i.cr, %19
  %i.ct = fmul double %i.bz, %i.bz                ; 4 uses
  %i.cu = fmul double %i.ct, %i.ca
  %20 = fmul double %i.ct, %i.ct
  %i.cv = fadd double %0, -1.000000e+00           ; 3 uses
  %i.cw = fmul double %i.cv, %i.cb                ; 8 uses
  %i.cx = fmul double %i.cw, %i.cw                ; 6 uses
  %i.cy = fmul double %i.cw, %i.cx                ; 2 uses
  %21 = fmul double %i.cx, %i.cx
  %22 = fadd double %i.cw, 1.000000e+00
  %23 = fmul double %i.cx, 5.000000e-01
  %24 = fmul double %i.cc, %i.cw
  %i.cz = fsub double %24, %23
  %i.da = fmul double %i.ce, %i.cw
  %25 = fmul double %21, 2.500000e-01
  %26 = fmul double %16, %i.cy
  %27 = insertelement <2 x double> poison, double %i.cy, i64 0
  %28 = insertelement <2 x double> %27, double %26, i64 1
  %29 = fdiv <2 x double> %28, <double 3.000000e+00, double 6.000000e+00> ; 2 uses
  %30 = extractelement <2 x double> %29, i64 1
  %i.db = fsub double %30, %25
  %31 = fmul double %18, %i.cx
  %i.dc = fadd double %31, %i.db
  %i.dd = fmul double %i.co, %i.cw
  %i.de = fmul double %i.dd, 5.000000e-01
  %32 = fadd double %i.de, %i.dc
  %i.df = fadd double %i.cs, -3.790000e+02
  %i.dg = fmul double %i.cv, %22
  %i.dh = fmul nnan double %0, 4.600000e+01
  %i.di = fsub double %i.cf, %i.dh
  ...
  %i.ea = insertelement <4 x double> <double poison, double poison, double poison, double -0.000000e+00>, double %i.cz, i64 0
  %i.eb = insertelement <4 x double> %i.ea, double %i.ds, i64 1
  %i.ec = insertelement <4 x double> %i.eb, double %32, i64 2
  %i.ed = fadd <4 x double> %i.dz, %i.ec          ; 2 uses
  %i.ee = insertelement <4 x double> poison, double %i.cv, i64 0
  ...
  %i.ek = insertelement <4 x double> <double poison, double poison, double poison, double 1.000000e+00>, double %i.ct, i64 0
  %i.el = insertelement <4 x double> %i.ek, double %i.cu, i64 1
  %i.em = insertelement <4 x double> %i.el, double %20, i64 2
