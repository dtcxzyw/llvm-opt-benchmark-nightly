...
bb.q:                                             ; preds = %bb.o
  %13 = call double @log(double noundef %i.l) #41, !tbaa !3 ; 5 uses
  %14 = fneg double %13                           ; 2 uses
  %15 = call double @log(double noundef %14) #41, !tbaa !3
  %16 = fmul double %0, %0                        ; 6 uses
  %i.bz = fmul double %0, %16                     ; 2 uses
  %17 = fadd nnan double %0, -2.000000e+00
  %i.ca = fmul nnan double %0, 6.000000e+00
  %18 = fsub double %16, %i.ca
  %19 = fadd double %18, 7.000000e+00
  %20 = fmul nnan double %16, 1.100000e+01
  %i.cb = fmul nnan double %0, 1.100000e+01
  %21 = fadd nnan double %i.cb, -1.700000e+01
  %i.cc = fmul nnan double %16, 3.000000e+00
  %i.cd = fmul nnan double %0, 1.300000e+01
  %22 = fsub double %i.cd, %i.cc
  %i.ce = fadd double %22, -1.300000e+01
  %23 = fmul double %i.bz, 2.000000e+00
  %24 = fmul nnan double %16, 2.500000e+01
  %25 = fsub double %23, %24
  %i.cf = fmul nnan double %0, 7.200000e+01
  %26 = fadd double %i.cf, %25
  %27 = fadd double %26, -6.100000e+01
  %28 = fmul double %i.bz, 2.500000e+01
  %i.cg = fmul nnan double %16, 1.950000e+02
  %29 = fsub double %28, %i.cg
  %i.ch = fmul nnan double %0, 4.770000e+02
  %i.ci = fadd double %i.ch, %29
  %i.cj = fmul double %13, %13                    ; 4 uses
  %i.ck = fmul double %i.cj, %14
  %i.cl = fmul double %i.cj, %i.cj
  %30 = fadd double %0, -1.000000e+00             ; 3 uses
  %i.cm = fmul double %30, %15                    ; 8 uses
  %31 = fmul double %i.cm, %i.cm                  ; 6 uses
  %32 = fmul double %31, %31
  %33 = fadd double %i.cm, 1.000000e+00
  %i.cn = fmul double %31, 5.000000e-01
  %34 = fmul double %17, %i.cm
  %35 = fsub double %34, %i.cn
  %36 = fmul double %19, %i.cm
  %37 = fmul double %32, 2.500000e-01
  %38 = fmul double %i.cm, %31                    ; 2 uses
  %39 = fmul double %21, %38
  %40 = insertelement <2 x double> poison, double %38, i64 0
  %41 = insertelement <2 x double> %40, double %39, i64 1
  %i.co = fdiv <2 x double> %41, <double 3.000000e+00, double 6.000000e+00> ; 2 uses
  %42 = extractelement <2 x double> %i.co, i64 1
  %43 = fsub double %42, %37
  %44 = fmul double %i.ce, %31
  %45 = fadd double %44, %43
  %46 = fmul double %27, %i.cm
  %47 = fmul double %46, 5.000000e-01
  %48 = fadd double %47, %45
  %49 = fadd double %i.ci, -3.790000e+02
  %i.cp = fmul double %30, %33
  %i.cq = fmul nnan double %0, 4.600000e+01
  %i.cr = fsub double %20, %i.cq
  %i.cs = fmul nnan double %0, 3.000000e+00
  %i.ct = insertelement <2 x double> poison, double %i.cs, i64 0
  %i.cu = insertelement <2 x double> %i.ct, double %i.cr, i64 1
  %50 = fadd <2 x double> %i.cu, <double -5.000000e+00, double 4.700000e+01> ; 2 uses
  %51 = extractelement <2 x double> %50, i64 0
  %i.cv = fmul double %51, %31
  %i.cw = fmul double %i.cv, 5.000000e-01
  %52 = extractelement <2 x double> %i.co, i64 0
  %53 = fsub double %52, %i.cw
  %54 = fadd double %36, %53
  %55 = fmul <2 x double> %50, <double 5.000000e-01, double 1.000000e+00>
  %56 = fsub double %i.cm, %13
  %57 = shufflevector <2 x double> %55, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %58 = insertelement <4 x double> %57, double %49, i64 2
  %59 = insertelement <4 x double> %58, double %i.cp, i64 3
  %60 = insertelement <4 x double> <double 1.000000e+00, double 6.000000e+00, double 1.200000e+01, double poison>, double %13, i64 3
  %61 = fdiv <4 x double> %59, %60
  %62 = insertelement <4 x double> <double poison, double poison, double poison, double -0.000000e+00>, double %35, i64 0
  %63 = insertelement <4 x double> %62, double %54, i64 1
  %64 = insertelement <4 x double> %63, double %48, i64 2
  %65 = fadd <4 x double> %61, %64                ; 2 uses
  %66 = insertelement <4 x double> poison, double %30, i64 0
  %i.cx = insertelement <4 x double> %66, double %56, i64 1
  %67 = shufflevector <4 x double> %i.cx, <4 x double> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1> ; 2 uses
  %68 = fmul <4 x double> %67, %65
  %69 = fsub <4 x double> %67, %65                ; 2 uses
  %70 = shufflevector <4 x double> %68, <4 x double> %69, <4 x i32> <i32 0, i32 1, i32 2, i32 7>
  %i.cy = insertelement <4 x double> <double poison, double poison, double poison, double 1.000000e+00>, double %i.cj, i64 0
  %i.cz = insertelement <4 x double> %i.cy, double %i.ck, i64 1
  %i.da = insertelement <4 x double> %i.cz, double %i.cl, i64 2
  %i.db = fdiv <4 x double> %70, %i.da            ; 3 uses
  %shift = shufflevector <4 x double> %69, <4 x double> poison, <4 x i32> <i32 3, i32 poison, i32 poison, i32 poison>
  %foldExtExtBinop = fadd <4 x double> %shift, %i.db
  %shift343 = shufflevector <4 x double> %i.db, <4 x double> poison, <4 x i32> <i32 1, i32 poison, i32 poison, i32 poison>
  %foldExtExtBinop344 = fadd <4 x double> %foldExtExtBinop, %shift343
  %shift346 = shufflevector <4 x double> %i.db, <4 x double> poison, <4 x i32> <i32 2, i32 poison, i32 poison, i32 poison>
  %foldExtExtBinop347 = fadd <4 x double> %foldExtExtBinop344, %shift346
  %71 = extractelement <4 x double> %foldExtExtBinop347, i64 0 ; 2 uses
...
bb.s:                                             ; preds = %bb.c
  ...
  %i.ep = shufflevector <2 x double> %i.em, <2 x double> %i.eo, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.eq = insertelement <4 x double> <double 1.000000e+00, double poison, double 1.600000e+01, double poison>, double %i.ec, i64 1
  %i.er = insertelement <4 x double> %i.eq, double %i.ed, i64 3
  ...
  %i.ey = fdiv <4 x double> %i.es, %i.ex          ; 4 uses
