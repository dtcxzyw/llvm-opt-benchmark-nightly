...
bb.a:
  ...
  %i.o = load double, ptr %4, align 8, !tbaa !183 ; 6 uses
  %8 = fmul double %i.d, %i.j
  %9 = fdiv double %8, %i.m
  %10 = fsub double %9, %i.h
  %i.p = fmul double %i.k, %10
  %i.q = fsub double %i.f, %i.k
  %i.r = fdiv double %i.p, %i.q
  %11 = load double, ptr %0, align 8, !tbaa !183  ; 4 uses
  %12 = fsub double %11, %i.i                     ; 2 uses
  %13 = fsub double %i.k, %i.o                    ; 2 uses
  %i.s = fmul double %i.k, %12
  %i.t = fdiv double %i.s, %13
  %14 = fsub double %i.t, %i.n                    ; 2 uses
  %15 = fsub double %i.d, %i.o                    ; 2 uses
  %i.u = fmul double %i.d, %14
  %i.v = fdiv double %i.u, %15
  %i.w = fsub double %i.v, %i.r
  %16 = fmul double %i.o, %i.w
  %17 = fmul double %i.o, %14
  %i.x = fmul double %12, %i.o
  %i.y = fsub double %i.f, %i.o
  %18 = insertelement <4 x double> poison, double %i.x, i64 0
  %19 = insertelement <4 x double> %18, double %17, i64 1
  %20 = insertelement <4 x double> %19, double %16, i64 2
  %21 = insertelement <4 x double> %20, double %11, i64 3
  %22 = insertelement <4 x double> <double poison, double poison, double poison, double 1.000000e+00>, double %13, i64 0
  %23 = insertelement <4 x double> %22, double %15, i64 1
  %24 = insertelement <4 x double> %23, double %i.y, i64 2
  %25 = fdiv <4 x double> %21, %24                ; 3 uses
  %shift = shufflevector <4 x double> %25, <4 x double> poison, <4 x i32> <i32 1, i32 poison, i32 poison, i32 poison>
  %foldExtExtBinop = fadd <4 x double> %25, %shift
  %shift63 = shufflevector <4 x double> %25, <4 x double> poison, <4 x i32> <i32 2, i32 poison, i32 poison, i32 poison>
  %foldExtExtBinop64 = fadd <4 x double> %foldExtExtBinop, %shift63
  %26 = extractelement <4 x double> %foldExtExtBinop64, i64 0
  %i.z = fadd double %11, %26                     ; 3 uses
  %i.aa = fcmp ugt double %i.z, %11
