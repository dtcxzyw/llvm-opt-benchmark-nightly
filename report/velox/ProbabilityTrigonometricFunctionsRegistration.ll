...
thread-pre-split417:                              ; preds = %thread-pre-split.thread, %bb.n, %thread-pre-split, %.thread613
  %.sroa.0297.sroa.0.1 = phi x86_fp80 [ %1, %thread-pre-split ], [ %1, %bb.n ], [ 5.000000e-01, %thread-pre-split.thread ], [ 5.000000e-01, %.thread613 ] ; 21 uses
  %.sroa.0333.sroa.0.1 = phi x86_fp80 [ %0, %thread-pre-split ], [ %0, %bb.n ], [ 1.000000e+00, %thread-pre-split.thread ], [ %1, %.thread613 ] ; 23 uses
  %.1387 = phi x86_fp80 [ %3, %thread-pre-split ], [ %3, %bb.n ], [ %3, %thread-pre-split.thread ], [ %2, %.thread613 ] ; 10 uses
  %.1379 = phi x86_fp80 [ %2, %thread-pre-split ], [ %2, %bb.n ], [ %2, %thread-pre-split.thread ], [ %3, %.thread613 ] ; 16 uses
...
.thread635:                                       ; preds = %thread-pre-split.thread, %bb.p
  %.sroa.0333.sroa.0.1631644 = phi x86_fp80 [ %.sroa.0333.sroa.0.1, %bb.p ], [ %1, %thread-pre-split.thread ] ; 5 uses
  %.1387632643 = phi x86_fp80 [ %.1387, %bb.p ], [ %2, %thread-pre-split.thread ] ; 2 uses
  %.1379633642 = phi x86_fp80 [ %.1379, %bb.p ], [ %3, %thread-pre-split.thread ] ; 3 uses
  %.1166634641 = phi i8 [ %.1166, %bb.p ], [ 1, %thread-pre-split.thread ]
  %i.ad = fcmp olt x86_fp80 %.1379633642, %.1387632643
  br i1 %i.ad, label %bb.q, label %bb.t

bb.q:                                             ; preds = %.thread635
  %i.ae = fcmp ogt x86_fp80 %.sroa.0333.sroa.0.1631644, 1.000000e+00
  %i.af = fdiv x86_fp80 1.000000e+00, %.sroa.0333.sroa.0.1631644
  %i.ag = tail call noundef x86_fp80 @powl(x86_fp80 noundef %.1379633642, x86_fp80 noundef %i.af) #41 ; 3 uses
  br i1 %i.ae, label %bb.r, label %bb.s

bb.r:                                             ; preds = %bb.q
  %i.ah = tail call noundef x86_fp80 @logl(x86_fp80 noundef %.1379633642) #41
  %i.ai = fdiv x86_fp80 %i.ah, %.sroa.0333.sroa.0.1631644
...
bb.t:                                             ; preds = %.thread635
  %i.am = fneg x86_fp80 %.1387632643              ; 2 uses
  ...
  %i.ao = fdiv x86_fp80 %i.an, %.sroa.0333.sroa.0.1631644
  ...
  %i.ar = fdiv x86_fp80 %i.aq, %.sroa.0333.sroa.0.1631644
...
thread-pre-split426:                              ; preds = %bb.ap, %bb.aq
  %.sroa.0297.sroa.0.4 = phi x86_fp80 [ %.sroa.0333.sroa.0.1, %bb.aq ], [ %.sroa.0297.sroa.0.1, %bb.ap ] ; 5 uses
  %.sroa.0333.sroa.0.4 = phi x86_fp80 [ %.sroa.0297.sroa.0.1, %bb.aq ], [ %.sroa.0333.sroa.0.1, %bb.ap ] ; 8 uses
  %.4390 = phi x86_fp80 [ %.1379, %bb.aq ], [ %.1387, %bb.ap ] ; 2 uses
  %.4 = phi x86_fp80 [ %.1387, %bb.aq ], [ %.1379, %bb.ap ] ; 4 uses
...
bb.bf:                                            ; preds = %bb.be, %bb.bd
  %.sroa.0297.sroa.0.5 = phi x86_fp80 [ %.sroa.0333.sroa.0.1, %bb.be ], [ %.sroa.0297.sroa.0.1, %bb.bd ] ; 13 uses
  %.sroa.0333.sroa.0.5 = phi x86_fp80 [ %.sroa.0297.sroa.0.1, %bb.be ], [ %.sroa.0333.sroa.0.1, %bb.bd ] ; 18 uses
  %.0415 = phi x86_fp80 [ %i.ez, %bb.be ], [ %i.ev, %bb.bd ] ; 4 uses
  %.6392 = phi x86_fp80 [ %.1379, %bb.be ], [ %.1387, %bb.bd ] ; 2 uses
  %.6382 = phi x86_fp80 [ %.1387, %bb.be ], [ %.1379, %bb.bd ] ; 3 uses
...
thread-pre-split437:                              ; preds = %bb.bl, %bb.bm
  %.sroa.0297.sroa.0.6 = phi x86_fp80 [ %.sroa.0333.sroa.0.1, %bb.bm ], [ %.sroa.0297.sroa.0.1, %bb.bl ] ; 9 uses
  %.sroa.0333.sroa.0.6 = phi x86_fp80 [ %.sroa.0297.sroa.0.1, %bb.bm ], [ %.sroa.0333.sroa.0.1, %bb.bl ] ; 10 uses
  %.7393 = phi x86_fp80 [ %.1379, %bb.bm ], [ %.1387, %bb.bl ] ; 5 uses
  %.7383 = phi x86_fp80 [ %.1387, %bb.bm ], [ %.1379, %bb.bl ] ; 9 uses
...
.thread428:                                       ; preds = %bb.ba, %bb.bb, %bb.bj, %bb.bk, %bb.aa, %bb.al, %.thread423, %bb.af, %.thread442, %.thread439, %bb.o
  %.sroa.0297.sroa.0.7 = phi x86_fp80 [ %.sroa.0297.sroa.0.1, %bb.o ], [ %.sroa.0297.sroa.0.2, %bb.aa ], [ %.sroa.0297.sroa.0.2, %bb.af ], [ %.sroa.0297.sroa.0.3, %.thread423 ], [ %.sroa.0297.sroa.0.3, %bb.al ], [ %.sroa.0297.sroa.0.4, %bb.bb ], [ %.sroa.0297.sroa.0.4, %bb.ba ], [ %.sroa.0297.sroa.0.5, %bb.bk ], [ %.sroa.0297.sroa.0.5, %bb.bj ], [ %.sroa.0297.sroa.0.6, %.thread439 ], [ %.sroa.0297.sroa.0.6, %.thread442 ] ; 2 uses
  %.sroa.0333.sroa.0.7 = phi x86_fp80 [ %.sroa.0333.sroa.0.1, %bb.o ], [ %.sroa.0333.sroa.0.2, %bb.aa ], [ %.sroa.0333.sroa.0.2, %bb.af ], [ %.sroa.0333.sroa.0.3, %.thread423 ], [ %.sroa.0333.sroa.0.3, %bb.al ], [ %.sroa.0333.sroa.0.4, %bb.bb ], [ %.sroa.0333.sroa.0.4, %bb.ba ], [ %.sroa.0333.sroa.0.5, %bb.bk ], [ %.sroa.0333.sroa.0.5, %bb.bj ], [ %.sroa.0333.sroa.0.6, %.thread439 ], [ %.sroa.0333.sroa.0.6, %.thread442 ] ; 2 uses
  %.6414 = phi x86_fp80 [ %i.aa, %bb.o ], [ %i.bi, %bb.aa ], [ %i.bz, %bb.af ], [ %i.cr, %.thread423 ], [ %i.cn, %bb.al ], [ %i.ep, %bb.bb ], [ %i.ep, %bb.ba ], [ %i.fl, %bb.bk ], [ %i.fl, %bb.bj ], [ %i.it, %.thread439 ], [ %.5413, %.thread442 ]
  %.8404 = phi x86_fp80 [ %i.ab, %bb.o ], [ %i.bh, %bb.aa ], [ %storemerge, %bb.af ], [ %i.cq, %.thread423 ], [ %i.co, %bb.al ], [ %.0178, %bb.bb ], [ %i.eo, %bb.ba ], [ %.0415, %bb.bk ], [ %.4400, %bb.bj ], [ %.7403, %.thread439 ], [ %i.jk, %.thread442 ] ; 2 uses
  %.8394 = phi x86_fp80 [ %.1387, %bb.o ], [ %.2388, %bb.aa ], [ %.2388, %bb.af ], [ %.3389, %.thread423 ], [ %.3389, %bb.al ], [ %.4390, %bb.bb ], [ %.4390, %bb.ba ], [ %.6392, %bb.bk ], [ %.6392, %bb.bj ], [ %.7393, %.thread439 ], [ %.7393, %.thread442 ] ; 2 uses
  %.8384 = phi x86_fp80 [ %.1379, %bb.o ], [ %.2380, %bb.aa ], [ %.2380, %bb.af ], [ %.3381, %.thread423 ], [ %.3381, %bb.al ], [ %.4, %bb.bb ], [ %.4, %bb.ba ], [ %.6382, %bb.bk ], [ %.6382, %bb.bj ], [ %.7383, %.thread439 ], [ %.7383, %.thread442 ] ; 2 uses
  %.1173 = phi x86_fp80 [ 1.000000e+00, %bb.o ], [ 1.000000e+00, %bb.aa ], [ 1.000000e+00, %bb.af ], [ 1.000000e+00, %.thread423 ], [ 1.000000e+00, %bb.al ], [ %.0178, %bb.bb ], [ %.0178, %bb.ba ], [ %.0415, %bb.bk ], [ %.0415, %bb.bj ], [ 1.000000e+00, %.thread439 ], [ 1.000000e+00, %.thread442 ] ; 2 uses
  %.10 = phi i8 [ %.1166, %bb.o ], [ %.2167, %bb.aa ], [ %.2167, %bb.af ], [ %.3, %.thread423 ], [ %.3, %bb.al ], [ %.6, %bb.bb ], [ %.6, %bb.ba ], [ %.8, %bb.bk ], [ %.8, %bb.bj ], [ %.9, %.thread439 ], [ %.9, %.thread442 ] ; 2 uses
  %i.jl = fcmp ogt x86_fp80 %.8404, 5.000000e-01
  br i1 %i.jl, label %.thread444, label %.thread464

.thread444:                                       ; preds = %bb.bn, %.thread428
  %.sroa.0297.sroa.0.8 = phi x86_fp80 [ %.sroa.0297.sroa.0.7, %.thread428 ], [ %.sroa.0297.sroa.0.6, %bb.bn ] ; 2 uses
  %.sroa.0333.sroa.0.8 = phi x86_fp80 [ %.sroa.0333.sroa.0.7, %.thread428 ], [ %.sroa.0333.sroa.0.6, %bb.bn ] ; 2 uses
  %.10455 = phi i8 [ %.10, %.thread428 ], [ %.9, %bb.bn ]
  %.1173454 = phi x86_fp80 [ %.1173, %.thread428 ], [ 1.000000e+00, %bb.bn ]
  %.8384453 = phi x86_fp80 [ %.8384, %.thread428 ], [ %.7383, %bb.bn ] ; 2 uses
  %.8394452 = phi x86_fp80 [ %.8394, %.thread428 ], [ %.7393, %bb.bn ] ; 2 uses
  %.6414451 = phi x86_fp80 [ %.6414, %.thread428 ], [ 0.000000e+00, %bb.bn ] ; 2 uses
...
.thread464:                                       ; preds = %.thread428, %.thread444
  %.sroa.0297.sroa.0.9 = phi x86_fp80 [ %.sroa.0333.sroa.0.8, %.thread444 ], [ %.sroa.0297.sroa.0.7, %.thread428 ] ; 3 uses
  %.sroa.0333.sroa.0.9 = phi x86_fp80 [ %.sroa.0297.sroa.0.8, %.thread444 ], [ %.sroa.0333.sroa.0.7, %.thread428 ] ; 3 uses
  %.11478 = phi i8 [ %i.jm, %.thread444 ], [ %.10, %.thread428 ] ; 3 uses
  %.2174477 = phi x86_fp80 [ 1.000000e+00, %.thread444 ], [ %.1173, %.thread428 ] ; 3 uses
  %.9385475 = phi x86_fp80 [ %.8394452, %.thread444 ], [ %.8384, %.thread428 ] ; 3 uses
  %.9395473 = phi x86_fp80 [ %.8384453, %.thread444 ], [ %.8394, %.thread428 ] ; 3 uses
...
.thread483:                                       ; preds = %.thread464.thread, %bb.cb
  %.sroa.0297.sroa.0.10 = phi x86_fp80 [ %.sroa.0297.sroa.0.9, %bb.cb ], [ %.sroa.0297.sroa.0.6, %.thread464.thread ]
  %.sroa.0333.sroa.0.10 = phi x86_fp80 [ %.sroa.0333.sroa.0.9, %bb.cb ], [ %.sroa.0333.sroa.0.6, %.thread464.thread ]
  %.2174477505519 = phi x86_fp80 [ %.2174477, %bb.cb ], [ 1.000000e+00, %.thread464.thread ]
  %.9385475507518 = phi x86_fp80 [ %.9385475, %bb.cb ], [ %.7383, %.thread464.thread ]
  %.9395473509517 = phi x86_fp80 [ %.9395473, %bb.cb ], [ %.7393, %.thread464.thread ]
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #41
  store i64 200, ptr %i.b, align 8, !tbaa !260
  br label %bb.cg
...
bb.ce:                                            ; preds = %bb.cc, %bb.cd, %.thread444
  %.sroa.0297.sroa.0.11 = phi x86_fp80 [ %.sroa.0297.sroa.0.9, %bb.cd ], [ %.sroa.0297.sroa.0.9, %bb.cc ], [ %.sroa.0333.sroa.0.8, %.thread444 ] ; 2 uses
  %.sroa.0333.sroa.0.11 = phi x86_fp80 [ %.sroa.0333.sroa.0.9, %bb.cd ], [ %.sroa.0333.sroa.0.9, %bb.cc ], [ %.sroa.0297.sroa.0.8, %.thread444 ] ; 2 uses
  %.11479 = phi i8 [ %.11478, %bb.cd ], [ %.11478, %bb.cc ], [ %i.jm, %.thread444 ] ; 2 uses
  %.2174476 = phi x86_fp80 [ %.2174477, %bb.cd ], [ %.2174477, %bb.cc ], [ 1.000000e+00, %.thread444 ] ; 2 uses
  %.9385474 = phi x86_fp80 [ %.9385475, %bb.cd ], [ %.9385475, %bb.cc ], [ %.8394452, %.thread444 ] ; 2 uses
  %.9395472 = phi x86_fp80 [ %.9395473, %bb.cd ], [ %.9395473, %bb.cc ], [ %.8384453, %.thread444 ] ; 2 uses
  %.11407 = phi x86_fp80 [ %.1170, %bb.cd ], [ %.9405471, %bb.cc ], [ %.6414451, %.thread444 ] ; 3 uses
  %.2171 = phi x86_fp80 [ %.1170, %bb.cd ], [ %.1170, %bb.cc ], [ %i.jn, %.thread444 ] ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #41
  store i64 200, ptr %i.b, align 8, !tbaa !260
...
bb.cf:                                            ; preds = %.thread533, %bb.ce
  %.sroa.0297.sroa.0.12 = phi x86_fp80 [ %.sroa.0297.sroa.0.11, %bb.ce ], [ %.sroa.0297.sroa.0.6, %.thread533 ] ; 2 uses
  %.sroa.0333.sroa.0.12 = phi x86_fp80 [ %.sroa.0333.sroa.0.11, %bb.ce ], [ %.sroa.0333.sroa.0.6, %.thread533 ] ; 2 uses
  %.2171545 = phi x86_fp80 [ %.2171, %bb.ce ], [ f0x00018000000000000000, %.thread533 ]
  %.11407544 = phi x86_fp80 [ %.11407, %bb.ce ], [ f0x00018000000000000000, %.thread533 ]
  %.9395472543 = phi x86_fp80 [ %.9395472, %bb.ce ], [ %.7393, %.thread533 ]
  %.9385474542 = phi x86_fp80 [ %.9385474, %bb.ce ], [ %.7383, %.thread533 ]
  %.2174476541 = phi x86_fp80 [ %.2174476, %bb.ce ], [ 1.000000e+00, %.thread533 ]
  %.11479540 = phi i8 [ %.11479, %bb.ce ], [ %.9, %.thread533 ]
...
bb.cg:                                            ; preds = %bb.cf, %.thread483, %bb.ce
  %.sroa.0297.sroa.0.13 = phi x86_fp80 [ %.sroa.0297.sroa.0.10, %.thread483 ], [ %.sroa.0297.sroa.0.12, %bb.cf ], [ %.sroa.0297.sroa.0.11, %bb.ce ]
  %.sroa.0333.sroa.0.13 = phi x86_fp80 [ %.sroa.0333.sroa.0.10, %.thread483 ], [ %.sroa.0333.sroa.0.12, %bb.cf ], [ %.sroa.0333.sroa.0.11, %bb.ce ]
  %.2171495 = phi x86_fp80 [ f0x3FC08000000000000000, %.thread483 ], [ %.2171545, %bb.cf ], [ %.2171, %bb.ce ] ; 2 uses
  %.11407494 = phi x86_fp80 [ f0x3FC08000000000000000, %.thread483 ], [ %.11407544, %bb.cf ], [ %.11407, %bb.ce ]
  %.9395472493 = phi x86_fp80 [ %.9395473509517, %.thread483 ], [ %.9395472543, %bb.cf ], [ %.9395472, %bb.ce ] ; 2 uses
  %.9385474492 = phi x86_fp80 [ %.9385475507518, %.thread483 ], [ %.9385474542, %bb.cf ], [ %.9385474, %bb.ce ] ; 2 uses
  %.2174476491 = phi x86_fp80 [ %.2174477505519, %.thread483 ], [ %.2174476541, %bb.cf ], [ %.2174476, %bb.ce ]
  %.11479490 = phi i8 [ 1, %.thread483 ], [ %.11479540, %bb.cf ], [ %.11479, %bb.ce ]
