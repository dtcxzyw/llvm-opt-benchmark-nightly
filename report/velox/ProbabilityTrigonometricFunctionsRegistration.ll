...
thread-pre-split328:                              ; preds = %bb.cq, %bb.cr
  ...
  %i.lg = phi x86_fp80 [ %0, %bb.cr ], [ %1, %bb.cq ] ; 11 uses
...
bb.cs:                                            ; preds = %thread-pre-split328
  %i.li = tail call noundef x86_fp80 @llvm.floor.f80(x86_fp80 %i.lf)
  %i.lj = fcmp oeq x86_fp80 %i.li, %i.lf
  %i.lk = tail call x86_fp80 @llvm.floor.f80(x86_fp80 %i.lg) ; 3 uses
...
bb.dd:                                            ; preds = %bb.dc
  ...
  store x86_fp80 %i.lk, ptr %i.d, align 16, !tbaa !180
...
bb.dg:                                            ; preds = %bb.df
  ...
  store x86_fp80 %i.lk, ptr %i.e, align 16, !tbaa !180
...
bb.b:                                             ; preds = %bb.a
  %i.c = tail call noundef x86_fp80 @llvm.floor.f80(x86_fp80 %0)
...
bb.b:                                             ; preds = %bb.a
  %i.d = tail call noundef x86_fp80 @llvm.floor.f80(x86_fp80 %0)
...
bb.e:                                             ; preds = %bb.a
  %i.n = tail call noundef x86_fp80 @llvm.floor.f80(x86_fp80 %1)
...
begin_hunk_11_@_ZN5boost4math6detail28fast_students_t_quantile_impIeNS0_8policies6policyINS3_14default_policyES5_S5_S5_S5_S5_S5_S5_S5_S5_S5_S5_S5_EEEET_S7_S7_RKT0_PKSt17integral_constantIbLb1EE:bb.a
  ...
  %i.d = tail call x86_fp80 @llvm.floor.f80(x86_fp80 %0)
