...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %.not220, label %bb.ce, label %bb.c
...
bb.e:                                             ; preds = %bb.d
  ...
  br i1 %.not219, label %bb.ce, label %bb.f
...
bb.i:                                             ; preds = %bb.h
  ...
  br i1 %.not218, label %bb.ce, label %bb.j
...
thread-pre-split.thread:                          ; preds = %bb.h
  ...
  br i1 %i.i, label %thread-pre-split417, label %.thread640
...
bb.l:                                             ; preds = %bb.k
  ...
  br i1 %.not217, label %bb.ce, label %bb.m
...
bb.n:                                             ; preds = %bb.k
  ...
  br i1 %i.q, label %.thread618, label %thread-pre-split417
...
bb.aj:                                            ; preds = %bb.ai
  ...
  br i1 %i.cg, label %.thread, label %bb.cd
...
bb.av:                                            ; preds = %bb.au
  ...
  br i1 %i.dt, label %.critedge, label %bb.cd
...
bb.az:                                            ; preds = %bb.ax, %bb.ay
  %.0180 = phi x86_fp80 [ %i.em, %bb.ay ], [ %spec.select549, %bb.ax ] ; 2 uses
  %i.en = fadd x86_fp80 %.0180, 1.000000e+00      ; 2 uses
  %i.eo = fdiv x86_fp80 %.0180, %i.en             ; 2 uses
  %i.ep = fdiv x86_fp80 1.000000e+00, %i.en
  %i.eq = fcmp ogt x86_fp80 %i.eo, %.0178
  %spec.select550 = select i1 %i.eq, x86_fp80 %.0178, x86_fp80 %i.eo
  br label %.thread428
...
bb.bn:                                            ; preds = %bb.bm
  ...
  %or.cond553 = and i1 %i.ij, %i.il
  br i1 %or.cond553, label %bb.bq, label %.thread439
...
bb.bo:                                            ; preds = %bb.bm
  ...
  br i1 %i.ip, label %bb.bp, label %bb.cd
...
bb.bq:                                            ; preds = %bb.bn
  ...
  %spec.select554 = select i1 %i.is, x86_fp80 f0x00018000000000000000, x86_fp80 %i.ii
  br label %.thread439

.thread439:                                       ; preds = %bb.bq, %bb.bn, %bb.bp
  %.7403 = phi x86_fp80 [ 1.000000e+00, %bb.bn ], [ %spec.select554, %bb.bq ], [ 1.000000e+00, %bb.bp ] ; 2 uses
...
bb.bs:                                            ; preds = %bb.br
  ...
  %or.cond556 = and i1 %i.ja, %i.jc
  br i1 %or.cond556, label %bb.bv, label %.thread442
...
bb.bt:                                            ; preds = %bb.br
  ...
  br i1 %i.jg, label %bb.bu, label %bb.cd
...
bb.bv:                                            ; preds = %bb.bs
  ...
  %spec.select557 = select i1 %i.jj, x86_fp80 f0x00018000000000000000, x86_fp80 %i.iz
  br label %.thread442

.thread442:                                       ; preds = %bb.bv, %bb.bs, %bb.bu
  %.5413 = phi x86_fp80 [ 1.000000e+00, %bb.bs ], [ %spec.select557, %bb.bv ], [ 1.000000e+00, %bb.bu ] ; 2 uses
...
bb.bx:                                            ; preds = %.thread464, %bb.bw
  %.1170 = phi x86_fp80 [ f0x00018000000000000000, %.thread464 ], [ f0x3FC08000000000000000, %bb.bw ] ; 3 uses
  %i.ju = fcmp olt x86_fp80 %.9405471, %.1170
  %spec.select558 = select i1 %i.ju, x86_fp80 %.1170, x86_fp80 %.9405471
  br label %bb.by
...
bb.ca:                                            ; preds = %bb.bz, %.thread483, %bb.by
  ...
  br i1 %.not.i222, label %_ZN5boost4math8policies21check_root_iterationsIeNS1_6policyINS1_13promote_floatILb0EEENS1_14promote_doubleILb0EEENS1_14default_policyES8_S8_S8_S8_S8_S8_S8_S8_S8_S8_EEEEvPKcmRKT0_.exit, label %bb.cb
...
_ZN5boost4math8policies21check_root_iterationsIeNS1_6policyINS1_13promote_floatILb0EEENS1_14promote_doubleILb0EEENS1_14default_policyES8_S8_S8_S8_S8_S8_S8_S8_S8_S8_EEEEvPKcmRKT0_.exit: ; preds = %bb.ca, %bb.cb
  ...
  %.pre565 = fsub x86_fp80 1.000000e+00, %spec.select560 ; 2 uses
  br i1 %.not216, label %_ZN5boost4math8policies21check_root_iterationsIeNS1_6policyINS1_13promote_floatILb0EEENS1_14promote_doubleILb0EEENS1_14default_policyES8_S8_S8_S8_S8_S8_S8_S8_S8_S8_EEEEvPKcmRKT0_.exit._crit_edge, label %bb.cc

bb.cc:                                            ; preds = %_ZN5boost4math8policies21check_root_iterationsIeNS1_6policyINS1_13promote_floatILb0EEENS1_14promote_doubleILb0EEENS1_14default_policyES8_S8_S8_S8_S8_S8_S8_S8_S8_S8_EEEEvPKcmRKT0_.exit
  %i.kg = select i1 %.pre, x86_fp80 %spec.select560, x86_fp80 %.pre565
...
_ZN5boost4math8policies21check_root_iterationsIeNS1_6policyINS1_13promote_floatILb0EEENS1_14promote_doubleILb0EEENS1_14default_policyES8_S8_S8_S8_S8_S8_S8_S8_S8_S8_EEEEvPKcmRKT0_.exit._crit_edge: ; preds = %_ZN5boost4math8policies21check_root_iterationsIeNS1_6policyINS1_13promote_floatILb0EEENS1_14promote_doubleILb0EEENS1_14default_policyES8_S8_S8_S8_S8_S8_S8_S8_S8_S8_EEEEvPKcmRKT0_.exit, %bb.cc
  %i.kh = select i1 %.pre, x86_fp80 %.pre565, x86_fp80 %spec.select560
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #41
  br label %bb.ce

bb.cd:                                            ; preds = %bb.av, %bb.aj, %bb.bt, %bb.bo
  %.merged = phi { ptr, i32 } [ %i.jd, %bb.bt ], [ %i.cd, %bb.aj ], [ %i.im, %bb.bo ], [ %i.dq, %bb.av ]
  resume { ptr, i32 } %.merged

bb.ce:                                            ; preds = %_ZN5boost4math8policies21check_root_iterationsIeNS1_6policyINS1_13promote_floatILb0EEENS1_14promote_doubleILb0EEENS1_14default_policyES8_S8_S8_S8_S8_S8_S8_S8_S8_S8_EEEEvPKcmRKT0_.exit._crit_edge, %bb.m, %bb.l, %bb.v, %bb.u, %bb.at, %bb.ao, %bb.i, %bb.j, %bb.e, %bb.f, %bb.b, %bb.c
...
_ZN5boost4math5tools19evaluate_polynomialIeeEET0_PKT_RKS3_m.exit:
  ...
  br i1 %i.df, label %bb.b, label %bb.a
...
bb.a:                                             ; preds = %_ZN5boost4math5tools19evaluate_polynomialIeeEET0_PKT_RKS3_m.exit
  ...
  %i.dl = fmul x86_fp80 %i.dk, 5.000000e-01
  br label %bb.b

bb.b:                                             ; preds = %_ZN5boost4math5tools19evaluate_polynomialIeeEET0_PKT_RKS3_m.exit, %bb.a
  %.0 = phi x86_fp80 [ %i.dl, %bb.a ], [ 5.000000e-01, %_ZN5boost4math5tools19evaluate_polynomialIeeEET0_PKT_RKS3_m.exit ] ; 3 uses
  %i.dm = fcmp olt x86_fp80 %.0, 0.000000e+00
  %i.dn = fcmp ogt x86_fp80 %.0, 1.000000e+00
  %spec.store.select = select i1 %i.dn, x86_fp80 1.000000e+00, x86_fp80 %.0
  %.1 = select i1 %i.dm, x86_fp80 0.000000e+00, x86_fp80 %spec.store.select
  ret x86_fp80 %.1
}
...
_ZN5boost4math5tools24evaluate_even_polynomialIieEET0_PKT_S3_m.exit:
  ...
  %i.ah = fadd x86_fp80 %i.ag, -6.200000e+01
  %i.ai = fmul x86_fp80 %i.p, %i.ah
  %i.aj = fadd x86_fp80 %i.ai, 3.300000e+01
  %i.ak = fmul x86_fp80 %i.p, %i.aj
end_hunk_0
...
bb.h:                                             ; preds = %bb.g
  ...
  %spec.select = select i1 %.inv, x86_fp80 f0x00018000000000000000, x86_fp80 %i.o ; 2 uses
...
bb.i:                                             ; preds = %bb.h
  ...
  %spec.select33 = select i1 %i.t, i32 64, i32 31
...
_ZN5boost4math6detail20gamma_p_inverse_funcIeNS0_8policies6policyINS3_13promote_floatILb0EEENS3_14promote_doubleILb0EEENS3_14default_policyES9_S9_S9_S9_S9_S9_S9_S9_S9_S9_EEEC2Eeeb.exit: ; preds = %bb.i, %bb.h
  %.1 = phi i32 [ 31, %bb.h ], [ %spec.select33, %bb.i ]
  ...
  %spec.select34 = select i1 %i.u, x86_fp80 %1, x86_fp80 %i.n
  %spec.select35 = zext i1 %i.u to i8
  call void @llvm.lifetime.start.p0(ptr nonnull %3)
  store x86_fp80 %0, ptr %3, align 16
  %.sroa.230.0..sroa_idx = getelementptr inbounds nuw i8, ptr %3, i64 16
  store x86_fp80 %spec.select34, ptr %.sroa.230.0..sroa_idx, align 16
  %.sroa.431.0..sroa_idx = getelementptr inbounds nuw i8, ptr %3, i64 32
  store i8 %spec.select35, ptr %.sroa.431.0..sroa_idx, align 16
  %i.v = call noundef x86_fp80 @_ZN5boost4math5tools6detail24second_order_root_finderINS2_11halley_stepENS0_6detail20gamma_p_inverse_funcIeNS0_8policies6policyINS7_13promote_floatILb0EEENS7_14promote_doubleILb0EEENS7_14default_policyESD_SD_SD_SD_SD_SD_SD_SD_SD_SD_EEEEeEET1_T0_SG_SG_SG_iRm(ptr noundef nonnull byval(%"struct.boost::math::detail::gamma_p_inverse_func") align 16 %3, x86_fp80 noundef %spec.select, x86_fp80 noundef f0x00018000000000000000, x86_fp80 noundef f0x7FFEFFFFFFFFFFFFFFFF, i32 noundef %.1, ptr noundef nonnull align 8 dereferenceable(8) %i.e) ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %3)
  %i.w = load i64, ptr %i.e, align 8, !tbaa !260  ; 2 uses
  %.not.i = icmp ult i64 %i.w, 200
  br i1 %.not.i, label %_ZN5boost4math8policies21check_root_iterationsIeNS1_6policyINS1_13promote_floatILb0EEENS1_14promote_doubleILb0EEENS1_14default_policyES8_S8_S8_S8_S8_S8_S8_S8_S8_S8_EEEEvPKcmRKT0_.exit, label %bb.j

bb.j:                                             ; preds = %_ZN5boost4math6detail20gamma_p_inverse_funcIeNS0_8policies6policyINS3_13promote_floatILb0EEENS3_14promote_doubleILb0EEENS3_14default_policyES9_S9_S9_S9_S9_S9_S9_S9_S9_S9_EEEC2Eeeb.exit
...
_ZN5boost4math8policies21check_root_iterationsIeNS1_6policyINS1_13promote_floatILb0EEENS1_14promote_doubleILb0EEENS1_14default_policyES8_S8_S8_S8_S8_S8_S8_S8_S8_S8_EEEEvPKcmRKT0_.exit: ; preds = %_ZN5boost4math6detail20gamma_p_inverse_funcIeNS0_8policies6policyINS3_13promote_floatILb0EEENS3_14promote_doubleILb0EEENS3_14default_policyES9_S9_S9_S9_S9_S9_S9_S9_S9_S9_EEEC2Eeeb.exit, %bb.j
  ...
  %spec.select36 = select i1 %i.aa, x86_fp80 0.000000e+00, x86_fp80 %i.v
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e) #41
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d) #41
  br label %bb.k

bb.k:                                             ; preds = %bb.g, %_ZN5boost4math8policies21check_root_iterationsIeNS1_6policyINS1_13promote_floatILb0EEENS1_14promote_doubleILb0EEENS1_14default_policyES8_S8_S8_S8_S8_S8_S8_S8_S8_S8_EEEEvPKcmRKT0_.exit, %bb.f, %bb.d, %bb.b
  %.021 = phi x86_fp80 [ +qnan, %bb.b ], [ +qnan, %bb.d ], [ +inf, %bb.f ], [ %spec.select36, %_ZN5boost4math8policies21check_root_iterationsIeNS1_6policyINS1_13promote_floatILb0EEENS1_14promote_doubleILb0EEENS1_14default_policyES8_S8_S8_S8_S8_S8_S8_S8_S8_S8_EEEEvPKcmRKT0_.exit ], [ 0.000000e+00, %bb.g ]
  ret x86_fp80 %.021
}
...
bb.e:                                             ; preds = %bb.c, %bb.d
  ...
  br i1 %i.w, label %.lr.ph94, label %.lr.ph

.lr.ph94:                                         ; preds = %bb.e, %_ZNK5boost4math6detail20gamma_p_inverse_funcIeNS0_8policies6policyINS3_13promote_floatILb0EEENS3_14promote_doubleILb0EEENS3_14default_policyES9_S9_S9_S9_S9_S9_S9_S9_S9_S9_EEEclERKe.exit
  ...
  %.093 = phi x86_fp80 [ %i.ap, %_ZNK5boost4math6detail20gamma_p_inverse_funcIeNS0_8policies6policyINS3_13promote_floatILb0EEENS3_14promote_doubleILb0EEENS3_14default_policyES9_S9_S9_S9_S9_S9_S9_S9_S9_S9_EEEclERKe.exit ], [ %i.r, %bb.e ] ; 4 uses
  %.06592 = phi x86_fp80 [ %i.am, %_ZNK5boost4math6detail20gamma_p_inverse_funcIeNS0_8policies6policyINS3_13promote_floatILb0EEENS3_14promote_doubleILb0EEENS3_14default_policyES9_S9_S9_S9_S9_S9_S9_S9_S9_S9_EEEclERKe.exit ], [ %1, %bb.e ] ; 3 uses
...
bb.f:                                             ; preds = %.lr.ph94
  store x86_fp80 %.06592, ptr %3, align 16, !tbaa !182
  %i.am = fmul x86_fp80 %.06592, %.093            ; 3 uses
...
_ZNK5boost4math6detail20gamma_p_inverse_funcIeNS0_8policies6policyINS3_13promote_floatILb0EEENS3_14promote_doubleILb0EEENS3_14default_policyES9_S9_S9_S9_S9_S9_S9_S9_S9_S9_EEEclERKe.exit: ; preds = %bb.f
  ...
  br i1 %.not39, label %.critedge.thread, label %.lr.ph94, !llvm.loop !9994

.lr.ph:                                           ; preds = %bb.e, %_ZNK5boost4math6detail20gamma_p_inverse_funcIeNS0_8policies6policyINS3_13promote_floatILb0EEENS3_14promote_doubleILb0EEENS3_14default_policyES9_S9_S9_S9_S9_S9_S9_S9_S9_S9_EEEclERKe.exit45
  %i.au = phi x86_fp80 [ %i.be, %_ZNK5boost4math6detail20gamma_p_inverse_funcIeNS0_8policies6policyINS3_13promote_floatILb0EEENS3_14promote_doubleILb0EEENS3_14default_policyES9_S9_S9_S9_S9_S9_S9_S9_S9_S9_EEEclERKe.exit45 ], [ %i.s, %bb.e ] ; 2 uses
  %.190 = phi x86_fp80 [ %i.bc, %_ZNK5boost4math6detail20gamma_p_inverse_funcIeNS0_8policies6policyINS3_13promote_floatILb0EEENS3_14promote_doubleILb0EEENS3_14default_policyES9_S9_S9_S9_S9_S9_S9_S9_S9_S9_EEEclERKe.exit45 ], [ %i.r, %bb.e ] ; 4 uses
  %.16689 = phi x86_fp80 [ %i.az, %_ZNK5boost4math6detail20gamma_p_inverse_funcIeNS0_8policies6policyINS3_13promote_floatILb0EEENS3_14promote_doubleILb0EEENS3_14default_policyES9_S9_S9_S9_S9_S9_S9_S9_S9_S9_EEEclERKe.exit45 ], [ %1, %bb.e ] ; 3 uses
...
bb.g:                                             ; preds = %.lr.ph
  store x86_fp80 %.16689, ptr %3, align 16, !tbaa !182
  %i.az = fdiv x86_fp80 %.16689, %.190            ; 3 uses
  %i.ba = load x86_fp80, ptr %4, align 16, !tbaa !182 ; 2 uses
  %i.bb = fcmp ogt x86_fp80 %i.az, %i.ba
  br i1 %i.bb, label %.critedge.sink.split, label %_ZNK5boost4math6detail20gamma_p_inverse_funcIeNS0_8policies6policyINS3_13promote_floatILb0EEENS3_14promote_doubleILb0EEENS3_14default_policyES9_S9_S9_S9_S9_S9_S9_S9_S9_S9_EEEclERKe.exit45

_ZNK5boost4math6detail20gamma_p_inverse_funcIeNS0_8policies6policyINS3_13promote_floatILb0EEENS3_14promote_doubleILb0EEENS3_14default_policyES9_S9_S9_S9_S9_S9_S9_S9_S9_S9_EEEclERKe.exit45: ; preds = %bb.g
  %i.bc = fmul x86_fp80 %.190, %i.aa
...
.critedge.sink.split:                             ; preds = %bb.g, %bb.f
  %.lcssa131.sink = phi x86_fp80 [ %i.ah, %bb.f ], [ %i.au, %bb.g ]
  %.267.ph.ph = phi x86_fp80 [ %i.an, %bb.f ], [ %i.ba, %bb.g ]
  %.2.ph.ph = phi x86_fp80 [ %.093, %bb.f ], [ %.190, %bb.g ]
  %i.bh = fneg x86_fp80 %.lcssa131.sink
  store x86_fp80 %i.bh, ptr %i.c, align 16, !tbaa !182
  br label %.critedge

.critedge:                                        ; preds = %.lr.ph, %.lr.ph94, %.critedge.sink.split
  %.267.ph = phi x86_fp80 [ %.267.ph.ph, %.critedge.sink.split ], [ %.06592, %.lr.ph94 ], [ %.16689, %.lr.ph ] ; 3 uses
  %.2.ph = phi x86_fp80 [ %.2.ph.ph, %.critedge.sink.split ], [ %.093, %.lr.ph94 ], [ %.190, %.lr.ph ]
  store x86_fp80 %.267.ph, ptr %4, align 16, !tbaa !182
  %i.bi = fcmp ogt x86_fp80 %.2.ph, 1.600000e+01
  br i1 %i.bi, label %bb.h, label %.critedge.thread

bb.h:                                             ; preds = %.critedge
  %i.bj = fsub x86_fp80 %1, %.267.ph
  %i.bk = call noundef x86_fp80 @_ZN5boost4math5tools6detail24bracket_root_towards_minINS0_6detail20gamma_p_inverse_funcIeNS0_8policies6policyINS6_13promote_floatILb0EEENS6_14promote_doubleILb0EEENS6_14default_policyESC_SC_SC_SC_SC_SC_SC_SC_SC_SC_EEEEeEET0_T_SF_RKSF_RSF_SJ_Rm(ptr noundef nonnull byval(%"struct.boost::math::detail::gamma_p_inverse_func") align 16 %0, x86_fp80 noundef %.267.ph, ptr noundef nonnull align 16 dereferenceable(16) %i.c, ptr noundef nonnull align 16 dereferenceable(16) %3, ptr noundef nonnull align 16 dereferenceable(16) %4, ptr noundef nonnull align 8 dereferenceable(8) %5)
  %i.bl = fadd x86_fp80 %i.bj, %i.bk
  br label %bb.i

.critedge.thread:                                 ; preds = %_ZNK5boost4math6detail20gamma_p_inverse_funcIeNS0_8policies6policyINS3_13promote_floatILb0EEENS3_14promote_doubleILb0EEENS3_14default_policyES9_S9_S9_S9_S9_S9_S9_S9_S9_S9_EEEclERKe.exit45, %_ZNK5boost4math6detail20gamma_p_inverse_funcIeNS0_8policies6policyINS3_13promote_floatILb0EEENS3_14promote_doubleILb0EEENS3_14default_policyES9_S9_S9_S9_S9_S9_S9_S9_S9_S9_EEEclERKe.exit, %.critedge
...
bb.m:                                             ; preds = %bb.k, %_ZN5boost4math6detail19get_min_shift_valueIeEET_v.exit, %bb.g
  ...
  %spec.select = add i32 %i.ad, -64
  %i.ah = add i32 %spec.select, %i.ag
