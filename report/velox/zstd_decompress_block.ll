...
begin_hunk_0_@ZSTD_decompressSequencesLong:bb.a
  br i1 %i.yh, label %vec.epilog.middle.block105, label %vec.epilog.vector.body99, !llvm.loop !100
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i
  ...
  br i1 %exitcond.not.i.i, label %ZSTD_safecopyDstBeforeSrc.exit.i, label %.lr.ph.i.i, !llvm.loop !101
...
ZSTD_safecopyDstBeforeSrc.exit.i:                 ; preds = %.lr.ph.i.i, %.lr.ph41.i.i, %middle.block87, %vec.epilog.middle.block105, %middle.block55, %vec.epilog.middle.block, %.preheader.i.i
  %i.yl = load i64, ptr %i.we, align 8, !tbaa !92
  %i.ym = sub i64 %i.yl, %i.wl                    ; 2 uses
  store i64 %i.ym, ptr %i.we, align 8, !tbaa !92
...
thread-pre-split:                                 ; preds = %bb.ce, %ZSTD_safecopyDstBeforeSrc.exit.i
  ...
  store ptr %i.hv, ptr %i.a, align 8, !tbaa !36
  ...
  %or.cond.i.i = select i1 %i.ys, i1 true, i1 %i.yu, !prof !102
  br i1 %or.cond.i.i, label %bb.cl, label %.critedge.i.i, !prof !102
...
.critedge.i.i:                                    ; preds = %thread-pre-split
  ...
  br i1 %i.yv, label %bb.cm, label %ZSTD_wildcopy.exit178.i, !prof !50
...
bb.co:                                            ; preds = %bb.co, %bb.cn
  ...
  br i1 %i.zd, label %bb.co, label %ZSTD_wildcopy.exit178.i, !llvm.loop !98

ZSTD_wildcopy.exit178.i:                          ; preds = %bb.co, %bb.cm, %.critedge.i.i
  store ptr %i.yp, ptr %i.a, align 8, !tbaa !36
...
bb.cp:                                            ; preds = %ZSTD_wildcopy.exit178.i
  ...
  br i1 %i.zi, label %.thread566.i, label %bb.cq, !prof !50
...
bb.ct:                                            ; preds = %bb.cs, %ZSTD_wildcopy.exit178.i
  ...
  br i1 %i.zo, label %bb.cu, label %bb.cx, !prof !87

bb.cu:                                            ; preds = %bb.ct
  %i.zp = getelementptr inbounds i8, ptr %.0505.i, i64 %.sroa.6.0
  %.val204.i = load <2 x i64>, ptr %.0506.i, align 1, !tbaa !9
  store <2 x i64> %.val204.i, ptr %.0505.i, align 1, !tbaa !9
...
bb.cw:                                            ; preds = %bb.cw, %bb.cv
  ...
  br i1 %i.zv, label %bb.cw, label %ZSTD_execSequence.exit.i, !llvm.loop !98
...
bb.cy:                                            ; preds = %bb.cx
  ...
  %i.zz = load i8, ptr %.0506.i, align 1, !tbaa !9
  store i8 %i.zz, ptr %.0505.i, align 1, !tbaa !9
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.abq, label %middle.block, label %vector.body, !llvm.loop !103
...
.preheader598.i:                                  ; preds = %.preheader598.i.preheader326, %.preheader598.i
  ...
  br i1 %i.abt, label %.preheader598.i, label %ZSTD_execSequence.exit.i, !llvm.loop !104
...
bb.dd:                                            ; preds = %bb.dd, %bb.dc
  ...
  br i1 %i.abz, label %bb.dd, label %ZSTD_execSequence.exit.i, !llvm.loop !98
...
bb.de:                                            ; preds = %ZSTD_execSequence.exit.i
  ...
  store i64 %.sroa.0.0.i, ptr %i.we, align 8, !tbaa !43
  store i64 %.sroa.9.0.i, ptr %.sroa.6.0..sroa_idx, align 8, !tbaa !43
  store i64 %.sink826.i, ptr %.sroa.11.0..sroa_idx, align 8, !tbaa !43
...
bb.df:                                            ; preds = %bb.cd
  ...
  %or.cond.i35.i = select i1 %i.aco, i1 true, i1 %i.acq, !prof !102
  br i1 %or.cond.i35.i, label %bb.dg, label %.critedge.i36.i, !prof !102

.critedge.i36.i:                                  ; preds = %bb.df
  %.val238.i = load <2 x i64>, ptr %i.wb, align 1, !tbaa !9
  store <2 x i64> %.val238.i, ptr %.0207.i646.i, align 1, !tbaa !9
  %i.acr = icmp ugt i64 %i.wf, 16
  br i1 %i.acr, label %bb.dh, label %ZSTD_wildcopy.exit94.i, !prof !50
...
bb.dj:                                            ; preds = %bb.dj, %bb.di
  ...
  br i1 %i.adb, label %bb.dj, label %ZSTD_wildcopy.exit94.i, !llvm.loop !98

ZSTD_wildcopy.exit94.i:                           ; preds = %bb.dj, %bb.dh, %.critedge.i36.i
  store ptr %i.wg, ptr %i.a, align 8, !tbaa !36
...
bb.dk:                                            ; preds = %ZSTD_wildcopy.exit94.i
  ...
  br i1 %i.adg, label %.thread566.i, label %bb.dl, !prof !50
...
bb.do:                                            ; preds = %bb.dn, %ZSTD_wildcopy.exit94.i
  ...
  br i1 %i.adm, label %bb.dp, label %bb.ds, !prof !87

bb.dp:                                            ; preds = %bb.do
  %i.adn = getelementptr inbounds i8, ptr %.0493.i, i64 %.sroa.544.0
  %.val228.i = load <2 x i64>, ptr %.0494.i, align 1, !tbaa !9
  store <2 x i64> %.val228.i, ptr %.0493.i, align 1, !tbaa !9
...
bb.dr:                                            ; preds = %bb.dr, %bb.dq
  ...
  br i1 %i.adt, label %bb.dr, label %ZSTD_execSequenceSplitLitBuffer.exit.i, !llvm.loop !98
...
bb.dt:                                            ; preds = %bb.ds
  ...
  %i.adx = load i8, ptr %.0494.i, align 1, !tbaa !9
  store i8 %i.adx, ptr %.0493.i, align 1, !tbaa !9
...
vector.body122:                                   ; preds = %vector.body122, %vector.ph119
  ...
  br i1 %i.afo, label %middle.block129, label %vector.body122, !llvm.loop !105
...
.preheader602.i:                                  ; preds = %.preheader602.i.preheader330, %.preheader602.i
  ...
  br i1 %i.afr, label %.preheader602.i, label %ZSTD_execSequenceSplitLitBuffer.exit.i, !llvm.loop !106
...
bb.dy:                                            ; preds = %bb.dy, %bb.dx
  ...
  br i1 %i.afx, label %bb.dy, label %ZSTD_execSequenceSplitLitBuffer.exit.i, !llvm.loop !98
...
bb.dz:                                            ; preds = %ZSTD_decodeSequence.exit14.i
  ...
  %i.agd = load ptr, ptr %i.a, align 8, !tbaa !36 ; 3 uses
  ...
  %or.cond.i17.i = select i1 %i.agh, i1 true, i1 %i.agj, !prof !102
  br i1 %or.cond.i17.i, label %bb.ea, label %.critedge.i18.i, !prof !102

.critedge.i18.i:                                  ; preds = %bb.dz
  %.val241.i = load <2 x i64>, ptr %i.agd, align 1, !tbaa !9
  store <2 x i64> %.val241.i, ptr %.0207.i646.i, align 1, !tbaa !9
  %i.agk = icmp ugt i64 %.sroa.020.0.copyload, 16
  br i1 %i.agk, label %bb.eb, label %ZSTD_wildcopy.exit157.i, !prof !50
...
bb.ed:                                            ; preds = %bb.ed, %bb.ec
  ...
  br i1 %i.agu, label %bb.ed, label %ZSTD_wildcopy.exit157.i, !llvm.loop !98

ZSTD_wildcopy.exit157.i:                          ; preds = %bb.ed, %bb.eb, %.critedge.i18.i
  store ptr %i.age, ptr %i.a, align 8, !tbaa !36
...
bb.ee:                                            ; preds = %ZSTD_wildcopy.exit157.i
  ...
  br i1 %i.agz, label %.thread566.i, label %bb.ef, !prof !50
...
bb.ei:                                            ; preds = %bb.eh, %ZSTD_wildcopy.exit157.i
  ...
  br i1 %i.ahf, label %bb.ej, label %bb.em, !prof !87

bb.ej:                                            ; preds = %bb.ei
  %i.ahg = getelementptr inbounds i8, ptr %.0502.i, i64 %.sroa.5.0
  %.val210.i = load <2 x i64>, ptr %.0503.i, align 1, !tbaa !9
  store <2 x i64> %.val210.i, ptr %.0502.i, align 1, !tbaa !9
...
bb.el:                                            ; preds = %bb.el, %bb.ek
  ...
  br i1 %i.ahm, label %bb.el, label %ZSTD_execSequenceSplitLitBuffer.exit.i, !llvm.loop !98
...
bb.en:                                            ; preds = %bb.em
  ...
  %i.ahq = load i8, ptr %.0503.i, align 1, !tbaa !9
  store i8 %i.ahq, ptr %.0502.i, align 1, !tbaa !9
...
vector.body145:                                   ; preds = %vector.body145, %vector.ph142
  ...
  br i1 %i.ajh, label %middle.block152, label %vector.body145, !llvm.loop !107
...
.preheader605.i:                                  ; preds = %.preheader605.i.preheader334, %.preheader605.i
  ...
  br i1 %i.ajk, label %.preheader605.i, label %ZSTD_execSequenceSplitLitBuffer.exit.i, !llvm.loop !108
...
bb.es:                                            ; preds = %bb.es, %bb.er
  ...
  br i1 %i.ajq, label %bb.es, label %ZSTD_execSequenceSplitLitBuffer.exit.i, !llvm.loop !98
...
.thread529.i:                                     ; preds = %ZSTD_execSequenceSplitLitBuffer.exit.i
  ...
  store i64 %.sroa.0.0.i, ptr %i.akc, align 8, !tbaa !43
  ...
  store i64 %.sink826.i, ptr %.sroa.12.0..sroa_idx.i, align 8, !tbaa !43
...
bb.et:                                            ; preds = %.thread529.i, %bb.de
  ...
  br i1 %exitcond687.not.i, label %._crit_edge.i, label %bb.bf, !llvm.loop !109
...
.lr.ph662.i:                                      ; preds = %bb.eu
  ...
  %i.akq = getelementptr inbounds nuw i8, ptr %0, i64 30388 ; 3 uses
  %i.akr = getelementptr inbounds nuw i8, ptr %0, i64 95924 ; 2 uses
  %i.aks = getelementptr inbounds nuw i8, ptr %0, i64 30404 ; 2 uses
...
.preheader.i:                                     ; preds = %bb.hl, %bb.eu
  ...
  %.pre698.i = load i32, ptr %i.d, align 8, !tbaa !33
  %.pre699.pre.i = load ptr, ptr %i.a, align 8, !tbaa !36
  br label %bb.hm
...
bb.ev:                                            ; preds = %bb.hl, %.lr.ph662.i
  ...
  %i.alc = load i32, ptr %i.d, align 8, !tbaa !33
  %i.ald = icmp eq i32 %i.alc, 2
  br i1 %i.ald, label %bb.ew, label %bb.gr

bb.ew:                                            ; preds = %bb.ev
  %i.ale = load ptr, ptr %i.a, align 8, !tbaa !36 ; 14 uses
  %i.alf = load i64, ptr %i.alb, align 8, !tbaa !92 ; 7 uses
  %i.alg = getelementptr inbounds nuw i8, ptr %i.ale, i64 %i.alf ; 4 uses
  %i.alh = load ptr, ptr %i.m, align 8, !tbaa !32 ; 3 uses
...
begin_hunk_1_@ZSTD_decompressSequencesLong:bb.a
  br i1 %i.anh, label %vec.epilog.middle.block255, label %vec.epilog.vector.body249, !llvm.loop !114
...
.lr.ph.i300.i:                                    ; preds = %.lr.ph.i300.i.preheader, %.lr.ph.i300.i
  ...
  br i1 %exitcond.not.i303.i, label %ZSTD_safecopyDstBeforeSrc.exit316.i, label %.lr.ph.i300.i, !llvm.loop !115
...
ZSTD_safecopyDstBeforeSrc.exit316.i:              ; preds = %.lr.ph.i300.i, %.lr.ph41.i313.i, %middle.block237, %vec.epilog.middle.block255, %middle.block197, %vec.epilog.middle.block215, %.preheader.i312.i
  %i.anl = load i64, ptr %i.alb, align 8, !tbaa !92
  %i.anm = sub i64 %i.anl, %i.all                 ; 2 uses
  store i64 %i.anm, ptr %i.alb, align 8, !tbaa !92
...
thread-pre-split58:                               ; preds = %bb.ex, %ZSTD_safecopyDstBeforeSrc.exit316.i
  ...
  store ptr %i.akq, ptr %i.a, align 8, !tbaa !36
  store i32 0, ptr %i.d, align 8, !tbaa !33
  ...
  %or.cond.i23.i = select i1 %i.ans, i1 true, i1 %i.anu, !prof !102
  br i1 %or.cond.i23.i, label %bb.fe, label %.critedge.i24.i, !prof !102
...
.critedge.i24.i:                                  ; preds = %thread-pre-split58
  ...
  br i1 %i.anv, label %bb.ff, label %ZSTD_wildcopy.exit136.i, !prof !50
...
bb.fh:                                            ; preds = %bb.fh, %bb.fg
  ...
  br i1 %i.aod, label %bb.fh, label %ZSTD_wildcopy.exit136.i, !llvm.loop !98

ZSTD_wildcopy.exit136.i:                          ; preds = %bb.fh, %bb.ff, %.critedge.i24.i
  store ptr %i.anp, ptr %i.a, align 8, !tbaa !36
...
bb.fi:                                            ; preds = %ZSTD_wildcopy.exit136.i
  ...
  br i1 %i.aoi, label %.thread566.i, label %bb.fj, !prof !50
...
bb.fm:                                            ; preds = %bb.fl, %ZSTD_wildcopy.exit136.i
  ...
  br i1 %i.aoo, label %bb.fn, label %bb.fq, !prof !87

bb.fn:                                            ; preds = %bb.fm
  %i.aop = getelementptr inbounds i8, ptr %.0499.i, i64 %.sroa.628.0
  %.val216.i = load <2 x i64>, ptr %.0500.i, align 1, !tbaa !9
  store <2 x i64> %.val216.i, ptr %.0499.i, align 1, !tbaa !9
...
bb.fp:                                            ; preds = %bb.fp, %bb.fo
  ...
  br i1 %i.aov, label %bb.fp, label %.loopexit.i, !llvm.loop !98
...
bb.fr:                                            ; preds = %bb.fq
  ...
  %i.aoz = load i8, ptr %.0500.i, align 1, !tbaa !9
  store i8 %i.aoz, ptr %.0499.i, align 1, !tbaa !9
...
vector.body169:                                   ; preds = %vector.body169, %vector.ph166
  ...
  br i1 %i.aqq, label %middle.block176, label %vector.body169, !llvm.loop !116
...
.preheader588.i:                                  ; preds = %.preheader588.i.preheader315, %.preheader588.i
  ...
  br i1 %i.aqt, label %.preheader588.i, label %.loopexit.i, !llvm.loop !117
...
bb.fw:                                            ; preds = %bb.fw, %bb.fv
  ...
  br i1 %i.aqz, label %bb.fw, label %.loopexit.i, !llvm.loop !98
...
bb.fx:                                            ; preds = %bb.ew
  ...
  %or.cond.i40.i = select i1 %i.arh, i1 true, i1 %i.arj, !prof !102
  br i1 %or.cond.i40.i, label %bb.fy, label %.critedge.i41.i, !prof !102

.critedge.i41.i:                                  ; preds = %bb.fx
  %.val237.i = load <2 x i64>, ptr %i.ale, align 1, !tbaa !9
  store <2 x i64> %.val237.i, ptr %.7214.i657.i, align 1, !tbaa !9
  %i.ark = icmp ugt i64 %i.alf, 16
  br i1 %i.ark, label %bb.fz, label %ZSTD_wildcopy.exit.i, !prof !50
...
bb.gb:                                            ; preds = %bb.gb, %bb.ga
  ...
  br i1 %i.aru, label %bb.gb, label %ZSTD_wildcopy.exit.i, !llvm.loop !98

ZSTD_wildcopy.exit.i:                             ; preds = %bb.gb, %bb.fz, %.critedge.i41.i
  store ptr %i.alg, ptr %i.a, align 8, !tbaa !36
...
bb.gc:                                            ; preds = %ZSTD_wildcopy.exit.i
  ...
  br i1 %i.arz, label %.thread566.i, label %bb.gd, !prof !50
...
bb.gg:                                            ; preds = %bb.gf, %ZSTD_wildcopy.exit.i
  ...
  br i1 %i.asf, label %bb.gh, label %bb.gk, !prof !87

bb.gh:                                            ; preds = %bb.gg
  %i.asg = getelementptr inbounds i8, ptr %.0.i, i64 %.sroa.552.0
  %.val234.i = load <2 x i64>, ptr %.0492.i, align 1, !tbaa !9
...
bb.gj:                                            ; preds = %bb.gj, %bb.gi
  ...
  br i1 %i.asm, label %bb.gj, label %ZSTD_execSequenceSplitLitBuffer.exit45.i, !llvm.loop !98
...
bb.gl:                                            ; preds = %bb.gk
  ...
  %i.asq = load i8, ptr %.0492.i, align 1, !tbaa !9
...
vector.body272:                                   ; preds = %vector.body272, %vector.ph269
  ...
  br i1 %i.auh, label %middle.block279, label %vector.body272, !llvm.loop !118
...
.preheader592.i:                                  ; preds = %.preheader592.i.preheader319, %.preheader592.i
  ...
  br i1 %i.auk, label %.preheader592.i, label %ZSTD_execSequenceSplitLitBuffer.exit45.i, !llvm.loop !119
...
bb.gq:                                            ; preds = %bb.gq, %bb.gp
  ...
  br i1 %i.auq, label %bb.gq, label %ZSTD_execSequenceSplitLitBuffer.exit45.i, !llvm.loop !98
...
bb.gr:                                            ; preds = %bb.ev
  ...
  %i.aut = load ptr, ptr %i.a, align 8, !tbaa !36 ; 3 uses
  ...
  %or.cond.i29.i = select i1 %i.aux, i1 true, i1 %i.auz, !prof !102
  br i1 %or.cond.i29.i, label %bb.gs, label %.critedge.i30.i, !prof !102

.critedge.i30.i:                                  ; preds = %bb.gr
  %.val239.i = load <2 x i64>, ptr %i.aut, align 1, !tbaa !9
  store <2 x i64> %.val239.i, ptr %.7214.i657.i, align 1, !tbaa !9
  %i.ava = icmp ugt i64 %.sroa.034.0.copyload, 16
  br i1 %i.ava, label %bb.gt, label %ZSTD_wildcopy.exit115.i, !prof !50
...
bb.gv:                                            ; preds = %bb.gv, %bb.gu
  ...
  br i1 %i.avk, label %bb.gv, label %ZSTD_wildcopy.exit115.i, !llvm.loop !98

ZSTD_wildcopy.exit115.i:                          ; preds = %bb.gv, %bb.gt, %.critedge.i30.i
  store ptr %i.auu, ptr %i.a, align 8, !tbaa !36
...
bb.gw:                                            ; preds = %ZSTD_wildcopy.exit115.i
  ...
  br i1 %i.avp, label %.thread566.i, label %bb.gx, !prof !50
...
bb.ha:                                            ; preds = %bb.gz, %ZSTD_wildcopy.exit115.i
  ...
  br i1 %i.avv, label %bb.hb, label %bb.he, !prof !87

bb.hb:                                            ; preds = %bb.ha
  %i.avw = getelementptr inbounds i8, ptr %.0496.i, i64 %.sroa.536.0
  %.val222.i = load <2 x i64>, ptr %.0497.i, align 1, !tbaa !9
  store <2 x i64> %.val222.i, ptr %.0496.i, align 1, !tbaa !9
...
bb.hd:                                            ; preds = %bb.hd, %bb.hc
  ...
  br i1 %i.awc, label %bb.hd, label %ZSTD_execSequenceSplitLitBuffer.exit45.i, !llvm.loop !98
...
bb.hf:                                            ; preds = %bb.he
  ...
  %i.awg = load i8, ptr %.0497.i, align 1, !tbaa !9
  store i8 %i.awg, ptr %.0496.i, align 1, !tbaa !9
...
vector.body295:                                   ; preds = %vector.body295, %vector.ph292
  ...
  br i1 %i.axx, label %middle.block302, label %vector.body295, !llvm.loop !120
...
.preheader595.i:                                  ; preds = %.preheader595.i.preheader323, %.preheader595.i
  ...
  br i1 %i.aya, label %.preheader595.i, label %ZSTD_execSequenceSplitLitBuffer.exit45.i, !llvm.loop !121
...
bb.hk:                                            ; preds = %bb.hk, %bb.hj
  ...
  br i1 %i.ayg, label %bb.hk, label %ZSTD_execSequenceSplitLitBuffer.exit45.i, !llvm.loop !98
...
bb.hl:                                            ; preds = %ZSTD_execSequenceSplitLitBuffer.exit45.i, %.loopexit.i
  ...
  br i1 %exitcond688.not.i, label %.preheader.i, label %bb.ev, !llvm.loop !122
...
bb.hq:                                            ; preds = %bb.hp, %bb.ho
  ...
  %i.ayu = getelementptr inbounds nuw i8, ptr %0, i64 30388
  %i.ayv = getelementptr inbounds nuw i8, ptr %0, i64 95924
  br label %bb.hr
...
bb.a:
  ...
  %.val = load i32, ptr %i.b, align 4, !tbaa !29
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 30376 ; 3 uses
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !32   ; 4 uses
  %i.i = getelementptr inbounds nuw i8, ptr %0, i64 29896
  %i.j = load ptr, ptr %i.i, align 8, !tbaa !71   ; 7 uses
...
bb.bc:                                            ; preds = %ZSTD_decodeSequence.exit189.i.thread.i, %ZSTD_decodeSequence.exit189.i.i
  ...
  %or.cond.i197.i.i = select i1 %i.ok, i1 true, i1 %i.om, !prof !102
  br i1 %or.cond.i197.i.i, label %bb.bd, label %.critedge.i198.i.i, !prof !102

.critedge.i198.i.i:                               ; preds = %bb.bc
  %.val29.i = load <2 x i64>, ptr %i.ob, align 1, !tbaa !9
  store <2 x i64> %.val29.i, ptr %.0132.i289.i, align 1, !tbaa !9
  %i.on = icmp ugt i64 %.sroa.080.0.i, 16
  br i1 %i.on, label %bb.be, label %ZSTD_wildcopy.exit.i.i, !prof !50
...
bb.bg:                                            ; preds = %bb.bg, %bb.bf
  ...
  br i1 %i.ox, label %bb.bg, label %ZSTD_wildcopy.exit.i.i, !llvm.loop !98

ZSTD_wildcopy.exit.i.i:                           ; preds = %bb.bg, %bb.be, %.critedge.i198.i.i
  store ptr %i.oa, ptr %i.a, align 8, !tbaa !36
...
bb.bh:                                            ; preds = %ZSTD_wildcopy.exit.i.i
  ...
  br i1 %i.pc, label %ZSTD_execSequenceSplitLitBuffer.exit.i.thread.i, label %bb.bi, !prof !50
...
bb.bk:                                            ; preds = %bb.bi
  ...
  store i64 %i.pg, ptr %.sroa.986.0..sroa_idx.i, align 8, !tbaa !127
  br label %bb.bl
...
bb.bl:                                            ; preds = %bb.bk, %ZSTD_wildcopy.exit.i.i
  ...
  br i1 %i.pj, label %bb.bm, label %bb.bp, !prof !87

bb.bm:                                            ; preds = %bb.bl
  %i.pk = getelementptr inbounds i8, ptr %.0.i, i64 %i.pi
  %.val19.i = load <2 x i64>, ptr %.0173.i, align 1, !tbaa !9
...
bb.bo:                                            ; preds = %bb.bo, %bb.bn
  ...
  %.1.i235.i.val.i = load <2 x i64>, ptr %.1.i235.i.i, align 1, !tbaa !9
  store <2 x i64> %.1.i235.i.val.i, ptr %.130.i233.i.i, align 1, !tbaa !9
  ...
  %.val18.i = load <2 x i64>, ptr %i.po, align 1, !tbaa !9
  store <2 x i64> %.val18.i, ptr %i.pn, align 1, !tbaa !9
  %i.pp = getelementptr inbounds nuw i8, ptr %.130.i233.i.i, i64 32 ; 2 uses
  %i.pq = icmp ult ptr %i.pp, %i.pk
  br i1 %i.pq, label %bb.bo, label %ZSTD_execSequenceSplitLitBuffer.exit.i.i, !llvm.loop !98
...
bb.bq:                                            ; preds = %bb.bp
  ...
  %i.pu = load i8, ptr %.0173.i, align 1, !tbaa !9
  store i8 %i.pu, ptr %.0.i, align 1, !tbaa !9
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.rl, label %middle.block, label %vector.body, !llvm.loop !128
...
.preheader269.i:                                  ; preds = %.preheader269.i.preheader255, %.preheader269.i
  ...
  br i1 %i.ro, label %.preheader269.i, label %ZSTD_execSequenceSplitLitBuffer.exit.i.i, !llvm.loop !129

bb.bt:                                            ; preds = %bb.bs
  %.val21.i = load <2 x i64>, ptr %i.qm, align 1, !tbaa !9
  store <2 x i64> %.val21.i, ptr %i.qn, align 1, !tbaa !9
...
bb.bv:                                            ; preds = %bb.bv, %bb.bu
  ...
  %.1.i241.i.val.i = load <2 x i64>, ptr %.1.i241.i.i, align 1, !tbaa !9
  store <2 x i64> %.1.i241.i.val.i, ptr %.130.i239.i.i, align 1, !tbaa !9
  ...
  %.val20.i = load <2 x i64>, ptr %i.rs, align 1, !tbaa !9
  store <2 x i64> %.val20.i, ptr %i.rr, align 1, !tbaa !9
  %i.rt = getelementptr inbounds nuw i8, ptr %.130.i239.i.i, i64 32 ; 2 uses
  %i.ru = icmp ult ptr %i.rt, %i.qs
  br i1 %i.ru, label %bb.bv, label %ZSTD_execSequenceSplitLitBuffer.exit.i.i, !llvm.loop !98
...
bb.bw:                                            ; preds = %ZSTD_execSequenceSplitLitBuffer.exit.i.i
  ...
  br i1 %.not169.i.i, label %.thread235.i, label %bb.ae, !llvm.loop !130
...
vec.epilog.iter.check168:                         ; preds = %middle.block161
  ...
  br i1 %min.epilog.iters.check169, label %.lr.ph41.i.i.preheader, label %vec.epilog.ph170, !prof !95
...
vec.epilog.vector.body173:                        ; preds = %vec.epilog.vector.body173, %vec.epilog.ph170
  ...
  br i1 %i.tf, label %vec.epilog.middle.block179, label %vec.epilog.vector.body173, !llvm.loop !132
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i
  ...
  %i.ui = load i8, ptr %.23137.i.i, align 1, !tbaa !9
  %i.uj = getelementptr inbounds nuw i8, ptr %.238.i.i, i64 1 ; 2 uses
  store i8 %i.ui, ptr %.238.i.i, align 1, !tbaa !9
  %exitcond.not.i.i = icmp eq ptr %i.uj, %scevgep.i.i
  br i1 %exitcond.not.i.i, label %ZSTD_safecopyDstBeforeSrc.exit.i, label %.lr.ph.i.i, !llvm.loop !136
...
bb.ce:                                            ; preds = %ZSTD_safecopyDstBeforeSrc.exit.i, %.thread391.i
  ...
  %i.ul = getelementptr inbounds nuw i8, ptr %0, i64 30388 ; 3 uses
  store ptr %i.ul, ptr %i.a, align 8, !tbaa !36
  %i.um = getelementptr inbounds nuw i8, ptr %0, i64 95924 ; 5 uses
  %i.un = getelementptr inbounds nuw i8, ptr %0, i64 30384
  store i32 0, ptr %i.un, align 8, !tbaa !33
  ...
  %or.cond.i191.i.i = select i1 %i.ut, i1 true, i1 %i.uw, !prof !102
  br i1 %or.cond.i191.i.i, label %bb.cf, label %.critedge.i192.i.i, !prof !102

.critedge.i192.i.i:                               ; preds = %bb.ce
  %.val15.i = load <2 x i64>, ptr %i.ul, align 4, !tbaa !9
  store <2 x i64> %.val15.i, ptr %.2134.i.i, align 1, !tbaa !9
  %i.ux = icmp samesign ugt i64 %.sroa.083.2.i, 16
  br i1 %i.ux, label %bb.cg, label %ZSTD_wildcopy.exit250.i.i, !prof !50
...
bb.cg:                                            ; preds = %.critedge.i192.i.i
  ...
  %i.va = getelementptr inbounds nuw i8, ptr %0, i64 30404 ; 2 uses
  %.val10.i = load <2 x i64>, ptr %i.va, align 4, !tbaa !9
  store <2 x i64> %.val10.i, ptr %i.uz, align 1, !tbaa !9
...
bb.ci:                                            ; preds = %bb.ci, %bb.ch
  ...
  %.1.i247.i.val.i = load <2 x i64>, ptr %.1.i247.i.i, align 1, !tbaa !9
  store <2 x i64> %.1.i247.i.val.i, ptr %.130.i245.i.i, align 1, !tbaa !9
  ...
  %.val9.i = load <2 x i64>, ptr %i.ve, align 1, !tbaa !9
  store <2 x i64> %.val9.i, ptr %i.vd, align 1, !tbaa !9
  %i.vf = getelementptr inbounds nuw i8, ptr %.130.i245.i.i, i64 32 ; 2 uses
  %i.vg = icmp ult ptr %i.vf, %i.uo
  br i1 %i.vg, label %bb.ci, label %ZSTD_wildcopy.exit250.i.i, !llvm.loop !98

ZSTD_wildcopy.exit250.i.i:                        ; preds = %bb.ci, %bb.cg, %.critedge.i192.i.i
  store ptr %i.uq, ptr %i.a, align 8, !tbaa !36
...
bb.cj:                                            ; preds = %ZSTD_wildcopy.exit250.i.i
  ...
  br i1 %i.vl, label %.loopexit.thread.i, label %bb.ck, !prof !50
...
bb.cm:                                            ; preds = %bb.ck
  ...
  store i64 %i.vp, ptr %.sroa.986.0..sroa_idx87.i, align 8, !tbaa !127
  br label %bb.cn
...
bb.cn:                                            ; preds = %bb.cm, %ZSTD_wildcopy.exit250.i.i
  ...
  br i1 %i.vs, label %bb.co, label %bb.cr, !prof !87

bb.co:                                            ; preds = %bb.cn
  %i.vt = getelementptr inbounds i8, ptr %.0179.i, i64 %i.vr
  %.val12.i = load <2 x i64>, ptr %.0177.i, align 1, !tbaa !9
  store <2 x i64> %.val12.i, ptr %.0179.i, align 1, !tbaa !9
...
bb.cq:                                            ; preds = %bb.cq, %bb.cp
  ...
  %.1.i254.i.val.i = load <2 x i64>, ptr %.1.i254.i.i, align 1, !tbaa !9
  store <2 x i64> %.1.i254.i.val.i, ptr %.130.i252.i.i, align 1, !tbaa !9
  ...
  %.val11.i = load <2 x i64>, ptr %i.vx, align 1, !tbaa !9
  store <2 x i64> %.val11.i, ptr %i.vw, align 1, !tbaa !9
  %i.vy = getelementptr inbounds nuw i8, ptr %.130.i252.i.i, i64 32 ; 2 uses
  %i.vz = icmp ult ptr %i.vy, %i.vt
  br i1 %i.vz, label %bb.cq, label %.loopexit.i, !llvm.loop !98
...
bb.cs:                                            ; preds = %bb.cr
  ...
  %i.wd = load i8, ptr %.0177.i, align 1, !tbaa !9
  store i8 %i.wd, ptr %.0179.i, align 1, !tbaa !9
  ...
  store i8 %i.wl, ptr %i.wm, align 1, !tbaa !9
...
vector.body196:                                   ; preds = %vector.body196, %vector.ph193
  ...
  br i1 %i.xv, label %middle.block203, label %vector.body196, !llvm.loop !137
...
.preheader265.i:                                  ; preds = %.preheader265.i.preheader251, %.preheader265.i
  ...
  br i1 %i.xy, label %.preheader265.i, label %.loopexit.i, !llvm.loop !138

bb.cv:                                            ; preds = %bb.cu
  %.val14.i = load <2 x i64>, ptr %i.wv, align 1, !tbaa !9
  store <2 x i64> %.val14.i, ptr %i.ww, align 1, !tbaa !9
...
bb.cx:                                            ; preds = %bb.cx, %bb.cw
  ...
  %.1.i261.i.val.i = load <2 x i64>, ptr %.1.i261.i.i, align 1, !tbaa !9
  store <2 x i64> %.1.i261.i.val.i, ptr %.130.i259.i.i, align 1, !tbaa !9
  ...
  %.val13.i = load <2 x i64>, ptr %i.yc, align 1, !tbaa !9
  store <2 x i64> %.val13.i, ptr %i.yb, align 1, !tbaa !9
  %i.yd = getelementptr inbounds nuw i8, ptr %.130.i259.i.i, i64 32 ; 2 uses
  %i.ye = icmp ult ptr %i.yd, %i.xb
  br i1 %i.ye, label %bb.cx, label %.loopexit.i, !llvm.loop !98
...
bb.cz:                                            ; preds = %bb.cy
  tail call void asm sideeffect ".p2align 6", "~{dirflag},~{fpsr},~{flags}"() #17, !srcloc !139
  tail call void asm sideeffect "nop", "~{dirflag},~{fpsr},~{flags}"() #17, !srcloc !140
  tail call void asm sideeffect ".p2align 4", "~{dirflag},~{fpsr},~{flags}"() #17, !srcloc !141
...
bb.da:                                            ; preds = %bb.er, %bb.cz
  ...
  %i.yw = load i32, ptr %i.yv, align 4, !tbaa !39, !noalias !144
  %i.yx = zext i32 %i.yw to i64                   ; 2 uses
  %i.yy = getelementptr inbounds nuw i8, ptr %i.ys, i64 4
  %i.yz = load i32, ptr %i.yy, align 4, !tbaa !39, !noalias !144 ; 2 uses
  %i.za = zext i32 %i.yz to i64                   ; 2 uses
  %i.zb = getelementptr inbounds nuw i8, ptr %i.yu, i64 4
  %i.zc = load i32, ptr %i.zb, align 4, !tbaa !39, !noalias !144 ; 2 uses
  %i.zd = getelementptr inbounds nuw i8, ptr %i.ys, i64 2
  %i.ze = load i8, ptr %i.zd, align 2, !tbaa !56, !noalias !144 ; 3 uses
  %i.zf = getelementptr inbounds nuw i8, ptr %i.yt, i64 2
  %i.zg = load i8, ptr %i.zf, align 2, !tbaa !56, !noalias !144 ; 3 uses
  %i.zh = getelementptr inbounds nuw i8, ptr %i.yu, i64 2
  %i.zi = load i8, ptr %i.zh, align 2, !tbaa !56, !noalias !144 ; 4 uses
  %i.zj = zext i8 %i.ze to i32                    ; 2 uses
  %i.zk = zext i8 %i.zg to i32                    ; 2 uses
  %i.zl = add i8 %i.zg, %i.ze
  %i.zm = add i8 %i.zl, %i.zi
  %i.zn = load i16, ptr %i.ys, align 4, !tbaa !55, !noalias !144
  %i.zo = load i16, ptr %i.yt, align 4, !tbaa !55, !noalias !144
  %i.zp = load i16, ptr %i.yu, align 4, !tbaa !55, !noalias !144
  %i.zq = getelementptr inbounds nuw i8, ptr %i.ys, i64 3
  %i.zr = load i8, ptr %i.zq, align 1, !tbaa !54, !noalias !144 ; 2 uses
  %i.zs = zext i8 %i.zr to i32
  %i.zt = getelementptr inbounds nuw i8, ptr %i.yt, i64 3
  %i.zu = load i8, ptr %i.zt, align 1, !tbaa !54, !noalias !144 ; 2 uses
  %i.zv = zext i8 %i.zu to i32
  %i.zw = getelementptr inbounds nuw i8, ptr %i.yu, i64 3
  %i.zx = load i8, ptr %i.zw, align 1, !tbaa !54, !noalias !144 ; 2 uses
...
bb.db:                                            ; preds = %bb.da
  ...
  store i32 %i.aai, ptr %i.cp, align 8, !tbaa !81, !noalias !144
  %i.aaj = zext i32 %i.zc to i64
  %i.aak = add i64 %i.aah, %i.aaj
  store i64 %i.yn, ptr %i.aa, align 8, !tbaa !43, !noalias !144
  br label %bb.dh

bb.dc:                                            ; preds = %bb.da
  %i.aal = icmp eq i32 %i.yz, 0                   ; 3 uses
  %i.aam = icmp eq i8 %i.zi, 0
  br i1 %i.aam, label %bb.dd, label %bb.de, !prof !87
...
bb.de:                                            ; preds = %bb.dc
  ...
  store i32 %i.aaw, ptr %i.cp, align 8, !tbaa !81, !noalias !144
...
bb.df:                                            ; preds = %bb.de
  ...
  %i.abc = load i64, ptr %i.abb, align 8, !tbaa !43, !noalias !144 ; 2 uses
...
begin_hunk_4_@ZSTD_decompressSequencesSplitLitBuffer:bb.a
  ...
  store ptr %i.aeu, ptr %i.cz, align 8, !tbaa !76, !noalias !144
  %i.aev = shl i32 %.021.i220.i.i, 3
  %i.aew = sub i32 %i.adt, %i.aev                 ; 2 uses
  store i32 %i.aew, ptr %i.cp, align 8, !tbaa !81, !noalias !144
  %.val8.i = load i64, ptr %i.aeu, align 1, !tbaa !43 ; 2 uses
  store i64 %.val8.i, ptr %9, align 8, !tbaa !77, !noalias !144
...
ZSTD_decodeSequence.exit.i.i:                     ; preds = %bb.dx, %bb.dw, %bb.dv, %bb.dt, %bb.dr
  ...
  %i.aff = load ptr, ptr %i.a, align 8, !tbaa !36 ; 3 uses
  ...
  %or.cond.i.i.i = select i1 %i.afj, i1 true, i1 %i.afl, !prof !102
  br i1 %or.cond.i.i.i, label %bb.dy, label %.critedge.i.i.i, !prof !102

.critedge.i.i.i:                                  ; preds = %ZSTD_decodeSequence.exit.i.i
  %.val28.i = load <2 x i64>, ptr %i.aff, align 1, !tbaa !9
  store <2 x i64> %.val28.i, ptr %.7139.i292.i, align 1, !tbaa !9
  %i.afm = icmp ugt i64 %.sroa.0.0.i, 16
  br i1 %i.afm, label %bb.dz, label %ZSTD_wildcopy.exit271.i.i, !prof !50
...
bb.dz:                                            ; preds = %.critedge.i.i.i
  ...
  %.val23.i = load <2 x i64>, ptr %i.afp, align 1, !tbaa !9
  store <2 x i64> %.val23.i, ptr %i.afo, align 1, !tbaa !9
...
bb.eb:                                            ; preds = %bb.eb, %bb.ea
  ...
  %.1.i268.i.val.i = load <2 x i64>, ptr %.1.i268.i.i, align 1, !tbaa !9
  store <2 x i64> %.1.i268.i.val.i, ptr %.130.i266.i.i, align 1, !tbaa !9
  ...
  %.val22.i = load <2 x i64>, ptr %i.afu, align 1, !tbaa !9
  store <2 x i64> %.val22.i, ptr %i.aft, align 1, !tbaa !9
  %i.afv = getelementptr inbounds nuw i8, ptr %.130.i266.i.i, i64 32 ; 2 uses
  %i.afw = icmp ult ptr %i.afv, %i.afd
  br i1 %i.afw, label %bb.eb, label %ZSTD_wildcopy.exit271.i.i, !llvm.loop !98

ZSTD_wildcopy.exit271.i.i:                        ; preds = %bb.eb, %bb.dz, %.critedge.i.i.i
  store ptr %i.afg, ptr %i.a, align 8, !tbaa !36
...
bb.ec:                                            ; preds = %ZSTD_wildcopy.exit271.i.i
  ...
  br i1 %i.agb, label %ZSTD_execSequence.exit.i.thread.i, label %bb.ed, !prof !50
...
bb.ef:                                            ; preds = %bb.ed
  ...
  store i64 %i.agf, ptr %.sroa.6.0..sroa_idx.i, align 8, !tbaa !127
  br label %bb.eg
...
bb.eg:                                            ; preds = %bb.ef, %ZSTD_wildcopy.exit271.i.i
  ...
  br i1 %i.agi, label %bb.eh, label %bb.ek, !prof !87

bb.eh:                                            ; preds = %bb.eg
  %i.agj = getelementptr inbounds i8, ptr %.0176.i, i64 %i.agh
  %.val25.i = load <2 x i64>, ptr %.0174.i, align 1, !tbaa !9
  store <2 x i64> %.val25.i, ptr %.0176.i, align 1, !tbaa !9
...
bb.ej:                                            ; preds = %bb.ej, %bb.ei
  ...
  %.1.i275.i.val.i = load <2 x i64>, ptr %.1.i275.i.i, align 1, !tbaa !9
  store <2 x i64> %.1.i275.i.val.i, ptr %.130.i273.i.i, align 1, !tbaa !9
  ...
  %.val24.i = load <2 x i64>, ptr %i.agn, align 1, !tbaa !9
  store <2 x i64> %.val24.i, ptr %i.agm, align 1, !tbaa !9
  %i.ago = getelementptr inbounds nuw i8, ptr %.130.i273.i.i, i64 32 ; 2 uses
  %i.agp = icmp ult ptr %i.ago, %i.agj
  br i1 %i.agp, label %bb.ej, label %ZSTD_execSequence.exit.i.i, !llvm.loop !98
...
bb.el:                                            ; preds = %bb.ek
  ...
  %i.ags = load i32, ptr %i.agr, align 4, !tbaa !3
  %i.agt = load i8, ptr %.0174.i, align 1, !tbaa !9
  store i8 %i.agt, ptr %.0176.i, align 1, !tbaa !9
  ...
  %i.ahb = load i8, ptr %i.aha, align 1, !tbaa !9
  %i.ahc = getelementptr inbounds nuw i8, ptr %.0176.i, i64 3
  store i8 %i.ahb, ptr %i.ahc, align 1, !tbaa !9
...
vector.body220:                                   ; preds = %vector.body220, %vector.ph217
  ...
  br i1 %i.aik, label %middle.block227, label %vector.body220, !llvm.loop !147
...
.preheader262.i:                                  ; preds = %.preheader262.i.preheader234, %.preheader262.i
  ...
  br i1 %i.ain, label %.preheader262.i, label %ZSTD_execSequence.exit.i.i, !llvm.loop !148

bb.eo:                                            ; preds = %bb.en
  %.val27.i = load <2 x i64>, ptr %i.ahl, align 1, !tbaa !9
  store <2 x i64> %.val27.i, ptr %i.ahm, align 1, !tbaa !9
...
bb.eq:                                            ; preds = %bb.eq, %bb.ep
  ...
  %.1.i282.i.val.i = load <2 x i64>, ptr %.1.i282.i.i, align 1, !tbaa !9
  store <2 x i64> %.1.i282.i.val.i, ptr %.130.i280.i.i, align 1, !tbaa !9
  ...
  %.val26.i = load <2 x i64>, ptr %i.air, align 1, !tbaa !9
  store <2 x i64> %.val26.i, ptr %i.aiq, align 1, !tbaa !9
  %i.ais = getelementptr inbounds nuw i8, ptr %.130.i280.i.i, i64 32 ; 2 uses
  %i.ait = icmp ult ptr %i.ais, %i.ahr
  br i1 %i.ait, label %bb.eq, label %ZSTD_execSequence.exit.i.i, !llvm.loop !98
...
bb.er:                                            ; preds = %ZSTD_execSequence.exit.i.i
  ...
  br i1 %.not173.i.i, label %.thread235.i, label %bb.da, !llvm.loop !149
...
.preheader.i:                                     ; preds = %.thread235.i
  ...
  store i32 %i.ajd, ptr %i.p, align 4, !tbaa !3
  %i.aje = trunc i64 %i.aja to i32
  store i32 %i.aje, ptr %i.t, align 8, !tbaa !3
  %i.ajf = trunc i64 %i.aiz to i32
  store i32 %i.ajf, ptr %i.x, align 4, !tbaa !3
  call void @llvm.lifetime.end.p0(ptr nonnull %9) #17
  %.pre.pre.i = load ptr, ptr %i.a, align 8, !tbaa !36
  br label %bb.es
...
bb.es:                                            ; preds = %.preheader.i, %bb.c
  ...
  %i.ajg = getelementptr inbounds nuw i8, ptr %0, i64 30384 ; 2 uses
  %i.ajh = load i32, ptr %i.ajg, align 8, !tbaa !33
...
bb.ew:                                            ; preds = %bb.ev, %bb.eu
  ...
  %i.ajq = getelementptr inbounds nuw i8, ptr %0, i64 30388
  %i.ajr = getelementptr inbounds nuw i8, ptr %0, i64 95924
  store i32 0, ptr %i.ajg, align 8, !tbaa !33
  br label %bb.ex
...
begin_hunk_5_@ZSTD_decompressSequences:bb.a
  ...
  store ptr %i.nr, ptr %i.dg, align 8, !tbaa !76, !noalias !155
  %i.ns = shl i32 %.021.i87.i.i, 3
  %i.nt = sub i32 %i.mq, %i.ns                    ; 2 uses
  store i32 %i.nt, ptr %i.cw, align 8, !tbaa !81, !noalias !155
  %.val6.i = load i64, ptr %i.nr, align 1, !tbaa !43 ; 2 uses
  store i64 %.val6.i, ptr %7, align 8, !tbaa !77, !noalias !155
  br label %ZSTD_decodeSequence.exit.i.i
...
ZSTD_decodeSequence.exit.i.i:                     ; preds = %bb.be, %bb.bd, %bb.bc, %bb.ba, %bb.ay
  ...
  %i.oc = load ptr, ptr %i.a, align 8, !tbaa !36  ; 3 uses
  ...
  %or.cond.i.i.i = select i1 %i.og, i1 true, i1 %i.oi, !prof !102
  br i1 %or.cond.i.i.i, label %bb.bf, label %.critedge.i.i.i, !prof !102

.critedge.i.i.i:                                  ; preds = %ZSTD_decodeSequence.exit.i.i
  %.val13.i = load <2 x i64>, ptr %i.oc, align 1, !tbaa !9
  store <2 x i64> %.val13.i, ptr %.068.i103.i, align 1, !tbaa !9
  %i.oj = icmp ugt i64 %.sroa.0.0.i, 16
  br i1 %i.oj, label %bb.bg, label %ZSTD_wildcopy.exit.i.i, !prof !50
...
bb.bi:                                            ; preds = %bb.bi, %bb.bh
  ...
  br i1 %i.ot, label %bb.bi, label %ZSTD_wildcopy.exit.i.i, !llvm.loop !98

ZSTD_wildcopy.exit.i.i:                           ; preds = %bb.bi, %bb.bg, %.critedge.i.i.i
  store ptr %i.od, ptr %i.a, align 8, !tbaa !36
...
bb.bj:                                            ; preds = %ZSTD_wildcopy.exit.i.i
  ...
  br i1 %i.oy, label %ZSTD_execSequence.exit.i.thread.i, label %bb.bk, !prof !50
...
bb.bm:                                            ; preds = %bb.bk
  ...
  store i64 %i.pc, ptr %.sroa.6.0..sroa_idx.i, align 8, !tbaa !127
  br label %bb.bn
...
bb.bn:                                            ; preds = %bb.bm, %ZSTD_wildcopy.exit.i.i
  ...
  br i1 %i.pf, label %bb.bo, label %bb.br, !prof !87

bb.bo:                                            ; preds = %bb.bn
  %i.pg = getelementptr inbounds i8, ptr %.0.i, i64 %i.pe
  %.val10.i = load <2 x i64>, ptr %.071.i, align 1, !tbaa !9
...
bb.bq:                                            ; preds = %bb.bq, %bb.bp
  ...
  %.val9.i = load <2 x i64>, ptr %i.pk, align 1, !tbaa !9
  store <2 x i64> %.val9.i, ptr %i.pj, align 1, !tbaa !9
  %i.pl = getelementptr inbounds nuw i8, ptr %.130.i97.i.i, i64 32 ; 2 uses
  %i.pm = icmp ult ptr %i.pl, %i.pg
  br i1 %i.pm, label %bb.bq, label %ZSTD_execSequence.exit.i.i, !llvm.loop !98
...
bb.bs:                                            ; preds = %bb.br
  ...
  %i.pq = load i8, ptr %.071.i, align 1, !tbaa !9
  store i8 %i.pq, ptr %.0.i, align 1, !tbaa !9
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.rh, label %middle.block, label %vector.body, !llvm.loop !158
...
.preheader97.i:                                   ; preds = %.preheader97.i.preheader25, %.preheader97.i
  ...
  br i1 %i.rk, label %.preheader97.i, label %ZSTD_execSequence.exit.i.i, !llvm.loop !159

bb.bv:                                            ; preds = %bb.bu
  %.val12.i = load <2 x i64>, ptr %i.qi, align 1, !tbaa !9
  store <2 x i64> %.val12.i, ptr %i.qj, align 1, !tbaa !9
...
bb.bx:                                            ; preds = %bb.bx, %bb.bw
  ...
  %.val11.i = load <2 x i64>, ptr %i.ro, align 1, !tbaa !9
  store <2 x i64> %.val11.i, ptr %i.rn, align 1, !tbaa !9
  %i.rp = getelementptr inbounds nuw i8, ptr %.130.i103.i.i, i64 32 ; 2 uses
  %i.rq = icmp ult ptr %i.rp, %i.qo
  br i1 %i.rq, label %bb.bx, label %ZSTD_execSequence.exit.i.i, !llvm.loop !98
...
bb.by:                                            ; preds = %ZSTD_execSequence.exit.i.i
  ...
  br i1 %.not77.i.i, label %bb.bz, label %bb.ah, !llvm.loop !160
...
.preheader.i:                                     ; preds = %bb.bz
  ...
  store i32 %i.rv, ptr %i.w, align 4, !tbaa !3
  %i.rw = trunc i64 %.sink160.i to i32
  store i32 %i.rw, ptr %i.aa, align 8, !tbaa !3
  %i.rx = trunc i64 %i.kd to i32
  store i32 %i.rx, ptr %i.ae, align 4, !tbaa !3
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #17
...
define void @ZSTD_checkContinuity(ptr nofree noundef captures(none) %0, ptr noundef %1, i64 noundef %2) local_unnamed_addr #0 {
bb.a:
...
bb.b:                                             ; preds = %bb.a
  ...
  store ptr %i.b, ptr %i.e, align 8, !tbaa !72
  ...
  %i.k = getelementptr inbounds nuw i8, ptr %0, i64 29904
  store ptr %i.j, ptr %i.k, align 8, !tbaa !68
  store ptr %1, ptr %i.f, align 8, !tbaa !71
...
bb.b:                                             ; preds = %bb.a
  ...
  store ptr %i.c, ptr %i.f, align 8, !tbaa !72
...
begin_hunk_6_@ZSTD_decompressSequencesSplitLitBuffer_bmi2:bb.a
  ...
  br i1 %i.cw, label %bb.n, label %bb.o, !prof !50

bb.n:                                             ; preds = %bb.m
  store ptr @BIT_reloadDStream.zeroFilled, ptr %i.cx, align 8, !tbaa !76
...
bb.p:                                             ; preds = %bb.o
  ...
  store ptr %i.db, ptr %i.cx, align 8, !tbaa !76
  %i.dc = and i32 %i.co, 7                        ; 2 uses
  store i32 %i.dc, ptr %i.cn, align 8, !tbaa !81
  %.val.i.i = load i64, ptr %i.db, align 1, !tbaa !43 ; 2 uses
  store i64 %.val.i.i, ptr %9, align 8, !tbaa !77
  br label %ZSTD_initFseState.exit
...
bb.r:                                             ; preds = %bb.q
  ...
  store ptr %i.di, ptr %i.cx, align 8, !tbaa !76
  %i.dj = shl i32 %.021.i.i40, 3
  %i.dk = sub i32 %i.co, %i.dj                    ; 2 uses
  store i32 %i.dk, ptr %i.cn, align 8, !tbaa !81
  %.val.i41 = load i64, ptr %i.di, align 1, !tbaa !43 ; 2 uses
  store i64 %.val.i41, ptr %9, align 8, !tbaa !77
  br label %ZSTD_initFseState.exit
...
ZSTD_initFseState.exit:                           ; preds = %bb.n, %bb.p, %bb.q, %bb.r
  ...
  store ptr %i.dp, ptr %i.dq, align 8, !tbaa !82
  ...
  %i.dv = load i32, ptr %i.du, align 4, !tbaa !61 ; 2 uses
  ...
  store i64 %i.ed, ptr %i.dr, align 8, !tbaa !79
  %i.ee = icmp ugt i32 %i.dw, 64
  br i1 %i.ee, label %bb.s, label %bb.t, !prof !50
...
bb.u:                                             ; preds = %bb.t
  ...
  store ptr %i.ei, ptr %i.cx, align 8, !tbaa !76
  %i.ej = and i32 %i.dw, 7
  %.val.i.i44 = load i64, ptr %i.ei, align 1, !tbaa !43 ; 2 uses
  store i64 %.val.i.i44, ptr %9, align 8, !tbaa !77
  br label %ZSTD_initFseState.exit48
...
bb.w:                                             ; preds = %bb.v
  ...
  store ptr %i.ew, ptr %i.cx, align 8, !tbaa !76
  %i.ex = shl i32 %.021.i.i46, 3
  %i.ey = sub i32 %i.dw, %i.ex
  %.val.i47 = load i64, ptr %i.ew, align 1, !tbaa !43 ; 2 uses
  store i64 %.val.i47, ptr %9, align 8, !tbaa !77
  br label %ZSTD_initFseState.exit48
...
ZSTD_initFseState.exit48:                         ; preds = %bb.s, %bb.u, %bb.v, %bb.w
  ...
  store ptr %i.fd, ptr %i.fe, align 8, !tbaa !82
  ...
  %i.fj = load i32, ptr %i.fi, align 4, !tbaa !61 ; 2 uses
  ...
  store i32 %i.fk, ptr %i.cn, align 8, !tbaa !81
  store i64 %i.fr, ptr %i.ff, align 8, !tbaa !79
  %i.fs = icmp ugt i32 %i.fk, 64
  br i1 %i.fs, label %bb.x, label %bb.y, !prof !50
...
bb.z:                                             ; preds = %bb.y
  ...
  store ptr %i.fw, ptr %i.cx, align 8, !tbaa !76
  %i.fx = and i32 %i.fk, 7                        ; 2 uses
  store i32 %i.fx, ptr %i.cn, align 8, !tbaa !81
  %.val.i.i51 = load i64, ptr %i.fw, align 1, !tbaa !43 ; 2 uses
  store i64 %.val.i.i51, ptr %9, align 8, !tbaa !77
  br label %ZSTD_initFseState.exit55
...
bb.ab:                                            ; preds = %bb.aa
  ...
  store ptr %i.gk, ptr %i.cx, align 8, !tbaa !76
  %i.gl = shl i32 %.021.i.i53, 3
  %i.gm = sub i32 %i.fk, %i.gl                    ; 2 uses
  store i32 %i.gm, ptr %i.cn, align 8, !tbaa !81
  %.val.i54 = load i64, ptr %i.gk, align 1, !tbaa !43 ; 2 uses
  store i64 %.val.i54, ptr %9, align 8, !tbaa !77
  br label %ZSTD_initFseState.exit55
...
ZSTD_initFseState.exit55:                         ; preds = %bb.x, %bb.z, %bb.aa, %bb.ab
  ...
  store ptr %i.gq, ptr %i.gr, align 8, !tbaa !82
  tail call void asm sideeffect ".p2align 6", "~{dirflag},~{fpsr},~{flags}"() #17, !srcloc !123
...
bb.ac:                                            ; preds = %ZSTD_initFseState.exit55, %bb.bu
  ...
  %i.hk = load i32, ptr %i.hj, align 4, !tbaa !39, !noalias !215
  %i.hl = zext i32 %i.hk to i64                   ; 2 uses
  %i.hm = getelementptr inbounds nuw i8, ptr %i.hg, i64 4
  %i.hn = load i32, ptr %i.hm, align 4, !tbaa !39, !noalias !215 ; 2 uses
  %i.ho = zext i32 %i.hn to i64                   ; 2 uses
  %i.hp = getelementptr inbounds nuw i8, ptr %i.hi, i64 4
  %i.hq = load i32, ptr %i.hp, align 4, !tbaa !39, !noalias !215 ; 2 uses
  %i.hr = getelementptr inbounds nuw i8, ptr %i.hg, i64 2
  %i.hs = load i8, ptr %i.hr, align 2, !tbaa !56, !noalias !215 ; 3 uses
  %i.ht = getelementptr inbounds nuw i8, ptr %i.hh, i64 2
  %i.hu = load i8, ptr %i.ht, align 2, !tbaa !56, !noalias !215 ; 3 uses
  %i.hv = getelementptr inbounds nuw i8, ptr %i.hi, i64 2
  %i.hw = load i8, ptr %i.hv, align 2, !tbaa !56, !noalias !215 ; 4 uses
  %i.hx = zext i8 %i.hs to i32                    ; 2 uses
  %i.hy = zext i8 %i.hu to i32                    ; 2 uses
  %i.hz = add i8 %i.hu, %i.hs
  %i.ia = add i8 %i.hz, %i.hw
  %i.ib = load i16, ptr %i.hg, align 4, !tbaa !55, !noalias !215
  %i.ic = load i16, ptr %i.hh, align 4, !tbaa !55, !noalias !215
  %i.id = load i16, ptr %i.hi, align 4, !tbaa !55, !noalias !215
  %i.ie = getelementptr inbounds nuw i8, ptr %i.hg, i64 3
  %i.if = load i8, ptr %i.ie, align 1, !tbaa !54, !noalias !215 ; 2 uses
  %i.ig = zext i8 %i.if to i32
  %i.ih = getelementptr inbounds nuw i8, ptr %i.hh, i64 3
  %i.ii = load i8, ptr %i.ih, align 1, !tbaa !54, !noalias !215 ; 2 uses
  %i.ij = zext i8 %i.ii to i32
  %i.ik = getelementptr inbounds nuw i8, ptr %i.hi, i64 3
  %i.il = load i8, ptr %i.ik, align 1, !tbaa !54, !noalias !215 ; 2 uses
...
bb.ad:                                            ; preds = %bb.ac
  ...
  store i32 %i.iw, ptr %i.cn, align 8, !tbaa !81, !noalias !215
  %i.ix = zext i32 %i.hq to i64
  %i.iy = add i64 %i.iv, %i.ix
  store i64 %i.hb, ptr %i.gt, align 8, !tbaa !43, !noalias !215
  br label %bb.aj

bb.ae:                                            ; preds = %bb.ac
  %i.iz = icmp eq i32 %i.hn, 0                    ; 3 uses
  %i.ja = icmp eq i8 %i.hw, 0
  br i1 %i.ja, label %bb.af, label %bb.ag, !prof !87
...
bb.ag:                                            ; preds = %bb.ae
  ...
  store i32 %i.jk, ptr %i.cn, align 8, !tbaa !81, !noalias !215
...
bb.ah:                                            ; preds = %bb.ag
  ...
  %i.jq = load i64, ptr %i.jp, align 8, !tbaa !43, !noalias !215 ; 2 uses
...
bb.aj:                                            ; preds = %bb.ah, %bb.ai, %bb.af, %bb.ad
  ...
  store i64 %.sink470, ptr %i.gs, align 8, !tbaa !43, !noalias !215
  store i64 %.sink, ptr %i.o, align 8, !tbaa !43, !noalias !215
...
bb.ak:                                            ; preds = %bb.aj
  ...
  store i32 %i.kc, ptr %i.cn, align 8, !tbaa !81, !noalias !215
...
bb.al:                                            ; preds = %bb.ak, %bb.aj
  ...
  br i1 %i.kf, label %bb.am, label %BIT_reloadDStream.exit.i, !prof !50

bb.am:                                            ; preds = %bb.al
  %i.kg = icmp ugt i32 %i.ke, 64
  br i1 %i.kg, label %bb.an, label %bb.ao, !prof !50

bb.an:                                            ; preds = %bb.am
  store ptr @BIT_reloadDStream.zeroFilled, ptr %i.cx, align 8, !tbaa !76, !noalias !215
...
bb.ap:                                            ; preds = %bb.ao
  ...
  store ptr %i.kk, ptr %i.cx, align 8, !tbaa !76, !noalias !215
  %i.kl = and i32 %i.ke, 7                        ; 2 uses
  store i32 %i.kl, ptr %i.cn, align 8, !tbaa !81, !noalias !215
  %.val.i61 = load i64, ptr %i.kk, align 1, !tbaa !43, !noalias !215 ; 2 uses
  store i64 %.val.i61, ptr %9, align 8, !tbaa !77, !noalias !215
  br label %BIT_reloadDStream.exit.i
...
bb.ar:                                            ; preds = %bb.aq
  ...
  store ptr %i.kx, ptr %i.cx, align 8, !tbaa !76, !noalias !215
  %i.ky = shl i32 %.021.i.i, 3
  %i.kz = sub i32 %i.ke, %i.ky                    ; 2 uses
  store i32 %i.kz, ptr %i.cn, align 8, !tbaa !81, !noalias !215
  %.val = load i64, ptr %i.kx, align 1, !tbaa !43 ; 2 uses
  store i64 %.val, ptr %9, align 8, !tbaa !77, !noalias !215
  br label %BIT_reloadDStream.exit.i
...
bb.as:                                            ; preds = %BIT_reloadDStream.exit.i
  ...
  store i32 %i.lk, ptr %i.cn, align 8, !tbaa !81, !noalias !215
...
bb.au:                                            ; preds = %bb.at
  ...
  store i64 %i.lw, ptr %i.cj, align 8, !tbaa !79, !noalias !215
  ...
  store i64 %i.mg, ptr %i.ff, align 8, !tbaa !79, !noalias !215
  ...
  store i32 %i.mh, ptr %i.cn, align 8, !tbaa !81, !noalias !215
  %i.mp = zext i16 %i.id to i64
  %i.mq = add nuw i64 %i.mo, %i.mp                ; 3 uses
  store i64 %i.mq, ptr %i.dr, align 8, !tbaa !79, !noalias !215
  %i.mr = icmp ugt i32 %i.mh, 64
  br i1 %i.mr, label %bb.av, label %bb.aw, !prof !50
...
bb.ax:                                            ; preds = %bb.aw
  ...
  store ptr %i.mv, ptr %i.cx, align 8, !tbaa !76, !noalias !215
  %i.mw = and i32 %i.mh, 7                        ; 2 uses
  store i32 %i.mw, ptr %i.cn, align 8, !tbaa !81, !noalias !215
  %.val.i64 = load i64, ptr %i.mv, align 1, !tbaa !43, !noalias !215 ; 2 uses
  store i64 %.val.i64, ptr %9, align 8, !tbaa !77, !noalias !215
  br label %ZSTD_decodeSequence.exit189.i
...
bb.az:                                            ; preds = %bb.ay
  ...
  store ptr %i.ni, ptr %i.cx, align 8, !tbaa !76, !noalias !215
  %i.nj = shl i32 %.021.i206.i, 3
  %i.nk = sub i32 %i.mh, %i.nj                    ; 2 uses
  store i32 %i.nk, ptr %i.cn, align 8, !tbaa !81, !noalias !215
  %.val6 = load i64, ptr %i.ni, align 1, !tbaa !43 ; 2 uses
  store i64 %.val6, ptr %9, align 8, !tbaa !77, !noalias !215
  br label %ZSTD_decodeSequence.exit189.i
...
bb.ba:                                            ; preds = %ZSTD_decodeSequence.exit189.i.thread, %ZSTD_decodeSequence.exit189.i
  ...
  %or.cond.i197.i = select i1 %i.oj, i1 true, i1 %i.ol, !prof !102
  br i1 %or.cond.i197.i, label %bb.bb, label %.critedge.i198.i, !prof !102

.critedge.i198.i:                                 ; preds = %bb.ba
  %.val29 = load <2 x i64>, ptr %i.oa, align 1, !tbaa !9
  store <2 x i64> %.val29, ptr %.0132.i289, align 1, !tbaa !9
  %i.om = icmp ugt i64 %.sroa.080.0, 16
  br i1 %i.om, label %bb.bc, label %ZSTD_wildcopy.exit.i, !prof !50
...
bb.be:                                            ; preds = %bb.be, %bb.bd
  ...
  br i1 %i.ow, label %bb.be, label %ZSTD_wildcopy.exit.i, !llvm.loop !98

ZSTD_wildcopy.exit.i:                             ; preds = %bb.be, %bb.bc, %.critedge.i198.i
  store ptr %i.nz, ptr %i.a, align 8, !tbaa !36
...
bb.bf:                                            ; preds = %ZSTD_wildcopy.exit.i
  ...
  br i1 %i.pb, label %ZSTD_execSequenceSplitLitBuffer.exit.i.thread, label %bb.bg, !prof !50
...
bb.bi:                                            ; preds = %bb.bg
  ...
  store i64 %i.pf, ptr %.sroa.986.0..sroa_idx, align 8, !tbaa !127
  br label %bb.bj
...
bb.bj:                                            ; preds = %bb.bi, %ZSTD_wildcopy.exit.i
  ...
  br i1 %i.pi, label %bb.bk, label %bb.bn, !prof !87

bb.bk:                                            ; preds = %bb.bj
  %i.pj = getelementptr inbounds i8, ptr %.0, i64 %i.ph
  %.val19 = load <2 x i64>, ptr %.0173, align 1, !tbaa !9
...
bb.bm:                                            ; preds = %bb.bm, %bb.bl
  ...
  %.1.i235.i.val = load <2 x i64>, ptr %.1.i235.i, align 1, !tbaa !9
  store <2 x i64> %.1.i235.i.val, ptr %.130.i233.i, align 1, !tbaa !9
  %i.pm = getelementptr inbounds nuw i8, ptr %.130.i233.i, i64 16
  %i.pn = getelementptr inbounds nuw i8, ptr %.pn.i234.i, i64 32 ; 2 uses
  %.val18 = load <2 x i64>, ptr %i.pn, align 1, !tbaa !9
  store <2 x i64> %.val18, ptr %i.pm, align 1, !tbaa !9
  %i.po = getelementptr inbounds nuw i8, ptr %.130.i233.i, i64 32 ; 2 uses
  %i.pp = icmp ult ptr %i.po, %i.pj
  br i1 %i.pp, label %bb.bm, label %ZSTD_execSequenceSplitLitBuffer.exit.i, !llvm.loop !98
...
bb.bo:                                            ; preds = %bb.bn
  ...
  %i.pt = load i8, ptr %.0173, align 1, !tbaa !9
  store i8 %i.pt, ptr %.0, align 1, !tbaa !9
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.rk, label %middle.block, label %vector.body, !llvm.loop !218
...
.preheader269:                                    ; preds = %.preheader269.preheader220, %.preheader269
  ...
  br i1 %i.rn, label %.preheader269, label %ZSTD_execSequenceSplitLitBuffer.exit.i, !llvm.loop !219

bb.br:                                            ; preds = %bb.bq
  %.val21 = load <2 x i64>, ptr %i.ql, align 1, !tbaa !9
  store <2 x i64> %.val21, ptr %i.qm, align 1, !tbaa !9
...
bb.bt:                                            ; preds = %bb.bt, %bb.bs
  ...
  %.1.i241.i.val = load <2 x i64>, ptr %.1.i241.i, align 1, !tbaa !9
  store <2 x i64> %.1.i241.i.val, ptr %.130.i239.i, align 1, !tbaa !9
  %i.rq = getelementptr inbounds nuw i8, ptr %.130.i239.i, i64 16
  %i.rr = getelementptr inbounds nuw i8, ptr %.pn.i240.i, i64 32 ; 2 uses
  %.val20 = load <2 x i64>, ptr %i.rr, align 1, !tbaa !9
  store <2 x i64> %.val20, ptr %i.rq, align 1, !tbaa !9
  %i.rs = getelementptr inbounds nuw i8, ptr %.130.i239.i, i64 32 ; 2 uses
  %i.rt = icmp ult ptr %i.rs, %i.qr
  br i1 %i.rt, label %bb.bt, label %ZSTD_execSequenceSplitLitBuffer.exit.i, !llvm.loop !98
...
bb.bu:                                            ; preds = %ZSTD_execSequenceSplitLitBuffer.exit.i
  ...
  br i1 %.not169.i, label %.thread235, label %bb.ac, !llvm.loop !130
...
vec.epilog.iter.check138:                         ; preds = %middle.block131
  ...
  br i1 %min.epilog.iters.check139, label %.lr.ph41.i.preheader, label %vec.epilog.ph140, !prof !95
...
vec.epilog.vector.body143:                        ; preds = %vec.epilog.vector.body143, %vec.epilog.ph140
  ...
  br i1 %i.te, label %vec.epilog.middle.block149, label %vec.epilog.vector.body143, !llvm.loop !221
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  ...
  %i.uh = load i8, ptr %.23137.i, align 1, !tbaa !9
  %i.ui = getelementptr inbounds nuw i8, ptr %.238.i, i64 1 ; 2 uses
  store i8 %i.uh, ptr %.238.i, align 1, !tbaa !9
  %exitcond.not.i = icmp eq ptr %i.ui, %scevgep.i
  br i1 %exitcond.not.i, label %ZSTD_safecopyDstBeforeSrc.exit, label %.lr.ph.i, !llvm.loop !225
...
bb.cc:                                            ; preds = %ZSTD_safecopyDstBeforeSrc.exit, %.thread391
  ...
  %i.uk = getelementptr inbounds nuw i8, ptr %0, i64 30388 ; 3 uses
  store ptr %i.uk, ptr %i.a, align 8, !tbaa !36
  %i.ul = getelementptr inbounds nuw i8, ptr %0, i64 95924 ; 5 uses
  %i.um = getelementptr inbounds nuw i8, ptr %0, i64 30384
  store i32 0, ptr %i.um, align 8, !tbaa !33
  call void @llvm.lifetime.start.p0(ptr nonnull %7)
  ...
  %or.cond.i191.i = select i1 %i.us, i1 true, i1 %i.uv, !prof !102
  br i1 %or.cond.i191.i, label %bb.cd, label %.critedge.i192.i, !prof !102

.critedge.i192.i:                                 ; preds = %bb.cc
  %.val15 = load <2 x i64>, ptr %i.uk, align 4, !tbaa !9
  store <2 x i64> %.val15, ptr %.2134.i, align 1, !tbaa !9
  %i.uw = icmp samesign ugt i64 %.sroa.083.2, 16
  br i1 %i.uw, label %bb.ce, label %ZSTD_wildcopy.exit250.i, !prof !50
...
bb.ce:                                            ; preds = %.critedge.i192.i
  ...
  %i.uz = getelementptr inbounds nuw i8, ptr %0, i64 30404 ; 2 uses
  %.val10 = load <2 x i64>, ptr %i.uz, align 4, !tbaa !9
  store <2 x i64> %.val10, ptr %i.uy, align 1, !tbaa !9
...
bb.cg:                                            ; preds = %bb.cg, %bb.cf
  ...
  %.1.i247.i.val = load <2 x i64>, ptr %.1.i247.i, align 1, !tbaa !9
  store <2 x i64> %.1.i247.i.val, ptr %.130.i245.i, align 1, !tbaa !9
  %i.vc = getelementptr inbounds nuw i8, ptr %.130.i245.i, i64 16
  %i.vd = getelementptr inbounds nuw i8, ptr %.pn.i246.i, i64 32 ; 2 uses
  %.val9 = load <2 x i64>, ptr %i.vd, align 1, !tbaa !9
  store <2 x i64> %.val9, ptr %i.vc, align 1, !tbaa !9
  %i.ve = getelementptr inbounds nuw i8, ptr %.130.i245.i, i64 32 ; 2 uses
  %i.vf = icmp ult ptr %i.ve, %i.un
  br i1 %i.vf, label %bb.cg, label %ZSTD_wildcopy.exit250.i, !llvm.loop !98

ZSTD_wildcopy.exit250.i:                          ; preds = %bb.cg, %bb.ce, %.critedge.i192.i
  store ptr %i.up, ptr %i.a, align 8, !tbaa !36
...
bb.ch:                                            ; preds = %ZSTD_wildcopy.exit250.i
  ...
  br i1 %i.vk, label %.loopexit.thread, label %bb.ci, !prof !50
...
bb.ck:                                            ; preds = %bb.ci
  ...
  store i64 %i.vo, ptr %.sroa.986.0..sroa_idx87, align 8, !tbaa !127
  br label %bb.cl
...
bb.cl:                                            ; preds = %bb.ck, %ZSTD_wildcopy.exit250.i
  ...
  br i1 %i.vr, label %bb.cm, label %bb.cp, !prof !87

bb.cm:                                            ; preds = %bb.cl
  %i.vs = getelementptr inbounds i8, ptr %.0179, i64 %i.vq
  %.val12 = load <2 x i64>, ptr %.0177, align 1, !tbaa !9
  store <2 x i64> %.val12, ptr %.0179, align 1, !tbaa !9
...
bb.co:                                            ; preds = %bb.co, %bb.cn
  ...
  %.1.i254.i.val = load <2 x i64>, ptr %.1.i254.i, align 1, !tbaa !9
  store <2 x i64> %.1.i254.i.val, ptr %.130.i252.i, align 1, !tbaa !9
  %i.vv = getelementptr inbounds nuw i8, ptr %.130.i252.i, i64 16
  %i.vw = getelementptr inbounds nuw i8, ptr %.pn.i253.i, i64 32 ; 2 uses
  %.val11 = load <2 x i64>, ptr %i.vw, align 1, !tbaa !9
  store <2 x i64> %.val11, ptr %i.vv, align 1, !tbaa !9
  %i.vx = getelementptr inbounds nuw i8, ptr %.130.i252.i, i64 32 ; 2 uses
  %i.vy = icmp ult ptr %i.vx, %i.vs
  br i1 %i.vy, label %bb.co, label %.loopexit, !llvm.loop !98
...
bb.cq:                                            ; preds = %bb.cp
  ...
  %i.wc = load i8, ptr %.0177, align 1, !tbaa !9
  store i8 %i.wc, ptr %.0179, align 1, !tbaa !9
...
vector.body166:                                   ; preds = %vector.body166, %vector.ph163
  ...
  br i1 %i.xu, label %middle.block173, label %vector.body166, !llvm.loop !226
...
.preheader265:                                    ; preds = %.preheader265.preheader216, %.preheader265
  ...
  br i1 %i.xx, label %.preheader265, label %.loopexit, !llvm.loop !227

bb.ct:                                            ; preds = %bb.cs
  %.val14 = load <2 x i64>, ptr %i.wu, align 1, !tbaa !9
  store <2 x i64> %.val14, ptr %i.wv, align 1, !tbaa !9
...
bb.cv:                                            ; preds = %bb.cv, %bb.cu
  ...
  %.1.i261.i.val = load <2 x i64>, ptr %.1.i261.i, align 1, !tbaa !9
  store <2 x i64> %.1.i261.i.val, ptr %.130.i259.i, align 1, !tbaa !9
  %i.ya = getelementptr inbounds nuw i8, ptr %.130.i259.i, i64 16
  %i.yb = getelementptr inbounds nuw i8, ptr %.pn.i260.i, i64 32 ; 2 uses
  %.val13 = load <2 x i64>, ptr %i.yb, align 1, !tbaa !9
  store <2 x i64> %.val13, ptr %i.ya, align 1, !tbaa !9
  %i.yc = getelementptr inbounds nuw i8, ptr %.130.i259.i, i64 32 ; 2 uses
  %i.yd = icmp ult ptr %i.yc, %i.xa
  br i1 %i.yd, label %bb.cv, label %.loopexit, !llvm.loop !98
...
bb.cy:                                            ; preds = %bb.cx, %bb.ep
  ...
  %i.yv = load i32, ptr %i.yu, align 4, !tbaa !39, !noalias !228
  %i.yw = zext i32 %i.yv to i64                   ; 2 uses
  %i.yx = getelementptr inbounds nuw i8, ptr %i.yr, i64 4
  %i.yy = load i32, ptr %i.yx, align 4, !tbaa !39, !noalias !228 ; 2 uses
  %i.yz = zext i32 %i.yy to i64                   ; 2 uses
  %i.za = getelementptr inbounds nuw i8, ptr %i.yt, i64 4
  %i.zb = load i32, ptr %i.za, align 4, !tbaa !39, !noalias !228 ; 2 uses
  %i.zc = getelementptr inbounds nuw i8, ptr %i.yr, i64 2
  %i.zd = load i8, ptr %i.zc, align 2, !tbaa !56, !noalias !228 ; 3 uses
  %i.ze = getelementptr inbounds nuw i8, ptr %i.ys, i64 2
  %i.zf = load i8, ptr %i.ze, align 2, !tbaa !56, !noalias !228 ; 3 uses
  %i.zg = getelementptr inbounds nuw i8, ptr %i.yt, i64 2
  %i.zh = load i8, ptr %i.zg, align 2, !tbaa !56, !noalias !228 ; 4 uses
  %i.zi = zext i8 %i.zd to i32                    ; 2 uses
  %i.zj = zext i8 %i.zf to i32                    ; 2 uses
  %i.zk = add i8 %i.zf, %i.zd
  %i.zl = add i8 %i.zk, %i.zh
  %i.zm = load i16, ptr %i.yr, align 4, !tbaa !55, !noalias !228
  %i.zn = load i16, ptr %i.ys, align 4, !tbaa !55, !noalias !228
  %i.zo = load i16, ptr %i.yt, align 4, !tbaa !55, !noalias !228
  %i.zp = getelementptr inbounds nuw i8, ptr %i.yr, i64 3
  %i.zq = load i8, ptr %i.zp, align 1, !tbaa !54, !noalias !228 ; 2 uses
  %i.zr = zext i8 %i.zq to i32
  %i.zs = getelementptr inbounds nuw i8, ptr %i.ys, i64 3
  %i.zt = load i8, ptr %i.zs, align 1, !tbaa !54, !noalias !228 ; 2 uses
  %i.zu = zext i8 %i.zt to i32
  %i.zv = getelementptr inbounds nuw i8, ptr %i.yt, i64 3
  %i.zw = load i8, ptr %i.zv, align 1, !tbaa !54, !noalias !228 ; 2 uses
...
bb.cz:                                            ; preds = %bb.cy
  ...
  store i32 %i.aah, ptr %i.cn, align 8, !tbaa !81, !noalias !228
  %i.aai = zext i32 %i.zb to i64
  %i.aaj = add i64 %i.aag, %i.aai
  store i64 %i.ym, ptr %i.gt, align 8, !tbaa !43, !noalias !228
  br label %bb.df

bb.da:                                            ; preds = %bb.cy
  %i.aak = icmp eq i32 %i.yy, 0                   ; 3 uses
  %i.aal = icmp eq i8 %i.zh, 0
  br i1 %i.aal, label %bb.db, label %bb.dc, !prof !87
...
bb.dc:                                            ; preds = %bb.da
  ...
  store i32 %i.aav, ptr %i.cn, align 8, !tbaa !81, !noalias !228
...
bb.dd:                                            ; preds = %bb.dc
  ...
  %i.abb = load i64, ptr %i.aba, align 8, !tbaa !43, !noalias !228 ; 2 uses
...
bb.df:                                            ; preds = %bb.dd, %bb.de, %bb.db, %bb.cz
  ...
  store i64 %.sink472, ptr %i.gs, align 8, !tbaa !43, !noalias !228
  store i64 %.sink471, ptr %i.o, align 8, !tbaa !43, !noalias !228
...
bb.dg:                                            ; preds = %bb.df
  ...
  store i32 %i.abn, ptr %i.cn, align 8, !tbaa !81, !noalias !228
...
bb.dh:                                            ; preds = %bb.dg, %bb.df
  ...
  br i1 %i.abq, label %bb.di, label %BIT_reloadDStream.exit217.i, !prof !50

bb.di:                                            ; preds = %bb.dh
  %i.abr = icmp ugt i32 %i.abp, 64
  br i1 %i.abr, label %bb.dj, label %bb.dk, !prof !50

bb.dj:                                            ; preds = %bb.di
  store ptr @BIT_reloadDStream.zeroFilled, ptr %i.cx, align 8, !tbaa !76, !noalias !228
...
bb.dl:                                            ; preds = %bb.dk
  ...
  store ptr %i.abv, ptr %i.cx, align 8, !tbaa !76, !noalias !228
  %i.abw = and i32 %i.abp, 7                      ; 2 uses
  store i32 %i.abw, ptr %i.cn, align 8, !tbaa !81, !noalias !228
  %.val.i76 = load i64, ptr %i.abv, align 1, !tbaa !43, !noalias !228 ; 2 uses
  store i64 %.val.i76, ptr %9, align 8, !tbaa !77, !noalias !228
  br label %BIT_reloadDStream.exit217.i
...
bb.dn:                                            ; preds = %bb.dm
  ...
  store ptr %i.aci, ptr %i.cx, align 8, !tbaa !76, !noalias !228
  %i.acj = shl i32 %.021.i213.i, 3
  %i.ack = sub i32 %i.abp, %i.acj                 ; 2 uses
  store i32 %i.ack, ptr %i.cn, align 8, !tbaa !81, !noalias !228
  %.val7 = load i64, ptr %i.aci, align 1, !tbaa !43 ; 2 uses
  store i64 %.val7, ptr %9, align 8, !tbaa !77, !noalias !228
  br label %BIT_reloadDStream.exit217.i
...
bb.do:                                            ; preds = %BIT_reloadDStream.exit217.i
  ...
  store i32 %i.acv, ptr %i.cn, align 8, !tbaa !81, !noalias !228
...
bb.dq:                                            ; preds = %bb.dp
  ...
  store i64 %i.adh, ptr %i.cj, align 8, !tbaa !79, !noalias !228
  ...
  store i64 %i.adr, ptr %i.ff, align 8, !tbaa !79, !noalias !228
  ...
  store i32 %i.ads, ptr %i.cn, align 8, !tbaa !81, !noalias !228
  %i.aea = zext i16 %i.zo to i64
  %i.aeb = add nuw i64 %i.adz, %i.aea             ; 5 uses
  store i64 %i.aeb, ptr %i.dr, align 8, !tbaa !79, !noalias !228
  %i.aec = icmp ugt i32 %i.ads, 64
  br i1 %i.aec, label %bb.dr, label %bb.ds, !prof !50
...
bb.dt:                                            ; preds = %bb.ds
  ...
  store ptr %i.aeg, ptr %i.cx, align 8, !tbaa !76, !noalias !228
  %i.aeh = and i32 %i.ads, 7                      ; 2 uses
  store i32 %i.aeh, ptr %i.cn, align 8, !tbaa !81, !noalias !228
  %.val.i79 = load i64, ptr %i.aeg, align 1, !tbaa !43, !noalias !228 ; 2 uses
  store i64 %.val.i79, ptr %9, align 8, !tbaa !77, !noalias !228
  br label %ZSTD_decodeSequence.exit.i
...
bb.dv:                                            ; preds = %bb.du
  ...
  store ptr %i.aet, ptr %i.cx, align 8, !tbaa !76, !noalias !228
  %i.aeu = shl i32 %.021.i220.i, 3
  %i.aev = sub i32 %i.ads, %i.aeu                 ; 2 uses
  store i32 %i.aev, ptr %i.cn, align 8, !tbaa !81, !noalias !228
  %.val8 = load i64, ptr %i.aet, align 1, !tbaa !43 ; 2 uses
  store i64 %.val8, ptr %9, align 8, !tbaa !77, !noalias !228
  br label %ZSTD_decodeSequence.exit.i
...
ZSTD_decodeSequence.exit.i:                       ; preds = %bb.du, %bb.dr, %bb.dt, %bb.dv, %bb.dp
  ...
  %i.afe = load ptr, ptr %i.a, align 8, !tbaa !36 ; 3 uses
  ...
  %or.cond.i.i = select i1 %i.afi, i1 true, i1 %i.afk, !prof !102
  br i1 %or.cond.i.i, label %bb.dw, label %.critedge.i.i, !prof !102

.critedge.i.i:                                    ; preds = %ZSTD_decodeSequence.exit.i
  %.val28 = load <2 x i64>, ptr %i.afe, align 1, !tbaa !9
  store <2 x i64> %.val28, ptr %.7139.i292, align 1, !tbaa !9
  %i.afl = icmp ugt i64 %.sroa.0.0, 16
  br i1 %i.afl, label %bb.dx, label %ZSTD_wildcopy.exit271.i, !prof !50
...
bb.dx:                                            ; preds = %.critedge.i.i
  ...
  %.val23 = load <2 x i64>, ptr %i.afo, align 1, !tbaa !9
  store <2 x i64> %.val23, ptr %i.afn, align 1, !tbaa !9
...
bb.dz:                                            ; preds = %bb.dz, %bb.dy
  ...
  %.1.i268.i.val = load <2 x i64>, ptr %.1.i268.i, align 1, !tbaa !9
  store <2 x i64> %.1.i268.i.val, ptr %.130.i266.i, align 1, !tbaa !9
  %i.afs = getelementptr inbounds nuw i8, ptr %.130.i266.i, i64 16
  %i.aft = getelementptr inbounds nuw i8, ptr %.pn.i267.i, i64 32 ; 2 uses
  %.val22 = load <2 x i64>, ptr %i.aft, align 1, !tbaa !9
  store <2 x i64> %.val22, ptr %i.afs, align 1, !tbaa !9
  %i.afu = getelementptr inbounds nuw i8, ptr %.130.i266.i, i64 32 ; 2 uses
  %i.afv = icmp ult ptr %i.afu, %i.afc
  br i1 %i.afv, label %bb.dz, label %ZSTD_wildcopy.exit271.i, !llvm.loop !98

ZSTD_wildcopy.exit271.i:                          ; preds = %bb.dz, %bb.dx, %.critedge.i.i
  store ptr %i.aff, ptr %i.a, align 8, !tbaa !36
...
bb.ea:                                            ; preds = %ZSTD_wildcopy.exit271.i
  ...
  br i1 %i.aga, label %ZSTD_execSequence.exit.i.thread, label %bb.eb, !prof !50
...
bb.ed:                                            ; preds = %bb.eb
  ...
  store i64 %i.age, ptr %.sroa.6.0..sroa_idx, align 8, !tbaa !127
  br label %bb.ee
...
bb.ee:                                            ; preds = %bb.ed, %ZSTD_wildcopy.exit271.i
  ...
  br i1 %i.agh, label %bb.ef, label %bb.ei, !prof !87

bb.ef:                                            ; preds = %bb.ee
  %i.agi = getelementptr inbounds i8, ptr %.0176, i64 %i.agg
  %.val25 = load <2 x i64>, ptr %.0174, align 1, !tbaa !9
  store <2 x i64> %.val25, ptr %.0176, align 1, !tbaa !9
...
bb.eh:                                            ; preds = %bb.eh, %bb.eg
  ...
  %.1.i275.i.val = load <2 x i64>, ptr %.1.i275.i, align 1, !tbaa !9
  store <2 x i64> %.1.i275.i.val, ptr %.130.i273.i, align 1, !tbaa !9
  %i.agl = getelementptr inbounds nuw i8, ptr %.130.i273.i, i64 16
  %i.agm = getelementptr inbounds nuw i8, ptr %.pn.i274.i, i64 32 ; 2 uses
  %.val24 = load <2 x i64>, ptr %i.agm, align 1, !tbaa !9
  store <2 x i64> %.val24, ptr %i.agl, align 1, !tbaa !9
  %i.agn = getelementptr inbounds nuw i8, ptr %.130.i273.i, i64 32 ; 2 uses
  %i.ago = icmp ult ptr %i.agn, %i.agi
  br i1 %i.ago, label %bb.eh, label %ZSTD_execSequence.exit.i, !llvm.loop !98
...
bb.ej:                                            ; preds = %bb.ei
  ...
  %i.ags = load i8, ptr %.0174, align 1, !tbaa !9
  store i8 %i.ags, ptr %.0176, align 1, !tbaa !9
  ...
  %i.aha = load i8, ptr %i.agz, align 1, !tbaa !9
  %i.ahb = getelementptr inbounds nuw i8, ptr %.0176, i64 3
  store i8 %i.aha, ptr %i.ahb, align 1, !tbaa !9
...
vector.body190:                                   ; preds = %vector.body190, %vector.ph187
  ...
  br i1 %i.aij, label %middle.block197, label %vector.body190, !llvm.loop !231
...
.preheader262:                                    ; preds = %.preheader262.preheader205, %.preheader262
  ...
  br i1 %i.aim, label %.preheader262, label %ZSTD_execSequence.exit.i, !llvm.loop !232

bb.em:                                            ; preds = %bb.el
  %.val27 = load <2 x i64>, ptr %i.ahk, align 1, !tbaa !9
  store <2 x i64> %.val27, ptr %i.ahl, align 1, !tbaa !9
...
bb.eo:                                            ; preds = %bb.eo, %bb.en
  ...
  %.1.i282.i.val = load <2 x i64>, ptr %.1.i282.i, align 1, !tbaa !9
  store <2 x i64> %.1.i282.i.val, ptr %.130.i280.i, align 1, !tbaa !9
  %i.aip = getelementptr inbounds nuw i8, ptr %.130.i280.i, i64 16
  %i.aiq = getelementptr inbounds nuw i8, ptr %.pn.i281.i, i64 32 ; 2 uses
  %.val26 = load <2 x i64>, ptr %i.aiq, align 1, !tbaa !9
  store <2 x i64> %.val26, ptr %i.aip, align 1, !tbaa !9
  %i.air = getelementptr inbounds nuw i8, ptr %.130.i280.i, i64 32 ; 2 uses
  %i.ais = icmp ult ptr %i.air, %i.ahq
  br i1 %i.ais, label %bb.eo, label %ZSTD_execSequence.exit.i, !llvm.loop !98
...
bb.ep:                                            ; preds = %ZSTD_execSequence.exit.i
  ...
  br i1 %.not173.i, label %.thread235, label %bb.cy, !llvm.loop !149
...
.preheader:                                       ; preds = %.thread235
  ...
  store i32 %i.ajc, ptr %i.n, align 4, !tbaa !3
  %i.ajd = trunc i64 %i.aiz to i32
  store i32 %i.ajd, ptr %i.r, align 8, !tbaa !3
  %i.aje = trunc i64 %i.aiy to i32
  store i32 %i.aje, ptr %i.v, align 4, !tbaa !3
  call void @llvm.lifetime.end.p0(ptr nonnull %9) #17
  %.pre.pre = load ptr, ptr %i.a, align 8, !tbaa !36
  br label %bb.eq
...
bb.eq:                                            ; preds = %.preheader, %bb.a
  ...
  %i.ajf = getelementptr inbounds nuw i8, ptr %0, i64 30384 ; 2 uses
  %i.ajg = load i32, ptr %i.ajf, align 8, !tbaa !33
...
bb.eu:                                            ; preds = %bb.es, %bb.et
  ...
  %i.ajp = getelementptr inbounds nuw i8, ptr %0, i64 30388
  %i.ajq = getelementptr inbounds nuw i8, ptr %0, i64 95924
  store i32 0, ptr %i.ajf, align 8, !tbaa !33
  br label %bb.ev
...
bb.a:
  ...
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 30384
...
bb.s:                                             ; preds = %bb.r
  ...
  %i.dh = sub nsw i64 0, %i.dg
  %i.di = getelementptr inbounds i8, ptr %.ptr, i64 %i.dh ; 4 uses
  store ptr %i.di, ptr %i.de, align 8, !tbaa !76
  %i.dj = and i32 %i.cv, 7                        ; 2 uses
  store i32 %i.dj, ptr %i.cu, align 8, !tbaa !81
  %.val.i.i = load i64, ptr %i.di, align 1, !tbaa !43 ; 2 uses
  store i64 %.val.i.i, ptr %7, align 8, !tbaa !77
  br label %ZSTD_initFseState.exit
...
bb.u:                                             ; preds = %bb.t
  ...
  store ptr %i.dp, ptr %i.de, align 8, !tbaa !76
  %i.dq = shl i32 %.021.i.i20, 3
  %i.dr = sub i32 %i.cv, %i.dq                    ; 2 uses
  store i32 %i.dr, ptr %i.cu, align 8, !tbaa !81
  %.val.i21 = load i64, ptr %i.dp, align 1, !tbaa !43 ; 2 uses
  store i64 %.val.i21, ptr %7, align 8, !tbaa !77
  br label %ZSTD_initFseState.exit
...
ZSTD_initFseState.exit:                           ; preds = %bb.q, %bb.s, %bb.t, %bb.u
  ...
  store i64 %i.ek, ptr %i.dy, align 8, !tbaa !79
  %i.el = icmp ugt i32 %i.ed, 64
  br i1 %i.el, label %bb.v, label %bb.w, !prof !50

bb.v:                                             ; preds = %ZSTD_initFseState.exit
  store ptr @BIT_reloadDStream.zeroFilled, ptr %i.de, align 8, !tbaa !76
...
bb.x:                                             ; preds = %bb.w
  ...
  store ptr %i.ep, ptr %i.de, align 8, !tbaa !76
  %i.eq = and i32 %i.ed, 7
  %.val.i.i24 = load i64, ptr %i.ep, align 1, !tbaa !43 ; 2 uses
  store i64 %.val.i.i24, ptr %7, align 8, !tbaa !77
  br label %ZSTD_initFseState.exit28
...
bb.z:                                             ; preds = %bb.y
  ...
  store ptr %i.fd, ptr %i.de, align 8, !tbaa !76
  %i.fe = shl i32 %.021.i.i26, 3
  %i.ff = sub i32 %i.ed, %i.fe
  %.val.i27 = load i64, ptr %i.fd, align 1, !tbaa !43 ; 2 uses
  store i64 %.val.i27, ptr %7, align 8, !tbaa !77
  br label %ZSTD_initFseState.exit28
...
ZSTD_initFseState.exit28:                         ; preds = %bb.v, %bb.x, %bb.y, %bb.z
  ...
  store i32 %i.fr, ptr %i.cu, align 8, !tbaa !81
  store i64 %i.fy, ptr %i.fm, align 8, !tbaa !79
  %i.fz = icmp ugt i32 %i.fr, 64
  br i1 %i.fz, label %bb.aa, label %bb.ab, !prof !50
...
bb.ac:                                            ; preds = %bb.ab
  ...
  store ptr %i.gd, ptr %i.de, align 8, !tbaa !76
  %i.ge = and i32 %i.fr, 7                        ; 2 uses
  store i32 %i.ge, ptr %i.cu, align 8, !tbaa !81
  %.val.i.i31 = load i64, ptr %i.gd, align 1, !tbaa !43 ; 2 uses
  store i64 %.val.i.i31, ptr %7, align 8, !tbaa !77
  br label %ZSTD_initFseState.exit35
...
bb.ae:                                            ; preds = %bb.ad
  ...
  store ptr %i.gr, ptr %i.de, align 8, !tbaa !76
  %i.gs = shl i32 %.021.i.i33, 3
  %i.gt = sub i32 %i.fr, %i.gs                    ; 2 uses
  store i32 %i.gt, ptr %i.cu, align 8, !tbaa !81
  %.val.i34 = load i64, ptr %i.gr, align 1, !tbaa !43 ; 2 uses
  store i64 %.val.i34, ptr %7, align 8, !tbaa !77
  br label %ZSTD_initFseState.exit35
...
ZSTD_initFseState.exit35:                         ; preds = %bb.aa, %bb.ac, %bb.ad, %bb.ae
  ...
  store ptr %i.gx, ptr %i.gy, align 8, !tbaa !82
  tail call void asm sideeffect ".p2align 6", "~{dirflag},~{fpsr},~{flags}"() #17, !srcloc !150
  tail call void asm sideeffect "nop", "~{dirflag},~{fpsr},~{flags}"() #17, !srcloc !151
  tail call void asm sideeffect ".p2align 4", "~{dirflag},~{fpsr},~{flags}"() #17, !srcloc !152
  tail call void asm sideeffect "nop", "~{dirflag},~{fpsr},~{flags}"() #17, !srcloc !153
  tail call void asm sideeffect ".p2align 3", "~{dirflag},~{fpsr},~{flags}"() #17, !srcloc !154
...
bb.af:                                            ; preds = %ZSTD_initFseState.exit35, %bb.bw
  ...
  %i.hs = load i32, ptr %i.hr, align 4, !tbaa !39, !noalias !233
  %i.ht = zext i32 %i.hs to i64                   ; 2 uses
  %i.hu = getelementptr inbounds nuw i8, ptr %i.ho, i64 4
  %i.hv = load i32, ptr %i.hu, align 4, !tbaa !39, !noalias !233 ; 2 uses
  %i.hw = zext i32 %i.hv to i64                   ; 2 uses
  %i.hx = getelementptr inbounds nuw i8, ptr %i.hq, i64 4
  %i.hy = load i32, ptr %i.hx, align 4, !tbaa !39, !noalias !233 ; 2 uses
  %i.hz = getelementptr inbounds nuw i8, ptr %i.ho, i64 2
  %i.ia = load i8, ptr %i.hz, align 2, !tbaa !56, !noalias !233 ; 3 uses
  %i.ib = getelementptr inbounds nuw i8, ptr %i.hp, i64 2
  %i.ic = load i8, ptr %i.ib, align 2, !tbaa !56, !noalias !233 ; 3 uses
  %i.id = getelementptr inbounds nuw i8, ptr %i.hq, i64 2
  %i.ie = load i8, ptr %i.id, align 2, !tbaa !56, !noalias !233 ; 4 uses
  %i.if = zext i8 %i.ia to i32                    ; 2 uses
  %i.ig = zext i8 %i.ic to i32                    ; 2 uses
  %i.ih = add i8 %i.ic, %i.ia
  %i.ii = add i8 %i.ih, %i.ie
  %i.ij = load i16, ptr %i.ho, align 4, !tbaa !55, !noalias !233
  %i.ik = load i16, ptr %i.hp, align 4, !tbaa !55, !noalias !233
  %i.il = load i16, ptr %i.hq, align 4, !tbaa !55, !noalias !233
  %i.im = getelementptr inbounds nuw i8, ptr %i.ho, i64 3
  %i.in = load i8, ptr %i.im, align 1, !tbaa !54, !noalias !233 ; 2 uses
  %i.io = zext i8 %i.in to i32
  %i.ip = getelementptr inbounds nuw i8, ptr %i.hp, i64 3
  %i.iq = load i8, ptr %i.ip, align 1, !tbaa !54, !noalias !233 ; 2 uses
  %i.ir = zext i8 %i.iq to i32
  %i.is = getelementptr inbounds nuw i8, ptr %i.hq, i64 3
  %i.it = load i8, ptr %i.is, align 1, !tbaa !54, !noalias !233 ; 2 uses
...
bb.ag:                                            ; preds = %bb.af
  ...
  store i32 %i.je, ptr %i.cu, align 8, !tbaa !81, !noalias !233
  %i.jf = zext i32 %i.hy to i64
  %i.jg = add i64 %i.jd, %i.jf
  store i64 %i.hj, ptr %i.hb, align 8, !tbaa !43, !noalias !233
  br label %bb.am

bb.ah:                                            ; preds = %bb.af
  %i.jh = icmp eq i32 %i.hv, 0                    ; 3 uses
  %i.ji = icmp eq i8 %i.ie, 0
  br i1 %i.ji, label %bb.ai, label %bb.aj, !prof !87
...
bb.aj:                                            ; preds = %bb.ah
  ...
  store i32 %i.js, ptr %i.cu, align 8, !tbaa !81, !noalias !233
...
bb.ak:                                            ; preds = %bb.aj
  ...
  %i.jy = load i64, ptr %i.jx, align 8, !tbaa !43, !noalias !233 ; 2 uses
...
bb.am:                                            ; preds = %bb.ak, %bb.al, %bb.ai, %bb.ag
  ...
  store i64 %.sink160, ptr %i.ha, align 8, !tbaa !43, !noalias !233
  store i64 %.sink, ptr %i.v, align 8, !tbaa !43, !noalias !233
...
bb.an:                                            ; preds = %bb.am
  ...
  store i32 %i.kk, ptr %i.cu, align 8, !tbaa !81, !noalias !233
...
bb.ao:                                            ; preds = %bb.an, %bb.am
  ...
  br i1 %i.kn, label %bb.ap, label %BIT_reloadDStream.exit.i, !prof !50

bb.ap:                                            ; preds = %bb.ao
  %i.ko = icmp ugt i32 %i.km, 64
  br i1 %i.ko, label %bb.aq, label %bb.ar, !prof !50

bb.aq:                                            ; preds = %bb.ap
  store ptr @BIT_reloadDStream.zeroFilled, ptr %i.de, align 8, !tbaa !76, !noalias !233
  br label %BIT_reloadDStream.exit.i
...
bb.as:                                            ; preds = %bb.ar
  ...
  store ptr %i.ks, ptr %i.de, align 8, !tbaa !76, !noalias !233
  %i.kt = and i32 %i.km, 7                        ; 2 uses
  store i32 %i.kt, ptr %i.cu, align 8, !tbaa !81, !noalias !233
  %.val.i41 = load i64, ptr %i.ks, align 1, !tbaa !43, !noalias !233 ; 2 uses
  store i64 %.val.i41, ptr %7, align 8, !tbaa !77, !noalias !233
  br label %BIT_reloadDStream.exit.i
...
bb.au:                                            ; preds = %bb.at
  ...
  store ptr %i.lf, ptr %i.de, align 8, !tbaa !76, !noalias !233
  %i.lg = shl i32 %.021.i.i, 3
  %i.lh = sub i32 %i.km, %i.lg                    ; 2 uses
  store i32 %i.lh, ptr %i.cu, align 8, !tbaa !81, !noalias !233
  %.val = load i64, ptr %i.lf, align 1, !tbaa !43 ; 2 uses
  store i64 %.val, ptr %7, align 8, !tbaa !77, !noalias !233
  br label %BIT_reloadDStream.exit.i
...
bb.av:                                            ; preds = %BIT_reloadDStream.exit.i
  ...
  store i32 %i.ls, ptr %i.cu, align 8, !tbaa !81, !noalias !233
...
bb.ax:                                            ; preds = %bb.aw
  ...
  store i64 %i.me, ptr %i.cq, align 8, !tbaa !79, !noalias !233
  ...
  store i64 %i.mo, ptr %i.fm, align 8, !tbaa !79, !noalias !233
  ...
  store i32 %i.mp, ptr %i.cu, align 8, !tbaa !81, !noalias !233
  %i.mx = zext i16 %i.il to i64
  %i.my = add nuw i64 %i.mw, %i.mx                ; 5 uses
  store i64 %i.my, ptr %i.dy, align 8, !tbaa !79, !noalias !233
  %i.mz = icmp ugt i32 %i.mp, 64
  br i1 %i.mz, label %bb.ay, label %bb.az, !prof !50
...
bb.ba:                                            ; preds = %bb.az
  ...
  store ptr %i.nd, ptr %i.de, align 8, !tbaa !76, !noalias !233
  %i.ne = and i32 %i.mp, 7                        ; 2 uses
  store i32 %i.ne, ptr %i.cu, align 8, !tbaa !81, !noalias !233
  %.val.i44 = load i64, ptr %i.nd, align 1, !tbaa !43, !noalias !233 ; 2 uses
  store i64 %.val.i44, ptr %7, align 8, !tbaa !77, !noalias !233
  br label %ZSTD_decodeSequence.exit.i
...
bb.bc:                                            ; preds = %bb.bb
  ...
  store ptr %i.nq, ptr %i.de, align 8, !tbaa !76, !noalias !233
  %i.nr = shl i32 %.021.i87.i, 3
  %i.ns = sub i32 %i.mp, %i.nr                    ; 2 uses
  store i32 %i.ns, ptr %i.cu, align 8, !tbaa !81, !noalias !233
  %.val6 = load i64, ptr %i.nq, align 1, !tbaa !43 ; 2 uses
  store i64 %.val6, ptr %7, align 8, !tbaa !77, !noalias !233
  br label %ZSTD_decodeSequence.exit.i
...
ZSTD_decodeSequence.exit.i:                       ; preds = %bb.bb, %bb.ay, %bb.ba, %bb.bc, %bb.aw
  ...
  %i.ob = load ptr, ptr %i.a, align 8, !tbaa !36  ; 3 uses
  ...
  %or.cond.i.i = select i1 %i.of, i1 true, i1 %i.oh, !prof !102
  br i1 %or.cond.i.i, label %bb.bd, label %.critedge.i.i, !prof !102

.critedge.i.i:                                    ; preds = %ZSTD_decodeSequence.exit.i
  %.val13 = load <2 x i64>, ptr %i.ob, align 1, !tbaa !9
  store <2 x i64> %.val13, ptr %.068.i103, align 1, !tbaa !9
  %i.oi = icmp ugt i64 %.sroa.0.0, 16
  br i1 %i.oi, label %bb.be, label %ZSTD_wildcopy.exit.i, !prof !50
...
bb.bg:                                            ; preds = %bb.bg, %bb.bf
  ...
  br i1 %i.os, label %bb.bg, label %ZSTD_wildcopy.exit.i, !llvm.loop !98

ZSTD_wildcopy.exit.i:                             ; preds = %bb.bg, %bb.be, %.critedge.i.i
  store ptr %i.oc, ptr %i.a, align 8, !tbaa !36
...
bb.bh:                                            ; preds = %ZSTD_wildcopy.exit.i
  ...
  br i1 %i.ox, label %ZSTD_execSequence.exit.i.thread, label %bb.bi, !prof !50
...
bb.bk:                                            ; preds = %bb.bi
  ...
  store i64 %i.pb, ptr %.sroa.6.0..sroa_idx, align 8, !tbaa !127
  br label %bb.bl
...
bb.bl:                                            ; preds = %bb.bk, %ZSTD_wildcopy.exit.i
  ...
  br i1 %i.pe, label %bb.bm, label %bb.bp, !prof !87

bb.bm:                                            ; preds = %bb.bl
  %i.pf = getelementptr inbounds i8, ptr %.0, i64 %i.pd
  %.val10 = load <2 x i64>, ptr %.071, align 1, !tbaa !9
...
bb.bo:                                            ; preds = %bb.bo, %bb.bn
  ...
  %.val9 = load <2 x i64>, ptr %i.pj, align 1, !tbaa !9
  store <2 x i64> %.val9, ptr %i.pi, align 1, !tbaa !9
  %i.pk = getelementptr inbounds nuw i8, ptr %.130.i97.i, i64 32 ; 2 uses
  %i.pl = icmp ult ptr %i.pk, %i.pf
  br i1 %i.pl, label %bb.bo, label %ZSTD_execSequence.exit.i, !llvm.loop !98
...
bb.bq:                                            ; preds = %bb.bp
  ...
  %i.pp = load i8, ptr %.071, align 1, !tbaa !9
  store i8 %i.pp, ptr %.0, align 1, !tbaa !9
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.rg, label %middle.block, label %vector.body, !llvm.loop !236
...
.preheader97:                                     ; preds = %.preheader97.preheader19, %.preheader97
  ...
  br i1 %i.rj, label %.preheader97, label %ZSTD_execSequence.exit.i, !llvm.loop !237

bb.bt:                                            ; preds = %bb.bs
  %.val12 = load <2 x i64>, ptr %i.qh, align 1, !tbaa !9
  store <2 x i64> %.val12, ptr %i.qi, align 1, !tbaa !9
...
bb.bv:                                            ; preds = %bb.bv, %bb.bu
  ...
  %.val11 = load <2 x i64>, ptr %i.rn, align 1, !tbaa !9
  store <2 x i64> %.val11, ptr %i.rm, align 1, !tbaa !9
  %i.ro = getelementptr inbounds nuw i8, ptr %.130.i103.i, i64 32 ; 2 uses
  %i.rp = icmp ult ptr %i.ro, %i.qn
  br i1 %i.rp, label %bb.bv, label %ZSTD_execSequence.exit.i, !llvm.loop !98
...
.preheader:                                       ; preds = %bb.bx
  ...
  store i32 %i.ru, ptr %i.u, align 4, !tbaa !3
  %i.rv = trunc i64 %.sink160 to i32
  store i32 %i.rv, ptr %i.y, align 8, !tbaa !3
  %i.rw = trunc i64 %i.kc to i32
  store i32 %i.rw, ptr %i.ac, align 4, !tbaa !3
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #17
