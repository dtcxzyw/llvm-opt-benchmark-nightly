...
.lr.ph37:                                         ; preds = %iter.check, %.lr.ph37
  %indvars.iv45 = phi i64 [ %i.bz, %iter.check ], [ %indvars.iv.next46, %.lr.ph37 ] ; 2 uses
  %indvars.iv.next46 = add nsw i64 %indvars.iv45, -1 ; 2 uses
  %i.cb = sub nsw i64 6, %indvars.iv45            ; 2 uses
  %i.cc = icmp slt i64 %i.cb, %i.ca
  br i1 %i.cc, label %.lr.ph37, label %._crit_edge.loopexit, !llvm.loop !23
...
.lr.ph.i:                                         ; preds = %.lr.ph.i, %.lr.ph.i.preheader.new
  ...
  br i1 %niter93.ncmp.1, label %_ZN14arrow_vendored17double_conversion13StringBuilder10AddPaddingEci.exit.loopexit.unr-lcssa, label %.lr.ph.i, !llvm.loop !24
...
.lr.ph.i49:                                       ; preds = %.lr.ph.i49, %.lr.ph.i49.preheader.new
  ...
  br i1 %niter98.ncmp.1, label %_ZN14arrow_vendored17double_conversion13StringBuilder10AddPaddingEci.exit52.thread.loopexit.unr-lcssa, label %.lr.ph.i49, !llvm.loop !24
...
.lr.ph.i53:                                       ; preds = %.lr.ph.i53, %.lr.ph.i53.preheader.new
  ...
  br i1 %niter.ncmp.1, label %_ZN14arrow_vendored17double_conversion13StringBuilder10AddPaddingEci.exit56.loopexit.unr-lcssa, label %.lr.ph.i53, !llvm.loop !24
...
bb.f:                                             ; preds = %bb.f, %.lr.ph.i57.new
  ...
  br i1 %niter83.ncmp.1, label %_ZN14arrow_vendored17double_conversion13StringBuilder10AddPaddingEci.exit52.thread.loopexit77.unr-lcssa, label %bb.f, !llvm.loop !24
...
.lr.ph.i61:                                       ; preds = %.lr.ph.i61, %.lr.ph.i61.preheader.new
  ...
  br i1 %niter88.ncmp.1, label %_ZN14arrow_vendored17double_conversion13StringBuilder10AddPaddingEci.exit52.loopexit.unr-lcssa, label %.lr.ph.i61, !llvm.loop !24
...
bb.g:                                             ; preds = %bb.a
  ...
  %i.ae = load i8, ptr %i.b, align 1, !tbaa !25, !range !27, !noundef !28
...
bb.a:
  ...
  store i8 %.sink, ptr %5, align 1, !tbaa !25
  %i.b = icmp eq i32 %1, 3
  %i.c = icmp eq i32 %2, 0
...
.lr.ph:                                           ; preds = %.lr.ph78
  ...
  br i1 %i.by, label %.lr.ph78, label %.lr.ph..critedge.loopexit.split.loop.exit70_crit_edge, !llvm.loop !33
...
.lr.ph78:                                         ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  br i1 %i.ca, label %.lr.ph, label %.critedge.loopexit, !llvm.loop !33
