...
bb.a:
  ...
  %3 = alloca %"class.std::function.301", align 8 ; 9 uses
  %.sroa.0.i.i.i = alloca { i64, i64 }, align 8   ; 4 uses
  %4 = alloca %"class.std::function.297", align 8 ; 9 uses
...
bb.g:                                             ; preds = %bb.f
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %4, ptr noundef nonnull align 8 dereferenceable(32) %1, i64 16, i1 false), !tbaa.struct !3196
...
_ZNSt8functionIFPSt10shared_ptrIN5folly21CPUThreadPoolExecutorEEvEEC2EOS6_.exit.i: ; preds = %bb.g, %bb.f
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.0.i.i.i, ptr noundef nonnull align 8 dereferenceable(32) %4, i64 16, i1 false), !tbaa.struct !3196
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %4, ptr noundef nonnull align 8 dereferenceable(32) %i.i, i64 16, i1 false), !tbaa.struct !3196
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.i, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.0.i.i.i, i64 16, i1 false), !tbaa.struct !3196
  ...
  store <2 x ptr> %i.o, ptr %i.m, align 8, !tbaa !181
...
bb.j:                                             ; preds = %_ZNSt8functionIFPSt10shared_ptrIN5folly21CPUThreadPoolExecutorEEvEEaSEOS6_.exit
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %3, ptr noundef nonnull align 8 dereferenceable(32) %2, i64 16, i1 false), !tbaa.struct !3196
...
_ZNSt8functionIFvPSt10shared_ptrIN5folly21CPUThreadPoolExecutorEEEEC2EOS6_.exit.i: ; preds = %bb.j, %_ZNSt8functionIFPSt10shared_ptrIN5folly21CPUThreadPoolExecutorEEvEEaSEOS6_.exit
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.0.i.i.i3, ptr noundef nonnull align 8 dereferenceable(32) %3, i64 16, i1 false), !tbaa.struct !3196
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %3, ptr noundef nonnull align 8 dereferenceable(32) %i.t, i64 16, i1 false), !tbaa.struct !3196
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.t, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.0.i.i.i3, i64 16, i1 false), !tbaa.struct !3196
  ...
  store <2 x ptr> %i.z, ptr %i.x, align 8, !tbaa !181
...
bb.a:
  %.sroa.0.i.i.i3 = alloca { i64, i64 }, align 8  ; 4 uses
  %3 = alloca %"class.std::function.431", align 8 ; 9 uses
  %.sroa.0.i.i.i = alloca { i64, i64 }, align 8   ; 4 uses
  %4 = alloca %"class.std::function.427", align 8 ; 9 uses
  %5 = alloca %"class.folly::detail::TypeDescriptor", align 16 ; 4 uses
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 32 ; 3 uses
  %i.b = tail call noundef i32 @pthread_mutex_lock(ptr noundef nonnull align 8 dereferenceable(40) %i.a) #26 ; 2 uses
end_hunk_5
...
bb.a:
  %.sroa.0.i.i.i.i.i56 = alloca { i64, i64 }, align 8 ; 4 uses
  %0 = alloca %"class.std::function.508", align 8 ; 11 uses
  %1 = alloca %"class.std::function.508", align 8 ; 10 uses
  %.sroa.0.i.i.i.i.i = alloca { i64, i64 }, align 8 ; 4 uses
  %2 = alloca %"class.std::function.489", align 8 ; 11 uses
...
begin_hunk_11_@_GLOBAL__sub_I_GlobalExecutor.cpp:bb.a
  ...
  %.sroa.0.i.i.i3.i.i.i = alloca { i64, i64 }, align 8 ; 4 uses
  %14 = alloca %"class.std::function.0", align 8  ; 9 uses
  %.sroa.0.i.i.i.i.i.i = alloca { i64, i64 }, align 8 ; 4 uses
  %15 = alloca %"class.std::function", align 8    ; 9 uses
...
bb.j:                                             ; preds = %bb.i
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %15, ptr noundef nonnull align 8 dereferenceable(32) %17, i64 16, i1 false), !tbaa.struct !3196
...
_ZNSt8functionIFPSt10shared_ptrIN12_GLOBAL__N_118DefaultCPUExecutorEEvEEC2EOS6_.exit.i.i.i.i: ; preds = %bb.j, %bb.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.0.i.i.i.i.i.i, ptr noundef nonnull align 8 dereferenceable(32) %15, i64 16, i1 false), !tbaa.struct !3196
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %15, ptr noundef nonnull align 8 dereferenceable(32) %i.aa, i64 16, i1 false), !tbaa.struct !3196
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.aa, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.0.i.i.i.i.i.i, i64 16, i1 false), !tbaa.struct !3196
  ...
  store <2 x ptr> %i.af, ptr %i.ad, align 8, !tbaa !181
...
bb.m:                                             ; preds = %_ZNSt8functionIFPSt10shared_ptrIN12_GLOBAL__N_118DefaultCPUExecutorEEvEEaSEOS6_.exit.i.i.i
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %14, ptr noundef nonnull align 8 dereferenceable(32) %18, i64 16, i1 false), !tbaa.struct !3196
...
_ZNSt8functionIFvPSt10shared_ptrIN12_GLOBAL__N_118DefaultCPUExecutorEEEEC2EOS6_.exit.i.i.i.i: ; preds = %bb.m, %_ZNSt8functionIFPSt10shared_ptrIN12_GLOBAL__N_118DefaultCPUExecutorEEvEEaSEOS6_.exit.i.i.i
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.0.i.i.i3.i.i.i)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.0.i.i.i3.i.i.i, ptr noundef nonnull align 8 dereferenceable(32) %14, i64 16, i1 false), !tbaa.struct !3196
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %14, ptr noundef nonnull align 8 dereferenceable(32) %i.ak, i64 16, i1 false), !tbaa.struct !3196
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.ak, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.0.i.i.i3.i.i.i, i64 16, i1 false), !tbaa.struct !3196
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.0.i.i.i3.i.i.i)
  ...
  store <2 x ptr> %i.ao, ptr %i.am, align 8, !tbaa !181
...
bb.cx:                                            ; preds = %bb.cv
  %i.ig = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.ih = load ptr, ptr %i.id, align 8, !tbaa !256 ; 2 uses
...
_ZNSt8functionIFPN12_GLOBAL__N_114GlobalExecutorIN5folly8ExecutorEEEvEEC2ERKS7_.exit.i.i.i: ; preds = %bb.cw, %bb.cu
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.0.i.i.i.i.i, ptr noundef nonnull align 8 dereferenceable(32) %2, i64 16, i1 false), !tbaa.struct !3196
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %2, ptr noundef nonnull align 8 dereferenceable(32) %i.ic, i64 16, i1 false), !tbaa.struct !3196
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.ic, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.0.i.i.i.i.i, i64 16, i1 false), !tbaa.struct !3196
  ...
  store <2 x ptr> %i.in, ptr %i.id, align 8, !tbaa !181
...
bb.dn:                                            ; preds = %bb.dl
  %i.jn = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.jo = load ptr, ptr %i.jk, align 8, !tbaa !256 ; 2 uses
...
_ZNSt8functionIFPN12_GLOBAL__N_114GlobalExecutorIN5folly10IOExecutorEEEvEEC2ERKS7_.exit.i.i.i: ; preds = %bb.dm, %bb.dk
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.0.i.i.i.i.i56, ptr noundef nonnull align 8 dereferenceable(32) %0, i64 16, i1 false), !tbaa.struct !3196
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %0, ptr noundef nonnull align 8 dereferenceable(32) %i.jj, i64 16, i1 false), !tbaa.struct !3196
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.jj, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.0.i.i.i.i.i56, i64 16, i1 false), !tbaa.struct !3196
  ...
  store <2 x ptr> %i.ju, ptr %i.jk, align 8, !tbaa !181
