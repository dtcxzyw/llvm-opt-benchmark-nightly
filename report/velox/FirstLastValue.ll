begin_hunk_0
  ...
  %invariant.op183 = sub i32 1, %.sroa.016.0.extract.trunc.i
...
begin_hunk_1
  ...
  %reass.sub60 = sub nsw i32 %i.fd, %.sroa.016.0.extract.trunc.i
  %i.fg = add i32 %i.ff, %invariant.op183
...
begin_hunk_2
  ...
  %i.fh = call noundef zeroext i1 @_ZN8facebook5velox4bits16testWordsReverseIZNS1_11findLastBitEPKmiibEUlimE_ZNS1_11findLastBitES4_iibEUliE_EEbiiT_T0_(i32 noundef %reass.sub60, i32 noundef %i.fg, ptr noundef nonnull byval(%class.anon.202) align 8 %16, ptr noundef nonnull byval(%class.anon.204) align 8 %17) ; 0 uses
...
begin_hunk_3
  ...
  %invariant.op182 = sub i32 1, %.sroa.016.0.extract.trunc.i
...
begin_hunk_4
  ...
  %reass.sub59 = sub nsw i32 %i.gs, %.sroa.016.0.extract.trunc.i
  %i.gv = add i32 %i.gu, %invariant.op182
...
begin_hunk_5
  ...
  %i.gw = call noundef zeroext i1 @_ZN8facebook5velox4bits16testWordsReverseIZNS1_11findLastBitEPKmiibEUlimE_ZNS1_11findLastBitES4_iibEUliE_EEbiiT_T0_(i32 noundef %reass.sub59, i32 noundef %i.gv, ptr noundef nonnull byval(%class.anon.202) align 8 %14, ptr noundef nonnull byval(%class.anon.204) align 8 %15) ; 0 uses
...
begin_hunk_6
  ...
  %invariant.op = sub i32 1, %.sroa.016.0.extract.trunc.i
...
begin_hunk_7
  ...
  %reass.sub = sub nsw i32 %i.hz, %.sroa.016.0.extract.trunc.i
  %i.ic = add i32 %i.ib, %invariant.op
...
begin_hunk_8
  ...
  %i.id = call noundef zeroext i1 @_ZN8facebook5velox4bits16testWordsReverseIZNS1_11findLastBitEPKmiibEUlimE_ZNS1_11findLastBitES4_iibEUliE_EEbiiT_T0_(i32 noundef %reass.sub, i32 noundef %i.ic, ptr noundef nonnull byval(%class.anon.202) align 8 %12, ptr noundef nonnull byval(%class.anon.204) align 8 %13) ; 0 uses
...
begin_hunk_9
  ...
  %invariant.op179 = sub i32 1, %.sroa.016.0.extract.trunc.i
  %invariant.op180 = sub i32 1, %.sroa.016.0.extract.trunc.i
  br label %bb.w
...
begin_hunk_10
  ...
  %reass.sub57 = sub nsw i32 %i.jc, %.sroa.016.0.extract.trunc.i
  %i.jf = add i32 %i.je, %invariant.op179
...
begin_hunk_11
  ...
  %i.jg = call noundef zeroext i1 @_ZN8facebook5velox4bits16testWordsReverseIZNS1_11findLastBitEPKmiibEUlimE_ZNS1_11findLastBitES4_iibEUliE_EEbiiT_T0_(i32 noundef %reass.sub57, i32 noundef %i.jf, ptr noundef nonnull byval(%class.anon.202) align 8 %10, ptr noundef nonnull byval(%class.anon.204) align 8 %11) ; 0 uses
...
begin_hunk_12
  ...
  %reass.sub56.i = sub nsw i32 %i.jt, %.sroa.016.0.extract.trunc.i ; 6 uses
  %i.jw = add i32 %i.jv, %invariant.op180         ; 9 uses
  %.not.i51.i.i.i.i.i = icmp slt i32 %reass.sub56.i, %i.jw
...
bb.z:                                             ; preds = %bb.y
  %i.jx = add i32 %reass.sub56.i, 63              ; 2 uses
...
begin_hunk_13
  ...
  %i.kg = sub nsw i32 %i.jz, %reass.sub56.i       ; 2 uses
...
.critedge.i.i.i.i.i.i:                            ; preds = %_ZZN8facebook5velox4bits11findLastBitEPKmiibENKUliE_clEi.exit.i.i.i.i.i.i
  %.not37.i.i.i.i.i.i = icmp eq i32 %reass.sub56.i, %i.jz
...
bb.ag:                                            ; preds = %.critedge.i.i.i.i.i.i
  %i.lp = sdiv i32 %reass.sub56.i, 64             ; 2 uses
  %i.lq = sub nsw i32 %i.jz, %reass.sub56.i       ; 2 uses
...
begin_hunk_15
  ...
  %invariant.op181 = sub i32 1, %.sroa.016.0.extract.trunc.i
...
begin_hunk_16
  ...
  %reass.sub58 = sub nsw i32 %i.nd, %.sroa.016.0.extract.trunc.i
  %i.ng = add i32 %i.nf, %invariant.op181
...
begin_hunk_17
  ...
  %i.nh = call noundef zeroext i1 @_ZN8facebook5velox4bits16testWordsReverseIZNS1_11findLastBitEPKmiibEUlimE_ZNS1_11findLastBitES4_iibEUliE_EEbiiT_T0_(i32 noundef %reass.sub58, i32 noundef %i.ng, ptr noundef nonnull byval(%class.anon.202) align 8 %8, ptr noundef nonnull byval(%class.anon.204) align 8 %9) ; 0 uses
