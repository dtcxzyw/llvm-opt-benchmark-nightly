...
define void @_ZN5folly23tryGetShutdownSocketSetEv(ptr dead_on_unwind noalias writable writeonly sret(%"class.std::shared_ptr") align 8 captures(none) initializes((8, 16)) %0) local_unnamed_addr #2 personality ptr @__gxx_personality_v0 {
bb.a:
...
begin_hunk_3_@_ZN5folly23tryGetShutdownSocketSetEv:bb.a
  ...
  br i1 %i.ak, label %_ZNKSt14__shared_countILN9__gnu_cxx12_Lock_policyE2EE16_M_get_use_countEv.exit.i.i.i.i.i.i, label %bb.h, !llvm.loop !8868
...
_ZNKSt14__shared_countILN9__gnu_cxx12_Lock_policyE2EE16_M_get_use_countEv.exit.i.i.i.i.i.i: ; preds = %bb.i
  %i.am = load atomic i32, ptr %i.ag monotonic, align 8, !noalias !8867
