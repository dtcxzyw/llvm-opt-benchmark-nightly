Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/velox/original/numbers?download=true
inline.NumInlined: 377
inline.NumDeleted: 169
begin_hunk_0_@_ZN4absl12lts_2024011616numbers_internal23FastIntToBufferBackwardEiPcj:bb.a
  %i.c = xor i64 %i.b, -1
  %i.d = getelementptr inbounds i8, ptr %1, i64 %i.c
  store i8 45, ptr %i.d, align 1, !tbaa !14
...
bb.a:
  ...
  br i1 %i.a, label %._crit_edge.i, label %.lr.ph.i, !prof !16
...
bb.c:                                             ; preds = %.lr.ph.i
  ...
  br i1 %i.g, label %bb.d, label %bb.e, !prof !17
...
bb.e:                                             ; preds = %bb.c
  ...
  br i1 %i.l, label %._crit_edge.i, label %.lr.ph.i, !prof !18, !llvm.loop !2
...
bb.a:
  ...
  br i1 %i.c, label %._crit_edge.i, label %.lr.ph.i, !prof !16
...
bb.e:                                             ; preds = %bb.c
  ...
  br i1 %i.n, label %._crit_edge.i, label %.lr.ph.i, !prof !18, !llvm.loop !2
...
bb.f:                                             ; preds = %_ZN4absl12lts_2024011616numbers_internal12Base10DigitsImEENSt9enable_ifIXsr3std11is_unsignedIT_EE5valueEjE4typeES4_j.exit
  ...
  store i8 45, ptr %i.r, align 1, !tbaa !14
...
bb.e:                                             ; preds = %bb.c
  ...
  %i.ab = mul nuw nsw i32 %i.z, 5243
  %i.ac = lshr i32 %i.ab, 19                      ; 2 uses
  ...
  %2 = zext i32 %i.af to i64
  %3 = mul nuw nsw i64 %2, 103
  %4 = lshr i64 %3, 10
  %5 = trunc nuw nsw i64 %4 to i32
  %i.ag = and i32 %5, 983055                      ; 2 uses
  %narrow.neg15.i.i.i.i.i = mul i32 %i.ag, 16777206
  %i.ah = add i32 %narrow.neg15.i.i.i.i.i, %i.af
  %i.ai = shl i32 %i.ah, 8
  %i.aj = or disjoint i32 %i.ag, 808464432
  %i.ak = add i32 %i.aj, %i.ai
  %i.al = getelementptr inbounds i8, ptr %1, i64 -4 ; 2 uses
  store i32 %i.ak, ptr %i.al, align 1
  br label %bb.f

bb.f:                                             ; preds = %bb.e, %bb.d
  %.112.i = phi i32 [ %i.aa, %bb.e ], [ %i.e, %bb.d ] ; 3 uses
  %.1.i = phi ptr [ %i.al, %bb.e ], [ %i.y, %bb.d ] ; 2 uses
  %i.am = icmp samesign ugt i32 %.112.i, 9
...
bb.g:                                             ; preds = %bb.f, %bb.b
  ...
  %i.an = urem i16 %.lhs.trunc.i, 100
  %.zext.i = zext nneg i16 %i.an to i32           ; 2 uses
  %i.ao = udiv i16 %.lhs.trunc.i, 100
  %.zext17.i = zext nneg i16 %i.ao to i32
  %narrow.i.i.i = mul nuw nsw i32 %.zext.i, 103
  %i.ap = lshr i32 %narrow.i.i.i, 10              ; 2 uses
  %.neg.i.i.i = mul nuw nsw i32 %i.ap, 246
  %i.aq = add nuw nsw i32 %.neg.i.i.i, %.zext.i
  %i.ar = trunc i32 %i.aq to i8
  %i.as = add i8 %i.ar, 48
  %i.at = getelementptr inbounds i8, ptr %.2.i, i64 -1
  store i8 %i.as, ptr %i.at, align 1, !tbaa !14
  %i.au = trunc nuw nsw i32 %i.ap to i8
  %i.av = or disjoint i8 %i.au, 48
  %i.aw = getelementptr inbounds i8, ptr %.2.i, i64 -2 ; 2 uses
  store i8 %i.av, ptr %i.aw, align 1, !tbaa !14
  br label %bb.h

bb.h:                                             ; preds = %bb.g, %bb.f
  %.314.i = phi i32 [ %.zext17.i, %bb.g ], [ %.112.i, %bb.f ] ; 2 uses
  %.3.i = phi ptr [ %i.aw, %bb.g ], [ %.1.i, %bb.f ] ; 2 uses
...
bb.i:                                             ; preds = %bb.h, %bb.a
  ...
  %i.ax = trunc nuw nsw i32 %.415.i to i8
  %i.ay = add nuw nsw i8 %i.ax, 48
  %i.az = getelementptr inbounds i8, ptr %.4.i, i64 -1 ; 2 uses
...
_ZN4absl12lts_2024011612_GLOBAL__N_125FastUIntToStringConverterIjPcE23FastIntToBufferBackwardEjS3_.exit: ; preds = %bb.h, %bb.i
  %.5.i = phi ptr [ %i.az, %bb.i ], [ %.3.i, %bb.h ]
  ret ptr %.5.i
}
...
bb.f:                                             ; preds = %bb.e, %bb.d
  ...
  %i.ak = mul nuw nsw i64 %i.aj, 5243
  %i.al = lshr i64 %i.ak, 19
...
bb.g:                                             ; preds = %bb.f, %bb.c
  ...
  %i.bb = mul nuw nsw i32 %i.az, 5243
  %i.bc = lshr i32 %i.bb, 19                      ; 2 uses
  ...
  %4 = lshr i64 %3, 10
  %5 = trunc nuw nsw i64 %4 to i32
  %i.bg = and i32 %5, 983055                      ; 2 uses
  %narrow.neg15.i.i.i.i.i = mul i32 %i.bg, 16777206
  %i.bh = add i32 %narrow.neg15.i.i.i.i.i, %i.bf
  %i.bi = shl i32 %i.bh, 8
  %i.bj = or disjoint i32 %i.bg, 808464432
  %i.bk = add i32 %i.bj, %i.bi
  %i.bl = getelementptr inbounds i8, ptr %.1.i, i64 -4 ; 2 uses
  store i32 %i.bk, ptr %i.bl, align 1
  br label %bb.h

bb.h:                                             ; preds = %bb.g, %bb.f
  %.217.i = phi i64 [ %.zext26.i, %bb.g ], [ %i.ac, %bb.f ] ; 3 uses
  %.2.i = phi ptr [ %i.bl, %bb.g ], [ %i.ax, %bb.f ] ; 2 uses
  %i.bm = icmp samesign ugt i64 %.217.i, 9
...
bb.i:                                             ; preds = %bb.h, %bb.b
  ...
  %i.bn = urem i16 %.lhs.trunc.i, 100
  %.zext.i = zext nneg i16 %i.bn to i64           ; 2 uses
  %i.bo = udiv i16 %.lhs.trunc.i, 100
  %.zext22.i = zext nneg i16 %i.bo to i64
  %i.bp = mul nuw nsw i64 %.zext.i, 103
  %i.bq = lshr i64 %i.bp, 10                      ; 2 uses
  %.neg.i.i.i = mul nuw nsw i64 %i.bq, 246
  %i.br = add nuw nsw i64 %.neg.i.i.i, %.zext.i
  %i.bs = trunc i64 %i.br to i8
  %i.bt = add i8 %i.bs, 48
  %i.bu = getelementptr inbounds i8, ptr %.3.i, i64 -1
  store i8 %i.bt, ptr %i.bu, align 1, !tbaa !14
  %i.bv = trunc nuw nsw i64 %i.bq to i8
  %i.bw = or disjoint i8 %i.bv, 48
  %i.bx = getelementptr inbounds i8, ptr %.3.i, i64 -2 ; 2 uses
  store i8 %i.bw, ptr %i.bx, align 1, !tbaa !14
  br label %bb.j

bb.j:                                             ; preds = %bb.i, %bb.h
  %.419.i = phi i64 [ %.zext22.i, %bb.i ], [ %.217.i, %bb.h ] ; 2 uses
  %.4.i = phi ptr [ %i.bx, %bb.i ], [ %.2.i, %bb.h ] ; 2 uses
...
bb.k:                                             ; preds = %bb.j, %bb.a
  ...
  %i.by = trunc nuw nsw i64 %.520.i to i8
  %i.bz = add nuw nsw i8 %i.by, 48
  %i.ca = getelementptr inbounds i8, ptr %.5.i, i64 -1 ; 2 uses
  store i8 %i.bz, ptr %i.ca, align 1, !tbaa !14
...
_ZN4absl12lts_2024011612_GLOBAL__N_125FastUIntToStringConverterImPcE23FastIntToBufferBackwardEmS3_.exit: ; preds = %bb.j, %bb.k
  %.6.i = phi ptr [ %i.ca, %bb.k ], [ %.4.i, %bb.j ]
  ret ptr %.6.i
}
...
bb.a:
  ...
  %.1.i.i = select i1 %i.b, i32 %i.d, i32 3, !prof !17
  %.lobit.i = ashr i8 %0, 7
...
bb.a:
  ...
  %.1.i.i = select i1 %i.a, i32 %i.c, i32 3, !prof !17
  ret i32 %.1.i.i
}
...
bb.c:                                             ; preds = %bb.a
  ...
  br i1 %i.e, label %bb.d, label %_ZN4absl12lts_2024011612_GLOBAL__N_136GetNumDigitsOrNegativeIfNegativeImplIsEENSt9enable_ifIXsr3std11is_integralIT_EE5valueEiE4typeES4_.exit, !prof !17
...
bb.c:                                             ; preds = %bb.a
  ...
  br i1 %i.d, label %bb.d, label %_ZN4absl12lts_2024011612_GLOBAL__N_136GetNumDigitsOrNegativeIfNegativeImplItEENSt9enable_ifIXsr3std11is_integralIT_EE5valueEiE4typeES4_.exit, !prof !17
...
bb.a:
  ...
  br i1 %i.b, label %._crit_edge.i.i, label %.lr.ph.i.i, !prof !16
...
.lr.ph.i.i:                                       ; preds = %bb.a, %bb.e
  ...
  br i1 %i.e, label %bb.b, label %bb.c, !prof !17
...
bb.c:                                             ; preds = %.lr.ph.i.i
  ...
  br i1 %i.h, label %bb.d, label %bb.e, !prof !17
...
bb.e:                                             ; preds = %bb.c
  ...
  br i1 %i.m, label %._crit_edge.i.i, label %.lr.ph.i.i, !prof !18, !llvm.loop !1
...
bb.a:
  ...
  br i1 %i.a, label %._crit_edge.i.i, label %.lr.ph.i.i, !prof !16

._crit_edge.i.i:                                  ; preds = %bb.e, %bb.a
  %.013.lcssa.i.i = phi i32 [ %0, %bb.a ], [ %i.k, %bb.e ]
  %.0.lcssa.i.i = phi i32 [ 1, %bb.a ], [ %i.j, %bb.e ]
  %i.b = icmp samesign ugt i32 %.013.lcssa.i.i, 9
  %i.c = zext i1 %i.b to i32
  br label %_ZN4absl12lts_2024011612_GLOBAL__N_136GetNumDigitsOrNegativeIfNegativeImplIjEENSt9enable_ifIXsr3std11is_integralIT_EE5valueEiE4typeES4_.exit
