...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %7 = and i64 %index, 288230376151711728         ; 2 uses
  %i.at = getelementptr inbounds nuw [8 x i8], ptr %i.ag, i64 %7 ; 5 uses
  ...
  %i.ax = getelementptr inbounds nuw [8 x i8], ptr %i.ai, i64 %7 ; 4 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %8 = and i64 %index88, 288230376151711740       ; 2 uses
  %i.bi = getelementptr inbounds nuw [8 x i8], ptr %i.ag, i64 %8 ; 2 uses
  %wide.load89 = load <4 x i64>, ptr %i.bi, align 8, !tbaa !31, !alias.scope !79, !noalias !82
  %i.bj = getelementptr inbounds nuw [8 x i8], ptr %i.ai, i64 %8
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.n = shl i64 %index, 3
  %1 = and i64 %i.n, 2305843009213693824
  %i.o = getelementptr inbounds nuw i8, ptr %i.b, i64 %1 ; 4 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.aj = shl i64 %index19, 3
  %2 = and i64 %i.aj, 2305843009213693920
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.q = shl i64 %index, 3
  %3 = and i64 %i.q, 2305843009213693824
  %i.r = getelementptr inbounds nuw i8, ptr %i.e, i64 %3 ; 4 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.am = shl i64 %index45, 3
  %4 = and i64 %i.am, 2305843009213693920
...
vector.body18:                                    ; preds = %vector.body18, %vector.ph17
  ...
  %i.hf = getelementptr [8 x i8], ptr %0, i64 %index19 ; 8 uses
  %i.hg = getelementptr i8, ptr %i.hf, i64 1248
  %i.hh = getelementptr [8 x i8], ptr %0, i64 %index19 ; 4 uses
  %i.hi = getelementptr i8, ptr %i.hh, i64 1256
  %i.hj = getelementptr i8, ptr %i.hh, i64 1288
  %i.hk = getelementptr i8, ptr %i.hh, i64 1320
  %i.hl = getelementptr i8, ptr %i.hh, i64 1352
  ...
  %i.jd = getelementptr i8, ptr %i.hf, i64 1280
  %i.je = getelementptr i8, ptr %i.hf, i64 1312
  %i.jf = getelementptr i8, ptr %i.hf, i64 1344
