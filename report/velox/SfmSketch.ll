...
bb.t:                                             ; preds = %.lr.ph, %_ZN8facebook5velox4bits6setBitImEEvPT_mb.exit
  ...
  %10 = load ptr, ptr %i.dr, align 8, !tbaa !47
  %11 = getelementptr inbounds nuw [8 x i8], ptr %10, i64 %i.dt
  %12 = load i64, ptr %11, align 8, !tbaa !31
  %13 = and i64 %12, %i.dx
  %14 = and i64 %i.dv, %i.dx
  ...
  %i.dy = fmul double %i.cv, %20
  %21 = extractelement <2 x double> %19, i64 1
  %i.dz = fmul double %i.dy, %21
