...
.prol.preheader:                                  ; preds = %.lr.ph24.i, %.prol.preheader
  ...
  store ptr %.11522.i.prol, ptr %7, align 8, !tbaa !15
  ...
  %11 = load ptr, ptr %10, align 8, !tbaa !18     ; 3 uses
...
.lr.ph24.i.new:                                   ; preds = %.prol.loopexit, %.lr.ph24.i.new
  ...
  store ptr %.11522.i, ptr %15, align 8, !tbaa !15
  ...
  %21 = load ptr, ptr %20, align 8, !tbaa !18     ; 3 uses
  ...
  %29 = load ptr, ptr %28, align 8, !tbaa !18     ; 3 uses
  ...
  %37 = load ptr, ptr %36, align 8, !tbaa !18     ; 3 uses
  ...
  br i1 %40, label %.lr.ph24.i.new, label %_ZN4absl12lts_2024011613cord_internal12_GLOBAL__N_115StackOperationsILNS1_12CordRepBtree8EdgeTypeE1EE10BuildStackEPS4_i.exit, !llvm.loop !38
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  br i1 %exitcond.not.i.i, label %_ZN4absl12lts_2024011613cord_internal12CordRepBtree10AlignBeginEv.exit.i, label %scalar.ph, !llvm.loop !114
...
vector.body90:                                    ; preds = %vector.body90, %vector.ph87
  ...
  br i1 %i.ds, label %middle.block97, label %vector.body90, !llvm.loop !115
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.dx, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !117
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph
  ...
  br i1 %.not.i, label %._crit_edge.loopexit.i, label %vec.epilog.scalar.ph, !llvm.loop !118
...
.prol.preheader:                                  ; preds = %.lr.ph24.i, %.prol.preheader
  ...
  %prol.iter.next = add i32 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.prol.loopexit, label %.prol.preheader, !llvm.loop !119
...
.lr.ph24.i.new:                                   ; preds = %.prol.loopexit, %.lr.ph24.i.new
  ...
  %39 = trunc nuw i64 %indvars.iv.next28.i.3 to i32
  %40 = icmp sgt i32 %i.i, %39
  br i1 %40, label %.lr.ph24.i.new, label %_ZN4absl12lts_2024011613cord_internal12_GLOBAL__N_115StackOperationsILNS1_12CordRepBtree8EdgeTypeE0EE10BuildStackEPS4_i.exit, !llvm.loop !26
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.dr, label %middle.block, label %vector.body, !llvm.loop !120
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.dy, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !121
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph
  ...
  br i1 %.not.i, label %_ZN4absl12lts_2024011613cord_internal12CordRepBtree3AddILNS2_8EdgeTypeE0EEEvNS0_4SpanIKPNS1_7CordRepEEE.exit, label %vec.epilog.scalar.ph, !llvm.loop !122
...
_ZNK4absl12lts_2024011613cord_internal12CordRepBtree4DataEm.exit: ; preds = %bb.g, %bb.h
  ...
  store i64 %i.o, ptr %1, align 8, !tbaa !123
  %.sroa.4.0..sroa_idx = getelementptr inbounds nuw i8, ptr %1, i64 8
  store ptr %.sroa.3.0.i.i, ptr %.sroa.4.0..sroa_idx, align 8, !tbaa !124
  br label %bb.i
...
bb.d:                                             ; preds = %_ZNK4absl12lts_2024011613cord_internal12CordRepBtree7IndexOfEm.exit
  ...
  br i1 %i.w, label %bb.e, label %bb.c, !llvm.loop !125
...
_ZNKSt17basic_string_viewIcSt11char_traitsIcEE6substrEmm.exit: ; preds = %_ZN4absl12lts_2024011613cord_internal8EdgeDataEPKNS1_7CordRepE.exit
  ...
  store i64 %.sroa.speculated.i, ptr %3, align 8, !tbaa !123
  %.sroa.4.0..sroa_idx = getelementptr inbounds nuw i8, ptr %3, i64 8
  store ptr %i.al, ptr %.sroa.4.0..sroa_idx, align 8, !tbaa !124
  br label %.thread
...
_ZNK4absl12lts_2024011613cord_internal12CordRepBtree7IndexOfEm.exit: ; preds = %.lr.ph.i, %bb.b
  ...
  br i1 %i.r, label %bb.b, label %bb.c, !llvm.loop !126
...
.lr.ph38:                                         ; preds = %.lr.ph38, %.lr.ph38.preheader.new
  ...
  br i1 %niter.ncmp.3, label %.thread.loopexit.unr-lcssa, label %.lr.ph38, !llvm.loop !128
...
.lr.ph38.epil:                                    ; preds = %.lr.ph38.epil, %.lr.ph38.epil.preheader
  ...
  br i1 %epil.iter.cmp.not, label %.thread, label %.lr.ph38.epil, !llvm.loop !129
...
bb.b:                                             ; preds = %bb.a
  ...
  store ptr %i.a, ptr %1, align 8, !tbaa !130
...
bb.e:                                             ; preds = %bb.a
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #18
  store ptr %i.a, ptr %2, align 8, !tbaa !130
...
vector.body152:                                   ; preds = %vector.body152, %vector.ph149
  ...
  br i1 %i.aq, label %middle.block156, label %vector.body152, !llvm.loop !133
...
scalar.ph147:                                     ; preds = %scalar.ph147.preheader, %scalar.ph147
  ...
  br i1 %exitcond.not.i.i.i, label %_ZN4absl12lts_2024011613cord_internal12CordRepBtree3AddILNS2_8EdgeTypeE1EEEvPNS1_7CordRepE.exit.i.loopexit, label %scalar.ph147, !llvm.loop !134
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.db, label %middle.block, label %vector.body, !llvm.loop !135
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  br i1 %exitcond.not.i.i.i62, label %_ZN4absl12lts_2024011613cord_internal12CordRepBtree3AddILNS2_8EdgeTypeE1EEEvPNS1_7CordRepE.exit.i63.loopexit, label %scalar.ph, !llvm.loop !136
...
_ZN4absl12lts_2024011613cord_internal12CordRepBtree7AddEdgeILNS2_8EdgeTypeE1EEENS2_8OpResultEbPNS1_7CordRepEm.exit69: ; preds = %bb.k, %bb.l
  ...
  br i1 %i.dy, label %.lr.ph82._crit_edge, label %.lr.ph142, !llvm.loop !137
...
.lr.ph84:                                         ; preds = %.preheader, %.lr.ph84
  ...
  br i1 %.not57, label %._crit_edge, label %.lr.ph84, !llvm.loop !138
...
bb.b:                                             ; preds = %.lr.ph
  ...
  br i1 %.not46, label %._crit_edge.loopexit, label %.lr.ph, !llvm.loop !139
...
_ZN4absl12lts_2024011613cord_internal12CordRepBtree6DeleteEPS2_.exit: ; preds = %bb.f
  ...
  br i1 %i.ay, label %.thread, label %bb.f, !llvm.loop !140
...
bb.f:                                             ; preds = %.lr.ph103, %_ZN4absl12lts_2024011613cord_internal12CordRepBtree6DeleteEPS2_.exit
  ...
  br i1 %i.bj, label %_ZN4absl12lts_2024011613cord_internal12CordRepBtree6DeleteEPS2_.exit, label %._crit_edge64.loopexit, !llvm.loop !140
...
.lr.ph71.prol:                                    ; preds = %.lr.ph71.preheader, %.lr.ph71.prol
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph71.prol.loopexit, label %.lr.ph71.prol, !llvm.loop !141
...
.lr.ph71:                                         ; preds = %.lr.ph71.prol.loopexit, %.lr.ph71
  ...
  br i1 %i.cp, label %.lr.ph71, label %.preheader.preheader, !llvm.loop !142
...
_ZN4absl12lts_2024011613cord_internal12CordRepBtree6DeleteEPS2_.exit43: ; preds = %.preheader
  ...
  br i1 %.not, label %.thread, label %.preheader, !llvm.loop !143
...
_ZN4absl12lts_2024011613cord_internal12_GLOBAL__N_113MakeSubstringEPNS1_7CordRepEmm.exit.i.i.i.i: ; preds = %_ZN4absl12lts_2024011613cord_internal12_GLOBAL__N_115CreateSubstringEPNS1_7CordRepEmm.exit.i.i.i.i.i, %bb.d, %bb.c, %bb.a
  ...
  %i.w = load ptr, ptr %0, align 8, !tbaa !144, !nonnull !29, !align !146 ; 2 uses
...
bb.j:                                             ; preds = %_ZN4absl12lts_2024011613cord_internal12_GLOBAL__N_113MakeSubstringEPNS1_7CordRepEmm.exit.i.i.i.i
  ...
  %i.ap = load ptr, ptr %0, align 8, !tbaa !144, !nonnull !29, !align !146
...
"_ZSt6invokeIRKZN4absl12lts_2024011613cord_internal12CordRepBtree10AppendSlowEPS3_PNS2_7CordRepEE3$_0JS6_mmEENSt13invoke_resultIT_JDpT0_EE4typeEOSB_DpOSC_.exit": ; preds = %bb.a, %bb.c, %bb.d, %_ZN4absl12lts_2024011613cord_internal12_GLOBAL__N_115CreateSubstringEPNS1_7CordRepEmm.exit.i.i.i.i.i
  ...
  %i.w = load ptr, ptr %0, align 8, !tbaa !147, !nonnull !29, !align !146
  ...
  %i.z = load ptr, ptr %0, align 8, !tbaa !147, !nonnull !29, !align !146
...
"_ZSt6invokeIRKZN4absl12lts_2024011613cord_internal12CordRepBtree11PrependSlowEPS3_PNS2_7CordRepEE3$_0JS6_mmEENSt13invoke_resultIT_JDpT0_EE4typeEOSB_DpOSC_.exit": ; preds = %bb.a, %bb.c, %bb.d, %_ZN4absl12lts_2024011613cord_internal12_GLOBAL__N_115CreateSubstringEPNS1_7CordRepEmm.exit.i.i.i.i.i
  %.0.i.i.i.i.i = phi ptr [ %i.r, %_ZN4absl12lts_2024011613cord_internal12_GLOBAL__N_115CreateSubstringEPNS1_7CordRepEmm.exit.i.i.i.i.i ], [ %1, %bb.a ], [ null, %bb.c ], [ null, %bb.d ]
  %i.w = load ptr, ptr %0, align 8, !tbaa !149, !nonnull !29, !align !146
  %i.x = load ptr, ptr %i.w, align 8, !tbaa !15
  ...
  %i.z = load ptr, ptr %0, align 8, !tbaa !149, !nonnull !29, !align !146
  store ptr %i.y, ptr %i.z, align 8, !tbaa !15
  ret void
}
...
!111 = distinct !{!111, !21}
!112 = distinct !{!112, !25}
!113 = distinct !{!113, !21, !25, !41, !42}
!114 = distinct !{!114, !21, !25, !41}
...
!129 = distinct !{!129, !25}
!130 = !{!131, !131, i64 0}
!131 = !{!"p2 _ZTSN4absl12lts_2024011613cord_internal12CordRepBtreeE", !132, i64 0}
!132 = !{!"any p2 pointer", !17, i64 0}
!133 = distinct !{!133, !21, !25, !41, !42}
!134 = distinct !{!134, !21, !25, !41}
!135 = distinct !{!135, !21, !25, !41, !42}
!136 = distinct !{!136, !21, !25, !41}
!137 = distinct !{!137, !21}
!138 = distinct !{!138, !21}
!139 = distinct !{!139, !21}
!140 = distinct !{!140, !21}
...
!143 = distinct !{!143, !21}
!144 = !{!145, !131, i64 0}
!145 = !{!"_ZTSZN4absl12lts_2024011613cord_internal12CordRepBtree10CreateSlowEPNS1_7CordRepEE3$_0", !131, i64 0}
!146 = !{i64 8}
!147 = !{!148, !131, i64 0}
!148 = !{!"_ZTSZN4absl12lts_2024011613cord_internal12CordRepBtree10AppendSlowEPS2_PNS1_7CordRepEE3$_0", !131, i64 0}
!149 = !{!150, !131, i64 0}
!150 = !{!"_ZTSZN4absl12lts_2024011613cord_internal12CordRepBtree11PrependSlowEPS2_PNS1_7CordRepEE3$_0", !131, i64 0}
end_hunk_0
