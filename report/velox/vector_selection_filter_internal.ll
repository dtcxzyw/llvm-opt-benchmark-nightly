...
begin_hunk_0_@_ZNK5arrow7compute8internal12_GLOBAL__N_118FilterMetaFunction11ExecuteImplERKSt6vectorINS_5DatumESaIS5_EEPKNS0_15FunctionOptionsEPNS0_11ExecContextE:bb.a
  ...
  store i32 0, ptr %i.wy, align 4, !tbaa !337
  %i.wz = load ptr, ptr %i.wt, align 8, !tbaa !71
  %i.xa = getelementptr inbounds nuw i8, ptr %i.wz, i64 16
  %i.xb = load ptr, ptr %i.xa, align 8
  call void %i.xb(ptr noundef nonnull align 8 dereferenceable(16) %i.wt) #25, !inline_history !1054
  %i.xc = load ptr, ptr %i.wt, align 8, !tbaa !71
  %i.xd = getelementptr inbounds nuw i8, ptr %i.xc, i64 24
  %i.xe = load ptr, ptr %i.xd, align 8
  call void %i.xe(ptr noundef nonnull align 8 dereferenceable(16) %i.wt) #25, !inline_history !1054
  br label %_ZNSt12__shared_ptrIN5arrow5ArrayELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i104

bb.hy:                                            ; preds = %bb.hw
  %i.xf = load i8, ptr @__libc_single_threaded, align 1, !tbaa !42, !noalias !1030
  %.not.i.i.i141.i = icmp eq i8 %i.xf, 0
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i142.i: ; preds = %bb.ia, %bb.hz
  %.0.i.i.i.i143.i = phi i32 [ %i.wx, %bb.hz ], [ %i.xh, %bb.ia ]
  %i.xi = icmp eq i32 %.0.i.i.i.i143.i, 1
  br i1 %i.xi, label %bb.ib, label %_ZNSt12__shared_ptrIN5arrow5ArrayELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i104, !prof !41

bb.ib:                                            ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i142.i
  call void @_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE24_M_release_last_use_coldEv(ptr noundef nonnull align 8 dereferenceable(16) %i.wt) #25
  br label %_ZNSt12__shared_ptrIN5arrow5ArrayELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i104
...
bb.ie:                                            ; preds = %bb.id, %bb.ic
  %.pn.i = phi { ptr, i32 } [ %i.xk, %bb.id ], [ %i.xj, %bb.ic ]
  call void @llvm.lifetime.end.p0(ptr nonnull %17) #25, !noalias !1030
  br label %bb.mp

bb.if:                                            ; preds = %._crit_edge.i
  %.not.i.i.i144.i = icmp eq i8 %i.vf, 3
  br i1 %.not.i.i.i144.i, label %_ZNK5arrow5Datum13chunked_arrayEv.exit.i84, label %bb.ig

bb.ig:                                            ; preds = %bb.if
  %i.xl = call ptr @__cxa_allocate_exception(i64 16) #25 ; 3 uses
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt18bad_variant_access, i64 16), ptr %i.xl, align 8, !tbaa !71
  %i.xm = getelementptr inbounds nuw i8, ptr %i.xl, i64 8
  store ptr @.str.6, ptr %i.xm, align 8, !tbaa !73
  invoke void @__cxa_throw(ptr nonnull %i.xl, ptr nonnull @_ZTISt18bad_variant_access, ptr nonnull @_ZNSt9exceptionD2Ev) #27
...
_ZNK5arrow5Datum13chunked_arrayEv.exit.i84:       ; preds = %bb.if
  %i.xn = load ptr, ptr %i.rb, align 8, !tbaa !859, !noalias !1030
  %i.xo = load ptr, ptr %i.vd, align 8, !tbaa !1053, !noalias !1030
  %i.xp = getelementptr inbounds i8, ptr %i.xo, i64 -24
  %i.xq = invoke noundef nonnull align 8 dereferenceable(24) ptr @_ZNSt6vectorISt10shared_ptrIN5arrow5ArrayEESaIS3_EEaSERKS5_(ptr noundef nonnull align 8 dereferenceable(24) %i.xp, ptr noundef nonnull align 8 dereferenceable(24) %i.xn)
...
_ZN5arrow6Status9TypeErrorIJRA28_KcEEES0_DpOT_.exit.i105: ; preds = %bb.ii
  ...
  %i.xs = load ptr, ptr %18, align 8, !tbaa !84, !noalias !1030
  %.not.i147.i = icmp eq ptr %i.xs, null
...
bb.im:                                            ; preds = %bb.il
  ...
  %i.xu = load ptr, ptr %15, align 8, !tbaa !1046, !noalias !1030
  %i.xv = load ptr, ptr %i.vd, align 8, !tbaa !1050, !noalias !1030
  %i.xw = load ptr, ptr %i.vc, align 8, !tbaa !1049, !noalias !1030
  %i.xx = load ptr, ptr %19, align 8, !tbaa !1046, !noalias !1030
  store ptr %i.xx, ptr %15, align 8, !tbaa !1046, !noalias !1030
  %i.xy = getelementptr inbounds nuw i8, ptr %19, i64 8
  %i.xz = load ptr, ptr %i.xy, align 8, !tbaa !1050, !noalias !1030
  store ptr %i.xz, ptr %i.vd, align 8, !tbaa !1050, !noalias !1030
  %i.ya = getelementptr inbounds nuw i8, ptr %19, i64 16
  %i.yb = load ptr, ptr %i.ya, align 8, !tbaa !1049, !noalias !1030
  store ptr %i.yb, ptr %i.vc, align 8, !tbaa !1049, !noalias !1030
  %i.yc = getelementptr inbounds nuw i8, ptr %10, i64 8
  %i.yd = getelementptr inbounds nuw i8, ptr %10, i64 16
  store ptr %i.xu, ptr %10, align 8, !tbaa !1046, !noalias !1030
  store ptr %i.xv, ptr %i.yc, align 8, !tbaa !1050, !noalias !1030
  store ptr %i.xw, ptr %i.yd, align 8, !tbaa !1049, !noalias !1030
  ...
  %i.ye = load ptr, ptr %i.vd, align 8, !tbaa !1053, !noalias !1030 ; 2 uses
  %i.yf = getelementptr inbounds i8, ptr %i.ye, i64 -24
  %i.yg = getelementptr inbounds i8, ptr %i.ye, i64 -16
  %i.yh = load ptr, ptr %i.yg, align 8, !tbaa !1003
  %i.yi = load ptr, ptr %i.yf, align 8, !tbaa !999
  ...
  %i.yn = sext i32 %i.uq to i64                   ; 4 uses
  %i.yo = icmp slt i32 %i.uq, 0
  br i1 %i.yo, label %bb.in, label %_ZNSt6vectorIS_ISt10shared_ptrIN5arrow5ArrayEESaIS3_EESaIS5_EE17_S_check_init_lenEmRKS6_.exit.i149.i
...
_ZNSt6vectorIS_ISt10shared_ptrIN5arrow5ArrayEESaIS3_EESaIS5_EE17_S_check_init_lenEmRKS6_.exit.i149.i: ; preds = %bb.im
  ...
  %.not.i.i.i.i150.i = icmp eq i32 %i.uq, 0       ; 3 uses
...
.lr.ph.preheader.i.i.i.i.i151.i:                  ; preds = %_ZNSt6vectorIS_ISt10shared_ptrIN5arrow5ArrayEESaIS3_EESaIS5_EE17_S_check_init_lenEmRKS6_.exit.i149.i
  %i.yp = mul nuw nsw i64 %i.yn, 24               ; 3 uses
  %i.yq = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.yp) #29
          to label %.noexc157.i unwind label %bb.iq ; 4 uses

.noexc157.i:                                      ; preds = %.lr.ph.preheader.i.i.i.i.i151.i
  store ptr %i.yq, ptr %20, align 8, !tbaa !1046, !noalias !1030
  %i.yr = getelementptr inbounds nuw [24 x i8], ptr %i.yq, i64 %i.yn
  call void @llvm.memset.p0.i64(ptr nonnull align 8 %i.yq, i8 0, i64 %i.yp, i1 false)
  %scevgep.i.i.i.i.i152.i = getelementptr i8, ptr %i.yq, i64 %i.yp
...
_ZNSt12_Vector_baseISt6vectorISt10shared_ptrIN5arrow5ArrayEESaIS4_EESaIS6_EEC2EmRKS7_.exit.thread.i155.i: ; preds = %.noexc157.i, %_ZNSt6vectorIS_ISt10shared_ptrIN5arrow5ArrayEESaIS3_EESaIS5_EE17_S_check_init_lenEmRKS6_.exit.i149.i
  %.sink.i153.i = phi ptr [ %i.yr, %.noexc157.i ], [ null, %_ZNSt6vectorIS_ISt10shared_ptrIN5arrow5ArrayEESaIS3_EESaIS5_EE17_S_check_init_lenEmRKS6_.exit.i149.i ]
  ...
  %i.ys = getelementptr inbounds nuw i8, ptr %20, i64 8
  %i.yt = getelementptr inbounds nuw i8, ptr %20, i64 16
  store ptr %.sink.i153.i, ptr %i.yt, align 8, !tbaa !1049, !noalias !1030
  store ptr %.0.lcssa.i.i.i.i.i154.i, ptr %i.ys, align 8, !tbaa !1050, !noalias !1030
  %.not106289.i = icmp sgt i64 %i.ym, 0
...
.lr.ph296.i:                                      ; preds = %_ZNSt12_Vector_baseISt6vectorISt10shared_ptrIN5arrow5ArrayEESaIS4_EESaIS6_EEC2EmRKS7_.exit.thread.i155.i
  %i.yu = getelementptr inbounds nuw i8, ptr %22, i64 16
  %i.yv = getelementptr inbounds nuw i8, ptr %22, i64 24
  %i.yw = getelementptr inbounds nuw i8, ptr %3, i64 16
  %i.yx = getelementptr inbounds nuw i8, ptr %22, i64 104 ; 3 uses
  %i.yy = getelementptr inbounds nuw i8, ptr %22, i64 112
  %i.yz = getelementptr inbounds nuw i8, ptr %22, i64 120
  %i.za = getelementptr inbounds nuw i8, ptr %21, i64 8 ; 2 uses
  %i.zb = getelementptr inbounds nuw i8, ptr %23, i64 8 ; 2 uses
  %i.zc = getelementptr inbounds nuw i8, ptr %21, i64 16 ; 3 uses
  %i.zd = getelementptr inbounds nuw i8, ptr %24, i64 8
  %i.ze = getelementptr inbounds nuw i8, ptr %24, i64 16
  %i.zf = getelementptr inbounds nuw i8, ptr %25, i64 24
  %i.zg = getelementptr inbounds nuw i8, ptr %25, i64 8 ; 3 uses
...
bb.io:                                            ; preds = %_ZN5arrow6ResultISt10shared_ptrINS_9ArrayDataEEED2Ev.exit.i91
  %i.zk = add nuw nsw i64 %.087291.i, 1           ; 2 uses
  %exitcond312.not.i = icmp eq i64 %i.zk, %i.ym
...
bb.ir:                                            ; preds = %bb.io, %.lr.ph296.i
  %.087291.i = phi i64 [ 0, %.lr.ph296.i ], [ %i.zk, %bb.io ] ; 3 uses
  %.088290.i = phi i64 [ 0, %.lr.ph296.i ], [ %.492.i, %bb.io ] ; 4 uses
  %i.zn = load ptr, ptr %i.vd, align 8, !tbaa !1053, !noalias !1030
  %i.zo = getelementptr inbounds i8, ptr %i.zn, i64 -24
  %i.zp = load ptr, ptr %i.zo, align 8, !tbaa !999
  %i.zq = getelementptr inbounds nuw [16 x i8], ptr %i.zp, i64 %.087291.i
  %i.zr = load ptr, ptr %i.zq, align 8, !tbaa !984
  %i.zs = getelementptr inbounds nuw i8, ptr %i.zr, i64 8
  %i.zt = load ptr, ptr %i.zs, align 8, !tbaa !76
  ...
  store i64 -1, ptr %i.yu, align 8, !tbaa !34, !noalias !1030
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(104) %i.yv, i8 0, i64 104, i1 false), !noalias !1030
  invoke void @_ZN5arrow9ArraySpan10SetMembersERKNS_9ArrayDataE(ptr noundef nonnull align 8 dereferenceable(128) %22, ptr noundef nonnull align 8 dereferenceable(120) %i.zt)
          to label %_ZN5arrow9ArraySpanC2ERKNS_9ArrayDataE.exit.i88 unwind label %bb.is

bb.is:                                            ; preds = %bb.ir
  %i.zu = landingpad { ptr, i32 }
          cleanup
  call void @_ZNSt6vectorIN5arrow9ArraySpanESaIS1_EED2Ev(ptr noundef nonnull align 8 dereferenceable(24) %i.yx) #25
  br label %.body.i87

_ZN5arrow9ArraySpanC2ERKNS_9ArrayDataE.exit.i88:  ; preds = %bb.ir
  %i.zv = load i32, ptr %i.yw, align 8, !tbaa !63, !noalias !1030
  %i.zw = load ptr, ptr %4, align 8, !tbaa !344, !noalias !1030
  invoke void @_ZN5arrow7compute8internal14GetTakeIndicesERKNS_9ArraySpanENS0_13FilterOptions21NullSelectionBehaviorEPNS_10MemoryPoolE(ptr dead_on_unwind nonnull writable sret(%"class.arrow::Result.227") align 8 %21, ptr noundef nonnull align 8 dereferenceable(128) %22, i32 noundef %i.zv, ptr noundef %i.zw)
          to label %bb.it unwind label %bb.iw

bb.it:                                            ; preds = %_ZN5arrow9ArraySpanC2ERKNS_9ArrayDataE.exit.i88
  %i.zx = load ptr, ptr %i.yx, align 8, !tbaa !80, !noalias !1030
  %i.zy = load ptr, ptr %i.yy, align 8, !tbaa !829, !noalias !1030
  call void @_ZNSt12_Destroy_auxILb0EE9__destroyIPN5arrow9ArraySpanEEEvT_S5_(ptr noundef %i.zx, ptr noundef %i.zy), !inline_history !890
  %i.zz = load ptr, ptr %i.yx, align 8, !tbaa !80, !noalias !1030 ; 3 uses
  %.not.i.i.i.i159.i = icmp eq ptr %i.zz, null
  br i1 %.not.i.i.i.i159.i, label %_ZN5arrow9ArraySpanD2Ev.exit.i89, label %bb.iu

bb.iu:                                            ; preds = %bb.it
  %i.aaa = load ptr, ptr %i.yz, align 8, !tbaa !831, !noalias !1030
  %i.aab = ptrtoint ptr %i.aaa to i64
  %i.aac = ptrtoint ptr %i.zz to i64
  %i.aad = sub i64 %i.aab, %i.aac
  call void @_ZdlPvm(ptr noundef nonnull %i.zz, i64 noundef %i.aad) #28, !inline_history !891
...
_ZN5arrow9ArraySpanD2Ev.exit.i89:                 ; preds = %bb.iu, %bb.it
  ...
  %i.aae = load ptr, ptr %21, align 8, !tbaa !84, !noalias !1030
  %i.aaf = icmp eq ptr %i.aae, null
  br i1 %i.aaf, label %bb.ix, label %bb.iv, !prof !110
...
.body.i87:                                        ; preds = %bb.iw, %bb.is
  %.pn96.i = phi { ptr, i32 } [ %i.aag, %bb.iw ], [ %i.zu, %bb.is ]
  call void @llvm.lifetime.end.p0(ptr nonnull %22) #25, !noalias !1030
  br label %bb.mm
...
bb.ix:                                            ; preds = %_ZN5arrow9ArraySpanD2Ev.exit.i89
  ...
  %i.aah = load ptr, ptr %i.za, align 8, !tbaa !76, !noalias !1062 ; 3 uses
  store ptr %i.aah, ptr %23, align 8, !tbaa !76, !alias.scope !1063, !noalias !1030
  %i.aai = load ptr, ptr %i.zc, align 8, !tbaa !330, !noalias !1062 ; 5 uses
  store ptr null, ptr %i.zc, align 8, !tbaa !330, !noalias !1062
  store ptr %i.aai, ptr %i.zb, align 8, !tbaa !330, !alias.scope !1063, !noalias !1030
  store ptr null, ptr %i.za, align 8, !tbaa !76, !noalias !1062
  %i.aaj = getelementptr inbounds nuw i8, ptr %i.aah, i64 16
  %i.aak = load i64, ptr %i.aaj, align 8, !tbaa !112
  %i.aal = icmp sgt i64 %i.aak, 0
  br i1 %i.aal, label %bb.iy, label %bb.kf

bb.iy:                                            ; preds = %bb.ix
  call void @llvm.lifetime.start.p0(ptr nonnull %24) #25, !noalias !1030
  %.not.i.i.i160.i = icmp eq ptr %i.aai, null
  br i1 %.not.i.i.i160.i, label %_ZNSt12__shared_ptrIN5arrow9ArrayDataELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i95, label %bb.iz

bb.iz:                                            ; preds = %bb.iy
  %i.aam = getelementptr inbounds nuw i8, ptr %i.aai, i64 8 ; 3 uses
  %i.aan = load i8, ptr @__libc_single_threaded, align 1, !tbaa !42, !noalias !1030
  %.not.i.i.i.i161.i = icmp eq i8 %i.aan, 0
  br i1 %.not.i.i.i.i161.i, label %bb.jb, label %bb.ja

bb.ja:                                            ; preds = %bb.iz
  %i.aao = load i32, ptr %i.aam, align 4, !tbaa !3
  %i.aap = add nsw i32 %i.aao, 1
  store i32 %i.aap, ptr %i.aam, align 4, !tbaa !3
  br label %_ZNSt12__shared_ptrIN5arrow9ArrayDataELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i95

bb.jb:                                            ; preds = %bb.iz
  %i.aaq = atomicrmw volatile add ptr %i.aam, i32 1 acq_rel, align 4 ; 0 uses
  br label %_ZNSt12__shared_ptrIN5arrow9ArrayDataELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i95

_ZNSt12__shared_ptrIN5arrow9ArrayDataELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i95: ; preds = %bb.jb, %bb.ja, %bb.iy
  store ptr %i.aah, ptr %24, align 8, !tbaa !76, !noalias !1030
  store ptr %i.aai, ptr %i.zd, align 8, !tbaa !330, !noalias !1030
  store i8 2, ptr %i.ze, align 8, !tbaa !629, !noalias !1030
...
.lr.ph288.i:                                      ; preds = %_ZNSt12__shared_ptrIN5arrow9ArrayDataELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i95, %bb.jc
  ...
  %i.aar = load ptr, ptr %15, align 8, !tbaa !1046, !noalias !1030
  %i.aas = getelementptr inbounds nuw [24 x i8], ptr %i.aar, i64 %indvars.iv307.i
  %i.aat = load ptr, ptr %i.aas, align 8, !tbaa !999
  %i.aau = getelementptr inbounds nuw [16 x i8], ptr %i.aat, i64 %.087291.i
  ...
  invoke void @_ZN5arrow5DatumC1ERKSt10shared_ptrINS_5ArrayEE(ptr noundef nonnull align 8 dereferenceable(24) %26, ptr noundef nonnull align 8 dereferenceable(16) %i.aau)
...
bb.jf:                                            ; preds = %bb.je
  ...
  call void @__clang_call_terminate(ptr %i.aaw) #26
  unreachable
...
_ZN5arrow5DatumD2Ev.exit.i:                       ; preds = %bb.je
  ...
  %i.aax = load ptr, ptr %25, align 8, !tbaa !84, !noalias !1030
  %i.aay = icmp eq ptr %i.aax, null               ; 2 uses
  br i1 %i.aay, label %bb.jm, label %bb.jg, !prof !110
...
bb.jk:                                            ; preds = %bb.jj, %bb.ji
  %.pn98.i = phi { ptr, i32 } [ %i.abb, %bb.jj ], [ %i.aba, %bb.ji ]
  call void @llvm.lifetime.end.p0(ptr nonnull %27) #25, !noalias !1030
...
bb.jl:                                            ; preds = %bb.jk, %bb.jh
  %.pn98.pn.i = phi { ptr, i32 } [ %.pn98.i, %bb.jk ], [ %i.aaz, %bb.jh ]
  call void @llvm.lifetime.end.p0(ptr nonnull %26) #25, !noalias !1030
end_hunk_0
