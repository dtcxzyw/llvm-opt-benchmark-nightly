...
bb.o:                                             ; preds = %bb.k
  ...
  %i.ar = load i8, ptr %.lcssa876.a, align 1, !tbaa !10
...
bb.t:                                             ; preds = %bb.p
  ...
  %i.be = load i8, ptr %.lcssa876.a, align 1, !tbaa !10
...
.lr.ph420:                                        ; preds = %.lr.ph420.preheader, %bb.y
  ...
  %i.bs = load i8, ptr %.5419, align 1, !tbaa !10 ; 2 uses
...
iter.check730:                                    ; preds = %.preheader348
  ...
  %min.iters.check712 = icmp ult i64 %i.fn, 16
...
vector.body717:                                   ; preds = %vector.body717, %vector.ph715
  ...
  %wide.load722 = load <32 x i8>, ptr %i.fr, align 1, !tbaa !10
  %wide.load723 = load <32 x i8>, ptr %i.fs, align 1, !tbaa !10
  %wide.load724 = load <32 x i8>, ptr %i.ft, align 1, !tbaa !10
  ...
  store <32 x i8> %wide.load722, ptr %i.fu, align 1, !tbaa !10
  store <32 x i8> %wide.load723, ptr %i.fv, align 1, !tbaa !10
  store <32 x i8> %wide.load724, ptr %i.fw, align 1, !tbaa !10
  %index.next725 = add nuw i64 %index718, 128     ; 2 uses
  %i.fx = icmp eq i64 %index.next725, %n.vec716
  br i1 %i.fx, label %middle.block726, label %vector.body717, !llvm.loop !31
...
vec.epilog.ph734:                                 ; preds = %vector.main.loop.iter.check713, %vec.epilog.iter.check732
  ...
  %n.vec735 = and i64 %i.fn, -16                  ; 4 uses
...
vec.epilog.vector.body736:                        ; preds = %vec.epilog.vector.body736, %vec.epilog.ph734
  ...
  br i1 %i.ga, label %vec.epilog.middle.block742, label %vec.epilog.vector.body736, !llvm.loop !32
...
.lr.ph437:                                        ; preds = %.lr.ph437.preheader, %.lr.ph437
  ...
  %i.gc = load i8, ptr %.0208436, align 1, !tbaa !10
  %i.gd = getelementptr inbounds nuw i8, ptr %.2250435, i64 1 ; 2 uses
  store i8 %i.gc, ptr %.2250435, align 1, !tbaa !10
  %i.ge = icmp ult ptr %i.gd, %i.fc
  br i1 %i.ge, label %.lr.ph437, label %.thread331, !llvm.loop !33
...
bb.bf:                                            ; preds = %bb.be
  ...
  %i.gh = load i32, ptr %i.gg, align 4, !tbaa !51
  %i.gi = getelementptr inbounds nuw [4 x i8], ptr @_ZN8facebook5velox6common11compressionL12DEC_64_TABLEE, i64 %i.ex
  %i.gj = load i32, ptr %i.gi, align 4, !tbaa !51
  %i.gk = load i8, ptr %i.ez, align 1, !tbaa !10
  store i8 %i.gk, ptr %.1249449.ph, align 1, !tbaa !10
  ...
  store i8 %i.gs, ptr %i.gt, align 1, !tbaa !10
  ...
  %i.gx = load i32, ptr %i.gw, align 4, !tbaa !51
  store i32 %i.gx, ptr %i.gu, align 4, !tbaa !51
...
bb.bg:                                            ; preds = %bb.be
  %i.hb = load i64, ptr %i.ez, align 8, !tbaa !22
  store i64 %i.hb, ptr %.1249449.ph, align 8, !tbaa !22
...
vector.body829:                                   ; preds = %vector.body829, %vector.ph827
  ...
  %wide.load833.a = load <4 x i64>, ptr %next.gep831.a, align 8, !tbaa !22
  %wide.load834.a = load <4 x i64>, ptr %i.ho, align 8, !tbaa !22
  %wide.load835.a = load <4 x i64>, ptr %i.hp, align 8, !tbaa !22
  %wide.load836 = load <4 x i64>, ptr %i.hq, align 8, !tbaa !22
  ...
  store <4 x i64> %wide.load833.a, ptr %next.gep832, align 8, !tbaa !22
  store <4 x i64> %wide.load834.a, ptr %i.hr, align 8, !tbaa !22
  store <4 x i64> %wide.load835.a, ptr %i.hs, align 8, !tbaa !22
  store <4 x i64> %wide.load836, ptr %i.ht, align 8, !tbaa !22
  %index.next837 = add nuw i64 %index830, 16      ; 2 uses
  %i.hu = icmp eq i64 %index.next837, %n.vec828
  br i1 %i.hu, label %middle.block838, label %vector.body829, !llvm.loop !34
...
vec.epilog.iter.check844:                         ; preds = %middle.block838
  ...
  br i1 %min.epilog.iters.check845, label %.lr.ph426.preheader, label %vec.epilog.ph846, !prof !52
...
vec.epilog.vector.body848:                        ; preds = %vec.epilog.vector.body848, %vec.epilog.ph846
  ...
  %wide.load852 = load <4 x i64>, ptr %next.gep850.a, align 8, !tbaa !22
  store <4 x i64> %wide.load852, ptr %next.gep851, align 8, !tbaa !22
...
vector.body755:                                   ; preds = %vector.body755, %vector.ph753
  ...
  %wide.load759 = load <4 x i64>, ptr %next.gep757, align 8, !tbaa !22
  %wide.load760 = load <4 x i64>, ptr %i.io, align 8, !tbaa !22
  %wide.load761 = load <4 x i64>, ptr %i.ip, align 8, !tbaa !22
  %wide.load762 = load <4 x i64>, ptr %i.iq, align 8, !tbaa !22
  ...
  store <4 x i64> %wide.load759, ptr %next.gep758, align 8, !tbaa !22
  store <4 x i64> %wide.load760, ptr %i.ir, align 8, !tbaa !22
  store <4 x i64> %wide.load761, ptr %i.is, align 8, !tbaa !22
  store <4 x i64> %wide.load762, ptr %i.it, align 8, !tbaa !22
...
iter.check805:                                    ; preds = %.preheader351
  ...
  %min.iters.check787 = icmp ult i64 %i.jc, 16
