...
begin_hunk_1
  ...
  %i.hs = tail call i64 @llvm.smax.i64(i64 %i.gz, i64 0)
  %i.ht = add i64 %i.hp, %i.hr
  %i.hu = tail call i64 @llvm.smax.i64(i64 %i.gz, i64 0)
  %smax228 = add nuw nsw i64 %i.hu, 1             ; 2 uses
  %min.iters.check230 = icmp ult i32 %i.gw, 105
  %7 = and i64 %i.hs, 4294967295
  %8 = icmp eq i64 %7, 4294967295
  %or.cond = select i1 %min.iters.check230, i1 true, i1 %8
  %n.vec233 = and i64 %smax228, 9223372036854775804 ; 4 uses
  %i.hv = trunc i64 %n.vec233 to i32
  %cmp.n240 = icmp eq i64 %smax228, %n.vec233
...
begin_hunk_2
  ...
  br i1 %or.cond, label %scalar.ph229.preheader, label %vector.memcheck226
...
scalar.ph229.preheader:                           ; preds = %vector.memcheck226, %.lr.ph148, %middle.block239
  %.ph = phi i64 [ 0, %vector.memcheck226 ], [ 0, %.lr.ph148 ], [ %n.vec233, %middle.block239 ]
  %.0107146.ph = phi i32 [ 0, %vector.memcheck226 ], [ 0, %.lr.ph148 ], [ %i.hv, %middle.block239 ]
