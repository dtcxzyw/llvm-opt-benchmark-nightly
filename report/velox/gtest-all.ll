...
begin_hunk_0_@_ZN7testing8internal12UnitTestImpl11FilterTestsENS1_18ReactionToShardingE:bb.a
  ...
  %.not392655.i.i63 = select i1 %i.cl, i1 %i.cf, i1 false ; 3 uses
  br i1 %.not392655.i.i63, label %_ZN7testing8internal15UnitTestOptions13MatchesFilterERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPKc.exit123, label %.lr.ph.i.i64
...
_ZN7testing8internalL20PatternMatchesStringERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPKcSA_.exit.i86: ; preds = %.loopexit1.i.i74
  ...
  br i1 %.not.i62, label %_ZN7testing8internal15UnitTestOptions13MatchesFilterERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPKc.exit123, label %bb.w, !llvm.loop !292

_ZN7testing8internal15UnitTestOptions13MatchesFilterERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPKc.exit123: ; preds = %bb.p, %_ZN7testing8internalL20PatternMatchesStringERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPKcSA_.exit.i86, %bb.y, %.outer.backedge.i.i, %bb.r, %.outer.backedge.i.i79, %bb.aa, %bb.v, %bb.ae
  %4 = phi i1 [ true, %bb.v ], [ %.not392655.i.i63, %_ZN7testing8internalL20PatternMatchesStringERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPKcSA_.exit.i86 ], [ true, %.outer.backedge.i.i ], [ true, %bb.ae ], [ true, %.outer.backedge.i.i79 ], [ true, %bb.aa ], [ true, %bb.r ], [ %.not392655.i.i63, %bb.y ], [ true, %bb.p ] ; 2 uses
  %5 = zext i1 %4 to i8
  %i.dh = getelementptr inbounds nuw i8, ptr %i.ao, i64 129
  store i8 %5, ptr %i.dh, align 1, !tbaa !390
