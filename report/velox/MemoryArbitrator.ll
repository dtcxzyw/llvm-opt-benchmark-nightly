...
bb.h:                                             ; preds = %bb.g
  tail call void asm sideeffect "pause", "~{dirflag},~{fpsr},~{flags}"() #33, !srcloc !595
  %i.s = load atomic i32, ptr %0 acquire, align 4
  %i.t = and i32 %i.s, -3
  %i.u = icmp eq i32 %i.t, 1
  br i1 %i.u, label %_ZN5folly6detail16spin_pause_untilINSt6chrono3_V212steady_clockENS2_8durationIlSt5ratioILl1ELl1000000000EEEEZNS_5BatonILb1ESt6atomicE11tryWaitSlowIS4_S8_EEbRKNS2_10time_pointIT_T0_EERKNS_11WaitOptionsEEUlvE_EENS0_11spin_resultESI_SL_T1_.exit.thread, label %.lr.ph.i, !llvm.loop !819
...
bb.i:                                             ; preds = %.noexc
  %i.z = load i32, ptr %i.a, align 4, !tbaa !820
  br label %bb.j
...
bb.e:                                             ; preds = %_ZN5folly6detail14futexWaitUntilISt6atomicIjENSt6chrono3_V212steady_clockENS4_8durationIlSt5ratioILl1ELl1000000000EEEEEENS0_11FutexResultEPKT_jRKNS4_10time_pointIT0_T1_EEj.exit
  store i32 %i.ak, ptr %0, align 4, !tbaa !820
  br label %.thread
...
bb.a:
  %.val = load ptr, ptr %1, align 8, !tbaa !823   ; 2 uses
  %i.a = load ptr, ptr %.val, align 8, !tbaa !16
  %i.b = getelementptr inbounds nuw i8, ptr %i.a, i64 304
  %i.c = load ptr, ptr %i.b, align 8
  %i.d = tail call { i64, i8 } %i.c(ptr noundef nonnull align 8 dereferenceable(264) %.val), !inline_history !824 ; 2 uses
  ...
  %i.l = load ptr, ptr %i.k, align 8, !tbaa !827, !nonnull !77, !align !374 ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  store ptr @"_ZTIZNK8facebook5velox6memory15MemoryReclaimer16reclaimableBytesERKNS1_10MemoryPoolERmE3$_0", ptr %0, align 8, !tbaa !338
...
bb.d:                                             ; preds = %bb.a
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %0, ptr noundef nonnull readonly align 8 dereferenceable(16) %1, i64 16, i1 false), !tbaa.struct !828
  br label %"_ZNSt14_Function_base13_Base_managerIZNK8facebook5velox6memory15MemoryReclaimer16reclaimableBytesERKNS3_10MemoryPoolERmE3$_0E10_M_managerERSt9_Any_dataRKSB_St18_Manager_operation.exit"
...
bb.a:
  %.val = load ptr, ptr %1, align 8, !tbaa !823   ; 3 uses
  %i.a = load ptr, ptr %.val, align 8, !tbaa !16
  %i.b = getelementptr inbounds nuw i8, ptr %i.a, i64 296
  %i.c = load ptr, ptr %i.b, align 8
  %i.d = tail call noundef ptr %i.c(ptr noundef nonnull align 8 dereferenceable(264) %.val), !inline_history !829 ; 3 uses
...
bb.b:                                             ; preds = %bb.a
  %i.e = load ptr, ptr %0, align 8, !tbaa !830, !nonnull !77, !align !374
  %i.f = load ptr, ptr %i.d, align 8, !tbaa !16
  %i.g = getelementptr inbounds nuw i8, ptr %i.f, i64 56
  %i.h = load ptr, ptr %i.g, align 8
  tail call void %i.h(ptr noundef nonnull align 8 dereferenceable(12) %i.d, ptr noundef nonnull %.val, ptr noundef nonnull align 8 dereferenceable(8) %i.e), !inline_history !829
...
bb.b:                                             ; preds = %bb.a
  store ptr @"_ZTIZN8facebook5velox6memory15MemoryReclaimer5abortEPNS1_10MemoryPoolERKNSt15__exception_ptr13exception_ptrEE3$_0", ptr %0, align 8, !tbaa !338
...
bb.d:                                             ; preds = %bb.a
  %.val.i = load i64, ptr %1, align 8, !tbaa !193
  store i64 %.val.i, ptr %0, align 8, !tbaa !193
  br label %"_ZNSt14_Function_base13_Base_managerIZN8facebook5velox6memory15MemoryReclaimer5abortEPNS3_10MemoryPoolERKNSt15__exception_ptr13exception_ptrEE3$_0E10_M_managerERSt9_Any_dataRKSD_St18_Manager_operation.exit"
