...
.preheader:                                       ; preds = %bb.a, %.sink.split
  %.022.ph = phi ptr [ %i.j, %.sink.split ], [ %0, %bb.a ]
  br label %bb.b

bb.b:                                             ; preds = %.backedge, %.preheader
  %.022 = phi ptr [ %.022.ph, %.preheader ], [ %i.q, %.backedge ] ; 7 uses
  %i.k = load i8, ptr %.022, align 8, !tbaa !8    ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  %i.l = getelementptr inbounds nuw i8, ptr %.022, i64 6
  %i.m = load i16, ptr %i.l, align 2, !tbaa !16
  %i.n = icmp ult i16 %i.m, 2
  %i.o = getelementptr inbounds nuw i8, ptr %.022, i64 8 ; 2 uses
...
bb.e:                                             ; preds = %bb.b, %bb.b
  %i.v = getelementptr inbounds nuw i8, ptr %.022, i64 2 ; 2 uses
...
.thread:                                          ; preds = %bb.e
  %i.aa = getelementptr inbounds nuw i8, ptr %.022, i64 24
  br label %bb.g

bb.f:                                             ; preds = %bb.e
  %i.ab = getelementptr inbounds nuw i8, ptr %.022, i64 32
  %i.ac = load ptr, ptr %i.ab, align 8, !tbaa !17
  %i.ad = getelementptr inbounds nuw i8, ptr %.022, i64 24
