...
begin_hunk_0_@_ZNK5boost16cpp_regex_traitsIcE3toiERPKcS3_i:bb.a
          to label %_ZNSt15basic_streambufIcSt11char_traitsIcEE9pubsetbufEPcl.exit unwind label %bb.o, !inline_history !11240 ; 0 uses

_ZNSt15basic_streambufIcSt11char_traitsIcEE9pubsetbufEPcl.exit: ; preds = %_ZSt4findIPKccET_S2_S2_RKT0_.exit
  %i.bq = load ptr, ptr %5, align 8, !tbaa !421
...
bb.m:                                             ; preds = %_ZNSt15basic_streambufIcSt11char_traitsIcEE9pubsetbufEPcl.exit
  ...
  %i.bv = load ptr, ptr %5, align 8, !tbaa !421
  ...
  %i.ca = load i32, ptr %i.bz, align 8, !tbaa !11258
  ...
  store i32 %i.cc, ptr %i.bz, align 8, !tbaa !11259
...
bb.p:                                             ; preds = %bb.m
  %i.cg = load ptr, ptr %i.cd, align 8, !tbaa !421
  ...
  %i.cl = load i32, ptr %i.ck, align 8, !tbaa !11260
  %i.cm = and i32 %i.cl, 5
  %.not.i = icmp eq i32 %i.cm, 0
  br i1 %.not.i, label %bb.q, label %bb.t

bb.q:                                             ; preds = %bb.p
  %i.cn = load ptr, ptr %1, align 8, !tbaa !7178  ; 2 uses
  %i.co = getelementptr inbounds nuw i8, ptr %4, i64 24
  %i.cp = load ptr, ptr %i.co, align 8, !tbaa !9491
  %i.cq = getelementptr inbounds nuw i8, ptr %4, i64 16
  %i.cr = load ptr, ptr %i.cq, align 8, !tbaa !9492
...
bb.r:                                             ; preds = %bb.q
  %i.cv = load ptr, ptr %4, align 8, !tbaa !421
  ...
  %i.cy = invoke noundef i64 %i.cx(ptr noundef nonnull align 8 dereferenceable(64) %4)
          to label %_ZNSt15basic_streambufIcSt11char_traitsIcEE8in_availEv.exit unwind label %bb.s, !inline_history !11241
...
_ZNSt15basic_streambufIcSt11char_traitsIcEE8in_availEv.exit: ; preds = %bb.q, %bb.r
  ...
  store ptr %i.dd, ptr %1, align 8, !tbaa !7178
  %i.de = load i64, ptr %i.a, align 8, !tbaa !635
  br label %bb.t
...
bb.t:                                             ; preds = %bb.p, %_ZNSt15basic_streambufIcSt11char_traitsIcEE8in_availEv.exit
  ...
  store ptr %i.dg, ptr %5, align 8, !tbaa !421
  ...
  store ptr %i.dh, ptr %i.dk, align 8, !tbaa !421
  store i64 0, ptr %i.i, align 8, !tbaa !11257
  call void @_ZNSt8ios_baseD2Ev(ptr noundef nonnull align 8 dead_on_return(264) dereferenceable(264) %i.d) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #23
  store ptr getelementptr inbounds nuw inrange(-16, 112) (i8, ptr @_ZTVSt15basic_streambufIcSt11char_traitsIcEE, i64 16), ptr %4, align 8, !tbaa !421
  call void @_ZNSt6localeD1Ev(ptr noundef nonnull align 8 dead_on_return(8) dereferenceable(8) %i.c) #23
...
bb.u:                                             ; preds = %bb.s, %bb.o, %bb.n
  ...
  store ptr %i.dl, ptr %5, align 8, !tbaa !421
  ...
  store ptr %i.dm, ptr %i.dp, align 8, !tbaa !421
  store i64 0, ptr %i.i, align 8, !tbaa !11257
  br label %.body
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i, %.lr.ph.i.i.preheader.new
  ...
  %i.f = load i8, ptr %.0810.i.i, align 1, !tbaa !413
  ...
  %i.o = load i8, ptr %i.n, align 1, !tbaa !413
  ...
  br i1 %niter.ncmp.1, label %._crit_edge.loopexit.i.i.unr-lcssa, label %.lr.ph.i.i, !llvm.loop !376
...
.lr.ph.i.i.epil.preheader:                        ; preds = %._crit_edge.loopexit.i.i.unr-lcssa, %.lr.ph.i.i.preheader
  ...
  %i.x = load i8, ptr %.0810.i.i.epil.init, align 1, !tbaa !413
...
._crit_edge.loopexit.i.i:                         ; preds = %._crit_edge.loopexit.i.i.unr-lcssa, %.lr.ph.i.i.epil.preheader
  %.lcssa42 = phi i64 [ %i.v, %._crit_edge.loopexit.i.i.unr-lcssa ], [ %i.ae, %.lr.ph.i.i.epil.preheader ]
  %i.af = urem i64 %.lcssa42, 2147483647
...
bb.c:                                             ; preds = %_ZN5boost13re_detail_50020named_subexpressions4nameC2IcEEPKT_S6_i.exit
  %i.an = load ptr, ptr %0, align 8, !tbaa !9199  ; 9 uses
  %i.ao = ptrtoint ptr %i.aj to i64               ; 2 uses
  %i.ap = ptrtoint ptr %i.an to i64               ; 4 uses
  %i.aq = sub i64 %i.ao, %i.ap                    ; 3 uses
  %i.ar = icmp eq i64 %i.aq, 9223372036854775800
  br i1 %i.ar, label %bb.d, label %_ZNKSt6vectorIN5boost13re_detail_50020named_subexpressions4nameESaIS3_EE12_M_check_lenEmPKc.exit.i.i.i

bb.d:                                             ; preds = %bb.c
  tail call void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.18) #46
  unreachable
...
_ZNKSt6vectorIN5boost13re_detail_50020named_subexpressions4nameESaIS3_EE12_M_check_lenEmPKc.exit.i.i.i: ; preds = %bb.c
  ...
  %i.ay = tail call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.ax) #48 ; 11 uses
...
iter.check:                                       ; preds = %_ZNKSt6vectorIN5boost13re_detail_50020named_subexpressions4nameESaIS3_EE12_M_check_lenEmPKc.exit.i.i.i
...
vector.main.loop.iter.check:                      ; preds = %iter.check
  %min.iters.check27 = icmp ult i64 %i.bc, 120
  br i1 %min.iters.check27, label %vec.epilog.ph, label %vector.ph

vector.ph:                                        ; preds = %vector.main.loop.iter.check
  %i.bg = and i64 %i.be, 12
  %n.vec = and i64 %i.be, 4611686018427387888     ; 4 uses
...
vector.body:                                      ; preds = %vector.ph, %vector.body
  ...
  %next.gep = getelementptr i8, ptr %i.ay, i64 %i.bk ; 4 uses
  %next.gep28 = getelementptr i8, ptr %i.an, i64 %i.bk ; 4 uses
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %_ZNSt6vectorIN5boost13re_detail_50020named_subexpressions4nameESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit22.i.i.i, label %vec.epilog.iter.check

vec.epilog.iter.check:                            ; preds = %middle.block
  %min.epilog.iters.check = icmp eq i64 %i.bg, 0
  br i1 %min.epilog.iters.check, label %.lr.ph.i.i.i.i.i.i.preheader, label %vec.epilog.ph, !prof !1692

vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  %vec.epilog.resume.val = phi i64 [ %n.vec, %vec.epilog.iter.check ], [ 0, %vector.main.loop.iter.check ]
  %n.vec33 = and i64 %i.be, 4611686018427387900   ; 3 uses
  %i.bs = shl i64 %n.vec33, 3                     ; 2 uses
  %i.bt = getelementptr i8, ptr %i.ay, i64 %i.bs  ; 2 uses
  %i.bu = getelementptr i8, ptr %i.an, i64 %i.bs
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index34 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next38, %vec.epilog.vector.body ] ; 2 uses
  %i.bv = shl i64 %index34, 3                     ; 2 uses
  %next.gep35 = getelementptr i8, ptr %i.ay, i64 %i.bv
...
vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n39 = icmp eq i64 %i.be, %n.vec33
  br i1 %cmp.n39, label %_ZNSt6vectorIN5boost13re_detail_50020named_subexpressions4nameESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit22.i.i.i, label %.lr.ph.i.i.i.i.i.i.preheader

.lr.ph.i.i.i.i.i.i.preheader:                     ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %.012.i.i.i.i.i.i.ph = phi ptr [ %i.ay, %iter.check ], [ %i.bi, %vec.epilog.iter.check ], [ %i.bt, %vec.epilog.middle.block ]
  %.0911.i.i.i.i.i.i.ph = phi ptr [ %i.an, %iter.check ], [ %i.bj, %vec.epilog.iter.check ], [ %i.bu, %vec.epilog.middle.block ]
  br label %.lr.ph.i.i.i.i.i.i

.lr.ph.i.i.i.i.i.i:                               ; preds = %.lr.ph.i.i.i.i.i.i.preheader, %.lr.ph.i.i.i.i.i.i
  %.012.i.i.i.i.i.i = phi ptr [ %i.bz, %.lr.ph.i.i.i.i.i.i ], [ %.012.i.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.i.preheader ] ; 2 uses
  ...
  br i1 %.not.i.i.i.i.i.i, label %_ZNSt6vectorIN5boost13re_detail_50020named_subexpressions4nameESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit22.i.i.i, label %.lr.ph.i.i.i.i.i.i, !llvm.loop !11266

_ZNSt6vectorIN5boost13re_detail_50020named_subexpressions4nameESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit22.i.i.i: ; preds = %.lr.ph.i.i.i.i.i.i, %middle.block, %vec.epilog.middle.block, %_ZNKSt6vectorIN5boost13re_detail_50020named_subexpressions4nameESaIS3_EE12_M_check_lenEmPKc.exit.i.i.i
  %.0.lcssa.i.i.i.i.i.i = phi ptr [ %i.ay, %_ZNKSt6vectorIN5boost13re_detail_50020named_subexpressions4nameESaIS3_EE12_M_check_lenEmPKc.exit.i.i.i ], [ %i.bt, %vec.epilog.middle.block ], [ %i.bi, %middle.block ], [ %i.bz, %.lr.ph.i.i.i.i.i.i ]
...
bb.e:                                             ; preds = %_ZNSt6vectorIN5boost13re_detail_50020named_subexpressions4nameESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit22.i.i.i
  %i.cb = load ptr, ptr %i.ak, align 8, !tbaa !9200
  %i.cc = ptrtoint ptr %i.cb to i64
  %i.cd = sub i64 %i.cc, %i.ap
  tail call void @_ZdlPvm(ptr noundef nonnull %i.an, i64 noundef %i.cd) #49
...
_ZNSt6vectorIN5boost13re_detail_50020named_subexpressions4nameESaIS3_EE17_M_realloc_insertIJS3_EEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i.i: ; preds = %bb.e, %_ZNSt6vectorIN5boost13re_detail_50020named_subexpressions4nameESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit22.i.i.i
  store ptr %i.ay, ptr %0, align 8, !tbaa !9199
  store ptr %i.ca, ptr %i.ai, align 8, !tbaa !11268
  %i.ce = getelementptr inbounds nuw [8 x i8], ptr %i.ay, i64 %i.aw
  store ptr %i.ce, ptr %i.ak, align 8, !tbaa !9200
  br label %_ZNSt6vectorIN5boost13re_detail_50020named_subexpressions4nameESaIS3_EE9push_backEOS3_.exit
...
_ZNSt6vectorIN5boost13re_detail_50020named_subexpressions4nameESaIS3_EE9push_backEOS3_.exit: ; preds = %bb.b, %_ZNSt6vectorIN5boost13re_detail_50020named_subexpressions4nameESaIS3_EE17_M_realloc_insertIJS3_EEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i.i
  %i.cf = phi ptr [ %i.am, %bb.b ], [ %i.ca, %_ZNSt6vectorIN5boost13re_detail_50020named_subexpressions4nameESaIS3_EE17_M_realloc_insertIJS3_EEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i.i ] ; 2 uses
  %i.cg = phi ptr [ %.pre, %bb.b ], [ %i.ay, %_ZNSt6vectorIN5boost13re_detail_50020named_subexpressions4nameESaIS3_EE17_M_realloc_insertIJS3_EEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i.i ] ; 3 uses
  %i.ch = icmp eq ptr %i.cg, %i.cf
  %i.ci = getelementptr inbounds i8, ptr %i.cf, i64 -8 ; 2 uses
  %i.cj = icmp eq ptr %i.ci, %i.cg
  %or.cond.i = select i1 %i.ch, i1 true, i1 %i.cj
...
.lr.ph.i:                                         ; preds = %_ZNSt6vectorIN5boost13re_detail_50020named_subexpressions4nameESaIS3_EE9push_backEOS3_.exit, %bb.f
  %.sroa.02.012.i = phi ptr [ %i.cp, %bb.f ], [ %i.ci, %_ZNSt6vectorIN5boost13re_detail_50020named_subexpressions4nameESaIS3_EE9push_backEOS3_.exit ] ; 5 uses
  %i.ck = getelementptr inbounds nuw i8, ptr %.sroa.02.012.i, i64 4 ; 2 uses
  %i.cl = load i32, ptr %i.ck, align 4, !tbaa !9495 ; 2 uses
  %i.cm = getelementptr inbounds i8, ptr %.sroa.02.012.i, i64 -4 ; 2 uses
  %i.cn = load i32, ptr %i.cm, align 4, !tbaa !9495 ; 2 uses
  %i.co = icmp slt i32 %i.cl, %i.cn
  br i1 %i.co, label %bb.f, label %_ZN5boost13re_detail_50015bubble_down_oneIN9__gnu_cxx17__normal_iteratorIPNS0_20named_subexpressions4nameESt6vectorIS5_SaIS5_EEEEEEvT_SB_.exit

bb.f:                                             ; preds = %.lr.ph.i
  %i.cp = getelementptr inbounds i8, ptr %.sroa.02.012.i, i64 -8 ; 4 uses
  %i.cq = load i32, ptr %i.cp, align 4, !tbaa !527
  %i.cr = load i32, ptr %.sroa.02.012.i, align 4, !tbaa !527
  store i32 %i.cr, ptr %i.cp, align 4, !tbaa !527
  store i32 %i.cq, ptr %.sroa.02.012.i, align 4, !tbaa !527
  store i32 %i.cl, ptr %i.cm, align 4, !tbaa !527
  store i32 %i.cn, ptr %i.ck, align 4, !tbaa !527
  %i.cs = icmp eq ptr %i.cp, %i.cg
  br i1 %i.cs, label %_ZN5boost13re_detail_50015bubble_down_oneIN9__gnu_cxx17__normal_iteratorIPNS0_20named_subexpressions4nameESt6vectorIS5_SaIS5_EEEEEEvT_SB_.exit, label %.lr.ph.i, !llvm.loop !11267
...
bb.a:
  ...
  %i.a = load ptr, ptr %0, align 8, !tbaa !9410   ; 4 uses
  %i.b = getelementptr inbounds nuw i8, ptr %i.a, i64 40
  %i.c = load i32, ptr %i.b, align 8, !tbaa !9411
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 136 ; 7 uses
  %.promoted = load ptr, ptr %i.d, align 8, !tbaa !9414
...
bb.g:                                             ; preds = %bb.f, %bb.e, %bb.d, %bb.c
  ...
  store ptr %i.n, ptr %i.d, align 8, !tbaa !9414
  %i.o = icmp eq ptr %i.n, %i.f
  br i1 %i.o, label %.preheader46, label %bb.b

.preheader46:                                     ; preds = %bb.g
  %i.p = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.q = load ptr, ptr %i.p, align 8, !tbaa !9434, !nonnull !515, !align !559
  %i.r = load ptr, ptr %i.q, align 8, !tbaa !9232
  %i.s = getelementptr inbounds nuw i8, ptr %i.r, i64 32
  br label %bb.h

bb.h:                                             ; preds = %bb.h, %.preheader46
  %storemerge = phi ptr [ %i.x, %bb.h ], [ %i.g, %.preheader46 ] ; 4 uses
  store ptr %storemerge, ptr %i.d, align 8, !tbaa !9414
  %i.t = load i8, ptr %storemerge, align 1, !tbaa !413
  ...
  br i1 %.not, label %bb.i, label %bb.h, !llvm.loop !11271

bb.i:                                             ; preds = %bb.h
  %i.y = getelementptr inbounds nuw i8, ptr %0, i64 120
  %i.z = load ptr, ptr %i.y, align 8, !tbaa !9413
  %i.aa = ptrtoint ptr %storemerge to i64
  %i.ab = ptrtoint ptr %i.z to i64
  %i.ac = sub i64 %i.aa, %i.ab
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #23
  %i.ad = getelementptr inbounds nuw i8, ptr %i.a, i64 24
  %i.ae = load ptr, ptr %i.ad, align 8, !tbaa !9198
  %i.af = load ptr, ptr %i.ae, align 8, !tbaa !9232, !noalias !11280
  call void @_ZNK5boost13re_detail_50031cpp_regex_traits_implementationIcE12error_stringB5cxx11ENS_15regex_constants10error_typeE(ptr dead_on_unwind nonnull writable sret(%"class.std::__cxx11::basic_string") align 8 %3, ptr noundef nonnull align 8 dereferenceable(437) %i.af, i32 noundef 8)
...
bb.j:                                             ; preds = %bb.i
  %i.ag = load ptr, ptr %3, align 8, !tbaa !447   ; 2 uses
  %i.ah = getelementptr inbounds nuw i8, ptr %3, i64 16 ; 2 uses
  %i.ai = icmp eq ptr %i.ag, %i.ah
  br i1 %i.ai, label %_ZN5boost13re_detail_50018basic_regex_parserIcNS_12regex_traitsIcNS_16cpp_regex_traitsIcEEEEE4failENS_15regex_constants10error_typeEl.exit, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i: ; preds = %bb.j
  %i.aj = load i64, ptr %i.ah, align 8, !tbaa !413
  %i.ak = add i64 %i.aj, 1
  call void @_ZdlPvm(ptr noundef %i.ag, i64 noundef %i.ak) #49
  br label %_ZN5boost13re_detail_50018basic_regex_parserIcNS_12regex_traitsIcNS_16cpp_regex_traitsIcEEEEE4failENS_15regex_constants10error_typeEl.exit

bb.k:                                             ; preds = %bb.i
  %i.al = landingpad { ptr, i32 }
          cleanup
  %i.am = load ptr, ptr %3, align 8, !tbaa !447   ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i5.i: ; preds = %bb.k
  %i.ap = load i64, ptr %i.an, align 8, !tbaa !413
  %i.aq = add i64 %i.ap, 1
  call void @_ZdlPvm(ptr noundef %i.am, i64 noundef %i.aq) #49
...
_ZN5boost13re_detail_50018basic_regex_parserIcNS_12regex_traitsIcNS_16cpp_regex_traitsIcEEEEE4failENS_15regex_constants10error_typeEl.exit: ; preds = %bb.j, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #23
  br label %.thread41

bb.l:                                             ; preds = %bb.b
  %i.ar = getelementptr inbounds nuw i8, ptr %i.g, i64 1 ; 3 uses
  store ptr %i.ar, ptr %i.d, align 8, !tbaa !9414
  %i.as = icmp eq ptr %i.ar, %i.f
  br i1 %i.as, label %.preheader, label %.preheader45

.preheader:                                       ; preds = %bb.l
  %i.at = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.au = load ptr, ptr %i.at, align 8, !tbaa !9434, !nonnull !515, !align !559
  %i.av = load ptr, ptr %i.au, align 8, !tbaa !9232
...
bb.m:                                             ; preds = %bb.m, %.preheader
  ...
  store ptr %storemerge24, ptr %i.d, align 8, !tbaa !9414
  %i.ax = load i8, ptr %storemerge24, align 1, !tbaa !413
  %i.ay = zext i8 %i.ax to i64
  %i.az = getelementptr inbounds nuw i8, ptr %i.aw, i64 %i.ay
  %i.ba = load i8, ptr %i.az, align 1, !tbaa !413
