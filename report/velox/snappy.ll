...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.bj, label %middle.block, label %vector.body, !llvm.loop !153
...
vec.epilog.iter.check:                            ; preds = %middle.block
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph.i.i.preheader, label %vec.epilog.ph, !prof !154
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.bm, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !155
...
.lr.ph.i59:                                       ; preds = %bb.j, %.lr.ph.i59
  ...
  br i1 %i.bp, label %.lr.ph.i59, label %._crit_edge.i, !llvm.loop !156
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i
  ...
  br i1 %exitcond.not.i.i, label %.thread69, label %.lr.ph.i.i, !llvm.loop !157
...
vector.body240:                                   ; preds = %vector.body240, %vector.ph237
  ...
  %wide.load244 = load <2 x i64>, ptr %next.gep242, align 1, !alias.scope !158
  store <2 x i64> %wide.load244, ptr %next.gep243, align 1, !alias.scope !161, !noalias !158
  %index.next245 = add nuw i64 %index241, 1
  %i.de = icmp eq i64 %index241, %i.cs
  br i1 %i.de, label %._crit_edge91.i, label %vector.body240, !llvm.loop !163
...
.lr.ph90.i:                                       ; preds = %.lr.ph90.i.preheader253, %.lr.ph90.i
  ...
  br i1 %i.dj, label %.lr.ph90.i, label %._crit_edge91.i, !llvm.loop !164
...
vector.body202:                                   ; preds = %vector.body202, %vector.ph199
  ...
  br i1 %i.dt, label %middle.block208, label %vector.body202, !llvm.loop !165
...
vec.epilog.iter.check214:                         ; preds = %middle.block208
  ...
  br i1 %min.epilog.iters.check215, label %.lr.ph.i79.i.preheader, label %vec.epilog.ph216, !prof !154
...
vec.epilog.vector.body219:                        ; preds = %vec.epilog.vector.body219, %vec.epilog.ph216
  ...
  br i1 %i.dw, label %vec.epilog.middle.block225, label %vec.epilog.vector.body219, !llvm.loop !166
...
.lr.ph.i79.i:                                     ; preds = %.lr.ph.i79.i.preheader, %.lr.ph.i79.i
  ...
  br i1 %exitcond.not.i82.i, label %.thread69, label %.lr.ph.i79.i, !llvm.loop !167
...
.thread69:                                        ; preds = %.lr.ph.i79.i, %.lr.ph.i.i, %middle.block208, %vec.epilog.middle.block225, %middle.block, %vec.epilog.middle.block, %bb.u, %._crit_edge91.i, %bb.q, %bb.p, %._crit_edge.i
  %i.ea = load ptr, ptr %i.t, align 8, !tbaa !65
  %i.eb = getelementptr inbounds nuw i8, ptr %i.ea, i64 %spec.select57
  store ptr %i.eb, ptr %i.t, align 8, !tbaa !65
  %i.ec = load i64, ptr %i.l, align 8, !tbaa !66
  %i.ed = sub i64 %i.ec, %spec.select57           ; 3 uses
  store i64 %i.ed, ptr %i.l, align 8, !tbaa !66
  %i.ee = add i64 %spec.select57, %.235.ph109
  %i.ef = load i64, ptr %i.b, align 8, !tbaa !67
  %i.eg = add i64 %i.ef, %spec.select57
  store i64 %i.eg, ptr %i.b, align 8, !tbaa !67
  br label %.outer

bb.v:                                             ; preds = %bb.i
  store ptr %i.au, ptr %i.h, align 8, !tbaa !61
  %i.eh = load ptr, ptr %i.au, align 8, !tbaa !62
  store ptr %i.eh, ptr %i.t, align 8, !tbaa !65
  %i.ei = getelementptr inbounds nuw i8, ptr %i.as, i64 24
  %i.ej = load i64, ptr %i.ei, align 8, !tbaa !64 ; 4 uses
  store i64 %i.ej, ptr %i.l, align 8, !tbaa !66
...
.outer:                                           ; preds = %.thread69, %_ZN6snappy17SnappyIOVecWriter13AppendNoCheckEPKcm.exit
  %.pre.i136 = phi i64 [ %i.ed, %.thread69 ], [ %.pre.i133, %_ZN6snappy17SnappyIOVecWriter13AppendNoCheckEPKcm.exit ]
  %.promoted86112129 = phi i64 [ %i.ed, %.thread69 ], [ %.promoted86112126, %_ZN6snappy17SnappyIOVecWriter13AppendNoCheckEPKcm.exit ]
  ...
  %.538 = phi i64 [ %i.ee, %.thread69 ], [ %spec.select56, %_ZN6snappy17SnappyIOVecWriter13AppendNoCheckEPKcm.exit ]
  %.2 = sub i64 %.0.ph106, %spec.select57.pn      ; 2 uses
  %.not52 = icmp eq i64 %.2, 0
  br i1 %.not52, label %.thread, label %.lr.ph87.split, !llvm.loop !168
...
define internal fastcc noundef ptr @_ZN6snappy12_GLOBAL__N_115IncrementalCopyEPKcPcS3_S3_(ptr noundef %0, ptr noundef %1, ptr noundef readnone returned captures(address, ret: address, provenance) %2, ptr noundef readnone captures(address) %3) unnamed_addr #17 {
bb.a:
...
.lr.ph:                                           ; preds = %bb.b, %.lr.ph
  ...
  br i1 %i.j, label %.lr.ph, label %._crit_edge, !llvm.loop !156

._crit_edge:                                      ; preds = %.lr.ph
  %.not67 = icmp ult ptr %i.h, %2
  br i1 %.not67, label %bb.d, label %_ZN6snappy12_GLOBAL__N_119IncrementalCopySlowEPKcPcS3_.exit, !prof !22

bb.c:                                             ; preds = %bb.b
  %i.k = icmp ult ptr %1, %2
  br i1 %i.k, label %iter.check165, label %_ZN6snappy12_GLOBAL__N_119IncrementalCopySlowEPKcPcS3_.exit
...
vector.body154:                                   ; preds = %vector.body154, %vector.ph151
  ...
  br i1 %i.p, label %middle.block160, label %vector.body154, !llvm.loop !169

middle.block160:                                  ; preds = %vector.body154
  %cmp.n161 = icmp eq i64 %i.l, %n.vec153
  br i1 %cmp.n161, label %_ZN6snappy12_GLOBAL__N_119IncrementalCopySlowEPKcPcS3_.exit, label %vec.epilog.iter.check167

vec.epilog.iter.check167:                         ; preds = %middle.block160
  %min.epilog.iters.check168 = icmp eq i64 %n.mod.vf152, 0
  br i1 %min.epilog.iters.check168, label %.lr.ph.i.preheader, label %vec.epilog.ph169, !prof !154
...
vec.epilog.vector.body172:                        ; preds = %vec.epilog.vector.body172, %vec.epilog.ph169
  ...
  br i1 %i.s, label %vec.epilog.middle.block178, label %vec.epilog.vector.body172, !llvm.loop !170

vec.epilog.middle.block178:                       ; preds = %vec.epilog.vector.body172
  %cmp.n179 = icmp eq i64 %i.l, %n.vec171
  br i1 %cmp.n179, label %_ZN6snappy12_GLOBAL__N_119IncrementalCopySlowEPKcPcS3_.exit, label %.lr.ph.i.preheader
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  ...
  br i1 %exitcond.not.i, label %_ZN6snappy12_GLOBAL__N_119IncrementalCopySlowEPKcPcS3_.exit, label %.lr.ph.i, !llvm.loop !171
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %next.gep, align 1, !alias.scope !172
  store <2 x i64> %wide.load, ptr %next.gep113, align 1, !alias.scope !175, !noalias !172
  %index.next = add nuw i64 %index, 1
  %i.bg = icmp eq i64 %index, %i.au
  br i1 %i.bg, label %._crit_edge91, label %vector.body, !llvm.loop !177
...
.lr.ph90:                                         ; preds = %.lr.ph90.preheader184, %.lr.ph90
  ...
  br i1 %i.bl, label %.lr.ph90, label %._crit_edge91, !llvm.loop !178
...
bb.n:                                             ; preds = %bb.m, %bb.l
  ...
  br i1 %i.bp, label %iter.check, label %_ZN6snappy12_GLOBAL__N_119IncrementalCopySlowEPKcPcS3_.exit
...
vector.body125:                                   ; preds = %vector.body125, %vector.ph122
  ...
  br i1 %i.bu, label %middle.block131, label %vector.body125, !llvm.loop !179

middle.block131:                                  ; preds = %vector.body125
  %cmp.n132 = icmp eq i64 %i.bq, %n.vec124
  br i1 %cmp.n132, label %_ZN6snappy12_GLOBAL__N_119IncrementalCopySlowEPKcPcS3_.exit, label %vec.epilog.iter.check

vec.epilog.iter.check:                            ; preds = %middle.block131
  %min.epilog.iters.check = icmp eq i64 %n.mod.vf123, 0
  br i1 %min.epilog.iters.check, label %.lr.ph.i79.preheader, label %vec.epilog.ph, !prof !154
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.bx, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !180

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n142 = icmp eq i64 %i.bq, %n.vec136
  br i1 %cmp.n142, label %_ZN6snappy12_GLOBAL__N_119IncrementalCopySlowEPKcPcS3_.exit, label %.lr.ph.i79.preheader
...
.lr.ph.i79:                                       ; preds = %.lr.ph.i79.preheader, %.lr.ph.i79
  ...
  br i1 %exitcond.not.i82, label %_ZN6snappy12_GLOBAL__N_119IncrementalCopySlowEPKcPcS3_.exit, label %.lr.ph.i79, !llvm.loop !181

_ZN6snappy12_GLOBAL__N_119IncrementalCopySlowEPKcPcS3_.exit: ; preds = %.lr.ph.i79, %.lr.ph.i, %middle.block131, %vec.epilog.middle.block, %middle.block160, %vec.epilog.middle.block178, %bb.n, %bb.c, %bb.j, %bb.i, %._crit_edge91, %._crit_edge
  ret ptr %2
}

; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr void @_ZN6snappy18SnappyDecompressor17DecompressAllTagsINS_28SnappyDecompressionValidatorEEEvPT_(ptr noundef nonnull align 8 dereferenceable(42) %0, ptr noundef %1) local_unnamed_addr #3 comdat align 32 prefalign(32) {
bb.a:
  ...
  store ptr %i.j, ptr %i.k, align 8, !tbaa !140
  %i.l = getelementptr inbounds nuw i8, ptr %1, i64 8 ; 2 uses
  %i.m = load i64, ptr %i.l, align 8, !tbaa !91   ; 2 uses
  %.not = icmp ult ptr %i.c, %i.j
  br i1 %.not, label %bb.d, label %bb.b, !prof !19

bb.b:                                             ; preds = %bb.a
  %i.n = tail call noundef zeroext i1 @_ZN6snappy18SnappyDecompressor9RefillTagEv(ptr noundef nonnull align 8 dereferenceable(42) %0)
  br i1 %i.n, label %bb.c, label %.thread193, !prof !19

bb.c:                                             ; preds = %bb.b
  %i.o = load ptr, ptr %i.b, align 8, !tbaa !40   ; 2 uses
  ...
  store ptr %i.u, ptr %i.k, align 8, !tbaa !140
  br label %bb.d
...
.loopexit:                                        ; preds = %.loopexit.backedge, %bb.d
  ...
  %i.ac = load ptr, ptr %i.k, align 8, !tbaa !140 ; 2 uses
  %.not116 = icmp ult ptr %i.z, %i.ac
  br i1 %.not116, label %bb.g, label %bb.e, !prof !19

bb.e:                                             ; preds = %.loopexit
  store ptr %i.z, ptr %i.b, align 8, !tbaa !40
  %i.ad = call noundef zeroext i1 @_ZN6snappy18SnappyDecompressor9RefillTagEv(ptr noundef nonnull align 8 dereferenceable(42) %0)
  br i1 %i.ad, label %bb.f, label %.thread193, !prof !19

bb.f:                                             ; preds = %bb.e
  %i.ae = load ptr, ptr %i.b, align 8, !tbaa !40  ; 2 uses
  ...
  store ptr %i.ak, ptr %i.k, align 8, !tbaa !140
  br label %bb.g
...
.lr.ph:                                           ; preds = %bb.j, %bb.l
  ...
  %i.bk = load i64, ptr %1, align 8, !tbaa !89
  %.not200 = icmp ugt i64 %i.bj, %i.bk
  br i1 %.not200, label %.thread193, label %bb.k

bb.k:                                             ; preds = %.lr.ph
  %i.bl = load ptr, ptr %0, align 8, !tbaa !45    ; 2 uses
  %i.bm = load i32, ptr %i.v, align 8, !tbaa !46
  %i.bn = zext i32 %i.bm to i64
  %i.bo = load ptr, ptr %i.bl, align 8, !tbaa !47
  %i.bp = getelementptr inbounds nuw i8, ptr %i.bo, i64 32
  %i.bq = load ptr, ptr %i.bp, align 8
  call void %i.bq(ptr noundef nonnull align 8 dereferenceable(8) %i.bl, i64 noundef %i.bn) #23
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #23
  %i.br = load ptr, ptr %0, align 8, !tbaa !45    ; 2 uses
  %i.bs = load ptr, ptr %i.br, align 8, !tbaa !47
  %i.bt = getelementptr inbounds nuw i8, ptr %i.bs, i64 24
  %i.bu = load ptr, ptr %i.bt, align 8
  %i.bv = call noundef ptr %i.bu(ptr noundef nonnull align 8 dereferenceable(8) %i.br, ptr noundef nonnull %i.a) #23 ; 2 uses
  %i.bw = load i64, ptr %i.a, align 8, !tbaa !8   ; 6 uses
  %i.bx = trunc i64 %i.bw to i32
  store i32 %i.bx, ptr %i.v, align 8, !tbaa !46
...
bb.l:                                             ; preds = %bb.k
  ...
  store ptr %i.bz, ptr %i.d, align 8, !tbaa !44
  ...
  store ptr %i.cb, ptr %i.k, align 8, !tbaa !140
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #23
  %i.cc = icmp ult i64 %i.bw, %i.by
  br i1 %i.cc, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !182
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %bb.j
  ...
  %i.cg = load i64, ptr %1, align 8, !tbaa !89
...
bb.n:                                             ; preds = %bb.m
  store ptr %i.ch, ptr %i.b, align 8, !tbaa !40
  %i.ci = call noundef zeroext i1 @_ZN6snappy18SnappyDecompressor9RefillTagEv(ptr noundef nonnull align 8 dereferenceable(42) %0)
...
bb.o:                                             ; preds = %bb.g
  ...
  br i1 %.not.i, label %_ZN6snappy28SnappyDecompressionValidator14AppendFromSelfEmmPm.exit, label %.thread193
...
_ZN6snappy28SnappyDecompressionValidator14AppendFromSelfEmmPm.exit: ; preds = %bb.o
  ...
  %i.cq = load i64, ptr %1, align 8, !tbaa !89
  %.not198 = icmp ugt i64 %i.cp, %i.cq
  br i1 %.not198, label %.thread193, label %bb.r

bb.p:                                             ; preds = %bb.g
  %i.cr = zext i8 %i.am to i64
  %i.cs = getelementptr inbounds nuw [2 x i8], ptr @_ZN6snappy12_GLOBAL__N_118kLengthMinusOffsetE, i64 %i.cr
  ...
  br i1 %.not.i131, label %_ZN6snappy28SnappyDecompressionValidator14AppendFromSelfEmmPm.exit133, label %.thread193

_ZN6snappy28SnappyDecompressionValidator14AppendFromSelfEmmPm.exit133: ; preds = %bb.p
  %i.de = add i64 %i.ab, %i.da                    ; 4 uses
  %i.df = load i64, ptr %1, align 8, !tbaa !89
  %.not201 = icmp ugt i64 %i.de, %i.df
  br i1 %.not201, label %.thread193, label %bb.q

bb.q:                                             ; preds = %_ZN6snappy28SnappyDecompressionValidator14AppendFromSelfEmmPm.exit133
...
bb.r:                                             ; preds = %_ZN6snappy28SnappyDecompressionValidator14AppendFromSelfEmmPm.exit, %bb.q
  %.4 = phi i64 [ %i.de, %bb.q ], [ %i.cp, %_ZN6snappy28SnappyDecompressionValidator14AppendFromSelfEmmPm.exit ] ; 3 uses
  %.12 = phi ptr [ %i.dh, %bb.q ], [ %i.cl, %_ZN6snappy28SnappyDecompressionValidator14AppendFromSelfEmmPm.exit ] ; 3 uses
  %.not117 = icmp ult ptr %.12, %i.al
  br i1 %.not117, label %.loopexit.backedge, label %bb.s, !prof !19

bb.s:                                             ; preds = %bb.r
  store ptr %.12, ptr %i.b, align 8, !tbaa !40
  %i.di = call noundef zeroext i1 @_ZN6snappy18SnappyDecompressor9RefillTagEv(ptr noundef nonnull align 8 dereferenceable(42) %0)
...
.loopexit.sink.split:                             ; preds = %bb.s, %bb.n
  ...
  %i.dj = load ptr, ptr %i.b, align 8, !tbaa !40  ; 2 uses
  %i.dk = load ptr, ptr %i.d, align 8, !tbaa !44  ; 2 uses
  ...
  store ptr %i.dp, ptr %i.k, align 8, !tbaa !140
...
.thread193:                                       ; preds = %bb.n, %._crit_edge, %bb.p, %_ZN6snappy28SnappyDecompressionValidator14AppendFromSelfEmmPm.exit133, %bb.o, %_ZN6snappy28SnappyDecompressionValidator14AppendFromSelfEmmPm.exit, %bb.s, %bb.e, %.lr.ph, %.thread173, %bb.b
  %.6150 = phi i64 [ %i.m, %bb.b ], [ %i.bj, %.thread173 ], [ %i.bj, %.lr.ph ], [ %i.cf, %bb.n ], [ %i.cf, %._crit_edge ], [ %i.de, %_ZN6snappy28SnappyDecompressionValidator14AppendFromSelfEmmPm.exit133 ], [ %i.cp, %_ZN6snappy28SnappyDecompressionValidator14AppendFromSelfEmmPm.exit ], [ %.4, %bb.s ], [ %i.ab, %bb.o ], [ %i.ab, %bb.e ], [ %i.ab, %bb.p ]
  store i64 %.6150, ptr %i.l, align 8, !tbaa !91
  ret void
}

; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr { ptr, i64 } @_ZN6snappy20DecompressBranchlessImEESt4pairIPKhlES3_S3_lT_l(ptr noundef %0, ptr noundef %1, i64 noundef %2, i64 noundef %3, i64 noundef %4) local_unnamed_addr #3 comdat {
bb.a:
  ...
  br i1 %or.cond, label %bb.b, label %.thread145
...
bb.c:                                             ; preds = %bb.m, %bb.b
  %.0112 = phi ptr [ %i.i, %bb.b ], [ %i.bv, %bb.m ] ; 9 uses
  %.0105 = phi i64 [ %2, %bb.b ], [ %.4109133.1, %bb.m ] ; 4 uses
  %.094 = phi i64 [ 0, %bb.b ], [ %.4134.1, %bb.m ] ; 4 uses
  %.091 = phi i64 [ %i.k, %bb.b ], [ %i.bq, %bb.m ] ; 3 uses
  %i.l = getelementptr inbounds nuw i8, ptr %.0112, i64 128
  tail call void @llvm.prefetch.p0(ptr nonnull %i.l, i32 0, i32 3, i32 1)
  %i.m = getelementptr inbounds nuw [2 x i8], ptr @_ZN6snappy12_GLOBAL__N_118kLengthMinusOffsetE, i64 %.091
  %i.n = load i16, ptr %i.m, align 2, !tbaa !20   ; 2 uses
  %i.o = sext i16 %i.n to i64                     ; 2 uses
  %i.p = lshr i64 %.091, 2                        ; 2 uses
  %i.q = tail call { i64, i8 } asm "and $$3, ${0:k}\0A\09", "=r,={@ccz},0,~{cc},~{dirflag},~{fpsr},~{flags}"(i64 %.091) #22, !srcloc !148 ; 2 uses
  %i.r = extractvalue { i64, i8 } %i.q, 0         ; 4 uses
  %i.s = extractvalue { i64, i8 } %i.q, 1         ; 2 uses
  %i.t = icmp ult i8 %i.s, 2
  tail call void @llvm.assume(i1 %i.t)
  %i.u = getelementptr inbounds nuw i8, ptr %.0112, i64 %i.p
  %i.v = getelementptr inbounds nuw i8, ptr %i.u, i64 1
  %i.w = load volatile i8, ptr %i.v, align 1, !tbaa !7
  %i.x = zext i8 %i.w to i64
  %i.y = getelementptr inbounds nuw i8, ptr %.0112, i64 %i.r
  ...
  %i.ad = getelementptr inbounds nuw i8, ptr %.0112, i64 1
  %i.ae = getelementptr inbounds nuw i8, ptr %i.ad, i64 %i.r
  %i.af = getelementptr inbounds nuw i8, ptr %.0112, i64 2
  %i.ag = getelementptr inbounds nuw i8, ptr %i.af, i64 %i.p
  %i.ah = select i1 %i.ab, ptr %i.ag, ptr %i.ae   ; 8 uses
  tail call void asm sideeffect "", "r,~{dirflag},~{fpsr},~{flags}"(i64 %i.aa) #23, !srcloc !149
  %.0.copyload.i = load i32, ptr %.0112, align 1
  ...
  %i.ao = sub nsw i64 %i.o, %i.an                 ; 4 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  br i1 %.not50, label %bb.e, label %.thread135.loopexit, !prof !19

bb.e:                                             ; preds = %bb.d
  %i.ar = add i64 %.094, %.0105                   ; 3 uses
  %i.as = sub i64 %i.ar, %i.ai
  %i.at = add i64 %i.as, %i.ao
  %i.au = icmp slt i64 %i.at, 0
  %.not = icmp eq i64 %i.ai, %i.ao
  %or.cond157 = or i1 %.not, %i.au
  br i1 %or.cond157, label %.thread135.thread, label %.thread127, !prof !183
...
bb.g:                                             ; preds = %bb.f
  ...
  br i1 %.not49, label %bb.h, label %.thread135.loopexit

bb.h:                                             ; preds = %bb.g, %bb.f, %.thread127
  %.4134 = phi i64 [ 0, %.thread127 ], [ %i.ai, %bb.f ], [ %i.ai, %bb.g ] ; 4 uses
  %.4109133 = phi i64 [ %i.av, %.thread127 ], [ %i.aw, %bb.f ], [ %i.aw, %bb.g ] ; 4 uses
  ...
  %i.be = tail call { i64, i8 } asm "and $$3, ${0:k}\0A\09", "=r,={@ccz},0,~{cc},~{dirflag},~{fpsr},~{flags}"(i64 %i.ac) #22, !srcloc !148 ; 2 uses
  ...
  tail call void asm sideeffect "", "r,~{dirflag},~{fpsr},~{flags}"(i64 %i.bo) #23, !srcloc !149
  ...
  %i.cc = sub nsw i64 %i.bc, %i.cb                ; 4 uses
  %i.cd = icmp sgt i64 %i.cc, 0
  br i1 %i.cd, label %bb.k, label %bb.i, !prof !22

bb.i:                                             ; preds = %bb.h
  %i.ce = add i64 %.4134, %.4109133               ; 3 uses
...
bb.j:                                             ; preds = %bb.i
  ...
  br i1 %.not49.1, label %bb.m, label %.thread135.loopexit

bb.k:                                             ; preds = %bb.h
  %i.ci = and i16 %i.bb, 128
  %.not50.1 = icmp eq i16 %i.ci, 0
  br i1 %.not50.1, label %bb.l, label %.thread135.loopexit, !prof !19

bb.l:                                             ; preds = %bb.k
  %i.cj = add i64 %.4134, %.4109133               ; 3 uses
  %i.ck = sub i64 %i.cj, %i.bw
  %i.cl = add i64 %i.ck, %i.cc
  %i.cm = icmp slt i64 %i.cl, 0
  %.not.1 = icmp eq i64 %i.bw, %i.cc
  %or.cond157.1 = or i1 %.not.1, %i.cm
  br i1 %or.cond157.1, label %.thread135.thread, label %.thread127.1, !prof !183

.thread127.1:                                     ; preds = %bb.l
  %i.cn = add i64 %i.bw, %i.cj
  br label %bb.m

bb.m:                                             ; preds = %.thread127.1, %bb.j, %bb.i
  %.4134.1 = phi i64 [ 0, %.thread127.1 ], [ %i.bw, %bb.i ], [ %i.bw, %bb.j ] ; 2 uses
  %.4109133.1 = phi i64 [ %i.cn, %.thread127.1 ], [ %i.ce, %bb.i ], [ %i.ce, %bb.j ] ; 2 uses
  %i.co = icmp ult ptr %i.bv, %i.h
  %i.cp = add i64 %.4134.1, %.4109133.1           ; 2 uses
  %i.cq = icmp ult i64 %i.cp, %i.b
  %or.cond156 = select i1 %i.co, i1 %i.cq, i1 false
  br i1 %or.cond156, label %bb.c, label %.thread135, !llvm.loop !184

.thread135.thread:                                ; preds = %bb.l, %bb.e
  %.1113170.lcssa182 = phi ptr [ %.0112, %bb.e ], [ %i.ah, %bb.l ]
  %.lcssa = phi i64 [ %i.ar, %bb.e ], [ %i.cj, %bb.l ]
  %i.cr = getelementptr inbounds i8, ptr %.1113170.lcssa182, i64 -1
  br label %.thread145

.thread135.loopexit:                              ; preds = %bb.k, %bb.j, %bb.g, %bb.d
  %.195172.lcssa = phi i64 [ %.094, %bb.g ], [ %.094, %bb.d ], [ %.4134, %bb.j ], [ %.4134, %bb.k ]
  %.1106171.lcssa = phi i64 [ %.0105, %bb.g ], [ %.0105, %bb.d ], [ %.4109133, %bb.j ], [ %.4109133, %bb.k ]
  %.1113170.lcssa = phi ptr [ %.0112, %bb.g ], [ %.0112, %bb.d ], [ %i.ah, %bb.j ], [ %i.ah, %bb.k ]
  %.pre = add i64 %.195172.lcssa, %.1106171.lcssa
  br label %.thread135

.thread135:                                       ; preds = %bb.m, %.thread135.loopexit
  %.pre-phi = phi i64 [ %.pre, %.thread135.loopexit ], [ %i.cp, %bb.m ]
  %.1113169 = phi ptr [ %.1113170.lcssa, %.thread135.loopexit ], [ %i.bv, %bb.m ]
  %i.cs = getelementptr inbounds i8, ptr %.1113169, i64 -1
  br label %.thread145

.thread145:                                       ; preds = %.thread135, %.thread135.thread, %bb.a
  %.4116150 = phi ptr [ %i.cs, %.thread135 ], [ %i.cr, %.thread135.thread ], [ %0, %bb.a ]
  %.7 = phi i64 [ %.pre-phi, %.thread135 ], [ %.lcssa, %.thread135.thread ], [ %2, %bb.a ]
  %.fca.0.insert = insertvalue { ptr, i64 } poison, ptr %.4116150, 0
...
; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr void @_ZN6snappy18SnappyDecompressor17DecompressAllTagsINS_17SnappyArrayWriterEEEvPT_(ptr noundef nonnull align 8 dereferenceable(42) %0, ptr noundef %1) local_unnamed_addr #3 comdat align 32 prefalign(32) {
bb.a:
  %i.a = alloca i64, align 8                      ; 5 uses
...
bb.b:                                             ; preds = %bb.a
  %i.n = tail call noundef zeroext i1 @_ZN6snappy18SnappyDecompressor9RefillTagEv(ptr noundef nonnull align 8 dereferenceable(42) %0)
  br i1 %i.n, label %bb.c, label %_ZN6snappy17SnappyArrayWriter14AppendFromSelfEmmPPc.exit126.thread210, !prof !19
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.r = ptrtoint ptr %i.o to i64
  %i.s = sub i64 %i.q, %i.r
  %.sroa.speculated.i128 = tail call i64 @llvm.smin.i64(i64 %i.s, i64 4)
  %i.t = sub i64 0, %.sroa.speculated.i128
  %i.u = getelementptr inbounds i8, ptr %i.p, i64 %i.t
  store ptr %i.u, ptr %i.k, align 8, !tbaa !140
  br label %bb.d

bb.d:                                             ; preds = %bb.c, %bb.a
  %.0 = phi ptr [ %i.o, %bb.c ], [ %i.c, %bb.a ]  ; 2 uses
  %i.v = load i8, ptr %.0, align 1, !tbaa !7
...
_ZN6snappy17SnappyArrayWriter14AppendFromSelfEmmPPc.exit126: ; preds = %_ZN6snappy17SnappyArrayWriter14AppendFromSelfEmmPPc.exit126.backedge, %bb.d
  %.0157 = phi i32 [ %i.w, %bb.d ], [ %.0157.be, %_ZN6snappy17SnappyArrayWriter14AppendFromSelfEmmPPc.exit126.backedge ]
  %.0147 = phi ptr [ %i.m, %bb.d ], [ %.0147.be, %_ZN6snappy17SnappyArrayWriter14AppendFromSelfEmmPPc.exit126.backedge ] ; 2 uses
  %.1 = phi ptr [ %.0, %bb.d ], [ %.1.be, %_ZN6snappy17SnappyArrayWriter14AppendFromSelfEmmPPc.exit126.backedge ] ; 2 uses
  %i.aa = load ptr, ptr %1, align 8, !tbaa !75    ; 4 uses
  %.not115 = icmp eq ptr %i.aa, null
  br i1 %.not115, label %bb.i, label %bb.e

bb.e:                                             ; preds = %_ZN6snappy17SnappyArrayWriter14AppendFromSelfEmmPPc.exit126
  %i.ab = load ptr, ptr %i.x, align 8, !tbaa !79
  %i.ac = ptrtoint ptr %i.ab to i64
  %i.ad = ptrtoint ptr %i.aa to i64               ; 2 uses
  %i.ae = sub i64 %i.ac, %i.ad
  %i.af = load ptr, ptr %i.d, align 8, !tbaa !44
  %i.ag = ptrtoint ptr %.0147 to i64
  ...
  %i.am = load ptr, ptr %i.k, align 8, !tbaa !140
  %.not116 = icmp ult ptr %i.aj, %i.am
  br i1 %.not116, label %bb.h, label %bb.f, !prof !19

bb.f:                                             ; preds = %bb.e
  store ptr %i.aj, ptr %i.b, align 8, !tbaa !40
  %i.an = call noundef zeroext i1 @_ZN6snappy18SnappyDecompressor9RefillTagEv(ptr noundef nonnull align 8 dereferenceable(42) %0)
  br i1 %i.an, label %bb.g, label %_ZN6snappy17SnappyArrayWriter14AppendFromSelfEmmPPc.exit126.thread210, !prof !19

bb.g:                                             ; preds = %bb.f
  %i.ao = load ptr, ptr %i.b, align 8, !tbaa !40  ; 2 uses
  %i.ap = load ptr, ptr %i.d, align 8, !tbaa !44  ; 2 uses
  %i.aq = ptrtoint ptr %i.ap to i64
  %i.ar = ptrtoint ptr %i.ao to i64
  %i.as = sub i64 %i.aq, %i.ar
  %.sroa.speculated.i129 = call i64 @llvm.smin.i64(i64 %i.as, i64 4)
  %i.at = sub i64 0, %.sroa.speculated.i129
  %i.au = getelementptr inbounds i8, ptr %i.ap, i64 %i.at
  store ptr %i.au, ptr %i.k, align 8, !tbaa !140
  br label %bb.h

bb.h:                                             ; preds = %bb.e, %bb.g
  %.2 = phi ptr [ %i.ao, %bb.g ], [ %i.aj, %bb.e ] ; 2 uses
  %i.av = load i8, ptr %.2, align 1, !tbaa !7
  %i.aw = zext i8 %i.av to i32
  br label %bb.i

bb.i:                                             ; preds = %_ZN6snappy17SnappyArrayWriter14AppendFromSelfEmmPPc.exit126, %bb.h
  %.2159.ph = phi i32 [ %i.aw, %bb.h ], [ %.0157, %_ZN6snappy17SnappyArrayWriter14AppendFromSelfEmmPPc.exit126 ] ; 2 uses
  %.1148.ph = phi ptr [ %i.al, %bb.h ], [ %.0147, %_ZN6snappy17SnappyArrayWriter14AppendFromSelfEmmPPc.exit126 ] ; 23 uses
  %.5.ph = phi ptr [ %.2, %bb.h ], [ %.1, %_ZN6snappy17SnappyArrayWriter14AppendFromSelfEmmPPc.exit126 ] ; 2 uses
  %i.ax = getelementptr inbounds nuw i8, ptr %.5.ph, i64 1 ; 9 uses
  %i.ay = and i32 %.2159.ph, 255                  ; 5 uses
  %i.az = and i32 %.2159.ph, 3                    ; 3 uses
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.bh = load ptr, ptr %i.y, align 8, !tbaa !78
  %i.bi = ptrtoint ptr %i.bh to i64
  %i.bj = ptrtoint ptr %.1148.ph to i64
  %i.bk = sub i64 %i.bi, %i.bj                    ; 2 uses
  %i.bl = icmp samesign ult i32 %i.ay, 64
  %i.bm = icmp ugt i64 %i.bg, 20
  %or.cond.i130 = and i1 %i.bl, %i.bm
  %i.bn = icmp ugt i64 %i.bk, 15
  %or.cond3.i = select i1 %or.cond.i130, i1 %i.bn, i1 false
  br i1 %or.cond3.i, label %bb.k, label %_ZN6snappy17SnappyArrayWriter13TryFastAppendEPKcmmPPc.exit

bb.k:                                             ; preds = %bb.j
  call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(16) %.1148.ph, ptr noundef nonnull readonly align 1 dereferenceable(16) %i.ax, i64 16, i1 false)
  %i.bo = getelementptr inbounds nuw i8, ptr %.1148.ph, i64 %i.bc
...
_ZN6snappy17SnappyArrayWriter14AppendFromSelfEmmPPc.exit126.backedge: ; preds = %bb.k, %bb.s, %bb.af, %_ZN6snappy17SnappyArrayWriter14AppendFromSelfEmmPPc.exit
  %.0157.be = phi i32 [ %i.gd, %bb.af ], [ %i.fr, %_ZN6snappy17SnappyArrayWriter14AppendFromSelfEmmPPc.exit ], [ %i.br, %bb.k ], [ %i.dn, %bb.s ]
  %.0147.be = phi ptr [ %.4, %bb.af ], [ %i.ex, %_ZN6snappy17SnappyArrayWriter14AppendFromSelfEmmPPc.exit ], [ %i.bo, %bb.k ], [ %i.db, %bb.s ]
  %.1.be = phi ptr [ %.13, %bb.af ], [ %i.fq, %_ZN6snappy17SnappyArrayWriter14AppendFromSelfEmmPPc.exit ], [ %i.bp, %bb.k ], [ %.8, %bb.s ]
  br label %_ZN6snappy17SnappyArrayWriter14AppendFromSelfEmmPPc.exit126, !llvm.loop !185

_ZN6snappy17SnappyArrayWriter13TryFastAppendEPKcmmPPc.exit: ; preds = %bb.j
  %i.bs = icmp samesign ugt i32 %i.ay, 236
  br i1 %i.bs, label %bb.l, label %bb.m, !prof !22
...
bb.l:                                             ; preds = %_ZN6snappy17SnappyArrayWriter13TryFastAppendEPKcmmPPc.exit
  ...
  %.pre239 = ptrtoint ptr %i.cc to i64
  %.pre240 = sub i64 %i.be, %.pre239
  br label %bb.m

bb.m:                                             ; preds = %bb.l, %_ZN6snappy17SnappyArrayWriter13TryFastAppendEPKcmmPPc.exit
  %.pre-phi241 = phi i64 [ %.pre240, %bb.l ], [ %i.bg, %_ZN6snappy17SnappyArrayWriter13TryFastAppendEPKcmmPPc.exit ] ; 2 uses
  %.099 = phi i64 [ %i.cb, %bb.l ], [ %i.bc, %_ZN6snappy17SnappyArrayWriter13TryFastAppendEPKcmmPPc.exit ] ; 3 uses
  %.6 = phi ptr [ %i.cc, %bb.l ], [ %i.ax, %_ZN6snappy17SnappyArrayWriter13TryFastAppendEPKcmmPPc.exit ] ; 2 uses
  %i.cd = icmp ult i64 %.pre-phi241, %.099
  br i1 %i.cd, label %.lr.ph, label %._crit_edge

.lr.ph:                                           ; preds = %bb.m, %bb.o
  %.7228 = phi ptr [ %i.ct, %bb.o ], [ %.6, %bb.m ]
  %.1100227 = phi i64 [ %i.cw, %bb.o ], [ %.099, %bb.m ]
  %.0101226 = phi i64 [ %i.cu, %bb.o ], [ %.pre-phi241, %bb.m ] ; 4 uses
  %.2149225 = phi ptr [ %i.ci, %bb.o ], [ %.1148.ph, %bb.m ] ; 4 uses
  %i.ce = load ptr, ptr %i.y, align 8, !tbaa !78
  %i.cf = ptrtoint ptr %i.ce to i64
  %i.cg = ptrtoint ptr %.2149225 to i64
  %i.ch = sub i64 %i.cf, %i.cg
  %.not216 = icmp ult i64 %i.ch, %.0101226
  br i1 %.not216, label %_ZN6snappy17SnappyArrayWriter14AppendFromSelfEmmPPc.exit126.thread210, label %bb.n

bb.n:                                             ; preds = %.lr.ph
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %.2149225, ptr align 1 %.7228, i64 %.0101226, i1 false)
  %i.ci = getelementptr inbounds nuw i8, ptr %.2149225, i64 %.0101226 ; 4 uses
  %i.cj = load ptr, ptr %0, align 8, !tbaa !45    ; 2 uses
  %i.ck = load i32, ptr %i.z, align 8, !tbaa !46
  %i.cl = zext i32 %i.ck to i64
  %i.cm = load ptr, ptr %i.cj, align 8, !tbaa !47
  %i.cn = getelementptr inbounds nuw i8, ptr %i.cm, i64 32
  %i.co = load ptr, ptr %i.cn, align 8
  call void %i.co(ptr noundef nonnull align 8 dereferenceable(8) %i.cj, i64 noundef %i.cl) #23
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #23
  %i.cp = load ptr, ptr %0, align 8, !tbaa !45    ; 2 uses
  %i.cq = load ptr, ptr %i.cp, align 8, !tbaa !47
  %i.cr = getelementptr inbounds nuw i8, ptr %i.cq, i64 24
  %i.cs = load ptr, ptr %i.cr, align 8
  %i.ct = call noundef ptr %i.cs(ptr noundef nonnull align 8 dereferenceable(8) %i.cp, ptr noundef nonnull %i.a) #23 ; 3 uses
  %i.cu = load i64, ptr %i.a, align 8, !tbaa !8   ; 6 uses
  %i.cv = trunc i64 %i.cu to i32
  store i32 %i.cv, ptr %i.z, align 8, !tbaa !46
  %.not119 = icmp eq i64 %i.cu, 0
  br i1 %.not119, label %.thread184, label %bb.o

.thread184:                                       ; preds = %bb.n
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #23
  br label %_ZN6snappy17SnappyArrayWriter14AppendFromSelfEmmPPc.exit126.thread210

bb.o:                                             ; preds = %bb.n
  %i.cw = sub i64 %.1100227, %.0101226            ; 3 uses
  %i.cx = getelementptr inbounds nuw i8, ptr %i.ct, i64 %i.cu ; 2 uses
  store ptr %i.cx, ptr %i.d, align 8, !tbaa !44
  %.sroa.speculated.i131 = call i64 @llvm.smin.i64(i64 %i.cu, i64 4)
  %i.cy = sub i64 0, %.sroa.speculated.i131
  %i.cz = getelementptr inbounds i8, ptr %i.cx, i64 %i.cy
  store ptr %i.cz, ptr %i.k, align 8, !tbaa !140
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #23
  %i.da = icmp ult i64 %i.cu, %i.cw
  br i1 %i.da, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !186
...
bb.f:                                             ; preds = %bb.e
  %i.ad = load ptr, ptr %i.y, align 8, !tbaa !187
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.bl = load ptr, ptr %i.aa, align 8, !tbaa !188
...
bb.n:                                             ; preds = %bb.m, %_ZN6snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE13TryFastAppendEPKcmmPPc.exit
  %.pre-phi201 = phi i64 [ %.pre200, %bb.m ], [ %i.bj, %_ZN6snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE13TryFastAppendEPKcmmPPc.exit ] ; 2 uses
  %.099 = phi i64 [ %i.cg, %bb.m ], [ %i.bf, %_ZN6snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE13TryFastAppendEPKcmmPPc.exit ] ; 3 uses
...
.lr.ph:                                           ; preds = %bb.n, %bb.p
  ...
  %i.ck = load ptr, ptr %i.aa, align 8, !tbaa !188
...
bb.p:                                             ; preds = %bb.o
  ...
  br i1 %i.di, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !190

._crit_edge.loopexit:                             ; preds = %bb.p
  %.pre = load ptr, ptr %i.a, align 8, !tbaa !141 ; 2 uses
  %.pre196 = load ptr, ptr %i.aa, align 8, !tbaa !188
...
bb.v:                                             ; preds = %bb.j
  ...
  %or.cond.not.i = select i1 %i.ev, i1 true, i1 %.not.i135, !prof !183
...
bb.x:                                             ; preds = %bb.w
  ...
  br i1 %i.fd, label %_ZN6snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE14AppendFromSelfEmmPPc.exit, label %bb.y, !prof !22
...
_ZN6snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE14AppendFromSelfEmmPPc.exit.thread169: ; preds = %bb.z, %bb.y
...
bb.aa:                                            ; preds = %_ZN6snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE14AppendFromSelfEmmPPc.exit, %_ZN6snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE14AppendFromSelfEmmPPc.exit.thread169
  ...
  br i1 %.not183, label %.backedge, label %.thread, !prof !146
...
bb.ab:                                            ; preds = %bb.u
  ...
  br i1 %i.fr, label %bb.ad, label %.thread, !prof !147

.thread:                                          ; preds = %bb.aa, %bb.ab
  %.12228 = phi ptr [ %i.fq, %bb.ab ], [ %i.fn, %bb.aa ]
  store ptr %.12228, ptr %i.c, align 8, !tbaa !40
...
.thread179:                                       ; preds = %bb.u, %bb.r, %_ZN6snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE6AppendEPKcmPPc.exit131, %bb.w, %_ZN6snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE14AppendFromSelfEmmPPc.exit, %.thread, %bb.g, %_ZN6snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE6AppendEPKcmPPc.exit, %.thread164, %bb.b
  %i.gc = load ptr, ptr %i.a, align 8, !tbaa !141
  store ptr %i.gc, ptr %i.m, align 8, !tbaa !125
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #23
  ret void
}
...
bb.a:
  ...
  %or.cond.not = select i1 %i.g, i1 true, i1 %.not, !prof !183
...
bb.c:                                             ; preds = %bb.b
  ...
  store ptr %i.af, ptr %i.a, align 8, !tbaa !188
  ...
  store ptr %i.ah, ptr %i.k, align 8, !tbaa !187
  %i.ai = load ptr, ptr %i.m, align 8, !tbaa !191 ; 4 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  store ptr %i.ak, ptr %i.m, align 8, !tbaa !191
...
_ZNSt6vectorIPcSaIS0_EE17_M_realloc_insertIJRKS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i: ; preds = %bb.h, %_ZNSt6vectorIPcSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit16.i.i
  ...
  store ptr %i.az, ptr %i.m, align 8, !tbaa !191
...
_ZNSt6vectorIPcSaIS0_EE9push_backERKS0_.exit:     ; preds = %bb.d, %_ZNSt6vectorIPcSaIS0_EE17_M_realloc_insertIJRKS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i
  ...
  br i1 %.not38, label %bb.b, label %._crit_edge.loopexit, !llvm.loop !192
...
; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr noundef ptr @_ZN6snappy19SnappySinkAllocator8AllocateEi(ptr noundef nonnull align 8 dereferenceable(32) %0, i32 noundef %1) local_unnamed_addr #3 comdat align 2 {
bb.a:
  %i.a = sext i32 %1 to i64                       ; 3 uses
  %i.b = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %i.a) #20 ; 3 uses
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 3 uses
  %i.e = load ptr, ptr %i.d, align 8, !tbaa !128  ; 7 uses
...
bb.c:                                             ; preds = %bb.a
  ...
  br i1 %i.m, label %bb.d, label %_ZNKSt6vectorIN6snappy19SnappySinkAllocator9DatablockESaIS2_EE12_M_check_lenEmPKc.exit.i.i
...
_ZNKSt6vectorIN6snappy19SnappySinkAllocator9DatablockESaIS2_EE12_M_check_lenEmPKc.exit.i.i: ; preds = %bb.c
  ...
  store ptr %i.b, ptr %i.u, align 8, !tbaa !141
  ...
  br i1 %.not10.i.i.i.i.i, label %_ZNSt6vectorIN6snappy19SnappySinkAllocator9DatablockESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit22.i.i, label %.lr.ph.i.i.i.i.i

.lr.ph.i.i.i.i.i:                                 ; preds = %_ZNKSt6vectorIN6snappy19SnappySinkAllocator9DatablockESaIS2_EE12_M_check_lenEmPKc.exit.i.i, %.lr.ph.i.i.i.i.i
  %.012.i.i.i.i.i = phi ptr [ %i.w, %.lr.ph.i.i.i.i.i ], [ %i.t, %_ZNKSt6vectorIN6snappy19SnappySinkAllocator9DatablockESaIS2_EE12_M_check_lenEmPKc.exit.i.i ] ; 2 uses
  %.0911.i.i.i.i.i = phi ptr [ %i.v, %.lr.ph.i.i.i.i.i ], [ %i.i, %_ZNKSt6vectorIN6snappy19SnappySinkAllocator9DatablockESaIS2_EE12_M_check_lenEmPKc.exit.i.i ] ; 2 uses
  ...
  %i.v = getelementptr inbounds nuw i8, ptr %.0911.i.i.i.i.i, i64 16 ; 2 uses
  %i.w = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i.i, i64 16 ; 2 uses
  %.not.i.i.i.i.i = icmp eq ptr %i.v, %i.e
  br i1 %.not.i.i.i.i.i, label %_ZNSt6vectorIN6snappy19SnappySinkAllocator9DatablockESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit22.i.i, label %.lr.ph.i.i.i.i.i, !llvm.loop !198

_ZNSt6vectorIN6snappy19SnappySinkAllocator9DatablockESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit22.i.i: ; preds = %.lr.ph.i.i.i.i.i, %_ZNKSt6vectorIN6snappy19SnappySinkAllocator9DatablockESaIS2_EE12_M_check_lenEmPKc.exit.i.i
  %.0.lcssa.i.i.i.i.i = phi ptr [ %i.t, %_ZNKSt6vectorIN6snappy19SnappySinkAllocator9DatablockESaIS2_EE12_M_check_lenEmPKc.exit.i.i ], [ %i.w, %.lr.ph.i.i.i.i.i ]
  %i.x = getelementptr inbounds nuw i8, ptr %.0.lcssa.i.i.i.i.i, i64 16
...
_ZNSt6vectorIN6snappy19SnappySinkAllocator9DatablockESaIS2_EE17_M_realloc_insertIJRKS2_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i: ; preds = %bb.e, %_ZNSt6vectorIN6snappy19SnappySinkAllocator9DatablockESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit22.i.i
  store ptr %i.t, ptr %i.c, align 8, !tbaa !127
  store ptr %i.x, ptr %i.d, align 8, !tbaa !128
  %i.y = getelementptr inbounds nuw [16 x i8], ptr %i.t, i64 %i.r
  store ptr %i.y, ptr %i.f, align 8, !tbaa !135
  br label %_ZNSt6vectorIN6snappy19SnappySinkAllocator9DatablockESaIS2_EE9push_backERKS2_.exit
...
; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr noundef zeroext i1 @_ZN6snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE18SlowAppendFromSelfEmm(ptr noundef nonnull align 8 dereferenceable(104) %0, i64 noundef %1, i64 noundef %2) local_unnamed_addr #3 comdat align 2 {
bb.a:
  %i.a = alloca i8, align 1                       ; 5 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 64
  %i.c = load i64, ptr %i.b, align 8, !tbaa !126
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.n = load i64, ptr %i.m, align 8, !tbaa !115
  %i.o = sub i64 %i.n, %i.k
...
bb.d:                                             ; preds = %.lr.ph, %bb.e
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #23
  %i.u = lshr i64 %.034, 16
  %i.v = load ptr, ptr %i.r, align 8, !tbaa !133
  ...
  %i.ab = load ptr, ptr %i.s, align 8, !tbaa !188
...
_ZN6snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE6AppendEPKcmPPc.exit: ; preds = %bb.d
  store ptr %.02133, ptr %i.d, align 8, !tbaa !125
  ...
  %i.ae = load ptr, ptr %i.d, align 8, !tbaa !125
...
bb.e:                                             ; preds = %_ZN6snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE6AppendEPKcmPPc.exit, %_ZN6snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE6AppendEPKcmPPc.exit.thread
  %storemerge.i25 = phi ptr [ %i.ac, %_ZN6snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE6AppendEPKcmPPc.exit.thread ], [ %i.ae, %_ZN6snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEE6AppendEPKcmPPc.exit ] ; 2 uses
  %i.af = add i64 %.034, 1
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #23
...
._crit_edge:                                      ; preds = %bb.e, %bb.c
  ...
  store ptr %.021.lcssa, ptr %i.d, align 8, !tbaa !125
  br label %bb.f
...
; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr void @_ZN6snappy19SnappySinkAllocator7DeleterEPvPKcm(ptr noundef %0, ptr noundef %1, i64 noundef %2) #3 comdat align 2 {
bb.a:
...
attributes #6 = { mustprogress nounwind memory(readwrite, inaccessiblemem: none, target_mem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
attributes #17 = { inlinehint mustprogress nofree norecurse nosync nounwind memory(argmem: readwrite) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
!9 = !{!"long", !5, i64 0}
!10 = !{!11, !9, i64 8}
!11 = !{!"_ZTSN6snappy8internal13WorkingMemoryE", !12, i64 0, !9, i64 8, !14, i64 16, !12, i64 24, !12, i64 32}
...
!27 = !{i64 121673, i64 121690, i64 121720}
!28 = !{!"branch_weights", i32 127, i32 1}
!29 = !{i64 122674, i64 122691, i64 122721}
!30 = distinct !{!30, !26}
...
!39 = !{!13, !13, i64 0}
!40 = !{!41, !12, i64 8}
!41 = !{!"_ZTSN6snappy18SnappyDecompressorE", !42, i64 0, !12, i64 8, !12, i64 16, !12, i64 24, !4, i64 32, !43, i64 36, !5, i64 37}
!42 = !{!"p1 _ZTSN6snappy6SourceE", !13, i64 0}
!43 = !{!"bool", !5, i64 0}
!44 = !{!41, !12, i64 16}
!45 = !{!41, !42, i64 0}
!46 = !{!41, !4, i64 32}
...
!53 = distinct !{!53, !26}
!54 = !{!55, !12, i64 8}
!55 = !{!"_ZTSN6snappy15ByteArraySourceE", !56, i64 0, !12, i64 8, !9, i64 16}
!56 = !{!"_ZTSN6snappy6SourceE"}
!57 = !{!55, !9, i64 16}
!58 = !{!59, !60, i64 0}
!59 = !{!"_ZTSN6snappy17SnappyIOVecWriterE", !60, i64 0, !60, i64 8, !12, i64 16, !9, i64 24, !9, i64 32, !9, i64 40}
!60 = !{!"p1 _ZTS5iovec", !13, i64 0}
!61 = !{!59, !60, i64 8}
!62 = !{!63, !13, i64 0}
!63 = !{!"_ZTS5iovec", !13, i64 0, !9, i64 8}
!64 = !{!63, !9, i64 8}
!65 = !{!59, !12, i64 16}
!66 = !{!59, !9, i64 24}
!67 = !{!59, !9, i64 32}
!68 = !{!59, !9, i64 40}
!69 = distinct !{ptr @_ZN6snappy20RawUncompressToIOVecEPNS_6SourceEPK5iovecm, null}
!70 = !{i8 0, i8 2}
!71 = !{}
!72 = distinct !{ptr @_ZN6snappy20RawUncompressToIOVecEPNS_6SourceEPK5iovecm, null, null}
!73 = distinct !{null}
!74 = distinct !{null, null}
!75 = !{!76, !12, i64 0}
!76 = !{!"_ZTSN6snappy17SnappyArrayWriterE", !12, i64 0, !12, i64 8, !12, i64 16, !12, i64 24}
!77 = !{!76, !12, i64 8}
!78 = !{!76, !12, i64 16}
!79 = !{!76, !12, i64 24}
!80 = distinct !{ptr @_ZN6snappy13RawUncompressEPNS_6SourceEPc, null}
!81 = distinct !{ptr @_ZN6snappy13RawUncompressEPNS_6SourceEPc, null, null}
!82 = distinct !{null}
!83 = distinct !{null, null}
!84 = !{!85, !9, i64 8}
!85 = !{!"_ZTSNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE", !86, i64 0, !9, i64 8, !5, i64 16}
!86 = !{!"_ZTSNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE12_Alloc_hiderE", !12, i64 0}
!87 = !{!85, !12, i64 0}
!88 = distinct !{null}
!89 = !{!90, !9, i64 0}
!90 = !{!"_ZTSN6snappy28SnappyDecompressionValidatorE", !9, i64 0, !9, i64 8}
!91 = !{!90, !9, i64 8}
!92 = distinct !{null, null}
!93 = !{!94, !12, i64 8}
!94 = !{!"_ZTSN6snappy22UncheckedByteArraySinkE", !95, i64 0, !12, i64 8}
!95 = !{!"_ZTSN6snappy4SinkE"}
!96 = !{!97, !60, i64 8}
!97 = !{!"_ZTSN6snappy17SnappyIOVecReaderE", !56, i64 0, !60, i64 8, !12, i64 16, !9, i64 24, !9, i64 32}
!98 = !{!97, !12, i64 16}
!99 = !{!97, !9, i64 24}
!100 = !{!97, !9, i64 32}
!101 = distinct !{!101, !26}
!102 = distinct !{!102, !26, !103, !104}
!103 = !{!"llvm.loop.isvectorized", i32 1}
!104 = !{!"llvm.loop.unroll.runtime.disable"}
!105 = distinct !{!105, !26, !104, !103}
!106 = !{!107, !108, i64 0}
!107 = !{!"_ZTSN6snappy19SnappySinkAllocatorE", !108, i64 0, !109, i64 8}
!108 = !{!"p1 _ZTSN6snappy4SinkE", !13, i64 0}
!109 = !{!"_ZTSSt6vectorIN6snappy19SnappySinkAllocator9DatablockESaIS2_EE", !110, i64 0}
!110 = !{!"_ZTSSt12_Vector_baseIN6snappy19SnappySinkAllocator9DatablockESaIS2_EE", !111, i64 0}
!111 = !{!"_ZTSNSt12_Vector_baseIN6snappy19SnappySinkAllocator9DatablockESaIS2_EE12_Vector_implE", !112, i64 0}
!112 = !{!"_ZTSNSt12_Vector_baseIN6snappy19SnappySinkAllocator9DatablockESaIS2_EE17_Vector_impl_dataE", !113, i64 0, !113, i64 8, !113, i64 16}
!113 = !{!"p1 _ZTSN6snappy19SnappySinkAllocator9DatablockE", !13, i64 0}
!114 = distinct !{null}
!115 = !{!116, !9, i64 56}
!116 = !{!"_ZTSN6snappy21SnappyScatteredWriterINS_19SnappySinkAllocatorEEE", !107, i64 0, !117, i64 32, !9, i64 56, !9, i64 64, !12, i64 72, !12, i64 80, !12, i64 88, !12, i64 96}
!117 = !{!"_ZTSSt6vectorIPcSaIS0_EE", !118, i64 0}
!118 = !{!"_ZTSSt12_Vector_baseIPcSaIS0_EE", !119, i64 0}
!119 = !{!"_ZTSNSt12_Vector_baseIPcSaIS0_EE12_Vector_implE", !120, i64 0}
!120 = !{!"_ZTSNSt12_Vector_baseIPcSaIS0_EE17_Vector_impl_dataE", !121, i64 0, !121, i64 8, !121, i64 16}
!121 = !{!"p2 omnipotent char", !122, i64 0}
!122 = !{!"any p2 pointer", !13, i64 0}
!123 = !{!113, !113, i64 0}
!124 = !{!116, !12, i64 72}
!125 = !{!116, !12, i64 80}
!126 = !{!116, !9, i64 64}
...
!128 = !{!112, !113, i64 8}
!129 = !{!130, !12, i64 0}
!130 = !{!"_ZTSN6snappy19SnappySinkAllocator9DatablockE", !12, i64 0, !9, i64 8}
...
!148 = !{i64 45836, i64 45859}
!149 = !{i64 47038}
!150 = !{!"branch_weights", i32 1, i32 1048575}
!151 = distinct !{!151, !26}
!152 = distinct !{!152, !26}
!153 = distinct !{!153, !26, !34, !103, !104}
!154 = !{!"branch_weights", i32 4, i32 12}
!155 = distinct !{!155, !26, !34, !103, !104}
!156 = distinct !{!156, !26}
!157 = distinct !{!157, !26, !34, !103}
!158 = !{!159}
!159 = distinct !{!159, !160}
!160 = distinct !{!160, !"LVerDomain"}
!161 = !{!162}
!162 = distinct !{!162, !160}
!163 = distinct !{!163, !26, !34, !103, !104}
!164 = distinct !{!164, !26, !34, !103}
!165 = distinct !{!165, !26, !34, !103, !104}
!166 = distinct !{!166, !26, !34, !103, !104}
!167 = distinct !{!167, !26, !34, !103}
!168 = distinct !{!168, !26}
!169 = distinct !{!169, !26, !34, !103, !104}
!170 = distinct !{!170, !26, !34, !103, !104}
!171 = distinct !{!171, !26, !34, !103}
!172 = !{!173}
!173 = distinct !{!173, !174}
!174 = distinct !{!174, !"LVerDomain"}
!175 = !{!176}
!176 = distinct !{!176, !174}
!177 = distinct !{!177, !26, !34, !103, !104}
!178 = distinct !{!178, !26, !34, !103}
!179 = distinct !{!179, !26, !34, !103, !104}
!180 = distinct !{!180, !26, !34, !103, !104}
!181 = distinct !{!181, !26, !34, !103}
!182 = distinct !{!182, !26}
...
!191 = !{!120, !121, i64 8}
!192 = distinct !{!192, !26}
!193 = !{i64 0, i64 8, !141, i64 8, i64 8, !8}
!194 = !{!195, !197}
!195 = distinct !{!195, !196, !"_ZSt19__relocate_object_aIN6snappy19SnappySinkAllocator9DatablockES2_SaIS2_EEvPT_PT0_RT1_: argument 0"}
!196 = distinct !{!196, !"_ZSt19__relocate_object_aIN6snappy19SnappySinkAllocator9DatablockES2_SaIS2_EEvPT_PT0_RT1_"}
!197 = distinct !{!197, !196, !"_ZSt19__relocate_object_aIN6snappy19SnappySinkAllocator9DatablockES2_SaIS2_EEvPT_PT0_RT1_: argument 1"}
!198 = distinct !{!198, !26}
end_hunk_0
