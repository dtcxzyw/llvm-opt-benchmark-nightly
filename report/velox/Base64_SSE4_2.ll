...
._crit_edge.i.i:                                  ; preds = %.lr.ph.i.i, %middle.block, %_ZN5folly6detail13base64_detail20base64SimdEncodeImplINS1_22Base64_SSE4_2_PlatformELb1EEEPcPKcS6_S4_.exit
  %.023.lcssa.i.i = phi ptr [ %.011.i.lcssa, %_ZN5folly6detail13base64_detail20base64SimdEncodeImplINS1_22Base64_SSE4_2_PlatformELb1EEEPcPKcS6_S4_.exit ], [ %i.ap, %middle.block ], [ %i.api, %.lr.ph.i.i ] ; 6 uses
...
begin_hunk_1_@_ZN5folly6detail13base64_detail22base64URLEncode_SSE4_2EPKcS3_Pc:bb.a
  ...
  %i.aps = getelementptr inbounds nuw i8, ptr %.023.lcssa.i.i, i64 1 ; 2 uses
...
begin_hunk_2_@_ZN5folly6detail13base64_detail22base64URLEncode_SSE4_2EPKcS3_Pc:bb.a
  ...
  %3 = getelementptr inbounds nuw i8, ptr %.023.lcssa.i.i, i64 2
  store i8 %i.apy, ptr %i.aps, align 1, !tbaa !18
...
begin_hunk_3_@_ZN5folly6detail13base64_detail22base64URLEncode_SSE4_2EPKcS3_Pc:bb.a
  ...
  store i8 %i.aqi, ptr %i.aps, align 1, !tbaa !18
  ...
  %4 = getelementptr inbounds nuw i8, ptr %.023.lcssa.i.i, i64 3
...
_ZN5folly6detail13base64_detail21base64URLEncodeScalarEPKcS3_Pc.exit: ; preds = %._crit_edge.i.i, %bb.c, %bb.d
  %.1.i.i.i = phi ptr [ %.023.lcssa.i.i, %._crit_edge.i.i ], [ %3, %bb.c ], [ %4, %bb.d ]
  ret ptr %.1.i.i.i
}
