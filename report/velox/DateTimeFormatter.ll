...
.lr.ph:                                           ; preds = %bb.c
  ...
  %i.eu = urem <2 x i16> %i.et, splat (i16 10)
  %19 = trunc nuw nsw <2 x i16> %i.eu to <2 x i8> ; 2 uses
  %i.ev = extractelement <2 x i8> %19, i64 0
  %i.ew = or disjoint i8 %i.ev, 48
  %i.ex = extractelement <2 x i8> %19, i64 1
