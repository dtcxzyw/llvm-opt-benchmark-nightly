...
26:                                               ; preds = %bb.j
  %27 = getelementptr inbounds nuw i8, ptr %i.bz, i64 2 ; 2 uses
  %.pr.i = load i8, ptr %27, align 1, !tbaa !15
  br label %bb.k

bb.k:                                             ; preds = %26, %bb.j
  %28 = phi i8 [ %i.cc, %bb.j ], [ %.pr.i, %26 ]
  %.064.i = phi ptr [ %i.cb, %bb.j ], [ %27, %26 ]
  %i.cp = icmp eq i8 %28, 0
...
begin_hunk_2
  ...
  %i.cs = invoke fastcc noundef ptr @_ZN6google12_GLOBAL__N_112FlagRegistry19SplitArgumentLockedEPKcPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPS3_SA_(ptr noundef nonnull align 8 dereferenceable(104) %i.cr, ptr noundef nonnull %.064.i, ptr noundef %12, ptr noundef %i.a, ptr noundef %13)
