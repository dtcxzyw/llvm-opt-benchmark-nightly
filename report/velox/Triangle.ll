...
bb.a:
  ...
  %i.i = fmul double %5, %5
  %10 = fadd double %i.h, %i.i
  %foldExtExtBinop39 = fmul <2 x double> %i.g, %i.g
  %11 = extractelement <2 x double> %foldExtExtBinop39, i64 0
  %12 = fmul double %3, %3
  %13 = fadd double %11, %12
  %14 = insertelement <2 x double> poison, double %13, i64 0
  %15 = shufflevector <2 x double> %14, <2 x double> poison, <2 x i32> zeroinitializer
  %i.j = fmul <2 x double> %i.e, %15
  %16 = insertelement <2 x double> poison, double %10, i64 0
  %i.k = shufflevector <2 x double> %16, <2 x double> poison, <2 x i32> zeroinitializer
...
bb.a:
  ...
  %i.h = fmul double %7, %7
  %12 = fadd double %i.g, %i.h
  %foldExtExtBinop6 = fmul <2 x double> %i.f, %i.f
  %13 = extractelement <2 x double> %foldExtExtBinop6, i64 0
  %14 = fmul double %5, %5
  %15 = fadd double %13, %14
  %16 = insertelement <2 x double> poison, double %15, i64 0
  %17 = shufflevector <2 x double> %16, <2 x double> poison, <2 x i32> zeroinitializer
  %i.i = fmul <2 x double> %i.e, %17
  %18 = insertelement <2 x double> poison, double %12, i64 0
  %i.j = shufflevector <2 x double> %18, <2 x double> poison, <2 x i32> zeroinitializer
  %i.k = fmul <2 x double> %i.f, %i.j
  %i.l = fsub <2 x double> %i.i, %i.k
  %i.m = insertelement <2 x double> poison, double %11, i64 0
