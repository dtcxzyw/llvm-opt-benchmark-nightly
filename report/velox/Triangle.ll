...
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 48
  %i.c = load <2 x double>, ptr %i.a, align 8, !tbaa !8 ; 5 uses
  %i.d = load <2 x double>, ptr %i.b, align 8, !tbaa !8 ; 3 uses
  %i.e = load <2 x double>, ptr %0, align 8, !tbaa !8 ; 3 uses
  %2 = shufflevector <2 x double> %i.e, <2 x double> %i.c, <3 x i32> <i32 0, i32 2, i32 0>
  %3 = shufflevector <2 x double> %i.c, <2 x double> %i.d, <3 x i32> <i32 0, i32 2, i32 2>
  %4 = fsub <3 x double> %2, %3                   ; 2 uses
  %5 = shufflevector <2 x double> %i.e, <2 x double> %i.c, <3 x i32> <i32 1, i32 3, i32 1>
  %6 = shufflevector <2 x double> %i.c, <2 x double> %i.d, <3 x i32> <i32 1, i32 3, i32 3>
  %7 = fsub <3 x double> %5, %6                   ; 2 uses
  %8 = fmul <3 x double> %4, %4
  %9 = fmul <3 x double> %7, %7
  %10 = fadd <3 x double> %8, %9
  %11 = tail call <3 x double> @llvm.sqrt.v3f64(<3 x double> %10) ; 6 uses
  %shift = shufflevector <3 x double> %11, <3 x double> poison, <3 x i32> <i32 poison, i32 2, i32 poison>
  %foldExtExtBinop = fadd <3 x double> %11, %shift
  %shift18 = shufflevector <3 x double> %foldExtExtBinop, <3 x double> poison, <3 x i32> <i32 1, i32 poison, i32 poison>
  %foldExtExtBinop19 = fadd <3 x double> %11, %shift18
  %12 = shufflevector <3 x double> %11, <3 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.f = fmul <2 x double> %i.e, %12
  %13 = shufflevector <3 x double> %11, <3 x double> poison, <2 x i32> <i32 2, i32 2>
  %i.g = fmul <2 x double> %i.c, %13
  %i.h = fadd <2 x double> %i.f, %i.g
  %i.i = shufflevector <3 x double> %11, <3 x double> poison, <2 x i32> zeroinitializer
  %i.j = fmul <2 x double> %i.d, %i.i
  %i.k = fadd <2 x double> %i.j, %i.h
  %i.l = shufflevector <3 x double> %foldExtExtBinop19, <3 x double> poison, <2 x i32> zeroinitializer
...
bb.a:
  ...
  %2 = extractelement <2 x double> %i.e, i64 0
  %3 = extractelement <2 x double> %i.g, i64 1    ; 3 uses
  %4 = fmul double %2, %3
  %5 = extractelement <2 x double> %i.e, i64 1    ; 3 uses
  %6 = extractelement <2 x double> %i.g, i64 0
  %7 = fmul double %5, %6
  %8 = fsub double %4, %7
  %9 = fmul double %8, 2.000000e+00
  %foldExtExtBinop.a = fmul <2 x double> %i.e, %i.e
  %10 = extractelement <2 x double> %foldExtExtBinop.a, i64 0
  %foldExtExtBinop39 = fmul <2 x double> %i.g, %i.g
  %i.h = extractelement <2 x double> %foldExtExtBinop39, i64 0
  %i.i = fmul double %5, %5
  %11 = fmul double %3, %3
  %12 = fadd double %10, %i.i
  %13 = fadd double %i.h, %11
  %14 = insertelement <2 x double> poison, double %13, i64 0
  %15 = shufflevector <2 x double> %14, <2 x double> poison, <2 x i32> zeroinitializer
  %16 = fmul <2 x double> %i.e, %15
  %17 = insertelement <2 x double> poison, double %12, i64 0
  %i.j = shufflevector <2 x double> %17, <2 x double> poison, <2 x i32> zeroinitializer
  %i.k = fmul <2 x double> %i.j, %i.g
  %i.l = fsub <2 x double> %16, %i.k
  %i.m = insertelement <2 x double> poison, double %9, i64 0
...
bb.a:
  ...
  %4 = extractelement <2 x double> %i.e, i64 0
  %5 = extractelement <2 x double> %i.f, i64 1    ; 3 uses
  %6 = fmul double %4, %5
  %7 = extractelement <2 x double> %i.e, i64 1    ; 3 uses
  %8 = extractelement <2 x double> %i.f, i64 0
  %9 = fmul double %8, %7
  %10 = fsub double %6, %9
  %11 = fmul double %10, 2.000000e+00
  %foldExtExtBinop.a = fmul <2 x double> %i.e, %i.e
  %12 = extractelement <2 x double> %foldExtExtBinop.a, i64 0
  %foldExtExtBinop6 = fmul <2 x double> %i.f, %i.f
  %i.g = extractelement <2 x double> %foldExtExtBinop6, i64 0
  %i.h = fmul double %7, %7
  %13 = fmul double %5, %5
  %14 = fadd double %12, %i.h
  %15 = fadd double %i.g, %13
  %16 = insertelement <2 x double> poison, double %15, i64 0
  %17 = shufflevector <2 x double> %16, <2 x double> poison, <2 x i32> zeroinitializer
  %18 = fmul <2 x double> %i.e, %17
  ...
  %i.k = fsub <2 x double> %18, %i.j
  %i.l = insertelement <2 x double> poison, double %11, i64 0
...
; Function Attrs: nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none)
declare <3 x double> @llvm.sqrt.v3f64(<3 x double>) #6
