...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.u = getelementptr inbounds nuw [8 x i8], ptr %i.i, i64 %index ; 5 uses
  ...
  %i.y = getelementptr inbounds nuw [8 x i8], ptr %i.j, i64 %index ; 4 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.aj = getelementptr inbounds nuw [8 x i8], ptr %i.i, i64 %index36 ; 2 uses
  %wide.load37 = load <4 x i64>, ptr %i.aj, align 8, !tbaa !50, !alias.scope !764, !noalias !767
  %i.ak = getelementptr inbounds nuw [8 x i8], ptr %i.j, i64 %index36
