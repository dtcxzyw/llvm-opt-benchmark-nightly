...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.o = shl i64 %index, 3
  %9 = and i64 %i.o, 2305843009213693824
  %i.p = getelementptr inbounds nuw i8, ptr %i.g, i64 %9 ; 4 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.ak = shl i64 %index153, 3
  %10 = and i64 %i.ak, 2305843009213693920
  %i.al = getelementptr inbounds nuw i8, ptr %i.g, i64 %10
...
vector.body:                                      ; preds = %vector.main.loop.iter.check, %vector.body
  %index = phi i64 [ %index.next, %vector.body ], [ 0, %vector.main.loop.iter.check ] ; 2 uses
  %i.wq = add i64 %index, %i.wm                   ; 2 uses
...
vec.epilog.vector.body:                           ; preds = %vector.main.loop.iter.check, %vec.epilog.vector.body
  ...
  %i.xa = add i64 %index159, %i.wm                ; 2 uses
