...
bb.b:                                             ; preds = %bb.a
  ...
  %i.g = load <2 x i64>, ptr %1, align 16, !tbaa !12
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.m = load <2 x i64>, ptr %i.f, align 16, !tbaa !12 ; 3 uses
  %i.n = getelementptr inbounds nuw i8, ptr %1, i64 48
  %i.o = load <2 x i64>, ptr %i.l, align 16, !tbaa !12 ; 3 uses
  %i.p = getelementptr inbounds nuw i8, ptr %1, i64 64 ; 2 uses
  %i.q = load <2 x i64>, ptr %i.n, align 16, !tbaa !12 ; 3 uses
  %i.r = icmp eq i64 %.idx106, 0
  br i1 %i.r, label %bb.e, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.s = getelementptr inbounds nuw i8, ptr %1, i64 80
  %i.t = load <2 x i64>, ptr %i.p, align 16, !tbaa !12 ; 2 uses
  %i.u = getelementptr inbounds nuw i8, ptr %1, i64 96
  %i.v = load <2 x i64>, ptr %i.s, align 16, !tbaa !12 ; 2 uses
  %i.w = getelementptr inbounds nuw i8, ptr %1, i64 112
  %i.x = load <2 x i64>, ptr %i.u, align 16, !tbaa !12 ; 2 uses
  %i.y = load <2 x i64>, ptr %i.w, align 16, !tbaa !12 ; 2 uses
...
.lr.ph:                                           ; preds = %bb.d, %.lr.ph
  ...
  %i.z = load <2 x i64>, ptr %.094120, align 16, !tbaa !12
  ...
  %i.af = load <2 x i64>, ptr %i.ae, align 16, !tbaa !12
  ...
  %i.al = load <2 x i64>, ptr %i.ak, align 16, !tbaa !12
  ...
  %i.ar = load <2 x i64>, ptr %i.aq, align 16, !tbaa !12
  ...
  %i.ax = load <2 x i64>, ptr %i.aw, align 16, !tbaa !12
  ...
  %i.bd = load <2 x i64>, ptr %i.bc, align 16, !tbaa !12
  ...
  %i.bj = load <2 x i64>, ptr %i.bi, align 16, !tbaa !12
  ...
  %i.bp = load <2 x i64>, ptr %i.bo, align 16, !tbaa !12
...
.lr.ph136:                                        ; preds = %bb.e, %.lr.ph136
  ...
  %i.ck = load <2 x i64>, ptr %.296130, align 16, !tbaa !12
  ...
  %i.cq = load <2 x i64>, ptr %i.cp, align 16, !tbaa !12
  ...
  %i.cw = load <2 x i64>, ptr %i.cv, align 16, !tbaa !12
  ...
  %i.dc = load <2 x i64>, ptr %i.db, align 16, !tbaa !12
  ...
  br i1 %.not107, label %._crit_edge137, label %.lr.ph136, !llvm.loop !15
...
.lr.ph147:                                        ; preds = %bb.f, %.lr.ph147
  ...
  %i.dv = load <2 x i64>, ptr %.498144, align 16, !tbaa !12
  ...
  br i1 %.not108, label %._crit_edge148, label %.lr.ph147, !llvm.loop !16
