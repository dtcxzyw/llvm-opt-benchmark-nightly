...
bb.h:                                             ; preds = %._crit_edge.i.i
  ...
  br i1 %.not.i43.i.i, label %"_ZN8facebook5velox4bits10forEachBitIZNKS0_13FlatMapVector11toMapVectorEvE3$_0EEvPKmiibT_.exit", label %.preheader.i48.i.i

.preheader.i48.i.i:                               ; preds = %bb.h
  %15 = zext nneg i32 %i.bx to i64
  %invariant.gep.i50.i.i = getelementptr inbounds nuw [4 x i8], ptr %i.az, i64 %15
  br label %.preheader.i44.i.i

.preheader.i44.i.i:                               ; preds = %.preheader.i44.i.i, %.preheader.i48.i.i
  %.011.i46.i.i = phi i64 [ %i.dl, %.preheader.i48.i.i ], [ %i.dr, %.preheader.i44.i.i ] ; 3 uses
  %i.dm = call range(i64 0, 65) i64 @llvm.cttz.i64(i64 %.011.i46.i.i, i1 true)
  %i.dn = getelementptr inbounds nuw [4 x i8], ptr %invariant.gep.i50.i.i, i64 %i.dm ; 2 uses
  %i.do = load i32, ptr %i.dn, align 4, !tbaa !3
  %i.dp = add nsw i32 %i.do, 1
  store i32 %i.dp, ptr %i.dn, align 4, !tbaa !3
  %i.dq = add nsw i64 %.011.i46.i.i, -1
  %i.dr = and i64 %i.dq, %.011.i46.i.i            ; 2 uses
  %.not10.i47.i.i = icmp eq i64 %i.dr, 0
...
bb.i:                                             ; preds = %._crit_edge
  ...
  %i.ds = load ptr, ptr %7, align 8, !tbaa !80    ; 2 uses
  %i.dt = getelementptr inbounds nuw i8, ptr %i.ds, i64 44
  %i.du = load i8, ptr %i.dt, align 4, !tbaa !81
  %i.dv = and i8 %i.du, 2
  %.not.i93 = icmp eq i8 %i.dv, 0
...
_ZNK8facebook5velox6Buffer9asMutableIiEEPT_v.exit95: ; preds = %bb.i
  ...
  %i.dx = load ptr, ptr %i.dw, align 8, !tbaa !86 ; 2 uses
  %i.dy = load i32, ptr %i.ao, align 8, !tbaa !58 ; 3 uses
  %i.dz = icmp sgt i32 %i.dy, 0
  br i1 %i.dz, label %.lr.ph177, label %_ZNK8facebook5velox6Buffer9asMutableIiEEPT_v.exit95.._crit_edge178_crit_edge
...
._crit_edge178:                                   ; preds = %.lr.ph177, %_ZNK8facebook5velox6Buffer9asMutableIiEEPT_v.exit95.._crit_edge178_crit_edge
  %.pre-phi = phi i64 [ %.pre210, %_ZNK8facebook5velox6Buffer9asMutableIiEEPT_v.exit95.._crit_edge178_crit_edge ], [ %i.eh, %.lr.ph177 ]
  %.059.lcssa = phi i32 [ 0, %_ZNK8facebook5velox6Buffer9asMutableIiEEPT_v.exit95.._crit_edge178_crit_edge ], [ %i.ef, %.lr.ph177 ] ; 3 uses
  %.lcssa = phi i32 [ %i.dy, %_ZNK8facebook5velox6Buffer9asMutableIiEEPT_v.exit95.._crit_edge178_crit_edge ], [ %i.eg, %.lr.ph177 ]
...
.lr.ph177:                                        ; preds = %_ZNK8facebook5velox6Buffer9asMutableIiEEPT_v.exit95, %.lr.ph177
  ...
  %.059175 = phi i32 [ %i.ef, %.lr.ph177 ], [ 0, %_ZNK8facebook5velox6Buffer9asMutableIiEEPT_v.exit95 ] ; 2 uses
  %i.ec = getelementptr inbounds nuw [4 x i8], ptr %i.dx, i64 %indvars.iv197
  store i32 %.059175, ptr %i.ec, align 4, !tbaa !3
  %i.ed = getelementptr inbounds nuw [4 x i8], ptr %i.az, i64 %indvars.iv197
  %i.ee = load i32, ptr %i.ed, align 4, !tbaa !3
  %i.ef = add nsw i32 %i.ee, %.059175             ; 2 uses
  %indvars.iv.next198 = add nuw nsw i64 %indvars.iv197, 1 ; 2 uses
  %i.eg = load i32, ptr %i.ao, align 8, !tbaa !58 ; 2 uses
  %i.eh = sext i32 %i.eg to i64                   ; 2 uses
  %i.ei = icmp slt i64 %indvars.iv.next198, %i.eh
  br i1 %i.ei, label %.lr.ph177, label %._crit_edge178, !llvm.loop !298

_ZSt4fillIPiiEvT_S1_RKT0_.exit:                   ; preds = %.lr.ph.i.i.i96.preheader, %._crit_edge178
  call void @llvm.lifetime.start.p0(ptr nonnull %8) #27
  call void @llvm.lifetime.start.p0(ptr nonnull %9) #27
  call void @llvm.experimental.noalias.scope.decl(metadata !299)
  %i.ej = getelementptr inbounds nuw i8, ptr %1, i64 8 ; 2 uses
  %i.ek = load ptr, ptr %i.ej, align 8, !tbaa !200, !noalias !299
  %i.el = call ptr @__dynamic_cast(ptr nonnull align 8 dereferenceable(18) %i.ek, ptr nonnull @_ZTIN8facebook5velox4TypeE, ptr nonnull @_ZTIN8facebook5velox7MapTypeE, i64 0) #27, !noalias !299 ; 3 uses
  %i.em = icmp eq ptr %i.el, null
  br i1 %i.em, label %bb.m, label %_ZNK8facebook5velox4Type5asMapEv.exit.i
...
_ZNK8facebook5velox4Type5asMapEv.exit.i:          ; preds = %_ZSt4fillIPiiEvT_S1_RKT0_.exit
  %i.en = getelementptr inbounds nuw i8, ptr %i.el, i64 40
  %i.eo = getelementptr inbounds nuw i8, ptr %9, i64 8
  %i.ep = getelementptr inbounds nuw i8, ptr %i.el, i64 48
  %i.eq = load ptr, ptr %i.ep, align 8, !tbaa !91, !noalias !299 ; 2 uses
  %i.er = load <2 x ptr>, ptr %i.en, align 8, !tbaa !108, !noalias !299
  store <2 x ptr> %i.er, ptr %9, align 16, !tbaa !108, !alias.scope !299
  %.not.i.i.i.i = icmp eq ptr %i.eq, null
...
bb.n:                                             ; preds = %_ZNK8facebook5velox4Type5asMapEv.exit.i
  ...
  %i.et = load i8, ptr @__libc_single_threaded, align 1, !tbaa !23, !noalias !299
  %.not.i.i.i.i.i = icmp eq i8 %i.et, 0
  br i1 %.not.i.i.i.i.i, label %bb.p, label %bb.o

bb.o:                                             ; preds = %bb.n
  %i.eu = load i32, ptr %i.es, align 4, !tbaa !3, !noalias !299
  %i.ev = add nsw i32 %i.eu, 1
  store i32 %i.ev, ptr %i.es, align 4, !tbaa !3, !noalias !299
  br label %_ZNK8facebook5velox13FlatMapVector9valueTypeEv.exit

bb.p:                                             ; preds = %bb.n
  %i.ew = atomicrmw volatile add ptr %i.es, i32 1 acq_rel, align 4, !noalias !299 ; 0 uses
  br label %_ZNK8facebook5velox13FlatMapVector9valueTypeEv.exit

_ZNK8facebook5velox13FlatMapVector9valueTypeEv.exit: ; preds = %bb.p, %bb.o, %_ZNK8facebook5velox4Type5asMapEv.exit.i
  %i.ex = load ptr, ptr %i.ar, align 8, !tbaa !119
  call void @llvm.experimental.noalias.scope.decl(metadata !302)
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #27, !noalias !302
  invoke void @_ZN8facebook5velox10BaseVector14createInternalERKSt10shared_ptrIKNS0_4TypeEEiPNS0_6memory10MemoryPoolE(ptr dead_on_unwind nonnull writable sret(%"class.std::shared_ptr.8") align 8 %3, ptr noundef nonnull align 8 dereferenceable(16) %9, i32 noundef %.059.lcssa, ptr noundef %i.ex)
          to label %bb.q unwind label %bb.aa

bb.q:                                             ; preds = %_ZNK8facebook5velox13FlatMapVector9valueTypeEv.exit
  call void @llvm.experimental.noalias.scope.decl(metadata !305)
  %i.ey = getelementptr inbounds nuw i8, ptr %8, i64 8
  %i.ez = load <2 x ptr>, ptr %3, align 16, !tbaa !108, !noalias !308
  store <2 x ptr> %i.ez, ptr %8, align 16, !tbaa !108, !alias.scope !308
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #27, !noalias !302
  %i.fa = load ptr, ptr %i.eo, align 8, !tbaa !91 ; 8 uses
  %.not.i.i99 = icmp eq ptr %i.fa, null
...
bb.s:                                             ; preds = %bb.r
  store i32 0, ptr %i.fb, align 8, !tbaa !109
  %i.ff = getelementptr inbounds nuw i8, ptr %i.fa, i64 12
  store i32 0, ptr %i.ff, align 4, !tbaa !111
  %i.fg = load ptr, ptr %i.fa, align 8, !tbaa !43
  %i.fh = getelementptr inbounds nuw i8, ptr %i.fg, i64 16
  %i.fi = load ptr, ptr %i.fh, align 8
  call void %i.fi(ptr noundef nonnull align 8 dereferenceable(16) %i.fa) #27, !inline_history !209
  %i.fj = load ptr, ptr %i.fa, align 8, !tbaa !43
  %i.fk = getelementptr inbounds nuw i8, ptr %i.fj, i64 24
  %i.fl = load ptr, ptr %i.fk, align 8
  call void %i.fl(ptr noundef nonnull align 8 dereferenceable(16) %i.fa) #27, !inline_history !209
  br label %_ZNSt12__shared_ptrIKN8facebook5velox4TypeELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit

bb.t:                                             ; preds = %bb.r
  %i.fm = load i8, ptr @__libc_single_threaded, align 1, !tbaa !23
  %.not.i.i.i100 = icmp eq i8 %i.fm, 0
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i: ; preds = %bb.v, %bb.u
  %.0.i.i.i.i = phi i32 [ %i.fe, %bb.u ], [ %i.fo, %bb.v ]
  %i.fp = icmp eq i32 %.0.i.i.i.i, 1
  br i1 %i.fp, label %bb.w, label %_ZNSt12__shared_ptrIKN8facebook5velox4TypeELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit, !prof !13
...
_ZNSt12__shared_ptrIKN8facebook5velox4TypeELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit: ; preds = %bb.q, %bb.s, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i, %bb.w
  call void @llvm.lifetime.end.p0(ptr nonnull %9) #27
  call void @llvm.lifetime.start.p0(ptr nonnull %10) #27
  %i.fq = load ptr, ptr %i.ar, align 8, !tbaa !119
  %i.fr = sext i32 %.059.lcssa to i64
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #27, !noalias !309
  store i32 0, ptr %2, align 4, !tbaa !23, !noalias !309
  %i.fs = getelementptr inbounds nuw i8, ptr %2, i64 4
  store i8 1, ptr %i.fs, align 4, !tbaa !289, !noalias !309
  invoke void @_ZN8facebook5velox13AlignedBuffer8allocateIiEEN5boost13intrusive_ptrINS0_6BufferEEEmPNS0_6memory10MemoryPoolERKSt8optionalIT_Eb(ptr dead_on_unwind nonnull writable sret(%"class.boost::intrusive_ptr") align 8 %10, i64 noundef %i.fr, ptr noundef %i.fq, ptr noundef nonnull align 4 dereferenceable(8) %2, i1 noundef zeroext false)
          to label %bb.x unwind label %bb.ac

bb.x:                                             ; preds = %_ZNSt12__shared_ptrIKN8facebook5velox4TypeELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #27, !noalias !309
  %i.ft = load ptr, ptr %10, align 8, !tbaa !80   ; 2 uses
  %i.fu = getelementptr inbounds nuw i8, ptr %i.ft, i64 44
  %i.fv = load i8, ptr %i.fu, align 4, !tbaa !81
  %i.fw = and i8 %i.fv, 2
  %.not.i103 = icmp eq i8 %i.fw, 0
  br i1 %.not.i103, label %_ZNK8facebook5velox6Buffer9asMutableIiEEPT_v.exit105, label %bb.y, !prof !76
end_hunk_0
