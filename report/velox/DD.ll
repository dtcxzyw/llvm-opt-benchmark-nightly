...
.preheader:                                       ; preds = %bb.b, %bb.e
  ...
  %.sroa.0.028 = phi double [ %.sroa.0.1, %bb.e ], [ 1.000000e+00, %bb.b ] ; 4 uses
  %.sroa.8.027 = phi double [ %.sroa.8.1, %bb.e ], [ 0.000000e+00, %bb.b ] ; 2 uses
  %.sroa.018.026 = phi double [ %i.aj, %bb.e ], [ %.sroa.018.0.copyload, %bb.b ] ; 9 uses
...
bb.c:                                             ; preds = %.preheader
  %2 = insertelement <2 x double> poison, double %.sroa.0.028, i64 0
  %3 = insertelement <2 x double> %2, double %.sroa.018.026, i64 1 ; 3 uses
  %4 = fmul <2 x double> %3, splat (double f0x41A0000002000000) ; 2 uses
  %5 = fmul double %.sroa.018.026, %.sroa.0.028   ; 3 uses
  %6 = fsub <2 x double> %4, %3
  %7 = fsub <2 x double> %4, %6                   ; 3 uses
  %8 = fsub <2 x double> %3, %7                   ; 2 uses
  %9 = extractelement <2 x double> %7, i64 0      ; 2 uses
  %10 = extractelement <2 x double> %7, i64 1     ; 2 uses
  %i.e = fmul double %10, %9
  %i.f = fsub double %i.e, %5
  %11 = extractelement <2 x double> %8, i64 1     ; 2 uses
  %i.g = fmul double %11, %9
  %i.h = fadd double %i.g, %i.f
  %12 = extractelement <2 x double> %8, i64 0     ; 2 uses
  %i.i = fmul double %10, %12
  %i.j = fadd double %i.i, %i.h
  %i.k = fmul double %11, %12
  ...
  %i.q = fadd double %5, %i.p                     ; 2 uses
  %i.r = fsub double %5, %i.q
