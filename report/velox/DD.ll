...
bb.b:                                             ; preds = %bb.a
  %i.e = tail call double @llvm.floor.f64(double %i.a)
  %1 = tail call double @llvm.trunc.f64(double %i.a)
  %i.f = fcmp oeq double %1, %i.a
...
bb.b:                                             ; preds = %bb.a
  %i.e = tail call double @llvm.ceil.f64(double %i.a)
  %1 = tail call double @llvm.trunc.f64(double %i.a)
  %i.f = fcmp oeq double %1, %i.a
...
bb.c:                                             ; preds = %bb.b
  %i.s = tail call double @llvm.floor.f64(double %i.o)
  %1 = tail call double @llvm.trunc.f64(double %i.o)
  %i.t = fcmp oeq double %1, %i.o
...
bb.a:
  %.sroa.0.0.copyload9 = load double, ptr %0, align 8, !tbaa !11 ; 10 uses
...
_ZNK4geos4math2DD5floorEv.exit:                   ; preds = %bb.c, %bb.b
  %i.e = tail call double @llvm.floor.f64(double %.sroa.0.0.copyload9)
  %1 = tail call double @llvm.trunc.f64(double %.sroa.0.0.copyload9)
  %i.f = fcmp oeq double %1, %.sroa.0.0.copyload9
...
_ZNK4geos4math2DD4ceilEv.exit:                    ; preds = %bb.c
  %i.h = tail call double @llvm.ceil.f64(double %.sroa.0.0.copyload9)
  %2 = tail call double @llvm.trunc.f64(double %.sroa.0.0.copyload9)
  %i.i = fcmp oeq double %2, %.sroa.0.0.copyload9
