...
bb.cr:                                            ; preds = %bb.co
  ...
  %umin = tail call i64 @llvm.umin.i64(i64 %i.sc, i64 %i.wy)
  %i.abb = add i64 %i.aba, %umin
  %umax158 = tail call i64 @llvm.umax.i64(i64 %i.sc, i64 %i.wy) ; 3 uses
  %i.abc = add i64 %i.abb, %umax158
