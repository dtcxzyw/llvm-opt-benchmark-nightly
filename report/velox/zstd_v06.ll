...
.thread172.i:                                     ; preds = %bb.ab, %bb.aa, %bb.z
  %6 = phi i64 [ 4, %bb.ab ], [ 3, %bb.aa ], [ 2, %bb.z ]
  %.0176.i = phi i64 [ 3, %bb.ab ], [ 2, %bb.aa ], [ 1, %bb.z ]
  ...
  %i.fh = getelementptr inbounds nuw i8, ptr %3, i64 %.0176.i
...
bb.ac:                                            ; preds = %.thread172.i, %bb.x, %bb.w, %bb.p, %bb.k
  ...
  %.5.i = phi i64 [ %i.dy, %bb.w ], [ %i.cu, %bb.p ], [ %6, %.thread172.i ], [ %i.dy, %bb.x ], [ %i.bv, %bb.k ] ; 3 uses
