...
.preheader.i.preheader:                           ; preds = %bb.cp
  ...
  %6 = add i64 %umax137, %i.oz
  %7 = sub i64 %i.yr, %6                          ; 2 uses
  %i.ys = lshr i64 %7, 3
...
bb.cr:                                            ; preds = %bb.co
  ...
  %i.aal = add i64 %8, %umin
  %umax156 = tail call i64 @llvm.umax.i64(i64 %i.rq, i64 %i.wl) ; 3 uses
  %i.aam = add i64 %i.aal, %umax156
  %9 = add i64 %i.aam, %i.rv
  %10 = sub i64 %9, %i.rq
  %i.aan = add i64 %i.pi, %umax156
  %umax157 = tail call i64 @llvm.umax.i64(i64 %10, i64 %i.aan)
  %i.aao = add i64 %umax157, -9
  %11 = add i64 %umax156, %i.oz
  %12 = sub i64 %i.aao, %11                       ; 2 uses
  %i.aap = lshr i64 %12, 3
  %i.aaq = add nuw nsw i64 %i.aap, 1              ; 2 uses
  %min.iters.check159 = icmp ult i64 %12, 104
