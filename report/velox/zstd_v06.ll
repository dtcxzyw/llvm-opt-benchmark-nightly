...
.preheader.i.preheader:                           ; preds = %bb.cp
  ...
  %6 = tail call i64 @llvm.umax.i64(i64 %i.pb, i64 %.reass243)
  %7 = add i64 %6, -9
  %i.yo = add i64 %i.yn, %i.oy
  %i.yp = sub i64 %7, %i.yo                       ; 2 uses
...
bb.cr:                                            ; preds = %bb.co
  ...
  %.reass = add i64 %i.aaf, %invariant.op
