...
FSEv06_initDState.exit105.i:                      ; preds = %BITv06_reloadDStream.exit.sink.split.i101.i, %bb.bl, %FSEv06_initDState.exit97.i
  ...
  %i.oy = ptrtoint ptr %i.fy to i64               ; 12 uses
  %i.oz = ptrtoint ptr %i.ga to i64
  %i.pa = getelementptr inbounds i8, ptr %i.ft, i64 -13
  %i.pb = ptrtoint ptr %i.ov to i64               ; 3 uses
  %6 = add i64 %i.oy, 8
  %i.pc = add i64 %i.oy, 8
  %i.pd = add i64 %i.oy, 1
  %i.pe = add i64 %i.oy, 16
  %7 = ptrtoaddr ptr %1 to i64
  %invariant.op = add i64 %2, %7
  %invariant.op242 = add i64 %invariant.op, -17
  br label %bb.bn
...
.preheader.i.preheader:                           ; preds = %bb.cp
  %i.yn = tail call i64 @llvm.umax.i64(i64 %i.rl, i64 %i.wh)
  %i.yo = add i64 %i.yn, %i.oy
  %i.yp = sub i64 %invariant.op242, %i.yo         ; 2 uses
  %i.yq = lshr i64 %i.yp, 3
  %i.yr = add nuw nsw i64 %i.yq, 1                ; 2 uses
  %min.iters.check136 = icmp ult i64 %i.yp, 56
...
vector.memcheck132:                               ; preds = %.preheader.i.preheader
  ...
  %i.ys = add i64 %umax133, %i.oy
  %i.yt = sub i64 %.3.i.i134, %i.ys
  %diff.check135 = icmp ugt i64 %i.yt, -32
  br i1 %diff.check135, label %.preheader.i.preheader222, label %vector.ph137

vector.ph137:                                     ; preds = %vector.memcheck132
  %n.vec138 = and i64 %i.yr, 4611686018427387900  ; 3 uses
  %i.yu = shl i64 %n.vec138, 3                    ; 2 uses
  %i.yv = getelementptr i8, ptr %i.yk, i64 %i.yu
  %i.yw = getelementptr i8, ptr %i.yj, i64 %i.yu
...
vector.body139:                                   ; preds = %vector.body139, %vector.ph137
  ...
  %i.yx = shl i64 %index140, 3                    ; 2 uses
  %next.gep141 = getelementptr i8, ptr %i.yk, i64 %i.yx ; 2 uses
  %next.gep142 = getelementptr i8, ptr %i.yj, i64 %i.yx ; 2 uses
  %i.yy = getelementptr i8, ptr %next.gep141, i64 16
  %wide.load143 = load <2 x i64>, ptr %next.gep141, align 1
  %wide.load144 = load <2 x i64>, ptr %i.yy, align 1
  %i.yz = getelementptr i8, ptr %next.gep142, i64 16
  store <2 x i64> %wide.load143, ptr %next.gep142, align 1
  store <2 x i64> %wide.load144, ptr %i.yz, align 1
  %index.next145 = add nuw i64 %index140, 4       ; 2 uses
  %i.za = icmp eq i64 %index.next145, %n.vec138
  br i1 %i.za, label %middle.block146, label %vector.body139, !llvm.loop !119

middle.block146:                                  ; preds = %vector.body139
  %cmp.n147 = icmp eq i64 %i.yr, %n.vec138
...
.preheader.i.preheader222:                        ; preds = %vector.memcheck132, %.preheader.i.preheader, %middle.block146
  %.09.i111.i.i.ph = phi ptr [ %i.yk, %vector.memcheck132 ], [ %i.yk, %.preheader.i.preheader ], [ %i.yv, %middle.block146 ]
  %.0.i112.i.i.ph = phi ptr [ %i.yj, %vector.memcheck132 ], [ %i.yj, %.preheader.i.preheader ], [ %i.yw, %middle.block146 ]
  br label %.preheader.i

.preheader.i:                                     ; preds = %.preheader.i.preheader222, %.preheader.i
  %.09.i111.i.i = phi ptr [ %i.zc, %.preheader.i ], [ %.09.i111.i.i.ph, %.preheader.i.preheader222 ] ; 2 uses
  %.0.i112.i.i = phi ptr [ %i.zb, %.preheader.i ], [ %.0.i112.i.i.ph, %.preheader.i.preheader222 ] ; 2 uses
  %.09.val.i113.i.i = load i64, ptr %.09.i111.i.i, align 1
  store i64 %.09.val.i113.i.i, ptr %.0.i112.i.i, align 1
  %i.zb = getelementptr inbounds nuw i8, ptr %.0.i112.i.i, i64 8 ; 2 uses
  %i.zc = getelementptr inbounds nuw i8, ptr %.09.i111.i.i, i64 8
  %i.zd = icmp ult ptr %i.zb, %i.ov
  br i1 %i.zd, label %.preheader.i, label %ZSTDv06_wildcopy.exit114.i.i, !llvm.loop !120

ZSTDv06_wildcopy.exit114.i.i:                     ; preds = %.preheader.i, %middle.block146
  %i.ze = ptrtoint ptr %i.yj to i64
  %i.zf = sub i64 %i.pb, %i.ze
  %i.zg = getelementptr inbounds i8, ptr %i.yk, i64 %i.zf
  br label %bb.cq

bb.cq:                                            ; preds = %ZSTDv06_wildcopy.exit114.i.i, %bb.cp
  %.395.i.i = phi ptr [ %i.ov, %ZSTDv06_wildcopy.exit114.i.i ], [ %i.yj, %bb.cp ] ; 7 uses
  %.4.i.i = phi ptr [ %i.zg, %ZSTDv06_wildcopy.exit114.i.i ], [ %i.yk, %bb.cp ] ; 7 uses
  %.4.i.i116 = ptrtoaddr ptr %.4.i.i to i64
  %i.zh = icmp ult ptr %.395.i.i, %i.va
  br i1 %i.zh, label %iter.check, label %ZSTDv06_execSequence.exit.i

iter.check:                                       ; preds = %bb.cq
  %i.zi = add i64 %i.sb, %i.sq
  %i.zj = add i64 %i.zi, %i.ve
  %i.zk = add i64 %i.zj, %i.sf
  %i.zl = add i64 %i.zk, %i.rq
  %umax117 = tail call i64 @llvm.umax.i64(i64 %i.rl, i64 %i.wh)
  %i.zm = add i64 %i.pc, %umax117
  %umax118 = tail call i64 @llvm.umax.i64(i64 %i.pb, i64 %i.zm)
  %i.zn = sub i64 %i.zl, %umax118                 ; 7 uses
  %min.iters.check = icmp ult i64 %i.zn, 4
...
vector.memcheck:                                  ; preds = %iter.check
  ...
  %i.zo = add i64 %6, %umax
  %umax115 = tail call i64 @llvm.umax.i64(i64 %i.pb, i64 %i.zo)
  %i.zp = sub i64 %.4.i.i116, %umax115
  %diff.check = icmp ugt i64 %i.zp, -32
  br i1 %diff.check, label %.lr.ph128.i.i.preheader, label %vector.main.loop.iter.check

vector.main.loop.iter.check:                      ; preds = %vector.memcheck
  %min.iters.check119 = icmp ult i64 %i.zn, 32
  br i1 %min.iters.check119, label %vec.epilog.ph, label %vector.ph

vector.ph:                                        ; preds = %vector.main.loop.iter.check
  %i.zq = and i64 %i.zn, 28
  %n.vec = and i64 %i.zn, -32                     ; 5 uses
  %i.zr = getelementptr i8, ptr %.4.i.i, i64 %n.vec
  %i.zs = getelementptr i8, ptr %.395.i.i, i64 %n.vec
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.zt = getelementptr i8, ptr %next.gep, i64 16
  %wide.load = load <16 x i8>, ptr %next.gep, align 1, !tbaa !29
  %wide.load121 = load <16 x i8>, ptr %i.zt, align 1, !tbaa !29
  %i.zu = getelementptr i8, ptr %next.gep120, i64 16
  store <16 x i8> %wide.load, ptr %next.gep120, align 1, !tbaa !29
  store <16 x i8> %wide.load121, ptr %i.zu, align 1, !tbaa !29
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.zv = icmp eq i64 %index.next, %n.vec
  br i1 %i.zv, label %middle.block, label %vector.body, !llvm.loop !121

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %i.zn, %n.vec
  br i1 %cmp.n, label %ZSTDv06_execSequence.exit.i, label %vec.epilog.iter.check

vec.epilog.iter.check:                            ; preds = %middle.block
  %min.epilog.iters.check = icmp eq i64 %i.zq, 0
  br i1 %min.epilog.iters.check, label %.lr.ph128.i.i.preheader, label %vec.epilog.ph, !prof !116

vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  %vec.epilog.resume.val = phi i64 [ %n.vec, %vec.epilog.iter.check ], [ 0, %vector.main.loop.iter.check ]
  %n.vec123 = and i64 %i.zn, -4                   ; 4 uses
  %i.zw = getelementptr i8, ptr %.4.i.i, i64 %n.vec123
  %i.zx = getelementptr i8, ptr %.395.i.i, i64 %n.vec123
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.zy = icmp eq i64 %index.next128, %n.vec123
  br i1 %i.zy, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !122

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n129 = icmp eq i64 %i.zn, %n.vec123
...
.lr.ph128.i.i.preheader:                          ; preds = %vector.memcheck, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %.5127.i.i.ph = phi ptr [ %.4.i.i, %iter.check ], [ %.4.i.i, %vector.memcheck ], [ %i.zr, %vec.epilog.iter.check ], [ %i.zw, %vec.epilog.middle.block ]
  %.496126.i.i.ph = phi ptr [ %.395.i.i, %iter.check ], [ %.395.i.i, %vector.memcheck ], [ %i.zs, %vec.epilog.iter.check ], [ %i.zx, %vec.epilog.middle.block ]
  br label %.lr.ph128.i.i

.lr.ph128.i.i:                                    ; preds = %.lr.ph128.i.i.preheader, %.lr.ph128.i.i
  %.5127.i.i = phi ptr [ %i.zz, %.lr.ph128.i.i ], [ %.5127.i.i.ph, %.lr.ph128.i.i.preheader ] ; 2 uses
  %.496126.i.i = phi ptr [ %i.aab, %.lr.ph128.i.i ], [ %.496126.i.i.ph, %.lr.ph128.i.i.preheader ] ; 2 uses
  %i.zz = getelementptr inbounds nuw i8, ptr %.5127.i.i, i64 1
  %i.aaa = load i8, ptr %.5127.i.i, align 1, !tbaa !29
  %i.aab = getelementptr inbounds nuw i8, ptr %.496126.i.i, i64 1 ; 2 uses
  store i8 %i.aaa, ptr %.496126.i.i, align 1, !tbaa !29
  %i.aac = icmp ult ptr %i.aab, %i.va
  br i1 %i.aac, label %.lr.ph128.i.i, label %ZSTDv06_execSequence.exit.i, !llvm.loop !123

bb.cr:                                            ; preds = %bb.co
  %i.aad = getelementptr i8, ptr %.294.i.i, i64 %i.xn
  %i.aae = tail call i64 @llvm.umin.i64(i64 %i.rl, i64 %i.wh)
  %i.aaf = tail call i64 @llvm.umax.i64(i64 %i.rl, i64 %i.wh) ; 3 uses
  %i.aag = add i64 %i.sb, %i.oy
  %i.aah = add i64 %i.aag, %i.aae
  %i.aai = add i64 %i.aah, %i.aaf
  %i.aaj = add i64 %i.aai, %i.rq
  %i.aak = sub i64 %i.aaj, %i.rl
  %.reass = add i64 %i.aaf, %i.pe
  %i.aal = tail call i64 @llvm.umax.i64(i64 %i.aak, i64 %.reass)
  %i.aam = add i64 %i.aal, -9
  %i.aan = add i64 %i.aaf, %i.oy
  %i.aao = sub i64 %i.aam, %i.aan                 ; 2 uses
  %i.aap = lshr i64 %i.aao, 3
  %i.aaq = add nuw nsw i64 %i.aap, 1              ; 2 uses
  %min.iters.check153 = icmp ult i64 %i.aao, 56
...
vector.memcheck149:                               ; preds = %bb.cr
  ...
  %i.aar = add i64 %umax150, %i.oy
  %i.aas = sub i64 %.3.i.i134, %i.aar
  %diff.check151 = icmp ugt i64 %i.aas, -32
  br i1 %diff.check151, label %scalar.ph152.preheader, label %vector.ph154

vector.ph154:                                     ; preds = %vector.memcheck149
  %n.vec155 = and i64 %i.aaq, 4611686018427387900 ; 3 uses
  %i.aat = shl i64 %n.vec155, 3                   ; 2 uses
  %i.aau = getelementptr i8, ptr %i.yk, i64 %i.aat
  %i.aav = getelementptr i8, ptr %i.yj, i64 %i.aat
...
vector.body156:                                   ; preds = %vector.body156, %vector.ph154
  ...
  %i.aaw = shl i64 %index157, 3                   ; 2 uses
  %next.gep158 = getelementptr i8, ptr %i.yk, i64 %i.aaw ; 2 uses
  %next.gep159 = getelementptr i8, ptr %i.yj, i64 %i.aaw ; 2 uses
  %i.aax = getelementptr i8, ptr %next.gep158, i64 16
  %wide.load160 = load <2 x i64>, ptr %next.gep158, align 1
  %wide.load161 = load <2 x i64>, ptr %i.aax, align 1
  %i.aay = getelementptr i8, ptr %next.gep159, i64 16
  store <2 x i64> %wide.load160, ptr %next.gep159, align 1
  store <2 x i64> %wide.load161, ptr %i.aay, align 1
  %index.next162 = add nuw i64 %index157, 4       ; 2 uses
  %i.aaz = icmp eq i64 %index.next162, %n.vec155
  br i1 %i.aaz, label %middle.block163, label %vector.body156, !llvm.loop !124

middle.block163:                                  ; preds = %vector.body156
  %cmp.n164 = icmp eq i64 %i.aaq, %n.vec155
...
scalar.ph152.preheader:                           ; preds = %vector.memcheck149, %bb.cr, %middle.block163
  %.09.i115.i.i.ph = phi ptr [ %i.yk, %vector.memcheck149 ], [ %i.yk, %bb.cr ], [ %i.aau, %middle.block163 ]
  %.0.i116.i.i.ph = phi ptr [ %i.yj, %vector.memcheck149 ], [ %i.yj, %bb.cr ], [ %i.aav, %middle.block163 ]
  br label %scalar.ph152

scalar.ph152:                                     ; preds = %scalar.ph152.preheader, %scalar.ph152
  %.09.i115.i.i = phi ptr [ %i.abb, %scalar.ph152 ], [ %.09.i115.i.i.ph, %scalar.ph152.preheader ] ; 2 uses
  %.0.i116.i.i = phi ptr [ %i.aba, %scalar.ph152 ], [ %.0.i116.i.i.ph, %scalar.ph152.preheader ] ; 2 uses
  %.09.val.i117.i.i = load i64, ptr %.09.i115.i.i, align 1
  store i64 %.09.val.i117.i.i, ptr %.0.i116.i.i, align 1
  %i.aba = getelementptr inbounds nuw i8, ptr %.0.i116.i.i, i64 8 ; 2 uses
  %i.abb = getelementptr inbounds nuw i8, ptr %.09.i115.i.i, i64 8
  %i.abc = icmp ult ptr %i.aba, %i.aad
  br i1 %i.abc, label %scalar.ph152, label %ZSTDv06_execSequence.exit.i, !llvm.loop !125
...
ZSTDv06_execSequence.exit.i:                      ; preds = %.lr.ph.i.i, %scalar.ph152, %.lr.ph128.i.i, %middle.block183, %vec.epilog.middle.block200, %middle.block163, %middle.block, %vec.epilog.middle.block, %bb.cq, %.preheader.i.i, %bb.ck
  %i.abd = icmp ult i64 %i.uz, -119
  br i1 %i.abd, label %bb.bn, label %.thread155.i, !llvm.loop !126
...
bb.ct:                                            ; preds = %.thread267.i, %bb.ao, %.thread.i22
  ...
  %i.abe = ptrtoint ptr %i.fu to i64
  %i.abf = ptrtoint ptr %.2.i to i64
  %i.abg = sub i64 %i.abe, %i.abf                 ; 2 uses
  %i.abh = icmp ugt ptr %.2.i, %i.fu
  br i1 %i.abh, label %ZSTDv06_decompressSequences.exit, label %bb.cu

bb.cu:                                            ; preds = %bb.ct
  %i.abi = getelementptr inbounds nuw i8, ptr %.371.i, i64 %i.abg ; 2 uses
  %i.abj = icmp ugt ptr %i.abi, %i.ft
  br i1 %i.abj, label %ZSTDv06_decompressSequences.exit, label %bb.cv
...
bb.cw:                                            ; preds = %bb.cv
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %.371.i, ptr align 1 %.2.i, i64 %i.abg, i1 false)
  br label %bb.cx

bb.cx:                                            ; preds = %bb.cw, %bb.cv
  %.5.ph.i = phi ptr [ %.371.i, %bb.cv ], [ %i.abi, %bb.cw ]
  %i.abk = ptrtoint ptr %.5.ph.i to i64
...
ZSTDv06_decompressSequences.exit:                 ; preds = %.thread.i, %bb.ab, %bb.o, %bb.m, %bb.l, %bb.g, %bb.f, %bb.d, %bb.n, %bb.j, %bb.b, %bb.v, %bb.cx, %bb.cu, %bb.ct, %bb.cs, %.thread155.i, %ZSTDv06_decodeSeqHeaders.exit.i, %bb.an, %bb.am, %bb.al, %bb.ak, %bb.ai, %bb.ag, %bb.ac, %bb.a
  %.1 = phi i64 [ -20, %bb.am ], [ -72, %bb.a ], [ %i.abm, %bb.cx ], [ %.478.ph.i, %.thread155.i ], [ -20, %bb.cs ], [ %i.hx, %ZSTDv06_decodeSeqHeaders.exit.i ], [ -20, %bb.ct ], [ -70, %bb.cu ], [ -20, %bb.al ], [ -72, %bb.ag ], [ -72, %bb.ai ], [ -72, %bb.ak ], [ -20, %bb.an ], [ -72, %bb.ac ], [ -20, %.thread.i ], [ -20, %bb.ab ], [ -20, %bb.o ], [ -30, %bb.m ], [ -20, %bb.l ], [ -20, %bb.g ], [ -20, %bb.f ], [ -20, %bb.d ], [ -20, %bb.n ], [ -20, %bb.j ], [ -20, %bb.b ], [ -20, %bb.v ]
  ret i64 %.1
}
