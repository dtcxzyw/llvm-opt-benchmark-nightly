...
@_ZN4absl12lts_2024011613base_internalL10delay_randE.0 = internal unnamed_addr global i64 0, align 8
...
; Function Attrs: mustprogress uwtable
define weak void @AbslInternalSpinLockWake_lts_20240116(ptr noundef %0, i1 noundef zeroext %1) local_unnamed_addr #0 {
bb.a:
...
; Function Attrs: mustprogress uwtable
define noundef i32 @_ZN4absl12lts_2024011613base_internal12SpinLockWaitEPSt6atomicIjEiPKNS1_22SpinLockWaitTransitionENS1_14SchedulingModeE(ptr noundef %0, i32 noundef %1, ptr nofree noundef readonly captures(none) %2, i32 noundef %3) local_unnamed_addr #0 personality ptr @__gxx_personality_v0 {
bb.a:
...
define noundef range(i32 131072, 4194304) i32 @_ZN4absl12lts_2024011613base_internal24SpinLockSuggestedDelayNSEi(i32 noundef %0) local_unnamed_addr #2 {
bb.a:
  %i.a = load atomic i64, ptr @_ZN4absl12lts_2024011613base_internalL10delay_randE.0 monotonic, align 8
  %i.b = mul i64 %i.a, 25214903917
  %i.c = add i64 %i.b, 11                         ; 2 uses
  store atomic i64 %i.c, ptr @_ZN4absl12lts_2024011613base_internalL10delay_randE.0 monotonic, align 8
