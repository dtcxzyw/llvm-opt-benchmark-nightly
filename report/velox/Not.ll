...
vector.ph142:                                     ; preds = %vector.main.loop.iter.check140
  ...
  %i.fh = getelementptr inbounds nuw i8, ptr %i.dm, i64 %i.fg
...
vector.body145:                                   ; preds = %vector.body145, %vector.ph142
  ...
  %i.fi = getelementptr inbounds nuw i8, ptr %i.fh, i64 %index146 ; 5 uses
  %i.fj = getelementptr inbounds nuw i8, ptr %i.fi, i64 32 ; 2 uses
  %i.fk = getelementptr inbounds nuw i8, ptr %i.fi, i64 64 ; 2 uses
  %i.fl = getelementptr inbounds nuw i8, ptr %i.fi, i64 96 ; 2 uses
  %wide.load147 = load <32 x i8>, ptr %i.fi, align 1, !tbaa !32
  %wide.load148 = load <32 x i8>, ptr %i.fj, align 1, !tbaa !32
  %wide.load149 = load <32 x i8>, ptr %i.fk, align 1, !tbaa !32
  %wide.load150 = load <32 x i8>, ptr %i.fl, align 1, !tbaa !32
  %i.fm = xor <32 x i8> %wide.load147, splat (i8 -1)
  %i.fn = xor <32 x i8> %wide.load148, splat (i8 -1)
  %i.fo = xor <32 x i8> %wide.load149, splat (i8 -1)
  %i.fp = xor <32 x i8> %wide.load150, splat (i8 -1)
  ...
  store <32 x i8> %i.fp, ptr %i.fl, align 1, !tbaa !32
  %index.next151 = add nuw i64 %index146, 128     ; 2 uses
  %i.fq = icmp eq i64 %index.next151, %n.vec144
  br i1 %i.fq, label %middle.block152, label %vector.body145, !llvm.loop !254
...
vec.epilog.ph160:                                 ; preds = %vector.main.loop.iter.check140, %vec.epilog.iter.check158
  ...
  %i.fr = shl i64 %n.vec162, 3                    ; 2 uses
  %i.fs = add i64 %i.fr, %i.eu
  %i.ft = add i64 %i.ev, %i.fr                    ; 2 uses
  %i.fu = lshr exact i64 %i.eu, 3
...
vec.epilog.vector.body163:                        ; preds = %vec.epilog.vector.body163, %vec.epilog.ph160
  ...
  %i.fw = getelementptr inbounds nuw i8, ptr %i.fv, i64 %index164 ; 2 uses
  %wide.load165 = load <16 x i8>, ptr %i.fw, align 1, !tbaa !32
  %i.fx = xor <16 x i8> %wide.load165, splat (i8 -1)
  store <16 x i8> %i.fx, ptr %i.fw, align 1, !tbaa !32
  %index.next166 = add nuw i64 %index164, 16      ; 2 uses
  %i.fy = icmp eq i64 %index.next166, %n.vec162
  br i1 %i.fy, label %vec.epilog.middle.block167, label %vec.epilog.vector.body163, !llvm.loop !256

vec.epilog.middle.block167:                       ; preds = %vec.epilog.vector.body163
  %ind.escape168 = add nsw i64 %i.ft, -8
...
.lr.ph31.i.preheader:                             ; preds = %iter.check156, %vec.epilog.iter.check158, %vec.epilog.middle.block167
  %indvars.iv101.ph = phi i64 [ %i.eu, %iter.check156 ], [ %i.fe, %vec.epilog.iter.check158 ], [ %i.fs, %vec.epilog.middle.block167 ]
  %indvars.iv.ph = phi i64 [ %i.ev, %iter.check156 ], [ %i.ff, %vec.epilog.iter.check158 ], [ %i.ft, %vec.epilog.middle.block167 ]
  br label %.lr.ph31.i
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  ...
  %i.fz = lshr exact i64 %indvars.iv36.i, 3
  %i.ga = getelementptr inbounds nuw i8, ptr %i.dm, i64 %i.fz ; 2 uses
  %i.gb = load i64, ptr %i.ga, align 8, !tbaa !116
  %i.gc = xor i64 %i.gb, -1
  store i64 %i.gc, ptr %i.ga, align 8, !tbaa !116
...
.preheader.i.loopexit:                            ; preds = %.lr.ph31.i, %vec.epilog.middle.block167, %middle.block152
  ...
  %i.gd = trunc nuw nsw i64 %indvars.iv.lcssa to i32
  br label %.preheader.i

.preheader.i:                                     ; preds = %.preheader.i.loopexit, %.preheader26.i
  %.1.lcssa.i = phi i32 [ %.0.lcssa.i, %.preheader26.i ], [ %i.gd, %.preheader.i.loopexit ] ; 2 uses
  %i.ge = icmp slt i32 %.1.lcssa.i, %i.du
  br i1 %i.ge, label %.lr.ph34.preheader.i, label %.loopexit

.lr.ph34.preheader.i:                             ; preds = %.preheader.i
  %i.gf = zext nneg i32 %.1.lcssa.i to i64
  %wide.trip.count = zext i32 %i.du to i64
  br label %.lr.ph34.i
...
.lr.ph31.i:                                       ; preds = %.lr.ph31.i.preheader, %.lr.ph31.i
  ...
  %i.gg = lshr exact i64 %indvars.iv101, 3
  %i.gh = getelementptr inbounds nuw i8, ptr %i.dm, i64 %i.gg ; 2 uses
  %i.gi = load i8, ptr %i.gh, align 1, !tbaa !32
  %i.gj = xor i8 %i.gi, -1
  store i8 %i.gj, ptr %i.gh, align 1, !tbaa !32
...
.lr.ph34.i:                                       ; preds = %_ZN8facebook5velox4bits6setBitIhEEvPT_mb.exit.i, %.lr.ph34.preheader.i
  %indvars.iv41.i = phi i64 [ %i.gf, %.lr.ph34.preheader.i ], [ %indvars.iv.next42.i, %_ZN8facebook5velox4bits6setBitIhEEvPT_mb.exit.i ] ; 6 uses
  %i.gk = lshr i64 %indvars.iv41.i, 6
  %i.gl = getelementptr inbounds nuw [8 x i8], ptr %i.dm, i64 %i.gk
  %i.gm = load i64, ptr %i.gl, align 8, !tbaa !116
  %i.gn = and i64 %indvars.iv41.i, 63
  %i.go = shl nuw i64 1, %i.gn
  %i.gp = and i64 %i.go, %i.gm
  %.not25.i = icmp eq i64 %i.gp, 0
  %i.gq = lshr i64 %indvars.iv41.i, 3
  %i.gr = getelementptr inbounds nuw i8, ptr %i.dm, i64 %i.gq ; 2 uses
  %i.gs = load i8, ptr %i.gr, align 1, !tbaa !32  ; 2 uses
  br i1 %.not25.i, label %bb.y, label %bb.z

bb.y:                                             ; preds = %.lr.ph34.i
  %i.gt = trunc i64 %indvars.iv41.i to i8
  %i.gu = and i8 %i.gt, 7
  %i.gv = shl nuw i8 1, %i.gu
  %i.gw = or i8 %i.gv, %i.gs
  br label %_ZN8facebook5velox4bits6setBitIhEEvPT_mb.exit.i

bb.z:                                             ; preds = %.lr.ph34.i
  %i.gx = and i64 %indvars.iv41.i, 7
  ...
  %i.ha = and i8 %i.gz, %i.gs
  br label %_ZN8facebook5velox4bits6setBitIhEEvPT_mb.exit.i

_ZN8facebook5velox4bits6setBitIhEEvPT_mb.exit.i:  ; preds = %bb.z, %bb.y
  %.sink.i.i = phi i8 [ %i.ha, %bb.z ], [ %i.gw, %bb.y ]
  store i8 %.sink.i.i, ptr %i.gr, align 1, !tbaa !32
...
.loopexit:                                        ; preds = %_ZN8facebook5velox4bits6setBitIhEEvPT_mb.exit.i, %_ZN5boost13intrusive_ptrIN8facebook5velox6BufferEED2Ev.exit, %.preheader.i
  ...
  %i.hd = load ptr, ptr %4, align 8, !tbaa !182
  %i.he = load ptr, ptr %i.hd, align 8, !tbaa !197
  store ptr %i.he, ptr %i.c, align 8, !tbaa !260
...
bb.ac:                                            ; preds = %.loopexit
  ...
  %i.hg = load i32, ptr %i.hf, align 8, !tbaa !176
  store i32 %i.hg, ptr %i.e, align 4, !tbaa !3
  call void @llvm.lifetime.start.p0(ptr nonnull %17) #32
  call void @llvm.experimental.noalias.scope.decl(metadata !263)
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %17, i8 0, i64 24, i1 false)
  %i.hh = invoke noalias noundef nonnull dereferenceable(192) ptr @_Znwm(i64 noundef 192) #33
          to label %.noexc71 unwind label %bb.bg  ; 6 uses

.noexc71:                                         ; preds = %bb.ac
  %i.hi = getelementptr inbounds nuw i8, ptr %i.hh, i64 8
  store i32 1, ptr %i.hi, align 8, !tbaa !42, !noalias !263
  %i.hj = getelementptr inbounds nuw i8, ptr %i.hh, i64 12
  store i32 1, ptr %i.hj, align 4, !tbaa !44, !noalias !263
  store ptr getelementptr inbounds nuw inrange(-16, 40) (i8, ptr @_ZTVSt23_Sp_counted_ptr_inplaceIN8facebook5velox10FlatVectorIbEESaIvELN9__gnu_cxx12_Lock_policyE2EE, i64 16), ptr %i.hh, align 8, !tbaa !45, !noalias !263
  %i.hk = getelementptr inbounds nuw i8, ptr %i.hh, i64 16 ; 2 uses
  invoke void @_ZSt10_ConstructIN8facebook5velox10FlatVectorIbEEJPNS1_6memory10MemoryPoolESt10shared_ptrIKNS1_10ScalarTypeILNS1_8TypeKindE0EEEEDniRN5boost13intrusive_ptrINS1_6BufferEEESt6vectorISG_SaISG_EEEEvPT_DpOT0_(ptr noundef nonnull %i.hk, ptr noundef nonnull align 8 dereferenceable(8) %i.c, ptr noundef nonnull align 8 dereferenceable(16) %16, ptr noundef nonnull align 8 dereferenceable(8) %i.d, ptr noundef nonnull align 4 dereferenceable(4) %i.e, ptr noundef nonnull align 8 dereferenceable(8) %12, ptr noundef nonnull align 8 dereferenceable(24) %17)
...
_ZNSt15__allocated_ptrISaISt23_Sp_counted_ptr_inplaceIN8facebook5velox10FlatVectorIbEESaIvELN9__gnu_cxx12_Lock_policyE2EEEED2Ev.exit14.i.i.i.i: ; preds = %.noexc71
  %i.hl = landingpad { ptr, i32 }
          cleanup
  call void @_ZdlPvm(ptr noundef nonnull %i.hh, i64 noundef 192) #34, !noalias !263
  br label %.body

bb.ad:                                            ; preds = %.noexc71
  %i.hm = getelementptr inbounds nuw i8, ptr %15, i64 8 ; 3 uses
  store ptr %i.hh, ptr %i.hm, align 8, !tbaa !37, !alias.scope !263
  store ptr %i.hk, ptr %15, align 16, !tbaa !266, !alias.scope !263
  %i.hn = load ptr, ptr %17, align 8, !tbaa !268  ; 3 uses
  %i.ho = getelementptr inbounds nuw i8, ptr %17, i64 8
  %i.hp = load ptr, ptr %i.ho, align 8, !tbaa !269 ; 2 uses
  %.not4.i.i.i = icmp eq ptr %i.hn, %i.hp
...
.lr.ph.i.i.i:                                     ; preds = %bb.ad, %_ZSt8_DestroyIN5boost13intrusive_ptrIN8facebook5velox6BufferEEEEvPT_.exit.i.i.i
  %.05.i.i.i = phi ptr [ %i.ie, %_ZSt8_DestroyIN5boost13intrusive_ptrIN8facebook5velox6BufferEEEEvPT_.exit.i.i.i ], [ %i.hn, %bb.ad ] ; 2 uses
  %i.hq = load ptr, ptr %.05.i.i.i, align 8, !tbaa !150 ; 7 uses
  %.not.i.i.i.i.i.i = icmp eq ptr %i.hq, null
...
bb.ae:                                            ; preds = %.lr.ph.i.i.i
  ...
  %i.hs = atomicrmw sub ptr %i.hr, i32 1 acq_rel, align 4
  %i.ht = icmp eq i32 %i.hs, 1
  br i1 %i.ht, label %.sink.split.i.i.i.i.i.i.i, label %_ZSt8_DestroyIN5boost13intrusive_ptrIN8facebook5velox6BufferEEEEvPT_.exit.i.i.i

.sink.split.i.i.i.i.i.i.i:                        ; preds = %bb.ae
  %i.hu = load ptr, ptr %i.hq, align 8, !tbaa !45
  %i.hv = getelementptr inbounds nuw i8, ptr %i.hu, i64 64
  %i.hw = load ptr, ptr %i.hv, align 8
  invoke void %i.hw(ptr noundef nonnull align 8 dereferenceable(64) %i.hq)
...
.noexc.i.i.i.i.i.i:                               ; preds = %.sink.split.i.i.i.i.i.i.i
  ...
  %i.hy = load ptr, ptr %i.hx, align 8, !tbaa !224
  %.not.i.i.i.i.i.i.i = icmp eq ptr %i.hy, null
  %i.hz = load ptr, ptr %i.hq, align 8, !tbaa !45
  %..i.i.i.i.i.i.i = select i1 %.not.i.i.i.i.i.i.i, i64 8, i64 48
  %i.ia = getelementptr inbounds nuw i8, ptr %i.hz, i64 %..i.i.i.i.i.i.i
  %i.ib = load ptr, ptr %i.ia, align 8
  invoke void %i.ib(ptr noundef nonnull align 8 dereferenceable(64) %i.hq)
...
bb.af:                                            ; preds = %.noexc.i.i.i.i.i.i, %.sink.split.i.i.i.i.i.i.i
  ...
  call void @__clang_call_terminate(ptr %i.id) #35
  unreachable
...
_ZSt8_DestroyIN5boost13intrusive_ptrIN8facebook5velox6BufferEEEEvPT_.exit.i.i.i: ; preds = %.noexc.i.i.i.i.i.i, %bb.ae, %.lr.ph.i.i.i
  %i.ie = getelementptr inbounds nuw i8, ptr %.05.i.i.i, i64 8 ; 2 uses
  %.not.i.i.i72 = icmp eq ptr %i.ie, %i.hp
...
_ZSt8_DestroyIPN5boost13intrusive_ptrIN8facebook5velox6BufferEEES5_EvT_S7_RSaIT0_E.exit.i: ; preds = %_ZSt8_DestroyIPN5boost13intrusive_ptrIN8facebook5velox6BufferEEES5_EvT_S7_RSaIT0_E.exitthread-pre-split.i, %bb.ad
  %i.if = phi ptr [ %.pr.i, %_ZSt8_DestroyIPN5boost13intrusive_ptrIN8facebook5velox6BufferEEES5_EvT_S7_RSaIT0_E.exitthread-pre-split.i ], [ %i.hn, %bb.ad ] ; 3 uses
  %.not.i.i1.i = icmp eq ptr %i.if, null
...
bb.ag:                                            ; preds = %_ZSt8_DestroyIPN5boost13intrusive_ptrIN8facebook5velox6BufferEEES5_EvT_S7_RSaIT0_E.exit.i
  %i.ig = getelementptr inbounds nuw i8, ptr %17, i64 16
  %i.ih = load ptr, ptr %i.ig, align 8, !tbaa !271
  %i.ii = ptrtoint ptr %i.ih to i64
  %i.ij = ptrtoint ptr %i.if to i64
  %i.ik = sub i64 %i.ii, %i.ij
  call void @_ZdlPvm(ptr noundef nonnull %i.if, i64 noundef %i.ik) #34
...
_ZNSt6vectorIN5boost13intrusive_ptrIN8facebook5velox6BufferEEESaIS5_EED2Ev.exit: ; preds = %_ZSt8_DestroyIPN5boost13intrusive_ptrIN8facebook5velox6BufferEEES5_EvT_S7_RSaIT0_E.exit.i, %bb.ag
  ...
  %i.im = load ptr, ptr %i.il, align 8, !tbaa !37 ; 8 uses
...
bb.ah:                                            ; preds = %_ZNSt6vectorIN5boost13intrusive_ptrIN8facebook5velox6BufferEEESaIS5_EED2Ev.exit
  ...
  br i1 %i.ip, label %bb.ai, label %bb.aj

bb.ai:                                            ; preds = %bb.ah
  store i32 0, ptr %i.in, align 8, !tbaa !42
  %i.ir = getelementptr inbounds nuw i8, ptr %i.im, i64 12
  store i32 0, ptr %i.ir, align 4, !tbaa !44
  %i.is = load ptr, ptr %i.im, align 8, !tbaa !45
  %i.it = getelementptr inbounds nuw i8, ptr %i.is, i64 16
  %i.iu = load ptr, ptr %i.it, align 8
  call void %i.iu(ptr noundef nonnull align 8 dereferenceable(16) %i.im) #32, !inline_history !272
  %i.iv = load ptr, ptr %i.im, align 8, !tbaa !45
  %i.iw = getelementptr inbounds nuw i8, ptr %i.iv, i64 24
  %i.ix = load ptr, ptr %i.iw, align 8
  call void %i.ix(ptr noundef nonnull align 8 dereferenceable(16) %i.im) #32, !inline_history !272
...
begin_hunk_1_@_ZSt6__sortIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10BaseVector11sortIndicesERS5_NSA_12CompareFlagsEEUliiE_EEEvT_SG_T0_:bb.a
  ...
  %i.af = tail call i64 %i.ae(ptr noundef nonnull align 8 dereferenceable(94) %2, ptr noundef nonnull %2, i32 noundef %i.q, i32 noundef %i.ab, i64 %.sroa.01.0.copyload.i.i.i.i), !inline_history !473
  %i.ag = and i64 %i.af, 6442450944
  %.not.i.i = icmp eq i64 %i.ag, 4294967296
  br i1 %.not.i.i, label %_ZSt13move_backwardIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEES6_ET0_T_S8_S7_.exit.i, label %.lr.ph.i.i8, !llvm.loop !474
...
_ZSt13move_backwardIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEES6_ET0_T_S8_S7_.exit.i: ; preds = %.lr.ph.i.i8, %bb.h, %bb.g, %bb.f
  ...
  br i1 %i.ah, label %_ZSt16__insertion_sortIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10BaseVector11sortIndicesERS5_NSA_12CompareFlagsEEUliiE_EEEvT_SG_T0_.exit, label %bb.d, !llvm.loop !475
...
.lr.ph.i.i:                                       ; preds = %_ZSt16__insertion_sortIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10BaseVector11sortIndicesERS5_NSA_12CompareFlagsEEUliiE_EEEvT_SG_T0_.exit, %_ZSt25__unguarded_linear_insertIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops14_Val_comp_iterIZNK8facebook5velox10BaseVector11sortIndicesERS5_NSA_12CompareFlagsEEUliiE_EEEvT_T0_.exit.i.i
  ...
  %i.ap = tail call i64 %i.ao(ptr noundef nonnull align 8 dereferenceable(94) %2, ptr noundef nonnull %2, i32 noundef %i.ak, i32 noundef %i.al, i64 %.sroa.01.0.copyload.i.i9.i.i.i), !inline_history !476
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i, %.lr.ph.i.i.i
  ...
  %i.aw = tail call i64 %i.av(ptr noundef nonnull align 8 dereferenceable(94) %2, ptr noundef nonnull %2, i32 noundef %i.ak, i32 noundef %i.as, i64 %.sroa.01.0.copyload.i.i.i.i.i), !inline_history !476
  %i.ax = and i64 %i.aw, 6442450944
  %.not.i.i.i = icmp eq i64 %i.ax, 4294967296
  br i1 %.not.i.i.i, label %_ZSt25__unguarded_linear_insertIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops14_Val_comp_iterIZNK8facebook5velox10BaseVector11sortIndicesERS5_NSA_12CompareFlagsEEUliiE_EEEvT_T0_.exit.i.i, label %.lr.ph.i.i.i, !llvm.loop !474
...
_ZSt25__unguarded_linear_insertIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops14_Val_comp_iterIZNK8facebook5velox10BaseVector11sortIndicesERS5_NSA_12CompareFlagsEEUliiE_EEEvT_T0_.exit.i.i: ; preds = %.lr.ph.i.i.i, %.lr.ph.i.i
  ...
  br i1 %i.az, label %_ZSt22__final_insertion_sortIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10BaseVector11sortIndicesERS5_NSA_12CompareFlagsEEUliiE_EEEvT_SG_T0_.exit, label %.lr.ph.i.i, !llvm.loop !477
...
bb.b:                                             ; preds = %_ZSt27__unguarded_partition_pivotIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10BaseVector11sortIndicesERS5_NSA_12CompareFlagsEEUliiE_EEET_SG_SG_T0_.exit
  ...
  br i1 %i.h, label %._crit_edge, label %.lr.ph27, !llvm.loop !478
...
bb.d:                                             ; preds = %bb.d, %bb.c
  ...
  %i.t = tail call i64 %i.s(ptr noundef nonnull align 8 dereferenceable(94) %3, ptr noundef nonnull %3, i32 noundef %i.o, i32 noundef %i.p, i64 %.sroa.01.0.copyload.i.i.i.i), !inline_history !479
  ...
  br i1 %.not.i.i, label %.preheader.i.i, label %bb.d, !llvm.loop !480
...
.preheader.i.i:                                   ; preds = %bb.d, %.preheader.i.i
  ...
  %i.ab = tail call i64 %i.aa(ptr noundef nonnull align 8 dereferenceable(94) %3, ptr noundef nonnull %3, i32 noundef %i.w, i32 noundef %i.x, i64 %.sroa.01.0.copyload.i.i10.i.i), !inline_history !479
  %i.ac = and i64 %i.ab, 6442450944
  %.not19.i.i = icmp eq i64 %i.ac, 4294967296
  br i1 %.not19.i.i, label %bb.e, label %.preheader.i.i, !llvm.loop !481
...
_ZSt27__unguarded_partition_pivotIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10BaseVector11sortIndicesERS5_NSA_12CompareFlagsEEUliiE_EEET_SG_SG_T0_.exit: ; preds = %bb.e
  ...
  br i1 %i.aj, label %bb.b, label %.loopexit, !llvm.loop !478
...
bb.b:                                             ; preds = %.lr.ph, %_ZSt10__pop_heapIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10BaseVector11sortIndicesERS5_NSA_12CompareFlagsEEUliiE_EEEvT_SG_SG_RT0_.exit
  ...
  %.sroa.0.0.copyload.i = load ptr, ptr %2, align 8, !tbaa !483 ; 6 uses
  %.sroa.2.0.copyload.i = load ptr, ptr %.sroa.2.0..sroa_idx.i, align 8, !tbaa !484 ; 2 uses
...
.lr.ph.i.i:                                       ; preds = %bb.b, %.lr.ph.i.i
  ...
  %i.w = tail call i64 %i.v(ptr noundef nonnull align 8 dereferenceable(94) %.sroa.0.0.copyload.i, ptr noundef nonnull %.sroa.0.0.copyload.i, i32 noundef %i.r, i32 noundef %i.s, i64 %.sroa.01.0.copyload.i.i.i.i), !inline_history !486
  ...
  br i1 %i.ab, label %.lr.ph.i.i, label %._crit_edge.i.i, !llvm.loop !487
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.preheader, %bb.e
  ...
  %i.ar = tail call i64 %i.aq(ptr noundef nonnull align 8 dereferenceable(94) %.sroa.0.0.copyload.i, ptr noundef nonnull %.sroa.0.0.copyload.i, i32 noundef %i.an, i32 noundef %i.f, i64 %.sroa.01.0.copyload.i.i.i.i.i), !inline_history !488
...
bb.e:                                             ; preds = %.lr.ph.i.i.i
  ...
  br i1 %.not8.i, label %_ZSt10__pop_heapIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10BaseVector11sortIndicesERS5_NSA_12CompareFlagsEEUliiE_EEEvT_SG_SG_RT0_.exit, label %.lr.ph.i.i.i, !llvm.loop !489
...
_ZSt10__pop_heapIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10BaseVector11sortIndicesERS5_NSA_12CompareFlagsEEUliiE_EEEvT_SG_SG_RT0_.exit: ; preds = %.lr.ph.i.i.i, %bb.e, %bb.d
  ...
  br i1 %i.aw, label %bb.b, label %._crit_edge, !llvm.loop !490
...
bb.c:                                             ; preds = %_ZSt13__adjust_heapIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEliNS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10BaseVector11sortIndicesERS5_NSA_12CompareFlagsEEUliiE_EEEvT_T0_SH_T1_T2_.exit, %bb.b
  ...
  %.sroa.0.0.copyload = load ptr, ptr %2, align 8, !tbaa !483 ; 6 uses
  %.sroa.2.0.copyload = load ptr, ptr %.sroa.2.0..sroa_idx, align 8, !tbaa !484 ; 2 uses
...
.lr.ph.i:                                         ; preds = %bb.c, %.lr.ph.i
  ...
  %i.ac = tail call i64 %i.ab(ptr noundef nonnull align 8 dereferenceable(94) %.sroa.0.0.copyload, ptr noundef nonnull %.sroa.0.0.copyload, i32 noundef %i.x, i32 noundef %i.y, i64 %.sroa.01.0.copyload.i.i.i), !inline_history !491
  ...
  br i1 %i.ah, label %.lr.ph.i, label %._crit_edge.i, !llvm.loop !487
...
.lr.ph.i.i:                                       ; preds = %bb.e, %bb.f
  ...
  %i.aq = tail call i64 %i.ap(ptr noundef nonnull align 8 dereferenceable(94) %.sroa.0.0.copyload, ptr noundef nonnull %.sroa.0.0.copyload, i32 noundef %i.am, i32 noundef %i.q, i64 %.sroa.01.0.copyload.i.i.i.i), !inline_history !492
...
bb.f:                                             ; preds = %.lr.ph.i.i
  ...
  br i1 %i.au, label %.lr.ph.i.i, label %_ZSt13__adjust_heapIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEliNS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10BaseVector11sortIndicesERS5_NSA_12CompareFlagsEEUliiE_EEEvT_T0_SH_T1_T2_.exit, !llvm.loop !489
...
_ZSt13__adjust_heapIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEliNS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10BaseVector11sortIndicesERS5_NSA_12CompareFlagsEEUliiE_EEEvT_T0_SH_T1_T2_.exit: ; preds = %.lr.ph.i.i, %bb.f, %bb.e
  ...
  br i1 %.not, label %.loopexit, label %bb.c, !llvm.loop !493
...
bb.a:
  ...
  %i.f = tail call i64 %i.e(ptr noundef nonnull align 8 dereferenceable(94) %4, ptr noundef nonnull %4, i32 noundef %i.a, i32 noundef %i.b, i64 %.sroa.01.0.copyload.i.i), !inline_history !494
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.m = tail call i64 %i.k(ptr noundef nonnull align 8 dereferenceable(94) %4, ptr noundef nonnull %4, i32 noundef %i.l, i32 noundef %i.h, i64 %.sroa.01.0.copyload.i.i28), !inline_history !494
...
bb.d:                                             ; preds = %bb.b
  ...
  %i.v = tail call i64 %i.u(ptr noundef nonnull align 8 dereferenceable(94) %4, ptr noundef nonnull %4, i32 noundef %i.q, i32 noundef %i.r, i64 %.sroa.01.0.copyload.i.i27), !inline_history !494
...
bb.d:                                             ; preds = %bb.d, %bb.c
  ...
  %i.o = load ptr, ptr %.sroa.4.0.copyload, align 8, !tbaa !402 ; 2 uses
  ...
  %i.y = tail call i64 %i.x(ptr noundef nonnull align 8 dereferenceable(94) %.sroa.0.0.copyload, ptr noundef nonnull %.sroa.0.0.copyload, i32 noundef %i.r, i32 noundef %i.u, i64 %.sroa.01.0.copyload.i.i.i.i), !inline_history !497
  ...
  br i1 %.not.i.i, label %.preheader.i.i, label %bb.d, !llvm.loop !498
...
.preheader.i.i:                                   ; preds = %bb.d, %.preheader.i.i
  ...
  %i.ad = load ptr, ptr %.sroa.4.0.copyload, align 8, !tbaa !402 ; 2 uses
  ...
  %i.an = tail call i64 %i.am(ptr noundef nonnull align 8 dereferenceable(94) %.sroa.0.0.copyload, ptr noundef nonnull %.sroa.0.0.copyload, i32 noundef %i.ag, i32 noundef %i.aj, i64 %.sroa.01.0.copyload.i.i10.i.i), !inline_history !497
  %i.ao = and i64 %i.an, 6442450944
  %.not16.i.i = icmp eq i64 %i.ao, 4294967296
  br i1 %.not16.i.i, label %bb.e, label %.preheader.i.i, !llvm.loop !499
...
bb.b:                                             ; preds = %bb.a
  ...
  tail call void @_ZSt16__insertion_sortIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10BaseVector11sortIndicesERS5_PKiNSA_12CompareFlagsEEUliiE_EEEvT_SI_T0_(ptr %0, ptr nonnull %i.e, ptr noundef nonnull byval(%"struct.__gnu_cxx::__ops::_Iter_comp_iter.149") align 8 %2)
  %.sroa.0.sroa.0.0.copyload = load ptr, ptr %2, align 8, !tbaa !483 ; 6 uses
  %.sroa.0.sroa.2.0..sroa_idx = getelementptr inbounds nuw i8, ptr %2, i64 8
  %.sroa.0.sroa.2.0.copyload = load ptr, ptr %.sroa.0.sroa.2.0..sroa_idx, align 8, !tbaa !501 ; 2 uses
  %.sroa.0.sroa.3.0..sroa_idx = getelementptr inbounds nuw i8, ptr %2, i64 16
  %.sroa.0.sroa.3.0.copyload = load ptr, ptr %.sroa.0.sroa.3.0..sroa_idx, align 8, !tbaa !484 ; 2 uses
...
.lr.ph.i:                                         ; preds = %bb.b, %_ZSt25__unguarded_linear_insertIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops14_Val_comp_iterIZNK8facebook5velox10BaseVector11sortIndicesERS5_PKiNSA_12CompareFlagsEEUliiE_EEEvT_T0_.exit.i
  ...
  %i.j = load ptr, ptr %.sroa.0.sroa.2.0.copyload, align 8, !tbaa !402 ; 2 uses
  ...
  %i.s = tail call i64 %i.r(ptr noundef nonnull align 8 dereferenceable(94) %.sroa.0.sroa.0.0.copyload, ptr noundef nonnull %.sroa.0.sroa.0.0.copyload, i32 noundef %i.l, i32 noundef %i.o, i64 %.sroa.01.0.copyload.i.i8.i.i), !inline_history !503
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i, %.lr.ph.i.i
  ...
  %i.w = load ptr, ptr %.sroa.0.sroa.2.0.copyload, align 8, !tbaa !402 ; 2 uses
  ...
  %i.ad = getelementptr inbounds nuw i8, ptr %i.ac, i64 80
  %i.ae = load ptr, ptr %i.ad, align 8
  %i.af = tail call i64 %i.ae(ptr noundef nonnull align 8 dereferenceable(94) %.sroa.0.sroa.0.0.copyload, ptr noundef nonnull %.sroa.0.sroa.0.0.copyload, i32 noundef %i.y, i32 noundef %i.ab, i64 %.sroa.01.0.copyload.i.i.i.i), !inline_history !503
  %i.ag = and i64 %i.af, 6442450944
  %.not.i.i = icmp eq i64 %i.ag, 4294967296
  br i1 %.not.i.i, label %_ZSt25__unguarded_linear_insertIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops14_Val_comp_iterIZNK8facebook5velox10BaseVector11sortIndicesERS5_PKiNSA_12CompareFlagsEEUliiE_EEEvT_T0_.exit.i, label %.lr.ph.i.i, !llvm.loop !504
...
_ZSt25__unguarded_linear_insertIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops14_Val_comp_iterIZNK8facebook5velox10BaseVector11sortIndicesERS5_PKiNSA_12CompareFlagsEEUliiE_EEEvT_T0_.exit.i: ; preds = %.lr.ph.i.i, %.lr.ph.i
  ...
  br i1 %i.ai, label %_ZSt26__unguarded_insertion_sortIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10BaseVector11sortIndicesERS5_PKiNSA_12CompareFlagsEEUliiE_EEEvT_SI_T0_.exit, label %.lr.ph.i, !llvm.loop !505

bb.c:                                             ; preds = %bb.a
  tail call void @_ZSt16__insertion_sortIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10BaseVector11sortIndicesERS5_PKiNSA_12CompareFlagsEEUliiE_EEEvT_SI_T0_(ptr %0, ptr %1, ptr noundef nonnull byval(%"struct.__gnu_cxx::__ops::_Iter_comp_iter.149") align 8 %2)
...
bb.b:                                             ; preds = %.lr.ph, %_ZSt10__pop_heapIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10BaseVector11sortIndicesERS5_PKiNSA_12CompareFlagsEEUliiE_EEEvT_SI_SI_RT0_.exit
  ...
  %i.i = sub i64 %i.h, %i.a                       ; 3 uses
  %i.j = ashr exact i64 %i.i, 2                   ; 3 uses
  %.sroa.0.sroa.0.0.copyload.i = load ptr, ptr %2, align 8, !tbaa !483 ; 6 uses
  %.sroa.0.sroa.2.0.copyload.i = load ptr, ptr %.sroa.0.sroa.2.0..sroa_idx.i, align 8, !tbaa !501 ; 2 uses
  %.sroa.0.sroa.3.0.copyload.i = load ptr, ptr %.sroa.0.sroa.3.0..sroa_idx.i, align 8, !tbaa !484 ; 2 uses
  %i.k = add nsw i64 %i.j, -1
  %3 = lshr i64 %i.k, 1
  %i.l = icmp sgt i64 %i.j, 2
  br i1 %i.l, label %.lr.ph.i.i, label %._crit_edge.i.i
...
.lr.ph.i.i:                                       ; preds = %bb.b, %.lr.ph.i.i
  ...
  %i.r = load i32, ptr %i.o, align 4, !tbaa !3
  %i.s = load i32, ptr %i.q, align 4, !tbaa !3
  %i.t = load ptr, ptr %.sroa.0.sroa.2.0.copyload.i, align 8, !tbaa !402 ; 2 uses
  ...
  %i.ad = tail call i64 %i.ac(ptr noundef nonnull align 8 dereferenceable(94) %.sroa.0.sroa.0.0.copyload.i, ptr noundef nonnull %.sroa.0.sroa.0.0.copyload.i, i32 noundef %i.w, i32 noundef %i.z, i64 %.sroa.01.0.copyload.i.i.i.i), !inline_history !506
  ...
  br i1 %i.ai, label %.lr.ph.i.i, label %._crit_edge.i.i, !llvm.loop !507
...
bb.e:                                             ; preds = %bb.f, %.lr.ph.i.i.i
  ...
  %i.aw = load ptr, ptr %.sroa.0.sroa.2.0.copyload.i, align 8, !tbaa !402 ; 2 uses
  ...
  %i.bf = tail call i64 %i.be(ptr noundef nonnull align 8 dereferenceable(94) %.sroa.0.sroa.0.0.copyload.i, ptr noundef nonnull %.sroa.0.sroa.0.0.copyload.i, i32 noundef %i.az, i32 noundef %i.bb, i64 %.sroa.01.0.copyload.i.i.i.i.i), !inline_history !508
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %.not11.i, label %_ZSt10__pop_heapIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10BaseVector11sortIndicesERS5_PKiNSA_12CompareFlagsEEUliiE_EEEvT_SI_SI_RT0_.exit, label %bb.e, !llvm.loop !509
...
_ZSt10__pop_heapIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10BaseVector11sortIndicesERS5_PKiNSA_12CompareFlagsEEUliiE_EEEvT_SI_SI_RT0_.exit: ; preds = %bb.e, %bb.f, %bb.d
  ...
  br i1 %i.bk, label %bb.b, label %._crit_edge, !llvm.loop !510
...
.lr.ph.i:                                         ; preds = %bb.c, %.lr.ph.i
  ...
  %i.x = load i32, ptr %i.u, align 4, !tbaa !3
  %i.y = load i32, ptr %i.w, align 4, !tbaa !3
  %i.z = load ptr, ptr %.sroa.0.sroa.2.0.copyload, align 8, !tbaa !402 ; 2 uses
  ...
  %i.aj = tail call i64 %i.ai(ptr noundef nonnull align 8 dereferenceable(94) %.sroa.0.sroa.0.0.copyload, ptr noundef nonnull %.sroa.0.sroa.0.0.copyload, i32 noundef %i.ac, i32 noundef %i.af, i64 %.sroa.01.0.copyload.i.i.i), !inline_history !511
  ...
  br i1 %i.ao, label %.lr.ph.i, label %._crit_edge.i, !llvm.loop !507
...
bb.f:                                             ; preds = %bb.g, %.lr.ph.i.i
  ...
  %i.av = load ptr, ptr %.sroa.0.sroa.2.0.copyload, align 8, !tbaa !402 ; 2 uses
  ...
  %i.be = tail call i64 %i.bd(ptr noundef nonnull align 8 dereferenceable(94) %.sroa.0.sroa.0.0.copyload, ptr noundef nonnull %.sroa.0.sroa.0.0.copyload, i32 noundef %i.ay, i32 noundef %i.ba, i64 %.sroa.01.0.copyload.i.i.i.i), !inline_history !512
...
bb.g:                                             ; preds = %bb.f
  ...
  br i1 %i.bi, label %bb.f, label %_ZSt13__adjust_heapIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEliNS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10BaseVector11sortIndicesERS5_PKiNSA_12CompareFlagsEEUliiE_EEEvT_T0_SJ_T1_T2_.exit, !llvm.loop !509
...
_ZSt13__adjust_heapIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEliNS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10BaseVector11sortIndicesERS5_PKiNSA_12CompareFlagsEEUliiE_EEEvT_T0_SJ_T1_T2_.exit: ; preds = %bb.f, %bb.g, %bb.e
  ...
  br i1 %.not, label %.loopexit, label %bb.c, !llvm.loop !513
...
bb.a:
  ...
  %i.n = load ptr, ptr %i.m, align 8, !tbaa !517, !nonnull !70, !align !303 ; 4 uses
...
bb.e:                                             ; preds = %bb.c
  call void @_ZSt16__insertion_sortIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10FlatVectorIbE11sortIndicesILb1EZNKSC_11sortIndicesERS5_NSA_12CompareFlagsEEUliE_ZNKSC_11sortIndicesESE_SF_EUliE0_EEvT0_T1_SE_SF_EUliiE0_EEEvT_SM_SI_(ptr %i.e, ptr %i.g, ptr noundef nonnull byval(%"struct.__gnu_cxx::__ops::_Iter_comp_iter.295") align 8 %5)
  br label %_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEZNK8facebook5velox10FlatVectorIbE11sortIndicesILb1EZNKSA_11sortIndicesERS5_NS8_12CompareFlagsEEUliE_ZNKSA_11sortIndicesESC_SD_EUliE0_EEvT0_T1_SC_SD_EUliiE0_EvT_SJ_SG_.exit
...
bb.a:
  %5 = alloca %class.anon.302, align 8            ; 9 uses
  %6 = alloca %class.anon.291, align 8            ; 3 uses
  %7 = alloca %class.anon.292, align 8            ; 2 uses
  %8 = alloca %"struct.facebook::velox::CompareFlags", align 8 ; 4 uses
  %9 = alloca %class.anon.301, align 8            ; 5 uses
  ...
  store ptr %8, ptr %i.a, align 8, !tbaa !484
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !566
  %.not = icmp eq ptr %i.c, null
  %i.d = load ptr, ptr %3, align 8, !tbaa !402    ; 7 uses
  %i.e = getelementptr inbounds nuw i8, ptr %3, i64 8
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !402  ; 6 uses
...
bb.e:                                             ; preds = %bb.c
  call void @_ZSt16__insertion_sortIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10FlatVectorIbE11sortIndicesILb0EZNKSC_11sortIndicesERS5_NSA_12CompareFlagsEEUliE1_ZNKSC_11sortIndicesESE_SF_EUliE2_EEvT0_T1_SE_SF_EUliiE0_EEEvT_SM_SI_(ptr %i.d, ptr %i.f, ptr noundef nonnull byval(%"struct.__gnu_cxx::__ops::_Iter_comp_iter.303") align 8 %5)
  br label %_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEZNK8facebook5velox10FlatVectorIbE11sortIndicesILb0EZNKSA_11sortIndicesERS5_NS8_12CompareFlagsEEUliE1_ZNKSA_11sortIndicesESC_SD_EUliE2_EEvT0_T1_SC_SD_EUliiE0_EvT_SJ_SG_.exit
...
bb.b:                                             ; preds = %.lr.ph22
  ...
  br i1 %i.h, label %._crit_edge, label %.lr.ph22, !llvm.loop !850
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %_ZZNK8facebook5velox10FlatVectorIbE11sortIndicesILb1EZNKS2_11sortIndicesERSt6vectorIiSaIiEENS0_12CompareFlagsEEUliE_ZNKS2_11sortIndicesES7_S8_EUliE0_EEvT0_T1_S7_S8_ENKUliiE0_clEii.exit16.thread
  ...
  %i.af = load ptr, ptr %.sroa.019.0.copyload, align 8, !tbaa !851
  %i.ag = getelementptr inbounds nuw i8, ptr %i.af, i64 40
  %i.ah = load ptr, ptr %i.ag, align 8, !tbaa !566 ; 3 uses
...
bb.f:                                             ; preds = %bb.e
  call void @_ZN8facebook5velox6detail14veloxCheckFailINS0_14VeloxUserErrorEPKcEEvRKNS1_18VeloxCheckFailArgsET0_(ptr noundef nonnull align 8 dereferenceable(56) @_ZZN8facebook5velox10BaseVector12compareNullsEbbNS0_12CompareFlagsEE18veloxCheckFailArgs, ptr noundef nonnull @.str.46) #36
  unreachable
...
bb.h:                                             ; preds = %bb.d
  call void @_ZN8facebook5velox6detail14veloxCheckFailINS0_17VeloxRuntimeErrorEPKcEEvRKNS1_18VeloxCheckFailArgsET0_(ptr noundef nonnull align 8 dereferenceable(56) @_ZZN8facebook5velox10BaseVector12compareNullsEbbNS0_12CompareFlagsEE18veloxCheckFailArgs_0, ptr noundef nonnull @.str.47) #36
  unreachable
...
bb.i:                                             ; preds = %_ZZNK8facebook5velox10FlatVectorIbE11sortIndicesERSt6vectorIiSaIiEENS0_12CompareFlagsEENKUliE0_clEi.exit12.i6
  %i.az = load ptr, ptr %i.w, align 8, !tbaa !848
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #32
  %i.ba = load ptr, ptr %.sroa.7.0.copyload, align 8, !tbaa !853, !nonnull !70, !align !301
  %i.bb = load ptr, ptr %i.ba, align 8, !tbaa !854
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c) #32
  %i.be = load ptr, ptr %.sroa.7.0.copyload, align 8, !tbaa !853, !nonnull !70, !align !301
  %i.bf = load ptr, ptr %i.be, align 8, !tbaa !854
  ...
  %i.bj = load ptr, ptr %i.bi, align 8, !tbaa !138
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a)
  store ptr %i.bj, ptr %i.a, align 8, !tbaa !420
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #32
  store ptr %i.a, ptr %3, align 8, !tbaa !421
  store ptr %i.b, ptr %i.k, align 8, !tbaa !407
  store ptr %i.c, ptr %i.l, align 8, !tbaa !407
  ...
  %i.bl = load ptr, ptr %i.x, align 8, !tbaa !856, !nonnull !70, !align !303
  %i.bm = getelementptr inbounds nuw i8, ptr %i.bl, i64 1
  %i.bn = load i8, ptr %i.bm, align 1, !tbaa !857, !range !69, !noundef !70
...
_ZZNK8facebook5velox10FlatVectorIbE11sortIndicesILb1EZNKS2_11sortIndicesERSt6vectorIiSaIiEENS0_12CompareFlagsEEUliE_ZNKS2_11sortIndicesES7_S8_EUliE0_EEvT0_T1_S7_S8_ENKUliiE0_clEii.exit16.thread: ; preds = %bb.g, %bb.i, %_ZZNK8facebook5velox10FlatVectorIbE11sortIndicesILb1EZNKS2_11sortIndicesERSt6vectorIiSaIiEENS0_12CompareFlagsEEUliE_ZNKS2_11sortIndicesES7_S8_EUliE0_EEvT0_T1_S7_S8_ENKUliiE0_clEii.exit16, %bb.j
  ...
  br i1 %i.by, label %.lr.ph.i.i, label %._crit_edge.i.i, !llvm.loop !860
...
.lr.ph.i.i.i:                                     ; preds = %bb.t, %.lr.ph.i.i.preheader.i
  ...
  %i.cr = load ptr, ptr %.sroa.019.0.copyload, align 8, !tbaa !851
  %i.cs = getelementptr inbounds nuw i8, ptr %i.cr, i64 40
  %i.ct = load ptr, ptr %i.cs, align 8, !tbaa !566 ; 3 uses
...
bb.m:                                             ; preds = %.lr.ph.i.i.i
  ...
  %i.cx = load i64, ptr %i.cw, align 8, !tbaa !116
...
bb.s:                                             ; preds = %_ZZNK8facebook5velox10FlatVectorIbE11sortIndicesERSt6vectorIiSaIiEENS0_12CompareFlagsEENKUliE0_clEi.exit12.i
  %i.dj = load ptr, ptr %i.cn, align 8, !tbaa !848
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e) #32
  %i.dk = load ptr, ptr %.sroa.7.0.copyload, align 8, !tbaa !853, !nonnull !70, !align !301
  %i.dl = load ptr, ptr %i.dk, align 8, !tbaa !854
  ...
  %i.do = load ptr, ptr %.sroa.7.0.copyload, align 8, !tbaa !853, !nonnull !70, !align !301
  %i.dp = load ptr, ptr %i.do, align 8, !tbaa !854
  ...
  store ptr %i.dt, ptr %i.d, align 8, !tbaa !420
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #32
  store ptr %i.d, ptr %4, align 8, !tbaa !421
  store ptr %i.e, ptr %i.m, align 8, !tbaa !407
  store ptr %i.f, ptr %i.n, align 8, !tbaa !407
  ...
  %i.dv = load ptr, ptr %i.co, align 8, !tbaa !856, !nonnull !70, !align !303
  %i.dw = getelementptr inbounds nuw i8, ptr %i.dv, i64 1
  %i.dx = load i8, ptr %i.dw, align 1, !tbaa !857, !range !69, !noundef !70
...
_ZSt10__pop_heapIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10FlatVectorIbE11sortIndicesILb1EZNKSC_11sortIndicesERS5_NSA_12CompareFlagsEEUliE_ZNKSC_11sortIndicesESE_SF_EUliE0_EEvT0_T1_SE_SF_EUliiE0_EEEvT_SM_SM_RSI_.exit: ; preds = %bb.q, %bb.s, %bb.t, %bb.l
  ...
  br i1 %i.ef, label %bb.b, label %._crit_edge, !llvm.loop !862
...
bb.c:                                             ; preds = %_ZSt13__adjust_heapIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEliNS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10FlatVectorIbE11sortIndicesILb1EZNKSC_11sortIndicesERS5_NSA_12CompareFlagsEEUliE_ZNKSC_11sortIndicesESE_SF_EUliE0_EEvT0_T1_SE_SF_EUliiE0_EEEvT_SI_SI_SJ_T2_.exit, %bb.b
  ...
  %.sroa.0.sroa.2.0.copyload = load ptr, ptr %.sroa.0.sroa.2.0..sroa_idx, align 8, !tbaa !484 ; 2 uses
...
end_hunk_3
begin_hunk_4_@_ZSt16__insertion_sortIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10FlatVectorIbE11sortIndicesILb1EZNKSC_11sortIndicesERS5_NSA_12CompareFlagsEEUliE_ZNKSC_11sortIndicesESE_SF_EUliE0_EEvT0_T1_SE_SF_EUliiE_EEEvT_SM_SI_:bb.a
...
bb.b:                                             ; preds = %.lr.ph, %_ZSt13move_backwardIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEES6_ET0_T_S8_S7_.exit
  ...
  %i.s = load ptr, ptr %i.i, align 8, !tbaa !848
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e) #32
  %i.t = load ptr, ptr %i.j, align 8, !tbaa !854
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.f) #32
  %i.w = load ptr, ptr %i.j, align 8, !tbaa !854
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d)
  store ptr %i.aa, ptr %i.d, align 8, !tbaa !420
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #32
  store ptr %i.d, ptr %4, align 8, !tbaa !421
  store ptr %i.e, ptr %i.k, align 8, !tbaa !407
  store ptr %i.f, ptr %i.l, align 8, !tbaa !407
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #32
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d)
  %i.ac = load ptr, ptr %i.m, align 8, !tbaa !856
  %i.ad = getelementptr inbounds nuw i8, ptr %i.ac, i64 1 ; 2 uses
  %i.ae = load i8, ptr %i.ad, align 1, !tbaa !857, !range !69, !noundef !70
...
bb.c:                                             ; preds = %bb.b
  ...
  br i1 %i.an, label %bb.d, label %bb.e, !prof !121
...
.preheader24:                                     ; preds = %bb.b, %bb.g
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #32
  %i.av = load ptr, ptr %i.j, align 8, !tbaa !854
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c) #32
  %i.ay = load ptr, ptr %i.j, align 8, !tbaa !854
  ...
  %i.bb = load ptr, ptr %i.z, align 8, !tbaa !138
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a)
  store ptr %i.bb, ptr %i.a, align 8, !tbaa !420
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #32
  store ptr %i.a, ptr %3, align 8, !tbaa !421
  store ptr %i.b, ptr %i.n, align 8, !tbaa !407
  store ptr %i.c, ptr %i.o, align 8, !tbaa !407
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #32
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a)
  %i.bd = load i8, ptr %i.ad, align 1, !tbaa !857, !range !69, !noundef !70
...
bb.g:                                             ; preds = %.preheader24
  ...
  br label %.preheader24, !llvm.loop !877
...
_ZSt13move_backwardIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEES6_ET0_T_S8_S7_.exit: ; preds = %.preheader24, %bb.f, %bb.e, %bb.d
  ...
  br i1 %i.bj, label %.loopexit, label %bb.b, !llvm.loop !884
...
bb.b:                                             ; preds = %.lr.ph22
  %i.h = icmp eq i64 %i.j, 0
  br i1 %i.h, label %._crit_edge, label %.lr.ph22, !llvm.loop !885
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %_ZZNK8facebook5velox10FlatVectorIbE11sortIndicesILb0EZNKS2_11sortIndicesERSt6vectorIiSaIiEENS0_12CompareFlagsEEUliE1_ZNKS2_11sortIndicesES7_S8_EUliE2_EEvT0_T1_S7_S8_ENKUliiE0_clEii.exit17.thread
  ...
  %i.u = load ptr, ptr %.sroa.020.0.copyload, align 8, !tbaa !886
  %i.v = getelementptr inbounds nuw i8, ptr %i.u, i64 40
  %i.w = load ptr, ptr %i.v, align 8, !tbaa !566  ; 3 uses
...
bb.f:                                             ; preds = %bb.e
  tail call void @_ZN8facebook5velox6detail14veloxCheckFailINS0_14VeloxUserErrorEPKcEEvRKNS1_18VeloxCheckFailArgsET0_(ptr noundef nonnull align 8 dereferenceable(56) @_ZZN8facebook5velox10BaseVector12compareNullsEbbNS0_12CompareFlagsEE18veloxCheckFailArgs, ptr noundef nonnull @.str.46) #36
  unreachable
...
bb.h:                                             ; preds = %bb.d
  tail call void @_ZN8facebook5velox6detail14veloxCheckFailINS0_17VeloxRuntimeErrorEPKcEEvRKNS1_18VeloxCheckFailArgsET0_(ptr noundef nonnull align 8 dereferenceable(56) @_ZZN8facebook5velox10BaseVector12compareNullsEbbNS0_12CompareFlagsEE18veloxCheckFailArgs_0, ptr noundef nonnull @.str.47) #36
  unreachable
...
bb.i:                                             ; preds = %_ZZNK8facebook5velox10FlatVectorIbE11sortIndicesERSt6vectorIiSaIiEENS0_12CompareFlagsEENKUliE2_clEi.exit12.i6
  %i.ao = load ptr, ptr %.sroa.7.0.copyload, align 8, !tbaa !888, !nonnull !70, !align !301
  %i.ap = load ptr, ptr %i.ao, align 8, !tbaa !890
  ...
  %i.ar = load ptr, ptr %.sroa.7.0.copyload, align 8, !tbaa !888, !nonnull !70, !align !301
  %i.as = load ptr, ptr %i.ar, align 8, !tbaa !890
  ...
  %i.ax = load ptr, ptr %i.m, align 8, !tbaa !892, !nonnull !70, !align !303
  %i.ay = getelementptr inbounds nuw i8, ptr %i.ax, i64 1
  %i.az = load i8, ptr %i.ay, align 1, !tbaa !857, !range !69, !noundef !70
...
_ZZNK8facebook5velox10FlatVectorIbE11sortIndicesILb0EZNKS2_11sortIndicesERSt6vectorIiSaIiEENS0_12CompareFlagsEEUliE1_ZNKS2_11sortIndicesES7_S8_EUliE2_EEvT0_T1_S7_S8_ENKUliiE0_clEii.exit17.thread: ; preds = %bb.g, %bb.i, %_ZZNK8facebook5velox10FlatVectorIbE11sortIndicesILb0EZNKS2_11sortIndicesERSt6vectorIiSaIiEENS0_12CompareFlagsEEUliE1_ZNKS2_11sortIndicesES7_S8_EUliE2_EEvT0_T1_S7_S8_ENKUliiE0_clEii.exit17, %bb.j
  ...
  br i1 %i.bj, label %.lr.ph.i.i, label %._crit_edge.i.i, !llvm.loop !893
...
.lr.ph.i.i.i:                                     ; preds = %bb.t, %.lr.ph.i.i.preheader.i
  ...
  %i.cb = load ptr, ptr %.sroa.020.0.copyload, align 8, !tbaa !886
  %i.cc = getelementptr inbounds nuw i8, ptr %i.cb, i64 40
  %i.cd = load ptr, ptr %i.cc, align 8, !tbaa !566 ; 3 uses
...
bb.m:                                             ; preds = %.lr.ph.i.i.i
  ...
  %i.ch = load i64, ptr %i.cg, align 8, !tbaa !116
...
bb.s:                                             ; preds = %_ZZNK8facebook5velox10FlatVectorIbE11sortIndicesERSt6vectorIiSaIiEENS0_12CompareFlagsEENKUliE2_clEi.exit12.i
  %i.ct = load ptr, ptr %.sroa.7.0.copyload, align 8, !tbaa !888, !nonnull !70, !align !301
  %i.cu = load ptr, ptr %i.ct, align 8, !tbaa !890
  ...
  %i.cw = load ptr, ptr %.sroa.7.0.copyload, align 8, !tbaa !888, !nonnull !70, !align !301
  %i.cx = load ptr, ptr %i.cw, align 8, !tbaa !890
  ...
  %i.dc = load ptr, ptr %i.by, align 8, !tbaa !892, !nonnull !70, !align !303
  %i.dd = getelementptr inbounds nuw i8, ptr %i.dc, i64 1
  %i.de = load i8, ptr %i.dd, align 1, !tbaa !857, !range !69, !noundef !70
...
_ZSt10__pop_heapIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10FlatVectorIbE11sortIndicesILb0EZNKSC_11sortIndicesERS5_NSA_12CompareFlagsEEUliE1_ZNKSC_11sortIndicesESE_SF_EUliE2_EEvT0_T1_SE_SF_EUliiE0_EEEvT_SM_SM_RSI_.exit: ; preds = %bb.q, %bb.s, %bb.t, %bb.l
  ...
  br i1 %i.dl, label %bb.b, label %._crit_edge, !llvm.loop !895
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %_ZZNK8facebook5velox10FlatVectorIbE11sortIndicesILb0EZNKS2_11sortIndicesERSt6vectorIiSaIiEENS0_12CompareFlagsEEUliE1_ZNKS2_11sortIndicesES7_S8_EUliE2_EEvT0_T1_S7_S8_ENKUliiE0_clEii.exit24.thread
  ...
  %i.aa = load ptr, ptr %.sroa.0.sroa.0.0.copyload, align 8, !tbaa !886
  %i.ab = getelementptr inbounds nuw i8, ptr %i.aa, i64 40
  %i.ac = load ptr, ptr %i.ab, align 8, !tbaa !566 ; 3 uses
...
end_hunk_4
begin_hunk_5_@_ZSt22__final_insertion_sortIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10FlatVectorIbE11sortIndicesILb1EZNKSC_11sortIndicesERS5_PKiNSA_12CompareFlagsEEUliE_ZNKSC_11sortIndicesESE_SG_SH_EUliE0_EEvT0_T1_SE_SH_EUliiE0_EEEvT_SO_SK_:bb.a
  br label %bb.b
...
bb.c:                                             ; preds = %bb.b
  ...
  br i1 %i.i, label %bb.d, label %bb.e, !prof !121
...
bb.i:                                             ; preds = %.lr.ph.i15
  ...
  br i1 %i.al, label %bb.j, label %bb.k, !prof !121
...
bb.a:
  %3 = alloca %"struct.__gnu_cxx::__ops::_Iter_comp_val.316", align 8 ; 6 uses
  %4 = alloca %"struct.__gnu_cxx::__ops::_Iter_comp_iter.315", align 8 ; 6 uses
  %i.a = ptrtoint ptr %0 to i64                   ; 2 uses
  %i.b = ptrtoint ptr %1 to i64
  %i.c = sub i64 %i.b, %i.a
  %i.d = icmp sgt i64 %i.c, 4
...
.lr.ph.i.i:                                       ; preds = %.lr.ph, %.lr.ph.i.i
  ...
  br i1 %i.x, label %.lr.ph.i.i, label %._crit_edge.i.i, !llvm.loop !927
...
.thread.i:                                        ; preds = %bb.b
  ...
  store i32 %i.ag, ptr %i.ah, align 4, !tbaa !3
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #32
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %3, ptr noundef nonnull align 8 dereferenceable(24) %4, i64 24, i1 false), !tbaa.struct !928
  br label %.lr.ph.i.i.i.preheader
...
_ZSt10__pop_heapIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10FlatVectorIbE11sortIndicesILb1EZNKSC_11sortIndicesERS5_PKiNSA_12CompareFlagsEEUliE_ZNKSC_11sortIndicesESE_SG_SH_EUliE0_EEvT0_T1_SE_SH_EUliiE0_EEEvT_SO_SO_RSK_.exit: ; preds = %.lr.ph.i.i.i, %bb.d, %bb.c
  ...
  br i1 %i.ao, label %.lr.ph, label %._crit_edge, !llvm.loop !930
...
bb.a:
  %3 = alloca %"struct.__gnu_cxx::__ops::_Iter_comp_val.316", align 8 ; 4 uses
  %4 = alloca %"struct.__gnu_cxx::__ops::_Iter_comp_iter.315", align 8 ; 5 uses
  %i.a = ptrtoint ptr %1 to i64
  %i.b = ptrtoint ptr %0 to i64
  %i.c = sub i64 %i.a, %i.b                       ; 2 uses
  %i.d = ashr exact i64 %i.c, 2                   ; 3 uses
...
.lr.ph.i:                                         ; preds = %bb.c, %.lr.ph.i
  ...
  br i1 %i.ad, label %.lr.ph.i, label %._crit_edge.i, !llvm.loop !927
...
_ZSt13__adjust_heapIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEliNS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10FlatVectorIbE11sortIndicesILb1EZNKSC_11sortIndicesERS5_PKiNSA_12CompareFlagsEEUliE_ZNKSC_11sortIndicesESE_SG_SH_EUliE0_EEvT0_T1_SE_SH_EUliiE0_EEEvT_SK_SK_SL_T2_.exit: ; preds = %.lr.ph.i.i, %bb.f, %bb.e
  ...
  br i1 %.not, label %.loopexit, label %bb.c, !llvm.loop !931
...
bb.a:
  ...
  %i.b = alloca i8, align 1                       ; 4 uses
  %i.c = alloca i8, align 1                       ; 4 uses
  %i.d = load ptr, ptr %0, align 8, !tbaa !932, !nonnull !70, !align !301 ; 2 uses
  %i.e = load ptr, ptr %i.d, align 8, !tbaa !934
  %i.f = getelementptr inbounds nuw i8, ptr %i.e, i64 40
  %i.g = load ptr, ptr %i.f, align 8, !tbaa !566  ; 3 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.i = load ptr, ptr %i.h, align 8, !tbaa !936, !nonnull !70, !align !301
  %i.j = load ptr, ptr %i.i, align 8, !tbaa !402  ; 2 uses
...
bb.c:                                             ; preds = %_ZZNK8facebook5velox10FlatVectorIbE11sortIndicesERSt6vectorIiSaIiEEPKiNS0_12CompareFlagsEENKUliE0_clEi.exit12
  ...
  %i.ah = load ptr, ptr %i.ag, align 8, !tbaa !937, !nonnull !70, !align !303
  ...
  switch i32 %.sroa.37.0.extract.trunc.i, label %bb.h [
    i32 1, label %bb.d
end_hunk_5
begin_hunk_6_@_ZSt16__insertion_sortIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10FlatVectorIbE11sortIndicesILb1EZNKSC_11sortIndicesERS5_PKiNSA_12CompareFlagsEEUliE_ZNKSC_11sortIndicesESE_SG_SH_EUliE0_EEvT0_T1_SE_SH_EUliiE_EEEvT_SO_SK_:bb.a
  call void @llvm.lifetime.start.p0(ptr nonnull %i.f) #32
  %i.ac = load ptr, ptr %i.j, align 8, !tbaa !940
  %i.ad = load ptr, ptr %i.k, align 8, !tbaa !942, !nonnull !70, !align !301
  ...
  %i.al = load ptr, ptr %i.ak, align 8, !tbaa !138
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d)
  store ptr %i.al, ptr %i.d, align 8, !tbaa !420
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #32
  store ptr %i.d, ptr %4, align 8, !tbaa !421
  store ptr %i.e, ptr %i.l, align 8, !tbaa !407
  store ptr %i.f, ptr %i.m, align 8, !tbaa !407
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #32
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d)
  %i.an = load ptr, ptr %i.n, align 8, !tbaa !943
  %i.ao = getelementptr inbounds nuw i8, ptr %i.an, i64 1 ; 2 uses
  %i.ap = load i8, ptr %i.ao, align 1, !tbaa !857, !range !69, !noundef !70
...
bb.c:                                             ; preds = %bb.b
  ...
  br i1 %i.ay, label %bb.d, label %bb.e, !prof !121
...
bb.h:                                             ; preds = %bb.i, %bb.g
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #32
  %i.bh = load ptr, ptr %i.j, align 8, !tbaa !940
  %i.bi = load ptr, ptr %i.k, align 8, !tbaa !942, !nonnull !70, !align !301
  %i.bj = load ptr, ptr %i.bi, align 8, !tbaa !402
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c) #32
  %i.bo = load ptr, ptr %i.j, align 8, !tbaa !940
  %i.bp = load ptr, ptr %i.k, align 8, !tbaa !942, !nonnull !70, !align !301
  %i.bq = load ptr, ptr %i.bp, align 8, !tbaa !402
  ...
  %i.bw = load ptr, ptr %i.ak, align 8, !tbaa !138
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a)
  store ptr %i.bw, ptr %i.a, align 8, !tbaa !420
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #32
  store ptr %i.a, ptr %3, align 8, !tbaa !421
  store ptr %i.b, ptr %i.o, align 8, !tbaa !407
  store ptr %i.c, ptr %i.p, align 8, !tbaa !407
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #32
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a)
  %i.by = load i8, ptr %i.ao, align 1, !tbaa !857, !range !69, !noundef !70
...
_ZSt13move_backwardIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEES6_ET0_T_S8_S7_.exit: ; preds = %bb.h, %bb.f, %bb.e, %bb.d
  ...
  br i1 %i.ce, label %.loopexit, label %bb.b, !llvm.loop !954
...
bb.b:                                             ; preds = %.lr.ph22
  %i.h = icmp eq i64 %i.j, 0
  br i1 %i.h, label %._crit_edge, label %.lr.ph22, !llvm.loop !955
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %_ZZNK8facebook5velox10FlatVectorIbE11sortIndicesILb0EZNKS2_11sortIndicesERSt6vectorIiSaIiEEPKiNS0_12CompareFlagsEEUliE1_ZNKS2_11sortIndicesES7_S9_SA_EUliE2_EEvT0_T1_S7_SA_ENKUliiE0_clEii.exit17.thread
  ...
  %i.v = load ptr, ptr %.sroa.020.0.copyload, align 8, !tbaa !956
  %i.w = getelementptr inbounds nuw i8, ptr %i.v, i64 40
  %i.x = load ptr, ptr %i.w, align 8, !tbaa !566  ; 3 uses
...
bb.c:                                             ; preds = %.lr.ph.i.i
  %i.y = load ptr, ptr %i.m, align 8, !tbaa !958, !nonnull !70, !align !301
  %i.z = load ptr, ptr %i.y, align 8, !tbaa !402  ; 2 uses
...
bb.i:                                             ; preds = %_ZZNK8facebook5velox10FlatVectorIbE11sortIndicesERSt6vectorIiSaIiEEPKiNS0_12CompareFlagsEENKUliE2_clEi.exit12.i6
  %i.ax = load ptr, ptr %.sroa.7.0.copyload, align 8, !tbaa !959, !nonnull !70, !align !301 ; 2 uses
  %i.ay = load ptr, ptr %i.ax, align 8, !tbaa !961
  %i.az = getelementptr inbounds nuw i8, ptr %i.ax, i64 8
  %i.ba = load ptr, ptr %i.az, align 8, !tbaa !963, !nonnull !70, !align !301
  %i.bb = load ptr, ptr %i.ba, align 8, !tbaa !402
  ...
  %i.bg = load ptr, ptr %.sroa.7.0.copyload, align 8, !tbaa !959, !nonnull !70, !align !301 ; 2 uses
  %i.bh = load ptr, ptr %i.bg, align 8, !tbaa !961
  %i.bi = getelementptr inbounds nuw i8, ptr %i.bg, i64 8
  %i.bj = load ptr, ptr %i.bi, align 8, !tbaa !963, !nonnull !70, !align !301
  %i.bk = load ptr, ptr %i.bj, align 8, !tbaa !402
  ...
  %i.bs = load ptr, ptr %i.n, align 8, !tbaa !964, !nonnull !70, !align !303
  %i.bt = getelementptr inbounds nuw i8, ptr %i.bs, i64 1
  %i.bu = load i8, ptr %i.bt, align 1, !tbaa !857, !range !69, !noundef !70
...
_ZZNK8facebook5velox10FlatVectorIbE11sortIndicesILb0EZNKS2_11sortIndicesERSt6vectorIiSaIiEEPKiNS0_12CompareFlagsEEUliE1_ZNKS2_11sortIndicesES7_S9_SA_EUliE2_EEvT0_T1_S7_SA_ENKUliiE0_clEii.exit17.thread: ; preds = %bb.g, %bb.i, %_ZZNK8facebook5velox10FlatVectorIbE11sortIndicesILb0EZNKS2_11sortIndicesERSt6vectorIiSaIiEEPKiNS0_12CompareFlagsEEUliE1_ZNKS2_11sortIndicesES7_S9_SA_EUliE2_EEvT0_T1_S7_SA_ENKUliiE0_clEii.exit17, %bb.j
  ...
  br i1 %i.ce, label %.lr.ph.i.i, label %._crit_edge.i.i, !llvm.loop !965
...
.lr.ph.i.i.i:                                     ; preds = %bb.t, %.lr.ph.i.i.preheader.i
  ...
  %i.cu = load ptr, ptr %.sroa.020.0.copyload, align 8, !tbaa !956
  %i.cv = getelementptr inbounds nuw i8, ptr %i.cu, i64 40
  %i.cw = load ptr, ptr %i.cv, align 8, !tbaa !566 ; 3 uses
...
bb.m:                                             ; preds = %.lr.ph.i.i.i
  %i.cx = load ptr, ptr %i.cp, align 8, !tbaa !958, !nonnull !70, !align !301
  %i.cy = load ptr, ptr %i.cx, align 8, !tbaa !402 ; 2 uses
...
bb.s:                                             ; preds = %_ZZNK8facebook5velox10FlatVectorIbE11sortIndicesERSt6vectorIiSaIiEEPKiNS0_12CompareFlagsEENKUliE2_clEi.exit12.i
  %i.dx = load ptr, ptr %.sroa.7.0.copyload, align 8, !tbaa !959, !nonnull !70, !align !301 ; 2 uses
  %i.dy = load ptr, ptr %i.dx, align 8, !tbaa !961
  %i.dz = getelementptr inbounds nuw i8, ptr %i.dx, i64 8
  %i.ea = load ptr, ptr %i.dz, align 8, !tbaa !963, !nonnull !70, !align !301
  %i.eb = load ptr, ptr %i.ea, align 8, !tbaa !402
  ...
  %i.eg = load ptr, ptr %.sroa.7.0.copyload, align 8, !tbaa !959, !nonnull !70, !align !301 ; 2 uses
  %i.eh = load ptr, ptr %i.eg, align 8, !tbaa !961
  %i.ei = getelementptr inbounds nuw i8, ptr %i.eg, i64 8
  %i.ej = load ptr, ptr %i.ei, align 8, !tbaa !963, !nonnull !70, !align !301
  %i.ek = load ptr, ptr %i.ej, align 8, !tbaa !402
  ...
  %i.er = load ptr, ptr %i.cr, align 8, !tbaa !964, !nonnull !70, !align !303
  %i.es = getelementptr inbounds nuw i8, ptr %i.er, i64 1
  %i.et = load i8, ptr %i.es, align 1, !tbaa !857, !range !69, !noundef !70
...
_ZSt10__pop_heapIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10FlatVectorIbE11sortIndicesILb0EZNKSC_11sortIndicesERS5_PKiNSA_12CompareFlagsEEUliE1_ZNKSC_11sortIndicesESE_SG_SH_EUliE2_EEvT0_T1_SE_SH_EUliiE0_EEEvT_SO_SO_RSK_.exit: ; preds = %bb.q, %bb.s, %bb.t, %bb.l
  ...
  br i1 %i.fa, label %bb.b, label %._crit_edge, !llvm.loop !967
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %_ZZNK8facebook5velox10FlatVectorIbE11sortIndicesILb0EZNKS2_11sortIndicesERSt6vectorIiSaIiEEPKiNS0_12CompareFlagsEEUliE1_ZNKS2_11sortIndicesES7_S9_SA_EUliE2_EEvT0_T1_S7_SA_ENKUliiE0_clEii.exit24.thread
  ...
  %i.ab = load ptr, ptr %.sroa.0.sroa.0.0.copyload, align 8, !tbaa !956
...
bb.d:                                             ; preds = %.lr.ph.i
  %i.ae = load ptr, ptr %i.s, align 8, !tbaa !958, !nonnull !70, !align !301
end_hunk_6
...
_ZSt25__unguarded_linear_insertIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops14_Val_comp_iterIZNK8facebook5velox10FlatVectorImE11sortIndicesILb1EZNKSC_11sortIndicesERS5_NSA_12CompareFlagsEEUliE_ZNKSC_11sortIndicesESE_SF_EUliE0_EEvT0_T1_SE_SF_EUliiE_EEEvT_SI_.exit.i.i.i.i: ; preds = %bb.j
  ...
  br i1 %i.bd, label %_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEZNK8facebook5velox10FlatVectorImE11sortIndicesILb1EZNKSA_11sortIndicesERS5_NS8_12CompareFlagsEEUliE_ZNKSA_11sortIndicesESC_SD_EUliE0_EEvT0_T1_SC_SD_EUliiE_EvT_SJ_SG_.exit, label %bb.i, !llvm.loop !1126

bb.l:                                             ; preds = %bb.g
  call void @_ZSt16__insertion_sortIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10FlatVectorImE11sortIndicesILb1EZNKSC_11sortIndicesERS5_NSA_12CompareFlagsEEUliE_ZNKSC_11sortIndicesESE_SF_EUliE0_EEvT0_T1_SE_SF_EUliiE_EEEvT_SM_SI_(ptr %i.h, ptr %i.j, ptr noundef nonnull byval(%"struct.__gnu_cxx::__ops::_Iter_comp_iter.372") align 8 %10)
...
bb.a:
  %5 = alloca %class.anon.376, align 8            ; 9 uses
  %6 = alloca %class.anon.365, align 8            ; 4 uses
  %7 = alloca %class.anon.366, align 8            ; 2 uses
  %8 = alloca %"struct.facebook::velox::CompareFlags", align 8 ; 5 uses
  %9 = alloca %class.anon.375, align 8            ; 5 uses
  store ptr %1, ptr %6, align 8
  store ptr %2, ptr %7, align 8
  store i64 %4, ptr %8, align 8
  call void @llvm.lifetime.start.p0(ptr nonnull %9) #32
  ...
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !566
  %.not = icmp eq ptr %i.c, null
  %i.d = load ptr, ptr %3, align 8, !tbaa !402    ; 10 uses
  %i.e = getelementptr inbounds nuw i8, ptr %3, i64 8
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !402  ; 9 uses
  br i1 %.not, label %bb.f, label %bb.b
...
bb.e:                                             ; preds = %bb.c
  call void @_ZSt16__insertion_sortIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10FlatVectorImE11sortIndicesILb0EZNKSC_11sortIndicesERS5_NSA_12CompareFlagsEEUliE1_ZNKSC_11sortIndicesESE_SF_EUliE2_EEvT0_T1_SE_SF_EUliiE0_EEEvT_SM_SI_(ptr %i.d, ptr %i.f, ptr noundef nonnull byval(%"struct.__gnu_cxx::__ops::_Iter_comp_iter.377") align 8 %5)
  br label %_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEZNK8facebook5velox10FlatVectorImE11sortIndicesILb0EZNKSA_11sortIndicesERS5_NS8_12CompareFlagsEEUliE1_ZNKSA_11sortIndicesESC_SD_EUliE2_EEvT0_T1_SC_SD_EUliiE0_EvT_SJ_SG_.exit
...
bb.b:                                             ; preds = %.lr.ph22
  %i.h = icmp eq i64 %i.j, 0
  br i1 %i.h, label %._crit_edge, label %.lr.ph22, !llvm.loop !1127
...
bb.a:
  ...
  %i.d = alloca ptr, align 8                      ; 4 uses
  %4 = alloca %class.anon.179, align 8            ; 6 uses
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %_ZZNK8facebook5velox10FlatVectorImE11sortIndicesILb1EZNKS2_11sortIndicesERSt6vectorIiSaIiEENS0_12CompareFlagsEEUliE_ZNKS2_11sortIndicesES7_S8_EUliE0_EEvT0_T1_S7_S8_ENKUliiE0_clEii.exit16.thread
  ...
  %i.ad = load i32, ptr %i.aa, align 4, !tbaa !3  ; 2 uses
  %i.ae = load i32, ptr %i.ac, align 4, !tbaa !3  ; 2 uses
  %i.af = load ptr, ptr %.sroa.019.0.copyload, align 8, !tbaa !1128
  %i.ag = getelementptr inbounds nuw i8, ptr %i.af, i64 40
  %i.ah = load ptr, ptr %i.ag, align 8, !tbaa !566 ; 3 uses
  %.not.i.i.i3 = icmp eq ptr %i.ah, null
...
bb.i:                                             ; preds = %_ZZNK8facebook5velox10FlatVectorImE11sortIndicesERSt6vectorIiSaIiEENS0_12CompareFlagsEENKUliE0_clEi.exit12.i6
  %i.az = load ptr, ptr %i.w, align 8, !tbaa !1121
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #32
  %i.ba = load ptr, ptr %.sroa.7.0.copyload, align 8, !tbaa !1130, !nonnull !70, !align !301
  %i.bb = load ptr, ptr %i.ba, align 8, !tbaa !1123
  %i.bc = getelementptr inbounds nuw i8, ptr %i.bb, i64 144
  %i.bd = load ptr, ptr %i.bc, align 8, !tbaa !993 ; 2 uses
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a)
  store ptr %i.bl, ptr %i.a, align 8, !tbaa !420
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #32
  store ptr %i.a, ptr %3, align 8, !tbaa !421
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #32
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a)
  %i.bn = load ptr, ptr %i.x, align 8, !tbaa !1131, !nonnull !70, !align !303
  %i.bo = getelementptr inbounds nuw i8, ptr %i.bn, i64 1
  %i.bp = load i8, ptr %i.bo, align 1, !tbaa !857, !range !69, !noundef !70
...
_ZZNK8facebook5velox10FlatVectorImE11sortIndicesILb1EZNKS2_11sortIndicesERSt6vectorIiSaIiEENS0_12CompareFlagsEEUliE_ZNKS2_11sortIndicesES7_S8_EUliE0_EEvT0_T1_S7_S8_ENKUliiE0_clEii.exit16.thread: ; preds = %bb.g, %bb.i, %_ZZNK8facebook5velox10FlatVectorImE11sortIndicesILb1EZNKS2_11sortIndicesERSt6vectorIiSaIiEENS0_12CompareFlagsEEUliE_ZNKS2_11sortIndicesES7_S8_EUliE0_EEvT0_T1_S7_S8_ENKUliiE0_clEii.exit16, %bb.j
  ...
  br i1 %i.ca, label %.lr.ph.i.i, label %._crit_edge.i.i, !llvm.loop !1132
...
.lr.ph.i.i.i:                                     ; preds = %bb.t, %.lr.ph.i.i.preheader.i
  ...
  %i.cs = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %.0920.i.i67.i ; 2 uses
  %i.ct = load i32, ptr %i.cs, align 4, !tbaa !3  ; 3 uses
  %i.cu = load ptr, ptr %.sroa.019.0.copyload, align 8, !tbaa !1128
  %i.cv = getelementptr inbounds nuw i8, ptr %i.cu, i64 40
  %i.cw = load ptr, ptr %i.cv, align 8, !tbaa !566 ; 3 uses
  %.not.i.i.i = icmp eq ptr %i.cw, null
...
bb.s:                                             ; preds = %_ZZNK8facebook5velox10FlatVectorImE11sortIndicesERSt6vectorIiSaIiEENS0_12CompareFlagsEENKUliE0_clEi.exit12.i
  %i.dm = load ptr, ptr %i.cp, align 8, !tbaa !1121
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e) #32
  %i.dn = load ptr, ptr %.sroa.7.0.copyload, align 8, !tbaa !1130, !nonnull !70, !align !301
  %i.do = load ptr, ptr %i.dn, align 8, !tbaa !1123
  %i.dp = getelementptr inbounds nuw i8, ptr %i.do, i64 144
  %i.dq = load ptr, ptr %i.dp, align 8, !tbaa !993 ; 2 uses
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d)
  store ptr %i.dx, ptr %i.d, align 8, !tbaa !420
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #32
  store ptr %i.d, ptr %4, align 8, !tbaa !421
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #32
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d)
  %i.dz = load ptr, ptr %i.cr, align 8, !tbaa !1131, !nonnull !70, !align !303
  %i.ea = getelementptr inbounds nuw i8, ptr %i.dz, i64 1
  %i.eb = load i8, ptr %i.ea, align 1, !tbaa !857, !range !69, !noundef !70
...
_ZSt10__pop_heapIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10FlatVectorImE11sortIndicesILb1EZNKSC_11sortIndicesERS5_NSA_12CompareFlagsEEUliE_ZNKSC_11sortIndicesESE_SF_EUliE0_EEvT0_T1_SE_SF_EUliiE0_EEEvT_SM_SM_RSI_.exit: ; preds = %bb.q, %bb.s, %bb.t, %bb.l
  ...
  br i1 %i.ej, label %bb.b, label %._crit_edge, !llvm.loop !1134
...
begin_hunk_8_@_ZSt16__insertion_sortIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10FlatVectorImE11sortIndicesILb1EZNKSC_11sortIndicesERS5_NSA_12CompareFlagsEEUliE_ZNKSC_11sortIndicesESE_SF_EUliE0_EEvT0_T1_SE_SF_EUliiE_EEEvT_SM_SI_:bb.a
  ...
  %i.q = load i32, ptr %.sroa.08.021, align 4, !tbaa !3
  %i.r = load i32, ptr %0, align 4, !tbaa !3
  %i.s = load ptr, ptr %i.i, align 8, !tbaa !1121
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e) #32
  %i.t = load ptr, ptr %i.j, align 8, !tbaa !1123
  %i.u = getelementptr inbounds nuw i8, ptr %i.t, i64 144
  %i.v = load ptr, ptr %i.u, align 8, !tbaa !993  ; 2 uses
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d)
  store ptr %i.ad, ptr %i.d, align 8, !tbaa !420
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #32
  store ptr %i.d, ptr %4, align 8, !tbaa !421
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #32
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d)
  %i.af = load ptr, ptr %i.m, align 8, !tbaa !1131
  %i.ag = getelementptr inbounds nuw i8, ptr %i.af, i64 1 ; 2 uses
  %i.ah = load i8, ptr %i.ag, align 1, !tbaa !857, !range !69, !noundef !70
...
bb.h:                                             ; preds = %bb.i, %bb.g
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #32
  %i.az = load ptr, ptr %i.j, align 8, !tbaa !1123
  %i.ba = getelementptr inbounds nuw i8, ptr %i.az, i64 144
  %i.bb = load ptr, ptr %i.ba, align 8, !tbaa !993 ; 2 uses
  ...
  %i.bh = load ptr, ptr %i.ac, align 8, !tbaa !138
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a)
  store ptr %i.bh, ptr %i.a, align 8, !tbaa !420
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #32
  store ptr %i.a, ptr %3, align 8, !tbaa !421
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #32
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a)
  %i.bj = load i8, ptr %i.ag, align 1, !tbaa !857, !range !69, !noundef !70
...
_ZSt13move_backwardIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEES6_ET0_T_S8_S7_.exit: ; preds = %bb.h, %bb.f, %bb.e, %bb.d
  ...
  br i1 %i.bp, label %.loopexit, label %bb.b, !llvm.loop !1154
...
bb.b:                                             ; preds = %.lr.ph22
  %i.h = icmp eq i64 %i.j, 0
  br i1 %i.h, label %._crit_edge, label %.lr.ph22, !llvm.loop !1155
...
.lr.ph.i.i.preheader:                             ; preds = %bb.b
  %i.m = load ptr, ptr %.sroa.019.0.copyload, align 8, !tbaa !1156
  %i.n = getelementptr inbounds nuw i8, ptr %i.m, i64 40
  %i.o = load ptr, ptr %i.n, align 8, !tbaa !566  ; 3 uses
...
bb.i:                                             ; preds = %_ZZNK8facebook5velox10FlatVectorImE11sortIndicesERSt6vectorIiSaIiEENS0_12CompareFlagsEENKUliE2_clEi.exit12.i.i7
  %i.ao = load ptr, ptr %.sroa.7.0.copyload, align 8, !tbaa !1158, !nonnull !70, !align !301
  %i.ap = load ptr, ptr %i.ao, align 8, !tbaa !1160
  %i.aq = getelementptr inbounds nuw i8, ptr %i.ap, i64 144
  %i.ar = load ptr, ptr %i.aq, align 8, !tbaa !993 ; 2 uses
  ...
  %i.az = load ptr, ptr %i.p, align 8, !tbaa !1162, !nonnull !70, !align !303
  %i.ba = getelementptr inbounds nuw i8, ptr %i.az, i64 1
  %i.bb = load i8, ptr %i.ba, align 1, !tbaa !857, !range !69, !noundef !70
...
_ZN9__gnu_cxx5__ops15_Iter_comp_iterIZNK8facebook5velox10FlatVectorImE11sortIndicesILb0EZNKS5_11sortIndicesERSt6vectorIiSaIiEENS3_12CompareFlagsEEUliE1_ZNKS5_11sortIndicesESA_SB_EUliE2_EEvT0_T1_SA_SB_EUliiE0_EclINS_17__normal_iteratorIPiS9_EESL_EEbT_SE_.exit.thread: ; preds = %bb.g, %bb.i, %_ZN9__gnu_cxx5__ops15_Iter_comp_iterIZNK8facebook5velox10FlatVectorImE11sortIndicesILb0EZNKS5_11sortIndicesERSt6vectorIiSaIiEENS3_12CompareFlagsEEUliE1_ZNKS5_11sortIndicesESA_SB_EUliE2_EEvT0_T1_SA_SB_EUliiE0_EclINS_17__normal_iteratorIPiS9_EESL_EEbT_SE_.exit, %bb.j
  ...
  br i1 %i.bl, label %.lr.ph.i.i, label %._crit_edge.i.i, !llvm.loop !1163
...
.lr.ph.i.i.preheader.i:                           ; preds = %bb.l, %.thread.i
  ...
  %i.bw = load ptr, ptr %.sroa.019.0.copyload, align 8, !tbaa !1156
  %i.bx = getelementptr inbounds nuw i8, ptr %i.bw, i64 40
  %i.by = load ptr, ptr %i.bx, align 8, !tbaa !566 ; 3 uses
...
bb.s:                                             ; preds = %_ZZNK8facebook5velox10FlatVectorImE11sortIndicesERSt6vectorIiSaIiEENS0_12CompareFlagsEENKUliE2_clEi.exit12.i.i
  %i.cw = load ptr, ptr %.sroa.7.0.copyload, align 8, !tbaa !1158, !nonnull !70, !align !301
  %i.cx = load ptr, ptr %i.cw, align 8, !tbaa !1160
  %i.cy = getelementptr inbounds nuw i8, ptr %i.cx, i64 144
  %i.cz = load ptr, ptr %i.cy, align 8, !tbaa !993 ; 2 uses
  ...
  %i.dg = load ptr, ptr %i.cf, align 8, !tbaa !1162, !nonnull !70, !align !303
  %i.dh = getelementptr inbounds nuw i8, ptr %i.dg, i64 1
  %i.di = load i8, ptr %i.dh, align 1, !tbaa !857, !range !69, !noundef !70
...
_ZSt10__pop_heapIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10FlatVectorImE11sortIndicesILb0EZNKSC_11sortIndicesERS5_NSA_12CompareFlagsEEUliE1_ZNKSC_11sortIndicesESE_SF_EUliE2_EEvT0_T1_SE_SF_EUliiE0_EEEvT_SM_SM_RSI_.exit: ; preds = %bb.q, %bb.t, %bb.s, %bb.l
  ...
  br i1 %i.dp, label %bb.b, label %._crit_edge, !llvm.loop !1165
...
.lr.ph.i.preheader:                               ; preds = %bb.c
  %i.t = load ptr, ptr %.sroa.0.sroa.0.0.copyload, align 8, !tbaa !1156
  %i.u = getelementptr inbounds nuw i8, ptr %i.t, i64 40
  %i.v = load ptr, ptr %i.u, align 8, !tbaa !566  ; 3 uses
...
bb.a:
  %7 = alloca %class.anon.396, align 8            ; 9 uses
  %8 = alloca %class.anon.385, align 8            ; 5 uses
  %9 = alloca %class.anon.386, align 8            ; 3 uses
  %10 = alloca %"struct.facebook::velox::CompareFlags", align 8 ; 5 uses
  %11 = alloca %class.anon.395, align 8           ; 5 uses
  ...
  store ptr %10, ptr %i.c, align 8, !tbaa !484
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.e = load ptr, ptr %i.d, align 8, !tbaa !566
  %.not = icmp eq ptr %i.e, null
  %i.f = load ptr, ptr %5, align 8, !tbaa !402    ; 10 uses
  %i.g = getelementptr inbounds nuw i8, ptr %5, i64 8
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !402  ; 9 uses
  br i1 %.not, label %bb.f, label %bb.b
...
bb.e:                                             ; preds = %bb.c
  call void @_ZSt16__insertion_sortIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10FlatVectorImE11sortIndicesILb0EZNKSC_11sortIndicesERS5_PKiNSA_12CompareFlagsEEUliE1_ZNKSC_11sortIndicesESE_SG_SH_EUliE2_EEvT0_T1_SE_SH_EUliiE0_EEEvT_SO_SK_(ptr %i.f, ptr %i.h, ptr noundef nonnull byval(%"struct.__gnu_cxx::__ops::_Iter_comp_iter.397") align 8 %7)
  br label %_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEZNK8facebook5velox10FlatVectorImE11sortIndicesILb0EZNKSA_11sortIndicesERS5_PKiNS8_12CompareFlagsEEUliE1_ZNKSA_11sortIndicesESC_SE_SF_EUliE2_EEvT0_T1_SC_SF_EUliiE0_EvT_SL_SI_.exit
...
bb.b:                                             ; preds = %.lr.ph22
  %i.h = icmp eq i64 %i.j, 0
  br i1 %i.h, label %._crit_edge, label %.lr.ph22, !llvm.loop !1190
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %_ZZNK8facebook5velox10FlatVectorImE11sortIndicesILb1EZNKS2_11sortIndicesERSt6vectorIiSaIiEEPKiNS0_12CompareFlagsEEUliE_ZNKS2_11sortIndicesES7_S9_SA_EUliE0_EEvT0_T1_S7_SA_ENKUliiE0_clEii.exit16.thread
  ...
  %i.ag = load ptr, ptr %.sroa.019.0.copyload, align 8, !tbaa !1191
  %i.ah = getelementptr inbounds nuw i8, ptr %i.ag, i64 40
  %i.ai = load ptr, ptr %i.ah, align 8, !tbaa !566 ; 3 uses
...
bb.c:                                             ; preds = %.lr.ph.i.i
  %i.aj = load ptr, ptr %i.w, align 8, !tbaa !1193, !nonnull !70, !align !301
  %i.ak = load ptr, ptr %i.aj, align 8, !tbaa !402 ; 2 uses
...
bb.i:                                             ; preds = %_ZZNK8facebook5velox10FlatVectorImE11sortIndicesERSt6vectorIiSaIiEEPKiNS0_12CompareFlagsEENKUliE0_clEi.exit12.i6
  %i.bi = load ptr, ptr %i.x, align 8, !tbaa !1188
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #32
  %i.bj = load ptr, ptr %.sroa.7.0.copyload, align 8, !tbaa !1194, !nonnull !70, !align !301 ; 2 uses
  %i.bk = load ptr, ptr %i.bj, align 8, !tbaa !1195
  %i.bl = getelementptr inbounds nuw i8, ptr %i.bj, i64 8
  %i.bm = load ptr, ptr %i.bl, align 8, !tbaa !1197, !nonnull !70, !align !301
  %i.bn = load ptr, ptr %i.bm, align 8, !tbaa !402 ; 2 uses
  ...
  %i.bs = load ptr, ptr %i.br, align 8, !tbaa !993 ; 2 uses
  ...
  %i.cd = load ptr, ptr %i.cc, align 8, !tbaa !138
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a)
  store ptr %i.cd, ptr %i.a, align 8, !tbaa !420
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #32
  store ptr %i.a, ptr %3, align 8, !tbaa !421
  store ptr %i.b, ptr %i.k, align 8, !tbaa !308
  store ptr %i.c, ptr %i.l, align 8, !tbaa !308
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #32
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a)
  %i.cf = load ptr, ptr %i.y, align 8, !tbaa !1198, !nonnull !70, !align !303
  %i.cg = getelementptr inbounds nuw i8, ptr %i.cf, i64 1
  %i.ch = load i8, ptr %i.cg, align 1, !tbaa !857, !range !69, !noundef !70
...
_ZZNK8facebook5velox10FlatVectorImE11sortIndicesILb1EZNKS2_11sortIndicesERSt6vectorIiSaIiEEPKiNS0_12CompareFlagsEEUliE_ZNKS2_11sortIndicesES7_S9_SA_EUliE0_EEvT0_T1_S7_SA_ENKUliiE0_clEii.exit16.thread: ; preds = %bb.g, %bb.i, %_ZZNK8facebook5velox10FlatVectorImE11sortIndicesILb1EZNKS2_11sortIndicesERSt6vectorIiSaIiEEPKiNS0_12CompareFlagsEEUliE_ZNKS2_11sortIndicesES7_S9_SA_EUliE0_EEvT0_T1_S7_SA_ENKUliiE0_clEii.exit16, %bb.j
  ...
  br i1 %i.cs, label %.lr.ph.i.i, label %._crit_edge.i.i, !llvm.loop !1199
...
.lr.ph.i.i.i:                                     ; preds = %bb.t, %.lr.ph.i.i.preheader.i
  ...
  %i.dj = load ptr, ptr %.sroa.019.0.copyload, align 8, !tbaa !1191
  %i.dk = getelementptr inbounds nuw i8, ptr %i.dj, i64 40
  %i.dl = load ptr, ptr %i.dk, align 8, !tbaa !566 ; 3 uses
...
bb.m:                                             ; preds = %.lr.ph.i.i.i
  %i.dm = load ptr, ptr %i.dd, align 8, !tbaa !1193, !nonnull !70, !align !301
  %i.dn = load ptr, ptr %i.dm, align 8, !tbaa !402 ; 2 uses
...
bb.s:                                             ; preds = %_ZZNK8facebook5velox10FlatVectorImE11sortIndicesERSt6vectorIiSaIiEEPKiNS0_12CompareFlagsEENKUliE0_clEi.exit12.i
  %i.em = load ptr, ptr %i.df, align 8, !tbaa !1188
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e) #32
  %i.en = load ptr, ptr %.sroa.7.0.copyload, align 8, !tbaa !1194, !nonnull !70, !align !301 ; 2 uses
  %i.eo = load ptr, ptr %i.en, align 8, !tbaa !1195
  %i.ep = getelementptr inbounds nuw i8, ptr %i.en, i64 8
  %i.eq = load ptr, ptr %i.ep, align 8, !tbaa !1197, !nonnull !70, !align !301
  %i.er = load ptr, ptr %i.eq, align 8, !tbaa !402 ; 2 uses
  ...
  %i.ew = load ptr, ptr %i.ev, align 8, !tbaa !993 ; 2 uses
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d)
  store ptr %i.fg, ptr %i.d, align 8, !tbaa !420
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #32
  store ptr %i.d, ptr %4, align 8, !tbaa !421
  store ptr %i.e, ptr %i.m, align 8, !tbaa !308
  store ptr %i.f, ptr %i.n, align 8, !tbaa !308
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #32
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d)
  %i.fi = load ptr, ptr %i.dg, align 8, !tbaa !1198, !nonnull !70, !align !303
  %i.fj = getelementptr inbounds nuw i8, ptr %i.fi, i64 1
  %i.fk = load i8, ptr %i.fj, align 1, !tbaa !857, !range !69, !noundef !70
...
_ZSt10__pop_heapIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10FlatVectorImE11sortIndicesILb1EZNKSC_11sortIndicesERS5_PKiNSA_12CompareFlagsEEUliE_ZNKSC_11sortIndicesESE_SG_SH_EUliE0_EEvT0_T1_SE_SH_EUliiE0_EEEvT_SO_SO_RSK_.exit: ; preds = %bb.q, %bb.s, %bb.t, %bb.l
  ...
  br i1 %i.fs, label %bb.b, label %._crit_edge, !llvm.loop !1201
...
begin_hunk_10_@_ZSt16__insertion_sortIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10FlatVectorImE11sortIndicesILb1EZNKSC_11sortIndicesERS5_PKiNSA_12CompareFlagsEEUliE_ZNKSC_11sortIndicesESE_SG_SH_EUliE0_EEvT0_T1_SE_SH_EUliiE_EEEvT_SO_SK_:bb.a
  ...
  %i.am = load ptr, ptr %i.al, align 8, !tbaa !138
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d)
  store ptr %i.am, ptr %i.d, align 8, !tbaa !420
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #32
  store ptr %i.d, ptr %4, align 8, !tbaa !421
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #32
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d)
  %i.ao = load ptr, ptr %i.n, align 8, !tbaa !1198
  %i.ap = getelementptr inbounds nuw i8, ptr %i.ao, i64 1 ; 2 uses
  %i.aq = load i8, ptr %i.ap, align 1, !tbaa !857, !range !69, !noundef !70
...
bb.h:                                             ; preds = %bb.i, %bb.g
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #32
  %i.bi = load ptr, ptr %i.j, align 8, !tbaa !1195
  %i.bj = load ptr, ptr %i.k, align 8, !tbaa !1197, !nonnull !70, !align !301
  %i.bk = load ptr, ptr %i.bj, align 8, !tbaa !402 ; 2 uses
  ...
  %i.bo = load ptr, ptr %i.bn, align 8, !tbaa !993 ; 2 uses
  ...
  %i.by = load ptr, ptr %i.al, align 8, !tbaa !138
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a)
  store ptr %i.by, ptr %i.a, align 8, !tbaa !420
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #32
  store ptr %i.a, ptr %3, align 8, !tbaa !421
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #32
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a)
  %i.ca = load i8, ptr %i.ap, align 1, !tbaa !857, !range !69, !noundef !70
...
_ZSt13move_backwardIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEES6_ET0_T_S8_S7_.exit: ; preds = %bb.h, %bb.f, %bb.e, %bb.d
  ...
  br i1 %i.cg, label %.loopexit, label %bb.b, !llvm.loop !1223
...
bb.b:                                             ; preds = %.lr.ph22
  %i.h = icmp eq i64 %i.j, 0
  br i1 %i.h, label %._crit_edge, label %.lr.ph22, !llvm.loop !1224
...
.lr.ph.i.i.preheader:                             ; preds = %bb.b
  %i.m = load ptr, ptr %.sroa.019.0.copyload, align 8, !tbaa !1225
  %i.n = getelementptr inbounds nuw i8, ptr %i.m, i64 40
  %i.o = load ptr, ptr %i.n, align 8, !tbaa !566  ; 3 uses
...
bb.c:                                             ; preds = %.lr.ph.i.i
  %i.y = load ptr, ptr %i.p, align 8, !tbaa !1227, !nonnull !70, !align !301
  %i.z = load ptr, ptr %i.y, align 8, !tbaa !402  ; 2 uses
...
bb.i:                                             ; preds = %_ZZNK8facebook5velox10FlatVectorImE11sortIndicesERSt6vectorIiSaIiEEPKiNS0_12CompareFlagsEENKUliE2_clEi.exit12.i6
  %i.ax = load ptr, ptr %.sroa.7.0.copyload, align 8, !tbaa !1228, !nonnull !70, !align !301 ; 2 uses
  %i.ay = load ptr, ptr %i.ax, align 8, !tbaa !1230
  %i.az = getelementptr inbounds nuw i8, ptr %i.ax, i64 8
  %i.ba = load ptr, ptr %i.az, align 8, !tbaa !1232, !nonnull !70, !align !301
  %i.bb = load ptr, ptr %i.ba, align 8, !tbaa !402 ; 2 uses
  %i.bc = sext i32 %i.w to i64
  %i.bd = getelementptr inbounds [4 x i8], ptr %i.bb, i64 %i.bc
  %i.be = load i32, ptr %i.bd, align 4, !tbaa !3
  %i.bf = getelementptr inbounds nuw i8, ptr %i.ay, i64 144
  %i.bg = load ptr, ptr %i.bf, align 8, !tbaa !993 ; 2 uses
  ...
  %i.br = load ptr, ptr %i.q, align 8, !tbaa !1233, !nonnull !70, !align !303
  %i.bs = getelementptr inbounds nuw i8, ptr %i.br, i64 1
  %i.bt = load i8, ptr %i.bs, align 1, !tbaa !857, !range !69, !noundef !70
...
_ZZNK8facebook5velox10FlatVectorImE11sortIndicesILb0EZNKS2_11sortIndicesERSt6vectorIiSaIiEEPKiNS0_12CompareFlagsEEUliE1_ZNKS2_11sortIndicesES7_S9_SA_EUliE2_EEvT0_T1_S7_SA_ENKUliiE0_clEii.exit16.thread: ; preds = %bb.g, %bb.i, %_ZZNK8facebook5velox10FlatVectorImE11sortIndicesILb0EZNKS2_11sortIndicesERSt6vectorIiSaIiEEPKiNS0_12CompareFlagsEEUliE1_ZNKS2_11sortIndicesES7_S9_SA_EUliE2_EEvT0_T1_S7_SA_ENKUliiE0_clEii.exit16, %bb.j
  ...
  br i1 %i.cd, label %.lr.ph.i.i, label %._crit_edge.i.i, !llvm.loop !1234
...
.lr.ph.i.i.preheader.i:                           ; preds = %bb.l, %.thread.i
  ...
  %i.co = load ptr, ptr %.sroa.019.0.copyload, align 8, !tbaa !1225
  %i.cp = getelementptr inbounds nuw i8, ptr %i.co, i64 40
  %i.cq = load ptr, ptr %i.cp, align 8, !tbaa !566 ; 3 uses
...
bb.m:                                             ; preds = %.lr.ph.i.i.i
  %i.cw = load ptr, ptr %i.cr, align 8, !tbaa !1227, !nonnull !70, !align !301
  %i.cx = load ptr, ptr %i.cw, align 8, !tbaa !402 ; 2 uses
...
bb.s:                                             ; preds = %_ZZNK8facebook5velox10FlatVectorImE11sortIndicesERSt6vectorIiSaIiEEPKiNS0_12CompareFlagsEENKUliE2_clEi.exit12.i
  %i.dw = load ptr, ptr %.sroa.7.0.copyload, align 8, !tbaa !1228, !nonnull !70, !align !301 ; 2 uses
  %i.dx = load ptr, ptr %i.dw, align 8, !tbaa !1230
  %i.dy = getelementptr inbounds nuw i8, ptr %i.dw, i64 8
  %i.dz = load ptr, ptr %i.dy, align 8, !tbaa !1232, !nonnull !70, !align !301
  %i.ea = load ptr, ptr %i.dz, align 8, !tbaa !402 ; 2 uses
  ...
  %i.ef = load ptr, ptr %i.ee, align 8, !tbaa !993 ; 2 uses
  ...
  %i.ep = load ptr, ptr %i.ct, align 8, !tbaa !1233, !nonnull !70, !align !303
  %i.eq = getelementptr inbounds nuw i8, ptr %i.ep, i64 1
  %i.er = load i8, ptr %i.eq, align 1, !tbaa !857, !range !69, !noundef !70
...
_ZSt10__pop_heapIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterIZNK8facebook5velox10FlatVectorImE11sortIndicesILb0EZNKSC_11sortIndicesERS5_PKiNSA_12CompareFlagsEEUliE1_ZNKSC_11sortIndicesESE_SG_SH_EUliE2_EEvT0_T1_SE_SH_EUliiE0_EEEvT_SO_SO_RSK_.exit: ; preds = %bb.q, %bb.s, %bb.t, %bb.l
  ...
  br i1 %i.ey, label %bb.b, label %._crit_edge, !llvm.loop !1236
...
.lr.ph.i.preheader:                               ; preds = %bb.c
  %i.u = load ptr, ptr %.sroa.0.sroa.0.0.copyload, align 8, !tbaa !1225
  %i.v = getelementptr inbounds nuw i8, ptr %i.u, i64 40
  %i.w = load ptr, ptr %i.v, align 8, !tbaa !566  ; 3 uses
...
bb.d:                                             ; preds = %.lr.ph.i
  %i.ae = load ptr, ptr %i.j, align 8, !tbaa !1227, !nonnull !70, !align !301
