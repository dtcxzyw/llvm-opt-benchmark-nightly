...
bb.b:                                             ; preds = %_ZN12_GLOBAL__N_120exTypefromSSLErrInfoEimi.exit
  ...
  store ptr %i.c, ptr %7, align 8, !tbaa !14, !alias.scope !11
...
._crit_edge.i.i.i:                                ; preds = %bb.b
  ...
  store i64 14, ptr %i.d, align 8, !tbaa !18, !alias.scope !11
  %i.e = getelementptr inbounds nuw i8, ptr %7, i64 30
  store i8 0, ptr %i.e, align 2, !tbaa !21, !alias.scope !11
...
._crit_edge.i.i11.i:                              ; preds = %bb.b
  ...
  store i64 13, ptr %i.d, align 8, !tbaa !18, !alias.scope !11
  %i.f = getelementptr inbounds nuw i8, ptr %7, i64 29
  store i8 0, ptr %i.f, align 1, !tbaa !21, !alias.scope !11
  br label %_ZN12_GLOBAL__N_118decodeOpenSSLErrorB5cxx11Eimi.exit.thread
...
_ZN12_GLOBAL__N_118decodeOpenSSLErrorB5cxx11Eimi.exit.thread38: ; preds = %bb.a
  ...
  %8 = tail call noalias noundef nonnull dereferenceable(31) ptr @_Znwm(i64 noundef 31) #11, !noalias !11 ; 3 uses
  store ptr %8, ptr %7, align 8, !tbaa !22, !alias.scope !11
  store i64 30, ptr %i.g, align 8, !tbaa !21, !alias.scope !11
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(30) %8, ptr noundef nonnull align 1 dereferenceable(30) @.str.2, i64 30, i1 false), !noalias !11
  ...
  store i8 0, ptr %i.i, align 1, !tbaa !21, !noalias !11
  br label %_ZN12_GLOBAL__N_118decodeOpenSSLErrorB5cxx11Eimi.exit.thread
...
.thread:                                          ; preds = %_ZN12_GLOBAL__N_120exTypefromSSLErrInfoEimi.exit, %bb.c
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #10, !noalias !11
  call void @ERR_error_string_n(i64 noundef %2, ptr noundef nonnull %6, i64 noundef 256), !noalias !11
  %i.k = getelementptr inbounds nuw i8, ptr %7, i64 16 ; 3 uses
  store ptr %i.k, ptr %7, align 8, !tbaa !14, !alias.scope !11
  %i.l = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %6) #10, !noalias !11 ; 8 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  br i1 %i.p, label %.noexc11.i29.i, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm.exit.i.i28.i, !prof !23
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm.exit.i.i28.i: ; preds = %bb.e
  ...
  store ptr %i.q, ptr %7, align 8, !tbaa !22, !alias.scope !11
  store i64 %i.l, ptr %i.k, align 8, !tbaa !21, !alias.scope !11
...
bb.f:                                             ; preds = %._crit_edge.i.i27.i
  %i.s = load i8, ptr %6, align 1, !tbaa !21, !noalias !11
  store i8 %i.s, ptr %i.r, align 1, !tbaa !21
...
_ZN12_GLOBAL__N_118decodeOpenSSLErrorB5cxx11Eimi.exit: ; preds = %._crit_edge.i.i27.i, %bb.f, %bb.g
  ...
  store i64 %i.l, ptr %i.t, align 8, !tbaa !18, !alias.scope !11
  %i.u = getelementptr inbounds nuw i8, ptr %i.r, i64 %i.l
  store i8 0, ptr %i.u, align 1, !tbaa !21
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #10, !noalias !11
...
bb.h:                                             ; preds = %.noexc
  %i.x = load ptr, ptr %5, align 8, !tbaa !22     ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i: ; preds = %bb.h
  %i.aa = load i64, ptr %i.y, align 8, !tbaa !21
  %i.ab = add i64 %i.aa, 1
...
bb.i:                                             ; preds = %.noexc
  %i.ac = landingpad { ptr, i32 }
          cleanup
  %i.ad = load ptr, ptr %5, align 8, !tbaa !22    ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i.i: ; preds = %bb.h, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #10
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVN5folly20AsyncSocketExceptionE, i64 16), ptr %0, align 8, !tbaa !24
  %i.ai = getelementptr inbounds nuw i8, ptr %0, i64 16
  store i32 %.0.i1936, ptr %i.ai, align 8, !tbaa !26
  %i.aj = getelementptr inbounds nuw i8, ptr %0, i64 20
  store i32 %i.w, ptr %i.aj, align 4, !tbaa !32
  %i.ak = load ptr, ptr %7, align 8, !tbaa !22    ; 2 uses
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i.i, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVN5folly12SSLExceptionE, i64 16), ptr %0, align 8, !tbaa !24
  %i.ap = icmp eq i32 %1, 6
  %i.aq = getelementptr inbounds nuw i8, ptr %0, i64 24
  %.sink = select i1 %i.ap, i32 5, i32 %.
  store i32 %.sink, ptr %i.aq, align 8, !tbaa !33
  %i.ar = getelementptr inbounds nuw i8, ptr %0, i64 32
  store i64 %2, ptr %i.ar, align 8, !tbaa !36
  ret void
...
.body:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit9.i, %bb.j
  ...
  %i.at = load ptr, ptr %7, align 8, !tbaa !22    ; 2 uses
...
bb.a:
  tail call void @_ZNSt13runtime_errorD2Ev(ptr noundef nonnull align 8 dereferenceable(40) %0) #10
