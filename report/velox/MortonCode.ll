...
bb.a:
  ...
  %i.k = or <2 x i32> %i.j, %i.i                  ; 2 uses
  %i.l = and <2 x i32> %i.k, splat (i32 858993459) ; 2 uses
  %i.m = extractelement <2 x i32> %i.l, i64 0
  %i.n = shl nuw nsw i32 %i.m, 1
  %2 = insertelement <2 x i32> %i.k, i32 %i.n, i64 0
  %3 = and <2 x i32> %2, <i32 -1, i32 858993459>
  %4 = shl nuw <2 x i32> %i.l, <i32 2, i32 1>
  %i.o = or <2 x i32> %4, %3
