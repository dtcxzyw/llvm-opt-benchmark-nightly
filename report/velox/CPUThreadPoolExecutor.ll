...
_ZN5folly10hazptr_objISt6atomicE16pre_retire_checkEv.exit: ; preds = %.loopexit, %bb.e
  store <2 x ptr> <ptr @_ZZN5folly22hazptr_obj_base_linkedINS_14UnboundedQueueINS_21CPUThreadPoolExecutor7CPUTaskELb0ELb0ELb0ELm6ELm6ESt6atomicE7SegmentES4_St14default_deleteIS6_EE11set_reclaimEvENUlPNS_10hazptr_objIS4_EERNS_15hazptr_obj_listIS4_EEE_8__invokeESC_SF_, ptr null>, ptr %i.z, align 8, !tbaa !58
...
_ZN5folly10hazptr_objISt6atomicE16pre_retire_checkEv.exit: ; preds = %.loopexit, %bb.e
  store <2 x ptr> <ptr @_ZZN5folly22hazptr_obj_base_linkedINS_14UnboundedQueueINS_21CPUThreadPoolExecutor7CPUTaskELb0ELb0ELb1ELm8ELm6ESt6atomicE7SegmentES4_St14default_deleteIS6_EE11set_reclaimEvENUlPNS_10hazptr_objIS4_EERNS_15hazptr_obj_listIS4_EEE_8__invokeESC_SF_, ptr null>, ptr %i.z, align 8, !tbaa !58
  %i.ak = load ptr, ptr %i.i, align 8, !tbaa !5702 ; 2 uses
  %.not.i.i7 = icmp eq ptr %i.ak, null
  br i1 %.not.i.i7, label %bb.g, label %bb.f
end_hunk_3
...
begin_hunk_5_@_ZN5folly25PriorityUnboundedQueueSetINS_21CPUThreadPoolExecutor7CPUTaskELb0ELb0ELb1ELm8ELm6ESt6atomicE11try_dequeueEv:bb.a
  ...
  %i.cr = getelementptr inbounds nuw i8, ptr %i.cc, i64 72
  %i.cs = load <2 x ptr>, ptr %i.cq, align 16, !tbaa !58
  store <2 x ptr> %i.cs, ptr %i.g, align 16, !tbaa !58
  store <2 x ptr> <ptr @_ZN5folly6detail8function14FunctionTraitsIFvvEE10uninitCallERNS1_4DataE, ptr null>, ptr %i.cq, align 16, !tbaa !58
...
begin_hunk_6_@_ZN5folly25PriorityUnboundedQueueSetINS_21CPUThreadPoolExecutor7CPUTaskELb0ELb0ELb1ELm8ELm6ESt6atomicE11try_dequeueEv:bb.a
  ...
  store <2 x ptr> <ptr @_ZN5folly6detail8function14FunctionTraitsIFvvEE10uninitCallERNS1_4DataE, ptr null>, ptr %i.g, align 16, !tbaa !58
