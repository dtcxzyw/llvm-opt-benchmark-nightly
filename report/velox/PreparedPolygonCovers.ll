...
$_ZN4geos4geom4prep21PreparedPolygonCoversD0Ev = comdat any
...
bb.a:
  ...
  %i.g = tail call noundef zeroext i1 @_ZNK4geos4geom8Geometry6coversEPKS1_(ptr noundef nonnull align 8 dereferenceable(40) %i.f, ptr noundef %1)
  ret i1 %i.g
}

declare noundef zeroext i1 @_ZNK4geos4geom8Geometry6coversEPKS1_(ptr noundef nonnull align 8 dereferenceable(40), ptr noundef) local_unnamed_addr #1
...
define linkonce_odr void @_ZN4geos4geom4prep21PreparedPolygonCoversD0Ev(ptr noundef nonnull align 8 dereferenceable(20) %0) unnamed_addr #3 comdat align 2 {
bb.a:
