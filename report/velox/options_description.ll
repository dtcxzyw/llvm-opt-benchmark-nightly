...
_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i.a:   ; preds = %bb.ab, %.lr.ph.i.i
  ...
  %reass.sub = sub i64 %.041.i.i, %i.az
  %i.bh = add i64 %reass.sub, 1
  %9 = call ptr @memchr(ptr noundef nonnull dereferenceable(1) %.02840.i.i, i32 noundef %i.bf, i64 noundef %i.bh) #33 ; 4 uses
  %.not34.i.i.a = icmp eq ptr %9, null
  br i1 %.not34.i.i.a, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4findERKS4_m.exit, label %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4findERKS4_m.exit: ; preds = %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i.a, %bb.ab, %bb.x, %bb.y, %bb.z, %bb.aa
  %.1.i.i = phi i32 [ 2, %bb.x ], [ 0, %bb.y ], [ %i.bk, %bb.aa ], [ 0, %bb.z ], [ 0, %bb.ab ], [ 0, %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i.a ]
...
.critedge:                                        ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit, %bb.r, %bb.q
  ...
  %.1 = phi i32 [ %.0121, %bb.q ], [ %.1.i.i, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit ], [ 0, %bb.r ] ; 7 uses
...
_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i41:   ; preds = %bb.ah, %.lr.ph.i.i40
  ...
  %reass.sub123 = sub i64 %.041.i.i42, %i.bx
  %i.ck = add i64 %reass.sub123, 1
  %10 = call ptr @memchr(ptr noundef nonnull dereferenceable(1) %.02840.i.i43, i32 noundef %i.ci, i64 noundef %i.ck) #33 ; 4 uses
  %.not34.i.i45 = icmp eq ptr %10, null
  br i1 %.not34.i.i45, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4findERKS4_m.exit49.thread, label %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i46

_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i46: ; preds = %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i41
