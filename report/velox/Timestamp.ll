...
begin_hunk_0_@_ZN8facebook5velox9Timestamp14tmToStringViewERK2tmmRKNS0_24TimestampToStringOptionsEPc:bb.a
  ...
  %i.rx = getelementptr inbounds i8, ptr %i.rh, i64 %i.rw ; 9 uses
...
._crit_edge:                                      ; preds = %bb.eq
  ...
  br i1 %i.sl, label %_ZNRSt8optionalIjE5valueEv.exit, label %._crit_edge.thread

._crit_edge.thread:                               ; preds = %.preheader, %._crit_edge
  tail call void @_ZSt27__throw_bad_optional_accessv() #22
  unreachable

_ZNRSt8optionalIjE5valueEv.exit:                  ; preds = %._crit_edge
  %13 = add i32 %.sroa.0.1, 1
  %14 = zext i32 %13 to i64
  %15 = getelementptr inbounds nuw i8, ptr %i.rx, i64 %14
...
bb.er:                                            ; preds = %_ZN8facebook5velox11countDigitsEo.exit
  ...
  %16 = getelementptr inbounds i8, ptr %i.rx, i64 %i.sm
