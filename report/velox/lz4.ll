...
begin_hunk_0_@LZ4_decompress_safe:bb.a
  ...
  br i1 %.not22.i15, label %bb.af, label %LZ4_wildCopy32.exit.thread, !prof !32

bb.af:                                            ; preds = %._crit_edge
  %i.gg = getelementptr inbounds nuw i8, ptr %.3.lcssa, i64 2 ; 2 uses
  %i.gh = load i8, ptr %.lcssa143, align 1, !tbaa !14 ; 2 uses
  %i.gi = zext i8 %i.gh to i64
  %.not23.i17 = icmp eq i8 %i.gh, -1
  br i1 %.not23.i17, label %.preheader119, label %read_variable_length.exit19.thread93, !prof !26
...
.preheader119:                                    ; preds = %bb.af, %bb.ag
  ...
  br i1 %i.gk, label %LZ4_wildCopy32.exit.thread, label %bb.ag, !prof !26

bb.ag:                                            ; preds = %.preheader119
  %i.gl = load i8, ptr %.14, align 1, !tbaa !14   ; 2 uses
  %i.gm = zext i8 %i.gl to i64
  %i.gn = add i64 %.0.i18, %i.gm                  ; 3 uses
  %i.go = icmp eq i8 %i.gl, -1
  br i1 %i.go, label %.preheader119, label %read_variable_length.exit19, !llvm.loop !3
...
read_variable_length.exit19.thread93:             ; preds = %bb.af, %read_variable_length.exit19
  ...
  br i1 %or.cond111, label %LZ4_wildCopy32.exit.thread, label %LZ4_wildCopy32.exit, !prof !42
...
vector.body436:                                   ; preds = %vector.body436, %vector.ph434
  ...
  br i1 %i.hr, label %middle.block443, label %vector.body436, !llvm.loop !99
...
.preheader118:                                    ; preds = %.preheader118.preheader515, %.preheader118
  ...
  br i1 %i.ia, label %.preheader118, label %LZ4_wildCopy8.exit9, !llvm.loop !100

LZ4_wildCopy8.exit9:                              ; preds = %.preheader118, %middle.block443
  %.val30 = load i16, ptr %i.ha, align 1, !tbaa !31
...
bb.ak:                                            ; preds = %.loopexit
  ...
  br i1 %i.ik, label %LZ4_wildCopy32.exit.thread, label %bb.al, !prof !26

bb.al:                                            ; preds = %bb.ak
  %i.il = load i8, ptr %.5, align 1, !tbaa !14    ; 2 uses
  %i.im = zext i8 %i.il to i64
  %.not23.i20 = icmp eq i8 %i.il, -1
  br i1 %.not23.i20, label %.preheader117, label %read_variable_length.exit23, !prof !26
...
.preheader117:                                    ; preds = %bb.al, %bb.am
  ...
  br i1 %i.io, label %LZ4_wildCopy32.exit.thread, label %bb.am, !prof !26

bb.am:                                            ; preds = %.preheader117
  %i.ip = load i8, ptr %.16, align 1, !tbaa !14   ; 2 uses
  %i.iq = zext i8 %i.ip to i64
  %i.ir = add i64 %.0.i22, %i.iq                  ; 2 uses
  %i.is = icmp eq i8 %i.ip, -1
  br i1 %i.is, label %.preheader117, label %read_variable_length.exit23, !llvm.loop !3
...
.loopexit132:                                     ; preds = %bb.p, %bb.q, %bb.an
  ...
  br i1 %i.iz, label %LZ4_wildCopy32.exit.thread, label %bb.ao, !prof !43
...
bb.ao:                                            ; preds = %.loopexit132
  ...
  br i1 %i.jc, label %bb.ap, label %bb.aq, !prof !26

bb.ap:                                            ; preds = %bb.ao
  store i32 0, ptr %.10387.i, align 1, !tbaa !23
  %i.jd = load i8, ptr %.1370.i, align 1, !tbaa !14
  store i8 %i.jd, ptr %.10387.i, align 1, !tbaa !14
  %i.je = getelementptr inbounds nuw i8, ptr %.1370.i, i64 1
  %i.jf = load i8, ptr %i.je, align 1, !tbaa !14
  %i.jg = getelementptr inbounds nuw i8, ptr %.10387.i, i64 1
  store i8 %i.jf, ptr %i.jg, align 1, !tbaa !14
  ...
  store i8 %i.ji, ptr %i.jj, align 1, !tbaa !14
  %i.jk = getelementptr inbounds nuw i8, ptr %.1370.i, i64 3
  %i.jl = load i8, ptr %i.jk, align 1, !tbaa !14
  %i.jm = getelementptr inbounds nuw i8, ptr %.10387.i, i64 3
  store i8 %i.jl, ptr %i.jm, align 1, !tbaa !14
...
bb.ar:                                            ; preds = %bb.aq, %bb.ap
  ...
  br i1 %i.kb, label %bb.as, label %bb.av, !prof !26
...
vector.body472:                                   ; preds = %vector.body472, %vector.ph470
  ...
  br i1 %i.kt, label %middle.block479, label %vector.body472, !llvm.loop !101
...
.preheader:                                       ; preds = %.preheader.preheader511, %.preheader
  ...
  br i1 %i.kx, label %.preheader, label %LZ4_wildCopy8.exit, !llvm.loop !102
...
vector.body490:                                   ; preds = %vector.body490, %vector.ph488
  ...
  %wide.load494 = load <16 x i8>, ptr %next.gep492, align 1, !tbaa !14
  %wide.load495 = load <16 x i8>, ptr %i.ln, align 1, !tbaa !14
  %i.lo = getelementptr i8, ptr %next.gep493, i64 16
  store <16 x i8> %wide.load494, ptr %next.gep493, align 1, !tbaa !14
  store <16 x i8> %wide.load495, ptr %i.lo, align 1, !tbaa !14
  %index.next496 = add nuw i64 %index491, 32      ; 2 uses
  %i.lp = icmp eq i64 %index.next496, %n.vec489
  br i1 %i.lp, label %middle.block497, label %vector.body490, !llvm.loop !103
...
vec.epilog.iter.check:                            ; preds = %middle.block497
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph189.preheader, label %vec.epilog.ph, !prof !44
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load505 = load <4 x i8>, ptr %next.gep503, align 1, !tbaa !14
  store <4 x i8> %wide.load505, ptr %next.gep504, align 1, !tbaa !14
  %index.next506 = add nuw i64 %index502, 4       ; 2 uses
  %i.ls = icmp eq i64 %index.next506, %n.vec501
  br i1 %i.ls, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !104
...
.lr.ph189:                                        ; preds = %.lr.ph189.preheader, %.lr.ph189
  ...
  %i.lu = load i8, ptr %.5374.i187, align 1, !tbaa !14
  %i.lv = getelementptr inbounds nuw i8, ptr %.16.i186, i64 1 ; 2 uses
  store i8 %i.lu, ptr %.16.i186, align 1, !tbaa !14
  %i.lw = icmp ult ptr %i.lv, %i.ja
  br i1 %i.lw, label %.lr.ph189, label %.preheader120, !llvm.loop !105
...
vector.body455:                                   ; preds = %vector.body455, %vector.ph453
  ...
  br i1 %i.mq, label %middle.block462, label %vector.body455, !llvm.loop !106
...
begin_hunk_1_@LZ4_decompress_safe_forceExtDict:bb.a
  ...
  br i1 %.not22.i18, label %bb.al, label %LZ4_wildCopy32.exit.thread, !prof !32

bb.al:                                            ; preds = %._crit_edge
  %i.hs = getelementptr inbounds nuw i8, ptr %.3.lcssa, i64 2 ; 2 uses
  %i.ht = load i8, ptr %.lcssa150, align 1, !tbaa !14 ; 2 uses
  %i.hu = zext i8 %i.ht to i64
  %.not23.i20 = icmp eq i8 %i.ht, -1
  br i1 %.not23.i20, label %.preheader123, label %read_variable_length.exit22.thread96, !prof !26
...
.preheader123:                                    ; preds = %bb.al, %bb.am
  ...
  br i1 %i.hw, label %LZ4_wildCopy32.exit.thread, label %bb.am, !prof !26

bb.am:                                            ; preds = %.preheader123
  %i.hx = load i8, ptr %.14, align 1, !tbaa !14   ; 2 uses
  %i.hy = zext i8 %i.hx to i64
  %i.hz = add i64 %.0.i21, %i.hy                  ; 3 uses
  %i.ia = icmp eq i8 %i.hx, -1
  br i1 %i.ia, label %.preheader123, label %read_variable_length.exit22, !llvm.loop !3
...
read_variable_length.exit22.thread96:             ; preds = %bb.al, %read_variable_length.exit22
  ...
  br i1 %or.cond114, label %LZ4_wildCopy32.exit.thread, label %LZ4_wildCopy32.exit, !prof !42
...
vector.body498:                                   ; preds = %vector.body498, %vector.ph496
  ...
  br i1 %i.jd, label %middle.block505, label %vector.body498, !llvm.loop !147
...
.preheader122:                                    ; preds = %.preheader122.preheader628, %.preheader122
  ...
  br i1 %i.jm, label %.preheader122, label %LZ4_wildCopy8.exit12, !llvm.loop !148

LZ4_wildCopy8.exit12:                             ; preds = %.preheader122, %middle.block505
  %.val33 = load i16, ptr %i.im, align 1, !tbaa !31
...
bb.aq:                                            ; preds = %.loopexit125
  ...
  br i1 %i.jw, label %LZ4_wildCopy32.exit.thread, label %bb.ar, !prof !26

bb.ar:                                            ; preds = %bb.aq
  %i.jx = load i8, ptr %.5, align 1, !tbaa !14    ; 2 uses
  %i.jy = zext i8 %i.jx to i64
  %.not23.i23 = icmp eq i8 %i.jx, -1
  br i1 %.not23.i23, label %.preheader121, label %read_variable_length.exit26, !prof !26
...
.preheader121:                                    ; preds = %bb.ar, %bb.as
  ...
  br i1 %i.ka, label %LZ4_wildCopy32.exit.thread, label %bb.as, !prof !26

bb.as:                                            ; preds = %.preheader121
  %i.kb = load i8, ptr %.16, align 1, !tbaa !14   ; 2 uses
  %i.kc = zext i8 %i.kb to i64
  %i.kd = add i64 %.0.i25, %i.kc                  ; 2 uses
  %i.ke = icmp eq i8 %i.kb, -1
  br i1 %i.ke, label %.preheader121, label %read_variable_length.exit26, !llvm.loop !3
...
.loopexit139:                                     ; preds = %bb.p, %bb.q, %bb.at
  ...
  %or.cond462.i = select i1 %i.j, i1 %i.km, i1 false, !prof !43
  br i1 %or.cond462.i, label %LZ4_wildCopy32.exit.thread, label %bb.au, !prof !43
...
bb.av:                                            ; preds = %bb.au
  ...
  br i1 %i.kq, label %LZ4_wildCopy32.exit.thread, label %bb.aw, !prof !26
...
vector.body591:                                   ; preds = %vector.body591, %vector.ph589
  ...
  %wide.load595 = load <16 x i8>, ptr %next.gep593, align 1, !tbaa !14
  %wide.load596 = load <16 x i8>, ptr %i.ln, align 1, !tbaa !14
  %i.lo = getelementptr i8, ptr %next.gep594, i64 16
  store <16 x i8> %wide.load595, ptr %next.gep594, align 1, !tbaa !14
  store <16 x i8> %wide.load596, ptr %i.lo, align 1, !tbaa !14
  %index.next597 = add nuw i64 %index592, 32      ; 2 uses
  %i.lp = icmp eq i64 %index.next597, %n.vec590
  br i1 %i.lp, label %middle.block598, label %vector.body591, !llvm.loop !149
...
vec.epilog.iter.check605:                         ; preds = %middle.block598
  ...
  br i1 %min.epilog.iters.check606, label %.lr.ph203.preheader, label %vec.epilog.ph607, !prof !44
...
vec.epilog.vector.body609:                        ; preds = %vec.epilog.vector.body609, %vec.epilog.ph607
  ...
  %wide.load613 = load <4 x i8>, ptr %next.gep611, align 1, !tbaa !14
  store <4 x i8> %wide.load613, ptr %next.gep612, align 1, !tbaa !14
  %index.next614 = add nuw i64 %index610, 4       ; 2 uses
  %i.ls = icmp eq i64 %index.next614, %n.vec608
  br i1 %i.ls, label %vec.epilog.middle.block615, label %vec.epilog.vector.body609, !llvm.loop !150
...
.lr.ph203:                                        ; preds = %.lr.ph203.preheader, %.lr.ph203
  ...
  %i.lu = load i8, ptr %.0.i202, align 1, !tbaa !14
  %i.lv = getelementptr inbounds nuw i8, ptr %.11388.i201, i64 1 ; 3 uses
  store i8 %i.lu, ptr %.11388.i201, align 1, !tbaa !14
  %i.lw = icmp ult ptr %i.lv, %i.ko
  br i1 %i.lw, label %.lr.ph203, label %.preheader124, !llvm.loop !151
...
bb.ba:                                            ; preds = %bb.au
  ...
  br i1 %i.ly, label %bb.bb, label %bb.bc, !prof !26

bb.bb:                                            ; preds = %bb.ba
  store i32 0, ptr %.10387.i, align 1, !tbaa !23
  %i.lz = load i8, ptr %.1370.i, align 1, !tbaa !14
  store i8 %i.lz, ptr %.10387.i, align 1, !tbaa !14
  %i.ma = getelementptr inbounds nuw i8, ptr %.1370.i, i64 1
  %i.mb = load i8, ptr %i.ma, align 1, !tbaa !14
  %i.mc = getelementptr inbounds nuw i8, ptr %.10387.i, i64 1
  store i8 %i.mb, ptr %i.mc, align 1, !tbaa !14
  ...
  store i8 %i.me, ptr %i.mf, align 1, !tbaa !14
  ...
  store i8 %i.mh, ptr %i.mi, align 1, !tbaa !14
  %i.mj = getelementptr inbounds nuw [4 x i8], ptr @inc32table, i64 %.1368.i
  %i.mk = load i32, ptr %i.mj, align 4, !tbaa !38
  ...
  %i.mq = load i32, ptr %i.mp, align 4, !tbaa !38
...
bb.bd:                                            ; preds = %bb.bc, %bb.bb
  ...
  br i1 %i.mx, label %bb.be, label %bb.bh, !prof !26
...
vector.body534:                                   ; preds = %vector.body534, %vector.ph532
  ...
  br i1 %i.np, label %middle.block541, label %vector.body534, !llvm.loop !152
...
.preheader119:                                    ; preds = %.preheader119.preheader623, %.preheader119
  ...
  br i1 %i.nt, label %.preheader119, label %LZ4_wildCopy8.exit, !llvm.loop !153
...
vector.body554:                                   ; preds = %vector.body554, %vector.ph552
  ...
  %wide.load558 = load <16 x i8>, ptr %next.gep556, align 1, !tbaa !14
  %wide.load559 = load <16 x i8>, ptr %i.oj, align 1, !tbaa !14
  %i.ok = getelementptr i8, ptr %next.gep557, i64 16
  store <16 x i8> %wide.load558, ptr %next.gep557, align 1, !tbaa !14
  store <16 x i8> %wide.load559, ptr %i.ok, align 1, !tbaa !14
  %index.next560 = add nuw i64 %index555, 32      ; 2 uses
  %i.ol = icmp eq i64 %index.next560, %n.vec553
  br i1 %i.ol, label %middle.block561, label %vector.body554, !llvm.loop !154
...
vec.epilog.iter.check568:                         ; preds = %middle.block561
  ...
  br i1 %min.epilog.iters.check569, label %.lr.ph200.preheader, label %vec.epilog.ph570, !prof !44
...
vec.epilog.vector.body572:                        ; preds = %vec.epilog.vector.body572, %vec.epilog.ph570
  ...
  %wide.load576 = load <4 x i8>, ptr %next.gep574, align 1, !tbaa !14
  store <4 x i8> %wide.load576, ptr %next.gep575, align 1, !tbaa !14
  %index.next577 = add nuw i64 %index573, 4       ; 2 uses
  %i.oo = icmp eq i64 %index.next577, %n.vec571
  br i1 %i.oo, label %vec.epilog.middle.block578, label %vec.epilog.vector.body572, !llvm.loop !155
...
.lr.ph200:                                        ; preds = %.lr.ph200.preheader, %.lr.ph200
  ...
  %i.oq = load i8, ptr %.5374.i198, align 1, !tbaa !14
  %i.or = getelementptr inbounds nuw i8, ptr %.16.i197, i64 1 ; 2 uses
  store i8 %i.oq, ptr %.16.i197, align 1, !tbaa !14
  %i.os = icmp ult ptr %i.or, %i.ko
  br i1 %i.os, label %.lr.ph200, label %.preheader124, !llvm.loop !156
...
vector.body517:                                   ; preds = %vector.body517, %vector.ph515
  ...
  br i1 %i.pm, label %middle.block524, label %vector.body517, !llvm.loop !157
...
begin_hunk_2_@LZ4_decompress_safe_continue:bb.a
  ...
  br i1 %.not22.i78, label %bb.at, label %LZ4_wildCopy32.exit.thread, !prof !32

bb.at:                                            ; preds = %._crit_edge
  %i.ip = getelementptr inbounds nuw i8, ptr %.3.lcssa, i64 2 ; 2 uses
  %i.iq = load i8, ptr %.lcssa213, align 1, !tbaa !14 ; 2 uses
  %i.ir = zext i8 %i.iq to i64
  %.not23.i80 = icmp eq i8 %i.iq, -1
  br i1 %.not23.i80, label %.preheader186, label %read_variable_length.exit82.thread158, !prof !26
...
.preheader186:                                    ; preds = %bb.at, %bb.au
  ...
  br i1 %i.it, label %LZ4_wildCopy32.exit.thread, label %bb.au, !prof !26

bb.au:                                            ; preds = %.preheader186
  %i.iu = load i8, ptr %.14, align 1, !tbaa !14   ; 2 uses
  %i.iv = zext i8 %i.iu to i64
  %i.iw = add i64 %.0.i81, %i.iv                  ; 3 uses
  %i.ix = icmp eq i8 %i.iu, -1
  br i1 %i.ix, label %.preheader186, label %read_variable_length.exit82, !llvm.loop !3
...
read_variable_length.exit82.thread158:            ; preds = %bb.at, %read_variable_length.exit82
  ...
  br i1 %or.cond177, label %LZ4_wildCopy32.exit.thread, label %LZ4_wildCopy32.exit, !prof !42
...
LZ4_wildCopy8.exit72:                             ; preds = %.preheader185, %middle.block577
  %.val94 = load i16, ptr %i.jj, align 1, !tbaa !31
...
bb.ay:                                            ; preds = %.loopexit188
  ...
  br i1 %i.kt, label %LZ4_wildCopy32.exit.thread, label %bb.az, !prof !26

bb.az:                                            ; preds = %bb.ay
  %i.ku = load i8, ptr %.5, align 1, !tbaa !14    ; 2 uses
  %i.kv = zext i8 %i.ku to i64
  %.not23.i83 = icmp eq i8 %i.ku, -1
  br i1 %.not23.i83, label %.preheader184, label %read_variable_length.exit86, !prof !26
...
.preheader184:                                    ; preds = %bb.az, %bb.ba
  ...
  br i1 %i.kx, label %LZ4_wildCopy32.exit.thread, label %bb.ba, !prof !26

bb.ba:                                            ; preds = %.preheader184
  %i.ky = load i8, ptr %.16, align 1, !tbaa !14   ; 2 uses
  %i.kz = zext i8 %i.ky to i64
  %i.la = add i64 %.0.i85, %i.kz                  ; 2 uses
  %i.lb = icmp eq i8 %i.ky, -1
  br i1 %i.lb, label %.preheader184, label %read_variable_length.exit86, !llvm.loop !3
...
.loopexit202:                                     ; preds = %bb.x, %bb.y, %bb.bb
  ...
  %or.cond462.i.i = select i1 %i.ad, i1 %i.lj, i1 false, !prof !43
  br i1 %or.cond462.i.i, label %LZ4_wildCopy32.exit.thread, label %bb.bc, !prof !43
...
bb.bd:                                            ; preds = %bb.bc
  ...
  br i1 %i.ln, label %LZ4_wildCopy32.exit.thread, label %bb.be, !prof !26
...
vector.body663:                                   ; preds = %vector.body663, %vector.ph661
  ...
  %wide.load667 = load <16 x i8>, ptr %next.gep665, align 1, !tbaa !14
  %wide.load668 = load <16 x i8>, ptr %i.mn, align 1, !tbaa !14
  %i.mo = getelementptr i8, ptr %next.gep666, i64 16
  store <16 x i8> %wide.load667, ptr %next.gep666, align 1, !tbaa !14
  store <16 x i8> %wide.load668, ptr %i.mo, align 1, !tbaa !14
...
vec.epilog.iter.check677:                         ; preds = %middle.block670
  ...
  br i1 %min.epilog.iters.check678, label %.lr.ph266.preheader, label %vec.epilog.ph679, !prof !44
...
vec.epilog.vector.body681:                        ; preds = %vec.epilog.vector.body681, %vec.epilog.ph679
  ...
  %wide.load685 = load <4 x i8>, ptr %next.gep683, align 1, !tbaa !14
  store <4 x i8> %wide.load685, ptr %next.gep684, align 1, !tbaa !14
...
.lr.ph266:                                        ; preds = %.lr.ph266.preheader, %.lr.ph266
  ...
  %i.mu = load i8, ptr %.0.i.i265, align 1, !tbaa !14
  %i.mv = getelementptr inbounds nuw i8, ptr %.11388.i.i264, i64 1 ; 3 uses
  store i8 %i.mu, ptr %.11388.i.i264, align 1, !tbaa !14
...
bb.bi:                                            ; preds = %bb.bc
  ...
  br i1 %i.my, label %bb.bj, label %bb.bk, !prof !26

bb.bj:                                            ; preds = %bb.bi
  store i32 0, ptr %.10387.i.i, align 1, !tbaa !23
  %i.mz = load i8, ptr %.1370.i.i, align 1, !tbaa !14
  store i8 %i.mz, ptr %.10387.i.i, align 1, !tbaa !14
  %i.na = getelementptr inbounds nuw i8, ptr %.1370.i.i, i64 1
  %i.nb = load i8, ptr %i.na, align 1, !tbaa !14
  %i.nc = getelementptr inbounds nuw i8, ptr %.10387.i.i, i64 1
  store i8 %i.nb, ptr %i.nc, align 1, !tbaa !14
  ...
  store i8 %i.ne, ptr %i.nf, align 1, !tbaa !14
  %i.ng = getelementptr inbounds nuw i8, ptr %.1370.i.i, i64 3
  %i.nh = load i8, ptr %i.ng, align 1, !tbaa !14
  %i.ni = getelementptr inbounds nuw i8, ptr %.10387.i.i, i64 3
  store i8 %i.nh, ptr %i.ni, align 1, !tbaa !14
  ...
  %i.nq = load i32, ptr %i.np, align 4, !tbaa !38
...
bb.bl:                                            ; preds = %bb.bk, %bb.bj
  ...
  br i1 %i.nx, label %bb.bm, label %bb.bp, !prof !26
...
vector.body626:                                   ; preds = %vector.body626, %vector.ph624
  ...
  %wide.load630 = load <16 x i8>, ptr %next.gep628, align 1, !tbaa !14
  %wide.load631 = load <16 x i8>, ptr %i.pj, align 1, !tbaa !14
  %i.pk = getelementptr i8, ptr %next.gep629, i64 16
  store <16 x i8> %wide.load630, ptr %next.gep629, align 1, !tbaa !14
  store <16 x i8> %wide.load631, ptr %i.pk, align 1, !tbaa !14
...
vec.epilog.iter.check640:                         ; preds = %middle.block633
  ...
  br i1 %min.epilog.iters.check641, label %.lr.ph263.preheader, label %vec.epilog.ph642, !prof !44
...
vec.epilog.vector.body644:                        ; preds = %vec.epilog.vector.body644, %vec.epilog.ph642
  ...
  %wide.load648 = load <4 x i8>, ptr %next.gep646, align 1, !tbaa !14
  store <4 x i8> %wide.load648, ptr %next.gep647, align 1, !tbaa !14
...
.lr.ph263:                                        ; preds = %.lr.ph263.preheader, %.lr.ph263
  ...
  %i.pq = load i8, ptr %.5374.i.i261, align 1, !tbaa !14
  %i.pr = getelementptr inbounds nuw i8, ptr %.16.i.i260, i64 1 ; 2 uses
  store i8 %i.pq, ptr %.16.i.i260, align 1, !tbaa !14
...
begin_hunk_3_@LZ4_decompress_safe_withSmallPrefix:bb.a
  ...
  br i1 %.not22.i16, label %bb.af, label %LZ4_wildCopy32.exit.thread, !prof !32

bb.af:                                            ; preds = %._crit_edge
  %i.gi = getelementptr inbounds nuw i8, ptr %.3.lcssa, i64 2 ; 2 uses
  %i.gj = load i8, ptr %.lcssa144, align 1, !tbaa !14 ; 2 uses
  %i.gk = zext i8 %i.gj to i64
  %.not23.i18 = icmp eq i8 %i.gj, -1
  br i1 %.not23.i18, label %.preheader120, label %read_variable_length.exit20.thread94, !prof !26
...
.preheader120:                                    ; preds = %bb.af, %bb.ag
  ...
  br i1 %i.gm, label %LZ4_wildCopy32.exit.thread, label %bb.ag, !prof !26

bb.ag:                                            ; preds = %.preheader120
  %i.gn = load i8, ptr %.14, align 1, !tbaa !14   ; 2 uses
  %i.go = zext i8 %i.gn to i64
  %i.gp = add i64 %.0.i19, %i.go                  ; 3 uses
  %i.gq = icmp eq i8 %i.gn, -1
  br i1 %i.gq, label %.preheader120, label %read_variable_length.exit20, !llvm.loop !3
...
read_variable_length.exit20.thread94:             ; preds = %bb.af, %read_variable_length.exit20
  ...
  br i1 %or.cond112, label %LZ4_wildCopy32.exit.thread, label %LZ4_wildCopy32.exit, !prof !42
...
LZ4_wildCopy8.exit10:                             ; preds = %.preheader119, %middle.block444
  %.val31 = load i16, ptr %i.hc, align 1, !tbaa !31
...
bb.ak:                                            ; preds = %.loopexit
  ...
  br i1 %i.im, label %LZ4_wildCopy32.exit.thread, label %bb.al, !prof !26

bb.al:                                            ; preds = %bb.ak
  %i.in = load i8, ptr %.5, align 1, !tbaa !14    ; 2 uses
  %i.io = zext i8 %i.in to i64
  %.not23.i21 = icmp eq i8 %i.in, -1
  br i1 %.not23.i21, label %.preheader118, label %read_variable_length.exit24, !prof !26
...
.preheader118:                                    ; preds = %bb.al, %bb.am
  ...
  br i1 %i.iq, label %LZ4_wildCopy32.exit.thread, label %bb.am, !prof !26

bb.am:                                            ; preds = %.preheader118
  %i.ir = load i8, ptr %.16, align 1, !tbaa !14   ; 2 uses
  %i.is = zext i8 %i.ir to i64
  %i.it = add i64 %.0.i23, %i.is                  ; 2 uses
  %i.iu = icmp eq i8 %i.ir, -1
  br i1 %i.iu, label %.preheader118, label %read_variable_length.exit24, !llvm.loop !3
...
.loopexit133:                                     ; preds = %bb.p, %bb.q, %bb.an
  ...
  br i1 %i.jb, label %LZ4_wildCopy32.exit.thread, label %bb.ao, !prof !43
...
bb.ao:                                            ; preds = %.loopexit133
  ...
  br i1 %i.je, label %bb.ap, label %bb.aq, !prof !26

bb.ap:                                            ; preds = %bb.ao
  store i32 0, ptr %.10387.i, align 1, !tbaa !23
  %i.jf = load i8, ptr %.1370.i, align 1, !tbaa !14
  store i8 %i.jf, ptr %.10387.i, align 1, !tbaa !14
  %i.jg = getelementptr inbounds nuw i8, ptr %.1370.i, i64 1
  %i.jh = load i8, ptr %i.jg, align 1, !tbaa !14
  %i.ji = getelementptr inbounds nuw i8, ptr %.10387.i, i64 1
  store i8 %i.jh, ptr %i.ji, align 1, !tbaa !14
  %i.jj = getelementptr inbounds nuw i8, ptr %.1370.i, i64 2
  %i.jk = load i8, ptr %i.jj, align 1, !tbaa !14
  %i.jl = getelementptr inbounds nuw i8, ptr %.10387.i, i64 2
  store i8 %i.jk, ptr %i.jl, align 1, !tbaa !14
  ...
  store i8 %i.jn, ptr %i.jo, align 1, !tbaa !14
...
bb.ar:                                            ; preds = %bb.aq, %bb.ap
  ...
  br i1 %i.kd, label %bb.as, label %bb.av, !prof !26
...
vector.body491:                                   ; preds = %vector.body491, %vector.ph489
  ...
  %wide.load495 = load <16 x i8>, ptr %next.gep493, align 1, !tbaa !14
  %wide.load496 = load <16 x i8>, ptr %i.lp, align 1, !tbaa !14
  %i.lq = getelementptr i8, ptr %next.gep494, i64 16
  store <16 x i8> %wide.load495, ptr %next.gep494, align 1, !tbaa !14
  store <16 x i8> %wide.load496, ptr %i.lq, align 1, !tbaa !14
...
vec.epilog.iter.check:                            ; preds = %middle.block498
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph190.preheader, label %vec.epilog.ph, !prof !44
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load506 = load <4 x i8>, ptr %next.gep504, align 1, !tbaa !14
  store <4 x i8> %wide.load506, ptr %next.gep505, align 1, !tbaa !14
...
.lr.ph190:                                        ; preds = %.lr.ph190.preheader, %.lr.ph190
  ...
  %i.lw = load i8, ptr %.5374.i188, align 1, !tbaa !14
  %i.lx = getelementptr inbounds nuw i8, ptr %.16.i187, i64 1 ; 2 uses
  store i8 %i.lw, ptr %.16.i187, align 1, !tbaa !14
