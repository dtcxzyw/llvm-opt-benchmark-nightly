...
bb.g:                                             ; preds = %.backedge
  ...
  br i1 %.not22.i, label %4, label %LZ4_wildCopy32.exit.thread, !prof !29

4:                                                ; preds = %bb.g
  %5 = getelementptr inbounds nuw i8, ptr %.0, i64 2 ; 4 uses
  %6 = icmp ugt ptr %5, %i.r
  br i1 %6, label %LZ4_wildCopy32.exit.thread, label %bb.h, !prof !20
...
._crit_edge:                                      ; preds = %bb.ae, %.preheader121
  ...
  br i1 %.not22.i16, label %7, label %LZ4_wildCopy32.exit.thread, !prof !29

7:                                                ; preds = %._crit_edge
  %8 = getelementptr inbounds nuw i8, ptr %.3.lcssa, i64 2 ; 4 uses
  %9 = icmp ugt ptr %8, %i.ge
  br i1 %9, label %LZ4_wildCopy32.exit.thread, label %bb.af, !prof !20
...
bb.e:                                             ; preds = %.backedge
  ...
  br i1 %.not22.i, label %5, label %LZ4_wildCopy32.exit.thread, !prof !29

5:                                                ; preds = %bb.e
  %6 = getelementptr inbounds nuw i8, ptr %.0, i64 2 ; 4 uses
  %7 = icmp ugt ptr %6, %i.p
  br i1 %7, label %LZ4_wildCopy32.exit.thread, label %bb.f, !prof !20
...
._crit_edge:                                      ; preds = %bb.ac, %.preheader128
  ...
  br i1 %.not22.i20, label %8, label %LZ4_wildCopy32.exit.thread, !prof !29

8:                                                ; preds = %._crit_edge
  %9 = getelementptr inbounds nuw i8, ptr %.3.lcssa, i64 2 ; 4 uses
  %10 = icmp ugt ptr %9, %i.gc
  br i1 %10, label %LZ4_wildCopy32.exit.thread, label %bb.ad, !prof !20
...
7:                                                ; preds = %._crit_edge
  ...
  br i1 %9, label %LZ4_wildCopy32.exit.thread, label %bb.ag, !prof !20
...
bb.g:                                             ; preds = %.backedge
  ...
  br i1 %.not22.i, label %6, label %LZ4_wildCopy32.exit.thread, !prof !29

6:                                                ; preds = %bb.g
  %7 = getelementptr inbounds nuw i8, ptr %.0, i64 2 ; 4 uses
  %8 = icmp ugt ptr %7, %i.v
  br i1 %8, label %LZ4_wildCopy32.exit.thread, label %bb.h, !prof !20
...
._crit_edge:                                      ; preds = %bb.ak, %.preheader124
  ...
  br i1 %.not22.i18, label %9, label %LZ4_wildCopy32.exit.thread, !prof !29

9:                                                ; preds = %._crit_edge
  %10 = getelementptr inbounds nuw i8, ptr %.3.lcssa, i64 2 ; 4 uses
  %11 = icmp ugt ptr %10, %i.hp
  br i1 %11, label %LZ4_wildCopy32.exit.thread, label %bb.al, !prof !20
...
bb.e:                                             ; preds = %.backedge
  ...
  br i1 %.not22.i, label %7, label %LZ4_wildCopy32.exit.thread, !prof !29

7:                                                ; preds = %bb.e
  %8 = getelementptr inbounds nuw i8, ptr %.0, i64 2 ; 4 uses
  %9 = icmp ugt ptr %8, %i.t
  br i1 %9, label %LZ4_wildCopy32.exit.thread, label %bb.f, !prof !20
...
._crit_edge:                                      ; preds = %bb.aj, %.preheader131
  ...
  br i1 %.not22.i22, label %10, label %LZ4_wildCopy32.exit.thread, !prof !29

10:                                               ; preds = %._crit_edge
  %11 = getelementptr inbounds nuw i8, ptr %.3.lcssa, i64 2 ; 4 uses
  %12 = icmp ugt ptr %11, %i.ht
  br i1 %12, label %LZ4_wildCopy32.exit.thread, label %bb.ak, !prof !20
...
5:                                                ; preds = %bb.o
  ...
  br i1 %7, label %LZ4_wildCopy32.exit.thread, label %bb.p, !prof !20
...
._crit_edge:                                      ; preds = %bb.as, %.preheader187
  ...
  br i1 %.not22.i78, label %8, label %LZ4_wildCopy32.exit.thread, !prof !29

8:                                                ; preds = %._crit_edge
  %9 = getelementptr inbounds nuw i8, ptr %.3.lcssa, i64 2 ; 4 uses
  %10 = icmp ugt ptr %9, %i.im
  br i1 %10, label %LZ4_wildCopy32.exit.thread, label %bb.at, !prof !20
...
5:                                                ; preds = %bb.g
  ...
  br i1 %7, label %LZ4_wildCopy32.exit.thread, label %bb.h, !prof !20
...
._crit_edge:                                      ; preds = %bb.ae, %.preheader122
  ...
  br i1 %.not22.i17, label %8, label %LZ4_wildCopy32.exit.thread, !prof !29

8:                                                ; preds = %._crit_edge
  %9 = getelementptr inbounds nuw i8, ptr %.3.lcssa, i64 2 ; 4 uses
  %10 = icmp ugt ptr %9, %i.gg
  br i1 %10, label %LZ4_wildCopy32.exit.thread, label %bb.af, !prof !20
...
bb.i:                                             ; preds = %.backedge.i
  ...
  br i1 %.not22.i.i, label %7, label %LZ4_wildCopy32.exit.thread.i, !prof !29

7:                                                ; preds = %bb.i
  %8 = getelementptr inbounds nuw i8, ptr %.0.i, i64 2 ; 4 uses
  %9 = icmp ugt ptr %8, %i.t
  br i1 %9, label %LZ4_wildCopy32.exit.thread.i, label %bb.j, !prof !20
...
._crit_edge.i:                                    ; preds = %bb.ah, %.preheader146.i
  ...
  br i1 %.not22.i20.i, label %10, label %LZ4_wildCopy32.exit.thread.i, !prof !29

10:                                               ; preds = %._crit_edge.i
  %11 = getelementptr inbounds nuw i8, ptr %.3.lcssa.i, i64 2 ; 4 uses
  %12 = icmp ugt ptr %11, %i.fx
  br i1 %12, label %LZ4_wildCopy32.exit.thread.i, label %bb.ai, !prof !20
...
bb.be:                                            ; preds = %.backedge.i75
  ...
  br i1 %.not22.i.i94, label %13, label %LZ4_wildCopy32.exit.thread.i55, !prof !29

13:                                               ; preds = %bb.be
  %14 = getelementptr inbounds nuw i8, ptr %.0.i31, i64 2 ; 4 uses
  %15 = icmp ugt ptr %14, %i.my
  br i1 %15, label %LZ4_wildCopy32.exit.thread.i55, label %bb.bf, !prof !20
...
._crit_edge.i67:                                  ; preds = %bb.cc, %.preheader129.i
  ...
  br i1 %.not22.i21.i, label %16, label %LZ4_wildCopy32.exit.thread.i55, !prof !29

16:                                               ; preds = %._crit_edge.i67
  %17 = getelementptr inbounds nuw i8, ptr %.3.lcssa.i68, i64 2 ; 4 uses
  %18 = icmp ugt ptr %17, %i.tl
  br i1 %18, label %LZ4_wildCopy32.exit.thread.i55, label %bb.cd, !prof !20
