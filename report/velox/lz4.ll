...
begin_hunk_0_@LZ4_compress_forceExtDict:bb.a
  ...
  store i8 %i.vi, ptr %i.vg, align 1, !tbaa !7
  br label %bb.dm

bb.dl:                                            ; preds = %bb.dj
  %i.vk = trunc nuw nsw i32 %.1456.i80.fr to i8
  %i.vl = add i8 %i.uu, %i.vk
  store i8 %i.vl, ptr %.0483.i72, align 1, !tbaa !7
  br label %bb.dm
...
bb.dn:                                            ; preds = %bb.dm
  ...
  %.val238 = load i64, ptr %i.vm, align 1, !tbaa !29
  ...
  store i32 %i.vr, ptr %i.vs, align 4, !tbaa !3
  %.6409.i81.val237 = load i64, ptr %.6409.i81, align 1, !tbaa !29
  ...
  %i.vz = load i32, ptr %i.vy, align 4, !tbaa !3  ; 4 uses
  ...
  store i32 %i.vx, ptr %i.vy, align 4, !tbaa !3
  %i.wc = add i32 %i.vz, 65535
  %.not527.i87 = icmp ult i32 %i.wc, %i.vx
  br i1 %.not527.i87, label %bb.dq, label %bb.do

bb.do:                                            ; preds = %bb.dn
  %.10480.i84.val = load i32, ptr %.10480.i84, align 1, !tbaa !15
  %.6409.i81.val = load i32, ptr %.6409.i81, align 1, !tbaa !15
...
bb.dp:                                            ; preds = %bb.do
  ...
  store i8 0, ptr %.8432.i82, align 1, !tbaa !7
...
bb.dq:                                            ; preds = %bb.do, %bb.dn
  ...
  br i1 %i.wk, label %.thread385, label %.lr.ph, !prof !37
...
bb.dr:                                            ; preds = %.thread385
  ...
  store i8 -16, ptr %.12.i57, align 1, !tbaa !7
...
.lr.ph496.preheader:                              ; preds = %bb.dr
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %.13.i66492, i8 -1, i64 %i.wv, i1 false), !tbaa !7
...
._crit_edge497:                                   ; preds = %.lr.ph496.preheader, %bb.dr
  ...
  store i8 %i.wy, ptr %.13.i66.lcssa, align 1, !tbaa !7
...
bb.ds:                                            ; preds = %.thread385
  ...
  store i8 %i.wz, ptr %.12.i57, align 1, !tbaa !7
  br label %LZ4_compress_generic_validated.exit99
...
LZ4_compress_generic.exit20:                      ; preds = %LZ4_compress_generic_validated.exit99, %bb.bm, %bb.bk, %LZ4_compress_generic_validated.exit, %bb.d, %bb.b
  ...
  store ptr %1, ptr %i.xf, align 8, !tbaa !59
  store i32 %3, ptr %i.x, align 8, !tbaa !13
  ret i32 %.0
}
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  store ptr %1, ptr %i.j, align 8, !tbaa !59
  store i32 %spec.select, ptr %i.a, align 8, !tbaa !13
  ret i32 %spec.select
}
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.i = icmp eq i32 %3, 0
  br i1 %i.i, label %bb.c, label %bb.e, !prof !19
...
bb.e:                                             ; preds = %bb.b
  %i.n = icmp eq i32 %2, 0
  br i1 %i.n, label %LZ4_decompress_generic.exit, label %bb.f, !prof !19
...
.preheader128:                                    ; preds = %bb.h, %bb.i
  ...
  br i1 %i.ae, label %LZ4_wildCopy32.exit.thread, label %bb.i, !prof !19

bb.i:                                             ; preds = %.preheader128
  %i.af = load i8, ptr %.10, align 1, !tbaa !7    ; 2 uses
  %i.ag = zext i8 %i.af to i64
  %i.ah = add i64 %.0.i11, %i.ag                  ; 3 uses
  %i.ai = icmp eq i8 %i.af, -1
  br i1 %i.ai, label %.preheader128, label %read_variable_length.exit, !llvm.loop !81
...
read_variable_length.exit.thread62:               ; preds = %bb.h, %read_variable_length.exit
  ...
  br i1 %or.cond, label %LZ4_wildCopy32.exit.thread, label %bb.j, !prof !82
...
.preheader127:                                    ; preds = %bb.j, %.preheader127
  ...
  br i1 %i.az, label %.preheader127, label %LZ4_wildCopy32.exit.thread71, !llvm.loop !83
...
LZ4_wildCopy32.exit.thread71:                     ; preds = %.preheader127, %bb.l
  ...
  %.val32 = load i16, ptr %.1, align 1, !tbaa !26 ; 5 uses
...
bb.m:                                             ; preds = %LZ4_wildCopy32.exit.thread71
  ...
  br i1 %i.bj, label %LZ4_wildCopy32.exit.thread, label %bb.n, !prof !19

bb.n:                                             ; preds = %bb.m
  %i.bk = load i8, ptr %i.bd, align 1, !tbaa !7   ; 2 uses
...
.preheader125:                                    ; preds = %bb.n, %bb.o
  ...
  br i1 %i.bn, label %LZ4_wildCopy32.exit.thread, label %bb.o, !prof !19

bb.o:                                             ; preds = %.preheader125
  %i.bo = load i8, ptr %.12, align 1, !tbaa !7    ; 2 uses
  %i.bp = zext i8 %i.bo to i64
  %i.bq = add i64 %.0.i14, %i.bp                  ; 3 uses
  %i.br = icmp eq i8 %i.bo, -1
  br i1 %i.br, label %.preheader125, label %read_variable_length.exit15, !llvm.loop !81
...
read_variable_length.exit15.thread79:             ; preds = %bb.n, %read_variable_length.exit15
  ...
  br i1 %i.bw, label %LZ4_wildCopy32.exit.thread, label %bb.p, !prof !19
...
.thread87:                                        ; preds = %bb.p, %bb.r
  ...
  br i1 %i.cj, label %LZ4_wildCopy32.exit.thread, label %bb.t, !prof !84

bb.t:                                             ; preds = %.thread87
  %i.ck = getelementptr inbounds nuw i8, ptr %.2.i, i64 %.2374.i ; 9 uses
  %i.cl = icmp ult i16 %.val32, 16
  br i1 %i.cl, label %bb.u, label %.preheader123, !prof !19
...
bb.v:                                             ; preds = %bb.u
  %i.cm = load i8, ptr %i.bf, align 1, !tbaa !7
...
bb.z:                                             ; preds = %bb.y
  store i32 0, ptr %.2.i, align 1, !tbaa !15
  %i.cp = load i8, ptr %i.bf, align 1, !tbaa !7
  store i8 %i.cp, ptr %.2.i, align 1, !tbaa !7
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.eb, label %middle.block, label %vector.body, !llvm.loop !85
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  br i1 %i.ef, label %scalar.ph, label %.backedge.backedge, !llvm.loop !86
...
vector.body424:                                   ; preds = %vector.body424, %vector.ph421
  ...
  br i1 %i.eu, label %middle.block430, label %vector.body424, !llvm.loop !87
...
.lr.ph:                                           ; preds = %.lr.ph.preheader555, %.lr.ph
  ...
  br i1 %i.ev, label %.lr.ph, label %.backedge.backedge, !llvm.loop !88
...
.preheader123:                                    ; preds = %bb.t, %.preheader123
  ...
  br i1 %i.fa, label %.preheader123, label %.backedge.backedge, !llvm.loop !83
...
.lr.ph183:                                        ; preds = %.preheader121, %bb.ae
  ...
  br i1 %i.fg, label %bb.ad, label %LZ4_wildCopy32.exit, !prof !28
...
bb.ad:                                            ; preds = %.lr.ph183
  ...
  %.val = load i16, ptr %i.fi, align 1, !tbaa !26 ; 2 uses
...
bb.ae:                                            ; preds = %bb.ad
  ...
  %i.gb = load i8, ptr %i.fm, align 1, !tbaa !7
...
.preheader120:                                    ; preds = %bb.af, %bb.ag
  ...
  br i1 %i.gi, label %LZ4_wildCopy32.exit.thread, label %bb.ag, !prof !19

bb.ag:                                            ; preds = %.preheader120
  %i.gj = load i8, ptr %.14, align 1, !tbaa !7    ; 2 uses
  %i.gk = zext i8 %i.gj to i64
  %i.gl = add i64 %.0.i19, %i.gk                  ; 3 uses
  %i.gm = icmp eq i8 %i.gj, -1
  br i1 %i.gm, label %.preheader120, label %read_variable_length.exit20, !llvm.loop !81
...
read_variable_length.exit20.thread94:             ; preds = %bb.af, %read_variable_length.exit20
  ...
  br i1 %or.cond112, label %LZ4_wildCopy32.exit.thread, label %LZ4_wildCopy32.exit, !prof !82
...
vector.body443:                                   ; preds = %vector.body443, %vector.ph440
  ...
  br i1 %i.hp, label %middle.block450, label %vector.body443, !llvm.loop !89
...
bb.ai:                                            ; preds = %bb.ah, %LZ4_wildCopy32.exit
  ...
  %or.cond458.i = select i1 %.not440.i, i1 true, i1 %i.hr
  br i1 %or.cond458.i, label %LZ4_wildCopy32.exit.thread, label %bb.aj
...
.preheader119:                                    ; preds = %.preheader119.preheader526, %.preheader119
  ...
  br i1 %i.hy, label %.preheader119, label %LZ4_wildCopy8.exit10, !llvm.loop !90

LZ4_wildCopy8.exit10:                             ; preds = %.preheader119, %middle.block450
  %.val31 = load i16, ptr %i.gy, align 1, !tbaa !26
...
bb.ak:                                            ; preds = %.loopexit
  ...
  br i1 %i.ii, label %LZ4_wildCopy32.exit.thread, label %bb.al, !prof !19

bb.al:                                            ; preds = %bb.ak
  %i.ij = load i8, ptr %.5, align 1, !tbaa !7     ; 2 uses
...
.preheader118:                                    ; preds = %bb.al, %bb.am
  ...
  br i1 %i.im, label %LZ4_wildCopy32.exit.thread, label %bb.am, !prof !19

bb.am:                                            ; preds = %.preheader118
  %i.in = load i8, ptr %.16, align 1, !tbaa !7    ; 2 uses
  %i.io = zext i8 %i.in to i64
  %i.ip = add i64 %.0.i23, %i.io                  ; 2 uses
  %i.iq = icmp eq i8 %i.in, -1
  br i1 %i.iq, label %.preheader118, label %read_variable_length.exit24, !llvm.loop !81
...
.loopexit133:                                     ; preds = %bb.p, %bb.q, %bb.an
  ...
  br i1 %i.ix, label %LZ4_wildCopy32.exit.thread, label %bb.ao, !prof !84
...
bb.ao:                                            ; preds = %.loopexit133
  ...
  br i1 %i.ja, label %bb.ap, label %bb.aq, !prof !19

bb.ap:                                            ; preds = %bb.ao
  store i32 0, ptr %.10.i, align 1, !tbaa !15
  %i.jb = load i8, ptr %.1363.i, align 1, !tbaa !7
  store i8 %i.jb, ptr %.10.i, align 1, !tbaa !7
  ...
  store i8 %i.jg, ptr %i.jh, align 1, !tbaa !7
  ...
  store i8 %i.jj, ptr %i.jk, align 1, !tbaa !7
...
begin_hunk_1_@LZ4_decompress_safe:bb.a
  ...
  br i1 %i.ku, label %middle.block488, label %vector.body481, !llvm.loop !91
...
.preheader:                                       ; preds = %.preheader.preheader522, %.preheader
  ...
  br i1 %i.ky, label %.preheader, label %LZ4_wildCopy8.exit, !llvm.loop !92
...
vector.body500:                                   ; preds = %vector.body500, %vector.ph497
  ...
  %wide.load504 = load <16 x i8>, ptr %next.gep503, align 1, !tbaa !7
  %wide.load505 = load <16 x i8>, ptr %i.ln, align 1, !tbaa !7
  %i.lo = getelementptr i8, ptr %next.gep502, i64 16
  store <16 x i8> %wide.load504, ptr %next.gep502, align 1, !tbaa !7
  store <16 x i8> %wide.load505, ptr %i.lo, align 1, !tbaa !7
  %index.next506 = add nuw i64 %index501, 32      ; 2 uses
  %i.lp = icmp eq i64 %index.next506, %n.vec499
  br i1 %i.lp, label %middle.block507, label %vector.body500, !llvm.loop !93
...
vec.epilog.iter.check:                            ; preds = %middle.block507
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph190.preheader, label %vec.epilog.ph, !prof !94
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load516 = load <4 x i8>, ptr %next.gep515, align 1, !tbaa !7
  store <4 x i8> %wide.load516, ptr %next.gep514, align 1, !tbaa !7
  %index.next517 = add nuw i64 %index513, 4       ; 2 uses
  %i.ls = icmp eq i64 %index.next517, %n.vec512
  br i1 %i.ls, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !95
...
.lr.ph190:                                        ; preds = %.lr.ph190.preheader, %.lr.ph190
  ...
  %i.lu = load i8, ptr %.5367.i187, align 1, !tbaa !7
  %i.lv = getelementptr inbounds nuw i8, ptr %.16.i188, i64 1 ; 2 uses
  store i8 %i.lu, ptr %.16.i188, align 1, !tbaa !7
  %i.lw = icmp ult ptr %i.lv, %i.iy
  br i1 %i.lw, label %.lr.ph190, label %.preheader121, !llvm.loop !96
...
vector.body463:                                   ; preds = %vector.body463, %vector.ph460
  ...
  br i1 %i.mq, label %middle.block470, label %vector.body463, !llvm.loop !97
...
scalar.ph458:                                     ; preds = %scalar.ph458.preheader, %scalar.ph458
  ...
  br i1 %i.mt, label %scalar.ph458, label %.preheader121, !llvm.loop !98
...
.preheader121:                                    ; preds = %scalar.ph458, %.lr.ph190, %bb.av, %bb.au, %vec.epilog.middle.block, %middle.block507, %middle.block470, %bb.f
  ...
  %i.mv = load i8, ptr %.3.ph, align 1, !tbaa !7
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %i.j, label %LZ4_decompress_generic.exit, label %bb.c, !prof !19

bb.c:                                             ; preds = %bb.b
  %i.k = icmp eq i32 %2, 0
  br i1 %i.k, label %LZ4_decompress_generic.exit, label %bb.d, !prof !19
...
.backedge:                                        ; preds = %.backedge.backedge, %.preheader138
  ...
  %i.u = load i8, ptr %.0, align 1, !tbaa !7
...
.preheader136:                                    ; preds = %bb.f, %bb.g
  ...
  br i1 %i.ac, label %LZ4_wildCopy32.exit.thread, label %bb.g, !prof !19

bb.g:                                             ; preds = %.preheader136
  %i.ad = load i8, ptr %.11, align 1, !tbaa !7    ; 2 uses
  %i.ae = zext i8 %i.ad to i64
  %i.af = add i64 %.0.i15, %i.ae                  ; 3 uses
  %i.ag = icmp eq i8 %i.ad, -1
  br i1 %i.ag, label %.preheader136, label %read_variable_length.exit, !llvm.loop !81
...
read_variable_length.exit.thread66:               ; preds = %bb.f, %read_variable_length.exit
  ...
  br i1 %or.cond, label %LZ4_wildCopy32.exit.thread, label %bb.h, !prof !82
...
.preheader135:                                    ; preds = %bb.h, %.preheader135
  ...
  br i1 %i.ax, label %.preheader135, label %LZ4_wildCopy32.exit.thread75, !llvm.loop !83
...
LZ4_wildCopy32.exit.thread75:                     ; preds = %.preheader135, %bb.j
  ...
  %.val36 = load i16, ptr %.1, align 1, !tbaa !26 ; 5 uses
...
bb.k:                                             ; preds = %LZ4_wildCopy32.exit.thread75
  ...
  br i1 %i.bh, label %LZ4_wildCopy32.exit.thread, label %bb.l, !prof !19

bb.l:                                             ; preds = %bb.k
  %i.bi = load i8, ptr %i.bb, align 1, !tbaa !7   ; 2 uses
...
.preheader133:                                    ; preds = %bb.l, %bb.m
  ...
  br i1 %i.bl, label %LZ4_wildCopy32.exit.thread, label %bb.m, !prof !19

bb.m:                                             ; preds = %.preheader133
  %i.bm = load i8, ptr %.13, align 1, !tbaa !7    ; 2 uses
  %i.bn = zext i8 %i.bm to i64
  %i.bo = add i64 %.0.i18, %i.bn                  ; 3 uses
  %i.bp = icmp eq i8 %i.bm, -1
  br i1 %i.bp, label %.preheader133, label %read_variable_length.exit19, !llvm.loop !81
...
read_variable_length.exit19.thread83:             ; preds = %bb.l, %read_variable_length.exit19
  ...
  br i1 %i.bu, label %LZ4_wildCopy32.exit.thread, label %bb.n, !prof !19
...
.thread91:                                        ; preds = %bb.n, %bb.p
  ...
  br i1 %i.ch, label %LZ4_wildCopy32.exit.thread, label %bb.r, !prof !84

bb.r:                                             ; preds = %.thread91
  %i.ci = getelementptr inbounds nuw i8, ptr %.2.i, i64 %.2374.i ; 9 uses
  %i.cj = icmp ult i16 %.val36, 16
  br i1 %i.cj, label %bb.s, label %.preheader131, !prof !19
...
bb.t:                                             ; preds = %bb.s
  %i.ck = load i8, ptr %i.bd, align 1, !tbaa !7
...
bb.x:                                             ; preds = %bb.w
  store i32 0, ptr %.2.i, align 1, !tbaa !15
  %i.cn = load i8, ptr %i.bd, align 1, !tbaa !7
  store i8 %i.cn, ptr %.2.i, align 1, !tbaa !7
  ...
  store i8 %i.cp, ptr %i.cq, align 1, !tbaa !7
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.dz, label %middle.block, label %vector.body, !llvm.loop !99
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  br i1 %i.ed, label %scalar.ph, label %.backedge.backedge, !llvm.loop !100
...
vector.body427:                                   ; preds = %vector.body427, %vector.ph424
  ...
  br i1 %i.es, label %middle.block433, label %vector.body427, !llvm.loop !101
...
.lr.ph:                                           ; preds = %.lr.ph.preheader540, %.lr.ph
  ...
  br i1 %i.et, label %.lr.ph, label %.backedge.backedge, !llvm.loop !102
...
.preheader131:                                    ; preds = %bb.r, %.preheader131
  ...
  br i1 %i.ey, label %.preheader131, label %.backedge.backedge, !llvm.loop !83
...
.lr.ph191:                                        ; preds = %.preheader128, %bb.ac
  ...
  br i1 %i.fe, label %bb.ab, label %LZ4_wildCopy32.exit, !prof !28
...
bb.ab:                                            ; preds = %.lr.ph191
  ...
  %.val = load i16, ptr %i.fg, align 1, !tbaa !26 ; 2 uses
...
bb.ac:                                            ; preds = %bb.ab
  ...
  %i.fz = load i8, ptr %i.fk, align 1, !tbaa !7
...
.preheader127:                                    ; preds = %bb.ad, %bb.ae
  ...
  br i1 %i.gg, label %LZ4_wildCopy32.exit.thread, label %bb.ae, !prof !19

bb.ae:                                            ; preds = %.preheader127
  %i.gh = load i8, ptr %.15, align 1, !tbaa !7    ; 2 uses
  %i.gi = zext i8 %i.gh to i64
  %i.gj = add i64 %.0.i23, %i.gi                  ; 3 uses
  %i.gk = icmp eq i8 %i.gh, -1
  br i1 %i.gk, label %.preheader127, label %read_variable_length.exit24, !llvm.loop !81
...
read_variable_length.exit24.thread98:             ; preds = %bb.ad, %read_variable_length.exit24
  ...
  br i1 %or.cond120, label %LZ4_wildCopy32.exit.thread, label %LZ4_wildCopy32.exit, !prof !82
...
vector.body446:                                   ; preds = %vector.body446, %vector.ph443
  ...
  br i1 %i.hn, label %middle.block453, label %vector.body446, !llvm.loop !103
...
bb.ah:                                            ; preds = %bb.ag
  ...
  %or.cond460.i = select i1 %i.ia, i1 %.not441.i, i1 false
  br i1 %or.cond460.i, label %LZ4_wildCopy8.exit14, label %bb.au
...
.preheader126:                                    ; preds = %.preheader126.preheader511, %.preheader126
  ...
  br i1 %i.if, label %.preheader126, label %LZ4_wildCopy8.exit14, !llvm.loop !104
...
bb.ai:                                            ; preds = %.loopexit129
  ...
  br i1 %i.ip, label %LZ4_wildCopy32.exit.thread, label %bb.aj, !prof !19

bb.aj:                                            ; preds = %bb.ai
  %i.iq = load i8, ptr %.6, align 1, !tbaa !7     ; 2 uses
...
.preheader125:                                    ; preds = %bb.aj, %bb.ak
  ...
  br i1 %i.it, label %LZ4_wildCopy32.exit.thread, label %bb.ak, !prof !19

bb.ak:                                            ; preds = %.preheader125
  %i.iu = load i8, ptr %.17, align 1, !tbaa !7    ; 2 uses
  %i.iv = zext i8 %i.iu to i64
  %i.iw = add i64 %.0.i27, %i.iv                  ; 2 uses
  %i.ix = icmp eq i8 %i.iu, -1
  br i1 %i.ix, label %.preheader125, label %read_variable_length.exit28, !llvm.loop !81
...
.loopexit141:                                     ; preds = %bb.n, %bb.o, %bb.al
  ...
  br i1 %i.je, label %LZ4_wildCopy32.exit.thread, label %bb.am, !prof !84
...
vector.body486:                                   ; preds = %vector.body486, %vector.ph483
  ...
  %wide.load490 = load <16 x i8>, ptr %next.gep489, align 1, !tbaa !7
  %wide.load491 = load <16 x i8>, ptr %i.ju, align 1, !tbaa !7
  %i.jv = getelementptr i8, ptr %next.gep488, i64 16
  store <16 x i8> %wide.load490, ptr %next.gep488, align 1, !tbaa !7
  store <16 x i8> %wide.load491, ptr %i.jv, align 1, !tbaa !7
  %index.next492 = add nuw i64 %index487, 32      ; 2 uses
  %i.jw = icmp eq i64 %index.next492, %n.vec485
  br i1 %i.jw, label %middle.block493, label %vector.body486, !llvm.loop !105
...
vec.epilog.iter.check:                            ; preds = %middle.block493
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph197.preheader, label %vec.epilog.ph, !prof !94
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load502 = load <4 x i8>, ptr %next.gep501, align 1, !tbaa !7
  store <4 x i8> %wide.load502, ptr %next.gep500, align 1, !tbaa !7
  %index.next503 = add nuw i64 %index499, 4       ; 2 uses
  %i.jz = icmp eq i64 %index.next503, %n.vec498
  br i1 %i.jz, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !106
...
.lr.ph197:                                        ; preds = %.lr.ph197.preheader, %.lr.ph197
  ...
  %i.kb = load i8, ptr %.2364.i195, align 1, !tbaa !7
  %i.kc = getelementptr inbounds nuw i8, ptr %.14.i196, i64 1 ; 2 uses
  store i8 %i.kb, ptr %.14.i196, align 1, !tbaa !7
  %i.kd = icmp ult ptr %i.kc, %i.jm
  br i1 %i.kd, label %.lr.ph197, label %.loopexit, !llvm.loop !107
...
bb.ap:                                            ; preds = %bb.am
  ...
  br i1 %i.kf, label %bb.aq, label %bb.ar, !prof !19

bb.aq:                                            ; preds = %bb.ap
  store i32 0, ptr %.10.i, align 1, !tbaa !15
  %i.kg = load i8, ptr %.1363.i, align 1, !tbaa !7
  store i8 %i.kg, ptr %.10.i, align 1, !tbaa !7
...
vector.body466:                                   ; preds = %vector.body466, %vector.ph463
  ...
  br i1 %i.lx, label %middle.block473, label %vector.body466, !llvm.loop !108
...
scalar.ph461:                                     ; preds = %scalar.ph461.preheader, %scalar.ph461
  ...
  br i1 %i.ma, label %scalar.ph461, label %.preheader128, !llvm.loop !109
...
.preheader128:                                    ; preds = %scalar.ph461, %bb.as, %middle.block473, %bb.d, %.loopexit
  ...
  %i.mc = load i8, ptr %.3.ph, align 1, !tbaa !7
...
.preheader34:                                     ; preds = %.thread, %.preheader34
  ...
  br i1 %i.p, label %.preheader34, label %read_long_length_no_check.exit, !llvm.loop !110
...
bb.e:                                             ; preds = %bb.c
  ...
  %.val = load i16, ptr %i.v, align 1, !tbaa !26  ; 2 uses
...
.preheader:                                       ; preds = %bb.e, %.preheader
  ...
  br i1 %i.ak, label %.preheader, label %read_long_length_no_check.exit5, !llvm.loop !110
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load60 = load <16 x i8>, ptr %i.at, align 1, !tbaa !7
  %i.au = getelementptr inbounds nuw i8, ptr %i.u, i64 %index ; 2 uses
  %i.av = getelementptr inbounds nuw i8, ptr %i.au, i64 16
  store <16 x i8> %wide.load, ptr %i.au, align 1, !tbaa !7
  store <16 x i8> %wide.load60, ptr %i.av, align 1, !tbaa !7
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.aw = icmp eq i64 %index.next, %n.vec
  br i1 %i.aw, label %middle.block, label %vector.body, !llvm.loop !111
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load64 = load <4 x i8>, ptr %i.ax, align 1, !tbaa !7
  %i.ay = getelementptr inbounds nuw i8, ptr %i.u, i64 %index63
  store <4 x i8> %wide.load64, ptr %i.ay, align 1, !tbaa !7
...
.lr.ph.prol:                                      ; preds = %.lr.ph.preheader, %.lr.ph.prol
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph.prol.loopexit, label %.lr.ph.prol, !llvm.loop !113
...
.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  ...
  br i1 %exitcond.not.3, label %._crit_edge, label %.lr.ph, !llvm.loop !115
...
.backedge:                                        ; preds = %.backedge.backedge, %.preheader144
  ...
  %i.x = load i8, ptr %.0, align 1, !tbaa !7
...
.preheader142:                                    ; preds = %bb.h, %bb.i
  ...
  br i1 %i.af, label %LZ4_wildCopy32.exit.thread, label %bb.i, !prof !19

bb.i:                                             ; preds = %.preheader142
  %i.ag = load i8, ptr %.10, align 1, !tbaa !7    ; 2 uses
  %i.ah = zext i8 %i.ag to i64
  %i.ai = add i64 %.0.i11, %i.ah                  ; 3 uses
  %i.aj = icmp eq i8 %i.ag, -1
  br i1 %i.aj, label %.preheader142, label %read_variable_length.exit, !llvm.loop !81
...
.preheader141:                                    ; preds = %bb.j, %.preheader141
  ...
  br i1 %i.az, label %.preheader141, label %LZ4_wildCopy32.exit.thread71, !llvm.loop !83
...
bb.m:                                             ; preds = %LZ4_wildCopy32.exit.thread71
  ...
  br i1 %i.bg, label %LZ4_wildCopy32.exit.thread, label %bb.n, !prof !19

bb.n:                                             ; preds = %bb.m
  %i.bh = load i8, ptr %i.bc, align 1, !tbaa !7   ; 2 uses
...
.preheader139:                                    ; preds = %bb.n, %bb.o
  ...
  br i1 %i.bk, label %LZ4_wildCopy32.exit.thread, label %bb.o, !prof !19

bb.o:                                             ; preds = %.preheader139
  %i.bl = load i8, ptr %.12, align 1, !tbaa !7    ; 2 uses
  %i.bm = zext i8 %i.bl to i64
  %i.bn = add i64 %.0.i14, %i.bm                  ; 3 uses
  %i.bo = icmp eq i8 %i.bl, -1
  br i1 %i.bo, label %.preheader139, label %read_variable_length.exit15, !llvm.loop !81
...
read_variable_length.exit15.thread79:             ; preds = %bb.n, %read_variable_length.exit15
  ...
  br i1 %i.bt, label %LZ4_wildCopy32.exit.thread, label %bb.p, !prof !19
...
.thread87:                                        ; preds = %bb.p, %bb.r
  ...
  br i1 %i.cd, label %LZ4_wildCopy32.exit.thread, label %bb.t, !prof !84
...
bb.t:                                             ; preds = %.thread87
  ...
  br i1 %i.ce, label %bb.u, label %.preheader137, !prof !19
...
bb.v:                                             ; preds = %bb.u
  %i.cf = load i8, ptr %.ptr.ptr, align 1, !tbaa !7
...
bb.z:                                             ; preds = %bb.y
  store i32 0, ptr %.2.i.ptr.ptr, align 1, !tbaa !15
  %i.ci = load i8, ptr %.ptr.ptr, align 1, !tbaa !7
  store i8 %i.ci, ptr %.2.i.ptr.ptr, align 1, !tbaa !7
  ...
  store i8 %i.ck, ptr %i.cl, align 1, !tbaa !7
  ...
  store i8 %i.cn, ptr %i.co, align 1, !tbaa !7
  ...
  store i8 %i.cq, ptr %i.cr, align 1, !tbaa !7
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  br i1 %i.dz, label %scalar.ph, label %.backedge.backedge, !llvm.loop !117
...
vector.body416:                                   ; preds = %vector.body416, %vector.ph413
  ...
  br i1 %i.ep, label %middle.block422, label %vector.body416, !llvm.loop !118
...
.lr.ph:                                           ; preds = %.lr.ph.preheader542, %.lr.ph
  ...
  br i1 %i.eq, label %.lr.ph, label %.backedge.backedge, !llvm.loop !119
...
.preheader137:                                    ; preds = %bb.t, %.preheader137
  ...
  br i1 %i.ev, label %.preheader137, label %.backedge.backedge, !llvm.loop !83
...
bb.ad:                                            ; preds = %.lr.ph198, %bb.af
  ...
  br i1 %i.fb, label %bb.ae, label %LZ4_wildCopy32.exit, !prof !28
...
bb.ae:                                            ; preds = %bb.ad
  ...
  %.val = load i16, ptr %i.fc, align 1, !tbaa !26 ; 2 uses
...
bb.af:                                            ; preds = %bb.ae
  ...
  %i.fr = load i8, ptr %i.fg, align 1, !tbaa !7
...
.preheader134:                                    ; preds = %bb.ag, %bb.ah
  ...
  br i1 %i.fy, label %LZ4_wildCopy32.exit.thread, label %bb.ah, !prof !19

bb.ah:                                            ; preds = %.preheader134
  %i.fz = load i8, ptr %.14, align 1, !tbaa !7    ; 2 uses
  %i.ga = zext i8 %i.fz to i64
  %i.gb = add i64 %.0.i19, %i.ga                  ; 3 uses
  %i.gc = icmp eq i8 %i.fz, -1
  br i1 %i.gc, label %.preheader134, label %read_variable_length.exit20, !llvm.loop !81
...
read_variable_length.exit20.thread94:             ; preds = %bb.ag, %read_variable_length.exit20
  ...
  br i1 %or.cond111, label %LZ4_wildCopy32.exit.thread, label %LZ4_wildCopy32.exit, !prof !82
...
vector.body434:                                   ; preds = %vector.body434, %vector.ph431
  ...
  br i1 %i.hi, label %middle.block441, label %vector.body434, !llvm.loop !120
...
bb.aj:                                            ; preds = %bb.ai, %LZ4_wildCopy32.exit
  ...
  %or.cond458.i = select i1 %.not440.i, i1 true, i1 %i.hk
  br i1 %or.cond458.i, label %LZ4_wildCopy32.exit.thread, label %bb.ak
...
.preheader133:                                    ; preds = %.preheader133.preheader515, %.preheader133
  ...
  br i1 %i.hp, label %.preheader133, label %LZ4_wildCopy8.exit10, !llvm.loop !121

LZ4_wildCopy8.exit10:                             ; preds = %.preheader133, %middle.block441
  %.val31 = load i16, ptr %i.gn, align 1, !tbaa !26
...
bb.al:                                            ; preds = %.loopexit
  ...
  br i1 %i.hx, label %LZ4_wildCopy32.exit.thread, label %bb.am, !prof !19

bb.am:                                            ; preds = %bb.al
  %i.hy = load i8, ptr %.5, align 1, !tbaa !7     ; 2 uses
...
.preheader132:                                    ; preds = %bb.am, %bb.an
  ...
  br i1 %i.ib, label %LZ4_wildCopy32.exit.thread, label %bb.an, !prof !19

bb.an:                                            ; preds = %.preheader132
  %i.ic = load i8, ptr %.16, align 1, !tbaa !7    ; 2 uses
  %i.id = zext i8 %i.ic to i64
  %i.ie = add i64 %.0.i23, %i.id                  ; 2 uses
  %i.if = icmp eq i8 %i.ic, -1
  br i1 %i.if, label %.preheader132, label %read_variable_length.exit24, !llvm.loop !81
...
.loopexit147:                                     ; preds = %bb.p, %bb.q, %bb.ao
  ...
  br i1 %i.im, label %LZ4_wildCopy32.exit.thread, label %bb.ap, !prof !84
...
bb.ap:                                            ; preds = %.loopexit147
  ...
  br i1 %i.in, label %bb.aq, label %bb.ar, !prof !19

bb.aq:                                            ; preds = %bb.ap
  store i32 0, ptr %.10.i.ptr, align 1, !tbaa !15
  %i.io = load i8, ptr %.1363.i.ptr, align 1, !tbaa !7
  store i8 %i.io, ptr %.10.i.ptr, align 1, !tbaa !7
  ...
  store i8 %i.iq, ptr %i.ir, align 1, !tbaa !7
  ...
  store i8 %i.it, ptr %i.iu, align 1, !tbaa !7
...
.preheader:                                       ; preds = %.preheader.preheader511, %.preheader
  ...
  br i1 %i.kr, label %.preheader, label %LZ4_wildCopy8.exit, !llvm.loop !123
...
vector.body490:                                   ; preds = %vector.body490, %vector.ph487
  ...
  %wide.load494 = load <16 x i8>, ptr %next.gep493, align 1, !tbaa !7
  %wide.load495 = load <16 x i8>, ptr %i.ld, align 1, !tbaa !7
  %i.le = getelementptr i8, ptr %next.gep492, i64 16
  store <16 x i8> %wide.load494, ptr %next.gep492, align 1, !tbaa !7
  store <16 x i8> %wide.load495, ptr %i.le, align 1, !tbaa !7
  %index.next496 = add nuw i64 %index491, 32      ; 2 uses
  %i.lf = icmp eq i64 %index.next496, %n.vec489
  br i1 %i.lf, label %middle.block497, label %vector.body490, !llvm.loop !124
...
vec.epilog.iter.check:                            ; preds = %middle.block497
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph206.preheader, label %vec.epilog.ph, !prof !94
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load506 = load <4 x i8>, ptr %next.gep505, align 1, !tbaa !7
  store <4 x i8> %wide.load506, ptr %next.gep504, align 1, !tbaa !7
  %index.next507 = add nuw i64 %index503, 4       ; 2 uses
  %i.li = icmp eq i64 %index.next507, %n.vec502
  br i1 %i.li, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !125
...
.lr.ph206:                                        ; preds = %.lr.ph206.preheader, %.lr.ph206
  ...
  %i.lk = load i8, ptr %.5367.i203, align 1, !tbaa !7
  %i.ll = getelementptr inbounds nuw i8, ptr %.16.i204, i64 1 ; 2 uses
  store i8 %i.lk, ptr %.16.i204, align 1, !tbaa !7
  %i.lm = icmp ult ptr %i.ll, %.ptr130
  br i1 %i.lm, label %.lr.ph206, label %.preheader135, !llvm.loop !126
...
vector.body453:                                   ; preds = %vector.body453, %vector.ph450
  ...
  br i1 %i.mk, label %middle.block460, label %vector.body453, !llvm.loop !127
...
scalar.ph448:                                     ; preds = %scalar.ph448.preheader, %scalar.ph448
  ...
  br i1 %i.mn, label %scalar.ph448, label %.preheader135, !llvm.loop !128
...
.preheader135:                                    ; preds = %scalar.ph448, %.lr.ph206, %bb.aw, %bb.av, %vec.epilog.middle.block, %middle.block497, %middle.block460, %bb.f
  ...
  %i.mp = load i8, ptr %.3.ph, align 1, !tbaa !7
...
.preheader34:                                     ; preds = %.thread, %.preheader34
  ...
  br i1 %i.q, label %.preheader34, label %read_long_length_no_check.exit, !llvm.loop !110
...
bb.e:                                             ; preds = %bb.c
  ...
  %.val = load i16, ptr %i.w, align 1, !tbaa !26  ; 2 uses
...
.preheader:                                       ; preds = %bb.e, %.preheader
  ...
  br i1 %i.al, label %.preheader, label %read_long_length_no_check.exit5, !llvm.loop !110
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load60 = load <16 x i8>, ptr %i.au, align 1, !tbaa !7
  %i.av = getelementptr inbounds nuw i8, ptr %i.v, i64 %index ; 2 uses
  %i.aw = getelementptr inbounds nuw i8, ptr %i.av, i64 16
  store <16 x i8> %wide.load, ptr %i.av, align 1, !tbaa !7
  store <16 x i8> %wide.load60, ptr %i.aw, align 1, !tbaa !7
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.ax = icmp eq i64 %index.next, %n.vec
  br i1 %i.ax, label %middle.block, label %vector.body, !llvm.loop !129
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load64 = load <4 x i8>, ptr %i.ay, align 1, !tbaa !7
  %i.az = getelementptr inbounds nuw i8, ptr %i.v, i64 %index63
  store <4 x i8> %wide.load64, ptr %i.az, align 1, !tbaa !7
  %index.next65 = add nuw i64 %index63, 4         ; 2 uses
  %i.ba = icmp eq i64 %index.next65, %n.vec62
  br i1 %i.ba, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !130
...
.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  ...
  %exitcond.not.3 = icmp eq i64 %.0.i40, %.092.i
  br i1 %exitcond.not.3, label %._crit_edge, label %.lr.ph, !llvm.loop !132
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.m = icmp eq i32 %3, 0
  br i1 %i.m, label %bb.c, label %bb.e, !prof !19
...
bb.e:                                             ; preds = %bb.b
  %i.r = icmp eq i32 %2, 0
  br i1 %i.r, label %LZ4_decompress_generic.exit, label %bb.f, !prof !19
...
.backedge:                                        ; preds = %.backedge.backedge, %.preheader136
  ...
  %i.ac = load i8, ptr %.0, align 1, !tbaa !7
...
.preheader134:                                    ; preds = %bb.h, %bb.i
  ...
  br i1 %i.ak, label %LZ4_wildCopy32.exit.thread, label %bb.i, !prof !19

bb.i:                                             ; preds = %.preheader134
  %i.al = load i8, ptr %.10, align 1, !tbaa !7    ; 2 uses
  %i.am = zext i8 %i.al to i64
  %i.an = add i64 %.0.i13, %i.am                  ; 3 uses
  %i.ao = icmp eq i8 %i.al, -1
  br i1 %i.ao, label %.preheader134, label %read_variable_length.exit, !llvm.loop !81
...
.preheader133:                                    ; preds = %bb.j, %.preheader133
  ...
  br i1 %i.bf, label %.preheader133, label %LZ4_wildCopy32.exit.thread73, !llvm.loop !83
...
LZ4_wildCopy32.exit.thread73:                     ; preds = %.preheader133, %bb.l
  ...
  %.val34 = load i16, ptr %.1, align 1, !tbaa !26 ; 6 uses
...
bb.m:                                             ; preds = %LZ4_wildCopy32.exit.thread73
  ...
  br i1 %i.bp, label %LZ4_wildCopy32.exit.thread, label %bb.n, !prof !19

bb.n:                                             ; preds = %bb.m
  %i.bq = load i8, ptr %i.bj, align 1, !tbaa !7   ; 2 uses
...
.preheader131:                                    ; preds = %bb.n, %bb.o
  ...
  br i1 %i.bt, label %LZ4_wildCopy32.exit.thread, label %bb.o, !prof !19

bb.o:                                             ; preds = %.preheader131
  %i.bu = load i8, ptr %.12, align 1, !tbaa !7    ; 2 uses
  %i.bv = zext i8 %i.bu to i64
  %i.bw = add i64 %.0.i16, %i.bv                  ; 3 uses
  %i.bx = icmp eq i8 %i.bu, -1
  br i1 %i.bx, label %.preheader131, label %read_variable_length.exit17, !llvm.loop !81
...
read_variable_length.exit17.thread81:             ; preds = %bb.n, %read_variable_length.exit17
  ...
  br i1 %i.cc, label %LZ4_wildCopy32.exit.thread, label %bb.p, !prof !19
...
.thread89:                                        ; preds = %bb.p, %bb.r
  ...
  %or.cond452.i = select i1 %i.j, i1 %i.cq, i1 false, !prof !84
  br i1 %or.cond452.i, label %LZ4_wildCopy32.exit.thread, label %bb.t, !prof !84
...
bb.u:                                             ; preds = %bb.t
  ...
  br i1 %i.ct, label %LZ4_wildCopy32.exit.thread, label %bb.v, !prof !19
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %next.gep452, align 1, !tbaa !7
  %wide.load453 = load <16 x i8>, ptr %i.dm, align 1, !tbaa !7
  %i.dn = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load, ptr %next.gep, align 1, !tbaa !7
  store <16 x i8> %wide.load453, ptr %i.dn, align 1, !tbaa !7
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.do = icmp eq i64 %index.next, %n.vec
  br i1 %i.do, label %middle.block, label %vector.body, !llvm.loop !133
...
vector.body472:                                   ; preds = %vector.body472, %vector.ph469
  ...
  br i1 %i.fm, label %middle.block479, label %vector.body472, !llvm.loop !136
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  br i1 %i.fq, label %scalar.ph, label %.backedge.backedge, !llvm.loop !137
...
vector.body487:                                   ; preds = %vector.body487, %vector.ph484
  ...
  br i1 %i.gf, label %middle.block493, label %vector.body487, !llvm.loop !138
...
.lr.ph:                                           ; preds = %.lr.ph.preheader672, %.lr.ph
  ...
  br i1 %i.gg, label %.lr.ph, label %.backedge.backedge, !llvm.loop !139
...
.preheader129:                                    ; preds = %bb.z, %.preheader129
  ...
  br i1 %i.gl, label %.preheader129, label %.backedge.backedge, !llvm.loop !83
...
.lr.ph192:                                        ; preds = %.preheader124, %bb.ak
  ...
  br i1 %i.gr, label %bb.aj, label %LZ4_wildCopy32.exit, !prof !28
...
bb.aj:                                            ; preds = %.lr.ph192
  ...
  %.val = load i16, ptr %i.gt, align 1, !tbaa !26 ; 2 uses
...
bb.ak:                                            ; preds = %bb.aj
  ...
  %i.hm = load i8, ptr %i.gx, align 1, !tbaa !7
...
.preheader123:                                    ; preds = %bb.al, %bb.am
  ...
  br i1 %i.ht, label %LZ4_wildCopy32.exit.thread, label %bb.am, !prof !19

bb.am:                                            ; preds = %.preheader123
  %i.hu = load i8, ptr %.14, align 1, !tbaa !7    ; 2 uses
  %i.hv = zext i8 %i.hu to i64
  %i.hw = add i64 %.0.i21, %i.hv                  ; 3 uses
  %i.hx = icmp eq i8 %i.hu, -1
  br i1 %i.hx, label %.preheader123, label %read_variable_length.exit22, !llvm.loop !81
...
read_variable_length.exit22.thread96:             ; preds = %bb.al, %read_variable_length.exit22
  ...
  br i1 %or.cond114, label %LZ4_wildCopy32.exit.thread, label %LZ4_wildCopy32.exit, !prof !82
...
vector.body506:                                   ; preds = %vector.body506, %vector.ph503
  ...
  br i1 %i.ja, label %middle.block513, label %vector.body506, !llvm.loop !140
...
bb.ao:                                            ; preds = %bb.an, %LZ4_wildCopy32.exit
  ...
  %or.cond458.i = select i1 %.not440.i, i1 true, i1 %i.jc
  br i1 %or.cond458.i, label %LZ4_wildCopy32.exit.thread, label %bb.ap
...
.preheader122:                                    ; preds = %.preheader122.preheader642, %.preheader122
  ...
  br i1 %i.jj, label %.preheader122, label %LZ4_wildCopy8.exit12, !llvm.loop !141

LZ4_wildCopy8.exit12:                             ; preds = %.preheader122, %middle.block513
  %.val33 = load i16, ptr %i.ij, align 1, !tbaa !26
...
bb.aq:                                            ; preds = %.loopexit125
  ...
  br i1 %i.jt, label %LZ4_wildCopy32.exit.thread, label %bb.ar, !prof !19

bb.ar:                                            ; preds = %bb.aq
  %i.ju = load i8, ptr %.5, align 1, !tbaa !7     ; 2 uses
...
.preheader121:                                    ; preds = %bb.ar, %bb.as
  ...
  br i1 %i.jx, label %LZ4_wildCopy32.exit.thread, label %bb.as, !prof !19

bb.as:                                            ; preds = %.preheader121
  %i.jy = load i8, ptr %.16, align 1, !tbaa !7    ; 2 uses
  %i.jz = zext i8 %i.jy to i64
  %i.ka = add i64 %.0.i25, %i.jz                  ; 2 uses
  %i.kb = icmp eq i8 %i.jy, -1
  br i1 %i.kb, label %.preheader121, label %read_variable_length.exit26, !llvm.loop !81
...
.loopexit139:                                     ; preds = %bb.p, %bb.q, %bb.at
  ...
  %or.cond463.i = select i1 %i.j, i1 %i.kj, i1 false, !prof !84
  br i1 %or.cond463.i, label %LZ4_wildCopy32.exit.thread, label %bb.au, !prof !84
...
bb.av:                                            ; preds = %bb.au
  ...
  br i1 %i.kn, label %LZ4_wildCopy32.exit.thread, label %bb.aw, !prof !19
...
begin_hunk_5_@LZ4_decompress_safe_forceExtDict:bb.a
  ...
  br i1 %i.no, label %middle.block551, label %vector.body544, !llvm.loop !145
...
.preheader119:                                    ; preds = %.preheader119.preheader637, %.preheader119
  ...
  br i1 %i.ns, label %.preheader119, label %LZ4_wildCopy8.exit, !llvm.loop !146
...
vector.body565:                                   ; preds = %vector.body565, %vector.ph562
  ...
  %wide.load569 = load <16 x i8>, ptr %next.gep568, align 1, !tbaa !7
  %wide.load570 = load <16 x i8>, ptr %i.oh, align 1, !tbaa !7
  %i.oi = getelementptr i8, ptr %next.gep567, i64 16
  store <16 x i8> %wide.load569, ptr %next.gep567, align 1, !tbaa !7
  store <16 x i8> %wide.load570, ptr %i.oi, align 1, !tbaa !7
  %index.next571 = add nuw i64 %index566, 32      ; 2 uses
  %i.oj = icmp eq i64 %index.next571, %n.vec564
  br i1 %i.oj, label %middle.block572, label %vector.body565, !llvm.loop !147
...
vec.epilog.iter.check579:                         ; preds = %middle.block572
  ...
  br i1 %min.epilog.iters.check580, label %.lr.ph200.preheader, label %vec.epilog.ph581, !prof !94
...
vec.epilog.vector.body584:                        ; preds = %vec.epilog.vector.body584, %vec.epilog.ph581
  ...
  %wide.load588 = load <4 x i8>, ptr %next.gep587, align 1, !tbaa !7
  store <4 x i8> %wide.load588, ptr %next.gep586, align 1, !tbaa !7
  %index.next589 = add nuw i64 %index585, 4       ; 2 uses
  %i.om = icmp eq i64 %index.next589, %n.vec583
  br i1 %i.om, label %vec.epilog.middle.block590, label %vec.epilog.vector.body584, !llvm.loop !148
...
.lr.ph200:                                        ; preds = %.lr.ph200.preheader, %.lr.ph200
  ...
  %i.oo = load i8, ptr %.5367.i197, align 1, !tbaa !7
  %i.op = getelementptr inbounds nuw i8, ptr %.16.i198, i64 1 ; 2 uses
  store i8 %i.oo, ptr %.16.i198, align 1, !tbaa !7
  %i.oq = icmp ult ptr %i.op, %i.kl
  br i1 %i.oq, label %.lr.ph200, label %.preheader124, !llvm.loop !149
...
vector.body526:                                   ; preds = %vector.body526, %vector.ph523
  ...
  br i1 %i.pk, label %middle.block533, label %vector.body526, !llvm.loop !150
...
scalar.ph521:                                     ; preds = %scalar.ph521.preheader, %scalar.ph521
  ...
  br i1 %i.pn, label %scalar.ph521, label %.preheader124, !llvm.loop !151
...
.preheader124:                                    ; preds = %scalar.ph521, %.lr.ph200, %.lr.ph203, %bb.bh, %bb.bg, %vec.epilog.middle.block590, %middle.block572, %middle.block533, %bb.ax, %bb.az, %vec.epilog.middle.block629, %middle.block611, %bb.f
  ...
  %i.pp = load i8, ptr %.3.ph, align 1, !tbaa !7
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %i.n, label %LZ4_decompress_generic.exit, label %bb.c, !prof !19

bb.c:                                             ; preds = %bb.b
  %i.o = icmp eq i32 %2, 0
  br i1 %i.o, label %LZ4_decompress_generic.exit, label %bb.d, !prof !19
...
.backedge:                                        ; preds = %.backedge.backedge, %.preheader142
  ...
  %i.aa = load i8, ptr %.0, align 1, !tbaa !7
...
.preheader140:                                    ; preds = %bb.f, %bb.g
  ...
  br i1 %i.ai, label %LZ4_wildCopy32.exit.thread, label %bb.g, !prof !19

bb.g:                                             ; preds = %.preheader140
  %i.aj = load i8, ptr %.11, align 1, !tbaa !7    ; 2 uses
  %i.ak = zext i8 %i.aj to i64
  %i.al = add i64 %.0.i17, %i.ak                  ; 3 uses
  %i.am = icmp eq i8 %i.aj, -1
  br i1 %i.am, label %.preheader140, label %read_variable_length.exit, !llvm.loop !81
...
.preheader139:                                    ; preds = %bb.h, %.preheader139
  ...
  br i1 %i.bd, label %.preheader139, label %LZ4_wildCopy32.exit.thread77, !llvm.loop !83
...
LZ4_wildCopy32.exit.thread77:                     ; preds = %.preheader139, %bb.j
  ...
  %.2.i450 = ptrtoaddr ptr %.2.i to i64           ; 8 uses
  %.val38 = load i16, ptr %.1, align 1, !tbaa !26 ; 6 uses
...
bb.k:                                             ; preds = %LZ4_wildCopy32.exit.thread77
  ...
  br i1 %i.bn, label %LZ4_wildCopy32.exit.thread, label %bb.l, !prof !19

bb.l:                                             ; preds = %bb.k
  %i.bo = load i8, ptr %i.bh, align 1, !tbaa !7   ; 2 uses
  %i.bp = zext i8 %i.bo to i64
...
.preheader137:                                    ; preds = %bb.l, %bb.m
  ...
  br i1 %i.br, label %LZ4_wildCopy32.exit.thread, label %bb.m, !prof !19

bb.m:                                             ; preds = %.preheader137
  %i.bs = load i8, ptr %.13, align 1, !tbaa !7    ; 2 uses
  %i.bt = zext i8 %i.bs to i64
  %i.bu = add i64 %.0.i20, %i.bt                  ; 3 uses
  %i.bv = icmp eq i8 %i.bs, -1
  br i1 %i.bv, label %.preheader137, label %read_variable_length.exit21, !llvm.loop !81
...
read_variable_length.exit21.thread85:             ; preds = %bb.l, %read_variable_length.exit21
  ...
  br i1 %i.ca, label %LZ4_wildCopy32.exit.thread, label %bb.n, !prof !19
...
.thread93:                                        ; preds = %bb.n, %bb.p
  ...
  %or.cond452.i = select i1 %i.k, i1 %i.co, i1 false, !prof !84
  br i1 %or.cond452.i, label %LZ4_wildCopy32.exit.thread, label %bb.r, !prof !84
...
bb.s:                                             ; preds = %bb.r
  ...
  br i1 %i.cr, label %bb.t, label %bb.u, !prof !19
...
vector.body472:                                   ; preds = %vector.body472, %vector.ph469
  ...
  br i1 %i.fq, label %middle.block479, label %vector.body472, !llvm.loop !155
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  br i1 %i.fu, label %scalar.ph, label %.backedge.backedge, !llvm.loop !156
...
vector.body487:                                   ; preds = %vector.body487, %vector.ph484
  ...
  br i1 %i.gj, label %middle.block493, label %vector.body487, !llvm.loop !157
...
.lr.ph:                                           ; preds = %.lr.ph.preheader654, %.lr.ph
  ...
  br i1 %i.gk, label %.lr.ph, label %.backedge.backedge, !llvm.loop !158
...
.preheader135:                                    ; preds = %bb.y, %.preheader135
  ...
  br i1 %i.gp, label %.preheader135, label %.backedge.backedge, !llvm.loop !83
...
.lr.ph198:                                        ; preds = %.preheader131, %bb.aj
  ...
  br i1 %i.gv, label %bb.ai, label %LZ4_wildCopy32.exit, !prof !28
...
bb.ai:                                            ; preds = %.lr.ph198
  ...
  %.val = load i16, ptr %i.gx, align 1, !tbaa !26 ; 2 uses
...
bb.aj:                                            ; preds = %bb.ai
  ...
  %i.hq = load i8, ptr %i.hb, align 1, !tbaa !7
...
.preheader130:                                    ; preds = %bb.ak, %bb.al
  ...
  br i1 %i.hx, label %LZ4_wildCopy32.exit.thread, label %bb.al, !prof !19

bb.al:                                            ; preds = %.preheader130
  %i.hy = load i8, ptr %.15, align 1, !tbaa !7    ; 2 uses
  %i.hz = zext i8 %i.hy to i64
  %i.ia = add i64 %.0.i25, %i.hz                  ; 3 uses
  %i.ib = icmp eq i8 %i.hy, -1
  br i1 %i.ib, label %.preheader130, label %read_variable_length.exit26, !llvm.loop !81
...
read_variable_length.exit26.thread100:            ; preds = %bb.ak, %read_variable_length.exit26
  ...
  br i1 %or.cond122, label %LZ4_wildCopy32.exit.thread, label %LZ4_wildCopy32.exit, !prof !82
...
vector.body506:                                   ; preds = %vector.body506, %vector.ph503
  ...
  br i1 %i.je, label %middle.block513, label %vector.body506, !llvm.loop !159
...
bb.ao:                                            ; preds = %bb.an
  ...
  %or.cond460.i = select i1 %i.jr, i1 %.not441.i, i1 false
  br i1 %or.cond460.i, label %LZ4_wildCopy8.exit16, label %bb.bi
...
.preheader129:                                    ; preds = %.preheader129.preheader624, %.preheader129
  ...
  br i1 %i.jw, label %.preheader129, label %LZ4_wildCopy8.exit16, !llvm.loop !160
...
bb.ap:                                            ; preds = %.loopexit132
  ...
  br i1 %i.kg, label %LZ4_wildCopy32.exit.thread, label %bb.aq, !prof !19

bb.aq:                                            ; preds = %bb.ap
  %i.kh = load i8, ptr %.6, align 1, !tbaa !7     ; 2 uses
...
.preheader128:                                    ; preds = %bb.aq, %bb.ar
  ...
  br i1 %i.kk, label %LZ4_wildCopy32.exit.thread, label %bb.ar, !prof !19

bb.ar:                                            ; preds = %.preheader128
  %i.kl = load i8, ptr %.17, align 1, !tbaa !7    ; 2 uses
  %i.km = zext i8 %i.kl to i64
  %i.kn = add i64 %.0.i29, %i.km                  ; 2 uses
  %i.ko = icmp eq i8 %i.kl, -1
  br i1 %i.ko, label %.preheader128, label %read_variable_length.exit30, !llvm.loop !81
...
.loopexit145:                                     ; preds = %bb.n, %bb.o, %bb.as
  ...
  %or.cond463.i = select i1 %i.k, i1 %i.kw, i1 false, !prof !84
  br i1 %or.cond463.i, label %LZ4_wildCopy32.exit.thread, label %bb.at, !prof !84
...
bb.au:                                            ; preds = %bb.at
  ...
  br i1 %i.la, label %bb.av, label %bb.aw, !prof !19
...
vector.body548:                                   ; preds = %vector.body548, %vector.ph545
  ...
  %wide.load552 = load <16 x i8>, ptr %next.gep551, align 1, !tbaa !7
  %wide.load553 = load <16 x i8>, ptr %i.na, align 1, !tbaa !7
  %i.nb = getelementptr i8, ptr %next.gep550, i64 16
  store <16 x i8> %wide.load552, ptr %next.gep550, align 1, !tbaa !7
  store <16 x i8> %wide.load553, ptr %i.nb, align 1, !tbaa !7
  %index.next554 = add nuw i64 %index549, 32      ; 2 uses
  %i.nc = icmp eq i64 %index.next554, %n.vec547
  br i1 %i.nc, label %middle.block555, label %vector.body548, !llvm.loop !164
...
vec.epilog.iter.check562:                         ; preds = %middle.block555
  ...
  br i1 %min.epilog.iters.check563, label %.lr.ph205.preheader, label %vec.epilog.ph564, !prof !94
...
vec.epilog.vector.body567:                        ; preds = %vec.epilog.vector.body567, %vec.epilog.ph564
  ...
  %wide.load571 = load <4 x i8>, ptr %next.gep570, align 1, !tbaa !7
  store <4 x i8> %wide.load571, ptr %next.gep569, align 1, !tbaa !7
  %index.next572 = add nuw i64 %index568, 4       ; 2 uses
  %i.nf = icmp eq i64 %index.next572, %n.vec566
  br i1 %i.nf, label %vec.epilog.middle.block573, label %vec.epilog.vector.body567, !llvm.loop !165
...
.lr.ph205:                                        ; preds = %.lr.ph205.preheader, %.lr.ph205
  ...
  %i.nh = load i8, ptr %.2364.i203, align 1, !tbaa !7
  %i.ni = getelementptr inbounds nuw i8, ptr %.14.i204, i64 1 ; 2 uses
  store i8 %i.nh, ptr %.14.i204, align 1, !tbaa !7
  %i.nj = icmp ult ptr %i.ni, %i.ms
  br i1 %i.nj, label %.lr.ph205, label %.loopexit127, !llvm.loop !166
...
bb.bd:                                            ; preds = %bb.ba
  ...
  br i1 %i.nl, label %bb.be, label %bb.bf, !prof !19

bb.be:                                            ; preds = %bb.bd
  store i32 0, ptr %.10.i, align 1, !tbaa !15
  %i.nm = load i8, ptr %.1363.i, align 1, !tbaa !7
  store i8 %i.nm, ptr %.10.i, align 1, !tbaa !7
  ...
  store i8 %i.no, ptr %i.np, align 1, !tbaa !7
  ...
  store i8 %i.nr, ptr %i.ns, align 1, !tbaa !7
  %i.nt = getelementptr inbounds nuw i8, ptr %.1363.i, i64 3
  %i.nu = load i8, ptr %i.nt, align 1, !tbaa !7
  %i.nv = getelementptr inbounds nuw i8, ptr %.10.i, i64 3
  store i8 %i.nu, ptr %i.nv, align 1, !tbaa !7
...
vector.body526:                                   ; preds = %vector.body526, %vector.ph523
  ...
  br i1 %i.pd, label %middle.block533, label %vector.body526, !llvm.loop !167
...
scalar.ph521:                                     ; preds = %scalar.ph521.preheader, %scalar.ph521
  ...
  br i1 %i.pg, label %scalar.ph521, label %.preheader131, !llvm.loop !168
...
.preheader131:                                    ; preds = %scalar.ph521, %.lr.ph209, %bb.bg, %middle.block533, %bb.ax, %bb.az, %vec.epilog.middle.block612, %middle.block594, %bb.d, %.loopexit127
  ...
  %i.pi = load i8, ptr %.3.ph, align 1, !tbaa !7
...
bb.a:
  ...
  store i64 %i.a, ptr %i.b, align 8, !tbaa !169
...
bb.a:
  ...
  %i.b = load i64, ptr %i.a, align 8, !tbaa !169  ; 11 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  store i64 %i.f, ptr %i.a, align 8, !tbaa !169
...
bb.g:                                             ; preds = %bb.e
  ...
  %i.o = load i64, ptr %i.n, align 8, !tbaa !173  ; 5 uses
...
bb.j:                                             ; preds = %bb.i
  %i.v = load ptr, ptr %0, align 8, !tbaa !172    ; 2 uses
  ...
  br i1 %i.ag, label %bb.k, label %bb.m, !prof !19
...
bb.l:                                             ; preds = %bb.k
  %i.ai = load i8, ptr %1, align 1, !tbaa !7
...
bb.m:                                             ; preds = %bb.j
  ...
  br i1 %i.al, label %LZ4_decompress_safe_doubleDict.exit.thread, label %bb.n, !prof !19
...
.backedge:                                        ; preds = %.backedge.backedge, %.preheader199
  ...
  %i.ay = load i8, ptr %.0123, align 1, !tbaa !7
...
.preheader197:                                    ; preds = %bb.p, %bb.q
  ...
  br i1 %i.bg, label %LZ4_wildCopy32.exit.thread, label %bb.q, !prof !19

bb.q:                                             ; preds = %.preheader197
  %i.bh = load i8, ptr %.10, align 1, !tbaa !7    ; 2 uses
  %i.bi = zext i8 %i.bh to i64
  %i.bj = add i64 %.0.i73, %i.bi                  ; 3 uses
  %i.bk = icmp eq i8 %i.bh, -1
  br i1 %i.bk, label %.preheader197, label %read_variable_length.exit, !llvm.loop !81
...
read_variable_length.exit.thread126:              ; preds = %bb.p, %read_variable_length.exit
  ...
  br i1 %or.cond, label %LZ4_wildCopy32.exit.thread, label %bb.r, !prof !82
...
.preheader196:                                    ; preds = %bb.r, %.preheader196
  ...
  br i1 %i.cb, label %.preheader196, label %LZ4_wildCopy32.exit.thread135, !llvm.loop !83
...
LZ4_wildCopy32.exit.thread135:                    ; preds = %.preheader196, %bb.t
  ...
  %.val95 = load i16, ptr %.1, align 1, !tbaa !26 ; 6 uses
...
bb.u:                                             ; preds = %LZ4_wildCopy32.exit.thread135
  ...
  br i1 %i.cl, label %LZ4_wildCopy32.exit.thread, label %bb.v, !prof !19

bb.v:                                             ; preds = %bb.u
  %i.cm = load i8, ptr %i.cf, align 1, !tbaa !7   ; 2 uses
...
.preheader194:                                    ; preds = %bb.v, %bb.w
  ...
  br i1 %i.cp, label %LZ4_wildCopy32.exit.thread, label %bb.w, !prof !19

bb.w:                                             ; preds = %.preheader194
  %i.cq = load i8, ptr %.12, align 1, !tbaa !7    ; 2 uses
  %i.cr = zext i8 %i.cq to i64
  %i.cs = add i64 %.0.i76, %i.cr                  ; 3 uses
  %i.ct = icmp eq i8 %i.cq, -1
  br i1 %i.ct, label %.preheader194, label %read_variable_length.exit77, !llvm.loop !81
...
read_variable_length.exit77.thread143:            ; preds = %bb.v, %read_variable_length.exit77
  ...
  br i1 %i.cy, label %LZ4_wildCopy32.exit.thread, label %bb.x, !prof !19
...
.thread151:                                       ; preds = %bb.x, %bb.z
  ...
  %or.cond452.i.i = select i1 %i.ad, i1 %i.dm, i1 false, !prof !84
  br i1 %or.cond452.i.i, label %LZ4_wildCopy32.exit.thread, label %bb.ab, !prof !84
...
bb.ac:                                            ; preds = %bb.ab
  ...
  br i1 %i.dp, label %LZ4_wildCopy32.exit.thread, label %bb.ad, !prof !19
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %next.gep524, align 1, !tbaa !7
  %wide.load525 = load <16 x i8>, ptr %i.ej, align 1, !tbaa !7
  %i.ek = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load, ptr %next.gep, align 1, !tbaa !7
  store <16 x i8> %wide.load525, ptr %i.ek, align 1, !tbaa !7
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.el = icmp eq i64 %index.next, %n.vec
  br i1 %i.el, label %middle.block, label %vector.body, !llvm.loop !174
...
vector.body544:                                   ; preds = %vector.body544, %vector.ph541
  ...
  br i1 %i.gj, label %middle.block551, label %vector.body544, !llvm.loop !177
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  br i1 %i.gn, label %scalar.ph, label %.backedge.backedge, !llvm.loop !178
...
vector.body559:                                   ; preds = %vector.body559, %vector.ph556
  ...
  br i1 %i.hc, label %middle.block565, label %vector.body559, !llvm.loop !179
...
.lr.ph:                                           ; preds = %.lr.ph.preheader744, %.lr.ph
  ...
  br i1 %i.hd, label %.lr.ph, label %.backedge.backedge, !llvm.loop !180
...
.preheader192:                                    ; preds = %bb.ah, %.preheader192
  ...
  br i1 %i.hi, label %.preheader192, label %.backedge.backedge, !llvm.loop !83
...
.lr.ph255:                                        ; preds = %.preheader187, %bb.as
  ...
  br i1 %i.ho, label %bb.ar, label %LZ4_wildCopy32.exit, !prof !28
...
bb.ar:                                            ; preds = %.lr.ph255
  ...
  %.val = load i16, ptr %i.hq, align 1, !tbaa !26 ; 2 uses
...
bb.as:                                            ; preds = %bb.ar
  ...
  %i.ij = load i8, ptr %i.hu, align 1, !tbaa !7
...
.preheader186:                                    ; preds = %bb.at, %bb.au
  ...
  br i1 %i.iq, label %LZ4_wildCopy32.exit.thread, label %bb.au, !prof !19

bb.au:                                            ; preds = %.preheader186
  %i.ir = load i8, ptr %.14, align 1, !tbaa !7    ; 2 uses
  %i.is = zext i8 %i.ir to i64
  %i.it = add i64 %.0.i81, %i.is                  ; 3 uses
  %i.iu = icmp eq i8 %i.ir, -1
  br i1 %i.iu, label %.preheader186, label %read_variable_length.exit82, !llvm.loop !81
...
read_variable_length.exit82.thread158:            ; preds = %bb.at, %read_variable_length.exit82
  ...
  br i1 %or.cond177, label %LZ4_wildCopy32.exit.thread, label %LZ4_wildCopy32.exit, !prof !82
...
vector.body578:                                   ; preds = %vector.body578, %vector.ph575
  ...
  br i1 %i.jx, label %middle.block585, label %vector.body578, !llvm.loop !181
...
bb.aw:                                            ; preds = %bb.av, %LZ4_wildCopy32.exit
  ...
  %or.cond458.i.i = select i1 %.not440.i.i, i1 true, i1 %i.jz
  br i1 %or.cond458.i.i, label %LZ4_wildCopy32.exit.thread, label %bb.ax
...
.preheader185:                                    ; preds = %.preheader185.preheader714, %.preheader185
  ...
  br i1 %i.kg, label %.preheader185, label %LZ4_wildCopy8.exit72, !llvm.loop !182

LZ4_wildCopy8.exit72:                             ; preds = %.preheader185, %middle.block585
  %.val94 = load i16, ptr %i.jg, align 1, !tbaa !26
...
bb.ay:                                            ; preds = %.loopexit188
  ...
  br i1 %i.kq, label %LZ4_wildCopy32.exit.thread, label %bb.az, !prof !19

bb.az:                                            ; preds = %bb.ay
  %i.kr = load i8, ptr %.5, align 1, !tbaa !7     ; 2 uses
...
.preheader184:                                    ; preds = %bb.az, %bb.ba
  ...
  br i1 %i.ku, label %LZ4_wildCopy32.exit.thread, label %bb.ba, !prof !19

bb.ba:                                            ; preds = %.preheader184
  %i.kv = load i8, ptr %.16, align 1, !tbaa !7    ; 2 uses
  %i.kw = zext i8 %i.kv to i64
  %i.kx = add i64 %.0.i85, %i.kw                  ; 2 uses
  %i.ky = icmp eq i8 %i.kv, -1
  br i1 %i.ky, label %.preheader184, label %read_variable_length.exit86, !llvm.loop !81
...
.loopexit202:                                     ; preds = %bb.x, %bb.y, %bb.bb
  ...
  %or.cond463.i.i = select i1 %i.ad, i1 %i.lg, i1 false, !prof !84
  br i1 %or.cond463.i.i, label %LZ4_wildCopy32.exit.thread, label %bb.bc, !prof !84
...
bb.bd:                                            ; preds = %bb.bc
  ...
  br i1 %i.lk, label %LZ4_wildCopy32.exit.thread, label %bb.be, !prof !19
...
begin_hunk_9_@LZ4_decompress_safe_continue:bb.a
  ...
  br i1 %i.oo, label %middle.block623, label %vector.body616, !llvm.loop !186
...
.preheader182:                                    ; preds = %.preheader182.preheader709, %.preheader182
  ...
  br i1 %i.os, label %.preheader182, label %LZ4_wildCopy8.exit, !llvm.loop !187
...
vector.body637:                                   ; preds = %vector.body637, %vector.ph634
  ...
  %wide.load641 = load <16 x i8>, ptr %next.gep640, align 1, !tbaa !7
  %wide.load642 = load <16 x i8>, ptr %i.ph, align 1, !tbaa !7
  %i.pi = getelementptr i8, ptr %next.gep639, i64 16
  store <16 x i8> %wide.load641, ptr %next.gep639, align 1, !tbaa !7
  store <16 x i8> %wide.load642, ptr %i.pi, align 1, !tbaa !7
  %index.next643 = add nuw i64 %index638, 32      ; 2 uses
  %i.pj = icmp eq i64 %index.next643, %n.vec636
  br i1 %i.pj, label %middle.block644, label %vector.body637, !llvm.loop !188
...
vec.epilog.iter.check651:                         ; preds = %middle.block644
  ...
  br i1 %min.epilog.iters.check652, label %.lr.ph263.preheader, label %vec.epilog.ph653, !prof !94
...
vec.epilog.vector.body656:                        ; preds = %vec.epilog.vector.body656, %vec.epilog.ph653
  ...
  %wide.load660 = load <4 x i8>, ptr %next.gep659, align 1, !tbaa !7
  store <4 x i8> %wide.load660, ptr %next.gep658, align 1, !tbaa !7
  %index.next661 = add nuw i64 %index657, 4       ; 2 uses
  %i.pm = icmp eq i64 %index.next661, %n.vec655
  br i1 %i.pm, label %vec.epilog.middle.block662, label %vec.epilog.vector.body656, !llvm.loop !189
...
.lr.ph263:                                        ; preds = %.lr.ph263.preheader, %.lr.ph263
  ...
  %i.po = load i8, ptr %.5367.i.i260, align 1, !tbaa !7
  %i.pp = getelementptr inbounds nuw i8, ptr %.16.i.i261, i64 1 ; 2 uses
  store i8 %i.po, ptr %.16.i.i261, align 1, !tbaa !7
  %i.pq = icmp ult ptr %i.pp, %i.li
  br i1 %i.pq, label %.lr.ph263, label %.preheader187, !llvm.loop !190
...
vector.body598:                                   ; preds = %vector.body598, %vector.ph595
  ...
  br i1 %i.qk, label %middle.block605, label %vector.body598, !llvm.loop !191
...
scalar.ph593:                                     ; preds = %scalar.ph593.preheader, %scalar.ph593
  ...
  br i1 %i.qn, label %scalar.ph593, label %.preheader187, !llvm.loop !192
...
.preheader187:                                    ; preds = %scalar.ph593, %.lr.ph263, %.lr.ph266, %bb.bp, %bb.bo, %vec.epilog.middle.block662, %middle.block644, %middle.block605, %bb.bf, %bb.bh, %vec.epilog.middle.block701, %middle.block683, %bb.n
  ...
  %i.qp = load i8, ptr %.3.ph, align 1, !tbaa !7
...
bb.br:                                            ; preds = %LZ4_decompress_safe_doubleDict.exit
  ...
  %i.qy = load i64, ptr %i.a, align 8, !tbaa !169
  %i.qz = add i64 %i.qy, %i.qx
  store i64 %i.qz, ptr %i.a, align 8, !tbaa !169
  %i.ra = load ptr, ptr %i.i, align 8, !tbaa !171
  %i.rb = getelementptr inbounds nuw i8, ptr %i.ra, i64 %i.qx
  store ptr %i.rb, ptr %i.i, align 8, !tbaa !171
  br label %LZ4_decompress_safe_doubleDict.exit.thread

bb.bs:                                            ; preds = %bb.d
  %i.rc = getelementptr inbounds nuw i8, ptr %0, i64 16
  store i64 %i.b, ptr %i.rc, align 8, !tbaa !173
  %i.rd = sub i64 0, %i.b
  %i.re = getelementptr inbounds i8, ptr %i.j, i64 %i.rd ; 2 uses
  store ptr %i.re, ptr %0, align 8, !tbaa !172
...
bb.bt:                                            ; preds = %bb.bs
  ...
  store i64 %i.rh, ptr %i.a, align 8, !tbaa !169
  %i.ri = getelementptr inbounds nuw i8, ptr %2, i64 %i.rh
  store ptr %i.ri, ptr %i.i, align 8, !tbaa !171
  br label %LZ4_decompress_safe_doubleDict.exit.thread
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.k = icmp eq i32 %3, 0
  br i1 %i.k, label %bb.c, label %bb.e, !prof !19
...
bb.d:                                             ; preds = %bb.c
  %i.m = load i8, ptr %0, align 1, !tbaa !7
...
bb.e:                                             ; preds = %bb.b
  %i.p = icmp eq i32 %2, 0
  br i1 %i.p, label %LZ4_decompress_generic.exit, label %bb.f, !prof !19
...
.backedge:                                        ; preds = %.backedge.backedge, %.preheader131
  ...
  %i.y = load i8, ptr %.0, align 1, !tbaa !7
...
.preheader129:                                    ; preds = %bb.h, %bb.i
  ...
  br i1 %i.ag, label %LZ4_wildCopy32.exit.thread, label %bb.i, !prof !19

bb.i:                                             ; preds = %.preheader129
  %i.ah = load i8, ptr %.10, align 1, !tbaa !7    ; 2 uses
  %i.ai = zext i8 %i.ah to i64
  %i.aj = add i64 %.0.i12, %i.ai                  ; 3 uses
  %i.ak = icmp eq i8 %i.ah, -1
  br i1 %i.ak, label %.preheader129, label %read_variable_length.exit, !llvm.loop !81
...
.preheader128:                                    ; preds = %bb.j, %.preheader128
  ...
  br i1 %i.bb, label %.preheader128, label %LZ4_wildCopy32.exit.thread72, !llvm.loop !83
...
LZ4_wildCopy32.exit.thread72:                     ; preds = %.preheader128, %bb.l
  ...
  %.val33 = load i16, ptr %.1, align 1, !tbaa !26 ; 5 uses
...
bb.m:                                             ; preds = %LZ4_wildCopy32.exit.thread72
  ...
  br i1 %i.bl, label %LZ4_wildCopy32.exit.thread, label %bb.n, !prof !19

bb.n:                                             ; preds = %bb.m
  %i.bm = load i8, ptr %i.bf, align 1, !tbaa !7   ; 2 uses
  %i.bn = zext i8 %i.bm to i64
...
.preheader126:                                    ; preds = %bb.n, %bb.o
  ...
  br i1 %i.bp, label %LZ4_wildCopy32.exit.thread, label %bb.o, !prof !19

bb.o:                                             ; preds = %.preheader126
  %i.bq = load i8, ptr %.12, align 1, !tbaa !7    ; 2 uses
  %i.br = zext i8 %i.bq to i64
  %i.bs = add i64 %.0.i15, %i.br                  ; 3 uses
  %i.bt = icmp eq i8 %i.bq, -1
  br i1 %i.bt, label %.preheader126, label %read_variable_length.exit16, !llvm.loop !81
...
read_variable_length.exit16.thread80:             ; preds = %bb.n, %read_variable_length.exit16
  ...
  br i1 %i.by, label %LZ4_wildCopy32.exit.thread, label %bb.p, !prof !19
...
.thread88:                                        ; preds = %bb.p, %bb.r
  ...
  br i1 %i.cl, label %LZ4_wildCopy32.exit.thread, label %bb.t, !prof !84

bb.t:                                             ; preds = %.thread88
  %i.cm = getelementptr inbounds nuw i8, ptr %.2.i, i64 %.2374.i ; 9 uses
  %i.cn = icmp ult i16 %.val33, 16
  br i1 %i.cn, label %bb.u, label %.preheader124, !prof !19
...
bb.v:                                             ; preds = %bb.u
  %i.co = load i8, ptr %i.bh, align 1, !tbaa !7
...
bb.z:                                             ; preds = %bb.y
  store i32 0, ptr %.2.i, align 1, !tbaa !15
  %i.cr = load i8, ptr %i.bh, align 1, !tbaa !7
  store i8 %i.cr, ptr %.2.i, align 1, !tbaa !7
  ...
  store i8 %i.ct, ptr %i.cu, align 1, !tbaa !7
  ...
  store i8 %i.cz, ptr %i.da, align 1, !tbaa !7
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.ed, label %middle.block, label %vector.body, !llvm.loop !193
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  br i1 %i.eh, label %scalar.ph, label %.backedge.backedge, !llvm.loop !194
...
vector.body425:                                   ; preds = %vector.body425, %vector.ph422
  ...
  br i1 %i.ew, label %middle.block431, label %vector.body425, !llvm.loop !195
...
.lr.ph:                                           ; preds = %.lr.ph.preheader556, %.lr.ph
  ...
  br i1 %i.ex, label %.lr.ph, label %.backedge.backedge, !llvm.loop !196
...
.preheader124:                                    ; preds = %bb.t, %.preheader124
  ...
  br i1 %i.fc, label %.preheader124, label %.backedge.backedge, !llvm.loop !83
...
.lr.ph184:                                        ; preds = %.preheader122, %bb.ae
  ...
  br i1 %i.fi, label %bb.ad, label %LZ4_wildCopy32.exit, !prof !28
...
bb.ad:                                            ; preds = %.lr.ph184
  ...
  %.val = load i16, ptr %i.fk, align 1, !tbaa !26 ; 2 uses
...
bb.ae:                                            ; preds = %bb.ad
  ...
  %i.gd = load i8, ptr %i.fo, align 1, !tbaa !7
...
.preheader121:                                    ; preds = %bb.af, %bb.ag
  ...
  br i1 %i.gk, label %LZ4_wildCopy32.exit.thread, label %bb.ag, !prof !19

bb.ag:                                            ; preds = %.preheader121
  %i.gl = load i8, ptr %.14, align 1, !tbaa !7    ; 2 uses
  %i.gm = zext i8 %i.gl to i64
  %i.gn = add i64 %.0.i20, %i.gm                  ; 3 uses
  %i.go = icmp eq i8 %i.gl, -1
  br i1 %i.go, label %.preheader121, label %read_variable_length.exit21, !llvm.loop !81
...
read_variable_length.exit21.thread95:             ; preds = %bb.af, %read_variable_length.exit21
  ...
  br i1 %or.cond113, label %LZ4_wildCopy32.exit.thread, label %LZ4_wildCopy32.exit, !prof !82
...
vector.body444:                                   ; preds = %vector.body444, %vector.ph441
  ...
  br i1 %i.hr, label %middle.block451, label %vector.body444, !llvm.loop !197
...
bb.ai:                                            ; preds = %bb.ah, %LZ4_wildCopy32.exit
  ...
  %or.cond458.i = select i1 %.not440.i, i1 true, i1 %i.ht
  br i1 %or.cond458.i, label %LZ4_wildCopy32.exit.thread, label %bb.aj
...
.preheader120:                                    ; preds = %.preheader120.preheader527, %.preheader120
  ...
  br i1 %i.ia, label %.preheader120, label %LZ4_wildCopy8.exit11, !llvm.loop !198

LZ4_wildCopy8.exit11:                             ; preds = %.preheader120, %middle.block451
  %.val32 = load i16, ptr %i.ha, align 1, !tbaa !26
...
bb.ak:                                            ; preds = %.loopexit
  ...
  br i1 %i.ik, label %LZ4_wildCopy32.exit.thread, label %bb.al, !prof !19

bb.al:                                            ; preds = %bb.ak
  %i.il = load i8, ptr %.5, align 1, !tbaa !7     ; 2 uses
...
.preheader119:                                    ; preds = %bb.al, %bb.am
  ...
  br i1 %i.io, label %LZ4_wildCopy32.exit.thread, label %bb.am, !prof !19

bb.am:                                            ; preds = %.preheader119
  %i.ip = load i8, ptr %.16, align 1, !tbaa !7    ; 2 uses
  %i.iq = zext i8 %i.ip to i64
  %i.ir = add i64 %.0.i24, %i.iq                  ; 2 uses
  %i.is = icmp eq i8 %i.ip, -1
  br i1 %i.is, label %.preheader119, label %read_variable_length.exit25, !llvm.loop !81
...
.loopexit134:                                     ; preds = %bb.p, %bb.q, %bb.an
  ...
  br i1 %i.iz, label %LZ4_wildCopy32.exit.thread, label %bb.ao, !prof !84
...
bb.ao:                                            ; preds = %.loopexit134
  ...
  br i1 %i.jc, label %bb.ap, label %bb.aq, !prof !19

bb.ap:                                            ; preds = %bb.ao
  store i32 0, ptr %.10.i, align 1, !tbaa !15
  %i.jd = load i8, ptr %.1363.i, align 1, !tbaa !7
  store i8 %i.jd, ptr %.10.i, align 1, !tbaa !7
...
begin_hunk_10_@LZ4_decompress_safe_withSmallPrefix:bb.a
  ...
  br i1 %i.kw, label %middle.block489, label %vector.body482, !llvm.loop !199
...
.preheader:                                       ; preds = %.preheader.preheader523, %.preheader
  ...
  br i1 %i.la, label %.preheader, label %LZ4_wildCopy8.exit, !llvm.loop !200
...
vector.body501:                                   ; preds = %vector.body501, %vector.ph498
  ...
  %wide.load505 = load <16 x i8>, ptr %next.gep504, align 1, !tbaa !7
  %wide.load506 = load <16 x i8>, ptr %i.lp, align 1, !tbaa !7
  %i.lq = getelementptr i8, ptr %next.gep503, i64 16
  store <16 x i8> %wide.load505, ptr %next.gep503, align 1, !tbaa !7
  store <16 x i8> %wide.load506, ptr %i.lq, align 1, !tbaa !7
  %index.next507 = add nuw i64 %index502, 32      ; 2 uses
  %i.lr = icmp eq i64 %index.next507, %n.vec500
  br i1 %i.lr, label %middle.block508, label %vector.body501, !llvm.loop !201
...
vec.epilog.iter.check:                            ; preds = %middle.block508
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph191.preheader, label %vec.epilog.ph, !prof !94
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load517 = load <4 x i8>, ptr %next.gep516, align 1, !tbaa !7
  store <4 x i8> %wide.load517, ptr %next.gep515, align 1, !tbaa !7
  %index.next518 = add nuw i64 %index514, 4       ; 2 uses
  %i.lu = icmp eq i64 %index.next518, %n.vec513
  br i1 %i.lu, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !202
...
.lr.ph191:                                        ; preds = %.lr.ph191.preheader, %.lr.ph191
  ...
  %i.lw = load i8, ptr %.5367.i188, align 1, !tbaa !7
  %i.lx = getelementptr inbounds nuw i8, ptr %.16.i189, i64 1 ; 2 uses
  store i8 %i.lw, ptr %.16.i189, align 1, !tbaa !7
  %i.ly = icmp ult ptr %i.lx, %i.ja
  br i1 %i.ly, label %.lr.ph191, label %.preheader122, !llvm.loop !203
...
vector.body464:                                   ; preds = %vector.body464, %vector.ph461
  ...
  br i1 %i.ms, label %middle.block471, label %vector.body464, !llvm.loop !204
...
scalar.ph459:                                     ; preds = %scalar.ph459.preheader, %scalar.ph459
  ...
  br i1 %i.mv, label %scalar.ph459, label %.preheader122, !llvm.loop !205
...
.preheader122:                                    ; preds = %scalar.ph459, %.lr.ph191, %bb.av, %bb.au, %vec.epilog.middle.block, %middle.block508, %middle.block471, %bb.f
  ...
  %i.mx = load i8, ptr %.3.ph, align 1, !tbaa !7
...
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 24 ; 5 uses
  %i.b = load i64, ptr %i.a, align 8, !tbaa !169  ; 5 uses
  %i.c = icmp eq i64 %i.b, 0
...
.thread.i:                                        ; preds = %._crit_edge.i, %bb.b
  ...
  %i.i = load i8, ptr %.0.i53, align 1, !tbaa !7
...
.preheader34.i:                                   ; preds = %.thread.i, %.preheader34.i
  ...
  br i1 %i.s, label %.preheader34.i, label %read_long_length_no_check.exit.i, !llvm.loop !110
...
bb.f:                                             ; preds = %bb.d
  ...
  %.val.i = load i16, ptr %i.y, align 1, !tbaa !26 ; 2 uses
...
.preheader.i:                                     ; preds = %bb.f, %.preheader.i
  ...
  br i1 %i.an, label %.preheader.i, label %read_long_length_no_check.exit5.i, !llvm.loop !110
...
vector.body259:                                   ; preds = %vector.body259, %vector.ph256
  ...
  %i.aw = getelementptr inbounds nuw i8, ptr %i.av, i64 16
  %wide.load261 = load <16 x i8>, ptr %i.av, align 1, !tbaa !7
  %wide.load262 = load <16 x i8>, ptr %i.aw, align 1, !tbaa !7
  %i.ax = getelementptr inbounds nuw i8, ptr %i.x, i64 %index260 ; 2 uses
  %i.ay = getelementptr inbounds nuw i8, ptr %i.ax, i64 16
  store <16 x i8> %wide.load261, ptr %i.ax, align 1, !tbaa !7
  store <16 x i8> %wide.load262, ptr %i.ay, align 1, !tbaa !7
  %index.next263 = add nuw i64 %index260, 32      ; 2 uses
  %i.az = icmp eq i64 %index.next263, %n.vec258
  br i1 %i.az, label %middle.block264, label %vector.body259, !llvm.loop !206
...
vec.epilog.iter.check269:                         ; preds = %middle.block264
  ...
  br i1 %min.epilog.iters.check270, label %.lr.ph.i.preheader, label %vec.epilog.ph271, !prof !94
...
vec.epilog.vector.body274:                        ; preds = %vec.epilog.vector.body274, %vec.epilog.ph271
  ...
  %wide.load276 = load <4 x i8>, ptr %i.ba, align 1, !tbaa !7
  %i.bb = getelementptr inbounds nuw i8, ptr %i.x, i64 %index275
  store <4 x i8> %wide.load276, ptr %i.bb, align 1, !tbaa !7
  %index.next277 = add nuw i64 %index275, 4       ; 2 uses
  %i.bc = icmp eq i64 %index.next277, %n.vec273
  br i1 %i.bc, label %vec.epilog.middle.block278, label %vec.epilog.vector.body274, !llvm.loop !207
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader, %.lr.ph.i.prol
  ...
  store i8 %i.bg, ptr %i.bh, align 1, !tbaa !7
  ...
  br i1 %prol.iter307.cmp.not, label %.lr.ph.i.prol.loopexit, label %.lr.ph.i.prol, !llvm.loop !208
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.ih, align 1, !tbaa !7
  %wide.load212 = load <16 x i8>, ptr %i.ii, align 1, !tbaa !7
  %i.ij = getelementptr inbounds nuw i8, ptr %.383.i.i, i64 %index ; 2 uses
  %i.ik = getelementptr inbounds nuw i8, ptr %i.ij, i64 16
  store <16 x i8> %wide.load, ptr %i.ij, align 1, !tbaa !7
  store <16 x i8> %wide.load212, ptr %i.ik, align 1, !tbaa !7
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.il = icmp eq i64 %index.next, %n.vec
  br i1 %i.il, label %middle.block, label %vector.body, !llvm.loop !214
...
vec.epilog.iter.check:                            ; preds = %middle.block
  %min.epilog.iters.check = icmp eq i64 %n.mod.vf, 0
  br i1 %min.epilog.iters.check, label %.lr.ph.i69.preheader, label %vec.epilog.ph, !prof !94
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load216 = load <4 x i8>, ptr %i.im, align 1, !tbaa !7
  %i.in = getelementptr inbounds nuw i8, ptr %.383.i.i, i64 %index215
  store <4 x i8> %wide.load216, ptr %i.in, align 1, !tbaa !7
  %index.next217 = add nuw i64 %index215, 4       ; 2 uses
  %i.io = icmp eq i64 %index.next217, %n.vec214
  br i1 %i.io, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !215
...
.lr.ph.i69.prol:                                  ; preds = %.lr.ph.i69.preheader, %.lr.ph.i69.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i69.prol.loopexit, label %.lr.ph.i69.prol, !llvm.loop !216
...
.lr.ph.i69:                                       ; preds = %.lr.ph.i69.prol.loopexit, %.lr.ph.i69
  ...
  %i.ja = load i8, ptr %i.iz, align 1, !tbaa !7
  %i.jb = getelementptr inbounds nuw i8, ptr %.383.i.i, i64 %i.iy
  store i8 %i.ja, ptr %i.jb, align 1, !tbaa !7
  ...
  br i1 %exitcond.not.i70.3, label %._crit_edge.i71, label %.lr.ph.i69, !llvm.loop !217
...
bb.al:                                            ; preds = %LZ4_decompress_fast_extDict.exit
  store i64 %i.gk, ptr %i.a, align 8, !tbaa !169
  store ptr %i.gl, ptr %i.ck, align 8, !tbaa !171
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %i.o, label %LZ4_decompress_safe_partial_withPrefix64k.exit, label %bb.g, !prof !19

bb.g:                                             ; preds = %bb.f
  %i.p = icmp eq i32 %2, 0
  br i1 %i.p, label %LZ4_decompress_safe_partial_withPrefix64k.exit, label %bb.h, !prof !19
...
.backedge.i:                                      ; preds = %.backedge.i.backedge, %.preheader156.i
  ...
  %i.aa = load i8, ptr %.0.i, align 1, !tbaa !7
  %i.ab = zext i8 %i.aa to i32                    ; 4 uses
  %i.ac = lshr i32 %i.ab, 4                       ; 2 uses
  %i.ad = zext nneg i32 %i.ac to i64              ; 3 uses
  %i.ae = icmp eq i32 %i.ac, 15
...
.preheader154.i:                                  ; preds = %bb.j, %bb.k
  ...
  %i.ai = icmp ugt ptr %i.ah, %i.t
  br i1 %i.ai, label %LZ4_wildCopy32.exit.thread.i, label %bb.k, !prof !19

bb.k:                                             ; preds = %.preheader154.i
  %i.aj = load i8, ptr %.11.i, align 1, !tbaa !7  ; 2 uses
  %i.ak = zext i8 %i.aj to i64
  %i.al = add i64 %.0.i15.i, %i.ak                ; 3 uses
  %i.am = icmp eq i8 %i.aj, -1
  br i1 %i.am, label %.preheader154.i, label %read_variable_length.exit.i, !llvm.loop !81
...
read_variable_length.exit.thread66.i:             ; preds = %read_variable_length.exit.i, %bb.j
  ...
  br i1 %or.cond.i, label %LZ4_wildCopy32.exit.thread.i, label %bb.l, !prof !82
...
.preheader153.i:                                  ; preds = %bb.l, %.preheader153.i
  ...
  br i1 %i.bc, label %.preheader153.i, label %LZ4_wildCopy32.exit.thread75.i, !llvm.loop !83
...
LZ4_wildCopy32.exit.thread75.i:                   ; preds = %.preheader153.i, %bb.n
  ...
  %.val36.i = load i16, ptr %.1.i, align 1, !tbaa !26 ; 5 uses
...
bb.o:                                             ; preds = %LZ4_wildCopy32.exit.thread75.i
  ...
  br i1 %i.bj, label %LZ4_wildCopy32.exit.thread.i, label %bb.p, !prof !19

bb.p:                                             ; preds = %bb.o
  %i.bk = load i8, ptr %i.bf, align 1, !tbaa !7   ; 2 uses
  %i.bl = zext i8 %i.bk to i64
...
.preheader151.i:                                  ; preds = %bb.p, %bb.q
  ...
  br i1 %i.bn, label %LZ4_wildCopy32.exit.thread.i, label %bb.q, !prof !19

bb.q:                                             ; preds = %.preheader151.i
  %i.bo = load i8, ptr %.13.i, align 1, !tbaa !7  ; 2 uses
  %i.bp = zext i8 %i.bo to i64
  %i.bq = add i64 %.0.i18.i, %i.bp                ; 3 uses
  %i.br = icmp eq i8 %i.bo, -1
  br i1 %i.br, label %.preheader151.i, label %read_variable_length.exit19.i, !llvm.loop !81
...
read_variable_length.exit19.thread83.i:           ; preds = %read_variable_length.exit19.i, %bb.p
  ...
  %i.bv = xor i64 %i.bu, -1
  %i.bw = icmp ugt i64 %i.bt, %i.bv
  br i1 %i.bw, label %LZ4_wildCopy32.exit.thread.i, label %bb.r, !prof !19
...
.thread91.i:                                      ; preds = %bb.t, %bb.r
  ...
  br i1 %i.cg, label %LZ4_wildCopy32.exit.thread.i, label %bb.v, !prof !84
...
bb.v:                                             ; preds = %.thread91.i
  ...
  br i1 %i.ch, label %bb.w, label %.preheader149.i, !prof !19
...
bb.x:                                             ; preds = %bb.w
  %i.ci = load i8, ptr %.ptr.ptr.i, align 1, !tbaa !7
...
bb.ab:                                            ; preds = %bb.aa
  store i32 0, ptr %.2.i.ptr.ptr.i, align 1, !tbaa !15
  %i.cl = load i8, ptr %.ptr.ptr.i, align 1, !tbaa !7
  store i8 %i.cl, ptr %.2.i.ptr.ptr.i, align 1, !tbaa !7
...
vector.body728:                                   ; preds = %vector.body728, %vector.ph725
  ...
  br i1 %i.dy, label %middle.block735, label %vector.body728, !llvm.loop !218
...
scalar.ph723:                                     ; preds = %scalar.ph723.preheader, %scalar.ph723
  ...
  br i1 %i.ec, label %scalar.ph723, label %.backedge.i.backedge, !llvm.loop !219
...
vector.body746:                                   ; preds = %vector.body746, %vector.ph741
  ...
  br i1 %i.es, label %middle.block753, label %vector.body746, !llvm.loop !220
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  ...
  br i1 %i.et, label %.lr.ph.i, label %.backedge.i.backedge, !llvm.loop !221
...
.preheader149.i:                                  ; preds = %bb.v, %.preheader149.i
  ...
  br i1 %i.ey, label %.preheader149.i, label %.backedge.i.backedge, !llvm.loop !83
...
bb.af:                                            ; preds = %.lr.ph210.i, %bb.ah
  ...
  %i.fe = and i1 %i.fc, %i.fd
  br i1 %i.fe, label %bb.ag, label %LZ4_wildCopy32.exit.i, !prof !28
...
bb.ag:                                            ; preds = %bb.af
  ...
  %.val.i = load i16, ptr %i.ff, align 1, !tbaa !26 ; 2 uses
...
bb.ah:                                            ; preds = %bb.ag
  ...
  %i.fu = load i8, ptr %i.fj, align 1, !tbaa !7
...
.preheader145.i:                                  ; preds = %bb.ai, %bb.aj
  ...
  br i1 %i.gb, label %LZ4_wildCopy32.exit.thread.i, label %bb.aj, !prof !19

bb.aj:                                            ; preds = %.preheader145.i
  %i.gc = load i8, ptr %.15.i, align 1, !tbaa !7  ; 2 uses
  %i.gd = zext i8 %i.gc to i64
  %i.ge = add i64 %.0.i23.i, %i.gd                ; 3 uses
  %i.gf = icmp eq i8 %i.gc, -1
  br i1 %i.gf, label %.preheader145.i, label %read_variable_length.exit24.i, !llvm.loop !81
...
read_variable_length.exit24.thread98.i:           ; preds = %read_variable_length.exit24.i, %bb.ai
  ...
  br i1 %or.cond119.i, label %LZ4_wildCopy32.exit.thread.i, label %LZ4_wildCopy32.exit.i, !prof !82
...
vector.body765:                                   ; preds = %vector.body765, %vector.ph762
  ...
  br i1 %i.hl, label %middle.block772, label %vector.body765, !llvm.loop !222
...
bb.am:                                            ; preds = %bb.al
  ...
  %or.cond460.i.i = select i1 %i.hu, i1 %.not441.i.i, i1 false
  br i1 %or.cond460.i.i, label %LZ4_wildCopy8.exit14.i, label %bb.az
...
.preheader144.i:                                  ; preds = %.preheader144.i.preheader838, %.preheader144.i
  ...
  br i1 %i.hz, label %.preheader144.i, label %LZ4_wildCopy8.exit14.i, !llvm.loop !223
...
bb.an:                                            ; preds = %.loopexit147.i
  ...
  br i1 %i.ih, label %LZ4_wildCopy32.exit.thread.i, label %bb.ao, !prof !19

bb.ao:                                            ; preds = %bb.an
  %i.ii = load i8, ptr %.6.i, align 1, !tbaa !7   ; 2 uses
...
.preheader143.i:                                  ; preds = %bb.ao, %bb.ap
  ...
  br i1 %i.il, label %LZ4_wildCopy32.exit.thread.i, label %bb.ap, !prof !19

bb.ap:                                            ; preds = %.preheader143.i
  %i.im = load i8, ptr %.17.i, align 1, !tbaa !7  ; 2 uses
  %i.in = zext i8 %i.im to i64
  %i.io = add i64 %.0.i27.i, %i.in                ; 2 uses
  %i.ip = icmp eq i8 %i.im, -1
  br i1 %i.ip, label %.preheader143.i, label %read_variable_length.exit28.i, !llvm.loop !81
...
.loopexit159.i:                                   ; preds = %bb.s, %bb.r, %bb.aq
  ...
  br i1 %i.iw, label %LZ4_wildCopy32.exit.thread.i, label %bb.ar, !prof !84
...
begin_hunk_12_@LZ4_decompress_safe_partial_usingDict:bb.a
  ...
  %wide.load809 = load <16 x i8>, ptr %next.gep808, align 1, !tbaa !7
  %wide.load810 = load <16 x i8>, ptr %i.jl, align 1, !tbaa !7
  %i.jm = getelementptr i8, ptr %next.gep807, i64 16
  store <16 x i8> %wide.load809, ptr %next.gep807, align 1, !tbaa !7
  store <16 x i8> %wide.load810, ptr %i.jm, align 1, !tbaa !7
  %index.next811 = add nuw i64 %index806, 32      ; 2 uses
  %i.jn = icmp eq i64 %index.next811, %n.vec804
  br i1 %i.jn, label %middle.block812, label %vector.body805, !llvm.loop !224
...
vec.epilog.iter.check819:                         ; preds = %middle.block812
  ...
  br i1 %min.epilog.iters.check820, label %.lr.ph217.i.preheader, label %vec.epilog.ph821, !prof !94
...
vec.epilog.vector.body824:                        ; preds = %vec.epilog.vector.body824, %vec.epilog.ph821
  ...
  %wide.load828 = load <4 x i8>, ptr %next.gep827, align 1, !tbaa !7
  store <4 x i8> %wide.load828, ptr %next.gep826, align 1, !tbaa !7
  %index.next829 = add nuw i64 %index825, 4       ; 2 uses
  %i.jq = icmp eq i64 %index.next829, %n.vec823
  br i1 %i.jq, label %vec.epilog.middle.block830, label %vec.epilog.vector.body824, !llvm.loop !225
...
.lr.ph217.i:                                      ; preds = %.lr.ph217.i.preheader, %.lr.ph217.i
  ...
  %i.js = load i8, ptr %.2364.i215.i, align 1, !tbaa !7
  %i.jt = getelementptr inbounds nuw i8, ptr %.14.i216.i, i64 1 ; 2 uses
  store i8 %i.js, ptr %.14.i216.i, align 1, !tbaa !7
  %i.ju = icmp ult ptr %i.jt, %.ptr141.i
  br i1 %i.ju, label %.lr.ph217.i, label %.loopexit.i, !llvm.loop !226
...
bb.au:                                            ; preds = %bb.ar
  ...
  br i1 %i.jw, label %bb.av, label %bb.aw, !prof !19

bb.av:                                            ; preds = %bb.au
  store i32 0, ptr %.10.i.ptr.i, align 1, !tbaa !15
  %i.jx = load i8, ptr %.1363.i.ptr.i, align 1, !tbaa !7
  store i8 %i.jx, ptr %.10.i.ptr.i, align 1, !tbaa !7
  ...
  store i8 %i.jz, ptr %i.ka, align 1, !tbaa !7
  ...
  store i8 %i.kf, ptr %i.kg, align 1, !tbaa !7
...
vector.body784:                                   ; preds = %vector.body784, %vector.ph781
  ...
  br i1 %i.ls, label %middle.block791, label %vector.body784, !llvm.loop !227
...
scalar.ph779:                                     ; preds = %scalar.ph779.preheader, %scalar.ph779
  ...
  br i1 %i.lv, label %scalar.ph779, label %.preheader146.i, !llvm.loop !228
...
.preheader146.i:                                  ; preds = %scalar.ph779, %bb.ax, %middle.block791, %.loopexit.i, %bb.h
  ...
  %i.lx = load i8, ptr %.3.ph.i, align 1, !tbaa !7
...
bb.bb:                                            ; preds = %bb.ba
  ...
  br i1 %i.ms, label %LZ4_decompress_safe_partial_withPrefix64k.exit, label %bb.bc, !prof !19

bb.bc:                                            ; preds = %bb.bb
  %i.mt = icmp eq i32 %2, 0
  br i1 %i.mt, label %LZ4_decompress_safe_partial_withPrefix64k.exit, label %bb.bd, !prof !19
...
.backedge.i75:                                    ; preds = %.backedge.i75.backedge, %.preheader139.i
  ...
  %i.nd = load i8, ptr %.0.i31, align 1, !tbaa !7
...
.preheader137.i:                                  ; preds = %bb.bf, %bb.bg
  ...
  br i1 %i.nl, label %LZ4_wildCopy32.exit.thread.i55, label %bb.bg, !prof !19

bb.bg:                                            ; preds = %.preheader137.i
  %i.nm = load i8, ptr %.11.i99, align 1, !tbaa !7 ; 2 uses
  %i.nn = zext i8 %i.nm to i64
  %i.no = add i64 %.0.i16.i, %i.nn                ; 3 uses
  %i.np = icmp eq i8 %i.nm, -1
  br i1 %i.np, label %.preheader137.i, label %read_variable_length.exit.i100, !llvm.loop !81
...
read_variable_length.exit.thread67.i:             ; preds = %read_variable_length.exit.i100, %bb.bf
  ...
  br i1 %or.cond.i96, label %LZ4_wildCopy32.exit.thread.i55, label %bb.bh, !prof !82
...
.preheader136.i:                                  ; preds = %bb.bh, %.preheader136.i
  ...
  br i1 %i.og, label %.preheader136.i, label %LZ4_wildCopy32.exit.thread76.i, !llvm.loop !83
...
LZ4_wildCopy32.exit.thread76.i:                   ; preds = %.preheader136.i, %bb.bj
  ...
  %.val37.i = load i16, ptr %.1.i33, align 1, !tbaa !26 ; 5 uses
...
bb.bk:                                            ; preds = %LZ4_wildCopy32.exit.thread76.i
  ...
  br i1 %i.oq, label %LZ4_wildCopy32.exit.thread.i55, label %bb.bl, !prof !19

bb.bl:                                            ; preds = %bb.bk
  %i.or = load i8, ptr %i.ok, align 1, !tbaa !7   ; 2 uses
...
.preheader134.i:                                  ; preds = %bb.bl, %bb.bm
  ...
  br i1 %i.ou, label %LZ4_wildCopy32.exit.thread.i55, label %bb.bm, !prof !19

bb.bm:                                            ; preds = %.preheader134.i
  %i.ov = load i8, ptr %.13.i93, align 1, !tbaa !7 ; 2 uses
  %i.ow = zext i8 %i.ov to i64
  %i.ox = add i64 %.0.i19.i, %i.ow                ; 3 uses
  %i.oy = icmp eq i8 %i.ov, -1
  br i1 %i.oy, label %.preheader134.i, label %read_variable_length.exit20.i, !llvm.loop !81
...
read_variable_length.exit20.thread84.i:           ; preds = %read_variable_length.exit20.i, %bb.bl
  ...
  br i1 %i.pd, label %LZ4_wildCopy32.exit.thread.i55, label %bb.bn, !prof !19
...
.thread92.i:                                      ; preds = %bb.bp, %bb.bn
  ...
  br i1 %i.pq, label %LZ4_wildCopy32.exit.thread.i55, label %bb.br, !prof !84

bb.br:                                            ; preds = %.thread92.i
  %i.pr = getelementptr inbounds nuw i8, ptr %.2.i.i, i64 %.2374.i.i74 ; 9 uses
  %i.ps = icmp ult i16 %.val37.i, 16
  br i1 %i.ps, label %bb.bs, label %.preheader132.i, !prof !19
...
bb.bt:                                            ; preds = %bb.bs
  %i.pt = load i8, ptr %i.om, align 1, !tbaa !7
...
bb.bx:                                            ; preds = %bb.bw
  store i32 0, ptr %.2.i.i, align 1, !tbaa !15
  %i.pw = load i8, ptr %i.om, align 1, !tbaa !7
  store i8 %i.pw, ptr %.2.i.i, align 1, !tbaa !7
  ...
  store i8 %i.py, ptr %i.pz, align 1, !tbaa !7
  ...
  store i8 %i.qb, ptr %i.qc, align 1, !tbaa !7
  %i.qd = getelementptr inbounds nuw i8, ptr %i.om, i64 3
  %i.qe = load i8, ptr %i.qd, align 1, !tbaa !7
  %i.qf = getelementptr inbounds nuw i8, ptr %.2.i.i, i64 3
  store i8 %i.qe, ptr %i.qf, align 1, !tbaa !7
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.ri, label %middle.block, label %vector.body, !llvm.loop !229
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  br i1 %i.rm, label %scalar.ph, label %.backedge.i75.backedge, !llvm.loop !230
...
vector.body640:                                   ; preds = %vector.body640, %vector.ph637
  ...
  br i1 %i.sb, label %middle.block646, label %vector.body640, !llvm.loop !231
...
.lr.ph.i81:                                       ; preds = %.lr.ph.i81.preheader, %.lr.ph.i81
  ...
  br i1 %i.sc, label %.lr.ph.i81, label %.backedge.i75.backedge, !llvm.loop !232
...
.preheader132.i:                                  ; preds = %bb.br, %.preheader132.i
  ...
  br i1 %i.sh, label %.preheader132.i, label %.backedge.i75.backedge, !llvm.loop !83
...
.lr.ph192.i:                                      ; preds = %.preheader129.i, %bb.cc
  ...
  br i1 %i.sn, label %bb.cb, label %LZ4_wildCopy32.exit.i42, !prof !28
...
bb.cb:                                            ; preds = %.lr.ph192.i
  ...
  %.val.i65 = load i16, ptr %i.sp, align 1, !tbaa !26 ; 2 uses
...
bb.cc:                                            ; preds = %bb.cb
  ...
  %i.ti = load i8, ptr %i.st, align 1, !tbaa !7
...
.preheader128.i:                                  ; preds = %bb.cd, %bb.ce
  ...
  br i1 %i.tp, label %LZ4_wildCopy32.exit.thread.i55, label %bb.ce, !prof !19

bb.ce:                                            ; preds = %.preheader128.i
  %i.tq = load i8, ptr %.15.i69, align 1, !tbaa !7 ; 2 uses
  %i.tr = zext i8 %i.tq to i64
  %i.ts = add i64 %.0.i24.i, %i.tr                ; 3 uses
  %i.tt = icmp eq i8 %i.tq, -1
  br i1 %i.tt, label %.preheader128.i, label %read_variable_length.exit25.i, !llvm.loop !81
...
read_variable_length.exit25.thread99.i:           ; preds = %read_variable_length.exit25.i, %bb.cd
  ...
  br i1 %or.cond121.i, label %LZ4_wildCopy32.exit.thread.i55, label %LZ4_wildCopy32.exit.i42, !prof !82
...
vector.body659:                                   ; preds = %vector.body659, %vector.ph656
  ...
  br i1 %i.uw, label %middle.block666, label %vector.body659, !llvm.loop !233
...
bb.ch:                                            ; preds = %bb.cg
  ...
  %or.cond460.i.i63 = select i1 %i.vj, i1 %.not441.i.i62, i1 false
  br i1 %or.cond460.i.i63, label %LZ4_wildCopy8.exit15.i, label %bb.cu
...
.preheader127.i:                                  ; preds = %.preheader127.i.preheader892, %.preheader127.i
  ...
  br i1 %i.vo, label %.preheader127.i, label %LZ4_wildCopy8.exit15.i, !llvm.loop !234
...
bb.ci:                                            ; preds = %.loopexit130.i
  ...
  br i1 %i.vy, label %LZ4_wildCopy32.exit.thread.i55, label %bb.cj, !prof !19

bb.cj:                                            ; preds = %bb.ci
  %i.vz = load i8, ptr %.6.i48, align 1, !tbaa !7 ; 2 uses
...
.preheader126.i:                                  ; preds = %bb.cj, %bb.ck
  ...
  br i1 %i.wc, label %LZ4_wildCopy32.exit.thread.i55, label %bb.ck, !prof !19

bb.ck:                                            ; preds = %.preheader126.i
  %i.wd = load i8, ptr %.17.i59, align 1, !tbaa !7 ; 2 uses
  %i.we = zext i8 %i.wd to i64
  %i.wf = add i64 %.0.i28.i, %i.we                ; 2 uses
  %i.wg = icmp eq i8 %i.wd, -1
  br i1 %i.wg, label %.preheader126.i, label %read_variable_length.exit29.i, !llvm.loop !81
...
.loopexit142.i:                                   ; preds = %bb.bo, %bb.bn, %bb.cl
  ...
  br i1 %i.wn, label %LZ4_wildCopy32.exit.thread.i55, label %bb.cm, !prof !84
...
vector.body699:                                   ; preds = %vector.body699, %vector.ph696
  ...
  %wide.load703 = load <16 x i8>, ptr %next.gep702, align 1, !tbaa !7
  %wide.load704 = load <16 x i8>, ptr %i.xd, align 1, !tbaa !7
  %i.xe = getelementptr i8, ptr %next.gep701, i64 16
  store <16 x i8> %wide.load703, ptr %next.gep701, align 1, !tbaa !7
  store <16 x i8> %wide.load704, ptr %i.xe, align 1, !tbaa !7
  %index.next705 = add nuw i64 %index700, 32      ; 2 uses
  %i.xf = icmp eq i64 %index.next705, %n.vec698
  br i1 %i.xf, label %middle.block706, label %vector.body699, !llvm.loop !235
...
vec.epilog.iter.check:                            ; preds = %middle.block706
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph198.i.preheader, label %vec.epilog.ph, !prof !94
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load715 = load <4 x i8>, ptr %next.gep714, align 1, !tbaa !7
  store <4 x i8> %wide.load715, ptr %next.gep713, align 1, !tbaa !7
  %index.next716 = add nuw i64 %index712, 4       ; 2 uses
  %i.xi = icmp eq i64 %index.next716, %n.vec711
  br i1 %i.xi, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !236
...
.lr.ph198.i:                                      ; preds = %.lr.ph198.i.preheader, %.lr.ph198.i
  ...
  %i.xk = load i8, ptr %.2364.i196.i, align 1, !tbaa !7
  %i.xl = getelementptr inbounds nuw i8, ptr %.14.i197.i, i64 1 ; 2 uses
  store i8 %i.xk, ptr %.14.i197.i, align 1, !tbaa !7
  %i.xm = icmp ult ptr %i.xl, %i.wv
  br i1 %i.xm, label %.lr.ph198.i, label %.loopexit.i71, !llvm.loop !237
...
bb.cp:                                            ; preds = %bb.cm
  ...
  br i1 %i.xo, label %bb.cq, label %bb.cr, !prof !19

bb.cq:                                            ; preds = %bb.cp
  store i32 0, ptr %.10.i.i, align 1, !tbaa !15
  %i.xp = load i8, ptr %.1363.i.i, align 1, !tbaa !7
  store i8 %i.xp, ptr %.10.i.i, align 1, !tbaa !7
  %i.xq = getelementptr inbounds nuw i8, ptr %.1363.i.i, i64 1
  %i.xr = load i8, ptr %i.xq, align 1, !tbaa !7
  %i.xs = getelementptr inbounds nuw i8, ptr %.10.i.i, i64 1
  store i8 %i.xr, ptr %i.xs, align 1, !tbaa !7
  %i.xt = getelementptr inbounds nuw i8, ptr %.1363.i.i, i64 2
  %i.xu = load i8, ptr %i.xt, align 1, !tbaa !7
  %i.xv = getelementptr inbounds nuw i8, ptr %.10.i.i, i64 2
  store i8 %i.xu, ptr %i.xv, align 1, !tbaa !7
  %i.xw = getelementptr inbounds nuw i8, ptr %.1363.i.i, i64 3
  %i.xx = load i8, ptr %i.xw, align 1, !tbaa !7
  %i.xy = getelementptr inbounds nuw i8, ptr %.10.i.i, i64 3
  store i8 %i.xx, ptr %i.xy, align 1, !tbaa !7
...
vector.body679:                                   ; preds = %vector.body679, %vector.ph676
  ...
  br i1 %i.zg, label %middle.block686, label %vector.body679, !llvm.loop !238
...
scalar.ph674:                                     ; preds = %scalar.ph674.preheader, %scalar.ph674
  ...
  br i1 %i.zj, label %scalar.ph674, label %.preheader129.i, !llvm.loop !239
...
.preheader129.i:                                  ; preds = %scalar.ph674, %bb.cs, %middle.block686, %.loopexit.i71, %bb.bd
  ...
  %i.zl = load i8, ptr %.3.ph.i40, align 1, !tbaa !7
...
.thread:                                          ; preds = %._crit_edge, %._crit_edge76
  ...
  %i.l = load i8, ptr %.026, align 1, !tbaa !7
...
.preheader50:                                     ; preds = %.thread, %.preheader50
  ...
  br i1 %i.v, label %.preheader50, label %read_long_length_no_check.exit, !llvm.loop !110
...
bb.f:                                             ; preds = %bb.d
  ...
  %.val = load i16, ptr %i.ab, align 1, !tbaa !26 ; 2 uses
...
.preheader:                                       ; preds = %bb.f, %.preheader
  ...
  br i1 %i.aq, label %.preheader, label %read_long_length_no_check.exit18, !llvm.loop !110
...
vector.body130:                                   ; preds = %vector.body130, %vector.ph127
  ...
  %wide.load132 = load <16 x i8>, ptr %i.ay, align 1, !tbaa !7
  %wide.load133 = load <16 x i8>, ptr %i.az, align 1, !tbaa !7
  %i.ba = getelementptr inbounds nuw i8, ptr %i.aa, i64 %index131 ; 2 uses
  %i.bb = getelementptr inbounds nuw i8, ptr %i.ba, i64 16
  store <16 x i8> %wide.load132, ptr %i.ba, align 1, !tbaa !7
  store <16 x i8> %wide.load133, ptr %i.bb, align 1, !tbaa !7
  %index.next134 = add nuw i64 %index131, 32      ; 2 uses
  %i.bc = icmp eq i64 %index.next134, %n.vec129
  br i1 %i.bc, label %middle.block135, label %vector.body130, !llvm.loop !240
...
vec.epilog.iter.check140:                         ; preds = %middle.block135
  ...
  br i1 %min.epilog.iters.check141, label %.lr.ph.preheader, label %vec.epilog.ph142, !prof !94
...
vec.epilog.vector.body145:                        ; preds = %vec.epilog.vector.body145, %vec.epilog.ph142
  ...
  %wide.load147 = load <4 x i8>, ptr %i.bd, align 1, !tbaa !7
  %i.be = getelementptr inbounds nuw i8, ptr %i.aa, i64 %index146
  store <4 x i8> %wide.load147, ptr %i.be, align 1, !tbaa !7
  %index.next148 = add nuw i64 %index146, 4       ; 2 uses
  %i.bf = icmp eq i64 %index.next148, %n.vec144
  br i1 %i.bf, label %vec.epilog.middle.block149, label %vec.epilog.vector.body145, !llvm.loop !241
...
.lr.ph.prol:                                      ; preds = %.lr.ph.preheader, %.lr.ph.prol
  ...
  br i1 %prol.iter168.cmp.not, label %.lr.ph.prol.loopexit, label %.lr.ph.prol, !llvm.loop !242
