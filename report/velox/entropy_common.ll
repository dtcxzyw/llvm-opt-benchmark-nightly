...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %10 = shl i64 %index, 1                         ; 2 uses
  %11 = and i64 %index, 9223372036854775792
  %i.s = getelementptr inbounds nuw i8, ptr %i.i, i64 %11 ; 3 uses
  ...
  store <16 x i8> %interleaved.vec.a, ptr %12, align 1, !tbaa !14, !alias.scope !18, !noalias !15
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  ...
  br i1 %i.at, label %.lr.ph.i, label %.loopexit.thread.i, !llvm.loop !25
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.aw = tail call i64 @FSE_decompress_wksp_bmi2(ptr noundef %0, i64 noundef %i.au, ptr noundef nonnull %i.av, i64 noundef %i.d, i32 noundef 6, ptr noundef %7, i64 noundef %8, i32 noundef 0) #10 ; 4 uses
  %i.ax = icmp ult i64 %i.aw, -119
  br i1 %i.ax, label %.loopexit.i, label %HUF_readStats_body_default.exit
...
.lr.ph13.i:                                       ; preds = %bb.i, %.lr.ph13.preheader.i
  ...
  br i1 %i.bb, label %HUF_readStats_body_default.exit, label %bb.i
...
bb.j:                                             ; preds = %.critedge.i.i
  %i.bn = tail call range(i32 0, 32) i32 @llvm.ctlz.i32(i32 %i.bk, i1 true) ; 2 uses
  %i.bo = xor i32 %i.bn, 31                       ; 2 uses
  %i.bp = icmp samesign ugt i32 %i.bo, 11
  br i1 %i.bp, label %HUF_readStats_body_default.exit, label %bb.k
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.bt = tail call range(i32 0, 32) i32 @llvm.ctlz.i32(i32 %i.bs, i1 true) ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 3 uses
  %9 = shl i64 %index, 1                          ; 2 uses
  %10 = and i64 %index, 9223372036854775792
  %i.q = getelementptr inbounds nuw i8, ptr %i.g, i64 %10 ; 3 uses
  ...
  store <16 x i8> %interleaved.vec.a, ptr %11, align 1, !tbaa !14, !alias.scope !30, !noalias !27
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load42 = load <4 x i8>, ptr %i.ac, align 1, !tbaa !14, !alias.scope !27 ; 2 uses
  ...
  store <8 x i8> %interleaved.vec44, ptr %i.ae, align 1, !tbaa !14, !alias.scope !30, !noalias !27
  %index.next45 = add nuw i64 %index41, 4         ; 2 uses
  %i.ag = icmp eq i64 %index.next45, %n.vec40
  br i1 %i.ag, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !33
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  br i1 %i.as, label %.lr.ph, label %.loopexit.thread, !llvm.loop !34
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.av = tail call i64 @FSE_decompress_wksp_bmi2(ptr noundef %0, i64 noundef %i.at, ptr noundef nonnull %i.au, i64 noundef %i.b, i32 noundef 6, ptr noundef %7, i64 noundef %8, i32 noundef 1) #10 ; 4 uses
  %i.aw = icmp ult i64 %i.av, -119
  br i1 %i.aw, label %.loopexit, label %HUF_readStats_body.exit
...
.lr.ph13:                                         ; preds = %.lr.ph13.preheader, %bb.g
  ...
  br i1 %i.ba, label %HUF_readStats_body.exit, label %bb.g
...
bb.h:                                             ; preds = %.critedge.i
  ...
  br i1 %i.bo, label %HUF_readStats_body.exit, label %bb.i
...
!6 = !{!"Simple C/C++ TBAA"}
!7 = distinct !{ptr @FSE_readNCount, null}
!8 = !{!"branch_weights", !"expected", i32 1, i32 2000}
!9 = distinct !{!9, !10}
!10 = !{!"llvm.loop.mustprogress"}
!11 = !{!12, !12, i64 0}
!12 = !{!"short", !5, i64 0}
!13 = !{ptr @FSE_readNCount}
!14 = !{!5, !5, i64 0}
!15 = !{!16}
!16 = distinct !{!16, !17}
