...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.ah, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !23
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  ...
  br i1 %i.as, label %.lr.ph.i, label %.loopexit.thread.i, !llvm.loop !26
...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %wide.load35 = load <8 x i8>, ptr %9, align 1, !tbaa !16, !alias.scope !28 ; 2 uses
  ...
  store <16 x i8> %interleaved.vec38, ptr %12, align 1, !tbaa !16, !alias.scope !31, !noalias !28
...
vector.body.1:                                    ; preds = %vector.ph
  ...
  %wide.load.1 = load <8 x i8>, ptr %16, align 1, !tbaa !16, !alias.scope !28 ; 2 uses
  %wide.load35.1 = load <8 x i8>, ptr %17, align 1, !tbaa !16, !alias.scope !28 ; 2 uses
  ...
  store <16 x i8> %interleaved.vec.1, ptr %20, align 1, !tbaa !16, !alias.scope !31, !noalias !28
  ...
  store <16 x i8> %interleaved.vec38.1, ptr %21, align 1, !tbaa !16, !alias.scope !31, !noalias !28
...
vector.body:                                      ; preds = %vector.body.1
  ...
  %wide.load.a = load <8 x i8>, ptr %i.q, align 1, !tbaa !16, !alias.scope !28 ; 2 uses
  %wide.load35.a = load <8 x i8>, ptr %i.r, align 1, !tbaa !16, !alias.scope !28 ; 2 uses
  ...
  store <16 x i8> %interleaved.vec.a, ptr %i.u, align 1, !tbaa !16, !alias.scope !31, !noalias !28
  ...
  store <16 x i8> %interleaved.vec38.a, ptr %i.v, align 1, !tbaa !16, !alias.scope !31, !noalias !28
...
vector.body.3:                                    ; preds = %vector.body
  ...
  %wide.load.3 = load <8 x i8>, ptr %25, align 1, !tbaa !16, !alias.scope !28 ; 2 uses
  %wide.load35.3 = load <8 x i8>, ptr %26, align 1, !tbaa !16, !alias.scope !28 ; 2 uses
  ...
  store <16 x i8> %interleaved.vec.3, ptr %29, align 1, !tbaa !16, !alias.scope !31, !noalias !28
  ...
  store <16 x i8> %interleaved.vec38.3, ptr %30, align 1, !tbaa !16, !alias.scope !31, !noalias !28
  br label %middle.block
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load42 = load <4 x i8>, ptr %i.ab, align 1, !tbaa !16, !alias.scope !28 ; 2 uses
  ...
  store <8 x i8> %interleaved.vec44, ptr %i.ad, align 1, !tbaa !16, !alias.scope !31, !noalias !28
