Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/velox/original/charconv_bigint?download=true
inline.NumInlined: 261
inline.NumDeleted: 97
loop-unroll.NumCompletelyUnrolled: 1
loop-unroll.NumRuntimeUnrolled: 22
loop-unroll.NumUnrolled: 23
begin_hunk_0_@_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE22MultiplyByFiveToTheNthEi:bb.a
...
bb.b:                                             ; preds = %.lr.ph, %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE10MultiplyByEiPKj.exit
  %.023 = phi i1 [ true, %.lr.ph ], [ false, %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE10MultiplyByEiPKj.exit ]
  %.01122 = phi i32 [ %1, %.lr.ph ], [ %i.dy, %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE10MultiplyByEiPKj.exit ] ; 2 uses
...
._crit_edge.i13:                                  ; preds = %bb.f, %bb.e, %bb.d, %.lr.ph.i12
  ...
  br i1 %or.cond.i.i, label %bb.g, label %._crit_edge.i13._ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE12AddWithCarryEim.exit.i_crit_edge

._crit_edge.i13._ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE12AddWithCarryEim.exit.i_crit_edge: ; preds = %._crit_edge.i13
...
bb.g:                                             ; preds = %._crit_edge.i13
  ...
  store i32 %i.cn, ptr %i.cl, align 4, !tbaa !13
...
bb.i:                                             ; preds = %bb.h
  ...
  br i1 %i.cr, label %.lr.ph.i.i.i, label %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE12AddWithCarryEij.exit.i.i
...
.lr.ph.i.i.i:                                     ; preds = %bb.i, %.lr.ph.i.i.i
  ...
  br i1 %i.db, label %.lr.ph.i.i.i, label %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE12AddWithCarryEij.exit.i.i, !llvm.loop !19

_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE12AddWithCarryEij.exit.i.i: ; preds = %.lr.ph.i.i.i, %bb.i
...
.lr.ph.i21.i.i:                                   ; preds = %.lr.ph.i21.i.i, %.lr.ph.i21.preheader.i.i
  ...
  store i32 %i.dj, ptr %i.dh, align 4, !tbaa !13
  ...
  br i1 %i.dn, label %.lr.ph.i21.i.i, label %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE12AddWithCarryEij.exit25.loopexit.i.i, !llvm.loop !19
...
.sink.split.i.i:                                  ; preds = %bb.k, %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE12AddWithCarryEij.exit25.loopexit.i.i, %.preheader.i.i.i, %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE12AddWithCarryEij.exit.i.i
  %.sink35.i.i = phi i32 [ %i.dc, %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE12AddWithCarryEij.exit.i.i ], [ %i.dq, %bb.k ], [ 5, %.preheader.i.i.i ], [ %i.do, %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE12AddWithCarryEij.exit25.loopexit.i.i ]
  %i.dr = load i32, ptr %0, align 4, !tbaa !13
...
_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE12AddWithCarryEim.exit.i: ; preds = %._crit_edge.i13._ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE12AddWithCarryEim.exit.i_crit_edge, %.sink.split.i.i
  %2 = phi i32 [ %.pre, %._crit_edge.i13._ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE12AddWithCarryEim.exit.i_crit_edge ], [ %.sroa.speculated.i.i.i, %.sink.split.i.i ]
  %i.dt = trunc i64 %.lcssa58 to i32
  %i.du = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %indvars.iv
  store i32 %i.dt, ptr %i.du, align 4, !tbaa !13
  ...
  br i1 %or.cond, label %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE12MultiplyStepEiPKjii.exit, label %bb.l

bb.l:                                             ; preds = %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE12AddWithCarryEim.exit.i
  %i.dw = trunc nsw i64 %i.cf to i32
  store i32 %i.dw, ptr %0, align 4, !tbaa !8
  br label %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE12MultiplyStepEiPKjii.exit

_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE12MultiplyStepEiPKjii.exit: ; preds = %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE12AddWithCarryEim.exit.thread.i, %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE12AddWithCarryEim.exit.i, %bb.l
  %indvars.iv.next = add nsw i64 %indvars.iv, -1
  %i.dx = icmp eq i64 %indvars.iv, 0
  br i1 %i.dx, label %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE10MultiplyByEiPKj.exit, label %select.unfold.i, !llvm.loop !39
...
_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE10MultiplyByEiPKj.exit: ; preds = %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE12MultiplyStepEiPKjii.exit, %bb.c, %_ZSt6copy_nIPKjiPjET1_T_T0_S3_.exit
  ...
  br i1 %i.dz, label %bb.b, label %._crit_edge, !llvm.loop !40

._crit_edge:                                      ; preds = %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE10MultiplyByEiPKj.exit, %bb.a
  %.011.lcssa = phi i32 [ %1, %bb.a ], [ %i.dy, %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE10MultiplyByEiPKj.exit ] ; 3 uses
...
bb.m:                                             ; preds = %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE10MultiplyByEj.exit.i, %.lr.ph.i
  %.015.i = phi i32 [ %.011.lcssa, %.lr.ph.i ], [ %i.fg, %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE10MultiplyByEj.exit.i ] ; 2 uses
  %i.ec = phi i32 [ %.promoted.i, %.lr.ph.i ], [ %i.ff, %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE10MultiplyByEj.exit.i ] ; 8 uses
  %i.ed = icmp sgt i32 %i.ec, 0
  br i1 %i.ed, label %.lr.ph.i.i, label %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE10MultiplyByEj.exit.i
...
._crit_edge.i.i:                                  ; preds = %._crit_edge.i.i.unr-lcssa, %.epil.preheader
  ...
  br i1 %or.cond17.i.i, label %bb.o, label %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE10MultiplyByEj.exit.i
...
bb.n:                                             ; preds = %bb.n, %.lr.ph.i.i.new
  ...
  store i32 %i.es, ptr %i.en, align 4, !tbaa !13
  ...
  store i32 %i.fa, ptr %i.ev, align 4, !tbaa !13
  %i.fb = lshr i64 %i.ez, 32                      ; 3 uses
  %indvars.iv.next.i.i.1 = add nuw nsw i64 %indvars.iv.i.i, 2 ; 2 uses
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge.i.i.unr-lcssa, label %bb.n, !llvm.loop !18
...
bb.o:                                             ; preds = %._crit_edge.i.i
  ...
  store i32 %i.fc, ptr %i.fd, align 4, !tbaa !13
  %i.fe = add nuw nsw i32 %i.ec, 1                ; 2 uses
  store i32 %i.fe, ptr %0, align 4, !tbaa !8
  br label %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE10MultiplyByEj.exit.i

_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE10MultiplyByEj.exit.i: ; preds = %bb.o, %._crit_edge.i.i, %bb.m
  %i.ff = phi i32 [ %i.ec, %bb.m ], [ %i.ec, %._crit_edge.i.i ], [ %i.fe, %bb.o ]
  %i.fg = add nsw i32 %.015.i, -13                ; 2 uses
  %i.fh = icmp sgt i32 %.015.i, 25
  br i1 %i.fh, label %bb.m, label %._crit_edge.i, !llvm.loop !21

._crit_edge.i:                                    ; preds = %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE10MultiplyByEj.exit.i, %._crit_edge
  %.0.lcssa.i = phi i32 [ %.011.lcssa, %._crit_edge ], [ %i.fg, %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE10MultiplyByEj.exit.i ] ; 2 uses
  %i.fi = icmp sgt i32 %.0.lcssa.i, 0
  br i1 %i.fi, label %bb.p, label %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE22MultiplyByFiveToTheNthEi.exit

bb.p:                                             ; preds = %._crit_edge.i
  %i.fj = load i32, ptr %0, align 4, !tbaa !8     ; 7 uses
  %i.fk = icmp eq i32 %i.fj, 0
  br i1 %i.fk, label %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE22MultiplyByFiveToTheNthEi.exit, label %bb.q

bb.q:                                             ; preds = %bb.p
  %i.fl = zext nneg i32 %.0.lcssa.i to i64
  %i.fm = getelementptr inbounds nuw [4 x i8], ptr @_ZN4absl12lts_2024011616strings_internal10kFiveToNthE, i64 %i.fl
  %i.fn = load i32, ptr %i.fm, align 4, !tbaa !13
  %i.fo = zext i32 %i.fn to i64                   ; 3 uses
  %i.fp = icmp sgt i32 %i.fj, 0
  br i1 %i.fp, label %.lr.ph.i4.i, label %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi4EE22MultiplyByFiveToTheNthEi.exit
...
.epil.preheader62:                                ; preds = %._crit_edge.i10.i.unr-lcssa, %.lr.ph.i4.i
  ...
  store i32 %i.fx, ptr %i.fs, align 4, !tbaa !13
...
bb.r:                                             ; preds = %bb.r, %.lr.ph.i4.i.new
  ...
  br i1 %niter68.ncmp.1, label %._crit_edge.i10.i.unr-lcssa, label %bb.r, !llvm.loop !18
...
._crit_edge.thread.sink.split.i.i:                ; preds = %._crit_edge.i10.i
  ...
  store i32 %i.gp, ptr %i.gq, align 4, !tbaa !13
  %i.gr = add nuw nsw i32 %i.fj, 1
  store i32 %i.gr, ptr %0, align 4, !tbaa !8
end_hunk_0
begin_hunk_1_@_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE22MultiplyByFiveToTheNthEi:bb.a
  %i.ae = add nuw nsw i32 %i.c, 1                 ; 2 uses
  store i32 %i.ae, ptr %0, align 4, !tbaa !51
  br label %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE10MultiplyByEj.exit

_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE10MultiplyByEj.exit: ; preds = %bb.b, %._crit_edge.i, %bb.d
  %i.af = phi i32 [ %i.c, %bb.b ], [ %i.c, %._crit_edge.i ], [ %i.ae, %bb.d ]
  %i.ag = add nsw i32 %.015, -13                  ; 2 uses
  %i.ah = icmp sgt i32 %.015, 25
  br i1 %i.ah, label %bb.b, label %._crit_edge, !llvm.loop !59

._crit_edge:                                      ; preds = %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE10MultiplyByEj.exit, %bb.a
  %.0.lcssa = phi i32 [ %1, %bb.a ], [ %i.ag, %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE10MultiplyByEj.exit ] ; 2 uses
  %i.ai = icmp sgt i32 %.0.lcssa, 0
  br i1 %i.ai, label %bb.e, label %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE10MultiplyByEj.exit13

bb.e:                                             ; preds = %._crit_edge
  %i.aj = load i32, ptr %0, align 4, !tbaa !51    ; 7 uses
  %i.ak = icmp eq i32 %i.aj, 0
  br i1 %i.ak, label %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE10MultiplyByEj.exit13, label %bb.f
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %i.ap, label %.lr.ph.i4, label %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE10MultiplyByEj.exit13
...
._crit_edge.i10:                                  ; preds = %._crit_edge.i10.unr-lcssa, %.epil.preheader31
  ...
  %or.cond17.i12 = and i1 %i.az, %.not.i11
  br i1 %or.cond17.i12, label %._crit_edge.thread.sink.split.i, label %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE10MultiplyByEj.exit13
...
bb.g:                                             ; preds = %bb.g, %.lr.ph.i4.new
  ...
  %niter37.next.1 = add i64 %niter37, 2           ; 2 uses
  %niter37.ncmp.1 = icmp eq i64 %niter37.next.1, %unroll_iter36
  br i1 %niter37.ncmp.1, label %._crit_edge.i10.unr-lcssa, label %bb.g, !llvm.loop !56
...
._crit_edge.thread.sink.split.i:                  ; preds = %._crit_edge.i10
  ...
  store i32 %i.bp, ptr %i.bq, align 4, !tbaa !13
  %i.br = add nuw nsw i32 %i.aj, 1
  store i32 %i.br, ptr %0, align 4, !tbaa !51
  br label %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE10MultiplyByEj.exit13

_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE10MultiplyByEj.exit13: ; preds = %._crit_edge.thread.sink.split.i, %._crit_edge.i10, %bb.f, %bb.e, %._crit_edge
  ret void
}

; Function Attrs: mustprogress uwtable
define weak_odr void @_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE12FiveToTheNthEi(ptr dead_on_unwind noalias writable sret(%"class.absl::lts_20240116::strings_internal::BigUnsigned.0") align 4 %0, i32 noundef %1) local_unnamed_addr #1 comdat align 2 {
bb.a:
  tail call void @_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EEC1Em(ptr noundef nonnull align 4 dereferenceable(340) %0, i64 noundef 1)
  %i.a = icmp sgt i32 %1, 26
  br i1 %i.a, label %.lr.ph, label %._crit_edge
...
bb.b:                                             ; preds = %.lr.ph, %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE10MultiplyByEiPKj.exit
  %.023 = phi i1 [ true, %.lr.ph ], [ false, %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE10MultiplyByEiPKj.exit ]
  %.01122 = phi i32 [ %1, %.lr.ph ], [ %i.ck, %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE10MultiplyByEiPKj.exit ] ; 2 uses
  %i.c = udiv i32 %.01122, 27
  %.sroa.speculated = tail call i32 @llvm.umin.i32(i32 %i.c, i32 20) ; 8 uses
  br i1 %.023, label %_ZSt6copy_nIPKjiPjET1_T_T0_S3_.exit, label %bb.c
...
_ZSt6copy_nIPKjiPjET1_T_T0_S3_.exit:              ; preds = %bb.b
  ...
  %.idx.i.i = zext nneg i32 %i.i to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %i.b, ptr nonnull align 4 %i.g, i64 %.idx.i.i, i1 false)
  store i32 %i.h, ptr %0, align 4, !tbaa !51
  br label %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE10MultiplyByEiPKj.exit
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.o = load i32, ptr %0, align 4, !tbaa !51     ; 2 uses
  %i.p = add nsw i32 %i.o, %i.j                   ; 2 uses
  %i.q = icmp sgt i32 %i.p, 1
  br i1 %i.q, label %select.unfold.preheader.i, label %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE10MultiplyByEiPKj.exit
...
select.unfold.i:                                  ; preds = %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE12MultiplyStepEiPKjii.exit, %select.unfold.preheader.i
  %indvars.iv = phi i64 [ %indvars.iv.next, %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE12MultiplyStepEiPKjii.exit ], [ %i.t, %select.unfold.preheader.i ] ; 13 uses
  %i.u = trunc nsw i64 %indvars.iv to i32         ; 2 uses
  ...
  %i.x = icmp slt i32 %i.v, %i.j
  %i.y = and i1 %i.w, %i.x
  br i1 %i.y, label %.lr.ph.i12, label %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE12AddWithCarryEim.exit.thread.i

_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE12AddWithCarryEim.exit.thread.i: ; preds = %select.unfold.i
  %i.z = getelementptr inbounds [4 x i8], ptr %i.b, i64 %indvars.iv
  store i32 0, ptr %i.z, align 4, !tbaa !13
  br label %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE12MultiplyStepEiPKjii.exit
...
bb.d:                                             ; preds = %bb.d, %.lr.ph.i12
  ...
  br i1 %i.aq, label %bb.d, label %._crit_edge.i13, !llvm.loop !65
...
._crit_edge.i13:                                  ; preds = %bb.d
  ...
  br i1 %or.cond.i.i, label %bb.e, label %._crit_edge.i13._ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE12AddWithCarryEim.exit.i_crit_edge

._crit_edge.i13._ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE12AddWithCarryEim.exit.i_crit_edge: ; preds = %._crit_edge.i13
  %.pre = load i32, ptr %0, align 4
  br label %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE12AddWithCarryEim.exit.i
...
bb.g:                                             ; preds = %bb.f
  ...
  br i1 %i.bd, label %.lr.ph.i.i.i, label %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE12AddWithCarryEij.exit.i.i
...
.lr.ph.i.i.i:                                     ; preds = %bb.g, %.lr.ph.i.i.i
  ...
  br i1 %i.bn, label %.lr.ph.i.i.i, label %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE12AddWithCarryEij.exit.i.i, !llvm.loop !57

_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE12AddWithCarryEij.exit.i.i: ; preds = %.lr.ph.i.i.i, %bb.g
...
.lr.ph.i21.i.i:                                   ; preds = %.lr.ph.i21.i.i, %.lr.ph.i21.preheader.i.i
  ...
  br i1 %i.bz, label %.lr.ph.i21.i.i, label %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE12AddWithCarryEij.exit25.loopexit.i.i, !llvm.loop !57

_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE12AddWithCarryEij.exit25.loopexit.i.i: ; preds = %.lr.ph.i21.i.i
...
.sink.split.i.i:                                  ; preds = %bb.i, %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE12AddWithCarryEij.exit25.loopexit.i.i, %.preheader.i.i.i, %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE12AddWithCarryEij.exit.i.i
  %.sink35.i.i = phi i32 [ %i.bo, %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE12AddWithCarryEij.exit.i.i ], [ %i.cc, %bb.i ], [ 85, %.preheader.i.i.i ], [ %i.ca, %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE12AddWithCarryEij.exit25.loopexit.i.i ]
  ...
  store i32 %.sroa.speculated.i.i.i, ptr %0, align 4, !tbaa !51
  br label %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE12AddWithCarryEim.exit.i

_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE12AddWithCarryEim.exit.i: ; preds = %._crit_edge.i13._ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE12AddWithCarryEim.exit.i_crit_edge, %.sink.split.i.i
  %2 = phi i32 [ %.pre, %._crit_edge.i13._ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE12AddWithCarryEim.exit.i_crit_edge ], [ %.sroa.speculated.i.i.i, %.sink.split.i.i ]
  ...
  %or.cond = select i1 %.not.i14, i1 true, i1 %.not23.i
  br i1 %or.cond, label %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE12MultiplyStepEiPKjii.exit, label %bb.j

bb.j:                                             ; preds = %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE12AddWithCarryEim.exit.i
  %i.ci = trunc nsw i64 %i.ar to i32
  store i32 %i.ci, ptr %0, align 4, !tbaa !51
  br label %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE12MultiplyStepEiPKjii.exit

_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE12MultiplyStepEiPKjii.exit: ; preds = %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE12AddWithCarryEim.exit.thread.i, %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE12AddWithCarryEim.exit.i, %bb.j
  %indvars.iv.next = add nsw i64 %indvars.iv, -1
  %i.cj = icmp eq i64 %indvars.iv, 0
  br i1 %i.cj, label %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE10MultiplyByEiPKj.exit, label %select.unfold.i, !llvm.loop !64

_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE10MultiplyByEiPKj.exit: ; preds = %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE12MultiplyStepEiPKjii.exit, %bb.c, %_ZSt6copy_nIPKjiPjET1_T_T0_S3_.exit
  %.neg = mul nsw i32 %.sroa.speculated, -27
  %i.ck = add nsw i32 %.neg, %.01122              ; 3 uses
  %i.cl = icmp sgt i32 %i.ck, 26
  br i1 %i.cl, label %bb.b, label %._crit_edge, !llvm.loop !66

._crit_edge:                                      ; preds = %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE10MultiplyByEiPKj.exit, %bb.a
  %.011.lcssa = phi i32 [ %1, %bb.a ], [ %i.ck, %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE10MultiplyByEiPKj.exit ] ; 3 uses
...
bb.k:                                             ; preds = %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE10MultiplyByEj.exit.i, %.lr.ph.i
  %.015.i = phi i32 [ %.011.lcssa, %.lr.ph.i ], [ %i.ds, %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE10MultiplyByEj.exit.i ] ; 2 uses
  %i.co = phi i32 [ %.promoted.i, %.lr.ph.i ], [ %i.dr, %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE10MultiplyByEj.exit.i ] ; 8 uses
...
._crit_edge.i:                                    ; preds = %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE10MultiplyByEj.exit.i, %._crit_edge
  %.0.lcssa.i = phi i32 [ %.011.lcssa, %._crit_edge ], [ %i.ds, %_ZN4absl12lts_2024011616strings_internal11BigUnsignedILi84EE10MultiplyByEj.exit.i ] ; 2 uses
