...
bb.c:                                             ; preds = %bb.b
  %i.n = load ptr, ptr %0, align 8, !tbaa !7, !nonnull !11, !align !12 ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  %i.s = load ptr, ptr %0, align 8, !tbaa !7, !nonnull !11, !align !12
...
!6 = !{!"Simple C++ TBAA"}
!7 = !{!8, !9, i64 0}
!8 = !{!"_ZTSN4geos4geom4prep23PreparedPolygonDistanceE", !9, i64 0}
