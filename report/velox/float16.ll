...
bb.b:                                             ; preds = %bb.a
  ...
  %i.f = shl nuw nsw i32 %i.e, 13
  %i.g = or disjoint i32 %i.b, %i.f
  %i.h = or i32 %i.g, 2139095040
  br label %_ZN5arrow4util12_GLOBAL__N_115BinaryConverterIjE12FromBinary16Et.exit

bb.c:                                             ; preds = %bb.a
  %i.i = icmp eq i16 %i.d, 0
  br i1 %i.i, label %_ZN5arrow4util12_GLOBAL__N_115BinaryConverterIjE12FromBinary16Et.exit, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.j = shl nuw nsw i16 %i.d, 1
  %i.k = zext nneg i16 %i.j to i32                ; 2 uses
  %i.l = icmp samesign ult i16 %i.d, 512
  br i1 %i.l, label %.lr.ph.i, label %._crit_edge.i

.lr.ph.i:                                         ; preds = %bb.d, %.lr.ph.i
  %.024.i = phi i32 [ %i.n, %.lr.ph.i ], [ %i.k, %bb.d ] ; 2 uses
  %.02023.i = phi i32 [ %i.m, %.lr.ph.i ], [ 112, %bb.d ]
  %i.m = add i32 %.02023.i, -1                    ; 2 uses
...
._crit_edge.i:                                    ; preds = %._crit_edge.loopexit.i, %bb.d
  %.020.lcssa.i = phi i32 [ 939524096, %bb.d ], [ %i.q, %._crit_edge.loopexit.i ]
  %.0.lcssa.i = phi i32 [ %i.k, %bb.d ], [ %i.n, %._crit_edge.loopexit.i ]
  %i.r = shl i32 %.0.lcssa.i, 13
  %i.s = and i32 %i.r, 8372224
  %i.t = or disjoint i32 %.020.lcssa.i, %i.s
  %i.u = or i32 %i.t, %i.b
  br label %_ZN5arrow4util12_GLOBAL__N_115BinaryConverterIjE12FromBinary16Et.exit
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.t = and i64 %narrow.i, 4294967295
  %i.u = lshr i64 %i.s, %i.t                      ; 3 uses
  %i.v = and i64 %i.u, 8796093022207
  %.not40.i = icmp eq i64 %i.v, 2199023255552
  %i.w = and i64 %i.a, 2047
  %.not41.i = icmp eq i64 %i.w, 0
  %or.cond42.i = and i1 %.not41.i, %.not40.i
  %i.x = add nuw nsw i64 %i.u, 2199023255552
  %.037.i = select i1 %or.cond42.i, i64 %i.u, i64 %i.x
  %i.y = lshr i64 %.037.i, 42
  %i.z = trunc nuw nsw i64 %i.y to i16
  %i.aa = add nuw i16 %i.d, %i.z
  br label %_ZN5arrow4util12_GLOBAL__N_115BinaryConverterImE10ToBinary16Em.exit

bb.h:                                             ; preds = %bb.e
  %i.ab = shl i16 %i.g, 10
  %i.ac = and i64 %i.a, 8796093022207
  %.not.i = icmp eq i64 %i.ac, 2199023255552
  %i.ad = add nuw nsw i64 %i.h, 2199023255552
  %spec.select.i = select i1 %.not.i, i64 %i.h, i64 %i.ad
  %i.ae = lshr i64 %spec.select.i, 42
  %i.af = trunc nuw nsw i64 %i.ae to i16
  %i.ag = or disjoint i16 %i.d, 16384
...
_ZN5arrow4util12_GLOBAL__N_115BinaryConverterImE10ToBinary16Em.exit: ; preds = %bb.c, %bb.d, %bb.f, %bb.g, %bb.h
  %.0.i = phi i16 [ %i.o, %bb.c ], [ %i.p, %bb.d ], [ %i.ai, %bb.h ], [ %i.aa, %bb.g ], [ %i.d, %bb.f ]
  ret i16 %.0.i
}
