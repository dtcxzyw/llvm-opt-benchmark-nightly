...
.critedge.i:                                      ; preds = %bb.n, %_ZNK5arrow4json17MultiStringStream4PeekEv.exit24, %bb.m, %_ZNK5arrow4json17MultiStringStream4PeekEv.exit22
  ...
  store i64 %i.w, ptr %5, align 8, !tbaa !62
  br label %.critedge
...
bb.q:                                             ; preds = %bb.p
  ...
  store i64 %i.w, ptr %6, align 8, !tbaa !62
  br label %.critedge
...
bb.s:                                             ; preds = %bb.l
  ...
  store i64 %i.w, ptr %7, align 8, !tbaa !62
  br label %.critedge
...
.thread:                                          ; preds = %bb.f, %bb.i
  ...
  store i64 %i.w, ptr %8, align 8, !tbaa !62
  br label %.critedge
...
begin_hunk_4
  ...
  store i64 %i.cl, ptr %9, align 8, !tbaa !62
  br label %.critedge
...
bb.y:                                             ; preds = %bb.x
  ...
  store i64 %i.cn, ptr %10, align 8, !tbaa !62
  br label %.critedge
...
.critedge:                                        ; preds = %bb.o, %bb.j, %.thread42, %.thread, %bb.y, %bb.s, %bb.q, %.critedge.i, %bb.ad, %_ZN5arrow9rapidjson13GenericReaderINS0_4UTF8IcEES3_NS0_12CrtAllocatorEE19ParseStringToStreamILj76ES3_S3_NS_4json17MultiStringStreamENS5_11StackStreamIcEEEEvRT2_RT3_.exit
...
begin_hunk_6
  ...
  br i1 %i.acx, label %.critedge135, label %_ZNK5arrow4json17MultiStringStream4PeekEv.exit364, !prof !105
...
begin_hunk_7
  ...
  br i1 %or.cond1048, label %_ZNK5arrow4json17MultiStringStream4PeekEv.exit368, label %.critedge135, !prof !122
...
.critedge135:                                     ; preds = %bb.ez, %_ZNK5arrow4json17MultiStringStream4PeekEv.exit364, %_ZNK5arrow4json17MultiStringStream4PeekEv.exit343, %.critedge137, %_ZN5arrow9rapidjson13GenericReaderINS0_4UTF8IcEES3_NS0_12CrtAllocatorEE12NumberStreamINS_4json17MultiStringStreamEcLb1ELb1EE4TakeEv.exit162, %bb.cn, %.critedge125, %.critedge130.thread925, %.critedge130, %bb.ek, %_ZNK5arrow4json17MultiStringStream4PeekEv.exit313
  %.sroa.107.19 = phi i32 [ %.sroa.107.12923, %_ZNK5arrow4json17MultiStringStream4PeekEv.exit313 ], [ %.sroa.107.7, %.critedge125 ], [ %.sroa.107.15692, %_ZNK5arrow4json17MultiStringStream4PeekEv.exit343 ], [ %i.yx, %bb.ek ], [ %.sroa.107.12.ph, %.critedge130 ], [ %.sroa.107.9, %bb.cn ], [ %i.acj, %_ZN5arrow9rapidjson13GenericReaderINS0_4UTF8IcEES3_NS0_12CrtAllocatorEE12NumberStreamINS_4json17MultiStringStreamEcLb1ELb1EE4TakeEv.exit162 ], [ %.sroa.107.11911, %.critedge130.thread925 ], [ %.sroa.107.17, %.critedge137 ], [ %.sroa.107.18, %_ZNK5arrow4json17MultiStringStream4PeekEv.exit364 ], [ %.sroa.107.18, %bb.ez ] ; 4 uses
...
.critedge.i:                                      ; preds = %bb.h, %_ZNK5arrow9rapidjson18EncodedInputStreamINS0_4UTF8IcEENS0_12MemoryStreamEE4PeekEv.exit22, %bb.g, %_ZNK5arrow9rapidjson18EncodedInputStreamINS0_4UTF8IcEENS0_12MemoryStreamEE4PeekEv.exit20
  ...
  %5 = getelementptr inbounds nuw i8, ptr %0, i64 56
  store i64 %i.s, ptr %5, align 8, !tbaa !62
  br label %.critedge
...
bb.k:                                             ; preds = %bb.j
  store i32 9, ptr %i.j, align 8, !tbaa !59
  %6 = getelementptr inbounds nuw i8, ptr %0, i64 56
  store i64 %i.s, ptr %6, align 8, !tbaa !62
  br label %.critedge
...
bb.m:                                             ; preds = %bb.f
  store i32 9, ptr %i.j, align 8, !tbaa !59
  %7 = getelementptr inbounds nuw i8, ptr %0, i64 56
  store i64 %i.s, ptr %7, align 8, !tbaa !62
  br label %.critedge
...
.thread27:                                        ; preds = %_ZN5arrow9rapidjson18EncodedInputStreamINS0_4UTF8IcEENS0_12MemoryStreamEE4TakeEv.exit16, %bb.d
  ...
  %8 = getelementptr inbounds nuw i8, ptr %0, i64 56
  store i64 %i.s, ptr %8, align 8, !tbaa !62
  br label %.critedge
...
begin_hunk_13
  ...
  %9 = getelementptr inbounds nuw i8, ptr %0, i64 56
  store i64 %i.cf, ptr %9, align 8, !tbaa !62
  br label %.critedge
...
begin_hunk_14
  ...
  %10 = getelementptr inbounds nuw i8, ptr %0, i64 56
  store i64 %i.cl, ptr %10, align 8, !tbaa !62
  br label %.critedge
...
begin_hunk_16
  ...
  br i1 %or.cond872, label %_ZNK5arrow9rapidjson18EncodedInputStreamINS0_4UTF8IcEENS0_12MemoryStreamEE4PeekEv.exit280, label %.critedge135, !prof !122
...
.critedge135:                                     ; preds = %bb.db, %_ZNK5arrow9rapidjson18EncodedInputStreamINS0_4UTF8IcEENS0_12MemoryStreamEE4PeekEv.exit278, %_ZNK5arrow9rapidjson18EncodedInputStreamINS0_4UTF8IcEENS0_12MemoryStreamEE4PeekEv.exit264, %.critedge137, %_ZNK5arrow9rapidjson18EncodedInputStreamINS0_4UTF8IcEENS0_12MemoryStreamEE4PeekEv.exit226._crit_edge, %.critedge125, %.critedge130, %bb.co, %_ZNK5arrow9rapidjson18EncodedInputStreamINS0_4UTF8IcEENS0_12MemoryStreamEE4PeekEv.exit251.a
  %.sroa.107.19 = phi i32 [ %.sroa.107.12768, %_ZNK5arrow9rapidjson18EncodedInputStreamINS0_4UTF8IcEENS0_12MemoryStreamEE4PeekEv.exit251.a ], [ %.sroa.107.12.ph, %.critedge130 ], [ %.sroa.107.15558, %_ZNK5arrow9rapidjson18EncodedInputStreamINS0_4UTF8IcEENS0_12MemoryStreamEE4PeekEv.exit264 ], [ %i.vo, %bb.co ], [ %.sroa.107.8.lcssa.ph, %_ZNK5arrow9rapidjson18EncodedInputStreamINS0_4UTF8IcEENS0_12MemoryStreamEE4PeekEv.exit226._crit_edge ], [ %.sroa.107.7, %.critedge125 ], [ %.sroa.107.17, %.critedge137 ], [ %.sroa.107.18, %_ZNK5arrow9rapidjson18EncodedInputStreamINS0_4UTF8IcEENS0_12MemoryStreamEE4PeekEv.exit278 ], [ %.sroa.107.18, %bb.db ] ; 4 uses
...
!154 = distinct !{!154, !86}
!155 = distinct !{!155, !86}
!156 = !{!"branch_weights", !"expected", i32 1073742, i32 2146409906}
!157 = distinct !{!157, !86}
!158 = distinct !{!158, !86}
!159 = distinct !{!159, !86}
end_hunk_18
