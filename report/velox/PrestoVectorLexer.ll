...
begin_hunk_0_@_ZN8facebook5velox10serializer6presto6detail17PrestoVectorLexer8lexNullsERi:bb.a
  ...
  %i.w = load ptr, ptr %i.v, align 8, !tbaa !428  ; 2 uses
  %i.x = load ptr, ptr %i.u, align 8, !tbaa !429  ; 6 uses
  %i.y = ptrtoint ptr %i.w to i64
  %i.z = ptrtoint ptr %i.x to i64
  %i.aa = sub i64 %i.y, %i.z
  %i.ab = ashr exact i64 %i.aa, 3                 ; 4 uses
  %i.ac = icmp ult i64 %i.ab, %i.r
  br i1 %i.ac, label %bb.e, label %_ZNSt6vectorImSaImEE6resizeEm.exit

bb.e:                                             ; preds = %bb.d
  %i.ad = add nuw nsw i64 %i.r, 7
  %i.ae = lshr i64 %i.ad, 3                       ; 4 uses
  %i.af = icmp samesign ugt i64 %i.ae, %i.ab
  br i1 %i.af, label %bb.f, label %bb.g

bb.f:                                             ; preds = %bb.e
  %i.ag = sub nuw nsw i64 %i.ae, %i.ab
  call void @_ZNSt6vectorImSaImEE17_M_default_appendEm(ptr noundef nonnull align 8 dereferenceable(24) %i.u, i64 noundef %i.ag)
  %.pre = load ptr, ptr %i.u, align 8, !tbaa !429
...
vector.body74:                                    ; preds = %vector.body74, %vector.ph71
  ...
  %vec.phi = phi <4 x i32> [ zeroinitializer, %vector.ph71 ], [ %i.cm, %vector.body74 ]
  %vec.phi76 = phi <4 x i32> [ zeroinitializer, %vector.ph71 ], [ %i.cn, %vector.body74 ]
  %vec.phi77 = phi <4 x i32> [ zeroinitializer, %vector.ph71 ], [ %i.co, %vector.body74 ]
  %vec.phi78 = phi <4 x i32> [ zeroinitializer, %vector.ph71 ], [ %i.cp, %vector.body74 ]
  %i.by = shl i64 %index75, 3
  %i.bz = and i64 %i.by, 2305843009213693824
  %i.ca = getelementptr inbounds nuw i8, ptr %i.aj, i64 %i.bz ; 4 uses
  ...
  %wide.load79 = load <4 x i64>, ptr %i.ca, align 8, !tbaa !22
  %wide.load80 = load <4 x i64>, ptr %i.cb, align 8, !tbaa !22
  %wide.load81 = load <4 x i64>, ptr %i.cc, align 8, !tbaa !22
  %wide.load82 = load <4 x i64>, ptr %i.cd, align 8, !tbaa !22
  %i.ce = call range(i64 0, 65) <4 x i64> @llvm.ctpop.v4i64(<4 x i64> %wide.load79)
  %i.cf = call range(i64 0, 65) <4 x i64> @llvm.ctpop.v4i64(<4 x i64> %wide.load80)
  %i.cg = call range(i64 0, 65) <4 x i64> @llvm.ctpop.v4i64(<4 x i64> %wide.load81)
  %i.ch = call range(i64 0, 65) <4 x i64> @llvm.ctpop.v4i64(<4 x i64> %wide.load82)
  ...
  %i.cl = trunc nuw nsw <4 x i64> %i.ch to <4 x i32>
  %i.cm = add <4 x i32> %vec.phi, %i.ci           ; 2 uses
  %i.cn = add <4 x i32> %vec.phi76, %i.cj         ; 2 uses
  %i.co = add <4 x i32> %vec.phi77, %i.ck         ; 2 uses
  %i.cp = add <4 x i32> %vec.phi78, %i.cl         ; 2 uses
  %index.next83 = add nuw i64 %index75, 16        ; 2 uses
  %i.cq = icmp eq i64 %index.next83, %n.vec73
  br i1 %i.cq, label %middle.block84, label %vector.body74, !llvm.loop !444

middle.block84:                                   ; preds = %vector.body74
  %bin.rdx = add <4 x i32> %i.cn, %i.cm
  %bin.rdx85 = add <4 x i32> %i.co, %bin.rdx
  %bin.rdx86 = add <4 x i32> %i.cp, %bin.rdx85
  %i.cr = call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx86) ; 3 uses
...
vec.epilog.ph95:                                  ; preds = %vector.main.loop.iter.check69, %vec.epilog.iter.check93
  ...
  %bc.merge.rdx = phi i32 [ %i.cr, %vec.epilog.iter.check93 ], [ 0, %vector.main.loop.iter.check69 ]
  %n.vec97 = and i64 %i.bv, 576460752303423484    ; 3 uses
  %i.cs = shl i64 %n.vec97, 6                     ; 2 uses
  %i.ct = or disjoint i64 %i.cs, 64
  %i.cu = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %bc.merge.rdx, i64 0
...
vec.epilog.vector.body98:                         ; preds = %vec.epilog.vector.body98, %vec.epilog.ph95
  ...
  %vec.phi100 = phi <4 x i32> [ %i.cu, %vec.epilog.ph95 ], [ %i.da, %vec.epilog.vector.body98 ]
  %i.cv = shl i64 %index99, 3
  %i.cw = and i64 %i.cv, 2305843009213693920
  %i.cx = getelementptr inbounds nuw i8, ptr %i.aj, i64 %i.cw
  %wide.load101 = load <4 x i64>, ptr %i.cx, align 8, !tbaa !22
  %i.cy = call range(i64 0, 65) <4 x i64> @llvm.ctpop.v4i64(<4 x i64> %wide.load101)
  %i.cz = trunc nuw nsw <4 x i64> %i.cy to <4 x i32>
  %i.da = add <4 x i32> %vec.phi100, %i.cz        ; 2 uses
  %index.next102 = add nuw i64 %index99, 4        ; 2 uses
  %i.db = icmp eq i64 %index.next102, %n.vec97
  br i1 %i.db, label %vec.epilog.middle.block103, label %vec.epilog.vector.body98, !llvm.loop !446
...
.lr.ph.i.i.preheader:                             ; preds = %iter.check91, %vec.epilog.iter.check93, %vec.epilog.middle.block103
  %indvars.iv42.ph = phi i64 [ 0, %iter.check91 ], [ %i.bw, %vec.epilog.iter.check93 ], [ %i.cs, %vec.epilog.middle.block103 ]
  %indvars.iv.ph = phi i64 [ 64, %iter.check91 ], [ %i.bx, %vec.epilog.iter.check93 ], [ %i.ct, %vec.epilog.middle.block103 ]
  %.ph = phi i32 [ 0, %iter.check91 ], [ %i.cr, %vec.epilog.iter.check93 ], [ %i.dc, %vec.epilog.middle.block103 ]
  br label %.lr.ph.i.i

._crit_edge.i.i:                                  ; preds = %.lr.ph.i.i, %middle.block84, %vec.epilog.middle.block103, %bb.q
  %.1.i = phi i32 [ 0, %bb.q ], [ %i.dc, %vec.epilog.middle.block103 ], [ %i.cr, %middle.block84 ], [ %i.dj, %.lr.ph.i.i ] ; 2 uses
...
.sink.split.i.i:                                  ; preds = %._crit_edge.i.i
  ...
  %i.dl = and i32 %i.bq, 63
  %i.dm = zext nneg i32 %i.dl to i64
  %notmask.i36.i.i = shl nsw i64 -1, %i.dm
  %i.dn = xor i64 %notmask.i36.i.i, -1
  %i.do = zext nneg i32 %i.dk to i64
  %i.dp = getelementptr inbounds nuw [8 x i8], ptr %i.aj, i64 %i.do
  %i.dq = load i64, ptr %i.dp, align 8, !tbaa !22
  %i.dr = and i64 %i.dq, %i.dn
  %i.ds = call range(i64 0, 64) i64 @llvm.ctpop.i64(i64 %i.dr)
  %i.dt = trunc nuw nsw i64 %i.ds to i32
  %i.du = add nsw i32 %.1.i, %i.dt
...
_ZN8facebook5velox4bits9countBitsEPKmii.exit:     ; preds = %_ZN8facebook5velox4bits11reverseBitsEPhi.exit, %._crit_edge.i.i, %.sink.split.i.i
  %.3.i = phi i32 [ %i.du, %.sink.split.i.i ], [ %.1.i, %._crit_edge.i.i ], [ 0, %_ZN8facebook5velox4bits11reverseBitsEPhi.exit ]
  %i.dv = sub nsw i32 %i.bq, %.3.i
  store i32 %i.dv, ptr %2, align 4, !tbaa !3
  br label %bb.r
...
bb.c:                                             ; preds = %bb.a
  %i.h = landingpad { ptr, i32 }
          cleanup
  %i.i = load ptr, ptr %3, align 8, !tbaa !63, !noalias !461 ; 2 uses
  %i.j = getelementptr inbounds nuw i8, ptr %3, i64 16 ; 2 uses
  %i.k = icmp eq ptr %i.i, %i.j
  br i1 %i.k, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit7.i, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i5.i

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i5.i: ; preds = %bb.c
  %i.l = load i64, ptr %i.j, align 8, !tbaa !59, !noalias !461
  %i.m = add i64 %i.l, 1
  call void @_ZdlPvm(ptr noundef %i.i, i64 noundef %i.m) #12
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit7.i

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit7.i: ; preds = %bb.c, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i5.i
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #11, !noalias !461
  resume { ptr, i32 } %i.h
...
; Function Attrs: mustprogress uwtable
define linkonce_odr void @_ZN8facebook5velox6Status7InvalidIJRA54_KcRimEEES1_DpOT_(ptr dead_on_unwind noalias writable sret(%"class.facebook::velox::Status") align 8 %0, ptr noundef nonnull align 1 dereferenceable(54) %1, ptr noundef nonnull align 4 dereferenceable(4) %2, ptr noundef nonnull align 8 dereferenceable(8) %3) local_unnamed_addr #0 comdat align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %4 = alloca %"class.std::__cxx11::basic_string", align 8 ; 8 uses
  %5 = alloca %"struct.fmt::v11::detail::format_arg_store.15", align 16 ; 6 uses
  %i.a = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %1) #11
  call void @llvm.lifetime.start.p0(ptr nonnull %4)
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #11, !noalias !464
  tail call void @llvm.experimental.noalias.scope.decl(metadata !467)
  %i.b = load i32, ptr %2, align 4, !tbaa !3, !noalias !470
  store i32 %i.b, ptr %5, align 16, !tbaa !59, !alias.scope !467, !noalias !464
  %i.c = getelementptr inbounds nuw i8, ptr %5, i64 16
  %i.d = load i64, ptr %3, align 8, !tbaa !22, !noalias !470
end_hunk_0
