...
vector.body74:                                    ; preds = %vector.body74, %vector.ph71
  ...
  %i.by = shl nuw nsw i64 %index75, 3
  %i.bz = getelementptr inbounds nuw i8, ptr %i.aj, i64 %i.by ; 4 uses
...
vec.epilog.vector.body98:                         ; preds = %vec.epilog.vector.body98, %vec.epilog.ph95
  ...
  %i.cu = shl nuw nsw i64 %index99, 3
  %i.cv = getelementptr inbounds nuw i8, ptr %i.aj, i64 %i.cu
