...
.critedge.i.preheader.us:                         ; preds = %.split.us.preheader, %.loopexit.us
  %i.h = phi i64 [ %i.bh, %.loopexit.us ], [ 0, %.split.us.preheader ] ; 2 uses
  %.052.us63 = phi i32 [ %i.bg, %.loopexit.us ], [ 0, %.split.us.preheader ]
...
.lr.ph.us:                                        ; preds = %.preheader.us.a, %bb.f
  ...
  %.019.us = phi i32 [ %i.an, %bb.f ], [ 0, %.preheader.us.a ]
...
bb.f:                                             ; preds = %bb.e, %.lr.ph.us
  %i.an = add nuw i32 %.019.us, 1                 ; 3 uses
  %i.ao = zext i32 %i.an to i64
  %.not67.not.us = icmp ult i32 %i.an, %i.bi
  br i1 %.not67.not.us, label %.lr.ph.us, label %.loopexit.us, !llvm.loop !45

bb.g:                                             ; preds = %bb.e
  %i.ap = load i32, ptr %i.ad, align 8, !tbaa !54
  %i.aq = zext i32 %i.ap to i64
  %i.ar = add i64 %.24.val, %i.aq
  br i1 %.not.i71, label %.split28.us, label %.critedge.i72.us

.critedge.i72.us:                                 ; preds = %bb.g, %.critedge27.i79.us
  %.020.i73.us = phi i64 [ %i.bc, %.critedge27.i79.us ], [ 0, %bb.g ] ; 6 uses
  %i.as = icmp ult i64 %.020.i73.us, %3
  br i1 %i.as, label %.preheader.i78.us, label %.critedge.thread33.i74.us

.preheader.i78.us:                                ; preds = %.critedge.i72.us
  %i.at = getelementptr inbounds nuw i8, ptr %2, i64 %.020.i73.us
  %i.au = sub nuw nsw i64 %3, %.020.i73.us
  %i.av = add i64 %i.ar, %.020.i73.us
  br label %bb.h

bb.h:                                             ; preds = %bb.i, %.preheader.i78.us
  %i.aw = tail call i64 @pread(i32 noundef %1, ptr noundef %i.at, i64 noundef %i.au, i64 noundef %i.av) ; 3 uses
  %i.ax = icmp slt i64 %i.aw, 0
  br i1 %i.ax, label %bb.i, label %.critedge27.i79.us

bb.i:                                             ; preds = %bb.h
  %i.ay = tail call ptr @__errno_location() #21
  %i.az = load i32, ptr %i.ay, align 4, !tbaa !11
  %i.ba = icmp eq i32 %i.az, 4
  br i1 %i.ba, label %bb.h, label %_ZN6googleL14ReadFromOffsetEiPvmm.exit80.thread.us, !llvm.loop !0

.critedge27.i79.us:                               ; preds = %bb.h
  %i.bb = icmp eq i64 %i.aw, 0
  %i.bc = add nuw i64 %i.aw, %.020.i73.us         ; 2 uses
  br i1 %i.bb, label %.critedge.thread33.i74.us, label %.critedge.i72.us

.critedge.thread33.i74.us:                        ; preds = %.critedge27.i79.us, %.critedge.i72.us
  %.2.i75.us = phi i64 [ %.020.i73.us, %.critedge.i72.us ], [ %i.bc, %.critedge27.i79.us ] ; 2 uses
...
_ZN6googleL14ReadFromOffsetEiPvmm.exit80.us:      ; preds = %.critedge.thread33.i74.us
  %i.bd = icmp slt i64 %.2.i75.us, 1
  br i1 %i.bd, label %_ZN6googleL14ReadFromOffsetEiPvmm.exit80.thread.us, label %bb.j

bb.j:                                             ; preds = %_ZN6googleL14ReadFromOffsetEiPvmm.exit80.us
  %i.be = tail call noundef ptr @memchr(ptr noundef %2, i32 noundef 0, i64 noundef %3) #22
  %i.bf = icmp eq ptr %i.be, null
  br i1 %i.bf, label %_ZN6googleL14ReadFromOffsetEiPvmm.exit80.thread.us, label %.loopexit.us.thread
