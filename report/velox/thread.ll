...
begin_hunk_0_@_ZN5boost16exception_detail27get_static_exception_objectINS0_10bad_alloc_EEENS_13exception_ptrEv:.noexc
  ...
  invoke void @_ZN5boost16exception_detail20copy_boost_exceptionEPNS_9exceptionEPKS1_(ptr noundef nonnull align 8 dereferenceable(48) %2, ptr noundef nonnull align 8 dereferenceable(48) %1)
          to label %bb.a unwind label %4

4:                                                ; preds = %.noexc
  %5 = landingpad { ptr, i32 }
          cleanup
  call void @_ZN5boost16exception_detail10bad_alloc_D2Ev(ptr noundef nonnull align 8 dereferenceable(48) %2) #33
  br label %.body.a
...
begin_hunk_2_@_ZN5boost16exception_detail27get_static_exception_objectINS0_10bad_alloc_EEENS_13exception_ptrEv:.noexc
  call void @_ZN5boost16exception_detail10clone_implINS0_10bad_alloc_EED1Ev(ptr noundef nonnull align 8 dereferenceable(48) %2) #33
  br label %.body.a

.body.a:                                          ; preds = %4, %bb.q
  %.pn8.pn.pn = phi { ptr, i32 } [ %.pn8, %bb.q ], [ %5, %4 ]
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #33
  call void @_ZN5boost16exception_detail10bad_alloc_D2Ev(ptr noundef nonnull align 8 dereferenceable(48) %1) #33
  call void @llvm.lifetime.end.p0(ptr nonnull %1) #33
end_hunk_2
...
4:                                                ; preds = %.noexc
  %5 = landingpad { ptr, i32 }
          cleanup
  call void @_ZN5boost16exception_detail14bad_exception_D2Ev(ptr noundef nonnull align 8 dereferenceable(48) %2) #33
  br label %.body.a
...
begin_hunk_5_@_ZN5boost16exception_detail27get_static_exception_objectINS0_14bad_exception_EEENS_13exception_ptrEv:.noexc
  call void @_ZN5boost16exception_detail10clone_implINS0_14bad_exception_EED1Ev(ptr noundef nonnull align 8 dereferenceable(48) %2) #33
  br label %.body.a

.body.a:                                          ; preds = %4, %bb.q
  %.pn8.pn.pn = phi { ptr, i32 } [ %.pn8, %bb.q ], [ %5, %4 ]
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #33
  call void @_ZN5boost16exception_detail14bad_exception_D2Ev(ptr noundef nonnull align 8 dereferenceable(48) %1) #33
  call void @llvm.lifetime.end.p0(ptr nonnull %1) #33
end_hunk_5
