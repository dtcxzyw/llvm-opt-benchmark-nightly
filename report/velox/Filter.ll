...
begin_hunk_0_@_ZNK8facebook5velox6common18NegatedBigintRange9mergeWithEPKNS1_6FilterE:bb.a
  ...
  %i.k = load i32, ptr %i.j, align 4, !tbaa !125  ; 2 uses
...
bb.b:                                             ; preds = %bb.a, %bb.a, %bb.a
  %i.l = load ptr, ptr %2, align 8, !tbaa !144
...
bb.d:                                             ; preds = %bb.a
  ...
  %i.p = load i8, ptr %i.o, align 8, !tbaa !127, !range !117, !noundef !118
  %i.q = trunc nuw i8 %i.p to i1
  br i1 %i.q, label %bb.e, label %bb.f

bb.e:                                             ; preds = %bb.d
  %i.r = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.s = load i8, ptr %i.r, align 8, !tbaa !127, !range !117, !noundef !118
...
bb.f:                                             ; preds = %bb.e, %bb.d
  ...
  %i.w = load i64, ptr %i.v, align 8, !tbaa !157  ; 6 uses
  %i.x = getelementptr inbounds nuw i8, ptr %2, i64 24
  %i.y = load i64, ptr %i.x, align 8, !tbaa !158  ; 6 uses
  %i.z = invoke noalias noundef nonnull dereferenceable(48) ptr @_Znwm(i64 noundef 48) #48
          to label %.noexc unwind label %bb.i, !inline_history !337 ; 15 uses

.noexc:                                           ; preds = %bb.f
  %i.aa = getelementptr inbounds nuw i8, ptr %i.z, i64 8
  store i8 0, ptr %i.aa, align 8, !tbaa !127, !noalias !1161
  %i.ab = getelementptr inbounds nuw i8, ptr %i.z, i64 9
  store i8 1, ptr %i.ab, align 1, !tbaa !126, !noalias !1161
  %i.ac = getelementptr inbounds nuw i8, ptr %i.z, i64 12
  store i32 5, ptr %i.ac, align 4, !tbaa !125, !noalias !1161
  store ptr getelementptr inbounds nuw inrange(-16, 232) (i8, ptr @_ZTVN8facebook5velox6common11BigintRangeE, i64 16), ptr %i.z, align 8, !tbaa !144, !noalias !1161
  %i.ad = getelementptr inbounds nuw i8, ptr %i.z, i64 16
  store i64 %i.w, ptr %i.ad, align 8, !tbaa !157, !noalias !1161
  %i.ae = getelementptr inbounds nuw i8, ptr %i.z, i64 24
  store i64 %i.y, ptr %i.ae, align 8, !tbaa !158, !noalias !1161
  ...
  store i32 %i.ag, ptr %i.af, align 8, !tbaa !159, !noalias !1161
  ...
  store i32 %i.ai, ptr %i.ah, align 4, !tbaa !160, !noalias !1161
  ...
  store i16 %i.ak, ptr %i.aj, align 8, !tbaa !161, !noalias !1161
  ...
  store i16 %i.am, ptr %i.al, align 2, !tbaa !162, !noalias !1161
  %i.an = getelementptr inbounds nuw i8, ptr %i.z, i64 44
  %i.ao = icmp eq i64 %i.y, %i.w
  %i.ap = zext i1 %i.ao to i8
  store i8 %i.ap, ptr %i.an, align 4, !tbaa !163, !noalias !1161
...
.thread.i.i:                                      ; preds = %.noexc
  store i8 0, ptr %i.aq, align 1, !tbaa !164, !noalias !1161
...
bb.g:                                             ; preds = %.noexc
  ...
  store i8 %i.as, ptr %i.aq, align 1, !tbaa !164, !noalias !1161
...
_ZNKSt6vectorISt10unique_ptrIN8facebook5velox6common11BigintRangeESt14default_deleteIS4_EESaIS7_EE12_M_check_lenEmPKc.exit.i: ; preds = %bb.h, %bb.g, %.thread.i.i
  ...
  store i8 %i.av, ptr %i.aw, align 2, !tbaa !165, !noalias !1161
...
_ZNSt10unique_ptrIN8facebook5velox6common11BigintRangeESt14default_deleteIS3_EED2Ev.exit: ; preds = %_ZNKSt6vectorISt10unique_ptrIN8facebook5velox6common11BigintRangeESt14default_deleteIS4_EESaIS7_EE12_M_check_lenEmPKc.exit.i
  ...
  store i64 %i.ba, ptr %i.ax, align 8, !tbaa !167
  %i.bb = getelementptr inbounds nuw i8, ptr %i.ax, i64 8 ; 2 uses
  store ptr %i.ax, ptr %3, align 8, !tbaa !234
  store ptr %i.bb, ptr %i.az, align 8, !tbaa !235
  store ptr %i.bb, ptr %i.ay, align 8, !tbaa !236
  %i.bc = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.bd = load ptr, ptr %i.bc, align 8, !tbaa !167 ; 2 uses
  %i.be = getelementptr inbounds nuw i8, ptr %i.bd, i64 16
  %i.bf = load i64, ptr %i.be, align 8, !tbaa !157
  %i.bg = getelementptr inbounds nuw i8, ptr %i.bd, i64 24
  %i.bh = load i64, ptr %i.bg, align 8, !tbaa !158
...
.lr.ph.i.i.i:                                     ; preds = %_ZNSt10unique_ptrIN8facebook5velox6common11BigintRangeESt14default_deleteIS3_EED2Ev.exit
  %i.bi = load ptr, ptr %i.ax, align 8, !tbaa !167 ; 2 uses
...
bb.p:                                             ; preds = %bb.n
  ...
  %i.cf = load i64, ptr %i.ce, align 8, !tbaa !158 ; 2 uses
...
bb.q:                                             ; preds = %bb.p
  ...
  %i.ci = load i64, ptr %i.bu, align 8, !tbaa !157 ; 2 uses
  %i.cj = load i64, ptr %i.by, align 8, !tbaa !157 ; 2 uses
  %i.ck = getelementptr inbounds nuw i8, ptr %i.bx, i64 24
  %i.cl = load i64, ptr %i.ck, align 8, !tbaa !158 ; 2 uses
...
bb.r:                                             ; preds = %bb.q
  ...
  store i64 -9223372036854775808, ptr %i.a, align 8, !tbaa !102
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #44
  %i.cm = add nsw i64 %i.ci, -1
  store i64 %i.cm, ptr %i.b, align 8, !tbaa !102
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c) #44
  store i8 0, ptr %i.c, align 1, !tbaa !116
...
bb.t:                                             ; preds = %bb.s
  %i.co = load ptr, ptr %5, align 8, !tbaa !167   ; 2 uses
...
bb.v:                                             ; preds = %bb.s
  %i.cq = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.cr = load ptr, ptr %5, align 8, !tbaa !167   ; 2 uses
...
bb.w:                                             ; preds = %bb.q, %_ZNSt10unique_ptrIN8facebook5velox6common11BigintRangeESt14default_deleteIS3_EED2Ev.exit75
  %.not166 = icmp eq i64 %i.cj, -9223372036854775808
  br i1 %.not166, label %bb.ac, label %bb.x

bb.x:                                             ; preds = %bb.w
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #44
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d) #44
  store i64 %i.cg, ptr %i.d, align 8, !tbaa !102
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e) #44
  %i.cs = add nsw i64 %i.cj, -1
  store i64 %i.cs, ptr %i.e, align 8, !tbaa !102
  call void @llvm.lifetime.start.p0(ptr nonnull %i.f) #44
  store i8 0, ptr %i.f, align 1, !tbaa !116
...
bb.z:                                             ; preds = %bb.y
  %i.cu = load ptr, ptr %6, align 8, !tbaa !167   ; 2 uses
...
bb.ab:                                            ; preds = %bb.y
  %i.cw = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.cx = load ptr, ptr %6, align 8, !tbaa !167   ; 2 uses
...
bb.ac:                                            ; preds = %_ZNSt10unique_ptrIN8facebook5velox6common11BigintRangeESt14default_deleteIS3_EED2Ev.exit81, %bb.w
  %.not166.a = icmp eq i64 %i.cl, 9223372036854775807
  br i1 %.not166.a, label %bb.ai, label %bb.ad
...
bb.ad:                                            ; preds = %bb.ac
  ...
  store i64 %i.cy, ptr %i.g, align 8, !tbaa !102
  call void @llvm.lifetime.start.p0(ptr nonnull %i.h) #44
  store i64 9223372036854775807, ptr %i.h, align 8, !tbaa !102
  call void @llvm.lifetime.start.p0(ptr nonnull %i.i) #44
  store i8 0, ptr %i.i, align 1, !tbaa !116
...
bb.af:                                            ; preds = %bb.ae
  %i.da = load ptr, ptr %7, align 8, !tbaa !167   ; 2 uses
...
bb.ah:                                            ; preds = %bb.ae
  %i.dc = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.dd = load ptr, ptr %7, align 8, !tbaa !167   ; 2 uses
...
bb.ai:                                            ; preds = %_ZNSt10unique_ptrIN8facebook5velox6common11BigintRangeESt14default_deleteIS3_EED2Ev.exit87, %bb.ac
  ...
  %i.df = load <2 x ptr>, ptr %4, align 16, !tbaa !237
  store <2 x ptr> %i.df, ptr %8, align 16, !tbaa !237
  %i.dg = getelementptr inbounds nuw i8, ptr %8, i64 16 ; 2 uses
  %i.dh = getelementptr inbounds nuw i8, ptr %4, i64 16 ; 2 uses
  %i.di = load ptr, ptr %i.dh, align 16, !tbaa !236
  store ptr %i.di, ptr %i.dg, align 16, !tbaa !236
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(24) %4, i8 0, i64 24, i1 false)
...
bb.aj:                                            ; preds = %bb.ai
  ...
  %i.dl = load ptr, ptr %8, align 16, !tbaa !234  ; 5 uses
  %i.dm = load ptr, ptr %i.dk, align 8, !tbaa !235 ; 2 uses
...
.lr.ph.i.i.i92:                                   ; preds = %bb.aj, %_ZSt8_DestroyISt10unique_ptrIN8facebook5velox6common11BigintRangeESt14default_deleteIS4_EEEvPT_.exit.i.i.i96
  ...
  %i.dn = load ptr, ptr %.05.i.i.i93, align 8, !tbaa !167 ; 2 uses
...
_ZSt8_DestroyISt10unique_ptrIN8facebook5velox6common11BigintRangeESt14default_deleteIS4_EEEvPT_.exit.i.i.i96: ; preds = %_ZNKSt14default_deleteIN8facebook5velox6common11BigintRangeEEclEPS3_.exit.i.i.i.i.i.i95, %.lr.ph.i.i.i92
  ...
  br i1 %.not.i.i.i97, label %_ZSt8_DestroyIPSt10unique_ptrIN8facebook5velox6common11BigintRangeESt14default_deleteIS4_EES7_EvT_S9_RSaIT0_E.exit.i100, label %.lr.ph.i.i.i92, !llvm.loop !17
...
bb.ak:                                            ; preds = %_ZSt8_DestroyIPSt10unique_ptrIN8facebook5velox6common11BigintRangeESt14default_deleteIS4_EES7_EvT_S9_RSaIT0_E.exit.i100
  %i.dp = load ptr, ptr %i.dg, align 16, !tbaa !236
...
_ZNSt6vectorISt10unique_ptrIN8facebook5velox6common11BigintRangeESt14default_deleteIS4_EESaIS7_EED2Ev.exit102: ; preds = %_ZSt8_DestroyIPSt10unique_ptrIN8facebook5velox6common11BigintRangeESt14default_deleteIS4_EES7_EvT_S9_RSaIT0_E.exit.i100, %bb.ak
  %i.dt = load ptr, ptr %4, align 16, !tbaa !234  ; 3 uses
  %i.du = load ptr, ptr %i.de, align 8, !tbaa !235 ; 2 uses
...
.lr.ph.i.i.i104:                                  ; preds = %_ZNSt6vectorISt10unique_ptrIN8facebook5velox6common11BigintRangeESt14default_deleteIS4_EESaIS7_EED2Ev.exit102, %_ZSt8_DestroyISt10unique_ptrIN8facebook5velox6common11BigintRangeESt14default_deleteIS4_EEEvPT_.exit.i.i.i108
  ...
  %i.dv = load ptr, ptr %.05.i.i.i105, align 8, !tbaa !167 ; 2 uses
...
_ZSt8_DestroyISt10unique_ptrIN8facebook5velox6common11BigintRangeESt14default_deleteIS4_EEEvPT_.exit.i.i.i108: ; preds = %_ZNKSt14default_deleteIN8facebook5velox6common11BigintRangeEEclEPS3_.exit.i.i.i.i.i.i107, %.lr.ph.i.i.i104
  ...
  br i1 %.not.i.i.i109, label %_ZSt8_DestroyIPSt10unique_ptrIN8facebook5velox6common11BigintRangeESt14default_deleteIS4_EES7_EvT_S9_RSaIT0_E.exitthread-pre-split.i110, label %.lr.ph.i.i.i104, !llvm.loop !17
...
_ZSt8_DestroyIPSt10unique_ptrIN8facebook5velox6common11BigintRangeESt14default_deleteIS4_EES7_EvT_S9_RSaIT0_E.exitthread-pre-split.i110: ; preds = %_ZSt8_DestroyISt10unique_ptrIN8facebook5velox6common11BigintRangeESt14default_deleteIS4_EEEvPT_.exit.i.i.i108
  %.pr.i111 = load ptr, ptr %4, align 16, !tbaa !234
...
bb.al:                                            ; preds = %_ZSt8_DestroyIPSt10unique_ptrIN8facebook5velox6common11BigintRangeESt14default_deleteIS4_EES7_EvT_S9_RSaIT0_E.exit.i112
  %i.dy = load ptr, ptr %i.dh, align 16, !tbaa !236
