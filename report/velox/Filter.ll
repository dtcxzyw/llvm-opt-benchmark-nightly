inline.NumInlined: 10426
inline.NumDeleted: 4078
begin_hunk_0_@_ZNK8facebook5velox6common18FloatingPointRangeIdE9mergeWithEPKNS1_6FilterE:bb.a
  ...
  %i.at = load <2 x double>, ptr %i.ap, align 8, !tbaa !118 ; 5 uses
  ...
  %i.ax = select <2 x i1> %i.aw, <2 x double> %i.as, <2 x double> %i.at ; 6 uses
...
end_hunk_0
begin_hunk_1_@_ZNK8facebook5velox6common18FloatingPointRangeIdE9mergeWithEPKNS1_6FilterE:bb.a
bb.m:                                             ; preds = %bb.l
  %i.bl = extractelement <2 x double> %i.ax, i64 0 ; 4 uses
  %i.bm = fcmp uno double %i.bl, 0.000000e+00
  br i1 %i.bm, label %_ZNK8facebook5velox6common18FloatingPointRangeIdE10testDoubleEd.exit, label %bb.n
...
end_hunk_1
begin_hunk_2_@_ZNK8facebook5velox6common18FloatingPointRangeIdE9mergeWithEPKNS1_6FilterE:bb.a
...
bb.q:                                             ; preds = %bb.p
end_hunk_2
begin_hunk_3_@_ZNK8facebook5velox6common18FloatingPointRangeIdE9mergeWithEPKNS1_6FilterE:bb.a
  %i.cd = zext i1 %i.cc to i8
  br label %_ZNK8facebook5velox6common18FloatingPointRangeIdE10testDoubleEd.exit.thread

_ZNK8facebook5velox6common18FloatingPointRangeIdE10testDoubleEd.exit.thread: ; preds = %bb.q, %bb.o, %bb.r, %_ZNK8facebook5velox6common18FloatingPointRangeIdE10testDoubleEd.exit, %_ZNK8facebook5velox6common18FloatingPointRangeIdE10testDoubleEd.exit.thread56, %bb.l
  %3 = phi i8 [ 0, %bb.l ], [ 1, %_ZNK8facebook5velox6common18FloatingPointRangeIdE10testDoubleEd.exit ], [ %i.cd, %_ZNK8facebook5velox6common18FloatingPointRangeIdE10testDoubleEd.exit.thread56 ], [ 1, %bb.r ], [ 1, %bb.o ], [ 1, %bb.q ]
...
end_hunk_3
begin_hunk_4_@_ZNK8facebook5velox6common18FloatingPointRangeIdE9mergeWithEPKNS1_6FilterE:bb.a
...
end_hunk_4
begin_hunk_5_@_ZNK8facebook5velox6common18FloatingPointRangeIfE9mergeWithEPKNS1_6FilterE:bb.a
  ...
  %i.at = load <2 x float>, ptr %i.ap, align 4, !tbaa !2154 ; 5 uses
  ...
  %i.ax = select <2 x i1> %i.aw, <2 x float> %i.as, <2 x float> %i.at ; 6 uses
  %i.ay = getelementptr inbounds nuw i8, ptr %1, i64 16 ; 2 uses
  %i.az = load i8, ptr %i.ay, align 8, !tbaa !225, !range !53, !noundef !57
  %i.ba = trunc nuw i8 %i.az to i1                ; 2 uses
end_hunk_5
begin_hunk_6_@_ZNK8facebook5velox6common18FloatingPointRangeIfE9mergeWithEPKNS1_6FilterE:bb.a
bb.m:                                             ; preds = %bb.l
  %i.bl = extractelement <2 x float> %i.ax, i64 0 ; 4 uses
  %i.bm = fcmp uno float %i.bl, 0.000000e+00
  br i1 %i.bm, label %_ZNK8facebook5velox6common18FloatingPointRangeIfE10testDoubleEd.exit, label %bb.n
...
bb.o:                                             ; preds = %bb.n
  %i.bn = getelementptr inbounds nuw i8, ptr %1, i64 17
end_hunk_6
begin_hunk_7_@_ZNK8facebook5velox6common18FloatingPointRangeIfE9mergeWithEPKNS1_6FilterE:bb.a
  %or.cond.i.i = and i1 %i.br, %i.bp
...
bb.q:                                             ; preds = %bb.p
end_hunk_7
begin_hunk_8_@_ZNK8facebook5velox6common18FloatingPointRangeIfE9mergeWithEPKNS1_6FilterE:bb.a
  %i.ce = zext i1 %i.cd to i8
  br label %_ZNK8facebook5velox6common18FloatingPointRangeIfE10testDoubleEd.exit.thread

_ZNK8facebook5velox6common18FloatingPointRangeIfE10testDoubleEd.exit.thread: ; preds = %bb.q, %bb.o, %bb.r, %_ZNK8facebook5velox6common18FloatingPointRangeIfE10testDoubleEd.exit, %_ZNK8facebook5velox6common18FloatingPointRangeIfE10testDoubleEd.exit.thread56, %bb.l
  %3 = phi i8 [ 0, %bb.l ], [ 1, %_ZNK8facebook5velox6common18FloatingPointRangeIfE10testDoubleEd.exit ], [ %i.ce, %_ZNK8facebook5velox6common18FloatingPointRangeIfE10testDoubleEd.exit.thread56 ], [ 1, %bb.r ], [ 1, %bb.o ], [ 1, %bb.q ]
...
end_hunk_8
begin_hunk_9_@_ZNK8facebook5velox6common18FloatingPointRangeIfE9mergeWithEPKNS1_6FilterE:bb.a
