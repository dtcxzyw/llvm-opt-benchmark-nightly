...
begin_hunk_1_@_ZN5folly10symbolizer25installFatalSignalHandlerESt6bitsetILm64EE:bb.a
  ...
  br i1 %.not28, label %._crit_edge, label %bb.o

._crit_edge:                                      ; preds = %.critedge18, %bb.n
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #20
  br label %bb.v

bb.o:                                             ; preds = %bb.n, %.critedge18
  %.01429 = phi ptr [ %i.ar, %.critedge18 ], [ @_ZN5folly10symbolizer12_GLOBAL__N_113kFatalSignalsE, %bb.n ] ; 4 uses
...
bb.s:                                             ; preds = %bb.r
  ...
  store <2 x i64> <i64 ptrtoint (ptr @_ZN6google10LogMessage9SendToLogEv to i64), i64 0>, ptr %i.a, align 16, !tbaa !57
