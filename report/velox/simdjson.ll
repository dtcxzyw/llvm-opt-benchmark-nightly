...
bb.d:                                             ; preds = %bb.c
  ...
  %i.s = lshr i32 %i.p, 2
  %i.t = and i32 %i.s, 64
  %3 = or disjoint i32 %2, %i.r
  %i.u = or disjoint i32 %3, %i.t
  %.3.i = or disjoint i32 %i.u, %spec.select.i    ; 2 uses
  %i.v = and i64 %i.l, 224
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.o = lshr i32 %i.l, 2
  %i.p = and i32 %i.o, 64
  %3 = or disjoint i32 %2, %i.n
  %i.q = or disjoint i32 %3, %i.p
  %.3.i = or disjoint i32 %i.q, %spec.select.i    ; 2 uses
  %i.r = and i64 %i.h, 224
