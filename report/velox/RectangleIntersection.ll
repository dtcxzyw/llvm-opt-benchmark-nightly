...
_ZN4geos9operation12intersection13clip_one_edgeERdS2_ddd.exit33.sink.split: ; preds = %bb.k, %bb.o
  ...
  store double %i.au, ptr %0, align 8, !tbaa !8
  store double %.sink59, ptr %1, align 8, !tbaa !8
...
_ZNK4geos9operation12intersection9Rectangle8positionEdd.exit: ; preds = %bb.c
  %i.r = load ptr, ptr %1, align 8, !tbaa !15, !noalias !17
  %i.s = getelementptr inbounds nuw i8, ptr %i.r, i64 416
  %i.t = load ptr, ptr %i.s, align 8, !noalias !17
  %i.u = tail call noundef ptr %i.t(ptr noundef nonnull align 8 dereferenceable(82) %1), !noalias !17, !inline_history !20
...
.lr.ph.preheader.preheader:                       ; preds = %.preheader540, %.outer.outer.backedge
  ...
  %i.w = load ptr, ptr %4, align 8, !tbaa !21     ; 2 uses
  %i.x = getelementptr inbounds nuw [24 x i8], ptr %i.w, i64 %.0171.ph.ph1746 ; 2 uses
  %i.y = load <2 x double>, ptr %i.x, align 8, !tbaa !8 ; 2 uses
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.outer.backedge
  ...
  %i.am = load double, ptr %.in, align 8, !tbaa !25 ; 4 uses
...
_ZNK4geos9operation12intersection9Rectangle8positionEdd.exit: ; preds = %.outer.backedge, %.lr.ph.preheader.preheader, %bb.h, %bb.i, %bb.j
  %.0159.ph8461637 = phi i8 [ %.0159.ph8461728, %bb.i ], [ %.0159.ph8461728, %bb.j ], [ %.0159.ph8461728, %bb.h ], [ %.0159.ph.ph1747, %.lr.ph.preheader.preheader ], [ %.0159.ph.be, %.outer.backedge ] ; 2 uses
  %.0171.ph8451626 = phi i64 [ %.0171.ph8451729, %bb.i ], [ %.0171.ph8451729, %bb.j ], [ %.0171.ph8451729, %bb.h ], [ %.0171.ph.ph1746, %.lr.ph.preheader.preheader ], [ %.5176, %.outer.backedge ] ; 4 uses
  %.0473.ph8441604 = phi double [ %.0473.ph8441730, %bb.i ], [ %.0473.ph8441730, %bb.j ], [ %.0473.ph8441730, %bb.h ], [ %.0473.ph.ph1745, %.lr.ph.preheader.preheader ], [ %.7, %.outer.backedge ] ; 5 uses
  %.0478.ph8431582 = phi double [ %.0478.ph8431731, %bb.i ], [ %.0478.ph8431731, %bb.j ], [ %.0478.ph8431731, %bb.h ], [ %.0478.ph.ph1744, %.lr.ph.preheader.preheader ], [ %.7485, %.outer.backedge ] ; 5 uses
  %.018.i = phi i32 [ %.0.i, %bb.i ], [ %i.az, %bb.j ], [ %i.ax, %bb.h ], [ 1, %.lr.ph.preheader.preheader ], [ 1, %.outer.backedge ]
  %i.ba = add nuw i64 %.0171.ph8451626, 1         ; 3 uses
  %i.bb = icmp ult i64 %i.ba, %i.d
  br i1 %i.bb, label %.lr.ph1739.preheader, label %.critedge10

.lr.ph1739.preheader:                             ; preds = %_ZNK4geos9operation12intersection9Rectangle8positionEdd.exit
  %13 = insertelement <2 x double> poison, double %.0473.ph8441604, i64 0
  %14 = insertelement <2 x double> %13, double %.0478.ph8431582, i64 1
  br label %.lr.ph1739
...
.lr.ph839:                                        ; preds = %.preheader, %bb.l
  ...
  %i.bf = load double, ptr %i.be, align 8, !tbaa !27
...
bb.l:                                             ; preds = %.lr.ph839
  ...
  br i1 %exitcond1158.not, label %.thread, label %.lr.ph839, !llvm.loop !28
...
bb.o:                                             ; preds = %.lr.ph834
  ...
  br i1 %exitcond1157.not, label %.thread, label %.lr.ph834, !llvm.loop !30
...
.lr.ph829:                                        ; preds = %.preheader536, %bb.q
  ...
  %i.bp = load double, ptr %i.bo, align 8, !tbaa !25
...
bb.q:                                             ; preds = %.lr.ph829
  ...
  br i1 %exitcond1156.not, label %.thread, label %.lr.ph829, !llvm.loop !31
...
.lr.ph825:                                        ; preds = %bb.r, %bb.s
  ...
  %i.bu = load double, ptr %i.bt, align 8, !tbaa !25
...
bb.s:                                             ; preds = %.lr.ph825
  ...
  br i1 %exitcond.not, label %.thread, label %.lr.ph825, !llvm.loop !32
...
bb.t:                                             ; preds = %.critedge
  ...
  %i.by = load double, ptr %i.bx, align 8, !tbaa !27 ; 22 uses
  %i.bz = getelementptr inbounds nuw i8, ptr %i.bx, i64 8
  %i.ca = load double, ptr %i.bz, align 8, !tbaa !25 ; 20 uses
...
_ZNK4geos9operation12intersection9Rectangle8positionEdd.exit220: ; preds = %bb.t, %bb.u, %bb.z, %bb.aa, %bb.ab
  ...
  %i.cq = load double, ptr %i.cp, align 8, !tbaa !27 ; 5 uses
  %i.cr = getelementptr i8, ptr %i.bx, i64 -16
  %i.cs = load double, ptr %i.cr, align 8, !tbaa !25 ; 3 uses
...
.noexc:                                           ; preds = %bb.bf
  store ptr %i.gj, ptr %5, align 8, !tbaa !21
  %i.gk = getelementptr inbounds nuw i8, ptr %i.gj, i64 48
  store ptr %i.gk, ptr %i.u, align 8, !tbaa !33
  ...
  store ptr %i.gn, ptr %i.v, align 8, !tbaa !34
  store double %.7, ptr %i.gj, align 8, !tbaa !8
  %.sroa.4408.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.gj, i64 8
  store double %.7485, ptr %.sroa.4408.0..sroa_idx, align 8, !tbaa !8
  store double +qnan, ptr %i.gl, align 8, !tbaa !8
  store double %.5491, ptr %i.gm, align 8, !tbaa !8
  %.sroa.4.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.gj, i64 32
  store double %.5499, ptr %.sroa.4.0..sroa_idx, align 8, !tbaa !8
  ...
  %i.go = load ptr, ptr %i.o, align 8, !tbaa !35  ; 2 uses
  %i.gp = load ptr, ptr %i.go, align 8, !tbaa !15
...
bb.bg:                                            ; preds = %.noexc
  %i.gs = load ptr, ptr %i.p, align 8, !tbaa !41
  %i.gt = load ptr, ptr %6, align 8, !tbaa !42
...
bb.bi:                                            ; preds = %bb.bh
  %i.gv = load ptr, ptr %6, align 8, !tbaa !42    ; 3 uses
...
_ZNKSt14default_deleteIN4geos4geom18CoordinateSequenceEEclEPS2_.exit.i: ; preds = %bb.bi
  ...
  call void %i.gy(ptr noundef nonnull align 8 dereferenceable(8) %i.gv) #17, !inline_history !44
...
_ZNSt10unique_ptrIN4geos4geom18CoordinateSequenceESt14default_deleteIS2_EED2Ev.exit: ; preds = %bb.bi, %_ZNKSt14default_deleteIN4geos4geom18CoordinateSequenceEEclEPS2_.exit.i
  ...
  %i.gz = load ptr, ptr %5, align 8, !tbaa !21    ; 2 uses
...
.outer.backedge:                                  ; preds = %_ZNSt6vectorIN4geos4geom10CoordinateESaIS2_EED2Ev.exit, %_ZNK4geos9operation12intersection9Rectangle8positionEdd.exit268
  ...
  %i.ha = load ptr, ptr %4, align 8, !tbaa !21    ; 2 uses
  %i.hb = getelementptr inbounds nuw [24 x i8], ptr %i.ha, i64 %.5176 ; 2 uses
  %i.hc = load <2 x double>, ptr %i.hb, align 8, !tbaa !8 ; 2 uses
...
bb.bm:                                            ; preds = %bb.bh, %bb.bg
  %i.hp = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.hq = load ptr, ptr %6, align 8, !tbaa !42    ; 3 uses
...
_ZNKSt14default_deleteIN4geos4geom18CoordinateSequenceEEclEPS2_.exit.i256: ; preds = %bb.bm
  ...
  call void %i.ht(ptr noundef nonnull align 8 dereferenceable(8) %i.hq) #17, !inline_history !44
  br label %_ZNSt10unique_ptrIN4geos4geom18CoordinateSequenceESt14default_deleteIS2_EED2Ev.exit257
...
_ZNSt10unique_ptrIN4geos4geom18CoordinateSequenceESt14default_deleteIS2_EED2Ev.exit257: ; preds = %_ZNKSt14default_deleteIN4geos4geom18CoordinateSequenceEEclEPS2_.exit.i256, %bb.bm, %bb.bl
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #17
  %i.hu = load ptr, ptr %5, align 8, !tbaa !21    ; 2 uses
...
.lr.ph1739:                                       ; preds = %.lr.ph1739.preheader, %_ZNK4geos9operation12intersection9Rectangle8positionEdd.exit277.thread
  %i.il = phi i64 [ %i.pc, %_ZNK4geos9operation12intersection9Rectangle8positionEdd.exit277.thread ], [ %i.ba, %.lr.ph1739.preheader ] ; 7 uses
  %.01838101738 = phi i64 [ %.1184, %_ZNK4geos9operation12intersection9Rectangle8positionEdd.exit277.thread ], [ %.0171.ph8451626, %.lr.ph1739.preheader ] ; 8 uses
  %.01818111737 = phi i32 [ %.1182, %_ZNK4geos9operation12intersection9Rectangle8positionEdd.exit277.thread ], [ %.018.i, %.lr.ph1739.preheader ] ; 2 uses
  %.61778121736 = phi i64 [ %i.il, %_ZNK4geos9operation12intersection9Rectangle8positionEdd.exit277.thread ], [ %.0171.ph8451626, %.lr.ph1739.preheader ] ; 3 uses
  %.21618131735 = phi i8 [ %.7166, %_ZNK4geos9operation12intersection9Rectangle8positionEdd.exit277.thread ], [ %.0159.ph8461637, %.lr.ph1739.preheader ] ; 5 uses
  %i.im = load ptr, ptr %4, align 8, !tbaa !21    ; 4 uses
  %i.in = getelementptr inbounds [24 x i8], ptr %i.im, i64 %i.il ; 4 uses
  %i.io = getelementptr inbounds nuw i8, ptr %i.in, i64 8
  %i.ip = load <2 x double>, ptr %i.in, align 8, !tbaa !8 ; 2 uses
  %i.iq = load double, ptr %i.io, align 8, !tbaa !25 ; 8 uses
...
_ZNK4geos9operation12intersection9Rectangle8positionEdd.exit277.thread508: ; preds = %bb.bx, %_ZNK4geos9operation12intersection9Rectangle8positionEdd.exit277
  ...
  %i.jo = load double, ptr %i.jn, align 8, !tbaa !27 ; 11 uses
  %i.jp = getelementptr inbounds nuw i8, ptr %i.jn, i64 8
  %i.jq = load double, ptr %i.jp, align 8, !tbaa !25 ; 11 uses
...
.noexc323:                                        ; preds = %_ZNKSt6vectorIN4geos4geom10CoordinateESaIS2_EE12_M_check_lenEmPKc.exit.i.i310
  ...
  store double %.11, ptr %i.ms, align 8, !tbaa !27
  %i.mt = getelementptr inbounds nuw i8, ptr %i.ms, i64 8
  store double %.11505, ptr %i.mt, align 8, !tbaa !25
  %i.mu = getelementptr inbounds nuw i8, ptr %i.ms, i64 16
  store double +qnan, ptr %i.mu, align 8, !tbaa !45
...
.lr.ph.i.i.i.i.i.i314:                            ; preds = %.noexc323, %.lr.ph.i.i.i.i.i.i314
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %.012.i.i.i.i.i.i315, ptr noundef nonnull align 8 dereferenceable(24) %.0911.i.i.i.i.i.i316, i64 24, i1 false), !tbaa.struct !47, !alias.scope !48
  ...
  br i1 %.not.i.i.i.i.i.i317, label %_ZNSt6vectorIN4geos4geom10CoordinateESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit33.i.i318, label %.lr.ph.i.i.i.i.i.i314, !llvm.loop !52
...
_ZNSt6vectorIN4geos4geom10CoordinateESaIS2_EE17_M_realloc_insertIJRdS6_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i321: ; preds = %bb.db, %_ZNSt6vectorIN4geos4geom10CoordinateESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit33.i.i318
  store ptr %i.mr, ptr %7, align 8, !tbaa !21
  store ptr %i.mx, ptr %i.q, align 8, !tbaa !34
  %i.my = getelementptr inbounds nuw [24 x i8], ptr %i.mr, i64 %i.mp
  store ptr %i.my, ptr %i.r, align 8, !tbaa !33
  br label %_ZNSt6vectorIN4geos4geom10CoordinateESaIS2_EE12emplace_backIJRdS6_EEEvDpOT_.exit324
...
_ZNSt6vectorIN4geos4geom10CoordinateESaIS2_EE12emplace_backIJRdS6_EEEvDpOT_.exit324: ; preds = %_ZNSt6vectorIN4geos4geom10CoordinateESaIS2_EE17_M_realloc_insertIJRdS6_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i321, %bb.cy, %bb.cw
  ...
  %i.na = load ptr, ptr %i.o, align 8, !tbaa !35  ; 2 uses
  %i.nb = load ptr, ptr %i.na, align 8, !tbaa !15
...
bb.dd:                                            ; preds = %_ZNSt6vectorIN4geos4geom10CoordinateESaIS2_EE12emplace_backIJRdS6_EEEvDpOT_.exit324
  %i.ne = load ptr, ptr %i.p, align 8, !tbaa !41
  %i.nf = load ptr, ptr %8, align 8, !tbaa !42
...
bb.df:                                            ; preds = %bb.de
  %i.nh = load ptr, ptr %8, align 8, !tbaa !42    ; 3 uses
...
_ZNKSt14default_deleteIN4geos4geom18CoordinateSequenceEEclEPS2_.exit.i326: ; preds = %bb.df
  %i.ni = load ptr, ptr %i.nh, align 8, !tbaa !15
  %i.nj = getelementptr inbounds nuw i8, ptr %i.ni, i64 8
  %i.nk = load ptr, ptr %i.nj, align 8
  call void %i.nk(ptr noundef nonnull align 8 dereferenceable(8) %i.nh) #17, !inline_history !44
...
_ZNSt10unique_ptrIN4geos4geom18CoordinateSequenceESt14default_deleteIS2_EED2Ev.exit327: ; preds = %bb.df, %_ZNKSt14default_deleteIN4geos4geom18CoordinateSequenceEEclEPS2_.exit.i326
  ...
  %i.nl = load ptr, ptr %7, align 8, !tbaa !21    ; 2 uses
...
bb.di:                                            ; preds = %bb.de, %bb.dd
  %i.nn = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.no = load ptr, ptr %8, align 8, !tbaa !42    ; 3 uses
...
_ZNKSt14default_deleteIN4geos4geom18CoordinateSequenceEEclEPS2_.exit.i331: ; preds = %bb.di
  %i.np = load ptr, ptr %i.no, align 8, !tbaa !15
  %i.nq = getelementptr inbounds nuw i8, ptr %i.np, i64 8
  %i.nr = load ptr, ptr %i.nq, align 8
  call void %i.nr(ptr noundef nonnull align 8 dereferenceable(8) %i.no) #17, !inline_history !44
  br label %_ZNSt10unique_ptrIN4geos4geom18CoordinateSequenceESt14default_deleteIS2_EED2Ev.exit332
...
bb.dj:                                            ; preds = %.loopexit529, %.loopexit.split-lp530, %_ZNSt10unique_ptrIN4geos4geom18CoordinateSequenceESt14default_deleteIS2_EED2Ev.exit332, %bb.dc
  ...
  %i.ns = load ptr, ptr %7, align 8, !tbaa !21    ; 2 uses
...
_ZNSt6vectorIN4geos4geom10CoordinateESaIS2_EE17_M_realloc_insertIJRdS6_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i347: ; preds = %_ZNKSt6vectorIN4geos4geom10CoordinateESaIS2_EE12_M_check_lenEmPKc.exit.i.i336
  store <2 x double> %14, ptr %i.nx, align 8, !tbaa !8
  %i.ny = getelementptr inbounds nuw i8, ptr %i.nx, i64 16
  store double +qnan, ptr %i.ny, align 8, !tbaa !45
  %i.nz = getelementptr inbounds nuw i8, ptr %i.nx, i64 24 ; 3 uses
  store ptr %i.nx, ptr %9, align 8, !tbaa !21
  store ptr %i.nz, ptr %i.m, align 8, !tbaa !34
  store ptr %i.nz, ptr %i.n, align 8, !tbaa !33
...
bb.do:                                            ; preds = %_ZNSt6vectorIN4geos4geom10CoordinateESaIS2_EE12emplace_backIJRdS6_EEEvDpOT_.exit350
  ...
  %i.oh = load ptr, ptr %i.o, align 8, !tbaa !35  ; 2 uses
  %i.oi = load ptr, ptr %i.oh, align 8, !tbaa !15
...
bb.dp:                                            ; preds = %bb.do
  %i.ol = load ptr, ptr %i.p, align 8, !tbaa !41
  %i.om = load ptr, ptr %10, align 8, !tbaa !42
...
bb.dr:                                            ; preds = %bb.dq
  %i.oo = load ptr, ptr %10, align 8, !tbaa !42   ; 3 uses
...
_ZNKSt14default_deleteIN4geos4geom18CoordinateSequenceEEclEPS2_.exit.i354: ; preds = %bb.dr
  %i.op = load ptr, ptr %i.oo, align 8, !tbaa !15
  %i.oq = getelementptr inbounds nuw i8, ptr %i.op, i64 8
  %i.or = load ptr, ptr %i.oq, align 8
  call void %i.or(ptr noundef nonnull align 8 dereferenceable(8) %i.oo) #17, !inline_history !44
...
_ZNSt10unique_ptrIN4geos4geom18CoordinateSequenceESt14default_deleteIS2_EED2Ev.exit355: ; preds = %bb.dr, %_ZNKSt14default_deleteIN4geos4geom18CoordinateSequenceEEclEPS2_.exit.i354
  ...
  %i.os = load ptr, ptr %9, align 8, !tbaa !21    ; 2 uses
...
bb.dv:                                            ; preds = %bb.dq, %bb.dp
  %i.ov = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.ow = load ptr, ptr %10, align 8, !tbaa !42   ; 3 uses
...
_ZNKSt14default_deleteIN4geos4geom18CoordinateSequenceEEclEPS2_.exit.i359: ; preds = %bb.dv
  %i.ox = load ptr, ptr %i.ow, align 8, !tbaa !15
  %i.oy = getelementptr inbounds nuw i8, ptr %i.ox, i64 8
  %i.oz = load ptr, ptr %i.oy, align 8
  call void %i.oz(ptr noundef nonnull align 8 dereferenceable(8) %i.ow) #17, !inline_history !44
  br label %_ZNSt10unique_ptrIN4geos4geom18CoordinateSequenceESt14default_deleteIS2_EED2Ev.exit360
...
thread-pre-split:                                 ; preds = %bb.dt, %_ZNSt10unique_ptrIN4geos4geom18CoordinateSequenceESt14default_deleteIS2_EED2Ev.exit360
  ...
  %.pr = load ptr, ptr %9, align 8, !tbaa !21
  br label %bb.dw
...
_ZNK4geos9operation12intersection9Rectangle8positionEdd.exit277.thread: ; preds = %.lr.ph1739, %_ZNSt6vectorIN4geos4geom10CoordinateESaIS2_EED2Ev.exit357, %bb.dm, %_ZNK4geos9operation12intersection9Rectangle8positionEdd.exit277, %bb.dl
  ...
  br i1 %i.pd, label %.lr.ph1739, label %..critedge10_crit_edge, !llvm.loop !53
...
.critedge10:                                      ; preds = %..critedge10_crit_edge, %_ZNK4geos9operation12intersection9Rectangle8positionEdd.exit
  %.2161813.lcssa = phi i8 [ %.7166, %..critedge10_crit_edge ], [ %.0159.ph8461637, %_ZNK4geos9operation12intersection9Rectangle8positionEdd.exit ] ; 2 uses
  %.6177812.lcssa = phi i1 [ %i.pe, %..critedge10_crit_edge ], [ false, %_ZNK4geos9operation12intersection9Rectangle8positionEdd.exit ]
  %.0183810.lcssa = phi i64 [ %.1184, %..critedge10_crit_edge ], [ %.0171.ph8451626, %_ZNK4geos9operation12intersection9Rectangle8positionEdd.exit ] ; 2 uses
...
_ZNSt6vectorIN4geos4geom10CoordinateESaIS2_EE17_M_realloc_insertIJRdS6_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i375: ; preds = %_ZNKSt6vectorIN4geos4geom10CoordinateESaIS2_EE12_M_check_lenEmPKc.exit.i.i364
  store double %.0473.ph8441604, ptr %i.ph, align 8, !tbaa !27
  %i.pi = getelementptr inbounds nuw i8, ptr %i.ph, i64 8
  store double %.0478.ph8431582, ptr %i.pi, align 8, !tbaa !25
  %i.pj = getelementptr inbounds nuw i8, ptr %i.ph, i64 16
  store double +qnan, ptr %i.pj, align 8, !tbaa !45
  %i.pk = getelementptr inbounds nuw i8, ptr %i.ph, i64 24 ; 3 uses
  store ptr %i.ph, ptr %11, align 8, !tbaa !21
  store ptr %i.pk, ptr %i.s, align 8, !tbaa !34
  store ptr %i.pk, ptr %i.t, align 8, !tbaa !33
...
_ZNSt6vectorIN4geos4geom10CoordinateESaIS2_EE12emplace_backIJRdS6_EEEvDpOT_.exit378: ; preds = %_ZNSt6vectorIN4geos4geom10CoordinateESaIS2_EE17_M_realloc_insertIJRdS6_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i375, %bb.dz
  ...
  %i.po = load ptr, ptr %4, align 8, !tbaa !46    ; 2 uses
...
bb.ea:                                            ; preds = %_ZNSt6vectorIN4geos4geom10CoordinateESaIS2_EE12emplace_backIJRdS6_EEEvDpOT_.exit378
  ...
  %i.pu = load ptr, ptr %i.o, align 8, !tbaa !35  ; 2 uses
...
bb.eb:                                            ; preds = %bb.ea
  %i.py = load ptr, ptr %i.p, align 8, !tbaa !41
  %i.pz = load ptr, ptr %12, align 8, !tbaa !42
