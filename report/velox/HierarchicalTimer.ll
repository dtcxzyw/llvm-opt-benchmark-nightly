...
.lr.ph:                                           ; preds = %bb.b, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEpLEPKc.exit
  ...
  %.038 = phi i64 [ %i.s, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEpLEPKc.exit ], [ 0, %bb.b ] ; 2 uses
  %2 = lshr i64 %.038, 6
  %i.t = getelementptr inbounds nuw [8 x i8], ptr %i.r, i64 %2
  %i.u = and i64 %.038, 63
  %i.v = shl nuw i64 1, %i.u
  %i.w = load i64, ptr %i.t, align 8, !tbaa !37
  %i.x = and i64 %i.w, %i.v
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEpLEPKc.exit: ; preds = %bb.e, %bb.d
  ...
  %i.am = add nuw nsw i64 %i.s, 1                 ; 2 uses
