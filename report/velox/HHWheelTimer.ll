...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.o = getelementptr inbounds nuw i8, ptr %i.n, i64 248 ; 2 uses
  %5 = getelementptr i8, ptr %0, i64 %i.m
  %i.p = getelementptr i8, ptr %5, i64 264
  ...
  %6 = insertelement <4 x ptr> poison, ptr %i.o, i64 0
  %i.u = insertelement <4 x ptr> %6, ptr %i.p, i64 1
  %i.v = insertelement <4 x ptr> %i.u, ptr %i.r, i64 2
  %7 = insertelement <4 x ptr> %i.v, ptr %i.t, i64 3
  %i.w = getelementptr i8, ptr %0, i64 %i.m
  %8 = getelementptr i8, ptr %i.w, i64 312        ; 2 uses
  %9 = getelementptr i8, ptr %0, i64 %i.m
  %i.x = getelementptr i8, ptr %9, i64 328
  ...
  %i.ac = insertelement <4 x ptr> %10, ptr %i.x, i64 1
  %i.ad = insertelement <4 x ptr> %i.ac, ptr %i.z, i64 2
  %11 = insertelement <4 x ptr> %i.ad, ptr %i.ab, i64 3
  %i.ae = getelementptr i8, ptr %0, i64 %i.m
  %12 = getelementptr i8, ptr %i.ae, i64 376      ; 2 uses
  %13 = getelementptr i8, ptr %0, i64 %i.m
  %i.af = getelementptr i8, ptr %13, i64 392
  ...
  %14 = insertelement <4 x ptr> poison, ptr %12, i64 0
  %i.ak = insertelement <4 x ptr> %14, ptr %i.af, i64 1
  %i.al = insertelement <4 x ptr> %i.ak, ptr %i.ah, i64 2
  %15 = insertelement <4 x ptr> %i.al, ptr %i.aj, i64 3
  %i.am = getelementptr i8, ptr %0, i64 %i.m
  %16 = getelementptr i8, ptr %i.am, i64 440      ; 2 uses
  %17 = getelementptr i8, ptr %0, i64 %i.m
  %18 = getelementptr i8, ptr %17, i64 456
  %i.an = getelementptr i8, ptr %0, i64 %i.m
  %i.ao = getelementptr i8, ptr %i.an, i64 472
  %i.ap = getelementptr i8, ptr %0, i64 %i.m
  %i.aq = getelementptr i8, ptr %i.ap, i64 488
  %19 = insertelement <4 x ptr> poison, ptr %16, i64 0
  %20 = insertelement <4 x ptr> %19, ptr %18, i64 1
  %i.ar = insertelement <4 x ptr> %20, ptr %i.ao, i64 2
  %i.as = insertelement <4 x ptr> %i.ar, ptr %i.aq, i64 3
  %interleaved.vec = shufflevector <4 x ptr> %7, <4 x ptr> poison, <8 x i32> <i32 0, i32 0, i32 1, i32 1, i32 2, i32 2, i32 3, i32 3>
  store <8 x ptr> %interleaved.vec, ptr %i.o, align 8, !tbaa !2390
  %interleaved.vec36 = shufflevector <4 x ptr> %11, <4 x ptr> poison, <8 x i32> <i32 0, i32 0, i32 1, i32 1, i32 2, i32 2, i32 3, i32 3>
  store <8 x ptr> %interleaved.vec36, ptr %8, align 8, !tbaa !2390
  %interleaved.vec37 = shufflevector <4 x ptr> %15, <4 x ptr> poison, <8 x i32> <i32 0, i32 0, i32 1, i32 1, i32 2, i32 2, i32 3, i32 3>
  store <8 x ptr> %interleaved.vec37, ptr %12, align 8, !tbaa !2390
  %interleaved.vec38 = shufflevector <4 x ptr> %i.as, <4 x ptr> poison, <8 x i32> <i32 0, i32 0, i32 1, i32 1, i32 2, i32 2, i32 3, i32 3>
  store <8 x ptr> %interleaved.vec38, ptr %16, align 8, !tbaa !2390
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %4 = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.k
  ...
  %5 = insertelement <4 x ptr> poison, ptr %i.m, i64 0
  %i.s = insertelement <4 x ptr> %5, ptr %i.n, i64 1
  %i.t = insertelement <4 x ptr> %i.s, ptr %i.p, i64 2
  %6 = insertelement <4 x ptr> %i.t, ptr %i.r, i64 3
  %i.u = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.k
  %7 = getelementptr inbounds nuw i8, ptr %i.u, i64 72 ; 2 uses
  %8 = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.k
  ...
  %i.aa = insertelement <4 x ptr> %9, ptr %i.v, i64 1
  %i.ab = insertelement <4 x ptr> %i.aa, ptr %i.x, i64 2
  %10 = insertelement <4 x ptr> %i.ab, ptr %i.z, i64 3
  %i.ac = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.k
  %11 = getelementptr inbounds nuw i8, ptr %i.ac, i64 136 ; 2 uses
  %12 = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.k
  %i.ad = getelementptr inbounds nuw i8, ptr %12, i64 152
  ...
  %13 = insertelement <4 x ptr> poison, ptr %11, i64 0
  %i.ai = insertelement <4 x ptr> %13, ptr %i.ad, i64 1
  %i.aj = insertelement <4 x ptr> %i.ai, ptr %i.af, i64 2
  %14 = insertelement <4 x ptr> %i.aj, ptr %i.ah, i64 3
  %i.ak = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.k
  %15 = getelementptr inbounds nuw i8, ptr %i.ak, i64 200 ; 2 uses
  %16 = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.k
  %17 = getelementptr inbounds nuw i8, ptr %16, i64 216
  %i.al = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.k
  ...
  %18 = insertelement <4 x ptr> poison, ptr %15, i64 0
  %19 = insertelement <4 x ptr> %18, ptr %17, i64 1
  %i.ap = insertelement <4 x ptr> %19, ptr %i.am, i64 2
  %i.aq = insertelement <4 x ptr> %i.ap, ptr %i.ao, i64 3
  %interleaved.vec = shufflevector <4 x ptr> %6, <4 x ptr> poison, <8 x i32> <i32 0, i32 0, i32 1, i32 1, i32 2, i32 2, i32 3, i32 3>
  store <8 x ptr> %interleaved.vec, ptr %i.m, align 8, !tbaa !2390, !noalias !2394
  %interleaved.vec144 = shufflevector <4 x ptr> %10, <4 x ptr> poison, <8 x i32> <i32 0, i32 0, i32 1, i32 1, i32 2, i32 2, i32 3, i32 3>
  store <8 x ptr> %interleaved.vec144, ptr %7, align 8, !tbaa !2390, !noalias !2394
  %interleaved.vec145 = shufflevector <4 x ptr> %14, <4 x ptr> poison, <8 x i32> <i32 0, i32 0, i32 1, i32 1, i32 2, i32 2, i32 3, i32 3>
  store <8 x ptr> %interleaved.vec145, ptr %11, align 8, !tbaa !2390, !noalias !2394
  %interleaved.vec146 = shufflevector <4 x ptr> %i.aq, <4 x ptr> poison, <8 x i32> <i32 0, i32 0, i32 1, i32 1, i32 2, i32 2, i32 3, i32 3>
  store <8 x ptr> %interleaved.vec146, ptr %15, align 8, !tbaa !2390, !noalias !2394
  %index.next = add nuw i64 %index, 16            ; 2 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %20 = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.au
  %21 = getelementptr inbounds nuw i8, ptr %20, i64 24
  %i.ax = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.au
  %i.ay = getelementptr inbounds nuw i8, ptr %i.ax, i64 40
  %i.az = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.au
  %i.ba = getelementptr inbounds nuw i8, ptr %i.az, i64 56
  %22 = insertelement <4 x ptr> poison, ptr %i.aw, i64 0
  %23 = insertelement <4 x ptr> %22, ptr %21, i64 1
  %i.bb = insertelement <4 x ptr> %23, ptr %i.ay, i64 2
  %i.bc = insertelement <4 x ptr> %i.bb, ptr %i.ba, i64 3
  %interleaved.vec150 = shufflevector <4 x ptr> %i.bc, <4 x ptr> poison, <8 x i32> <i32 0, i32 0, i32 1, i32 1, i32 2, i32 2, i32 3, i32 3>
  store <8 x ptr> %interleaved.vec150, ptr %i.aw, align 8, !tbaa !2390, !noalias !2394
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.aq = insertelement <4 x ptr> %i.ap, ptr %i.ao, i64 3
  %interleaved.vec = shufflevector <4 x ptr> %6, <4 x ptr> poison, <8 x i32> <i32 0, i32 0, i32 1, i32 1, i32 2, i32 2, i32 3, i32 3>
  store <8 x ptr> %interleaved.vec, ptr %i.m, align 8, !tbaa !2390, !noalias !2437
  %interleaved.vec144 = shufflevector <4 x ptr> %10, <4 x ptr> poison, <8 x i32> <i32 0, i32 0, i32 1, i32 1, i32 2, i32 2, i32 3, i32 3>
  store <8 x ptr> %interleaved.vec144, ptr %7, align 8, !tbaa !2390, !noalias !2437
  %interleaved.vec145 = shufflevector <4 x ptr> %14, <4 x ptr> poison, <8 x i32> <i32 0, i32 0, i32 1, i32 1, i32 2, i32 2, i32 3, i32 3>
  store <8 x ptr> %interleaved.vec145, ptr %11, align 8, !tbaa !2390, !noalias !2437
  %interleaved.vec146 = shufflevector <4 x ptr> %i.aq, <4 x ptr> poison, <8 x i32> <i32 0, i32 0, i32 1, i32 1, i32 2, i32 2, i32 3, i32 3>
  store <8 x ptr> %interleaved.vec146, ptr %15, align 8, !tbaa !2390, !noalias !2437
  %index.next = add nuw i64 %index, 16            ; 2 uses
  %i.ar = icmp eq i64 %index.next, %n.vec
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.bc = insertelement <4 x ptr> %i.bb, ptr %i.ba, i64 3
  %interleaved.vec150 = shufflevector <4 x ptr> %i.bc, <4 x ptr> poison, <8 x i32> <i32 0, i32 0, i32 1, i32 1, i32 2, i32 2, i32 3, i32 3>
  store <8 x ptr> %interleaved.vec150, ptr %i.aw, align 8, !tbaa !2390, !noalias !2437
  %index.next151 = add nuw i64 %index149, 4       ; 2 uses
  %i.bd = icmp eq i64 %index.next151, %n.vec148
