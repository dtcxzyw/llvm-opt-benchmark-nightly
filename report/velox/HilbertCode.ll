...
bb.a:
  ...
  %3 = and i32 %i.c, 1431655765                   ; 2 uses
  %4 = lshr i32 %3, 1
  %5 = or disjoint i32 %4, %3
  %6 = and i32 %5, 858993459                      ; 2 uses
  %7 = lshr i32 %6, 2
  %8 = or disjoint i32 %7, %6
  %9 = and i32 %8, 252645135                      ; 2 uses
  %10 = lshr i32 %9, 4
  %11 = or disjoint i32 %10, %9                   ; 2 uses
  %i.d = lshr i32 %11, 8
  %12 = and i32 %i.d, 65280
  %.masked.i = and i32 %11, 255
  %13 = or disjoint i32 %12, %.masked.i           ; 5 uses
  %14 = lshr i32 %i.c, 1
  %15 = and i32 %14, 1431655765                   ; 2 uses
  %16 = lshr i32 %15, 1
  %17 = or disjoint i32 %16, %15
  %18 = and i32 %17, 858993459                    ; 2 uses
  %19 = lshr i32 %18, 2
  %20 = or disjoint i32 %19, %18
  %21 = and i32 %20, 252645135                    ; 2 uses
  %22 = lshr i32 %21, 4
  %23 = or disjoint i32 %22, %21                  ; 2 uses
  %24 = lshr i32 %23, 8
  %25 = and i32 %24, 65280
  %.masked.i22 = and i32 %23, 255
  %26 = or disjoint i32 %25, %.masked.i22         ; 3 uses
  %27 = xor i32 %13, 65535
  %i.e = or i32 %26, %13
  %i.f = and i32 %26, %13
  ...
  %i.r = insertelement <2 x i32> %28, i32 %13, i64 1
  %i.s = and <2 x i32> %i.q, %i.r
  %29 = tail call i32 @llvm.vector.reduce.or.v2i32(<2 x i32> %i.s)
  %i.t = getelementptr inbounds nuw i8, ptr %0, i64 16
  store double +qnan, ptr %i.t, align 8, !tbaa !20
  %30 = xor i32 %29, %26                          ; 2 uses
