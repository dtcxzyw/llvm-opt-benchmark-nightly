...
bb.a:
  ...
  %3 = or disjoint i32 %i.aa, %.masked.i22        ; 3 uses
  %i.ab = or i32 %3, %i.o
  %i.ac = xor i32 %i.ab, 65535                    ; 2 uses
  %4 = and i32 %3, %i.o                           ; 2 uses
  %5 = lshr i32 %i.ac, 8
  %6 = xor i32 %5, %i.ac                          ; 2 uses
  %7 = lshr i32 %6, 4
  ...
  %12 = xor i32 %11, %10
  %13 = lshr i32 %4, 8
  %14 = xor i32 %13, %4                           ; 2 uses
  %15 = lshr i32 %14, 4
  %16 = xor i32 %15, %14                          ; 2 uses
  %17 = lshr i32 %16, 2
  %18 = xor i32 %17, %16                          ; 2 uses
  %19 = lshr i32 %18, 1
  %20 = xor i32 %19, %18
  %21 = xor i32 %i.o, 65535
  %22 = and i32 %20, %21
  %23 = and i32 %12, %i.o
  %24 = or i32 %23, %22
  %i.ad = getelementptr inbounds nuw i8, ptr %0, i64 16
  store double +qnan, ptr %i.ad, align 8, !tbaa !20
  %i.ae = xor i32 %24, %3                         ; 2 uses
