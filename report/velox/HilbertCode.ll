...
begin_hunk_0_@_ZN4geos5shape7fractal11HilbertCode10interleaveEj:bb.a
...
bb.a:
  ...
  %7 = xor <2 x i32> %6, <i32 0, i32 65535>       ; 2 uses
  ...
  %13 = xor <2 x i32> %12, %11                    ; 2 uses
  %14 = lshr <2 x i32> %13, splat (i32 1)
  %15 = xor <2 x i32> %14, %13
  %16 = insertelement <2 x i32> poison, i32 %i.ac, i64 0
  %17 = insertelement <2 x i32> %16, i32 %i.o, i64 1
  %18 = and <2 x i32> %15, %17                    ; 2 uses
  %shift = shufflevector <2 x i32> %18, <2 x i32> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop = or <2 x i32> %shift, %18
  %19 = extractelement <2 x i32> %foldExtExtBinop, i64 0
  %i.ad = getelementptr inbounds nuw i8, ptr %0, i64 16
  store double +qnan, ptr %i.ad, align 8, !tbaa !20
  %i.ae = xor i32 %19, %i.ab                      ; 2 uses
  %i.af = sub i32 16, %1                          ; 2 uses
  %i.ag = lshr i32 %i.ae, %i.af
  %i.ah = uitofp nneg i32 %i.ag to double
  store double %i.ah, ptr %0, align 8, !tbaa !23
  %i.ai = xor i32 %i.ae, %i.o
  %i.aj = lshr i32 %i.ai, %i.af
  %i.ak = uitofp nneg i32 %i.aj to double
  %i.al = getelementptr inbounds nuw i8, ptr %0, i64 8
  store double %i.ak, ptr %i.al, align 8, !tbaa !24
  ret void
}
...
bb.a:
  ...
  %i.cs = extractelement <2 x i32> %foldExtExtBinop, i64 0
  %i.ct = shl i32 %0, 1
