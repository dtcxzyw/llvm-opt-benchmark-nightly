...
define noundef i32 @_ZN4geos5shape7fractal11HilbertCode9levelSizeEj(i32 noundef %0) local_unnamed_addr #0 align 2 {
bb.a:
  %i.a = shl i32 %0, 1
...
; Function Attrs: mustprogress uwtable
define noundef i32 @_ZN4geos5shape7fractal11HilbertCode11maxOrdinateEj(i32 noundef %0) local_unnamed_addr #0 align 2 {
bb.a:
...
; Function Attrs: mustprogress uwtable
define noundef range(i32 0, -2147483647) i32 @_ZN4geos5shape7fractal11HilbertCode5levelEj(i32 noundef %0) local_unnamed_addr #0 align 2 {
bb.a:
  %i.a = uitofp i32 %0 to double
  %i.b = tail call noundef double @log(double noundef %i.a) #13
...
bb.d:                                             ; preds = %bb.c
  invoke void @__cxa_throw(ptr nonnull %i.b, ptr nonnull @_ZTIN4geos4util24IllegalArgumentExceptionE, ptr nonnull @_ZNSt13runtime_errorD2Ev) #14
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %bb.e
  call void @_ZdlPv(ptr noundef %i.e) #15
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #13
  call void @llvm.lifetime.end.p0(ptr nonnull %1) #13
...
bb.f:                                             ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.thread, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  ...
  call void @__cxa_free_exception(ptr %i.b) #13
  br label %bb.h
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i5: ; preds = %bb.b
  call void @_ZdlPv(ptr noundef %i.k) #15
...
bb.a:
  ...
  %i.e = lshr i32 %i.d, 1
  %i.f = or disjoint i32 %i.e, %i.d
  %i.g = and i32 %i.f, 858993459                  ; 2 uses
  %i.h = lshr i32 %i.g, 2
  %i.i = or disjoint i32 %i.h, %i.g
  %i.j = and i32 %i.i, 252645135                  ; 2 uses
  %i.k = lshr i32 %i.j, 4
  ...
  %i.p = lshr i32 %i.c, 1
  %i.q = and i32 %i.p, 1431655765                 ; 2 uses
  %i.r = lshr i32 %i.q, 1
  %i.s = or disjoint i32 %i.r, %i.q
  %i.t = and i32 %i.s, 858993459                  ; 2 uses
  %i.u = lshr i32 %i.t, 2
  %i.v = or disjoint i32 %i.u, %i.t
  %i.w = and i32 %i.v, 252645135                  ; 2 uses
  %i.x = lshr i32 %i.w, 4
  %i.y = or disjoint i32 %i.x, %i.w               ; 2 uses
  %i.z = lshr i32 %i.y, 8
  %i.aa = and i32 %i.z, 65280
  %.masked.i22 = and i32 %i.y, 255
  %i.ab = or disjoint i32 %i.aa, %.masked.i22     ; 3 uses
  %i.ac = xor i32 %i.o, 65535
  %i.ad = or i32 %i.ab, %i.o
  %i.ae = and i32 %i.ab, %i.o
  %i.af = insertelement <2 x i32> poison, i32 %i.ae, i64 0
  %i.ag = insertelement <2 x i32> %i.af, i32 %i.ad, i64 1
  %i.ah = xor <2 x i32> %i.ag, <i32 0, i32 65535> ; 2 uses
  %i.ai = lshr <2 x i32> %i.ah, splat (i32 8)
  %i.aj = xor <2 x i32> %i.ai, %i.ah              ; 2 uses
  %i.ak = lshr <2 x i32> %i.aj, splat (i32 4)
  %i.al = xor <2 x i32> %i.ak, %i.aj              ; 2 uses
  %i.am = lshr <2 x i32> %i.al, splat (i32 2)
  %i.an = xor <2 x i32> %i.am, %i.al              ; 2 uses
  %i.ao = lshr <2 x i32> %i.an, splat (i32 1)
  %i.ap = xor <2 x i32> %i.ao, %i.an
  %i.aq = insertelement <2 x i32> poison, i32 %i.ac, i64 0
  %i.ar = insertelement <2 x i32> %i.aq, i32 %i.o, i64 1
  %i.as = and <2 x i32> %i.ap, %i.ar              ; 2 uses
  %shift = shufflevector <2 x i32> %i.as, <2 x i32> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop = or <2 x i32> %shift, %i.as
  %3 = extractelement <2 x i32> %foldExtExtBinop, i64 0
  %i.at = getelementptr inbounds nuw i8, ptr %0, i64 16
  store double +qnan, ptr %i.at, align 8, !tbaa !20
  %i.au = xor i32 %3, %i.ab                       ; 2 uses
  %i.av = sub i32 16, %1                          ; 2 uses
  %i.aw = lshr i32 %i.au, %i.av
  %i.ax = uitofp nneg i32 %i.aw to double
  store double %i.ax, ptr %0, align 8, !tbaa !23
  %i.ay = xor i32 %i.au, %i.o
  %i.az = lshr i32 %i.ay, %i.av
  %i.ba = uitofp nneg i32 %i.az to double
  %i.bb = getelementptr inbounds nuw i8, ptr %0, i64 8
  store double %i.ba, ptr %i.bb, align 8, !tbaa !24
  ret void
}
...
bb.a:
  ...
  %i.cr = and <2 x i32> %i.cq, <i32 -1431655766, i32 1431655765> ; 2 uses
  %shift = shufflevector <2 x i32> %i.cr, <2 x i32> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop = or disjoint <2 x i32> %i.cr, %shift
  %3 = extractelement <2 x i32> %foldExtExtBinop, i64 0
  %i.cs = shl i32 %0, 1
  %i.ct = sub i32 32, %i.cs
  %i.cu = lshr i32 %3, %i.ct
  ret i32 %i.cu
}
...
.noexc6:                                          ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendERKS4_.exit.i
  ...
  store ptr %i.y, ptr %3, align 8, !tbaa !14, !alias.scope !31
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %.noexc6
  store ptr %i.z, ptr %3, align 8, !tbaa !8, !alias.scope !31
  %i.ag = load i64, ptr %i.aa, align 8, !tbaa !16
  store i64 %i.ag, ptr %i.y, align 8, !tbaa !16, !alias.scope !31
...
bb.f:                                             ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i, %bb.e
  ...
  store i64 %i.ah, ptr %i.aj, align 8, !tbaa !17, !alias.scope !31
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i7: ; preds = %bb.g
  call void @_ZdlPv(ptr noundef %i.ak) #15
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i8: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  call void @_ZdlPv(ptr noundef %i.am) #15
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i11: ; preds = %bb.i
  call void @_ZdlPv(ptr noundef %i.aq) #15
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit13
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i14: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit13
  call void @_ZdlPv(ptr noundef %i.as) #15
...
attributes #5 = { mustprogress nocallback nofree nosync nounwind willreturn memory(errnomem: write) "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+avx,+avx2,+bmi2,+cmov,+crc32,+cx8,+f16c,+fma,+fxsr,+lzcnt,+mmx,+popcnt,+sse,+sse2,+sse3,+sse4.1,+sse4.2,+ssse3,+x87,+xsave" "tune-cpu"="generic" }
