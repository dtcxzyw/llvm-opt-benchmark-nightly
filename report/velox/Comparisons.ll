...
.lr.ph.i.preheader.i:                             ; preds = %bb.cw
  %69 = icmp eq i32 %i.od, %i.of
  %.neg.i.i = sext i1 %69 to i8
  br label %.lr.ph.i.i
...
begin_hunk_1
  ...
  store i8 %.neg.i.i, ptr %i.ou, align 1, !tbaa !32
...
.lr.ph.i.preheader.i164:                          ; preds = %bb.hb
  %70 = icmp eq i8 %i.ahr, %i.aht
  %.neg.i.i165 = sext i1 %70 to i32
...
begin_hunk_3
  ...
  store i32 %.neg.i.i165, ptr %i.aii, align 4, !tbaa !3
...
iter.check:                                       ; preds = %bb.pl
  %71 = icmp eq i64 %i.bvv, %i.bvx
  %72 = select i1 %71, i8 15, i8 0                ; 4 uses
  %i.bvy = shl nuw i8 %72, 4                      ; 3 uses
...
begin_hunk_5
  ...
  %broadcast.splatinsert = insertelement <32 x i8> poison, i8 %72, i64 0
...
begin_hunk_6
  ...
  %broadcast.splatinsert1440 = insertelement <8 x i8> poison, i8 %72, i64 0
...
begin_hunk_7
  ...
  %spec.select.i = or disjoint i8 %i.cex, %72
...
.lr.ph.i.preheader.i:                             ; preds = %bb.cw
  ...
  %.neg.i.i = sext i1 %.scalar.i.i.a to i8
  br label %.lr.ph.i.i
...
begin_hunk_9
  ...
  store i8 %.neg.i.i, ptr %i.ot, align 1, !tbaa !32
...
.lr.ph.i.preheader.i168:                          ; preds = %bb.hb
  ...
  %.neg.i.i169 = sext i1 %.scalar.i.i169 to i32
...
begin_hunk_11
  ...
  store i32 %.neg.i.i169, ptr %i.aid, align 4, !tbaa !3
...
iter.check:                                       ; preds = %bb.pl
  %.not40.i.i = icmp eq i64 %i.bvh, %i.bvj
  %69 = select i1 %.not40.i.i, i8 0, i8 15        ; 4 uses
  %i.bvk = shl nuw i8 %69, 4                      ; 3 uses
...
begin_hunk_13
  ...
  %broadcast.splatinsert = insertelement <32 x i8> poison, i8 %69, i64 0
  %broadcast.splat = shufflevector <32 x i8> %broadcast.splatinsert, <32 x i8> poison, <32 x i32> zeroinitializer
...
begin_hunk_14
  ...
  %broadcast.splatinsert1451 = insertelement <8 x i8> poison, i8 %69, i64 0
...
begin_hunk_15
  ...
  %spec.select.i = or disjoint i8 %i.cei, %69
...
begin_hunk_30
  ...
  %i.ccj = add i32 %i.bvn, %i.cci
  %broadcast.splatinsert1414 = insertelement <8 x i8> poison, i8 %72, i64 0
...
iter.check:                                       ; preds = %bb.pl
  %.not40.i.i = icmp slt i64 %i.bvj, %i.bvh
  %69 = select i1 %.not40.i.i, i8 0, i8 15        ; 4 uses
  %i.bvk = shl nuw i8 %69, 4                      ; 3 uses
  %i.bvl = add i32 %i.buz, 8
  %umax = tail call i32 @llvm.umax.i32(i32 %i.bvd, i32 %i.bvl)
...
begin_hunk_38
  ...
  %i.cbv = add i32 %i.buz, %i.cbu
  %broadcast.splatinsert1443 = insertelement <8 x i8> poison, i8 %69, i64 0
...
iter.check:                                       ; preds = %bb.pl
  %.not40.i.i = icmp slt i64 %i.bvh, %i.bvj
  %69 = select i1 %.not40.i.i, i8 0, i8 15        ; 4 uses
  %i.bvk = shl nuw i8 %69, 4                      ; 3 uses
  %i.bvl = add i32 %i.buz, 8
  %umax = tail call i32 @llvm.umax.i32(i32 %i.bvd, i32 %i.bvl)
