...
vector.ph706:                                     ; preds = %vector.main.loop.iter.check704
  ...
  %39 = load i32, ptr %i.ez, align 4, !tbaa !3, !alias.scope !855
  %broadcast.splatinsert.a = insertelement <8 x i32> poison, i32 %39, i64 0
  %broadcast.splat = shufflevector <8 x i32> %broadcast.splatinsert.a, <8 x i32> poison, <8 x i32> zeroinitializer ; 4 uses
  %40 = add i32 %i.ct, %n.vec708
  %41 = insertelement <8 x i32> <i32 poison, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0>, i32 %.pre39.i, i64 0
...
vector.body709:                                   ; preds = %vector.body709, %vector.ph706
  ...
  %vec.phi711 = phi <8 x i32> [ %41, %vector.ph706 ], [ %i.fc, %vector.body709 ]
...
begin_hunk_1_@_ZNK8facebook5velox9functions12_GLOBAL__N_117MapConcatFunctionILb1ELb0EE5applyERKNS0_17SelectivityVectorERSt6vectorISt10shared_ptrINS0_10BaseVectorEESaISB_EERKS9_IKNS0_4TypeEERNS0_4exec7EvalCtxERSB_:bb.a
  ...
  %broadcast.splatinsert733.a = insertelement <4 x i32> poison, i32 %42, i64 0
  %broadcast.splat734 = shufflevector <4 x i32> %broadcast.splatinsert733.a, <4 x i32> poison, <4 x i32> zeroinitializer
  %43 = add i32 %i.ct, %n.vec729
  %44 = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %bc.merge.rdx722, i64 0
...
vec.epilog.vector.body730:                        ; preds = %vec.epilog.vector.body730, %vec.epilog.ph727
  ...
  %vec.phi732 = phi <4 x i32> [ %44, %vec.epilog.ph727 ], [ %i.fi, %vec.epilog.vector.body730 ]
...
_ZNK8facebook5velox13DecodedVector8isNullAtEi.exit.thread.i.us.us14.i.preheader: ; preds = %vector.memcheck697, %iter.check723, %vec.epilog.iter.check725, %vec.epilog.middle.block736
  ...
  %.012.us.us15.i.ph = phi i32 [ %i.ct, %iter.check723 ], [ %i.ct, %vector.memcheck697 ], [ %40, %vec.epilog.iter.check725 ], [ %43, %vec.epilog.middle.block736 ] ; 4 uses
