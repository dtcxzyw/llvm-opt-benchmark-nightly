...
begin_hunk_1_@_ZNK4geos9operation8geounion18PointGeometryUnion5UnionEv:bb.a
  ...
  %i.r = invoke noundef ptr %i.q(ptr noundef nonnull align 8 dereferenceable(40) %i.n, i64 noundef %.053)
          to label %bb.d unwind label %6          ; 2 uses

bb.d:                                             ; preds = %bb.c
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %i.r) ]
  %5 = call ptr @__dynamic_cast(ptr nonnull %i.r, ptr nonnull @_ZTIN4geos4geom8GeometryE, ptr nonnull @_ZTIN4geos4geom5PointE, i64 0) #17 ; 4 uses
  %i.s = load ptr, ptr %5, align 8, !tbaa !24
  %i.t = getelementptr inbounds nuw i8, ptr %i.s, i64 104
  %i.u = load ptr, ptr %i.t, align 8
  %i.v = invoke noundef zeroext i1 %i.u(ptr noundef nonnull align 8 dereferenceable(82) %5)
          to label %bb.e unwind label %6
...
bb.f:                                             ; preds = %bb.e
  %i.w = load ptr, ptr %5, align 8, !tbaa !24
  %i.x = getelementptr inbounds nuw i8, ptr %i.w, i64 32
  %i.y = load ptr, ptr %i.x, align 8
  %i.z = invoke noundef ptr %i.y(ptr noundef nonnull align 8 dereferenceable(82) %5)
...
begin_hunk_4_@_ZNK4geos9operation8geounion18PointGeometryUnion5UnionEv:bb.a
  ...
  %i.bz = call noundef ptr @_ZSt18_Rb_tree_incrementPKSt18_Rb_tree_node_base(ptr noundef %.sroa.03.07.i.i.i.i.i) #20 ; 2 uses
...
bb.r:                                             ; preds = %_ZNSt10unique_ptrIN4geos4geom8GeometryESt14default_deleteIS2_EE5resetEPS2_.exit37
  call void @_ZdlPv(ptr noundef nonnull %i.cd) #21
...
bb.u:                                             ; preds = %bb.t
  call void @_ZdlPv(ptr noundef nonnull %i.cg) #21
...
begin_hunk_7_@_ZNK4geos9operation8geounion18PointGeometryUnion5UnionEv:bb.a
  ...
  call void %i.cl(ptr noundef nonnull align 8 dead_on_return(40) dereferenceable(40) %.sroa.044.0) #17, !inline_history !49
...
begin_hunk_8_@_ZNK4geos9operation8geounion18PointGeometryUnion5UnionEv:bb.a
  ...
  call void %i.cp(ptr noundef nonnull align 8 dead_on_return(40) dereferenceable(40) %.sroa.044.0) #17, !inline_history !49
  br label %_ZNSt10unique_ptrIN4geos4geom8GeometryESt14default_deleteIS2_EED2Ev.exit42
...
_ZNSt10unique_ptrIN4geos4geom8GeometryESt14default_deleteIS2_EED2Ev.exit42: ; preds = %_ZNSt6vectorIN4geos4geom10CoordinateESaIS2_EED2Ev.exit39, %bb.o, %_ZNKSt14default_deleteIN4geos4geom8GeometryEEclEPS2_.exit.i41, %bb.w, %bb.b, %bb.j, %bb.k, %6, %bb.m
  %.pn26.pn.pn.pn = phi { ptr, i32 } [ %i.ae, %bb.j ], [ %i.an, %bb.m ], [ %i.m, %bb.b ], [ %7, %6 ], [ %i.af, %bb.k ], [ %i.cm, %_ZNKSt14default_deleteIN4geos4geom8GeometryEEclEPS2_.exit.i41 ], [ %i.cm, %bb.w ], [ %.pn, %_ZNSt6vectorIN4geos4geom10CoordinateESaIS2_EED2Ev.exit39 ], [ %i.at, %bb.o ]
  call void @_ZNSt3setIN4geos4geom10CoordinateESt4lessIS2_ESaIS2_EED2Ev(ptr noundef nonnull align 8 dead_on_return(48) dereferenceable(48) %3) #17
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #17
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #17
...
bb.e:                                             ; preds = %._crit_edge.thread.i
  %i.r = tail call noundef ptr @_ZSt18_Rb_tree_decrementPSt18_Rb_tree_node_base(ptr noundef nonnull %.021.lcssa37.i) #20 ; 2 uses
...
_ZNSt8_Rb_treeIN4geos4geom10CoordinateES2_St9_IdentityIS2_ESt4lessIS2_ESaIS2_EE10_M_insert_IRKS2_NS8_11_Alloc_nodeEEESt17_Rb_tree_iteratorIS2_EPSt18_Rb_tree_node_baseSG_OT_RT0_.exit: ; preds = %bb.h, %bb.i, %bb.j, %bb.k, %bb.l
  ...
  %i.an = tail call noalias noundef nonnull dereferenceable(56) ptr @_Znwm(i64 noundef 56) #19 ; 3 uses
  ...
  tail call void @_ZSt29_Rb_tree_insert_and_rebalancebPSt18_Rb_tree_node_baseS0_RS_(i1 noundef zeroext %i.am, ptr noundef nonnull %i.an, ptr noundef nonnull %.sroa.4.0.i.ph, ptr noundef nonnull align 8 dereferenceable(32) %i.b) #17
