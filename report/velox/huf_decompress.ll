...
begin_hunk_3_@HUF_decompress4X2_usingDTable_internal_fast:bb.a
  ...
  br i1 %i.dq, label %BIT_reloadDStream.exit73.loopexit, label %bb.g, !prof !144, !llvm.loop !111
...
begin_hunk_5_@HUF_decompress4X1_usingDTable_internal_fast_c_loop:bb.a
  ...
  br i1 %i.ad, label %.loopexit226, label %.preheader225, !llvm.loop !145
...
begin_hunk_6_@HUF_decompress4X1_usingDTable_internal_fast_c_loop:bb.a
  ...
  br i1 %i.im, label %.preheader, label %.loopexit, !llvm.loop !145
...
bb.b:                                             ; preds = %bb.a
  call void %5(ptr noundef nonnull %6) #17, !callees !146
  %i.e = add i64 %1, 3
...
begin_hunk_13_@HUF_decompress4X1_usingDTable_internal_fast:bb.a
  ...
  br i1 %i.cq, label %BIT_reloadDStream.exit.i.loopexit, label %bb.g, !prof !144, !llvm.loop !122
...
!142 = distinct !{!142, !9}
!143 = !{!127, !127, i64 0}
!144 = !{!"branch_weights", i32 1, i32 1999}
!145 = distinct !{!145, !9}
!146 = !{ptr @HUF_decompress4X1_usingDTable_internal_fast_asm_loop, ptr @HUF_decompress4X1_usingDTable_internal_fast_c_loop}
!147 = distinct !{!147, !9}
end_hunk_17
