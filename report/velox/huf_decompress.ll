...
begin_hunk_3
  ...
  br i1 %i.dq, label %BIT_reloadDStream.exit73, label %bb.g, !prof !105, !llvm.loop !106
...
bb.b:                                             ; preds = %bb.a
  call void %5(ptr noundef nonnull %6) #17, !callees !140
  %i.e = add i64 %1, 3
...
bb.c:                                             ; preds = %._crit_edge
  ...
  br i1 %exitcond131, label %.thread, label %bb.d, !llvm.loop !141
...
begin_hunk_13
  ...
  br i1 %i.cq, label %BIT_reloadDStream.exit.i, label %bb.g, !prof !105, !llvm.loop !117
...
!138 = !{!122, !122, i64 0}
!139 = distinct !{!139, !9}
!140 = !{ptr @HUF_decompress4X1_usingDTable_internal_fast_asm_loop, ptr @HUF_decompress4X1_usingDTable_internal_fast_c_loop}
!141 = distinct !{!141, !9}
end_hunk_17
