...
begin_hunk_3
  ...
  br i1 %i.dq, label %BIT_reloadDStream.exit73.loopexit, label %bb.g, !prof !139, !llvm.loop !106
...
begin_hunk_5
  ...
  br i1 %i.ad, label %.loopexit226, label %.preheader225, !llvm.loop !140
...
begin_hunk_6
  ...
  br i1 %i.im, label %.preheader, label %.loopexit, !llvm.loop !140
...
bb.b:                                             ; preds = %bb.a
  call void %5(ptr noundef nonnull %6) #17, !callees !141
  %i.e = add i64 %1, 3
...
bb.c:                                             ; preds = %._crit_edge
  ...
  br i1 %exitcond131, label %.thread, label %bb.d, !llvm.loop !142
...
begin_hunk_9
  ...
  %i.p = load ptr, ptr %i.o, align 8, !tbaa !138  ; 6 uses
...
begin_hunk_13
  ...
  br i1 %i.cq, label %BIT_reloadDStream.exit.i.loopexit, label %bb.g, !prof !139, !llvm.loop !117
...
BIT_reloadDStream.exit.i.loopexit:                ; preds = %BIT_reloadDStream.exit43.i, %bb.k, %bb.i
  ...
  %.pre = ptrtoint ptr %.3.i.ph to i64
  br label %BIT_reloadDStream.exit.i

BIT_reloadDStream.exit.i:                         ; preds = %BIT_reloadDStream.exit.i.loopexit, %bb.n, %bb.m, %bb.o
  %.3.i119.pre-phi = phi i64 [ %.pre, %BIT_reloadDStream.exit.i.loopexit ], [ %i.ae, %bb.n ], [ %i.ae, %bb.m ], [ %i.ae, %bb.o ] ; 2 uses
...
.lr.ph126.preheader:                              ; preds = %BIT_reloadDStream.exit.i
  %7 = sub i64 %i.ad, %.3.i119.pre-phi            ; 2 uses
  %scevgep = getelementptr i8, ptr %.3.i, i64 %7
...
begin_hunk_16
  ...
  br i1 %exitcond.not.1, label %._crit_edge, label %.lr.ph126, !llvm.loop !118

._crit_edge:                                      ; preds = %.lr.ph126.prol.loopexit, %.lr.ph126, %BIT_reloadDStream.exit.i
end_hunk_16
begin_hunk_17
!136 = !{ptr @HUF_decompress4X2_usingDTable_internal_fast_asm_loop, ptr @HUF_decompress4X2_usingDTable_internal_fast_c_loop}
!137 = distinct !{!137, !9}
!138 = !{!122, !122, i64 0}
!139 = !{!"branch_weights", i32 1, i32 1999}
!140 = distinct !{!140, !9}
!141 = !{ptr @HUF_decompress4X1_usingDTable_internal_fast_asm_loop, ptr @HUF_decompress4X1_usingDTable_internal_fast_c_loop}
!142 = distinct !{!142, !9}
end_hunk_17
