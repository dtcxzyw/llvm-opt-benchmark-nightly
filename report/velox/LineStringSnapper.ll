...
begin_hunk_0_@_ZN4geos9operation7overlay4snap17LineStringSnapper12snapSegmentsERNS_4geom14CoordinateListERKSt6vectorIPKNS4_10CoordinateESaISA_EE:bb.a

bb.g:                                             ; preds = %bb.f
  %i.y = load ptr, ptr %1, align 8, !tbaa !20
  %i.z = getelementptr inbounds nuw i8, ptr %i.y, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.z, ptr noundef nonnull align 8 dereferenceable(24) %i.l, i64 24, i1 false), !tbaa.struct !24
  %i.aa = load ptr, ptr %1, align 8, !tbaa !20
  br label %bb.i

bb.h:                                             ; preds = %bb.f
  %i.ab = call noalias noundef nonnull dereferenceable(40) ptr @_Znwm(i64 noundef 40) #13 ; 2 uses
  %i.ac = getelementptr inbounds nuw i8, ptr %i.ab, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.ac, ptr noundef nonnull align 8 dereferenceable(24) %4, i64 24, i1 false), !tbaa.struct !24
  call void @_ZNSt8__detail15_List_node_base7_M_hookEPS0_(ptr noundef nonnull align 8 dereferenceable(16) %i.ab, ptr noundef nonnull %i.q) #12
  %i.ad = load i64, ptr %i.i, align 8, !tbaa !26
  %i.ae = add i64 %i.ad, 1
  store i64 %i.ae, ptr %i.i, align 8, !tbaa !26
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #12
  br label %bb.s

bb.i:                                             ; preds = %bb.g, %bb.e
  %.sroa.049.0 = phi ptr [ %i.aa, %bb.g ], [ %i.q, %bb.e ]
  %i.af = load ptr, ptr %.sroa.049.0, align 8, !tbaa !20 ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #12
  %i.ag = getelementptr inbounds nuw i8, ptr %i.af, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %5, ptr noundef nonnull align 8 dereferenceable(24) %i.g, i64 24, i1 false), !tbaa.struct !24
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.j, ptr noundef nonnull align 8 dereferenceable(24) %i.ag, i64 24, i1 false), !tbaa.struct !24
  %i.ah = call noundef double @_ZN4geos9algorithm8Distance14pointToSegmentERKNS_4geom10CoordinateES5_S5_(ptr noundef nonnull align 8 dereferenceable(24) %4, ptr noundef nonnull align 8 dereferenceable(48) %5, ptr noundef nonnull align 8 dereferenceable(24) %i.j)
  %i.ai = call noundef double @_ZN4geos9algorithm8Distance14pointToSegmentERKNS_4geom10CoordinateES5_S5_(ptr noundef nonnull align 8 dereferenceable(24) %4, ptr noundef nonnull align 8 dereferenceable(48) %3, ptr noundef nonnull align 8 dereferenceable(24) %i.g)
  %i.aj = fcmp olt double %i.ah, %i.ai
  br i1 %i.aj, label %.critedge, label %bb.j

bb.j:                                             ; preds = %bb.i
  %i.ak = load ptr, ptr %i.o, align 8, !tbaa !20
  br label %.critedge

.critedge:                                        ; preds = %bb.i, %bb.j
  %.sink84 = phi ptr [ %i.ak, %bb.j ], [ %i.af, %bb.i ]
  %i.al = call noalias noundef nonnull dereferenceable(40) ptr @_Znwm(i64 noundef 40) #13 ; 2 uses
  %i.am = getelementptr inbounds nuw i8, ptr %i.al, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.am, ptr noundef nonnull align 8 dereferenceable(24) %4, i64 24, i1 false)
  call void @_ZNSt8__detail15_List_node_base7_M_hookEPS0_(ptr noundef nonnull align 8 dereferenceable(16) %i.al, ptr noundef %.sink84) #12
  %storemerge.in = load i64, ptr %i.i, align 8, !tbaa !26
  %storemerge = add i64 %storemerge.in, 1
  store i64 %storemerge, ptr %i.i, align 8, !tbaa !26
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #12
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #12
  br label %bb.s

bb.k:                                             ; preds = %bb.d
  %i.an = fcmp ugt double %i.t, 0.000000e+00
  br i1 %i.an, label %bb.r, label %bb.l

bb.l:                                             ; preds = %bb.k
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #12
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %6, ptr noundef nonnull align 8 dereferenceable(24) %3, i64 24, i1 false), !tbaa.struct !24
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %3, ptr noundef nonnull align 8 dereferenceable(24) %i.l, i64 24, i1 false), !tbaa.struct !24
  call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.r, ptr noundef nonnull align 8 dereferenceable(24) %i.l, i64 24, i1 false)
  %i.ao = load ptr, ptr %1, align 8, !tbaa !20
  %i.ap = icmp eq ptr %i.o, %i.ao
  br i1 %i.ap, label %bb.m, label %bb.p

bb.m:                                             ; preds = %bb.l
  %i.aq = load i8, ptr %i.h, align 1, !tbaa !35, !range !36, !noundef !13
  %i.ar = trunc nuw i8 %i.aq to i1
  br i1 %i.ar, label %bb.n, label %bb.o

bb.n:                                             ; preds = %bb.m
  %i.as = load ptr, ptr %i.f, align 8, !tbaa !17  ; 2 uses
  %i.at = getelementptr inbounds nuw i8, ptr %i.as, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.at, ptr noundef nonnull align 8 dereferenceable(24) %i.l, i64 24, i1 false), !tbaa.struct !24
  br label %bb.p

bb.o:                                             ; preds = %bb.m
  %i.au = load ptr, ptr %i.o, align 8, !tbaa !20
  %i.av = call noalias noundef nonnull dereferenceable(40) ptr @_Znwm(i64 noundef 40) #13 ; 2 uses
  %i.aw = getelementptr inbounds nuw i8, ptr %i.av, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.aw, ptr noundef nonnull align 8 dereferenceable(24) %6, i64 24, i1 false), !tbaa.struct !24
  call void @_ZNSt8__detail15_List_node_base7_M_hookEPS0_(ptr noundef nonnull align 8 dereferenceable(16) %i.av, ptr noundef %i.au) #12
  %i.ax = load i64, ptr %i.i, align 8, !tbaa !26
  %i.ay = add i64 %i.ax, 1
  store i64 %i.ay, ptr %i.i, align 8, !tbaa !26
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #12
  br label %bb.s

bb.p:                                             ; preds = %bb.n, %bb.l
  %.sroa.055.0 = phi ptr [ %i.as, %bb.n ], [ %i.o, %bb.l ]
  %i.az = getelementptr inbounds nuw i8, ptr %.sroa.055.0, i64 8
  %i.ba = load ptr, ptr %i.az, align 8, !tbaa !17 ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %7) #12
  %i.bb = getelementptr inbounds nuw i8, ptr %i.ba, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %7, ptr noundef nonnull align 8 dereferenceable(24) %i.bb, i64 24, i1 false), !tbaa.struct !24
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.k, ptr noundef nonnull align 8 dereferenceable(24) %3, i64 24, i1 false), !tbaa.struct !24
  %i.bc = call noundef double @_ZN4geos9algorithm8Distance14pointToSegmentERKNS_4geom10CoordinateES5_S5_(ptr noundef nonnull align 8 dereferenceable(24) %6, ptr noundef nonnull align 8 dereferenceable(48) %7, ptr noundef nonnull align 8 dereferenceable(24) %i.k)
  %i.bd = call noundef double @_ZN4geos9algorithm8Distance14pointToSegmentERKNS_4geom10CoordinateES5_S5_(ptr noundef nonnull align 8 dereferenceable(24) %6, ptr noundef nonnull align 8 dereferenceable(48) %3, ptr noundef nonnull align 8 dereferenceable(24) %i.g)
  %i.be = fcmp olt double %i.bc, %i.bd
  br i1 %i.be, label %bb.q, label %.critedge47

bb.q:                                             ; preds = %bb.p
  %i.bf = load ptr, ptr %i.ba, align 8, !tbaa !20
  br label %.critedge47

.critedge47:                                      ; preds = %bb.p, %bb.q
  %.sink87 = phi ptr [ %i.bf, %bb.q ], [ %i.q, %bb.p ]
  %i.bg = call noalias noundef nonnull dereferenceable(40) ptr @_Znwm(i64 noundef 40) #13 ; 2 uses
  %i.bh = getelementptr inbounds nuw i8, ptr %i.bg, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.bh, ptr noundef nonnull align 8 dereferenceable(24) %6, i64 24, i1 false)
  call void @_ZNSt8__detail15_List_node_base7_M_hookEPS0_(ptr noundef nonnull align 8 dereferenceable(16) %i.bg, ptr noundef %.sink87) #12
  %storemerge83.in = load i64, ptr %i.i, align 8, !tbaa !26
  %storemerge83 = add i64 %storemerge83.in, 1
  store i64 %storemerge83, ptr %i.i, align 8, !tbaa !26
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #12
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #12
  br label %bb.s

bb.r:                                             ; preds = %bb.k
  %i.bi = load ptr, ptr %i.o, align 8, !tbaa !20
  %i.bj = call noalias noundef nonnull dereferenceable(40) ptr @_Znwm(i64 noundef 40) #13 ; 2 uses
  %i.bk = getelementptr inbounds nuw i8, ptr %i.bj, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.bk, ptr noundef nonnull align 8 dereferenceable(24) %i.l, i64 24, i1 false), !tbaa.struct !24
  call void @_ZNSt8__detail15_List_node_base7_M_hookEPS0_(ptr noundef nonnull align 8 dereferenceable(16) %i.bj, ptr noundef %i.bi) #12
  %i.bl = load i64, ptr %i.i, align 8, !tbaa !26
  %i.bm = add i64 %i.bl, 1
  store i64 %i.bm, ptr %i.i, align 8, !tbaa !26
  br label %bb.s

bb.s:                                             ; preds = %bb.r, %.critedge, %.critedge47, %bb.o, %bb.h
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #12
  br label %bb.t

bb.t:                                             ; preds = %bb.c, %bb.s
  %i.bn = getelementptr inbounds nuw i8, ptr %.sroa.071.075, i64 8 ; 2 uses
  %.not = icmp eq ptr %i.bn, %i.e
  br i1 %.not, label %.loopexit, label %bb.c, !llvm.loop !44

.loopexit:                                        ; preds = %bb.t, %bb.b, %bb.a
  ret void
}
...
define ptr @_ZN4geos9operation7overlay4snap17LineStringSnapper16findVertexToSnapERKNS_4geom10CoordinateESt14_List_iteratorIS5_ES9_(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(18) %0, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(24) %1, ptr nofree readonly captures(address, ret: address, provenance) %2, ptr nofree readnone captures(address, ret: address, provenance) %3) local_unnamed_addr #2 align 2 {
bb.a:
...
.lr.ph:                                           ; preds = %bb.a
  ...
  %i.c = load <2 x double>, ptr %1, align 8, !tbaa !25
  br label %bb.b

bb.b:                                             ; preds = %.lr.ph, %bb.d
  %.01025 = phi double [ %i.b, %.lr.ph ], [ %.1.ph, %bb.d ] ; 2 uses
  %.sroa.0.024 = phi ptr [ %3, %.lr.ph ], [ %.sroa.0.1.ph, %bb.d ]
  %.sroa.012.023 = phi ptr [ %2, %.lr.ph ], [ %i.k, %bb.d ] ; 4 uses
  %i.d = getelementptr inbounds nuw i8, ptr %.sroa.012.023, i64 16
  %i.e = load <2 x double>, ptr %i.d, align 8, !tbaa !25
  %i.f = fsub <2 x double> %i.e, %i.c             ; 2 uses
  %i.g = fmul <2 x double> %i.f, %i.f             ; 2 uses
  %shift = shufflevector <2 x double> %i.g, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop = fadd <2 x double> %i.g, %shift
  %i.h = extractelement <2 x double> %foldExtExtBinop, i64 0 ; 2 uses
  %sqrt.i = tail call noundef double @llvm.sqrt.f64(double %i.h) ; 2 uses
  %i.i = fcmp ult double %sqrt.i, %.01025
  br i1 %i.i, label %bb.c, label %bb.d

bb.c:                                             ; preds = %bb.b
  %i.j = fcmp oeq double %i.h, 0.000000e+00
  br i1 %i.j, label %._crit_edge, label %bb.d

bb.d:                                             ; preds = %bb.b, %bb.c
  %.sroa.0.1.ph = phi ptr [ %.sroa.012.023, %bb.c ], [ %.sroa.0.024, %bb.b ] ; 2 uses
  %.1.ph = phi double [ %sqrt.i, %bb.c ], [ %.01025, %bb.b ]
  %i.k = load ptr, ptr %.sroa.012.023, align 8, !tbaa !20 ; 2 uses
  %.not = icmp eq ptr %i.k, %3
  br i1 %.not, label %._crit_edge, label %bb.b, !llvm.loop !38

._crit_edge:                                      ; preds = %bb.d, %bb.c, %bb.a
  %.sroa.09.2 = phi ptr [ %3, %bb.a ], [ %.sroa.012.023, %bb.c ], [ %.sroa.0.1.ph, %bb.d ]
  ret ptr %.sroa.09.2
}
...
declare void @_ZN4geos4util9Interrupt7processEv() local_unnamed_addr #3

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(read, inaccessiblemem: none, target_mem: none) uwtable
define ptr @_ZN4geos9operation7overlay4snap17LineStringSnapper17findSnapForVertexERKNS_4geom10CoordinateERKSt6vectorIPS6_SaIS9_EE(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(18) %0, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(24) %1, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(24) %2) local_unnamed_addr #2 align 2 {
bb.a:
...
.lr.ph:                                           ; preds = %bb.a
  ...
  %3 = load double, ptr %i.d, align 8, !tbaa !37
  %i.e = load double, ptr %1, align 8, !tbaa !45  ; 2 uses
...
bb.b:                                             ; preds = %.lr.ph, %bb.c
  ...
  %.01527 = phi double [ %3, %.lr.ph ], [ %.116, %bb.c ] ; 2 uses
  %.sroa.0.02126 = phi ptr [ %i.c, %.lr.ph ], [ %i.h, %bb.c ] ; 3 uses
  %i.f = load ptr, ptr %.sroa.0.02126, align 8, !tbaa !15 ; 2 uses
  %6 = load double, ptr %i.f, align 8, !tbaa !45  ; 2 uses
  %7 = fcmp oeq double %6, %i.e
  %8 = getelementptr inbounds nuw i8, ptr %i.f, i64 8
  %9 = load double, ptr %8, align 8               ; 2 uses
  %10 = fcmp oeq double %9, %5
  %.0.i = select i1 %7, i1 %10, i1 false
  br i1 %.0.i, label %.thread, label %bb.c

bb.c:                                             ; preds = %bb.b
  %11 = fsub double %6, %i.e                      ; 2 uses
  %12 = fsub double %9, %5                        ; 2 uses
  %13 = fmul double %11, %11
  %14 = fmul double %12, %12
  %15 = fadd double %13, %14
  %sqrt.i = tail call noundef double @llvm.sqrt.f64(double %15) ; 2 uses
...
define ptr @_ZN4geos9operation7overlay4snap17LineStringSnapper17findSegmentToSnapERKNS_4geom10CoordinateESt14_List_iteratorIS5_ES9_(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(18) %0, ptr noundef nonnull align 8 dereferenceable(24) %1, ptr nofree readonly captures(address, ret: address, provenance) %2, ptr nofree readnone captures(address, ret: address, provenance) %3) local_unnamed_addr #0 align 2 {
bb.a:
...
!6 = !{!"Simple C++ TBAA"}
!7 = !{!8, !9, i64 0}
!8 = !{!"_ZTSN4geos9operation7overlay4snap17LineStringSnapperE", !9, i64 0, !11, i64 8, !12, i64 16, !12, i64 17}
!9 = !{!"p1 _ZTSSt6vectorIN4geos4geom10CoordinateESaIS2_EE", !10, i64 0}
...
!14 = !{i64 8}
!15 = !{!16, !16, i64 0}
!16 = !{!"p1 _ZTSN4geos4geom10CoordinateE", !10, i64 0}
!17 = !{!18, !19, i64 8}
!18 = !{!"_ZTSNSt8__detail15_List_node_baseE", !19, i64 0, !19, i64 8}
!19 = !{!"p1 _ZTSNSt8__detail15_List_node_baseE", !10, i64 0}
!20 = !{!18, !19, i64 0}
!21 = !{!22, !23, i64 16}
...
!25 = !{!11, !11, i64 0}
!26 = !{!27, !23, i64 16}
!27 = !{!"_ZTSNSt7__cxx1110_List_baseIN4geos4geom10CoordinateESaIS3_EEE", !28, i64 0}
!28 = !{!"_ZTSNSt7__cxx1110_List_baseIN4geos4geom10CoordinateESaIS3_EE10_List_implE", !22, i64 0}
!29 = distinct !{!29, !30}
!30 = !{!"llvm.loop.mustprogress"}
!31 = distinct !{!31, !30}
!32 = !{!33, !33, i64 0}
!33 = !{!"p2 _ZTSN4geos4geom10CoordinateE", !34, i64 0}
...
!39 = distinct !{!39, !30}
!40 = !{!41}
!41 = distinct !{!41, !42, !"_ZNK4geos4geom14CoordinateList17toCoordinateArrayEv: argument 0"}
!42 = distinct !{!42, !"_ZNK4geos4geom14CoordinateList17toCoordinateArrayEv"}
!43 = !{!9, !9, i64 0}
!44 = distinct !{!44, !30}
!45 = !{!46, !11, i64 0}
!46 = !{!"_ZTSN4geos4geom10CoordinateE", !11, i64 0, !11, i64 8, !11, i64 16}
!47 = distinct !{!47, !30}
!48 = !{!46, !11, i64 16}
!49 = !{!8, !12, i64 16}
!50 = distinct !{!50, !30}
!51 = !{!52, !16, i64 0}
!52 = !{!"_ZTSNSt12_Vector_baseIN4geos4geom10CoordinateESaIS2_EE17_Vector_impl_dataE", !16, i64 0, !16, i64 8, !16, i64 16}
!53 = distinct !{!53, !30}
!54 = !{!52, !16, i64 16}
!55 = distinct !{!55, !30}
!56 = !{!52, !16, i64 8}
