...
begin_hunk_0_@_ZN5arrow3ipc4test9MakeUnionEPSt10shared_ptrINS_11RecordBatchEE:._crit_edge.i.i
  call void @_ZdlPvm(ptr noundef nonnull %i.ajj, i64 noundef %i.ajn) #23
  br label %.body303

.body303:                                         ; preds = %bb.fv, %bb.kt, %bb.ks
...
begin_hunk_1_@_ZN5arrow3ipc4test9MakeUnionEPSt10shared_ptrINS_11RecordBatchEE:._crit_edge.i.i
  call void @_ZdlPvm(ptr noundef nonnull %i.aqp, i64 noundef %i.aqt) #23
  br label %.body278

.body278:                                         ; preds = %bb.eu, %bb.nd, %bb.nc
  ...
  call void @_ZNSt12__shared_ptrIN5arrow6BufferELN9__gnu_cxx12_Lock_policyE2EED2Ev(ptr noundef nonnull align 8 dereferenceable(16) %30) #22
end_hunk_1
...
.body:                                            ; preds = %bb.n, %bb.wq, %_ZNSt6vectorIiSaIiEED2Ev.exit608
...
.body:                                            ; preds = %bb.n, %bb.kj, %_ZNSt6vectorIiSaIiEED2Ev.exit294
