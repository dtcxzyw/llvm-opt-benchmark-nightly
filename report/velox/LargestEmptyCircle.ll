...
bb.a:
  ...
  %.sroa.06.i.i.i = alloca { double, double, double, double }, align 8 ; 4 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.06.i.i.i, ptr noundef nonnull align 8 dereferenceable(32) %i.ap, i64 32, i1 false)
...
_ZSt10__pop_heapIN9__gnu_cxx17__normal_iteratorIPN4geos9algorithm9construct18LargestEmptyCircle4CellESt6vectorIS6_SaIS6_EEEENS0_5__ops15_Iter_comp_iterISt4lessIS6_EEEEvT_SH_SH_RT0_.exit.i.i: ; preds = %bb.j, %.lr.ph.i.i.i.i.i, %bb.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.bx, ptr noundef nonnull align 8 dereferenceable(32) %.sroa.06.i.i.i, i64 32, i1 false)
...
begin_hunk_3_@_ZN4geos9algorithm9construct18LargestEmptyCircle7computeEv:bb.a
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.05.i.i, ptr noundef nonnull align 8 dereferenceable(32) %i.dt, i64 32, i1 false)
...
.loopexit199:                                     ; preds = %bb.u, %.lr.ph.i.i.i, %.noexc17
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.ed, ptr noundef nonnull align 8 dereferenceable(32) %.sroa.05.i.i, i64 32, i1 false), !tbaa.struct !115
...
.loopexit198:                                     ; preds = %bb.z, %.lr.ph.i.i.i25, %.noexc30
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.ft, ptr noundef nonnull align 8 dereferenceable(32) %.sroa.05.i.i20, i64 32, i1 false), !tbaa.struct !115
...
begin_hunk_7_@_ZN4geos9algorithm9construct18LargestEmptyCircle7computeEv:bb.a
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.05.i.i34)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.05.i.i34, ptr noundef nonnull align 8 dereferenceable(32) %i.hm, i64 32, i1 false)
...
.loopexit197:                                     ; preds = %bb.ae, %.lr.ph.i.i.i39, %.noexc44
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.hx, ptr noundef nonnull align 8 dereferenceable(32) %.sroa.05.i.i34, i64 32, i1 false), !tbaa.struct !115
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.05.i.i34)
...
.loopexit:                                        ; preds = %bb.aj, %.lr.ph.i.i.i53, %.noexc58
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.jj, ptr noundef nonnull align 8 dereferenceable(32) %.sroa.05.i.i48, i64 32, i1 false), !tbaa.struct !115
...
begin_hunk_12_@_ZN4geos9algorithm9construct18LargestEmptyCircle17createInitialGridEPKNS_4geom8EnvelopeERSt14priority_queueINS2_4CellESt6vectorIS8_SaIS8_EESt4lessIS8_EE:bb.a
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.05.i.i)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.05.i.i, ptr noundef nonnull align 8 dereferenceable(32) %i.bw, i64 32, i1 false)
...
_ZNSt14priority_queueIN4geos9algorithm9construct18LargestEmptyCircle4CellESt6vectorIS4_SaIS4_EESt4lessIS4_EE7emplaceIJddRddEEEvDpOT_.exit.us: ; preds = %.lr.ph.i.i.i.us, %bb.k, %_ZNSt6vectorIN4geos9algorithm9construct18LargestEmptyCircle4CellESaIS4_EE12emplace_backIJddRddEEEvDpOT_.exit.us
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.ci, ptr noundef nonnull align 8 dereferenceable(32) %.sroa.05.i.i, i64 32, i1 false), !tbaa.struct !115
