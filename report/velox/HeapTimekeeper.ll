...
_ZNSt10unique_ptrIN5folly14HeapTimekeeper7TimeoutENS2_6DecRefEEaSEOS4_.exit:
  ...
  %.sroa.017.i.sroa.0.0.copyload = load <4 x ptr>, ptr %8, align 8
...
_ZN5folly6detail17distributed_mutex6WaiterISt6atomicE10initializeEmNS0_17InlineFunctionRefIFvvELm48EEE.exit.i.i: ; preds = %bb.i, %_ZNSt10unique_ptrIN5folly14HeapTimekeeper7TimeoutENS2_6DecRefEEaSEOS4_.exit
  ...
  store <4 x ptr> %.sroa.017.i.sroa.0.0.copyload, ptr %.sroa.516.0..sroa_idx.i.i, align 8, !noalias !241
...
bb.g:                                             ; preds = %_ZNSt15__exception_ptr13exception_ptrD2Ev.exit.i.i.i.i
  ...
  br i1 %.not.i6.i.i.i.i, label %.body, label %bb.h
...
.body:                                            ; preds = %bb.g, %bb.h, %bb.r, %.loopexit, %.loopexit.split-lp
  %eh.lpad-body = phi { ptr, i32 } [ %lpad.loopexit.split-lp, %.loopexit.split-lp ], [ %lpad.loopexit, %.loopexit ], [ %.pn.i, %bb.r ], [ %i.ao, %bb.g ], [ %i.ao, %bb.h ]
