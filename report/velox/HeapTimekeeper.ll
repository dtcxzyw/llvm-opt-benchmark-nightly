begin_hunk_0
  ...
  %i.ak = load i32, ptr %i.a, align 4, !tbaa !7, !noalias !235 ; 3 uses
  %i.al = icmp eq i32 %i.ak, 7                    ; 2 uses
...
begin_hunk_3
  ...
  %i.af = load i32, ptr %i.a, align 4, !tbaa !7, !noalias !336 ; 3 uses
...
.noexc50:                                         ; preds = %bb.n, %bb.n, %bb.n, %bb.n, %bb.x, %bb.x, %bb.x, %bb.x
  %.5 = phi i32 [ %.4, %bb.x ], [ %.4, %bb.x ], [ %.4, %bb.x ], [ %.4, %bb.x ], [ %.2, %bb.n ], [ %.2, %bb.n ], [ %.2, %bb.n ], [ %.2, %bb.n ] ; 3 uses
...
begin_hunk_8
  ...
  br i1 %i.db, label %bb.am, label %bb.ae
...
bb.am:                                            ; preds = %"_ZN5folly6detail17distributed_mutex18lockImplementationISt6atomicLb1ES3_ImENS1_20RequestWithoutReturnIZNS_14HeapTimekeeper5State6workerEvE3$_0EEEENS1_16DistributedMutexIT_XT0_EE26DistributedMutexStateProxyERSC_RT1_RT2_.exit.i"
...
begin_hunk_10
  ...
  %i.fe = load i32, ptr %i.a, align 4, !tbaa !7, !noalias !356 ; 3 uses
  %i.ff = icmp eq i32 %i.fe, 7                    ; 2 uses
...
begin_hunk_11
  ...
  br i1 %i.ff, label %bb.bf, label %bb.bd
