Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/velox/original/fnmatch?download=true
...
define noundef zeroext i1 @_ZN4absl12lts_2024011612log_internal7FNMatchESt17basic_string_viewIcSt11char_traitsIcEES5_(i64 %0, ptr nofree readonly captures(none) %1, i64 %2, ptr %3) local_unnamed_addr #0 personality ptr @__gxx_personality_v0 {
bb.a:
  %i.a = icmp eq i64 %0, 0
...
bb.c:                                             ; preds = %.lr.ph
  %i.j = load i8, ptr %.sroa.12.076, align 1, !tbaa !11 ; 3 uses
...
bb.g:                                             ; preds = %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i
  %i.t = add i64 %.0111420.i.i, 1                 ; 2 uses
...
_ZNKSt17basic_string_viewIcSt11char_traitsIcEE13find_first_ofEPKcm.exit.thread: ; preds = %bb.g, %_ZNKSt17basic_string_viewIcSt11char_traitsIcEE13find_first_ofEPKcm.exit
  %.sroa.0.0 = phi i64 [ %spec.select82, %_ZNKSt17basic_string_viewIcSt11char_traitsIcEE13find_first_ofEPKcm.exit ], [ %.sroa.035.077, %bb.g ] ; 8 uses
...
.lr.ph.i.i17:                                     ; preds = %_ZNKSt17basic_string_viewIcSt11char_traitsIcEE13find_first_ofEPKcm.exit.thread.thread
  %i.v = getelementptr inbounds nuw i8, ptr %.sroa.1030.078, i64 %.sroa.024.079
...
bb.h:                                             ; preds = %bb.i, %.lr.ph.i.i17
  %.033.i.i = phi i64 [ %.sroa.024.079, %.lr.ph.i.i17 ], [ %i.ad, %bb.i ]
  %.02032.i.i = phi ptr [ %.sroa.1030.078, %.lr.ph.i.i17 ], [ %i.ab, %bb.i ]
...
_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i18:   ; preds = %bb.h
  %i.z = tail call ptr @memchr(ptr noundef %.02032.i.i, i32 noundef %i.w, i64 noundef %.reass.reass.i.reass.reass.i.reass.reass.reass) #3 ; 4 uses
...
_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i:   ; preds = %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i18
  %bcmp.i.i = tail call i32 @bcmp(ptr nonnull %i.z, ptr nonnull %.sroa.12.076, i64 %.sroa.0.0)
  %i.aa = icmp eq i32 %bcmp.i.i, 0
  br i1 %i.aa, label %_ZNKSt17basic_string_viewIcSt11char_traitsIcEE4findES2_m.exit, label %bb.i
...
bb.i:                                             ; preds = %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i
  ...
  br i1 %.not25.i.i, label %.critedge, label %bb.h, !llvm.loop !9
...
_ZNKSt17basic_string_viewIcSt11char_traitsIcEE4findES2_m.exit: ; preds = %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i
  ...
  %i.af = ptrtoint ptr %.sroa.1030.078 to i64
...
_ZNKSt17basic_string_viewIcSt11char_traitsIcEE4findES2_m.exit.thread52: ; preds = %_ZNKSt17basic_string_viewIcSt11char_traitsIcEE13find_first_ofEPKcm.exit.thread, %_ZNKSt17basic_string_viewIcSt11char_traitsIcEE4findES2_m.exit
  %.1.i.i55 = phi i64 [ %i.ag, %_ZNKSt17basic_string_viewIcSt11char_traitsIcEE4findES2_m.exit ], [ 0, %_ZNKSt17basic_string_viewIcSt11char_traitsIcEE13find_first_ofEPKcm.exit.thread ]
  %i.ah = getelementptr inbounds nuw i8, ptr %.sroa.12.076, i64 %.sroa.0.0
  %i.ai = sub i64 %.sroa.035.077, %.sroa.0.0
  %i.aj = add i64 %.1.i.i55, %.sroa.0.0           ; 2 uses
  %i.ak = getelementptr inbounds nuw i8, ptr %.sroa.1030.078, i64 %i.aj
  %i.al = sub i64 %.sroa.024.079, %i.aj
  br label %bb.l

bb.j:                                             ; preds = %bb.f
  %i.am = load i8, ptr %.sroa.1030.078, align 1, !tbaa !11
  %.not = icmp eq i8 %i.j, %i.am
  br i1 %.not, label %bb.k, label %.critedge

bb.k:                                             ; preds = %bb.j
  %i.an = getelementptr inbounds nuw i8, ptr %.sroa.12.076, i64 1
  %i.ao = add i64 %.sroa.035.077, -1
  %i.ap = getelementptr inbounds nuw i8, ptr %.sroa.1030.078, i64 1
  %i.aq = add i64 %.sroa.024.079, -1
  br label %bb.l

bb.l:                                             ; preds = %_ZNKSt17basic_string_viewIcSt11char_traitsIcEE4findES2_m.exit.thread52, %bb.k, %bb.e, %bb.d
  %.sroa.12.1 = phi ptr [ %i.ah, %_ZNKSt17basic_string_viewIcSt11char_traitsIcEE4findES2_m.exit.thread52 ], [ %i.an, %bb.k ], [ %i.k, %bb.d ], [ %i.m, %bb.e ]
  %.sroa.035.1 = phi i64 [ %i.ai, %_ZNKSt17basic_string_viewIcSt11char_traitsIcEE4findES2_m.exit.thread52 ], [ %i.ao, %bb.k ], [ %i.l, %bb.d ], [ %i.n, %bb.e ] ; 2 uses
  %.sroa.1030.1 = phi ptr [ %i.ak, %_ZNKSt17basic_string_viewIcSt11char_traitsIcEE4findES2_m.exit.thread52 ], [ %i.ap, %bb.k ], [ %.sroa.1030.078, %bb.d ], [ %i.o, %bb.e ]
  ...
  br i1 %i.ar, label %._crit_edge.loopexit, label %.lr.ph, !llvm.loop !10
