...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec = load <12 x i64>, ptr %i.t, align 8, !tbaa !25
  %strided.vec = shufflevector <12 x i64> %wide.vec, <12 x i64> poison, <4 x i32> <i32 0, i32 3, i32 6, i32 9>
  %wide.vec18 = load <12 x i64>, ptr %i.u, align 8, !tbaa !25
  %strided.vec19 = shufflevector <12 x i64> %wide.vec18, <12 x i64> poison, <4 x i32> <i32 0, i32 3, i32 6, i32 9>
  %wide.vec20 = load <12 x i64>, ptr %i.v, align 8, !tbaa !25
  %strided.vec21 = shufflevector <12 x i64> %wide.vec20, <12 x i64> poison, <4 x i32> <i32 0, i32 3, i32 6, i32 9>
  %wide.vec22 = load <12 x i64>, ptr %i.w, align 8, !tbaa !25
  %strided.vec23 = shufflevector <12 x i64> %wide.vec22, <12 x i64> poison, <4 x i32> <i32 0, i32 3, i32 6, i32 9>
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.vec31 = load <12 x i64>, ptr %i.aj, align 8, !tbaa !25
  %strided.vec32 = shufflevector <12 x i64> %wide.vec31, <12 x i64> poison, <4 x i32> <i32 0, i32 3, i32 6, i32 9>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec = load <12 x i64>, ptr %i.aj, align 8, !tbaa !25
  %strided.vec = shufflevector <12 x i64> %wide.vec, <12 x i64> poison, <4 x i32> <i32 0, i32 3, i32 6, i32 9>
  %wide.vec22 = load <12 x i64>, ptr %i.ak, align 8, !tbaa !25
  %strided.vec23 = shufflevector <12 x i64> %wide.vec22, <12 x i64> poison, <4 x i32> <i32 0, i32 3, i32 6, i32 9>
  %wide.vec24 = load <12 x i64>, ptr %i.al, align 8, !tbaa !25
  %strided.vec25 = shufflevector <12 x i64> %wide.vec24, <12 x i64> poison, <4 x i32> <i32 0, i32 3, i32 6, i32 9>
  %wide.vec26 = load <12 x i64>, ptr %i.am, align 8, !tbaa !25
  %strided.vec27 = shufflevector <12 x i64> %wide.vec26, <12 x i64> poison, <4 x i32> <i32 0, i32 3, i32 6, i32 9>
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.vec36 = load <12 x i64>, ptr %i.ba, align 8, !tbaa !25
  %strided.vec37 = shufflevector <12 x i64> %wide.vec36, <12 x i64> poison, <4 x i32> <i32 0, i32 3, i32 6, i32 9>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec = load <12 x i64>, ptr %i.q, align 8, !tbaa !25
  %strided.vec = shufflevector <12 x i64> %wide.vec, <12 x i64> poison, <4 x i32> <i32 0, i32 3, i32 6, i32 9>
  %wide.vec19 = load <12 x i64>, ptr %i.r, align 8, !tbaa !25
  %strided.vec20 = shufflevector <12 x i64> %wide.vec19, <12 x i64> poison, <4 x i32> <i32 0, i32 3, i32 6, i32 9>
  %wide.vec21 = load <12 x i64>, ptr %i.s, align 8, !tbaa !25
  %strided.vec22 = shufflevector <12 x i64> %wide.vec21, <12 x i64> poison, <4 x i32> <i32 0, i32 3, i32 6, i32 9>
  %wide.vec23 = load <12 x i64>, ptr %i.t, align 8, !tbaa !25
  %strided.vec24 = shufflevector <12 x i64> %wide.vec23, <12 x i64> poison, <4 x i32> <i32 0, i32 3, i32 6, i32 9>
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.vec31 = load <12 x i64>, ptr %i.ae, align 8, !tbaa !25
  %strided.vec32 = shufflevector <12 x i64> %wide.vec31, <12 x i64> poison, <4 x i32> <i32 0, i32 3, i32 6, i32 9>
