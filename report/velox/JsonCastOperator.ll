...
begin_hunk_0_@_ZN3fmt3v116detail6bigint13divmod_assignERKS2_:bb.a
  br i1 %i.bf, label %middle.block, label %vector.body, !llvm.loop !1475
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %i.bg = sub nsw i64 %i.an, %n.vec116
  %i.bh = sub nsw i64 %i.am, %n.vec116
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index117 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next119, %vec.epilog.vector.body ] ; 3 uses
  %i.bi = sub i64 %i.an, %index117
  %i.bj = sub i64 %i.am, %index117
  %i.bk = getelementptr inbounds nuw [4 x i8], ptr %.pre.i, i64 %i.bi
  %i.bl = getelementptr inbounds i8, ptr %i.bk, i64 -28
  %wide.load118 = load <8 x i32>, ptr %i.bl, align 4, !tbaa !3
  %i.bm = getelementptr inbounds [4 x i8], ptr %.pre.i, i64 %i.bj
  %i.bn = getelementptr inbounds i8, ptr %i.bm, i64 -28
  store <8 x i32> %wide.load118, ptr %i.bn, align 4, !tbaa !3
  %index.next119 = add nuw i64 %index117, 8       ; 2 uses
  %i.bo = icmp eq i64 %index.next119, %n.vec116
  br i1 %i.bo, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !1476
...
vec.epilog.scalar.ph.preheader:                   ; preds = %vector.memcheck, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv18.i.ph = phi i64 [ %i.an, %iter.check ], [ %i.an, %vector.memcheck ], [ %i.ar, %vec.epilog.iter.check ], [ %i.bg, %vec.epilog.middle.block ] ; 4 uses
  %indvars.iv.i11.ph = phi i64 [ %i.am, %iter.check ], [ %i.am, %vector.memcheck ], [ %i.as, %vec.epilog.iter.check ], [ %i.bh, %vec.epilog.middle.block ] ; 2 uses
  %i.bp = add nsw i64 %indvars.iv18.i.ph, 1
...
vec.epilog.scalar.ph.prol:                        ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph.prol
  ...
  %i.bq = getelementptr inbounds nuw [4 x i8], ptr %.pre.i, i64 %indvars.iv18.i.prol
  %i.br = load i32, ptr %i.bq, align 4, !tbaa !3
  %i.bs = getelementptr inbounds [4 x i8], ptr %.pre.i, i64 %indvars.iv.i11.prol
...
vec.epilog.scalar.ph.prol.loopexit:               ; preds = %vec.epilog.scalar.ph.prol, %vec.epilog.scalar.ph.preheader
  ...
  %i.bt = icmp ult i64 %indvars.iv18.i.ph, 3
  br i1 %i.bt, label %._crit_edge.i, label %vec.epilog.scalar.ph
...
._crit_edge.i:                                    ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph, %middle.block, %vec.epilog.middle.block, %_ZN3fmt3v1119basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i
  %i.bu = zext nneg i32 %i.y to i64
  %i.bv = shl nuw nsw i64 %i.bu, 2
  tail call void @llvm.memset.p0.i64(ptr align 4 %.pre.i, i8 0, i64 %i.bv, i1 false)
  %i.bw = load i32, ptr %i.d, align 8, !tbaa !1425
  %i.bx = sub nsw i32 %i.bw, %i.y                 ; 2 uses
  store i32 %i.bx, ptr %i.d, align 8, !tbaa !1425
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph
  ...
  %i.by = getelementptr inbounds nuw [4 x i8], ptr %.pre.i, i64 %indvars.iv18.i
  %i.bz = load i32, ptr %i.by, align 4, !tbaa !3
  %i.ca = getelementptr inbounds [4 x i8], ptr %.pre.i, i64 %indvars.iv.i11
  store i32 %i.bz, ptr %i.ca, align 4, !tbaa !3
  %i.cb = getelementptr [4 x i8], ptr %.pre.i, i64 %indvars.iv18.i
  ...
  %i.cg = getelementptr [4 x i8], ptr %.pre.i, i64 %indvars.iv18.i
  %i.ch = getelementptr i8, ptr %i.cg, i64 -8
  %i.ci = load i32, ptr %i.ch, align 4, !tbaa !3
  %i.cj = getelementptr [4 x i8], ptr %.pre.i, i64 %indvars.iv.i11
  ...
  %i.cl = getelementptr inbounds nuw [4 x i8], ptr %.pre.i, i64 %indvars.iv.next19.i.2
  %i.cm = load i32, ptr %i.cl, align 4, !tbaa !3
  %i.cn = getelementptr [4 x i8], ptr %.pre.i, i64 %indvars.iv.i11
...
_ZN3fmt3v116detail6bigint5alignERKS2_.exit:       ; preds = %select.unfold, %._crit_edge.i
  ...
  %i.cp = phi i32 [ %i.e, %select.unfold ], [ %i.bx, %._crit_edge.i ]
...
_ZN3fmt3v116detail7compareERKNS1_6bigintES4_.exit33: ; preds = %_ZN3fmt3v116detail7compareERKNS1_6bigintES4_.exit33.backedge, %_ZN3fmt3v116detail6bigint5alignERKS2_.exit
  %i.cs = phi i32 [ %i.cp, %_ZN3fmt3v116detail6bigint5alignERKS2_.exit ], [ %i.fe, %_ZN3fmt3v116detail7compareERKNS1_6bigintES4_.exit33.backedge ]
  %i.ct = phi i64 [ %.pre62, %_ZN3fmt3v116detail6bigint5alignERKS2_.exit ], [ %i.fg, %_ZN3fmt3v116detail7compareERKNS1_6bigintES4_.exit33.backedge ] ; 5 uses
  %i.cu = phi i64 [ %.pre, %_ZN3fmt3v116detail6bigint5alignERKS2_.exit ], [ %i.fb, %_ZN3fmt3v116detail7compareERKNS1_6bigintES4_.exit33.backedge ] ; 3 uses
  %.0 = phi i32 [ 0, %_ZN3fmt3v116detail6bigint5alignERKS2_.exit ], [ %i.fc, %_ZN3fmt3v116detail7compareERKNS1_6bigintES4_.exit33.backedge ]
  %i.cv = trunc i64 %i.cu to i32
  %.not21.i = icmp eq i64 %i.ct, 0
...
.lr.ph.i14:                                       ; preds = %_ZN3fmt3v116detail7compareERKNS1_6bigintES4_.exit33
  %i.cw = load i32, ptr %i.j, align 8, !tbaa !1425
  %i.cx = sub i32 %i.cw, %i.cs
  %i.cy = load ptr, ptr %1, align 8, !tbaa !1423  ; 3 uses
  %i.cz = load ptr, ptr %0, align 8, !tbaa !1423  ; 4 uses
  %i.da = sext i32 %i.cx to i64                   ; 2 uses
  %xtraiter136 = and i64 %i.ct, 1
  %i.db = icmp eq i64 %i.ct, 1
  br i1 %i.db, label %.epil.preheader, label %.lr.ph.i14.new
...
.epil.preheader:                                  ; preds = %._crit_edge.i18.unr-lcssa, %.lr.ph.i14
  %indvars.iv.i15.epil.init = phi i64 [ %i.da, %.lr.ph.i14 ], [ %indvars.iv.next.i16.1, %._crit_edge.i18.unr-lcssa ] ; 2 uses
  %.01223.i.epil.init = phi i64 [ 0, %.lr.ph.i14 ], [ %i.ei, %._crit_edge.i18.unr-lcssa ]
  %.01822.i.epil.init = phi i64 [ 0, %.lr.ph.i14 ], [ %i.eh, %._crit_edge.i18.unr-lcssa ]
  %lcmp.mod140 = trunc i64 %i.ct to i1
  tail call void @llvm.assume(i1 %lcmp.mod140)
  %i.dc = getelementptr inbounds nuw [4 x i8], ptr %i.cy, i64 %.01223.i.epil.init
  %i.dd = load i32, ptr %i.dc, align 4, !tbaa !3
  %i.de = getelementptr inbounds [4 x i8], ptr %i.cz, i64 %indvars.iv.i15.epil.init ; 2 uses
  %i.df = load i32, ptr %i.de, align 4, !tbaa !3
  %i.dg = zext i32 %i.df to i64
  %i.dh = zext i32 %i.dd to i64
  %i.di = add nuw nsw i64 %.01822.i.epil.init, %i.dh
...
._crit_edge.i18:                                  ; preds = %._crit_edge.i18.unr-lcssa, %.epil.preheader
  %.lcssa = phi i64 [ %i.ef, %._crit_edge.i18.unr-lcssa ], [ %i.dj, %.epil.preheader ]
  %indvars.iv.next.i16.lcssa = phi i64 [ %indvars.iv.next.i16.1, %._crit_edge.i18.unr-lcssa ], [ %indvars.iv.next.i16.epil, %.epil.preheader ]
  %i.dl = icmp sgt i64 %.lcssa, -1
  br i1 %i.dl, label %._crit_edge.thread.i, label %bb.h

bb.g:                                             ; preds = %bb.g, %.lr.ph.i14.new
  %indvars.iv.i15 = phi i64 [ %i.da, %.lr.ph.i14.new ], [ %indvars.iv.next.i16.1, %bb.g ] ; 3 uses
  %.01223.i = phi i64 [ 0, %.lr.ph.i14.new ], [ %i.ei, %bb.g ] ; 3 uses
  %.01822.i = phi i64 [ 0, %.lr.ph.i14.new ], [ %i.eh, %bb.g ]
  %niter = phi i64 [ 0, %.lr.ph.i14.new ], [ %niter.next.1, %bb.g ]
  %i.dm = getelementptr inbounds nuw [4 x i8], ptr %i.cy, i64 %.01223.i
  %i.dn = load i32, ptr %i.dm, align 4, !tbaa !3
  %i.do = getelementptr inbounds [4 x i8], ptr %i.cz, i64 %indvars.iv.i15 ; 2 uses
  %i.dp = load i32, ptr %i.do, align 4, !tbaa !3
  %i.dq = zext i32 %i.dp to i64
  %i.dr = zext i32 %i.dn to i64
  %i.ds = add nuw nsw i64 %.01822.i, %i.dr
  %i.dt = sub nsw i64 %i.dq, %i.ds                ; 2 uses
  %i.du = trunc i64 %i.dt to i32
  store i32 %i.du, ptr %i.do, align 4, !tbaa !3
  %i.dv = lshr i64 %i.dt, 63
  %i.dw = getelementptr inbounds nuw [4 x i8], ptr %i.cy, i64 %.01223.i
  %i.dx = getelementptr inbounds nuw i8, ptr %i.dw, i64 4
  %i.dy = load i32, ptr %i.dx, align 4, !tbaa !3
  %i.dz = getelementptr [4 x i8], ptr %i.cz, i64 %indvars.iv.i15
  %i.ea = getelementptr i8, ptr %i.dz, i64 4      ; 2 uses
  %i.eb = load i32, ptr %i.ea, align 4, !tbaa !3
  %i.ec = zext i32 %i.eb to i64
  %i.ed = zext i32 %i.dy to i64
  %i.ee = add nuw nsw i64 %i.dv, %i.ed
  %i.ef = sub nsw i64 %i.ec, %i.ee                ; 3 uses
  %i.eg = trunc i64 %i.ef to i32
  store i32 %i.eg, ptr %i.ea, align 4, !tbaa !3
  %i.eh = lshr i64 %i.ef, 63                      ; 2 uses
  %indvars.iv.next.i16.1 = add nsw i64 %indvars.iv.i15, 2 ; 3 uses
  %i.ei = add nuw i64 %.01223.i, 2                ; 2 uses
...
._crit_edge.thread.i:                             ; preds = %bb.h, %._crit_edge.i18, %_ZN3fmt3v116detail7compareERKNS1_6bigintES4_.exit33
  ...
  %smin.i.i = tail call i32 @llvm.smin.i32(i32 %i.cv, i32 1) ; 2 uses
  %i.em = trunc i64 %i.cu to i32                  ; 2 uses
  %i.en = icmp sgt i32 %i.em, 1
  br i1 %i.en, label %.lr.ph99, label %.critedge.i.i

.lr.ph99:                                         ; preds = %._crit_edge.thread.i
  %i.eo = and i64 %i.cu, 2147483647
  br label %bb.j

bb.i:                                             ; preds = %bb.j
  %i.ep = trunc nuw i64 %i.es to i32              ; 2 uses
  %i.eq = icmp sgt i32 %i.ep, 1
  br i1 %i.eq, label %bb.j, label %.critedge.i.i, !llvm.loop !1480

bb.j:                                             ; preds = %.lr.ph99, %bb.i
  %i.er = phi i32 [ %i.em, %.lr.ph99 ], [ %i.ep, %bb.i ]
  %indvars.iv.i14.i98 = phi i64 [ %i.eo, %.lr.ph99 ], [ %i.es, %bb.i ]
  %i.es = add nsw i64 %indvars.iv.i14.i98, -1     ; 3 uses
  %i.et = getelementptr inbounds nuw [4 x i8], ptr %i.el, i64 %i.es
  %i.eu = load i32, ptr %i.et, align 4, !tbaa !3
  %i.ev = icmp eq i32 %i.eu, 0
  br i1 %i.ev, label %bb.i, label %..critedge.i.i_crit_edge, !llvm.loop !1480
...
.critedge.i.i:                                    ; preds = %bb.i, %..critedge.i.i_crit_edge, %._crit_edge.thread.i
  %.0.in.lcssa.i.i = phi i32 [ %smin.i.i, %._crit_edge.thread.i ], [ %i.er, %..critedge.i.i_crit_edge ], [ %smin.i.i, %bb.i ]
  %i.ew = zext i32 %.0.in.lcssa.i.i to i64        ; 3 uses
  %i.ex = load i64, ptr %i.cq, align 8, !tbaa !1424 ; 2 uses
  %i.ey = icmp ult i64 %i.ex, %i.ew
  br i1 %i.ey, label %bb.k, label %_ZN3fmt3v116detail6bigint16subtract_alignedERKS2_.exit

bb.k:                                             ; preds = %.critedge.i.i
  %i.ez = load ptr, ptr %i.cr, align 8, !tbaa !1421
  tail call void %i.ez(ptr noundef nonnull align 8 dereferenceable(164) %0, i64 noundef %i.ew), !inline_history !1481
  %.pre.i.i.i.i = load i64, ptr %i.cq, align 8, !tbaa !1424
...
_ZN3fmt3v116detail6bigint16subtract_alignedERKS2_.exit: ; preds = %.critedge.i.i, %bb.k
  %i.fa = phi i64 [ %i.ex, %.critedge.i.i ], [ %.pre.i.i.i.i, %bb.k ]
  %i.fb = tail call noundef i64 @llvm.umin.i64(i64 %i.ew, i64 %i.fa) ; 4 uses
  store i64 %i.fb, ptr %i.a, align 8, !tbaa !1432
  %i.fc = add nuw nsw i32 %.0, 1                  ; 4 uses
  %i.fd = trunc nuw i64 %i.fb to i32              ; 2 uses
  %i.fe = load i32, ptr %i.d, align 8, !tbaa !1425 ; 2 uses
  %i.ff = add nsw i32 %i.fe, %i.fd                ; 2 uses
  %i.fg = load i64, ptr %i.g, align 8, !tbaa !1432 ; 3 uses
  %i.fh = trunc i64 %i.fg to i32                  ; 2 uses
  %i.fi = load i32, ptr %i.j, align 8, !tbaa !1425
  %i.fj = add nsw i32 %i.fi, %i.fh                ; 2 uses
  %.not.i20 = icmp eq i32 %i.ff, %i.fj
  br i1 %.not.i20, label %bb.m, label %bb.l

bb.l:                                             ; preds = %_ZN3fmt3v116detail6bigint16subtract_alignedERKS2_.exit
  %i.fk = icmp sgt i32 %i.ff, %i.fj
  br i1 %i.fk, label %_ZN3fmt3v116detail7compareERKNS1_6bigintES4_.exit33.backedge, label %_ZN3fmt3v116detail7compareERKNS1_6bigintES4_.exit

bb.m:                                             ; preds = %_ZN3fmt3v116detail6bigint16subtract_alignedERKS2_.exit
  %i.fl = sub nsw i32 %i.fd, %i.fh
  %spec.store.select.i22 = tail call i32 @llvm.smax.i32(i32 %i.fl, i32 0)
  %i.fm = load ptr, ptr %0, align 8
  %i.fn = load ptr, ptr %1, align 8
  %sext.i23 = shl nuw i64 %i.fb, 32
  %i.fo = ashr exact i64 %sext.i23, 32            ; 3 uses
  %i.fp = zext nneg i32 %spec.store.select.i22 to i64 ; 3 uses
  %sext55.i24 = shl i64 %i.fg, 32
  %i.fq = ashr exact i64 %sext55.i24, 32          ; 2 uses
  %smin61 = tail call i64 @llvm.smin.i64(i64 %i.fo, i64 %i.fp)
  %.not35.not.i27103 = icmp sgt i64 %i.fo, %i.fp
  br i1 %.not35.not.i27103, label %.lr.ph107, label %._crit_edge108

bb.n:                                             ; preds = %.lr.ph107
  %.not35.not.i27 = icmp sgt i64 %indvars.iv.next.i29, %i.fp
  br i1 %.not35.not.i27, label %.lr.ph107, label %._crit_edge108, !llvm.loop !1462

.lr.ph107:                                        ; preds = %bb.m, %bb.n
  %indvars.iv.i26105 = phi i64 [ %indvars.iv.next.i29, %bb.n ], [ %i.fo, %bb.m ]
  %indvars.iv45.i25104 = phi i64 [ %indvars.iv.next46.i30, %bb.n ], [ %i.fq, %bb.m ]
  %indvars.iv.next.i29 = add nsw i64 %indvars.iv.i26105, -1 ; 3 uses
  %indvars.iv.next46.i30 = add nsw i64 %indvars.iv45.i25104, -1 ; 3 uses
  %i.fr = getelementptr inbounds nuw [4 x i8], ptr %i.fm, i64 %indvars.iv.next.i29
  %i.fs = load i32, ptr %i.fr, align 4, !tbaa !3  ; 2 uses
  %i.ft = getelementptr inbounds [4 x i8], ptr %i.fn, i64 %indvars.iv.next46.i30
  %i.fu = load i32, ptr %i.ft, align 4, !tbaa !3  ; 2 uses
  %.not37.i31 = icmp eq i32 %i.fs, %i.fu
  br i1 %.not37.i31, label %bb.n, label %.loopexit.i32, !llvm.loop !1462

._crit_edge108:                                   ; preds = %bb.n, %bb.m
  %indvars.iv45.i25.lcssa = phi i64 [ %i.fq, %bb.m ], [ %indvars.iv.next46.i30, %bb.n ]
...
.loopexit.i32:                                    ; preds = %.lr.ph107
  %i.fv = icmp ugt i32 %i.fs, %i.fu
  br i1 %i.fv, label %_ZN3fmt3v116detail7compareERKNS1_6bigintES4_.exit33.backedge, label %_ZN3fmt3v116detail7compareERKNS1_6bigintES4_.exit
...
_ZN3fmt3v116detail7compareERKNS1_6bigintES4_.exit: ; preds = %._crit_edge108, %.loopexit.i32, %bb.l, %._crit_edge, %bb.b, %.loopexit.i
  %.010 = phi i32 [ 0, %bb.b ], [ 0, %.loopexit.i ], [ 0, %._crit_edge ], [ %i.fc, %bb.l ], [ %i.fc, %.loopexit.i32 ], [ %i.fc, %._crit_edge108 ]
  ret i32 %.010
}
