begin_hunk_0
  ...
  %i.bh = getelementptr inbounds nuw i8, ptr %i.be, i64 %i.bg ; 2 uses
  %.0.copyload.i.i.i.pre = load i32, ptr %i.bh, align 1 ; 2 uses
...
begin_hunk_1
  ...
  br i1 %.not397, label %_ZN8simdjson8fallback8ondemand14value_iterator7is_nullEv.exit.i, label %.critedge.i.i.thread

_ZNK8simdjson8fallback8ondemand14value_iterator10parse_nullEPKh.exit.i: ; preds = %_ZN8simdjson8fallback8ondemand14value_iterator20peek_non_root_scalarEPKc.exit.i
  %15 = and i32 %.0.copyload.i.i.i.pre, 255
  %.not = icmp eq i32 %15, 110
  br i1 %.not, label %_ZN8simdjson8fallback8ondemand14value_iterator7is_nullEv.exit.i, label %.critedge.i

_ZN8simdjson8fallback8ondemand14value_iterator7is_nullEv.exit.i: ; preds = %_ZNK8simdjson8fallback8ondemand14value_iterator10parse_nullEPKh.exit.i, %bb.h
