...
bb.b:                                             ; preds = %bb.i, %.lr.ph.i
  ...
  %scevgep.i = getelementptr i8, ptr %.sroa.07.021.i.ptr, i64 %i.f
  %scevgep22.i = getelementptr i8, ptr %.pn20.i, i64 %i.f
  %3 = mul nuw nsw i64 %2, 24
  %i.g = load double, ptr %.sroa.07.021.i.ptr, align 8, !tbaa !113 ; 5 uses
  %i.h = load double, ptr %0, align 8, !tbaa !113 ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  %i.k = load double, ptr %i.e, align 8, !tbaa !115
...
.loopexit.i:                                      ; preds = %bb.d, %bb.b
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep.i, ptr noundef nonnull align 8 dereferenceable(1) %scevgep22.i, i64 %3, i1 false)
...
bb.e:                                             ; preds = %bb.h, %_ZNK9__gnu_cxx5__ops15_Iter_less_iterclINS_17__normal_iteratorIPN4geos11triangulate8quadedge6VertexESt6vectorIS7_SaIS7_EEEESC_EEbT_T0_.exit.i
  ...
  %i.m = load double, ptr %.sroa.0.0.i.i, align 8, !tbaa !113 ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.q = load double, ptr %i.p, align 8, !tbaa !115
...
_ZSt25__unguarded_linear_insertIN9__gnu_cxx17__normal_iteratorIPN4geos11triangulate8quadedge6VertexESt6vectorIS5_SaIS5_EEEENS0_5__ops14_Val_less_iterEEvT_T0_.exit.i: ; preds = %bb.g, %bb.f
  store double %i.g, ptr %.sroa.09.0.i.i, align 8, !tbaa !8
...
.lr.ph.i6:                                        ; preds = %_ZSt16__insertion_sortIN9__gnu_cxx17__normal_iteratorIPN4geos11triangulate8quadedge6VertexESt6vectorIS5_SaIS5_EEEENS0_5__ops15_Iter_less_iterEEvT_SD_T0_.exit, %_ZSt25__unguarded_linear_insertIN9__gnu_cxx17__normal_iteratorIPN4geos11triangulate8quadedge6VertexESt6vectorIS5_SaIS5_EEEENS0_5__ops14_Val_less_iterEEvT_T0_.exit.i11
  ...
  %i.t = load <2 x double>, ptr %.sroa.0.05.i, align 8, !tbaa !8 ; 3 uses
...
bb.j:                                             ; preds = %bb.m, %.lr.ph.i6
  ...
  %i.w = load double, ptr %.sroa.0.0.i.i10, align 8, !tbaa !113 ; 2 uses
...
_ZSt25__unguarded_linear_insertIN9__gnu_cxx17__normal_iteratorIPN4geos11triangulate8quadedge6VertexESt6vectorIS5_SaIS5_EEEENS0_5__ops14_Val_less_iterEEvT_T0_.exit.i11: ; preds = %bb.l, %bb.k
  store <2 x double> %i.t, ptr %.sroa.09.0.i.i9, align 8, !tbaa !8
...
bb.o:                                             ; preds = %bb.w, %.lr.ph.i19
  ...
  %.sroa.07.021.i21 = phi ptr [ %.sroa.07.018.i17, %.lr.ph.i19 ], [ %.sroa.07.0.i37, %bb.w ] ; 7 uses
  %.pn20.i22 = phi ptr [ %0, %.lr.ph.i19 ], [ %.sroa.07.021.i21, %bb.w ] ; 3 uses
  %4 = mul nuw i64 %indvar.i20, 24
  %5 = add i64 %4, 24
  %6 = udiv i64 %5, 24                            ; 2 uses
  %7 = icmp samesign ugt i64 %indvar.i20, 768614336404564649 ; 2 uses
  %8 = select i1 %7, i64 0, i64 24
  %.neg.i24 = mul i64 %6, -24
  %9 = add i64 %.neg.i24, %8                      ; 2 uses
  %scevgep.i25 = getelementptr i8, ptr %.sroa.07.021.i21, i64 %9
  %scevgep22.i26 = getelementptr i8, ptr %.pn20.i22, i64 %9
  %10 = zext i1 %7 to i64
  %i.af = add nuw nsw i64 %6, %10
  %11 = mul nuw i64 %i.af, 24
  %i.ag = load double, ptr %.sroa.07.021.i21, align 8, !tbaa !113 ; 5 uses
  %i.ah = load double, ptr %0, align 8, !tbaa !113 ; 2 uses
...
bb.p:                                             ; preds = %bb.o
  ...
  %.sroa.6.0.copyload.i.pre.i28 = load double, ptr %.sroa.6.0..sroa_idx.i.phi.trans.insert.i27, align 8, !tbaa !8 ; 3 uses
...
bb.q:                                             ; preds = %bb.p
  %i.ak = load double, ptr %i.ae, align 8, !tbaa !115
...
.lr.ph.preheader.i.i.i.i.i.i41:                   ; preds = %bb.r
  tail call void @llvm.memmove.p0.p0.i64(ptr align 8 %scevgep.i25, ptr align 8 %scevgep22.i26, i64 %11, i1 false)
...
_ZNK9__gnu_cxx5__ops15_Iter_less_iterclINS_17__normal_iteratorIPN4geos11triangulate8quadedge6VertexESt6vectorIS7_SaIS7_EEEESC_EEbT_T0_.exit.i29: ; preds = %bb.q, %bb.p
  ...
  %.sroa.7.0.copyload.i.i31 = load double, ptr %.sroa.7.0..sroa_idx.i.i30, align 8, !tbaa !8
  br label %bb.s
...
bb.s:                                             ; preds = %bb.v, %_ZNK9__gnu_cxx5__ops15_Iter_less_iterclINS_17__normal_iteratorIPN4geos11triangulate8quadedge6VertexESt6vectorIS7_SaIS7_EEEESC_EEbT_T0_.exit.i29
  ...
  %i.ap = load double, ptr %.sroa.0.0.i.i33, align 8, !tbaa !113 ; 2 uses
...
bb.v:                                             ; preds = %bb.u, %bb.s
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %.sroa.09.0.i.i32, ptr noundef nonnull align 8 dereferenceable(24) %.sroa.0.0.i.i33, i64 24, i1 false), !tbaa.struct !118
...
_ZSt25__unguarded_linear_insertIN9__gnu_cxx17__normal_iteratorIPN4geos11triangulate8quadedge6VertexESt6vectorIS5_SaIS5_EEEENS0_5__ops14_Val_less_iterEEvT_T0_.exit.i34: ; preds = %bb.u, %bb.t
  store double %i.ag, ptr %.sroa.09.0.i.i32, align 8, !tbaa !8
  %.sroa.6.0..sroa_idx5.i.i35 = getelementptr inbounds nuw i8, ptr %.sroa.09.0.i.i32, i64 8
  store double %.sroa.6.0.copyload.i.pre.i28, ptr %.sroa.6.0..sroa_idx5.i.i35, align 8, !tbaa !8
  %.sroa.7.0..sroa_idx7.i.i36 = getelementptr inbounds nuw i8, ptr %.sroa.09.0.i.i32, i64 16
  store double %.sroa.7.0.copyload.i.i31, ptr %.sroa.7.0..sroa_idx7.i.i36, align 8, !tbaa !8
  br label %bb.w
...
bb.w:                                             ; preds = %_ZSt25__unguarded_linear_insertIN9__gnu_cxx17__normal_iteratorIPN4geos11triangulate8quadedge6VertexESt6vectorIS5_SaIS5_EEEENS0_5__ops14_Val_less_iterEEvT_T0_.exit.i34, %.loopexit.i40
  ...
  br i1 %.not.i38, label %_ZSt26__unguarded_insertion_sortIN9__gnu_cxx17__normal_iteratorIPN4geos11triangulate8quadedge6VertexESt6vectorIS5_SaIS5_EEEENS0_5__ops15_Iter_less_iterEEvT_SD_T0_.exit, label %bb.o, !llvm.loop !121
