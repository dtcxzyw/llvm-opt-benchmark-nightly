...
begin_hunk_0_@_ZN8facebook5velox6memory16SharedArbitrator24reclaimUsedMemoryBySpillEmRSt13unordered_setImSt4hashImESt8equal_toImESaImEESA_Rb:bb.a
  ...
  %10 = alloca %"class.std::function.249", align 16 ; 12 uses
...
begin_hunk_1_@_ZN8facebook5velox6memory16SharedArbitrator24reclaimUsedMemoryBySpillEmRSt13unordered_setImSt4hashImESt8equal_toImESaImEESA_Rb:bb.a
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %10, i8 0, i64 32, i1 false), !noalias !789
...
bb.gd:                                            ; preds = %bb.gc
  %.sroa.0.i.i.i.i.sroa.0.0.copyload = load <2 x i64>, ptr %10, align 16, !tbaa !14, !noalias !789
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %10, ptr noundef nonnull align 8 dereferenceable(32) %i.ue, i64 16, i1 false), !tbaa.struct !754, !noalias !789
  store <2 x i64> %.sroa.0.i.i.i.i.sroa.0.0.copyload, ptr %i.ue, align 8, !tbaa !14, !noalias !789
  %i.uj = load <2 x ptr>, ptr %i.uf, align 8, !tbaa !118, !noalias !789
  %i.uk = load <2 x ptr>, ptr %i.jt, align 16, !tbaa !118, !noalias !789
  store <2 x ptr> %i.uj, ptr %i.jt, align 16, !tbaa !118, !noalias !789
...
bb.ge:                                            ; preds = %bb.gd, %_ZN5folly10SemiFutureINS_4UnitEED2Ev.exit.i, %_ZNSt10lock_guardISt5mutexEC2ERS0_.exit.i
  ...
  %.val.i = load ptr, ptr %i.jt, align 16, !tbaa !117, !noalias !789
...
_ZN5folly10SemiFutureINS_4UnitEED2Ev.exit54.i:    ; preds = %bb.he, %bb.hd
  ...
  %i.wk = load ptr, ptr %i.jt, align 16, !tbaa !117, !noalias !789 ; 2 uses
...
bb.hi:                                            ; preds = %_ZNSt15__exception_ptr13exception_ptrD2Ev.exit50.i, %bb.gx, %_ZN5folly17ExecutorKeepAliveINS_8ExecutorEED2Ev.exit11.i.i, %bb.gg, %_ZNSt15__exception_ptr13exception_ptrD2Ev.exit28.i, %bb.eo
  ...
  %.pre65.i = load ptr, ptr %i.jt, align 16, !tbaa !117, !noalias !789 ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %11) #28, !noalias !789
...
bb.a:
  %1 = alloca %"class.std::function.249", align 16 ; 14 uses
...
bb.k:                                             ; preds = %bb.i
  ...
  %.sroa.0.i.i.i.i.i.sroa.0.0.copyload = load <2 x i64>, ptr %1, align 16, !tbaa !14
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %1, ptr noundef nonnull align 8 dereferenceable(32) %i.j, i64 16, i1 false), !tbaa.struct !754
  store <2 x i64> %.sroa.0.i.i.i.i.i.sroa.0.0.copyload, ptr %i.j, align 8, !tbaa !14
  %i.k = getelementptr inbounds nuw i8, ptr %1, i64 16 ; 2 uses
  %i.l = getelementptr inbounds nuw i8, ptr %.val, i64 224 ; 2 uses
  %i.m = load <2 x ptr>, ptr %i.l, align 8, !tbaa !118
  %i.n = load <2 x ptr>, ptr %i.k, align 16, !tbaa !118
  store <2 x ptr> %i.m, ptr %i.k, align 16, !tbaa !118
...
bb.l:                                             ; preds = %bb.k, %bb.j
  ...
  %i.q = load ptr, ptr %i.p, align 16, !tbaa !117 ; 2 uses
...
bb.q:                                             ; preds = %bb.p, %bb.o, %bb.f
  ...
  %i.x = load ptr, ptr %i.w, align 16, !tbaa !117 ; 2 uses
...
bb.a:
  %2 = alloca %"class.std::function.269", align 16 ; 9 uses
...
bb.n:                                             ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit12
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %2, ptr noundef nonnull align 8 dereferenceable(32) %i.be, i64 16, i1 false), !tbaa.struct !754
...
_ZNSt8functionIFvvEEC2EOS1_.exit.i:               ; preds = %bb.n, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit12
  %.sroa.0.i.i.i.sroa.0.0.copyload = load <2 x i64>, ptr %2, align 16, !tbaa !14
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %2, ptr noundef nonnull align 8 dereferenceable(32) %i.ba, i64 16, i1 false), !tbaa.struct !754
  store <2 x i64> %.sroa.0.i.i.i.sroa.0.0.copyload, ptr %i.ba, align 8, !tbaa !14
  ...
  store <2 x ptr> %i.bh, ptr %i.bf, align 16, !tbaa !118
