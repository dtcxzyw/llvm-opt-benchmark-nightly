...
define range(i32 -2147483648, 2) i32 @catalan_UTF_8_stem(ptr noundef %0) local_unnamed_addr #0 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 12 ; 8 uses
  %i.b = load i32, ptr %i.a, align 4, !tbaa !7    ; 2 uses
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 40 ; 13 uses
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !14   ; 2 uses
  %i.e = getelementptr inbounds nuw i8, ptr %i.d, i64 4
  store i32 %i.b, ptr %i.e, align 4, !tbaa !3
  store i32 %i.b, ptr %i.d, align 4, !tbaa !3
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 21 uses
  %i.g = load i32, ptr %i.f, align 8, !tbaa !15   ; 2 uses
  %i.h = tail call i32 @out_grouping_U(ptr noundef %0, ptr noundef nonnull @g_v, i32 noundef 97, i32 noundef 252, i32 noundef 1) #2 ; 2 uses
  %i.i = icmp slt i32 %i.h, 0
  br i1 %i.i, label %r_mark_regions.exit, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.j = load i32, ptr %i.f, align 8, !tbaa !15
  %i.k = add nsw i32 %i.j, %i.h
  store i32 %i.k, ptr %i.f, align 8, !tbaa !15
  %i.l = tail call i32 @in_grouping_U(ptr noundef nonnull %0, ptr noundef nonnull @g_v, i32 noundef 97, i32 noundef 252, i32 noundef 1) #2 ; 2 uses
  %i.m = icmp slt i32 %i.l, 0
  br i1 %i.m, label %r_mark_regions.exit, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.n = load i32, ptr %i.f, align 8, !tbaa !15
  %i.o = add nsw i32 %i.n, %i.l                   ; 2 uses
  store i32 %i.o, ptr %i.f, align 8, !tbaa !15
  %i.p = load ptr, ptr %i.c, align 8, !tbaa !14
  %i.q = getelementptr inbounds nuw i8, ptr %i.p, i64 4
  store i32 %i.o, ptr %i.q, align 4, !tbaa !3
  %i.r = tail call i32 @out_grouping_U(ptr noundef nonnull %0, ptr noundef nonnull @g_v, i32 noundef 97, i32 noundef 252, i32 noundef 1) #2 ; 2 uses
  %i.s = icmp slt i32 %i.r, 0
  br i1 %i.s, label %r_mark_regions.exit, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.t = load i32, ptr %i.f, align 8, !tbaa !15
  %i.u = add nsw i32 %i.t, %i.r
  store i32 %i.u, ptr %i.f, align 8, !tbaa !15
  %i.v = tail call i32 @in_grouping_U(ptr noundef nonnull %0, ptr noundef nonnull @g_v, i32 noundef 97, i32 noundef 252, i32 noundef 1) #2 ; 2 uses
  %i.w = icmp slt i32 %i.v, 0
  br i1 %i.w, label %r_mark_regions.exit, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.x = load i32, ptr %i.f, align 8, !tbaa !15
  %i.y = add nsw i32 %i.x, %i.v
  %i.z = load ptr, ptr %i.c, align 8, !tbaa !14
  store i32 %i.y, ptr %i.z, align 4, !tbaa !3
  br label %r_mark_regions.exit

r_mark_regions.exit:                              ; preds = %bb.a, %bb.b, %bb.c, %bb.d, %bb.e
  %i.aa = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  store i32 %i.g, ptr %i.aa, align 8, !tbaa !16
  %i.ab = load i32, ptr %i.a, align 4, !tbaa !7   ; 3 uses
  store i32 %i.ab, ptr %i.f, align 8, !tbaa !15
  %i.ac = getelementptr inbounds nuw i8, ptr %0, i64 24 ; 6 uses
  store i32 %i.ab, ptr %i.ac, align 8, !tbaa !17
  %i.ad = add nsw i32 %i.ab, -1                   ; 2 uses
  %.not.i = icmp sgt i32 %i.ad, %i.g
  br i1 %.not.i, label %bb.f, label %select.unfold

bb.f:                                             ; preds = %r_mark_regions.exit
  ...
  %.mask.i = and i32 %i.ai, 224
  %.not22.i = icmp eq i32 %.mask.i, 96
  br i1 %.not22.i, label %bb.g, label %select.unfold

bb.g:                                             ; preds = %bb.f
  %i.aj = and i32 %i.ai, 31
  %i.ak = shl nuw i32 1, %i.aj
  %i.al = and i32 %i.ak, 1634850
  %.not23.i = icmp eq i32 %i.al, 0
  br i1 %.not23.i, label %select.unfold, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.am = tail call i32 @find_among_b(ptr noundef nonnull %0, ptr noundef nonnull @a_1, i32 noundef 39) #2
  %.not24.i = icmp eq i32 %i.am, 0
  br i1 %.not24.i, label %select.unfold, label %bb.i

bb.i:                                             ; preds = %bb.h
  %i.an = load i32, ptr %i.f, align 8, !tbaa !15  ; 2 uses
  %i.ao = getelementptr inbounds nuw i8, ptr %0, i64 20
  store i32 %i.an, ptr %i.ao, align 4, !tbaa !20
  %.val27.i = load ptr, ptr %i.c, align 8, !tbaa !14
  %i.ap = getelementptr i8, ptr %.val27.i, i64 4
  %.val27.val.i = load i32, ptr %i.ap, align 4, !tbaa !3
  %.not.i.not.i = icmp sgt i32 %.val27.val.i, %i.an
...
select.unfold:                                    ; preds = %bb.j, %bb.f, %bb.g, %bb.i, %bb.h, %r_mark_regions.exit
  %i.as = load i32, ptr %i.a, align 4, !tbaa !7   ; 2 uses
  store i32 %i.as, ptr %i.f, align 8, !tbaa !15
  store i32 %i.as, ptr %i.ac, align 8, !tbaa !17
  %i.at = tail call i32 @find_among_b(ptr noundef nonnull %0, ptr noundef nonnull @a_2, i32 noundef 200) #2 ; 2 uses
  %.not.i79 = icmp eq i32 %i.at, 0
  br i1 %.not.i79, label %r_standard_suffix.exit.thread, label %bb.k

bb.k:                                             ; preds = %select.unfold
  %i.au = load i32, ptr %i.f, align 8, !tbaa !15  ; 6 uses
  %i.av = getelementptr inbounds nuw i8, ptr %0, i64 20
  store i32 %i.au, ptr %i.av, align 4, !tbaa !20
  switch i32 %i.at, label %.thread111 [
    i32 1, label %bb.l
    i32 2, label %bb.n
    i32 3, label %bb.p
    i32 4, label %bb.r
...
bb.l:                                             ; preds = %bb.k
  %.val82.i = load ptr, ptr %i.c, align 8, !tbaa !14
  %i.aw = getelementptr i8, ptr %.val82.i, i64 4
  %.val82.val.i = load i32, ptr %i.aw, align 4, !tbaa !3
  %.not.i.not.i80 = icmp sgt i32 %.val82.val.i, %i.au
  br i1 %.not.i.not.i80, label %r_standard_suffix.exit.thread, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.ax = tail call i32 @slice_del(ptr noundef nonnull %0) #2 ; 2 uses
  %i.ay = icmp sgt i32 %i.ax, -1
  br i1 %i.ay, label %.thread111, label %.thread139

bb.n:                                             ; preds = %bb.k
  %.val88.i = load ptr, ptr %i.c, align 8, !tbaa !14
  %.val88.val.i = load i32, ptr %.val88.i, align 4, !tbaa !3
  %.not.i89.not.i = icmp sgt i32 %.val88.val.i, %i.au
  br i1 %.not.i89.not.i, label %r_standard_suffix.exit.thread, label %bb.o

bb.o:                                             ; preds = %bb.n
  %i.az = tail call i32 @slice_del(ptr noundef nonnull %0) #2 ; 2 uses
  %i.ba = icmp sgt i32 %i.az, -1
  br i1 %i.ba, label %.thread111, label %.thread139

bb.p:                                             ; preds = %bb.k
  %.val86.i = load ptr, ptr %i.c, align 8, !tbaa !14
  %.val86.val.i = load i32, ptr %.val86.i, align 4, !tbaa !3
  %.not.i91.not.i = icmp sgt i32 %.val86.val.i, %i.au
  br i1 %.not.i91.not.i, label %r_standard_suffix.exit.thread, label %bb.q

bb.q:                                             ; preds = %bb.p
  %i.bb = tail call i32 @slice_from_s(ptr noundef nonnull %0, i32 noundef 3, ptr noundef nonnull @s_6) #2 ; 2 uses
  %i.bc = icmp sgt i32 %i.bb, -1
  br i1 %i.bc, label %.thread111, label %.thread139

bb.r:                                             ; preds = %bb.k
  %.val84.i = load ptr, ptr %i.c, align 8, !tbaa !14
  %.val84.val.i = load i32, ptr %.val84.i, align 4, !tbaa !3
  %.not.i93.not.i = icmp sgt i32 %.val84.val.i, %i.au
  br i1 %.not.i93.not.i, label %r_standard_suffix.exit.thread, label %bb.s

bb.s:                                             ; preds = %bb.r
  %i.bd = tail call i32 @slice_from_s(ptr noundef nonnull %0, i32 noundef 2, ptr noundef nonnull @s_7) #2 ; 2 uses
  %i.be = icmp sgt i32 %i.bd, -1
  br i1 %i.be, label %.thread111, label %.thread139

bb.t:                                             ; preds = %bb.k
  %.val80.i = load ptr, ptr %i.c, align 8, !tbaa !14
  %i.bf = getelementptr i8, ptr %.val80.i, i64 4
  %.val80.val.i = load i32, ptr %i.bf, align 4, !tbaa !3
  %.not.i95.not.i = icmp sgt i32 %.val80.val.i, %i.au
  br i1 %.not.i95.not.i, label %r_standard_suffix.exit.thread, label %bb.u

bb.u:                                             ; preds = %bb.t
  %i.bg = tail call i32 @slice_from_s(ptr noundef nonnull %0, i32 noundef 1, ptr noundef nonnull @s_8) #2 ; 2 uses
  %i.bh = icmp sgt i32 %i.bg, -1
  br i1 %i.bh, label %.thread111, label %.thread139

r_standard_suffix.exit.thread:                    ; preds = %select.unfold, %bb.t, %bb.r, %bb.p, %bb.n, %bb.l
  %i.bi = load i32, ptr %i.a, align 4, !tbaa !7   ; 2 uses
  store i32 %i.bi, ptr %i.f, align 8, !tbaa !15
  store i32 %i.bi, ptr %i.ac, align 8, !tbaa !17
  %i.bj = tail call i32 @find_among_b(ptr noundef nonnull %0, ptr noundef nonnull @a_3, i32 noundef 283) #2 ; 2 uses
  %.not.i81 = icmp eq i32 %i.bj, 0
  br i1 %.not.i81, label %.thread111, label %bb.v

bb.v:                                             ; preds = %r_standard_suffix.exit.thread
  %i.bk = load i32, ptr %i.f, align 8, !tbaa !15  ; 3 uses
  %i.bl = getelementptr inbounds nuw i8, ptr %0, i64 20
  store i32 %i.bk, ptr %i.bl, align 4, !tbaa !20
  switch i32 %i.bj, label %.thread111 [
    i32 1, label %bb.w
    i32 2, label %bb.y
  ]

bb.w:                                             ; preds = %bb.v
  %.val35.i = load ptr, ptr %i.c, align 8, !tbaa !14
  %i.bm = getelementptr i8, ptr %.val35.i, i64 4
  %.val35.val.i = load i32, ptr %i.bm, align 4, !tbaa !3
  %.not.i.not.i82 = icmp sgt i32 %.val35.val.i, %i.bk
  br i1 %.not.i.not.i82, label %.thread111, label %bb.x

bb.x:                                             ; preds = %bb.w
  %i.bn = tail call i32 @slice_del(ptr noundef nonnull %0) #2 ; 2 uses
  %i.bo = icmp sgt i32 %i.bn, -1
  br i1 %i.bo, label %.thread111, label %.thread139

bb.y:                                             ; preds = %bb.v
  %.val37.i = load ptr, ptr %i.c, align 8, !tbaa !14
  %.val37.val.i = load i32, ptr %.val37.i, align 4, !tbaa !3
  %.not.i38.not.i = icmp sgt i32 %.val37.val.i, %i.bk
  br i1 %.not.i38.not.i, label %.thread111, label %bb.z

bb.z:                                             ; preds = %bb.y
  %i.bp = tail call i32 @slice_del(ptr noundef nonnull %0) #2 ; 2 uses
  %i.bq = icmp sgt i32 %i.bp, -1
  br i1 %i.bq, label %.thread111, label %.thread139

.thread111:                                       ; preds = %bb.u, %bb.s, %bb.q, %bb.o, %bb.m, %bb.k, %bb.v, %bb.x, %bb.z, %bb.w, %bb.y, %r_standard_suffix.exit.thread
  %i.br = load i32, ptr %i.a, align 4, !tbaa !7   ; 2 uses
  store i32 %i.br, ptr %i.f, align 8, !tbaa !15
  store i32 %i.br, ptr %i.ac, align 8, !tbaa !17
  %i.bs = tail call i32 @find_among_b(ptr noundef nonnull %0, ptr noundef nonnull @a_4, i32 noundef 22) #2 ; 2 uses
  %.not.i83 = icmp eq i32 %i.bs, 0
  br i1 %.not.i83, label %bb.af, label %bb.aa

bb.aa:                                            ; preds = %.thread111
  %i.bt = load i32, ptr %i.f, align 8, !tbaa !15  ; 3 uses
  %i.bu = getelementptr inbounds nuw i8, ptr %0, i64 20
  store i32 %i.bt, ptr %i.bu, align 4, !tbaa !20
...
bb.ab:                                            ; preds = %bb.aa
  %.val37.i88 = load ptr, ptr %i.c, align 8, !tbaa !14
  %i.bv = getelementptr i8, ptr %.val37.i88, i64 4
  %.val37.val.i89 = load i32, ptr %i.bv, align 4, !tbaa !3
  %.not.i.not.i90 = icmp sgt i32 %.val37.val.i89, %i.bt
  br i1 %.not.i.not.i90, label %bb.af, label %bb.ac

bb.ac:                                            ; preds = %bb.ab
  %i.bw = tail call i32 @slice_del(ptr noundef nonnull %0) #2 ; 2 uses
  %i.bx = icmp sgt i32 %i.bw, -1
  br i1 %i.bx, label %bb.af, label %.thread139

bb.ad:                                            ; preds = %bb.aa
  %.val35.i84 = load ptr, ptr %i.c, align 8, !tbaa !14
  %i.by = getelementptr i8, ptr %.val35.i84, i64 4
  %.val35.val.i85 = load i32, ptr %i.by, align 4, !tbaa !3
  %.not.i38.not.i86 = icmp sgt i32 %.val35.val.i85, %i.bt
  br i1 %.not.i38.not.i86, label %bb.af, label %bb.ae

bb.ae:                                            ; preds = %bb.ad
  %i.bz = tail call i32 @slice_from_s(ptr noundef nonnull %0, i32 noundef 2, ptr noundef nonnull @s_9) #2 ; 2 uses
  %i.ca = icmp sgt i32 %i.bz, -1
  br i1 %i.ca, label %bb.af, label %.thread139

bb.af:                                            ; preds = %bb.aa, %bb.ac, %bb.ae, %.thread111, %bb.ad, %bb.ab
  %i.cb = load i32, ptr %i.a, align 4, !tbaa !7
  %i.cc = load i32, ptr %i.aa, align 8, !tbaa !16 ; 3 uses
  store i32 %i.cc, ptr %i.f, align 8, !tbaa !15
  %i.cd = getelementptr inbounds nuw i8, ptr %0, i64 20
  br label %bb.ag

bb.ag:                                            ; preds = %bb.as, %bb.af
  %i.ce = phi i32 [ %.pre149, %bb.as ], [ %i.cb, %bb.af ] ; 2 uses
  %i.cf = phi i32 [ %.pre, %bb.as ], [ %i.cc, %bb.af ] ; 4 uses
  store i32 %i.cf, ptr %i.cd, align 4, !tbaa !20
  %i.cg = add nsw i32 %i.cf, 1                    ; 2 uses
  %.not.i91 = icmp slt i32 %i.cg, %i.ce
  br i1 %.not.i91, label %bb.ah, label %.thread82.i

bb.ah:                                            ; preds = %bb.ag
  %i.ch = load ptr, ptr %0, align 8, !tbaa !18
  ...
  %.mask.i92 = and i32 %i.cl, 224
  %.not70.i = icmp eq i32 %.mask.i92, 160
  br i1 %.not70.i, label %bb.ai, label %.thread82.i

bb.ai:                                            ; preds = %bb.ah
  %i.cm = and i32 %i.cl, 31
  %i.cn = shl nuw i32 1, %i.cm
  %i.co = and i32 %i.cn, 344765187
  %.not71.i = icmp eq i32 %i.co, 0
  br i1 %.not71.i, label %.thread82.i, label %bb.aj

.thread82.i:                                      ; preds = %bb.ai, %bb.ah, %bb.ag
  store i32 %i.cf, ptr %i.ac, align 8, !tbaa !17
  br label %bb.ar

bb.aj:                                            ; preds = %bb.ai
  %i.cp = tail call i32 @find_among(ptr noundef nonnull %0, ptr noundef nonnull @a_0, i32 noundef 13) #2 ; 2 uses
  %.not72.i = icmp eq i32 %i.cp, 0
  br i1 %.not72.i, label %bb.at, label %bb.ak

bb.ak:                                            ; preds = %bb.aj
  %i.cq = load i32, ptr %i.f, align 8, !tbaa !15  ; 2 uses
  store i32 %i.cq, ptr %i.ac, align 8, !tbaa !17
  switch i32 %i.cp, label %bb.as [
    i32 1, label %bb.al
    i32 2, label %bb.am
    i32 3, label %bb.an
    i32 4, label %bb.ao
...
._crit_edge.i:                                    ; preds = %bb.ak
  %.pre.i = load i32, ptr %i.a, align 4, !tbaa !7
  br label %bb.ar

bb.al:                                            ; preds = %bb.ak
  %i.cr = tail call i32 @slice_from_s(ptr noundef nonnull %0, i32 noundef 1, ptr noundef nonnull @s_0) #2 ; 2 uses
  %i.cs = icmp sgt i32 %i.cr, -1
  br i1 %i.cs, label %bb.as, label %.thread139

bb.am:                                            ; preds = %bb.ak
  %i.ct = tail call i32 @slice_from_s(ptr noundef nonnull %0, i32 noundef 1, ptr noundef nonnull @s_1) #2 ; 2 uses
  %i.cu = icmp sgt i32 %i.ct, -1
  br i1 %i.cu, label %bb.as, label %.thread139

bb.an:                                            ; preds = %bb.ak
  %i.cv = tail call i32 @slice_from_s(ptr noundef nonnull %0, i32 noundef 1, ptr noundef nonnull @s_2) #2 ; 2 uses
  %i.cw = icmp sgt i32 %i.cv, -1
  br i1 %i.cw, label %bb.as, label %.thread139

bb.ao:                                            ; preds = %bb.ak
  %i.cx = tail call i32 @slice_from_s(ptr noundef nonnull %0, i32 noundef 1, ptr noundef nonnull @s_3) #2 ; 2 uses
  %i.cy = icmp sgt i32 %i.cx, -1
  br i1 %i.cy, label %bb.as, label %.thread139

bb.ap:                                            ; preds = %bb.ak
  %i.cz = tail call i32 @slice_from_s(ptr noundef nonnull %0, i32 noundef 1, ptr noundef nonnull @s_4) #2 ; 2 uses
  %i.da = icmp sgt i32 %i.cz, -1
  br i1 %i.da, label %bb.as, label %.thread139

bb.aq:                                            ; preds = %bb.ak
  %i.db = tail call i32 @slice_from_s(ptr noundef nonnull %0, i32 noundef 1, ptr noundef nonnull @s_5) #2 ; 2 uses
  %i.dc = icmp sgt i32 %i.db, -1
  br i1 %i.dc, label %bb.as, label %.thread139

bb.ar:                                            ; preds = %._crit_edge.i, %.thread82.i
  %i.dd = phi i32 [ %i.ce, %.thread82.i ], [ %.pre.i, %._crit_edge.i ]
  %i.de = phi i32 [ %i.cf, %.thread82.i ], [ %i.cq, %._crit_edge.i ]
  %i.df = load ptr, ptr %0, align 8, !tbaa !18
  %i.dg = tail call i32 @skip_utf8(ptr noundef %i.df, i32 noundef %i.de, i32 noundef %i.dd, i32 noundef 1) #2 ; 2 uses
  %i.dh = icmp slt i32 %i.dg, 0
  br i1 %i.dh, label %bb.at, label %.thread84.i

.thread84.i:                                      ; preds = %bb.ar
  store i32 %i.dg, ptr %i.f, align 8, !tbaa !15
  br label %bb.as

bb.as:                                            ; preds = %.thread84.i, %bb.aq, %bb.ap, %bb.ao, %bb.an, %bb.am, %bb.al, %bb.ak
  %.pre = load i32, ptr %i.f, align 8, !tbaa !15
  %.pre149 = load i32, ptr %i.a, align 4, !tbaa !7
  br label %bb.ag

bb.at:                                            ; preds = %bb.aj, %bb.ar
  store i32 %i.cc, ptr %i.f, align 8, !tbaa !15
  br label %.thread139
...
; Function Attrs: nounwind uwtable
define ptr @catalan_UTF_8_create_env() local_unnamed_addr #0 {
bb.a:
...
; Function Attrs: nounwind uwtable
define void @catalan_UTF_8_close_env(ptr noundef %0) local_unnamed_addr #0 {
bb.a:
