...
bb.j:                                             ; preds = %_ZN5folly7PromiseINS_4UnitEE13getSemiFutureEv.exit
  ...
  br i1 %.not.i.i.i41, label %_ZN5folly10SemiFutureINS_4UnitEED2Ev.exit, label %bb.k
...
bb.l:                                             ; preds = %_ZN5folly7PromiseINS_4UnitEE13getSemiFutureEv.exit
...
_ZN5folly10SemiFutureINS_4UnitEED2Ev.exit:        ; preds = %bb.j, %bb.k
...
begin_hunk_2_@_ZN5folly7futures6detail8waitImplINS_10SemiFutureINS_4UnitEEES4_EEvRT_:bb.a
  ...
  store ptr %i.c, ptr %7, align 8, !tbaa !51
...
bb.d:                                             ; preds = %bb.c
  %i.l = load ptr, ptr %7, align 8, !tbaa !51     ; 3 uses
...
bb.e:                                             ; preds = %bb.d
  %i.m = load i8, ptr %6, align 8, !tbaa !59, !range !66, !noundef !67
...
bb.f:                                             ; preds = %bb.e
  ...
  %.pre.i.i.i = load ptr, ptr %7, align 8, !tbaa !51
  br label %bb.g
