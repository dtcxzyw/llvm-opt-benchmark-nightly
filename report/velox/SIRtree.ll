...
bb.a:
  ...
  %i.c = tail call noundef ptr %i.b(ptr noundef nonnull align 8 dereferenceable(8) %0)
  %2 = load ptr, ptr %1, align 8, !tbaa !10
  %3 = load ptr, ptr %2, align 8
  %4 = load <2 x double>, ptr %i.c, align 8, !tbaa !84 ; 2 uses
  %5 = tail call noundef ptr %3(ptr noundef nonnull align 8 dereferenceable(8) %1)
  %6 = load <2 x double>, ptr %5, align 8, !tbaa !84 ; 2 uses
  %7 = shufflevector <2 x double> %4, <2 x double> %6, <2 x i32> <i32 0, i32 2>
  %8 = shufflevector <2 x double> %4, <2 x double> %6, <2 x i32> <i32 1, i32 3>
  %9 = fadd <2 x double> %7, %8
  %10 = fmul <2 x double> %9, splat (double 5.000000e-01) ; 2 uses
  %shift = shufflevector <2 x double> %10, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %11 = fcmp olt <2 x double> %10, %shift
...
bb.d:                                             ; preds = %bb.c
  tail call void @_ZdlPv(ptr noundef nonnull %i.e) #19, !inline_history !86
...
bb.b:                                             ; preds = %bb.a
  tail call void @_ZdlPv(ptr noundef nonnull %i.b) #19, !inline_history !87
  br label %bb.c
...
bb.d:                                             ; preds = %bb.c
  tail call void @_ZdlPv(ptr noundef nonnull %i.e) #19, !inline_history !88
...
bb.c:                                             ; preds = %bb.b
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %i.j, ptr noundef nonnull align 8 dereferenceable(16) %i.m, i64 16, i1 false), !tbaa.struct !89
  br label %bb.f
...
begin_hunk_6_@_ZNK4geos5index7strtree15SIRAbstractNode13computeBoundsEv:bb.a
  ...
  %i.t = load double, ptr %i.r, align 8, !tbaa !84 ; 2 uses
  %i.u = load double, ptr %i.s, align 8, !tbaa !84 ; 2 uses
  %i.v = fcmp olt double %i.t, %i.u
  %i.w = select i1 %i.v, double %i.u, double %i.t
  store double %i.w, ptr %i.r, align 8, !tbaa !39
  %i.x = load double, ptr %i.q, align 8, !tbaa !84 ; 2 uses
  %i.y = load double, ptr %.016, align 8, !tbaa !84 ; 2 uses
...
!84 = !{!38, !38, i64 0}
!85 = !{!22, !24, i64 24}
!86 = !{ptr @_ZN4geos5index7strtree12AbstractNodeD2Ev}
!87 = !{ptr @_ZN4geos5index7strtree15SIRAbstractNodeD2Ev}
!88 = !{ptr @_ZN4geos5index7strtree15SIRAbstractNodeD2Ev, ptr @_ZN4geos5index7strtree12AbstractNodeD2Ev}
!89 = !{i64 0, i64 8, !84, i64 8, i64 8, !84}
!90 = distinct !{!90, !28}
!91 = distinct !{!91, !28}
