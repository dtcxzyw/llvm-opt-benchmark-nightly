...
._crit_edge:                                      ; preds = %.lr.ph, %bb.g
  %i.am = phi <4 x double> [ <double 0xFFF0000000000000, double 0x7FF0000000000000, double 0xFFF0000000000000, double 0x7FF0000000000000>, %bb.g ], [ %i.do, %.lr.ph ] ; 8 uses
...
bb.h:                                             ; preds = %._crit_edge
  %i.ar = extractelement <4 x double> %i.am, i64 2
  ...
  %i.aw = extractelement <4 x double> %i.am, i64 3
...
bb.j:                                             ; preds = %_ZN4geos9algorithm15MinimumDiameter21computeSegmentForLineEddd.exit61
  %i.bp = extractelement <4 x double> %i.am, i64 0
  ...
  %i.bu = extractelement <4 x double> %i.am, i64 1
...
bb.k:                                             ; preds = %_ZN4geos9algorithm15MinimumDiameter21computeSegmentForLineEddd.exit61
  %i.bx = extractelement <4 x double> %i.am, i64 0
  ...
  %i.cc = extractelement <4 x double> %i.am, i64 1
...
.lr.ph:                                           ; preds = %bb.g, %.lr.ph
  %.044108 = phi i64 [ %i.dp, %.lr.ph ], [ 0, %bb.g ] ; 3 uses
  %i.cx = phi <4 x double> [ %i.do, %.lr.ph ], [ <double 0xFFF0000000000000, double 0x7FF0000000000000, double 0xFFF0000000000000, double 0x7FF0000000000000>, %bb.g ] ; 3 uses
...
begin_hunk_5_@_ZN4geos9algorithm15MinimumDiameter19getMinimumRectangleEv:bb.a
  ...
  %14 = shufflevector <2 x double> %i.dj, <2 x double> %i.ag, <2 x i32> <i32 1, i32 2>
  %i.dk = insertelement <2 x double> %i.dh, double %.pre, i64 0
  %i.dl = fmul <2 x double> %14, %i.dk
  %15 = shufflevector <2 x double> %i.dj, <2 x double> %i.dh, <2 x i32> <i32 0, i32 2>
  %i.dm = fmul <2 x double> %i.ag, %15
  %i.dn = fsub <2 x double> %i.dl, %i.dm
  %16 = shufflevector <2 x double> %i.dn, <2 x double> poison, <4 x i32> <i32 1, i32 1, i32 0, i32 0> ; 3 uses
  %17 = fcmp ogt <4 x double> %16, %i.cx
  %18 = fcmp olt <4 x double> %16, %i.cx
  %19 = shufflevector <4 x i1> %17, <4 x i1> %18, <4 x i32> <i32 0, i32 5, i32 2, i32 7>
  %i.do = select <4 x i1> %19, <4 x double> %16, <4 x double> %i.cx ; 2 uses
...
._crit_edge:                                      ; preds = %bb.i, %bb.a
  %.sroa.625.0.lcssa.a = phi double [ %.sroa.625.0.copyload, %bb.a ], [ %.sroa.625.1.a, %bb.i ]
  %.sroa.022.0.lcssa.a = phi double [ %.sroa.022.0.copyload, %bb.a ], [ %.sroa.022.1.a, %bb.i ]
  %.sroa.7.0.lcssa.a = phi double [ %.sroa.7.0.copyload, %bb.a ], [ %.sroa.7.1, %bb.i ]
  %.sroa.6.0.lcssa.a = phi double [ %.sroa.6.0.copyload, %bb.a ], [ %.sroa.6.1, %bb.i ]
  %.sroa.0.0.lcssa.a = phi double [ %.sroa.0.0.copyload, %bb.a ], [ %.sroa.0.1, %bb.i ]
  %.sroa.729.0.lcssa = phi double [ %.sroa.729.0.copyload, %bb.a ], [ %.sroa.729.1, %bb.i ]
  %.sroa.033.0.lcssa = phi double [ %.sroa.033.0.copyload, %bb.a ], [ %.sroa.033.1, %bb.i ] ; 2 uses
  %.sroa.038.0.lcssa = phi double [ %.sroa.038.0.copyload, %bb.a ], [ %.sroa.038.1, %bb.i ] ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #19
  store double %.sroa.038.0.lcssa, ptr %3, align 8, !tbaa !11
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #19
  store double %.sroa.033.0.lcssa, ptr %4, align 8, !tbaa !11
  ...
  %i.v = fcmp oeq double %.sroa.038.0.lcssa, %.sroa.033.0.lcssa
  br i1 %i.v, label %bb.j, label %bb.k

.lr.ph:                                           ; preds = %bb.a, %bb.i
  %.sroa.038.070 = phi double [ %.sroa.038.1, %bb.i ], [ %.sroa.038.0.copyload, %bb.a ] ; 2 uses
  %.sroa.033.069 = phi double [ %.sroa.033.1, %bb.i ], [ %.sroa.033.0.copyload, %bb.a ] ; 2 uses
  %.05268 = phi i64 [ %i.ah, %bb.i ], [ 1, %bb.a ] ; 2 uses
  %.sroa.729.067 = phi double [ %.sroa.729.1, %bb.i ], [ %.sroa.729.0.copyload, %bb.a ]
  %.sroa.0.066 = phi double [ %.sroa.0.1, %bb.i ], [ %.sroa.0.0.copyload, %bb.a ]
  %.sroa.6.065 = phi double [ %.sroa.6.1, %bb.i ], [ %.sroa.6.0.copyload, %bb.a ] ; 2 uses
  %.sroa.7.064 = phi double [ %.sroa.7.1, %bb.i ], [ %.sroa.7.0.copyload, %bb.a ]
  %.sroa.022.063 = phi double [ %.sroa.022.1.a, %bb.i ], [ %.sroa.022.0.copyload, %bb.a ]
  %.sroa.625.062 = phi double [ %.sroa.625.1.a, %bb.i ], [ %.sroa.625.0.copyload, %bb.a ] ; 2 uses
  %i.w = load ptr, ptr %1, align 8, !tbaa !28
  %i.x = getelementptr inbounds nuw i8, ptr %i.w, i64 24
  %i.y = load ptr, ptr %i.x, align 8
  %i.z = tail call noundef nonnull align 8 dereferenceable(24) ptr %i.y(ptr noundef nonnull align 8 dereferenceable(8) %1, i64 noundef %.05268) ; 6 uses
  %i.aa = load double, ptr %i.z, align 8, !tbaa !33 ; 6 uses
  %i.ab = fcmp olt double %i.aa, %.sroa.038.070
...
bb.c:                                             ; preds = %bb.b, %.lr.ph
  %.sroa.038.1 = phi double [ %i.aa, %bb.b ], [ %.sroa.038.070, %.lr.ph ] ; 2 uses
  %i.ac = fcmp ogt double %i.aa, %.sroa.033.069
...
bb.g:                                             ; preds = %bb.f, %bb.e
  %.sroa.625.1.a = phi double [ %i.ae, %bb.f ], [ %.sroa.625.062, %bb.e ] ; 2 uses
  %.sroa.022.1.a = phi double [ %i.aa, %bb.f ], [ %.sroa.022.063, %bb.e ] ; 2 uses
  %.sroa.729.1 = phi double [ %.sroa.729.0.copyload30, %bb.f ], [ %.sroa.729.067, %bb.e ] ; 2 uses
  %i.ag = fcmp ogt double %i.ae, %.sroa.6.065
...
bb.i:                                             ; preds = %bb.h, %bb.g
  %.sroa.7.1 = phi double [ %.sroa.7.0.copyload19, %bb.h ], [ %.sroa.7.064, %bb.g ] ; 2 uses
  %.sroa.6.1 = phi double [ %i.ae, %bb.h ], [ %.sroa.6.065, %bb.g ] ; 2 uses
  %.sroa.0.1 = phi double [ %i.aa, %bb.h ], [ %.sroa.0.066, %bb.g ] ; 2 uses
  %i.ah = add nuw i64 %.05268, 1                  ; 2 uses
  %exitcond.not = icmp eq i64 %i.ah, %i.t
  br i1 %exitcond.not, label %._crit_edge, label %.lr.ph, !llvm.loop !111

bb.j:                                             ; preds = %._crit_edge
  store double %.sroa.022.0.lcssa.a, ptr %3, align 8, !tbaa !11
  store double %.sroa.625.0.lcssa.a, ptr %.sroa.741.0..sroa_idx42, align 8, !tbaa !11
  %.sroa.729.0..sroa_idx31 = getelementptr inbounds nuw i8, ptr %3, i64 16
  store double %.sroa.729.0.lcssa, ptr %.sroa.729.0..sroa_idx31, align 8, !tbaa !11
  store double %.sroa.0.0.lcssa.a, ptr %4, align 8, !tbaa !11
  store double %.sroa.6.0.lcssa.a, ptr %.sroa.736.0..sroa_idx37, align 8, !tbaa !11
  %.sroa.7.0..sroa_idx20 = getelementptr inbounds nuw i8, ptr %4, i64 16
  store double %.sroa.7.0.lcssa.a, ptr %.sroa.7.0..sroa_idx20, align 8, !tbaa !11
  br label %bb.k
