...
begin_hunk_0_@_ZN8facebook5velox16VariantConverter7convertILNS0_8TypeKindE7EEENS0_7VariantERKS4_:bb.a
  ...
  %i.h = select i1 %i.f, i64 4, i64 5             ; 4 uses
  ...
  %2 = add nuw nsw i64 %i.h, 1                    ; 2 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %.sroa.215, ptr noundef nonnull align 8 dereferenceable(1) %.sroa.213, i64 %2, i1 false), !noalias !117
...
begin_hunk_1_@_ZN8facebook5velox16VariantConverter7convertILNS0_8TypeKindE7EEENS0_7VariantERKS4_:bb.a
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %i.j, ptr noundef nonnull align 8 dereferenceable(1) %.sroa.2, i64 %2, i1 false), !noalias !117
...
begin_hunk_2_@_ZZN5folly2toIldEENSt9enable_ifIXsr6detail14IsArithToArithIT_T0_EE5valueES2_E4typeERKS3_ENKUlNS_14ConversionCodeEE_clES8_:_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm.exit.i
  ...
  %i.i = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %4) #38
