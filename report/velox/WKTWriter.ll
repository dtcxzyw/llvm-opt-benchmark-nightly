...
._crit_edge.i.i65:                                ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i60
  ...
  store ptr %i.x, ptr %7, align 8, !tbaa !22
  ...
  store i64 5, ptr %i.y, align 8, !tbaa !25
  store i8 0, ptr %i.aj, align 1, !tbaa !24
...
bb.l:                                             ; preds = %._crit_edge.i.i65
  %i.bc = load ptr, ptr %7, align 8, !tbaa !16    ; 2 uses
...
bb.m:                                             ; preds = %.loopexit.split-lp92, %.loopexit91
  ...
  %i.be = load ptr, ptr %7, align 8, !tbaa !16    ; 2 uses
...
bb.o:                                             ; preds = %bb.n, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit71
  ...
  br i1 %exitcond.not, label %._crit_edge.i.i48, label %._crit_edge.i.i55, !llvm.loop !69

bb.p:                                             ; preds = %._crit_edge.i.i48
  %i.bh = load ptr, ptr %8, align 8, !tbaa !16    ; 2 uses
...
bb.q:                                             ; preds = %._crit_edge.i.i48
  %i.bj = landingpad { ptr, i32 }
          cleanup
  %i.bk = load ptr, ptr %8, align 8, !tbaa !16    ; 2 uses
...
._crit_edge.i.i:                                  ; preds = %bb.a
  ...
  store ptr %i.e, ptr %5, align 8, !tbaa !22
  ...
  store i64 5, ptr %i.f, align 8, !tbaa !25
...
bb.b:                                             ; preds = %._crit_edge.i.i
  %i.h = load ptr, ptr %5, align 8, !tbaa !16     ; 2 uses
...
bb.c:                                             ; preds = %._crit_edge.i.i
  %i.j = landingpad { ptr, i32 }
          cleanup
  %i.k = load ptr, ptr %5, align 8, !tbaa !16     ; 2 uses
...
._crit_edge.i.i44:                                ; preds = %bb.a
  ...
  store ptr %i.m, ptr %6, align 8, !tbaa !22
  store i8 40, ptr %i.m, align 8, !tbaa !24
...
bb.d:                                             ; preds = %._crit_edge.i.i44
  %i.p = load ptr, ptr %6, align 8, !tbaa !16     ; 2 uses
...
._crit_edge.i.i51:                                ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i63, %bb.e, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit50
  ...
  store i8 41, ptr %i.aa, align 8, !tbaa !24
...
bb.f:                                             ; preds = %._crit_edge.i.i44
  %i.ad = landingpad { ptr, i32 }
          cleanup
  %i.ae = load ptr, ptr %6, align 8, !tbaa !16    ; 2 uses
...
._crit_edge.i.i58:                                ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i63, %.peel.next
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %7) #15
  store ptr %i.v, ptr %7, align 8, !tbaa !22
  store i16 8236, ptr %i.v, align 8
  store i64 2, ptr %i.w, align 8, !tbaa !25
  store i8 0, ptr %i.z, align 2, !tbaa !24
...
bb.g:                                             ; preds = %._crit_edge.i.i58
  %i.ag = load ptr, ptr %7, align 8, !tbaa !16    ; 2 uses
...
bb.h:                                             ; preds = %._crit_edge.i.i58
  %lpad.loopexit = landingpad { ptr, i32 }
          cleanup
  %.pre84 = load ptr, ptr %7, align 8, !tbaa !16  ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i63: ; preds = %bb.g, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i62
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #15
  %i.aj = load ptr, ptr %1, align 8, !tbaa !26
  ...
  br i1 %exitcond.not, label %._crit_edge.i.i51, label %._crit_edge.i.i58, !llvm.loop !70

bb.i:                                             ; preds = %._crit_edge.i.i51
  %i.ao = load ptr, ptr %8, align 8, !tbaa !16    ; 2 uses
...
bb.j:                                             ; preds = %._crit_edge.i.i51
  %i.aq = landingpad { ptr, i32 }
          cleanup
  %i.ar = load ptr, ptr %8, align 8, !tbaa !16    ; 2 uses
...
._crit_edge.i.i43:                                ; preds = %bb.a
  ...
  store ptr %i.m, ptr %5, align 8, !tbaa !22
  store i8 40, ptr %i.m, align 8, !tbaa !24
