...
bb.h:                                             ; preds = %bb.g
  ...
  store i8 46, ptr %i.x, align 1, !tbaa !11
...
bb.j:                                             ; preds = %bb.i
  ...
  store i8 48, ptr %.012, align 1, !tbaa !11
  %i.aj = getelementptr inbounds nuw i8, ptr %.012, i64 1
  store i8 46, ptr %i.aj, align 1, !tbaa !11
...
bb.l:                                             ; preds = %bb.k
  ...
  store i8 46, ptr %i.ao, align 1, !tbaa !11
...
bb.m:                                             ; preds = %bb.l, %bb.k
  ...
  store i8 101, ptr %.056.i, align 1, !tbaa !11
...
bb.q:                                             ; preds = %bb.o
  ...
  %i.bi = add i8 %i.bh, 48
  store i8 %i.bi, ptr %.023.i.i, align 1, !tbaa !11
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i, %bb.a
  ...
  br i1 %i.m, label %.lr.ph.i.i, label %.lr.ph.i32.i, !llvm.loop !277
...
.lr.ph.i32.i:                                     ; preds = %.lr.ph.i.i, %.lr.ph.i32.i
  ...
  br i1 %i.p, label %.lr.ph.i32.i, label %_ZN13geos_nlohmann6detail9dtoa_impl18compute_boundariesIdEENS1_10boundariesET_.exit, !llvm.loop !277
...
_ZN13geos_nlohmann6detail9dtoa_impl18compute_boundariesIdEENS1_10boundariesET_.exit: ; preds = %.lr.ph.i32.i
  ...
  %.sroa.0.0.copyload.i.i = load i64, ptr %i.ah, align 8, !tbaa !64 ; 2 uses
...
bb.a:
  %i.a = load i64, ptr %6, align 8, !tbaa !278    ; 4 uses
  %i.b = sub i64 %i.a, %3                         ; 4 uses
  %i.c = getelementptr inbounds nuw i8, ptr %6, i64 8
  %i.d = load i32, ptr %i.c, align 8, !tbaa !280
  %i.e = load i64, ptr %5, align 8, !tbaa !278
...
bb.j:                                             ; preds = %_ZN13geos_nlohmann6detail9dtoa_impl12grisu2_roundEPcimmmm.exit
  ...
  br i1 %i.w, label %_ZN13geos_nlohmann6detail9dtoa_impl18find_largest_pow10EjRj.exit, label %.preheader, !llvm.loop !281
...
_ZN13geos_nlohmann6detail9dtoa_impl18find_largest_pow10EjRj.exit: ; preds = %_ZN13geos_nlohmann6detail9dtoa_impl18find_largest_pow10EjRj.exit.preheader, %bb.j
  ...
  %i.aa = add i8 %i.z, 48
  %i.ab = load i32, ptr %1, align 4, !tbaa !39    ; 2 uses
  %i.ac = add nsw i32 %i.ab, 1
  store i32 %i.ac, ptr %1, align 4, !tbaa !39
  %i.ad = sext i32 %i.ab to i64
  %i.ae = getelementptr inbounds i8, ptr %0, i64 %i.ad
  store i8 %i.aa, ptr %i.ae, align 1, !tbaa !11
...
bb.k:                                             ; preds = %_ZN13geos_nlohmann6detail9dtoa_impl18find_largest_pow10EjRj.exit
  %i.aj = load i32, ptr %2, align 4, !tbaa !39
  %i.ak = add nsw i32 %i.aj, %i.af
  store i32 %i.ak, ptr %2, align 4, !tbaa !39
...
.lr.ph.i:                                         ; preds = %bb.k
  %i.ap = load i32, ptr %1, align 4, !tbaa !39
...
.critedge2.i:                                     ; preds = %bb.m, %bb.l
  %i.ay = load i8, ptr %i.as, align 1, !tbaa !11
  %i.az = add i8 %i.ay, -1
  store i8 %i.az, ptr %i.as, align 1, !tbaa !11
  %i.ba = icmp uge i64 %i.at, %i.f
  %i.bb = sub i64 %i.b, %i.at
  %.not.i = icmp ult i64 %i.bb, %i.am
  %or.cond.i = or i1 %i.ba, %.not.i
  br i1 %or.cond.i, label %_ZN13geos_nlohmann6detail9dtoa_impl12grisu2_roundEPcimmmm.exit, label %bb.l, !llvm.loop !282
...
_ZN13geos_nlohmann6detail9dtoa_impl12grisu2_roundEPcimmmm.exit: ; preds = %.critedge2.i, %bb.m, %bb.n
  ...
  br i1 %.not58, label %bb.j, label %_ZN13geos_nlohmann6detail9dtoa_impl12grisu2_roundEPcimmmm.exit68, !llvm.loop !281
...
.preheader:                                       ; preds = %bb.j, %.preheader
  ...
  %i.bh = add i8 %i.bg, 48
  %i.bi = load i32, ptr %1, align 4, !tbaa !39    ; 2 uses
  %i.bj = add nsw i32 %i.bi, 1
  store i32 %i.bj, ptr %1, align 4, !tbaa !39
  %i.bk = sext i32 %i.bi to i64
  %i.bl = getelementptr inbounds i8, ptr %0, i64 %i.bk
  store i8 %i.bh, ptr %i.bl, align 1, !tbaa !11
...
bb.o:                                             ; preds = %.preheader
  %i.bp = load i32, ptr %2, align 4, !tbaa !39
  %i.bq = sub nsw i32 %i.bp, %i.bm
  store i32 %i.bq, ptr %2, align 4, !tbaa !39
...
.lr.ph.i63:                                       ; preds = %bb.o
  %i.bt = load i32, ptr %1, align 4, !tbaa !39
...
.critedge2.i65:                                   ; preds = %bb.q, %bb.p
  %i.cc = load i8, ptr %i.bw, align 1, !tbaa !11
  %i.cd = add i8 %i.cc, -1
  store i8 %i.cd, ptr %i.bw, align 1, !tbaa !11
  %i.ce = icmp uge i64 %i.bx, %i.bo
  %i.cf = sub i64 %i.bn, %i.bx
  %.not.i66 = icmp ult i64 %i.cf, %i.i
  %or.cond.i67 = or i1 %i.ce, %.not.i66
  br i1 %or.cond.i67, label %_ZN13geos_nlohmann6detail9dtoa_impl12grisu2_roundEPcimmmm.exit68, label %bb.p, !llvm.loop !282
