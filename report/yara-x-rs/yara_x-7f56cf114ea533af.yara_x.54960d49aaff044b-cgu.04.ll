...
bb.c:                                             ; preds = %bb.a
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !2634
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(2048) %i.a, i8 0, i64 2048, i1 false), !alias.scope !2635, !noalias !2637
...
.lr.ph.i.i.prol:                                  ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i.prol
  ...
  %i.h = load i8, ptr %.sroa.0.02.i.i.prol, align 1, !alias.scope !2637, !noalias !2635, !noundef !9
  ...
  %i.l = load i64, ptr %i.k, align 8, !alias.scope !2635, !noalias !2637, !noundef !9
  %i.m = add i64 %i.l, 1
  store i64 %i.m, ptr %i.k, align 8, !alias.scope !2635, !noalias !2637
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.prol.loopexit, label %.lr.ph.i.i.prol, !llvm.loop !2625
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i
  ...
  %i.o = load i8, ptr %.sroa.0.02.i.i, align 1, !alias.scope !2637, !noalias !2635, !noundef !9
  ...
  %i.s = load i64, ptr %i.r, align 8, !alias.scope !2635, !noalias !2637, !noundef !9
  %i.t = add i64 %i.s, 1
  store i64 %i.t, ptr %i.r, align 8, !alias.scope !2635, !noalias !2637
  %i.u = load i8, ptr %i.q, align 1, !alias.scope !2637, !noalias !2635, !noundef !9
  ...
  %i.y = load i64, ptr %i.x, align 8, !alias.scope !2635, !noalias !2637, !noundef !9
  %i.z = add i64 %i.y, 1
  store i64 %i.z, ptr %i.x, align 8, !alias.scope !2635, !noalias !2637
  %i.aa = load i8, ptr %i.w, align 1, !alias.scope !2637, !noalias !2635, !noundef !9
  ...
  %i.ae = load i64, ptr %i.ad, align 8, !alias.scope !2635, !noalias !2637, !noundef !9
  %i.af = add i64 %i.ae, 1
  store i64 %i.af, ptr %i.ad, align 8, !alias.scope !2635, !noalias !2637
  %i.ag = load i8, ptr %i.ac, align 1, !alias.scope !2637, !noalias !2635, !noundef !9
  ...
  %i.ak = load i64, ptr %i.aj, align 8, !alias.scope !2635, !noalias !2637, !noundef !9
  %i.al = add i64 %i.ak, 1
  store i64 %i.al, ptr %i.aj, align 8, !alias.scope !2635, !noalias !2637
...
.preheader.i.i:                                   ; preds = %.preheader.i.i, %.preheader.i.i.preheader
  ...
  %i.ar = load i64, ptr %.sroa.0.08.ptr.i.i, align 8, !alias.scope !2638, !noalias !2634, !noundef !9
  ...
  %i.ba = load i64, ptr %.sroa.0.08.ptr.i.i.1, align 8, !alias.scope !2638, !noalias !2634, !noundef !9
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !2634
  tail call void @llvm.experimental.noalias.scope.decl(metadata !2639)
  %i.bh = load i32, ptr %1, align 8, !range !26, !alias.scope !2639, !noundef !9
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.bj = load ptr, ptr %i.bi, align 8, !alias.scope !2642, !nonnull !9, !noundef !9 ; 2 uses
  %i.bk = load i64, ptr %i.bj, align 8, !noalias !2642, !noundef !9
  %i.bl = add i64 %i.bk, -1                       ; 2 uses
  store i64 %i.bl, ptr %i.bj, align 8, !noalias !2642
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.l = icmp samesign ult i64 %i.h, 6
...
.lr.ph.i:                                         ; preds = %bb.d, %.lr.ph.i
  ...
  %i.m = load i8, ptr %.sroa.06.021.i, align 1, !alias.scope !2645, !noundef !9
  %i.n = zext i8 %i.m to i64
  %i.o = getelementptr inbounds nuw i8, ptr %.sroa.06.021.i, i64 3
  %i.p = load i8, ptr %i.o, align 1, !alias.scope !2645, !noundef !9
  %i.q = zext i8 %i.p to i64
  %i.r = getelementptr inbounds nuw i8, ptr %.sroa.06.021.i, i64 1
  %i.s = load i8, ptr %i.r, align 1, !alias.scope !2645, !noundef !9
  %i.t = zext i8 %i.s to i64
  %i.u = getelementptr inbounds nuw i8, ptr %.sroa.06.021.i, i64 4
  %i.v = load i8, ptr %i.u, align 1, !alias.scope !2645, !noundef !9
  ...
  %i.ae = load i8, ptr %i.ad, align 1, !alias.scope !2645, !noundef !9
  %i.af = zext i8 %i.ae to i64
  %i.ag = or disjoint i64 %i.ac, %i.af            ; 2 uses
  %i.ah = getelementptr inbounds nuw i8, ptr %.sroa.06.021.i, i64 5
  %i.ai = load i8, ptr %i.ah, align 1, !alias.scope !2645, !noundef !9
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.g = icmp samesign ult i64 %i.d, 6
...
.lr.ph.i:                                         ; preds = %bb.c, %.lr.ph.i
  ...
  %i.h = load i8, ptr %.sroa.06.021.i, align 1, !alias.scope !2654, !noundef !9
  %i.i = zext i8 %i.h to i64
  %i.j = getelementptr inbounds nuw i8, ptr %.sroa.06.021.i, i64 3
  %i.k = load i8, ptr %i.j, align 1, !alias.scope !2654, !noundef !9
  %i.l = zext i8 %i.k to i64
  %i.m = getelementptr inbounds nuw i8, ptr %.sroa.06.021.i, i64 1
  %i.n = load i8, ptr %i.m, align 1, !alias.scope !2654, !noundef !9
  %i.o = zext i8 %i.n to i64
  %i.p = getelementptr inbounds nuw i8, ptr %.sroa.06.021.i, i64 4
  %i.q = load i8, ptr %i.p, align 1, !alias.scope !2654, !noundef !9
  ...
  %i.z = load i8, ptr %i.y, align 1, !alias.scope !2654, !noundef !9
  %i.aa = zext i8 %i.z to i64
  %i.ab = or disjoint i64 %i.x, %i.aa             ; 2 uses
  %i.ac = getelementptr inbounds nuw i8, ptr %.sroa.06.021.i, i64 5
  %i.ad = load i8, ptr %i.ac, align 1, !alias.scope !2654, !noundef !9
...
bb.e:                                             ; preds = %bb.d, %._crit_edge.i, %bb.c
  ...
  %i.av = load i32, ptr %1, align 8, !range !26, !alias.scope !2655, !noundef !9
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.ax = load ptr, ptr %i.aw, align 8, !alias.scope !2658, !nonnull !9, !noundef !9 ; 2 uses
  %i.ay = load i64, ptr %i.ax, align 8, !noalias !2658, !noundef !9
  %i.az = add i64 %i.ay, -1                       ; 2 uses
  store i64 %i.az, ptr %i.ax, align 8, !noalias !2658
...
bb.d:                                             ; preds = %bb.c
  %i.e = load i8, ptr %i.c, align 1, !alias.scope !2667, !noundef !9
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.preheader.i
  %i.k = load i8, ptr %.sroa.012.017.i, align 1, !alias.scope !2667, !noundef !9
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  %i.r = load i8, ptr %.sroa.012.022.i, align 1, !alias.scope !2667, !noundef !9
  ...
  %i.y = load i8, ptr %.sroa.012.0.i, align 1, !alias.scope !2667, !noundef !9
...
bb.e:                                             ; preds = %._crit_edge.i, %bb.c
  ...
  %i.ao = load i32, ptr %1, align 8, !range !26, !alias.scope !2668, !noundef !9
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.aq = load ptr, ptr %i.ap, align 8, !alias.scope !2671, !nonnull !9, !noundef !9 ; 2 uses
  %i.ar = load i64, ptr %i.aq, align 8, !noalias !2671, !noundef !9
  %i.as = add i64 %i.ar, -1                       ; 2 uses
  store i64 %i.as, ptr %i.aq, align 8, !noalias !2671
