...
bb.c:                                             ; preds = %3, %.split
  %.sroa.5.0119.i = phi i64 [ %i.m, %.split ], [ %i.n, %3 ] ; 7 uses
...
_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj4_NtNtB4_5array17TryFromSliceErrorE6unwrapCs7gfv9tzbXmh_6yara_x.exit102.i: ; preds = %bb.c
  ...
  br i1 %i.r, label %_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj2_NtNtB4_5array17TryFromSliceErrorE6unwrapCs7gfv9tzbXmh_6yara_x.exit100.i, label %3
...
bb.f:                                             ; preds = %bb.e
  ...
  store i16 6, ptr %i.ae, align 8
  store ptr null, ptr %0, align 8
  br label %bb.an

bb.g:                                             ; preds = %bb.e
  %i.af = icmp eq i16 %.sroa.052.0.copyload.i, -1
  %i.ag = icmp eq i32 %.sroa.053.0.copyload.i, -1
  %or.cond1 = or i1 %i.af, %i.ag
  %i.ah = icmp eq i32 %.sroa.054.0.copyload.i, -1
  %or.cond2 = or i1 %or.cond1, %i.ah
  br i1 %or.cond2, label %bb.h, label %bb.v

bb.h:                                             ; preds = %bb.g
  %i.ai = icmp ult i64 %i.ac, 20
  br i1 %i.ai, label %bb.x, label %bb.i

bb.i:                                             ; preds = %bb.h
  %i.aj = add i64 %i.ac, -20                      ; 3 uses
  ...
  %i.ak = call noundef zeroext i1 @_RNvXs1_CskIN1fSNyKrj_7tinyzipRShNtB5_6Reader13read_exact_at(ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %i.h, i64 noundef %i.aj, ptr noalias nofree noundef nonnull %i.f, i64 noundef 20), !noalias !4857
  br i1 %i.ak, label %_RINvCskIN1fSNyKrj_7tinyzip27resolve_zip64_record_offsetRShECs7gfv9tzbXmh_6yara_x.exit.thread.i, label %_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj4_NtNtB4_5array17TryFromSliceErrorE6unwrapCs7gfv9tzbXmh_6yara_x.exit110.i

_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj4_NtNtB4_5array17TryFromSliceErrorE6unwrapCs7gfv9tzbXmh_6yara_x.exit110.i: ; preds = %bb.i
  %.sroa.066.0.copyload.i = load i32, ptr %i.f, align 4, !noalias !4856
  %i.al = icmp eq i32 %.sroa.066.0.copyload.i, 117853008
  br i1 %i.al, label %_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj8_NtNtB4_5array17TryFromSliceErrorE6unwrapCs7gfv9tzbXmh_6yara_x.exit118.i, label %_RINvCskIN1fSNyKrj_7tinyzip27resolve_zip64_record_offsetRShECs7gfv9tzbXmh_6yara_x.exit.thread.i
...
_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj8_NtNtB4_5array17TryFromSliceErrorE6unwrapCs7gfv9tzbXmh_6yara_x.exit118.i: ; preds = %_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj4_NtNtB4_5array17TryFromSliceErrorE6unwrapCs7gfv9tzbXmh_6yara_x.exit110.i
  ...
  %.sroa.067.0.copyload.i = load i32, ptr %i.am, align 4, !noalias !4856
  %i.an = getelementptr inbounds nuw i8, ptr %i.f, i64 8
  %.sroa.068.0.copyload.i = load i64, ptr %i.an, align 4, !noalias !4856 ; 4 uses
  %i.ao = getelementptr inbounds nuw i8, ptr %i.f, i64 16
  %.sroa.070.0.copyload.i = load i32, ptr %i.ao, align 4, !noalias !4856
  %i.ap = icmp eq i32 %.sroa.067.0.copyload.i, 0
  %i.aq = icmp eq i32 %.sroa.070.0.copyload.i, 1
  %or.cond.i = and i1 %i.ap, %i.aq
  br i1 %or.cond.i, label %bb.j, label %_RINvCskIN1fSNyKrj_7tinyzip27resolve_zip64_record_offsetRShECs7gfv9tzbXmh_6yara_x.exit.thread.i

bb.j:                                             ; preds = %_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj8_NtNtB4_5array17TryFromSliceErrorE6unwrapCs7gfv9tzbXmh_6yara_x.exit118.i
  %i.ar = icmp ugt i64 %.sroa.068.0.copyload.i, -5
  %i.as = add i64 %.sroa.068.0.copyload.i, 4
  %i.at = icmp ugt i64 %i.as, %2
  %or.cond.i.i.i = or i1 %i.ar, %i.at
  br i1 %or.cond.i.i.i, label %.thread.i.i, label %bb.k, !prof !64

bb.k:                                             ; preds = %bb.j
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c), !noalias !4858
  store i32 0, ptr %i.c, align 4, !noalias !4858
  %i.au = call noundef zeroext i1 @_RNvXs1_CskIN1fSNyKrj_7tinyzipRShNtB5_6Reader13read_exact_at(ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %i.h, i64 noundef %.sroa.068.0.copyload.i, ptr noalias nofree noundef nonnull %i.c, i64 noundef 4), !noalias !4859
  br i1 %i.au, label %_RINvCskIN1fSNyKrj_7tinyzip20looks_like_signatureRShECs7gfv9tzbXmh_6yara_x.exit.thread52.i.i, label %_RINvCskIN1fSNyKrj_7tinyzip20looks_like_signatureRShECs7gfv9tzbXmh_6yara_x.exit.i.i

_RINvCskIN1fSNyKrj_7tinyzip20looks_like_signatureRShECs7gfv9tzbXmh_6yara_x.exit.thread52.i.i: ; preds = %bb.k
...
_RINvCskIN1fSNyKrj_7tinyzip20looks_like_signatureRShECs7gfv9tzbXmh_6yara_x.exit.i.i: ; preds = %bb.k
  %.sroa.09.0.copyload.i.i.i = load i32, ptr %i.c, align 4, !noalias !4858
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c), !noalias !4858
  %i.av = icmp eq i32 %.sroa.09.0.copyload.i.i.i, 101075792
  br i1 %i.av, label %_RINvCskIN1fSNyKrj_7tinyzip27resolve_zip64_record_offsetRShECs7gfv9tzbXmh_6yara_x.exit.thread150.i, label %.thread.i.i

.thread.i.i:                                      ; preds = %_RINvCskIN1fSNyKrj_7tinyzip20looks_like_signatureRShECs7gfv9tzbXmh_6yara_x.exit.i.i, %bb.j
  %i.aw = call i64 @llvm.usub.sat.i64(i64 range(i64 0, -20) %i.aj, i64 4096) ; 3 uses
  %i.ax = sub nuw i64 %i.aj, %i.aw                ; 5 uses
  ...
  br i1 %i.ay, label %bb.m, label %bb.l, !prof !65

bb.l:                                             ; preds = %.thread.i.i
  call void @_RNvNtNtCskKLDkoKarTP_4core5slice5index16slice_index_fail(i64 noundef 0, i64 noundef %i.ax, i64 noundef 4096, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @2) #39, !noalias !4859
  unreachable

bb.m:                                             ; preds = %.thread.i.i
  %i.az = call noundef zeroext i1 @_RNvXs1_CskIN1fSNyKrj_7tinyzipRShNtB5_6Reader13read_exact_at(ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %i.h, i64 noundef %i.aw, ptr noalias nofree noundef nonnull %i.d, i64 noundef %i.ax), !noalias !4859
  br i1 %i.az, label %_RINvCskIN1fSNyKrj_7tinyzip27resolve_zip64_record_offsetRShECs7gfv9tzbXmh_6yara_x.exit.thread156.i, label %bb.n

bb.n:                                             ; preds = %bb.m
  %i.ba = icmp samesign ult i64 %i.ax, 4
...
bb.o:                                             ; preds = %bb.n
  %i.bb = add nsw i64 %i.ax, -4
  br label %bb.p

bb.p:                                             ; preds = %_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj4_NtNtB4_5array17TryFromSliceErrorE6unwrapCs7gfv9tzbXmh_6yara_x.exit.i.i, %bb.o
  %.sroa.8.0.i.i = phi i1 [ false, %bb.o ], [ %i.bc, %_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj4_NtNtB4_5array17TryFromSliceErrorE6unwrapCs7gfv9tzbXmh_6yara_x.exit.i.i ]
  %.sroa.5.0.i.i = phi i64 [ %i.bb, %bb.o ], [ %i.bd, %_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj4_NtNtB4_5array17TryFromSliceErrorE6unwrapCs7gfv9tzbXmh_6yara_x.exit.i.i ] ; 5 uses
  br i1 %.sroa.8.0.i.i, label %bb.r, label %bb.q

bb.q:                                             ; preds = %bb.p
  %or.cond.i.i = icmp ult i64 %.sroa.5.0.i.i, 4093
  br i1 %or.cond.i.i, label %_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj4_NtNtB4_5array17TryFromSliceErrorE6unwrapCs7gfv9tzbXmh_6yara_x.exit.i.i, label %bb.s, !prof !65
...
_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj4_NtNtB4_5array17TryFromSliceErrorE6unwrapCs7gfv9tzbXmh_6yara_x.exit.i.i: ; preds = %bb.q
  %i.bc = icmp eq i64 %.sroa.5.0.i.i, 0
  %i.bd = add nsw i64 %.sroa.5.0.i.i, -1
  %i.be = getelementptr inbounds nuw i8, ptr %i.d, i64 %.sroa.5.0.i.i
  %.sroa.039.0.copyload.i.i = load i32, ptr %i.be, align 1, !noalias !4860
  %i.bf = icmp eq i32 %.sroa.039.0.copyload.i.i, 101075792
  br i1 %i.bf, label %_RINvCskIN1fSNyKrj_7tinyzip27resolve_zip64_record_offsetRShECs7gfv9tzbXmh_6yara_x.exit.i, label %bb.p

_RINvCskIN1fSNyKrj_7tinyzip27resolve_zip64_record_offsetRShECs7gfv9tzbXmh_6yara_x.exit.thread156.i: ; preds = %bb.n, %bb.m
  %.sroa.8.0.ph.i = phi i16 [ 3, %bb.n ], [ 0, %bb.m ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d), !noalias !4860
  br label %_RINvCskIN1fSNyKrj_7tinyzip27resolve_zip64_record_offsetRShECs7gfv9tzbXmh_6yara_x.exit.thread.i
...
_RINvCskIN1fSNyKrj_7tinyzip27resolve_zip64_record_offsetRShECs7gfv9tzbXmh_6yara_x.exit.i: ; preds = %_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj4_NtNtB4_5array17TryFromSliceErrorE6unwrapCs7gfv9tzbXmh_6yara_x.exit.i.i
  %i.bg = add nuw i64 %.sroa.5.0.i.i, %i.aw
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d), !noalias !4860
...
_RINvCskIN1fSNyKrj_7tinyzip27resolve_zip64_record_offsetRShECs7gfv9tzbXmh_6yara_x.exit.thread150.i: ; preds = %_RINvCskIN1fSNyKrj_7tinyzip27resolve_zip64_record_offsetRShECs7gfv9tzbXmh_6yara_x.exit.i, %_RINvCskIN1fSNyKrj_7tinyzip20looks_like_signatureRShECs7gfv9tzbXmh_6yara_x.exit.i.i
  %.sroa.15124.1154.i = phi i64 [ %i.bg, %_RINvCskIN1fSNyKrj_7tinyzip27resolve_zip64_record_offsetRShECs7gfv9tzbXmh_6yara_x.exit.i ], [ %.sroa.068.0.copyload.i, %_RINvCskIN1fSNyKrj_7tinyzip20looks_like_signatureRShECs7gfv9tzbXmh_6yara_x.exit.i.i ] ; 6 uses
  ...
  %i.bh = icmp ugt i64 %.sroa.15124.1154.i, -57
  br i1 %i.bh, label %bb.u, label %_RINvCskIN1fSNyKrj_7tinyzip3addNtB2_16SliceReaderErrorECs7gfv9tzbXmh_6yara_x.exit.i, !prof !14
...
_RINvCskIN1fSNyKrj_7tinyzip3addNtB2_16SliceReaderErrorECs7gfv9tzbXmh_6yara_x.exit.i: ; preds = %_RINvCskIN1fSNyKrj_7tinyzip27resolve_zip64_record_offsetRShECs7gfv9tzbXmh_6yara_x.exit.thread150.i
  %i.bi = add nuw i64 %.sroa.15124.1154.i, 56
  %i.bj = icmp ugt i64 %i.bi, %2
  br i1 %i.bj, label %bb.u, label %bb.t

bb.t:                                             ; preds = %_RINvCskIN1fSNyKrj_7tinyzip3addNtB2_16SliceReaderErrorECs7gfv9tzbXmh_6yara_x.exit.i
  %i.bk = call noundef zeroext i1 @_RNvXs1_CskIN1fSNyKrj_7tinyzipRShNtB5_6Reader13read_exact_at(ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %i.h, i64 noundef %.sroa.15124.1154.i, ptr noalias nofree noundef nonnull %i.e, i64 noundef 56), !noalias !4857
  br i1 %i.bk, label %bb.u, label %_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj4_NtNtB4_5array17TryFromSliceErrorE6unwrapCs7gfv9tzbXmh_6yara_x.exit107.i

_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj4_NtNtB4_5array17TryFromSliceErrorE6unwrapCs7gfv9tzbXmh_6yara_x.exit107.i: ; preds = %bb.t
  %.sroa.071.0.copyload.i = load i32, ptr %i.e, align 4, !noalias !4856
  %i.bl = icmp eq i32 %.sroa.071.0.copyload.i, 101075792
  br i1 %i.bl, label %_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj8_NtNtB4_5array17TryFromSliceErrorE6unwrapCs7gfv9tzbXmh_6yara_x.exit116.i, label %bb.u
...
_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj8_NtNtB4_5array17TryFromSliceErrorE6unwrapCs7gfv9tzbXmh_6yara_x.exit116.i: ; preds = %_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj4_NtNtB4_5array17TryFromSliceErrorE6unwrapCs7gfv9tzbXmh_6yara_x.exit107.i
  ...
  %.sroa.072.0.copyload.i = load i64, ptr %i.bm, align 4, !noalias !4856 ; 2 uses
  %i.bn = icmp ugt i64 %.sroa.072.0.copyload.i, -13
  br i1 %i.bn, label %bb.u, label %_RINvCskIN1fSNyKrj_7tinyzip3addNtB2_16SliceReaderErrorECs7gfv9tzbXmh_6yara_x.exit120.i, !prof !14
...
_RINvCskIN1fSNyKrj_7tinyzip3addNtB2_16SliceReaderErrorECs7gfv9tzbXmh_6yara_x.exit120.i: ; preds = %_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj8_NtNtB4_5array17TryFromSliceErrorE6unwrapCs7gfv9tzbXmh_6yara_x.exit116.i
  %i.bo = add nuw i64 %.sroa.15124.1154.i, 12
  %i.bp = add i64 %i.bo, %.sroa.072.0.copyload.i  ; 2 uses
  %i.bq = icmp ult i64 %i.bp, %.sroa.15124.1154.i
  br i1 %i.bq, label %bb.u, label %_RINvCskIN1fSNyKrj_7tinyzip3addNtB2_16SliceReaderErrorECs7gfv9tzbXmh_6yara_x.exit122.i, !prof !14
...
_RINvCskIN1fSNyKrj_7tinyzip3addNtB2_16SliceReaderErrorECs7gfv9tzbXmh_6yara_x.exit122.i: ; preds = %_RINvCskIN1fSNyKrj_7tinyzip3addNtB2_16SliceReaderErrorECs7gfv9tzbXmh_6yara_x.exit120.i
  %i.br = icmp ugt i64 %i.bp, %2
  br i1 %i.br, label %bb.u, label %bb.y

bb.u:                                             ; preds = %_RINvCskIN1fSNyKrj_7tinyzip3addNtB2_16SliceReaderErrorECs7gfv9tzbXmh_6yara_x.exit122.i, %_RINvCskIN1fSNyKrj_7tinyzip3addNtB2_16SliceReaderErrorECs7gfv9tzbXmh_6yara_x.exit120.i, %_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj8_NtNtB4_5array17TryFromSliceErrorE6unwrapCs7gfv9tzbXmh_6yara_x.exit116.i, %_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj4_NtNtB4_5array17TryFromSliceErrorE6unwrapCs7gfv9tzbXmh_6yara_x.exit107.i, %bb.t, %_RINvCskIN1fSNyKrj_7tinyzip3addNtB2_16SliceReaderErrorECs7gfv9tzbXmh_6yara_x.exit.i, %_RINvCskIN1fSNyKrj_7tinyzip27resolve_zip64_record_offsetRShECs7gfv9tzbXmh_6yara_x.exit.thread150.i
  %.sink.i = phi i16 [ 2, %_RINvCskIN1fSNyKrj_7tinyzip3addNtB2_16SliceReaderErrorECs7gfv9tzbXmh_6yara_x.exit.i ], [ 4, %_RINvCskIN1fSNyKrj_7tinyzip27resolve_zip64_record_offsetRShECs7gfv9tzbXmh_6yara_x.exit.thread150.i ], [ 3, %_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj4_NtNtB4_5array17TryFromSliceErrorE6unwrapCs7gfv9tzbXmh_6yara_x.exit107.i ], [ 4, %_RINvCskIN1fSNyKrj_7tinyzip3addNtB2_16SliceReaderErrorECs7gfv9tzbXmh_6yara_x.exit120.i ], [ 4, %_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj8_NtNtB4_5array17TryFromSliceErrorE6unwrapCs7gfv9tzbXmh_6yara_x.exit116.i ], [ 0, %bb.t ], [ 2, %_RINvCskIN1fSNyKrj_7tinyzip3addNtB2_16SliceReaderErrorECs7gfv9tzbXmh_6yara_x.exit122.i ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e), !noalias !4856
  br label %_RINvCskIN1fSNyKrj_7tinyzip27resolve_zip64_record_offsetRShECs7gfv9tzbXmh_6yara_x.exit.thread.i

_RINvCskIN1fSNyKrj_7tinyzip27resolve_zip64_record_offsetRShECs7gfv9tzbXmh_6yara_x.exit.thread.i: ; preds = %_RINvCskIN1fSNyKrj_7tinyzip20looks_like_signatureRShECs7gfv9tzbXmh_6yara_x.exit.thread52.i.i, %bb.r, %_RINvCskIN1fSNyKrj_7tinyzip27resolve_zip64_record_offsetRShECs7gfv9tzbXmh_6yara_x.exit.thread156.i, %_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj8_NtNtB4_5array17TryFromSliceErrorE6unwrapCs7gfv9tzbXmh_6yara_x.exit118.i, %_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj4_NtNtB4_5array17TryFromSliceErrorE6unwrapCs7gfv9tzbXmh_6yara_x.exit110.i, %bb.i, %bb.u
  %.sroa.11127.0 = phi i16 [ 0, %bb.i ], [ 6, %_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj8_NtNtB4_5array17TryFromSliceErrorE6unwrapCs7gfv9tzbXmh_6yara_x.exit118.i ], [ %.sink.i, %bb.u ], [ 3, %_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj4_NtNtB4_5array17TryFromSliceErrorE6unwrapCs7gfv9tzbXmh_6yara_x.exit110.i ], [ %.sroa.8.0.ph.i, %_RINvCskIN1fSNyKrj_7tinyzip27resolve_zip64_record_offsetRShECs7gfv9tzbXmh_6yara_x.exit.thread156.i ], [ 0, %_RINvCskIN1fSNyKrj_7tinyzip20looks_like_signatureRShECs7gfv9tzbXmh_6yara_x.exit.thread52.i.i ], [ 3, %bb.r ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.f), !noalias !4856
  br label %bb.x

bb.v:                                             ; preds = %bb.g
  %i.bs = zext i16 %.sroa.052.0.copyload.i to i64
  %i.bt = zext i32 %.sroa.053.0.copyload.i to i64
  %i.bu = zext i32 %.sroa.054.0.copyload.i to i64
  br label %bb.w

bb.w:                                             ; preds = %bb.y, %bb.v
  %.sroa.0103.0 = phi i64 [ %i.ac, %bb.v ], [ %.sroa.15124.1154.i, %bb.y ] ; 3 uses
  %.sroa.0106.0 = phi i64 [ %i.bs, %bb.v ], [ %.sroa.076.0.copyload.i, %bb.y ] ; 2 uses
  %.sroa.0108.0 = phi i64 [ %i.bt, %bb.v ], [ %.sroa.078.0.copyload.i, %bb.y ] ; 3 uses
  %.sroa.0111.0 = phi i64 [ %i.bu, %bb.v ], [ %.sroa.080.0.copyload.i, %bb.y ] ; 12 uses
  %i.bv = add i64 %.sroa.0111.0, %.sroa.0108.0    ; 5 uses
  %i.bw = icmp ult i64 %i.bv, %.sroa.0111.0
  br i1 %i.bw, label %bb.aa, label %_RINvCskIN1fSNyKrj_7tinyzip3addNtB2_16SliceReaderErrorECs7gfv9tzbXmh_6yara_x.exit, !prof !14

bb.x:                                             ; preds = %_RINvCskIN1fSNyKrj_7tinyzip27resolve_zip64_record_offsetRShECs7gfv9tzbXmh_6yara_x.exit.thread.i, %bb.h
  %.sroa.11127.1.ph = phi i16 [ 5, %bb.h ], [ %.sroa.11127.0, %_RINvCskIN1fSNyKrj_7tinyzip27resolve_zip64_record_offsetRShECs7gfv9tzbXmh_6yara_x.exit.thread.i ]
  %i.bx = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i16 %.sroa.11127.1.ph, ptr %i.bx, align 8
  %i.by = getelementptr inbounds nuw i8, ptr %0, i64 10
  store i16 0, ptr %i.by, align 2
  store ptr null, ptr %0, align 8
  br label %bb.an

bb.y:                                             ; preds = %_RINvCskIN1fSNyKrj_7tinyzip3addNtB2_16SliceReaderErrorECs7gfv9tzbXmh_6yara_x.exit122.i
  %i.bz = getelementptr inbounds nuw i8, ptr %i.e, i64 16
  %.sroa.074.0.copyload.i = load i32, ptr %i.bz, align 4, !noalias !4856
  %i.ca = getelementptr inbounds nuw i8, ptr %i.e, i64 20
  %.sroa.075.0.copyload.i = load i32, ptr %i.ca, align 4, !noalias !4856
end_hunk_0
