...
bb.e:                                             ; preds = %bb.d
  ...
  %.sroa.5.0.copyload.i = load i64, ptr %.sroa.5.0..sroa_idx.i, align 8, !alias.scope !4740
  ...
  store i32 %.sroa.4.0.copyload.i, ptr %.sroa.4.0..sroa_idx2.i, align 4, !noalias !4740
  %.sroa.5.0..sroa_idx4.i = getelementptr inbounds nuw i8, ptr %i.s, i64 16
  store i64 %.sroa.5.0.copyload.i, ptr %.sroa.5.0..sroa_idx4.i, align 8, !noalias !4740
  %i.aj = getelementptr inbounds nuw i8, ptr %1, i64 1800
  %i.ak = load ptr, ptr %i.aj, align 8, !alias.scope !4740, !nonnull !10, !noundef !10
...
.noexc:                                           ; preds = %bb.e
  %i.al = load i8, ptr %i.t, align 8, !range !28, !noalias !4740, !noundef !10
  %i.am = icmp eq i8 %i.al, 1
  br i1 %i.am, label %bb.f, label %.invoke170, !prof !20

bb.f:                                             ; preds = %.noexc
  %i.an = getelementptr inbounds nuw i8, ptr %i.t, i64 8
  %i.ao = load i64, ptr %i.an, align 8, !noalias !4740, !noundef !10 ; 6 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.s), !noalias !4740
  call void @llvm.lifetime.end.p0(ptr nonnull %i.t), !noalias !4740
  %i.ap = getelementptr inbounds nuw i8, ptr %1, i64 2000
  %i.aq = load ptr, ptr %i.ap, align 8, !nonnull !10, !align !17, !noundef !10
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.aw = load i64, ptr %i.av, align 8, !range !24, !alias.scope !4741, !noundef !10
...
bb.i:                                             ; preds = %bb.h
  %i.ay = load i64, ptr %i.ax, align 8, !alias.scope !4741, !noundef !10
  %i.az = icmp sge i64 %i.ao, %i.ay
  br label %bb.l

bb.j:                                             ; preds = %bb.h
  %i.ba = load i64, ptr %i.ax, align 8, !alias.scope !4741, !noundef !10
  %i.bb = icmp sgt i64 %i.ao, %i.ba
  br label %bb.l

bb.k:                                             ; preds = %bb.h
  %i.bc = getelementptr inbounds nuw i8, ptr %i.av, i64 16
  %i.bd = load i64, ptr %i.bc, align 8, !range !24, !alias.scope !4741, !noundef !10
...
bb.l:                                             ; preds = %bb.j, %bb.i
  ...
  %i.bg = load i64, ptr %i.bf, align 8, !range !24, !alias.scope !4741, !noundef !10
...
bb.m:                                             ; preds = %bb.l
  %i.bi = load i64, ptr %i.bh, align 8, !alias.scope !4741, !noundef !10
  %i.bj = icmp sle i64 %i.ao, %i.bi
  br label %_RNvMs8_NtNtCs7gfv9tzbXmh_6yara_x8compiler5rulesNtB5_14FilesizeBounds8contains.exit

bb.n:                                             ; preds = %bb.l
  %i.bk = load i64, ptr %i.bh, align 8, !alias.scope !4741, !noundef !10
  %i.bl = icmp slt i64 %i.ao, %i.bk
  br label %_RNvMs8_NtNtCs7gfv9tzbXmh_6yara_x8compiler5rulesNtB5_14FilesizeBounds8contains.exit

.split89:                                         ; preds = %bb.k
  %i.bm = load i64, ptr %i.be, align 8, !alias.scope !4741, !noundef !10
...
.split:                                           ; preds = %bb.k
  %i.bn = load i64, ptr %i.be, align 8, !alias.scope !4741, !noundef !10
...
bb.o:                                             ; preds = %bb.a
  ...
  %i.bq = load i64, ptr %i.bp, align 8, !noundef !10 ; 2 uses
  %i.br = getelementptr inbounds nuw i8, ptr %i.ab, i64 16
  %i.bs = load ptr, ptr %i.br, align 8, !nonnull !10, !noundef !10 ; 2 uses
...
bb.p:                                             ; preds = %.split89, %.split, %_RNvMs8_NtNtCs7gfv9tzbXmh_6yara_x8compiler5rulesNtB5_14FilesizeBounds8contains.exit
  %i.bw = load i32, ptr %i.au, align 4, !noundef !10
...
bb.q:                                             ; preds = %bb.ac, %bb.o
  ...
  call void @llvm.experimental.noalias.scope.decl(metadata !4742)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.r)
  %i.by = getelementptr inbounds nuw i8, ptr %1, i64 2000 ; 10 uses
  %i.bz = load ptr, ptr %i.by, align 8, !alias.scope !4742, !noalias !4743, !nonnull !10, !align !17, !noundef !10 ; 5 uses
  %i.ca = getelementptr inbounds nuw i8, ptr %i.bz, i64 296
  %i.cb = load ptr, ptr %i.ca, align 8, !noalias !4744, !nonnull !10, !noundef !10 ; 2 uses
  %i.cc = getelementptr inbounds nuw i8, ptr %i.bz, i64 304
  %i.cd = load i64, ptr %i.cc, align 8, !noalias !4744, !noundef !10 ; 2 uses
...
bb.r:                                             ; preds = %.backedge.i, %.lr.ph.i
  ...
  %i.cp = load i32, ptr %.sroa.0.012.i, align 4, !noalias !4743, !noundef !10
  %i.cq = load ptr, ptr %i.cg, align 8, !noalias !4743, !nonnull !10, !noundef !10
  %i.cr = load i64, ptr %i.ch, align 8, !noalias !4743, !noundef !10
...
bb.s:                                             ; preds = %.noexc32
  %i.cx = load i8, ptr %i.cv, align 8, !range !59, !noalias !4743, !noundef !10
  %i.cy = icmp eq i8 %i.cx, 0
  br i1 %i.cy, label %bb.t, label %.invoke, !prof !20

bb.t:                                             ; preds = %bb.s
  %i.cz = getelementptr inbounds nuw i8, ptr %i.cu, i64 16
  %i.da = load i64, ptr %i.cz, align 8, !range !19, !noalias !4743, !noundef !10
  %i.db = trunc nuw i64 %i.da to i1
  br i1 %i.db, label %bb.u, label %.invoke, !prof !20

bb.u:                                             ; preds = %bb.t
  %i.dc = getelementptr inbounds nuw i8, ptr %i.cu, i64 24
  %i.dd = load i64, ptr %i.dc, align 8, !noalias !4743, !noundef !10 ; 4 uses
  %i.de = sub i64 %i.dd, %.sroa.05.082
  %i.df = icmp ult i64 %i.dd, %.sroa.05.082
  br i1 %i.df, label %.backedge.i, label %bb.v

bb.v:                                             ; preds = %bb.u
  %i.dg = load ptr, ptr %i.by, align 8, !alias.scope !4742, !noalias !4743, !nonnull !10, !align !17, !noundef !10 ; 2 uses
  %i.dh = getelementptr inbounds nuw i8, ptr %i.cu, i64 12
  %i.di = load i32, ptr %i.dh, align 4, !noalias !4743, !noundef !10
  %i.dj = getelementptr i8, ptr %i.dg, i64 144
  %.val8.i = load i64, ptr %i.dj, align 8, !noalias !4743, !noundef !10
...
bb.w:                                             ; preds = %bb.v
  ...
  %.val.i = load ptr, ptr %i.dn, align 8, !noalias !4743, !nonnull !10, !noundef !10
  ...
  %.sroa.03.0.i.i = load ptr, ptr %.sroa.03.0.in.i.i, align 8, !noalias !4743, !nonnull !10, !noundef !10
  %.sroa.34.0.in.i.i = getelementptr inbounds nuw i8, ptr %i.do, i64 16
  %.sroa.34.0.i.i = load i64, ptr %.sroa.34.0.in.i.i, align 8, !noalias !4743, !noundef !10 ; 2 uses
  %i.dp = getelementptr inbounds nuw i8, ptr %i.cu, i64 10
  %i.dq = load i16, ptr %i.dp, align 2, !noalias !4743, !noundef !10
...
bb.x:                                             ; preds = %.noexc34
  %i.ds = load i32, ptr %.sroa.0.012.i, align 4, !noalias !4743, !noundef !10
  %i.dt = load i32, ptr %i.cu, align 8, !noalias !4743, !noundef !10
  store i8 0, ptr %i.cn, align 8, !noalias !4744
  %i.du = add i64 %.sroa.34.0.i.i, %i.dd
  store i64 %i.dd, ptr %i.cl, align 8, !noalias !4744
  store i64 %i.du, ptr %i.cm, align 8, !noalias !4744
  store i64 %.sroa.05.082, ptr %i.r, align 8, !noalias !4744
...
bb.y:                                             ; preds = %.thread78, %bb.o
  ...
  %i.dw = load ptr, ptr %i.dv, align 8, !nonnull !10, !align !17, !noundef !10
...
.loopexit99.loopexit:                             ; preds = %.backedge.i
  %.pre = load ptr, ptr %i.by, align 8, !alias.scope !4745, !noalias !4746
  br label %.loopexit99
...
.loopexit99:                                      ; preds = %.loopexit99.loopexit, %bb.q
  ...
  store i64 %.sroa.05.082, ptr %i.q, align 8, !noalias !4748
  %i.ee = getelementptr inbounds nuw i8, ptr %i.ed, i64 384
  %i.ef = getelementptr inbounds nuw i8, ptr %i.ed, i64 528
  %i.eg = load ptr, ptr %i.ef, align 8, !noalias !4748, !noundef !10 ; 2 uses
...
bb.ad:                                            ; preds = %.loopexit99
  ...
  %i.ei = load i64, ptr %i.eh, align 8, !alias.scope !4749, !noalias !4747, !noundef !10
...
.noexc43:                                         ; preds = %bb.ae
  %.sroa.077.0.copyload.i = load ptr, ptr %i.o, align 8, !noalias !4748 ; 8 uses
  %.sroa.5.0..sroa_idx.i40 = getelementptr inbounds nuw i8, ptr %i.o, i64 8
  %.sroa.5.0.copyload.i41 = load i64, ptr %.sroa.5.0..sroa_idx.i40, align 8, !noalias !4748 ; 13 uses
  %.sroa.6.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.o, i64 16
  %.sroa.6.0.copyload.i = load i64, ptr %.sroa.6.0..sroa_idx.i, align 8, !noalias !4748
  %.sroa.10.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.o, i64 24
  %.sroa.10.0.copyload.i = load ptr, ptr %.sroa.10.0..sroa_idx.i, align 8, !noalias !4748
  %.sroa.12.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.o, i64 32
  %.sroa.12.0.copyload.i = load ptr, ptr %.sroa.12.0..sroa_idx.i, align 8, !noalias !4748 ; 8 uses
  %.sroa.18.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.o, i64 40
  %.sroa.18.0.copyload.i = load i64, ptr %.sroa.18.0..sroa_idx.i, align 8, !noalias !4748
  %.sroa.21.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.o, i64 48
  %.sroa.21.0.copyload.i = load i32, ptr %.sroa.21.0..sroa_idx.i, align 8, !noalias !4748
  %.sroa.24.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.o, i64 52
  %.sroa.24.0.copyload.i = load i8, ptr %.sroa.24.0..sroa_idx.i, align 4, !noalias !4748
  %.sroa.2684.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.o, i64 56
  %.sroa.2684.0.copyload.i = load i32, ptr %.sroa.2684.0..sroa_idx.i, align 8, !noalias !4748
  %.sroa.29.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.o, i64 60
  %.sroa.29.0.copyload.i = load i32, ptr %.sroa.29.0..sroa_idx.i, align 4, !noalias !4748
...
bb.af:                                            ; preds = %bb.ad
  call void @llvm.lifetime.start.p0(ptr nonnull %i.p), !noalias !4748
  store ptr %1, ptr %i.p, align 8, !noalias !4748
  %i.fd = getelementptr inbounds nuw i8, ptr %i.p, i64 8
  store ptr %.sroa.0.087, ptr %i.fd, align 8, !noalias !4748
  %i.fe = getelementptr inbounds nuw i8, ptr %i.p, i64 16
  store i64 %.sroa.5.085, ptr %i.fe, align 8, !noalias !4748
  %i.ff = getelementptr inbounds nuw i8, ptr %i.p, i64 24
  store ptr %i.q, ptr %i.ff, align 8, !noalias !4748
  call void @llvm.experimental.noalias.scope.decl(metadata !4750)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.n), !noalias !4751
  store i64 -1, ptr %i.n, align 8, !noalias !4751
  call void @llvm.lifetime.start.p0(ptr nonnull %i.m), !noalias !4751
  store i8 0, ptr %i.m, align 1, !noalias !4751
  %i.fg = getelementptr inbounds nuw i8, ptr %i.ed, i64 536
  %i.fh = load ptr, ptr %i.fg, align 8, !alias.scope !4750, !noalias !4752, !nonnull !10, !align !17, !noundef !10 ; 2 uses
  %i.fi = getelementptr inbounds nuw i8, ptr %i.fh, i64 16
  %i.fj = load i64, ptr %i.fi, align 8, !range !32, !invariant.load !10, !noalias !4753
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.l), !noalias !4751
  store ptr %i.p, ptr %i.l, align 8, !noalias !4751
  %i.fp = getelementptr inbounds nuw i8, ptr %i.l, i64 8
  store ptr %i.m, ptr %i.fp, align 8, !noalias !4751
  %i.fq = getelementptr inbounds nuw i8, ptr %i.l, i64 16
  store ptr %i.n, ptr %i.fq, align 8, !noalias !4751
  %i.fr = getelementptr inbounds nuw i8, ptr %i.fh, i64 32
  %i.fs = load ptr, ptr %i.fr, align 8, !invariant.load !10, !noalias !4754, !nonnull !10
  %i.ft = invoke noundef zeroext i1 %i.fs(ptr noundef nonnull %i.fn, ptr noundef nonnull readonly %.sroa.0.087, ptr noundef nonnull readonly %i.fo, ptr noundef nonnull %i.l, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(40) @29)
end_hunk_0
...
bb.g:                                             ; preds = %bb.e, %bb.f
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c), !noalias !6180
  %i.z = inttoptr i64 %.sroa.01.0.i to ptr
  store i64 2, ptr %i.c, align 8, !noalias !6180
  %i.aa = getelementptr inbounds nuw i8, ptr %i.c, i64 8
  store ptr %i.z, ptr %i.aa, align 8, !noalias !6180
  call void @_RNvNtCskKLDkoKarTP_4core6result13unwrap_failed(ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) @114, i64 noundef 43, ptr noundef nonnull %i.c, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) @122, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @153) #39, !noalias !6180
  unreachable
...
_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultQINtNtCscjxkGEBy879_6bitvec5slice8BitSlicehEINtNtNtBN_3ptr4span12BitSpanErrorhEE6unwrapCs7gfv9tzbXmh_6yara_x.exit: ; preds = %bb.d
  ...
  %i.ai = and i8 %i.ah, 7
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !6181
  store i64 %i.ag, ptr %i.b, align 8, !noalias !6181
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !6181
  %i.ak = call noundef nonnull ptr @_RINvMs9_NtCs3f5EAvbiDJf_3wyz4comuINtB6_7AddressINtB6_6FrozenNtB6_3MutEhE8with_ptrINtNtCskKLDkoKarTP_4core4cell4CellhENCINvMs8_B6_Bv_4castB1h_E0ECs7gfv9tzbXmh_6yara_x(ptr noundef nonnull %i.aj, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @107), !noalias !6182 ; 2 uses
  %i.al = shl nuw i8 1, %i.ai
  %i.am = load i8, ptr %i.ak, align 1, !noalias !6182, !noundef !10
  %i.an = or i8 %i.am, %i.al
  store i8 %i.an, ptr %i.ak, align 1, !noalias !6182
...
_RNvMs2_NtNtCs7gfv9tzbXmh_6yara_x8compiler5rulesNtB5_5Rules12is_fast_scan.exit: ; preds = %bb.j
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !6183
  store i64 %i.bi, ptr %i.a, align 8, !noalias !6183
  %i.bj = call noundef nonnull ptr @_RINvMs9_NtCs3f5EAvbiDJf_3wyz4comuINtB6_7AddressNtB6_5ConstjE8with_ptrjNCNvMs8_B6_Bv_6offset0ECs7gfv9tzbXmh_6yara_x(ptr noundef nonnull readonly %i.bc, ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(8) %i.a, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @107), !noalias !6184
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !6183
  %.val.i.i = load i64, ptr %i.bj, align 8, !noalias !6184, !noundef !10
...
bb.a:                                             ; preds = %_RNvNtCscstn3lKcJpi_6base646encode11encoded_len.exit
  tail call void @_RNvNtCskKLDkoKarTP_4core9panicking5panic(ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) @6, i64 noundef 40, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @431) #39
  unreachable
...
bb.p:                                             ; preds = %bb.n
  br i1 %i.ab, label %.invoke, label %bb.r, !prof !14

bb.q:                                             ; preds = %bb.n
  br i1 %i.ab, label %.invoke, label %bb.w, !prof !14

bb.r:                                             ; preds = %bb.p
  %i.ac = sub nuw nsw i64 %spec.store.select, %i.o ; 5 uses
  %i.ad = getelementptr inbounds nuw i8, ptr %3, i64 %i.o ; 5 uses
  %i.ae = invoke noundef zeroext i1 @_RNvMNtCskKLDkoKarTP_4core5sliceSh9ends_withCs7gfv9tzbXmh_6yara_x(ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %i.ad, i64 noundef range(i64 0, -9223372036854775808) %i.ac, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) @427, i64 noundef 2)
...
.invoke:                                          ; preds = %bb.p, %bb.q
  %i.af = phi ptr [ @430, %bb.q ], [ @429, %bb.p ]
...
bb.s:                                             ; preds = %_RINvYShNtNtCs2AhGS15tZfv_4bstr9ext_slice9ByteSlice13ends_with_strRAhj2_ECs7gfv9tzbXmh_6yara_x.exit
  %i.ag = invoke noundef zeroext i1 @_RNvMNtCskKLDkoKarTP_4core5sliceSh9ends_withCs7gfv9tzbXmh_6yara_x(ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %i.ad, i64 noundef range(i64 0, -9223372036854775808) %i.ac, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) @428, i64 noundef 1)
...
bb.x:                                             ; preds = %.lr.ph, %bb.an
  ...
  %i.ax = load i8, ptr %.sroa.0.084, align 1, !noundef !10 ; 3 uses
  br i1 %i.aw, label %bb.al, label %bb.ak

.thread.loopexit:                                 ; preds = %bb.an
  %.pre = load i64, ptr %i.aa, align 8, !alias.scope !6211, !noalias !6212
  %.pre85 = load ptr, ptr %i.c, align 8, !alias.scope !6211, !noalias !6212
  br label %.thread
...
.thread:                                          ; preds = %.thread.loopexit, %bb.w
  ...
  %i.bc = load i64, ptr %i.bb, align 8, !alias.scope !6211, !noalias !6212
...
bb.z:                                             ; preds = %bb.v
  ...
  %i.bf = load i64, ptr %i.be, align 8, !alias.scope !6213, !noalias !6214, !noundef !10 ; 2 uses
  %i.bg = icmp ugt i64 %i.bf, 256                 ; 2 uses
  %i.bh = load ptr, ptr %i.b, align 8, !alias.scope !6213, !noalias !6214, !nonnull !10
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !6215
...
.noexc:                                           ; preds = %bb.z
  %i.bn = load i64, ptr %i.a, align 8, !range !24, !noalias !6215, !noundef !10
...
.thread77:                                        ; preds = %.noexc
  ...
  %i.bq = load i64, ptr %i.bp, align 8, !noalias !6215, !noundef !10
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !6215
  br label %bb.ab

bb.aa:                                            ; preds = %.noexc
  %i.br = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  %.sroa.060.0.copyload = load i8, ptr %i.br, align 8, !noalias !6216
  %.sroa.662.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  %.sroa.662.0.copyload = load i64, ptr %.sroa.662.0..sroa_idx, align 8, !noalias !6216
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !6215
...
bb.ac:                                            ; preds = %bb.ab
  %i.bs = load i64, ptr %i.be, align 8, !alias.scope !6217, !noalias !6218, !noundef !10 ; 2 uses
  %i.bt = icmp ugt i64 %i.bs, 256                 ; 2 uses
  %i.bu = load i64, ptr %i.bi, align 8, !alias.scope !6217, !noalias !6218
