...
20:                                               ; preds = %5
  %21 = load i8, ptr %2, align 1, !tbaa !14       ; [#uses=1 type=i8]
  %.fr27 = freeze i8 %21                          ; [#uses=2 type=i8]
  %22 = and i8 %.fr27, -33                        ; [#uses=1 type=i8]
  %23 = add i8 %22, -65                           ; [#uses=1 type=i8]
  %or.cond29 = icmp ult i8 %23, 26                ; [#uses=1 type=i1]
...
39:                                               ; preds = %5
  %40 = load i8, ptr %2, align 1, !tbaa !14       ; [#uses=1 type=i8]
  %.fr = freeze i8 %40                            ; [#uses=8 type=i8]
...
.lr.ph:                                           ; preds = %39
  ...
  %44 = add i8 %.fr, -65                          ; [#uses=1 type=i8]
...
.lr.ph.split.split.preheader:                     ; preds = %switch.early.test
  %53 = icmp eq i8 %.fr, 126                      ; [#uses=1 type=i1]
...
begin_hunk_5
  ...
  %.old.us47 = icmp eq i8 %.fr, %55               ; [#uses=1 type=i1]
  %or.cond53 = or i1 %56, %.old.us47              ; [#uses=1 type=i1]
  br i1 %or.cond53, label %.thread, label %57

57:                                               ; preds = %.lr.ph.split.split.us
  %58 = add nuw i64 %.01542.us46, 1               ; [#uses=2 type=i64]
  %exitcond65.not = icmp eq i64 %58, %42          ; [#uses=1 type=i1]
...
62:                                               ; preds = %.lr.ph.split.split
  %.old = icmp eq i8 %.fr, %60                    ; [#uses=1 type=i1]
...
.thread:                                          ; preds = %62, %_ZN22photos_editing_formats8image_io12_GLOBAL__N_115IsFirstNameCharEc.exit, %.lr.ph.split.split.us, %.lr.ph.split.us
  %.us-phi = phi i8 [ %47, %.lr.ph.split.us ], [ %55, %.lr.ph.split.split.us ], [ 126, %_ZN22photos_editing_formats8image_io12_GLOBAL__N_115IsFirstNameCharEc.exit ], [ %.fr, %62 ] ; [#uses=1 type=i8]
