...
begin_hunk_0_@Exa_ManExactSynthesis2:bb.a
  %unroll_iter686 = and i64 %wide.trip.count.i.i93, 2147483646
  %lcmp.mod683.not = icmp eq i64 %xtraiter682, 0
  %lcmp.mod685 = trunc i32 %i.arw to i1
...
.preheader.us.i:                                  ; preds = %Exa_ManFindFanin.exit.loopexit.us.us.1.i, %.preheader.us.preheader.i
  ...
  br i1 %i.ash, label %.epil.preheader674, label %.preheader.us.i.new
...
.preheader.us.i.new:                              ; preds = %.preheader.us.i, %bb.hh
  ...
  %niter680 = phi i64 [ %niter680.next.1, %bb.hh ], [ 0, %.preheader.us.i ]
...
bb.hh:                                            ; preds = %bb.hg, %bb.hf
  ...
  %niter680.next.1 = add i64 %niter680, 2         ; 2 uses
  %niter680.ncmp.1 = icmp eq i64 %niter680.next.1, %unroll_iter679
  br i1 %niter680.ncmp.1, label %Exa_ManFindFanin.exit.loopexit.us.us.i.unr-lcssa, label %.preheader.us.i.new, !llvm.loop !156

Exa_ManFindFanin.exit.loopexit.us.us.i.unr-lcssa: ; preds = %bb.hh
  br i1 %lcmp.mod676.not, label %Exa_ManFindFanin.exit.loopexit.us.us.i, label %.epil.preheader674

.epil.preheader674:                               ; preds = %Exa_ManFindFanin.exit.loopexit.us.us.i.unr-lcssa, %.preheader.us.i
  ...
  call void @llvm.assume(i1 %lcmp.mod678)
...
Exa_ManFindFanin.exit.loopexit.us.us.i:           ; preds = %.epil.preheader674, %bb.hi, %Exa_ManFindFanin.exit.loopexit.us.us.i.unr-lcssa
  %.1.i.us.us.i.lcssa = phi i32 [ %.1.i.us.us.i.1, %Exa_ManFindFanin.exit.loopexit.us.us.i.unr-lcssa ], [ %.023.i.us.us.i.epil.init, %.epil.preheader674 ], [ %spec.select19.i.us.us.i.epil, %bb.hi ]
  ...
  br i1 %i.asi, label %.epil.preheader681, label %Exa_ManFindFanin.exit.loopexit.us.us.i.new
...
Exa_ManFindFanin.exit.loopexit.us.us.i.new:       ; preds = %Exa_ManFindFanin.exit.loopexit.us.us.i, %bb.hm
  ...
  %niter687 = phi i64 [ %niter687.next.1, %bb.hm ], [ 0, %Exa_ManFindFanin.exit.loopexit.us.us.i ]
...
bb.hm:                                            ; preds = %bb.hl, %bb.hk
  ...
  %niter687.next.1 = add i64 %niter687, 2         ; 2 uses
  %niter687.ncmp.1 = icmp eq i64 %niter687.next.1, %unroll_iter686
  br i1 %niter687.ncmp.1, label %Exa_ManFindFanin.exit.loopexit.us.us.1.i.unr-lcssa, label %Exa_ManFindFanin.exit.loopexit.us.us.i.new, !llvm.loop !156

Exa_ManFindFanin.exit.loopexit.us.us.1.i.unr-lcssa: ; preds = %bb.hm
  br i1 %lcmp.mod683.not, label %Exa_ManFindFanin.exit.loopexit.us.us.1.i, label %.epil.preheader681

.epil.preheader681:                               ; preds = %Exa_ManFindFanin.exit.loopexit.us.us.1.i.unr-lcssa, %Exa_ManFindFanin.exit.loopexit.us.us.i
  ...
  call void @llvm.assume(i1 %lcmp.mod685)
...
Exa_ManFindFanin.exit.loopexit.us.us.1.i:         ; preds = %.epil.preheader681, %bb.hn, %Exa_ManFindFanin.exit.loopexit.us.us.1.i.unr-lcssa
  %.1.i.us.us.1.i.lcssa = phi i32 [ %.1.i.us.us.1.i.1, %Exa_ManFindFanin.exit.loopexit.us.us.1.i.unr-lcssa ], [ %.023.i.us.us.1.i.epil.init, %.epil.preheader681 ], [ %spec.select19.i.us.us.1.i.epil, %bb.hn ]
...
.lr.ph.i.i104:                                    ; preds = %bb.ia
  ...
  %xtraiter689 = and i64 %wide.trip.count.i.i105, 1
  %i.awd = icmp eq i32 %i.awa, 1
  br i1 %i.awd, label %.epil.preheader688, label %.lr.ph.i.i104.new

.lr.ph.i.i104.new:                                ; preds = %.lr.ph.i.i104
  %unroll_iter693 = and i64 %wide.trip.count.i.i105, 2147483646
  br label %bb.ib
...
bb.ib:                                            ; preds = %bb.if, %.lr.ph.i.i104.new
  ...
  %niter694 = phi i64 [ 0, %.lr.ph.i.i104.new ], [ %niter694.next.1, %bb.if ]
...
bb.if:                                            ; preds = %bb.ie, %bb.id
  ...
  %niter694.next.1 = add i64 %niter694, 2         ; 2 uses
  %niter694.ncmp.1 = icmp eq i64 %niter694.next.1, %unroll_iter693
  br i1 %niter694.ncmp.1, label %Exa_ManFindFanin.exit.i.unr-lcssa, label %bb.ib, !llvm.loop !156

Exa_ManFindFanin.exit.i.unr-lcssa:                ; preds = %bb.if
  %lcmp.mod690.not = icmp eq i64 %xtraiter689, 0
  br i1 %lcmp.mod690.not, label %Exa_ManFindFanin.exit.i, label %.epil.preheader688

.epil.preheader688:                               ; preds = %Exa_ManFindFanin.exit.i.unr-lcssa, %.lr.ph.i.i104
  ...
  %lcmp.mod692 = trunc i32 %i.awa to i1
...
Exa_ManFindFanin.exit.i:                          ; preds = %.epil.preheader688, %bb.ig, %Exa_ManFindFanin.exit.i.unr-lcssa
  %.1.i.i.lcssa = phi i32 [ %.1.i.i.1, %Exa_ManFindFanin.exit.i.unr-lcssa ], [ %.023.i.i.epil.init, %.epil.preheader688 ], [ %spec.select19.i.i.epil, %bb.ig ] ; 5 uses
...
bb.jp:                                            ; preds = %bb.jo, %bb.jn
  ...
  br i1 %niter715.ncmp.1, label %Exa_ManFindFanin.exit.1.i130.unr-lcssa, label %bb.jl, !llvm.loop !156

Exa_ManFindFanin.exit.1.i130.unr-lcssa:           ; preds = %bb.jp
  %lcmp.mod711.not = icmp eq i64 %xtraiter710, 0
  br i1 %lcmp.mod711.not, label %Exa_ManFindFanin.exit.1.i130, label %.epil.preheader709

.epil.preheader709:                               ; preds = %Exa_ManFindFanin.exit.1.i130.unr-lcssa, %.lr.ph.i.1.i119
  ...
  %lcmp.mod713 = trunc i32 %i.baw to i1
  call void @llvm.assume(i1 %lcmp.mod713)
...
Exa_ManFindFanin.exit.1.i130:                     ; preds = %.epil.preheader709, %bb.jq, %Exa_ManFindFanin.exit.1.i130.unr-lcssa
  %.1.i.1.i127.lcssa = phi i32 [ %.1.i.1.i127.1, %Exa_ManFindFanin.exit.1.i130.unr-lcssa ], [ %.023.i.1.i122.epil.init, %.epil.preheader709 ], [ %spec.select19.i.1.i126.epil, %bb.jq ] ; 5 uses
...
bb.jw:                                            ; preds = %Exa_ManSaveSolution.exit, %Exa_ManPrintPerm.exit, %Exa_ManAddCnf.exit.thread
  %.036 = phi i32 [ 0, %Exa_ManAddCnf.exit.thread ], [ 1, %Exa_ManPrintPerm.exit ], [ 1, %Exa_ManSaveSolution.exit ] ; 2 uses
...
bb.jz:                                            ; preds = %bb.jw, %Abc_Clock.exit146, %.loopexit197
  %.0 = phi i32 [ 0, %.loopexit197 ], [ %.036, %Abc_Clock.exit146 ], [ %.036, %bb.jw ]
