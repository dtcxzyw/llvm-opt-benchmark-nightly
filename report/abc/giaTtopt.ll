...
bb.a:
  ...
  %i.b = load i32, ptr %i.a, align 8, !tbaa !95   ; 3 uses
...
.loopexit:                                        ; preds = %._crit_edge.i, %_ZN5Ttopt17TruthTableRewrite8CopyFuncEiiib.exit.us, %bb.b
  ...
  br i1 %i.j, label %bb.b, label %._crit_edge, !llvm.loop !370
...
bb.b:                                             ; preds = %.lr.ph15, %.loopexit
  ...
  %i.k = getelementptr inbounds nuw [24 x i8], ptr %i.e, i64 %indvars.iv.next ; 2 uses
  %i.l = getelementptr inbounds nuw i8, ptr %i.k, i64 8
  %i.m = load ptr, ptr %i.l, align 8, !tbaa !329, !noalias !371 ; 3 uses
  %i.n = load ptr, ptr %i.k, align 8, !tbaa !329, !noalias !374 ; 3 uses
  %.not11 = icmp eq ptr %i.m, %i.n
...
.lr.ph:                                           ; preds = %bb.b
  ...
  %.not71.i = icmp eq i32 %i.s, 31                ; 4 uses
  %smax.i = tail call i32 @llvm.smax.i32(i32 %i.t, i32 1)
  %wide.trip.count.i = zext nneg i32 %smax.i to i64 ; 7 uses
  %i.u = shl nuw nsw i64 %wide.trip.count.i, 3    ; 2 uses
  br i1 %i.p, label %.lr.ph.split.us.preheader, label %.lr.ph.split

.lr.ph.split.us.preheader:                        ; preds = %.lr.ph
  %min.iters.check36 = icmp slt i32 %i.t, 6
  %n.vec38 = and i64 %wide.trip.count.i, 2147483644
  %xtraiter = and i64 %wide.trip.count.i, 3       ; 3 uses
  %i.v = icmp slt i32 %i.t, 4
  %unroll_iter = and i64 %wide.trip.count.i, 2147483644
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  %lcmp.mod51 = icmp ne i64 %xtraiter, 0
  %min.iters.check = icmp slt i32 %i.t, 4
  %n.vec = and i64 %wide.trip.count.i, 2147483644
  %xtraiter52 = and i64 %wide.trip.count.i, 3     ; 3 uses
  %i.w = icmp slt i32 %i.t, 4
  %unroll_iter56 = and i64 %wide.trip.count.i, 2147483644
...
.lr.ph.split.us:                                  ; preds = %.lr.ph.split.us.preheader, %_ZN5Ttopt17TruthTableRewrite8CopyFuncEiiib.exit.us
  %.sroa.06.012.us = phi ptr [ %i.x, %_ZN5Ttopt17TruthTableRewrite8CopyFuncEiiib.exit.us ], [ %i.m, %.lr.ph.split.us.preheader ] ; 2 uses
...
.preheader60.i.us:                                ; preds = %bb.c
  br i1 %.not71.i, label %_ZN5Ttopt17TruthTableRewrite8CopyFuncEiiib.exit.us, label %.lr.ph.i.us

.lr.ph.i.us:                                      ; preds = %.preheader60.i.us
  %i.ae = shl i32 %i.ab, %i.s
  %i.af = load ptr, ptr %i.f, align 8, !tbaa !75  ; 2 uses
  %i.ag = shl i32 %i.z, %i.s
  ...
  br i1 %min.iters.check36, label %scalar.ph35.preheader, label %vector.memcheck33

scalar.ph35.preheader:                            ; preds = %vector.memcheck33, %.lr.ph.i.us
  br i1 %i.v, label %scalar.ph35.epil.preheader, label %scalar.ph35

vector.memcheck33:                                ; preds = %.lr.ph.i.us
  %i.aj = sub nsw i64 %i.ai, %i.ah
  %i.ak = shl nsw i64 %i.aj, 3
  %i.al = add nsw i64 %i.ak, -1
  %diff.check34 = icmp ult i64 %i.al, 31
  br i1 %diff.check34, label %scalar.ph35.preheader, label %vector.body39

vector.body39:                                    ; preds = %vector.memcheck33, %vector.body39
  %index40 = phi i64 [ %index.next43, %vector.body39 ], [ 0, %vector.memcheck33 ] ; 3 uses
  %i.am = getelementptr [8 x i8], ptr %invariant.gep.i.us, i64 %index40 ; 2 uses
  %i.an = getelementptr i8, ptr %i.am, i64 16
  %wide.load41.a = load <2 x i64>, ptr %i.am, align 8, !tbaa !71
  %wide.load42 = load <2 x i64>, ptr %i.an, align 8, !tbaa !71
  %i.ao = getelementptr [8 x i8], ptr %invariant.gep101.i.us, i64 %index40 ; 2 uses
  %i.ap = getelementptr i8, ptr %i.ao, i64 16
  store <2 x i64> %wide.load41.a, ptr %i.ao, align 8, !tbaa !71
  store <2 x i64> %wide.load42, ptr %i.ap, align 8, !tbaa !71
  %index.next43 = add nuw i64 %index40, 4         ; 2 uses
  %i.aq = icmp eq i64 %index.next43, %n.vec38
  br i1 %i.aq, label %_ZN5Ttopt17TruthTableRewrite8CopyFuncEiiib.exit.us, label %vector.body39, !llvm.loop !377

scalar.ph35:                                      ; preds = %scalar.ph35.preheader, %scalar.ph35
  %indvars.iv.i.us = phi i64 [ %indvars.iv.next.i.us.3, %scalar.ph35 ], [ 0, %scalar.ph35.preheader ] ; 6 uses
  %niter = phi i64 [ %niter.next.3, %scalar.ph35 ], [ 0, %scalar.ph35.preheader ]
  ...
  br i1 %niter.ncmp.3, label %_ZN5Ttopt17TruthTableRewrite8CopyFuncEiiib.exit.us.loopexit48.unr-lcssa, label %scalar.ph35, !llvm.loop !378

.preheader58.i.us:                                ; preds = %bb.c
  br i1 %.not71.i, label %_ZN5Ttopt17TruthTableRewrite8CopyFuncEiiib.exit.us, label %.lr.ph64.i.us

.lr.ph64.i.us:                                    ; preds = %.preheader58.i.us
  %i.av = shl i32 %i.z, %i.s
...
.preheader56.i.us:                                ; preds = %bb.d
  br i1 %.not71.i, label %_ZN5Ttopt17TruthTableRewrite8CopyFuncEiiib.exit.us, label %.lr.ph66.i.us

.lr.ph66.i.us:                                    ; preds = %.preheader56.i.us
  %i.az = shl i32 %i.ab, %i.s
  %i.ba = load ptr, ptr %i.f, align 8, !tbaa !75  ; 2 uses
  %i.bb = shl i32 %i.z, %i.s
...
vector.body:                                      ; preds = %vector.memcheck, %vector.body
  ...
  %wide.load32 = load <2 x i64>, ptr %i.bi, align 8, !tbaa !71
  %i.bj = xor <2 x i64> %wide.load, splat (i64 -1)
  %i.bk = xor <2 x i64> %wide.load32, splat (i64 -1)
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %niter57 = phi i64 [ %niter57.next.3, %scalar.ph ], [ 0, %scalar.ph.preheader ]
  ...
  br i1 %niter57.ncmp.3, label %_ZN5Ttopt17TruthTableRewrite8CopyFuncEiiib.exit.us.loopexit.unr-lcssa, label %scalar.ph, !llvm.loop !380

.preheader.i.us:                                  ; preds = %bb.d
  br i1 %.not71.i, label %_ZN5Ttopt17TruthTableRewrite8CopyFuncEiiib.exit.us, label %.lr.ph68.i.us

.lr.ph68.i.us:                                    ; preds = %.preheader.i.us
  %i.bw = shl i32 %i.z, %i.s
...
_ZN5Ttopt17TruthTableRewrite8CopyFuncEiiib.exit.us.loopexit.unr-lcssa: ; preds = %scalar.ph
  br i1 %lcmp.mod54.not, label %_ZN5Ttopt17TruthTableRewrite8CopyFuncEiiib.exit.us, label %scalar.ph.epil.preheader
...
scalar.ph.epil:                                   ; preds = %scalar.ph.epil, %scalar.ph.epil.preheader
  ...
  %epil.iter53 = phi i64 [ %epil.iter53.next, %scalar.ph.epil ], [ 0, %scalar.ph.epil.preheader ]
  ...
  br i1 %epil.iter53.cmp.not, label %_ZN5Ttopt17TruthTableRewrite8CopyFuncEiiib.exit.us, label %scalar.ph.epil, !llvm.loop !381

_ZN5Ttopt17TruthTableRewrite8CopyFuncEiiib.exit.us.loopexit48.unr-lcssa: ; preds = %scalar.ph35
  br i1 %lcmp.mod.not, label %_ZN5Ttopt17TruthTableRewrite8CopyFuncEiiib.exit.us, label %scalar.ph35.epil.preheader

scalar.ph35.epil.preheader:                       ; preds = %_ZN5Ttopt17TruthTableRewrite8CopyFuncEiiib.exit.us.loopexit48.unr-lcssa, %scalar.ph35.preheader
  %indvars.iv.i.us.epil.init = phi i64 [ 0, %scalar.ph35.preheader ], [ %indvars.iv.next.i.us.3, %_ZN5Ttopt17TruthTableRewrite8CopyFuncEiiib.exit.us.loopexit48.unr-lcssa ]
  tail call void @llvm.assume(i1 %lcmp.mod51)
  br label %scalar.ph35.epil

scalar.ph35.epil:                                 ; preds = %scalar.ph35.epil, %scalar.ph35.epil.preheader
  %indvars.iv.i.us.epil = phi i64 [ %indvars.iv.next.i.us.epil, %scalar.ph35.epil ], [ %indvars.iv.i.us.epil.init, %scalar.ph35.epil.preheader ] ; 3 uses
  %epil.iter = phi i64 [ %epil.iter.next, %scalar.ph35.epil ], [ 0, %scalar.ph35.epil.preheader ]
  ...
  br i1 %epil.iter.cmp.not, label %_ZN5Ttopt17TruthTableRewrite8CopyFuncEiiib.exit.us, label %scalar.ph35.epil, !llvm.loop !382

_ZN5Ttopt17TruthTableRewrite8CopyFuncEiiib.exit.us: ; preds = %vector.body39, %_ZN5Ttopt17TruthTableRewrite8CopyFuncEiiib.exit.us.loopexit48.unr-lcssa, %scalar.ph35.epil, %vector.body, %_ZN5Ttopt17TruthTableRewrite8CopyFuncEiiib.exit.us.loopexit.unr-lcssa, %scalar.ph.epil, %.lr.ph68.i.us, %.preheader.i.us, %.preheader56.i.us, %.lr.ph64.i.us, %.preheader58.i.us, %.preheader60.i.us
  %.not.us = icmp eq ptr %i.x, %i.n
...
bb.e:                                             ; preds = %.lr.ph.split, %._crit_edge.i
  %.sroa.06.012 = phi ptr [ %i.m, %.lr.ph.split ], [ %i.cg, %._crit_edge.i ] ; 2 uses
