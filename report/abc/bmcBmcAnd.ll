...
begin_hunk_0_@Gia_ManBmcAddCone:bb.a
  ...
  %i.dg = load ptr, ptr %i.a, align 8, !tbaa !67  ; 2 uses
  %i.dh = getelementptr i8, ptr %i.dg, i64 4
  %.val36 = load i32, ptr %i.dh, align 4, !tbaa !38
  %i.di = sext i32 %.val36 to i64
  %i.dj = icmp slt i64 %indvars.iv.next61, %i.di
  br i1 %i.dj, label %.lr.ph53, label %.critedge, !llvm.loop !141

.critedge:                                        ; preds = %.lr.ph53, %bb.y, %.preheader
  %i.dk = load ptr, ptr %i.d, align 8, !tbaa !65  ; 2 uses
  %i.dl = getelementptr i8, ptr %i.dk, i64 4
  %.val55 = load i32, ptr %i.dl, align 4, !tbaa !38
...
bb.z:                                             ; preds = %.lr.ph57
  ...
  %i.dx = load ptr, ptr %i.d, align 8, !tbaa !65  ; 2 uses
  %i.dy = getelementptr i8, ptr %i.dx, i64 4
  %.val = load i32, ptr %i.dy, align 4, !tbaa !38
  %i.dz = sext i32 %.val to i64
  %i.ea = icmp slt i64 %indvars.iv.next64, %i.dz
  br i1 %i.ea, label %.lr.ph57, label %.critedge2, !llvm.loop !142
...
.lr.ph:                                           ; preds = %bb.a
  ...
  %.val8 = load ptr, ptr %i.b, align 8, !tbaa !42 ; 2 uses
  %i.c = getelementptr i8, ptr %0, i64 72
  %.val9 = load ptr, ptr %i.c, align 8, !tbaa !37
  %i.d = getelementptr i8, ptr %.val9, i64 8
  %.val9.val = load ptr, ptr %i.d, align 8, !tbaa !47
...
bb.b:                                             ; preds = %bb.c
  ...
  br i1 %exitcond.not, label %._crit_edge, label %bb.c, !llvm.loop !5
...
bb.a:
  ...
  %.val11 = load i32, ptr %i.a, align 8, !tbaa !45
  %i.b = getelementptr i8, ptr %0, i64 72
  %.val12 = load ptr, ptr %i.b, align 8, !tbaa !37 ; 2 uses
  %i.c = getelementptr i8, ptr %.val12, i64 4
  %.val12.val = load i32, ptr %i.c, align 4, !tbaa !38
...
.lr.ph:                                           ; preds = %bb.a
  ...
  %.val13 = load ptr, ptr %i.f, align 8, !tbaa !42 ; 3 uses
  %.not = icmp eq ptr %.val13, null
  br i1 %.not, label %.critedge, label %.lr.ph.split

.lr.ph.split:                                     ; preds = %.lr.ph
  %i.g = getelementptr i8, ptr %.val12, i64 8
  %.val14.val = load ptr, ptr %i.g, align 8, !tbaa !47
...
bb.c:                                             ; preds = %bb.b
  ...
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %.critedge, label %bb.b, !llvm.loop !6
...
bb.b:                                             ; preds = %bb.i
  ...
  br i1 %exitcond.not, label %.loopexit117, label %.lr.ph168, !llvm.loop !143
...
.lr.ph168:                                        ; preds = %bb.a, %bb.b
  ...
  store ptr %i.v, ptr %i.d, align 8, !tbaa !77
  %.val102 = load i32, ptr %i.h, align 8, !tbaa !45
  %.val103 = load ptr, ptr %i.i, align 8, !tbaa !37
  %i.w = getelementptr i8, ptr %.val103, i64 4
  %.val103.val = load i32, ptr %i.w, align 4, !tbaa !38
...
.lr.ph.i:                                         ; preds = %.lr.ph168
  ...
  %.val8.i = load ptr, ptr %i.ac, align 8, !tbaa !42 ; 2 uses
  %i.ad = getelementptr i8, ptr %i.v, i64 72
  %.val9.i = load ptr, ptr %i.ad, align 8, !tbaa !37
  %i.ae = getelementptr i8, ptr %.val9.i, i64 8
  %.val9.val.i = load ptr, ptr %i.ae, align 8, !tbaa !47
...
bb.c:                                             ; preds = %bb.d
  ...
  br i1 %exitcond.not.i, label %Gia_ManBmcCheckOutputs.exit.thread, label %bb.d, !llvm.loop !5
...
Gia_ManBmcCheckOutputs.exit:                      ; preds = %bb.d
  ...
  %i.at = load ptr, ptr %i.d, align 8, !tbaa !77
  %i.au = load ptr, ptr %i.j, align 8, !tbaa !65
  %i.av = load ptr, ptr %i.k, align 8, !tbaa !67
  %i.aw = load ptr, ptr %i.l, align 8, !tbaa !66
  call void @Gia_ManBmcAddCnf(ptr noundef nonnull %i.d, ptr noundef %i.at, ptr noundef %i.au, ptr noundef %i.av, ptr noundef %i.aw)
  %.val94 = load i32, ptr %i.h, align 8, !tbaa !45 ; 2 uses
  %.val95 = load ptr, ptr %i.i, align 8, !tbaa !37 ; 2 uses
  %i.ax = getelementptr i8, ptr %.val95, i64 4
  %.val95.val = load i32, ptr %i.ax, align 4, !tbaa !38
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.f
  ...
  %i.bd = load ptr, ptr %i.d, align 8, !tbaa !77  ; 2 uses
  %i.be = getelementptr i8, ptr %i.bd, i64 32
  %.val104 = load ptr, ptr %i.be, align 8, !tbaa !42 ; 2 uses
  %i.bf = getelementptr i8, ptr %i.bd, i64 72
  %.val105 = load ptr, ptr %i.bf, align 8, !tbaa !37
  %i.bg = getelementptr i8, ptr %.val105, i64 8
  %.val105.val = load ptr, ptr %i.bg, align 8, !tbaa !47
...
bb.e:                                             ; preds = %.lr.ph
  %i.bv = load ptr, ptr %i.m, align 8, !tbaa !64
  %i.bw = getelementptr i8, ptr %i.bv, i64 8
  %.val89 = load ptr, ptr %i.bw, align 8, !tbaa !47
  %i.bx = getelementptr inbounds [4 x i8], ptr %.val89, i64 %i.bj
  %i.by = load i32, ptr %i.bx, align 4, !tbaa !48
  %i.bz = shl nsw i32 %i.by, 1
  store i32 %i.bz, ptr %i.a, align 4, !tbaa !48
  %i.ca = load ptr, ptr %i.n, align 8, !tbaa !68
  %i.cb = load i32, ptr %i.p, align 4, !tbaa !81
...
._crit_edge:                                      ; preds = %bb.e
  %.val92.pre = load i32, ptr %i.h, align 8, !tbaa !45
  %.val93.pre = load ptr, ptr %i.i, align 8, !tbaa !37
  br label %bb.f
...
bb.f:                                             ; preds = %._crit_edge, %.lr.ph
  ...
  %.val93.val = load i32, ptr %i.ce, align 4, !tbaa !38
  %i.cf = sub nsw i32 %.val93.val, %.val92
  %i.cg = mul nsw i32 %i.cf, %i.z
  %i.ch = sext i32 %i.cg to i64
  %i.ci = icmp slt i64 %indvars.iv.next, %i.ch
  br i1 %i.ci, label %.lr.ph, label %Gia_ManBmcCheckOutputs.exit.thread.loopexit, !llvm.loop !144
...
bb.g:                                             ; preds = %Gia_ManBmcCheckOutputs.exit.thread
  ...
  %.val.i = load i32, ptr %i.cu, align 4, !tbaa !38
  %i.cv = add i32 %.val.i, %.val88.val
  %i.cw = xor i32 %i.cv, -1
  %i.cx = add i32 %i.cr, %i.cw
  %i.cy = load i32, ptr %i.r, align 8, !tbaa !69
  %i.cz = add nsw i32 %i.cy, -1
  %i.da = load ptr, ptr %i.j, align 8, !tbaa !65
  %i.db = getelementptr i8, ptr %i.da, i64 4
  %.val85 = load i32, ptr %i.db, align 4, !tbaa !38
  %i.dc = load ptr, ptr %i.k, align 8, !tbaa !67
  %i.dd = getelementptr i8, ptr %i.dc, i64 4
  %.val = load i32, ptr %i.dd, align 4, !tbaa !38
  %i.de = load ptr, ptr %i.n, align 8, !tbaa !68
  %i.df = call i32 @sat_solver_nclauses(ptr noundef %i.de) #20
  %i.dg = load ptr, ptr %i.n, align 8, !tbaa !68
  %i.dh = call i32 @sat_solver_nconflicts(ptr noundef %i.dg) #20
  %i.di = load ptr, ptr %i.d, align 8, !tbaa !77
...
bb.h:                                             ; preds = %bb.g
  %i.do = load i64, ptr %3, align 8, !tbaa !40
  %i.dp = mul nsw i64 %i.do, 1000000
  %i.dq = load i64, ptr %i.s, align 8, !tbaa !41
...
Abc_Clock.exit:                                   ; preds = %bb.g, %bb.h
  ...
  %i.dt = load i64, ptr %i.t, align 8, !tbaa !70
...
bb.g:                                             ; preds = %bb.f, %bb.c
  ...
  br i1 %i.bf, label %bb.b, label %.critedge, !llvm.loop !145
...
bb.b:                                             ; preds = %bb.a
  %i.d = load i64, ptr %5, align 8, !tbaa !40
...
Abc_Clock.exit:                                   ; preds = %bb.a, %bb.b
  ...
  store ptr %i.o, ptr %i.g, align 8, !tbaa !77
  %i.p = getelementptr i8, ptr %i.o, i64 16
  %.val127 = load i32, ptr %i.p, align 8, !tbaa !45
  %i.q = getelementptr i8, ptr %i.o, i64 72
  %.val128 = load ptr, ptr %i.q, align 8, !tbaa !37 ; 2 uses
  %i.r = getelementptr i8, ptr %.val128, i64 4
  %.val128.val = load i32, ptr %i.r, align 4, !tbaa !38
  %i.s = sub nsw i32 %.val128.val, %.val127       ; 3 uses
  %i.t = getelementptr i8, ptr %0, i64 16         ; 5 uses
  %.val125 = load i32, ptr %i.t, align 8, !tbaa !45
  %i.u = getelementptr i8, ptr %0, i64 72         ; 5 uses
  %.val126 = load ptr, ptr %i.u, align 8, !tbaa !37
  %i.v = getelementptr i8, ptr %.val126, i64 4
  %.val126.val = load i32, ptr %i.v, align 4, !tbaa !38
...
.lr.ph.i:                                         ; preds = %bb.c
  ...
  %.val13.i = load ptr, ptr %i.ab, align 8, !tbaa !42 ; 3 uses
...
.lr.ph.split.i:                                   ; preds = %.lr.ph.i
  ...
  %.val14.val.i = load ptr, ptr %i.ac, align 8, !tbaa !47
...
bb.d:                                             ; preds = %bb.e, %.lr.ph.split.i
  ...
  %i.ae = load i32, ptr %i.ad, align 4, !tbaa !48
...
bb.e:                                             ; preds = %bb.d
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %wide.trip.count.i
  br i1 %exitcond.not.i, label %Gia_ManBmcFindFirst.exit, label %bb.d, !llvm.loop !6
...
bb.g:                                             ; preds = %Abc_Clock.exit134, %Abc_Clock.exit
  ...
  %i.be = load i32, ptr %i.bd, align 4, !tbaa !95
  %.not98 = icmp eq i32 %i.be, 0
  %i.bf = load i32, ptr %i.y, align 4, !tbaa !82  ; 2 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  store ptr %i.bg, ptr %i.g, align 8, !tbaa !77
...
bb.n:                                             ; preds = %.lr.ph175, %.thread150
  ...
  %.val123 = load i32, ptr %i.t, align 8, !tbaa !45
  %.val124 = load ptr, ptr %i.u, align 8, !tbaa !37
  %i.bv = getelementptr i8, ptr %.val124, i64 4
  %.val124.val = load i32, ptr %i.bv, align 4, !tbaa !38
...
.lr.ph.i135:                                      ; preds = %bb.n
  %i.cb = load ptr, ptr %i.g, align 8, !tbaa !77  ; 2 uses
  %i.cc = getelementptr i8, ptr %i.cb, i64 32
  %.val8.i = load ptr, ptr %i.cc, align 8, !tbaa !42 ; 2 uses
  %i.cd = getelementptr i8, ptr %i.cb, i64 72
  %.val9.i = load ptr, ptr %i.cd, align 8, !tbaa !37
  %i.ce = getelementptr i8, ptr %.val9.i, i64 8
  %.val9.val.i = load ptr, ptr %i.ce, align 8, !tbaa !47
...
bb.o:                                             ; preds = %bb.p
  ...
  br i1 %exitcond.not.i140, label %.thread150, label %bb.p, !llvm.loop !5
...
Gia_ManBmcCheckOutputs.exit:                      ; preds = %bb.p
  ...
  %i.ct = load ptr, ptr %i.g, align 8, !tbaa !77
  %i.cu = load ptr, ptr %i.bk, align 8, !tbaa !65
  %i.cv = load ptr, ptr %i.bl, align 8, !tbaa !67
  %i.cw = load ptr, ptr %i.bm, align 8, !tbaa !66
  call void @Gia_ManBmcAddCnf(ptr noundef nonnull %i.g, ptr noundef %i.ct, ptr noundef %i.cu, ptr noundef %i.cv, ptr noundef %i.cw)
  %.val115 = load i32, ptr %i.t, align 8, !tbaa !45 ; 2 uses
  %.val116 = load ptr, ptr %i.u, align 8, !tbaa !37 ; 2 uses
  %i.cx = getelementptr i8, ptr %.val116, i64 4
  %.val116.val = load i32, ptr %i.cx, align 4, !tbaa !38
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.r
  ...
  %i.dc = load ptr, ptr %i.g, align 8, !tbaa !77  ; 2 uses
  %i.dd = getelementptr i8, ptr %i.dc, i64 32
  %.val129 = load ptr, ptr %i.dd, align 8, !tbaa !42 ; 2 uses
  %i.de = getelementptr i8, ptr %i.dc, i64 72
  %.val130 = load ptr, ptr %i.de, align 8, !tbaa !37
  %i.df = getelementptr i8, ptr %.val130, i64 8
  %.val130.val = load ptr, ptr %i.df, align 8, !tbaa !47
...
bb.q:                                             ; preds = %.lr.ph
  %i.du = load ptr, ptr %i.bn, align 8, !tbaa !64
  %i.dv = getelementptr i8, ptr %i.du, i64 8
  %.val110 = load ptr, ptr %i.dv, align 8, !tbaa !47
  %i.dw = getelementptr inbounds [4 x i8], ptr %.val110, i64 %i.di
  %i.dx = load i32, ptr %i.dw, align 4, !tbaa !48
  %i.dy = shl nsw i32 %i.dx, 1
  store i32 %i.dy, ptr %i.a, align 4, !tbaa !48
  %i.dz = load ptr, ptr %i.bo, align 8, !tbaa !68
  %i.ea = load i32, ptr %i.bq, align 4, !tbaa !81
...
._crit_edge:                                      ; preds = %bb.q
  %.val113.pre = load i32, ptr %i.t, align 8, !tbaa !45
  %.val114.pre = load ptr, ptr %i.u, align 8, !tbaa !37
  br label %bb.r
...
bb.r:                                             ; preds = %._crit_edge, %.lr.ph
  ...
  %.val114.val = load i32, ptr %i.ed, align 4, !tbaa !38
  %i.ee = sub nsw i32 %.val114.val, %.val113
  %i.ef = mul nsw i32 %i.ee, %i.by
  %i.eg = sext i32 %i.ef to i64
  %i.eh = icmp slt i64 %indvars.iv.next, %i.eg
  br i1 %i.eh, label %.lr.ph, label %.loopexit.loopexit, !llvm.loop !151
...
bb.s:                                             ; preds = %.loopexit
  ...
  %.val.i = load i32, ptr %i.et, align 4, !tbaa !38
  %i.eu = add i32 %.val.i, %.val109.val
  %i.ev = xor i32 %i.eu, -1
  %i.ew = add i32 %i.eq, %i.ev
  %i.ex = load i32, ptr %i.br, align 8, !tbaa !69
  %i.ey = add nsw i32 %i.ex, -1
  %i.ez = load ptr, ptr %i.bk, align 8, !tbaa !65
  %i.fa = getelementptr i8, ptr %i.ez, i64 4
  %.val106 = load i32, ptr %i.fa, align 4, !tbaa !38
  %i.fb = load ptr, ptr %i.bl, align 8, !tbaa !67
  %i.fc = getelementptr i8, ptr %i.fb, i64 4
  %.val = load i32, ptr %i.fc, align 4, !tbaa !38
  %i.fd = load ptr, ptr %i.bo, align 8, !tbaa !68
  %i.fe = call i32 @sat_solver_nclauses(ptr noundef %i.fd) #20
  %i.ff = load ptr, ptr %i.bo, align 8, !tbaa !68
...
bb.t:                                             ; preds = %bb.s
  %i.fn = load i64, ptr %3, align 8, !tbaa !40
  %i.fo = mul nsw i64 %i.fn, 1000000
  %i.fp = load i64, ptr %i.bs, align 8, !tbaa !41
...
Abc_Clock.exit142:                                ; preds = %bb.s, %bb.t
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #20
  %i.fs = load i64, ptr %i.bt, align 8, !tbaa !70
...
bb.m:                                             ; preds = %bb.l
  %i.cb = load ptr, ptr %i.l, align 8, !tbaa !77  ; 2 uses
  %i.cc = load i32, ptr %i.au, align 4, !tbaa !82
  ...
  store ptr %i.cd, ptr %i.l, align 8, !tbaa !77
  call void @Gia_ManStop(ptr noundef %i.cb) #20
  br label %bb.p

bb.n:                                             ; preds = %bb.l
  %i.ce = load i32, ptr %i.au, align 4, !tbaa !82
  %.not128 = icmp eq i32 %i.ce, 0
  br i1 %.not128, label %bb.p, label %bb.o

bb.o:                                             ; preds = %bb.n
  %i.cf = load ptr, ptr %i.l, align 8, !tbaa !77
...
bb.q:                                             ; preds = %bb.p
  %i.ci = load ptr, ptr %i.l, align 8, !tbaa !77
...
bb.r:                                             ; preds = %bb.q, %bb.p
  ...
  %i.ck = load i32, ptr %i.cj, align 8, !tbaa !162
  %.not130 = icmp eq i32 %i.ck, 0
  %i.cl = load ptr, ptr %i.l, align 8, !tbaa !77  ; 2 uses
...
bb.t:                                             ; preds = %bb.r
  ...
  %i.cp = load i32, ptr %i.co, align 4, !tbaa !163
  %i.cq = load i32, ptr %i.au, align 4, !tbaa !82
...
bb.u:                                             ; preds = %bb.t, %bb.s
  ...
  store ptr %.sink, ptr %i.cs, align 8, !tbaa !71
  %i.ct = getelementptr inbounds nuw i8, ptr %i.l, i64 24 ; 2 uses
  %i.cu = load ptr, ptr %i.ct, align 8, !tbaa !64 ; 6 uses
  %i.cv = load ptr, ptr %i.l, align 8, !tbaa !77
  %i.cw = getelementptr i8, ptr %i.cv, i64 24
  %.val166 = load i32, ptr %i.cw, align 8, !tbaa !56 ; 8 uses
  %i.cx = getelementptr inbounds nuw i8, ptr %i.cu, i64 4 ; 3 uses
  %i.cy = load i32, ptr %i.cx, align 4, !tbaa !38 ; 4 uses
...
bb.x:                                             ; preds = %bb.w
  ...
  %i.dd = load ptr, ptr %i.dc, align 8, !tbaa !47 ; 2 uses
...
bb.aa:                                            ; preds = %bb.z, %bb.y
  ...
  store ptr %i.di, ptr %i.dc, align 8, !tbaa !47
...
bb.ad:                                            ; preds = %bb.ac
  ...
  %i.dl = load ptr, ptr %i.dk, align 8, !tbaa !47 ; 2 uses
...
bb.ag:                                            ; preds = %bb.af, %bb.ae
  ...
  store ptr %i.dq, ptr %i.dk, align 8, !tbaa !47
  br label %Vec_IntGrow.exit.sink.split.i
...
Vec_IntGrow.exit.sink.split.i:                    ; preds = %bb.ag, %bb.aa
  ...
  %.pre = load i32, ptr %i.cx, align 4, !tbaa !38
...
.lr.ph.i174:                                      ; preds = %Vec_IntGrow.exit.i
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %scevgep.i, i8 0, i64 %i.eb, i1 false), !tbaa !48
  br label %._crit_edge.i

._crit_edge.i:                                    ; preds = %.lr.ph.i174, %Vec_IntGrow.exit.i
  store i32 %.val166, ptr %i.cx, align 4, !tbaa !38
...
bb.ah:                                            ; preds = %.lr.ph226, %.thread197
  ...
  %i.el = load ptr, ptr %i.g, align 8, !tbaa !159 ; 2 uses
  %.not131 = icmp eq ptr %i.el, null
  br i1 %.not131, label %bb.aj, label %bb.ai

bb.ai:                                            ; preds = %bb.ah
  %i.em = load ptr, ptr %i.ec, align 8, !tbaa !160
...
bb.aj:                                            ; preds = %bb.ai, %bb.ah
  %.val157 = load i32, ptr %i.ap, align 8, !tbaa !45
  %.val158 = load ptr, ptr %i.aq, align 8, !tbaa !37
  %i.eo = getelementptr i8, ptr %.val158, i64 4
  %.val158.val = load i32, ptr %i.eo, align 4, !tbaa !38
...
.lr.ph.i176:                                      ; preds = %bb.aj
  ...
  %i.eu = load ptr, ptr %i.l, align 8, !tbaa !77  ; 2 uses
  %i.ev = getelementptr i8, ptr %i.eu, i64 32
  %.val8.i = load ptr, ptr %i.ev, align 8, !tbaa !42 ; 2 uses
  %i.ew = getelementptr i8, ptr %i.eu, i64 72
  %.val9.i = load ptr, ptr %i.ew, align 8, !tbaa !37
  %i.ex = getelementptr i8, ptr %.val9.i, i64 8
  %.val9.val.i = load ptr, ptr %i.ex, align 8, !tbaa !47
...
bb.ak:                                            ; preds = %bb.al
  ...
  br i1 %exitcond.not.i181, label %.thread197, label %bb.al, !llvm.loop !5
...
.lr.ph.i183:                                      ; preds = %bb.al, %bb.an
  ...
  %i.fm = load ptr, ptr %i.l, align 8, !tbaa !77  ; 2 uses
  %i.fn = getelementptr i8, ptr %i.fm, i64 32
  %.val9.i185 = load ptr, ptr %i.fn, align 8, !tbaa !42
  %i.fo = getelementptr i8, ptr %i.fm, i64 72
  %.val10.i = load ptr, ptr %i.fo, align 8, !tbaa !37
  %i.fp = getelementptr i8, ptr %.val10.i, i64 8
  %.val10.val.i = load ptr, ptr %i.fp, align 8, !tbaa !47
  %i.fq = getelementptr inbounds nuw [4 x i8], ptr %.val10.val.i, i64 %indvars.iv.i184
  %i.fr = load i32, ptr %i.fq, align 4, !tbaa !48
...
bb.an:                                            ; preds = %bb.am, %.lr.ph.i183
  ...
  br i1 %exitcond.not.i187, label %Gia_ManBmcAddCnfNew.exit, label %.lr.ph.i183, !llvm.loop !7

Gia_ManBmcAddCnfNew.exit:                         ; preds = %bb.an
  %.val149 = load i32, ptr %i.ap, align 8, !tbaa !45
  %.val150 = load ptr, ptr %i.aq, align 8, !tbaa !37
  %i.fx = getelementptr i8, ptr %.val150, i64 4
  %.val150.val = load i32, ptr %i.fx, align 4, !tbaa !38
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.at
  ...
  %i.gc = load ptr, ptr %i.g, align 8, !tbaa !159 ; 2 uses
  %.not134 = icmp eq ptr %i.gc, null
  br i1 %.not134, label %bb.ap, label %bb.ao

bb.ao:                                            ; preds = %.lr.ph
  %i.gd = load ptr, ptr %i.ec, align 8, !tbaa !160
...
bb.ap:                                            ; preds = %bb.ao, %.lr.ph
  %i.gg = load ptr, ptr %i.l, align 8, !tbaa !77  ; 2 uses
  %i.gh = getelementptr i8, ptr %i.gg, i64 32
  %.val163 = load ptr, ptr %i.gh, align 8, !tbaa !42 ; 3 uses
  %i.gi = getelementptr i8, ptr %i.gg, i64 72
  %.val164 = load ptr, ptr %i.gi, align 8, !tbaa !37
  %i.gj = getelementptr i8, ptr %.val164, i64 8
  %.val164.val = load ptr, ptr %i.gj, align 8, !tbaa !47
...
bb.as:                                            ; preds = %bb.aq
  %i.hd = load ptr, ptr %i.ct, align 8, !tbaa !64
  %i.he = getelementptr i8, ptr %i.hd, i64 8
  %.val144 = load ptr, ptr %i.he, align 8, !tbaa !47
  %i.hf = getelementptr inbounds [4 x i8], ptr %.val144, i64 %i.gm
  %i.hg = load i32, ptr %i.hf, align 4, !tbaa !48
  %i.hh = shl nsw i32 %i.hg, 1
  store i32 %i.hh, ptr %i.a, align 4, !tbaa !48
  %i.hi = load ptr, ptr %i.m, align 8, !tbaa !68
  %i.hj = load i32, ptr %i.ee, align 4, !tbaa !81
...
bb.at:                                            ; preds = %bb.as, %bb.ar, %bb.ap
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 3 uses
  %.val147 = load i32, ptr %i.ap, align 8, !tbaa !45
  %.val148 = load ptr, ptr %i.aq, align 8, !tbaa !37
  %i.hm = getelementptr i8, ptr %.val148, i64 4
  %.val148.val = load i32, ptr %i.hm, align 4, !tbaa !38
  %i.hn = sub nsw i32 %.val148.val, %.val147
  %i.ho = mul nsw i32 %i.hn, %i.eq
  %i.hp = sext i32 %i.ho to i64
  %i.hq = icmp slt i64 %indvars.iv.next, %i.hp
  br i1 %i.hq, label %.lr.ph, label %.loopexit.loopexit.split.loop.exit260, !llvm.loop !157
...
.loopexit:                                        ; preds = %bb.ao, %.loopexit.loopexit.split.loop.exit260, %Gia_ManBmcAddCnfNew.exit, %.loopexit228
  ...
  %i.hr = load i32, ptr %i.au, align 4, !tbaa !82
  %.not136 = icmp eq i32 %i.hr, 0
  br i1 %.not136, label %bb.aw, label %bb.au

bb.au:                                            ; preds = %.loopexit
  %i.hs = load ptr, ptr %i.l, align 8, !tbaa !77  ; 4 uses
  %i.ht = getelementptr i8, ptr %i.hs, i64 16
  %.val142 = load i32, ptr %i.ht, align 8, !tbaa !45
  %i.hu = getelementptr i8, ptr %i.hs, i64 64
  %.val143 = load ptr, ptr %i.hu, align 8, !tbaa !46
  %i.hv = getelementptr i8, ptr %.val143, i64 4
  %.val143.val = load i32, ptr %i.hv, align 4, !tbaa !38 ; 2 uses
  ...
  %.val.i = load i32, ptr %i.ib, align 4, !tbaa !38
