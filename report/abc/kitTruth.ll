...
.preheader87.us.preheader.i:                      ; preds = %.preheader87.lr.ph.i
  ...
  %6 = zext nneg i32 %i.ch to i64                 ; 2 uses
  ...
  %min.iters.check163 = icmp ult i32 %i.cg, 3
  ...
  %min.iters.check149 = icmp ult i32 %i.cg, 3
  ...
  %min.iters.check135 = icmp ult i32 %i.cg, 3
  ...
  %min.iters.check121 = icmp ult i32 %i.cg, 3
...
.preheader87.us.preheader.i:                      ; preds = %.preheader87.lr.ph.i
  ...
  %6 = zext nneg i32 %i.ce to i64                 ; 2 uses
  ...
  %min.iters.check164 = icmp ult i32 %i.cd, 3
  ...
  %min.iters.check150 = icmp ult i32 %i.cd, 3
  ...
  %min.iters.check136 = icmp ult i32 %i.cd, 3
  ...
  %min.iters.check122 = icmp ult i32 %i.cd, 3
...
bb.b:                                             ; preds = %.lr.ph128.us
  ...
  %i.ca = shl nuw nsw i32 1, %i.bu                ; 7 uses
  %i.cb = shl i32 3, %i.bu
