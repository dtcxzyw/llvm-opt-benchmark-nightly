...
.lr.ph84.1:                                       ; preds = %.lr.ph84
  ...
  %i.gr = load i32, ptr %i.gq, align 4, !tbaa !22 ; 3 uses
  ...
  store i32 %i.gx, ptr %i.gq, align 4, !tbaa !22
...
.lr.ph84.2:                                       ; preds = %.lr.ph84.1
  ...
  %i.gz = load i32, ptr %i.gy, align 4, !tbaa !22 ; 3 uses
  ...
  store i32 %i.hf, ptr %i.gy, align 4, !tbaa !22
  %i.hg = getelementptr inbounds nuw i8, ptr %0, i64 12 ; 2 uses
  %i.hh = load i32, ptr %i.hg, align 4, !tbaa !22 ; 3 uses
  ...
  store i32 %i.hn, ptr %i.hg, align 4, !tbaa !22
...
.lr.ph84.4:                                       ; preds = %.lr.ph84.2
  ...
  %i.hp = load i32, ptr %i.ho, align 4, !tbaa !22 ; 3 uses
  ...
  store i32 %i.hv, ptr %i.ho, align 4, !tbaa !22
  %i.hw = getelementptr inbounds nuw i8, ptr %0, i64 20 ; 2 uses
  %i.hx = load i32, ptr %i.hw, align 4, !tbaa !22 ; 3 uses
  ...
  store i32 %i.id, ptr %i.hw, align 4, !tbaa !22
  %i.ie = getelementptr inbounds nuw i8, ptr %0, i64 24 ; 2 uses
  %i.if = load i32, ptr %i.ie, align 4, !tbaa !22 ; 3 uses
  ...
  store i32 %i.il, ptr %i.ie, align 4, !tbaa !22
  br label %.loopexit

.lr.ph82:                                         ; preds = %.lr.ph82.preheader
  %i.im = load i32, ptr %0, align 4, !tbaa !22    ; 3 uses
  ...
  store i32 %i.is, ptr %0, align 4, !tbaa !22
...
.lr.ph82.1:                                       ; preds = %.lr.ph82
  ...
  store i32 %i.ja, ptr %i.it, align 4, !tbaa !22
...
.lr.ph82.2:                                       ; preds = %.lr.ph82.1
  ...
  %i.jc = load i32, ptr %i.jb, align 4, !tbaa !22 ; 3 uses
  ...
  store i32 %i.ji, ptr %i.jb, align 4, !tbaa !22
  %i.jj = getelementptr inbounds nuw i8, ptr %0, i64 12 ; 2 uses
  %i.jk = load i32, ptr %i.jj, align 4, !tbaa !22 ; 3 uses
  ...
  store i32 %i.jq, ptr %i.jj, align 4, !tbaa !22
...
.lr.ph82.4:                                       ; preds = %.lr.ph82.2
  ...
  %i.js = load i32, ptr %i.jr, align 4, !tbaa !22 ; 3 uses
  ...
  store i32 %i.jy, ptr %i.jr, align 4, !tbaa !22
  %i.jz = getelementptr inbounds nuw i8, ptr %0, i64 20 ; 2 uses
  %i.ka = load i32, ptr %i.jz, align 4, !tbaa !22 ; 3 uses
  ...
  store i32 %i.kg, ptr %i.jz, align 4, !tbaa !22
  %i.kh = getelementptr inbounds nuw i8, ptr %0, i64 24 ; 2 uses
  %i.ki = load i32, ptr %i.kh, align 4, !tbaa !22 ; 3 uses
  ...
  store i32 %i.ko, ptr %i.kh, align 4, !tbaa !22
  br label %.loopexit

.lr.ph:                                           ; preds = %.lr.ph.preheader
  %i.kp = load i32, ptr %0, align 4, !tbaa !22    ; 3 uses
  %i.kq = tail call i32 @llvm.fshl.i32(i32 %i.kp, i32 %i.kp, i32 16)
  %i.kr = or i32 %i.kq, %i.kp
  store i32 %i.kr, ptr %0, align 4, !tbaa !22
...
.lr.ph.1:                                         ; preds = %.lr.ph
  ...
  %i.kt = load i32, ptr %i.ks, align 4, !tbaa !22 ; 3 uses
  %i.ku = tail call i32 @llvm.fshl.i32(i32 %i.kt, i32 %i.kt, i32 16)
  %i.kv = or i32 %i.ku, %i.kt
  store i32 %i.kv, ptr %i.ks, align 4, !tbaa !22
...
vector.body192:                                   ; preds = %.preheader, %vector.body192
  ...
  %wide.load194.a = load <4 x i32>, ptr %i.mj, align 4, !tbaa !22, !alias.scope !208
  %wide.load195.a = load <4 x i32>, ptr %i.mk, align 4, !tbaa !22, !alias.scope !208
  ...
  %wide.load196.a = load <4 x i32>, ptr %i.ml, align 4, !tbaa !22, !alias.scope !209, !noalias !208
  %wide.load197 = load <4 x i32>, ptr %i.mm, align 4, !tbaa !22, !alias.scope !209, !noalias !208
  %i.mn = or <4 x i32> %wide.load196.a, %wide.load194.a ; 2 uses
  %i.mo = or <4 x i32> %wide.load197, %wide.load195.a ; 2 uses
  store <4 x i32> %i.mn, ptr %i.ml, align 4, !tbaa !22, !alias.scope !209, !noalias !208
  store <4 x i32> %i.mo, ptr %i.mm, align 4, !tbaa !22, !alias.scope !209, !noalias !208
  store <4 x i32> %i.mn, ptr %i.mj, align 4, !tbaa !22, !alias.scope !208
  store <4 x i32> %i.mo, ptr %i.mk, align 4, !tbaa !22, !alias.scope !208
...
scalar.ph188:                                     ; preds = %scalar.ph188.preheader, %scalar.ph188
  ...
  %i.mq = load i32, ptr %gep, align 4, !tbaa !22
  %i.mr = getelementptr inbounds nuw [4 x i8], ptr %.06791, i64 %indvars.iv119 ; 2 uses
  %i.ms = load i32, ptr %i.mr, align 4, !tbaa !22
  %i.mt = or i32 %i.ms, %i.mq                     ; 2 uses
  store i32 %i.mt, ptr %i.mr, align 4, !tbaa !22
  store i32 %i.mt, ptr %gep, align 4, !tbaa !22
  ...
  %i.mu = load i32, ptr %gep.1, align 4, !tbaa !22
  ...
  store i32 %i.mx, ptr %i.mv, align 4, !tbaa !22
  store i32 %i.mx, ptr %gep.1, align 4, !tbaa !22
...
scalar.ph188.epil.preheader:                      ; preds = %._crit_edge.loopexit.unr-lcssa, %scalar.ph188.preheader
  ...
  %i.my = load i32, ptr %gep.epil, align 4, !tbaa !22
  %i.mz = getelementptr inbounds nuw [4 x i8], ptr %.06791, i64 %indvars.iv119.epil.init ; 2 uses
  %i.na = load i32, ptr %i.mz, align 4, !tbaa !22
  %i.nb = or i32 %i.na, %i.my                     ; 2 uses
  store i32 %i.nb, ptr %i.mz, align 4, !tbaa !22
  store i32 %i.nb, ptr %gep.epil, align 4, !tbaa !22
  br label %._crit_edge
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %i.j, align 4, !tbaa !22 ; 3 uses
  %wide.load151 = load <4 x i32>, ptr %i.k, align 4, !tbaa !22 ; 3 uses
  ...
  store <4 x i32> %i.n, ptr %i.p, align 4, !tbaa !22
  store <4 x i32> %i.o, ptr %i.q, align 4, !tbaa !22
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.r = icmp eq i64 %index.next, %n.vec
  br i1 %i.r, label %.loopexit, label %vector.body, !llvm.loop !210
...
vector.body158:                                   ; preds = %vector.body158, %vector.ph156
  ...
  %wide.load160 = load <4 x i32>, ptr %i.v, align 4, !tbaa !22 ; 3 uses
  %wide.load161 = load <4 x i32>, ptr %i.w, align 4, !tbaa !22 ; 3 uses
...
vector.body192:                                   ; preds = %.preheader, %vector.body192
  ...
  %i.mj = getelementptr [4 x i8], ptr %invariant.gep, i64 %index193 ; 3 uses
  %i.mk = getelementptr i8, ptr %i.mj, i64 16     ; 2 uses
  %wide.load194.a = load <4 x i32>, ptr %i.mj, align 4, !tbaa !22, !alias.scope !239
  %wide.load195.a = load <4 x i32>, ptr %i.mk, align 4, !tbaa !22, !alias.scope !239
  %i.ml = getelementptr inbounds nuw [4 x i8], ptr %.06791, i64 %index193 ; 3 uses
  %i.mm = getelementptr inbounds nuw i8, ptr %i.ml, i64 16 ; 2 uses
  %wide.load196.a = load <4 x i32>, ptr %i.ml, align 4, !tbaa !22, !alias.scope !240, !noalias !239
  %wide.load197 = load <4 x i32>, ptr %i.mm, align 4, !tbaa !22, !alias.scope !240, !noalias !239
  %i.mn = and <4 x i32> %wide.load196.a, %wide.load194.a ; 2 uses
  %i.mo = and <4 x i32> %wide.load197, %wide.load195.a ; 2 uses
  store <4 x i32> %i.mn, ptr %i.ml, align 4, !tbaa !22, !alias.scope !240, !noalias !239
  store <4 x i32> %i.mo, ptr %i.mm, align 4, !tbaa !22, !alias.scope !240, !noalias !239
  store <4 x i32> %i.mn, ptr %i.mj, align 4, !tbaa !22, !alias.scope !239
  store <4 x i32> %i.mo, ptr %i.mk, align 4, !tbaa !22, !alias.scope !239
  %index.next198 = add nuw i64 %index193, 8       ; 2 uses
  %i.mp = icmp eq i64 %index.next198, %n.vec191
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.r = icmp eq i64 %index.next, %n.vec
  br i1 %i.r, label %.loopexit, label %vector.body, !llvm.loop !241
...
.lr.ph85.4:                                       ; preds = %.lr.ph85.2
  ...
  store i32 %i.gz, ptr %i.gt, align 4, !tbaa !22
  %i.ha = getelementptr inbounds nuw i8, ptr %0, i64 24 ; 2 uses
  %i.hb = load i32, ptr %i.ha, align 4, !tbaa !22 ; 2 uses
  %i.hc = shl i32 %i.hb, 4
  %i.hd = and i32 %i.hc, -252645136
...
.lr.ph83:                                         ; preds = %.lr.ph83.preheader
  %i.hh = load i32, ptr %0, align 4, !tbaa !22    ; 2 uses
  %i.hi = shl i32 %i.hh, 8
  %i.hj = and i32 %i.hi, -16711936
  %i.hk = lshr i32 %i.hh, 8
  %i.hl = and i32 %i.hk, 16711935
  %i.hm = or disjoint i32 %i.hj, %i.hl
  store i32 %i.hm, ptr %0, align 4, !tbaa !22
...
.lr.ph83.2:                                       ; preds = %.lr.ph83.1
  ...
  store i32 %i.ih, ptr %i.ib, align 4, !tbaa !22
...
.lr.ph.4:                                         ; preds = %.lr.ph.2
  ...
  store i32 %i.jw, ptr %i.ju, align 4, !tbaa !22
  br label %.loopexit
...
vector.body193:                                   ; preds = %.preheader, %vector.body193
  ...
  %wide.load195.a = load <4 x i32>, ptr %i.kq, align 4, !tbaa !22, !alias.scope !328, !noalias !329
  %wide.load196.a = load <4 x i32>, ptr %i.kr, align 4, !tbaa !22, !alias.scope !328, !noalias !329
  %i.ks = getelementptr [4 x i8], ptr %invariant.gep, i64 %index194 ; 3 uses
  %i.kt = getelementptr i8, ptr %i.ks, i64 16     ; 2 uses
  %wide.load197.a = load <4 x i32>, ptr %i.ks, align 4, !tbaa !22, !alias.scope !329
  %wide.load198 = load <4 x i32>, ptr %i.kt, align 4, !tbaa !22, !alias.scope !329
  store <4 x i32> %wide.load197.a, ptr %i.kq, align 4, !tbaa !22, !alias.scope !328, !noalias !329
  store <4 x i32> %wide.load198, ptr %i.kr, align 4, !tbaa !22, !alias.scope !328, !noalias !329
  store <4 x i32> %wide.load195.a, ptr %i.ks, align 4, !tbaa !22, !alias.scope !329
  store <4 x i32> %wide.load196.a, ptr %i.kt, align 4, !tbaa !22, !alias.scope !329
  %index.next199 = add nuw i64 %index194, 8       ; 2 uses
  %i.ku = icmp eq i64 %index.next199, %n.vec192
  br i1 %i.ku, label %._crit_edge, label %vector.body193, !llvm.loop !325
...
scalar.ph189:                                     ; preds = %scalar.ph189.preheader, %scalar.ph189
  ...
  %i.kx = load i32, ptr %gep, align 4, !tbaa !22
  store i32 %i.kx, ptr %i.kv, align 4, !tbaa !22
  store i32 %i.kw, ptr %gep, align 4, !tbaa !22
  ...
  %i.kz = load i32, ptr %i.ky, align 4, !tbaa !22
  %gep.1 = getelementptr [4 x i8], ptr %invariant.gep, i64 %indvars.iv.next121 ; 2 uses
  %i.la = load i32, ptr %gep.1, align 4, !tbaa !22
  store i32 %i.la, ptr %i.ky, align 4, !tbaa !22
  store i32 %i.kz, ptr %gep.1, align 4, !tbaa !22
  %indvars.iv.next121.1 = add nuw nsw i64 %indvars.iv120, 2 ; 2 uses
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge.loopexit.unr-lcssa, label %scalar.ph189, !llvm.loop !326
...
scalar.ph189.epil.preheader:                      ; preds = %._crit_edge.loopexit.unr-lcssa, %scalar.ph189.preheader
  ...
  %i.ld = load i32, ptr %gep.epil, align 4, !tbaa !22
  store i32 %i.ld, ptr %i.lb, align 4, !tbaa !22
  store i32 %i.lc, ptr %gep.epil, align 4, !tbaa !22
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %vector.body193, %scalar.ph189.epil.preheader, %._crit_edge.loopexit.unr-lcssa
  ...
  br i1 %i.lg, label %.preheader, label %.loopexit, !llvm.loop !327
...
bb.b:                                             ; preds = %Kit_TruthSupport.exit51.loopexit
  ...
  br i1 %exitcond.not, label %Kit_TruthSupport.exit51.loopexit._crit_edge, label %bb.c, !llvm.loop !330
...
select.unfold.i.prol:                             ; preds = %select.unfold.i.preheader268, %select.unfold.i.prol
  ...
  store i32 %i.n, ptr %i.o, align 4, !tbaa !22
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %select.unfold.i.prol.loopexit, label %select.unfold.i.prol, !llvm.loop !331
...
vector.body236:                                   ; preds = %select.unfold.i.preheader, %vector.body236
  ...
  %wide.load238 = load <4 x i32>, ptr %i.s, align 4, !tbaa !22
  %wide.load239 = load <4 x i32>, ptr %i.t, align 4, !tbaa !22
  ...
  store <4 x i32> %wide.load238, ptr %i.v, align 4, !tbaa !22
  store <4 x i32> %wide.load239, ptr %i.w, align 4, !tbaa !22
  %index.next240 = add nuw i64 %index237, 8       ; 2 uses
  %i.x = icmp eq i64 %index.next240, %n.vec235
  br i1 %i.x, label %Kit_TruthCopy.exit, label %vector.body236, !llvm.loop !332
...
select.unfold.i:                                  ; preds = %select.unfold.i.prol.loopexit, %select.unfold.i
  ...
  store i32 %i.ac, ptr %i.ad, align 4, !tbaa !22
