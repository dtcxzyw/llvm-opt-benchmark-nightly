...
bb.t:                                             ; preds = %.lr.ph335, %bb.w
  ...
  %.0334 = phi ptr [ %.val238, %.lr.ph335 ], [ %i.fv, %bb.w ]
...
bb.w:                                             ; preds = %bb.v, %bb.u
  ...
  %i.fv = tail call ptr @Aig_And(ptr noundef nonnull %i.i, ptr noundef %.0334, ptr noundef %i.fu) #17 ; 2 uses
...
.critedge8:                                       ; preds = %bb.w, %.preheader
  %.0.lcssa = phi ptr [ %.val238, %.preheader ], [ %i.fv, %bb.w ]
  %i.fy = tail call ptr @Aig_And(ptr noundef nonnull %i.i, ptr noundef %i.eg, ptr noundef %.0.lcssa) #17
  br label %bb.x

bb.x:                                             ; preds = %.critedge8, %bb.s
  %.0200 = phi ptr [ %i.fy, %.critedge8 ], [ %i.eg, %bb.s ]
...
Vec_PtrPush.exit297.Vec_PtrPush.exit305_crit_edge: ; preds = %Vec_PtrPush.exit297
  %.pre392 = load ptr, ptr %i.go, align 8, !tbaa !29
...
Vec_PtrPush.exit305:                              ; preds = %Vec_PtrPush.exit297.Vec_PtrPush.exit305_crit_edge, %bb.bc, %Vec_PtrGrow.exit12.sink.split.i301
  %i.ka = phi ptr [ %.pre392, %Vec_PtrPush.exit297.Vec_PtrPush.exit305_crit_edge ], [ %.pre393, %bb.bc ], [ %storemerge313, %Vec_PtrGrow.exit12.sink.split.i301 ]
...
.critedge12.loopexit:                             ; preds = %Aig_ObjChild0Copy.exit307
  %indvars.le = trunc i64 %indvars.iv.next375 to i32
  br label %.critedge12

.critedge12:                                      ; preds = %.critedge12.loopexit, %.critedge10.preheader
  %.6.lcssa = phi i32 [ 0, %.critedge10.preheader ], [ %indvars.le, %.critedge12.loopexit ] ; 2 uses
  store i32 %.6.lcssa, ptr %3, align 4, !tbaa !34
...
.critedge14.preheader:                            ; preds = %bb.bi, %.critedge12
  %.0201.lcssa = phi i32 [ 0, %.critedge12 ], [ %.val217, %bb.bi ]
