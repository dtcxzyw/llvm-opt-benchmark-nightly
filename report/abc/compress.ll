...
begin_hunk_0_@BZ2_compressBlock:bb.a
  ...
  %2 = insertelement <36 x i32> poison, i32 %i.tj, i64 0
  %3 = insertelement <36 x i32> %2, i32 %i.ta, i64 1
  %4 = insertelement <36 x i32> %3, i32 %i.tt, i64 2
  %5 = insertelement <36 x i32> %4, i32 %i.ud, i64 3
  %6 = insertelement <36 x i32> %5, i32 %i.un, i64 4
  %7 = insertelement <36 x i32> %6, i32 %i.ux, i64 5
  %8 = insertelement <36 x i32> %7, i32 %i.vh, i64 6
  %9 = insertelement <36 x i32> %8, i32 %i.vr, i64 7
  %10 = insertelement <36 x i32> %9, i32 %i.wb, i64 8
  %11 = insertelement <36 x i32> %10, i32 %i.wl, i64 9
  %12 = insertelement <36 x i32> %11, i32 %i.wv, i64 10
  %13 = insertelement <36 x i32> %12, i32 %i.xf, i64 11
  %14 = insertelement <36 x i32> %13, i32 %i.xp, i64 12
  %15 = insertelement <36 x i32> %14, i32 %i.xz, i64 13
  %16 = insertelement <36 x i32> %15, i32 %i.yj, i64 14
  %17 = insertelement <36 x i32> %16, i32 %i.yt, i64 15
  %18 = insertelement <36 x i32> %17, i32 %i.zd, i64 16
  %19 = insertelement <36 x i32> %18, i32 %i.zn, i64 17
  %20 = insertelement <36 x i32> %19, i32 %i.zx, i64 18
  %21 = insertelement <36 x i32> %20, i32 %i.aah, i64 19
  %22 = insertelement <36 x i32> %21, i32 %i.aar, i64 20
  %23 = insertelement <36 x i32> %22, i32 %i.abb, i64 21
  %24 = insertelement <36 x i32> %23, i32 %i.abl, i64 22
  %25 = insertelement <36 x i32> %24, i32 %i.abv, i64 23
  %26 = insertelement <36 x i32> %25, i32 %i.acf, i64 24
  %27 = insertelement <36 x i32> %26, i32 %i.acp, i64 25
  %28 = insertelement <36 x i32> %27, i32 %i.acz, i64 26
  %29 = insertelement <36 x i32> %28, i32 %i.adj, i64 27
  %30 = insertelement <36 x i32> %29, i32 %i.adt, i64 28
  %31 = insertelement <36 x i32> %30, i32 %i.aed, i64 29
  %32 = insertelement <36 x i32> %31, i32 %i.aen, i64 30
  %33 = insertelement <36 x i32> %32, i32 %i.aex, i64 31
  %34 = insertelement <36 x i32> %33, i32 %i.afh, i64 32
  %35 = insertelement <36 x i32> %34, i32 %i.afr, i64 33
  %36 = insertelement <36 x i32> %35, i32 %i.agb, i64 34
  %37 = insertelement <36 x i32> %36, i32 %i.agl, i64 35
  %i.agw = call i32 @llvm.vector.reduce.add.v36i32(<36 x i32> %37)
  ...
  %38 = insertelement <36 x i32> poison, i32 %i.tl, i64 0
  %39 = insertelement <36 x i32> %38, i32 %i.tc, i64 1
  %40 = insertelement <36 x i32> %39, i32 %i.tv, i64 2
  %41 = insertelement <36 x i32> %40, i32 %i.uf, i64 3
  %42 = insertelement <36 x i32> %41, i32 %i.up, i64 4
  %43 = insertelement <36 x i32> %42, i32 %i.uz, i64 5
  %44 = insertelement <36 x i32> %43, i32 %i.vj, i64 6
  %45 = insertelement <36 x i32> %44, i32 %i.vt, i64 7
  %46 = insertelement <36 x i32> %45, i32 %i.wd, i64 8
  %47 = insertelement <36 x i32> %46, i32 %i.wn, i64 9
  %48 = insertelement <36 x i32> %47, i32 %i.wx, i64 10
  %49 = insertelement <36 x i32> %48, i32 %i.xh, i64 11
  %50 = insertelement <36 x i32> %49, i32 %i.xr, i64 12
  %51 = insertelement <36 x i32> %50, i32 %i.yb, i64 13
  %52 = insertelement <36 x i32> %51, i32 %i.yl, i64 14
  %53 = insertelement <36 x i32> %52, i32 %i.yv, i64 15
  %54 = insertelement <36 x i32> %53, i32 %i.zf, i64 16
  %55 = insertelement <36 x i32> %54, i32 %i.zp, i64 17
  %56 = insertelement <36 x i32> %55, i32 %i.zz, i64 18
  %57 = insertelement <36 x i32> %56, i32 %i.aaj, i64 19
  %58 = insertelement <36 x i32> %57, i32 %i.aat, i64 20
  %59 = insertelement <36 x i32> %58, i32 %i.abd, i64 21
  %60 = insertelement <36 x i32> %59, i32 %i.abn, i64 22
  %61 = insertelement <36 x i32> %60, i32 %i.abx, i64 23
  %62 = insertelement <36 x i32> %61, i32 %i.ach, i64 24
  %63 = insertelement <36 x i32> %62, i32 %i.acr, i64 25
  %64 = insertelement <36 x i32> %63, i32 %i.adb, i64 26
  %65 = insertelement <36 x i32> %64, i32 %i.adl, i64 27
  %66 = insertelement <36 x i32> %65, i32 %i.adv, i64 28
  %67 = insertelement <36 x i32> %66, i32 %i.aef, i64 29
  %68 = insertelement <36 x i32> %67, i32 %i.aep, i64 30
  %69 = insertelement <36 x i32> %68, i32 %i.aez, i64 31
  %70 = insertelement <36 x i32> %69, i32 %i.afj, i64 32
  %71 = insertelement <36 x i32> %70, i32 %i.aft, i64 33
  %72 = insertelement <36 x i32> %71, i32 %i.agd, i64 34
  %73 = insertelement <36 x i32> %72, i32 %i.agn, i64 35
  %i.ahn = call i32 @llvm.vector.reduce.add.v36i32(<36 x i32> %73)
...
; Function Attrs: nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none)
declare i32 @llvm.vector.reduce.add.v36i32(<36 x i32>) #6
