...
bb.a:
  ...
  %i.az = xor i64 %i.ay, %i.ag                    ; 2 uses
  %i.ba = and i64 %i.aw, 1
  %i.bb = and i64 %i.ba, %i.az
  %i.bc = load i64, ptr %i.g, align 8
  %i.bd = lshr i64 %i.bc, 61
  %i.be = xor i64 %i.bd, %i.e
  %4 = trunc i64 %i.az to i1
  %5 = and i64 %i.be, 1
  %6 = select i1 %4, i64 0, i64 %5
  %i.bf = or i64 %6, %i.bb
  %i.bg = load i64, ptr %i.a, align 8
  %i.bh = shl nuw nsw i64 %i.bf, 61
  %i.bi = and i64 %i.bg, -2305843009213693953
  ...
  %i.bo = tail call noundef i32 @llvm.smax.i32(i32 %i.bl, i32 %i.bn) ; 2 uses
  ...
  %i.br = load i32, ptr %i.bq, align 8, !tbaa !34
  %i.bs = tail call noundef i32 @llvm.smax.i32(i32 %i.bo, i32 %i.br)
  %i.bt = add nsw i32 %i.bs, 2                    ; 3 uses
  store i32 %i.bt, ptr %i.bp, align 8, !tbaa !34
  %i.bu = getelementptr inbounds nuw i8, ptr %0, i64 124 ; 2 uses
  %i.bv = load i32, ptr %i.bu, align 4, !tbaa !35
  %i.bw = icmp slt i32 %i.bv, %i.bt
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %i.by = load i32, ptr %i.bx, align 8, !tbaa !23
  %i.bz = add nsw i32 %i.by, 1
  store i32 %i.bz, ptr %i.bx, align 8, !tbaa !23
  ret ptr %i.a
}
