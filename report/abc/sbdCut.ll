...
.lr.ph.i68.i.us:                                  ; preds = %bb.aj, %.lr.ph.preheader.i67.i.us
  ...
  %.017.i.i.us = phi i32 [ %i.mj, %.lr.ph.preheader.i67.i.us ], [ %.1.i.i160.us, %bb.aj ] ; 13 uses
...
.preheader120.lr.ph.i286.us:                      ; preds = %bb.af
  ...
  %umin874 = zext i1 %i.nj to i64                 ; 3 uses
  %i.nk = or disjoint i64 %umin874, %i.nf
  %i.nl = sub nsw i64 %umax873, %i.nk             ; 2 uses
  %2 = shl nuw nsw i64 %i.ng, 4
  %3 = shl nuw nsw i64 %i.nh, 3                   ; 2 uses
  ...
  %i.ny = getelementptr i8, ptr %i.d, i64 %3
  %i.nz = getelementptr i8, ptr %i.d, i64 %i.nt
  %i.oa = getelementptr i8, ptr %i.nz, i64 %3
  %i.ob = getelementptr i8, ptr %i.oa, i64 %i.ni
  %min.iters.check882 = icmp ult i32 %i.na, 4
  %4 = add i32 %.017.i.i.us, -5
  %5 = zext nneg i32 %4 to i64
  %6 = lshr i64 %i.nl, %5
  %7 = add i64 %6, %umin874
  %8 = shl i64 %7, 3
  %9 = add i32 %.017.i.i.us, -5
  %10 = zext nneg i32 %9 to i64
  %11 = shl i64 %8, %10
  %i.oc = getelementptr i8, ptr %i.d, i64 %11
  %invariant.gep1126 = getelementptr i8, ptr %i.oc, i64 %2
...
.preheader120.i287.us:                            ; preds = %bb.ag, %.preheader120.lr.ph.i286.us
  ...
  %scevgep877 = getelementptr i8, ptr %i.ob, i64 %i.oe
  %invariant.gep157.i290.us.a = getelementptr inbounds nuw [8 x i8], ptr %.1124.i288.us, i64 %i.ng
  %invariant.gep157.i290.us = getelementptr inbounds nuw [8 x i8], ptr %.1124.i288.us, i64 %i.nh
  %scevgep877.a = getelementptr i8, ptr %invariant.gep1126, i64 %i.oe
  %bound0878 = icmp ult ptr %scevgep872, %scevgep877
  %bound1879 = icmp ult ptr %scevgep876, %scevgep877.a
...
.preheader119.i291.us:                            ; preds = %middle.block892, %.preheader120.i287.us
  ...
  %gep.i293.us = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep157.i290.us.a, i64 %indvars.iv138.i292.us ; 4 uses
  %gep158.i294.us = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep157.i290.us, i64 %indvars.iv138.i292.us ; 4 uses
...
.lr.ph.i72.i.us:                                  ; preds = %bb.ar, %.lr.ph.preheader.i71.i.us
  ...
  %.017.i74.i.us = phi i32 [ %i.sq, %.lr.ph.preheader.i71.i.us ], [ %.1.i76.i.us, %bb.ar ] ; 13 uses
...
.preheader120.lr.ph.i251.us:                      ; preds = %bb.an
  ...
  %umin810 = zext i1 %i.tq to i64                 ; 3 uses
  %i.tr = or disjoint i64 %umin810, %i.tm
  %i.ts = sub nsw i64 %umax809, %i.tr             ; 2 uses
  %12 = shl nuw nsw i64 %i.tn, 4
  %13 = shl nuw nsw i64 %i.to, 3                  ; 2 uses
  ...
  %i.uf = getelementptr i8, ptr %i.e, i64 %13
  %i.ug = getelementptr i8, ptr %i.e, i64 %i.ua
  %i.uh = getelementptr i8, ptr %i.ug, i64 %13
  %i.ui = getelementptr i8, ptr %i.uh, i64 %i.tp
  %min.iters.check818 = icmp ult i32 %i.th, 4
  %14 = add i32 %.017.i74.i.us, -5
  %15 = zext nneg i32 %14 to i64
  %16 = lshr i64 %i.ts, %15
  %17 = add i64 %16, %umin810
  %18 = shl i64 %17, 3
  %19 = add i32 %.017.i74.i.us, -5
  %20 = zext nneg i32 %19 to i64
  %21 = shl i64 %18, %20
  %i.uj = getelementptr i8, ptr %i.e, i64 %21
  %invariant.gep1130 = getelementptr i8, ptr %i.uj, i64 %12
...
.preheader120.i252.us:                            ; preds = %bb.ao, %.preheader120.lr.ph.i251.us
  ...
  %scevgep813 = getelementptr i8, ptr %i.ui, i64 %i.ul
  %invariant.gep157.i255.us.a = getelementptr inbounds nuw [8 x i8], ptr %.1124.i253.us, i64 %i.tn
  %invariant.gep157.i255.us = getelementptr inbounds nuw [8 x i8], ptr %.1124.i253.us, i64 %i.to
  %scevgep813.a = getelementptr i8, ptr %invariant.gep1130, i64 %i.ul
  %bound0814 = icmp ult ptr %scevgep808, %scevgep813
  %bound1815 = icmp ult ptr %scevgep812, %scevgep813.a
...
.preheader119.i256.us:                            ; preds = %middle.block828, %.preheader120.i252.us
  ...
  %gep.i258.us = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep157.i255.us.a, i64 %indvars.iv138.i257.us ; 4 uses
  %gep158.i259.us = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep157.i255.us, i64 %indvars.iv138.i257.us ; 4 uses
...
bb.ba:                                            ; preds = %bb.az
  ...
  %spec.select117.i.us = call i32 @llvm.smin.i32(i32 range(i32 -2147483648, 15) %i.abq, i32 range(i32 -2147483648, 14) %.038.i.i159.us) ; 10 uses
...
.preheader120.lr.ph.i.us:                         ; preds = %bb.bb
  ...
  %umin = zext i1 %i.add to i64                   ; 3 uses
  %i.ade = or disjoint i64 %umin, %i.acz
  %i.adf = sub nsw i64 %umax, %i.ade              ; 2 uses
  %22 = shl nuw nsw i64 %i.ada, 4
  %23 = shl nuw nsw i64 %i.adb, 3                 ; 2 uses
  ...
  %i.ads = getelementptr i8, ptr %i.c, i64 %23
  %i.adt = getelementptr i8, ptr %i.c, i64 %i.adn
  %i.adu = getelementptr i8, ptr %i.adt, i64 %23
  %i.adv = getelementptr i8, ptr %i.adu, i64 %i.adc
  %min.iters.check698 = icmp ult i32 %i.acu, 4
  %24 = add nsw i32 %spec.select117.i.us, -5
  %25 = zext nneg i32 %24 to i64
  %26 = lshr i64 %i.adf, %25
  %27 = add i64 %26, %umin
  %28 = shl i64 %27, 3
  %29 = add nsw i32 %spec.select117.i.us, -5
  %30 = zext nneg i32 %29 to i64
  %31 = shl i64 %28, %30
  %i.adw = getelementptr i8, ptr %i.c, i64 %31
  %invariant.gep1134 = getelementptr i8, ptr %i.adw, i64 %22
...
.preheader120.i.us:                               ; preds = %bb.bc, %.preheader120.lr.ph.i.us
  ...
  %scevgep696 = getelementptr i8, ptr %i.adv, i64 %i.ady
  %invariant.gep157.i.us.a = getelementptr inbounds nuw [8 x i8], ptr %.1124.i.us, i64 %i.ada
  %invariant.gep157.i.us = getelementptr inbounds nuw [8 x i8], ptr %.1124.i.us, i64 %i.adb
  %scevgep696.a = getelementptr i8, ptr %invariant.gep1134, i64 %i.ady
  %bound0 = icmp ult ptr %scevgep, %scevgep696
  %bound1 = icmp ult ptr %scevgep695, %scevgep696.a
...
.preheader119.i.us:                               ; preds = %middle.block708, %.preheader120.i.us
  ...
  %gep.i.us = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep157.i.us.a, i64 %indvars.iv138.i.us ; 4 uses
  %gep158.i.us = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep157.i.us, i64 %indvars.iv138.i.us ; 4 uses
