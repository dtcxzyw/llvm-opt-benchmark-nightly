...
bb.e:                                             ; preds = %.lr.ph112.us, %bb.e
  ...
  %i.ax = and i32 %i.aq, %5
  %.not97.us = icmp eq i32 %i.ax, 0
  %3 = and i32 %i.aw, %5
  %.not98.us = icmp eq i32 %3, 0
  %4 = select i1 %.not97.us, i32 49, i32 45
  %i.ay = select i1 %.not98.us, i32 48, i32 %4
...
.lr.ph112.us:                                     ; preds = %.preheader.us
  ...
  %i.bk = and i32 %.2113.us, 31
  %5 = shl nuw i32 1, %i.bk                       ; 2 uses
  br label %bb.e
