...
bb.b:                                             ; preds = %bb.f, %.preheader78.us.us.us
  ...
  %i.ab = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %indvars.iv116.a
...
bb.f:                                             ; preds = %.sink.split, %bb.c
  %indvars.iv.next117 = add nuw nsw i64 %indvars.iv116.a, 1 ; 2 uses
...
bb.g:                                             ; preds = %bb.k, %.preheader78.us.us.us.1
  ...
  %i.at = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %indvars.iv116.1.a
  %i.au = load i32, ptr %i.at, align 4, !tbaa !75
  %i.av = sext i32 %i.au to i64
  %i.aw = getelementptr inbounds i8, ptr %i.aq, i64 %i.av ; 2 uses
  %i.ax = load i8, ptr %i.aw, align 1, !tbaa !66  ; 4 uses
  %i.ay = add i8 %i.ax, -65
  %or.cond.us.us.us.1 = icmp ult i8 %i.ay, 26
  br i1 %or.cond.us.us.us.1, label %bb.j, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.az = add i8 %i.ax, -97
  %or.cond75.us.us.us.1 = icmp ult i8 %i.az, 26
  br i1 %or.cond75.us.us.us.1, label %bb.i, label %bb.k

bb.i:                                             ; preds = %bb.h
  %narrow.us.us.us.1 = add nsw i8 %i.ax, -32
  br label %.sink.split147

bb.j:                                             ; preds = %bb.g
  %i.ba = or disjoint i8 %i.ax, 32
  br label %.sink.split147

.sink.split147:                                   ; preds = %bb.i, %bb.j
  %.sink148 = phi i8 [ %i.ba, %bb.j ], [ %narrow.us.us.us.1, %bb.i ]
  store i8 %.sink148, ptr %i.aw, align 1, !tbaa !66
  br label %bb.k

bb.k:                                             ; preds = %.sink.split147, %bb.h
  %indvars.iv.next117.1 = add nuw nsw i64 %indvars.iv116.1.a, 1 ; 2 uses
...
._crit_edge83.us.us.us.1:                         ; preds = %bb.k
  ...
  %i.bg = load i8, ptr %i.be, align 1, !tbaa !66
...
.preheader78.us90:                                ; preds = %.preheader78.us90, %.preheader78.lr.ph.us.preheader.new
  ...
  %i.bi = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %indvars.iv128
  %i.bj = load i32, ptr %i.bi, align 4, !tbaa !75
  %i.bk = sext i32 %i.bj to i64
  %i.bl = getelementptr inbounds i8, ptr %3, i64 %i.bk ; 3 uses
  ...
  store i8 %i.bo, ptr %i.bl, align 1, !tbaa !66
  store i8 %i.bn, ptr %i.bm, align 1, !tbaa !66
  %i.bp = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %indvars.iv128
  %i.bq = getelementptr inbounds nuw i8, ptr %i.bp, i64 4
  %i.br = load i32, ptr %i.bq, align 4, !tbaa !75
  %i.bs = sext i32 %i.br to i64
  %i.bt = getelementptr inbounds i8, ptr %3, i64 %i.bs ; 3 uses
  %i.bu = getelementptr inbounds nuw i8, ptr %i.bt, i64 1 ; 2 uses
  %i.bv = load i8, ptr %i.bt, align 1, !tbaa !66
  %i.bw = load i8, ptr %i.bu, align 1, !tbaa !66
  store i8 %i.bw, ptr %i.bt, align 1, !tbaa !66
  store i8 %i.bv, ptr %i.bu, align 1, !tbaa !66
...
.preheader78.us90.epil.preheader:                 ; preds = %._crit_edge86.split.us92.unr-lcssa, %.preheader78.lr.ph.us.preheader
  ...
  %i.bx = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %indvars.iv128.epil.init
  %i.by = load i32, ptr %i.bx, align 4, !tbaa !75
  %i.bz = sext i32 %i.by to i64
  %i.ca = getelementptr inbounds i8, ptr %3, i64 %i.bz ; 3 uses
  %i.cb = getelementptr inbounds nuw i8, ptr %i.ca, i64 1 ; 2 uses
  %i.cc = load i8, ptr %i.ca, align 1, !tbaa !66
  %i.cd = load i8, ptr %i.cb, align 1, !tbaa !66
  store i8 %i.cd, ptr %i.ca, align 1, !tbaa !66
  store i8 %i.cc, ptr %i.cb, align 1, !tbaa !66
...
._crit_edge86.split.us92:                         ; preds = %._crit_edge86.split.us92.unr-lcssa, %.preheader78.us90.epil.preheader
  ...
  %i.ce = icmp eq i64 %i.w, 0
  br i1 %i.ce, label %.preheader78.us90.1.epil.preheader, label %._crit_edge86.split.us92.new
...
.preheader78.us90.1:                              ; preds = %.preheader78.us90.1, %._crit_edge86.split.us92.new
  ...
  %i.cf = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %indvars.iv128.1
  %i.cg = load i32, ptr %i.cf, align 4, !tbaa !75
  %i.ch = sext i32 %i.cg to i64
  %i.ci = getelementptr inbounds i8, ptr %3, i64 %i.ch ; 3 uses
  %i.cj = getelementptr inbounds nuw i8, ptr %i.ci, i64 1 ; 2 uses
  %i.ck = load i8, ptr %i.ci, align 1, !tbaa !66
  %i.cl = load i8, ptr %i.cj, align 1, !tbaa !66
  store i8 %i.cl, ptr %i.ci, align 1, !tbaa !66
  store i8 %i.ck, ptr %i.cj, align 1, !tbaa !66
  %i.cm = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %indvars.iv128.1
  %i.cn = getelementptr inbounds nuw i8, ptr %i.cm, i64 4
  %i.co = load i32, ptr %i.cn, align 4, !tbaa !75
  %i.cp = sext i32 %i.co to i64
  %i.cq = getelementptr inbounds i8, ptr %3, i64 %i.cp ; 3 uses
  %i.cr = getelementptr inbounds nuw i8, ptr %i.cq, i64 1 ; 2 uses
  %i.cs = load i8, ptr %i.cq, align 1, !tbaa !66
  %i.ct = load i8, ptr %i.cr, align 1, !tbaa !66
  store i8 %i.ct, ptr %i.cq, align 1, !tbaa !66
  store i8 %i.cs, ptr %i.cr, align 1, !tbaa !66
...
.preheader78.us90.1.epil.preheader:               ; preds = %.split106.loopexit.unr-lcssa, %._crit_edge86.split.us92
  ...
  %i.de = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %indvars.iv128.1.epil.init
  %i.df = load i32, ptr %i.de, align 4, !tbaa !75
  %i.dg = sext i32 %i.df to i64
  %i.dh = getelementptr inbounds i8, ptr %3, i64 %i.dg ; 3 uses
  %i.di = getelementptr inbounds nuw i8, ptr %i.dh, i64 1 ; 2 uses
  %i.dj = load i8, ptr %i.dh, align 1, !tbaa !66
  %i.dk = load i8, ptr %i.di, align 1, !tbaa !66
  store i8 %i.dk, ptr %i.dh, align 1, !tbaa !66
...
bb.h:                                             ; preds = %.epil.preheader
  %i.bt = add nsw i32 %.018.i.epil.init, 1
  %i.bu = sext i32 %.018.i.epil.init to i64
  %i.bv = getelementptr inbounds [8 x i8], ptr %.val16.i, i64 %i.bu
  store i64 %i.bq, ptr %i.bv, align 8, !tbaa !158
