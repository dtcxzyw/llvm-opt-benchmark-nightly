...
bb.o:                                             ; preds = %bb.n
  ...
  %i.at = shl i32 %indvars.iv191.tr, 1
...
bb.s:                                             ; preds = %.lr.ph170
  ...
  %i.bf = shl i32 %indvars.iv225.tr, 1
...
bb.ao:                                            ; preds = %.lr.ph180
  ...
  %i.dc = shl i32 %indvars.iv236.tr, 1
...
bb.u:                                             ; preds = %bb.q
  ...
  %i.bz = shl i32 %indvars.iv405.tr, 1
...
bb.ad:                                            ; preds = %bb.z
  ...
  %i.da = shl i32 %indvars.iv408.tr, 1
...
bb.dt:                                            ; preds = %bb.dp
  ...
  %indvars.iv423.tr = trunc i64 %indvars.iv423 to i32
  %i.lz = shl i32 %indvars.iv423.tr, 1
...
bb.eb:                                            ; preds = %bb.dx
  ...
  %i.mn = shl i32 %indvars.iv421.tr, 1
...
bb.ex:                                            ; preds = %bb.et
  ...
  %i.on = shl i32 %indvars.iv434.tr, 1
...
bb.t:                                             ; preds = %bb.p
  ...
  %indvars.iv405.tr = trunc i64 %indvars.iv405 to i32
  %i.cm = shl i32 %indvars.iv405.tr, 1
...
bb.da:                                            ; preds = %bb.cw
  ...
  %i.mv = shl i32 %indvars.iv415.tr, 1
...
bb.ei:                                            ; preds = %bb.ee
  ...
  %i.rd = shl i32 %indvars.iv424.tr, 1
...
bb.t:                                             ; preds = %bb.p
  ...
  %indvars.iv401.tr = trunc i64 %indvars.iv401 to i32
  %i.ce = shl i32 %indvars.iv401.tr, 1
...
bb.da:                                            ; preds = %bb.cw
  ...
  %indvars.iv411.tr = trunc i64 %indvars.iv411 to i32
  %i.mn = shl i32 %indvars.iv411.tr, 1
...
bb.ei:                                            ; preds = %bb.ee
  ...
  %indvars.iv420.tr = trunc i64 %indvars.iv420 to i32
  %i.qv = shl i32 %indvars.iv420.tr, 1
...
bb.r:                                             ; preds = %bb.n
  ...
  %indvars.iv354.tr = trunc i64 %indvars.iv354 to i32
  %i.bo = shl i32 %indvars.iv354.tr, 1
...
bb.cg:                                            ; preds = %bb.cc
  ...
  %indvars.iv360.tr = trunc i64 %indvars.iv360 to i32
  %i.js = shl i32 %indvars.iv360.tr, 1
...
bb.dg:                                            ; preds = %bb.df
  ...
  %i.nj = shl i32 %indvars.iv368.tr, 1
...
bb.r:                                             ; preds = %bb.n
  ...
  %indvars.iv355.tr = trunc i64 %indvars.iv355 to i32
  %i.bm = shl i32 %indvars.iv355.tr, 1
...
bb.cg:                                            ; preds = %bb.cc
  ...
  %indvars.iv361.tr = trunc i64 %indvars.iv361 to i32
  %i.jr = shl i32 %indvars.iv361.tr, 1
...
bb.df:                                            ; preds = %bb.de
  ...
  %indvars.iv369.tr = trunc i64 %indvars.iv369 to i32
  %i.nn = shl i32 %indvars.iv369.tr, 1
