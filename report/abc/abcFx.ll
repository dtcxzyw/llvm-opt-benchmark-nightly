...
begin_hunk_0_@Fx_ManUpdate:bb.a
  %i.aeg = load i32, ptr %i.aef, align 4, !tbaa !17 ; 5 uses
  %i.aeh = load i32, ptr %i.aee, align 8, !tbaa !18
...
bb.eh:                                            ; preds = %bb.eg
  ...
  %i.ael = load ptr, ptr %i.aek, align 8, !tbaa !19 ; 2 uses
...
bb.ei:                                            ; preds = %bb.eh
  ...
  %.pre.i.i615 = load i32, ptr %i.aee, align 8, !tbaa !18
...
Vec_WecGrow.exit.i616:                            ; preds = %bb.ej, %bb.ei
  ...
  store ptr %i.aep, ptr %i.aek, align 8, !tbaa !19
...
bb.ek:                                            ; preds = %bb.eg
  ...
  %i.aev = load ptr, ptr %i.aeu, align 8, !tbaa !19 ; 2 uses
...
bb.el:                                            ; preds = %bb.ek
  ...
  %.pre.i11.i613 = load i32, ptr %i.aee, align 8, !tbaa !18
  br label %bb.en
...
bb.en:                                            ; preds = %bb.em, %bb.el
  ...
  store ptr %i.afb, ptr %i.aeu, align 8, !tbaa !19
...
Vec_WecPushLevel.exit617.sink.split:              ; preds = %bb.en, %Vec_WecGrow.exit.i616
  ...
  store i32 %.sink1210, ptr %i.aee, align 8, !tbaa !18
  br label %Vec_WecPushLevel.exit617

Vec_WecPushLevel.exit617:                         ; preds = %Vec_WecPushLevel.exit617.sink.split, %Vec_IntPush.exit607
  %i.afh = load i32, ptr %i.aef, align 4, !tbaa !17
  %i.afi = add nsw i32 %i.afh, 1
  store i32 %i.afi, ptr %i.aef, align 4, !tbaa !17
  %i.afj = load ptr, ptr %i.gy, align 8, !tbaa !83 ; 9 uses
  %i.afk = getelementptr inbounds nuw i8, ptr %i.afj, i64 4 ; 3 uses
  %i.afl = load i32, ptr %i.afk, align 4, !tbaa !17 ; 5 uses
  %i.afm = load i32, ptr %i.afj, align 8, !tbaa !18
...
bb.ep:                                            ; preds = %bb.eo
  ...
  %i.afq = load ptr, ptr %i.afp, align 8, !tbaa !19 ; 2 uses
...
bb.eq:                                            ; preds = %bb.ep
  ...
  %.pre.i.i625 = load i32, ptr %i.afj, align 8, !tbaa !18
...
Vec_WecGrow.exit.i626:                            ; preds = %bb.er, %bb.eq
  ...
  store ptr %i.afu, ptr %i.afp, align 8, !tbaa !19
...
bb.et:                                            ; preds = %bb.es
  ...
  %.pre.i11.i623 = load i32, ptr %i.afj, align 8, !tbaa !18
  br label %bb.ev
...
bb.ev:                                            ; preds = %bb.eu, %bb.et
  ...
  store ptr %i.agi, ptr %i.agb, align 8, !tbaa !19
  ...
  store i32 %i.aga, ptr %i.afj, align 8, !tbaa !18
  br label %Vec_WecPushLevel.exit627
...
Vec_WecPushLevel.exit627:                         ; preds = %.Vec_WecGrow.exit12_crit_edge.i618, %Vec_WecGrow.exit.i626, %bb.ev
  ...
  %i.ago = load i32, ptr %i.afk, align 4, !tbaa !17
  %i.agp = add nsw i32 %i.ago, 1                  ; 2 uses
  store i32 %i.agp, ptr %i.afk, align 4, !tbaa !17
  ...
  %i.agt = load ptr, ptr %i.gy, align 8, !tbaa !83 ; 2 uses
  %i.agu = getelementptr i8, ptr %i.agt, i64 4
  %.val345 = load i32, ptr %i.agu, align 4, !tbaa !17
  %i.agv = getelementptr i8, ptr %i.agt, i64 8
  %.val361 = load ptr, ptr %i.agv, align 8, !tbaa !19
  ...
  %i.agz = load ptr, ptr %i.bm, align 8, !tbaa !77 ; 2 uses
  %i.aha = getelementptr i8, ptr %i.agz, i64 4
  %.val334927 = load i32, ptr %i.aha, align 4, !tbaa !45
...
bb.ew:                                            ; preds = %.lr.ph929, %Vec_IntPush.exit667
  ...
  %i.ahg = load ptr, ptr %0, align 8, !tbaa !76
  %i.ahh = getelementptr i8, ptr %i.ahf, i64 8
  %.val386 = load ptr, ptr %i.ahh, align 8, !tbaa !47
  %i.ahi = getelementptr inbounds nuw [4 x i8], ptr %.val386, i64 %indvars.iv1013
  %i.ahj = load i32, ptr %i.ahi, align 4, !tbaa !48
  %i.ahk = getelementptr i8, ptr %i.ahg, i64 8
  %.val360 = load ptr, ptr %i.ahk, align 8, !tbaa !19 ; 4 uses
...
bb.ex:                                            ; preds = %bb.ew
  ...
  %i.aho = load i32, ptr %i.ahn, align 4, !tbaa !45 ; 7 uses
...
.lr.ph.i629:                                      ; preds = %bb.ex
  ...
  %i.ahr = load ptr, ptr %i.ahq, align 8, !tbaa !47 ; 4 uses
...
bb.ey:                                            ; preds = %bb.ez, %.lr.ph.i629
  ...
  %i.aht = load i32, ptr %i.ahs, align 4, !tbaa !48
...
.lr.ph25.i:                                       ; preds = %.preheader.i634
  %i.ahy = shl nuw nsw i64 %indvar.i, 2
  %i.ahz = getelementptr nuw i8, ptr %i.ahr, i64 %i.ahy ; 2 uses
  %scevgep.i = getelementptr nuw i8, ptr %i.ahz, i64 4
  %scevgep29.i = getelementptr nuw i8, ptr %i.ahz, i64 8
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %scevgep.i, ptr noundef nonnull align 4 dereferenceable(1) %scevgep29.i, i64 %i.aif, i1 false), !tbaa !48
  %.pre.i635 = load i32, ptr %i.ahn, align 4, !tbaa !45
...
._crit_edge.i:                                    ; preds = %.lr.ph25.i, %.preheader.i634
  ...
  store i32 %i.aih, ptr %i.ahn, align 4, !tbaa !45
...
bb.fa:                                            ; preds = %bb.fb, %.lr.ph.i637
  ...
  %i.aik = load i32, ptr %i.aij, align 4, !tbaa !48
...
.lr.ph25.i647:                                    ; preds = %.preheader.i644
  %i.aip = shl nuw nsw i64 %indvar.i639, 2
  %i.aiq = getelementptr nuw i8, ptr %i.ahr, i64 %i.aip ; 2 uses
  %scevgep.i648 = getelementptr nuw i8, ptr %i.aiq, i64 4
  %scevgep29.i649 = getelementptr nuw i8, ptr %i.aiq, i64 8
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %scevgep.i648, ptr noundef nonnull align 4 dereferenceable(1) %scevgep29.i649, i64 %i.aiw, i1 false), !tbaa !48
  %.pre.i650 = load i32, ptr %i.ahn, align 4, !tbaa !45
...
._crit_edge.i646:                                 ; preds = %.lr.ph25.i647, %.preheader.i644
  ...
  store i32 %i.aiy, ptr %i.ahn, align 4, !tbaa !45
...
Vec_IntRemove1.exit651:                           ; preds = %bb.fb, %Vec_IntRemove1.exit, %bb.ex, %._crit_edge.i646
  ...
  %i.aja = load i32, ptr %i.ahm, align 8, !tbaa !46
...
bb.fd:                                            ; preds = %bb.fc
  ...
  %i.aje = load ptr, ptr %i.ajd, align 8, !tbaa !47 ; 2 uses
...
Vec_IntGrow.exit.i658:                            ; preds = %bb.ff, %bb.fe
  ...
  store ptr %i.ajh, ptr %i.ajd, align 8, !tbaa !47
...
bb.fh:                                            ; preds = %bb.fg
  ...
  %i.ajl = load ptr, ptr %i.ajk, align 8, !tbaa !47 ; 2 uses
...
bb.fk:                                            ; preds = %bb.fj, %bb.fi
  ...
  store ptr %i.ajq, ptr %i.ajk, align 8, !tbaa !47
  br label %Vec_IntGrow.exit11.sink.split.i655
...
Vec_IntGrow.exit11.sink.split.i655:               ; preds = %bb.fk, %Vec_IntGrow.exit.i658
  ...
  store i32 %spec.select.sink.i656, ptr %i.ahm, align 8, !tbaa !46
  %.pre1059 = load i32, ptr %i.ahn, align 4, !tbaa !45
...
Vec_IntPush.exit659:                              ; preds = %Vec_IntRemove1.exit651, %bb.fg, %Vec_IntGrow.exit11.sink.split.i655
  ...
  %i.ajt = load ptr, ptr %i.ajs, align 8, !tbaa !47
  %i.aju = add nsw i32 %i.ajr, 1
  store i32 %i.aju, ptr %i.ahn, align 4, !tbaa !45
  %i.ajv = sext i32 %i.ajr to i64
  %i.ajw = getelementptr inbounds [4 x i8], ptr %i.ajt, i64 %i.ajv
  store i32 %i.ahc, ptr %i.ajw, align 4, !tbaa !48
  ...
  %i.akc = load i32, ptr %i.ahd, align 4, !tbaa !45 ; 7 uses
  %i.akd = load i32, ptr %i.agy, align 8, !tbaa !46
...
Vec_IntPush.exit659.Vec_IntPush.exit667_crit_edge: ; preds = %Vec_IntPush.exit659
  %.pre1063 = load ptr, ptr %i.ahe, align 8, !tbaa !47
...
bb.fm:                                            ; preds = %bb.fl
  %i.akg = load ptr, ptr %i.ahe, align 8, !tbaa !47 ; 2 uses
...
bb.fp:                                            ; preds = %bb.fl
  ...
  %.pre1064 = load ptr, ptr %i.ahe, align 8, !tbaa !47 ; 3 uses
...
Vec_IntGrow.exit11.sink.split.i663:               ; preds = %bb.fr, %bb.fs, %bb.fn, %bb.fo
  ...
  store ptr %i.akp, ptr %i.ahe, align 8, !tbaa !47
  store i32 %spec.select.sink.i664, ptr %i.agy, align 8, !tbaa !46
  %.pre1065 = load i32, ptr %i.ahd, align 4, !tbaa !45
  br label %Vec_IntPush.exit667
...
Vec_IntPush.exit667:                              ; preds = %Vec_IntPush.exit659.Vec_IntPush.exit667_crit_edge, %bb.fp, %Vec_IntGrow.exit11.sink.split.i663
  ...
  store i32 %i.aks, ptr %i.ahd, align 4, !tbaa !45
  %i.akt = sext i32 %i.akq to i64
  %i.aku = getelementptr inbounds [4 x i8], ptr %i.akr, i64 %i.akt
  store i32 %i.akb, ptr %i.aku, align 4, !tbaa !48
  %i.akv = load i32, ptr %i.aeb, align 4, !tbaa !94
  %i.akw = add nsw i32 %i.akv, -1
  store i32 %i.akw, ptr %i.aeb, align 4, !tbaa !94
  %indvars.iv.next1014 = add nuw nsw i64 %indvars.iv1013, 1 ; 2 uses
  %i.akx = load ptr, ptr %i.bm, align 8, !tbaa !77 ; 2 uses
  %i.aky = getelementptr i8, ptr %i.akx, i64 4
  %.val334 = load i32, ptr %i.aky, align 4, !tbaa !45
...
.critedge8:                                       ; preds = %Vec_IntPush.exit667, %bb.ew, %Vec_WecPushLevel.exit627, %bb.au
  ...
  store i32 0, ptr %i.alb, align 4, !tbaa !211
  %i.alc = load ptr, ptr %i.ij, align 8, !tbaa !78 ; 4 uses
  %i.ald = getelementptr i8, ptr %i.alc, i64 4
  %.val333932 = load i32, ptr %i.ald, align 4, !tbaa !45
...
bb.ft:                                            ; preds = %.lr.ph935, %bb.hr
  ...
  %i.alo = load ptr, ptr %i.il, align 8, !tbaa !79
  %i.alp = lshr exact i64 %indvars.iv1018, 1
  %i.alq = getelementptr i8, ptr %i.alo, i64 8
  %.val385 = load ptr, ptr %i.alq, align 8, !tbaa !47
  %i.alr = getelementptr inbounds nuw [4 x i8], ptr %.val385, i64 %i.alp
  %i.als = load i32, ptr %i.alr, align 4, !tbaa !48 ; 3 uses
  %i.alt = load i32, ptr %i.alb, align 4, !tbaa !211
  %i.alu = add nsw i32 %i.alt, %i.als
  store i32 %i.alu, ptr %i.alb, align 4, !tbaa !211
  ...
  %i.ama = load i32, ptr %i.alz, align 4, !tbaa !48
...
.lr.ph.i670:                                      ; preds = %bb.ft
  %.val16.i671 = load ptr, ptr %i.alf, align 8, !tbaa !47 ; 2 uses
  ...
  %.pre.i672 = load i32, ptr %i.amf, align 4, !tbaa !45 ; 2 uses
  br label %bb.fu
...
bb.fu:                                            ; preds = %Vec_IntRemove1.exit32.i, %.lr.ph.i670
  ...
  %i.amk = load i32, ptr %i.amj, align 4, !tbaa !48
...
.lr.ph.i.i:                                       ; preds = %bb.fu
  %i.amr = load ptr, ptr %i.amg, align 8, !tbaa !47 ; 2 uses
...
bb.fv:                                            ; preds = %bb.fw, %.lr.ph.i.i
  ...
  %i.amt = load i32, ptr %i.ams, align 4, !tbaa !48
...
.lr.ph25.i.i:                                     ; preds = %.preheader.i.i
  %i.amx = shl nuw nsw i64 %indvar.i.i, 2
  %i.amy = getelementptr nuw i8, ptr %i.amr, i64 %i.amx ; 2 uses
  %scevgep.i.i = getelementptr nuw i8, ptr %i.amy, i64 4
  %scevgep29.i.i = getelementptr nuw i8, ptr %i.amy, i64 8
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %scevgep.i.i, ptr noundef nonnull align 4 dereferenceable(1) %scevgep29.i.i, i64 %i.ane, i1 false), !tbaa !48
  %.pre.i.i677 = load i32, ptr %i.amf, align 4, !tbaa !45
...
._crit_edge.i.i:                                  ; preds = %.lr.ph25.i.i, %.preheader.i.i
  ...
  store i32 %i.ang, ptr %i.amf, align 4, !tbaa !45
...
.lr.ph.i18.i:                                     ; preds = %bb.fx
  %i.anl = load ptr, ptr %i.amg, align 8, !tbaa !47 ; 2 uses
...
bb.fy:                                            ; preds = %bb.fz, %.lr.ph.i18.i
  ...
  %i.ann = load i32, ptr %i.anm, align 4, !tbaa !48
...
.lr.ph25.i28.i:                                   ; preds = %.preheader.i25.i
  %i.ans = shl nuw nsw i64 %indvar.i20.i, 2
  %i.ant = getelementptr nuw i8, ptr %i.anl, i64 %i.ans ; 2 uses
  %scevgep.i29.i = getelementptr nuw i8, ptr %i.ant, i64 4
  %scevgep29.i30.i = getelementptr nuw i8, ptr %i.ant, i64 8
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %scevgep.i29.i, ptr noundef nonnull align 4 dereferenceable(1) %scevgep29.i30.i, i64 %i.anz, i1 false), !tbaa !48
  %.pre.i31.i = load i32, ptr %i.amf, align 4, !tbaa !45
...
._crit_edge.i27.i:                                ; preds = %.lr.ph25.i28.i, %.preheader.i25.i
  ...
  store i32 %i.aob, ptr %i.amf, align 4, !tbaa !45
...
Vec_IntRemove1.exit32.i:                          ; preds = %bb.fz, %bb.fx, %._crit_edge.i27.i, %Vec_IntRemove1.exit.i
  ...
  br i1 %i.aof, label %bb.fu, label %Fx_ManDivRemoveLits.exit, !llvm.loop !195
...
.lr.ph.i681:                                      ; preds = %Fx_ManDivRemoveLits.exit
  ...
  %.pre.i683 = load i32, ptr %i.aoh, align 4, !tbaa !45 ; 2 uses
  br label %bb.ga
...
bb.ga:                                            ; preds = %Vec_IntRemove1.exit32.i696, %.lr.ph.i681
  ...
  %i.aom = load i32, ptr %i.aol, align 4, !tbaa !48
...
.lr.ph.i.i714:                                    ; preds = %bb.ga
  %i.aot = load ptr, ptr %i.aoi, align 8, !tbaa !47 ; 2 uses
...
bb.gb:                                            ; preds = %bb.gc, %.lr.ph.i.i714
  ...
  %i.aov = load i32, ptr %i.aou, align 4, !tbaa !48
...
.lr.ph25.i.i725:                                  ; preds = %.preheader.i.i721
  %i.aoz = shl nuw nsw i64 %indvar.i.i716, 2
  %i.apa = getelementptr nuw i8, ptr %i.aot, i64 %i.aoz ; 2 uses
  %scevgep.i.i726 = getelementptr nuw i8, ptr %i.apa, i64 4
  %scevgep29.i.i727 = getelementptr nuw i8, ptr %i.apa, i64 8
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %scevgep.i.i726, ptr noundef nonnull align 4 dereferenceable(1) %scevgep29.i.i727, i64 %i.apg, i1 false), !tbaa !48
  %.pre.i.i728 = load i32, ptr %i.aoh, align 4, !tbaa !45
...
._crit_edge.i.i723:                               ; preds = %.lr.ph25.i.i725, %.preheader.i.i721
  ...
  store i32 %i.api, ptr %i.aoh, align 4, !tbaa !45
...
.lr.ph.i18.i699:                                  ; preds = %bb.gd
  %i.apn = load ptr, ptr %i.aoi, align 8, !tbaa !47 ; 2 uses
...
bb.ge:                                            ; preds = %bb.gf, %.lr.ph.i18.i699
  ...
  %i.app = load i32, ptr %i.apo, align 4, !tbaa !48
...
.lr.ph25.i28.i710:                                ; preds = %.preheader.i25.i706
  %i.apu = shl nuw nsw i64 %indvar.i20.i701, 2
  %i.apv = getelementptr nuw i8, ptr %i.apn, i64 %i.apu ; 2 uses
  %scevgep.i29.i711 = getelementptr nuw i8, ptr %i.apv, i64 4
  %scevgep29.i30.i712 = getelementptr nuw i8, ptr %i.apv, i64 8
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %scevgep.i29.i711, ptr noundef nonnull align 4 dereferenceable(1) %scevgep29.i30.i712, i64 %i.aqb, i1 false), !tbaa !48
  %.pre.i31.i713 = load i32, ptr %i.aoh, align 4, !tbaa !45
...
._crit_edge.i27.i708:                             ; preds = %.lr.ph25.i28.i710, %.preheader.i25.i706
  ...
  store i32 %i.aqd, ptr %i.aoh, align 4, !tbaa !45
...
Vec_IntRemove1.exit32.i696:                       ; preds = %bb.gf, %bb.gd, %._crit_edge.i27.i708, %Vec_IntRemove1.exit.i688
  ...
  br i1 %i.aqh, label %bb.ga, label %Fx_ManDivRemoveLits.exit729.loopexit, !llvm.loop !195
...
bb.gg:                                            ; preds = %Fx_ManDivRemoveLits.exit729
  ...
  %i.aql = load i32, ptr %i.aqk, align 4, !tbaa !45 ; 13 uses
  %i.aqm = load i32, ptr %i.aly, align 8, !tbaa !46
...
bb.gj:                                            ; preds = %bb.gi
  ...
  %i.aqq = load ptr, ptr %i.aqp, align 8, !tbaa !47 ; 2 uses
...
Vec_IntGrow.exit.i736:                            ; preds = %bb.gl, %bb.gk
  ...
  store ptr %i.aqt, ptr %i.aqp, align 8, !tbaa !47
...
bb.gn:                                            ; preds = %bb.gm
  ...
  %i.aqx = load ptr, ptr %i.aqw, align 8, !tbaa !47 ; 2 uses
...
bb.gq:                                            ; preds = %bb.gp, %bb.go
  ...
  store ptr %i.arc, ptr %i.aqw, align 8, !tbaa !47
  br label %Vec_IntGrow.exit11.sink.split.i733
...
Vec_IntGrow.exit11.sink.split.i733:               ; preds = %bb.gq, %Vec_IntGrow.exit.i736
  ...
  store i32 %spec.select.sink.i734, ptr %i.aly, align 8, !tbaa !46
  %.pre1077 = load i32, ptr %i.aqk, align 4, !tbaa !45
...
Vec_IntPush.exit737:                              ; preds = %bb.gh, %bb.gm, %Vec_IntGrow.exit11.sink.split.i733
  ...
  %i.arf = load ptr, ptr %i.are, align 8, !tbaa !47
  %i.arg = add nsw i32 %i.ard, 1
  store i32 %i.arg, ptr %i.aqk, align 4, !tbaa !45
  %i.arh = sext i32 %i.ard to i64
  %i.ari = getelementptr inbounds [4 x i8], ptr %i.arf, i64 %i.arh
  store i32 %i.alk, ptr %i.ari, align 4, !tbaa !48
  ...
  %i.aro = load i32, ptr %i.all, align 4, !tbaa !45 ; 7 uses
  %i.arp = load i32, ptr %.0298, align 8, !tbaa !46
...
Vec_IntPush.exit737.Vec_IntPush.exit745_crit_edge: ; preds = %Vec_IntPush.exit737
  %.pre1081 = load ptr, ptr %i.alm, align 8, !tbaa !47
...
bb.gs:                                            ; preds = %bb.gr
  %i.ars = load ptr, ptr %i.alm, align 8, !tbaa !47 ; 2 uses
...
bb.gv:                                            ; preds = %bb.gr
  ...
  %.pre1082 = load ptr, ptr %i.alm, align 8, !tbaa !47 ; 3 uses
...
Vec_IntGrow.exit11.sink.split.i741:               ; preds = %bb.gx, %bb.gy, %bb.gt, %bb.gu
  ...
  store ptr %i.asb, ptr %i.alm, align 8, !tbaa !47
  store i32 %spec.select.sink.i742, ptr %.0298, align 8, !tbaa !46
  %.pre1083 = load i32, ptr %i.all, align 4, !tbaa !45
  br label %Vec_IntPush.exit745
...
Vec_IntPush.exit745:                              ; preds = %Vec_IntPush.exit737.Vec_IntPush.exit745_crit_edge, %bb.gv, %Vec_IntGrow.exit11.sink.split.i741
  ...
  store i32 %i.ase, ptr %i.all, align 4, !tbaa !45
  %i.asf = sext i32 %i.asc to i64
  %i.asg = getelementptr inbounds [4 x i8], ptr %i.asd, i64 %i.asf
  store i32 %i.arn, ptr %i.asg, align 4, !tbaa !48
  br label %bb.hr
