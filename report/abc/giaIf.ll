...
begin_hunk_0_@Gia_ManFromIfGetConfig2:bb.a
  %niter623.next.1 = add i64 %niter623, 2         ; 2 uses
  %niter623.ncmp.1 = icmp eq i64 %niter623.next.1, %unroll_iter622
  br i1 %niter623.ncmp.1, label %._crit_edge.us.12.i.preheader.unr-lcssa, label %._crit_edge.us.11.i, !llvm.loop !302

._crit_edge.us.12.i.preheader.unr-lcssa:          ; preds = %._crit_edge.us.11.i
...
._crit_edge.us.12.i.preheader:                    ; preds = %._crit_edge.us.12.i.preheader.unr-lcssa, %._crit_edge.us.11.i.epil.preheader
  %.lcssa543 = phi i32 [ %i.lj, %._crit_edge.us.12.i.preheader.unr-lcssa ], [ %i.ls, %._crit_edge.us.11.i.epil.preheader ]
...
.split.i:                                         ; preds = %bb.ab
  %i.pk = trunc i64 %i.f to i16
  %i.pl = and i16 %i.pk, 1
  %i.pm = insertelement <3 x i16> poison, i16 %i.pl, i64 0
  %i.pn = shufflevector <3 x i16> %i.pm, <3 x i16> poison, <6 x i32> zeroinitializer
  %i.po = mul nuw <6 x i16> %i.pn, <i16 8192, i16 4096, i16 16384, i16 -32768, i16 126, i16 3969>
  %i.pp = tail call i16 @llvm.vector.reduce.or.v6i16(<6 x i16> %i.po)
...
Gia_ManFromIfPermuteTruth4.exit:                  ; preds = %.split.i, %._crit_edge.us.15.i, %._crit_edge327
  ...
  %i.pu = load i32, ptr %0, align 8, !tbaa !66
  %i.pv = icmp eq i32 %i.pt, %i.pu
  br i1 %i.pv, label %bb.ad, label %Gia_ManFromIfPermuteTruth4.exit.Vec_StrPush.exit145_crit_edge
...
bb.ad:                                            ; preds = %Gia_ManFromIfPermuteTruth4.exit
  %i.pw = icmp slt i32 %i.pt, 16
  br i1 %i.pw, label %bb.ae, label %bb.ah

bb.ae:                                            ; preds = %bb.ad
  %i.px = load ptr, ptr %i.y, align 8, !tbaa !62  ; 2 uses
  %.not9.i.i143 = icmp eq ptr %i.px, null
  br i1 %.not9.i.i143, label %bb.ag, label %bb.af

bb.af:                                            ; preds = %bb.ae
  %i.py = tail call dereferenceable_or_null(16) ptr @realloc(ptr noundef nonnull %i.px, i64 noundef 16) #30
  br label %Vec_StrGrow.exit11.sink.split.i141

bb.ag:                                            ; preds = %bb.ae
  %i.pz = tail call noalias dereferenceable_or_null(16) ptr @malloc(i64 noundef 16) #31
  br label %Vec_StrGrow.exit11.sink.split.i141

bb.ah:                                            ; preds = %bb.ad
  %i.qa = icmp samesign ult i32 %i.pt, 1073741823
  %i.qb = shl nuw nsw i32 %i.pt, 1
  %spec.select.i138 = select i1 %i.qa, i32 %i.qb, i32 2147483647 ; 4 uses
  %.not.i9.i139 = icmp samesign ult i32 %i.pt, %spec.select.i138
...
bb.ai:                                            ; preds = %bb.ah
  ...
  %i.qc = zext nneg i32 %spec.select.i138 to i64  ; 2 uses
  br i1 %.not9.i10.i140, label %bb.ak, label %bb.aj

bb.aj:                                            ; preds = %bb.ai
  %i.qd = tail call ptr @realloc(ptr noundef nonnull %.pre414, i64 noundef %i.qc) #30
  br label %Vec_StrGrow.exit11.sink.split.i141

bb.ak:                                            ; preds = %bb.ai
  %i.qe = tail call noalias ptr @malloc(i64 noundef %i.qc) #31
  br label %Vec_StrGrow.exit11.sink.split.i141

Vec_StrGrow.exit11.sink.split.i141:               ; preds = %bb.aj, %bb.ak, %bb.af, %bb.ag
  %storemerge295 = phi ptr [ %i.pz, %bb.ag ], [ %i.py, %bb.af ], [ %i.qd, %bb.aj ], [ %i.qe, %bb.ak ] ; 2 uses
...
Vec_StrPush.exit145:                              ; preds = %Gia_ManFromIfPermuteTruth4.exit.Vec_StrPush.exit145_crit_edge, %bb.ah, %Vec_StrGrow.exit11.sink.split.i141
  %i.qf = phi i32 [ %i.pt, %Gia_ManFromIfPermuteTruth4.exit.Vec_StrPush.exit145_crit_edge ], [ %i.pt, %bb.ah ], [ %.pre415, %Vec_StrGrow.exit11.sink.split.i141 ] ; 2 uses
  %i.qg = phi ptr [ %.pre413, %Gia_ManFromIfPermuteTruth4.exit.Vec_StrPush.exit145_crit_edge ], [ %.pre414, %bb.ah ], [ %storemerge295, %Vec_StrGrow.exit11.sink.split.i141 ]
  %i.qh = add nsw i32 %i.qf, 1
  store i32 %i.qh, ptr %i.b, align 4, !tbaa !67
  %i.qi = sext i32 %i.qf to i64
  %i.qj = getelementptr inbounds i8, ptr %i.qg, i64 %i.qi
  store i8 %i.ps, ptr %i.qj, align 1, !tbaa !63
  %i.qk = trunc i64 %.0110 to i8
  %i.ql = load i32, ptr %i.b, align 4, !tbaa !67  ; 7 uses
  %i.qm = load i32, ptr %0, align 8, !tbaa !66
  %i.qn = icmp eq i32 %i.ql, %i.qm
  br i1 %i.qn, label %bb.al, label %Vec_StrPush.exit145.Vec_StrPush.exit153_crit_edge
...
bb.al:                                            ; preds = %Vec_StrPush.exit145
  %i.qo = icmp slt i32 %i.ql, 16
  br i1 %i.qo, label %bb.am, label %bb.ap

bb.am:                                            ; preds = %bb.al
  %i.qp = load ptr, ptr %i.y, align 8, !tbaa !62  ; 2 uses
  %.not9.i.i151 = icmp eq ptr %i.qp, null
  br i1 %.not9.i.i151, label %bb.ao, label %bb.an

bb.an:                                            ; preds = %bb.am
  %i.qq = tail call dereferenceable_or_null(16) ptr @realloc(ptr noundef nonnull %i.qp, i64 noundef 16) #30
  br label %Vec_StrGrow.exit11.sink.split.i149

bb.ao:                                            ; preds = %bb.am
  %i.qr = tail call noalias dereferenceable_or_null(16) ptr @malloc(i64 noundef 16) #31
  br label %Vec_StrGrow.exit11.sink.split.i149

bb.ap:                                            ; preds = %bb.al
  %i.qs = icmp samesign ult i32 %i.ql, 1073741823
  %i.qt = shl nuw nsw i32 %i.ql, 1
  %spec.select.i146 = select i1 %i.qs, i32 %i.qt, i32 2147483647 ; 4 uses
  %.not.i9.i147 = icmp samesign ult i32 %i.ql, %spec.select.i146
...
bb.aq:                                            ; preds = %bb.ap
  ...
  %i.qu = zext nneg i32 %spec.select.i146 to i64  ; 2 uses
  br i1 %.not9.i10.i148, label %bb.as, label %bb.ar

bb.ar:                                            ; preds = %bb.aq
  %i.qv = tail call ptr @realloc(ptr noundef nonnull %.pre417, i64 noundef %i.qu) #30
  br label %Vec_StrGrow.exit11.sink.split.i149

bb.as:                                            ; preds = %bb.aq
  %i.qw = tail call noalias ptr @malloc(i64 noundef %i.qu) #31
  br label %Vec_StrGrow.exit11.sink.split.i149

Vec_StrGrow.exit11.sink.split.i149:               ; preds = %bb.ar, %bb.as, %bb.an, %bb.ao
  %storemerge296 = phi ptr [ %i.qr, %bb.ao ], [ %i.qq, %bb.an ], [ %i.qv, %bb.ar ], [ %i.qw, %bb.as ] ; 2 uses
...
Vec_StrPush.exit153:                              ; preds = %Vec_StrPush.exit145.Vec_StrPush.exit153_crit_edge, %bb.ap, %Vec_StrGrow.exit11.sink.split.i149
  %i.qx = phi i32 [ %i.ql, %Vec_StrPush.exit145.Vec_StrPush.exit153_crit_edge ], [ %i.ql, %bb.ap ], [ %.pre418, %Vec_StrGrow.exit11.sink.split.i149 ] ; 2 uses
  %i.qy = phi ptr [ %.pre416, %Vec_StrPush.exit145.Vec_StrPush.exit153_crit_edge ], [ %.pre417, %bb.ap ], [ %storemerge296, %Vec_StrGrow.exit11.sink.split.i149 ]
  %i.qz = add nsw i32 %i.qx, 1
  store i32 %i.qz, ptr %i.b, align 4, !tbaa !67
  %i.ra = sext i32 %i.qx to i64
  %i.rb = getelementptr inbounds i8, ptr %i.qy, i64 %i.ra
  store i8 %i.qk, ptr %i.rb, align 1, !tbaa !63
  br label %bb.gi

bb.at:                                            ; preds = %bb.a
  %i.rc = icmp sgt i64 %i.d, -1
  br i1 %i.rc, label %bb.au, label %bb.dy

bb.au:                                            ; preds = %bb.at
  %i.rd = load i32, ptr %i.b, align 4, !tbaa !67  ; 7 uses
  %i.re = load i32, ptr %0, align 8, !tbaa !66
  %i.rf = icmp eq i32 %i.rd, %i.re
  br i1 %i.rf, label %bb.av, label %Vec_StrPush.exit161

bb.av:                                            ; preds = %bb.au
  %i.rg = icmp slt i32 %i.rd, 16
  br i1 %i.rg, label %bb.aw, label %bb.az

bb.aw:                                            ; preds = %bb.av
  %i.rh = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
  %i.ri = load ptr, ptr %i.rh, align 8, !tbaa !62 ; 2 uses
  %.not9.i.i159 = icmp eq ptr %i.ri, null
  br i1 %.not9.i.i159, label %bb.ay, label %bb.ax

bb.ax:                                            ; preds = %bb.aw
  %i.rj = tail call dereferenceable_or_null(16) ptr @realloc(ptr noundef nonnull %i.ri, i64 noundef 16) #30
  br label %Vec_StrGrow.exit.i160

bb.ay:                                            ; preds = %bb.aw
  %i.rk = tail call noalias dereferenceable_or_null(16) ptr @malloc(i64 noundef 16) #31
  br label %Vec_StrGrow.exit.i160

Vec_StrGrow.exit.i160:                            ; preds = %bb.ay, %bb.ax
  %i.rl = phi ptr [ %i.rj, %bb.ax ], [ %i.rk, %bb.ay ]
  store ptr %i.rl, ptr %i.rh, align 8, !tbaa !62
  br label %Vec_StrGrow.exit11.sink.split.i157

bb.az:                                            ; preds = %bb.av
  %i.rm = icmp samesign ult i32 %i.rd, 1073741823
  %i.rn = shl nuw nsw i32 %i.rd, 1
  %spec.select.i154 = select i1 %i.rm, i32 %i.rn, i32 2147483647 ; 3 uses
  %.not.i9.i155 = icmp samesign ult i32 %i.rd, %spec.select.i154
...
bb.ba:                                            ; preds = %bb.az
  ...
  %.not9.i10.i156 = icmp eq ptr %i.rp, null
  %i.rq = zext nneg i32 %spec.select.i154 to i64  ; 2 uses
  br i1 %.not9.i10.i156, label %bb.bc, label %bb.bb

bb.bb:                                            ; preds = %bb.ba
  %i.rr = tail call ptr @realloc(ptr noundef nonnull %i.rp, i64 noundef %i.rq) #30
  br label %bb.bd

bb.bc:                                            ; preds = %bb.ba
  %i.rs = tail call noalias ptr @malloc(i64 noundef %i.rq) #31
  br label %bb.bd

bb.bd:                                            ; preds = %bb.bc, %bb.bb
  %i.rt = phi ptr [ %i.rr, %bb.bb ], [ %i.rs, %bb.bc ]
  store ptr %i.rt, ptr %i.ro, align 8, !tbaa !62
  br label %Vec_StrGrow.exit11.sink.split.i157
...
Vec_StrGrow.exit11.sink.split.i157:               ; preds = %bb.bd, %Vec_StrGrow.exit.i160
  ...
  store i32 %spec.select.sink.i158, ptr %0, align 8, !tbaa !66
  %.pre381 = load i32, ptr %i.b, align 4, !tbaa !67
  br label %Vec_StrPush.exit161

Vec_StrPush.exit161:                              ; preds = %bb.au, %bb.az, %Vec_StrGrow.exit11.sink.split.i157
  %i.ru = phi i32 [ %i.rd, %bb.au ], [ %i.rd, %bb.az ], [ %.pre381, %Vec_StrGrow.exit11.sink.split.i157 ] ; 2 uses
  %i.rv = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 33 uses
end_hunk_0
