...
vector.body328:                                   ; preds = %vector.body328, %vector.ph326
  ...
  %strided.vec332 = shufflevector <8 x i16> %wide.vec331, <8 x i16> poison, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %i.qr = and <4 x i16> %strided.vec, splat (i16 513)
  %i.qs = and <4 x i16> %strided.vec332, splat (i16 513)
  %3 = icmp eq <4 x i16> %i.qr, splat (i16 513)
  %4 = icmp eq <4 x i16> %i.qs, splat (i16 513)
  %5 = zext <4 x i1> %3 to <4 x i32>
  %6 = zext <4 x i1> %4 to <4 x i32>
  %i.qt = add <4 x i32> %vec.phi, %5              ; 2 uses
  %i.qu = add <4 x i32> %vec.phi330, %6           ; 2 uses
...
.lr.ph.i21.i:                                     ; preds = %.lr.ph.i21.i.preheader, %.lr.ph.i21.i
  ...
  %i.qy = load i16, ptr %i.qx, align 4
  %i.qz = and i16 %i.qy, 513
  %7 = icmp eq i16 %i.qz, 513
  %spec.select.i.i48 = zext i1 %7 to i32
  %.2.i23.i = add i32 %.0112.i.i, %spec.select.i.i48 ; 2 uses
...
vector.body376:                                   ; preds = %vector.body376, %vector.ph374
  ...
  %strided.vec383 = shufflevector <8 x i16> %wide.vec382, <8 x i16> poison, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %i.ave = and <4 x i16> %strided.vec381, splat (i16 513)
  %i.avf = and <4 x i16> %strided.vec383, splat (i16 513)
  %8 = icmp eq <4 x i16> %i.ave, splat (i16 513)
  %9 = icmp eq <4 x i16> %i.avf, splat (i16 513)
  %10 = zext <4 x i1> %8 to <4 x i32>
  %11 = zext <4 x i1> %9 to <4 x i32>
  %i.avg = add <4 x i32> %vec.phi378, %10         ; 2 uses
  %i.avh = add <4 x i32> %vec.phi379, %11         ; 2 uses
...
.lr.ph.i.i76:                                     ; preds = %.lr.ph.i.i76.preheader, %.lr.ph.i.i76
  ...
  %i.avm = and i16 %i.avl, 513
  %12 = icmp eq i16 %i.avm, 513
  %spec.select.i.i79 = zext i1 %12 to i32
  %.2.i.i80 = add i32 %.0112.i.i78, %spec.select.i.i79 ; 2 uses
