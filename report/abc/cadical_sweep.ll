...
.critedge:                                        ; preds = %bb.c, %.preheader46, %..critedge_crit_edge
  ...
  %wcslen = tail call i64 @wcslen(ptr nonnull %.sroa.035.0) ; 2 uses
  %i.j = shl i64 %wcslen, 2                       ; 2 uses
...
.critedge.i:                                      ; preds = %bb.cd, %.preheader46.i, %..critedge_crit_edge.i
  ...
  %wcslen.i = call i64 @wcslen(ptr nonnull %.sroa.035.0.i) ; 2 uses
  %i.lf = shl i64 %wcslen.i, 2                    ; 2 uses
...
.lr.ph54.i.preheader:                             ; preds = %.preheader.i
  %i.lk = add i64 %i.la, -8
  %10 = add i64 %indvar292, %wcslen.i
  %11 = shl i64 %10, 2
  %i.ll = add i64 %11, %.cast.i
...
.critedge.i156:                                   ; preds = %bb.cl, %.preheader46.i149, %..critedge_crit_edge.i154
  ...
  %wcslen.i159 = call i64 @wcslen(ptr nonnull %.sroa.035.0.i147) ; 2 uses
  %i.mx = shl i64 %wcslen.i159, 2                 ; 2 uses
...
.lr.ph54.i176.preheader:                          ; preds = %.preheader.i173
  %i.nc = add i64 %i.ms, -8
  %12 = add i64 %indvar, %wcslen.i159
  %13 = shl i64 %12, 2
  %i.nd = add i64 %13, %.cast.i150
