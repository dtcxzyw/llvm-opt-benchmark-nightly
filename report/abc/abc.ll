...
bb.fs:                                            ; preds = %bb.fr
  ...
  %i.oa = load ptr, ptr %i.nz, align 8, !tbaa !1285
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x float>, ptr %i.on, align 4, !tbaa !209, !alias.scope !1286, !noalias !1287
  %wide.load634 = load <4 x float>, ptr %i.oo, align 4, !tbaa !209, !alias.scope !1286, !noalias !1287
  %i.op = fadd <4 x float> %broadcast.splat, %wide.load
  %i.oq = fadd <4 x float> %broadcast.splat, %wide.load634
  store <4 x float> %i.op, ptr %i.on, align 4, !tbaa !209, !alias.scope !1286, !noalias !1287
  store <4 x float> %i.oq, ptr %i.oo, align 4, !tbaa !209, !alias.scope !1286, !noalias !1287
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.or = icmp eq i64 %index.next, %n.vec
  br i1 %i.or, label %middle.block, label %vector.body, !llvm.loop !1263
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  ...
  br i1 %prol.iter.cmp.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol, !llvm.loop !1264
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  br i1 %exitcond.not.3, label %.loopexit656, label %scalar.ph, !llvm.loop !1265
...
.loopexit656:                                     ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  ...
  br i1 %exitcond576.not, label %.loopexit558, label %.preheader556, !llvm.loop !1266
...
vector.body645:                                   ; preds = %vector.body645, %vector.ph643
  ...
  %wide.load647 = load <4 x float>, ptr %i.qd, align 4, !tbaa !209, !alias.scope !1289, !noalias !1290
  %wide.load648 = load <4 x float>, ptr %i.qe, align 4, !tbaa !209, !alias.scope !1289, !noalias !1290
  %i.qf = fsub <4 x float> %wide.load647, %broadcast.splat650
  %i.qg = fsub <4 x float> %wide.load648, %broadcast.splat650
  store <4 x float> %i.qf, ptr %i.qd, align 4, !tbaa !209, !alias.scope !1289, !noalias !1290
  store <4 x float> %i.qg, ptr %i.qe, align 4, !tbaa !209, !alias.scope !1289, !noalias !1290
  %index.next651 = add nuw i64 %index646, 8       ; 2 uses
  %i.qh = icmp eq i64 %index.next651, %n.vec644
  br i1 %i.qh, label %middle.block652, label %vector.body645, !llvm.loop !1270
...
scalar.ph641.prol:                                ; preds = %scalar.ph641.preheader, %scalar.ph641.prol
  ...
  br i1 %prol.iter659.cmp.not, label %scalar.ph641.prol.loopexit, label %scalar.ph641.prol, !llvm.loop !1271
...
scalar.ph641:                                     ; preds = %scalar.ph641.prol.loopexit, %scalar.ph641
  ...
  br i1 %exitcond582.not.3, label %.loopexit655, label %scalar.ph641, !llvm.loop !1272
...
.loopexit655:                                     ; preds = %scalar.ph641.prol.loopexit, %scalar.ph641, %middle.block652
  ...
  br i1 %exitcond591.not, label %.loopexit, label %.preheader, !llvm.loop !1273
...
bb.gc:                                            ; preds = %bb.gb, %bb.ga
  ...
  %i.rx = load i32, ptr %i.aq, align 8, !tbaa !1275
  ...
  %i.sl = load i32, ptr %i.af, align 8, !tbaa !1276
