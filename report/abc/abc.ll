...
begin_hunk_0_@Abc_CommandAbc9If:bb.a
  ...
  store i32 %i.mh, ptr %i.n, align 4, !tbaa !199
  store ptr null, ptr %i.g, align 8, !tbaa !167
  br label %bb.es

bb.es:                                            ; preds = %bb.eq, %bb.er
  %i.mi = load i32, ptr %i.av, align 8, !tbaa !172 ; 2 uses
  %i.mj = icmp sgt i32 %i.mi, 0
  br i1 %i.mj, label %bb.et, label %bb.eu

bb.et:                                            ; preds = %bb.es
  %i.mk = getelementptr inbounds nuw i8, ptr %3, i64 232
  store i32 1, ptr %i.mk, align 8, !tbaa !207
  store i32 1, ptr %i.ac, align 4, !tbaa !189
  store i32 0, ptr %i.ag, align 8, !tbaa !186
  %i.ml = getelementptr inbounds nuw i8, ptr %3, i64 236
  store i32 1, ptr %i.ml, align 4, !tbaa !208
  store ptr null, ptr %i.g, align 8, !tbaa !167
  store i32 %i.mi, ptr %3, align 8, !tbaa !168
  br label %bb.eu

bb.eu:                                            ; preds = %bb.et, %bb.es
  %i.mm = load i32, ptr %i.n, align 4, !tbaa !199
...
bb.ev:                                            ; preds = %bb.eu
  ...
  store i32 1, ptr %i.mp, align 8, !tbaa !207
  store i32 1, ptr %i.ac, align 4, !tbaa !189
  store i32 0, ptr %i.ag, align 8, !tbaa !186
...
bb.ex:                                            ; preds = %bb.ew
  ...
  %i.mr = load i8, ptr %i.mq, align 1, !tbaa !99
  %i.ms = icmp eq i8 %i.mr, 0
  br i1 %i.ms, label %bb.ey, label %bb.ez

bb.ey:                                            ; preds = %bb.ex
  %i.mt = load i8, ptr %i.ky, align 1, !tbaa !99
...
bb.fd:                                            ; preds = %bb.fc
  %i.nb = load i32, ptr %3, align 8, !tbaa !168
...
bb.fi:                                            ; preds = %bb.fh
  %i.nh = load i32, ptr %3, align 8, !tbaa !168   ; 2 uses
...
.critedge540:                                     ; preds = %bb.eu, %bb.fk, %bb.ff, %bb.ev
  %i.nl = load i32, ptr %i.w, align 8, !tbaa !194
...
bb.fp:                                            ; preds = %.critedge540._crit_edge, %bb.fn
  ...
  %i.nu = load i32, ptr %i.nt, align 8, !tbaa !207
...
bb.fu:                                            ; preds = %bb.fs, %bb.fr
  %i.oc = load float, ptr %i.an, align 4, !tbaa !181
...
.preheader557:                                    ; preds = %bb.fu
  ...
  %i.og = load i32, ptr %i.of, align 8, !tbaa !204 ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x float>, ptr %i.on, align 4, !tbaa !209, !alias.scope !1285, !noalias !1286
  %wide.load634 = load <4 x float>, ptr %i.oo, align 4, !tbaa !209, !alias.scope !1285, !noalias !1286
  %i.op = fadd <4 x float> %broadcast.splat, %wide.load
  %i.oq = fadd <4 x float> %broadcast.splat, %wide.load634
  store <4 x float> %i.op, ptr %i.on, align 4, !tbaa !209, !alias.scope !1285, !noalias !1286
  store <4 x float> %i.oq, ptr %i.oo, align 4, !tbaa !209, !alias.scope !1285, !noalias !1286
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.or = icmp eq i64 %index.next, %n.vec
  br i1 %i.or, label %middle.block, label %vector.body, !llvm.loop !1262
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  ...
  %i.ot = load float, ptr %i.an, align 4, !tbaa !181
  %i.ou = getelementptr inbounds nuw [4 x i8], ptr %i.oj, i64 %indvars.iv.prol ; 2 uses
  %i.ov = load float, ptr %i.ou, align 4, !tbaa !209
  %i.ow = fadd float %i.ot, %i.ov
  store float %i.ow, ptr %i.ou, align 4, !tbaa !209
  %indvars.iv.next.prol = add nuw nsw i64 %indvars.iv.prol, 1 ; 2 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol, !llvm.loop !1263
...
.loopexit656:                                     ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  ...
  br i1 %exitcond576.not, label %.loopexit558, label %.preheader556, !llvm.loop !1265
...
.loopexit558:                                     ; preds = %.loopexit656, %.preheader557, %bb.fu
  ...
  %i.ps = load float, ptr %i.an, align 4, !tbaa !181
...
.preheader555:                                    ; preds = %.loopexit558
  ...
  %i.pw = load i32, ptr %i.pv, align 8, !tbaa !204 ; 2 uses
...
vector.body645:                                   ; preds = %vector.body645, %vector.ph643
  ...
  %wide.load647 = load <4 x float>, ptr %i.qd, align 4, !tbaa !209, !alias.scope !1288, !noalias !1289
  %wide.load648 = load <4 x float>, ptr %i.qe, align 4, !tbaa !209, !alias.scope !1288, !noalias !1289
  %i.qf = fsub <4 x float> %wide.load647, %broadcast.splat650
  %i.qg = fsub <4 x float> %wide.load648, %broadcast.splat650
  store <4 x float> %i.qf, ptr %i.qd, align 4, !tbaa !209, !alias.scope !1288, !noalias !1289
  store <4 x float> %i.qg, ptr %i.qe, align 4, !tbaa !209, !alias.scope !1288, !noalias !1289
  %index.next651 = add nuw i64 %index646, 8       ; 2 uses
  %i.qh = icmp eq i64 %index.next651, %n.vec644
  br i1 %i.qh, label %middle.block652, label %vector.body645, !llvm.loop !1269
...
scalar.ph641.prol:                                ; preds = %scalar.ph641.preheader, %scalar.ph641.prol
  ...
  %i.qj = load float, ptr %i.an, align 4, !tbaa !181
  %i.qk = getelementptr inbounds nuw [4 x i8], ptr %i.pz, i64 %indvars.iv577.prol ; 2 uses
  %i.ql = load float, ptr %i.qk, align 4, !tbaa !209
  %i.qm = fsub float %i.ql, %i.qj
  store float %i.qm, ptr %i.qk, align 4, !tbaa !209
  ...
  br i1 %prol.iter659.cmp.not, label %scalar.ph641.prol.loopexit, label %scalar.ph641.prol, !llvm.loop !1270
...
scalar.ph641:                                     ; preds = %scalar.ph641.prol.loopexit, %scalar.ph641
  ...
  %i.qo = load float, ptr %i.an, align 4, !tbaa !181
  %i.qp = getelementptr inbounds nuw [4 x i8], ptr %i.pz, i64 %indvars.iv577 ; 2 uses
  %i.qq = load float, ptr %i.qp, align 4, !tbaa !209
  %i.qr = fsub float %i.qq, %i.qo
  store float %i.qr, ptr %i.qp, align 4, !tbaa !209
  %i.qs = load float, ptr %i.an, align 4, !tbaa !181
  ...
  %i.qv = load float, ptr %i.qu, align 4, !tbaa !209
  %i.qw = fsub float %i.qv, %i.qs
  store float %i.qw, ptr %i.qu, align 4, !tbaa !209
  %i.qx = load float, ptr %i.an, align 4, !tbaa !181
  ...
  %i.ra = load float, ptr %i.qz, align 4, !tbaa !209
  %i.rb = fsub float %i.ra, %i.qx
  store float %i.rb, ptr %i.qz, align 4, !tbaa !209
  %i.rc = load float, ptr %i.an, align 4, !tbaa !181
  ...
  %i.rf = load float, ptr %i.re, align 4, !tbaa !209
  %i.rg = fsub float %i.rf, %i.rc
  store float %i.rg, ptr %i.re, align 4, !tbaa !209
  ...
  br i1 %exitcond582.not.3, label %.loopexit655, label %scalar.ph641, !llvm.loop !1271
...
.loopexit655:                                     ; preds = %scalar.ph641.prol.loopexit, %scalar.ph641, %middle.block652
  ...
  br i1 %exitcond591.not, label %.loopexit, label %.preheader, !llvm.loop !1272
...
.threadthread-pre-split:                          ; preds = %bb.f, %bb.i, %bb.k, %bb.m, %bb.o, %bb.r, %bb.t, %bb.v, %bb.x, %bb.ae, %bb.ag, %bb.am, %bb.d, %bb.z, %.threadthread-pre-split.sink.split
  %.pr = load float, ptr %i.ap, align 8, !tbaa !179
  br label %.thread
...
bb.fz:                                            ; preds = %bb.fy, %bb.fx
  %i.rm = load i32, ptr %3, align 8, !tbaa !168   ; 2 uses
...
bb.gc:                                            ; preds = %bb.gb, %bb.ga
  ...
  %i.ry = load float, ptr %i.ao, align 4, !tbaa !180
  ...
  %i.sa = load float, ptr %i.an, align 4, !tbaa !181
  ...
  %i.sc = load ptr, ptr %i.al, align 8, !tbaa !182 ; 2 uses
  ...
  %i.sd = load ptr, ptr %i.al, align 8, !tbaa !182 ; 2 uses
  ...
  %i.sf = load i32, ptr %i.ai, align 4, !tbaa !184
  ...
  %i.sh = load i32, ptr %i.ah, align 8, !tbaa !185
  ...
  %i.sj = load i32, ptr %i.ag, align 8, !tbaa !186
  ...
  %i.sl = load i32, ptr %i.af, align 8, !tbaa !1275
  ...
  %i.sn = load i32, ptr %i.ae, align 4, !tbaa !187
  ...
  %i.sp = load i32, ptr %i.ad, align 8, !tbaa !188
  ...
  %i.sr = load i32, ptr %i.ac, align 4, !tbaa !189
end_hunk_0
