...
.preheader166.lr.ph.i:                            ; preds = %bb.l, %.preheader172.i
  %.pre-phi225 = phi i32 [ 2, %.preheader172.i ], [ %i.cs, %bb.l ]
...
.lr.ph.i.preheader.i:                             ; preds = %._crit_edge.i32, %.preheader167.i
  ...
  %min.iters.check589 = icmp ult i32 %i.cx, 8
  br i1 %min.iters.check589, label %.lr.ph.i.i.preheader, label %vector.ph590

vector.ph590:                                     ; preds = %.lr.ph.i.preheader.i
  %n.vec591 = and i32 %i.cx, -8                   ; 3 uses
  %i.cy = add i32 %i.ct, %n.vec591
  %i.cz = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %.val126.i, i64 0
  %broadcast.splatinsert592 = insertelement <4 x i32> poison, i32 %i.ct, i64 0
  %broadcast.splat593 = shufflevector <4 x i32> %broadcast.splatinsert592, <4 x i32> poison, <4 x i32> zeroinitializer
  %induction594 = add nsw <4 x i32> %broadcast.splat593, <i32 0, i32 1, i32 2, i32 3>
  br label %vector.body595

vector.body595:                                   ; preds = %vector.body595, %vector.ph590
  %index596 = phi i32 [ 0, %vector.ph590 ], [ %index.next601, %vector.body595 ]
  %vec.phi597.a = phi <4 x i32> [ %i.cz, %vector.ph590 ], [ %i.dg, %vector.body595 ]
  %vec.phi598 = phi <4 x i32> [ zeroinitializer, %vector.ph590 ], [ %i.dh, %vector.body595 ]
  %vec.ind599 = phi <4 x i32> [ %induction594, %vector.ph590 ], [ %vec.ind.next602, %vector.body595 ] ; 5 uses
  %step.add600 = add nsw <4 x i32> %vec.ind599, splat (i32 4)
  %i.da = add nsw <4 x i32> %vec.ind599, splat (i32 -1)
  %i.db = add nsw <4 x i32> %vec.ind599, splat (i32 3)
  %i.dc = mul nsw <4 x i32> %i.da, %vec.ind599
  %i.dd = mul nsw <4 x i32> %i.db, %step.add600
  %i.de = sdiv <4 x i32> %i.dc, splat (i32 2)
  %i.df = sdiv <4 x i32> %i.dd, splat (i32 2)
  %i.dg = add <4 x i32> %i.de, %vec.phi597.a      ; 2 uses
  %i.dh = add <4 x i32> %i.df, %vec.phi598        ; 2 uses
  %index.next601 = add nuw i32 %index596, 8       ; 2 uses
  %vec.ind.next602 = add nsw <4 x i32> %vec.ind599, splat (i32 8)
  %i.di = icmp eq i32 %index.next601, %n.vec591
  br i1 %i.di, label %middle.block603, label %vector.body595, !llvm.loop !258

middle.block603:                                  ; preds = %vector.body595
  %bin.rdx604 = add <4 x i32> %i.dh, %i.dg
  %i.dj = call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx604) ; 2 uses
  %cmp.n605 = icmp eq i32 %i.cx, %n.vec591
  br i1 %cmp.n605, label %Ses_ManSelectVar.exit.loopexit.i, label %.lr.ph.i.i.preheader

.lr.ph.i.i.preheader:                             ; preds = %.lr.ph.i.preheader.i, %middle.block603
  %.02.i.i.ph = phi i32 [ %.val126.i, %.lr.ph.i.preheader.i ], [ %i.dj, %middle.block603 ]
  %.0151.i.i.ph = phi i32 [ %i.ct, %.lr.ph.i.preheader.i ], [ %i.cy, %middle.block603 ]
  br label %.lr.ph.i.i
...
Ses_ManSelectVar.exit.loopexit.i:                 ; preds = %.lr.ph.i.i, %middle.block603
  %.lcssa539.a = phi i32 [ %i.dj, %middle.block603 ], [ %i.dn, %.lr.ph.i.i ]
...
.lr.ph.i151.preheader.i:                          ; preds = %._crit_edge186.i, %.lr.ph.i151.preheader.lr.ph.i
  ...
  %min.iters.check569 = icmp ult i32 %i.fh, 8
  br i1 %min.iters.check569, label %.lr.ph.i151.i.preheader, label %vector.ph570

vector.ph570:                                     ; preds = %.lr.ph.i151.preheader.i
  %n.vec571 = and i32 %i.fh, -8                   ; 3 uses
  %i.fi = add i32 %i.fd, %n.vec571
  %i.fj = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %.val124.i, i64 0
  %broadcast.splatinsert572 = insertelement <4 x i32> poison, i32 %i.fd, i64 0
  %broadcast.splat573 = shufflevector <4 x i32> %broadcast.splatinsert572, <4 x i32> poison, <4 x i32> zeroinitializer
  %induction574 = add nsw <4 x i32> %broadcast.splat573, <i32 0, i32 1, i32 2, i32 3>
  br label %vector.body575

vector.body575:                                   ; preds = %vector.body575, %vector.ph570
  %index576 = phi i32 [ 0, %vector.ph570 ], [ %index.next581, %vector.body575 ]
  %vec.phi577.a = phi <4 x i32> [ %i.fj, %vector.ph570 ], [ %i.fq, %vector.body575 ]
  %vec.phi578 = phi <4 x i32> [ zeroinitializer, %vector.ph570 ], [ %i.fr, %vector.body575 ]
  %vec.ind579 = phi <4 x i32> [ %induction574, %vector.ph570 ], [ %vec.ind.next582, %vector.body575 ] ; 5 uses
  %step.add580 = add nsw <4 x i32> %vec.ind579, splat (i32 4)
  %i.fk = add nsw <4 x i32> %vec.ind579, splat (i32 -1)
  %i.fl = add nsw <4 x i32> %vec.ind579, splat (i32 3)
  %i.fm = mul nsw <4 x i32> %i.fk, %vec.ind579
  %i.fn = mul nsw <4 x i32> %i.fl, %step.add580
  %i.fo = sdiv <4 x i32> %i.fm, splat (i32 2)
  %i.fp = sdiv <4 x i32> %i.fn, splat (i32 2)
  %i.fq = add <4 x i32> %i.fo, %vec.phi577.a      ; 2 uses
  %i.fr = add <4 x i32> %i.fp, %vec.phi578        ; 2 uses
  %index.next581 = add nuw i32 %index576, 8       ; 2 uses
  %vec.ind.next582 = add nsw <4 x i32> %vec.ind579, splat (i32 8)
  %i.fs = icmp eq i32 %index.next581, %n.vec571
  br i1 %i.fs, label %middle.block583, label %vector.body575, !llvm.loop !263

middle.block583:                                  ; preds = %vector.body575
  %bin.rdx584 = add <4 x i32> %i.fr, %i.fq
  %i.ft = call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx584) ; 2 uses
  %cmp.n585 = icmp eq i32 %i.fh, %n.vec571
  br i1 %cmp.n585, label %Ses_ManSelectVar.exit154.loopexit.i, label %.lr.ph.i151.i.preheader

.lr.ph.i151.i.preheader:                          ; preds = %.lr.ph.i151.preheader.i, %middle.block583
  %.02.i152.i.ph = phi i32 [ %.val124.i, %.lr.ph.i151.preheader.i ], [ %i.ft, %middle.block583 ]
  %.0151.i153.i.ph = phi i32 [ %i.fd, %.lr.ph.i151.preheader.i ], [ %i.fi, %middle.block583 ]
...
Ses_ManSelectVar.exit154.loopexit.i:              ; preds = %.lr.ph.i151.i, %middle.block583
  %.lcssa540 = phi i32 [ %i.ft, %middle.block583 ], [ %i.fx, %.lr.ph.i151.i ]
...
.lr.ph.i159.preheader.i:                          ; preds = %bb.n, %.lr.ph193.split.i
  ...
  %min.iters.check549 = icmp ult i32 %i.je, 8
  br i1 %min.iters.check549, label %.lr.ph.i159.i.preheader, label %vector.ph550

vector.ph550:                                     ; preds = %.lr.ph.i159.preheader.i
  %n.vec551 = and i32 %i.je, -8                   ; 3 uses
  %i.jf = add i32 %i.it, %n.vec551
  %i.jg = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %.val122.i, i64 0
  %broadcast.splatinsert552 = insertelement <4 x i32> poison, i32 %i.it, i64 0
  %broadcast.splat553 = shufflevector <4 x i32> %broadcast.splatinsert552, <4 x i32> poison, <4 x i32> zeroinitializer
  %induction554 = add nsw <4 x i32> %broadcast.splat553, <i32 0, i32 1, i32 2, i32 3>
  br label %vector.body555

vector.body555:                                   ; preds = %vector.body555, %vector.ph550
  %index556 = phi i32 [ 0, %vector.ph550 ], [ %index.next561, %vector.body555 ]
  %vec.phi557.a = phi <4 x i32> [ %i.jg, %vector.ph550 ], [ %i.jn, %vector.body555 ]
  %vec.phi558 = phi <4 x i32> [ zeroinitializer, %vector.ph550 ], [ %i.jo, %vector.body555 ]
  %vec.ind559 = phi <4 x i32> [ %induction554, %vector.ph550 ], [ %vec.ind.next562, %vector.body555 ] ; 5 uses
  %step.add560 = add nsw <4 x i32> %vec.ind559, splat (i32 4)
  %i.jh = add nsw <4 x i32> %vec.ind559, splat (i32 -1)
  %i.ji = add nsw <4 x i32> %vec.ind559, splat (i32 3)
  %i.jj = mul nsw <4 x i32> %i.jh, %vec.ind559
  %i.jk = mul nsw <4 x i32> %i.ji, %step.add560
  %i.jl = sdiv <4 x i32> %i.jj, splat (i32 2)
  %i.jm = sdiv <4 x i32> %i.jk, splat (i32 2)
  %i.jn = add <4 x i32> %i.jl, %vec.phi557.a      ; 2 uses
  %i.jo = add <4 x i32> %i.jm, %vec.phi558        ; 2 uses
  %index.next561 = add nuw i32 %index556, 8       ; 2 uses
  %vec.ind.next562 = add nsw <4 x i32> %vec.ind559, splat (i32 8)
  %i.jp = icmp eq i32 %index.next561, %n.vec551
  br i1 %i.jp, label %middle.block563, label %vector.body555, !llvm.loop !270

middle.block563:                                  ; preds = %vector.body555
  %bin.rdx564 = add <4 x i32> %i.jo, %i.jn
  %i.jq = call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx564) ; 2 uses
  %cmp.n565 = icmp eq i32 %i.je, %n.vec551
  br i1 %cmp.n565, label %Ses_ManSelectVar.exit162.loopexit.i, label %.lr.ph.i159.i.preheader

.lr.ph.i159.i.preheader:                          ; preds = %.lr.ph.i159.preheader.i, %middle.block563
  %.02.i160.i.ph = phi i32 [ %.val122.i, %.lr.ph.i159.preheader.i ], [ %i.jq, %middle.block563 ]
  %.0151.i161.i.ph = phi i32 [ %i.it, %.lr.ph.i159.preheader.i ], [ %i.jf, %middle.block563 ]
...
.preheader877.i.preheader:                        ; preds = %.preheader877.lr.ph.i
  %min.iters.check669 = icmp samesign ult i32 %.5431972.i, 8
  %n.vec671 = and i32 %.5431972.i, 2147483640     ; 3 uses
  %cmp.n685 = icmp eq i32 %.5431972.i, %n.vec671
  %min.iters.check649 = icmp samesign ult i32 %.5431972.i, 8
  %n.vec651 = and i32 %.5431972.i, 2147483640     ; 3 uses
  %cmp.n665 = icmp eq i32 %.5431972.i, %n.vec651
  %min.iters.check629 = icmp samesign ult i32 %.5431972.i, 8
  %n.vec631 = and i32 %.5431972.i, 2147483640     ; 3 uses
  %cmp.n645 = icmp eq i32 %.5431972.i, %n.vec631
...
.preheader877.us.i:                               ; preds = %.preheader877.lr.ph.i, %.split954.us.us.i
  ...
  %i.aby = icmp sgt i32 %.val490.us.us.us.i, %invariant.op.i49
...
Ses_ManSelectVar.exit568.us.us966.i:              ; preds = %.preheader877.us.i, %._crit_edge940.split.us.us.us.i
  ...
  %i.aci = icmp sgt i32 %i.aca, %invariant.op.i49
...
.lr.ph.i565.preheader.i:                          ; preds = %._crit_edge940.split.i, %.preheader877.i
  ...
  br i1 %min.iters.check669, label %.lr.ph.i565.i.preheader, label %vector.ph670

vector.ph670:                                     ; preds = %.lr.ph.i565.preheader.i
  %i.aec = add i32 %i.aea, %n.vec671
  %i.aed = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %.val491.i, i64 0
  %broadcast.splatinsert672 = insertelement <4 x i32> poison, i32 %i.aea, i64 0
  %broadcast.splat673 = shufflevector <4 x i32> %broadcast.splatinsert672, <4 x i32> poison, <4 x i32> zeroinitializer
  %induction674 = add nsw <4 x i32> %broadcast.splat673, <i32 0, i32 1, i32 2, i32 3>
  br label %vector.body675

vector.body675:                                   ; preds = %vector.body675, %vector.ph670
  %index676 = phi i32 [ 0, %vector.ph670 ], [ %index.next681, %vector.body675 ]
  %vec.phi677.a = phi <4 x i32> [ %i.aed, %vector.ph670 ], [ %i.aek, %vector.body675 ]
  %vec.phi678 = phi <4 x i32> [ zeroinitializer, %vector.ph670 ], [ %i.ael, %vector.body675 ]
  %vec.ind679 = phi <4 x i32> [ %induction674, %vector.ph670 ], [ %vec.ind.next682, %vector.body675 ] ; 5 uses
  %step.add680 = add nsw <4 x i32> %vec.ind679, splat (i32 4)
  %i.aee = add nsw <4 x i32> %vec.ind679, splat (i32 -1)
  %i.aef = add nsw <4 x i32> %vec.ind679, splat (i32 3)
  %i.aeg = mul nsw <4 x i32> %i.aee, %vec.ind679
  %i.aeh = mul nsw <4 x i32> %i.aef, %step.add680
  %i.aei = sdiv <4 x i32> %i.aeg, splat (i32 2)
  %i.aej = sdiv <4 x i32> %i.aeh, splat (i32 2)
  %i.aek = add <4 x i32> %i.aei, %vec.phi677.a    ; 2 uses
  %i.ael = add <4 x i32> %i.aej, %vec.phi678      ; 2 uses
  %index.next681 = add nuw i32 %index676, 8       ; 2 uses
  %vec.ind.next682 = add nsw <4 x i32> %vec.ind679, splat (i32 8)
  %i.aem = icmp eq i32 %index.next681, %n.vec671
  br i1 %i.aem, label %middle.block683, label %vector.body675, !llvm.loop !303

middle.block683:                                  ; preds = %vector.body675
  %bin.rdx684 = add <4 x i32> %i.ael, %i.aek
  %i.aen = call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx684) ; 2 uses
  br i1 %cmp.n685, label %Ses_ManSelectVar.exit568.loopexit.i, label %.lr.ph.i565.i.preheader

.lr.ph.i565.i.preheader:                          ; preds = %.lr.ph.i565.preheader.i, %middle.block683
  %.02.i566.i.ph = phi i32 [ %.val491.i, %.lr.ph.i565.preheader.i ], [ %i.aen, %middle.block683 ]
  %.0151.i567.i.ph = phi i32 [ %i.aea, %.lr.ph.i565.preheader.i ], [ %i.aec, %middle.block683 ]
  br label %.lr.ph.i565.i
end_hunk_1
begin_hunk_2_@Ses_ManFindNetworkExact:bb.a
  %vec.ind719 = phi <4 x i32> [ %induction714, %vector.ph710 ], [ %vec.ind.next722, %vector.body715 ] ; 5 uses
  %step.add720 = add nsw <4 x i32> %vec.ind719, splat (i32 4)
  %i.baf = add nsw <4 x i32> %vec.ind719, splat (i32 -1)
  %i.bag = add nsw <4 x i32> %vec.ind719, splat (i32 3)
  %i.bah = mul nsw <4 x i32> %i.baf, %vec.ind719
  %i.bai = mul nsw <4 x i32> %i.bag, %step.add720
  %i.baj = sdiv <4 x i32> %i.bah, splat (i32 2)
  %i.bak = sdiv <4 x i32> %i.bai, splat (i32 2)
  %i.bal = add <4 x i32> %i.baj, %vec.phi717.a    ; 2 uses
  %i.bam = add <4 x i32> %i.bak, %vec.phi718      ; 2 uses
  %index.next721 = add nuw i32 %index716, 8       ; 2 uses
  %vec.ind.next722 = add nsw <4 x i32> %vec.ind719, splat (i32 8)
  %i.ban = icmp eq i32 %index.next721, %n.vec711
  br i1 %i.ban, label %middle.block723, label %vector.body715, !llvm.loop !318

middle.block723:                                  ; preds = %vector.body715
  %bin.rdx724 = add <4 x i32> %i.bam, %i.bal
  %i.bao = call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx724) ; 2 uses
  %cmp.n725 = icmp eq i32 %i.bac, %n.vec711
  br i1 %cmp.n725, label %Ses_ManSelectVar.exit709.i, label %.lr.ph.i706.i.preheader

.lr.ph.i706.i.preheader:                          ; preds = %.lr.ph993.i, %middle.block723
  %.02.i707.i.ph = phi i32 [ %.val483.i, %.lr.ph993.i ], [ %i.bao, %middle.block723 ]
  %.0151.i708.i.ph = phi i32 [ %i.azz, %.lr.ph993.i ], [ %i.bad, %middle.block723 ]
...
Ses_ManSelectVar.exit709.i:                       ; preds = %.lr.ph.i706.i, %middle.block723
  %.lcssa516 = phi i32 [ %i.bao, %middle.block723 ], [ %i.bas, %.lr.ph.i706.i ]
...
.preheader868.i.preheader:                        ; preds = %.preheader869.i
  %min.iters.check749 = icmp samesign ult i32 %.14081006.i, 8
  %n.vec751 = and i32 %.14081006.i, 2147483640    ; 3 uses
  %cmp.n765 = icmp eq i32 %.14081006.i, %n.vec751
...
.lr.ph.i732.i.preheader:                          ; preds = %bb.ht
  ...
  %min.iters.check789 = icmp ult i32 %i.bdm, 8
  br i1 %min.iters.check789, label %.lr.ph.i732.i.preheader1034, label %vector.ph790

vector.ph790:                                     ; preds = %.lr.ph.i732.i.preheader
  %n.vec791 = and i32 %i.bdm, -8                  ; 3 uses
  %i.bdn = add i32 %.val480.i, %n.vec791
  %i.bdo = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %.val481.i, i64 0
  %broadcast.splatinsert792 = insertelement <4 x i32> poison, i32 %.val480.i, i64 0
  %broadcast.splat793 = shufflevector <4 x i32> %broadcast.splatinsert792, <4 x i32> poison, <4 x i32> zeroinitializer
  %induction794 = add nsw <4 x i32> %broadcast.splat793, <i32 0, i32 1, i32 2, i32 3>
  br label %vector.body795

vector.body795:                                   ; preds = %vector.body795, %vector.ph790
  %index796 = phi i32 [ 0, %vector.ph790 ], [ %index.next801, %vector.body795 ]
  %vec.phi797.a = phi <4 x i32> [ %i.bdo, %vector.ph790 ], [ %i.bdv, %vector.body795 ]
  %vec.phi798 = phi <4 x i32> [ zeroinitializer, %vector.ph790 ], [ %i.bdw, %vector.body795 ]
  %vec.ind799 = phi <4 x i32> [ %induction794, %vector.ph790 ], [ %vec.ind.next802, %vector.body795 ] ; 5 uses
  %step.add800 = add nsw <4 x i32> %vec.ind799, splat (i32 4)
  %i.bdp = add nsw <4 x i32> %vec.ind799, splat (i32 -1)
  %i.bdq = add nsw <4 x i32> %vec.ind799, splat (i32 3)
  %i.bdr = mul nsw <4 x i32> %i.bdp, %vec.ind799
  %i.bds = mul nsw <4 x i32> %i.bdq, %step.add800
  %i.bdt = sdiv <4 x i32> %i.bdr, splat (i32 2)
  %i.bdu = sdiv <4 x i32> %i.bds, splat (i32 2)
  %i.bdv = add <4 x i32> %i.bdt, %vec.phi797.a    ; 2 uses
  %i.bdw = add <4 x i32> %i.bdu, %vec.phi798      ; 2 uses
  %index.next801 = add nuw i32 %index796, 8       ; 2 uses
  %vec.ind.next802 = add nsw <4 x i32> %vec.ind799, splat (i32 8)
  %i.bdx = icmp eq i32 %index.next801, %n.vec791
  br i1 %i.bdx, label %middle.block803, label %vector.body795, !llvm.loop !324

middle.block803:                                  ; preds = %vector.body795
  %bin.rdx804 = add <4 x i32> %i.bdw, %i.bdv
  %i.bdy = call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx804) ; 2 uses
  %cmp.n805 = icmp eq i32 %i.bdm, %n.vec791
  br i1 %cmp.n805, label %Ses_ManSelectVar.exit735.i, label %.lr.ph.i732.i.preheader1034

.lr.ph.i732.i.preheader1034:                      ; preds = %.lr.ph.i732.i.preheader, %middle.block803
  %.02.i733.i.ph = phi i32 [ %.val481.i, %.lr.ph.i732.i.preheader ], [ %i.bdy, %middle.block803 ]
  %.0151.i734.i.ph = phi i32 [ %.val480.i, %.lr.ph.i732.i.preheader ], [ %i.bdn, %middle.block803 ]
  br label %.lr.ph.i732.i

.lr.ph.i732.i:                                    ; preds = %.lr.ph.i732.i.preheader1034, %.lr.ph.i732.i
  %.02.i733.i = phi i32 [ %i.bec, %.lr.ph.i732.i ], [ %.02.i733.i.ph, %.lr.ph.i732.i.preheader1034 ]
  %.0151.i734.i = phi i32 [ %i.bed, %.lr.ph.i732.i ], [ %.0151.i734.i.ph, %.lr.ph.i732.i.preheader1034 ] ; 3 uses
...
Ses_ManSelectVar.exit735.i:                       ; preds = %.lr.ph.i732.i, %middle.block803, %bb.ht
  %.0.lcssa.i728.i = phi i32 [ %.val481.i, %bb.ht ], [ %i.bdy, %middle.block803 ], [ %i.bec, %.lr.ph.i732.i ]
  ...
  %min.iters.check769 = icmp ult i32 %i.bep, 8
  br i1 %min.iters.check769, label %.lr.ph.i740.i.preheader, label %vector.ph770

vector.ph770:                                     ; preds = %Ses_ManSelectVar.exit735.i
  %n.vec771 = and i32 %i.bep, -8                  ; 3 uses
  %i.beq = add i32 %.val480.i, %n.vec771
  %i.ber = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %.val481.i, i64 0
  %broadcast.splatinsert772 = insertelement <4 x i32> poison, i32 %.val480.i, i64 0
  %broadcast.splat773 = shufflevector <4 x i32> %broadcast.splatinsert772, <4 x i32> poison, <4 x i32> zeroinitializer
  %induction774 = add nsw <4 x i32> %broadcast.splat773, <i32 0, i32 1, i32 2, i32 3>
  br label %vector.body775

vector.body775:                                   ; preds = %vector.body775, %vector.ph770
  %index776 = phi i32 [ 0, %vector.ph770 ], [ %index.next781, %vector.body775 ]
  %vec.phi777.a = phi <4 x i32> [ %i.ber, %vector.ph770 ], [ %i.bey, %vector.body775 ]
  %vec.phi778 = phi <4 x i32> [ zeroinitializer, %vector.ph770 ], [ %i.bez, %vector.body775 ]
  %vec.ind779 = phi <4 x i32> [ %induction774, %vector.ph770 ], [ %vec.ind.next782, %vector.body775 ] ; 5 uses
  %step.add780 = add nsw <4 x i32> %vec.ind779, splat (i32 4)
  %i.bes = add nsw <4 x i32> %vec.ind779, splat (i32 -1)
  %i.bet = add nsw <4 x i32> %vec.ind779, splat (i32 3)
  %i.beu = mul nsw <4 x i32> %i.bes, %vec.ind779
  %i.bev = mul nsw <4 x i32> %i.bet, %step.add780
  %i.bew = sdiv <4 x i32> %i.beu, splat (i32 2)
  %i.bex = sdiv <4 x i32> %i.bev, splat (i32 2)
  %i.bey = add <4 x i32> %i.bew, %vec.phi777.a    ; 2 uses
  %i.bez = add <4 x i32> %i.bex, %vec.phi778      ; 2 uses
  %index.next781 = add nuw i32 %index776, 8       ; 2 uses
  %vec.ind.next782 = add nsw <4 x i32> %vec.ind779, splat (i32 8)
  %i.bfa = icmp eq i32 %index.next781, %n.vec771
  br i1 %i.bfa, label %middle.block783, label %vector.body775, !llvm.loop !326

middle.block783:                                  ; preds = %vector.body775
  %bin.rdx784 = add <4 x i32> %i.bez, %i.bey
  %i.bfb = call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx784) ; 2 uses
  %cmp.n785 = icmp eq i32 %i.bep, %n.vec771
  br i1 %cmp.n785, label %Ses_ManSelectVar.exit743.i, label %.lr.ph.i740.i.preheader

.lr.ph.i740.i.preheader:                          ; preds = %Ses_ManSelectVar.exit735.i, %middle.block783
  %.02.i741.i.ph = phi i32 [ %.val481.i, %Ses_ManSelectVar.exit735.i ], [ %i.bfb, %middle.block783 ]
  %.0151.i742.i.ph = phi i32 [ %.val480.i, %Ses_ManSelectVar.exit735.i ], [ %i.beq, %middle.block783 ]
...
Ses_ManSelectVar.exit743.i:                       ; preds = %.lr.ph.i740.i, %middle.block783
  %.lcssa508.a = phi i32 [ %i.bfb, %middle.block783 ], [ %i.bff, %.lr.ph.i740.i ]
  ...
  %i.bfm = add i32 %i.bfl, %.lcssa508.a
  ...
  br i1 %min.iters.check749, label %.lr.ph.i748.i.preheader, label %vector.ph750

vector.ph750:                                     ; preds = %Ses_ManSelectVar.exit743.i
  %i.bft = add i32 %i.bfr, %n.vec751
  %i.bfu = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %.val477.i, i64 0
  %broadcast.splatinsert752 = insertelement <4 x i32> poison, i32 %i.bfr, i64 0
  %broadcast.splat753 = shufflevector <4 x i32> %broadcast.splatinsert752, <4 x i32> poison, <4 x i32> zeroinitializer
  %induction754 = add nsw <4 x i32> %broadcast.splat753, <i32 0, i32 1, i32 2, i32 3>
  br label %vector.body755

vector.body755:                                   ; preds = %vector.body755, %vector.ph750
  %index756 = phi i32 [ 0, %vector.ph750 ], [ %index.next761, %vector.body755 ]
  %vec.phi757.a = phi <4 x i32> [ %i.bfu, %vector.ph750 ], [ %i.bgb, %vector.body755 ]
  %vec.phi758 = phi <4 x i32> [ zeroinitializer, %vector.ph750 ], [ %i.bgc, %vector.body755 ]
  %vec.ind759 = phi <4 x i32> [ %induction754, %vector.ph750 ], [ %vec.ind.next762, %vector.body755 ] ; 5 uses
  %step.add760 = add nsw <4 x i32> %vec.ind759, splat (i32 4)
  %i.bfv = add nsw <4 x i32> %vec.ind759, splat (i32 -1)
  %i.bfw = add nsw <4 x i32> %vec.ind759, splat (i32 3)
  %i.bfx = mul nsw <4 x i32> %i.bfv, %vec.ind759
  %i.bfy = mul nsw <4 x i32> %i.bfw, %step.add760
  %i.bfz = sdiv <4 x i32> %i.bfx, splat (i32 2)
  %i.bga = sdiv <4 x i32> %i.bfy, splat (i32 2)
  %i.bgb = add <4 x i32> %i.bfz, %vec.phi757.a    ; 2 uses
  %i.bgc = add <4 x i32> %i.bga, %vec.phi758      ; 2 uses
  %index.next761 = add nuw i32 %index756, 8       ; 2 uses
  %vec.ind.next762 = add nsw <4 x i32> %vec.ind759, splat (i32 8)
  %i.bgd = icmp eq i32 %index.next761, %n.vec751
  br i1 %i.bgd, label %middle.block763, label %vector.body755, !llvm.loop !328

middle.block763:                                  ; preds = %vector.body755
  %bin.rdx764 = add <4 x i32> %i.bgc, %i.bgb
  %i.bge = call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx764) ; 2 uses
  br i1 %cmp.n765, label %Ses_ManSelectVar.exit751.i, label %.lr.ph.i748.i.preheader

.lr.ph.i748.i.preheader:                          ; preds = %Ses_ManSelectVar.exit743.i, %middle.block763
  %.02.i749.i.ph = phi i32 [ %.val477.i, %Ses_ManSelectVar.exit743.i ], [ %i.bge, %middle.block763 ]
  %.0151.i750.i.ph = phi i32 [ %i.bfr, %Ses_ManSelectVar.exit743.i ], [ %i.bft, %middle.block763 ]
...
Ses_ManSelectVar.exit751.i:                       ; preds = %.lr.ph.i748.i, %middle.block763
  %.lcssa509 = phi i32 [ %i.bge, %middle.block763 ], [ %i.bgi, %.lr.ph.i748.i ]
...
.lr.ph.i756.i.preheader:                          ; preds = %bb.hx
  ...
  %min.iters.check849 = icmp ult i32 %i.big, 8
  br i1 %min.iters.check849, label %.lr.ph.i756.i.preheader1019, label %vector.ph850

vector.ph850:                                     ; preds = %.lr.ph.i756.i.preheader
  %n.vec851 = and i32 %i.big, -8                  ; 3 uses
  %i.bih = add i32 %.val474.i, %n.vec851
  %i.bii = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %.val475.i, i64 0
  %broadcast.splatinsert852 = insertelement <4 x i32> poison, i32 %.val474.i, i64 0
  %broadcast.splat853 = shufflevector <4 x i32> %broadcast.splatinsert852, <4 x i32> poison, <4 x i32> zeroinitializer
  %induction854 = add nsw <4 x i32> %broadcast.splat853, <i32 0, i32 1, i32 2, i32 3>
  br label %vector.body855

vector.body855:                                   ; preds = %vector.body855, %vector.ph850
  %index856 = phi i32 [ 0, %vector.ph850 ], [ %index.next861, %vector.body855 ]
  %vec.phi857.a = phi <4 x i32> [ %i.bii, %vector.ph850 ], [ %i.bip, %vector.body855 ]
  %vec.phi858 = phi <4 x i32> [ zeroinitializer, %vector.ph850 ], [ %i.biq, %vector.body855 ]
  %vec.ind859 = phi <4 x i32> [ %induction854, %vector.ph850 ], [ %vec.ind.next862, %vector.body855 ] ; 5 uses
  %step.add860 = add nsw <4 x i32> %vec.ind859, splat (i32 4)
  %i.bij = add nsw <4 x i32> %vec.ind859, splat (i32 -1)
  %i.bik = add nsw <4 x i32> %vec.ind859, splat (i32 3)
  %i.bil = mul nsw <4 x i32> %i.bij, %vec.ind859
  %i.bim = mul nsw <4 x i32> %i.bik, %step.add860
  %i.bin = sdiv <4 x i32> %i.bil, splat (i32 2)
  %i.bio = sdiv <4 x i32> %i.bim, splat (i32 2)
  %i.bip = add <4 x i32> %i.bin, %vec.phi857.a    ; 2 uses
  %i.biq = add <4 x i32> %i.bio, %vec.phi858      ; 2 uses
  %index.next861 = add nuw i32 %index856, 8       ; 2 uses
  %vec.ind.next862 = add nsw <4 x i32> %vec.ind859, splat (i32 8)
  %i.bir = icmp eq i32 %index.next861, %n.vec851
  br i1 %i.bir, label %middle.block863, label %vector.body855, !llvm.loop !335

middle.block863:                                  ; preds = %vector.body855
  %bin.rdx864 = add <4 x i32> %i.biq, %i.bip
  %i.bis = call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx864) ; 2 uses
  %cmp.n865 = icmp eq i32 %i.big, %n.vec851
  br i1 %cmp.n865, label %Ses_ManSelectVar.exit759.i, label %.lr.ph.i756.i.preheader1019

.lr.ph.i756.i.preheader1019:                      ; preds = %.lr.ph.i756.i.preheader, %middle.block863
  %.02.i757.i.ph = phi i32 [ %.val475.i, %.lr.ph.i756.i.preheader ], [ %i.bis, %middle.block863 ]
  %.0151.i758.i.ph = phi i32 [ %.val474.i, %.lr.ph.i756.i.preheader ], [ %i.bih, %middle.block863 ]
  br label %.lr.ph.i756.i

.lr.ph.i756.i:                                    ; preds = %.lr.ph.i756.i.preheader1019, %.lr.ph.i756.i
  %.02.i757.i = phi i32 [ %i.biw, %.lr.ph.i756.i ], [ %.02.i757.i.ph, %.lr.ph.i756.i.preheader1019 ]
  %.0151.i758.i = phi i32 [ %i.bix, %.lr.ph.i756.i ], [ %.0151.i758.i.ph, %.lr.ph.i756.i.preheader1019 ] ; 3 uses
...
Ses_ManSelectVar.exit759.i:                       ; preds = %.lr.ph.i756.i, %middle.block863, %bb.hx
  %.0.lcssa.i752.i = phi i32 [ %.val475.i, %bb.hx ], [ %i.bis, %middle.block863 ], [ %i.biw, %.lr.ph.i756.i ]
  ...
  %min.iters.check829 = icmp ult i32 %i.bjj, 8
  br i1 %min.iters.check829, label %.lr.ph.i764.i.preheader, label %vector.ph830

vector.ph830:                                     ; preds = %Ses_ManSelectVar.exit759.i
  %n.vec831 = and i32 %i.bjj, -8                  ; 3 uses
  %i.bjk = add i32 %.val474.i, %n.vec831
  %i.bjl = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %.val475.i, i64 0
  %broadcast.splatinsert832 = insertelement <4 x i32> poison, i32 %.val474.i, i64 0
  %broadcast.splat833 = shufflevector <4 x i32> %broadcast.splatinsert832, <4 x i32> poison, <4 x i32> zeroinitializer
  %induction834 = add nsw <4 x i32> %broadcast.splat833, <i32 0, i32 1, i32 2, i32 3>
  br label %vector.body835

vector.body835:                                   ; preds = %vector.body835, %vector.ph830
  %index836 = phi i32 [ 0, %vector.ph830 ], [ %index.next841, %vector.body835 ]
  %vec.phi837.a = phi <4 x i32> [ %i.bjl, %vector.ph830 ], [ %i.bjs, %vector.body835 ]
  %vec.phi838 = phi <4 x i32> [ zeroinitializer, %vector.ph830 ], [ %i.bjt, %vector.body835 ]
  %vec.ind839 = phi <4 x i32> [ %induction834, %vector.ph830 ], [ %vec.ind.next842, %vector.body835 ] ; 5 uses
  %step.add840 = add nsw <4 x i32> %vec.ind839, splat (i32 4)
  %i.bjm = add nsw <4 x i32> %vec.ind839, splat (i32 -1)
  %i.bjn = add nsw <4 x i32> %vec.ind839, splat (i32 3)
  %i.bjo = mul nsw <4 x i32> %i.bjm, %vec.ind839
  %i.bjp = mul nsw <4 x i32> %i.bjn, %step.add840
  %i.bjq = sdiv <4 x i32> %i.bjo, splat (i32 2)
  %i.bjr = sdiv <4 x i32> %i.bjp, splat (i32 2)
  %i.bjs = add <4 x i32> %i.bjq, %vec.phi837.a    ; 2 uses
  %i.bjt = add <4 x i32> %i.bjr, %vec.phi838      ; 2 uses
  %index.next841 = add nuw i32 %index836, 8       ; 2 uses
  %vec.ind.next842 = add nsw <4 x i32> %vec.ind839, splat (i32 8)
  %i.bju = icmp eq i32 %index.next841, %n.vec831
  br i1 %i.bju, label %middle.block843, label %vector.body835, !llvm.loop !337

middle.block843:                                  ; preds = %vector.body835
  %bin.rdx844 = add <4 x i32> %i.bjt, %i.bjs
  %i.bjv = call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx844) ; 2 uses
  %cmp.n845 = icmp eq i32 %i.bjj, %n.vec831
  br i1 %cmp.n845, label %Ses_ManSelectVar.exit767.i, label %.lr.ph.i764.i.preheader

.lr.ph.i764.i.preheader:                          ; preds = %Ses_ManSelectVar.exit759.i, %middle.block843
  %.02.i765.i.ph = phi i32 [ %.val475.i, %Ses_ManSelectVar.exit759.i ], [ %i.bjv, %middle.block843 ]
  %.0151.i766.i.ph = phi i32 [ %.val474.i, %Ses_ManSelectVar.exit759.i ], [ %i.bjk, %middle.block843 ]
...
Ses_ManSelectVar.exit767.i:                       ; preds = %.lr.ph.i764.i, %middle.block843
  %.lcssa500.a = phi i32 [ %i.bjv, %middle.block843 ], [ %i.bjz, %.lr.ph.i764.i ]
  ...
  %i.bkf = add i32 %i.bke, %.lcssa500.a
  ...
  %min.iters.check809 = icmp ult i32 %i.bkl, 8
  br i1 %min.iters.check809, label %.lr.ph.i772.i.preheader, label %vector.ph810

vector.ph810:                                     ; preds = %Ses_ManSelectVar.exit767.i
  %n.vec811 = and i32 %i.bkl, -8                  ; 3 uses
  %i.bkm = add i32 %.val474.i, %n.vec811
  %i.bkn = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %.val475.i, i64 0
  %broadcast.splatinsert812 = insertelement <4 x i32> poison, i32 %.val474.i, i64 0
  %broadcast.splat813 = shufflevector <4 x i32> %broadcast.splatinsert812, <4 x i32> poison, <4 x i32> zeroinitializer
  %induction814 = add nsw <4 x i32> %broadcast.splat813, <i32 0, i32 1, i32 2, i32 3>
  br label %vector.body815

vector.body815:                                   ; preds = %vector.body815, %vector.ph810
end_hunk_2
