...
.lr.ph.preheader.lr.ph:                           ; preds = %Vec_WrdAlloc.exit
  ...
  %i.u = add i64 %umax55, -9
  %i.v = sub i64 %i.u, %.val3351
  %i.w = and i64 %i.v, -8
  %i.x = getelementptr i8, ptr %.val33, i64 %i.w
  %scevgep56 = getelementptr i8, ptr %i.x, i64 8
  %i.y = add i64 %.val3351, 16
  %3 = add i64 %.idx, %.val3351
  %invariant.op = sub i64 -9, %.val3351
  %invariant.op68 = sub i64 -9, %.val3351
  br label %.lr.ph.preheader

.lr.ph45.loopexit:                                ; preds = %.lr.ph, %middle.block
  %.lcssa = phi ptr [ %i.an, %middle.block ], [ %i.az, %.lr.ph ]
  %i.z = getelementptr inbounds nuw i8, ptr %i.ab, i64 8 ; 2 uses
  %i.aa = icmp ult ptr %i.z, %i.i
  %indvar.next = add i64 %indvar, 1
  br i1 %i.aa, label %.lr.ph.preheader, label %._crit_edge, !llvm.loop !57
...
.lr.ph.preheader:                                 ; preds = %.lr.ph.preheader.lr.ph, %.lr.ph45.loopexit
  ...
  %i.ab = phi ptr [ %i.r, %.lr.ph.preheader.lr.ph ], [ %i.z, %.lr.ph45.loopexit ] ; 7 uses
  %.0234350 = phi ptr [ %.val33, %.lr.ph.preheader.lr.ph ], [ %i.ab, %.lr.ph45.loopexit ] ; 2 uses
  %.04449 = phi ptr [ %i.q, %.lr.ph.preheader.lr.ph ], [ %.lcssa, %.lr.ph45.loopexit ] ; 7 uses
  %4 = shl nuw i64 %indvar, 3
  %i.ac = add i64 %i.y, %4
  %umax60 = call i64 @llvm.umax.i64(i64 %i.ac, i64 %3)
  %5 = mul i64 %indvar, -8
  %.reass = add i64 %5, %invariant.op
  %i.ad = add i64 %umax60, %.reass                ; 2 uses
  %i.ae = lshr i64 %i.ad, 3
  %i.af = add nuw nsw i64 %i.ae, 1                ; 2 uses
  %min.iters.check = icmp ult i64 %i.ad, 40
  br i1 %min.iters.check, label %.lr.ph.preheader65, label %vector.memcheck

vector.memcheck:                                  ; preds = %.lr.ph.preheader
  %i.ag = shl nuw i64 %indvar, 3                  ; 2 uses
  %i.ah = getelementptr i8, ptr %.val33, i64 %i.ag
  %scevgep53 = getelementptr i8, ptr %i.ah, i64 16
  %i.ai = add i64 %i.s, %i.ag
  %umax = call i64 @llvm.umax.i64(i64 %i.ai, i64 %i.t)
  %i.aj = mul i64 %indvar, -8
  %.reass69 = add i64 %i.aj, %invariant.op68
  %i.ak = add i64 %umax, %.reass69
  ...
  %bound1 = icmp ult ptr %i.ab, %scevgep52
  ...
  br i1 %conflict.rdx, label %.lr.ph.preheader65, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep61 = getelementptr i8, ptr %i.ab, i64 %i.aq ; 2 uses
  %i.ar = getelementptr i8, ptr %next.gep61, i64 16
  %wide.load = load <2 x i64>, ptr %next.gep61, align 8, !tbaa !14, !alias.scope !61
  %wide.load62 = load <2 x i64>, ptr %i.ar, align 8, !tbaa !14, !alias.scope !61
  %i.as = xor <2 x i64> %wide.load, %broadcast.splat
  %i.at = xor <2 x i64> %wide.load62, %broadcast.splat
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %.lr.ph45.loopexit, label %.lr.ph.preheader65

.lr.ph.preheader65:                               ; preds = %vector.memcheck, %.lr.ph.preheader, %middle.block
  %.142.ph = phi ptr [ %.04449, %vector.memcheck ], [ %.04449, %.lr.ph.preheader ], [ %i.an, %middle.block ]
  %.02441.ph = phi ptr [ %i.ab, %vector.memcheck ], [ %i.ab, %.lr.ph.preheader ], [ %i.ao, %middle.block ]
  br label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.preheader65, %.lr.ph
  %.142 = phi ptr [ %i.az, %.lr.ph ], [ %.142.ph, %.lr.ph.preheader65 ] ; 2 uses
  %.02441 = phi ptr [ %i.ba, %.lr.ph ], [ %.02441.ph, %.lr.ph.preheader65 ] ; 2 uses
