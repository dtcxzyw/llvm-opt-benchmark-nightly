...
Vec_WrdGrow.exit11.sink.split.i:                  ; preds = %bb.w, %bb.x, %bb.s, %bb.t
  ...
  store ptr %storemerge, ptr %i.o, align 8, !tbaa !19
  store i32 %spec.select.sink.i, ptr %i.l, align 8, !tbaa !18
...
bb.z:                                             ; preds = %bb.y
  %i.av = load i8, ptr %i.u, align 1, !tbaa !67
...
bb.ab:                                            ; preds = %bb.y
  %i.az = load i8, ptr %i.u, align 1, !tbaa !67
...
.thread:                                          ; preds = %bb.y, %bb.z, %bb.ab
  ...
  %i.bb = load ptr, ptr %i.o, align 8, !tbaa !19  ; 2 uses
...
bb.ad:                                            ; preds = %bb.ab, %bb.aa
  ...
  br i1 %.not, label %.loopexit, label %bb.h, !llvm.loop !66
...
Abc_Clock.exit:                                   ; preds = %bb.a, %bb.b
  ...
  %.val33 = load ptr, ptr %i.f, align 8, !tbaa !19 ; 7 uses
  %.val3351 = ptrtoaddr ptr %.val33 to i64        ; 7 uses
  %i.g = getelementptr i8, ptr %0, i64 4
  %.val30 = load i32, ptr %i.g, align 4, !tbaa !17 ; 4 uses
  %i.h = sext i32 %.val30 to i64
  %.idx = shl nsw i64 %i.h, 3                     ; 3 uses
...
.lr.ph.preheader.lr.ph:                           ; preds = %Vec_WrdAlloc.exit
  ...
  %i.s = add i64 %.val3351, 16                    ; 2 uses
  %i.t = add i64 %.idx, %.val3351                 ; 2 uses
  %umax55 = call i64 @llvm.umax.i64(i64 %i.t, i64 %i.s)
  %3 = add i64 %umax55, -9
  %i.u = sub i64 %3, %.val3351
  %4 = and i64 %i.u, -8
  %i.v = getelementptr i8, ptr %.val33, i64 %4
  %scevgep56 = getelementptr i8, ptr %i.v, i64 8
  %i.w = add i64 %.val3351, 16
  %invariant.op = sub i64 -9, %.val3351
  %i.x = add i64 %.idx, %.val3351
  %invariant.op67 = sub i64 -9, %.val3351
...
.lr.ph45.loopexit:                                ; preds = %.lr.ph, %middle.block
  ...
  br i1 %i.z, label %.lr.ph.preheader, label %._crit_edge, !llvm.loop !68
...
vector.memcheck:                                  ; preds = %.lr.ph.preheader
  ...
  %6 = mul i64 %indvar, -8
  %.reass68 = add i64 %6, %invariant.op67
  %i.ak = add i64 %umax, %.reass68
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %i.ap = load i64, ptr %.0234350, align 8, !tbaa !21, !alias.scope !75
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %next.gep60, align 8, !tbaa !21, !alias.scope !76
  %wide.load61 = load <2 x i64>, ptr %i.ar, align 8, !tbaa !21, !alias.scope !76
  ...
  store <2 x i64> %i.as, ptr %next.gep, align 8, !tbaa !21, !alias.scope !77, !noalias !78
  store <2 x i64> %i.at, ptr %i.au, align 8, !tbaa !21, !alias.scope !77, !noalias !78
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.av = icmp eq i64 %index.next, %n.vec
  br i1 %i.av, label %middle.block, label %vector.body, !llvm.loop !73
...
.lr.ph:                                           ; preds = %.lr.ph.preheader64, %.lr.ph
  ...
  %i.aw = load i64, ptr %.0234350, align 8, !tbaa !21
  %i.ax = load i64, ptr %.02441, align 8, !tbaa !21
  %i.ay = xor i64 %i.ax, %i.aw
  %i.az = getelementptr inbounds nuw i8, ptr %.142, i64 8 ; 2 uses
  store i64 %i.ay, ptr %.142, align 8, !tbaa !21
  %i.ba = getelementptr inbounds nuw i8, ptr %.02441, i64 8 ; 2 uses
  %i.bb = icmp ult ptr %i.ba, %i.i
  br i1 %i.bb, label %.lr.ph, label %.lr.ph45.loopexit, !llvm.loop !74
...
._crit_edge:                                      ; preds = %.lr.ph45.loopexit, %Vec_WrdAlloc.exit
  ...
  store i32 %spec.store.select.i, ptr %i.bd, align 4, !tbaa !17
  store i32 %spec.store.select.i, ptr %i.bc, align 8, !tbaa !18
...
bb.e:                                             ; preds = %Vec_WrdDup.exit
  %i.bp = load i64, ptr %1, align 8, !tbaa !28
...
.lr.ph:                                           ; preds = %bb.a
  ...
  %.val16 = load ptr, ptr %i.b, align 8, !tbaa !32
...
bb.c:                                             ; preds = %bb.b
  ...
  %.val.i18.pre = load i32, ptr %.phi.trans.insert24, align 4, !tbaa !35 ; 2 uses
...
bb.a:
  ...
  %.val38 = load ptr, ptr %i.a, align 8, !tbaa !32
  ...
  %.val62 = load i32, ptr %i.e, align 4, !tbaa !17
...
bb.b:                                             ; preds = %.lr.ph65, %.loopexit
  ...
  %.val36 = load ptr, ptr %i.g, align 8, !tbaa !19
