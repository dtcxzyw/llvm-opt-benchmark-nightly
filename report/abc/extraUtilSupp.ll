...
.lr.ph.preheader.lr.ph:                           ; preds = %Vec_WrdAlloc.exit
  ...
  %4 = sub i64 %3, %.val3351
  %5 = and i64 %4, -8
  %i.u = getelementptr i8, ptr %.val33, i64 %5
  %scevgep56 = getelementptr i8, ptr %i.u, i64 8
  %i.v = add i64 %.val3351, 16
  %i.w = add i64 %.idx, %.val3351
...
.lr.ph45.loopexit:                                ; preds = %.lr.ph, %middle.block
  ...
  %i.x = getelementptr inbounds nuw i8, ptr %i.z, i64 8 ; 2 uses
  %i.y = icmp ult ptr %i.x, %i.i
  %indvar.next = add i64 %indvar, 1
  br i1 %i.y, label %.lr.ph.preheader, label %._crit_edge, !llvm.loop !57
...
.lr.ph.preheader:                                 ; preds = %.lr.ph.preheader.lr.ph, %.lr.ph45.loopexit
  ...
  %i.z = phi ptr [ %i.r, %.lr.ph.preheader.lr.ph ], [ %i.x, %.lr.ph45.loopexit ] ; 7 uses
  %.0234350 = phi ptr [ %.val33, %.lr.ph.preheader.lr.ph ], [ %i.z, %.lr.ph45.loopexit ] ; 2 uses
  %.04449 = phi ptr [ %i.q, %.lr.ph.preheader.lr.ph ], [ %.lcssa, %.lr.ph45.loopexit ] ; 7 uses
  %i.aa = shl nuw i64 %indvar, 3
  %i.ab = add i64 %i.v, %i.aa
  %umax60 = call i64 @llvm.umax.i64(i64 %i.ab, i64 %i.w)
  %i.ac = mul i64 %indvar, -8
  %.reass = add i64 %i.ac, %invariant.op
...
vector.memcheck:                                  ; preds = %.lr.ph.preheader
  ...
  %bound1 = icmp ult ptr %i.z, %scevgep52
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep61 = getelementptr i8, ptr %i.z, i64 %i.aq ; 2 uses
...
.lr.ph.preheader65:                               ; preds = %vector.memcheck, %.lr.ph.preheader, %middle.block
  ...
  %.02441.ph = phi ptr [ %i.z, %vector.memcheck ], [ %i.z, %.lr.ph.preheader ], [ %i.ao, %middle.block ]
  br label %.lr.ph
