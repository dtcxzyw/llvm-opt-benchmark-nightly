...
.lr.ph.epil:                                      ; preds = %.lr.ph.epil, %.lr.ph.epil.preheader
  ...
  %i.r = shl i32 %indvars.iv.tr.epil, 1
...
.critedge2.us.us.us:                              ; preds = %.critedge.split.us.split.us, %bb.d
  ...
  %i.ez = shl i32 %indvars.iv199.tr, 2
...
.critedge2.us.us:                                 ; preds = %.critedge.split.us.split.us, %bb.h
  ...
  %indvars.iv204.tr = trunc i64 %indvars.iv204 to i32
  %i.fv = shl i32 %indvars.iv204.tr, 2
...
.critedge2.us:                                    ; preds = %.critedge.split.us, %bb.k
  ...
  %i.gs = shl i32 %indvars.iv194.tr, 2
...
.critedge2:                                       ; preds = %.critedge, %bb.t
  ...
  %i.ho = shl i32 %indvars.iv189.tr, 2
...
bb.d:                                             ; preds = %bb.e, %.lr.ph.i.i
  ...
  %i.av = shl i32 %indvars.iv.tr.i.i, 2
...
bb.h:                                             ; preds = %bb.i, %.lr.ph.i.1.i
  ...
  %indvars.iv.tr.i.1.i = trunc i64 %indvars.iv.i.1.i to i32 ; 2 uses
  %i.cw = shl i32 %indvars.iv.tr.i.1.i, 2
...
bb.x:                                             ; preds = %bb.r
  ...
  %i.hv = shl i32 %indvars.iv.next377.tr, 1       ; 2 uses
...
.critedge2:                                       ; preds = %.preheader, %bb.f
  ...
  %i.dv = shl i32 %indvars.iv125.tr, 2
...
bb.w:                                             ; preds = %Nf_ObjMatchBest.exit.i, %.lr.ph.i
  ...
  %i.eo = shl i32 %indvars.iv.tr.i, 2
...
bb.x:                                             ; preds = %Nf_ObjMatchBest.exit.i.1, %.lr.ph.i.1
  ...
  %indvars.iv.tr.i.1 = trunc i64 %indvars.iv.i.1 to i32 ; 2 uses
  %i.gg = shl i32 %indvars.iv.tr.i.1, 2
...
bb.z:                                             ; preds = %Nf_ObjMatchBest.exit.i142, %.lr.ph.i135
  ...
  %indvars.iv.tr.i140 = trunc i64 %indvars.iv.i138 to i32 ; 2 uses
  %i.ib = shl i32 %indvars.iv.tr.i140, 2
...
Gia_ObjLevelId.exit:                              ; preds = %bb.s, %._crit_edge.i.i.i
  ...
  %i.jg = shl i32 %indvars.iv340.tr, 1
