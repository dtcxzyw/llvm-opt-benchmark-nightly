...
bb.ap:                                            ; preds = %bb.ao
  ...
  store i32 %i.ha, ptr %i.b, align 4, !tbaa !54
  store i32 %.reass140.reass.1, ptr %i.ay, align 4, !tbaa !54
  %i.hd = load i32, ptr %i.ar, align 8, !tbaa !42
  %i.he = add nsw i32 %i.hd, -1
  %.not105.1.1 = icmp eq i32 %i.he, %i.bk
  br i1 %.not105.1.1, label %bb.ar, label %bb.aq

bb.aq:                                            ; preds = %bb.ap
  store i32 %.reass142.reass.1, ptr %i.bf, align 4, !tbaa !54
  br label %bb.ar

bb.ar:                                            ; preds = %bb.aq, %bb.ap
  %.3.1.1 = phi i32 [ 3, %bb.aq ], [ 2, %bb.ap ]
  %i.hf = load ptr, ptr %i.ah, align 8, !tbaa !68
...
bb.as:                                            ; preds = %bb.ar
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #41
  store i32 %i.ha, ptr %i.b, align 4, !tbaa !54
  store i32 %.reass.reass.1, ptr %i.ay, align 4, !tbaa !54
  %i.hh = load i32, ptr %i.ar, align 8, !tbaa !42
  %i.hi = add nsw i32 %i.hh, -1
  %.not105.2.1 = icmp eq i32 %i.hi, %i.bk
  br i1 %.not105.2.1, label %bb.au, label %bb.at

bb.at:                                            ; preds = %bb.as
  store i32 %.reass142.reass.1, ptr %i.bg, align 4, !tbaa !54
  br label %bb.au

bb.au:                                            ; preds = %bb.at, %bb.as
  %.3.2.1 = phi i32 [ 3, %bb.at ], [ 2, %bb.as ]
  %i.hj = load ptr, ptr %i.ah, align 8, !tbaa !68
...
.loopexit.loopexit.1:                             ; preds = %bb.au
  %.pre191 = load i32, ptr %i.ar, align 8, !tbaa !42
  br label %.loopexit.1
...
.loopexit.1:                                      ; preds = %.loopexit.loopexit.1, %.loopexit
  ...
  br i1 %i.hn, label %bb.b, label %._crit_edge153, !llvm.loop !219

._crit_edge153:                                   ; preds = %.loopexit.1, %._crit_edge
  %i.ho = load i32, ptr %i.al, align 4, !tbaa !67
  %i.hp = shl nsw i32 %i.ho, 2
  %i.hq = load i32, ptr %i.aj, align 8, !tbaa !52
  %i.hr = add nsw i32 %i.hq, %i.hp
  store i32 %i.hr, ptr %i.aj, align 8, !tbaa !52
  br label %.critedge
...
bb.b:                                             ; preds = %bb.a
  %i.d = load i64, ptr %8, align 8, !tbaa !70
...
Abc_Clock.exit:                                   ; preds = %bb.a, %bb.b
  ...
  %i.i = load i32, ptr %i.g, align 8, !tbaa !49
  ...
  %.pr33 = load i32, ptr %i.a, align 4, !tbaa !54
...
bb.d:                                             ; preds = %bb.c
  %i.w = load i64, ptr %7, align 8, !tbaa !70
  %.neg34 = mul i64 %i.w, -1000000
  %i.x = load i64, ptr %i.m, align 8, !tbaa !71
...
Abc_Clock.exit26:                                 ; preds = %bb.c, %bb.d
  ...
  %i.y = load i32, ptr %i.a, align 4, !tbaa !54
...
bb.e:                                             ; preds = %Abc_Clock.exit26
  %i.aa = load ptr, ptr %i.n, align 8, !tbaa !68  ; 6 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.ad = load ptr, ptr @stdout, align 8, !tbaa !73
  %i.ae = load i32, ptr %i.g, align 8, !tbaa !49
  call void @Extra_PrintBinary(ptr noundef %i.ad, ptr noundef nonnull %i.a, i32 noundef %i.ae) #41
  %i.af = load i32, ptr %i.o, align 8, !tbaa !52
...
bb.g:                                             ; preds = %bb.f
  %i.an = load i64, ptr %6, align 8, !tbaa !70
  %i.ao = mul nsw i64 %i.an, 1000000
  %i.ap = load i64, ptr %i.p, align 8, !tbaa !71
...
bb.j:                                             ; preds = %bb.h
  %i.aw = load i32, ptr %i.g, align 8, !tbaa !49  ; 6 uses
  %i.ax = add nsw i32 %i.aw, 2
  %i.ay = load i32, ptr %i.q, align 8, !tbaa !42  ; 6 uses
...
.preheader63.lr.ph.split.us.i:                    ; preds = %.preheader63.lr.ph.i
  %.val55.us.us.i = load i32, ptr %i.s, align 4, !tbaa !41 ; 5 uses
  %.val56.us.us.i = load ptr, ptr %i.t, align 8, !tbaa !48
  %i.be = getelementptr i8, ptr %.val56.us.us.i, i64 8
  %.val56.val.us.us.i = load ptr, ptr %i.be, align 8, !tbaa !46 ; 2 uses
...
vector.body83:                                    ; preds = %vector.memcheck75, %vector.body83
  ...
  %wide.load85 = load <2 x i64>, ptr %i.bv, align 8, !tbaa !51
  %wide.load86 = load <2 x i64>, ptr %i.bw, align 8, !tbaa !51
  %i.bx = getelementptr inbounds nuw [8 x i8], ptr %i.bt, i64 %index84 ; 2 uses
  %i.by = getelementptr inbounds nuw i8, ptr %i.bx, i64 16
  store <2 x i64> %wide.load85, ptr %i.bx, align 8, !tbaa !51
  store <2 x i64> %wide.load86, ptr %i.by, align 8, !tbaa !51
  %index.next87 = add nuw i64 %index84, 4         ; 2 uses
  %i.bz = icmp eq i64 %index.next87, %n.vec82
  br i1 %i.bz, label %middle.block88, label %vector.body83, !llvm.loop !220
...
.lr.ph.i57.us.us.i.prol:                          ; preds = %.lr.ph.i57.us.us.i.preheader, %.lr.ph.i57.us.us.i.prol
  ...
  store i64 %i.cb, ptr %i.cc, align 8, !tbaa !51
  %indvars.iv.next.i59.us.us.i.prol = add nuw nsw i64 %indvars.iv.i58.us.us.i.prol, 1 ; 2 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i57.us.us.i.prol.loopexit, label %.lr.ph.i57.us.us.i.prol, !llvm.loop !221
...
.lr.ph.i57.us.us.i:                               ; preds = %.lr.ph.i57.us.us.i.prol.loopexit, %.lr.ph.i57.us.us.i
  ...
  store i64 %i.cg, ptr %i.ch, align 8, !tbaa !51
  ...
  store i64 %i.cp, ptr %i.cq, align 8, !tbaa !51
  ...
  br i1 %exitcond.not.i.us.us.i.3, label %Abc_TtMaj.exit.loopexit.us.us.i, label %.lr.ph.i57.us.us.i, !llvm.loop !222
...
Abc_TtMaj.exit.loopexit.us.us.i:                  ; preds = %.lr.ph.i57.us.us.i.prol.loopexit, %.lr.ph.i57.us.us.i, %middle.block88
  ...
  br i1 %exitcond.not, label %.preheader.i, label %.preheader63.us.us.i, !llvm.loop !223
...
.lr.ph.i.i:                                       ; preds = %.preheader63.i, %bb.l
  ...
  %i.cy = load i32, ptr %i.cx, align 4, !tbaa !54 ; 2 uses
...
bb.l:                                             ; preds = %bb.k, %.lr.ph.i.i
  ...
  br i1 %exitcond46.not, label %Maj_ManFindFanin.exit.i, label %.lr.ph.i.i, !llvm.loop !1

Maj_ManFindFanin.exit.i:                          ; preds = %bb.l
  %.val55.i = load i32, ptr %i.s, align 4, !tbaa !41 ; 7 uses
  %.val56.i = load ptr, ptr %i.t, align 8, !tbaa !48
  %i.db = getelementptr i8, ptr %.val56.i, i64 8  ; 3 uses
  %.val56.val.i = load ptr, ptr %i.db, align 8, !tbaa !46 ; 2 uses
...
bb.m:                                             ; preds = %bb.o, %Maj_ManFindFanin.exit.i
  ...
  %i.de = load i32, ptr %i.dd, align 4, !tbaa !54 ; 2 uses
...
bb.o:                                             ; preds = %bb.n, %bb.m
  ...
  br i1 %exitcond47.not, label %Maj_ManFindFanin.exit.1.i, label %bb.m, !llvm.loop !1

Maj_ManFindFanin.exit.1.i:                        ; preds = %bb.o
  %.val56.val.1.pre.i = load ptr, ptr %i.db, align 8, !tbaa !46 ; 2 uses
...
bb.p:                                             ; preds = %bb.r, %Maj_ManFindFanin.exit.1.i
  ...
  %i.dj = load i32, ptr %i.di, align 4, !tbaa !54 ; 2 uses
...
bb.r:                                             ; preds = %bb.q, %bb.p
  ...
  br i1 %exitcond48.not, label %Maj_ManFindFanin.exit.loopexit.2.i, label %bb.p, !llvm.loop !1
...
Maj_ManFindFanin.exit.loopexit.2.i:               ; preds = %bb.r
  ...
  %.val56.val.2.pre.i = load ptr, ptr %i.db, align 8, !tbaa !46 ; 3 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %i.ej, align 8, !tbaa !51
  %wide.load70 = load <2 x i64>, ptr %i.ek, align 8, !tbaa !51
  %i.el = getelementptr inbounds nuw [8 x i8], ptr %i.dr, i64 %index ; 2 uses
  %i.em = getelementptr inbounds nuw i8, ptr %i.el, i64 16
  %wide.load71 = load <2 x i64>, ptr %i.el, align 8, !tbaa !51 ; 2 uses
  %wide.load72 = load <2 x i64>, ptr %i.em, align 8, !tbaa !51 ; 2 uses
  %i.en = getelementptr inbounds nuw [8 x i8], ptr %i.du, i64 %index ; 2 uses
  %i.eo = getelementptr inbounds nuw i8, ptr %i.en, i64 16
  %wide.load73 = load <2 x i64>, ptr %i.en, align 8, !tbaa !51 ; 2 uses
  %wide.load74 = load <2 x i64>, ptr %i.eo, align 8, !tbaa !51 ; 2 uses
  ...
  store <2 x i64> %i.ev, ptr %i.ex, align 8, !tbaa !51
  store <2 x i64> %i.ew, ptr %i.ey, align 8, !tbaa !51
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ez = icmp eq i64 %index.next, %n.vec
  br i1 %i.ez, label %middle.block, label %vector.body, !llvm.loop !224
...
.lr.ph.i57.i.prol:                                ; preds = %.lr.ph.i57.i.preheader
  ...
  %i.fd = load i64, ptr %i.fc, align 8, !tbaa !51 ; 2 uses
  %i.fe = getelementptr inbounds nuw [8 x i8], ptr %i.du, i64 %indvars.iv.i58.i.ph
  %i.ff = load i64, ptr %i.fe, align 8, !tbaa !51 ; 2 uses
  ...
  store i64 %i.fj, ptr %i.fk, align 8, !tbaa !51
...
.lr.ph.i57.i:                                     ; preds = %.lr.ph.i57.i.prol.loopexit, %.lr.ph.i57.i
  ...
  %i.fq = load i64, ptr %i.fp, align 8, !tbaa !51 ; 2 uses
  %i.fr = getelementptr inbounds nuw [8 x i8], ptr %i.du, i64 %indvars.iv.i58.i
  %i.fs = load i64, ptr %i.fr, align 8, !tbaa !51 ; 2 uses
  ...
  store i64 %i.fw, ptr %i.fx, align 8, !tbaa !51
  ...
  %i.gb = load i64, ptr %i.ga, align 8, !tbaa !51 ; 2 uses
  %i.gc = getelementptr inbounds nuw [8 x i8], ptr %i.du, i64 %indvars.iv.next.i59.i
  %i.gd = load i64, ptr %i.gc, align 8, !tbaa !51 ; 2 uses
  ...
  store i64 %i.gh, ptr %i.gi, align 8, !tbaa !51
  ...
  br i1 %exitcond.not.i.i.1, label %Abc_TtMaj.exit.i, label %.lr.ph.i57.i, !llvm.loop !225
...
Abc_TtMaj.exit.i:                                 ; preds = %.lr.ph.i57.i.prol.loopexit, %.lr.ph.i57.i, %middle.block, %Maj_ManFindFanin.exit.loopexit.2.i
  ...
  br i1 %exitcond49.not, label %.preheader.i, label %.preheader63.i, !llvm.loop !226
...
bb.t:                                             ; preds = %bb.s
  %.val51.i = load i32, ptr %i.s, align 4, !tbaa !41 ; 2 uses
  %.val52.i = load ptr, ptr %i.t, align 8, !tbaa !48
  %i.gn = getelementptr i8, ptr %.val52.i, i64 8
  %.val52.val.i = load ptr, ptr %i.gn, align 8, !tbaa !46 ; 2 uses
  ...
  %i.gu = load i64, ptr %i.gt, align 8, !tbaa !51
...
select.unfold.i:                                  ; preds = %bb.t, %bb.s
  ...
  br i1 %exitcond.not.i, label %.thread32.loopexit, label %bb.s, !llvm.loop !227

.loopexit:                                        ; preds = %bb.t
  store i32 %.14567.i, ptr %i.a, align 4, !tbaa !54
  %i.hh = add nuw nsw i32 %.02243, 1
  br label %bb.c

.loopexit41:                                      ; preds = %Abc_Clock.exit26, %bb.i
  %.pr = load i32, ptr %i.a, align 4, !tbaa !54
...
bb.v:                                             ; preds = %bb.u
  %i.hl = load i64, ptr %5, align 8, !tbaa !70
...
Abc_Clock.exit30:                                 ; preds = %bb.u, %bb.v
  ...
  %i.hu = load i32, ptr %i.a, align 4, !tbaa !54
...
bb.a:
  ...
  %i.b = load i32, ptr %i.a, align 4, !tbaa !78   ; 2 uses
  ...
  store i32 %spec.store.select.i.i, ptr %i.g, align 8, !tbaa !45
...
Vec_WrdStart.exit:                                ; preds = %bb.a, %bb.b
  ...
  store ptr %i.l, ptr %i.n, align 8, !tbaa !46
  store i32 %i.f, ptr %i.m, align 4, !tbaa !47
  ...
  store ptr %i.g, ptr %i.q, align 8, !tbaa !80
  %i.r = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.s = load i32, ptr %i.r, align 8, !tbaa !81   ; 4 uses
...
vector.body25:                                    ; preds = %vector.body25, %vector.ph21
  ...
  store <2 x i64> %i.ak, ptr %i.am, align 8, !tbaa !51
  store <2 x i64> %i.al, ptr %i.an, align 8, !tbaa !51
  ...
  br i1 %i.ao, label %middle.block28, label %vector.body25, !llvm.loop !228
