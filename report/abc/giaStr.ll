...
begin_hunk_0_@Str_MuxChangeUndo:bb.a
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(64) %i.r, ptr noundef nonnull align 4 dereferenceable(64) %i.s, i64 64, i1 false), !tbaa.struct !159
  ret void
}

; Function Attrs: nofree nosync nounwind memory(argmem: readwrite) uwtable
define range(i32 0, 2) i32 @Str_MuxFindPathEdge_rec(ptr nofree noundef readonly captures(none) %0, i32 noundef %1, ptr nofree noundef writeonly captures(none) %2, ptr nofree noundef captures(none) %3) local_unnamed_addr #14 {
bb.a:
  ...
  %.pre19 = load i32, ptr %0, align 4, !tbaa !151 ; 3 uses
  br i1 %i.e, label %bb.b, label %Str_MuxFindPath_rec.exit.thread12

bb.b:                                             ; preds = %bb.a
  %i.f = sext i32 %.pre19 to i64
  %i.g = sub nsw i64 0, %i.f
  %i.h = getelementptr inbounds [64 x i8], ptr %0, i64 %i.g
  %i.i = zext nneg i32 %i.d to i64
  %i.j = getelementptr inbounds nuw [64 x i8], ptr %i.h, i64 %i.i ; 4 uses
  %i.k = getelementptr inbounds nuw i8, ptr %i.j, i64 24
  %i.l = load i32, ptr %i.k, align 4, !tbaa !150  ; 2 uses
...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  br i1 %i.h, label %.lr.ph, label %._crit_edge70.thread
...
.lr.ph:                                           ; preds = %bb.d
  ...
  %wide.trip.count83 = zext nneg i32 %.pre to i64 ; 2 uses
...
bb.e:                                             ; preds = %.lr.ph, %._crit_edge
  ...
  %.05067 = phi i32 [ -1, %.lr.ph ], [ %.151.lcssa, %._crit_edge ] ; 2 uses
  %.05465 = phi i32 [ %i.c, %.lr.ph ], [ %.155.lcssa, %._crit_edge ] ; 2 uses
  %i.n = icmp slt i64 %indvars.iv80, %invariant.op
  br i1 %i.n, label %.lr.ph.i.preheader.lr.ph, label %.._crit_edge_crit_edge

.._crit_edge_crit_edge:                           ; preds = %bb.e
  %.pre85 = add nuw nsw i64 %indvars.iv80, 1
  br label %._crit_edge

.lr.ph.i.preheader.lr.ph:                         ; preds = %bb.e
  %i.o = getelementptr [4 x i8], ptr %i.a, i64 %indvars.iv80 ; 2 uses
  ...
  %i.y = add nuw nsw i64 %indvars.iv80, 1         ; 2 uses
  %i.z = and i32 %i.q, 1
  %i.aa = and i32 %i.u, 1
...
.lr.ph.i.preheader:                               ; preds = %.lr.ph.i.preheader.lr.ph, %bb.k
  %indvars.iv74 = phi i64 [ %indvars.iv, %.lr.ph.i.preheader.lr.ph ], [ %indvars.iv.next75, %bb.k ] ; 5 uses
  %.15161 = phi i32 [ %.05067, %.lr.ph.i.preheader.lr.ph ], [ %.2, %bb.k ] ; 2 uses
  %.15559 = phi i32 [ %.05465, %.lr.ph.i.preheader.lr.ph ], [ %.256, %bb.k ] ; 3 uses
  %i.ap = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %indvars.iv74
  ...
  %i.bf = load i32, ptr %i.k, align 4, !tbaa !154
  %.promoted.i = load i32, ptr %i.am, align 4, !tbaa !150
  br label %bb.f

bb.f:                                             ; preds = %bb.f, %.lr.ph.i.preheader
  %indvars.iv119.i = phi i64 [ %i.y, %.lr.ph.i.preheader ], [ %indvars.iv.next120.i, %bb.f ] ; 2 uses
  %i.bg = phi i32 [ %.promoted.i, %.lr.ph.i.preheader ], [ %i.bz, %bb.f ] ; 2 uses
  %i.bh = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %indvars.iv119.i
  %i.bi = load i32, ptr %i.bh, align 4, !tbaa !40
  %i.bj = ashr i32 %i.bi, 1
  %i.bk = sext i32 %i.bj to i64
  %i.bl = getelementptr inbounds [64 x i8], ptr %2, i64 %i.bk
  %i.bm = getelementptr inbounds nuw i8, ptr %i.bl, i64 56
  %i.bn = load i32, ptr %i.bm, align 4, !tbaa !150 ; 2 uses
  %i.bo = ashr i32 %i.bg, 4                       ; 3 uses
  %i.bp = ashr i32 %i.bn, 4                       ; 3 uses
  %i.bq = tail call noundef i32 @llvm.smax.i32(i32 %i.bo, i32 %i.bp)
  %.not.i.i = icmp slt i32 %i.bo, %i.bp
  %i.br = and i32 %i.bg, 15
  %i.bs = select i1 %.not.i.i, i32 1, i32 %i.br
  %.not13.i.i = icmp slt i32 %i.bp, %i.bo
  %i.bt = and i32 %i.bn, 15
  %i.bu = select i1 %.not13.i.i, i32 1, i32 %i.bt
  %i.bv = add nuw nsw i32 %i.bs, %i.bu            ; 2 uses
  %i.bw = shl nsw i32 %i.bq, 4
  %i.bx = icmp sgt i32 %i.bv, %i.bf
  %i.by = select i1 %i.bx, i32 18, i32 %i.bv
  %i.bz = add nsw i32 %i.by, %i.bw                ; 2 uses
  store i32 %i.bz, ptr %i.am, align 4, !tbaa !150
  %indvars.iv.next120.i = add nuw nsw i64 %indvars.iv119.i, 1 ; 2 uses
  %i.ca = and i64 %indvars.iv.next120.i, 4294967295
  %exitcond = icmp eq i64 %i.ca, %indvars.iv74
  br i1 %exitcond, label %Str_MuxChangeOnce.exit.loopexit, label %bb.f, !llvm.loop !161

Str_MuxChangeOnce.exit.loopexit:                  ; preds = %bb.f
...
bb.g:                                             ; preds = %Str_MuxChangeOnce.exit.loopexit
  %i.cd = icmp sgt i32 %.15161, 0
  %i.ce = icmp eq i32 %.15559, %i.cb
  %or.cond = select i1 %i.cd, i1 %i.ce, i1 false
  br i1 %or.cond, label %bb.h, label %bb.i

bb.h:                                             ; preds = %bb.g, %Str_MuxChangeOnce.exit.loopexit
  %i.cf = trunc nuw nsw i64 %indvars.iv74 to i32
...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  %exitcond79.not = icmp eq i64 %indvars.iv.next75, %wide.trip.count83
  br i1 %exitcond79.not, label %._crit_edge.loopexit, label %.lr.ph.i.preheader, !llvm.loop !164

._crit_edge.loopexit:                             ; preds = %bb.k
  %i.cj = add i32 %.068, %indvars.iv76
  br label %._crit_edge

._crit_edge:                                      ; preds = %.._crit_edge_crit_edge, %._crit_edge.loopexit
  %indvars.iv.next81.pre-phi = phi i64 [ %.pre85, %.._crit_edge_crit_edge ], [ %i.y, %._crit_edge.loopexit ] ; 2 uses
  ...
  %exitcond84.not = icmp eq i64 %indvars.iv.next81.pre-phi, %wide.trip.count83
  br i1 %exitcond84.not, label %._crit_edge70, label %bb.e, !llvm.loop !165

._crit_edge70:                                    ; preds = %._crit_edge
  %i.ck = icmp eq i32 %.151.lcssa, -1
  br i1 %i.ck, label %._crit_edge70.thread, label %bb.m

._crit_edge70.thread:                             ; preds = %bb.d, %._crit_edge70
  br i1 %.not, label %.critedge, label %bb.l

bb.l:                                             ; preds = %._crit_edge70.thread
...
.critedge:                                        ; preds = %bb.n, %bb.m, %._crit_edge70.thread, %bb.l, %bb.a
  %.057 = phi i32 [ 0, %._crit_edge70.thread ], [ 0, %bb.a ], [ 0, %bb.l ], [ 1, %bb.m ], [ 1, %bb.n ]
...
.peel.next:                                       ; preds = %.peel.begin, %.peel.next
  ...
  %.not = icmp eq i32 %i.d, 0
  br i1 %.not, label %.loopexit, label %.peel.next, !llvm.loop !169
...
; Function Attrs: nounwind uwtable
define i32 @Str_MuxRestructureArea(ptr noundef %0, ptr nofree noundef readonly captures(none) %1, i32 noundef %2, i32 noundef %3, ptr noundef %4, i32 noundef %5, i32 noundef %6) local_unnamed_addr #0 {
bb.a:
  %7 = alloca [10000 x %struct.Str_Mux_t_], align 16 ; 6 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %7) #29
  %i.a = icmp sgt i32 %3, 9999
