...
Str_MuxFindPath_rec.exit:                         ; preds = %bb.c, %bb.b
  %.014.i16.lcssa.wide = phi i32 [ 0, %bb.b ], [ 1, %bb.c ]
  %i.u = tail call i32 @Str_MuxFindPathEdge_rec(ptr noundef nonnull %i.j, i32 noundef %.014.i16.lcssa.wide, ptr noundef %2, ptr noundef %3), !inline_history !163
...
bb.b:                                             ; preds = %bb.c, %bb.a
  %.01416.lcssa.wide = phi i32 [ 0, %bb.a ], [ 1, %bb.c ]
  %i.i = tail call i32 @Str_MuxFindPathEdge_rec(ptr noundef nonnull %0, i32 noundef %.01416.lcssa.wide, ptr noundef %1, ptr noundef %2)
  br label %bb.e
...
bb.e:                                             ; preds = %.lr.ph70, %._crit_edge
  ...
  %.05068 = phi i32 [ 0, %.lr.ph70 ], [ %.1.lcssa, %._crit_edge ] ; 2 uses
  %.05167 = phi i32 [ -1, %.lr.ph70 ], [ %.152.lcssa, %._crit_edge ] ; 2 uses
  %.05565 = phi i32 [ %i.c, %.lr.ph70 ], [ %.156.lcssa, %._crit_edge ] ; 2 uses
...
._crit_edge.i:                                    ; preds = %.lr.ph, %bb.k
  ...
  %.15261 = phi i32 [ %.05167, %.lr.ph ], [ %.2, %bb.k ] ; 2 uses
  %.15659 = phi i32 [ %.05565, %.lr.ph ], [ %.257, %bb.k ] ; 3 uses
...
Str_MuxChangeOnce.exit:                           ; preds = %bb.f
  ...
  %i.cb = icmp sgt i32 %.15659, %i.ca
  br i1 %i.cb, label %bb.h, label %bb.g

bb.g:                                             ; preds = %Str_MuxChangeOnce.exit
  %i.cc = icmp sgt i32 %.15261, 0
  %i.cd = icmp eq i32 %.15659, %i.ca
...
bb.i:                                             ; preds = %bb.h, %bb.g
  %.257 = phi i32 [ %i.ca, %bb.h ], [ %.15659, %bb.g ] ; 3 uses
  %.2 = phi i32 [ %i.cf, %bb.h ], [ %.15261, %bb.g ] ; 2 uses
  br i1 %.not, label %bb.k, label %bb.j

bb.j:                                             ; preds = %bb.i
  %i.cg = trunc nuw nsw i64 %indvars.iv75 to i32
  %i.ch = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.19, i32 noundef %i.an, i32 noundef %i.cg, i32 noundef %i.ca, i32 noundef %.257) ; 0 uses
  br label %bb.k
...
._crit_edge.loopexit:                             ; preds = %bb.k
  %i.ci = add i32 %.05068, %indvars.iv77
  br label %._crit_edge

._crit_edge:                                      ; preds = %.._crit_edge_crit_edge, %._crit_edge.loopexit
  %indvars.iv.next82.pre-phi = phi i64 [ %.pre86, %.._crit_edge_crit_edge ], [ %i.y, %._crit_edge.loopexit ] ; 2 uses
  %.156.lcssa = phi i32 [ %.05565, %.._crit_edge_crit_edge ], [ %.257, %._crit_edge.loopexit ] ; 2 uses
  %.152.lcssa = phi i32 [ %.05167, %.._crit_edge_crit_edge ], [ %.2, %._crit_edge.loopexit ] ; 4 uses
  %.1.lcssa = phi i32 [ %.05068, %.._crit_edge_crit_edge ], [ %i.ci, %._crit_edge.loopexit ] ; 2 uses
...
bb.m:                                             ; preds = %._crit_edge71
  %i.ck = ashr i32 %.152.lcssa, 16                ; 2 uses
  %i.cl = and i32 %.152.lcssa, 65535              ; 2 uses
...
bb.n:                                             ; preds = %bb.m
  ...
  %i.cn = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.21, i32 noundef %i.cm, i32 noundef %i.ck, i32 noundef %i.cl, i32 noundef %.1.lcssa, i32 noundef %i.c, i32 noundef %.156.lcssa) ; 0 uses
  %putchar = tail call i32 @putchar(i32 10)       ; 0 uses
  br label %.critedge

.critedge:                                        ; preds = %bb.n, %bb.m, %._crit_edge71.thread, %bb.l, %bb.a
  %.0 = phi i32 [ 0, %._crit_edge71.thread ], [ 0, %bb.a ], [ 0, %bb.l ], [ 1, %bb.m ], [ 1, %bb.n ]
