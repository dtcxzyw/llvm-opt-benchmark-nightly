...
bb.f:                                             ; preds = %bb.f, %.lr.ph.i.preheader
  ...
  %exitcond = icmp eq i64 %indvars.iv.next120.i, %indvars.iv74
...
bb.h:                                             ; preds = %bb.g, %Str_MuxChangeOnce.exit.loopexit
  %i.ce = trunc nuw nsw i64 %indvars.iv74 to i32
...
bb.j:                                             ; preds = %bb.i
  %i.cg = trunc nuw nsw i64 %indvars.iv74 to i32
...
._crit_edge70:                                    ; preds = %._crit_edge
  ...
  br i1 %i.cj, label %._crit_edge70.thread, label %bb.m
