Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/abc/original/wlcNtk?download=true
...
bb.d:                                             ; preds = %.lr.ph, %bb.cf
  ...
  %.0328825 = phi i64 [ 0, %.lr.ph ], [ %.1329.a, %bb.cf ]
  %.0330824 = phi i32 [ 0, %.lr.ph ], [ %.1331, %bb.cf ]
...
bb.f:                                             ; preds = %bb.e, %bb.d
  ...
  %i.av = icmp ne ptr %.0332823, null
  %3 = select i1 %.not349, i1 true, i1 %i.av
  %.2334 = select i1 %3, ptr %.0332823, ptr %i.ae ; 4 uses
  %not..not349 = xor i1 %.not349, true
  %4 = zext i1 %not..not349 to i32
  %.1331 = add nuw nsw i32 %.0330824, %4          ; 3 uses
  %i.aw = and i16 %.val360, 61
  %narrow.i.not = icmp eq i16 %i.aw, 1
  br i1 %narrow.i.not, label %bb.h, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.ax = and i16 %.val360, 63                    ; 7 uses
  switch i16 %i.ax, label %bb.j [
    i16 6, label %bb.h
    i16 23, label %bb.h
    i16 7, label %bb.i
    i16 22, label %bb.i
...
bb.i:                                             ; preds = %bb.g, %bb.g, %bb.g, %bb.g, %bb.g, %bb.g, %bb.g, %bb.g
  ...
  %i.bh = sub nsw i32 %.val.i562, %i.au
  %i.bi = tail call i32 @llvm.abs.i32(i32 %i.bh, i1 true)
  %i.bj = lshr i16 %.val360, 6
  %i.bk = and i16 %i.bj, 1
  %i.bl = zext nneg i16 %i.bk to i32
  %i.bm = shl nuw i32 %i.bi, 1
  %i.bn = add i32 %i.bm, 2
  %i.bo = or disjoint i32 %i.bn, %i.bl
  %i.bp = getelementptr inbounds nuw i8, ptr %i.ae, i64 4
  %i.bq = load i32, ptr %i.bp, align 4, !tbaa !38
  %i.br = icmp ugt i32 %i.bq, 2
  %cond = icmp eq i16 %i.ax, 22
  %or.cond814 = or i1 %cond, %i.br
  %i.bs = getelementptr inbounds nuw i8, ptr %i.ae, i64 16 ; 2 uses
...
Wlc_ObjFanin0.exit:                               ; preds = %bb.i, %Wlc_ObjHasArray.exit.thread.i.i.i
  %i.bu = phi ptr [ %i.bt, %Wlc_ObjHasArray.exit.thread.i.i.i ], [ %i.bs, %bb.i ]
  %i.bv = load i32, ptr %i.bu, align 4, !tbaa !11
  %.val.i565 = load ptr, ptr %i.s, align 8, !tbaa !29
  %i.bw = sext i32 %i.bv to i64
  %i.bx = getelementptr inbounds [24 x i8], ptr %.val.i565, i64 %i.bw ; 3 uses
  %i.by = getelementptr i8, ptr %i.bx, i64 8
  %.val.i566 = load i32, ptr %i.by, align 8, !tbaa !35
  %i.bz = getelementptr i8, ptr %i.bx, i64 12
  %.val2.i567 = load i32, ptr %i.bz, align 4, !tbaa !37
  %i.ca = sub nsw i32 %.val.i566, %.val2.i567
  %i.cb = tail call i32 @llvm.abs.i32(i32 %i.ca, i1 true)
  %.val3.i568 = load i16, ptr %i.bx, align 8
  %i.cc = lshr i16 %.val3.i568, 6
  %i.cd = and i16 %i.cc, 1
  %i.ce = zext nneg i16 %i.cd to i32
  %i.cf = shl nuw i32 %i.cb, 1
  %i.cg = add i32 %i.cf, 2
  %i.ch = or disjoint i32 %i.cg, %i.ce
  %i.ci = sext i32 %i.ch to i64
  %i.cj = shl nsw i64 %i.ci, 21
  %i.ck = sext i32 %i.bo to i64
  %i.cl = or i64 %i.cj, %i.ck
  br label %bb.v

bb.j:                                             ; preds = %bb.g
  %i.cm = getelementptr i8, ptr %i.ae, i64 4
  %.val365 = load i32, ptr %i.cm, align 4, !tbaa !38 ; 2 uses
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.cn = icmp slt i32 %.val.i569, 1
  br i1 %i.cn, label %bb.n, label %bb.l

bb.l:                                             ; preds = %bb.k
  %.val9.i = load ptr, ptr %i.u, align 8, !tbaa !25
  %i.co = getelementptr inbounds nuw [4 x i8], ptr %.val9.i, i64 %indvars.iv839
  %i.cp = load i32, ptr %i.co, align 4, !tbaa !11 ; 2 uses
  %.not7.i = icmp eq i32 %i.cp, 0
  br i1 %.not7.i, label %bb.n, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.cq = load ptr, ptr %i.v, align 8, !tbaa !39
  %i.cr = tail call ptr @Abc_NamStr(ptr noundef %i.cq, i32 noundef %i.cp) #27
  %.pre886 = trunc nuw nsw i64 %indvars.iv839 to i32
  br label %Wlc_ObjName.exit

bb.n:                                             ; preds = %bb.l, %bb.k
  %i.cs = trunc nuw nsw i64 %indvars.iv839 to i32 ; 2 uses
  %i.ct = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) @Wlc_ObjName.Buffer, ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %i.cs) #27 ; 0 uses
  br label %Wlc_ObjName.exit

Wlc_ObjName.exit:                                 ; preds = %bb.m, %bb.n
  %.pre-phi = phi i32 [ %.pre886, %bb.m ], [ %i.cs, %bb.n ]
  %.0.i = phi ptr [ %i.cr, %bb.m ], [ @Wlc_ObjName.Buffer, %bb.n ]
  %i.cu = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, i32 noundef %.pre-phi, ptr noundef %.0.i) ; 0 uses
  %.pre853 = load i16, ptr %i.ae, align 8
  br label %bb.v

bb.o:                                             ; preds = %bb.j
  %.val.i570 = load i32, ptr %i.af, align 8, !tbaa !35
  %i.cv = sub nsw i32 %.val.i570, %i.au
  %i.cw = tail call i32 @llvm.abs.i32(i32 %i.cv, i1 true)
  %i.cx = lshr i16 %.val360, 6
  %i.cy = and i16 %i.cx, 1
  %i.cz = zext nneg i16 %i.cy to i32
  %i.da = shl nuw i32 %i.cw, 1
  %i.db = add i32 %i.da, 2
  %i.dc = or disjoint i32 %i.db, %i.cz
  %i.dd = getelementptr inbounds nuw i8, ptr %i.ae, i64 16 ; 2 uses
  switch i16 %i.ax, label %Wlc_ObjFanin0.exit575 [
...
Wlc_ObjFanin0.exit575:                            ; preds = %bb.o, %Wlc_ObjHasArray.exit.thread.i.i.i573
  %i.df = phi ptr [ %i.de, %Wlc_ObjHasArray.exit.thread.i.i.i573 ], [ %i.dd, %bb.o ]
  %i.dg = load i32, ptr %i.df, align 4, !tbaa !11
  %.val.i574 = load ptr, ptr %i.s, align 8, !tbaa !29
  %i.dh = sext i32 %i.dg to i64
  %i.di = getelementptr inbounds [24 x i8], ptr %.val.i574, i64 %i.dh ; 3 uses
  %i.dj = getelementptr i8, ptr %i.di, i64 8
  %.val.i576 = load i32, ptr %i.dj, align 8, !tbaa !35
  %i.dk = getelementptr i8, ptr %i.di, i64 12
  %.val2.i577 = load i32, ptr %i.dk, align 4, !tbaa !37
  %i.dl = sub nsw i32 %.val.i576, %.val2.i577
  %i.dm = tail call i32 @llvm.abs.i32(i32 %i.dl, i1 true)
  %.val3.i578 = load i16, ptr %i.di, align 8
  %i.dn = lshr i16 %.val3.i578, 6
  %i.do = and i16 %i.dn, 1
  %i.dp = zext nneg i16 %i.do to i32
  %i.dq = shl nuw i32 %i.dm, 1
  %i.dr = add i32 %i.dq, 2
  %i.ds = or disjoint i32 %i.dr, %i.dp
  %i.dt = sext i32 %i.ds to i64
  %i.du = shl nsw i64 %i.dt, 21
  %i.dv = sext i32 %i.dc to i64
  %i.dw = or i64 %i.du, %i.dv
  br label %bb.v

bb.p:                                             ; preds = %bb.j
  %.val.i579 = load i32, ptr %i.af, align 8, !tbaa !35
  %i.dx = sub nsw i32 %.val.i579, %i.au
  %i.dy = tail call i32 @llvm.abs.i32(i32 %i.dx, i1 true)
  %i.dz = lshr i16 %.val360, 6
  %i.ea = and i16 %i.dz, 1
  %i.eb = zext nneg i16 %i.ea to i32
  %i.ec = shl nuw i32 %i.dy, 1
  %i.ed = add i32 %i.ec, 2
  %i.ee = or disjoint i32 %i.ed, %i.eb
  %i.ef = icmp ugt i32 %.val365, 2                ; 3 uses
  %i.eg = getelementptr inbounds nuw i8, ptr %i.ae, i64 16 ; 3 uses
  br i1 %i.ef, label %Wlc_ObjFaninId.exit.thread810, label %bb.q

bb.q:                                             ; preds = %bb.p
  switch i16 %i.ax, label %Wlc_ObjFaninId.exit.thread [
...
Wlc_ObjFaninId.exit:                              ; preds = %bb.q, %bb.q
  ...
  %i.ei = load i32, ptr %i.eh, align 4, !tbaa !11
  %.not351 = icmp eq i32 %i.ei, 0
...
Wlc_ObjFaninId.exit.thread810:                    ; preds = %bb.p
  %i.el = load ptr, ptr %i.eg, align 8, !tbaa !32
  %i.em = load i32, ptr %i.el, align 4, !tbaa !11
  %.not351811 = icmp eq i32 %i.em, 0
...
Wlc_ObjFaninId.exit.thread:                       ; preds = %bb.q
  %i.en = load i32, ptr %i.eg, align 8, !tbaa !11 ; 2 uses
  %.not351806 = icmp eq i32 %i.en, 0
  br i1 %.not351806, label %.thread807, label %.thread

.thread:                                          ; preds = %Wlc_ObjFaninId.exit, %Wlc_ObjFaninId.exit.thread
  %i.eo = phi i32 [ %i.ek, %Wlc_ObjFaninId.exit ], [ %i.en, %Wlc_ObjFaninId.exit.thread ]
  switch i16 %i.ax, label %bb.r [
...
Wlc_ObjHasArray.exit.thread.i.i.i582:             ; preds = %Wlc_ObjFaninId.exit.thread810, %.thread, %.thread
  %i.ep = getelementptr inbounds nuw i8, ptr %i.ae, i64 16
  %i.eq = load ptr, ptr %i.ep, align 8, !tbaa !32
  %.pre852 = load i32, ptr %i.eq, align 4, !tbaa !11
  br label %bb.r

bb.r:                                             ; preds = %Wlc_ObjHasArray.exit.thread.i.i.i582, %.thread
  %i.er = phi i32 [ %.pre852, %Wlc_ObjHasArray.exit.thread.i.i.i582 ], [ %i.eo, %.thread ]
  %.val.i583 = load ptr, ptr %i.s, align 8, !tbaa !29
  %i.es = sext i32 %i.er to i64
  %i.et = getelementptr inbounds [24 x i8], ptr %.val.i583, i64 %i.es ; 3 uses
  %i.eu = getelementptr i8, ptr %i.et, i64 8
  %.val.i585 = load i32, ptr %i.eu, align 8, !tbaa !35
  %i.ev = getelementptr i8, ptr %i.et, i64 12
  %.val2.i586 = load i32, ptr %i.ev, align 4, !tbaa !37
  %i.ew = sub nsw i32 %.val.i585, %.val2.i586
  %i.ex = tail call i32 @llvm.abs.i32(i32 %i.ew, i1 true)
  %.val3.i587 = load i16, ptr %i.et, align 8
  %i.ey = lshr i16 %.val3.i587, 6
  %i.ez = and i16 %i.ey, 1
  %i.fa = zext nneg i16 %i.ez to i32
  %i.fb = shl nuw i32 %i.ex, 1
  %i.fc = add i32 %i.fb, 2
  %i.fd = or disjoint i32 %i.fc, %i.fa            ; 2 uses
  br i1 %i.ef, label %Wlc_ObjFaninId.exit589, label %.thread807

.thread807:                                       ; preds = %Wlc_ObjFaninId.exit, %Wlc_ObjFaninId.exit.thread, %bb.r
  %i.fe = phi i32 [ %i.fd, %bb.r ], [ 0, %Wlc_ObjFaninId.exit.thread ], [ 0, %Wlc_ObjFaninId.exit ] ; 4 uses
  switch i16 %i.ax, label %Wlc_ObjFaninId.exit589.thread [
...
Wlc_ObjFaninId.exit589:                           ; preds = %Wlc_ObjFaninId.exit.thread810, %bb.r, %.thread807, %.thread807
  %i.ff = phi i32 [ %i.fe, %.thread807 ], [ %i.fe, %.thread807 ], [ %i.fd, %bb.r ], [ 0, %Wlc_ObjFaninId.exit.thread810 ] ; 3 uses
  %i.fg = getelementptr inbounds nuw i8, ptr %i.ae, i64 16
  %i.fh = load ptr, ptr %i.fg, align 8, !tbaa !32
  %i.fi = getelementptr inbounds nuw i8, ptr %i.fh, i64 4
  %i.fj = load i32, ptr %i.fi, align 4, !tbaa !11
  %.not352 = icmp eq i32 %i.fj, 0
  br i1 %.not352, label %bb.u, label %bb.s

Wlc_ObjFaninId.exit589.thread:                    ; preds = %.thread807
  %i.fk = getelementptr inbounds nuw i8, ptr %i.ae, i64 20
  %i.fl = load i32, ptr %i.fk, align 4, !tbaa !11
  %.not352808 = icmp eq i32 %i.fl, 0
  br i1 %.not352808, label %bb.u, label %.thread809

bb.s:                                             ; preds = %Wlc_ObjFaninId.exit589
  br i1 %i.ef, label %Wlc_ObjHasArray.exit.thread.i.i.i590, label %.thread809

.thread809:                                       ; preds = %Wlc_ObjFaninId.exit589.thread, %bb.s
  %i.fm = phi i32 [ %i.ff, %bb.s ], [ %i.fe, %Wlc_ObjFaninId.exit589.thread ] ; 3 uses
  switch i16 %i.ax, label %bb.t [
...
Wlc_ObjHasArray.exit.thread.i.i.i590:             ; preds = %.thread809, %.thread809, %bb.s
  %i.fn = phi i32 [ %i.fm, %.thread809 ], [ %i.fm, %.thread809 ], [ %i.ff, %bb.s ]
  %i.fo = getelementptr inbounds nuw i8, ptr %i.ae, i64 16
  %i.fp = load ptr, ptr %i.fo, align 8, !tbaa !32
  br label %Wlc_ObjFanin1.exit

bb.t:                                             ; preds = %.thread809
  %i.fq = getelementptr inbounds nuw i8, ptr %i.ae, i64 16
  br label %Wlc_ObjFanin1.exit

Wlc_ObjFanin1.exit:                               ; preds = %Wlc_ObjHasArray.exit.thread.i.i.i590, %bb.t
  %i.fr = phi i32 [ %i.fn, %Wlc_ObjHasArray.exit.thread.i.i.i590 ], [ %i.fm, %bb.t ]
  %i.fs = phi ptr [ %i.fp, %Wlc_ObjHasArray.exit.thread.i.i.i590 ], [ %i.fq, %bb.t ]
  %i.ft = getelementptr inbounds nuw i8, ptr %i.fs, i64 4
  %i.fu = load i32, ptr %i.ft, align 4, !tbaa !11
  %.val.i591 = load ptr, ptr %i.s, align 8, !tbaa !29
  %i.fv = sext i32 %i.fu to i64
  %i.fw = getelementptr inbounds [24 x i8], ptr %.val.i591, i64 %i.fv ; 3 uses
  %i.fx = getelementptr i8, ptr %i.fw, i64 8
  %.val.i592 = load i32, ptr %i.fx, align 8, !tbaa !35
  %i.fy = getelementptr i8, ptr %i.fw, i64 12
  %.val2.i593 = load i32, ptr %i.fy, align 4, !tbaa !37
  %i.fz = sub nsw i32 %.val.i592, %.val2.i593
  %i.ga = tail call i32 @llvm.abs.i32(i32 %i.fz, i1 true)
  %.val3.i594 = load i16, ptr %i.fw, align 8
  %i.gb = lshr i16 %.val3.i594, 6
  %i.gc = and i16 %i.gb, 1
  %i.gd = zext nneg i16 %i.gc to i32
  %i.ge = shl nuw i32 %i.ga, 1
  %i.gf = add i32 %i.ge, 2
  %i.gg = or disjoint i32 %i.gf, %i.gd
  %i.gh = zext i32 %i.gg to i64
  %i.gi = shl i64 %i.gh, 42
  br label %bb.u

bb.u:                                             ; preds = %Wlc_ObjFaninId.exit589.thread, %Wlc_ObjFaninId.exit589, %Wlc_ObjFanin1.exit
  %i.gj = phi i32 [ %i.fr, %Wlc_ObjFanin1.exit ], [ %i.ff, %Wlc_ObjFaninId.exit589 ], [ %i.fe, %Wlc_ObjFaninId.exit589.thread ]
  %i.gk = phi i64 [ %i.gi, %Wlc_ObjFanin1.exit ], [ 0, %Wlc_ObjFaninId.exit589 ], [ 0, %Wlc_ObjFaninId.exit589.thread ]
  %i.gl = sext i32 %i.gj to i64
  %i.gm = shl nsw i64 %i.gl, 21
  %i.gn = sext i32 %i.ee to i64
  %i.go = or i64 %i.gk, %i.gn
  %i.gp = or i64 %i.go, %i.gm
  br label %bb.v

bb.v:                                             ; preds = %Wlc_ObjFanin0.exit, %Wlc_ObjFanin0.exit575, %bb.u, %Wlc_ObjName.exit, %bb.h
  %i.gq = phi i16 [ %.val360, %bb.h ], [ %.val360, %Wlc_ObjFanin0.exit ], [ %.pre853, %Wlc_ObjName.exit ], [ %.val360, %Wlc_ObjFanin0.exit575 ], [ %.val360, %bb.u ]
  %.1329.a = phi i64 [ %i.bg, %bb.h ], [ %i.cl, %Wlc_ObjFanin0.exit ], [ %.0328825, %Wlc_ObjName.exit ], [ %i.dw, %Wlc_ObjFanin0.exit575 ], [ %i.gp, %bb.u ] ; 3 uses
  %i.gr = and i16 %i.gq, 63
  %i.gs = zext nneg i16 %i.gr to i64              ; 2 uses
  %i.gt = getelementptr inbounds nuw [8 x i8], ptr %calloc.i, i64 %i.gs
  %i.gu = load ptr, ptr %i.gt, align 8, !tbaa !100 ; 7 uses
  %i.gv = getelementptr inbounds nuw [8 x i8], ptr %calloc.i558, i64 %i.gs
  %i.gw = load ptr, ptr %i.gv, align 8, !tbaa !100 ; 7 uses
  %i.gx = getelementptr i8, ptr %i.gu, i64 4      ; 3 uses
  %.val16.i = load i32, ptr %i.gx, align 4, !tbaa !101 ; 9 uses
  %i.gy = icmp sgt i32 %.val16.i, 0
  br i1 %i.gy, label %.lr.ph.i, label %.critedge.i

.lr.ph.i:                                         ; preds = %bb.v
  %i.gz = getelementptr i8, ptr %i.gu, i64 8
  %.val17.i = load ptr, ptr %i.gz, align 8, !tbaa !47
...
bb.x:                                             ; preds = %bb.w, %.lr.ph.i
  ...
  %i.ha = getelementptr inbounds nuw [8 x i8], ptr %.val17.i, i64 %indvars.iv.i
  %i.hb = load i64, ptr %i.ha, align 8, !tbaa !102
  %i.hc = icmp eq i64 %i.hb, %.1329.a
  br i1 %i.hc, label %bb.y, label %bb.w

bb.y:                                             ; preds = %bb.x
  %i.hd = getelementptr i8, ptr %i.gw, i64 8
  %.val18.i = load ptr, ptr %i.hd, align 8, !tbaa !47
  %i.he = getelementptr inbounds nuw [8 x i8], ptr %.val18.i, i64 %indvars.iv.i ; 2 uses
  %i.hf = load i64, ptr %i.he, align 8, !tbaa !102
  %i.hg = add i64 %i.hf, 1
  store i64 %i.hg, ptr %i.he, align 8, !tbaa !102
  br label %Wlc_NtkPrintDistribAddOne.exit

.critedge.i:                                      ; preds = %bb.w, %bb.v
  %i.hh = load i32, ptr %i.gu, align 8, !tbaa !110
  %i.hi = icmp eq i32 %.val16.i, %i.hh
  br i1 %i.hi, label %bb.z, label %Vec_WrdPush.exit.i

bb.z:                                             ; preds = %.critedge.i
  %i.hj = icmp slt i32 %.val16.i, 16
  br i1 %i.hj, label %bb.aa, label %bb.ad

bb.aa:                                            ; preds = %bb.z
  %i.hk = getelementptr inbounds nuw i8, ptr %i.gu, i64 8 ; 2 uses
  %i.hl = load ptr, ptr %i.hk, align 8, !tbaa !47 ; 2 uses
  %.not9.i.i.i = icmp eq ptr %i.hl, null
  br i1 %.not9.i.i.i, label %bb.ac, label %bb.ab

bb.ab:                                            ; preds = %bb.aa
  %i.hm = tail call dereferenceable_or_null(128) ptr @realloc(ptr noundef nonnull %i.hl, i64 noundef 128) #29
  br label %Vec_WrdGrow.exit.i.i

bb.ac:                                            ; preds = %bb.aa
  %i.hn = tail call noalias dereferenceable_or_null(128) ptr @malloc(i64 noundef 128) #28
  br label %Vec_WrdGrow.exit.i.i

Vec_WrdGrow.exit.i.i:                             ; preds = %bb.ac, %bb.ab
  %i.ho = phi ptr [ %i.hm, %bb.ab ], [ %i.hn, %bb.ac ]
  store ptr %i.ho, ptr %i.hk, align 8, !tbaa !47
  br label %Vec_WrdGrow.exit11.sink.split.i.i

bb.ad:                                            ; preds = %bb.z
  %i.hp = icmp samesign ult i32 %.val16.i, 1073741823
  %i.hq = shl nuw nsw i32 %.val16.i, 1
  %spec.select.i.i = select i1 %i.hp, i32 %i.hq, i32 2147483647 ; 3 uses
  %.not.i9.i.i = icmp samesign ult i32 %.val16.i, %spec.select.i.i
  br i1 %.not.i9.i.i, label %bb.ae, label %Vec_WrdPush.exit.i

bb.ae:                                            ; preds = %bb.ad
  %i.hr = getelementptr inbounds nuw i8, ptr %i.gu, i64 8 ; 2 uses
  %i.hs = load ptr, ptr %i.hr, align 8, !tbaa !47 ; 2 uses
  %.not9.i10.i.i = icmp eq ptr %i.hs, null
  %i.ht = zext nneg i32 %spec.select.i.i to i64
  %i.hu = shl nuw nsw i64 %i.ht, 3                ; 2 uses
  br i1 %.not9.i10.i.i, label %bb.ag, label %bb.af

bb.af:                                            ; preds = %bb.ae
  %i.hv = tail call ptr @realloc(ptr noundef nonnull %i.hs, i64 noundef %i.hu) #29
  br label %bb.ah

bb.ag:                                            ; preds = %bb.ae
  %i.hw = tail call noalias ptr @malloc(i64 noundef %i.hu) #28
  br label %bb.ah

bb.ah:                                            ; preds = %bb.ag, %bb.af
  %i.hx = phi ptr [ %i.hv, %bb.af ], [ %i.hw, %bb.ag ]
  store ptr %i.hx, ptr %i.hr, align 8, !tbaa !47
  br label %Vec_WrdGrow.exit11.sink.split.i.i
...
Vec_WrdGrow.exit11.sink.split.i.i:                ; preds = %bb.ah, %Vec_WrdGrow.exit.i.i
  ...
  store i32 %spec.select.sink.i.i, ptr %i.gu, align 8, !tbaa !110
  %.pre.i = load i32, ptr %i.gx, align 4, !tbaa !101
  br label %Vec_WrdPush.exit.i

Vec_WrdPush.exit.i:                               ; preds = %Vec_WrdGrow.exit11.sink.split.i.i, %bb.ad, %.critedge.i
  %i.hy = phi i32 [ %.val16.i, %.critedge.i ], [ %.val16.i, %bb.ad ], [ %.pre.i, %Vec_WrdGrow.exit11.sink.split.i.i ] ; 2 uses
  %i.hz = getelementptr inbounds nuw i8, ptr %i.gu, i64 8
  %i.ia = load ptr, ptr %i.hz, align 8, !tbaa !47
  %i.ib = add nsw i32 %i.hy, 1
  store i32 %i.ib, ptr %i.gx, align 4, !tbaa !101
  %i.ic = sext i32 %i.hy to i64
  %i.id = getelementptr inbounds [8 x i8], ptr %i.ia, i64 %i.ic
  store i64 %.1329.a, ptr %i.id, align 8, !tbaa !102
  %i.ie = getelementptr inbounds nuw i8, ptr %i.gw, i64 4 ; 3 uses
  %i.if = load i32, ptr %i.ie, align 4, !tbaa !101 ; 7 uses
  %i.ig = load i32, ptr %i.gw, align 8, !tbaa !110
  %i.ih = icmp eq i32 %i.if, %i.ig
  br i1 %i.ih, label %bb.ai, label %Vec_WrdPush.exit26.i

bb.ai:                                            ; preds = %Vec_WrdPush.exit.i
  %i.ii = icmp slt i32 %i.if, 16
  br i1 %i.ii, label %bb.aj, label %bb.am

bb.aj:                                            ; preds = %bb.ai
  %i.ij = getelementptr inbounds nuw i8, ptr %i.gw, i64 8 ; 2 uses
  %i.ik = load ptr, ptr %i.ij, align 8, !tbaa !47 ; 2 uses
  %.not9.i.i24.i = icmp eq ptr %i.ik, null
  br i1 %.not9.i.i24.i, label %bb.al, label %bb.ak

bb.ak:                                            ; preds = %bb.aj
  %i.il = tail call dereferenceable_or_null(128) ptr @realloc(ptr noundef nonnull %i.ik, i64 noundef 128) #29
  br label %Vec_WrdGrow.exit.i25.i

bb.al:                                            ; preds = %bb.aj
  %i.im = tail call noalias dereferenceable_or_null(128) ptr @malloc(i64 noundef 128) #28
  br label %Vec_WrdGrow.exit.i25.i

Vec_WrdGrow.exit.i25.i:                           ; preds = %bb.al, %bb.ak
  %i.in = phi ptr [ %i.il, %bb.ak ], [ %i.im, %bb.al ]
  store ptr %i.in, ptr %i.ij, align 8, !tbaa !47
  br label %Vec_WrdGrow.exit11.sink.split.i22.i

bb.am:                                            ; preds = %bb.ai
  %i.io = icmp samesign ult i32 %i.if, 1073741823
  %i.ip = shl nuw nsw i32 %i.if, 1
  %spec.select.i19.i = select i1 %i.io, i32 %i.ip, i32 2147483647 ; 3 uses
  %.not.i9.i20.i = icmp samesign ult i32 %i.if, %spec.select.i19.i
  br i1 %.not.i9.i20.i, label %bb.an, label %Vec_WrdPush.exit26.i

bb.an:                                            ; preds = %bb.am
  %i.iq = getelementptr inbounds nuw i8, ptr %i.gw, i64 8 ; 2 uses
  %i.ir = load ptr, ptr %i.iq, align 8, !tbaa !47 ; 2 uses
  %.not9.i10.i21.i = icmp eq ptr %i.ir, null
  %i.is = zext nneg i32 %spec.select.i19.i to i64
...
bb.ap:                                            ; preds = %bb.an
  %i.iv = tail call noalias ptr @malloc(i64 noundef %i.it) #28
  br label %bb.aq

bb.aq:                                            ; preds = %bb.ap, %bb.ao
  %i.iw = phi ptr [ %i.iu, %bb.ao ], [ %i.iv, %bb.ap ]
  store ptr %i.iw, ptr %i.iq, align 8, !tbaa !47
  br label %Vec_WrdGrow.exit11.sink.split.i22.i
...
Vec_WrdGrow.exit11.sink.split.i22.i:              ; preds = %bb.aq, %Vec_WrdGrow.exit.i25.i
  ...
  store i32 %spec.select.sink.i23.i, ptr %i.gw, align 8, !tbaa !110
  %.pre9.i = load i32, ptr %i.ie, align 4, !tbaa !101
  br label %Vec_WrdPush.exit26.i

Vec_WrdPush.exit26.i:                             ; preds = %Vec_WrdGrow.exit11.sink.split.i22.i, %bb.am, %Vec_WrdPush.exit.i
  %i.ix = phi i32 [ %i.if, %Vec_WrdPush.exit.i ], [ %i.if, %bb.am ], [ %.pre9.i, %Vec_WrdGrow.exit11.sink.split.i22.i ] ; 2 uses
  %i.iy = getelementptr inbounds nuw i8, ptr %i.gw, i64 8
  %i.iz = load ptr, ptr %i.iy, align 8, !tbaa !47
  %i.ja = add nsw i32 %i.ix, 1
  store i32 %i.ja, ptr %i.ie, align 4, !tbaa !101
  %i.jb = sext i32 %i.ix to i64
  %i.jc = getelementptr inbounds [8 x i8], ptr %i.iz, i64 %i.jb
  store i64 1, ptr %i.jc, align 8, !tbaa !102
  br label %Wlc_NtkPrintDistribAddOne.exit

Wlc_NtkPrintDistribAddOne.exit:                   ; preds = %bb.y, %Vec_WrdPush.exit26.i
  %i.jd = load i16, ptr %i.ae, align 8
  %i.je = and i16 %i.jd, 63
  switch i16 %i.je, label %bb.cf [
    i16 8, label %bb.ar
    i16 9, label %bb.as
    i16 10, label %bb.at
    i16 11, label %bb.au
...
begin_hunk_1_@Wlc_NtkPrintDistrib:Vec_IntStart.exit
  %.val431 = load i32, ptr %i.aow, align 4, !tbaa !37
  %i.aox = sub nsw i32 %.val430, %.val431
  %i.aoy = tail call i32 @llvm.abs.i32(i32 %i.aox, i1 true)
  %i.aoz = add nuw nsw i32 %i.aoy, 1
  %i.apa = uitofp nneg i32 %i.aoz to double
  %i.apb = tail call double @pow(double noundef %i.aoo, double noundef %i.apa) #27
  %i.apc = fptosi double %i.apb to i32
  %i.apd = mul nsw i32 %i.apc, 10
  %.val369 = load ptr, ptr %i.d, align 8, !tbaa !25 ; 17 uses
  %i.ape = getelementptr inbounds nuw i8, ptr %.val369, i64 196 ; 2 uses
  %i.apf = load i32, ptr %i.ape, align 4, !tbaa !11
  %i.apg = add nsw i32 %i.apf, %i.apd
  store i32 %i.apg, ptr %i.ape, align 4, !tbaa !11
  br label %bb.cf

bb.cc:                                            ; preds = %Wlc_NtkPrintDistribAddOne.exit
  %i.aph = getelementptr inbounds nuw i8, ptr %i.ae, i64 4
  %i.api = load i32, ptr %i.aph, align 4, !tbaa !38
  %i.apj = icmp ugt i32 %i.api, 2
  %i.apk = getelementptr inbounds nuw i8, ptr %i.ae, i64 16 ; 2 uses
  br i1 %i.apj, label %Wlc_ObjHasArray.exit.thread.i.i.i744, label %Wlc_ObjFanin0.exit746

Wlc_ObjHasArray.exit.thread.i.i.i744:             ; preds = %bb.cc
  %i.apl = load ptr, ptr %i.apk, align 8, !tbaa !32
  br label %Wlc_ObjFanin0.exit746

Wlc_ObjFanin0.exit746:                            ; preds = %bb.cc, %Wlc_ObjHasArray.exit.thread.i.i.i744
  %i.apm = phi ptr [ %i.apl, %Wlc_ObjHasArray.exit.thread.i.i.i744 ], [ %i.apk, %bb.cc ]
  %i.apn = load i32, ptr %i.apm, align 4, !tbaa !11
  %.val.i745 = load ptr, ptr %i.s, align 8, !tbaa !29
  %i.apo = sext i32 %i.apn to i64
  %i.app = getelementptr inbounds [24 x i8], ptr %.val.i745, i64 %i.apo ; 2 uses
  %i.apq = getelementptr i8, ptr %i.app, i64 8
  %.val428 = load i32, ptr %i.apq, align 8, !tbaa !35
  %i.apr = getelementptr i8, ptr %i.app, i64 12
  %.val429 = load i32, ptr %i.apr, align 4, !tbaa !37
  %i.aps = sub nsw i32 %.val428, %.val429
  %i.apt = tail call i32 @llvm.abs.i32(i32 %i.aps, i1 true)
  %i.apu = shl i32 %i.apt, 2
  %.val368 = load ptr, ptr %i.d, align 8, !tbaa !25 ; 17 uses
  %i.apv = getelementptr inbounds nuw i8, ptr %.val368, i64 200 ; 2 uses
  %i.apw = load i32, ptr %i.apv, align 4, !tbaa !11
  %i.apx = add i32 %i.apw, 4
  %i.apy = add i32 %i.apx, %i.apu
  store i32 %i.apy, ptr %i.apv, align 4, !tbaa !11
  br label %bb.cf

bb.cd:                                            ; preds = %Wlc_NtkPrintDistribAddOne.exit
  %i.apz = getelementptr inbounds nuw i8, ptr %i.ae, i64 4
  %i.aqa = load i32, ptr %i.apz, align 4, !tbaa !38
  %i.aqb = icmp ugt i32 %i.aqa, 2                 ; 3 uses
  %i.aqc = getelementptr inbounds nuw i8, ptr %i.ae, i64 16 ; 2 uses
  br i1 %i.aqb, label %Wlc_ObjHasArray.exit.thread.i.i.i747, label %Wlc_ObjFanin0.exit749
...
Wlc_ObjFanin0.exit749:                            ; preds = %bb.cd, %Wlc_ObjHasArray.exit.thread.i.i.i747
  %i.aqe = phi ptr [ %i.aqd, %Wlc_ObjHasArray.exit.thread.i.i.i747 ], [ %i.aqc, %bb.cd ]
  %i.aqf = load i32, ptr %i.aqe, align 4, !tbaa !11
  %.val.i748 = load ptr, ptr %i.s, align 8, !tbaa !29 ; 3 uses
  %i.aqg = sext i32 %i.aqf to i64
  %i.aqh = getelementptr inbounds [24 x i8], ptr %.val.i748, i64 %i.aqg ; 2 uses
  %i.aqi = getelementptr i8, ptr %i.aqh, i64 8
  %.val426 = load i32, ptr %i.aqi, align 8, !tbaa !35
  %i.aqj = getelementptr i8, ptr %i.aqh, i64 12
  %.val427 = load i32, ptr %i.aqj, align 4, !tbaa !37
  %i.aqk = sub nsw i32 %.val426, %.val427
  %i.aql = tail call i32 @llvm.abs.i32(i32 %i.aqk, i1 true)
  %i.aqm = mul i32 %i.aql, 11
  %i.aqn = add i32 %i.aqm, 11
  %i.aqo = getelementptr inbounds nuw i8, ptr %i.ae, i64 16 ; 2 uses
  br i1 %i.aqb, label %Wlc_ObjHasArray.exit.thread.i.i.i750, label %Wlc_ObjFanin0.exit752

Wlc_ObjHasArray.exit.thread.i.i.i750:             ; preds = %Wlc_ObjFanin0.exit749
  %i.aqp = load ptr, ptr %i.aqo, align 8, !tbaa !32
  br label %Wlc_ObjFanin0.exit752

Wlc_ObjFanin0.exit752:                            ; preds = %Wlc_ObjFanin0.exit749, %Wlc_ObjHasArray.exit.thread.i.i.i750
  %i.aqq = phi ptr [ %i.aqp, %Wlc_ObjHasArray.exit.thread.i.i.i750 ], [ %i.aqo, %Wlc_ObjFanin0.exit749 ]
  %i.aqr = load i32, ptr %i.aqq, align 4, !tbaa !11
  %i.aqs = sext i32 %i.aqr to i64
  %i.aqt = getelementptr inbounds [24 x i8], ptr %.val.i748, i64 %i.aqs ; 2 uses
  %i.aqu = getelementptr i8, ptr %i.aqt, i64 8
  %.val424 = load i32, ptr %i.aqu, align 8, !tbaa !35
  %i.aqv = getelementptr i8, ptr %i.aqt, i64 12
  %.val425 = load i32, ptr %i.aqv, align 4, !tbaa !37
  %i.aqw = sub nsw i32 %.val424, %.val425
  %i.aqx = tail call i32 @llvm.abs.i32(i32 %i.aqw, i1 true)
  %i.aqy = add nuw nsw i32 %i.aqx, 1
  %i.aqz = mul nsw i32 %i.aqy, %i.aqn
  %i.ara = lshr i32 %i.aqz, 3
  %i.arb = getelementptr inbounds nuw i8, ptr %i.ae, i64 16 ; 2 uses
  br i1 %i.aqb, label %Wlc_ObjHasArray.exit.thread.i.i.i753, label %Wlc_ObjFanin0.exit755
...
Wlc_ObjFanin0.exit755:                            ; preds = %Wlc_ObjFanin0.exit752, %Wlc_ObjHasArray.exit.thread.i.i.i753
  %i.ard = phi ptr [ %i.arc, %Wlc_ObjHasArray.exit.thread.i.i.i753 ], [ %i.arb, %Wlc_ObjFanin0.exit752 ]
  %i.are = load i32, ptr %i.ard, align 4, !tbaa !11
  %i.arf = sext i32 %i.are to i64
  %i.arg = getelementptr inbounds [24 x i8], ptr %.val.i748, i64 %i.arf ; 2 uses
  %i.arh = getelementptr i8, ptr %i.arg, i64 8
  %.val422 = load i32, ptr %i.arh, align 8, !tbaa !35
  %i.ari = getelementptr i8, ptr %i.arg, i64 12
  %.val423 = load i32, ptr %i.ari, align 4, !tbaa !37
  %i.arj = sub nsw i32 %.val422, %.val423
  %i.ark = tail call i32 @llvm.abs.i32(i32 %i.arj, i1 true)
  %i.arl = mul i32 %i.ark, 5
  %i.arm = add i32 %i.arl, 5
  %i.arn = lshr i32 %i.arm, 1
  %.val367 = load ptr, ptr %i.d, align 8, !tbaa !25 ; 17 uses
  %i.aro = getelementptr inbounds nuw i8, ptr %.val367, i64 204 ; 2 uses
  %i.arp = load i32, ptr %i.aro, align 4, !tbaa !11
  %i.arq = add nsw i32 %i.ara, -5
  %i.arr = add i32 %i.arq, %i.arp
  %i.ars = add i32 %i.arr, %i.arn
  store i32 %i.ars, ptr %i.aro, align 4, !tbaa !11
  br label %bb.cf

bb.ce:                                            ; preds = %Wlc_NtkPrintDistribAddOne.exit
  %i.art = getelementptr inbounds nuw i8, ptr %i.ae, i64 4
  %i.aru = load i32, ptr %i.art, align 4, !tbaa !38
  %i.arv = icmp ugt i32 %i.aru, 2                 ; 2 uses
  %i.arw = getelementptr inbounds nuw i8, ptr %i.ae, i64 16 ; 2 uses
  br i1 %i.arv, label %Wlc_ObjHasArray.exit.thread.i.i.i756, label %Wlc_ObjFanin0.exit758

Wlc_ObjHasArray.exit.thread.i.i.i756:             ; preds = %bb.ce
  %i.arx = load ptr, ptr %i.arw, align 8, !tbaa !32
  br label %Wlc_ObjFanin0.exit758

Wlc_ObjFanin0.exit758:                            ; preds = %bb.ce, %Wlc_ObjHasArray.exit.thread.i.i.i756
  %i.ary = phi ptr [ %i.arx, %Wlc_ObjHasArray.exit.thread.i.i.i756 ], [ %i.arw, %bb.ce ]
  %i.arz = load i32, ptr %i.ary, align 4, !tbaa !11
  %.val.i757 = load ptr, ptr %i.s, align 8, !tbaa !29 ; 2 uses
  %i.asa = sext i32 %i.arz to i64
  %i.asb = getelementptr inbounds [24 x i8], ptr %.val.i757, i64 %i.asa ; 2 uses
  %i.asc = getelementptr i8, ptr %i.asb, i64 8
  %.val420 = load i32, ptr %i.asc, align 8, !tbaa !35
  %i.asd = getelementptr i8, ptr %i.asb, i64 12
  %.val421 = load i32, ptr %i.asd, align 4, !tbaa !37
  %i.ase = sub nsw i32 %.val420, %.val421
  %i.asf = tail call i32 @llvm.abs.i32(i32 %i.ase, i1 true)
  %i.asg = mul i32 %i.asf, 5
  %i.ash = add i32 %i.asg, 5
  %i.asi = getelementptr inbounds nuw i8, ptr %i.ae, i64 16 ; 2 uses
  br i1 %i.arv, label %Wlc_ObjHasArray.exit.thread.i.i.i759, label %Wlc_ObjFanin1.exit761

Wlc_ObjHasArray.exit.thread.i.i.i759:             ; preds = %Wlc_ObjFanin0.exit758
  %i.asj = load ptr, ptr %i.asi, align 8, !tbaa !32
  br label %Wlc_ObjFanin1.exit761

Wlc_ObjFanin1.exit761:                            ; preds = %Wlc_ObjFanin0.exit758, %Wlc_ObjHasArray.exit.thread.i.i.i759
  %i.ask = phi ptr [ %i.asj, %Wlc_ObjHasArray.exit.thread.i.i.i759 ], [ %i.asi, %Wlc_ObjFanin0.exit758 ]
  %i.asl = getelementptr inbounds nuw i8, ptr %i.ask, i64 4
  %i.asm = load i32, ptr %i.asl, align 4, !tbaa !11
  %i.asn = sext i32 %i.asm to i64
  %i.aso = getelementptr inbounds [24 x i8], ptr %.val.i757, i64 %i.asn ; 2 uses
  %i.asp = getelementptr i8, ptr %i.aso, i64 8
  %.val418 = load i32, ptr %i.asp, align 8, !tbaa !35
  %i.asq = getelementptr i8, ptr %i.aso, i64 12
  %.val419 = load i32, ptr %i.asq, align 4, !tbaa !37
  %i.asr = sub nsw i32 %.val418, %.val419
  %i.ass = tail call i32 @llvm.abs.i32(i32 %i.asr, i1 true)
  %i.ast = add nuw nsw i32 %i.ass, 1
  %i.asu = mul nsw i32 %i.ast, %i.ash
  %.val366 = load ptr, ptr %i.d, align 8, !tbaa !25 ; 17 uses
  %i.asv = getelementptr inbounds nuw i8, ptr %.val366, i64 208 ; 2 uses
  %i.asw = load i32, ptr %i.asv, align 4, !tbaa !11
  %i.asx = add nsw i32 %i.asu, %i.asw
  store i32 %i.asx, ptr %i.asv, align 4, !tbaa !11
  br label %bb.cf
...
bb.cf:                                            ; preds = %Wlc_NtkPrintDistribAddOne.exit, %bb.ar, %Wlc_ObjFanin0.exit600, %Wlc_ObjFanin0.exit608, %Wlc_ObjFanin0.exit616, %Wlc_ObjFanin0.exit620, %Wlc_ObjFanin0.exit626, %Wlc_ObjFanin0.exit632, %Wlc_ObjFanin0.exit638, %Wlc_ObjFanin1.exit650, %Wlc_ObjFanin1.exit662, %Wlc_ObjFanin0.exit668, %Wlc_ObjFanin0.exit674, %Wlc_ObjFanin0.exit680, %Wlc_ObjFanin0.exit686, %Wlc_ObjFanin0.exit692, %Wlc_ObjFanin0.exit698, %Wlc_ObjFanin0.exit704, %Wlc_ObjFanin0.exit719, %Wlc_ObjFanin0.exit737, %Wlc_ObjFanin0.exit746, %Wlc_ObjFanin1.exit761, %Wlc_ObjFanin0.exit755, %Wlc_ObjFanin0.exit743, %Wlc_ObjFanin0.exit728, %Wlc_ObjFanin1.exit710, %Wlc_ObjFanin0.exit701, %Wlc_ObjFanin0.exit695, %Wlc_ObjFanin0.exit689, %Wlc_ObjFanin0.exit683, %Wlc_ObjFanin0.exit677, %Wlc_ObjFanin0.exit671, %Wlc_ObjFanin0.exit665, %Wlc_ObjFanin1.exit656, %Wlc_ObjFanin1.exit644, %Wlc_ObjFanin0.exit635, %Wlc_ObjFanin0.exit629, %Wlc_ObjFanin0.exit623, %Wlc_ObjFanin0.exit612, %Wlc_ObjFanin0.exit604, %Wlc_ObjFanin0.exit597
  ...
  %i.asy = sext i32 %.val362 to i64
  %i.asz = icmp slt i64 %indvars.iv.next840, %i.asy
  br i1 %i.asz, label %bb.d, label %.critedge, !llvm.loop !114
...
bb.cg:                                            ; preds = %.critedge
  %i.ata = getelementptr i8, ptr %0, i64 700
  %.val = load i32, ptr %i.ata, align 4, !tbaa !31
  %i.atb = icmp sgt i32 %.val, 0
  br i1 %i.atb, label %bb.ch, label %.critedge.thread

bb.ch:                                            ; preds = %bb.cg
  %i.atc = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, i32 noundef %.1331) ; 0 uses
  %i.atd = getelementptr i8, ptr %0, i64 640
  %.val357 = load ptr, ptr %i.atd, align 8, !tbaa !29
  %i.ate = ptrtoint ptr %.2334 to i64
  %i.atf = ptrtoint ptr %.val357 to i64
  %i.atg = sub i64 %i.ate, %i.atf
  %i.ath = sdiv exact i64 %i.atg, 24              ; 2 uses
  %i.ati = trunc i64 %i.ath to i32
  %i.atj = getelementptr inbounds nuw i8, ptr %0, i64 688
  %i.atk = load ptr, ptr %i.atj, align 8, !tbaa !39
  %i.atl = getelementptr i8, ptr %0, i64 704
  %.val361 = load ptr, ptr %i.atl, align 8, !tbaa !25
  %sext = shl i64 %i.ath, 32
  %i.atm = ashr exact i64 %sext, 30
  %i.atn = getelementptr inbounds i8, ptr %.val361, i64 %i.atm
  %i.ato = load i32, ptr %i.atn, align 4, !tbaa !11
  %i.atp = tail call ptr @Abc_NamStr(ptr noundef %i.atk, i32 noundef %i.ato) #27
  %i.atq = getelementptr i8, ptr %.2334, i64 8
  %.0332.val = load i32, ptr %i.atq, align 8, !tbaa !35 ; 2 uses
  %i.atr = getelementptr i8, ptr %.2334, i64 12
  %.0332.val417 = load i32, ptr %i.atr, align 4, !tbaa !37 ; 2 uses
  %i.ats = sub nsw i32 %.0332.val, %.0332.val417
  %i.att = tail call i32 @llvm.abs.i32(i32 %i.ats, i1 true)
  %i.atu = add nuw nsw i32 %i.att, 1
  %i.atv = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.6, i32 noundef %i.ati, ptr noundef %i.atp, i32 noundef %i.atu, i32 noundef %.0332.val, i32 noundef %.0332.val417) ; 0 uses
  br label %.critedge.thread

.critedge.thread:                                 ; preds = %.preheader, %bb.ch, %bb.cg, %.critedge
  %i.atw = select i1 %.not341, ptr @.str.9, ptr @.str.8
  %i.atx = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.7, ptr noundef nonnull %i.atw) ; 0 uses
  %.val413 = load ptr, ptr %i.h, align 8, !tbaa !43 ; 4 uses
  %.val412 = load ptr, ptr %i.k, align 8, !tbaa !43 ; 4 uses
  %i.aty = getelementptr inbounds nuw i8, ptr %0, i64 136
  %i.atz = getelementptr i8, ptr %0, i64 20
  %i.aua = getelementptr i8, ptr %0, i64 24
  %i.aub = getelementptr i8, ptr %0, i64 640      ; 2 uses
  %i.auc = getelementptr inbounds nuw i8, ptr %i.a, i64 240
  br label %bb.ci

bb.ci:                                            ; preds = %.critedge.thread, %bb.da
  %indvars.iv845 = phi i64 [ 0, %.critedge.thread ], [ %indvars.iv.next846, %bb.da ] ; 10 uses
  %i.aud = getelementptr inbounds nuw [8 x i8], ptr %.val413, i64 %indvars.iv845 ; 2 uses
  %i.aue = load ptr, ptr %i.aud, align 8, !tbaa !100 ; 2 uses
  %i.auf = getelementptr inbounds nuw [8 x i8], ptr %.val412, i64 %indvars.iv845 ; 2 uses
  %i.aug = load ptr, ptr %i.auf, align 8, !tbaa !100
  %i.auh = getelementptr inbounds nuw [4 x i8], ptr %i.aty, i64 %indvars.iv845 ; 2 uses
  %i.aui = load i32, ptr %i.auh, align 4, !tbaa !11 ; 2 uses
  %i.auj = icmp eq i32 %i.aui, 0
  br i1 %i.auj, label %bb.da, label %bb.cj

bb.cj:                                            ; preds = %bb.ci
  %i.auk = getelementptr inbounds nuw [8 x i8], ptr @Wlc_Names, i64 %indvars.iv845
  %i.aul = load ptr, ptr %i.auk, align 8, !tbaa !8
  %i.aum = trunc nuw nsw i64 %indvars.iv845 to i32
  %i.aun = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.10, i32 noundef %i.aum, ptr noundef %i.aul, i32 noundef %i.aui) ; 0 uses
  br i1 %.not341, label %bb.co, label %bb.ck

bb.ck:                                            ; preds = %bb.cj
  %i.auo = icmp eq i64 %indvars.iv845, 1
  br i1 %i.auo, label %bb.cl, label %bb.cn

bb.cl:                                            ; preds = %bb.ck
  tail call void @Wlc_NtkMarkCone(ptr noundef nonnull readonly %0, i32 noundef -1, i32 noundef -1, i32 noundef 1, i32 noundef 0)
  %.val.i762 = load i32, ptr %i.atz, align 4, !tbaa !31 ; 4 uses
  %i.aup = icmp sgt i32 %.val.i762, 0
  br i1 %i.aup, label %.lr.ph.i764, label %.critedge.i763

.lr.ph.i764:                                      ; preds = %bb.cl
  %.val10.i = load ptr, ptr %i.aua, align 8, !tbaa !25 ; 3 uses
  %.val11.i = load ptr, ptr %i.aub, align 8, !tbaa !29 ; 3 uses
  %wide.trip.count.i765 = zext nneg i32 %.val.i762 to i64 ; 2 uses
  %xtraiter = and i64 %wide.trip.count.i765, 1
  %i.auq = icmp eq i32 %.val.i762, 1
  br i1 %i.auq, label %.epil.preheader, label %.lr.ph.i764.new
...
bb.cm:                                            ; preds = %bb.cm, %.lr.ph.i764.new
  ...
  %.013.i = phi i32 [ 0, %.lr.ph.i764.new ], [ %i.avj, %bb.cm ]
  %niter = phi i64 [ 0, %.lr.ph.i764.new ], [ %niter.next.1, %bb.cm ]
  %i.aur = getelementptr inbounds nuw [4 x i8], ptr %.val10.i, i64 %indvars.iv.i766
  %i.aus = load i32, ptr %i.aur, align 4, !tbaa !11
  %i.aut = sext i32 %i.aus to i64
  %i.auu = getelementptr inbounds [24 x i8], ptr %.val11.i, i64 %i.aut
  %i.auv = load i16, ptr %i.auu, align 8
  %i.auw = lshr i16 %i.auv, 7
  %i.aux = and i16 %i.auw, 1
  %i.auy = zext nneg i16 %i.aux to i32
  %i.auz = add nuw nsw i32 %.013.i, %i.auy
  %i.ava = getelementptr inbounds nuw [4 x i8], ptr %.val10.i, i64 %indvars.iv.i766
  %i.avb = getelementptr inbounds nuw i8, ptr %i.ava, i64 4
  %i.avc = load i32, ptr %i.avb, align 4, !tbaa !11
  %i.avd = sext i32 %i.avc to i64
  %i.ave = getelementptr inbounds [24 x i8], ptr %.val11.i, i64 %i.avd
  %i.avf = load i16, ptr %i.ave, align 8
  %i.avg = lshr i16 %i.avf, 7
  %i.avh = and i16 %i.avg, 1
  %i.avi = zext nneg i16 %i.avh to i32
  %i.avj = add nuw nsw i32 %i.auz, %i.avi         ; 3 uses
...
.epil.preheader:                                  ; preds = %.critedge.i763.loopexit.unr-lcssa, %.lr.ph.i764
  ...
  %.013.i.epil.init = phi i32 [ 0, %.lr.ph.i764 ], [ %i.avj, %.critedge.i763.loopexit.unr-lcssa ]
  %lcmp.mod912 = trunc i32 %.val.i762 to i1
  tail call void @llvm.assume(i1 %lcmp.mod912)
  %i.avk = getelementptr inbounds nuw [4 x i8], ptr %.val10.i, i64 %indvars.iv.i766.epil.init
  %i.avl = load i32, ptr %i.avk, align 4, !tbaa !11
  %i.avm = sext i32 %i.avl to i64
  %i.avn = getelementptr inbounds [24 x i8], ptr %.val11.i, i64 %i.avm
  %i.avo = load i16, ptr %i.avn, align 8
  %i.avp = lshr i16 %i.avo, 7
  %i.avq = and i16 %i.avp, 1
  %i.avr = zext nneg i16 %i.avq to i32
  %i.avs = add nuw nsw i32 %.013.i.epil.init, %i.avr
  br label %.critedge.i763

.critedge.i763:                                   ; preds = %.epil.preheader, %.critedge.i763.loopexit.unr-lcssa, %bb.cl
  %.0.lcssa.i = phi i32 [ 0, %bb.cl ], [ %i.avj, %.critedge.i763.loopexit.unr-lcssa ], [ %i.avs, %.epil.preheader ] ; 2 uses
  %.val56.i.i = load i32, ptr %i.q, align 8, !tbaa !30
  %i.avt = icmp sgt i32 %.val56.i.i, 1
  br i1 %i.avt, label %.lr.ph.i.i, label %Wlc_NtkCountRealPis.exit

.lr.ph.i.i:                                       ; preds = %.critedge.i763, %.lr.ph.i.i
  %indvars.iv.i.i = phi i64 [ %indvars.iv.next.i.i, %.lr.ph.i.i ], [ 1, %.critedge.i763 ] ; 2 uses
  %.val.i.i = load ptr, ptr %i.aub, align 8, !tbaa !29
  %i.avu = getelementptr inbounds nuw [24 x i8], ptr %.val.i.i, i64 %indvars.iv.i.i ; 2 uses
  %i.avv = load i16, ptr %i.avu, align 8
  %i.avw = and i16 %i.avv, -129
  store i16 %i.avw, ptr %i.avu, align 8
  %indvars.iv.next.i.i = add nuw nsw i64 %indvars.iv.i.i, 1 ; 2 uses
  %.val5.i.i = load i32, ptr %i.q, align 8, !tbaa !30
  %i.avx = sext i32 %.val5.i.i to i64
  %i.avy = icmp slt i64 %indvars.iv.next.i.i, %i.avx
  br i1 %i.avy, label %.lr.ph.i.i, label %Wlc_NtkCountRealPis.exit, !llvm.loop !95

bb.cn:                                            ; preds = %bb.ck
  %i.avz = load i32, ptr %i.auh, align 4, !tbaa !11
  br label %Wlc_NtkCountRealPis.exit

Wlc_NtkCountRealPis.exit:                         ; preds = %.lr.ph.i.i, %.critedge.i763, %bb.cn
  %i.awa = phi i32 [ %i.avz, %bb.cn ], [ %.0.lcssa.i, %.critedge.i763 ], [ %.0.lcssa.i, %.lr.ph.i.i ]
  %i.awb = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.11) ; 0 uses
  %i.awc = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %indvars.iv845
  %i.awd = load i32, ptr %i.awc, align 4, !tbaa !11 ; 2 uses
  %i.awe = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.12, i32 noundef %i.awd) ; 0 uses
  %i.awf = getelementptr inbounds nuw [4 x i8], ptr %i.auc, i64 %indvars.iv845
  %i.awg = load i32, ptr %i.awf, align 4, !tbaa !11 ; 2 uses
  %i.awh = sub i32 %i.awd, %i.awa
  %i.awi = add i32 %i.awh, %i.awg
  %i.awj = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.12, i32 noundef %i.awi) ; 0 uses
  %i.awk = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.12, i32 noundef %i.awg) ; 0 uses
  br label %bb.co

bb.co:                                            ; preds = %Wlc_NtkCountRealPis.exit, %bb.cj
  %.val358 = load ptr, ptr %i.d, align 8, !tbaa !25
  %i.awl = getelementptr inbounds nuw [4 x i8], ptr %.val358, i64 %indvars.iv845
  %i.awm = load i32, ptr %i.awl, align 4, !tbaa !11
  %i.awn = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.13, i32 noundef %i.awm) ; 0 uses
  %i.awo = load ptr, ptr %i.aud, align 8, !tbaa !100 ; 2 uses
  %i.awp = load ptr, ptr %i.auf, align 8, !tbaa !100 ; 2 uses
  %i.awq = getelementptr i8, ptr %i.awo, i64 8
  %.val10.i770 = load ptr, ptr %i.awq, align 8, !tbaa !47 ; 6 uses
  %i.awr = getelementptr i8, ptr %i.awo, i64 4
  %.val11.i771 = load i32, ptr %i.awr, align 4, !tbaa !101 ; 4 uses
  %i.aws = getelementptr i8, ptr %i.awp, i64 8
  %.val9.i772 = load ptr, ptr %i.aws, align 8, !tbaa !47 ; 11 uses
  %i.awt = icmp sgt i32 %.val11.i771, 1
  br i1 %i.awt, label %.lr.ph36.preheader.i.i, label %Vec_WrdReverseOrder.exit.i

.lr.ph36.preheader.i.i:                           ; preds = %bb.co
  %i.awu = add nsw i32 %.val11.i771, -1
  %wide.trip.count44.i.i = zext nneg i32 %i.awu to i64
  %wide.trip.count.i.i = zext nneg i32 %.val11.i771 to i64 ; 4 uses
  %i.awv = add nsw i64 %wide.trip.count.i.i, -2
...
.lr.ph.preheader.i.i:                             ; preds = %._crit_edge.i.i, %.lr.ph36.preheader.i.i
  ...
  %i.aww = xor i64 %indvars.iv41.i.i, -1
  %i.awx = add nsw i64 %i.aww, %wide.trip.count.i.i
  %i.awy = sub i64 %i.awv, %indvars.iv41.i.i
  %i.awz = trunc nuw nsw i64 %indvars.iv41.i.i to i32 ; 2 uses
  ...
  %xtraiter913 = and i64 %i.awx, 3                ; 2 uses
...
.lr.ph.i.i774.prol:                               ; preds = %.lr.ph.preheader.i.i, %.lr.ph.i.i774.prol
  %i.axa = phi i64 [ %i.axf, %.lr.ph.i.i774.prol ], [ %.pre.i.i, %.lr.ph.preheader.i.i ] ; 2 uses
  %indvars.iv38.i.i.prol = phi i64 [ %indvars.iv.next39.i.i.prol, %.lr.ph.i.i774.prol ], [ %indvars.iv.i.i773, %.lr.ph.preheader.i.i ] ; 3 uses
  %.03132.i.i.prol = phi i32 [ %spec.select.i.i775.prol, %.lr.ph.i.i774.prol ], [ %i.awz, %.lr.ph.preheader.i.i ]
  %prol.iter = phi i64 [ %prol.iter.next, %.lr.ph.i.i774.prol ], [ 0, %.lr.ph.preheader.i.i ]
  %i.axb = getelementptr inbounds nuw [8 x i8], ptr %.val9.i772, i64 %indvars.iv38.i.i.prol
  %i.axc = load i64, ptr %i.axb, align 8, !tbaa !102 ; 2 uses
  %i.axd = icmp ult i64 %i.axc, %i.axa
  %i.axe = trunc nuw nsw i64 %indvars.iv38.i.i.prol to i32
  %spec.select.i.i775.prol = select i1 %i.axd, i32 %i.axe, i32 %.03132.i.i.prol ; 3 uses
  %indvars.iv.next39.i.i.prol = add nuw nsw i64 %indvars.iv38.i.i.prol, 1 ; 2 uses
  %i.axf = tail call i64 @llvm.umin.i64(i64 %i.axc, i64 %i.axa) ; 2 uses
...
.lr.ph.i.i774.prol.loopexit:                      ; preds = %.lr.ph.i.i774.prol, %.lr.ph.preheader.i.i
  ...
  %.unr = phi i64 [ %.pre.i.i, %.lr.ph.preheader.i.i ], [ %i.axf, %.lr.ph.i.i774.prol ]
