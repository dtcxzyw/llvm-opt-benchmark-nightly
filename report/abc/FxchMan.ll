...
vector.body634:                                   ; preds = %vector.body634, %vector.ph632
  ...
  %wide.load638 = load <4 x i32>, ptr %next.gep637, align 4, !tbaa !61
  %wide.load639 = load <4 x i32>, ptr %i.fs, align 4, !tbaa !61
  %i.ft = getelementptr i8, ptr %next.gep636, i64 16
  store <4 x i32> %wide.load638, ptr %next.gep636, align 4, !tbaa !61
  store <4 x i32> %wide.load639, ptr %i.ft, align 4, !tbaa !61
  %index.next640 = add nuw i64 %index635, 8       ; 2 uses
  %i.fu = icmp eq i64 %index.next640, %n.vec633
  br i1 %i.fu, label %middle.block641, label %vector.body634, !llvm.loop !118
...
.lr.ph62.i:                                       ; preds = %.lr.ph62.i.preheader661, %.lr.ph62.i
  ...
  %i.fw = load i32, ptr %.24860.i, align 4, !tbaa !61
  %i.fx = getelementptr inbounds nuw i8, ptr %.24261.i, i64 4 ; 2 uses
  store i32 %i.fw, ptr %.24261.i, align 4, !tbaa !61
  %i.fy = icmp ult ptr %i.fv, %i.da
  br i1 %i.fy, label %.lr.ph62.i, label %.preheader.i, !llvm.loop !119
...
.lr.ph66.i:                                       ; preds = %.lr.ph66.i.preheader659, %.lr.ph66.i
  ...
  %i.ga = load i32, ptr %.24564.i, align 4, !tbaa !61
  %i.gb = getelementptr inbounds nuw i8, ptr %.265.i, i64 4 ; 2 uses
  store i32 %i.ga, ptr %.265.i, align 4, !tbaa !61
  %i.gc = icmp ult ptr %i.fz, %i.dc
  br i1 %i.gc, label %.lr.ph66.i, label %Vec_IntTwoRemoveCommon.exit, !llvm.loop !120
...
Vec_IntTwoRemoveCommon.exit:                      ; preds = %.lr.ph66.i, %middle.block641, %.preheader.i
  ...
  %i.gd = load ptr, ptr %i.cv, align 8, !tbaa !27
  ...
  store i32 %i.gi, ptr %i.bo, align 4, !tbaa !28
  %i.gj = load ptr, ptr %i.cx, align 8, !tbaa !27
  ...
  store i32 %i.go, ptr %i.cg, align 4, !tbaa !28
  br label %bb.af
...
bb.af:                                            ; preds = %Vec_IntTwoRemoveCommon.exit, %Vec_IntAppend.exit
  ...
  store i32 0, ptr %i.gr, align 4, !tbaa !28
  ...
  %.val67.i282 = load i32, ptr %i.gw, align 4, !tbaa !28
...
bb.ag:                                            ; preds = %Vec_IntPush.exit.i288, %.lr.ph.i283
  ...
  %.val.i285 = load ptr, ptr %i.gy, align 8, !tbaa !27
  %i.ha = getelementptr inbounds nuw [4 x i8], ptr %.val.i285, i64 %indvars.iv.i284
  %i.hb = load i32, ptr %i.ha, align 4, !tbaa !61
  %i.hc = load i32, ptr %i.gr, align 4, !tbaa !28 ; 7 uses
  %i.hd = load i32, ptr %i.gq, align 8, !tbaa !26
...
.Vec_IntPush.exit_crit_edge.i286:                 ; preds = %bb.ag
  %.pre.i287 = load ptr, ptr %i.gz, align 8, !tbaa !27
...
bb.ai:                                            ; preds = %bb.ah
  %i.hg = load ptr, ptr %i.gz, align 8, !tbaa !27 ; 2 uses
...
bb.al:                                            ; preds = %bb.ah
  ...
  %.pre10.i293 = load ptr, ptr %i.gz, align 8, !tbaa !27 ; 3 uses
...
Vec_IntGrow.exit11.sink.split.i.i295:             ; preds = %bb.ao, %bb.an, %bb.ak, %bb.aj
  ...
  store ptr %i.hp, ptr %i.gz, align 8, !tbaa !27
  store i32 %spec.select.sink.i.i296, ptr %i.gq, align 8, !tbaa !26
  %.pre11.i297 = load i32, ptr %i.gr, align 4, !tbaa !28
  br label %Vec_IntPush.exit.i288
...
Vec_IntErase.exit:                                ; preds = %Vec_IntAppend.exit299, %bb.ap
  store i32 0, ptr %i.gw, align 4, !tbaa !28
  store i32 0, ptr %i.gv, align 8, !tbaa !26
  %i.hz = load ptr, ptr %i.gp, align 8, !tbaa !45 ; 3 uses
  %i.ia = getelementptr i8, ptr %i.hz, i64 4
  %.val240404 = load i32, ptr %i.ia, align 4, !tbaa !28
...
.critedge:                                        ; preds = %Vec_IntErase.exit, %bb.av
  ...
  %.val229 = load ptr, ptr %i.ie, align 8, !tbaa !27 ; 7 uses
  %i.if = getelementptr inbounds nuw [4 x i8], ptr %.val229, i64 %indvars.iv ; 2 uses
  %i.ig = load i32, ptr %i.if, align 4, !tbaa !61 ; 2 uses
  %i.ih = getelementptr inbounds nuw [4 x i8], ptr %.val229, i64 %i.id
  %i.ii = load i32, ptr %i.ih, align 4, !tbaa !61 ; 2 uses
...
bb.aq:                                            ; preds = %Vec_IntSetEntry.exit
  %i.io = load i32, ptr %i.ic, align 8, !tbaa !26 ; 4 uses
...
bb.ar:                                            ; preds = %bb.aq
  ...
  store ptr %i.is, ptr %i.ie, align 8, !tbaa !27
...
bb.au:                                            ; preds = %bb.at
  ...
  store ptr %i.ix, ptr %i.ie, align 8, !tbaa !27
  br label %Vec_IntGrow.exit.sink.split.i.i310
...
Vec_IntGrow.exit.sink.split.i.i310:               ; preds = %bb.au, %bb.ar
  ...
  store i32 %spec.select.sink.i.i311, ptr %i.ic, align 8, !tbaa !26
  %.pre.i312 = load i32, ptr %i.il, align 4, !tbaa !28 ; 2 uses
...
.lr.ph.i.i315:                                    ; preds = %Vec_IntGrow.exit.i.i313
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %scevgep.i.i316, i8 0, i64 %i.je, i1 false), !tbaa !61
  br label %._crit_edge.i.i317

._crit_edge.i.i317:                               ; preds = %.lr.ph.i.i315, %Vec_IntGrow.exit.i.i313
  %i.jf = trunc nuw nsw i64 %i.ik to i32
  store i32 %i.jf, ptr %i.il, align 4, !tbaa !28
...
Vec_IntSetEntry.exit322:                          ; preds = %Vec_IntSetEntry.exit, %._crit_edge.i.i317
  ...
  store i32 %i.ig, ptr %i.jg, align 4, !tbaa !61
  br label %bb.av
...
bb.av:                                            ; preds = %.critedge._crit_edge, %Vec_IntSetEntry.exit322
  ...
  %.val240 = load i32, ptr %i.jj, align 4, !tbaa !28 ; 3 uses
  %i.jk = sext i32 %.val240 to i64
  %i.jl = icmp slt i64 %i.ji, %i.jk
  br i1 %i.jl, label %.critedge, label %._crit_edge, !llvm.loop !121
...
bb.aw:                                            ; preds = %._crit_edge
  ...
  %.val31.i = load ptr, ptr %i.jo, align 8, !tbaa !27
...
._crit_edge37.i:                                  ; preds = %bb.ay, %bb.ax
  ...
  store i32 %i.jw, ptr %i.kf, align 4, !tbaa !61
  %i.kg = getelementptr i8, ptr %i.kf, i64 4
  store i32 %i.ka, ptr %i.kg, align 4, !tbaa !61
  %i.kh = add nsw i32 %.033.i, 1
  %.pre38.i = load i32, ptr %i.jm, align 4, !tbaa !28
  br label %bb.az
...
bb.az:                                            ; preds = %._crit_edge37.i, %bb.ay
  ...
  br i1 %i.kl, label %bb.ax, label %._crit_edge.i.loopexit, !llvm.loop !122
...
._crit_edge.i:                                    ; preds = %._crit_edge.i.loopexit, %bb.aw
  ...
  store i32 %.0.lcssa.i323, ptr %i.jm, align 4, !tbaa !28
...
Vec_IntUniqifyPairs.exit:                         ; preds = %Vec_IntErase.exit, %._crit_edge, %._crit_edge.i
  ...
  %.val239408 = load i32, ptr %i.ko, align 4, !tbaa !28
...
.critedge2.preheader:                             ; preds = %bb.bb, %Vec_IntUniqifyPairs.exit
  ...
  %.val238410 = load i32, ptr %i.kr, align 4, !tbaa !28
...
.lr.ph:                                           ; preds = %Vec_IntUniqifyPairs.exit, %bb.bb
  ...
  %.val2.i = load ptr, ptr %i.lb, align 8, !tbaa !27
  %i.lc = load i32, ptr %.val2.i, align 4, !tbaa !61
...
bb.bb:                                            ; preds = %.lr.ph, %bb.ba
  ...
  %.val239 = load i32, ptr %i.lf, align 4, !tbaa !28
  %i.lg = sext i32 %.val239 to i64
  %i.lh = icmp slt i64 %indvars.iv.next452, %i.lg
  br i1 %i.lh, label %.lr.ph, label %.critedge2.preheader, !llvm.loop !123
...
.lr.ph412:                                        ; preds = %.critedge2.preheader, %.critedge2
  ...
  %.val2.i330 = load ptr, ptr %i.lq, align 8, !tbaa !27
  %i.lr = load i32, ptr %.val2.i330, align 4, !tbaa !61
...
.critedge2:                                       ; preds = %.lr.ph412, %bb.bc
  ...
  %.val238 = load i32, ptr %i.lu, align 4, !tbaa !28
  %i.lv = sext i32 %.val238 to i64
  %i.lw = icmp slt i64 %indvars.iv.next455, %i.lv
  br i1 %i.lw, label %.lr.ph412, label %.critedge4, !llvm.loop !124
...
.critedge4:                                       ; preds = %.critedge2, %.critedge2.preheader
  ...
  store i32 0, ptr %i.lz, align 4, !tbaa !28
...
bb.bd:                                            ; preds = %.critedge4
  ...
  %i.md = load i32, ptr %i.mc, align 8, !tbaa !59 ; 6 uses
  %i.me = add nsw i32 %i.md, 1
  store i32 %i.me, ptr %i.mc, align 8, !tbaa !59
  %i.mf = getelementptr inbounds nuw i8, ptr %0, i64 112 ; 4 uses
  %i.mg = load i32, ptr %i.mf, align 8, !tbaa !68
