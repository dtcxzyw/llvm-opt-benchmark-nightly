...
begin_hunk_0_@Fxch_ManUpdate:bb.a
  %i.afl = load i32, ptr %i.afk, align 4, !tbaa !60
  %i.afm = add nsw i32 %i.afl, %.val85.i
  store i32 %i.afm, ptr %i.afk, align 4, !tbaa !60
  ...
  %i.afq = load i32, ptr %i.afp, align 4, !tbaa !23 ; 6 uses
  %i.afr = load i32, ptr %i.afo, align 8, !tbaa !39 ; 2 uses
  %i.afs = icmp eq i32 %i.afq, %i.afr
  br i1 %i.afs, label %bb.fp, label %Vec_WecPushLevel.exit221.i

bb.fp:                                            ; preds = %Vec_IntPush.exit211.i
  %i.aft = icmp slt i32 %i.afq, 16
  br i1 %i.aft, label %bb.fq, label %bb.ft
...
Vec_WecGrow.exit.i220.i:                          ; preds = %bb.fs, %bb.fr
  %i.afy = phi i32 [ %.pre.i.i219.i, %bb.fr ], [ %i.afq, %bb.fs ] ; 2 uses
  %i.afz = phi ptr [ %i.afw, %bb.fr ], [ %i.afx, %bb.fs ] ; 2 uses
...
bb.fw:                                            ; preds = %bb.fv, %bb.fu
  %i.agk = phi i32 [ %.pre.i11.i217.i, %bb.fu ], [ %i.afq, %bb.fv ] ; 2 uses
  %i.agl = phi ptr [ %i.agi, %bb.fu ], [ %i.agj, %bb.fv ] ; 2 uses
...
Vec_WecPushLevel.exit221.sink.split.i:            ; preds = %bb.fw, %Vec_WecGrow.exit.i220.i
  %.sink322.i = phi i32 [ %i.agc, %Vec_WecGrow.exit.i220.i ], [ %i.ago, %bb.fw ]
  %.sink319.i = phi ptr [ %i.agb, %Vec_WecGrow.exit.i220.i ], [ %i.agn, %bb.fw ]
  %.sink318.i = phi i32 [ 16, %Vec_WecGrow.exit.i220.i ], [ %i.agd, %bb.fw ]
  ...
  %.pre478 = load i32, ptr %i.afp, align 4, !tbaa !23
...
Vec_WecPushLevel.exit221.i:                       ; preds = %Vec_WecPushLevel.exit221.sink.split.i, %Vec_IntPush.exit211.i
  ...
  store i32 %i.agu, ptr %i.afp, align 4, !tbaa !23
  %i.agv = getelementptr inbounds nuw i8, ptr %i.ags, i64 4 ; 3 uses
  %i.agw = load i32, ptr %i.agv, align 4, !tbaa !23 ; 2 uses
  %i.agx = icmp eq i32 %i.agw, %i.agr
  br i1 %i.agx, label %bb.fx, label %Fxch_ManCreateCube.exit

bb.fx:                                            ; preds = %Vec_WecPushLevel.exit221.i
  %i.agy = icmp slt i32 %i.agr, 16
  br i1 %i.agy, label %bb.fy, label %bb.gb
...
Vec_WecGrow.exit.i230.i:                          ; preds = %bb.ga, %bb.fz
  %i.ahd = phi i32 [ %.pre.i.i229.i, %bb.fz ], [ %i.agr, %bb.ga ] ; 2 uses
  %i.ahe = phi ptr [ %i.ahb, %bb.fz ], [ %i.ahc, %bb.ga ] ; 2 uses
...
bb.ge:                                            ; preds = %bb.gd, %bb.gc
  %i.ahp = phi i32 [ %.pre.i11.i227.i, %bb.gc ], [ %i.agr, %bb.gd ] ; 2 uses
  %i.ahq = phi ptr [ %i.ahn, %bb.gc ], [ %i.aho, %bb.gd ] ; 2 uses
...
Vec_WecPushLevel.exit231.sink.split.i:            ; preds = %bb.ge, %Vec_WecGrow.exit.i230.i
  %.sink327.i = phi i32 [ %i.ahh, %Vec_WecGrow.exit.i230.i ], [ %i.aht, %bb.ge ]
  %.sink324.i = phi ptr [ %i.ahg, %Vec_WecGrow.exit.i230.i ], [ %i.ahs, %bb.ge ]
  %.sink323.i = phi i32 [ 16, %Vec_WecGrow.exit.i230.i ], [ %i.ahi, %bb.ge ]
  ...
  %.pre481 = load i32, ptr %i.agv, align 4, !tbaa !23
...
Fxch_ManCreateCube.exit:                          ; preds = %Vec_WecPushLevel.exit221.i, %Vec_WecPushLevel.exit231.sink.split.i
  ...
  store i32 %i.ahy, ptr %i.agv, align 4, !tbaa !23
  %i.ahz = getelementptr i8, ptr %i.ahw, i64 4
  %.val.i347 = load i32, ptr %i.ahz, align 4, !tbaa !23
  ...
  %.val2364.i = load i32, ptr %i.aif, align 4, !tbaa !28
...
bb.gf:                                            ; preds = %Vec_IntPush.exit57.i, %.lr.ph.i349
  ...
  %.val22.i = load ptr, ptr %i.ail, align 8, !tbaa !27
  %i.aim = getelementptr inbounds nuw [4 x i8], ptr %.val22.i, i64 %indvars.iv.i350
  %i.ain = load i32, ptr %i.aim, align 4, !tbaa !61 ; 2 uses
  ...
  %i.ais = load i32, ptr %i.air, align 4, !tbaa !28 ; 7 uses
...
.lr.ph.i.i363:                                    ; preds = %bb.gf
  ...
  %i.aiv = load ptr, ptr %i.aiu, align 8, !tbaa !27 ; 4 uses
...
bb.gg:                                            ; preds = %bb.gh, %.lr.ph.i.i363
  ...
  %indvars.iv.i.i365 = phi i64 [ 1, %.lr.ph.i.i363 ], [ %indvars.iv.next.i.i366, %bb.gh ] ; 3 uses
  %i.aiw = getelementptr inbounds nuw [4 x i8], ptr %i.aiv, i64 %indvars.iv.i.i365
  %i.aix = load i32, ptr %i.aiw, align 4, !tbaa !61
  %i.aiy = xor i32 %i.aix, %.0196
  %i.aiz = icmp eq i32 %i.aiy, 1
  br i1 %i.aiz, label %.preheader.i.i, label %bb.gh
...
.lr.ph25.i.i:                                     ; preds = %.preheader.i.i
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %scevgep.i.i369, ptr noundef nonnull align 4 dereferenceable(1) %scevgep29.i.i, i64 %i.ajj, i1 false), !tbaa !61
  %.pre.i.i370 = load i32, ptr %i.air, align 4, !tbaa !28
...
._crit_edge.i.i368:                               ; preds = %.lr.ph25.i.i, %.preheader.i.i
  ...
  store i32 %i.ajl, ptr %i.air, align 4, !tbaa !28
  br label %Vec_IntRemove1.exit.i

Vec_IntRemove1.exit.i:                            ; preds = %bb.gh, %._crit_edge.i.i368
  %.pr58.i = phi i32 [ %i.ajl, %._crit_edge.i.i368 ], [ %i.ais, %bb.gh ] ; 7 uses
...
bb.gi:                                            ; preds = %bb.gj, %.lr.ph.i27.i
  ...
  %indvars.iv.i30.i = phi i64 [ 1, %.lr.ph.i27.i ], [ %indvars.iv.next.i31.i, %bb.gj ] ; 3 uses
  %i.ajn = getelementptr inbounds nuw [4 x i8], ptr %i.aiv, i64 %indvars.iv.i30.i
  %i.ajo = load i32, ptr %i.ajn, align 4, !tbaa !61
  %i.ajp = xor i32 %i.ajo, %.0195
  %i.ajq = icmp eq i32 %i.ajp, 1
  br i1 %i.ajq, label %.preheader.i34.i, label %bb.gj
...
.lr.ph25.i37.i:                                   ; preds = %.preheader.i34.i
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %scevgep.i38.i, ptr noundef nonnull align 4 dereferenceable(1) %scevgep29.i39.i, i64 %i.aka, i1 false), !tbaa !61
  %.pre.i40.i = load i32, ptr %i.air, align 4, !tbaa !28
...
._crit_edge.i36.i:                                ; preds = %.lr.ph25.i37.i, %.preheader.i34.i
  ...
  store i32 %i.akc, ptr %i.air, align 4, !tbaa !28
  br label %Vec_IntRemove1.exit41.i

Vec_IntRemove1.exit41.i:                          ; preds = %bb.gj, %._crit_edge.i36.i, %Vec_IntRemove1.exit.i, %bb.gf
  %i.akd = phi i32 [ %i.ais, %bb.gf ], [ %i.akc, %._crit_edge.i36.i ], [ %.pr58.i, %Vec_IntRemove1.exit.i ], [ %.pr58.i, %bb.gj ] ; 7 uses
  %i.ake = load i32, ptr %i.aiq, align 8, !tbaa !26
  %i.akf = icmp eq i32 %i.akd, %i.ake
  br i1 %i.akf, label %bb.gk, label %Vec_IntPush.exit.i351

bb.gk:                                            ; preds = %Vec_IntRemove1.exit41.i
  %i.akg = icmp slt i32 %i.akd, 16
  br i1 %i.akg, label %bb.gl, label %bb.go

bb.gl:                                            ; preds = %bb.gk
  %i.akh = getelementptr inbounds nuw i8, ptr %i.aiq, i64 8 ; 2 uses
  %i.aki = load ptr, ptr %i.akh, align 8, !tbaa !27 ; 2 uses
...
Vec_IntGrow.exit.i.i362:                          ; preds = %bb.gn, %bb.gm
  %i.akl = phi ptr [ %i.akj, %bb.gm ], [ %i.akk, %bb.gn ]
  store ptr %i.akl, ptr %i.akh, align 8, !tbaa !27
...
bb.gp:                                            ; preds = %bb.go
  ...
  %i.akp = load ptr, ptr %i.ako, align 8, !tbaa !27 ; 2 uses
...
bb.gs:                                            ; preds = %bb.gr, %bb.gq
  %i.aku = phi ptr [ %i.aks, %bb.gq ], [ %i.akt, %bb.gr ]
  store ptr %i.aku, ptr %i.ako, align 8, !tbaa !27
  br label %Vec_IntGrow.exit11.sink.split.i.i356
...
Vec_IntGrow.exit11.sink.split.i.i356:             ; preds = %bb.gs, %Vec_IntGrow.exit.i.i362
  ...
  store i32 %spec.select.sink.i.i357, ptr %i.aiq, align 8, !tbaa !26
  %.pre.i358 = load i32, ptr %i.air, align 4, !tbaa !28
...
Vec_IntPush.exit.i351:                            ; preds = %Vec_IntGrow.exit11.sink.split.i.i356, %bb.go, %Vec_IntRemove1.exit41.i
  ...
  %i.akv = phi i32 [ %i.akd, %Vec_IntRemove1.exit41.i ], [ %i.akd, %bb.go ], [ %.pre.i358, %Vec_IntGrow.exit11.sink.split.i.i356 ] ; 2 uses
  %i.akw = getelementptr inbounds nuw i8, ptr %i.aiq, i64 8
  %i.akx = load ptr, ptr %i.akw, align 8, !tbaa !27
  %i.aky = add nsw i32 %i.akv, 1
  store i32 %i.aky, ptr %i.air, align 4, !tbaa !28
  %i.akz = sext i32 %i.akv to i64
  %i.ala = getelementptr inbounds [4 x i8], ptr %i.akx, i64 %i.akz
  store i32 %i.aih, ptr %i.ala, align 4, !tbaa !61
  ...
  %i.alg = load i32, ptr %i.aii, align 4, !tbaa !28 ; 7 uses
  %i.alh = load i32, ptr %i.aid, align 8, !tbaa !26
  %i.ali = icmp eq i32 %i.alg, %i.alh
  br i1 %i.ali, label %bb.gt, label %Vec_IntPush.exit.Vec_IntPush.exit49_crit_edge.i

Vec_IntPush.exit.Vec_IntPush.exit49_crit_edge.i:  ; preds = %Vec_IntPush.exit.i351
  %.pre73.i = load ptr, ptr %i.aij, align 8, !tbaa !27
  br label %Vec_IntPush.exit49.i

bb.gt:                                            ; preds = %Vec_IntPush.exit.i351
  %i.alj = icmp slt i32 %i.alg, 16
  br i1 %i.alj, label %bb.gu, label %bb.gx

bb.gu:                                            ; preds = %bb.gt
  %i.alk = load ptr, ptr %i.aij, align 8, !tbaa !27 ; 2 uses
...
bb.gx:                                            ; preds = %bb.gt
  ...
  %.pre74.i = load ptr, ptr %i.aij, align 8, !tbaa !27 ; 3 uses
...
Vec_IntGrow.exit11.sink.split.i45.i:              ; preds = %bb.ha, %bb.gz, %bb.gw, %bb.gv
  %i.alt = phi ptr [ %i.alm, %bb.gw ], [ %i.all, %bb.gv ], [ %i.alr, %bb.gz ], [ %i.als, %bb.ha ] ; 2 uses
  %spec.select.sink.i46.i = phi i32 [ 16, %bb.gw ], [ 16, %bb.gv ], [ %spec.select.i42.i, %bb.gz ], [ %spec.select.i42.i, %bb.ha ]
  store ptr %i.alt, ptr %i.aij, align 8, !tbaa !27
  store i32 %spec.select.sink.i46.i, ptr %i.aid, align 8, !tbaa !26
  %.pre75.i = load i32, ptr %i.aii, align 4, !tbaa !28
  br label %Vec_IntPush.exit49.i

Vec_IntPush.exit49.i:                             ; preds = %Vec_IntGrow.exit11.sink.split.i45.i, %bb.gx, %Vec_IntPush.exit.Vec_IntPush.exit49_crit_edge.i
  %i.alu = phi i32 [ %i.alg, %Vec_IntPush.exit.Vec_IntPush.exit49_crit_edge.i ], [ %i.alg, %bb.gx ], [ %.pre75.i, %Vec_IntGrow.exit11.sink.split.i45.i ] ; 2 uses
  %i.alv = phi ptr [ %.pre73.i, %Vec_IntPush.exit.Vec_IntPush.exit49_crit_edge.i ], [ %.pre74.i, %bb.gx ], [ %i.alt, %Vec_IntGrow.exit11.sink.split.i45.i ]
  %i.alw = add nsw i32 %i.alu, 1
  store i32 %i.alw, ptr %i.aii, align 4, !tbaa !28
  %i.alx = sext i32 %i.alu to i64
  %i.aly = getelementptr inbounds [4 x i8], ptr %i.alv, i64 %i.alx
  store i32 %i.alf, ptr %i.aly, align 4, !tbaa !61
  %i.alz = load ptr, ptr %i.ma, align 8, !tbaa !46 ; 6 uses
  %i.ama = getelementptr inbounds nuw i8, ptr %i.alz, i64 4 ; 3 uses
  %i.amb = load i32, ptr %i.ama, align 4, !tbaa !28 ; 7 uses
  %i.amc = load i32, ptr %i.alz, align 8, !tbaa !26
  %i.amd = icmp eq i32 %i.amb, %i.amc
  br i1 %i.amd, label %bb.hb, label %Vec_IntPush.exit57.i

bb.hb:                                            ; preds = %Vec_IntPush.exit49.i
  %i.ame = icmp slt i32 %i.amb, 16
  br i1 %i.ame, label %bb.hc, label %bb.hf

bb.hc:                                            ; preds = %bb.hb
  %i.amf = getelementptr inbounds nuw i8, ptr %i.alz, i64 8 ; 2 uses
  %i.amg = load ptr, ptr %i.amf, align 8, !tbaa !27 ; 2 uses
...
Vec_IntGrow.exit.i56.i:                           ; preds = %bb.he, %bb.hd
  %i.amj = phi ptr [ %i.amh, %bb.hd ], [ %i.ami, %bb.he ]
  store ptr %i.amj, ptr %i.amf, align 8, !tbaa !27
...
bb.hg:                                            ; preds = %bb.hf
  ...
  %i.amn = load ptr, ptr %i.amm, align 8, !tbaa !27 ; 2 uses
end_hunk_0
