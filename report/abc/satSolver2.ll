...
clause2_read.exit:                                ; preds = %clause2_read.exit.lr.ph, %.loopexit
  ...
  %i.an = load i32, ptr %.099150, align 4, !tbaa !36 ; 3 uses
  %.not.i.i = icmp ne i32 %i.an, 0
  call void @llvm.assume(i1 %.not.i.i)
  %.val.i.i = load i32, ptr %i.g, align 8, !tbaa !41
  %i.ao = ashr i32 %i.an, %.val.i.i
  %.val5.i.i = load i32, ptr %i.h, align 4, !tbaa !42
  %i.ap = and i32 %.val5.i.i, %i.an
  %.val6.i.i = load ptr, ptr %i.i, align 8, !tbaa !43
  ...
  %i.aw = load i32, ptr %i.av, align 4, !tbaa !36 ; 2 uses
...
bb.d:                                             ; preds = %clause2_read.exit
  ...
  store i32 %i.az, ptr %i.av, align 4, !tbaa !36
  store i32 %i.ak, ptr %i.ay, align 4, !tbaa !36
  br label %bb.e

bb.e:                                             ; preds = %bb.d, %clause2_read.exit
  %i.ba = phi i32 [ %i.az, %bb.d ], [ %i.aw, %clause2_read.exit ] ; 3 uses
  %i.bb = ashr i32 %i.ba, 1                       ; 2 uses
  %.val121 = load ptr, ptr %i.j, align 8, !tbaa !30 ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  %i.bi = load i32, ptr %.099150, align 4, !tbaa !36
  %i.bj = getelementptr inbounds nuw i8, ptr %.098151, i64 4
  store i32 %i.bi, ptr %.098151, align 4, !tbaa !36
  br label %.loopexit
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.o
  ...
  %i.bq = load i32, ptr %.0102139, align 4, !tbaa !36 ; 3 uses
...
bb.h:                                             ; preds = %.lr.ph
  ...
  store i32 %i.bq, ptr %i.by, align 4, !tbaa !36
  store i32 %i.ak, ptr %.0102139, align 4, !tbaa !36
  %i.bz = load i32, ptr %i.by, align 4, !tbaa !36
  %i.ca = xor i32 %i.bz, 1
  %.val = load ptr, ptr %i.e, align 8, !tbaa !37
  %i.cb = sext i32 %i.ca to i64
  %i.cc = getelementptr inbounds [16 x i8], ptr %.val, i64 %i.cb ; 6 uses
  %i.cd = load i32, ptr %.099150, align 4, !tbaa !36
  %i.ce = getelementptr inbounds nuw i8, ptr %i.cc, i64 4 ; 3 uses
  %i.cf = load i32, ptr %i.ce, align 4, !tbaa !39 ; 5 uses
  %i.cg = load i32, ptr %i.cc, align 8, !tbaa !45
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.co = load ptr, ptr %i.cn, align 8, !tbaa !38 ; 2 uses
...
bb.l:                                             ; preds = %bb.k, %bb.j
  ...
  store ptr %i.ct, ptr %i.cn, align 8, !tbaa !38
  %i.cu = icmp eq ptr %i.ct, null
  br i1 %i.cu, label %bb.m, label %bb.n

bb.m:                                             ; preds = %bb.l
  %i.cv = load i32, ptr %i.cc, align 8, !tbaa !45
  ...
  %i.db = load ptr, ptr @stdout, align 8, !tbaa !47
  %i.dc = call i32 @fflush(ptr noundef %i.db)     ; 0 uses
  br label %bb.n

bb.n:                                             ; preds = %bb.m, %bb.l
  store i32 %i.cm, ptr %i.cc, align 8, !tbaa !45
  %.pre.i = load i32, ptr %i.ce, align 4, !tbaa !39
...
bb.r:                                             ; preds = %.lr.ph142
  ...
  br i1 %i.dv, label %.lr.ph142, label %.critedge2, !llvm.loop !114
...
.critedge2:                                       ; preds = %.lr.ph142, %bb.r, %bb.q
  ...
  %i.dy = load ptr, ptr %i.n, align 8, !tbaa !50
...
var_unit_clause.exit:                             ; preds = %.critedge2
  %.val.i.i.i = load i32, ptr %i.g, align 8, !tbaa !41 ; 2 uses
  %i.eb = ashr i32 %i.ea, %.val.i.i.i
  %.val6.i.i.i = load ptr, ptr %i.i, align 8, !tbaa !43 ; 2 uses
...
var_unit_clause.exit.thread:                      ; preds = %.critedge2, %var_unit_clause.exit
  store i32 %i.dx, ptr %i.dz, align 4, !tbaa !36
  %i.eg = load i32, ptr %i.p, align 8, !tbaa !51
  %i.eh = add nsw i32 %i.eg, 1
  store i32 %i.eh, ptr %i.p, align 8, !tbaa !51
  br label %bb.u
...
bb.t:                                             ; preds = %bb.s
  ...
  %.val5.i.i125 = load i32, ptr %i.h, align 4, !tbaa !42
...
.lr.ph.i:                                         ; preds = %bb.v
  %.val.i = load ptr, ptr %i.q, align 8, !tbaa !53 ; 3 uses
...
bb.w:                                             ; preds = %bb.w, %.lr.ph.i.new
  ...
  %i.ey = load i32, ptr %i.ex, align 4, !tbaa !36
  ...
  %i.fk = load i32, ptr %i.fj, align 4, !tbaa !36
  ...
  br i1 %niter.ncmp.1, label %sat_clause_compute_lbd.exit.loopexit.unr-lcssa, label %bb.w, !llvm.loop !0
...
bb.x:                                             ; preds = %sat_clause_compute_lbd.exit, %bb.u
  %i.gi = load i32, ptr %i.a, align 4, !tbaa !36  ; 4 uses
  %i.gj = ashr i32 %i.gi, 1
  %.val20.i = load ptr, ptr %i.j, align 8, !tbaa !30
  %i.gk = sext i32 %i.gj to i64                   ; 3 uses
  %i.gl = getelementptr inbounds i8, ptr %.val20.i, i64 %i.gk ; 2 uses
  %i.gm = load i8, ptr %i.gl, align 1, !tbaa !31  ; 2 uses
...
solver2_enqueue.exit.thread:                      ; preds = %bb.x
  %i.gn = load i32, ptr %.099150, align 4, !tbaa !36
  %i.go = trunc i32 %i.gi to i8
  %i.gp = and i8 %i.go, 1
  store i8 %i.gp, ptr %i.gl, align 1, !tbaa !31
  %.val21.i = load i32, ptr %i.l, align 4, !tbaa !39
  %.val23.i = load ptr, ptr %i.q, align 8, !tbaa !53
  %i.gq = getelementptr inbounds [4 x i8], ptr %.val23.i, i64 %i.gk
  store i32 %.val21.i, ptr %i.gq, align 4, !tbaa !36
  %i.gr = load ptr, ptr %i.r, align 8, !tbaa !54
  %i.gs = getelementptr inbounds [4 x i8], ptr %i.gr, i64 %i.gk
  store i32 %i.gn, ptr %i.gs, align 4, !tbaa !36
  %i.gt = load ptr, ptr %i.d, align 8, !tbaa !35
  %i.gu = load i32, ptr %i.b, align 4, !tbaa !33  ; 2 uses
  %i.gv = add nsw i32 %i.gu, 1
  store i32 %i.gv, ptr %i.b, align 4, !tbaa !33
  %i.gw = sext i32 %i.gu to i64
  %i.gx = getelementptr inbounds [4 x i8], ptr %i.gt, i64 %i.gw
  store i32 %i.gi, ptr %i.gx, align 4, !tbaa !36
  br label %.loopexit
...
bb.y:                                             ; preds = %solver2_enqueue.exit
  %i.ha = load i32, ptr %.099150, align 4, !tbaa !36 ; 3 uses
  %.not.i.i130 = icmp eq i32 %i.ha, 0
  br i1 %.not.i.i130, label %clause2_read.exit134, label %bb.z

bb.z:                                             ; preds = %bb.y
  %.val.i.i131 = load i32, ptr %i.g, align 8, !tbaa !41
  %i.hb = ashr i32 %i.ha, %.val.i.i131
  %.val5.i.i132 = load i32, ptr %i.h, align 4, !tbaa !42
  %i.hc = and i32 %.val5.i.i132, %i.ha
  %.val6.i.i133 = load ptr, ptr %i.i, align 8, !tbaa !43
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %next.gep, align 4, !tbaa !36
  %wide.load184 = load <4 x i32>, ptr %i.hs, align 4, !tbaa !36
  %i.ht = getelementptr i8, ptr %next.gep183, i64 16
  store <4 x i32> %wide.load, ptr %next.gep183, align 4, !tbaa !36
  store <4 x i32> %wide.load184, ptr %i.ht, align 4, !tbaa !36
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.hu = icmp eq i64 %index.next, %n.vec
  br i1 %i.hu, label %middle.block, label %vector.body, !llvm.loop !115
...
.loopexit:                                        ; preds = %.lr.ph147, %middle.block, %clause2_read.exit134, %solver2_enqueue.exit.thread, %bb.f, %solver2_enqueue.exit, %veci_push.exit
  ...
  br i1 %i.hz, label %clause2_read.exit, label %._crit_edge152.loopexit, !llvm.loop !117

._crit_edge152.loopexit:                          ; preds = %.loopexit
  %.val116.pre = load ptr, ptr %i.ad, align 8, !tbaa !38
...
._crit_edge152:                                   ; preds = %._crit_edge152.loopexit, %bb.c
  ...
  %i.ie = load i64, ptr %i.s, align 8, !tbaa !119
  %i.if = add nsw i64 %i.id, %i.ie
  store i64 %i.if, ptr %i.s, align 8, !tbaa !119
  %i.ig = lshr exact i64 %i.ic, 2
  %i.ih = trunc i64 %i.ig to i32
  store i32 %i.ih, ptr %i.ae, align 4, !tbaa !39
  %i.ii = icmp eq ptr %.1104.lcssa, null
  br i1 %i.ii, label %bb.b, label %.critedge, !llvm.loop !118
...
bb.f:                                             ; preds = %Vec_WrdPush.exit.i.i, %.lr.ph.i.i
  ...
  %i.n = load ptr, ptr %i.l, align 8, !tbaa !65   ; 6 uses
  %i.o = getelementptr inbounds nuw i8, ptr %i.n, i64 4 ; 3 uses
  %i.p = load i32, ptr %i.o, align 4, !tbaa !67   ; 7 uses
  %i.q = load i32, ptr %i.n, align 8, !tbaa !68
...
Vec_WrdGrow.exit.i.i.i:                           ; preds = %bb.j, %bb.i
  ...
  store ptr %i.x, ptr %i.t, align 8, !tbaa !69
...
bb.o:                                             ; preds = %bb.n, %bb.m
  ...
  store ptr %i.ag, ptr %i.aa, align 8, !tbaa !69
  br label %Vec_WrdGrow.exit11.sink.split.i.i.i
...
Vec_WrdGrow.exit11.sink.split.i.i.i:              ; preds = %bb.o, %Vec_WrdGrow.exit.i.i.i
  ...
  store i32 %spec.select.sink.i.i.i, ptr %i.n, align 8, !tbaa !68
  %.pre.i.i = load i32, ptr %i.o, align 4, !tbaa !67
  %.pre4.i.i = load i32, ptr %i.i, align 8, !tbaa !64
...
Vec_WrdPush.exit.i.i:                             ; preds = %Vec_WrdGrow.exit11.sink.split.i.i.i, %bb.k, %bb.f
  ...
  store i32 %i.ak, ptr %i.o, align 4, !tbaa !67
...
.critedge.loopexit:                               ; preds = %bb.f, %bb.b
  %.pre30 = load ptr, ptr %i.a, align 8, !tbaa !32 ; 2 uses
...
bb.g:                                             ; preds = %.critedge
  ...
  %i.ar = load i32, ptr %i.aq, align 4, !tbaa !39 ; 5 uses
  %i.as = load i32, ptr %i.ap, align 8, !tbaa !45
...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  store ptr %i.bf, ptr %i.az, align 8, !tbaa !38
  %i.bg = icmp eq ptr %i.bf, null
  br i1 %i.bg, label %bb.l, label %bb.m

bb.l:                                             ; preds = %bb.k
  %i.bh = load i32, ptr %i.ap, align 8, !tbaa !45
  ...
  %i.bn = load ptr, ptr @stdout, align 8, !tbaa !47
  %i.bo = tail call i32 @fflush(ptr noundef %i.bn) ; 0 uses
  br label %bb.m

bb.m:                                             ; preds = %bb.l, %bb.k
  store i32 %i.ay, ptr %i.ap, align 8, !tbaa !45
  %.pre.i.i = load i32, ptr %i.aq, align 4, !tbaa !39
  %.pre.pre.i = load ptr, ptr %i.a, align 8, !tbaa !32
...
var_add_tag.exit:                                 ; preds = %.critedge, %veci_push.exit.i
  ...
  %i.cb = load i32, ptr %i.ca, align 4, !tbaa !39 ; 5 uses
  %i.cc = load i32, ptr %i.bz, align 8, !tbaa !45
...
bb.q:                                             ; preds = %bb.p, %bb.o
  ...
  store ptr %i.cp, ptr %i.cj, align 8, !tbaa !38
  %i.cq = icmp eq ptr %i.cp, null
  br i1 %i.cq, label %bb.r, label %bb.s

bb.r:                                             ; preds = %bb.q
  %i.cr = load i32, ptr %i.bz, align 8, !tbaa !45
  ...
  %i.cx = load ptr, ptr @stdout, align 8, !tbaa !47
  %i.cy = tail call i32 @fflush(ptr noundef %i.cx) ; 0 uses
  br label %bb.s

bb.s:                                             ; preds = %bb.r, %bb.q
  store i32 %i.ci, ptr %i.bz, align 8, !tbaa !45
  %.pre.i26 = load i32, ptr %i.ca, align 4, !tbaa !39
  br label %veci_push.exit
...
!18 = !{!"p2 int", !17, i64 0}
!19 = !{!"Sat_Mem_t_", !10, i64 0, !10, i64 8, !10, i64 16, !10, i64 24, !11, i64 32, !11, i64 36, !11, i64 40, !11, i64 44, !18, i64 48}
!20 = !{!"p1 _ZTS6veci_t", !15, i64 0}
!21 = !{!"veci_t", !11, i64 0, !11, i64 4, !16, i64 8}
!22 = !{!"p1 _ZTS10varinfo2_t", !15, i64 0}
!23 = !{!"p1 omnipotent char", !15, i64 0}
!24 = !{!"p1 _ZTS10Vec_Set_t_", !15, i64 0}
!25 = !{!"p1 _ZTS10Prf_Man_t_", !15, i64 0}
!26 = !{!"p1 _ZTS11Int2_Man_t_", !15, i64 0}
!27 = !{!"long", !10, i64 0}
!28 = !{!"stats_t", !11, i64 0, !11, i64 4, !11, i64 8, !27, i64 16, !27, i64 24, !27, i64 32, !27, i64 40, !27, i64 48, !27, i64 56, !27, i64 64}
!29 = !{!"sat_solver2_t", !11, i64 0, !11, i64 4, !11, i64 8, !11, i64 12, !11, i64 16, !14, i64 24, !14, i64 32, !11, i64 40, !11, i64 44, !11, i64 48, !11, i64 52, !16, i64 56, !16, i64 64, !11, i64 72, !11, i64 76, !11, i64 80, !11, i64 84, !11, i64 88, !11, i64 92, !11, i64 96, !11, i64 100, !11, i64 104, !11, i64 108, !11, i64 112, !19, i64 120, !20, i64 176, !21, i64 184, !21, i64 200, !11, i64 216, !11, i64 220, !11, i64 224, !22, i64 232, !16, i64 240, !23, i64 248, !16, i64 256, !16, i64 264, !16, i64 272, !16, i64 280, !16, i64 288, !21, i64 296, !21, i64 312, !21, i64 328, !21, i64 344, !21, i64 360, !21, i64 376, !21, i64 392, !21, i64 408, !21, i64 424, !21, i64 440, !24, i64 456, !21, i64 464, !11, i64 480, !11, i64 484, !25, i64 488, !14, i64 496, !26, i64 504, !11, i64 512, !28, i64 520, !27, i64 592, !27, i64 600, !27, i64 608}
!30 = !{!29, !23, i64 248}
!31 = !{!10, !10, i64 0}
!32 = !{!29, !22, i64 232}
!33 = !{!29, !11, i64 12}
...
!59 = !{!29, !25, i64 488}
!60 = !{!"p1 long", !15, i64 0}
!61 = !{!"p1 _ZTS10Vec_Wrd_t_", !15, i64 0}
!62 = !{!"p1 _ZTS10Vec_Int_t_", !15, i64 0}
!63 = !{!"Prf_Man_t_", !11, i64 0, !11, i64 4, !11, i64 8, !60, i64 16, !61, i64 24, !62, i64 32, !62, i64 40}
!64 = !{!63, !11, i64 8}
!65 = !{!63, !61, i64 24}
!66 = !{!"Vec_Wrd_t_", !11, i64 0, !11, i64 4, !60, i64 8}
!67 = !{!66, !11, i64 4}
!68 = !{!66, !11, i64 0}
!69 = !{!66, !60, i64 8}
!70 = !{!27, !27, i64 0}
...
!74 = !{!63, !62, i64 40}
!75 = !{!"Vec_Int_t_", !11, i64 0, !11, i64 4, !16, i64 8}
!76 = !{!75, !16, i64 8}
!77 = !{!29, !24, i64 456}
!78 = !{!"p2 long", !17, i64 0}
!79 = !{!"Vec_Set_t_", !11, i64 0, !11, i64 4, !11, i64 8, !11, i64 12, !11, i64 16, !11, i64 20, !78, i64 24}
!80 = !{!79, !78, i64 24}
!81 = !{!79, !11, i64 12}
!82 = !{!60, !60, i64 0}
!83 = !{!79, !11, i64 0}
...
!102 = !{!75, !11, i64 0}
!103 = !{!75, !11, i64 4}
!104 = !{!"timespec", !27, i64 0, !27, i64 8}
!105 = !{!104, !27, i64 0}
!106 = !{!104, !27, i64 8}
!107 = !{!29, !11, i64 80}
!108 = !{!19, !11, i64 40}
...
!113 = distinct !{!113, !48}
!114 = distinct !{!114, !48}
!115 = distinct !{!115, !48, !55, !56}
!116 = distinct !{!116, !48, !55}
!117 = distinct !{!117, !48}
!118 = distinct !{!118, !48}
!119 = !{!29, !27, i64 552}
!120 = distinct !{!120, !48}
...
!124 = distinct !{!124, !48, !55, !56}
!125 = distinct !{!125, !73}
!126 = distinct !{!126, !48, !55}
!127 = !{!122}
!128 = !{!123}
!129 = distinct !{!129, !"LVerDomain"}
!130 = distinct !{!130, !129}
!131 = distinct !{!131, !129}
!132 = distinct !{!132, !48, !55, !56}
!133 = distinct !{!133, !73}
!134 = distinct !{!134, !48, !55}
!135 = !{!130}
!136 = !{!131}
!137 = !{!79, !11, i64 8}
!138 = !{!29, !14, i64 24}
...
!155 = distinct !{!155, !154, !"vprintf: argument 0"}
!156 = distinct !{null}
!157 = !{!155}
!158 = distinct !{!158, !48}
!159 = distinct !{!159, !48}
