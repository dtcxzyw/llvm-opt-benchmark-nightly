...
.lr.ph51.i109.preheader:                          ; preds = %.preheader42.i99
  %.033.lcssa.i100253 = ptrtoaddr ptr %.033.lcssa.i100 to i64 ; 3 uses
  %.036.lcssa.i102252 = ptrtoaddr ptr %.036.lcssa.i102 to i64
  %i.du = ptrtoaddr ptr %i.e to i64
  %2 = add i64 %.idx.i96, %i.du
  %3 = add i64 %2, 4
  %i.dv = add i64 %.033.lcssa.i100253, 4
  %4 = call i64 @llvm.umax.i64(i64 %3, i64 %i.dv)
  %5 = xor i64 %.033.lcssa.i100253, -1
  %6 = add i64 %4, %5                             ; 2 uses
  %i.dw = lshr i64 %6, 2
  %i.dx = add nuw nsw i64 %i.dw, 1                ; 2 uses
  %min.iters.check256 = icmp ult i64 %6, 44
...
.preheader42.i123:                                ; preds = %bb.p, %Sbd_CutMergeSimple.exit119
  ...
  %.0.lcssa.i125310 = ptrtoaddr ptr %.0.lcssa.i125 to i64 ; 3 uses
...
.lr.ph55.i130.preheader:                          ; preds = %.preheader.i127
  ...
  %7 = add i64 %.idx57.i121, %i.ho
  %8 = add i64 %7, 4
  %i.hp = add i64 %.0.lcssa.i125310, 4
  %9 = call i64 @llvm.umax.i64(i64 %8, i64 %i.hp)
  %10 = xor i64 %.0.lcssa.i125310, -1
  %11 = add i64 %9, %10                           ; 2 uses
  %i.hq = lshr i64 %11, 2
  %i.hr = add nuw nsw i64 %i.hq, 1                ; 2 uses
  %min.iters.check313 = icmp ult i64 %11, 44
...
.preheader42.i147:                                ; preds = %bb.u, %Sbd_CutMergeSimple.exit143
  ...
  %.0.lcssa.i149348 = ptrtoaddr ptr %.0.lcssa.i149 to i64 ; 3 uses
...
.lr.ph51.i157.preheader:                          ; preds = %.preheader42.i147
  %.033.lcssa.i148329 = ptrtoaddr ptr %.033.lcssa.i148 to i64 ; 3 uses
  %.036.lcssa.i150328 = ptrtoaddr ptr %.036.lcssa.i150 to i64
  %i.ix = ptrtoaddr ptr %i.e to i64
  %12 = add i64 %.idx.i144, %i.ix
  %13 = add i64 %12, 4
  %i.iy = add i64 %.033.lcssa.i148329, 4
  %14 = call i64 @llvm.umax.i64(i64 %13, i64 %i.iy)
  %15 = xor i64 %.033.lcssa.i148329, -1
  %16 = add i64 %14, %15                          ; 2 uses
  %i.iz = lshr i64 %16, 2
  %i.ja = add nuw nsw i64 %i.iz, 1                ; 2 uses
  %min.iters.check332 = icmp ult i64 %16, 44
...
.lr.ph55.i154.preheader:                          ; preds = %.preheader.i151
  ...
  %17 = add i64 %.idx57.i145.pre-phi, %i.jv
  %18 = add i64 %17, 4
  %i.jw = add i64 %.0.lcssa.i149348, 4
  %19 = call i64 @llvm.umax.i64(i64 %18, i64 %i.jw)
  %20 = xor i64 %.0.lcssa.i149348, -1
  %21 = add i64 %19, %20                          ; 2 uses
  %i.jx = lshr i64 %21, 2
  %i.jy = add nuw nsw i64 %i.jx, 1                ; 2 uses
  %min.iters.check351 = icmp ult i64 %21, 44
