...
Vec_IntGrow.exit11.sink.split.i.i:                ; preds = %bb.g, %bb.f
  %.pre255.i.a = phi i32 [ %.pre255.pre.i, %bb.f ], [ 0, %bb.g ]
...
Vec_IntPush.exit.i:                               ; preds = %Vec_IntGrow.exit11.sink.split.i.i, %bb.d
  %i.aj = phi i32 [ %.pre255.i.a, %Vec_IntGrow.exit11.sink.split.i.i ], [ 0, %bb.d ] ; 2 uses
...
Vec_IntGrow.exit11.sink.split.i94.i:              ; preds = %bb.m, %bb.l
  ...
  %.pre250.i.a = phi i32 [ %.pre250.pre.i, %bb.l ], [ 0, %bb.m ]
...
Vec_IntPush.exit98.i:                             ; preds = %Vec_IntGrow.exit11.sink.split.i94.i, %bb.j
  ...
  %i.bf = phi i32 [ %.pre250.i.a, %Vec_IntGrow.exit11.sink.split.i94.i ], [ 0, %bb.j ] ; 2 uses
...
.lr.ph165.i:                                      ; preds = %.lr.ph167.i
  %i.fj = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv238.i
  br label %bb.aw
...
.lr.ph163.i:                                      ; preds = %bb.aw
  ...
  %i.fl = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv233.i
  br label %bb.ax

.loopexit.i:                                      ; preds = %bb.ba, %bb.ax
  %indvars.iv.next216.i = add nsw i64 %indvars.iv215.i, 1
  %exitcond292 = icmp eq i32 %2, %i.fm
...
bb.ax:                                            ; preds = %.loopexit.i, %.lr.ph163.i
  ...
  %indvars.iv215.i = phi i64 [ %i.fk, %.lr.ph163.i ], [ %indvars.iv.next216.i, %.loopexit.i ] ; 2 uses
  %indvars.iv.next227.i = add nuw nsw i64 %indvars.iv226.i, 1 ; 2 uses
  %i.fm = trunc i64 %indvars.iv.next227.i to i32  ; 2 uses
  %i.fn = icmp sgt i32 %2, %i.fm
  br i1 %i.fn, label %.lr.ph161.i, label %.loopexit.i

.lr.ph161.i:                                      ; preds = %bb.ax
  %i.fo = load i64, ptr %i.fj, align 8, !tbaa !100
  %i.fp = load i64, ptr %i.fl, align 8, !tbaa !100
  %i.fq = or i64 %i.fp, %i.fo
  %i.fr = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv226.i
  %i.fs = load i64, ptr %i.fr, align 8, !tbaa !100
...
bb.ay:                                            ; preds = %bb.ba, %.lr.ph161.i
  ...
  %i.fu = getelementptr inbounds [8 x i8], ptr %1, i64 %indvars.iv217.i
  %i.fv = load i64, ptr %i.fu, align 8, !tbaa !100
  %i.fw = or i64 %i.ft, %i.fv
  %i.fx = icmp eq i64 %i.fw, %i.j
  br i1 %i.fx, label %bb.az, label %bb.ba

bb.az:                                            ; preds = %bb.ay
  %i.fy = trunc nuw nsw i64 %indvars.iv238.i to i32
  %i.fz = trunc nuw nsw i64 %indvars.iv233.i to i32
  %i.ga = trunc nuw i64 %indvars.iv226.i to i32
  %i.gb = trunc nsw i64 %indvars.iv217.i to i32
  tail call fastcc void @Vec_IntPush(ptr noundef %i.w, i32 noundef %i.fy)
  ...
  %i.ge = load ptr, ptr %i.x, align 8, !tbaa !93
  tail call fastcc void @Vec_IntPush(ptr noundef %i.ge, i32 noundef %i.gb)
  br label %Sbd_ManFindCandsSimple.exit
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.bf
  ...
  %i.gf = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv
  %i.gg = load i64, ptr %i.gf, align 8, !tbaa !100
  %i.gh = icmp eq i64 %i.gg, %i.j
  br i1 %i.gh, label %bb.bb, label %bb.bf

bb.bb:                                            ; preds = %.lr.ph
  %i.gi = trunc nuw nsw i64 %indvars.iv to i32
  %i.gj = load i32, ptr %i.p, align 8, !tbaa !45
  %i.gk = icmp eq i32 %i.gj, 0
  %i.gl = getelementptr inbounds nuw i8, ptr %i.p, i64 8 ; 2 uses
  %i.gm = load ptr, ptr %i.gl, align 8, !tbaa !44 ; 3 uses
  br i1 %i.gk, label %bb.bc, label %Vec_IntPush.exit
...
bb.bd:                                            ; preds = %bb.bc
  %i.gn = tail call dereferenceable_or_null(64) ptr @realloc(ptr noundef nonnull %i.gm, i64 noundef 64) #34
  %.pre298.pre = load i32, ptr %i.q, align 4, !tbaa !43
  br label %Vec_IntGrow.exit11.sink.split.i

bb.be:                                            ; preds = %bb.bc
  %i.go = tail call noalias dereferenceable_or_null(64) ptr @malloc(i64 noundef 64) #31
  br label %Vec_IntGrow.exit11.sink.split.i

Vec_IntGrow.exit11.sink.split.i:                  ; preds = %bb.bd, %bb.be
  %.pre298 = phi i32 [ %.pre298.pre, %bb.bd ], [ 0, %bb.be ]
  %i.gp = phi ptr [ %i.gn, %bb.bd ], [ %i.go, %bb.be ] ; 2 uses
  store ptr %i.gp, ptr %i.gl, align 8, !tbaa !44
  store i32 16, ptr %i.p, align 8, !tbaa !45
  br label %Vec_IntPush.exit

Vec_IntPush.exit:                                 ; preds = %bb.bb, %Vec_IntGrow.exit11.sink.split.i
  %i.gq = phi i32 [ %.pre298, %Vec_IntGrow.exit11.sink.split.i ], [ 0, %bb.bb ] ; 2 uses
  %i.gr = phi ptr [ %i.gp, %Vec_IntGrow.exit11.sink.split.i ], [ %i.gm, %bb.bb ]
  %i.gs = add nsw i32 %i.gq, 1
  store i32 %i.gs, ptr %i.q, align 4, !tbaa !43
...
vector.body:                                      ; preds = %vector.body, %.lr.ph161.preheader
  ...
  %i.gv = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %index ; 2 uses
  %i.gw = getelementptr inbounds nuw i8, ptr %i.gv, i64 16
  %wide.load = load <2 x i64>, ptr %i.gv, align 8, !tbaa !100
  %wide.load368 = load <2 x i64>, ptr %i.gw, align 8, !tbaa !100
  %i.gx = tail call range(i64 0, 65) <2 x i64> @llvm.ctpop.v2i64(<2 x i64> %wide.load)
  %i.gy = tail call range(i64 0, 65) <2 x i64> @llvm.ctpop.v2i64(<2 x i64> %wide.load368)
  %i.gz = trunc nuw nsw <2 x i64> %i.gx to <2 x i32>
  %i.ha = trunc nuw nsw <2 x i64> %i.gy to <2 x i32>
  %i.hb = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %index ; 2 uses
  %i.hc = getelementptr inbounds nuw i8, ptr %i.hb, i64 8
  store <2 x i32> %i.gz, ptr %i.hb, align 16, !tbaa !8
  store <2 x i32> %i.ha, ptr %i.hc, align 8, !tbaa !8
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.hd = icmp eq i64 %index.next, %n.vec
  br i1 %i.hd, label %middle.block, label %vector.body, !llvm.loop !280
...
.lr.ph159:                                        ; preds = %.lr.ph159.preheader, %.loopexit134
  ...
  %i.he = icmp slt i64 %indvars.iv.next217, %i.h
  br i1 %i.he, label %.lr.ph157, label %.loopexit134

.lr.ph157:                                        ; preds = %.lr.ph159
  %i.hf = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv216
  %i.hg = load i64, ptr %i.hf, align 8, !tbaa !100
  br label %bb.bg

bb.bg:                                            ; preds = %.lr.ph157, %bb.bu
  %indvars.iv211 = phi i64 [ %indvars.iv209, %.lr.ph157 ], [ %indvars.iv.next212, %bb.bu ] ; 3 uses
  %i.hh = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv211
  %i.hi = load i64, ptr %i.hh, align 8, !tbaa !100
  %i.hj = or i64 %i.hi, %i.hg
  %i.hk = icmp eq i64 %i.hj, %i.j
  br i1 %i.hk, label %bb.bh, label %bb.bu

bb.bh:                                            ; preds = %bb.bg
  %i.hl = trunc nuw nsw i64 %indvars.iv216 to i32
  %i.hm = trunc nuw nsw i64 %indvars.iv211 to i32
  %i.hn = load i32, ptr %i.p, align 8, !tbaa !45
  %i.ho = icmp eq i32 %i.hn, 0
  %i.hp = getelementptr inbounds nuw i8, ptr %i.p, i64 8 ; 2 uses
  %i.hq = load ptr, ptr %i.hp, align 8, !tbaa !44 ; 3 uses
  br i1 %i.ho, label %bb.bi, label %Vec_IntPush.exit118

bb.bi:                                            ; preds = %bb.bh
  %.not9.i.i116 = icmp eq ptr %i.hq, null
  br i1 %.not9.i.i116, label %bb.bk, label %bb.bj

bb.bj:                                            ; preds = %bb.bi
  %i.hr = tail call dereferenceable_or_null(64) ptr @realloc(ptr noundef nonnull %i.hq, i64 noundef 64) #34
...
bb.bk:                                            ; preds = %bb.bi
  %i.hs = tail call noalias dereferenceable_or_null(64) ptr @malloc(i64 noundef 64) #31
  br label %Vec_IntGrow.exit11.sink.split.i114
...
Vec_IntGrow.exit11.sink.split.i114:               ; preds = %bb.bj, %bb.bk
  ...
  %i.ht = phi ptr [ %i.hr, %bb.bj ], [ %i.hs, %bb.bk ] ; 2 uses
  store ptr %i.ht, ptr %i.hp, align 8, !tbaa !44
  store i32 16, ptr %i.p, align 8, !tbaa !45
  br label %Vec_IntPush.exit118

Vec_IntPush.exit118:                              ; preds = %bb.bh, %Vec_IntGrow.exit11.sink.split.i114
  %i.hu = phi ptr [ %.pre294, %Vec_IntGrow.exit11.sink.split.i114 ], [ %i.p, %bb.bh ] ; 6 uses
end_hunk_0
