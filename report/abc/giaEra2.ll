...
bb.j:                                             ; preds = %bb.i
  ...
  %i.au = zext nneg i32 %spec.select.i.i to i64
  %i.av = shl nuw nsw i64 %i.au, 3                ; 2 uses
  br i1 %.not9.i11.i.i, label %bb.l, label %bb.k

bb.k:                                             ; preds = %bb.j
  %i.aw = tail call ptr @realloc(ptr noundef nonnull %storemerge17.i, i64 noundef %i.av) #29
  br label %Vec_PtrPush.exit.i
...
Vec_PtrPush.exit.i:                               ; preds = %bb.l, %bb.k, %bb.i, %bb.h, %bb.g, %Vec_IntDup.exit.i
  %storemerge18.i = phi ptr [ %storemerge17.i, %Vec_IntDup.exit.i ], [ %storemerge17.i, %bb.i ], [ %i.aq, %bb.h ], [ %i.ap, %bb.g ], [ %i.aw, %bb.k ], [ %i.ax, %bb.l ] ; 3 uses
  ...
  %i.ay = getelementptr inbounds nuw [8 x i8], ptr %storemerge18.i, i64 %indvars.iv19.i
  store ptr %i.ab, ptr %i.ay, align 8, !tbaa !63
  %.val.i = load i32, ptr %i.p, align 4, !tbaa !68
  %i.az = sext i32 %.val.i to i64
  %i.ba = icmp slt i64 %indvars.iv.next20.i, %i.az
  br i1 %i.ba, label %bb.c, label %..critedge_crit_edge.i, !llvm.loop !71

..critedge_crit_edge.i:                           ; preds = %Vec_PtrPush.exit.i
  %i.bb = trunc nsw i64 %indvars.iv.next20.i to i32
  store i32 %i.bb, ptr %i.s, align 4, !tbaa !59
...
Vec_VecDupInt.exit:                               ; preds = %Vec_PtrAlloc.exit.i, %..critedge_crit_edge.i
  %i.bc = getelementptr inbounds nuw i8, ptr %i.a, i64 88
  store ptr %i.q, ptr %i.bc, align 8, !tbaa !72
  %i.bd = tail call noalias dereferenceable_or_null(16) ptr @malloc(i64 noundef 16) #30 ; 4 uses
  %i.be = getelementptr inbounds nuw i8, ptr %i.bd, i64 4
  store i32 0, ptr %i.be, align 4, !tbaa !53
  store i32 100, ptr %i.bd, align 8, !tbaa !54
  %i.bf = tail call noalias dereferenceable_or_null(400) ptr @malloc(i64 noundef 400) #30
  %i.bg = getelementptr inbounds nuw i8, ptr %i.bd, i64 8
  store ptr %i.bf, ptr %i.bg, align 8, !tbaa !55
  %i.bh = getelementptr inbounds nuw i8, ptr %i.a, i64 96
  store ptr %i.bd, ptr %i.bh, align 8, !tbaa !73
  %i.bi = tail call noalias dereferenceable_or_null(16) ptr @malloc(i64 noundef 16) #30 ; 4 uses
  %i.bj = getelementptr inbounds nuw i8, ptr %i.bi, i64 4
  store i32 0, ptr %i.bj, align 4, !tbaa !53
  store i32 100, ptr %i.bi, align 8, !tbaa !54
  %i.bk = tail call noalias dereferenceable_or_null(400) ptr @malloc(i64 noundef 400) #30
  %i.bl = getelementptr inbounds nuw i8, ptr %i.bi, i64 8
  store ptr %i.bk, ptr %i.bl, align 8, !tbaa !55
  %i.bm = getelementptr inbounds nuw i8, ptr %i.a, i64 104
  store ptr %i.bi, ptr %i.bm, align 8, !tbaa !74
...
end_hunk_2
begin_hunk_3_@Gia_ManAreDeriveNexts:bb.a
  br label %Vec_IntGrow.exit11.sink.split.i.i.i

bb.w:                                             ; preds = %bb.s
  %i.cj = icmp samesign ult i32 %i.ca, 1073741823
  %i.ck = shl nuw nsw i32 %i.ca, 1
  %spec.select.i.i.i = select i1 %i.cj, i32 %i.ck, i32 2147483647 ; 3 uses
  %.not.i9.i.i.i = icmp samesign ult i32 %i.ca, %spec.select.i.i.i
  br i1 %.not.i9.i.i.i, label %bb.x, label %Vec_IntPush.exit.i.i

bb.x:                                             ; preds = %bb.w
  %i.cl = getelementptr inbounds nuw i8, ptr %i.ao, i64 88 ; 2 uses
  %i.cm = load ptr, ptr %i.cl, align 8, !tbaa !55 ; 2 uses
  %.not9.i10.i.i.i = icmp eq ptr %i.cm, null
  %i.cn = zext nneg i32 %spec.select.i.i.i to i64
  %i.co = shl nuw nsw i64 %i.cn, 2                ; 2 uses
  br i1 %.not9.i10.i.i.i, label %bb.z, label %bb.y

bb.y:                                             ; preds = %bb.x
  %i.cp = call ptr @realloc(ptr noundef nonnull %i.cm, i64 noundef %i.co) #29
  br label %bb.aa

bb.z:                                             ; preds = %bb.x
  %i.cq = call noalias ptr @malloc(i64 noundef %i.co) #30
  br label %bb.aa

bb.aa:                                            ; preds = %bb.z, %bb.y
  %i.cr = phi ptr [ %i.cp, %bb.y ], [ %i.cq, %bb.z ]
  store ptr %i.cr, ptr %i.cl, align 8, !tbaa !55
  br label %Vec_IntGrow.exit11.sink.split.i.i.i

Vec_IntGrow.exit11.sink.split.i.i.i:              ; preds = %bb.aa, %Vec_IntGrow.exit.i.i.i
  %spec.select.sink.i.i.i = phi i32 [ %spec.select.i.i.i, %bb.aa ], [ 16, %Vec_IntGrow.exit.i.i.i ]
  store i32 %spec.select.sink.i.i.i, ptr %i.by, align 8, !tbaa !54
  %.pre.i.i = load i32, ptr %i.bz, align 4, !tbaa !53
  br label %Vec_IntPush.exit.i.i

Vec_IntPush.exit.i.i:                             ; preds = %Vec_IntGrow.exit11.sink.split.i.i.i, %bb.w, %bb.r
  %i.cs = phi i32 [ %i.ca, %bb.r ], [ %i.ca, %bb.w ], [ %.pre.i.i, %Vec_IntGrow.exit11.sink.split.i.i.i ] ; 2 uses
  %i.ct = getelementptr inbounds nuw i8, ptr %i.ao, i64 88
  %i.cu = load ptr, ptr %i.ct, align 8, !tbaa !55
  %i.cv = add nsw i32 %i.cs, 1
  store i32 %i.cv, ptr %i.bz, align 4, !tbaa !53
  %i.cw = sext i32 %i.cs to i64
  %i.cx = getelementptr inbounds [4 x i8], ptr %i.cu, i64 %i.cw
  store i32 0, ptr %i.cx, align 4, !tbaa !8
  br label %Gia_ManAppendObj.exit.i

Gia_ManAppendObj.exit.i:                          ; preds = %Vec_IntPush.exit.i.i, %bb.q
  %i.cy = load i32, ptr %i.ap, align 8, !tbaa !124 ; 2 uses
  %i.cz = add nsw i32 %i.cy, 1
  store i32 %i.cz, ptr %i.ap, align 8, !tbaa !124
  %i.da = getelementptr i8, ptr %i.ao, i64 32     ; 3 uses
  %.val36.i.i = load ptr, ptr %i.da, align 8, !tbaa !51
  %i.db = sext i32 %i.cy to i64
  %i.dc = getelementptr inbounds [12 x i8], ptr %.val36.i.i, i64 %i.db ; 4 uses
  %i.dd = load i64, ptr %i.dc, align 4
  %i.de = or i64 %i.dd, 2684354559                ; 2 uses
  store i64 %i.de, ptr %i.dc, align 4
  %i.df = getelementptr inbounds nuw i8, ptr %i.ao, i64 64 ; 2 uses
  %i.dg = load ptr, ptr %i.df, align 8, !tbaa !58
  %i.dh = getelementptr i8, ptr %i.dg, i64 4
  %.val11.i = load i32, ptr %i.dh, align 4, !tbaa !53
  %i.di = and i32 %.val11.i, 536870911
  %i.dj = zext nneg i32 %i.di to i64
  %i.dk = shl nuw nsw i64 %i.dj, 32
  %i.dl = and i64 %i.de, -2305843004918726657
  %i.dm = or disjoint i64 %i.dk, %i.dl
  store i64 %i.dm, ptr %i.dc, align 4
  %i.dn = load ptr, ptr %i.df, align 8, !tbaa !58 ; 6 uses
  %.val10.i = load ptr, ptr %i.da, align 8, !tbaa !51 ; 3 uses
  %i.do = getelementptr inbounds nuw i8, ptr %i.dn, i64 4 ; 3 uses
  %i.dp = load i32, ptr %i.do, align 4, !tbaa !53 ; 7 uses
  %i.dq = load i32, ptr %i.dn, align 8, !tbaa !54
  %i.dr = icmp eq i32 %i.dp, %i.dq
  br i1 %i.dr, label %bb.ab, label %Gia_ManAppendCi.exit

bb.ab:                                            ; preds = %Gia_ManAppendObj.exit.i
...
bb.ac:                                            ; preds = %bb.ab
  ...
  %.not9.i.i.i = icmp eq ptr %i.du, null
  br i1 %.not9.i.i.i, label %bb.ae, label %bb.ad

bb.ad:                                            ; preds = %bb.ac
  %i.dv = call dereferenceable_or_null(64) ptr @realloc(ptr noundef nonnull %i.du, i64 noundef 64) #29
  br label %Vec_IntGrow.exit.i.i

bb.ae:                                            ; preds = %bb.ac
  %i.dw = call noalias dereferenceable_or_null(64) ptr @malloc(i64 noundef 64) #30
  br label %Vec_IntGrow.exit.i.i

Vec_IntGrow.exit.i.i:                             ; preds = %bb.ae, %bb.ad
  %i.dx = phi ptr [ %i.dv, %bb.ad ], [ %i.dw, %bb.ae ]
  store ptr %i.dx, ptr %i.dt, align 8, !tbaa !55
  br label %Vec_IntGrow.exit11.sink.split.i.i

bb.af:                                            ; preds = %bb.ab
  %i.dy = icmp samesign ult i32 %i.dp, 1073741823
  %i.dz = shl nuw nsw i32 %i.dp, 1
  %spec.select.i.i = select i1 %i.dy, i32 %i.dz, i32 2147483647 ; 3 uses
  %.not.i9.i.i = icmp samesign ult i32 %i.dp, %spec.select.i.i
  br i1 %.not.i9.i.i, label %bb.ag, label %Gia_ManAppendCi.exit

bb.ag:                                            ; preds = %bb.af
  %i.ea = getelementptr inbounds nuw i8, ptr %i.dn, i64 8 ; 2 uses
  %i.eb = load ptr, ptr %i.ea, align 8, !tbaa !55 ; 2 uses
  %.not9.i10.i.i = icmp eq ptr %i.eb, null
  %i.ec = zext nneg i32 %spec.select.i.i to i64
  %i.ed = shl nuw nsw i64 %i.ec, 2                ; 2 uses
  br i1 %.not9.i10.i.i, label %bb.ai, label %bb.ah

bb.ah:                                            ; preds = %bb.ag
  %i.ee = call ptr @realloc(ptr noundef nonnull %i.eb, i64 noundef %i.ed) #29
  br label %bb.aj

bb.ai:                                            ; preds = %bb.ag
  %i.ef = call noalias ptr @malloc(i64 noundef %i.ed) #30
  br label %bb.aj

bb.aj:                                            ; preds = %bb.ai, %bb.ah
  %i.eg = phi ptr [ %i.ee, %bb.ah ], [ %i.ef, %bb.ai ]
  store ptr %i.eg, ptr %i.ea, align 8, !tbaa !55
  br label %Vec_IntGrow.exit11.sink.split.i.i

Vec_IntGrow.exit11.sink.split.i.i:                ; preds = %bb.aj, %Vec_IntGrow.exit.i.i
  %spec.select.sink.i.i = phi i32 [ %spec.select.i.i, %bb.aj ], [ 16, %Vec_IntGrow.exit.i.i ]
  store i32 %spec.select.sink.i.i, ptr %i.dn, align 8, !tbaa !54
  %.pre.i = load i32, ptr %i.do, align 4, !tbaa !53
  %.val.pre.i = load ptr, ptr %i.da, align 8, !tbaa !51
  br label %Gia_ManAppendCi.exit

Gia_ManAppendCi.exit:                             ; preds = %Gia_ManAppendObj.exit.i, %bb.af, %Vec_IntGrow.exit11.sink.split.i.i
  %.val.i = phi ptr [ %.val10.i, %Gia_ManAppendObj.exit.i ], [ %.val10.i, %bb.af ], [ %.val.pre.i, %Vec_IntGrow.exit11.sink.split.i.i ]
  %i.eh = phi i32 [ %i.dp, %Gia_ManAppendObj.exit.i ], [ %i.dp, %bb.af ], [ %.pre.i, %Vec_IntGrow.exit11.sink.split.i.i ] ; 2 uses
  %i.ei = ptrtoint ptr %i.dc to i64               ; 2 uses
  %i.ej = ptrtoint ptr %.val10.i to i64
  %i.ek = sub i64 %i.ei, %i.ej
  %i.el = sdiv exact i64 %i.ek, 12
  %i.em = trunc i64 %i.el to i32
  %i.en = getelementptr inbounds nuw i8, ptr %i.dn, i64 8
  %i.eo = load ptr, ptr %i.en, align 8, !tbaa !55
  %i.ep = add nsw i32 %i.eh, 1
  store i32 %i.ep, ptr %i.do, align 4, !tbaa !53
  %i.eq = sext i32 %i.eh to i64
  %i.er = getelementptr inbounds [4 x i8], ptr %i.eo, i64 %i.eq
  store i32 %i.em, ptr %i.er, align 4, !tbaa !8
  %i.es = ptrtoint ptr %.val.i to i64
  %i.et = sub i64 %i.ei, %i.es
  %i.eu = sdiv exact i64 %i.et, 12
  %i.ev = trunc i64 %i.eu to i32
  %i.ew = shl i32 %i.ev, 1
  %i.ex = getelementptr inbounds nuw i8, ptr %i.an, i64 8
  store i32 %i.ew, ptr %i.ex, align 4, !tbaa !102
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.ey = load ptr, ptr %0, align 8, !tbaa !13    ; 3 uses
  %i.ez = getelementptr inbounds nuw i8, ptr %i.ey, i64 64
  %i.fa = load ptr, ptr %i.ez, align 8, !tbaa !58 ; 2 uses
  %i.fb = getelementptr i8, ptr %i.fa, i64 4
  %.val85 = load i32, ptr %i.fb, align 4, !tbaa !53
  %i.fc = sext i32 %.val85 to i64
  %i.fd = icmp slt i64 %indvars.iv.next, %i.fc
  br i1 %i.fd, label %.lr.ph, label %.critedge, !llvm.loop !128

.critedge:                                        ; preds = %Gia_ManAppendCi.exit, %.lr.ph, %..critedge_crit_edge, %.thread
  %i.fe = phi ptr [ %.pre, %..critedge_crit_edge ], [ %i.z, %.thread ], [ %i.ey, %Gia_ManAppendCi.exit ], [ %i.ah, %.lr.ph ] ; 6 uses
  %i.ff = getelementptr i8, ptr %i.fe, i64 16
  %.val = load i32, ptr %i.ff, align 8, !tbaa !23 ; 3 uses
  %i.fg = icmp sgt i32 %.val, 0
  br i1 %i.fg, label %.lr.ph111, label %.critedge2

.lr.ph111:                                        ; preds = %.critedge
  %i.fh = getelementptr i8, ptr %i.fe, i64 64
  %.val101 = load ptr, ptr %i.fh, align 8, !tbaa !58 ; 2 uses
  %i.fi = getelementptr i8, ptr %.val101, i64 4
  %.val101.val = load i32, ptr %i.fi, align 4, !tbaa !53
  %invariant.op = sub i32 %.val101.val, %.val
  %i.fj = getelementptr i8, ptr %i.fe, i64 32
  %.val91 = load ptr, ptr %i.fj, align 8, !tbaa !51 ; 2 uses
  %i.fk = getelementptr i8, ptr %.val101, i64 8
  %.val92.val = load ptr, ptr %i.fk, align 8, !tbaa !55
  %.not74 = icmp eq ptr %.val91, null
  %i.fl = getelementptr inbounds nuw i8, ptr %i.p, i64 8
...
.lr.ph111.split:                                  ; preds = %.lr.ph111.split.preheader, %bb.am
  %indvars.iv121 = phi i64 [ 0, %.lr.ph111.split.preheader ], [ %indvars.iv.next122, %bb.am ] ; 3 uses
  %i.fm = trunc nuw nsw i64 %indvars.iv121 to i32
  %.reass = add i32 %invariant.op, %i.fm
  %i.fn = sext i32 %.reass to i64
  %i.fo = getelementptr inbounds [4 x i8], ptr %.val92.val, i64 %i.fn
  ...
  %i.fx = and i32 %i.fs, 30                       ; 2 uses
  %i.fy = shl nuw nsw i32 1, %i.fx
  %i.fz = and i32 %i.fw, %i.fy
  %.not78 = icmp eq i32 %i.fz, 0
  br i1 %.not78, label %bb.ak, label %bb.am

bb.ak:                                            ; preds = %.lr.ph111.split
  %i.ga = shl nuw i32 2, %i.fx
  %i.gb = and i32 %i.fw, %i.ga
  %.not79 = icmp eq i32 %i.gb, 0
  br i1 %.not79, label %bb.al, label %bb.am

bb.al:                                            ; preds = %bb.ak
  %i.gc = load ptr, ptr %i.q, align 8, !tbaa !76
  %.val96 = load i64, ptr %i.fr, align 4
  %i.gd = lshr i64 %.val96, 32
  %i.ge = and i64 %i.gd, 536870911
  %i.gf = getelementptr i8, ptr %i.gc, i64 64
  %.val90 = load ptr, ptr %i.gf, align 8, !tbaa !58
  %i.gg = getelementptr i8, ptr %.val90, i64 8
  %.val90.val = load ptr, ptr %i.gg, align 8, !tbaa !55
  %i.gh = getelementptr inbounds nuw [4 x i8], ptr %.val90.val, i64 %i.ge
  %i.gi = load i32, ptr %i.gh, align 4, !tbaa !8
  %i.gj = shl nsw i32 %i.gi, 1
  br label %bb.am

bb.am:                                            ; preds = %bb.ak, %.lr.ph111.split, %bb.al
  %.sink = phi i32 [ 0, %.lr.ph111.split ], [ %i.gj, %bb.al ], [ 1, %bb.ak ]
  %i.gk = getelementptr inbounds nuw i8, ptr %i.fr, i64 8
  store i32 %.sink, ptr %i.gk, align 4, !tbaa !102
  %indvars.iv.next122 = add nuw nsw i64 %indvars.iv121, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next122, %wide.trip.count
  br i1 %exitcond.not, label %.critedge2, label %.lr.ph111.split, !llvm.loop !129

.critedge2:                                       ; preds = %bb.am, %.lr.ph111, %.critedge
  %i.gl = getelementptr inbounds nuw i8, ptr %i.fe, i64 24
  %i.gm = load i32, ptr %i.gl, align 8, !tbaa !124
  %i.gn = icmp sgt i32 %i.gm, 0
  br i1 %i.gn, label %.lr.ph114, label %.critedge4

.lr.ph114:                                        ; preds = %.critedge2, %bb.ap
  %i.go = phi ptr [ %i.hp, %bb.ap ], [ %i.fe, %.critedge2 ] ; 3 uses
  %indvars.iv124 = phi i64 [ %indvars.iv.next125, %bb.ap ], [ 0, %.critedge2 ] ; 2 uses
  %i.gp = getelementptr i8, ptr %i.go, i64 32
  %.val86 = load ptr, ptr %i.gp, align 8, !tbaa !51 ; 2 uses
  %i.gq = getelementptr inbounds nuw [12 x i8], ptr %.val86, i64 %indvars.iv124 ; 4 uses
  %.not75 = icmp eq ptr %.val86, null
  br i1 %.not75, label %.critedge4, label %bb.an

bb.an:                                            ; preds = %.lr.ph114
  %.val97 = load i64, ptr %i.gq, align 4          ; 5 uses
  %i.gr = and i64 %.val97, 2147483648
  %.not.i = icmp ne i64 %i.gr, 0
  %i.gs = and i64 %.val97, 536870911              ; 2 uses
  %i.gt = icmp eq i64 %i.gs, 536870911
  %narrow.i.not = or i1 %.not.i, %i.gt
  br i1 %narrow.i.not, label %bb.ap, label %bb.ao

bb.ao:                                            ; preds = %bb.an
  %i.gu = load ptr, ptr %i.q, align 8, !tbaa !76
  %i.gv = sub nsw i64 0, %i.gs
  %i.gw = getelementptr inbounds [12 x i8], ptr %i.gq, i64 %i.gv
  %i.gx = getelementptr inbounds nuw i8, ptr %i.gw, i64 8
  %i.gy = load i32, ptr %i.gx, align 4, !tbaa !102
  %i.gz = trunc i64 %.val97 to i32
  %i.ha = lshr i32 %i.gz, 29
  %i.hb = and i32 %i.ha, 1
  %i.hc = xor i32 %i.gy, %i.hb
  %i.hd = lshr i64 %.val97, 32
  %i.he = and i64 %i.hd, 536870911
  %i.hf = sub nsw i64 0, %i.he
  %i.hg = getelementptr inbounds [12 x i8], ptr %i.gq, i64 %i.hf
  %i.hh = getelementptr inbounds nuw i8, ptr %i.hg, i64 8
  %i.hi = load i32, ptr %i.hh, align 4, !tbaa !102
  %i.hj = lshr i64 %.val97, 61
  %i.hk = trunc nuw nsw i64 %i.hj to i32
  %i.hl = and i32 %i.hk, 1
  %i.hm = xor i32 %i.hi, %i.hl
  %i.hn = call i32 @Gia_ManHashAnd(ptr noundef %i.gu, i32 noundef %i.hc, i32 noundef %i.hm) #27
  %i.ho = getelementptr inbounds nuw i8, ptr %i.gq, i64 8
  store i32 %i.hn, ptr %i.ho, align 4, !tbaa !102
  %.pre132 = load ptr, ptr %0, align 8, !tbaa !13
  br label %bb.ap

bb.ap:                                            ; preds = %bb.ao, %bb.an
  %i.hp = phi ptr [ %.pre132, %bb.ao ], [ %i.go, %bb.an ] ; 3 uses
  %indvars.iv.next125 = add nuw nsw i64 %indvars.iv124, 1 ; 2 uses
  %i.hq = getelementptr inbounds nuw i8, ptr %i.hp, i64 24
  %i.hr = load i32, ptr %i.hq, align 8, !tbaa !124
  %i.hs = sext i32 %i.hr to i64
  %i.ht = icmp slt i64 %indvars.iv.next125, %i.hs
  br i1 %i.ht, label %.lr.ph114, label %.critedge4, !llvm.loop !130

.critedge4:                                       ; preds = %.lr.ph114, %bb.ap, %.critedge2
  %.lcssa = phi ptr [ %i.fe, %.critedge2 ], [ %i.hp, %bb.ap ], [ %i.go, %.lr.ph114 ] ; 2 uses
  %i.hu = getelementptr inbounds nuw i8, ptr %.lcssa, i64 72
  %i.hv = load ptr, ptr %i.hu, align 8, !tbaa !56 ; 2 uses
  %i.hw = getelementptr i8, ptr %i.hv, i64 4
  %.val84 = load i32, ptr %i.hw, align 4, !tbaa !53 ; 4 uses
  %i.hx = icmp sgt i32 %.val84, 0
  br i1 %i.hx, label %.lr.ph118, label %.critedge6

.lr.ph118:                                        ; preds = %.critedge4
  %i.hy = getelementptr i8, ptr %.lcssa, i64 32
  %.val87 = load ptr, ptr %i.hy, align 8, !tbaa !51 ; 4 uses
...
.lr.ph118.split:                                  ; preds = %.lr.ph118
  ...
  %.val88.val = load ptr, ptr %i.hz, align 8, !tbaa !55 ; 3 uses
  %wide.trip.count130 = zext nneg i32 %.val84 to i64 ; 2 uses
  %xtraiter = and i64 %wide.trip.count130, 1
  %i.ia = icmp eq i32 %.val84, 1
  br i1 %i.ia, label %.epil.preheader, label %.lr.ph118.split.new

.lr.ph118.split.new:                              ; preds = %.lr.ph118.split
  %unroll_iter = and i64 %wide.trip.count130, 2147483646
  br label %bb.aq

bb.aq:                                            ; preds = %bb.aq, %.lr.ph118.split.new
  %indvars.iv127 = phi i64 [ 0, %.lr.ph118.split.new ], [ %indvars.iv.next128.1, %bb.aq ] ; 3 uses
  %niter = phi i64 [ 0, %.lr.ph118.split.new ], [ %niter.next.1, %bb.aq ]
  %i.ib = getelementptr inbounds nuw [4 x i8], ptr %.val88.val, i64 %indvars.iv127
  %i.ic = load i32, ptr %i.ib, align 4, !tbaa !8
  %i.id = sext i32 %i.ic to i64
  %i.ie = getelementptr inbounds [12 x i8], ptr %.val87, i64 %i.id ; 3 uses
  %i.if = load i64, ptr %i.ie, align 4            ; 2 uses
  %i.ig = and i64 %i.if, 536870911
  %i.ih = sub nsw i64 0, %i.ig
  %i.ii = getelementptr inbounds [12 x i8], ptr %i.ie, i64 %i.ih
  %i.ij = getelementptr inbounds nuw i8, ptr %i.ii, i64 8
  %i.ik = load i32, ptr %i.ij, align 4, !tbaa !102
  %i.il = trunc i64 %i.if to i32
  %i.im = lshr i32 %i.il, 29
  %i.in = and i32 %i.im, 1
  %i.io = xor i32 %i.in, %i.ik
  %i.ip = getelementptr inbounds nuw i8, ptr %i.ie, i64 8
  store i32 %i.io, ptr %i.ip, align 4, !tbaa !102
  %i.iq = getelementptr inbounds nuw [4 x i8], ptr %.val88.val, i64 %indvars.iv127
  %i.ir = getelementptr inbounds nuw i8, ptr %i.iq, i64 4
  %i.is = load i32, ptr %i.ir, align 4, !tbaa !8
  %i.it = sext i32 %i.is to i64
  %i.iu = getelementptr inbounds [12 x i8], ptr %.val87, i64 %i.it ; 3 uses
  %i.iv = load i64, ptr %i.iu, align 4            ; 2 uses
  %i.iw = and i64 %i.iv, 536870911
  %i.ix = sub nsw i64 0, %i.iw
  %i.iy = getelementptr inbounds [12 x i8], ptr %i.iu, i64 %i.ix
  %i.iz = getelementptr inbounds nuw i8, ptr %i.iy, i64 8
  %i.ja = load i32, ptr %i.iz, align 4, !tbaa !102
  %i.jb = trunc i64 %i.iv to i32
  %i.jc = lshr i32 %i.jb, 29
  %i.jd = and i32 %i.jc, 1
  %i.je = xor i32 %i.jd, %i.ja
  %i.jf = getelementptr inbounds nuw i8, ptr %i.iu, i64 8
  store i32 %i.je, ptr %i.jf, align 4, !tbaa !102
  %indvars.iv.next128.1 = add nuw nsw i64 %indvars.iv127, 2 ; 2 uses
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %.critedge6.loopexit.unr-lcssa, label %bb.aq, !llvm.loop !131

.critedge6.loopexit.unr-lcssa:                    ; preds = %bb.aq
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %.critedge6, label %.epil.preheader

.epil.preheader:                                  ; preds = %.critedge6.loopexit.unr-lcssa, %.lr.ph118.split
  %indvars.iv127.epil.init = phi i64 [ 0, %.lr.ph118.split ], [ %indvars.iv.next128.1, %.critedge6.loopexit.unr-lcssa ]
  %lcmp.mod145 = trunc i32 %.val84 to i1
  call void @llvm.assume(i1 %lcmp.mod145)
  %i.jg = getelementptr inbounds nuw [4 x i8], ptr %.val88.val, i64 %indvars.iv127.epil.init
  %i.jh = load i32, ptr %i.jg, align 4, !tbaa !8
  %i.ji = sext i32 %i.jh to i64
  %i.jj = getelementptr inbounds [12 x i8], ptr %.val87, i64 %i.ji ; 3 uses
  %i.jk = load i64, ptr %i.jj, align 4            ; 2 uses
  %i.jl = and i64 %i.jk, 536870911
  %i.jm = sub nsw i64 0, %i.jl
  %i.jn = getelementptr inbounds [12 x i8], ptr %i.jj, i64 %i.jm
  %i.jo = getelementptr inbounds nuw i8, ptr %i.jn, i64 8
  %i.jp = load i32, ptr %i.jo, align 4, !tbaa !102
  %i.jq = trunc i64 %i.jk to i32
  %i.jr = lshr i32 %i.jq, 29
  %i.js = and i32 %i.jr, 1
  %i.jt = xor i32 %i.js, %i.jp
  %i.ju = getelementptr inbounds nuw i8, ptr %i.jj, i64 8
  store i32 %i.jt, ptr %i.ju, align 4, !tbaa !102
  br label %.critedge6

.critedge6:                                       ; preds = %.epil.preheader, %.critedge6.loopexit.unr-lcssa, %.lr.ph118, %.critedge4
  %i.jv = getelementptr inbounds nuw i8, ptr %0, i64 176 ; 2 uses
  store i32 0, ptr %i.jv, align 8, !tbaa !104
  %i.jw = call i32 @Gia_ManAreDeriveNexts_rec(ptr noundef nonnull %0, i32 %1)
  %i.jx = load i32, ptr %i.jv, align 8, !tbaa !104
  %i.jy = icmp sgt i32 %i.jx, 999999
  br i1 %i.jy, label %bb.ar, label %bb.as

bb.ar:                                            ; preds = %.critedge6
end_hunk_3
