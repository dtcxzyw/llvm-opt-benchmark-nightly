...
.lr.ph.i:                                         ; preds = %bb.c
  %i.r = load ptr, ptr %i.e, align 8, !tbaa !24   ; 3 uses
...
.lr.ph25.i:                                       ; preds = %.preheader.i
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %i.y, ptr noundef nonnull align 4 dereferenceable(1) %scevgep29.i, i64 %i.ae, i1 false), !tbaa !25
...
.lr.ph.i105:                                      ; preds = %bb.f
  %i.ai = load ptr, ptr %i.e, align 8, !tbaa !24  ; 3 uses
...
.lr.ph25.i115:                                    ; preds = %.preheader.i112
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %i.ap, ptr noundef nonnull align 4 dereferenceable(1) %scevgep29.i117, i64 %i.av, i1 false), !tbaa !25
...
.lr.ph.i121:                                      ; preds = %.lr.ph230.split
  %i.bg = load ptr, ptr %i.i, align 8, !tbaa !24  ; 3 uses
...
.lr.ph25.i131:                                    ; preds = %.preheader.i128
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %i.bn, ptr noundef nonnull align 4 dereferenceable(1) %scevgep29.i133, i64 %i.bt, i1 false), !tbaa !25
...
.lr.ph.i137:                                      ; preds = %bb.l
  %i.cn = load ptr, ptr %i.ce, align 8, !tbaa !24 ; 3 uses
...
.lr.ph25.i147:                                    ; preds = %.preheader.i144
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %i.cu, ptr noundef nonnull align 4 dereferenceable(1) %scevgep29.i149, i64 %i.da, i1 false), !tbaa !25
...
.lr.ph.i153:                                      ; preds = %Vec_IntRemove1.exit151
  %i.df = load ptr, ptr %i.cg, align 8, !tbaa !24 ; 3 uses
...
.lr.ph25.i163:                                    ; preds = %.preheader.i160
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %i.dm, ptr noundef nonnull align 4 dereferenceable(1) %scevgep29.i165, i64 %i.ds, i1 false), !tbaa !25
...
.lr.ph.i169:                                      ; preds = %.lr.ph241.split
  %i.fg = load ptr, ptr %i.eq, align 8, !tbaa !24 ; 3 uses
...
.lr.ph25.i179:                                    ; preds = %.preheader.i176
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %i.fn, ptr noundef nonnull align 4 dereferenceable(1) %scevgep29.i181, i64 %i.ft, i1 false), !tbaa !25
...
.lr.ph.i185:                                      ; preds = %.lr.ph247.split
  %i.gi = load ptr, ptr %i.ev, align 8, !tbaa !24 ; 3 uses
...
.lr.ph25.i195:                                    ; preds = %.preheader.i192
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %i.gp, ptr noundef nonnull align 4 dereferenceable(1) %scevgep29.i197, i64 %i.gv, i1 false), !tbaa !25
