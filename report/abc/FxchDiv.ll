...
begin_hunk_0_@Fxch_DivSepareteCubes:bb.a
  ...
  %.pre48 = load ptr, ptr %i.e, align 8, !tbaa !24 ; 3 uses
...
Vec_IntGrow.exit11.sink.split.i:                  ; preds = %bb.j, %bb.k, %bb.f, %bb.g
  ...
  store ptr %i.y, ptr %i.e, align 8, !tbaa !24
  store i32 %spec.select.sink.i, ptr %2, align 8, !tbaa !26
  %.pre49 = load i32, ptr %i.d, align 4, !tbaa !21
...
bb.l:                                             ; preds = %bb.b
  %i.ac = load i32, ptr %i.f, align 4, !tbaa !21  ; 7 uses
  %i.ad = load i32, ptr %1, align 8, !tbaa !26
...
.Vec_IntPush.exit43_crit_edge:                    ; preds = %bb.l
  %.pre50 = load ptr, ptr %i.g, align 8, !tbaa !24
...
bb.n:                                             ; preds = %bb.m
  %i.ag = load ptr, ptr %i.g, align 8, !tbaa !24  ; 2 uses
...
bb.q:                                             ; preds = %bb.m
  ...
  %.pre51 = load ptr, ptr %i.g, align 8, !tbaa !24 ; 3 uses
...
Vec_IntGrow.exit11.sink.split.i39:                ; preds = %bb.s, %bb.t, %bb.o, %bb.p
  ...
  store ptr %i.ap, ptr %i.g, align 8, !tbaa !24
  store i32 %spec.select.sink.i40, ptr %1, align 8, !tbaa !26
  %.pre52 = load i32, ptr %i.f, align 4, !tbaa !21
  br label %Vec_IntPush.exit43
...
Vec_IntPush.exit43:                               ; preds = %.Vec_IntPush.exit43_crit_edge, %bb.q, %Vec_IntGrow.exit11.sink.split.i39
  ...
  store i32 %i.as, ptr %i.f, align 4, !tbaa !21
  br label %bb.u
...
bb.u:                                             ; preds = %Vec_IntPush.exit, %Vec_IntPush.exit43
  ...
  store i32 %i.k, ptr %i.au, align 4, !tbaa !25
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %.val35 = load i32, ptr %i.a, align 4, !tbaa !21 ; 2 uses
...
bb.x:                                             ; preds = %bb.w
  store i32 %i.be, ptr %i.bb, align 4, !tbaa !25
  store i32 %i.bc, ptr %i.bd, align 4, !tbaa !25
  br label %bb.y

bb.y:                                             ; preds = %bb.x, %bb.w
  %i.bg = getelementptr i8, ptr %2, i64 8
  %.val31 = load ptr, ptr %i.bg, align 8, !tbaa !24 ; 2 uses
...
bb.z:                                             ; preds = %bb.y
  store i32 %i.bk, ptr %i.bh, align 4, !tbaa !25
...
.lr.ph230:                                        ; preds = %.critedge.preheader
  ...
  %.val95 = load ptr, ptr %i.g, align 8, !tbaa !24
  %i.h = getelementptr inbounds nuw i8, ptr %1, i64 4 ; 3 uses
  %i.i = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.j = load i32, ptr %i.h, align 4, !tbaa !21   ; 2 uses
...
bb.b:                                             ; preds = %.lr.ph, %bb.i
  ...
  %i.p = load i32, ptr %i.d, align 4, !tbaa !21   ; 9 uses
...
.lr.ph.i:                                         ; preds = %bb.c
  %i.r = load ptr, ptr %i.e, align 8, !tbaa !24   ; 2 uses
...
.lr.ph25.i:                                       ; preds = %.preheader.i
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %scevgep.i, ptr noundef nonnull align 4 dereferenceable(1) %scevgep29.i, i64 %i.ae, i1 false), !tbaa !25
...
._crit_edge.i:                                    ; preds = %.lr.ph25.i, %.preheader.i
  ...
  store i32 %i.ag, ptr %i.d, align 4, !tbaa !21
...
.lr.ph.i105:                                      ; preds = %bb.f
  %i.ai = load ptr, ptr %i.e, align 8, !tbaa !24  ; 2 uses
...
.lr.ph25.i115:                                    ; preds = %.preheader.i112
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %scevgep.i116, ptr noundef nonnull align 4 dereferenceable(1) %scevgep29.i117, i64 %i.av, i1 false), !tbaa !25
  %.pre.i118 = load i32, ptr %i.d, align 4, !tbaa !21
...
._crit_edge.i114:                                 ; preds = %.lr.ph25.i115, %.preheader.i112
  ...
  store i32 %i.ax, ptr %i.d, align 4, !tbaa !21
...
bb.i:                                             ; preds = %Vec_IntRemove1.exit, %Vec_IntRemove1.exit119
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %.val103 = load i32, ptr %i.a, align 4, !tbaa !21 ; 4 uses
...
.lr.ph.i121:                                      ; preds = %.lr.ph230.split
  %i.bg = load ptr, ptr %i.i, align 8, !tbaa !24  ; 2 uses
...
.lr.ph25.i131:                                    ; preds = %.preheader.i128
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %scevgep.i132, ptr noundef nonnull align 4 dereferenceable(1) %scevgep29.i133, i64 %i.bt, i1 false), !tbaa !25
  %.pre.i134 = load i32, ptr %i.h, align 4, !tbaa !21
...
._crit_edge.i130:                                 ; preds = %.lr.ph25.i131, %.preheader.i128
  ...
  store i32 %i.bv, ptr %i.h, align 4, !tbaa !21
  %.val102.pr.pre = load i32, ptr %i.a, align 4, !tbaa !21
...
.lr.ph236:                                        ; preds = %.critedge2
  ...
  %.val94 = load ptr, ptr %i.cc, align 8, !tbaa !24
...
.lr.ph25.i147:                                    ; preds = %.preheader.i144
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %scevgep.i148, ptr noundef nonnull align 4 dereferenceable(1) %scevgep29.i149, i64 %i.da, i1 false), !tbaa !25
  %.pre.i150 = load i32, ptr %i.cd, align 4, !tbaa !21
...
.lr.ph25.i163:                                    ; preds = %.preheader.i160
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %scevgep.i164, ptr noundef nonnull align 4 dereferenceable(1) %scevgep29.i165, i64 %i.ds, i1 false), !tbaa !25
  %.pre.i166 = load i32, ptr %i.cf, align 4, !tbaa !21
...
._crit_edge.i162:                                 ; preds = %.lr.ph25.i163, %.preheader.i160
  ...
  store i32 %i.du, ptr %i.cf, align 4, !tbaa !21
...
Vec_IntRemove1.exit167:                           ; preds = %bb.p, %Vec_IntRemove1.exit151, %._crit_edge.i162
  ...
  %.val100 = load i32, ptr %i.a, align 4, !tbaa !21 ; 2 uses
  %i.dv = sext i32 %.val100 to i64
  %i.dw = icmp slt i64 %indvars.iv.next275, %i.dv
  br i1 %i.dw, label %bb.l, label %.critedge4, !llvm.loop !73
...
bb.q:                                             ; preds = %.critedge4
  ...
  %.val93 = load ptr, ptr %i.ea, align 8, !tbaa !24 ; 6 uses
  %i.eb = load i32, ptr %.val93, align 4, !tbaa !25
  %i.ec = getelementptr inbounds nuw i8, ptr %.val93, i64 4
  %i.ed = load i32, ptr %i.ec, align 4, !tbaa !25
...
bb.u:                                             ; preds = %bb.t
  store i32 1, ptr %3, align 4, !tbaa !25
  %.val98238 = load i32, ptr %i.a, align 4, !tbaa !21 ; 3 uses
...
.lr.ph241:                                        ; preds = %bb.u
  ...
  %i.er = load i32, ptr %i.ep, align 4, !tbaa !21 ; 2 uses
...
.lr.ph247:                                        ; preds = %.lr.ph241, %.critedge9.preheader
  ...
  %i.ew = load i32, ptr %i.eu, align 4, !tbaa !21 ; 2 uses
...
.lr.ph.i169:                                      ; preds = %.lr.ph241.split
  %i.fg = load ptr, ptr %i.eq, align 8, !tbaa !24 ; 2 uses
...
.lr.ph25.i179:                                    ; preds = %.preheader.i176
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %scevgep.i180, ptr noundef nonnull align 4 dereferenceable(1) %scevgep29.i181, i64 %i.ft, i1 false), !tbaa !25
  %.pre.i182 = load i32, ptr %i.ep, align 4, !tbaa !21
...
._crit_edge.i178:                                 ; preds = %.lr.ph25.i179, %.preheader.i176
  ...
  store i32 %i.fv, ptr %i.ep, align 4, !tbaa !21
  %.val98.pre = load i32, ptr %i.a, align 4, !tbaa !21
...
Vec_IntRemove1.exit183:                           ; preds = %bb.w, %.lr.ph241.split, %._crit_edge.i178
  ...
  br i1 %i.fz, label %.lr.ph241.split, label %.critedge9.preheader, !llvm.loop !74
...
.lr.ph.i185:                                      ; preds = %.lr.ph247.split
  %i.gi = load ptr, ptr %i.ev, align 8, !tbaa !24 ; 2 uses
...
.lr.ph25.i195:                                    ; preds = %.preheader.i192
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %scevgep.i196, ptr noundef nonnull align 4 dereferenceable(1) %scevgep29.i197, i64 %i.gv, i1 false), !tbaa !25
  %.pre.i198 = load i32, ptr %i.eu, align 4, !tbaa !21
...
._crit_edge.i194:                                 ; preds = %.lr.ph25.i195, %.preheader.i192
  ...
  store i32 %i.gx, ptr %i.eu, align 4, !tbaa !21
  %.val97.pre = load i32, ptr %i.a, align 4, !tbaa !21
...
Vec_IntRemove1.exit199:                           ; preds = %bb.y, %.lr.ph247.split, %._crit_edge.i194
  ...
  br i1 %i.hb, label %.lr.ph247.split, label %.critedge11, !llvm.loop !75
...
bb.a:
  ...
  %.val.i.i = load ptr, ptr %i.h, align 8, !tbaa !24
  ...
  %.val3.i.i = load ptr, ptr %i.l, align 8, !tbaa !24
  ...
  store i32 %i.o, ptr %i.p, align 8, !tbaa !50
  %i.q = getelementptr i8, ptr %i.b, i64 44       ; 5 uses
  store i32 %i.o, ptr %i.q, align 4, !tbaa !51
  ...
  %.val26 = load ptr, ptr %i.w, align 8, !tbaa !31
  ...
  %.val2528 = load i32, ptr %i.q, align 4, !tbaa !21 ; 2 uses
...
.lr.ph:                                           ; preds = %bb.a, %bb.c
  ...
  %.val23 = load ptr, ptr %i.s, align 8, !tbaa !24
  %i.ac = getelementptr inbounds nuw [4 x i8], ptr %.val23, i64 %indvars.iv
  %i.ad = load i32, ptr %i.ac, align 4, !tbaa !25 ; 2 uses
  %i.ae = and i32 %i.ad, 1
...
bb.b:                                             ; preds = %.lr.ph
  ...
  %.val25.pre = load i32, ptr %i.q, align 4, !tbaa !21
  br label %bb.c
...
.critedge:                                        ; preds = %bb.c, %bb.a
  ...
  %.val2430 = load i32, ptr %i.q, align 4, !tbaa !21 ; 2 uses
...
.lr.ph32:                                         ; preds = %.critedge, %bb.e
  ...
  %.val = load ptr, ptr %i.s, align 8, !tbaa !24
  %i.al = getelementptr inbounds nuw [4 x i8], ptr %.val, i64 %indvars.iv34
  %i.am = load i32, ptr %i.al, align 4, !tbaa !25 ; 2 uses
  %i.an = and i32 %i.am, 1
...
bb.d:                                             ; preds = %.lr.ph32
  ...
  %.val24.pre = load i32, ptr %i.q, align 4, !tbaa !21
  br label %bb.e
...
.critedge2:                                       ; preds = %bb.e, %.critedge
  ...
  %i.av = load ptr, ptr %i.a, align 8, !tbaa !27
  %i.aw = getelementptr i8, ptr %i.av, i64 16
  %.val27 = load ptr, ptr %i.aw, align 8, !tbaa !46
  %i.ax = getelementptr i8, ptr %.val27, i64 4
  %.val27.val = load i32, ptr %i.ax, align 4, !tbaa !21
...
bb.a:
  ...
  %.val5 = load ptr, ptr %i.a, align 8, !tbaa !24 ; 2 uses
  %i.b = load i32, ptr %.val5, align 4, !tbaa !25
  %i.c = getelementptr inbounds nuw i8, ptr %.val5, i64 4
  %i.d = load i32, ptr %i.c, align 4, !tbaa !25
  %i.e = getelementptr i8, ptr %0, i64 4
  %.val6 = load i32, ptr %i.e, align 4, !tbaa !21
