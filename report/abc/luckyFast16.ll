...
._crit_edge:                                      ; preds = %bb.d, %bb.a, %bb.c, %bb.b
  ...
  %.014 = phi i32 [ 0, %bb.b ], [ 3, %bb.c ], [ 0, %bb.a ], [ 0, %bb.d ]
...
._crit_edge:                                      ; preds = %bb.d, %bb.a, %bb.c, %bb.b
  %.sink = phi i32 [ %i.j, %bb.b ], [ %i.l, %bb.c ], [ 0, %bb.a ], [ 0, %bb.d ]
  %.014 = phi i32 [ 1, %bb.b ], [ 2, %bb.c ], [ 1, %bb.a ], [ 1, %bb.d ]
  store i32 %.sink, ptr %2, align 4, !tbaa !9
  ret i32 %.014
}
...
._crit_edge:                                      ; preds = %bb.d, %bb.a, %bb.c, %bb.b
  ...
  %.016 = phi i32 [ 0, %bb.b ], [ 1, %bb.c ], [ 0, %bb.a ], [ 0, %bb.d ]
...
._crit_edge:                                      ; preds = %bb.d, %bb.a, %bb.c, %bb.b
  ...
  %.017 = phi i32 [ 0, %bb.b ], [ 1, %bb.c ], [ 0, %bb.a ], [ 0, %bb.d ]
...
minTemp0_fast_iVar5.exit:                         ; preds = %bb.d, %bb.b, %bb.c
  ...
  %.014.i = phi i32 [ 0, %bb.b ], [ 3, %bb.c ], [ 0, %bb.d ] ; 10 uses
  store i32 %.014.i, ptr %i.a, align 4, !tbaa !9
  %i.s = add i32 %i.e, -2
...
minTemp1_fast_iVar5.exit:                         ; preds = %bb.g, %bb.e, %bb.f
  ...
  %or.cond.i65 = phi i1 [ %i.r, %bb.e ], [ false, %bb.f ], [ %i.r, %bb.g ]
  %.014.i50 = phi i32 [ 1, %bb.e ], [ 2, %bb.f ], [ 1, %bb.g ] ; 10 uses
  %i.ae = getelementptr inbounds nuw i8, ptr %i.a, i64 4
  store i32 %.014.i50, ptr %i.ae, align 4, !tbaa !9
  %i.af = sext i32 %i.f to i64
  %i.ag = zext nneg i32 %.014.i to i64
  %i.ah = zext nneg i32 %.014.i50 to i64
  br label %.lr.ph.i58

.lr.ph.i58:                                       ; preds = %bb.j, %minTemp1_fast_iVar5.exit
  %indvars.iv.i59 = phi i64 [ %i.af, %minTemp1_fast_iVar5.exit ], [ %indvars.iv.next.i61, %bb.j ] ; 6 uses
  %i.ai = sub nsw i64 %indvars.iv.i59, %i.ag
  %i.aj = getelementptr inbounds [4 x i8], ptr %0, i64 %i.ai
  %i.ak = load i32, ptr %i.aj, align 4, !tbaa !9
  %8 = zext i32 %i.ak to i64
  %i.al = sub nsw i64 %indvars.iv.i59, %i.ah
  %i.am = getelementptr inbounds [4 x i8], ptr %0, i64 %i.al
  %i.an = load i32, ptr %i.am, align 4, !tbaa !9
  %9 = zext i32 %i.an to i64
  %.0.i.i60 = tail call noundef range(i32 -1, 2) i32 @llvm.ucmp.i32.i64(i64 %8, i64 %9)
  switch i32 %.0.i.i60, label %bb.i [
    i32 0, label %bb.j
    i32 -1, label %bb.h
  ]

bb.h:                                             ; preds = %.lr.ph.i58
  %i.ao = trunc nsw i64 %indvars.iv.i59 to i32
  %i.ap = add nuw nsw i32 %i.ao, 1
  br label %minTemp2_fast_iVar5.exit

bb.i:                                             ; preds = %.lr.ph.i58
  %i.aq = trunc nsw i64 %indvars.iv.i59 to i32
  %i.ar = add nuw nsw i32 %i.aq, 1
  br label %minTemp2_fast_iVar5.exit

bb.j:                                             ; preds = %.lr.ph.i58
  %indvars.iv.next.i61 = add nsw i64 %indvars.iv.i59, -4
  %i.as = icmp sgt i64 %indvars.iv.i59, 3
  br i1 %i.as, label %.lr.ph.i58, label %minTemp2_fast_iVar5.exit, !llvm.loop !40

minTemp2_fast_iVar5.exit:                         ; preds = %bb.j, %bb.h, %bb.i
  %.sink.i56 = phi i32 [ %i.ap, %bb.h ], [ %i.ar, %bb.i ], [ 0, %bb.j ] ; 10 uses
  %.016.i = phi i32 [ 0, %bb.h ], [ 1, %bb.i ], [ 0, %bb.j ] ; 5 uses
...
bb.m:                                             ; preds = %bb.l
  ...
  br i1 %i.bd, label %.lr.ph.i62, label %._crit_edge.i

.lr.ph.i62:                                       ; preds = %bb.m
...
bb.n:                                             ; preds = %bb.n, %.lr.ph.i62
  %indvars.iv.i63 = phi i64 [ %i.bk, %.lr.ph.i62 ], [ %indvars.iv.next.i64, %bb.n ] ; 3 uses
  %.041.i = phi ptr [ %i.bf, %.lr.ph.i62 ], [ %i.bw, %bb.n ] ; 4 uses
  %i.bl = getelementptr inbounds i8, ptr %.041.i, i64 -4
  %i.bm = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %indvars.iv.i63 ; 4 uses
  ...
  %indvars.iv.next.i64 = add nsw i64 %indvars.iv.i63, -4
  %i.ca = icmp samesign ugt i64 %indvars.iv.i63, 4
...
bb.p:                                             ; preds = %bb.o
  ...
  br i1 %or.cond.i65, label %arrangeQuoters_superFast_iVar5.exit, label %bb.q

bb.q:                                             ; preds = %bb.p
  %i.cg = icmp sgt i32 %i.ce, 1
  br i1 %i.cg, label %.lr.ph.i67, label %._crit_edge.i66

.lr.ph.i67:                                       ; preds = %bb.q
  %i.ch = add nsw i32 %i.ce, -1
  %i.ci = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %i.cf
  %narrow146 = sub nsw i32 0, %.014.i
  %i.cj = sext i32 %narrow146 to i64
  %narrow147 = sub nsw i32 0, %.014.i50
  %i.ck = sext i32 %narrow147 to i64
  %i.cl = zext nneg i32 %i.ch to i64
  %i.cm = zext nneg i32 %.014.i50 to i64
  %i.cn = zext nneg i32 %.014.i to i64
  br label %bb.r

bb.r:                                             ; preds = %bb.r, %.lr.ph.i67
  %indvars.iv.i68 = phi i64 [ %i.cl, %.lr.ph.i67 ], [ %indvars.iv.next.i70, %bb.r ] ; 3 uses
  %.041.i69 = phi ptr [ %i.ci, %.lr.ph.i67 ], [ %i.cz, %bb.r ] ; 4 uses
  %i.co = getelementptr inbounds i8, ptr %.041.i69, i64 -4
  %i.cp = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %indvars.iv.i68 ; 4 uses
  %i.cq = getelementptr inbounds [4 x i8], ptr %i.cp, i64 %i.cj
  %i.cr = load i32, ptr %i.cq, align 4
  store i32 %i.cr, ptr %i.co, align 4
  %i.cs = getelementptr inbounds i8, ptr %.041.i69, i64 -8
  %i.ct = getelementptr inbounds [4 x i8], ptr %i.cp, i64 %i.ck
  %i.cu = load i32, ptr %i.ct, align 4
  store i32 %i.cu, ptr %i.cs, align 4
  %i.cv = getelementptr inbounds i8, ptr %.041.i69, i64 -12
  ...
  %i.cz = getelementptr inbounds i8, ptr %.041.i69, i64 -16 ; 2 uses
  ...
  %indvars.iv.next.i70 = add nsw i64 %indvars.iv.i68, -4
  %i.dd = icmp samesign ugt i64 %indvars.iv.i68, 4
  br i1 %i.dd, label %bb.r, label %._crit_edge.i66, !llvm.loop !37

._crit_edge.i66:                                  ; preds = %bb.r, %bb.q
  %i.de = shl nsw i64 %i.cf, 2
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %0, ptr nonnull align 16 %i.b, i64 %i.de, i1 false)
  %i.df = sub nsw i32 %.014.i, %.014.i50
  br label %arrangeQuoters_superFast_iVar5.exit.sink.split
...
bb.s:                                             ; preds = %bb.o
  ...
  br i1 %i.di, label %.lr.ph.i74, label %arrangeQuoters_superFast_iVar5.exit78

.lr.ph.i74:                                       ; preds = %bb.s
  %i.dj = add nsw i32 %i.dg, -1
  %i.dk = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %i.dh
  %narrow = sub nsw i32 0, %.014.i50
  %i.dl = sext i32 %narrow to i64
  %narrow142 = sub nsw i32 0, %.014.i
  %i.dm = sext i32 %narrow142 to i64
  %i.dn = zext nneg i32 %i.dj to i64
  %i.do = zext nneg i32 %.014.i to i64
  %i.dp = zext nneg i32 %.014.i50 to i64
  br label %bb.t

bb.t:                                             ; preds = %bb.t, %.lr.ph.i74
  %indvars.iv.i75 = phi i64 [ %i.dn, %.lr.ph.i74 ], [ %indvars.iv.next.i77, %bb.t ] ; 3 uses
  %.041.i76 = phi ptr [ %i.dk, %.lr.ph.i74 ], [ %i.eb, %bb.t ] ; 4 uses
  %i.dq = getelementptr inbounds i8, ptr %.041.i76, i64 -4
  %i.dr = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %indvars.iv.i75 ; 4 uses
  %i.ds = getelementptr inbounds [4 x i8], ptr %i.dr, i64 %i.dl
  %i.dt = load i32, ptr %i.ds, align 4
  store i32 %i.dt, ptr %i.dq, align 4
  %i.du = getelementptr inbounds i8, ptr %.041.i76, i64 -8
  %i.dv = getelementptr inbounds [4 x i8], ptr %i.dr, i64 %i.dm
  %i.dw = load i32, ptr %i.dv, align 4
  store i32 %i.dw, ptr %i.du, align 4
  %i.dx = getelementptr inbounds i8, ptr %.041.i76, i64 -12
  ...
  %i.eb = getelementptr inbounds i8, ptr %.041.i76, i64 -16 ; 2 uses
  ...
  %indvars.iv.next.i77 = add nsw i64 %indvars.iv.i75, -4
  %i.ef = icmp samesign ugt i64 %indvars.iv.i75, 4
  br i1 %i.ef, label %bb.t, label %arrangeQuoters_superFast_iVar5.exit78, !llvm.loop !37

arrangeQuoters_superFast_iVar5.exit78:            ; preds = %bb.t, %bb.s
  %i.eg = shl nsw i64 %i.dh, 2
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %0, ptr nonnull align 16 %i.b, i64 %i.eg, i1 false)
  %i.eh = sub nsw i32 %.014.i50, %.014.i
  br label %arrangeQuoters_superFast_iVar5.exit.sink.split

bb.u:                                             ; preds = %minTemp2_fast_iVar5.exit
  br i1 %.not46, label %.lr.ph.preheader.i88, label %bb.v

bb.v:                                             ; preds = %.thread, %bb.u
  %.sink.i56171180 = phi i32 [ 0, %.thread ], [ %.sink.i56, %bb.u ] ; 3 uses
  %.016.i172179 = phi i32 [ 0, %.thread ], [ %.016.i, %bb.u ] ; 2 uses
  %i.ei = zext nneg i32 %.016.i172179 to i64
  %i.ej = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %i.ei
  %i.ek = load i32, ptr %i.ej, align 4, !tbaa !9  ; 4 uses
  %i.el = xor i32 %.016.i172179, 1
  %i.em = zext nneg i32 %i.el to i64
  %i.en = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %i.em
  %i.eo = load i32, ptr %i.en, align 4, !tbaa !9  ; 3 uses
  %i.ep = sext i32 %.sink.i56171180 to i64        ; 2 uses
  %i.eq = icmp eq i32 %i.ek, 0
  %i.er = icmp eq i32 %i.eo, 1
  %or.cond.i79 = and i1 %i.eq, %i.er
  br i1 %or.cond.i79, label %arrangeQuoters_superFast_iVar5.exit, label %bb.w

bb.w:                                             ; preds = %bb.v
  %i.es = icmp sgt i32 %.sink.i56171180, 1
  br i1 %i.es, label %.lr.ph.i81, label %._crit_edge.i80

.lr.ph.i81:                                       ; preds = %bb.w
  %i.et = add nsw i32 %.sink.i56171180, -1
...
bb.x:                                             ; preds = %bb.x, %.lr.ph.i81
  %indvars.iv.i82 = phi i64 [ %i.ez, %.lr.ph.i81 ], [ %indvars.iv.next.i84, %bb.x ] ; 3 uses
  %.041.i83 = phi ptr [ %i.eu, %.lr.ph.i81 ], [ %i.fl, %bb.x ] ; 4 uses
  %i.fa = getelementptr inbounds i8, ptr %.041.i83, i64 -4
  %i.fb = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %indvars.iv.i82 ; 4 uses
  %i.fc = getelementptr inbounds [4 x i8], ptr %i.fb, i64 %i.ew
  %i.fd = load i32, ptr %i.fc, align 4
  store i32 %i.fd, ptr %i.fa, align 4
  %i.fe = getelementptr inbounds i8, ptr %.041.i83, i64 -8
  %i.ff = getelementptr inbounds [4 x i8], ptr %i.fb, i64 %i.ey
  %i.fg = load i32, ptr %i.ff, align 4
  store i32 %i.fg, ptr %i.fe, align 4
  %i.fh = getelementptr inbounds i8, ptr %.041.i83, i64 -12
  ...
  %i.fl = getelementptr inbounds i8, ptr %.041.i83, i64 -16 ; 2 uses
  ...
  %indvars.iv.next.i84 = add nsw i64 %indvars.iv.i82, -4
  %i.fp = icmp samesign ugt i64 %indvars.iv.i82, 4
  br i1 %i.fp, label %bb.x, label %._crit_edge.i80, !llvm.loop !37

._crit_edge.i80:                                  ; preds = %bb.x, %bb.w
...
.lr.ph.preheader.i88:                             ; preds = %bb.u
  %i.fs = xor i32 %.014.i, 3
  %i.ft = xor i32 %.014.i50, 3
...
.lr.ph.i89:                                       ; preds = %bb.aa, %.lr.ph.preheader.i88
  %indvars.iv.i90 = phi i64 [ %i.fv, %.lr.ph.preheader.i88 ], [ %indvars.iv.next.i92, %bb.aa ] ; 5 uses
  %i.fz = sub nsw i64 %indvars.iv.i90, %i.fx
  %i.ga = getelementptr inbounds [4 x i8], ptr %0, i64 %i.fz
  %i.gb = load i32, ptr %i.ga, align 4, !tbaa !9
  %10 = zext i32 %i.gb to i64
  %i.gc = sub nsw i64 %indvars.iv.i90, %i.fy
  %i.gd = getelementptr inbounds [4 x i8], ptr %0, i64 %i.gc
  %i.ge = load i32, ptr %i.gd, align 4, !tbaa !9
  %11 = zext i32 %i.ge to i64
  %.0.i.i91 = tail call noundef range(i32 -1, 2) i32 @llvm.ucmp.i32.i64(i64 %10, i64 %11)
  switch i32 %.0.i.i91, label %bb.z [
    i32 0, label %bb.aa
    i32 -1, label %bb.y
  ]

bb.y:                                             ; preds = %.lr.ph.i89
  %i.gf = trunc nsw i64 %indvars.iv.i90 to i32
  %i.gg = add nsw i32 %i.gf, 1
  br label %minTemp3_fast_iVar5.exit

bb.z:                                             ; preds = %.lr.ph.i89
  %i.gh = trunc nsw i64 %indvars.iv.i90 to i32
  %i.gi = add nsw i32 %i.gh, 1
  br label %minTemp3_fast_iVar5.exit

bb.aa:                                            ; preds = %.lr.ph.i89
  %indvars.iv.next.i92 = add nsw i64 %indvars.iv.i90, -4 ; 2 uses
  %.not.i = icmp slt i64 %indvars.iv.next.i92, %i.fw
  br i1 %.not.i, label %minTemp3_fast_iVar5.exit, label %.lr.ph.i89, !llvm.loop !41

minTemp3_fast_iVar5.exit:                         ; preds = %bb.aa, %bb.y, %bb.z
  %.sink.i87 = phi i32 [ %i.gg, %bb.y ], [ %i.gi, %bb.z ], [ 0, %bb.aa ]
  %.017.i = phi i32 [ 0, %bb.y ], [ 1, %bb.z ], [ 0, %bb.aa ] ; 2 uses
  %i.gj = icmp sgt i32 %.sink.i87, %.sink.i56
  %i.gk = sext i32 %.sink.i49 to i64              ; 4 uses
  br i1 %i.gj, label %bb.ab, label %bb.ae

bb.ab:                                            ; preds = %minTemp3_fast_iVar5.exit
  %i.gl = xor i32 %.017.i, 1
  ...
  %i.gp = zext nneg i32 %.017.i to i64
  ...
  %or.cond.i93 = and i1 %i.gs, %i.gt
  br i1 %or.cond.i93, label %arrangeQuoters_superFast_iVar5.exit, label %bb.ac

bb.ac:                                            ; preds = %bb.ab
  %i.gu = icmp sgt i32 %.sink.i49, 1
  br i1 %i.gu, label %.lr.ph.i95, label %._crit_edge.i94

.lr.ph.i95:                                       ; preds = %bb.ac
...
bb.ad:                                            ; preds = %bb.ad, %.lr.ph.i95
  %indvars.iv.i96 = phi i64 [ %i.ha, %.lr.ph.i95 ], [ %indvars.iv.next.i98, %bb.ad ] ; 3 uses
  %.041.i97 = phi ptr [ %i.gv, %.lr.ph.i95 ], [ %i.hm, %bb.ad ] ; 4 uses
  %i.hb = getelementptr inbounds i8, ptr %.041.i97, i64 -4
  %i.hc = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %indvars.iv.i96 ; 4 uses
  %i.hd = getelementptr inbounds [4 x i8], ptr %i.hc, i64 %i.gx
  %i.he = load i32, ptr %i.hd, align 4
  store i32 %i.he, ptr %i.hb, align 4
  %i.hf = getelementptr inbounds i8, ptr %.041.i97, i64 -8
  %i.hg = getelementptr inbounds [4 x i8], ptr %i.hc, i64 %i.gz
  %i.hh = load i32, ptr %i.hg, align 4
  store i32 %i.hh, ptr %i.hf, align 4
  %i.hi = getelementptr inbounds i8, ptr %.041.i97, i64 -12
  ...
  %i.hm = getelementptr inbounds i8, ptr %.041.i97, i64 -16 ; 2 uses
  ...
  %indvars.iv.next.i98 = add nsw i64 %indvars.iv.i96, -4
  %i.hq = icmp samesign ugt i64 %indvars.iv.i96, 4
  br i1 %i.hq, label %bb.ad, label %._crit_edge.i94, !llvm.loop !37
...
bb.ae:                                            ; preds = %minTemp3_fast_iVar5.exit
  ...
  %or.cond.i100 = and i1 %i.ia, %i.ib
  br i1 %or.cond.i100, label %arrangeQuoters_superFast_iVar5.exit, label %bb.af

bb.af:                                            ; preds = %bb.ae
  %i.ic = icmp sgt i32 %.sink.i49, 1
  br i1 %i.ic, label %.lr.ph.i102, label %._crit_edge.i101

.lr.ph.i102:                                      ; preds = %bb.af
...
bb.ag:                                            ; preds = %bb.ag, %.lr.ph.i102
  %indvars.iv.i103 = phi i64 [ %i.ii, %.lr.ph.i102 ], [ %indvars.iv.next.i105, %bb.ag ] ; 3 uses
  %.041.i104 = phi ptr [ %i.id, %.lr.ph.i102 ], [ %i.iu, %bb.ag ] ; 4 uses
  %i.ij = getelementptr inbounds i8, ptr %.041.i104, i64 -4
  %i.ik = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %indvars.iv.i103 ; 4 uses
  %i.il = getelementptr inbounds [4 x i8], ptr %i.ik, i64 %i.if
  %i.im = load i32, ptr %i.il, align 4
  store i32 %i.im, ptr %i.ij, align 4
  %i.in = getelementptr inbounds i8, ptr %.041.i104, i64 -8
  %i.io = getelementptr inbounds [4 x i8], ptr %i.ik, i64 %i.ih
  %i.ip = load i32, ptr %i.io, align 4
  store i32 %i.ip, ptr %i.in, align 4
  %i.iq = getelementptr inbounds i8, ptr %.041.i104, i64 -12
  ...
  %i.iu = getelementptr inbounds i8, ptr %.041.i104, i64 -16 ; 2 uses
  ...
  %indvars.iv.next.i105 = add nsw i64 %indvars.iv.i103, -4
  %i.iy = icmp samesign ugt i64 %indvars.iv.i103, 4
  br i1 %i.iy, label %bb.ag, label %._crit_edge.i101, !llvm.loop !37

._crit_edge.i101:                                 ; preds = %bb.ag, %bb.af
...
arrangeQuoters_superFast_iVar5.exit.sink.split:   ; preds = %arrangeQuoters_superFast_iVar5.exit78, %._crit_edge.i, %._crit_edge.i66, %._crit_edge.i80, %._crit_edge.i94, %._crit_edge.i101
  %.sink193 = phi i32 [ %i.ja, %._crit_edge.i101 ], [ %i.hs, %._crit_edge.i94 ], [ %i.fr, %._crit_edge.i80 ], [ %i.df, %._crit_edge.i66 ], [ %i.cc, %._crit_edge.i ], [ %i.eh, %arrangeQuoters_superFast_iVar5.exit78 ]
  %.sink192 = phi i32 [ %i.hv, %._crit_edge.i101 ], [ %i.go, %._crit_edge.i94 ], [ %i.ek, %._crit_edge.i80 ], [ %.014.i, %._crit_edge.i66 ], [ %i.av, %._crit_edge.i ], [ %.014.i50, %arrangeQuoters_superFast_iVar5.exit78 ]
  %.sink189 = load i32, ptr %3, align 4, !tbaa !9
  %i.jb = tail call i32 @llvm.abs.i32(i32 %.sink193, i1 true)
  %i.jc = shl i32 %i.jb, 2
  %i.jd = add i32 %.sink192, -4
  %i.je = add i32 %i.jd, %i.jc
  %i.jf = tail call i32 @adjustInfoAfterSwap(ptr noundef %2, i32 noundef %.sink189, i32 noundef 5, i32 noundef %i.je) #8
...
._crit_edge32:                                    ; preds = %._crit_edge.us, %bb.a, %.split.us, %.split34.us
  ...
  %.025 = phi i32 [ 0, %.split34.us ], [ 3, %.split.us ], [ 0, %bb.a ], [ 0, %._crit_edge.us ]
