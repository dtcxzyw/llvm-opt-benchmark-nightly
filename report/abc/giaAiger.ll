...
Vec_StrGrow.exit11.sink.split.i.i245:             ; preds = %bb.bq, %bb.bp, %bb.bm, %bb.bl
  ...
  store ptr %i.jc, ptr %i.ck, align 8, !tbaa !46
...
Vec_StrPush.exit.i238:                            ; preds = %Vec_StrGrow.exit11.sink.split.i.i245, %bb.bn, %.Vec_StrPush.exit_crit_edge.i236
  ...
  store i8 10, ptr %i.jg, align 1, !tbaa !12
  %.val119.pre = load i32, ptr %i.gl, align 4, !tbaa !37
...
.lr.ph300:                                        ; preds = %.critedge4, %Vec_StrPrintStr.exit266
  ...
  %.val128 = load ptr, ptr %i.hx, align 8, !tbaa !39
...
.lr.ph.i250:                                      ; preds = %bb.br
  ...
  %.val146 = load i32, ptr %i.ju, align 4, !tbaa !84
  ...
  %i.kb = load i32, ptr %i.cc, align 8, !tbaa !45
...
bb.bt:                                            ; preds = %bb.bs
  %i.ke = load ptr, ptr %i.ck, align 8, !tbaa !46 ; 2 uses
...
Vec_StrGrow.exit11.sink.split.i.i262:             ; preds = %bb.bz, %bb.by, %bb.bv, %bb.bu
  ...
  store ptr %i.km, ptr %i.ck, align 8, !tbaa !46
...
Vec_StrPush.exit.i255:                            ; preds = %Vec_StrGrow.exit11.sink.split.i.i262, %bb.bw, %.Vec_StrPush.exit_crit_edge.i253
  ...
  store i8 10, ptr %i.kq, align 1, !tbaa !12
  %.val117.pre = load i32, ptr %i.gl, align 4, !tbaa !37
...
bb.cb:                                            ; preds = %bb.ca
  %.val127 = load ptr, ptr %i.ku, align 8, !tbaa !39
  ...
  %.val145 = load i32, ptr %i.kz, align 4, !tbaa !84
  ...
  %.val144 = load i32, ptr %i.lf, align 4, !tbaa !84
  ...
  %.val143 = load i32, ptr %i.lp, align 4, !tbaa !84
...
.lr.ph.i267:                                      ; preds = %bb.cb, %bb.ca, %.critedge6
  ...
  %i.ma = load i32, ptr %i.cc, align 8, !tbaa !45
...
bb.cd:                                            ; preds = %bb.cc
  %i.md = load ptr, ptr %i.ck, align 8, !tbaa !46 ; 2 uses
...
Vec_StrGrow.exit11.sink.split.i.i279:             ; preds = %bb.cj, %bb.ci, %bb.cf, %bb.ce
  ...
  store ptr %i.ml, ptr %i.ck, align 8, !tbaa !46
...
Vec_StrPush.exit.i272:                            ; preds = %Vec_StrGrow.exit11.sink.split.i.i279, %bb.cg, %.Vec_StrPush.exit_crit_edge.i270
  ...
  store i8 99, ptr %i.mp, align 1, !tbaa !12
  ret ptr %i.cc
}
