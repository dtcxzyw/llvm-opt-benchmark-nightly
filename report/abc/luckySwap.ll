...
begin_hunk_0_@Kit_TruthCountOnesInCofs_64bit:bb.a
  store i32 %i.ae, ptr %i.af, align 4, !tbaa !16
...
bb.k:                                             ; preds = %bb.j
  ...
  store i32 %i.bf, ptr %i.bd, align 4, !tbaa !16
  br label %bb.l
...
bb.l:                                             ; preds = %bb.k, %bb.j
  ...
  br i1 %niter.ncmp.1, label %._crit_edge.unr-lcssa, label %.lr.ph.new, !llvm.loop !20
...
._crit_edge:                                      ; preds = %.epil.preheader, %bb.m, %._crit_edge.unr-lcssa
  ...
  br i1 %exitcond97.not, label %._crit_edge72.split, label %.lr.ph, !llvm.loop !21
...
.lr.ph76:                                         ; preds = %._crit_edge72.split
  ...
  %i.br = load <4 x i32>, ptr %2, align 4, !tbaa !16 ; 5 uses
  %i.bs = load <2 x i32>, ptr %i.bq, align 4, !tbaa !16 ; 3 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec = load <4 x i64>, ptr %next.gep, align 8, !tbaa !12 ; 2 uses
  ...
  br i1 %i.dz, label %middle.block, label %vector.body, !llvm.loop !22
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %.05773 = phi ptr [ %i.ez, %scalar.ph ], [ %.05773.ph, %scalar.ph.preheader ] ; 2 uses
  %i.em = phi <4 x i32> [ %i.ev, %scalar.ph ], [ %.ph, %scalar.ph.preheader ]
  %i.en = phi <2 x i32> [ %i.ey, %scalar.ph ], [ %.ph122, %scalar.ph.preheader ]
  %3 = load <2 x i64>, ptr %.05773, align 8, !tbaa !12 ; 6 uses
  %i.eo = shufflevector <2 x i64> %3, <2 x i64> poison, <4 x i32> zeroinitializer
  %i.ep = and <4 x i64> %i.eo, <i64 6148914691236517205, i64 3689348814741910323, i64 1085102592571150095, i64 71777214294589695>
  %4 = shufflevector <2 x i64> %3, <2 x i64> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %i.eq = shl <4 x i64> %4, <i64 1, i64 2, i64 4, i64 8>
  ...
  %6 = shl i64 %5, 16
  %7 = shufflevector <2 x i64> %3, <2 x i64> poison, <2 x i32> <i32 poison, i32 0>
  %8 = insertelement <2 x i64> %7, i64 %6, i64 0
  %9 = and <2 x i64> %8, <i64 -281470681808896, i64 4294967295>
  %10 = and <2 x i64> %3, <i64 281470681808895, i64 poison>
  %11 = shl <2 x i64> %3, <i64 281470681808895, i64 32>
  %12 = shufflevector <2 x i64> %10, <2 x i64> %11, <2 x i32> <i32 0, i32 3>
  %13 = or disjoint <2 x i64> %9, %12
  %i.ew = tail call range(i64 0, 65) <2 x i64> @llvm.ctpop.v2i64(<2 x i64> %13)
  ...
  br i1 %i.fb, label %scalar.ph, label %..thread67.loopexit_crit_edge, !llvm.loop !23
...
..thread67.loopexit_crit_edge:                    ; preds = %scalar.ph, %middle.block
  ...
  store <4 x i32> %i.fc, ptr %2, align 4, !tbaa !16
  store <2 x i32> %i.fd, ptr %i.bq, align 4, !tbaa !16
  br label %.thread67
...
.lr.ph38:                                         ; preds = %.preheader
  ...
  %i.j = load i64, ptr %i.i, align 8, !tbaa !12   ; 5 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %i.o, align 8, !tbaa !12 ; 2 uses
  %wide.load49 = load <2 x i64>, ptr %i.p, align 8, !tbaa !12 ; 2 uses
  ...
  store <2 x i64> %i.y, ptr %i.o, align 8, !tbaa !12
  store <2 x i64> %i.z, ptr %i.p, align 8, !tbaa !12
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.aa = icmp eq i64 %index.next, %n.vec
  br i1 %i.aa, label %.loopexit, label %vector.body, !llvm.loop !24

scalar.ph:                                        ; preds = %.lr.ph38
  %i.ab = load i64, ptr %0, align 8, !tbaa !12    ; 2 uses
  %i.ac = and i64 %i.j, %i.ab
  %i.ad = shl i64 %i.ac, %i.l
  %i.ae = and i64 %i.ab, %i.m
  %i.af = lshr i64 %i.ae, %i.l
  %i.ag = or i64 %i.ad, %i.af
  store i64 %i.ag, ptr %0, align 8, !tbaa !12
...
scalar.ph.1:                                      ; preds = %scalar.ph
  ...
  store i64 %i.an, ptr %i.ah, align 8, !tbaa !12
...
bb.c:                                             ; preds = %.lr.ph, %bb.c
  ...
  br i1 %i.bg, label %bb.c, label %.loopexit, !llvm.loop !0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %i.g, align 8, !tbaa !12
  %wide.load8 = load <2 x i64>, ptr %i.h, align 8, !tbaa !12
  %i.i = xor <2 x i64> %wide.load, splat (i64 -1)
  %i.j = xor <2 x i64> %wide.load8, splat (i64 -1)
  store <2 x i64> %i.i, ptr %i.g, align 8, !tbaa !12
  store <2 x i64> %i.j, ptr %i.h, align 8, !tbaa !12
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.k = icmp eq i64 %index.next, %n.vec
  br i1 %i.k, label %select.unfold._crit_edge, label %vector.body, !llvm.loop !25
...
select.unfold:                                    ; preds = %select.unfold.preheader, %select.unfold
  ...
  br i1 %i.o, label %select.unfold, label %select.unfold._crit_edge, !llvm.loop !26
