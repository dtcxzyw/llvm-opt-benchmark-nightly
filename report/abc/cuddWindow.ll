...
10:                                               ; preds = %bb.l, %8
  ...
  br i1 %exitcond.not.i.i, label %ddWindow2.exit, label %bb.k, !llvm.loop !33

.preheader.i:                                     ; preds = %.lr.ph138
  %i.t = add nsw i32 %i.v, 1                      ; 2 uses
  %i.u = icmp slt i32 %i.t, %2
  br i1 %i.u, label %.lr.ph138, label %ddWindow2.exit, !llvm.loop !34
...
.lr.ph138:                                        ; preds = %.preheader.i.preheader, %.preheader.i
  ...
  br i1 %i.x, label %.ddWindow2.exit.loopexit127_crit_edge, label %.preheader.i, !llvm.loop !34
...
17:                                               ; preds = %bb.r, %15
  ...
  br i1 %exitcond.not.i.i.i, label %ddWindow2.exit, label %bb.q, !llvm.loop !33

.preheader.i.i:                                   ; preds = %.lr.ph
  %i.ah = add nsw i32 %i.aj, 1                    ; 2 uses
  %i.ai = icmp slt i32 %i.ah, %2
  br i1 %i.ai, label %.lr.ph, label %ddWindow2.exit, !llvm.loop !34
...
.lr.ph:                                           ; preds = %.preheader.i.i.preheader, %.preheader.i.i
  ...
  br i1 %i.al, label %.ddWindow2.exit.loopexit127_crit_edge, label %.preheader.i.i, !llvm.loop !34

bb.s:                                             ; preds = %.lr.ph.i
  %i.am = add nsw i32 %.017.i, 1
  %i.an = add nsw i32 %.017.i, 3
  %i.ao = icmp slt i32 %i.an, %2
  br i1 %i.ao, label %.lr.ph.i, label %ddWindow2.exit, !llvm.loop !35
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x i32> splat (i32 1), ptr %i.bb, align 4, !tbaa !29
  store <4 x i32> splat (i32 1), ptr %i.bc, align 4, !tbaa !29
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.bd = icmp eq i64 %index.next, %n.vec
  br i1 %i.bd, label %middle.block, label %vector.body, !llvm.loop !36
...
bb.y:                                             ; preds = %bb.x
  ...
  store i32 1, ptr %i.be, align 8, !tbaa !32
  br label %ddWindow2.exit
...
.lr.ph139.us.i:                                   ; preds = %._crit_edge.us.i, %.lr.ph139.us.preheader.i
  %i.dr = load i32, ptr %i.az, align 4, !tbaa !29
...
bb.ab:                                            ; preds = %bb.aa
  store i32 1, ptr %i.bm, align 4, !tbaa !29
...
bb.cn:                                            ; preds = %bb.cm, %bb.cl
  store i32 1, ptr %i.do, align 4, !tbaa !29
...
bb.cp:                                            ; preds = %bb.co
  store i32 1, ptr %i.dq, align 4, !tbaa !29
  br label %.thread.us.i.peel57
...
.thread.us.sink.split.i.peel55:                   ; preds = %bb.bt, %bb.bu, %bb.ch, %bb.cj, %bb.ci
  ...
  store i32 1, ptr %i.dx, align 4, !tbaa !29
  br label %.thread.us.i.peel57
...
.thread.us.i.peel57:                              ; preds = %bb.co, %bb.cp, %bb.cn, %bb.cd, %bb.by, %.thread.us.sink.split.i.peel55, %bb.bs
  ...
  store i32 0, ptr %i.bm, align 4, !tbaa !29
  br label %bb.cq
...
.peel.next.i:                                     ; preds = %bb.cq, %bb.dk
  ...
  %i.dz = load i32, ptr %i.dy, align 4, !tbaa !29
...
bb.cu:                                            ; preds = %bb.ct
  ...
  store i32 1, ptr %i.ef, align 4, !tbaa !29
  br label %bb.cv
...
bb.cx:                                            ; preds = %bb.cw
  ...
  store i32 1, ptr %i.ei, align 4, !tbaa !29
  br label %bb.cy
...
bb.db:                                            ; preds = %bb.da
  ...
  store i32 1, ptr %i.em, align 4, !tbaa !29
...
bb.dd:                                            ; preds = %bb.dc
  ...
  store i32 1, ptr %i.eo, align 4, !tbaa !29
  br label %bb.de
...
bb.dh:                                            ; preds = %bb.dg
  ...
  store i32 1, ptr %i.es, align 4, !tbaa !29
  br label %bb.di
...
.thread.us.sink.split.i.sink.split.sink.split:    ; preds = %bb.di, %bb.de, %bb.db, %bb.da, %bb.cv
  ...
  store i32 1, ptr %i.ev, align 4, !tbaa !29
...
.thread.us.sink.split.i.sink.split:               ; preds = %.thread.us.sink.split.i.sink.split.sink.split, %bb.dj, %bb.di, %bb.df, %bb.de, %bb.cv, %bb.cs
  ...
  store i32 1, ptr %i.ew, align 4, !tbaa !29
...
.thread.us.i:                                     ; preds = %.thread.us.sink.split.i, %bb.cr
  ...
  store i32 0, ptr %i.dy, align 4, !tbaa !29
  br label %bb.dk
...
.lr.ph.i24:                                       ; preds = %.lr.ph.i24.preheader152, %.lr.ph.i24
  ...
  store i32 1, ptr %i.ey, align 4, !tbaa !29
