...
.preheader.preheader:                             ; preds = %.preheader.lr.ph
  ...
  %9 = add i64 %i.be, %i.a
  %10 = sub i64 %i.c, %i.a                        ; 2 uses
  %11 = shufflevector <2 x i64> %8, <2 x i64> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %12 = shufflevector <2 x ptr> %5, <2 x ptr> poison, <8 x i32> <i32 0, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %13 = ptrtoaddr <8 x ptr> %12 to <8 x i64>
  %min.iters.check = icmp slt i32 %i.ay, 18
  %14 = sub i64 %i.be, %i.bd
  %diff.check81 = icmp ugt i64 %14, -32
  %15 = add i64 %10, -1
  %diff.check93 = icmp ult i64 %15, 31
  %16 = insertelement <8 x i64> %13, i64 %i.a, i64 1 ; 2 uses
  %17 = insertelement <8 x i64> %16, i64 %i.be, i64 2
  %18 = insertelement <8 x i64> %17, i64 %i.bd, i64 3
  ...
  %21 = shufflevector <8 x i64> %20, <8 x i64> %11, <8 x i32> <i32 0, i32 8, i32 9, i32 poison, i32 4, i32 poison, i32 poison, i32 7>
  %22 = insertelement <8 x i64> %21, i64 %9, i64 3
  %i.bh = insertelement <8 x i64> %22, i64 %10, i64 6
  %i.bi = shufflevector <8 x i64> %i.bh, <8 x i64> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 2, i32 6, i32 7>
  %i.bj = sub <8 x i64> %19, %i.bi                ; 2 uses
