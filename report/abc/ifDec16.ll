...
.preheader:                                       ; preds = %bb.ab, %bb.ad
  ...
  %i.hl = load ptr, ptr %.0121, align 8, !tbaa !136 ; 4 uses
...
bb.ad:                                            ; preds = %.preheader
  ...
  br i1 %i.ho, label %.preheader, label %.critedge2, !llvm.loop !129

.critedge2:                                       ; preds = %.preheader, %bb.ad
  store ptr %i.hl, ptr %i.fo, align 8, !tbaa !136
  store ptr %i.fo, ptr %.0121, align 8, !tbaa !136
  br label %bb.ae
...
bb.ae:                                            ; preds = %bb.ac, %.critedge2
  ...
  br i1 %exitcond.not, label %.critedge, label %bb.aa, !llvm.loop !130
...
.critedge:                                        ; preds = %bb.ae, %._crit_edge191.thread, %._crit_edge191
  ...
  store i32 %.val140249, ptr %i.dl, align 4, !tbaa !35
...
bb.af:                                            ; preds = %.critedge
  ...
  %.pre221.pre = load i32, ptr %i.dl, align 4, !tbaa !35
...
Vec_PtrFree.exit:                                 ; preds = %.critedge, %bb.af
  ...
  %.pre222 = load ptr, ptr %i.i, align 8, !tbaa !132
...
bb.ag:                                            ; preds = %Vec_PtrFree.exit, %bb.m
  ...
  store i32 %i.hr, ptr %i.dl, align 4, !tbaa !35
  ...
  store i32 255, ptr %i.hu, align 8, !tbaa !42
  %i.hv = getelementptr inbounds nuw i8, ptr %i.hs, i64 12
  store i32 1, ptr %i.hv, align 4, !tbaa !72
  store ptr null, ptr %i.hs, align 8, !tbaa !136
  %i.hw = load ptr, ptr %i.r, align 8, !tbaa !38
...
bb.ai:                                            ; preds = %bb.ah
  %i.hz = load ptr, ptr %.0127, align 8, !tbaa !136 ; 2 uses
  %.not136 = icmp eq ptr %i.hz, null
  br i1 %.not136, label %.critedge4, label %bb.ah, !llvm.loop !131

bb.aj:                                            ; preds = %bb.ah
  store ptr %i.hs, ptr %i.hx, align 8, !tbaa !40
  br label %bb.ak

.critedge4:                                       ; preds = %bb.ai
  store ptr %i.hs, ptr %.0127, align 8, !tbaa !136
  br label %bb.ak
...
.lr.ph:                                           ; preds = %bb.b
  ...
  %i.j = load i64, ptr %i.i, align 8, !tbaa !44   ; 5 uses
...
vector.body75:                                    ; preds = %vector.body75, %vector.ph69
  ...
  %wide.load77.a = load <2 x i64>, ptr %i.n, align 8, !tbaa !44 ; 2 uses
  %wide.load78 = load <2 x i64>, ptr %i.o, align 8, !tbaa !44 ; 2 uses
  ...
  store <2 x i64> %i.x, ptr %i.n, align 8, !tbaa !44
  store <2 x i64> %i.y, ptr %i.o, align 8, !tbaa !44
  %index.next79 = add nuw i64 %index76, 4         ; 2 uses
  %i.z = icmp eq i64 %index.next79, %n.vec70
  br i1 %i.z, label %.loopexit, label %vector.body75, !llvm.loop !137

scalar.ph67:                                      ; preds = %.lr.ph
  %i.aa = load i64, ptr %0, align 8, !tbaa !44    ; 2 uses
  %i.ab = and i64 %i.aa, %i.k
  %i.ac = shl i64 %i.ab, %i.l
  %i.ad = and i64 %i.j, %i.aa
  %i.ae = lshr i64 %i.ad, %i.l
  %i.af = or i64 %i.ac, %i.ae
  store i64 %i.af, ptr %0, align 8, !tbaa !44
...
scalar.ph67.1:                                    ; preds = %scalar.ph67
  ...
  store i64 %i.am, ptr %i.ag, align 8, !tbaa !44
...
vector.body:                                      ; preds = %.preheader, %vector.body
  ...
  %wide.load = load <2 x i64>, ptr %i.bn, align 8, !tbaa !44, !alias.scope !143, !noalias !144
  %wide.load64.a = load <2 x i64>, ptr %i.bo, align 8, !tbaa !44, !alias.scope !143, !noalias !144
  %i.bp = getelementptr [8 x i8], ptr %invariant.gep, i64 %index ; 3 uses
  %i.bq = getelementptr i8, ptr %i.bp, i64 16     ; 2 uses
  %wide.load65.a = load <2 x i64>, ptr %i.bp, align 8, !tbaa !44, !alias.scope !144
  %wide.load66 = load <2 x i64>, ptr %i.bq, align 8, !tbaa !44, !alias.scope !144
  store <2 x i64> %wide.load65.a, ptr %i.bn, align 8, !tbaa !44, !alias.scope !143, !noalias !144
  store <2 x i64> %wide.load66, ptr %i.bo, align 8, !tbaa !44, !alias.scope !143, !noalias !144
  store <2 x i64> %wide.load, ptr %i.bp, align 8, !tbaa !44, !alias.scope !144
  store <2 x i64> %wide.load64.a, ptr %i.bq, align 8, !tbaa !44, !alias.scope !144
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.br = icmp eq i64 %index.next, %n.vec
  br i1 %i.br, label %._crit_edge, label %vector.body, !llvm.loop !141
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %i.bu = load i64, ptr %gep, align 8, !tbaa !44
  store i64 %i.bu, ptr %i.bs, align 8, !tbaa !44
  store i64 %i.bt, ptr %gep, align 8, !tbaa !44
  ...
  %i.bx = load i64, ptr %gep.1, align 8, !tbaa !44
  store i64 %i.bx, ptr %i.bv, align 8, !tbaa !44
  store i64 %i.bw, ptr %gep.1, align 8, !tbaa !44
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2 ; 2 uses
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge.loopexit.unr-lcssa, label %scalar.ph, !llvm.loop !142
...
scalar.ph.epil.preheader:                         ; preds = %._crit_edge.loopexit.unr-lcssa, %scalar.ph.preheader
  ...
  %i.ca = load i64, ptr %gep.epil, align 8, !tbaa !44
  store i64 %i.ca, ptr %i.by, align 8, !tbaa !44
  store i64 %i.bz, ptr %gep.epil, align 8, !tbaa !44
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %vector.body, %scalar.ph.epil.preheader, %._crit_edge.loopexit.unr-lcssa
  ...
  br i1 %i.cd, label %.preheader, label %.loopexit, !llvm.loop !7
...
.preheader49.preheader:                           ; preds = %bb.a
  ...
  %.promoted = load i32, ptr %i.i, align 4, !tbaa !35
...
.preheader49:                                     ; preds = %.preheader49.preheader, %._crit_edge
  ...
  %i.q = load i64, ptr %i.p, align 8, !tbaa !44   ; 12 uses
  %i.r = lshr i64 %i.q, 1
...
bb.b:                                             ; preds = %.preheader49
  ...
  %i.bg = load i32, ptr %i.j, align 4, !tbaa !35
  %i.bh = add nsw i32 %i.bg, %i.bf
  store i32 %i.bh, ptr %i.j, align 4, !tbaa !35
...
begin_hunk_1_@If_CluCountOnesInCofs:bb.a
  ...
  br i1 %i.ib, label %middle.block, label %vector.body, !llvm.loop !148
...
.lr.ph:                                           ; preds = %.lr.ph.preheader
  %i.ie = load i64, ptr %0, align 8, !tbaa !44    ; 2 uses
...
.lr.ph.1:                                         ; preds = %.lr.ph
  ...
  %i.jd = load i64, ptr %i.jc, align 8, !tbaa !44 ; 2 uses
...
.lr.ph.2:                                         ; preds = %.lr.ph.1
  ...
  %i.kd = load i64, ptr %i.kc, align 8, !tbaa !44 ; 2 uses
...
.lr.ph60:                                         ; preds = %.lr.ph60, %.lr.ph60.preheader.new
  ...
  %i.le = load i32, ptr %i.ld, align 4, !tbaa !35
  %i.lf = sub nsw i32 %.0.lcssa, %i.le
  store i32 %i.lf, ptr %i.lc, align 4, !tbaa !35
  ...
  %i.lj = load i32, ptr %i.li, align 4, !tbaa !35
  %i.lk = sub nsw i32 %.0.lcssa, %i.lj
  store i32 %i.lk, ptr %i.lh, align 4, !tbaa !35
  ...
  %i.lo = load i32, ptr %i.ln, align 4, !tbaa !35
  %i.lp = sub nsw i32 %.0.lcssa, %i.lo
  store i32 %i.lp, ptr %i.lm, align 4, !tbaa !35
  ...
  %i.lt = load i32, ptr %i.ls, align 4, !tbaa !35
  %i.lu = sub nsw i32 %.0.lcssa, %i.lt
  store i32 %i.lu, ptr %i.lr, align 4, !tbaa !35
  %indvars.iv.next85.3 = add nuw nsw i64 %indvars.iv84, 4 ; 2 uses
  %niter.next.3 = add i64 %niter, 4               ; 2 uses
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %._crit_edge61.loopexit.unr-lcssa, label %.lr.ph60, !llvm.loop !149
...
.lr.ph60.epil:                                    ; preds = %.lr.ph60.epil, %.lr.ph60.epil.preheader
  ...
  %i.lx = load i32, ptr %i.lw, align 4, !tbaa !35
  %i.ly = sub nsw i32 %.0.lcssa, %i.lx
  store i32 %i.ly, ptr %i.lv, align 4, !tbaa !35
  %indvars.iv.next85.epil = add nuw nsw i64 %indvars.iv84.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %._crit_edge61, label %.lr.ph60.epil, !llvm.loop !150
...
vector.body180:                                   ; preds = %vector.body180, %vector.ph178
  ...
  store <4 x i32> %vec.ind, ptr %i.l, align 4, !tbaa !35
  store <4 x i32> %step.add, ptr %i.m, align 4, !tbaa !35
  %index.next182 = add nuw i64 %index181, 8       ; 2 uses
  %vec.ind.next = add <4 x i32> %vec.ind, splat (i32 8)
  %i.n = icmp eq i64 %index.next182, %n.vec179
  br i1 %i.n, label %middle.block183, label %vector.body180, !llvm.loop !151
...
bb.c:                                             ; preds = %bb.b
  ...
  store i32 %i.r, ptr %i.o, align 8, !tbaa !35
  store i32 %i.p, ptr %i.q, align 4, !tbaa !35
...
.lr.ph.i:                                         ; preds = %bb.d
  ...
  %i.x = load i64, ptr %i.w, align 8, !tbaa !44   ; 5 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %i.aa, align 8, !tbaa !44 ; 2 uses
  %wide.load158 = load <2 x i64>, ptr %i.ab, align 8, !tbaa !44 ; 2 uses
...
vector.body166:                                   ; preds = %.preheader.i, %vector.body166
  ...
  %wide.load168 = load <2 x i64>, ptr %i.bx, align 8, !tbaa !44, !alias.scope !166, !noalias !167
  %wide.load169 = load <2 x i64>, ptr %i.by, align 8, !tbaa !44, !alias.scope !166, !noalias !167
  %i.bz = getelementptr [8 x i8], ptr %invariant.gep.i, i64 %index167 ; 3 uses
  %i.ca = getelementptr i8, ptr %i.bz, i64 16     ; 2 uses
  %wide.load170 = load <2 x i64>, ptr %i.bz, align 8, !tbaa !44, !alias.scope !167
  %wide.load171 = load <2 x i64>, ptr %i.ca, align 8, !tbaa !44, !alias.scope !167
  store <2 x i64> %wide.load170, ptr %i.bx, align 8, !tbaa !44, !alias.scope !166, !noalias !167
  store <2 x i64> %wide.load171, ptr %i.by, align 8, !tbaa !44, !alias.scope !166, !noalias !167
  store <2 x i64> %wide.load168, ptr %i.bz, align 8, !tbaa !44, !alias.scope !167
  store <2 x i64> %wide.load169, ptr %i.ca, align 8, !tbaa !44, !alias.scope !167
  %index.next172 = add nuw i64 %index167, 4       ; 2 uses
  %i.cb = icmp eq i64 %index.next172, %n.vec165
  br i1 %i.cb, label %._crit_edge.i, label %vector.body166, !llvm.loop !156
...
scalar.ph162:                                     ; preds = %scalar.ph162.preheader, %scalar.ph162
  ...
  %i.cd = load i64, ptr %i.cc, align 8, !tbaa !44
  %gep.i = getelementptr [8 x i8], ptr %invariant.gep.i, i64 %indvars.iv.i ; 2 uses
  %i.ce = load i64, ptr %gep.i, align 8, !tbaa !44
  store i64 %i.ce, ptr %i.cc, align 8, !tbaa !44
  store i64 %i.cd, ptr %gep.i, align 8, !tbaa !44
  ...
  %i.ch = load i64, ptr %gep.i.1, align 8, !tbaa !44
  store i64 %i.ch, ptr %i.cf, align 8, !tbaa !44
  store i64 %i.cg, ptr %gep.i.1, align 8, !tbaa !44
  %indvars.iv.next.i.1 = add nuw nsw i64 %indvars.iv.i, 2 ; 2 uses
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge.i.loopexit.unr-lcssa, label %scalar.ph162, !llvm.loop !157
...
scalar.ph162.epil.preheader:                      ; preds = %._crit_edge.i.loopexit.unr-lcssa, %scalar.ph162.preheader
  ...
  %i.cj = load i64, ptr %i.ci, align 8, !tbaa !44
  %gep.i.epil = getelementptr [8 x i8], ptr %invariant.gep.i, i64 %indvars.iv.i.epil.init ; 2 uses
  %i.ck = load i64, ptr %gep.i.epil, align 8, !tbaa !44
  store i64 %i.ck, ptr %i.ci, align 8, !tbaa !44
  store i64 %i.cj, ptr %gep.i.epil, align 8, !tbaa !44
...
._crit_edge.i:                                    ; preds = %vector.body166, %scalar.ph162.epil.preheader, %._crit_edge.i.loopexit.unr-lcssa
  ...
  br i1 %i.cn, label %.preheader.i, label %If_CluChangePhase.exit, !llvm.loop !7
...
If_CluChangePhase.exit:                           ; preds = %._crit_edge.i, %vector.body, %scalar.ph, %scalar.ph.1, %scalar.ph.2, %bb.e, %bb.d, %bb.b
  ...
  br i1 %exitcond.not, label %.lr.ph105.preheader, label %bb.b, !llvm.loop !158
...
.lr.ph111.us:                                     ; preds = %.lr.ph111.us.backedge, %.lr.ph111.us.preheader
  ...
  %i.dd = load i32, ptr %i.dc, align 8, !tbaa !35 ; 2 uses
  ...
  %i.df = load i32, ptr %i.de, align 8, !tbaa !35 ; 2 uses
...
bb.f:                                             ; preds = %.lr.ph111.us
  ...
  %i.di = load <2 x i32>, ptr %i.dh, align 4, !tbaa !35
  %i.dj = shufflevector <2 x i32> %i.di, <2 x i32> poison, <2 x i32> <i32 1, i32 0>
  store <2 x i32> %i.dj, ptr %i.dh, align 4, !tbaa !35
  store i32 %i.df, ptr %i.dc, align 8, !tbaa !35
  store i32 %i.dd, ptr %i.de, align 8, !tbaa !35
  ...
  store i32 %i.dn, ptr %i.dk, align 4, !tbaa !35
  store i32 %i.dl, ptr %i.dm, align 4, !tbaa !35
...
begin_hunk_2_@If_CluSemiCanonicizeVerify:bb.a
  ...
  store i64 %i.az, ptr %i.ba, align 8, !tbaa !44
  %indvars.iv.next151.i.us.3 = add nuw nsw i64 %indvars.iv150.i.us, 4 ; 2 uses
  %niter.next.3 = add i64 %niter, 4               ; 2 uses
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %._crit_edge.us.i.us.loopexit.unr-lcssa, label %.lr.ph95.us.i.us, !llvm.loop !183
...
.lr.ph95.us.i.us.epil:                            ; preds = %.lr.ph95.us.i.us.epil, %.lr.ph95.us.i.us.epil.preheader
  ...
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %._crit_edge.us.i.us, label %.lr.ph95.us.i.us.epil, !llvm.loop !184
...
._crit_edge.us.i.us:                              ; preds = %vector.body155, %._crit_edge.us.i.us.loopexit.unr-lcssa, %.lr.ph95.us.i.us.epil
  ...
  br i1 %i.bi, label %.lr.ph.us.preheader.i.us, label %If_CluSwapAdjacent.exit.us, !llvm.loop !8
...
.lr.ph.i71.us:                                    ; preds = %.preheader.i.us, %.lr.ph.i71.us
  ...
  %i.bl = load <2 x i64>, ptr %i.bj, align 8, !tbaa !44 ; 3 uses
  ...
  store <2 x i64> %i.bq, ptr %i.bk, align 8, !tbaa !44
  ...
  br i1 %i.br, label %.lr.ph.i71.us, label %If_CluSwapAdjacent.exit.us, !llvm.loop !9
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %i.cc, align 8, !tbaa !44 ; 3 uses
  %wide.load148 = load <2 x i64>, ptr %i.cd, align 8, !tbaa !44 ; 3 uses
  ...
  store <2 x i64> %i.cq, ptr %i.cs, align 8, !tbaa !44
  store <2 x i64> %i.cr, ptr %i.ct, align 8, !tbaa !44
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.cu = icmp eq i64 %index.next, %n.vec
  br i1 %i.cu, label %middle.block, label %vector.body, !llvm.loop !185
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader
  ...
  %i.cw = load i64, ptr %i.cv, align 8, !tbaa !44 ; 3 uses
  ...
  store i64 %i.dd, ptr %i.de, align 8, !tbaa !44
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  %i.dh = load i64, ptr %i.dg, align 8, !tbaa !44 ; 3 uses
  ...
  %i.dr = load i64, ptr %i.dq, align 8, !tbaa !44 ; 3 uses
  ...
  store i64 %i.dy, ptr %i.dz, align 8, !tbaa !44
  ...
  br i1 %exitcond162.not.i.us.1, label %If_CluSwapAdjacent.exit.us, label %scalar.ph, !llvm.loop !186
...
If_CluSwapAdjacent.exit.us:                       ; preds = %._crit_edge.us.i.us, %.lr.ph.i71.us, %scalar.ph.prol.loopexit, %scalar.ph, %middle.block, %bb.f, %.preheader.i.us, %.preheader87.lr.ph.i.us, %bb.e, %bb.b
  ...
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %._crit_edge.us, label %bb.b, !llvm.loop !187

._crit_edge.us:                                   ; preds = %If_CluSwapAdjacent.exit.us
  %.not.us = icmp eq i32 %.148.us, 0
  br i1 %.not.us, label %.split.us, label %.lr.ph.us, !llvm.loop !188
...
.lr.ph.preheader.i72:                             ; preds = %.split.us
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %.253.us, ptr align 8 %.256.us, i64 %i.ee, i1 false), !tbaa !44
...
.lr.ph.i88:                                       ; preds = %bb.i
  ...
  %i.el = load i64, ptr %i.ek, align 8, !tbaa !44 ; 3 uses
...
vector.body173:                                   ; preds = %vector.body173, %vector.ph165
  ...
  %wide.load175 = load <2 x i64>, ptr %i.eo, align 8, !tbaa !44 ; 2 uses
  %wide.load176 = load <2 x i64>, ptr %i.ep, align 8, !tbaa !44 ; 2 uses
  ...
  store <2 x i64> %i.ey, ptr %i.eo, align 8, !tbaa !44
  store <2 x i64> %i.ez, ptr %i.ep, align 8, !tbaa !44
  %index.next177 = add nuw i64 %index174, 4       ; 2 uses
  %i.fa = icmp eq i64 %index.next177, %n.vec166
  br i1 %i.fa, label %middle.block178, label %vector.body173, !llvm.loop !189
...
vector.body189:                                   ; preds = %.preheader.i82, %vector.body189
  ...
  %wide.load191 = load <2 x i64>, ptr %i.gb, align 8, !tbaa !44, !alias.scope !197, !noalias !198
  %wide.load192 = load <2 x i64>, ptr %i.gc, align 8, !tbaa !44, !alias.scope !197, !noalias !198
  %i.gd = getelementptr [8 x i8], ptr %invariant.gep.i83, i64 %index190 ; 3 uses
  %i.ge = getelementptr i8, ptr %i.gd, i64 16     ; 2 uses
  %wide.load193 = load <2 x i64>, ptr %i.gd, align 8, !tbaa !44, !alias.scope !198
  %wide.load194 = load <2 x i64>, ptr %i.ge, align 8, !tbaa !44, !alias.scope !198
  store <2 x i64> %wide.load193, ptr %i.gb, align 8, !tbaa !44, !alias.scope !197, !noalias !198
  store <2 x i64> %wide.load194, ptr %i.gc, align 8, !tbaa !44, !alias.scope !197, !noalias !198
  store <2 x i64> %wide.load191, ptr %i.gd, align 8, !tbaa !44, !alias.scope !198
  store <2 x i64> %wide.load192, ptr %i.ge, align 8, !tbaa !44, !alias.scope !198
  %index.next195 = add nuw i64 %index190, 4       ; 2 uses
  %i.gf = icmp eq i64 %index.next195, %n.vec188
  br i1 %i.gf, label %._crit_edge.i, label %vector.body189, !llvm.loop !194
...
scalar.ph185:                                     ; preds = %scalar.ph185.preheader, %scalar.ph185
  ...
  %i.gi = load i64, ptr %gep.i85, align 8, !tbaa !44
  store i64 %i.gi, ptr %i.gg, align 8, !tbaa !44
  store i64 %i.gh, ptr %gep.i85, align 8, !tbaa !44
  ...
  %i.gl = load i64, ptr %gep.i85.1, align 8, !tbaa !44
  store i64 %i.gl, ptr %i.gj, align 8, !tbaa !44
  store i64 %i.gk, ptr %gep.i85.1, align 8, !tbaa !44
  ...
  br i1 %niter213.ncmp.1, label %._crit_edge.i.loopexit.unr-lcssa, label %scalar.ph185, !llvm.loop !195
...
scalar.ph185.epil.preheader:                      ; preds = %._crit_edge.i.loopexit.unr-lcssa, %scalar.ph185.preheader
  ...
  %i.gn = load i64, ptr %i.gm, align 8, !tbaa !44
  %gep.i85.epil = getelementptr [8 x i8], ptr %invariant.gep.i83, i64 %indvars.iv.i84.epil.init ; 2 uses
  %i.go = load i64, ptr %gep.i85.epil, align 8, !tbaa !44
  store i64 %i.go, ptr %i.gm, align 8, !tbaa !44
  store i64 %i.gn, ptr %gep.i85.epil, align 8, !tbaa !44
  br label %._crit_edge.i
...
._crit_edge.i:                                    ; preds = %vector.body189, %scalar.ph185.epil.preheader, %._crit_edge.i.loopexit.unr-lcssa
  ...
  br i1 %i.gr, label %.preheader.i82, label %If_CluChangePhase.exit, !llvm.loop !7
...
If_CluChangePhase.exit:                           ; preds = %._crit_edge.i, %scalar.ph163, %middle.block178, %.preheader.lr.ph.i, %bb.j, %bb.i, %bb.g
  ...
  br i1 %exitcond123.not, label %._crit_edge, label %bb.g, !llvm.loop !196
...
bb.k:                                             ; preds = %.lr.ph.i92
  ...
  br i1 %exitcond.not.i96, label %If_CluEqual.exit.thread, label %.lr.ph.i92, !llvm.loop !10
...
.lr.ph.i92:                                       ; preds = %._crit_edge, %bb.k
  ...
  %i.gv = load i64, ptr %i.gu, align 8, !tbaa !44
...
bb.a:
  %i.a = load i8, ptr %0, align 1, !tbaa !78
...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.p = load i8, ptr %0, align 1, !tbaa !78
  %i.q = sext i8 %i.p to i64
  %i.r = icmp slt i64 %indvars.iv.next, %i.q
  br i1 %i.r, label %bb.b, label %._crit_edge, !llvm.loop !11
...
bb.a:
  ...
  store i64 %3, ptr %i.a, align 8, !tbaa !44
  %i.b = load i8, ptr %1, align 1, !tbaa !78
  ...
  %i.i = load i8, ptr %1, align 1, !tbaa !78
...
bb.b:                                             ; preds = %bb.b, %.lr.ph.i
  ...
  %i.m = load i8, ptr %i.l, align 1, !tbaa !71
  ...
  %i.q = load i8, ptr %1, align 1, !tbaa !78
