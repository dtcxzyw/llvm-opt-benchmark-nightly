...
begin_hunk_0_@Eso_ManMinimizeAdd:bb.a
  store ptr %i.kz, ptr %i.kv, align 8, !tbaa !48
...
bb.br:                                            ; preds = %bb.bq
  ...
  %i.ld = load ptr, ptr %i.lc, align 8, !tbaa !48 ; 2 uses
...
bb.bu:                                            ; preds = %bb.bt, %bb.bs
  ...
  store ptr %i.li, ptr %i.lc, align 8, !tbaa !48
  br label %Vec_IntGrow.exit11.sink.split.i237
...
Vec_IntGrow.exit11.sink.split.i237:               ; preds = %bb.bu, %Vec_IntGrow.exit.i240
  ...
  store i32 %spec.select.sink.i238, ptr %i.ad, align 8, !tbaa !47
  %.pre437 = load i32, ptr %i.ae, align 4, !tbaa !37
...
bb.a:
  ...
  %.val1920 = load i32, ptr %i.d, align 4, !tbaa !44
...
bb.e:                                             ; preds = %bb.d
  %i.s = load ptr, ptr %i.f, align 8, !tbaa !48   ; 2 uses
...
bb.h:                                             ; preds = %bb.d
  ...
  %.pre10.i = load ptr, ptr %i.f, align 8, !tbaa !48 ; 3 uses
...
Vec_IntGrow.exit11.sink.split.i.i:                ; preds = %bb.k, %bb.j, %bb.g, %bb.f
  ...
  store ptr %i.ab, ptr %i.f, align 8, !tbaa !48
  store i32 %spec.select.sink.i.i, ptr %1, align 8, !tbaa !47
  %.pre11.i = load i32, ptr %i.a, align 4, !tbaa !37
  br label %Vec_IntPush.exit.i
...
bb.a:
  ...
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !48   ; 4 uses
  ...
  %i.l = load i32, ptr %i.k, align 4, !tbaa !37   ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load76 = load <4 x i32>, ptr %i.ad, align 4, !tbaa !58
  %i.ae = getelementptr i8, ptr %next.gep75, i64 16
  store <4 x i32> %wide.load, ptr %next.gep75, align 4, !tbaa !58
  store <4 x i32> %wide.load76, ptr %i.ae, align 4, !tbaa !58
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.af = icmp eq i64 %index.next, %n.vec
  br i1 %i.af, label %middle.block, label %vector.body, !llvm.loop !119
...
.lr.ph:                                           ; preds = %bb.a, %bb.g
  ...
  %i.ag = load i32, ptr %.03753, align 4, !tbaa !58 ; 5 uses
  %i.ah = load i32, ptr %.054, align 4, !tbaa !58 ; 4 uses
  %i.ai = icmp eq i32 %i.ag, %i.ah
  br i1 %i.ai, label %bb.b, label %bb.c

bb.b:                                             ; preds = %.lr.ph
  %i.aj = getelementptr inbounds nuw i8, ptr %.03753, i64 4
  store i32 %i.ag, ptr %.04052, align 4, !tbaa !58
...
bb.f:                                             ; preds = %bb.d
  ...
  store i32 %i.ah, ptr %.04052, align 4, !tbaa !58
  br label %bb.g
...
bb.g:                                             ; preds = %bb.f, %bb.e, %bb.b
  ...
  br i1 %i.ar, label %.lr.ph, label %.preheader48, !llvm.loop !3
...
vector.body86:                                    ; preds = %vector.body86, %vector.ph84
  ...
  %wide.load90 = load <4 x i32>, ptr %next.gep88, align 4, !tbaa !58
  %wide.load91 = load <4 x i32>, ptr %i.be, align 4, !tbaa !58
  %i.bf = getelementptr i8, ptr %next.gep89, i64 16
  store <4 x i32> %wide.load90, ptr %next.gep89, align 4, !tbaa !58
  store <4 x i32> %wide.load91, ptr %i.bf, align 4, !tbaa !58
...
.lr.ph59:                                         ; preds = %.lr.ph59.preheader99, %.lr.ph59
  ...
  %i.bi = load i32, ptr %.23958, align 4, !tbaa !58
  %i.bj = getelementptr inbounds nuw i8, ptr %.24257, i64 4 ; 2 uses
  store i32 %i.bi, ptr %.24257, align 4, !tbaa !58
...
.lr.ph63:                                         ; preds = %.lr.ph63.preheader98, %.lr.ph63
  ...
  %i.bm = load i32, ptr %.262, align 4, !tbaa !58
  %i.bn = getelementptr inbounds nuw i8, ptr %.361, i64 4 ; 2 uses
  store i32 %i.bm, ptr %.361, align 4, !tbaa !58
...
._crit_edge:                                      ; preds = %.lr.ph63, %middle.block93, %.preheader
  ...
  store i32 %i.bt, ptr %i.bu, align 4, !tbaa !37
...
bb.d:                                             ; preds = %.lr.ph71, %.critedge2
  ...
  %.val52 = load ptr, ptr %i.f, align 8, !tbaa !48
  %i.l = getelementptr inbounds nuw [4 x i8], ptr %.val52, i64 %indvars.iv78
  %i.m = load i32, ptr %i.l, align 4, !tbaa !58   ; 4 uses
  %i.n = load i32, ptr %i.i, align 4, !tbaa !39
...
.lr.ph68:                                         ; preds = %.preheader, %.lr.ph68
  ...
  %.val51 = load ptr, ptr %i.g, align 8, !tbaa !48
  ...
  %.val46 = load i32, ptr %i.d, align 4, !tbaa !37 ; 3 uses
...
bb.e:                                             ; preds = %.lr.ph, %Eso_ManComputeAnd.exit.thread
  ...
  %.val50 = load ptr, ptr %i.g, align 8, !tbaa !48
  %i.x = getelementptr inbounds nuw [4 x i8], ptr %.val50, i64 %indvars.iv
  %i.y = load i32, ptr %i.x, align 4, !tbaa !58   ; 3 uses
  %i.z = load i32, ptr %i.i, align 4, !tbaa !39
  %i.aa = icmp eq i32 %i.y, %i.z
  br i1 %i.aa, label %Eso_ManComputeAnd.exit.thread.sink.split, label %bb.f

bb.f:                                             ; preds = %bb.e
  %i.ab = load ptr, ptr %i.j, align 8, !tbaa !53  ; 6 uses
  ...
  %.val.i.i = load ptr, ptr %i.ag, align 8, !tbaa !48
...
vector.body108:                                   ; preds = %vector.body108, %vector.ph106
  ...
  %wide.load112 = load <4 x i32>, ptr %next.gep110, align 4, !tbaa !58
  %wide.load113 = load <4 x i32>, ptr %i.bw, align 4, !tbaa !58
  %i.bx = getelementptr i8, ptr %next.gep111, i64 16
  store <4 x i32> %wide.load112, ptr %next.gep111, align 4, !tbaa !58
  store <4 x i32> %wide.load113, ptr %i.bx, align 4, !tbaa !58
...
.lr.ph.i:                                         ; preds = %bb.f, %bb.l
  ...
  %i.bz = load i32, ptr %.03753.i, align 4, !tbaa !58 ; 5 uses
  %i.ca = load i32, ptr %.054.i, align 4, !tbaa !58 ; 4 uses
  %i.cb = icmp eq i32 %i.bz, %i.ca
  br i1 %i.cb, label %bb.g, label %bb.h

bb.g:                                             ; preds = %.lr.ph.i
  %i.cc = getelementptr inbounds nuw i8, ptr %.03753.i, i64 4
  store i32 %i.bz, ptr %.04052.i, align 4, !tbaa !58
...
bb.k:                                             ; preds = %bb.i
  ...
  store i32 %i.ca, ptr %.04052.i, align 4, !tbaa !58
  br label %bb.l
...
bb.l:                                             ; preds = %bb.k, %bb.j, %bb.g
  ...
  br i1 %i.ck, label %.lr.ph.i, label %.preheader48.i, !llvm.loop !3
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %next.gep, align 4, !tbaa !58
  %wide.load98 = load <4 x i32>, ptr %i.cy, align 4, !tbaa !58
  %i.cz = getelementptr i8, ptr %next.gep97, i64 16
  store <4 x i32> %wide.load, ptr %next.gep97, align 4, !tbaa !58
  store <4 x i32> %wide.load98, ptr %i.cz, align 4, !tbaa !58
  %index.next = add nuw i64 %index, 8             ; 2 uses
...
.lr.ph59.i:                                       ; preds = %.lr.ph59.i.preheader121, %.lr.ph59.i
  ...
  %i.dc = load i32, ptr %.23958.i, align 4, !tbaa !58
  %i.dd = getelementptr inbounds nuw i8, ptr %.24257.i, i64 4 ; 2 uses
  store i32 %i.dc, ptr %.24257.i, align 4, !tbaa !58
...
.lr.ph63.i:                                       ; preds = %.lr.ph63.i.preheader120, %.lr.ph63.i
  ...
  %i.dg = load i32, ptr %.262.i, align 4, !tbaa !58
  %i.dh = getelementptr inbounds nuw i8, ptr %.361.i, i64 4 ; 2 uses
  store i32 %i.dg, ptr %.361.i, align 4, !tbaa !58
...
Eso_ManComputeAnd.exit:                           ; preds = %.lr.ph63.i, %middle.block, %.preheader.i
  ...
  store i32 %i.dn, ptr %i.do, align 4, !tbaa !37
...
Eso_ManComputeAnd.exit.thread:                    ; preds = %bb.h, %Eso_ManComputeAnd.exit.thread.sink.split, %Eso_ManComputeAnd.exit
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %.val = load i32, ptr %i.d, align 4, !tbaa !37  ; 3 uses
...
.critedge2:                                       ; preds = %Eso_ManComputeAnd.exit.thread, %.lr.ph68, %.preheader61, %.preheader
  ...
  %.val47 = load i32, ptr %i.b, align 4, !tbaa !37
...
bb.b:                                             ; preds = %bb.a
  ...
  %.val25 = load i32, ptr %i.b, align 4, !tbaa !37
  %i.c = icmp eq i32 %.val25, 0
  br i1 %i.c, label %bb.c, label %bb.g

bb.c:                                             ; preds = %bb.b
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 12
  %i.e = load i32, ptr %i.d, align 4, !tbaa !39   ; 2 uses
  %i.f = load i32, ptr %3, align 8, !tbaa !47
...
bb.e:                                             ; preds = %bb.d
  ...
  %.pre61.pre = load i32, ptr %i.a, align 4, !tbaa !37
...
Vec_IntGrow.exit11.sink.split.i:                  ; preds = %bb.e, %bb.f
  ...
  store ptr %i.l, ptr %i.h, align 8, !tbaa !48
  br label %.sink.split.sink.split

bb.g:                                             ; preds = %bb.b
  %i.m = getelementptr i8, ptr %1, i64 8
  %.val27 = load ptr, ptr %i.m, align 8, !tbaa !48
  %i.n = load i32, ptr %.val27, align 4, !tbaa !58 ; 3 uses
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.w = load i32, ptr %3, align 8, !tbaa !47
  %i.x = icmp eq i32 %i.w, 0
  %i.y = getelementptr inbounds nuw i8, ptr %3, i64 8 ; 2 uses
  %i.z = load ptr, ptr %i.y, align 8, !tbaa !48   ; 3 uses
...
bb.k:                                             ; preds = %bb.j
  ...
  %.pre58.pre = load i32, ptr %i.a, align 4, !tbaa !37
...
Vec_IntGrow.exit11.sink.split.i31:                ; preds = %bb.k, %bb.l
  ...
  store ptr %i.ac, ptr %i.y, align 8, !tbaa !48
  br label %.sink.split.sink.split

bb.m:                                             ; preds = %bb.h
  %i.ad = load i32, ptr %3, align 8, !tbaa !47
...
bb.o:                                             ; preds = %bb.n
  ...
  %.pre55.pre = load i32, ptr %i.a, align 4, !tbaa !37
end_hunk_0
...
bb.l:                                             ; preds = %bb.k, %bb.a
  ...
  %.val = load i32, ptr %i.aj, align 4, !tbaa !37
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.am = load i32, ptr %i.al, align 4, !tbaa !37 ; 7 uses
...
Vec_IntGrow.exit.i:                               ; preds = %bb.q, %bb.p
  ...
  store ptr %i.au, ptr %i.aq, align 8, !tbaa !48
  br label %Vec_IntGrow.exit11.sink.split.i
...
bb.v:                                             ; preds = %bb.u, %bb.t
  ...
  store ptr %i.bd, ptr %i.ax, align 8, !tbaa !48
  br label %Vec_IntGrow.exit11.sink.split.i
...
Vec_IntGrow.exit11.sink.split.i:                  ; preds = %bb.v, %Vec_IntGrow.exit.i
  ...
  %.pre = load i32, ptr %i.al, align 4, !tbaa !37
...
Vec_IntPush.exit:                                 ; preds = %bb.m, %bb.r, %Vec_IntGrow.exit11.sink.split.i
  ...
  store i32 %i.bh, ptr %i.al, align 4, !tbaa !37
...
bb.w:                                             ; preds = %Vec_IntPush.exit, %bb.l
  %i.bk = load i32, ptr %i.a, align 8, !tbaa !40  ; 2 uses
  %i.bl = add nsw i32 %i.bk, 1
  store i32 %i.bl, ptr %i.a, align 8, !tbaa !40
  %i.bm = getelementptr i8, ptr %0, i64 32
  %.val36 = load ptr, ptr %i.bm, align 8, !tbaa !72
...
bb.a:
  ...
  %i.a = load i32, ptr @enable_dbg_outs, align 4, !tbaa !58
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.e = load ptr, ptr @stdout, align 8, !tbaa !147
...
bb.d:                                             ; preds = %bb.b
  %i.i = load ptr, ptr @stdout, align 8, !tbaa !147, !noalias !148
  %i.j = call i32 @vfprintf(ptr noundef %i.i, ptr noundef %1, ptr noundef nonnull %2) #25, !inline_history !145 ; 0 uses
  br label %bb.e
...
!14 = !{!"p1 _ZTS10Vec_Wec_t_", !12, i64 0}
!15 = !{!"p1 _ZTS13Hsh_VecMan_t_", !12, i64 0}
!16 = !{!"p1 _ZTS10Vec_Int_t_", !12, i64 0}
!17 = !{!"Eso_Man_t_", !13, i64 0, !9, i64 8, !9, i64 12, !14, i64 16, !15, i64 24, !14, i64 32, !16, i64 40, !16, i64 48, !16, i64 56}
!18 = !{!17, !13, i64 0}
!19 = !{!"p1 omnipotent char", !12, i64 0}
!20 = !{!"p1 _ZTS10Gia_Obj_t_", !12, i64 0}
!21 = !{!"p1 int", !12, i64 0}
!22 = !{!"Vec_Int_t_", !9, i64 0, !9, i64 4, !21, i64 8}
!23 = !{!"p1 _ZTS10Gia_Rpr_t_", !12, i64 0}
!24 = !{!"p1 _ZTS10Vec_Str_t_", !12, i64 0}
...
!35 = !{!"Gia_Man_t_", !19, i64 0, !19, i64 8, !9, i64 16, !9, i64 20, !9, i64 24, !9, i64 28, !20, i64 32, !21, i64 40, !9, i64 48, !9, i64 52, !9, i64 56, !16, i64 64, !16, i64 72, !22, i64 80, !22, i64 96, !9, i64 112, !9, i64 116, !9, i64 120, !22, i64 128, !21, i64 144, !21, i64 152, !16, i64 160, !9, i64 168, !9, i64 172, !9, i64 176, !9, i64 180, !21, i64 184, !23, i64 192, !21, i64 200, !21, i64 208, !21, i64 216, !9, i64 224, !9, i64 228, !21, i64 232, !9, i64 240, !16, i64 248, !16, i64 256, !16, i64 264, !14, i64 272, !14, i64 280, !16, i64 288, !12, i64 296, !16, i64 304, !16, i64 312, !24, i64 320, !19, i64 328, !16, i64 336, !16, i64 344, !16, i64 352, !16, i64 360, !16, i64 368, !25, i64 376, !25, i64 384, !26, i64 392, !22, i64 400, !22, i64 416, !16, i64 432, !16, i64 440, !16, i64 448, !16, i64 456, !16, i64 464, !16, i64 472, !16, i64 480, !16, i64 488, !16, i64 496, !16, i64 504, !16, i64 512, !19, i64 520, !27, i64 528, !13, i64 536, !28, i64 544, !28, i64 552, !16, i64 560, !16, i64 568, !16, i64 576, !16, i64 584, !16, i64 592, !9, i64 600, !29, i64 604, !29, i64 608, !16, i64 616, !21, i64 624, !9, i64 632, !26, i64 640, !26, i64 648, !26, i64 656, !16, i64 664, !16, i64 672, !16, i64 680, !16, i64 688, !16, i64 696, !16, i64 704, !16, i64 712, !16, i64 720, !16, i64 728, !30, i64 736, !28, i64 744, !12, i64 752, !12, i64 760, !12, i64 768, !31, i64 776, !31, i64 784, !12, i64 792, !21, i64 800, !9, i64 808, !9, i64 812, !9, i64 816, !9, i64 820, !9, i64 824, !9, i64 828, !9, i64 832, !9, i64 836, !9, i64 840, !9, i64 844, !9, i64 848, !9, i64 852, !32, i64 856, !32, i64 864, !32, i64 872, !32, i64 880, !16, i64 888, !16, i64 896, !16, i64 904, !33, i64 912, !9, i64 920, !9, i64 924, !9, i64 928, !16, i64 936, !9, i64 944, !9, i64 948, !16, i64 952, !16, i64 960, !26, i64 968, !32, i64 976, !16, i64 984, !16, i64 992, !9, i64 1000, !9, i64 1004, !32, i64 1008, !22, i64 1016, !22, i64 1032, !22, i64 1048, !34, i64 1064, !24, i64 1072, !24, i64 1080, !9, i64 1088, !9, i64 1092, !9, i64 1096, !9, i64 1100, !24, i64 1104, !16, i64 1112, !16, i64 1120, !16, i64 1128, !26, i64 1136}
!36 = !{!35, !16, i64 64}
!37 = !{!22, !9, i64 4}
!38 = !{!17, !9, i64 8}
!39 = !{!17, !9, i64 12}
!40 = !{!35, !9, i64 24}
!41 = !{!"Vec_Wec_t_", !9, i64 0, !9, i64 4, !16, i64 8}
!42 = !{!41, !9, i64 0}
!43 = !{!41, !16, i64 8}
!44 = !{!41, !9, i64 4}
!45 = !{!17, !14, i64 16}
...
!47 = !{!22, !9, i64 0}
!48 = !{!22, !21, i64 8}
!49 = !{!"Hsh_VecMan_t_", !16, i64 0, !16, i64 8, !16, i64 16, !16, i64 24, !16, i64 32, !22, i64 40, !22, i64 56, !22, i64 72}
!50 = !{!49, !16, i64 0}
!51 = !{!49, !16, i64 8}
!52 = !{!49, !16, i64 16}
!53 = !{!17, !15, i64 24}
...
!57 = !{!17, !16, i64 56}
!58 = !{!9, !9, i64 0}
!59 = !{!"Hsh_VecObj_t_", !9, i64 0, !9, i64 4, !8, i64 8}
!60 = !{!59, !9, i64 0}
!61 = !{!49, !9, i64 40}
!62 = !{!49, !9, i64 44}
!63 = !{!49, !21, i64 48}
...
!66 = !{!"Vec_Vec_t_", !9, i64 0, !9, i64 4, !65, i64 8}
!67 = !{!66, !9, i64 4}
!68 = !{!12, !12, i64 0}
!69 = !{!"Vec_Ptr_t_", !9, i64 0, !9, i64 4, !65, i64 8}
!70 = !{!69, !9, i64 4}
!71 = !{!69, !65, i64 8}
!72 = !{!35, !20, i64 32}
!73 = !{!35, !16, i64 72}
...
!87 = distinct !{!87, !46}
!88 = distinct !{!88, !46}
!89 = !{!"Vec_Str_t_", !9, i64 0, !9, i64 4, !19, i64 8}
!90 = !{!89, !9, i64 4}
!91 = !{!89, !9, i64 0}
!92 = !{!89, !19, i64 8}
!93 = !{!8, !8, i64 0}
...
!117 = distinct !{!117, !46}
!118 = distinct !{!118, !46}
!119 = distinct !{!119, !46, !74, !75}
!120 = distinct !{!120, !46, !74, !75}
!121 = distinct !{!121, !46, !74}
!122 = distinct !{!122, !46, !74}
!123 = distinct !{!123, !46}
!124 = distinct !{!124, !46, !74, !75}
!125 = distinct !{!125, !46, !74, !75}
!126 = distinct !{!126, !46, !74}
!127 = distinct !{!127, !46, !74}
!128 = distinct !{!128, !46}
!129 = distinct !{!129, !46}
!130 = distinct !{!130, !46}
!131 = distinct !{!131, !46}
!132 = distinct !{!132, !46}
!133 = distinct !{!133, !46}
!134 = !{!"timespec", !31, i64 0, !31, i64 8}
!135 = !{!134, !31, i64 0}
!136 = !{!134, !31, i64 8}
!137 = !{!69, !9, i64 0}
!138 = !{!14, !14, i64 0}
...
!144 = distinct !{!144, !143, !"vprintf: argument 0"}
!145 = distinct !{null}
!146 = !{!"p1 _ZTS8_IO_FILE", !12, i64 0}
!147 = !{!146, !146, i64 0}
!148 = !{!144}
end_hunk_1
