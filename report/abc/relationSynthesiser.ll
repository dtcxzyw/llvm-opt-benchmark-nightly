...
begin_hunk_0_@_ZN5eSLIM19RelationSynthesiser24addUseAllStepsConstraintEv:bb.a
  store i32 %i.bp, ptr %.sroa.13.073, align 4, !tbaa !47
...
_ZNKSt6vectorIiSaIiEE12_M_check_lenEmPKc.exit.i.i: ; preds = %bb.p
  ...
  store i32 %i.bp, ptr %i.cx, align 4, !tbaa !47
...
_ZNSt6vectorIiSaIiEE9push_backERKi.exit:          ; preds = %bb.o, %_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJRKiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i
  ...
  %i.da = load i32, ptr %i.a, align 8, !tbaa !41
  %i.db = zext i32 %i.da to i64
  %i.dc = icmp samesign ult i64 %indvars.iv.next82, %i.db
  br i1 %i.dc, label %.lr.ph.i21, label %._crit_edge, !llvm.loop !185
}
...
bb.a:
  ...
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !48, !nonnull !44, !align !45
  %i.d = getelementptr inbounds nuw i8, ptr %i.c, i64 4
  %i.e = load i32, ptr %i.d, align 4, !tbaa !69   ; 2 uses
  %i.f = icmp sgt i32 %i.e, 0
  br i1 %i.f, label %.lr.ph.i63.lr.ph, label %.lr.ph.i

.lr.ph.i63.lr.ph:                                 ; preds = %bb.a
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !60, !nonnull !44, !align !45 ; 2 uses
...
.loopexit.loopexit:                               ; preds = %.lr.ph.i77
  %.pre = load ptr, ptr %i.b, align 8, !tbaa !48
  %.phi.trans.insert = getelementptr inbounds nuw i8, ptr %.pre, i64 4
  %.pre138 = load i32, ptr %.phi.trans.insert, align 4, !tbaa !69
  br label %.loopexit
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %.lr.ph.i63
  ...
  br i1 %i.w, label %.lr.ph.i63, label %.lr.ph.i, !llvm.loop !186
...
.lr.ph.i:                                         ; preds = %.loopexit, %bb.a
  ...
  %i.ap = load ptr, ptr %i.x, align 8, !tbaa !61
  ...
  %i.aw = load ptr, ptr %i.ae, align 8, !tbaa !67
...
.lr.ph.i63:                                       ; preds = %.lr.ph.i63.lr.ph, %.loopexit
  ...
  %i.be = load ptr, ptr %2, align 8, !tbaa !61
  ...
  %i.bk = load ptr, ptr %i.r, align 8, !tbaa !67
  ...
  %i.bs = load i32, ptr %.sroa.4124.0..sroa_idx, align 4, !tbaa !47
  ...
  %i.bt = load ptr, ptr %2, align 8, !tbaa !61
  ...
  %i.by = load ptr, ptr %i.r, align 8, !tbaa !67
  ...
  %i.ch = load i32, ptr %.sroa.4117.0..sroa_idx, align 4, !tbaa !47
  ...
  %i.ci = load ptr, ptr %i.b, align 8, !tbaa !48, !nonnull !44, !align !45
  %i.cj = getelementptr inbounds nuw i8, ptr %i.ci, i64 4
  %i.ck = load i32, ptr %i.cj, align 4, !tbaa !69 ; 2 uses
...
.lr.ph.i77:                                       ; preds = %.lr.ph.i63, %.lr.ph.i77
  ...
  %i.cy = load i32, ptr %i.cx, align 4, !tbaa !47 ; 2 uses
  ...
  %i.dd = load ptr, ptr %i.r, align 8, !tbaa !67
  %i.de = getelementptr inbounds nuw [24 x i8], ptr %i.dd, i64 %i.a
  %i.df = load ptr, ptr %i.de, align 8, !tbaa !61
  ...
  %i.dy = load ptr, ptr %i.r, align 8, !tbaa !67
  %i.dz = getelementptr inbounds nuw [24 x i8], ptr %i.dy, i64 %i.a
  %i.ea = load ptr, ptr %i.dz, align 8, !tbaa !61
  ...
  %i.ee = load i32, ptr %i.ed, align 4, !tbaa !47
  ...
  br i1 %4, label %.lr.ph.i77, label %.loopexit.loopexit, !llvm.loop !187
}
...
_ZNSt6vectorIS_IiSaIiEESaIS1_EE9push_backEOS1_.exit:
  ...
  %i.a = load ptr, ptr %2, align 8, !tbaa !65
  ...
  store ptr %i.c, ptr %5, align 8, !tbaa !46
  ...
  store i32 %i.b, ptr %i.c, align 4, !tbaa !47
  %i.f = getelementptr inbounds nuw i8, ptr %5, i64 8
  store ptr %i.d, ptr %i.f, align 8, !tbaa !58
  ...
  %.pr = load ptr, ptr %5, align 8, !tbaa !46     ; 3 uses
...
bb.a:                                             ; preds = %_ZNSt6vectorIS_IiSaIiEESaIS1_EE9push_backEOS1_.exit
  %i.i = load ptr, ptr %i.e, align 8, !tbaa !59
...
.lr.ph.i:                                         ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit64, %_ZNSt6vectorIiSaIiEED2Ev.exit
  ...
  %i.ag = load ptr, ptr %i.g, align 8, !tbaa !62
...
bb.b:                                             ; preds = %.lr.ph129, %_ZNSt6vectorIiSaIiEED2Ev.exit64
  ...
  %i.bb = load i32, ptr %i.ba, align 4, !tbaa !47 ; 4 uses
  %i.bc = load ptr, ptr %i.g, align 8, !tbaa !62  ; 2 uses
  ...
  %i.bg = load ptr, ptr %i.bd, align 8, !tbaa !46 ; 2 uses
...
bb.c:                                             ; preds = %.lr.ph, %bb.j
  ...
  %i.bk = load i32, ptr %i.v, align 8, !tbaa !42
  %i.bl = add nsw i32 %i.bk, 1                    ; 4 uses
  store i32 %i.bl, ptr %i.v, align 8, !tbaa !42
  ...
  store ptr %i.bo, ptr %7, align 8, !tbaa !46
  %i.bp = getelementptr inbounds nuw i8, ptr %i.bo, i64 8 ; 2 uses
  store ptr %i.bp, ptr %i.w, align 8, !tbaa !59
  ...
  store ptr %i.bp, ptr %i.x, align 8, !tbaa !58
...
_ZNSt6vectorIiSaIiEED2Ev.exit42:                  ; preds = %bb.c, %bb.d
  ...
  %i.bv = load ptr, ptr %i.y, align 8, !tbaa !58  ; 4 uses
  %i.bw = load ptr, ptr %i.z, align 8, !tbaa !59
  %.not.i43 = icmp eq ptr %i.bv, %i.bw
  br i1 %.not.i43, label %bb.f, label %bb.e

bb.e:                                             ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit42
  store i32 %i.bl, ptr %i.bv, align 4, !tbaa !47
  %i.bx = getelementptr inbounds nuw i8, ptr %i.bv, i64 4
  store ptr %i.bx, ptr %i.y, align 8, !tbaa !58
  br label %_ZNSt6vectorIiSaIiEE9push_backERKi.exit

bb.f:                                             ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit42
  %i.by = load ptr, ptr %6, align 8, !tbaa !46    ; 4 uses
...
_ZNKSt6vectorIiSaIiEE12_M_check_lenEmPKc.exit.i.i: ; preds = %bb.f
  ...
  store i32 %i.bl, ptr %i.ck, align 4, !tbaa !47
...
bb.i:                                             ; preds = %_ZNSt6vectorIiSaIiEE11_S_relocateEPiS2_S2_RS0_.exit16.i.i
  %i.cn = load ptr, ptr %i.z, align 8, !tbaa !59
end_hunk_0
