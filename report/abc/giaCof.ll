...
begin_hunk_0_@Cof_ManCountRemoved:bb.a
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %scevgep.i.i.i.i.i114, i8 0, i64 %i.ex, i1 false), !tbaa !47
  br label %._crit_edge.i.i.i.i.i115

._crit_edge.i.i.i.i.i115:                         ; preds = %.lr.ph.i.i.i.i.i113, %Vec_IntGrow.exit.i.i.i.i.i111
  store i32 %i.dv, ptr %i.dw, align 4, !tbaa !34
...
Cof_ObjLevel.exit121:                             ; preds = %bb.w, %._crit_edge.i.i.i.i.i115
  ...
  %.val.i.i.i.i116 = load ptr, ptr %i.ez, align 8, !tbaa !36
  ...
  %i.fd = load ptr, ptr %i.av, align 8, !tbaa !54
...
bb.aj:                                            ; preds = %bb.v, %bb.o, %bb.n, %Cof_ObjLevel.exit121
  ...
  br i1 %i.fr, label %bb.n, label %.critedge2, !llvm.loop !80
...
.critedge2:                                       ; preds = %bb.aj, %.lr.ph131
  ...
  %.069 = load i32, ptr %i.fs, align 4, !tbaa !47 ; 2 uses
  %.not = icmp eq i32 %.069, 0
  br i1 %.not, label %.critedge.loopexit, label %.lr.ph131, !llvm.loop !81

.critedge.loopexit:                               ; preds = %.critedge2
  %.pre = load ptr, ptr %i.av, align 8, !tbaa !54
  br label %.critedge
...
.critedge:                                        ; preds = %.critedge.loopexit, %.lr.ph135
  ...
  store i32 0, ptr %i.fu, align 4, !tbaa !47
  %indvars.iv.next = add nsw i64 %indvars.iv, 1   ; 2 uses
  %i.fv = load i32, ptr %i.ba, align 8, !tbaa !65
  %i.fw = sext i32 %i.fv to i64
  %i.fx = icmp slt i64 %indvars.iv.next, %i.fw
  br i1 %i.fx, label %.lr.ph135, label %._crit_edge, !llvm.loop !82
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  store ptr %i.w, ptr %i.q, align 8, !tbaa !36
...
bb.m:                                             ; preds = %bb.l, %bb.k
  ...
  store ptr %i.ae, ptr %i.y, align 8, !tbaa !36
  br label %Vec_IntGrow.exit.sink.split.i.i.i.i.i
...
Vec_IntGrow.exit.sink.split.i.i.i.i.i:            ; preds = %bb.m, %bb.g
  ...
  store i32 %spec.select.sink.i.i.i.i.i, ptr %.val6.val8, align 8, !tbaa !35
  %.pre.i.i.i.i = load i32, ptr %i.m, align 4, !tbaa !34
...
.lr.ph.i.i.i.i.i:                                 ; preds = %Vec_IntGrow.exit.i.i.i.i.i
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %scevgep.i.i.i.i.i, i8 0, i64 %i.an, i1 false), !tbaa !47
...
Cof_ObjLevel.exit:                                ; preds = %bb.a, %._crit_edge.i.i.i.i.i
  ...
  store i32 %i.aw, ptr %i.au, align 8, !tbaa !55
...
Cof_ManSuppSize.exit:                             ; preds = %bb.n, %Cof_ObjLevel.exit
  ...
  %i.bf = load i32, ptr %i.au, align 8, !tbaa !55
  %i.bg = add nsw i32 %i.bf, 1
  store i32 %i.bg, ptr %i.au, align 8, !tbaa !55
...
Cof_ManTfiSize.exit:                              ; preds = %bb.o, %Cof_ManSuppSize.exit
  ...
  %i.bp = load i32, ptr %i.au, align 8, !tbaa !55
  %i.bq = add nsw i32 %i.bp, 1
  store i32 %i.bq, ptr %i.au, align 8, !tbaa !55
...
bb.a:
  ...
  store i32 0, ptr %i.c, align 4, !tbaa !60
  store i32 %spec.store.select.i.i, ptr %i.a, align 8, !tbaa !61
...
Vec_PtrAlloc.exit.i:                              ; preds = %bb.b, %bb.a
  ...
  store ptr %i.g, ptr %i.h, align 8, !tbaa !62
...
.lr.ph.i:                                         ; preds = %Vec_PtrAlloc.exit.i, %bb.f
  ...
  %.val.i = load ptr, ptr %i.i, align 8, !tbaa !42 ; 2 uses
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  %.pre.i = load i32, ptr %i.j, align 8, !tbaa !41
  br label %bb.f
...
bb.f:                                             ; preds = %bb.e, %bb.d
  ...
  br i1 %i.x, label %.lr.ph.i, label %Cof_ManCollectHighFanout.exit, !llvm.loop !1

Cof_ManCollectHighFanout.exit:                    ; preds = %.lr.ph.i, %bb.f
  %.val.pre = load i32, ptr %i.c, align 4, !tbaa !60 ; 2 uses
  %.pre.pre = load ptr, ptr %i.h, align 8, !tbaa !62 ; 3 uses
...
bb.g:                                             ; preds = %.lr.ph, %bb.g
  ...
  br i1 %exitcond.not, label %.critedge.thread, label %bb.g, !llvm.loop !85
