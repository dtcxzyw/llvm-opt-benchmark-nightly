...
.lr.ph71:                                         ; preds = %.lr.ph78.split, %._crit_edge72
  ...
  %.lcssa80 = phi i64 [ 1, %.lr.ph78.split ], [ %indvars.iv.next90.a, %._crit_edge72 ]
...
bb.k:                                             ; preds = %.lr.ph71, %._crit_edge
  ...
  %indvars.iv89.a = phi i64 [ %.lcssa80, %.lr.ph71 ], [ %indvars.iv.next90.a, %._crit_edge ] ; 5 uses
...
Vec_WecPushLevel.exit59:                          ; preds = %bb.k, %Vec_WecGrow.exit.i58, %bb.s
  ...
  %indvars.iv.next90.a = add nsw i64 %indvars.iv89.a, 1 ; 4 uses
