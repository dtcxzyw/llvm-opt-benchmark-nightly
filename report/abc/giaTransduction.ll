...
.lr.ph156.split:                                  ; preds = %.lr.ph156.split, %.lr.ph156.split.preheader.new
  ...
  %i.dm = shl nuw i32 %indvars.iv165.tr, 1
  ...
  %i.dt = shl nuw i32 %indvars.iv165.tr.1, 1
...
.lr.ph156.split:                                  ; preds = %.lr.ph156.split, %.lr.ph156.split.preheader.new
  ...
  %indvars.iv165.tr = trunc nuw nsw i64 %indvars.iv165 to i32
  %i.do = shl nuw i32 %indvars.iv165.tr, 1
  ...
  %indvars.iv165.tr.1 = trunc nuw nsw i64 %indvars.iv.next166 to i32
  %i.du = shl nuw i32 %indvars.iv165.tr.1, 1
  %i.dv = add nuw nsw i32 %i.du, 2
  ...
  %i.ea = shl nuw i32 %indvars.iv165.tr.2, 1
  ...
  %i.eg = shl nuw i32 %indvars.iv165.tr.3, 1
  %i.eh = add nuw i32 %i.eg, 2
