...
bb.k:                                             ; preds = %.preheader.preheader.i, %bb.j
  ...
  br i1 %exitcond.not.i, label %If_Dec6ComposeLut4.exit.preheader, label %bb.j, !llvm.loop !16
...
bb.u:                                             ; preds = %.preheader.preheader.i24, %bb.t
  ...
  br i1 %exitcond.not.i32, label %If_Dec6ComposeLut4.exit33, label %bb.t, !llvm.loop !16
...
.preheader62:
  ...
  store <4 x i32> <i32 0, i32 1, i32 2, i32 3>, ptr %i.h, align 16, !tbaa !9
  %i.k = getelementptr inbounds nuw i8, ptr %i.g, i64 12
  store <4 x i32> <i32 0, i32 1, i32 2, i32 3>, ptr %i.g, align 16, !tbaa !9
  %i.l = getelementptr inbounds nuw i8, ptr %i.h, i64 16
  store i32 4, ptr %i.l, align 16, !tbaa !9
  %i.m = getelementptr inbounds nuw i8, ptr %i.g, i64 16 ; 2 uses
  store i32 4, ptr %i.m, align 16, !tbaa !9
  %i.n = getelementptr inbounds nuw i8, ptr %i.h, i64 20
  store i32 5, ptr %i.n, align 4, !tbaa !9
  %i.o = getelementptr inbounds nuw i8, ptr %i.g, i64 20 ; 2 uses
  store i32 5, ptr %i.o, align 4, !tbaa !9
...
.loopexit61:                                      ; preds = %.loopexit, %bb.a
  ...
  br i1 %exitcond104.not, label %.loopexit63, label %bb.a, !llvm.loop !18
...
.lr.ph.i:                                         ; preds = %bb.b, %.lr.ph.i
  ...
  store i32 %i.bd, ptr %i.bb, align 4, !tbaa !9
  store i32 %i.as, ptr %i.ay, align 4, !tbaa !9
  store i32 %i.az, ptr %i.ar, align 4, !tbaa !9
  %i.be = load i32, ptr %i.x, align 4, !tbaa !9   ; 2 uses
  %.not.i = icmp eq i32 %i.be, 0
  br i1 %.not.i, label %If_Dec6MoveTo.exit, label %.lr.ph.i, !llvm.loop !0
...
.lr.ph.i51:                                       ; preds = %If_Dec6MoveTo.exit, %.lr.ph.i51
  ...
  store i32 %i.ce, ptr %i.cc, align 4, !tbaa !9
  ...
  store i32 %i.cl, ptr %i.cj, align 4, !tbaa !9
  store i32 %i.ca, ptr %i.cg, align 4, !tbaa !9
  store i32 %i.ch, ptr %i.bz, align 4, !tbaa !9
  %i.cm = load i32, ptr %i.bf, align 4, !tbaa !9  ; 2 uses
  %.not.i53 = icmp eq i32 %i.cm, 1
  br i1 %.not.i53, label %If_Dec6MoveTo.exit55, label %.lr.ph.i51, !llvm.loop !0
