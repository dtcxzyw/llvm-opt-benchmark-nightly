...
bb.b:                                             ; preds = %bb.c, %bb.a
  ...
  %6 = phi <2 x i64> [ zeroinitializer, %bb.a ], [ %27, %bb.c ]
  %7 = phi <2 x i64> [ zeroinitializer, %bb.a ], [ %28, %bb.c ] ; 2 uses
...
.preheader.preheader.i:                           ; preds = %bb.b
  ...
  %i.v = sext i32 %sext64 to i64
  %8 = lshr i32 %.02328.i, 2
  %9 = and i32 %8, 1
  %sext65 = add nsw i32 %9, -1
  %10 = sext i32 %sext65 to i64
  %i.w = lshr i32 %.02328.i, 3
  %i.x = and i32 %i.w, 1
  %sext65.a = add nsw i32 %i.x, -1
  %i.y = sext i32 %sext65.a to i64
  %11 = insertelement <2 x i64> poison, i64 %i.s, i64 0
  %12 = shufflevector <2 x i64> %11, <2 x i64> poison, <2 x i32> zeroinitializer
  %13 = xor <2 x i64> %2, %12
  %14 = insertelement <2 x i64> poison, i64 %i.v, i64 0
  %15 = shufflevector <2 x i64> %14, <2 x i64> poison, <2 x i32> zeroinitializer
  %16 = xor <2 x i64> %3, %15
  %17 = and <2 x i64> %16, %13
  %18 = insertelement <2 x i64> poison, i64 %10, i64 0
  %19 = shufflevector <2 x i64> %18, <2 x i64> poison, <2 x i32> zeroinitializer
  %20 = xor <2 x i64> %4, %19
  %21 = and <2 x i64> %17, %20
  %22 = insertelement <2 x i64> poison, i64 %i.y, i64 0
  %23 = shufflevector <2 x i64> %22, <2 x i64> poison, <2 x i32> zeroinitializer
  %24 = xor <2 x i64> %5, %23
  %25 = and <2 x i64> %21, %24
  %26 = or <2 x i64> %25, %7                      ; 2 uses
  br label %bb.c

bb.c:                                             ; preds = %.preheader.preheader.i, %bb.b
  %27 = phi <2 x i64> [ %6, %bb.b ], [ %26, %.preheader.preheader.i ] ; 3 uses
  %28 = phi <2 x i64> [ %7, %bb.b ], [ %26, %.preheader.preheader.i ]
...
If_Dec7ComposeLut4.exit:                          ; preds = %bb.c
  ...
  store i64 %29, ptr %i.a, align 16
  %i.aa = lshr i64 %1, 48
  %i.ab = and i64 %i.aa, 7
  %i.ac = getelementptr inbounds nuw [16 x i8], ptr @Truth7, i64 %i.ab
  %i.ad = lshr i64 %1, 52
  %i.ae = and i64 %i.ad, 7
  %i.af = getelementptr inbounds nuw [16 x i8], ptr @Truth7, i64 %i.ae
  %i.ag = lshr i64 %1, 56
  %i.ah = and i64 %i.ag, 7
  %i.ai = getelementptr inbounds nuw [16 x i8], ptr @Truth7, i64 %i.ah
  %30 = load <2 x i64>, ptr %i.ac, align 16, !tbaa !12
  %31 = load <2 x i64>, ptr %i.af, align 16, !tbaa !12
  %32 = load <2 x i64>, ptr %i.ai, align 16, !tbaa !12
  %i.aj = lshr i64 %1, 32
...
bb.d:                                             ; preds = %bb.e, %If_Dec7ComposeLut4.exit
  ...
  %33 = phi <2 x i64> [ zeroinitializer, %If_Dec7ComposeLut4.exit ], [ %54, %bb.e ]
  %34 = phi <2 x i64> [ zeroinitializer, %If_Dec7ComposeLut4.exit ], [ %55, %bb.e ] ; 2 uses
...
.preheader.preheader.i25:                         ; preds = %bb.d
  ...
  %i.ap = sext i32 %sext67 to i64
  %i.aq = lshr i32 %.02328.i23, 1
  %i.ar = and i32 %i.aq, 1
  %sext68 = add nsw i32 %i.ar, -1
  %i.as = sext i32 %sext68 to i64
  %35 = lshr i32 %.02328.i23, 2
  %36 = and i32 %35, 1
  %sext69 = add nsw i32 %36, -1
  %37 = sext i32 %sext69 to i64
  %i.at = lshr i32 %.02328.i23, 3
  %i.au = and i32 %i.at, 1
  %sext69.a = add nsw i32 %i.au, -1
  %i.av = sext i32 %sext69.a to i64
  %38 = insertelement <2 x i64> poison, i64 %i.ap, i64 0
  %39 = shufflevector <2 x i64> %38, <2 x i64> poison, <2 x i32> zeroinitializer
  %40 = xor <2 x i64> %30, %39
  %41 = insertelement <2 x i64> poison, i64 %i.as, i64 0
  %42 = shufflevector <2 x i64> %41, <2 x i64> poison, <2 x i32> zeroinitializer
  %43 = xor <2 x i64> %31, %42
  %44 = and <2 x i64> %43, %40
  %45 = insertelement <2 x i64> poison, i64 %37, i64 0
  %46 = shufflevector <2 x i64> %45, <2 x i64> poison, <2 x i32> zeroinitializer
  %47 = xor <2 x i64> %32, %46
  %48 = and <2 x i64> %44, %47
  %49 = insertelement <2 x i64> poison, i64 %i.av, i64 0
  %50 = shufflevector <2 x i64> %49, <2 x i64> poison, <2 x i32> zeroinitializer
  %51 = xor <2 x i64> %27, %50
  %52 = and <2 x i64> %48, %51
  %53 = or <2 x i64> %52, %34                     ; 2 uses
  br label %bb.e

bb.e:                                             ; preds = %.preheader.preheader.i25, %bb.d
  %54 = phi <2 x i64> [ %33, %bb.d ], [ %53, %.preheader.preheader.i25 ] ; 4 uses
  %55 = phi <2 x i64> [ %34, %bb.d ], [ %53, %.preheader.preheader.i25 ]
...
If_Dec7ComposeLut4.exit38:                        ; preds = %bb.e
  store <2 x i64> %54, ptr %i.a, align 16
  %56 = load i64, ptr %0, align 8, !tbaa !12
  %57 = extractelement <2 x i64> %54, i64 0
  %.not = icmp eq i64 %57, %56
  br i1 %.not, label %bb.f, label %bb.g

bb.f:                                             ; preds = %If_Dec7ComposeLut4.exit38
  %i.ax = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.ay = load i64, ptr %i.ax, align 8, !tbaa !12
  %58 = extractelement <2 x i64> %54, i64 1
  %.not21 = icmp eq i64 %58, %i.ay
