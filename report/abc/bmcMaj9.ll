...
.lr.ph53.i:                                       ; preds = %Abc_TtReadHexDigit.exit.i, %.lr.ph53.preheader.i
  ...
  %i.ep = load i8, ptr %i.eo, align 1, !tbaa !30  ; 4 uses
...
bb.x:                                             ; preds = %._crit_edge54.i
  %.pre = load i64, ptr %i.ar, align 8, !tbaa !108 ; 4 uses
...
Abc_TtReadHex.exit:                               ; preds = %.sink.split.i, %._crit_edge54.i, %bb.o
  ...
  %i.ft = load i32, ptr %i.fs, align 4, !tbaa !103
...
bb.aa:                                            ; preds = %bb.z, %bb.y, %Abc_TtReadHex.exit
  ...
  store i32 %i.gw, ptr %i.gx, align 4, !tbaa !113
  %i.gy = getelementptr inbounds nuw i8, ptr %i.fw, i64 64 ; 4 uses
  store ptr %i.ar, ptr %i.gy, align 8, !tbaa !114
  ...
  store i32 %spec.store.select.i.i.i, ptr %i.hc, align 8, !tbaa !116
...
Vec_WrdStart.exit.i:                              ; preds = %bb.ab, %bb.aa
  ...
  store ptr %i.hh, ptr %i.hj, align 8, !tbaa !117
  store i32 %i.hb, ptr %i.hi, align 4, !tbaa !118
...
Exa9_ManAlloc.exit:                               ; preds = %Vec_WrdStart.exit.i, %bb.ac
  ...
  store i64 0, ptr %i.ht, align 8, !tbaa !41
  %i.hu = load i32, ptr %i.n, align 4, !tbaa !100
...
bb.ad:                                            ; preds = %Exa9_ManAlloc.exit
  ...
  %i.hw = load i32, ptr %i.hv, align 8, !tbaa !23
  %.not177 = icmp eq i32 %i.hw, 0
  br i1 %.not177, label %bb.ae, label %bb.ao

bb.ae:                                            ; preds = %bb.ad
  %i.hx = load i32, ptr %i.gb, align 4, !tbaa !38 ; 14 uses
  %i.hy = shl nsw i32 %i.hx, 2
  %i.hz = load i32, ptr %i.gd, align 8, !tbaa !39 ; 5 uses
  %i.ia = or disjoint i32 %i.hy, 2
  %i.ib = mul i32 %i.ia, %i.hz                    ; 5 uses
  %i.ic = load ptr, ptr %i.fw, align 8, !tbaa !36
  %i.id = getelementptr inbounds nuw i8, ptr %i.ic, i64 104
  %i.ie = load i32, ptr %i.id, align 8, !tbaa !24
...
.lr.ph.i205:                                      ; preds = %bb.ae
  %i.ig = load i32, ptr %i.fy, align 8, !tbaa !37 ; 6 uses
...
vector.body701:                                   ; preds = %vector.body701, %vector.ph697
  ...
  br i1 %i.iw, label %middle.block710, label %vector.body701, !llvm.loop !57
...
vector.body721:                                   ; preds = %vector.body721, %vector.ph717
  ...
  br i1 %i.jh, label %middle.block729, label %vector.body721, !llvm.loop !58
...
vector.body740:                                   ; preds = %vector.body740, %vector.ph736
  ...
  br i1 %i.js, label %middle.block750, label %vector.body740, !llvm.loop !59
