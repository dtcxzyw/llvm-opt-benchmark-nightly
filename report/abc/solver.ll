...
bb.a:
  ...
  %i.c = load i32, ptr %i.a, align 8, !tbaa !71   ; 2 uses
  %i.d = load ptr, ptr %i.b, align 8, !tbaa !52   ; 2 uses
  %i.e = getelementptr i8, ptr %i.d, i64 4
  %.val136215 = load i32, ptr %i.e, align 4, !tbaa !18
...
bb.b:                                             ; preds = %.lr.ph219, %._crit_edge212
  ...
  store i32 %i.r, ptr %i.a, align 8, !tbaa !71
  %i.s = getelementptr i8, ptr %i.p, i64 8
  %.val138 = load ptr, ptr %i.s, align 8, !tbaa !40
  ...
  %i.x = load ptr, ptr %i.g, align 8, !tbaa !72   ; 2 uses
  %i.y = getelementptr i8, ptr %i.x, i64 8
  %.val143 = load ptr, ptr %i.y, align 8, !tbaa !75
  ...
  %.val148 = load ptr, ptr %i.ab, align 8, !tbaa !78 ; 3 uses
  %i.ac = getelementptr inbounds nuw i8, ptr %i.aa, i64 8
  %i.ad = load i32, ptr %i.ac, align 8, !tbaa !79 ; 2 uses
...
.lr.ph:                                           ; preds = %bb.b, %bb.j
  ...
  %.val150 = load ptr, ptr %i.h, align 8, !tbaa !80 ; 2 uses
...
bb.c:                                             ; preds = %.lr.ph
  ...
  %.val152.val = load ptr, ptr %i.ah, align 8, !tbaa !56
...
bb.d:                                             ; preds = %.lr.ph._crit_edge, %bb.c
  ...
  %.val153 = load ptr, ptr %i.i, align 8, !tbaa !53
  %i.al = getelementptr i8, ptr %.val153, i64 8
  %.val153.val = load ptr, ptr %i.al, align 8, !tbaa !56
  %i.am = getelementptr inbounds nuw i8, ptr %.val153.val, i64 %.pre-phi244 ; 2 uses
  %i.an = load i8, ptr %i.am, align 1, !tbaa !47  ; 2 uses
  %i.ao = icmp eq i8 %i.an, 3
  br i1 %i.ao, label %bb.e, label %bb.i

bb.e:                                             ; preds = %bb.d
  %i.ap = load i32, ptr %.0113191, align 4, !tbaa !83
  %i.aq = trunc i32 %.pre to i8
  %i.ar = and i8 %i.aq, 1                         ; 2 uses
  store i8 %i.ar, ptr %i.am, align 1, !tbaa !47
  %i.as = load ptr, ptr %i.j, align 8, !tbaa !84
  ...
  store i8 %i.ar, ptr %i.au, align 1, !tbaa !47
  %i.av = load ptr, ptr %i.k, align 8, !tbaa !45
  %.val15.i = load ptr, ptr %i.l, align 8, !tbaa !51
  %i.aw = getelementptr i8, ptr %.val15.i, i64 4
  %.val15.val.i = load i32, ptr %i.aw, align 4, !tbaa !18
  %i.ax = getelementptr i8, ptr %i.av, i64 8
  %.val14.i = load ptr, ptr %i.ax, align 8, !tbaa !40
  %i.ay = getelementptr inbounds nuw [4 x i8], ptr %.val14.i, i64 %.pre-phi244
  store i32 %.val15.val.i, ptr %i.ay, align 4, !tbaa !43
  %i.az = load ptr, ptr %i.m, align 8, !tbaa !57
  %i.ba = getelementptr i8, ptr %i.az, i64 8
  %.val.i = load ptr, ptr %i.ba, align 8, !tbaa !40
  %i.bb = getelementptr inbounds nuw [4 x i8], ptr %.val.i, i64 %.pre-phi244
  store i32 %i.ap, ptr %i.bb, align 4, !tbaa !43
  %i.bc = load ptr, ptr %i.b, align 8, !tbaa !52  ; 6 uses
  %i.bd = getelementptr inbounds nuw i8, ptr %i.bc, i64 4 ; 4 uses
  %i.be = load i32, ptr %i.bd, align 4, !tbaa !18 ; 6 uses
  %i.bf = load i32, ptr %i.bc, align 8, !tbaa !42
...
vec_uint_reserve.exit.i.i:                        ; preds = %bb.f
  ...
  store ptr %i.bk, ptr %i.bi, align 8, !tbaa !40
...
bb.h:                                             ; preds = %bb.g
  ...
  store ptr %i.bq, ptr %i.bm, align 8, !tbaa !40
  br label %vec_uint_reserve.exit10.sink.split.i.i
...
vec_uint_reserve.exit10.sink.split.i.i:           ; preds = %bb.h, %vec_uint_reserve.exit.i.i
  ...
  store i32 %.sink.i.i, ptr %i.bc, align 8, !tbaa !42
  %.pre.i = load i32, ptr %i.bd, align 4, !tbaa !18
...
solver_enqueue.exit:                              ; preds = %bb.e, %bb.g, %vec_uint_reserve.exit10.sink.split.i.i
  ...
  store i32 %.pre, ptr %i.bv, align 4, !tbaa !43
  %i.bw = load i32, ptr %i.bd, align 4, !tbaa !18
  %i.bx = add i32 %i.bw, 1
  store i32 %i.bx, ptr %i.bd, align 4, !tbaa !18
  %.pre235 = load ptr, ptr %i.g, align 8, !tbaa !72
  br label %bb.j
...
.thread:                                          ; preds = %bb.i
  %i.cc = load i32, ptr %.0113191, align 4, !tbaa !83
  br label %bb.ae
...
bb.j:                                             ; preds = %solver_enqueue.exit, %bb.i, %bb.c
  ...
  br i1 %.not135, label %.lr.ph, label %._crit_edge, !llvm.loop !95
...
._crit_edge:                                      ; preds = %bb.j, %bb.b
  ...
  %.val159 = load i32, ptr %i.cn, align 4, !tbaa !85
...
bb.k:                                             ; preds = %.lr.ph211, %.loopexit
  ...
  %.val149 = load ptr, ptr %i.h, align 8, !tbaa !80 ; 2 uses
...
bb.l:                                             ; preds = %bb.k
  ...
  %.val151.val = load ptr, ptr %i.cv, align 8, !tbaa !56
...
bb.n:                                             ; preds = %._crit_edge236, %bb.l
  ...
  %.val157 = load ptr, ptr %i.i, align 8, !tbaa !53
  %i.dc = getelementptr i8, ptr %.val157, i64 8
  %.val157.val = load ptr, ptr %i.dc, align 8, !tbaa !56 ; 4 uses
...
clause_fetch.exit:                                ; preds = %bb.n
  %i.dk = load i32, ptr %.1114208, align 4, !tbaa !83 ; 3 uses
  %.val137 = load ptr, ptr %i.n, align 8, !tbaa !32
  ...
  %i.dq = load i32, ptr %i.dp, align 4, !tbaa !43 ; 2 uses
...
bb.p:                                             ; preds = %clause_fetch.exit
  ...
  store i32 %i.dt, ptr %i.dp, align 4, !tbaa !43
  store i32 %i.cr, ptr %i.ds, align 4, !tbaa !43
  %.pre239 = load i32, ptr %.1114208, align 4, !tbaa !83
...
bb.s:                                             ; preds = %bb.r
  ...
  store i32 %i.dw, ptr %.0110209, align 4, !tbaa !43
  %.sroa.6.0..sroa_idx = getelementptr inbounds nuw i8, ptr %.0110209, i64 4
  store i32 %i.dv, ptr %.sroa.6.0..sroa_idx, align 4, !tbaa !43
  br label %.loopexit

bb.t:                                             ; preds = %bb.r, %bb.q
  %i.ef = getelementptr inbounds nuw i8, ptr %i.do, i64 4
  %i.eg = load i32, ptr %i.ef, align 4, !tbaa !39 ; 2 uses
...
bb.u:                                             ; preds = %.lr.ph198
  ...
  br i1 %exitcond.not, label %._crit_edge199, label %.lr.ph198, !llvm.loop !97
...
.lr.ph198:                                        ; preds = %.lr.ph198.preheader, %bb.u
  ...
  %i.ej = load i32, ptr %i.ei, align 4, !tbaa !43 ; 3 uses
...
bb.v:                                             ; preds = %.lr.ph198
  ...
  store i32 %i.ej, ptr %i.es, align 4, !tbaa !43
  store i32 %i.cr, ptr %i.er, align 4, !tbaa !43
  %i.et = load ptr, ptr %i.g, align 8, !tbaa !72
  %i.eu = load i32, ptr %i.es, align 4, !tbaa !43
  %i.ev = xor i32 %i.eu, 1
  %i.ew = getelementptr i8, ptr %i.et, i64 8
  %.val139 = load ptr, ptr %i.ew, align 8, !tbaa !75
  ...
  %i.fa = load i32, ptr %i.ez, align 4, !tbaa !85 ; 3 uses
  %i.fb = load i32, ptr %i.ey, align 8, !tbaa !86
...
bb.x:                                             ; preds = %bb.w
  %i.fn = load i32, ptr %i.ey, align 8, !tbaa !86
  ...
  %i.ft = load ptr, ptr @stdout, align 8, !tbaa !88
  %i.fu = tail call i32 @fflush(ptr noundef %i.ft) ; 0 uses
  br label %watch_list_push.exit

bb.y:                                             ; preds = %bb.w
  store ptr %i.fl, ptr %i.fh, align 8, !tbaa !78
  store i32 %i.fg, ptr %i.ey, align 8, !tbaa !86
  br label %watch_list_push.exit

watch_list_push.exit:                             ; preds = %bb.v, %bb.x, %bb.y
  %i.fv = getelementptr inbounds nuw i8, ptr %i.ey, i64 16
  %i.fw = load ptr, ptr %i.fv, align 8, !tbaa !78
  %i.fx = load i32, ptr %i.ez, align 4, !tbaa !85 ; 2 uses
  %i.fy = add i32 %i.fx, 1
  store i32 %i.fy, ptr %i.ez, align 4, !tbaa !85
...
._crit_edge199:                                   ; preds = %bb.u, %bb.t
  ...
  store i32 %i.dv, ptr %.sroa.6.0..sroa_idx7, align 4, !tbaa !43
  %i.gc = load i32, ptr %i.dp, align 4, !tbaa !43 ; 3 uses
  ...
  %i.gl = load i32, ptr %.1114208, align 4, !tbaa !83 ; 4 uses
  br i1 %i.gk, label %bb.z, label %bb.aa

bb.z:                                             ; preds = %._crit_edge199
  %i.gm = load ptr, ptr %i.b, align 8, !tbaa !52
  %i.gn = getelementptr i8, ptr %i.gm, i64 4
  %.val = load i32, ptr %i.gn, align 4, !tbaa !18
  store i32 %.val, ptr %i.a, align 8, !tbaa !71
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.gz, label %middle.block, label %vector.body, !llvm.loop !98
...
.lr.ph204:                                        ; preds = %.lr.ph204.preheader290, %.lr.ph204
  ...
  br i1 %i.hc, label %.lr.ph204, label %.loopexit, !llvm.loop !99

bb.aa:                                            ; preds = %._crit_edge199
  store i8 %i.ge, ptr %i.gh, align 1, !tbaa !47
  %i.hd = load ptr, ptr %i.j, align 8, !tbaa !84
  %i.he = getelementptr i8, ptr %i.hd, i64 8
  %.val16.i161 = load ptr, ptr %i.he, align 8, !tbaa !56
  %i.hf = getelementptr inbounds nuw i8, ptr %.val16.i161, i64 %i.gg
  store i8 %i.ge, ptr %i.hf, align 1, !tbaa !47
  %i.hg = load ptr, ptr %i.k, align 8, !tbaa !45
  %.val15.i162 = load ptr, ptr %i.l, align 8, !tbaa !51
  %i.hh = getelementptr i8, ptr %.val15.i162, i64 4
  %.val15.val.i163 = load i32, ptr %i.hh, align 4, !tbaa !18
  %i.hi = getelementptr i8, ptr %i.hg, i64 8
  %.val14.i164 = load ptr, ptr %i.hi, align 8, !tbaa !40
  %i.hj = getelementptr inbounds nuw [4 x i8], ptr %.val14.i164, i64 %i.gg
  store i32 %.val15.val.i163, ptr %i.hj, align 4, !tbaa !43
  %i.hk = load ptr, ptr %i.m, align 8, !tbaa !57
  %i.hl = getelementptr i8, ptr %i.hk, i64 8
  %.val.i165 = load ptr, ptr %i.hl, align 8, !tbaa !40
  %i.hm = getelementptr inbounds nuw [4 x i8], ptr %.val.i165, i64 %i.gg
  store i32 %i.gl, ptr %i.hm, align 4, !tbaa !43
  %i.hn = load ptr, ptr %i.b, align 8, !tbaa !52  ; 6 uses
  %i.ho = getelementptr inbounds nuw i8, ptr %i.hn, i64 4 ; 4 uses
  %i.hp = load i32, ptr %i.ho, align 4, !tbaa !18 ; 6 uses
  %i.hq = load i32, ptr %i.hn, align 8, !tbaa !42
...
vec_uint_reserve.exit.i.i170:                     ; preds = %bb.ab
  ...
  store ptr %i.hv, ptr %i.ht, align 8, !tbaa !40
...
vec_uint_reserve.exit10.sink.split.i.i167:        ; preds = %bb.ad, %vec_uint_reserve.exit.i.i170
  ...
  store i32 %.sink.i.i168, ptr %i.hn, align 8, !tbaa !42
  %.pre.i169 = load i32, ptr %i.ho, align 4, !tbaa !18
...
solver_enqueue.exit171:                           ; preds = %bb.aa, %bb.ac, %vec_uint_reserve.exit10.sink.split.i.i167
  ...
  store i32 %i.gc, ptr %i.ig, align 4, !tbaa !43
  %i.ih = load i32, ptr %i.ho, align 4, !tbaa !18
  %i.ii = add i32 %i.ih, 1
  store i32 %i.ii, ptr %i.ho, align 4, !tbaa !18
  br label %.loopexit
...
._crit_edge212.loopexit:                          ; preds = %.loopexit
  %.val145.pre = load ptr, ptr %i.cm, align 8, !tbaa !78
...
._crit_edge212:                                   ; preds = %._crit_edge212.loopexit, %._crit_edge
  ...
  %i.io = load i64, ptr %i.o, align 8, !tbaa !101
  %i.ip = add nsw i64 %i.in, %i.io
  store i64 %i.ip, ptr %i.o, align 8, !tbaa !101
  %i.iq = lshr exact i64 %i.im, 3
  %i.ir = trunc i64 %i.iq to i32
  store i32 %i.ir, ptr %i.cn, align 4, !tbaa !85
  %i.is = load i32, ptr %i.a, align 8, !tbaa !71  ; 2 uses
  %i.it = load ptr, ptr %i.b, align 8, !tbaa !52  ; 2 uses
  %i.iu = getelementptr i8, ptr %i.it, i64 4
  %.val136 = load i32, ptr %i.iu, align 4, !tbaa !18
  %i.iv = icmp ult i32 %i.is, %.val136
  br i1 %i.iv, label %bb.b, label %._crit_edge220.loopexit, !llvm.loop !100
...
._crit_edge220:                                   ; preds = %._crit_edge220.loopexit, %bb.a
  ...
  %i.iy = load <2 x i64>, ptr %i.ix, align 8, !tbaa !70
  ...
  store <2 x i64> %i.jb, ptr %i.ix, align 8, !tbaa !70
  %i.jc = getelementptr inbounds nuw i8, ptr %0, i64 144 ; 2 uses
  %i.jd = load i64, ptr %i.jc, align 8, !tbaa !102
  %i.je = sub nsw i64 %i.jd, %.0119.lcssa
  store i64 %i.je, ptr %i.jc, align 8, !tbaa !102
  br label %bb.ae
...
bb.a:
  ...
  %i.c = add i32 %i.b, 1
  store i32 %i.c, ptr %i.a, align 8, !tbaa !133
