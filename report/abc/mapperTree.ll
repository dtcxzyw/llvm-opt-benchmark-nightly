...
bb.b:                                             ; preds = %.lr.ph71, %._crit_edge68
  ...
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !31   ; 10 uses
...
._crit_edge:                                      ; preds = %bb.c, %bb.b
  ...
  %1 = load <2 x float>, ptr %i.as, align 8, !tbaa !46
  %2 = fpext <2 x float> %1 to <2 x double>       ; 2 uses
  %3 = extractelement <2 x double> %2, i64 0
  %4 = extractelement <2 x double> %2, i64 1
  %i.at = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.28, double noundef %3, double noundef %4) ; 0 uses
