...
Abc_Clock.exit110:                                ; preds = %Abc_Clock.exit108, %bb.ak
  %.0.i109 = phi i64 [ %i.tc, %bb.ak ], [ -1, %Abc_Clock.exit108 ]
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #26
  br label %bb.al

bb.al:                                            ; preds = %bb.ah, %Abc_Clock.exit110, %bb.ag
  %.2 = phi i64 [ %.0.i109, %Abc_Clock.exit110 ], [ %.062, %bb.ah ], [ %.062, %bb.ag ]
  %i.td = icmp eq i32 %i.rv, -1
  br i1 %i.td, label %.loopexit127, label %bb.am

bb.am:                                            ; preds = %bb.al, %bb.ab
  %.079.i119 = phi i32 [ -1, %bb.ab ], [ %.079.i, %bb.al ]
  %.164 = phi i32 [ %i.qi, %bb.ab ], [ %.063, %bb.al ]
  %.3 = phi i64 [ %.1, %bb.ab ], [ %.2, %bb.al ]
  %i.te = add nuw nsw i32 %.073, 1
  br label %bb.f

.loopexit127:                                     ; preds = %bb.ab, %bb.al, %bb.w, %bb.g, %.thread.thread, %bb.af
  %.172 = phi i32 [ %.071, %.thread.thread ], [ %.079.i, %bb.af ], [ %.071, %bb.g ], [ %.079.i, %bb.al ], [ -1, %bb.w ], [ -1, %bb.ab ] ; 2 uses
  %.265 = phi i32 [ %.063, %.thread.thread ], [ %.063, %bb.af ], [ %.063, %bb.g ], [ %.063, %bb.al ], [ %.063, %bb.w ], [ %i.qi, %bb.ab ]
  %i.tf = load i32, ptr %i.bw, align 4, !tbaa !236
  %.not92 = icmp eq i32 %i.tf, 0
  br i1 %.not92, label %bb.ap, label %bb.an

bb.an:                                            ; preds = %.loopexit127
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #26
  %i.tg = call i32 @clock_gettime(i32 noundef 1, ptr noundef nonnull %2) #26
  %i.th = icmp slt i32 %i.tg, 0
  br i1 %i.th, label %Abc_Clock.exit112, label %bb.ao
...
Abc_Clock.exit112:                                ; preds = %bb.an, %bb.ao
  %.0.i111 = phi i64 [ %i.tn, %bb.ao ], [ -1, %bb.an ]
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #26
  %i.to = sub nsw i64 %.0.i111, %.0.i
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a)
  store i32 %.172, ptr %i.a, align 4, !tbaa !34
  %i.tp = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.56, i32 noundef %.073) ; 0 uses
  ...
  %i.tx = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.59, i32 noundef %.167) ; 0 uses
...
bb.ap:                                            ; preds = %Abc_Clock.exit112, %.loopexit127
  %i.ud = load i32, ptr %i.bz, align 8, !tbaa !235
  %.not93 = icmp eq i32 %i.ud, 0
  br i1 %.not93, label %bb.ar, label %bb.aq

bb.aq:                                            ; preds = %bb.ap
  %i.ue = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.27, i32 noundef %.265) ; 0 uses
  br label %bb.au

bb.ar:                                            ; preds = %bb.ap
  %i.uf = icmp eq i32 %.172, -1
  br i1 %i.uf, label %bb.as, label %bb.at

bb.as:                                            ; preds = %bb.ar
  call fastcc void @Zyx_ManPrintSolution(ptr noundef nonnull %i.aw, i32 noundef %.070, i32 noundef 1)
  br label %bb.au
...
bb.au:                                            ; preds = %bb.as, %bb.at, %bb.aq
  ...
  br i1 %i.um, label %Abc_Clock.exit114, label %bb.av
...
Abc_Clock.exit114:                                ; preds = %bb.au, %bb.av
  %.0.i113 = phi i64 [ %i.us, %bb.av ], [ -1, %bb.au ]
  call void @llvm.lifetime.end.p0(ptr nonnull %1) #26
  %i.ut = sub nsw i64 %.0.i113, %.0.i
