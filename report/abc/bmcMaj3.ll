...
bb.b:                                             ; preds = %bb.a
  %i.h = load i64, ptr %8, align 8, !tbaa !42
...
bb.c:                                             ; preds = %Abc_Clock.exit
  %i.p = load i64, ptr %7, align 8, !tbaa !42
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %i.ai, align 16, !tbaa !26
  %wide.load240 = load <2 x i64>, ptr %i.aj, align 16, !tbaa !26
  %i.ak = xor <2 x i64> %wide.load, splat (i64 -1)
  %i.al = xor <2 x i64> %wide.load240, splat (i64 -1)
  store <2 x i64> %i.ak, ptr %i.ai, align 16, !tbaa !26
  store <2 x i64> %i.al, ptr %i.aj, align 16, !tbaa !26
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.am = icmp eq i64 %index.next, %n.vec
  br i1 %i.am, label %Abc_TtNot.exit, label %vector.body, !llvm.loop !202

.lr.ph.i:                                         ; preds = %.lr.ph.preheader.i
  %i.an = load i64, ptr %i.e, align 16, !tbaa !26
  %i.ao = xor i64 %i.an, -1
  store i64 %i.ao, ptr %i.e, align 16, !tbaa !26
...
.lr.ph.i.2:                                       ; preds = %.lr.ph.i.1
  ...
  %i.at = load i64, ptr %i.as, align 16, !tbaa !26
  %i.au = xor i64 %i.at, -1
  store i64 %i.au, ptr %i.as, align 16, !tbaa !26
...
Abc_TtNot.exit:                                   ; preds = %vector.body, %.lr.ph.i, %.lr.ph.i.1, %.lr.ph.i.2, %bb.e, %bb.d, %Abc_Clock.exit97
  ...
  %i.ax = load ptr, ptr %i.aw, align 8, !tbaa !52 ; 4 uses
...
bb.g:                                             ; preds = %bb.i, %bb.f
  ...
  %i.cc = load ptr, ptr %i.bh, align 8, !tbaa !50
...
.thread.thread122:                                ; preds = %bb.g, %bb.h
  ...
  %i.cg = load ptr, ptr %i.aw, align 8, !tbaa !52 ; 2 uses
  %i.ch = load i32, ptr %i.cg, align 8, !tbaa !60 ; 2 uses
  %i.ci = load i32, ptr %i.bi, align 8, !tbaa !56 ; 2 uses
...
bb.j:                                             ; preds = %Abc_TtMaj.exit.i, %.lr.ph158.i
  ...
  store i32 0, ptr %i.bj, align 8, !tbaa !30
  %i.cp = icmp sgt i64 %indvars.iv181.i, 0
  %.pre.i = load ptr, ptr %i.aw, align 8, !tbaa !52 ; 2 uses
...
bb.k:                                             ; preds = %bb.k, %.lr.ph.i.i
  ...
  %i.ct = load ptr, ptr %i.bh, align 8, !tbaa !50
  %i.cu = load i32, ptr %i.bl, align 4, !tbaa !62
  %i.cv = load i32, ptr %i.bi, align 8, !tbaa !56
  %i.cw = load i32, ptr %i.cs, align 8, !tbaa !60
  ...
  %i.dc = load i32, ptr %i.bk, align 4, !tbaa !30
  %i.dd = sext i32 %i.dc to i64
  %i.de = getelementptr inbounds [4 x i8], ptr %i.cq, i64 %i.dd
  store i32 %.022.i.i, ptr %i.de, align 4, !tbaa !30
  %i.df = load i32, ptr %i.bl, align 4, !tbaa !62
  %i.dg = load i32, ptr %i.bi, align 8, !tbaa !56
  %i.dh = load ptr, ptr %i.aw, align 8, !tbaa !52 ; 3 uses
  %i.di = load i32, ptr %i.dh, align 8, !tbaa !60
  ...
  %i.ds = load i32, ptr %i.dr, align 4, !tbaa !30 ; 2 uses
  %i.dt = add nsw i32 %i.ds, 1
  store i32 %i.dt, ptr %i.dr, align 4, !tbaa !30
  %i.du = sext i32 %i.ds to i64
  %i.dv = getelementptr inbounds [4 x i8], ptr %i.dq, i64 %i.du
  store i32 %i.do, ptr %i.dv, align 4, !tbaa !30
  %i.dw = add nuw nsw i32 %.022.i.i, 1            ; 2 uses
  %exitcond.not.i.i = icmp eq i32 %i.dw, %i.cr
  br i1 %exitcond.not.i.i, label %Zyx_ManCollectFanins.exit.i, label %bb.k, !llvm.loop !3

Zyx_ManCollectFanins.exit.i:                      ; preds = %bb.k, %bb.j
  %i.dx = phi ptr [ %.pre.i, %bb.j ], [ %i.dh, %bb.k ] ; 2 uses
  %i.dy = getelementptr inbounds nuw i8, ptr %i.dx, i64 8
  %i.dz = load i32, ptr %i.dy, align 8, !tbaa !64 ; 3 uses
  %i.ea = icmp sgt i32 %i.dz, 0
  %.val106.i.pre = load i32, ptr %i.bo, align 4, !tbaa !57 ; 11 uses
...
.lr.ph.i98:                                       ; preds = %Zyx_ManCollectFanins.exit.i
  ...
  %.val111.i = load ptr, ptr %i.bp, align 8, !tbaa !58
  %i.ec = getelementptr i8, ptr %.val111.i, i64 8
  %.val111.val.i = load ptr, ptr %i.ec, align 8, !tbaa !21 ; 5 uses
...
bb.l:                                             ; preds = %bb.l, %.lr.ph.i98.new
  ...
  store ptr %i.ei, ptr %i.ej, align 16, !tbaa !73
  ...
  store ptr %i.eo, ptr %i.ep, align 8, !tbaa !73
  ...
  store ptr %i.eu, ptr %i.ev, align 16, !tbaa !73
  ...
  store ptr %i.fa, ptr %i.fb, align 8, !tbaa !73
...
._crit_edge.i:                                    ; preds = %._crit_edge.i.loopexit.unr-lcssa, %bb.m, %Zyx_ManCollectFanins.exit.i
  ...
  %i.fj = load i32, ptr %i.fi, align 8, !tbaa !55
  %.not83.i = icmp eq i32 %i.fj, 0
  br i1 %.not83.i, label %bb.o, label %bb.n

bb.n:                                             ; preds = %._crit_edge.i
  %.val109.i = load ptr, ptr %i.bp, align 8, !tbaa !58
  %i.fk = getelementptr i8, ptr %.val109.i, i64 8
  %.val109.val.i = load ptr, ptr %i.fk, align 8, !tbaa !21 ; 2 uses
  ...
  %i.fo = load ptr, ptr %i.d, align 16, !tbaa !73 ; 5 uses
  %i.fp = ptrtoaddr ptr %i.fo to i64
  %i.fq = load ptr, ptr %i.bq, align 8, !tbaa !73 ; 5 uses
  %i.fr = ptrtoaddr ptr %i.fq to i64
  %i.fs = load ptr, ptr %i.br, align 16, !tbaa !73 ; 5 uses
...
vector.body304:                                   ; preds = %vector.body304, %vector.ph302
  ...
  %wide.load306 = load <2 x i64>, ptr %i.gb, align 8, !tbaa !26
  %wide.load307 = load <2 x i64>, ptr %i.gc, align 8, !tbaa !26
  %i.gd = getelementptr inbounds nuw [8 x i8], ptr %i.fq, i64 %index305 ; 2 uses
  %i.ge = getelementptr inbounds nuw i8, ptr %i.gd, i64 16
  %wide.load308 = load <2 x i64>, ptr %i.gd, align 8, !tbaa !26 ; 2 uses
  %wide.load309 = load <2 x i64>, ptr %i.ge, align 8, !tbaa !26 ; 2 uses
  %i.gf = getelementptr inbounds nuw [8 x i8], ptr %i.fs, i64 %index305 ; 2 uses
  %i.gg = getelementptr inbounds nuw i8, ptr %i.gf, i64 16
  %wide.load310 = load <2 x i64>, ptr %i.gf, align 8, !tbaa !26 ; 2 uses
  %wide.load311 = load <2 x i64>, ptr %i.gg, align 8, !tbaa !26 ; 2 uses
