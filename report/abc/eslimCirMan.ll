...
bb.e:                                             ; preds = %bb.d
  ...
  %4 = and i64 %.val53, 2305843009213693952
  %5 = icmp ne i64 %4, 0
  %6 = icmp ne i32 %i.ap, %i.ah
  %.not9.i = xor i1 %5, %6                        ; 2 uses
...
bb.a:
  ...
  %2 = and i64 %.val, 2305843009213693952
  %3 = icmp ne i64 %2, 0
  %4 = icmp ne i32 %i.ab, %i.o
  %.not9 = xor i1 %3, %4                          ; 2 uses
