...
bb.h:                                             ; preds = %bb.f, %bb.b, %bb.g, %bb.e
  ...
  %.val39 = load i32, ptr %i.a, align 4, !tbaa !104
  %i.an = sext i32 %.val39 to i64
  %i.ao = icmp slt i64 %indvars.iv.next, %i.an
  br i1 %i.ao, label %bb.b, label %.critedge, !llvm.loop !184
...
bb.j:                                             ; preds = %.critedge.thread
  store i32 %.028.lcssa53, ptr %2, align 4, !tbaa !23
  br label %bb.k
...
vector.body268:                                   ; preds = %vector.memcheck260, %vector.body268
  ...
  %wide.load270 = load <2 x i64>, ptr %i.ae, align 8, !tbaa !80
  %wide.load271 = load <2 x i64>, ptr %i.af, align 8, !tbaa !80
  %i.ag = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep.i, i64 %index269 ; 2 uses
  %i.ah = getelementptr inbounds nuw i8, ptr %i.ag, i64 16
  store <2 x i64> %wide.load270, ptr %i.ag, align 8, !tbaa !80
  store <2 x i64> %wide.load271, ptr %i.ah, align 8, !tbaa !80
  %index.next272 = add nuw i64 %index269, 4       ; 2 uses
  %i.ai = icmp eq i64 %index.next272, %n.vec267
  br i1 %i.ai, label %._crit_edge.i, label %vector.body268, !llvm.loop !185
...
scalar.ph264:                                     ; preds = %scalar.ph264.preheader, %scalar.ph264
  ...
  store i64 %i.ak, ptr %gep.i, align 8, !tbaa !80
  ...
  store i64 %i.am, ptr %gep.i.1, align 8, !tbaa !80
  ...
  store i64 %i.ao, ptr %gep.i.2, align 8, !tbaa !80
  ...
  store i64 %i.aq, ptr %gep.i.3, align 8, !tbaa !80
  %indvars.iv.next.i.3 = add nuw nsw i64 %indvars.iv.i, 4 ; 2 uses
  %niter305.next.3 = add i64 %niter305, 4         ; 2 uses
  %niter305.ncmp.3 = icmp eq i64 %niter305.next.3, %unroll_iter304
  br i1 %niter305.ncmp.3, label %._crit_edge.i.loopexit.unr-lcssa, label %scalar.ph264, !llvm.loop !186
...
scalar.ph264.epil:                                ; preds = %scalar.ph264.epil, %scalar.ph264.epil.preheader
  ...
  store i64 %i.as, ptr %gep.i.epil, align 8, !tbaa !80
  %indvars.iv.next.i.epil = add nuw nsw i64 %indvars.iv.i.epil, 1
  %epil.iter301.next = add i64 %epil.iter301, 1   ; 2 uses
  %epil.iter301.cmp.not = icmp eq i64 %epil.iter301.next, %xtraiter300
  br i1 %epil.iter301.cmp.not, label %._crit_edge.i, label %scalar.ph264.epil, !llvm.loop !187
...
._crit_edge.i:                                    ; preds = %vector.body268, %._crit_edge.i.loopexit.unr-lcssa, %scalar.ph264.epil
  ...
  br i1 %i.au, label %.preheader.i, label %Abc_TtStretch6.exit, !llvm.loop !7
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load172 = load <4 x i32>, ptr %i.bn, align 4, !tbaa !23
  %i.bo = getelementptr i8, ptr %next.gep171, i64 16
  store <4 x i32> %wide.load, ptr %next.gep171, align 4, !tbaa !23
  store <4 x i32> %wide.load172, ptr %i.bo, align 4, !tbaa !23
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.bp = icmp eq i64 %index.next, %n.vec
  br i1 %i.bp, label %middle.block, label %vector.body, !llvm.loop !188
...
.lr.ph.i:                                         ; preds = %._crit_edge, %bb.j
  ...
  %i.bq = load i32, ptr %.0337.i, align 4, !tbaa !23 ; 4 uses
  %i.br = load i32, ptr %.08.i, align 4, !tbaa !23 ; 3 uses
  %i.bs = icmp eq i32 %i.bq, %i.br
  br i1 %i.bs, label %bb.f, label %bb.g

bb.f:                                             ; preds = %.lr.ph.i
  %i.bt = getelementptr inbounds nuw i8, ptr %.0337.i, i64 4
  store i32 %i.bq, ptr %.0366.i, align 4, !tbaa !23
...
bb.i:                                             ; preds = %bb.g
  ...
  store i32 %i.br, ptr %.0366.i, align 4, !tbaa !23
  br label %bb.j
...
bb.j:                                             ; preds = %bb.i, %bb.h, %bb.f
  ...
  br i1 %i.ca, label %.lr.ph.i, label %.preheader5.i, !llvm.loop !189
...
vector.body182:                                   ; preds = %vector.body182, %vector.ph180
  ...
  %wide.load186 = load <4 x i32>, ptr %next.gep184, align 4, !tbaa !23
  %wide.load187 = load <4 x i32>, ptr %i.cn, align 4, !tbaa !23
  %i.co = getelementptr i8, ptr %next.gep185, i64 16
  store <4 x i32> %wide.load186, ptr %next.gep185, align 4, !tbaa !23
  store <4 x i32> %wide.load187, ptr %i.co, align 4, !tbaa !23
  %index.next188 = add nuw i64 %index183, 8       ; 2 uses
  %i.cp = icmp eq i64 %index.next188, %n.vec181
  br i1 %i.cp, label %middle.block189, label %vector.body182, !llvm.loop !190
...
.lr.ph13.i:                                       ; preds = %.lr.ph13.i.preheader283, %.lr.ph13.i
  ...
  %i.cr = load i32, ptr %.23512.i, align 4, !tbaa !23
  %i.cs = getelementptr inbounds nuw i8, ptr %.23811.i, i64 4 ; 2 uses
  store i32 %i.cr, ptr %.23811.i, align 4, !tbaa !23
  %i.ct = icmp ult ptr %i.cq, %i.av
  br i1 %i.ct, label %.lr.ph13.i, label %.preheader.i64, !llvm.loop !191
...
.lr.ph17.i:                                       ; preds = %.lr.ph17.i.preheader282, %.lr.ph17.i
  ...
  %i.cv = load i32, ptr %.216.i, align 4, !tbaa !23
  %i.cw = getelementptr inbounds nuw i8, ptr %.315.i, i64 4 ; 2 uses
  store i32 %i.cv, ptr %.315.i, align 4, !tbaa !23
  %i.cx = icmp ult ptr %i.cu, %i.ax
  br i1 %i.cx, label %.lr.ph17.i, label %Vec_IntTwoMerge2Int.exit, !llvm.loop !192
...
bb.n:                                             ; preds = %bb.o, %.lr.ph.i67
  ...
  %i.dl = load i32, ptr %i.dk, align 4, !tbaa !23 ; 2 uses
...
bb.o:                                             ; preds = %bb.n
  ...
  store i32 %i.dl, ptr %i.dn, align 4, !tbaa !23
  %i.do = icmp samesign ugt i64 %indvars.iv.i68, 1
  br i1 %i.do, label %bb.n, label %Vec_IntPushOrder.exit, !llvm.loop !193
...
Vec_IntPushOrder.exit:                            ; preds = %bb.n, %bb.o, %Vec_IntGrow.exit24.i
  ...
  store i32 %9, ptr %i.dr, align 4, !tbaa !23
  %i.ds = load ptr, ptr %0, align 8, !tbaa !50
...
vector.body199:                                   ; preds = %vector.memcheck193, %vector.body199
  ...
  %wide.load201 = load <2 x i64>, ptr %i.el, align 8, !tbaa !80
  %wide.load202 = load <2 x i64>, ptr %i.em, align 8, !tbaa !80
  %i.en = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep.i75, i64 %index200 ; 2 uses
  %i.eo = getelementptr inbounds nuw i8, ptr %i.en, i64 16
  store <2 x i64> %wide.load201, ptr %i.en, align 8, !tbaa !80
  store <2 x i64> %wide.load202, ptr %i.eo, align 8, !tbaa !80
  %index.next203 = add nuw i64 %index200, 4       ; 2 uses
  %i.ep = icmp eq i64 %index.next203, %n.vec198
  br i1 %i.ep, label %._crit_edge.i80, label %vector.body199, !llvm.loop !194
...
scalar.ph195:                                     ; preds = %scalar.ph195.preheader, %scalar.ph195
  ...
  store i64 %i.er, ptr %gep.i77, align 8, !tbaa !80
  ...
  store i64 %i.ev, ptr %gep.i77.2, align 8, !tbaa !80
  ...
  %i.ex = load i64, ptr %i.ew, align 8, !tbaa !80
...
Exp_Truth6Lit.exit:                               ; preds = %bb.b, %bb.c, %bb.f, %bb.g, %bb.i, %bb.j
  ...
  %i.ag = load i32, ptr %i.af, align 4, !tbaa !23 ; 7 uses
...
Exp_Truth6Lit.exit31:                             ; preds = %Exp_Truth6Lit.exit, %bb.k, %bb.n, %bb.o, %bb.q, %bb.r
  ...
  store i64 %i.bd, ptr %i.be, align 8, !tbaa !80
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
...
!18 = !{!17, !16, i64 0}
!19 = !{!"Sfm_Par_t_", !16, i64 0, !16, i64 4, !16, i64 8, !16, i64 12, !16, i64 16, !16, i64 20, !16, i64 24, !16, i64 28, !16, i64 32, !16, i64 36, !16, i64 40, !16, i64 44, !16, i64 48, !16, i64 52, !16, i64 56, !16, i64 60, !16, i64 64, !16, i64 68, !16, i64 72, !16, i64 76, !16, i64 80, !16, i64 84, !16, i64 88, !16, i64 92, !16, i64 96, !16, i64 100, !16, i64 104, !16, i64 108, !16, i64 112, !16, i64 116, !16, i64 120}
!20 = !{!19, !16, i64 0}
!21 = !{!19, !16, i64 4}
!22 = !{!19, !16, i64 8}
!23 = !{!16, !16, i64 0}
...
!33 = !{!"p1 _ZTS10Sfm_Par_t_", !32, i64 0}
!34 = !{!"p1 _ZTS10Sfm_Lib_t_", !32, i64 0}
!35 = !{!"p1 _ZTS10Sfm_Tim_t_", !32, i64 0}
!36 = !{!"p1 _ZTS10Sfm_Mit_t_", !32, i64 0}
!37 = !{!"p1 _ZTS10Abc_Ntk_t_", !32, i64 0}
!38 = !{!"p1 int", !32, i64 0}
!39 = !{!"Vec_Int_t_", !16, i64 0, !16, i64 4, !38, i64 8}
!40 = !{!"p1 long", !32, i64 0}
!41 = !{!"Vec_Wrd_t_", !16, i64 0, !16, i64 4, !40, i64 8}
!42 = !{!"p1 _ZTS10Vec_Int_t_", !32, i64 0}
!43 = !{!"Vec_Wec_t_", !16, i64 0, !16, i64 4, !42, i64 8}
!44 = !{!"any p2 pointer", !32, i64 0}
!45 = !{!"Vec_Ptr_t_", !16, i64 0, !16, i64 4, !44, i64 8}
!46 = !{!"p1 _ZTS17Mio_GateStruct_t_", !32, i64 0}
!47 = !{!"p1 _ZTS12sat_solver_t", !32, i64 0}
!48 = !{!"Sfm_Dec_t_", !33, i64 0, !34, i64 8, !35, i64 16, !36, i64 24, !37, i64 32, !39, i64 40, !41, i64 56, !43, i64 72, !45, i64 88, !16, i64 104, !16, i64 108, !16, i64 112, !16, i64 116, !15, i64 120, !15, i64 136, !16, i64 152, !16, i64 156, !16, i64 160, !16, i64 164, !16, i64 168, !16, i64 172, !16, i64 176, !16, i64 180, !16, i64 184, !46, i64 192, !28, i64 200, !39, i64 208, !39, i64 224, !43, i64 240, !39, i64 256, !39, i64 272, !39, i64 288, !39, i64 304, !41, i64 320, !41, i64 336, !45, i64 352, !45, i64 368, !47, i64 384, !43, i64 392, !15, i64 408, !15, i64 440, !15, i64 472, !15, i64 480, !16, i64 488, !16, i64 492, !15, i64 496, !15, i64 752, !15, i64 816, !39, i64 880, !39, i64 896, !39, i64 912, !39, i64 928, !39, i64 944, !39, i64 960, !39, i64 976, !15, i64 992, !16, i64 1024, !28, i64 1032, !28, i64 1040, !28, i64 1048, !28, i64 1056, !28, i64 1064, !28, i64 1072, !28, i64 1080, !28, i64 1088, !28, i64 1096, !28, i64 1104, !28, i64 1112, !16, i64 1120, !16, i64 1124, !16, i64 1128, !16, i64 1132, !16, i64 1136, !16, i64 1140, !16, i64 1144, !16, i64 1148, !16, i64 1152, !16, i64 1156, !16, i64 1160, !16, i64 1164, !16, i64 1168, !16, i64 1172, !16, i64 1176, !16, i64 1180, !16, i64 1184, !16, i64 1188, !16, i64 1192, !16, i64 1196, !16, i64 1200, !28, i64 1208, !28, i64 1216, !15, i64 1224, !15, i64 1260}
!49 = !{!48, !28, i64 1104}
!50 = !{!48, !33, i64 0}
!51 = !{!48, !37, i64 32}
!52 = !{!48, !47, i64 384}
...
!60 = !{!48, !36, i64 24}
!61 = !{!48, !35, i64 16}
!62 = !{!"p1 omnipotent char", !32, i64 0}
!63 = !{!"p1 _ZTS9Nm_Man_t_", !32, i64 0}
!64 = !{!"p1 _ZTS10Vec_Ptr_t_", !32, i64 0}
!65 = !{!"p1 _ZTS10Abc_Des_t_", !32, i64 0}
!66 = !{!"double", !15, i64 0}
!67 = !{!"p1 _ZTS12Mem_Fixed_t_", !32, i64 0}
!68 = !{!"p1 _ZTS11Mem_Step_t_", !32, i64 0}
!69 = !{!"p1 _ZTS14Abc_ManTime_t_", !32, i64 0}
!70 = !{!"float", !15, i64 0}
!71 = !{!"p1 _ZTS10Abc_Cex_t_", !32, i64 0}
!72 = !{!"p1 float", !32, i64 0}
!73 = !{!"Abc_Ntk_t_", !16, i64 0, !16, i64 4, !62, i64 8, !62, i64 16, !63, i64 24, !64, i64 32, !64, i64 40, !64, i64 48, !64, i64 56, !64, i64 64, !64, i64 72, !64, i64 80, !64, i64 88, !15, i64 96, !16, i64 140, !16, i64 144, !16, i64 148, !16, i64 152, !37, i64 160, !16, i64 168, !65, i64 176, !37, i64 184, !16, i64 192, !16, i64 196, !16, i64 200, !66, i64 208, !16, i64 216, !39, i64 224, !67, i64 240, !68, i64 248, !32, i64 256, !69, i64 264, !32, i64 272, !70, i64 280, !16, i64 284, !42, i64 288, !64, i64 296, !38, i64 304, !71, i64 312, !64, i64 320, !37, i64 328, !32, i64 336, !32, i64 344, !37, i64 352, !32, i64 360, !32, i64 368, !42, i64 376, !42, i64 384, !62, i64 392, !72, i64 400, !64, i64 408, !42, i64 416, !42, i64 424, !64, i64 432, !42, i64 440, !42, i64 448, !42, i64 456}
!74 = !{!73, !32, i64 344}
!75 = !{!48, !16, i64 104}
!76 = !{!48, !16, i64 108}
!77 = !{!48, !16, i64 112}
...
!97 = !{!48, !16, i64 152}
!98 = !{!15, !15, i64 0}
!99 = !{!"p1 _ZTS10Abc_Obj_t_", !32, i64 0}
!100 = !{!"Abc_Obj_t_", !37, i64 0, !99, i64 8, !16, i64 16, !16, i64 20, !16, i64 20, !16, i64 20, !16, i64 20, !16, i64 20, !16, i64 21, !16, i64 21, !16, i64 21, !16, i64 21, !16, i64 21, !39, i64 24, !39, i64 40, !32, i64 56, !15, i64 64, !15, i64 72}
!101 = !{!100, !16, i64 28}
!102 = !{!100, !37, i64 0}
!103 = !{!100, !38, i64 32}
!104 = !{!100, !16, i64 44}
