...
._crit_edge:                                      ; preds = %bb.j
  ...
  %.0.val80124.pre = load i32, ptr %.phi.trans.insert, align 4, !tbaa !114
  br label %bb.r
...
bb.r:                                             ; preds = %._crit_edge, %bb.m
  %.0.val80124 = phi i32 [ %.val81, %bb.m ], [ %.0.val80124.pre, %._crit_edge ] ; 2 uses
  %.0 = phi ptr [ %i.bu, %bb.m ], [ %i.bq, %._crit_edge ] ; 3 uses
  %i.cp = getelementptr i8, ptr %.0, i64 28
  %i.cq = icmp sgt i32 %.0.val80124, 0
...
bb.s:                                             ; preds = %.lr.ph127, %bb.ac
  %.0.val80157 = phi i32 [ %.0.val80124, %.lr.ph127 ], [ %.0.val80, %bb.ac ] ; 2 uses
  ...
  %.0.val82 = load ptr, ptr %.0, align 8, !tbaa !117
  %.0.val83 = load ptr, ptr %i.cr, align 8, !tbaa !118
  %i.cv = getelementptr i8, ptr %.0.val82, i64 32
  %.0.val82.val = load ptr, ptr %i.cv, align 8, !tbaa !74
  %i.cw = getelementptr i8, ptr %.0.val82.val, i64 8
  %.0.val82.val.val = load ptr, ptr %i.cw, align 8, !tbaa !76
  %i.cx = getelementptr inbounds nuw [4 x i8], ptr %.0.val83, i64 %indvars.iv145
  %i.cy = load i32, ptr %i.cx, align 4, !tbaa !12
  %i.cz = sext i32 %i.cy to i64
  %i.da = getelementptr inbounds [8 x i8], ptr %.0.val82.val.val, i64 %i.cz
...
Vec_PtrPush.exit113:                              ; preds = %bb.x, %bb.w, %bb.ab, %bb.aa, %bb.t, %bb.y
  ...
  %.0.val80.pre = load i32, ptr %i.cp, align 4, !tbaa !114
  br label %bb.ac

bb.ac:                                            ; preds = %bb.s, %Vec_PtrPush.exit113
  %.0.val80 = phi i32 [ %.0.val80157, %bb.s ], [ %.0.val80.pre, %Vec_PtrPush.exit113 ] ; 2 uses
