...
.preheader25.lr.ph.split:                         ; preds = %bb.a
  ...
  %.val = load ptr, ptr %i.e, align 8, !tbaa !192 ; 3 uses
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load53 = load <2 x i64>, ptr %i.al, align 8, !tbaa !173, !alias.scope !194
  ...
  store <2 x i64> %wide.load53, ptr %i.an, align 8, !tbaa !173, !alias.scope !197, !noalias !194
...
scalar.ph:                                        ; preds = %.preheader24, %scalar.ph
  ...
  store ptr %gep.1, ptr %i.ay, align 8, !tbaa !189
  %i.az = add nsw i64 %i.q, %indvars.iv.next
  %i.ba = mul nsw i64 %i.az, %i.f
  %gep48.1 = getelementptr [8 x i8], ptr %invariant.gep47, i64 %i.ba
  %i.bb = load i64, ptr %gep48.1, align 8, !tbaa !173
  store i64 %i.bb, ptr %gep.1, align 8, !tbaa !173
...
.preheader.1.i:                                   ; preds = %.preheader, %.preheader.1.i
  ...
  br i1 %i.ci, label %.preheader.1.i, label %.preheader.2.i, !llvm.loop !191
...
.preheader.2.i:                                   ; preds = %.preheader.1.i, %.preheader.2.i
  ...
  br i1 %i.cz, label %.preheader.2.i, label %.preheader.3.i, !llvm.loop !191
...
.preheader.3.i:                                   ; preds = %.preheader.2.i, %.preheader.3.i
  ...
  %i.dc = load ptr, ptr %i.db, align 8, !tbaa !189 ; 2 uses
  %i.dd = load i64, ptr %i.dc, align 8, !tbaa !173 ; 2 uses
  %i.de = getelementptr i8, ptr %i.db, i64 32
  %i.df = load ptr, ptr %i.de, align 8, !tbaa !189 ; 3 uses
  %i.dg = load i64, ptr %i.df, align 8, !tbaa !173
  %i.dh = lshr i64 %i.dg, 4
  %i.di = xor i64 %i.dh, %i.dd
  %i.dj = and i64 %i.di, 1085102592571150095      ; 2 uses
  %i.dk = xor i64 %i.dj, %i.dd
  store i64 %i.dk, ptr %i.dc, align 8, !tbaa !173
  %i.dl = load i64, ptr %i.df, align 8, !tbaa !173
  %i.dm = shl nuw i64 %i.dj, 4
  %i.dn = xor i64 %i.dm, %i.dl
  store i64 %i.dn, ptr %i.df, align 8, !tbaa !173
  %i.do = add nsw i32 %.02830.3.i, 5
  %i.dp = and i32 %i.do, -5                       ; 2 uses
  %i.dq = icmp slt i32 %i.dp, 64
  br i1 %i.dq, label %.preheader.3.i, label %.preheader.4.i, !llvm.loop !191
...
.preheader.4.i:                                   ; preds = %.preheader.3.i, %.preheader.4.i
  ...
  %i.du = load i64, ptr %i.dt, align 8, !tbaa !173 ; 2 uses
  %i.dv = getelementptr i8, ptr %i.ds, i64 16
  %i.dw = load ptr, ptr %i.dv, align 8, !tbaa !189 ; 3 uses
  %i.dx = load i64, ptr %i.dw, align 8, !tbaa !173
  %i.dy = lshr i64 %i.dx, 2
  %i.dz = xor i64 %i.dy, %i.du
  %i.ea = and i64 %i.dz, 3689348814741910323      ; 2 uses
  %i.eb = xor i64 %i.ea, %i.du
  store i64 %i.eb, ptr %i.dt, align 8, !tbaa !173
  %i.ec = load i64, ptr %i.dw, align 8, !tbaa !173
  %i.ed = shl nuw i64 %i.ea, 2
  %i.ee = xor i64 %i.ed, %i.ec
  store i64 %i.ee, ptr %i.dw, align 8, !tbaa !173
  %i.ef = add nsw i32 %.02830.4.i, 3
  %i.eg = and i32 %i.ef, -3                       ; 2 uses
  %i.eh = icmp slt i32 %i.eg, 64
  br i1 %i.eh, label %.preheader.4.i, label %.preheader.5.i, !llvm.loop !191
