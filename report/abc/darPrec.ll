...
.lr.ph.us:                                        ; preds = %.lr.ph.us.preheader, %._crit_edge.us
  %i.l = phi i8 [ %.pre61, %.lr.ph.us.preheader ], [ %i.aj, %._crit_edge.us ]
  %indvars.iv56 = phi i64 [ 0, %.lr.ph.us.preheader ], [ %indvars.iv.next57, %._crit_edge.us ] ; 3 uses
  %i.m = getelementptr inbounds nuw i8, ptr %3, i64 %indvars.iv56 ; 4 uses
  %i.n = load i8, ptr %i.m, align 1, !tbaa !19    ; 6 uses
...
.lr.ph.us.new:                                    ; preds = %.lr.ph.us, %.lr.ph.us.new
  ...
  %i.r = getelementptr inbounds nuw [8 x i8], ptr %i.q, i64 %indvars.iv51
  %i.s = load ptr, ptr %i.r, align 8, !tbaa !8
  %i.t = getelementptr inbounds nuw i8, ptr %i.s, i64 %i.g
  store i8 %i.n, ptr %i.t, align 1, !tbaa !19
  %i.u = getelementptr inbounds nuw [8 x i8], ptr %i.q, i64 %indvars.iv51
  %i.v = getelementptr inbounds nuw i8, ptr %i.u, i64 8
  %i.w = load ptr, ptr %i.v, align 8, !tbaa !8
  %i.x = getelementptr inbounds nuw i8, ptr %i.w, i64 %i.g
  store i8 %i.n, ptr %i.x, align 1, !tbaa !19
  %i.y = getelementptr inbounds nuw [8 x i8], ptr %i.q, i64 %indvars.iv51
  %i.z = getelementptr inbounds nuw i8, ptr %i.y, i64 16
  %i.aa = load ptr, ptr %i.z, align 8, !tbaa !8
  %i.ab = getelementptr inbounds nuw i8, ptr %i.aa, i64 %i.g
  store i8 %i.n, ptr %i.ab, align 1, !tbaa !19
  %i.ac = getelementptr inbounds nuw [8 x i8], ptr %i.q, i64 %indvars.iv51
  %i.ad = getelementptr inbounds nuw i8, ptr %i.ac, i64 24
  %i.ae = load ptr, ptr %i.ad, align 8, !tbaa !8
  %i.af = getelementptr inbounds nuw i8, ptr %i.ae, i64 %i.g
  store i8 %i.n, ptr %i.af, align 1, !tbaa !19
...
bb.d:                                             ; preds = %bb.d, %.epil.preheader
  ...
  %i.ag = getelementptr inbounds nuw [8 x i8], ptr %i.q, i64 %indvars.iv51.epil
  %i.ah = load ptr, ptr %i.ag, align 8, !tbaa !8
  %i.ai = getelementptr inbounds nuw i8, ptr %i.ah, i64 %i.g
  store i8 %i.n, ptr %i.ai, align 1, !tbaa !19
...
._crit_edge.us:                                   ; preds = %bb.d, %._crit_edge.us.unr-lcssa
  tail call void @Dar_Permutations_rec(ptr noundef nonnull %i.q, i32 noundef %i.d, i32 noundef %i.e, ptr noundef nonnull %3)
  %i.aj = load i8, ptr %i.m, align 1, !tbaa !19   ; 2 uses
  %i.ak = load i8, ptr %i.h, align 1, !tbaa !19
  store i8 %i.ak, ptr %i.m, align 1, !tbaa !19
  store i8 %i.aj, ptr %i.h, align 1, !tbaa !19
...
.lr.ph48.split:                                   ; preds = %.lr.ph48.split.preheader, %.lr.ph48.split
  %i.al = phi i8 [ %.pre61, %.lr.ph48.split.preheader ], [ %i.ar, %.lr.ph48.split ]
  %indvars.iv = phi i64 [ 0, %.lr.ph48.split.preheader ], [ %indvars.iv.next, %.lr.ph48.split ] ; 3 uses
  %i.am = getelementptr inbounds nuw i8, ptr %3, i64 %indvars.iv ; 4 uses
  %i.an = load i8, ptr %i.am, align 1, !tbaa !19
  store i8 %i.al, ptr %i.am, align 1, !tbaa !19
  store i8 %i.an, ptr %i.h, align 1, !tbaa !19
  %i.ao = sub nsw i64 %i.g, %indvars.iv
  %i.ap = mul nsw i64 %i.ao, %i.j
  %i.aq = getelementptr inbounds [8 x i8], ptr %0, i64 %i.ap
  tail call void @Dar_Permutations_rec(ptr noundef %i.aq, i32 noundef %i.d, i32 noundef %i.e, ptr noundef nonnull %3)
  %i.ar = load i8, ptr %i.am, align 1, !tbaa !19  ; 2 uses
  %i.as = load i8, ptr %i.h, align 1, !tbaa !19
  store i8 %i.as, ptr %i.am, align 1, !tbaa !19
  store i8 %i.ar, ptr %i.h, align 1, !tbaa !19
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
