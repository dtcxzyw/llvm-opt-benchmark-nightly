...
bb.d:                                             ; preds = %bb.c
  %i.z = load ptr, ptr %i.j, align 8, !tbaa !51
...
bb.f:                                             ; preds = %bb.e
  %i.am = load ptr, ptr %i.j, align 8, !tbaa !51
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  br i1 %niter.ncmp.1, label %.critedge2.unr-lcssa, label %bb.c, !llvm.loop !2
...
bb.i:                                             ; preds = %.critedge2
  ...
  br i1 %exitcond51.not, label %.critedge, label %bb.b, !llvm.loop !3
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.g = load ptr, ptr %i.f, align 8, !tbaa !34   ; 6 uses
  %i.h = getelementptr inbounds nuw i8, ptr %i.g, i64 4 ; 3 uses
  %i.i = load i32, ptr %i.h, align 4, !tbaa !30   ; 7 uses
  %i.j = load i32, ptr %i.g, align 8, !tbaa !31
...
Vec_IntGrow.exit.i:                               ; preds = %bb.f, %bb.e
  ...
  store ptr %i.q, ptr %i.m, align 8, !tbaa !32
...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  store ptr %i.z, ptr %i.t, align 8, !tbaa !32
  br label %Vec_IntGrow.exit11.sink.split.i
...
Vec_IntGrow.exit11.sink.split.i:                  ; preds = %bb.k, %Vec_IntGrow.exit.i
  ...
  store i32 %spec.select.sink.i, ptr %i.g, align 8, !tbaa !31
  %.pre = load i32, ptr %i.h, align 4, !tbaa !30
...
Vec_IntPush.exit:                                 ; preds = %bb.b, %bb.g, %Vec_IntGrow.exit11.sink.split.i
  ...
  store i32 %i.ad, ptr %i.h, align 4, !tbaa !30
...
bb.l:                                             ; preds = %Vec_IntPush.exit, %bb.a
  ...
  %.val32 = load i32, ptr %i.ai, align 4, !tbaa !30 ; 5 uses
...
bb.n:                                             ; preds = %bb.m
  ...
  br i1 %exitcond.not.i, label %Vec_IntRemove.exit, label %bb.m, !llvm.loop !69
...
.lr.ph26.i:                                       ; preds = %._crit_edge.i
  ...
  %.pre.i = load i32, ptr %i.ai, align 4, !tbaa !30
...
._crit_edge27.i:                                  ; preds = %.lr.ph26.i, %._crit_edge.i
  ...
  store i32 %i.az, ptr %i.ai, align 4, !tbaa !30
...
Vec_IntRemove.exit:                               ; preds = %bb.n, %._crit_edge27.i, %bb.l
  ...
  %i.be = load ptr, ptr %i.bd, align 8, !tbaa !33 ; 6 uses
  %i.bf = getelementptr inbounds nuw i8, ptr %i.be, i64 4 ; 3 uses
  %i.bg = load i32, ptr %i.bf, align 4, !tbaa !30 ; 7 uses
  %i.bh = load i32, ptr %i.be, align 8, !tbaa !31
...
bb.p:                                             ; preds = %bb.o
  ...
  %i.bl = load ptr, ptr %i.bk, align 8, !tbaa !32 ; 2 uses
...
Vec_IntGrow.exit.i40:                             ; preds = %bb.r, %bb.q
  ...
  store ptr %i.bo, ptr %i.bk, align 8, !tbaa !32
...
bb.t:                                             ; preds = %bb.s
  ...
  %i.bs = load ptr, ptr %i.br, align 8, !tbaa !32 ; 2 uses
...
bb.w:                                             ; preds = %bb.v, %bb.u
  ...
  store ptr %i.bx, ptr %i.br, align 8, !tbaa !32
  br label %Vec_IntGrow.exit11.sink.split.i37
...
Vec_IntGrow.exit11.sink.split.i37:                ; preds = %bb.w, %Vec_IntGrow.exit.i40
  ...
  store i32 %spec.select.sink.i38, ptr %i.be, align 8, !tbaa !31
  %.pre61 = load i32, ptr %i.bf, align 4, !tbaa !30
...
Vec_IntPush.exit41:                               ; preds = %Vec_IntRemove.exit, %bb.s, %Vec_IntGrow.exit11.sink.split.i37
  ...
  store i32 %i.cb, ptr %i.bf, align 4, !tbaa !30
  ...
  %.val = load ptr, ptr %i.cg, align 8, !tbaa !26
  %i.ch = getelementptr inbounds [8 x i8], ptr %.val, i64 %i.c
  %i.ci = load ptr, ptr %i.ch, align 8, !tbaa !53 ; 2 uses
  %i.cj = getelementptr i8, ptr %i.ci, i64 4      ; 2 uses
  %.val3154 = load i32, ptr %i.cj, align 4, !tbaa !30 ; 2 uses
...
bb.y:                                             ; preds = %bb.x
  ...
  %i.cs = load ptr, ptr %i.ag, align 8, !tbaa !35 ; 6 uses
  %i.ct = getelementptr inbounds nuw i8, ptr %i.cs, i64 4 ; 3 uses
  %i.cu = load i32, ptr %i.ct, align 4, !tbaa !30 ; 7 uses
  %i.cv = load i32, ptr %i.cs, align 8, !tbaa !31
...
Vec_IntGrow.exit.i48:                             ; preds = %bb.ac, %bb.ab
  ...
  store ptr %i.dc, ptr %i.cy, align 8, !tbaa !32
...
bb.ae:                                            ; preds = %bb.ad
  ...
  %i.dg = load ptr, ptr %i.df, align 8, !tbaa !32 ; 2 uses
...
bb.ah:                                            ; preds = %bb.ag, %bb.af
  ...
  store ptr %i.dl, ptr %i.df, align 8, !tbaa !32
  br label %Vec_IntGrow.exit11.sink.split.i45
...
Vec_IntGrow.exit11.sink.split.i45:                ; preds = %bb.ah, %Vec_IntGrow.exit.i48
  ...
  store i32 %spec.select.sink.i46, ptr %i.cs, align 8, !tbaa !31
  %.pre62 = load i32, ptr %i.ct, align 4, !tbaa !30
