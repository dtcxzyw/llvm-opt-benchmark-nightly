...
bb.t:                                             ; preds = %bb.bg, %Vec_PtrPush.exit71
  ...
  br i1 %i.be, label %.lr.ph154.preheader, label %._crit_edge

.lr.ph154.preheader:                              ; preds = %bb.t
...
bb.u:                                             ; preds = %.lr.ph154
  ...
  br i1 %i.bg, label %.lr.ph154, label %._crit_edge, !llvm.loop !65

.lr.ph154:                                        ; preds = %.lr.ph154.preheader, %bb.u
  %indvars.iv153 = phi i64 [ %i.bh, %bb.u ], [ %i.bd, %.lr.ph154.preheader ]
  %i.bh = add nsw i64 %indvars.iv153, -1          ; 3 uses
  ...
  br i1 %i.bn, label %.lr.ph156, label %bb.u, !llvm.loop !65
...
bb.v:                                             ; preds = %.lr.ph156
  ...
  br i1 %i.br, label %.lr.ph156, label %._crit_edge158, !llvm.loop !66

.lr.ph156:                                        ; preds = %.lr.ph154, %bb.v
  %i.bs = phi i32 [ %i.bq, %bb.v ], [ %.val58, %.lr.ph154 ]
  %indvars.iv.i155 = phi i64 [ %i.bt, %bb.v ], [ %i.bd, %.lr.ph154 ]
  %i.bt = add nsw i64 %indvars.iv.i155, -1        ; 3 uses
  ...
  br i1 %i.bw, label %._crit_edge157, label %bb.v, !llvm.loop !66

._crit_edge157:                                   ; preds = %.lr.ph156
  br label %._crit_edge158, !llvm.loop !66

._crit_edge158:                                   ; preds = %bb.v, %._crit_edge157
  %.0.in.lcssa.i = phi i32 [ %i.bs, %._crit_edge157 ], [ 0, %bb.v ] ; 2 uses
  %i.bx = icmp slt i32 %.0.in.lcssa.i, %.val58
  br i1 %i.bx, label %.lr.ph.i, label %Vec_PtrRemove.exit

.lr.ph.i:                                         ; preds = %._crit_edge158
  %4 = sext i32 %.0.in.lcssa.i to i64             ; 4 uses
...
.prol.preheader:                                  ; preds = %.lr.ph.i, %.prol.preheader
  ...
  %i.ca = getelementptr inbounds [8 x i8], ptr %i.bz, i64 %indvars.iv18.i.prol ; 2 uses
...
.lr.ph.i.new:                                     ; preds = %.prol.loopexit, %.lr.ph.i.new
  ...
  %i.cg = getelementptr inbounds [8 x i8], ptr %i.cf, i64 %indvars.iv18.i ; 2 uses
  ...
  %i.ck = getelementptr [8 x i8], ptr %i.cj, i64 %indvars.iv18.i ; 2 uses
  ...
  %i.co = getelementptr [8 x i8], ptr %i.cn, i64 %indvars.iv18.i ; 2 uses
  ...
  %i.ct = getelementptr [8 x i8], ptr %i.cs, i64 %indvars.iv18.i ; 2 uses
  ...
  %indvars.iv.next19.i.3 = add nsw i64 %indvars.iv18.i, 4 ; 2 uses
...
Vec_PtrRemove.exit:                               ; preds = %.prol.loopexit, %.lr.ph.i.new, %._crit_edge158
