Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/abc/original/analyze?download=true
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  %i.g = load i32, ptr %.012, align 4, !tbaa !62
  ...
  br i1 %.not, label %.critedge.loopexit, label %.lr.ph, !llvm.loop !0
...
.critedge:                                        ; preds = %.critedge.loopexit, %bb.a
  ...
  store ptr %i.n, ptr %i.e, align 8, !tbaa !61
  ret void
}
...
bb.a:
  ...
  %i.c = load i8, ptr %i.b, align 1, !tbaa !93, !range !94, !noundef !95
  %i.d = trunc nuw i8 %i.c to i1
  br i1 %i.d, label %.loopexit, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 4 ; 5 uses
  %i.f = load i8, ptr %i.e, align 4, !tbaa !96, !range !94, !noundef !95
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.l = load i8, ptr %i.k, align 1, !tbaa !98, !range !94, !noundef !95
  ...
  %i.q = sub i64 %i.i, %i.p
  store i64 %i.i, ptr %i.o, align 8, !tbaa !101
...
.lr.ph.i:                                         ; preds = %bb.e, %.critedge.i
  ...
  %i.be = load i32, ptr %.0118158.i, align 4, !tbaa !62 ; 2 uses
  %i.bf = lshr i32 %i.be, 1
  %i.bg = zext nneg i32 %i.bf to i64
  %i.bh = getelementptr inbounds nuw [16 x i8], ptr %i.ay, i64 %i.bg
  %i.bi = load i32, ptr %i.bh, align 4, !tbaa !104 ; 5 uses
...
bb.g:                                             ; preds = %bb.f
  %i.bq = load i32, ptr %i.u, align 8, !tbaa !105
...
.thread:                                          ; preds = %._crit_edge.i
  store i8 1, ptr %i.b, align 1, !tbaa !93
  br label %one_literal_on_conflict_level.exit

bb.h:                                             ; preds = %._crit_edge.i
  %i.bu = load i32, ptr %i.u, align 8, !tbaa !105
...
.lr.ph173.preheader.i:                            ; preds = %bb.j
  ...
  %i.by = load i32, ptr %i.az, align 4, !tbaa !62 ; 5 uses
...
.lr.ph173.i:                                      ; preds = %bb.l, %.lr.ph173.preheader.i
  ...
  %i.ce = load i32, ptr %i.cd, align 4, !tbaa !62 ; 3 uses
  %i.cf = lshr i32 %i.ce, 1
  %i.cg = zext nneg i32 %i.cf to i64
  %i.ch = getelementptr inbounds nuw [16 x i8], ptr %i.ay, i64 %i.cg
  %i.ci = load i32, ptr %i.ch, align 4, !tbaa !104 ; 3 uses
...
bb.l:                                             ; preds = %bb.k, %.lr.ph173.i
  ...
  %.not196.i.a = icmp eq i64 %indvars.iv.next182.i, %i.bc
  br i1 %.not196.i.a, label %._crit_edge174.i, label %.lr.ph173.i, !llvm.loop !68
...
bb.m:                                             ; preds = %._crit_edge174.thread.i
  ...
  store i32 %i.by, ptr %i.cv, align 4, !tbaa !62
  store i32 %.2111.ph227.i, ptr %i.az, align 4, !tbaa !62
  %i.cw = getelementptr inbounds nuw i8, ptr %.028, i64 16
  %i.cx = load i32, ptr %i.cw, align 4, !tbaa !62
  %i.cy = load ptr, ptr %i.w, align 8, !tbaa !107
...
.lr.ph173.1.i:                                    ; preds = %bb.o, %.lr.ph173.preheader.1.i
  ...
  %i.dl = load i32, ptr %i.dk, align 4, !tbaa !62 ; 3 uses
  %i.dm = lshr i32 %i.dl, 1
  %i.dn = zext nneg i32 %i.dm to i64
  %i.do = getelementptr inbounds nuw [16 x i8], ptr %i.ay, i64 %i.dn
  %i.dp = load i32, ptr %i.do, align 4, !tbaa !104 ; 3 uses
...
bb.o:                                             ; preds = %bb.n, %.lr.ph173.1.i
  ...
  br i1 %exitcond, label %._crit_edge174.1.i, label %.lr.ph173.1.i, !llvm.loop !68
...
.split.i:                                         ; preds = %._crit_edge174.1.i
  ...
  store i32 %i.df, ptr %i.eb, align 4, !tbaa !62
  store i32 %.2111.ph.1.i, ptr %i.de, align 4, !tbaa !62
  %i.ec = load i32, ptr %i.az, align 4, !tbaa !62
  %i.ed = load ptr, ptr %i.w, align 8, !tbaa !107
...
bb.p:                                             ; preds = %.loopexit.thread.i
  %i.ek = load i32, ptr %i.az, align 4, !tbaa !62
...
bb.q:                                             ; preds = %.loopexit.thread.i
  %.val.i = load ptr, ptr %i.v, align 8, !tbaa !106
...
bb.s:                                             ; preds = %bb.r
  %i.eu = load ptr, ptr %i.x, align 8, !tbaa !108
  %i.ev = getelementptr inbounds nuw i8, ptr %i.eu, i64 20
  %i.ew = load i32, ptr %i.ev, align 4, !tbaa !110
  %i.ex = xor i32 %i.ew, 1                        ; 4 uses
  %i.ey = load ptr, ptr %i.t, align 8, !tbaa !59  ; 4 uses
  %i.ez = load ptr, ptr %i.z, align 8, !tbaa !111
  %i.fa = load i32, ptr %i.ba, align 4, !tbaa !102 ; 2 uses
...
.lr.ph.i36:                                       ; preds = %bb.s, %bb.w
  ...
  %i.fd = load i32, ptr %.0107145.i, align 4, !tbaa !62 ; 2 uses
...
bb.t:                                             ; preds = %.lr.ph.i36
  ...
  %i.fi = load i32, ptr %i.fh, align 4, !tbaa !104
...
bb.u:                                             ; preds = %bb.t
  ...
  %i.fm = load ptr, ptr %i.aa, align 8, !tbaa !61 ; 2 uses
  %i.fn = load ptr, ptr %i.ab, align 8, !tbaa !112
...
bb.v:                                             ; preds = %bb.u
  ...
  %.pre.i.i = load ptr, ptr %i.aa, align 8, !tbaa !61
...
kissat_push_analyzed.exit.i:                      ; preds = %bb.v, %bb.u
  ...
  store ptr %i.fq, ptr %i.aa, align 8, !tbaa !61
  store i32 %i.ff, ptr %i.fp, align 4, !tbaa !62
...
bb.w:                                             ; preds = %kissat_push_analyzed.exit.i, %bb.t
  ...
  br i1 %.not.i37, label %.critedge.i38.preheader, label %.lr.ph.i36, !llvm.loop !69
...
bb.x:                                             ; preds = %bb.x, %.critedge.i38
  ...
  br i1 %i.ga, label %bb.y, label %bb.x, !llvm.loop !70
...
bb.z:                                             ; preds = %bb.y
  ...
  %i.ge = load ptr, ptr %i.ad, align 8, !tbaa !64 ; 2 uses
  %i.gf = load ptr, ptr %i.ae, align 8, !tbaa !65
...
bb.aa:                                            ; preds = %bb.z
  ...
  %.pre.i = load ptr, ptr %i.ad, align 8, !tbaa !64
  br label %bb.ab

bb.ab:                                            ; preds = %bb.aa, %bb.z
  %i.gh = phi ptr [ %.pre.i, %bb.aa ], [ %i.ge, %bb.z ] ; 2 uses
  %i.gi = getelementptr inbounds nuw i8, ptr %i.gh, i64 4
  store ptr %i.gi, ptr %i.ad, align 8, !tbaa !64
  store i32 %i.gd, ptr %i.gh, align 4, !tbaa !62
...
begin_hunk_1_@kissat_analyze:bb.a
  %.1302.i.i = phi i64 [ %.0301.i.i, %bb.bh ], [ %i.li, %bb.bi ] ; 4 uses
  %i.li = add i64 %.1302.i.i, 1                   ; 7 uses
  %i.lj = getelementptr inbounds nuw [4 x i8], ptr %i.jz, i64 %i.li
  %i.lk = load i32, ptr %i.lj, align 4, !tbaa !62 ; 3 uses
  %i.ll = icmp ult i32 %i.lk, %i.lg
  br i1 %i.ll, label %bb.bi, label %.preheader339.i.i.preheader, !llvm.loop !75
...
.preheader339.i.i:                                ; preds = %.preheader339.i.i.preheader, %.preheader339.i.i
  ...
  %i.lp = load i32, ptr %i.lo, align 4, !tbaa !62 ; 2 uses
  %i.lq = icmp uge i32 %i.lg, %i.lp
  %i.lr = icmp eq i64 %.1300.i.i, %i.lh
  %or.cond.i.i = or i1 %i.lr, %i.lq
  br i1 %or.cond.i.i, label %bb.bj, label %.preheader339.i.i, !llvm.loop !76
...
bb.bk:                                            ; preds = %bb.bj
  ...
  store i32 %i.lp, ptr %i.lm, align 4, !tbaa !62
  store i32 %i.lk, ptr %i.ls, align 4, !tbaa !62
  br label %bb.bh

bb.bl:                                            ; preds = %bb.bj
  %i.lt = load i32, ptr %i.ku, align 4, !tbaa !62
  store i32 %i.lt, ptr %i.lm, align 4, !tbaa !62
  store i32 %i.lk, ptr %i.ku, align 4, !tbaa !62
...
bb.bm:                                            ; preds = %bb.bl
  %i.ma = load ptr, ptr %i.aq, align 8, !tbaa !128 ; 2 uses
  %i.mb = load ptr, ptr %i.ar, align 8, !tbaa !129 ; 2 uses
...
bb.bn:                                            ; preds = %bb.bm
  ...
  %.pre398.i.i = load ptr, ptr %i.aq, align 8, !tbaa !128
  %.pre399.i.i = load ptr, ptr %i.ar, align 8, !tbaa !129
  br label %bb.bo
...
bb.bo:                                            ; preds = %bb.bn, %bb.bm
  ...
  store ptr %i.mf, ptr %i.aq, align 8, !tbaa !128
  store i64 %..0295.i.i, ptr %i.me, align 8, !tbaa !130
  %i.mg = icmp eq ptr %i.mf, %i.md
  br i1 %i.mg, label %bb.bp, label %bb.bq

bb.bp:                                            ; preds = %bb.bo
  tail call void @kissat_stack_enlarge(ptr noundef nonnull %0, ptr noundef nonnull %i.ap, i64 noundef 8) #8
  %.pre400.i.i = load ptr, ptr %i.aq, align 8, !tbaa !128
  br label %bb.bq

bb.bq:                                            ; preds = %bb.bp, %bb.bo
  %i.mh = phi ptr [ %.pre400.i.i, %bb.bp ], [ %i.mf, %bb.bo ] ; 2 uses
  %i.mi = getelementptr inbounds nuw i8, ptr %i.mh, i64 8
  store ptr %i.mi, ptr %i.aq, align 8, !tbaa !128
  store i64 %.0303..1302.i.i, ptr %i.mh, align 8, !tbaa !130
...
bb.bs:                                            ; preds = %bb.br
  %i.ml = load ptr, ptr %i.ap, align 8, !tbaa !131
  %i.mm = load ptr, ptr %i.aq, align 8, !tbaa !128 ; 3 uses
...
bb.bt:                                            ; preds = %bb.bs
  ...
  %i.mp = load i64, ptr %i.mo, align 8, !tbaa !130
  %i.mq = getelementptr inbounds i8, ptr %i.mm, i64 -16 ; 2 uses
  store ptr %i.mq, ptr %i.aq, align 8, !tbaa !128
  %i.mr = load i64, ptr %i.mq, align 8, !tbaa !130
  br label %.preheader340.i.i.backedge
...
.lr.ph381.i.i:                                    ; preds = %.lr.ph381.i.i.prol.loopexit, %bb.bw
  ...
  %i.mv = load i32, ptr %i.mu, align 4, !tbaa !62 ; 2 uses
  %i.mw = getelementptr i8, ptr %i.mu, i64 -4     ; 2 uses
  %i.mx = load i32, ptr %i.mw, align 4, !tbaa !62 ; 2 uses
  %i.my = icmp ult i32 %i.mv, %i.mx
  br i1 %i.my, label %bb.bu, label %.lr.ph381.i.i.1

bb.bu:                                            ; preds = %.lr.ph381.i.i
  store i32 %i.mv, ptr %i.mw, align 4, !tbaa !62
  store i32 %i.mx, ptr %i.mu, align 4, !tbaa !62
...
.lr.ph381.i.i.1:                                  ; preds = %bb.bu, %.lr.ph381.i.i
  ...
  %i.nb = load i32, ptr %i.na, align 4, !tbaa !62 ; 2 uses
...
bb.bv:                                            ; preds = %.lr.ph381.i.i.1
  store i32 %i.nb, ptr %i.nc, align 4, !tbaa !62
  store i32 %i.nd, ptr %i.na, align 4, !tbaa !62
  br label %bb.bw

bb.bw:                                            ; preds = %bb.bv, %.lr.ph381.i.i.1
  %i.nf = add nsw i64 %.0292380.i.i, -2           ; 2 uses
  %.not331.i.i.1 = icmp eq i64 %i.nf, 0
  br i1 %.not331.i.i.1, label %.preheader.i.i, label %.lr.ph381.i.i, !llvm.loop !77
...
.lr.ph389.i.i:                                    ; preds = %._crit_edge385.i.i.1, %.lr.ph389.preheader.i.i.new
  ...
  %i.nh = load i32, ptr %i.ng, align 4, !tbaa !62 ; 3 uses
  %i.ni = getelementptr i8, ptr %i.ng, i64 -4
  %i.nj = load i32, ptr %i.ni, align 4, !tbaa !62 ; 2 uses
...
.lr.ph384.i.i.1:                                  ; preds = %._crit_edge385.i.i, %.lr.ph384.i.i.1
  ...
  store i32 %i.ny, ptr %i.nz, align 4, !tbaa !62
  ...
  %i.od = load i32, ptr %i.oc, align 4, !tbaa !62 ; 2 uses
  %i.oe = icmp ult i32 %i.nu, %i.od
  br i1 %i.oe, label %.lr.ph384.i.i.1, label %._crit_edge385.i.i.1, !llvm.loop !78

._crit_edge385.i.i.1:                             ; preds = %.lr.ph384.i.i.1, %._crit_edge385.i.i
  %.lcssa.i.i.1 = phi ptr [ %i.nt, %._crit_edge385.i.i ], [ %i.ob, %.lr.ph384.i.i.1 ]
  store i32 %i.nu, ptr %.lcssa.i.i.1, align 4, !tbaa !62
  %i.of = add nuw nsw i64 %.0291388.i.i, 2        ; 2 uses
  %niter294.next.1 = add i64 %niter294, 2         ; 2 uses
  %niter294.ncmp.1 = icmp eq i64 %niter294.next.1, %unroll_iter293
  br i1 %niter294.ncmp.1, label %sort_levels.exit.i.loopexit.unr-lcssa, label %.lr.ph389.i.i, !llvm.loop !79
...
.lr.ph.i.i42:                                     ; preds = %bb.cb, %.lr.ph.i.i42
  ...
  %i.oz = load i32, ptr %.0259353.i.i, align 4, !tbaa !62 ; 3 uses
  ...
  %i.pi = load i64, ptr %i.ph, align 8, !tbaa !130
  %i.pj = add i64 %i.pi, 1
  store i64 %i.pj, ptr %i.ph, align 8, !tbaa !130
  %i.pk = getelementptr inbounds nuw i8, ptr %.0259353.i.i, i64 4 ; 2 uses
  %.not326.i.i = icmp eq ptr %i.pk, %i.op
  br i1 %.not326.i.i, label %._crit_edge.i.i, label %.lr.ph.i.i42, !llvm.loop !80
...
.lr.ph360.i.i.epil:                               ; preds = %.lr.ph360.i.i.epil, %.lr.ph360.i.i.epil.preheader
  ...
  %i.pw = load i64, ptr %i.pv, align 8, !tbaa !130
  store i64 %.0258357.i.i.epil, ptr %i.pv, align 8, !tbaa !130
  %i.px = add i64 %i.pw, %.0258357.i.i.epil
  %i.py = add nuw nsw i64 %.0257358.i.i.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %._crit_edge361.i.i, label %.lr.ph360.i.i.epil, !llvm.loop !81
...
.lr.ph360.i.i:                                    ; preds = %.lr.ph360.i.i, %.lr.ph360.preheader.i.i.new
  ...
  %i.qa = load i64, ptr %i.pz, align 8, !tbaa !130
  store i64 %.0258357.i.i, ptr %i.pz, align 8, !tbaa !130
  ...
  %i.qe = load i64, ptr %i.qd, align 8, !tbaa !130
  store i64 %i.qb, ptr %i.qd, align 8, !tbaa !130
  ...
  %i.qi = load i64, ptr %i.qh, align 8, !tbaa !130
  store i64 %i.qf, ptr %i.qh, align 8, !tbaa !130
  ...
  %i.qm = load i64, ptr %i.ql, align 8, !tbaa !130
  store i64 %i.qj, ptr %i.ql, align 8, !tbaa !130
  %i.qn = add i64 %i.qm, %i.qj                    ; 2 uses
  %i.qo = add nuw nsw i64 %.0257358.i.i, 4        ; 2 uses
  %niter.next.3 = add i64 %niter, 4               ; 2 uses
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %._crit_edge361.i.i.loopexit.unr-lcssa, label %.lr.ph360.i.i, !llvm.loop !82
...
.lr.ph365.i.i:                                    ; preds = %.lr.ph365.i.i, %.lr.ph365.preheader.i.i
  ...
  %i.qs = load i32, ptr %.0256363.i.i, align 4, !tbaa !62 ; 2 uses
  ...
  %i.qx = load i64, ptr %i.qw, align 8, !tbaa !130 ; 2 uses
  %i.qy = add i64 %i.qx, 1
  store i64 %i.qy, ptr %i.qw, align 8, !tbaa !130
  %i.qz = getelementptr inbounds nuw [4 x i8], ptr %i.qr, i64 %i.qx
  store i32 %i.qs, ptr %i.qz, align 4, !tbaa !62
  %i.ra = getelementptr inbounds nuw i8, ptr %.0256363.i.i, i64 4 ; 2 uses
  %.not329.i.i = icmp eq ptr %i.ra, %i.op
  br i1 %.not329.i.i, label %.loopexit341.i.i, label %.lr.ph365.i.i, !llvm.loop !83
