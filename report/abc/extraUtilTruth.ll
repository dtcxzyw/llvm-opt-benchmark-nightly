...
.lr.ph96:                                         ; preds = %.preheader
  ...
  %i.aj = load <8 x i16>, ptr %2, align 2, !tbaa !24 ; 9 uses
  %.promoted111 = load i16, ptr %i.ah, align 2, !tbaa !24 ; 2 uses
  %.promoted113 = load i16, ptr %i.ai, align 2, !tbaa !24 ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec = load <8 x i32>, ptr %next.gep, align 4, !tbaa !18 ; 2 uses
...
bb.i:                                             ; preds = %bb.h
  ...
  store i16 %i.fb, ptr %i.ez, align 2, !tbaa !24
  br label %bb.k

bb.j:                                             ; preds = %bb.h
  %i.fc = load i16, ptr %i.ey, align 2, !tbaa !24
  %i.fd = add i16 %i.fc, %i.es
  store i16 %i.fd, ptr %i.ey, align 2, !tbaa !24
  br label %bb.k
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %.07994 = phi ptr [ %i.gd, %scalar.ph ], [ %.07994.ph, %scalar.ph.preheader ] ; 2 uses
  %i.fg = phi <8 x i16> [ %i.fq, %scalar.ph ], [ %.ph173, %scalar.ph.preheader ]
  %3 = load <2 x i32>, ptr %.07994, align 4, !tbaa !18 ; 4 uses
  %4 = shufflevector <2 x i32> %3, <2 x i32> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1> ; 2 uses
  %i.fh = shl <4 x i32> %4, <i32 1, i32 2, i32 4, i32 8>
  %i.fi = shufflevector <2 x i32> %3, <2 x i32> poison, <8 x i32> zeroinitializer
  ...
  %i.fk = lshr <4 x i32> %4, <i32 1, i32 2, i32 4, i32 8>
  ...
  %5 = extractelement <2 x i32> %3, i64 0         ; 2 uses
  %i.fr = and i32 %5, 65535
...
..thread87.loopexit_crit_edge:                    ; preds = %scalar.ph, %middle.block
  ...
  store <8 x i16> %i.gf, ptr %2, align 2, !tbaa !24
  store i16 %.lcssa143, ptr %i.ah, align 2, !tbaa !24
  store i16 %.lcssa, ptr %i.ai, align 2, !tbaa !24
  br label %.thread87
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %i.b, align 16, !tbaa !18
  %wide.load12 = load <4 x i32>, ptr %i.c, align 16, !tbaa !18
  %i.d = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %index ; 2 uses
  %i.e = getelementptr inbounds nuw i8, ptr %i.d, i64 16
  %wide.load13 = load <4 x i32>, ptr %i.d, align 4, !tbaa !18
  %wide.load14 = load <4 x i32>, ptr %i.e, align 4, !tbaa !18
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %i.h, align 4, !tbaa !18
  %wide.load167 = load <4 x i32>, ptr %i.i, align 4, !tbaa !18
...
bb.c:                                             ; preds = %bb.b
  %i.z = load i32, ptr %0, align 4, !tbaa !18
  %i.aa = and i32 %i.z, 1
...
vector.body173:                                   ; preds = %vector.body173, %vector.ph171
  ...
  %wide.load175 = load <4 x i32>, ptr %i.ae, align 4, !tbaa !18
  %wide.load176 = load <4 x i32>, ptr %i.af, align 4, !tbaa !18
  %i.ag = xor <4 x i32> %wide.load175, splat (i32 -1)
  %i.ah = xor <4 x i32> %wide.load176, splat (i32 -1)
  store <4 x i32> %i.ag, ptr %i.ae, align 4, !tbaa !18
  store <4 x i32> %i.ah, ptr %i.af, align 4, !tbaa !18
