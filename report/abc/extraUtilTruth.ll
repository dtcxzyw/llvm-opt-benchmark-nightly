...
.preheader87.us.preheader.i:                      ; preds = %.preheader87.lr.ph.i
  ...
  %6 = icmp slt i32 %i.ch, 4
  %unroll_iter = and i64 %wide.trip.count.i, 2147483644
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  %lcmp.mod215 = icmp ne i64 %xtraiter, 0
  %min.iters.check159 = icmp slt i32 %i.ch, 8
  ...
  %min.iters.check145 = icmp slt i32 %i.ch, 8
  ...
  %min.iters.check131 = icmp slt i32 %i.ch, 8
...
.preheader87.us.preheader.i:                      ; preds = %.preheader87.lr.ph.i
  ...
  %xtraiter = and i64 %wide.trip.count.i, 3       ; 3 uses
  %6 = icmp slt i32 %i.ce, 4
  %unroll_iter = and i64 %wide.trip.count.i, 2147483644
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  %lcmp.mod216 = icmp ne i64 %xtraiter, 0
  %min.iters.check160 = icmp slt i32 %i.ce, 8
  ...
  %min.iters.check146 = icmp slt i32 %i.ce, 8
  ...
  %min.iters.check132 = icmp slt i32 %i.ce, 8
