...
.lr.ph129:                                        ; preds = %.lr.ph129, %.lr.ph129.preheader.new
  ...
  %i.bq = load i32, ptr %i.bp, align 4, !tbaa !12 ; 2 uses
  ...
  br i1 %niter.ncmp.1, label %._crit_edge130.loopexit.unr-lcssa, label %.lr.ph129, !llvm.loop !19
...
._crit_edge130:                                   ; preds = %._crit_edge130.loopexit, %bb.l
  ...
  store i32 %i.cd, ptr %i.ce, align 4, !tbaa !12
  %i.cf = load i32, ptr %i.at, align 4, !tbaa !12
  %i.cg = getelementptr inbounds nuw [4 x i8], ptr %i.ap, i64 %.0.lcssa
  store i32 %i.cf, ptr %i.cg, align 4, !tbaa !12
...
bb.c:                                             ; preds = %bb.c, %bb.b
  ...
  br i1 %.not.i, label %.preheader.i, label %bb.c, !llvm.loop !0
...
.lr.ph.preheader.i:                               ; preds = %.preheader.i
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep.i, ptr noundef nonnull align 8 dereferenceable(1) %scevgep15.i, i64 %i.t, i1 false), !tbaa !11
...
bb.d:                                             ; preds = %bb.d, %Msat_ClauseRemoveWatch.exit
  ...
  br i1 %.not.i13, label %.preheader.i15, label %bb.d, !llvm.loop !0
...
.lr.ph.preheader.i16:                             ; preds = %.preheader.i15
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep.i17, ptr noundef nonnull align 8 dereferenceable(1) %scevgep15.i18, i64 %i.an, i1 false), !tbaa !11
...
bb.b:                                             ; preds = %bb.b, %bb.a
  ...
  br i1 %.not, label %.preheader, label %bb.b, !llvm.loop !0
...
.lr.ph.preheader:                                 ; preds = %.preheader
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep, ptr noundef nonnull align 8 dereferenceable(1) %scevgep15, i64 %i.o, i1 false), !tbaa !11
  br label %._crit_edge
...
bb.b:                                             ; preds = %bb.a
  ...
  store i32 %i.a, ptr %i.e, align 4, !tbaa !12
  br label %bb.c
...
bb.f:                                             ; preds = %.lr.ph
  ...
  store i32 %i.t, ptr %i.aa, align 4, !tbaa !12
  store i32 %i.a, ptr %i.z, align 4, !tbaa !12
end_hunk_0
