...
bb.u:                                             ; preds = %bb.q
  ...
  %i.dc = shl nsw i32 %indvars.iv157.tr, 1
...
bb.ei:                                            ; preds = %bb.ee
  ...
  %i.alc = shl nsw i32 %indvars.iv5587.tr, 1
...
bb.nd:                                            ; preds = %bb.mz
  ...
  %i.bqx = shl nsw i32 %indvars.iv5678.tr, 1
...
bb.acn:                                           ; preds = %bb.acj
  ...
  %i.eeu = shl nsw i32 %indvars.iv5758.tr, 1
...
bb.acx:                                           ; preds = %bb.act
  ...
  %i.ehy = shl nsw i32 %indvars.iv5767.tr, 1
...
bb.g:                                             ; preds = %bb.c
  ...
  %i.aw = shl nsw i32 %indvars.iv.tr, 1
...
bb.q:                                             ; preds = %bb.m
  ...
  %i.aw = shl nsw i32 %indvars.iv112.tr, 1
  %spec.select.i = select i1 %i.av, i32 %i.aw, i32 2147483647 ; 4 uses
  %i.ax = sext i32 %spec.select.i to i64
...
bb.y:                                             ; preds = %bb.u
  ...
  %indvars.iv.tr = trunc i64 %indvars.iv to i32
  %i.bo = shl nsw i32 %indvars.iv.tr, 1
...
bb.aj:                                            ; preds = %bb.af
  ...
  %i.dp = shl nsw i32 %indvars.iv125.tr, 1
