...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %i.l = add nsw i64 %indvars.iv, -1              ; 2 uses
  %i.m = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.l ; 2 uses
  %i.n = load i32, ptr %i.m, align 4, !tbaa !8
  %i.o = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %i.l ; 2 uses
  %i.p = load i32, ptr %i.o, align 4, !tbaa !8
  %i.q = tail call i32 @Gia_ManHashAnd(ptr noundef %0, i32 noundef %i.n, i32 noundef %i.p) #27
  %i.r = getelementptr inbounds nuw [4 x i8], ptr %i.e, i64 %indvars.iv
  store i32 %i.q, ptr %i.r, align 4, !tbaa !8
  %i.s = load i32, ptr %i.m, align 4, !tbaa !8
  %i.t = load i32, ptr %i.o, align 4, !tbaa !8
  %i.u = tail call i32 @Gia_ManHashXor(ptr noundef %0, i32 noundef %i.s, i32 noundef %i.t) #27 ; 2 uses
  %i.v = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %indvars.iv
  store i32 %i.u, ptr %i.v, align 4, !tbaa !8
  %i.w = getelementptr inbounds nuw [4 x i8], ptr %i.g, i64 %indvars.iv
  store i32 %i.u, ptr %i.w, align 4, !tbaa !8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %.lr.ph176, label %.lr.ph, !llvm.loop !78

.preheader170:                                    ; preds = %.lr.ph176
  %i.x = icmp sgt i32 %3, 2
  br i1 %i.x, label %.lr.ph181.preheader, label %.lr.ph186.preheader
...
.lr.ph176:                                        ; preds = %.lr.ph, %.lr.ph176
  %indvars.iv194 = phi i64 [ %indvars.iv.next195, %.lr.ph176 ], [ 1, %.lr.ph ] ; 4 uses
  %i.aa = getelementptr inbounds nuw [4 x i8], ptr %i.e, i64 %indvars.iv194 ; 2 uses
  %i.ab = load i32, ptr %i.aa, align 4, !tbaa !8
  %i.ac = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %indvars.iv194 ; 2 uses
  %i.ad = load i32, ptr %i.ac, align 4, !tbaa !8  ; 2 uses
  %i.ae = add nsw i64 %indvars.iv194, -1          ; 2 uses
  %i.af = getelementptr inbounds nuw [4 x i8], ptr %i.e, i64 %i.ae
  %i.ag = load i32, ptr %i.af, align 4, !tbaa !8
  %i.ah = tail call i32 @Gia_ManHashAnd(ptr noundef %0, i32 noundef %i.ad, i32 noundef %i.ag) #27
  %i.ai = tail call i32 @Gia_ManHashOr(ptr noundef %0, i32 noundef %i.ab, i32 noundef %i.ah) #27
  %i.aj = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.ae
  %i.ak = load i32, ptr %i.aj, align 4, !tbaa !8
  %i.al = tail call i32 @Gia_ManHashAnd(ptr noundef %0, i32 noundef %i.ad, i32 noundef %i.ak) #27
  store i32 %i.al, ptr %i.ac, align 4, !tbaa !8
  store i32 %i.ai, ptr %i.aa, align 4, !tbaa !8
  %indvars.iv.next195 = add nuw nsw i64 %indvars.iv194, 2 ; 2 uses
  %i.am = trunc nuw i64 %indvars.iv.next195 to i32
  %.not162 = icmp slt i32 %i.b, %i.am
...
.lr.ph181:                                        ; preds = %.lr.ph181.preheader, %._crit_edge
  ...
  %.not165177.not = icmp slt i64 %i.an, %i.z
...
.preheader169:                                    ; preds = %.lr.ph186
  ...
  br i1 %.not164187, label %.lr.ph191.preheader, label %.lr.ph189
...
.lr.ph186:                                        ; preds = %.lr.ph186.preheader, %.lr.ph186
  ...
  %i.be = getelementptr inbounds [4 x i8], ptr %i.e, i64 %indvars.iv207 ; 2 uses
  %i.bf = load i32, ptr %i.be, align 4, !tbaa !8
  %i.bg = getelementptr inbounds [4 x i8], ptr %i.f, i64 %indvars.iv207 ; 2 uses
  %i.bh = load i32, ptr %i.bg, align 4, !tbaa !8  ; 2 uses
  %i.bi = sub nsw i64 %indvars.iv207, %i.bb       ; 2 uses
  %i.bj = getelementptr inbounds nuw [4 x i8], ptr %i.e, i64 %i.bi
  %i.bk = load i32, ptr %i.bj, align 4, !tbaa !8
  %i.bl = tail call i32 @Gia_ManHashAnd(ptr noundef %0, i32 noundef %i.bh, i32 noundef %i.bk) #27
  %i.bm = tail call i32 @Gia_ManHashOr(ptr noundef %0, i32 noundef %i.bf, i32 noundef %i.bl) #27
  %i.bn = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.bi
  %i.bo = load i32, ptr %i.bn, align 4, !tbaa !8
  %i.bp = tail call i32 @Gia_ManHashAnd(ptr noundef %0, i32 noundef %i.bh, i32 noundef %i.bo) #27
  store i32 %i.bp, ptr %i.bg, align 4, !tbaa !8
  store i32 %i.bm, ptr %i.be, align 4, !tbaa !8
...
.lr.ph189:                                        ; preds = %.preheader169, %.lr.ph189
  %indvars.iv210 = phi i64 [ %indvars.iv.next211, %.lr.ph189 ], [ 2, %.preheader169 ] ; 4 uses
  %i.bq = getelementptr inbounds nuw [4 x i8], ptr %i.e, i64 %indvars.iv210 ; 2 uses
  %i.br = load i32, ptr %i.bq, align 4, !tbaa !8
  %i.bs = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %indvars.iv210 ; 2 uses
  %i.bt = load i32, ptr %i.bs, align 4, !tbaa !8  ; 2 uses
  %i.bu = add nsw i64 %indvars.iv210, -1          ; 2 uses
  %i.bv = getelementptr inbounds nuw [4 x i8], ptr %i.e, i64 %i.bu
  %i.bw = load i32, ptr %i.bv, align 4, !tbaa !8
  %i.bx = tail call i32 @Gia_ManHashAnd(ptr noundef %0, i32 noundef %i.bt, i32 noundef %i.bw) #27
  %i.by = tail call i32 @Gia_ManHashOr(ptr noundef %0, i32 noundef %i.br, i32 noundef %i.bx) #27
  %i.bz = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %i.bu
  %i.ca = load i32, ptr %i.bz, align 4, !tbaa !8
  %i.cb = tail call i32 @Gia_ManHashAnd(ptr noundef %0, i32 noundef %i.bt, i32 noundef %i.ca) #27
  store i32 %i.cb, ptr %i.bs, align 4, !tbaa !8
  store i32 %i.by, ptr %i.bq, align 4, !tbaa !8
  %indvars.iv.next211 = add nuw nsw i64 %indvars.iv210, 2 ; 2 uses
  %i.cc = trunc nuw i64 %indvars.iv.next211 to i32
  %.not164 = icmp slt i32 %i.b, %i.cc
...
._crit_edge:                                      ; preds = %scalar.ph, %middle.block, %.thread.us.preheader, %.preheader
  tail call void @Wlc_BlastAdderFast_int(ptr noundef %0, ptr noundef %i.h, ptr noundef %i.i, i32 noundef %.09.i, i32 noundef %5)
end_hunk_0
...
bb.a:
  ...
  %i.f = add i32 %2, -1                           ; 3 uses
  %i.g = icmp sgt i32 %2, 0
  br i1 %i.g, label %.preheader120.lr.ph, label %._crit_edge139
...
.preheader120:                                    ; preds = %.preheader120.lr.ph, %.loopexit
  %indvars.iv149.in = phi i64 [ %i.b, %.preheader120.lr.ph ], [ %indvars.iv149, %.loopexit ] ; 2 uses
  %indvars.iv149 = add nsw i64 %indvars.iv149.in, -1 ; 8 uses
  %i.j = sub nuw nsw i64 %i.i, %indvars.iv149
  %i.k = icmp samesign ugt i64 %indvars.iv149.in, 1 ; 2 uses
  br i1 %i.k, label %.lr.ph, label %.lr.ph129

bb.b:                                             ; preds = %.lr.ph
  %i.l = add nsw i32 %.0107121, -1                ; 2 uses
  %i.m = sext i32 %i.l to i64
  %i.n = icmp slt i64 %i.j, %i.m
  br i1 %i.n, label %.lr.ph, label %.lr.ph129, !llvm.loop !100

.lr.ph:                                           ; preds = %.preheader120, %bb.b
  %.0105122 = phi i32 [ %i.r, %bb.b ], [ 0, %.preheader120 ]
  %.0107121 = phi i32 [ %i.l, %bb.b ], [ %i.f, %.preheader120 ] ; 2 uses
  %i.o = zext nneg i32 %.0107121 to i64
  %i.p = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %i.o
  %i.q = load i32, ptr %i.p, align 4, !tbaa !8
  %i.r = tail call i32 @Gia_ManHashOr(ptr noundef %0, i32 noundef %.0105122, i32 noundef %i.q) #27 ; 3 uses
  %i.s = icmp eq i32 %i.r, 1
  br i1 %i.s, label %.thread, label %bb.b

.thread:                                          ; preds = %.lr.ph
  %i.t = getelementptr inbounds nuw [4 x i8], ptr %i.d, i64 %indvars.iv149
  store i32 0, ptr %i.t, align 4, !tbaa !8
  br label %.loopexit

.lr.ph129:                                        ; preds = %bb.b, %.preheader120
  %.promoted.ph = phi i32 [ 0, %.preheader120 ], [ %i.r, %bb.b ] ; 2 uses
  %i.u = getelementptr inbounds nuw [4 x i8], ptr %i.d, i64 %indvars.iv149
  br label %bb.c

bb.c:                                             ; preds = %.lr.ph129, %bb.e
  %indvars.iv = phi i64 [ %i.h, %.lr.ph129 ], [ %indvars.iv.next, %bb.e ] ; 5 uses
  %i.v = phi i32 [ %.promoted.ph, %.lr.ph129 ], [ %i.ae, %bb.e ]
  %.2127 = phi i32 [ %.promoted.ph, %.lr.ph129 ], [ %i.ah, %bb.e ] ; 2 uses
  %.not117 = icmp slt i64 %indvars.iv, %indvars.iv149
...
bb.e:                                             ; preds = %bb.c, %bb.d
  %i.z = phi i32 [ %i.y, %bb.d ], [ 0, %bb.c ]    ; 2 uses
  %i.aa = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %indvars.iv ; 2 uses
  %i.ab = load i32, ptr %i.aa, align 4, !tbaa !8
  %i.ac = xor i32 %i.ab, 1
  %i.ad = tail call i32 @Gia_ManHashAnd(ptr noundef %0, i32 noundef %i.z, i32 noundef %i.ac) #27
  %i.ae = tail call i32 @Gia_ManHashMux(ptr noundef %0, i32 noundef %.2127, i32 noundef %i.v, i32 noundef %i.ad) #27 ; 4 uses
  %i.af = load i32, ptr %i.aa, align 4, !tbaa !8
  %i.ag = tail call i32 @Gia_ManHashXor(ptr noundef %0, i32 noundef %i.z, i32 noundef %i.af) #27
  %i.ah = tail call i32 @Gia_ManHashOr(ptr noundef %0, i32 noundef %.2127, i32 noundef %i.ag) #27 ; 2 uses
  %indvars.iv.next = add nsw i64 %indvars.iv, -1
  %i.ai = icmp slt i64 %indvars.iv, 1
  %i.aj = icmp eq i32 %i.ah, 1
  %or.cond = select i1 %i.ai, i1 true, i1 %i.aj
  br i1 %or.cond, label %bb.f, label %bb.c, !llvm.loop !101

bb.f:                                             ; preds = %bb.e
  %i.ak = xor i32 %i.ae, 1                        ; 2 uses
  store i32 %i.ak, ptr %i.u, align 4, !tbaa !8
  %i.al = icmp eq i32 %i.ae, 1
  br i1 %i.al, label %.loopexit, label %.lr.ph133

.lr.ph133:                                        ; preds = %bb.f, %bb.h
  %indvars.iv141 = phi i64 [ %indvars.iv.next142, %bb.h ], [ 0, %bb.f ] ; 5 uses
  %.0132 = phi i32 [ %i.ax, %bb.h ], [ 0, %bb.f ] ; 3 uses
  %i.am = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %indvars.iv141 ; 2 uses
  %i.an = load i32, ptr %i.am, align 4, !tbaa !8  ; 2 uses
  %i.ao = xor i32 %i.an, 1
  %i.ap = tail call i32 @Gia_ManHashMux(ptr noundef %0, i32 noundef %.0132, i32 noundef %i.ao, i32 noundef %i.an) #27
  %.not118 = icmp slt i64 %indvars.iv141, %indvars.iv149
...
bb.h:                                             ; preds = %.lr.ph133, %bb.g
  %i.at = phi i32 [ %i.as, %bb.g ], [ 0, %.lr.ph133 ] ; 3 uses
  %i.au = load i32, ptr %i.am, align 4, !tbaa !8
  %i.av = tail call i32 @Gia_ManHashAnd(ptr noundef %0, i32 noundef %.0132, i32 noundef %i.at) #27
  %i.aw = tail call i32 @Gia_ManHashOr(ptr noundef %0, i32 noundef %.0132, i32 noundef %i.at) #27
  %i.ax = tail call i32 @Gia_ManHashMux(ptr noundef %0, i32 noundef %i.au, i32 noundef %i.av, i32 noundef %i.aw) #27
  %i.ay = tail call i32 @Gia_ManHashXor(ptr noundef %0, i32 noundef %i.ap, i32 noundef %i.at) #27
  %i.az = getelementptr inbounds nuw [4 x i8], ptr %i.e, i64 %indvars.iv141
...
._crit_edge134:                                   ; preds = %bb.h
  %i.ba = icmp eq i32 %i.ae, 0
  br i1 %i.ba, label %bb.i, label %.lr.ph136

bb.i:                                             ; preds = %._crit_edge134
  %i.bb = tail call ptr @Wlc_VecCopy(ptr noundef %6, ptr noundef nonnull %i.e, i32 noundef %2) ; 0 uses
  br label %.loopexit

.lr.ph136:                                        ; preds = %._crit_edge134, %.lr.ph136
  %indvars.iv144 = phi i64 [ %indvars.iv.next145, %.lr.ph136 ], [ 0, %._crit_edge134 ] ; 3 uses
  %i.bc = getelementptr inbounds nuw [4 x i8], ptr %i.e, i64 %indvars.iv144
  %i.bd = load i32, ptr %i.bc, align 4, !tbaa !8
  %i.be = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %indvars.iv144 ; 2 uses
  %i.bf = load i32, ptr %i.be, align 4, !tbaa !8
  %i.bg = tail call i32 @Gia_ManHashMux(ptr noundef %0, i32 noundef %i.ak, i32 noundef %i.bd, i32 noundef %i.bf) #27
  store i32 %i.bg, ptr %i.be, align 4, !tbaa !8
  %indvars.iv.next145 = add nuw nsw i64 %indvars.iv144, 1 ; 2 uses
  %exitcond148.not = icmp eq i64 %indvars.iv.next145, %wide.trip.count147
  br i1 %exitcond148.not, label %.loopexit, label %.lr.ph136, !llvm.loop !103

.loopexit:                                        ; preds = %.lr.ph136, %.thread, %bb.i, %bb.f
  br i1 %i.k, label %.preheader120, label %._crit_edge139, !llvm.loop !104
...
bb.l:                                             ; preds = %bb.k
  %i.bh = tail call ptr @Wlc_VecCopy(ptr noundef %6, ptr noundef %i.d, i32 noundef %2) ; 0 uses
  br label %bb.m
...
.lr.ph80.split.us.preheader113:                   ; preds = %.lr.ph80.split.us.preheader, %middle.block
end_hunk_1
