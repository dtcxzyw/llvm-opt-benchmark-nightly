...
.lr.ph31.split.us:                                ; preds = %.lr.ph31.split.us.preheader, %Scl_LibertyItem.exit22.us
  %.01830.us = phi ptr [ %i.y, %Scl_LibertyItem.exit22.us ], [ %i.f, %.lr.ph31.split.us.preheader ] ; 3 uses
  %i.k = getelementptr inbounds nuw i8, ptr %.01830.us, i64 16
  %i.l = load i64, ptr %i.k, align 8              ; 2 uses
  %i.m = getelementptr inbounds nuw i8, ptr %.01830.us, i64 24
