...
begin_hunk_0_@Acb_TransformPatchFunctions:bb.a
  ...
  %.val82 = load ptr, ptr %i.bj, align 8, !tbaa !87
  %i.de = getelementptr inbounds nuw [16 x i8], ptr %.val82, i64 %indvars.iv130
  %.val85 = load ptr, ptr %i.bk, align 8, !tbaa !72
  ...
  %i.di = load i32, ptr %i.d, align 4, !tbaa !73  ; 7 uses
  %i.dj = load i32, ptr %i.b, align 8, !tbaa !71
  %i.dk = icmp eq i32 %i.di, %i.dj
  br i1 %i.dk, label %bb.aa, label %.Vec_PtrPush.exit_crit_edge

.Vec_PtrPush.exit_crit_edge:                      ; preds = %bb.z
  %.pre144 = load ptr, ptr %i.i, align 8, !tbaa !72
...
bb.ab:                                            ; preds = %bb.aa
  %i.dm = load ptr, ptr %i.i, align 8, !tbaa !72  ; 2 uses
...
bb.ae:                                            ; preds = %bb.aa
  ...
  %.pre145 = load ptr, ptr %i.i, align 8, !tbaa !72 ; 3 uses
...
Vec_PtrGrow.exit12.sink.split.i:                  ; preds = %bb.ag, %bb.ah, %bb.ac, %bb.ad
  ...
  store ptr %storemerge, ptr %i.i, align 8, !tbaa !72
  store i32 %spec.select.sink.i100, ptr %i.b, align 8, !tbaa !71
  br label %Vec_PtrPush.exit
...
Vec_PtrPush.exit:                                 ; preds = %.Vec_PtrPush.exit_crit_edge, %bb.ae, %Vec_PtrGrow.exit12.sink.split.i
  ...
  store i32 %i.dw, ptr %i.d, align 4, !tbaa !73
  %i.dx = sext i32 %i.di to i64
  %i.dy = getelementptr inbounds [8 x i8], ptr %i.dv, i64 %i.dx
  store ptr %i.dh, ptr %i.dy, align 8, !tbaa !74
  %indvars.iv.next131 = add nuw nsw i64 %indvars.iv130, 1 ; 2 uses
  %.val88 = load i32, ptr %i.ah, align 4, !tbaa !88
  %i.dz = sext i32 %.val88 to i64
  %i.ea = icmp slt i64 %indvars.iv.next131, %i.dz
  br i1 %i.ea, label %bb.z, label %.critedge6, !llvm.loop !340
...
.critedge6:                                       ; preds = %Vec_PtrPush.exit, %Vec_IntStart.exit, %.critedge.preheader, %.critedge2.preheader
  ...
  %i.ec = load ptr, ptr %i.eb, align 8, !tbaa !32 ; 2 uses
...
Vec_IntFree.exit:                                 ; preds = %.critedge6, %bb.ai
  ...
  %i.ee = load ptr, ptr %i.ed, align 8, !tbaa !32 ; 2 uses
...
Vec_IntFree.exit104:                              ; preds = %Vec_IntFree.exit, %bb.aj
  ...
  store ptr %i.j, ptr %2, align 8, !tbaa !128
  ret ptr %i.b
}
...
bb.b:                                             ; preds = %bb.a
  %i.f = load i64, ptr %15, align 8, !tbaa !117
...
bb.c:                                             ; preds = %Abc_Clock.exit
  %i.k = load i64, ptr %14, align 8, !tbaa !117
...
Abc_Clock.exit190:                                ; preds = %Abc_Clock.exit, %bb.c
  ...
  %.val186 = load i32, ptr %i.r, align 4, !tbaa !30 ; 14 uses
  ...
  %i.y = load i32, ptr %i.x, align 4, !tbaa !30   ; 3 uses
  ...
  store i32 %spec.store.select.i.i, ptr %i.aa, align 8, !tbaa !31
...
Vec_IntAlloc.exit.i:                              ; preds = %bb.d, %Abc_Clock.exit190
  ...
  %.val6.i = load ptr, ptr %i.ai, align 8, !tbaa !32 ; 4 uses
  %i.aj = getelementptr i8, ptr %i.u, i64 8       ; 2 uses
  %.val8.i = load ptr, ptr %i.aj, align 8, !tbaa !32 ; 4 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load524 = load <4 x i32>, ptr %i.bd, align 4, !tbaa !33
  %i.be = getelementptr i8, ptr %next.gep523, i64 16
  store <4 x i32> %wide.load, ptr %next.gep523, align 4, !tbaa !33
  store <4 x i32> %wide.load524, ptr %i.be, align 4, !tbaa !33
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.bf = icmp eq i64 %index.next, %n.vec
  br i1 %i.bf, label %middle.block, label %vector.body, !llvm.loop !341
...
.lr.ph.i.i:                                       ; preds = %Vec_IntAlloc.exit.i, %bb.i
  ...
  %i.bg = load i32, ptr %.0337.i.i, align 4, !tbaa !33 ; 4 uses
  %i.bh = load i32, ptr %.08.i.i, align 4, !tbaa !33 ; 3 uses
  %i.bi = icmp eq i32 %i.bg, %i.bh
  br i1 %i.bi, label %bb.e, label %bb.f

bb.e:                                             ; preds = %.lr.ph.i.i
  %i.bj = getelementptr inbounds nuw i8, ptr %.0337.i.i, i64 4
  store i32 %i.bg, ptr %.0366.i.i, align 4, !tbaa !33
...
bb.h:                                             ; preds = %bb.f
  ...
  store i32 %i.bh, ptr %.0366.i.i, align 4, !tbaa !33
  br label %bb.i
...
bb.i:                                             ; preds = %bb.h, %bb.g, %bb.e
  ...
  br i1 %i.bq, label %.lr.ph.i.i, label %.preheader5.i.i, !llvm.loop !342
...
vector.body534:                                   ; preds = %vector.body534, %vector.ph532
  ...
  %wide.load538 = load <4 x i32>, ptr %next.gep536, align 4, !tbaa !33
  %wide.load539 = load <4 x i32>, ptr %i.cd, align 4, !tbaa !33
  %i.ce = getelementptr i8, ptr %next.gep537, i64 16
  store <4 x i32> %wide.load538, ptr %next.gep537, align 4, !tbaa !33
  store <4 x i32> %wide.load539, ptr %i.ce, align 4, !tbaa !33
  %index.next540 = add nuw i64 %index535, 8       ; 2 uses
  %i.cf = icmp eq i64 %index.next540, %n.vec533
  br i1 %i.cf, label %middle.block541, label %vector.body534, !llvm.loop !343
...
.lr.ph13.i.i:                                     ; preds = %.lr.ph13.i.i.preheader581, %.lr.ph13.i.i
  ...
  %i.ch = load i32, ptr %.23512.i.i, align 4, !tbaa !33
  %i.ci = getelementptr inbounds nuw i8, ptr %.23811.i.i, i64 4 ; 2 uses
  store i32 %i.ch, ptr %.23811.i.i, align 4, !tbaa !33
  %i.cj = icmp ult ptr %i.cg, %i.al
  br i1 %i.cj, label %.lr.ph13.i.i, label %.preheader.i.i, !llvm.loop !344
...
.lr.ph17.i.i:                                     ; preds = %.lr.ph17.i.i.preheader580, %.lr.ph17.i.i
  ...
  %i.cl = load i32, ptr %.216.i.i, align 4, !tbaa !33
  %i.cm = getelementptr inbounds nuw i8, ptr %.315.i.i, i64 4 ; 2 uses
  store i32 %i.cl, ptr %.315.i.i, align 4, !tbaa !33
  %i.cn = icmp ult ptr %i.ck, %i.an
  br i1 %i.cn, label %.lr.ph17.i.i, label %Vec_IntTwoMerge.exit, !llvm.loop !345
...
Vec_IntTwoMerge.exit:                             ; preds = %.lr.ph17.i.i, %middle.block541, %.preheader.i.i
  ...
  store i32 %i.cs, ptr %i.ac, align 4, !tbaa !30
  %i.ct = or i32 %5, %4
...
bb.k:                                             ; preds = %Vec_IntTwoMerge.exit
  %i.cv = load ptr, ptr %i.a, align 8, !tbaa !100
...
bb.l:                                             ; preds = %bb.k, %bb.j
  ...
  store i32 %spec.store.select.i, ptr %i.dd, align 8, !tbaa !71
...
Vec_PtrAlloc.exit:                                ; preds = %bb.l, %bb.m
  ...
  store i32 0, ptr %i.dm, align 4, !tbaa !88
  store i32 %spec.store.select.i, ptr %i.dl, align 8, !tbaa !86
...
Vec_WecAlloc.exit:                                ; preds = %Vec_PtrAlloc.exit, %bb.n
  ...
  store ptr %i.dp, ptr %i.dq, align 8, !tbaa !87
  ...
  store i32 0, ptr %i.ds, align 4, !tbaa !30
  store i32 100, ptr %i.dr, align 8, !tbaa !31
  ...
  store ptr %i.dt, ptr %i.du, align 8, !tbaa !32
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #34
  store ptr null, ptr %i.b, align 8, !tbaa !128
...
bb.o:                                             ; preds = %Vec_WecAlloc.exit
  ...
  store i32 %spec.store.select.i, ptr %i.dv, align 8, !tbaa !71
...
Vec_PtrAlloc.exit197:                             ; preds = %bb.o, %bb.p
  ...
  store ptr %i.ea, ptr %i.eb, align 8, !tbaa !72
  br label %bb.q
...
bb.t:                                             ; preds = %bb.s
  ...
  store i32 2, ptr %i.c, align 4, !tbaa !33
...
Vec_IntGrow.exit.i:                               ; preds = %bb.q, %bb.p
  ...
  store ptr %i.au, ptr %i.aq, align 8, !tbaa !32
...
bb.v:                                             ; preds = %bb.u, %bb.t
  ...
  store ptr %i.bd, ptr %i.ax, align 8, !tbaa !32
  br label %Vec_IntGrow.exit11.sink.split.i
...
Vec_IntGrow.exit11.sink.split.i:                  ; preds = %bb.v, %Vec_IntGrow.exit.i
  ...
  store i32 %spec.select.sink.i, ptr %i.ak, align 8, !tbaa !31
  %.pre = load i32, ptr %i.al, align 4, !tbaa !30
...
Vec_IntPush.exit:                                 ; preds = %bb.m, %bb.r, %Vec_IntGrow.exit11.sink.split.i
  ...
  store i32 %i.bh, ptr %i.al, align 4, !tbaa !30
...
bb.w:                                             ; preds = %Vec_IntPush.exit, %bb.l
  ...
  %.val36 = load ptr, ptr %i.bm, align 8, !tbaa !60
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.e = load ptr, ptr @stdout, align 8, !tbaa !129
...
bb.d:                                             ; preds = %bb.b
  %i.i = load ptr, ptr @stdout, align 8, !tbaa !129, !noalias !372
  %i.j = call i32 @vfprintf(ptr noundef %i.i, ptr noundef %1, ptr noundef nonnull %2) #34, !inline_history !371 ; 0 uses
  br label %bb.e
...
!21 = !{!"Vec_Str_t_", !16, i64 0, !16, i64 4, !20, i64 8}
!22 = !{!21, !16, i64 4}
!23 = !{!21, !16, i64 0}
!24 = !{!21, !20, i64 8}
!25 = !{!20, !20, i64 0}
...
!28 = !{!"p1 int", !19, i64 0}
!29 = !{!"Vec_Int_t_", !16, i64 0, !16, i64 4, !28, i64 8}
!30 = !{!29, !16, i64 4}
!31 = !{!29, !16, i64 0}
!32 = !{!29, !28, i64 8}
!33 = !{!16, !16, i64 0}
!34 = !{!"Ndr_Data_t_", !16, i64 0, !16, i64 4, !20, i64 8, !28, i64 16}
!35 = !{!34, !16, i64 4}
!36 = !{!34, !20, i64 8}
!37 = !{!34, !28, i64 16}
!38 = !{!34, !16, i64 0}
...
!42 = !{!"p1 _ZTS10Gia_Obj_t_", !19, i64 0}
!43 = !{!"p1 _ZTS10Vec_Int_t_", !19, i64 0}
!44 = !{!"p1 _ZTS10Gia_Rpr_t_", !19, i64 0}
!45 = !{!"p1 _ZTS10Vec_Wec_t_", !19, i64 0}
!46 = !{!"p1 _ZTS10Vec_Str_t_", !19, i64 0}
!47 = !{!"p1 _ZTS10Abc_Cex_t_", !19, i64 0}
!48 = !{!"p1 _ZTS10Vec_Ptr_t_", !19, i64 0}
!49 = !{!"p1 _ZTS10Gia_Plc_t_", !19, i64 0}
!50 = !{!"p1 _ZTS10Gia_Man_t_", !19, i64 0}
!51 = !{!"p1 _ZTS10Vec_Flt_t_", !19, i64 0}
!52 = !{!"float", !15, i64 0}
!53 = !{!"p1 _ZTS10Vec_Vec_t_", !19, i64 0}
!54 = !{!"long", !15, i64 0}
!55 = !{!"p1 _ZTS10Vec_Wrd_t_", !19, i64 0}
!56 = !{!"p1 _ZTS10Vec_Bit_t_", !19, i64 0}
!57 = !{!"p1 _ZTS10Gia_Dat_t_", !19, i64 0}
!58 = !{!"Gia_Man_t_", !20, i64 0, !20, i64 8, !16, i64 16, !16, i64 20, !16, i64 24, !16, i64 28, !42, i64 32, !28, i64 40, !16, i64 48, !16, i64 52, !16, i64 56, !43, i64 64, !43, i64 72, !29, i64 80, !29, i64 96, !16, i64 112, !16, i64 116, !16, i64 120, !29, i64 128, !28, i64 144, !28, i64 152, !43, i64 160, !16, i64 168, !16, i64 172, !16, i64 176, !16, i64 180, !28, i64 184, !44, i64 192, !28, i64 200, !28, i64 208, !28, i64 216, !16, i64 224, !16, i64 228, !28, i64 232, !16, i64 240, !43, i64 248, !43, i64 256, !43, i64 264, !45, i64 272, !45, i64 280, !43, i64 288, !19, i64 296, !43, i64 304, !43, i64 312, !46, i64 320, !20, i64 328, !43, i64 336, !43, i64 344, !43, i64 352, !43, i64 360, !43, i64 368, !47, i64 376, !47, i64 384, !48, i64 392, !29, i64 400, !29, i64 416, !43, i64 432, !43, i64 440, !43, i64 448, !43, i64 456, !43, i64 464, !43, i64 472, !43, i64 480, !43, i64 488, !43, i64 496, !43, i64 504, !43, i64 512, !20, i64 520, !49, i64 528, !50, i64 536, !51, i64 544, !51, i64 552, !43, i64 560, !43, i64 568, !43, i64 576, !43, i64 584, !43, i64 592, !16, i64 600, !52, i64 604, !52, i64 608, !43, i64 616, !28, i64 624, !16, i64 632, !48, i64 640, !48, i64 648, !48, i64 656, !43, i64 664, !43, i64 672, !43, i64 680, !43, i64 688, !43, i64 696, !43, i64 704, !43, i64 712, !43, i64 720, !43, i64 728, !53, i64 736, !51, i64 744, !19, i64 752, !19, i64 760, !19, i64 768, !54, i64 776, !54, i64 784, !19, i64 792, !28, i64 800, !16, i64 808, !16, i64 812, !16, i64 816, !16, i64 820, !16, i64 824, !16, i64 828, !16, i64 832, !16, i64 836, !16, i64 840, !16, i64 844, !16, i64 848, !16, i64 852, !55, i64 856, !55, i64 864, !55, i64 872, !55, i64 880, !43, i64 888, !43, i64 896, !43, i64 904, !56, i64 912, !16, i64 920, !16, i64 924, !16, i64 928, !43, i64 936, !16, i64 944, !16, i64 948, !43, i64 952, !43, i64 960, !48, i64 968, !55, i64 976, !43, i64 984, !43, i64 992, !16, i64 1000, !16, i64 1004, !55, i64 1008, !29, i64 1016, !29, i64 1032, !29, i64 1048, !57, i64 1064, !46, i64 1072, !46, i64 1080, !16, i64 1088, !16, i64 1092, !16, i64 1096, !16, i64 1100, !46, i64 1104, !43, i64 1112, !43, i64 1120, !43, i64 1128, !48, i64 1136}
!59 = !{!58, !16, i64 120}
!60 = !{!58, !42, i64 32}
!61 = !{!58, !28, i64 232}
!62 = !{!58, !20, i64 0}
!63 = !{!58, !43, i64 64}
!64 = !{!58, !16, i64 24}
!65 = !{!"Vec_Bit_t_", !16, i64 0, !16, i64 4, !28, i64 8}
!66 = !{!65, !16, i64 0}
!67 = !{!65, !28, i64 8}
!68 = !{!65, !16, i64 4}
!69 = !{!"any p2 pointer", !19, i64 0}
!70 = !{!"Vec_Ptr_t_", !16, i64 0, !16, i64 4, !69, i64 8}
!71 = !{!70, !16, i64 0}
!72 = !{!70, !69, i64 8}
!73 = !{!70, !16, i64 4}
!74 = !{!19, !19, i64 0}
...
!77 = !{!58, !43, i64 72}
!78 = !{!"p1 long", !19, i64 0}
!79 = !{!"Vec_Wrd_t_", !16, i64 0, !16, i64 4, !78, i64 8}
!80 = !{!79, !78, i64 8}
!81 = !{!79, !16, i64 4}
!82 = !{!79, !16, i64 0}
!83 = !{!"p1 float", !19, i64 0}
!84 = !{!"Vec_Flt_t_", !16, i64 0, !16, i64 4, !83, i64 8}
!85 = !{!"Vec_Wec_t_", !16, i64 0, !16, i64 4, !43, i64 8}
!86 = !{!85, !16, i64 0}
!87 = !{!85, !43, i64 8}
!88 = !{!85, !16, i64 4}
!89 = !{!"p1 _ZTS10Vec_Que_t_", !19, i64 0}
!90 = !{!"p1 _ZTS10Acb_Man_t_", !19, i64 0}
!91 = !{!"Acb_Ntk_t_", !90, i64 0, !16, i64 8, !16, i64 12, !16, i64 16, !16, i64 20, !16, i64 20, !16, i64 20, !29, i64 24, !29, i64 40, !29, i64 56, !29, i64 72, !16, i64 88, !16, i64 92, !16, i64 96, !16, i64 100, !16, i64 104, !21, i64 112, !29, i64 128, !29, i64 144, !29, i64 160, !29, i64 176, !29, i64 192, !79, i64 208, !29, i64 224, !29, i64 240, !29, i64 256, !29, i64 272, !29, i64 288, !29, i64 304, !29, i64 320, !29, i64 336, !29, i64 352, !29, i64 368, !29, i64 384, !29, i64 400, !84, i64 416, !85, i64 432, !85, i64 448, !21, i64 464, !29, i64 480, !89, i64 496, !29, i64 504, !29, i64 520, !29, i64 536, !29, i64 552}
!92 = !{!91, !90, i64 0}
!93 = !{!91, !16, i64 12}
!94 = !{!"p1 _ZTS10Abc_Nam_t_", !19, i64 0}
!95 = !{!"p1 _ZTS14Hash_IntMan_t_", !19, i64 0}
!96 = !{!"Acb_Man_t_", !20, i64 0, !20, i64 8, !94, i64 16, !94, i64 24, !94, i64 32, !95, i64 40, !29, i64 48, !29, i64 64, !29, i64 80, !29, i64 96, !15, i64 112, !15, i64 904, !15, i64 1300, !16, i64 1696, !70, i64 1704, !16, i64 1720, !21, i64 1728, !21, i64 1744, !19, i64 1760}
!97 = !{!96, !94, i64 16}
!98 = !{!"llvm.loop.peeled.count", i32 1}
!99 = !{!91, !16, i64 96}
!100 = !{!56, !56, i64 0}
!101 = !{!"Gia_Obj_t_", !16, i64 0, !16, i64 3, !16, i64 3, !16, i64 3, !16, i64 4, !16, i64 7, !16, i64 7, !16, i64 7, !16, i64 8}
!102 = !{!101, !16, i64 8}
!103 = !{!54, !54, i64 0}
!104 = !{!"p2 int", !69, i64 0}
!105 = !{!"Sat_Mem_t_", !15, i64 0, !15, i64 8, !15, i64 16, !15, i64 24, !16, i64 32, !16, i64 36, !16, i64 40, !16, i64 44, !104, i64 48}
!106 = !{!"p1 _ZTS8clause_t", !19, i64 0}
!107 = !{!"p1 _ZTS6veci_t", !19, i64 0}
!108 = !{!"veci_t", !16, i64 0, !16, i64 4, !28, i64 8}
!109 = !{!"double", !15, i64 0}
!110 = !{!"stats_t", !16, i64 0, !16, i64 4, !16, i64 8, !54, i64 16, !54, i64 24, !54, i64 32, !54, i64 40, !54, i64 48, !54, i64 56, !54, i64 64}
!111 = !{!"p1 double", !19, i64 0}
!112 = !{!"p1 _ZTS8_IO_FILE", !19, i64 0}
!113 = !{!"sat_solver_t", !16, i64 0, !16, i64 4, !16, i64 8, !16, i64 12, !105, i64 16, !16, i64 72, !16, i64 76, !106, i64 80, !107, i64 88, !16, i64 96, !16, i64 100, !16, i64 104, !16, i64 108, !16, i64 112, !54, i64 120, !54, i64 128, !54, i64 136, !78, i64 144, !78, i64 152, !16, i64 160, !16, i64 164, !108, i64 168, !20, i64 184, !16, i64 192, !28, i64 200, !20, i64 208, !20, i64 216, !20, i64 224, !20, i64 232, !28, i64 240, !28, i64 248, !28, i64 256, !108, i64 264, !108, i64 280, !108, i64 296, !108, i64 312, !28, i64 328, !108, i64 336, !16, i64 352, !16, i64 356, !16, i64 360, !109, i64 368, !109, i64 376, !16, i64 384, !16, i64 388, !16, i64 392, !110, i64 400, !16, i64 472, !16, i64 476, !16, i64 480, !16, i64 484, !16, i64 488, !54, i64 496, !54, i64 504, !54, i64 512, !108, i64 520, !111, i64 536, !16, i64 544, !16, i64 548, !16, i64 552, !108, i64 560, !108, i64 576, !16, i64 592, !16, i64 596, !16, i64 600, !28, i64 608, !19, i64 616, !16, i64 624, !112, i64 632, !16, i64 640, !16, i64 644, !108, i64 648, !108, i64 664, !108, i64 680, !19, i64 696, !19, i64 704, !16, i64 712, !19, i64 720}
!114 = !{!113, !28, i64 328}
!115 = !{!55, !55, i64 0}
!116 = !{!"timespec", !54, i64 0, !54, i64 8}
!117 = !{!116, !54, i64 0}
!118 = !{!116, !54, i64 8}
!119 = !{!"p1 _ZTS10Aig_Man_t_", !19, i64 0}
!120 = !{!"Cnf_Dat_t_", !119, i64 0, !16, i64 8, !16, i64 12, !16, i64 16, !104, i64 24, !28, i64 32, !28, i64 40, !28, i64 48, !20, i64 56, !43, i64 64}
!121 = !{!120, !16, i64 8}
!122 = !{!120, !16, i64 16}
!123 = !{!120, !104, i64 24}
!124 = !{!28, !28, i64 0}
...
!139 = distinct !{!139, !27, !39, !40}
!140 = distinct !{!140, !27, !39}
!141 = distinct !{!141, !"LVerDomain"}
!142 = distinct !{!142, !141}
!143 = distinct !{!143, !141}
!144 = distinct !{!144, !141}
!145 = distinct !{!145, !27, !39, !40}
!146 = distinct !{!146, !27, !39}
!147 = distinct !{!147, !27}
!148 = distinct !{!148, !27}
!149 = distinct !{!149, !27}
!150 = distinct !{!150, !27}
