...
.lr.ph.split.us.i.i:                              ; preds = %.preheader.i.i, %bb.m
  ...
  %.12538.us.i.i = phi i32 [ %i.ci, %bb.m ], [ 0, %.preheader.i.i ]
...
bb.m:                                             ; preds = %.lr.ph.split.us.i.i
  ...
  %i.ci = add nuw nsw i32 %.12538.us.i.i, 1       ; 2 uses
...
cuddZddSiftingDown.exit.i:                        ; preds = %bb.j, %cuddZddSiftingDown.exit.i
  %.02137.i.i = phi ptr [ %i.co, %cuddZddSiftingDown.exit.i ], [ %i.bn, %bb.j ] ; 2 uses
  %.02236.i.i = phi i32 [ %spec.select32.fr.i.i, %cuddZddSiftingDown.exit.i ], [ -1, %bb.j ]
  %.02435.i.i = phi i32 [ %i.cp, %cuddZddSiftingDown.exit.i ], [ 0, %bb.j ] ; 2 uses
  %.02634.i.i = phi i32 [ %spec.select.i115.i, %cuddZddSiftingDown.exit.i ], [ %i.bj, %bb.j ] ; 2 uses
  %i.ck = getelementptr inbounds nuw i8, ptr %.02137.i.i, i64 12
  %i.cl = load i32, ptr %i.ck, align 4, !tbaa !106 ; 2 uses
  %i.cm = icmp slt i32 %i.cl, %.02634.i.i
  %spec.select.i115.i = tail call i32 @llvm.smin.i32(i32 %i.cl, i32 %.02634.i.i) ; 2 uses
  %spec.select32.i.i = select i1 %i.cm, i32 %.02435.i.i, i32 %.02236.i.i
  %spec.select32.fr.i.i = freeze i32 %spec.select32.i.i ; 3 uses
  %i.cn = getelementptr inbounds nuw i8, ptr %.02137.i.i, i64 16
  %i.co = load ptr, ptr %i.cn, align 8, !tbaa !107 ; 2 uses
  %i.cp = add nuw nsw i32 %.02435.i.i, 1
...
.lr.ph.i118.i:                                    ; preds = %bb.p, %bb.r
  ...
  %.04051.i120.i = phi ptr [ %i.da, %bb.r ], [ null, %bb.p ] ; 3 uses
  %.04250.i121.i = phi i32 [ %.03953.i122.i, %bb.r ], [ %2, %bb.p ] ; 3 uses
  %.03953.i122.i = add nsw i32 %.04250.i121.i, -1 ; 4 uses
  %i.cy = tail call i32 @cuddZddSwapInPlace(ptr noundef nonnull %0, i32 noundef %.03953.i122.i, i32 noundef %.04250.i121.i) ; 4 uses
...
bb.r:                                             ; preds = %bb.q
  store i32 %.03953.i122.i, ptr %i.da, align 8, !tbaa !102
  ...
  store ptr %.04051.i120.i, ptr %i.de, align 8, !tbaa !107
...
bb.t:                                             ; preds = %bb.t, %.lr.ph58.i126.i
  ...
  %.257.i128.i = phi ptr [ %.04051.i120.i, %.lr.ph58.i126.i ], [ %i.dm, %bb.t ] ; 5 uses
...
.lr.ph.split.us.i145.i:                           ; preds = %.preheader.i139.i, %bb.u
  ...
  %.12538.us.i147.i = phi i32 [ %i.dv, %bb.u ], [ 0, %.preheader.i139.i ]
...
bb.u:                                             ; preds = %.lr.ph.split.us.i145.i
  ...
  %i.dv = add nuw nsw i32 %.12538.us.i147.i, 1    ; 2 uses
...
cuddZddSiftingUp.exit.i:                          ; preds = %bb.r, %cuddZddSiftingUp.exit.i
  %.02137.i131.i = phi ptr [ %i.eb, %cuddZddSiftingUp.exit.i ], [ %i.da, %bb.r ] ; 2 uses
  %.02236.i132.i = phi i32 [ %spec.select32.fr.i137.i, %cuddZddSiftingUp.exit.i ], [ -1, %bb.r ]
  %.02435.i133.i = phi i32 [ %i.ec, %cuddZddSiftingUp.exit.i ], [ 0, %bb.r ] ; 2 uses
  %.02634.i134.i = phi i32 [ %spec.select.i135.i, %cuddZddSiftingUp.exit.i ], [ %i.bj, %bb.r ] ; 2 uses
  %i.dx = getelementptr inbounds nuw i8, ptr %.02137.i131.i, i64 12
  %i.dy = load i32, ptr %i.dx, align 4, !tbaa !106 ; 2 uses
  %i.dz = icmp slt i32 %i.dy, %.02634.i134.i
  %spec.select.i135.i = tail call i32 @llvm.smin.i32(i32 %i.dy, i32 %.02634.i134.i) ; 2 uses
  %spec.select32.i136.i = select i1 %i.dz, i32 %.02435.i133.i, i32 %.02236.i132.i
  %spec.select32.fr.i137.i = freeze i32 %spec.select32.i136.i ; 3 uses
  %i.ea = getelementptr inbounds nuw i8, ptr %.02137.i131.i, i64 16
  %i.eb = load ptr, ptr %i.ea, align 8, !tbaa !107 ; 2 uses
  %i.ec = add nuw nsw i32 %.02435.i133.i, 1
...
.lr.ph.i154.i:                                    ; preds = %bb.x, %bb.z
  ...
  %.04051.i156.i = phi ptr [ %i.ep, %bb.z ], [ null, %bb.x ] ; 3 uses
  %.04250.i157.i = phi i32 [ %.03953.i158.i, %bb.z ], [ %i.bg, %bb.x ] ; 4 uses
  %.03953.i158.i = add nsw i32 %.04250.i157.i, 1  ; 5 uses
  %i.en = tail call i32 @cuddZddSwapInPlace(ptr noundef nonnull %0, i32 noundef %.04250.i157.i, i32 noundef %.03953.i158.i) ; 4 uses
...
bb.z:                                             ; preds = %bb.y
  ...
  store i32 %.03953.i158.i, ptr %i.er, align 4, !tbaa !105
  ...
  store ptr %.04051.i156.i, ptr %i.et, align 8, !tbaa !107
...
bb.ab:                                            ; preds = %bb.ab, %.lr.ph58.i163.i
  ...
  %.257.i165.i = phi ptr [ %.04051.i156.i, %.lr.ph58.i163.i ], [ %i.fb, %bb.ab ] ; 5 uses
...
.lr.ph.i171.i:                                    ; preds = %cuddZddSiftingDown.exit168.i, %bb.ad
  ...
  %.04051.i173.i = phi ptr [ %i.fg, %bb.ad ], [ null, %cuddZddSiftingDown.exit168.i ] ; 3 uses
  %.04250.i174.i = phi i32 [ %.03953.i175.i, %bb.ad ], [ %.03953.i158.i, %cuddZddSiftingDown.exit168.i ] ; 3 uses
  %.03953.i175.i = add nsw i32 %.04250.i174.i, -1 ; 4 uses
  %i.fe = tail call i32 @cuddZddSwapInPlace(ptr noundef nonnull %0, i32 noundef %.03953.i175.i, i32 noundef %.04250.i174.i) ; 4 uses
...
bb.ad:                                            ; preds = %bb.ac
  store i32 %.03953.i175.i, ptr %i.fg, align 8, !tbaa !102
  ...
  store ptr %.04051.i173.i, ptr %i.fk, align 8, !tbaa !107
...
bb.af:                                            ; preds = %bb.af, %.lr.ph58.i180.i
  ...
  %.257.i182.i = phi ptr [ %.04051.i173.i, %.lr.ph58.i180.i ], [ %i.fs, %bb.af ] ; 5 uses
...
.lr.ph.split.us.i200.i:                           ; preds = %.preheader.i194.i, %bb.ag
  ...
  %.12538.us.i202.i = phi i32 [ %i.gb, %bb.ag ], [ 0, %.preheader.i194.i ]
...
bb.ag:                                            ; preds = %.lr.ph.split.us.i200.i
  ...
  %i.gb = add nuw nsw i32 %.12538.us.i202.i, 1    ; 2 uses
...
cuddZddSiftingUp.exit185.i:                       ; preds = %bb.ad, %cuddZddSiftingUp.exit185.i
  %.02137.i186.i = phi ptr [ %i.gh, %cuddZddSiftingUp.exit185.i ], [ %i.fg, %bb.ad ] ; 2 uses
  %.02236.i187.i = phi i32 [ %spec.select32.fr.i192.i, %cuddZddSiftingUp.exit185.i ], [ -1, %bb.ad ]
  %.02435.i188.i = phi i32 [ %i.gi, %cuddZddSiftingUp.exit185.i ], [ 0, %bb.ad ] ; 2 uses
  %.02634.i189.i = phi i32 [ %spec.select.i190.i, %cuddZddSiftingUp.exit185.i ], [ %i.bj, %bb.ad ] ; 2 uses
  %i.gd = getelementptr inbounds nuw i8, ptr %.02137.i186.i, i64 12
  %i.ge = load i32, ptr %i.gd, align 4, !tbaa !106 ; 2 uses
  %i.gf = icmp slt i32 %i.ge, %.02634.i189.i
  %spec.select.i190.i = tail call i32 @llvm.smin.i32(i32 %i.ge, i32 %.02634.i189.i) ; 2 uses
  %spec.select32.i191.i = select i1 %i.gf, i32 %.02435.i188.i, i32 %.02236.i187.i
  %spec.select32.fr.i192.i = freeze i32 %spec.select32.i191.i ; 3 uses
  %i.gg = getelementptr inbounds nuw i8, ptr %.02137.i186.i, i64 16
  %i.gh = load ptr, ptr %i.gg, align 8, !tbaa !107 ; 2 uses
  %i.gi = add nuw nsw i32 %.02435.i188.i, 1
...
.lr.ph.i209.i:                                    ; preds = %bb.x, %bb.ak
  ...
  %.04051.i211.i = phi ptr [ %i.gs, %bb.ak ], [ null, %bb.x ] ; 3 uses
  %.04250.i212.i = phi i32 [ %.03953.i213.i, %bb.ak ], [ %i.bg, %bb.x ] ; 4 uses
  %.03953.i213.i = add nsw i32 %.04250.i212.i, -1 ; 5 uses
  %i.gq = tail call i32 @cuddZddSwapInPlace(ptr noundef nonnull %0, i32 noundef %.03953.i213.i, i32 noundef %.04250.i212.i) ; 4 uses
...
bb.ak:                                            ; preds = %bb.aj
  store i32 %.03953.i213.i, ptr %i.gs, align 8, !tbaa !102
  ...
  store ptr %.04051.i211.i, ptr %i.gw, align 8, !tbaa !107
...
bb.am:                                            ; preds = %bb.am, %.lr.ph58.i218.i
  ...
  %.257.i220.i = phi ptr [ %.04051.i211.i, %.lr.ph58.i218.i ], [ %i.he, %bb.am ] ; 5 uses
...
.lr.ph.i226.i:                                    ; preds = %cuddZddSiftingUp.exit223.i, %bb.ao
  ...
  %.04051.i228.i = phi ptr [ %i.hj, %bb.ao ], [ null, %cuddZddSiftingUp.exit223.i ] ; 3 uses
  %.04250.i229.i = phi i32 [ %.03953.i230.i, %bb.ao ], [ %.03953.i213.i, %cuddZddSiftingUp.exit223.i ] ; 3 uses
  %.03953.i230.i = add nsw i32 %.04250.i229.i, 1  ; 4 uses
  %i.hh = tail call i32 @cuddZddSwapInPlace(ptr noundef nonnull %0, i32 noundef %.04250.i229.i, i32 noundef %.03953.i230.i) ; 4 uses
...
bb.ao:                                            ; preds = %bb.an
  ...
  store i32 %.03953.i230.i, ptr %i.hl, align 4, !tbaa !105
  ...
  store ptr %.04051.i228.i, ptr %i.hn, align 8, !tbaa !107
...
bb.aq:                                            ; preds = %bb.aq, %.lr.ph58.i235.i
  ...
  %.257.i237.i = phi ptr [ %.04051.i228.i, %.lr.ph58.i235.i ], [ %i.hv, %bb.aq ] ; 5 uses
...
.lr.ph.split.us.i255.i:                           ; preds = %.preheader.i249.i, %bb.ar
  ...
  %.12538.us.i257.i = phi i32 [ %i.ie, %bb.ar ], [ 0, %.preheader.i249.i ]
...
bb.ar:                                            ; preds = %.lr.ph.split.us.i255.i
  ...
  %i.ie = add nuw nsw i32 %.12538.us.i257.i, 1    ; 2 uses
...
cuddZddSiftingDown.exit240.i:                     ; preds = %bb.ao, %cuddZddSiftingDown.exit240.i
  %.02137.i241.i = phi ptr [ %i.ik, %cuddZddSiftingDown.exit240.i ], [ %i.hj, %bb.ao ] ; 2 uses
  %.02236.i242.i = phi i32 [ %spec.select32.fr.i247.i, %cuddZddSiftingDown.exit240.i ], [ -1, %bb.ao ]
  %.02435.i243.i = phi i32 [ %i.il, %cuddZddSiftingDown.exit240.i ], [ 0, %bb.ao ] ; 2 uses
  %.02634.i244.i = phi i32 [ %spec.select.i245.i, %cuddZddSiftingDown.exit240.i ], [ %i.bj, %bb.ao ] ; 2 uses
  %i.ig = getelementptr inbounds nuw i8, ptr %.02137.i241.i, i64 12
  %i.ih = load i32, ptr %i.ig, align 4, !tbaa !106 ; 2 uses
  %i.ii = icmp slt i32 %i.ih, %.02634.i244.i
  %spec.select.i245.i = tail call i32 @llvm.smin.i32(i32 %i.ih, i32 %.02634.i244.i) ; 2 uses
  %spec.select32.i246.i = select i1 %i.ii, i32 %.02435.i243.i, i32 %.02236.i242.i
  %spec.select32.fr.i247.i = freeze i32 %spec.select32.i246.i ; 3 uses
  %i.ij = getelementptr inbounds nuw i8, ptr %.02137.i241.i, i64 16
  %i.ik = load ptr, ptr %i.ij, align 8, !tbaa !107 ; 2 uses
  %i.il = add nuw nsw i32 %.02435.i243.i, 1
...
.lr.ph.i:                                         ; preds = %bb.as, %bb.at, %bb.ar, %bb.ah, %bb.ai, %bb.ag, %bb.n, %bb.o, %bb.m, %.preheader.i194.i, %.preheader.i249.i, %.preheader.i.i
  %.087384.i = phi ptr [ %i.bn, %.preheader.i.i ], [ %i.hj, %.preheader.i249.i ], [ %i.ep, %.preheader.i194.i ], [ %i.ep, %bb.ag ], [ %i.hj, %bb.ar ], [ %i.bn, %bb.n ], [ %i.bn, %bb.m ], [ %i.ep, %bb.ah ], [ %i.bn, %bb.o ], [ %i.ep, %bb.ai ], [ %i.hj, %bb.at ], [ %i.hj, %bb.as ]
  %.088383.i = phi ptr [ null, %.preheader.i.i ], [ %i.gs, %.preheader.i249.i ], [ %i.fg, %.preheader.i194.i ], [ %i.fg, %bb.ag ], [ %i.gs, %bb.ar ], [ null, %bb.n ], [ null, %bb.m ], [ %i.fg, %bb.ah ], [ null, %bb.o ], [ %i.fg, %bb.ai ], [ %i.gs, %bb.at ], [ %i.gs, %bb.as ]
...
.preheader276.i:                                  ; preds = %bb.w, %bb.v, %bb.u, %..preheader276_crit_edge.i
  %.088377.i = phi ptr [ %i.da, %bb.u ], [ %.088383.i, %..preheader276_crit_edge.i ], [ %i.da, %bb.v ], [ %i.da, %bb.w ] ; 2 uses
  %.not112305.i = icmp eq ptr %.088377.i, null
  br i1 %.not112305.i, label %cuddZddSiftingAux.exit, label %.lr.ph307.i

.lr.ph307.i:                                      ; preds = %.preheader276.i, %.preheader.i139.i
  %.088377398.i = phi ptr [ %.088377.i, %.preheader276.i ], [ %i.da, %.preheader.i139.i ]
  %.promoted308.i = load ptr, ptr %i.ay, align 8, !tbaa !94
  br label %bb.av

bb.au:                                            ; preds = %bb.au, %.lr.ph.i
  %i.it = phi ptr [ %.promoted.i, %.lr.ph.i ], [ %.1304.i, %bb.au ]
  %.1304.i = phi ptr [ %.087384.i, %.lr.ph.i ], [ %i.iv, %bb.au ] ; 5 uses
...
bb.av:                                            ; preds = %bb.av, %.lr.ph307.i
  %i.iy = phi ptr [ %.promoted308.i, %.lr.ph307.i ], [ %.189306.i, %bb.av ]
  %.189306.i = phi ptr [ %.088377398.i, %.lr.ph307.i ], [ %i.ja, %bb.av ] ; 5 uses
  %i.iz = getelementptr inbounds nuw i8, ptr %.189306.i, i64 16
  %i.ja = load ptr, ptr %i.iz, align 8, !tbaa !107 ; 2 uses
  %i.jb = getelementptr inbounds nuw i8, ptr %.189306.i, i64 4
  store i32 0, ptr %i.jb, align 4, !tbaa !90
  %i.jc = getelementptr inbounds nuw i8, ptr %.189306.i, i64 8
...
.lr.ph311.i:                                      ; preds = %cuddZddSiftingDown.exit168.i, %.lr.ph.split.i250.i, %.lr.ph.split.us.i255.i, %.lr.ph.split.i195.i, %.lr.ph.split.us.i200.i, %.lr.ph.split.i.i, %.lr.ph.split.us.i.i, %bb.ae, %..loopexit_crit_edge.i184.i
  ...
  %.290394.i = phi ptr [ %i.fg, %.lr.ph.split.us.i200.i ], [ null, %..loopexit_crit_edge.i184.i ], [ null, %.lr.ph.split.us.i.i ], [ %i.fg, %.lr.ph.split.i195.i ], [ null, %.lr.ph.split.i.i ], [ null, %bb.ae ], [ %i.gs, %.lr.ph.split.i250.i ], [ %i.gs, %.lr.ph.split.us.i255.i ], [ null, %cuddZddSiftingDown.exit168.i ]
...
.preheader.i.sink.split:                          ; preds = %bb.aq, %bb.aw
  ...
  %.290389.i.ph = phi ptr [ %.290394.i, %bb.aw ], [ %i.gs, %bb.aq ]
...
.preheader.i:                                     ; preds = %.lr.ph.split.i140.i, %.lr.ph.split.us.i145.i, %.preheader.i.sink.split, %bb.ap
  %.290389.i = phi ptr [ %.290389.i.ph, %.preheader.i.sink.split ], [ %i.gs, %bb.ap ], [ %i.da, %.lr.ph.split.us.i145.i ], [ %i.da, %.lr.ph.split.i140.i ] ; 2 uses
  %.not114313.i = icmp eq ptr %.290389.i, null
...
.lr.ph315.i:                                      ; preds = %cuddZddSiftingUp.exit223.i, %.preheader.i
  %.290389404.i = phi ptr [ %.290389.i, %.preheader.i ], [ %i.gs, %cuddZddSiftingUp.exit223.i ]
...
bb.ax:                                            ; preds = %bb.ax, %.lr.ph315.i
  %i.ji = phi ptr [ %.promoted316.i, %.lr.ph315.i ], [ %.391314.i, %bb.ax ]
  %.391314.i = phi ptr [ %.290389404.i, %.lr.ph315.i ], [ %i.jk, %bb.ax ] ; 5 uses
  %i.jj = getelementptr inbounds nuw i8, ptr %.391314.i, i64 16
  %i.jk = load ptr, ptr %i.jj, align 8, !tbaa !107 ; 2 uses
  %i.jl = getelementptr inbounds nuw i8, ptr %.391314.i, i64 4
  store i32 0, ptr %i.jl, align 4, !tbaa !90
  %i.jm = getelementptr inbounds nuw i8, ptr %.391314.i, i64 8
...
..loopexit_crit_edge.i:                           ; preds = %bb.ax
  store ptr %.391314.i, ptr %i.ay, align 8, !tbaa !94
  br label %cuddZddSiftingAux.exit.thread

..loopexit277_crit_edge.i:                        ; preds = %bb.av
  store ptr %.189306.i, ptr %i.ay, align 8, !tbaa !94
...
bb.bc:                                            ; preds = %.thread66, %bb.ba, %bb.bb, %bb.ay, %._crit_edge112
  %.0 = phi i32 [ 1, %bb.ay ], [ 1, %._crit_edge112 ], [ 0, %bb.bb ], [ 0, %bb.ba ], [ 0, %.thread66 ]
  ret i32 %.0
}
