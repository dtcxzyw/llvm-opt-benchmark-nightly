...
.lr.ph.i154.i:                                    ; preds = %bb.x, %bb.z
  ...
  %.04250.i157.i = phi i32 [ %.03953.i158.i, %bb.z ], [ %i.bg, %bb.x ] ; 3 uses
...
.lr.ph.i171.i:                                    ; preds = %bb.z, %bb.ad
  ...
  %.04051.i173.i = phi ptr [ %i.fg, %bb.ad ], [ null, %bb.z ] ; 3 uses
  %.04250.i174.i = phi i32 [ %.03953.i175.i, %bb.ad ], [ %.03953.i158.i, %bb.z ] ; 3 uses
...
.lr.ph311.i:                                      ; preds = %.lr.ph.split.i250.i, %.lr.ph.split.us.i255.i, %.lr.ph.split.i195.i, %.lr.ph.split.us.i200.i, %.lr.ph.split.i.i, %.lr.ph.split.us.i.i, %bb.ae, %..loopexit_crit_edge.i184.i
  ...
  %.290394.i = phi ptr [ null, %.lr.ph.split.i.i ], [ null, %..loopexit_crit_edge.i184.i ], [ %i.gs, %.lr.ph.split.us.i255.i ], [ %i.fg, %.lr.ph.split.us.i200.i ], [ null, %.lr.ph.split.us.i.i ], [ null, %bb.ae ], [ %i.fg, %.lr.ph.split.i195.i ], [ %i.gs, %.lr.ph.split.i250.i ]
