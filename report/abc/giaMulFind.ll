...
bb.a:
  ...
  %.val59 = load i32, ptr %i.a, align 4, !tbaa !35 ; 2 uses
  %i.b = icmp sgt i32 %.val59, 0
  br i1 %i.b, label %.lr.ph, label %.critedge

.lr.ph:                                           ; preds = %bb.a
  %i.c = getelementptr i8, ptr %1, i64 8
  %.val67 = load ptr, ptr %i.c, align 8, !tbaa !37 ; 2 uses
  %i.d = getelementptr i8, ptr %0, i64 8
  %.val69 = load ptr, ptr %i.d, align 8, !tbaa !41 ; 2 uses
...
bb.b:                                             ; preds = %.lr.ph, %Vec_IntFind.exit.thread
  ...
  %i.e = getelementptr inbounds nuw [4 x i8], ptr %.val67, i64 %indvars.iv
  %i.f = load i32, ptr %i.e, align 4, !tbaa !31
  %i.g = sext i32 %i.f to i64
  %i.h = getelementptr inbounds [16 x i8], ptr %.val69, i64 %i.g ; 2 uses
  %i.i = getelementptr i8, ptr %i.h, i64 4
  %.val58 = load i32, ptr %i.i, align 4, !tbaa !35 ; 2 uses
  %i.j = icmp sgt i32 %.val58, 0
...
.split.loop.exit14.i:                             ; preds = %.critedge.i
  %i.z = getelementptr inbounds nuw [4 x i8], ptr %.val13.i, i64 %indvars.iv.i70
  %i.aa = getelementptr inbounds nuw i8, ptr %i.z, i64 4
  %i.ab = load i32, ptr %i.aa, align 4, !tbaa !31
  br label %.critedge.lr.ph.i74

.critedge.lr.ph.i74:                              ; preds = %bb.g, %.split.loop.exit14.i
  %.010.i = phi i32 [ %i.ab, %.split.loop.exit14.i ], [ -1, %bb.g ] ; 2 uses
  br label %.critedge.i76

bb.h:                                             ; preds = %.critedge.i76
...
.split.loop.exit14.i79:                           ; preds = %.critedge.i76
  %i.ai = getelementptr inbounds nuw [4 x i8], ptr %.val13.i, i64 %indvars.iv.i77
...
Gia_ManMulFindNextEntryCount.exit80:              ; preds = %bb.h, %bb.f, %.split.loop.exit14.i79
  ...
  br i1 %i.an, label %.lr.ph122, label %.critedge

.lr.ph122:                                        ; preds = %Gia_ManMulFindNextEntryCount.exit80, %Vec_IntFind.exit88.thread
  %.val57135 = phi i32 [ %.val57, %Vec_IntFind.exit88.thread ], [ %.val57120, %Gia_ManMulFindNextEntryCount.exit80 ] ; 2 uses
  %indvars.iv132 = phi i64 [ %indvars.iv.next133, %Vec_IntFind.exit88.thread ], [ 0, %Gia_ManMulFindNextEntryCount.exit80 ] ; 2 uses
  %i.ao = getelementptr inbounds nuw [4 x i8], ptr %.val67, i64 %indvars.iv132
  %i.ap = load i32, ptr %i.ao, align 4, !tbaa !31
  %i.aq = sext i32 %i.ap to i64
  %i.ar = getelementptr inbounds [16 x i8], ptr %.val69, i64 %i.aq ; 2 uses
  %i.as = getelementptr i8, ptr %i.ar, i64 4      ; 2 uses
  %.val = load i32, ptr %i.as, align 4, !tbaa !35 ; 2 uses
  %i.at = icmp sgt i32 %.val, 0
  br i1 %i.at, label %.lr.ph.i82, label %Vec_IntFind.exit88.thread

.lr.ph.i82:                                       ; preds = %.lr.ph122
  %i.au = getelementptr inbounds nuw i8, ptr %i.ar, i64 8
  %i.av = load ptr, ptr %i.au, align 8, !tbaa !37
  %wide.trip.count.i83 = zext nneg i32 %.val to i64
  br label %bb.i

bb.i:                                             ; preds = %bb.j, %.lr.ph.i82
  %indvars.iv.i84 = phi i64 [ 0, %.lr.ph.i82 ], [ %indvars.iv.next.i85, %bb.j ] ; 2 uses
  %i.aw = getelementptr inbounds nuw [4 x i8], ptr %i.av, i64 %indvars.iv.i84
  %i.ax = load i32, ptr %i.aw, align 4, !tbaa !31
  %i.ay = icmp eq i32 %i.ax, %2
  br i1 %i.ay, label %Vec_IntFind.exit88, label %bb.j
...
bb.j:                                             ; preds = %bb.i
  ...
  br i1 %exitcond.not.i86, label %Vec_IntFind.exit88.thread, label %bb.i, !llvm.loop !74

Vec_IntFind.exit88:                               ; preds = %bb.i
  store i32 0, ptr %i.as, align 4, !tbaa !35
  %.val57.pre = load i32, ptr %i.a, align 4, !tbaa !35
  br label %Vec_IntFind.exit88.thread

Vec_IntFind.exit88.thread:                        ; preds = %bb.j, %Vec_IntFind.exit88, %.lr.ph122
  %.val57 = phi i32 [ %.val57135, %.lr.ph122 ], [ %.val57.pre, %Vec_IntFind.exit88 ], [ %.val57135, %bb.j ] ; 2 uses
  %indvars.iv.next133 = add nuw nsw i64 %indvars.iv132, 1 ; 2 uses
  %i.az = sext i32 %.val57 to i64
  %i.ba = icmp slt i64 %indvars.iv.next133, %i.az
  br i1 %i.ba, label %.lr.ph122, label %.critedge, !llvm.loop !88
...
.critedge:                                        ; preds = %Vec_IntFind.exit.thread, %Vec_IntFind.exit88.thread, %bb.a, %Gia_ManMulFindNextEntryCount.exit80
  %.355 = phi i32 [ 1, %Gia_ManMulFindNextEntryCount.exit80 ], [ 0, %bb.a ], [ 1, %Vec_IntFind.exit88.thread ], [ 0, %Vec_IntFind.exit.thread ]
  ret i32 %.355
}
...
bb.f:                                             ; preds = %.lr.ph199, %.critedge12
  ...
  %.1110198 = phi i32 [ 1, %.lr.ph199 ], [ %.pre-phi264, %.critedge12 ] ; 3 uses
  %.1192 = add nsw i32 %.1110198, 1               ; 4 uses
  %i.ax = icmp slt i32 %.1192, %.val120247
  br i1 %i.ax, label %.lr.ph196, label %.critedge12

.lr.ph196:                                        ; preds = %bb.f
  %.val126 = load ptr, ptr %i.au, align 8, !tbaa !37
  %i.ay = sext i32 %.1110198 to i64
...
Vec_IntDrop.exit:                                 ; preds = %bb.p, %Vec_IntPush.exit
  ...
  %i.cj = icmp slt i32 %.2111194, %i.ci
...
.critedge12:                                      ; preds = %.lr.ph196, %.critedge12.loopexit, %bb.f
  %.pre-phi264 = phi i32 [ %.1192, %bb.f ], [ %.pre263, %.critedge12.loopexit ], [ %.1192, %.lr.ph196 ] ; 2 uses
...
Vec_WecPushLevel.exit152.sink.split:              ; preds = %bb.ag, %Vec_WecGrow.exit.i151
  %.sink296.a = phi i32 [ %i.ei, %Vec_WecGrow.exit.i151 ], [ %i.dx, %bb.ag ]
  %.pn = phi ptr [ %i.eh, %Vec_WecGrow.exit.i151 ], [ %i.eo, %bb.ag ] ; 2 uses
  %.sink = phi i32 [ 16, %Vec_WecGrow.exit.i151 ], [ %i.ej, %bb.ag ] ; 2 uses
  %.sink293 = getelementptr inbounds [16 x i8], ptr %.pn, i64 %i.ea
  %i.ep = sext i32 %.sink296.a to i64
  %i.eq = shl nsw i64 %i.ep, 4
  tail call void @llvm.memset.p0.i64(ptr align 8 %.sink293, i8 0, i64 %i.eq, i1 false)
