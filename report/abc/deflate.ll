...
bb.h:                                             ; preds = %.thread152
  ...
  %12 = load i32, ptr %i.n, align 4, !tbaa !119
  %13 = load i32, ptr %i.p, align 8, !tbaa !46
  %14 = icmp eq i32 %12, %13                      ; 2 uses
  %15 = load i32, ptr %i.l, align 8, !tbaa !67    ; 4 uses
  %16 = load i32, ptr %i.a, align 4, !tbaa !64
  %17 = sub i32 %16, %15                          ; 2 uses
  store i32 %17, ptr %i.a, align 4, !tbaa !64
  %18 = load i32, ptr %i.t, align 8, !tbaa !55
...
bb.m:                                             ; preds = %bb.l
  ...
  %11 = add i16 %10, 1
  store i16 %11, ptr %9, align 4, !tbaa !8
  %12 = load i32, ptr %i.s, align 4, !tbaa !119
  %13 = load i32, ptr %i.v, align 8, !tbaa !46
  %14 = load i32, ptr %i.d, align 8, !tbaa !66    ; 2 uses
  %15 = load i32, ptr %i.a, align 4, !tbaa !64
  %reass.sub = sub i32 %15, %14
  %16 = add i32 %reass.sub, 1
  store i32 %16, ptr %i.a, align 4, !tbaa !64
  %17 = add i32 %14, -2                           ; 2 uses
  store i32 %17, ptr %i.d, align 8, !tbaa !66
