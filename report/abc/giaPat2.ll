...
.lr.ph.i33:                                       ; preds = %bb.m, %bb.r
  ...
  %.0196.i = phi ptr [ %.120.i, %bb.r ], [ %.val32, %bb.m ] ; 4 uses
  %.0215.i = phi ptr [ %.122.i, %bb.r ], [ %.val30, %bb.m ] ; 4 uses
  %i.as = load i32, ptr %.0215.i, align 4, !tbaa !37 ; 2 uses
  %i.at = load i32, ptr %.0196.i, align 4, !tbaa !37 ; 2 uses
  %i.au = icmp eq i32 %i.as, %i.at
  br i1 %i.au, label %bb.n, label %bb.o

bb.n:                                             ; preds = %.lr.ph.i33
  %i.av = getelementptr inbounds nuw i8, ptr %.0215.i, i64 4
  %i.aw = getelementptr inbounds nuw i8, ptr %.0196.i, i64 4
...
bb.p:                                             ; preds = %bb.o
  %i.az = getelementptr inbounds nuw i8, ptr %.0215.i, i64 4
  br label %bb.r

bb.q:                                             ; preds = %bb.o
  %i.ba = getelementptr inbounds nuw i8, ptr %.0196.i, i64 4
  br label %bb.r

bb.r:                                             ; preds = %bb.q, %bb.p, %bb.n
  %.122.i = phi ptr [ %i.av, %bb.n ], [ %i.az, %bb.p ], [ %.0215.i, %bb.q ] ; 2 uses
  %.120.i = phi ptr [ %i.aw, %bb.n ], [ %.0196.i, %bb.p ], [ %i.ba, %bb.q ] ; 2 uses
  %.1.i = phi i32 [ %i.ax, %bb.n ], [ %.07.i, %bb.p ], [ %.07.i, %bb.q ] ; 2 uses
  %i.bb = icmp ult ptr %.122.i, %i.am
  %i.bc = icmp ult ptr %.120.i, %i.ao
...
.critedge:                                        ; preds = %Vec_IntTwoCountCommon.exit, %bb.v, %bb.a, %Vec_IntAppend.exit
  %.023 = phi i32 [ %i.aj, %Vec_IntAppend.exit ], [ 1000000000, %bb.a ], [ %.046, %Vec_IntTwoCountCommon.exit ], [ 1000000000, %bb.v ]
  ret i32 %.023
}
