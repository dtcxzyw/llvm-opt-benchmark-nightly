...
bb.d:                                             ; preds = %bb.a
  ...
  %i.f = tail call fastcc ptr @GiaHie_CountSymbsAll(ptr noundef nonnull %i.a) ; 4 uses
...
.lr.ph:                                           ; preds = %bb.d
  ...
  %.val53 = load ptr, ptr %4, align 8, !tbaa !71  ; 3 uses
...
bb.e:                                             ; preds = %.lr.ph, %GiaHie_PrintOneName.exit
  ...
  %7 = add nsw i64 %5, %6
  %.idx = shl i64 %7, 3
  %8 = getelementptr i8, ptr %.val53, i64 %.idx   ; 2 uses
  %i.j = load i32, ptr %8, align 4, !tbaa !46     ; 2 uses
...
._crit_edge.thread:                               ; preds = %GiaHie_PrintOneName.exit, %._crit_edge
  %9 = phi ptr [ %.pre, %._crit_edge ], [ %.val53, %GiaHie_PrintOneName.exit ]
