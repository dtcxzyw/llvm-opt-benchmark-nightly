...
begin_hunk_0_@Sat_MemAppend:bb.a
  ...
  store ptr %i.y, ptr %i.a, align 8, !tbaa !52
  %i.z = load i32, ptr %i.t, align 4, !tbaa !58   ; 2 uses
  ...
  store i32 %i.ad, ptr %i.t, align 4, !tbaa !58
...
bb.e:                                             ; preds = %bb.d
  %i.ak = load i32, ptr %i.p, align 8, !tbaa !50
  ...
  %i.ao = load i32, ptr %i.e, align 4, !tbaa !40
  %i.ap = sext i32 %i.ao to i64
  %i.aq = getelementptr inbounds [8 x i8], ptr %i.af, i64 %i.ap
  store ptr %i.an, ptr %i.aq, align 8, !tbaa !53
  br label %bb.f

bb.f:                                             ; preds = %bb.e, %bb.d
  %i.ar = phi ptr [ %i.an, %bb.e ], [ %i.ai, %bb.d ] ; 2 uses
  store i32 2, ptr %i.ar, align 4, !tbaa !40
  br label %bb.g
...
bb.g:                                             ; preds = %bb.f, %bb.a
  ...
  store i32 0, ptr %i.at, align 4, !tbaa !40
  %.0.val = load i32, ptr %.0, align 4, !tbaa !40
...
bb.i:                                             ; preds = %bb.h, %bb.g
  ...
  %.pre67 = load i32, ptr %.phi.trans.insert, align 4, !tbaa !40 ; 2 uses
...
bb.j:                                             ; preds = %bb.i
  ...
  store i32 %.pre67, ptr %i.bi, align 4, !tbaa !40
  br label %._crit_edge

._crit_edge:                                      ; preds = %bb.i, %bb.j
  %i.bj = getelementptr inbounds [4 x i8], ptr %0, i64 %i.d
  %i.bk = add nsw i32 %.pre67, 1
  store i32 %i.bk, ptr %i.bj, align 4, !tbaa !40
  %i.bl = load i32, ptr %.0, align 4, !tbaa !40
  %i.bm = add nsw i32 %i.bl, %i.m
  store i32 %i.bm, ptr %.0, align 4, !tbaa !40
  %i.bn = load i32, ptr %i.e, align 4, !tbaa !40  ; 2 uses
  %i.bo = load i32, ptr %i.p, align 8, !tbaa !50
  %i.bp = shl i32 %i.bn, %i.bo
  %i.bq = load ptr, ptr %i.a, align 8, !tbaa !52
  %i.br = sext i32 %i.bn to i64
  %i.bs = getelementptr inbounds [8 x i8], ptr %i.bq, i64 %i.br
  %i.bt = load ptr, ptr %i.bs, align 8, !tbaa !53
  %.val.i = load i32, ptr %i.bt, align 4, !tbaa !40
...
.lr.ph:                                           ; preds = %bb.a
  ...
  %.val = load ptr, ptr %i.c, align 8, !tbaa !31  ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i8>, ptr %i.d, align 1, !tbaa !32
  %wide.load11 = load <4 x i8>, ptr %i.e, align 1, !tbaa !32
  ...
  br i1 %i.l, label %middle.block, label %vector.body, !llvm.loop !102
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  br i1 %exitcond.not, label %._crit_edge, label %scalar.ph, !llvm.loop !103
...
bb.d:                                             ; preds = %.lr.ph, %bb.j
  ...
  %i.am = load i32, ptr %.092156, align 4, !tbaa !40 ; 8 uses
  %i.an = and i32 %i.am, 1
...
bb.e:                                             ; preds = %bb.d
  ...
  %.val121 = load ptr, ptr %i.f, align 8, !tbaa !31 ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  store i32 %i.am, ptr %.090157, align 4, !tbaa !40
  %i.ax = load i32, ptr %.092156, align 4, !tbaa !40 ; 2 uses
...
sat_solver_enqueue.exit.thread:                   ; preds = %bb.h
  ...
  %i.bi = and i8 %i.bh, 1
  store i8 %i.bi, ptr %i.bf, align 1, !tbaa !32
  %.val26.i = load i32, ptr %i.j, align 4, !tbaa !44
  %.val27.i = load ptr, ptr %i.k, align 8, !tbaa !54
  %i.bj = getelementptr inbounds [4 x i8], ptr %.val27.i, i64 %i.bb
  store i32 %.val26.i, ptr %i.bj, align 4, !tbaa !40
  %i.bk = load ptr, ptr %i.l, align 8, !tbaa !66
  %i.bl = getelementptr inbounds [4 x i8], ptr %i.bk, i64 %i.bb
  store i32 %i.ai, ptr %i.bl, align 4, !tbaa !40
  %i.bm = load ptr, ptr %i.c, align 8, !tbaa !63
  %i.bn = load i32, ptr %i.a, align 4, !tbaa !61  ; 2 uses
  %i.bo = add nsw i32 %i.bn, 1
  store i32 %i.bo, ptr %i.a, align 4, !tbaa !61
  %i.bp = sext i32 %i.bn to i64
  %i.bq = getelementptr inbounds [4 x i8], ptr %i.bm, i64 %i.bp
  store i32 %i.ay, ptr %i.bq, align 4, !tbaa !40
  br label %.thread
...
bb.i:                                             ; preds = %sat_solver_enqueue.exit
  %i.bt = load i32, ptr %i.h, align 4, !tbaa !67  ; 3 uses
  %i.bu = load ptr, ptr %i.i, align 8, !tbaa !68  ; 2 uses
  %i.bv = getelementptr inbounds nuw i8, ptr %i.bu, i64 4
  %i.bw = getelementptr inbounds nuw i8, ptr %i.bu, i64 8
  store i32 %i.aj, ptr %i.bw, align 4, !tbaa !40
  %i.bx = load i32, ptr %.092156, align 4, !tbaa !40
  %i.by = ashr i32 %i.bx, 1
  store i32 %i.by, ptr %i.bv, align 4, !tbaa !40
...
vector.body258:                                   ; preds = %vector.body258, %vector.ph256
  ...
  %wide.load262 = load <4 x i32>, ptr %next.gep260, align 4, !tbaa !40
  %wide.load263 = load <4 x i32>, ptr %i.cj, align 4, !tbaa !40
  %i.ck = getelementptr i8, ptr %next.gep261, i64 16
  store <4 x i32> %wide.load262, ptr %next.gep261, align 4, !tbaa !40
  store <4 x i32> %wide.load263, ptr %i.ck, align 4, !tbaa !40
  %index.next264 = add nuw i64 %index259, 8       ; 2 uses
  %i.cl = icmp eq i64 %index.next264, %n.vec257
  br i1 %i.cl, label %middle.block265, label %vector.body258, !llvm.loop !104
...
clause_read.exit:                                 ; preds = %bb.d
  ...
  %.val.i.i = load i32, ptr %i.m, align 8, !tbaa !50
  %i.cs = ashr i32 %i.am, %.val.i.i
  %.val5.i.i = load i32, ptr %i.n, align 4, !tbaa !51
  %i.ct = and i32 %.val5.i.i, %i.am
  %.val6.i.i = load ptr, ptr %i.o, align 8, !tbaa !52
  ...
  %i.da = load i32, ptr %i.cz, align 4, !tbaa !40 ; 2 uses
...
bb.k:                                             ; preds = %clause_read.exit
  ...
  %i.dd = load i32, ptr %i.dc, align 4, !tbaa !40 ; 2 uses
  store i32 %i.dd, ptr %i.cz, align 4, !tbaa !40
  store i32 %i.aj, ptr %i.dc, align 4, !tbaa !40
  br label %bb.l

bb.l:                                             ; preds = %bb.k, %clause_read.exit
  %i.de = phi i32 [ %i.dd, %bb.k ], [ %i.da, %clause_read.exit ] ; 2 uses
  %i.df = ashr i32 %i.de, 1
  %.val120 = load ptr, ptr %i.f, align 8, !tbaa !31 ; 2 uses
...
bb.m:                                             ; preds = %bb.l
  %i.dm = load i32, ptr %.092156, align 4, !tbaa !40
  %i.dn = getelementptr inbounds nuw i8, ptr %.090157, i64 4
  store i32 %i.dm, ptr %.090157, align 4, !tbaa !40
  br label %.thread
...
.lr.ph171:                                        ; preds = %.lr.ph171.preheader, %bb.v
  ...
  %i.ds = load i32, ptr %.0169, align 4, !tbaa !40 ; 3 uses
...
bb.o:                                             ; preds = %.lr.ph171
  ...
  store i32 %i.ds, ptr %i.ea, align 4, !tbaa !40
  store i32 %i.aj, ptr %.0169, align 4, !tbaa !40
  %i.eb = load i32, ptr %i.ea, align 4, !tbaa !40
  %i.ec = xor i32 %i.eb, 1
  %.val125 = load ptr, ptr %i.d, align 8, !tbaa !43
  %i.ed = sext i32 %i.ec to i64
  %i.ee = getelementptr inbounds [16 x i8], ptr %.val125, i64 %i.ed ; 6 uses
  %i.ef = load i32, ptr %.092156, align 4, !tbaa !40
  %i.eg = getelementptr inbounds nuw i8, ptr %i.ee, i64 4 ; 3 uses
  %i.eh = load i32, ptr %i.eg, align 4, !tbaa !44 ; 5 uses
  %i.ei = load i32, ptr %i.ee, align 8, !tbaa !45
...
bb.p:                                             ; preds = %bb.o
  ...
  %i.eq = load ptr, ptr %i.ep, align 8, !tbaa !41 ; 2 uses
...
bb.s:                                             ; preds = %bb.r, %bb.q
  ...
  store ptr %i.ev, ptr %i.ep, align 8, !tbaa !41
  %i.ew = icmp eq ptr %i.ev, null
  br i1 %i.ew, label %bb.t, label %bb.u

bb.t:                                             ; preds = %bb.s
  %i.ex = load i32, ptr %i.ee, align 8, !tbaa !45
  ...
  %i.fd = load ptr, ptr @stdout, align 8, !tbaa !46
  %i.fe = tail call i32 @fflush(ptr noundef %i.fd) ; 0 uses
  br label %bb.u

bb.u:                                             ; preds = %bb.t, %bb.s
  store i32 %i.eo, ptr %i.ee, align 8, !tbaa !45
  %.pre.i = load i32, ptr %i.eg, align 4, !tbaa !44
...
.lr.ph.i:                                         ; preds = %bb.w
  %.val.i = load ptr, ptr %i.k, align 8, !tbaa !54 ; 3 uses
...
bb.x:                                             ; preds = %bb.x, %.lr.ph.i.new
  ...
  br i1 %niter.ncmp.1, label %sat_clause_compute_lbd.exit.loopexit.unr-lcssa, label %bb.x, !llvm.loop !1
...
.epil.preheader:                                  ; preds = %sat_clause_compute_lbd.exit.loopexit.unr-lcssa, %.lr.ph.i
  ...
  %i.gq = load i32, ptr %i.gp, align 4, !tbaa !40
...
bb.z:                                             ; preds = %bb.y
  store i8 1, ptr %i.hi, align 1, !tbaa !32
  br label %bb.aa

bb.aa:                                            ; preds = %bb.z, %bb.y
  %.val24.i131 = load ptr, ptr %i.f, align 8, !tbaa !31
  %i.hl = getelementptr inbounds i8, ptr %.val24.i131, i64 %i.hh ; 2 uses
  %i.hm = load i8, ptr %i.hl, align 1, !tbaa !32  ; 2 uses
...
sat_solver_enqueue.exit136.thread:                ; preds = %bb.aa
  ...
  %i.ho = and i8 %i.hn, 1
  store i8 %i.ho, ptr %i.hl, align 1, !tbaa !32
  %.val26.i134 = load i32, ptr %i.j, align 4, !tbaa !44
  %.val27.i135 = load ptr, ptr %i.k, align 8, !tbaa !54
  %i.hp = getelementptr inbounds [4 x i8], ptr %.val27.i135, i64 %i.hh
  store i32 %.val26.i134, ptr %i.hp, align 4, !tbaa !40
  %i.hq = load ptr, ptr %i.l, align 8, !tbaa !66
  %i.hr = getelementptr inbounds [4 x i8], ptr %i.hq, i64 %i.hh
  store i32 %i.hd, ptr %i.hr, align 4, !tbaa !40
  %i.hs = load ptr, ptr %i.c, align 8, !tbaa !63
  %i.ht = load i32, ptr %i.a, align 4, !tbaa !61  ; 2 uses
  %i.hu = add nsw i32 %i.ht, 1
  store i32 %i.hu, ptr %i.a, align 4, !tbaa !61
  %i.hv = sext i32 %i.ht to i64
  %i.hw = getelementptr inbounds [4 x i8], ptr %i.hs, i64 %i.hv
  store i32 %i.he, ptr %i.hw, align 4, !tbaa !40
  br label %.thread
...
bb.ab:                                            ; preds = %sat_solver_enqueue.exit136
  %i.hz = load i32, ptr %.092156, align 4, !tbaa !40 ; 3 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %next.gep, align 4, !tbaa !40
  %wide.load250 = load <4 x i32>, ptr %i.ik, align 4, !tbaa !40
  %i.il = getelementptr i8, ptr %next.gep249, i64 16
  store <4 x i32> %wide.load, ptr %next.gep249, align 4, !tbaa !40
  store <4 x i32> %wide.load250, ptr %i.il, align 4, !tbaa !40
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.im = icmp eq i64 %index.next, %n.vec
  br i1 %i.im, label %middle.block, label %vector.body, !llvm.loop !107
...
.thread:                                          ; preds = %.lr.ph165, %.lr.ph177, %middle.block265, %middle.block, %bb.i, %bb.ab, %sat_solver_enqueue.exit.thread, %sat_solver_enqueue.exit, %sat_solver_enqueue.exit136.thread, %veci_push.exit, %sat_solver_enqueue.exit136, %bb.m
  ...
  br i1 %i.ir, label %.lr.ph, label %.outer._crit_edge, !llvm.loop !109
...
clause_read.exit:
  ...
  store i32 256, ptr %i.c, align 4, !tbaa !58
  ...
  store ptr %i.p, ptr %i.q, align 8, !tbaa !41
  %i.r = getelementptr inbounds nuw i8, ptr %i.a, i64 312
  store i32 4, ptr %i.r, align 8, !tbaa !45
  ...
  store i32 4, ptr %i.u, align 8, !tbaa !45
  ...
  store ptr %i.v, ptr %i.w, align 8, !tbaa !41
  %i.x = getelementptr inbounds nuw i8, ptr %i.a, i64 168
  store i32 4, ptr %i.x, align 8, !tbaa !45
  ...
  store i32 4, ptr %i.aa, align 8, !tbaa !45
  ...
  store ptr %i.ab, ptr %i.ac, align 8, !tbaa !41
  ...
  store ptr %i.ae, ptr %i.af, align 8, !tbaa !41
  %i.ag = getelementptr inbounds nuw i8, ptr %i.a, i64 648
  store i32 4, ptr %i.ag, align 8, !tbaa !45
  ...
  store i32 4, ptr %i.aj, align 8, !tbaa !45
  ...
  store double f0x4195D9C3F4000000, ptr %i.at, align 8, !tbaa !70
  ret ptr %i.a
}
...
clause_read.exit:
  ...
  store ptr %i.g, ptr %i.h, align 8, !tbaa !53
  %i.i = getelementptr inbounds nuw i8, ptr %i.a, i64 44
  store <4 x i32> <i32 1, i32 15, i32 32767, i32 32768>, ptr %i.i, align 4, !tbaa !40
  store i32 2, ptr %i.g, align 4, !tbaa !40
  %i.j = getelementptr inbounds nuw i8, ptr %i.a, i64 72
  store i32 -1, ptr %i.j, align 8, !tbaa !49
  %i.k = getelementptr inbounds nuw i8, ptr %i.f, i64 8 ; 2 uses
