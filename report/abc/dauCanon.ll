...
.lr.ph.preheader:                                 ; preds = %bb.b
  %i.h = shl nuw nsw i64 %i.d, 1                  ; 2 uses
  %i.i = tail call i64 @llvm.umax.i64(i64 %i.h, i64 64)
  %i.j = icmp ne i32 %1, 5
  %i.k = zext i1 %i.j to i64                      ; 2 uses
  %2 = or disjoint i64 %i.h, %i.k
  %3 = sub nsw i64 %i.i, %2
...
.lr.ph.i.preheader:                               ; preds = %bb.b
  ...
  %i.o = tail call i64 @llvm.umax.i64(i64 %i.n, i64 64)
  %i.p = icmp ne i32 %3, 5
  %i.q = zext i1 %i.p to i64                      ; 2 uses
  %6 = or disjoint i64 %i.n, %i.q
  %7 = sub nsw i64 %i.o, %6
...
.lr.ph.i.i.i.i.preheader:                         ; preds = %bb.l
  %i.gu = shl nuw nsw i64 %i.gq, 1                ; 2 uses
  %i.gv = call i64 @llvm.umax.i64(i64 %i.gu, i64 64)
  %i.gw = icmp ne i32 %i.gi, 5
  %i.gx = zext i1 %i.gw to i64                    ; 2 uses
  %7 = or disjoint i64 %i.gu, %i.gx
  %8 = sub nsw i64 %i.gv, %7
  %i.gy = zext nneg i32 %i.gi to i64
  %i.gz = lshr i64 %8, %i.gy
...
.lr.ph.i.i62.i.i.preheader:                       ; preds = %bb.ag
  %i.ni = shl nuw nsw i64 %i.ne, 1                ; 2 uses
  %i.nj = call i64 @llvm.umax.i64(i64 %i.ni, i64 64)
  %i.nk = icmp ne i32 %i.mv, 5
  %i.nl = zext i1 %i.nk to i64                    ; 2 uses
  %9 = or disjoint i64 %i.ni, %i.nl
  %10 = sub nsw i64 %i.nj, %9
  %i.nm = zext nneg i32 %i.mv to i64
  %i.nn = lshr i64 %10, %i.nm
...
.lr.ph.i.i.preheader:                             ; preds = %bb.n
  %i.cp = shl nuw nsw i64 %i.cl, 1                ; 2 uses
  %i.cq = tail call i64 @llvm.umax.i64(i64 %i.cp, i64 64)
  %i.cr = icmp ne i32 %i.cd, 5
  %i.cs = zext i1 %i.cr to i64                    ; 2 uses
  %2 = or disjoint i64 %i.cp, %i.cs
  %3 = sub nsw i64 %i.cq, %2
  %i.ct = zext nneg i32 %i.cd to i64
  %i.cu = lshr i64 %3, %i.ct
...
.lr.ph.i.i119.preheader:                          ; preds = %bb.ap
  %i.lg = shl nuw nsw i64 %i.lc, 1                ; 2 uses
  %i.lh = tail call i64 @llvm.umax.i64(i64 %i.lg, i64 64)
  %i.li = icmp ne i32 %i.ku, 5
  %i.lj = zext i1 %i.li to i64                    ; 2 uses
  %4 = or disjoint i64 %i.lg, %i.lj
  %5 = sub nsw i64 %i.lh, %4
  %i.lk = zext nneg i32 %i.ku to i64
  %i.ll = lshr i64 %5, %i.lk
...
.lr.ph.i.i.preheader:                             ; preds = %bb.c
  %i.o = shl nuw nsw i64 %i.k, 1                  ; 2 uses
  %i.p = tail call i64 @llvm.umax.i64(i64 %i.o, i64 64)
  %i.q = icmp ne i32 %i.d, 5
  %i.r = zext i1 %i.q to i64                      ; 2 uses
  %3 = or disjoint i64 %i.o, %i.r
  %4 = sub nsw i64 %i.p, %3
