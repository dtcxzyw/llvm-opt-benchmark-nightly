...
.lr.ph165.preheader:                              ; preds = %bb.i
  ...
  %i.ca = add i64 %i.bz, %.092.ph181248
  %reass.sub = sub i64 %i.ak, %i.ca               ; 2 uses
  %i.cb = lshr i64 %reass.sub, 2
  %i.cc = add nuw nsw i64 %i.cb, 1                ; 2 uses
  %min.iters.check257 = icmp ult i64 %reass.sub, 28
...
vector.body260:                                   ; preds = %vector.body260, %vector.ph258
  ...
  %next.gep262.a = getelementptr i8, ptr %.193161, i64 %i.ch ; 2 uses
  %next.gep263 = getelementptr i8, ptr %i.av, i64 %i.ch ; 2 uses
  %i.ci = getelementptr i8, ptr %next.gep262.a, i64 16
  %wide.load264.a = load <4 x i32>, ptr %next.gep262.a, align 4, !tbaa !32
  %wide.load265 = load <4 x i32>, ptr %i.ci, align 4, !tbaa !32
  %i.cj = getelementptr i8, ptr %next.gep263, i64 16
  store <4 x i32> %wide.load264.a, ptr %next.gep263, align 4, !tbaa !32
...
.lr.ph177.preheader:                              ; preds = %bb.ab
  %i.ia = shl i64 %indvar, 2
  %i.ib = add i64 %i.ia, %.092.ph181248
  %reass.sub273 = sub i64 %2, %i.ib               ; 2 uses
  %i.ic = lshr i64 %reass.sub273, 2
  %i.id = add nuw nsw i64 %i.ic, 1                ; 2 uses
  %min.iters.check = icmp ult i64 %reass.sub273, 28
