...
.lr.ph165.preheader:                              ; preds = %bb.i
  ...
  %i.ca = add i64 %i.bz, %1
  %umax255 = tail call i64 @llvm.umax.i64(i64 %i.ca, i64 %i.ak)
  %2 = mul i64 %indvar, -4
  %reass.sub = sub i64 %2, %.092.ph181248
  %3 = add i64 %reass.sub, -5
  %4 = add i64 %umax255, %3                       ; 2 uses
  %i.cb = lshr i64 %4, 2
  %i.cc = add nuw nsw i64 %i.cb, 1                ; 2 uses
  %min.iters.check257 = icmp ult i64 %4, 28
...
.lr.ph177.preheader:                              ; preds = %bb.ab
  ...
  %i.ib = add i64 %i.ia, %5
  %umax = tail call i64 @llvm.umax.i64(i64 %i.ib, i64 %i.ak)
  %6 = mul i64 %indvar, -4
  %reass.sub273 = sub i64 %6, %.092.ph181248
  %7 = add i64 %reass.sub273, -5
  %8 = add i64 %umax, %7                          ; 2 uses
  %i.ic = lshr i64 %8, 2
