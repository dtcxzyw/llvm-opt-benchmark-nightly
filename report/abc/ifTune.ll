...
bb.c:                                             ; preds = %bb.f, %.lr.ph.us.i
  ...
  %i.az = shl nuw i32 %indvars.iv.tr.i, 1
...
bb.j:                                             ; preds = %bb.m, %.lr.ph.us.i64
  ...
  %indvars.iv.tr.i69 = trunc nuw i64 %indvars.iv.i67 to i32
  %i.dj = shl nuw i32 %indvars.iv.tr.i69, 1
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.bq = shl nsw <4 x i32> %i.bp, splat (i32 1)
