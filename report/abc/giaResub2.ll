...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %.idx = shl nsw i64 %indvars.iv, 3
  %i.w = getelementptr inbounds i8, ptr %.val, i64 %.idx ; 2 uses
  %1 = load i32, ptr %i.w, align 4, !tbaa !33
  %2 = sdiv i32 %1, 2
  %3 = getelementptr i8, ptr %i.w, i64 4
  %4 = load i32, ptr %3, align 4, !tbaa !33
  %5 = sdiv i32 %4, 2
  %i.x = tail call noundef i32 @llvm.smax.i32(i32 %2, i32 %5)
