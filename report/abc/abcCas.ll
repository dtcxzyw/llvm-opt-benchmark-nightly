...
.lr.ph.i.split.preheader:                         ; preds = %.lr.ph.i
  ...
  %2 = getelementptr i8, ptr %0, i64 %i.ad
  %3 = getelementptr i8, ptr %2, i64 24
  %i.af = getelementptr i8, ptr %3, i64 %i.ae
  %i.ag = getelementptr i8, ptr %0, i64 %i.ad
  %i.ah = getelementptr i8, ptr %i.ag, i64 24
  %i.ai = getelementptr i8, ptr %i.ah, i64 %i.ae
  %i.aj = getelementptr i8, ptr %0, i64 %i.ad
  %i.ak = getelementptr i8, ptr %i.aj, i64 24
  %i.al = getelementptr i8, ptr %i.ak, i64 %i.ae
  %i.am = getelementptr i8, ptr %0, i64 %i.ad
  %i.an = getelementptr i8, ptr %i.am, i64 24
  %i.ao = getelementptr i8, ptr %i.an, i64 %i.ae
...
.preheader120.us.us.preheader.i.i:                ; preds = %.preheader120.lr.ph.i.i
  ...
  %umax = tail call i64 @llvm.umax.i64(i64 %i.hj, i64 1)
  %4 = udiv i64 %i.hq, %umax
  %5 = add i64 %4, %umin
  %i.hr = shl i64 %5, 3
  %6 = mul i64 %i.hr, %i.hj                       ; 2 uses
  %i.hs = shl nuw nsw i64 %wide.trip.count.i28.i, 3 ; 2 uses
  %7 = shl nsw i64 %i.hl, 3                       ; 2 uses
  %8 = getelementptr i8, ptr %i.af, i64 %i.hm
  %9 = getelementptr i8, ptr %i.ai, i64 %7
  %10 = getelementptr i8, ptr %i.al, i64 %6
  %i.ht = getelementptr i8, ptr %10, i64 %i.hm
  %i.hu = getelementptr i8, ptr %i.ht, i64 %i.hs
  %i.hv = getelementptr i8, ptr %i.ao, i64 %6
  %i.hw = getelementptr i8, ptr %i.hv, i64 %7
  %i.hx = getelementptr i8, ptr %i.hw, i64 %i.hs
  %min.iters.check147 = icmp slt i32 %i.hc, 6
...
.preheader120.us.us.i.i:                          ; preds = %._crit_edge124.us.us.i.i, %.preheader120.us.us.preheader.i.i
  ...
  %scevgep138.a = getelementptr i8, ptr %8, i64 %i.hz
  %scevgep140 = getelementptr i8, ptr %9, i64 %i.hz
  ...
  %scevgep139 = getelementptr i8, ptr %i.hu, i64 %i.hz
  %scevgep141 = getelementptr i8, ptr %i.hx, i64 %i.hz
  %bound0142 = icmp ult ptr %scevgep138.a, %scevgep141
...
scalar.ph146:                                     ; preds = %scalar.ph146.preheader.a, %scalar.ph146
  %indvars.iv.i31.i = phi i64 [ %indvars.iv.next.i32.i.1, %scalar.ph146 ], [ 0, %scalar.ph146.preheader.a ] ; 4 uses
  %niter = phi i64 [ %niter.next.1, %scalar.ph146 ], [ 0, %scalar.ph146.preheader.a ]
...
.preheader119.us.us.i.i:                          ; preds = %._crit_edge.us.us.i.i, %.preheader120.us.us.i.i
  ...
  %brmerge = select i1 %min.iters.check147, i1 true, i1 %11
  br i1 %brmerge, label %scalar.ph146.preheader.a, label %vector.body150

scalar.ph146.preheader.a:                         ; preds = %.preheader119.us.us.i.i
  br i1 %i.hy, label %scalar.ph146.epil.preheader, label %scalar.ph146

vector.body150:                                   ; preds = %.preheader119.us.us.i.i, %vector.body150
  %index151 = phi i64 [ %index.next156, %vector.body150 ], [ 0, %.preheader119.us.us.i.i ] ; 3 uses
...
scalar.ph146.epil.preheader:                      ; preds = %._crit_edge.us.us.i.i.loopexit.unr-lcssa, %scalar.ph146.preheader.a
  %indvars.iv.i31.i.epil.init = phi i64 [ 0, %scalar.ph146.preheader.a ], [ %indvars.iv.next.i32.i.1, %._crit_edge.us.us.i.i.loopexit.unr-lcssa ] ; 2 uses
