...
Gli_NodeComputeValue.exit:                        ; preds = %.lr.ph.i, %bb.d, %bb.e, %bb.f, %bb.g, %bb.h, %bb.i, %.critedge
  ...
  %4 = ashr i32 %.0.lcssa.i, 5
  %5 = sext i32 %4 to i64
  %i.dk = getelementptr inbounds [4 x i8], ptr %3, i64 %5
...
Gli_NodeComputeValue.exit:                        ; preds = %.lr.ph.i, %bb.d, %bb.e, %bb.f, %bb.g, %bb.h, %bb.i, %bb.c
  ...
  %1 = ashr i32 %.0.lcssa.i, 5
  %2 = sext i32 %1 to i64
  %i.bw = getelementptr inbounds [4 x i8], ptr %i.bv, i64 %2
...
Gli_NodeComputeValue2.exit:                       ; preds = %.lr.ph.i, %bb.y, %bb.z, %bb.aa, %bb.ab, %bb.ac, %bb.ad, %bb.x
  ...
  %1 = ashr i32 %.0.lcssa.i, 5
  %2 = sext i32 %1 to i64
  %i.gf = getelementptr inbounds [4 x i8], ptr %i.ge, i64 %2
...
Gli_NodeComputeValue.exit:                        ; preds = %.lr.ph.i, %bb.f, %bb.g, %bb.h, %bb.i, %bb.j, %bb.k, %bb.e
  ...
  %2 = ashr i32 %.0.lcssa.i, 5
  %3 = sext i32 %2 to i64
  %i.cu = getelementptr inbounds [4 x i8], ptr %i.ct, i64 %3
...
Gli_NodeComputeValue.exit.i:                      ; preds = %.lr.ph.i.i, %bb.f, %bb.g, %bb.h, %bb.i, %bb.j, %bb.k, %bb.e
  ...
  %6 = ashr i32 %.0.lcssa.i.i, 5
  %7 = sext i32 %6 to i64
  %i.ct = getelementptr inbounds [4 x i8], ptr %i.cs, i64 %7
...
Gli_NodeComputeValue.exit.i46.us:                 ; preds = %.lr.ph.i.i40.us, %bb.r, %bb.s, %bb.t, %bb.u, %bb.v, %bb.w, %bb.q
  ...
  %8 = ashr i32 %.0.lcssa.i.i47.us, 5
  %9 = sext i32 %8 to i64
  %i.gm = getelementptr inbounds [4 x i8], ptr %i.gl, i64 %9
