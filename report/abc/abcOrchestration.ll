...
bb.a:
  ...
  %i.f = select i1 %i.c, i32 1, i32 %i.e          ; 11 uses
...
.lr.ph112:                                        ; preds = %.preheader96
  ...
  %wide.trip.count = zext i32 %i.f to i64         ; 4 uses
  %wide.trip.count.a = zext i32 %i.f to i64       ; 9 uses
  %i.aa = add nsw i64 %wide.trip.count.a, -1      ; 3 uses
  %min.iters.check198 = icmp ult i32 %i.f, 6
  %n.vec200 = and i64 %wide.trip.count, 2147483644
  ...
  %n.vec182 = and i64 %wide.trip.count, 2147483644
  ...
  %n.vec164 = and i64 %wide.trip.count, 2147483644
