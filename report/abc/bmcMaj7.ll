...
.preheader.us.i:                                  ; preds = %bb.g, %.preheader.us.preheader.i
  %.01518.us.i = phi i32 [ %i.bg, %bb.g ], [ 0, %.preheader.us.preheader.i ] ; 5 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi869 = phi <4 x i32> [ zeroinitializer, %vector.ph ], [ %i.ar, %vector.body ]
  ...
  %i.ar = add <4 x i32> %i.ap, %vec.phi869        ; 2 uses
...
scalar.ph.preheader:                              ; preds = %.preheader.us.i, %middle.block
  %.017.us.i.ph = phi i32 [ 0, %.preheader.us.i ], [ %i.at, %middle.block ]
  %.01416.us.i.ph = phi i32 [ 0, %.preheader.us.i ], [ %n.vec, %middle.block ]
  br label %scalar.ph

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %.017.us.i = phi i32 [ %i.aw, %scalar.ph ], [ %.017.us.i.ph, %scalar.ph.preheader ]
  %.01416.us.i = phi i32 [ %i.ax, %scalar.ph ], [ %.01416.us.i.ph, %scalar.ph.preheader ] ; 2 uses
  %i.au = lshr i32 %.01518.us.i, %.01416.us.i
  %i.av = and i32 %i.au, 1
  %i.aw = add nuw nsw i32 %i.av, %.017.us.i       ; 2 uses
  %i.ax = add nuw nsw i32 %.01416.us.i, 1         ; 2 uses
...
bb.f:                                             ; preds = %._crit_edge.us.i
  %i.ay = and i32 %.01518.us.i, 63
  %i.az = zext nneg i32 %i.ay to i64
  %i.ba = shl nuw i64 1, %i.az
  %i.bb = lshr i32 %.01518.us.i, 6
...
bb.g:                                             ; preds = %._crit_edge.us.i, %bb.f
  %i.bg = add nuw nsw i32 %.01518.us.i, 1         ; 2 uses
...
._crit_edge.us.i:                                 ; preds = %scalar.ph, %middle.block
  %.lcssa868 = phi i32 [ %i.at, %middle.block ], [ %i.aw, %scalar.ph ]
  %i.bh = zext nneg i32 %.lcssa868 to i64
...
.preheader.i:                                     ; preds = %.preheader.i, %.preheader.preheader.i.new
  %.01518.i = phi i32 [ 0, %.preheader.preheader.i.new ], [ %i.cf, %.preheader.i ] ; 5 uses
  %niter = phi i32 [ 0, %.preheader.preheader.i.new ], [ %niter.next.1, %.preheader.i ]
  %i.bo = and i32 %.01518.i, 62
  %i.bp = zext nneg i32 %i.bo to i64
  %i.bq = shl nuw nsw i64 1, %i.bp
  %i.br = lshr i32 %.01518.i, 6
  ...
  %i.cf = add nuw nsw i32 %.01518.i, 2            ; 2 uses
  %niter.next.1 = add i32 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i32 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %Abc_TtSymFunGenerate.exit.loopexit1121.unr-lcssa, label %.preheader.i, !llvm.loop !60

Abc_TtSymFunGenerate.exit.loopexit1121.unr-lcssa: ; preds = %.preheader.i
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  br i1 %lcmp.mod.not, label %Abc_TtSymFunGenerate.exit, label %.preheader.i.epil.preheader

.preheader.i.epil.preheader:                      ; preds = %Abc_TtSymFunGenerate.exit.loopexit1121.unr-lcssa, %.preheader.preheader.i
  %.01518.i.epil.init = phi i32 [ 0, %.preheader.preheader.i ], [ %i.cf, %Abc_TtSymFunGenerate.exit.loopexit1121.unr-lcssa ] ; 2 uses
  %lcmp.mod1122 = trunc i32 %smax.i to i1
  call void @llvm.assume(i1 %lcmp.mod1122)
  %i.cg = and i32 %.01518.i.epil.init, 63
  %i.ch = zext nneg i32 %i.cg to i64
  %i.ci = shl nuw i64 1, %i.ch
  %i.cj = lshr i32 %.01518.i.epil.init, 6
...
Abc_TtSymFunGenerate.exit:                        ; preds = %.preheader.i.epil.preheader, %Abc_TtSymFunGenerate.exit.loopexit1121.unr-lcssa, %bb.g, %bb.e, %.preheader.lr.ph.split.i
