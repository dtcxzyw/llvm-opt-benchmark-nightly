...
begin_hunk_0_@Of_ObjMergeOrder:bb.a
  %.epil.init1090 = phi i32 [ 0, %.lr.ph.i301.us.us.us ], [ %i.amz, %._crit_edge.i308.us.us.us.loopexit.unr-lcssa ]
  %lcmp.mod1094 = trunc i32 %i.ame to i1
  ...
  %i.ani = call noundef i32 @llvm.smax.i32(i32 %.epil.init1090, i32 %i.anh) ; 2 uses
  ...
  %i.anl = add nsw i32 %i.ank, %.epil.init1088    ; 2 uses
  store i32 %i.anl, ptr %i.amg, align 4, !tbaa !86
  br label %._crit_edge.i308.us.us.us

._crit_edge.i308.us.us.us:                        ; preds = %.epil.preheader1085, %._crit_edge.i308.us.us.us.loopexit.unr-lcssa, %bb.bf
  %i.anm = phi i32 [ 0, %bb.bf ], [ %i.anc, %._crit_edge.i308.us.us.us.loopexit.unr-lcssa ], [ %i.anl, %.epil.preheader1085 ]
  %i.ann = phi i32 [ 0, %bb.bf ], [ %i.amz, %._crit_edge.i308.us.us.us.loopexit.unr-lcssa ], [ %i.ani, %.epil.preheader1085 ]
...
begin_hunk_1_@Of_ObjMergeOrder:bb.a
  %.epil.init1102 = phi i32 [ 0, %.lr.ph.i400.us ], [ %i.bgm, %._crit_edge.i407.us.loopexit.unr-lcssa ]
  %lcmp.mod1106 = trunc i32 %i.bfr to i1
  call void @llvm.assume(i1 %lcmp.mod1106)
  %i.bgq = getelementptr inbounds nuw [4 x i8], ptr %i.atb, i64 %indvars.iv.i404.us.epil.init
  %i.bgr = load i32, ptr %i.bgq, align 4, !tbaa !42
  %i.bgs = sext i32 %i.bgr to i64                 ; 2 uses
  %i.bgt = getelementptr inbounds [4 x i8], ptr %.val.i401.us, i64 %i.bgs
  %i.bgu = load i32, ptr %i.bgt, align 4, !tbaa !42
  %i.bgv = call noundef i32 @llvm.smax.i32(i32 %.epil.init1102, i32 %i.bgu) ; 2 uses
  store i32 %i.bgv, ptr %i.bfs, align 8, !tbaa !84
  %i.bgw = getelementptr inbounds [4 x i8], ptr %.val23.i402.us, i64 %i.bgs
  %i.bgx = load i32, ptr %i.bgw, align 4, !tbaa !42
  %i.bgy = add nsw i32 %i.bgx, %.epil.init1100    ; 2 uses
  store i32 %i.bgy, ptr %i.bft, align 4, !tbaa !86
  br label %._crit_edge.i407.us

._crit_edge.i407.us:                              ; preds = %.epil.preheader1097, %._crit_edge.i407.us.loopexit.unr-lcssa, %bb.dj
  %i.bgz = phi i32 [ 0, %bb.dj ], [ %i.bgp, %._crit_edge.i407.us.loopexit.unr-lcssa ], [ %i.bgy, %.epil.preheader1097 ]
  %i.bha = phi i32 [ 0, %bb.dj ], [ %i.bgm, %._crit_edge.i407.us.loopexit.unr-lcssa ], [ %i.bgv, %.epil.preheader1097 ]
  %i.bhb = icmp ugt i32 %i.bfq, 268435455
  %i.bhc = zext i1 %i.bhb to i32
  %i.bhd = add nuw nsw i32 %i.bha, %i.bhc
  store i32 %i.bhd, ptr %i.bfs, align 8, !tbaa !84
  %i.bhe = icmp ult i32 %i.bfq, 268435456
  br i1 %i.bhe, label %Of_CutParams.exit409.us, label %bb.dl

bb.dl:                                            ; preds = %._crit_edge.i407.us
  %i.bhf = load ptr, ptr %i.l, align 8, !tbaa !57
  %i.bhg = getelementptr inbounds nuw i8, ptr %i.bhf, i64 28
  %i.bhh = load i32, ptr %i.bhg, align 4, !tbaa !102
  %i.bhi = add nsw i32 %i.bhh, %i.bfr
  %i.bhj = mul nsw i32 %i.bhi, 100
  br label %Of_CutParams.exit409.us

Of_CutParams.exit409.us:                          ; preds = %bb.dl, %._crit_edge.i407.us
  %.0.i.i408.us = phi i32 [ %i.bhj, %bb.dl ], [ 0, %._crit_edge.i407.us ]
  %i.bhk = add nsw i32 %.0.i.i408.us, %i.bgz
  %i.bhl = sdiv i32 %i.bhk, %i.ase
  store i32 %i.bhl, ptr %i.bft, align 4, !tbaa !86
  %i.bhm = icmp eq i32 %.7569.us, 0
  br i1 %i.bhm, label %Of_SetAddCut.exit455.us, label %bb.dm

bb.dm:                                            ; preds = %Of_CutParams.exit409.us
  br i1 %i.avf, label %.lr.ph.i.i413.us, label %Of_SetSortByArea.exit.i410.us

.lr.ph.i.i413.us:                                 ; preds = %bb.dm
  %i.bhn = zext nneg i32 %.7569.us to i64         ; 4 uses
  %i.bho = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %i.bhn
...
.outer.i.i414.us:                                 ; preds = %Of_SetCutIsContainedOrder.exit.thread.thread.i.i444.us, %.lr.ph.i.i413.us
  ...
  %i.bhp = phi i1 [ false, %Of_SetCutIsContainedOrder.exit.thread.thread.i.i444.us ], [ true, %.lr.ph.i.i413.us ]
  %i.bhq = load ptr, ptr %i.bho, align 8, !tbaa !93 ; 4 uses
  %i.bhr = getelementptr inbounds nuw i8, ptr %i.bhq, i64 16
  %i.bhs = load i32, ptr %i.bhr, align 8
...
Of_CutCompareArea.exit.i.i436.us:                 ; preds = %bb.ea, %bb.dz, %bb.dx
  ...
  %i.bkm = icmp sgt i64 %indvars.iv665, 1
...
.lr.ph.preheader.i458:                            ; preds = %.loopexit488
  ...
  %xtraiter1109 = and i64 %wide.trip.count.i459, 3 ; 3 uses
...
.lr.ph.preheader.i458.new:                        ; preds = %.lr.ph.preheader.i458
  %unroll_iter1113 = and i64 %wide.trip.count.i459, 2147483644
  br label %.lr.ph.i460
...
.lr.ph.i460:                                      ; preds = %.lr.ph.i460, %.lr.ph.preheader.i458.new
  ...
  %niter1114 = phi i64 [ 0, %.lr.ph.preheader.i458.new ], [ %niter1114.next.3, %.lr.ph.i460 ]
  ...
  br i1 %niter1114.ncmp.3, label %._crit_edge.i456.loopexit.unr-lcssa, label %.lr.ph.i460, !llvm.loop !124

._crit_edge.i456.loopexit.unr-lcssa:              ; preds = %.lr.ph.i460
  %lcmp.mod1110.not = icmp eq i64 %xtraiter1109, 0
  br i1 %lcmp.mod1110.not, label %._crit_edge.i456, label %.lr.ph.i460.epil.preheader
...
.lr.ph.i460.epil.preheader:                       ; preds = %._crit_edge.i456.loopexit.unr-lcssa, %.lr.ph.preheader.i458
  ...
  %lcmp.mod1112 = icmp ne i64 %xtraiter1109, 0
...
.lr.ph.i460.epil:                                 ; preds = %.lr.ph.i460.epil, %.lr.ph.i460.epil.preheader
  ...
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter1109
...
begin_hunk_2_@Of_ObjMergeOrder:bb.a
  %i.bok = load ptr, ptr %i.boj, align 8, !tbaa !93 ; 2 uses
  %i.bol = getelementptr inbounds nuw i8, ptr %i.bok, i64 16 ; 3 uses
  %i.bom = load i32, ptr %i.bol, align 8          ; 2 uses
  %i.bon = call i32 @llvm.fshl.i32(i32 %i.bom, i32 %i.bom, i32 5)
  %i.boo = getelementptr inbounds nuw i8, ptr %.04049.i, i64 4 ; 2 uses
  store i32 %i.bon, ptr %.04049.i, align 4, !tbaa !42
  %i.bop = getelementptr inbounds nuw i8, ptr %i.bok, i64 20
  %i.boq = load i32, ptr %i.bol, align 8
  %i.bor = lshr i32 %i.boq, 25
  %i.bos = and i32 %i.bor, 124
  %i.bot = zext nneg i32 %i.bos to i64
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %i.boo, ptr nonnull align 4 %i.bop, i64 %i.bot, i1 false)
  %i.bou = load i32, ptr %i.bol, align 8
  %i.bov = lshr i32 %i.bou, 27
  %i.bow = zext nneg i32 %i.bov to i64
  %i.box = getelementptr inbounds nuw [4 x i8], ptr %i.boo, i64 %i.bow ; 2 uses
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %i.box, i8 -1, i64 12, i1 false)
...
Of_ManSaveCuts.exit:                              ; preds = %.lr.ph51.i, %bb.em
  ...
  %i.boz = getelementptr inbounds [4 x i8], ptr %.val165, i64 %i.f
  store i32 %i.bnz, ptr %i.boz, align 4, !tbaa !42
  %i.bpa = sitofp i32 %.9 to double
  %i.bpb = getelementptr inbounds nuw i8, ptr %0, i64 152 ; 2 uses
  %i.bpc = load double, ptr %i.bpb, align 8, !tbaa !106
  %i.bpd = fadd double %i.bpc, %i.bpa
  store double %i.bpd, ptr %i.bpb, align 8, !tbaa !106
