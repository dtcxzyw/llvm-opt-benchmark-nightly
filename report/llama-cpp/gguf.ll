...
.preheader.i.i582:                                ; preds = %bb.ed, %bb.ef
  %.025.i.i583 = phi i64 [ %i.td, %bb.ef ], [ 0, %bb.ed ] ; 7 uses
  %i.su = icmp ult i64 %.025.i.i583, 8
  %.pre37.i.i584 = load i64, ptr %i.cv, align 8, !tbaa !68 ; 4 uses
  br i1 %i.su, label %bb.ee, label %.thread.i.i585

bb.ee:                                            ; preds = %.preheader.i.i582
  %i.sv = add i64 %.pre37.i.i584, %.025.i.i583    ; 2 uses
  %i.sw = icmp ult i64 %i.sv, %.pre37.i.i584
  br i1 %i.sw, label %.thread.i.i585, label %bb.ef

bb.ef:                                            ; preds = %bb.ee
  %i.sx = sub nuw nsw i64 8, %.025.i.i583
  %i.sy = load i64, ptr %i.cw, align 8, !tbaa !81
  %.sroa.speculated.i.i591 = call i64 @llvm.umin.i64(i64 %i.sx, i64 %i.sy) ; 2 uses
  %i.sz = load ptr, ptr %0, align 8, !tbaa !65
  %i.ta = load ptr, ptr %i.cx, align 8, !tbaa !66
  %i.tb = getelementptr inbounds nuw i8, ptr %i.sn, i64 %.025.i.i583
  %i.tc = call noundef i64 %i.sz(ptr noundef %i.ta, ptr noundef nonnull %i.tb, i64 noundef %i.sv, i64 noundef %.sroa.speculated.i.i591), !inline_history !2 ; 2 uses
  %i.td = add i64 %i.tc, %.025.i.i583             ; 2 uses
  %.not.i.i592 = icmp eq i64 %i.tc, %.sroa.speculated.i.i591
  br i1 %.not.i.i592, label %.preheader.i.i582, label %..thread_crit_edge.i.i593

..thread_crit_edge.i.i593:                        ; preds = %bb.ef
  %.pre.i.i594 = load i64, ptr %i.cv, align 8, !tbaa !68
  br label %.thread.i.i585

.thread.i.i585:                                   ; preds = %bb.ee, %.preheader.i.i582, %..thread_crit_edge.i.i593
  %i.te = phi i64 [ %.pre.i.i594, %..thread_crit_edge.i.i593 ], [ %.pre37.i.i584, %.preheader.i.i582 ], [ %.pre37.i.i584, %bb.ee ]
  %.227.i.i586 = phi i64 [ %i.td, %..thread_crit_edge.i.i593 ], [ %.025.i.i583, %.preheader.i.i582 ], [ %.025.i.i583, %bb.ee ] ; 4 uses
  %.3.i.i587 = phi i1 [ true, %..thread_crit_edge.i.i593 ], [ false, %.preheader.i.i582 ], [ false, %bb.ee ]
  %i.tf = add i64 %.227.i.i586, %i.te
  store i64 %i.tf, ptr %i.cv, align 8, !tbaa !68
  %i.tg = load i64, ptr %i.cq, align 8, !tbaa !69 ; 2 uses
  %.not32.i.i588 = icmp ugt i64 %.227.i.i586, %i.tg
...
bb.eh:                                            ; preds = %.thread.i.i585
  %i.th = sub nuw i64 %i.tg, %.227.i.i586
  %spec.select.i.i589 = select i1 %.3.i.i587, i64 0, i64 %i.th ; 2 uses
  store i64 %spec.select.i.i589, ptr %i.cq, align 8, !tbaa !69
  %i.ti = icmp eq i64 %.227.i.i586, 8
  %.pr.pre = load i64, ptr %i.sn, align 8, !tbaa !81 ; 2 uses
  %i.tj = icmp slt i64 %.pr.pre, 0
  br i1 %i.tj, label %.thread661, label %.thread658

.thread661:                                       ; preds = %bb.eh
  %i.tk = trunc nuw nsw i64 %indvars.iv1032 to i32
  call void (i32, ptr, ...) @ggml_log_internal(i32 noundef 4, ptr noundef nonnull @.str.43, ptr noundef nonnull @__func__._ZL21gguf_init_from_readerRK11gguf_reader16gguf_init_params, ptr noundef nonnull %i.ox, i32 noundef %i.tk, i64 noundef %.pr.pre)
  br label %.loopexit703

.thread658:                                       ; preds = %.lr.ph912, %bb.eh
  %i.tl = phi i64 [ %spec.select.i.i589, %bb.eh ], [ %i.sm, %.lr.ph912 ]
  %.20660 = phi i1 [ %i.ti, %bb.eh ], [ true, %.lr.ph912 ] ; 2 uses
  %indvars.iv.next1033 = add nuw nsw i64 %indvars.iv1032, 1
  %i.tm = icmp samesign ult i64 %indvars.iv1032, 3
  %i.tn = select i1 %.20660, i1 %i.tm, i1 false
  br i1 %i.tn, label %.lr.ph912, label %._crit_edge913, !llvm.loop !217

._crit_edge913:                                   ; preds = %.thread658
  br i1 %.20660, label %bb.ei, label %.loopexit703

bb.ei:                                            ; preds = %._crit_edge913
  %i.to = call i64 @ggml_nelements(ptr noundef nonnull %5)
  %i.tp = icmp sgt i64 %i.to, 0
  br i1 %i.tp, label %bb.ej, label %bb.en

bb.ej:                                            ; preds = %bb.ei
  %i.tq = load i64, ptr %i.pa, align 8, !tbaa !81 ; 3 uses
  %i.tr = sdiv i64 9223372036854775807, %i.tq
  %i.ts = load i64, ptr %i.oz, align 8, !tbaa !81 ; 3 uses
  %.not411 = icmp sgt i64 %i.tr, %i.ts
  %.pre1041 = load i64, ptr %i.pb, align 8, !tbaa !81 ; 3 uses
  br i1 %.not411, label %bb.ek, label %._crit_edge1042

._crit_edge1042:                                  ; preds = %bb.ej
  %.pre1043 = load i64, ptr %i.pc, align 8, !tbaa !81
  br label %split

bb.ek:                                            ; preds = %bb.ej
  %i.tt = sdiv i64 9223372036854775807, %.pre1041
  %i.tu = mul nsw i64 %i.ts, %i.tq                ; 2 uses
  %.not412 = icmp sgt i64 %i.tt, %i.tu
  %.pre1044 = load i64, ptr %i.pc, align 8, !tbaa !81 ; 3 uses
  br i1 %.not412, label %bb.el, label %split

bb.el:                                            ; preds = %bb.ek
  %i.tv = sdiv i64 9223372036854775807, %.pre1044
  %i.tw = mul nsw i64 %.pre1041, %i.tu
  %.not413 = icmp sgt i64 %i.tv, %i.tw
  br i1 %.not413, label %bb.en, label %split

split:                                            ; preds = %bb.el, %bb.ek, %._crit_edge1042
  %i.tx = phi i64 [ %.pre1043, %._crit_edge1042 ], [ %.pre1044, %bb.ek ], [ %.pre1044, %bb.el ]
  call void (i32, ptr, ...) @ggml_log_internal(i32 noundef 4, ptr noundef nonnull @.str.44, ptr noundef nonnull @__func__._ZL21gguf_init_from_readerRK11gguf_reader16gguf_init_params, ptr noundef nonnull %i.ox, i64 noundef %i.ts, i64 noundef %i.tq, i64 noundef %.pre1041, i64 noundef %i.tx, i64 noundef 9223372036854775807)
  br label %bb.em
...
bb.en:                                            ; preds = %bb.ei, %bb.el
  ...
  %i.ty = load i64, ptr %i.cq, align 8, !tbaa !69
  %i.tz = icmp ult i64 %i.ty, 4
  %i.ua = load ptr, ptr %0, align 8
  %i.ub = icmp eq ptr %i.ua, null
  %or.cond.i.i596 = select i1 %i.tz, i1 true, i1 %i.ub
...
.preheader.i.i.i597:                              ; preds = %bb.en, %bb.ep
  %.025.i.i.i598 = phi i64 [ %i.ul, %bb.ep ], [ 0, %bb.en ] ; 7 uses
  %i.uc = icmp ult i64 %.025.i.i.i598, 4
  %.pre37.i.i.i599 = load i64, ptr %i.cv, align 8, !tbaa !68 ; 4 uses
  br i1 %i.uc, label %bb.eo, label %.thread.i.i.i600

bb.eo:                                            ; preds = %.preheader.i.i.i597
  %i.ud = add i64 %.pre37.i.i.i599, %.025.i.i.i598 ; 2 uses
  %i.ue = icmp ult i64 %i.ud, %.pre37.i.i.i599
  br i1 %i.ue, label %.thread.i.i.i600, label %bb.ep

bb.ep:                                            ; preds = %bb.eo
  %i.uf = sub nuw nsw i64 4, %.025.i.i.i598
  %i.ug = load i64, ptr %i.cw, align 8, !tbaa !81
  %.sroa.speculated.i.i.i607 = call i64 @llvm.umin.i64(i64 %i.uf, i64 %i.ug) ; 2 uses
  %i.uh = load ptr, ptr %0, align 8, !tbaa !65
  %i.ui = load ptr, ptr %i.cx, align 8, !tbaa !66
  %i.uj = getelementptr inbounds nuw i8, ptr %i.a, i64 %.025.i.i.i598
  %i.uk = call noundef i64 %i.uh(ptr noundef %i.ui, ptr noundef nonnull %i.uj, i64 noundef %i.ud, i64 noundef %.sroa.speculated.i.i.i607), !inline_history !218 ; 2 uses
  %i.ul = add i64 %i.uk, %.025.i.i.i598           ; 2 uses
  %.not.i.i.i608 = icmp eq i64 %i.uk, %.sroa.speculated.i.i.i607
  br i1 %.not.i.i.i608, label %.preheader.i.i.i597, label %..thread_crit_edge.i.i.i609

..thread_crit_edge.i.i.i609:                      ; preds = %bb.ep
  %.pre.i.i.i610 = load i64, ptr %i.cv, align 8, !tbaa !68
  br label %.thread.i.i.i600

.thread.i.i.i600:                                 ; preds = %bb.eo, %.preheader.i.i.i597, %..thread_crit_edge.i.i.i609
  %i.um = phi i64 [ %.pre.i.i.i610, %..thread_crit_edge.i.i.i609 ], [ %.pre37.i.i.i599, %.preheader.i.i.i597 ], [ %.pre37.i.i.i599, %bb.eo ]
  %.227.i.i.i601 = phi i64 [ %i.ul, %..thread_crit_edge.i.i.i609 ], [ %.025.i.i.i598, %.preheader.i.i.i597 ], [ %.025.i.i.i598, %bb.eo ] ; 4 uses
  %.3.i.i.i602 = phi i1 [ true, %..thread_crit_edge.i.i.i609 ], [ false, %.preheader.i.i.i597 ], [ false, %bb.eo ]
  %i.un = add i64 %.227.i.i.i601, %i.um
  store i64 %i.un, ptr %i.cv, align 8, !tbaa !68
  %i.uo = load i64, ptr %i.cq, align 8, !tbaa !69 ; 2 uses
  %.not32.i.i.i603 = icmp ugt i64 %.227.i.i.i601, %i.uo
...
_ZNK11gguf_reader4readIiEEbRT_.exit.i604:         ; preds = %.thread.i.i.i600
  %i.up = sub nuw i64 %i.uo, %.227.i.i.i601
  %spec.select.i.i.i605 = select i1 %.3.i.i.i602, i64 0, i64 %i.up
  store i64 %spec.select.i.i.i605, ptr %i.cq, align 8, !tbaa !69
  %i.uq = icmp eq i64 %.227.i.i.i601, 4
  br i1 %i.uq, label %bb.er, label %_ZNK11gguf_reader4readER9ggml_type.exitthread-pre-split

bb.er:                                            ; preds = %_ZNK11gguf_reader4readIiEEbRT_.exit.i604
  %i.ur = load i32, ptr %i.a, align 4, !tbaa !87  ; 2 uses
  store i32 %i.ur, ptr %5, align 8, !tbaa !105
...
_ZNK11gguf_reader4readER9ggml_type.exit:          ; preds = %_ZNK11gguf_reader4readER9ggml_type.exitthread-pre-split, %bb.er
  %i.us = phi i32 [ %.pr672, %_ZNK11gguf_reader4readER9ggml_type.exitthread-pre-split ], [ %i.ur, %bb.er ] ; 3 uses
  %.0.i4.i606 = phi i1 [ false, %_ZNK11gguf_reader4readER9ggml_type.exitthread-pre-split ], [ true, %bb.er ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #31
  %or.cond19 = icmp ugt i32 %i.us, 42
  br i1 %or.cond19, label %bb.es, label %bb.et

bb.es:                                            ; preds = %_ZNK11gguf_reader4readER9ggml_type.exit
  call void (i32, ptr, ...) @ggml_log_internal(i32 noundef 4, ptr noundef nonnull @.str.45, ptr noundef nonnull @__func__._ZL21gguf_init_from_readerRK11gguf_reader16gguf_init_params, ptr noundef nonnull %i.ox, i32 noundef %i.us, i32 noundef 43)
  br label %.thread688

bb.et:                                            ; preds = %_ZNK11gguf_reader4readER9ggml_type.exit
  %i.ut = call i64 @ggml_type_size(i32 noundef %i.us) ; 4 uses
  %i.uu = load i32, ptr %5, align 8, !tbaa !111
  %i.uv = call i64 @ggml_blck_size(i32 noundef %i.uu) ; 5 uses
  %i.uw = icmp eq i64 %i.uv, 0
  br i1 %i.uw, label %bb.ev, label %bb.eu

bb.eu:                                            ; preds = %bb.et
  %i.ux = load i64, ptr %i.oz, align 8, !tbaa !81 ; 2 uses
  %i.uy = srem i64 %i.ux, %i.uv
  %i.uz = sdiv exact i64 %i.ux, %i.uv
  %.not414 = icmp eq i64 %i.uy, 0
  br i1 %.not414, label %bb.ew, label %bb.ev

bb.ev:                                            ; preds = %bb.eu, %bb.et
  %i.va = load i32, ptr %5, align 8, !tbaa !111   ; 2 uses
  %i.vb = call ptr @ggml_type_name(i32 noundef %i.va)
  %i.vc = load i64, ptr %i.oz, align 8, !tbaa !81
  call void (i32, ptr, ...) @ggml_log_internal(i32 noundef 4, ptr noundef nonnull @.str.46, ptr noundef nonnull @__func__._ZL21gguf_init_from_readerRK11gguf_reader16gguf_init_params, ptr noundef nonnull %i.ox, i32 noundef %i.va, ptr noundef %i.vb, i64 noundef %i.vc, i64 noundef %i.uv)
  br label %.thread688
...
bb.ex:                                            ; preds = %bb.ew
  %i.vd = call i64 @ggml_nelements(ptr noundef nonnull %5)
  %i.ve = load i32, ptr %5, align 8, !tbaa !111
  %i.vf = call i64 @ggml_blck_size(i32 noundef %i.ve)
  %i.vg = sdiv i64 %i.vd, %i.vf
  %i.vh = load i32, ptr %5, align 8, !tbaa !111
  %i.vi = call i64 @ggml_type_size(i32 noundef %i.vh)
  %mul = call { i64, i1 } @llvm.umul.with.overflow.i64(i64 %i.vi, i64 %i.vg)
  %mul.ov = extractvalue { i64, i1 } %mul, 1
  %.pre1045 = load i64, ptr %i.oz, align 8, !tbaa !81 ; 2 uses
  br i1 %mul.ov, label %bb.ey, label %.thread683

bb.ey:                                            ; preds = %bb.ex
  %i.vj = load i64, ptr %i.pa, align 8, !tbaa !81
  %i.vk = load i64, ptr %i.pb, align 8, !tbaa !81
  %i.vl = load i64, ptr %i.pc, align 8, !tbaa !81
  call void (i32, ptr, ...) @ggml_log_internal(i32 noundef 4, ptr noundef nonnull @.str.47, ptr noundef nonnull @__func__._ZL21gguf_init_from_readerRK11gguf_reader16gguf_init_params, ptr noundef nonnull %i.ox, i64 noundef %.pre1045, i64 noundef %i.vj, i64 noundef %i.vk, i64 noundef %i.vl, i64 noundef -1)
  br label %.thread688

.thread683:                                       ; preds = %bb.ex
  store i64 %i.ut, ptr %i.pd, align 8, !tbaa !81
  %i.vm = sdiv i64 %.pre1045, %i.uv
  %i.vn = mul i64 %i.vm, %i.ut                    ; 2 uses
  store i64 %i.vn, ptr %i.pe, align 8, !tbaa !81
  %i.vo = load i64, ptr %i.pg, align 8, !tbaa !81
  %i.vp = mul i64 %i.vo, %i.vn                    ; 2 uses
  store i64 %i.vp, ptr %i.ph, align 8, !tbaa !81
  %i.vq = load i64, ptr %i.pi, align 8, !tbaa !81
  %i.vr = mul i64 %i.vq, %i.vp
  store i64 %i.vr, ptr %i.pj, align 8, !tbaa !81
  %i.vs = call noundef zeroext i1 @_ZNK11gguf_reader4readImEEbRT_(ptr noundef nonnull align 8 dereferenceable(40) %0, ptr noundef nonnull align 8 dereferenceable(8) %i.pf) ; 2 uses
  call void @_ZNSt6vectorI16gguf_tensor_infoSaIS0_EE9push_backERKS0_(ptr noundef nonnull align 8 dereferenceable(24) %i.oy, ptr noundef nonnull align 8 dereferenceable(344) %5)
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #31
  %i.vt = add nuw nsw i64 %.0313916, 1            ; 2 uses
  %i.vu = load i64, ptr %i.e, align 8
  %i.vv = icmp slt i64 %i.vt, %i.vu
  %i.vw = select i1 %i.vs, i1 %i.vv, i1 false
  br i1 %i.vw, label %bb.dd, label %.loopexit701, !llvm.loop !219

.thread688.loopexit.critedge:                     ; preds = %bb.ew
  store i64 %i.ut, ptr %i.pd, align 8, !tbaa !81
  %i.vx = mul i64 %i.uz, %i.ut                    ; 2 uses
  store i64 %i.vx, ptr %i.pe, align 8, !tbaa !81
  %i.vy = load i64, ptr %i.pg, align 8, !tbaa !81
  %i.vz = mul i64 %i.vy, %i.vx                    ; 2 uses
  store i64 %i.vz, ptr %i.ph, align 8, !tbaa !81
  %i.wa = load i64, ptr %i.pi, align 8, !tbaa !81
  %i.wb = mul i64 %i.wa, %i.vz
  store i64 %i.wb, ptr %i.pj, align 8, !tbaa !81
  br label %.thread688
...
.split:                                           ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit562
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #31
  %i.wc = trunc nuw i8 %.18 to i1
  br i1 %i.wc, label %.loopexit701.thread, label %bb.ez

.loopexit701:                                     ; preds = %.thread683
  br i1 %i.vs, label %.loopexit701.thread, label %bb.ez
...
.loopexit701.thread:                              ; preds = %.preheader700, %.split, %.loopexit701
  %i.wd = getelementptr inbounds nuw i8, ptr %i.h, i64 32 ; 5 uses
  %i.we = getelementptr inbounds nuw i8, ptr %i.h, i64 40 ; 4 uses
  %i.wf = load ptr, ptr %i.we, align 8, !tbaa !112 ; 2 uses
  %i.wg = load ptr, ptr %i.wd, align 8, !tbaa !74 ; 3 uses
  %i.wh = ptrtoint ptr %i.wf to i64
  %i.wi = ptrtoint ptr %i.wg to i64
  %i.wj = sub i64 %i.wh, %i.wi                    ; 2 uses
  %i.wk = sdiv exact i64 %i.wj, 344
  %i.wl = load i64, ptr %i.e, align 8, !tbaa !81
  %i.wm = icmp eq i64 %i.wk, %i.wl
  br i1 %i.wm, label %bb.fb, label %bb.fa
...
bb.fb:                                            ; preds = %.loopexit701.thread
  %i.wn = icmp sgt i64 %i.wj, 0
  %.pre1046 = load i64, ptr %i.cv, align 8, !tbaa !68 ; 3 uses
  br i1 %i.wn, label %bb.fc, label %bb.fd

bb.fc:                                            ; preds = %bb.fb
  %i.wo = load i64, ptr %i.j, align 8, !tbaa !63  ; 2 uses
  %i.wp = add i64 %.pre1046, -1
  %i.wq = add i64 %i.wp, %i.wo
  %i.wr = sub i64 0, %i.wo
  %i.ws = and i64 %i.wq, %i.wr                    ; 4 uses
  %i.wt = load i64, ptr %i.cq, align 8, !tbaa !69
  %i.wu = add i64 %i.wt, %.pre1046                ; 2 uses
  %.not696 = icmp ugt i64 %i.ws, %i.wu
...
_ZNK11gguf_reader4seekEm.exit.thread:             ; preds = %bb.fc
  store i64 %i.ws, ptr %i.cv, align 8, !tbaa !68
  %i.wv = sub nuw i64 %i.wu, %i.ws
  store i64 %i.wv, ptr %i.cq, align 8, !tbaa !69
  br label %bb.fd
...
bb.fd:                                            ; preds = %_ZNK11gguf_reader4seekEm.exit.thread, %bb.fb
  %i.ww = phi i64 [ %i.ws, %_ZNK11gguf_reader4seekEm.exit.thread ], [ %.pre1046, %bb.fb ]
  store i64 %i.ww, ptr %i.k, align 8, !tbaa !113
  %i.wx = getelementptr inbounds nuw i8, ptr %i.h, i64 72 ; 6 uses
  store i64 0, ptr %i.wx, align 8, !tbaa !223
  %.not416921.not = icmp eq ptr %i.wf, %i.wg
  br i1 %.not416921.not, label %.critedge440, label %.lr.ph924

.lr.ph924:                                        ; preds = %bb.fd, %bb.fk
  %i.wy = phi i64 [ %i.yd, %bb.fk ], [ 0, %bb.fd ] ; 2 uses
  %i.wz = phi ptr [ %i.yg, %bb.fk ], [ %i.wg, %bb.fd ]
  %.0309922 = phi i64 [ %i.ye, %bb.fk ], [ 0, %bb.fd ] ; 2 uses
  %i.xa = getelementptr inbounds nuw [344 x i8], ptr %i.wz, i64 %.0309922 ; 4 uses
  %i.xb = getelementptr inbounds nuw i8, ptr %i.xa, i64 336
  %i.xc = load i64, ptr %i.xb, align 8, !tbaa !114 ; 2 uses
  %.not415 = icmp eq i64 %i.xc, %i.wy
  br i1 %.not415, label %bb.fe, label %.critedge438

.critedge438:                                     ; preds = %.lr.ph924
  %i.xd = getelementptr inbounds nuw i8, ptr %i.xa, i64 256
  call void (i32, ptr, ...) @ggml_log_internal(i32 noundef 4, ptr noundef nonnull @.str.51, ptr noundef nonnull @__func__._ZL21gguf_init_from_readerRK11gguf_reader16gguf_init_params, ptr noundef nonnull %i.xd, i64 noundef %i.xc, i64 noundef %i.wy)
...
bb.fe:                                            ; preds = %.lr.ph924
  %i.xe = call i64 @ggml_nbytes(ptr noundef nonnull %i.xa)
  %i.xf = load i64, ptr %i.j, align 8, !tbaa !63  ; 2 uses
  %i.xg = add i64 %i.xe, -1
  %i.xh = add i64 %i.xg, %i.xf
  %i.xi = sub i64 0, %i.xf
  %i.xj = and i64 %i.xh, %i.xi                    ; 3 uses
  %i.xk = load i64, ptr %i.wx, align 8, !tbaa !223 ; 3 uses
  %i.xl = xor i64 %i.xk, -1
  %.not698 = icmp ugt i64 %i.xj, %i.xl
  br i1 %.not698, label %bb.ff, label %bb.fk

bb.ff:                                            ; preds = %bb.fe
  %i.xm = getelementptr inbounds nuw i8, ptr %i.xa, i64 256
  call void (i32, ptr, ...) @ggml_log_internal(i32 noundef 4, ptr noundef nonnull @.str.53, ptr noundef nonnull @__func__._ZL21gguf_init_from_readerRK11gguf_reader16gguf_init_params, ptr noundef nonnull %i.xm, i64 noundef %i.xk, i64 noundef %i.xj)
  %i.xn = load ptr, ptr %i.wd, align 8, !tbaa !74 ; 3 uses
  %.not.i.i.i.i.i611 = icmp eq ptr %i.xn, null
  br i1 %.not.i.i.i.i.i611, label %_ZNSt6vectorI16gguf_tensor_infoSaIS0_EED2Ev.exit.i.i612, label %bb.fg

bb.fg:                                            ; preds = %bb.ff
  %i.xo = getelementptr inbounds nuw i8, ptr %i.h, i64 48
  %i.xp = load ptr, ptr %i.xo, align 8, !tbaa !75
  %i.xq = ptrtoint ptr %i.xp to i64
  %i.xr = ptrtoint ptr %i.xn to i64
  %i.xs = sub i64 %i.xq, %i.xr
  call void @_ZdlPvm(ptr noundef nonnull %i.xn, i64 noundef %i.xs) #33
...
_ZNSt6vectorI16gguf_tensor_infoSaIS0_EED2Ev.exit.i.i612: ; preds = %bb.fg, %bb.ff
  %i.xt = load ptr, ptr %i.i, align 8, !tbaa !76
  %i.xu = load ptr, ptr %i.ma, align 8, !tbaa !77
  invoke void @_ZNSt12_Destroy_auxILb0EE9__destroyIP7gguf_kvEEvT_S4_(ptr noundef %i.xt, ptr noundef %i.xu)
...
_ZSt8_DestroyIP7gguf_kvS0_EvT_S2_RSaIT0_E.exit.i.i.i613: ; preds = %_ZNSt6vectorI16gguf_tensor_infoSaIS0_EED2Ev.exit.i.i612
  %i.xv = load ptr, ptr %i.i, align 8, !tbaa !76  ; 3 uses
  %.not.i.i.i1.i.i614 = icmp eq ptr %i.xv, null
  br i1 %.not.i.i.i1.i.i614, label %bb.fj, label %bb.fh

bb.fh:                                            ; preds = %_ZSt8_DestroyIP7gguf_kvS0_EvT_S2_RSaIT0_E.exit.i.i.i613
  %i.xw = getelementptr inbounds nuw i8, ptr %i.h, i64 24
  %i.xx = load ptr, ptr %i.xw, align 8, !tbaa !78
  %i.xy = ptrtoint ptr %i.xx to i64
  %i.xz = ptrtoint ptr %i.xv to i64
  %i.ya = sub i64 %i.xy, %i.xz
  call void @_ZdlPvm(ptr noundef nonnull %i.xv, i64 noundef %i.ya) #33
  br label %bb.fj
