...
begin_hunk_0_@quantize_iq2_xs:bb.a
  %i.ahc = and i32 %spec.store.select.i.i.us, 2139095040
  %i.ahd = add nuw i32 %i.ahc, 125829120
  %i.ahe = bitcast i32 %i.ahd to float
  %i.ahf = fadd float %i.agy, %i.ahe
  %i.ahg = bitcast float %i.ahf to i32            ; 2 uses
  %i.ahh = lshr i32 %i.ahg, 13
  %i.ahi = and i32 %i.ahh, 31744
  %i.ahj = and i32 %i.ahg, 4095
  %i.ahk = add nuw nsw i32 %i.ahi, %i.ahj
  %i.ahl = lshr i32 %i.agz, 16
  %i.ahm = and i32 %i.ahl, 32768
  %i.ahn = icmp ugt i32 %i.aha, -16777216
  %i.aho = select i1 %i.ahn, i32 32256, i32 %i.ahk
  %i.ahp = or i32 %i.aho, %i.ahm
  %i.ahq = trunc nuw i32 %i.ahp to i16
  store i16 %i.ahq, ptr %i.bu, align 2, !tbaa !57, !alias.scope !650, !noalias !653
  %i.ahr = fdiv float 1.000000e+00, %i.agv
  br label %bb.aa

bb.aa:                                            ; preds = %bb.ad, %bb.z
  %indvars.iv486.i.us = phi i64 [ 0, %bb.z ], [ %indvars.iv.next487.i.us, %bb.ad ] ; 5 uses
  %i.ahs = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %indvars.iv486.i.us
  %i.aht = load float, ptr %i.ahs, align 4, !tbaa !36, !noalias !652
  %i.ahu = tail call float @llvm.fmuladd.f32(float %i.ahr, float %i.aht, float -1.000000e+00)
  %i.ahv = fmul float %i.ahu, 5.000000e-01
  %i.ahw = fadd float %i.ahv, f0x4B400000
  %i.ahx = bitcast float %i.ahw to i32
  %i.ahy = and i32 %i.ahx, 8388607
  %i.ahz = tail call i32 @llvm.usub.sat.i32(i32 %i.ahy, i32 4194304)
  %i.aia = tail call i32 @llvm.umin.i32(i32 %i.ahz, i32 15) ; 2 uses
  %i.aib = and i64 %indvars.iv486.i.us, 1
  %i.aic = icmp eq i64 %i.aib, 0
  br i1 %i.aic, label %bb.ac, label %bb.ab

bb.ab:                                            ; preds = %bb.aa
  %i.aid = lshr i64 %indvars.iv486.i.us, 1
  %i.aie = and i64 %i.aid, 2147483647
  %i.aif = getelementptr inbounds nuw i8, ptr %i.bv, i64 %i.aie ; 2 uses
  %i.aig = load i8, ptr %i.aif, align 1, !tbaa !34, !alias.scope !650, !noalias !653
  %.tr.i.us = trunc nuw nsw i32 %i.aia to i8
  %i.aih = shl nuw i8 %.tr.i.us, 4
  %i.aii = or i8 %i.aig, %i.aih
  store i8 %i.aii, ptr %i.aif, align 1, !tbaa !34, !alias.scope !650, !noalias !653
  br label %bb.ad

bb.ac:                                            ; preds = %bb.aa
  %i.aij = trunc nuw nsw i32 %i.aia to i8
  %i.aik = lshr exact i64 %indvars.iv486.i.us, 1
  %i.ail = and i64 %i.aik, 2147483647
  %i.aim = getelementptr inbounds nuw i8, ptr %i.bv, i64 %i.ail
  store i8 %i.aij, ptr %i.aim, align 1, !tbaa !34, !alias.scope !650, !noalias !653
  br label %bb.ad
...
bb.ae:                                            ; preds = %bb.ad
  %i.ain = getelementptr inbounds nuw i8, ptr %i.bu, i64 2
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 2 dereferenceable(64) %i.ain, ptr noundef nonnull align 16 dereferenceable(64) %i.f, i64 64, i1 false), !noalias !653
  br label %bb.af
...
quantize_row_iq2_xs_impl.exit.loopexit.us:        ; preds = %bb.af
  ...
  %i.aio = getelementptr inbounds [4 x i8], ptr %.01659.us64, i64 %3
  %i.aip = getelementptr inbounds nuw i8, ptr %.01560.us63, i64 %i.an
  %i.aiq = add nuw nsw i64 %.061.us62, 1          ; 2 uses
  %exitcond92.not = icmp eq i64 %i.aiq, %2
  br i1 %exitcond92.not, label %._crit_edge, label %.lr.ph.split.split.us, !llvm.loop !648

.lr.ph.split.split:                               ; preds = %.lr.ph.split
  %i.air = load ptr, ptr getelementptr inbounds nuw (i8, ptr @iq2_data, i64 32), align 16, !tbaa !77, !noalias !652
  %i.ais = icmp eq ptr %i.air, null
  br i1 %i.ais, label %.split.us65.loopexit86, label %.lr.ph.split.split.split.us

.lr.ph.split.split.split.us:                      ; preds = %.lr.ph.split.split
  %i.ait = load ptr, ptr getelementptr inbounds nuw (i8, ptr @iq2_data, i64 24), align 8, !tbaa !74, !noalias !652
  %.not348.i.us79 = icmp eq ptr %i.ait, null
...
.lr.ph.split.split.split.us.split:                ; preds = %.lr.ph.split.split.split.us
  %i.aiu = load ptr, ptr getelementptr inbounds nuw (i8, ptr @iq2_data, i64 40), align 8, !tbaa !79, !noalias !652
  %.not349.i.us80 = icmp eq ptr %i.aiu, null
...
.split71.us:                                      ; preds = %.loopexit357.i.us, %.preheader352.1.i.us
  ...
  %.lcssa413.lcssa.i.us = phi i16 [ %i.afo, %.loopexit357.i.us ], [ %i.age, %.preheader352.1.i.us ]
  %i.aix = zext i16 %.lcssa413.lcssa.i.us to i32
  %i.aiy = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.16, i32 noundef %i.aix), !noalias !652 ; 0 uses
  %i.aiz = load i8, ptr %.0290401.lcssa.wide.i.sroa.phi.us, align 1, !tbaa !34, !noalias !652
  ...
  %i.ajc = getelementptr inbounds nuw i8, ptr %.0290401.lcssa.wide.i.sroa.phi.us, i64 1
  ...
  %i.ajg = getelementptr inbounds nuw i8, ptr %.0290401.lcssa.wide.i.sroa.phi.us, i64 2
  ...
  %i.ajk = getelementptr inbounds nuw i8, ptr %.0290401.lcssa.wide.i.sroa.phi.us, i64 3
  ...
  %i.ajo = getelementptr inbounds nuw i8, ptr %.0290401.lcssa.wide.i.sroa.phi.us, i64 4
  %i.ajp = load i8, ptr %i.ajo, align 1, !tbaa !34, !noalias !652
  %i.ajq = sext i8 %i.ajp to i32
  %i.ajr = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.17, i32 noundef %i.ajq), !noalias !652 ; 0 uses
  %i.ajs = getelementptr inbounds nuw i8, ptr %.0290401.lcssa.wide.i.sroa.phi.us, i64 5
  %i.ajt = load i8, ptr %i.ajs, align 1, !tbaa !34, !noalias !652
  %i.aju = sext i8 %i.ajt to i32
  %i.ajv = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.17, i32 noundef %i.aju), !noalias !652 ; 0 uses
  %i.ajw = getelementptr inbounds nuw i8, ptr %.0290401.lcssa.wide.i.sroa.phi.us, i64 6
  %i.ajx = load i8, ptr %i.ajw, align 1, !tbaa !34, !noalias !652
  %i.ajy = sext i8 %i.ajx to i32
  %i.ajz = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.17, i32 noundef %i.ajy), !noalias !652 ; 0 uses
  %i.aka = getelementptr inbounds nuw i8, ptr %.0290401.lcssa.wide.i.sroa.phi.us, i64 7
  %i.akb = load i8, ptr %i.aka, align 1, !tbaa !34, !noalias !652
  %i.akc = sext i8 %i.akb to i32
  %i.akd = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.17, i32 noundef %i.akc), !noalias !652 ; 0 uses
