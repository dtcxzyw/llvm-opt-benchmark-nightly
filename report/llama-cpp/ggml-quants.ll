...
.preheader361.preheader.i.us:                     ; preds = %bb.w, %bb.h
  ...
  %i.cr = getelementptr inbounds nuw [4 x i8], ptr %i.co, i64 %i.cp ; 3 uses
  ...
  %5 = load <11 x float>, ptr %i.du, align 4, !tbaa !36, !alias.scope !651, !noalias !655
  %6 = insertelement <11 x float> poison, float %i.dy, i64 0
  %7 = insertelement <11 x float> %6, float %i.ec, i64 1
  %8 = insertelement <11 x float> %7, float %i.eg, i64 2
  %9 = insertelement <11 x float> %8, float %i.ek, i64 3
  %10 = insertelement <11 x float> %9, float %i.eo, i64 4
  %11 = insertelement <11 x float> %10, float %i.es, i64 5
  %12 = insertelement <11 x float> %11, float %i.ew, i64 6
  %13 = insertelement <11 x float> %12, float %i.fa, i64 7
  %14 = insertelement <11 x float> %13, float %i.fe, i64 8
  %15 = insertelement <11 x float> %14, float %i.fi, i64 9
  %16 = insertelement <11 x float> %15, float %i.fm, i64 10
  %17 = fmul <11 x float> %5, %16                 ; 23 uses
  %18 = extractelement <4 x float> %i.dm, i64 0   ; 3 uses
  %19 = tail call float @sqrtf(float noundef %18) #14, !noalias !652
  store float %19, ptr %i.e, align 16, !tbaa !36, !noalias !652
  %20 = extractelement <4 x float> %i.dm, i64 1   ; 3 uses
  %21 = tail call float @sqrtf(float noundef %20) #14, !noalias !652
  store float %21, ptr %i.k, align 4, !tbaa !36, !noalias !652
  %i.fn = extractelement <4 x float> %i.dm, i64 2 ; 4 uses
  %i.fo = tail call float @sqrtf(float noundef %i.fn) #14, !noalias !652
  store float %i.fo, ptr %i.l, align 8, !tbaa !36, !noalias !652
  %i.fp = extractelement <4 x float> %i.dm, i64 3 ; 4 uses
  %i.fq = tail call float @sqrtf(float noundef %i.fp) #14, !noalias !652
  store float %i.fq, ptr %i.m, align 4, !tbaa !36, !noalias !652
  %i.fr = tail call float @sqrtf(float noundef %i.dt) #14, !noalias !652
  store float %i.fr, ptr %i.n, align 16, !tbaa !36, !noalias !652
  %i.fs = extractelement <11 x float> %17, i64 0  ; 4 uses
  %i.ft = tail call float @sqrtf(float noundef %i.fs) #14, !noalias !652
  store float %i.ft, ptr %i.o, align 4, !tbaa !36, !noalias !652
  %22 = extractelement <11 x float> %17, i64 1    ; 4 uses
  %i.fu = tail call float @sqrtf(float noundef %22) #14, !noalias !652
  store float %i.fu, ptr %i.p, align 8, !tbaa !36, !noalias !652
  %23 = extractelement <11 x float> %17, i64 2    ; 4 uses
  %24 = tail call float @sqrtf(float noundef %23) #14, !noalias !652
  store float %24, ptr %i.q, align 4, !tbaa !36, !noalias !652
  %25 = extractelement <11 x float> %17, i64 3    ; 3 uses
  %i.fv = tail call float @sqrtf(float noundef %25) #14, !noalias !652
  store float %i.fv, ptr %indvars.iv446.i.us.sroa.gep95, align 16, !tbaa !36, !noalias !652
  %i.fw = extractelement <11 x float> %17, i64 4  ; 3 uses
  %i.fx = tail call float @sqrtf(float noundef %i.fw) #14, !noalias !652
  store float %i.fx, ptr %i.r, align 4, !tbaa !36, !noalias !652
  %i.fy = extractelement <11 x float> %17, i64 5  ; 4 uses
  %i.fz = tail call float @sqrtf(float noundef %i.fy) #14, !noalias !652
  store float %i.fz, ptr %i.s, align 8, !tbaa !36, !noalias !652
  %i.ga = extractelement <11 x float> %17, i64 6  ; 4 uses
  %i.gb = tail call float @sqrtf(float noundef %i.ga) #14, !noalias !652
  store float %i.gb, ptr %i.t, align 4, !tbaa !36, !noalias !652
  %i.gc = extractelement <11 x float> %17, i64 7  ; 4 uses
  %i.gd = tail call float @sqrtf(float noundef %i.gc) #14, !noalias !652
  store float %i.gd, ptr %i.u, align 16, !tbaa !36, !noalias !652
  %i.ge = extractelement <11 x float> %17, i64 8  ; 4 uses
  %i.gf = tail call float @sqrtf(float noundef %i.ge) #14, !noalias !652
  store float %i.gf, ptr %i.v, align 4, !tbaa !36, !noalias !652
  %i.gg = extractelement <11 x float> %17, i64 9  ; 4 uses
  %i.gh = tail call float @sqrtf(float noundef %i.gg) #14, !noalias !652
  store float %i.gh, ptr %i.w, align 8, !tbaa !36, !noalias !652
  %26 = extractelement <11 x float> %17, i64 10   ; 4 uses
  %i.gi = tail call float @sqrtf(float noundef %26) #14, !noalias !652
...
.preheader356.i.us.1:                             ; preds = %bb.i, %.preheader361.preheader.i.us
  ...
  %i.iz = load <2 x float>, ptr %i.ep, align 4, !tbaa !36, !alias.scope !649, !noalias !654 ; 2 uses
  ...
  %i.jo = load <2 x float>, ptr %i.ex, align 4, !tbaa !36, !alias.scope !649, !noalias !654 ; 2 uses
...
bb.j:                                             ; preds = %.preheader356.i.us.1
  %27 = shufflevector <11 x float> %17, <11 x float> poison, <2 x i32> <i32 3, i32 4>
  %i.kq = fmul <2 x float> %i.iy, %27
  ...
  %i.kv = extractelement <2 x float> %i.iz, i64 0 ; 2 uses
  %28 = fmul float %i.kv, %i.fy
  %i.kw = fmul float %i.kv, %28                   ; 2 uses
  ...
  %29 = fmul float %i.ja, %i.ga
  %i.ky = fmul float %i.ja, %29                   ; 2 uses
  ...
  %i.la = extractelement <2 x float> %i.jo, i64 0 ; 2 uses
  %30 = fmul float %i.la, %i.gc
  %i.lb = fmul float %i.la, %30                   ; 2 uses
  ...
  %31 = fmul float %i.jp, %i.ge
  %i.ld = fmul float %i.jp, %31                   ; 2 uses
...
.preheader358.preheader.i.us:                     ; preds = %bb.s, %.preheader353.i.us.1, %bb.r
  ...
  %i.aat = shufflevector <11 x float> %17, <11 x float> poison, <2 x i32> zeroinitializer
  ...
  %32 = shufflevector <11 x float> %17, <11 x float> poison, <2 x i32> <i32 1, i32 1>
  ...
  %33 = shufflevector <11 x float> %17, <11 x float> poison, <2 x i32> <i32 2, i32 2>
  ...
  %34 = shufflevector <11 x float> %17, <11 x float> poison, <2 x i32> <i32 3, i32 3>
  ...
  %35 = shufflevector <11 x float> %17, <11 x float> poison, <2 x i32> <i32 4, i32 4>
  ...
  %36 = shufflevector <11 x float> %17, <11 x float> poison, <2 x i32> <i32 5, i32 5>
  ...
  %37 = shufflevector <11 x float> %17, <11 x float> poison, <2 x i32> <i32 6, i32 6>
  ...
  %38 = shufflevector <11 x float> %17, <11 x float> poison, <2 x i32> <i32 7, i32 7>
  ...
  %39 = shufflevector <11 x float> %17, <11 x float> poison, <2 x i32> <i32 8, i32 8>
  ...
  %40 = shufflevector <11 x float> %17, <11 x float> poison, <2 x i32> <i32 9, i32 9>
  ...
  %41 = shufflevector <11 x float> %17, <11 x float> poison, <2 x i32> <i32 10, i32 10>
