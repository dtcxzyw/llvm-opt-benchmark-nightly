...
.preheader421:                                    ; preds = %.preheader431, %bb.w
  ...
  %i.vl = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.vj ; 3 uses
  ...
  %i.vt = tail call <4 x i32> @llvm.umin.v4i32(<4 x i32> %i.vs, <4 x i32> splat (i32 7)) ; 4 uses
  %i.vu = trunc nuw nsw <4 x i32> %i.vt to <4 x i8>
  store <4 x i8> %i.vu, ptr %i.vl, align 4, !tbaa !34
  %4 = load i8, ptr %i.vl, align 4, !tbaa !34
  %5 = sext i8 %4 to i64
  %6 = extractelement <4 x i32> %i.vt, i64 1
  %7 = shl nuw nsw i32 %6, 3
  %8 = zext nneg i32 %7 to i64
  %9 = extractelement <4 x i32> %i.vt, i64 2
  %10 = shl nuw nsw i32 %9, 6
  %11 = zext nneg i32 %10 to i64
  %12 = extractelement <4 x i32> %i.vt, i64 3
  %13 = shl nuw nsw i32 %12, 9
  %i.vv = zext nneg i32 %13 to i64
  %.masked679 = and i64 %5, 65535
  %.masked678 = or i64 %.masked679, %8
  %.masked = or i64 %.masked678, %11
  %14 = or i64 %.masked, %i.vv
  %i.vw = getelementptr inbounds nuw [4 x i8], ptr %i.l, i64 %14
