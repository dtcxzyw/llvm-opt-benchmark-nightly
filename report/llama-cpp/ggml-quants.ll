...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %1 = load i64, ptr %i.be, align 8, !tbaa !606   ; 8 uses
  %.sroa.10.0.extract.shift = lshr i64 %1, 56
  %.sroa.9.0.extract.shift = lshr i64 %1, 48
  %.sroa.8.0.extract.shift = lshr i64 %1, 40
  %.sroa.7.0.extract.shift = lshr i64 %1, 32
  %.sroa.6.0.extract.shift = lshr i64 %1, 24
  %.sroa.5.0.extract.shift = lshr i64 %1, 16
  %.sroa.10.0.extract.trunc = trunc nuw nsw i64 %.sroa.10.0.extract.shift to i16
  %.sroa.9.0.extract.trunc = trunc nuw i64 %.sroa.9.0.extract.shift to i16
  %.sroa.8.0.extract.trunc = trunc i64 %.sroa.8.0.extract.shift to i16
  %.sroa.7.0.extract.trunc = trunc i64 %.sroa.7.0.extract.shift to i16
  ...
  %3 = lshr i16 %2, 8
  %4 = insertelement <8 x i16> poison, i16 %.sroa.0.0.extract.trunc, i64 0
  %5 = insertelement <8 x i16> %4, i16 %3, i64 1
  %6 = insertelement <8 x i16> %5, i16 %.sroa.5.0.extract.trunc, i64 2
  %7 = insertelement <8 x i16> %6, i16 %.sroa.6.0.extract.trunc, i64 3
  %8 = insertelement <8 x i16> %7, i16 %.sroa.7.0.extract.trunc, i64 4
  %9 = insertelement <8 x i16> %8, i16 %.sroa.8.0.extract.trunc, i64 5
  %10 = insertelement <8 x i16> %9, i16 %.sroa.9.0.extract.trunc, i64 6
  %11 = insertelement <8 x i16> %10, i16 %.sroa.10.0.extract.trunc, i64 7
  %12 = and <8 x i16> %11, <i16 255, i16 -1, i16 255, i16 255, i16 255, i16 255, i16 255, i16 -1>
  %i.bf = add nsw <8 x i16> %12, splat (i16 -1)
...
.lr.ph56:                                         ; preds = %.lr.ph56.preheader, %.lr.ph56
  ...
  %1 = load i32, ptr %i.ax, align 4, !tbaa !47    ; 4 uses
  %.sroa.0.0.extract.trunc = trunc i32 %1 to i16
  %2 = trunc i32 %1 to i16
  %3 = lshr i16 %2, 8
  %.sroa.5.0.extract.shift = lshr i32 %1, 16
  %.sroa.5.0.extract.trunc = trunc nuw i32 %.sroa.5.0.extract.shift to i16
  %.sroa.6.0.extract.shift = lshr i32 %1, 24
  %.sroa.6.0.extract.trunc = trunc nuw nsw i32 %.sroa.6.0.extract.shift to i16
  %4 = and i16 %.sroa.0.0.extract.trunc, 255
  %5 = and i16 %.sroa.5.0.extract.trunc, 255
  %6 = insertelement <4 x i16> poison, i16 %4, i64 0
  %7 = insertelement <4 x i16> %6, i16 %3, i64 1
  %8 = insertelement <4 x i16> %7, i16 %5, i64 2
  %9 = insertelement <4 x i16> %8, i16 %.sroa.6.0.extract.trunc, i64 3
  %i.ay = add nsw <4 x i16> %9, splat (i16 -1)
