...
.preheader374.i.us:                               ; preds = %.preheader374.i.us, %.preheader374.preheader.i.us
  ...
  %i.yc = load float, ptr %i.yb, align 4, !tbaa !36, !noalias !784 ; 2 uses
  ...
  %i.zh = insertelement <8 x float> poison, float %i.yc, i64 0
  ...
  %i.zl = insertelement <8 x float> %i.zk, float %i.ys, i64 4
  %i.zm = insertelement <8 x float> %i.zl, float %i.yw, i64 5
  %i.zn = insertelement <8 x float> %i.zm, float %i.za, i64 6
  ...
  %5 = insertelement <2 x float> poison, float %i.yc, i64 0
  ...
  %i.aae = load <2 x float>, ptr %i.xs, align 4, !tbaa !36, !alias.scope !780, !noalias !783 ; 2 uses
  %i.aaf = shufflevector <8 x float> %i.zp, <8 x float> poison, <2 x i32> <i32 4, i32 4>
  %6 = insertelement <2 x float> poison, float %i.ys, i64 0
  %7 = shufflevector <2 x float> %6, <2 x float> %i.aae, <2 x i32> <i32 0, i32 2>
  ...
  %8 = insertelement <2 x float> %i.aae, float %i.yw, i64 0
  ...
  %9 = insertelement <2 x float> poison, float %i.za, i64 0
  %10 = shufflevector <2 x float> %9, <2 x float> %i.aaj, <2 x i32> <i32 0, i32 2>
...
bb.e:                                             ; preds = %bb.d
  ...
  %7 = shufflevector <2 x float> %i.gd, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %i.gg = shufflevector <2 x float> %i.gc, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %i.gh = shufflevector <2 x float> %i.gb, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %8 = shufflevector <2 x float> %i.gf, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  br label %bb.f
...
bb.f:                                             ; preds = %bb.e, %bb.f
  ...
  %i.hx = insertelement <8 x float> %i.hw, float %i.gx, i64 1
  %i.hy = insertelement <8 x float> %i.hx, float %i.hb, i64 2
  %i.hz = insertelement <8 x float> %i.hy, float %i.hf, i64 3
  %i.ia = insertelement <8 x float> %i.hz, float %i.hj, i64 4
  %i.ib = insertelement <8 x float> %i.ia, float %i.hn, i64 5
  %i.ic = insertelement <8 x float> %i.ib, float %i.hr, i64 6
  ...
  %9 = insertelement <2 x float> %8, float %i.gx, i64 1
  %i.ij = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ii, <2 x float> %9, <2 x float> %i.ih)
  ...
  %10 = insertelement <2 x float> %i.gc, float %i.hj, i64 1
  %i.ir = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.iq, <2 x float> %10, <2 x float> %i.ip)
  %i.is = shufflevector <8 x float> %i.ie, <8 x float> poison, <2 x i32> <i32 5, i32 5>
  %11 = insertelement <2 x float> %i.gg, float %i.hn, i64 1
  %i.it = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.is, <2 x float> %11, <2 x float> %i.ir)
  %i.iu = shufflevector <8 x float> %i.ie, <8 x float> poison, <2 x i32> <i32 6, i32 6>
  %12 = insertelement <2 x float> %i.gd, float %i.hr, i64 1
  %i.iv = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.iu, <2 x float> %12, <2 x float> %i.it)
  %i.iw = shufflevector <8 x float> %i.ie, <8 x float> poison, <2 x i32> <i32 7, i32 7>
  %i.ix = insertelement <2 x float> %7, float %i.hv, i64 1
...
.preheader581.i.us:                               ; preds = %.thread.i.us, %bb.aj
  ...
  %5 = insertelement <2 x float> poison, float %i.hh, i64 0
  %6 = insertelement <2 x float> poison, float %i.hg, i64 0
  %7 = insertelement <2 x float> poison, float %i.hf, i64 0
  %8 = insertelement <2 x float> poison, float %i.he, i64 0
  ...
  %i.wp = load float, ptr %i.wo, align 4, !tbaa !36, !noalias !813 ; 2 uses
  %i.wq = extractelement <16 x i16> %i.wl, i64 1
  %i.wr = sext i16 %i.wq to i64
  %i.ws = getelementptr inbounds [4 x i8], ptr %i.uq, i64 %i.wr
  %i.wt = load float, ptr %i.ws, align 4, !tbaa !36, !noalias !813 ; 2 uses
  %i.wu = extractelement <16 x i16> %i.wl, i64 2
  %i.wv = sext i16 %i.wu to i64
  %i.ww = getelementptr inbounds [4 x i8], ptr %i.uq, i64 %i.wv
  %i.wx = load float, ptr %i.ww, align 4, !tbaa !36, !noalias !813 ; 2 uses
  %i.wy = extractelement <16 x i16> %i.wl, i64 3
  %i.wz = sext i16 %i.wy to i64
  %i.xa = getelementptr inbounds [4 x i8], ptr %i.uq, i64 %i.wz
  %i.xb = load float, ptr %i.xa, align 4, !tbaa !36, !noalias !813 ; 2 uses
  %i.xc = insertelement <4 x float> poison, float %i.wp, i64 0
  %i.xd = insertelement <4 x float> %i.xc, float %i.wt, i64 1
  %i.xe = insertelement <4 x float> %i.xd, float %i.wx, i64 2
  %i.xf = insertelement <4 x float> %i.xe, float %i.xb, i64 3
  %i.xg = fmul <4 x float> %i.hj, %i.xf           ; 4 uses
  %i.xh = shufflevector <4 x float> %i.xg, <4 x float> poison, <2 x i32> zeroinitializer
  %i.xi = insertelement <2 x float> %5, float %i.wp, i64 1
  ...
  %i.xl = insertelement <2 x float> %6, float %i.wt, i64 1
  ...
  %i.xo = insertelement <2 x float> %7, float %i.wx, i64 1
  ...
  %i.xr = insertelement <2 x float> %8, float %i.xb, i64 1
  ...
  %i.yu = load float, ptr %i.yt, align 4, !tbaa !36, !noalias !813 ; 2 uses
  ...
  %i.zk = load float, ptr %i.zj, align 4, !tbaa !36, !noalias !813 ; 2 uses
  ...
  %i.zq = insertelement <12 x float> %i.zp, float %i.zk, i64 1
  ...
  %i.zu = insertelement <12 x float> %i.zt, float %i.yu, i64 5
  %i.zv = insertelement <12 x float> %i.zu, float %i.yq, i64 6
  %i.zw = insertelement <12 x float> %i.zv, float %i.ym, i64 7
  %i.zx = insertelement <12 x float> %i.zw, float %i.yi, i64 8
  %i.zy = insertelement <12 x float> %i.zx, float %i.ye, i64 9
  %i.zz = insertelement <12 x float> %i.zy, float %i.ya, i64 10
  %i.aaa = insertelement <12 x float> %i.zz, float %i.xw, i64 11
  %i.aab = fmul <12 x float> %i.hk, %i.aaa        ; 12 uses
  %i.aac = shufflevector <12 x float> %i.aab, <12 x float> poison, <2 x i32> <i32 11, i32 11>
  %9 = insertelement <2 x float> poison, float %i.hd, i64 0
  %i.aad = insertelement <2 x float> %9, float %i.xw, i64 1
  ...
  %10 = insertelement <2 x float> poison, float %i.hc, i64 0
  %i.aag = insertelement <2 x float> %10, float %i.ya, i64 1
  ...
  %11 = insertelement <2 x float> poison, float %i.hb, i64 0
  %i.aaj = insertelement <2 x float> %11, float %i.ye, i64 1
  ...
  %12 = insertelement <2 x float> poison, float %i.ha, i64 0
  %i.aam = insertelement <2 x float> %12, float %i.yi, i64 1
  ...
  %13 = insertelement <2 x float> %i.aaw, float %i.yu, i64 1
  %i.aay = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.aax, <2 x float> %13, <2 x float> %i.aav)
  ...
  %14 = insertelement <2 x float> %i.abl, float %i.zk, i64 1
  %i.abn = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.abm, <2 x float> %14, <2 x float> %i.abk)
