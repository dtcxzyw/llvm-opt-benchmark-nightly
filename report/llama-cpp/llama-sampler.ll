...
bb.i:                                             ; preds = %.lr.ph.i.i.i.i14.i
  ...
  br i1 %.not7.i.i.i, label %"_ZSt10__pop_heapIN9__gnu_cxx17__normal_iteratorIPSt4pairIiiESt6vectorIS3_SaIS3_EEEENS0_5__ops15_Iter_comp_iterIZL41llama_sampler_penalties_backend_set_inputP13llama_samplerE3$_0EEEvT_SF_SF_RT0_.exit.i.i", label %.lr.ph.i.i.i.i14.i, !llvm.loop !1283
...
"_ZSt10__pop_heapIN9__gnu_cxx17__normal_iteratorIPSt4pairIiiESt6vectorIS3_SaIS3_EEEENS0_5__ops15_Iter_comp_iterIZL41llama_sampler_penalties_backend_set_inputP13llama_samplerE3$_0EEEvT_SF_SF_RT0_.exit.i.i": ; preds = %bb.i, %.lr.ph.i.i.i.i14.i, %bb.h
  ...
  br i1 %i.cz, label %.lr.ph.i9.i, label %"_ZSt14__partial_sortIN9__gnu_cxx17__normal_iteratorIPSt4pairIiiESt6vectorIS3_SaIS3_EEEENS0_5__ops15_Iter_comp_iterIZL41llama_sampler_penalties_backend_set_inputP13llama_samplerE3$_0EEEvT_SF_SF_T0_.exit", !llvm.loop !1285
...
bb.t:                                             ; preds = %bb.t, %"_ZSt22__move_median_to_firstIN9__gnu_cxx17__normal_iteratorIPSt4pairIiiESt6vectorIS3_SaIS3_EEEENS0_5__ops15_Iter_comp_iterIZL41llama_sampler_penalties_backend_set_inputP13llama_samplerE3$_0EEEvT_SF_SF_SF_T0_.exit.i"
  ...
  br i1 %i.ec, label %bb.t, label %.preheader.i.i, !llvm.loop !1286
...
.preheader.i.i:                                   ; preds = %bb.t, %.preheader.i.i
  ...
  br i1 %i.ee, label %.preheader.i.i, label %bb.u, !llvm.loop !1287
...
bb.v:                                             ; preds = %bb.u
  ...
  br label %"_ZSt22__move_median_to_firstIN9__gnu_cxx17__normal_iteratorIPSt4pairIiiESt6vectorIS3_SaIS3_EEEENS0_5__ops15_Iter_comp_iterIZL41llama_sampler_penalties_backend_set_inputP13llama_samplerE3$_0EEEvT_SF_SF_SF_T0_.exit.i", !llvm.loop !1288
...
"_ZSt27__unguarded_partition_pivotIN9__gnu_cxx17__normal_iteratorIPSt4pairIiiESt6vectorIS3_SaIS3_EEEENS0_5__ops15_Iter_comp_iterIZL41llama_sampler_penalties_backend_set_inputP13llama_samplerE3$_0EEET_SF_SF_T0_.exit": ; preds = %bb.u
  ...
  br i1 %i.en, label %bb.b, label %"_ZSt14__partial_sortIN9__gnu_cxx17__normal_iteratorIPSt4pairIiiESt6vectorIS3_SaIS3_EEEENS0_5__ops15_Iter_comp_iterIZL41llama_sampler_penalties_backend_set_inputP13llama_samplerE3$_0EEEvT_SF_SF_T0_.exit", !llvm.loop !1281
...
bb.i:                                             ; preds = %bb.h, %bb.g
  ...
  br i1 %niter.ncmp.1, label %.unr-lcssa, label %bb.e, !llvm.loop !1289
...
bb.o:                                             ; preds = %bb.n, %bb.m
  ...
  br i1 %niter93.ncmp.1, label %.unr-lcssa85, label %bb.k, !llvm.loop !1290
...
pred.store.continue79:                            ; preds = %pred.store.if78, %pred.store.continue77
  ...
  br i1 %i.dm, label %scalar.ph.preheader, label %vector.body, !llvm.loop !1291
...
bb.r:                                             ; preds = %scalar.ph, %bb.q
  ...
  br i1 %exitcond58.not, label %.loopexit, label %scalar.ph, !llvm.loop !1292
...
bb.b:                                             ; preds = %bb.a
  %i.e = tail call noalias noundef nonnull dereferenceable(8) ptr @_Znwm(i64 noundef 8) #37, !inline_history !1293 ; 2 uses
  store ptr @.str.26, ptr %i.e, align 8, !tbaa !135
  br label %llama_sampler_init_top_n_sigma.exit

bb.c:                                             ; preds = %bb.a
  %i.f = tail call noalias noundef nonnull dereferenceable(4) ptr @_Znwm(i64 noundef 4) #37, !inline_history !1294 ; 2 uses
...
llama_sampler_init_top_n_sigma.exit:              ; preds = %bb.b, %bb.c
  ...
  %i.g = tail call noalias noundef nonnull dereferenceable(16) ptr @_Znwm(i64 noundef 16) #37, !inline_history !1294 ; 3 uses
