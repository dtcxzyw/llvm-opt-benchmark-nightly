...
.lr.ph.i19.i.i.i.i:                               ; preds = %485
  ...
  %490 = load i64, ptr %380, align 8, !alias.scope !2644, !noalias !2651
  %.fr99.i.i.i = freeze i64 %490                  ; 7 uses
  %491 = getelementptr inbounds nuw i8, ptr %8, i64 24
  %492 = load i64, ptr %491, align 8, !alias.scope !2644, !noalias !2651
  %493 = add i64 %.fr99.i.i.i, -1                 ; 2 uses
  %.first_iter.i.i.i.i = icmp ult i64 %493, %458
  %494 = icmp ult i64 %.fr99.i.i.i, %458
...
.preheader33.i.i.i.i.preheader:                   ; preds = %495
  br i1 %494, label %.lr.ph365, label %.preheader.i.preheader.i.i.i
...
.preheader33.i.i.i.i:                             ; preds = %524
  %511 = add nuw nsw i64 %.sroa.04.0.i22.i.i.i.i364, 1 ; 2 uses
  %512 = icmp ult i64 %511, %458
  br i1 %512, label %.lr.ph365, label %.preheader.i.preheader.i.i.i
...
.preheader.i.us.i.i.i.preheader:                  ; preds = %.preheader.i.preheader.i.i.i
  br i1 %.not.i.us.i.i.i366, label %_RNvXsv_NtNtCsbvkFyIu7lgC_4core3str7patternNtB5_11StrSearcherNtB5_8Searcher10next_match.exit.i.i.i.i, label %.lr.ph368

.preheader.i.us.i.i.i:                            ; preds = %516
  %.not.i.us.i.i.i = icmp eq i64 %513, 0
  br i1 %.not.i.us.i.i.i, label %_RNvXsv_NtNtCsbvkFyIu7lgC_4core3str7patternNtB5_11StrSearcherNtB5_8Searcher10next_match.exit.i.i.i.i, label %.lr.ph368

.lr.ph368:                                        ; preds = %.preheader.i.us.i.i.i.preheader, %.preheader.i.us.i.i.i
  %.sroa.2.0.i23.i.us.i.i.i367 = phi i64 [ %513, %.preheader.i.us.i.i.i ], [ %.fr99.i.i.i, %.preheader.i.us.i.i.i.preheader ]
  %513 = add i64 %.sroa.2.0.i23.i.us.i.i.i367, -1 ; 4 uses
...
.lr.ph365:                                        ; preds = %.preheader33.i.i.i.i.preheader, %.preheader33.i.i.i.i
  %.sroa.04.0.i22.i.i.i.i364 = phi i64 [ %511, %.preheader33.i.i.i.i ], [ %.fr99.i.i.i, %.preheader33.i.i.i.i.preheader ] ; 4 uses
  %522 = add i64 %.sroa.04.0.i22.i.i.i.i364, %496 ; 2 uses
  %523 = icmp ult i64 %522, %454
  br i1 %523, label %524, label %529

.preheader.i.i.i.i:                               ; preds = %.preheader.i.preheader.i.i.i
  br i1 %.not.i.us.i.i.i366, label %_RNvXsv_NtNtCsbvkFyIu7lgC_4core3str7patternNtB5_11StrSearcherNtB5_8Searcher10next_match.exit.i.i.i.i, label %.invoke.i.i.i

524:                                              ; preds = %.lr.ph365
  %525 = getelementptr inbounds nuw i8, ptr %456, i64 %.sroa.04.0.i22.i.i.i.i364
...
529:                                              ; preds = %.lr.ph365
  %530 = add i64 %496, %.fr99.i.i.i
  %umax.i25.i.i.i.i = call i64 @llvm.umax.i64(i64 range(i64 0, -9223372036854775808) %454, i64 %530)
  br label %.invoke.i.i.i

531:                                              ; preds = %524
  %reass.sub220 = sub i64 %496, %.fr99.i.i.i
  %532 = add i64 %reass.sub220, 1
  %533 = add i64 %532, %.sroa.04.0.i22.i.i.i.i364
  br label %507
...
556:                                              ; preds = %543
  ...
  br i1 %557, label %.lr.ph361, label %.preheader34.i.i.i.i.preheader
...
560:                                              ; preds = %579
  %561 = add nuw nsw i64 %.sroa.04.0.i.i.i.i.i360, 1 ; 2 uses
  %562 = icmp ult i64 %561, %458
  br i1 %562, label %.lr.ph361, label %.preheader34.i.i.i.i.preheader

.preheader34.i.i.i.i.preheader:                   ; preds = %560, %556
  %563 = icmp ult i64 %545, %539
  br i1 %563, label %.lr.ph363, label %_RNvXsv_NtNtCsbvkFyIu7lgC_4core3str7patternNtB5_11StrSearcherNtB5_8Searcher10next_match.exit.i.i.i.i

.lr.ph361:                                        ; preds = %556, %560
  %.sroa.04.0.i.i.i.i.i360 = phi i64 [ %561, %560 ], [ %.sroa.0.0.i.i.i.i.i.i, %556 ] ; 4 uses
  %564 = add i64 %.sroa.04.0.i.i.i.i.i360, %544   ; 2 uses
  %565 = icmp ult i64 %564, %454
  br i1 %565, label %579, label %584

.preheader34.i.i.i.i:                             ; preds = %572
  %566 = icmp ult i64 %545, %567
  br i1 %566, label %.lr.ph363, label %_RNvXsv_NtNtCsbvkFyIu7lgC_4core3str7patternNtB5_11StrSearcherNtB5_8Searcher10next_match.exit.i.i.i.i

.lr.ph363:                                        ; preds = %.preheader34.i.i.i.i.preheader, %.preheader34.i.i.i.i
  %.sroa.2.0.i.i.i.i.i362 = phi i64 [ %567, %.preheader34.i.i.i.i ], [ %539, %.preheader34.i.i.i.i.preheader ]
  %567 = add i64 %.sroa.2.0.i.i.i.i.i362, -1      ; 6 uses
...
579:                                              ; preds = %.lr.ph361
  %580 = getelementptr inbounds nuw i8, ptr %456, i64 %.sroa.04.0.i.i.i.i.i360
...
586:                                              ; preds = %579
  ...
  %588 = add i64 %587, %.sroa.04.0.i.i.i.i.i360
  br label %.sink.split.i.i.i.i.i
...
.invoke.i.i.i:                                    ; preds = %.lr.ph, %569, %.lr.ph363, %.lr.ph368, %584, %529, %.preheader.i.i.i.i
  %601 = phi i64 [ %493, %.preheader.i.i.i.i ], [ %umax.i.i.i.i.i, %584 ], [ %570, %569 ], [ %514, %.lr.ph368 ], [ %umax.i25.i.i.i.i, %529 ], [ %567, %.lr.ph363 ], [ %599, %.lr.ph ]
  %602 = phi i64 [ %458, %.preheader.i.i.i.i ], [ %454, %584 ], [ %454, %569 ], [ %454, %.lr.ph368 ], [ %454, %529 ], [ %458, %.lr.ph363 ], [ %355, %.lr.ph ]
  %603 = phi ptr [ @6, %.preheader.i.i.i.i ], [ @8, %584 ], [ @7, %569 ], [ @7, %.lr.ph368 ], [ @8, %529 ], [ @6, %.lr.ph363 ], [ @74, %.lr.ph ]
