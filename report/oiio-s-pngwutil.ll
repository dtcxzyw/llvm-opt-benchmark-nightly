begin_hunk_0
  ...
  %15 = load i8, ptr %14, align 2, !tbaa !52      ; [#uses=1 type=i8]
  %.fr45 = freeze i8 %15                          ; [#uses=3 type=i8]
  %16 = icmp ugt i8 %.fr45, 7                     ; [#uses=1 type=i1]
  %17 = zext nneg i8 %.fr45 to i64                ; [#uses=7 type=i64]
  %18 = lshr i8 %.fr45, 3                         ; [#uses=1 type=i8]
...
begin_hunk_1
  ...
  %.fr.i = freeze i32 %974                        ; [#uses=1 type=i32]
  %975 = add i32 %.fr.i, 1                        ; [#uses=2 type=i32]
