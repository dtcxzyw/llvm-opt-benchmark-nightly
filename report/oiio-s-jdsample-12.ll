begin_hunk_0
  ...
  %13 = load i8, ptr %12, align 1, !tbaa !39      ; [#uses=1 type=i8]
  %.fr50 = freeze i8 %13                          ; [#uses=6 type=i8]
  %14 = zext i8 %.fr50 to i32                     ; [#uses=4 type=i32]
  %15 = getelementptr inbounds nuw i8, ptr %6, i64 258 ; [#uses=1 type=ptr]
  %16 = getelementptr inbounds i8, ptr %15, i64 %11 ; [#uses=1 type=ptr]
  %17 = load i8, ptr %16, align 1, !tbaa !39      ; [#uses=1 type=i8]
  %.fr = freeze i8 %17                            ; [#uses=3 type=i8]
  %18 = zext i8 %.fr to i32                       ; [#uses=3 type=i32]
...
.lr.ph:                                           ; preds = %4
  ...
  %.not = icmp eq i8 %.fr50, 0                    ; [#uses=1 type=i1]
  %23 = icmp ugt i8 %.fr, 1                       ; [#uses=2 type=i1]
  %24 = add nsw i32 %18, -1                       ; [#uses=2 type=i32]
  br i1 %.not, label %.lr.ph.split, label %.lr.ph.split.us

.lr.ph.split.us:                                  ; preds = %.lr.ph
  %25 = zext i8 %.fr to i64                       ; [#uses=2 type=i64]
  br i1 %23, label %.lr.ph.split.us.split.us.preheader, label %.lr.ph.split.us.split

.lr.ph.split.us.split.us.preheader:               ; preds = %.lr.ph.split.us
  %26 = zext i8 %.fr50 to i64                     ; [#uses=2 type=i64]
  %min.iters.check88 = icmp ult i8 %.fr50, 16     ; [#uses=1 type=i1]
...
.lr.ph.split.us.split.us:                         ; preds = %.lr.ph.split.us.split.us.preheader, %._crit_edge.split.us.us.us
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %._crit_edge.split.us.us.us ], [ 0, %.lr.ph.split.us.split.us.preheader ] ; [#uses=2 type=i64]
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %._crit_edge.split.us.us.us ], [ 0, %.lr.ph.split.us.split.us.preheader ] ; [#uses=3 type=i64]
  %indvars69 = trunc i64 %indvars.iv65 to i32     ; [#uses=2 type=i32]
  %29 = getelementptr inbounds nuw [8 x i8], ptr %7, i64 %indvars.iv65 ; [#uses=1 type=ptr]
  ...
  %.idx54 = shl nuw nsw i64 %32, 1                ; [#uses=1 type=i64]
  %33 = getelementptr inbounds nuw i8, ptr %30, i64 %.idx54 ; [#uses=1 type=ptr]
  %.not55 = icmp eq i32 %31, 0                    ; [#uses=1 type=i1]
...
.lr.ph.us.us.us.preheader:                        ; preds = %.lr.ph.split.us.split.us
  %34 = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %indvars.iv67 ; [#uses=1 type=ptr]
...
._crit_edge.split.us.us.us:                       ; preds = %..loopexit_crit_edge.us.us.us, %.lr.ph.split.us.split.us
  %36 = add nuw nsw i32 %indvars69, 1             ; [#uses=1 type=i32]
  tail call void @j12copy_sample_rows(ptr noundef %7, i32 noundef %indvars69, ptr noundef %7, i32 noundef %36, i32 noundef %24, i32 noundef %31) #6
  %indvars.iv.next68 = add nuw nsw i64 %indvars.iv67, 1 ; [#uses=1 type=i64]
  %indvars.iv.next66 = add nuw nsw i64 %indvars.iv65, %25 ; [#uses=2 type=i64]
  %37 = load i32, ptr %19, align 4, !tbaa !61     ; [#uses=1 type=i32]
  %38 = trunc nuw i64 %indvars.iv.next66 to i32   ; [#uses=1 type=i32]
...
begin_hunk_3
  ...
  %.not53 = icmp eq i32 %.pre, 0                  ; [#uses=1 type=i1]
  %51 = zext i8 %.fr50 to i64                     ; [#uses=2 type=i64]
  %min.iters.check = icmp ult i8 %.fr50, 16       ; [#uses=1 type=i1]
...
54:                                               ; preds = %._crit_edge.split.us.us, %.lr.ph.split.us.split
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %._crit_edge.split.us.us ], [ 0, %.lr.ph.split.us.split ] ; [#uses=2 type=i64]
...
.lr.ph.us.us.preheader:                           ; preds = %54
  %58 = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %indvars.iv60 ; [#uses=1 type=ptr]
  %59 = load ptr, ptr %58, align 8, !tbaa !78     ; [#uses=1 type=ptr]
  br label %.lr.ph.us.us

._crit_edge.split.us.us:                          ; preds = %..loopexit_crit_edge.us.us, %54
  %indvars.iv.next61 = add nuw nsw i64 %indvars.iv60, 1 ; [#uses=1 type=i64]
...
.lr.ph.split.split.us:                            ; preds = %.lr.ph.split, %71
  ...
  %.not52 = icmp eq i32 %70, 0                    ; [#uses=1 type=i1]
  br i1 %.not52, label %71, label %.loopexit.preheader
...
.lr.ph.split.split:                               ; preds = %.lr.ph.split
  ...
  %.not51 = icmp eq i32 %76, 0                    ; [#uses=1 type=i1]
  br label %77

77:                                               ; preds = %.lr.ph.split.split, %78
  %.042 = phi i32 [ 0, %.lr.ph.split.split ], [ %79, %78 ] ; [#uses=1 type=i32]
  br i1 %.not51, label %78, label %.loopexit.preheader
