begin_hunk_0
  ...
  %13 = load ptr, ptr %12, align 8, !alias.scope !12367, !noalias !12368 ; 2 uses
...
.split.us.thread38.i.i.i.i:                       ; preds = %38, %.lr.ph.split.split.i.i.i.i
  %33 = atomicrmw sub ptr %13, i64 1 release, align 8, !noalias !12376
  %34 = icmp eq i64 %33, 1
...
begin_hunk_6
  ...
  %32 = trunc nuw i64 %26 to i1
  %op.rdx = select i1 %.not71.i.i.i, i1 %32, i1 false
...
begin_hunk_9
  ...
  %60 = trunc nuw i64 %54 to i1
  %op.rdx3 = select i1 %.not71.i.i30.i, i1 %60, i1 false
...
begin_hunk_10
  ...
  %162 = select i1 %160, i8 12, i8 %161           ; 4 uses
  %.cmp9.i.i = icmp samesign ugt i8 %162, 9
  %163 = icmp samesign ult i8 %162, 10            ; 2 uses
  %164 = select i1 %.cmp9.i.i, i8 49, i8 48
  %.urem10.i.i = add nsw i8 %162, -10
  %165 = select i1 %163, i8 %162, i8 %.urem10.i.i
