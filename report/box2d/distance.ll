...
b2MakeSeparationFunction.exit:                    ; preds = %bb.g, %bb.h, %b2Normalize.exit114.i, %bb.l, %b2Normalize.exit161.i, %bb.o
  ...
  %.sroa.73.0 = phi <2 x float> [ %.sroa.012.0.i157.i, %b2Normalize.exit161.i ], [ %i.ig, %bb.l ], [ %.sroa.012.0.i110.i, %b2Normalize.exit114.i ], [ %i.kc, %bb.o ], [ %i.gh, %bb.h ], [ zeroinitializer, %bb.g ] ; 13 uses
  ...
  %5 = fneg float %.sroa.0.4.vec.extract.i190.i
  %i.kd = shufflevector <2 x float> %.sroa.73.0, <2 x float> poison, <2 x i32> zeroinitializer ; 5 uses
  ...
  %6 = insertelement <2 x float> %i.kd, float %5, i64 0
  br label %bb.p
...
bb.ah:                                            ; preds = %bb.af
  ...
  %shift929 = shufflevector <2 x float> %i.zg, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop930 = fsub <2 x float> %i.zg, %shift929
  %7 = extractelement <2 x float> %foldExtExtBinop930, i64 0
...
bb.ai:                                            ; preds = %bb.af
  ...
  %shift932 = shufflevector <2 x float> %i.zs, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop933 = fsub <2 x float> %i.zs, %shift932
  %8 = extractelement <2 x float> %foldExtExtBinop933, i64 0
...
b2EvaluateSeparation.exit256:                     ; preds = %bb.ag, %bb.ah, %bb.ai
  ...
  %.sroa.0.0.vec.extract.i188.i.sink823 = phi float [ %.sroa.0.0.vec.extract.i188.i, %bb.ag ], [ %7, %bb.ah ], [ %8, %bb.ai ]
  %.sroa.0.4.vec.extract.i190.i.sink821 = phi float [ %.sroa.0.4.vec.extract.i190.i, %bb.ag ], [ %i.zj, %bb.ah ], [ %i.zv, %bb.ai ]
  %i.aad = phi <2 x float> [ %i.zd, %bb.ag ], [ %i.zp, %bb.ah ], [ %i.aab, %bb.ai ]
  %i.aae = phi <2 x float> [ %i.ze, %bb.ag ], [ %i.zq, %bb.ah ], [ %i.aac, %bb.ai ] ; 2 uses
  ...
  %i.aag = shufflevector <2 x float> %i.aae, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  ...
  %i.aaj = shufflevector <2 x float> %i.aae, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.aap = fsub <2 x float> %i.aao, %i.aad
  %9 = insertelement <2 x float> poison, float %.sroa.0.0.vec.extract.i188.i.sink823, i64 0
  %10 = insertelement <2 x float> %9, float %.sroa.0.4.vec.extract.i190.i.sink821, i64 1
  %i.aaq = fmul <2 x float> %10, %i.aap
