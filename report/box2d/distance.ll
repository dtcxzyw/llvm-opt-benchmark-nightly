...
bb.e:                                             ; preds = %bb.d
  ...
  %5 = shufflevector <2 x float> %i.dq, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %.sroa.010.0.vec.insert.i.le = fsub <2 x float> %i.dq, %5
  %6 = fadd float %i.dr, %i.ds
  %.sroa.010.4.vec.insert.i.le577 = insertelement <2 x float> %.sroa.010.0.vec.insert.i.le, float %6, i64 1 ; 3 uses
