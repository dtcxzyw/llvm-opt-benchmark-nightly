...
bb.j:                                             ; preds = %bb.i
  ...
  %4 = fmul <2 x float> %.sroa.699.0.copyload, %.sroa.085.0.copyload ; 2 uses
  %i.du = fmul <2 x float> %.sroa.6.0.copyload, %.sroa.083.0.copyload ; 2 uses
  %shift = shufflevector <2 x float> %4, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop = fadd <2 x float> %4, %shift  ; 2 uses
  %5 = extractelement <2 x float> %foldExtExtBinop, i64 0 ; 2 uses
  %shift416 = shufflevector <2 x float> %i.du, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop417 = fadd <2 x float> %i.du, %shift416 ; 2 uses
  %i.dv = extractelement <2 x float> %foldExtExtBinop417, i64 0 ; 2 uses
  %i.dw = fcmp olt float %5, %i.dv
  %i.dx = select i1 %i.dw, float %5, float %i.dv
...
bb.p:                                             ; preds = %bb.o
  %6 = shufflevector <2 x float> %.sroa.6.0.copyload, <2 x float> %.sroa.699.0.copyload, <2 x i32> <i32 1, i32 3>
  %7 = shufflevector <2 x float> %.sroa.083.0.copyload, <2 x float> %.sroa.085.0.copyload, <2 x i32> <i32 0, i32 2>
  %i.fb = fmul <2 x float> %6, %7
  %8 = shufflevector <2 x float> %.sroa.6.0.copyload, <2 x float> %.sroa.699.0.copyload, <2 x i32> <i32 0, i32 2>
  %9 = shufflevector <2 x float> %.sroa.083.0.copyload, <2 x float> %.sroa.085.0.copyload, <2 x i32> <i32 1, i32 3>
  %i.fc = fmul <2 x float> %8, %9
...
.lr.ph382:                                        ; preds = %bb.p
  ...
  %i.fv = shufflevector <2 x float> %foldExtExtBinop417, <2 x float> poison, <2 x i32> zeroinitializer
  %10 = shufflevector <2 x float> %foldExtExtBinop, <2 x float> poison, <2 x i32> zeroinitializer
...
bb.q:                                             ; preds = %.lr.ph382, %bb.x
  ...
  %i.gi = fmul <2 x float> %10, %i.gb             ; 2 uses
