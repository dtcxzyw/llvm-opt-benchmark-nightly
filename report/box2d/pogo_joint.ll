...
bb.a:
  ...
  %i.w = fmul float %.sroa.05.4.vec.extract.i, 0.000000e+00
  %1 = fmul float %.sroa.05.0.vec.extract.i, 0.000000e+00
  %2 = fadd float %.sroa.05.0.vec.extract.i, %i.w
  %3 = fsub float %1, %.sroa.05.4.vec.extract.i
  ...
  %i.ab = insertelement <2 x float> poison, float %2, i64 0
