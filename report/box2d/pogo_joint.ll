...
bb.a:
  ...
  %1 = fmul float %.sroa.05.4.vec.extract.i, 0.000000e+00
  %2 = fmul float %.sroa.05.0.vec.extract.i, 0.000000e+00
  %3 = fadd float %.sroa.05.0.vec.extract.i, %1
  %4 = fsub float %2, %.sroa.05.4.vec.extract.i
