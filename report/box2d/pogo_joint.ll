...
bb.a:
  ...
  %.sroa.05.0.vec.extract.i = extractelement <2 x float> %i.q, i64 0 ; 2 uses
  %.sroa.05.4.vec.extract.i = extractelement <2 x float> %i.q, i64 1 ; 2 uses
  ...
  %i.w = fmul float %.sroa.05.0.vec.extract.i, 0.000000e+00
  %1 = fsub float %i.w, %.sroa.05.4.vec.extract.i
  %2 = fmul float %.sroa.05.4.vec.extract.i, 0.000000e+00
  %3 = fadd float %.sroa.05.0.vec.extract.i, %2
  %i.x = insertelement <2 x float> poison, float %1, i64 0
  %i.y = shufflevector <2 x float> %i.x, <2 x float> poison, <2 x i32> zeroinitializer
  %i.z = fmul <2 x float> %i.n, %i.y              ; 2 uses
  %i.aa = shufflevector <2 x float> %i.n, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.ab = insertelement <2 x float> poison, float %3, i64 0
  %i.ac = shufflevector <2 x float> %i.ab, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ad = fmul <2 x float> %i.aa, %i.ac           ; 2 uses
  %i.ae = fsub <2 x float> %i.z, %i.ad
  %i.af = fadd <2 x float> %i.z, %i.ad
  %i.ag = shufflevector <2 x float> %i.ae, <2 x float> %i.af, <2 x i32> <i32 0, i32 3>
  %i.ah = shufflevector <2 x float> %i.s, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ai = fmul <2 x float> %i.i, %i.ah            ; 2 uses
  %i.aj = shufflevector <2 x float> %i.i, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %i.ak = shufflevector <2 x float> %i.s, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  ...
  %i.ap = fadd <2 x float> %i.u, %i.ao
  %i.aq = shufflevector <2 x float> %i.t, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ar = fmul <2 x float> %i.n, %i.aq            ; 2 uses
  %i.as = shufflevector <2 x float> %i.t, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.at = fmul <2 x float> %i.aa, %i.as           ; 2 uses
  %i.au = fsub <2 x float> %i.ar, %i.at
  %i.av = fadd <2 x float> %i.ar, %i.at
  %i.aw = shufflevector <2 x float> %i.au, <2 x float> %i.av, <2 x i32> <i32 0, i32 3>
  %i.ax = fadd <2 x float> %i.v, %i.aw
  %i.ay = fsub <2 x float> %i.ax, %i.ap
  %i.az = fmul <2 x float> %i.ag, %i.ay
  %i.ba = tail call reassoc float @llvm.vector.reduce.fadd.v2f32(float -0.000000e+00, <2 x float> %i.az)
  ret float %i.ba
}
