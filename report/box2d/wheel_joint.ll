...
bb.a:
  ...
  %i.d = load float, ptr %i.c, align 4, !tbaa !103 ; 2 uses
...
bb.e:                                             ; preds = %bb.c, %bb.d
  ...
  %3 = fmul float %.sroa.05.4.vec.extract.i107, 0.000000e+00
  %4 = fsub float %.sroa.05.0.vec.extract.i106, %3 ; 2 uses
  %5 = fmul float %.sroa.05.0.vec.extract.i106, 0.000000e+00
  %i.ah = fadd float %.sroa.05.4.vec.extract.i107, %5 ; 2 uses
  ...
  %i.ap = fmul float %.sroa.05.4.vec.extract.i, %4
  %i.aq = fmul float %.sroa.05.4.vec.extract.i, %i.ah
  %7 = fmul float %.sroa.05.0.vec.extract.i, %i.ah
  %i.ar = fsub float %6, %i.aq                    ; 5 uses
  %8 = fadd float %i.ap, %7                       ; 5 uses
  %9 = extractelement <2 x float> %i.an, i64 0    ; 2 uses
  %10 = fmul float %9, %8
  %11 = extractelement <2 x float> %i.ao, i64 1   ; 2 uses
  %12 = fmul float %11, %i.ar
  %13 = fsub float %10, %12
  %14 = fmul float %9, %i.ar
  %i.as = fmul float %11, %8
  %15 = fadd float %14, %i.as
  ...
  %23 = fsub float %20, %22                       ; 4 uses
  %24 = fmul float %23, %i.ar
  %25 = fmul float %23, %8
  %26 = load float, ptr %i.i, align 4, !tbaa !81  ; 4 uses
  %i.at = fmul float %26, %i.ar
  %27 = fmul float %26, %8
  %i.au = fsub float %24, %27                     ; 2 uses
  %i.av = fadd float %25, %i.at                   ; 2 uses
  %i.aw = getelementptr inbounds nuw i8, ptr %0, i64 96
  %i.ax = load float, ptr %i.aw, align 4, !tbaa !109 ; 2 uses
  %i.ay = fmul float %23, %13
  %i.az = fmul float %26, %15
...
bb.f:                                             ; preds = %bb.e
  %28 = shufflevector <2 x float> %i.an, <2 x float> %i.ao, <2 x i32> <i32 0, i32 3>
  ...
  %i.bx = fsub <2 x float> %28, %i.bw
  %i.by = fadd <2 x float> %i.bo, %i.bx
  %i.bz = fadd <2 x float> %i.bw, %i.by           ; 2 uses
  %29 = insertelement <2 x float> poison, float %8, i64 0
  %30 = shufflevector <2 x float> %29, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ca = fmul <2 x float> %30, %i.bz             ; 2 uses
  %31 = insertelement <2 x float> poison, float %i.ar, i64 0
  %i.cb = shufflevector <2 x float> %31, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.ch = insertelement <2 x float> poison, float %23, i64 0
  %i.ci = insertelement <2 x float> %i.ch, float %26, i64 1
  ...
  %i.cm = load <2 x float>, ptr %i.q, align 4     ; 2 uses
  %.sroa.02.0.vec.extract.i = extractelement <2 x float> %i.cm, i64 0
  %32 = fmul float %i.b, %i.au
  %33 = fsub float %.sroa.02.0.vec.extract.i, %32
  %i.cn = insertelement <2 x float> poison, float %33, i64 0
  %.sroa.02.4.vec.extract.i = extractelement <2 x float> %i.cm, i64 1
  %34 = fmul float %i.b, %i.av
  %35 = fsub float %.sroa.02.4.vec.extract.i, %34
  %.sroa.03.4.vec.insert.i = insertelement <2 x float> %i.cn, float %35, i64 1
...
bb.h:                                             ; preds = %bb.g
  %i.cv = load <2 x float>, ptr %i.y, align 4     ; 2 uses
  %.sroa.02.0.vec.extract.i161 = extractelement <2 x float> %i.cv, i64 0
  %36 = fmul float %i.d, %i.au
  %37 = fadd float %36, %.sroa.02.0.vec.extract.i161
  %i.cw = insertelement <2 x float> poison, float %37, i64 0
  %.sroa.02.4.vec.extract.i164 = extractelement <2 x float> %i.cv, i64 1
  %38 = fmul float %i.d, %i.av
  %39 = fadd float %38, %.sroa.02.4.vec.extract.i164
  %.sroa.03.4.vec.insert.i166 = insertelement <2 x float> %i.cw, float %39, i64 1
  store <2 x float> %.sroa.03.4.vec.insert.i166, ptr %i.y, align 4
