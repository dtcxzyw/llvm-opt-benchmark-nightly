...
bb.e:                                             ; preds = %bb.c, %bb.d
  ...
  %i.bd = fmul <2 x float> %i.bc, %7              ; 2 uses
...
bb.e:                                             ; preds = %bb.c, %bb.d
  ...
  %4 = shufflevector <2 x float> %i.as, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  ...
  %5 = fmul <2 x float> %i.as, zeroinitializer    ; 2 uses
  %6 = fsub <2 x float> %4, %5
  %7 = fadd <2 x float> %4, %5
  %8 = shufflevector <2 x float> %6, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.bn = fmul <2 x float> %i.av, %8              ; 2 uses
  %i.bo = shufflevector <2 x float> %7, <2 x float> poison, <2 x i32> zeroinitializer
