...
bb.a:
  ...
  %i.b = load float, ptr %i.a, align 4, !tbaa !103 ; 2 uses
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 52
  %i.d = load float, ptr %i.c, align 4, !tbaa !104 ; 2 uses
...
bb.e:                                             ; preds = %bb.c, %bb.d
  ...
  %.sroa.05.0.vec.extract.i = extractelement <2 x float> %i.aa, i64 0 ; 2 uses
  %.sroa.05.4.vec.extract.i = extractelement <2 x float> %i.aa, i64 1 ; 2 uses
  ...
  %4 = fsub float %.sroa.05.0.vec.extract.i109, %3 ; 2 uses
  %5 = fmul float %.sroa.05.0.vec.extract.i109, 0.000000e+00
  %i.ah = fadd float %.sroa.05.4.vec.extract.i110, %5 ; 2 uses
  ...
  %6 = fmul float %.sroa.05.0.vec.extract.i, %4
  %7 = fmul float %.sroa.05.4.vec.extract.i, %4
  %8 = fmul float %.sroa.05.4.vec.extract.i, %i.ah
  %i.ap = fmul float %.sroa.05.0.vec.extract.i, %i.ah
  %9 = fsub float %6, %8                          ; 5 uses
  %i.aq = fadd float %7, %i.ap                    ; 5 uses
  %10 = extractelement <2 x float> %i.an, i64 0   ; 2 uses
  %11 = fmul float %10, %i.aq
  %12 = extractelement <2 x float> %i.ao, i64 1   ; 2 uses
  %13 = fmul float %12, %9
  %14 = fsub float %11, %13
  %15 = getelementptr inbounds nuw i8, ptr %0, i64 100
  %16 = load float, ptr %15, align 4, !tbaa !106
  %17 = getelementptr inbounds nuw i8, ptr %0, i64 104
  %18 = load float, ptr %17, align 4, !tbaa !107
  %19 = fadd float %16, %18
  ...
  %i.ar = fsub float %22, %24                     ; 4 uses
  %25 = fmul float %10, %9
  %26 = fmul float %12, %i.aq
  %27 = fadd float %25, %26
  %28 = load float, ptr %i.i, align 4, !tbaa !85  ; 4 uses
  %29 = getelementptr inbounds nuw i8, ptr %0, i64 96
  %30 = load float, ptr %29, align 4, !tbaa !109  ; 2 uses
  %31 = fmul float %i.ar, %9
  %i.as = fmul float %i.ar, %i.aq
  %i.at = fmul float %28, %9
  %32 = fmul float %i.aq, %28
  %i.au = fsub float %31, %32                     ; 2 uses
  %i.av = fadd float %i.as, %i.at                 ; 2 uses
  %i.aw = fmul float %i.ar, %14
  %i.ax = fmul float %28, %27
  %i.ay = fadd float %i.aw, %i.ax
  %i.az = fadd float %30, %i.ay
...
bb.f:                                             ; preds = %bb.e
  %33 = shufflevector <2 x float> %i.an, <2 x float> %i.ao, <2 x i32> <i32 0, i32 3>
  ...
  %i.bv = fsub <2 x float> %33, %i.bs
  %i.bw = fadd <2 x float> %i.bv, %i.bu
  %i.bx = fadd <2 x float> %i.bs, %i.bw           ; 2 uses
  %34 = insertelement <2 x float> poison, float %i.aq, i64 0
  %35 = shufflevector <2 x float> %34, <2 x float> poison, <2 x i32> zeroinitializer
  %i.by = fmul <2 x float> %35, %i.bx             ; 2 uses
  %36 = insertelement <2 x float> poison, float %9, i64 0
  %i.bz = shufflevector <2 x float> %36, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.cg = insertelement <2 x float> %i.cf, float %28, i64 1
  ...
  %i.cj = fadd float %30, %i.ci
  %i.ck = load <2 x float>, ptr %i.q, align 4     ; 2 uses
  %.sroa.02.0.vec.extract.i = extractelement <2 x float> %i.ck, i64 0
  %37 = fmul float %i.b, %i.au
  %38 = fsub float %.sroa.02.0.vec.extract.i, %37
  %i.cl = insertelement <2 x float> poison, float %38, i64 0
  %.sroa.02.4.vec.extract.i = extractelement <2 x float> %i.ck, i64 1
  %39 = fmul float %i.b, %i.av
  %40 = fsub float %.sroa.02.4.vec.extract.i, %39
  %.sroa.03.4.vec.insert.i = insertelement <2 x float> %i.cl, float %40, i64 1
  store <2 x float> %.sroa.03.4.vec.insert.i, ptr %i.q, align 4
...
bb.h:                                             ; preds = %bb.g
  %i.ct = load <2 x float>, ptr %i.y, align 4     ; 2 uses
  %.sroa.02.0.vec.extract.i164 = extractelement <2 x float> %i.ct, i64 0
  %41 = fmul float %i.d, %i.au
  %42 = fadd float %41, %.sroa.02.0.vec.extract.i164
  %i.cu = insertelement <2 x float> poison, float %42, i64 0
  %.sroa.02.4.vec.extract.i167 = extractelement <2 x float> %i.ct, i64 1
  %43 = fmul float %i.d, %i.av
  %44 = fadd float %43, %.sroa.02.4.vec.extract.i167
  %.sroa.03.4.vec.insert.i169 = insertelement <2 x float> %i.cu, float %44, i64 1
  store <2 x float> %.sroa.03.4.vec.insert.i169, ptr %i.y, align 4
