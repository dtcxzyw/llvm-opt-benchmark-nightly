...
bb.a:
  ...
  %3 = fadd float %.sroa.05.4.vec.extract.i, %1
  %4 = fsub float %.sroa.05.0.vec.extract.i, %2
  %5 = insertelement <2 x float> poison, float %4, i64 0
  %i.w = shufflevector <2 x float> %5, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.z = fmul <2 x float> %i.y, %7                ; 2 uses
...
bb.e:                                             ; preds = %bb.c, %bb.d
  ...
  %3 = fmul float %.sroa.05.0.vec.extract.i109, 0.000000e+00
  %4 = fmul float %.sroa.05.4.vec.extract.i110, 0.000000e+00
  %5 = fadd float %.sroa.05.4.vec.extract.i110, %3
  %6 = fsub float %.sroa.05.0.vec.extract.i109, %4
  %7 = insertelement <2 x float> poison, float %6, i64 0
  %i.bf = shufflevector <2 x float> %7, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.bi = fmul <2 x float> %i.bh, %9              ; 2 uses
...
bb.e:                                             ; preds = %bb.c, %bb.d
  ...
  %4 = fmul float %.sroa.0.0.vec.extract.i, 0.000000e+00
  %5 = fmul float %.sroa.0.4.vec.extract.i, 0.000000e+00
  %6 = fadd float %.sroa.0.4.vec.extract.i, %4
  %7 = fsub float %.sroa.0.0.vec.extract.i, %5
  %8 = insertelement <2 x float> poison, float %7, i64 0
  %9 = shufflevector <2 x float> %8, <2 x float> poison, <2 x i32> zeroinitializer
  %i.cg = fmul <2 x float> %i.ag, %9              ; 2 uses
  %10 = insertelement <2 x float> poison, float %6, i64 0
  %i.ch = shufflevector <2 x float> %10, <2 x float> poison, <2 x i32> zeroinitializer
