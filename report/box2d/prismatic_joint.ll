...
bb.e:                                             ; preds = %bb.c, %bb.d
  ...
  %3 = extractelement <2 x float> %i.ba, i64 0
  %4 = extractelement <2 x float> %i.bb, i64 1
  %5 = fmul <2 x float> %i.ag, zeroinitializer
  %i.bd = shufflevector <2 x float> %5, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %6 = fsub <2 x float> %i.ag, %i.bd
  %7 = fadd <2 x float> %i.ag, %i.bd
  %i.be = shufflevector <2 x float> %6, <2 x float> poison, <2 x i32> zeroinitializer
  %i.bf = fmul <2 x float> %i.aa, %i.be           ; 2 uses
  %8 = shufflevector <2 x float> %i.aa, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %9 = shufflevector <2 x float> %7, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.bg = fmul <2 x float> %8, %9                 ; 2 uses
  %10 = fsub <2 x float> %i.bf, %i.bg             ; 3 uses
  %i.bh = fadd <2 x float> %i.bf, %i.bg           ; 3 uses
  %11 = shufflevector <2 x float> %10, <2 x float> %i.bh, <4 x i32> <i32 0, i32 3, i32 0, i32 3>
  %12 = extractelement <2 x float> %i.bh, i64 1   ; 2 uses
  %13 = fmul float %3, %12
  %i.bi = extractelement <2 x float> %10, i64 0   ; 2 uses
  %14 = fmul float %4, %i.bi
  %15 = fsub float %13, %14
  %16 = shufflevector <2 x float> %i.bc, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %17 = insertelement <4 x float> poison, float %i.au, i64 0
  %18 = shufflevector <4 x float> %17, <4 x float> poison, <4 x i32> <i32 poison, i32 poison, i32 0, i32 0>
  %19 = shufflevector <4 x float> %16, <4 x float> %18, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %20 = fmul <4 x float> %19, %11                 ; 4 uses
  %shift = shufflevector <4 x float> %20, <4 x float> poison, <4 x i32> <i32 1, i32 poison, i32 poison, i32 poison>
  %foldExtExtBinop = fadd <4 x float> %20, %shift
  %21 = extractelement <4 x float> %foldExtExtBinop, i64 0
  %i.bj = fmul float %i.aq, %i.bi
  %i.bk = fmul float %12, %i.aq
  %22 = extractelement <4 x float> %20, i64 2
  %i.bl = fsub float %22, %i.bk                   ; 2 uses
  %23 = extractelement <4 x float> %20, i64 3
  %i.bm = fadd float %23, %i.bj                   ; 2 uses
  %i.bn = fmul float %i.au, %15
  %i.bo = fmul float %i.aq, %21
...
bb.f:                                             ; preds = %bb.e
  ...
  %24 = shufflevector <2 x float> %i.aa, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %i.ce = shufflevector <2 x float> %i.bv, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.cf = fmul <2 x float> %24, %i.ce             ; 2 uses
  ...
  %25 = shufflevector <2 x float> %i.bh, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.co = fmul <2 x float> %25, %i.cn             ; 2 uses
  %26 = shufflevector <2 x float> %10, <2 x float> poison, <2 x i32> zeroinitializer
  %i.cp = shufflevector <2 x float> %i.cn, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %i.cq = fmul <2 x float> %26, %i.cp             ; 2 uses
