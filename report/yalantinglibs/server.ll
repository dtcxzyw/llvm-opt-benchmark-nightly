...
begin_hunk_0_@_ZN7cinatra4sha19transformIvEEvPjS2_:bb.a
  ...
  %2 = xor i32 %i.aku, %i.akn
  %3 = xor i32 %2, %i.akm
  %i.akv = tail call i32 @llvm.fshl.i32(i32 %i.akt, i32 %i.akt, i32 5)
  %4 = add i32 %i.ajh, -899497514
  %5 = add i32 %4, %i.akf
  %i.akw = add i32 %5, %3
  %i.akx = add i32 %i.akw, %i.akv                 ; 3 uses
  %6 = tail call i32 @llvm.fshl.i32(i32 %i.akm, i32 %i.akm, i32 30) ; 2 uses
  %i.aky = xor i32 %6, %i.aku
  %i.akz = xor i32 %i.aky, %i.akt
  %7 = tail call i32 @llvm.fshl.i32(i32 %i.akx, i32 %i.akx, i32 5)
  %i.ala = tail call i32 @llvm.fshl.i32(i32 %i.akt, i32 %i.akt, i32 30)
  %i.alb = add i32 %i.ajo, %i.akn
  %i.alc = add i32 %i.alb, %i.akz
  %i.ald = add i32 %i.alc, %7
  store i32 %i.ald, ptr %0, align 4, !tbaa !280
  %i.ale = load <4 x i32>, ptr %i.b, align 4, !tbaa !280
  %i.alf = insertelement <4 x i32> poison, i32 %i.akx, i64 0
  %i.alg = insertelement <4 x i32> %i.alf, i32 %i.ala, i64 1
  %i.alh = insertelement <4 x i32> %i.alg, i32 %6, i64 2
