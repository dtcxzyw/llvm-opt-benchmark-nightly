begin_hunk_0
  ...
  switch i8 %154, label %default.unreachable1040 [
    i8 0, label %155
    i8 1, label %389
    i8 2, label %390
end_hunk_0
...
default.unreachable1040:                          ; preds = %1467, %495, %3
  unreachable
...
begin_hunk_2
  ...
  switch i8 %.pre1000, label %default.unreachable1040 [
    i8 0, label %498
    i8 1, label %637
    i8 2, label %638
end_hunk_2
begin_hunk_3
  ...
  %777 = load ptr, ptr %725, align 8, !alias.scope !14603, !noalias !14471 ; [#uses=2 type=ptr]
  %.not.i.i.i.i.i.i.i.i = icmp eq ptr %777, null  ; [#uses=1 type=i1]
...
.split.us.thread38.i.i.i:                         ; preds = %.lr.ph.split.split.i.i.i, %801
  %794 = atomicrmw sub ptr %777, i64 1 release, align 8, !noalias !14611 ; [#uses=1 type=i64]
...
begin_hunk_6
  ...
  switch i8 %.pre998, label %default.unreachable1040 [
    i8 0, label %1470
    i8 1, label %1585
    i8 2, label %1586
end_hunk_6
...
1470:                                             ; preds = %.thread1041, %1467
  %1471 = phi ptr [ %1454, %.thread1041 ], [ %1469, %1467 ] ; [#uses=8 type=ptr]
  %1472 = phi ptr [ %1453, %.thread1041 ], [ %1468, %1467 ] ; [#uses=8 type=ptr]
