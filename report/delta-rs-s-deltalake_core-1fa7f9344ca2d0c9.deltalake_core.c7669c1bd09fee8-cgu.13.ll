begin_hunk_0
  ...
  %777 = load ptr, ptr %725, align 8, !alias.scope !14603, !noalias !14471
  %.fr.i.i.i = freeze ptr %777                    ; 2 uses
  %.not.i.i.i.i.i.i.i.i = icmp eq ptr %.fr.i.i.i, null
...
.split.us.thread38.i.i.i:                         ; preds = %.lr.ph.split.split.i.i.i, %801
  %794 = atomicrmw sub ptr %.fr.i.i.i, i64 1 release, align 8, !noalias !14611
...
1470:                                             ; preds = %.thread1040, %1467
  %1471 = phi ptr [ %1454, %.thread1040 ], [ %1469, %1467 ] ; 8 uses
  %1472 = phi ptr [ %1453, %.thread1040 ], [ %1468, %1467 ] ; 8 uses
