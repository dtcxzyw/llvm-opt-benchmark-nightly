...
bb.gv:                                            ; preds = %bb.gt
  ...
  %i.ars = load i8, ptr %i.arr, align 4, !tbaa !42
  %.fr15.i = freeze i8 %i.ars                     ; 3 uses
  %i.art = and i8 %.fr15.i, -2
  %switch.i = icmp eq i8 %i.art, 2
  %.phi.trans.insert = getelementptr inbounds nuw i8, ptr %1, i64 32
  %.pre1316 = load i32, ptr %.phi.trans.insert, align 8, !tbaa !41
  %.fr.i.i606 = freeze i32 %.pre1316              ; 6 uses
  br i1 %switch.i, label %.critedge251, label %.preheader.i

.preheader.i:                                     ; preds = %bb.gv
  %i.aru = add i8 %.fr15.i, -3
...
tailrecurse.preheader.i.i609:                     ; preds = %bb.gw, %tailrecurse.preheader.i.lr.ph.i
  %.059.i.a = phi i32 [ %i.ary, %bb.gw ], [ 0, %tailrecurse.preheader.i.lr.ph.i ] ; 3 uses
...
.lr.ph.i624:                                      ; preds = %tailrecurse.preheader.i.i609, %_ZNK8V3Number6bitIsZEi.exit.i612, %_ZNK8V3Number6isAllZEv.exit..lr.ph.i624_crit_edge
  %i.ask = phi ptr [ %.pre1315, %_ZNK8V3Number6isAllZEv.exit..lr.ph.i624_crit_edge ], [ %i.arx, %_ZNK8V3Number6bitIsZEi.exit.i612 ], [ %i.arx, %tailrecurse.preheader.i.i609 ]
  %i.asl = icmp samesign ult i32 %.fr.i.i606, 129
  %spec.select.i11.i.i626 = select i1 %i.asl, ptr %1, ptr %i.ask
  br i1 %spec.select.i.i.i607, label %.preheader.i1280, label %_ZNK12V3NumberData3numEv.exit.i.i627
...
_ZNK8V3Number6bitIsXEi.exit.thread.i635:          ; preds = %_ZNK8V3Number6bitIsXEi.exit.i631, %_ZNK12V3NumberData3numEv.exit.i.i627
  ...
  br i1 %exitcond.not.i636, label %.preheader.i1280, label %_ZNK12V3NumberData3numEv.exit.i.i627, !llvm.loop !257

.preheader.i1280:                                 ; preds = %_ZNK8V3Number6bitIsXEi.exit.thread.i635, %.lr.ph.i624
  %25 = getelementptr inbounds nuw i8, ptr %1, i64 32
  %26 = load i32, ptr %25, align 8, !tbaa !41
  %.fr.i.i1281 = freeze i32 %26                   ; 6 uses
  %27 = icmp sgt i32 %.fr.i.i1281, 0
  br i1 %27, label %.preheader.i1281, label %.critedge251

.preheader.i1281:                                 ; preds = %.preheader.i1280
  %28 = add i8 %.fr15.i, -3
  %spec.select.i.i.i1282 = icmp ult i8 %28, -2
  %29 = icmp samesign ult i32 %.fr.i.i1281, 129
  %30 = load ptr, ptr %1, align 8
  %spec.select.i9.i.i = select i1 %29, ptr %1, ptr %30
  br i1 %spec.select.i.i.i1282, label %.critedge251, label %tailrecurse.preheader.i.i1284

tailrecurse.preheader.i.i1284:                    ; preds = %.preheader.i1281, %_ZNK8V3Number6bitIsZEi.exit.thread.i1292
  %.059.i1285 = phi i32 [ %i.ati, %_ZNK8V3Number6bitIsZEi.exit.thread.i1292 ], [ 0, %.preheader.i1281 ] ; 3 uses
  %i.asx = lshr i32 %.059.i1285, 5
  %i.asy = zext nneg i32 %i.asx to i64
  %i.asz = getelementptr inbounds nuw [8 x i8], ptr %spec.select.i9.i.i, i64 %i.asy ; 2 uses
  %.sroa.0.0.copyload.i.i1286 = load i32, ptr %i.asz, align 4, !tbaa !66
  %i.ata = xor i32 %.sroa.0.0.copyload.i.i1286, -1
  %i.atb = zext i32 %i.ata to i64
  %i.atc = and i32 %.059.i1285, 31
  %i.atd = zext nneg i32 %i.atc to i64
  %i.ate = shl nuw nsw i64 1, %i.atd              ; 2 uses
  %i.atf = and i64 %i.ate, %i.atb
  %.not7.i.i1287 = icmp eq i64 %i.atf, 0
  br i1 %.not7.i.i1287, label %_ZNK8V3Number6bitIsZEi.exit.thread.i1292, label %_ZNK8V3Number6bitIsZEi.exit.i1288

_ZNK8V3Number6bitIsZEi.exit.i1288:                ; preds = %tailrecurse.preheader.i.i1284
  %.sroa.4.0..sroa_idx.i.i1289 = getelementptr inbounds nuw i8, ptr %i.asz, i64 4
  %.sroa.4.0.copyload.i.i1290 = load i32, ptr %.sroa.4.0..sroa_idx.i.i1289, align 4, !tbaa !66
  %i.atg = zext i32 %.sroa.4.0.copyload.i.i1290 to i64
  %i.ath = and i64 %i.ate, %i.atg
  %.not.i1291 = icmp eq i64 %i.ath, 0
  br i1 %.not.i1291, label %_ZNK8V3Number6bitIsZEi.exit.thread.i1292, label %.invoke.invoke

_ZNK8V3Number6bitIsZEi.exit.thread.i1292:         ; preds = %_ZNK8V3Number6bitIsZEi.exit.i1288, %tailrecurse.preheader.i.i1284
  %i.ati = add nuw nsw i32 %.059.i1285, 1         ; 2 uses
  %exitcond.not.i = icmp eq i32 %i.ati, %.fr.i.i1281
  br i1 %exitcond.not.i, label %.critedge251, label %tailrecurse.preheader.i.i1284, !llvm.loop !258

.invoke.invoke:                                   ; preds = %bb.gw, %_ZNK8V3Number6bitIsXEi.exit.i631, %_ZNK8V3Number6bitIsZEi.exit.i1288, %bb.gt, %_ZNK8V3Number6isAllZEv.exit
  %i.atj = phi ptr [ @.str.41, %_ZNK8V3Number6bitIsZEi.exit.i1288 ], [ @.str.38, %bb.gt ], [ @.str.39, %_ZNK8V3Number6isAllZEv.exit ], [ @.str.40, %_ZNK8V3Number6bitIsXEi.exit.i631 ], [ @.str.39, %bb.gw ]
...
.critedge251:                                     ; preds = %_ZNK8V3Number6bitIsZEi.exit.thread.i1292, %bb.gv, %.preheader.i1281, %.preheader.i1280
  %31 = phi i32 [ %.fr.i.i606, %bb.gv ], [ %.fr.i.i1281, %.preheader.i1280 ], [ %.fr.i.i1281, %.preheader.i1281 ], [ %.fr.i.i1281, %_ZNK8V3Number6bitIsZEi.exit.thread.i1292 ]
  %i.atm = icmp sgt i32 %31, 64                   ; 2 uses
...
tailrecurse.preheader.i:                          ; preds = %tailrecurse.preheader.i.lr.ph, %bb.b
  %.059 = phi i32 [ %i.j, %bb.b ], [ 0, %tailrecurse.preheader.i.lr.ph ] ; 3 uses
  %i.k = lshr i32 %.059, 5
