...
bb.i:                                             ; preds = %bb.g
  ...
  %i.x = load i32, ptr %i.w, align 8, !tbaa !47   ; 3 uses
  %i.y = icmp sgt i32 %i.x, 32
  br i1 %i.y, label %.lr.ph, label %._crit_edge.split

.lr.ph:                                           ; preds = %bb.i
  %i.z = load i8, ptr %i.m, align 4, !tbaa !48
  %i.aa = add i8 %i.z, -3
...
_ZNK12V3NumberData3numEv.exit.i:                  ; preds = %.lr.ph.split, %_ZNK8V3Number6bitIs1Ei.exit.thread
  ...
  %.sroa.0.0.copyload.i = load i32, ptr %i.af, align 4, !tbaa !69
...
_ZNK8V3Number6bitIs1Ei.exit.thread:               ; preds = %_ZNK12V3NumberData3numEv.exit.i, %_ZNK8V3Number6bitIs1Ei.exit
  ...
  br i1 %exitcond.not, label %._crit_edge.split, label %_ZNK12V3NumberData3numEv.exit.i, !llvm.loop !447
...
.lr.ph37:                                         ; preds = %.preheader, %.lr.ph37
  ...
  %i.ay = load i32, ptr %i.as, align 8, !tbaa !47
  %i.az = icmp slt i32 %i.ax, %i.ay
  br i1 %i.az, label %.lr.ph37, label %.loopexit, !llvm.loop !448
...
bb.a:
  ...
  %i.b = icmp eq ptr %0, %2
  %.not33 = or i1 %i.a, %i.b
  br i1 %.not33, label %bb.b, label %bb.c, !prof !133
...
bb.e:                                             ; preds = %bb.c
  ...
  br i1 %.not34, label %bb.g, label %bb.f, !prof !49
...
.lr.ph.i:                                         ; preds = %bb.i
  %4 = load i8, ptr %i.m, align 4, !tbaa !48
  %.fr23.i = freeze i8 %4
  %5 = add i8 %.fr23.i, -3
  ...
  br i1 %spec.select.i.i.i, label %.critedge37, label %.lr.ph.split.split.i.preheader, !prof !164
...
.lr.ph.i.a:                                       ; preds = %tailrecurse.preheader.i.i.i, %.lr.ph.split.split.i.preheader.new
  ...
  %.sroa.0.0.copyload.i.i = load i32, ptr %13, align 4, !tbaa !69 ; 2 uses
  ...
  %18 = and i64 %17, %i.z
  %19 = icmp eq i64 %18, 0
  br i1 %19, label %.lr.ph.split.split.i, label %.critedge37, !prof !165
...
.lr.ph.split.split.i:                             ; preds = %.lr.ph.i.a
  ...
  %26 = and i64 %25, %21
  %27 = icmp eq i64 %26, 0
  br i1 %27, label %tailrecurse.preheader.i.i.i, label %.critedge37, !prof !165

tailrecurse.preheader.i.i.i:                      ; preds = %.lr.ph.split.split.i
  %28 = add nuw nsw i32 %.0713.i, 2               ; 2 uses
  %niter.next.1 = add i32 %niter, 2
  %i.aa = icmp eq i32 %niter, %10
  br i1 %i.aa, label %.critedge.loopexit.unr-lcssa, label %.lr.ph.i.a, !llvm.loop !7
...
_ZNK8V3Number6bitIs0Ei.exit.i:                    ; preds = %.critedge.loopexit.unr-lcssa, %.lr.ph.split.split.i.preheader
  ...
  %.sroa.0.0.copyload.i.i.a = load i32, ptr %i.ad, align 4, !tbaa !69
  %.sroa.4.0..sroa_idx.i.i.a = getelementptr inbounds nuw i8, ptr %i.ad, i64 4
  %.sroa.4.0.copyload.i.i.a = load i32, ptr %.sroa.4.0..sroa_idx.i.i.a, align 4, !tbaa !69
  ...
  br i1 %i.ak, label %.critedge, label %.critedge37, !prof !165
...
.critedge:                                        ; preds = %.critedge.loopexit.unr-lcssa, %_ZNK8V3Number6bitIs0Ei.exit.i, %bb.i
  ...
  %i.an = load i32, ptr %i.am, align 8, !tbaa !47
...
.lr.ph:                                           ; preds = %.preheader, %.lr.ph
  ...
  %i.au = load i32, ptr %i.ao, align 8, !tbaa !47
  %i.av = icmp slt i32 %i.at, %i.au
  br i1 %i.av, label %.lr.ph, label %.loopexit, !llvm.loop !449
...
.critedge37:                                      ; preds = %_ZNK8V3Number6bitIs0Ei.exit.i, %.lr.ph.split.split.i, %.lr.ph.i.a, %.lr.ph.i, %.critedge
  ...
  %i.ax = load i32, ptr %i.aw, align 8, !tbaa !47
...
bb.j:                                             ; preds = %.lr.ph44, %bb.j
  ...
  %i.bc = load i32, ptr %i.aw, align 8, !tbaa !47
  %i.bd = icmp slt i32 %i.bb, %i.bc
  br i1 %i.bd, label %bb.j, label %.loopexit, !llvm.loop !450
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %.not, label %bb.c, label %bb.d, !prof !133
...
bb.e:                                             ; preds = %bb.d
  br i1 %spec.select.i.i23, label %_ZNK12V3NumberData3numEv.exit, label %bb.f, !prof !49
...
bb.g:                                             ; preds = %bb.d
  br i1 %spec.select.i.i23, label %_ZNK12V3NumberData3numEv.exit25, label %bb.h, !prof !49
...
.sink.split:                                      ; preds = %_ZNK12V3NumberData3numEv.exit, %_ZNK12V3NumberData3numEv.exit25
  ...
  %.sroa.0.0.copyload.sink = load i32, ptr %.sink36, align 4, !tbaa !69
...
bb.a:
  ...
  %i.b = icmp eq ptr %0, %2
  %.not15 = or i1 %i.a, %i.b
  br i1 %.not15, label %bb.b, label %bb.c, !prof !133
...
bb.e:                                             ; preds = %bb.c
  ...
  br i1 %.not16, label %bb.g, label %bb.f, !prof !49
...
bb.j:                                             ; preds = %bb.h
  ...
  store i8 0, ptr %i.z, align 4, !tbaa !48
