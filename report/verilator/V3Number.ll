...
.lr.ph.i.a:                                       ; preds = %bb.i
  ...
  %5 = load i8, ptr %i.m, align 4, !tbaa !48
  %.fr23.i = freeze i8 %5
  %6 = add i8 %.fr23.i, -3
  ...
  br i1 %spec.select.i.i.i, label %.critedge37, label %.lr.ph.split.split.i, !prof !164
...
tailrecurse.preheader.i.i.i:                      ; preds = %.lr.ph.split.split.i
  %.sroa.3.0.copyload.i.i.i = load i32, ptr %.sroa.3.0..sroa_idx.i.i.i, align 4, !tbaa !69
  %14 = zext i32 %.sroa.3.0.copyload.i.i.i to i64
  %15 = and i64 %13, %14
  %i.aa = icmp eq i64 %15, 0
  br i1 %i.aa, label %_ZNK8V3Number6bitIs0Ei.exit.thread.i, label %.critedge37, !prof !165
...
_ZNK8V3Number6bitIs0Ei.exit.i:                    ; preds = %.lr.ph.split.split.i
  ...
  br i1 %i.ak, label %_ZNK8V3Number6bitIs0Ei.exit.thread.i, label %.critedge37, !prof !165
...
_ZNK8V3Number6bitIs0Ei.exit.thread.i:             ; preds = %_ZNK8V3Number6bitIs0Ei.exit.i, %tailrecurse.preheader.i.i.i
  ...
  br i1 %exitcond.not.i, label %.critedge, label %.lr.ph.split.split.i, !llvm.loop !7
