...
bb.j:                                             ; preds = %bb.h
  %i.ah = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.ai = load ptr, ptr %i.r, align 8, !tbaa !84  ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %bb.j
  %i.ak = load i64, ptr %i.s, align 8, !tbaa !83
  %i.al = add i64 %i.ak, 1
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %bb.j, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i, %bb.i
  ...
  %i.am = load ptr, ptr %i.d, align 8, !tbaa !84  ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i16: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  %i.ao = load i64, ptr %i.e, align 8, !tbaa !83
  %i.ap = add i64 %i.ao, 1
...
bb.a:
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 320) (i8, ptr @_ZTV10AstLibrary, i64 16), ptr %0, align 8, !tbaa !71
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 152 ; 5 uses
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 168 ; 5 uses
  store ptr %i.c, ptr %i.b, align 8, !tbaa !81
  %i.d = load ptr, ptr %2, align 8, !tbaa !84     ; 2 uses
  %i.e = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.f = load i64, ptr %i.e, align 8, !tbaa !82   ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #29
  store i64 %i.f, ptr %i.a, align 8, !tbaa !85
...
.noexc.i:                                         ; preds = %bb.a
  ...
  store ptr %i.h, ptr %i.b, align 8, !tbaa !84
  %i.i = load i64, ptr %i.a, align 8, !tbaa !85
  store i64 %i.i, ptr %i.c, align 8, !tbaa !83
...
bb.b:                                             ; preds = %._crit_edge.i.i
  %i.k = load i8, ptr %i.d, align 1, !tbaa !83
  store i8 %i.k, ptr %i.j, align 1, !tbaa !83
  br label %bb.d
...
bb.d:                                             ; preds = %bb.c, %bb.b, %._crit_edge.i.i
  %i.l = load i64, ptr %i.a, align 8, !tbaa !85   ; 2 uses
  %i.m = getelementptr inbounds nuw i8, ptr %0, i64 160
  store i64 %i.l, ptr %i.m, align 8, !tbaa !82
  %i.n = load ptr, ptr %i.b, align 8, !tbaa !84
  %i.o = getelementptr inbounds nuw i8, ptr %i.n, i64 %i.l
  store i8 0, ptr %i.o, align 1, !tbaa !83
...
bb.g:                                             ; preds = %bb.f, %bb.e
  %i.p = landingpad { ptr, i32 }
          cleanup
  %i.q = load ptr, ptr %i.b, align 8, !tbaa !84   ; 2 uses
  %i.r = icmp eq ptr %i.q, %i.c
  br i1 %i.r, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %bb.g
  %i.s = load i64, ptr %i.c, align 8, !tbaa !83
  %i.t = add i64 %i.s, 1
...
bb.a:
  %i.a = load i8, ptr %0, align 1, !tbaa !278
  ret i8 %i.a
}
...
.lr.ph.preheader.i.i:                             ; preds = %bb.c
  ...
  %invariant.gep.i.i = getelementptr [2 x i8], ptr @_ZL7yycheck, i64 %i.l
  br label %.lr.ph.i.i
...
.lr.ph.i.i:                                       ; preds = %bb.f, %.lr.ph.preheader.i.i
  ...
  %i.m = load i16, ptr %gep.i.i, align 2, !tbaa !90
  %i.n = sext i16 %i.m to i32                     ; 2 uses
  %i.o = trunc nuw nsw i64 %indvars.iv.i.i to i32
  %i.p = icmp eq i32 %i.o, %i.n
  %i.q = icmp ne i64 %indvars.iv.i.i, 1
  %or.cond.i.i = and i1 %i.q, %i.p
  br i1 %or.cond.i.i, label %bb.d, label %bb.f

bb.d:                                             ; preds = %.lr.ph.i.i
  %i.r = icmp eq i32 %.0345.i.i, 4
  br i1 %i.r, label %_ZL25yy_syntax_error_argumentsPK12yypcontext_tP15yysymbol_kind_ti.exit.thread6, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.s = add i32 %.0345.i.i, 1
  %i.t = sext i32 %.0345.i.i to i64
  %i.u = getelementptr inbounds [4 x i8], ptr %i.b, i64 %i.t
  store i32 %i.n, ptr %i.u, align 4, !tbaa !758
  br label %bb.f

bb.f:                                             ; preds = %bb.e, %.lr.ph.i.i
  %.1.i.i = phi i32 [ %i.s, %bb.e ], [ %.0345.i.i, %.lr.ph.i.i ] ; 4 uses
  %indvars.iv.next.i.i = add nuw nsw i64 %indvars.iv.i.i, 1 ; 2 uses
  %lftr.wideiv.i.i = trunc i64 %indvars.iv.next.i.i to i32
  %exitcond.not.i.i = icmp eq i32 %i.j, %lftr.wideiv.i.i
  br i1 %exitcond.not.i.i, label %.critedge.i.i, label %.lr.ph.i.i, !llvm.loop !753
...
.critedge.thread.i.i:                             ; preds = %.critedge.i.i, %bb.c, %bb.b
  store i32 -2, ptr %i.b, align 4, !tbaa !758
...
_ZL25yy_syntax_error_argumentsPK12yypcontext_tP15yysymbol_kind_ti.exit: ; preds = %.critedge.i.i
  %i.v = add nsw i32 %.1.i.i, 1                   ; 8 uses
  switch i32 %i.v, label %_ZL25yy_syntax_error_argumentsPK12yypcontext_tP15yysymbol_kind_ti.exit.thread6 [
    i32 -2, label %_ZL25yy_syntax_error_argumentsPK12yypcontext_tP15yysymbol_kind_ti.exit.thread8
    i32 5, label %bb.k
    i32 1, label %bb.g
    i32 2, label %bb.h
...
_ZL25yy_syntax_error_argumentsPK12yypcontext_tP15yysymbol_kind_ti.exit.thread6: ; preds = %bb.d, %.critedge.thread.i.i, %bb.a, %_ZL25yy_syntax_error_argumentsPK12yypcontext_tP15yysymbol_kind_ti.exit, %bb.k, %bb.j, %bb.i, %bb.h, %bb.g
  %.118.i5 = phi i32 [ %i.v, %bb.j ], [ %i.v, %bb.k ], [ %i.v, %bb.g ], [ %i.v, %bb.h ], [ %i.v, %bb.i ], [ %i.v, %_ZL25yy_syntax_error_argumentsPK12yypcontext_tP15yysymbol_kind_ti.exit ], [ 0, %bb.a ], [ 1, %.critedge.thread.i.i ], [ 1, %bb.d ] ; 4 uses
  ...
  %i.w = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %.046) #36
  %i.x = shl nsw i32 %.118.i5, 1
  %i.y = sext i32 %i.x to i64
  %reass.sub = sub i64 %i.w, %i.y
  %i.z = add i64 %reass.sub, 1                    ; 2 uses
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %_ZL9yytnamerrPcPKc.exit.thread
  ...
  %.04421 = phi i64 [ %i.z, %.lr.ph.preheader ], [ %.14513, %_ZL9yytnamerrPcPKc.exit.thread ]
  %i.aa = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %indvars.iv
  %i.ab = load i32, ptr %i.aa, align 4, !tbaa !758
  %i.ac = sext i32 %i.ab to i64
  %i.ad = getelementptr inbounds [8 x i8], ptr @_ZL7yytname, i64 %i.ac
  %i.ae = load ptr, ptr %i.ad, align 8, !tbaa !91 ; 3 uses
  %i.af = load i8, ptr %i.ae, align 1, !tbaa !83
  %i.ag = icmp eq i8 %i.af, 34
  br i1 %i.ag, label %.preheader.split.us.i, label %_ZL9yytnamerrPcPKc.exit

.preheader.split.us.i:                            ; preds = %.lr.ph, %bb.m
  %.020.us.i = phi i64 [ %i.al, %bb.m ], [ 0, %.lr.ph ] ; 2 uses
  %.019.us.i = phi ptr [ %.1.us.i, %bb.m ], [ %i.ae, %.lr.ph ] ; 2 uses
  %i.ah = getelementptr inbounds nuw i8, ptr %.019.us.i, i64 1 ; 2 uses
...
bb.l:                                             ; preds = %.preheader.split.us.i
  %i.aj = getelementptr inbounds nuw i8, ptr %.019.us.i, i64 2 ; 2 uses
  %i.ak = load i8, ptr %i.aj, align 1, !tbaa !83
  %.not25.us.i = icmp eq i8 %i.ak, 92
  br i1 %.not25.us.i, label %bb.m, label %_ZL9yytnamerrPcPKc.exit

bb.m:                                             ; preds = %bb.l, %.preheader.split.us.i
  %.1.us.i = phi ptr [ %i.ah, %.preheader.split.us.i ], [ %i.aj, %bb.l ]
  %i.al = add nuw nsw i64 %.020.us.i, 1
  br label %.preheader.split.us.i, !llvm.loop !754

_ZL9yytnamerrPcPKc.exit:                          ; preds = %.preheader.split.us.i, %.preheader.split.us.i, %bb.l, %.lr.ph
  %i.am = tail call i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %i.ae) #36 ; 2 uses
  %.not = icmp sgt i64 %i.am, -1
...
_ZL9yytnamerrPcPKc.exit.thread:                   ; preds = %.preheader.split.us.i, %_ZL9yytnamerrPcPKc.exit
  %.020.us.i.pn = phi i64 [ %i.am, %_ZL9yytnamerrPcPKc.exit ], [ %.020.us.i, %.preheader.split.us.i ]
  %.14513 = add nsw i64 %.020.us.i.pn, %.04421    ; 2 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %.thread, label %.lr.ph, !llvm.loop !755
...
.thread:                                          ; preds = %_ZL9yytnamerrPcPKc.exit.thread, %_ZL25yy_syntax_error_argumentsPK12yypcontext_tP15yysymbol_kind_ti.exit.thread6
  %.044.lcssa = phi i64 [ %i.z, %_ZL25yy_syntax_error_argumentsPK12yypcontext_tP15yysymbol_kind_ti.exit.thread6 ], [ %.14513, %_ZL9yytnamerrPcPKc.exit.thread ] ; 3 uses
  %i.an = load i64, ptr %0, align 8, !tbaa !85
  %i.ao = icmp slt i64 %i.an, %.044.lcssa
  br i1 %i.ao, label %bb.n, label %.preheader

bb.n:                                             ; preds = %.thread
  %i.ap = shl nsw i64 %.044.lcssa, 1              ; 2 uses
  %.not57 = icmp sgt i64 %.044.lcssa, %i.ap
  %spec.store.select = select i1 %.not57, i64 9223372036854775807, i64 %i.ap
...
.preheader:                                       ; preds = %.thread, %_ZL9yytnamerrPcPKc.exit67
  %.147 = phi ptr [ %i.bq, %_ZL9yytnamerrPcPKc.exit67 ], [ %.046, %.thread ] ; 3 uses
  %.039 = phi ptr [ %i.bp, %_ZL9yytnamerrPcPKc.exit67 ], [ %.0.val, %.thread ] ; 6 uses
  %.0 = phi i32 [ %.1, %_ZL9yytnamerrPcPKc.exit67 ], [ 0, %.thread ] ; 5 uses
  %i.aq = load i8, ptr %.147, align 1, !tbaa !83  ; 2 uses
  store i8 %i.aq, ptr %.039, align 1, !tbaa !83
  switch i8 %i.aq, label %_ZL9yytnamerrPcPKc.exit67 [
    i8 0, label %_ZL25yy_syntax_error_argumentsPK12yypcontext_tP15yysymbol_kind_ti.exit.thread8
    i8 37, label %bb.o
  ]

bb.o:                                             ; preds = %.preheader
  %i.ar = getelementptr inbounds nuw i8, ptr %.147, i64 1
  %i.as = load i8, ptr %i.ar, align 1, !tbaa !83
  %i.at = icmp eq i8 %i.as, 115
  %i.au = icmp slt i32 %.0, %.118.i5
...
bb.p:                                             ; preds = %bb.o
  ...
  %i.ay = load i32, ptr %i.ax, align 4, !tbaa !758
  %i.az = sext i32 %i.ay to i64
  %i.ba = getelementptr inbounds [8 x i8], ptr @_ZL7yytname, i64 %i.az
  %i.bb = load ptr, ptr %i.ba, align 8, !tbaa !91 ; 3 uses
  %i.bc = load i8, ptr %i.bb, align 1, !tbaa !83
  %i.bd = icmp eq i8 %i.bc, 34
  br i1 %i.bd, label %.preheader.split.i, label %.thread.thread.i

.preheader.split.i:                               ; preds = %bb.p, %bb.r
  %.020.i = phi i64 [ %i.bj, %bb.r ], [ 0, %bb.p ] ; 4 uses
  %.019.i = phi ptr [ %.1.i, %bb.r ], [ %i.bb, %bb.p ] ; 2 uses
  %i.be = getelementptr inbounds nuw i8, ptr %.019.i, i64 1 ; 2 uses
  %i.bf = load i8, ptr %i.be, align 1, !tbaa !83  ; 2 uses
...
bb.q:                                             ; preds = %.preheader.split.i
  %i.bg = getelementptr inbounds nuw i8, ptr %.019.i, i64 2 ; 2 uses
  %i.bh = load i8, ptr %i.bg, align 1, !tbaa !83
  %.not25.i = icmp eq i8 %i.bh, 92
  br i1 %.not25.i, label %bb.r, label %.thread.thread.i

bb.r:                                             ; preds = %bb.q, %.preheader.split.i
  %.1.i = phi ptr [ %i.be, %.preheader.split.i ], [ %i.bg, %bb.q ]
  %i.bi = getelementptr inbounds nuw i8, ptr %.039, i64 %.020.i
  store i8 %i.bf, ptr %i.bi, align 1, !tbaa !83
  %i.bj = add nuw nsw i64 %.020.i, 1
  br label %.preheader.split.i, !llvm.loop !754

.split.us.thread.i:                               ; preds = %.preheader.split.i
  %i.bk = getelementptr inbounds nuw i8, ptr %.039, i64 %.020.i
  store i8 0, ptr %i.bk, align 1, !tbaa !83
  br label %_ZL9yytnamerrPcPKc.exit67

.thread.thread.i:                                 ; preds = %bb.q, %.preheader.split.i, %.preheader.split.i, %bb.p
  %i.bl = tail call ptr @stpcpy(ptr noundef nonnull %.039, ptr noundef nonnull readonly %i.bb) #29
  %i.bm = ptrtoint ptr %i.bl to i64
  %i.bn = ptrtoint ptr %.039 to i64
