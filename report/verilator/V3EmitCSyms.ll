...
.preheader235:                                    ; preds = %.preheader235.lr.ph, %_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE6resizeEm.exit
  ...
  %.050659 = phi i64 [ 0, %.preheader235.lr.ph ], [ %i.cg, %_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE6resizeEm.exit ]
  br label %.preheader
...
bb.h:                                             ; preds = %.critedge
  ...
  %i.ch = icmp ult i64 %.151657, 10
  br i1 %i.ch, label %_ZNSt8__detail14__to_chars_lenImEEjT_i.exit.i, label %.lr.ph.i.i

.lr.ph.i.i:                                       ; preds = %bb.h, %bb.n
  %.02229.i.i = phi i64 [ %i.co, %bb.n ], [ %.151657, %bb.h ] ; 5 uses
  %.02328.i.i = phi i32 [ %i.cp, %bb.n ], [ 1, %bb.h ] ; 4 uses
  %i.ci = icmp ult i64 %.02229.i.i, 100
  br i1 %i.ci, label %bb.i, label %bb.j

bb.i:                                             ; preds = %.lr.ph.i.i
  %i.cj = add i32 %.02328.i.i, 1
  br label %_ZNSt8__detail14__to_chars_lenImEEjT_i.exit.i

bb.j:                                             ; preds = %.lr.ph.i.i
  %i.ck = icmp ult i64 %.02229.i.i, 1000
  br i1 %i.ck, label %bb.k, label %bb.l

bb.k:                                             ; preds = %bb.j
  %i.cl = add i32 %.02328.i.i, 2
  br label %_ZNSt8__detail14__to_chars_lenImEEjT_i.exit.i

bb.l:                                             ; preds = %bb.j
  %i.cm = icmp ult i64 %.02229.i.i, 10000
  br i1 %i.cm, label %bb.m, label %bb.n

bb.m:                                             ; preds = %bb.l
  %i.cn = add i32 %.02328.i.i, 3
  br label %_ZNSt8__detail14__to_chars_lenImEEjT_i.exit.i

bb.n:                                             ; preds = %bb.l
  %i.co = udiv i64 %.02229.i.i, 10000
  %i.cp = add i32 %.02328.i.i, 4                  ; 2 uses
  %i.cq = icmp ult i64 %.02229.i.i, 100000
...
_ZNSt8__detail14__to_chars_lenImEEjT_i.exit.i:    ; preds = %bb.n, %bb.m, %bb.k, %bb.i, %bb.h
  %.0.i.i = phi i32 [ %i.cn, %bb.m ], [ %i.cj, %bb.i ], [ %i.cl, %bb.k ], [ 1, %bb.h ], [ %i.cp, %bb.n ]
  %i.cr = zext i32 %.0.i.i to i64
...
.lr.ph.i4.i:                                      ; preds = %.lr.ph.i4.i, %.lr.ph.preheader.i.i
  %.020.i.i = phi i64 [ %i.cz, %.lr.ph.i4.i ], [ %.151657, %.lr.ph.preheader.i.i ] ; 3 uses
...
._crit_edge.i.i:                                  ; preds = %.lr.ph.i4.i, %_ZNSt8__detail14__to_chars_lenImEEjT_i.exit.i
  %.0.lcssa.i.i = phi i64 [ %.151657, %_ZNSt8__detail14__to_chars_lenImEEjT_i.exit.i ], [ %i.cz, %.lr.ph.i4.i ] ; 3 uses
