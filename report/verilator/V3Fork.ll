...
bb.z:                                             ; preds = %.lr.ph, %_ZNSt15_Deque_iteratorIP6AstVarRS1_PS1_EppEv.exit
  %.072400 = phi ptr [ null, %.lr.ph ], [ %.2, %_ZNSt15_Deque_iteratorIP6AstVarRS1_PS1_EppEv.exit ] ; 3 uses
  %.098399 = phi ptr [ %i.z, %.lr.ph ], [ %.2100, %_ZNSt15_Deque_iteratorIP6AstVarRS1_PS1_EppEv.exit ] ; 4 uses
...
_ZN9AstAssignC2EP8FileLineP11AstNodeExprS3_P7AstNode.exit182: ; preds = %.noexc181, %bb.am
  ...
  %i.gc = call noundef ptr @_ZN7AstNode7addNextIS_S_EEPT_S2_PT0_(ptr noundef %.072400, ptr noundef nonnull %i.fs)
...
_ZNK10VDirection11isNonOutputEv.exit:             ; preds = %_ZN9AstAssignC2EP8FileLineP11AstNodeExprS3_P7AstNode.exit182, %bb.z
  %.1 = phi ptr [ %i.gc, %_ZN9AstAssignC2EP8FileLineP11AstNodeExprS3_P7AstNode.exit182 ], [ %.072400, %bb.z ] ; 3 uses
...
_ZN9AstAssignC2EP8FileLineP11AstNodeExprS3_P7AstNode.exit216: ; preds = %.noexc215, %bb.bj
  ...
  %i.ik = call noundef ptr @_ZN7AstNode7addNextIS_S_EEPT_S2_PT0_(ptr noundef %.098399, ptr noundef nonnull %i.ia)
  br label %bb.bs
...
bb.bs:                                            ; preds = %_ZN9AstAssignC2EP8FileLineP11AstNodeExprS3_P7AstNode.exit216, %bb.z, %.critedge141, %bb.aw
  %.2100 = phi ptr [ %.098399, %bb.z ], [ %.098399, %bb.aw ], [ %.098399, %.critedge141 ], [ %i.ik, %_ZN9AstAssignC2EP8FileLineP11AstNodeExprS3_P7AstNode.exit216 ] ; 3 uses
  %.2 = phi ptr [ %.072400, %bb.z ], [ %.1, %bb.aw ], [ %.1, %.critedge141 ], [ %.1, %_ZN9AstAssignC2EP8FileLineP11AstNodeExprS3_P7AstNode.exit216 ] ; 3 uses
...
._crit_edge.thread:                               ; preds = %_ZN9AstAssignC2EP8FileLineP11AstNodeExprS3_P7AstNode.exit, %bb.bu, %._crit_edge
  %.098.lcssa483 = phi ptr [ %.2100, %._crit_edge ], [ %.2100, %bb.bu ], [ %i.z, %_ZN9AstAssignC2EP8FileLineP11AstNodeExprS3_P7AstNode.exit ] ; 2 uses
...
._crit_edge:                                      ; preds = %_ZNSt6vectorIP8AstBeginSaIS1_EE9push_backERKS1_.exit
  store i8 %i.cy, ptr %i.cx, align 8, !tbaa !291
  %.not117152 = icmp eq ptr %.sroa.0106.2, %.sroa.9110.1.a
...
.loopexit.split-lp:                               ; preds = %bb.am, %bb.aq, %.noexc81, %.noexc83, %.noexc85, %.noexc84, %.noexc82
  %.sroa.13.1.ph = phi ptr [ %.sroa.13.2, %bb.aq ], [ %.sroa.13.2, %.noexc81 ], [ %.sroa.13.2, %.noexc82 ], [ %.sroa.13.2, %.noexc83 ], [ %.sroa.13.2, %.noexc84 ], [ %.sroa.13.2, %.noexc85 ], [ %.sroa.13.0146, %bb.am ]
...
bb.ah:                                            ; preds = %.loopexit.split-lp, %.loopexit
  %.sroa.13.1 = phi ptr [ %.sroa.13.0146, %.loopexit ], [ %.sroa.13.1.ph, %.loopexit.split-lp ]
...
.lr.ph149:                                        ; preds = %_ZN9VNVisitor18iterateAndNextNullEP7AstNode.exit72, %bb.ap
  ...
  %.sroa.13.0146 = phi ptr [ %.sroa.13.2, %bb.ap ], [ null, %_ZN9VNVisitor18iterateAndNextNullEP7AstNode.exit72 ] ; 6 uses
...
bb.aj:                                            ; preds = %bb.ai
  %.not.i73 = icmp eq ptr %.sroa.9110.0145, %.sroa.13.0146
  br i1 %.not.i73, label %bb.al, label %bb.ak

bb.ak:                                            ; preds = %bb.aj
  store ptr %storemerge148, ptr %.sroa.9110.0145, align 8, !tbaa !533
...
_ZNSt6vectorIP8AstBeginSaIS1_EE9push_backERKS1_.exit: ; preds = %_ZNSt6vectorIP8AstBeginSaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i, %bb.ak, %bb.ai
  %.sroa.9110.1.a = phi ptr [ %.sroa.9110.0145, %bb.ai ], [ %i.dq, %_ZNSt6vectorIP8AstBeginSaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i ], [ %i.dc, %bb.ak ] ; 3 uses
  %.sroa.13.2 = phi ptr [ %.sroa.13.0146, %bb.ai ], [ %i.dr, %_ZNSt6vectorIP8AstBeginSaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i ], [ %.sroa.13.0146, %bb.ak ] ; 9 uses
...
bb.ar:                                            ; preds = %._crit_edge156
  %i.ee = ptrtoint ptr %.sroa.13.2 to i64
...
_ZN9VNVisitor18iterateAndNextNullEP7AstNode.exit91: ; preds = %.lr.ph155, %bb.as
  ...
  %.not117 = icmp eq ptr %i.ei, %.sroa.9110.1.a
...
bb.au:                                            ; preds = %bb.at, %bb.ah
  %.sroa.13.3 = phi ptr [ %.sroa.13.2, %bb.at ], [ %.sroa.13.1, %bb.ah ]
