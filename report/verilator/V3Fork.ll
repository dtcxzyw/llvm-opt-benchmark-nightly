...
_ZN9AstAssignC2EP8FileLineP11AstNodeExprS3_P7AstNode.exit182: ; preds = %.noexc181, %bb.am
  ...
  %i.gc = call noundef ptr @_ZN7AstNode7addNextIS_S_EEPT_S2_PT0_(ptr noundef %.071400, ptr noundef nonnull %i.fs)
...
_ZNK10VDirection11isNonOutputEv.exit:             ; preds = %_ZN9AstAssignC2EP8FileLineP11AstNodeExprS3_P7AstNode.exit182, %bb.z
  %.1102 = phi ptr [ %i.gc, %_ZN9AstAssignC2EP8FileLineP11AstNodeExprS3_P7AstNode.exit182 ], [ %.071400, %bb.z ] ; 3 uses
...
_ZN9AstAssignC2EP8FileLineP11AstNodeExprS3_P7AstNode.exit216: ; preds = %.noexc215, %bb.bj
  ...
  %i.ik = call noundef ptr @_ZN7AstNode7addNextIS_S_EEPT_S2_PT0_(ptr noundef %.0101399, ptr noundef nonnull %i.ia)
  br label %bb.bs
...
bb.bs:                                            ; preds = %_ZN9AstAssignC2EP8FileLineP11AstNodeExprS3_P7AstNode.exit216, %bb.z, %.critedge141, %bb.aw
  %.2103 = phi ptr [ %.0101399, %bb.z ], [ %.0101399, %bb.aw ], [ %.0101399, %.critedge141 ], [ %i.ik, %_ZN9AstAssignC2EP8FileLineP11AstNodeExprS3_P7AstNode.exit216 ] ; 3 uses
...
bb.bu:                                            ; preds = %._crit_edge
  %i.iy = call noundef ptr @_ZN7AstNode7addNextIS_S_EEPT_S2_PT0_(ptr noundef nonnull %i.db, ptr noundef nonnull %.2) ; 0 uses
...
bb.bw:                                            ; preds = %._crit_edge.thread
  %i.iz = call noundef ptr @_ZN7AstNode7addNextIS_S_EEPT_S2_PT0_(ptr noundef nonnull %i.db, ptr noundef nonnull %.099392) ; 0 uses
  br label %_ZN10VNRelinker6relinkEP7AstNode.exit
...
_ZN10VNRelinker6relinkEP7AstNode.exit:            ; preds = %bb.bv, %bb.bw
  ...
  %i.jb = call noundef ptr @_ZN7AstNode7addNextIS_S_EEPT_S2_PT0_(ptr noundef %i.ja, ptr noundef %.3) ; 0 uses
...
.lr.ph:                                           ; preds = %bb.t, %bb.ab
  %.030142 = phi ptr [ %i.br, %bb.ab ], [ %i.bp, %bb.t ] ; 3 uses
  %i.bq = getelementptr inbounds nuw i8, ptr %.030142, i64 8
...
_ZN7AstNode2asI8AstBeginS_EEPT_PT0_.exit:         ; preds = %.lr.ph, %bb.u
  %i.cc = getelementptr inbounds nuw i8, ptr %.030142, i64 32 ; 2 uses
...
_ZN8AstDelayC2EP8FileLineP11AstNodeExprb.exit:    ; preds = %.noexc68
  ...
  call void @_ZN11ForkVisitor39moveForkSentinelAfterDisableQueuePushesEP8AstBegin(ptr noundef nonnull %.030142)
  br label %bb.ab
...
._crit_edge:                                      ; preds = %_ZNSt6vectorIP8AstBeginSaIS1_EE9push_backERKS1_.exit
  store i8 %i.cy, ptr %i.cx, align 8, !tbaa !291
  %.not117152 = icmp eq ptr %.sroa.0106.2, %.sroa.13.2.a
...
.loopexit.split-lp:                               ; preds = %bb.am, %bb.aq, %.noexc81, %.noexc83, %.noexc85, %.noexc84, %.noexc82
  %.sroa.13.1.ph = phi ptr [ %.sroa.9110.1, %bb.aq ], [ %.sroa.9110.1, %.noexc81 ], [ %.sroa.9110.1, %.noexc82 ], [ %.sroa.9110.1, %.noexc83 ], [ %.sroa.9110.1, %.noexc84 ], [ %.sroa.9110.1, %.noexc85 ], [ %.sroa.9110.0146, %bb.am ]
...
bb.ah:                                            ; preds = %.loopexit.split-lp, %.loopexit
  %.sroa.13.1 = phi ptr [ %.sroa.9110.0146, %.loopexit ], [ %.sroa.13.1.ph, %.loopexit.split-lp ]
...
.lr.ph149:                                        ; preds = %_ZN9VNVisitor18iterateAndNextNullEP7AstNode.exit72, %bb.ap
  ...
  %.sroa.9110.0146 = phi ptr [ %.sroa.9110.1, %bb.ap ], [ null, %_ZN9VNVisitor18iterateAndNextNullEP7AstNode.exit72 ] ; 6 uses
  %.sroa.13.0145 = phi ptr [ %.sroa.13.2.a, %bb.ap ], [ null, %_ZN9VNVisitor18iterateAndNextNullEP7AstNode.exit72 ] ; 4 uses
...
bb.aj:                                            ; preds = %bb.ai
  %.not.i73 = icmp eq ptr %.sroa.13.0145, %.sroa.9110.0146
  br i1 %.not.i73, label %bb.al, label %bb.ak

bb.ak:                                            ; preds = %bb.aj
  store ptr %storemerge148, ptr %.sroa.13.0145, align 8, !tbaa !533
  %i.dc = getelementptr inbounds nuw i8, ptr %.sroa.13.0145, i64 8
  br label %_ZNSt6vectorIP8AstBeginSaIS1_EE9push_backERKS1_.exit

bb.al:                                            ; preds = %bb.aj
  %i.dd = ptrtoint ptr %.sroa.9110.0146 to i64
...
_ZNSt6vectorIP8AstBeginSaIS1_EE9push_backERKS1_.exit: ; preds = %_ZNSt6vectorIP8AstBeginSaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i, %bb.ak, %bb.ai
  %.sroa.13.2.a = phi ptr [ %.sroa.13.0145, %bb.ai ], [ %i.dq, %_ZNSt6vectorIP8AstBeginSaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i ], [ %i.dc, %bb.ak ] ; 3 uses
  %.sroa.9110.1 = phi ptr [ %.sroa.9110.0146, %bb.ai ], [ %i.dr, %_ZNSt6vectorIP8AstBeginSaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i ], [ %.sroa.9110.0146, %bb.ak ] ; 9 uses
...
_ZN9VNVisitor18iterateAndNextNullEP7AstNode.exit91: ; preds = %.lr.ph155, %bb.as
  ...
  %.not117 = icmp eq ptr %i.ei, %.sroa.13.2.a
