...
begin_hunk_0_@_ZN17ForkDynScopeFrame9linkNodesER10VMemberMap:bb.a
  ...
  store i8 0, ptr %i.bh, align 8, !tbaa !17
...
bb.s:                                             ; preds = %_ZN7AstNode6dtypepEP12AstNodeDType.exit
  %i.dg = load ptr, ptr %i.dd, align 8, !tbaa !229
  %i.dh = load ptr, ptr %i.k, align 8, !tbaa !132
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #23
  store i8 1, ptr %5, align 1, !tbaa !252
  invoke void @_ZN9AstVarRefC2EP8FileLineP6AstVarRK7VAccess(ptr noundef nonnull align 8 dereferenceable(232) %i.df, ptr noundef %i.dg, ptr noundef %i.dh, ptr noundef nonnull align 1 dereferenceable(1) %5)
...
.noexc157:                                        ; preds = %.noexc156
  %i.di = getelementptr inbounds nuw i8, ptr %i.df, i64 72
  %i.dj = load ptr, ptr %i.di, align 8, !tbaa !236 ; 2 uses
  %i.dk = getelementptr inbounds nuw i8, ptr %i.db, i64 72 ; 2 uses
  %i.dl = load ptr, ptr %i.dk, align 8, !tbaa !236
  %.not.i.i8.i.i = icmp eq ptr %i.dl, %i.dj
  br i1 %.not.i.i8.i.i, label %_ZN9AstAssignC2EP8FileLineP11AstNodeExprS3_P7AstNode.exit, label %bb.u

bb.u:                                             ; preds = %.noexc157
  store ptr %i.dj, ptr %i.dk, align 8, !tbaa !236
  %i.dm = load i64, ptr @_ZN7AstNode12s_editCntGblE, align 8, !tbaa !215
  %i.dn = add i64 %i.dm, 1
  store i64 %i.dn, ptr @_ZN7AstNode12s_editCntGblE, align 8, !tbaa !215
...
_ZN9AstAssignC2EP8FileLineP11AstNodeExprS3_P7AstNode.exit: ; preds = %.noexc157, %bb.u
  ...
  %i.dp = load ptr, ptr %i.do, align 8, !tbaa !219, !noalias !253 ; 2 uses
  %i.dq = getelementptr inbounds nuw i8, ptr %0, i64 64
  %i.dr = load ptr, ptr %i.dq, align 8, !tbaa !219, !noalias !256 ; 2 uses
  %.not282395 = icmp eq ptr %i.dp, %i.dr
...
.lr.ph:                                           ; preds = %_ZN9AstAssignC2EP8FileLineP11AstNodeExprS3_P7AstNode.exit
  ...
  %i.dt = load ptr, ptr %i.ds, align 8, !tbaa !226, !noalias !253
  %i.du = getelementptr inbounds nuw i8, ptr %0, i64 48
  %i.dv = load ptr, ptr %i.du, align 8, !tbaa !227, !noalias !253
  %i.dw = getelementptr inbounds nuw i8, ptr %7, i64 16 ; 7 uses
  %i.dx = getelementptr inbounds nuw i8, ptr %7, i64 8
  %i.dy = getelementptr inbounds nuw i8, ptr %10, i64 16 ; 7 uses
...
bb.v:                                             ; preds = %.noexc149, %.noexc151, %.noexc152, %.noexc150, %.noexc148, %bb.q, %._crit_edge.i.i
  %i.ea = landingpad { ptr, i32 }
          cleanup
  %i.eb = load ptr, ptr %4, align 8, !tbaa !10    ; 2 uses
  %i.ec = icmp eq ptr %i.eb, %i.cb
  br i1 %i.ec, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit160, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i158

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i158: ; preds = %bb.v
  %i.ed = load i64, ptr %i.cb, align 8, !tbaa !17
  %i.ee = add i64 %i.ed, 1
...
bb.y:                                             ; preds = %.thread, %bb.w, %bb.x
  %.pn109 = phi { ptr, i32 } [ %lpad.thr_comm.split-lp, %bb.x ], [ %lpad.thr_comm, %.thread ], [ %i.ef, %bb.w ]
...
bb.z:                                             ; preds = %.lr.ph, %_ZNSt15_Deque_iteratorIP6AstVarRS1_PS1_EppEv.exit
  %.071400 = phi ptr [ null, %.lr.ph ], [ %.2, %_ZNSt15_Deque_iteratorIP6AstVarRS1_PS1_EppEv.exit ] ; 3 uses
  %.0101399 = phi ptr [ %i.z, %.lr.ph ], [ %.2103, %_ZNSt15_Deque_iteratorIP6AstVarRS1_PS1_EppEv.exit ] ; 4 uses
  %.sroa.14.0398 = phi ptr [ %i.dt, %.lr.ph ], [ %.sroa.14.1, %_ZNSt15_Deque_iteratorIP6AstVarRS1_PS1_EppEv.exit ] ; 2 uses
  %.sroa.11.0397 = phi ptr [ %i.dv, %.lr.ph ], [ %.sroa.11.1, %_ZNSt15_Deque_iteratorIP6AstVarRS1_PS1_EppEv.exit ] ; 2 uses
  %.sroa.0241.0396 = phi ptr [ %i.dp, %.lr.ph ], [ %.sroa.0241.1, %_ZNSt15_Deque_iteratorIP6AstVarRS1_PS1_EppEv.exit ] ; 2 uses
  %i.eg = load ptr, ptr %.sroa.0241.0396, align 8, !tbaa !167 ; 10 uses
  %i.eh = getelementptr inbounds nuw i8, ptr %i.eg, i64 249 ; 2 uses
  %.sroa.0.0.copyload.i = load i8, ptr %i.eh, align 1, !tbaa !230
...
bb.aa:                                            ; preds = %bb.z, %bb.z, %bb.z, %bb.z
  %i.ei = call noalias noundef nonnull dereferenceable(200) ptr @_Znwm(i64 noundef 200) #27 ; 4 uses
  %i.ej = getelementptr inbounds nuw i8, ptr %i.eg, i64 88 ; 4 uses
  %i.ek = load ptr, ptr %i.ej, align 8, !tbaa !229
  %i.el = invoke noalias noundef nonnull dereferenceable(232) ptr @_Znwm(i64 noundef 232) #27
          to label %bb.ab unwind label %bb.an     ; 3 uses

bb.ab:                                            ; preds = %bb.aa
  %i.em = load ptr, ptr %i.ej, align 8, !tbaa !229
  %i.en = load ptr, ptr %i.k, align 8, !tbaa !132
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #23
  store i8 1, ptr %6, align 1, !tbaa !252
  invoke void @_ZN9AstVarRefC2EP8FileLineP6AstVarRK7VAccess(ptr noundef nonnull align 8 dereferenceable(232) %i.el, ptr noundef %i.em, ptr noundef %i.en, ptr noundef nonnull align 1 dereferenceable(1) %6)
          to label %bb.ac unwind label %bb.aq

bb.ac:                                            ; preds = %bb.ab
  %i.eo = load ptr, ptr %i.d, align 8, !tbaa !228
  call void @llvm.lifetime.start.p0(ptr nonnull %7) #23
  call void @llvm.experimental.noalias.scope.decl(metadata !259)
  %i.ep = getelementptr inbounds nuw i8, ptr %i.eg, i64 152
  store ptr %i.dw, ptr %7, align 8, !tbaa !18, !alias.scope !259
  %i.eq = load ptr, ptr %i.ep, align 8, !tbaa !10, !noalias !259 ; 2 uses
  %i.er = getelementptr inbounds nuw i8, ptr %i.eg, i64 160
  %i.es = load i64, ptr %i.er, align 8, !tbaa !16, !noalias !259 ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c) #23, !noalias !259
  store i64 %i.es, ptr %i.c, align 8, !tbaa !215, !noalias !259
  %i.et = icmp ugt i64 %i.es, 15
  br i1 %i.et, label %.noexc.i.i, label %._crit_edge.i.i.i

.noexc.i.i:                                       ; preds = %bb.ac
  %i.eu = invoke noundef ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm(ptr noundef nonnull align 8 dereferenceable(32) %7, ptr noundef nonnull align 8 dereferenceable(8) %i.c, i64 noundef 0)
          to label %.noexc162 unwind label %bb.ao ; 2 uses

.noexc162:                                        ; preds = %.noexc.i.i
  store ptr %i.eu, ptr %7, align 8, !tbaa !10, !alias.scope !259
  %i.ev = load i64, ptr %i.c, align 8, !tbaa !215, !noalias !259
  store i64 %i.ev, ptr %i.dw, align 8, !tbaa !17, !alias.scope !259
  br label %._crit_edge.i.i.i

._crit_edge.i.i.i:                                ; preds = %.noexc162, %bb.ac
  %i.ew = phi ptr [ %i.eu, %.noexc162 ], [ %i.dw, %bb.ac ] ; 2 uses
  switch i64 %i.es, label %bb.ae [
    i64 1, label %bb.ad
    i64 0, label %bb.af
  ]

bb.ad:                                            ; preds = %._crit_edge.i.i.i
  %i.ex = load i8, ptr %i.eq, align 1, !tbaa !17
  store i8 %i.ex, ptr %i.ew, align 1, !tbaa !17
  br label %bb.af
...
bb.af:                                            ; preds = %bb.ae, %bb.ad, %._crit_edge.i.i.i
  %i.ey = load i64, ptr %i.c, align 8, !tbaa !215, !noalias !259 ; 2 uses
  store i64 %i.ey, ptr %i.dx, align 8, !tbaa !16, !alias.scope !259
  %i.ez = load ptr, ptr %7, align 8, !tbaa !10, !alias.scope !259
  ...
  %i.fb = invoke noundef ptr @_ZN10VMemberMap10findMemberEPK7AstNodeRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(ptr noundef nonnull align 8 dereferenceable(48) %1, ptr noundef %i.eo, ptr noundef nonnull align 8 dereferenceable(32) %7)
          to label %bb.ag unwind label %.loopexit ; 5 uses

bb.ag:                                            ; preds = %bb.af
  %.not.i163 = icmp eq ptr %i.fb, null
...
bb.ah:                                            ; preds = %bb.ag
  ...
  %.sroa.0.0.copyload.i.i.i164 = load i16, ptr %i.fc, align 8, !tbaa !155
...
bb.ai:                                            ; preds = %bb.ah
  %i.fd = getelementptr inbounds nuw i8, ptr %i.fb, i64 64
  %i.fe = invoke noundef nonnull align 8 dereferenceable(112) ptr @_ZN7V3Error19v3errorPrepFileLineB5cxx11E11V3ErrorCodePKci(i8 4, ptr noundef nonnull @.str.9, i32 noundef 1063)
          to label %.noexc166 unwind label %.loopexit.split-lp ; 0 uses

.noexc166:                                        ; preds = %bb.ai
  %i.ff = invoke noundef nonnull align 8 dereferenceable(112) ptr @_ZN7V3Error10v3errorStrB5cxx11Ev()
          to label %.noexc167 unwind label %.loopexit.split-lp ; 2 uses

.noexc167:                                        ; preds = %.noexc166
  %i.fg = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %i.ff, ptr noundef nonnull @.str.33, i64 noundef 55)
          to label %.noexc168 unwind label %.loopexit.split-lp ; 0 uses

.noexc168:                                        ; preds = %.noexc167
  %.sroa.0.0.copyload.i.i5.i165 = load i16, ptr %i.fd, align 8, !tbaa !155
  %i.fh = zext i16 %.sroa.0.0.copyload.i.i5.i165 to i64
  %i.fi = getelementptr inbounds nuw [8 x i8], ptr @_ZZNK6VNType5asciiEvE5names, i64 %i.fh
  %i.fj = load ptr, ptr %i.fi, align 8, !tbaa !248
  %i.fk = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %i.ff, ptr noundef %i.fj)
          to label %.noexc169 unwind label %.loopexit.split-lp ; 2 uses

.noexc169:                                        ; preds = %.noexc168
  %i.fl = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %i.fk, ptr noundef nonnull @.str.34, i64 noundef 1)
          to label %.noexc170 unwind label %.loopexit.split-lp ; 0 uses

.noexc170:                                        ; preds = %.noexc169
  invoke void @_ZNK7AstNode15v3errorEndFatalERKNSt7__cxx1119basic_ostringstreamIcSt11char_traitsIcESaIcEEE(ptr noundef nonnull align 8 dereferenceable(152) %i.fb, ptr noundef nonnull align 8 dereferenceable(112) %i.fk) #26
...
_ZN7AstNode2asI6AstVarS_EEPT_PT0_.exit:           ; preds = %bb.ah, %bb.ag
  invoke void @_ZN12AstMemberSelC1EP8FileLineP11AstNodeExprP6AstVar(ptr noundef nonnull align 8 dereferenceable(200) %i.ei, ptr noundef %i.ek, ptr noundef nonnull %i.el, ptr noundef %i.fb)
          to label %bb.aj unwind label %.loopexit

bb.aj:                                            ; preds = %_ZN7AstNode2asI6AstVarS_EEPT_PT0_.exit
  %i.fm = load ptr, ptr %7, align 8, !tbaa !10    ; 2 uses
  %i.fn = icmp eq ptr %i.fm, %i.dw
  br i1 %i.fn, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit174, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i172

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i172: ; preds = %bb.aj
  %i.fo = load i64, ptr %i.dw, align 8, !tbaa !17
  %i.fp = add i64 %i.fo, 1
  call void @_ZdlPvm(ptr noundef %i.fm, i64 noundef %i.fp) #24
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit174: ; preds = %bb.aj, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i172
  ...
  %i.fq = call noalias noundef nonnull dereferenceable(152) ptr @_Znwm(i64 noundef 152) #27 ; 8 uses
  %i.fr = load ptr, ptr %i.ej, align 8, !tbaa !229
  %i.fs = invoke noalias noundef nonnull dereferenceable(232) ptr @_Znwm(i64 noundef 232) #27
          to label %bb.ak unwind label %bb.as     ; 3 uses

bb.ak:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit174
  %i.ft = load ptr, ptr %i.ej, align 8, !tbaa !229
  call void @llvm.lifetime.start.p0(ptr nonnull %8) #23
  store i8 0, ptr %8, align 1, !tbaa !252
  invoke void @_ZN9AstVarRefC2EP8FileLineP6AstVarRK7VAccess(ptr noundef nonnull align 8 dereferenceable(232) %i.fs, ptr noundef %i.ft, ptr noundef nonnull %i.eg, ptr noundef nonnull align 1 dereferenceable(1) %8)
          to label %bb.al unwind label %bb.at

bb.al:                                            ; preds = %bb.ak
  invoke void @_ZN7AstNodeC2E6VNTypeP8FileLine(ptr noundef nonnull align 8 dereferenceable(152) %i.fq, i16 466, ptr noundef %i.fr)
          to label %.noexc179 unwind label %.thread266

.noexc179:                                        ; preds = %bb.al
  store ptr getelementptr inbounds nuw inrange(-16, 336) (i8, ptr @_ZTV13AstNodeAssign, i64 16), ptr %i.fq, align 8, !tbaa !67
  invoke void @_ZN7AstNode7setOp1pEPS_(ptr noundef nonnull align 8 dereferenceable(152) %i.fq, ptr noundef nonnull %i.fs)
          to label %.noexc180 unwind label %.thread266

.noexc180:                                        ; preds = %.noexc179
  invoke void @_ZN7AstNode7setOp2pEPS_(ptr noundef nonnull align 8 dereferenceable(152) %i.fq, ptr noundef nonnull %i.ei)
          to label %.noexc181 unwind label %.thread266

.noexc181:                                        ; preds = %.noexc180
  %i.fu = getelementptr inbounds nuw i8, ptr %i.ei, i64 72
  %i.fv = load ptr, ptr %i.fu, align 8, !tbaa !236 ; 2 uses
  %i.fw = getelementptr inbounds nuw i8, ptr %i.fq, i64 72 ; 2 uses
  %i.fx = load ptr, ptr %i.fw, align 8, !tbaa !236
  %.not.i.i8.i.i175 = icmp eq ptr %i.fx, %i.fv
  br i1 %.not.i.i8.i.i175, label %_ZN9AstAssignC2EP8FileLineP11AstNodeExprS3_P7AstNode.exit182, label %bb.am

bb.am:                                            ; preds = %.noexc181
  store ptr %i.fv, ptr %i.fw, align 8, !tbaa !236
  %i.fy = load i64, ptr @_ZN7AstNode12s_editCntGblE, align 8, !tbaa !215
  %i.fz = add i64 %i.fy, 1
  store i64 %i.fz, ptr @_ZN7AstNode12s_editCntGblE, align 8, !tbaa !215
...
_ZN9AstAssignC2EP8FileLineP11AstNodeExprS3_P7AstNode.exit182: ; preds = %.noexc181, %bb.am
  store ptr getelementptr inbounds nuw inrange(-16, 336) (i8, ptr @_ZTV9AstAssign, i64 16), ptr %i.fq, align 8, !tbaa !67
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #23
  %i.ga = call noundef ptr @_ZN7AstNode7addNextIS_S_EEPT_S2_PT0_(ptr noundef %.071400, ptr noundef nonnull %i.fq)
...
bb.ap:                                            ; preds = %.loopexit.split-lp, %.loopexit
  ...
  %i.gd = load ptr, ptr %7, align 8, !tbaa !10    ; 2 uses
  %i.ge = icmp eq ptr %i.gd, %i.dw
  br i1 %i.ge, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i184, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i183

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i183: ; preds = %bb.ap
  %i.gf = load i64, ptr %i.dw, align 8, !tbaa !17
  %i.gg = add i64 %i.gf, 1
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i184: ; preds = %bb.ap, %bb.ao, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i183
  %.pn113 = phi { ptr, i32 } [ %i.gc, %bb.ao ], [ %lpad.phi, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i183 ], [ %lpad.phi, %bb.ap ]
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #23
  br label %bb.ar
...
bb.aq:                                            ; preds = %bb.ab
  %i.gh = landingpad { ptr, i32 }
          cleanup
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #23
  call void @_ZdlPvm(ptr noundef nonnull %i.el, i64 noundef 232) #24
  br label %bb.ar

bb.ar:                                            ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i184, %bb.an, %bb.aq
  %.pn113.pn.pn = phi { ptr, i32 } [ %i.gh, %bb.aq ], [ %.pn113, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i184 ], [ %i.gb, %bb.an ]
  call void @_ZdlPvm(ptr noundef nonnull %i.ei, i64 noundef 200) #24
  br label %bb.bz
...
bb.au:                                            ; preds = %.thread266, %bb.as, %bb.at
  %.pn117 = phi { ptr, i32 } [ %lpad.thr_comm.split-lp265, %bb.at ], [ %lpad.thr_comm264, %.thread266 ], [ %i.gi, %bb.as ]
  call void @_ZdlPvm(ptr noundef nonnull %i.fq, i64 noundef 152) #24
  br label %bb.bz

_ZNK10VDirection11isNonOutputEv.exit:             ; preds = %_ZN9AstAssignC2EP8FileLineP11AstNodeExprS3_P7AstNode.exit182, %bb.z
  %.1102 = phi ptr [ %i.ga, %_ZN9AstAssignC2EP8FileLineP11AstNodeExprS3_P7AstNode.exit182 ], [ %.071400, %bb.z ] ; 3 uses
  %i.gj = getelementptr inbounds nuw i8, ptr %i.eg, i64 72
  %i.gk = load ptr, ptr %i.gj, align 8, !tbaa !236
  %i.gl = call noundef ptr @_ZNK12AstNodeDType12skipRefIterpEbbb(ptr noundef nonnull align 8 dereferenceable(162) %i.gk, i1 noundef zeroext true, i1 noundef zeroext true, i1 noundef zeroext true) ; 3 uses
  %.not.i187 = icmp eq ptr %i.gl, null
...
bb.av:                                            ; preds = %_ZNK10VDirection11isNonOutputEv.exit
  ...
  %.sroa.0.0.copyload.i.i.i188 = load i16, ptr %i.gm, align 8, !tbaa !155
  %i.gn = icmp eq i16 %.sroa.0.0.copyload.i.i.i188, 74
  br i1 %i.gn, label %bb.aw, label %.critedge141

bb.aw:                                            ; preds = %bb.av
  store i8 1, ptr getelementptr inbounds nuw (i8, ptr @v3Global, i64 42), align 2, !tbaa !262
  %i.go = getelementptr inbounds nuw i8, ptr %i.gl, i64 164
  %.sroa.0.0.copyload.i.i = load i8, ptr %i.go, align 4, !tbaa !263
  %i.gp = icmp eq i8 %.sroa.0.0.copyload.i.i, 5
  br i1 %i.gp, label %bb.bs, label %.critedge141

.critedge141:                                     ; preds = %bb.av, %_ZNK10VDirection11isNonOutputEv.exit, %bb.aw
  %.sroa.0.0.copyload.i190 = load i8, ptr %i.eh, align 1, !tbaa !230
  %.off.i = add i8 %.sroa.0.0.copyload.i190, -2
  %switch.i = icmp ult i8 %.off.i, 3
  br i1 %switch.i, label %bb.ax, label %bb.bs

bb.ax:                                            ; preds = %.critedge141
  %i.gq = call noalias noundef nonnull dereferenceable(200) ptr @_Znwm(i64 noundef 200) #27 ; 3 uses
  %i.gr = getelementptr inbounds nuw i8, ptr %i.eg, i64 88 ; 4 uses
  %i.gs = load ptr, ptr %i.gr, align 8, !tbaa !229
  %i.gt = invoke noalias noundef nonnull dereferenceable(232) ptr @_Znwm(i64 noundef 232) #27
          to label %bb.ay unwind label %bb.bk     ; 3 uses

bb.ay:                                            ; preds = %bb.ax
  %i.gu = load ptr, ptr %i.gr, align 8, !tbaa !229
  %i.gv = load ptr, ptr %i.k, align 8, !tbaa !132
  call void @llvm.lifetime.start.p0(ptr nonnull %9) #23
  store i8 0, ptr %9, align 1, !tbaa !252
  invoke void @_ZN9AstVarRefC2EP8FileLineP6AstVarRK7VAccess(ptr noundef nonnull align 8 dereferenceable(232) %i.gt, ptr noundef %i.gu, ptr noundef %i.gv, ptr noundef nonnull align 1 dereferenceable(1) %9)
          to label %bb.az unwind label %bb.bn

bb.az:                                            ; preds = %bb.ay
  %i.gw = load ptr, ptr %i.d, align 8, !tbaa !228
  call void @llvm.lifetime.start.p0(ptr nonnull %10) #23
  call void @llvm.experimental.noalias.scope.decl(metadata !265)
  %i.gx = getelementptr inbounds nuw i8, ptr %i.eg, i64 152
  store ptr %i.dy, ptr %10, align 8, !tbaa !18, !alias.scope !265
  %i.gy = load ptr, ptr %i.gx, align 8, !tbaa !10, !noalias !265 ; 2 uses
  %i.gz = getelementptr inbounds nuw i8, ptr %i.eg, i64 160
  %i.ha = load i64, ptr %i.gz, align 8, !tbaa !16, !noalias !265 ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #23, !noalias !265
  store i64 %i.ha, ptr %i.b, align 8, !tbaa !215, !noalias !265
  %i.hb = icmp ugt i64 %i.ha, 15
  br i1 %i.hb, label %.noexc.i.i192, label %._crit_edge.i.i.i191

.noexc.i.i192:                                    ; preds = %bb.az
  %i.hc = invoke noundef ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm(ptr noundef nonnull align 8 dereferenceable(32) %10, ptr noundef nonnull align 8 dereferenceable(8) %i.b, i64 noundef 0)
          to label %.noexc193 unwind label %bb.bl ; 2 uses

.noexc193:                                        ; preds = %.noexc.i.i192
  store ptr %i.hc, ptr %10, align 8, !tbaa !10, !alias.scope !265
  %i.hd = load i64, ptr %i.b, align 8, !tbaa !215, !noalias !265
  store i64 %i.hd, ptr %i.dy, align 8, !tbaa !17, !alias.scope !265
  br label %._crit_edge.i.i.i191

._crit_edge.i.i.i191:                             ; preds = %.noexc193, %bb.az
  %i.he = phi ptr [ %i.hc, %.noexc193 ], [ %i.dy, %bb.az ] ; 2 uses
  switch i64 %i.ha, label %bb.bb [
    i64 1, label %bb.ba
    i64 0, label %bb.bc
  ]

bb.ba:                                            ; preds = %._crit_edge.i.i.i191
  %i.hf = load i8, ptr %i.gy, align 1, !tbaa !17
  store i8 %i.hf, ptr %i.he, align 1, !tbaa !17
  br label %bb.bc
...
bb.bc:                                            ; preds = %bb.bb, %bb.ba, %._crit_edge.i.i.i191
  %i.hg = load i64, ptr %i.b, align 8, !tbaa !215, !noalias !265 ; 2 uses
  store i64 %i.hg, ptr %i.dz, align 8, !tbaa !16, !alias.scope !265
  %i.hh = load ptr, ptr %10, align 8, !tbaa !10, !alias.scope !265
  %i.hi = getelementptr inbounds nuw i8, ptr %i.hh, i64 %i.hg
  store i8 0, ptr %i.hi, align 1, !tbaa !17
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #23, !noalias !265
  %i.hj = invoke noundef ptr @_ZN10VMemberMap10findMemberEPK7AstNodeRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(ptr noundef nonnull align 8 dereferenceable(48) %1, ptr noundef %i.gw, ptr noundef nonnull align 8 dereferenceable(32) %10)
          to label %bb.bd unwind label %.loopexit283 ; 5 uses

bb.bd:                                            ; preds = %bb.bc
  %.not.i195 = icmp eq ptr %i.hj, null
...
bb.be:                                            ; preds = %bb.bd
  ...
  %.sroa.0.0.copyload.i.i.i196 = load i16, ptr %i.hk, align 8, !tbaa !155
...
bb.bf:                                            ; preds = %bb.be
  %i.hl = getelementptr inbounds nuw i8, ptr %i.hj, i64 64
  %i.hm = invoke noundef nonnull align 8 dereferenceable(112) ptr @_ZN7V3Error19v3errorPrepFileLineB5cxx11E11V3ErrorCodePKci(i8 4, ptr noundef nonnull @.str.9, i32 noundef 1063)
          to label %.noexc199 unwind label %.loopexit.split-lp284 ; 0 uses

.noexc199:                                        ; preds = %bb.bf
  %i.hn = invoke noundef nonnull align 8 dereferenceable(112) ptr @_ZN7V3Error10v3errorStrB5cxx11Ev()
          to label %.noexc200 unwind label %.loopexit.split-lp284 ; 2 uses

.noexc200:                                        ; preds = %.noexc199
  %i.ho = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %i.hn, ptr noundef nonnull @.str.33, i64 noundef 55)
          to label %.noexc201 unwind label %.loopexit.split-lp284 ; 0 uses

.noexc201:                                        ; preds = %.noexc200
  %.sroa.0.0.copyload.i.i5.i198 = load i16, ptr %i.hl, align 8, !tbaa !155
  %i.hp = zext i16 %.sroa.0.0.copyload.i.i5.i198 to i64
  %i.hq = getelementptr inbounds nuw [8 x i8], ptr @_ZZNK6VNType5asciiEvE5names, i64 %i.hp
  %i.hr = load ptr, ptr %i.hq, align 8, !tbaa !248
  %i.hs = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %i.hn, ptr noundef %i.hr)
          to label %.noexc202 unwind label %.loopexit.split-lp284 ; 2 uses

.noexc202:                                        ; preds = %.noexc201
  %i.ht = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %i.hs, ptr noundef nonnull @.str.34, i64 noundef 1)
          to label %.noexc203 unwind label %.loopexit.split-lp284 ; 0 uses

.noexc203:                                        ; preds = %.noexc202
  invoke void @_ZNK7AstNode15v3errorEndFatalERKNSt7__cxx1119basic_ostringstreamIcSt11char_traitsIcESaIcEEE(ptr noundef nonnull align 8 dereferenceable(152) %i.hj, ptr noundef nonnull align 8 dereferenceable(112) %i.hs) #26
...
_ZN7AstNode2asI6AstVarS_EEPT_PT0_.exit205:        ; preds = %bb.be, %bb.bd
  invoke void @_ZN12AstMemberSelC1EP8FileLineP11AstNodeExprP6AstVar(ptr noundef nonnull align 8 dereferenceable(200) %i.gq, ptr noundef %i.gs, ptr noundef nonnull %i.gt, ptr noundef %i.hj)
          to label %bb.bg unwind label %.loopexit283

bb.bg:                                            ; preds = %_ZN7AstNode2asI6AstVarS_EEPT_PT0_.exit205
  %i.hu = load ptr, ptr %10, align 8, !tbaa !10   ; 2 uses
  %i.hv = icmp eq ptr %i.hu, %i.dy
  br i1 %i.hv, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit208, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i206

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i206: ; preds = %bb.bg
  %i.hw = load i64, ptr %i.dy, align 8, !tbaa !17
  %i.hx = add i64 %i.hw, 1
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit208: ; preds = %bb.bg, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i206
  ...
  %i.hy = call noalias noundef nonnull dereferenceable(152) ptr @_Znwm(i64 noundef 152) #27 ; 8 uses
  %i.hz = load ptr, ptr %i.gr, align 8, !tbaa !229
  %i.ia = invoke noalias noundef nonnull dereferenceable(232) ptr @_Znwm(i64 noundef 232) #27
          to label %bb.bh unwind label %bb.bp     ; 4 uses

bb.bh:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit208
  %i.ib = load ptr, ptr %i.gr, align 8, !tbaa !229
  call void @llvm.lifetime.start.p0(ptr nonnull %11) #23
  store i8 1, ptr %11, align 1, !tbaa !252
  invoke void @_ZN9AstVarRefC2EP8FileLineP6AstVarRK7VAccess(ptr noundef nonnull align 8 dereferenceable(232) %i.ia, ptr noundef %i.ib, ptr noundef nonnull %i.eg, ptr noundef nonnull align 1 dereferenceable(1) %11)
          to label %bb.bi unwind label %bb.bq

bb.bi:                                            ; preds = %bb.bh
  invoke void @_ZN7AstNodeC2E6VNTypeP8FileLine(ptr noundef nonnull align 8 dereferenceable(152) %i.hy, i16 466, ptr noundef %i.hz)
          to label %.noexc213 unwind label %.thread278

.noexc213:                                        ; preds = %bb.bi
  store ptr getelementptr inbounds nuw inrange(-16, 336) (i8, ptr @_ZTV13AstNodeAssign, i64 16), ptr %i.hy, align 8, !tbaa !67
  invoke void @_ZN7AstNode7setOp1pEPS_(ptr noundef nonnull align 8 dereferenceable(152) %i.hy, ptr noundef nonnull %i.gq)
          to label %.noexc214 unwind label %.thread278

.noexc214:                                        ; preds = %.noexc213
  invoke void @_ZN7AstNode7setOp2pEPS_(ptr noundef nonnull align 8 dereferenceable(152) %i.hy, ptr noundef nonnull %i.ia)
          to label %.noexc215 unwind label %.thread278

.noexc215:                                        ; preds = %.noexc214
  %i.ic = getelementptr inbounds nuw i8, ptr %i.ia, i64 72
  %i.id = load ptr, ptr %i.ic, align 8, !tbaa !236 ; 2 uses
  %i.ie = getelementptr inbounds nuw i8, ptr %i.hy, i64 72 ; 2 uses
  %i.if = load ptr, ptr %i.ie, align 8, !tbaa !236
  %.not.i.i8.i.i209 = icmp eq ptr %i.if, %i.id
  br i1 %.not.i.i8.i.i209, label %_ZN9AstAssignC2EP8FileLineP11AstNodeExprS3_P7AstNode.exit216, label %bb.bj

bb.bj:                                            ; preds = %.noexc215
  store ptr %i.id, ptr %i.ie, align 8, !tbaa !236
  %i.ig = load i64, ptr @_ZN7AstNode12s_editCntGblE, align 8, !tbaa !215
  %i.ih = add i64 %i.ig, 1
  store i64 %i.ih, ptr @_ZN7AstNode12s_editCntGblE, align 8, !tbaa !215
...
_ZN9AstAssignC2EP8FileLineP11AstNodeExprS3_P7AstNode.exit216: ; preds = %.noexc215, %bb.bj
  store ptr getelementptr inbounds nuw inrange(-16, 336) (i8, ptr @_ZTV9AstAssign, i64 16), ptr %i.hy, align 8, !tbaa !67
  call void @llvm.lifetime.end.p0(ptr nonnull %11) #23
  %i.ii = call noundef ptr @_ZN7AstNode7addNextIS_S_EEPT_S2_PT0_(ptr noundef %.0101399, ptr noundef nonnull %i.hy)
  br label %bb.bs
...
bb.bm:                                            ; preds = %.loopexit.split-lp284, %.loopexit283
  ...
  %i.il = load ptr, ptr %10, align 8, !tbaa !10   ; 2 uses
  %i.im = icmp eq ptr %i.il, %i.dy
  br i1 %i.im, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i218, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i217

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i217: ; preds = %bb.bm
  %i.in = load i64, ptr %i.dy, align 8, !tbaa !17
  %i.io = add i64 %i.in, 1
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i218: ; preds = %bb.bm, %bb.bl, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i217
  %.pn123 = phi { ptr, i32 } [ %i.ik, %bb.bl ], [ %lpad.phi287, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i217 ], [ %lpad.phi287, %bb.bm ]
  call void @llvm.lifetime.end.p0(ptr nonnull %10) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %9) #23
  br label %bb.bo
...
bb.bn:                                            ; preds = %bb.ay
  %i.ip = landingpad { ptr, i32 }
          cleanup
  call void @llvm.lifetime.end.p0(ptr nonnull %9) #23
  call void @_ZdlPvm(ptr noundef nonnull %i.gt, i64 noundef 232) #24
  br label %bb.bo

bb.bo:                                            ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i218, %bb.bk, %bb.bn
  %.pn123.pn.pn = phi { ptr, i32 } [ %i.ip, %bb.bn ], [ %.pn123, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i218 ], [ %i.ij, %bb.bk ]
  call void @_ZdlPvm(ptr noundef nonnull %i.gq, i64 noundef 200) #24
  br label %bb.bz
...
bb.bq:                                            ; preds = %bb.bh
  %lpad.thr_comm.split-lp277 = landingpad { ptr, i32 }
          cleanup
  call void @llvm.lifetime.end.p0(ptr nonnull %11) #23
  call void @_ZdlPvm(ptr noundef nonnull %i.ia, i64 noundef 232) #24
  br label %bb.br

bb.br:                                            ; preds = %.thread278, %bb.bp, %bb.bq
  %.pn127 = phi { ptr, i32 } [ %lpad.thr_comm.split-lp277, %bb.bq ], [ %lpad.thr_comm276, %.thread278 ], [ %i.iq, %bb.bp ]
  call void @_ZdlPvm(ptr noundef nonnull %i.hy, i64 noundef 152) #24
  br label %bb.bz

bb.bs:                                            ; preds = %_ZN9AstAssignC2EP8FileLineP11AstNodeExprS3_P7AstNode.exit216, %bb.z, %.critedge141, %bb.aw
  %.2103 = phi ptr [ %.0101399, %bb.z ], [ %.0101399, %bb.aw ], [ %.0101399, %.critedge141 ], [ %i.ii, %_ZN9AstAssignC2EP8FileLineP11AstNodeExprS3_P7AstNode.exit216 ] ; 3 uses
  %.2 = phi ptr [ %.071400, %bb.z ], [ %.1102, %bb.aw ], [ %.1102, %.critedge141 ], [ %.1102, %_ZN9AstAssignC2EP8FileLineP11AstNodeExprS3_P7AstNode.exit216 ] ; 3 uses
  %i.ir = getelementptr inbounds nuw i8, ptr %.sroa.0241.0396, i64 8 ; 2 uses
  %i.is = icmp eq ptr %i.ir, %.sroa.11.0397
  br i1 %i.is, label %bb.bt, label %_ZNSt15_Deque_iteratorIP6AstVarRS1_PS1_EppEv.exit

bb.bt:                                            ; preds = %bb.bs
  %i.it = getelementptr inbounds nuw i8, ptr %.sroa.14.0398, i64 8 ; 2 uses
  %i.iu = load ptr, ptr %i.it, align 8, !tbaa !212 ; 2 uses
...
_ZNSt15_Deque_iteratorIP6AstVarRS1_PS1_EppEv.exit: ; preds = %bb.bs, %bb.bt
  %.sroa.0241.1 = phi ptr [ %i.iu, %bb.bt ], [ %i.ir, %bb.bs ] ; 2 uses
  %.sroa.11.1 = phi ptr [ %i.iv, %bb.bt ], [ %.sroa.11.0397, %bb.bs ]
  %.sroa.14.1 = phi ptr [ %i.it, %bb.bt ], [ %.sroa.14.0398, %bb.bs ]
  %.not282 = icmp eq ptr %.sroa.0241.1, %i.dr
  br i1 %.not282, label %._crit_edge, label %bb.z

bb.bu:                                            ; preds = %._crit_edge
  %i.iw = call noundef ptr @_ZN7AstNode7addNextIS_S_EEPT_S2_PT0_(ptr noundef nonnull %i.db, ptr noundef nonnull %.2) ; 0 uses
  br label %._crit_edge.thread

._crit_edge.thread:                               ; preds = %_ZN9AstAssignC2EP8FileLineP11AstNodeExprS3_P7AstNode.exit, %bb.bu, %._crit_edge
  %.071.lcssa482 = phi ptr [ %.2103, %._crit_edge ], [ %.2103, %bb.bu ], [ %i.z, %_ZN9AstAssignC2EP8FileLineP11AstNodeExprS3_P7AstNode.exit ] ; 2 uses
  %.not112 = icmp eq ptr %.099392, %.071.lcssa482
  br i1 %.not112, label %bb.bw, label %bb.bv

bb.bv:                                            ; preds = %._crit_edge.thread
  call void @_ZN7AstNode17addHereThisAsNextEPS_(ptr noundef nonnull align 8 dereferenceable(152) %.099392, ptr noundef nonnull %i.db)
  br label %_ZN10VNRelinker6relinkEP7AstNode.exit

bb.bw:                                            ; preds = %._crit_edge.thread
  %i.ix = call noundef ptr @_ZN7AstNode7addNextIS_S_EEPT_S2_PT0_(ptr noundef nonnull %i.db, ptr noundef nonnull %.099392) ; 0 uses
  br label %_ZN10VNRelinker6relinkEP7AstNode.exit

_ZN10VNRelinker6relinkEP7AstNode.exit:            ; preds = %bb.bv, %bb.bw
  %.3 = phi ptr [ %.071.lcssa482, %bb.bv ], [ %i.db, %bb.bw ]
  %i.iy = load ptr, ptr %i.k, align 8, !tbaa !132
  %i.iz = call noundef ptr @_ZN7AstNode7addNextIS_S_EEPT_S2_PT0_(ptr noundef %i.iy, ptr noundef %.3) ; 0 uses
  %i.ja = load ptr, ptr %i.k, align 8, !tbaa !132
  call void @_ZN7AstNode6relinkEP10VNRelinker(ptr noundef nonnull align 8 dereferenceable(152) %i.ja, ptr noundef nonnull align 8 dereferenceable(32) %3)
  %i.jb = load ptr, ptr %i.d, align 8, !tbaa !228 ; 2 uses
...
bb.bx:                                            ; preds = %_ZN10VNRelinker6relinkEP7AstNode.exit
  %i.jc = load ptr, ptr %0, align 8, !tbaa !268
  call void @_ZN7AstNode7addOp2pEPS_(ptr noundef nonnull align 8 dereferenceable(306) %i.jc, ptr noundef nonnull %i.jb)
...
bb.bz:                                            ; preds = %bb.au, %bb.ar, %bb.br, %bb.bo, %bb.y, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit160, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit9.i
  %.pn136.pn = phi { ptr, i32 } [ %.pn127, %bb.br ], [ %.pn113.pn.pn, %bb.ar ], [ %i.bt, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit9.i ], [ %.pn123.pn.pn, %bb.bo ], [ %i.ea, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit160 ], [ %.pn117, %bb.au ], [ %.pn109, %bb.y ]
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #23
...
bb.a:                                             ; preds = %_ZN9AstVarRef12unlinkFrBackEP10VNRelinker.exit
  ...
  %.sroa.0.0.copyload.i = load i8, ptr %i.i, align 8, !tbaa !270
  store i8 %.sroa.0.0.copyload.i, ptr %4, align 1
  invoke void @_ZN9AstVarRefC2EP8FileLineP6AstVarRK7VAccess(ptr noundef nonnull align 8 dereferenceable(232) %i.f, ptr noundef %i.e, ptr noundef %i.h, ptr noundef nonnull align 1 dereferenceable(1) %4)
...
bb.b:                                             ; preds = %bb.a
  ...
  invoke void @_ZN12AstMemberSelC1EP8FileLineP11AstNodeExprP6AstVar(ptr noundef nonnull align 8 dereferenceable(200) %i.c, ptr noundef %i.e, ptr noundef nonnull %i.f, ptr noundef %i.k)
          to label %bb.c unwind label %bb.l

bb.c:                                             ; preds = %bb.b
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #23
  %i.l = load ptr, ptr %i.j, align 8, !tbaa !156  ; 4 uses
  %i.m = getelementptr inbounds nuw i8, ptr %i.l, i64 249
  %.sroa.0.0.copyload.i29 = load i8, ptr %i.m, align 1, !tbaa !230
  %.not = icmp eq i8 %.sroa.0.0.copyload.i29, 0
  br i1 %.not, label %bb.q, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.n = load ptr, ptr %2, align 8, !tbaa !127
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #23
  call void @llvm.experimental.noalias.scope.decl(metadata !271)
  %i.o = getelementptr inbounds nuw i8, ptr %i.l, i64 152
  %i.p = getelementptr inbounds nuw i8, ptr %5, i64 16 ; 7 uses
  store ptr %i.p, ptr %5, align 8, !tbaa !18, !alias.scope !271
  %i.q = load ptr, ptr %i.o, align 8, !tbaa !10, !noalias !271 ; 2 uses
  %i.r = getelementptr inbounds nuw i8, ptr %i.l, i64 160
  %i.s = load i64, ptr %i.r, align 8, !tbaa !16, !noalias !271 ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #23, !noalias !271
  store i64 %i.s, ptr %i.a, align 8, !tbaa !215, !noalias !271
...
.noexc:                                           ; preds = %.noexc.i.i
  store ptr %i.u, ptr %5, align 8, !tbaa !10, !alias.scope !271
  %i.v = load i64, ptr %i.a, align 8, !tbaa !215, !noalias !271
  store i64 %i.v, ptr %i.p, align 8, !tbaa !17, !alias.scope !271
  br label %._crit_edge.i.i.i

._crit_edge.i.i.i:                                ; preds = %.noexc, %bb.d
  %i.w = phi ptr [ %i.u, %.noexc ], [ %i.p, %bb.d ] ; 2 uses
...
bb.g:                                             ; preds = %bb.f, %bb.e, %._crit_edge.i.i.i
  %i.y = load i64, ptr %i.a, align 8, !tbaa !215, !noalias !271 ; 2 uses
  %i.z = getelementptr inbounds nuw i8, ptr %5, i64 8
  store i64 %i.y, ptr %i.z, align 8, !tbaa !16, !alias.scope !271
  %i.aa = load ptr, ptr %5, align 8, !tbaa !10, !alias.scope !271
  ...
  %i.ad = invoke noundef ptr @_ZN10VMemberMap10findMemberEPK7AstNodeRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(ptr noundef nonnull align 8 dereferenceable(48) %i.ac, ptr noundef %i.n, ptr noundef nonnull align 8 dereferenceable(32) %5)
...
bb.i:                                             ; preds = %bb.h
  ...
  %.sroa.0.0.copyload.i.i.i = load i16, ptr %i.ae, align 8, !tbaa !155
...
bb.j:                                             ; preds = %bb.i
  %i.af = invoke noundef nonnull align 8 dereferenceable(112) ptr @_ZN7V3Error19v3errorPrepFileLineB5cxx11E11V3ErrorCodePKci(i8 4, ptr noundef nonnull @.str.9, i32 noundef 1063)
          to label %.noexc30 unwind label %bb.p   ; 0 uses

.noexc30:                                         ; preds = %bb.j
  %i.ag = invoke noundef nonnull align 8 dereferenceable(112) ptr @_ZN7V3Error10v3errorStrB5cxx11Ev()
          to label %.noexc31 unwind label %bb.p   ; 2 uses

.noexc31:                                         ; preds = %.noexc30
  %i.ah = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %i.ag, ptr noundef nonnull @.str.33, i64 noundef 55)
          to label %.noexc32 unwind label %bb.p   ; 0 uses

.noexc32:                                         ; preds = %.noexc31
  %.sroa.0.0.copyload.i.i5.i = load i16, ptr %i.ae, align 8, !tbaa !155
  %i.ai = zext i16 %.sroa.0.0.copyload.i.i5.i to i64
  %i.aj = getelementptr inbounds nuw [8 x i8], ptr @_ZZNK6VNType5asciiEvE5names, i64 %i.ai
  %i.ak = load ptr, ptr %i.aj, align 8, !tbaa !248
  %i.al = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %i.ag, ptr noundef %i.ak)
          to label %.noexc33 unwind label %bb.p   ; 2 uses

.noexc33:                                         ; preds = %.noexc32
  %i.am = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %i.al, ptr noundef nonnull @.str.34, i64 noundef 1)
          to label %.noexc34 unwind label %bb.p   ; 0 uses

.noexc34:                                         ; preds = %.noexc33
  invoke void @_ZNK7AstNode15v3errorEndFatalERKNSt7__cxx1119basic_ostringstreamIcSt11char_traitsIcESaIcEEE(ptr noundef nonnull align 8 dereferenceable(152) %i.ad, ptr noundef nonnull align 8 dereferenceable(112) %i.al) #26
          to label %.noexc35 unwind label %bb.p

.noexc35:                                         ; preds = %.noexc34
  unreachable

_ZN7AstNode2asI6AstVarS_EEPT_PT0_.exit:           ; preds = %bb.i, %bb.h
end_hunk_0
...
.lr.ph.i.i:                                       ; preds = %bb.l, %bb.r
  %.029.i.i = phi i32 [ %i.br, %bb.r ], [ 1, %bb.l ] ; 4 uses
  %.02328.i.i = phi i64 [ %i.bq, %bb.r ], [ %i.bi, %bb.l ] ; 5 uses
  %i.bk = icmp ult i64 %.02328.i.i, 100
  br i1 %i.bk, label %bb.m, label %bb.n

bb.m:                                             ; preds = %.lr.ph.i.i
  %i.bl = add i32 %.029.i.i, 1
  br label %_ZNSt8__detail14__to_chars_lenImEEjT_i.exit.i

bb.n:                                             ; preds = %.lr.ph.i.i
  %i.bm = icmp ult i64 %.02328.i.i, 1000
  br i1 %i.bm, label %bb.o, label %bb.p

bb.o:                                             ; preds = %bb.n
  %i.bn = add i32 %.029.i.i, 2
  br label %_ZNSt8__detail14__to_chars_lenImEEjT_i.exit.i

bb.p:                                             ; preds = %bb.n
  %i.bo = icmp ult i64 %.02328.i.i, 10000
  br i1 %i.bo, label %bb.q, label %bb.r

bb.q:                                             ; preds = %bb.p
  %i.bp = add i32 %.029.i.i, 3
  br label %_ZNSt8__detail14__to_chars_lenImEEjT_i.exit.i

bb.r:                                             ; preds = %bb.p
  %i.bq = udiv i64 %.02328.i.i, 10000
  %i.br = add i32 %.029.i.i, 4                    ; 2 uses
  %i.bs = icmp ult i64 %.02328.i.i, 100000
...
_ZNSt8__detail14__to_chars_lenImEEjT_i.exit.i:    ; preds = %bb.r, %bb.q, %bb.o, %bb.m, %bb.l
  %.0.i.i = phi i32 [ %i.bp, %bb.q ], [ %i.bl, %bb.m ], [ %i.bn, %bb.o ], [ 1, %bb.l ], [ %i.br, %bb.r ]
  %i.bt = zext i32 %.0.i.i to i64
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.backedge
  %.035101 = phi ptr [ %.136, %.backedge ], [ %i.c, %.lr.ph.preheader ] ; 2 uses
  %.033100 = phi ptr [ %.134, %.backedge ], [ %.ptr105, %.lr.ph.preheader ] ; 3 uses
  %.03999 = phi i64 [ %.140, %.backedge ], [ 32, %.lr.ph.preheader ] ; 3 uses
...
bb.n:                                             ; preds = %bb.m
  ...
  %i.aj = ptrtoint ptr %.033100 to i64
  %i.ak = sub i64 %i.ai, %i.aj                    ; 2 uses
  %i.al = getelementptr inbounds i8, ptr %.033100, i64 -16
...
bb.p:                                             ; preds = %_ZNSt10unique_ptrIA_P7AstNodeSt14default_deleteIS2_EE5resetIPS1_vEEvT_.exit, %.lr.ph
  ...
  %.140 = phi i64 [ %.03999, %.lr.ph ], [ %i.ad, %_ZNSt10unique_ptrIA_P7AstNodeSt14default_deleteIS2_EE5resetIPS1_vEEvT_.exit ]
  %.134 = phi ptr [ %.033100, %.lr.ph ], [ %i.an, %_ZNSt10unique_ptrIA_P7AstNodeSt14default_deleteIS2_EE5resetIPS1_vEEvT_.exit ] ; 2 uses
  %.136 = phi ptr [ %.035101, %.lr.ph ], [ %i.aq, %_ZNSt10unique_ptrIA_P7AstNodeSt14default_deleteIS2_EE5resetIPS1_vEEvT_.exit ]
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %_ZZN7AstNode13predicateImplI7AstForkLb0EZN15DynScopeVisitor12hasAsyncForkEPS_EUlPS1_E_EEbPNSt11conditionalIXsr3std8is_constIT_EE5valueEKS_S_E4typeERKT1_bENKUlS3_E_clES3_.exit58
  %.035102 = phi ptr [ %.136, %_ZZN7AstNode13predicateImplI7AstForkLb0EZN15DynScopeVisitor12hasAsyncForkEPS_EUlPS1_E_EEbPNSt11conditionalIXsr3std8is_constIT_EE5valueEKS_S_E4typeERKT1_bENKUlS3_E_clES3_.exit58 ], [ %i.c, %.lr.ph.preheader ] ; 2 uses
  %.033101 = phi ptr [ %.134, %_ZZN7AstNode13predicateImplI7AstForkLb0EZN15DynScopeVisitor12hasAsyncForkEPS_EUlPS1_E_EEbPNSt11conditionalIXsr3std8is_constIT_EE5valueEKS_S_E4typeERKT1_bENKUlS3_E_clES3_.exit58 ], [ %.ptr110, %.lr.ph.preheader ] ; 3 uses
  %.039100 = phi i64 [ %.140, %_ZZN7AstNode13predicateImplI7AstForkLb0EZN15DynScopeVisitor12hasAsyncForkEPS_EUlPS1_E_EEbPNSt11conditionalIXsr3std8is_constIT_EE5valueEKS_S_E4typeERKT1_bENKUlS3_E_clES3_.exit58 ], [ 32, %.lr.ph.preheader ] ; 3 uses
  ...
  %.not46 = icmp ult ptr %i.r, %.035102
  br i1 %.not46, label %bb.p, label %bb.m, !prof !237

bb.m:                                             ; preds = %.lr.ph
  %i.x = shl i64 %.039100, 1                      ; 3 uses
  %i.y = icmp ugt i64 %i.x, 2305843009213693951
  %i.z = shl i64 %.039100, 4
...
bb.n:                                             ; preds = %bb.m
  ...
  %i.ad = ptrtoint ptr %.033101 to i64
  %i.ae = sub i64 %i.ac, %i.ad                    ; 2 uses
  %i.af = getelementptr inbounds i8, ptr %.033101, i64 -16
...
bb.p:                                             ; preds = %_ZNSt10unique_ptrIA_P7AstNodeSt14default_deleteIS2_EE5resetIPS1_vEEvT_.exit, %.lr.ph
  ...
  %.140 = phi i64 [ %.039100, %.lr.ph ], [ %i.x, %_ZNSt10unique_ptrIA_P7AstNodeSt14default_deleteIS2_EE5resetIPS1_vEEvT_.exit ]
  %.134 = phi ptr [ %.033101, %.lr.ph ], [ %i.ah, %_ZNSt10unique_ptrIA_P7AstNodeSt14default_deleteIS2_EE5resetIPS1_vEEvT_.exit ] ; 2 uses
  %.136 = phi ptr [ %.035102, %.lr.ph ], [ %i.ak, %_ZNSt10unique_ptrIA_P7AstNodeSt14default_deleteIS2_EE5resetIPS1_vEEvT_.exit ]
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %_ZZN7AstNode13predicateImplI12AstAssignDlyLb0EZN15DynScopeVisitor12hasAsyncForkEPS_EUlPS1_E_EEbPNSt11conditionalIXsr3std8is_constIT_EE5valueEKS_S_E4typeERKT1_bENKUlS3_E_clES3_.exit55
  %.03597 = phi ptr [ %.136, %_ZZN7AstNode13predicateImplI12AstAssignDlyLb0EZN15DynScopeVisitor12hasAsyncForkEPS_EUlPS1_E_EEbPNSt11conditionalIXsr3std8is_constIT_EE5valueEKS_S_E4typeERKT1_bENKUlS3_E_clES3_.exit55 ], [ %i.c, %.lr.ph.preheader ] ; 2 uses
  %.03396 = phi ptr [ %.134, %_ZZN7AstNode13predicateImplI12AstAssignDlyLb0EZN15DynScopeVisitor12hasAsyncForkEPS_EUlPS1_E_EEbPNSt11conditionalIXsr3std8is_constIT_EE5valueEKS_S_E4typeERKT1_bENKUlS3_E_clES3_.exit55 ], [ %.ptr105, %.lr.ph.preheader ] ; 3 uses
  %.03995 = phi i64 [ %.140, %_ZZN7AstNode13predicateImplI12AstAssignDlyLb0EZN15DynScopeVisitor12hasAsyncForkEPS_EUlPS1_E_EEbPNSt11conditionalIXsr3std8is_constIT_EE5valueEKS_S_E4typeERKT1_bENKUlS3_E_clES3_.exit55 ], [ 32, %.lr.ph.preheader ] ; 3 uses
  ...
  call void @llvm.prefetch.p0(ptr nonnull %i.v, i32 0, i32 3, i32 1)
  %.not46 = icmp ult ptr %i.q, %.03597
  br i1 %.not46, label %bb.o, label %bb.l, !prof !237

bb.l:                                             ; preds = %.lr.ph
  %i.w = shl i64 %.03995, 1                       ; 3 uses
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.ac = ptrtoint ptr %.03396 to i64
  %i.ad = sub i64 %i.ab, %i.ac                    ; 2 uses
  %i.ae = getelementptr inbounds i8, ptr %.03396, i64 -16
...
bb.o:                                             ; preds = %_ZNSt10unique_ptrIA_P7AstNodeSt14default_deleteIS2_EE5resetIPS1_vEEvT_.exit, %.lr.ph
  ...
  %.140 = phi i64 [ %.03995, %.lr.ph ], [ %i.w, %_ZNSt10unique_ptrIA_P7AstNodeSt14default_deleteIS2_EE5resetIPS1_vEEvT_.exit ]
  %.134 = phi ptr [ %.03396, %.lr.ph ], [ %i.ag, %_ZNSt10unique_ptrIA_P7AstNodeSt14default_deleteIS2_EE5resetIPS1_vEEvT_.exit ] ; 2 uses
  %.136 = phi ptr [ %.03597, %.lr.ph ], [ %i.aj, %_ZNSt10unique_ptrIA_P7AstNodeSt14default_deleteIS2_EE5resetIPS1_vEEvT_.exit ]
...
.lr.ph.i:                                         ; preds = %_ZNSt11_Deque_baseIP6AstVarSaIS1_EE15_M_allocate_mapEm.exit, %_ZNSt11_Deque_baseIP6AstVarSaIS1_EE16_M_allocate_nodeEv.exit.i
  %.011.i = phi ptr [ %i.l, %_ZNSt11_Deque_baseIP6AstVarSaIS1_EE16_M_allocate_nodeEv.exit.i ], [ %i.i, %_ZNSt11_Deque_baseIP6AstVarSaIS1_EE15_M_allocate_mapEm.exit ] ; 4 uses
  %i.k = invoke noalias noundef nonnull dereferenceable(512) ptr @_Znwm(i64 noundef 512) #27
...
_ZNSt11_Deque_baseIP6AstVarSaIS1_EE16_M_allocate_nodeEv.exit.i: ; preds = %.lr.ph.i
  store ptr %i.k, ptr %.011.i, align 8, !tbaa !212
  %i.l = getelementptr inbounds nuw i8, ptr %.011.i, i64 8 ; 2 uses
  %i.m = icmp ult ptr %i.l, %i.j
  br i1 %i.m, label %.lr.ph.i, label %_ZNSt11_Deque_baseIP6AstVarSaIS1_EE15_M_create_nodesEPPS1_S5_.exit, !llvm.loop !474

bb.a:                                             ; preds = %.lr.ph.i
  %i.n = landingpad { ptr, i32 }
          catch ptr null
  %i.o = extractvalue { ptr, i32 } %i.n, 0
  %i.p = tail call ptr @__cxa_begin_catch(ptr %i.o) #23 ; 0 uses
  %i.q = icmp ult ptr %i.i, %.011.i
  br i1 %i.q, label %.lr.ph.i.i, label %_ZNSt11_Deque_baseIP6AstVarSaIS1_EE16_M_destroy_nodesEPPS1_S5_.exit.i

.lr.ph.i.i:                                       ; preds = %bb.a, %.lr.ph.i.i
  %.06.i.i = phi ptr [ %i.s, %.lr.ph.i.i ], [ %i.i, %bb.a ] ; 2 uses
  %i.r = load ptr, ptr %.06.i.i, align 8, !tbaa !212
  tail call void @_ZdlPvm(ptr noundef %i.r, i64 noundef 512) #24
  %i.s = getelementptr inbounds nuw i8, ptr %.06.i.i, i64 8 ; 2 uses
  %i.t = icmp ult ptr %i.s, %.011.i
  br i1 %i.t, label %.lr.ph.i.i, label %_ZNSt11_Deque_baseIP6AstVarSaIS1_EE16_M_destroy_nodesEPPS1_S5_.exit.i, !llvm.loop !213
...
.body:                                            ; preds = %bb.b
  ...
  %i.y = tail call ptr @__cxa_begin_catch(ptr %i.x) #23 ; 0 uses
  %i.z = load ptr, ptr %0, align 8, !tbaa !209
  %i.aa = load i64, ptr %i.d, align 8, !tbaa !214
  %i.ab = shl i64 %i.aa, 3
  tail call void @_ZdlPvm(ptr noundef %i.z, i64 noundef %i.ab) #24
...
_ZNSt11_Deque_baseIP6AstVarSaIS1_EE15_M_create_nodesEPPS1_S5_.exit: ; preds = %_ZNSt11_Deque_baseIP6AstVarSaIS1_EE16_M_allocate_nodeEv.exit.i
  ...
  store ptr %i.i, ptr %i.ae, align 8, !tbaa !226
  %i.af = load ptr, ptr %i.i, align 8, !tbaa !212 ; 3 uses
  %i.ag = getelementptr inbounds nuw i8, ptr %0, i64 24
  store ptr %i.af, ptr %i.ag, align 8, !tbaa !475
  %i.ah = getelementptr inbounds nuw i8, ptr %i.af, i64 512
  %i.ai = getelementptr inbounds nuw i8, ptr %0, i64 32
  store ptr %i.ah, ptr %i.ai, align 8, !tbaa !227
  %i.aj = getelementptr inbounds nuw i8, ptr %0, i64 48
  %i.ak = getelementptr inbounds i8, ptr %i.j, i64 -8 ; 2 uses
  %i.al = getelementptr inbounds nuw i8, ptr %0, i64 72
  store ptr %i.ak, ptr %i.al, align 8, !tbaa !226
  %i.am = load ptr, ptr %i.ak, align 8, !tbaa !212 ; 3 uses
  %i.an = getelementptr inbounds nuw i8, ptr %0, i64 56
  store ptr %i.am, ptr %i.an, align 8, !tbaa !475
  ...
  store ptr %i.af, ptr %i.ad, align 8, !tbaa !476
  %i.aq = and i64 %1, 63
...
bb.t:                                             ; preds = %bb.c, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit63
  ...
  %.not38140 = icmp eq ptr %i.bp, null
  br i1 %.not38140, label %.loopexit117, label %.lr.ph

.lr.ph:                                           ; preds = %bb.t, %bb.ab
  %.030141 = phi ptr [ %i.br, %bb.ab ], [ %i.bp, %bb.t ] ; 3 uses
  %i.bq = getelementptr inbounds nuw i8, ptr %.030141, i64 8
...
_ZN7AstNode2asI8AstBeginS_EEPT_PT0_.exit:         ; preds = %.lr.ph, %bb.u
  %i.cc = getelementptr inbounds nuw i8, ptr %.030141, i64 32 ; 2 uses
...
_ZN8AstDelayC2EP8FileLineP11AstNodeExprb.exit:    ; preds = %.noexc68
  ...
  call void @_ZN11ForkVisitor39moveForkSentinelAfterDisableQueuePushesEP8AstBegin(ptr noundef nonnull %.030141)
  br label %bb.ab

bb.ab:                                            ; preds = %_ZN7AstNode2asI8AstBeginS_EEPT_PT0_.exit, %_ZN8AstDelayC2EP8FileLineP11AstNodeExprb.exit
  br i1 %.not.i, label %.loopexit117, label %.lr.ph, !llvm.loop !528
...
.loopexit117:                                     ; preds = %bb.ab, %bb.t, %bb.a
...
_ZN9VNVisitor18iterateAndNextNullEP7AstNode.exit: ; preds = %.loopexit117, %bb.af
...
_ZN9VNVisitor18iterateAndNextNullEP7AstNode.exit72: ; preds = %_ZN9VNVisitor18iterateAndNextNullEP7AstNode.exit, %bb.ag
  ...
  %.not39143 = icmp eq ptr %i.da, null
  br i1 %.not39143, label %._crit_edge155.thread, label %.lr.ph148

._crit_edge155.thread:                            ; preds = %_ZN9VNVisitor18iterateAndNextNullEP7AstNode.exit72
...
._crit_edge:                                      ; preds = %_ZNSt6vectorIP8AstBeginSaIS1_EE9push_backERKS1_.exit
  store i8 %i.cy, ptr %i.cx, align 8, !tbaa !291
  %.not116151 = icmp eq ptr %.sroa.0106.2, %.sroa.13.2.a
  br i1 %.not116151, label %._crit_edge155, label %.lr.ph154

.loopexit:                                        ; preds = %.lr.ph148, %_ZNKSt6vectorIP8AstBeginSaIS1_EE12_M_check_lenEmPKc.exit.i.i
  %lpad.loopexit = landingpad { ptr, i32 }
          cleanup
  br label %bb.ah

.loopexit.split-lp:                               ; preds = %bb.am, %bb.aq, %.noexc81, %.noexc83, %.noexc85, %.noexc84, %.noexc82
  %.sroa.13.1.ph = phi ptr [ %.sroa.9110.1, %bb.aq ], [ %.sroa.9110.1, %.noexc81 ], [ %.sroa.9110.1, %.noexc82 ], [ %.sroa.9110.1, %.noexc83 ], [ %.sroa.9110.1, %.noexc84 ], [ %.sroa.9110.1, %.noexc85 ], [ %.sroa.9110.0145, %bb.am ]
  %.sroa.0106.1.ph = phi ptr [ %.sroa.0106.2, %bb.aq ], [ %.sroa.0106.2, %.noexc81 ], [ %.sroa.0106.2, %.noexc82 ], [ %.sroa.0106.2, %.noexc83 ], [ %.sroa.0106.2, %.noexc84 ], [ %.sroa.0106.2, %.noexc85 ], [ %.sroa.0106.0146, %bb.am ]
  %lpad.loopexit.split-lp = landingpad { ptr, i32 }
          cleanup
  br label %bb.ah

bb.ah:                                            ; preds = %.loopexit.split-lp, %.loopexit
  %.sroa.13.1 = phi ptr [ %.sroa.9110.0145, %.loopexit ], [ %.sroa.13.1.ph, %.loopexit.split-lp ]
  %.sroa.0106.1 = phi ptr [ %.sroa.0106.0146, %.loopexit ], [ %.sroa.0106.1.ph, %.loopexit.split-lp ]
  %lpad.phi = phi { ptr, i32 } [ %lpad.loopexit, %.loopexit ], [ %lpad.loopexit.split-lp, %.loopexit.split-lp ]
  store i8 %i.cy, ptr %i.cx, align 8, !tbaa !291
  br label %bb.au

.lr.ph148:                                        ; preds = %_ZN9VNVisitor18iterateAndNextNullEP7AstNode.exit72, %bb.ap
  %storemerge147 = phi ptr [ %i.dt, %bb.ap ], [ %i.da, %_ZN9VNVisitor18iterateAndNextNullEP7AstNode.exit72 ] ; 4 uses
  %.sroa.0106.0146 = phi ptr [ %.sroa.0106.2, %bb.ap ], [ null, %_ZN9VNVisitor18iterateAndNextNullEP7AstNode.exit72 ] ; 8 uses
  %.sroa.9110.0145 = phi ptr [ %.sroa.9110.1, %bb.ap ], [ null, %_ZN9VNVisitor18iterateAndNextNullEP7AstNode.exit72 ] ; 6 uses
  %.sroa.13.0144 = phi ptr [ %.sroa.13.2.a, %bb.ap ], [ null, %_ZN9VNVisitor18iterateAndNextNullEP7AstNode.exit72 ] ; 4 uses
  %i.db = invoke noundef zeroext i1 @_ZN11ForkVisitor7taskifyEP8AstBegin(ptr noundef nonnull align 8 dereferenceable(136) %0, ptr noundef nonnull %storemerge147)
          to label %bb.ai unwind label %.loopexit

bb.ai:                                            ; preds = %.lr.ph148
  br i1 %i.db, label %bb.aj, label %_ZNSt6vectorIP8AstBeginSaIS1_EE9push_backERKS1_.exit

bb.aj:                                            ; preds = %bb.ai
  %.not.i73 = icmp eq ptr %.sroa.13.0144, %.sroa.9110.0145
  br i1 %.not.i73, label %bb.al, label %bb.ak

bb.ak:                                            ; preds = %bb.aj
  store ptr %storemerge147, ptr %.sroa.13.0144, align 8, !tbaa !533
  %i.dc = getelementptr inbounds nuw i8, ptr %.sroa.13.0144, i64 8
  br label %_ZNSt6vectorIP8AstBeginSaIS1_EE9push_backERKS1_.exit

bb.al:                                            ; preds = %bb.aj
  %i.dd = ptrtoint ptr %.sroa.9110.0145 to i64
  %i.de = ptrtoint ptr %.sroa.0106.0146 to i64
...
.noexc76:                                         ; preds = %_ZNKSt6vectorIP8AstBeginSaIS1_EE12_M_check_lenEmPKc.exit.i.i
  ...
  store ptr %storemerge147, ptr %i.do, align 8, !tbaa !533
...
bb.an:                                            ; preds = %.noexc76
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.dn, ptr align 8 %.sroa.0106.0146, i64 %i.df, i1 false)
...
_ZNSt6vectorIP8AstBeginSaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i: ; preds = %bb.an, %.noexc76
  ...
  %.not.i17.i.i = icmp eq ptr %.sroa.0106.0146, null
...
bb.ao:                                            ; preds = %_ZNSt6vectorIP8AstBeginSaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit16.i.i
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0106.0146, i64 noundef %i.df) #24
...
_ZNSt6vectorIP8AstBeginSaIS1_EE9push_backERKS1_.exit: ; preds = %_ZNSt6vectorIP8AstBeginSaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i, %bb.ak, %bb.ai
  %.sroa.13.2.a = phi ptr [ %.sroa.13.0144, %bb.ai ], [ %i.dq, %_ZNSt6vectorIP8AstBeginSaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i ], [ %i.dc, %bb.ak ] ; 3 uses
  %.sroa.9110.1 = phi ptr [ %.sroa.9110.0145, %bb.ai ], [ %i.dr, %_ZNSt6vectorIP8AstBeginSaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i ], [ %.sroa.9110.0145, %bb.ak ] ; 9 uses
  %.sroa.0106.2 = phi ptr [ %.sroa.0106.0146, %bb.ai ], [ %i.dn, %_ZNSt6vectorIP8AstBeginSaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i ], [ %.sroa.0106.0146, %bb.ak ] ; 13 uses
  %i.ds = getelementptr inbounds nuw i8, ptr %storemerge147, i64 8
...
bb.ap:                                            ; preds = %_ZNSt6vectorIP8AstBeginSaIS1_EE9push_backERKS1_.exit
  ...
  br i1 %.not6.i79, label %.lr.ph148, label %bb.aq, !prof !237
...
._crit_edge155:                                   ; preds = %_ZN9VNVisitor18iterateAndNextNullEP7AstNode.exit91, %._crit_edge
  %.not.i.i.i88 = icmp eq ptr %.sroa.0106.2, null
  br i1 %.not.i.i.i88, label %_ZNSt6vectorIP8AstBeginSaIS1_EED2Ev.exit, label %bb.ar

bb.ar:                                            ; preds = %._crit_edge155
  %i.ee = ptrtoint ptr %.sroa.9110.1 to i64
  %i.ef = ptrtoint ptr %.sroa.0106.2 to i64
  %i.eg = sub i64 %i.ee, %i.ef
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0106.2, i64 noundef %i.eg) #24
  br label %_ZNSt6vectorIP8AstBeginSaIS1_EED2Ev.exit

.lr.ph154:                                        ; preds = %._crit_edge, %_ZN9VNVisitor18iterateAndNextNullEP7AstNode.exit91
  %.sroa.098.0152 = phi ptr [ %i.ei, %_ZN9VNVisitor18iterateAndNextNullEP7AstNode.exit91 ], [ %.sroa.0106.2, %._crit_edge ] ; 2 uses
  %i.eh = load ptr, ptr %.sroa.098.0152, align 8, !tbaa !533 ; 2 uses
  %.not.i89 = icmp eq ptr %i.eh, null
  br i1 %.not.i89, label %_ZN9VNVisitor18iterateAndNextNullEP7AstNode.exit91, label %bb.as, !prof !9

bb.as:                                            ; preds = %.lr.ph154
...
_ZN9VNVisitor18iterateAndNextNullEP7AstNode.exit91: ; preds = %.lr.ph154, %bb.as
  %i.ei = getelementptr inbounds nuw i8, ptr %.sroa.098.0152, i64 8 ; 2 uses
  %.not116 = icmp eq ptr %i.ei, %.sroa.13.2.a
  br i1 %.not116, label %._crit_edge155, label %.lr.ph154
...
_ZNSt6vectorIP8AstBeginSaIS1_EED2Ev.exit:         ; preds = %._crit_edge155.thread, %bb.ar, %._crit_edge155, %bb.b
  ret void

bb.au:                                            ; preds = %bb.at, %bb.ah
  %.sroa.13.3 = phi ptr [ %.sroa.9110.1, %bb.at ], [ %.sroa.13.1, %bb.ah ]
...
.lr.ph.i.i:                                       ; preds = %bb.h, %bb.n
  %.029.i.i = phi i32 [ %i.ax, %bb.n ], [ 1, %bb.h ] ; 4 uses
  %.02328.i.i = phi i64 [ %i.aw, %bb.n ], [ %i.an, %bb.h ] ; 5 uses
  %i.aq = icmp ult i64 %.02328.i.i, 100
  br i1 %i.aq, label %bb.i, label %bb.j

bb.i:                                             ; preds = %.lr.ph.i.i
  %i.ar = add i32 %.029.i.i, 1
  br label %_ZNSt8__detail14__to_chars_lenImEEjT_i.exit.i

bb.j:                                             ; preds = %.lr.ph.i.i
  %i.as = icmp ult i64 %.02328.i.i, 1000
  br i1 %i.as, label %bb.k, label %bb.l

bb.k:                                             ; preds = %bb.j
  %i.at = add i32 %.029.i.i, 2
  br label %_ZNSt8__detail14__to_chars_lenImEEjT_i.exit.i

bb.l:                                             ; preds = %bb.j
  %i.au = icmp ult i64 %.02328.i.i, 10000
  br i1 %i.au, label %bb.m, label %bb.n

bb.m:                                             ; preds = %bb.l
  %i.av = add i32 %.029.i.i, 3
  br label %_ZNSt8__detail14__to_chars_lenImEEjT_i.exit.i

bb.n:                                             ; preds = %bb.l
  %i.aw = udiv i64 %.02328.i.i, 10000
  %i.ax = add i32 %.029.i.i, 4                    ; 2 uses
  %i.ay = icmp ult i64 %.02328.i.i, 100000
...
_ZNSt8__detail14__to_chars_lenImEEjT_i.exit.i:    ; preds = %bb.n, %bb.m, %bb.k, %bb.i, %bb.h
  %.0.i.i = phi i32 [ %i.av, %bb.m ], [ %i.ar, %bb.i ], [ %i.at, %bb.k ], [ 1, %bb.h ], [ %i.ax, %bb.n ]
  %i.az = zext i32 %.0.i.i to i64
