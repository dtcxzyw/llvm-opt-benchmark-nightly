Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/openssl/original/curve448?download=true
...
begin_hunk_0_@ossl_curve448_point_mul_by_ratio_and_encode_like_x448:bb.a
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(256) %4, ptr noundef nonnull readonly align 16 dereferenceable(256) %1, i64 256, i1 false), !tbaa.struct !14
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(64) %i.a, ptr noundef nonnull align 16 dereferenceable(64) %3, i64 64, i1 false), !tbaa.struct !13
...
define void @ossl_x448_derive_public_key(ptr noundef %0, ptr nofree noundef readonly captures(none) %1) local_unnamed_addr #0 {
bb.a:
  %2 = alloca [1 x %struct.gf_s], align 16        ; 6 uses
  %3 = alloca [1 x %struct.gf_s], align 16        ; 6 uses
  %4 = alloca [1 x %struct.curve448_point_s], align 16 ; 9 uses
  ...
  %i.b = load i8, ptr %i.a, align 16, !tbaa !10
  %i.c = and i8 %i.b, -4
  store i8 %i.c, ptr %i.a, align 16, !tbaa !10
  %i.d = getelementptr inbounds nuw i8, ptr %i.a, i64 55 ; 2 uses
  %i.e = load i8, ptr %i.d, align 1, !tbaa !10
  %i.f = or i8 %i.e, -128
  store i8 %i.f, ptr %i.d, align 1, !tbaa !10
  ...
  %i.g = load ptr, ptr @ossl_curve448_precomputed_base, align 8, !tbaa !40
  call void @ossl_curve448_precomputed_scalarmul(ptr noundef nonnull %6, ptr noundef %i.g, ptr noundef nonnull %5)
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #6
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(256) %4, ptr noundef nonnull readonly align 16 dereferenceable(256) %6, i64 256, i1 false), !tbaa.struct !14
  ...
  call void @ossl_gf_sqr(ptr noundef nonnull %2, ptr noundef nonnull %3) #6
  call void @ossl_gf_mul(ptr noundef nonnull %3, ptr noundef nonnull %2, ptr noundef nonnull %4) #6
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(64) %i.h, ptr noundef nonnull align 16 dereferenceable(64) %3, i64 64, i1 false), !tbaa.struct !13
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #6
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #6
...
; Function Attrs: nounwind uwtable
define void @ossl_curve448_base_double_scalarmul_non_secret(ptr noundef %0, ptr nofree noundef readonly captures(none) %1, ptr noundef %2, ptr nofree noundef readonly captures(none) %3) local_unnamed_addr #0 {
bb.a:
  ...
  store i32 -1, ptr %i.c, align 16, !tbaa !51
...
bb.e:                                             ; preds = %bb.e, %.lr.ph.i
  ...
  store i32 %spec.select.i, ptr %i.ae, align 4, !tbaa !52
  %indvars.iv.next.i = add nsw i64 %indvars.iv.i, -1 ; 2 uses
  %i.af = and i64 %i.ab, 65535
  %.not.i = icmp eq i64 %i.af, 0
  br i1 %.not.i, label %._crit_edge.loopexit.i, label %bb.e, !llvm.loop !41
...
._crit_edge.i:                                    ; preds = %._crit_edge.loopexit.i, %bb.d
  ...
  br i1 %exitcond.not.i, label %bb.f, label %bb.b, !llvm.loop !42
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load107 = load <2 x i64>, ptr %i.aw, align 8, !tbaa !53
  %i.ax = getelementptr inbounds nuw i8, ptr %i.ar, i64 16
  store <2 x i64> %wide.load, ptr %i.ar, align 16, !tbaa !53
  store <2 x i64> %wide.load107, ptr %i.ax, align 16, !tbaa !53
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ay = icmp eq i64 %index.next, %n.vec
  br i1 %i.ay, label %middle.block, label %vector.body, !llvm.loop !43
...
.lr.ph65.i.prol:                                  ; preds = %.lr.ph65.i.preheader, %.lr.ph65.i.prol
  ...
  store i64 %i.be, ptr %i.az, align 8, !tbaa !53
  %indvars.iv.next71.i.prol = add nuw nsw i64 %indvars.iv70.i.prol, 1 ; 2 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph65.i.prol.loopexit, label %.lr.ph65.i.prol, !llvm.loop !44
...
.lr.ph65.i:                                       ; preds = %.lr.ph65.i.prol.loopexit, %.lr.ph65.i
  ...
  store i64 %i.bm, ptr %i.bh, align 8, !tbaa !53
  ...
  store i64 %i.bs, ptr %i.bn, align 8, !tbaa !53
  ...
  store i64 %i.by, ptr %i.bt, align 8, !tbaa !53
  ...
  store i64 %i.ce, ptr %i.bz, align 8, !tbaa !53
  ...
  br i1 %exitcond73.not.i.3, label %recode_wnaf.exit, label %.lr.ph65.i, !llvm.loop !45

recode_wnaf.exit:                                 ; preds = %.lr.ph65.i.prol.loopexit, %.lr.ph65.i, %middle.block, %bb.f
  %i.cf = load i64, ptr %3, align 8, !tbaa !9
  ...
  store i32 0, ptr %i.ci, align 4, !tbaa !52
  br label %bb.g
...
bb.j:                                             ; preds = %bb.j, %.lr.ph.i69
  ...
  store i32 %i.dh, ptr %i.di, align 8, !tbaa !51
  %i.dj = getelementptr inbounds nuw i8, ptr %i.di, i64 4
  store i32 %spec.select.i73, ptr %i.dj, align 4, !tbaa !52
  %indvars.iv.next.i74 = add nsw i64 %indvars.iv.i70, -1 ; 2 uses
  %i.dk = and i64 %i.dg, 65535
  %.not.i75 = icmp eq i64 %i.dk, 0
  br i1 %.not.i75, label %._crit_edge.loopexit.i76, label %bb.j, !llvm.loop !41
...
._crit_edge.i77:                                  ; preds = %._crit_edge.loopexit.i76, %bb.i
  ...
  br i1 %exitcond.not.i80, label %bb.k, label %bb.g, !llvm.loop !42
...
vector.body113:                                   ; preds = %vector.body113, %vector.ph111
  ...
  %wide.load115 = load <2 x i64>, ptr %i.ea, align 8, !tbaa !53
  %wide.load116 = load <2 x i64>, ptr %i.eb, align 8, !tbaa !53
  %i.ec = getelementptr inbounds nuw i8, ptr %i.dw, i64 16
  store <2 x i64> %wide.load115, ptr %i.dw, align 16, !tbaa !53
  store <2 x i64> %wide.load116, ptr %i.ec, align 16, !tbaa !53
  %index.next117 = add nuw i64 %index114, 4       ; 2 uses
  %i.ed = icmp eq i64 %index.next117, %n.vec112
  br i1 %i.ed, label %middle.block118, label %vector.body113, !llvm.loop !46
...
.lr.ph65.i84.prol:                                ; preds = %.lr.ph65.i84.preheader, %.lr.ph65.i84.prol
  ...
  store i64 %i.ej, ptr %i.ee, align 8, !tbaa !53
  ...
  br i1 %prol.iter124.cmp.not, label %.lr.ph65.i84.prol.loopexit, label %.lr.ph65.i84.prol, !llvm.loop !47
...
.lr.ph65.i84:                                     ; preds = %.lr.ph65.i84.prol.loopexit, %.lr.ph65.i84
  ...
  %i.er = load i64, ptr %i.eq, align 8, !tbaa !53
  store i64 %i.er, ptr %i.em, align 8, !tbaa !53
  ...
  store i64 %i.ex, ptr %i.es, align 8, !tbaa !53
  ...
  %i.fd = load i64, ptr %i.fc, align 8, !tbaa !53
  store i64 %i.fd, ptr %i.ey, align 8, !tbaa !53
  ...
  %i.fj = load i64, ptr %i.fi, align 8, !tbaa !53
  store i64 %i.fj, ptr %i.fe, align 8, !tbaa !53
  ...
  br i1 %exitcond73.not.i87.3, label %recode_wnaf.exit88, label %.lr.ph65.i84, !llvm.loop !48
...
recode_wnaf.exit88:                               ; preds = %.lr.ph65.i84.prol.loopexit, %.lr.ph65.i84, %middle.block118, %bb.k
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(64) %i.fv, ptr noundef nonnull align 16 dereferenceable(64) %9, i64 64, i1 false), !tbaa.struct !13
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(64) %i.fv, ptr noundef nonnull align 16 dereferenceable(64) %8, i64 64, i1 false), !tbaa.struct !13
  ...
  %i.gy = load i32, ptr %12, align 16, !tbaa !51  ; 6 uses
  %i.gz = icmp slt i32 %i.gy, 0
  br i1 %i.gz, label %bb.l, label %bb.m

bb.l:                                             ; preds = %recode_wnaf.exit88
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(256) %0, ptr noundef nonnull align 16 dereferenceable(256) @ossl_curve448_point_identity, i64 256, i1 false), !tbaa.struct !14
  br label %bb.ad

bb.m:                                             ; preds = %recode_wnaf.exit88
  %i.ha = load i32, ptr %13, align 16, !tbaa !51  ; 3 uses
...
bb.p:                                             ; preds = %bb.o
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #6
  %i.hx = load ptr, ptr @ossl_curve448_wnaf_base, align 8, !tbaa !57
...
bb.q:                                             ; preds = %bb.o
  %i.id = load ptr, ptr @ossl_curve448_wnaf_base, align 8, !tbaa !57
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(64) %i.il, ptr noundef nonnull align 16 dereferenceable(64) @ONE, i64 64, i1 false), !tbaa.struct !13
  br label %bb.r
...
bb.t:                                             ; preds = %bb.s
  ...
  %i.iy = load i32, ptr %i.ix, align 4, !tbaa !52 ; 3 uses
...
bb.u:                                             ; preds = %bb.t
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(64) %i.im, ptr noundef nonnull align 16 dereferenceable(64) %5, i64 64, i1 false), !tbaa.struct !13
...
bb.v:                                             ; preds = %bb.t
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(64) %i.im, ptr noundef nonnull align 16 dereferenceable(64) %4, i64 64, i1 false), !tbaa.struct !13
...
bb.y:                                             ; preds = %bb.x
  ...
  %i.jl = load i32, ptr %i.jk, align 4, !tbaa !52 ; 3 uses
  %i.jm = icmp sgt i32 %i.jl, 0
  %i.jn = load ptr, ptr @ossl_curve448_wnaf_base, align 8, !tbaa !57 ; 2 uses
...
bb.ac:                                            ; preds = %bb.ab, %bb.x
  ...
  br i1 %i.jw, label %bb.s, label %._crit_edge, !llvm.loop !49
...
gf_add_RAW.exit26:
  ...
  %i.y = load <4 x i64>, ptr %i.a, align 8, !tbaa !9
  %i.z = load <4 x i64>, ptr %0, align 8, !tbaa !9
  %i.aa = add <4 x i64> %i.y, splat (i64 144115188075855870)
  %i.ab = sub <4 x i64> %i.aa, %i.z               ; 3 uses
  %i.ac = add i64 %i.u, 144115188075855870
  %i.ad = load <2 x i64>, ptr %i.o, align 8, !tbaa !9
  %i.ae = load <2 x i64>, ptr %i.p, align 8, !tbaa !9
  ...
  %i.bh = load <4 x i64>, ptr %0, align 8, !tbaa !9
  %i.bi = load <4 x i64>, ptr %i.a, align 8, !tbaa !9
  %i.bj = add <4 x i64> %i.bi, %i.bh              ; 3 uses
  %i.bk = shufflevector <4 x i64> %i.bj, <4 x i64> poison, <4 x i32> <i32 poison, i32 0, i32 1, i32 2>
  %i.bl = load <2 x i64>, ptr %i.j, align 8, !tbaa !9
  %i.bm = load <2 x i64>, ptr %i.bd, align 8, !tbaa !9
  %i.bn = add <2 x i64> %i.bm, %i.bl
  %i.bo = load <2 x i64>, ptr %i.bf, align 8, !tbaa !9
  %i.bp = load <2 x i64>, ptr %i.r, align 8, !tbaa !9
  ...
  store <2 x i64> %i.cb, ptr %i.s, align 16, !tbaa !9
  ...
  %i.cl = load i64, ptr %3, align 16, !tbaa !9    ; 2 uses
  %i.cm = load i64, ptr %i.a, align 8, !tbaa !9   ; 2 uses
  %i.cn = add i64 %i.cm, %i.cl                    ; 2 uses
  %i.co = getelementptr inbounds nuw i8, ptr %3, i64 8 ; 2 uses
  %i.cp = load i64, ptr %i.co, align 8, !tbaa !9  ; 2 uses
  %i.cq = load i64, ptr %i.ba, align 8, !tbaa !9  ; 2 uses
  ...
  %i.cu = load i64, ptr %i.ct, align 16, !tbaa !9 ; 2 uses
  %i.cv = load i64, ptr %i.bb, align 8, !tbaa !9  ; 2 uses
  ...
  %i.cz = load i64, ptr %i.cy, align 8, !tbaa !9  ; 2 uses
  %i.da = load i64, ptr %i.bc, align 8, !tbaa !9  ; 2 uses
  ...
  %i.de = load i64, ptr %i.dd, align 16, !tbaa !9 ; 2 uses
  %i.df = load i64, ptr %i.bd, align 8, !tbaa !9  ; 2 uses
  ...
  %i.dj = load i64, ptr %i.di, align 8, !tbaa !9  ; 2 uses
  %i.dk = load i64, ptr %i.be, align 8, !tbaa !9  ; 2 uses
  ...
  %i.do = load i64, ptr %i.dn, align 16, !tbaa !9 ; 2 uses
  %i.dp = load i64, ptr %i.bf, align 8, !tbaa !9  ; 2 uses
  ...
  %i.du = load i64, ptr %i.bg, align 8, !tbaa !9  ; 2 uses
...
begin_hunk_1_@sub_niels_from_pt:gf_add_RAW.exit26
  %i.gz = load i64, ptr %i.f, align 8, !tbaa !9   ; 2 uses
  %i.ha = add i64 %i.gz, %i.gy                    ; 2 uses
  %i.hb = getelementptr inbounds nuw i8, ptr %0, i64 160
  %i.hc = load i64, ptr %i.hb, align 8, !tbaa !9  ; 2 uses
  %i.hd = load i64, ptr %i.j, align 8, !tbaa !9   ; 2 uses
  %i.he = add i64 %i.hd, %i.hc
  %i.hf = getelementptr inbounds nuw i8, ptr %0, i64 168
  %i.hg = load i64, ptr %i.hf, align 8, !tbaa !9  ; 2 uses
  %i.hh = load i64, ptr %i.p, align 8, !tbaa !9   ; 2 uses
  %i.hi = add i64 %i.hh, %i.hg                    ; 2 uses
  %i.hj = getelementptr inbounds nuw i8, ptr %0, i64 176
  %i.hk = load i64, ptr %i.hj, align 8, !tbaa !9  ; 2 uses
  %i.hl = load i64, ptr %i.r, align 8, !tbaa !9   ; 2 uses
  %i.hm = add i64 %i.hl, %i.hk                    ; 2 uses
  %i.hn = getelementptr inbounds nuw i8, ptr %0, i64 184
  %i.ho = load i64, ptr %i.hn, align 8, !tbaa !9  ; 2 uses
  %i.hp = load i64, ptr %i.v, align 8, !tbaa !9   ; 2 uses
...
; Function Attrs: nounwind uwtable
define range(i32 0, 2) i32 @ossl_x448(ptr noundef %0, ptr nofree noundef readonly captures(none) %1, ptr noundef %2) local_unnamed_addr #0 {
bb.a:
...
; Function Attrs: nounwind uwtable
define void @ossl_x448_public_from_private(ptr noundef %0, ptr nofree noundef readonly captures(none) %1) local_unnamed_addr #0 {
bb.a:
...
!12 = !{i64 821461}
!13 = !{i64 0, i64 64, !10}
!14 = !{i64 0, i64 64, !10, i64 64, i64 64, !10, i64 128, i64 64, !10, i64 192, i64 64, !10}
!15 = !{!"any pointer", !4, i64 0}
!16 = distinct !{!16, !"constant_time_lookup_niels"}
!17 = distinct !{!17, !16, !"constant_time_lookup_niels: argument 0"}
!18 = distinct !{!18, !11}
!19 = distinct !{!19, !"gf_cond_swap"}
!20 = distinct !{!20, !19, !"gf_cond_swap: argument 0"}
!21 = distinct !{!21, !11}
!22 = distinct !{!22, !11}
!23 = !{!17}
!24 = !{i64 820939}
!25 = !{!20}
!26 = distinct !{!26, !"gf_cond_swap"}
!27 = distinct !{!27, !26, !"gf_cond_swap: argument 0"}
!28 = distinct !{!28, !"gf_cond_swap"}
!29 = distinct !{!29, !28, !"gf_cond_swap: argument 0"}
!30 = distinct !{!30, !11}
!31 = distinct !{!31, !"gf_cond_swap"}
!32 = distinct !{!32, !31, !"gf_cond_swap: argument 0"}
...
!37 = !{!32}
!38 = !{!34}
!39 = !{!"p1 _ZTS22curve448_precomputed_s", !15, i64 0}
!40 = !{!39, !39, i64 0}
!41 = distinct !{!41, !11}
!42 = distinct !{!42, !11}
!43 = distinct !{!43, !11, !54, !55}
!44 = distinct !{!44, !56}
!45 = distinct !{!45, !11, !54}
!46 = distinct !{!46, !11, !54, !55}
!47 = distinct !{!47, !56}
!48 = distinct !{!48, !11, !54}
!49 = distinct !{!49, !11}
!50 = !{!"smvt_control", !5, i64 0, !5, i64 4}
!51 = !{!50, !5, i64 0}
!52 = !{!50, !5, i64 4}
!53 = !{!5, !5, i64 0}
