...
bb.p:                                             ; preds = %bb.o
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #6
  %i.hx = load ptr, ptr @ossl_curve448_wnaf_base, align 8, !tbaa !56
...
bb.q:                                             ; preds = %bb.o
  %i.id = load ptr, ptr @ossl_curve448_wnaf_base, align 8, !tbaa !56
...
bb.y:                                             ; preds = %bb.x
  ...
  %i.jn = load ptr, ptr @ossl_curve448_wnaf_base, align 8, !tbaa !56 ; 2 uses
...
!41 = distinct !{!41, !11}
!42 = distinct !{!42, !11}
!43 = distinct !{!43, !11, !53, !54}
!44 = distinct !{!44, !55}
!45 = distinct !{!45, !11, !53}
!46 = distinct !{!46, !11, !53, !54}
!47 = distinct !{!47, !55}
!48 = distinct !{!48, !11, !53}
!49 = distinct !{!49, !11}
