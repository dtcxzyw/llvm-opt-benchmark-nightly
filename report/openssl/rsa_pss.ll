...
bb.o:                                             ; preds = %bb.m
  %i.ae = xor i32 %i.f, -1
  %i.af = add nsw i32 %.083, %i.ae                ; 8 uses
  %6 = sext i32 %i.af to i64                      ; 3 uses
  %i.ag = getelementptr inbounds i8, ptr %.090, i64 %6 ; 2 uses
...
vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n137 = icmp eq i64 %n.vec132, %wide.trip.count
...
bb.r:                                             ; preds = %bb.q, %bb.o
  ...
  %i.ag = getelementptr inbounds i8, ptr %.089, i64 %6 ; 2 uses
