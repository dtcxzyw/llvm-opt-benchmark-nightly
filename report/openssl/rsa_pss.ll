Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/openssl/original/rsa_pss?download=true
inline.NumInlined: 2
begin_hunk_0
...
bb.f:                                             ; preds = %bb.c, %bb.d
  %.084 = phi i32 [ %i.b, %bb.d ], [ %i.f, %bb.c ] ; 3 uses
...
bb.h:                                             ; preds = %bb.f
  ...
  %.090.idx = zext i1 %i.t to i64
  %.090 = getelementptr inbounds nuw i8, ptr %4, i64 %.090.idx ; 5 uses
  %i.u = sext i1 %i.t to i32
  %.083 = add nsw i32 %i.o, %i.u                  ; 4 uses
  %i.v = add nuw nsw i32 %i.f, 2
  %i.w = icmp slt i32 %.083, %i.v
...
bb.j:                                             ; preds = %bb.h
  %i.x = icmp eq i32 %.084, -3
  %reass.sub113 = sub nsw i32 %.083, %i.f
  %i.y = add nsw i32 %reass.sub113, -2            ; 2 uses
  br i1 %i.x, label %bb.m, label %bb.k

bb.k:                                             ; preds = %bb.j
  %i.z = icmp sgt i32 %.084, %i.y
...
bb.m:                                             ; preds = %bb.j, %bb.k
  %.1 = phi i32 [ %.084, %bb.k ], [ %i.y, %bb.j ] ; 3 uses
  %i.aa = zext nneg i32 %.083 to i64
  %i.ab = getelementptr i8, ptr %.090, i64 %i.aa
...
bb.o:                                             ; preds = %bb.m
  %i.ae = xor i32 %i.f, -1
  %i.af = add nsw i32 %.083, %i.ae                ; 7 uses
  %6 = zext i32 %i.af to i64                      ; 9 uses
  %i.ag = getelementptr inbounds nuw i8, ptr %.090, i64 %6 ; 2 uses
...
vector.main.loop.iter.check:                      ; preds = %iter.check
  %min.iters.check128 = icmp ult i32 %i.af, 32
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ao = getelementptr inbounds nuw i8, ptr %.090, i64 %index ; 2 uses
  %i.ap = getelementptr inbounds nuw i8, ptr %i.ao, i64 16
  %wide.load = load <16 x i8>, ptr %i.ao, align 1, !tbaa !23
  %wide.load129.a = load <16 x i8>, ptr %i.ap, align 1, !tbaa !23
  %i.aq = getelementptr inbounds nuw i8, ptr %i.ah, i64 %index ; 3 uses
  %i.ar = getelementptr inbounds nuw i8, ptr %i.aq, i64 16 ; 2 uses
  %wide.load130.a = load <16 x i8>, ptr %i.aq, align 1, !tbaa !23
  %wide.load131 = load <16 x i8>, ptr %i.ar, align 1, !tbaa !23
  %i.as = xor <16 x i8> %wide.load130.a, %wide.load
  %i.at = xor <16 x i8> %wide.load131, %wide.load129.a
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec132 = and i64 %6, 2147483644              ; 3 uses
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index133 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next136, %vec.epilog.vector.body ] ; 3 uses
  %i.av = getelementptr inbounds nuw i8, ptr %.090, i64 %index133
  %wide.load134.a = load <4 x i8>, ptr %i.av, align 1, !tbaa !23
  %i.aw = getelementptr inbounds nuw i8, ptr %i.ah, i64 %index133 ; 2 uses
  %wide.load135 = load <4 x i8>, ptr %i.aw, align 1, !tbaa !23
  %i.ax = xor <4 x i8> %wide.load135, %wide.load134.a
  store <4 x i8> %i.ax, ptr %i.aw, align 1, !tbaa !23
  %index.next136 = add nuw i64 %index133, 4       ; 2 uses
  %i.ay = icmp eq i64 %index.next136, %n.vec132
  br i1 %i.ay, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !29

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n137 = icmp eq i64 %n.vec132, %6
  br i1 %cmp.n137, label %._crit_edge, label %.lr.ph.preheader

.lr.ph.preheader:                                 ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv.ph = phi i64 [ 0, %iter.check ], [ %n.vec, %vec.epilog.iter.check ], [ %n.vec132, %vec.epilog.middle.block ]
  br label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  %indvars.iv = phi i64 [ %indvars.iv.next, %.lr.ph ], [ %indvars.iv.ph, %.lr.ph.preheader ] ; 3 uses
  %i.az = getelementptr inbounds nuw i8, ptr %.090, i64 %indvars.iv
...
bb.w:                                             ; preds = %bb.v
  ...
  tail call void (i32, i32, ptr, ...) @ERR_set_error(i32 noundef 4, i32 noundef 136, ptr noundef nonnull @.str.1, i32 noundef %.1, i32 noundef %.pre) #9
  br label %bb.af
...
bb.af:                                            ; preds = %bb.ab, %bb.aa, %._crit_edge118, %bb.x, %bb.y, %bb.p, %bb.o, %bb.b, %bb.a, %bb.ae, %bb.w, %bb.u, %bb.n, %bb.l, %bb.i, %bb.g, %bb.e
  %.186 = phi i32 [ 0, %bb.a ], [ 0, %bb.b ], [ 0, %bb.g ], [ 0, %bb.i ], [ 0, %bb.n ], [ 0, %bb.o ], [ 0, %bb.p ], [ 0, %bb.u ], [ 0, %bb.w ], [ %.085, %bb.ae ], [ 0, %bb.ab ], [ 0, %bb.aa ], [ 0, %bb.y ], [ 0, %bb.x ], [ 0, %._crit_edge118 ], [ 0, %bb.l ], [ 0, %bb.e ]
  %.0 = phi ptr [ null, %bb.a ], [ null, %bb.b ], [ null, %bb.g ], [ null, %bb.i ], [ null, %bb.n ], [ null, %bb.o ], [ %i.ah, %bb.p ], [ %i.ah, %bb.u ], [ %i.ah, %bb.w ], [ %i.ah, %bb.ae ], [ %i.ah, %bb.ab ], [ %i.ah, %bb.aa ], [ %i.ah, %bb.y ], [ %i.ah, %bb.x ], [ %i.ah, %._crit_edge118 ], [ null, %bb.l ], [ null, %bb.e ]
  call void @CRYPTO_free(ptr noundef %.0, ptr noundef nonnull @.str, i32 noundef 152) #9
...
bb.g:                                             ; preds = %bb.b, %bb.c, %bb.e, %bb.d
  %.085 = phi i32 [ %i.a, %bb.e ], [ -3, %bb.c ], [ -3, %bb.d ], [ %i.c, %bb.b ] ; 5 uses
...
bb.i:                                             ; preds = %bb.h, %bb.g
  %.089 = phi ptr [ %i.m, %bb.h ], [ %1, %bb.g ]  ; 6 uses
  %.084 = phi i32 [ %i.n, %bb.h ], [ %i.k, %bb.g ] ; 5 uses
  %i.o = add nuw nsw i32 %i.c, 2
  %i.p = icmp slt i32 %.084, %i.o
...
bb.k:                                             ; preds = %bb.i
  %i.q = icmp eq i32 %.085, -3
  %i.r = sub nsw i32 %.084, %i.c
...
bb.o:                                             ; preds = %bb.l, %bb.m
  %.186 = phi i32 [ %spec.select107, %bb.l ], [ %.085, %bb.m ] ; 19 uses
  %i.w = icmp sgt i32 %.186, 0                    ; 2 uses
  br i1 %i.w, label %bb.p, label %bb.r

bb.p:                                             ; preds = %bb.o
  %i.x = zext nneg i32 %.186 to i64               ; 2 uses
...
bb.r:                                             ; preds = %bb.q, %bb.o
  ...
  %i.ae = xor i32 %i.c, -1
  %i.af = add nsw i32 %.084, %i.ae
  %6 = zext nneg i32 %i.af to i64                 ; 2 uses
  %i.ag = getelementptr inbounds nuw i8, ptr %.089, i64 %6 ; 2 uses
...
bb.y:                                             ; preds = %bb.x
  %i.aq = tail call i32 @PKCS1_MGF1(ptr noundef %.089, i64 noundef %6, ptr noundef %i.ag, i64 noundef %i.al, ptr noundef %spec.select) #9
  %.not105 = icmp eq i32 %i.aq, 0
  br i1 %.not105, label %bb.z, label %bb.ac

bb.z:                                             ; preds = %bb.y
  %i.ar = add i32 %i.c, %.186
  %i.as = sub i32 %.084, %i.ar
  %i.at = sext i32 %i.as to i64
  %i.au = getelementptr i8, ptr %.089, i64 %i.at  ; 2 uses
...
iter.check:                                       ; preds = %bb.z
  ...
  %wide.trip.count = zext nneg i32 %.186 to i64   ; 6 uses
  %min.iters.check = icmp ult i32 %.186, 4
  br i1 %min.iters.check, label %vec.epilog.scalar.ph.preheader, label %vector.main.loop.iter.check

vector.main.loop.iter.check:                      ; preds = %iter.check
  %min.iters.check118 = icmp ult i32 %.186, 32
...
bb.aa:                                            ; preds = %.loopexit
  ...
  %i.bs = load i8, ptr %.089, align 1, !tbaa !23
  %i.bt = trunc nuw nsw i32 %i.br to i8
  %i.bu = and i8 %i.bs, %i.bt
  store i8 %i.bu, ptr %.089, align 1, !tbaa !23
  br label %bb.ab

bb.ab:                                            ; preds = %bb.aa, %.loopexit
  %i.bv = zext nneg i32 %.084 to i64
  %i.bw = getelementptr i8, ptr %.089, i64 %i.bv
...
bb.ac:                                            ; preds = %bb.y, %bb.x, %bb.w, %bb.s, %bb.t, %bb.u, %bb.r, %bb.q, %bb.p, %bb.a, %bb.ab, %bb.n, %bb.j, %bb.f
  %.087 = phi i32 [ 0, %bb.a ], [ 0, %bb.j ], [ 0, %bb.p ], [ 0, %bb.q ], [ 0, %bb.r ], [ 0, %bb.y ], [ 1, %bb.ab ], [ 0, %bb.x ], [ 0, %bb.w ], [ 0, %bb.u ], [ 0, %bb.t ], [ 0, %bb.s ], [ 0, %bb.n ], [ 0, %bb.f ]
  %.2 = phi i32 [ %i.a, %bb.a ], [ %.085, %bb.j ], [ %.186, %bb.p ], [ %.186, %bb.q ], [ %.186, %bb.r ], [ %.186, %bb.y ], [ %.186, %bb.ab ], [ %.186, %bb.x ], [ %.186, %bb.w ], [ %.186, %bb.u ], [ %.186, %bb.t ], [ %.186, %bb.s ], [ %.085, %bb.n ], [ %i.a, %bb.f ]
