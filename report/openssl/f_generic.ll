...
bb.a:
  ...
  %i.ac = sub <2 x i64> %i.z, %i.x                ; 3 uses
  %3 = sub <2 x i64> %i.ab, %i.aa                 ; 2 uses
  %4 = extractelement <2 x i64> %3, i64 1
  %5 = lshr i64 %4, 56                            ; 2 uses
  %i.ad = add i64 %5, %i.o                        ; 2 uses
  %i.ae = and <2 x i64> %3, splat (i64 72057594037927935)
  %i.af = lshr <2 x i64> %i.ac, splat (i64 56)
  %i.ag = and <2 x i64> %i.ac, splat (i64 72057594037927935)
  %i.ah = shufflevector <2 x i64> %i.ac, <2 x i64> poison, <2 x i32> <i32 poison, i32 0>
  ...
  %i.bp = add nuw nsw i64 %5, %i.bo               ; 2 uses
