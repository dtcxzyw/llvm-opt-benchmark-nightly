...
.loopexit:                                        ; preds = %.lr.ph84, %middle.block118, %vec.epilog.middle.block132, %._crit_edge, %bb.l, %bb.k, %bb.j, %bb.i
  %.070 = phi i32 [ 0, %bb.j ], [ 0, %bb.k ], [ 0, %bb.l ], [ 0, %._crit_edge ], [ 0, %bb.i ], [ 1, %middle.block118 ], [ 1, %vec.epilog.middle.block132 ], [ 1, %.lr.ph84 ]
  %.067 = phi ptr [ null, %bb.j ], [ null, %bb.k ], [ %i.am, %bb.l ], [ %i.am, %._crit_edge ], [ null, %bb.i ], [ %i.am, %middle.block118 ], [ %i.am, %vec.epilog.middle.block132 ], [ %i.am, %.lr.ph84 ]
  ...
  call void @CRYPTO_clear_free(ptr noundef %.067, i64 noundef %i.cb, ptr noundef nonnull @.str, i32 noundef 147) #6
  br label %bb.m

bb.m:                                             ; preds = %.loopexit, %bb.h, %bb.f, %bb.d
  %.066 = phi i32 [ 0, %bb.d ], [ 0, %bb.f ], [ 0, %bb.h ], [ %.070, %.loopexit ]
...
bb.f:                                             ; preds = %bb.e
  %i.v = add nuw nsw i64 %.03242, %i.k            ; 3 uses
  %.not39 = icmp sgt i64 %i.v, %1
  br i1 %.not39, label %bb.h, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.w = getelementptr inbounds nuw i8, ptr %0, i64 %.03242
...
.thread:                                          ; preds = %bb.h
  %i.z = getelementptr inbounds nuw i8, ptr %0, i64 %.03242
  %i.aa = sub nsw i64 %1, %.03242
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %i.z, ptr nonnull align 16 %i.b, i64 %i.aa, i1 false)
  br label %.loopexit

bb.i:                                             ; preds = %bb.g
  %i.ab = add nuw nsw i64 %.03143, 1
...
bb.c:                                             ; preds = %bb.b, %bb.a
  %.0142 = phi ptr [ %i.d, %bb.b ], [ %7, %bb.a ] ; 3 uses
  %i.e = icmp eq ptr %8, null
  %spec.select = select i1 %i.e, ptr %.0142, ptr %8 ; 2 uses
  %i.f = tail call i32 @EVP_MD_get_size(ptr noundef %.0142) #6 ; 10 uses
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  %.0139179 = phi ptr [ %i.v, %.lr.ph.preheader.new ], [ %i.af, %.lr.ph ]
  %.0140178 = phi ptr [ %i.t, %.lr.ph.preheader.new ], [ %i.ai, %.lr.ph ] ; 3 uses
  %.0141177 = phi i32 [ %3, %.lr.ph.preheader.new ], [ %i.ae, %.lr.ph ] ; 2 uses
  %niter = phi i32 [ 0, %.lr.ph.preheader.new ], [ %niter.next.1, %.lr.ph ]
  %i.x = icmp ne i32 %.0141177, 0                 ; 3 uses
  %.neg172 = sext i1 %i.x to i32
  %i.y = add i32 %.0141177, %.neg172              ; 2 uses
  %.neg173 = sext i1 %i.x to i64
  %i.z = getelementptr inbounds i8, ptr %.0139179, i64 %.neg173 ; 2 uses
  %i.aa = load i8, ptr %i.z, align 1, !tbaa !8
  %i.ab = select i1 %i.x, i8 %i.aa, i8 0
  %i.ac = getelementptr inbounds i8, ptr %.0140178, i64 -1
  ...
  %i.ai = getelementptr inbounds i8, ptr %.0140178, i64 -2 ; 4 uses
...
._crit_edge.unr-lcssa:                            ; preds = %.lr.ph
  %i.aj = getelementptr inbounds i8, ptr %.0140178, i64 -1
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  br i1 %lcmp.mod.not, label %._crit_edge, label %.lr.ph.epil.preheader

.lr.ph.epil.preheader:                            ; preds = %._crit_edge.unr-lcssa, %.lr.ph.preheader
  %.0139179.epil.init = phi ptr [ %i.v, %.lr.ph.preheader ], [ %i.af, %._crit_edge.unr-lcssa ]
  %.0140178.epil.init = phi ptr [ %i.t, %.lr.ph.preheader ], [ %i.ai, %._crit_edge.unr-lcssa ] ; 2 uses
  %.0141177.epil.init = phi i32 [ %3, %.lr.ph.preheader ], [ %i.ae, %._crit_edge.unr-lcssa ]
  %lcmp.mod338 = trunc i32 %4 to i1
  tail call void @llvm.assume(i1 %lcmp.mod338)
  %i.ak = icmp ne i32 %.0141177.epil.init, 0      ; 2 uses
  %.neg173.epil = sext i1 %i.ak to i64
  %i.al = getelementptr inbounds i8, ptr %.0139179.epil.init, i64 %.neg173.epil
  %i.am = load i8, ptr %i.al, align 1, !tbaa !8
  %i.an = select i1 %i.ak, i8 %i.am, i8 0         ; 2 uses
  %i.ao = getelementptr inbounds i8, ptr %.0140178.epil.init, i64 -1 ; 2 uses
  store i8 %i.an, ptr %i.ao, align 1, !tbaa !8
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.unr-lcssa, %.lr.ph.epil.preheader
  %.0140178.lcssa = phi ptr [ %i.aj, %._crit_edge.unr-lcssa ], [ %.0140178.epil.init, %.lr.ph.epil.preheader ] ; 4 uses
  ...
  %i.ar = getelementptr inbounds nuw i8, ptr %.0140178.lcssa, i64 %i.aq ; 4 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.au = getelementptr inbounds nuw i8, ptr %.0140178.lcssa, i64 %index ; 2 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.bb = getelementptr inbounds nuw i8, ptr %.0140178.lcssa, i64 %index258
...
.lr.ph181:                                        ; preds = %.lr.ph181.preheader, %.lr.ph181
  ...
  %i.bf = getelementptr inbounds nuw i8, ptr %.0140178.lcssa, i64 %indvars.iv
...
._crit_edge185:                                   ; preds = %.lr.ph184, %middle.block275, %vec.epilog.middle.block289, %.preheader174
  ...
  %i.ce = call i32 @EVP_Digest(ptr noundef %5, i64 noundef %i.cd, ptr noundef nonnull %i.b, ptr noundef null, ptr noundef %.0142, ptr noundef null) #6
...
.lr.ph191:                                        ; preds = %bb.i, %.lr.ph191
  ...
  %.0143189 = phi i32 [ %i.cx, %.lr.ph191 ], [ 0, %bb.i ] ; 2 uses
  %.0144188 = phi i32 [ %i.cz, %.lr.ph191 ], [ %i.ci, %bb.i ]
  %.0147187 = phi i32 [ %i.cw, %.lr.ph191 ], [ 0, %bb.i ]
  ...
  %i.cv = and i32 %i.cu, %.0147187
  %i.cw = or i32 %i.cv, %i.cs                     ; 2 uses
  %i.cx = select i1 %i.cm, i32 -1, i32 %.0143189  ; 3 uses
  %i.cy = select i1 %i.cn, i32 -1, i32 %i.cx
  %i.cz = and i32 %i.cy, %.0144188                ; 2 uses
...
._crit_edge192:                                   ; preds = %.lr.ph191, %bb.i
  %.0147.lcssa = phi i32 [ 0, %bb.i ], [ %i.cw, %.lr.ph191 ] ; 2 uses
  %.0144.lcssa = phi i32 [ %i.ci, %bb.i ], [ %i.cz, %.lr.ph191 ]
  %.0143.lcssa = phi i32 [ 0, %bb.i ], [ %i.cx, %.lr.ph191 ]
  %.neg = xor i32 %.0147.lcssa, -1
  %i.dc = add i32 %i.o, %.neg                     ; 5 uses
  %i.dd = sub i32 %1, %i.dc
  %i.de = or i32 %i.dd, %i.dc
  %isnotneg.i.inv = icmp slt i32 %i.de, 0
  %i.df = select i1 %isnotneg.i.inv, i32 0, i32 %.0143.lcssa
  %i.dg = and i32 %i.df, %.0144.lcssa             ; 3 uses
...
bb.j:                                             ; preds = %.lr.ph203, %._crit_edge200
  %.0146201 = phi i32 [ 1, %.lr.ph203 ], [ %i.fp, %._crit_edge200 ] ; 4 uses
  %i.dx = sub nsw i32 %i.o, %.0146201             ; 2 uses
  %i.dy = icmp slt i32 %.4196, %i.dx
  br i1 %i.dy, label %iter.check313, label %._crit_edge200

iter.check313:                                    ; preds = %bb.j
  %i.dz = and i32 %.0146201, %i.ds
  ...
  %i.ee = sext i32 %.0146201 to i64               ; 3 uses
