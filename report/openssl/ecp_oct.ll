...
._crit_edge130:                                   ; preds = %.lr.ph129.preheader, %.preheader
  %.181.lcssa = phi i64 [ %i.j, %.preheader ], [ %i.an, %.lr.ph129.preheader ] ; 2 uses
  %i.ao = getelementptr inbounds nuw i8, ptr %3, i64 %.181.lcssa
  %i.ap = tail call i32 @BN_bn2bin(ptr noundef nonnull %i.u, ptr noundef nonnull %i.ao) #3
  %i.aq = sext i32 %i.ap to i64
  %i.ar = add nsw i64 %.181.lcssa, %i.aq
  br label %bb.t

bb.t:                                             ; preds = %bb.r, %._crit_edge130
  %.2 = phi i64 [ %i.ar, %._crit_edge130 ], [ %i.j, %bb.r ]
