Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/openssl/original/ecp_oct?download=true
inline.NumInlined: 2
inline.NumDeleted: 2
...
bb.t:                                             ; preds = %bb.s
  ...
  %.not136 = icmp eq i32 %i.bg, 0
  br i1 %.not136, label %bb.aj, label %bb.u
...
bb.u:                                             ; preds = %bb.t
  ...
  %.not137 = icmp eq i32 %i.bi, 0
  br i1 %.not137, label %bb.aj, label %bb.w
...
bb.v:                                             ; preds = %bb.s
  ...
  %.not135 = icmp eq i32 %i.bk, 0
  br i1 %.not135, label %bb.aj, label %bb.w
...
bb.w:                                             ; preds = %bb.v, %bb.u
  ...
  br i1 %.not138, label %bb.x, label %bb.aa
...
bb.aa:                                            ; preds = %bb.w
  ...
  %.not139 = icmp eq i32 %i.bt, %i.g
  br i1 %.not139, label %bb.ag, label %bb.ab

bb.ab:                                            ; preds = %bb.aa
  %i.bu = tail call i32 @BN_is_zero(ptr noundef nonnull %i.k) #3
  %.not140 = icmp eq i32 %i.bu, 0
  %i.bv = load ptr, ptr %i.m, align 8, !tbaa !18  ; 2 uses
  br i1 %.not140, label %bb.af, label %bb.ac
...
bb.af:                                            ; preds = %bb.ab
  ...
  %.not141 = icmp eq i32 %i.bx, 0
  br i1 %.not141, label %bb.aj, label %bb.ag

bb.ag:                                            ; preds = %bb.af, %bb.aa
  %i.by = tail call i32 @BN_is_odd(ptr noundef nonnull %i.k) #3
  %.not142 = icmp eq i32 %i.by, %i.g
  br i1 %.not142, label %bb.ai, label %bb.ah
...
bb.ai:                                            ; preds = %bb.ag
  ...
  %.not143 = icmp ne i32 %i.bz, 0
  %spec.select = zext i1 %.not143 to i32
  br label %bb.aj
...
bb.aj:                                            ; preds = %bb.ai, %bb.ac, %bb.ae, %bb.ad, %bb.y, %bb.z, %bb.af, %bb.v, %bb.u, %bb.t, %bb.r, %bb.q, %bb.p, %bb.o, %bb.m, %bb.l, %bb.k, %bb.i, %bb.h, %bb.g, %bb.f, %bb.d, %bb.c, %bb.ah
  %.0112 = phi i32 [ 0, %bb.c ], [ 0, %bb.y ], [ 0, %bb.ah ], [ 0, %bb.ac ], [ %spec.select, %bb.ai ], [ 0, %bb.af ], [ 0, %bb.d ], [ 0, %bb.u ], [ 0, %bb.t ], [ 0, %bb.v ], [ 0, %bb.m ], [ 0, %bb.l ], [ 0, %bb.k ], [ 0, %bb.r ], [ 0, %bb.p ], [ 0, %bb.o ], [ 0, %bb.q ], [ 0, %bb.g ], [ 0, %bb.f ], [ 0, %bb.i ], [ 0, %bb.h ], [ 0, %bb.z ], [ 0, %bb.ad ], [ 0, %bb.ae ]
  tail call void @BN_CTX_end(ptr noundef nonnull %.0114) #3
  tail call void @BN_CTX_free(ptr noundef %.0113) #3
  br label %bb.ak

bb.ak:                                            ; preds = %bb.b, %bb.aj
  %.0115 = phi i32 [ %.0112, %bb.aj ], [ 0, %bb.b ]
  ret i32 %.0115
}
...
bb.m:                                             ; preds = %bb.l, %bb.k
  %.087 = phi ptr [ %i.r, %bb.l ], [ %5, %bb.k ]  ; 6 uses
  %.084 = phi ptr [ %i.r, %bb.l ], [ null, %bb.k ] ; 2 uses
  tail call void @BN_CTX_start(ptr noundef nonnull %.087) #3
  %i.t = tail call ptr @BN_CTX_get(ptr noundef nonnull %.087) #3 ; 3 uses
  %i.u = tail call ptr @BN_CTX_get(ptr noundef nonnull %.087) #3 ; 5 uses
  %i.v = icmp eq ptr %i.u, null
  br i1 %i.v, label %bb.v, label %bb.n

bb.n:                                             ; preds = %bb.m
  %i.w = tail call i32 @EC_POINT_get_affine_coordinates(ptr noundef nonnull %0, ptr noundef %1, ptr noundef %i.t, ptr noundef nonnull %i.u, ptr noundef nonnull %.087) #3
...
._crit_edge:                                      ; preds = %.lr.ph.preheader, %.preheader122
  %.080.lcssa = phi i64 [ 1, %.preheader122 ], [ %i.ad, %.lr.ph.preheader ] ; 2 uses
  %i.ae = getelementptr inbounds nuw i8, ptr %3, i64 %.080.lcssa
  %i.af = tail call i32 @BN_bn2bin(ptr noundef %i.t, ptr noundef nonnull %i.ae) #3
  %i.ag = sext i32 %i.af to i64
  %i.ah = add nsw i64 %.080.lcssa, %i.ag
  %.not104 = icmp eq i64 %i.ah, %i.j
...
bb.s:                                             ; preds = %bb.r, %bb.r
  %i.ai = tail call i32 @BN_num_bits(ptr noundef nonnull %i.u) #3
  %i.aj = add nsw i32 %i.ai, 7
  %.neg106 = sdiv i32 %i.aj, -8                   ; 2 uses
  %narrow105 = add nsw i32 %.neg106, %i.g         ; 3 uses
  %i.ak = icmp ugt i32 %narrow105, %i.g
  br i1 %i.ak, label %.sink.split, label %.preheader
...
.lr.ph129.preheader:                              ; preds = %.preheader
  %i.al = sext i32 %narrow105 to i64
  %scevgep133 = getelementptr i8, ptr %3, i64 %i.j
  tail call void @llvm.memset.p0.i64(ptr align 1 %scevgep133, i8 0, i64 %i.al, i1 false), !tbaa !19
  %i.am = add nsw i64 %i.j, %i.h
  %i.an = sext i32 %.neg106 to i64
  %i.ao = add nsw i64 %i.am, %i.an
  br label %._crit_edge130

._crit_edge130:                                   ; preds = %.lr.ph129.preheader, %.preheader
  %.181.lcssa = phi i64 [ %i.j, %.preheader ], [ %i.ao, %.lr.ph129.preheader ] ; 2 uses
  %i.ap = getelementptr inbounds nuw i8, ptr %3, i64 %.181.lcssa
  %i.aq = tail call i32 @BN_bn2bin(ptr noundef nonnull %i.u, ptr noundef nonnull %i.ap) #3
  %i.ar = sext i32 %i.aq to i64
  %i.as = add nsw i64 %.181.lcssa, %i.ar
  br label %bb.t

bb.t:                                             ; preds = %bb.r, %._crit_edge130
  %.2 = phi i64 [ %i.as, %._crit_edge130 ], [ %i.j, %bb.r ]
  %.not108 = icmp eq i64 %.2, %i.m
  br i1 %.not108, label %bb.u, label %.sink.split

bb.u:                                             ; preds = %bb.t
  tail call void @BN_CTX_end(ptr noundef nonnull %.087) #3
  br label %.thread

.thread:                                          ; preds = %bb.h, %bb.u
  %.185114 = phi ptr [ %.084, %bb.u ], [ null, %bb.h ]
  tail call void @BN_CTX_free(ptr noundef %.185114) #3
  br label %bb.x
...
bb.w:                                             ; preds = %bb.b, %bb.j, %bb.v
  %.286121 = phi ptr [ %.084, %bb.v ], [ null, %bb.b ], [ null, %bb.j ]
  tail call void @BN_CTX_free(ptr noundef %.286121) #3
  br label %bb.x

bb.x:                                             ; preds = %bb.l, %bb.d, %bb.g, %bb.w, %.thread, %bb.f
  %.090 = phi i64 [ 0, %bb.w ], [ 0, %bb.f ], [ %i.m, %.thread ], [ 1, %bb.d ], [ 1, %bb.g ], [ 0, %bb.l ]
  ret i64 %.090
}
...
bb.c:                                             ; preds = %bb.a
  %i.b = load i8, ptr %2, align 1, !tbaa !19      ; 3 uses
...
bb.o:                                             ; preds = %bb.n, %bb.m
  ...
  %.065 = phi ptr [ %i.z, %bb.n ], [ null, %bb.m ]
