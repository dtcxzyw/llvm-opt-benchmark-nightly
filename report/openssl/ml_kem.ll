...
vector.body213:                                   ; preds = %bb.e, %vector.body213
  ...
  %i.mb = add nsw <4 x i32> %i.ma, %i.lu
  %i.mc = add nsw <4 x i32> %i.mb, %i.ly
  %i.md = add nsw <4 x i32> %i.mc, %i.lw          ; 2 uses
...
vector.body247:                                   ; preds = %vector_encode.exit, %vector.body247
  ...
  %i.ra = add nsw <4 x i32> %i.qz, %i.qt
  %i.rb = add nsw <4 x i32> %i.ra, %i.qx
  %i.rc = add nsw <4 x i32> %i.rb, %i.qv          ; 2 uses
