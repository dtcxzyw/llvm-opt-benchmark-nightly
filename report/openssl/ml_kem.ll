...
.preheader37:                                     ; preds = %.loopexit137, %.loopexit136
  ...
  %7 = xor i64 %.020.idx.2, -1
  %8 = add i64 %i.ep, %7
  %9 = sub i64 %8, %i.a                           ; 2 uses
  %i.eq = lshr i64 %9, 1
...
.preheader42:                                     ; preds = %.preheader42.preheader, %.loopexit150
  ...
  %1 = xor i64 %.021.idx.3, -1
  %2 = add i64 %i.avx, %1
  %3 = sub i64 %2, %i.avq                         ; 2 uses
  %i.avy = lshr i64 %3, 1
...
.preheader41:                                     ; preds = %.loopexit150, %.loopexit149
  ...
  %4 = xor i64 %.021.idx.4, -1
  %5 = add i64 %i.ayj, %4
  %6 = sub i64 %5, %i.avq                         ; 2 uses
  %i.ayk = lshr i64 %6, 1
...
.preheader40:                                     ; preds = %.loopexit149, %.loopexit148
  ...
  %7 = xor i64 %.021.idx.5, -1
  %8 = add i64 %i.bav, %7
  %9 = sub i64 %8, %i.avq                         ; 2 uses
  %i.baw = lshr i64 %9, 1
...
.preheader39:                                     ; preds = %.loopexit148, %.loopexit
  ...
  %10 = xor i64 %.021.idx.6, -1
  %11 = add i64 %i.bdh, %10
  %12 = sub i64 %11, %i.avq                       ; 2 uses
  %i.bdi = lshr i64 %12, 1
