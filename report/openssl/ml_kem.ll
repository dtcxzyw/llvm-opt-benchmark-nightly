...
vector.body:                                      ; preds = %bb.a, %vector.body
  ...
  %4 = icmp slt <16 x i32> %i.em, zeroinitializer
  %i.en = select <16 x i1> %4, <16 x i32> splat (i32 3329), <16 x i32> zeroinitializer
  ...
  %5 = icmp slt <16 x i32> %i.eq, zeroinitializer
  %i.er = select <16 x i1> %5, <16 x i32> splat (i32 3329), <16 x i32> zeroinitializer
...
vector.body:                                      ; preds = %bb.a, %vector.body
  ...
  %4 = icmp slt <4 x i32> %i.q, zeroinitializer
  %i.r = select <4 x i1> %4, <4 x i32> splat (i32 3329), <4 x i32> zeroinitializer
  ...
  %5 = icmp slt <4 x i32> %i.ac, zeroinitializer
  %i.ad = select <4 x i1> %5, <4 x i32> splat (i32 3329), <4 x i32> zeroinitializer
...
vector.body212:                                   ; preds = %bb.e, %vector.body212
  ...
  %7 = icmp slt <4 x i32> %i.md, zeroinitializer
  %i.me = select <4 x i1> %7, <4 x i32> splat (i32 3329), <4 x i32> zeroinitializer
  ...
  %8 = icmp slt <4 x i32> %i.mp, zeroinitializer
  %i.mq = select <4 x i1> %8, <4 x i32> splat (i32 3329), <4 x i32> zeroinitializer
...
vector.body246:                                   ; preds = %vector_encode.exit, %vector.body246
  ...
  %9 = icmp slt <4 x i32> %i.ra, zeroinitializer
  %i.rb = select <4 x i1> %9, <4 x i32> splat (i32 3329), <4 x i32> zeroinitializer
  ...
  %10 = icmp slt <4 x i32> %i.rm, zeroinitializer
  %i.rn = select <4 x i1> %10, <4 x i32> splat (i32 3329), <4 x i32> zeroinitializer
