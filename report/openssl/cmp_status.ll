...
define i32 @ossl_cmp_pkisi_get_status(ptr nofree noundef readonly captures(address_is_null) %0) local_unnamed_addr #0 {
bb.a:
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %.not6, label %.critedge, label %bb.c, !prof !13

bb.c:                                             ; preds = %bb.b
  %i.b = tail call i32 @ossl_cmp_asn1_get_int(ptr noundef nonnull %i.a) #5 ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  tail call void @ERR_set_debug(ptr noundef nonnull @.str.7, i32 noundef 46, ptr noundef nonnull @__func__.ossl_cmp_PKIStatus_to_string) #5
  tail call void (i32, i32, ptr, ...) @ERR_set_error(i32 noundef 58, i32 noundef 107, ptr noundef nonnull @.str.8, i32 noundef %0) #5
  br label %bb.c
...
define ptr @ossl_cmp_pkisi_get0_statusString(ptr nofree noundef readonly captures(address_is_null) %0) local_unnamed_addr #2 {
bb.a:
  %.not = icmp eq ptr %0, null
...
; Function Attrs: nounwind uwtable
define range(i32 -1, 134217728) i32 @ossl_cmp_pkisi_get_pkifailureinfo(ptr nofree noundef readonly captures(address_is_null) %0) local_unnamed_addr #0 {
bb.a:
  %.not = icmp eq ptr %0, null
  br i1 %.not, label %.loopexit, label %bb.b, !prof !13
...
.preheader.preheader:                             ; preds = %bb.b
  %i.c = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef nonnull %i.b, i32 noundef 0) #5
  %.not13 = icmp ne i32 %i.c, 0
  %i.d = zext i1 %.not13 to i32
  %i.e = load ptr, ptr %i.a, align 8, !tbaa !15
  %i.f = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %i.e, i32 noundef 1) #5
  %.not13.1 = icmp eq i32 %i.f, 0
  %i.g = select i1 %.not13.1, i32 0, i32 2
  %i.h = load ptr, ptr %i.a, align 8, !tbaa !15
  %i.i = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %i.h, i32 noundef 2) #5
  %.not13.2 = icmp eq i32 %i.i, 0
  %i.j = select i1 %.not13.2, i32 0, i32 4
  %i.k = load ptr, ptr %i.a, align 8, !tbaa !15
  %i.l = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %i.k, i32 noundef 3) #5
  %.not13.3 = icmp eq i32 %i.l, 0
  %i.m = select i1 %.not13.3, i32 0, i32 8
  %i.n = load ptr, ptr %i.a, align 8, !tbaa !15
  %i.o = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %i.n, i32 noundef 4) #5
  %.not13.4 = icmp eq i32 %i.o, 0
  %i.p = select i1 %.not13.4, i32 0, i32 16
  %i.q = load ptr, ptr %i.a, align 8, !tbaa !15
  %i.r = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %i.q, i32 noundef 5) #5
  %.not13.5 = icmp eq i32 %i.r, 0
  %i.s = select i1 %.not13.5, i32 0, i32 32
  %i.t = load ptr, ptr %i.a, align 8, !tbaa !15
  %i.u = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %i.t, i32 noundef 6) #5
  %.not13.6 = icmp eq i32 %i.u, 0
  %i.v = select i1 %.not13.6, i32 0, i32 64
  %i.w = load ptr, ptr %i.a, align 8, !tbaa !15
  %i.x = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %i.w, i32 noundef 7) #5
  %.not13.7 = icmp eq i32 %i.x, 0
  %i.y = select i1 %.not13.7, i32 0, i32 128
  %i.z = load ptr, ptr %i.a, align 8, !tbaa !15
  %i.aa = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %i.z, i32 noundef 8) #5
  %i.ab = load ptr, ptr %i.a, align 8, !tbaa !15
  %i.ac = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %i.ab, i32 noundef 9) #5
  %i.ad = load ptr, ptr %i.a, align 8, !tbaa !15
  %i.ae = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %i.ad, i32 noundef 10) #5
  %i.af = load ptr, ptr %i.a, align 8, !tbaa !15
  %i.ag = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %i.af, i32 noundef 11) #5
  %i.ah = load ptr, ptr %i.a, align 8, !tbaa !15
  %i.ai = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %i.ah, i32 noundef 12) #5
  %i.aj = load ptr, ptr %i.a, align 8, !tbaa !15
  %i.ak = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %i.aj, i32 noundef 13) #5
  %1 = load ptr, ptr %i.a, align 8, !tbaa !15
  %2 = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %1, i32 noundef 14) #5
  %i.al = load ptr, ptr %i.a, align 8, !tbaa !15
  %i.am = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %i.al, i32 noundef 15) #5
  %3 = load ptr, ptr %i.a, align 8, !tbaa !15
  %4 = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %3, i32 noundef 16) #5
  %i.an = load ptr, ptr %i.a, align 8, !tbaa !15
  %i.ao = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %i.an, i32 noundef 17) #5
  %5 = load ptr, ptr %i.a, align 8, !tbaa !15
  %6 = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %5, i32 noundef 18) #5
  %i.ap = load ptr, ptr %i.a, align 8, !tbaa !15
  %i.aq = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %i.ap, i32 noundef 19) #5
  %7 = load ptr, ptr %i.a, align 8, !tbaa !15
  %8 = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %7, i32 noundef 20) #5
  %i.ar = load ptr, ptr %i.a, align 8, !tbaa !15
  %i.as = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %i.ar, i32 noundef 21) #5
  %9 = load ptr, ptr %i.a, align 8, !tbaa !15
  %10 = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %9, i32 noundef 22) #5
  %i.at = load ptr, ptr %i.a, align 8, !tbaa !15
  %i.au = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %i.at, i32 noundef 23) #5
  ...
  %i.av = load ptr, ptr %i.a, align 8, !tbaa !15
  %i.aw = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %i.av, i32 noundef 24) #5
  %.not13.22 = icmp eq i32 %i.aw, 0
  %i.ax = select i1 %.not13.22, i32 0, i32 16777216
  %i.ay = load ptr, ptr %i.a, align 8, !tbaa !15
  %i.az = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %i.ay, i32 noundef 25) #5
  %.not13.23 = icmp eq i32 %i.az, 0
  %i.ba = select i1 %.not13.23, i32 0, i32 33554432
  %i.bb = load ptr, ptr %i.a, align 8, !tbaa !15
  %i.bc = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %i.bb, i32 noundef 26) #5
...
; Function Attrs: nounwind uwtable
define i32 @ossl_cmp_pkisi_check_pkifailureinfo(ptr nofree noundef readonly captures(address_is_null) %0, i32 noundef %1) local_unnamed_addr #0 {
bb.a:
  %.not = icmp eq ptr %0, null
  br i1 %.not, label %.critedge, label %bb.b
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %.not9, label %.critedge, label %bb.c, !prof !13
...
bb.d:                                             ; preds = %bb.c
  tail call void @ERR_new() #5
  tail call void @ERR_set_debug(ptr noundef nonnull @.str.7, i32 noundef 144, ptr noundef nonnull @__func__.ossl_cmp_pkisi_check_pkifailureinfo) #5
  tail call void (i32, i32, ptr, ...) @ERR_set_error(i32 noundef 58, i32 noundef 100, ptr noundef null) #5
  br label %.critedge

bb.e:                                             ; preds = %bb.c
  %i.c = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef nonnull %i.b, i32 noundef %1) #5
  br label %.critedge
...
; Function Attrs: nounwind uwtable
define noundef ptr @OSSL_CMP_snprint_PKIStatusInfo(ptr nofree noundef readonly captures(address_is_null) %0, ptr noundef %1, i64 noundef %2) local_unnamed_addr #0 {
bb.a:
...
bb.b:                                             ; preds = %bb.a
  tail call void @ERR_new() #5
  tail call void @ERR_set_debug(ptr noundef nonnull @.str.7, i32 noundef 233, ptr noundef nonnull @__func__.OSSL_CMP_snprint_PKIStatusInfo) #5
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.d = tail call i64 @ASN1_INTEGER_get(ptr noundef %i.c) #5
...
switch.lookup:                                    ; preds = %bb.b
  ...
  %switch.load = load ptr, ptr %switch.gep, align 8
  %i.e = tail call i32 (ptr, i64, ptr, ...) @BIO_snprintf(ptr noundef nonnull %3, i64 noundef %4, ptr noundef nonnull @.str.9, ptr noundef nonnull %switch.load) #5 ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  %i.k = tail call i32 (ptr, i64, ptr, ...) @BIO_snprintf(ptr noundef nonnull %i.h, i64 noundef %i.i, ptr noundef nonnull @.str.10) #5 ; 2 uses
...
switch.lookup179:                                 ; preds = %bb.h
  ...
  %i.t = tail call i32 (ptr, i64, ptr, ...) @BIO_snprintf(ptr noundef %.0149, i64 noundef %.097147, ptr noundef nonnull @.str.11, ptr noundef nonnull %i.s, ptr noundef nonnull %switch.load181) #5 ; 2 uses
...
CMP_PKIFAILUREINFO_to_string.exit:                ; preds = %bb.h, %bb.j
  ...
  br i1 %exitcond.not, label %.loopexit138.loopexit, label %bb.h, !llvm.loop !16
...
bb.k:                                             ; preds = %.loopexit138
  %i.ab = tail call i32 (ptr, i64, ptr, ...) @BIO_snprintf(ptr noundef %.2, i64 noundef %.299, ptr noundef nonnull @.str.14) #5 ; 2 uses
...
bb.n:                                             ; preds = %bb.m, %.loopexit138
  ...
  %i.ag = tail call i32 @OPENSSL_sk_num(ptr noundef %2) #5 ; 4 uses
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.aj = tail call i32 (ptr, i64, ptr, ...) @BIO_snprintf(ptr noundef %.3, i64 noundef %.3100, ptr noundef nonnull @.str.15, ptr noundef nonnull %i.ai) #5 ; 2 uses
...
bb.q:                                             ; preds = %.lr.ph, %bb.s
  ...
  %i.ap = tail call ptr @OPENSSL_sk_value(ptr noundef %2, i32 noundef %.096151) #5 ; 2 uses
  %i.aq = tail call i32 @ASN1_STRING_length(ptr noundef %i.ap) #5
  %i.ar = tail call ptr @ASN1_STRING_get0_data(ptr noundef %i.ap) #5
  %i.as = icmp slt i32 %.096151, %i.ao
  %i.at = select i1 %i.as, ptr @.str.12, ptr @.str.13
  %i.au = tail call i32 (ptr, i64, ptr, ...) @BIO_snprintf(ptr noundef %.4152, i64 noundef %.4101150, ptr noundef nonnull @.str.17, i32 noundef %i.aq, ptr noundef %i.ar, ptr noundef nonnull %i.at) #5 ; 2 uses
...
bb.s:                                             ; preds = %bb.r
  ...
  br i1 %exitcond158.not, label %.loopexit, label %bb.q, !llvm.loop !18
...
bb.b:                                             ; preds = %bb.a
  tail call void @ERR_new() #5
  tail call void @ERR_set_debug(ptr noundef nonnull @.str.7, i32 noundef 248, ptr noundef nonnull @__func__.OSSL_CMP_CTX_snprint_PKIStatus) #5
  tail call void (i32, i32, ptr, ...) @ERR_set_error(i32 noundef 58, i32 noundef 103, ptr noundef null) #5
  br label %bb.d

bb.c:                                             ; preds = %bb.a
  %i.b = tail call i32 @OSSL_CMP_CTX_get_status(ptr noundef nonnull %0) #5
  %i.c = tail call i32 @OSSL_CMP_CTX_get_failInfoCode(ptr noundef nonnull %0) #5
  %i.d = tail call ptr @OSSL_CMP_CTX_get0_statusString(ptr noundef nonnull %0) #5
...
bb.a:
  %i.a = tail call ptr @OSSL_CMP_PKISI_new() #5   ; 6 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.e = tail call i32 @ASN1_INTEGER_set(ptr noundef %i.c, i64 noundef %i.d) #5
...
bb.d:                                             ; preds = %bb.c
  %i.f = tail call ptr @ASN1_UTF8STRING_new() #5  ; 6 uses
  %i.g = icmp eq ptr %i.f, null
  br i1 %i.g, label %.loopexit32, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.h = tail call i32 @ASN1_STRING_set(ptr noundef nonnull %i.f, ptr noundef nonnull %2, i32 noundef -1) #5
  %.not28 = icmp eq i32 %i.h, 0
  br i1 %.not28, label %.loopexit32, label %bb.f

bb.f:                                             ; preds = %bb.e
  %i.i = tail call ptr @OPENSSL_sk_new_null() #5
  %i.j = tail call ptr @OPENSSL_sk_set_thunks(ptr noundef %i.i, ptr noundef nonnull @sk_ASN1_UTF8STRING_freefunc_thunk) #5 ; 3 uses
  %i.k = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  store ptr %i.j, ptr %i.k, align 8, !tbaa !14
  %i.l = icmp eq ptr %i.j, null
  br i1 %i.l, label %.loopexit32, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.m = tail call i32 @OPENSSL_sk_push(ptr noundef nonnull %i.j, ptr noundef nonnull %i.f) #5
...
bb.i:                                             ; preds = %bb.h, %bb.m
  %.033 = phi i32 [ 0, %bb.h ], [ %i.w, %bb.m ]   ; 3 uses
  %i.o = shl nuw nsw i32 1, %.033
  %i.p = and i32 %i.o, %1
  %.not30 = icmp eq i32 %i.p, 0
  br i1 %.not30, label %bb.m, label %bb.j

bb.j:                                             ; preds = %bb.i
  %i.q = load ptr, ptr %i.n, align 8, !tbaa !15   ; 2 uses
  %i.r = icmp eq ptr %i.q, null
  br i1 %i.r, label %bb.k, label %bb.l

bb.k:                                             ; preds = %bb.j
  %i.s = tail call ptr @ASN1_BIT_STRING_new() #5  ; 3 uses
  store ptr %i.s, ptr %i.n, align 8, !tbaa !15
  %i.t = icmp eq ptr %i.s, null
  br i1 %i.t, label %.loopexit32, label %bb.l

bb.l:                                             ; preds = %bb.k, %bb.j
  %i.u = phi ptr [ %i.s, %bb.k ], [ %i.q, %bb.j ]
  %i.v = tail call i32 @ASN1_BIT_STRING_set_bit(ptr noundef nonnull %i.u, i32 noundef %.033, i32 noundef 1) #5
  %.not31 = icmp eq i32 %i.v, 0
  br i1 %.not31, label %.loopexit32, label %bb.m

bb.m:                                             ; preds = %bb.i, %bb.l
  %i.w = add nuw nsw i32 %.033, 1                 ; 2 uses
  %exitcond.not = icmp eq i32 %i.w, 27
  br i1 %exitcond.not, label %.loopexit, label %bb.i, !llvm.loop !19
...
.loopexit32:                                      ; preds = %bb.l, %bb.k, %bb.g, %bb.f, %bb.d, %bb.e, %bb.b, %bb.a
  ...
  tail call void @OSSL_CMP_PKISI_free(ptr noundef %i.a) #5
  tail call void @ASN1_UTF8STRING_free(ptr noundef %.1) #5
  br label %.loopexit
...
define internal void @sk_ASN1_UTF8STRING_freefunc_thunk(ptr nofree noundef readonly captures(none) %0, ptr noundef %1) #3 {
bb.a:
...
declare i32 @llvm.vector.reduce.or.v16i32(<16 x i32>) #4
...
!7 = !{!"Simple C/C++ TBAA"}
!8 = !{!9, !10, i64 0}
!9 = !{!"ossl_cmp_pkisi_st", !10, i64 0, !12, i64 8, !10, i64 16}
!10 = !{!"p1 _ZTS14asn1_string_st", !11, i64 0}
!11 = !{!"any pointer", !6, i64 0}
!12 = !{!"p1 _ZTS24stack_st_ASN1_UTF8STRING", !11, i64 0}
