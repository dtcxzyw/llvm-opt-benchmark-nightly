...
bb.b:                                             ; preds = %bb.a
  ...
  tail call void @ERR_set_debug(ptr noundef nonnull @.str.7, i32 noundef 46, ptr noundef nonnull @__func__.ossl_cmp_PKIStatus_to_string) #4
...
.preheader.preheader:                             ; preds = %bb.b
  ...
  %i.am = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %i.al, i32 noundef 14) #4
  %.not13.14 = icmp eq i32 %i.am, 0
  %7 = select i1 %.not13.14, i32 0, i32 16384
  %.1.14 = or i32 %7, %.1.13
  %i.an = load ptr, ptr %i.a, align 8, !tbaa !15
  %i.ao = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %i.an, i32 noundef 15) #4
  %.not13.15 = icmp eq i32 %i.ao, 0
  %8 = select i1 %.not13.15, i32 0, i32 32768
  %.1.15 = or i32 %8, %.1.14
  %i.ap = load ptr, ptr %i.a, align 8, !tbaa !15
  %i.aq = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %i.ap, i32 noundef 16) #4
  %.not13.16 = icmp eq i32 %i.aq, 0
  %9 = select i1 %.not13.16, i32 0, i32 65536
  %.1.16 = or i32 %9, %.1.15
  %i.ar = load ptr, ptr %i.a, align 8, !tbaa !15
  %i.as = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %i.ar, i32 noundef 17) #4
  %.not13.17 = icmp eq i32 %i.as, 0
  %10 = select i1 %.not13.17, i32 0, i32 131072
  %.1.17 = or i32 %10, %.1.16
  %i.at = load ptr, ptr %i.a, align 8, !tbaa !15
  %i.au = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %i.at, i32 noundef 18) #4
  %.not13.18 = icmp eq i32 %i.au, 0
  %11 = select i1 %.not13.18, i32 0, i32 262144
  %.1.18 = or i32 %11, %.1.17
  %12 = load ptr, ptr %i.a, align 8, !tbaa !15
  %13 = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %12, i32 noundef 19) #4
  %.not13.19 = icmp eq i32 %13, 0
  %14 = select i1 %.not13.19, i32 0, i32 524288
  %.1.19 = or i32 %14, %.1.18
  %15 = load ptr, ptr %i.a, align 8, !tbaa !15
  %16 = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %15, i32 noundef 20) #4
  %.not13.20 = icmp eq i32 %16, 0
  %17 = select i1 %.not13.20, i32 0, i32 1048576
  %.1.20 = or i32 %17, %.1.19
  %18 = load ptr, ptr %i.a, align 8, !tbaa !15
  %19 = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %18, i32 noundef 21) #4
  %.not13.21 = icmp eq i32 %19, 0
  %20 = select i1 %.not13.21, i32 0, i32 2097152
  %.1.21 = or i32 %20, %.1.20
  %i.av = load ptr, ptr %i.a, align 8, !tbaa !15
  %i.aw = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %i.av, i32 noundef 22) #4
  ...
  %i.az = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %i.ay, i32 noundef 23) #4
  ...
  %i.bc = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %i.bb, i32 noundef 24) #4
  %.not13.24 = icmp eq i32 %i.bc, 0
  %i.bd = select i1 %.not13.24, i32 0, i32 16777216
  %.1.24 = or i32 %i.bd, %.1.23
  %21 = load ptr, ptr %i.a, align 8, !tbaa !15
  %22 = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %21, i32 noundef 25) #4
  %.not13.25 = icmp eq i32 %22, 0
  %23 = select i1 %.not13.25, i32 0, i32 33554432
  %.1.25 = or i32 %23, %.1.24
  %24 = load ptr, ptr %i.a, align 8, !tbaa !15
  %25 = tail call i32 @ASN1_BIT_STRING_get_bit(ptr noundef %24, i32 noundef 26) #4
...
bb.d:                                             ; preds = %bb.c
  tail call void @ERR_new() #4
  tail call void @ERR_set_debug(ptr noundef nonnull @.str.7, i32 noundef 144, ptr noundef nonnull @__func__.ossl_cmp_pkisi_check_pkifailureinfo) #4
...
bb.b:                                             ; preds = %bb.a
  tail call void @ERR_new() #4
  tail call void @ERR_set_debug(ptr noundef nonnull @.str.7, i32 noundef 233, ptr noundef nonnull @__func__.OSSL_CMP_snprint_PKIStatusInfo) #4
...
bb.b:                                             ; preds = %bb.a
  tail call void @ERR_new() #4
  tail call void @ERR_set_debug(ptr noundef nonnull @.str.7, i32 noundef 248, ptr noundef nonnull @__func__.OSSL_CMP_CTX_snprint_PKIStatus) #4
  tail call void (i32, i32, ptr, ...) @ERR_set_error(i32 noundef 58, i32 noundef 103, ptr noundef null) #4
  br label %bb.d
...
bb.f:                                             ; preds = %bb.e
  %i.i = tail call ptr @OPENSSL_sk_new_null() #4
  %i.j = tail call ptr @OPENSSL_sk_set_thunks(ptr noundef %i.i, ptr noundef nonnull @sk_ASN1_UTF8STRING_freefunc_thunk) #4 ; 3 uses
...
bb.g:                                             ; preds = %bb.f
  %i.m = tail call i32 @OPENSSL_sk_push(ptr noundef nonnull %i.j, ptr noundef nonnull %i.f) #4
...
bb.k:                                             ; preds = %bb.j
  %i.s = tail call ptr @ASN1_BIT_STRING_new() #4  ; 3 uses
...
bb.l:                                             ; preds = %bb.k, %bb.j
  ...
  %i.v = tail call i32 @ASN1_BIT_STRING_set_bit(ptr noundef nonnull %i.u, i32 noundef %.033, i32 noundef 1) #4
