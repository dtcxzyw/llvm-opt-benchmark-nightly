...
@.str = private unnamed_addr constant [23 x i8] c"ssl/rio/poll_builder.c\00", align 1

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write) uwtable
define noundef i32 @ossl_rio_poll_builder_init(ptr nofree noundef writeonly captures(none) initializes((0, 8), (264, 280)) %0) local_unnamed_addr #0 {
bb.a:
  ...
  store i64 32, ptr %i.b, align 8, !tbaa !14
  ret i32 1
}

; Function Attrs: nounwind uwtable
define void @ossl_rio_poll_builder_cleanup(ptr nofree noundef readonly captures(address_is_null) %0) local_unnamed_addr #1 {
bb.a:
...
; Function Attrs: nounwind uwtable
define range(i32 0, 2) i32 @ossl_rio_poll_builder_add_fd(ptr nofree noundef captures(none) %0, i32 noundef %1, i32 noundef %2, i32 noundef %3) local_unnamed_addr #1 {
bb.a:
...
.preheader:                                       ; preds = %bb.a
  ...
  %i.f = load i64, ptr %i.e, align 8, !tbaa !13   ; 5 uses
...
bb.h:                                             ; preds = %bb.g, %bb.f
  ...
  %.pre.pre = load i64, ptr %i.e, align 8, !tbaa !13
...
rpb_ensure_alloc.exit:                            ; preds = %bb.c, %bb.h, %._crit_edge
  ...
  store i16 %spec.select44, ptr %i.v, align 4, !tbaa !20
...
!7 = !{!"Simple C/C++ TBAA"}
!8 = !{!9, !10, i64 0}
!9 = !{!"rio_poll_builder_st", !10, i64 0, !6, i64 8, !12, i64 264, !12, i64 272}
!10 = !{!"p1 _ZTS6pollfd", !11, i64 0}
!11 = !{!"any pointer", !6, i64 0}
!12 = !{!"long", !6, i64 0}
!13 = !{!9, !12, i64 264}
!14 = !{!9, !12, i64 272}
!15 = !{!16, !5, i64 0}
!16 = !{!"pollfd", !5, i64 0, !17, i64 4, !17, i64 6}
!17 = !{!"short", !6, i64 0}
!18 = distinct !{!18, !19}
