Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/openssl/original/cipher_aes_gcm_siv_hw?download=true
inline.NumInlined: 5
inline.NumDeleted: 4
...
bb.i:                                             ; preds = %bb.h
  ...
  store i64 0, ptr %i.ad, align 8, !tbaa !22
  br label %aes_gcm_siv_finish.exit
...
bb.l:                                             ; preds = %bb.k
  store ptr %i.am, ptr %i.ak, align 8, !tbaa !21
  %i.ao = load i64, ptr %i.ae, align 8, !tbaa !22
  ...
  %i.aq = load i64, ptr %i.ae, align 8, !tbaa !22
  %i.ar = add i64 %i.aq, %3                       ; 4 uses
  store i64 %i.ar, ptr %i.ae, align 8, !tbaa !22
  %i.as = icmp ugt i64 %i.ai, %i.ar
  br i1 %i.as, label %bb.m, label %aes_gcm_siv_finish.exit

bb.m:                                             ; preds = %bb.l
  %i.at = load ptr, ptr %i.ak, align 8, !tbaa !21
...
bb.p:                                             ; preds = %bb.o
  ...
  %i.bd = load i64, ptr %i.bc, align 8, !tbaa !22
  %i.be = shl i64 %i.bd, 3
  store i64 %i.be, ptr %i.e, align 16, !tbaa !23
  %i.bf = shl i64 %3, 3
  %i.bg = getelementptr inbounds nuw i8, ptr %i.e, i64 8
  store i64 %i.bf, ptr %i.bg, align 8, !tbaa !23
...
bb.q:                                             ; preds = %bb.p
  %i.bl = load i64, ptr %i.bc, align 8, !tbaa !22
...
bb.v:                                             ; preds = %bb.u, %bb.t
  ...
  %i.bv = load <8 x i8>, ptr %i.bu, align 8, !tbaa !18
  %i.bw = load <8 x i8>, ptr %i.f, align 16, !tbaa !18
  %i.bx = xor <8 x i8> %i.bw, %i.bv
  store <8 x i8> %i.bx, ptr %i.f, align 16, !tbaa !18
  %i.by = getelementptr inbounds nuw i8, ptr %0, i64 176
  %i.bz = getelementptr inbounds nuw i8, ptr %i.f, i64 8 ; 2 uses
  %i.ca = load <4 x i8>, ptr %i.by, align 8, !tbaa !18
  %i.cb = load <4 x i8>, ptr %i.bz, align 8, !tbaa !18
  %i.cc = xor <4 x i8> %i.cb, %i.ca
  store <4 x i8> %i.cc, ptr %i.bz, align 8, !tbaa !18
  %i.cd = getelementptr inbounds nuw i8, ptr %i.f, i64 15 ; 2 uses
  %i.ce = load i8, ptr %i.cd, align 1, !tbaa !18
  %i.cf = and i8 %i.ce, 127
  store i8 %i.cf, ptr %i.cd, align 1, !tbaa !18
  store i32 16, ptr %i.h, align 4, !tbaa !19
...
iter.check:                                       ; preds = %iter.check.preheader, %._crit_edge.i.i
  ...
  store i32 16, ptr %i.d, align 4, !tbaa !19
  %i.cm = load ptr, ptr %0, align 8, !tbaa !17
  ...
  %i.co = load i32, ptr %4, align 16, !tbaa !18
  %i.cp = add i32 %i.co, 1
  store i32 %i.cp, ptr %4, align 16, !tbaa !18
...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %wide.load = load <16 x i8>, ptr %i.cq, align 1, !tbaa !18
  %wide.load30 = load <16 x i8>, ptr %i.c, align 16, !tbaa !18
  %i.cr = xor <16 x i8> %wide.load30, %wide.load
  %i.cs = getelementptr inbounds nuw i8, ptr %1, i64 %.02024.i.i
  store <16 x i8> %i.cr, ptr %i.cs, align 1, !tbaa !18
...
vec.epilog.iter.check:                            ; preds = %vector.ph
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph.i.i.preheader, label %vec.epilog.ph, !prof !24
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load32 = load <4 x i8>, ptr %i.cv, align 1, !tbaa !18
  %i.cw = getelementptr inbounds nuw i8, ptr %i.c, i64 %index
  %wide.load33 = load <4 x i8>, ptr %i.cw, align 4, !tbaa !18
  %i.cx = xor <4 x i8> %wide.load33, %wide.load32
  %i.cy = getelementptr inbounds nuw i8, ptr %1, i64 %i.cu
  store <4 x i8> %i.cx, ptr %i.cy, align 1, !tbaa !18
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.cz = icmp eq i64 %index.next, %n.vec31
  br i1 %i.cz, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !30
...
.lr.ph.i.i.prol:                                  ; preds = %.lr.ph.i.i.preheader
  ...
  %i.de = load i8, ptr %i.dd, align 4, !tbaa !18
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i
  ...
  store i8 %i.do, ptr %i.dp, align 1, !tbaa !18
  ...
  store i8 %i.dw, ptr %i.dx, align 1, !tbaa !18
  %i.dy = add nuw nsw i64 %.01923.i.i, 2          ; 2 uses
  %exitcond.not.i.i.1 = icmp eq i64 %i.dy, %umax.i.i
  br i1 %exitcond.not.i.i.1, label %._crit_edge.i.i, label %.lr.ph.i.i, !llvm.loop !31
...
bb.w:                                             ; preds = %bb.n
  %i.eg = tail call fastcc i32 @aes_gcm_siv_decrypt(ptr noundef nonnull %0, ptr noundef nonnull %2, ptr noundef nonnull %1, i64 noundef %3)
  br label %aes_gcm_siv_finish.exit

aes_gcm_siv_finish.exit:                          ; preds = %bb.m, %bb.l, %bb.k, %bb.j, %bb.i, %bb.f, %bb.c, %bb.w, %aes_gcm_siv_encrypt.exit
  %.0 = phi i32 [ %i.eg, %bb.w ], [ %i.y, %bb.f ], [ %.041.i, %aes_gcm_siv_encrypt.exit ], [ %i.o, %bb.c ], [ 1, %bb.i ], [ 0, %bb.k ], [ 0, %bb.j ], [ 1, %bb.m ], [ 1, %bb.l ]
  ret i32 %.0
}
...
iter.check:                                       ; preds = %iter.check.preheader, %._crit_edge.i
  ...
  %i.t = load i32, ptr %4, align 16, !tbaa !18
  %i.u = add i32 %i.t, 1
  store i32 %i.u, ptr %4, align 16, !tbaa !18
...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %wide.load = load <16 x i8>, ptr %i.v, align 1, !tbaa !18
  %wide.load62 = load <16 x i8>, ptr %i.c, align 16, !tbaa !18
  %i.w = xor <16 x i8> %wide.load62, %wide.load
  %i.x = getelementptr inbounds nuw i8, ptr %2, i64 %.02024.i
  store <16 x i8> %i.w, ptr %i.x, align 1, !tbaa !18
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader
  ...
  %i.aj = load i8, ptr %i.ai, align 4, !tbaa !18
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  store i8 %i.at, ptr %i.au, align 1, !tbaa !18
...
aes_gcm_siv_ctr32.exit:                           ; preds = %bb.b, %._crit_edge28.loopexit.i
  ...
  %i.bj = load i64, ptr %i.bi, align 8, !tbaa !22
  %i.bk = shl i64 %i.bj, 3
  store i64 %i.bk, ptr %i.e, align 16, !tbaa !23
  %i.bl = shl i64 %3, 3
  %i.bm = getelementptr inbounds nuw i8, ptr %i.e, i64 8
  store i64 %i.bl, ptr %i.bm, align 8, !tbaa !23
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %i.f, i8 0, i64 16, i1 false)
  %i.bn = getelementptr inbounds nuw i8, ptr %0, i64 184 ; 5 uses
  %i.bo = getelementptr inbounds nuw i8, ptr %0, i64 120
  call void @ossl_polyval_ghash_init(ptr noundef nonnull %i.bn, ptr noundef nonnull %i.bo) #6
  %i.bp = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.bq = load ptr, ptr %i.bp, align 8, !tbaa !21 ; 2 uses
  %.not48 = icmp eq ptr %i.bq, null
  br i1 %.not48, label %bb.d, label %bb.c

bb.c:                                             ; preds = %aes_gcm_siv_ctr32.exit
  %i.br = load i64, ptr %i.bi, align 8, !tbaa !22
  %i.bs = add i64 %i.br, 15
  %i.bt = and i64 %i.bs, -16
  call void @ossl_polyval_ghash_hash(ptr noundef nonnull %i.bn, ptr noundef nonnull %i.f, ptr noundef nonnull %i.bq, i64 noundef %i.bt) #6
  br label %bb.d

bb.d:                                             ; preds = %bb.c, %aes_gcm_siv_ctr32.exit
  %i.bu = and i64 %3, -16                         ; 3 uses
  %.not49 = icmp eq i64 %i.bu, 0
  br i1 %.not49, label %bb.f, label %bb.e

bb.e:                                             ; preds = %bb.d
  call void @ossl_polyval_ghash_hash(ptr noundef nonnull %i.bn, ptr noundef nonnull %i.f, ptr noundef %2, i64 noundef %i.bu) #6
  br label %bb.f

bb.f:                                             ; preds = %bb.e, %bb.d
  %i.bv = and i64 %3, 15                          ; 4 uses
  %i.bw = icmp eq i64 %i.bv, 0
  br i1 %i.bw, label %bb.h, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.bx = getelementptr inbounds nuw i8, ptr %2, i64 %i.bu
  %i.by = sub nuw nsw i64 16, %i.bv
  %i.bz = getelementptr i8, ptr %i.g, i64 %i.bv
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %i.bz, i8 0, i64 %i.by, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 16 %i.g, ptr align 1 %i.bx, i64 %i.bv, i1 false)
  call void @ossl_polyval_ghash_hash(ptr noundef nonnull %i.bn, ptr noundef nonnull %i.f, ptr noundef nonnull %i.g, i64 noundef 16) #6
  br label %bb.h

bb.h:                                             ; preds = %bb.g, %bb.f
  call void @ossl_polyval_ghash_hash(ptr noundef nonnull %i.bn, ptr noundef nonnull %i.f, ptr noundef nonnull %i.e, i64 noundef 16) #6
  %i.ca = getelementptr inbounds nuw i8, ptr %0, i64 168
  %i.cb = load <8 x i8>, ptr %i.ca, align 8, !tbaa !18
  %i.cc = load <8 x i8>, ptr %i.f, align 16, !tbaa !18
  %i.cd = xor <8 x i8> %i.cc, %i.cb
  store <8 x i8> %i.cd, ptr %i.f, align 16, !tbaa !18
  %i.ce = getelementptr inbounds nuw i8, ptr %0, i64 176
  %i.cf = getelementptr inbounds nuw i8, ptr %i.f, i64 8 ; 2 uses
  %i.cg = load <4 x i8>, ptr %i.ce, align 8, !tbaa !18
  %i.ch = load <4 x i8>, ptr %i.cf, align 8, !tbaa !18
  %i.ci = xor <4 x i8> %i.ch, %i.cg
  store <4 x i8> %i.ci, ptr %i.cf, align 8, !tbaa !18
  %i.cj = getelementptr inbounds nuw i8, ptr %i.f, i64 15 ; 2 uses
  %i.ck = load i8, ptr %i.cj, align 1, !tbaa !18
  %i.cl = and i8 %i.ck, 127
  store i8 %i.cl, ptr %i.cj, align 1, !tbaa !18
  store i32 16, ptr %i.h, align 4, !tbaa !19
  %i.cm = load ptr, ptr %0, align 8, !tbaa !17
  %i.cn = getelementptr inbounds nuw i8, ptr %0, i64 136
  %i.co = call i32 @EVP_EncryptUpdate(ptr noundef %i.cm, ptr noundef nonnull %i.cn, ptr noundef nonnull %i.h, ptr noundef nonnull %i.f, i32 noundef 16) #6
  %.not50 = icmp eq i32 %i.co, 0
  %i.cp = zext i1 %.not50 to i32
  %i.cq = or i32 %.0.lcssa.i, %i.cp
  %i.cr = xor i32 %i.cq, 1                        ; 2 uses
...
!10 = !{!"p1 _ZTS17evp_cipher_ctx_st", !9, i64 0}
!11 = !{!"p1 _ZTS29prov_cipher_hw_aes_gcm_siv_st", !9, i64 0}
!12 = !{!"p1 omnipotent char", !9, i64 0}
!13 = !{!"p1 _ZTS15ossl_lib_ctx_st", !9, i64 0}
!14 = !{!"p1 _ZTS16ossl_provider_st", !9, i64 0}
!15 = !{!"long", !5, i64 0}
!16 = !{!"prov_aes_gcm_siv_ctx_st", !10, i64 0, !11, i64 8, !12, i64 16, !13, i64 24, !14, i64 32, !15, i64 40, !15, i64 48, !5, i64 56, !5, i64 88, !5, i64 120, !5, i64 136, !5, i64 152, !5, i64 168, !5, i64 184, !6, i64 440, !6, i64 440, !6, i64 440, !6, i64 440, !6, i64 440, !6, i64 440}
!17 = !{!16, !10, i64 0}
!18 = !{!5, !5, i64 0}
!19 = !{!6, !6, i64 0}
...
!28 = !{!16, !15, i64 48}
!29 = !{!16, !13, i64 24}
!30 = distinct !{!30, !20, !25, !26}
!31 = distinct !{!31, !20, !25}
!32 = distinct !{!32, !20, !25, !26}
!33 = distinct !{!33, !20, !25}
end_hunk_0
