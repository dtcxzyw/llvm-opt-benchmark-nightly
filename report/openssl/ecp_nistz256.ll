...
._crit_edge:                                      ; preds = %.lr.ph218.preheader, %.preheader
  ...
  %9 = insertelement <2 x i64> <i64 poison, i64 0>, i64 %i.bn, i64 0
  %10 = insertelement <2 x i64> <i64 1, i64 poison>, i64 %i.bn, i64 1
  %11 = sub nsw <2 x i64> %9, %10                 ; 2 uses
  %12 = load <4 x i64>, ptr %i.bl, align 32, !tbaa !29
  %13 = shufflevector <2 x i64> %11, <2 x i64> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %i.br = and <4 x i64> %12, %13
  %i.bs = load <4 x i64>, ptr %i.bm, align 32, !tbaa !29
  %i.bt = shufflevector <2 x i64> %11, <2 x i64> poison, <4 x i32> zeroinitializer
