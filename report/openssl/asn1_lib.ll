...
bb.e:                                             ; preds = %.preheader
  ...
  br i1 %or.cond, label %asn1_get_length.exit.thread, label %.preheader, !llvm.loop !21
...
bb.k:                                             ; preds = %.lr.ph.i
  ...
  br i1 %.not32.i, label %.thread, label %.lr.ph.i, !llvm.loop !22
...
.lr.ph44.i:                                       ; preds = %.lr.ph44.i, %.lr.ph44.i.preheader.new
  ...
  br i1 %niter.ncmp.3.not, label %._crit_edge.i.unr-lcssa, label %.lr.ph44.i, !llvm.loop !23
...
.lr.ph44.i.epil:                                  ; preds = %.lr.ph44.i.epil, %.lr.ph44.i.epil.preheader
  ...
  br i1 %epil.iter.cmp.not, label %._crit_edge.i, label %.lr.ph44.i.epil, !llvm.loop !24
...
.preheader:                                       ; preds = %bb.d, %.preheader
  ...
  br i1 %.not29, label %.loopexit, label %.preheader, !llvm.loop !33
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.g = load i32, ptr %1, align 8, !tbaa !20
...
bb.c:                                             ; preds = %bb.b
  ...
  store i64 %i.o, ptr %i.i, align 8, !tbaa !17
  br label %bb.d
...
bb.g:                                             ; preds = %bb.e
  %i.f = load i32, ptr %0, align 8, !tbaa !20
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.h = load i32, ptr %0, align 8, !tbaa !20
...
ASN1_STRING_copy.exit:                            ; preds = %bb.c
  ...
  store i64 %i.p, ptr %i.j, align 8, !tbaa !17
...
bb.b:                                             ; preds = %bb.a
  %i.c = getelementptr inbounds nuw i8, ptr %i.a, i64 4
  store i32 4, ptr %i.c, align 4, !tbaa !18
...
bb.d:                                             ; preds = %bb.c
  %i.g = load i32, ptr %0, align 8, !tbaa !20
...
bb.a:
  ...
  %i.b = load i32, ptr %1, align 8, !tbaa !20
...
!16 = !{!"asn1_string_st", !5, i64 0, !5, i64 4, !9, i64 8, !14, i64 16}
!17 = !{!16, !14, i64 16}
!18 = !{!16, !5, i64 4}
!19 = !{!16, !9, i64 8}
!20 = !{!16, !5, i64 0}
