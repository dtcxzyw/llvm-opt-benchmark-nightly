...
.lr.ph44.i:                                       ; preds = %.critedge.i.a, %.lr.ph44.i
  ...
  br i1 %5, label %.lr.ph44.i, label %._crit_edge.i, !llvm.loop !22
...
.preheader.i:                                     ; preds = %bb.g, %.preheader.i
  ...
  br i1 %.not.i, label %bb.i, label %.preheader.i, !llvm.loop !28
...
.prol.preheader:                                  ; preds = %bb.i, %.prol.preheader
  ...
  br i1 %prol.iter53.cmp.not, label %.prol.loopexit, label %.prol.preheader, !llvm.loop !29
...
.new:                                             ; preds = %.prol.loopexit, %.new
  ...
  br i1 %i.bj, label %.new, label %.unr-lcssa, !llvm.loop !30
...
.preheader:                                       ; preds = %bb.d, %.preheader
  ...
  br i1 %.not29, label %.loopexit, label %.preheader, !llvm.loop !32
...
bb.a:
  ...
  store i64 %i.g, ptr %i.a, align 8, !tbaa !16
  ret void
}
...
bb.b:                                             ; preds = %bb.a
  ...
  store i32 %i.c, ptr %i.d, align 4, !tbaa !17
  %i.e = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !18
  %i.g = load i32, ptr %1, align 8, !tbaa !19
...
bb.c:                                             ; preds = %bb.b
  ...
  store i64 %i.k, ptr %i.i, align 8, !tbaa !16
  %i.l = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.m = load i64, ptr %i.l, align 8, !tbaa !16
  %i.n = and i64 %i.m, -129
  %i.o = or disjoint i64 %i.n, %i.k
  store i64 %i.o, ptr %i.i, align 8, !tbaa !16
  br label %bb.d
...
bb.g:                                             ; preds = %bb.e
  %i.f = load i32, ptr %0, align 8, !tbaa !19
...
bb.j:                                             ; preds = %._crit_edge, %bb.h
  ...
  store i32 %i.q, ptr %0, align 8, !tbaa !19
...
bb.c:                                             ; preds = %bb.b
  ...
  store i32 %i.e, ptr %i.c, align 4, !tbaa !17
...
bb.b:                                             ; preds = %bb.a
  %i.c = getelementptr inbounds nuw i8, ptr %i.a, i64 4
  store i32 4, ptr %i.c, align 4, !tbaa !17
...
bb.a:
  ...
  %i.b = load i32, ptr %1, align 8, !tbaa !19
...
.lr.ph53.split.us:                                ; preds = %.lr.ph53, %.lr.ph53.split.us
  ...
  %i.ap = load i32, ptr %i.ao, align 8, !tbaa !19
...
.lr.ph53.split.peel.next:                         ; preds = %bb.d, %.lr.ph53.split.peel.next
  ...
  %i.az = load i32, ptr %i.ay, align 8, !tbaa !19
  ...
  %i.be = load ptr, ptr %i.bd, align 8, !tbaa !18
...
!15 = !{!"asn1_string_st", !5, i64 0, !5, i64 4, !9, i64 8, !13, i64 16}
!16 = !{!15, !13, i64 16}
!17 = !{!15, !5, i64 4}
!18 = !{!15, !9, i64 8}
!19 = !{!15, !5, i64 0}
