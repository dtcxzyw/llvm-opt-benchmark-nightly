Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/openssl/original/mem_sec?download=true
...
@.str.15 = private unnamed_addr constant [62 x i8] c"assertion failed: !sh_testbit(temp, (int)slist, sh.bitmalloc)\00", align 1
...
@.str.18 = private unnamed_addr constant [88 x i8] c"assertion failed: temp - (sh.arena_size >> slist) == sh_find_my_buddy(temp, (int)slist)\00", align 1
@.str.19 = private unnamed_addr constant [60 x i8] c"assertion failed: sh_testbit(chunk, (int)list, sh.bittable)\00", align 1
...
@.str.23 = private unnamed_addr constant [58 x i8] c"assertion failed: sh_testbit(ptr, (int)list, sh.bittable)\00", align 1
@.str.24 = private unnamed_addr constant [60 x i8] c"assertion failed: ptr == sh_find_my_buddy(buddy, (int)list)\00", align 1
@.str.26 = private unnamed_addr constant [60 x i8] c"assertion failed: !sh_testbit(ptr, (int)list, sh.bitmalloc)\00", align 1
...
@.str.29 = private unnamed_addr constant [53 x i8] c"assertion failed: sh_testbit(ptr, list, sh.bittable)\00", align 1
...
bb.b:                                             ; preds = %bb.a
  ...
  store ptr %i.a, ptr @sec_malloc_lock, align 8, !tbaa !10
...
bb.d:                                             ; preds = %bb.c
  tail call void @OPENSSL_die(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 443) #10
  unreachable
...
bb.f:                                             ; preds = %bb.e
  tail call void @OPENSSL_die(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 444) #10
  unreachable
...
bb.i:                                             ; preds = %bb.h
  tail call void @OPENSSL_die(ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.1, i32 noundef 465) #10
  unreachable

bb.j:                                             ; preds = %bb.h, %bb.g
  %.035.i = phi i64 [ 16, %bb.g ], [ %1, %bb.h ]  ; 2 uses
  store i64 %0, ptr getelementptr inbounds nuw (i8, ptr @sh, i64 24), align 8, !tbaa !16
  store i64 %.035.i, ptr getelementptr inbounds nuw (i8, ptr @sh, i64 48), align 8, !tbaa !17
...
bb.l:                                             ; preds = %bb.k
  tail call void @OPENSSL_die(ptr noundef nonnull @.str.4, ptr noundef nonnull @.str.1, i32 noundef 483) #10
  unreachable
...
bb.n:                                             ; preds = %bb.m
  tail call void @OPENSSL_die(ptr noundef nonnull @.str.5, ptr noundef nonnull @.str.1, i32 noundef 488) #10
  unreachable
...
bb.p:                                             ; preds = %bb.o
  tail call void @OPENSSL_die(ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.1, i32 noundef 493) #10
  unreachable

bb.q:                                             ; preds = %bb.o
  %i.s = tail call i64 @sysconf(i32 noundef 30) #9 ; 2 uses
  %i.t = icmp slt i64 %i.s, 1
  %..i = select i1 %i.t, i64 4096, i64 %i.s       ; 5 uses
...
bb.r:                                             ; preds = %bb.q
  ...
  br i1 %i.as, label %bb.s, label %sh_init.exit
...
bb.t:                                             ; preds = %bb.s
  ...
  %spec.select46.i = select i1 %i.az, i32 2, i32 %.1.i
...
bb.u:                                             ; preds = %._crit_edge.i, %bb.j
  ...
  %or.cond.i.i = select i1 %i.be, i1 %i.bg, i1 false
  br i1 %or.cond.i.i, label %bb.v, label %sh_init.exit.thread

bb.v:                                             ; preds = %bb.u
  %i.bh = tail call i32 @munmap(ptr noundef %i.bd, i64 noundef %i.bf) #9 ; 0 uses
  br label %sh_init.exit.thread

sh_init.exit.thread:                              ; preds = %bb.u, %bb.v
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(80) @sh, i8 0, i64 80, i1 false)
  %i.bi = load ptr, ptr @sec_malloc_lock, align 8, !tbaa !10
  tail call void @CRYPTO_THREAD_lock_free(ptr noundef %i.bi) #9
  store ptr null, ptr @sec_malloc_lock, align 8, !tbaa !10
  br label %bb.w
...
sh_init.exit:                                     ; preds = %bb.r, %bb.s, %bb.t
  ...
  %spec.select47.i = select i1 %i.bm, i32 2, i32 %.2.i
...
sh_done.exit:                                     ; preds = %bb.b, %bb.c
  ...
  %i.k = load ptr, ptr @sec_malloc_lock, align 8, !tbaa !10
...
bb.c:                                             ; preds = %bb.a
  %i.b = load ptr, ptr @sec_malloc_lock, align 8, !tbaa !10
  %i.c = tail call i32 @CRYPTO_THREAD_write_lock(ptr noundef %i.b) #9
  %.not = icmp eq i32 %i.c, 0
  br i1 %.not, label %.thread, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.d = load i64, ptr getelementptr inbounds nuw (i8, ptr @sh, i64 24), align 8, !tbaa !16 ; 3 uses
...
sh_testbit.exit.i:                                ; preds = %bb.m
  ...
  %i.am = load i8, ptr %i.al, align 1, !tbaa !27
...
bb.o:                                             ; preds = %sh_testbit.exit.i
  tail call void @OPENSSL_die(ptr noundef nonnull @.str.15, ptr noundef nonnull @.str.1, i32 noundef 658) #10
  unreachable
...
bb.p:                                             ; preds = %sh_testbit.exit.i
  ...
  %.pre.i.i = load ptr, ptr %.phi.trans.insert.i.i, align 8, !tbaa !32 ; 2 uses
  br i1 %.not.i71.i, label %._crit_edge.i.i, label %bb.q

bb.q:                                             ; preds = %bb.p
  %i.at = getelementptr inbounds nuw i8, ptr %i.as, i64 8
  store ptr %.pre.i.i, ptr %i.at, align 8, !tbaa !32
...
bb.r:                                             ; preds = %._crit_edge.i.i
  ...
  %i.ax = load ptr, ptr %i.aw, align 8, !tbaa !32 ; 4 uses
...
bb.u:                                             ; preds = %sh_remove_from_list.exit.i
  tail call void @OPENSSL_die(ptr noundef nonnull @.str.16, ptr noundef nonnull @.str.1, i32 noundef 661) #10
  unreachable
...
bb.ab:                                            ; preds = %sh_testbit.exit76.i
  tail call void @OPENSSL_die(ptr noundef nonnull @.str.15, ptr noundef nonnull @.str.1, i32 noundef 667) #10
  unreachable
...
bb.ad:                                            ; preds = %bb.ac
  tail call void @OPENSSL_die(ptr noundef nonnull @.str.17, ptr noundef nonnull @.str.1, i32 noundef 670) #10
  unreachable
...
bb.ak:                                            ; preds = %sh_testbit.exit80.i
  tail call void @OPENSSL_die(ptr noundef nonnull @.str.15, ptr noundef nonnull @.str.1, i32 noundef 674) #10
  unreachable
...
bb.am:                                            ; preds = %bb.al
  tail call void @OPENSSL_die(ptr noundef nonnull @.str.17, ptr noundef nonnull @.str.1, i32 noundef 677) #10
  unreachable

bb.an:                                            ; preds = %bb.al
  %i.dv = load i64, ptr getelementptr inbounds nuw (i8, ptr @sh, i64 24), align 8, !tbaa !16 ; 4 uses
...
.preheader.i._crit_edge:                          ; preds = %.preheader.i.preheader..preheader.i._crit_edge_crit_edge, %.preheader.i._crit_edge.loopexit
  ...
  %i.fb = load ptr, ptr %i.fa, align 8, !tbaa !26 ; 10 uses
...
bb.au:                                            ; preds = %sh_testbit.exit85.i
  tail call void @OPENSSL_die(ptr noundef nonnull @.str.19, ptr noundef nonnull @.str.1, i32 noundef 684) #10
  unreachable
...
bb.av:                                            ; preds = %sh_testbit.exit85.i
  ...
  %.pre.i88.i = load ptr, ptr %.phi.trans.insert.i87.i, align 8, !tbaa !32 ; 2 uses
  br i1 %.not.i86.i, label %._crit_edge.i89.i, label %bb.aw

bb.aw:                                            ; preds = %bb.av
  %i.gc = getelementptr inbounds nuw i8, ptr %i.gb, i64 8
  store ptr %.pre.i88.i, ptr %i.gc, align 8, !tbaa !32
  br label %._crit_edge.i89.i

._crit_edge.i89.i:                                ; preds = %bb.aw, %bb.av
  store ptr %i.gb, ptr %.pre.i88.i, align 8, !tbaa !33
  %i.gd = load ptr, ptr %i.fb, align 8, !tbaa !31 ; 2 uses
...
bb.ba:                                            ; preds = %sh_remove_from_list.exit94.i
  tail call void @OPENSSL_die(ptr noundef nonnull @.str.20, ptr noundef nonnull @.str.1, i32 noundef 688) #10
  unreachable
...
bb.b:                                             ; preds = %bb.a
  tail call void @OPENSSL_die(ptr noundef nonnull @.str.12, ptr noundef nonnull @.str.1, i32 noundef 741) #10
  unreachable
...
bb.g:                                             ; preds = %bb.f
  tail call void @OPENSSL_die(ptr noundef nonnull @.str.28, ptr noundef nonnull @.str.1, i32 noundef 353) #10
  unreachable
...
bb.m:                                             ; preds = %sh_testbit.exit
  tail call void @OPENSSL_die(ptr noundef nonnull @.str.29, ptr noundef nonnull @.str.1, i32 noundef 745) #10
  unreachable
...
bb.c:                                             ; preds = %CRYPTO_secure_allocated.exit
  %i.g = load ptr, ptr @sec_malloc_lock, align 8, !tbaa !10
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(read, argmem: none, inaccessiblemem: none, target_mem: none) uwtable
define range(i32 0, 2) i32 @CRYPTO_secure_allocated(ptr nofree noundef readnone captures(address) %0) local_unnamed_addr #2 {
bb.a:
  %.b = load i1, ptr @secure_mem_initialized, align 4
  br i1 %.b, label %bb.b, label %bb.c
...
bb.b:                                             ; preds = %bb.a
  tail call void @OPENSSL_die(ptr noundef nonnull @.str.12, ptr noundef nonnull @.str.1, i32 noundef 703) #10
  unreachable
...
bb.m:                                             ; preds = %sh_testbit.exit
  tail call void @OPENSSL_die(ptr noundef nonnull @.str.23, ptr noundef nonnull @.str.1, i32 noundef 708) #10
  unreachable
...
bb.o:                                             ; preds = %bb.av, %bb.n
  ...
  %i.bb = load i64, ptr getelementptr inbounds nuw (i8, ptr @sh, i64 24), align 8, !tbaa !16
...
.critedge:                                        ; preds = %bb.r, %bb.q, %sh_find_my_buddy.exit60
  tail call void @OPENSSL_die(ptr noundef nonnull @.str.24, ptr noundef nonnull @.str.1, i32 noundef 714) #10
  unreachable
...
bb.y:                                             ; preds = %sh_testbit.exit64
  tail call void @OPENSSL_die(ptr noundef nonnull @.str.26, ptr noundef nonnull @.str.1, i32 noundef 716) #10
  unreachable
...
bb.z:                                             ; preds = %sh_testbit.exit64
  ...
  %i.cz = load ptr, ptr %.043, align 8, !tbaa !31 ; 3 uses
  %.not.i65 = icmp eq ptr %i.cz, null
  %.phi.trans.insert.i = getelementptr inbounds nuw i8, ptr %.043, i64 8
  %.pre.i = load ptr, ptr %.phi.trans.insert.i, align 8, !tbaa !32 ; 2 uses
  br i1 %.not.i65, label %._crit_edge.i, label %bb.aa

bb.aa:                                            ; preds = %bb.z
  %i.da = getelementptr inbounds nuw i8, ptr %i.cz, i64 8
  store ptr %.pre.i, ptr %i.da, align 8, !tbaa !32
  br label %._crit_edge.i

._crit_edge.i:                                    ; preds = %bb.aa, %bb.z
  store ptr %i.cz, ptr %.pre.i, align 8, !tbaa !33
  %i.db = load ptr, ptr %.043, align 8, !tbaa !31 ; 2 uses
...
bb.aj:                                            ; preds = %sh_testbit.exit70
  tail call void @OPENSSL_die(ptr noundef nonnull @.str.26, ptr noundef nonnull @.str.1, i32 noundef 719) #10
  unreachable
...
bb.ak:                                            ; preds = %sh_testbit.exit70
  ...
  %.pre.i73 = load ptr, ptr %.phi.trans.insert.i72, align 8, !tbaa !32 ; 2 uses
  br i1 %.not.i71, label %._crit_edge.i74, label %bb.al

bb.al:                                            ; preds = %bb.ak
  %i.ej = getelementptr inbounds nuw i8, ptr %i.ei, i64 8
  store ptr %.pre.i73, ptr %i.ej, align 8, !tbaa !32
  br label %._crit_edge.i74

._crit_edge.i74:                                  ; preds = %bb.al, %bb.ak
  store ptr %i.ei, ptr %.pre.i73, align 8, !tbaa !33
  %i.ek = load ptr, ptr %i.bw, align 8, !tbaa !31 ; 2 uses
...
bb.aq:                                            ; preds = %sh_remove_from_list.exit79
  ...
  %i.fh = load i64, ptr getelementptr inbounds nuw (i8, ptr @sh, i64 24), align 8, !tbaa !16
...
sh_testbit.exit83:                                ; preds = %bb.as
  ...
  %i.ft = load i8, ptr %i.fs, align 1, !tbaa !27
...
bb.au:                                            ; preds = %sh_testbit.exit83
  tail call void @OPENSSL_die(ptr noundef nonnull @.str.26, ptr noundef nonnull @.str.1, i32 noundef 730) #10
  unreachable
...
bb.b:                                             ; preds = %bb.a
  %i.a = load ptr, ptr @sec_malloc_lock, align 8, !tbaa !10
...
bb.d:                                             ; preds = %bb.b, %bb.a, %bb.c
  %.0 = phi i64 [ %i.c, %bb.c ], [ 0, %bb.a ], [ 0, %bb.b ]
  ret i64 %.0
}
...
declare noalias ptr @CRYPTO_calloc(i64 noundef, i64 noundef, ptr noundef, i32 noundef) local_unnamed_addr #1
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.i = load i64, ptr getelementptr inbounds nuw (i8, ptr @sh, i64 24), align 8, !tbaa !16
...
bb.g:                                             ; preds = %bb.e
  ...
  %i.u = load i8, ptr %i.t, align 1, !tbaa !27    ; 2 uses
...
bb.i:                                             ; preds = %bb.g
  ...
  %i.aa = or i8 %i.u, %i.z
  store i8 %i.aa, ptr %i.t, align 1, !tbaa !27
  ret void
}
...
bb.e:                                             ; preds = %bb.c
  %i.i = load ptr, ptr %0, align 8, !tbaa !33     ; 5 uses
  store ptr %i.i, ptr %1, align 8, !tbaa !31
  %i.j = icmp eq ptr %i.i, null
  br i1 %i.j, label %.thread, label %bb.f

.thread:                                          ; preds = %bb.e
  %i.k = getelementptr inbounds nuw i8, ptr %1, i64 8
  store ptr %0, ptr %i.k, align 8, !tbaa !32
  br label %bb.k
...
bb.j:                                             ; preds = %bb.h
  store ptr %1, ptr %i.n, align 8, !tbaa !32
  br label %bb.k
...
bb.i:                                             ; preds = %bb.g
  ...
  store i8 %i.ab, ptr %i.t, align 1, !tbaa !27
  ret void
}
...
!29 = !{!"p2 _ZTS10sh_list_st", !13, i64 0}
!30 = !{!"sh_list_st", !28, i64 0, !29, i64 8}
!31 = !{!30, !28, i64 0}
!32 = !{!30, !29, i64 8}
!33 = !{!28, !28, i64 0}
!34 = distinct !{!34, !18}
