...
bb.e:                                             ; preds = %bb.d
  ...
  store i32 2, ptr %i.i, align 8, !tbaa !130
...
.sink.split:                                      ; preds = %bb.c, %bb.b
  ...
  store i32 %.sink, ptr %i.m, align 8, !tbaa !130
  br label %bb.g
...
bb.a:
  ...
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !28   ; 9 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.l = load i64, ptr %i.k, align 8, !tbaa !276  ; 2 uses
  %i.m = add i64 %i.l, 2
  %i.n = udiv i64 %i.m, 3
  %i.o = shl i64 %i.n, 2
  %i.p = udiv i64 %i.l, 48
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.v = load i64, ptr %i.k, align 8, !tbaa !276
  br label %bb.f
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.aj = load i32, ptr %i.a, align 4, !tbaa !14
  %i.ak = add nsw i32 %i.aj, %.086                ; 3 uses
  %.not98 = icmp eq i64 %i.ai, 0
  br i1 %.not98, label %bb.h, label %bb.f, !llvm.loop !273
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.an = load i32, ptr %i.a, align 4, !tbaa !14
  %i.ao = add nsw i32 %i.an, %i.ak
  %i.ap = getelementptr inbounds nuw i8, ptr %i.c, i64 16
  %i.aq = load ptr, ptr %i.ap, align 8, !tbaa !132 ; 2 uses
  %i.ar = getelementptr inbounds nuw i8, ptr %i.c, i64 24
  %i.as = load i64, ptr %i.ar, align 8, !tbaa !277 ; 2 uses
...
memory_err_compare.exit:                          ; preds = %.split, %bb.j, %bb.b
  ...
  %i.bc = load i64, ptr %i.bb, align 8, !tbaa !277
  %i.bd = add i64 %i.bc, 3
...
bb.k:                                             ; preds = %memory_err_compare.exit
  ...
  %i.bj = load i64, ptr %i.bb, align 8, !tbaa !277
...
bb.l:                                             ; preds = %bb.m, %bb.k
  ...
  %i.bl = load i32, ptr @data_chunk_size, align 4, !tbaa !14 ; 2 uses
  ...
  %i.br = load ptr, ptr %i.bk, align 8, !tbaa !132
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.by = load i32, ptr %i.a, align 4, !tbaa !14
  %i.bz = add nsw i32 %i.by, %.288                ; 3 uses
  %.not101 = icmp eq i64 %i.bx, 0
  br i1 %.not101, label %bb.n, label %bb.l, !llvm.loop !274
...
bb.o:                                             ; preds = %bb.n
  %i.cd = load i32, ptr %i.a, align 4, !tbaa !14
  %i.ce = add i32 %i.cd, %i.bz                    ; 3 uses
  %i.cf = load i32, ptr %i.f, align 8, !tbaa !130
  %.not103 = icmp eq i32 %i.cf, 2
  br i1 %.not103, label %memory_err_compare.exit114, label %bb.p

bb.p:                                             ; preds = %bb.o
  %i.cg = load ptr, ptr %i.c, align 8, !tbaa !131 ; 2 uses
  %i.ch = getelementptr inbounds nuw i8, ptr %i.c, i64 8
  %i.ci = load i64, ptr %i.ch, align 8, !tbaa !276 ; 2 uses
...
bb.s:                                             ; preds = %.lr.ph
  ...
  br i1 %exitcond.not, label %.loopexit.sink.split, label %.lr.ph, !llvm.loop !275
...
.loopexit.sink.split:                             ; preds = %bb.l, %bb.s, %.lr.ph, %memory_err_compare.exit114, %bb.r, %.split140, %bb.n, %bb.j, %.split, %bb.a
  ...
  store ptr %.str.305.sink, ptr %i.cw, align 8, !tbaa !51
  br label %.loopexit
...
bb.b:                                             ; preds = %bb.a
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(40) %i.c, ptr noundef nonnull align 8 dereferenceable(40) %2, i64 40, i1 false), !tbaa.struct !76
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #12
  %i.e = load ptr, ptr @libctx, align 8, !tbaa !20
  %i.f = load ptr, ptr @propquery, align 8, !tbaa !18
...
bb.d:                                             ; preds = %bb.b
  ...
  store ptr %i.i, ptr %i.a, align 8, !tbaa !137
  call void @EVP_KDF_free(ptr noundef nonnull %i.g) #12
  %i.j = load ptr, ptr %i.a, align 8, !tbaa !137
...
bb.f:                                             ; preds = %bb.d
  ...
  store ptr %i.a, ptr %i.l, align 8, !tbaa !28
  ...
  store ptr %i.n, ptr %i.o, align 8, !tbaa !138
  br label %bb.g
...
bb.h:                                             ; preds = %bb.g
  %i.r = load ptr, ptr %i.b, align 8, !tbaa !137
