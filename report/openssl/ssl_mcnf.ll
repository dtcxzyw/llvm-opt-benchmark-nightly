...
bb.p:                                             ; preds = %bb.o, %bb.n
  %.049.a = phi ptr [ %i.w, %bb.n ], [ %i.aa, %bb.o ] ; 2 uses
  %.048.in = phi ptr [ %i.y, %bb.n ], [ %1, %bb.o ]
  %.048.a = load ptr, ptr %.048.in, align 8, !tbaa !19 ; 2 uses
  %i.ab = call i32 @OSSL_LIB_CTX_get_conf_diagnostics(ptr noundef %.048.a) #4
  ...
  %i.ad = getelementptr inbounds nuw i8, ptr %.049.a, i64 64
  ...
  %i.ag = getelementptr inbounds nuw i8, ptr %.049.a, i64 72
  ...
  %i.ak = call ptr @OSSL_LIB_CTX_set0_default(ptr noundef %.048.a) #4
  %i.al = load i64, ptr %i.c, align 8, !tbaa !51
  %.not = icmp eq i64 %i.al, 0
  br i1 %.not, label %._crit_edge, label %.lr.ph

.lr.ph:                                           ; preds = %bb.p, %.lr.ph
  %.05276 = phi i32 [ %spec.select72, %.lr.ph ], [ 0, %bb.p ]
  %.05575 = phi i64 [ %i.ar, %.lr.ph ], [ 0, %bb.p ] ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d) #4
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e) #4
  call void @conf_ssl_get_cmd(ptr noundef %i.s, i64 noundef %.05575, ptr noundef nonnull %i.d, ptr noundef nonnull %i.e) #4
  ...
  %spec.select72 = add nuw nsw i32 %.05276, %i.aq ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e) #4
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d) #4
  %i.ar = add nuw i64 %.05575, 1                  ; 2 uses
...
bb.q:                                             ; preds = %._crit_edge, %bb.l, %bb.j, %bb.k, %bb.e, %bb.b
  ...
  %.254 = phi i1 [ false, %bb.b ], [ false, %bb.e ], [ false, %bb.k ], [ %i.ax, %._crit_edge ], [ false, %bb.l ], [ false, %bb.j ]
  %.050 = phi i32 [ 1, %bb.b ], [ 1, %bb.e ], [ 1, %bb.k ], [ %i.ay, %._crit_edge ], [ 1, %bb.l ], [ 1, %bb.j ]
  %.0 = phi ptr [ null, %bb.b ], [ null, %bb.e ], [ null, %bb.k ], [ %i.ak, %._crit_edge ], [ null, %bb.l ], [ null, %bb.j ]
  %i.az = call ptr @OSSL_LIB_CTX_set0_default(ptr noundef %.0) #4 ; 0 uses
  call void @SSL_CONF_CTX_free(ptr noundef %.056) #4
  %.not69 = icmp eq i32 %.057, 0
  %spec.select81 = select i1 %.not69, i32 0, i32 %.050
  %i.ba = select i1 %.254, i32 1, i32 %spec.select81
