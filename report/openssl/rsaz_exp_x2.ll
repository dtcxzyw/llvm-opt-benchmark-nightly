...
.lr.ph48.i:                                       ; preds = %.preheader.i, %.lr.ph48.i
  ...
  br i1 %i.hf, label %.lr.ph48.i, label %._crit_edge.i119, !llvm.loop !14
...
.lr.ph.i.i:                                       ; preds = %._crit_edge.i119
  %i.hh = load i64, ptr %.032.lcssa.i, align 8, !tbaa !9 ; 7 uses
  %i.hi = trunc i64 %i.hh to i8
  %i.hj = getelementptr inbounds nuw i8, ptr %.030.lcssa.i, i64 1
  store i8 %i.hi, ptr %.030.lcssa.i, align 1, !tbaa !11
...
.lr.ph.i33.i.prol:                                ; preds = %.lr.ph.i.i, %.lr.ph.i33.i.prol
  ...
  store i8 %i.ii, ptr %.056.i36.i.prol, align 1, !tbaa !11
  ...
  br i1 %prol.iter227.cmp.not, label %.lr.ph.i33.i.prol.loopexit, label %.lr.ph.i33.i.prol, !llvm.loop !15
...
.lr.ph.i33.i:                                     ; preds = %.lr.ph.i33.i.prol.loopexit, %.lr.ph.i33.i
  ...
  store i8 %i.in, ptr %.056.i36.i, align 1, !tbaa !11
...
.lr.ph.i38.preheader.i:                           ; preds = %bb.o
  %i.jp = load i64, ptr %.032.lcssa.i, align 8, !tbaa !9 ; 2 uses
...
.lr.ph.i38.i.prol:                                ; preds = %.lr.ph.i38.preheader.i, %.lr.ph.i38.i.prol
  ...
  store i8 %i.jq, ptr %.056.i41.i.prol, align 1, !tbaa !11
...
.lr.ph.i38.i:                                     ; preds = %.lr.ph.i38.i.prol.loopexit, %.lr.ph.i38.i
  ...
  store i8 %i.jv, ptr %.056.i41.i, align 1, !tbaa !11
  ...
  br i1 %i.kt, label %.lr.ph.i38.i, label %from_words52.exit, !llvm.loop !16
...
.lr.ph.preheader.i142:                            ; preds = %from_words52.exit
  ...
  call void @llvm.memset.p0.i64(ptr align 8 %6, i8 0, i64 %i.kv, i1 false), !tbaa !9
...
.lr.ph48.i138:                                    ; preds = %.preheader.i122, %.lr.ph48.i138
  ...
  %i.kw = load i64, ptr %.03245.i141, align 8, !tbaa !9 ; 2 uses
  ...
  %i.la = load i64, ptr %i.kz, align 8, !tbaa !9
  %i.lb = shl i64 %i.la, 4
  ...
  br i1 %i.lg, label %.lr.ph48.i138, label %._crit_edge.i123, !llvm.loop !14
...
.lr.ph.i.i133:                                    ; preds = %._crit_edge.i123
  ...
  %i.mf = load i64, ptr %i.me, align 8, !tbaa !9
  %i.mg = shl i64 %i.mf, 4
...
.lr.ph.i33.i134.prol:                             ; preds = %.lr.ph.i.i133, %.lr.ph.i33.i134.prol
  ...
  store i8 %i.mj, ptr %.056.i36.i137.prol, align 1, !tbaa !11
  ...
  br i1 %prol.iter233.cmp.not, label %.lr.ph.i33.i134.prol.loopexit, label %.lr.ph.i33.i134.prol, !llvm.loop !18
...
.lr.ph.i33.i134:                                  ; preds = %.lr.ph.i33.i134.prol.loopexit, %.lr.ph.i33.i134
  ...
  store i8 %i.mo, ptr %.056.i36.i137, align 1, !tbaa !11
  ...
  br i1 %i.nm, label %.lr.ph.i33.i134, label %from_words52.exit143, !llvm.loop !16
...
.lr.ph.i38.preheader.i128:                        ; preds = %bb.q
  %i.nq = load i64, ptr %.032.lcssa.i124, align 8, !tbaa !9 ; 2 uses
...
.lr.ph.i38.i129.prol:                             ; preds = %.lr.ph.i38.preheader.i128, %.lr.ph.i38.i129.prol
  ...
  store i8 %i.nr, ptr %.056.i41.i132.prol, align 1, !tbaa !11
  ...
  br i1 %prol.iter230.cmp.not, label %.lr.ph.i38.i129.prol.loopexit, label %.lr.ph.i38.i129.prol, !llvm.loop !19
...
.lr.ph.i38.i129:                                  ; preds = %.lr.ph.i38.i129.prol.loopexit, %.lr.ph.i38.i129
  ...
  store i8 %i.nw, ptr %.056.i41.i132, align 1, !tbaa !11
  ...
  br i1 %i.ou, label %.lr.ph.i38.i129, label %from_words52.exit143, !llvm.loop !16
...
from_words52.exit143:                             ; preds = %.lr.ph.i38.i129.prol.loopexit, %.lr.ph.i38.i129, %.lr.ph.i33.i134.prol.loopexit, %.lr.ph.i33.i134, %bb.p, %bb.q
  ...
  %i.oy = sub i64 0, %i.ox
  %i.oz = call i64 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %i.oy) #8, !srcloc !27 ; 2 uses
  %i.pa = add i64 %i.ox, -1
  %i.pb = call i64 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %i.pa) #8, !srcloc !27 ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %i.pc, align 8, !tbaa !9
  %wide.load197 = load <2 x i64>, ptr %i.pd, align 8, !tbaa !9
  %i.pe = getelementptr inbounds nuw [8 x i8], ptr %i.w, i64 %index ; 2 uses
  %i.pf = getelementptr inbounds nuw i8, ptr %i.pe, i64 16
  %wide.load198 = load <2 x i64>, ptr %i.pe, align 8, !tbaa !9
  %wide.load199 = load <2 x i64>, ptr %i.pf, align 8, !tbaa !9
  ...
  store <2 x i64> %i.pk, ptr %i.pc, align 8, !tbaa !9
  store <2 x i64> %i.pl, ptr %i.pd, align 8, !tbaa !9
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.pm = icmp eq i64 %index.next, %n.vec
  br i1 %i.pm, label %middle.block, label %vector.body, !llvm.loop !20
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %i.po = load i64, ptr %i.pn, align 8, !tbaa !9
  ...
  store i64 %i.pt, ptr %i.pn, align 8, !tbaa !9
...
.lr.ph.i.i146:                                    ; preds = %scalar.ph, %middle.block
  ...
  %i.pw = sub i64 0, %i.pv
  %i.px = call i64 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %i.pw) #8, !srcloc !27 ; 2 uses
  %i.py = add i64 %i.pv, -1
  %i.pz = call i64 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %i.py) #8, !srcloc !27 ; 2 uses
...
vector.body208:                                   ; preds = %vector.body208, %vector.ph202
  ...
  %wide.load210 = load <2 x i64>, ptr %i.qa, align 8, !tbaa !9
  %wide.load211 = load <2 x i64>, ptr %i.qb, align 8, !tbaa !9
  %i.qc = getelementptr inbounds nuw [8 x i8], ptr %i.w, i64 %index209 ; 2 uses
  %i.qd = getelementptr inbounds nuw i8, ptr %i.qc, i64 16
  %wide.load212 = load <2 x i64>, ptr %i.qc, align 8, !tbaa !9
  %wide.load213 = load <2 x i64>, ptr %i.qd, align 8, !tbaa !9
  ...
  store <2 x i64> %i.qi, ptr %i.qa, align 8, !tbaa !9
  store <2 x i64> %i.qj, ptr %i.qb, align 8, !tbaa !9
  %index.next214 = add nuw i64 %index209, 4       ; 2 uses
  %i.qk = icmp eq i64 %index.next214, %n.vec203
  br i1 %i.qk, label %middle.block215, label %vector.body208, !llvm.loop !22
...
get_digit.exit44:                                 ; preds = %bb.e
  store i64 %i.bn, ptr %.0.lcssa, align 8, !tbaa !9
