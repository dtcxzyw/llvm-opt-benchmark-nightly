...
bb.m:                                             ; preds = %bb.l
  ...
  store i64 1, ptr %i.cf, align 8, !tbaa !10
  store i64 1, ptr %i.ci, align 8, !tbaa !10
...
.lr.ph.preheader.i121:                            ; preds = %bb.m
  ...
  call void @llvm.memset.p0.i64(ptr align 8 %0, i8 0, i64 %i.gt, i1 false), !tbaa !10
...
.lr.ph48.i.prol:                                  ; preds = %.lr.ph48.i.preheader
  %i.gy = load i64, ptr %i.am, align 8, !tbaa !10 ; 2 uses
...
.lr.ph48.i:                                       ; preds = %.lr.ph48.i.prol.loopexit, %.lr.ph48.i
  ...
  %i.hj = load i64, ptr %.03245.i, align 8, !tbaa !10 ; 2 uses
  ...
  %i.hs = load i64, ptr %i.hr, align 8, !tbaa !10 ; 2 uses
...
.lr.ph.i.i:                                       ; preds = %._crit_edge.i119
  ...
  %i.jc = shl i64 %i.jb, 4
  %i.jd = or i64 %i.jc, %i.iw
  br label %.lr.ph.i33.i

.lr.ph.i33.i:                                     ; preds = %.lr.ph.i33.i, %.lr.ph.i.i
  %.08.i34.i = phi i64 [ %i.jg, %.lr.ph.i33.i ], [ %i.jd, %.lr.ph.i.i ] ; 2 uses
  %.047.i35.i = phi i32 [ %i.jh, %.lr.ph.i33.i ], [ %i.iz, %.lr.ph.i.i ] ; 2 uses
  %.056.i36.i = phi ptr [ %i.jf, %.lr.ph.i33.i ], [ %i.iv, %.lr.ph.i.i ] ; 2 uses
  %i.je = trunc i64 %.08.i34.i to i8
  %i.jf = getelementptr inbounds nuw i8, ptr %.056.i36.i, i64 1
  store i8 %i.je, ptr %.056.i36.i, align 1, !tbaa !16
  %i.jg = lshr i64 %.08.i34.i, 8
  %i.jh = add nsw i32 %.047.i35.i, -1
  %13 = icmp samesign ugt i32 %.047.i35.i, 1
  br i1 %13, label %.lr.ph.i33.i, label %from_words52.exit, !llvm.loop !17
...
.lr.ph.i38.preheader.i:                           ; preds = %bb.o
  %i.jl = load i64, ptr %.032.lcssa.i, align 8, !tbaa !10 ; 2 uses
...
.lr.ph.i38.i.prol:                                ; preds = %.lr.ph.i38.preheader.i, %.lr.ph.i38.i.prol
  ...
  store i8 %i.jm, ptr %.056.i41.i.prol, align 1, !tbaa !16
...
.lr.ph.i38.i:                                     ; preds = %.lr.ph.i38.i.prol.loopexit, %.lr.ph.i38.i
  ...
  br i1 %i.kp, label %.lr.ph.i38.i, label %from_words52.exit, !llvm.loop !17

from_words52.exit:                                ; preds = %.lr.ph.i38.i.prol.loopexit, %.lr.ph.i38.i, %.lr.ph.i33.i, %bb.n, %bb.o
...
.lr.ph.preheader.i142:                            ; preds = %from_words52.exit
  ...
  call void @llvm.memset.p0.i64(ptr align 8 %6, i8 0, i64 %i.kr, i1 false), !tbaa !10
...
.lr.ph48.i138.prol:                               ; preds = %.lr.ph48.i138.preheader
  %i.kv = load i64, ptr %i.ap, align 8, !tbaa !10 ; 2 uses
...
.lr.ph48.i138:                                    ; preds = %.lr.ph48.i138.prol.loopexit, %.lr.ph48.i138
  ...
  %i.lg = load i64, ptr %.03245.i141, align 8, !tbaa !10 ; 2 uses
  ...
  %i.lk = load i64, ptr %i.lj, align 8, !tbaa !10
  %i.ll = shl i64 %i.lk, 4
  ...
  %i.lp = load i64, ptr %i.lo, align 8, !tbaa !10 ; 2 uses
  ...
  br i1 %i.lz, label %.lr.ph48.i138, label %._crit_edge.i123, !llvm.loop !15
...
.lr.ph.i.i133:                                    ; preds = %._crit_edge.i123
  ...
  %i.mz = shl i64 %i.my, 4
  %i.na = or i64 %i.mz, %i.mt
  br label %.lr.ph.i33.i134

.lr.ph.i33.i134:                                  ; preds = %.lr.ph.i33.i134, %.lr.ph.i.i133
  %.08.i34.i135 = phi i64 [ %i.nd, %.lr.ph.i33.i134 ], [ %i.na, %.lr.ph.i.i133 ] ; 2 uses
  %.047.i35.i136 = phi i32 [ %i.ne, %.lr.ph.i33.i134 ], [ %i.mw, %.lr.ph.i.i133 ] ; 2 uses
  %.056.i36.i137 = phi ptr [ %i.nc, %.lr.ph.i33.i134 ], [ %i.ms, %.lr.ph.i.i133 ] ; 2 uses
  %i.nb = trunc i64 %.08.i34.i135 to i8
  %i.nc = getelementptr inbounds nuw i8, ptr %.056.i36.i137, i64 1
  store i8 %i.nb, ptr %.056.i36.i137, align 1, !tbaa !16
  %i.nd = lshr i64 %.08.i34.i135, 8
  %i.ne = add nsw i32 %.047.i35.i136, -1
  %14 = icmp samesign ugt i32 %.047.i35.i136, 1
  br i1 %14, label %.lr.ph.i33.i134, label %from_words52.exit143, !llvm.loop !17
...
.lr.ph.i38.preheader.i128:                        ; preds = %bb.q
  %i.ni = load i64, ptr %.032.lcssa.i124, align 8, !tbaa !10 ; 2 uses
...
.lr.ph.i38.i129.prol:                             ; preds = %.lr.ph.i38.preheader.i128, %.lr.ph.i38.i129.prol
  ...
  store i8 %i.nj, ptr %.056.i41.i132.prol, align 1, !tbaa !16
  ...
  br i1 %prol.iter232.cmp.not, label %.lr.ph.i38.i129.prol.loopexit, label %.lr.ph.i38.i129.prol, !llvm.loop !20
...
from_words52.exit143:                             ; preds = %.lr.ph.i38.i129.prol.loopexit, %.lr.ph.i38.i129, %.lr.ph.i33.i134, %bb.p, %bb.q
  ...
  %i.oq = sub i64 0, %i.op
  %i.or = call i64 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %i.oq) #8, !srcloc !21 ; 2 uses
  %i.os = add i64 %i.op, -1
  %i.ot = call i64 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %i.os) #8, !srcloc !21 ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %i.ou, align 8, !tbaa !10
  %wide.load197 = load <2 x i64>, ptr %i.ov, align 8, !tbaa !10
  %i.ow = getelementptr inbounds nuw [8 x i8], ptr %i.w, i64 %index ; 2 uses
  %i.ox = getelementptr inbounds nuw i8, ptr %i.ow, i64 16
  %wide.load198 = load <2 x i64>, ptr %i.ow, align 8, !tbaa !10
  %wide.load199 = load <2 x i64>, ptr %i.ox, align 8, !tbaa !10
  ...
  store <2 x i64> %i.pc, ptr %i.ou, align 8, !tbaa !10
  store <2 x i64> %i.pd, ptr %i.ov, align 8, !tbaa !10
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.pe = icmp eq i64 %index.next, %n.vec
  br i1 %i.pe, label %middle.block, label %vector.body, !llvm.loop !22
...
.lr.ph.i.i146:                                    ; preds = %scalar.ph, %middle.block
  ...
  %i.po = sub i64 0, %i.pn
  %i.pp = call i64 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %i.po) #8, !srcloc !21 ; 2 uses
  %i.pq = add i64 %i.pn, -1
  %i.pr = call i64 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %i.pq) #8, !srcloc !21 ; 2 uses
...
vector.body208:                                   ; preds = %vector.body208, %vector.ph202
  ...
  %wide.load210 = load <2 x i64>, ptr %i.ps, align 8, !tbaa !10
  %wide.load211 = load <2 x i64>, ptr %i.pt, align 8, !tbaa !10
  %i.pu = getelementptr inbounds nuw [8 x i8], ptr %i.w, i64 %index209 ; 2 uses
  %i.pv = getelementptr inbounds nuw i8, ptr %i.pu, i64 16
  %wide.load212 = load <2 x i64>, ptr %i.pu, align 8, !tbaa !10
  %wide.load213 = load <2 x i64>, ptr %i.pv, align 8, !tbaa !10
  ...
  store <2 x i64> %i.qa, ptr %i.ps, align 8, !tbaa !10
  store <2 x i64> %i.qb, ptr %i.pt, align 8, !tbaa !10
  %index.next214 = add nuw i64 %index209, 4       ; 2 uses
  %i.qc = icmp eq i64 %index.next214, %n.vec203
  br i1 %i.qc, label %middle.block215, label %vector.body208, !llvm.loop !26
...
scalar.ph200:                                     ; preds = %scalar.ph200.preheader, %scalar.ph200
  ...
  %i.qe = load i64, ptr %i.qd, align 8, !tbaa !10
  ...
  store i64 %i.qj, ptr %i.qd, align 8, !tbaa !10
  %i.qk = add nuw i64 %.09.i.i147, 1              ; 2 uses
  %exitcond.not.i.i148 = icmp eq i64 %i.qk, %i.oo
  br i1 %exitcond.not.i.i148, label %RSAZ_mod_exp_x2_ifma256.exit.thread, label %scalar.ph200, !llvm.loop !27
...
.lr.ph.prol:                                      ; preds = %.lr.ph.preheader
  ...
  store i64 %i.e, ptr %0, align 8, !tbaa !10
...
.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  ...
  store i64 %i.o, ptr %.050, align 8, !tbaa !10
  ...
  store i64 %i.y, ptr %i.z, align 8, !tbaa !10
  ...
  br i1 %i.ae, label %.lr.ph, label %._crit_edge, !llvm.loop !28
...
bb.b:                                             ; preds = %bb.b, %.preheader.preheader
  ...
  br i1 %i.bu, label %bb.b, label %get_digit.exit40, !llvm.loop !29
...
bb.e:                                             ; preds = %bb.e, %bb.d
  ...
  br i1 %i.cj, label %bb.e, label %get_digit.exit44, !llvm.loop !29

get_digit.exit44:                                 ; preds = %bb.e
  store i64 %i.ci, ptr %.0.lcssa, align 8, !tbaa !10
...
!25 = distinct !{!25, !14, !24, !23}
!26 = distinct !{!26, !14, !23, !24}
!27 = distinct !{!27, !14, !24, !23}
!28 = distinct !{!28, !14}
!29 = distinct !{!29, !14}
end_hunk_0
