...
.lr.ph.i33.i:                                     ; preds = %.lr.ph.i33.i.prol.loopexit, %.lr.ph.i33.i
  ...
  br i1 %i.jl, label %.lr.ph.i33.i, label %from_words52.exit, !llvm.loop !17
...
.lr.ph.i38.i:                                     ; preds = %.lr.ph.i38.i.prol.loopexit, %.lr.ph.i38.i
  ...
  br i1 %i.kt, label %.lr.ph.i38.i, label %from_words52.exit, !llvm.loop !17
...
.lr.ph48.i138:                                    ; preds = %.preheader.i122, %.lr.ph48.i138
  ...
  br i1 %i.lg, label %.lr.ph48.i138, label %._crit_edge.i123, !llvm.loop !15
...
.lr.ph.i33.i134:                                  ; preds = %.lr.ph.i33.i134.prol.loopexit, %.lr.ph.i33.i134
  ...
  br i1 %i.nm, label %.lr.ph.i33.i134, label %from_words52.exit143, !llvm.loop !17
...
.lr.ph.i38.i129:                                  ; preds = %.lr.ph.i38.i129.prol.loopexit, %.lr.ph.i38.i129
  ...
  br i1 %i.ou, label %.lr.ph.i38.i129, label %from_words52.exit143, !llvm.loop !17
...
from_words52.exit143:                             ; preds = %.lr.ph.i38.i129.prol.loopexit, %.lr.ph.i38.i129, %.lr.ph.i33.i134.prol.loopexit, %.lr.ph.i33.i134, %bb.p, %bb.q
  ...
  %i.ox = call i64 @bn_sub_words(ptr noundef nonnull %i.w, ptr noundef %0, ptr noundef %3, i32 noundef %i.ov) #7 ; 2 uses
  %i.oy = sub i64 0, %i.ox
  %i.oz = call i64 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %i.oy) #9, !srcloc !27 ; 2 uses
  %i.pa = add i64 %i.ox, -1
  %i.pb = call i64 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %i.pa) #9, !srcloc !27 ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.pm, label %middle.block, label %vector.body, !llvm.loop !21
...
.lr.ph.i.i146:                                    ; preds = %scalar.ph, %middle.block
  %i.pv = call i64 @bn_sub_words(ptr noundef nonnull %i.w, ptr noundef %6, ptr noundef %9, i32 noundef %i.ov) #7 ; 2 uses
  %i.pw = sub i64 0, %i.pv
  %i.px = call i64 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %i.pw) #9, !srcloc !27 ; 2 uses
  %i.py = add i64 %i.pv, -1
  %i.pz = call i64 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %i.py) #9, !srcloc !27 ; 2 uses
...
vector.body208:                                   ; preds = %vector.body208, %vector.ph202
  ...
  br i1 %i.qk, label %middle.block215, label %vector.body208, !llvm.loop !23
