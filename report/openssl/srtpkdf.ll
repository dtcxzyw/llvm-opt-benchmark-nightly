...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.bn = sub nuw nsw i64 13, %index
  %i.bo = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.bn ; 2 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.bw = sub nuw nsw i64 13, %index44
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  ...
  %i.ce = sub nuw nsw i64 14, %indvars.iv.i
  %i.cf = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.ce ; 2 uses
