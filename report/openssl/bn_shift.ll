...
define range(i32 0, 2) i32 @BN_lshift1(ptr noundef %0, ptr nofree noundef readonly captures(address) %1) local_unnamed_addr #0 {
bb.a:
  %.not = icmp eq ptr %0, %1
...
bb.c:                                             ; preds = %bb.b
  %i.i = load i32, ptr %i.d, align 8, !tbaa !12   ; 2 uses
  %i.j = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i32 %i.i, ptr %i.j, align 8, !tbaa !12
  br label %bb.e
...
._crit_edge37:                                    ; preds = %bb.d
  %.pre = load i32, ptr %i.k, align 8, !tbaa !12
  br label %bb.e

bb.e:                                             ; preds = %._crit_edge37, %bb.c
  %i.p = phi i32 [ %.pre, %._crit_edge37 ], [ %i.i, %bb.c ] ; 4 uses
  %i.q = load ptr, ptr %0, align 8, !tbaa !13     ; 3 uses
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph.epil, %bb.e
  ...
  store i64 %.024.lcssa, ptr %.026.lcssa, align 8, !tbaa !14
  %i.as = trunc nuw nsw i64 %.024.lcssa to i32
  %i.at = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
  %i.au = load i32, ptr %i.at, align 8, !tbaa !12
  %i.av = add nsw i32 %i.au, %i.as
  store i32 %i.av, ptr %i.at, align 8, !tbaa !12
  br label %bb.f
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.c = load i32, ptr %i.b, align 8, !tbaa !12   ; 5 uses
...
bb.f:                                             ; preds = %bb.e, %bb.c
  ...
  store i32 %i.t, ptr %i.l, align 8, !tbaa !12
...
.lr.ph.preheader:                                 ; preds = %bb.f
  ...
  %.neg45 = sext i1 %i.x to i64
  %2 = zext nneg i32 %i.c to i64
  %i.y = add nsw i64 %.neg45, %2                  ; 3 uses
  %min.iters.check = icmp ult i64 %i.y, 4
  %i.z = sub i64 %i.v, %i.e
  %diff.check = icmp ugt i64 %i.z, -32
  %or.cond = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond, label %.lr.ph.preheader46, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %i.ae, align 8, !tbaa !14 ; 3 uses
  %wide.load41 = load <2 x i64>, ptr %i.af, align 8, !tbaa !14 ; 3 uses
  ...
  store <2 x i64> %reverse43, ptr %i.al, align 8, !tbaa !14
  store <2 x i64> %reverse44, ptr %i.am, align 8, !tbaa !14
...
.lr.ph:                                           ; preds = %.lr.ph.preheader46, %.lr.ph
  %indvars.iv = phi i64 [ %indvars.iv.next, %.lr.ph ], [ %indvars.iv.ph, %.lr.ph.preheader46 ] ; 2 uses
  %.031.in37 = phi i64 [ %i.ap, %.lr.ph ], [ %.031.in37.ph, %.lr.ph.preheader46 ]
  ...
  br i1 %i.as, label %.lr.ph, label %._crit_edge, !llvm.loop !23
...
bb.g:                                             ; preds = %._crit_edge
  ...
  store i32 0, ptr %i.at, align 8, !tbaa !8
  br label %bb.h
...
; Function Attrs: nounwind uwtable
define range(i32 0, 2) i32 @BN_lshift(ptr noundef %0, ptr nofree noundef readonly captures(none) %1, i32 noundef %2) local_unnamed_addr #0 {
bb.a:
...
bb.d:                                             ; preds = %bb.c
  %i.i = load i32, ptr %i.c, align 8, !tbaa !12   ; 6 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.q = load ptr, ptr %1, align 8, !tbaa !13     ; 4 uses
  ...
  %i.z = load i64, ptr %i.y, align 8, !tbaa !14   ; 5 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %i.ao, align 8, !tbaa !14 ; 3 uses
  %wide.load13 = load <2 x i64>, ptr %i.ap, align 8, !tbaa !14 ; 3 uses
  %reverse = shufflevector <2 x i64> %wide.load, <2 x i64> poison, <2 x i32> <i32 1, i32 0>
  ...
  store <2 x i64> %reverse15, ptr %i.bb, align 8, !tbaa !14
  store <2 x i64> %reverse16, ptr %i.bc, align 8, !tbaa !14
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.bd = icmp eq i64 %index.next, %n.vec
  br i1 %i.bd, label %middle.block, label %vector.body, !llvm.loop !24
