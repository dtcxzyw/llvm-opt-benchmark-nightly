...
bb.v:                                             ; preds = %bb.c
  %i.bc = getelementptr inbounds nuw i8, ptr %i.r, i64 1
  %i.bd = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(4) @.str.14, ptr noundef nonnull dereferenceable(1) %i.bc) #8
  %i.be = icmp eq i32 %i.bd, 0
  br i1 %i.be, label %bb.w, label %bb.aj, !prof !32

bb.w:                                             ; preds = %bb.v
  %.not69.i = icmp eq ptr %i.n, null
  br i1 %.not69.i, label %bb.x, label %kdf_tls1_3_set_ctx_params_decoder.exit, !prof !32

bb.x:                                             ; preds = %bb.w
  store ptr %.06283.i, ptr %2, align 8, !tbaa !40
  br label %bb.aj

bb.y:                                             ; preds = %bb.c
  %i.bf = getelementptr inbounds nuw i8, ptr %i.r, i64 1
  %i.bg = load i8, ptr %i.bf, align 1, !tbaa !31
  %cond.i = icmp eq i8 %i.bg, 114
  br i1 %cond.i, label %bb.z, label %bb.aj

bb.z:                                             ; preds = %bb.y
  %i.bh = getelementptr inbounds nuw i8, ptr %i.r, i64 2
  %i.bi = load i8, ptr %i.bh, align 1, !tbaa !31
  switch i8 %i.bi, label %bb.aj [
    i8 101, label %bb.aa
    i8 111, label %bb.ad
  ]

bb.aa:                                            ; preds = %bb.z
  %i.bj = getelementptr inbounds nuw i8, ptr %i.r, i64 3
  %i.bk = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(4) @.str.35, ptr noundef nonnull dereferenceable(1) %i.bj) #8
  %i.bl = icmp eq i32 %i.bk, 0
  br i1 %i.bl, label %bb.ab, label %bb.aj, !prof !32

bb.ab:                                            ; preds = %bb.aa
  %.not68.i = icmp eq ptr %i.o, null
  br i1 %.not68.i, label %bb.ac, label %kdf_tls1_3_set_ctx_params_decoder.exit, !prof !32

bb.ac:                                            ; preds = %bb.ab
  store ptr %.06283.i, ptr %i.e, align 8, !tbaa !52
  br label %bb.aj

bb.ad:                                            ; preds = %bb.z
  %i.bm = getelementptr inbounds nuw i8, ptr %i.r, i64 3
  %i.bn = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(8) @.str.36, ptr noundef nonnull dereferenceable(1) %i.bm) #8
  %i.bo = icmp eq i32 %i.bn, 0
  br i1 %i.bo, label %bb.ae, label %bb.aj, !prof !32

bb.ae:                                            ; preds = %bb.ad
  %.not67.i = icmp eq ptr %i.p, null
  br i1 %.not67.i, label %bb.af, label %kdf_tls1_3_set_ctx_params_decoder.exit, !prof !32

bb.af:                                            ; preds = %bb.ae
  store ptr %.06283.i, ptr %i.d, align 8, !tbaa !41
  br label %bb.aj

bb.ag:                                            ; preds = %bb.c
  %i.bp = getelementptr inbounds nuw i8, ptr %i.r, i64 1
  %i.bq = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(4) @.str.16, ptr noundef nonnull dereferenceable(1) %i.bp) #8
  %i.br = icmp eq i32 %i.bq, 0
  br i1 %i.br, label %bb.ah, label %bb.aj, !prof !32

bb.ah:                                            ; preds = %bb.ag
  %.not66.i = icmp eq ptr %i.q, null
  br i1 %.not66.i, label %bb.ai, label %kdf_tls1_3_set_ctx_params_decoder.exit, !prof !32

bb.ai:                                            ; preds = %bb.ah
  store ptr %.06283.i, ptr %i.c, align 8, !tbaa !42
  br label %bb.aj

bb.aj:                                            ; preds = %bb.ai, %bb.ag, %bb.af, %bb.ad, %bb.ac, %bb.aa, %bb.z, %bb.y, %bb.x, %bb.v, %bb.u, %bb.s, %bb.r, %bb.p, %bb.o, %bb.n, %bb.m, %bb.k, %bb.j, %bb.i, %bb.h, %bb.g, %bb.f, %.tail.i, %bb.d, %bb.c
  %i.bs = phi ptr [ %i.j, %bb.p ], [ %i.j, %bb.k ], [ %i.j, %bb.c ], [ %i.j, %bb.g ], [ %i.j, %bb.i ], [ %i.j, %bb.m ], [ %i.j, %bb.j ], [ %i.j, %bb.h ], [ %i.j, %.tail.i ], [ %.06283.i, %bb.f ], [ %i.j, %bb.d ], [ %i.j, %bb.o ], [ %i.j, %bb.r ], [ %i.j, %bb.n ], [ %i.j, %bb.u ], [ %i.j, %bb.s ], [ %i.j, %bb.x ], [ %i.j, %bb.v ], [ %i.j, %bb.z ], [ %i.j, %bb.ac ], [ %i.j, %bb.aa ], [ %i.j, %bb.af ], [ %i.j, %bb.ad ], [ %i.j, %bb.y ], [ %i.j, %bb.ai ], [ %i.j, %bb.ag ]
  %i.bt = phi ptr [ %i.k, %bb.p ], [ %i.k, %bb.k ], [ %i.k, %bb.c ], [ %i.k, %bb.g ], [ %i.k, %bb.i ], [ %.06283.i, %bb.m ], [ %i.k, %bb.j ], [ %i.k, %bb.h ], [ %i.k, %.tail.i ], [ %i.k, %bb.f ], [ %i.k, %bb.d ], [ %i.k, %bb.o ], [ %i.k, %bb.r ], [ %i.k, %bb.n ], [ %i.k, %bb.u ], [ %i.k, %bb.s ], [ %i.k, %bb.x ], [ %i.k, %bb.v ], [ %i.k, %bb.z ], [ %i.k, %bb.ac ], [ %i.k, %bb.aa ], [ %i.k, %bb.af ], [ %i.k, %bb.ad ], [ %i.k, %bb.y ], [ %i.k, %bb.ai ], [ %i.k, %bb.ag ]
  %i.bu = phi ptr [ %i.l, %bb.p ], [ %i.l, %bb.k ], [ %i.l, %bb.c ], [ %i.l, %bb.g ], [ %i.l, %bb.i ], [ %i.l, %bb.m ], [ %i.l, %bb.j ], [ %i.l, %bb.h ], [ %i.l, %.tail.i ], [ %i.l, %bb.f ], [ %i.l, %bb.d ], [ %i.l, %bb.o ], [ %.06283.i, %bb.r ], [ %i.l, %bb.n ], [ %i.l, %bb.u ], [ %i.l, %bb.s ], [ %i.l, %bb.x ], [ %i.l, %bb.v ], [ %i.l, %bb.z ], [ %i.l, %bb.ac ], [ %i.l, %bb.aa ], [ %i.l, %bb.af ], [ %i.l, %bb.ad ], [ %i.l, %bb.y ], [ %i.l, %bb.ai ], [ %i.l, %bb.ag ]
  %i.bv = phi ptr [ %i.m, %bb.p ], [ %i.m, %bb.k ], [ %i.m, %bb.c ], [ %i.m, %bb.g ], [ %i.m, %bb.i ], [ %i.m, %bb.m ], [ %i.m, %bb.j ], [ %i.m, %bb.h ], [ %i.m, %.tail.i ], [ %i.m, %bb.f ], [ %i.m, %bb.d ], [ %i.m, %bb.o ], [ %i.m, %bb.r ], [ %i.m, %bb.n ], [ %.06283.i, %bb.u ], [ %i.m, %bb.s ], [ %i.m, %bb.x ], [ %i.m, %bb.v ], [ %i.m, %bb.z ], [ %i.m, %bb.ac ], [ %i.m, %bb.aa ], [ %i.m, %bb.af ], [ %i.m, %bb.ad ], [ %i.m, %bb.y ], [ %i.m, %bb.ai ], [ %i.m, %bb.ag ]
  %i.bw = phi ptr [ %i.n, %bb.p ], [ %i.n, %bb.k ], [ %i.n, %bb.c ], [ %i.n, %bb.g ], [ %i.n, %bb.i ], [ %i.n, %bb.m ], [ %i.n, %bb.j ], [ %i.n, %bb.h ], [ %i.n, %.tail.i ], [ %i.n, %bb.f ], [ %i.n, %bb.d ], [ %i.n, %bb.o ], [ %i.n, %bb.r ], [ %i.n, %bb.n ], [ %i.n, %bb.u ], [ %i.n, %bb.s ], [ %.06283.i, %bb.x ], [ %i.n, %bb.v ], [ %i.n, %bb.z ], [ %i.n, %bb.ac ], [ %i.n, %bb.aa ], [ %i.n, %bb.af ], [ %i.n, %bb.ad ], [ %i.n, %bb.y ], [ %i.n, %bb.ai ], [ %i.n, %bb.ag ]
  %i.bx = phi ptr [ %i.o, %bb.p ], [ %i.o, %bb.k ], [ %i.o, %bb.c ], [ %i.o, %bb.g ], [ %i.o, %bb.i ], [ %i.o, %bb.m ], [ %i.o, %bb.j ], [ %i.o, %bb.h ], [ %i.o, %.tail.i ], [ %i.o, %bb.f ], [ %i.o, %bb.d ], [ %i.o, %bb.o ], [ %i.o, %bb.r ], [ %i.o, %bb.n ], [ %i.o, %bb.u ], [ %i.o, %bb.s ], [ %i.o, %bb.x ], [ %i.o, %bb.v ], [ %i.o, %bb.z ], [ %.06283.i, %bb.ac ], [ %i.o, %bb.aa ], [ %i.o, %bb.af ], [ %i.o, %bb.ad ], [ %i.o, %bb.y ], [ %i.o, %bb.ai ], [ %i.o, %bb.ag ]
  %i.by = phi ptr [ %i.p, %bb.p ], [ %i.p, %bb.k ], [ %i.p, %bb.c ], [ %i.p, %bb.g ], [ %i.p, %bb.i ], [ %i.p, %bb.m ], [ %i.p, %bb.j ], [ %i.p, %bb.h ], [ %i.p, %.tail.i ], [ %i.p, %bb.f ], [ %i.p, %bb.d ], [ %i.p, %bb.o ], [ %i.p, %bb.r ], [ %i.p, %bb.n ], [ %i.p, %bb.u ], [ %i.p, %bb.s ], [ %i.p, %bb.x ], [ %i.p, %bb.v ], [ %i.p, %bb.z ], [ %i.p, %bb.ac ], [ %i.p, %bb.aa ], [ %.06283.i, %bb.af ], [ %i.p, %bb.ad ], [ %i.p, %bb.y ], [ %i.p, %bb.ai ], [ %i.p, %bb.ag ]
  %i.bz = phi ptr [ %i.q, %bb.p ], [ %i.q, %bb.k ], [ %i.q, %bb.c ], [ %i.q, %bb.g ], [ %i.q, %bb.i ], [ %i.q, %bb.m ], [ %i.q, %bb.j ], [ %i.q, %bb.h ], [ %i.q, %.tail.i ], [ %i.q, %bb.f ], [ %i.q, %bb.d ], [ %i.q, %bb.o ], [ %i.q, %bb.r ], [ %i.q, %bb.n ], [ %i.q, %bb.u ], [ %i.q, %bb.s ], [ %i.q, %bb.x ], [ %i.q, %bb.v ], [ %i.q, %bb.z ], [ %i.q, %bb.ac ], [ %i.q, %bb.aa ], [ %i.q, %bb.af ], [ %i.q, %bb.ad ], [ %i.q, %bb.y ], [ %.06283.i, %bb.ai ], [ %i.q, %bb.ag ]
  %i.ca = getelementptr inbounds nuw i8, ptr %.06283.i, i64 40 ; 2 uses
  %i.cb = load ptr, ptr %i.ca, align 8, !tbaa !30 ; 2 uses
  %.not65.i = icmp eq ptr %i.cb, null
  br i1 %.not65.i, label %.loopexit, label %bb.c, !llvm.loop !49

kdf_tls1_3_set_ctx_params_decoder.exit:           ; preds = %bb.e, %bb.l, %bb.q, %bb.t, %bb.w, %bb.ab, %bb.ae, %bb.ah
  %.sink.i = phi i32 [ 589, %bb.ae ], [ 578, %bb.ab ], [ 559, %bb.w ], [ 548, %bb.t ], [ 535, %bb.q ], [ 496, %bb.l ], [ 454, %bb.e ], [ 602, %bb.ah ]
  tail call void @ERR_new() #7
  tail call void @ERR_set_debug(ptr noundef nonnull @.str.10, i32 noundef %.sink.i, ptr noundef nonnull @__func__.kdf_tls1_3_set_ctx_params_decoder) #7
  tail call void (i32, i32, ptr, ...) @ERR_set_error(i32 noundef 57, i32 noundef 252, ptr noundef nonnull @.str.11, ptr noundef nonnull %i.r) #7
  br label %bb.at

.loopexit:                                        ; preds = %bb.aj, %.preheader.i, %bb.b
  %i.cc = call fastcc i32 @hkdf_common_set_ctx_params(ptr noundef %0, ptr noundef %2)
  %.not19 = icmp eq i32 %i.cc, 0
  br i1 %.not19, label %bb.at, label %bb.ak
...
bb.al:                                            ; preds = %bb.ak
  call void @ERR_new() #7
  call void @ERR_set_debug(ptr noundef nonnull @.str, i32 noundef 986, ptr noundef nonnull @__func__.kdf_tls1_3_set_ctx_params) #7
...
.preheader:                                       ; preds = %bb.d
  ...
  br i1 %.not5159, label %.loopexit, label %bb.e

bb.e:                                             ; preds = %.preheader
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #7
  store i8 1, ptr %i.b, align 1, !tbaa !31
  %i.o = tail call i32 @HMAC_Update(ptr noundef nonnull %i.k, ptr noundef %3, i64 noundef %4) #7
  %.not54.peel = icmp eq i32 %i.o, 0
  br i1 %.not54.peel, label %.thread, label %bb.f

bb.f:                                             ; preds = %bb.e
  %i.p = call i32 @HMAC_Update(ptr noundef nonnull %i.k, ptr noundef nonnull %i.b, i64 noundef 1) #7
  %.not55.peel = icmp eq i32 %i.p, 0
  br i1 %.not55.peel, label %.thread, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.q = call i32 @HMAC_Final(ptr noundef nonnull %i.k, ptr noundef nonnull %i.a, ptr noundef null) #7
  %.not56.peel = icmp eq i32 %i.q, 0
  br i1 %.not56.peel, label %.thread, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.r = call i64 @llvm.umin.i64(i64 %6, i64 %i.e) ; 2 uses
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %5, ptr nonnull align 16 %i.a, i64 %i.r, i1 false)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #7
  %.not51.peel = icmp eq i64 %spec.select, 1
  br i1 %.not51.peel, label %.loopexit, label %.lr.ph.peel.next

.lr.ph.peel.next:                                 ; preds = %bb.h, %bb.m
  %indvars.iv = phi i64 [ %indvars.iv.next, %bb.m ], [ 2, %bb.h ] ; 3 uses
  %.04361 = phi i64 [ %i.ab, %bb.m ], [ %i.r, %bb.h ] ; 3 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #7
  %i.s = trunc i64 %indvars.iv to i8
  store i8 %i.s, ptr %i.b, align 1, !tbaa !31
  %i.t = call i32 @HMAC_Init_ex(ptr noundef nonnull %i.k, ptr noundef null, i32 noundef 0, ptr noundef null, ptr noundef null) #7
  %.not52 = icmp eq i32 %i.t, 0
  br i1 %.not52, label %.thread, label %bb.i

bb.i:                                             ; preds = %.lr.ph.peel.next
  %i.u = call i32 @HMAC_Update(ptr noundef nonnull %i.k, ptr noundef nonnull %i.a, i64 noundef %i.e) #7
  %.not53 = icmp eq i32 %i.u, 0
  br i1 %.not53, label %.thread, label %bb.j

bb.j:                                             ; preds = %bb.i
  %i.v = call i32 @HMAC_Update(ptr noundef nonnull %i.k, ptr noundef %3, i64 noundef %4) #7
  %.not54 = icmp eq i32 %i.v, 0
  br i1 %.not54, label %.thread, label %bb.k

bb.k:                                             ; preds = %bb.j
  %i.w = call i32 @HMAC_Update(ptr noundef nonnull %i.k, ptr noundef nonnull %i.b, i64 noundef 1) #7
  %.not55 = icmp eq i32 %i.w, 0
  br i1 %.not55, label %.thread, label %bb.l

bb.l:                                             ; preds = %bb.k
  %i.x = call i32 @HMAC_Final(ptr noundef nonnull %i.k, ptr noundef nonnull %i.a, ptr noundef null) #7
  %.not56 = icmp eq i32 %i.x, 0
  br i1 %.not56, label %.thread, label %bb.m

.thread:                                          ; preds = %bb.k, %bb.j, %bb.i, %.lr.ph.peel.next, %bb.l, %bb.g, %bb.f, %bb.e
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #7
  br label %.loopexit

bb.m:                                             ; preds = %bb.l
  %i.y = sub i64 %6, %.04361
  %i.z = call i64 @llvm.umin.i64(i64 %i.y, i64 %i.e) ; 2 uses
  %i.aa = getelementptr inbounds nuw i8, ptr %5, i64 %.04361
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %i.aa, ptr nonnull align 16 %i.a, i64 %i.z, i1 false)
  %i.ab = add i64 %i.z, %.04361
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #7
...
bb.n:                                             ; preds = %bb.c, %bb.b, %bb.a, %.loopexit
