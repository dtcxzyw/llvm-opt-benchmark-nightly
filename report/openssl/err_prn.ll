...
bb.c:                                             ; preds = %bb.b
  ...
  %i.j = load i32, ptr %i.f, align 4, !tbaa !8
  %i.k = and i32 %i.j, 2
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  %i.ab = load i32, ptr %i.e, align 4, !tbaa !8
...
bb.d:                                             ; preds = %bb.s, %bb.c
  ...
  %i.k = call i64 @ERR_peek_last_error_all(ptr noundef nonnull %i.a, ptr noundef nonnull %i.b, ptr noundef nonnull %i.c, ptr noundef nonnull %i.d, ptr noundef nonnull %i.e) #5 ; 0 uses
...
bb.f:                                             ; preds = %._crit_edge, %bb.e
  %i.o = phi ptr [ @.str, %bb.e ], [ %.pre, %._crit_edge ]
  %.062 = phi ptr [ @.str, %bb.e ], [ %spec.store.select, %._crit_edge ] ; 2 uses
  %i.p = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %i.o) #6 ; 2 uses
  %i.q = icmp ugt i64 %i.p, 3995
  br i1 %i.q, label %bb.i, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.r = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %spec.store.select) #6 ; 2 uses
  %i.s = sub nuw nsw i64 3996, %i.p               ; 2 uses
  %.not = icmp ult i64 %i.r, %i.s
...
bb.i:                                             ; preds = %bb.f, %bb.g, %bb.h
  %.069 = phi i64 [ %i.u, %bb.h ], [ 0, %bb.g ], [ 0, %bb.f ] ; 3 uses
  %i.v = load i8, ptr %spec.store.select, align 1, !tbaa !12
  %i.w = icmp eq i8 %i.v, 0
  br i1 %i.w, label %bb.j, label %.preheader

.preheader:                                       ; preds = %bb.i
  %i.x = ptrtoint ptr %.070 to i64                ; 2 uses
  %i.y = load i8, ptr %.070, align 1, !tbaa !12
  %.not80111 = icmp eq i8 %i.y, 0
  br i1 %.not80111, label %.thread.thread, label %.lr.ph

bb.j:                                             ; preds = %bb.i
  %i.z = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %.070) #6 ; 2 uses
  %.not84 = icmp ugt i64 %i.z, %.069
  %i.aa = getelementptr inbounds nuw i8, ptr %.070, i64 %i.z
  %i.ab = getelementptr inbounds nuw i8, ptr %.070, i64 %.069
...
.lr.ph:                                           ; preds = %.preheader, %bb.m
  ...
  %i.ac = call ptr @strstr(ptr noundef nonnull dereferenceable(1) %.164112, ptr noundef nonnull dereferenceable(1) %spec.store.select) #6 ; 2 uses
  %.not83 = icmp eq ptr %i.ac, null
  br i1 %.not83, label %bb.l, label %bb.k

bb.k:                                             ; preds = %.lr.ph
  %i.ad = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %spec.store.select) #6
...
bb.l:                                             ; preds = %.lr.ph
  %i.ai = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %.164112) #6
  %i.aj = getelementptr inbounds nuw i8, ptr %.164112, i64 %i.ai ; 2 uses
  %.pre118 = load i8, ptr %i.aj, align 1, !tbaa !12
  br label %bb.m

bb.m:                                             ; preds = %bb.l, %bb.k
  %i.ak = phi i8 [ %i.af, %bb.k ], [ %.pre118, %bb.l ]
  %.265 = phi ptr [ %i.ae, %bb.k ], [ %i.aj, %bb.l ] ; 5 uses
  %.1 = phi i32 [ %i.ah, %bb.k ], [ %.061113, %bb.l ] ; 2 uses
  %.not80 = icmp eq i8 %i.ak, 0
  %i.al = ptrtoint ptr %.265 to i64
  %i.am = sub i64 %i.al, %i.x
  %.not81 = icmp ugt i64 %i.am, %.069             ; 2 uses
...
.thread100:                                       ; preds = %.critedge, %bb.j
  %.268105 = phi ptr [ %.164112, %.critedge ], [ %i.ab, %bb.j ] ; 3 uses
  %.not87 = icmp eq ptr %.268105, %.070
  br i1 %.not87, label %bb.p, label %bb.n

bb.n:                                             ; preds = %.thread100
  %i.an = ptrtoint ptr %.268105 to i64
  %i.ao = ptrtoint ptr %.070 to i64
  %i.ap = sub i64 %i.an, %i.ao
  %i.aq = call ptr @CRYPTO_strndup(ptr noundef %.070, i64 noundef %i.ap, ptr noundef nonnull @.str.4, i32 noundef 121) #5 ; 3 uses
  %i.ar = icmp eq ptr %i.aq, null
  br i1 %i.ar, label %.critedge92, label %bb.o

bb.o:                                             ; preds = %bb.n
  call void (i32, ...) @ERR_add_error_data(i32 noundef 2, ptr noundef nonnull %spec.store.select, ptr noundef nonnull %i.aq) #5
  call void @CRYPTO_free(ptr noundef nonnull %i.aq, ptr noundef nonnull @.str.4, i32 noundef 125) #5
  br label %bb.p

bb.p:                                             ; preds = %bb.o, %.thread100
  %i.as = load ptr, ptr %i.c, align 8, !tbaa !11
  %i.at = load ptr, ptr %i.a, align 8, !tbaa !11
...
.thread:                                          ; preds = %.critedge
  %i.av = icmp eq i32 %.1, 0
  br i1 %i.av, label %.thread.thread, label %bb.q

bb.q:                                             ; preds = %.thread
  %i.aw = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %spec.store.select) #6
  %i.ax = sub i64 0, %i.aw
  %i.ay = getelementptr inbounds i8, ptr %.265, i64 %i.ax
  %i.az = ptrtoint ptr %i.ay to i64
  %i.ba = sub i64 %i.az, %i.x
  %i.bb = call ptr @CRYPTO_strndup(ptr noundef nonnull %.070, i64 noundef %i.ba, ptr noundef nonnull @.str.4, i32 noundef 131) #5 ; 3 uses
  %i.bc = icmp eq ptr %i.bb, null
  br i1 %i.bc, label %.critedge92, label %bb.r

bb.r:                                             ; preds = %bb.q
  call void (i32, ...) @ERR_add_error_data(i32 noundef 2, ptr noundef nonnull %.062, ptr noundef nonnull %i.bb) #5
  call void @CRYPTO_free(ptr noundef nonnull %i.bb, ptr noundef nonnull @.str.4, i32 noundef 136) #5
  br label %bb.s

.thread.thread:                                   ; preds = %.preheader, %bb.j, %.thread
  %.398109 = phi ptr [ %.265, %.thread ], [ %i.aa, %bb.j ], [ %.070, %.preheader ]
...
bb.s:                                             ; preds = %bb.r, %.thread.thread, %bb.p
  ...
  %i.bd = load i8, ptr %.272, align 1, !tbaa !12
  %.not88 = icmp eq i8 %i.bd, 0
  br i1 %.not88, label %.critedge92, label %bb.d, !llvm.loop !16
