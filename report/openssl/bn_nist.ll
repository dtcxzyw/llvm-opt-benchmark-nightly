Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/openssl/original/bn_nist?download=true
...
define i32 @BN_nist_mod_192(ptr noundef %0, ptr noundef %1, ptr nofree readnone captures(none) %2, ptr noundef %3) #1 {
bb.a:
  %4 = alloca %union.anon, align 8                ; 10 uses
  %i.a = alloca [3 x i64], align 16               ; 6 uses
  %i.b = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.c = load i32, ptr %i.b, align 8, !tbaa !11   ; 4 uses
  %i.d = load ptr, ptr %1, align 8, !tbaa !12     ; 5 uses
...
nist_cp_bn.exit.loopexit:                         ; preds = %bb.j
  %i.q = load ptr, ptr %0, align 8, !tbaa !12     ; 4 uses
...
.preheader:                                       ; preds = %nist_cp_bn.exit
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %4, ptr align 8 %i.aa, i64 %i.ac, i1 false), !tbaa !15
...
.lr.ph125.preheader:                              ; preds = %nist_cp_bn.exit, %.preheader
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep, i8 0, i64 %i.ak, i1 false), !tbaa !15
  br label %._crit_edge

._crit_edge:                                      ; preds = %.lr.ph125.preheader, %.preheader
  %.0105.val = load i32, ptr %.0105, align 1
  %i.al = zext i32 %.0105.val to i64
  %i.am = load i32, ptr %4, align 8, !tbaa !16
  %i.an = zext i32 %i.am to i64
  %i.ao = getelementptr inbounds nuw i8, ptr %4, i64 16
  %i.ap = load i32, ptr %i.ao, align 8, !tbaa !16
  ...
  %i.bl = load i32, ptr %i.bk, align 8, !tbaa !16
  ...
  %i.bv = load i32, ptr %i.bu, align 4, !tbaa !16
...
nist_cp_bn.exit122:                               ; preds = %._crit_edge, %bb.k
  %.0106 = phi i1 [ %i.cs, %bb.k ], [ true, %._crit_edge ]
...
; Function Attrs: nounwind uwtable
define i32 @BN_nist_mod_224(ptr noundef %0, ptr noundef %1, ptr nofree readnone captures(none) %2, ptr noundef %3) #1 {
bb.a:
  ...
  %i.f = load ptr, ptr %1, align 8, !tbaa !12     ; 7 uses
...
nist_cp_bn.exit.loopexit:                         ; preds = %bb.j
  %i.t = load ptr, ptr %0, align 8, !tbaa !12     ; 5 uses
...
nist_cp_bn.exit:                                  ; preds = %nist_cp_bn.exit.loopexit, %bb.i
  %.083 = phi ptr [ %i.f, %bb.i ], [ %i.t, %nist_cp_bn.exit.loopexit ] ; 18 uses
...
.lr.ph.preheader:                                 ; preds = %nist_cp_bn.exit
  ...
  br i1 %min.iters.check, label %.lr.ph.preheader117, label %vector.memcheck

vector.memcheck:                                  ; preds = %.lr.ph.preheader
  %i.ah = sub i64 %i.b, %i.g
  %i.ai = add i64 %i.ah, -25
  %diff.check = icmp ult i64 %i.ai, 31
  br i1 %diff.check, label %.lr.ph.preheader117, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load116 = load <2 x i64>, ptr %i.ak, align 8, !tbaa !14
  ...
  store <2 x i64> %wide.load116, ptr %i.am, align 16, !tbaa !14
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %.preheader, label %.lr.ph.preheader117

.lr.ph.preheader117:                              ; preds = %vector.memcheck, %.lr.ph.preheader, %middle.block
  %indvars.iv.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %.lr.ph.preheader ], [ %n.vec, %middle.block ] ; 3 uses
  %xtraiter = and i64 %wide.trip.count, 3         ; 2 uses
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %.lr.ph.prol.loopexit, label %.lr.ph.prol

.lr.ph.prol:                                      ; preds = %.lr.ph.preheader117, %.lr.ph.prol
  %indvars.iv.prol = phi i64 [ %indvars.iv.next.prol, %.lr.ph.prol ], [ %indvars.iv.ph, %.lr.ph.preheader117 ] ; 3 uses
  %prol.iter = phi i64 [ %prol.iter.next, %.lr.ph.prol ], [ 0, %.lr.ph.preheader117 ]
...
.lr.ph.prol.loopexit:                             ; preds = %.lr.ph.prol, %.lr.ph.preheader117
  %indvars.iv.unr = phi i64 [ %indvars.iv.ph, %.lr.ph.preheader117 ], [ %indvars.iv.next.prol, %.lr.ph.prol ]
...
.lr.ph101.preheader:                              ; preds = %nist_cp_bn.exit, %.preheader
  %.0.lcssa115 = phi i32 [ %i.af, %.preheader ], [ 0, %nist_cp_bn.exit ] ; 2 uses
  %i.au = shl nuw nsw i32 %.0.lcssa115, 3
  %i.av = zext nneg i32 %i.au to i64
  %scevgep = getelementptr i8, ptr %i.a, i64 %i.av
  %i.aw = shl nuw nsw i32 %.0.lcssa115, 3
...
.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  ...
  br i1 %exitcond.not.3, label %.preheader, label %.lr.ph, !llvm.loop !24
...
._crit_edge:                                      ; preds = %.lr.ph101.preheader, %.preheader
  ...
  %i.bv = getelementptr inbounds nuw i8, ptr %.083, i64 24 ; 6 uses
  ...
  %i.ce = call i64 @bn_add_words(ptr noundef %.083, ptr noundef %.083, ptr noundef nonnull %i.c, i32 noundef 4) #6 ; 0 uses
  store i64 0, ptr %i.c, align 16, !tbaa !14
  ...
  %i.cj = call i64 @bn_add_words(ptr noundef %.083, ptr noundef %.083, ptr noundef nonnull %i.c, i32 noundef 4) #6 ; 0 uses
  ...
  %i.ck = call i64 @bn_sub_words(ptr noundef %.083, ptr noundef %.083, ptr noundef nonnull %i.c, i32 noundef 4) #6 ; 0 uses
  ...
  %i.cl = call i64 @bn_sub_words(ptr noundef %.083, ptr noundef %.083, ptr noundef nonnull %i.c, i32 noundef 4) #6 ; 0 uses
...
bb.k:                                             ; preds = %._crit_edge
  ...
  %i.ct = call i64 @bn_sub_words(ptr noundef nonnull %.083, ptr noundef nonnull %.083, ptr noundef nonnull %i.cs, i32 noundef 4) #6 ; 0 uses
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.dc = call i64 @bn_add_words(ptr noundef nonnull %.083, ptr noundef nonnull %.083, ptr noundef nonnull %i.db, i32 noundef 4) #6
...
nist_cp_bn.exit98:                                ; preds = %bb.l, %bb.m, %bb.k
  ...
  %.082 = phi ptr [ @bn_sub_words, %bb.k ], [ %i.de, %bb.m ], [ @bn_sub_words, %bb.l ]
  %i.df = call i64 %.082(ptr noundef nonnull %i.a, ptr noundef nonnull %.083, ptr noundef nonnull @_nist_p_224, i32 noundef 4) #6, !callees !21
  %i.dg = icmp ne i64 %i.df, 0
  %i.dh = icmp ne i32 %.084, 0
  %or.cond = select i1 %i.dg, i1 %i.dh, i1 false  ; 4 uses
  %i.di = select i1 %or.cond, ptr %.083, ptr %i.a
  %i.dj = load i64, ptr %i.di, align 8, !tbaa !14
  store i64 %i.dj, ptr %.083, align 8, !tbaa !14
  %.083.sroa.gep = getelementptr inbounds nuw i8, ptr %.083, i64 8 ; 2 uses
  %.sroa.sel = select i1 %or.cond, ptr %.083.sroa.gep, ptr %i.bl
  %i.dk = load i64, ptr %.sroa.sel, align 8, !tbaa !14
  store i64 %i.dk, ptr %.083.sroa.gep, align 8, !tbaa !14
  %.083.sroa.gep106 = getelementptr inbounds nuw i8, ptr %.083, i64 16 ; 2 uses
  %.sroa.sel108 = select i1 %or.cond, ptr %.083.sroa.gep106, ptr %i.bo
  %i.dl = load i64, ptr %.sroa.sel108, align 8, !tbaa !14
  store i64 %i.dl, ptr %.083.sroa.gep106, align 8, !tbaa !14
  ...
  store i32 4, ptr %i.dn, align 8, !tbaa !11
  call void @bn_correct_top(ptr noundef %0) #6
  br label %bb.n

bb.n:                                             ; preds = %bb.j, %bb.h, %bb.g, %nist_cp_bn.exit98, %bb.e, %bb.c
  %.085 = phi i32 [ %i.k, %bb.c ], [ 1, %bb.e ], [ 1, %bb.g ], [ 1, %nist_cp_bn.exit98 ], [ %i.r, %bb.h ], [ 0, %bb.j ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #6
  ret i32 %.085
}
...
; Function Attrs: nounwind uwtable
define i32 @BN_nist_mod_256(ptr noundef %0, ptr noundef %1, ptr nofree readnone captures(none) %2, ptr noundef %3) #1 {
bb.a:
  %4 = alloca %union.anon.1, align 8              ; 12 uses
  %i.a = alloca [4 x i64], align 16               ; 7 uses
  %i.b = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.c = load i32, ptr %i.b, align 8, !tbaa !11   ; 4 uses
  %i.d = load ptr, ptr %1, align 8, !tbaa !12     ; 6 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #6
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #6
  %i.e = tail call i32 @BN_is_negative(ptr noundef nonnull %1) #6
  %.not = icmp eq i32 %i.e, 0
...
nist_cp_bn.exit.loopexit:                         ; preds = %bb.j
  %i.q = load ptr, ptr %0, align 8, !tbaa !12     ; 5 uses
  %i.r = load i64, ptr %i.d, align 8, !tbaa !14
  store i64 %i.r, ptr %i.q, align 8, !tbaa !14
  %i.s = getelementptr inbounds nuw i8, ptr %i.d, i64 8
  %i.t = load i64, ptr %i.s, align 8, !tbaa !14
...
nist_cp_bn.exit:                                  ; preds = %nist_cp_bn.exit.loopexit, %bb.i
  %.0204 = phi ptr [ %i.d, %bb.i ], [ %i.q, %nist_cp_bn.exit.loopexit ] ; 16 uses
...
.preheader:                                       ; preds = %nist_cp_bn.exit
  ...
  %i.af = shl nuw nsw i64 %i.ae, 3
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %4, ptr align 8 %i.ad, i64 %i.af, i1 false), !tbaa !15
...
.lr.ph252.preheader:                              ; preds = %nist_cp_bn.exit, %.preheader
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep, i8 0, i64 %i.an, i1 false), !tbaa !15
  br label %._crit_edge

._crit_edge:                                      ; preds = %.lr.ph252.preheader, %.preheader
  %.0204.val = load i32, ptr %.0204, align 1
  %i.ao = zext i32 %.0204.val to i64
  %i.ap = load i32, ptr %4, align 8, !tbaa !16
  %i.aq = zext i32 %i.ap to i64                   ; 2 uses
  ...
  %i.ay = load i32, ptr %i.ax, align 8, !tbaa !16
  ...
  %i.bf = load i32, ptr %i.be, align 8, !tbaa !16
  ...
  store i32 %i.bk, ptr %.0204, align 1
  %i.bl = ashr i64 %i.bj, 32
  %i.bm = getelementptr inbounds nuw i8, ptr %.0204, i64 4 ; 2 uses
  ...
  %i.cc = getelementptr inbounds nuw i8, ptr %.0204, i64 8 ; 4 uses
  ...
  %i.cl = getelementptr inbounds nuw i8, ptr %.0204, i64 12 ; 2 uses
  ...
  %i.cv = getelementptr inbounds nuw i8, ptr %.0204, i64 16 ; 4 uses
  ...
  %i.de = getelementptr inbounds nuw i8, ptr %.0204, i64 20 ; 2 uses
  ...
  %i.dn = getelementptr inbounds nuw i8, ptr %.0204, i64 24 ; 4 uses
  ...
  %i.dx = getelementptr inbounds nuw i8, ptr %.0204, i64 28 ; 2 uses
...
bb.k:                                             ; preds = %._crit_edge
  ...
  %i.el = tail call i64 @bn_sub_words(ptr noundef nonnull %.0204, ptr noundef nonnull %.0204, ptr noundef nonnull %i.ek, i32 noundef 4) #6
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.eq = tail call i64 @bn_add_words(ptr noundef nonnull %.0204, ptr noundef nonnull %.0204, ptr noundef nonnull %i.ep, i32 noundef 4) #6
...
nist_cp_bn.exit228:                               ; preds = %bb.l, %bb.m, %bb.k
  %.0205 = phi i32 [ %i.em, %bb.k ], [ %i.er, %bb.m ], [ 1, %bb.l ]
  %.0203 = phi ptr [ @bn_sub_words, %bb.k ], [ %i.es, %bb.m ], [ @bn_sub_words, %bb.l ]
  %i.et = call i64 %.0203(ptr noundef nonnull %i.a, ptr noundef nonnull %.0204, ptr noundef nonnull @_nist_p_256, i32 noundef 4) #6, !callees !21
  %i.eu = icmp ne i64 %i.et, 0
  %i.ev = icmp ne i32 %.0205, 0
  %or.cond = select i1 %i.eu, i1 %i.ev, i1 false  ; 4 uses
  %i.ew = select i1 %or.cond, ptr %.0204, ptr %i.a
  %i.ex = load i64, ptr %i.ew, align 8, !tbaa !14
  store i64 %i.ex, ptr %.0204, align 8, !tbaa !14
  %.sroa.gep = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  %.sroa.sel = select i1 %or.cond, ptr %i.cc, ptr %.sroa.gep
  %i.ey = load i64, ptr %.sroa.sel, align 8, !tbaa !14
  store i64 %i.ey, ptr %i.cc, align 8, !tbaa !14
  %.sroa.gep257 = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  %.sroa.sel258 = select i1 %or.cond, ptr %i.cv, ptr %.sroa.gep257
  %i.ez = load i64, ptr %.sroa.sel258, align 8, !tbaa !14
  store i64 %i.ez, ptr %i.cv, align 8, !tbaa !14
  %.sroa.gep260 = getelementptr inbounds nuw i8, ptr %i.a, i64 24
  %.sroa.sel261 = select i1 %or.cond, ptr %i.dn, ptr %.sroa.gep260
  %i.fa = load i64, ptr %.sroa.sel261, align 8, !tbaa !14
  store i64 %i.fa, ptr %i.dn, align 8, !tbaa !14
  %i.fb = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i32 4, ptr %i.fb, align 8, !tbaa !11
  call void @bn_correct_top(ptr noundef %0) #6
  br label %bb.n
...
; Function Attrs: nounwind uwtable
define i32 @BN_nist_mod_384(ptr noundef %0, ptr noundef %1, ptr nofree readnone captures(none) %2, ptr noundef %3) #1 {
bb.a:
  %4 = alloca %union.anon.2, align 8              ; 16 uses
  %i.a = alloca [6 x i64], align 16               ; 9 uses
  %i.b = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.c = load i32, ptr %i.b, align 8, !tbaa !11   ; 4 uses
  %i.d = load ptr, ptr %1, align 8, !tbaa !12     ; 8 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #6
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #6
  %i.e = tail call i32 @BN_is_negative(ptr noundef nonnull %1) #6
  %.not = icmp eq i32 %i.e, 0
...
nist_cp_bn.exit.loopexit:                         ; preds = %bb.j
  %i.q = load ptr, ptr %0, align 8, !tbaa !12     ; 7 uses
  %i.r = load i64, ptr %i.d, align 8, !tbaa !14
  store i64 %i.r, ptr %i.q, align 8, !tbaa !14
  %i.s = getelementptr inbounds nuw i8, ptr %i.d, i64 8
  %i.t = load i64, ptr %i.s, align 8, !tbaa !14
...
nist_cp_bn.exit:                                  ; preds = %nist_cp_bn.exit.loopexit, %bb.i
  %.0246 = phi ptr [ %i.d, %bb.i ], [ %i.q, %nist_cp_bn.exit.loopexit ] ; 20 uses
...
.preheader:                                       ; preds = %nist_cp_bn.exit
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %4, ptr align 8 %i.aj, i64 %i.al, i1 false), !tbaa !15
...
.lr.ph292.preheader:                              ; preds = %nist_cp_bn.exit, %.preheader
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep, i8 0, i64 %i.at, i1 false), !tbaa !15
  br label %._crit_edge

._crit_edge:                                      ; preds = %.lr.ph292.preheader, %.preheader
  %.0246.val = load i32, ptr %.0246, align 1
  %i.au = zext i32 %.0246.val to i64
  %i.av = load i32, ptr %4, align 8, !tbaa !16
  ...
  %i.bk = trunc i64 %i.bj to i32
  store i32 %i.bk, ptr %.0246, align 1
  %i.bl = ashr i64 %i.bj, 32
  %i.bm = getelementptr inbounds nuw i8, ptr %.0246, i64 4 ; 2 uses
  ...
  %i.ck = ashr i64 %i.ci, 32
  %i.cl = getelementptr inbounds nuw i8, ptr %.0246, i64 12 ; 2 uses
  ...
  %i.cy = getelementptr inbounds nuw i8, ptr %.0246, i64 16 ; 4 uses
  ...
  %i.db = load i32, ptr %i.da, align 8, !tbaa !16
  ...
  %i.dm = ashr i64 %i.dk, 32
  %i.dn = getelementptr inbounds nuw i8, ptr %.0246, i64 20 ; 2 uses
  ...
  %i.ep = getelementptr inbounds nuw i8, ptr %.0246, i64 28 ; 2 uses
  ...
  %i.fc = getelementptr inbounds nuw i8, ptr %.0246, i64 32 ; 4 uses
  ...
  %i.fl = getelementptr inbounds nuw i8, ptr %.0246, i64 36 ; 2 uses
  ...
  %i.fu = getelementptr inbounds nuw i8, ptr %.0246, i64 40 ; 4 uses
  ...
  %i.gd = getelementptr inbounds nuw i8, ptr %.0246, i64 44 ; 2 uses
...
bb.k:                                             ; preds = %._crit_edge
  ...
  %i.gq = tail call i64 @bn_sub_words(ptr noundef nonnull %.0246, ptr noundef nonnull %.0246, ptr noundef nonnull %i.gp, i32 noundef 6) #6
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.gv = tail call i64 @bn_add_words(ptr noundef nonnull %.0246, ptr noundef nonnull %.0246, ptr noundef nonnull %i.gu, i32 noundef 6) #6
...
nist_cp_bn.exit273:                               ; preds = %bb.l, %bb.m, %bb.k
  %.0247 = phi i32 [ %i.gr, %bb.k ], [ %i.gw, %bb.m ], [ 1, %bb.l ]
  %.0245 = phi ptr [ @bn_sub_words, %bb.k ], [ %i.gx, %bb.m ], [ @bn_sub_words, %bb.l ]
  %i.gy = call i64 %.0245(ptr noundef nonnull %i.a, ptr noundef nonnull %.0246, ptr noundef nonnull @_nist_p_384, i32 noundef 6) #6, !callees !21
  %i.gz = icmp ne i64 %i.gy, 0
  %i.ha = icmp ne i32 %.0247, 0
  %or.cond = select i1 %i.gz, i1 %i.ha, i1 false  ; 6 uses
  %i.hb = select i1 %or.cond, ptr %.0246, ptr %i.a
  %i.hc = load i64, ptr %i.hb, align 8, !tbaa !14
  store i64 %i.hc, ptr %.0246, align 8, !tbaa !14
  %.sroa.gep = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  %.sroa.sel = select i1 %or.cond, ptr %i.ca, ptr %.sroa.gep
  %i.hd = load i64, ptr %.sroa.sel, align 8, !tbaa !14
  store i64 %i.hd, ptr %i.ca, align 8, !tbaa !14
  %.sroa.gep297 = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  %.sroa.sel298 = select i1 %or.cond, ptr %i.cy, ptr %.sroa.gep297
  %i.he = load i64, ptr %.sroa.sel298, align 8, !tbaa !14
  store i64 %i.he, ptr %i.cy, align 8, !tbaa !14
  %.sroa.gep300 = getelementptr inbounds nuw i8, ptr %i.a, i64 24
  %.sroa.sel301 = select i1 %or.cond, ptr %i.eb, ptr %.sroa.gep300
  %i.hf = load i64, ptr %.sroa.sel301, align 8, !tbaa !14
  store i64 %i.hf, ptr %i.eb, align 8, !tbaa !14
  %.sroa.gep303 = getelementptr inbounds nuw i8, ptr %i.a, i64 32
  %.sroa.sel304 = select i1 %or.cond, ptr %i.fc, ptr %.sroa.gep303
  %i.hg = load i64, ptr %.sroa.sel304, align 8, !tbaa !14
  store i64 %i.hg, ptr %i.fc, align 8, !tbaa !14
  %.sroa.gep306 = getelementptr inbounds nuw i8, ptr %i.a, i64 40
  %.sroa.sel307 = select i1 %or.cond, ptr %i.fu, ptr %.sroa.gep306
  %i.hh = load i64, ptr %.sroa.sel307, align 8, !tbaa !14
  store i64 %i.hh, ptr %i.fu, align 8, !tbaa !14
  %i.hi = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i32 6, ptr %i.hi, align 8, !tbaa !11
  call void @bn_correct_top(ptr noundef %0) #6
  br label %bb.n
...
; Function Attrs: nounwind uwtable
define i32 @BN_nist_mod_521(ptr noundef %0, ptr noundef %1, ptr nofree readnone captures(none) %2, ptr noundef %3) #1 {
bb.a:
  %i.a = alloca [9 x i64], align 16               ; 23 uses
  %i.b = ptrtoaddr ptr %i.a to i64
  %i.c = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.d = load i32, ptr %i.c, align 8, !tbaa !11   ; 2 uses
  %i.e = load ptr, ptr %1, align 8, !tbaa !12     ; 12 uses
...
nist_cp_bn.exit.loopexit:                         ; preds = %bb.j
  %i.s = load ptr, ptr %0, align 8, !tbaa !12     ; 10 uses
  %i.t = load i64, ptr %i.e, align 8, !tbaa !14
  store i64 %i.t, ptr %i.s, align 8, !tbaa !14
  ...
  store i64 %i.ab, ptr %i.ac, align 8, !tbaa !14
  ...
  store i64 %i.ah, ptr %i.ai, align 8, !tbaa !14
  ...
  store i64 %i.ak, ptr %i.al, align 8, !tbaa !14
  %i.am = getelementptr inbounds nuw i8, ptr %i.e, i64 56
  %i.an = load i64, ptr %i.am, align 8, !tbaa !14
  %i.ao = getelementptr inbounds nuw i8, ptr %i.s, i64 56
  store i64 %i.an, ptr %i.ao, align 8, !tbaa !14
  ...
  store i64 %i.aq, ptr %i.ar, align 8, !tbaa !14
  br label %nist_cp_bn.exit

nist_cp_bn.exit:                                  ; preds = %nist_cp_bn.exit.loopexit, %bb.i
  %.053 = phi ptr [ %i.e, %bb.i ], [ %i.s, %nist_cp_bn.exit.loopexit ] ; 13 uses
...
vector.memcheck:                                  ; preds = %.lr.ph.preheader
  ...
  br i1 %diff.check, label %.lr.ph.preheader108, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load107 = load <2 x i64>, ptr %i.ay, align 8, !tbaa !14
  %i.az = getelementptr inbounds nuw [8 x i8], ptr %i.a, i64 %index ; 2 uses
  %i.ba = getelementptr inbounds nuw i8, ptr %i.az, i64 16
  store <2 x i64> %wide.load, ptr %i.az, align 16, !tbaa !14
  store <2 x i64> %wide.load107, ptr %i.ba, align 16, !tbaa !14
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.bb = icmp eq i64 %index.next, %n.vec
  br i1 %i.bb, label %middle.block, label %vector.body, !llvm.loop !25
...
.lr.ph.prol:                                      ; preds = %.lr.ph.preheader108, %.lr.ph.prol
  %indvars.iv.prol = phi i64 [ %indvars.iv.next.prol, %.lr.ph.prol ], [ %indvars.iv.ph, %.lr.ph.preheader108 ] ; 3 uses
