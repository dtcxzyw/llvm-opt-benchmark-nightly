...
bb.c:                                             ; preds = %bb.d, %bb.b
  %.014.in = phi i32 [ %i.b, %bb.b ], [ %.014, %bb.d ]
  %.014 = add nsw i32 %.014.in, 1                 ; 4 uses
  %i.e = tail call i32 @OPENSSL_sk_num(ptr noundef %i.d) #8
  %i.f = icmp slt i32 %.014, %i.e
  br i1 %i.f, label %bb.d, label %.loopexit

bb.d:                                             ; preds = %bb.c
  %i.g = tail call ptr @OPENSSL_sk_value(ptr noundef %i.d, i32 noundef %.014) #8
...
.loopexit:                                        ; preds = %bb.c, %bb.d, %bb.a
  %.0 = phi i32 [ -1, %bb.a ], [ -1, %bb.c ], [ %.014, %bb.d ]
  ret i32 %.0
}
...
bb.c:                                             ; preds = %bb.d, %bb.b
  %.014.in.i = phi i32 [ -1, %bb.b ], [ %.014.i, %bb.d ] ; 2 uses
  %.014.i = add nsw i32 %.014.in.i, 1             ; 4 uses
  %i.d = tail call i32 @OPENSSL_sk_num(ptr noundef %i.c) #8
  %i.e = icmp slt i32 %.014.i, %i.d
  br i1 %i.e, label %bb.d, label %OCSP_resp_find.exit.thread

bb.d:                                             ; preds = %bb.c
  %i.f = tail call ptr @OPENSSL_sk_value(ptr noundef %i.c, i32 noundef %.014.i) #8
...
OCSP_resp_get0.exit:                              ; preds = %OCSP_resp_find.exit
  ...
  %i.j = tail call ptr @OPENSSL_sk_value(ptr noundef %i.i, i32 noundef %.014.i) #8 ; 4 uses
