...
.epilog-lcssa44:                                  ; preds = %.preheader.epil, %.unr-lcssa40
  ...
  %4 = fdiv double %.lcssa27, %i.aw
  %5 = fmul nnan double %i.cz, %i.da
  %i.dd = insertelement <2 x double> poison, double %4, i64 0
  %i.de = insertelement <2 x double> %i.dd, double %5, i64 1
  ...
  %6 = fmul double %i.ee, 5.000000e-01
  %7 = fdiv double 2.000000e+00, %i.ef
  %i.eg = insertelement <2 x double> poison, double %6, i64 0
  %i.eh = insertelement <2 x double> %i.eg, double %7, i64 1
