...
bb.az:                                            ; preds = %._crit_edge153
  ...
  %5 = fmul nnan double %i.di, %i.dj              ; 2 uses
  %6 = fadd double %i.di, %i.dj                   ; 2 uses
  %7 = fdiv double %5, %6
  %8 = fmul double %5, %6
  %i.dm = insertelement <2 x double> poison, double %7, i64 0
  %i.dn = insertelement <2 x double> %i.dm, double %8, i64 1
...
bb.ba:                                            ; preds = %._crit_edge153
  ...
  %9 = fmul nnan double %i.ea, %i.eb              ; 2 uses
  %10 = fadd double %i.ea, %i.eb                  ; 2 uses
  %11 = fdiv double %9, %10
  %12 = fmul double %9, %10
  %i.ee = insertelement <2 x double> poison, double %11, i64 0
  %i.ef = insertelement <2 x double> %i.ee, double %12, i64 1
