...
bb.az:                                            ; preds = %._crit_edge153
  ...
  %i.dk = fmul nnan double %i.di, %i.dj           ; 2 uses
  %i.dl = fadd double %i.di, %i.dj                ; 2 uses
  %5 = fmul nnan double %i.dj, 2.000000e+00
  %6 = fadd nnan double %5, %i.di
  %i.dm = fmul double %i.dk, %i.dl
  %i.dn = fdiv double %i.dk, %i.dl
...
bb.ba:                                            ; preds = %._crit_edge153
  ...
  %i.ee = fmul nnan double %i.ec, %i.ed           ; 2 uses
  %i.ef = fadd double %i.ec, %i.ed                ; 2 uses
  %7 = fmul nnan double %i.ed, 2.000000e+00
  %8 = fadd nnan double %7, %i.ec
  %i.eg = fmul double %i.ee, %i.ef
  %i.eh = fdiv double %i.ee, %i.ef
