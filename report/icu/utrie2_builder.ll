...
.lr.ph19.i134.preheader:                          ; preds = %.preheader.i133
  ...
  %10 = xor i64 %i.ey, -1
  %11 = add i64 %i.fg, %10
  %i.fh = add nuw nsw i64 %i.w, %i.ee
  %12 = shl nuw nsw i64 %i.fh, 2
...
bb.bn:                                            ; preds = %bb.bm
  ...
  %14 = xor i64 %i.mv, -1
  %i.nc = add i64 %i.nb, %14
  %15 = shl nuw nsw i64 %i.mq, 2
  %16 = sub i64 %i.nc, %15                        ; 2 uses
  %i.nd = lshr i64 %16, 2
