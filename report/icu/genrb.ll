...
bb.bn:                                            ; preds = %bb.bm
  %i.fa = load ptr, ptr @stderr, align 8, !tbaa !23
  %i.fb = load ptr, ptr %3, align 8, !tbaa !39
...
bb.bp:                                            ; preds = %bb.bo
  store ptr %i.fg, ptr @_ZL10poolBundle, align 8, !tbaa !9
...
bb.br:                                            ; preds = %bb.bq
  %i.fi = load ptr, ptr @stderr, align 8, !tbaa !23
  %i.fj = load ptr, ptr %3, align 8, !tbaa !39
...
bb.bt:                                            ; preds = %bb.bq
  %i.fm = load ptr, ptr @_ZL10poolBundle, align 8, !tbaa !9
...
bb.bu:                                            ; preds = %bb.bt
  %i.fo = load i32, ptr %i.a, align 4, !tbaa !19  ; 2 uses
  %i.fp = icmp slt i32 %i.fo, 1
  br i1 %i.fp, label %bb.bx, label %bb.bv

bb.bv:                                            ; preds = %bb.bu
  %i.fq = load ptr, ptr @stderr, align 8, !tbaa !23
  %i.fr = load ptr, ptr %3, align 8, !tbaa !39
...
bb.bw:                                            ; preds = %bb.bv
  ...
  %i.fu = load i32, ptr %i.a, align 4, !tbaa !19
  br label %bb.dt

bb.bx:                                            ; preds = %bb.bu
  %i.fv = load ptr, ptr @_ZL10poolBundle, align 8, !tbaa !9 ; 2 uses
...
bb.bz:                                            ; preds = %bb.by
  %i.fx = load i32, ptr %i.a, align 4, !tbaa !19  ; 2 uses
  %i.fy = icmp slt i32 %i.fx, 1
  br i1 %i.fy, label %bb.cc, label %bb.ca

bb.ca:                                            ; preds = %bb.bz
  %i.fz = load ptr, ptr @stderr, align 8, !tbaa !23
  %i.ga = load ptr, ptr %3, align 8, !tbaa !39
...
bb.cb:                                            ; preds = %bb.ca
  ...
  %i.gd = load i32, ptr %i.a, align 4, !tbaa !19
  br label %bb.dt

bb.cc:                                            ; preds = %bb.bz
  %i.ge = load ptr, ptr @_ZL10poolBundle, align 8, !tbaa !9 ; 3 uses
  %i.gf = getelementptr inbounds nuw i8, ptr %i.ge, i64 16
  %i.gg = load i8, ptr %i.gf, align 2, !tbaa !27
  %i.gh = icmp ult i8 %i.gg, 2
  br i1 %i.gh, label %bb.cd, label %bb.ce

bb.cd:                                            ; preds = %bb.cc
  %i.gi = load ptr, ptr @stderr, align 8, !tbaa !23
  %i.gj = load ptr, ptr %3, align 8, !tbaa !39
  %i.gk = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.gi, ptr noundef nonnull @.str.57, ptr noundef %i.gj) #26 ; 0 uses
  br label %bb.dt

bb.ce:                                            ; preds = %bb.cc
  %i.gl = load i16, ptr %i.ge, align 2, !tbaa !45
  ...
  store ptr %i.go, ptr getelementptr inbounds nuw (i8, ptr @_ZL10poolBundle, i64 8), align 8, !tbaa !50
...
bb.cf:                                            ; preds = %bb.ce
  %i.gs = load ptr, ptr @stderr, align 8, !tbaa !23
  %i.gt = load ptr, ptr %3, align 8, !tbaa !39
...
bb.cg:                                            ; preds = %bb.ce
  ...
  %i.gx = load i32, ptr %i.gw, align 4, !tbaa !51 ; 3 uses
  %i.gy = zext nneg i32 %i.gv to i64
  %i.gz = getelementptr inbounds nuw [4 x i8], ptr %i.gn, i64 %i.gy ; 4 uses
  store ptr %i.gz, ptr getelementptr inbounds nuw (i8, ptr @_ZL10poolBundle, i64 16), align 8, !tbaa !52
  %i.ha = sub nsw i32 %i.gx, %i.gv                ; 2 uses
  %i.hb = shl i32 %i.ha, 2                        ; 2 uses
  store i32 %i.hb, ptr getelementptr inbounds nuw (i8, ptr @_ZL10poolBundle, i64 24), align 8, !tbaa !53
  %i.hc = getelementptr inbounds nuw i8, ptr %i.gn, i64 32
  %i.hd = load i32, ptr %i.hc, align 4, !tbaa !51
  store i32 %i.hd, ptr getelementptr inbounds nuw (i8, ptr @_ZL10poolBundle, i64 44), align 4, !tbaa !54
...
bb.ch:                                            ; preds = %.lr.ph
  ...
  store i32 %i.hk, ptr getelementptr inbounds nuw (i8, ptr @_ZL10poolBundle, i64 28), align 4, !tbaa !55
  br label %.lr.ph.1
...
.lr.ph.1:                                         ; preds = %.lr.ph, %bb.ch
  ...
  %i.ho = load i8, ptr %i.hn, align 1, !tbaa !27
  %i.hp = icmp eq i8 %i.ho, 0
  br i1 %i.hp, label %bb.ci, label %bb.cj

bb.ci:                                            ; preds = %.lr.ph.1
  %i.hq = add nsw i32 %i.hl, 1                    ; 2 uses
  store i32 %i.hq, ptr getelementptr inbounds nuw (i8, ptr @_ZL10poolBundle, i64 28), align 4, !tbaa !55
  br label %bb.cj
...
bb.ck:                                            ; preds = %.lr.ph.epil.preheader
  ...
  store i32 %i.hv, ptr getelementptr inbounds nuw (i8, ptr @_ZL10poolBundle, i64 28), align 4, !tbaa !55
  br label %._crit_edge
...
bb.cp:                                            ; preds = %bb.co
  ...
  store i32 0, ptr %i.ie, align 8, !tbaa !58
  %i.if = getelementptr inbounds nuw i8, ptr %i.id, i64 64
  store ptr null, ptr %i.if, align 8, !tbaa !63
  store ptr getelementptr inbounds nuw inrange(-16, 64) (i8, ptr @_ZTV18PseudoListResource, i64 16), ptr %i.id, align 8, !tbaa !16
  store ptr %i.id, ptr getelementptr inbounds nuw (i8, ptr @_ZL10poolBundle, i64 32), align 8, !tbaa !15
  %i.ig = load i32, ptr %i.a, align 4, !tbaa !19
...
bb.cu:                                            ; preds = %bb.dm, %bb.ct
  ...
  %i.im = load i16, ptr %.0177, align 2, !tbaa !64 ; 4 uses
...
.lr.ph318:                                        ; preds = %.lr.ph318.preheader, %bb.cv
  ...
  %i.is = load i16, ptr %i.ir, align 2, !tbaa !64
...
bb.cv:                                            ; preds = %.lr.ph318
  ...
  br i1 %exitcond330.not, label %.critedge, label %.lr.ph318, !llvm.loop !66
...
bb.cz:                                            ; preds = %bb.cy
  ...
  %i.iz = load i16, ptr %i.iy, align 2, !tbaa !64
...
bb.dc:                                            ; preds = %.critedge
  ...
  %i.jq = load i16, ptr %i.jp, align 2, !tbaa !64
...
bb.dj:                                            ; preds = %bb.dg
  store ptr getelementptr inbounds nuw inrange(-16, 64) (i8, ptr @_ZTV14StringResource, i64 16), ptr %i.jw, align 8, !tbaa !16
  ...
  store i8 %.0173, ptr %i.ka, align 4, !tbaa !67
  %i.kb = or i32 %i.jr, 1610612736
  %i.kc = getelementptr inbounds nuw i8, ptr %i.jw, i64 12
  store i32 %i.kb, ptr %i.kc, align 4, !tbaa !71
  %i.kd = getelementptr inbounds nuw i8, ptr %i.jw, i64 9
  store i8 1, ptr %i.kd, align 1, !tbaa !72
  %i.ke = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_ZL10poolBundle, i64 32), align 8, !tbaa !15
...
bb.dk:                                            ; preds = %bb.dj
  store i32 %i.js, ptr getelementptr inbounds nuw (i8, ptr @_ZL10poolBundle, i64 40), align 8, !tbaa !73
  %i.kf = load i32, ptr %i.a, align 4, !tbaa !19
...
bb.dm:                                            ; preds = %bb.de, %bb.dk
  ...
  br i1 %i.kl, label %bb.cu, label %.thread308, !llvm.loop !74

.thread308:                                       ; preds = %bb.dd, %bb.dc, %.critedge, %bb.da, %bb.dm
  %i.km = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_ZL10poolBundle, i64 32), align 8, !tbaa !15 ; 3 uses
...
bb.dn:                                            ; preds = %.thread308
  %i.kq = load ptr, ptr %i.km, align 8, !tbaa !16
  ...
  store ptr null, ptr getelementptr inbounds nuw (i8, ptr @_ZL10poolBundle, i64 32), align 8, !tbaa !15
  br label %bb.do
...
bb.ds:                                            ; preds = %bb.dr
  ...
  %i.ky = load i32, ptr %i.kx, align 8, !tbaa !58
  %i.kz = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.63, i32 noundef %i.ky) ; 0 uses
  %i.la = load i32, ptr getelementptr inbounds nuw (i8, ptr @_ZL10poolBundle, i64 40), align 8, !tbaa !73
...
bb.du:                                            ; preds = %bb.dt
  %i.lf = load ptr, ptr %3, align 8, !tbaa !39
...
bb.dx:                                            ; preds = %_ZN6icu_7810CharStringD2Ev.exit, %bb.ba
  %i.li = load i8, ptr getelementptr inbounds nuw (i8, ptr @options, i64 754), align 2, !tbaa !26
...
bb.eb:                                            ; preds = %bb.ea, %bb.dz, %bb.dx
  %i.lp = load i8, ptr getelementptr inbounds nuw (i8, ptr @options, i64 874), align 2, !tbaa !26
...
bb.el:                                            ; preds = %bb.ek
  %i.mk = load i32, ptr %i.a, align 4, !tbaa !19
  %i.ml = icmp sgt i32 %i.mk, 0                   ; 2 uses
  br i1 %i.ml, label %bb.eq, label %bb.em

bb.em:                                            ; preds = %bb.el
  %i.mm = load ptr, ptr %7, align 8, !tbaa !39
  store ptr %i.mm, ptr @gCurrentFileName, align 8, !tbaa !25
...
bb.eo:                                            ; preds = %bb.en
  %i.mo = load ptr, ptr %7, align 8, !tbaa !39
  %i.mp = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.67, ptr noundef %i.mo) ; 0 uses
  br label %bb.ep

bb.ep:                                            ; preds = %bb.eo, %bb.en
  %i.mq = load i8, ptr getelementptr inbounds nuw (i8, ptr @options, i64 634), align 2, !tbaa !26
