...
begin_hunk_0_@_ZN6icu_785units12_GLOBAL__N_118loadConversionRateERNS0_14ConversionRateERKNS_15MeasureUnitImplES6_NS0_14ConvertibilityERKNS0_15ConversionRatesER10UErrorCode:bb.a
  %i.ob = phi double [ %i.ns, %bb.eh ], [ %i.ns, %bb.ej ], [ %i.oa, %bb.ek ]
  %i.oc = phi double [ %i.nt, %bb.eh ], [ %i.nz, %bb.ej ], [ %i.nt, %bb.ek ]
  %i.od = getelementptr inbounds nuw i8, ptr %0, i64 248
  store double %i.oc, ptr %i.od, align 8, !tbaa !90
  %i.oe = getelementptr inbounds nuw i8, ptr %0, i64 256
  store double %i.ob, ptr %i.oe, align 8, !tbaa !91
  br label %bb.el

bb.el:                                            ; preds = %_ZN6icu_785units6Factor19substituteConstantsEv.exit79, %bb.bz, %.critedge, %bb.o, %bb.ca, %bb.i
  ret void
}
...
bb.b:                                             ; preds = %bb.a
  %i.c = load i32, ptr %0, align 8, !tbaa !39
...
bb.c:                                             ; preds = %bb.b
  store i32 65804, ptr %3, align 4, !tbaa !29
  br label %bb.m
...
bb.d:                                             ; preds = %bb.b
  ...
  %i.h = load i32, ptr %3, align 4, !tbaa !29
...
bb.k:                                             ; preds = %bb.h
  ...
  %i.n = load double, ptr %5, align 8, !tbaa !17
  %i.o = getelementptr inbounds nuw i8, ptr %5, i64 8
  %i.p = load double, ptr %i.o, align 8, !tbaa !18
  %i.q = fdiv double %i.n, %i.p
  %i.r = load double, ptr %6, align 8, !tbaa !17
...
bb.b:                                             ; preds = %bb.a
  ...
  %.pre17 = load ptr, ptr %.pre, align 8, !tbaa !45 ; 3 uses
...
_ZN6icu_785units12_GLOBAL__N_115checkSimpleUnitERKNS_15MeasureUnitImplER10UErrorCode.exit.thread12: ; preds = %bb.b, %_ZN6icu_785units12_GLOBAL__N_115checkSimpleUnitERKNS_15MeasureUnitImplER10UErrorCode.exit
  ...
  %i.m = load i32, ptr %2, align 4, !tbaa !29
...
bb.a:
  ...
  %12 = alloca %"class.icu_78::StringPiece", align 8 ; 7 uses
  ...
  %16 = alloca %"struct.icu_78::units::Factor", align 16 ; 29 uses
  %17 = alloca %"class.icu_78::StringPiece", align 8 ; 3 uses
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 8
  store <2 x double> splat (double 1.000000e+00), ptr %0, align 8, !tbaa !12
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  store double 0.000000e+00, ptr %i.e, align 8, !tbaa !16
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 24
  store i8 0, ptr %i.f, align 8, !tbaa !100
  %scevgep.i = getelementptr inbounds nuw i8, ptr %0, i64 28 ; 2 uses
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(60) %scevgep.i, i8 0, i64 60, i1 false), !tbaa !13
...
bb.b:                                             ; preds = %.lr.ph, %_ZN6icu_785units6Factor11applyPrefixENS_14UMeasurePrefixE.exit
  ...
  %i.bx = load ptr, ptr %i.j, align 8, !tbaa !41
  ...
  %i.ce = load i32, ptr %3, align 4, !tbaa !29, !noalias !101
...
.loopexit.loopexit.i:                             ; preds = %bb.c
  store i32 5, ptr %3, align 4, !tbaa !29, !noalias !101
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.ci = load ptr, ptr %i.ch, align 8, !tbaa !46, !noalias !101 ; 2 uses
  ...
  %i.cl = load i32, ptr %i.o, align 8, !noalias !101 ; 6 uses
  ...
  store <2 x double> splat (double 1.000000e+00), ptr %16, align 16, !tbaa !12, !alias.scope !103
  store double 0.000000e+00, ptr %i.m, align 16, !tbaa !16, !alias.scope !103
  store i8 0, ptr %i.n, align 8, !tbaa !100, !alias.scope !103
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(60) %scevgep.i15, i8 0, i64 60, i1 false), !tbaa !13, !alias.scope !103
...
bb.e:                                             ; preds = %bb.g, %.lr.ph.i.split.i
  %indvars.iv.i.i = phi i64 [ 0, %.lr.ph.i.split.i ], [ %indvars.iv.next.i.i, %bb.g ] ; 4 uses
  %.041.i.i = phi i32 [ 1, %.lr.ph.i.split.i ], [ %spec.select.i18.i, %bb.g ] ; 2 uses
  %.03039.i.i = phi i32 [ 0, %.lr.ph.i.split.i ], [ %.131.i.i, %bb.g ] ; 3 uses
  %i.cq = getelementptr inbounds nuw i8, ptr %i.ck, i64 %indvars.iv.i.i ; 2 uses
  %i.cr = load i8, ptr %i.cq, align 1, !tbaa !73, !noalias !103 ; 2 uses
...
bb.f:                                             ; preds = %bb.e, %bb.e
  ...
  %.pre = load i8, ptr %i.cq, align 1, !tbaa !73, !noalias !103
  br label %bb.g

bb.g:                                             ; preds = %bb.e, %bb.f
  %18 = phi i8 [ %.pre, %bb.f ], [ %i.cr, %bb.e ]
  %.131.i.i = phi i32 [ %i.cu, %bb.f ], [ %.03039.i.i, %bb.e ] ; 2 uses
  %i.cv = icmp eq i8 %18, 47
...
_ZN6icu_785units12_GLOBAL__N_124extractFactorConversionsENS_11StringPieceER10UErrorCode.exit.loopexit.peel.begin.i: ; preds = %bb.g, %.lr.ph.i.i
  ...
  %i.da = load i8, ptr %i.cz, align 1, !tbaa !73, !noalias !103
...
bb.h:                                             ; preds = %_ZN6icu_785units12_GLOBAL__N_124extractFactorConversionsENS_11StringPieceER10UErrorCode.exit.loopexit.peel.begin.i, %_ZN6icu_785units12_GLOBAL__N_124extractFactorConversionsENS_11StringPieceER10UErrorCode.exit.loopexit.peel.begin.i
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %11), !noalias !103
  call void @_ZN6icu_7811StringPieceC1ERKS0_ii(ptr noundef nonnull align 8 dereferenceable(12) %11, ptr noundef nonnull align 8 dereferenceable(12) %12, i32 noundef %i.cy, i32 noundef %i.dc), !noalias !103
...
bb.j:                                             ; preds = %bb.i
  ...
  call void @_ZN6icu_7811StringPieceC1ERKS0_ii(ptr noundef nonnull align 8 dereferenceable(12) %10, ptr noundef nonnull align 8 dereferenceable(12) %12, i32 noundef %i.cy, i32 noundef %i.cl), !noalias !103
...
_ZN6icu_785units12_GLOBAL__N_124extractFactorConversionsENS_11StringPieceER10UErrorCode.exit.i: ; preds = %bb.j, %bb.i, %bb.h, %bb.d
  ...
  %i.df = load ptr, ptr %i.de, align 8, !tbaa !46, !noalias !101 ; 2 uses
  ...
  %i.dh = load ptr, ptr %14, align 8, !noalias !101 ; 3 uses
  %i.di = load i32, ptr %i.q, align 8, !noalias !101 ; 5 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %9), !noalias !101
  store ptr %i.dh, ptr %9, align 8, !noalias !101
  store i32 %i.di, ptr %i.r, align 8, !noalias !101
...
.lr.ph.i21.i:                                     ; preds = %bb.k, %.lr.ph.preheader.i.i
  ...
  %i.dl = load i8, ptr %i.dk, align 1, !tbaa !73, !noalias !101
...
bb.l:                                             ; preds = %.lr.ph.i21.i
  ...
  call void @_ZN6icu_7811StringPieceC1ERKS0_ii(ptr noundef nonnull align 8 dereferenceable(12) %8, ptr noundef nonnull align 8 dereferenceable(12) %9, i32 noundef 0, i32 noundef %i.dn), !noalias !101
  ...
  store i32 0, ptr %7, align 8, !tbaa !24, !noalias !101
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.v, i8 0, i64 16, i1 false), !noalias !101
  store <2 x ptr> <ptr @.str.20, ptr @.str.20>, ptr %i.w, align 8, !tbaa !61, !noalias !101
  store i16 0, ptr %i.x, align 8, !tbaa !27, !noalias !101
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c) #19, !noalias !101
  %i.do = call noundef double @_ZNK6icu_7817double_conversion23StringToDoubleConverter14StringToDoubleEPKciPi(ptr noundef nonnull align 8 dereferenceable(42) %7, ptr noundef %.fca.0.load.i.i25.i, i32 noundef %.fca.1.load.i.i27.i, ptr noundef nonnull %i.c), !noalias !101
  %i.dp = load i32, ptr %i.c, align 4, !tbaa !13, !noalias !101
...
bb.m:                                             ; preds = %bb.l
  store i32 3, ptr %3, align 4, !tbaa !29, !noalias !101
...
_ZN6icu_785units12_GLOBAL__N_111strToDoubleENS_11StringPieceER10UErrorCode.exit.i.i: ; preds = %bb.m, %bb.l
  ...
  call void @_ZN6icu_7811StringPieceC1ERKS0_ii(ptr noundef nonnull align 8 dereferenceable(12) %6, ptr noundef nonnull align 8 dereferenceable(12) %9, i32 noundef %i.dq, i32 noundef %i.y), !noalias !101
  ...
  store i32 0, ptr %5, align 8, !tbaa !24, !noalias !101
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.z, i8 0, i64 16, i1 false), !noalias !101
  store <2 x ptr> <ptr @.str.20, ptr @.str.20>, ptr %i.aa, align 8, !tbaa !61, !noalias !101
  store i16 0, ptr %i.ab, align 8, !tbaa !27, !noalias !101
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #19, !noalias !101
  %i.dr = call noundef double @_ZNK6icu_7817double_conversion23StringToDoubleConverter14StringToDoubleEPKciPi(ptr noundef nonnull align 8 dereferenceable(42) %5, ptr noundef %.fca.0.load.i23.i.i, i32 noundef %.fca.1.load.i26.i.i, ptr noundef nonnull %i.b), !noalias !101
  %i.ds = load i32, ptr %i.b, align 4, !tbaa !13, !noalias !101
...
._crit_edge.i.i:                                  ; preds = %bb.k, %_ZN6icu_785units12_GLOBAL__N_124extractFactorConversionsENS_11StringPieceER10UErrorCode.exit.i
  ...
  store i32 0, ptr %4, align 8, !tbaa !24, !noalias !101
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.s, i8 0, i64 16, i1 false), !noalias !101
  store <2 x ptr> <ptr @.str.20, ptr @.str.20>, ptr %i.t, align 8, !tbaa !61, !noalias !101
  store i16 0, ptr %i.u, align 8, !tbaa !27, !noalias !101
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #19, !noalias !101
  %i.du = call noundef double @_ZNK6icu_7817double_conversion23StringToDoubleConverter14StringToDoubleEPKciPi(ptr noundef nonnull align 8 dereferenceable(42) %4, ptr noundef %i.dh, i32 noundef %i.di, ptr noundef nonnull %i.a), !noalias !101
  %i.dv = load i32, ptr %i.a, align 4, !tbaa !13, !noalias !101
...
_ZN6icu_785units12_GLOBAL__N_116loadSingleFactorENS_11StringPieceERKNS0_15ConversionRatesER10UErrorCode.exit: ; preds = %_ZN6icu_785units12_GLOBAL__N_111strToDoubleENS_11StringPieceER10UErrorCode.exit29.i.i, %_ZN6icu_785units12_GLOBAL__N_111strToDoubleENS_11StringPieceER10UErrorCode.exit31.i.i
  ...
  %.pre.a = load i32, ptr %3, align 4, !tbaa !29
...
bb.p:                                             ; preds = %_ZN6icu_785units12_GLOBAL__N_116loadSingleFactorENS_11StringPieceERKNS0_15ConversionRatesER10UErrorCode.exit
  %i.dx = load i32, ptr %i.ac, align 4, !tbaa !105 ; 3 uses
...
bb.r:                                             ; preds = %bb.q
  %i.eg = load double, ptr %16, align 16, !tbaa !17
  %i.eh = fmul double %i.ee, %i.eg
  store double %i.eh, ptr %16, align 16, !tbaa !17
  br label %_ZN6icu_785units6Factor11applyPrefixENS_14UMeasurePrefixE.exit

bb.s:                                             ; preds = %bb.q
  %i.ei = load double, ptr %i.l, align 8, !tbaa !18
  %i.ej = fmul double %i.ee, %i.ei
  store double %i.ej, ptr %i.l, align 8, !tbaa !18
  br label %_ZN6icu_785units6Factor11applyPrefixENS_14UMeasurePrefixE.exit

_ZN6icu_785units6Factor11applyPrefixENS_14UMeasurePrefixE.exit: ; preds = %bb.p, %bb.r, %bb.s
  %i.ek = load i32, ptr %i.ad, align 4, !tbaa !49 ; 17 uses
  %i.el = load i32, ptr %scevgep.i15, align 4, !tbaa !13
  %i.em = mul nsw i32 %i.el, %i.ek                ; 2 uses
  store i32 %i.em, ptr %scevgep.i15, align 4, !tbaa !13
  %i.en = load i32, ptr %i.ae, align 16, !tbaa !13
  %i.eo = mul nsw i32 %i.en, %i.ek                ; 2 uses
  store i32 %i.eo, ptr %i.ae, align 16, !tbaa !13
  %i.ep = load i32, ptr %i.af, align 4, !tbaa !13
  %i.eq = mul nsw i32 %i.ep, %i.ek                ; 2 uses
  store i32 %i.eq, ptr %i.af, align 4, !tbaa !13
  %i.er = load i32, ptr %i.ag, align 8, !tbaa !13
  %i.es = mul nsw i32 %i.er, %i.ek                ; 2 uses
  store i32 %i.es, ptr %i.ag, align 8, !tbaa !13
  %i.et = load i32, ptr %i.ah, align 4, !tbaa !13
end_hunk_0
