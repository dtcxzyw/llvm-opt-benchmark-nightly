Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/icu/original/tzgnames?download=true
...
begin_hunk_0_@_ZNK6icu_7828TimeZoneGenericNameMatchInfo13getTimeZoneIDEiRNS_13UnicodeStringE:bb.a
  %i.i = load ptr, ptr %3, align 8, !tbaa !29
...
bb.a:
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVN6icu_7818GNameSearchHandlerE, i64 16), ptr %0, align 8, !tbaa !13
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i32 %1, ptr %i.a, align 8, !tbaa !33
...
bb.b:                                             ; preds = %bb.a
  %i.d = load ptr, ptr %i.b, align 8, !tbaa !13
...
bb.d:                                             ; preds = %.lr.ph, %.critedge52
  ...
  %i.m = load i8, ptr %i.d, align 2, !tbaa !86
  %.not.i53 = icmp eq i8 %i.m, 0
  %i.n = load ptr, ptr %2, align 8, !tbaa !85     ; 2 uses
...
bb.f:                                             ; preds = %_ZNK6icu_7813CharacterNode8getValueEi.exit
  %i.q = load i32, ptr %.0.i, align 8, !tbaa !25
  %i.r = load i32, ptr %i.j, align 8, !tbaa !33
  %i.s = and i32 %i.r, %i.q
...
_ZN6icu_7812LocalPointerINS_7UVectorEEC2EPS1_R10UErrorCode.exit: ; preds = %bb.i
  %.pre = load i32, ptr %3, align 4, !tbaa !37
...
bb.o:                                             ; preds = %bb.m
  ...
  %i.ag = load i32, ptr %3, align 4, !tbaa !37
...
.critedge:                                        ; preds = %_ZN6icu_7812LocalPointerINS_7UVectorEEC2EPS1_R10UErrorCode.exit
  ...
  tail call void %i.am(ptr noundef nonnull align 8 dereferenceable(40) %i.v) #19, !inline_history !81
  br label %.thread67

.critedge52:                                      ; preds = %bb.q, %bb.p, %bb.f
  %i.an = add nuw nsw i32 %.03869, 1              ; 2 uses
  %exitcond.not = icmp eq i32 %i.an, %i.i
  br i1 %exitcond.not, label %.thread67, label %bb.d, !llvm.loop !82
...
bb.a:
  ...
  store i32 %i.d, ptr %1, align 4, !tbaa !40
...
bb.a:
  store ptr getelementptr inbounds nuw inrange(-16, 16) (i8, ptr @_ZTVN6icu_788TZGNCoreE, i64 16), ptr %0, align 8, !tbaa !13
...
bb.c:                                             ; preds = %bb.b
  ...
  store i8 0, ptr %i.j, align 8, !tbaa !56
...
bb.i:                                             ; preds = %bb.c
  %i.p = landingpad { ptr, i32 }
          cleanup
  %i.q = load ptr, ptr %i.k, align 8, !tbaa !57
...
bb.a:
  ...
  %i.b = load i32, ptr %2, align 4, !tbaa !37
...
bb.b:                                             ; preds = %bb.a
  ...
  store ptr %i.d, ptr %i.e, align 8, !tbaa !58
  %i.f = load i32, ptr %2, align 4, !tbaa !37
  %i.g = icmp slt i32 %i.f, 1
  br i1 %i.g, label %bb.c, label %bb.bv

bb.c:                                             ; preds = %bb.b
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #19
  store ptr @_ZN6icu_78L17gDefRegionPatternE, ptr %4, align 8, !tbaa !29
...
bb.d:                                             ; preds = %bb.c
  %i.h = load ptr, ptr %4, align 8, !tbaa !29
  call void asm sideeffect "", "rm,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr %i.h) #19, !srcloc !30
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #19
  store ptr @_ZN6icu_78L19gDefFallbackPatternE, ptr %6, align 8, !tbaa !29
...
bb.h:                                             ; preds = %bb.g
  %i.m = load i32, ptr %i.a, align 4, !tbaa !37
