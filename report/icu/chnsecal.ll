...
bb.l:                                             ; preds = %bb.k
  ...
  %i.ao = fcmp oge <2 x double> %i.an, zeroinitializer ; 2 uses
  %4 = extractelement <2 x i1> %i.ao, i64 1
  %5 = select i1 %4, double 5.000000e-01, double -5.000000e-01
  %i.ap = extractelement <2 x double> %i.an, i64 1
  %6 = fadd double %i.ap, %5
  %i.aq = fptosi double %6 to i32
  ...
  %7 = extractelement <2 x i1> %i.ao, i64 0
  %8 = select i1 %7, double 5.000000e-01, double -5.000000e-01
  %i.as = extractelement <2 x double> %i.an, i64 0
  %9 = fadd double %i.as, %8
  %i.at = fptosi double %9 to i32                 ; 5 uses
