...
.lr.ph203.preheader:                              ; preds = %.lr.ph
  ...
  %12 = add i32 %11, %i.bp
  %indvars.iv223.lcssa.sroa.phi = select i1 %exitcond227.not.5, ptr %indvars.iv223.lcssa.sroa.gep280, ptr %indvars.iv223.lcssa.sroa.gep281
  %.lcssa = select i1 %exitcond227.not.5, i32 %i.bp, i32 %12
