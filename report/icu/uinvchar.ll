Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/icu/original/uinvchar?download=true
inline.NumInlined: 4
inline.NumDeleted: 1
loop-unroll.NumRuntimeUnrolled: 1
loop-unroll.NumUnrolled: 1
begin_hunk_0_@u_UCharsToChars_78:bb.a
  br i1 %.not, label %bb.e, label %.lr.ph.1
...
.lr.ph.1:                                         ; preds = %bb.e, %bb.d
  ...
  store i8 %i.ab, ptr %.0812, align 1, !tbaa !8
  %i.ad = getelementptr inbounds nuw i8, ptr %.0911, i64 4
  %i.ae = load i16, ptr %i.q, align 2, !tbaa !10  ; 3 uses
...
bb.h:                                             ; preds = %bb.g, %bb.f
  ...
  store i8 %i.ao, ptr %i.ac, align 1, !tbaa !8
...
define signext range(i8 0, 2) i8 @uprv_isInvariantString_78(ptr nofree noundef readonly captures(none) %0, i32 noundef %1) local_unnamed_addr #1 {
bb.a:
  br label %.backedge
...
bb.b:                                             ; preds = %.backedge
  ...
  %i.c = load i8, ptr %.011, align 1, !tbaa !8    ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.h = load i8, ptr %.011, align 1, !tbaa !8    ; 2 uses
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define signext range(i8 0, 2) i8 @uprv_isInvariantUString_78(ptr nofree noundef readonly captures(none) %0, i32 noundef %1) local_unnamed_addr #1 {
bb.a:
  br label %bb.b
...
bb.c:                                             ; preds = %bb.b
  %i.b = load i16, ptr %.010, align 2, !tbaa !10  ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.f = load i16, ptr %.010, align 2, !tbaa !10
  br label %bb.f
...
bb.g:                                             ; preds = %bb.f
  ...
  br i1 %.not, label %bb.h, label %bb.b, !llvm.loop !28
...
define range(i32 0, -2147483648) i32 @uprv_ebcdicFromAscii_78(ptr noundef %0, ptr nofree noundef readonly captures(address_is_null) %1, i32 noundef %2, ptr nofree noundef writeonly captures(address_is_null) %3, ptr nofree noundef captures(address_is_null) %4) local_unnamed_addr #2 {
bb.a:
  %i.a = icmp eq ptr %4, null
  br i1 %i.a, label %.loopexit, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.b = load i32, ptr %4, align 4, !tbaa !14
...
.lr.ph:                                           ; preds = %.preheader, %bb.g
  ...
  %.03041 = phi ptr [ %i.x, %bb.g ], [ %3, %.preheader ] ; 2 uses
  %.03140 = phi ptr [ %i.i, %bb.g ], [ %1, %.preheader ] ; 2 uses
  %i.i = getelementptr inbounds nuw i8, ptr %.03140, i64 1
  %i.j = load i8, ptr %.03140, align 1, !tbaa !8  ; 3 uses
...
bb.g:                                             ; preds = %bb.e
  ...
  %i.x = getelementptr inbounds nuw i8, ptr %.03041, i64 1
  store i8 %i.w, ptr %.03041, align 1, !tbaa !8
  %i.y = add nsw i32 %.042, -1
  %i.z = icmp sgt i32 %.042, 1
  br i1 %i.z, label %.lr.ph, label %.loopexit, !llvm.loop !29
...
.loopexit:                                        ; preds = %bb.g, %.loopexit.sink.split, %.preheader, %bb.a, %bb.b
  %.032 = phi i32 [ 0, %bb.a ], [ 0, %.preheader ], [ 0, %.loopexit.sink.split ], [ 0, %bb.b ], [ %2, %bb.g ]
  ret i32 %.032
}
...
; Function Attrs: mustprogress uwtable
define range(i32 0, -2147483648) i32 @uprv_copyAscii_78(ptr noundef %0, ptr nofree noundef readonly captures(address) %1, i32 noundef %2, ptr nofree noundef writeonly captures(address) %3, ptr nofree noundef captures(address_is_null) %4) local_unnamed_addr #2 {
bb.a:
  %i.a = icmp eq ptr %4, null
...
.lr.ph:                                           ; preds = %.preheader, %bb.h
  ...
  %.03346 = phi ptr [ %i.i, %bb.h ], [ %1, %.preheader ] ; 2 uses
  %i.i = getelementptr inbounds nuw i8, ptr %.03346, i64 1
  %i.j = load i8, ptr %.03346, align 1, !tbaa !8  ; 2 uses
  %i.k = icmp sgt i8 %i.j, -1
...
bb.h:                                             ; preds = %bb.f
  ...
  br i1 %i.v, label %.lr.ph, label %._crit_edge, !llvm.loop !30
...
._crit_edge.thread:                               ; preds = %.preheader, %._crit_edge, %bb.i, %bb.a, %bb.b, %bb.g, %bb.e
  %.034 = phi i32 [ 0, %bb.a ], [ 0, %bb.e ], [ 0, %bb.g ], [ 0, %bb.b ], [ %2, %bb.i ], [ %2, %._crit_edge ], [ 0, %.preheader ]
  ret i32 %.034
}
...
; Function Attrs: mustprogress uwtable
define range(i32 0, -2147483648) i32 @uprv_asciiFromEbcdic_78(ptr noundef %0, ptr nofree noundef readonly captures(address_is_null) %1, i32 noundef %2, ptr nofree noundef writeonly captures(address_is_null) %3, ptr nofree noundef captures(address_is_null) %4) local_unnamed_addr #2 {
bb.a:
  %i.a = icmp eq ptr %4, null
  br i1 %i.a, label %.loopexit, label %bb.b
...
.lr.ph:                                           ; preds = %.preheader, %bb.h
  ...
  %i.j = load i8, ptr %.03748, align 1, !tbaa !8  ; 2 uses
...
bb.e:                                             ; preds = %.lr.ph
  ...
  %i.m = load i8, ptr %i.l, align 1, !tbaa !8     ; 3 uses
...
bb.h:                                             ; preds = %bb.f, %.lr.ph
  ...
  store i8 %.035, ptr %.03649, align 1, !tbaa !8
  %i.x = add nsw i32 %.050, -1
  %i.y = icmp sgt i32 %.050, 1
  br i1 %i.y, label %.lr.ph, label %.loopexit, !llvm.loop !31
...
; Function Attrs: mustprogress uwtable
define range(i32 0, -2147483648) i32 @uprv_copyEbcdic_78(ptr noundef %0, ptr nofree noundef readonly captures(address) %1, i32 noundef %2, ptr nofree noundef writeonly captures(address) %3, ptr nofree noundef captures(address_is_null) %4) local_unnamed_addr #2 {
bb.a:
  %i.a = icmp eq ptr %4, null
  br i1 %i.a, label %._crit_edge.thread, label %bb.b
...
.lr.ph:                                           ; preds = %.preheader, %bb.i
  ...
  %i.j = load i8, ptr %.03853, align 1, !tbaa !8  ; 2 uses
...
define signext range(i8 0, 2) i8 @uprv_isEbcdicAtSign_78(i8 noundef signext %0) local_unnamed_addr #5 {
bb.a:
  %.not = icmp eq i8 %0, 0
...
; Function Attrs: mustprogress uwtable
define i32 @uprv_compareInvAscii_78(ptr nofree noundef readnone captures(none) %0, ptr nofree noundef readonly captures(address_is_null) %1, i32 noundef %2, ptr noundef %3, i32 noundef %4) local_unnamed_addr #2 {
bb.a:
...
bb.c:                                             ; preds = %bb.b
  %i.f = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %1) #10
  %i.g = trunc i64 %i.f to i32
  br label %bb.d

bb.d:                                             ; preds = %bb.c, %bb.b
  %.037 = phi i32 [ %i.g, %bb.c ], [ %2, %bb.b ]  ; 2 uses
  %i.h = icmp slt i32 %4, 0
  br i1 %i.h, label %bb.e, label %bb.f

bb.e:                                             ; preds = %bb.d
  %i.i = tail call i32 @u_strlen_78(ptr noundef nonnull %3)
  br label %bb.f

bb.f:                                             ; preds = %bb.e, %bb.d
  %.035 = phi i32 [ %i.i, %bb.e ], [ %4, %bb.d ]  ; 2 uses
  %i.j = tail call i32 @llvm.smin.i32(i32 %.037, i32 %.035) ; 2 uses
  %i.k = icmp sgt i32 %i.j, 0
  br i1 %i.k, label %.lr.ph, label %._crit_edge

bb.g:                                             ; preds = %bb.m
  %i.l = add nsw i32 %.03451, -1
  %i.m = icmp sgt i32 %.03451, 1
  br i1 %i.m, label %.lr.ph, label %._crit_edge, !llvm.loop !33

.lr.ph:                                           ; preds = %bb.f, %bb.g
  %.03451 = phi i32 [ %i.l, %bb.g ], [ %i.j, %bb.f ] ; 2 uses
  %.03650 = phi ptr [ %i.y, %bb.g ], [ %3, %bb.f ] ; 2 uses
  %.03849 = phi ptr [ %i.n, %bb.g ], [ %1, %bb.f ] ; 2 uses
  %i.n = getelementptr inbounds nuw i8, ptr %.03849, i64 1
  %i.o = load i8, ptr %.03849, align 1, !tbaa !8  ; 2 uses
...
bb.j:                                             ; preds = %bb.h, %bb.i
  %.033 = phi i32 [ -1, %bb.i ], [ %i.q, %bb.h ]
  %i.y = getelementptr inbounds nuw i8, ptr %.03650, i64 2
  %i.z = load i16, ptr %.03650, align 2, !tbaa !10 ; 2 uses
...
bb.m:                                             ; preds = %bb.l, %bb.k
  %.0 = phi i32 [ %i.ab, %bb.k ], [ -2, %bb.l ]
  %i.aj = sub nsw i32 %.033, %.0                  ; 2 uses
  %.not48 = icmp eq i32 %i.aj, 0
  br i1 %.not48, label %bb.g, label %.loopexit

._crit_edge:                                      ; preds = %bb.g, %bb.f
  %i.ak = sub nsw i32 %.037, %.035
  br label %.loopexit

.loopexit:                                        ; preds = %bb.m, %bb.a, %._crit_edge
  %.039 = phi i32 [ %i.ak, %._crit_edge ], [ 0, %bb.a ], [ %i.aj, %bb.m ]
  ret i32 %.039
}
...
; Function Attrs: mustprogress uwtable
define i32 @uprv_compareInvEbcdic_78(ptr nofree noundef readnone captures(none) %0, ptr nofree noundef readonly captures(address_is_null) %1, i32 noundef %2, ptr noundef %3, i32 noundef %4) local_unnamed_addr #2 {
bb.a:
  %i.a = icmp eq ptr %1, null
  %i.b = icmp slt i32 %2, -1
  %or.cond = or i1 %i.a, %i.b
...
bb.d:                                             ; preds = %bb.c, %bb.b
  %.040 = phi i32 [ %i.g, %bb.c ], [ %2, %bb.b ]  ; 2 uses
  %i.h = icmp slt i32 %4, 0
  br i1 %i.h, label %bb.e, label %bb.f
...
bb.f:                                             ; preds = %bb.e, %bb.d
  %.038 = phi i32 [ %i.i, %bb.e ], [ %4, %bb.d ]  ; 2 uses
  %i.j = tail call i32 @llvm.smin.i32(i32 %.040, i32 %.038) ; 2 uses
  %i.k = icmp sgt i32 %i.j, 0
  br i1 %i.k, label %.lr.ph, label %._crit_edge

bb.g:                                             ; preds = %bb.n
  %i.l = add nsw i32 %.03755, -1
  %i.m = icmp sgt i32 %.03755, 1
  br i1 %i.m, label %.lr.ph, label %._crit_edge, !llvm.loop !34

.lr.ph:                                           ; preds = %bb.f, %bb.g
  %.03755 = phi i32 [ %i.l, %bb.g ], [ %i.j, %bb.f ] ; 2 uses
  %.03954 = phi ptr [ %i.ab, %bb.g ], [ %3, %bb.f ] ; 2 uses
  %.04153 = phi ptr [ %i.n, %bb.g ], [ %1, %bb.f ] ; 2 uses
  %i.n = getelementptr inbounds nuw i8, ptr %.04153, i64 1
  %i.o = load i8, ptr %.04153, align 1, !tbaa !8  ; 2 uses
