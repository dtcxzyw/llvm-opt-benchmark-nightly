...
.sink.split:                                      ; preds = %middle.block150, %bb.h
  ...
  %.1102.ph = phi i32 [ %i.bt, %bb.h ], [ %i.bn, %middle.block150 ]
  %.099.ph = phi i32 [ %i.ca, %bb.h ], [ 0, %middle.block150 ]
...
bb.i:                                             ; preds = %.sink.split, %middle.block, %middle.block150
  %.1102 = phi i32 [ %i.bt, %middle.block ], [ %i.bn, %middle.block150 ], [ %.1102.ph, %.sink.split ] ; 2 uses
  %.099 = phi i32 [ 0, %middle.block ], [ 0, %middle.block150 ], [ %.099.ph, %.sink.split ] ; 2 uses
  ...
  %i.cs = shl nuw nsw i32 %.095, 2                ; 2 uses
  ...
  %i.di = shl nuw nsw i32 %.099, 1                ; 2 uses
...
bb.m:                                             ; preds = %bb.l, %bb.i
  ...
  %i.eo = getelementptr inbounds nuw [4 x i8], ptr %i.en, i64 %.1104
  %i.ep = getelementptr inbounds nuw i8, ptr %0, i64 67768
  %i.eq = getelementptr inbounds nuw [2 x i8], ptr %i.ep, i64 %.1104
...
bb.q:                                             ; preds = %bb.o, %bb.p, %bb.k
  %.094 = phi i32 [ 0, %bb.k ], [ %spec.select, %bb.p ], [ %spec.select, %bb.o ]
