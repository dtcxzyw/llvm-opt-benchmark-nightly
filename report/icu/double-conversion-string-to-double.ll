...
bb.e:                                             ; preds = %.preheader358, %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175
  ...
  %.promoted389 = phi ptr [ %24, %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175 ], [ %.promoted385, %.preheader358 ] ; 10 uses
...
9:                                                ; preds = %bb.k
  ...
  br i1 %i.m, label %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175.sink.split, label %11, !llvm.loop !52

11:                                               ; preds = %9
  store ptr %10, ptr %0, align 8, !tbaa !15
  %12 = icmp ne ptr %10, %1
  %or.cond512.not = select i1 %or.cond.i160, i1 %12, i1 false
  br i1 %or.cond512.not, label %bb.l, label %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175, !llvm.loop !52

bb.l:                                             ; preds = %11
  %i.as = getelementptr inbounds nuw i8, ptr %.promoted389, i64 2 ; 15 uses
  %13 = icmp eq ptr %i.as, %1
  br i1 %13, label %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175, label %14, !llvm.loop !52

14:                                               ; preds = %bb.l
  %15 = load i8, ptr %10, align 1, !tbaa !22
  %16 = sext i8 %15 to i32
  %17 = icmp eq i32 %i.c, %16
  br i1 %17, label %18, label %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175, !llvm.loop !52

18:                                               ; preds = %14
  %19 = load i8, ptr %i.as, align 1, !tbaa !22    ; 3 uses
  ...
  br i1 %23, label %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175.sink.split, label %switch.early.test349, !llvm.loop !52

switch.early.test349:                             ; preds = %18
  switch i8 %19, label %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175 [
...
_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175: ; preds = %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175.sink.split, %11, %switch.early.test353, %switch.early.test349, %bb.ad, %bb.ac, %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit224, %.split299, %14, %bb.l
  %24 = phi ptr [ %10, %14 ], [ %10, %switch.early.test349 ], [ %i.dv, %bb.ac ], [ %i.dq, %.split299 ], [ %i.dv, %bb.ad ], [ %i.dv, %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit224 ], [ %10, %11 ], [ %10, %bb.l ], [ %i.dv, %switch.early.test353 ], [ %.sink, %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175.sink.split ] ; 2 uses
  %.5139 = phi i64 [ %.0134, %14 ], [ %.0134, %switch.early.test349 ], [ %i.bb, %bb.ac ], [ %i.bb, %.split299 ], [ %i.bb, %bb.ad ], [ %i.bb, %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit224 ], [ %.0134, %11 ], [ %.0134, %bb.l ], [ %i.bb, %switch.early.test353 ], [ %.5139.ph516, %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175.sink.split ]
  %.7 = phi i32 [ %.0128, %14 ], [ %.0128, %switch.early.test349 ], [ %spec.select148, %bb.ac ], [ %spec.select148, %.split299 ], [ %spec.select148, %bb.ad ], [ %spec.select148, %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit224 ], [ %.0128, %11 ], [ %.0128, %bb.l ], [ %spec.select148, %switch.early.test353 ], [ %.7.ph517, %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175.sink.split ]
  %.5 = phi i8 [ 1, %14 ], [ 1, %switch.early.test349 ], [ %.0123, %bb.ac ], [ %.0123, %.split299 ], [ %.0123, %bb.ad ], [ %.0123, %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit224 ], [ 1, %11 ], [ 1, %bb.l ], [ %.0123, %switch.early.test353 ], [ %.5.ph, %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175.sink.split ]
  %.pre = load i8, ptr %24, align 1, !tbaa !22
  br label %bb.e
