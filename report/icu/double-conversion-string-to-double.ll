...
bb.e:                                             ; preds = %.preheader358, %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175
  ...
  %.0129 = phi i8 [ %.5134, %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175 ], [ 0, %.preheader358 ] ; 20 uses
  %.0122 = phi i32 [ %.7, %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175 ], [ 0, %.preheader358 ] ; 23 uses
  %.0116 = phi i64 [ %.5, %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175 ], [ 0, %.preheader358 ] ; 22 uses
...
_ZN6icu_7817double_conversionL24IsCharacterDigitForRadixEiic.exit: ; preds = %bb.f
  ...
  br i1 %i.ak, label %12, label %_ZN6icu_7817double_conversionL24IsCharacterDigitForRadixEiic.exit162.thread282

12:                                               ; preds = %_ZN6icu_7817double_conversionL24IsCharacterDigitForRadixEiic.exit
...
bb.g:                                             ; preds = %bb.f
  ...
  br i1 %or.cond325, label %15, label %_ZN6icu_7817double_conversionL24IsCharacterDigitForRadixEiic.exit162.thread282
...
bb.j:                                             ; preds = %bb.i
  ...
  %or.cond513.not = select i1 %or.cond.i160, i1 %i.an, i1 false
  br i1 %or.cond513.not, label %bb.k, label %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175, !llvm.loop !50
...
bb.o:                                             ; preds = %15, %12, %9
  %.0137 = phi i64 [ %14, %12 ], [ %17, %15 ], [ %11, %9 ]
  %i.bd = trunc nuw i8 %.0129 to i1
  %i.be = add nsw i32 %.0122, -4
  %spec.select148 = select i1 %i.bd, i32 %i.be, i32 %.0122 ; 22 uses
  %i.bf = shl nsw i64 %.0116, 4
  %i.bg = add nsw i64 %.0137, %i.bf               ; 24 uses
...
.lr.ph388:                                        ; preds = %.preheader, %.lr.ph388
  %.0135387 = phi i32 [ %i.bk, %.lr.ph388 ], [ 1, %.preheader ]
  %.0136386 = phi i32 [ %i.bl, %.lr.ph388 ], [ %i.bi, %.preheader ] ; 2 uses
  %i.bk = add nuw nsw i32 %.0135387, 1            ; 2 uses
  %i.bl = lshr i32 %.0136386, 1
  %i.bm = icmp samesign ugt i32 %.0136386, 3
  br i1 %i.bm, label %.lr.ph388, label %._crit_edge, !llvm.loop !51

._crit_edge:                                      ; preds = %.lr.ph388, %.preheader
  %.0135.lcssa = phi i32 [ 1, %.preheader ], [ %i.bk, %.lr.ph388 ] ; 4 uses
  %notmask = shl nsw i32 -1, %.0135.lcssa
  %i.bn = xor i32 %notmask, -1
  %i.bo = trunc i64 %i.bg to i32
  %i.bp = and i32 %i.bn, %i.bo                    ; 2 uses
  %i.bq = zext nneg i32 %.0135.lcssa to i64
  %i.br = ashr i64 %i.bg, %i.bq                   ; 4 uses
  %i.bs = add nsw i32 %.0135.lcssa, %spec.select148
  br label %bb.p
...
bb.p:                                             ; preds = %_ZN6icu_7817double_conversionL7isDigitEii.exit.thread, %._crit_edge
  ...
  %.2124 = phi i32 [ %i.bs, %._crit_edge ], [ %spec.select149, %_ZN6icu_7817double_conversionL7isDigitEii.exit.thread ] ; 3 uses
  %.0121 = phi i1 [ true, %._crit_edge ], [ %spec.select328, %_ZN6icu_7817double_conversionL7isDigitEii.exit.thread ] ; 2 uses
...
_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit201thread-pre-split: ; preds = %bb.v, %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit188.thread
  %.ph471 = phi ptr [ %i.cp, %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit188.thread ], [ %i.cs, %bb.v ] ; 2 uses
  %.2131.ph = phi i8 [ %.1130, %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit188.thread ], [ 1, %bb.v ]
  %.pr472 = load i8, ptr %.ph471, align 1, !tbaa !17
...
_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit201: ; preds = %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit201thread-pre-split, %bb.u
  %i.ct = phi i8 [ %.pr472, %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit201thread-pre-split ], [ %i.cq, %bb.u ] ; 5 uses
  %i.cu = phi ptr [ %.ph471, %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit201thread-pre-split ], [ %i.cp, %bb.u ] ; 2 uses
  %.2131 = phi i8 [ %.2131.ph, %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit201thread-pre-split ], [ %.1130, %bb.u ] ; 2 uses
...
_ZN6icu_7817double_conversionL7isDigitEii.exit.thread: ; preds = %switch.early.test352, %switch.early.test352, %switch.early.test352, %switch.early.test352, %switch.early.test352, %switch.early.test352, %switch.early.test352, %switch.early.test352, %switch.early.test352, %switch.early.test352, %switch.early.test352, %switch.early.test352, %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit201
  ...
  %spec.select328 = and i1 %.0121, %i.cz
  %i.da = trunc nuw i8 %.2131 to i1
  %i.db = add nsw i32 %.2124, 4
  %spec.select149 = select i1 %i.da, i32 %.2124, i32 %i.db
...
_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit188.thread287: ; preds = %switch.early.test352, %_ZN6icu_7817double_conversionL7isDigitEii.exit.thread.i182, %.split289, %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit188
  ...
  %or.cond515 = or i1 %i.dc, %4
  br i1 %or.cond515, label %_ZN6icu_7817double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit211, label %.lr.ph.i206
...
bb.at:                                            ; preds = %bb.as
  %i.gp = sub nsw i64 0, %.5.ph321
  br label %bb.au

bb.au:                                            ; preds = %bb.at, %bb.ar
  %.6 = phi i64 [ %i.gp, %bb.at ], [ %.5.ph321, %bb.ar ]
  %i.gq = sitofp i64 %.6 to double
  br label %_ZN6icu_7817double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175.thread311

bb.av:                                            ; preds = %bb.aq
  %i.gr = icmp ugt i64 %.5.ph321, 9007199254740991
  br i1 %i.gr, label %.lr.ph.i.i, label %._crit_edge.i.i

.lr.ph.i.i:                                       ; preds = %bb.av, %.lr.ph.i.i
  %.01521.i.i = phi i32 [ %i.gt, %.lr.ph.i.i ], [ %.8, %bb.av ]
  %.01620.i.i = phi i64 [ %i.gs, %.lr.ph.i.i ], [ %.5.ph321, %bb.av ] ; 2 uses
...
._crit_edge.i.i:                                  ; preds = %.lr.ph.i.i, %bb.av
  %.016.lcssa.i.i = phi i64 [ %.5.ph321, %bb.av ], [ %i.gs, %.lr.ph.i.i ] ; 3 uses
...
._crit_edge:                                      ; preds = %_ZN6icu_7817double_conversionL17AdvanceToNonspaceIPcEEbPT_S3_.exit, %.preheader208
  %.0116.lcssa = phi i64 [ 0, %.preheader208 ], [ %i.ar, %_ZN6icu_7817double_conversionL17AdvanceToNonspaceIPcEEbPT_S3_.exit ] ; 2 uses
...
bb.f:                                             ; preds = %.lr.ph228, %_ZN6icu_7817double_conversionL17AdvanceToNonspaceIPcEEbPT_S3_.exit
  ...
  %.0116227 = phi i64 [ 0, %.lr.ph228 ], [ %i.ar, %_ZN6icu_7817double_conversionL17AdvanceToNonspaceIPcEEbPT_S3_.exit ]
...
.lr.ph232:                                        ; preds = %.preheader, %.lr.ph232
  %.0135231 = phi i32 [ %i.av, %.lr.ph232 ], [ 1, %.preheader ]
  %.0136230 = phi i32 [ %i.aw, %.lr.ph232 ], [ %i.at, %.preheader ] ; 2 uses
  %i.av = add nuw nsw i32 %.0135231, 1            ; 2 uses
  %i.aw = lshr i32 %.0136230, 1
  %i.ax = icmp samesign ugt i32 %.0136230, 3
  br i1 %i.ax, label %.lr.ph232, label %._crit_edge233, !llvm.loop !58

._crit_edge233:                                   ; preds = %.lr.ph232, %.preheader
  %.0135.lcssa = phi i32 [ 1, %.preheader ], [ %i.av, %.lr.ph232 ] ; 6 uses
  %notmask = shl nsw i32 -1, %.0135.lcssa
  %i.ay = xor i32 %notmask, -1
  %i.az = trunc i64 %i.ar to i32
  %i.ba = and i32 %i.ay, %i.az                    ; 2 uses
  %i.bb = zext nneg i32 %.0135.lcssa to i64
...
_ZN6icu_7817double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread.us: ; preds = %.split.us236, %.split183.us
  ...
  %.2124.us238 = phi i32 [ %i.bl, %.split183.us ], [ %.0135.lcssa, %.split.us236 ] ; 2 uses
...
.split183.us:                                     ; preds = %_ZN6icu_7817double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread.us
  ...
  %spec.select206.us = and i1 %.0121.us239, %i.bk ; 2 uses
  %i.bl = add nuw nsw i32 %.2124.us238, 3         ; 2 uses
...
.split:                                           ; preds = %._crit_edge233, %bb.k
  ...
  %.2124 = phi i32 [ %i.ci, %bb.k ], [ %.0135.lcssa, %._crit_edge233 ] ; 3 uses
...
bb.k:                                             ; preds = %_ZN6icu_7817double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread
  ...
  %spec.select206 = and i1 %.0121, %i.ch
  %i.ci = add nuw nsw i32 %.2124, 3
...
_ZN6icu_7817double_conversionL7isDigitEii.exit:   ; preds = %_ZN6icu_7817double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157, %_ZN6icu_7817double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread, %_ZN6icu_7817double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread.us, %.split183.us, %.split.us236
  ...
  %.us-phi = phi i32 [ %i.bl, %.split183.us ], [ %.0135.lcssa, %.split.us236 ], [ %.2124.us238, %_ZN6icu_7817double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread.us ], [ %.2124, %_ZN6icu_7817double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread ], [ %.2124, %_ZN6icu_7817double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157 ]
  %.us-phi237 = phi i1 [ %spec.select206.us, %.split183.us ], [ true, %.split.us236 ], [ %.0121.us239, %_ZN6icu_7817double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread.us ], [ %.0121, %_ZN6icu_7817double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread ], [ %.0121, %_ZN6icu_7817double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157 ]
