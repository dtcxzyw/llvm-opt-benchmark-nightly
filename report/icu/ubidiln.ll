...
bb.d:                                             ; preds = %.lr.ph.us, %bb.e
  ...
  %indvars.iv67.in = phi i32 [ %.057.us, %.lr.ph.us ], [ %indvars.iv67, %bb.e ]
...
vector.body108:                                   ; preds = %vector.body108, %vector.ph106
  ...
  %wide.load110 = load <4 x i32>, ptr %i.an, align 4, !tbaa !53
  ...
  br i1 %i.aq, label %middle.block112, label %vector.body108, !llvm.loop !88
...
.lr.ph.us:                                        ; preds = %.loopexit, %.lr.ph.lr.ph.us
  %.057.us = phi i32 [ 0, %.lr.ph.lr.ph.us ], [ %i.av, %.loopexit ] ; 2 uses
  %i.ba = sext i32 %.057.us to i64                ; 2 uses
  br label %bb.d
...
bb.d:                                             ; preds = %.lr.ph.us, %bb.e
  %indvars.iv76.in = phi i32 [ %.066.us, %.lr.ph.us ], [ %indvars.iv76, %bb.e ]
...
.lr.ph65.us:                                      ; preds = %.critedge2.us, %.lr.ph65.us
  %indvars.iv84 = phi i64 [ %indvars.iv.next85, %.lr.ph65.us ], [ %indvars.iv74111, %.critedge2.us ] ; 2 uses
  %indvars.iv82 = phi i64 [ %indvars.iv.next83, %.lr.ph65.us ], [ %indvars.iv, %.critedge2.us ] ; 2 uses
  %i.aj = getelementptr inbounds [4 x i8], ptr %2, i64 %indvars.iv82 ; 2 uses
  %i.ak = load i32, ptr %i.aj, align 4, !tbaa !53
  %i.al = getelementptr inbounds [4 x i8], ptr %2, i64 %indvars.iv84 ; 2 uses
  ...
  %i.an = icmp slt i64 %indvars.iv.next83, %indvars.iv.next85
...
.lr.ph.us:                                        ; preds = %._crit_edge.us, %.lr.ph.lr.ph.us
  %.066.us = phi i32 [ 0, %.lr.ph.lr.ph.us ], [ %i.ap, %._crit_edge.us ] ; 2 uses
...
begin_hunk_1_@ubidi_getVisualMap_78:bb.a
    i16 8235, label %bb.aa
    i16 8234, label %bb.aa
  ]

bb.z:                                             ; preds = %switch.early.test.1
  %i.jn = add nsw i32 %.3126, 1
  %i.jo = sext i32 %.3126 to i64
  %i.jp = getelementptr inbounds [4 x i8], ptr %1, i64 %i.jo
  %i.jq = trunc nuw nsw i64 %i.ji to i32
  store i32 %i.jq, ptr %i.jp, align 4, !tbaa !53
  br label %bb.aa

bb.aa:                                            ; preds = %bb.z, %switch.early.test.1, %switch.early.test.1, %switch.early.test.1, %switch.early.test.1, %switch.early.test.1, %switch.early.test.1, %switch.early.test.1, %switch.early.test.1, %switch.early.test.1, %.lr.ph178.split.1
  %.3126.1 = phi i32 [ %.3126, %switch.early.test.1 ], [ %i.jn, %bb.z ], [ %.3126, %.lr.ph178.split.1 ], [ %.3126, %switch.early.test.1 ], [ %.3126, %switch.early.test.1 ], [ %.3126, %switch.early.test.1 ], [ %.3126, %switch.early.test.1 ], [ %.3126, %switch.early.test.1 ], [ %.3126, %switch.early.test.1 ], [ %.3126, %switch.early.test.1 ], [ %.3126, %switch.early.test.1 ] ; 3 uses
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2 ; 2 uses
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %.loopexit162.loopexit347.unr-lcssa, label %.lr.ph178.split, !llvm.loop !135

.loopexit162.loopexit:                            ; preds = %.lr.ph181.prol.loopexit, %.lr.ph181, %middle.block312
  %indvars.iv.next230.lcssa = phi i64 [ %i.gt, %middle.block312 ], [ %indvars.iv.next230.lcssa349.unr, %.lr.ph181.prol.loopexit ], [ %indvars.iv.next230.3, %.lr.ph181 ]
  %i.jr = trunc nsw i64 %indvars.iv.next230.lcssa to i32
  br label %.loopexit162

.loopexit162.loopexit346.unr-lcssa:               ; preds = %bb.x
  %lcmp.mod357.not = icmp eq i64 %xtraiter356, 0
  br i1 %lcmp.mod357.not, label %.loopexit162, label %.lr.ph178.split.us.epil.preheader

.lr.ph178.split.us.epil.preheader:                ; preds = %.loopexit162.loopexit346.unr-lcssa, %.lr.ph178.split.us.preheader
  %indvars.iv223.epil.init = phi i64 [ 0, %.lr.ph178.split.us.preheader ], [ %indvars.iv.next224.1, %.loopexit162.loopexit346.unr-lcssa ]
  %.2125176.us.epil.init = phi i32 [ %.0123184, %.lr.ph178.split.us.preheader ], [ %.3126.us.1, %.loopexit162.loopexit346.unr-lcssa ] ; 12 uses
  %lcmp.mod359 = trunc i32 %i.gg to i1
  tail call void @llvm.assume(i1 %lcmp.mod359)
  %i.js = xor i64 %indvars.iv223.epil.init, -1
  %i.jt = add nsw i64 %i.id, %i.js                ; 2 uses
  %i.ju = getelementptr inbounds [2 x i8], ptr %i.ia, i64 %i.jt
  %i.jv = load i16, ptr %i.ju, align 2, !tbaa !39
  %.fr161.us.epil = freeze i16 %i.jv              ; 2 uses
  %i.jw = and i16 %.fr161.us.epil, -4
  %i.jx = icmp eq i16 %i.jw, 8204
  br i1 %i.jx, label %.loopexit162, label %switch.early.test.us.epil

switch.early.test.us.epil:                        ; preds = %.lr.ph178.split.us.epil.preheader
  switch i16 %.fr161.us.epil, label %bb.ab [
...
bb.ab:                                            ; preds = %switch.early.test.us.epil
  %i.jy = add nsw i32 %.2125176.us.epil.init, 1
  %i.jz = sext i32 %.2125176.us.epil.init to i64
  %i.ka = getelementptr inbounds [4 x i8], ptr %1, i64 %i.jz
  %i.kb = trunc nsw i64 %i.jt to i32
  store i32 %i.kb, ptr %i.ka, align 4, !tbaa !53
  br label %.loopexit162

.loopexit162.loopexit347.unr-lcssa:               ; preds = %bb.aa
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %.loopexit162, label %.lr.ph178.split.epil.preheader

.lr.ph178.split.epil.preheader:                   ; preds = %.loopexit162.loopexit347.unr-lcssa, %.lr.ph178.split.preheader
  %indvars.iv.epil.init = phi i64 [ 0, %.lr.ph178.split.preheader ], [ %indvars.iv.next.1, %.loopexit162.loopexit347.unr-lcssa ]
  %.2125176.epil.init = phi i32 [ %.0123184, %.lr.ph178.split.preheader ], [ %.3126.1, %.loopexit162.loopexit347.unr-lcssa ] ; 12 uses
  %lcmp.mod355 = trunc i32 %i.gg to i1
  tail call void @llvm.assume(i1 %lcmp.mod355)
  %i.kc = add nuw nsw i64 %indvars.iv.epil.init, %i.ib ; 2 uses
  %i.kd = getelementptr inbounds nuw [2 x i8], ptr %i.ia, i64 %i.kc
  %i.ke = load i16, ptr %i.kd, align 2, !tbaa !39
  %.fr161.epil = freeze i16 %i.ke                 ; 2 uses
  %i.kf = and i16 %.fr161.epil, -4
  %i.kg = icmp eq i16 %i.kf, 8204
  br i1 %i.kg, label %.loopexit162, label %switch.early.test.epil

switch.early.test.epil:                           ; preds = %.lr.ph178.split.epil.preheader
  switch i16 %.fr161.epil, label %bb.ac [
    i16 8297, label %.loopexit162
    i16 8296, label %.loopexit162
    i16 8295, label %.loopexit162
    i16 8294, label %.loopexit162
...
bb.ac:                                            ; preds = %switch.early.test.epil
  %i.kh = add nsw i32 %.2125176.epil.init, 1
  %i.ki = sext i32 %.2125176.epil.init to i64
  %i.kj = getelementptr inbounds [4 x i8], ptr %1, i64 %i.ki
  %i.kk = trunc nuw nsw i64 %i.kc to i32
  store i32 %i.kk, ptr %i.kj, align 4, !tbaa !53
  br label %.loopexit162

.loopexit162:                                     ; preds = %.loopexit162.loopexit347.unr-lcssa, %bb.ac, %switch.early.test.epil, %switch.early.test.epil, %switch.early.test.epil, %switch.early.test.epil, %switch.early.test.epil, %switch.early.test.epil, %switch.early.test.epil, %switch.early.test.epil, %switch.early.test.epil, %.lr.ph178.split.epil.preheader, %.loopexit162.loopexit346.unr-lcssa, %bb.ab, %switch.early.test.us.epil, %switch.early.test.us.epil, %switch.early.test.us.epil, %switch.early.test.us.epil, %switch.early.test.us.epil, %switch.early.test.us.epil, %switch.early.test.us.epil, %switch.early.test.us.epil, %switch.early.test.us.epil, %.lr.ph178.split.us.epil.preheader, %bb.s, %.loopexit162.loopexit, %bb.u, %.preheader
  %.4127 = phi i32 [ %.2125176.us.epil.init, %switch.early.test.us.epil ], [ %i.gf, %bb.s ], [ %.0123184, %.preheader ], [ %.0123184, %bb.u ], [ %i.jr, %.loopexit162.loopexit ], [ %.3126.us.1, %.loopexit162.loopexit346.unr-lcssa ], [ %.2125176.us.epil.init, %switch.early.test.us.epil ], [ %i.jy, %bb.ab ], [ %.2125176.us.epil.init, %.lr.ph178.split.us.epil.preheader ], [ %.2125176.us.epil.init, %switch.early.test.us.epil ], [ %.2125176.us.epil.init, %switch.early.test.us.epil ], [ %.2125176.us.epil.init, %switch.early.test.us.epil ], [ %.2125176.us.epil.init, %switch.early.test.us.epil ], [ %.2125176.us.epil.init, %switch.early.test.us.epil ], [ %.2125176.us.epil.init, %switch.early.test.us.epil ], [ %.2125176.us.epil.init, %switch.early.test.us.epil ], [ %.3126.1, %.loopexit162.loopexit347.unr-lcssa ], [ %.2125176.epil.init, %switch.early.test.epil ], [ %i.kh, %bb.ac ], [ %.2125176.epil.init, %.lr.ph178.split.epil.preheader ], [ %.2125176.epil.init, %switch.early.test.epil ], [ %.2125176.epil.init, %switch.early.test.epil ], [ %.2125176.epil.init, %switch.early.test.epil ], [ %.2125176.epil.init, %switch.early.test.epil ], [ %.2125176.epil.init, %switch.early.test.epil ], [ %.2125176.epil.init, %switch.early.test.epil ], [ %.2125176.epil.init, %switch.early.test.epil ], [ %.2125176.epil.init, %switch.early.test.epil ]
