...
bb.a:
  ...
  br i1 %.not, label %.preheader519, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.a = getelementptr inbounds nuw i8, ptr %3, i64 8
  %i.b = load i32, ptr %i.a, align 8, !tbaa !49
  %i.c = icmp sgt i32 %i.b, -1
  br i1 %i.c, label %.preheader519, label %_ZL14parseArgumentsPKDsP13__va_list_tagP10UErrorCode.exit.thread

.preheader519:                                    ; preds = %bb.b, %bb.a
  br label %bb.c

bb.c:                                             ; preds = %.preheader519, %bb.h
  %.0169.i = phi ptr [ %.2171.lcssa.i, %bb.h ], [ %1, %.preheader519 ]
  %.0166.i = phi i32 [ %spec.select.i, %bb.h ], [ 0, %.preheader519 ] ; 3 uses
  %.0.i = phi i32 [ %.1.lcssa.i, %bb.h ], [ 0, %.preheader519 ]
  br label %bb.d

bb.d:                                             ; preds = %bb.e, %bb.c
  %.1170.i = phi ptr [ %.0169.i, %bb.c ], [ %i.e, %bb.e ] ; 4 uses
  %i.d = load i16, ptr %.1170.i, align 2, !tbaa !12
...
bb.e:                                             ; preds = %bb.d
  ...
  br label %bb.d, !llvm.loop !31

bb.f:                                             ; preds = %bb.d
  %i.f = getelementptr inbounds nuw i8, ptr %.1170.i, i64 2
  %i.g = load i16, ptr %i.f, align 2, !tbaa !12   ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.k = load i16, ptr %i.h, align 2, !tbaa !12   ; 3 uses
...
.critedge2.i:                                     ; preds = %bb.g, %.critedge2.i
  ...
  %i.r = load i16, ptr %i.n, align 2, !tbaa !12   ; 3 uses
  %.off203.i = add i16 %i.r, -48
  %switch204.i = icmp ult i16 %.off203.i, 10
  br i1 %switch204.i, label %.critedge2.i, label %._crit_edge.i, !llvm.loop !32
...
bb.p:                                             ; preds = %bb.q, %.preheader209.i
  ...
  %i.ac = load i16, ptr %.5174.i, align 2, !tbaa !12
...
bb.r:                                             ; preds = %bb.p
  ...
  %i.aj = load i16, ptr %i.ai, align 2, !tbaa !12 ; 3 uses
...
bb.s:                                             ; preds = %bb.r
  ...
  %i.an = load i16, ptr %i.ak, align 2, !tbaa !12 ; 3 uses
...
.critedge9.i:                                     ; preds = %bb.s, %.critedge9.i
  ...
  %i.au = load i16, ptr %i.aq, align 2, !tbaa !12 ; 3 uses
  %.off207.i = add i16 %i.au, -48
  %switch208.i = icmp ult i16 %.off207.i, 10
  br i1 %switch208.i, label %.critedge9.i, label %.loopexit.i, !llvm.loop !35
...
begin_hunk_1_@u_printf_parse_78:bb.a
  %i.bc = load i16, ptr %i.bb, align 2, !tbaa !12
  %i.bd = icmp eq i16 %i.bc, 108
  br i1 %i.bd, label %bb.v, label %bb.w

bb.v:                                             ; preds = %bb.u
  store i8 1, ptr %i.ay, align 1, !tbaa !13
  br label %bb.w
...
bb.w:                                             ; preds = %bb.v, %bb.u, %.critedge11.i
  ...
  %.pre.i = load i16, ptr %i.be, align 2, !tbaa !12
  br label %bb.t, !llvm.loop !36
...
bb.y:                                             ; preds = %bb.x
  ...
  %i.bj = load i32, ptr %i.bi, align 16, !tbaa !53
  br label %bb.z

bb.z:                                             ; preds = %bb.y, %bb.x
  %.sink.i = phi i32 [ %i.bj, %bb.y ], [ 0, %bb.x ]
  %i.bk = getelementptr inbounds [4 x i8], ptr %i.v, i64 %i.ax
  store i32 %.sink.i, ptr %i.bk, align 4, !tbaa !54
  br label %.preheader209.i, !llvm.loop !37
...
bb.ae:                                            ; preds = %bb.ad, %bb.ac
  ...
  store ptr %i.bw, ptr %i.bx, align 8, !tbaa !13
  br label %bb.ax
...
bb.aj:                                            ; preds = %bb.ai, %bb.ah
  ...
  %i.cj = load i64, ptr %i.ci, align 8, !tbaa !57
  %i.ck = getelementptr inbounds nuw [8 x i8], ptr %i.y, i64 %indvars.iv.i
  store i64 %i.cj, ptr %i.ck, align 8, !tbaa !13
  br label %bb.ax
...
bb.an:                                            ; preds = %bb.am, %bb.al
  ...
  store i64 %i.ct, ptr %i.cu, align 8, !tbaa !13
  br label %bb.ax
...
bb.ar:                                            ; preds = %bb.aq, %bb.ap
  ...
  store float %i.df, ptr %i.dg, align 8, !tbaa !13
  br label %bb.ax
...
bb.ay:                                            ; preds = %bb.ee, %_ZL14parseArgumentsPKDsP13__va_list_tagP10UErrorCode.exit.thread
  %.0279 = phi ptr [ %1, %_ZL14parseArgumentsPKDsP13__va_list_tagP10UErrorCode.exit.thread ], [ %i.is, %bb.ee ] ; 7 uses
  br i1 %.not, label %.critedge.preheader, label %bb.az

bb.az:                                            ; preds = %bb.ay
  %i.eo = load i32, ptr %i.dt, align 8, !tbaa !49
  %i.ep = icmp sgt i32 %i.eo, -1
  br i1 %i.ep, label %.critedge.preheader, label %bb.ef
...
.critedge:                                        ; preds = %.critedge.preheader, %bb.ba
  ...
  %i.eq = load i16, ptr %.1, align 2, !tbaa !12   ; 2 uses
...
bb.bb:                                            ; preds = %.critedge2
  %i.et = load ptr, ptr %0, align 8, !tbaa !16
  ...
  %i.fa = load i32, ptr %5, align 4, !tbaa !14
  %i.fb = add nsw i32 %i.fa, %i.ez
  store i32 %i.fb, ptr %5, align 4, !tbaa !14
  %.pre = load i16, ptr %.1, align 2, !tbaa !12
  br label %bb.bc

bb.bc:                                            ; preds = %bb.bb, %.critedge2
  %i.fc = phi i16 [ %.pre, %bb.bb ], [ %i.eq, %.critedge2 ]
  %i.fd = icmp eq i16 %i.fc, 0
  br i1 %i.fd, label %bb.ef, label %bb.bd

bb.bd:                                            ; preds = %bb.bc
  store i32 -1, ptr %i.du, align 4, !tbaa !61
  store i32 -1, ptr %i.dv, align 4, !tbaa !62
  store i32 -1, ptr %i.dw, align 4, !tbaa !63
  ...
  store i32 -1, ptr %i.dx, align 4, !tbaa !19
  store i16 32, ptr %i.dy, align 4, !tbaa !64
  %i.fe = getelementptr inbounds nuw i8, ptr %.1, i64 2 ; 3 uses
  %i.ff = load i16, ptr %i.fe, align 2, !tbaa !12 ; 2 uses
  %.off = add i16 %i.ff, -48
...
bb.be:                                            ; preds = %bb.bd
  ...
  %i.fj = load i16, ptr %i.fg, align 2, !tbaa !12 ; 3 uses
  %.off321362 = add i16 %i.fj, -48
  %switch322363 = icmp ult i16 %.off321362, 10
  br i1 %switch322363, label %.critedge4, label %bb.bf
...
.critedge4:                                       ; preds = %bb.be, %.critedge4
  ...
  %i.fq = load i16, ptr %i.fm, align 2, !tbaa !12 ; 3 uses
  %.off321 = add i16 %i.fq, -48
  %switch322 = icmp ult i16 %.off321, 10
  br i1 %switch322, label %.critedge4, label %bb.bf, !llvm.loop !40

bb.bf:                                            ; preds = %.critedge4, %bb.be
  ...
  store i32 %storemerge.lcssa, ptr %i.dw, align 4, !tbaa !63
  %.not309 = icmp eq i16 %i.fr, 36
  br i1 %.not309, label %bb.bh, label %bb.bg
...
.preheader:                                       ; preds = %bb.bd, %bb.bg, %bb.bh
  %.5.ph = phi ptr [ %i.fs, %bb.bh ], [ %i.fe, %bb.bg ], [ %i.fe, %bb.bd ]
  br label %bb.bi

bb.bi:                                            ; preds = %.backedge, %.preheader
  %.5 = phi ptr [ %.5.ph, %.preheader ], [ %.5.be, %.backedge ] ; 10 uses
  %i.ft = load i16, ptr %.5, align 2, !tbaa !12   ; 4 uses
  switch i16 %i.ft, label %.loopexit341 [
...
.critedge6:                                       ; preds = %bb.bi, %bb.bi, %bb.bi, %bb.bi, %bb.bi, %bb.bi
...
bb.bj:                                            ; preds = %.critedge6
  store i8 1, ptr %i.ed, align 4, !tbaa !65
  br label %.backedge

bb.bk:                                            ; preds = %.critedge6
  store i8 1, ptr %i.eb, align 1, !tbaa !20
  br label %.backedge

bb.bl:                                            ; preds = %.critedge6
  store i8 1, ptr %i.eb, align 1, !tbaa !20
  store i8 1, ptr %i.ec, align 1, !tbaa !21
  br label %.backedge

bb.bm:                                            ; preds = %.critedge6
  store i8 1, ptr %i.ea, align 2, !tbaa !22
  br label %.backedge

bb.bn:                                            ; preds = %.critedge6
  store i8 1, ptr %i.dz, align 2, !tbaa !23
  store i16 48, ptr %i.dy, align 4, !tbaa !64
  br label %.backedge

bb.bo:                                            ; preds = %.critedge6
  %i.fv = getelementptr inbounds nuw i8, ptr %.5, i64 4
  %i.fw = load i16, ptr %i.fu, align 2, !tbaa !12
  %i.fx = call noundef i32 @_Z18ufmt_digitvalue_78Ds(i16 noundef zeroext %i.fw) ; 2 uses
  %i.fy = trunc i32 %i.fx to i16
  store i16 %i.fy, ptr %i.dy, align 4, !tbaa !64
  %i.fz = shl i32 %i.fx, 4
  %i.ga = getelementptr inbounds nuw i8, ptr %.5, i64 6
  %i.gb = load i16, ptr %i.fv, align 2, !tbaa !12
  ...
  store i16 %i.ge, ptr %i.dy, align 4, !tbaa !64
  %i.gf = shl i32 %i.gd, 4
  %i.gg = getelementptr inbounds nuw i8, ptr %.5, i64 8
  %i.gh = load i16, ptr %i.ga, align 2, !tbaa !12
  ...
  store i16 %i.gk, ptr %i.dy, align 4, !tbaa !64
  %i.gl = shl i32 %i.gj, 4
  %i.gm = load i16, ptr %i.gg, align 2, !tbaa !12
  %i.gn = call noundef i32 @_Z18ufmt_digitvalue_78Ds(i16 noundef zeroext %i.gm)
  %i.go = add i32 %i.gn, %i.gl
  %i.gp = trunc i32 %i.go to i16
  store i16 %i.gp, ptr %i.dy, align 4, !tbaa !64
  %i.gq = getelementptr inbounds nuw i8, ptr %.5, i64 12
  br label %.backedge

.backedge:                                        ; preds = %bb.bo, %bb.bn, %bb.bm, %bb.bl, %bb.bk, %bb.bj, %.critedge6
  %.5.be = phi ptr [ %i.fu, %bb.bm ], [ %i.fu, %bb.bn ], [ %i.gq, %bb.bo ], [ %i.fu, %.critedge6 ], [ %i.fu, %bb.bj ], [ %i.fu, %bb.bk ], [ %i.fu, %bb.bl ]
  br label %bb.bi, !llvm.loop !41

bb.bp:                                            ; preds = %bb.bi
  store i32 -2, ptr %i.dx, align 4, !tbaa !19
  %i.gr = getelementptr inbounds nuw i8, ptr %.5, i64 2 ; 3 uses
  %i.gs = load i16, ptr %i.gr, align 2, !tbaa !12 ; 3 uses
  %.off323 = add i16 %i.gs, -48
  %switch324 = icmp ult i16 %.off323, 10
  br i1 %switch324, label %bb.bq, label %.loopexit340

bb.bq:                                            ; preds = %bb.bp
  %i.gt = getelementptr inbounds nuw i8, ptr %.5, i64 4 ; 3 uses
  %i.gu = zext nneg i16 %i.gs to i32
  %i.gv = add nsw i32 %i.gu, -48                  ; 2 uses
  %i.gw = load i16, ptr %i.gt, align 2, !tbaa !12 ; 3 uses
  %.off325375 = add i16 %i.gw, -48
  %switch326376 = icmp ult i16 %.off325375, 10
  br i1 %switch326376, label %.critedge8, label %..loopexit340_crit_edge

.critedge8:                                       ; preds = %bb.bq, %.critedge8
  %i.gx = phi i16 [ %i.hd, %.critedge8 ], [ %i.gw, %bb.bq ]
  %.7378 = phi ptr [ %i.gz, %.critedge8 ], [ %i.gt, %bb.bq ]
  %storemerge311377 = phi i32 [ %i.hc, %.critedge8 ], [ %i.gv, %bb.bq ]
  ...
  %i.hd = load i16, ptr %i.gz, align 2, !tbaa !12 ; 3 uses
  %.off325 = add i16 %i.hd, -48
  %switch326 = icmp ult i16 %.off325, 10
  br i1 %switch326, label %.critedge8, label %..loopexit340_crit_edge, !llvm.loop !42

..loopexit340_crit_edge:                          ; preds = %.critedge8, %bb.bq
  %storemerge311.lcssa = phi i32 [ %i.gv, %bb.bq ], [ %i.hc, %.critedge8 ]
  %.7.lcssa = phi ptr [ %i.gt, %bb.bq ], [ %i.gz, %.critedge8 ]
  %.lcssa348 = phi i16 [ %i.gw, %bb.bq ], [ %i.hd, %.critedge8 ]
  store i32 %storemerge311.lcssa, ptr %i.du, align 4, !tbaa !61
  br label %.loopexit340

.loopexit340:                                     ; preds = %..loopexit340_crit_edge, %bb.bp
  %9 = phi i16 [ %i.gs, %bb.bp ], [ %.lcssa348, %..loopexit340_crit_edge ]
  %.8 = phi ptr [ %i.gr, %bb.bp ], [ %.7.lcssa, %..loopexit340_crit_edge ]
...
.critedge10:                                      ; preds = %bb.bt, %.critedge10
  ...
  %i.hn = load i16, ptr %.9, align 2, !tbaa !12   ; 3 uses
  %.off327 = add i16 %i.hn, -48
  %switch328 = icmp ult i16 %.off327, 10
  br i1 %switch328, label %.critedge10, label %..loopexit341_crit_edge, !llvm.loop !43
...
..loopexit341_crit_edge:                          ; preds = %.critedge10, %bb.bt
  ...
  store i32 %storemerge310.lcssa, ptr %i.dx, align 4, !tbaa !19
  br label %.loopexit341

.loopexit341:                                     ; preds = %bb.bi, %..loopexit341_crit_edge, %thread-pre-split
  %10 = phi i16 [ %.pr, %thread-pre-split ], [ %.lcssa347, %..loopexit341_crit_edge ], [ %i.ft, %bb.bi ]
  %.10 = phi ptr [ %.10.ph, %thread-pre-split ], [ %.9.lcssa, %..loopexit341_crit_edge ], [ %.5, %bb.bi ] ; 5 uses
  %i.ho = icmp eq i16 %10, 46
  br i1 %i.ho, label %bb.bu, label %thread-pre-split337

bb.bu:                                            ; preds = %.loopexit341
  %i.hp = getelementptr inbounds nuw i8, ptr %.10, i64 2 ; 2 uses
  %i.hq = load i16, ptr %i.hp, align 2, !tbaa !12 ; 3 uses
  switch i16 %i.hq, label %.loopexit [
    i16 42, label %bb.bv
    i16 48, label %bb.ca
    i16 49, label %bb.ca
    i16 50, label %bb.ca
...
bb.bv:                                            ; preds = %bb.bu
  ...
  %i.hs = load i16, ptr %i.hr, align 2, !tbaa !12 ; 3 uses
  %.off329 = add i16 %i.hs, -48
  %switch330 = icmp ult i16 %.off329, 10
  br i1 %switch330, label %bb.bw, label %.loopexit
...
bb.bx:                                            ; preds = %.critedge12, %bb.bw
  ...
  %i.hw = load i16, ptr %.11, align 2, !tbaa !12  ; 2 uses
...
bb.bz:                                            ; preds = %bb.bx
  store i32 %storemerge314, ptr %i.dv, align 4, !tbaa !62
...
bb.ca:                                            ; preds = %bb.bu, %bb.bu, %bb.bu, %bb.bu, %bb.bu, %bb.bu, %bb.bu, %bb.bu, %bb.bu, %bb.bu
  ...
  %i.ig = load i16, ptr %i.id, align 2, !tbaa !12 ; 3 uses
  %.off331382 = add i16 %i.ig, -48
  %switch332383 = icmp ult i16 %.off331382, 10
  br i1 %switch332383, label %.critedge14, label %..loopexit_crit_edge
...
.critedge14:                                      ; preds = %bb.ca, %.critedge14
  ...
  %i.in = load i16, ptr %i.ij, align 2, !tbaa !12 ; 3 uses
  %.off331 = add i16 %i.in, -48
  %switch332 = icmp ult i16 %.off331, 10
  br i1 %switch332, label %.critedge14, label %..loopexit_crit_edge, !llvm.loop !45

thread-pre-split337:                              ; preds = %.loopexit341, %bb.bz, %bb.by
  %.13.ph = phi ptr [ %.10, %.loopexit341 ], [ %i.ic, %bb.bz ], [ %i.hr, %bb.by ] ; 2 uses
  %.pr338 = load i16, ptr %.13.ph, align 2, !tbaa !12
  br label %.loopexit

..loopexit_crit_edge:                             ; preds = %.critedge14, %bb.ca
  ...
  store i32 %storemerge313.lcssa, ptr %8, align 4, !tbaa !18
  br label %.loopexit

.loopexit:                                        ; preds = %..loopexit_crit_edge, %thread-pre-split337, %bb.bv, %bb.bu
  %11 = phi i16 [ %.pr338, %thread-pre-split337 ], [ %i.hq, %bb.bu ], [ %i.hs, %bb.bv ], [ %.lcssa349, %..loopexit_crit_edge ] ; 2 uses
  %.13 = phi ptr [ %.13.ph, %thread-pre-split337 ], [ %i.hp, %bb.bu ], [ %i.hr, %bb.bv ], [ %.12.lcssa, %..loopexit_crit_edge ] ; 3 uses
  switch i16 %11, label %bb.ch [
    i16 104, label %bb.cb
    i16 108, label %bb.cb
    i16 76, label %bb.cb
  ]

bb.cb:                                            ; preds = %.loopexit, %.loopexit, %.loopexit
...
bb.cc:                                            ; preds = %bb.cb
  store i8 1, ptr %i.eh, align 4, !tbaa !24
  br label %bb.ch

bb.cd:                                            ; preds = %bb.cb
  %i.ip = load i16, ptr %i.io, align 2, !tbaa !12
  %i.iq = icmp eq i16 %i.ip, 108
  br i1 %i.iq, label %bb.ce, label %bb.cf

bb.ce:                                            ; preds = %bb.cd
  store i8 1, ptr %i.eg, align 2, !tbaa !25
...
bb.cg:                                            ; preds = %bb.cb
  store i8 1, ptr %i.ee, align 1, !tbaa !67
  br label %bb.ch

bb.ch:                                            ; preds = %.loopexit, %bb.cb, %bb.cc, %bb.cg, %bb.cf, %bb.ce
  %.14 = phi ptr [ %i.io, %bb.cb ], [ %i.io, %bb.cc ], [ %i.ir, %bb.ce ], [ %i.io, %bb.cf ], [ %i.io, %bb.cg ], [ %.13, %.loopexit ] ; 2 uses
  %i.is = getelementptr inbounds nuw i8, ptr %.14, i64 2 ; 3 uses
  %i.it = load i16, ptr %.14, align 2, !tbaa !12  ; 3 uses
  store i16 %i.it, ptr %i.ei, align 2, !tbaa !26
  store i16 %i.it, ptr %i.ej, align 4, !tbaa !27
  %i.iu = load i32, ptr %i.dx, align 4, !tbaa !19
  %i.iv = icmp eq i32 %i.iu, -2
  br i1 %i.iv, label %bb.ci, label %bb.cn

bb.ci:                                            ; preds = %bb.ch
  %i.iw = load i32, ptr %i.du, align 4, !tbaa !61
  %i.ix = icmp eq i32 %i.iw, -1
  br i1 %i.ix, label %bb.cj, label %.thread

bb.cj:                                            ; preds = %bb.ci
  %i.iy = load i32, ptr %6, align 8               ; 3 uses
  %i.iz = icmp ult i32 %i.iy, 41
  br i1 %i.iz, label %bb.ck, label %bb.cl
...
bb.cm:                                            ; preds = %bb.ck, %bb.cl
  %i.jg = phi ptr [ %i.jc, %bb.ck ], [ %i.je, %bb.cl ]
  %i.jh = load i32, ptr %i.jg, align 4, !tbaa !14 ; 3 uses
  store i32 %i.jh, ptr %i.dx, align 4, !tbaa !19
  %i.ji = icmp slt i32 %i.jh, 0
  br i1 %i.ji, label %.thread, label %bb.cn

.thread:                                          ; preds = %bb.ci, %bb.cm
  %i.jj = phi i32 [ %i.jh, %bb.cm ], [ -2, %bb.ci ]
  %i.jk = sub nsw i32 0, %i.jj
  store i32 %i.jk, ptr %i.dx, align 4, !tbaa !19
  store i8 1, ptr %i.ed, align 4, !tbaa !65
  br label %bb.cn

bb.cn:                                            ; preds = %bb.cm, %.thread, %bb.ch
  %i.jl = load i32, ptr %8, align 4, !tbaa !18
  %i.jm = icmp eq i32 %i.jl, -2
  br i1 %i.jm, label %bb.co, label %bb.ct

bb.co:                                            ; preds = %bb.cn
  %i.jn = load i32, ptr %i.dv, align 4, !tbaa !62
  %i.jo = icmp eq i32 %i.jn, -1
  br i1 %i.jo, label %bb.cp, label %.thread339

bb.cp:                                            ; preds = %bb.co
  %i.jp = load i32, ptr %6, align 8               ; 3 uses
  %i.jq = icmp ult i32 %i.jp, 41
  br i1 %i.jq, label %bb.cq, label %bb.cr
...
bb.cs:                                            ; preds = %bb.cq, %bb.cr
  %i.jx = phi ptr [ %i.jt, %bb.cq ], [ %i.jv, %bb.cr ]
  %i.jy = load i32, ptr %i.jx, align 4, !tbaa !14 ; 2 uses
  store i32 %i.jy, ptr %8, align 4, !tbaa !18
  %i.jz = icmp slt i32 %i.jy, 0
  br i1 %i.jz, label %.thread339, label %bb.ct

.thread339:                                       ; preds = %bb.co, %bb.cs
  store i32 0, ptr %8, align 4, !tbaa !18
  br label %bb.ct

bb.ct:                                            ; preds = %bb.cs, %.thread339, %bb.cn
  %i.ka = add i16 %i.it, -32                      ; 2 uses
  %i.kb = icmp ult i16 %i.ka, 108
  br i1 %i.kb, label %bb.cu, label %bb.ed

bb.cu:                                            ; preds = %bb.ct
  %i.kc = zext nneg i16 %i.ka to i64
  %i.kd = getelementptr inbounds nuw [16 x i8], ptr @_ZL16g_u_printf_infos, i64 %i.kc ; 2 uses
  %i.ke = load i32, ptr %i.kd, align 16, !tbaa !53 ; 2 uses
  %i.kf = load i32, ptr %i.dw, align 4, !tbaa !63 ; 2 uses
  %i.kg = icmp sgt i32 %i.kf, 0
  br i1 %i.kg, label %bb.cv, label %bb.dc

bb.cv:                                            ; preds = %bb.cu
  %i.kh = add nsw i32 %i.kf, -1                   ; 5 uses
  store i32 %i.kh, ptr %i.dw, align 4, !tbaa !63
  switch i32 %i.ke, label %bb.db [
    i32 2, label %bb.cw
    i32 5, label %bb.cx
    i32 10, label %bb.cx
    i32 6, label %bb.cx
...
bb.cw:                                            ; preds = %bb.cv
  %i.ki = load i32, ptr %5, align 4, !tbaa !14
  store i32 %i.ki, ptr %i.dx, align 4, !tbaa !19
  br label %bb.cx

bb.cx:                                            ; preds = %bb.cw, %bb.cv, %bb.cv, %bb.cv
  %i.kj = zext nneg i32 %i.kh to i64
  %i.kk = getelementptr inbounds nuw [8 x i8], ptr %.0, i64 %i.kj
  %i.kl = load ptr, ptr %i.kk, align 8, !tbaa !13
  store ptr %i.kl, ptr %7, align 8, !tbaa !13
  br label %bb.ea

bb.cy:                                            ; preds = %bb.cv, %bb.cv, %bb.cv
  %i.km = zext nneg i32 %i.kh to i64
  %i.kn = getelementptr inbounds nuw [8 x i8], ptr %.0, i64 %i.km
  %i.ko = load i64, ptr %i.kn, align 8, !tbaa !13
  store i64 %i.ko, ptr %7, align 8, !tbaa !13
  br label %bb.ea

bb.cz:                                            ; preds = %bb.cv
  %i.kp = zext nneg i32 %i.kh to i64
  %i.kq = getelementptr inbounds nuw [8 x i8], ptr %.0, i64 %i.kp
  %i.kr = load float, ptr %i.kq, align 8, !tbaa !13
  store float %i.kr, ptr %7, align 8, !tbaa !13
  br label %bb.ea

bb.da:                                            ; preds = %bb.cv
  %i.ks = zext nneg i32 %i.kh to i64
  %i.kt = getelementptr inbounds nuw [8 x i8], ptr %.0, i64 %i.ks
  %i.ku = load double, ptr %i.kt, align 8, !tbaa !13
  store double %i.ku, ptr %7, align 8, !tbaa !13
  br label %bb.ea
