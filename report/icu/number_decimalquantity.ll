...
.lr.ph40:                                         ; preds = %.preheader, %.lr.ph40
  %.039 = phi double [ %i.ai, %.lr.ph40 ], [ %1, %.preheader ]
  %.02938 = phi i32 [ %i.aj, %.lr.ph40 ], [ %i.ae, %.preheader ] ; 2 uses
  %i.ai = fmul double %.039, 1.000000e+22         ; 2 uses
  %i.aj = add nsw i32 %.02938, -22                ; 2 uses
  %i.ak = icmp samesign ugt i32 %.02938, 43
  br i1 %i.ak, label %.lr.ph40, label %._crit_edge41, !llvm.loop !70

._crit_edge41:                                    ; preds = %.lr.ph40, %.preheader
  %.029.lcssa = phi i32 [ %i.ae, %.preheader ], [ %i.aj, %.lr.ph40 ]
  %.0.lcssa = phi double [ %1, %.preheader ], [ %i.ai, %.lr.ph40 ]
  %i.al = zext nneg i32 %.029.lcssa to i64
  ...
  %i.ao = fmul double %.0.lcssa, %i.an
  br label %bb.h

.lr.ph:                                           ; preds = %.preheader34, %.lr.ph
  %.136 = phi double [ %i.ap, %.lr.ph ], [ %1, %.preheader34 ]
  %.02835 = phi i32 [ %i.aq, %.lr.ph ], [ %i.ae, %.preheader34 ] ; 2 uses
  %i.ap = fdiv double %.136, 1.000000e+22         ; 2 uses
  %i.aq = add nsw i32 %.02835, 22                 ; 2 uses
  %i.ar = icmp samesign ult i32 %.02835, -43
  br i1 %i.ar, label %.lr.ph, label %._crit_edge, !llvm.loop !72

._crit_edge:                                      ; preds = %.lr.ph, %.preheader34
  %.028.lcssa = phi i32 [ %i.ae, %.preheader34 ], [ %i.aq, %.lr.ph ]
  %.1.lcssa = phi double [ %1, %.preheader34 ], [ %i.ap, %.lr.ph ]
  %i.as = sub nsw i32 0, %.028.lcssa
