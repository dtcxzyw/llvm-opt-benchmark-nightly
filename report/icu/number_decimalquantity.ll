...
bb.x:                                             ; preds = %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit242.thread.us, %.lr.ph354.split.us
  %.0172352.us = phi i32 [ %spec.select.i236, %.lr.ph354.split.us ], [ %i.ca, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit242.thread.us ] ; 5 uses
  %i.bv = icmp sgt i32 %.0172352.us, -1
  %.not.i240.us = icmp slt i32 %.0172352.us, %i.bu
...
_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit242.us: ; preds = %bb.x
  ...
  %i.bx = zext nneg i32 %.0172352.us to i64
...
_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit242.thread.us: ; preds = %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit242.us, %bb.x
  %i.ca = add nsw i32 %.0172352.us, -1
  %.not197.us.not = icmp sgt i32 %.0172352.us, %i.bq
...
.lr.ph354.split:                                  ; preds = %.lr.ph354, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit242.thread
  %.0172352 = phi i32 [ %i.cg, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit242.thread ], [ %spec.select.i236, %.lr.ph354 ] ; 4 uses
  %or.cond.i238 = icmp ugt i32 %.0172352, 15
...
_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit242: ; preds = %.lr.ph354.split
  ...
  %i.cc = shl nuw nsw i32 %.0172352, 2
...
_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit242.thread: ; preds = %.lr.ph354.split, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit242
  %i.cg = add nsw i32 %.0172352, -1
  %.not197.not = icmp sgt i32 %.0172352, %i.bq
...
bb.aa:                                            ; preds = %bb.ab, %.lr.ph334.split.us
  %.1333.us = phi i32 [ %spec.select.i236, %.lr.ph334.split.us ], [ %i.cm, %bb.ab ] ; 4 uses
  %i.cl = icmp sgt i32 %.1333.us, -1
  %or.cond10.i246.us = select i1 %i.cl, i1 %.not.i245.us, i1 false
  br i1 %or.cond10.i246.us, label %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit247.us, label %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit247.thread

bb.ab:                                            ; preds = %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit247.us
  %i.cm = add nsw i32 %.1333.us, -1
  %.not195.us.not = icmp sgt i32 %.1333.us, %i.bq
...
_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit247.us: ; preds = %bb.aa
  ...
  %i.co = zext nneg i32 %.1333.us to i64
...
bb.ac:                                            ; preds = %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit247
  %i.cr = add nsw i32 %.1333, -1
  %.not195.not = icmp sgt i32 %.1333, %i.bq
...
.lr.ph334.split:                                  ; preds = %.lr.ph334, %bb.ac
  %.1333 = phi i32 [ %i.cr, %bb.ac ], [ %spec.select.i236, %.lr.ph334 ] ; 4 uses
  %or.cond.i243 = icmp ugt i32 %.1333, 15
...
bb.af:                                            ; preds = %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit252.thread.us, %.lr.ph323.split.us
  %.2321.us = phi i32 [ %spec.select.i236, %.lr.ph323.split.us ], [ %i.dg, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit252.thread.us ] ; 5 uses
  %i.db = icmp sgt i32 %.2321.us, -1
  %.not.i250.us = icmp slt i32 %.2321.us, %i.da
...
_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit252.us: ; preds = %bb.af
  ...
  %i.dd = zext nneg i32 %.2321.us to i64
...
_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit252.thread.us: ; preds = %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit252.us, %bb.af
  %i.dg = add nsw i32 %.2321.us, -1
  %.not193.us.not = icmp sgt i32 %.2321.us, %i.bq
...
.lr.ph323.split:                                  ; preds = %.lr.ph323, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit252.thread
  %.2321 = phi i32 [ %i.dm, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit252.thread ], [ %spec.select.i236, %.lr.ph323 ] ; 4 uses
  %or.cond.i248 = icmp ugt i32 %.2321, 15
...
_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit252.thread: ; preds = %.lr.ph323.split, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit252
  %i.dm = add nsw i32 %.2321, -1
  %.not193.not = icmp sgt i32 %.2321, %i.bq
...
bb.ai:                                            ; preds = %bb.aj, %.lr.ph.split.us
  %.3312.us = phi i32 [ %spec.select.i236, %.lr.ph.split.us ], [ %i.ds, %bb.aj ] ; 4 uses
  %i.dr = icmp sgt i32 %.3312.us, -1
  %or.cond10.i256.us = select i1 %i.dr, i1 %.not.i255.us, i1 false
  br i1 %or.cond10.i256.us, label %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit257.us, label %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit247.thread

bb.aj:                                            ; preds = %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit257.us
  %i.ds = add nsw i32 %.3312.us, -1
  %.not191.us.not = icmp sgt i32 %.3312.us, %i.bq
...
_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit257.us: ; preds = %bb.ai
  ...
  %i.du = zext nneg i32 %.3312.us to i64
...
bb.ak:                                            ; preds = %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit257
  %i.dx = add nsw i32 %.3312, -1
  %.not191.not = icmp sgt i32 %.3312, %i.bq
...
.lr.ph.split:                                     ; preds = %.lr.ph, %bb.ak
  %.3312 = phi i32 [ %i.dx, %bb.ak ], [ %spec.select.i236, %.lr.ph ] ; 4 uses
  %or.cond.i253 = icmp ugt i32 %.3312, 15
...
_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit247.thread: ; preds = %bb.ak, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit257, %.lr.ph.split, %bb.aj, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit257.us, %bb.ai, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit252.thread, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit252, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit252.thread.us, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit252.us, %bb.ac, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit247, %.lr.ph334.split, %bb.ab, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit247.us, %bb.aa, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit242.thread, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit242, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit242.thread.us, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit242.us, %bb.ah, %bb.ae, %bb.z, %bb.w, %bb.ap, %bb.ao, %bb.an, %bb.am
  %5 = phi i1 [ false, %bb.ap ], [ false, %bb.am ], [ false, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit252 ], [ false, %bb.an ], [ false, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit252.us ], [ false, %bb.ao ], [ false, %bb.w ], [ false, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit242.thread ], [ false, %.lr.ph334.split ], [ false, %bb.ah ], [ false, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit242.thread.us ], [ true, %bb.ae ], [ false, %bb.aa ], [ false, %bb.aj ], [ true, %bb.z ], [ false, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit242.us ], [ false, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit242 ], [ true, %bb.ab ], [ false, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit247.us ], [ false, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit247 ], [ true, %bb.ac ], [ true, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit252.thread.us ], [ true, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit252.thread ], [ false, %bb.ai ], [ false, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit257.us ], [ false, %.lr.ph.split ], [ false, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit257 ], [ false, %bb.ak ]
  %.not199 = phi i1 [ true, %bb.ap ], [ true, %bb.am ], [ true, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit252.thread ], [ true, %bb.an ], [ true, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit252.thread.us ], [ true, %bb.ao ], [ false, %bb.w ], [ false, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit242.thread ], [ true, %bb.ac ], [ false, %bb.ah ], [ false, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit242.thread.us ], [ true, %bb.ae ], [ true, %bb.ab ], [ true, %bb.ai ], [ true, %bb.z ], [ true, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit242.us ], [ true, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit242 ], [ true, %bb.aa ], [ true, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit247.us ], [ true, %.lr.ph334.split ], [ true, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit247 ], [ true, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit252.us ], [ true, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit252 ], [ true, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit257.us ], [ false, %bb.aj ], [ false, %bb.ak ], [ true, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit257 ], [ true, %.lr.ph.split ]
  %spec.store.select68 = phi i32 [ %.209, %bb.ap ], [ 1, %bb.am ], [ 3, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit252 ], [ 3, %bb.an ], [ 3, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit252.us ], [ %.208, %bb.ao ], [ 1, %bb.w ], [ 1, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit242.thread ], [ 1, %.lr.ph334.split ], [ 3, %bb.ah ], [ 1, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit242.thread.us ], [ 2, %bb.ae ], [ 1, %bb.aa ], [ 3, %bb.aj ], [ 2, %bb.z ], [ 1, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit242.us ], [ 1, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit242 ], [ 2, %bb.ab ], [ 1, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit247.us ], [ 1, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit247 ], [ 2, %bb.ac ], [ 2, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit252.thread.us ], [ 2, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit252.thread ], [ 3, %bb.ai ], [ 3, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit257.us ], [ 3, %.lr.ph.split ], [ 3, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit257 ], [ 3, %bb.ak ] ; 2 uses
...
.thread:                                          ; preds = %switch.early.test211, %bb.q, %.loopexit
  %.3180285 = phi i32 [ %.3180, %.loopexit ], [ %., %bb.q ], [ %spec.store.select68, %switch.early.test211 ] ; 4 uses
...
.thread.thread:                                   ; preds = %bb.o, %.thread, %.thread295, %bb.au, %bb.av
  %.3180286 = phi i32 [ %.3180, %bb.av ], [ %.3180285, %bb.au ], [ %.3180285294298, %.thread295 ], [ %.3180285, %.thread ], [ 1, %bb.o ] ; 6 uses
...
bb.az:                                            ; preds = %bb.aw
  %i.fq = icmp eq i32 %.3180286, 1
  br i1 %i.fq, label %bb.bf, label %bb.bk

bb.ba:                                            ; preds = %bb.aw
  %i.fr = icmp eq i32 %.3180286, 3
  br i1 %i.fr, label %bb.bi, label %bb.bk

bb.bb:                                            ; preds = %bb.aw
  switch i32 %.3180286, label %default.unreachable300 [
    i32 2, label %bb.bk
    i32 1, label %bb.bf
    i32 3, label %bb.bi
  ]
...
bb.bc:                                            ; preds = %bb.aw
  switch i32 %.3180286, label %default.unreachable301 [
    i32 2, label %bb.bd
    i32 1, label %bb.bk
    i32 3, label %bb.bi
  ]
...
bb.be:                                            ; preds = %bb.aw
  switch i32 %.3180286, label %default.unreachable302 [
    i32 2, label %bb.bk
    i32 1, label %bb.bf
    i32 3, label %bb.bi
  ]
...
bb.bg:                                            ; preds = %bb.aw
  switch i32 %.3180286, label %default.unreachable303 [
    i32 2, label %bb.bh
    i32 1, label %bb.bk
    i32 3, label %bb.bi
  ]
