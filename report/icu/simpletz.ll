...
begin_hunk_0_@_ZNK6icu_7814SimpleTimeZone9getOffsetEhiiihiiiR10UErrorCode:bb.a
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.v = load i8, ptr %i.u, align 8, !tbaa !22    ; 2 uses
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  %.05798 = phi i8 [ %spec.select73, %.lr.ph ], [ %0, %bb.a ]
  %.05997 = phi i8 [ %spec.select, %.lr.ph ], [ %3, %bb.a ]
  ...
  %spec.select = select i1 %i.h, i8 1, i8 %i.e    ; 2 uses
  %i.i = zext i1 %i.h to i8
  %spec.select73 = add i8 %.05798, %i.i           ; 2 uses
  %i.j = icmp samesign ugt i32 %.06595, 172799999
...
.lr.ph106:                                        ; preds = %.preheader, %.lr.ph106
  ...
  %.164103 = phi i8 [ %i.p, %.lr.ph106 ], [ %4, %.preheader ]
  %.166102 = phi i32 [ %i.k, %.lr.ph106 ], [ %i.a, %.preheader ] ; 2 uses
  %i.k = add nsw i32 %.166102, 86400000           ; 2 uses
  %i.l = add i8 %.261104, -1                      ; 2 uses
  %i.m = sext i8 %.164103 to i16
  %.lhs.trunc77 = add nsw i16 %i.m, 5
  %i.n = srem i16 %.lhs.trunc77, 7
  %i.o = trunc nsw i16 %i.n to i8
  %i.p = add nsw i8 %i.o, 1                       ; 2 uses
  %i.q = icmp slt i8 %i.l, 1                      ; 2 uses
  %spec.select74 = select i1 %i.q, i8 %2, i8 %i.l ; 2 uses
  %i.r = sext i1 %i.q to i8
  %spec.select75 = add i8 %.2105, %i.r            ; 2 uses
  %i.s = icmp samesign ult i32 %.166102, -86400000
  br i1 %i.s, label %.lr.ph106, label %._crit_edge, !llvm.loop !57

._crit_edge:                                      ; preds = %.lr.ph106, %.lr.ph, %.preheader
  %.166.lcssa = phi i32 [ %i.a, %.preheader ], [ %i.d, %.lr.ph ], [ %i.k, %.lr.ph106 ] ; 2 uses
  %.164.lcssa = phi i8 [ %4, %.preheader ], [ %i.g, %.lr.ph ], [ %i.p, %.lr.ph106 ] ; 4 uses
  %.261.lcssa = phi i8 [ %3, %.preheader ], [ %spec.select, %.lr.ph ], [ %spec.select74, %.lr.ph106 ] ; 5 uses
  %.2.lcssa = phi i8 [ %0, %.preheader ], [ %spec.select73, %.lr.ph ], [ %spec.select75, %.lr.ph106 ] ; 2 uses
  %i.t = icmp slt i8 %.2.lcssa, %8
  br i1 %i.t, label %bb.n, label %bb.b

bb.b:                                             ; preds = %._crit_edge
  %i.u = icmp sgt i8 %.2.lcssa, %8
  br i1 %i.u, label %bb.n, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.v = sext i8 %1 to i32
...
bb.e:                                             ; preds = %bb.c
  %i.x = sext i8 %spec.select76 to i32
  %i.y = icmp sgt i8 %spec.select76, 0
  %i.z = mul nsw i32 %i.x, 7                      ; 2 uses
  br i1 %i.y, label %bb.f, label %bb.g

bb.f:                                             ; preds = %bb.e
  %i.aa = add nsw i32 %i.z, -6
  %i.ab = sext i8 %9 to i16
  %i.ac = sext i8 %.261.lcssa to i16
  %12 = xor i8 %.164.lcssa, -1
  %i.ad = sext i8 %12 to i16
  %.neg = add nsw i16 %i.ab, 7
  %13 = add nsw i16 %.neg, %i.ad
  %.lhs.trunc79 = add nsw i16 %13, %i.ac
  %i.ae = srem i16 %.lhs.trunc79, 7
  %.sext80 = sext i16 %i.ae to i32
  %i.af = add nsw i32 %i.aa, %.sext80
  br label %bb.j

bb.g:                                             ; preds = %bb.e
  %i.ag = sext i8 %.164.lcssa to i32
  %i.ah = sext i8 %.261.lcssa to i32
  %i.ai = sext i8 %9 to i32
  %.neg94 = add nsw i32 %i.v, 7                   ; 2 uses
  %i.aj = add nsw i32 %.neg94, %i.ag
  %i.ak = add nsw i32 %i.ai, %i.ah
  %i.al = sub nsw i32 %i.aj, %i.ak
  %.lhs.trunc81 = trunc nsw i32 %i.al to i16
  %i.am = srem i16 %.lhs.trunc81, 7
  %narrow = sub nsw i16 0, %i.am
  %.sext82.neg = sext i16 %narrow to i32
  %i.an = add nsw i32 %.neg94, %i.z
  %i.ao = add nsw i32 %i.an, %.sext82.neg
  br label %bb.j

bb.h:                                             ; preds = %bb.c
  %i.ap = sext i8 %spec.select76 to i32           ; 2 uses
  %i.aq = sext i8 %9 to i32
  %i.ar = sext i8 %.164.lcssa to i32
  %i.as = sext i8 %.261.lcssa to i32
  %.neg91 = add nsw i32 %i.aq, 49
  %i.at = add nsw i32 %i.ap, %i.ar
  %i.au = sub nsw i32 %.neg91, %i.at
  %i.av = add nsw i32 %i.au, %i.as
  %.lhs.trunc83 = trunc nsw i32 %i.av to i16
  %i.aw = srem i16 %.lhs.trunc83, 7
  %.sext84 = sext i16 %i.aw to i32
  %i.ax = add nsw i32 %.sext84, %i.ap
  br label %bb.j

bb.i:                                             ; preds = %bb.c
  %i.ay = sext i8 %spec.select76 to i32           ; 2 uses
  %i.az = sext i8 %9 to i32
  %i.ba = sext i8 %.164.lcssa to i32
  %i.bb = sext i8 %.261.lcssa to i32
  %reass.sub111 = sub nsw i32 %i.ay, %i.az
  %i.bc = add nsw i32 %reass.sub111, 49
  %i.bd = add nsw i32 %i.bc, %i.ba
  %i.be = sub nsw i32 %i.bd, %i.bb
  %.lhs.trunc85 = trunc nsw i32 %i.be to i16
  %i.bf = srem i16 %.lhs.trunc85, 7
  %.sext86 = sext i16 %i.bf to i32
  %i.bg = sub nsw i32 %i.ay, %.sext86
  br label %bb.j

bb.j:                                             ; preds = %bb.f, %bb.g, %bb.i, %bb.h, %bb.d, %bb.c
  %.0 = phi i32 [ 0, %bb.c ], [ %i.w, %bb.d ], [ %i.af, %bb.f ], [ %i.ao, %bb.g ], [ %i.ax, %bb.h ], [ %i.bg, %bb.i ] ; 2 uses
  %i.bh = sext i8 %.261.lcssa to i32              ; 2 uses
  %i.bi = icmp sgt i32 %.0, %i.bh
  br i1 %i.bi, label %bb.n, label %bb.k

bb.k:                                             ; preds = %bb.j
  %i.bj = icmp slt i32 %.0, %i.bh
  br i1 %i.bj, label %bb.n, label %bb.l

bb.l:                                             ; preds = %bb.k
  %i.bk = icmp slt i32 %.166.lcssa, %11
  br i1 %i.bk, label %bb.n, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.bl = icmp sgt i32 %.166.lcssa, %11
  %. = zext i1 %i.bl to i32
  br label %bb.n
...
bb.a:
  ...
  %i.f = load i32, ptr %6, align 4, !tbaa !40
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.l = load i32, ptr %6, align 4, !tbaa !40
...
bb.j:                                             ; preds = %bb.i, %bb.h, %bb.g, %bb.f
  ...
  %i.av = call noundef i32 %i.au(ptr noundef nonnull align 8 dereferenceable(160) %0)
  %.pn = sitofp i32 %i.av to double
  %.025 = fsub double %1, %.pn
  call void @_ZN6icu_785Grego12timeToFieldsEdRiRaS2_S2_S1_R10UErrorCode(double noundef %.025, ptr noundef nonnull align 4 dereferenceable(4) %i.a, ptr noundef nonnull align 1 dereferenceable(1) %i.c, ptr noundef nonnull align 1 dereferenceable(1) %i.d, ptr noundef nonnull align 1 dereferenceable(1) %i.e, ptr noundef nonnull align 4 dereferenceable(4) %i.b, ptr noundef nonnull align 4 dereferenceable(4) %6)
  %i.aw = load i32, ptr %6, align 4, !tbaa !40
  %i.ax = icmp slt i32 %i.aw, 1
  br i1 %i.ax, label %bb.k, label %.critedge

bb.k:                                             ; preds = %bb.j
  %i.ay = load i32, ptr %i.a, align 4, !tbaa !48  ; 4 uses
  %i.az = load i8, ptr %i.c, align 1, !tbaa !41
  %i.ba = sext i8 %i.az to i32                    ; 2 uses
  %i.bb = load i8, ptr %i.d, align 1, !tbaa !41
  %i.bc = sext i8 %i.bb to i32
  %i.bd = load i8, ptr %i.e, align 1, !tbaa !41
  %i.be = load i32, ptr %i.b, align 4, !tbaa !48
  %i.bf = and i32 %i.ay, 3
  %i.bg = icmp eq i32 %i.bf, 0
  br i1 %i.bg, label %bb.l, label %_ZN6icu_785Grego10isLeapYearEi.exit.thread.i35
