...
_ZN6icu_7814SimpleTimeZone13decodeEndRuleER10UErrorCode.exit.sink.split: ; preds = %.thread.i4, %thread-pre-split.i8, %bb.u, %bb.v, %thread-pre-split.i8.thread, %bb.k, %bb.l, %thread-pre-split.i, %thread-pre-split.i.thread, %bb.f
