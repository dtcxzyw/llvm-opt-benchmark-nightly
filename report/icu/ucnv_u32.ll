...
bb.e:                                             ; preds = %bb.c
  %i.ai = load ptr, ptr %i.c, align 8, !tbaa !15
...
bb.g:                                             ; preds = %bb.f
  ...
  store i8 %i.au, ptr %i.l, align 2, !tbaa !55
  br label %.outer
...
bb.j:                                             ; preds = %bb.i, %bb.h
  %i.bc = load ptr, ptr %i.c, align 8, !tbaa !15
  br label %.outer.outer.jt8
...
bb.m:                                             ; preds = %bb.l, %bb.k
  %i.bd = load ptr, ptr %i.c, align 8, !tbaa !15
  br label %.outer.outer.jt9
...
.outer.outer:                                     ; preds = %.outer.split.us.split.preheader, %bb.c
  ...
  br i1 %i.be, label %.outer.split.us, label %.critedge, !llvm.loop !52
...
.outer.outer.jt8:                                 ; preds = %bb.j, %bb.d
  ...
  br i1 %i.bf, label %.outer.split.us.jt8, label %.critedge, !llvm.loop !52
...
.outer.outer.jt5:                                 ; preds = %.loopexit102.split.us.loopexit, %bb.b
  ...
  br i1 %i.bh, label %.outer.split.us.jt5, label %.critedge, !llvm.loop !52
...
.outer.outer.jt9:                                 ; preds = %bb.e, %bb.m
  ...
  br i1 %i.bi, label %.outer.split.us.jt9, label %.critedge, !llvm.loop !52
...
bb.n:                                             ; preds = %.critedge
  %i.bl = load ptr, ptr %i.g, align 8, !tbaa !32  ; 3 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load258 = load <4 x i32>, ptr %i.bw, align 4, !tbaa !33
  %i.bx = add nsw <4 x i32> %wide.load, %broadcast.splat
  %i.by = add nsw <4 x i32> %wide.load258, %broadcast.splat
  store <4 x i32> %i.bx, ptr %next.gep, align 4, !tbaa !33
  store <4 x i32> %i.by, ptr %i.bw, align 4, !tbaa !33
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.bz = icmp eq i64 %index.next, %n.vec
  br i1 %i.bz, label %middle.block, label %vector.body, !llvm.loop !53
...
.lr.ph:                                           ; preds = %.lr.ph.preheader259, %.lr.ph
  ...
  %i.cb = load i32, ptr %.090180, align 4, !tbaa !33
  %i.cc = add nsw i32 %i.cb, %.us-phi
  store i32 %i.cc, ptr %.090180, align 4, !tbaa !33
  %i.cd = icmp ult ptr %i.ca, %i.bl
  br i1 %i.cd, label %.lr.ph, label %.loopexit, !llvm.loop !54
...
bb.o:                                             ; preds = %.loopexit
  ...
  %i.cg = load i8, ptr %i.cf, align 2, !tbaa !55
...
bb.s:                                             ; preds = %bb.p
  ...
  store ptr %i.cj, ptr %i.c, align 8, !tbaa !15
