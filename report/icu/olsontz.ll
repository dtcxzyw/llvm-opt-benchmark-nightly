...
bb.z:                                             ; preds = %.lr.ph173, %._crit_edge.thread
  %i.bl = phi i16 [ %i.ba, %.lr.ph173 ], [ %i.ep, %._crit_edge.thread ] ; 4 uses
...
bb.al:                                            ; preds = %bb.ak
  store ptr %i.eb, ptr %i.bh, align 8, !tbaa !58
  %i.ec = icmp eq ptr %i.eb, null
  br i1 %i.ec, label %bb.am, label %.preheader

.preheader:                                       ; preds = %bb.al
  %i.ed = load i16, ptr %i.bi, align 8, !tbaa !59 ; 2 uses
  %i.ee = icmp sgt i16 %i.ed, 0
  br i1 %i.ee, label %.lr.ph171.preheader, label %.loopexit

.lr.ph171.preheader:                              ; preds = %.preheader
  %i.ef = zext nneg i16 %i.ed to i64
  %i.eg = shl nuw nsw i64 %i.ef, 3
  call void @llvm.memset.p0.i64(ptr nonnull align 8 %i.eb, i8 0, i64 %i.eg, i1 false), !tbaa !60
  br label %.loopexit
...
.loopexit:                                        ; preds = %.lr.ph171.preheader, %.preheader, %bb.aj
  %i.eh = call noundef ptr @_ZN6icu_787UMemorynwEm(i64 noundef 352) #19 ; 4 uses
  %i.ei = icmp eq ptr %i.eh, null
  br i1 %i.ei, label %bb.aq, label %bb.ao

bb.ao:                                            ; preds = %.loopexit
  %i.ej = icmp eq i32 %i.dv, 0
  %.5 = select i1 %i.ej, ptr %3, ptr %6
  invoke void @_ZN6icu_7821TimeArrayTimeZoneRuleC1ERKNS_13UnicodeStringEiiPKdiNS_12DateTimeRule12TimeRuleTypeE(ptr noundef nonnull align 8 dereferenceable(352) %i.eh, ptr noundef nonnull align 8 dereferenceable(64) %.5, i32 noundef %i.dt, i32 noundef %i.dw, ptr noundef nonnull %i.ax, i32 noundef %.299, i32 noundef 2)
          to label %bb.ap unwind label %bb.ar

bb.ap:                                            ; preds = %bb.ao
  %i.ek = load ptr, ptr %i.bh, align 8, !tbaa !58
  %i.el = getelementptr inbounds nuw [8 x i8], ptr %i.ek, i64 %indvars.iv187
  store ptr %i.eh, ptr %i.el, align 8, !tbaa !60
  %.pre = load i16, ptr %i.az, align 8, !tbaa !34
  br label %._crit_edge.thread

bb.aq:                                            ; preds = %.loopexit
  %i.em = load ptr, ptr %i.bh, align 8, !tbaa !58
  %i.en = getelementptr inbounds nuw [8 x i8], ptr %i.em, i64 %indvars.iv187
  store ptr null, ptr %i.en, align 8, !tbaa !60
  store i32 7, ptr %1, align 4, !tbaa !39
  invoke void @_ZN6icu_7813OlsonTimeZone21deleteTransitionRulesEv(ptr noundef nonnull align 8 dereferenceable(224) %0)
          to label %.critedge unwind label %.loopexit.split-lp
...
bb.ar:                                            ; preds = %bb.ao
  %i.eo = landingpad { ptr, i32 }
          cleanup
  call void @_ZN6icu_787UMemorydlEPv(ptr noundef nonnull %i.eh) #19
  br label %bb.ch

._crit_edge.thread:                               ; preds = %bb.z, %bb.ap, %._crit_edge
  %i.ep = phi i16 [ %.pre, %bb.ap ], [ %i.bl, %._crit_edge ], [ %i.bl, %bb.z ] ; 2 uses
  %indvars.iv.next188 = add nuw nsw i64 %indvars.iv187, 1 ; 2 uses
  %i.eq = sext i16 %i.ep to i64
  %i.er = icmp slt i64 %indvars.iv.next188, %i.eq
  br i1 %i.er, label %bb.z, label %._crit_edge174, !llvm.loop !74
...
bb.as:                                            ; preds = %._crit_edge174
  %i.es = load ptr, ptr %i.ao, align 8, !tbaa !33
  %i.et = load i16, ptr %i.an, align 8, !tbaa !70
  %i.eu = sext i16 %i.et to i64
  %i.ev = getelementptr inbounds i8, ptr %i.es, i64 %i.eu
  %i.ew = load i8, ptr %i.ev, align 1, !tbaa !47
  %i.ex = call noundef ptr @_ZN6icu_787UMemorynwEm(i64 noundef 32) #19 ; 4 uses
  %i.ey = icmp eq ptr %i.ex, null
  br i1 %i.ey, label %bb.av, label %bb.at

bb.at:                                            ; preds = %bb.as
  %i.ez = load i16, ptr %i.an, align 8, !tbaa !70
  %i.fa = call noundef double @_ZNK6icu_7813OlsonTimeZone14transitionTimeEs(ptr noundef nonnull align 8 dereferenceable(224) %0, i16 noundef signext %i.ez)
  %i.fb = load ptr, ptr %i.ac, align 8, !tbaa !55
  %i.fc = getelementptr inbounds nuw i8, ptr %0, i64 192
  %i.fd = load ptr, ptr %i.fc, align 8, !tbaa !58
  %i.fe = zext i8 %i.ew to i64
  %i.ff = getelementptr inbounds nuw [8 x i8], ptr %i.fd, i64 %i.fe
  %i.fg = load ptr, ptr %i.ff, align 8, !tbaa !60
  invoke void @_ZN6icu_7818TimeZoneTransitionC1EdRKNS_12TimeZoneRuleES3_(ptr noundef nonnull align 8 dereferenceable(32) %i.ex, double noundef %i.fa, ptr noundef nonnull align 8 dereferenceable(80) %i.fb, ptr noundef nonnull align 8 dereferenceable(80) %i.fg)
          to label %bb.au unwind label %bb.aw

bb.au:                                            ; preds = %bb.at
  %i.fh = getelementptr inbounds nuw i8, ptr %0, i64 168
  store ptr %i.ex, ptr %i.fh, align 8, !tbaa !56
  br label %.critedge145

bb.av:                                            ; preds = %bb.as
  %i.fi = getelementptr inbounds nuw i8, ptr %0, i64 168
  store ptr null, ptr %i.fi, align 8, !tbaa !56
  br label %.invoke
...
bb.aw:                                            ; preds = %bb.at
  %i.fj = landingpad { ptr, i32 }
          cleanup
  call void @_ZN6icu_787UMemorydlEPv(ptr noundef nonnull %i.ex) #19
  br label %bb.ch

.critedge145:                                     ; preds = %bb.u, %bb.au, %bb.v, %bb.r
  %i.fk = getelementptr inbounds nuw i8, ptr %0, i64 128 ; 4 uses
  %i.fl = load ptr, ptr %i.fk, align 8, !tbaa !36 ; 3 uses
  %.not129 = icmp eq ptr %i.fl, null
  br i1 %.not129, label %.critedge, label %bb.ax

bb.ax:                                            ; preds = %.critedge145
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #19
  %i.fm = getelementptr inbounds nuw i8, ptr %0, i64 136
  %i.fn = load double, ptr %i.fm, align 8, !tbaa !49 ; 2 uses
  store double %i.fn, ptr %i.a, align 8, !tbaa !72
  %i.fo = load ptr, ptr %i.fl, align 8, !tbaa !37
  %i.fp = getelementptr inbounds nuw i8, ptr %i.fo, i64 72
  %i.fq = load ptr, ptr %i.fp, align 8
  %i.fr = invoke noundef signext i8 %i.fq(ptr noundef nonnull align 8 dereferenceable(160) %i.fl)
          to label %bb.ay unwind label %bb.bb

bb.ay:                                            ; preds = %bb.ax
  %.not130 = icmp eq i8 %i.fr, 0
  %i.fs = load ptr, ptr %i.fk, align 8, !tbaa !36 ; 3 uses
  %i.ft = load ptr, ptr %i.fs, align 8, !tbaa !37
...
bb.az:                                            ; preds = %bb.ay
  %i.fw = invoke noundef ptr %i.fv(ptr noundef nonnull align 8 dereferenceable(160) %i.fs)
          to label %bb.ba unwind label %bb.bb     ; 3 uses

bb.ba:                                            ; preds = %bb.az
  %i.fx = getelementptr inbounds nuw i8, ptr %0, i64 208 ; 2 uses
  store ptr %i.fw, ptr %i.fx, align 8, !tbaa !50
  %i.fy = icmp eq ptr %i.fw, null
  br i1 %i.fy, label %.invoke212, label %bb.bc
...
bb.bc:                                            ; preds = %bb.ba
  %i.ga = getelementptr inbounds nuw i8, ptr %0, i64 144
  %i.gb = load i32, ptr %i.ga, align 8, !tbaa !48
  invoke void @_ZN6icu_7814SimpleTimeZone12setStartYearEi(ptr noundef nonnull align 8 dereferenceable(160) %i.fw, i32 noundef %i.gb)
...
bb.be:                                            ; preds = %bb.bd
  %i.gc = load ptr, ptr %i.fx, align 8, !tbaa !50 ; 2 uses
  %i.gd = load ptr, ptr %i.gc, align 8, !tbaa !37
  %i.ge = getelementptr inbounds nuw i8, ptr %i.gd, i64 112
  %i.gf = load ptr, ptr %i.ge, align 8
  %i.gg = invoke noundef signext i8 %i.gf(ptr noundef nonnull align 8 dereferenceable(160) %i.gc, double noundef %i.fn, i8 noundef signext 0, ptr noundef nonnull align 8 dereferenceable(32) %9)
          to label %bb.bf unwind label %bb.bk     ; 0 uses

bb.bf:                                            ; preds = %bb.be
  %i.gh = invoke noundef ptr @_ZNK6icu_7818TimeZoneTransition5getToEv(ptr noundef nonnull align 8 dereferenceable(32) %9)
...
bb.bg:                                            ; preds = %bb.bf
  ...
  %i.gl = invoke noundef ptr %i.gk(ptr noundef nonnull align 8 dereferenceable(80) %i.gh)
          to label %bb.bh unwind label %bb.bk     ; 2 uses

bb.bh:                                            ; preds = %bb.bg
  %.not133 = icmp eq ptr %i.gl, null
