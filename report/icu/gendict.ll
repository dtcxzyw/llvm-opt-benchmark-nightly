...
.preheader:                                       ; preds = %bb.ay, %.critedge
  %.0123.lcssa478 = phi i32 [ %i.fl, %.critedge ], [ %i.fb, %bb.ay ] ; 11 uses
  ...
  %i.ft = icmp slt i32 %.0123.lcssa478, %i.fs
...
_ZNK6icu_7813UnicodeStringixEi.exit246.preheader: ; preds = %.preheader
  %i.fu = zext nneg i32 %.0123.lcssa478 to i64
...
_ZNK6icu_7813UnicodeStringixEi.exit246:           ; preds = %_ZNK6icu_7813UnicodeStringixEi.exit246.preheader, %bb.bb
  ...
  %.0121371 = phi i32 [ %.0123.lcssa478, %_ZNK6icu_7813UnicodeStringixEi.exit246.preheader ], [ %i.gf, %bb.bb ]
  %i.fy = and i16 %i.fx, 2
...
bb.ba:                                            ; preds = %_ZNK6icu_7813UnicodeStringixEi.exit246
  ...
  br i1 %.not214, label %.critedge3.loopexit.split.loop.exit566, label %bb.bb

bb.bb:                                            ; preds = %bb.ba
  %indvars.iv.next456 = add nuw nsw i64 %indvars.iv455, 1 ; 2 uses
  %i.gf = add nuw nsw i32 %.0121371, 1            ; 2 uses
...
.critedge3.loopexit.split.loop.exit566:           ; preds = %bb.ba
  %i.go = trunc nuw nsw i64 %indvars.iv455 to i32
  br label %.critedge3

.critedge3:                                       ; preds = %bb.bb, %.critedge3.loopexit.split.loop.exit566, %.preheader
  %.0121.lcssa = phi i32 [ %.0123.lcssa478, %.preheader ], [ %i.go, %.critedge3.loopexit.split.loop.exit566 ], [ %i.gf, %bb.bb ] ; 3 uses
  %i.gp = icmp samesign ult i32 %.0123.lcssa478, %.0121.lcssa
...
bb.bc:                                            ; preds = %.critedge3
  ...
  %i.gw = sub nsw i32 %i.gv, %.0121.lcssa         ; 3 uses
...
bb.bd:                                            ; preds = %bb.bc
  ...
  %i.ha = invoke noundef i32 @_ZNK6icu_7813UnicodeString7extractEiiPciNS0_10EInvariantE(ptr noundef nonnull align 8 dereferenceable(64) %5, i32 noundef %.0121.lcssa, i32 noundef %i.gw, ptr noundef nonnull %i.c, i32 noundef 16, i32 noundef 0)
...
bb.bi:                                            ; preds = %bb.bg
  ...
  invoke void @_ZNK6icu_7813UnicodeString13tempSubStringEii(ptr dead_on_unwind nonnull writable sret(%"class.icu_78::UnicodeString") align 8 %6, ptr noundef nonnull align 8 dereferenceable(64) %5, i32 noundef 0, i32 noundef %.0123.lcssa478)
...
bb.bp:                                            ; preds = %.critedge3
  ...
  invoke void @_ZNK6icu_7813UnicodeString13tempSubStringEii(ptr dead_on_unwind nonnull writable sret(%"class.icu_78::UnicodeString") align 8 %7, ptr noundef nonnull align 8 dereferenceable(64) %5, i32 noundef 0, i32 noundef %.0123.lcssa478)
...
bb.cq:                                            ; preds = %_ZN8DataDict14serializeBytesER10UErrorCode.exit, %bb.cl, %bb.cn, %bb.co
  %.0120 = phi i32 [ %.fca.1.extract, %_ZN8DataDict14serializeBytesER10UErrorCode.exit ], [ %i.is, %bb.cl ], [ %i.is, %bb.cn ], [ %i.is, %bb.co ] ; 4 uses
  %.0 = phi ptr [ %.fca.0.extract, %_ZN8DataDict14serializeBytesER10UErrorCode.exit ], [ null, %bb.cl ], [ %i.iv, %bb.cn ], [ %i.ix, %bb.co ] ; 2 uses
...
bb.db:                                            ; preds = %bb.cx
  ...
  %i.ke = sdiv i32 %.0120, 2
  %i.kf = select i1 %.not.i, i32 %i.ke, i32 %.0120
  invoke void @usrc_writeArray(ptr noundef nonnull %i.jg, ptr noundef nonnull @.str.35, ptr noundef %.0, i32 noundef %i.kd, i32 noundef %i.kf, ptr noundef nonnull @.str.36, ptr noundef nonnull @.str.37)
...
bb.dm:                                            ; preds = %bb.dl, %bb.dk
  ...
  %i.kr = add nsw i32 %.0120, 32                  ; 4 uses
