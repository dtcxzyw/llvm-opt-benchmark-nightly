...
.outer:                                           ; preds = %.outer.outer, %bb.bv
  ...
  %.0154.ph = phi i32 [ %.5159, %bb.bv ], [ %.0154.ph.ph, %.outer.outer ] ; 4 uses
  %.0148.ph = phi i32 [ %.3151, %bb.bv ], [ %.0148.ph.ph, %.outer.outer ] ; 3 uses
  %.0147.ph = phi i32 [ %i.ek, %bb.bv ], [ %.0147.ph.ph, %.outer.outer ]
  %.0143.ph = phi i8 [ %.1144, %bb.bv ], [ %.0143.ph.ph, %.outer.outer ] ; 3 uses
  %.0137.ph = phi i8 [ %.3140, %bb.bv ], [ %.0137.ph.ph, %.outer.outer ] ; 3 uses
  br label %bb.ar
...
.thread269:                                       ; preds = %bb.bj
  ...
  %spec.select = call i32 @llvm.smin.i32(i32 %.0177.lcssa477, i32 %.0154.ph)
  %.1163 = call i32 @llvm.smax.i32(i32 %.0177.lcssa477, i32 %.0162.ph)
...
bb.br:                                            ; preds = %bb.bq
  ...
  %spec.select234 = call i32 @llvm.smin.i32(i32 %.0177.lcssa477, i32 %.0154.ph)
  %spec.select235 = call i32 @llvm.smax.i32(i32 %.0177.lcssa477, i32 %.0162.ph)
  br label %bb.bv
...
bb.ca:                                            ; preds = %bb.bz
  %i.hx = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.18, i32 noundef %.0147, i32 noundef %.0148.ph, i32 noundef %.0154.ph, i32 noundef %.0162.ph) ; 0 uses
...
bb.cd:                                            ; preds = %bb.cc, %bb.cb
  %i.ia = icmp ne i8 %.0137.ph, 0                 ; 3 uses
