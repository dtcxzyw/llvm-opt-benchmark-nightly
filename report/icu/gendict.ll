...
.outer.outer:                                     ; preds = %bb.bw, %bb.aq
  %.0150.ph.ph = phi i8 [ %.3153, %bb.bw ], [ 0, %bb.aq ] ; 2 uses
  %.0146.ph.ph = phi i8 [ %.1147, %bb.bw ], [ 0, %bb.aq ] ; 2 uses
  %.0145.ph.ph = phi i32 [ %i.ek, %bb.bw ], [ 0, %bb.aq ]
  %.0139.ph.ph = phi i32 [ %.3142, %bb.bw ], [ 0, %bb.aq ] ; 2 uses
  %.0132.ph.ph = phi i32 [ %.5137, %bb.bw ], [ 255, %bb.aq ] ; 3 uses
  %.0126.ph.ph = phi i32 [ %.4130, %bb.bw ], [ 0, %bb.aq ] ; 3 uses
  %.0124.ph.ph = phi i8 [ %.0124.ph, %bb.bw ], [ 1, %bb.aq ]
  br label %.outer
...
bb.ar:                                            ; preds = %.outer, %bb.aw
  %.0145 = phi i32 [ %i.ek, %bb.aw ], [ %.0145.ph, %.outer ] ; 2 uses
...
bb.aw:                                            ; preds = %.critedge4.i
  ...
  %i.ek = add nsw i32 %.0145, 1                   ; 7 uses
...
_ZNK6icu_7813UnicodeStringixEi.exit:              ; preds = %.preheader279, %bb.ay
  ...
  %.0123368 = phi i32 [ %i.fb, %bb.ay ], [ 0, %.preheader279 ]
  %i.eu = and i16 %i.et, 2
...
bb.ay:                                            ; preds = %bb.ax
  ...
  %i.fb = add nuw nsw i32 %.0123368, 1            ; 2 uses
...
.preheader:                                       ; preds = %bb.ay, %.critedge
  %.0123.lcssa480 = phi i32 [ %i.fl, %.critedge ], [ %i.fb, %bb.ay ] ; 11 uses
  ...
  %i.ft = icmp slt i32 %.0123.lcssa480, %i.fs
  br i1 %i.ft, label %.lr.ph.preheader, label %.critedge3

.lr.ph.preheader:                                 ; preds = %.preheader
  %i.fu = zext nneg i32 %.0123.lcssa480 to i64
  br label %.lr.ph
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.bc
  ...
  %.0121371 = phi i32 [ %.0123.lcssa480, %.lr.ph.preheader ], [ %i.gd, %bb.bc ]
...
bb.bb:                                            ; preds = %_ZNK6icu_7813UnicodeStringixEi.exit246
  ...
  br i1 %.not214, label %.critedge3.loopexit.split.loop.exit568, label %bb.bc

bb.bc:                                            ; preds = %bb.bb
  %indvars.iv.next456 = add nuw nsw i64 %indvars.iv455, 1 ; 2 uses
  %i.gd = add nuw nsw i32 %.0121371, 1            ; 2 uses
...
.critedge3.loopexit.split.loop.exit568:           ; preds = %bb.bb
  %i.gm = trunc nuw nsw i64 %indvars.iv455 to i32
  br label %.critedge3

.critedge3:                                       ; preds = %bb.bc, %.critedge3.loopexit.split.loop.exit568, %.preheader
  %.0121.lcssa = phi i32 [ %.0123.lcssa480, %.preheader ], [ %i.gm, %.critedge3.loopexit.split.loop.exit568 ], [ %i.gd, %bb.bc ] ; 3 uses
  %i.gn = icmp samesign ult i32 %.0123.lcssa480, %.0121.lcssa
...
bb.bd:                                            ; preds = %.critedge3
  ...
  %i.gu = sub nsw i32 %i.gt, %.0121.lcssa         ; 3 uses
...
bb.be:                                            ; preds = %bb.bd
  ...
  %i.gy = invoke noundef i32 @_ZNK6icu_7813UnicodeString7extractEiiPciNS0_10EInvariantE(ptr noundef nonnull align 8 dereferenceable(64) %5, i32 noundef %.0121.lcssa, i32 noundef %i.gu, ptr noundef nonnull %i.c, i32 noundef 16, i32 noundef 0)
...
bb.bj:                                            ; preds = %bb.bh
  ...
  invoke void @_ZNK6icu_7813UnicodeString13tempSubStringEii(ptr dead_on_unwind nonnull writable sret(%"class.icu_78::UnicodeString") align 8 %6, ptr noundef nonnull align 8 dereferenceable(64) %5, i32 noundef 0, i32 noundef %.0123.lcssa480)
...
.thread269:                                       ; preds = %bb.bk
  ...
  %spec.select = call i32 @llvm.smin.i32(i32 %.0123.lcssa480, i32 %.0132.ph.ph)
  %.1127 = call i32 @llvm.smax.i32(i32 %.0123.lcssa480, i32 %.0126.ph.ph)
...
.outer.backedge:                                  ; preds = %bb.bo, %.thread262, %.critedge.thread
...
bb.bq:                                            ; preds = %.critedge3
  ...
  invoke void @_ZNK6icu_7813UnicodeString13tempSubStringEii(ptr dead_on_unwind nonnull writable sret(%"class.icu_78::UnicodeString") align 8 %7, ptr noundef nonnull align 8 dereferenceable(64) %5, i32 noundef 0, i32 noundef %.0123.lcssa480)
...
bb.bs:                                            ; preds = %bb.br
  ...
  %spec.select234 = call i32 @llvm.smin.i32(i32 %.0123.lcssa480, i32 %.0132.ph.ph)
  %spec.select235 = call i32 @llvm.smax.i32(i32 %.0123.lcssa480, i32 %.0126.ph.ph)
  br label %bb.bw
...
bb.bw:                                            ; preds = %bb.bs, %.thread269
  %.3153 = phi i8 [ 1, %.thread269 ], [ %.0150.ph.ph, %bb.bs ]
  %.1147 = phi i8 [ %.0146.ph.ph, %.thread269 ], [ 1, %bb.bs ]
  %.5137 = phi i32 [ %spec.select, %.thread269 ], [ %spec.select234, %bb.bs ]
  %.4130 = phi i32 [ %.1127, %.thread269 ], [ %spec.select235, %bb.bs ]
  %.3142 = add nuw nsw i32 %.0139.ph.ph, 1
  %i.hp = load i32, ptr %i.bs, align 8, !tbaa !19
  %i.hq = icmp slt i32 %i.hp, 1
  br i1 %i.hq, label %.outer.outer, label %bb.bx
...
bb.cb:                                            ; preds = %bb.ca
  %i.hv = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.18, i32 noundef %.0145, i32 noundef %.0139.ph.ph, i32 noundef %.0132.ph.ph, i32 noundef %.0126.ph.ph) ; 0 uses
...
bb.ce:                                            ; preds = %bb.cd, %bb.cc
  %i.hy = icmp ne i8 %.0150.ph.ph, 0              ; 3 uses
  %i.hz = icmp ne i8 %.0146.ph.ph, 0
