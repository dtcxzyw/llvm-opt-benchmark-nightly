...
begin_hunk_0_@_ZL16uprv_swapArray16PK12UDataSwapperPKviPvP10UErrorCode:bb.a
  ...
  store <8 x i16> %i.v, ptr %next.gep, align 2, !tbaa !31
  store <8 x i16> %i.w, ptr %i.x, align 2, !tbaa !31
  %index.next = add nuw i64 %index, 16            ; 2 uses
  %i.y = icmp eq i64 %index.next, %n.vec
  br i1 %i.y, label %middle.block, label %vector.body, !llvm.loop !46
...
vec.epilog.iter.check:                            ; preds = %middle.block
  ...
  br i1 %min.epilog.iters.check.not.not, label %.lr.ph.preheader, label %vec.epilog.ph, !prof !49
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load47 = load <8 x i16>, ptr %next.gep46, align 2, !tbaa !31
  %i.af = tail call <8 x i16> @llvm.bswap.v8i16(<8 x i16> %wide.load47)
  store <8 x i16> %i.af, ptr %next.gep45, align 2, !tbaa !31
  %index.next48 = add nuw i64 %index44, 8         ; 2 uses
  %i.ag = icmp eq i64 %index.next48, %n.vec43
  br i1 %i.ag, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !47
...
bb.b:                                             ; preds = %bb.a
  %i.d = load i32, ptr %4, align 4, !tbaa !13
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %next.gep38, align 4, !tbaa !32
  %wide.load39 = load <4 x i32>, ptr %i.u, align 4, !tbaa !32
  %i.v = tail call <4 x i32> @llvm.bswap.v4i32(<4 x i32> %wide.load)
  %i.w = tail call <4 x i32> @llvm.bswap.v4i32(<4 x i32> %wide.load39)
  %i.x = getelementptr i8, ptr %next.gep, i64 16
  store <4 x i32> %i.v, ptr %next.gep, align 4, !tbaa !32
  store <4 x i32> %i.w, ptr %i.x, align 4, !tbaa !32
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.y = icmp eq i64 %index.next, %n.vec
  br i1 %i.y, label %middle.block, label %vector.body, !llvm.loop !50
