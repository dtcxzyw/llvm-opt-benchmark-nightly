...
bb.ap:                                            ; preds = %bb.ao
  ...
  store i16 %.6, ptr %.9217, align 2, !tbaa !33
...
bb.ar:                                            ; preds = %bb.aq, %bb.ap
  ...
  store i16 %i.gn, ptr %i.gu, align 8, !tbaa !33
...
.thread283.sink.split:                            ; preds = %bb.am, %bb.ao, %bb.ar
  ...
  store i32 %.sink421, ptr %1, align 4, !tbaa !17
  br label %.thread283
...
.thread283:                                       ; preds = %bb.ak, %bb.af, %.thread283.sink.split, %.loopexit, %bb.an, %bb.al
  ...
  %i.gx = load i32, ptr %1, align 4, !tbaa !17
...
bb.a:
  ...
  %i.e = load ptr, ptr %i.d, align 8, !tbaa !38   ; 5 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.o = load ptr, ptr %i.n, align 8, !tbaa !40   ; 4 uses
...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  %i.x = load ptr, ptr %i.w, align 8, !tbaa !42   ; 10 uses
  store ptr %i.x, ptr %i.a, align 8, !tbaa !43
...
bb.f:                                             ; preds = %bb.d
  ...
  %i.af = load ptr, ptr %i.ae, align 8, !tbaa !44 ; 5 uses
  store ptr %i.af, ptr %i.b, align 8, !tbaa !45
  %i.ag = getelementptr inbounds nuw i8, ptr %i.o, i64 84 ; 3 uses
  %i.ah = load i32, ptr %i.ag, align 4, !tbaa !46 ; 4 uses
...
bb.g:                                             ; preds = %bb.f
  %i.ak = load i16, ptr %i.e, align 2, !tbaa !33  ; 3 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  store ptr %i.az, ptr %i.a, align 8, !tbaa !43
  %i.ba = add i32 %i.ad, -4
...
.lr.ph250:                                        ; preds = %.preheader, %bb.p
  ...
  %i.bp = load i16, ptr %.1142248, align 2, !tbaa !33 ; 7 uses
...
bb.l:                                             ; preds = %.lr.ph250
  ...
  %i.bw = load ptr, ptr %i.a, align 8, !tbaa !43  ; 2 uses
...
bb.n:                                             ; preds = %bb.m
  %i.cc = load i16, ptr %i.bo, align 2, !tbaa !33 ; 3 uses
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.ck = load ptr, ptr %i.a, align 8, !tbaa !43  ; 4 uses
...
bb.p:                                             ; preds = %bb.o, %bb.l
  ...
  store ptr %storemerge, ptr %i.a, align 8, !tbaa !43
  %i.cs = add nsw i32 %.2, -1                     ; 2 uses
  %.not161 = icmp eq i32 %i.cs, 0
  br i1 %.not161, label %.thread175, label %.lr.ph250, !llvm.loop !55
...
.lr.ph:                                           ; preds = %.preheader231, %bb.u
  ...
  %i.cv = load i16, ptr %.3144243, align 2, !tbaa !33 ; 7 uses
...
begin_hunk_1_@_ZL30_UTF16BEFromUnicodeWithOffsetsP25UConverterFromUnicodeArgsP10UErrorCode:bb.a
  store ptr %i.de, ptr %i.a, align 8, !tbaa !43
  %i.df = load ptr, ptr %i.b, align 8, !tbaa !45  ; 3 uses
  ...
  store ptr %i.di, ptr %i.b, align 8, !tbaa !45
...
bb.s:                                             ; preds = %bb.r
  %i.dm = load i16, ptr %i.cu, align 2, !tbaa !33 ; 3 uses
...
bb.t:                                             ; preds = %bb.s
  ...
  %i.du = load ptr, ptr %i.a, align 8, !tbaa !43  ; 4 uses
  ...
  store ptr %i.eb, ptr %i.a, align 8, !tbaa !43
  %i.ec = load ptr, ptr %i.b, align 8, !tbaa !45  ; 2 uses
  %i.ed = getelementptr inbounds nuw i8, ptr %i.ec, i64 16
  store ptr %i.ed, ptr %i.b, align 8, !tbaa !45
...
bb.u:                                             ; preds = %bb.t, %bb.q
  ...
  br i1 %.not160, label %.thread175, label %.lr.ph, !llvm.loop !56
...
bb.v:                                             ; preds = %.thread175
  ...
  %i.en = load i16, ptr %.5146180, align 2, !tbaa !33 ; 4 uses
...
bb.w:                                             ; preds = %.thread205
  %i.fa = load ptr, ptr %i.f, align 8, !tbaa !39
  %i.fb = icmp ult ptr %.7212, %i.fa
  br i1 %i.fb, label %bb.x, label %bb.ab

bb.x:                                             ; preds = %bb.w
  %i.fc = load i16, ptr %.7212, align 2, !tbaa !33 ; 3 uses
...
bb.ab:                                            ; preds = %bb.z, %bb.y, %bb.w, %bb.aa
  ...
  store i32 %i.fp, ptr %i.ag, align 4, !tbaa !46
  br label %.thread193
...
bb.ac:                                            ; preds = %.thread193.thread222, %.thread193
  ...
  %i.fr = load ptr, ptr %i.y, align 8, !tbaa !41
  ...
  %i.fs = load ptr, ptr %i.y, align 8, !tbaa !41
  %i.ft = load ptr, ptr %i.a, align 8, !tbaa !43  ; 2 uses
...
bb.af:                                            ; preds = %bb.ae, %bb.ad, %.thread193.thread
  store ptr %.9221, ptr %i.d, align 8, !tbaa !38
  store ptr %i.fy, ptr %i.w, align 8, !tbaa !42
  %i.ge = load ptr, ptr %i.b, align 8, !tbaa !45
  store ptr %i.ge, ptr %i.ae, align 8, !tbaa !44
  br label %bb.ag
...
bb.j:                                             ; preds = %bb.g
  %i.ah = load i32, ptr %i.o, align 8, !tbaa !13
...
bb.ar:                                            ; preds = %bb.aq, %bb.ap
  ...
  store i16 %i.fm, ptr %i.ft, align 8, !tbaa !33
...
.thread283:                                       ; preds = %bb.ak, %bb.af, %.thread283.sink.split, %.loopexit, %bb.an, %bb.al
  ...
  %i.fw = load i32, ptr %1, align 4, !tbaa !17
...
.lr.ph250:                                        ; preds = %.preheader, %bb.p
  ...
  %i.bp = load i16, ptr %.1143248, align 2, !tbaa !33 ; 7 uses
  %i.bq = zext i16 %i.bp to i32                   ; 2 uses
  %i.br = and i32 %i.bq, 63488
  %i.bs = icmp eq i32 %i.br, 55296
  br i1 %i.bs, label %bb.m, label %bb.l
...
.lr.ph:                                           ; preds = %.preheader231, %bb.u
  ...
  %i.cv = load i16, ptr %.3145243, align 2, !tbaa !33 ; 7 uses
  %i.cw = zext i16 %i.cv to i32                   ; 2 uses
  %i.cx = and i32 %i.cw, 63488
  %i.cy = icmp eq i32 %i.cx, 55296
...
bb.q:                                             ; preds = %.lr.ph
  ...
  %i.dc = load ptr, ptr %i.a, align 8, !tbaa !43  ; 2 uses
...
bb.v:                                             ; preds = %.thread175
  ...
  %i.en = load i16, ptr %.5147180, align 2, !tbaa !33 ; 3 uses
  %i.eo = and i16 %i.en, -2048
  %i.ep = icmp eq i16 %i.eo, -10240
  br i1 %i.ep, label %.thread205, label %.thread193.thread222
...
bb.w:                                             ; preds = %.thread205
  %i.ew = load ptr, ptr %i.f, align 8, !tbaa !39
  %i.ex = icmp ult ptr %.7212, %i.ew
  br i1 %i.ex, label %bb.x, label %bb.ab

bb.x:                                             ; preds = %bb.w
  %i.ey = load i16, ptr %.7212, align 2, !tbaa !33 ; 2 uses
...
bb.ab:                                            ; preds = %bb.z, %bb.y, %bb.w, %bb.aa
  ...
  store i32 %i.fd, ptr %i.ag, align 4, !tbaa !46
  br label %.thread193
...
bb.ac:                                            ; preds = %.thread193.thread222, %.thread193
  ...
  %i.ff = load ptr, ptr %i.y, align 8, !tbaa !41
  ...
  %i.fg = load ptr, ptr %i.y, align 8, !tbaa !41
  %i.fh = load ptr, ptr %i.a, align 8, !tbaa !43  ; 2 uses
...
.thread193.thread:                                ; preds = %.thread175, %bb.ac, %.thread193
  ...
  %i.fn = load i32, ptr %1, align 4, !tbaa !17
  %i.fo = icmp sgt i32 %i.fn, 0
  br i1 %i.fo, label %bb.af, label %bb.ad

bb.ad:                                            ; preds = %.thread193.thread
  %i.fp = load ptr, ptr %i.f, align 8, !tbaa !39
...
bb.af:                                            ; preds = %bb.ae, %bb.ad, %.thread193.thread
  store ptr %.9221, ptr %i.d, align 8, !tbaa !38
  store ptr %i.fm, ptr %i.w, align 8, !tbaa !42
  %i.fs = load ptr, ptr %i.b, align 8, !tbaa !45
  store ptr %i.fs, ptr %i.ae, align 8, !tbaa !44
  br label %bb.ag
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load32 = load <8 x i8>, ptr %next.gep30, align 1, !tbaa !30
  store <8 x i8> %wide.load32, ptr %next.gep31, align 1, !tbaa !30
...
!10 = !{!"p1 _ZTS20UConverterSharedData", !8, i64 0}
!11 = !{!"_ZTS24UConverterCallbackReason", !4, i64 0}
!12 = !{!"_ZTS10UConverter", !8, i64 0, !8, i64 8, !8, i64 16, !8, i64 24, !8, i64 32, !9, i64 40, !10, i64 48, !5, i64 56, !4, i64 60, !4, i64 61, !4, i64 62, !4, i64 63, !4, i64 64, !4, i64 65, !5, i64 72, !5, i64 76, !5, i64 80, !5, i64 84, !4, i64 88, !4, i64 89, !4, i64 90, !4, i64 91, !4, i64 92, !4, i64 93, !4, i64 94, !4, i64 95, !4, i64 96, !4, i64 104, !4, i64 136, !4, i64 140, !4, i64 144, !5, i64 208, !4, i64 212, !4, i64 250, !4, i64 281, !4, i64 282, !4, i64 283, !11, i64 284}
!13 = !{!12, !5, i64 56}
!14 = !{!12, !5, i64 76}
!15 = !{!12, !5, i64 80}
...
!17 = !{!16, !16, i64 0}
!18 = !{!"short", !4, i64 0}
!19 = !{!"p1 _ZTS10UConverter", !8, i64 0}
!20 = !{!"p1 char16_t", !8, i64 0}
!21 = !{!"p1 int", !8, i64 0}
!22 = !{!"_ZTS23UConverterToUnicodeArgs", !18, i64 0, !4, i64 2, !19, i64 8, !9, i64 16, !9, i64 24, !20, i64 32, !20, i64 40, !21, i64 48}
!23 = !{!22, !19, i64 8}
!24 = !{!22, !9, i64 16}
!25 = !{!22, !9, i64 24}
!26 = !{!12, !5, i64 72}
...
!37 = !{!"_ZTS25UConverterFromUnicodeArgs", !18, i64 0, !4, i64 2, !19, i64 8, !20, i64 16, !20, i64 24, !9, i64 32, !9, i64 40, !21, i64 48}
!38 = !{!37, !20, i64 16}
!39 = !{!37, !20, i64 24}
!40 = !{!37, !19, i64 8}
!41 = !{!37, !9, i64 40}
...
!55 = distinct !{!55, !36}
!56 = distinct !{!56, !36}
!57 = distinct !{!57, !36, !47, !48}
!58 = distinct !{!58, !36, !47, !48}
!59 = distinct !{!59, !50}
!60 = distinct !{!60, !36, !47}
!61 = distinct !{!61, !36}
!62 = distinct !{!62, !36, !47, !48}
!63 = distinct !{!63, !36, !48, !47}
!64 = !{!22, !4, i64 2}
!65 = distinct !{!65, !36}
!66 = distinct !{!66, !36}
!67 = distinct !{!67, !36}
!68 = distinct !{!68, !36}
!69 = distinct !{!69, !36}
!70 = distinct !{!70, !36, !47, !48}
!71 = distinct !{!71, !36, !47, !48}
!72 = distinct !{!72, !50}
!73 = distinct !{!73, !36, !47}
!74 = !{!"_ZTS18UConverterLoadArgs", !5, i64 0, !5, i64 4, !4, i64 8, !4, i64 9, !18, i64 10, !5, i64 12, !9, i64 16, !9, i64 24, !9, i64 32}
!75 = !{!74, !4, i64 8}
!76 = !{!12, !9, i64 40}
!77 = distinct !{!77, !36, !47, !48}
!78 = distinct !{!78, !36, !47, !48}
!79 = distinct !{!79, !50}
!80 = distinct !{!80, !36, !47}
!81 = distinct !{!81, !36, !47, !48}
!82 = distinct !{!82, !36, !47, !48}
!83 = distinct !{!83, !50}
!84 = distinct !{!84, !36, !47}
end_hunk_4
