...
end_hunk_0
begin_hunk_1_@_ZNK6icu_7813LikelySubtags13isMacroregionERNS_11StringPieceER10UErrorCode:bb.a
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #16
  %.sroa.0.0.copyload = load ptr, ptr %1, align 8
  %.sroa.2.0..sroa_idx = getelementptr inbounds nuw i8, ptr %1, i64 8
  %.sroa.2.0.copyload = load i32, ptr %.sroa.2.0..sroa_idx, align 8
  call void @_ZN6icu_7813UnicodeString8fromUTF8ENS_11StringPieceE(ptr dead_on_unwind nonnull writable sret(%"class.icu_78::UnicodeString") align 8 %3, ptr %.sroa.0.0.copyload, i32 %.sroa.2.0.copyload)
  %i.i = load ptr, ptr @_ZN6icu_7812_GLOBAL__N_113gMacroregionsE, align 8, !tbaa !54
  %i.j = invoke noundef i32 @_ZNK6icu_787UVector7indexOfEPvi(ptr noundef nonnull align 8 dereferenceable(40) %i.i, ptr noundef nonnull %3, i32 noundef 0)
...
bb.i:                                             ; preds = %_ZN6icu_7813umtx_initOnceERNS_9UInitOnceEPFvR10UErrorCodeES3_.exit.thread, %_ZN6icu_7813umtx_initOnceERNS_9UInitOnceEPFvR10UErrorCodeES3_.exit, %bb.a, %bb.g
  %.0 = phi i1 [ %i.k, %bb.g ], [ false, %bb.a ], [ false, %_ZN6icu_7813umtx_initOnceERNS_9UInitOnceEPFvR10UErrorCodeES3_.exit ], [ false, %_ZN6icu_7813umtx_initOnceERNS_9UInitOnceEPFvR10UErrorCodeES3_.exit.thread ]
  ret i1 %.0
}

declare void @_ZN6icu_7813UnicodeString8fromUTF8ENS_11StringPieceE(ptr dead_on_unwind writable sret(%"class.icu_78::UnicodeString") align 8, ptr, i32) local_unnamed_addr #2

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(argmem: readwrite)
declare void @llvm.memcpy.p0.p0.i64(ptr noalias writeonly captures(none), ptr noalias readonly captures(none), i64, i1 immarg) #8

; Function Attrs: nounwind
declare void @_ZN6icu_7813UnicodeStringD1Ev(ptr noundef nonnull align 8 dead_on_return(64) dereferenceable(64)) unnamed_addr #6

declare noundef i32 @_ZN6icu_7811StringPiece7compareES0_(ptr noundef nonnull align 8 dereferenceable(12), ptr, i32) local_unnamed_addr #2

; Function Attrs: mustprogress uwtable
define noundef i32 @_ZN6icu_7813LikelySubtags8trieNextERNS_9BytesTrieENS_11StringPieceEi(ptr noundef nonnull align 8 dereferenceable(28) %0, ptr nofree readonly captures(none) %1, i32 %2, i32 noundef %3) local_unnamed_addr #7 align 2 {
bb.a:
  %i.a = icmp eq i32 %2, %3
...
.preheader.preheader:                             ; preds = %bb.a
  ...
  %.0.in27 = getelementptr inbounds i8, ptr %1, i64 %i.b
  %.028 = load i8, ptr %.0.in27, align 1, !tbaa !51 ; 2 uses
  %indvars.iv.next29 = add nsw i64 %i.b, 1        ; 2 uses
  %i.c = trunc nsw i64 %indvars.iv.next29 to i32
  %.not30 = icmp eq i32 %2, %i.c
  br i1 %.not30, label %.preheader._crit_edge, label %.lr.ph

.preheader:                                       ; preds = %.lr.ph
  %.0.in = getelementptr inbounds i8, ptr %1, i64 %indvars.iv.next32
  %.0 = load i8, ptr %.0.in, align 1, !tbaa !51   ; 2 uses
  %indvars.iv.next = add nsw i64 %indvars.iv.next32, 1 ; 2 uses
  %i.d = trunc nsw i64 %indvars.iv.next to i32
  %.not = icmp eq i32 %2, %i.d
  br i1 %.not, label %.preheader._crit_edge, label %.lr.ph, !llvm.loop !132

.lr.ph:                                           ; preds = %.preheader.preheader, %.preheader
  %indvars.iv.next32 = phi i64 [ %indvars.iv.next, %.preheader ], [ %indvars.iv.next29, %.preheader.preheader ] ; 2 uses
  %.031 = phi i8 [ %.0, %.preheader ], [ %.028, %.preheader.preheader ]
  %i.e = zext i8 %.031 to i32
  %i.f = tail call noundef i32 @_ZN6icu_789BytesTrie4nextEi(ptr noundef nonnull align 8 dereferenceable(28) %0, i32 noundef %i.e)
  %i.g = and i32 %i.f, 1
  %.not17 = icmp eq i32 %i.g, 0
  br i1 %.not17, label %.loopexit, label %.preheader, !llvm.loop !132

.preheader._crit_edge:                            ; preds = %.preheader, %.preheader.preheader
  %.0.lcssa = phi i8 [ %.028, %.preheader.preheader ], [ %.0, %.preheader ]
  %i.h = or i8 %.0.lcssa, -128
  %i.i = zext i8 %i.h to i32
  br label %bb.b

bb.b:                                             ; preds = %bb.a, %.preheader._crit_edge
  %.sink = phi i32 [ %i.i, %.preheader._crit_edge ], [ 42, %bb.a ]
  %i.j = tail call noundef i32 @_ZN6icu_789BytesTrie4nextEi(ptr noundef nonnull align 8 dereferenceable(28) %0, i32 noundef %.sink)
...
bb.m:                                             ; preds = %bb.a, %bb.l, %bb.k, %bb.f
  %.2 = phi i32 [ %i.ar, %bb.l ], [ %.0.a, %bb.f ], [ %.1, %bb.k ], [ -4, %bb.a ]
  ret i32 %.2
}
