...
.preheader:                                       ; preds = %bb.a, %bb.b
  ...
  %.015 = phi i8 [ %i.f, %bb.b ], [ %i.c, %bb.a ] ; 2 uses
...
.thread:                                          ; preds = %bb.b, %bb.c, %bb.f, %bb.e, %bb.d
  %.221 = phi i32 [ -1, %bb.f ], [ 0, %bb.c ], [ %i.s, %bb.e ], [ 1, %bb.d ], [ -1, %bb.b ]
  ret i32 %.221
}
...
bb.f:                                             ; preds = %bb.e, %bb.d
  ...
  %i.v = or i32 %.030, 1
  %i.w = and i32 %.030, -4
  %.031 = select i1 %i.u, i32 %i.v, i32 %i.w
  br label %bb.m
...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  %.1 = phi i32 [ %i.ae, %bb.i ], [ %i.ah, %bb.j ]
  %.0 = phi i32 [ %i.ad, %bb.i ], [ %i.af, %bb.j ]
...
bb.m:                                             ; preds = %bb.a, %bb.l, %bb.k, %bb.f
  %.2 = phi i32 [ %i.ar, %bb.l ], [ %.031, %bb.f ], [ %.132, %bb.k ], [ -4, %bb.a ]
  ret i32 %.2
}
...
.preheader.i:                                     ; preds = %bb.d, %.noexc
  ...
  %.015.i = phi i8 [ %i.aa, %.noexc ], [ %i.p, %bb.d ] ; 2 uses
...
.preheader.i31:                                   ; preds = %bb.g, %.noexc40
  ...
  %.015.i33 = phi i8 [ %i.ap, %.noexc40 ], [ %i.l, %bb.g ] ; 2 uses
...
bb.j:                                             ; preds = %_ZN6icu_7813LikelySubtags8trieNextERNS_9BytesTrieEPKci.exit.thread.thread, %_ZN6icu_7813LikelySubtags8trieNextERNS_9BytesTrieEPKci.exit.thread, %.thread
  %.02376 = phi i64 [ 0, %.thread ], [ %i.by, %_ZN6icu_7813LikelySubtags8trieNextERNS_9BytesTrieEPKci.exit.thread ], [ %i.bo, %_ZN6icu_7813LikelySubtags8trieNextERNS_9BytesTrieEPKci.exit.thread.thread ] ; 3 uses
...
.preheader.i44:                                   ; preds = %bb.j, %.noexc53
  ...
  %.015.i46 = phi i8 [ %i.cc, %.noexc53 ], [ %i.bz, %bb.j ] ; 2 uses
