...
.outer:                                           ; preds = %bb.af, %bb.a
  %.027.ph = phi ptr [ %i.dd, %bb.af ], [ %1, %bb.a ]
  %.025.ph = phi i32 [ %i.cz, %bb.af ], [ 0, %bb.a ] ; 3 uses
  %.0.ph = phi i32 [ %i.cy, %bb.af ], [ 0, %bb.a ] ; 2 uses
  br label %bb.b
...
bb.c:                                             ; preds = %bb.e, %bb.b
  ...
  %i.n = load i16, ptr %.128, align 2, !tbaa !11  ; 3 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  br i1 %switch122130.i, label %.critedge.i, label %bb.h
...
.preheader:                                       ; preds = %bb.j, %bb.i, %bb.f
  %.3.i.ph = phi ptr [ %i.ah, %bb.j ], [ %i.t, %bb.i ], [ %i.t, %bb.f ]
  br label %bb.k

bb.k:                                             ; preds = %.backedge, %.preheader
  %.3.i = phi ptr [ %.3.i.ph, %.preheader ], [ %.3.i.be, %.backedge ] ; 8 uses
  %i.ai = load i16, ptr %.3.i, align 2, !tbaa !11 ; 4 uses
  switch i16 %i.ai, label %.loopexit.i [
...
bb.m:                                             ; preds = %.critedge2.i
  ...
  store i16 %i.at, ptr %i.e, align 2, !tbaa !16
  %i.au = shl i32 %i.as, 4
  %i.av = getelementptr inbounds nuw i8, ptr %.3.i, i64 8
  %i.aw = load i16, ptr %i.ap, align 2, !tbaa !11
  ...
  store i16 %i.az, ptr %i.e, align 2, !tbaa !16
  %i.ba = shl i32 %i.ay, 4
  %i.bb = load i16, ptr %i.av, align 2, !tbaa !11
  %i.bc = call noundef i32 @_Z18ufmt_digitvalue_78Ds(i16 noundef zeroext %i.bb)
  %i.bd = add i32 %i.bc, %i.ba
  %i.be = trunc i32 %i.bd to i16
  store i16 %i.be, ptr %i.e, align 2, !tbaa !16
  %i.bf = getelementptr inbounds nuw i8, ptr %.3.i, i64 12
  br label %.backedge

.backedge:                                        ; preds = %bb.m, %bb.l, %.critedge2.i
  %.3.i.be = phi ptr [ %i.aj, %.critedge2.i ], [ %i.aj, %bb.l ], [ %i.bf, %bb.m ]
  br label %bb.k, !llvm.loop !49

bb.n:                                             ; preds = %bb.k, %bb.k, %bb.k, %bb.k, %bb.k, %bb.k, %bb.k, %bb.k, %bb.k, %bb.k
...
.critedge4.i:                                     ; preds = %bb.n, %.critedge4.i
  ...
  %.5138.i = phi ptr [ %.5.i, %.critedge4.i ], [ %.5134.i, %bb.n ]
  %storemerge118137.i = phi i32 [ %i.bn, %.critedge4.i ], [ %i.bh, %bb.n ]
  ...
  %i.bo = load i16, ptr %.5.i, align 2, !tbaa !11 ; 3 uses
...
bb.o:                                             ; preds = %.loopexit.i, %.loopexit.i, %.loopexit.i
...
bb.t:                                             ; preds = %bb.o
  store i8 1, ptr %i.g, align 1, !tbaa !22
  br label %_ZL18u_scanf_parse_specPKDsP12u_scanf_spec.exit

_ZL18u_scanf_parse_specPKDsP12u_scanf_spec.exit:  ; preds = %.loopexit.i, %bb.o, %bb.p, %bb.r, %bb.s, %bb.t
  %.7.i = phi ptr [ %i.bp, %bb.o ], [ %i.bp, %bb.p ], [ %i.bs, %bb.r ], [ %i.bp, %bb.s ], [ %i.bp, %bb.t ], [ %.6.i, %.loopexit.i ] ; 2 uses
  %i.bt = getelementptr inbounds nuw i8, ptr %.7.i, i64 2
  %i.bu = load i16, ptr %.7.i, align 2, !tbaa !11 ; 2 uses
  store i16 %i.bu, ptr %i.d, align 4, !tbaa !15
  %i.bv = ptrtoint ptr %i.bt to i64
  %i.bw = ptrtoint ptr %.128 to i64
  %i.bx = sub i64 %i.bv, %i.bw                    ; 2 uses
  %i.by = lshr exact i64 %i.bx, 1
  %i.bz = trunc i64 %i.by to i32
  store i32 %i.bz, ptr %i.a, align 4, !tbaa !9
  ...
  br i1 %i.cd, label %bb.u, label %.backedge73

bb.u:                                             ; preds = %_ZL18u_scanf_parse_specPKDsP12u_scanf_spec.exit
  %i.ce = zext nneg i16 %i.cc to i64
  %i.cf = getelementptr inbounds nuw [16 x i8], ptr @_ZL15g_u_scanf_infos, i64 %i.ce ; 2 uses
  %i.cg = load i32, ptr %i.cf, align 16, !tbaa !56
...
bb.v:                                             ; preds = %bb.u
  ...
  br i1 %.not37, label %bb.w, label %.loopexit

bb.w:                                             ; preds = %bb.v, %bb.u
  %i.ci = load i8, ptr %i.f, align 4, !tbaa !57
  %.not38 = icmp eq i8 %i.ci, 0
  br i1 %.not38, label %bb.x, label %bb.ad
...
bb.y:                                             ; preds = %bb.x
  store i32 %.0.ph, ptr %4, align 4, !tbaa !58
  br label %bb.z

bb.z:                                             ; preds = %bb.y, %bb.x, %bb.x, %bb.x, %bb.x, %bb.x, %bb.x, %bb.x, %bb.x
...
bb.ac:                                            ; preds = %bb.ab, %bb.aa
  %i.cr = phi ptr [ %i.cn, %bb.aa ], [ %i.cp, %bb.ab ]
  %i.cs = load ptr, ptr %i.cr, align 8, !tbaa !24
  br label %bb.ad

bb.ad:                                            ; preds = %bb.x, %bb.w, %bb.ac
  %.sink = phi ptr [ %i.cs, %bb.ac ], [ null, %bb.w ], [ null, %bb.x ]
  store ptr %.sink, ptr %3, align 8, !tbaa !25
  %i.ct = getelementptr inbounds nuw i8, ptr %i.cf, i64 8
  %i.cu = load ptr, ptr %i.ct, align 8, !tbaa !59 ; 2 uses
  %.not39 = icmp eq ptr %i.cu, null
  br i1 %.not39, label %.backedge73, label %bb.ae

.backedge73:                                      ; preds = %bb.ad, %_ZL18u_scanf_parse_specPKDsP12u_scanf_spec.exit
  br label %bb.b, !llvm.loop !51
...
bb.af:                                            ; preds = %bb.ae
  ...
  %i.da = load i32, ptr %i.a, align 4, !tbaa !9
  %i.db = sext i32 %i.da to i64
  %i.dc = getelementptr [2 x i8], ptr %i.cb, i64 %i.db
  %i.dd = getelementptr i8, ptr %i.dc, i64 -2
  br label %.outer, !llvm.loop !51

.loopexit:                                        ; preds = %bb.ae, %bb.v, %.critedge
  %.2 = phi i32 [ %.025.ph, %bb.v ], [ %.025.ph, %.critedge ], [ -1, %bb.ae ]
