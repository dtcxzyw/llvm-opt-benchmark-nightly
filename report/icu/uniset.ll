...
._crit_edge._crit_edge:                           ; preds = %._crit_edge, %bb.h
  ...
  store i32 1114112, ptr %i.cg, align 4, !tbaa !37
  br label %bb.i
...
bb.a:
  %i.a = load i32, ptr %3, align 4, !tbaa !40
...
bb.g:                                             ; preds = %bb.f
  store i16 0, ptr %1, align 2, !tbaa !57
  br label %.loopexit
...
bb.i:                                             ; preds = %bb.e
  ...
  %i.k = load ptr, ptr %i.j, align 8, !tbaa !31   ; 7 uses
...
bb.j:                                             ; preds = %bb.i
  %i.q = load i32, ptr %i.k, align 4, !tbaa !37
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %next.gep88, align 4, !tbaa !37
  %wide.load89 = load <4 x i32>, ptr %i.as, align 4, !tbaa !37
  %i.at = trunc <4 x i32> %wide.load to <4 x i16>
  %i.au = trunc <4 x i32> %wide.load89 to <4 x i16>
  %i.av = getelementptr i8, ptr %next.gep, i64 8
  store <4 x i16> %i.at, ptr %next.gep, align 2, !tbaa !57
  store <4 x i16> %i.au, ptr %i.av, align 2, !tbaa !57
...
vector.body96:                                    ; preds = %vector.body96, %vector.ph94
  ...
  %wide.load101 = load <4 x i32>, ptr %next.gep98, align 4, !tbaa !37 ; 2 uses
  %wide.load102 = load <4 x i32>, ptr %i.bk, align 4, !tbaa !37 ; 2 uses
  ...
  store <8 x i16> %interleaved.vec, ptr %next.gep99, align 2, !tbaa !57
  ...
  store <8 x i16> %interleaved.vec103, ptr %next.gep100, align 2, !tbaa !57
  %index.next104 = add nuw i64 %index97, 8        ; 2 uses
  %i.bp = icmp eq i64 %index.next104, %n.vec95
  br i1 %i.bp, label %middle.block105, label %vector.body96, !llvm.loop !83
...
.lr.ph69:                                         ; preds = %.lr.ph69.preheader111, %.lr.ph69
  ...
  %i.br = load i32, ptr %.05066, align 4, !tbaa !37
  %i.bs = trunc i32 %i.br to i16
  store i16 %i.bs, ptr %.15768, align 2, !tbaa !57
  ...
  br i1 %exitcond80.not, label %.preheader, label %.lr.ph69, !llvm.loop !84
...
.lr.ph76:                                         ; preds = %.lr.ph76.preheader110, %.lr.ph76
  ...
  store i16 %i.bz, ptr %i.bx, align 2, !tbaa !57
  %i.cb = add nuw nsw i32 %.175, 2                ; 2 uses
  %i.cc = icmp slt i32 %i.cb, %.052
  br i1 %i.cc, label %.lr.ph76, label %.loopexit, !llvm.loop !85
...
bb.h:                                             ; preds = %bb.g
  ...
  store i32 1114112, ptr %i.q, align 4, !tbaa !37
