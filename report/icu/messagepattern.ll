...
.lr.ph.split.i:                                   ; preds = %_ZNK6icu_7814MessagePattern4PartneERKS1_.exit.thread11.i, %.lr.ph.split.preheader.i
  ...
  %i.ay = load i32, ptr %i.aw, align 4, !tbaa !50
  %i.az = load i32, ptr %i.ax, align 4, !tbaa !50
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.bh = load i16, ptr %i.bg, align 4, !tbaa !52
  %i.bi = getelementptr inbounds nuw i8, ptr %i.ax, i64 8
  %i.bj = load i16, ptr %i.bi, align 4, !tbaa !52
...
_ZNK6icu_7814MessagePattern4PartneERKS1_.exit.i:  ; preds = %bb.i
  ...
  %i.bt = load i32, ptr %i.bs, align 4, !tbaa !54
...
_ZNK6icu_7814MessagePattern4PartneERKS1_.exit.thread11.i: ; preds = %_ZNK6icu_7814MessagePattern4PartneERKS1_.exit.i
  ...
  br i1 %exitcond.not.i, label %_ZNK6icu_7813UnicodeStringeqERKS0_.exit.thread, label %.lr.ph.split.i, !llvm.loop !63
...
bb.a:
  ...
  %i.i = load i32, ptr %i.h, align 8, !tbaa !35   ; 5 uses
...
bb.b:                                             ; preds = %bb.b, %.lr.ph.new
  ...
  %i.al = load i16, ptr %i.ak, align 4, !tbaa !52
  %i.am = zext i16 %i.al to i32
  %i.an = getelementptr inbounds nuw i8, ptr %i.ad, i64 10
  %i.ao = load i16, ptr %i.an, align 2, !tbaa !53
  ...
  %i.bb = load i16, ptr %i.ba, align 4, !tbaa !52
  %i.bc = zext i16 %i.bb to i32
  %i.bd = getelementptr inbounds nuw i8, ptr %i.as, i64 26
  %i.be = load i16, ptr %i.bd, align 2, !tbaa !53
  ...
  br i1 %niter.ncmp.1, label %._crit_edge.loopexit.unr-lcssa, label %bb.b, !llvm.loop !64
}
...
bb.a:
  ...
  %i.b = load i16, ptr %i.a, align 8, !tbaa !22   ; 4 uses
  %i.c = and i16 %i.b, 17
...
bb.e:                                             ; preds = %_ZNK6icu_7813UnicodeString9getBufferEv.exit
  %i.o = load i16, ptr %i.a, align 8, !tbaa !22
...
_ZNK6icu_7813UnicodeString6charAtEi.exit.i:       ; preds = %bb.f
  ...
  %i.ac = load i16, ptr %i.ab, align 2, !tbaa !34 ; 3 uses
...
_ZNK6icu_7813UnicodeString6charAtEi.exit39.i:     ; preds = %.lr.ph.split.i
  ...
  %i.ar = load i16, ptr %i.aq, align 2, !tbaa !34 ; 2 uses
...
.lr.ph.split.us:                                  ; preds = %.lr.ph, %bb.g
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %bb.g ], [ %3, %.lr.ph ] ; 3 uses
  ...
  %i.y = trunc nsw i64 %indvars.iv56 to i32
  %i.z = icmp ugt i32 %i.i, %i.y
  br i1 %i.z, label %_ZNK6icu_7813UnicodeString6charAtEi.exit39.us, label %.thread

_ZNK6icu_7813UnicodeString6charAtEi.exit39.us:    ; preds = %.lr.ph.split.us
  %i.aa = getelementptr inbounds [2 x i8], ptr %i.n, i64 %indvars.iv56
  %i.ab = load i16, ptr %i.aa, align 2, !tbaa !34 ; 2 uses
  %i.ac = add i16 %i.ab, -48
  %or.cond5.us = icmp ult i16 %i.ac, 10
...
bb.g:                                             ; preds = %_ZNK6icu_7813UnicodeString6charAtEi.exit39.us
  ...
  %i.ae = icmp sgt i32 %.12749.us, 214748363      ; 2 uses
  %i.af = mul nsw i32 %.12749.us, 10
  %i.ag = add i32 %i.af, -48
  %i.ah = add i32 %i.ag, %i.ad
  %.228.us = select i1 %i.ae, i32 %.12749.us, i32 %i.ah ; 2 uses
  %.2.us = select i1 %i.ae, i8 1, i8 %.150.us     ; 2 uses
  %lftr.wideiv58 = trunc i64 %indvars.iv.next57 to i32
  %exitcond59.not = icmp eq i32 %2, %lftr.wideiv58
  br i1 %exitcond59.not, label %._crit_edge, label %.lr.ph.split.us, !llvm.loop !0

.lr.ph.split:                                     ; preds = %.lr.ph, %bb.h
  %indvars.iv = phi i64 [ %indvars.iv.next, %bb.h ], [ %3, %.lr.ph ] ; 3 uses
  %.150 = phi i8 [ %.2, %bb.h ], [ %.0, %.lr.ph ]
  %.12749 = phi i32 [ %.228, %bb.h ], [ %.026, %.lr.ph ] ; 3 uses
  %indvars.iv.next = add nsw i64 %indvars.iv, 1   ; 2 uses
  %i.ai = trunc nsw i64 %indvars.iv to i32
  %i.aj = icmp ugt i32 %i.i, %i.ai
  br i1 %i.aj, label %_ZNK6icu_7813UnicodeString6charAtEi.exit39, label %.thread

_ZNK6icu_7813UnicodeString6charAtEi.exit39:       ; preds = %.lr.ph.split
  %i.ak = getelementptr inbounds [2 x i8], ptr %i.l, i64 %indvars.iv
  %i.al = load i16, ptr %i.ak, align 2, !tbaa !34 ; 2 uses
  %i.am = add i16 %i.al, -48
  %or.cond5 = icmp ult i16 %i.am, 10
  br i1 %or.cond5, label %bb.h, label %.thread

bb.h:                                             ; preds = %_ZNK6icu_7813UnicodeString6charAtEi.exit39
  %i.an = zext nneg i16 %i.al to i32
  %i.ao = icmp sgt i32 %.12749, 214748363         ; 2 uses
  %i.ap = mul nsw i32 %.12749, 10
  %i.aq = add i32 %i.ap, -48
  %i.ar = add i32 %i.aq, %i.an
  %.228 = select i1 %i.ao, i32 %.12749, i32 %i.ar ; 2 uses
  %.2 = select i1 %i.ao, i8 1, i8 %.150           ; 2 uses
...
bb.a:
  ...
  %i.c = load i8, ptr %i.b, align 2, !tbaa !42
...
bb.c:                                             ; preds = %.lr.ph, %bb.f
  ...
  %indvars.iv.next = add nsw i64 %indvars.iv, -1  ; 2 uses
  %i.j = load ptr, ptr %i.h, align 8, !tbaa !29
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.q = load i16, ptr %i.p, align 2, !tbaa !53
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a)
  store i16 %i.q, ptr %i.a, align 2, !tbaa !34
...
bb.f:                                             ; preds = %_ZN6icu_7813UnicodeString6insertEiDs.exit, %bb.c
  ...
  br i1 %i.t, label %bb.c, label %.loopexit, !llvm.loop !65
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.c = load i16, ptr %i.b, align 2, !tbaa !53
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.h = load i16, ptr %i.g, align 2, !tbaa !53
...
bb.a:
  ...
  %i.e = load i32, ptr %i.d, align 4, !tbaa !50   ; 2 uses
  %i.f = and i32 %i.e, -2
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.i = load i16, ptr %i.h, align 2, !tbaa !53
...
bb.d:                                             ; preds = %bb.b
  ...
  %i.n = load i16, ptr %i.m, align 2, !tbaa !53
