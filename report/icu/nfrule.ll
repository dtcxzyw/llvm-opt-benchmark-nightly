Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/icu/original/nfrule?download=true
...
begin_hunk_0_@_ZN6icu_786NFRule12setBaseValueElR10UErrorCode:bb.a
  ...
  store i32 10, ptr %i.a, align 8, !tbaa !20
...
_ZNK6icu_786NFRule16expectedExponentEv.exit:      ; preds = %bb.a
  ...
  %i.d = tail call double @uprv_log_78(double noundef %i.c)
  %i.e = load i32, ptr %i.a, align 8, !tbaa !20
  %i.f = sitofp i32 %i.e to double
  %i.g = tail call double @uprv_log_78(double noundef %i.f)
  %i.h = fdiv double %i.d, %i.g
  %i.i = fptosi double %i.h to i16                ; 2 uses
  %i.j = load i32, ptr %i.a, align 8, !tbaa !20
  %i.k = add i16 %i.i, 1                          ; 2 uses
  %i.l = tail call noundef i64 @_ZN6icu_7810util64_powEjt(i32 noundef %i.j, i16 noundef zeroext %i.k)
  %i.m = load i64, ptr %0, align 8, !tbaa !19
  ...
  store i16 %spec.select.i, ptr %i.n, align 4, !tbaa !21
  %i.o = getelementptr inbounds nuw i8, ptr %0, i64 80
  %i.p = load ptr, ptr %i.o, align 8, !tbaa !36   ; 3 uses
  %.not = icmp eq ptr %i.p, null
  br i1 %.not, label %bb.c, label %bb.b

bb.b:                                             ; preds = %_ZNK6icu_786NFRule16expectedExponentEv.exit
  %i.q = load i32, ptr %i.a, align 8, !tbaa !20
  %i.r = load ptr, ptr %i.p, align 8, !tbaa !27
  %i.s = getelementptr inbounds nuw i8, ptr %i.r, i64 32
  %i.t = load ptr, ptr %i.s, align 8
  tail call void %i.t(ptr noundef nonnull align 8 dereferenceable(32) %i.p, i32 noundef %i.q, i16 noundef signext %spec.select.i, ptr noundef nonnull align 4 dereferenceable(4) %2)
  br label %bb.c
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.x = load i16, ptr %i.n, align 4, !tbaa !21
  %i.y = load ptr, ptr %i.v, align 8, !tbaa !27
  %i.z = getelementptr inbounds nuw i8, ptr %i.y, i64 32
  %i.aa = load ptr, ptr %i.z, align 8
  tail call void %i.aa(ptr noundef nonnull align 8 dereferenceable(32) %i.v, i32 noundef %i.w, i16 noundef signext %i.x, ptr noundef nonnull align 4 dereferenceable(4) %2)
  br label %bb.f

bb.e:                                             ; preds = %bb.a
  %i.ab = getelementptr inbounds nuw i8, ptr %0, i64 12
  store i16 0, ptr %i.ab, align 4, !tbaa !21
  br label %bb.f
...
define noundef signext i16 @_ZNK6icu_786NFRule16expectedExponentEv(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(112) %0) local_unnamed_addr #0 align 2 {
bb.a:
...
bb.b:                                             ; preds = %bb.a
  %i.d = load i64, ptr %0, align 8, !tbaa !19     ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.g = tail call double @uprv_log_78(double noundef %i.f)
  %i.h = load i32, ptr %i.a, align 8, !tbaa !20
  %i.i = sitofp i32 %i.h to double
  %i.j = tail call double @uprv_log_78(double noundef %i.i)
  %i.k = fdiv double %i.g, %i.j
  %i.l = fptosi double %i.k to i16                ; 2 uses
  %i.m = load i32, ptr %i.a, align 8, !tbaa !20
  %i.n = add i16 %i.l, 1                          ; 2 uses
  %i.o = tail call noundef i64 @_ZN6icu_7810util64_powEjt(i32 noundef %i.m, i16 noundef zeroext %i.n)
  %i.p = load i64, ptr %0, align 8, !tbaa !19
...
define linkonce_odr noundef signext i8 @_ZNK6icu_7813UnicodeString7compareENS_14ConstChar16PtrEi(ptr noundef nonnull align 8 dereferenceable(64) %0, ptr noundef align 8 %1, i32 noundef %2) local_unnamed_addr #5 comdat align 2 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.b = load i16, ptr %i.a, align 8, !tbaa !25   ; 2 uses
...
; Function Attrs: mustprogress uwtable
define noundef ptr @_ZN6icu_786NFRule19extractSubstitutionEPKNS_9NFRuleSetEPKS0_R10UErrorCode(ptr noundef nonnull align 8 dereferenceable(112) %0, ptr noundef %1, ptr noundef %2, ptr noundef nonnull align 4 dereferenceable(4) %3) local_unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
...
bb.b:                                             ; preds = %bb.a
  ...
  %.pre.i = load i16, ptr %.phi.trans.insert.i, align 8, !tbaa !25 ; 2 uses
  ...
  %i.k = tail call noundef i32 @_ZNK6icu_7813UnicodeString7indexOfEPKDsiiii(ptr noundef nonnull align 8 dereferenceable(64) %i.c, ptr noundef nonnull @_ZN6icu_78L22gGreaterGreaterGreaterE, i32 noundef 0, i32 noundef 3, i32 noundef %spec.select.i, i32 noundef %i.j)
...
bb.d:                                             ; preds = %bb.b
  %i.n = load i16, ptr %.phi.trans.insert.i, align 8, !tbaa !25 ; 3 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.ab = load i16, ptr %i.aa, align 2, !tbaa !28
...
_ZNK6icu_7813UnicodeString6charAtEi.exit:         ; preds = %bb.d, %bb.e
  ...
  %spec.select.i34 = tail call i32 @llvm.smin.i32(i32 %i.ac, i32 %i.s)
  %.0.i = select i1 %i.ad, i32 0, i32 %spec.select.i34 ; 2 uses
  %i.ae = sub nsw i32 %i.s, %.0.i
  %i.af = tail call noundef i32 @_ZNK6icu_7813UnicodeString9doIndexOfEDsii(ptr noundef nonnull align 8 dereferenceable(64) %i.c, i16 noundef zeroext %.0.i.i, i32 noundef %.0.i, i32 noundef %i.ae) ; 7 uses
  %i.ag = icmp eq i16 %.0.i.i, 60
  %i.ah = icmp ne i32 %i.af, -1
  %or.cond = and i1 %i.ag, %i.ah
  br i1 %or.cond, label %bb.f, label %_ZNK6icu_7813UnicodeString6charAtEi.exit37.thread

bb.f:                                             ; preds = %_ZNK6icu_7813UnicodeString6charAtEi.exit
  %i.ai = load i16, ptr %.phi.trans.insert.i, align 8, !tbaa !25 ; 3 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  br i1 %i.ar, label %_ZNK6icu_7813UnicodeString6charAtEi.exit37, label %_ZNK6icu_7813UnicodeString6charAtEi.exit37.thread

_ZNK6icu_7813UnicodeString6charAtEi.exit37:       ; preds = %bb.g
  %i.as = and i16 %i.ai, 2
  %.not.i.i.i36 = icmp eq i16 %i.as, 0
  %i.at = getelementptr inbounds nuw i8, ptr %0, i64 26
  %i.au = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.av = load ptr, ptr %i.au, align 8
  %i.aw = select i1 %.not.i.i.i36, ptr %i.av, ptr %i.at
...
.thread:                                          ; preds = %_ZNK6icu_7813UnicodeString6charAtEi.exit37, %bb.f, %_ZNK6icu_7813UnicodeString6charAtEi.exit37.thread
  ...
  store i16 2, ptr %i.bc, align 8, !tbaa !25
  %reass.sub = sub i32 %.143, %i.a
...
.noexc:                                           ; preds = %.thread
  %i.be = load i16, ptr %i.bc, align 8, !tbaa !25 ; 2 uses
  ...
  %i.bl = invoke noundef nonnull align 8 dereferenceable(64) ptr @_ZN6icu_7813UnicodeString9doReplaceEiiRKS0_ii(ptr noundef nonnull align 8 dereferenceable(64) %4, i32 noundef 0, i32 noundef %i.bk, ptr noundef nonnull align 8 dereferenceable(64) %i.c, i32 noundef %i.a, i32 noundef %i.bd)
          to label %_ZN6icu_7813UnicodeString5setToERKS0_ii.exit unwind label %bb.i ; 0 uses

_ZN6icu_7813UnicodeString5setToERKS0_ii.exit:     ; preds = %.noexc
  %i.bm = getelementptr inbounds nuw i8, ptr %0, i64 96
  %i.bn = load ptr, ptr %i.bm, align 8, !tbaa !23
  %i.bo = invoke noundef ptr @_ZN6icu_7814NFSubstitution16makeSubstitutionEiPKNS_6NFRuleES3_PKNS_9NFRuleSetEPKNS_21RuleBasedNumberFormatERKNS_13UnicodeStringER10UErrorCode(i32 noundef %i.a, ptr noundef nonnull %0, ptr noundef %2, ptr noundef %1, ptr noundef %i.bn, ptr noundef nonnull align 8 dereferenceable(64) %4, ptr noundef nonnull align 4 dereferenceable(4) %3)
          to label %bb.h unwind label %bb.i

bb.h:                                             ; preds = %_ZN6icu_7813UnicodeString5setToERKS0_ii.exit
  %i.bp = invoke noundef nonnull align 8 dereferenceable(64) ptr @_ZN6icu_7813UnicodeString9doReplaceEiiPKDsii(ptr noundef nonnull align 8 dereferenceable(64) %i.c, i32 noundef %i.a, i32 noundef %i.bd, ptr noundef null, i32 noundef 0, i32 noundef 0)
          to label %_ZN6icu_7813UnicodeString13removeBetweenEii.exit unwind label %bb.i ; 0 uses

_ZN6icu_7813UnicodeString13removeBetweenEii.exit: ; preds = %bb.h
  call void @_ZN6icu_7813UnicodeStringD1Ev(ptr noundef nonnull align 8 dead_on_return(64) dereferenceable(64) %4) #9
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #9
  br label %bb.j

bb.i:                                             ; preds = %bb.h, %.noexc, %.thread, %_ZN6icu_7813UnicodeString5setToERKS0_ii.exit
...
bb.j:                                             ; preds = %_ZNK6icu_7813UnicodeString6charAtEi.exit37.thread, %bb.a, %_ZN6icu_7813UnicodeString13removeBetweenEii.exit
  %.0 = phi ptr [ %i.bo, %_ZN6icu_7813UnicodeString13removeBetweenEii.exit ], [ null, %bb.a ], [ null, %_ZNK6icu_7813UnicodeString6charAtEi.exit37.thread ]
  ret ptr %.0
}
...
; Function Attrs: mustprogress uwtable
define noundef i32 @_ZNK6icu_786NFRule20indexOfAnyRulePrefixEv(ptr noundef nonnull align 8 dereferenceable(112) %0) local_unnamed_addr #0 align 2 {
bb.a:
  ...
  %i.d = load i16, ptr %i.b, align 8, !tbaa !25   ; 2 uses
  %i.e = icmp slt i16 %i.d, 0
  %i.f = ashr i16 %i.d, 5
  %i.g = sext i16 %i.f to i32
  %i.h = load i32, ptr %i.c, align 4
  %i.i = select i1 %i.e, i32 %i.h, i32 %i.g
  %i.j = tail call noundef i32 @_ZNK6icu_7813UnicodeString9doIndexOfEDsii(ptr noundef nonnull align 8 dereferenceable(64) %i.a, i16 noundef zeroext 60, i32 noundef 0, i32 noundef %i.i) ; 3 uses
  %i.k = load i16, ptr %i.b, align 8, !tbaa !25   ; 2 uses
  %i.l = icmp slt i16 %i.k, 0
  %i.m = ashr i16 %i.k, 5
  %i.n = sext i16 %i.m to i32
  %i.o = load i32, ptr %i.c, align 4
  %i.p = select i1 %i.l, i32 %i.o, i32 %i.n
  %i.q = tail call noundef i32 @_ZNK6icu_7813UnicodeString9doIndexOfEDsii(ptr noundef nonnull align 8 dereferenceable(64) %i.a, i16 noundef zeroext 60, i32 noundef 0, i32 noundef %i.p) ; 3 uses
  ...
  %i.t = load i16, ptr %i.b, align 8, !tbaa !25   ; 2 uses
  %i.u = icmp slt i16 %i.t, 0
  %i.v = ashr i16 %i.t, 5
  %i.w = sext i16 %i.v to i32
  %i.x = load i32, ptr %i.c, align 4
  %i.y = select i1 %i.u, i32 %i.x, i32 %i.w
  %i.z = tail call noundef i32 @_ZNK6icu_7813UnicodeString9doIndexOfEDsii(ptr noundef nonnull align 8 dereferenceable(64) %i.a, i16 noundef zeroext 60, i32 noundef 0, i32 noundef %i.y) ; 3 uses
  ...
  %i.ac = load i16, ptr %i.b, align 8, !tbaa !25  ; 2 uses
  ...
  %i.ai = tail call noundef i32 @_ZNK6icu_7813UnicodeString9doIndexOfEDsii(ptr noundef nonnull align 8 dereferenceable(64) %i.a, i16 noundef zeroext 60, i32 noundef 0, i32 noundef %i.ah) ; 3 uses
  ...
  %i.al = load i16, ptr %i.b, align 8, !tbaa !25  ; 2 uses
  ...
  %i.ar = tail call noundef i32 @_ZNK6icu_7813UnicodeString9doIndexOfEDsii(ptr noundef nonnull align 8 dereferenceable(64) %i.a, i16 noundef zeroext 62, i32 noundef 0, i32 noundef %i.aq) ; 3 uses
  ...
  %i.au = load i16, ptr %i.b, align 8, !tbaa !25  ; 2 uses
  ...
  %i.ba = tail call noundef i32 @_ZNK6icu_7813UnicodeString9doIndexOfEDsii(ptr noundef nonnull align 8 dereferenceable(64) %i.a, i16 noundef zeroext 62, i32 noundef 0, i32 noundef %i.az) ; 3 uses
  ...
  %i.bd = load i16, ptr %i.b, align 8, !tbaa !25  ; 2 uses
  ...
  %i.bj = tail call noundef i32 @_ZNK6icu_7813UnicodeString9doIndexOfEDsii(ptr noundef nonnull align 8 dereferenceable(64) %i.a, i16 noundef zeroext 62, i32 noundef 0, i32 noundef %i.bi) ; 3 uses
  ...
  %i.bm = load i16, ptr %i.b, align 8, !tbaa !25  ; 2 uses
  ...
  %i.bs = tail call noundef i32 @_ZNK6icu_7813UnicodeString9doIndexOfEDsii(ptr noundef nonnull align 8 dereferenceable(64) %i.a, i16 noundef zeroext 62, i32 noundef 0, i32 noundef %i.br) ; 3 uses
  ...
  %i.bv = load i16, ptr %i.b, align 8, !tbaa !25  ; 2 uses
  ...
  %i.cb = tail call noundef i32 @_ZNK6icu_7813UnicodeString9doIndexOfEDsii(ptr noundef nonnull align 8 dereferenceable(64) %i.a, i16 noundef zeroext 61, i32 noundef 0, i32 noundef %i.ca) ; 3 uses
  ...
  %i.ce = load i16, ptr %i.b, align 8, !tbaa !25  ; 2 uses
  ...
  %i.ck = tail call noundef i32 @_ZNK6icu_7813UnicodeString9doIndexOfEDsii(ptr noundef nonnull align 8 dereferenceable(64) %i.a, i16 noundef zeroext 61, i32 noundef 0, i32 noundef %i.cj) ; 3 uses
  ...
  %i.cn = load i16, ptr %i.b, align 8, !tbaa !25  ; 2 uses
  ...
  %i.ct = tail call noundef i32 @_ZNK6icu_7813UnicodeString9doIndexOfEDsii(ptr noundef nonnull align 8 dereferenceable(64) %i.a, i16 noundef zeroext 61, i32 noundef 0, i32 noundef %i.cs) ; 3 uses
...
; Function Attrs: mustprogress uwtable
define noundef zeroext i1 @_ZNK6icu_786NFRuleeqERKS0_(ptr noundef nonnull align 8 dereferenceable(112) %0, ptr noundef nonnull align 8 dereferenceable(112) %1) local_unnamed_addr #0 align 2 {
bb.a:
  %i.a = load i64, ptr %0, align 8, !tbaa !19
  %i.b = load i64, ptr %1, align 8, !tbaa !19
