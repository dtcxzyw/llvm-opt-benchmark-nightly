...
.lr.ph:                                           ; preds = %.lr.ph.outer, %bb.cl
  %.0128378 = phi i32 [ %i.hi, %bb.cl ], [ %.0128378.ph, %.lr.ph.outer ] ; 7 uses
...
_ZNK6icu_787UVectorixEi.exit:                     ; preds = %.lr.ph
  ...
  %i.er = invoke noundef ptr @uhash_get_78(ptr noundef %i.eq, ptr noundef nonnull align 8 dereferenceable(64) %i.ep)
          to label %_ZNK6icu_789Hashtable3getERKNS_13UnicodeStringE.exit229 unwind label %.loopexit458 ; 2 uses
...
.loopexit458:                                     ; preds = %_ZNK6icu_787UVectorixEi.exit, %bb.cc
  %lpad.loopexit460 = landingpad { ptr, i32 }
          cleanup
  br label %.body259

.loopexit.split-lp459:                            ; preds = %bb.cj, %bb.ck
...
bb.cc:                                            ; preds = %_ZNK6icu_789Hashtable3getERKNS_13UnicodeStringE.exit229
  ...
  %i.gv = invoke noundef ptr @uhash_get_78(ptr noundef %i.gu, ptr noundef nonnull align 8 dereferenceable(64) %i.ep)
          to label %_ZNK6icu_789Hashtable3getERKNS_13UnicodeStringE.exit253 unwind label %.loopexit458 ; 2 uses
...
bb.cd:                                            ; preds = %_ZNK6icu_789Hashtable3getERKNS_13UnicodeStringE.exit253
  ...
  %i.gw = invoke noundef ptr @_ZNK6icu_787UVector9elementAtEi(ptr noundef nonnull align 8 dereferenceable(40) %i.o, i32 noundef %14)
...
bb.cl:                                            ; preds = %_ZNK6icu_789Hashtable3getERKNS_13UnicodeStringE.exit253
  %i.hi = add nsw i32 %.0128378, 2                ; 2 uses
...
.thread450:                                       ; preds = %bb.ck
  ...
  %.not201453 = icmp slt i32 %.0128378, %i.hk
...
.body259:                                         ; preds = %.loopexit458, %.loopexit.split-lp459, %bb.ci, %bb.ch, %12, %bb.bs, %.body235, %bb.bt, %bb.e, %bb.bm
  %.sroa.0272.7 = phi ptr [ %.sroa.0272.0, %bb.ch ], [ %.sroa.0272.0, %bb.ci ], [ %.sroa.0272.0, %.body235 ], [ %.sroa.0272.0, %bb.bt ], [ %.sroa.0272.0, %bb.bs ], [ %.sroa.0272.0, %12 ], [ %.sroa.0272.4, %bb.bm ], [ %.sroa.0272.0, %bb.e ], [ %.sroa.0272.0, %.loopexit458 ], [ %.sroa.0272.0, %.loopexit.split-lp459 ] ; 3 uses
  %.pn197.pn.pn = phi { ptr, i32 } [ %i.he, %bb.ch ], [ %i.hf, %bb.ci ], [ %eh.lpad-body236, %.body235 ], [ %i.fx, %bb.bt ], [ %i.fw, %bb.bs ], [ %13, %12 ], [ %.pn171.pn.pn, %bb.bm ], [ %i.t, %bb.e ], [ %lpad.loopexit460, %.loopexit458 ], [ %lpad.loopexit.split-lp461, %.loopexit.split-lp459 ]
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #18
