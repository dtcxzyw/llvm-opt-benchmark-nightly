...
bb.c:                                             ; preds = %.preheader317, %select.unfold
  %.sroa.0272.0 = phi ptr [ %.sroa.0272.2, %select.unfold ], [ null, %.preheader317 ] ; 37 uses
...
.preheader316.epil.preheader:                     ; preds = %.thread280.loopexit.unr-lcssa, %.preheader316.preheader
  ...
  %lcmp.mod624 = icmp ne i64 %xtraiter, 0
...
.critedge208:                                     ; preds = %.critedge208.preheader, %.thread299.thread455
  %i.eo = phi i32 [ %i.hn, %.thread299.thread455 ], [ %i.r, %.critedge208.preheader ]
  %.not201377 = icmp sgt i32 %i.eo, 0
  br i1 %.not201377, label %.lr.ph.outer, label %.critedge

.lr.ph.outer:                                     ; preds = %.critedge208, %.thread450
  %10 = phi i1 [ false, %.thread450 ], [ true, %.critedge208 ]
  %.0128378.ph = phi i32 [ %.0128378, %.thread450 ], [ 0, %.critedge208 ]
  br label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.outer, %bb.cn
  %.0128378 = phi i32 [ %i.hk, %bb.cn ], [ %.0128378.ph, %.lr.ph.outer ] ; 7 uses
  %i.ep = invoke noundef ptr @_ZNK6icu_787UVector9elementAtEi(ptr noundef nonnull align 8 dereferenceable(40) %i.o, i32 noundef %.0128378)
          to label %_ZNK6icu_787UVectorixEi.exit unwind label %12 ; 3 uses
...
_ZNK6icu_787UVectorixEi.exit:                     ; preds = %.lr.ph
  ...
  %i.er = invoke noundef ptr @uhash_get_78(ptr noundef %i.eq, ptr noundef nonnull align 8 dereferenceable(64) %i.ep)
          to label %_ZNK6icu_789Hashtable3getERKNS_13UnicodeStringE.exit229 unwind label %bb.bs ; 2 uses

_ZNK6icu_789Hashtable3getERKNS_13UnicodeStringE.exit229: ; preds = %_ZNK6icu_787UVectorixEi.exit
  %.not177 = icmp eq ptr %i.er, null
  br i1 %.not177, label %bb.ce, label %bb.bn

bb.bn:                                            ; preds = %_ZNK6icu_789Hashtable3getERKNS_13UnicodeStringE.exit229
  %11 = add nsw i32 %.0128378, 1                  ; 3 uses
  %i.es = invoke noundef ptr @_ZNK6icu_787UVector9elementAtEi(ptr noundef nonnull align 8 dereferenceable(40) %i.o, i32 noundef %11)
          to label %_ZNK6icu_787UVectorixEi.exit230 unwind label %bb.bu ; 3 uses
...
_ZNK6icu_787UVectorixEi.exit230:                  ; preds = %bb.bn
  ...
  %i.eu = invoke noundef ptr @uhash_get_78(ptr noundef %i.et, ptr noundef nonnull align 8 dereferenceable(64) %i.es)
          to label %_ZNK6icu_789Hashtable3getERKNS_13UnicodeStringE.exit231 unwind label %bb.bu
...
bb.bo:                                            ; preds = %_ZNK6icu_789Hashtable3getERKNS_13UnicodeStringE.exit231
  ...
  %i.ex = invoke noundef i32 @uhash_geti_78(ptr noundef %i.ew, ptr noundef nonnull align 8 dereferenceable(64) %i.ep)
          to label %_ZNK6icu_789Hashtable4getiERKNS_13UnicodeStringE.exit unwind label %bb.bv ; 6 uses
...
.preheader:                                       ; preds = %.preheader, %.preheader.preheader.new
  ...
  br i1 %niter630.ncmp.3, label %_ZN6icu_7810LocalArrayINS_13UnicodeStringEEC2EPS1_R10UErrorCode.exit233.unr-lcssa, label %.preheader
...
_ZN6icu_7810LocalArrayINS_13UnicodeStringEEC2EPS1_R10UErrorCode.exit233.unr-lcssa: ; preds = %.preheader
  ...
  br i1 %lcmp.mod627.not, label %_ZN6icu_7810LocalArrayINS_13UnicodeStringEEC2EPS1_R10UErrorCode.exit233, label %.preheader.epil.preheader
...
.preheader.epil.preheader:                        ; preds = %_ZN6icu_7810LocalArrayINS_13UnicodeStringEEC2EPS1_R10UErrorCode.exit233.unr-lcssa, %.preheader.preheader
  ...
  %lcmp.mod628 = icmp ne i64 %xtraiter625, 0
...
.preheader.epil:                                  ; preds = %.preheader.epil, %.preheader.epil.preheader
  ...
  %epil.iter626 = phi i64 [ %epil.iter626.next, %.preheader.epil ], [ 0, %.preheader.epil.preheader ]
  ...
  %epil.iter626.next = add i64 %epil.iter626, 1   ; 2 uses
  %epil.iter626.cmp.not = icmp eq i64 %epil.iter626.next, %xtraiter625
  br i1 %epil.iter626.cmp.not, label %_ZN6icu_7810LocalArrayINS_13UnicodeStringEEC2EPS1_R10UErrorCode.exit233, label %.preheader.epil, !llvm.loop !280
...
_ZN6icu_7810LocalArrayINS_13UnicodeStringEEC2EPS1_R10UErrorCode.exit233: ; preds = %.preheader.epil, %_ZN6icu_7810LocalArrayINS_13UnicodeStringEEC2EPS1_R10UErrorCode.exit233.unr-lcssa
  ...
  br i1 %i.fu, label %bb.bw, label %bb.cd
...
_ZN6icu_7810LocalArrayINS_13UnicodeStringEEC2EPS1_R10UErrorCode.exit233.thread446: ; preds = %bb.bp
  ...
  br i1 %i.fv, label %_ZL14uprv_arrayCopyPKN6icu_7813UnicodeStringEPS0_i.exit, label %bb.cd
...
bb.bs:                                            ; preds = %_ZNK6icu_787UVectorixEi.exit, %bb.ce
  %i.fw = landingpad { ptr, i32 }
          cleanup
  br label %.body259

bb.bt:                                            ; preds = %bb.cl, %bb.cm
  %i.fx = landingpad { ptr, i32 }
          cleanup
  br label %.body259

bb.bu:                                            ; preds = %_ZNK6icu_787UVectorixEi.exit230, %bb.bn
...
bb.bw:                                            ; preds = %_ZN6icu_7810LocalArrayINS_13UnicodeStringEEC2EPS1_R10UErrorCode.exit233
  %i.ga = icmp sgt i32 %i.ex, 0
  br i1 %i.ga, label %.lr.ph.i, label %_ZL14uprv_arrayCopyPKN6icu_7813UnicodeStringEPS0_i.exit

.lr.ph.i:                                         ; preds = %bb.bw, %.noexc
  %.06.i = phi i32 [ %i.ge, %.noexc ], [ %i.ex, %bb.bw ] ; 2 uses
  %.025.i = phi ptr [ %i.gc, %.noexc ], [ %.ptr183.ptr, %bb.bw ] ; 2 uses
  %.034.i = phi ptr [ %i.gd, %.noexc ], [ %i.er, %bb.bw ] ; 2 uses
  %i.gb = invoke noundef nonnull align 8 dereferenceable(64) ptr @_ZN6icu_7813UnicodeStringaSERKS0_(ptr noundef nonnull align 8 dereferenceable(64) %.025.i, ptr noundef nonnull align 8 dereferenceable(64) %.034.i)
          to label %.noexc unwind label %.loopexit ; 0 uses

.noexc:                                           ; preds = %.lr.ph.i
  %i.gc = getelementptr inbounds nuw i8, ptr %.025.i, i64 64
  %i.gd = getelementptr inbounds nuw i8, ptr %.034.i, i64 64
  %i.ge = add nsw i32 %.06.i, -1
  %i.gf = icmp samesign ugt i32 %.06.i, 1
  br i1 %i.gf, label %.lr.ph.i, label %_ZL14uprv_arrayCopyPKN6icu_7813UnicodeStringEPS0_i.exit, !llvm.loop !225

_ZL14uprv_arrayCopyPKN6icu_7813UnicodeStringEPS0_i.exit: ; preds = %.noexc, %_ZN6icu_7810LocalArrayINS_13UnicodeStringEEC2EPS1_R10UErrorCode.exit233.thread446, %bb.bw
  store ptr null, ptr %9, align 8, !tbaa !277
  %i.gg = load ptr, ptr %i.j, align 8, !tbaa !99
  %i.gh = call noundef ptr @_ZN6icu_787UMemorynwEm(i64 noundef 64) #18 ; 4 uses
  %i.gi = icmp eq ptr %i.gh, null
  br i1 %i.gi, label %bb.by, label %bb.bx

bb.bx:                                            ; preds = %_ZL14uprv_arrayCopyPKN6icu_7813UnicodeStringEPS0_i.exit
  invoke void @_ZN6icu_7813UnicodeStringC1ERKS0_(ptr noundef nonnull align 8 dereferenceable(64) %i.gh, ptr noundef nonnull align 8 dereferenceable(64) %i.es)
          to label %bb.by unwind label %bb.bz

bb.by:                                            ; preds = %bb.bx, %_ZL14uprv_arrayCopyPKN6icu_7813UnicodeStringEPS0_i.exit
  %i.gj = invoke noundef ptr @uhash_put_78(ptr noundef %i.gg, ptr noundef %i.gh, ptr noundef nonnull %.ptr183.ptr, ptr noundef nonnull align 4 dereferenceable(4) %4)
          to label %_ZN6icu_789Hashtable3putERKNS_13UnicodeStringEPvR10UErrorCode.exit237 unwind label %.loopexit.split-lp ; 0 uses

bb.bz:                                            ; preds = %bb.bx
  %i.gk = landingpad { ptr, i32 }
          cleanup
  call void @_ZN6icu_787UMemorydlEPv(ptr noundef nonnull %i.gh) #18
  br label %.body235

_ZN6icu_789Hashtable3putERKNS_13UnicodeStringEPvR10UErrorCode.exit237: ; preds = %bb.by
  %i.gl = load ptr, ptr %i.l, align 8, !tbaa !99
  %i.gm = call noundef ptr @_ZN6icu_787UMemorynwEm(i64 noundef 64) #18 ; 4 uses
  %i.gn = icmp eq ptr %i.gm, null
  br i1 %i.gn, label %bb.cb, label %bb.ca

bb.ca:                                            ; preds = %_ZN6icu_789Hashtable3putERKNS_13UnicodeStringEPvR10UErrorCode.exit237
  invoke void @_ZN6icu_7813UnicodeStringC1ERKS0_(ptr noundef nonnull align 8 dereferenceable(64) %i.gm, ptr noundef nonnull align 8 dereferenceable(64) %i.es)
          to label %bb.cb unwind label %bb.cc

bb.cb:                                            ; preds = %bb.ca, %_ZN6icu_789Hashtable3putERKNS_13UnicodeStringEPvR10UErrorCode.exit237
  %i.go = invoke noundef i32 @uhash_puti_78(ptr noundef %i.gl, ptr noundef %i.gm, i32 noundef %i.ex, ptr noundef nonnull align 4 dereferenceable(4) %4)
...
bb.cc:                                            ; preds = %bb.ca
  %i.gp = landingpad { ptr, i32 }
          cleanup
  call void @_ZN6icu_787UMemorydlEPv(ptr noundef nonnull %i.gm) #18
  br label %.body235
...
.loopexit.split-lp:                               ; preds = %bb.by, %bb.cb
  %lpad.loopexit.split-lp = landingpad { ptr, i32 }
          cleanup
  br label %.body235

.body235:                                         ; preds = %.loopexit, %.loopexit.split-lp, %bb.cc, %bb.bz
  %eh.lpad-body236 = phi { ptr, i32 } [ %i.gk, %bb.bz ], [ %i.gp, %bb.cc ], [ %lpad.loopexit, %.loopexit ], [ %lpad.loopexit.split-lp, %.loopexit.split-lp ]
...
bb.cd:                                            ; preds = %_ZN6icu_7810LocalArrayINS_13UnicodeStringEEC2EPS1_R10UErrorCode.exit233, %_ZN6icu_7810LocalArrayINS_13UnicodeStringEEC2EPS1_R10UErrorCode.exit233.thread446
  %i.gq = load i64, ptr %i.fd, align 8            ; 2 uses
  %i.gr = icmp eq i64 %i.gq, 0
  br i1 %i.gr, label %.loopexit.i250, label %.preheader.preheader.i247

.preheader.preheader.i247:                        ; preds = %bb.cd
  %.idx.i248 = shl nsw i64 %i.gq, 6
  %.ptr183.add = or disjoint i64 %.idx.i248, 8
  br label %.preheader.i249

.preheader.i249:                                  ; preds = %.preheader.i249, %.preheader.preheader.i247
  %.idx510 = phi i64 [ %.add511, %.preheader.i249 ], [ %.ptr183.add, %.preheader.preheader.i247 ]
  %.add511 = add nsw i64 %.idx510, -64            ; 3 uses
  %.ptr512 = getelementptr inbounds i8, ptr %i.fd, i64 %.add511
  call void @_ZN6icu_7813UnicodeStringD1Ev(ptr noundef nonnull align 8 dead_on_return(64) dereferenceable(64) %.ptr512) #18
  %i.gs = icmp eq i64 %.add511, 8
  br i1 %i.gs, label %.loopexit.i250, label %.preheader.i249

.loopexit.i250:                                   ; preds = %.preheader.i249, %bb.cd
...
_ZN6icu_789Hashtable4putiERKNS_13UnicodeStringEiR10UErrorCode.exit241._crit_edge: ; preds = %bb.cb
  %.pre416 = load i32, ptr %4, align 4, !tbaa !10
  call void @llvm.lifetime.end.p0(ptr nonnull %9) #18
  %i.gt = icmp slt i32 %.pre416, 1
  br i1 %i.gt, label %bb.cl, label %.thread305

.thread302:                                       ; preds = %_ZNK6icu_789Hashtable3getERKNS_13UnicodeStringE.exit231
  %i.gu = load i32, ptr %4, align 4, !tbaa !10
  %i.gv = icmp slt i32 %i.gu, 1
  br i1 %i.gv, label %bb.cl, label %.thread305

bb.ce:                                            ; preds = %_ZNK6icu_789Hashtable3getERKNS_13UnicodeStringE.exit229
  %i.gw = load ptr, ptr %i.n, align 8, !tbaa !99
  %i.gx = invoke noundef ptr @uhash_get_78(ptr noundef %i.gw, ptr noundef nonnull align 8 dereferenceable(64) %i.ep)
          to label %_ZNK6icu_789Hashtable3getERKNS_13UnicodeStringE.exit253 unwind label %bb.bs ; 2 uses

_ZNK6icu_789Hashtable3getERKNS_13UnicodeStringE.exit253: ; preds = %bb.ce
  %.not178 = icmp eq ptr %i.gx, null
  br i1 %.not178, label %bb.cn, label %bb.cf

bb.cf:                                            ; preds = %_ZNK6icu_789Hashtable3getERKNS_13UnicodeStringE.exit253
  %14 = add nsw i32 %.0128378, 1                  ; 2 uses
  %i.gy = invoke noundef ptr @_ZNK6icu_787UVector9elementAtEi(ptr noundef nonnull align 8 dereferenceable(40) %i.o, i32 noundef %14)
          to label %_ZNK6icu_787UVectorixEi.exit255 unwind label %bb.ck ; 2 uses

_ZNK6icu_787UVectorixEi.exit255:                  ; preds = %bb.cf
  %i.gz = load ptr, ptr %i.n, align 8, !tbaa !99
  %i.ha = invoke noundef ptr @uhash_get_78(ptr noundef %i.gz, ptr noundef nonnull align 8 dereferenceable(64) %i.gy)
          to label %_ZNK6icu_789Hashtable3getERKNS_13UnicodeStringE.exit257 unwind label %bb.ck

_ZNK6icu_789Hashtable3getERKNS_13UnicodeStringE.exit257: ; preds = %_ZNK6icu_787UVectorixEi.exit255
  %i.hb = icmp eq ptr %i.ha, null
  br i1 %i.hb, label %bb.cg, label %_ZN6icu_789Hashtable3putERKNS_13UnicodeStringEPvR10UErrorCode.exit261

bb.cg:                                            ; preds = %_ZNK6icu_789Hashtable3getERKNS_13UnicodeStringE.exit257
  %i.hc = load ptr, ptr %i.n, align 8, !tbaa !99
  %i.hd = call noundef ptr @_ZN6icu_787UMemorynwEm(i64 noundef 64) #18 ; 4 uses
  %i.he = icmp eq ptr %i.hd, null
  br i1 %i.he, label %bb.ci, label %bb.ch

bb.ch:                                            ; preds = %bb.cg
  invoke void @_ZN6icu_7813UnicodeStringC1ERKS0_(ptr noundef nonnull align 8 dereferenceable(64) %i.hd, ptr noundef nonnull align 8 dereferenceable(64) %i.gy)
          to label %bb.ci unwind label %bb.cj

bb.ci:                                            ; preds = %bb.ch, %bb.cg
  %i.hf = invoke noundef ptr @uhash_put_78(ptr noundef %i.hc, ptr noundef %i.hd, ptr noundef nonnull %i.gx, ptr noundef nonnull align 4 dereferenceable(4) %4)
          to label %_ZN6icu_789Hashtable3putERKNS_13UnicodeStringEPvR10UErrorCode.exit261 unwind label %bb.ck ; 0 uses

bb.cj:                                            ; preds = %bb.ch
  %i.hg = landingpad { ptr, i32 }
          cleanup
  call void @_ZN6icu_787UMemorydlEPv(ptr noundef nonnull %i.hd) #18
  br label %.body259

bb.ck:                                            ; preds = %bb.ci, %_ZNK6icu_787UVectorixEi.exit255, %bb.cf
  %i.hh = landingpad { ptr, i32 }
          cleanup
  br label %.body259

_ZN6icu_789Hashtable3putERKNS_13UnicodeStringEPvR10UErrorCode.exit261: ; preds = %bb.ci, %_ZNK6icu_789Hashtable3getERKNS_13UnicodeStringE.exit257
  %i.hi = load i32, ptr %4, align 4, !tbaa !10
  %i.hj = icmp slt i32 %i.hi, 1
  br i1 %i.hj, label %bb.cl, label %.thread305

bb.cl:                                            ; preds = %_ZN6icu_789Hashtable4putiERKNS_13UnicodeStringEiR10UErrorCode.exit241._crit_edge, %_ZN6icu_789Hashtable3putERKNS_13UnicodeStringEPvR10UErrorCode.exit261, %.thread302
  %.pre-phi = phi i32 [ %11, %_ZN6icu_789Hashtable4putiERKNS_13UnicodeStringEiR10UErrorCode.exit241._crit_edge ], [ %14, %_ZN6icu_789Hashtable3putERKNS_13UnicodeStringEPvR10UErrorCode.exit261 ], [ %11, %.thread302 ]
  invoke void @_ZN6icu_787UVector15removeElementAtEi(ptr noundef nonnull align 8 dereferenceable(40) %i.o, i32 noundef %.pre-phi)
          to label %bb.cm unwind label %bb.bt

bb.cm:                                            ; preds = %bb.cl
  invoke void @_ZN6icu_787UVector15removeElementAtEi(ptr noundef nonnull align 8 dereferenceable(40) %i.o, i32 noundef %.0128378)
          to label %.thread450 unwind label %bb.bt

bb.cn:                                            ; preds = %_ZNK6icu_789Hashtable3getERKNS_13UnicodeStringE.exit253
  %i.hk = add nsw i32 %.0128378, 2                ; 2 uses
  %i.hl = load i32, ptr %i.q, align 8, !tbaa !268 ; 2 uses
  %.not201 = icmp slt i32 %i.hk, %i.hl
  br i1 %.not201, label %.lr.ph, label %.thread299, !llvm.loop !281

.thread450:                                       ; preds = %bb.cm
  %i.hm = load i32, ptr %i.q, align 8, !tbaa !268 ; 2 uses
  %.not201453 = icmp slt i32 %.0128378, %i.hm
  br i1 %.not201453, label %.lr.ph.outer, label %.thread299.thread455, !llvm.loop !281

.thread299:                                       ; preds = %bb.cn
  br i1 %10, label %.critedge, label %.thread299.thread455

.thread299.thread455:                             ; preds = %.thread450, %.thread299
  %i.hn = phi i32 [ %i.hl, %.thread299 ], [ %i.hm, %.thread450 ] ; 2 uses
  %.not314 = icmp eq i32 %i.hn, 0
...
.critedge:                                        ; preds = %.critedge208, %.thread299.thread455, %.thread299, %.critedge208.preheader
  ...
  br i1 %.not315, label %.thread305.thread, label %bb.co
...
bb.co:                                            ; preds = %.critedge
  %i.ho = load ptr, ptr %i.i, align 8, !tbaa !112 ; 3 uses
  %i.hp = icmp eq ptr %i.ho, null
  br i1 %i.hp, label %_ZN6icu_7812LocalPointerINS_7UVectorEEaSEOS2_.exit, label %bb.cp

bb.cp:                                            ; preds = %bb.co
  %i.hq = load ptr, ptr %i.ho, align 8, !tbaa !8
  %i.hr = getelementptr inbounds nuw i8, ptr %i.hq, i64 8
  %i.hs = load ptr, ptr %i.hr, align 8
  call void %i.hs(ptr noundef nonnull align 8 dereferenceable(40) %i.ho) #18, !inline_history !284
  br label %_ZN6icu_7812LocalPointerINS_7UVectorEEaSEOS2_.exit

_ZN6icu_7812LocalPointerINS_7UVectorEEaSEOS2_.exit: ; preds = %bb.co, %bb.cp
...
.thread305:                                       ; preds = %_ZN6icu_789Hashtable4putiERKNS_13UnicodeStringEiR10UErrorCode.exit241._crit_edge, %_ZN6icu_789Hashtable3putERKNS_13UnicodeStringEPvR10UErrorCode.exit261, %.thread302, %.thread288, %_ZN6icu_7812LocalPointerINS_7UVectorEE29adoptInsteadAndCheckErrorCodeEPS1_R10UErrorCode.exit.thread
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #18
  %i.ht = icmp eq ptr %.sroa.0272.6, null
  br i1 %i.ht, label %_ZN6icu_7812LocalPointerINS_7UVectorEED2Ev.exit, label %bb.cq

bb.cq:                                            ; preds = %.thread305
  %i.hu = load ptr, ptr %.sroa.0272.6, align 8, !tbaa !8
  %i.hv = getelementptr inbounds nuw i8, ptr %i.hu, i64 8
  %i.hw = load ptr, ptr %i.hv, align 8
  call void %i.hw(ptr noundef nonnull align 8 dereferenceable(40) %.sroa.0272.6) #18, !inline_history !264
  br label %_ZN6icu_7812LocalPointerINS_7UVectorEED2Ev.exit

_ZN6icu_7812LocalPointerINS_7UVectorEED2Ev.exit:  ; preds = %.thread305.thread, %bb.cq, %.thread305, %.thread307, %bb.a
  ret void

.body259:                                         ; preds = %bb.bs, %bb.bt, %bb.ck, %bb.cj, %12, %bb.bu, %.body235, %bb.bv, %bb.e, %bb.bm
  %.sroa.0272.7 = phi ptr [ %.sroa.0272.0, %bb.cj ], [ %.sroa.0272.0, %bb.ck ], [ %.sroa.0272.0, %.body235 ], [ %.sroa.0272.0, %bb.bv ], [ %.sroa.0272.0, %bb.bu ], [ %.sroa.0272.0, %12 ], [ %.sroa.0272.4, %bb.bm ], [ %.sroa.0272.0, %bb.e ], [ %.sroa.0272.0, %bb.bs ], [ %.sroa.0272.0, %bb.bt ] ; 3 uses
  %.pn197.pn.pn = phi { ptr, i32 } [ %i.hg, %bb.cj ], [ %i.hh, %bb.ck ], [ %eh.lpad-body236, %.body235 ], [ %i.fz, %bb.bv ], [ %i.fy, %bb.bu ], [ %13, %12 ], [ %.pn171.pn.pn, %bb.bm ], [ %i.t, %bb.e ], [ %i.fw, %bb.bs ], [ %i.fx, %bb.bt ]
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #18
  %i.hx = icmp eq ptr %.sroa.0272.7, null
  br i1 %i.hx, label %_ZN6icu_7812LocalPointerINS_7UVectorEED2Ev.exit262, label %bb.cr

bb.cr:                                            ; preds = %.body259
  %i.hy = load ptr, ptr %.sroa.0272.7, align 8, !tbaa !8
  %i.hz = getelementptr inbounds nuw i8, ptr %i.hy, i64 8
  %i.ia = load ptr, ptr %i.hz, align 8
  call void %i.ia(ptr noundef nonnull align 8 dereferenceable(40) %.sroa.0272.7) #18, !inline_history !264
  br label %_ZN6icu_7812LocalPointerINS_7UVectorEED2Ev.exit262

_ZN6icu_7812LocalPointerINS_7UVectorEED2Ev.exit262: ; preds = %.body259, %bb.cr
