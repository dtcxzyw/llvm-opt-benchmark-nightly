...
.lr.ph:                                           ; preds = %.loopexit383, %bb.ay
  ...
  %i.fy = load i8, ptr %.6503, align 1, !tbaa !18 ; 2 uses
  %i.fz = add i8 %i.fy, 13
...
bb.ay:                                            ; preds = %bb.ax, %bb.aw
  ...
  br i1 %or.cond372, label %.lr.ph, label %.critedge2, !llvm.loop !56
...
.lr.ph518.split.us:                               ; preds = %.lr.ph518, %bb.bg
  ...
  %i.gs = load i8, ptr %.8517.us, align 1, !tbaa !18 ; 12 uses
...
bb.az:                                            ; preds = %.lr.ph518.split.us
  store i8 %i.gs, ptr %i.go, align 2, !tbaa !18
  br label %.sink.split
...
bb.be:                                            ; preds = %bb.bd
  store i8 -16, ptr %i.gq, align 1, !tbaa !18
  br label %.sink.split

bb.bf:                                            ; preds = %bb.ba
  store i8 %i.gs, ptr %i.gq, align 1, !tbaa !18
  br label %.sink.split
...
.sink.split:                                      ; preds = %bb.az, %bb.be, %bb.bf
  ...
  store i8 %.sink838, ptr %i.gp, align 8, !tbaa !22
  br label %bb.bg
...
bb.bg:                                            ; preds = %.sink.split, %.lr.ph518.split.us
  ...
  br i1 %exitcond.not, label %.loopexit, label %.lr.ph518.split.us, !llvm.loop !57
...
.split536.us:                                     ; preds = %bb.bd
  ...
  store i8 %i.gs, ptr %i.gq, align 1, !tbaa !18
  store i8 1, ptr %i.gp, align 8, !tbaa !22
  br label %.loopexit
...
.split.us:                                        ; preds = %.lr.ph518.split.us
  ...
  store i16 %i.hc, ptr %.12, align 2, !tbaa !29
...
bb.bh:                                            ; preds = %.split.us
  ...
  store i32 %.6274, ptr %.17, align 4, !tbaa !46
...
.loopexit:                                        ; preds = %bb.bg, %bb.u, %bb.y, %bb.x, %bb.w, %bb.v, %.loopexit771, %.loopexit772, %.critedge2, %.critedge, %bb.al, %bb.o, %.lr.ph570.split, %.lr.ph518.split, %.split536.us, %bb.at, %bb.am, %.split615.us
  ...
  %i.hf = load i32, ptr %1, align 4, !tbaa !27    ; 2 uses
...
bb.bj:                                            ; preds = %bb.bi
  ...
  store i8 0, ptr %i.hi, align 8, !tbaa !22
  br label %bb.bk

bb.bk:                                            ; preds = %.loopexit, %bb.bi, %bb.bj
  %.11314 = phi i8 [ %.10313, %bb.bi ], [ 0, %bb.bj ], [ 0, %.loopexit ]
  store i8 %.5320, ptr %i.o, align 4, !tbaa !21
  store i8 %.11314, ptr %i.q, align 1, !tbaa !42
  store i8 %.8292, ptr %i.s, align 2, !tbaa !43
  store i8 %.8283, ptr %i.u, align 1, !tbaa !44
  store i8 %.9302, ptr %i.w, align 4, !tbaa !45
  store ptr %.9, ptr %i.e, align 8, !tbaa !38
  store ptr %.13, ptr %i.i, align 8, !tbaa !40
  store ptr %.19, ptr %i.m, align 8, !tbaa !53
  ret void
}
...
bb.a:
  ...
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !58   ; 5 uses
  %i.d = getelementptr inbounds nuw i8, ptr %i.c, i64 16
  %i.e = load ptr, ptr %i.d, align 8, !tbaa !14   ; 16 uses
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  %i.g = load ptr, ptr %i.f, align 8, !tbaa !60
  %i.h = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.i = load ptr, ptr %i.h, align 8, !tbaa !61   ; 11 uses
  ...
  %i.s = load i8, ptr %i.r, align 4, !tbaa !23
  %i.t = getelementptr inbounds nuw i8, ptr %i.e, i64 73 ; 2 uses
  %i.u = load i8, ptr %i.t, align 1, !tbaa !24    ; 2 uses
...
bb.b:                                             ; preds = %bb.cy, %bb.a
  ...
  %.0279 = phi ptr [ %i.k, %bb.a ], [ %i.oz, %bb.cy ] ; 10 uses
  %.0272 = phi i32 [ %i.q, %bb.a ], [ %i.pa, %bb.cy ] ; 9 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.ap = load i16, ptr %.1289, align 2, !tbaa !29 ; 10 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  store i8 %i.at, ptr %.1280, align 1, !tbaa !18
  br label %bb.aw
...
bb.j:                                             ; preds = %bb.i
  ...
  store i8 %i.ay, ptr %.1280, align 1, !tbaa !18
  br label %bb.aw
...
bb.p:                                             ; preds = %bb.o
  %i.bh = load i16, ptr %.2290, align 2, !tbaa !29
...
select.unfold:                                    ; preds = %bb.y, %bb.r, %bb.s, %bb.t, %bb.u, %bb.v, %bb.w, %bb.x
  ...
  %i.cr = load i32, ptr %i.cq, align 4, !tbaa !46 ; 2 uses
  %i.cs = load i8, ptr %i.aj, align 1, !tbaa !25
...
bb.z:                                             ; preds = %bb.z, %select.unfold
  ...
  br i1 %.not.i, label %bb.aa, label %bb.z, !llvm.loop !64
...
_ZL16useDynamicWindowP8SCSUDataa.exit:            ; preds = %.lr.ph.i, %bb.aa
  ...
  store i8 %.06.i.ph, ptr %i.dk, align 1, !tbaa !18
...
4:                                                ; preds = %20, %17, %14, %11, %8, %5, %_ZL9getWindowPKjj.exit
  ...
  store i32 %.lcssa.i, ptr %i.a, align 4, !tbaa !46
  br label %bb.ac
...
31:                                               ; preds = %25
  ...
  store i32 %32, ptr %i.a, align 4, !tbaa !46
  %33 = lshr i32 %i.bo, 7
  br label %bb.ac
...
37:                                               ; preds = %bb.ab
  ...
  store i32 %38, ptr %i.a, align 4, !tbaa !46
...
bb.ac:                                            ; preds = %4, %31, %37
  ...
  %i.dq = load i8, ptr %i.aj, align 1, !tbaa !25  ; 2 uses
  %i.dr = sext i8 %i.dq to i64
  %i.ds = getelementptr inbounds i8, ptr %i.ai, i64 %i.dr
  %i.dt = load i8, ptr %i.ds, align 1, !tbaa !18  ; 5 uses
  %i.du = add i8 %i.dq, 1                         ; 2 uses
  %i.dv = icmp eq i8 %i.du, 8
  %spec.select.i333 = select i1 %i.dv, i8 0, i8 %i.du ; 2 uses
  store i8 %spec.select.i333, ptr %i.aj, align 1, !tbaa !25
  %i.dw = zext i8 %i.dt to i64
  %i.dx = getelementptr inbounds nuw [4 x i8], ptr %i.v, i64 %i.dw
  store i32 %41, ptr %i.dx, align 4, !tbaa !46
  %42 = sext i8 %spec.select.i333 to i32          ; 2 uses
  br label %43

43:                                               ; preds = %43, %bb.ac
  %.019.i334 = phi i32 [ %42, %bb.ac ], [ %spec.store.select.i335, %43 ] ; 2 uses
  %44 = add nsw i32 %.019.i334, -1
  %45 = icmp slt i32 %.019.i334, 1
  %spec.store.select.i335 = select i1 %45, i32 7, i32 %44 ; 4 uses
  %46 = sext i32 %spec.store.select.i335 to i64   ; 2 uses
  %47 = getelementptr inbounds i8, ptr %i.ai, i64 %46
  %48 = load i8, ptr %47, align 1, !tbaa !18
  %.not.i336 = icmp eq i8 %48, %i.dt
  br i1 %.not.i336, label %49, label %43, !llvm.loop !64

49:                                               ; preds = %43
  %50 = add nsw i32 %spec.store.select.i335, 1    ; 2 uses
  %51 = icmp eq i32 %50, 8
  %spec.store.select1.i337 = select i1 %51, i32 0, i32 %50 ; 2 uses
  %.not2021.i338 = icmp eq i32 %spec.store.select1.i337, %42
  br i1 %.not2021.i338, label %_ZL16useDynamicWindowP8SCSUDataa.exit345, label %.lr.ph.i339

.lr.ph.i339:                                      ; preds = %49, %.lr.ph.i339
  %.023.i340 = phi i32 [ %spec.store.select2.i342, %.lr.ph.i339 ], [ %spec.store.select1.i337, %49 ] ; 3 uses
  %.122.i341 = phi i32 [ %.023.i340, %.lr.ph.i339 ], [ %spec.store.select.i335, %49 ]
  %52 = sext i32 %.023.i340 to i64                ; 2 uses
  %53 = getelementptr inbounds i8, ptr %i.ai, i64 %52
  %54 = load i8, ptr %53, align 1, !tbaa !18
  %55 = sext i32 %.122.i341 to i64
  %56 = getelementptr inbounds i8, ptr %i.ai, i64 %55
  store i8 %54, ptr %56, align 1, !tbaa !18
  %57 = add nsw i32 %.023.i340, 1                 ; 2 uses
  %58 = icmp eq i32 %57, 8
  %spec.store.select2.i342 = select i1 %58, i32 0, i32 %57 ; 2 uses
  %59 = load i8, ptr %i.aj, align 1, !tbaa !25
  %60 = sext i8 %59 to i32
  %.not20.i343 = icmp eq i32 %spec.store.select2.i342, %60
  br i1 %.not20.i343, label %_ZL16useDynamicWindowP8SCSUDataa.exit345, label %.lr.ph.i339, !llvm.loop !65

_ZL16useDynamicWindowP8SCSUDataa.exit345:         ; preds = %.lr.ph.i339, %49
  %.pre-phi.i344 = phi i64 [ %46, %49 ], [ %52, %.lr.ph.i339 ]
  %61 = getelementptr inbounds i8, ptr %i.ai, i64 %.pre-phi.i344
  store i8 %i.dt, ptr %61, align 1, !tbaa !18
  %62 = zext i8 %i.dt to i32
  %63 = shl nuw nsw i32 %62, 21
  %64 = shl nuw nsw i32 %.023.i332.ph, 8
  %65 = add nsw i32 %64, -131072
  %66 = sub i32 %i.bo, %41
  %67 = or i32 %65, %63
  %68 = or i32 %67, %66
  %69 = or i32 %68, 184549504
  br label %bb.ct

_ZL16getDynamicOffsetjPj.exit.a:                  ; preds = %bb.ab, %23
  %i.dy = getelementptr inbounds nuw i8, ptr %.2281, i64 1
  store i8 15, ptr %.2281, align 1, !tbaa !18
...
bb.ai:                                            ; preds = %bb.ah
  ...
  %i.em = load i32, ptr %i.el, align 4, !tbaa !46 ; 5 uses
  br i1 %.not322, label %bb.aj, label %_ZL24isInOffsetWindowOrDirectjj.exit.thread389

bb.aj:                                            ; preds = %bb.ai
  %i.en = load i16, ptr %i.ao, align 2, !tbaa !29 ; 4 uses
...
bb.as:                                            ; preds = %bb.ar
  %i.gk = load i16, ptr %i.ao, align 2, !tbaa !29
...
bb.av:                                            ; preds = %bb.q, %bb.l
  ...
  store i8 %i.gq, ptr %.2281.sink, align 1, !tbaa !18
  br label %bb.aw
...
bb.ay:                                            ; preds = %.lr.ph.preheader
  ...
  %i.gu = load i16, ptr %.0288, align 2, !tbaa !29 ; 4 uses
...
begin_hunk_1_@_ZL16_SCSUFromUnicodeP25UConverterFromUnicodeArgsP10UErrorCode:bb.a
  %i.lp = load i8, ptr %i.aj, align 1, !tbaa !25
  %i.lq = sext i8 %i.lp to i32
  %.not20.i361 = icmp eq i32 %spec.store.select2.i360, %i.lq
  br i1 %.not20.i361, label %_ZL16useDynamicWindowP8SCSUDataa.exit363, label %.lr.ph.i357, !llvm.loop !65
...
_ZL16useDynamicWindowP8SCSUDataa.exit363:         ; preds = %.lr.ph.i357, %bb.ca
  ...
  store i8 %.06.i350.ph, ptr %i.lr, align 1, !tbaa !18
...
bb.cb:                                            ; preds = %_ZL9getWindowPKjj.exit351
  %i.ly = load i16, ptr %i.jq, align 2, !tbaa !29
...
bb.cd:                                            ; preds = %bb.cj, %bb.ci, %bb.ch, %bb.cg, %bb.cf, %bb.ce, %bb.cc
  ...
  store i32 %.lcssa.i369, ptr %i.a, align 4, !tbaa !46
  br label %bb.cp
...
bb.cm:                                            ; preds = %bb.cl
  ...
  store i32 %i.mv, ptr %i.a, align 4, !tbaa !46
...
bb.co:                                            ; preds = %bb.cn
  ...
  store i32 %i.na, ptr %i.a, align 4, !tbaa !46
...
bb.cp:                                            ; preds = %bb.cd, %bb.cm, %bb.co
  ...
  %i.ne = load i8, ptr %i.aj, align 1, !tbaa !25  ; 2 uses
  %i.nf = sext i8 %i.ne to i64
  %i.ng = getelementptr inbounds i8, ptr %i.ai, i64 %i.nf
  %i.nh = load i8, ptr %i.ng, align 1, !tbaa !18  ; 5 uses
  %i.ni = add i8 %i.ne, 1                         ; 2 uses
  %i.nj = icmp eq i8 %i.ni, 8
  %spec.select.i371 = select i1 %i.nj, i8 0, i8 %i.ni ; 2 uses
  store i8 %spec.select.i371, ptr %i.aj, align 1, !tbaa !25
  %i.nk = zext i8 %i.nh to i64
  %i.nl = getelementptr inbounds nuw [4 x i8], ptr %i.v, i64 %i.nk
  store i32 %i.nd, ptr %i.nl, align 4, !tbaa !46
  %i.nm = sext i8 %spec.select.i371 to i32        ; 2 uses
  br label %bb.cq

bb.cq:                                            ; preds = %bb.cq, %bb.cp
  %.019.i372 = phi i32 [ %i.nm, %bb.cp ], [ %spec.store.select.i373, %bb.cq ] ; 2 uses
  %i.nn = add nsw i32 %.019.i372, -1
  %i.no = icmp slt i32 %.019.i372, 1
  %spec.store.select.i373 = select i1 %i.no, i32 7, i32 %i.nn ; 4 uses
  %i.np = sext i32 %spec.store.select.i373 to i64 ; 2 uses
  %i.nq = getelementptr inbounds i8, ptr %i.ai, i64 %i.np
  %i.nr = load i8, ptr %i.nq, align 1, !tbaa !18
  %.not.i374 = icmp eq i8 %i.nr, %i.nh
  br i1 %.not.i374, label %bb.cr, label %bb.cq, !llvm.loop !64

bb.cr:                                            ; preds = %bb.cq
  %i.ns = add nsw i32 %spec.store.select.i373, 1  ; 2 uses
  %i.nt = icmp eq i32 %i.ns, 8
  %spec.store.select1.i375 = select i1 %i.nt, i32 0, i32 %i.ns ; 2 uses
  %.not2021.i376 = icmp eq i32 %spec.store.select1.i375, %i.nm
...
.lr.ph.i377:                                      ; preds = %bb.cr, %.lr.ph.i377
  ...
  %i.nu = sext i32 %.023.i378 to i64              ; 2 uses
  %i.nv = getelementptr inbounds i8, ptr %i.ai, i64 %i.nu
  %i.nw = load i8, ptr %i.nv, align 1, !tbaa !18
  %i.nx = sext i32 %.122.i379 to i64
  %i.ny = getelementptr inbounds i8, ptr %i.ai, i64 %i.nx
  store i8 %i.nw, ptr %i.ny, align 1, !tbaa !18
  %i.nz = add nsw i32 %.023.i378, 1               ; 2 uses
  %i.oa = icmp eq i32 %i.nz, 8
  %spec.store.select2.i380 = select i1 %i.oa, i32 0, i32 %i.nz ; 2 uses
  %i.ob = load i8, ptr %i.aj, align 1, !tbaa !25
  %i.oc = sext i8 %i.ob to i32
  %.not20.i381 = icmp eq i32 %spec.store.select2.i380, %i.oc
  br i1 %.not20.i381, label %_ZL16useDynamicWindowP8SCSUDataa.exit383, label %.lr.ph.i377, !llvm.loop !65

_ZL16useDynamicWindowP8SCSUDataa.exit383:         ; preds = %.lr.ph.i377, %bb.cr
  %.pre-phi.i382 = phi i64 [ %i.np, %bb.cr ], [ %i.nu, %.lr.ph.i377 ]
  %i.od = getelementptr inbounds i8, ptr %i.ai, i64 %.pre-phi.i382
  store i8 %i.nh, ptr %i.od, align 1, !tbaa !18
  %i.oe = zext i8 %i.nh to i32
  %i.of = shl nuw nsw i32 %i.oe, 21
  %i.og = shl nuw nsw i32 %.023.i367.ph, 8
  %i.oh = add nuw nsw i32 %i.og, 268304384
  %i.oi = sub i32 %i.jt, %i.nd
  %i.oj = or i32 %i.oh, %i.of
  %i.ok = or i32 %i.oj, %i.oi
  %i.ol = or i32 %i.ok, -251658112
  br label %bb.ct

_ZL16getDynamicOffsetjPj.exit370:                 ; preds = %bb.cn, %bb.ck, %bb.cb, %_ZL9getWindowPKjj.exit351
  %i.om = shl i32 %.4, 16
  %i.on = or disjoint i32 %i.om, %i.jn
  br label %bb.ct

bb.cs:                                            ; preds = %bb.bl
  %i.oo = or disjoint i32 %.lcssa507, 15728640
  br label %bb.cu
...
.loopexit.sink.split:                             ; preds = %bb.bm, %bb.bo, %.lr.ph.preheader, %bb.n, %bb.p, %bb.e, %.lr.ph.preheader714, %.lr.ph, %bb.dg, %bb.dd
  ...
  %.8287.ph = phi ptr [ %i.qa, %bb.dg ], [ %i.hp, %.lr.ph ], [ %.9406, %bb.dd ], [ %.1280, %bb.e ], [ %.7286, %bb.bo ], [ %.6285477.lcssa495, %bb.bm ], [ %.2281, %bb.p ], [ %.0279, %.lr.ph.preheader ], [ %.1280, %bb.n ], [ %i.hc, %.lr.ph.preheader714 ]
  ...
  store i32 %.sink713, ptr %1, align 4, !tbaa !27
  br label %.loopexit
...
.loopexit:                                        ; preds = %bb.o, %bb.d, %bb.bn, %.preheader, %bb.ba, %bb.bc, %.loopexit.sink.split
  ...
  store i8 %.1270, ptr %i.r, align 4, !tbaa !23
  store i8 %.1267, ptr %i.t, align 1, !tbaa !24
  store i32 %.5, ptr %i.z, align 4, !tbaa !26
  store ptr %.8296, ptr %i.f, align 8, !tbaa !60
  store ptr %.8287, ptr %i.j, align 8, !tbaa !62
...
bb.ct:                                            ; preds = %_ZL16getDynamicOffsetjPj.exit370, %_ZL16useDynamicWindowP8SCSUDataa.exit383, %_ZL16getDynamicOffsetjPj.exit.a, %_ZL16useDynamicWindowP8SCSUDataa.exit345
  ...
  %.6.jt4 = phi i32 [ %i.ol, %_ZL16useDynamicWindowP8SCSUDataa.exit383 ], [ %i.eb, %_ZL16getDynamicOffsetjPj.exit.a ], [ %69, %_ZL16useDynamicWindowP8SCSUDataa.exit345 ], [ %i.on, %_ZL16getDynamicOffsetjPj.exit370 ] ; 3 uses
...
bb.cu:                                            ; preds = %bb.bk, %bb.cs, %bb.au, %bb.at, %bb.ap, %bb.ag
  ...
  %.6.jt3 = phi i32 [ %i.gh, %bb.ap ], [ %i.jh, %bb.bk ], [ %i.eh, %bb.ag ], [ %i.gn, %bb.at ], [ %i.go, %bb.au ], [ %i.oo, %bb.cs ] ; 2 uses
...
bb.cw:                                            ; preds = %bb.ct
  %i.op = lshr i32 %.6.jt4, 24
  %i.oq = trunc nuw i32 %i.op to i8
  %i.or = getelementptr inbounds nuw i8, ptr %.9.jt4, i64 1
  store i8 %i.oq, ptr %.9.jt4, align 1, !tbaa !18
  br label %bb.cx
...
bb.cx:                                            ; preds = %bb.cu, %bb.cw
  ...
  %.10 = phi ptr [ %.9.jt3, %bb.cu ], [ %i.or, %bb.cw ] ; 2 uses
  %i.os = lshr i32 %.6617, 16
  %i.ot = trunc i32 %i.os to i8
  %i.ou = getelementptr inbounds nuw i8, ptr %.10, i64 1
  store i8 %i.ot, ptr %.10, align 1, !tbaa !18
  br label %bb.cy
...
bb.cy:                                            ; preds = %bb.cv, %bb.cx
  ...
  %.11 = phi ptr [ %.9.jt2, %bb.cv ], [ %i.ou, %bb.cx ] ; 3 uses
  %i.ov = lshr i32 %.6618, 8
  %i.ow = trunc i32 %i.ov to i8
  store i8 %i.ow, ptr %.11, align 1, !tbaa !18
  %i.ox = getelementptr inbounds nuw i8, ptr %.11, i64 1
  %i.oy = trunc i32 %.6618 to i8
  store i8 %i.oy, ptr %i.ox, align 1, !tbaa !18
  %i.oz = getelementptr inbounds nuw i8, ptr %.11, i64 2
  %i.pa = add i32 %.0260621.neg, %.8607
  br label %bb.b
...
.thread:                                          ; preds = %bb.cv, %bb.cu, %bb.ct, %bb.az, %bb.bb
  ...
  %i.pb = sub nsw i32 %.0260411, %.8407           ; 4 uses
  %i.pc = getelementptr inbounds nuw i8, ptr %i.c, i64 104 ; 4 uses
  switch i32 %i.pb, label %bb.dd [
    i32 4, label %bb.cz
    i32 3, label %bb.da
    i32 2, label %bb.db
    i32 1, label %bb.dc
...
bb.cz:                                            ; preds = %.thread
  %i.pd = lshr i32 %.6410, 24
  %i.pe = trunc nuw i32 %i.pd to i8
  %i.pf = getelementptr inbounds nuw i8, ptr %i.c, i64 105
  store i8 %i.pe, ptr %i.pc, align 8, !tbaa !18
  br label %bb.da

bb.da:                                            ; preds = %bb.cz, %.thread
  %.0 = phi ptr [ %i.pf, %bb.cz ], [ %i.pc, %.thread ] ; 2 uses
  %i.pg = lshr i32 %.6410, 16
  %i.ph = trunc i32 %i.pg to i8
  %i.pi = getelementptr inbounds nuw i8, ptr %.0, i64 1
  store i8 %i.ph, ptr %.0, align 1, !tbaa !18
  br label %bb.db

bb.db:                                            ; preds = %bb.da, %.thread
  %.1 = phi ptr [ %i.pi, %bb.da ], [ %i.pc, %.thread ] ; 2 uses
  %i.pj = lshr i32 %.6410, 8
  %i.pk = trunc i32 %i.pj to i8
  %i.pl = getelementptr inbounds nuw i8, ptr %.1, i64 1
  store i8 %i.pk, ptr %.1, align 1, !tbaa !18
  br label %bb.dc

bb.dc:                                            ; preds = %bb.db, %.thread
  %.2 = phi ptr [ %i.pl, %bb.db ], [ %i.pc, %.thread ]
  %i.pm = trunc i32 %.6410 to i8
  store i8 %i.pm, ptr %.2, align 1, !tbaa !18
  br label %bb.dd

bb.dd:                                            ; preds = %.thread, %bb.dc
  %i.pn = trunc nsw i32 %i.pb to i8
  %i.po = getelementptr inbounds nuw i8, ptr %i.c, i64 91
  store i8 %i.pn, ptr %i.po, align 1, !tbaa !69
  %i.pp = icmp eq i32 %i.pb, 4
  %i.pq = shl nsw i32 %i.pb, 3
  %i.pr = lshr i32 %.6410, %i.pq
  %i.ps = select i1 %i.pp, i32 0, i32 %i.pr       ; 3 uses
...
bb.de:                                            ; preds = %bb.dd
  %i.pt = lshr i32 %i.ps, 16
  %i.pu = trunc i32 %i.pt to i8
  %i.pv = getelementptr inbounds nuw i8, ptr %.9406, i64 1
  store i8 %i.pu, ptr %.9406, align 1, !tbaa !18
  br label %bb.df

bb.df:                                            ; preds = %bb.dd, %bb.de
  %.14 = phi ptr [ %i.pv, %bb.de ], [ %.9406, %bb.dd ] ; 2 uses
  %i.pw = lshr i32 %i.ps, 8
  %i.px = trunc i32 %i.pw to i8
  %i.py = getelementptr inbounds nuw i8, ptr %.14, i64 1
  store i8 %i.px, ptr %.14, align 1, !tbaa !18
  br label %bb.dg

bb.dg:                                            ; preds = %bb.dd, %bb.df
  %.15 = phi ptr [ %i.py, %bb.df ], [ %.9406, %bb.dd ] ; 2 uses
  %i.pz = trunc i32 %i.ps to i8
  %i.qa = getelementptr inbounds nuw i8, ptr %.15, i64 1
  store i8 %i.pz, ptr %.15, align 1, !tbaa !18
...
bb.a:
  ...
  %i.u = load i8, ptr %i.t, align 4, !tbaa !23
...
bb.b:                                             ; preds = %bb.dn, %bb.a
  ...
  %.0351 = phi i32 [ %i.q, %bb.a ], [ %i.qh, %bb.dn ] ; 9 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.at = load i16, ptr %.1381, align 2, !tbaa !29 ; 10 uses
...
bb.k:                                             ; preds = %bb.j
  ...
  store i8 %i.be, ptr %.1361, align 1, !tbaa !18
...
bb.o:                                             ; preds = %bb.n
  ...
  store i8 %i.bk, ptr %.1361, align 1, !tbaa !18
...
bb.t:                                             ; preds = %bb.s
  %i.br = load i16, ptr %.2382, align 2, !tbaa !29
...
select.unfold:                                    ; preds = %bb.ae, %bb.x, %bb.y, %bb.z, %bb.aa, %bb.ab, %bb.ac, %bb.ad
  ...
  %i.df = load i32, ptr %i.de, align 4, !tbaa !46 ; 2 uses
  %i.dg = load i8, ptr %i.an, align 1, !tbaa !25
...
bb.af:                                            ; preds = %bb.af, %select.unfold
  ...
  %i.dm = load i8, ptr %i.dl, align 1, !tbaa !18
  %.not.i = icmp eq i8 %i.dm, %.06.i.ph
  br i1 %.not.i, label %bb.ag, label %bb.af, !llvm.loop !64
...
_ZL16useDynamicWindowP8SCSUDataa.exit:            ; preds = %.lr.ph.i, %bb.ag
  ...
  store i8 %.06.i.ph, ptr %i.dy, align 1, !tbaa !18
  %narrow = or disjoint i8 %.06.i.ph, 16
...
bb.ai:                                            ; preds = %4, %31, %37
  ...
  %i.ee = load i8, ptr %i.an, align 1, !tbaa !25  ; 2 uses
  %i.ef = sext i8 %i.ee to i64
  %i.eg = getelementptr inbounds i8, ptr %i.am, i64 %i.ef
  %i.eh = load i8, ptr %i.eg, align 1, !tbaa !18  ; 5 uses
  %i.ei = add i8 %i.ee, 1                         ; 2 uses
  %i.ej = icmp eq i8 %i.ei, 8
  %spec.select.i434 = select i1 %i.ej, i8 0, i8 %i.ei ; 2 uses
  store i8 %spec.select.i434, ptr %i.an, align 1, !tbaa !25
  %i.ek = zext i8 %i.eh to i64
  %i.el = getelementptr inbounds nuw [4 x i8], ptr %i.x, i64 %i.ek
  store i32 %41, ptr %i.el, align 4, !tbaa !46
  %42 = sext i8 %spec.select.i434 to i32          ; 2 uses
  br label %43

43:                                               ; preds = %43, %bb.ai
  %.019.i435 = phi i32 [ %42, %bb.ai ], [ %spec.store.select.i436, %43 ] ; 2 uses
  %44 = add nsw i32 %.019.i435, -1
  %45 = icmp slt i32 %.019.i435, 1
  %spec.store.select.i436 = select i1 %45, i32 7, i32 %44 ; 4 uses
  %46 = sext i32 %spec.store.select.i436 to i64   ; 2 uses
  %47 = getelementptr inbounds i8, ptr %i.am, i64 %46
  %48 = load i8, ptr %47, align 1, !tbaa !18
  %.not.i437 = icmp eq i8 %48, %i.eh
  br i1 %.not.i437, label %49, label %43, !llvm.loop !64

49:                                               ; preds = %43
  %50 = add nsw i32 %spec.store.select.i436, 1    ; 2 uses
  %51 = icmp eq i32 %50, 8
  %spec.store.select1.i438 = select i1 %51, i32 0, i32 %50 ; 2 uses
  %.not2021.i439 = icmp eq i32 %spec.store.select1.i438, %42
  br i1 %.not2021.i439, label %_ZL16useDynamicWindowP8SCSUDataa.exit446, label %.lr.ph.i440

.lr.ph.i440:                                      ; preds = %49, %.lr.ph.i440
  %.023.i441 = phi i32 [ %spec.store.select2.i443, %.lr.ph.i440 ], [ %spec.store.select1.i438, %49 ] ; 3 uses
  %.122.i442 = phi i32 [ %.023.i441, %.lr.ph.i440 ], [ %spec.store.select.i436, %49 ]
  %52 = sext i32 %.023.i441 to i64                ; 2 uses
  %53 = getelementptr inbounds i8, ptr %i.am, i64 %52
  %54 = load i8, ptr %53, align 1, !tbaa !18
  %55 = sext i32 %.122.i442 to i64
  %56 = getelementptr inbounds i8, ptr %i.am, i64 %55
  store i8 %54, ptr %56, align 1, !tbaa !18
  %57 = add nsw i32 %.023.i441, 1                 ; 2 uses
  %58 = icmp eq i32 %57, 8
  %spec.store.select2.i443 = select i1 %58, i32 0, i32 %57 ; 2 uses
  %59 = load i8, ptr %i.an, align 1, !tbaa !25
  %60 = sext i8 %59 to i32
  %.not20.i444 = icmp eq i32 %spec.store.select2.i443, %60
  br i1 %.not20.i444, label %_ZL16useDynamicWindowP8SCSUDataa.exit446, label %.lr.ph.i440, !llvm.loop !65

_ZL16useDynamicWindowP8SCSUDataa.exit446:         ; preds = %.lr.ph.i440, %49
  %.pre-phi.i445 = phi i64 [ %46, %49 ], [ %52, %.lr.ph.i440 ]
  %61 = getelementptr inbounds i8, ptr %i.am, i64 %.pre-phi.i445
  store i8 %i.eh, ptr %61, align 1, !tbaa !18
  %62 = zext i8 %i.eh to i32
  %63 = shl nuw nsw i32 %62, 21
  %64 = shl nuw nsw i32 %.023.i433.ph, 8
  %65 = add nsw i32 %64, -131072
  %66 = sub i32 %i.bz, %41
  %67 = or i32 %65, %63
  %68 = or i32 %67, %66
...
_ZL16getDynamicOffsetjPj.exit.a:                  ; preds = %bb.ah, %23
  ...
  store i8 15, ptr %.2362, align 1, !tbaa !18
...
bb.aq:                                            ; preds = %bb.ap
  ...
  %i.fb = load i32, ptr %i.fa, align 4, !tbaa !46 ; 5 uses
  br i1 %.not417, label %bb.ar, label %_ZL24isInOffsetWindowOrDirectjj.exit.thread490

bb.ar:                                            ; preds = %bb.aq
  %i.fc = load i16, ptr %i.as, align 2, !tbaa !29 ; 4 uses
...
bb.ba:                                            ; preds = %bb.az
  %i.gz = load i16, ptr %i.as, align 2, !tbaa !29
...
bb.bf:                                            ; preds = %.lr.ph.preheader
  ...
  %i.hh = load i16, ptr %.0380, align 2, !tbaa !29 ; 4 uses
...
bb.bh:                                            ; preds = %bb.bg
  ...
  store i8 %i.hn, ptr %.0360, align 1, !tbaa !18
...
begin_hunk_2_@_ZL27_SCSUFromUnicodeWithOffsetsP25UConverterFromUnicodeArgsP10UErrorCode:bb.a
  br i1 %.not20.i462, label %_ZL16useDynamicWindowP8SCSUDataa.exit464, label %.lr.ph.i458, !llvm.loop !65
...
_ZL16useDynamicWindowP8SCSUDataa.exit464:         ; preds = %.lr.ph.i458, %bb.cl
  ...
  store i8 %.06.i451.ph, ptr %i.ml, align 1, !tbaa !18
...
bb.cm:                                            ; preds = %_ZL9getWindowPKjj.exit452
  %i.ms = load i16, ptr %i.kj, align 2, !tbaa !29
...
bb.co:                                            ; preds = %bb.cu, %bb.ct, %bb.cs, %bb.cr, %bb.cq, %bb.cp, %bb.cn
  ...
  store i32 %.lcssa.i470, ptr %i.a, align 4, !tbaa !46
  br label %bb.da
...
bb.cx:                                            ; preds = %bb.cw
  ...
  store i32 %i.np, ptr %i.a, align 4, !tbaa !46
...
bb.cz:                                            ; preds = %bb.cy
  ...
  store i32 %i.nu, ptr %i.a, align 4, !tbaa !46
...
bb.da:                                            ; preds = %bb.co, %bb.cx, %bb.cz
  ...
  %i.ny = load i8, ptr %i.an, align 1, !tbaa !25  ; 2 uses
  %i.nz = sext i8 %i.ny to i64
  %i.oa = getelementptr inbounds i8, ptr %i.am, i64 %i.nz
  %i.ob = load i8, ptr %i.oa, align 1, !tbaa !18  ; 5 uses
  %i.oc = add i8 %i.ny, 1                         ; 2 uses
  %i.od = icmp eq i8 %i.oc, 8
  %spec.select.i472 = select i1 %i.od, i8 0, i8 %i.oc ; 2 uses
  store i8 %spec.select.i472, ptr %i.an, align 1, !tbaa !25
  %i.oe = zext i8 %i.ob to i64
  %i.of = getelementptr inbounds nuw [4 x i8], ptr %i.x, i64 %i.oe
  store i32 %i.nx, ptr %i.of, align 4, !tbaa !46
  %i.og = sext i8 %spec.select.i472 to i32        ; 2 uses
  br label %bb.db

bb.db:                                            ; preds = %bb.db, %bb.da
  %.019.i473 = phi i32 [ %i.og, %bb.da ], [ %spec.store.select.i474, %bb.db ] ; 2 uses
  %i.oh = add nsw i32 %.019.i473, -1
  %i.oi = icmp slt i32 %.019.i473, 1
  %spec.store.select.i474 = select i1 %i.oi, i32 7, i32 %i.oh ; 4 uses
  %i.oj = sext i32 %spec.store.select.i474 to i64 ; 2 uses
  %i.ok = getelementptr inbounds i8, ptr %i.am, i64 %i.oj
  %i.ol = load i8, ptr %i.ok, align 1, !tbaa !18
  %.not.i475 = icmp eq i8 %i.ol, %i.ob
  br i1 %.not.i475, label %bb.dc, label %bb.db, !llvm.loop !64

bb.dc:                                            ; preds = %bb.db
  %i.om = add nsw i32 %spec.store.select.i474, 1  ; 2 uses
  %i.on = icmp eq i32 %i.om, 8
  %spec.store.select1.i476 = select i1 %i.on, i32 0, i32 %i.om ; 2 uses
  %.not2021.i477 = icmp eq i32 %spec.store.select1.i476, %i.og
...
.lr.ph.i478:                                      ; preds = %bb.dc, %.lr.ph.i478
  ...
  %i.oo = sext i32 %.023.i479 to i64              ; 2 uses
  %i.op = getelementptr inbounds i8, ptr %i.am, i64 %i.oo
  %i.oq = load i8, ptr %i.op, align 1, !tbaa !18
  %i.or = sext i32 %.122.i480 to i64
  %i.os = getelementptr inbounds i8, ptr %i.am, i64 %i.or
  store i8 %i.oq, ptr %i.os, align 1, !tbaa !18
  %i.ot = add nsw i32 %.023.i479, 1               ; 2 uses
  %i.ou = icmp eq i32 %i.ot, 8
  %spec.store.select2.i481 = select i1 %i.ou, i32 0, i32 %i.ot ; 2 uses
  %i.ov = load i8, ptr %i.an, align 1, !tbaa !25
  %i.ow = sext i8 %i.ov to i32
  %.not20.i482 = icmp eq i32 %spec.store.select2.i481, %i.ow
  br i1 %.not20.i482, label %_ZL16useDynamicWindowP8SCSUDataa.exit484, label %.lr.ph.i478, !llvm.loop !65

_ZL16useDynamicWindowP8SCSUDataa.exit484:         ; preds = %.lr.ph.i478, %bb.dc
  %.pre-phi.i483 = phi i64 [ %i.oj, %bb.dc ], [ %i.oo, %.lr.ph.i478 ]
  %i.ox = getelementptr inbounds i8, ptr %i.am, i64 %.pre-phi.i483
  store i8 %i.ob, ptr %i.ox, align 1, !tbaa !18
  %i.oy = zext i8 %i.ob to i32
  %i.oz = shl nuw nsw i32 %i.oy, 21
  %i.pa = shl nuw nsw i32 %.023.i468.ph, 8
  %i.pb = add nuw nsw i32 %i.pa, 268304384
  %i.pc = sub i32 %i.kn, %i.nx
  %i.pd = or i32 %i.pb, %i.oz
  %i.pe = or i32 %i.pd, %i.pc
  %i.pf = or i32 %i.pe, -251658112
  br label %bb.de

_ZL16getDynamicOffsetjPj.exit471:                 ; preds = %bb.cy, %bb.cv, %bb.cm, %_ZL9getWindowPKjj.exit452
  %i.pg = shl i32 %.4331, 16
  %i.ph = or disjoint i32 %i.pg, %i.kg
  br label %bb.de

bb.dd:                                            ; preds = %bb.bw
  %i.pi = or disjoint i32 %.lcssa656, 15728640
  br label %bb.df
...
.loopexit.sink.split:                             ; preds = %bb.bx, %bb.bz, %.lr.ph.preheader, %bb.r, %bb.t, %bb.e, %.lr.ph.preheader977, %.lr.ph, %bb.dv, %bb.dw, %.thread527, %bb.ds
  ...
  %.8368.ph = phi ptr [ %i.rs, %bb.dv ], [ %i.ig, %.lr.ph ], [ %.9369510, %bb.ds ], [ %i.rq, %.thread527 ], [ %i.rt, %bb.dw ], [ %.1361, %bb.e ], [ %.7367, %bb.bz ], [ %.6366612.lcssa635, %bb.bx ], [ %.2362, %bb.t ], [ %.0360, %.lr.ph.preheader ], [ %.1361, %bb.r ], [ %i.hq, %.lr.ph.preheader977 ]
  %.14.ph = phi ptr [ null, %bb.dv ], [ %.12, %.lr.ph ], [ %.15512, %bb.ds ], [ null, %.thread527 ], [ %i.ru, %bb.dw ], [ %.1343, %bb.e ], [ %.13, %bb.bz ], [ %.11614.lcssa641, %bb.bx ], [ %.5347, %bb.t ], [ %.0342, %.lr.ph.preheader ], [ %.1343, %bb.r ], [ %.12.peel, %.lr.ph.preheader977 ]
...
.loopexit:                                        ; preds = %bb.s, %bb.d, %bb.by, %.preheader, %bb.bj, %bb.bn, %.loopexit.sink.split
  ...
  store i8 %.1340, ptr %i.t, align 4, !tbaa !23
  store i8 %.1337, ptr %i.v, align 1, !tbaa !24
  store i32 %.5332, ptr %i.ab, align 4, !tbaa !26
  store ptr %.8388, ptr %i.f, align 8, !tbaa !60
  store ptr %.8368, ptr %i.j, align 8, !tbaa !62
  store ptr %.14, ptr %i.r, align 8, !tbaa !70
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #11
  ret void
...
bb.de:                                            ; preds = %_ZL16getDynamicOffsetjPj.exit471, %_ZL16useDynamicWindowP8SCSUDataa.exit484, %bb.ak, %_ZL16useDynamicWindowP8SCSUDataa.exit446
  ...
  %.6333.jt4 = phi i32 [ %i.pf, %_ZL16useDynamicWindowP8SCSUDataa.exit484 ], [ %i.eq, %bb.ak ], [ %69, %_ZL16useDynamicWindowP8SCSUDataa.exit446 ], [ %i.ph, %_ZL16getDynamicOffsetjPj.exit471 ] ; 4 uses
...
bb.df:                                            ; preds = %bb.bv, %bb.dd, %bb.bc, %bb.bb, %bb.ax, %bb.ao
  ...
  %.6333.jt3 = phi i32 [ %i.gw, %bb.ax ], [ %i.ka, %bb.bv ], [ %i.ew, %bb.ao ], [ %i.hc, %bb.bb ], [ %i.hd, %bb.bc ], [ %i.pi, %bb.dd ] ; 3 uses
...
bb.dh:                                            ; preds = %bb.de
  %i.pj = icmp eq ptr %.15.jt4, null
  %i.pk = lshr i32 %.6333.jt4, 24
  %i.pl = trunc nuw i32 %i.pk to i8
  %i.pm = getelementptr inbounds nuw i8, ptr %.9369.jt4, i64 1 ; 2 uses
  store i8 %i.pl, ptr %.9369.jt4, align 1, !tbaa !18
  br i1 %i.pj, label %bb.dk, label %bb.dm

bb.di:                                            ; preds = %bb.df
  %i.pn = icmp eq ptr %.15.jt3, null
  br i1 %i.pn, label %bb.dk, label %.thread842

bb.dj:                                            ; preds = %bb.dg
  %i.po = icmp eq ptr %.15.jt2, null
  br i1 %i.po, label %bb.dl, label %.thread854
...
bb.dk:                                            ; preds = %bb.dh, %bb.di
  ...
  %.10370 = phi ptr [ %.9369.jt3, %bb.di ], [ %i.pm, %bb.dh ] ; 2 uses
  %i.pp = lshr i32 %.6333788, 16
  %i.pq = trunc i32 %i.pp to i8
  %i.pr = getelementptr inbounds nuw i8, ptr %.10370, i64 1
  store i8 %i.pq, ptr %.10370, align 1, !tbaa !18
  br label %bb.dl
...
bb.dl:                                            ; preds = %bb.dj, %bb.dk
  ...
  %.11371 = phi ptr [ %.9369.jt2, %bb.dj ], [ %i.pr, %bb.dk ] ; 3 uses
  %i.ps = lshr i32 %.6333789, 8
  %i.pt = trunc i32 %i.ps to i8
  store i8 %i.pt, ptr %.11371, align 1, !tbaa !18
  %i.pu = getelementptr inbounds nuw i8, ptr %.11371, i64 1
  %i.pv = trunc i32 %.6333789 to i8
  store i8 %i.pv, ptr %i.pu, align 1, !tbaa !18
  br label %bb.dn

bb.dm:                                            ; preds = %bb.dh
  %i.pw = getelementptr inbounds nuw i8, ptr %.15.jt4, i64 4
  store i32 %.5326.jt4, ptr %.15.jt4, align 4, !tbaa !46
  br label %.thread842
...
.thread842:                                       ; preds = %bb.di, %bb.dm
  ...
  %.13373 = phi ptr [ %i.pm, %bb.dm ], [ %.9369.jt3, %bb.di ] ; 2 uses
  %.16 = phi ptr [ %i.pw, %bb.dm ], [ %.15.jt3, %bb.di ] ; 2 uses
  %i.px = lshr i32 %.6333787823, 16
  %i.py = trunc i32 %i.px to i8
  %i.pz = getelementptr inbounds nuw i8, ptr %.13373, i64 1
  store i8 %i.py, ptr %.13373, align 1, !tbaa !18
  %i.qa = getelementptr inbounds nuw i8, ptr %.16, i64 4
  store i32 %.5326791820, ptr %.16, align 4, !tbaa !46
  br label %.thread854
...
.thread854:                                       ; preds = %bb.dj, %.thread842
  ...
  %.14374 = phi ptr [ %i.pz, %.thread842 ], [ %.9369.jt2, %bb.dj ] ; 3 uses
  %.17 = phi ptr [ %i.qa, %.thread842 ], [ %.15.jt2, %bb.dj ] ; 3 uses
  %i.qb = lshr i32 %.6333787824, 8
  %i.qc = trunc i32 %i.qb to i8
  store i8 %i.qc, ptr %.14374, align 1, !tbaa !18
  store i32 %.5326791821, ptr %.17, align 4, !tbaa !46
  %i.qd = getelementptr inbounds nuw i8, ptr %.17, i64 4
  %i.qe = getelementptr inbounds nuw i8, ptr %.14374, i64 1
  %i.qf = trunc i32 %.6333787824 to i8
  store i8 %i.qf, ptr %i.qe, align 1, !tbaa !18
  %i.qg = getelementptr inbounds nuw i8, ptr %.17, i64 8
  store i32 %.5326791821, ptr %i.qd, align 4, !tbaa !46
  br label %bb.dn
...
bb.dn:                                            ; preds = %.thread854, %bb.dl
  ...
  %.19 = phi ptr [ %i.qg, %.thread854 ], [ null, %bb.dl ]
  %.16376 = getelementptr inbounds nuw i8, ptr %.14374.pn, i64 2
  %i.qh = add i32 %.0317800.neg, %.8359769
  br label %bb.b
...
.thread:                                          ; preds = %bb.dg, %bb.df, %bb.de, %bb.bg, %bb.bk
  ...
  %i.qi = sub nsw i32 %.0317517, %.8359511        ; 3 uses
  %i.qj = getelementptr inbounds nuw i8, ptr %i.c, i64 104 ; 4 uses
  switch i32 %i.qi, label %bb.ds [
    i32 4, label %bb.do
    i32 3, label %bb.dp
    i32 2, label %bb.dq
    i32 1, label %bb.dr
...
bb.do:                                            ; preds = %.thread
  %i.qk = lshr i32 %.6333515, 24
  %i.ql = trunc nuw i32 %i.qk to i8
  %i.qm = getelementptr inbounds nuw i8, ptr %i.c, i64 105
  store i8 %i.ql, ptr %i.qj, align 8, !tbaa !18
  br label %bb.dp

bb.dp:                                            ; preds = %bb.do, %.thread
  %.0 = phi ptr [ %i.qm, %bb.do ], [ %i.qj, %.thread ] ; 2 uses
  %i.qn = lshr i32 %.6333515, 16
  %i.qo = trunc i32 %i.qn to i8
  %i.qp = getelementptr inbounds nuw i8, ptr %.0, i64 1
  store i8 %i.qo, ptr %.0, align 1, !tbaa !18
  br label %bb.dq

bb.dq:                                            ; preds = %bb.dp, %.thread
  %.1 = phi ptr [ %i.qp, %bb.dp ], [ %i.qj, %.thread ] ; 2 uses
  %i.qq = lshr i32 %.6333515, 8
  %i.qr = trunc i32 %i.qq to i8
  %i.qs = getelementptr inbounds nuw i8, ptr %.1, i64 1
  store i8 %i.qr, ptr %.1, align 1, !tbaa !18
  br label %bb.dr

bb.dr:                                            ; preds = %bb.dq, %.thread
  %.2 = phi ptr [ %i.qs, %bb.dq ], [ %i.qj, %.thread ]
  %i.qt = trunc i32 %.6333515 to i8
  store i8 %i.qt, ptr %.2, align 1, !tbaa !18
  br label %bb.ds

bb.ds:                                            ; preds = %.thread, %bb.dr
  %i.qu = trunc nsw i32 %i.qi to i8
  %i.qv = getelementptr inbounds nuw i8, ptr %i.c, i64 91
  store i8 %i.qu, ptr %i.qv, align 1, !tbaa !69
  %i.qw = shl nsw i32 %i.qi, 3
  %i.qx = lshr i32 %.6333515, %i.qw               ; 7 uses
