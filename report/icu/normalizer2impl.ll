...
begin_hunk_0_@_ZNK6icu_7815Normalizer2Impl13addCompositesEPKtRNS_10UnicodeSetE:bb.a
  ...
  %i.ax = load ptr, ptr %i.d, align 8, !tbaa !58
  ...
  %i.bc = load i16, ptr %i.ba, align 2, !tbaa !50
...
bb.m:                                             ; preds = %_ZNK6icu_7815Normalizer2Impl12getRawNorm16Ei.exit, %bb.e
  ...
  br i1 %i.bh, label %bb.b, label %bb.n, !llvm.loop !119
...
_ZNK6icu_7815Normalizer2Impl31getCompositionsListForDecompYesEt.exit.thread: ; preds = %_ZNK6icu_7815Normalizer2Impl31getCompositionsListForDecompYesEt.exit.thread.backedge, %_ZNK6icu_7815Normalizer2Impl31getCompositionsListForDecompYesEt.exit.thread.outer
  ...
  %i.m = load i16, ptr %.0140, align 2, !tbaa !34
...
bb.b:                                             ; preds = %_ZNK6icu_7815Normalizer2Impl31getCompositionsListForDecompYesEt.exit.thread
  %i.q = load ptr, ptr %i.h, align 8, !tbaa !47   ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  %i.ab = load i16, ptr %i.l, align 2, !tbaa !34
  %i.ac = zext i16 %i.ab to i32                   ; 2 uses
  %i.ad = and i32 %i.ac, 64512
  %i.ae = icmp eq i32 %i.ad, 56320
  %.pre274 = load ptr, ptr %i.h, align 8, !tbaa !47 ; 5 uses
...
bb.g:                                             ; preds = %bb.e
  ...
  %.pre275 = load ptr, ptr %i.h, align 8, !tbaa !47
  br label %bb.i
...
bb.m:                                             ; preds = %bb.l
  %i.bl = load i16, ptr %.0132.ph485, align 2, !tbaa !34
...
bb.o:                                             ; preds = %bb.n
  %i.bu = load i16, ptr %.2142, align 2, !tbaa !34
...
bb.q:                                             ; preds = %bb.p, %bb.o, %bb.n
  ...
  store i16 %.0, ptr %.0132.ph485, align 2, !tbaa !34
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <8 x i16>, ptr %next.gep, align 2, !tbaa !34
  %wide.load436 = load <8 x i16>, ptr %i.ck, align 2, !tbaa !34
  %i.cl = getelementptr i8, ptr %next.gep435, i64 16
  store <8 x i16> %wide.load, ptr %next.gep435, align 2, !tbaa !34
  store <8 x i16> %wide.load436, ptr %i.cl, align 2, !tbaa !34
  %index.next = add nuw i64 %index, 16            ; 2 uses
  %i.cm = icmp eq i64 %index.next, %n.vec
  br i1 %i.cm, label %middle.block, label %vector.body, !llvm.loop !120
...
vec.epilog.iter.check:                            ; preds = %middle.block
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph234.preheader, label %vec.epilog.ph, !prof !56
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load442 = load <4 x i16>, ptr %next.gep440.a, align 2, !tbaa !34
  store <4 x i16> %wide.load442, ptr %next.gep441, align 2, !tbaa !34
  %index.next443 = add nuw i64 %index439, 4       ; 2 uses
  %i.cr = icmp eq i64 %index.next443, %n.vec438
  br i1 %i.cr, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !121
...
.lr.ph234:                                        ; preds = %.lr.ph234.preheader, %.lr.ph234
  ...
  %i.ct = load i16, ptr %.0123232, align 2, !tbaa !34
  %i.cu = getelementptr inbounds nuw i8, ptr %.0127231, i64 2 ; 2 uses
  store i16 %i.ct, ptr %.0127231, align 2, !tbaa !34
  %i.cv = icmp ult ptr %i.cs, %.0136.ph
  br i1 %i.cv, label %.lr.ph234, label %.outer.backedge, !llvm.loop !122
...
bb.s:                                             ; preds = %bb.r
  ...
  %i.cz = load i16, ptr %.0120, align 2, !tbaa !50
...
.lr.ph.i:                                         ; preds = %bb.s, %.lr.ph.i
  ...
  %i.dh = load i16, ptr %i.dg, align 2, !tbaa !50
  %i.di = zext i16 %i.dh to i32                   ; 3 uses
  %i.dj = icmp samesign ugt i32 %i.cy, %i.di
  br i1 %i.dj, label %.lr.ph.i, label %._crit_edge.i, !llvm.loop !2
...
bb.t:                                             ; preds = %._crit_edge.i
  ...
  %i.do = load i16, ptr %i.dn, align 2, !tbaa !50
...
bb.v:                                             ; preds = %.backedge, %bb.u
  ...
  %i.dv = load i16, ptr %.131.i, align 2, !tbaa !50 ; 2 uses
...
bb.y:                                             ; preds = %bb.x
  ...
  %i.ef = load i16, ptr %i.ee, align 2, !tbaa !50
...
_ZN6icu_7815Normalizer2Impl7combineEPKti.exit.thread169.split.loop.exit207: ; preds = %_ZN6icu_7815Normalizer2Impl7combineEPKti.exit, %_ZN6icu_7815Normalizer2Impl7combineEPKti.exit.thread304
  ...
  %i.eq = load i16, ptr %i.ep, align 2, !tbaa !50
...
bb.ad:                                            ; preds = %bb.ac
  ...
  store i16 %i.fb, ptr %.0132.ph485, align 2, !tbaa !34
  ...
  store i16 %i.fe, ptr %i.ff, align 2, !tbaa !34
  br label %bb.ai

bb.ae:                                            ; preds = %bb.ac
  %i.fg = trunc i32 %i.eu to i16
  store i16 %i.fg, ptr %.0132.ph485, align 2, !tbaa !34
...
.lr.ph.preheader:                                 ; preds = %bb.ae
  ...
  %i.fm = and i64 %i.fl, -2
  %i.fn = add i64 %i.fm, 2
  tail call void @llvm.memmove.p0.p0.i64(ptr align 2 %scevgep, ptr nonnull align 2 %i.fh, i64 %i.fn, i1 false), !tbaa !34
  br label %._crit_edge
...
vector.body456:                                   ; preds = %vector.body456, %vector.ph454
  ...
  %wide.load460 = load <8 x i16>, ptr %next.gep458, align 2, !tbaa !34
  %wide.load461 = load <8 x i16>, ptr %i.gp, align 2, !tbaa !34
  %i.gq = getelementptr i8, ptr %next.gep459, i64 16
  store <8 x i16> %wide.load460, ptr %next.gep459, align 2, !tbaa !34
  store <8 x i16> %wide.load461, ptr %i.gq, align 2, !tbaa !34
  %index.next462 = add nuw i64 %index457, 16      ; 2 uses
  %i.gr = icmp eq i64 %index.next462, %n.vec455
  br i1 %i.gr, label %middle.block463, label %vector.body456, !llvm.loop !125
...
vec.epilog.iter.check469:                         ; preds = %middle.block463
  ...
  br i1 %min.epilog.iters.check470, label %.lr.ph230.preheader, label %vec.epilog.ph471, !prof !56
...
vec.epilog.vector.body473:                        ; preds = %vec.epilog.vector.body473, %vec.epilog.ph471
  ...
  %wide.load477 = load <4 x i16>, ptr %next.gep475, align 2, !tbaa !34
  store <4 x i16> %wide.load477, ptr %next.gep476, align 2, !tbaa !34
  %index.next478 = add nuw i64 %index474, 4       ; 2 uses
  %i.gw = icmp eq i64 %index.next478, %n.vec472
  br i1 %i.gw, label %vec.epilog.middle.block479, label %vec.epilog.vector.body473, !llvm.loop !126
...
.lr.ph230:                                        ; preds = %.lr.ph230.preheader, %.lr.ph230
  ...
  %i.gy = load i16, ptr %.3126229, align 2, !tbaa !34
  %i.gz = getelementptr inbounds nuw i8, ptr %.3130228, i64 2 ; 2 uses
  store i16 %i.gy, ptr %.3130228, align 2, !tbaa !34
  %i.ha = icmp ult ptr %i.gx, %.0136.ph
  br i1 %i.ha, label %.lr.ph230, label %.loopexit179.thread311, !llvm.loop !127
...
bb.ao:                                            ; preds = %bb.am
  ...
  %.pre276 = load i16, ptr %i.i, align 2, !tbaa !68
  br label %_ZNK6icu_7815Normalizer2Impl12getRawNorm16Ei.exit

bb.ap:                                            ; preds = %bb.al
  %i.hu = getelementptr inbounds nuw i8, ptr %i.at, i64 20
  %i.hv = load i32, ptr %i.hu, align 4, !tbaa !52
...
_ZNK6icu_7815Normalizer2Impl12getRawNorm16Ei.exit: ; preds = %bb.ak, %bb.an, %bb.ao, %bb.ap
  ...
  %i.ib = load i16, ptr %i.ia, align 2, !tbaa !50 ; 3 uses
...
_ZNK6icu_7815Normalizer2Impl31getCompositionsListForDecompYesEt.exit.thread.backedge: ; preds = %bb.ar, %bb.as, %_ZNK6icu_7815Normalizer2Impl31getCompositionsListForDecompYesEt.exit
  ...
  br label %_ZNK6icu_7815Normalizer2Impl31getCompositionsListForDecompYesEt.exit.thread, !llvm.loop !123

_ZNK6icu_7815Normalizer2Impl31getCompositionsListForDecompYesEt.exit: ; preds = %bb.ar
  %i.iq = load i16, ptr %i.j, align 2
  %i.ir = load ptr, ptr %i.k, align 8, !tbaa !58  ; 2 uses
...
_ZNK6icu_7815Normalizer2Impl31getCompositionsListForDecompYesEt.exit.thread.outer.backedge: ; preds = %_ZNK6icu_7815Normalizer2Impl31getCompositionsListForDecompYesEt.exit
  ...
  br label %_ZNK6icu_7815Normalizer2Impl31getCompositionsListForDecompYesEt.exit.thread.outer, !llvm.loop !123
