...
bb.a:
  ...
  %10 = load float, ptr %8, align 4, !tbaa !90    ; 2 uses
  %11 = load float, ptr %i.e, align 4, !tbaa !89  ; 2 uses
  %i.i = load float, ptr %i.f, align 4, !tbaa !88 ; 2 uses
  %i.j = load <2 x float>, ptr %i.c, align 4, !tbaa !86
  %i.k = load <2 x float>, ptr %9, align 4, !tbaa !86
  %12 = insertelement <2 x float> poison, float %10, i64 0
  %13 = shufflevector <2 x float> %12, <2 x float> poison, <2 x i32> zeroinitializer
  %i.l = fmul nsz <2 x float> %13, %i.k
  %14 = insertelement <2 x float> poison, float %11, i64 0
  %i.m = shufflevector <2 x float> %14, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %15 = insertelement <2 x float> poison, float %i.i, i64 0
  %16 = shufflevector <2 x float> %15, <2 x float> poison, <2 x i32> zeroinitializer
  %i.p = call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %16, <2 x float> %i.o, <2 x float> %i.n)
  ...
  %i.w = fmul nsz float %10, %i.v
  %i.x = call nsz float @llvm.fmuladd.f32(float %11, float %i.t, float %i.w)
  %i.y = getelementptr inbounds nuw i8, ptr %i.b, i64 80
  %i.z = load float, ptr %i.y, align 4, !tbaa !86
  %i.aa = call nsz float @llvm.fmuladd.f32(float %i.i, float %i.z, float %i.x)
