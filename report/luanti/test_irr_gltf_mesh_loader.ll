...
bb.a:
  ...
  %i.e = getelementptr inbounds nuw [40 x i8], ptr %i.d, i64 %0 ; 3 uses
  %8 = load float, ptr %i.e, align 4, !tbaa !186  ; 2 uses
  %i.f = getelementptr inbounds nuw i8, ptr %i.e, i64 4
  %9 = load float, ptr %i.f, align 4, !tbaa !187  ; 2 uses
  %i.g = getelementptr inbounds nuw i8, ptr %i.b, i64 56
  %i.h = getelementptr inbounds nuw i8, ptr %i.e, i64 8
  %10 = load float, ptr %i.h, align 4, !tbaa !181 ; 2 uses
  %11 = getelementptr inbounds nuw i8, ptr %i.b, i64 72
  %12 = getelementptr inbounds nuw i8, ptr %i.b, i64 88
  %i.i = load <2 x float>, ptr %i.c, align 4, !tbaa !179
  %i.j = load <2 x float>, ptr %i.g, align 4, !tbaa !179
  %13 = insertelement <2 x float> poison, float %9, i64 0
  %14 = shufflevector <2 x float> %13, <2 x float> poison, <2 x i32> zeroinitializer
  %i.k = fmul nsz <2 x float> %14, %i.j
  %15 = insertelement <2 x float> poison, float %8, i64 0
  %i.l = shufflevector <2 x float> %15, <2 x float> poison, <2 x i32> zeroinitializer
  %i.m = call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.l, <2 x float> %i.i, <2 x float> %i.k)
  %i.n = load <2 x float>, ptr %11, align 4, !tbaa !179
  %16 = insertelement <2 x float> poison, float %10, i64 0
  %17 = shufflevector <2 x float> %16, <2 x float> poison, <2 x i32> zeroinitializer
  %i.o = call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %17, <2 x float> %i.n, <2 x float> %i.m)
  %i.p = load <2 x float>, ptr %12, align 4, !tbaa !179
  ...
  %i.v = fmul nsz float %9, %i.u
  %i.w = call nsz float @llvm.fmuladd.f32(float %8, float %i.s, float %i.v)
  %i.x = getelementptr inbounds nuw i8, ptr %i.b, i64 80
  %i.y = load float, ptr %i.x, align 4, !tbaa !179
  %i.z = call nsz float @llvm.fmuladd.f32(float %10, float %i.y, float %i.w)
