...
.loopexit:                                        ; preds = %.lr.ph.i, %bb.o, %bb.p
  ...
  %foldExtExtBinop288 = fadd nsz <2 x float> %shift287, %i.eb
  %i.ed = extractelement <2 x float> %foldExtExtBinop288, i64 0
...
.preheader:                                       ; preds = %bb.bh, %bb.bj
  ...
  %.sroa.7660.0813 = phi i16 [ %.sroa.7660.0.copyload, %bb.bh ], [ %.sroa.7660.2, %bb.bj ]
  %.sroa.6.0812 = phi i16 [ %.sroa.6.0.copyload, %bb.bh ], [ %.sroa.6.2, %bb.bj ]
  %.sroa.0656.0811 = phi i16 [ %.sroa.0656.0.copyload, %bb.bh ], [ %.sroa.0656.2.a, %bb.bj ]
...
bb.bi:                                            ; preds = %bb.bj
  ...
  store i16 %.sroa.0656.2.a, ptr %i.sc, align 2, !tbaa !135
  store i16 %.sroa.6.2, ptr %.sroa.6.0..sroa_idx, align 8, !tbaa !135
  store i16 %.sroa.7660.2, ptr %.sroa.7660.0..sroa_idx, align 2, !tbaa !135
...
bb.cf:                                            ; preds = %bb.bz, %_ZNK14NodeDefManager3getERK7MapNode.exit542, %bb.bs, %_ZNK14NodeDefManager3getERK7MapNode.exit534, %bb.bm, %_ZNK14NodeDefManager3getERK7MapNode.exit526, %bb.bk, %bb.ce
  %.sroa.0656.2.a = phi i16 [ %.sroa.0656.1804, %bb.bk ], [ %.sroa.0656.1804, %_ZNK14NodeDefManager3getERK7MapNode.exit534 ], [ %i.si, %bb.ce ], [ %.sroa.0656.1804, %_ZNK14NodeDefManager3getERK7MapNode.exit542 ], [ %.sroa.0656.1804, %bb.bz ], [ %.sroa.0656.1804, %bb.bs ], [ %.sroa.0656.1804, %_ZNK14NodeDefManager3getERK7MapNode.exit526 ], [ %.sroa.0656.1804, %bb.bm ] ; 3 uses
  ...
  %.sroa.7660.2 = phi i16 [ %.sroa.7660.1806, %bb.bk ], [ %.sroa.7660.1806, %_ZNK14NodeDefManager3getERK7MapNode.exit534 ], [ %i.sq, %bb.ce ], [ %.sroa.7660.1806, %_ZNK14NodeDefManager3getERK7MapNode.exit542 ], [ %.sroa.7660.1806, %bb.bz ], [ %.sroa.7660.1806, %bb.bs ], [ %.sroa.7660.1806, %_ZNK14NodeDefManager3getERK7MapNode.exit526 ], [ %.sroa.7660.1806, %bb.bm ] ; 3 uses
...
bb.ct:                                            ; preds = %.lr.ph822, %_ZNSt6vectorI13CollisionInfoSaIS0_EE9push_backERKS0_.exit
  %i.xa = phi ptr [ %.pre835, %.lr.ph822 ], [ %i.xy, %_ZNSt6vectorI13CollisionInfoSaIS0_EE9push_backERKS0_.exit ] ; 5 uses
  %.sroa.0630.0820 = phi ptr [ %i.wu, %.lr.ph822 ], [ %i.xz, %_ZNSt6vectorI13CollisionInfoSaIS0_EE9push_backERKS0_.exit ] ; 3 uses
...
bb.cx:                                            ; preds = %_ZNSt6vectorI13CollisionInfoSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit22.i.i
  %i.xu = load ptr, ptr %i.wy, align 8, !tbaa !214
  %i.xv = ptrtoint ptr %i.xu to i64
  %i.xw = sub i64 %i.xv, %i.xg
  call void @_ZdlPvm(ptr noundef nonnull %i.xe, i64 noundef %i.xw) #25
...
_ZNSt6vectorI13CollisionInfoSaIS0_EE17_M_realloc_insertIJRKS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i: ; preds = %bb.cx, %_ZNSt6vectorI13CollisionInfoSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit22.i.i
  ...
  %i.xx = getelementptr inbounds nuw [56 x i8], ptr %i.xp, i64 %i.xn
  store ptr %i.xx, ptr %i.wy, align 8, !tbaa !214
  br label %_ZNSt6vectorI13CollisionInfoSaIS0_EE9push_backERKS0_.exit
end_hunk_1
...
bb.cq:                                            ; preds = %bb.co, %bb.cp, %bb.ci
  %.0153 = phi nsz float [ %i.lg, %bb.co ], [ %i.ln, %bb.cp ], [ 0.000000e+00, %bb.ci ]
  %.1152 = phi nsz float [ %i.lg, %bb.co ], [ %i.ln, %bb.cp ], [ %.0151, %bb.ci ]
...
bb.cy:                                            ; preds = %._crit_edge, %bb.cw, %bb.cx, %bb.cv
  ...
  %i.mm = fmul nsz float %.1152, %i.mi
  %i.mn = fmul nsz float %.0154, %i.mm
  %i.mo = fmul nsz float %.0153, %i.mi
