...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.x
  %.093221 = phi i16 [ %i.fl, %bb.x ], [ 1, %.lr.ph.preheader ] ; 2 uses
  %i.fm = add i16 %.093221, %i.cb
...
bb.bh:                                            ; preds = %bb.bg
  ...
  %i.rl = fsub nsz float %i.rk, %.0319            ; 2 uses
...
bb.bj:                                            ; preds = %bb.cf
  %i.sp = add nsw i16 %.0323814, 1                ; 2 uses
...
bb.bk:                                            ; preds = %.preheader, %bb.cf
  %.1321808 = phi float [ %.0320815, %.preheader ], [ %.2322, %bb.cf ] ; 8 uses
  %.0324807 = phi i16 [ -1, %.preheader ], [ %i.vs, %bb.cf ] ; 2 uses
  %.sroa.0656.1806 = phi i16 [ %.sroa.0656.0813, %.preheader ], [ %.sroa.0656.2, %bb.cf ] ; 7 uses
  %.sroa.6.1805 = phi i16 [ %.sroa.6.0812, %.preheader ], [ %.sroa.6.2, %bb.cf ] ; 7 uses
  %.sroa.7660.1804 = phi i16 [ %.sroa.7660.0811, %.preheader ], [ %.sroa.7660.2.a, %bb.cf ] ; 7 uses
  %i.sq = add i16 %.0324807, %i.sb                ; 3 uses
  ...
  %i.ta = fcmp nsz ogt float %i.sw, %.1321808
...
._crit_edge:                                      ; preds = %.lr.ph, %bb.ci
  %.0325.lcssa = phi float [ 0.000000e+00, %bb.ci ], [ %.1326, %.lr.ph ]
  store float %.0325.lcssa, ptr %i.mo, align 8, !tbaa !73
...
.lr.ph:                                           ; preds = %bb.ci, %.lr.ph
  %.0325818 = phi float [ %.1326, %.lr.ph ], [ 0.000000e+00, %bb.ci ] ; 2 uses
  ...
  %i.wm = fcmp nsz ogt float %i.wl, %.0325818
  %.1326 = select nsz i1 %i.wm, float %i.wl, float %.0325818 ; 2 uses
...
bb.cu:                                            ; preds = %bb.ct, %bb.cs, %bb.cr, %bb.cq
  %.0148 = phi nsz float [ 1.000000e+00, %bb.cq ], [ 1.000000e+00, %bb.cr ], [ 1.000000e+00, %bb.cs ], [ %i.lu, %bb.ct ]
