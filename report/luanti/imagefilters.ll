...
begin_hunk_0_@_Z21imageCleanTransparentPN5video6IImageEj:bb.a
  ...
  call void @_ZdlPvm(ptr noundef nonnull %i.po, i64 noundef %i.ps) #10
  br label %_ZN6BitmapD2Ev.exit.i25

_ZN6BitmapD2Ev.exit.i25:                          ; preds = %bb.cu, %_ZNK6Bitmap3allEv.exit114.thread.i
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #9
  br label %_ZNK6Bitmap3allEv.exit.thread.i26

bb.cv:                                            ; preds = %bb.ct, %bb.cs, %.split.us.i
  %.pn.pn.i = phi { ptr, i32 } [ %i.pn, %bb.ct ], [ %i.oc, %.split.us.i ], [ %i.pi, %bb.cs ] ; 2 uses
  %i.pt = load ptr, ptr %i.kj, align 8, !tbaa !18 ; 3 uses
  %.not.i.i.i.i122.i = icmp eq ptr %i.pt, null
  br i1 %.not.i.i.i.i122.i, label %_ZN6BitmapD2Ev.exit124.i, label %bb.cw

bb.cw:                                            ; preds = %bb.cv
  %i.pu = load ptr, ptr %i.kv, align 8, !tbaa !20
  %i.pv = ptrtoint ptr %i.pu to i64
  %i.pw = ptrtoint ptr %i.pt to i64
  %i.px = sub i64 %i.pv, %i.pw
  call void @_ZdlPvm(ptr noundef nonnull %i.pt, i64 noundef %i.px) #10
  br label %_ZN6BitmapD2Ev.exit124.i

_ZNK6Bitmap3allEv.exit.thread.i26:                ; preds = %bb.be, %bb.bg, %bb.bi, %bb.bk, %bb.bm, %bb.bo, %_ZN6BitmapD2Ev.exit.i25, %._crit_edge.i.i37, %bb.bc, %._crit_edge186.split.i
  %i.py = load ptr, ptr %i.hx, align 8, !tbaa !18 ; 3 uses
  %.not.i.i.i.i125.i = icmp eq ptr %i.py, null
  br i1 %.not.i.i.i.i125.i, label %_ZL33imageCleanTransparentWithInliningILb0EEvPN5video6IImageEj.exit, label %bb.cx

bb.cx:                                            ; preds = %_ZNK6Bitmap3allEv.exit.thread.i26
...
_ZN6BitmapD2Ev.exit124.i:                         ; preds = %bb.cw, %bb.cv, %bb.by
  %.pn.pn.pn.i16 = phi { ptr, i32 } [ %i.lb, %bb.by ], [ %.pn.pn.i, %bb.cv ], [ %.pn.pn.i, %bb.cw ]
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #9
  br label %bb.cy

bb.cy:                                            ; preds = %_ZN6BitmapD2Ev.exit124.i, %bb.br
  %.pn90.pn.i = phi { ptr, i32 } [ %.pn.pn.pn.i16, %_ZN6BitmapD2Ev.exit124.i ], [ %i.kg, %bb.br ]
  %i.qe = load ptr, ptr %i.hx, align 8, !tbaa !18 ; 3 uses
  %.not.i.i.i.i128.i = icmp eq ptr %i.qe, null
  br i1 %.not.i.i.i.i128.i, label %_ZN6BitmapD2Ev.exit130.i, label %bb.cz

bb.cz:                                            ; preds = %bb.cy
  %i.qf = getelementptr inbounds nuw i8, ptr %3, i64 24
  %i.qg = load ptr, ptr %i.qf, align 8, !tbaa !20
  %i.qh = ptrtoint ptr %i.qg to i64
  %i.qi = ptrtoint ptr %i.qe to i64
  %i.qj = sub i64 %i.qh, %i.qi
  call void @_ZdlPvm(ptr noundef nonnull %i.qe, i64 noundef %i.qj) #10
...
_ZL33imageCleanTransparentWithInliningILb0EEvPN5video6IImageEj.exit: ; preds = %_ZNK6Bitmap3allEv.exit.thread.i26, %bb.cx
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #9
  br label %bb.da
...
_ZN12_GLOBAL__N_114linear_to_srgbEN4core8vector3dIfEE.exit.i: ; preds = %bb.l, %bb.k
  ...
  %i.bk = fcmp nsz olt <2 x float> %i.bc, zeroinitializer
  %i.bl = select <2 x i1> %i.bk, <2 x float> zeroinitializer, <2 x float> %i.bc ; 2 uses
  %i.bm = fcmp nsz olt <2 x float> %i.bl, splat (float 2.550000e+02)
  %i.bn = select <2 x i1> %i.bm, <2 x float> %i.bl, <2 x float> splat (float 2.550000e+02)
  %i.bo = fadd nsz <2 x float> %i.bn, splat (float 5.000000e-01)
  %i.bp = fptosi <2 x float> %i.bo to <2 x i32>
  %1 = shl <2 x i32> %i.bp, <i32 8, i32 16>       ; 2 uses
  %i.bq = extractelement <2 x i32> %1, i64 0
  %2 = and i32 %i.bq, 65280
  %3 = and i32 %i.bj, 255
  %i.br = extractelement <2 x i32> %1, i64 1
  %.masked.i = or disjoint i32 %2, %i.br
  %i.bs = or disjoint i32 %3, %.masked.i
  %i.bt = or i32 %i.bs, -16777216
...
bb.m:                                             ; preds = %bb.a
  ...
  %.sroa.017.0.copyload.i3 = load i32, ptr %i.bu, align 4, !tbaa !31 ; 3 uses
  %.sroa.5.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %0, i64 16
  %.sroa.5.0.copyload.i = load i32, ptr %.sroa.5.0..sroa_idx.i, align 8, !tbaa !31 ; 3 uses
  %i.bv = lshr i32 %.sroa.017.0.copyload.i3, 4
  %.sroa.speculated31.i = tail call i32 @llvm.umax.i32(i32 %i.bv, i32 1)
  %i.bw = lshr i32 %.sroa.5.0.copyload.i, 4
  %.sroa.speculated.i4 = tail call i32 @llvm.umax.i32(i32 %i.bw, i32 1)
...
.preheader.us.i6:                                 ; preds = %bb.m, %._crit_edge.us.i9
  ...
  %.02265.us.i = phi i32 [ %i.cw, %._crit_edge.us.i9 ], [ 0, %bb.m ] ; 2 uses
...
bb.n:                                             ; preds = %bb.p, %.preheader.us.i6
  ...
  %.02359.us.i = phi i32 [ 0, %.preheader.us.i6 ], [ %i.cu, %bb.p ] ; 2 uses
  ...
  %i.bx = load ptr, ptr %0, align 8, !tbaa !41
  %i.by = getelementptr inbounds nuw i8, ptr %i.bx, i64 16
  %i.bz = load ptr, ptr %i.by, align 8
  %i.ca = tail call i32 %i.bz(ptr noundef nonnull align 8 dereferenceable(41) %0, i32 noundef %.02359.us.i, i32 noundef %.02265.us.i), !inline_history !55 ; 4 uses
  %.not24.us.i = icmp ult i32 %i.ca, 16777216
  br i1 %.not24.us.i, label %bb.p, label %bb.o

bb.o:                                             ; preds = %bb.n
  %i.cb = add i32 %.160.us.i, 1
  %i.cc = lshr i32 %i.ca, 16
  %i.cd = and i32 %i.cc, 255
  %i.ce = zext nneg i32 %i.cd to i64
  %i.cf = getelementptr inbounds nuw [4 x i8], ptr @_ZN12_GLOBAL__N_118srgb_to_linear_lutE, i64 %i.ce
  %i.cg = load float, ptr %i.cf, align 4, !tbaa !51
  %i.ch = lshr i32 %i.ca, 8
  %i.ci = and i32 %i.ch, 255
  %i.cj = zext nneg i32 %i.ci to i64
  %i.ck = getelementptr inbounds nuw [4 x i8], ptr @_ZN12_GLOBAL__N_118srgb_to_linear_lutE, i64 %i.cj
  %i.cl = load float, ptr %i.ck, align 4, !tbaa !51
  ...
  %i.cs = fadd nsz <2 x float> %.sroa.036.157.us.i, %i.cr
  %i.ct = fadd nsz float %.sroa.13.158.us.i, %i.cp
  br label %bb.p

bb.p:                                             ; preds = %bb.o, %bb.n
  %.sroa.036.2.us.i = phi nsz <2 x float> [ %.sroa.036.157.us.i, %bb.n ], [ %i.cs, %bb.o ] ; 4 uses
  %.sroa.13.2.us.i7 = phi nsz float [ %.sroa.13.158.us.i, %bb.n ], [ %i.ct, %bb.o ] ; 3 uses
  %.2.us.i8 = phi i32 [ %.160.us.i, %bb.n ], [ %i.cb, %bb.o ] ; 4 uses
  %i.cu = add i32 %.02359.us.i, %.sroa.speculated31.i ; 2 uses
  %i.cv = icmp ult i32 %i.cu, %.sroa.017.0.copyload.i3
  br i1 %i.cv, label %bb.n, label %._crit_edge.us.i9, !llvm.loop !56

._crit_edge.us.i9:                                ; preds = %bb.p
  %i.cw = add i32 %.02265.us.i, %.sroa.speculated.i4 ; 2 uses
  %i.cx = icmp ult i32 %i.cw, %.sroa.5.0.copyload.i
  br i1 %i.cx, label %.preheader.us.i6, label %._crit_edge67.i, !llvm.loop !57
...
bb.q:                                             ; preds = %._crit_edge67.i
  %i.cy = uitofp nsz i32 %.2.us.i8 to float       ; 3 uses
  %.sroa.036.0.vec.extract42.i = extractelement <2 x float> %.sroa.036.2.us.i, i64 0
  %i.cz = fdiv nsz float %.sroa.036.0.vec.extract42.i, %i.cy ; 3 uses
  %.sroa.036.4.vec.extract49.i = extractelement <2 x float> %.sroa.036.2.us.i, i64 1
  %i.da = fdiv nsz float %.sroa.036.4.vec.extract49.i, %i.cy ; 3 uses
  %i.db = fdiv nsz float %.sroa.13.2.us.i7, %i.cy ; 3 uses
  %i.dc = fcmp nsz ogt float %i.cz, 3.130800e-03
  br i1 %i.dc, label %bb.r, label %bb.s

bb.r:                                             ; preds = %bb.q
  %i.dd = tail call nsz float @llvm.pow.f32(float %i.cz, float f0x3ED55555)
  %i.de = tail call nsz float @llvm.fmuladd.f32(float %i.dd, float 1.055000e+00, float -5.500000e-02)
  br label %_ZN12_GLOBAL__N_124linear_to_srgb_componentEf.exit.i.i11

bb.s:                                             ; preds = %bb.q
  %i.df = fmul nsz float %i.cz, 1.292000e+01
  br label %_ZN12_GLOBAL__N_124linear_to_srgb_componentEf.exit.i.i11

_ZN12_GLOBAL__N_124linear_to_srgb_componentEf.exit.i.i11: ; preds = %bb.s, %bb.r
  %.0.i.i.i12 = phi nsz float [ %i.de, %bb.r ], [ %i.df, %bb.s ]
  %i.dg = fcmp nsz ogt float %i.da, 3.130800e-03
  br i1 %i.dg, label %bb.t, label %bb.u

bb.t:                                             ; preds = %_ZN12_GLOBAL__N_124linear_to_srgb_componentEf.exit.i.i11
  %i.dh = tail call nsz float @llvm.pow.f32(float %i.da, float f0x3ED55555)
...
bb.u:                                             ; preds = %_ZN12_GLOBAL__N_124linear_to_srgb_componentEf.exit.i.i11
  %i.dj = fmul nsz float %i.da, 1.292000e+01
  br label %_ZN12_GLOBAL__N_124linear_to_srgb_componentEf.exit3.i.i13

_ZN12_GLOBAL__N_124linear_to_srgb_componentEf.exit3.i.i13: ; preds = %bb.u, %bb.t
  %.0.i2.i.i14 = phi nsz float [ %i.di, %bb.t ], [ %i.dj, %bb.u ]
  %i.dk = fcmp nsz ogt float %i.db, 3.130800e-03
  br i1 %i.dk, label %bb.v, label %bb.w

bb.v:                                             ; preds = %_ZN12_GLOBAL__N_124linear_to_srgb_componentEf.exit3.i.i13
  %i.dl = tail call nsz float @llvm.pow.f32(float %i.db, float f0x3ED55555)
...
bb.w:                                             ; preds = %_ZN12_GLOBAL__N_124linear_to_srgb_componentEf.exit3.i.i13
  %i.dn = fmul nsz float %i.db, 1.292000e+01
  br label %_ZN12_GLOBAL__N_114linear_to_srgbEN4core8vector3dIfEE.exit.i15

_ZN12_GLOBAL__N_114linear_to_srgbEN4core8vector3dIfEE.exit.i15: ; preds = %bb.w, %bb.v
  %.0.i4.i.i16 = phi nsz float [ %i.dm, %bb.v ], [ %i.dn, %bb.w ]
  %i.do = insertelement <2 x float> poison, float %.0.i2.i.i14, i64 0
  %i.dp = insertelement <2 x float> %i.do, float %.0.i.i.i12, i64 1
  %i.dq = fmul nsz <2 x float> %i.dp, splat (float 2.550000e+02) ; 2 uses
  %i.dr = fmul nsz float %.0.i4.i.i16, 2.550000e+02 ; 2 uses
  %i.ds = fcmp nsz olt float %i.dr, 0.000000e+00
  %i.dt = select i1 %i.ds, float 0.000000e+00, float %i.dr ; 2 uses
  %i.du = fcmp nsz olt float %i.dt, 2.550000e+02
  %i.dv = select i1 %i.du, float %i.dt, float 2.550000e+02
  %i.dw = fadd nsz float %i.dv, 5.000000e-01
  %i.dx = fptosi float %i.dw to i32
  %i.dy = fcmp nsz olt <2 x float> %i.dq, zeroinitializer
  %i.dz = select <2 x i1> %i.dy, <2 x float> zeroinitializer, <2 x float> %i.dq ; 2 uses
  %i.ea = fcmp nsz olt <2 x float> %i.dz, splat (float 2.550000e+02)
  %i.eb = select <2 x i1> %i.ea, <2 x float> %i.dz, <2 x float> splat (float 2.550000e+02)
  %i.ec = fadd nsz <2 x float> %i.eb, splat (float 5.000000e-01)
  %i.ed = fptosi <2 x float> %i.ec to <2 x i32>
  %4 = shl <2 x i32> %i.ed, <i32 8, i32 16>       ; 2 uses
  %i.ee = extractelement <2 x i32> %4, i64 0
  %5 = and i32 %i.ee, 65280
  %6 = and i32 %i.dx, 255
  %i.ef = extractelement <2 x i32> %4, i64 1
  %.masked.i17 = or disjoint i32 %5, %i.ef
  %i.eg = or disjoint i32 %6, %.masked.i17
  %i.eh = or i32 %i.eg, -16777216
  br label %_ZL23imageAverageColorInlineILb1EEN5video6SColorEPKNS0_6IImageE.exit
...
_ZL23imageAverageColorInlineILb1EEN5video6SColorEPKNS0_6IImageE.exit: ; preds = %_ZN12_GLOBAL__N_114linear_to_srgbEN4core8vector3dIfEE.exit.i15, %._crit_edge67.i, %bb.m, %_ZN12_GLOBAL__N_114linear_to_srgbEN4core8vector3dIfEE.exit.i, %._crit_edge71.i, %bb.b
  %.sroa.0.0 = phi i32 [ -16777216, %bb.b ], [ -16777216, %._crit_edge71.i ], [ %i.bt, %_ZN12_GLOBAL__N_114linear_to_srgbEN4core8vector3dIfEE.exit.i ], [ -16777216, %._crit_edge67.i ], [ %i.eh, %_ZN12_GLOBAL__N_114linear_to_srgbEN4core8vector3dIfEE.exit.i15 ], [ -16777216, %bb.m ]
  ret i32 %.sroa.0.0
}
...
bb.b:                                             ; preds = %.lr.ph.us, %bb.b
  ...
  br i1 %i.ch, label %bb.b, label %._crit_edge.us, !llvm.loop !60

._crit_edge.us:                                   ; preds = %bb.b
  %i.ci = fcmp nsz olt float %i.az, %.0128
  br i1 %i.ci, label %.lr.ph.us, label %._crit_edge147, !llvm.loop !61
...
._crit_edge147.thread:                            ; preds = %.lr.ph146, %_Z8rangelimIfifET_RKS0_RKT0_RKT1_.exit, %._crit_edge147, %bb.c
  ...
  store i32 %storemerge, ptr %3, align 4, !tbaa !58
  %i.cs = load ptr, ptr %2, align 8, !tbaa !41
  %i.ct = getelementptr inbounds nuw i8, ptr %i.cs, i64 24
  %i.cu = load ptr, ptr %i.ct, align 8
  call void %i.cu(ptr noundef nonnull align 8 dereferenceable(41) %2, i32 noundef %.082157, i32 noundef %.083158, ptr noundef nonnull align 4 dereferenceable(4) %3, i1 noundef zeroext false)
  %i.cv = add nuw i32 %.082157, 1                 ; 2 uses
  %exitcond.not = icmp eq i32 %i.cv, %i.m
  br i1 %exitcond.not, label %._crit_edge, label %_Z8rangelimIfifET_RKS0_RKT0_RKT1_.exit, !llvm.loop !62

._crit_edge:                                      ; preds = %._crit_edge147.thread
  %i.cw = add nuw i32 %.083158, 1                 ; 2 uses
  %exitcond166.not = icmp eq i32 %i.cw, %i.h
  br i1 %exitcond166.not, label %._crit_edge159.split, label %.preheader, !llvm.loop !63
