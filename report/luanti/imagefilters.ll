...
_ZN12_GLOBAL__N_114linear_to_srgbEN4core8vector3dIfEE.exit.i: ; preds = %bb.l, %bb.k
  ...
  %i.bp = fptosi <2 x float> %i.bo to <2 x i32>   ; 2 uses
  %i.bq = extractelement <2 x i32> %i.bp, i64 1
  %3 = shl i32 %i.bq, 16
  %.masked.i = or disjoint i32 %2, %3
  %i.br = extractelement <2 x i32> %i.bp, i64 0
  %4 = and i32 %i.br, 255
  %i.bs = or disjoint i32 %4, %.masked.i
...
_ZN12_GLOBAL__N_114linear_to_srgbEN4core8vector3dIfEE.exit.i15: ; preds = %bb.w, %bb.v
  ...
  %i.ed = fptosi <2 x float> %i.ec to <2 x i32>   ; 2 uses
  %i.ee = extractelement <2 x i32> %i.ed, i64 1
  %7 = shl i32 %i.ee, 16
  %.masked.i17 = or disjoint i32 %6, %7
  %i.ef = extractelement <2 x i32> %i.ed, i64 0
  %8 = and i32 %i.ef, 255
  %i.eg = or disjoint i32 %8, %.masked.i17
