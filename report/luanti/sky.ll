...
_ZN4core5arrayINS_8vector3dIfEEE8set_usedEj.exit: ; preds = %bb.b, %bb.c, %bb.d, %_ZSt8_DestroyIPN4core8vector3dIfEES2_EvT_S4_RSaIT0_E.exit.i.i.i
  ...
  %i.cc = load ptr, ptr %1, align 8, !tbaa !230   ; 3 uses
  ...
  %3 = load float, ptr %i.cd, align 4, !tbaa !179 ; 2 uses
  %4 = load float, ptr %2, align 4, !tbaa !178    ; 2 uses
  %i.cf = load float, ptr %i.ce, align 4, !tbaa !177 ; 2 uses
  ...
  %i.cx = load ptr, ptr %1, align 8, !tbaa !230   ; 3 uses
  ...
  %11 = load float, ptr %i.cy, align 4, !tbaa !179 ; 2 uses
  %12 = load float, ptr %10, align 4, !tbaa !178  ; 2 uses
  %i.da = load float, ptr %i.cz, align 4, !tbaa !177 ; 2 uses
  ...
  %i.ds = load ptr, ptr %1, align 8, !tbaa !230   ; 3 uses
  ...
  %19 = load float, ptr %i.dt, align 4, !tbaa !179 ; 2 uses
  %20 = load float, ptr %18, align 4, !tbaa !178  ; 2 uses
  %i.dv = load float, ptr %i.du, align 4, !tbaa !177 ; 2 uses
  ...
  %i.en = load ptr, ptr %1, align 8, !tbaa !230   ; 3 uses
  ...
  %27 = load float, ptr %i.eo, align 4, !tbaa !179 ; 2 uses
  %28 = load float, ptr %26, align 4, !tbaa !178  ; 2 uses
  %i.eq = load float, ptr %i.ep, align 4, !tbaa !177 ; 2 uses
  ...
  %i.fi = load ptr, ptr %1, align 8, !tbaa !230   ; 3 uses
  ...
  %35 = load float, ptr %i.fj, align 4, !tbaa !179 ; 2 uses
  %36 = load float, ptr %34, align 4, !tbaa !178  ; 2 uses
  %i.fl = load float, ptr %i.fk, align 4, !tbaa !177 ; 2 uses
  ...
  %i.gd = load ptr, ptr %1, align 8, !tbaa !230   ; 3 uses
  ...
  %43 = load float, ptr %i.ge, align 4, !tbaa !179 ; 2 uses
  %44 = load float, ptr %42, align 4, !tbaa !178  ; 2 uses
  %i.gg = load float, ptr %i.gf, align 4, !tbaa !177 ; 2 uses
  ...
  %i.gy = load ptr, ptr %1, align 8, !tbaa !230   ; 3 uses
  ...
  %51 = load float, ptr %i.gz, align 4, !tbaa !179 ; 2 uses
  %52 = load float, ptr %50, align 4, !tbaa !178  ; 2 uses
  %i.hb = load float, ptr %i.ha, align 4, !tbaa !177 ; 2 uses
