...
bb.ac:                                            ; preds = %.lr.ph, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSERKS4_.exit
  ...
  %17 = insertelement <2 x float> %i.hw, float %.sroa.22.0.copyload.i205, i64 0 ; 2 uses
  %i.ia = fcmp nsz ogt <2 x float> %17, zeroinitializer
  %i.ib = select <2 x i1> %i.ia, <2 x float> splat (float 5.000000e+00), <2 x float> splat (float -5.000000e+00)
  %i.ic = fadd nsz <2 x float> %17, %i.ib
...
._crit_edge:                                      ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSERKS4_.exit, %bb.ab
  ...
  %18 = insertelement <2 x float> poison, float %.sroa.22.0.copyload.i, i64 0
  %i.kb = insertelement <2 x float> %18, float %i.jv, i64 1 ; 2 uses
