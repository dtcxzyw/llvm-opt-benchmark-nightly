...
bb.n:                                             ; preds = %.lr.ph, %bb.n
  ...
  %i.dw = getelementptr inbounds nuw [4 x i8], ptr %i.cz, i64 %i.dv
...
bb.p:                                             ; preds = %bb.o, %._crit_edge97.split
  %i.dz = icmp eq ptr %i.df, null
  br i1 %i.dz, label %_ZNK9VoxelArea14hasEmptyExtentEv.exit.thread, label %bb.q
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.cl, label %middle.block, label %vector.body, !llvm.loop !129
