...
bb.j:                                             ; preds = %bb.i
  ...
  %i.ey = load <3 x float>, ptr %i.eh, align 8, !tbaa !95 ; 4 uses
  %i.ez = load <2 x float>, ptr %3, align 4, !tbaa !95 ; 2 uses
  %i.fa = load <2 x float>, ptr %i.ew, align 4, !tbaa !95 ; 2 uses
  %i.fb = shufflevector <3 x float> %i.ey, <3 x float> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  ...
  %31 = load float, ptr %.sroa.5113.0..sroa_idx, align 4, !tbaa !141 ; 2 uses
  %32 = insertelement <2 x float> poison, float %31, i64 0
  %i.fo = shufflevector <2 x float> %32, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %33 = load <2 x float>, ptr %i.ej, align 4, !tbaa !95 ; 3 uses
  %34 = shufflevector <2 x float> %i.fb, <2 x float> %33, <2 x i32> <i32 0, i32 3>
  ...
  %i.ft = fmul nsz <2 x float> %34, %i.fs
  ...
  %35 = shufflevector <3 x float> %i.ey, <3 x float> poison, <2 x i32> <i32 2, i32 poison>
  ...
  %i.fz = call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %36, <2 x float> %i.fy, <2 x float> %i.fw) ; 2 uses
  %i.ga = extractelement <2 x float> %i.fz, i64 0
  store float %i.ga, ptr %.sroa.5121.0..sroa_idx, align 8, !tbaa !95
  %37 = shufflevector <2 x float> %33, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %38 = fmul nsz <2 x float> %i.fa, %37
  %39 = shufflevector <2 x float> %33, <2 x float> poison, <2 x i32> zeroinitializer
  %40 = call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %39, <2 x float> %i.ez, <2 x float> %38)
  %41 = call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.fo, <2 x float> %i.ff, <2 x float> %40)
  store <2 x float> %41, ptr %i.ej, align 4
...
_ZN4core5arrayINS_8vector3dIfEEE8set_usedEj.exit: ; preds = %bb.b, %bb.c, %bb.d, %_ZSt8_DestroyIPN4core8vector3dIfEES2_EvT_S4_RSaIT0_E.exit.i.i.i
  ...
  %i.cc = load ptr, ptr %1, align 8, !tbaa !434   ; 3 uses
  ...
  %3 = load float, ptr %i.cd, align 4, !tbaa !203 ; 2 uses
  %4 = load float, ptr %2, align 4, !tbaa !202    ; 2 uses
  %i.cf = load float, ptr %i.ce, align 4, !tbaa !141 ; 2 uses
  ...
  %i.cx = load ptr, ptr %1, align 8, !tbaa !434   ; 3 uses
  ...
  %11 = load float, ptr %i.cy, align 4, !tbaa !203 ; 2 uses
  %12 = load float, ptr %10, align 4, !tbaa !202  ; 2 uses
  %i.da = load float, ptr %i.cz, align 4, !tbaa !141 ; 2 uses
  ...
  %i.ds = load ptr, ptr %1, align 8, !tbaa !434   ; 3 uses
  ...
  %19 = load float, ptr %i.dt, align 4, !tbaa !203 ; 2 uses
  %20 = load float, ptr %18, align 4, !tbaa !202  ; 2 uses
  %i.dv = load float, ptr %i.du, align 4, !tbaa !141 ; 2 uses
  ...
  %i.en = load ptr, ptr %1, align 8, !tbaa !434   ; 3 uses
  ...
  %27 = load float, ptr %i.eo, align 4, !tbaa !203 ; 2 uses
  %28 = load float, ptr %26, align 4, !tbaa !202  ; 2 uses
  %i.eq = load float, ptr %i.ep, align 4, !tbaa !141 ; 2 uses
  ...
  %i.fi = load ptr, ptr %1, align 8, !tbaa !434   ; 3 uses
  ...
  %35 = load float, ptr %i.fj, align 4, !tbaa !203 ; 2 uses
  %36 = load float, ptr %34, align 4, !tbaa !202  ; 2 uses
  %i.fl = load float, ptr %i.fk, align 4, !tbaa !141 ; 2 uses
  ...
  %i.gd = load ptr, ptr %1, align 8, !tbaa !434   ; 3 uses
  ...
  %43 = load float, ptr %i.ge, align 4, !tbaa !203 ; 2 uses
  %44 = load float, ptr %42, align 4, !tbaa !202  ; 2 uses
  %i.gg = load float, ptr %i.gf, align 4, !tbaa !141 ; 2 uses
  ...
  %i.gy = load ptr, ptr %1, align 8, !tbaa !434   ; 3 uses
  ...
  %51 = load float, ptr %i.gz, align 4, !tbaa !203 ; 2 uses
  %52 = load float, ptr %50, align 4, !tbaa !202  ; 2 uses
  %i.hb = load float, ptr %i.ha, align 4, !tbaa !141 ; 2 uses
