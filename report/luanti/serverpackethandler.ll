...
bb.bn:                                            ; preds = %bb.bm
  ...
  %.sroa.0142.0.copyload = load i48, ptr %i.iy, align 2 ; 5 uses
  ...
  %38 = bitcast i48 %.sroa.0142.0.copyload to <3 x i16>
  %39 = shufflevector <3 x i16> %38, <3 x i16> poison, <2 x i32> <i32 0, i32 1>
  %i.jd = sext <2 x i16> %39 to <2 x i32>         ; 2 uses
