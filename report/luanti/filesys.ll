...
.lr.ph:                                           ; preds = %.preheader, %bb.j
  %.16492 = phi i64 [ %i.ad, %bb.j ], [ %.063, %.preheader ] ; 3 uses
  %i.aa = getelementptr inbounds nuw i8, ptr %i.g, i64 %.16492
  %i.ab = load i8, ptr %i.aa, align 1, !tbaa !19
  %i.ac = icmp eq i8 %i.ab, 47
  br i1 %i.ac, label %bb.j, label %.critedge

bb.j:                                             ; preds = %.lr.ph
  %i.ad = add i64 %.16492, 1                      ; 2 uses
...
.critedge:                                        ; preds = %.lr.ph, %bb.j, %.preheader
  %.164.lcssa = phi i64 [ %.063, %.preheader ], [ %i.e, %bb.j ], [ %.16492, %.lr.ph ] ; 2 uses
  %i.ae = icmp ult i64 %.073, %i.b
  br i1 %i.ae, label %.lr.ph96, label %.critedge4

.lr.ph96:                                         ; preds = %.critedge, %bb.k
  %.17495 = phi i64 [ %i.ai, %bb.k ], [ %.073, %.critedge ] ; 3 uses
  %i.af = getelementptr inbounds nuw i8, ptr %i.h, i64 %.17495
  %i.ag = load i8, ptr %i.af, align 1, !tbaa !19
  %i.ah = icmp eq i8 %i.ag, 47
  br i1 %i.ah, label %bb.k, label %.critedge4

bb.k:                                             ; preds = %.lr.ph96
  %i.ai = add i64 %.17495, 1                      ; 2 uses
...
.critedge4:                                       ; preds = %.lr.ph96, %.critedge
  %.174.lcssa = phi i64 [ %.073, %.critedge ], [ %.17495, %.lr.ph96 ] ; 2 uses
  %i.aj = icmp eq i64 %.174.lcssa, %i.b
  br i1 %i.aj, label %.thread83, label %bb.l

bb.l:                                             ; preds = %.critedge4
  %i.ak = icmp eq i64 %.164.lcssa, %i.e
  br i1 %i.ak, label %.thread83, label %.backedge

.backedge:                                        ; preds = %bb.l, %.thread
  %.073.be = phi i64 [ %i.az, %.thread ], [ %.174.lcssa, %bb.l ]
  %.063.be = phi i64 [ %.lcssa102, %.thread ], [ %.164.lcssa, %bb.l ]
  br label %bb.d, !llvm.loop !168

bb.m:                                             ; preds = %.preheader88, %bb.q
  %.068 = phi i64 [ %i.ap, %bb.q ], [ 0, %.preheader88 ] ; 4 uses
  %i.al = getelementptr i8, ptr %i.u, i64 %.068
  %i.am = load i8, ptr %i.al, align 1, !tbaa !19
  %i.an = getelementptr i8, ptr %i.v, i64 %.068
  %i.ao = load i8, ptr %i.an, align 1, !tbaa !19
  %.not80 = icmp eq i8 %i.am, %i.ao
  %i.ap = add i64 %.068, 1                        ; 4 uses
  br i1 %.not80, label %bb.n, label %.thread83

bb.n:                                             ; preds = %bb.m
  %i.aq = add i64 %i.ap, %.063                    ; 4 uses
  %exitcond.not = icmp eq i64 %.068, %i.y
...
.preheader155:                                    ; preds = %.preheader155.lr.ph, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit136
  %.044241 = phi i64 [ %i.h, %.preheader155.lr.ph ], [ %.448, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit136 ] ; 9 uses
  %.049240 = phi i64 [ 0, %.preheader155.lr.ph ], [ %.150153, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit136 ] ; 4 uses
...
bb.c:                                             ; preds = %.preheader155, %bb.b
  %.145370 = phi i64 [ %.044241, %.preheader155 ], [ %i.w, %bb.b ] ; 2 uses
  %i.w = add i64 %.145370, -1                     ; 4 uses
...
.critedge:                                        ; preds = %bb.b, %bb.c
  %.145.lcssa = phi i64 [ %i.w, %bb.b ], [ %.145370, %bb.c ] ; 5 uses
  %.not57371 = icmp eq i64 %.145.lcssa, 0
...
.split51:                                         ; preds = %bb.d, %.critedge
  %.246.lcssa = phi i64 [ %.145.lcssa, %.critedge ], [ %i.al, %bb.d ]
  ...
  %spec.select.i.i.i = call noundef i64 @llvm.umin.i64(i64 %.145.lcssa, i64 %i.ab) ; 4 uses
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.d
  %.246372 = phi i64 [ %i.al, %bb.d ], [ %.145.lcssa, %.lr.ph.preheader ] ; 6 uses
  %i.al = add i64 %.246372, -1                    ; 4 uses
...
.split:                                           ; preds = %.lr.ph
  ...
  %i.aq = icmp ugt i64 %.246372, %i.ap
  br i1 %i.aq, label %bb.g, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8_M_checkEmPKc.exit.i.i

bb.g:                                             ; preds = %.split
  call void (ptr, ...) @_ZSt24__throw_out_of_range_fmtPKcz(ptr noundef nonnull @.str.39, ptr noundef nonnull @.str.43, i64 noundef %.246372, i64 noundef %i.ap) #27, !noalias !175
  unreachable
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8_M_checkEmPKc.exit.i.i: ; preds = %.split
  ...
  %i.ar = getelementptr inbounds nuw i8, ptr %i.aa, i64 %.246372 ; 2 uses
  %8 = call i64 @llvm.umin.i64(i64 %.145.lcssa, i64 %i.ap)
  %spec.select.i.i.i69 = sub nuw i64 %8, %.246372 ; 4 uses
...
.critedge2:                                       ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6substrEmm.exit, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6substrEmm.exit72
  %.246351 = phi i64 [ %.246.lcssa, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6substrEmm.exit ], [ %.246372, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6substrEmm.exit72 ] ; 4 uses
...
.split152:                                        ; preds = %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit, %.critedge2, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit74
  %.not58.not = icmp eq i64 %.049240, 0
  %spec.select = call i64 @llvm.usub.sat.i64(i64 %.049240, i64 1) ; 2 uses
...
.preheader:                                       ; preds = %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit74.thread, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit, %.split152
  %.150154.ph = phi i64 [ %spec.select, %.split152 ], [ %.049240, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit ], [ %i.bi, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit74.thread ]
  %.not59375 = icmp eq i64 %.246351, 0
...
.lr.ph378:                                        ; preds = %.lr.ph378.preheader, %bb.j
  %.347376 = phi i64 [ %i.bk, %bb.j ], [ %.246351, %.lr.ph378.preheader ] ; 2 uses
  %i.bk = add i64 %.347376, -1                    ; 4 uses
...
.critedge4:                                       ; preds = %bb.j, %..critedge4_crit_edge381, %.preheader
  %.347.lcssa = phi i64 [ %.246351, %.preheader ], [ %.347376, %..critedge4_crit_edge381 ], [ %i.bk, %bb.j ] ; 2 uses
...
bb.k:                                             ; preds = %.critedge4
  ...
  %i.bp = icmp ugt i64 %.044241, %i.bo
  br i1 %i.bp, label %bb.l, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8_M_checkEmPKc.exit.i.i75

bb.l:                                             ; preds = %bb.k
  invoke void (ptr, ...) @_ZSt24__throw_out_of_range_fmtPKcz(ptr noundef nonnull @.str.39, ptr noundef nonnull @.str.43, i64 noundef %.044241, i64 noundef %i.bo) #27
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8_M_checkEmPKc.exit.i.i75: ; preds = %bb.k
  ...
  %i.br = getelementptr inbounds nuw i8, ptr %i.bq, i64 %.044241 ; 2 uses
  %i.bs = sub nuw i64 %i.bo, %.044241             ; 4 uses
