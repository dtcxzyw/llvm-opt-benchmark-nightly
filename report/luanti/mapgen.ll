...
bb.b:                                             ; preds = %.lr.ph, %.loopexit.split
  %.040139 = phi i32 [ %i.e, %.lr.ph ], [ %i.hp, %.loopexit.split ] ; 3 uses
...
bb.s:                                             ; preds = %bb.r
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 2 dereferenceable(6) %i.cj, ptr noundef nonnull align 2 dereferenceable(6) %i.ch, i64 6, i1 false), !tbaa.struct !216
...
.noexc39:                                         ; preds = %_ZNKSt6vectorIN4core8vector3dIsEESaIS2_EE12_M_check_lenEmPKc.exit.i.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 2 dereferenceable(6) %i.da, ptr noundef nonnull align 2 dereferenceable(6) %i.ch, i64 6, i1 false), !tbaa.struct !216
