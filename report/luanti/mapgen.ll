...
_Z8rangelimIsiiET_RKS0_RKT0_RKT1_.exit:
  ...
  %.sroa.25.0.extract.trunc.a = trunc nuw i48 %.sroa.3.0.extract.shift to i16 ; 2 uses
  %.sroa.25.0.extract.trunc = trunc i48 %.sroa.25.0.extract.shift to i16 ; 2 uses
  %.sroa.3.0.extract.trunc = trunc i48 %1 to i16  ; 2 uses
  %4 = or i16 %.0.i, 15
  %5 = sext i16 %.sroa.25.0.extract.trunc.a to i32
  %6 = sext i16 %.sroa.25.0.extract.trunc to i32
  %i.a = sext i16 %.sroa.3.0.extract.trunc to i32
  %7 = shl nsw i32 %5, 4                          ; 5 uses
  %8 = shl nsw i32 %6, 4                          ; 5 uses
  %9 = shl nsw i32 %i.a, 4                        ; 5 uses
  %10 = trunc i32 %9 to i16
  %i.b = sdiv i16 %.sroa.25.0.extract.trunc.a, -2
  %11 = sdiv i16 %.sroa.25.0.extract.trunc, -2
  %12 = sdiv i16 %.sroa.3.0.extract.trunc, -2
  %13 = shl i16 %i.b, 4                           ; 3 uses
  %i.c = shl i16 %11, 4                           ; 3 uses
  %14 = shl i16 %12, 4                            ; 3 uses
  %i.d = add i16 %14, %10                         ; 2 uses
  %.neg = mul nsw i16 %3, -16
  %i.e = add i16 %i.d, -1
  %i.f = or disjoint i16 %i.d, 15
  %i.g = sext i16 %i.f to i32
  %i.h = sext i16 %.neg to i32                    ; 3 uses
  %i.i = trunc i32 %8 to i16
  %i.j = add i16 %i.c, %i.i                       ; 2 uses
  %i.k = add i16 %i.j, -1
  ...
  %i.o = add i16 %i.c, -16
  %i.p = add i16 %14, -16
  %i.q = zext nneg i16 %4 to i32                  ; 3 uses
  ...
  %i.w = mul i32 %.sroa.speculated.i12, %8
  ...
  %i.az = sub i16 %i.c, %i.av
  %i.ba = sub i16 %14, %i.aw
