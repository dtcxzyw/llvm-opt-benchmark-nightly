Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/luanti/original/light?download=true
inline.NumInlined: 71
inline.NumDeleted: 35
begin_hunk_0_@_Z15set_light_curvef:._crit_edge.i.i
  %i.aw = fcmp nsz ogt float %i.au, 1.000000e+00
  %..i58 = select nsz i1 %i.aw, float 1.000000e+00, float %i.au
  %.0.i59 = select nsz i1 %i.av, float 0.000000e+00, float %..i58
  %i.ax = load ptr, ptr %4, align 8, !tbaa !20    ; 2 uses
  %i.ay = icmp eq ptr %i.ax, %i.ao
  br i1 %i.ay, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit63, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i61

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i61: ; preds = %_Z8rangelimIfffET_RKS0_RKT0_RKT1_.exit60
  %i.az = load i64, ptr %i.ao, align 8, !tbaa !9
  %i.ba = add i64 %i.az, 1
  call void @_ZdlPvm(ptr noundef %i.ax, i64 noundef %i.ba) #8
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit63

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit63: ; preds = %_Z8rangelimIfffET_RKS0_RKT0_RKT1_.exit60, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i61
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #7
  %i.bb = load ptr, ptr @g_settings, align 8, !tbaa !13
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #7
  %i.bc = getelementptr inbounds nuw i8, ptr %5, i64 16 ; 6 uses
  store ptr %i.bc, ptr %5, align 8, !tbaa !16
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #7
  store i64 21, ptr %i.a, align 8, !tbaa !21
  %i.bd = invoke noundef ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm(ptr noundef nonnull align 8 dereferenceable(32) %5, ptr noundef nonnull align 8 dereferenceable(8) %i.a, i64 noundef 0)
          to label %.noexc66 unwind label %bb.g   ; 2 uses

.noexc66:                                         ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit63
  store ptr %i.bd, ptr %5, align 8, !tbaa !20
  %i.be = load i64, ptr %i.a, align 8, !tbaa !21  ; 3 uses
  store i64 %i.be, ptr %i.bc, align 8, !tbaa !9
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(21) %i.bd, ptr noundef nonnull align 1 dereferenceable(21) @.str.4, i64 21, i1 false)
  %i.bf = getelementptr inbounds nuw i8, ptr %5, i64 8
  store i64 %i.be, ptr %i.bf, align 8, !tbaa !19
  %i.bg = load ptr, ptr %5, align 8, !tbaa !20
  %i.bh = getelementptr inbounds nuw i8, ptr %i.bg, i64 %i.be
  store i8 0, ptr %i.bh, align 1, !tbaa !9
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #7
  %i.bi = invoke noundef float @_ZNK8Settings8getFloatERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(ptr noundef nonnull align 8 dereferenceable(236) %i.bb, ptr noundef nonnull align 8 dereferenceable(32) %5)
          to label %_Z8rangelimIfffET_RKS0_RKT0_RKT1_.exit70 unwind label %bb.h ; 3 uses

_Z8rangelimIfffET_RKS0_RKT0_RKT1_.exit70:         ; preds = %.noexc66
  %i.bj = fcmp nsz olt float %i.bi, 0.000000e+00
  %i.bk = fcmp nsz ogt float %i.bi, 4.000000e-01
  %..i68 = select nsz i1 %i.bk, float 4.000000e-01, float %i.bi
  %.0.i69 = select nsz i1 %i.bj, float 0.000000e+00, float %..i68
  %i.bl = load ptr, ptr %5, align 8, !tbaa !20    ; 2 uses
  %i.bm = icmp eq ptr %i.bl, %i.bc
  br i1 %i.bm, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit73, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i71

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i71: ; preds = %_Z8rangelimIfffET_RKS0_RKT0_RKT1_.exit70
  %i.bn = load i64, ptr %i.bc, align 8, !tbaa !9
  %i.bo = add i64 %i.bn, 1
  call void @_ZdlPvm(ptr noundef %i.bl, i64 noundef %i.bo) #8
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit73

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit73: ; preds = %_Z8rangelimIfffET_RKS0_RKT0_RKT1_.exit70, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i71
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #7
  %i.bp = fcmp nsz olt float %0, 3.300000e-01
  %i.bq = fcmp nsz ogt float %0, 3.000000e+00
  %..i74 = select nsz i1 %i.bq, float 3.000000e+00, float %0
  store i8 0, ptr @_ZL9light_LUT, align 16, !tbaa !9
  store i8 -1, ptr getelementptr inbounds nuw (i8, ptr @_ZL9light_LUT, i64 15), align 1, !tbaa !9
  %i.br = fdiv nsz float 1.000000e+00, %..i74
  %i.bs = select i1 %i.bp, float f0x4041F07C, float %i.br
  br label %bb.i
...
bb.b:                                             ; preds = %._crit_edge.i.i
  %i.bt = landingpad { ptr, i32 }
          cleanup
  %i.bu = load ptr, ptr %1, align 8, !tbaa !20    ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i77: ; preds = %bb.b
  %i.bw = load i64, ptr %i.d, align 8, !tbaa !9
  %i.bx = add i64 %i.bw, 1
...
bb.c:                                             ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  %i.by = landingpad { ptr, i32 }
          cleanup
  %i.bz = load ptr, ptr %2, align 8, !tbaa !20    ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i80: ; preds = %bb.c
  %i.cb = load i64, ptr %i.o, align 8, !tbaa !9
  %i.cc = add i64 %i.cb, 1
...
bb.d:                                             ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit43
  %i.cd = landingpad { ptr, i32 }
          cleanup
  %i.ce = load ptr, ptr %3, align 8, !tbaa !20    ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i83: ; preds = %bb.d
  %i.cg = load i64, ptr %i.ad, align 8, !tbaa !9
  %i.ch = add i64 %i.cg, 1
...
bb.f:                                             ; preds = %.noexc56
  %i.cj = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.ck = load ptr, ptr %4, align 8, !tbaa !20    ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i86: ; preds = %bb.f
  %i.cm = load i64, ptr %i.ao, align 8, !tbaa !9
  %i.cn = add i64 %i.cm, 1
...
bb.h:                                             ; preds = %.noexc66
  %i.cp = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.cq = load ptr, ptr %5, align 8, !tbaa !20    ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i89: ; preds = %bb.h
  %i.cs = load i64, ptr %i.bc, align 8, !tbaa !9
  %i.ct = add i64 %i.cs, 1
...
bb.i:                                             ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit73, %bb.n
  %.0121 = phi i64 [ 1, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit73 ], [ %i.dy, %bb.n ] ; 4 uses
  %i.cu = uitofp nsz nneg i64 %.0121 to float
...
_ZNK12_GLOBAL__N_110LightCurve3getEf.exit.thread: ; preds = %bb.j
  %i.di = getelementptr inbounds nuw i8, ptr @_ZL9light_LUT, i64 %.0121 ; 3 uses
  store i8 0, ptr %i.di, align 1, !tbaa !9
...
_ZNK12_GLOBAL__N_110LightCurve3getEf.exit:        ; preds = %bb.i, %bb.k, %bb.l
  %.1.i = phi i32 [ 255, %bb.i ], [ %i.dp, %bb.l ], [ 255, %bb.k ] ; 2 uses
  %i.dq = trunc nuw i32 %.1.i to i8
  %i.dr = getelementptr inbounds nuw i8, ptr @_ZL9light_LUT, i64 %.0121 ; 3 uses
  store i8 %i.dq, ptr %i.dr, align 1, !tbaa !9
  %i.ds = getelementptr i8, ptr %i.dr, i64 -1
  %i.dt = load i8, ptr %i.ds, align 1, !tbaa !9   ; 2 uses
  %i.du = zext i8 %i.dt to i32
  %.not = icmp samesign ugt i32 %.1.i, %i.du
  br i1 %.not, label %bb.n, label %bb.m

bb.m:                                             ; preds = %_ZNK12_GLOBAL__N_110LightCurve3getEf.exit.thread, %_ZNK12_GLOBAL__N_110LightCurve3getEf.exit
  %i.dv = phi i8 [ %i.dk, %_ZNK12_GLOBAL__N_110LightCurve3getEf.exit.thread ], [ %i.dt, %_ZNK12_GLOBAL__N_110LightCurve3getEf.exit ]
  %i.dw = phi ptr [ %i.di, %_ZNK12_GLOBAL__N_110LightCurve3getEf.exit.thread ], [ %i.dr, %_ZNK12_GLOBAL__N_110LightCurve3getEf.exit ]
  %i.dx = call i8 @llvm.uadd.sat.i8(i8 %i.dv, i8 1)
  store i8 %i.dx, ptr %i.dw, align 1, !tbaa !9
  br label %bb.n

bb.n:                                             ; preds = %bb.m, %_ZNK12_GLOBAL__N_110LightCurve3getEf.exit
  %i.dy = add nuw nsw i64 %.0121, 1               ; 2 uses
  %exitcond.not = icmp eq i64 %i.dy, 15
  br i1 %exitcond.not, label %bb.a, label %bb.i, !llvm.loop !10
...
bb.b:                                             ; preds = %bb.a
  %i.g = load i8, ptr getelementptr inbounds nuw (i8, ptr @_ZL9light_LUT, i64 15), align 1, !tbaa !9
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.l = fsub nsz float 1.000000e+00, %i.i
  %i.m = load <2 x i8>, ptr %i.k, align 1, !tbaa !9
  %i.n = uitofp <2 x i8> %i.m to <2 x float>      ; 2 uses
  %i.o = extractelement <2 x float> %i.n, i64 1
  %i.p = fmul nsz float %i.i, %i.o
  %i.q = extractelement <2 x float> %i.n, i64 0
  %i.r = tail call nsz float @llvm.fmuladd.f32(float %i.q, float %i.l, float %i.p)
  br label %bb.d

bb.d:                                             ; preds = %bb.c, %bb.b
  %.0.in = phi float [ %i.h, %bb.b ], [ %i.r, %bb.c ]
