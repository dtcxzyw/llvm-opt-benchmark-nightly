...
bb.a:
  ...
  %i.l = load i16, ptr %i.c, align 8, !tbaa !134
  %i.m = sitofp nsz i16 %i.l to float
  %i.n = load i16, ptr %i.f, align 4, !tbaa !135
...
.lr.ph82:                                         ; preds = %bb.a
  ...
  %i.al = getelementptr inbounds nuw i8, ptr %0, i64 252 ; 2 uses
  %.pre = load i16, ptr %i.ag, align 8, !tbaa !138 ; 2 uses
  br label %bb.b
...
bb.b:                                             ; preds = %.lr.ph82, %._crit_edge70
  %i.am = phi i16 [ %i.af, %.lr.ph82 ], [ %1, %._crit_edge70 ]
  %i.an = phi i16 [ %.pre, %.lr.ph82 ], [ %3, %._crit_edge70 ] ; 2 uses
  %i.ao = phi i16 [ %.pre, %.lr.ph82 ], [ %4, %._crit_edge70 ] ; 2 uses
  %.03480 = phi i16 [ %i.ac, %.lr.ph82 ], [ %i.ax, %._crit_edge70 ] ; 2 uses
  %.03579 = phi i32 [ -31007, %.lr.ph82 ], [ %.1.lcssa, %._crit_edge70 ] ; 2 uses
  %.03678 = phi i32 [ 0, %.lr.ph82 ], [ %i.aw, %._crit_edge70 ] ; 2 uses
  %.03977 = phi i32 [ 0, %.lr.ph82 ], [ %.140.lcssa, %._crit_edge70 ] ; 2 uses
  %i.ap = load i16, ptr %i.u, align 2, !tbaa !136
...
.._crit_edge70_crit_edge:                         ; preds = %bb.b
  %.pre90 = load i32, ptr %i.al, align 4, !tbaa !139
  br label %._crit_edge70

.lr.ph69:                                         ; preds = %bb.b
  %i.au = sext i16 %.03480 to i32
  %i.av = load i16, ptr %i.ad, align 2, !tbaa !140
  br label %.lr.ph69.split

._crit_edge70.loopexit85:                         ; preds = %._crit_edge
  %.pre91 = load i16, ptr %i.ae, align 2, !tbaa !137
  br label %._crit_edge70

._crit_edge70:                                    ; preds = %.._crit_edge70_crit_edge, %._crit_edge70.loopexit85
  %1 = phi i16 [ %i.am, %.._crit_edge70_crit_edge ], [ %.pre91, %._crit_edge70.loopexit85 ] ; 2 uses
  %2 = phi i32 [ %.pre90, %.._crit_edge70_crit_edge ], [ %i.cb, %._crit_edge70.loopexit85 ]
  %3 = phi i16 [ %i.an, %.._crit_edge70_crit_edge ], [ %i.bz, %._crit_edge70.loopexit85 ]
  %4 = phi i16 [ %i.ao, %.._crit_edge70_crit_edge ], [ %i.bz, %._crit_edge70.loopexit85 ]
  %.140.lcssa = phi i32 [ %.03977, %.._crit_edge70_crit_edge ], [ %.241.lcssa, %._crit_edge70.loopexit85 ]
  %.137.lcssa = phi i32 [ %.03678, %.._crit_edge70_crit_edge ], [ %i.cc, %._crit_edge70.loopexit85 ]
  %.1.lcssa = phi i32 [ %.03579, %.._crit_edge70_crit_edge ], [ %.2.lcssa, %._crit_edge70.loopexit85 ] ; 2 uses
  %i.aw = add i32 %2, %.137.lcssa
  %i.ax = add i16 %.03480, 1                      ; 2 uses
  %.not = icmp sgt i16 %i.ax, %1
  br i1 %.not, label %._crit_edge83, label %bb.b, !llvm.loop !131

.lr.ph69.split:                                   ; preds = %.lr.ph69, %._crit_edge
  %i.ay = phi i16 [ %i.an, %.lr.ph69 ], [ %i.bz, %._crit_edge ]
  %i.az = phi i16 [ %i.av, %.lr.ph69 ], [ %i.ca, %._crit_edge ] ; 2 uses
  %i.ba = phi i32 [ %i.ar, %.lr.ph69 ], [ %i.ce, %._crit_edge ] ; 3 uses
  %.03367 = phi i16 [ %i.aq, %.lr.ph69 ], [ %i.cd, %._crit_edge ] ; 2 uses
  %.166 = phi i32 [ %.03579, %.lr.ph69 ], [ %.2.lcssa, %._crit_edge ] ; 2 uses
  %.13765 = phi i32 [ %.03678, %.lr.ph69 ], [ %i.cc, %._crit_edge ] ; 2 uses
  %.14064 = phi i32 [ %.03977, %.lr.ph69 ], [ %.241.lcssa, %._crit_edge ] ; 2 uses
  %i.bb = load i16, ptr %i.c, align 8, !tbaa !134 ; 3 uses
...
._crit_edge.loopexit:                             ; preds = %bb.l
  %.pre89 = load i16, ptr %i.ag, align 8, !tbaa !138
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.lr.ph69.split
  ...
  %i.cb = load i32, ptr %i.al, align 4, !tbaa !139 ; 2 uses
  ...
  br i1 %.not44, label %._crit_edge70.loopexit85, label %.lr.ph69.split, !llvm.loop !132
...
bb.c:                                             ; preds = %.lr.ph, %bb.l
  ...
  %i.cm = load i16, ptr %i.cl, align 4, !tbaa !152
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.cp = load ptr, ptr %i.co, align 8, !tbaa !153
...
bb.i:                                             ; preds = %bb.h
  %i.dq = load i16, ptr %i.ak, align 2, !tbaa !154
...
bb.k:                                             ; preds = %bb.g
  %i.dr = load i16, ptr %i.ai, align 8, !tbaa !155
...
bb.l:                                             ; preds = %bb.k, %bb.j, %bb.i, %bb.c
  ...
  %i.dw = load i16, ptr %i.ad, align 2, !tbaa !140 ; 2 uses
  %.not45 = icmp sgt i16 %i.ds, %i.dw
  br i1 %.not45, label %._crit_edge.loopexit, label %bb.c, !llvm.loop !133
}
...
!139 = !{!46, !6, i64 252}
!140 = !{!46, !12, i64 222}
!141 = !{!"_ZTSN4core8vector3dIiEE", !6, i64 0, !6, i64 4, !6, i64 8}
!142 = !{!"_ZTS9VoxelArea", !13, i64 0, !13, i64 6, !141, i64 12}
!143 = !{!142, !12, i64 0}
!144 = !{!142, !12, i64 4}
!145 = !{!142, !6, i64 16}
!146 = !{!142, !12, i64 2}
!147 = !{!142, !6, i64 12}
!148 = !{!"p1 _ZTS7MapNode", !15, i64 0}
!149 = !{!"_ZTS16VoxelManipulator", !142, i64 8, !148, i64 32, !70, i64 40}
!150 = !{!149, !148, i64 32}
!151 = !{!"_ZTS7MapNode", !12, i64 0, !5, i64 2, !5, i64 3}
!152 = !{!151, !12, i64 0}
!153 = !{!79, !78, i64 80}
!154 = !{!46, !12, i64 242}
!155 = !{!46, !12, i64 240}
