...
bb.a:
  ...
  %i.o = load <4 x float>, ptr %i.g, align 8, !tbaa !8 ; 4 uses
  %5 = load <4 x float>, ptr %i.h, align 8, !tbaa !8 ; 4 uses
  %i.p = shufflevector <4 x float> %3, <4 x float> poison, <4 x i32> zeroinitializer
  %i.q = fmul <4 x float> %i.p, %5
  %i.r = shufflevector <4 x float> %2, <4 x float> poison, <4 x i32> zeroinitializer
  %i.s = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.o, <4 x float> %i.r, <4 x float> %i.q)
  %i.t = load <4 x float>, ptr %i.j, align 8, !tbaa !8 ; 4 uses
  %i.u = shufflevector <4 x float> %4, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.x = shufflevector <4 x float> %i.n, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %6 = load <4 x float>, ptr %i.z, align 8
  ...
  %8 = load <4 x float>, ptr %i.ab, align 8
  %i.ac = getelementptr inbounds nuw i8, ptr %0, i64 460
  %9 = load <4 x float>, ptr %i.ac, align 4
  %i.ad = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.ae = shufflevector <4 x float> %7, <4 x float> poison, <4 x i32> zeroinitializer
  %i.af = fmul <4 x float> %5, %i.ae
  %i.ag = shufflevector <4 x float> %6, <4 x float> poison, <4 x i32> zeroinitializer
  %i.ah = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.o, <4 x float> %i.ag, <4 x float> %i.af)
  %i.ai = shufflevector <4 x float> %8, <4 x float> poison, <4 x i32> zeroinitializer
  %i.aj = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.t, <4 x float> %i.ai, <4 x float> %i.ah)
  %i.ak = shufflevector <4 x float> %9, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %10 = load <4 x float>, ptr %i.am, align 8
  %i.an = getelementptr inbounds nuw i8, ptr %0, i64 468
  %11 = load <4 x float>, ptr %i.an, align 4
  %i.ao = getelementptr inbounds nuw i8, ptr %0, i64 472
  %12 = load <4 x float>, ptr %i.ao, align 8
  %i.ap = getelementptr inbounds nuw i8, ptr %0, i64 476
  %13 = load <4 x float>, ptr %i.ap, align 4
  %i.aq = getelementptr inbounds nuw i8, ptr %1, i64 32
  %i.ar = shufflevector <4 x float> %11, <4 x float> poison, <4 x i32> zeroinitializer
  %i.as = fmul <4 x float> %5, %i.ar
  %i.at = shufflevector <4 x float> %10, <4 x float> poison, <4 x i32> zeroinitializer
  %i.au = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.o, <4 x float> %i.at, <4 x float> %i.as)
  %i.av = shufflevector <4 x float> %12, <4 x float> poison, <4 x i32> zeroinitializer
  %i.aw = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.t, <4 x float> %i.av, <4 x float> %i.au)
  %i.ax = shufflevector <4 x float> %13, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %14 = load <4 x float>, ptr %i.az, align 8
  %i.ba = getelementptr inbounds nuw i8, ptr %0, i64 484
  %15 = load <4 x float>, ptr %i.ba, align 4
  %i.bb = getelementptr inbounds nuw i8, ptr %0, i64 488
  %16 = load <4 x float>, ptr %i.bb, align 8
  %i.bc = getelementptr inbounds nuw i8, ptr %0, i64 492
  %17 = load <4 x float>, ptr %i.bc, align 4
  %i.bd = getelementptr inbounds nuw i8, ptr %1, i64 48
  %i.be = shufflevector <4 x float> %15, <4 x float> poison, <4 x i32> zeroinitializer
  %i.bf = fmul <4 x float> %5, %i.be
  %i.bg = shufflevector <4 x float> %14, <4 x float> poison, <4 x i32> zeroinitializer
  %i.bh = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.o, <4 x float> %i.bg, <4 x float> %i.bf)
  %i.bi = shufflevector <4 x float> %16, <4 x float> poison, <4 x i32> zeroinitializer
  %i.bj = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.t, <4 x float> %i.bi, <4 x float> %i.bh)
  %i.bk = shufflevector <4 x float> %17, <4 x float> poison, <4 x i32> zeroinitializer
