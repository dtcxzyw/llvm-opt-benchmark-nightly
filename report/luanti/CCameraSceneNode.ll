...
bb.b:                                             ; preds = %bb.a
  ...
  %i.k = tail call double @cos(double noundef %i.j) #26 ; 3 uses
  %i.l = tail call double @sin(double noundef %i.j) #26 ; 3 uses
  ...
  %i.r = tail call double @sin(double noundef %i.p) #26 ; 3 uses
  ...
  %2 = fmul double %i.l, %i.r
  %3 = fmul double %i.k, %i.r
  ...
  %4 = insertelement <2 x double> poison, double %i.w, i64 0
  %i.aj = insertelement <2 x double> %4, double %i.x, i64 1 ; 4 uses
  %5 = fmul <2 x double> %i.ai, %i.aj
  %i.ak = insertelement <2 x double> poison, double %i.k, i64 0
  %6 = shufflevector <2 x double> %i.ak, <2 x double> poison, <2 x i32> zeroinitializer
  %7 = shufflevector <2 x double> %i.aj, <2 x double> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %8 = insertelement <2 x double> %7, double %i.z, i64 0
  %9 = fmul <2 x double> %6, %8
  %i.al = insertelement <2 x double> poison, double %2, i64 0
  %10 = shufflevector <2 x double> %i.al, <2 x double> poison, <2 x i32> zeroinitializer
  %11 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %10, <2 x double> %i.aj, <2 x double> %9)
  %12 = insertelement <2 x double> poison, double %i.l, i64 0
  %13 = shufflevector <2 x double> %12, <2 x double> poison, <2 x i32> zeroinitializer
  %i.am = insertelement <2 x double> %7, double %i.ab, i64 1
  %i.an = fmul <2 x double> %13, %i.am
  %14 = insertelement <2 x double> poison, double %3, i64 0
  %i.ao = shufflevector <2 x double> %14, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ap = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ao, <2 x double> %i.aj, <2 x double> %i.an)
  %i.aq = fmul <2 x double> %11, zeroinitializer
  %i.ar = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %5, <2 x double> zeroinitializer, <2 x double> %i.aq)
