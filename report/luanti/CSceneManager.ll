...
bb.c:                                             ; preds = %bb.b
  ...
  %4 = load <4 x float>, ptr %0, align 4
  %5 = shufflevector <4 x float> %4, <4 x float> poison, <2 x i32> <i32 3, i32 poison>
  %i.ay = getelementptr inbounds nuw i8, ptr %1, i64 12
  %i.az = load float, ptr %i.ay, align 4, !tbaa !151
  %i.ba = insertelement <2 x float> %5, float %i.az, i64 1 ; 2 uses
