...
bb.c:                                             ; preds = %bb.b
  ...
  %i.az = load float, ptr %i.ay, align 4, !tbaa !145 ; 2 uses
  %i.ba = getelementptr inbounds nuw i8, ptr %1, i64 12
  %i.bb = load float, ptr %i.ba, align 4, !tbaa !145 ; 2 uses
  ...
  %4 = insertelement <2 x float> poison, float %i.az, i64 0
  %5 = insertelement <2 x float> %4, float %i.bb, i64 1
  %i.bj = fmul <2 x float> %i.bi, %5
