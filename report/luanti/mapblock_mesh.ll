...
bb.a:
  ...
  %indvars.iv.sroa.gep755 = getelementptr inbounds nuw i8, ptr %7, i64 24
...
bb.aa:                                            ; preds = %bb.y
  ...
  br i1 %i.fn, label %.preheader, label %bb.ab, !llvm.loop !376

bb.ab:                                            ; preds = %bb.aa
  %i.fo = add i16 %storemerge484, 1               ; 2 uses
  %i.fp = sext i16 %i.fo to i32
  %i.fq = icmp slt i32 %i.fp, %i.bu
  br i1 %i.fq, label %.preheader363, label %_ZNK8MeshGrid9isMeshPosERN4core8vector3dIsEE.exit.thread, !llvm.loop !377
...
_ZNK8MeshGrid9isMeshPosERN4core8vector3dIsEE.exit.thread: ; preds = %bb.ab, %_ZN7irr_ptrIN5scene5SMeshEED2Ev.exit.1, %bb.d, %bb.m, %_ZNK8MeshGrid9isMeshPosERN4core8vector3dIsEE.exit
  ...
  %i.gf = insertelement <2 x i16> %i.gd, i16 %i.ge, i64 1
  %.sroa.0.0.extract.trunc.i139 = trunc i48 %.sroa.045.0.copyload to i16 ; 2 uses
  %11 = sext i16 %.sroa.2.0.extract.trunc.i141 to i32
  %12 = sext i16 %.sroa.0.0.extract.trunc.i139 to i32
  %.lobit.i.i1.i = lshr i16 %.sroa.2.0.extract.trunc.i141, 15
  %.lobit.i.i.i = lshr i16 %.sroa.0.0.extract.trunc.i139, 15
  %13 = zext nneg i16 %.lobit.i.i1.i to i32
  %14 = zext nneg i16 %.lobit.i.i.i to i32
  %15 = mul nuw nsw i32 %i.fr, %13
  %16 = mul nuw nsw i32 %i.fr, %14
...
.lr.ph.i.i:                                       ; preds = %bb.ai
  ...
  %min.iters.check = icmp ult i64 %i.iy, 120
  br i1 %min.iters.check, label %scalar.ph.preheader, label %vector.ph

vector.ph:                                        ; preds = %.lr.ph.i.i
  %n.vec = and i64 %i.ja, 1152921504606846972     ; 3 uses
  %i.jb = mul i64 %n.vec, 40
  ...
  %broadcast.splatinsert706 = insertelement <4 x i32> poison, i32 %i.it, i64 0
  %broadcast.splat707 = shufflevector <4 x i32> %broadcast.splatinsert706, <4 x i32> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert708 = insertelement <4 x i32> poison, i32 %i.iu, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.jd = mul i64 %index, 40                      ; 4 uses
  %next.gep = getelementptr i8, ptr %i.in, i64 %i.jd
  %i.je = getelementptr i8, ptr %i.in, i64 %i.jd
  %i.jf = getelementptr i8, ptr %i.in, i64 %i.jd
  %i.jg = getelementptr i8, ptr %i.in, i64 %i.jd
  %i.jh = getelementptr inbounds nuw i8, ptr %next.gep, i64 24 ; 2 uses
  ...
  %i.kc = mul nuw nsw <4 x i32> %i.kb, %broadcast.splat707
  ...
  %i.kh = mul nuw nsw <4 x i32> %i.kg, %broadcast.splat709
  ...
  br i1 %i.kw, label %middle.block, label %vector.body, !llvm.loop !378
end_hunk_0
