...
begin_hunk_0_@"_ZNSt17_Function_handlerIFvfEZN10GenericCAO10addToSceneEP14ITextureSourcePN5scene13ISceneManagerEE3$_0E9_M_invokeERKSt9_Any_dataOf":bb.a
  %i.cq = call noundef nonnull align 4 dereferenceable(12) ptr %i.cp(ptr noundef nonnull align 8 dereferenceable(218) %i.cm), !inline_history !999 ; 2 uses
  ...
  %.sroa.224.0.copyload.i.i.i = load float, ptr %.sroa.224.0..sroa_idx.i.i.i, align 4, !tbaa !48
  %i.cr = load float, ptr %i.i, align 4, !tbaa !671
  %i.cs = load float, ptr %i.l, align 4, !tbaa !1005 ; 2 uses
  ...
  %i.db = load float, ptr %i.da, align 8, !tbaa !149
  ...
  %i.dj = load i8, ptr %i.w, align 8, !tbaa !1006, !range !46, !noundef !47
  ...
  %i.dl = load <2 x float>, ptr %i.h, align 8, !tbaa !48
  %i.dm = fpext <2 x float> %i.dl to <2 x double>
  %i.dn = load <2 x float>, ptr %i.cw, align 4, !tbaa !48
  ...
  %i.dy = load ptr, ptr %i.cm, align 8, !tbaa !55
  %i.dz = getelementptr inbounds nuw i8, ptr %i.dy, i64 224
  %i.ea = load ptr, ptr %i.dz, align 8
  call void %i.ea(ptr noundef nonnull align 8 dereferenceable(218) %i.cm, ptr noundef nonnull align 4 dereferenceable(12) %2), !inline_history !999
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #28
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #28
  %i.eb = load ptr, ptr %i.cm, align 8, !tbaa !55
  %i.ec = getelementptr inbounds nuw i8, ptr %i.eb, i64 200
  %i.ed = load ptr, ptr %i.ec, align 8
  %i.ee = call { <2 x float>, float } %i.ed(ptr noundef nonnull align 8 dereferenceable(308) %i.cm), !inline_history !999 ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %3 = fmul nsz float %.0, %i.s
  %4 = fmul nsz float %i.v, %i.s
  %5 = tail call nsz float @llvm.sin.f32(float %3)
  %6 = tail call nsz float @llvm.sin.f32(float %4)
  %7 = fmul nsz float %5, %i.u
  %8 = fmul nsz float %6, %i.u
  %i.w = insertelement <2 x float> poison, float %8, i64 0
  %i.x = shufflevector <2 x float> %i.w, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.y = fmul nsz <2 x float> %.sroa.047.0.i, %i.x
  %9 = fmul nsz <2 x float> %.sroa.10.0.i, %i.x
  ...
  %12 = fmul nsz <2 x float> %.sroa.08.0.copyload, %11
  %13 = fmul nsz <2 x float> %.sroa.29.0.copyload, %11
  %14 = fadd nsz <2 x float> %i.y, %12
  %15 = fadd nsz <2 x float> %9, %13
...
_ZN4core10quaternion5slerpES0_S0_ff.exit:         ; preds = %bb.b, %bb.c
  %.sroa.0.4.vec.insert.i29.sink.i = phi <2 x float> [ %i.ax, %bb.c ], [ %14, %bb.b ] ; 6 uses
  %.sroa.3.12.vec.insert.i31.sink.i = phi <2 x float> [ %i.ay, %bb.c ], [ %15, %bb.b ] ; 4 uses
  %i.az = getelementptr inbounds nuw i8, ptr %0, i64 76
  %i.ba = load i8, ptr %i.az, align 4, !tbaa !1011, !range !46, !noundef !47
...
bb.a:
  %i.a = icmp eq i64 %1, 1
  br i1 %i.a, label %bb.b, label %bb.c, !prof !606
...
bb.c:                                             ; preds = %bb.a
  ...
  br i1 %i.c, label %bb.d, label %_ZNSt8__detail16_Hashtable_allocISaINS_10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEiELb1EEEEE19_M_allocate_bucketsEm.exit.i, !prof !606
...
_ZNSt10_HashtableINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_iESaIS8_ENSt8__detail10_Select1stESt8equal_toIS5_ESt4hashIS5_ENSA_18_Mod_range_hashingENSA_20_Default_ranged_hashENSA_20_Prime_rehash_policyENSA_17_Hashtable_traitsILb1ELb0ELb1EEEE19_M_allocate_bucketsEm.exit: ; preds = %bb.b, %_ZNSt8__detail16_Hashtable_allocISaINS_10_Hash_nodeISt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEiELb1EEEEE19_M_allocate_bucketsEm.exit.i
  ...
  store ptr null, ptr %i.g, align 8, !tbaa !140
...
.lr.ph:                                           ; preds = %_ZNSt10_HashtableINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_iESaIS8_ENSt8__detail10_Select1stESt8equal_toIS5_ESt4hashIS5_ENSA_18_Mod_range_hashingENSA_20_Default_ranged_hashENSA_20_Prime_rehash_policyENSA_17_Hashtable_traitsILb1ELb0ELb1EEEE19_M_allocate_bucketsEm.exit, %bb.h
  ...
  %i.i = load ptr, ptr %.02530, align 8, !tbaa !41 ; 2 uses
  %i.j = getelementptr inbounds nuw i8, ptr %.02530, i64 48
  %i.k = load i64, ptr %i.j, align 8, !tbaa !611
  %i.l = urem i64 %i.k, %1                        ; 3 uses
  %i.m = getelementptr inbounds nuw [8 x i8], ptr %.0.i, i64 %i.l ; 3 uses
  %i.n = load ptr, ptr %i.m, align 8, !tbaa !609  ; 2 uses
  %.not27 = icmp eq ptr %i.n, null
  br i1 %.not27, label %bb.e, label %bb.g

bb.e:                                             ; preds = %.lr.ph
  %i.o = load ptr, ptr %i.g, align 8, !tbaa !140
  store ptr %i.o, ptr %.02530, align 8, !tbaa !41
  store ptr %.02530, ptr %i.g, align 8, !tbaa !140
  store ptr %i.g, ptr %i.m, align 8, !tbaa !609
  %i.p = load ptr, ptr %.02530, align 8, !tbaa !41
  %.not28 = icmp eq ptr %i.p, null
  br i1 %.not28, label %bb.h, label %bb.f

bb.f:                                             ; preds = %bb.e
  %i.q = getelementptr inbounds nuw [8 x i8], ptr %.0.i, i64 %.031
  store ptr %.02530, ptr %i.q, align 8, !tbaa !609
  br label %bb.h

bb.g:                                             ; preds = %.lr.ph
  %i.r = load ptr, ptr %i.n, align 8, !tbaa !41
  store ptr %i.r, ptr %.02530, align 8, !tbaa !41
  %i.s = load ptr, ptr %i.m, align 8, !tbaa !609
  store ptr %.02530, ptr %i.s, align 8, !tbaa !41
  br label %bb.h
...
._crit_edge:                                      ; preds = %bb.h, %_ZNSt10_HashtableINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_iESaIS8_ENSt8__detail10_Select1stESt8equal_toIS5_ESt4hashIS5_ENSA_18_Mod_range_hashingENSA_20_Default_ranged_hashENSA_20_Prime_rehash_policyENSA_17_Hashtable_traitsILb1ELb0ELb1EEEE19_M_allocate_bucketsEm.exit
  %i.t = load ptr, ptr %0, align 8, !tbaa !130    ; 2 uses
...
_ZNSt10_HashtableINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_iESaIS8_ENSt8__detail10_Select1stESt8equal_toIS5_ESt4hashIS5_ENSA_18_Mod_range_hashingENSA_20_Default_ranged_hashENSA_20_Prime_rehash_policyENSA_17_Hashtable_traitsILb1ELb0ELb1EEEE21_M_deallocate_bucketsEv.exit: ; preds = %._crit_edge, %bb.i
  ...
  store i64 %1, ptr %i.z, align 8, !tbaa !131
...
bb.a:
  store ptr getelementptr inbounds nuw (i8, ptr @_ZN18ClientActiveObject7m_typesE, i64 48), ptr @_ZN18ClientActiveObject7m_typesE, align 8, !tbaa !43
  store i64 1, ptr getelementptr inbounds nuw (i8, ptr @_ZN18ClientActiveObject7m_typesE, i64 8), align 8, !tbaa !44
  ...
  store float 1.000000e+00, ptr getelementptr inbounds nuw (i8, ptr @_ZN18ClientActiveObject7m_typesE, i64 32), align 8, !tbaa !127
...
!2 = distinct !{!2, !42}
!3 = distinct !{!3, !42}
!4 = distinct !{ptr @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_, null}
!5 = distinct !{null}
!6 = distinct !{!6, !42}
!7 = distinct !{ptr @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_, null, null, null, null}
!8 = distinct !{null}
!9 = distinct !{null}
!10 = distinct !{null}
!11 = distinct !{null}
!12 = distinct !{ptr @_ZN10GenericCAO12setNodeLightERKN5video6SColorE, null}
!13 = distinct !{!13, !42}
!14 = distinct !{null}
!15 = distinct !{!15, !42}
!16 = distinct !{!16, !42}
...
!18 = distinct !{!18, !42}
!19 = distinct !{!19, !42}
!20 = distinct !{ptr @_ZN5scene5SMeshD1Ev, null, null}
!21 = distinct !{ptr @_ZN5scene13CVertexBufferIN5video9S3DVertexEED1Ev, null, null, null, null}
!22 = distinct !{!22, !42}
!23 = !{i32 8, !"PIC Level", i32 2}
!24 = !{i32 7, !"PIE Level", i32 2}
!25 = !{i32 7, !"uwtable", i32 2}
!26 = !{!"Ubuntu clang version 24.0.0 (++20260802081851+e18c3ea02484-1~exp1~20260802082001.1761)"}
!27 = !{!"Simple C++ TBAA"}
...
!33 = !{!"any p2 pointer", !32, i64 0}
!34 = !{!"p2 _ZTSNSt8__detail15_Hash_node_baseE", !33, i64 0}
!35 = !{!"long", !28, i64 0}
!36 = !{!"p1 _ZTSNSt8__detail15_Hash_node_baseE", !32, i64 0}
!37 = !{!"_ZTSNSt8__detail15_Hash_node_baseE", !36, i64 0}
!38 = !{!"float", !28, i64 0}
!39 = !{!"_ZTSNSt8__detail20_Prime_rehash_policyE", !38, i64 0, !35, i64 8}
!40 = !{!"_ZTSSt10_HashtableItSt4pairIKtPFSt10unique_ptrI18ClientActiveObjectSt14default_deleteIS3_EEP6ClientP17ClientEnvironmentEESaISD_ENSt8__detail10_Select1stESt8equal_toItESt4hashItENSF_18_Mod_range_hashingENSF_20_Default_ranged_hashENSF_20_Prime_rehash_policyENSF_17_Hashtable_traitsILb0ELb0ELb1EEEE", !34, i64 0, !35, i64 8, !37, i64 16, !35, i64 24, !39, i64 32, !36, i64 48}
!41 = !{!37, !36, i64 0}
...
!47 = !{}
!48 = !{!38, !38, i64 0}
!49 = !{!"_ZTSN4core8vector3dIfEE", !38, i64 0, !38, i64 4, !38, i64 8}
!50 = !{!"_ZTS16SmoothTranslatorIN4core8vector3dIfEEE", !49, i64 0, !49, i64 12, !49, i64 24, !38, i64 36, !38, i64 40, !45, i64 44}
!51 = !{!50, !38, i64 40}
!52 = !{!50, !38, i64 36}
!53 = !{!50, !45, i64 44}
!54 = !{!"vtable pointer", !27, i64 0}
!55 = !{!54, !54, i64 0}
!56 = !{!"p1 omnipotent char", !32, i64 0}
!57 = !{!"_ZTSNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE12_Alloc_hiderE", !56, i64 0}
!58 = !{!57, !56, i64 0}
!59 = !{!"_ZTSNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE", !57, i64 0, !35, i64 8, !28, i64 16}
!60 = !{!59, !35, i64 8}
!61 = !{!28, !28, i64 0}
!62 = !{!"short", !28, i64 0}
!63 = !{!"_ZTS12ActiveObject", !62, i64 8}
!64 = !{!"p1 _ZTS6Client", !32, i64 0}
!65 = !{!"p1 _ZTS17ClientEnvironment", !32, i64 0}
!66 = !{!"_ZTS18ClientActiveObject", !63, i64 0, !64, i64 16, !65, i64 24}
!67 = !{!"p1 _ZTSNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE", !32, i64 0}
!68 = !{!"_ZTSNSt12_Vector_baseINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE17_Vector_impl_dataE", !67, i64 0, !67, i64 8, !67, i64 16}
!69 = !{!"_ZTSNSt12_Vector_baseINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE12_Vector_implE", !68, i64 0}
!70 = !{!"_ZTSSt12_Vector_baseINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE", !69, i64 0}
!71 = !{!"_ZTSSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE", !70, i64 0}
!72 = !{!"p1 _ZTSN5video6SColorE", !32, i64 0}
!73 = !{!"_ZTSNSt12_Vector_baseIN5video6SColorESaIS1_EE17_Vector_impl_dataE", !72, i64 0, !72, i64 8, !72, i64 16}
!74 = !{!"_ZTSNSt12_Vector_baseIN5video6SColorESaIS1_EE12_Vector_implE", !73, i64 0}
!75 = !{!"_ZTSSt12_Vector_baseIN5video6SColorESaIS1_EE", !74, i64 0}
!76 = !{!"_ZTSSt6vectorIN5video6SColorESaIS1_EE", !75, i64 0}
!77 = !{!"_ZTSN4core8aabbox3dIfEE", !49, i64 0, !49, i64 12}
!78 = !{!"_ZTS12ObjectVisual", !28, i64 0}
!79 = !{!"_ZTSN5video6SColorE", !29, i64 0}
!80 = !{!"_ZTSSt22_Optional_payload_baseIN5video6SColorEE", !28, i64 0, !45, i64 4}
!81 = !{!"_ZTSSt17_Optional_payloadIN5video6SColorELb1ELb1ELb1EE", !80, i64 0}
!82 = !{!"_ZTSSt14_Optional_baseIN5video6SColorELb1ELb1EE", !81, i64 0}
!83 = !{!"_ZTSSt8optionalIN5video6SColorEE", !82, i64 0}
!84 = !{!"_ZTSN4core8vector2dIsEE", !62, i64 0, !62, i64 2}
!85 = !{!"_ZTSSt22_Optional_payload_baseIjE", !28, i64 0, !45, i64 4}
!86 = !{!"_ZTSSt17_Optional_payloadIjLb1ELb1ELb1EE", !85, i64 0}
!87 = !{!"_ZTSSt14_Optional_baseIjLb1ELb1EE", !86, i64 0}
!88 = !{!"_ZTSSt8optionalIjE", !87, i64 0}
!89 = !{!"_ZTS7MapNode", !62, i64 0, !28, i64 2, !28, i64 3}
!90 = !{!"_ZTS16PointabilityType", !28, i64 0}
!91 = !{!"_ZTS10StepUpMode", !28, i64 0}
!92 = !{!"_ZTS16ObjectProperties", !71, i64 0, !76, i64 24, !77, i64 48, !77, i64 72, !78, i64 96, !59, i64 104, !59, i64 136, !59, i64 168, !59, i64 200, !59, i64 232, !49, i64 264, !79, i64 276, !83, i64 280, !84, i64 288, !84, i64 292, !38, i64 296, !38, i64 300, !38, i64 304, !38, i64 308, !38, i64 312, !38, i64 316, !88, i64 320, !89, i64 328, !62, i64 332, !62, i64 334, !28, i64 336, !90, i64 337, !45, i64 338, !45, i64 339, !45, i64 340, !45, i64 341, !45, i64 342, !45, i64 343, !45, i64 344, !45, i64 345, !45, i64 346, !45, i64 347, !45, i64 348, !45, i64 349, !91, i64 350}
!93 = !{!"p1 _ZTSN5scene13ISceneManagerE", !32, i64 0}
!94 = !{!"p1 _ZTSN5scene14IMeshSceneNodeE", !32, i64 0}
!95 = !{!"p1 _ZTSN5scene21AnimatedMeshSceneNodeE", !32, i64 0}
!96 = !{!"p1 _ZTS18WieldMeshSceneNode", !32, i64 0}
!97 = !{!"p1 _ZTSN5scene19IBillboardSceneNodeE", !32, i64 0}
!98 = !{!"p1 _ZTSN5scene29IDummyTransformationSceneNodeE", !32, i64 0}
!99 = !{!"p1 _ZTS7Nametag", !32, i64 0}
!100 = !{!"p1 _ZTS13MinimapMarker", !32, i64 0}
!101 = !{!"p1 _ZTS17MeshAnimationInfo", !32, i64 0}
!102 = !{!"_ZTSNSt12_Vector_baseI17MeshAnimationInfoSaIS0_EE17_Vector_impl_dataE", !101, i64 0, !101, i64 8, !101, i64 16}
!103 = !{!"_ZTSNSt12_Vector_baseI17MeshAnimationInfoSaIS0_EE12_Vector_implE", !102, i64 0}
!104 = !{!"_ZTSSt12_Vector_baseI17MeshAnimationInfoSaIS0_EE", !103, i64 0}
!105 = !{!"_ZTSSt6vectorI17MeshAnimationInfoSaIS0_EE", !104, i64 0}
!106 = !{!"_ZTSN5video15E_MATERIAL_TYPEE", !28, i64 0}
!107 = !{!"_ZTS26SmoothTranslatorWrappedv3f", !50, i64 0}
!108 = !{!"_ZTSN4core8vector2dIfEE", !38, i64 0, !38, i64 4}
...
!110 = !{!"_ZTSSt13unordered_mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE12BoneOverrideSt4hashIS5_ESt8equal_toIS5_ESaISt4pairIKS5_S6_EEE", !109, i64 0}
!111 = !{!"_ZTSSt10_HashtableIttSaItENSt8__detail9_IdentityESt8equal_toItESt4hashItENS1_18_Mod_range_hashingENS1_20_Default_ranged_hashENS1_20_Prime_rehash_policyENS1_17_Hashtable_traitsILb0ELb1ELb1EEEE", !34, i64 0, !35, i64 8, !37, i64 16, !35, i64 24, !39, i64 32, !36, i64 48}
!112 = !{!"_ZTSSt13unordered_setItSt4hashItESt8equal_toItESaItEE", !111, i64 0}
!113 = !{!"_ZTSSt10_HashtableINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_iESaIS8_ENSt8__detail10_Select1stESt8equal_toIS5_ESt4hashIS5_ENSA_18_Mod_range_hashingENSA_20_Default_ranged_hashENSA_20_Prime_rehash_policyENSA_17_Hashtable_traitsILb1ELb0ELb1EEEE", !34, i64 0, !35, i64 8, !37, i64 16, !35, i64 24, !39, i64 32, !36, i64 48}
!114 = !{!"_ZTSSt13unordered_mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEiSt4hashIS5_ESt8equal_toIS5_ESaISt4pairIKS5_iEEE", !113, i64 0}
!115 = !{!"_ZTS10GenericCAO", !66, i64 0, !59, i64 32, !45, i64 64, !45, i64 65, !92, i64 72, !93, i64 424, !64, i64 432, !77, i64 440, !94, i64 464, !95, i64 472, !96, i64 480, !97, i64 488, !98, i64 496, !99, i64 504, !100, i64 512, !45, i64 520, !79, i64 524, !45, i64 528, !105, i64 536, !106, i64 560, !49, i64 564, !49, i64 576, !49, i64 588, !49, i64 600, !62, i64 612, !50, i64 616, !107, i64 664, !108, i64 712, !84, i64 720, !45, i64 724, !45, i64 725, !45, i64 726, !108, i64 728, !38, i64 736, !38, i64 740, !29, i64 744, !29, i64 748, !38, i64 752, !38, i64 756, !110, i64 760, !62, i64 816, !112, i64 824, !59, i64 880, !49, i64 912, !49, i64 924, !45, i64 936, !45, i64 937, !114, i64 944, !38, i64 1000, !59, i64 1008, !59, i64 1040, !38, i64 1072}
!116 = !{!115, !45, i64 64}
!117 = !{!115, !45, i64 65}
!118 = !{!79, !29, i64 0}
!119 = !{!115, !45, i64 528}
...
!137 = !{!102, !101, i64 16}
!138 = !{!35, !35, i64 0}
!139 = !{!"p1 _ZTS18ClientActiveObject", !32, i64 0}
!140 = !{!113, !36, i64 16}
!141 = !{!111, !36, i64 16}
!142 = !{!109, !36, i64 16}
!143 = !{!73, !72, i64 0}
...
!149 = !{!49, !38, i64 8}
!150 = !{!115, !45, i64 411}
!151 = !{!"_ZTSSt13_Ios_Fmtflags", !28, i64 0}
!152 = !{!"_ZTSSt12_Ios_Iostate", !28, i64 0}
!153 = !{!"p1 _ZTSNSt8ios_base14_Callback_listE", !32, i64 0}
!154 = !{!"_ZTSNSt8ios_base6_WordsE", !32, i64 0, !35, i64 8}
!155 = !{!"p1 _ZTSNSt8ios_base6_WordsE", !32, i64 0}
end_hunk_1
