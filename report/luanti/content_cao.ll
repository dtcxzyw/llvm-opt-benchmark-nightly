...
bb.a:
  ...
  %.sroa.036.0.vec.extract.i.a = extractelement <2 x float> %.sroa.010.0.copyload, i64 0
  %.sroa.036.4.vec.extract.i = extractelement <2 x float> %.sroa.08.0.copyload, i64 0
  ...
  %i.k = tail call nsz float @llvm.fmuladd.f32(float %.sroa.036.0.vec.extract.i.a, float %.sroa.036.4.vec.extract.i, float %i.j)
...
bb.c:                                             ; preds = %bb.a
  ...
  %5 = fmul nsz <2 x float> %.sroa.08.0.copyload, %4
  %6 = fmul nsz <2 x float> %4, %.sroa.29.0.copyload
  ...
  %9 = fmul nsz <2 x float> %8, %.sroa.10.0.i
  %10 = fadd nsz <2 x float> %6, %9               ; 3 uses
  %11 = extractelement <2 x float> %10, i64 0     ; 2 uses
  %12 = extractelement <2 x float> %10, i64 1     ; 2 uses
  %13 = fmul nsz <2 x float> %8, %.sroa.047.0.i
  %14 = fadd nsz <2 x float> %5, %13              ; 4 uses
  %foldExtExtBinop46 = fmul nsz <2 x float> %14, %14
  %15 = extractelement <2 x float> %foldExtExtBinop46, i64 1
  %16 = extractelement <2 x float> %14, i64 0     ; 2 uses
  %i.an = tail call nsz float @llvm.fmuladd.f32(float %16, float %16, float %15)
  %i.ao = tail call nsz float @llvm.fmuladd.f32(float %11, float %11, float %i.an)
  %i.ap = tail call nsz float @llvm.fmuladd.f32(float %12, float %12, float %i.ao)
  ...
  %i.at = fptrunc nsz double %i.as to float
  %.sroa.018.4.vec.insert.i.i = insertelement <2 x float> poison, float %i.at, i64 0
  %17 = shufflevector <2 x float> %.sroa.018.4.vec.insert.i.i, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %18 = fmul nsz <2 x float> %14, %17
  %19 = fmul nsz <2 x float> %10, %17
  br label %_ZN4core10quaternion5slerpES0_S0_ff.exit

_ZN4core10quaternion5slerpES0_S0_ff.exit:         ; preds = %bb.b, %bb.c
  %.sroa.0.4.vec.insert.i29.sink.i = phi <2 x float> [ %18, %bb.c ], [ %i.ai, %bb.b ] ; 6 uses
  %.sroa.3.12.vec.insert.i31.sink.i = phi <2 x float> [ %19, %bb.c ], [ %i.al, %bb.b ] ; 4 uses
