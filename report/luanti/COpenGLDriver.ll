...
_ZN5video23COpenGLCoreCacheHandlerINS_13COpenGLDriverENS_18COpenGLCoreTextureIS1_EEE16setActiveTextureEj.exit: ; preds = %_ZN5video23COpenGLCoreCacheHandlerINS_13COpenGLDriverENS_18COpenGLCoreTextureIS1_EEE12setBlendFuncEjj.exit, %_ZN5video23COpenGLExtensionHandler18irrGlActiveTextureEj.exit.i
  ...
  %2 = load float, ptr %i.bj, align 8, !tbaa !116, !noalias !216
  %i.bk = getelementptr inbounds nuw i8, ptr %0, i64 2880
  %i.bl = getelementptr inbounds nuw i8, ptr %0, i64 2932
  %3 = load float, ptr %i.bl, align 4, !tbaa !116, !noalias !216
  %i.bm = getelementptr inbounds nuw i8, ptr %0, i64 2896
  %i.bn = getelementptr inbounds nuw i8, ptr %0, i64 2936
  %4 = load float, ptr %i.bn, align 8, !tbaa !116, !noalias !216
  %i.bo = getelementptr inbounds nuw i8, ptr %0, i64 2912
  %i.bp = getelementptr inbounds nuw i8, ptr %0, i64 2940
  %5 = load float, ptr %i.bp, align 4, !tbaa !116, !noalias !216
  %i.bq = load <4 x float>, ptr %i.bi, align 8, !tbaa !116, !noalias !216 ; 4 uses
  %i.br = load <4 x float>, ptr %i.bk, align 8, !tbaa !116, !noalias !216 ; 4 uses
  %6 = insertelement <4 x float> poison, float %3, i64 0
  %i.bs = shufflevector <4 x float> %6, <4 x float> poison, <4 x i32> zeroinitializer
  %i.bt = fmul <4 x float> %i.bs, %i.br
  %7 = insertelement <4 x float> poison, float %2, i64 0
  %i.bu = shufflevector <4 x float> %7, <4 x float> poison, <4 x i32> zeroinitializer
  %i.bv = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.bq, <4 x float> %i.bu, <4 x float> %i.bt)
  %i.bw = load <4 x float>, ptr %i.bm, align 8, !tbaa !116, !noalias !216 ; 4 uses
  %8 = insertelement <4 x float> poison, float %4, i64 0
  %i.bx = shufflevector <4 x float> %8, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.ca = shufflevector <4 x float> %9, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %10 = load float, ptr %i.cc, align 8, !tbaa !116, !noalias !216
  %i.cd = getelementptr inbounds nuw i8, ptr %0, i64 2948
  %11 = load float, ptr %i.cd, align 4, !tbaa !116, !noalias !216
  %i.ce = getelementptr inbounds nuw i8, ptr %0, i64 2952
  %12 = load float, ptr %i.ce, align 8, !tbaa !116, !noalias !216
  %i.cf = getelementptr inbounds nuw i8, ptr %0, i64 2956
  %13 = load float, ptr %i.cf, align 4, !tbaa !116, !noalias !216
  %i.cg = getelementptr inbounds nuw i8, ptr %1, i64 16
  %14 = insertelement <4 x float> poison, float %11, i64 0
  %i.ch = shufflevector <4 x float> %14, <4 x float> poison, <4 x i32> zeroinitializer
  %i.ci = fmul <4 x float> %i.br, %i.ch
  %15 = insertelement <4 x float> poison, float %10, i64 0
  %i.cj = shufflevector <4 x float> %15, <4 x float> poison, <4 x i32> zeroinitializer
  %i.ck = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.bq, <4 x float> %i.cj, <4 x float> %i.ci)
  %16 = insertelement <4 x float> poison, float %12, i64 0
  %i.cl = shufflevector <4 x float> %16, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.cn = shufflevector <4 x float> %17, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %18 = load float, ptr %i.cp, align 8, !tbaa !116, !noalias !216
  %i.cq = getelementptr inbounds nuw i8, ptr %0, i64 2964
  %19 = load float, ptr %i.cq, align 4, !tbaa !116, !noalias !216
  %i.cr = getelementptr inbounds nuw i8, ptr %0, i64 2968
  %20 = load float, ptr %i.cr, align 8, !tbaa !116, !noalias !216
  %i.cs = getelementptr inbounds nuw i8, ptr %0, i64 2972
  %21 = load float, ptr %i.cs, align 4, !tbaa !116, !noalias !216
  %i.ct = getelementptr inbounds nuw i8, ptr %1, i64 32
  %22 = insertelement <4 x float> poison, float %19, i64 0
  %i.cu = shufflevector <4 x float> %22, <4 x float> poison, <4 x i32> zeroinitializer
  %i.cv = fmul <4 x float> %i.br, %i.cu
  %23 = insertelement <4 x float> poison, float %18, i64 0
  %i.cw = shufflevector <4 x float> %23, <4 x float> poison, <4 x i32> zeroinitializer
  %i.cx = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.bq, <4 x float> %i.cw, <4 x float> %i.cv)
  %24 = insertelement <4 x float> poison, float %20, i64 0
  %i.cy = shufflevector <4 x float> %24, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.da = shufflevector <4 x float> %25, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %26 = load float, ptr %i.dc, align 8, !tbaa !116, !noalias !216
  %i.dd = getelementptr inbounds nuw i8, ptr %0, i64 2980
  %27 = load float, ptr %i.dd, align 4, !tbaa !116, !noalias !216
  %i.de = getelementptr inbounds nuw i8, ptr %0, i64 2984
  %28 = load float, ptr %i.de, align 8, !tbaa !116, !noalias !216
  %i.df = getelementptr inbounds nuw i8, ptr %0, i64 2988
  %29 = load float, ptr %i.df, align 4, !tbaa !116, !noalias !216
  %i.dg = getelementptr inbounds nuw i8, ptr %1, i64 48
  %30 = insertelement <4 x float> poison, float %27, i64 0
  %i.dh = shufflevector <4 x float> %30, <4 x float> poison, <4 x i32> zeroinitializer
  %i.di = fmul <4 x float> %i.br, %i.dh
  %31 = insertelement <4 x float> poison, float %26, i64 0
  %i.dj = shufflevector <4 x float> %31, <4 x float> poison, <4 x i32> zeroinitializer
  %i.dk = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.bq, <4 x float> %i.dj, <4 x float> %i.di)
  %32 = insertelement <4 x float> poison, float %28, i64 0
  %i.dl = shufflevector <4 x float> %32, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.dn = shufflevector <4 x float> %33, <4 x float> poison, <4 x i32> zeroinitializer
...
bb.w:                                             ; preds = %bb.f
  ...
  %3 = load float, ptr %i.n, align 4, !tbaa !116, !noalias !467
  ...
  %4 = load float, ptr %i.p, align 8, !tbaa !116, !noalias !467
  %5 = load float, ptr %i.q, align 4, !tbaa !116, !noalias !467
  %6 = load float, ptr %i.r, align 8, !tbaa !116, !noalias !467
  %7 = load float, ptr %i.s, align 4, !tbaa !116, !noalias !467
  %i.eh = load float, ptr %i.t, align 8, !tbaa !116, !noalias !467 ; 2 uses
  %8 = load float, ptr %i.u, align 4, !tbaa !116, !noalias !467
  ...
  %i.fh = shufflevector <2 x float> %10, <2 x float> poison, <2 x i32> zeroinitializer
  %i.fi = fmul <2 x float> %i.fg, %i.fh
  %11 = insertelement <2 x float> poison, float %8, i64 0
  %i.fj = shufflevector <2 x float> %11, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.fm = shufflevector <2 x float> %9, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 poison, i32 poison>
  ...
  %12 = insertelement <2 x float> %i.el, float %i.em, i64 1
  %i.fs = insertelement <2 x float> poison, float %4, i64 0
  %i.ft = shufflevector <2 x float> %i.fs, <2 x float> poison, <2 x i32> zeroinitializer
  %i.fu = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %12, <2 x float> %i.ft, <2 x float> %i.fi)
  %13 = insertelement <2 x float> %i.er, float %i.es, i64 1
  %i.fv = insertelement <2 x float> poison, float %6, i64 0
  %i.fw = shufflevector <2 x float> %i.fv, <2 x float> poison, <2 x i32> zeroinitializer
  %i.fx = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %13, <2 x float> %i.fw, <2 x float> %i.fu)
  %14 = insertelement <2 x float> %i.ex, float %i.ey, i64 1
  %i.fy = insertelement <2 x float> poison, float %7, i64 0
  %i.fz = shufflevector <2 x float> %i.fy, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ga = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %14, <2 x float> %i.fz, <2 x float> %i.fx)
