...
._crit_edge163.i.i.i:                             ; preds = %._crit_edge160.split.i.i.i, %._crit_edge160.split.us.us.i.i.i
  ...
  %exitcond66.not = icmp eq i32 %indvars.iv314.i, %smax65
...
.preheader137.i.i83.i.preheader:                  ; preds = %.preheader137.lr.ph.i.i77.i
  %smax = call i32 @llvm.smax.i32(i32 %i.ju, i32 %i.kk)
  br label %.preheader137.i.i83.i

.preheader137.i.i83.i:                            ; preds = %.preheader137.i.i83.i.preheader, %._crit_edge163.i.i134.i
  %indvars.iv.i = phi i32 [ %indvars.iv.next.i, %._crit_edge163.i.i134.i ], [ %i.ju, %.preheader137.i.i83.i.preheader ] ; 4 uses
  %.0230.i = phi i32 [ %.9.i, %._crit_edge163.i.i134.i ], [ 0, %.preheader137.i.i83.i.preheader ] ; 2 uses
