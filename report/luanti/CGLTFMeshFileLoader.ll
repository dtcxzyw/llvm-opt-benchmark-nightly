...
"_ZNSt8__detail9__variant17__gen_vtable_implINS0_12_Multi_arrayIPFNS0_21__deduce_visit_resultIN4core8CMatrix4IfEEEEOZN5sceneL13loadTransformESt8optionalISt7variantIJSt5arrayIdLm16EEN10tiniergltf4Node3TRSEEEEPNS8_11SkinnedMesh6SJointEE3$_0RSG_EJEEESt16integer_sequenceImJLm1EEEE14__visit_invokeESM_SN_.exit.i.i.i": ; preds = %bb.g, %bb.f
  ...
  %i.bq = fmul float %i.ar, %i.bo                 ; 3 uses
  ...
  %i.cc = extractelement <2 x float> %i.cb, i64 1 ; 4 uses
  %5 = fmul float %i.cc, 2.000000e+00             ; 2 uses
  %6 = fneg float %5                              ; 2 uses
  %7 = extractelement <2 x float> %i.cb, i64 0
  %8 = fmul float %i.bq, %5                       ; 2 uses
  %9 = fneg float %8
  %10 = tail call float @llvm.fmuladd.f32(float %6, float %i.cc, float 1.000000e+00)
  %11 = insertelement <2 x float> poison, float %10, i64 0
  %12 = insertelement <2 x float> poison, float %i.am, i64 0
  %13 = shufflevector <2 x float> %12, <2 x float> poison, <2 x i32> zeroinitializer
  %14 = insertelement <4 x float> <float poison, float 1.000000e+00, float poison, float poison>, float %i.ak, i64 0
  %15 = shufflevector <4 x float> %14, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
  %16 = shufflevector <2 x float> %i.cb, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %i.cd = insertelement <2 x float> %16, float %i.bp, i64 0
  %17 = fmul <2 x float> %i.cd, splat (float 2.000000e+00) ; 5 uses
  %18 = extractelement <2 x float> %17, i64 0     ; 4 uses
  %i.ce = fneg float %18
  %19 = fmul float %i.bq, %18                     ; 2 uses
  %20 = extractelement <2 x float> %17, i64 1     ; 2 uses
  %21 = fneg float %20                            ; 2 uses
  %22 = fmul float %i.bq, %20                     ; 2 uses
  %23 = fneg float %22
  %24 = insertelement <2 x float> poison, float %21, i64 0
  %25 = shufflevector <2 x float> %24, <2 x float> %17, <2 x i32> <i32 0, i32 2>
  %i.cf = insertelement <2 x float> %11, float %23, i64 1
  %i.cg = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %25, <2 x float> %i.cb, <2 x float> %i.cf)
  %i.ch = insertelement <2 x float> poison, float %9, i64 0
  %i.ci = insertelement <2 x float> %i.ch, float %19, i64 1
  %i.cj = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %17, <2 x float> %i.cb, <2 x float> %i.ci)
  %26 = tail call float @llvm.fmuladd.f32(float %18, float %7, float %8)
  %27 = fneg float %19
  %i.ck = tail call float @llvm.fmuladd.f32(float %i.ce, float %i.bp, float 1.000000e+00) ; 2 uses
  %i.cl = insertelement <2 x float> %17, float %21, i64 0
  %i.cm = insertelement <2 x float> poison, float %i.ck, i64 0
  %i.cn = insertelement <2 x float> %i.cm, float %27, i64 1
  %i.co = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cl, <2 x float> %i.cb, <2 x float> %i.cn)
  %i.cp = tail call float @llvm.fmuladd.f32(float %18, float %i.cc, float %22)
  %28 = tail call float @llvm.fmuladd.f32(float %6, float %i.cc, float %i.ck)
  %29 = fmul <2 x float> %i.cg, %13
  store <2 x float> %29, ptr %4, align 16, !tbaa !412, !alias.scope !931
  %i.cq = fmul float %26, %i.am
  store float %i.cq, ptr %i.bu, align 8, !tbaa !412, !alias.scope !931
  %30 = insertelement <4 x float> <float poison, float poison, float poison, float 0.000000e+00>, float %i.cp, i64 0
  %i.cr = shufflevector <2 x float> %i.co, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.cs = shufflevector <4 x float> %30, <4 x float> %i.cr, <4 x i32> <i32 0, i32 4, i32 5, i32 3>
  %i.ct = fmul <4 x float> %i.cs, %15
