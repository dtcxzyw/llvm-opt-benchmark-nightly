...
bb.m:                                             ; preds = %bb.l
  ...
  %i.bu = load i32, ptr %i.bt, align 8, !tbaa !144 ; 3 uses
  %i.bv = trunc i32 %i.bu to i8                   ; 2 uses
  %5 = lshr i8 %i.bv, 4                           ; 2 uses
  %i.bw = and i8 %i.bv, 15                        ; 2 uses
...
bb.n:                                             ; preds = %bb.m
  ...
  %i.cj = tail call noundef i32 @_ZNK5video13COpenGLDriver10getGLBlendENS_14E_BLEND_FACTORE(ptr noundef nonnull align 8 dereferenceable(3992) %i.ci, i8 noundef zeroext %5)
...
bb.o:                                             ; preds = %bb.m
  ...
  %i.cr = tail call noundef i32 @_ZNK5video13COpenGLDriver10getGLBlendENS_14E_BLEND_FACTORE(ptr noundef nonnull align 8 dereferenceable(3992) %i.cq, i8 noundef zeroext %5) ; 5 uses
