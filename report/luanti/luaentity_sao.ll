...
bb.bb:                                            ; preds = %bb.ay, %bb.az, %bb.ba
  ...
  %.sroa.22.0.copyload.i124 = load float, ptr %.sroa.22.0..sroa_idx.i123, align 8, !tbaa !136
  ...
  %11 = insertelement <2 x float> poison, float %.sroa.22.0.copyload.i124, i64 0
  %i.ju = insertelement <2 x float> %11, float %i.ji, i64 1
