...
bb.a:
  ...
  %i.av = shufflevector <2 x float> %i.at, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 7 uses
  %i.aw = extractelement <2 x float> %i.at, i64 0 ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %10 = fneg nsz float %i.df
  %11 = fmul nsz float %i.aq, %10
  %12 = shufflevector <2 x float> %i.at, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %13 = shufflevector <2 x float> %i.at, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.dj = insertelement <2 x float> <float 2.000000e+00, float poison>, float %i.ax, i64 1
  %14 = tail call nsz float @llvm.fmuladd.f32(float %i.aq, float %i.dd, float %i.di) ; 3 uses
  %15 = tail call nsz float @llvm.fmuladd.f32(float %i.aw, float %i.de, float %11) ; 3 uses
  %16 = insertelement <2 x float> poison, float %15, i64 0
  %17 = insertelement <2 x float> %16, float %i.dd, i64 1
  %18 = fneg nsz <2 x float> %17
  %19 = fmul nsz <2 x float> %12, %18
  %i.dk = insertelement <2 x float> poison, float %14, i64 0
  %i.dl = insertelement <2 x float> %i.dk, float %i.df, i64 1
  %i.dm = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %13, <2 x float> %i.dl, <2 x float> %19) ; 3 uses
  %i.dn = extractelement <2 x float> %i.dm, i64 1
  %20 = fneg nsz float %14
  %i.do = fneg nsz float %i.dn
  %i.dp = fmul nsz float %i.aq, %20
  %21 = fmul nsz float %i.dh, %i.do
  %22 = insertelement <2 x float> %i.av, float %i.aq, i64 0
  %23 = insertelement <2 x float> %i.dm, float %15, i64 0
  %24 = insertelement <2 x float> poison, float %21, i64 0
  %25 = insertelement <2 x float> %24, float %i.dp, i64 1
  %26 = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %22, <2 x float> %23, <2 x float> %25)
  %i.dq = fmul nsz float %i.ax, %14
  %27 = fmul nsz float %i.ax, %15
  %i.dr = fmul nsz <2 x float> %i.dj, %i.dm       ; 2 uses
  %28 = fmul nsz <2 x float> %26, splat (float 2.000000e+00) ; 2 uses
  %i.ds = fadd nsz float %i.df, %i.dq
  %i.dt = extractelement <2 x float> %i.dr, i64 1
  %i.du = fadd nsz float %i.de, %i.dt
  %i.dv = fadd nsz float %i.dd, %27
  %29 = extractelement <2 x float> %28, i64 0
  %i.dw = fadd nsz float %i.ds, %29
  %i.dx = extractelement <2 x float> %i.dr, i64 0
  %i.dy = fadd nsz float %i.du, %i.dx
  %30 = extractelement <2 x float> %28, i64 1
  %i.dz = fadd nsz float %i.dv, %30
  ...
  %i.ep = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %12, <2 x float> %i.eo, <2 x float> %i.en) ; 3 uses
