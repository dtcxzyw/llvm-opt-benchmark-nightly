...
bb.c:                                             ; preds = %_ZN15RenderingEngine19get_shadow_rendererEv.exit
  ...
  %3 = load <2 x float>, ptr %i.s, align 4, !tbaa !18
  ...
  %i.bb = shufflevector <4 x float> %4, <4 x float> %i.ax, <2 x i32> <i32 1, i32 5>
  %i.bc = fmul nsz <2 x float> %i.ba, %i.bb
  %i.bd = insertelement <2 x float> %i.ae, float %.sroa.0124.0.copyload, i64 1 ; 3 uses
  %i.be = shufflevector <4 x float> %4, <4 x float> %i.ax, <2 x i32> <i32 0, i32 4>
...
bb.a:
  ...
  %3 = load float, ptr %i.as, align 8, !tbaa !87
  %i.at = getelementptr inbounds nuw i8, ptr %0, i64 44
  %4 = load float, ptr %i.at, align 4, !tbaa !88
  %i.au = getelementptr inbounds nuw i8, ptr %0, i64 48
  %5 = load float, ptr %i.au, align 8, !tbaa !89
  ...
  %6 = load float, ptr %i.ab, align 4, !tbaa !18
  %7 = load float, ptr %i.aa, align 4, !tbaa !18
  %8 = load float, ptr %i.z, align 4, !tbaa !18
  %9 = load float, ptr %i.y, align 4, !tbaa !18
  %i.cg = tail call noundef nonnull align 4 dereferenceable(64) ptr %i.ba(ptr noundef nonnull align 8 dereferenceable(8) %i.i, i32 noundef 1) ; 14 uses
  %10 = insertelement <4 x float> poison, float %8, i64 0
  %i.ch = shufflevector <4 x float> %10, <4 x float> poison, <4 x i32> zeroinitializer
  %i.ci = fmul nsz <4 x float> %i.bc, %i.ch
  %11 = insertelement <4 x float> poison, float %9, i64 0
  %i.cj = shufflevector <4 x float> %11, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.cl = shufflevector <4 x float> %12, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.cn = shufflevector <4 x float> %13, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.cu = shufflevector <4 x float> %14, <4 x float> poison, <4 x i32> zeroinitializer
  %i.cv = fmul nsz <4 x float> %i.co, %i.cu
  %15 = insertelement <4 x float> poison, float %3, i64 0
  %i.cw = shufflevector <4 x float> %15, <4 x float> poison, <4 x i32> zeroinitializer
  %i.cx = tail call nsz <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.cw, <4 x float> %i.bm, <4 x float> %i.cv)
  %16 = insertelement <4 x float> poison, float %5, i64 0
  %i.cy = shufflevector <4 x float> %16, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.db = load <4 x float>, ptr %2, align 16      ; 4 uses
  %i.dc = load <4 x float>, ptr %i.cg, align 4    ; 3 uses
  %i.dd = getelementptr inbounds nuw i8, ptr %i.cg, i64 4
  %17 = load float, ptr %i.dd, align 4, !tbaa !18
  %18 = insertelement <4 x float> poison, float %17, i64 0
  %i.de = shufflevector <4 x float> %18, <4 x float> poison, <4 x i32> zeroinitializer
  %i.df = shufflevector <4 x float> %i.dc, <4 x float> poison, <4 x i32> zeroinitializer
  %19 = shufflevector <4 x float> %i.dc, <4 x float> poison, <4 x i32> <i32 2, i32 2, i32 2, i32 2>
  %20 = shufflevector <4 x float> %i.dc, <4 x float> poison, <4 x i32> <i32 3, i32 3, i32 3, i32 3>
  %i.dg = getelementptr inbounds nuw i8, ptr %i.cg, i64 16
  %21 = load float, ptr %i.dg, align 4, !tbaa !18
  %i.dh = getelementptr inbounds nuw i8, ptr %i.cg, i64 20
  %22 = load float, ptr %i.dh, align 4, !tbaa !18
  %i.di = getelementptr inbounds nuw i8, ptr %i.cg, i64 24
  %23 = load float, ptr %i.di, align 4, !tbaa !18
  %i.dj = getelementptr inbounds nuw i8, ptr %i.cg, i64 28
  %24 = load float, ptr %i.dj, align 4, !tbaa !18
  ...
  %i.dn = tail call nsz <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.db, <4 x float> %i.df, <4 x float> %i.dm)
  %i.do = tail call nsz <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.bu, <4 x float> %19, <4 x float> %i.dn)
  %i.dp = tail call nsz <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.cf, <4 x float> %20, <4 x float> %i.do)
  store <4 x float> %i.dp, ptr %2, align 16, !tbaa !18
  %25 = insertelement <4 x float> poison, float %22, i64 0
  %i.dq = shufflevector <4 x float> %25, <4 x float> poison, <4 x i32> zeroinitializer
  %i.dr = fmul nsz <4 x float> %i.dl, %i.dq
  %26 = insertelement <4 x float> poison, float %21, i64 0
  %i.ds = shufflevector <4 x float> %26, <4 x float> poison, <4 x i32> zeroinitializer
  %i.dt = tail call nsz <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.db, <4 x float> %i.ds, <4 x float> %i.dr)
  ...
  %29 = load float, ptr %i.dy, align 4, !tbaa !18
  %i.dz = getelementptr inbounds nuw i8, ptr %i.cg, i64 36
  %30 = load float, ptr %i.dz, align 4, !tbaa !18
  %i.ea = getelementptr inbounds nuw i8, ptr %i.cg, i64 40
  %31 = load float, ptr %i.ea, align 4, !tbaa !18
  %i.eb = getelementptr inbounds nuw i8, ptr %i.cg, i64 44
  %32 = load float, ptr %i.eb, align 4, !tbaa !18
  ...
  %i.ee = shufflevector <4 x float> %33, <4 x float> poison, <4 x i32> zeroinitializer
  %i.ef = fmul nsz <4 x float> %i.ed, %i.ee
  %34 = insertelement <4 x float> poison, float %29, i64 0
  %i.eg = shufflevector <4 x float> %34, <4 x float> poison, <4 x i32> zeroinitializer
  %i.eh = tail call nsz <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.db, <4 x float> %i.eg, <4 x float> %i.ef)
  %35 = insertelement <4 x float> poison, float %31, i64 0
  %i.ei = shufflevector <4 x float> %35, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.ek = shufflevector <4 x float> %36, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %37 = load float, ptr %i.em, align 4, !tbaa !18
  ...
  %i.ew = shufflevector <4 x float> %38, <4 x float> poison, <4 x i32> zeroinitializer
  %i.ex = tail call nsz <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.db, <4 x float> %i.ew, <4 x float> %i.ev)
...
_ZN19CachedShaderSettingIiLm1ELb1EE3setEPKiPN5video25IMaterialRendererServicesE.exit: ; preds = %bb.b, %bb.c
  ...
  %i.hr = load float, ptr %i.hq, align 8, !tbaa !90 ; 3 uses
...
_ZN19CachedShaderSettingIfLm1ELb1EE3setEPKfPN5video25IMaterialRendererServicesE.exit31: ; preds = %.lr.ph.i.i.i.i.preheader.i29, %_ZSt5equalIPfPKfEbT_S3_T0_.exit.i26
  ...
  %i.jk = load float, ptr %i.jj, align 4, !tbaa !99 ; 2 uses
...
!89 = !{!34, !19, i64 8}
!90 = !{!91, !19, i64 32}
!91 = !{!"_ZTS24ShadowDepthUniformSetter", !92, i64 0, !19, i64 24, !19, i64 28, !19, i64 32, !19, i64 36, !34, i64 40, !95, i64 56, !96, i64 136, !96, i64 152, !97, i64 168, !96, i64 184, !96, i64 200, !96, i64 216, !98, i64 232}
!92 = !{!"_ZTS22IShaderUniformSetterRC", !93, i64 0, !94, i64 16}
!93 = !{!"_ZTS17IReferenceCounted", !6, i64 8}
!94 = !{!"_ZTS20IShaderUniformSetter"}
!95 = !{!"_ZTS25CachedVertexShaderSettingIfLm16ELb1EE", !84, i64 0}
!96 = !{!"_ZTS25CachedVertexShaderSettingIfLm1ELb1EE", !38, i64 0}
!97 = !{!"_ZTS24CachedPixelShaderSettingIiLm1ELb1EE", !77, i64 0}
!98 = !{!"_ZTS25CachedVertexShaderSettingIfLm4ELb1EE", !72, i64 0}
!99 = !{!91, !19, i64 36}
end_hunk_1
