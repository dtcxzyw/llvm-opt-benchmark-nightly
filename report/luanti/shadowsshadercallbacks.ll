...
bb.c:                                             ; preds = %_ZN15RenderingEngine19get_shadow_rendererEv.exit
  ...
  %3 = load <4 x float>, ptr %i.aa, align 4       ; 2 uses
  ...
  %i.co = shufflevector <4 x float> %3, <4 x float> %i.ck, <2 x i32> <i32 1, i32 5>
  %i.cp = fmul nsz <2 x float> %i.cn, %i.co
  %i.cq = shufflevector <4 x float> %3, <4 x float> %i.ck, <2 x i32> <i32 0, i32 4>
  ...
  %4 = load <4 x float>, ptr %i.bx, align 4       ; 2 uses
  ...
  %i.dw = shufflevector <4 x float> %4, <4 x float> %i.ds, <2 x i32> <i32 1, i32 5>
  %i.dx = fmul nsz <2 x float> %i.cn, %i.dw
  %i.dy = shufflevector <4 x float> %4, <4 x float> %i.ds, <2 x i32> <i32 0, i32 4>
