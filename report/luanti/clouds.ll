...
bb.a:
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(24) %0, ptr noundef nonnull align 4 dereferenceable(24) %i.d, i64 24, i1 false), !tbaa.struct !170
  ...
  %i.j = load <6 x float>, ptr %0, align 4, !tbaa !24 ; 12 uses
  %i.k = load <3 x float>, ptr %i.g, align 8, !tbaa !24 ; 2 uses
  %i.l = shufflevector <3 x float> %i.k, <3 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 2>
  %i.m = load <3 x float>, ptr %i.e, align 8, !tbaa !24
  ...
  %i.v = load <3 x float>, ptr %i.h, align 8, !tbaa !24
  ...
  %i.ae = load <3 x float>, ptr %i.i, align 8, !tbaa !24
  ...
  store <4 x float> %i.at, ptr %0, align 4, !tbaa !24
  ...
  store <2 x float> %i.bj, ptr %i.f, align 4, !tbaa !24
  ret void
}
...
bb.a:
  ...
  %i.c = load ptr, ptr %1, align 8, !tbaa !174    ; 2 uses
...
_ZSt8_DestroyIPN4core8vector3dIfEES2_EvT_S4_RSaIT0_E.exit.i.i.i: ; preds = %bb.d
  store ptr %i.j, ptr %i.a, align 8, !tbaa !173
  br label %_ZN4core5arrayINS_8vector3dIfEEE8set_usedEj.exit
...
_ZN4core5arrayINS_8vector3dIfEEE8set_usedEj.exit: ; preds = %bb.b, %bb.c, %bb.d, %_ZSt8_DestroyIPN4core8vector3dIfEES2_EvT_S4_RSaIT0_E.exit.i.i.i
  ...
  %i.o = load ptr, ptr %1, align 8, !tbaa !251    ; 18 uses
  ...
  %i.ae = load <2 x float>, ptr %i.n, align 4, !tbaa !24
  %i.af = load <2 x float>, ptr %i.p, align 4, !tbaa !24 ; 2 uses
  %i.ag = load <2 x float>, ptr %i.q, align 4, !tbaa !24
  %i.ah = load <2 x float>, ptr %i.r, align 4, !tbaa !24 ; 2 uses
  ...
  store float %i.ao, ptr %i.o, align 4, !tbaa !169
  %i.aq = extractelement <2 x float> %i.ap, i64 0 ; 3 uses
  store float %i.aq, ptr %i.s, align 4, !tbaa !168
  %i.ar = extractelement <2 x float> %i.ap, i64 1 ; 3 uses
  store float %i.ar, ptr %i.t, align 4, !tbaa !165
  store float %i.ao, ptr %i.u, align 4, !tbaa !169
  %i.as = fsub nsz <2 x float> %i.ak, %i.am       ; 3 uses
  %i.at = extractelement <2 x float> %i.as, i64 1 ; 3 uses
  store float %i.at, ptr %i.v, align 4, !tbaa !168
  store float %i.ar, ptr %i.w, align 4, !tbaa !165
  %foldExtExtBinop10 = fsub nsz <2 x float> %i.al, %i.an
  %i.au = extractelement <2 x float> %foldExtExtBinop10, i64 1 ; 4 uses
  store float %i.ao, ptr %i.x, align 4, !tbaa !169
  store float %i.aq, ptr %i.y, align 4, !tbaa !168
  store float %i.au, ptr %i.z, align 4, !tbaa !165
  store float %i.ao, ptr %i.aa, align 4, !tbaa !169
  store float %i.at, ptr %i.ab, align 4, !tbaa !168
  store float %i.au, ptr %i.ac, align 4, !tbaa !165
  %i.av = shufflevector <2 x float> %i.as, <2 x float> %i.ap, <8 x i32> <i32 0, i32 2, i32 3, i32 0, i32 1, i32 3, i32 0, i32 2>
  store <8 x float> %i.av, ptr %i.ad, align 4, !tbaa !24
  %i.aw = getelementptr inbounds nuw i8, ptr %i.o, i64 80
  store float %i.au, ptr %i.aw, align 4, !tbaa !165
  %i.ax = getelementptr inbounds nuw i8, ptr %i.o, i64 84
  %i.ay = extractelement <2 x float> %i.as, i64 0
  store float %i.ay, ptr %i.ax, align 4, !tbaa !169
  %i.az = getelementptr inbounds nuw i8, ptr %i.o, i64 88
  store float %i.at, ptr %i.az, align 4, !tbaa !168
  %i.ba = getelementptr inbounds nuw i8, ptr %i.o, i64 92
  store float %i.au, ptr %i.ba, align 4, !tbaa !165
  ...
  %i.bj = load <2 x float>, ptr %i.bb, align 8, !tbaa !24
  %i.bk = load <2 x float>, ptr %i.bc, align 8, !tbaa !24
  ...
  %i.bp = load <2 x float>, ptr %i.bd, align 8, !tbaa !24
  ...
  %i.bs = load <2 x float>, ptr %i.be, align 8, !tbaa !24
  %i.bt = fadd nsz <2 x float> %i.br, %i.bs
  %i.bu = load float, ptr %i.bf, align 8, !tbaa !24
  %i.bv = load float, ptr %i.bg, align 8, !tbaa !24
  %i.bw = fmul nsz float %i.aq, %i.bv
  %i.bx = tail call nsz float @llvm.fmuladd.f32(float %i.ao, float %i.bu, float %i.bw)
  %i.by = load float, ptr %i.bh, align 8, !tbaa !24
  %i.bz = tail call nsz float @llvm.fmuladd.f32(float %i.ar, float %i.by, float %i.bx)
  %i.ca = load float, ptr %i.bi, align 8, !tbaa !24
  %i.cb = fadd nsz float %i.ca, %i.bz
  store <2 x float> %i.bt, ptr %i.o, align 4
  store float %i.cb, ptr %i.t, align 4, !tbaa !24
  %i.cc = load ptr, ptr %1, align 8, !tbaa !174   ; 3 uses
  ...
  %3 = load float, ptr %i.cd, align 4, !tbaa !168 ; 2 uses
  %4 = load float, ptr %2, align 4, !tbaa !169    ; 2 uses
  %i.cf = load float, ptr %i.ce, align 4, !tbaa !165 ; 2 uses
  %i.cg = load <2 x float>, ptr %i.bb, align 8, !tbaa !24
  %i.ch = load <2 x float>, ptr %i.bc, align 8, !tbaa !24
  ...
  %i.cl = load <2 x float>, ptr %i.bd, align 8, !tbaa !24
  ...
  %11 = load float, ptr %i.cy, align 4, !tbaa !168 ; 2 uses
  %12 = load float, ptr %10, align 4, !tbaa !169  ; 2 uses
  %i.da = load float, ptr %i.cz, align 4, !tbaa !165 ; 2 uses
  %i.db = load <2 x float>, ptr %i.bb, align 8, !tbaa !24
  %i.dc = load <2 x float>, ptr %i.bc, align 8, !tbaa !24
  ...
  %i.dg = load <2 x float>, ptr %i.bd, align 8, !tbaa !24
  ...
  %i.di = load <2 x float>, ptr %i.be, align 8, !tbaa !24
  %i.dj = fadd nsz <2 x float> %i.dh, %i.di
  %i.dk = load float, ptr %i.bf, align 8, !tbaa !24
  %i.dl = load float, ptr %i.bg, align 8, !tbaa !24
  %i.dm = fmul nsz float %11, %i.dl
  %i.dn = tail call nsz float @llvm.fmuladd.f32(float %12, float %i.dk, float %i.dm)
  %i.do = load float, ptr %i.bh, align 8, !tbaa !24
  %i.dp = tail call nsz float @llvm.fmuladd.f32(float %i.da, float %i.do, float %i.dn)
  %i.dq = load float, ptr %i.bi, align 8, !tbaa !24
  %i.dr = fadd nsz float %i.dq, %i.dp
  store <2 x float> %i.dj, ptr %10, align 4
  store float %i.dr, ptr %i.cz, align 4, !tbaa !24
  %i.ds = load ptr, ptr %1, align 8, !tbaa !174   ; 3 uses
  ...
  %19 = load float, ptr %i.dt, align 4, !tbaa !168 ; 2 uses
  %20 = load float, ptr %18, align 4, !tbaa !169  ; 2 uses
  %i.dv = load float, ptr %i.du, align 4, !tbaa !165 ; 2 uses
  %i.dw = load <2 x float>, ptr %i.bb, align 8, !tbaa !24
  %i.dx = load <2 x float>, ptr %i.bc, align 8, !tbaa !24
  ...
  %i.eb = load <2 x float>, ptr %i.bd, align 8, !tbaa !24
  ...
  %i.ed = load <2 x float>, ptr %i.be, align 8, !tbaa !24
  %i.ee = fadd nsz <2 x float> %i.ec, %i.ed
  %i.ef = load float, ptr %i.bf, align 8, !tbaa !24
  %i.eg = load float, ptr %i.bg, align 8, !tbaa !24
  %i.eh = fmul nsz float %19, %i.eg
  %i.ei = tail call nsz float @llvm.fmuladd.f32(float %20, float %i.ef, float %i.eh)
  %i.ej = load float, ptr %i.bh, align 8, !tbaa !24
  %i.ek = tail call nsz float @llvm.fmuladd.f32(float %i.dv, float %i.ej, float %i.ei)
  %i.el = load float, ptr %i.bi, align 8, !tbaa !24
  %i.em = fadd nsz float %i.el, %i.ek
  store <2 x float> %i.ee, ptr %18, align 4
  store float %i.em, ptr %i.du, align 4, !tbaa !24
  %i.en = load ptr, ptr %1, align 8, !tbaa !174   ; 3 uses
  ...
  %27 = load float, ptr %i.eo, align 4, !tbaa !168 ; 2 uses
  %28 = load float, ptr %26, align 4, !tbaa !169  ; 2 uses
  %i.eq = load float, ptr %i.ep, align 4, !tbaa !165 ; 2 uses
  %i.er = load <2 x float>, ptr %i.bb, align 8, !tbaa !24
  %i.es = load <2 x float>, ptr %i.bc, align 8, !tbaa !24
  ...
  %i.ew = load <2 x float>, ptr %i.bd, align 8, !tbaa !24
  ...
  %i.ey = load <2 x float>, ptr %i.be, align 8, !tbaa !24
  %i.ez = fadd nsz <2 x float> %i.ex, %i.ey
  %i.fa = load float, ptr %i.bf, align 8, !tbaa !24
  %i.fb = load float, ptr %i.bg, align 8, !tbaa !24
  %i.fc = fmul nsz float %27, %i.fb
  %i.fd = tail call nsz float @llvm.fmuladd.f32(float %28, float %i.fa, float %i.fc)
  %i.fe = load float, ptr %i.bh, align 8, !tbaa !24
  %i.ff = tail call nsz float @llvm.fmuladd.f32(float %i.eq, float %i.fe, float %i.fd)
  %i.fg = load float, ptr %i.bi, align 8, !tbaa !24
  %i.fh = fadd nsz float %i.fg, %i.ff
  store <2 x float> %i.ez, ptr %26, align 4
  store float %i.fh, ptr %i.ep, align 4, !tbaa !24
  %i.fi = load ptr, ptr %1, align 8, !tbaa !174   ; 3 uses
  ...
  %35 = load float, ptr %i.fj, align 4, !tbaa !168 ; 2 uses
  %36 = load float, ptr %34, align 4, !tbaa !169  ; 2 uses
  %i.fl = load float, ptr %i.fk, align 4, !tbaa !165 ; 2 uses
  %i.fm = load <2 x float>, ptr %i.bb, align 8, !tbaa !24
  %i.fn = load <2 x float>, ptr %i.bc, align 8, !tbaa !24
  ...
  %i.fr = load <2 x float>, ptr %i.bd, align 8, !tbaa !24
  ...
  %i.ft = load <2 x float>, ptr %i.be, align 8, !tbaa !24
  %i.fu = fadd nsz <2 x float> %i.fs, %i.ft
  %i.fv = load float, ptr %i.bf, align 8, !tbaa !24
  %i.fw = load float, ptr %i.bg, align 8, !tbaa !24
  %i.fx = fmul nsz float %35, %i.fw
  %i.fy = tail call nsz float @llvm.fmuladd.f32(float %36, float %i.fv, float %i.fx)
  %i.fz = load float, ptr %i.bh, align 8, !tbaa !24
  %i.ga = tail call nsz float @llvm.fmuladd.f32(float %i.fl, float %i.fz, float %i.fy)
  %i.gb = load float, ptr %i.bi, align 8, !tbaa !24
  %i.gc = fadd nsz float %i.gb, %i.ga
  store <2 x float> %i.fu, ptr %34, align 4
  store float %i.gc, ptr %i.fk, align 4, !tbaa !24
  %i.gd = load ptr, ptr %1, align 8, !tbaa !174   ; 3 uses
  ...
  %43 = load float, ptr %i.ge, align 4, !tbaa !168 ; 2 uses
  %44 = load float, ptr %42, align 4, !tbaa !169  ; 2 uses
  %i.gg = load float, ptr %i.gf, align 4, !tbaa !165 ; 2 uses
  %i.gh = load <2 x float>, ptr %i.bb, align 8, !tbaa !24
  %i.gi = load <2 x float>, ptr %i.bc, align 8, !tbaa !24
  ...
  %i.gm = load <2 x float>, ptr %i.bd, align 8, !tbaa !24
  ...
  %i.go = load <2 x float>, ptr %i.be, align 8, !tbaa !24
  %i.gp = fadd nsz <2 x float> %i.gn, %i.go
  %i.gq = load float, ptr %i.bf, align 8, !tbaa !24
  %i.gr = load float, ptr %i.bg, align 8, !tbaa !24
  %i.gs = fmul nsz float %43, %i.gr
  %i.gt = tail call nsz float @llvm.fmuladd.f32(float %44, float %i.gq, float %i.gs)
  %i.gu = load float, ptr %i.bh, align 8, !tbaa !24
  %i.gv = tail call nsz float @llvm.fmuladd.f32(float %i.gg, float %i.gu, float %i.gt)
  %i.gw = load float, ptr %i.bi, align 8, !tbaa !24
  %i.gx = fadd nsz float %i.gw, %i.gv
  store <2 x float> %i.gp, ptr %42, align 4
  store float %i.gx, ptr %i.gf, align 4, !tbaa !24
  %i.gy = load ptr, ptr %1, align 8, !tbaa !174   ; 3 uses
  ...
  %51 = load float, ptr %i.gz, align 4, !tbaa !168 ; 2 uses
  %52 = load float, ptr %50, align 4, !tbaa !169  ; 2 uses
  %i.hb = load float, ptr %i.ha, align 4, !tbaa !165 ; 2 uses
  %i.hc = load <2 x float>, ptr %i.bb, align 8, !tbaa !24
  %i.hd = load <2 x float>, ptr %i.bc, align 8, !tbaa !24
  ...
  %i.hh = load <2 x float>, ptr %i.bd, align 8, !tbaa !24
...
bb.a:
  ...
  %i.f = load float, ptr %i.e, align 4, !tbaa !165
  ...
  %i.q = load <2 x float>, ptr %i.d, align 4, !tbaa !24
  ...
  store <2 x float> %i.an, ptr %i.k, align 4, !tbaa !24
  ...
  store <2 x float> %i.at, ptr %i.m, align 4, !tbaa !24
  ...
  store float %i.ax, ptr %i.l, align 4, !tbaa !24
  %i.ay = extractelement <2 x double> %i.av, i64 1
  %i.az = fptrunc nsz double %i.ay to float       ; 5 uses
  store float %i.az, ptr %i.c, align 4, !tbaa !24
  %i.ba = load <2 x float>, ptr %i.o, align 8, !tbaa !24 ; 5 uses
  store <2 x float> %i.ba, ptr %i.p, align 4, !tbaa !24
  %i.bb = getelementptr inbounds nuw i8, ptr %1, i64 120
  %i.bc = load float, ptr %i.bb, align 8, !tbaa !165 ; 5 uses
  %i.bd = getelementptr inbounds nuw i8, ptr %0, i64 56 ; 2 uses
  store float %i.bc, ptr %i.bd, align 4, !tbaa !24
  %i.be = getelementptr inbounds nuw i8, ptr %1, i64 136
  %i.bf = load float, ptr %i.be, align 8, !tbaa !169 ; 4 uses
  %i.bg = fcmp nsz oeq float %i.bf, 1.000000e+00
  %i.bh = getelementptr inbounds nuw i8, ptr %1, i64 140
  %i.bi = load float, ptr %i.bh, align 4, !tbaa !168 ; 2 uses
...
_ZNK4core8vector3dIfEneERKS1_.exit:               ; preds = %bb.a
  ...
  %i.bl = load float, ptr %i.bk, align 8, !tbaa !165
...
_ZNK4core8vector3dIfEneERKS1_.exit.thread:        ; preds = %bb.a, %_ZNK4core8vector3dIfEneERKS1_.exit
  ...
  %i.bp = load float, ptr %i.bo, align 8, !tbaa !165 ; 3 uses
  ...
  store <2 x float> %i.bv, ptr %0, align 4, !tbaa !24
  ...
  store float %i.bz, ptr %i.i, align 4, !tbaa !24
  %i.ca = fmul nsz float %i.bf, 0.000000e+00
  store float %i.ca, ptr %.sroa.15.0..sroa_idx, align 4, !tbaa !24
  ...
  store <2 x float> %i.cg, ptr %i.k, align 4, !tbaa !24
  ...
  store float %i.ck, ptr %i.l, align 4, !tbaa !24
  %i.cl = fmul nsz float %i.bn, 0.000000e+00
  store float %i.cl, ptr %.sroa.3172.0..sroa_idx, align 4, !tbaa !24
  ...
  store float %i.co, ptr %i.c, align 4, !tbaa !24
  %i.cp = fmul nsz float %i.bp, 0.000000e+00
  store float %i.cp, ptr %.sroa.4788.0..sroa_idx, align 4, !tbaa !24
  ...
  store <2 x float> %i.cu, ptr %i.m, align 4, !tbaa !24
...
bb.a:
  ...
  store i8 %i.a, ptr %i.b, align 8, !tbaa !56
  ret void
end_hunk_0
