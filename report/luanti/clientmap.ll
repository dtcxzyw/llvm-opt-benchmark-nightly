...
bb.a:
  ...
  %i.j = load <6 x float>, ptr %0, align 4, !tbaa !82 ; 12 uses
  ...
  %i.m = load <3 x float>, ptr %i.e, align 8, !tbaa !82
  ...
  %i.v = load <3 x float>, ptr %i.h, align 8, !tbaa !82
  ...
  %i.ae = load <3 x float>, ptr %i.i, align 8, !tbaa !82
  ...
  store <4 x float> %i.at, ptr %0, align 4, !tbaa !82
  ...
  store <2 x float> %i.bj, ptr %i.f, align 4, !tbaa !82
  ret void
}
...
_ZN4core5arrayINS_8vector3dIfEEE8set_usedEj.exit: ; preds = %bb.b, %bb.c, %bb.d, %_ZSt8_DestroyIPN4core8vector3dIfEES2_EvT_S4_RSaIT0_E.exit.i.i.i
  ...
  %3 = load float, ptr %i.cd, align 4, !tbaa !482 ; 2 uses
  %4 = load float, ptr %2, align 4, !tbaa !481    ; 2 uses
  %i.cf = load float, ptr %i.ce, align 4, !tbaa !483 ; 2 uses
  %i.cg = load <2 x float>, ptr %i.bb, align 8, !tbaa !82
  %i.ch = load <2 x float>, ptr %i.bc, align 8, !tbaa !82
  ...
  %i.cl = load <2 x float>, ptr %i.bd, align 8, !tbaa !82
  ...
  %i.cn = load <2 x float>, ptr %i.be, align 8, !tbaa !82
  %i.co = fadd nsz <2 x float> %i.cm, %i.cn
  %i.cp = load float, ptr %i.bf, align 8, !tbaa !82
  %i.cq = load float, ptr %i.bg, align 8, !tbaa !82
  %i.cr = fmul nsz float %3, %i.cq
  %i.cs = tail call nsz float @llvm.fmuladd.f32(float %4, float %i.cp, float %i.cr)
  %i.ct = load float, ptr %i.bh, align 8, !tbaa !82
  %i.cu = tail call nsz float @llvm.fmuladd.f32(float %i.cf, float %i.ct, float %i.cs)
  %i.cv = load float, ptr %i.bi, align 8, !tbaa !82
  %i.cw = fadd nsz float %i.cv, %i.cu
  store <2 x float> %i.co, ptr %2, align 4
  store float %i.cw, ptr %i.ce, align 4, !tbaa !82
  %i.cx = load ptr, ptr %1, align 8, !tbaa !655   ; 3 uses
  ...
  %11 = load float, ptr %i.cy, align 4, !tbaa !482 ; 2 uses
  %12 = load float, ptr %10, align 4, !tbaa !481  ; 2 uses
  %i.da = load float, ptr %i.cz, align 4, !tbaa !483 ; 2 uses
  %i.db = load <2 x float>, ptr %i.bb, align 8, !tbaa !82
  %i.dc = load <2 x float>, ptr %i.bc, align 8, !tbaa !82
  ...
  %i.dg = load <2 x float>, ptr %i.bd, align 8, !tbaa !82
  ...
  %i.di = load <2 x float>, ptr %i.be, align 8, !tbaa !82
  %i.dj = fadd nsz <2 x float> %i.dh, %i.di
  %i.dk = load float, ptr %i.bf, align 8, !tbaa !82
  %i.dl = load float, ptr %i.bg, align 8, !tbaa !82
  %i.dm = fmul nsz float %11, %i.dl
  %i.dn = tail call nsz float @llvm.fmuladd.f32(float %12, float %i.dk, float %i.dm)
  %i.do = load float, ptr %i.bh, align 8, !tbaa !82
  %i.dp = tail call nsz float @llvm.fmuladd.f32(float %i.da, float %i.do, float %i.dn)
  %i.dq = load float, ptr %i.bi, align 8, !tbaa !82
  %i.dr = fadd nsz float %i.dq, %i.dp
  store <2 x float> %i.dj, ptr %10, align 4
  store float %i.dr, ptr %i.cz, align 4, !tbaa !82
  %i.ds = load ptr, ptr %1, align 8, !tbaa !655   ; 3 uses
  ...
  %19 = load float, ptr %i.dt, align 4, !tbaa !482 ; 2 uses
  %20 = load float, ptr %18, align 4, !tbaa !481  ; 2 uses
  %i.dv = load float, ptr %i.du, align 4, !tbaa !483 ; 2 uses
  %i.dw = load <2 x float>, ptr %i.bb, align 8, !tbaa !82
  %i.dx = load <2 x float>, ptr %i.bc, align 8, !tbaa !82
  ...
  %i.eb = load <2 x float>, ptr %i.bd, align 8, !tbaa !82
  ...
  %i.ed = load <2 x float>, ptr %i.be, align 8, !tbaa !82
  %i.ee = fadd nsz <2 x float> %i.ec, %i.ed
  %i.ef = load float, ptr %i.bf, align 8, !tbaa !82
  %i.eg = load float, ptr %i.bg, align 8, !tbaa !82
  %i.eh = fmul nsz float %19, %i.eg
  %i.ei = tail call nsz float @llvm.fmuladd.f32(float %20, float %i.ef, float %i.eh)
  %i.ej = load float, ptr %i.bh, align 8, !tbaa !82
  %i.ek = tail call nsz float @llvm.fmuladd.f32(float %i.dv, float %i.ej, float %i.ei)
  %i.el = load float, ptr %i.bi, align 8, !tbaa !82
  %i.em = fadd nsz float %i.el, %i.ek
  store <2 x float> %i.ee, ptr %18, align 4
  store float %i.em, ptr %i.du, align 4, !tbaa !82
  %i.en = load ptr, ptr %1, align 8, !tbaa !655   ; 3 uses
  ...
  %27 = load float, ptr %i.eo, align 4, !tbaa !482 ; 2 uses
  %28 = load float, ptr %26, align 4, !tbaa !481  ; 2 uses
  %i.eq = load float, ptr %i.ep, align 4, !tbaa !483 ; 2 uses
  %i.er = load <2 x float>, ptr %i.bb, align 8, !tbaa !82
  %i.es = load <2 x float>, ptr %i.bc, align 8, !tbaa !82
  ...
  %i.ew = load <2 x float>, ptr %i.bd, align 8, !tbaa !82
  ...
  %i.ey = load <2 x float>, ptr %i.be, align 8, !tbaa !82
  %i.ez = fadd nsz <2 x float> %i.ex, %i.ey
  %i.fa = load float, ptr %i.bf, align 8, !tbaa !82
  %i.fb = load float, ptr %i.bg, align 8, !tbaa !82
  %i.fc = fmul nsz float %27, %i.fb
  %i.fd = tail call nsz float @llvm.fmuladd.f32(float %28, float %i.fa, float %i.fc)
  %i.fe = load float, ptr %i.bh, align 8, !tbaa !82
  %i.ff = tail call nsz float @llvm.fmuladd.f32(float %i.eq, float %i.fe, float %i.fd)
  %i.fg = load float, ptr %i.bi, align 8, !tbaa !82
  %i.fh = fadd nsz float %i.fg, %i.ff
  store <2 x float> %i.ez, ptr %26, align 4
  store float %i.fh, ptr %i.ep, align 4, !tbaa !82
  %i.fi = load ptr, ptr %1, align 8, !tbaa !655   ; 3 uses
  ...
  %35 = load float, ptr %i.fj, align 4, !tbaa !482 ; 2 uses
  %36 = load float, ptr %34, align 4, !tbaa !481  ; 2 uses
  %i.fl = load float, ptr %i.fk, align 4, !tbaa !483 ; 2 uses
  %i.fm = load <2 x float>, ptr %i.bb, align 8, !tbaa !82
  %i.fn = load <2 x float>, ptr %i.bc, align 8, !tbaa !82
  ...
  %i.fr = load <2 x float>, ptr %i.bd, align 8, !tbaa !82
  ...
  %i.ft = load <2 x float>, ptr %i.be, align 8, !tbaa !82
  %i.fu = fadd nsz <2 x float> %i.fs, %i.ft
  %i.fv = load float, ptr %i.bf, align 8, !tbaa !82
  %i.fw = load float, ptr %i.bg, align 8, !tbaa !82
  %i.fx = fmul nsz float %35, %i.fw
  %i.fy = tail call nsz float @llvm.fmuladd.f32(float %36, float %i.fv, float %i.fx)
  %i.fz = load float, ptr %i.bh, align 8, !tbaa !82
  %i.ga = tail call nsz float @llvm.fmuladd.f32(float %i.fl, float %i.fz, float %i.fy)
  %i.gb = load float, ptr %i.bi, align 8, !tbaa !82
  %i.gc = fadd nsz float %i.gb, %i.ga
  store <2 x float> %i.fu, ptr %34, align 4
  store float %i.gc, ptr %i.fk, align 4, !tbaa !82
  %i.gd = load ptr, ptr %1, align 8, !tbaa !655   ; 3 uses
  ...
  %43 = load float, ptr %i.ge, align 4, !tbaa !482 ; 2 uses
  %44 = load float, ptr %42, align 4, !tbaa !481  ; 2 uses
  %i.gg = load float, ptr %i.gf, align 4, !tbaa !483 ; 2 uses
  %i.gh = load <2 x float>, ptr %i.bb, align 8, !tbaa !82
  %i.gi = load <2 x float>, ptr %i.bc, align 8, !tbaa !82
  ...
  %i.gm = load <2 x float>, ptr %i.bd, align 8, !tbaa !82
  ...
  %i.go = load <2 x float>, ptr %i.be, align 8, !tbaa !82
  %i.gp = fadd nsz <2 x float> %i.gn, %i.go
  %i.gq = load float, ptr %i.bf, align 8, !tbaa !82
  %i.gr = load float, ptr %i.bg, align 8, !tbaa !82
  %i.gs = fmul nsz float %43, %i.gr
  %i.gt = tail call nsz float @llvm.fmuladd.f32(float %44, float %i.gq, float %i.gs)
  %i.gu = load float, ptr %i.bh, align 8, !tbaa !82
  %i.gv = tail call nsz float @llvm.fmuladd.f32(float %i.gg, float %i.gu, float %i.gt)
  %i.gw = load float, ptr %i.bi, align 8, !tbaa !82
  %i.gx = fadd nsz float %i.gw, %i.gv
  store <2 x float> %i.gp, ptr %42, align 4
  store float %i.gx, ptr %i.gf, align 4, !tbaa !82
  %i.gy = load ptr, ptr %1, align 8, !tbaa !655   ; 3 uses
  ...
  %51 = load float, ptr %i.gz, align 4, !tbaa !482 ; 2 uses
  %52 = load float, ptr %50, align 4, !tbaa !481  ; 2 uses
  %i.hb = load float, ptr %i.ha, align 4, !tbaa !483 ; 2 uses
  %i.hc = load <2 x float>, ptr %i.bb, align 8, !tbaa !82
  %i.hd = load <2 x float>, ptr %i.bc, align 8, !tbaa !82
  ...
  %i.hh = load <2 x float>, ptr %i.bd, align 8, !tbaa !82
...
bb.a:
  ...
  %i.q = load <2 x float>, ptr %i.d, align 4, !tbaa !82
  ...
  store <2 x float> %i.an, ptr %i.k, align 4, !tbaa !82
  ...
  store <2 x float> %i.at, ptr %i.m, align 4, !tbaa !82
  ...
  store float %i.ax, ptr %i.l, align 4, !tbaa !82
  %i.ay = extractelement <2 x double> %i.av, i64 1
  %i.az = fptrunc nsz double %i.ay to float       ; 5 uses
  store float %i.az, ptr %i.c, align 4, !tbaa !82
  %i.ba = load <2 x float>, ptr %i.o, align 8, !tbaa !82 ; 5 uses
  store <2 x float> %i.ba, ptr %i.p, align 4, !tbaa !82
  %i.bb = getelementptr inbounds nuw i8, ptr %1, i64 120
  %i.bc = load float, ptr %i.bb, align 8, !tbaa !483 ; 5 uses
  %i.bd = getelementptr inbounds nuw i8, ptr %0, i64 56 ; 2 uses
  store float %i.bc, ptr %i.bd, align 4, !tbaa !82
  %i.be = getelementptr inbounds nuw i8, ptr %1, i64 136
  %i.bf = load float, ptr %i.be, align 8, !tbaa !481 ; 4 uses
  %i.bg = fcmp nsz oeq float %i.bf, 1.000000e+00
  %i.bh = getelementptr inbounds nuw i8, ptr %1, i64 140
  %i.bi = load float, ptr %i.bh, align 4, !tbaa !482 ; 2 uses
...
_ZNK4core8vector3dIfEneERKS1_.exit:               ; preds = %bb.a
  ...
  %i.bl = load float, ptr %i.bk, align 8, !tbaa !483
...
_ZNK4core8vector3dIfEneERKS1_.exit.thread:        ; preds = %bb.a, %_ZNK4core8vector3dIfEneERKS1_.exit
  ...
  %i.bp = load float, ptr %i.bo, align 8, !tbaa !483 ; 3 uses
  ...
  store <2 x float> %i.bv, ptr %0, align 4, !tbaa !82
  ...
  store float %i.bz, ptr %i.i, align 4, !tbaa !82
  %i.ca = fmul nsz float %i.bf, 0.000000e+00
  store float %i.ca, ptr %.sroa.15.0..sroa_idx, align 4, !tbaa !82
  ...
  store <2 x float> %i.cg, ptr %i.k, align 4, !tbaa !82
  ...
  store float %i.ck, ptr %i.l, align 4, !tbaa !82
  %i.cl = fmul nsz float %i.bn, 0.000000e+00
  store float %i.cl, ptr %.sroa.3172.0..sroa_idx, align 4, !tbaa !82
  ...
  store float %i.co, ptr %i.c, align 4, !tbaa !82
  %i.cp = fmul nsz float %i.bp, 0.000000e+00
  store float %i.cp, ptr %.sroa.4788.0..sroa_idx, align 4, !tbaa !82
  ...
  store <2 x float> %i.cu, ptr %i.m, align 4, !tbaa !82
