...
bb.j:                                             ; preds = %bb.i
  ...
  %10 = load float, ptr %i.bm, align 16, !tbaa !82
  ...
  %i.cn = load float, ptr %i.bl, align 8, !tbaa !482 ; 3 uses
  ...
  %11 = fmul nsz float %i.cn, %i.cl
  %12 = fmul nsz float %i.cn, %10
  %i.ct = insertelement <2 x float> poison, float %i.co, i64 0
  %13 = shufflevector <2 x float> %i.ct, <2 x float> poison, <2 x i32> zeroinitializer
  %i.cu = insertelement <2 x float> %i.ce, float %i.ck, i64 1
  %14 = insertelement <2 x float> poison, float %12, i64 0
  %i.cv = insertelement <2 x float> %14, float %11, i64 1
  %i.cw = call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %13, <2 x float> %i.cu, <2 x float> %i.cv)
