...
bb.a:
  ...
  %2 = shufflevector <3 x float> %i.k, <3 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 2>
  %i.l = load <3 x float>, ptr %i.e, align 8, !tbaa !82
  %3 = shufflevector <3 x float> %i.l, <3 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 2> ; 3 uses
  %i.m = shufflevector <6 x float> %i.j, <6 x float> poison, <4 x i32> zeroinitializer
  %i.n = fmul nsz <4 x float> %i.m, %3            ; 2 uses
  %4 = shufflevector <6 x float> %i.j, <6 x float> poison, <4 x i32> <i32 0, i32 0, i32 3, i32 0>
  %i.o = shufflevector <6 x float> %i.j, <6 x float> poison, <4 x i32> <i32 3, i32 3, i32 3, i32 3>
  %i.p = fmul nsz <4 x float> %i.o, %3            ; 2 uses
  %5 = shufflevector <6 x float> %i.j, <6 x float> poison, <4 x i32> <i32 3, i32 3, i32 0, i32 3>
  %i.q = fcmp nsz olt <4 x float> %i.n, %i.p      ; 2 uses
  %i.r = load <3 x float>, ptr %i.h, align 8, !tbaa !82
  %6 = shufflevector <3 x float> %i.r, <3 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 2> ; 3 uses
  %i.s = shufflevector <6 x float> %i.j, <6 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %i.t = fmul nsz <4 x float> %i.s, %6            ; 2 uses
  %7 = shufflevector <6 x float> %i.j, <6 x float> poison, <4 x i32> <i32 1, i32 1, i32 4, i32 1>
  %i.u = shufflevector <6 x float> %i.j, <6 x float> poison, <4 x i32> <i32 4, i32 4, i32 4, i32 4>
  %i.v = fmul nsz <4 x float> %i.u, %6            ; 2 uses
  %8 = shufflevector <6 x float> %i.j, <6 x float> poison, <4 x i32> <i32 4, i32 4, i32 1, i32 4>
  %i.w = fcmp nsz olt <4 x float> %i.t, %i.v      ; 2 uses
  %i.x = load <3 x float>, ptr %i.i, align 8, !tbaa !82
  %9 = shufflevector <3 x float> %i.x, <3 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 2> ; 3 uses
  %i.y = shufflevector <6 x float> %i.j, <6 x float> poison, <4 x i32> <i32 2, i32 2, i32 2, i32 2>
  %i.z = fmul nsz <4 x float> %i.y, %9            ; 2 uses
  %10 = shufflevector <6 x float> %i.j, <6 x float> poison, <4 x i32> <i32 2, i32 2, i32 5, i32 2>
  %i.aa = shufflevector <6 x float> %i.j, <6 x float> poison, <4 x i32> <i32 5, i32 5, i32 5, i32 5>
  %i.ab = fmul nsz <4 x float> %i.aa, %9          ; 2 uses
  %11 = shufflevector <6 x float> %i.j, <6 x float> poison, <4 x i32> <i32 5, i32 5, i32 2, i32 5>
  %i.ac = fcmp nsz olt <4 x float> %i.z, %i.ab    ; 2 uses
  %.v = select <4 x i1> %i.q, <4 x float> %4, <4 x float> %5
  %i.ad = fmul nsz <4 x float> %.v, %3
  %.v1 = select <4 x i1> %i.w, <4 x float> %7, <4 x float> %8
  %i.ae = fmul nsz <4 x float> %.v1, %6
  %.v2 = select <4 x i1> %i.ac, <4 x float> %10, <4 x float> %11
  %i.af = fmul nsz <4 x float> %.v2, %9
  %i.ag = fadd nsz <4 x float> %2, %i.ad
  %i.ah = fadd nsz <4 x float> %i.ae, %i.ag
  %i.ai = fadd nsz <4 x float> %i.af, %i.ah
  %12 = shufflevector <4 x float> %i.ai, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 3, i32 2>
  store <4 x float> %12, ptr %0, align 4, !tbaa !82
  %13 = shufflevector <4 x i1> %i.q, <4 x i1> poison, <2 x i32> <i32 1, i32 3>
  %14 = shufflevector <4 x float> %i.p, <4 x float> poison, <2 x i32> <i32 1, i32 3>
  %15 = shufflevector <4 x float> %i.n, <4 x float> poison, <2 x i32> <i32 1, i32 3>
  %i.aj = select <2 x i1> %13, <2 x float> %14, <2 x float> %15
  %16 = shufflevector <4 x i1> %i.w, <4 x i1> poison, <2 x i32> <i32 1, i32 3>
  %17 = shufflevector <4 x float> %i.v, <4 x float> poison, <2 x i32> <i32 1, i32 3>
  %18 = shufflevector <4 x float> %i.t, <4 x float> poison, <2 x i32> <i32 1, i32 3>
  %i.ak = select <2 x i1> %16, <2 x float> %17, <2 x float> %18
  %19 = shufflevector <4 x i1> %i.ac, <4 x i1> poison, <2 x i32> <i32 1, i32 3>
  %20 = shufflevector <4 x float> %i.ab, <4 x float> poison, <2 x i32> <i32 1, i32 3>
  %21 = shufflevector <4 x float> %i.z, <4 x float> poison, <2 x i32> <i32 1, i32 3>
  %i.al = select <2 x i1> %19, <2 x float> %20, <2 x float> %21
