...
bb.a:
  ...
  %.sroa.26.0.copyload = load <2 x float>, ptr %.sroa.26.0..sroa_idx, align 4 ; 3 uses
  %.sroa.047.0.vec.extract.i = extractelement <2 x float> %.sroa.07.0.copyload, i64 0
  %.sroa.036.0.vec.extract.i.a = extractelement <2 x float> %.sroa.05.0.copyload, i64 0 ; 2 uses
  %.sroa.036.4.vec.extract.i = extractelement <2 x float> %.sroa.05.0.copyload, i64 1
  %foldExtExtBinop = fmul <2 x float> %.sroa.07.0.copyload, %.sroa.05.0.copyload
  %i.c = extractelement <2 x float> %foldExtExtBinop, i64 1
  %i.d = tail call float @llvm.fmuladd.f32(float %.sroa.047.0.vec.extract.i, float %.sroa.036.0.vec.extract.i.a, float %i.c)
  %.sroa.10.8.vec.extract.i = extractelement <2 x float> %.sroa.28.0.copyload, i64 0
  %.sroa.6.8.vec.extract.i = extractelement <2 x float> %.sroa.26.0.copyload, i64 0 ; 2 uses
  ...
  %.sroa.6.12.vec.extract.i = extractelement <2 x float> %.sroa.26.0.copyload, i64 1 ; 2 uses
  ...
  %i.j = fneg float %i.f
  %.sroa.047.0.i = select i1 %i.g, <2 x float> %i.h, <2 x float> %.sroa.07.0.copyload ; 3 uses
  %.sroa.10.0.i = select i1 %i.g, <2 x float> %i.i, <2 x float> %.sroa.28.0.copyload ; 3 uses
...
bb.c:                                             ; preds = %bb.a
  %i.af = fsub float 1.000000e+00, %3             ; 4 uses
  %.sroa.024.0.vec.extract.i.i = extractelement <2 x float> %.sroa.047.0.i, i64 0
  %4 = fmul float %i.af, %.sroa.024.0.vec.extract.i.i
  %.sroa.024.4.vec.extract.i.i = extractelement <2 x float> %.sroa.047.0.i, i64 1
  %5 = fmul float %i.af, %.sroa.024.4.vec.extract.i.i
  %.sroa.325.8.vec.extract.i.i = extractelement <2 x float> %.sroa.10.0.i, i64 0
  %6 = fmul float %i.af, %.sroa.325.8.vec.extract.i.i
  %.sroa.325.12.vec.extract.i.i = extractelement <2 x float> %.sroa.10.0.i, i64 1
  %7 = fmul float %i.af, %.sroa.325.12.vec.extract.i.i
  %8 = fmul float %3, %.sroa.036.0.vec.extract.i.a
  %9 = fmul float %3, %.sroa.036.4.vec.extract.i
  %10 = fmul float %3, %.sroa.6.8.vec.extract.i
  %11 = fmul float %3, %.sroa.6.12.vec.extract.i
  %12 = fadd float %8, %4                         ; 3 uses
  %13 = fadd float %9, %5                         ; 3 uses
  %14 = fadd float %10, %6                        ; 3 uses
  %15 = fadd float %11, %7                        ; 3 uses
  %16 = fmul float %13, %13
  %i.ag = tail call float @llvm.fmuladd.f32(float %12, float %12, float %16)
  %i.ah = tail call float @llvm.fmuladd.f32(float %14, float %14, float %i.ag)
  %i.ai = tail call float @llvm.fmuladd.f32(float %15, float %15, float %i.ah)
  ...
  %i.al = fptrunc double %i.ak to float           ; 4 uses
  %17 = fmul float %12, %i.al
  %18 = insertelement <2 x float> poison, float %17, i64 0
  %19 = fmul float %13, %i.al
  %.sroa.018.4.vec.insert.i.i = insertelement <2 x float> %18, float %19, i64 1
  %20 = fmul float %14, %i.al
  %21 = insertelement <2 x float> poison, float %20, i64 0
  %22 = fmul float %15, %i.al
  %.sroa.8.12.vec.insert.i.i = insertelement <2 x float> %21, float %22, i64 1
  br label %_ZN4core10quaternion5slerpES0_S0_ff.exit

_ZN4core10quaternion5slerpES0_S0_ff.exit:         ; preds = %bb.b, %bb.c
  %.sroa.0.4.vec.insert.i29.sink.i = phi <2 x float> [ %.sroa.018.4.vec.insert.i.i, %bb.c ], [ %i.ab, %bb.b ]
  %.sroa.3.12.vec.insert.i31.sink.i = phi <2 x float> [ %.sroa.8.12.vec.insert.i.i, %bb.c ], [ %i.ae, %bb.b ]
