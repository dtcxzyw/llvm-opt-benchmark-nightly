...
bb.a:
  ...
  %i.g = fsub <2 x float> %i.e, %i.f              ; 4 uses
  %i.h = load <2 x float>, ptr %6, align 4, !tbaa !106
  %i.i = fsub <2 x float> %i.h, %i.e              ; 5 uses
  ...
  %i.m = extractelement <2 x float> %i.i, i64 1   ; 2 uses
  %i.n = extractelement <2 x float> %i.i, i64 0   ; 2 uses
  %i.o = extractelement <2 x float> %i.g, i64 0   ; 2 uses
...
_ZN4core8vector3dIfE9normalizeEv.exit89:          ; preds = %_ZN4core8vector3dIfE9normalizeEv.exit, %bb.c
  ...
  %i.cg = fsub float %i.cd, %i.cf                 ; 3 uses
  %i.ch = getelementptr inbounds nuw i8, ptr %9, i64 4
  %i.ci = load float, ptr %i.ch, align 4, !tbaa !344
  %i.cj = fsub float %i.ci, %i.cd                 ; 3 uses
  %10 = fmul float %i.o, %i.cj
  %i.ck = fmul float %i.l, %i.cj
  %i.cl = fmul float %i.u, %i.cj
  %11 = fmul float %i.n, %i.cg
  %12 = fmul float %i.m, %i.cg
  %13 = fmul float %i.bc, %i.cg
  %14 = fsub float %10, %11                       ; 5 uses
  %15 = fsub float %i.ck, %12                     ; 5 uses
  %16 = fsub float %i.cl, %13                     ; 5 uses
  %.sroa.0.0.vec.insert.i98 = insertelement <2 x float> poison, float %14, i64 0
  %.sroa.0.4.vec.insert.i99 = insertelement <2 x float> %.sroa.0.0.vec.insert.i98, float %15, i64 1
  store <2 x float> %.sroa.0.4.vec.insert.i99, ptr %2, align 4
  %.sroa.4.0..sroa_idx = getelementptr inbounds nuw i8, ptr %2, i64 8 ; 3 uses
  store float %16, ptr %.sroa.4.0..sroa_idx, align 4, !tbaa !106
  %i.cm = getelementptr inbounds nuw i8, ptr %2, i64 4 ; 2 uses
  %i.cn = fmul float %15, %15
  %i.co = tail call float @llvm.fmuladd.f32(float %14, float %14, float %i.cn)
  %i.cp = tail call float @llvm.fmuladd.f32(float %16, float %16, float %i.co) ; 2 uses
...
_ZN4core8vector3dIfE9normalizeEv.exit103:         ; preds = %_ZN4core8vector3dIfE9normalizeEv.exit89, %bb.d
  %i.dc = phi float [ %14, %_ZN4core8vector3dIfE9normalizeEv.exit89 ], [ %i.cv, %bb.d ] ; 3 uses
  %i.dd = phi float [ %16, %_ZN4core8vector3dIfE9normalizeEv.exit89 ], [ %i.db, %bb.d ] ; 3 uses
  %i.de = phi float [ %15, %_ZN4core8vector3dIfE9normalizeEv.exit89 ], [ %i.cy, %bb.d ] ; 3 uses
...
bb.g:                                             ; preds = %bb.e
  ...
  %.sroa.2.0.copyload = load <2 x float>, ptr %.sroa.2.0..sroa_idx, align 4 ; 3 uses
  ...
  %i.ag = fdiv float %i.ad, %i.af                 ; 7 uses
  %.sroa.047.0.vec.extract.i.i = extractelement <2 x float> %.sroa.01.0.copyload, i64 0
  %.sroa.036.0.vec.extract.i.i.a = extractelement <2 x float> %.sroa.0.0.copyload, i64 0 ; 2 uses
  %.sroa.036.4.vec.extract.i.i = extractelement <2 x float> %.sroa.0.0.copyload, i64 1
  %foldExtExtBinop = fmul <2 x float> %.sroa.01.0.copyload, %.sroa.0.0.copyload
  %i.ah = extractelement <2 x float> %foldExtExtBinop, i64 1
  %i.ai = tail call float @llvm.fmuladd.f32(float %.sroa.047.0.vec.extract.i.i, float %.sroa.036.0.vec.extract.i.i.a, float %i.ah)
  %.sroa.10.8.vec.extract.i.i = extractelement <2 x float> %.sroa.22.0.copyload, i64 0
  %.sroa.6.8.vec.extract.i.i = extractelement <2 x float> %.sroa.2.0.copyload, i64 0 ; 2 uses
  ...
  %.sroa.6.12.vec.extract.i.i = extractelement <2 x float> %.sroa.2.0.copyload, i64 1 ; 2 uses
  ...
  %.sroa.047.0.i.i = select i1 %i.al, <2 x float> %i.am, <2 x float> %.sroa.01.0.copyload ; 3 uses
  %.sroa.10.0.i.i = select i1 %i.al, <2 x float> %i.an, <2 x float> %.sroa.22.0.copyload ; 3 uses
...
bb.i:                                             ; preds = %bb.g
  %i.bk = fsub float 1.000000e+00, %i.ag          ; 4 uses
  %.sroa.024.0.vec.extract.i.i.i = extractelement <2 x float> %.sroa.047.0.i.i, i64 0
  %3 = fmul float %i.bk, %.sroa.024.0.vec.extract.i.i.i
  %.sroa.024.4.vec.extract.i.i.i = extractelement <2 x float> %.sroa.047.0.i.i, i64 1
  %4 = fmul float %i.bk, %.sroa.024.4.vec.extract.i.i.i
  %.sroa.325.8.vec.extract.i.i.i = extractelement <2 x float> %.sroa.10.0.i.i, i64 0
  %5 = fmul float %i.bk, %.sroa.325.8.vec.extract.i.i.i
  %.sroa.325.12.vec.extract.i.i.i = extractelement <2 x float> %.sroa.10.0.i.i, i64 1
  %6 = fmul float %i.bk, %.sroa.325.12.vec.extract.i.i.i
  %7 = fmul float %.sroa.036.0.vec.extract.i.i.a, %i.ag
  %8 = fmul float %.sroa.036.4.vec.extract.i.i, %i.ag
  %9 = fmul float %.sroa.6.8.vec.extract.i.i, %i.ag
  %10 = fmul float %.sroa.6.12.vec.extract.i.i, %i.ag
  %11 = fadd float %7, %3                         ; 3 uses
  %12 = fadd float %8, %4                         ; 3 uses
  %13 = fadd float %9, %5                         ; 3 uses
  %14 = fadd float %10, %6                        ; 3 uses
  %15 = fmul float %12, %12
  %i.bl = tail call float @llvm.fmuladd.f32(float %11, float %11, float %15)
  %i.bm = tail call float @llvm.fmuladd.f32(float %13, float %13, float %i.bl)
  %i.bn = tail call float @llvm.fmuladd.f32(float %14, float %14, float %i.bm)
  ...
  %i.bq = fptrunc double %i.bp to float           ; 4 uses
  %16 = fmul float %11, %i.bq
  %17 = insertelement <2 x float> poison, float %16, i64 0
  %18 = fmul float %12, %i.bq
  %.sroa.018.4.vec.insert.i.i.i = insertelement <2 x float> %17, float %18, i64 1
  %19 = fmul float %13, %i.bq
  %20 = insertelement <2 x float> poison, float %19, i64 0
  %21 = fmul float %14, %i.bq
  %.sroa.8.12.vec.insert.i.i.i = insertelement <2 x float> %20, float %21, i64 1
  br label %_ZN5scene11SkinnedMesh7ChannelIN4core10quaternionEE16interpolateValueES3_S3_f.exit

_ZN5scene11SkinnedMesh7ChannelIN4core10quaternionEE16interpolateValueES3_S3_f.exit: ; preds = %bb.h, %bb.i
  %.sroa.0.4.vec.insert.i29.sink.i.i = phi <2 x float> [ %.sroa.018.4.vec.insert.i.i.i, %bb.i ], [ %i.bg, %bb.h ]
  %.sroa.3.12.vec.insert.i31.sink.i.i = phi <2 x float> [ %.sroa.8.12.vec.insert.i.i.i, %bb.i ], [ %i.bj, %bb.h ]
