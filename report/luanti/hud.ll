...
bb.a:
  ...
  %spec.select49.a = select i1 %or.cond, i32 %i.f, i32 %i.h ; 2 uses
  %spec.select = select i1 %or.cond, i32 %i.h, i32 %i.f ; 2 uses
  ...
  %i.t = insertelement <2 x i32> poison, i32 %spec.select49.a, i64 0
  %i.u = insertelement <2 x i32> %i.t, i32 %spec.select, i64 1
...
bb.a:
  ...
  %6 = getelementptr inbounds nuw i8, ptr %i.ae, i64 48
  %7 = load float, ptr %6, align 4, !tbaa !58     ; 3 uses
  ...
  %8 = load <2 x float>, ptr %i.bg, align 4, !tbaa !58 ; 2 uses
  %i.bi = load float, ptr %i.bh, align 4, !tbaa !58
  %9 = fmul nsz float %.sroa.18.0.copyload, %i.bf
  %i.bj = tail call nsz float @llvm.fmuladd.f32(float %.sroa.1026.0.copyload, float %7, float %9)
  %10 = fmul nsz float %i.x, %i.aw
  %i.bk = tail call nsz float @llvm.fmuladd.f32(float %.sroa.1026.0.copyload, float %i.af, float %i.ak)
  %11 = tail call nsz float @llvm.fmuladd.f32(float %.sroa.1026.0.copyload, float %i.ay, float %i.bd)
  %12 = load float, ptr %i.ai, align 4, !tbaa !58 ; 3 uses
  %i.bl = load float, ptr %i.aj, align 4, !tbaa !58 ; 3 uses
  %i.bm = tail call nsz float @llvm.fmuladd.f32(float %.sroa.26.0.copyload, float %12, float %i.bk)
  %13 = tail call nsz float @llvm.fmuladd.f32(float %.sroa.34.0.copyload, float %i.bl, float %i.bm)
  %14 = load float, ptr %i.bb, align 4, !tbaa !58 ; 3 uses
  %15 = load float, ptr %i.bc, align 4, !tbaa !58 ; 3 uses
  %16 = tail call nsz float @llvm.fmuladd.f32(float %.sroa.26.0.copyload, float %14, float %11)
  %17 = tail call nsz float @llvm.fmuladd.f32(float %.sroa.34.0.copyload, float %15, float %16)
  %i.bn = insertelement <2 x float> poison, float %13, i64 0
  %i.bo = insertelement <2 x float> %i.bn, float %.sroa.26.0.copyload, i64 1
  %18 = shufflevector <2 x float> %8, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %i.bp = insertelement <2 x float> %18, float %i.w, i64 0 ; 3 uses
  %i.bq = insertelement <2 x float> poison, float %10, i64 0
  %i.br = insertelement <2 x float> %i.bq, float %i.bj, i64 1
  %19 = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bo, <2 x float> %i.bp, <2 x float> %i.br)
  %20 = insertelement <2 x float> poison, float %17, i64 0
  %i.bs = insertelement <2 x float> %20, float %.sroa.34.0.copyload, i64 1
  %i.bt = insertelement <2 x float> poison, float %i.y, i64 0
  %i.bu = insertelement <2 x float> %i.bt, float %i.bi, i64 1 ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.bz = tail call nsz float @llvm.fmuladd.f32(float %.sroa.621.0.copyload, float %7, float %i.by)
  ...
  %i.ci = tail call nsz float @llvm.fmuladd.f32(float %.sroa.22.0.copyload, float %14, float %i.ch)
  %i.cj = tail call nsz float @llvm.fmuladd.f32(float %.sroa.30.0.copyload, float %15, float %i.ci)
  %i.ck = tail call nsz float @llvm.fmuladd.f32(float %.sroa.621.0.copyload, float %i.af, float %i.cb)
  %i.cl = tail call nsz float @llvm.fmuladd.f32(float %.sroa.22.0.copyload, float %12, float %i.ck)
  %i.cm = tail call nsz float @llvm.fmuladd.f32(float %.sroa.30.0.copyload, float %i.bl, float %i.cl)
  ...
  %i.cr = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.co, <2 x float> %i.bp, <2 x float> %i.cq)
  %i.cs = insertelement <2 x float> poison, float %i.cj, i64 0
  %i.ct = insertelement <2 x float> %i.cs, float %.sroa.30.0.copyload, i64 1
  %i.cu = insertelement <2 x float> %8, float %i.y, i64 0
  ...
  %i.cy = tail call nsz float @llvm.fmuladd.f32(float %.sroa.019.0.copyload, float %7, float %i.cx)
  ...
  %i.dh = tail call nsz float @llvm.fmuladd.f32(float %.sroa.20.0.copyload, float %14, float %i.dg)
  %i.di = tail call nsz float @llvm.fmuladd.f32(float %.sroa.28.0.copyload, float %15, float %i.dh)
  %i.dj = tail call nsz float @llvm.fmuladd.f32(float %.sroa.019.0.copyload, float %i.af, float %i.da)
  %i.dk = tail call nsz float @llvm.fmuladd.f32(float %.sroa.20.0.copyload, float %12, float %i.dj)
  %i.dl = tail call nsz float @llvm.fmuladd.f32(float %.sroa.28.0.copyload, float %i.bl, float %i.dk)
  ...
  %i.dq = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.dn, <2 x float> %i.bp, <2 x float> %i.dp)
...
bb.ac:                                            ; preds = %"_ZSt11stable_sortIN9__gnu_cxx17__normal_iteratorIPP10HudElementSt6vectorIS3_SaIS3_EEEEZN3Hud15drawLuaElementsERKN4core8vector3dIsEEE3$_0EvT_SG_T0_.exit", %.critedge.thread
  ...
  %32 = load i32, ptr %i.hc, align 8, !tbaa !492  ; 2 uses
  %33 = uitofp nsz i32 %32 to float
  %34 = load <2 x float>, ptr %i.jm, align 4, !tbaa !58
  %35 = load i32, ptr %i.hd, align 4, !tbaa !493  ; 2 uses
  %i.jn = uitofp nsz i32 %35 to float
  %i.jo = insertelement <2 x float> poison, float %33, i64 0
  %i.jp = insertelement <2 x float> %i.jo, float %i.jn, i64 1
  %i.jq = fmul nsz <2 x float> %34, %i.jp
...
bb.ed:                                            ; preds = %bb.ec
  %i.aep = load i32, ptr %i.hc, align 8, !tbaa !492
...
bb.ef:                                            ; preds = %bb.ee
  %i.aew = load i32, ptr %i.hd, align 4, !tbaa !493
...
bb.en:                                            ; preds = %bb.em
  %i.agm = load i32, ptr %i.hc, align 8, !tbaa !492
...
bb.ep:                                            ; preds = %bb.eo
  %i.agt = load i32, ptr %i.hd, align 4, !tbaa !493
...
bb.fd:                                            ; preds = %bb.fc
  %i.akj = uitofp nsz i32 %32 to double
...
bb.ff:                                            ; preds = %bb.fe
  %i.akw = uitofp nsz i32 %35 to double
...
bb.c:                                             ; preds = %bb.a, %bb.b
  ...
  %3 = fpext nsz float %i.ae to double
  %sincos36.i = tail call nsz { double, double } @llvm.sincos.f64(double %3) ; 2 uses
  %sin37.i = extractvalue { double, double } %sincos36.i, 0 ; 3 uses
  %cos38.i = extractvalue { double, double } %sincos36.i, 1 ; 4 uses
  %4 = load float, ptr %i.w, align 8, !tbaa !144
  %5 = fpext nsz float %4 to double
  %sincos39.i = tail call nsz { double, double } @llvm.sincos.f64(double %5) ; 2 uses
  ...
  %6 = insertelement <2 x float> poison, float %i.ap, i64 0
  ...
  %i.ci = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %7, <2 x float> zeroinitializer, <2 x float> %i.ch)
  ...
  %i.cl = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bj, <2 x float> zeroinitializer, <2 x float> %i.ck)
...
bb.g:                                             ; preds = %bb.f
  ...
  %8 = and i32 %i.fk, 255
  %9 = uitofp nsz nneg i32 %8 to double
  %10 = lshr i32 %i.fe, 8
  %11 = and i32 %10, 255
  %i.fl = uitofp nsz nneg i32 %11 to double
  %i.fm = insertelement <2 x double> poison, double %i.fl, i64 0
  %i.fn = insertelement <2 x double> %i.fm, double %9, i64 1
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %bb.b, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i
  ...
  %9 = select i1 %i.af, i32 %i.au, i32 %i.ae
  %10 = sdiv i32 %9, 16                           ; 3 uses
  %11 = add nsw i32 %i.ah, -15
  %12 = select i1 %i.ai, i32 %11, i32 %i.ah
  %i.av = sdiv i32 %12, 16                        ; 3 uses
  %.sroa.7.0.extract.trunc = trunc nsw i32 %10 to i16
