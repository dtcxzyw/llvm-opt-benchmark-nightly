...
bb.c:                                             ; preds = %bb.a, %bb.b
  ...
  %sin40.i = extractvalue { double, double } %sincos39.i, 0 ; 5 uses
  %cos41.i = extractvalue { double, double } %sincos39.i, 1 ; 5 uses
  ...
  %i.be = insertelement <2 x double> %i.bd, double %sin40.i, i64 1
  ...
  %3 = insertelement <2 x double> poison, double %cos41.i, i64 0
  %4 = insertelement <2 x double> %3, double %sin40.i, i64 1
  %i.bu = tail call nsz <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bt, <2 x double> %4, <2 x double> %i.br)
