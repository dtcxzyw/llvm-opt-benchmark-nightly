...
bb.a:
  ...
  %4 = insertelement <2 x i16> poison, i16 %.sroa.046.0.extract.trunc, i64 0
  %5 = insertelement <2 x i16> %4, i16 %.sroa.2.0.extract.trunc, i64 1
  %i.k = sub <2 x i16> %5, %i.d                   ; 5 uses
  %i.l = extractelement <2 x i16> %i.k, i64 0     ; 3 uses
  %i.m = insertelement <2 x i16> %i.d, i16 %i.i, i64 0
  %i.n = insertelement <2 x i16> %i.k, i16 %.sroa.2.0.extract.trunc, i64 1
