...
.lr.ph:                                           ; preds = %bb.i
  ...
  %i.bd = getelementptr inbounds nuw i8, ptr %13, i64 48
  %i.be = getelementptr inbounds nuw i8, ptr %13, i64 4
  %i.bf = getelementptr inbounds nuw i8, ptr %13, i64 20
...
bb.l:                                             ; preds = %.lr.ph.split.us
  ...
  %18 = fneg float %i.bp
  %19 = call noundef float @_ZN5scene16CXMeshFileLoader9readFloatEv(ptr noundef nonnull align 8 dereferenceable(162) %0) ; 3 uses
  %20 = fneg float %19
...
bb.o:                                             ; preds = %_ZN4core6stringIcED2Ev.exit80.us, %bb.l
  %i.bx = fmul float %i.bp, %i.bp
  %i.by = call float @llvm.fmuladd.f32(float %i.bo, float %i.bo, float %i.bx)
  %i.bz = call float @llvm.fmuladd.f32(float %19, float %19, float %i.by)
  ...
  %i.cd = fptrunc double %i.cc to float           ; 4 uses
  %21 = fmul float %17, %i.cd
  %22 = insertelement <2 x float> poison, float %21, i64 0
  %23 = fmul float %18, %i.cd
  %.sroa.0193.4.vec.insert200.us = insertelement <2 x float> %22, float %23, i64 1
  %24 = fmul float %20, %i.cd
  %25 = insertelement <2 x float> poison, float %24, i64 0
  %26 = fmul float %16, %i.cd
  %.sroa.9201.12.vec.insert208.us = insertelement <2 x float> %25, float %26, i64 1
  call void @_ZN5scene18SkinnedMeshBuilder14addRotationKeyEPNS_11SkinnedMesh6SJointEfN4core10quaternionE(ptr noundef nonnull align 8 dereferenceable(32) %i.ba, ptr noundef %1, float noundef %i.bl, <2 x float> %.sroa.0193.4.vec.insert200.us, <2 x float> %.sroa.9201.12.vec.insert208.us)
...
_ZN5scene16CXMeshFileLoader30checkForOneFollowingSemicolonsEv.exit111.thread.us: ; preds = %_ZN4core6stringIcED2Ev.exit114.us, %_ZN4core6stringIcED2Ev.exit.i107.us, %bb.x
  %i.ei = load float, ptr %13, align 4, !tbaa !95, !noalias !344 ; 6 uses
  %i.ej = load float, ptr %i.bb, align 4, !tbaa !95, !noalias !344 ; 4 uses
  %i.ek = load float, ptr %i.bf, align 4, !tbaa !95, !noalias !344 ; 6 uses
  %27 = load <2 x float>, ptr %i.bc, align 4, !tbaa !95, !noalias !344 ; 7 uses
  %i.el = load <2 x float>, ptr %i.be, align 4, !tbaa !95, !noalias !344 ; 7 uses
...
bb.aa:                                            ; preds = %_ZN5scene16CXMeshFileLoader30checkForOneFollowingSemicolonsEv.exit111.thread.us
  %i.es = fcmp ogt float %i.ei, %i.ek
  %i.et = fcmp ogt float %i.ei, %i.en
  %or.cond.i.us = and i1 %i.es, %i.et
  br i1 %or.cond.i.us, label %bb.ae, label %bb.ab

bb.ab:                                            ; preds = %bb.aa
  %i.eu = fcmp ogt float %i.ek, %i.en
  br i1 %i.eu, label %bb.ad, label %bb.ac

bb.ac:                                            ; preds = %bb.ab
  %i.ev = fadd float %i.en, 1.000000e+00
  %i.ew = fsub float %i.ev, %i.ei
  %i.ex = fsub float %i.ew, %i.ek
  %i.ey = call float @sqrtf(float noundef %i.ex) #28
  %i.ez = fmul float %i.ey, 2.000000e+00
  %28 = shufflevector <2 x float> %i.el, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %29 = insertelement <2 x float> %28, float %i.em, i64 1
  %30 = fadd <2 x float> %27, %29
  %i.fa = extractelement <2 x float> %i.el, i64 0
  %i.fb = fsub float %i.ej, %i.fa
  %i.fc = insertelement <4 x float> <float poison, float poison, float poison, float 2.500000e-01>, float %i.fb, i64 0
  %31 = shufflevector <2 x float> %30, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %32 = shufflevector <4 x float> %i.fc, <4 x float> %31, <4 x i32> <i32 0, i32 4, i32 5, i32 3> ; 2 uses
  ...
  %i.ff = fdiv <4 x float> %32, %i.fe
  %i.fg = fmul <4 x float> %32, %i.fe
...
bb.ad:                                            ; preds = %bb.ab
  %i.fi = fadd float %i.ek, 1.000000e+00
  %i.fj = fsub float %i.fi, %i.ei
  %i.fk = fsub float %i.fj, %i.en
  %i.fl = call float @sqrtf(float noundef %i.fk) #28
  %i.fm = fmul float %i.fl, 2.000000e+00
  %33 = extractelement <2 x float> %i.el, i64 0
  %34 = fadd float %i.ej, %33
  %35 = extractelement <2 x float> %27, i64 1
  %36 = fadd float %35, %i.em
  %shift = shufflevector <2 x float> %i.el, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop = fsub <2 x float> %shift, %27
  %37 = extractelement <2 x float> %foldExtExtBinop, i64 0
  %i.fn = insertelement <4 x float> <float poison, float poison, float 2.500000e-01, float poison>, float %37, i64 0
  %38 = insertelement <4 x float> %i.fn, float %34, i64 1
  %39 = insertelement <4 x float> %38, float %36, i64 3 ; 2 uses
  ...
  %i.fq = fdiv <4 x float> %39, %i.fp
  %i.fr = fmul <4 x float> %39, %i.fp
  %i.fs = shufflevector <4 x float> %i.fq, <4 x float> %i.fr, <4 x i32> <i32 0, i32 1, i32 6, i32 3>
  br label %_ZN4core10quaternionaSERKNS_8CMatrix4IfEE.exit.us

bb.ae:                                            ; preds = %bb.aa
  %i.ft = fadd float %i.ei, 1.000000e+00
  %i.fu = fsub float %i.ft, %i.ek
  ...
  %i.fz = insertelement <2 x float> poison, float %i.ej, i64 0
  %40 = extractelement <2 x float> %27, i64 1
  %i.ga = fsub float %40, %i.em
  ...
  %41 = shufflevector <2 x float> %i.fz, <2 x float> %27, <4 x i32> <i32 0, i32 2, i32 poison, i32 poison>
  %i.gd = shufflevector <2 x float> %i.el, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %42 = fadd <4 x float> %41, %i.gd
  %i.ge = shufflevector <4 x float> %i.gc, <4 x float> %42, <4 x i32> <i32 0, i32 1, i32 4, i32 5> ; 2 uses
...
bb.af:                                            ; preds = %_ZN5scene16CXMeshFileLoader30checkForOneFollowingSemicolonsEv.exit111.thread.us
  ...
  %i.gk = fsub float %i.ej, %i.gj
  %shift304 = shufflevector <2 x float> %i.el, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop305 = fsub <2 x float> %shift304, %27
  %i.gl = extractelement <2 x float> %foldExtExtBinop305, i64 0
  %43 = extractelement <2 x float> %27, i64 1
  %i.gm = fsub float %43, %i.em
  ...
  %i.gq = insertelement <4 x float> %i.gp, float %i.gl, i64 2
...
_ZN4core10quaternionaSERKNS_8CMatrix4IfEE.exit.us: ; preds = %bb.af, %bb.ae, %bb.ad, %bb.ac
  ...
  %i.hn = load <4 x float>, ptr %i.bd, align 4    ; 2 uses
