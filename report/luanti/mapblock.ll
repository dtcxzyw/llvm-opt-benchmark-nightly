...
.preheader:                                       ; preds = %.preheader218, %_ZN8MapBlock11getNodeNoExEN4core8vector3dIsEE.exit.15
  ...
  %13 = and i64 %i.ee, 65520
  %14 = icmp eq i64 %13, 0
  br i1 %14, label %bb.v, label %_ZN8MapBlock11getNodeNoExEN4core8vector3dIsEE.exit.15
...
bb.v:                                             ; preds = %.preheader
  ...
  %15 = add nuw nsw i64 %i.ef, %i.ec              ; 16 uses
  ...
  %i.ej = select i1 %i.ei, i64 0, i64 %15
