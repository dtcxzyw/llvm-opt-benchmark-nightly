...
bb.a:
  ...
  %i.o = load i16, ptr %i.a, align 8, !tbaa !181
  %i.p = sext i16 %i.o to i32
  %i.q = load i16, ptr %i.b, align 2, !tbaa !24
  %i.r = sext i16 %i.q to i32
  %i.s = add nsw i32 %i.r, 1
  %i.t = load i16, ptr %i.c, align 4, !tbaa !182
...
bb.b:                                             ; preds = %bb.a
  ...
  store ptr %i.n, ptr %i.v, align 8, !tbaa !25
  %i.w = tail call noalias noundef nonnull dereferenceable(88) ptr @_Znwm(i64 noundef 88) #19 ; 3 uses
  %i.x = load i16, ptr %i.a, align 8, !tbaa !181
  %i.y = sext i16 %i.x to i32
  %i.z = load i16, ptr %i.b, align 2, !tbaa !24
  %i.aa = sext i16 %i.z to i32
  %i.ab = add nsw i32 %i.aa, 1
  %i.ac = load i16, ptr %i.c, align 4, !tbaa !182
...
bb.c:                                             ; preds = %bb.b
  ...
  store ptr %i.w, ptr %i.ae, align 8, !tbaa !26
  ret void
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.ey = load i16, ptr %i.ew, align 8, !tbaa !224 ; 2 uses
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.fe = load i16, ptr %i.fd, align 8, !tbaa !134
  ...
  %i.fl = load i16, ptr %i.fk, align 2, !tbaa !30
...
bb.k:                                             ; preds = %bb.i, %bb.h
  ...
  %i.fo = load i32, ptr %i.fn, align 4, !tbaa !124
...
.thread:                                          ; preds = %bb.g
  ...
  %i.fs = load i32, ptr %i.fr, align 4, !tbaa !124
...
bb.l:                                             ; preds = %_ZN15CavesRandomWalk17isPosAboveSurfaceEN4core8vector3dIsEE.exit.thread131
  ...
  %i.fx = load i16, ptr %i.fv, align 8, !tbaa !224 ; 2 uses
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.gd = load i16, ptr %i.gc, align 8, !tbaa !134
  ...
  %i.gk = load i16, ptr %i.gj, align 2, !tbaa !30
...
_ZN15CavesRandomWalk17isPosAboveSurfaceEN4core8vector3dIsEE.exit63: ; preds = %_ZN15CavesRandomWalk17isPosAboveSurfaceEN4core8vector3dIsEE.exit.thread138, %bb.m
  ...
  %i.gr = load float, ptr %i.gq, align 8, !tbaa !115
  %i.gs = fadd nsz float %.sroa.19.0, %i.gr
  %i.gt = load <2 x float>, ptr %i.gp, align 8, !tbaa !63
...
bb.o:                                             ; preds = %_ZN15CavesRandomWalk17isPosAboveSurfaceEN4core8vector3dIsEE.exit63
  ...
  %i.hc = load i16, ptr %i.hb, align 2, !tbaa !152 ; 2 uses
...
bb.q:                                             ; preds = %bb.o, %bb.p, %bb.n
  ...
  %i.hj = load i16, ptr %i.hi, align 4, !tbaa !148
...
bb.s:                                             ; preds = %bb.q
  ...
  %i.hn = load i16, ptr %i.hm, align 2, !tbaa !149 ; 2 uses
...
bb.v:                                             ; preds = %bb.u
  ...
  %i.hv = load i16, ptr %i.hu, align 2, !tbaa !150 ; 2 uses
...
bb.x:                                             ; preds = %bb.u, %bb.v, %bb.w
  ...
  store i32 %i.ik, ptr %.pre153167.sink, align 4, !tbaa !136
...
bb.y:                                             ; preds = %bb.z
  ...
  store float %.sroa.12.0, ptr %i.dq, align 4, !tbaa !63
...
bb.z:                                             ; preds = %bb.x, %bb.z
  ...
  br i1 %i.iq, label %bb.z, label %bb.y, !llvm.loop !222
...
bb.a:
  %.sroa.0126 = alloca i32, align 4               ; 7 uses
  %.sroa.0123 = alloca i32, align 4               ; 6 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.0126)
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 144
  %i.b = load i16, ptr %i.a, align 8, !tbaa !128
  store i16 %i.b, ptr %.sroa.0126, align 4, !tbaa !57
  %.2..2..2..sroa_idx174 = getelementptr inbounds nuw i8, ptr %.sroa.0126, i64 2
  store i8 0, ptr %.2..2..2..sroa_idx174, align 2, !tbaa !228
  %.3..3..3..sroa_idx175 = getelementptr inbounds nuw i8, ptr %.sroa.0126, i64 3
  store i8 0, ptr %.3..3..3..sroa_idx175, align 1, !tbaa !229
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.0123)
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 146
  %i.d = load i16, ptr %i.c, align 2, !tbaa !129
  store i16 %i.d, ptr %.sroa.0123, align 4, !tbaa !57
  %.2..2..2..sroa_idx = getelementptr inbounds nuw i8, ptr %.sroa.0123, i64 2
  store i8 0, ptr %.2..2..2..sroa_idx, align 2, !tbaa !228
  %.3..3..3..sroa_idx = getelementptr inbounds nuw i8, ptr %.sroa.0123, i64 3
  store i8 0, ptr %.3..3..3..sroa_idx, align 1, !tbaa !229
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 92
  %i.f = load float, ptr %i.e, align 4, !tbaa !153 ; 2 uses
  %i.g = fptosi float %i.f to i16
  %i.h = getelementptr inbounds nuw i8, ptr %0, i64 96
  %i.i = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  %i.j = load i16, ptr %i.i, align 8, !tbaa !147
  %i.k = add i16 %i.j, %i.g
  %i.l = getelementptr inbounds nuw i8, ptr %0, i64 106 ; 2 uses
  %i.m = getelementptr inbounds nuw i8, ptr %0, i64 108
  %i.n = load <2 x float>, ptr %i.h, align 8, !tbaa !63 ; 3 uses
  %i.o = fptosi <2 x float> %i.n to <2 x i16>
  %i.p = load <2 x i16>, ptr %i.l, align 2, !tbaa !30
  ...
  store i32 %i.ag, ptr %i.v, align 4, !tbaa !136
...
bb.d:                                             ; preds = %bb.b
  ...
  %i.bj = load i32, ptr %i.bi, align 8, !tbaa !123
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.bp = load i16, ptr %i.bo, align 8, !tbaa !230
  %i.bq = sext i16 %i.bp to i32
  %i.br = getelementptr inbounds nuw i8, ptr %0, i64 44
  %i.bs = load i32, ptr %i.br, align 4, !tbaa !124
...
bb.g:                                             ; preds = %bb.e, %bb.f
  %i.bv = phi ptr [ %.sroa.0126, %bb.f ], [ %.sroa.0123, %bb.e ]
...
bb.h:                                             ; preds = %bb.c, %bb.g, %bb.a
  ...
  %i.by = load i16, ptr %i.bx, align 4, !tbaa !154 ; 2 uses
...
bb.i:                                             ; preds = %bb.h
  %i.cd = load ptr, ptr %i.u, align 8, !tbaa !131 ; 2 uses
  %i.ce = load i32, ptr %i.cd, align 4, !tbaa !136
  ...
  store i32 %i.cj, ptr %i.cd, align 4, !tbaa !136
...
bb.j:                                             ; preds = %bb.i, %bb.h
  ...
  %i.ct = load i8, ptr %i.cs, align 4, !tbaa !133, !range !99, !noundef !100
  %i.cu = trunc nuw i8 %i.ct to i1
  br i1 %i.cu, label %bb.l, label %bb.k

bb.k:                                             ; preds = %bb.j
  %i.cv = load ptr, ptr %i.u, align 8, !tbaa !131 ; 2 uses
  %i.cw = load i32, ptr %i.cv, align 4, !tbaa !136
  %i.cx = mul i32 %i.cw, 1103515245
  %i.cy = add i32 %i.cx, 12345                    ; 2 uses
  store i32 %i.cy, ptr %i.cv, align 4, !tbaa !136
...
.lr.ph146:                                        ; preds = %bb.l
  ...
  %.0..0..0..val79 = load i32, ptr %.sroa.0126, align 4
  %.pre = load ptr, ptr %i.u, align 8, !tbaa !131 ; 3 uses
  %.pre151 = load i32, ptr %.pre, align 4, !tbaa !136
  br label %bb.m
...
bb.m:                                             ; preds = %.lr.ph146, %._crit_edge142
  ...
  %i.dr = load i16, ptr %i.bx, align 4, !tbaa !154 ; 2 uses
  ...
  store i32 %i.ei, ptr %i.dp, align 4, !tbaa !136
...
._crit_edge142:                                   ; preds = %._crit_edge, %bb.m
  ...
  br i1 %.not, label %._crit_edge147, label %bb.m, !llvm.loop !225
...
bb.n:                                             ; preds = %.lr.ph141, %._crit_edge
  ...
  %i.et = load i16, ptr %i.bx, align 4, !tbaa !154 ; 2 uses
...
._crit_edge.loopexit:                             ; preds = %_ZNK9VoxelArea8containsEN4core8vector3dIsEE.exit.thread
  %.pre152 = load ptr, ptr %i.u, align 8, !tbaa !131
  br label %._crit_edge
...
bb.p:                                             ; preds = %bb.o
  %i.fn = load i16, ptr %i.bx, align 4, !tbaa !154 ; 2 uses
...
bb.q:                                             ; preds = %bb.p, %bb.o
  %i.fq = load i8, ptr %i.dg, align 1, !tbaa !143, !range !99, !noundef !100
  %i.fr = trunc nuw i8 %i.fq to i1
  br i1 %i.fr, label %bb.r, label %bb.t

bb.r:                                             ; preds = %bb.q
  %i.fs = load i16, ptr %i.bx, align 4, !tbaa !154 ; 2 uses
...
bb.t:                                             ; preds = %bb.r, %bb.s, %bb.q
  ...
  %i.fy = load i16, ptr %i.i, align 8, !tbaa !147
  %i.fz = add i16 %i.fd, %i.fy                    ; 3 uses
  %i.ga = load i16, ptr %i.l, align 2, !tbaa !145
  %i.gb = add i16 %i.fx, %i.ga                    ; 3 uses
  %i.gc = load i16, ptr %i.m, align 4, !tbaa !144
  %i.gd = add i16 %i.el, %i.gc                    ; 3 uses
  %i.ge = load ptr, ptr %0, align 8, !tbaa !130   ; 9 uses
  %i.gf = getelementptr inbounds nuw i8, ptr %i.ge, i64 8
  %i.gg = load i16, ptr %i.gf, align 4, !tbaa !37 ; 2 uses
...
bb.u:                                             ; preds = %bb.t
  ...
  %i.go = load i16, ptr %i.gn, align 4, !tbaa !34 ; 2 uses
...
_ZNK9VoxelArea8containsEN4core8vector3dIsEE.exit: ; preds = %bb.u
  ...
  %i.gq = load i16, ptr %i.gp, align 2, !tbaa !155
...
bb.v:                                             ; preds = %_ZNK9VoxelArea8containsEN4core8vector3dIsEE.exit
  ...
  %i.hm = load i16, ptr %i.hl, align 4, !tbaa !57
  %i.hn = load ptr, ptr %i.dh, align 8, !tbaa !121 ; 2 uses
  %i.ho = zext i16 %i.hm to i64                   ; 2 uses
  %i.hp = getelementptr inbounds nuw i8, ptr %i.hn, i64 8
  %i.hq = load ptr, ptr %i.hp, align 8, !tbaa !66
  %i.hr = load ptr, ptr %i.hn, align 8, !tbaa !67 ; 3 uses
