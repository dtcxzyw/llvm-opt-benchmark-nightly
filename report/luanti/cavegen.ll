...
._crit_edge:                                      ; preds = %bb.a, %bb.b
  ...
  br i1 %i.be, label %.thread162, label %bb.c

.thread162:                                       ; preds = %._crit_edge
  %i.bf = sdiv i16 %i.bc, 2
  %.pre153164 = load ptr, ptr %i.at, align 8, !tbaa !165 ; 2 uses
  %.pre154165 = load i32, ptr %.pre153164, align 4, !tbaa !169
  br label %bb.f
...
bb.c:                                             ; preds = %._crit_edge
  ...
  %.pre152 = load i8, ptr %i.a, align 4, !tbaa !167, !range !117
  %i.bk = trunc nuw i8 %.pre152 to i1
  %.pre153 = load ptr, ptr %i.at, align 8, !tbaa !165 ; 5 uses
  %.pre154 = load i32, ptr %.pre153, align 4, !tbaa !169 ; 2 uses
  br i1 %i.bk, label %bb.f, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.bl = mul i32 %.pre154, 1103515245
  %i.bm = add i32 %i.bl, 12345                    ; 4 uses
  store i32 %i.bm, ptr %.pre153, align 4, !tbaa !169
  %i.bn = sdiv i32 %i.bm, 65536
  %i.bo = trunc nsw i32 %i.bn to i16
  %.lhs.trunc.i35 = and i16 %i.bo, 32767
  %i.bp = urem i16 %.lhs.trunc.i35, 13
...
bb.e:                                             ; preds = %bb.d
  ...
  %sext148 = shl i32 %i.bb, 16
  %i.bv = ashr exact i32 %sext148, 16             ; 2 uses
  ...
  %sext176 = shl i32 %i.bi, 16
  %i.cf = ashr exact i32 %sext176, 15
...
bb.f:                                             ; preds = %.thread162, %bb.d, %bb.c
  %.pre153167 = phi ptr [ %.pre153, %bb.d ], [ %.pre153, %bb.c ], [ %.pre153164, %.thread162 ]
  %.sroa.7.0166 = phi i16 [ %i.bj, %bb.d ], [ %i.bj, %bb.c ], [ %i.bf, %.thread162 ] ; 2 uses
  %i.ck = phi i32 [ %i.bm, %bb.d ], [ %.pre154, %bb.c ], [ %.pre154165, %.thread162 ]
  %i.cl = mul i32 %i.ck, 1103515245
  %i.cm = add i32 %i.cl, 12345                    ; 2 uses
  %i.cn = sdiv i32 %i.cm, 65536
  %i.co = and i32 %i.cn, 32767
  %sext149 = shl i32 %i.bb, 16
  %i.cp = ashr exact i32 %sext149, 16             ; 2 uses
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  %i.ej = fptosi float %.sink175 to i16
...
bb.j:                                             ; preds = %bb.i
  ...
  br i1 %.not18.i, label %_ZN15CavesRandomWalk17isPosAboveSurfaceEN4core8vector3dIsEE.exit.thread, label %_ZN15CavesRandomWalk17isPosAboveSurfaceEN4core8vector3dIsEE.exit.thread131
...
bb.k:                                             ; preds = %bb.i, %bb.h
  ...
  br i1 %i.fp, label %_ZN15CavesRandomWalk17isPosAboveSurfaceEN4core8vector3dIsEE.exit.thread, label %_ZN15CavesRandomWalk17isPosAboveSurfaceEN4core8vector3dIsEE.exit.thread131
...
.thread:                                          ; preds = %bb.g
  ...
  br i1 %i.ft, label %_ZN15CavesRandomWalk17isPosAboveSurfaceEN4core8vector3dIsEE.exit.thread, label %_ZN15CavesRandomWalk17isPosAboveSurfaceEN4core8vector3dIsEE.exit.thread138

_ZN15CavesRandomWalk17isPosAboveSurfaceEN4core8vector3dIsEE.exit.thread131: ; preds = %bb.k, %bb.j
  %i.fu = sext i16 %i.en to i64
  %.not14.i55 = icmp slt i16 %i.en, %i.es
  %.not15.i56 = icmp sgt i16 %i.en, %i.ev
  %or.cond21.i57 = select i1 %.not14.i55, i1 true, i1 %.not15.i56
  br i1 %or.cond21.i57, label %_ZN15CavesRandomWalk17isPosAboveSurfaceEN4core8vector3dIsEE.exit.thread138, label %bb.l

bb.l:                                             ; preds = %_ZN15CavesRandomWalk17isPosAboveSurfaceEN4core8vector3dIsEE.exit.thread131
  ...
  %.not16.i58 = icmp sgt i16 %i.fx, %i.el
  %i.fy = load i16, ptr %i.fw, align 2
  %.not17.i59 = icmp slt i16 %i.fy, %i.el
  %or.cond.i60 = select i1 %.not16.i58, i1 true, i1 %.not17.i59
  br i1 %or.cond.i60, label %_ZN15CavesRandomWalk17isPosAboveSurfaceEN4core8vector3dIsEE.exit.thread138, label %bb.m
...
bb.m:                                             ; preds = %bb.l
  ...
  %.not18.i61 = icmp slt i16 %i.gk, %i.em
  br i1 %.not18.i61, label %_ZN15CavesRandomWalk17isPosAboveSurfaceEN4core8vector3dIsEE.exit.thread, label %_ZN15CavesRandomWalk17isPosAboveSurfaceEN4core8vector3dIsEE.exit63

_ZN15CavesRandomWalk17isPosAboveSurfaceEN4core8vector3dIsEE.exit.thread138: ; preds = %.thread, %bb.l, %_ZN15CavesRandomWalk17isPosAboveSurfaceEN4core8vector3dIsEE.exit.thread131
  ...
  br i1 %i.go, label %_ZN15CavesRandomWalk17isPosAboveSurfaceEN4core8vector3dIsEE.exit.thread, label %_ZN15CavesRandomWalk17isPosAboveSurfaceEN4core8vector3dIsEE.exit63

_ZN15CavesRandomWalk17isPosAboveSurfaceEN4core8vector3dIsEE.exit63: ; preds = %_ZN15CavesRandomWalk17isPosAboveSurfaceEN4core8vector3dIsEE.exit.thread138, %bb.m
  ...
  %i.gv = insertelement <2 x float> %i.gu, float %.sink175, i64 1
...
bb.n:                                             ; preds = %_ZN15CavesRandomWalk17isPosAboveSurfaceEN4core8vector3dIsEE.exit63
  %.sroa.0.0.vec.insert = insertelement <2 x float> %i.gx, float 0.000000e+00, i64 0
  br label %bb.q

bb.o:                                             ; preds = %_ZN15CavesRandomWalk17isPosAboveSurfaceEN4core8vector3dIsEE.exit63
...
bb.p:                                             ; preds = %bb.o
  ...
  %.sroa.0.0.vec.insert72 = insertelement <2 x float> %i.gx, float %i.hh, i64 0
  br label %bb.q

bb.q:                                             ; preds = %bb.o, %bb.p, %bb.n
  %.sroa.0.0 = phi nsz <2 x float> [ %.sroa.0.0.vec.insert, %bb.n ], [ %i.gx, %bb.o ], [ %.sroa.0.0.vec.insert72, %bb.p ] ; 4 uses
...
bb.r:                                             ; preds = %bb.q
  %.sroa.0.4.vec.insert76 = insertelement <2 x float> %.sroa.0.0, float %i.hk, i64 1
  br label %bb.u
...
bb.u:                                             ; preds = %bb.s, %bb.t, %bb.r
  %.sroa.0.1 = phi nsz <2 x float> [ %.sroa.0.4.vec.insert76, %bb.r ], [ %.sroa.0.0, %bb.s ], [ %.sroa.0.4.vec.insert, %bb.t ] ; 2 uses
...
bb.x:                                             ; preds = %bb.u, %bb.v, %bb.w
  ...
  %foldExtExtBinop179 = fmul nsz <2 x float> %i.ib, %i.ib
  %i.id = extractelement <2 x float> %foldExtExtBinop179, i64 1
  ...
  store i32 %i.ik, ptr %.pre153167.sink, align 4, !tbaa !169
  %i.il = sdiv i32 %i.ik, 65536
  %.zext.i69 = and i32 %i.il, 1
  %i.im = icmp eq i32 %.zext.i69, 0
...
bb.z:                                             ; preds = %bb.x, %bb.z
  %.0151 = phi float [ 0.000000e+00, %bb.x ], [ %i.ip, %bb.z ] ; 2 uses
  tail call void @_ZN15CavesRandomWalk10carveRouteEN4core8vector3dIfEEfb(ptr noundef nonnull align 8 dereferenceable(150) %0, <2 x float> %i.ib, float %i.ic, float noundef %.0151, i1 noundef zeroext %i.im)
  %i.ip = fadd nsz float %i.io, %.0151            ; 2 uses
  %i.iq = fcmp nsz olt float %i.ip, 1.000000e+00
  br i1 %i.iq, label %bb.z, label %bb.y, !llvm.loop !198

_ZN15CavesRandomWalk17isPosAboveSurfaceEN4core8vector3dIsEE.exit.thread: ; preds = %_ZN15CavesRandomWalk17isPosAboveSurfaceEN4core8vector3dIsEE.exit.thread138, %bb.m, %.thread, %bb.k, %bb.j, %bb.y
  ret void
}
...
._crit_edge:                                      ; preds = %bb.a, %bb.b
  ...
  %i.be = trunc nuw i8 %i.bd to i1
  %.pre155 = shl i32 %i.bb, 16
  %.pre156 = ashr exact i32 %.pre155, 16          ; 4 uses
...
bb.d:                                             ; preds = %._crit_edge
  ...
  %i.bh = tail call noundef i32 @_ZN12PseudoRandom5rangeEii(ptr noundef nonnull align 4 dereferenceable(4) %i.bg, i32 noundef 1, i32 noundef %.pre156)
  %i.bi = trunc i32 %i.bh to i16
  %.pre154 = load i8, ptr %i.a, align 4, !tbaa !218, !range !117
  %i.bj = trunc nuw i8 %.pre154 to i1
  br label %bb.e

bb.e:                                             ; preds = %bb.d, %bb.c
  %i.bk = phi i1 [ %i.bj, %bb.d ], [ true, %bb.c ]
  %.sroa.7128.0 = phi i16 [ %i.bi, %bb.d ], [ %i.bf, %bb.c ] ; 2 uses
  ...
  %i.bt = sdiv i32 %i.bs, 65536
  %i.bu = and i32 %i.bt, 32767
  %i.bv = sext i16 %.sroa.7128.0 to i32           ; 2 uses
  %i.bw = urem i32 %i.bu, %i.bv
  %i.bx = uitofp nsz nneg i32 %i.bw to float
  %i.by = sitofp nsz i16 %.sroa.7128.0 to float   ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %.lhs.trunc.i37 = and i16 %i.cm, 32767
  %i.cn = urem i16 %.lhs.trunc.i37, 13
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.dd = urem i32 %i.dc, %.pre156
  %i.de = uitofp nsz nneg i32 %i.dd to float
  %i.df = fsub nsz float %i.de, %i.bq
  %i.dg = insertelement <2 x float> poison, float %i.df, i64 0
  %.sroa.089.0.vec.insert93 = insertelement <2 x float> %i.dg, float %i.cy, i64 1
  br label %bb.h

bb.h:                                             ; preds = %bb.g, %bb.f, %bb.e
  %.sroa.089.0 = phi nsz <2 x float> [ %.sroa.089.0.vec.insert, %bb.e ], [ %.sroa.089.0.vec.insert93, %bb.g ], [ %.sroa.089.0.vec.insert, %bb.f ] ; 3 uses
  %.pn151.in.in = phi i32 [ %i.bo, %bb.e ], [ %i.cq, %bb.g ], [ %i.bo, %bb.f ]
  %.pn151.in = sdiv i32 %.pn151.in.in, 65536
  %.pn151 = and i32 %.pn151.in, 32767
  %.pn.in = urem i32 %.pn151, %.pre156
  ...
  %.sroa.089.0.vec.extract = extractelement <2 x float> %.sroa.089.0, i64 0
  %i.ee = fptosi float %.sroa.089.0.vec.extract to i16
  %.sroa.089.4.vec.extract = extractelement <2 x float> %.sroa.089.0, i64 1
  %i.ef = fptosi float %.sroa.089.4.vec.extract to i16
  ...
  br i1 %.not.i, label %_ZN7CavesV623getSurfaceFromHeightmapEN4core8vector3dIsEE.exit.thread140, label %bb.i
...
_ZN7CavesV623getSurfaceFromHeightmapEN4core8vector3dIsEE.exit.thread140: ; preds = %bb.h
  ...
  br i1 %i.fd, label %.thread141, label %bb.m
...
.thread:                                          ; preds = %_ZN7CavesV623getSurfaceFromHeightmapEN4core8vector3dIsEE.exit, %_ZN7CavesV623getSurfaceFromHeightmapEN4core8vector3dIsEE.exit.thread
  ...
  %.not12.i55 = icmp slt i16 %i.ej, %i.eo
  %.not13.i56 = icmp sgt i16 %i.ej, %i.er
  %or.cond18.i57 = select i1 %.not12.i55, i1 true, i1 %.not13.i56
  br i1 %or.cond18.i57, label %.thread141, label %bb.k
...
bb.k:                                             ; preds = %.thread
  ...
  %.not14.i58 = icmp sgt i16 %i.fu, %i.eh
  %i.fv = load i16, ptr %i.ft, align 4
  %.not15.i59 = icmp slt i16 %i.fv, %i.eh
  %or.cond.i60 = select i1 %.not14.i58, i1 true, i1 %.not15.i59
  br i1 %or.cond.i60, label %.thread141, label %bb.l
...
bb.l:                                             ; preds = %bb.k
  ...
  br label %_ZN7CavesV623getSurfaceFromHeightmapEN4core8vector3dIsEE.exit62

.thread141:                                       ; preds = %_ZN7CavesV623getSurfaceFromHeightmapEN4core8vector3dIsEE.exit.thread140, %bb.k, %.thread
  %i.gi = getelementptr inbounds nuw i8, ptr %0, i64 52
  %i.gj = load i32, ptr %i.gi, align 4, !tbaa !211
  %i.gk = trunc i32 %i.gj to i16
  br label %_ZN7CavesV623getSurfaceFromHeightmapEN4core8vector3dIsEE.exit62

_ZN7CavesV623getSurfaceFromHeightmapEN4core8vector3dIsEE.exit62: ; preds = %bb.l, %.thread141
  %.0.i61 = phi i16 [ %i.gh, %bb.l ], [ %i.gk, %.thread141 ]
  %i.gl = icmp slt i16 %.0.i61, %i.ei
  br label %bb.m

bb.m:                                             ; preds = %_ZN7CavesV623getSurfaceFromHeightmapEN4core8vector3dIsEE.exit.thread140, %_ZN7CavesV623getSurfaceFromHeightmapEN4core8vector3dIsEE.exit.thread, %_ZN7CavesV623getSurfaceFromHeightmapEN4core8vector3dIsEE.exit62, %_ZN7CavesV623getSurfaceFromHeightmapEN4core8vector3dIsEE.exit
  %i.gm = phi i1 [ false, %_ZN7CavesV623getSurfaceFromHeightmapEN4core8vector3dIsEE.exit ], [ %i.gl, %_ZN7CavesV623getSurfaceFromHeightmapEN4core8vector3dIsEE.exit62 ], [ false, %_ZN7CavesV623getSurfaceFromHeightmapEN4core8vector3dIsEE.exit.thread ], [ false, %_ZN7CavesV623getSurfaceFromHeightmapEN4core8vector3dIsEE.exit.thread140 ]
  ...
  %i.gs = fadd nsz <2 x float> %.sroa.089.0, %i.gr
...
bb.p:                                             ; preds = %bb.o
  ...
  %.sroa.0.0.vec.insert71 = insertelement <2 x float> %i.gt, float %i.hd, i64 0
  br label %bb.q

bb.q:                                             ; preds = %bb.o, %bb.p, %bb.n
  %.sroa.0.0 = phi nsz <2 x float> [ %.sroa.0.0.vec.insert, %bb.n ], [ %i.gt, %bb.o ], [ %.sroa.0.0.vec.insert71, %bb.p ] ; 4 uses
  %.sroa.0.4.vec.extract = extractelement <2 x float> %.sroa.0.0, i64 1 ; 2 uses
...
bb.r:                                             ; preds = %bb.q
  %.sroa.0.4.vec.insert75 = insertelement <2 x float> %.sroa.0.0, float %i.hg, i64 1
  br label %bb.u
...
bb.u:                                             ; preds = %bb.s, %bb.t, %bb.r
  %.sroa.0.1 = phi nsz <2 x float> [ %.sroa.0.4.vec.insert75, %bb.r ], [ %.sroa.0.0, %bb.s ], [ %.sroa.0.4.vec.insert, %bb.t ] ; 2 uses
...
bb.x:                                             ; preds = %bb.u, %bb.v, %bb.w
  ...
  %foldExtExtBinop166 = fmul nsz <2 x float> %i.hx, %i.hx
  %i.hz = extractelement <2 x float> %foldExtExtBinop166, i64 1
  ...
  %.zext.i68 = and i32 %i.ik, 1
  %i.il = icmp eq i32 %.zext.i68, 0
...
bb.z:                                             ; preds = %bb.x, %bb.z
  %.0153 = phi float [ 0.000000e+00, %bb.x ], [ %i.io, %bb.z ] ; 2 uses
  tail call void @_ZN7CavesV610carveRouteEN4core8vector3dIfEEfbb(ptr noundef nonnull align 8 dereferenceable(128) %0, <2 x float> %i.hx, float %i.hy, float noundef %.0153, i1 noundef zeroext %i.il, i1 noundef zeroext %i.gm)
  %i.io = fadd nsz float %i.in, %.0153            ; 2 uses
