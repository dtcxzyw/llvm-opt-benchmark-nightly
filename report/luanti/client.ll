...
_ZN11StreamProxylsEPFRSoS0_E.exit:                ; preds = %_ZTW10infostream.exit, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit
  ...
  %.sroa.0.0.extract.trunc.i.i = trunc i48 %.sroa.09.0.copyload to i16 ; 2 uses
  ...
  %5 = sext i16 %.sroa.0.0.extract.trunc.i.i to i32 ; 2 uses
  %6 = add nsw i32 %5, -15
  %7 = icmp slt i16 %.sroa.0.0.extract.trunc.i.i, 0
  %8 = select i1 %7, i32 %6, i32 %5
  %9 = sdiv i32 %8, 16                            ; 2 uses
  %10 = sext i16 %.sroa.2.0.extract.trunc.i.i to i32 ; 2 uses
  %11 = add nsw i32 %10, -15
  %12 = icmp slt i16 %.sroa.2.0.extract.trunc.i.i, 0
  %13 = select i1 %12, i32 %11, i32 %10
  %14 = sdiv i32 %13, 16                          ; 2 uses
  ...
  %.sroa.045.0.extract.trunc = trunc nsw i32 %9 to i16 ; 2 uses
  ...
  %.sroa.045.0.extract.trunc.mask = and i32 %9, 65535
