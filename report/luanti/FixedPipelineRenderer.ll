...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %i.ce = shufflevector <4 x float> %7, <4 x float> poison, <4 x i32> zeroinitializer
  %i.cf = fmul <4 x float> %i.ce, %i.cd
  %i.cg = shufflevector <4 x float> %6, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.cj = shufflevector <4 x float> %8, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.cm = shufflevector <4 x float> %9, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.cw = shufflevector <4 x float> %11, <4 x float> poison, <4 x i32> zeroinitializer
  %i.cx = fmul <4 x float> %i.cd, %i.cw
  %i.cy = shufflevector <4 x float> %10, <4 x float> poison, <4 x i32> zeroinitializer
  %i.cz = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.cc, <4 x float> %i.cy, <4 x float> %i.cx)
  %i.da = shufflevector <4 x float> %12, <4 x float> poison, <4 x i32> zeroinitializer
  %i.db = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ci, <4 x float> %i.da, <4 x float> %i.cz)
  %i.dc = shufflevector <4 x float> %13, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %i.dm = shufflevector <4 x float> %15, <4 x float> poison, <4 x i32> zeroinitializer
  %i.dn = fmul <4 x float> %i.cd, %i.dm
  %i.do = shufflevector <4 x float> %14, <4 x float> poison, <4 x i32> zeroinitializer
  %i.dp = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.cc, <4 x float> %i.do, <4 x float> %i.dn)
  %i.dq = shufflevector <4 x float> %16, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %18 = load <4 x float>, ptr %i.du, align 4
  ...
  %i.ei = shufflevector <4 x float> %18, <4 x float> poison, <4 x i32> zeroinitializer
