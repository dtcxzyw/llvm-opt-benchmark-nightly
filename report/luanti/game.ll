...
bb.bk:                                            ; preds = %bb.bj
  ...
  %.sroa.01.0.copyload.i = load <2 x float>, ptr %i.mk, align 4
  %.sroa.22.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.mj, i64 612
  %.sroa.22.0.copyload.i.a = load float, ptr %.sroa.22.0..sroa_idx.i, align 4, !tbaa !60
  %i.ml = insertelement <2 x float> %.sroa.01.0.copyload.i, float %.sroa.22.0.copyload.i.a, i64 1
