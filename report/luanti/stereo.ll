...
bb.a:                                             ; preds = %.noexc.i
  %i.am = load ptr, ptr %3, align 8, !tbaa !22    ; 2 uses
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %bb.a, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i
  ...
  store float %i.as, ptr %i.at, align 8, !tbaa !12
  %i.au = getelementptr inbounds nuw i8, ptr %0, i64 124
  store <2 x float> zeroinitializer, ptr %i.au, align 4, !tbaa !12
  ret void

bb.b:                                             ; preds = %.noexc.i
  %i.av = landingpad { ptr, i32 }
          cleanup
  %i.aw = load ptr, ptr %3, align 8, !tbaa !22    ; 2 uses
...
.noexc.i:
  ...
  store ptr getelementptr inbounds nuw inrange(-40, 48) (i8, ptr @_ZTV16OffsetCameraStep, i64 40), ptr %0, align 8, !tbaa !10
  ...
  store float 1.000000e+00, ptr %i.e, align 8, !tbaa !12
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 28
  store float 1.000000e+00, ptr %i.f, align 4, !tbaa !12
  store float 1.000000e+00, ptr %i.b, align 8, !tbaa !12
  ...
  store float 1.000000e+00, ptr %i.h, align 4, !tbaa !12
  %i.i = getelementptr inbounds nuw i8, ptr %0, i64 112
  store float 1.000000e+00, ptr %i.i, align 8, !tbaa !12
  %i.j = getelementptr inbounds nuw i8, ptr %0, i64 92
  store float 1.000000e+00, ptr %i.j, align 4, !tbaa !12
  store <2 x float> splat (float 1.000000e+00), ptr %i.d, align 4, !tbaa !12
  %i.k = load ptr, ptr @g_settings, align 8, !tbaa !15
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #15
  %i.l = getelementptr inbounds nuw i8, ptr %2, i64 16 ; 6 uses
  store ptr %i.l, ptr %2, align 8, !tbaa !18
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #15
  store i64 19, ptr %i.a, align 8, !tbaa !20
  ...
  %i.n = load i64, ptr %i.a, align 8, !tbaa !20   ; 3 uses
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %bb.a, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i
  ...
  store float %i.y, ptr %i.z, align 8, !tbaa !12
  %i.aa = getelementptr inbounds nuw i8, ptr %0, i64 124
  store <2 x float> zeroinitializer, ptr %i.aa, align 4, !tbaa !12
  ret void
...
bb.a:
  ...
  %i.j = load ptr, ptr %i.i, align 8, !tbaa !255  ; 2 uses
...
bb.a:
  ...
  %i.l = load float, ptr %i.k, align 8, !tbaa !12, !noalias !260
  %i.m = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.n = load float, ptr %i.m, align 8, !tbaa !12, !noalias !260
  %i.o = getelementptr inbounds nuw i8, ptr %0, i64 48
  %i.p = load float, ptr %i.o, align 8, !tbaa !12, !noalias !260
  %i.q = getelementptr inbounds nuw i8, ptr %0, i64 64
  %i.r = load float, ptr %i.q, align 8, !tbaa !12, !noalias !260
  %i.s = getelementptr inbounds nuw i8, ptr %0, i64 120
  %i.t = load <2 x float>, ptr %i.g, align 8, !tbaa !12, !noalias !260
  %i.u = load <2 x float>, ptr %i.h, align 8, !tbaa !12, !noalias !260
  %i.v = load <2 x float>, ptr %i.i, align 8, !tbaa !12, !noalias !260
  %i.w = load <2 x float>, ptr %i.j, align 8, !tbaa !12, !noalias !260
  %3 = load <4 x float>, ptr %i.s, align 8, !tbaa !12, !noalias !260 ; 8 uses
  %4 = shufflevector <4 x float> %3, <4 x float> poison, <2 x i32> <i32 1, i32 1>
  %5 = fmul nsz <2 x float> %i.u, %4
  %i.x = shufflevector <4 x float> %3, <4 x float> poison, <2 x i32> zeroinitializer
  %6 = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.t, <2 x float> %i.x, <2 x float> %5)
  %7 = shufflevector <4 x float> %3, <4 x float> poison, <2 x i32> <i32 2, i32 2>
  %i.y = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.v, <2 x float> %7, <2 x float> %6)
  %8 = shufflevector <4 x float> %3, <4 x float> poison, <2 x i32> <i32 3, i32 3>
  %9 = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.w, <2 x float> %8, <2 x float> %i.y)
  %10 = extractelement <4 x float> %3, i64 1
  %11 = fmul nsz float %i.n, %10
  %12 = extractelement <4 x float> %3, i64 0
  %13 = tail call nsz float @llvm.fmuladd.f32(float %i.l, float %12, float %11)
  %14 = extractelement <4 x float> %3, i64 2
  %i.z = tail call nsz float @llvm.fmuladd.f32(float %i.p, float %14, float %13)
  %15 = extractelement <4 x float> %3, i64 3
  %i.aa = tail call nsz float @llvm.fmuladd.f32(float %i.r, float %15, float %i.z)
  store <2 x float> %9, ptr %2, align 8
  %.sroa.2.0..sroa_idx = getelementptr inbounds nuw i8, ptr %2, i64 8
  store float %i.aa, ptr %.sroa.2.0..sroa_idx, align 8
  %i.ab = load ptr, ptr %i.f, align 8, !tbaa !10
  %i.ac = getelementptr inbounds nuw i8, ptr %i.ab, i64 224
  %i.ad = load ptr, ptr %i.ac, align 8
  call void %i.ad(ptr noundef nonnull align 8 dereferenceable(218) %i.f, ptr noundef nonnull align 4 dereferenceable(12) %2)
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #15
  ret void
}
...
bb.a:
  %i.a = load ptr, ptr %0, align 8, !tbaa !263    ; 3 uses
...
_ZNKSt14default_deleteI18ClientActiveObjectEclEPS0_.exit: ; preds = %bb.a
  ...
  tail call void %i.d(ptr noundef nonnull align 8 dereferenceable(32) %i.a) #15, !inline_history !261
  br label %bb.b
...
!19 = !{!"long", !5, i64 0}
!20 = !{!19, !19, i64 0}
!21 = !{!"_ZTSNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE", !17, i64 0, !19, i64 8, !5, i64 16}
!22 = !{!21, !16, i64 0}
!23 = !{!5, !5, i64 0}
!24 = !{!21, !19, i64 8}
!25 = !{!"p1 _ZTS14IrrlichtDevice", !13, i64 0}
!26 = !{!"p1 _ZTS6Client", !13, i64 0}
!27 = !{!"p1 _ZTS3Hud", !13, i64 0}
!28 = !{!"p1 _ZTS14ShadowRenderer", !13, i64 0}
!29 = !{!"_ZTSN5video6SColorE", !6, i64 0}
!30 = !{!"_ZTSN4core8vector2dIjEE", !6, i64 0, !6, i64 4}
!31 = !{!"bool", !5, i64 0}
!32 = !{!"_ZTS15PipelineContext", !25, i64 0, !26, i64 8, !27, i64 16, !28, i64 24, !29, i64 32, !30, i64 36, !31, i64 44, !31, i64 45, !31, i64 46}
!33 = !{!32, !26, i64 8}
!34 = !{!"_ZTSN3con11PeerHandlerE"}
!35 = !{!"_ZTS16InventoryManager"}
!36 = !{!"_ZTS8IGameDef"}
!37 = !{!"_ZTS15IntervalLimiter", !11, i64 0}
!38 = !{!"p1 _ZTS22IWritableTextureSource", !13, i64 0}
!39 = !{!"p1 _ZTS21IWritableShaderSource", !13, i64 0}
!40 = !{!"p1 _ZTS23IWritableItemDefManager", !13, i64 0}
!41 = !{!"p1 _ZTS14NodeDefManager", !13, i64 0}
!42 = !{!"p1 _ZTS13ISoundManager", !13, i64 0}
!43 = !{!"p1 _ZTS14MtEventManager", !13, i64 0}
!44 = !{!"p1 _ZTS15RenderingEngine", !13, i64 0}
!45 = !{!"p1 _ZTS18ItemVisualsManager", !13, i64 0}
end_hunk_0
