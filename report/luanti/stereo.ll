...
bb.a:
  ...
  %6 = load float, ptr %3, align 4, !tbaa !12, !noalias !260 ; 2 uses
  %7 = load float, ptr %i.s, align 8, !tbaa !12, !noalias !260 ; 2 uses
  %8 = load float, ptr %4, align 8, !tbaa !12, !noalias !260 ; 2 uses
  %9 = load float, ptr %5, align 4, !tbaa !12, !noalias !260 ; 2 uses
  %10 = insertelement <2 x float> poison, float %6, i64 0
  %i.x = shufflevector <2 x float> %10, <2 x float> poison, <2 x i32> zeroinitializer
  %11 = fmul nsz <2 x float> %i.u, %i.x
  %12 = insertelement <2 x float> poison, float %7, i64 0
  %13 = shufflevector <2 x float> %12, <2 x float> poison, <2 x i32> zeroinitializer
  %i.y = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.t, <2 x float> %13, <2 x float> %11)
  %14 = insertelement <2 x float> poison, float %8, i64 0
  %15 = shufflevector <2 x float> %14, <2 x float> poison, <2 x i32> zeroinitializer
  %16 = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.v, <2 x float> %15, <2 x float> %i.y)
  %17 = insertelement <2 x float> poison, float %9, i64 0
  %18 = shufflevector <2 x float> %17, <2 x float> poison, <2 x i32> zeroinitializer
  %19 = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.w, <2 x float> %18, <2 x float> %16)
  %20 = fmul nsz float %i.n, %6
  %i.z = tail call nsz float @llvm.fmuladd.f32(float %i.l, float %7, float %20)
  %21 = tail call nsz float @llvm.fmuladd.f32(float %i.p, float %8, float %i.z)
  %i.aa = tail call nsz float @llvm.fmuladd.f32(float %i.r, float %9, float %21)
  store <2 x float> %19, ptr %2, align 8
