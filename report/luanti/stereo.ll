...
bb.a:
  ...
  %3 = load float, ptr %i.s, align 8, !tbaa !11, !noalias !258 ; 2 uses
  %4 = getelementptr inbounds nuw i8, ptr %0, i64 124
  %5 = load float, ptr %4, align 4, !tbaa !11, !noalias !258 ; 2 uses
  %6 = getelementptr inbounds nuw i8, ptr %0, i64 128
  %7 = load float, ptr %6, align 8, !tbaa !11, !noalias !258 ; 2 uses
  %8 = getelementptr inbounds nuw i8, ptr %0, i64 132
  %9 = load float, ptr %8, align 4, !tbaa !11, !noalias !258 ; 2 uses
  %i.t = load <2 x float>, ptr %i.g, align 8, !tbaa !11, !noalias !258
  %i.u = load <2 x float>, ptr %i.h, align 8, !tbaa !11, !noalias !258
  %i.v = load <2 x float>, ptr %i.i, align 8, !tbaa !11, !noalias !258
  %10 = load <2 x float>, ptr %i.j, align 8, !tbaa !11, !noalias !258
  %11 = insertelement <2 x float> poison, float %5, i64 0
  %12 = shufflevector <2 x float> %11, <2 x float> poison, <2 x i32> zeroinitializer
  %13 = fmul nsz <2 x float> %i.u, %12
  %14 = insertelement <2 x float> poison, float %3, i64 0
  %15 = shufflevector <2 x float> %14, <2 x float> poison, <2 x i32> zeroinitializer
  %i.w = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.t, <2 x float> %15, <2 x float> %13)
  %16 = insertelement <2 x float> poison, float %7, i64 0
  %17 = shufflevector <2 x float> %16, <2 x float> poison, <2 x i32> zeroinitializer
  %18 = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.v, <2 x float> %17, <2 x float> %i.w)
  %19 = insertelement <2 x float> poison, float %9, i64 0
  %20 = shufflevector <2 x float> %19, <2 x float> poison, <2 x i32> zeroinitializer
  %21 = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %10, <2 x float> %20, <2 x float> %18)
  %22 = fmul nsz float %i.n, %5
  %i.x = tail call nsz float @llvm.fmuladd.f32(float %i.l, float %3, float %22)
  %23 = tail call nsz float @llvm.fmuladd.f32(float %i.p, float %7, float %i.x)
  %i.y = tail call nsz float @llvm.fmuladd.f32(float %i.r, float %9, float %23)
  store <2 x float> %21, ptr %2, align 8
