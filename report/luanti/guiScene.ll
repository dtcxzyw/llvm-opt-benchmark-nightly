...
_ZN8GUIScene13correctBoundsERN4core8vector3dIfEE.exit: ; preds = %bb.b, %bb.c, %.sink.split.i
  ...
  %i.n = extractvalue { <2 x double>, <2 x double> } %i.m, 0 ; 6 uses
  %i.o = extractelement <2 x double> %i.n, i64 1  ; 2 uses
  ...
  %4 = insertelement <2 x double> %3, double %sin.i.i, i64 1
  %5 = insertelement <2 x double> poison, double %cos.i.i, i64 0
  %i.v = insertelement <2 x double> %i.n, double %cos.i.i, i64 0
  %6 = fmul nsz <2 x double> %4, %i.v             ; 2 uses
  %i.w = shufflevector <2 x double> %5, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.ab = tail call nsz <2 x double> @llvm.fmuladd.v2f64(<2 x double> %7, <2 x double> %i.aa, <2 x double> %i.z)
  ...
  %i.al = shufflevector <2 x double> %6, <2 x double> poison, <2 x i32> zeroinitializer
