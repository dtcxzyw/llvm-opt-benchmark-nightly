...
.preheader91:                                     ; preds = %bb.d, %.preheader91.unr-lcssa
  ...
  %i.bv = load float, ptr %i.bi, align 8, !tbaa !45
  %7 = load <2 x float>, ptr %i.bh, align 4, !tbaa !44 ; 2 uses
  %i.bw = shufflevector <2 x float> %7, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %8 = shufflevector <2 x float> %7, <2 x float> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  %i.ci = insertelement <2 x float> %8, float %i.bg, i64 1
  ...
  %i.ct = fadd nsz <2 x float> %8, %i.cs          ; 6 uses
  ...
  %i.dw = fadd nsz float %i.bv, %i.dt             ; 5 uses
