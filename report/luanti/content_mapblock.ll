...
bb.a:
  ...
  %.sroa.09.4.vec.extract = extractelement <2 x float> %.fca.0.extract, i64 1
  %4 = fadd nsz float %i.h, 5.000000e-01
  %5 = tail call nsz noundef float @llvm.floor.f32(float %4)
  %6 = fptosi float %5 to i32
  %7 = tail call i32 @llvm.smax.i32(i32 %6, i32 0)
  %8 = tail call i32 @llvm.umin.i32(i32 %7, i32 255)
  %.sroa.0.0.insert.ext.i = trunc nuw nsw i32 %8 to i16
  %9 = fadd nsz float %.sroa.09.4.vec.extract, 5.000000e-01
  %10 = tail call nsz noundef float @llvm.floor.f32(float %9)
  %11 = fptosi float %10 to i32
  %12 = tail call i32 @llvm.smax.i32(i32 %11, i32 0)
  %13 = tail call i32 @llvm.umin.i32(i32 %12, i32 255)
  %.sroa.2.0.insert.ext.i = trunc nuw nsw i32 %13 to i16
...
.preheader.split.us108.preheader:                 ; preds = %.preheader91
  ...
  %8 = insertelement <2 x double> poison, double %i.hn, i64 0
  %i.ho = insertelement <2 x double> %8, double %7, i64 1 ; 2 uses
  ...
  %9 = tail call nsz double @llvm.fmuladd.f64(double %i.hn, double f0x3C91A62633145C07, double %i.ia)
  %10 = shufflevector <2 x double> %i.hy, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %11 = insertelement <2 x double> %10, double %i.hm, i64 1
  %12 = fmul nsz <2 x double> %11, splat (double f0x3C91A62633145C07) ; 2 uses
  %13 = fadd nsz <2 x double> %12, %i.ho
  %14 = fsub nsz <2 x double> %12, %i.ho
  %15 = shufflevector <2 x double> %13, <2 x double> %14, <4 x i32> <i32 0, i32 3, i32 poison, i32 poison>
  %16 = extractelement <2 x double> %i.hz, i64 0
  %17 = extractelement <2 x double> %i.hj, i64 0
  %18 = tail call nsz double @llvm.fmuladd.f64(double %17, double f0x3C91A62633145C07, double %16)
  %i.ib = insertelement <4 x double> poison, double %18, i64 0
  ...
  %i.iw = insertelement <4 x double> %i.iv, double %9, i64 3
  %i.ix = fptrunc <4 x double> %i.iw to <4 x float>
  store <4 x float> %i.ix, ptr %5, align 16, !tbaa !44
  %i.iy = insertelement <4 x double> %15, double %i.ip, i64 2
