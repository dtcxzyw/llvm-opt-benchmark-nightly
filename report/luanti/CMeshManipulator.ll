...
.lr.ph140.i:                                      ; preds = %.preheader131.i, %bb.h
  ...
  %4 = load <2 x float>, ptr %i.gi, align 4, !tbaa !26 ; 4 uses
  %5 = load <3 x float>, ptr %i.fv, align 4, !tbaa !26 ; 5 uses
  %i.gy = load float, ptr %i.fv, align 4, !tbaa !25
  %i.gz = load <2 x float>, ptr %i.gv, align 4, !tbaa !26 ; 4 uses
  %i.ha = load <2 x float>, ptr %i.gw, align 4, !tbaa !26 ; 5 uses
  %6 = shufflevector <3 x float> %5, <3 x float> poison, <2 x i32> <i32 1, i32 2> ; 2 uses
  %i.hb = fsub <2 x float> %i.ha, %6              ; 2 uses
  %i.hc = shufflevector <2 x float> %i.ha, <2 x float> %4, <2 x i32> <i32 1, i32 2>
  %7 = shufflevector <3 x float> %5, <3 x float> poison, <2 x i32> <i32 2, i32 poison>
  %i.hd = insertelement <2 x float> %7, float %i.gy, i64 1 ; 2 uses
  %i.he = fsub <2 x float> %i.hc, %i.hd           ; 2 uses
  %i.hf = load <2 x float>, ptr %i.gx, align 4, !tbaa !26 ; 5 uses
...
bb.g:                                             ; preds = %_ZN4core7plane3dIfEC2ERKNS_8vector3dIfEES5_S5_.exit84.i
  %foldExtExtBinop91 = fsub <2 x float> %4, %i.gz
  ...
  %i.in = shufflevector <3 x float> %5, <3 x float> poison, <2 x i32> zeroinitializer
  %i.io = shufflevector <2 x float> %i.gz, <2 x float> %4, <2 x i32> <i32 0, i32 2>
  %i.ip = fsub <2 x float> %i.in, %i.io           ; 2 uses
  %8 = shufflevector <3 x float> %5, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.iq = shufflevector <2 x float> %i.gz, <2 x float> %4, <2 x i32> <i32 1, i32 3>
  %i.ir = fsub <2 x float> %8, %i.iq              ; 2 uses
  %9 = shufflevector <3 x float> %5, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %i.is = shufflevector <2 x float> %i.ha, <2 x float> %i.hf, <2 x i32> <i32 3, i32 1>
  %i.it = fsub <2 x float> %9, %i.is              ; 2 uses
...
.lr.ph140.i30:                                    ; preds = %.preheader131.i28, %bb.o
  ...
  %10 = load <2 x float>, ptr %i.so, align 4, !tbaa !26 ; 4 uses
  %11 = load <3 x float>, ptr %i.sc, align 4, !tbaa !26 ; 5 uses
  %i.td = load float, ptr %i.sc, align 4, !tbaa !25
  %i.te = load <2 x float>, ptr %i.ta, align 4, !tbaa !26 ; 4 uses
  %i.tf = load <2 x float>, ptr %i.tb, align 4, !tbaa !26 ; 5 uses
  %12 = shufflevector <3 x float> %11, <3 x float> poison, <2 x i32> <i32 1, i32 2> ; 2 uses
  %i.tg = fsub <2 x float> %i.tf, %12             ; 2 uses
  %i.th = shufflevector <2 x float> %i.tf, <2 x float> %10, <2 x i32> <i32 1, i32 2>
  %13 = shufflevector <3 x float> %11, <3 x float> poison, <2 x i32> <i32 2, i32 poison>
  %i.ti = insertelement <2 x float> %13, float %i.td, i64 1 ; 2 uses
  %i.tj = fsub <2 x float> %i.th, %i.ti           ; 2 uses
  %i.tk = load <2 x float>, ptr %i.tc, align 4, !tbaa !26 ; 5 uses
  %i.tl = shufflevector <2 x float> %i.tk, <2 x float> %i.te, <2 x i32> <i32 1, i32 2>
  %i.tm = fsub <2 x float> %i.tl, %i.ti           ; 2 uses
  %i.tn = fsub <2 x float> %i.tk, %12             ; 2 uses
...
bb.n:                                             ; preds = %_ZN4core7plane3dIfEC2ERKNS_8vector3dIfEES5_S5_.exit84.i37
  %foldExtExtBinop105 = fsub <2 x float> %10, %i.te
  ...
  %i.us = shufflevector <3 x float> %11, <3 x float> poison, <2 x i32> zeroinitializer
  %i.ut = shufflevector <2 x float> %i.te, <2 x float> %10, <2 x i32> <i32 0, i32 2>
  %i.uu = fsub <2 x float> %i.us, %i.ut           ; 2 uses
  %14 = shufflevector <3 x float> %11, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.uv = shufflevector <2 x float> %i.te, <2 x float> %10, <2 x i32> <i32 1, i32 3>
  %i.uw = fsub <2 x float> %14, %i.uv             ; 2 uses
  ...
  %i.uy = fsub <2 x float> %15, %i.ux             ; 2 uses
