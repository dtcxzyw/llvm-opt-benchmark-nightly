...
bb.a:
  ...
  %8 = fmul double %.sroa.speculated21.i, %.sroa.speculated21.i ; 3 uses
  %9 = fmul double %.sroa.0.0.copyload, %.sroa.0.0.copyload ; 3 uses
  %10 = sub nsw i32 0, %i.h
  %11 = sitofp i32 %10 to double
  %12 = fneg double %i.i
  %13 = tail call double @llvm.fmuladd.f64(double %12, double %8, double %9)
  %14 = fmul double %8, 4.000000e+00
  ...
  %15 = fmul <2 x double> %i.ab, splat (double -2.000000e+00)
  ...
  %i.bb = shufflevector <2 x double> %16, <2 x double> poison, <2 x i32> zeroinitializer
  %17 = insertelement <2 x double> poison, double %9, i64 0
  %18 = shufflevector <2 x double> %17, <2 x double> poison, <2 x i32> zeroinitializer
  %i.bc = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ba, <2 x double> %i.bb, <2 x double> %18)
  ...
  %i.bh = fdiv double %.sroa.speculated4.i, %9
