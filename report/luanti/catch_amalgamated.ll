...
begin_hunk_0_@_ZN5Catch9Benchmark6Detail7analyseERKNS_7IConfigEPNSt6chrono8durationIdSt5ratioILl1ELl1000000000EEEESA_:bb.a
  %.pn35 = phi { ptr, i32 } [ %.pn.pn.pn, %bb.x ], [ %lpad.loopexit191, %.loopexit189 ], [ %lpad.loopexit.split-lp192, %.loopexit.split-lp190 ] ; 2 uses
  %.not.i.i.i57 = icmp eq ptr %.sroa.0118.0216, null
  br i1 %.not.i.i.i57, label %_ZNSt6vectorIdSaIdEED2Ev.exit58, label %bb.z

bb.z:                                             ; preds = %bb.y
  %i.bz = ptrtoint ptr %.sroa.29.0224 to i64
  %i.ca = ptrtoint ptr %.sroa.0118.0216 to i64
  %i.cb = sub i64 %i.bz, %i.ca
  tail call void @_ZdlPvm(ptr noundef nonnull %.sroa.0118.0216, i64 noundef %i.cb) #64
...
bb.ab:                                            ; preds = %bb.aa
  %.not182 = icmp eq ptr %3, %2
  br i1 %.not182, label %_ZNSt6vectorINSt6chrono8durationIdSt5ratioILl1ELl1000000000EEEESaIS4_EE7reserveEm.exit65, label %_ZNSt12_Vector_baseINSt6chrono8durationIdSt5ratioILl1ELl1000000000EEEESaIS4_EE11_M_allocateEm.exit.i59
...
bb.a:
  ...
  %.sroa.0.0.copyload = load double, ptr %7, align 8, !tbaa !14 ; 2 uses
  ...
  %11 = insertelement <2 x double> poison, double %.sroa.speculated21.i, i64 0
  %12 = insertelement <2 x double> %11, double %.sroa.0.0.copyload, i64 1 ; 2 uses
  %13 = fmul <2 x double> %12, %12                ; 4 uses
  %14 = extractelement <2 x double> %13, i64 0    ; 2 uses
  %15 = extractelement <2 x double> %13, i64 1    ; 2 uses
  %16 = tail call double @llvm.fmuladd.f64(double %10, double %14, double %15)
  %17 = fmul double %14, 4.000000e+00
  %i.u = shufflevector <2 x double> %foldExtExtBinop, <2 x double> %i.o, <2 x i32> <i32 1, i32 3> ; 2 uses
  ...
  %i.y = fmul <2 x double> %i.v, %i.x             ; 2 uses
  %i.z = insertelement <2 x double> poison, double %9, i64 0
  %i.aa = shufflevector <2 x double> %i.z, <2 x double> poison, <2 x i32> zeroinitializer
  %18 = fmul <2 x double> %i.y, %i.aa             ; 2 uses
  %i.ab = fmul <2 x double> %18, splat (double -2.000000e+00)
  %i.ac = insertelement <2 x double> poison, double %16, i64 0
  %i.ad = shufflevector <2 x double> %i.ac, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ae = fadd <2 x double> %i.y, %i.ad           ; 3 uses
  %i.af = fneg <2 x double> %18
  %i.ag = insertelement <2 x double> poison, double %17, i64 0
  %i.ah = shufflevector <2 x double> %i.ag, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ai = fmul <2 x double> %i.ah, %i.af
  %i.aj = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ae, <2 x double> %i.ae, <2 x double> %i.ai) ; 2 uses
  %i.ak = extractelement <2 x double> %i.aj, i64 1
  %i.al = tail call double @sqrt(double noundef %i.ak) #63
  %i.am = extractelement <2 x double> %i.aj, i64 0
  %i.an = tail call double @sqrt(double noundef %i.am) #63
  %i.ao = insertelement <2 x double> poison, double %i.an, i64 0
  %i.ap = insertelement <2 x double> %i.ao, double %i.al, i64 1
  %i.aq = fadd <2 x double> %i.ap, %i.ae
  %i.ar = fdiv <2 x double> %i.ab, %i.aq
  ...
  %.sroa.speculated.i = select i1 %i.aw, double %i.au, double %i.av
  %i.ax = insertelement <2 x double> <double poison, double 1.000000e+00>, double %.sroa.speculated.i, i64 0
  %i.ay = fsub <2 x double> %i.x, %i.ax           ; 2 uses
  %i.az = fdiv <2 x double> %i.ay, %i.x
  %i.ba = fneg <2 x double> %i.ay
  %i.bb = shufflevector <2 x double> %13, <2 x double> poison, <2 x i32> zeroinitializer
  %19 = shufflevector <2 x double> %13, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.bc = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ba, <2 x double> %i.bb, <2 x double> %19)
  %i.bd = fmul <2 x double> %i.az, %i.bc          ; 2 uses
  %i.be = extractelement <2 x double> %i.bd, i64 0 ; 2 uses
  %i.bf = extractelement <2 x double> %i.bd, i64 1 ; 2 uses
  %i.bg = fcmp olt double %i.be, %i.bf
  %.sroa.speculated4.i = select i1 %i.bg, double %i.be, double %i.bf
  %i.bh = fdiv double %.sroa.speculated4.i, %15
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.bi, ptr noundef nonnull align 8 dereferenceable(32) %7, i64 32, i1 false), !tbaa.struct !48
  %i.bj = getelementptr inbounds nuw i8, ptr %0, i64 64
  store double %i.bh, ptr %i.bj, align 8, !tbaa !31
