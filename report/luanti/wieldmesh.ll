...
_ZN4core5arrayINS_8vector3dIfEEE8set_usedEj.exit: ; preds = %bb.b, %bb.c, %bb.d, %_ZSt8_DestroyIPN4core8vector3dIfEES2_EvT_S4_RSaIT0_E.exit.i.i.i
  ...
  %i.cc = load ptr, ptr %1, align 8, !tbaa !291   ; 2 uses
  %i.cd = getelementptr inbounds nuw i8, ptr %i.cc, i64 12 ; 3 uses
  %i.ce = getelementptr inbounds nuw i8, ptr %i.cc, i64 20
  %2 = load <3 x float>, ptr %i.cd, align 4, !tbaa !88 ; 5 uses
  %i.cf = load float, ptr %i.cd, align 4, !tbaa !194
  ...
  %i.cx = load ptr, ptr %1, align 8, !tbaa !291   ; 2 uses
  %i.cy = getelementptr inbounds nuw i8, ptr %i.cx, i64 24 ; 3 uses
  %i.cz = getelementptr inbounds nuw i8, ptr %i.cx, i64 32
  %7 = load <3 x float>, ptr %i.cy, align 4, !tbaa !88 ; 5 uses
  %i.da = load float, ptr %i.cy, align 4, !tbaa !194
  ...
  %i.ds = load ptr, ptr %1, align 8, !tbaa !291   ; 2 uses
  %i.dt = getelementptr inbounds nuw i8, ptr %i.ds, i64 36 ; 3 uses
  %i.du = getelementptr inbounds nuw i8, ptr %i.ds, i64 44
  %12 = load <3 x float>, ptr %i.dt, align 4, !tbaa !88 ; 5 uses
  %i.dv = load float, ptr %i.dt, align 4, !tbaa !194
  ...
  %i.en = load ptr, ptr %1, align 8, !tbaa !291   ; 2 uses
  %i.eo = getelementptr inbounds nuw i8, ptr %i.en, i64 48 ; 3 uses
  %i.ep = getelementptr inbounds nuw i8, ptr %i.en, i64 56
  %17 = load <3 x float>, ptr %i.eo, align 4, !tbaa !88 ; 5 uses
  %i.eq = load float, ptr %i.eo, align 4, !tbaa !194
  ...
  %i.fi = load ptr, ptr %1, align 8, !tbaa !291   ; 2 uses
  %i.fj = getelementptr inbounds nuw i8, ptr %i.fi, i64 60 ; 3 uses
  %i.fk = getelementptr inbounds nuw i8, ptr %i.fi, i64 68
  %22 = load <3 x float>, ptr %i.fj, align 4, !tbaa !88 ; 5 uses
  %i.fl = load float, ptr %i.fj, align 4, !tbaa !194
  ...
  %i.gd = load ptr, ptr %1, align 8, !tbaa !291   ; 2 uses
  %i.ge = getelementptr inbounds nuw i8, ptr %i.gd, i64 72 ; 3 uses
  %i.gf = getelementptr inbounds nuw i8, ptr %i.gd, i64 80
  %27 = load <3 x float>, ptr %i.ge, align 4, !tbaa !88 ; 5 uses
  %i.gg = load float, ptr %i.ge, align 4, !tbaa !194
  ...
  %i.gy = load ptr, ptr %1, align 8, !tbaa !291   ; 2 uses
  %i.gz = getelementptr inbounds nuw i8, ptr %i.gy, i64 84 ; 3 uses
  %i.ha = getelementptr inbounds nuw i8, ptr %i.gy, i64 92
  %32 = load <3 x float>, ptr %i.gz, align 4, !tbaa !88 ; 5 uses
  %i.hb = load float, ptr %i.gz, align 4, !tbaa !194
