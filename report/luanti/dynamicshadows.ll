...
bb.a:
  ...
  %3 = load <4 x float>, ptr %i.an, align 4
  %i.ao = getelementptr inbounds nuw i8, ptr %2, i64 36
  %4 = load <4 x float>, ptr %i.ao, align 4
  %i.ap = getelementptr inbounds nuw i8, ptr %2, i64 40
  %5 = load <4 x float>, ptr %i.ap, align 4
  %i.aq = getelementptr inbounds nuw i8, ptr %2, i64 44
  %6 = load <4 x float>, ptr %i.aq, align 4
  %i.ar = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.as = shufflevector <4 x float> %4, <4 x float> poison, <4 x i32> zeroinitializer
  %i.at = fmul nsz <4 x float> %i.l, %i.as
  %i.au = shufflevector <4 x float> %3, <4 x float> poison, <4 x i32> zeroinitializer
  %i.av = tail call nsz <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.k, <4 x float> %i.au, <4 x float> %i.at)
  %i.aw = shufflevector <4 x float> %5, <4 x float> poison, <4 x i32> zeroinitializer
  %i.ax = tail call nsz <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.q, <4 x float> %i.aw, <4 x float> %i.av)
  %i.ay = shufflevector <4 x float> %6, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %7 = load <4 x float>, ptr %i.ba, align 4
  ...
  %i.bl = shufflevector <4 x float> %7, <4 x float> poison, <4 x i32> zeroinitializer
