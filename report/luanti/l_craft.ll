...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2ERKS4_.exit: ; preds = %._crit_edge.i.i, %bb.b, %bb.c
  ...
  %i.r = load ptr, ptr %i.q, align 8, !tbaa !239  ; 2 uses
...
.noexc4:                                          ; preds = %_ZNSt15__new_allocatorISt4pairIifEE8allocateEmPKv.exit.i.i.i.i.i, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2ERKS4_.exit
  ...
  store ptr %i.y, ptr %i.z, align 8, !tbaa !239
  %i.aa = getelementptr inbounds nuw i8, ptr %i.y, i64 %i.v
  %i.ab = getelementptr inbounds nuw i8, ptr %0, i64 48
  store ptr %i.aa, ptr %i.ab, align 8, !tbaa !114
  %i.ac = load ptr, ptr %i.p, align 8, !tbaa !240 ; 5 uses
  %i.ad = load ptr, ptr %i.q, align 8, !tbaa !240 ; 3 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %16, label %middle.block, label %vector.body, !llvm.loop !237
...
.lr.ph.i.i.i.i.i.i:                               ; preds = %.lr.ph.i.i.i.i.i.i.preheader12, %.lr.ph.i.i.i.i.i.i
  ...
  br i1 %.not.i.i.i.i.i.i, label %.loopexit, label %.lr.ph.i.i.i.i.i.i, !llvm.loop !238
...
.loopexit:                                        ; preds = %.lr.ph.i.i.i.i.i.i, %middle.block, %.noexc4
  ...
  store ptr %.0.lcssa.i.i.i.i.i.i, ptr %i.z, align 8, !tbaa !239
...
bb.a:
  ...
  %i.b = load ptr, ptr %3, align 8, !tbaa !245, !nonnull !49, !align !50
...
.lr.ph:                                           ; preds = %bb.e, %bb.l
  ...
  %i.l = load ptr, ptr %3, align 8, !tbaa !245, !nonnull !49, !align !50
...
bb.f:                                             ; preds = %bb.c, %bb.b, %._crit_edge.i.i.i
  ...
  %i.v = load i16, ptr %i.u, align 8, !tbaa !247
  store i16 %i.v, ptr %i.t, align 8, !tbaa !247
  ret void
...
bb.l:                                             ; preds = %bb.h, %bb.f
  ...
  %.030 = load ptr, ptr %.030.in, align 8, !tbaa !110 ; 2 uses
  %.not32 = icmp eq ptr %.030, null
  br i1 %.not32, label %._crit_edge, label %.lr.ph, !llvm.loop !248
...
!235 = !{!124, !124, i64 0}
!236 = distinct !{!236, !31}
!237 = distinct !{!237, !31, !241, !242}
!238 = distinct !{!238, !31, !241}
!239 = !{!112, !111, i64 8}
!240 = !{!111, !111, i64 0}
!241 = !{!"llvm.loop.isvectorized", i32 1}
!242 = !{!"llvm.loop.unroll.runtime.disable"}
!243 = distinct !{!243, !31}
!244 = !{!"_ZTSNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_sESt10_Select1stIS8_ESt4lessIS5_ESaIS8_EE11_Alloc_nodeE", !124, i64 0}
!245 = !{!244, !124, i64 0}
!246 = !{!"_ZTSSt4pairIKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEsE", !27, i64 0, !68, i64 32}
!247 = !{!246, !68, i64 32}
!248 = distinct !{!248, !31}
end_hunk_1
