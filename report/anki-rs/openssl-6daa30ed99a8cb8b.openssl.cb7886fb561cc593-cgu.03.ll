...
bb.a:
  ...
  %i.f = load i64, ptr %i.e, align 8, !range !4, !alias.scope !13, !noalias !14, !noundef !3
  %.not.i31 = icmp eq i64 %i.f, -9223372036854775808
  br i1 %.not.i31, label %"_ZN4core6result19Result$LT$T$C$E$GT$6unwrap17h5dba90d1d1ee9d75E.exit32", label %bb.b, !prof !15

bb.b:                                             ; preds = %bb.a
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.a, ptr noundef nonnull readonly align 8 dereferenceable(32) %i.e, i64 32, i1 false), !noalias !14
  invoke void @_ZN4core6result13unwrap_failed17h8e46864fd8bf13c6E(ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) @1, i64 noundef 43, ptr noundef nonnull align 1 %i.a, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) @0, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @10) #13
          to label %bb.d unwind label %bb.c, !noalias !13
...
bb.c:                                             ; preds = %bb.b
  ...
  invoke void @"_ZN4core3ptr48drop_in_place$LT$alloc..ffi..c_str..NulError$GT$17h50697b76f8ac5c34E"(ptr noalias noundef nonnull align 8 dereferenceable(32) %i.a) #14
          to label %common.resume unwind label %bb.e, !noalias !13
...
"_ZN4core6result19Result$LT$T$C$E$GT$6unwrap17h5dba90d1d1ee9d75E.exit32": ; preds = %bb.a
  ...
  %i.j = load ptr, ptr %i.i, align 8, !alias.scope !13, !noalias !14, !nonnull !3, !align !5, !noundef !3 ; 6 uses
  %i.k = getelementptr inbounds nuw i8, ptr %i.e, i64 16
  %i.l = load i64, ptr %i.k, align 8, !alias.scope !13, !noalias !14, !noundef !3 ; 5 uses
...
bb.i:                                             ; preds = %bb.f
  ...
  %i.o = load i64, ptr %i.d, align 8, !range !4, !alias.scope !17, !noalias !18, !noundef !3
  %.not.i = icmp eq i64 %i.o, -9223372036854775808
  br i1 %.not.i, label %.cont, label %bb.j, !prof !15

bb.j:                                             ; preds = %bb.i
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !19
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.b, ptr noundef nonnull readonly align 8 dereferenceable(32) %i.d, i64 32, i1 false), !noalias !18
  invoke void @_ZN4core6result13unwrap_failed17h8e46864fd8bf13c6E(ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) @1, i64 noundef 43, ptr noundef nonnull align 1 %i.b, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) @0, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @11) #13
          to label %bb.l unwind label %bb.k, !noalias !17
...
bb.k:                                             ; preds = %bb.j
  ...
  invoke void @"_ZN4core3ptr48drop_in_place$LT$alloc..ffi..c_str..NulError$GT$17h50697b76f8ac5c34E"(ptr noalias noundef nonnull align 8 dereferenceable(32) %i.b) #14
          to label %.body unwind label %bb.m, !noalias !17
...
bb.m:                                             ; preds = %bb.k
  %i.q = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_ZN4core9panicking16panic_in_cleanup17h6ca8ea5ab49097b2E() #11, !noalias !17
  unreachable
...
.cont:                                            ; preds = %bb.i
  ...
  %i.u = load ptr, ptr %i.t, align 8, !alias.scope !17, !noalias !18, !nonnull !3, !align !5, !noundef !3
  %i.v = getelementptr inbounds nuw i8, ptr %i.d, i64 16
  %i.w = load i64, ptr %i.v, align 8, !alias.scope !17, !noalias !18, !noundef !3
