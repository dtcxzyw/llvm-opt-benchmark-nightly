...
.lr.ph.i.i4:                                      ; preds = %bb.t, %_ZN3std4sync4mpmc5utils7Backoff10spin_heavy17h4febe83a2b9b9332E.exit.i.i6
  %.sroa.0.02.i.i5 = phi i32 [ %i.bo, %_ZN3std4sync4mpmc5utils7Backoff10spin_heavy17h4febe83a2b9b9332E.exit.i.i6 ], [ 0, %bb.t ] ; 6 uses
...
.lr.ph.i.i.i8.preheader:                          ; preds = %bb.v
  %i.bm = mul nuw i32 %.sroa.0.02.i.i5, %.sroa.0.02.i.i5 ; 2 uses
  %xtraiter111 = and i32 %i.bm, 7                 ; 3 uses
  %i.bn = icmp ult i32 %.sroa.0.02.i.i5, 3
  br i1 %i.bn, label %.lr.ph.i.i.i8.epil.preheader, label %.lr.ph.i.i.i8.preheader.new
...
.lr.ph.i.i.i8.epil:                               ; preds = %.lr.ph.i.i.i8.epil, %.lr.ph.i.i.i8.epil.preheader
  ...
  br i1 %epil.iter112.cmp.not, label %_ZN3std4sync4mpmc5utils7Backoff10spin_heavy17h4febe83a2b9b9332E.exit.i.i6, label %.lr.ph.i.i.i8.epil, !llvm.loop !4950
...
_ZN3std4sync4mpmc5utils7Backoff10spin_heavy17h4febe83a2b9b9332E.exit.i.i6: ; preds = %_ZN3std4sync4mpmc5utils7Backoff10spin_heavy17h4febe83a2b9b9332E.exit.i.i6.loopexit.unr-lcssa, %.lr.ph.i.i.i8.epil, %bb.v, %bb.u
  %i.bo = add i32 %.sroa.0.02.i.i5, 1
  %i.bp = load atomic i64, ptr %i.bh acquire, align 8, !noalias !4947
  %i.bq = and i64 %i.bp, 1
...
.lr.ph.i.i.preheader:                             ; preds = %bb.d
  %i.s = mul nuw i32 %.sroa.0.080.i90, %.sroa.0.080.i90 ; 2 uses
  %xtraiter = and i32 %i.s, 7                     ; 3 uses
  %i.t = icmp ult i32 %.sroa.0.080.i90, 3
  br i1 %i.t, label %.lr.ph.i.i.epil.preheader, label %.lr.ph.i.i.preheader.new

.lr.ph.i.i.preheader.new:                         ; preds = %.lr.ph.i.i.preheader
  %unroll_iter = and i32 %i.s, 56
  br label %.lr.ph.i.i
...
"_ZN4core3ptr211drop_in_place$LT$core..option..Option$LT$alloc..boxed..Box$LT$std..sync..mpmc..list..Block$LT$$LP$usize$C$core..result..Result$LT$fsrs..inference..SplitEvaluation$C$fsrs..error..FSRSError$GT$$RP$$GT$$GT$$GT$$GT$17h5909951d5852c9dcE.exit.i": ; preds = %bb.e, %._crit_edge
  %.sroa.044.1.i = phi ptr [ %.sroa.044.0.ph84.i, %._crit_edge ], [ %i.v, %bb.e ] ; 9 uses
  %i.u = icmp eq ptr %.sroa.07.081.i.lcssa, null
...
bb.f:                                             ; preds = %"_ZN4core3ptr211drop_in_place$LT$core..option..Option$LT$alloc..boxed..Box$LT$std..sync..mpmc..list..Block$LT$$LP$usize$C$core..result..Result$LT$fsrs..inference..SplitEvaluation$C$fsrs..error..FSRSError$GT$$RP$$GT$$GT$$GT$$GT$17h5909951d5852c9dcE.exit.i"
  %i.w = invoke noundef nonnull align 8 ptr @"_ZN5alloc5boxed16Box$LT$T$C$A$GT$13new_zeroed_in17h555a8c133f98e836E"()
          to label %bb.g unwind label %.loopexit.split-lp.i, !noalias !5056 ; 5 uses

bb.g:                                             ; preds = %bb.f
  %i.x = cmpxchg ptr %i.f, ptr null, ptr %i.w release monotonic, align 8, !noalias !5056
  %i.y = extractvalue { ptr, i1 } %i.x, 1
  br i1 %i.y, label %bb.h, label %bb.i

bb.h:                                             ; preds = %bb.g
  store atomic ptr %i.w, ptr %i.j release, align 8, !noalias !5056
  br label %bb.k

bb.i:                                             ; preds = %bb.g
  %i.z = icmp eq ptr %.sroa.044.1.i, null
  br i1 %i.z, label %.outer.backedge.i, label %bb.j
...
bb.k:                                             ; preds = %bb.h, %"_ZN4core3ptr211drop_in_place$LT$core..option..Option$LT$alloc..boxed..Box$LT$std..sync..mpmc..list..Block$LT$$LP$usize$C$core..result..Result$LT$fsrs..inference..SplitEvaluation$C$fsrs..error..FSRSError$GT$$RP$$GT$$GT$$GT$$GT$17h5909951d5852c9dcE.exit.i"
  %.sroa.07.1.i = phi ptr [ %.sroa.07.081.i.lcssa, %"_ZN4core3ptr211drop_in_place$LT$core..option..Option$LT$alloc..boxed..Box$LT$std..sync..mpmc..list..Block$LT$$LP$usize$C$core..result..Result$LT$fsrs..inference..SplitEvaluation$C$fsrs..error..FSRSError$GT$$RP$$GT$$GT$$GT$$GT$17h5909951d5852c9dcE.exit.i" ], [ %i.w, %bb.h ] ; 3 uses
  %i.aa = add i64 %.sroa.03.082.i.lcssa, 2
  %i.ab = cmpxchg weak ptr %i.d, i64 %.sroa.03.082.i.lcssa, i64 %i.aa seq_cst acquire, align 8, !noalias !5056
...
.outer.backedge.i:                                ; preds = %._crit_edge.loopexit.i.i, %bb.l, %bb.j, %bb.i
  %.sroa.044.0.ph.be.i = phi ptr [ %i.w, %bb.j ], [ %i.w, %bb.i ], [ %.sroa.044.1.i, %bb.l ], [ %.sroa.044.1.i, %._crit_edge.loopexit.i.i ] ; 2 uses
...
"_ZN3std4sync4mpmc4list16Channel$LT$T$GT$10start_send17h6eae73d9ce66a9ebE.exit": ; preds = %bb.q, %.critedge.i
  ...
  %i.aq = icmp eq ptr %.sroa.412.0, null
  br i1 %i.aq, label %"_ZN3std4sync4mpmc4list16Channel$LT$T$GT$5write17hab99178823f17639E.exit", label %bb.r
...
bb.r:                                             ; preds = %"_ZN3std4sync4mpmc4list16Channel$LT$T$GT$10start_send17h6eae73d9ce66a9ebE.exit.thread49", %"_ZN3std4sync4mpmc4list16Channel$LT$T$GT$10start_send17h6eae73d9ce66a9ebE.exit"
  ...
  %i.ar = getelementptr inbounds nuw i8, ptr %.sroa.412.157, i64 8
  %i.as = icmp samesign ult i64 %.sroa.9.156, 31
  tail call void @llvm.assume(i1 %i.as)
  %i.at = getelementptr inbounds nuw [136 x i8], ptr %i.ar, i64 %.sroa.9.156 ; 4 uses
  store i64 %.sroa.019.0.copyload58, ptr %i.at, align 8, !noalias !5061
  %.sroa.5.0..sroa_idx21 = getelementptr inbounds nuw i8, ptr %i.at, i64 8
  store i64 %.sroa.5.0.copyload59, ptr %.sroa.5.0..sroa_idx21, align 8, !noalias !5061
  %.sroa.623.0..sroa_idx24 = getelementptr inbounds nuw i8, ptr %i.at, i64 16
  ...
  %i.av = atomicrmw or ptr %i.au, i64 1 release, align 8, !noalias !5066 ; 0 uses
  %i.aw = getelementptr inbounds nuw i8, ptr %1, i64 312 ; 3 uses
  %i.ax = load atomic i8, ptr %i.aw seq_cst, align 8, !noalias !5066
  %i.ay = icmp eq i8 %i.ax, 0
  br i1 %i.ay, label %.noexc6, label %"_ZN3std4sync4mpmc4list16Channel$LT$T$GT$5write17hab99178823f17639E.exit.thread"

.noexc6:                                          ; preds = %bb.r
  %i.az = getelementptr inbounds nuw i8, ptr %1, i64 256
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c), !noalias !5066
  call void @"_ZN3std4sync6poison5mutex14Mutex$LT$T$GT$4lock17h0a39386b69d7fcf9E"(ptr noalias noundef nonnull sret([24 x i8]) align 8 captures(address) dereferenceable(24) %i.c, ptr noundef nonnull align 8 %i.az)
  call void @llvm.experimental.noalias.scope.decl(metadata !5067)
  %i.ba = load i64, ptr %i.c, align 8, !range !31, !alias.scope !5067, !noalias !5070, !noundef !13
  %i.bb = trunc nuw i64 %i.ba to i1
  br i1 %i.bb, label %bb.s, label %bb.x, !prof !33

bb.s:                                             ; preds = %.noexc6
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !5072
  %i.bc = getelementptr inbounds nuw i8, ptr %i.c, i64 8
  %i.bd = load ptr, ptr %i.bc, align 8, !alias.scope !5067, !noalias !5070, !nonnull !13, !align !82, !noundef !13
  %i.be = getelementptr inbounds nuw i8, ptr %i.c, i64 16
  %i.bf = load i8, ptr %i.be, align 8, !range !83, !alias.scope !5067, !noalias !5070, !noundef !13
  store ptr %i.bd, ptr %i.a, align 8, !noalias !5072
  %i.bg = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  store i8 %i.bf, ptr %i.bg, align 8, !noalias !5072
