...
.lr.ph.i:                                         ; preds = %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$16with_capacity_in17h48f6be3e9b76576cE.exit.i", %bb.d
  ...
  %.sroa.10.021.i = phi i64 [ %i.t, %bb.d ], [ %i.k, %"_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$16with_capacity_in17h48f6be3e9b76576cE.exit.i" ]
...
"_ZN67_$LT$ninja_gen..input..BuildInput$u20$as$u20$core..clone..Clone$GT$5clone17h9bf5381cb27e8ed8E.exit": ; preds = %.noexc3, %"_ZN61_$LT$ninja_gen..input..Glob$u20$as$u20$core..clone..Clone$GT$5clone17h93fc481102d37dbaE.exit.i", %.noexc1, %.noexc, %bb.d
  %.sroa.8.sroa.7.0 = phi i64 [ %.sroa.8.sroa.7.0.copyload21, %.noexc ], [ %.sroa.8.sroa.7.0.copyload19, %.noexc1 ], [ %.sroa.0.0.i.i, %"_ZN61_$LT$ninja_gen..input..Glob$u20$as$u20$core..clone..Clone$GT$5clone17h93fc481102d37dbaE.exit.i" ], [ %.sroa.8.sroa.7.0.copyload, %.noexc3 ], [ undef, %bb.d ]
  %.sroa.05.0 = phi i64 [ -9223372036854775808, %.noexc ], [ -9223372036854775807, %.noexc1 ], [ %.sroa.015.0.copyload, %"_ZN61_$LT$ninja_gen..input..Glob$u20$as$u20$core..clone..Clone$GT$5clone17h93fc481102d37dbaE.exit.i" ], [ -9223372036854775805, %.noexc3 ], [ -9223372036854775804, %bb.d ]
  %i.an = getelementptr inbounds nuw [48 x i8], ptr %i.r, i64 %.sroa.7.036 ; 4 uses
  store i64 %.sroa.05.0, ptr %i.an, align 8, !noalias !553
  ...
  store i64 %.sroa.8.sroa.7.0, ptr %.sroa.413.sroa.4.0..sroa.413.0..sroa_idx.sroa_idx, align 8, !noalias !553
