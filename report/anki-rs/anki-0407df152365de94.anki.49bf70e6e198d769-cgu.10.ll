...
bb.mq:                                            ; preds = %bb.mp
  ...
  %i.acd = trunc nuw i8 %.sroa.10606.0.copyload.i to i1
  %3 = trunc nuw i8 %i.acc to i1
  %.sroa.01.0.i.i = select i1 %3, i8 %.sroa.10606.0.copyload.i, i8 1
  %.sroa.02.0.i.i = select i1 %i.acd, i8 %i.acc, i8 1
