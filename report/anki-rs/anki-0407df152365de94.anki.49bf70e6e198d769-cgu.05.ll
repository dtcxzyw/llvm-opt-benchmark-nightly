...
bb.a:
  ...
  %i.c = load i64, ptr %i.a, align 8, !range !34, !noundef !10
...
bb.b:                                             ; preds = %bb.a
  %i.d = load i64, ptr %i.b, align 8, !range !54, !noundef !10 ; 6 uses
...
bb.c:                                             ; preds = %bb.a
  %i.i = load i64, ptr %i.b, align 8, !range !54, !noundef !10 ; 2 uses
...
bb.d:                                             ; preds = %bb.b
  ...
  %i.m = load i8, ptr %i.l, align 1, !range !27, !noundef !10
...
bb.f:                                             ; preds = %bb.d
  tail call void @llvm.experimental.noalias.scope.decl(metadata !8320)
  %i.o = getelementptr inbounds nuw i8, ptr %0, i64 280 ; 2 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !8321)
  %i.p = load i8, ptr %i.o, align 8, !range !53, !alias.scope !8322, !noundef !10 ; 2 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  %.val1.i.i.i.i = load i64, ptr %i.r, align 8, !alias.scope !8325, !noundef !10 ; 2 uses
...
"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h97e088f20b840830E.exit.i.i.i.i.i.i.i": ; preds = %bb.h
  ...
  %.val.i.i.i.i = load ptr, ptr %i.t, align 8, !alias.scope !8325, !nonnull !10, !noundef !10
  tail call void @_RNvCsiGVaDesi5rv_7___rustc14___rust_dealloc(ptr noundef nonnull %.val.i.i.i.i, i64 noundef %.val1.i.i.i.i, i64 noundef 1) #53, !noalias !8325
...
"_ZN4core3ptr52drop_in_place$LT$hyper..proto..h1..conn..Reading$GT$17ha8d1ddc3836f2c47E.exit.i": ; preds = %bb.f, %bb.g, %bb.h, %"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h97e088f20b840830E.exit.i.i.i.i.i.i.i"
  store i8 11, ptr %i.o, align 8, !alias.scope !8320
  store i8 0, ptr %i.l, align 1, !alias.scope !8320
  store i64 0, ptr %i.a, align 8, !alias.scope !8320
...
"_ZN4core3ptr52drop_in_place$LT$hyper..proto..h1..conn..Writing$GT$17h6e5198c414679bceE.exit.i": ; preds = %"_ZN4core3ptr76drop_in_place$LT$alloc..vec..Vec$LT$http..header..value..HeaderValue$GT$$GT$17hc3860b50130f3af5E.exit.i.i.i.i.i", %bb.i, %"_ZN4core3ptr52drop_in_place$LT$hyper..proto..h1..conn..Reading$GT$17ha8d1ddc3836f2c47E.exit.i"
  store i64 -9223372036854775805, ptr %i.b, align 8, !alias.scope !8320
  %i.ac = getelementptr inbounds nuw i8, ptr %0, i64 272
  %i.ad = load i32, ptr %i.ac, align 8, !range !39, !alias.scope !8320, !noundef !10
...
bb.n:                                             ; preds = %"_ZN4core3ptr52drop_in_place$LT$hyper..proto..h1..conn..Writing$GT$17h6e5198c414679bceE.exit.i"
  ...
  store i8 1, ptr %i.ae, align 1, !alias.scope !8320
  br label %_ZN5hyper5proto2h14conn5State4idle17h01c817db43b07d28E.exit
...
bb.a:
  ...
  %i.h = load i64, ptr %i.g, align 8, !range !12, !noundef !10
  %i.i = trunc nuw i64 %i.h to i1                 ; 2 uses
  br i1 %i.i, label %bb.b, label %bb.c

bb.b:                                             ; preds = %bb.a
  %2 = getelementptr inbounds nuw i8, ptr %i.g, i64 8
  %3 = load ptr, ptr %2, align 8, !noundef !10    ; 3 uses
  %i.j = getelementptr inbounds nuw i8, ptr %i.g, i64 24
  %4 = load i64, ptr %i.j, align 8, !noundef !10  ; 6 uses
  %5 = icmp eq i64 %4, 0
...
.lr.ph.preheader:                                 ; preds = %bb.b
  ...
  %.val.i58 = load i64, ptr %i.l, align 8, !noalias !8340, !noundef !10 ; 3 uses
...
.lr.ph:                                           ; preds = %.lr.ph.ithread-pre-split
  ...
  %.val.i = load i64, ptr %i.t, align 8, !noalias !8340, !noundef !10 ; 2 uses
...
bb.c:                                             ; preds = %bb.a
  ...
  %7 = load i64, ptr %6, align 8, !noundef !10    ; 3 uses
...
.body:                                            ; preds = %_ZN4core4iter6traits8iterator8Iterator4fold17h4e8d0663f1a53e8eE.exit, %_ZN4core4iter6traits8iterator8Iterator8for_each17hf8ca08a699e96b55E.exit.i, %bb.p
  ...
  %i.z = landingpad { ptr, i32 }
          cleanup                                 ; 4 uses
  %i.aa = load i64, ptr %i.g, align 8, !range !12, !noundef !10
  %i.ab = icmp eq i64 %i.aa, 0
  br i1 %i.ab, label %bb.s, label %bb.t

.body.thread44:                                   ; preds = %.body14
  %i.ac = load i64, ptr %i.g, align 8, !range !12, !noundef !10
...
.body.thread:                                     ; preds = %bb.g
  %i.ae = load i64, ptr %i.g, align 8, !range !12, !noundef !10
...
bb.f:                                             ; preds = %bb.d
  ...
  %.sroa.2.0.copyload = load ptr, ptr %.sroa.2.0..sroa_idx, align 8, !nonnull !10, !noundef !10 ; 3 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !8341)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d), !noalias !8342
  ...
  store ptr %.sroa.2.0.copyload, ptr %i.d, align 8, !alias.scope !8343, !noalias !8344
  %i.an = getelementptr inbounds nuw i8, ptr %i.d, i64 16
  store i64 %.sroa.0.0.copyload, ptr %i.an, align 8, !alias.scope !8343, !noalias !8344
  %i.ao = getelementptr inbounds nuw i8, ptr %i.d, i64 8
  store ptr %.sroa.2.0.copyload, ptr %i.ao, align 8, !alias.scope !8343, !noalias !8344
  %i.ap = getelementptr inbounds nuw i8, ptr %i.d, i64 24
  store ptr %i.am, ptr %i.ap, align 8, !alias.scope !8343, !noalias !8344
  %i.aq = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.ar = load i64, ptr %i.aq, align 8, !alias.scope !8341, !noalias !8345, !noundef !10
  ...
  invoke void @"_ZN9hashbrown3raw21RawTable$LT$T$C$A$GT$7reserve17h699198c29dd302d4E"(ptr noalias noundef nonnull align 8 dereferenceable(48) %0, i64 noundef %.sroa.0.0.i, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %i.y)
          to label %_ZN4core4iter6traits8iterator8Iterator8for_each17hf8ca08a699e96b55E.exit.i unwind label %bb.g, !noalias !8345

_ZN4core4iter6traits8iterator8Iterator8for_each17hf8ca08a699e96b55E.exit.i: ; preds = %bb.f
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c), !noalias !8342
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.c, ptr noundef nonnull align 8 dereferenceable(32) %i.d, i64 32, i1 false), !noalias !8342
...
bb.g:                                             ; preds = %bb.f
  ...
  invoke void @"_ZN86_$LT$alloc..vec..into_iter..IntoIter$LT$T$C$A$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17ha636508962d6e0faE"(ptr noalias noundef nonnull align 8 dereferenceable(32) %i.d)
          to label %.body.thread unwind label %bb.h, !noalias !8345

bb.h:                                             ; preds = %bb.g
  %i.aw = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_ZN4core9panicking16panic_in_cleanup17h6ca8ea5ab49097b2E() #51, !noalias !8345
  unreachable
...
"_ZN121_$LT$hashbrown..map..HashMap$LT$K$C$V$C$S$C$A$GT$$u20$as$u20$core..iter..traits..collect..Extend$LT$$LP$K$C$V$RP$$GT$$GT$6extend17hc3a018aacbc5934aE.exit": ; preds = %_ZN4core4iter6traits8iterator8Iterator8for_each17hf8ca08a699e96b55E.exit.i
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c), !noalias !8342
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d), !noalias !8342
  br label %bb.i
...
bb.l:                                             ; preds = %bb.j
  %i.ay = load i64, ptr %i.e, align 8, !range !24, !noundef !10 ; 2 uses
  %.not = icmp eq i64 %i.ay, -9223372036854775808
  br i1 %.not, label %bb.p, label %bb.m

bb.m:                                             ; preds = %bb.l
  %.sroa.219.0.copyload = load ptr, ptr %.sroa.219.0..sroa_idx, align 8, !nonnull !10, !noundef !10 ; 3 uses
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !8347
  ...
  store ptr %.sroa.219.0.copyload, ptr %i.b, align 8, !alias.scope !8348, !noalias !8349
  store i64 %i.ay, ptr %i.ah, align 8, !alias.scope !8348, !noalias !8349
  store ptr %.sroa.219.0.copyload, ptr %i.ai, align 8, !alias.scope !8348, !noalias !8349
  store ptr %i.ba, ptr %i.aj, align 8, !alias.scope !8348, !noalias !8349
  %i.bb = load i64, ptr %i.ak, align 8, !alias.scope !8346, !noalias !8350, !noundef !10
  ...
  invoke void @"_ZN9hashbrown3raw21RawTable$LT$T$C$A$GT$7reserve17h699198c29dd302d4E"(ptr noalias noundef nonnull align 8 dereferenceable(48) %0, i64 noundef %.sroa.0.0.i11, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %i.y)
          to label %_ZN4core4iter6traits8iterator8Iterator8for_each17hf8ca08a699e96b55E.exit.i13 unwind label %bb.n, !noalias !8350

_ZN4core4iter6traits8iterator8Iterator8for_each17hf8ca08a699e96b55E.exit.i13: ; preds = %bb.m
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !8347
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.a, ptr noundef nonnull align 8 dereferenceable(32) %i.b, i64 32, i1 false), !noalias !8347
...
bb.n:                                             ; preds = %bb.m
  ...
  invoke void @"_ZN86_$LT$alloc..vec..into_iter..IntoIter$LT$T$C$A$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17ha636508962d6e0faE"(ptr noalias noundef nonnull align 8 dereferenceable(32) %i.b)
          to label %.body14 unwind label %bb.o, !noalias !8350

bb.o:                                             ; preds = %bb.n
  %i.bg = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_ZN4core9panicking16panic_in_cleanup17h6ca8ea5ab49097b2E() #51, !noalias !8350
  unreachable
...
bb.q:                                             ; preds = %_ZN4core4iter6traits8iterator8Iterator8for_each17hf8ca08a699e96b55E.exit.i13
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !8347
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !8347
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e)
  br label %bb.j
...
.lr.ph.preheader:                                 ; preds = %bb.b
  %i.k = add i64 %4, -1                           ; 2 uses
  %i.l = getelementptr i8, ptr %3, i64 16
  %.val.i58 = load i64, ptr %i.l, align 8, !noalias !8365, !noundef !10 ; 3 uses
...
.lr.ph:                                           ; preds = %.lr.ph.ithread-pre-split
  %i.s = add i64 %i.p, -1                         ; 2 uses
  %i.t = getelementptr i8, ptr %.pr, i64 16
  %.val.i = load i64, ptr %i.t, align 8, !noalias !8365, !noundef !10 ; 2 uses
...
bb.f:                                             ; preds = %bb.d
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d), !noalias !8367
  ...
  store ptr %.sroa.2.0.copyload, ptr %i.d, align 8, !alias.scope !8368, !noalias !8369
  %i.an = getelementptr inbounds nuw i8, ptr %i.d, i64 16
  store i64 %.sroa.0.0.copyload, ptr %i.an, align 8, !alias.scope !8368, !noalias !8369
  %i.ao = getelementptr inbounds nuw i8, ptr %i.d, i64 8
  store ptr %.sroa.2.0.copyload, ptr %i.ao, align 8, !alias.scope !8368, !noalias !8369
  %i.ap = getelementptr inbounds nuw i8, ptr %i.d, i64 24
  store ptr %i.am, ptr %i.ap, align 8, !alias.scope !8368, !noalias !8369
  %i.aq = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.ar = load i64, ptr %i.aq, align 8, !alias.scope !8366, !noalias !8370, !noundef !10
  %i.as = icmp eq i64 %i.ar, 0
  %i.at = add nuw nsw i64 %.sroa.3.0.copyload, 1
  %i.au = lshr i64 %i.at, 1
  %.sroa.0.0.i = select i1 %i.as, i64 %.sroa.3.0.copyload, i64 %i.au
  invoke void @"_ZN9hashbrown3raw21RawTable$LT$T$C$A$GT$7reserve17h977154c32f1aafb7E"(ptr noalias noundef nonnull align 8 dereferenceable(48) %0, i64 noundef %.sroa.0.0.i, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %i.y)
          to label %_ZN4core4iter6traits8iterator8Iterator8for_each17h2196a003c3f0708fE.exit.i unwind label %bb.g, !noalias !8370

_ZN4core4iter6traits8iterator8Iterator8for_each17h2196a003c3f0708fE.exit.i: ; preds = %bb.f
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c), !noalias !8367
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.c, ptr noundef nonnull align 8 dereferenceable(32) %i.d, i64 32, i1 false), !noalias !8367
...
bb.g:                                             ; preds = %bb.f
  ...
  invoke void @"_ZN86_$LT$alloc..vec..into_iter..IntoIter$LT$T$C$A$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17hd4d0f3c4f41292a2E"(ptr noalias noundef nonnull align 8 dereferenceable(32) %i.d)
          to label %.body.thread unwind label %bb.h, !noalias !8370

bb.h:                                             ; preds = %bb.g
  %i.aw = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_ZN4core9panicking16panic_in_cleanup17h6ca8ea5ab49097b2E() #51, !noalias !8370
  unreachable
...
"_ZN121_$LT$hashbrown..map..HashMap$LT$K$C$V$C$S$C$A$GT$$u20$as$u20$core..iter..traits..collect..Extend$LT$$LP$K$C$V$RP$$GT$$GT$6extend17h8df85f740c388459E.exit": ; preds = %_ZN4core4iter6traits8iterator8Iterator8for_each17h2196a003c3f0708fE.exit.i
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c), !noalias !8367
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d), !noalias !8367
  br label %bb.i
...
bb.m:                                             ; preds = %bb.l
  %.sroa.219.0.copyload = load ptr, ptr %.sroa.219.0..sroa_idx, align 8, !nonnull !10, !noundef !10 ; 3 uses
  %.sroa.320.0.copyload = load i64, ptr %.sroa.320.0..sroa_idx, align 8 ; 4 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !8371)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !8372
  ...
  store ptr %.sroa.219.0.copyload, ptr %i.b, align 8, !alias.scope !8373, !noalias !8374
  store i64 %i.ay, ptr %i.ah, align 8, !alias.scope !8373, !noalias !8374
  store ptr %.sroa.219.0.copyload, ptr %i.ai, align 8, !alias.scope !8373, !noalias !8374
  store ptr %i.ba, ptr %i.aj, align 8, !alias.scope !8373, !noalias !8374
  %i.bb = load i64, ptr %i.ak, align 8, !alias.scope !8371, !noalias !8375, !noundef !10
  %i.bc = icmp eq i64 %i.bb, 0
  %i.bd = add nuw nsw i64 %.sroa.320.0.copyload, 1
  %i.be = lshr i64 %i.bd, 1
  %.sroa.0.0.i11 = select i1 %i.bc, i64 %.sroa.320.0.copyload, i64 %i.be
  invoke void @"_ZN9hashbrown3raw21RawTable$LT$T$C$A$GT$7reserve17h977154c32f1aafb7E"(ptr noalias noundef nonnull align 8 dereferenceable(48) %0, i64 noundef %.sroa.0.0.i11, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %i.y)
          to label %_ZN4core4iter6traits8iterator8Iterator8for_each17h2196a003c3f0708fE.exit.i13 unwind label %bb.n, !noalias !8375
...
_ZN4core4iter6traits8iterator8Iterator8for_each17h2196a003c3f0708fE.exit.i13: ; preds = %bb.m
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.a, ptr noundef nonnull align 8 dereferenceable(32) %i.b, i64 32, i1 false), !noalias !8372
...
bb.n:                                             ; preds = %bb.m
  ...
  invoke void @"_ZN86_$LT$alloc..vec..into_iter..IntoIter$LT$T$C$A$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17hd4d0f3c4f41292a2E"(ptr noalias noundef nonnull align 8 dereferenceable(32) %i.b)
          to label %.body14 unwind label %bb.o, !noalias !8375

bb.o:                                             ; preds = %bb.n
  %i.bg = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_ZN4core9panicking16panic_in_cleanup17h6ca8ea5ab49097b2E() #51, !noalias !8375
  unreachable
...
bb.q:                                             ; preds = %_ZN4core4iter6traits8iterator8Iterator8for_each17h2196a003c3f0708fE.exit.i13
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !8372
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !8372
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e)
  br label %bb.j
...
bb.a:
  ...
  %i.c = load i64, ptr %1, align 8, !range !36, !noundef !10
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = cmpxchg ptr %.0.val, i32 0, i32 1 acquire monotonic, align 4, !noalias !8380
  %i.e = extractvalue { i32, i1 } %i.d, 1
  br i1 %i.e, label %bb.c, label %.noexc12.thread

bb.c:                                             ; preds = %bb.b
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !8380
  %i.f = getelementptr inbounds nuw i8, ptr %.0.val, i64 4
  %i.g = load atomic i64, ptr @_ZN3std9panicking11panic_count18GLOBAL_PANIC_COUNT17h543844e35c7d658cE monotonic, align 8, !noalias !8380
  %i.h = and i64 %i.g, 9223372036854775807
  %i.i = icmp eq i64 %i.h, 0
  br i1 %i.i, label %_ZN3std4sync6poison4Flag5guard17hd239ea212f506341E.exit.i, label %bb.d, !prof !11
...
_ZN3std4sync6poison4Flag5guard17hd239ea212f506341E.exit.i: ; preds = %.noexc, %bb.c
  ...
  %i.m = load atomic i8, ptr %i.f monotonic, align 1, !noalias !8380
...
bb.e:                                             ; preds = %bb.a
  ...
  %i.p = load i32, ptr %i.o, align 8, !noundef !10
  %i.q = getelementptr inbounds nuw i8, ptr %1, i64 12
  %i.r = load float, ptr %i.q, align 4, !noundef !10
...
bb.h:                                             ; preds = %_ZN3std4sync6poison4Flag5guard17hd239ea212f506341E.exit.i
  %i.w = load i64, ptr %i.a, align 8, !range !12, !noalias !8380, !noundef !10
end_hunk_0
