...
bb.aa:                                            ; preds = %bb.y, %bb.z
  ...
  %1 = getelementptr inbounds nuw i8, ptr %0, i64 329
  %2 = getelementptr inbounds nuw i8, ptr %0, i64 330
  %3 = getelementptr inbounds nuw i8, ptr %0, i64 331
  %4 = load i8, ptr %3, align 1, !range !22, !noundef !3
  %5 = load i8, ptr %2, align 2, !range !22, !noundef !3
  %6 = load i8, ptr %1, align 1, !range !22, !noundef !3
  %7 = load i8, ptr %i.fu, align 8, !range !22, !noundef !3
...
bb.aw:                                            ; preds = %bb.au, %bb.av
  ...
  %8 = trunc nuw i8 %i.jj to i1
  %9 = shufflevector <4 x float> %i.cl, <4 x float> %i.kp, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %10 = fcmp une <8 x float> %9, zeroinitializer
  %11 = trunc nuw i8 %i.iu to i1
  %12 = trunc nuw i8 %4 to i1
  %13 = trunc nuw i8 %5 to i1
  %i.kq = trunc nuw i8 %6 to i1
  %14 = trunc nuw i8 %7 to i1
  %i.kr = trunc nuw i8 %i.ft to i1
  %15 = trunc nuw i8 %i.fh to i1
  %16 = insertelement <8 x i1> poison, i1 %15, i64 0
  %i.ks = insertelement <8 x i1> %16, i1 %i.kr, i64 1
  %17 = insertelement <8 x i1> %i.ks, i1 %14, i64 2
  %i.kt = insertelement <8 x i1> %17, i1 %i.kq, i64 3
  %18 = insertelement <8 x i1> %i.kt, i1 %13, i64 4
  %i.ku = insertelement <8 x i1> %18, i1 %12, i64 5
  %19 = insertelement <8 x i1> %i.ku, i1 %11, i64 6
  %20 = insertelement <8 x i1> %19, i1 %8, i64 7
  %i.kv = shufflevector <8 x i1> %10, <8 x i1> %20, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
