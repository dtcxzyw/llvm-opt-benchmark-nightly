...
bb.r:                                             ; preds = %bb.b
  ...
  %.sroa.4123.0..sroa_idx.a = getelementptr inbounds nuw i8, ptr %i.aa, i64 8
  store i64 %.sroa.6.0.copyload, ptr %.sroa.4123.0..sroa_idx.a, align 8
...
switch.lookup491:                                 ; preds = %bb.b
  %.sroa.6.sroa.0.0.extract.trunc27 = trunc i64 %.sroa.6.0.copyload to i32
  ...
  store i32 %.sroa.6.sroa.0.0.extract.trunc27, ptr %.sroa.4131.0..sroa_idx, align 8
...
bb.t:                                             ; preds = %bb.b
  %.sroa.6.sroa.0.0.extract.trunc29 = trunc i64 %.sroa.6.0.copyload to i32
  store i64 -9223372036854775806, ptr %i.aa, align 8
  %.sroa.4138.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.aa, i64 8
  store i32 %.sroa.6.sroa.0.0.extract.trunc29, ptr %.sroa.4138.0..sroa_idx, align 8
  br label %bb.dp
...
"_ZN87_$LT$T$u20$as$u20$alloc..slice..$LT$impl$u20$$u5b$T$u5d$$GT$..to_vec_in..ConvertVec$GT$6to_vec17h4d11a3cc5f708623E.exit": ; preds = %bb.u
  %.sroa.6.sroa.0.0.extract.trunc31 = trunc i64 %.sroa.6.0.copyload to i32
  ...
  store i32 %.sroa.6.sroa.0.0.extract.trunc31, ptr %.sroa.5148.0..sroa_idx, align 8
  br label %bb.dp

bb.w:                                             ; preds = %bb.b
  %.sroa.6.sroa.0.0.extract.trunc33 = trunc i64 %.sroa.6.0.copyload to i32
  switch i32 %.sroa.6.sroa.0.0.extract.trunc33, label %.thread461 [
    i32 0, label %bb.cc
    i32 8, label %bb.cl
    i32 2, label %bb.cf
    i32 3, label %bb.cg
...
.thread478:                                       ; preds = %bb.b
  %.sroa.6.sroa.0.0.extract.trunc35 = trunc i64 %.sroa.6.0.copyload to i32
  %i.bz = icmp ult i32 %.sroa.6.sroa.0.0.extract.trunc35, 6
...
bb.x:                                             ; preds = %bb.b
  ...
  store i64 -9223372036854775792, ptr %i.aa, align 8
  %.sroa.4120.0..sroa_idx.a = getelementptr inbounds nuw i8, ptr %i.aa, i64 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %.sroa.4120.0..sroa_idx.a, ptr noundef nonnull align 8 dereferenceable(24) %.sroa.4120, i64 24, i1 false)
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.4120)
  br label %bb.dp

bb.y:                                             ; preds = %bb.b
  %.sroa.6.sroa.0.0.extract.trunc37 = trunc i64 %.sroa.6.0.copyload to i32
  store i64 -9223372036854775805, ptr %i.aa, align 8
  %.sroa.4158.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.aa, i64 8
  store i32 %.sroa.6.sroa.0.0.extract.trunc37, ptr %.sroa.4158.0..sroa_idx, align 8
  br label %bb.dp
...
"_ZN87_$LT$T$u20$as$u20$alloc..slice..$LT$impl$u20$$u5b$T$u5d$$GT$..to_vec_in..ConvertVec$GT$6to_vec17h4d11a3cc5f708623E.exit366": ; preds = %bb.aa
  %.sroa.6.sroa.0.0.extract.trunc39 = trunc i64 %.sroa.6.0.copyload to i32
  ...
  store i32 %.sroa.6.sroa.0.0.extract.trunc39, ptr %.sroa.5155.0..sroa_idx, align 8
  br label %bb.dp
...
bb.ae:                                            ; preds = %bb.b
  %.sroa.6.sroa.0.0.extract.trunc41 = trunc i64 %.sroa.6.0.copyload to i32
  store i64 -9223372036854775800, ptr %i.aa, align 8
  %.sroa.4141.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.aa, i64 8
  store i32 %.sroa.6.sroa.0.0.extract.trunc41, ptr %.sroa.4141.0..sroa_idx, align 8
  br label %bb.dp
