...
.body.i:                                          ; preds = %bb.ch, %bb.ce, %bb.bx, %bb.br, %bb.bo, %bb.bh, %bb.bd, %bb.av, %bb.ar, %bb.an, %"_ZN4core3ptr59drop_in_place$LT$regex_automata..meta..regex..RegexInfo$GT$17hf92d34f57571db47E.exit56.i.i", %.loopexit.split-lp.loopexit.split-lp.i, %.loopexit.split-lp.loopexit.i, %.loopexit.i
  %.pn.i = phi { ptr, i32 } [ %i.ge, %bb.bd ], [ %i.hp, %bb.ch ], [ %i.gs, %bb.bo ], [ %i.ha, %bb.bx ], [ %eh.lpad-body133.ph.i, %bb.br ], [ %i.gk, %bb.bh ], [ %.pn31.i.i, %"_ZN4core3ptr59drop_in_place$LT$regex_automata..meta..regex..RegexInfo$GT$17hf92d34f57571db47E.exit56.i.i" ], [ %i.hj, %bb.ce ], [ %i.fq, %bb.an ], [ %lpad.thr_comm.split-lp.i.i, %bb.av ], [ %i.fv, %bb.ar ], [ %lpad.loopexit.i, %.loopexit.i ], [ %lpad.loopexit162.i, %.loopexit.split-lp.loopexit.i ], [ %lpad.loopexit.split-lp163.i, %.loopexit.split-lp.loopexit.split-lp.i ]
...
bb.g:                                             ; preds = %bb.bq, %bb.f
  %.sroa.0153.0.i = phi i32 [ undef, %bb.f ], [ %.sroa.0153.0.i.a, %bb.bq ] ; 2 uses
...
bb.j:                                             ; preds = %bb.i, %bb.h, %.noexc.i
  %.sroa.0153.0.i.a = phi i32 [ %.sroa.0153.0.i, %.noexc.i ], [ %.sroa.0153.0.i, %bb.h ], [ %i.bb, %bb.i ] ; 2 uses
