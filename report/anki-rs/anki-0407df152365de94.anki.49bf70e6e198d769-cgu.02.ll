...
begin_hunk_0_@"_ZN113_$LT$tracing_subscriber..layer..layered..Layered$LT$L$C$S$GT$$u20$as$u20$tracing_core..subscriber..Subscriber$GT$12downcast_raw17h92f20486b3c30776E":bb.a
  %.pr.i.i.i.i = load i64, ptr %i.b, align 8, !alias.scope !3315, !noalias !3316
  %.not2.i.i.i.i = icmp eq i64 %.pr.i.i.i.i, 3
  br i1 %.not2.i.i.i.i, label %.thread.thread.i.i.i.i, label %.thread.i.i.i.i

bb.d:                                             ; preds = %bb.b
  %i.c = load i64, ptr %i.b, align 8, !range !31, !alias.scope !3315, !noalias !3316, !noundef !14
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.h = load i8, ptr %i.g, align 1, !range !38, !noalias !3325, !noundef !14
  %i.i = trunc nuw i8 %i.h to i1
  %i.j = getelementptr inbounds nuw i8, ptr %0, i64 2401
  %i.k = load i8, ptr %i.j, align 1, !range !38, !noalias !3325, !noundef !14
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.o = load i8, ptr %i.n, align 2, !range !38, !noalias !3326, !noundef !14
...
"_ZN18tracing_subscriber5layer7layered24Layered$LT$A$C$B$C$S$GT$13pick_interest17h04c23b529da82a60E.exit.sink.split.i.i.i": ; preds = %"_ZN113_$LT$tracing_subscriber..layer..layered..Layered$LT$L$C$S$GT$$u20$as$u20$tracing_core..subscriber..Subscriber$GT$17register_callsite28_$u7b$$u7b$closure$u7d$$u7d$17hf45b47097536b92aE.exit9.i.i.i.i", %bb.d
  ...
  %i.r = load i8, ptr %i.q, align 2, !range !38, !noalias !3325, !noundef !14
...
bb.h:                                             ; preds = %bb.b
  ...
  %i.v = load i8, ptr %i.u, align 1, !range !38, !noalias !3327, !noundef !14
  %i.w = trunc nuw i8 %i.v to i1
  %i.x = getelementptr inbounds nuw i8, ptr %0, i64 2401
  %i.y = load i8, ptr %i.x, align 1, !range !38, !noalias !3327, !noundef !14
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.ac = load i8, ptr %i.ab, align 2, !range !38, !noalias !3328, !noundef !14
...
"_ZN18tracing_subscriber5layer7layered24Layered$LT$A$C$B$C$S$GT$13pick_interest17h04c23b529da82a60E.exit.sink.split.i.i11.i": ; preds = %"_ZN113_$LT$tracing_subscriber..layer..layered..Layered$LT$L$C$S$GT$$u20$as$u20$tracing_core..subscriber..Subscriber$GT$17register_callsite28_$u7b$$u7b$closure$u7d$$u7d$17hf45b47097536b92aE.exit9.i.i.i8.i", %bb.i
  ...
  %i.af = load i8, ptr %i.ae, align 2, !range !38, !noalias !3327, !noundef !14
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.i = load i8, ptr %i.h, align 2, !range !38, !noalias !3331, !noundef !14
...
bb.a:
  ...
  %i.p = load i8, ptr %i.o, align 1, !alias.scope !3338, !noalias !3339, !noundef !14 ; 2 uses
  %i.q = and i8 %i.p, 4
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.u = load i8, ptr %i.r, align 8, !range !38, !alias.scope !3338, !noalias !3339
...
bb.c:                                             ; preds = %bb.b, %bb.a
  call void @llvm.lifetime.start.p0(ptr nonnull %i.m), !noalias !3340
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !3341
  call void @_ZN18tracing_subscriber8registry10LookupSpan4span17hb5d09d09703ea29aE(ptr noalias noundef nonnull sret([40 x i8]) align 8 captures(address) dereferenceable(40) %i.a, ptr noundef nonnull align 8 %i.n, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(8) %1), !noalias !3342
  %i.w = load ptr, ptr %i.a, align 8, !noalias !3341, !noundef !14 ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %.sroa.8.0..sroa_idx.i, ptr noundef nonnull align 8 dereferenceable(24) %.sroa.5.0..sroa_idx46.i, i64 24, i1 false), !noalias !3340
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !3341
  store ptr %i.w, ptr %i.m, align 8, !noalias !3340
  %.sroa.9.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.m, i64 32
  store i64 0, ptr %.sroa.9.0..sroa_idx.i, align 8, !noalias !3340
  call void @llvm.lifetime.start.p0(ptr nonnull %i.l), !noalias !3340
  %i.x = invoke { ptr, i1 } @"_ZN102_$LT$tracing_subscriber..registry..sharded..Data$u20$as$u20$tracing_subscriber..registry..SpanData$GT$14extensions_mut17hb548493e2cd2ff64E"(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %.sroa.8.0..sroa_idx.i)
          to label %bb.g unwind label %.thread.i, !noalias !3338 ; 2 uses

bb.e:                                             ; preds = %bb.c
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !3341
  call void @_ZN4core6option13expect_failed17h40dde8b63ee0f843E(ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) @29, i64 noundef 29, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @42) #33, !noalias !3338
  unreachable
...
bb.g:                                             ; preds = %bb.d
  ...
  store ptr %i.z, ptr %i.l, align 8, !noalias !3340
  %i.ab = getelementptr inbounds nuw i8, ptr %i.l, i64 8 ; 2 uses
  %i.ac = zext i1 %i.aa to i8
  store i8 %i.ac, ptr %i.ab, align 8, !noalias !3340
  ...
  %i.ae = invoke noundef align 8 dereferenceable_or_null(40) ptr @_ZN18tracing_subscriber8registry10extensions15ExtensionsInner7get_mut17h53dde07f00a7db17E(ptr noalias noundef nonnull align 8 dereferenceable(32) %i.ad)
          to label %bb.h unwind label %bb.r, !noalias !3338 ; 5 uses
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.ag = load i64, ptr %i.af, align 8, !noalias !3338, !noundef !14
  %i.ah = add i64 %i.ag, -1                       ; 2 uses
  store i64 %i.ah, ptr %i.af, align 8, !noalias !3338
...
bb.k:                                             ; preds = %bb.i
  %i.aj = invoke { i64, i32 } @_ZN3std4time7Instant3now17h85e5dfc2f76449beE()
          to label %bb.l unwind label %bb.r, !noalias !3338 ; 2 uses
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.an = load i64, ptr %i.am, align 8, !noalias !3338, !noundef !14
  %i.ao = getelementptr inbounds nuw i8, ptr %i.ae, i64 32 ; 2 uses
  %i.ap = load i32, ptr %i.ao, align 8, !range !44, !noalias !3338, !noundef !14
  %i.aq = invoke { i64, i32 } @"_ZN60_$LT$std..time..Instant$u20$as$u20$core..ops..arith..Sub$GT$3sub17h5a2cdf940c4d2995E"(i64 noundef %i.ak, i32 noundef %i.al, i64 noundef %i.an, i32 noundef %i.ap)
          to label %bb.m unwind label %bb.r, !noalias !3338 ; 2 uses
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.ay = load i64, ptr %i.ax, align 8, !noalias !3338, !noundef !14
  %i.az = add i64 %i.aw, %i.ay
  store i64 %i.az, ptr %i.ax, align 8, !noalias !3338
  store i64 %i.ak, ptr %i.am, align 8, !noalias !3338
  store i32 %i.al, ptr %i.ao, align 8, !noalias !3338
  br label %bb.j

bb.n:                                             ; preds = %bb.j
  %.val21.i = load ptr, ptr %.sroa.8.0..sroa_idx.i, align 8, !noalias !3340, !nonnull !14, !noundef !14
  %i.ba = load ptr, ptr %.val21.i, align 8, !noalias !3338, !nonnull !14, !align !15, !noundef !14 ; 2 uses
  %i.bb = getelementptr inbounds nuw i8, ptr %i.ba, i64 64
  store ptr @37, ptr %i.k, align 8, !noalias !3340
  %i.bc = getelementptr inbounds nuw i8, ptr %i.k, i64 8
  store i64 1, ptr %i.bc, align 8, !noalias !3340
  %i.bd = getelementptr inbounds nuw i8, ptr %i.k, i64 16
  %i.be = load <2 x ptr>, ptr %i.bb, align 8, !noalias !3338
  store <2 x ptr> %i.be, ptr %i.bd, align 8, !noalias !3340
  call void @llvm.lifetime.start.p0(ptr nonnull %i.j), !noalias !3340
  call void @llvm.lifetime.start.p0(ptr nonnull %i.i), !noalias !3340
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.i, ptr noundef nonnull align 8 dereferenceable(32) %i.k, i64 32, i1 false), !noalias !3340
  %.sroa.412.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.i, i64 32
  store i64 0, ptr %.sroa.412.0..sroa_idx.i, align 8, !noalias !3340
  store ptr %i.i, ptr %i.j, align 8, !noalias !3340
  %.sroa.4.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.j, i64 8
  store ptr @44, ptr %.sroa.4.0..sroa_idx.i, align 8, !noalias !3340
  %.sroa.5.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.j, i64 16
  store ptr @40, ptr %.sroa.5.0..sroa_idx.i, align 8, !noalias !3340
  call void @llvm.lifetime.start.p0(ptr nonnull %i.h), !noalias !3340
  store ptr %i.j, ptr %i.h, align 8, !noalias !3340
  %i.bf = getelementptr inbounds nuw i8, ptr %i.h, i64 8
  store i64 1, ptr %i.bf, align 8, !noalias !3340
  %i.bg = getelementptr inbounds nuw i8, ptr %i.h, i64 16
  store ptr %i.k, ptr %i.bg, align 8, !noalias !3340
  call void @llvm.lifetime.start.p0(ptr nonnull %i.g), !noalias !3340
  %i.bh = load i64, ptr %1, align 8, !range !45, !alias.scope !3339, !noalias !3338, !noundef !14
  %i.bi = getelementptr inbounds nuw i8, ptr %i.g, i64 16
  store ptr %i.h, ptr %i.bi, align 8, !noalias !3340
  %i.bj = getelementptr inbounds nuw i8, ptr %i.g, i64 24
  store ptr %i.ba, ptr %i.bj, align 8, !noalias !3340
  store i64 2, ptr %i.g, align 8, !noalias !3340
  %i.bk = getelementptr inbounds nuw i8, ptr %i.g, i64 8
  store i64 %i.bh, ptr %i.bk, align 8, !noalias !3340
end_hunk_0
