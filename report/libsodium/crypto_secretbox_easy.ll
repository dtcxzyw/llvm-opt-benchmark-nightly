Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/libsodium/original/crypto_secretbox_easy?download=true
begin_hunk_0
...
bb.a:
  ...
  %i.c = call i32 @crypto_core_hsalsa20(ptr noundef nonnull %i.b, ptr noundef nonnull %4, ptr noundef nonnull %5, ptr noundef null) #6 ; 0 uses
...
._crit_edge:                                      ; preds = %.lr.ph.preheader, %bb.c
  ...
  %i.n = call i32 @crypto_stream_salsa20_xor(ptr noundef nonnull %i.a, ptr noundef nonnull %i.a, i64 noundef %i.l, ptr noundef %i.m, ptr noundef nonnull %i.b) #6 ; 0 uses
  %i.o = call i32 @crypto_onetimeauth_poly1305_init(ptr noundef nonnull %6, ptr noundef nonnull %i.a) #6 ; 0 uses
...
bb.d:                                             ; preds = %._crit_edge56
  ...
  %i.s = call i32 @crypto_stream_salsa20_xor_ic(ptr noundef %i.p, ptr noundef %i.q, i64 noundef %i.r, ptr noundef %i.m, i64 noundef 1, ptr noundef nonnull %i.b) #6 ; 0 uses
  br label %bb.e

bb.e:                                             ; preds = %bb.d, %._crit_edge56
  call void @sodium_memzero(ptr noundef nonnull %i.b, i64 noundef 32) #6
  %i.t = call i32 @crypto_onetimeauth_poly1305_update(ptr noundef nonnull %6, ptr noundef nonnull %0, i64 noundef %3) #6 ; 0 uses
  %i.u = call i32 @crypto_onetimeauth_poly1305_final(ptr noundef nonnull %6, ptr noundef nonnull %1) #6 ; 0 uses
  call void @sodium_memzero(ptr noundef nonnull %6, i64 noundef 256) #6
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.c = tail call i32 @crypto_secretbox_detached(ptr noundef %i.b, ptr noundef %0, ptr noundef %1, i64 noundef %2, ptr noundef %3, ptr noundef %4) ; 0 uses
  ret i32 0
}
...
bb.a:
  ...
  %i.e = call i32 @crypto_stream_salsa20(ptr noundef nonnull %i.a, i64 noundef 32, ptr noundef %i.d, ptr noundef nonnull %i.b) #6 ; 0 uses
  %i.f = call i32 @crypto_onetimeauth_poly1305_verify(ptr noundef nonnull %2, ptr noundef nonnull %1, i64 noundef %3, ptr noundef nonnull %i.a) #6
...
.thread:                                          ; preds = %bb.e, %bb.f
  call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 1 %0, ptr noundef nonnull align 1 %1, i64 noundef %3, i1 noundef false) #6
...
._crit_edge.thread:                               ; preds = %bb.g
  %i.p = call i32 @crypto_stream_salsa20_xor(ptr noundef nonnull %i.a, ptr noundef nonnull %i.a, i64 noundef 32, ptr noundef %i.d, ptr noundef nonnull %i.b) #6 ; 0 uses
  call void @sodium_memzero(ptr noundef nonnull %i.a, i64 noundef 64) #6
  br label %bb.i
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.c = add i64 %2, -16
  %i.d = tail call i32 @crypto_secretbox_open_detached(ptr noundef %0, ptr noundef %i.b, ptr noundef %1, i64 noundef %i.c, ptr noundef %3, ptr noundef %4)
  br label %bb.c
