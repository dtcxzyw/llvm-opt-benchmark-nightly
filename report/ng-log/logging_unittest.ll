...
_ZNKSt6vectorISt6threadSaIS0_EE12_M_check_lenEmPKc.exit.i.i: ; preds = %bb.s
  %i.cf = ashr exact i64 %i.cd, 3
  %mul2.i.i = ashr exact i64 %i.cd, 2
  %20 = call i64 @llvm.umax.i64(i64 %mul2.i.i, i64 1) ; 2 uses
  %i.cg = icmp ult i64 %20, %i.cf
  %i.ch = call i64 @llvm.umin.i64(i64 %20, i64 1152921504606846975)
  %i.ci = select i1 %i.cg, i64 1152921504606846975, i64 %i.ch ; 2 uses
