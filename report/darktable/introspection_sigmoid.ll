...
bb.f:                                             ; preds = %.lr.ph, %_preserve_hue_and_energy.exit
  ...
  %i.hq = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %.03897 ; 3 uses
  ...
  %6 = load <3 x float>, ptr %i.hq, align 4, !tbaa !21 ; 5 uses
  %i.hs = load float, ptr %i.hr, align 4, !tbaa !21
  %i.ht = shufflevector <3 x float> %6, <3 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.hv = fmul reassoc nsz arcp contract afn <2 x float> %i.gw, %7
  ...
  %9 = fmul reassoc nsz arcp contract afn <2 x float> %i.gx, %8
  %10 = fadd reassoc nsz arcp contract afn <2 x float> %i.hw, %9 ; 3 uses
  %11 = extractelement <3 x float> %6, i64 0
  %i.hx = fmul reassoc nsz arcp contract afn float %i.gz, %11
  ...
  %i.ia = fmul reassoc nsz arcp contract afn float %i.hd, %12
  %i.ib = fadd reassoc nsz arcp contract afn float %i.hz, %i.ia ; 3 uses
  %i.ic = extractelement <2 x float> %10, i64 0   ; 2 uses
  %i.id = extractelement <2 x float> %10, i64 1   ; 2 uses
  ...
  %i.ir = fsub reassoc nsz arcp contract afn <2 x float> %10, %i.iq
