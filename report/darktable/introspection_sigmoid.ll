...
bb.a:
  ...
  %4 = tail call reassoc nsz arcp contract afn float @llvm.maxnum.f32(float %i.bp, float 0.000000e+00)
  %i.bq = tail call reassoc nnan nsz arcp contract afn float @llvm.minnum.f32(float %4, float 1.000000e+02)
  %5 = fmul reassoc nnan nsz arcp contract afn float %i.bq, f0x3C23D70A
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %5 = tail call reassoc nsz arcp contract afn <8 x float> @llvm.maxnum.v8f32(<8 x float> %i.ah, <8 x float> zeroinitializer)
  %6 = fmul reassoc nnan nsz arcp contract afn <8 x float> %5, splat (float f0x3EAAAAAB) ; 10 uses
  ...
  %i.am = fsub reassoc nsz arcp contract afn <8 x float> %i.aj, %6
...
.lr.ph:                                           ; preds = %.lr.ph.preheader132, %_pixel_channel_order.exit
  ...
  %7 = tail call reassoc nsz arcp contract afn float @llvm.maxnum.f32(float %i.fw, float 0.000000e+00)
  %i.fx = tail call reassoc nsz arcp contract afn float @llvm.minnum.f32(float %i.fq, float %i.fs)
  %i.fy = tail call reassoc nsz arcp contract afn float @llvm.minnum.f32(float %i.fx, float %i.fv) ; 2 uses
  %8 = fcmp reassoc nsz arcp contract afn olt float %i.fy, 0.000000e+00
  %9 = fmul reassoc nnan nsz arcp contract afn float %7, f0x3EAAAAAB ; 10 uses
  %i.fz = fneg reassoc nsz arcp contract afn float %9
  %i.ga = fsub reassoc nsz arcp contract afn float %i.fy, %9
  %i.gb = fdiv reassoc nsz arcp contract afn float %i.fz, %i.ga
  %i.gc = select reassoc nsz arcp contract afn i1 %8, float %i.gb, float 1.000000e+00 ; 4 uses
  %i.gd = fsub reassoc nsz arcp contract afn float %i.fq, %9
  %i.ge = fmul reassoc nsz arcp contract afn float %i.gc, %i.gd
  %i.gf = fadd reassoc nsz arcp contract afn float %i.ge, %9 ; 2 uses
  %i.gg = fsub reassoc nsz arcp contract afn float %i.fs, %9
  %i.gh = fmul reassoc nsz arcp contract afn float %i.gc, %i.gg
  %i.gi = fadd reassoc nsz arcp contract afn float %i.gh, %9 ; 2 uses
  %i.gj = fsub reassoc nsz arcp contract afn float %i.fv, %9
  %i.gk = fmul reassoc nsz arcp contract afn float %i.gc, %i.gj
  %i.gl = fadd reassoc nsz arcp contract afn float %i.gk, %9 ; 2 uses
...
.preheader:                                       ; preds = %.lr.ph
  ...
  %i.he = fsub reassoc nsz arcp contract afn float %i.hd, %9
  %i.hf = fmul reassoc nsz arcp contract afn float %i.gy, 3.000000e+00
  %10 = fmul reassoc nsz arcp contract afn float %i.gc, %i.he
  %11 = fadd reassoc nsz arcp contract afn float %10, %9
  ...
  %i.hl = insertelement <4 x float> %i.hk, float %11, i64 3
...
bb.f:                                             ; preds = %.lr.ph, %_preserve_hue_and_energy.exit
  ...
  %6 = call reassoc nsz arcp contract afn float @llvm.maxnum.f32(float %i.kj, float 0.000000e+00)
  %7 = fmul reassoc nnan nsz arcp contract afn float %6, f0x3EAAAAAB ; 5 uses
  ...
  %i.ko = fsub reassoc nsz arcp contract afn float %i.kl, %7
