...
.loopexit:                                        ; preds = %.preheader, %bb.e
  ...
  %8 = tail call <4 x float> @llvm.masked.load.v4f32.p0(ptr nonnull align 4 %i.au, <4 x i1> <i1 true, i1 false, i1 false, i1 true>, <4 x float> poison), !tbaa !16 ; 2 uses
  %9 = shufflevector <4 x float> %8, <4 x float> poison, <2 x i32> <i32 0, i32 3>
  %i.bn = fmul reassoc nsz arcp contract afn <2 x float> %9, %i.bc
  ...
  %10 = fmul reassoc nsz arcp contract afn <2 x float> %i.bv, %i.c ; 3 uses
  %foldExtExtBinop = fmul reassoc nsz arcp contract afn <2 x float> %10, %10
  ...
  %11 = shufflevector <4 x float> %8, <4 x float> %i.by, <4 x i32> <i32 0, i32 5, i32 6, i32 3>
  %12 = shufflevector <2 x float> %10, <2 x float> %i.bk, <4 x i32> <i32 0, i32 2, i32 3, i32 1>
  %i.bz = fsub reassoc nsz arcp contract afn <4 x float> %11, %12
...
.lr.ph:                                           ; preds = %.lr.ph.preheader206, %.lr.ph
  ...
  %i.fc = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %i.ez ; 3 uses
  ...
  %i.fg = load float, ptr %i.fb, align 4, !tbaa !16
  ...
  %13 = tail call <4 x float> @llvm.masked.load.v4f32.p0(ptr nonnull align 4 %i.fc, <4 x i1> <i1 true, i1 false, i1 false, i1 true>, <4 x float> poison), !tbaa !16 ; 2 uses
  %14 = shufflevector <4 x float> %13, <4 x float> poison, <2 x i32> <i32 0, i32 3>
  %i.gc = fmul reassoc nsz arcp contract afn <2 x float> %14, %i.eu
  ...
  %i.gg = insertelement <2 x float> %i.gf, float %i.fz, i64 1
  %i.gh = insertelement <2 x float> poison, float %i.fg, i64 0 ; 2 uses
  ...
  %15 = fmul reassoc nsz arcp contract afn <2 x float> %i.gm, %i.c ; 3 uses
  %foldExtExtBinop204 = fmul reassoc nsz arcp contract afn <2 x float> %15, %15
  %i.gn = extractelement <2 x float> %foldExtExtBinop204, i64 0
  ...
  %16 = shufflevector <4 x float> %13, <4 x float> %i.gp, <4 x i32> <i32 0, i32 5, i32 6, i32 3>
  %17 = shufflevector <2 x float> %15, <2 x float> %i.fv, <4 x i32> <i32 0, i32 2, i32 3, i32 1>
  %i.gq = fsub reassoc nsz arcp contract afn <4 x float> %16, %17
  store <4 x float> %i.gq, ptr %i.fc, align 4, !tbaa !16
  %i.gr = add nuw nsw i64 %.0110135, 1            ; 2 uses
  %exitcond.not = icmp eq i64 %i.gr, %i.ca
  %i.gs = insertelement <2 x float> %i.gh, float %i.fz, i64 1
