...
bb.b:                                             ; preds = %.lr.ph141, %._crit_edge
  ...
  %.1117 = select nsz i1 %i.u, float %i.v, float %spec.select ; 4 uses
...
.lr.ph.preheader:                                 ; preds = %bb.f
  ...
  %i.co = getelementptr inbounds nuw [4 x i8], ptr %i.cn, i64 %i.y ; 2 uses
  %.sroa.9.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.co, i64 4
  %8 = load <2 x float>, ptr %.sroa.9.0..sroa_idx, align 4, !tbaa !16, !alias.scope !60 ; 3 uses
  %9 = tail call <4 x float> @llvm.masked.load.v4f32.p0(ptr nonnull align 4 %i.co, <4 x i1> <i1 true, i1 false, i1 false, i1 true>, <4 x float> poison), !tbaa !16, !alias.scope !60 ; 3 uses
  %10 = shufflevector <4 x float> %9, <4 x float> poison, <2 x i32> <i32 0, i32 3>
...
vector.ph:                                        ; preds = %.lr.ph.preheader
  ...
  %11 = shufflevector <4 x float> %9, <4 x float> poison, <8 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 3>
  ...
  %12 = shufflevector <4 x float> %9, <4 x float> poison, <8 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 0>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vector.recur = phi <8 x float> [ %11, %vector.ph ], [ %strided.vec179, %vector.body ]
  ...
  %vector.recur176 = phi <8 x float> [ %12, %vector.ph ], [ %strided.vec, %vector.body ]
  ...
  %wide.vec = load <32 x float>, ptr %i.cy, align 4, !tbaa !16 ; 6 uses
  ...
  %i.df = fadd reassoc nsz arcp contract afn <8 x float> %strided.vec186, %strided.vec
  %i.dg = fadd reassoc nsz arcp contract afn <8 x float> %strided.vec191, %i.dd
  %i.dh = fadd reassoc nsz arcp contract afn <8 x float> %i.df, %i.dg
  ...
  %i.dp = fadd reassoc nsz arcp contract afn <8 x float> %strided.vec187, %strided.vec177
  %i.dq = fadd reassoc nsz arcp contract afn <8 x float> %strided.vec192, %i.dn
  %i.dr = fadd reassoc nsz arcp contract afn <8 x float> %i.dp, %i.dq
  ...
  %i.dz = fadd reassoc nsz arcp contract afn <8 x float> %strided.vec188, %strided.vec178
  %i.ea = fadd reassoc nsz arcp contract afn <8 x float> %strided.vec193, %i.dx
  %i.eb = fadd reassoc nsz arcp contract afn <8 x float> %i.dz, %i.ea
  ...
  %i.ej = fadd reassoc nsz arcp contract afn <8 x float> %strided.vec189, %strided.vec179
  %i.ek = fadd reassoc nsz arcp contract afn <8 x float> %strided.vec194, %i.eh
  %i.el = fadd reassoc nsz arcp contract afn <8 x float> %i.ej, %i.ek
...
middle.block:                                     ; preds = %vector.body
  ...
  %13 = shufflevector <32 x float> %wide.vec, <32 x float> poison, <2 x i32> <i32 28, i32 31>
...
.lr.ph.preheader206:                              ; preds = %.lr.ph.preheader, %middle.block
  ...
  %.ph208 = phi <2 x float> [ %10, %.lr.ph.preheader ], [ %13, %middle.block ]
...
.lr.ph:                                           ; preds = %.lr.ph.preheader206, %.lr.ph
  %.sroa.9.0 = phi nsz float [ %i.gi, %.lr.ph ], [ %.sroa.0153.3.ph, %.lr.ph.preheader206 ]
  %.0111135 = phi i64 [ %i.gn, %.lr.ph ], [ %.0111135.ph, %.lr.ph.preheader206 ] ; 2 uses
  %14 = phi <2 x float> [ %i.fq, %.lr.ph ], [ %.ph, %.lr.ph.preheader206 ]
  %i.fa = phi <2 x float> [ %i.gb, %.lr.ph ], [ %.ph207, %.lr.ph.preheader206 ]
  %i.fb = phi <2 x float> [ %23, %.lr.ph ], [ %.ph208, %.lr.ph.preheader206 ]
  ...
  %i.fi = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.fh ; 2 uses
  %i.fj = getelementptr [4 x i8], ptr %i.fe, i64 %i.a ; 2 uses
  %i.fk = load float, ptr %i.ff, align 4, !tbaa !16
  %i.fl = load float, ptr %i.fg, align 4, !tbaa !16 ; 2 uses
  ...
  %i.fw = fadd reassoc nsz arcp contract afn <2 x float> %i.fu, %14
  ...
  %i.gb = fadd reassoc nsz arcp contract afn <2 x float> %i.ga, %i.fa ; 2 uses
  ...
  %15 = insertelement <2 x float> poison, float %i.fl, i64 0
  %16 = insertelement <2 x float> %15, float %i.gf, i64 1
  %17 = fmul reassoc nsz arcp contract afn <2 x float> %16, %i.ez
  %18 = tail call <4 x float> @llvm.masked.load.v4f32.p0(ptr nonnull align 4 %i.fi, <4 x i1> <i1 true, i1 false, i1 false, i1 true>, <4 x float> poison), !tbaa !16
  %19 = shufflevector <4 x float> %18, <4 x float> poison, <2 x i32> <i32 0, i32 3>
  %20 = tail call <4 x float> @llvm.masked.load.v4f32.p0(ptr align 4 %i.fj, <4 x i1> <i1 true, i1 false, i1 false, i1 true>, <4 x float> poison), !tbaa !16
  %21 = shufflevector <4 x float> %20, <4 x float> poison, <2 x i32> <i32 0, i32 3>
  %22 = insertelement <2 x float> poison, float %i.fk, i64 0
  %23 = insertelement <2 x float> %22, float %i.gd, i64 1 ; 2 uses
  %24 = fadd reassoc nsz arcp contract afn <2 x float> %19, %23
  %25 = fadd reassoc nsz arcp contract afn <2 x float> %21, %i.fb
  %26 = fadd reassoc nsz arcp contract afn <2 x float> %24, %25
  %27 = fsub reassoc nsz arcp contract afn <2 x float> %17, %26
  %28 = shufflevector <2 x float> %27, <2 x float> %i.fz, <4 x i32> <i32 0, i32 2, i32 3, i32 1>
  %i.gg = fmul reassoc nsz arcp contract afn <4 x float> %28, %i.e ; 3 uses
  ...
  %i.gi = fadd reassoc nsz arcp contract afn float %i.gh, %.sroa.9.0 ; 2 uses
  %i.gj = shufflevector <2 x float> %i.fr, <2 x float> poison, <4 x i32> <i32 poison, i32 0, i32 1, i32 poison>
  %i.gk = insertelement <4 x float> %i.gj, float %i.fl, i64 0
