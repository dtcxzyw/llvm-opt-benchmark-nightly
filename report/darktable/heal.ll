...
vector.body357:                                   ; preds = %vector.body357, %vector.ph352
  ...
  %7 = fsub reassoc nsz arcp contract afn <8 x float> %wide.masked.gather361, %wide.masked.gather363
  %8 = fsub reassoc nsz arcp contract afn <8 x float> %wide.masked.gather369, %wide.masked.gather371
  ...
  %10 = fsub reassoc nsz arcp contract afn <8 x float> %wide.masked.gather377, %wide.masked.gather379
  %11 = fsub reassoc nsz arcp contract afn <8 x float> %wide.masked.gather385, %wide.masked.gather387
  %12 = shufflevector <8 x float> %10, <8 x float> %11, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  ...
  %13 = fsub reassoc nsz arcp contract afn <8 x float> %wide.masked.gather365, %wide.masked.gather367
  %14 = fsub reassoc nsz arcp contract afn <8 x float> %wide.masked.gather373, %wide.masked.gather375
  ...
  %16 = fsub reassoc nsz arcp contract afn <8 x float> %wide.masked.gather381, %wide.masked.gather383
  %17 = fsub reassoc nsz arcp contract afn <8 x float> %wide.masked.gather390, %wide.masked.gather392
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %19 = fsub reassoc nsz arcp contract afn <8 x float> %wide.masked.gather, %wide.masked.gather194
  %20 = fsub reassoc nsz arcp contract afn <8 x float> %wide.masked.gather200, %wide.masked.gather202
  ...
  %22 = fsub reassoc nsz arcp contract afn <8 x float> %wide.masked.gather208, %wide.masked.gather210
  %23 = fsub reassoc nsz arcp contract afn <8 x float> %wide.masked.gather216, %wide.masked.gather218
  ...
  %25 = fsub reassoc nsz arcp contract afn <8 x float> %wide.masked.gather196, %wide.masked.gather198
  %26 = fsub reassoc nsz arcp contract afn <8 x float> %wide.masked.gather204, %wide.masked.gather206
  %27 = shufflevector <8 x float> %25, <8 x float> %26, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %28 = fsub reassoc nsz arcp contract afn <8 x float> %wide.masked.gather212, %wide.masked.gather214
  %29 = fsub reassoc nsz arcp contract afn <8 x float> %wide.masked.gather220, %wide.masked.gather222
