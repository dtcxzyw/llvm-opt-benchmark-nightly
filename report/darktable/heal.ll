...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.de = fadd reassoc nsz arcp contract afn <8 x float> %strided.vec, %strided.vec186
  %i.df = fadd reassoc nsz arcp contract afn <8 x float> %i.de, %strided.vec191
  %i.dg = fadd reassoc nsz arcp contract afn <8 x float> %i.df, %i.dc
  ...
  %i.do = fadd reassoc nsz arcp contract afn <8 x float> %strided.vec177, %strided.vec187
  %i.dp = fadd reassoc nsz arcp contract afn <8 x float> %i.do, %strided.vec192
  %i.dq = fadd reassoc nsz arcp contract afn <8 x float> %i.dp, %i.dm
  ...
  %i.dy = fadd reassoc nsz arcp contract afn <8 x float> %strided.vec178, %strided.vec188
  %i.dz = fadd reassoc nsz arcp contract afn <8 x float> %i.dy, %strided.vec193
  %i.ea = fadd reassoc nsz arcp contract afn <8 x float> %i.dz, %i.dw
  ...
  %i.ei = fadd reassoc nsz arcp contract afn <8 x float> %strided.vec179, %strided.vec189
  %i.ej = fadd reassoc nsz arcp contract afn <8 x float> %i.ei, %strided.vec194
  %i.ek = fadd reassoc nsz arcp contract afn <8 x float> %i.ej, %i.eg
...
.lr.ph:                                           ; preds = %.lr.ph.preheader206, %.lr.ph
  ...
  %i.fc = phi <2 x float> [ %13, %.lr.ph ], [ %.ph208, %.lr.ph.preheader206 ]
  ...
  %i.fj = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.fi ; 3 uses
  %i.fk = getelementptr [4 x i8], ptr %i.ff, i64 %i.a ; 2 uses
  %8 = load float, ptr %i.fg, align 4, !tbaa !16
  ...
  %9 = getelementptr inbounds nuw i8, ptr %i.fg, i64 12
  %10 = load float, ptr %9, align 4, !tbaa !16    ; 2 uses
  %i.gc = getelementptr inbounds nuw i8, ptr %i.fj, i64 12
  ...
  %i.gh = tail call <4 x float> @llvm.masked.load.v4f32.p0(ptr align 4 %i.fk, <4 x i1> <i1 true, i1 false, i1 false, i1 true>, <4 x float> poison), !tbaa !16
  %i.gi = shufflevector <4 x float> %i.gh, <4 x float> poison, <2 x i32> <i32 0, i32 3>
  %11 = insertelement <2 x float> poison, float %i.fl, i64 0
  %12 = insertelement <2 x float> %11, float %10, i64 1
  %i.gj = insertelement <2 x float> poison, float %8, i64 0 ; 2 uses
  %i.gk = insertelement <2 x float> %i.gj, float %i.gd, i64 1
  %i.gl = fadd reassoc nsz arcp contract afn <2 x float> %12, %i.gk
  %i.gm = fadd reassoc nsz arcp contract afn <2 x float> %i.gl, %i.gi
  %i.gn = fadd reassoc nsz arcp contract afn <2 x float> %i.gm, %i.fc
  ...
  %13 = insertelement <2 x float> %i.gj, float %10, i64 1
