...
bb.da:                                            ; preds = %bb.cw, %bb.cw, %bb.cw, %bb.cw, %bb.cw, %bb.cw, %bb.cw, %bb.cw, %bb.cw
  ...
  %5 = load <2 x i16>, ptr %i.afv, align 2, !tbaa !76
  %6 = shufflevector <2 x i16> %5, <2 x i16> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.agi = insertelement <4 x i16> %6, i16 %i.agg, i64 2
...
bb.di:                                            ; preds = %bb.cw, %bb.cw
  ...
  %7 = load <2 x i16>, ptr %i.apo, align 2, !tbaa !76
  %8 = shufflevector <2 x i16> %7, <2 x i16> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.aqb = insertelement <4 x i16> %8, i16 %i.apz, i64 2
...
bb.dj:                                            ; preds = %bb.cw, %bb.cw, %bb.cw, %bb.cw
  ...
  %9 = load <2 x i16>, ptr %i.atb, align 2, !tbaa !76
  %10 = shufflevector <2 x i16> %9, <2 x i16> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.ato = insertelement <4 x i16> %10, i16 %i.atm, i64 2
...
bb.dm:                                            ; preds = %bb.cw, %bb.cw, %bb.cw, %bb.cw
  ...
  %11 = load <2 x i16>, ptr %i.awr, align 2, !tbaa !76
  %12 = shufflevector <2 x i16> %11, <2 x i16> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.axe = insertelement <4 x i16> %12, i16 %i.axc, i64 2
