...
.thread:                                          ; preds = %bb.g, %bb.f, %bb.j
  ...
  %i.dk = fmul reassoc nsz arcp contract afn float %reass.add, %.153115
  %2 = fadd reassoc nsz arcp contract afn float %i.cz, %i.dg
  %i.dl = fadd reassoc nsz arcp contract afn float %2, %i.dk
  br label %bb.l
