...
.thread:                                          ; preds = %bb.g, %bb.f, %bb.j
  ...
  %.153115 = phi float [ %i.bw, %bb.j ], [ %i.as, %bb.f ], [ %i.au, %bb.g ] ; 2 uses
  ...
  %i.cr = fsub reassoc nsz arcp contract afn float 1.000000e+00, %i.cq
  %i.cs = fadd reassoc nsz arcp contract afn float %i.cr, %i.cp
  %.neg120 = fmul reassoc nsz arcp contract afn float %i.cn, -2.000000e+00
  %i.ct = fadd reassoc nsz arcp contract afn float %.neg120, %i.cm
  ...
  %i.dc = fmul reassoc nsz arcp contract afn float %i.cu, %i.db
  ...
  %i.dj = fmul reassoc nsz arcp contract afn float %i.cw, %i.di
  %reass.add = fadd reassoc nsz arcp contract afn float %i.dc, %i.dj
  %reass.mul = fmul reassoc nsz arcp contract afn float %reass.add, %.153115
  %2 = fadd reassoc nsz arcp contract afn float %i.dg, %i.cz
  %i.dk = fadd reassoc nsz arcp contract afn float %2, %reass.mul
  br label %bb.l

bb.l:                                             ; preds = %.thread, %bb.k
  %storemerge = phi float [ %i.ci, %bb.k ], [ %i.dk, %.thread ] ; 2 uses
  %i.dl = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.dm = load float, ptr %i.dl, align 8, !tbaa !34 ; 2 uses
  %i.dn = fcmp reassoc nsz arcp contract afn olt float %storemerge, %i.dm
  %.sroa.speculated78 = select i1 %i.dn, float %i.dm, float %storemerge ; 2 uses
  %i.do = getelementptr inbounds nuw i8, ptr %0, i64 36
  %i.dp = load float, ptr %i.do, align 4, !tbaa !34 ; 2 uses
  %i.dq = fcmp reassoc nsz arcp contract afn olt float %i.dp, %.sroa.speculated78
  %.sroa.speculated = select i1 %i.dq, float %i.dp, float %.sroa.speculated78
  br label %bb.m
