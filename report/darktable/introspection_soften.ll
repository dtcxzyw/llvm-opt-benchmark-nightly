...
rgb2hsl.exit:                                     ; preds = %.lr.ph, %bb.l, %bb.m, %bb.n
  %.043.i = phi nsz float [ %i.gr, %bb.l ], [ %i.gr, %bb.n ], [ %i.gr, %bb.m ], [ 0.000000e+00, %.lr.ph ]
  %.1.i = phi nsz float [ %i.hh, %bb.l ], [ %i.hj, %bb.n ], [ %i.hf, %bb.m ], [ 0.000000e+00, %.lr.ph ]
  %i.hk = fmul reassoc nsz arcp contract afn float %.043.i, %i.m ; 3 uses
...
bb.s:                                             ; preds = %bb.r, %bb.q
  ...
  %i.il = fmul reassoc nsz arcp contract afn float %.1.i, 6.000000e+00 ; 8 uses
