...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %6 = fcmp reassoc nsz arcp contract afn uge <8 x double> %i.bo, splat (double f0xB690000000000000)
  %i.bq = select <8 x i1> %i.al, <8 x i1> %6, <8 x i1> zeroinitializer ; 2 uses
  ...
  %predphi77 = select nsz <8 x i1> %i.al, <8 x float> %i.bu, <8 x float> zeroinitializer
  %predphi78 = select nsz <8 x i1> %i.bw, <8 x float> %i.bp, <8 x float> %predphi77
  %predphi79 = select nsz <8 x i1> %i.bs, <8 x float> %i.bt, <8 x float> %predphi78
  %predphi80 = select nsz <8 x i1> %i.al, <8 x float> %i.au, <8 x float> zeroinitializer
  %i.bx = fmul reassoc nsz arcp contract afn <8 x float> %predphi80, %broadcast.splat ; 3 uses
  ...
  %i.cw = fmul reassoc nsz arcp contract afn <8 x float> %predphi79, splat (float 6.000000e+00) ; 8 uses
...
bb.k:                                             ; preds = %bb.j, %bb.i, %bb.h, %bb.f
  %.0.i.a = phi nsz float [ %i.gu, %bb.f ], [ %i.gy, %bb.h ], [ %i.hc, %bb.j ], [ 0.000000e+00, %bb.i ]
  %i.hd = fpext reassoc nsz arcp contract afn float %.0.i.a to double
...
rgb2hsl.exit:                                     ; preds = %.lr.ph, %bb.l, %bb.m, %bb.n
  %.043.i = phi nsz float [ %i.hh, %bb.l ], [ %i.hj, %bb.n ], [ %i.hf, %bb.m ], [ 0.000000e+00, %.lr.ph ]
  %.1.i = phi nsz float [ %i.gr, %bb.l ], [ %i.gr, %bb.n ], [ %i.gr, %bb.m ], [ 0.000000e+00, %.lr.ph ]
  %i.hk = fmul reassoc nsz arcp contract afn float %.1.i, %i.m ; 3 uses
...
bb.s:                                             ; preds = %bb.r, %bb.q
  ...
  %i.il = fmul reassoc nsz arcp contract afn float %.043.i, 6.000000e+00 ; 8 uses
