...
bb.b:                                             ; preds = %bb.a
  ...
  %i.ae = insertelement <2 x float> %i.ad, float %6, i64 1 ; 2 uses
  %9 = shufflevector <2 x float> %i.ae, <2 x float> poison, <2 x i32> <i32 1, i32 0>
...
bb.d:                                             ; preds = %bb.b, %bb.d
  ...
  %i.ay = fsub reassoc nsz arcp contract afn <2 x float> %i.ax, %i.ae ; 2 uses
  ...
  %i.bd = fadd reassoc nsz arcp contract afn <2 x float> %9, %i.bc
