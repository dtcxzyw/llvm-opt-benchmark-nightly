Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/darktable/original/AbstractDngDecompressor?download=true
...
bb.u:                                             ; preds = %bb.t, %bb.s
  ...
  %.022 = extractvalue { ptr, i32 } %.pn, 1       ; 2 uses
  %.023 = extractvalue { ptr, i32 } %.pn, 0       ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #22
  %i.co = call i32 @llvm.eh.typeid.for.p0(ptr nonnull @_ZTIN8rawspeed19RawDecoderExceptionE) #22
  %i.cp = icmp eq i32 %.022, %i.co
  br i1 %i.cp, label %bb.v, label %bb.z

bb.v:                                             ; preds = %bb.u
  %i.cq = call ptr @__cxa_begin_catch(ptr %.023) #22 ; 2 uses
...
bb.k:                                             ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit22.invoke, %bb.d
  %i.am = getelementptr inbounds nuw i8, ptr %.01827, i64 72 ; 2 uses
...
bb.l:                                             ; preds = %_ZN8rawspeed8RawImageD2Ev.exit
  ...
  %.018 = extractvalue { ptr, i32 } %i.bd, 1      ; 2 uses
  %.019 = extractvalue { ptr, i32 } %i.bd, 0      ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %1) #22
  %i.be = call i32 @llvm.eh.typeid.for.p0(ptr nonnull @_ZTIN8rawspeed19RawDecoderExceptionE) #22
  %i.bf = icmp eq i32 %.018, %i.be
  br i1 %i.bf, label %bb.m, label %bb.q

bb.m:                                             ; preds = %bb.l
  %i.bg = call ptr @__cxa_begin_catch(ptr %.019) #22 ; 2 uses
...
bb.q:                                             ; preds = %bb.l
  ...
  %i.bt = icmp eq i32 %.018, %i.bs
  %i.bu = call ptr @__cxa_begin_catch(ptr %.019) #22
