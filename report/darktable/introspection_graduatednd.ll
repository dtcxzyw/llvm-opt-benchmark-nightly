...
bb.c:                                             ; preds = %bb.f, %bb.b
  %.085.i = phi nsz float [ %i.bc, %bb.b ], [ %.085..i.1, %bb.f ] ; 2 uses
  %.083.i = phi i32 [ 0, %bb.b ], [ %i.bp, %bb.f ] ; 4 uses
  %.182.i = phi nsz float [ f0x4055A0D9, %bb.b ], [ %.182..i.1, %bb.f ] ; 2 uses
  %.079.i = phi nsz float [ f0xC0490FDB, %bb.b ], [ %..079.i.1, %bb.f ] ; 2 uses
  %i.bd = fadd reassoc nsz arcp contract afn float %.079.i, %.182.i
  ...
  %reass.mul107.i = fmul reassoc nsz arcp contract afn float %cos.i, %reass.add106.i
  %reass.mul109.i = fmul reassoc nsz arcp contract afn float %sin.i, %reass.add108.i
  %i.bf = fadd reassoc nsz arcp contract afn float %reass.mul109.i, %reass.mul107.i ; 3 uses
...
bb.d:                                             ; preds = %bb.c
  %i.bh = fmul reassoc nsz arcp contract afn float %i.bf, %.085.i
  %i.bi = fcmp reassoc nsz arcp contract afn olt float %i.bh, 0.000000e+00 ; 3 uses
  %.085..i = select nsz i1 %i.bi, float %.085.i, float %i.bf ; 2 uses
  %.182..i = select nsz i1 %i.bi, float %.182.i, float %i.be ; 2 uses
  %..079.i = select nsz i1 %i.bi, float %i.be, float %.079.i ; 2 uses
  %exitcond.not.i = icmp eq i32 %.083.i, 1000
  br i1 %exitcond.not.i, label %_set_grad_from_points.exit, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.bj = fadd reassoc nsz arcp contract afn float %..079.i, %.182..i
  ...
  %reass.mul107.i.1 = fmul reassoc nsz arcp contract afn float %cos.i.1, %reass.add106.i
  %reass.mul109.i.1 = fmul reassoc nsz arcp contract afn float %sin.i.1, %reass.add108.i
  %i.bl = fadd reassoc nsz arcp contract afn float %reass.mul109.i.1, %reass.mul107.i.1 ; 3 uses
...
bb.f:                                             ; preds = %bb.e
  %i.bn = fmul reassoc nsz arcp contract afn float %i.bl, %.085..i
  %i.bo = fcmp reassoc nsz arcp contract afn olt float %i.bn, 0.000000e+00 ; 3 uses
  %.085..i.1 = select nsz i1 %i.bo, float %.085..i, float %i.bl
  %.182..i.1 = select nsz i1 %i.bo, float %.182..i, float %i.bk
  %..079.i.1 = select nsz i1 %i.bo, float %i.bk, float %..079.i
  %i.bp = add nuw nsw i32 %.083.i, 2
  br label %bb.c

.split.loop.exit:                                 ; preds = %bb.e
  %i.bq = or disjoint i32 %.083.i, 1
  br label %.split.loop.exit36

.split.loop.exit36:                               ; preds = %bb.c, %.split.loop.exit
  %.083.i.lcssa = phi i32 [ %i.bq, %.split.loop.exit ], [ %.083.i, %bb.c ]
  %.lcssa = phi float [ %i.bk, %.split.loop.exit ], [ %i.be, %bb.c ] ; 7 uses
  %i.br = icmp samesign ugt i32 %.083.i.lcssa, 999
  br i1 %i.br, label %_set_grad_from_points.exit, label %bb.g

bb.g:                                             ; preds = %.split.loop.exit36
  %i.bs = fcmp reassoc nsz arcp contract afn ogt float %reass.add108.i, f0x38D1B717
...
bb.h:                                             ; preds = %bb.g
  ...
  %.087.i = select nsz i1 %i.bt, float %.lcssa, float %i.bu ; 3 uses
  %i.bv = fcmp reassoc nsz arcp contract afn olt float %.087.i, f0xBFC90FDB
  br i1 %i.bv, label %bb.i, label %bb.m

bb.i:                                             ; preds = %bb.h
  %i.bw = fadd reassoc nsz arcp contract afn float %.087.i, f0x40490FDB
  br label %bb.m

bb.j:                                             ; preds = %bb.g
  %i.bx = fcmp reassoc nsz arcp contract afn olt float %reass.add108.i, f0xB8D1B717
...
bb.m:                                             ; preds = %bb.l, %bb.k, %bb.i, %bb.h
  %.3.i = phi nsz float [ %i.bw, %bb.i ], [ %.087.i, %bb.h ], [ %..i, %bb.l ], [ %spec.select98.i, %bb.k ] ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.at = fadd reassoc nsz arcp contract afn float %cos, -1.000000e+00
  %i.au = fadd reassoc nsz arcp contract afn float %i.at, %i.ad
  %i.av = fadd reassoc nsz arcp contract afn float %i.au, %i.as ; 2 uses
  %i.aw = fmul reassoc nsz arcp contract afn float %sin, %i.u
  %i.ax = fmul reassoc nsz arcp contract afn float %i.aw, %i.ak ; 6 uses
  %i.ay = load float, ptr %i.e, align 16, !tbaa !162 ; 4 uses
...
.lr.ph240:                                        ; preds = %.preheader201
  ...
  %6 = insertelement <4 x float> poison, float %i.ax, i64 0
  %7 = shufflevector <4 x float> %6, <4 x float> poison, <4 x i32> zeroinitializer
  %8 = fmul reassoc nsz arcp contract afn <4 x float> %7, <float 0.000000e+00, float 1.000000e+00, float 2.000000e+00, float 3.000000e+00>
  %invariant.op418 = add nsw i64 %i.br, -3
  %9 = insertelement <4 x float> poison, float %i.ay, i64 0
...
._crit_edge229:                                   ; preds = %.lr.ph228, %bb.c
  %.0183.lcssa = phi float [ %i.cf, %bb.c ], [ %i.dt, %.lr.ph228 ]
...
.lr.ph228:                                        ; preds = %bb.c, %.lr.ph228
  ...
  %.0183226 = phi float [ %i.dt, %.lr.ph228 ], [ %i.cf, %bb.c ] ; 2 uses
  %i.cg = fadd reassoc nsz arcp contract afn float %.0183226, 5.000000e-01
  %11 = insertelement <4 x float> poison, float %i.cg, i64 0
  %12 = shufflevector <4 x float> %11, <4 x float> poison, <4 x i32> zeroinitializer
  %13 = fadd reassoc nsz arcp contract afn <4 x float> %12, %8 ; 3 uses
  %14 = fcmp reassoc nsz arcp contract afn ole <4 x float> %13, splat (float 1.000000e+00)
  %15 = select <4 x i1> %14, <4 x float> %13, <4 x float> splat (float 1.000000e+00)
  %16 = fcmp reassoc nsz arcp contract afn ult <4 x float> %13, zeroinitializer
  %17 = select <4 x i1> %16, <4 x float> zeroinitializer, <4 x float> %15
  %18 = fmul reassoc nsz arcp contract afn <4 x float> %17, %10 ; 4 uses
  ...
  %i.ci = tail call reassoc nsz arcp contract afn float @llvm.exp2.f32(float %20)
  %21 = extractelement <4 x float> %18, i64 2
  %22 = tail call reassoc nsz arcp contract afn float @llvm.exp2.f32(float %21)
  %23 = extractelement <4 x float> %18, i64 3
  %i.cj = tail call reassoc nsz arcp contract afn float @llvm.exp2.f32(float %23)
  ...
  %i.cm = insertelement <4 x float> poison, float %i.ch, i64 0
  ...
  %i.de = insertelement <4 x float> poison, float %22, i64 0
  ...
  %i.dt = fadd reassoc nsz arcp contract afn float %.0183226, %i.bu ; 2 uses
...
.lr.ph237:                                        ; preds = %._crit_edge229, %.lr.ph237
  ...
  %.1184235 = phi float [ %i.ek, %.lr.ph237 ], [ %.0183.lcssa, %._crit_edge229 ] ; 2 uses
  %i.dv = fadd reassoc nsz arcp contract afn float %.1184235, 5.000000e-01 ; 3 uses
  ...
  %i.ek = fadd reassoc nsz arcp contract afn float %.1184235, %i.ax
...
._crit_edge:                                      ; preds = %.lr.ph, %bb.d
  %.0182.lcssa = phi float [ %i.eu, %bb.d ], [ %i.gv, %.lr.ph ]
  br i1 %.not242, label %._crit_edge216, label %.lr.ph215

.lr.ph:                                           ; preds = %bb.d, %.lr.ph
  %indvars.iv = phi i64 [ %indvars.iv.next, %.lr.ph ], [ 0, %bb.d ] ; 5 uses
  %.0182207 = phi float [ %i.gv, %.lr.ph ], [ %i.eu, %bb.d ] ; 2 uses
  %i.ev = insertelement <4 x float> poison, float %.0182207, i64 0
  ...
  %i.gv = fadd reassoc nsz arcp contract afn float %.0182207, %i.bj ; 2 uses
...
.lr.ph215:                                        ; preds = %._crit_edge, %.lr.ph215
  ...
  %.1212 = phi float [ %i.hm, %.lr.ph215 ], [ %.0182.lcssa, %._crit_edge ] ; 2 uses
