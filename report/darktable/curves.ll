...
vector.body492:                                   ; preds = %vector.body492, %vector.ph488
  ...
  %4 = fadd reassoc nsz arcp contract afn <8 x float> %i.nf, %wide.masked.load496
  %5 = fadd reassoc nsz arcp contract afn <8 x float> %4, %i.nc
...
bb.e:                                             ; preds = %bb.d
  ...
  %6 = fadd reassoc nsz arcp contract afn float %i.oq, %i.nz
  %7 = fadd reassoc nsz arcp contract afn float %6, %i.on
...
bb.e:                                             ; preds = %bb.c
  ...
  %5 = fsub reassoc nsz arcp contract afn double %i.cv, %.neg89
  %reass.mul = fmul reassoc nsz arcp contract afn double %5, %.sroa.43.0
  %6 = fadd reassoc nsz arcp contract afn double %.sroa.43.0, %.sroa.28.1
  %7 = fsub reassoc nsz arcp contract afn double 1.000000e+00, %6
  %i.cy = fadd reassoc nsz arcp contract afn double %7, %reass.mul
  br label %bb.f
