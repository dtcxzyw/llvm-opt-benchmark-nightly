...
begin_hunk_0_@set_new_params_interactive:bb.a
  ...
  %i.ci = fadd reassoc nsz arcp contract afn <2 x float> %i.ch, %i.cb
  ...
  %i.cp = fadd reassoc nsz arcp contract afn <2 x float> %i.co, %i.ci
  ...
  %i.dd = fadd reassoc nsz arcp contract afn <2 x float> %i.dc, %i.cw
  ...
  %i.dk = fadd reassoc nsz arcp contract afn <2 x float> %i.dj, %i.dd
