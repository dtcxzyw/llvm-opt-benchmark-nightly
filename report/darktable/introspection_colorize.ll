...
bb.a:
  ...
  %i.bw = sitofp reassoc nsz arcp contract afn <4 x i32> %i.bv to <4 x float> ; 6 uses
...
dt_XYZ_to_sRGB.exit:                              ; preds = %bb.b, %bb.c
  ...
  %.sroa.014.8.vec.extract.i.i.i = extractelement <4 x float> %i.bw, i64 2
  ...
  %3 = fptosi float %.sroa.014.8.vec.extract.i.i.i to i32
  %4 = shl i32 %3, 23
  %5 = add i32 %4, 1065353216
  %6 = bitcast i32 %5 to float
  %.sroa.014.4.vec.extract.i.i.i = extractelement <4 x float> %i.bw, i64 1
  ...
  %7 = fptosi float %.sroa.014.4.vec.extract.i.i.i to i32
  %8 = shl i32 %7, 23
  %9 = add i32 %8, 1065353216
  ...
  %i.do = fmul reassoc nnan nsz arcp contract afn float %10, 1.055000e+00
  ...
  %i.dt = fmul reassoc nnan nsz arcp contract afn float %6, 1.055000e+00
