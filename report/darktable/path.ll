...
bb.cc:                                            ; preds = %.lr.ph.i.epil.preheader
  ...
  %i.sq = fmul reassoc nsz arcp contract afn float %sin17.i.epil, %.08319.i.epil
  %i.sr = fmul reassoc nsz arcp contract afn float %cos18.i.epil, %.08319.i.epil
...
.critedge427:                                     ; preds = %.critedge427.loopexit.unr-lcssa, %bb.cc, %.lr.ph.i.epil.preheader, %dt_masks_dynbuf_reserve_n.exit106.i, %bb.bo, %_path_is_clockwise.exit527, %dt_masks_dynbuf_add_2.exit506.thread, %bb.bk, %dt_masks_dynbuf_add_2.exit513
  ...
  br i1 %exitcond.not, label %._crit_edge618, label %bb.an
...
bb.ci:                                            ; preds = %bb.ch
  ...
  %or.cond.i537 = or i1 %.not627, %i.tt
...
bb.cj:                                            ; preds = %bb.ci
  ...
  br i1 %i.tw, label %.lr.ph.i548, label %bb.ck

.lr.ph.i548:                                      ; preds = %bb.cj
  %i.tx = sext i32 %i.tu to i64
  %wide.trip.count.i = sext i32 %i.ts to i64
  br label %bb.cl

._crit_edge.i550:                                 ; preds = %bb.co
  %i.ty = add nsw <2 x i32> %i.vs, splat (i32 1)
  br label %bb.ck

bb.ck:                                            ; preds = %._crit_edge.i550, %bb.cj
  %.sroa.16.0.i = phi i32 [ %.0232379392.i, %._crit_edge.i550 ], [ 0, %bb.cj ] ; 2 uses
  %.sroa.13.0.i = phi i32 [ %.0232379389.i, %._crit_edge.i550 ], [ 0, %bb.cj ] ; 2 uses
  %.sroa.6.0.i = phi i32 [ %.0232379386.i, %._crit_edge.i550 ], [ 0, %bb.cj ] ; 18 uses
  %.0232373.lcssa.i = phi i32 [ %.0232372.i, %._crit_edge.i550 ], [ -1, %bb.cj ] ; 2 uses
  %i.tz = phi <2 x i32> [ %i.ty, %._crit_edge.i550 ], [ splat (i32 -2147483647), %bb.cj ]
  %i.ua = phi <2 x i32> [ %i.vq, %._crit_edge.i550 ], [ splat (i32 2147483647), %bb.cj ] ; 3 uses
  %.not.i.i538 = icmp slt i32 %.0232373.lcssa.i, %.sroa.6.0.i
  %i.ub = select i1 %.not.i.i538, i32 %i.tv, i32 0
  %i.uc = add nsw i32 %i.ub, %.0232373.lcssa.i
...
bb.cl:                                            ; preds = %bb.co, %.lr.ph.i548
  %indvars.iv.i = phi i64 [ %i.tx, %.lr.ph.i548 ], [ %indvars.iv.next.i, %bb.co ] ; 3 uses
  %.0232379391.i = phi i32 [ 0, %.lr.ph.i548 ], [ %.0232379392.i, %bb.co ]
  %.0232379388.i = phi i32 [ 0, %.lr.ph.i548 ], [ %.0232379389.i, %bb.co ]
  %.0232379385.i = phi i32 [ 0, %.lr.ph.i548 ], [ %.0232379386.i, %bb.co ]
  %.0232373374.i = phi i32 [ -1, %.lr.ph.i548 ], [ %.0232372.i, %bb.co ]
  %i.ut = phi <2 x i32> [ splat (i32 -2147483648), %.lr.ph.i548 ], [ %i.vs, %bb.co ] ; 2 uses
  %i.uu = phi <2 x i32> [ splat (i32 2147483647), %.lr.ph.i548 ], [ %i.vq, %bb.co ] ; 2 uses
...
bb.co:                                            ; preds = %bb.cn, %bb.cm
  ...
  %.0232372.i = select i1 %i.vm, i32 %i.vj, i32 %.0232373374.i ; 2 uses
  %i.vn = fcmp reassoc nsz arcp contract afn ogt <2 x float> %i.vg, %i.vk ; 3 uses
  %i.vo = extractelement <2 x i1> %i.vn, i64 1
  %.0232379386.i = select i1 %i.vo, i32 %i.vj, i32 %.0232379385.i ; 2 uses
  %i.vp = extractelement <2 x i1> %i.vl, i64 0
  %.0232379389.i = select i1 %i.vp, i32 %i.vj, i32 %.0232379388.i ; 2 uses
  %i.vq = select <2 x i1> %i.vl, <2 x i32> %i.vi, <2 x i32> %i.uu ; 2 uses
  %i.vr = extractelement <2 x i1> %i.vn, i64 0
  %.0232379392.i = select i1 %i.vr, i32 %i.vj, i32 %.0232379391.i ; 2 uses
  %i.vs = select <2 x i1> %i.vn, <2 x i32> %i.vi, <2 x i32> %i.ut ; 2 uses
  %indvars.iv.next.i = add nsw i64 %indvars.iv.i, 1 ; 2 uses
  %exitcond.not.i549 = icmp eq i64 %indvars.iv.next.i, %wide.trip.count.i
  br i1 %exitcond.not.i549, label %._crit_edge.i550, label %bb.cl
...
bb.cr:                                            ; preds = %bb.cq
  ...
  br i1 %i.tw, label %.lr.ph418.i, label %.thread349.i

.lr.ph418.i:                                      ; preds = %bb.cr
  %i.vy = shl i32 %.sroa.6.0.i, 1                 ; 2 uses
  %i.vz = add i32 %i.vy, -1
  ...
  %i.wr = insertelement <4 x i32> %i.wq, i32 %.sroa.6.0.i, i64 1
  ...
  %invariant.op945 = sub i32 1, %i.wu
  %invariant.op946 = sub i32 1, %i.wv
  br label %bb.cs

bb.cs:                                            ; preds = %._crit_edge409.i, %.lr.ph418.i
  %.0219416.i = phi i32 [ %i.tu, %.lr.ph418.i ], [ %i.agj, %._crit_edge409.i ] ; 2 uses
  %.0220415.i = phi i32 [ %i.wd, %.lr.ph418.i ], [ %.1221.lcssa.i, %._crit_edge409.i ] ; 6 uses
  %.0222414.i = phi i32 [ %i.wi, %.lr.ph418.i ], [ %.1223.lcssa.i, %._crit_edge409.i ] ; 7 uses
  %.0241413.i = phi i32 [ 0, %.lr.ph418.i ], [ %.1242.lcssa.i, %._crit_edge409.i ] ; 4 uses
  %.reass.i = add i32 %.0219416.i, %invariant.op.i ; 2 uses
  ...
  %.not277.i = icmp slt i32 %.0241413.i, %i.wj
...
dt_masks_dynbuf_add_2.exit.i.i:                   ; preds = %bb.cw, %bb.cv, %bb.cu
  ...
  %i.xm = sub nsw i32 %i.xl, %.0222414.i          ; 4 uses
...
.preheader147.i.i:                                ; preds = %dt_masks_dynbuf_add_2.exit.i.i
  %.077169.i.i = add nsw i32 %i.xl, -1
  %i.xo = extractelement <2 x i32> %i.xb, i64 1
  %i.xp = sub nsw i32 %i.xo, %.0220415.i
  %i.xq = uitofp nneg i32 %i.xm to float
  %i.xr = sitofp reassoc nsz arcp contract afn i32 %.0220415.i to float
...
.loopexit.i.i:                                    ; preds = %dt_masks_dynbuf_add_2.exit106.i.i, %.preheader147.i.i
  %.077170.i.i = phi i32 [ %.077169.i.i, %.preheader147.i.i ], [ %.077.i.i, %dt_masks_dynbuf_add_2.exit106.i.i ] ; 3 uses
  %i.xt = sub nsw i32 %.077170.i.i, %.0222414.i
...
bb.cz:                                            ; preds = %._crit_edge.i102.i.i, %.loopexit.i.i
  %.pre-phi.i105.i.i = phi i64 [ %.pre12.i104.i.i, %._crit_edge.i102.i.i ], [ %i.ya, %.loopexit.i.i ]
  %i.yg = phi i64 [ %.pre.i103.i.i, %._crit_edge.i102.i.i ], [ %.val85.i.i, %.loopexit.i.i ]
...
dt_masks_dynbuf_add_2.exit106.i.i:                ; preds = %bb.cz, %bb.cy, %bb.cx
  ...
  %i.yk = icmp sgt i32 %.077.i.i, %.0222414.i
  br i1 %i.yk, label %.loopexit.i.i, label %_path_fill_gaps.exit.i
...
.preheader153.i.i:                                ; preds = %bb.da
  ...
  %i.yn = sub nsw i32 %i.ym, %.0220415.i
  %i.yo = sitofp reassoc nsz arcp contract afn i32 %i.xm to float
  %i.yp = sitofp reassoc nsz arcp contract afn i32 %.0220415.i to float
...
.loopexit150.i.i:                                 ; preds = %dt_masks_dynbuf_add_2.exit127.i.i, %.preheader153.i.i
  ...
  %i.yr = sub nsw i32 %.074161.i.i, %.0222414.i
...
bb.dd:                                            ; preds = %._crit_edge.i123.i.i, %.loopexit150.i.i
  %.pre-phi.i126.i.i = phi i64 [ %.pre12.i125.i.i, %._crit_edge.i123.i.i ], [ %i.yy, %.loopexit150.i.i ]
  %i.ze = phi i64 [ %.pre.i124.i.i, %._crit_edge.i123.i.i ], [ %.val83.i.i, %.loopexit150.i.i ]
...
dt_masks_dynbuf_add_2.exit127.i.i:                ; preds = %bb.dd, %bb.dc, %bb.db
  ...
  %exitcond175.not.i.i = icmp eq i32 %.074.i.i, %.0222414.i
...
_path_fill_gaps.exit.i:                           ; preds = %dt_masks_dynbuf_add_2.exit127.i.i, %dt_masks_dynbuf_add_2.exit106.i.i, %bb.da
  ...
  %.0217403.i = add i32 %i.zj, -1                 ; 2 uses
  %i.zk = icmp sgt i32 %.0217403.i, -1
  br i1 %i.zk, label %.lr.ph408.i, label %._crit_edge409.i

.lr.ph408.i:                                      ; preds = %_path_fill_gaps.exit.i
  %i.zl = add nsw i32 %spec.select.i540, -1
  %.not.i294.i = icmp slt i32 %spec.select.i540, %.sroa.6.0.i
  ...
  %i.zr = zext nneg i32 %.0217403.i to i64
  %broadcast.splatinsert805 = insertelement <8 x i32> poison, i32 %i.zn, i64 0
  %broadcast.splat806 = shufflevector <8 x i32> %broadcast.splatinsert805, <8 x i32> poison, <8 x i32> zeroinitializer ; 8 uses
  %broadcast.splatinsert828 = insertelement <8 x i32> poison, i32 %i.zn, i64 0
  %broadcast.splat829 = shufflevector <8 x i32> %broadcast.splatinsert828, <8 x i32> poison, <8 x i32> zeroinitializer ; 2 uses
  br label %bb.de

bb.de:                                            ; preds = %bb.ei, %.lr.ph408.i
  %indvars.iv460.i = phi i64 [ %i.zr, %.lr.ph408.i ], [ %indvars.iv.next461.i, %bb.ei ] ; 3 uses
  %.1221406.i = phi i32 [ %.0220415.i, %.lr.ph408.i ], [ %.2.ph.i, %bb.ei ] ; 2 uses
  %.1223405.i = phi i32 [ %.0222414.i, %.lr.ph408.i ], [ %.2224.ph.i, %bb.ei ] ; 2 uses
  %.1242404.i = phi i32 [ %.0241413.i, %.lr.ph408.i ], [ %.8.ph.i, %bb.ei ] ; 2 uses
  %.val290.i = load ptr, ptr %i.vw, align 8, !tbaa !234
  %.idx506.i = shl nuw nsw i64 %indvars.iv460.i, 3
  %i.zs = getelementptr inbounds nuw i8, ptr %.val290.i, i64 %.idx506.i ; 2 uses
  ...
  %.reass.reass = add i32 %i.zx, %invariant.op945
  %i.zy = mul nsw i32 %.reass.reass, %i.un
  %.reass786.reass = add i32 %i.zu, %invariant.op946
  %i.zz = add nsw i32 %.reass786.reass, %i.zy     ; 3 uses
...
bb.dg:                                            ; preds = %bb.df
  %i.aad = icmp eq i32 %.1223405.i, %i.zu
  %i.aae = icmp eq i32 %.1221406.i, %i.zx
...
bb.dk:                                            ; preds = %bb.dj, %bb.di
  ...
  br i1 %.not279.i, label %.preheader908, label %bb.dl

.preheader908:                                    ; preds = %bb.dl, %bb.dk
  br label %bb.dn
...
bb.dn:                                            ; preds = %.preheader908, %_check_cutable.exit.thread.i
  %indvars.iv456.i = phi i64 [ %indvars.iv.next457.i.a, %_check_cutable.exit.thread.i ], [ 0, %.preheader908 ] ; 2 uses
  %.2243401.i = phi i32 [ %.7.i, %_check_cutable.exit.thread.i ], [ %.1242404.i, %.preheader908 ] ; 10 uses
  %i.aao = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %indvars.iv456.i
...
bb.dq:                                            ; preds = %bb.do
  %.not.i293.i = icmp slt i32 %i.aap, %.sroa.6.0.i
...
vector.main.loop.iter.check:                      ; preds = %iter.check
  %min.iters.check804 = icmp ult i64 %i.aax, 63
  br i1 %min.iters.check804, label %vec.epilog.ph, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi807 = phi <8 x float> [ zeroinitializer, %vector.ph ], [ %predphi820, %vector.body ] ; 2 uses
  ...
  %strided.vec810 = shufflevector <16 x i32> %wide.vec, <16 x i32> poison, <8 x i32> <i32 1, i32 3, i32 5, i32 7, i32 9, i32 11, i32 13, i32 15> ; 2 uses
  %wide.vec811 = load <16 x i32>, ptr %i.abh, align 4, !tbaa !28 ; 2 uses
  %strided.vec812 = shufflevector <16 x i32> %wide.vec811, <16 x i32> poison, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14> ; 2 uses
  %strided.vec813 = shufflevector <16 x i32> %wide.vec811, <16 x i32> poison, <8 x i32> <i32 1, i32 3, i32 5, i32 7, i32 9, i32 11, i32 13, i32 15> ; 2 uses
  %wide.vec814 = load <16 x i32>, ptr %i.abj, align 4, !tbaa !28 ; 2 uses
  %strided.vec815 = shufflevector <16 x i32> %wide.vec814, <16 x i32> poison, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14> ; 2 uses
  %strided.vec816 = shufflevector <16 x i32> %wide.vec814, <16 x i32> poison, <8 x i32> <i32 1, i32 3, i32 5, i32 7, i32 9, i32 11, i32 13, i32 15> ; 2 uses
  %wide.vec817 = load <16 x i32>, ptr %i.abl, align 4, !tbaa !28 ; 2 uses
  %strided.vec818 = shufflevector <16 x i32> %wide.vec817, <16 x i32> poison, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14> ; 2 uses
  %strided.vec819 = shufflevector <16 x i32> %wide.vec817, <16 x i32> poison, <8 x i32> <i32 1, i32 3, i32 5, i32 7, i32 9, i32 11, i32 13, i32 15> ; 2 uses
  %i.abm = icmp slt <8 x i32> %strided.vec810, %broadcast.splat
  %i.abn = icmp slt <8 x i32> %strided.vec813, %broadcast.splat
  %i.abo = icmp slt <8 x i32> %strided.vec816, %broadcast.splat
  %i.abp = icmp slt <8 x i32> %strided.vec819, %broadcast.splat
  %i.abq = icmp sgt <8 x i32> %strided.vec, %broadcast.splat806
  %i.abr = icmp sgt <8 x i32> %strided.vec812, %broadcast.splat806
  %i.abs = icmp sgt <8 x i32> %strided.vec815, %broadcast.splat806
  %i.abt = icmp sgt <8 x i32> %strided.vec818, %broadcast.splat806
  ...
  %i.aby = call <8 x i32> @llvm.smin.v8i32(<8 x i32> %broadcast.splat806, <8 x i32> %strided.vec810)
  %i.abz = call <8 x i32> @llvm.smin.v8i32(<8 x i32> %broadcast.splat806, <8 x i32> %strided.vec813)
  %i.aca = call <8 x i32> @llvm.smin.v8i32(<8 x i32> %broadcast.splat806, <8 x i32> %strided.vec816)
  %i.acb = call <8 x i32> @llvm.smin.v8i32(<8 x i32> %broadcast.splat806, <8 x i32> %strided.vec819)
  %i.acc = call <8 x i32> @llvm.smax.v8i32(<8 x i32> %broadcast.splat, <8 x i32> %strided.vec)
  %i.acd = call <8 x i32> @llvm.smax.v8i32(<8 x i32> %broadcast.splat, <8 x i32> %strided.vec812)
  %i.ace = call <8 x i32> @llvm.smax.v8i32(<8 x i32> %broadcast.splat, <8 x i32> %strided.vec815)
  %i.acf = call <8 x i32> @llvm.smax.v8i32(<8 x i32> %broadcast.splat, <8 x i32> %strided.vec818)
