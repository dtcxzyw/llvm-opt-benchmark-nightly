...
bb.ck:                                            ; preds = %._crit_edge.i553, %bb.cj
  ...
  %.sroa.6461.0.i = phi i32 [ %.0232375382.i, %._crit_edge.i553 ], [ 0, %bb.cj ] ; 18 uses
  %.0232369.lcssa.i = phi i32 [ %spec.select418.i, %._crit_edge.i553 ], [ -1, %bb.cj ] ; 2 uses
  ...
  %.not.i.i538 = icmp slt i32 %.0232369.lcssa.i, %.sroa.6461.0.i
  ...
  %i.ug = add i32 %i.tv, -1
  %i.uh = add i32 %i.ug, %.sroa.6461.0.i          ; 2 uses
...
bb.co:                                            ; preds = %bb.cn, %bb.cm
  ...
  %spec.select418.i = select i1 %i.vl, i32 %i.vi, i32 %.0232369370.i ; 2 uses
...
.lr.ph414.i:                                      ; preds = %bb.cr
  %i.vx = shl i32 %.sroa.6461.0.i, 1              ; 2 uses
  %i.vy = add i32 %i.vx, -1
  ...
  %i.wq = insertelement <4 x i32> %i.wp, i32 %.sroa.6461.0.i, i64 1
