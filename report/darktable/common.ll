...
bb.a:
  ...
  store double -1.000000e+00, ptr %i.as, align 16, !tbaa !33
  ...
  store <2 x double> %i.bk, ptr %i.bh, align 16, !tbaa !33
  %i.bl = getelementptr inbounds nuw i8, ptr %i.a, i64 208
  store double %i.m, ptr %i.bl, align 16, !tbaa !33
  ...
  store <2 x double> %i.bc, ptr %i.bp, align 16, !tbaa !33
  %i.br = getelementptr inbounds nuw i8, ptr %i.a, i64 256 ; 2 uses
  store double -1.000000e+00, ptr %i.br, align 16, !tbaa !33
  ...
  store <2 x double> %i.cj, ptr %i.cg, align 16, !tbaa !33
  %i.ck = getelementptr inbounds nuw i8, ptr %i.a, i64 352
  store double %i.s, ptr %i.ck, align 16, !tbaa !33
  ...
  store <2 x double> %i.cb, ptr %i.co, align 16, !tbaa !33
  %i.cq = getelementptr inbounds nuw i8, ptr %i.a, i64 400 ; 2 uses
  store double -1.000000e+00, ptr %i.cq, align 16, !tbaa !33
  ...
  store <2 x double> %i.dk, ptr %i.dg, align 16, !tbaa !33
  %i.dl = getelementptr inbounds nuw i8, ptr %i.a, i64 496 ; 2 uses
  store double %i.y, ptr %i.dl, align 16, !tbaa !33
  ...
  store <2 x double> %i.db, ptr %i.dp, align 16, !tbaa !33
  %i.dr = getelementptr inbounds nuw i8, ptr %i.a, i64 544 ; 2 uses
  store double -1.000000e+00, ptr %i.dr, align 16, !tbaa !33
  ...
  store <2 x double> %i.dw, ptr %i.ds, align 8, !tbaa !33
  %i.dx = getelementptr inbounds nuw i8, ptr %i.a, i64 568 ; 2 uses
  store double %i.ab, ptr %i.dx, align 8, !tbaa !33
  ...
  store double 1.000000e+00, ptr %i.eg, align 16, !tbaa !33
  ...
  store double 1.000000e+00, ptr %i.eh, align 16, !tbaa !33
  ...
  store i32 8, ptr %i.ej, align 4, !tbaa !34
...
bb.b:                                             ; preds = %.loopexit.i.i, %bb.a
  ...
  %i.ek = sub nsw i64 8, %indvars.iv143.i.i       ; 3 uses
  %i.el = sub nsw i64 8, %indvars.iv143.i.i       ; 3 uses
  %i.em = shl nuw nsw i64 %indvars.iv143.i.i, 3
  %3 = getelementptr nuw i8, ptr %i.a, i64 %i.em
  %scevgep98 = getelementptr nuw i8, ptr %3, i64 8
  %i.en = mul nuw nsw i64 %indvars.iv143.i.i, 80
  %i.eo = getelementptr nuw i8, ptr %i.a, i64 %i.en
  %scevgep102 = getelementptr nuw i8, ptr %i.eo, i64 8
  %i.ep = mul nuw nsw i64 %indvars.iv143.i.i, 72
  %4 = getelementptr nuw i8, ptr %i.a, i64 %i.ep
  %scevgep103 = getelementptr nuw i8, ptr %4, i64 72
  ...
  %5 = getelementptr nuw i8, ptr %i.a, i64 %i.ew
  %scevgep92 = getelementptr nuw i8, ptr %5, i64 72
  %indvars.iv.next144.i.i = add nuw nsw i64 %indvars.iv143.i.i, 1 ; 2 uses
  %i.ex = icmp samesign ult i64 %indvars.iv143.i.i, 8 ; 2 uses
  %i.ey = trunc nuw nsw i64 %indvars.iv143.i.i to i32 ; 3 uses
  br i1 %i.ex, label %.lr.ph.preheader.i.i, label %._crit_edge.i.i

.lr.ph.preheader.i.i:                             ; preds = %bb.b
  %i.ez = sub nsw i64 0, %indvars.iv143.i.i
...
.lr.ph.i.i.prol:                                  ; preds = %.lr.ph.preheader.i.i, %.lr.ph.i.i.prol
  ...
  %.0100112.i.i.prol = phi i32 [ %spec.select.i.i.prol, %.lr.ph.i.i.prol ], [ %i.ey, %.lr.ph.preheader.i.i ] ; 2 uses
  ...
  %i.fi = trunc nuw nsw i64 %indvars.iv124.i.i.prol to i32
  %spec.select.i.i.prol = select i1 %i.fh, i32 %i.fi, i32 %.0100112.i.i.prol ; 3 uses
...
.lr.ph.i.i.prol.loopexit:                         ; preds = %.lr.ph.i.i.prol, %.lr.ph.preheader.i.i
  ...
  %.0100112.i.i.unr = phi i32 [ %i.ey, %.lr.ph.preheader.i.i ], [ %spec.select.i.i.prol, %.lr.ph.i.i.prol ]
  %i.fj = icmp ugt i64 %indvars.iv143.i.i, 4
  br i1 %i.fj, label %._crit_edge.i.i, label %.lr.ph.i.i

._crit_edge.i.i:                                  ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i, %bb.b
  %.0100.lcssa.i.i = phi i32 [ %i.ey, %bb.b ], [ %spec.select.i.i.lcssa.unr, %.lr.ph.i.i.prol.loopexit ], [ %spec.select.i.i.3, %.lr.ph.i.i ] ; 3 uses
  %i.fk = getelementptr inbounds nuw [4 x i8], ptr %i.ei, i64 %indvars.iv143.i.i
  store i32 %.0100.lcssa.i.i, ptr %i.fk, align 4, !tbaa !34
  %i.fl = mul nuw nsw i32 %.0100.lcssa.i.i, 9
  %i.fm = zext nneg i32 %i.fl to i64              ; 2 uses
  %i.fn = getelementptr inbounds nuw [8 x i8], ptr %i.a, i64 %indvars.iv143.i.i ; 4 uses
  %i.fo = getelementptr inbounds nuw [8 x i8], ptr %i.fn, i64 %i.fm ; 2 uses
  %i.fp = load double, ptr %i.fo, align 8, !tbaa !33 ; 4 uses
  %i.fq = mul nuw nsw i64 %indvars.iv143.i.i, 9   ; 2 uses
  %.idx147.i.i = mul nuw nsw i64 %indvars.iv143.i.i, 80
  %i.fr = getelementptr inbounds nuw i8, ptr %i.a, i64 %.idx147.i.i ; 2 uses
  %i.fs = load double, ptr %i.fr, align 16, !tbaa !33
  store double %i.fs, ptr %i.fo, align 8, !tbaa !33
  store double %i.fp, ptr %i.fr, align 16, !tbaa !33
  %i.ft = fcmp reassoc nsz arcp contract afn une double %i.fp, 0.000000e+00
  br i1 %i.ft, label %.preheader111.i.i, label %gauss_solve.exit.thread
...
.preheader111.i.i:                                ; preds = %._crit_edge.i.i
  br i1 %i.ex, label %.lr.ph115.i.i.preheader, label %.loopexit.i.i

.lr.ph115.i.i.preheader:                          ; preds = %.preheader111.i.i
  %min.iters.check120 = icmp ult i64 %i.ek, 4
  br i1 %min.iters.check120, label %.lr.ph115.i.i.preheader138, label %vector.ph121
...
vector.body127:                                   ; preds = %vector.body127, %vector.ph121
  ...
  call void @llvm.masked.scatter.v4f64.v4p0(<4 x double> %i.fy, <4 x ptr> align 8 %wide.gep, <4 x i1> splat (i1 true)), !tbaa !33
  ...
  br i1 %i.fz, label %middle.block130, label %vector.body127, !llvm.loop !14

middle.block130:                                  ; preds = %vector.body127
  %cmp.n131 = icmp eq i64 %i.ek, %n.vec122
  br i1 %cmp.n131, label %._crit_edge116.i.i, label %.lr.ph115.i.i.preheader138

.lr.ph115.i.i.preheader138:                       ; preds = %.lr.ph115.i.i.preheader, %middle.block130
  %indvars.iv127.i.i.ph = phi i64 [ %indvars.iv.i.i, %.lr.ph115.i.i.preheader ], [ %i.fu, %middle.block130 ]
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i
  ...
  %i.gb = load double, ptr %gep.i.i, align 8, !tbaa !33
  %i.gc = tail call reassoc nsz arcp contract afn double @llvm.fabs.f64(double %i.gb)
  %i.gd = mul nuw nsw i32 %.0100112.i.i, 9
  ...
  %i.gj = trunc nuw nsw i64 %indvars.iv124.i.i to i32
  %spec.select.i.i = select i1 %i.gi, i32 %i.gj, i32 %.0100112.i.i ; 2 uses
  ...
  %i.gk = load double, ptr %gep.i.i.1, align 8, !tbaa !33
  %i.gl = tail call reassoc nsz arcp contract afn double @llvm.fabs.f64(double %i.gk)
  %i.gm = mul nuw nsw i32 %spec.select.i.i, 9
  ...
  %i.gs = trunc nuw nsw i64 %indvars.iv.next125.i.i to i32
  %spec.select.i.i.1 = select i1 %i.gr, i32 %i.gs, i32 %spec.select.i.i ; 2 uses
  ...
  %i.hb = trunc nuw nsw i64 %indvars.iv.next125.i.i.1 to i32
  %spec.select.i.i.2 = select i1 %i.ha, i32 %i.hb, i32 %spec.select.i.i.1 ; 2 uses
  ...
  %i.hk = trunc nuw nsw i64 %indvars.iv.next125.i.i.2 to i32
  %spec.select.i.i.3 = select i1 %i.hj, i32 %i.hk, i32 %spec.select.i.i.2 ; 2 uses
...
._crit_edge116.i.i:                               ; preds = %.lr.ph115.i.i, %middle.block130
  ...
  %.not.not.i.i = icmp eq i64 %indvars.iv143.i.i, %i.hl
...
.lr.ph118.preheader.i.i:                          ; preds = %._crit_edge116.i.i
  %invariant.gep153.i.i = getelementptr inbounds nuw [8 x i8], ptr %i.a, i64 %i.fm ; 6 uses
  %invariant.gep155.i.i = getelementptr inbounds nuw [8 x i8], ptr %i.a, i64 %i.fq ; 6 uses
...
vector.body111:                                   ; preds = %vector.body111, %vector.ph109
  ...
  %i.hp = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep153.i.i, i64 %i.ho ; 2 uses
  %wide.load113 = load <4 x double>, ptr %i.hp, align 8, !tbaa !33, !alias.scope !38, !noalias !39
  %i.hq = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep155.i.i, i64 %i.ho ; 2 uses
  %wide.load114 = load <4 x double>, ptr %i.hq, align 8, !tbaa !33, !alias.scope !39
  store <4 x double> %wide.load114, ptr %i.hp, align 8, !tbaa !33, !alias.scope !38, !noalias !39
  store <4 x double> %wide.load113, ptr %i.hq, align 8, !tbaa !33, !alias.scope !39
  %index.next115 = add nuw i64 %index112, 4       ; 2 uses
  %i.hr = icmp eq i64 %index.next115, %n.vec110
  br i1 %i.hr, label %middle.block116, label %vector.body111, !llvm.loop !18
...
.lr.ph118.i.i.preheader:                          ; preds = %vector.memcheck97, %.lr.ph118.preheader.i.i, %middle.block116
  %indvars.iv131.i.i.ph = phi i64 [ %indvars.iv.i.i, %vector.memcheck97 ], [ %indvars.iv.i.i, %.lr.ph118.preheader.i.i ], [ %i.hn, %middle.block116 ] ; 4 uses
  %i.hs = sub i64 1, %indvars.iv131.i.i.ph
  %xtraiter139 = and i64 %i.hs, 3                 ; 2 uses
  %lcmp.mod140.not = icmp eq i64 %xtraiter139, 0
  br i1 %lcmp.mod140.not, label %.lr.ph118.i.i.prol.loopexit, label %.lr.ph118.i.i.prol
...
.lr.ph118.i.i.prol:                               ; preds = %.lr.ph118.i.i.preheader, %.lr.ph118.i.i.prol
  ...
  %prol.iter141 = phi i64 [ %prol.iter141.next, %.lr.ph118.i.i.prol ], [ 0, %.lr.ph118.i.i.preheader ]
  %gep154.i.i.prol = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep153.i.i, i64 %indvars.iv131.i.i.prol ; 2 uses
  %i.ht = load double, ptr %gep154.i.i.prol, align 8, !tbaa !33
  %gep156.i.i.prol = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep155.i.i, i64 %indvars.iv131.i.i.prol ; 2 uses
  %i.hu = load double, ptr %gep156.i.i.prol, align 8, !tbaa !33
  store double %i.hu, ptr %gep154.i.i.prol, align 8, !tbaa !33
  store double %i.ht, ptr %gep156.i.i.prol, align 8, !tbaa !33
  ...
  br i1 %prol.iter141.cmp.not, label %.lr.ph118.i.i.prol.loopexit, label %.lr.ph118.i.i.prol, !llvm.loop !19
...
.lr.ph118.i.i.prol.loopexit:                      ; preds = %.lr.ph118.i.i.prol, %.lr.ph118.i.i.preheader
  ...
  %i.hv = add i64 %indvars.iv131.i.i.ph, -6
  %i.hw = icmp ult i64 %i.hv, 3
  br i1 %i.hw, label %.preheader.preheader.i.i, label %.lr.ph118.i.i

.lr.ph115.i.i:                                    ; preds = %.lr.ph115.i.i.preheader138, %.lr.ph115.i.i
  %indvars.iv127.i.i = phi i64 [ %indvars.iv.next128.i.i, %.lr.ph115.i.i ], [ %indvars.iv127.i.i.ph, %.lr.ph115.i.i.preheader138 ] ; 2 uses
  %.idx148.i.i = mul nuw nsw i64 %indvars.iv127.i.i, 72
  %gep152.i.i = getelementptr inbounds nuw i8, ptr %i.fn, i64 %.idx148.i.i ; 2 uses
  %i.hx = load double, ptr %gep152.i.i, align 8, !tbaa !33
  %i.hy = fneg reassoc nsz arcp contract afn double %i.hx
  %i.hz = fmul reassoc nsz arcp contract afn double %i.hy, %i.ga
  store double %i.hz, ptr %gep152.i.i, align 8, !tbaa !33
...
.lr.ph118.i.i:                                    ; preds = %.lr.ph118.i.i.prol.loopexit, %.lr.ph118.i.i
  ...
  %i.ia = load double, ptr %gep154.i.i, align 8, !tbaa !33
  %gep156.i.i = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep155.i.i, i64 %indvars.iv131.i.i ; 2 uses
  %i.ib = load double, ptr %gep156.i.i, align 8, !tbaa !33
  store double %i.ib, ptr %gep154.i.i, align 8, !tbaa !33
  store double %i.ia, ptr %gep156.i.i, align 8, !tbaa !33
  ...
  %i.ic = load double, ptr %gep154.i.i.1, align 8, !tbaa !33
  %gep156.i.i.1 = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep155.i.i, i64 %indvars.iv.next132.i.i ; 2 uses
  %i.id = load double, ptr %gep156.i.i.1, align 8, !tbaa !33
  store double %i.id, ptr %gep154.i.i.1, align 8, !tbaa !33
  store double %i.ic, ptr %gep156.i.i.1, align 8, !tbaa !33
  ...
  %i.ie = load double, ptr %gep154.i.i.2, align 8, !tbaa !33
  %gep156.i.i.2 = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep155.i.i, i64 %indvars.iv.next132.i.i.1 ; 2 uses
  %i.if = load double, ptr %gep156.i.i.2, align 8, !tbaa !33
  store double %i.if, ptr %gep154.i.i.2, align 8, !tbaa !33
  store double %i.ie, ptr %gep156.i.i.2, align 8, !tbaa !33
  ...
  %i.ig = load double, ptr %gep154.i.i.3, align 8, !tbaa !33
  %gep156.i.i.3 = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep155.i.i, i64 %indvars.iv.next132.i.i.2 ; 2 uses
  %i.ih = load double, ptr %gep156.i.i.3, align 8, !tbaa !33
  store double %i.ih, ptr %gep154.i.i.3, align 8, !tbaa !33
  store double %i.ig, ptr %gep156.i.i.3, align 8, !tbaa !33
...
.preheader.preheader.i.i:                         ; preds = %.lr.ph118.i.i.prol.loopexit, %.lr.ph118.i.i, %middle.block116, %._crit_edge116.i.i
  %invariant.gep157.i.i = getelementptr inbounds nuw [8 x i8], ptr %i.a, i64 %i.fq ; 6 uses
  ...
  %bound194 = icmp ult i64 %i.er, 640
...
.preheader.i.i:                                   ; preds = %._crit_edge121.i.i, %.preheader.preheader.i.i
  ...
  %i.ij = mul nuw nsw i64 %indvars.iv139.i.i, 9   ; 2 uses
  %gep162.i.i = getelementptr inbounds nuw [8 x i8], ptr %i.fn, i64 %i.ij ; 6 uses
  %invariant.gep159.i.i = getelementptr inbounds nuw [8 x i8], ptr %i.a, i64 %i.ij ; 6 uses
  %brmerge = select i1 %min.iters.check, i1 true, i1 %conflict.rdx
  br i1 %brmerge, label %scalar.ph.preheader, label %vector.ph

vector.ph:                                        ; preds = %.preheader.i.i
  %i.ik = load double, ptr %gep162.i.i, align 8, !tbaa !33, !alias.scope !40
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.im = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep157.i.i, i64 %i.il
  %wide.load = load <4 x double>, ptr %i.im, align 8, !tbaa !33, !alias.scope !41
  %i.in = fmul reassoc nsz arcp contract afn <4 x double> %wide.load, %broadcast.splat
  %i.io = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep159.i.i, i64 %i.il ; 2 uses
  %wide.load96 = load <4 x double>, ptr %i.io, align 8, !tbaa !33, !alias.scope !42, !noalias !43
  %i.ip = fadd reassoc nsz arcp contract afn <4 x double> %wide.load96, %i.in
  store <4 x double> %i.ip, ptr %i.io, align 8, !tbaa !33, !alias.scope !42, !noalias !43
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.iq = icmp eq i64 %index.next, %n.vec
  br i1 %i.iq, label %middle.block, label %vector.body, !llvm.loop !26

middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %._crit_edge121.i.i, label %scalar.ph.preheader

scalar.ph.preheader:                              ; preds = %.preheader.i.i, %middle.block
  %indvars.iv135.i.i.ph = phi i64 [ %i.ii, %middle.block ], [ %indvars.iv.i.i, %.preheader.i.i ] ; 4 uses
  %i.ir = sub i64 1, %indvars.iv135.i.i.ph
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  ...
  %i.iv = load double, ptr %gep160.i.i.prol, align 8, !tbaa !33
  %i.iw = fadd reassoc nsz arcp contract afn double %i.iv, %i.iu
  store double %i.iw, ptr %gep160.i.i.prol, align 8, !tbaa !33
  ...
  br i1 %prol.iter144.cmp.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol, !llvm.loop !27
...
scalar.ph.prol.loopexit:                          ; preds = %scalar.ph.prol, %scalar.ph.preheader
  ...
  %i.ix = add i64 %indvars.iv135.i.i.ph, -6
  %i.iy = icmp ult i64 %i.ix, 3
  br i1 %i.iy, label %._crit_edge121.i.i, label %scalar.ph
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  %i.iz = load double, ptr %gep162.i.i, align 8, !tbaa !33
  %gep158.i.i = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep157.i.i, i64 %indvars.iv135.i.i
  %i.ja = load double, ptr %gep158.i.i, align 8, !tbaa !33
  ...
  %i.jr = load double, ptr %gep160.i.i.3, align 8, !tbaa !33
  %i.js = fadd reassoc nsz arcp contract afn double %i.jr, %i.jq
  store double %i.js, ptr %gep160.i.i.3, align 8, !tbaa !33
...
gauss_solve.exit:                                 ; preds = %.loopexit.i.i
  %i.jt = load i32, ptr %i.ei, align 4, !tbaa !34
  %i.ju = sext i32 %i.jt to i64
  %i.jv = getelementptr inbounds [8 x i8], ptr %i.b, i64 %i.ju ; 2 uses
  %i.jw = load double, ptr %i.jv, align 8, !tbaa !33 ; 2 uses
  store double 0.000000e+00, ptr %i.jv, align 8, !tbaa !33
  store double %i.jw, ptr %i.b, align 16, !tbaa !33
  %i.jx = load <4 x double>, ptr %i.an, align 8
  %i.jy = getelementptr inbounds nuw i8, ptr %i.b, i64 8 ; 4 uses
  %i.jz = load double, ptr %i.ay, align 16, !tbaa !33
  %i.ka = getelementptr inbounds nuw i8, ptr %i.b, i64 16 ; 4 uses
  %i.kb = load double, ptr %i.bm, align 8, !tbaa !33
  %i.kc = getelementptr inbounds nuw i8, ptr %i.b, i64 24 ; 4 uses
  %i.kd = load double, ptr %i.bx, align 16, !tbaa !33
  ...
  %i.ky = load <4 x double>, ptr %i.ko, align 8, !tbaa !33
  %i.kz = fadd reassoc nsz arcp contract afn <4 x double> %i.ky, %i.kx
  store <4 x double> %i.kz, ptr %i.ko, align 8, !tbaa !33
  %i.la = getelementptr inbounds nuw i8, ptr %i.ei, i64 4
  %i.lb = load i32, ptr %i.la, align 4, !tbaa !34
  %i.lc = sext i32 %i.lb to i64
  %i.ld = getelementptr inbounds [8 x i8], ptr %i.b, i64 %i.lc ; 2 uses
  %i.le = load double, ptr %i.ld, align 8, !tbaa !33 ; 5 uses
  %i.lf = extractelement <4 x double> %i.km, i64 0
  store double %i.lf, ptr %i.ld, align 8, !tbaa !33
  store double %i.le, ptr %i.jy, align 8, !tbaa !33
  %i.lg = load <4 x double>, ptr %i.az, align 8
  %i.lh = load double, ptr %i.bn, align 16, !tbaa !33
  %i.li = load double, ptr %i.by, align 8, !tbaa !33
  %i.lj = load double, ptr %i.cm, align 16, !tbaa !33
  ...
  %i.lq = load <4 x double>, ptr %i.ka, align 16, !tbaa !33
  %i.lr = fadd reassoc nsz arcp contract afn <4 x double> %i.lq, %i.lp ; 2 uses
  store <4 x double> %i.lr, ptr %i.ka, align 16, !tbaa !33
  %i.ls = load double, ptr %i.cy, align 8, !tbaa !33
  %i.lt = fmul reassoc nsz arcp contract afn double %i.ls, %i.le
  %i.lu = load double, ptr %i.kq, align 16, !tbaa !33
  %i.lv = fadd reassoc nsz arcp contract afn double %i.lu, %i.lt
  store double %i.lv, ptr %i.kq, align 16, !tbaa !33
  %i.lw = load double, ptr %i.dn, align 16, !tbaa !33
  %i.lx = fmul reassoc nsz arcp contract afn double %i.lw, %i.le
  %i.ly = load double, ptr %i.ks, align 8, !tbaa !33
  %i.lz = fadd reassoc nsz arcp contract afn double %i.ly, %i.lx
  store double %i.lz, ptr %i.ks, align 8, !tbaa !33
  %i.ma = load double, ptr %i.dz, align 8, !tbaa !33
  %i.mb = fmul reassoc nsz arcp contract afn double %i.ma, %i.le
  %i.mc = load double, ptr %i.eh, align 16, !tbaa !33
  %i.md = fadd reassoc nsz arcp contract afn double %i.mc, %i.mb
  store double %i.md, ptr %i.eh, align 16, !tbaa !33
  %i.me = getelementptr inbounds nuw i8, ptr %i.ei, i64 8
  %i.mf = load i32, ptr %i.me, align 4, !tbaa !34
  %i.mg = sext i32 %i.mf to i64
  %i.mh = getelementptr inbounds [8 x i8], ptr %i.b, i64 %i.mg ; 2 uses
  %i.mi = load double, ptr %i.mh, align 8, !tbaa !33 ; 4 uses
  %i.mj = extractelement <4 x double> %i.lr, i64 0
  store double %i.mj, ptr %i.mh, align 8, !tbaa !33
  store double %i.mi, ptr %i.ka, align 16, !tbaa !33
  %i.mk = load <4 x double>, ptr %i.bo, align 8
  %i.ml = load double, ptr %i.cc, align 16, !tbaa !33
  %i.mm = load double, ptr %i.cn, align 8, !tbaa !33
  %i.mn = load double, ptr %i.dc, align 16, !tbaa !33
