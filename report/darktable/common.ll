...
bb.b:                                             ; preds = %.loopexit.i.i, %bb.a
  ...
  %3 = getelementptr nuw i8, ptr %i.a, i64 %i.ek
  ...
  %i.en = mul nuw nsw i64 %indvars.iv143.i.i, 72
  %4 = getelementptr nuw i8, ptr %i.a, i64 %i.en
  %scevgep103 = getelementptr nuw i8, ptr %4, i64 72
  %i.eo = sub nsw i64 8, %indvars.iv143.i.i       ; 3 uses
  %i.ep = mul nuw nsw i64 %indvars.iv143.i.i, 80  ; 3 uses
  %i.eq = getelementptr i8, ptr %i.a, i64 %i.ep
  %scevgep = getelementptr i8, ptr %i.eq, i64 80  ; 2 uses
  %i.er = getelementptr i8, ptr %i.a, i64 %i.ep
  ...
  %i.eu = mul nuw nsw i64 %indvars.iv143.i.i, 72
  %5 = getelementptr nuw i8, ptr %i.a, i64 %i.eu
...
.preheader.preheader.i.i:                         ; preds = %.lr.ph118.i.i.prol.loopexit, %.lr.ph118.i.i, %middle.block116, %._crit_edge116.i.i
  ...
  %bound194 = icmp ult i64 %i.ep, 640
