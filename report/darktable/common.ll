...
begin_hunk_1_@get_homography:bb.a
  ...
  %i.sk = fdiv reassoc nsz arcp contract afn double %i.sj, %i.qy ; 4 uses
  %i.sl = fmul reassoc nsz arcp contract afn double %i.qz, %i.sk
  %op.rdx133 = call reassoc nsz arcp contract afn double @llvm.vector.reduce.fadd.v4f64(double %i.sl, <4 x double> %i.sg)
  ...
  %7 = insertelement <2 x double> %6, double %i.sk, i64 1 ; 2 uses
  ...
  %i.sm = fsub reassoc nsz arcp contract afn double %i.qk, %13
  ...
  %op.rdx137 = call reassoc nsz arcp contract afn double @llvm.vector.reduce.fadd.v4f64(double %i.so, <4 x double> %16)
  ...
  %i.st = insertelement <8 x double> %i.ss, double %5, i64 2
  ...
  %i.th = insertelement <8 x double> %i.tg, double %5, i64 3
