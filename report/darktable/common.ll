...
begin_hunk_1_@get_homography:bb.a
  ...
  %i.sj = fsub reassoc nsz arcp contract afn double %i.qm, %i.si
  %i.sk = fdiv reassoc nsz arcp contract afn double %i.sj, %i.qy ; 5 uses
  %i.sl = fmul reassoc nsz arcp contract afn double %5, %i.sk
  %9 = fmul reassoc nsz arcp contract afn double %6, %i.sk
  %10 = fmul reassoc nsz arcp contract afn double %i.qz, %i.sk
  %op.rdx = call reassoc nsz arcp contract afn double @llvm.vector.reduce.fadd.v4f64(double %10, <4 x double> %i.sg)
  %11 = fsub reassoc nsz arcp contract afn double %i.ql, %op.rdx
  %12 = fdiv reassoc nsz arcp contract afn double %11, %i.ra ; 4 uses
  %13 = fmul reassoc nsz arcp contract afn double %7, %12
  %14 = fmul reassoc nsz arcp contract afn double %8, %12
  %op.rdx133 = call reassoc nsz arcp contract afn double @llvm.vector.reduce.fadd.v4f64(double %9, <4 x double> %i.sf)
  %op.rdx134 = fadd reassoc nsz arcp contract afn double %op.rdx133, %14
  %i.sm = fsub reassoc nsz arcp contract afn double %i.qk, %op.rdx134
  %i.sn = fdiv reassoc nsz arcp contract afn double %i.sm, %i.rb ; 3 uses
  %i.so = fmul reassoc nsz arcp contract afn double %i.rc, %i.sn
  %op.rdx135 = call reassoc nsz arcp contract afn double @llvm.vector.reduce.fadd.v4f64(double %i.sl, <4 x double> %i.se)
  %op.rdx136 = fadd reassoc nsz arcp contract afn double %13, %i.so
  %op.rdx137 = fadd reassoc nsz arcp contract afn double %op.rdx135, %op.rdx136
  %i.sp = fsub reassoc nsz arcp contract afn double %i.qj, %op.rdx137
  %i.sq = fdiv reassoc nsz arcp contract afn double %i.sp, %i.rd ; 2 uses
  %i.sr = insertelement <8 x double> poison, double %i.sq, i64 0
  %i.ss = insertelement <8 x double> %i.sr, double %i.sn, i64 1
  %i.st = insertelement <8 x double> %i.ss, double %12, i64 2
  %i.su = insertelement <8 x double> %i.st, double %i.sk, i64 3
  %i.sv = insertelement <8 x double> %i.su, double %i.rz, i64 4
  %i.sw = insertelement <8 x double> %i.sv, double %i.rv, i64 5
  %i.sx = insertelement <8 x double> %i.sw, double %i.rp, i64 6
  %i.sy = insertelement <8 x double> %i.sx, double %i.rk, i64 7
  %i.sz = fmul reassoc nsz arcp contract afn <8 x double> %i.rj, %i.sy
  store double %i.rv, ptr %i.kr, align 16, !tbaa !33
  %i.ta = call reassoc nsz arcp contract afn double @llvm.vector.reduce.fadd.v8f64(double 0.000000e+00, <8 x double> %i.sz)
  %i.tb = fsub reassoc nsz arcp contract afn double %i.qi, %i.ta
  %i.tc = fdiv reassoc nsz arcp contract afn double %i.tb, %i.re
  %i.td = load <2 x double>, ptr %i.kr, align 16, !tbaa !33
  %i.te = insertelement <8 x double> poison, double %i.tc, i64 0
  %i.tf = insertelement <8 x double> %i.te, double %i.sq, i64 1
  %i.tg = insertelement <8 x double> %i.tf, double %i.sn, i64 2
  %i.th = insertelement <8 x double> %i.tg, double %12, i64 3
  %i.ti = insertelement <8 x double> %i.th, double %i.sk, i64 4
  %i.tj = insertelement <8 x double> %i.ti, double %i.rz, i64 5
  %i.tk = shufflevector <2 x double> %i.td, <2 x double> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.tl = shufflevector <8 x double> %i.tj, <8 x double> %i.tk, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 8, i32 9>
  %i.tm = fptrunc <8 x double> %i.tl to <8 x float>
  store <8 x float> %i.tm, ptr %2, align 4, !tbaa !12
  %i.tn = load double, ptr %i.ef, align 16, !tbaa !33
  %i.to = fptrunc reassoc nsz arcp contract afn double %i.tn to float
  %i.tp = getelementptr inbounds nuw i8, ptr %2, i64 32
  store float %i.to, ptr %i.tp, align 4, !tbaa !12
  br label %.loopexit

.loopexit:                                        ; preds = %gauss_solve.exit, %gauss_solve.exit.thread
  %i.tq = phi i32 [ 0, %gauss_solve.exit.thread ], [ 1, %gauss_solve.exit ]
