...
.lr.ph232:                                        ; preds = %.lr.ph, %bb.a
  ...
  %1 = load i32, ptr %i.ar, align 8, !tbaa !119
...
.preheader217.preheader:                          ; preds = %vector.body, %vector.memcheck, %.lr.ph232
  ...
  %i.gu = shufflevector <4 x i32> %2, <4 x i32> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 0>
...
._crit_edge233:                                   ; preds = %.preheader217
  ...
  %3 = load i32, ptr %i.kv, align 8, !tbaa !119
  ...
  %i.me = shufflevector <4 x i32> %4, <4 x i32> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 0>
...
.preheader215.preheader:                          ; preds = %vector.body, %vector.memcheck, %.lr.ph230
  ...
  %2 = insertelement <4 x i32> poison, i32 %1, i64 0
  %i.ge = shufflevector <4 x i32> %2, <4 x i32> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 0>
...
._crit_edge231:                                   ; preds = %.preheader215
  ...
  %3 = load i32, ptr %i.kw, align 8, !tbaa !119
  ...
  %4 = insertelement <4 x i32> poison, i32 %i.ls, i64 0
  %i.lu = insertelement <4 x i32> poison, i32 %3, i64 0
  %i.lv = shufflevector <4 x i32> %i.lu, <4 x i32> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 0>
  ...
  %i.mc = insertelement <4 x i32> %4, i32 %i.mb, i64 1
...
.lr.ph:
  ...
  %2 = load i32, ptr %i.ag, align 8, !tbaa !119
...
.preheader215.preheader:                          ; preds = %vector.body, %vector.memcheck, %.lr.ph
  ...
  %i.it = shufflevector <4 x i32> %3, <4 x i32> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 0>
...
._crit_edge:                                      ; preds = %.preheader215
  ...
  %4 = load i32, ptr %i.ol, align 8, !tbaa !119
  ...
  %i.pv = shufflevector <4 x i32> %5, <4 x i32> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 0>
...
.preheader213.preheader:                          ; preds = %vector.body, %vector.memcheck, %.lr.ph
  %indvars.iv.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %.lr.ph ], [ %n.vec, %vector.body ]
  %3 = insertelement <4 x i32> poison, i32 %2, i64 0
  %i.hl = shufflevector <4 x i32> %3, <4 x i32> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 0>
...
._crit_edge:                                      ; preds = %.preheader213
  ...
  %4 = load i32, ptr %i.np, align 8, !tbaa !119
  ...
  %5 = insertelement <4 x i32> poison, i32 %4, i64 0
  %i.oq = shufflevector <4 x i32> %5, <4 x i32> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 0>
