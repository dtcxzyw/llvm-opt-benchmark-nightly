...
begin_hunk_0_@_draw_location:bb.a
  %i.cq = fcmp reassoc nsz arcp contract afn ogt double %i.ag, f0x4090000010000000
  %i.cr = fcmp reassoc nsz arcp contract afn olt float %i.ah, 1.600000e+01
  %i.cs = select reassoc nsz arcp contract afn i1 %i.cr, float 1.600000e+01, float %i.ah
  %i.ct = fptosi float %i.cs to i32
  %i.cu = select i1 %i.cq, i32 1024, i32 %i.ct    ; 3 uses
  %i.cv = sitofp reassoc nsz arcp contract afn i32 %i.cp to double
  %i.cw = load ptr, ptr getelementptr inbounds nuw (i8, ptr @darktable, i64 104), align 8, !tbaa !96
  %i.cx = getelementptr inbounds nuw i8, ptr %i.cw, i64 1432
  %i.cy = load double, ptr %i.cx, align 8, !tbaa !97 ; 3 uses
  %i.cz = fmul reassoc nsz arcp contract afn double %i.cy, 2.000000e+00 ; 2 uses
  %i.da = fmul reassoc nsz arcp contract afn double %i.cz, %i.cv
...
.preheader83.preheader:                           ; preds = %bb.g
  ...
  br i1 %.not160, label %.preheader.a, label %.lr.ph156.preheader
...
.preheader87:                                     ; preds = %bb.g
  ...
  %i.x = icmp samesign ult i64 %indvars.iv.next111152, %i.w
  br i1 %i.x, label %.lr.ph154.preheader, label %.preheader84
...
bb.h:                                             ; preds = %.lr.ph154
  ...
  %i.z = icmp samesign ult i64 %indvars.iv.next111, %i.w
  br i1 %i.z, label %.lr.ph154, label %.preheader84
...
.lr.ph154:                                        ; preds = %.lr.ph154.preheader, %bb.h
  ...
  %i.ab = getelementptr inbounds nuw [40 x i8], ptr %i.l, i64 %indvars.iv.next111153
...
bb.i:                                             ; preds = %.lr.ph97, %bb.j
  ...
  %i.af = getelementptr inbounds nuw [40 x i8], ptr %i.l, i64 %indvars.iv113
...
.preheader83:                                     ; preds = %.lr.ph156
  %i.aj = icmp sgt i64 %indvars.iv123155, 1
...
.lr.ph159.preheader:                              ; preds = %.preheader.a
  %i.al = load i32, ptr %i.u, align 8, !tbaa !172
  br label %.lr.ph159
...
.lr.ph156:                                        ; preds = %.lr.ph156.preheader, %.preheader83
  ...
  %i.am = getelementptr inbounds nuw [40 x i8], ptr %i.l, i64 %indvars.iv.next124
  %i.an = getelementptr inbounds nuw i8, ptr %i.am, i64 28
  %i.ao = load i32, ptr %i.an, align 4, !tbaa !170
  %i.ap = icmp eq i32 %i.ao, %i.v
  br i1 %i.ap, label %.thread80, label %.preheader83

bb.k:                                             ; preds = %.lr.ph159
  %indvars.iv.next127 = add nsw i64 %indvars.iv.next127158, -1 ; 2 uses
  %i.aq = icmp sgt i64 %indvars.iv.next127, %indvars.iv
  br i1 %i.aq, label %.lr.ph159, label %.thread77
...
.lr.ph159:                                        ; preds = %.lr.ph159.preheader, %bb.k
  ...
  br i1 %i.au, label %.thread80, label %bb.k
...
.thread80:                                        ; preds = %.lr.ph154, %bb.i, %.lr.ph156, %.lr.ph159
  ...
  %i.aw = getelementptr inbounds [40 x i8], ptr %i.l, i64 %i.av
  %i.ax = getelementptr inbounds nuw i8, ptr %i.aw, i64 32
  %i.ay = load i32, ptr %i.ax, align 8, !tbaa !173
  store i32 %i.ay, ptr %1, align 8, !tbaa !166
  %i.az = getelementptr inbounds nuw i8, ptr %1, i64 40 ; 2 uses
  %i.ba = load ptr, ptr %i.az, align 8, !tbaa !132 ; 2 uses
  %.not72 = icmp eq ptr %i.ba, null
...
bb.m:                                             ; preds = %.thread80
  ...
  %i.bd = tail call i32 @osm_gps_map_image_remove(ptr noundef %i.bc, ptr noundef nonnull %i.ba) #23 ; 0 uses
  store ptr null, ptr %i.az, align 8, !tbaa !132
  br label %.thread77.sink.split

.thread77.sink.split:                             ; preds = %.thread80, %bb.m, %bb.c, %bb.d
  %i.be = tail call fastcc i32 @_view_map_draw_image(ptr noundef nonnull %1, i32 noundef 1, i32 noundef 0, ptr noundef %0) ; 0 uses
  %i.bf = load i32, ptr %1, align 8, !tbaa !166
  tail call void @dt_control_set_mouse_over_id(i32 noundef %i.bf) #23
  br label %.thread77

.thread77:                                        ; preds = %bb.l, %bb.j, %bb.k, %.preheader.a, %.thread77.sink.split, %bb.e, %.preheader84, %bb.a
  %.167 = phi i32 [ 1, %.thread77.sink.split ], [ 0, %bb.a ], [ 0, %.preheader.a ], [ 0, %.preheader84 ], [ 0, %bb.e ], [ 0, %bb.j ], [ 0, %bb.k ], [ 0, %bb.l ]
  ret i32 %.167
}
