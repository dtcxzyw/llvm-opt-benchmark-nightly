...
.lr.ph90:                                         ; preds = %_hash_string.exit
  ...
  %6 = fmul reassoc nnan nsz arcp contract afn double %i.cw, 3.000000e-01
  %7 = tail call reassoc nsz arcp contract afn double @llvm.maxnum.f64(double %6, double 1.000000e+00)
