...
bb.b:                                             ; preds = %bb.a
  ...
  %6 = fmul reassoc nsz arcp contract afn float %i.m, f0x3C23D70A
  %i.n = tail call reassoc nsz arcp contract afn float @llvm.maxnum.f32(float %6, float 0.000000e+00)
  %7 = tail call reassoc nsz arcp contract afn float @llvm.minnum.f32(float %i.n, float 1.000000e+00) ; 4 uses
