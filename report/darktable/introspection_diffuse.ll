...
vector.body310:                                   ; preds = %.lr.ph.i.i.i.preheader, %vector.body310
  ...
  %9 = fadd reassoc nsz arcp contract afn <4 x float> %8, %i.th
  ...
  %i.ti = fadd reassoc nsz arcp contract afn <4 x float> %12, %11 ; 2 uses
  %i.tj = fmul reassoc nsz arcp contract afn <4 x float> %strided.vec314, splat (float 6.250000e-02)
  %13 = fmul reassoc nsz arcp contract afn <4 x float> %strided.vec319, splat (float 2.500000e-01)
  %14 = fadd reassoc nsz arcp contract afn <4 x float> %i.tj, %13
  %15 = fmul reassoc nsz arcp contract afn <4 x float> %strided.vec324, splat (float 3.750000e-01)
  %i.tk = fadd reassoc nsz arcp contract afn <4 x float> %14, %15
  %i.tl = fmul reassoc nsz arcp contract afn <4 x float> %strided.vec329, splat (float 2.500000e-01)
  %i.tm = fadd reassoc nsz arcp contract afn <4 x float> %i.tk, %i.tl
  %i.tn = fmul reassoc nsz arcp contract afn <4 x float> %strided.vec334, splat (float 6.250000e-02)
  %i.to = fadd reassoc nsz arcp contract afn <4 x float> %i.tn, %i.tm ; 2 uses
  %i.tp = fmul reassoc nsz arcp contract afn <4 x float> %strided.vec315, splat (float 6.250000e-02)
  %16 = fmul reassoc nsz arcp contract afn <4 x float> %strided.vec320, splat (float 2.500000e-01)
  %i.tq = fadd reassoc nsz arcp contract afn <4 x float> %i.tp, %16
  %i.tr = fmul reassoc nsz arcp contract afn <4 x float> %strided.vec325, splat (float 3.750000e-01)
  %i.ts = fadd reassoc nsz arcp contract afn <4 x float> %i.tq, %i.tr
  %i.tt = fmul reassoc nsz arcp contract afn <4 x float> %strided.vec330, splat (float 2.500000e-01)
  %i.tu = fadd reassoc nsz arcp contract afn <4 x float> %i.ts, %i.tt
  %i.tv = fmul reassoc nsz arcp contract afn <4 x float> %strided.vec335, splat (float 6.250000e-02)
  ...
  %i.tx = fmul reassoc nsz arcp contract afn <4 x float> %strided.vec321, splat (float 2.500000e-01)
  %i.ty = fadd reassoc nsz arcp contract afn <4 x float> %17, %i.tx
  %i.tz = fmul reassoc nsz arcp contract afn <4 x float> %strided.vec326, splat (float 3.750000e-01)
  %i.ua = fadd reassoc nsz arcp contract afn <4 x float> %i.ty, %i.tz
  %i.ub = fmul reassoc nsz arcp contract afn <4 x float> %strided.vec331, splat (float 2.500000e-01)
  ...
  %i.ud = fadd reassoc nsz arcp contract afn <4 x float> %18, %i.uc ; 2 uses
  %i.ue = shufflevector <4 x float> %i.ti, <4 x float> %i.to, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.uf = fcmp reassoc nsz arcp contract afn olt <8 x float> %i.ue, zeroinitializer
  %i.ug = shufflevector <4 x float> %i.ti, <4 x float> %i.to, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.uh = select reassoc nsz arcp contract afn <8 x i1> %i.uf, <8 x float> zeroinitializer, <8 x float> %i.ug
  %i.ui = shufflevector <4 x float> %i.tw, <4 x float> %i.ud, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.uj = fcmp reassoc nsz arcp contract afn olt <8 x float> %i.ui, zeroinitializer
  %i.uk = shufflevector <4 x float> %i.tw, <4 x float> %i.ud, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.preheader352, %.lr.ph.i.i.i
  ...
  %19 = fmul reassoc nsz arcp contract afn <4 x float> %i.uv, splat (float 6.250000e-02)
  %i.uw = load <4 x float>, ptr %i.ur, align 4, !tbaa !27, !alias.scope !164, !noalias !165
  %i.ux = fmul reassoc nsz arcp contract afn <4 x float> %i.uw, splat (float 2.500000e-01)
  %20 = fadd reassoc nsz arcp contract afn <4 x float> %19, %i.ux
  %i.uy = load <4 x float>, ptr %i.us, align 4, !tbaa !27, !alias.scope !164, !noalias !165
  %21 = fmul reassoc nsz arcp contract afn <4 x float> %i.uy, splat (float 3.750000e-01)
  %i.uz = fadd reassoc nsz arcp contract afn <4 x float> %20, %21
  %22 = load <4 x float>, ptr %i.ut, align 4, !tbaa !27, !alias.scope !164, !noalias !165
  %i.va = fmul reassoc nsz arcp contract afn <4 x float> %22, splat (float 2.500000e-01)
  %i.vb = fadd reassoc nsz arcp contract afn <4 x float> %i.uz, %i.va
  %23 = load <4 x float>, ptr %i.uu, align 4, !tbaa !27, !alias.scope !164, !noalias !165
  %24 = fmul reassoc nsz arcp contract afn <4 x float> %23, splat (float 6.250000e-02)
  %i.vc = fadd reassoc nsz arcp contract afn <4 x float> %24, %i.vb ; 2 uses
...
bb.ac:                                            ; preds = %bb.ac, %.lr.ph.i.i
  ...
  %25 = fmul reassoc nsz arcp contract afn <4 x float> %i.wc, splat (float 6.250000e-02)
  %i.wd = load <4 x float>, ptr %i.vy, align 16, !tbaa !27, !alias.scope !169, !noalias !174
  %i.we = fmul reassoc nsz arcp contract afn <4 x float> %i.wd, splat (float 2.500000e-01)
  %26 = fadd reassoc nsz arcp contract afn <4 x float> %25, %i.we
  %i.wf = load <4 x float>, ptr %i.vz, align 16, !tbaa !27, !alias.scope !169, !noalias !174
  %27 = fmul reassoc nsz arcp contract afn <4 x float> %i.wf, splat (float 3.750000e-01)
  %i.wg = fadd reassoc nsz arcp contract afn <4 x float> %26, %27
  %28 = load <4 x float>, ptr %i.wa, align 16, !tbaa !27, !alias.scope !169, !noalias !174
  %i.wh = fmul reassoc nsz arcp contract afn <4 x float> %28, splat (float 2.500000e-01)
  %i.wi = fadd reassoc nsz arcp contract afn <4 x float> %i.wg, %i.wh
  %29 = load <4 x float>, ptr %i.wb, align 16, !tbaa !27, !alias.scope !169, !noalias !174
  %30 = fmul reassoc nsz arcp contract afn <4 x float> %29, splat (float 6.250000e-02)
  %i.wj = fadd reassoc nsz arcp contract afn <4 x float> %30, %i.wi ; 2 uses
...
bb.af:                                            ; preds = %bb.az, %.lr.ph153.i
  ...
  %31 = shufflevector <2 x float> %i.yf, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 1, i32 0>
...
.lr.ph265.i.i:                                    ; preds = %bb.af
  ...
  %32 = shufflevector <2 x float> %i.yf, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
...
begin_hunk_1_@process:bb.a
  ...
  %i.axm = fmul reassoc nsz arcp contract afn <4 x float> %i.axl, %31
  ...
  %i.axr = fmul reassoc nsz arcp contract afn <4 x float> %i.axq, %32
  %i.axs = fadd reassoc nsz arcp contract afn <4 x float> %i.axm, %i.axr
  ...
  %i.ayi = fadd reassoc nsz arcp contract afn <4 x float> %i.ayh, %i.ayg
