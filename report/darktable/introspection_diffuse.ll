...
vector.body310:                                   ; preds = %.lr.ph.i.i.i.preheader, %vector.body310
  ...
  %i.tq = fadd reassoc nsz arcp contract afn <4 x float> %strided.vec328, %strided.vec318
  %i.tr = fmul reassoc nsz arcp contract afn <4 x float> %i.tq, splat (float 2.500000e-01)
  ...
  %8 = fadd reassoc nsz arcp contract afn <4 x float> %i.tr, %i.tp
  %i.ts = fadd reassoc nsz arcp contract afn <4 x float> %8, %7 ; 2 uses
  %i.tt = fmul reassoc nsz arcp contract afn <4 x float> %strided.vec324, splat (float 3.750000e-01)
  %i.tu = fadd reassoc nsz arcp contract afn <4 x float> %strided.vec329, %strided.vec319
  %i.tv = fmul reassoc nsz arcp contract afn <4 x float> %i.tu, splat (float 2.500000e-01)
  %i.tw = fadd reassoc nsz arcp contract afn <4 x float> %strided.vec334, %strided.vec314
  %i.tx = fmul reassoc nsz arcp contract afn <4 x float> %i.tw, splat (float 6.250000e-02)
  %9 = fadd reassoc nsz arcp contract afn <4 x float> %i.tv, %i.tt
  %i.ty = fadd reassoc nsz arcp contract afn <4 x float> %9, %i.tx ; 2 uses
  %i.tz = fmul reassoc nsz arcp contract afn <4 x float> %strided.vec325, splat (float 3.750000e-01)
  %i.ua = fadd reassoc nsz arcp contract afn <4 x float> %strided.vec330, %strided.vec320
  %i.ub = fmul reassoc nsz arcp contract afn <4 x float> %i.ua, splat (float 2.500000e-01)
  %i.uc = fadd reassoc nsz arcp contract afn <4 x float> %strided.vec335, %strided.vec315
  %i.ud = fmul reassoc nsz arcp contract afn <4 x float> %i.uc, splat (float 6.250000e-02)
  %i.ue = fadd reassoc nsz arcp contract afn <4 x float> %i.ub, %i.tz
  %10 = fadd reassoc nsz arcp contract afn <4 x float> %i.ue, %i.ud ; 2 uses
  %i.uf = fmul reassoc nsz arcp contract afn <4 x float> %strided.vec326, splat (float 3.750000e-01)
  %i.ug = fadd reassoc nsz arcp contract afn <4 x float> %strided.vec331, %strided.vec321
  %i.uh = fmul reassoc nsz arcp contract afn <4 x float> %i.ug, splat (float 2.500000e-01)
  %i.ui = fadd reassoc nsz arcp contract afn <4 x float> %strided.vec336, %strided.vec316
  %i.uj = fmul reassoc nsz arcp contract afn <4 x float> %i.ui, splat (float 6.250000e-02)
  %i.uk = fadd reassoc nsz arcp contract afn <4 x float> %i.uh, %i.uf
  %i.ul = fadd reassoc nsz arcp contract afn <4 x float> %i.uk, %i.uj ; 2 uses
  %i.um = shufflevector <4 x float> %i.ts, <4 x float> %i.ty, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.un = fcmp reassoc nsz arcp contract afn olt <8 x float> %i.um, zeroinitializer
  %i.uo = shufflevector <4 x float> %i.ts, <4 x float> %i.ty, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.up = select reassoc nsz arcp contract afn <8 x i1> %i.un, <8 x float> zeroinitializer, <8 x float> %i.uo
  %i.uq = shufflevector <4 x float> %10, <4 x float> %i.ul, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.ur = fcmp reassoc nsz arcp contract afn olt <8 x float> %i.uq, zeroinitializer
  %i.us = shufflevector <4 x float> %10, <4 x float> %i.ul, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.preheader352, %.lr.ph.i.i.i
  ...
  %11 = load <4 x float>, ptr %i.uz, align 4, !tbaa !27, !alias.scope !164, !noalias !165
  %i.ve = load <4 x float>, ptr %i.va, align 4, !tbaa !27, !alias.scope !164, !noalias !165
  %i.vf = fmul reassoc nsz arcp contract afn <4 x float> %i.ve, splat (float 3.750000e-01)
  %i.vg = load <4 x float>, ptr %i.vb, align 4, !tbaa !27, !alias.scope !164, !noalias !165
  %12 = load <4 x float>, ptr %i.vc, align 4, !tbaa !27, !alias.scope !164, !noalias !165
  %i.vh = fadd reassoc nsz arcp contract afn <4 x float> %i.vg, %11
  %i.vi = fmul reassoc nsz arcp contract afn <4 x float> %i.vh, splat (float 2.500000e-01)
  %i.vj = fadd reassoc nsz arcp contract afn <4 x float> %12, %i.vd
  %13 = fmul reassoc nsz arcp contract afn <4 x float> %i.vj, splat (float 6.250000e-02)
  %14 = fadd reassoc nsz arcp contract afn <4 x float> %i.vi, %i.vf
  %i.vk = fadd reassoc nsz arcp contract afn <4 x float> %14, %13 ; 2 uses
...
bb.ac:                                            ; preds = %bb.ac, %.lr.ph.i.i
  ...
  %15 = load <4 x float>, ptr %i.wg, align 16, !tbaa !27, !alias.scope !169, !noalias !174
  %i.wl = load <4 x float>, ptr %i.wh, align 16, !tbaa !27, !alias.scope !169, !noalias !174
  %i.wm = fmul reassoc nsz arcp contract afn <4 x float> %i.wl, splat (float 3.750000e-01)
  %i.wn = load <4 x float>, ptr %i.wi, align 16, !tbaa !27, !alias.scope !169, !noalias !174
  %16 = load <4 x float>, ptr %i.wj, align 16, !tbaa !27, !alias.scope !169, !noalias !174
  %i.wo = fadd reassoc nsz arcp contract afn <4 x float> %i.wn, %15
  %i.wp = fmul reassoc nsz arcp contract afn <4 x float> %i.wo, splat (float 2.500000e-01)
  %i.wq = fadd reassoc nsz arcp contract afn <4 x float> %16, %i.wk
  %17 = fmul reassoc nsz arcp contract afn <4 x float> %i.wq, splat (float 6.250000e-02)
  %18 = fadd reassoc nsz arcp contract afn <4 x float> %i.wp, %i.wm
  %i.wr = fadd reassoc nsz arcp contract afn <4 x float> %18, %17 ; 2 uses
...
bb.af:                                            ; preds = %bb.az, %.lr.ph153.i
  ...
  %19 = shufflevector <2 x float> %i.yn, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
...
.lr.ph265.i.i:                                    ; preds = %bb.af
  ...
  %20 = shufflevector <2 x float> %i.yn, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 1, i32 0>
...
begin_hunk_1_@process:bb.a
  ...
  %i.axu = fmul reassoc nsz arcp contract afn <4 x float> %i.axt, %20
  ...
  %i.axz = fmul reassoc nsz arcp contract afn <4 x float> %i.axy, %19
  %i.aya = fadd reassoc nsz arcp contract afn <4 x float> %i.axz, %i.axu
  ...
  %i.ayq = fadd reassoc nsz arcp contract afn <4 x float> %i.ayo, %i.ayp
