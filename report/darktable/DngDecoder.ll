...
bb.c:                                             ; preds = %bb.a
  store ptr null, ptr %1, align 8, !tbaa !263
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.l = load ptr, ptr %i.k, align 8, !tbaa !257
...
_ZNK8rawspeed7TiffIFD8hasEntryENS_7TiffTagE.exit.thread: ; preds = %_ZNKSt8_Rb_treeIN8rawspeed7TiffTagESt4pairIKS1_St10unique_ptrINS0_9TiffEntryESt14default_deleteIS5_EEESt10_Select1stIS9_ESt4lessIS1_ESaIS9_EE14_M_lower_boundEPKSt13_Rb_tree_nodeIS9_EPKSt18_Rb_tree_node_baseRS3_.exit.i.i.i, %bb.a, %bb.b, %_ZNK8rawspeed7TiffIFD8hasEntryENS_7TiffTagE.exit
  ...
  %i.m = load ptr, ptr %i.l, align 8, !tbaa !78   ; 7 uses
  ...
  %i.q = load i8, ptr %i.p, align 8, !tbaa !265, !range !148, !noundef !149
...
bb.c:                                             ; preds = %_ZNK8rawspeed7TiffIFD8hasEntryENS_7TiffTagE.exit.thread
  store i8 1, ptr %i.p, align 8, !tbaa !265
  br label %_ZSt4fillIPiiEvT_S1_RKT0_.exit

_ZSt4fillIPiiEvT_S1_RKT0_.exit:                   ; preds = %_ZNK8rawspeed7TiffIFD8hasEntryENS_7TiffTagE.exit.thread, %bb.c
  store ptr %i.n, ptr %i.o, align 8, !tbaa !266
  %i.s = getelementptr inbounds nuw i8, ptr %i.m, i64 128
  store i32 4, ptr %i.s, align 8, !tbaa !143
  %i.t = getelementptr inbounds nuw i8, ptr %i.m, i64 136
  store i32 2, ptr %i.t, align 8, !tbaa !143
  %i.u = getelementptr inbounds nuw i8, ptr %i.m, i64 140
  store i32 2, ptr %i.u, align 4, !tbaa !143
  %i.v = getelementptr inbounds nuw i8, ptr %i.m, i64 144
  store i32 2, ptr %i.v, align 8, !tbaa !143
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %i.n, i8 0, i64 16, i1 false), !tbaa !143
  %i.w = load ptr, ptr %i.a, align 8, !tbaa !66   ; 2 uses
...
.lr.ph.i.i.i.i6:                                  ; preds = %_ZSt4fillIPiiEvT_S1_RKT0_.exit, %.lr.ph.i.i.i.i6
  ...
  %i.y = load i16, ptr %i.x, align 2, !tbaa !68
  ...
  %.1.i.i.i.i12 = load ptr, ptr %.1.in.i.i.i.i11, align 8, !tbaa !69 ; 2 uses
  %.not.i.i.i.i13 = icmp eq ptr %.1.i.i.i.i12, null
  br i1 %.not.i.i.i.i13, label %_ZNKSt8_Rb_treeIN8rawspeed7TiffTagESt4pairIKS1_St10unique_ptrINS0_9TiffEntryESt14default_deleteIS5_EEESt10_Select1stIS9_ESt4lessIS1_ESaIS9_EE14_M_lower_boundEPKSt13_Rb_tree_nodeIS9_EPKSt18_Rb_tree_node_baseRS3_.exit.i.i.i14, label %.lr.ph.i.i.i.i6, !llvm.loop !0
...
_ZNK8rawspeed7TiffIFD8hasEntryENS_7TiffTagE.exit16: ; preds = %_ZNKSt8_Rb_treeIN8rawspeed7TiffTagESt4pairIKS1_St10unique_ptrINS0_9TiffEntryESt14default_deleteIS5_EEESt10_Select1stIS9_ESt4lessIS1_ESaIS9_EE14_M_lower_boundEPKSt13_Rb_tree_nodeIS9_EPKSt18_Rb_tree_node_baseRS3_.exit.i.i.i14
  ...
  %i.ac = load i16, ptr %i.ab, align 2, !tbaa !68
...
bb.d:                                             ; preds = %bb.a
  ...
  %i.w = load ptr, ptr %i.v, align 8, !tbaa !395  ; 2 uses
  %i.x = getelementptr inbounds nuw i8, ptr %i.u, i64 288
  %i.y = load ptr, ptr %i.x, align 8, !tbaa !395  ; 2 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.ak = tail call noundef float @_ZNK8rawspeed9TiffEntry8getFloatEj(ptr noundef nonnull align 8 dereferenceable(48) %i.aa, i32 noundef 1) ; 3 uses
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.ao = load ptr, ptr %i.t, align 8, !tbaa !78  ; 2 uses
  %i.ap = getelementptr inbounds nuw i8, ptr %i.ao, i64 280
  %i.aq = load ptr, ptr %i.ap, align 8, !tbaa !151 ; 6 uses
  %i.ar = getelementptr inbounds nuw i8, ptr %i.aq, i64 32
  %i.as = getelementptr inbounds nuw i8, ptr %i.aq, i64 40
  %1 = insertelement <2 x float> poison, float %i.an, i64 0
  %2 = insertelement <2 x float> %1, float %i.aj, i64 1
  %3 = insertelement <2 x float> poison, float %i.ak, i64 0
  %4 = shufflevector <2 x float> %3, <2 x float> poison, <2 x i32> zeroinitializer
  %5 = fdiv <2 x float> %2, %4                    ; 4 uses
  %i.at = load <8 x i32>, ptr %i.aq, align 4, !tbaa !143 ; 6 uses
  ...
  %i.az = load <2 x i32>, ptr %i.ar, align 4, !tbaa !143
  ...
  %i.bg = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ay, <2 x float> %6, <2 x float> %i.bf)
  %i.bh = load <2 x i32>, ptr %i.as, align 4, !tbaa !143
  ...
  %i.bu = load <2 x i32>, ptr %i.bt, align 4, !tbaa !143
  ...
  %i.by = load <2 x i32>, ptr %i.bx, align 4, !tbaa !143
  ...
  %7 = extractelement <2 x float> %foldExtExtBinop56, i64 0
  %i.ca = extractelement <2 x float> %5, i64 1
  %i.cb = tail call float @llvm.fmuladd.f32(float %i.bw, float %i.ca, float %7)
  %i.cc = getelementptr inbounds nuw i8, ptr %i.aq, i64 64
  %i.cd = load <2 x i32>, ptr %i.cc, align 4, !tbaa !143
  ...
  %8 = extractelement <2 x float> %foldExtExtBinop59, i64 0
  %i.cf = extractelement <2 x float> %5, i64 0
  %i.cg = tail call float @llvm.fmuladd.f32(float %8, float %i.cf, float %i.cb) ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  store i32 %i.d, ptr %i.g, align 8, !tbaa !400
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  store ptr %i.i, ptr %3, align 8, !tbaa !270
  %i.j = getelementptr inbounds nuw i8, ptr %3, i64 8 ; 5 uses
  store i64 0, ptr %i.j, align 8, !tbaa !271
  ...
  store ptr %i.l, ptr %i.k, align 8, !tbaa !270
  %i.m = getelementptr inbounds nuw i8, ptr %3, i64 40 ; 5 uses
  store i64 0, ptr %i.m, align 8, !tbaa !271
  store i8 0, ptr %i.l, align 8, !tbaa !59
...
bb.d:                                             ; preds = %bb.c
  %i.n = load ptr, ptr %3, align 8, !tbaa !253    ; 6 uses
  %i.o = icmp eq ptr %i.n, %i.i
  %i.p = load ptr, ptr %4, align 8, !tbaa !253    ; 5 uses
...
bb.e:                                             ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i
  ...
  %i.t = load i64, ptr %i.s, align 8, !tbaa !271  ; 3 uses
...
bb.f:                                             ; preds = %bb.e
  %i.v = load i8, ptr %i.p, align 1, !tbaa !59
  store i8 %i.v, ptr %i.n, align 1, !tbaa !59
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_S_copyEPcPKcm.exit.i.i: ; preds = %bb.g, %bb.f, %bb.e
  %i.w = load i64, ptr %i.s, align 8, !tbaa !271  ; 2 uses
  store i64 %i.w, ptr %i.j, align 8, !tbaa !271
  %i.x = load ptr, ptr %3, align 8, !tbaa !253
  %i.y = getelementptr inbounds nuw i8, ptr %i.x, i64 %i.w
  store i8 0, ptr %i.y, align 1, !tbaa !59
  %.pre.i.i = load ptr, ptr %4, align 8, !tbaa !253
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit.i

.thread.i.i:                                      ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i
  store ptr %i.p, ptr %3, align 8, !tbaa !253
  %i.z = getelementptr inbounds nuw i8, ptr %4, i64 8
  %i.aa = load <2 x i64>, ptr %i.z, align 8, !tbaa !59
  store <2 x i64> %i.aa, ptr %i.j, align 8, !tbaa !59
  br label %bb.i

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit23.thread25.i.i: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i
  %i.ab = load i64, ptr %i.i, align 8, !tbaa !59
  store ptr %i.p, ptr %3, align 8, !tbaa !253
  %i.ac = getelementptr inbounds nuw i8, ptr %4, i64 8
  %i.ad = load <2 x i64>, ptr %i.ac, align 8, !tbaa !59
  store <2 x i64> %i.ad, ptr %i.j, align 8, !tbaa !59
  %.not.i.i = icmp eq ptr %i.n, null
  br i1 %.not.i.i, label %bb.i, label %bb.h

bb.h:                                             ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit23.thread25.i.i
  store ptr %i.n, ptr %4, align 8, !tbaa !253
  store i64 %i.ab, ptr %i.q, align 8, !tbaa !59
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit.i

bb.i:                                             ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit23.thread25.i.i, %.thread.i.i
  store ptr %i.q, ptr %4, align 8, !tbaa !253
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit.i
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit.i: ; preds = %bb.i, %bb.h, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_S_copyEPcPKcm.exit.i.i
  ...
  store i64 0, ptr %i.af, align 8, !tbaa !271
  store i8 0, ptr %i.ae, align 1, !tbaa !59
  %i.ag = getelementptr inbounds nuw i8, ptr %4, i64 32 ; 5 uses
  %i.ah = load ptr, ptr %i.k, align 8, !tbaa !253 ; 6 uses
  %i.ai = icmp eq ptr %i.ah, %i.l
  %i.aj = load ptr, ptr %i.ag, align 8, !tbaa !253 ; 5 uses
...
bb.j:                                             ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i3.i, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i9.i
  ...
  %i.an = load i64, ptr %i.am, align 8, !tbaa !271 ; 3 uses
...
bb.k:                                             ; preds = %bb.j
  %i.ap = load i8, ptr %i.aj, align 1, !tbaa !59
  store i8 %i.ap, ptr %i.ah, align 1, !tbaa !59
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_S_copyEPcPKcm.exit.i7.i: ; preds = %bb.l, %bb.k, %bb.j
  %i.aq = load i64, ptr %i.am, align 8, !tbaa !271 ; 2 uses
  store i64 %i.aq, ptr %i.m, align 8, !tbaa !271
  %i.ar = load ptr, ptr %i.k, align 8, !tbaa !253
  %i.as = getelementptr inbounds nuw i8, ptr %i.ar, i64 %i.aq
  store i8 0, ptr %i.as, align 1, !tbaa !59
  %.pre.i8.i = load ptr, ptr %i.ag, align 8, !tbaa !253
...
.thread.i10.i:                                    ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i9.i
  store ptr %i.aj, ptr %i.k, align 8, !tbaa !253
  %i.at = getelementptr inbounds nuw i8, ptr %4, i64 40
  %i.au = load <2 x i64>, ptr %i.at, align 8, !tbaa !59
  store <2 x i64> %i.au, ptr %i.m, align 8, !tbaa !59
  br label %bb.n
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit23.thread25.i4.i: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i3.i
  %i.av = load i64, ptr %i.l, align 8, !tbaa !59
  store ptr %i.aj, ptr %i.k, align 8, !tbaa !253
  %i.aw = getelementptr inbounds nuw i8, ptr %4, i64 40
  %i.ax = load <2 x i64>, ptr %i.aw, align 8, !tbaa !59
end_hunk_0
