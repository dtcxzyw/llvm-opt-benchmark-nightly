...
bb.fj:                                            ; preds = %bb.fg
  ...
  %i.bdk = sext i32 %.3.i to i64                  ; 5 uses
...
.lr.ph363.i:                                      ; preds = %bb.fr
  ...
  %i.bet = zext nneg i32 %i.bch to i64            ; 5 uses
...
bb.fs:                                            ; preds = %.loopexit.i, %.lr.ph360.i
  ...
  %.0299359.i = phi i64 [ 0, %.lr.ph360.i ], [ %i.bmd, %.loopexit.i ] ; 8 uses
  %33 = mul i64 %.0299359.i, %i.bet
  %34 = add i64 %33, %i.bdk
  %i.bge = mul i64 %.0299359.i, %i.bet            ; 2 uses
  %i.bgf = mul i64 %.0299359.i, %i.bet            ; 5 uses
  %i.bgg = add i64 %i.bgf, %i.bdk
...
.lr.ph.i23:                                       ; preds = %.preheader350.i
  ...
  %umin = call i64 @llvm.umin.i64(i64 %34, i64 %i.bgi) ; 2 uses
