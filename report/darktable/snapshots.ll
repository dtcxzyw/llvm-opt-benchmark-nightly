...
bb.ah:                                            ; preds = %bb.ag
  ...
  %6 = fmul reassoc nsz arcp contract afn double %i.fh, 2.000000e-02
  %7 = call reassoc nsz arcp contract afn double @llvm.minnum.f64(double %6, double 2.400000e+01) ; 3 uses
...
bb.ai:                                            ; preds = %bb.ah
  ...
  %i.fn = fmul reassoc nnan nsz arcp contract afn double %7, 5.000000e-01 ; 2 uses
...
bb.aj:                                            ; preds = %bb.ah
  ...
  %i.fq = fmul reassoc nnan nsz arcp contract afn double %7, 5.000000e-01 ; 2 uses
...
bb.e:                                             ; preds = %._crit_edge, %bb.d
  ...
  %5 = fmul reassoc nsz arcp contract afn double %i.q, 2.000000e-02
  %i.t = tail call reassoc nsz arcp contract afn double @llvm.minnum.f64(double %5, double 2.400000e+01) ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.z = fmul reassoc nnan nsz arcp contract afn double %i.t, 5.000000e-01 ; 2 uses
  %i.aa = fsub reassoc nsz arcp contract afn double %i.y, %i.z
  br label %_get_rotation_area.exit

bb.g:                                             ; preds = %bb.e
  %i.ab = fmul reassoc nsz arcp contract afn double %i.q, 5.000000e-01
  %i.ac = fmul reassoc nnan nsz arcp contract afn double %i.t, 5.000000e-01 ; 2 uses
