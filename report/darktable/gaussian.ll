...
.preheader269.lr.ph.i:                            ; preds = %bb.d
  ...
  %8 = sext i32 %i.m to i64                       ; 2 uses
  %9 = sext i32 %i.o to i64                       ; 2 uses
...
.preheader355.lr.ph.i:                            ; preds = %bb.u
  %i.lo = shl nsw i32 %2, 3
  %i.lp = mul nsw i32 %2, 6
  %i.lq = shl nsw i32 %2, 2
  %i.lr = shl nsw i32 %2, 1
  %i.ls = icmp sgt i32 %2, 0
  %11 = sext i32 %i.lo to i64                     ; 2 uses
  %12 = sext i32 %i.lq to i64                     ; 2 uses
  %invariant.gep.i38 = getelementptr [4 x i8], ptr %0, i64 %12
  %invariant.gep362.i = getelementptr [4 x i8], ptr %0, i64 %11
  %13 = sext i32 %i.lr to i64                     ; 2 uses
  %invariant.gep364.i = getelementptr [4 x i8], ptr %0, i64 %13
  %14 = sext i32 %i.lp to i64                     ; 2 uses
...
.preheader355.lr.ph.i46:                          ; preds = %bb.w
  %i.adz = shl nsw i32 %2, 4
  %i.aea = mul nsw i32 %2, 12
  %i.aeb = shl nsw i32 %2, 3
  %i.aec = shl nsw i32 %2, 2
  %i.aed = icmp sgt i32 %2, 0
  %i.aee = getelementptr inbounds nuw i8, ptr %i.a, i64 56
  %i.aef = load <4 x float>, ptr %i.aee, align 8
  %15 = sext i32 %i.adz to i64                    ; 2 uses
  %16 = sext i32 %i.aeb to i64                    ; 2 uses
  ...
  %17 = sext i32 %i.aec to i64                    ; 2 uses
  ...
  %18 = sext i32 %i.aea to i64                    ; 2 uses
