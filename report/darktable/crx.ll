...
bb.b:                                             ; preds = %bb.a
  ...
  %4 = add nuw nsw i64 %i.s, 4294967248
  %5 = and i64 %4, 4294967280
  %6 = getelementptr inbounds nuw [4 x i8], ptr @exCoefNumTbl, i64 %5 ; 2 uses
  %i.t = and i32 %i.p, 7
  %i.u = mul nuw nsw i32 %i.t, 6
  %i.v = zext nneg i32 %i.u to i64
  %i.w = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %i.v ; 4 uses
  %i.x = and i32 %i.q, 7
  %i.y = mul nuw nsw i32 %i.x, 6
  %i.z = zext nneg i32 %i.y to i64
  %i.aa = getelementptr inbounds nuw [4 x i8], ptr %6, i64 %i.z ; 4 uses
