...
bb.h:                                             ; preds = %._crit_edge380, %._crit_edge385
  ...
  %i.ay = sext i8 %i.ar to i16                    ; 2 uses
  %.lhs.trunc318 = add nsw i16 %i.ay, 1
  %2 = srem i16 %.lhs.trunc318, 5
  %i.az = sext i16 %2 to i64
  ...
  %.lhs.trunc320 = add nsw i16 %i.ay, 2
  %3 = srem i16 %.lhs.trunc320, 5
  %i.be = sext i16 %3 to i64
