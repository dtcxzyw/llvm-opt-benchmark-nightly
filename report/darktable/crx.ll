...
bb.h:                                             ; preds = %._crit_edge380, %._crit_edge385
  ...
  %i.ar = load i8, ptr %i.aq, align 4, !tbaa !114 ; 2 uses
  %i.as = sext i8 %i.ar to i16                    ; 2 uses
  ...
  %i.ay = insertelement <2 x i16> poison, i16 %i.as, i64 0
...
bb.r:                                             ; preds = %bb.d
  ...
  %i.jd = load i8, ptr %i.jc, align 4, !tbaa !114 ; 2 uses
  %i.je = sext i8 %i.jd to i16                    ; 2 uses
  ...
  %.lhs.trunc316 = add nsw i16 %i.je, 1
