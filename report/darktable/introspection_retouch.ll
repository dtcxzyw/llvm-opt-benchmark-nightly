...
bb.an:                                            ; preds = %bb.am
  ...
  call fastcc void @_retouch_clone(ptr noundef %0, ptr noundef nonnull %i.ad, ptr noundef %.0.i156, ptr noundef %4, i32 noundef %i.iz, i32 noundef %i.ek, float noundef %i.bv)
  br label %bb.av

bb.ao:                                            ; preds = %bb.am
  %i.ja = load i32, ptr %i.bp, align 4, !tbaa !340
  %i.jb = extractelement <2 x i32> %i.ej, i64 0
  call fastcc void @_retouch_heal(ptr noundef %0, ptr noundef nonnull %i.ad, ptr noundef %.0.i156, ptr noundef %4, i32 noundef %i.jb, i32 noundef %i.ek, float noundef %i.bv, i32 noundef %i.ja)
  br label %bb.av
...
bb.ap:                                            ; preds = %bb.am
  ...
  call fastcc void @_retouch_blur(ptr noundef %i.k, ptr noundef %0, ptr noundef nonnull %i.ad, ptr noundef %.0.i156, ptr noundef %4, float noundef %i.bv, i32 noundef %i.jd, float noundef %i.jf, ptr noundef nonnull %i.m)
  br label %bb.av
...
bb.at:                                            ; preds = %bb.as, %bb.ar
  ...
  call fastcc void @_retouch_fill(ptr noundef %0, ptr noundef nonnull %i.ad, ptr noundef nonnull %.0.i156, ptr noundef %4, float noundef %i.bv, ptr noundef %i.h)
...
bb.aw:                                            ; preds = %bb.av
  ...
  call fastcc void @rt_copy_mask_to_alpha(ptr noundef %0, ptr noundef nonnull %i.ad, i32 noundef %i.jv, ptr noundef nonnull %.0.i156, ptr noundef %4, float noundef %i.bv)
  br label %bb.ax

bb.ax:                                            ; preds = %bb.av, %bb.aw, %bb.al
  %i.jw = load ptr, ptr %i.e, align 8, !tbaa !335
  call void @free(ptr noundef %i.jw) #27
  call void @free(ptr noundef nonnull %.0.i156) #27
  br label %bb.ay
...
bb.bb:                                            ; preds = %rt_masks_form_is_in_roi.exit.thread, %bb.o, %bb.s, %bb.ba, %rt_masks_form_is_in_roi.exit, %bb.q, %bb.p, %bb.m
  %i.jx = getelementptr inbounds nuw i8, ptr %.0129168, i64 8
  %.0129 = load ptr, ptr %i.jx, align 8, !tbaa !133 ; 2 uses
...
.lr.ph.split.us:                                  ; preds = %.lr.ph, %dt_XYZ_to_Lab.exit.us
  ...
  %.0304.us = phi float [ %i.ab, %dt_XYZ_to_Lab.exit.us ], [ f0xFF7FFFFF, %.lr.ph ] ; 2 uses
  %.0322.us = phi float [ %i.ae, %dt_XYZ_to_Lab.exit.us ], [ 0.000000e+00, %.lr.ph ]
  %.0331.us = phi float [ %i.ad, %dt_XYZ_to_Lab.exit.us ], [ f0x7F7FFFFF, %.lr.ph ] ; 2 uses
...
dt_XYZ_to_Lab.exit.us:                            ; preds = %bb.c, %bb.b
  ...
  %i.aa = fcmp reassoc nsz arcp contract afn ogt float %.0304.us, %i.z
  %i.ab = select reassoc nsz arcp contract afn i1 %i.aa, float %.0304.us, float %i.z ; 2 uses
  %i.ac = fcmp reassoc nsz arcp contract afn olt float %.0331.us, %i.z
  %i.ad = select reassoc nsz arcp contract afn i1 %i.ac, float %.0331.us, float %i.z ; 2 uses
  %i.ae = fadd reassoc nsz arcp contract afn float %i.z, %.0322.us ; 2 uses
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit13, %._crit_edge.loopexit, %bb.a
  %.033.lcssa = phi float [ f0x7F7FFFFF, %bb.a ], [ %i.ad, %._crit_edge.loopexit ], [ %i.be, %._crit_edge.loopexit13 ]
  %.032.lcssa = phi float [ 0.000000e+00, %bb.a ], [ %i.ae, %._crit_edge.loopexit ], [ %i.bf, %._crit_edge.loopexit13 ]
  %.031.lcssa = phi i32 [ 0, %bb.a ], [ %i.an, %._crit_edge.loopexit ], [ %i.ar, %._crit_edge.loopexit13 ]
  %.030.lcssa = phi float [ f0xFF7FFFFF, %bb.a ], [ %i.ab, %._crit_edge.loopexit ], [ %i.bc, %._crit_edge.loopexit13 ]
  %i.as = fmul reassoc nsz arcp contract afn float %.033.lcssa, f0x3C23D70A
  store float %i.as, ptr %3, align 4, !tbaa !18
  %i.at = fmul reassoc nsz arcp contract afn float %.030.lcssa, f0x3C23D70A
  %i.au = getelementptr inbounds nuw i8, ptr %3, i64 8
  store float %i.at, ptr %i.au, align 4, !tbaa !18
  %i.av = uitofp nneg i32 %.031.lcssa to float
  %i.aw = fmul reassoc nsz arcp contract afn float %.032.lcssa, f0x3C23D70A
...
bb.d:                                             ; preds = %.lr.ph.split, %bb.d
  ...
  %.0304 = phi float [ f0xFF7FFFFF, %.lr.ph.split ], [ %i.bc, %bb.d ] ; 2 uses
  %.0322 = phi float [ 0.000000e+00, %.lr.ph.split ], [ %i.bf, %bb.d ]
  %.0331 = phi float [ f0x7F7FFFFF, %.lr.ph.split ], [ %i.be, %bb.d ] ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #27
  ...
  %i.bb = fcmp reassoc nsz arcp contract afn ogt float %.0304, %i.ba
  %i.bc = select reassoc nsz arcp contract afn i1 %i.bb, float %.0304, float %i.ba ; 2 uses
  %i.bd = fcmp reassoc nsz arcp contract afn olt float %.0331, %i.ba
  %i.be = select reassoc nsz arcp contract afn i1 %i.bd, float %.0331, float %i.ba ; 2 uses
  %i.bf = fadd reassoc nsz arcp contract afn float %i.ba, %.0322 ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #27
