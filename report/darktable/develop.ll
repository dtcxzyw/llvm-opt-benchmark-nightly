...
bb.bt:                                            ; preds = %bb.bs, %.loopexit
  ...
  %14 = uitofp reassoc nsz arcp contract afn i32 %i.la to double
  %15 = fadd reassoc nsz arcp contract afn double %i.kz, %14
  %16 = fsub reassoc nsz arcp contract afn double %15, %i.lc
...
bb.ca:                                            ; preds = %dt_dev_get_zoom_scale.exit326
  ...
  %i.mg = fadd reassoc nsz arcp contract afn <2 x float> %i.mf, %i.ci
...
bb.q:                                             ; preds = %bb.p, %bb.o, %bb.n, %bb.m
  ...
  %i.cj = fadd reassoc nsz arcp contract afn <2 x float> %i.cd, %i.ci
...
bb.p:                                             ; preds = %bb.o, %bb.n, %bb.m, %bb.l
  ...
  %i.ch = insertelement <2 x float> poison, float %1, i64 0
  %i.ci = insertelement <2 x float> %i.ch, float %2, i64 1
  %i.cj = fadd reassoc nsz arcp contract afn <2 x float> %i.cc, %i.ci
