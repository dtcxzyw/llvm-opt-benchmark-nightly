...
@switch.table.dt_develop_blend_legacy_params = private unnamed_addr constant [6 x float] [float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float f0xC0D49A78], align 4
@switch.table.dt_develop_blend_legacy_params.8 = private unnamed_addr constant [6 x i8] c"\01\02\03\02\03\04", align 4
...
begin_hunk_1_@_refine_with_detail_mask:bb.a
  store float %i.dv, ptr %i.dp, align 4, !tbaa !34
  %i.dw = add nuw i64 %.042, 4                    ; 2 uses
  %exitcond.not.3 = icmp eq i64 %i.dw, %i.as
  br i1 %exitcond.not.3, label %._crit_edge, label %.lr.ph, !llvm.loop !178

bb.g:                                             ; preds = %_detail_mask_threshold.exit, %bb.b, %bb.c
  %i.dx = load i32, ptr getelementptr inbounds nuw (i8, ptr @darktable, i64 8), align 8, !tbaa !92
  %i.dy = and i32 %i.dx, 33558528
  %.not41 = icmp eq i32 %i.dy, 0
  br i1 %.not41, label %bb.i, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.dz = load ptr, ptr %i.c, align 8, !tbaa !51
  tail call void (ptr, ptr, ptr, i32, ptr, ptr, ptr, ...) @dt_print_pipe_ext(ptr noundef nonnull @.str.15, ptr noundef %i.dz, ptr noundef %0, i32 noundef -1, ptr noundef %3, ptr noundef %4, ptr noundef nonnull @.str.17) #14
  br label %bb.i

bb.i:                                             ; preds = %bb.h, %bb.g
  %i.ea = tail call ptr @dcgettext(ptr noundef null, ptr noundef nonnull @.str.18, i32 noundef 5) #14
  tail call void (ptr, ...) @dt_control_log(ptr noundef %i.ea) #14
  br label %bb.j

bb.j:                                             ; preds = %._crit_edge, %bb.i, %bb.a
  ret void
}
...
bb.a:
  ...
  store i32 0, ptr %i.b, align 4, !tbaa !179
  %i.c = getelementptr inbounds nuw i8, ptr %4, i64 20
  store i32 0, ptr %i.c, align 4, !tbaa !181
  %i.d = getelementptr inbounds nuw i8, ptr %4, i64 24
  store i32 1, ptr %i.d, align 4, !tbaa !182
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.p = load i32, ptr %i.o, align 8, !tbaa !184
  %i.q = getelementptr inbounds nuw i8, ptr %i.l, i64 572
  %i.r = load i32, ptr %i.q, align 4, !tbaa !185
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.aj = load i32, ptr %i.ai, align 4, !tbaa !186
  ...
  %spec.select39 = select i1 %i.an, float %i.ao, float 6.000000e+00
  %i.ap = fadd reassoc nsz arcp contract afn float %i.ac, 1.500000e+00
  %i.aq = select i1 %i.am, float %i.ap, float 2.500000e+00
  br label %bb.g

bb.g:                                             ; preds = %bb.f, %bb.e
  %i.ar = phi float [ %i.aq, %bb.f ], [ %i.ac, %bb.e ]
  %i.as = phi float [ %spec.select39, %bb.f ], [ %i.ac, %bb.e ]
  ...
  %i.aw = load i32, ptr %i.av, align 4, !tbaa !81
  ...
  %i.be = sitofp reassoc nsz arcp contract afn i32 %i.bd to float
  %i.bf = fdiv reassoc nsz arcp contract afn float %i.ay, %i.be ; 2 uses
  %i.bg = fadd reassoc nsz arcp contract afn float %i.bf, %i.as
  store float %i.bg, ptr %4, align 4, !tbaa !187
  %i.bh = fadd reassoc nsz arcp contract afn float %i.ar, %i.bf
  store float %i.bh, ptr %i.a, align 4, !tbaa !188
  br label %bb.h
...
switch.lookup:                                    ; preds = %bb.b
  ...
  %switch.gep577 = getelementptr inbounds nuw i8, ptr @switch.table.dt_develop_blend_legacy_params.8, i64 %6
...
.lr.ph.i:                                         ; preds = %_blend_default_module_blend_colorspace.exit, %bb.c
  ...
  %i.o = load i8, ptr %i.n, align 1, !tbaa !189
...
.loopexit:                                        ; preds = %bb.c, %_blend_default_module_blend_colorspace.exit
  ...
  store i32 %.0.i, ptr %.sroa.14.0..sroa_idx, align 4, !tbaa !82
...
bb.e:                                             ; preds = %bb.d
  ...
  store i32 %.0.i, ptr %.sroa.14.0..sroa_idx432, align 4, !tbaa !82
  ...
  %i.r = load i32, ptr %1, align 4, !tbaa !192    ; 5 uses
...
switch.lookup580:                                 ; preds = %switch.hole_check
  %trunc.i.mask601 = and i32 %i.r, 63
  %i.w = zext nneg i32 %trunc.i.mask601 to i64
  %switch.gep581 = getelementptr inbounds nuw [4 x i8], ptr @switch.table._blend_legacy_blend_mode, i64 %i.w
...
bb.h:                                             ; preds = %bb.g
  ...
  store i32 %.0.i, ptr %.sroa.14.0..sroa_idx434, align 4, !tbaa !82
  ...
  %i.af = load i32, ptr %1, align 4, !tbaa !196   ; 5 uses
  %i.ag = icmp ne i32 %i.af, 0                    ; 2 uses
  %i.ah = zext i1 %i.ag to i32
  %i.ai = getelementptr inbounds nuw i8, ptr %1, i64 12
  %i.aj = load i32, ptr %i.ai, align 4, !tbaa !198 ; 3 uses
  ...
  br i1 %i.an, label %switch.hole_check584, label %_blend_legacy_blend_mode.exit383
...
switch.lookup585:                                 ; preds = %switch.hole_check584
  %trunc.i381.mask600 = and i32 %i.af, 63
  %i.ao = zext nneg i32 %trunc.i381.mask600 to i64
  %switch.gep589 = getelementptr inbounds nuw [4 x i8], ptr @switch.table._blend_legacy_blend_mode, i64 %i.ao
...
_blend_legacy_blend_mode.exit383:                 ; preds = %switch.lookup585, %switch.hole_check584, %bb.h
  %.not.i382 = phi i32 [ %i.am, %bb.h ], [ %switch.load590, %switch.lookup585 ], [ %i.am, %switch.hole_check584 ] ; 2 uses
  %i.ap = add i64 %i.b, 8
...
bb.k:                                             ; preds = %bb.j
  ...
  store i32 %.0.i, ptr %.sroa.14.0..sroa_idx436, align 4, !tbaa !82
  ...
  br i1 %i.bc, label %switch.hole_check592, label %_blend_legacy_blend_mode.exit386
...
switch.lookup593:                                 ; preds = %switch.hole_check592
  %trunc.i384.mask599 = and i32 %i.au, 63
  %i.bd = zext nneg i32 %trunc.i384.mask599 to i64
  %switch.gep597 = getelementptr inbounds nuw [4 x i8], ptr @switch.table._blend_legacy_blend_mode, i64 %i.bd
...
_blend_legacy_blend_mode.exit386:                 ; preds = %switch.lookup593, %switch.hole_check592, %bb.k
  %.not.i385 = phi i32 [ %i.bb, %bb.k ], [ %switch.load598, %switch.lookup593 ], [ %i.bb, %switch.hole_check592 ]
  store i32 %.not.i385, ptr %.sroa.15.0..sroa_idx455, align 4, !tbaa !35
  %i.be = getelementptr inbounds nuw i8, ptr %1, i64 4
  %i.bf = load float, ptr %i.be, align 4, !tbaa !202
  ...
  %i.bi = load i32, ptr %i.bh, align 4, !tbaa !203
...
bb.n:                                             ; preds = %bb.m
  ...
  store i32 %.0.i, ptr %.sroa.14.0..sroa_idx438, align 4, !tbaa !82
  ...
  %i.bq = load i32, ptr %1, align 4, !tbaa !204   ; 2 uses
  ...
  %i.bw = load float, ptr %i.bv, align 4, !tbaa !206
...
bb.q:                                             ; preds = %bb.p
  ...
  store i32 %.0.i, ptr %.sroa.14.0..sroa_idx440, align 4, !tbaa !82
  ...
  %i.cm = load i32, ptr %1, align 4, !tbaa !209   ; 2 uses
  store i32 %i.cm, ptr %3, align 4, !tbaa !78
  %i.cn = getelementptr inbounds nuw i8, ptr %1, i64 4
  %i.co = load i32, ptr %i.cn, align 4, !tbaa !211
  ...
  %i.cr = load float, ptr %i.cq, align 4, !tbaa !212
  ...
  %i.db = load i32, ptr %i.da, align 4, !tbaa !215 ; 3 uses
  %i.dc = or i32 %i.db, 31
...
bb.w:                                             ; preds = %bb.v
  ...
  store i32 %.0.i, ptr %.sroa.14.0..sroa_idx442, align 4, !tbaa !82
  ...
  %i.dp = load i32, ptr %1, align 4, !tbaa !216   ; 2 uses
  store i32 %i.dp, ptr %3, align 4, !tbaa !78
  %i.dq = getelementptr inbounds nuw i8, ptr %1, i64 4
  %i.dr = load i32, ptr %i.dq, align 4, !tbaa !218
  ...
  %i.du = load float, ptr %i.dt, align 4, !tbaa !219
...
bb.ac:                                            ; preds = %bb.ab
  ...
  store i32 %.0.i, ptr %.sroa.14.0..sroa_idx444, align 4, !tbaa !82
  ...
  %i.ep = load i32, ptr %1, align 4, !tbaa !223   ; 2 uses
  store i32 %i.ep, ptr %3, align 4, !tbaa !78
  %i.eq = getelementptr inbounds nuw i8, ptr %1, i64 4
  %i.er = load i32, ptr %i.eq, align 4, !tbaa !225
  ...
  %i.eu = load float, ptr %i.et, align 4, !tbaa !226
  ...
  %i.fe = load i32, ptr %i.fd, align 4, !tbaa !229
...
bb.ai:                                            ; preds = %bb.ah
  ...
  store i32 %.0.i, ptr %.sroa.14.0..sroa_idx446, align 4, !tbaa !82
  ...
  %i.fp = load i32, ptr %1, align 4, !tbaa !230   ; 2 uses
  store i32 %i.fp, ptr %3, align 4, !tbaa !78
  %i.fq = getelementptr inbounds nuw i8, ptr %1, i64 4
  %i.fr = load i32, ptr %i.fq, align 4, !tbaa !232
  ...
  %i.fu = load float, ptr %i.ft, align 4, !tbaa !233
  ...
  %i.ge = load float, ptr %i.gd, align 4, !tbaa !236
  ...
  %i.gh = load i32, ptr %i.gg, align 4, !tbaa !237
  ...
  %i.gn = load float, ptr %i.gm, align 4, !tbaa !238
...
bb.ao:                                            ; preds = %bb.an
  ...
  store i32 %.0.i, ptr %.sroa.14.0..sroa_idx448, align 4, !tbaa !82
  ...
  %i.gy = load i32, ptr %1, align 4, !tbaa !239   ; 3 uses
  store i32 %i.gy, ptr %3, align 4, !tbaa !78
  %i.gz = getelementptr inbounds nuw i8, ptr %1, i64 4
  %i.ha = load i32, ptr %i.gz, align 4, !tbaa !241
  ...
  %i.hd = load float, ptr %i.hc, align 4, !tbaa !242
  ...
  %i.hn = load float, ptr %i.hm, align 4, !tbaa !245
  ...
  %i.hq = load i32, ptr %i.hp, align 4, !tbaa !246
  ...
  %i.hw = load float, ptr %i.hv, align 4, !tbaa !247
...
bb.ax:                                            ; preds = %bb.aw
  ...
  store i32 %.0.i, ptr %.sroa.14.0..sroa_idx450, align 4, !tbaa !82
  ...
  %i.jl = load float, ptr %i.jk, align 4, !tbaa !258
  ...
  %i.ju = load float, ptr %i.jt, align 4, !tbaa !260
...
_fix_masks_combine.exit414:                       ; preds = %bb.bg, %bb.bh, %.sink.split.i412
  ...
  %i.ll = load i8, ptr %i.lk, align 4, !tbaa !189
...
bb.bk:                                            ; preds = %_fix_masks_combine.exit414
  ...
  %i.ln = load i32, ptr %i.lm, align 4, !tbaa !251
  br label %bb.bl
...
bb.bl:                                            ; preds = %_fix_masks_combine.exit414, %bb.bk
  ...
  store i32 %i.lo, ptr %i.lp, align 4, !tbaa !251
