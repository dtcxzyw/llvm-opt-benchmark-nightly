...
._crit_edge189:                                   ; preds = %.lr.ph188, %bb.e, %bb.f, %.._crit_edge189_crit_edge
  ...
  %6 = and i64 %.pre-phi, 14                      ; 6 uses
  %7 = and i32 %.0155.lcssa, 1
  %8 = trunc nuw nsw i64 %6 to i32
  %.tr.i166 = or disjoint i32 %7, %8
...
.prol.preheader290:                               ; preds = %.lr.ph196, %.prol.preheader290
  ...
  %9 = and i64 %indvars.iv226.prol, 1
  %10 = or disjoint i64 %9, %6
  %.tr.i170.prol = trunc nuw nsw i64 %10 to i32
...
.lr.ph196.new:                                    ; preds = %.prol.loopexit291
  %11 = and i64 %indvars.iv226.unr, 1
  %12 = xor i64 %11, 1                            ; 2 uses
  %13 = and i64 %indvars.iv226.unr, 1             ; 2 uses
  %14 = or disjoint i64 %13, %6
  %.tr.i170 = trunc nuw nsw i64 %14 to i32
  ...
  %.tr.i170.1 = trunc nuw nsw i64 %15 to i32
  ...
  %16 = or disjoint i64 %13, %6
  %.tr.i170.2 = trunc nuw nsw i64 %16 to i32
  ...
  %17 = or disjoint i64 %12, %6
  %.tr.i170.3 = trunc nuw nsw i64 %17 to i32
