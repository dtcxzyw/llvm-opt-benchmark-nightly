...
bb.c:                                             ; preds = %.preheader134, %.loopexit131
  ...
  %i.ce = fmul reassoc nnan nsz arcp contract afn double %i.cd, f0x4092FEF286BCA1AF
  %i.cf = fadd reassoc nsz arcp contract afn double %i.ce, 1.901000e+03
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #22
  call fastcc void @_temperature_to_XYZ(ptr dead_on_unwind noalias writable align 8 %2, double noundef %i.cf)
  ...
  %6 = getelementptr inbounds nuw i8, ptr %.val.i109, i64 424
  %7 = load double, ptr %6, align 8, !tbaa !158
  %i.dw = getelementptr inbounds nuw i8, ptr %.val.i109, i64 432
  %i.dx = load double, ptr %i.dw, align 8, !tbaa !158
  %8 = getelementptr inbounds nuw i8, ptr %.val.i109, i64 440
  %9 = getelementptr inbounds nuw i8, ptr %.val.i109, i64 448
  %i.dy = getelementptr inbounds nuw i8, ptr %.val.i109, i64 456
  call void @llvm.lifetime.end.p0(ptr nonnull %1) #22
  %10 = fmul reassoc nsz arcp contract afn double %i.do, %i.aa
  %i.dz = fmul reassoc nsz arcp contract afn double %i.dp, %i.w
  %11 = fmul reassoc nsz arcp contract afn double %10, %i.df
  %12 = fmul reassoc nsz arcp contract afn double %i.dz, %i.do
  %13 = insertelement <2 x double> poison, double %12, i64 0
  %14 = insertelement <2 x double> %13, double %11, i64 1
  %15 = fdiv reassoc nsz arcp contract afn <2 x double> splat (double 1.000000e+00), %14
  %16 = fptrunc <2 x double> %15 to <2 x float>   ; 4 uses
  %i.ea = fmul reassoc nnan nsz arcp contract afn double %i.cd, f0x3FBD8555E8807C2C
  %17 = fadd reassoc nsz arcp contract afn double %i.ea, 1.350000e-01
  %18 = fdiv reassoc nsz arcp contract afn double %i.dq, %17 ; 3 uses
  %i.eb = fmul reassoc nsz arcp contract afn double %i.dv, %.sroa.0.0.copyload.i110
  %i.ec = fmul reassoc nsz arcp contract afn double %7, %18
  %19 = fadd reassoc nsz arcp contract afn double %i.ec, %i.eb
  %i.ed = fmul reassoc nsz arcp contract afn double %i.dx, %.sroa.5.0.copyload.i112
  %20 = fadd reassoc nsz arcp contract afn double %19, %i.ed
  %21 = fdiv reassoc nsz arcp contract afn double 1.000000e+00, %20
  %22 = load double, ptr %8, align 8, !tbaa !158
  %23 = load double, ptr %i.dt, align 8, !tbaa !158
  %i.ee = load double, ptr %i.ds, align 8, !tbaa !158
  %i.ef = load double, ptr %i.dr, align 8, !tbaa !158
  %i.eg = load double, ptr %i.dy, align 8, !tbaa !158
  %i.eh = load double, ptr %9, align 8, !tbaa !158
  %i.ei = insertelement <2 x double> poison, double %i.ef, i64 0
  %i.ej = insertelement <2 x double> %i.ei, double %22, i64 1
  ...
  %i.en = fmul reassoc nsz arcp contract afn double %i.eh, %18
  %i.eo = fmul reassoc nsz arcp contract afn double %i.ee, %18
  ...
  %i.es = insertelement <2 x double> poison, double %23, i64 0
  ...
  %i.ey = insertelement <2 x double> poison, double %21, i64 0
  ...
  %24 = fmul reassoc nnan nsz arcp contract afn double %i.cd, f0x3FAAF286BCA1AF28
  %25 = fptrunc reassoc nsz arcp contract afn double %24 to float ; 2 uses
  %i.fd = extractelement <2 x float> %16, i64 1
  %i.fe = shufflevector <2 x float> %16, <2 x float> %i.fc, <2 x i32> <i32 0, i32 2>
...
.preheader132:                                    ; preds = %bb.c
  ...
  %i.fo = fdiv reassoc nsz arcp contract afn <2 x float> %16, %i.fn
...
.loopexit133:                                     ; preds = %.preheader132, %bb.c
  ...
  %i.fs = phi <2 x float> [ %i.fr, %.preheader132 ], [ %16, %bb.c ] ; 2 uses
...
.loopexit131:                                     ; preds = %.preheader130, %.loopexit133
  ...
  tail call void @dt_bauhaus_slider_set_stop(ptr noundef %i.gb, float noundef %25, float noundef %i.gc, float noundef %.sroa.7176.0, float noundef %i.gd) #22
  %i.ge = load ptr, ptr %i.d, align 8, !tbaa !133
  %i.gf = extractelement <2 x float> %i.ga, i64 0
  %i.gg = extractelement <2 x float> %i.ga, i64 1
  tail call void @dt_bauhaus_slider_set_stop(ptr noundef %i.ge, float noundef %25, float noundef %i.gf, float noundef %.sroa.7.0, float noundef %i.gg) #22
