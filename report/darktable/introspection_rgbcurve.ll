...
.lr.ph193:                                        ; preds = %bb.y
  ...
  %min.iters.check250 = icmp ult i32 %i.fe, 24
  br i1 %min.iters.check250, label %scalar.ph.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %.lr.ph193
  %i.fh = mul nsw i64 %i.o, 160                   ; 3 uses
  %i.fi = shl nuw nsw i64 %wide.trip.count, 3     ; 2 uses
  ...
  %4 = add nsw i64 %i.fh, %i.fi                   ; 2 uses
  %scevgep244 = getelementptr i8, ptr %i.b, i64 %4
  %scevgep245 = getelementptr i8, ptr %i.d, i64 %i.fl
  %scevgep246 = getelementptr i8, ptr %i.d, i64 %4
