...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %5 = shufflevector <8 x float> %i.m, <8 x float> %i.s, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %6 = shufflevector <8 x float> %i.l, <8 x float> %i.r, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %7 = fmul reassoc nsz arcp contract afn <16 x float> %5, %6
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %6 = shufflevector <8 x float> %i.n, <8 x float> %i.t, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %7 = fmul reassoc nsz arcp contract afn <16 x float> %5, %6
