...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.cs = fadd reassoc nsz arcp contract afn <8 x float> %predphi85, %i.cr
  %i.ct = fadd reassoc nsz arcp contract afn <8 x float> %i.cs, splat (float 1.000000e+00)
...
dt_RGB_2_HSL.exit33:                              ; preds = %dt_RGB_2_HSL.exit, %_dt_RGB_2_Hue.exit.i31
  ...
  %i.hg = fadd reassoc nsz arcp contract afn float %.024.i, %i.hf
  %i.hh = fadd reassoc nsz arcp contract afn float %i.hg, 1.000000e+00
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.cy = fadd reassoc nsz arcp contract afn <8 x float> %predphi88, %i.cx
  %i.cz = fadd reassoc nsz arcp contract afn <8 x float> %i.cy, splat (float 1.000000e+00)
...
dt_RGB_2_HSL.exit35:                              ; preds = %dt_RGB_2_HSL.exit, %_dt_RGB_2_Hue.exit.i33
  ...
  %i.ht = fadd reassoc nsz arcp contract afn float %.024.i, %i.hs
  %i.hu = fadd reassoc nsz arcp contract afn float %i.ht, 1.000000e+00
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.cx = fmul reassoc nsz arcp contract afn <8 x float> %i.cv, %i.cw
  %i.cy = fadd reassoc nsz arcp contract afn <8 x float> %predphi87, %i.cx
  %i.cz = fadd reassoc nsz arcp contract afn <8 x float> %i.cy, splat (float 1.000000e+00)
  %i.da = frem reassoc nsz arcp contract afn <8 x float> %i.cz, splat (float 1.000000e+00)
