...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %5 = fmul reassoc nsz arcp contract afn <4 x float> %strided.vec40, %wide.load
  %6 = fadd reassoc nsz arcp contract afn <4 x float> %5, %strided.vec36
  %7 = tail call reassoc nsz arcp contract afn <4 x float> @llvm.maxnum.v4f32(<4 x float> %6, <4 x float> zeroinitializer)
  %8 = tail call reassoc nsz arcp contract afn <4 x float> @llvm.minnum.v4f32(<4 x float> %7, <4 x float> splat (float 1.000000e+00))
  %9 = shufflevector <4 x float> %i.l, <4 x float> %i.o, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %10 = tail call reassoc nsz arcp contract afn <8 x float> @llvm.maxnum.v8f32(<8 x float> %9, <8 x float> zeroinitializer)
  %i.p = tail call reassoc nsz arcp contract afn <8 x float> @llvm.minnum.v8f32(<8 x float> %10, <8 x float> splat (float 1.000000e+00))
  %i.q = shufflevector <4 x float> %8, <4 x float> %wide.load, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %5 = fadd reassoc nsz arcp contract afn <4 x float> %strided.vec40, splat (float -1.000000e+00)
  %6 = fmul reassoc nsz arcp contract afn <4 x float> %5, %wide.load
  %i.r = fadd reassoc nsz arcp contract afn <4 x float> %6, %strided.vec36
  %7 = tail call reassoc nsz arcp contract afn <4 x float> @llvm.maxnum.v4f32(<4 x float> %i.r, <4 x float> zeroinitializer)
  %8 = tail call reassoc nsz arcp contract afn <4 x float> @llvm.minnum.v4f32(<4 x float> %7, <4 x float> splat (float 1.000000e+00))
  %9 = shufflevector <4 x float> %i.m, <4 x float> %i.q, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %10 = tail call reassoc nsz arcp contract afn <8 x float> @llvm.maxnum.v8f32(<8 x float> %9, <8 x float> zeroinitializer)
  %i.s = tail call reassoc nsz arcp contract afn <8 x float> @llvm.minnum.v8f32(<8 x float> %10, <8 x float> splat (float 1.000000e+00))
  %i.t = shufflevector <4 x float> %8, <4 x float> %wide.load, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %5 = tail call reassoc nsz arcp contract afn <8 x float> @llvm.maxnum.v8f32(<8 x float> %strided.vec43, <8 x float> zeroinitializer)
  %6 = tail call reassoc nsz arcp contract afn <8 x float> @llvm.minnum.v8f32(<8 x float> %5, <8 x float> splat (float 1.000000e+00)) ; 4 uses
  %7 = tail call reassoc nsz arcp contract afn <8 x float> @llvm.maxnum.v8f32(<8 x float> %strided.vec47, <8 x float> zeroinitializer)
  %8 = tail call reassoc nsz arcp contract afn <8 x float> @llvm.minnum.v8f32(<8 x float> %7, <8 x float> splat (float 1.000000e+00)) ; 2 uses
  %9 = fcmp reassoc nsz arcp contract afn ogt <8 x float> %6, splat (float 5.000000e-01)
  %10 = fmul reassoc nnan nsz arcp contract afn <8 x float> %6, splat (float 2.000000e+00) ; 2 uses
  %11 = fmul reassoc nsz arcp contract afn <8 x float> %10, %8
  %12 = fsub reassoc nnan nsz arcp contract afn <8 x float> splat (float 2.000000e+00), %10
  %13 = fsub reassoc nnan nsz arcp contract afn <8 x float> splat (float 1.000000e+00), %8
  %14 = fmul reassoc nsz arcp contract afn <8 x float> %12, %13
  %15 = fsub reassoc nsz arcp contract afn <8 x float> splat (float 1.000000e+00), %14
  %predphi49 = select reassoc nsz arcp contract afn <8 x i1> %9, <8 x float> %15, <8 x float> %11
  %16 = fsub reassoc nsz arcp contract afn <8 x float> %predphi49, %6
  %17 = fmul reassoc nsz arcp contract afn <8 x float> %i.g, %16
  %18 = fadd reassoc nsz arcp contract afn <8 x float> %17, %6
  %19 = tail call reassoc nsz arcp contract afn <8 x float> @llvm.maxnum.v8f32(<8 x float> %18, <8 x float> zeroinitializer)
  %20 = tail call reassoc nsz arcp contract afn <8 x float> @llvm.minnum.v8f32(<8 x float> %19, <8 x float> splat (float 1.000000e+00))
  %21 = shufflevector <8 x float> %i.g, <8 x float> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %22 = shufflevector <8 x float> %i.j, <8 x float> %i.q, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %23 = fcmp reassoc nsz arcp contract afn ogt <16 x float> %22, splat (float 5.000000e-01)
  %24 = shufflevector <8 x float> %i.n, <8 x float> %i.t, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %25 = fsub reassoc nnan nsz arcp contract afn <16 x float> splat (float 2.000000e+00), %24
  %26 = shufflevector <8 x float> %i.m, <8 x float> %i.s, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %27 = fsub reassoc nnan nsz arcp contract afn <16 x float> splat (float 1.000000e+00), %26
  %28 = fmul reassoc nsz arcp contract afn <16 x float> %25, %27
  %29 = fsub reassoc nsz arcp contract afn <16 x float> splat (float 1.000000e+00), %28
  %30 = shufflevector <8 x float> %i.n, <8 x float> %i.t, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %31 = shufflevector <8 x float> %i.m, <8 x float> %i.s, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %32 = fmul reassoc nsz arcp contract afn <16 x float> %30, %31
  %33 = select reassoc nsz arcp contract afn <16 x i1> %23, <16 x float> %29, <16 x float> %32
  %34 = shufflevector <8 x float> %i.j, <8 x float> %i.q, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %35 = fsub reassoc nsz arcp contract afn <16 x float> %33, %34
  %36 = fmul reassoc nsz arcp contract afn <16 x float> %21, %35
  %37 = shufflevector <8 x float> %i.j, <8 x float> %i.q, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %38 = fadd reassoc nsz arcp contract afn <16 x float> %36, %37
  %39 = tail call reassoc nsz arcp contract afn <16 x float> @llvm.maxnum.v16f32(<16 x float> %38, <16 x float> zeroinitializer)
  %i.u = tail call reassoc nsz arcp contract afn <16 x float> @llvm.minnum.v16f32(<16 x float> %39, <16 x float> splat (float 1.000000e+00))
  %i.v = shufflevector <8 x float> %20, <8 x float> %wide.load, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %5 = tail call reassoc nsz arcp contract afn <8 x float> @llvm.maxnum.v8f32(<8 x float> %strided.vec48, <8 x float> zeroinitializer)
  %6 = tail call reassoc nsz arcp contract afn <8 x float> @llvm.minnum.v8f32(<8 x float> %5, <8 x float> splat (float 1.000000e+00)) ; 4 uses
  %7 = tail call reassoc nsz arcp contract afn <8 x float> @llvm.maxnum.v8f32(<8 x float> %strided.vec52, <8 x float> zeroinitializer)
  %8 = tail call reassoc nsz arcp contract afn <8 x float> @llvm.minnum.v8f32(<8 x float> %7, <8 x float> splat (float 1.000000e+00)) ; 3 uses
  %9 = fcmp reassoc nsz arcp contract afn ogt <8 x float> %8, splat (float 5.000000e-01)
  %10 = fadd reassoc nnan nsz arcp contract afn <8 x float> %8, splat (float 5.000000e-01)
  %11 = fmul reassoc nsz arcp contract afn <8 x float> %10, %6
  %12 = fsub reassoc nnan nsz arcp contract afn <8 x float> splat (float 1.000000e+00), %6
  %13 = fsub reassoc nnan nsz arcp contract afn <8 x float> splat (float 1.500000e+00), %8
  %14 = fmul reassoc nsz arcp contract afn <8 x float> %13, %12
  %15 = fsub reassoc nsz arcp contract afn <8 x float> splat (float 1.000000e+00), %14
  %predphi54 = select reassoc nsz arcp contract afn <8 x i1> %9, <8 x float> %15, <8 x float> %11
  %16 = fsub reassoc nsz arcp contract afn <8 x float> %predphi54, %6
  %17 = fmul reassoc nsz arcp contract afn <8 x float> %i.i, %16
  %18 = fadd reassoc nsz arcp contract afn <8 x float> %17, %6
  %19 = tail call reassoc nsz arcp contract afn <8 x float> @llvm.maxnum.v8f32(<8 x float> %18, <8 x float> zeroinitializer)
  %20 = tail call reassoc nsz arcp contract afn <8 x float> @llvm.minnum.v8f32(<8 x float> %19, <8 x float> splat (float 1.000000e+00))
  %21 = shufflevector <8 x float> %i.i, <8 x float> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %22 = shufflevector <8 x float> %i.o, <8 x float> %i.t, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %23 = fcmp reassoc nsz arcp contract afn ogt <16 x float> %22, splat (float 5.000000e-01)
  %24 = shufflevector <8 x float> %i.o, <8 x float> %i.t, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %25 = fsub reassoc nnan nsz arcp contract afn <16 x float> splat (float 1.500000e+00), %24
  %26 = shufflevector <8 x float> %i.l, <8 x float> %i.r, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %27 = fsub reassoc nnan nsz arcp contract afn <16 x float> splat (float 1.000000e+00), %26
  %28 = fmul reassoc nsz arcp contract afn <16 x float> %25, %27
  %29 = fsub reassoc nsz arcp contract afn <16 x float> splat (float 1.000000e+00), %28
  %30 = shufflevector <8 x float> %i.o, <8 x float> %i.t, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %31 = fadd reassoc nnan nsz arcp contract afn <16 x float> %30, splat (float 5.000000e-01)
  %32 = shufflevector <8 x float> %i.l, <8 x float> %i.r, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %33 = fmul reassoc nsz arcp contract afn <16 x float> %31, %32
  %34 = select reassoc nsz arcp contract afn <16 x i1> %23, <16 x float> %29, <16 x float> %33
  %35 = shufflevector <8 x float> %i.l, <8 x float> %i.r, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %36 = fsub reassoc nsz arcp contract afn <16 x float> %34, %35
  %37 = fmul reassoc nsz arcp contract afn <16 x float> %21, %36
  %38 = shufflevector <8 x float> %i.l, <8 x float> %i.r, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %39 = fadd reassoc nsz arcp contract afn <16 x float> %37, %38
  %40 = tail call reassoc nsz arcp contract afn <16 x float> @llvm.maxnum.v16f32(<16 x float> %39, <16 x float> zeroinitializer)
  %i.u = tail call reassoc nsz arcp contract afn <16 x float> @llvm.minnum.v16f32(<16 x float> %40, <16 x float> splat (float 1.000000e+00))
  %i.v = shufflevector <8 x float> %20, <8 x float> %wide.load, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %interleaved.vec = shufflevector <16 x float> %i.u, <16 x float> %i.v, <32 x i32> <i32 0, i32 8, i32 16, i32 24, i32 1, i32 9, i32 17, i32 25, i32 2, i32 10, i32 18, i32 26, i32 3, i32 11, i32 19, i32 27, i32 4, i32 12, i32 20, i32 28, i32 5, i32 13, i32 21, i32 29, i32 6, i32 14, i32 22, i32 30, i32 7, i32 15, i32 23, i32 31>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %5 = tail call reassoc nsz arcp contract afn <8 x float> @llvm.maxnum.v8f32(<8 x float> %strided.vec48, <8 x float> zeroinitializer)
  %6 = tail call reassoc nsz arcp contract afn <8 x float> @llvm.minnum.v8f32(<8 x float> %5, <8 x float> splat (float 1.000000e+00)) ; 3 uses
  %7 = tail call reassoc nsz arcp contract afn <8 x float> @llvm.maxnum.v8f32(<8 x float> %strided.vec52, <8 x float> zeroinitializer)
  %8 = tail call reassoc nsz arcp contract afn <8 x float> @llvm.minnum.v8f32(<8 x float> %7, <8 x float> splat (float 1.000000e+00)) ; 3 uses
  %9 = fcmp reassoc nsz arcp contract afn ogt <8 x float> %8, splat (float 5.000000e-01)
  %10 = fmul reassoc nnan nsz arcp contract afn <8 x float> %6, splat (float 2.000000e+00) ; 2 uses
  ...
  %20 = tail call reassoc nsz arcp contract afn <8 x float> @llvm.minnum.v8f32(<8 x float> %19, <8 x float> splat (float 1.000000e+00))
  %21 = shufflevector <8 x float> %i.i, <8 x float> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %22 = shufflevector <8 x float> %i.o, <8 x float> %i.u, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %23 = fcmp reassoc nsz arcp contract afn ogt <16 x float> %22, splat (float 5.000000e-01)
  %24 = shufflevector <8 x float> %i.p, <8 x float> %i.v, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %25 = fsub reassoc nnan nsz arcp contract afn <16 x float> splat (float 2.000000e+00), %24
  %26 = shufflevector <8 x float> %i.o, <8 x float> %i.u, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %27 = fsub reassoc nnan nsz arcp contract afn <16 x float> splat (float 1.000000e+00), %26
  %28 = fmul reassoc nsz arcp contract afn <16 x float> %25, %27
  %29 = fsub reassoc nsz arcp contract afn <16 x float> splat (float 1.000000e+00), %28
  %30 = shufflevector <8 x float> %i.p, <8 x float> %i.v, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %31 = shufflevector <8 x float> %i.o, <8 x float> %i.u, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %32 = fmul reassoc nsz arcp contract afn <16 x float> %30, %31
  %33 = select reassoc nsz arcp contract afn <16 x i1> %23, <16 x float> %29, <16 x float> %32
  %34 = shufflevector <8 x float> %i.l, <8 x float> %i.s, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %35 = fsub reassoc nsz arcp contract afn <16 x float> %33, %34
  %36 = fmul reassoc nsz arcp contract afn <16 x float> %21, %35
  %37 = shufflevector <8 x float> %i.l, <8 x float> %i.s, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %38 = fadd reassoc nsz arcp contract afn <16 x float> %36, %37
  %39 = tail call reassoc nsz arcp contract afn <16 x float> @llvm.maxnum.v16f32(<16 x float> %38, <16 x float> zeroinitializer)
  %i.w = tail call reassoc nsz arcp contract afn <16 x float> @llvm.minnum.v16f32(<16 x float> %39, <16 x float> splat (float 1.000000e+00))
  %i.x = shufflevector <8 x float> %20, <8 x float> %wide.load, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %8 = tail call reassoc nsz arcp contract afn <8 x float> @llvm.minnum.v8f32(<8 x float> %7, <8 x float> splat (float 1.000000e+00)) ; 2 uses
  %9 = fcmp reassoc nsz arcp contract afn ogt <8 x float> %8, splat (float 5.000000e-01)
  %10 = fmul reassoc nnan nsz arcp contract afn <8 x float> %8, splat (float 2.000000e+00) ; 2 uses
  %11 = fadd reassoc nnan nsz arcp contract afn <8 x float> %10, splat (float -1.000000e+00)
  %12 = tail call reassoc nnan nsz arcp contract afn <8 x float> @llvm.maxnum.v8f32(<8 x float> %6, <8 x float> %11)
  %13 = tail call reassoc nnan nsz arcp contract afn <8 x float> @llvm.minnum.v8f32(<8 x float> %6, <8 x float> %10)
  %14 = select reassoc nsz arcp contract afn <8 x i1> %9, <8 x float> %12, <8 x float> %13
  %15 = fsub reassoc nnan nsz arcp contract afn <8 x float> %14, %6
  %16 = fmul reassoc nsz arcp contract afn <8 x float> %i.i, %15
  %17 = fadd reassoc nsz arcp contract afn <8 x float> %16, %6
  %18 = tail call reassoc nsz arcp contract afn <8 x float> @llvm.maxnum.v8f32(<8 x float> %17, <8 x float> zeroinitializer)
  %19 = tail call reassoc nsz arcp contract afn <8 x float> @llvm.minnum.v8f32(<8 x float> %18, <8 x float> splat (float 1.000000e+00))
  %20 = shufflevector <8 x float> %i.i, <8 x float> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %21 = shufflevector <8 x float> %i.o, <8 x float> %i.u, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %22 = fcmp reassoc nsz arcp contract afn ogt <16 x float> %21, splat (float 5.000000e-01)
  %23 = shufflevector <8 x float> %i.l, <8 x float> %i.s, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %24 = shufflevector <8 x float> %i.p, <8 x float> %i.v, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %25 = fadd reassoc nnan nsz arcp contract afn <16 x float> %24, splat (float -1.000000e+00)
  %26 = tail call reassoc nnan nsz arcp contract afn <16 x float> @llvm.maxnum.v16f32(<16 x float> %23, <16 x float> %25)
  %27 = shufflevector <8 x float> %i.l, <8 x float> %i.s, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %28 = shufflevector <8 x float> %i.p, <8 x float> %i.v, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %29 = tail call reassoc nnan nsz arcp contract afn <16 x float> @llvm.minnum.v16f32(<16 x float> %27, <16 x float> %28)
  %30 = select reassoc nsz arcp contract afn <16 x i1> %22, <16 x float> %26, <16 x float> %29
  %31 = shufflevector <8 x float> %i.l, <8 x float> %i.s, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %32 = fsub reassoc nnan nsz arcp contract afn <16 x float> %30, %31
  %33 = fmul reassoc nsz arcp contract afn <16 x float> %20, %32
  %34 = shufflevector <8 x float> %i.l, <8 x float> %i.s, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %35 = fadd reassoc nsz arcp contract afn <16 x float> %33, %34
  %36 = tail call reassoc nsz arcp contract afn <16 x float> @llvm.maxnum.v16f32(<16 x float> %35, <16 x float> zeroinitializer)
  %i.w = tail call reassoc nsz arcp contract afn <16 x float> @llvm.minnum.v16f32(<16 x float> %36, <16 x float> splat (float 1.000000e+00))
  %i.x = shufflevector <8 x float> %19, <8 x float> %wide.load, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %interleaved.vec = shufflevector <16 x float> %i.w, <16 x float> %i.x, <32 x i32> <i32 0, i32 8, i32 16, i32 24, i32 1, i32 9, i32 17, i32 25, i32 2, i32 10, i32 18, i32 26, i32 3, i32 11, i32 19, i32 27, i32 4, i32 12, i32 20, i32 28, i32 5, i32 13, i32 21, i32 29, i32 6, i32 14, i32 22, i32 30, i32 7, i32 15, i32 23, i32 31>
