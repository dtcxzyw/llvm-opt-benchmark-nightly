...
bb.b:                                             ; preds = %bb.a
  ...
  %6 = fmul reassoc nsz arcp contract afn <2 x float> %i.s, splat (float f0x3C23D70A)
  %i.t = tail call reassoc nsz arcp contract afn <2 x float> @llvm.maxnum.v2f32(<2 x float> %6, <2 x float> splat (float -1.000000e+00))
  %i.u = tail call reassoc nnan nsz arcp contract afn <2 x float> @llvm.minnum.v2f32(<2 x float> %i.t, <2 x float> splat (float 1.000000e+00))
  %i.v = fmul reassoc nnan nsz arcp contract afn <2 x float> %i.u, splat (float 2.000000e+00) ; 4 uses
  ...
  %7 = fmul reassoc nsz arcp contract afn <4 x float> %i.ac, <float 1.000000e+00, float f0x3C23D70A, float f0x3C23D70A, float f0x3C23D70A>
  %i.ad = tail call reassoc nsz arcp contract afn <4 x float> @llvm.maxnum.v4f32(<4 x float> %7, <4 x float> <float 1.000000e-01, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00>) ; 3 uses
  ...
  %i.ai = tail call reassoc nsz arcp contract afn float @llvm.minnum.f32(float %i.ah, float 9.900000e-01) ; 2 uses
  %i.aj = shufflevector <4 x float> %i.ad, <4 x float> poison, <2 x i32> <i32 2, i32 3>
  %i.ak = tail call reassoc nnan nsz arcp contract afn <2 x float> @llvm.minnum.v2f32(<2 x float> %i.aj, <2 x float> splat (float 1.000000e+00))
  %i.al = fpext nnan ninf <2 x float> %i.ak to <2 x double>
...
.lr.ph276:                                        ; preds = %bb.h
  %i.br = fmul reassoc nsz arcp contract afn <2 x float> %i.v, %i.v ; 3 uses
  %i.bs = fsub reassoc nsz arcp contract afn float 1.000000e+00, %i.ai ; 2 uses
  %i.bt = and i32 %i.aw, 8
...
._crit_edge:                                      ; preds = %bb.ae, %bb.l
  ...
  %i.gb = fsub reassoc nsz arcp contract afn float %i.dn, %i.ai
