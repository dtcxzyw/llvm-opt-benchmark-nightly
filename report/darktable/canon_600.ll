...
.preheader.preheader:                             ; preds = %bb.a
  ...
  %.019 = zext i1 %or.cond24 to i64               ; 2 uses
  %i.x = fcmp reassoc nsz arcp contract afn ugt float %i.u, 2.000000e+00
  %spec.select = select i1 %i.x, i64 %.019, i64 4
  %.019.mux = select i1 %i.w, i64 3, i64 %spec.select
  %.1 = select i1 %or.cond.not29, i64 %.019, i64 %.019.mux
...
.preheader.preheader.i:                           ; preds = %._crit_edge21
  ...
  %.019.i = zext i1 %or.cond24.i to i64           ; 2 uses
  %i.by = fcmp reassoc nsz arcp contract afn ugt float %i.bv, 2.000000e+00
  %spec.select.i = select i1 %i.by, i64 %.019.i, i64 4
  %.019.mux.i = select i1 %i.bx, i64 3, i64 %spec.select.i
  %.1.i = select i1 %or.cond.not29.i, i64 %.019.i, i64 %.019.mux.i
  %i.bz = select i1 %i.bo, i64 5, i64 %.1.i
