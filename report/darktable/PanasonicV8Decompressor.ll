...
._crit_edge.i:                                    ; preds = %bb.v, %_ZNK8rawspeed12iRectangle2D12isThisInsideERKS0_.exit.i
  ...
  %i.br = add nuw nsw i32 %.sroa.041.sroa.0.0.lcssa.i, %.sroa.11.8.extract.trunc51.pre-phi.i
...
_ZNK8rawspeed12iRectangle2D12isThisInsideERKS0_.exit20.i: ; preds = %bb.v, %_ZNK8rawspeed12iRectangle2D12isThisInsideERKS0_.exit20.lr.ph.i
  ...
  %.sroa.023.0.copyload.i = load i64, ptr %i.bw, align 4 ; 2 uses
  ...
  %.sroa.013.0.extract.trunc.i11.i = trunc i64 %.sroa.023.0.copyload.i to i32 ; 6 uses
  ...
  %.not.i.i18.i = icmp sgt i32 %.sroa.013.0.extract.trunc.i11.i, -1
  tail call void @llvm.assume(i1 %.not.i.i18.i)
  ...
  %.sroa.017.0.extract.trunc.i.i = add nuw i32 %.sroa.041.sroa.0.0117.i, %i.cc
