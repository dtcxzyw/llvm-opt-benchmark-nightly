...
bb.ab:                                            ; preds = %._crit_edge579
  ...
  br i1 %.not514, label %bb.aw, label %bb.ac
...
bb.af:                                            ; preds = %bb.ae, %bb.ad
  ...
  br i1 %i.ln, label %bb.ak, label %bb.ag
...
bb.ag:                                            ; preds = %bb.af
  ...
  br i1 %i.lr, label %bb.ak, label %bb.ah
...
bb.ak:                                            ; preds = %bb.aj, %bb.ag, %bb.af
  %i.nc = phi float [ %.pre581, %bb.aj ], [ %i.lm, %bb.ag ], [ %i.lm, %bb.af ] ; 2 uses
  %.1 = phi nsz double [ %.0, %bb.aj ], [ %i.lk, %bb.ag ], [ %i.lk, %bb.af ] ; 3 uses
  %i.nd = fcmp reassoc nsz arcp contract afn ult float %i.kd, %i.nc
  br i1 %i.nd, label %bb.an, label %bb.al
...
bb.al:                                            ; preds = %bb.ak
  ...
  br i1 %i.nh, label %bb.an, label %bb.am
...
bb.an:                                            ; preds = %bb.am, %bb.al, %bb.ak
  ...
  br i1 %i.pm, label %bb.as, label %bb.ao
...
bb.ao:                                            ; preds = %bb.an
  ...
  br i1 %i.pq, label %bb.as, label %bb.ap
...
bb.ar:                                            ; preds = %._crit_edge584, %bb.aq
  ...
  %i.qv = fadd reassoc nsz arcp contract afn double %.pre-phi587, %i.qu
...
bb.as:                                            ; preds = %bb.ar, %bb.ao, %bb.an
  %i.rj = phi float [ %.pre582, %bb.ar ], [ %i.pl, %bb.ao ], [ %i.pl, %bb.an ] ; 2 uses
  %.3480 = phi nsz double [ %.2479, %bb.ar ], [ %i.pj, %bb.ao ], [ %i.pj, %bb.an ] ; 2 uses
  %i.rk = fcmp reassoc nsz arcp contract afn ult float %i.kf, %i.rj
  br i1 %i.rk, label %bb.av, label %bb.at
