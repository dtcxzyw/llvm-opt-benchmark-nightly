...
bb.ah:                                            ; preds = %bb.ag
  ...
  br i1 %i.mg, label %bb.ai, label %._crit_edge583.a
...
bb.ai:                                            ; preds = %bb.ah
  ...
  %i.ml = fadd reassoc nsz arcp contract afn double %i.mk, %i.lk
  %i.mm = fadd reassoc nsz arcp contract afn double %i.ml, %i.mb ; 2 uses
...
._crit_edge583.a:                                 ; preds = %bb.ah, %bb.ai
...
bb.ap:                                            ; preds = %bb.ao
  ...
  %i.qi = fadd reassoc nsz arcp contract afn double %i.qh, %i.pj
  %i.qj = fadd reassoc nsz arcp contract afn double %i.qi, %i.pz ; 2 uses
