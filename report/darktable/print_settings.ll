...
bb.ai:                                            ; preds = %bb.ah
  ...
  %i.mm = fadd reassoc nsz arcp contract afn double %i.lk, %i.mb
  %i.mn = fadd reassoc nsz arcp contract afn double %i.mm, %i.ml ; 2 uses
...
bb.ap:                                            ; preds = %bb.ao
  ...
  %i.qk = fadd reassoc nsz arcp contract afn double %i.pl, %i.qb
  %i.ql = fadd reassoc nsz arcp contract afn double %i.qk, %i.qj ; 2 uses
