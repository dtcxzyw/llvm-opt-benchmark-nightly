...
end_hunk_0
begin_hunk_1_@alloc_line_to:bb.a
bb.a:
  br label %bb.b
...
bb.h:                                             ; preds = %bb.f, %bb.e, %bb.d, %bb.c, %bb.b
  ...
  %i.w = getelementptr inbounds nuw i8, ptr %.lcssa, i64 36
  store <2 x float> %0, ptr %i.w, align 4
  %i.x = shufflevector <2 x float> %0, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  store <4 x float> %i.x, ptr %i.u, align 4
  %i.y = getelementptr inbounds nuw i8, ptr %.lcssa, i64 44
  store <2 x float> <float 5.000000e-01, float 7.500000e-01>, ptr %i.y, align 4, !tbaa !13
...
bb.h:                                             ; preds = %bb.f, %bb.e, %bb.d, %bb.c, %bb.b
  ...
  %i.x = getelementptr inbounds nuw i8, ptr %.lcssa, i64 36
  store <2 x float> %0, ptr %i.x, align 4
  %i.y = shufflevector <2 x float> %0, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  store <4 x float> %i.y, ptr %i.v, align 4
  %i.z = getelementptr inbounds nuw i8, ptr %.lcssa, i64 44
  store <2 x float> <float 5.000000e-01, float 7.500000e-01>, ptr %i.z, align 4, !tbaa !13
  %i.aa = getelementptr inbounds nuw i8, ptr %.lcssa, i64 56
  store i32 0, ptr %i.aa, align 4, !tbaa !91
  br label %node_alloc.exit.thread

node_alloc.exit.thread:                           ; preds = %bb.g, %bb.h
  %i.ab = phi ptr [ %.lcssa, %bb.h ], [ null, %bb.g ]
  ret ptr %i.ab
}
