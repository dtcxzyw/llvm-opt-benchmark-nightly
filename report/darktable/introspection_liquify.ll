...
bb.n:                                             ; preds = %bb.n, %bb.m
  ...
  %6 = fmul reassoc nsz arcp contract afn float %5, %i.bu
  %7 = fmul reassoc nnan nsz arcp contract afn float %i.bu, 3.000000e+00 ; 2 uses
  %8 = fmul reassoc nsz arcp contract afn float %i.bu, %i.bt
  %9 = fmul reassoc nsz arcp contract afn float %8, %7
  %10 = fmul reassoc nsz arcp contract afn float %i.bt, %i.bt ; 2 uses
  %11 = fmul reassoc nsz arcp contract afn float %7, %10
  %12 = fmul reassoc nsz arcp contract afn float %10, %i.bt
