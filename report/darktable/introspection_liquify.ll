...
bb.d:                                             ; preds = %bb.c
  %.val24 = load i32, ptr %i.b, align 4, !tbaa !84
...
bb.a:
  ...
  store i32 -999, ptr %i.a, align 4, !tbaa !228
  ret void
}
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %bb.a
  ...
  %i.c = load ptr, ptr getelementptr inbounds nuw (i8, ptr @darktable, i64 104), align 8, !tbaa !126
  %i.d = getelementptr inbounds nuw i8, ptr %i.c, i64 1432
  %i.e = load double, ptr %i.d, align 8, !tbaa !132
...
bb.b:                                             ; preds = %.lr.ph, %.loopexit
  ...
  %i.h = load ptr, ptr %.0228330, align 8, !tbaa !74
...
bb.c:                                             ; preds = %.preheader, %.thread
  ...
  %.val = load i8, ptr %i.v, align 4, !tbaa !139  ; 2 uses
  ...
  %i.z = load i32, ptr %i.u, align 4, !tbaa !140  ; 4 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.ac = load i32, ptr %i.ab, align 4, !tbaa !141
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.ae = load i32, ptr %i.ad, align 4, !tbaa !141
...
bb.n:                                             ; preds = %bb.n, %bb.m
  ...
  %i.br = uitofp nsz nneg i32 %.073.i to double
  %i.bs = fmul reassoc nnan nsz arcp contract afn double %i.br, 1.000000e-02
  %i.bt = fptrunc reassoc nsz arcp contract afn double %i.bs to float ; 6 uses
  %i.bu = fsub reassoc nsz arcp contract afn float 1.000000e+00, %i.bt ; 5 uses
  %5 = fmul reassoc nsz arcp contract afn float %i.bu, %i.bu
  %6 = fmul reassoc nsz arcp contract afn float %i.bu, %i.bt
  %7 = fmul reassoc nnan nsz arcp contract afn float %i.bu, 3.000000e+00 ; 2 uses
  %8 = fmul reassoc nsz arcp contract afn float %i.bt, %i.bt ; 2 uses
  %9 = fmul reassoc nsz arcp contract afn float %5, %i.bu
  %10 = fmul reassoc nsz arcp contract afn float %6, %7
  %11 = fmul reassoc nsz arcp contract afn float %7, %8
  %12 = fmul reassoc nsz arcp contract afn float %8, %i.bt
  %13 = insertelement <2 x float> poison, float %12, i64 0
  %i.bv = shufflevector <2 x float> %13, <2 x float> poison, <2 x i32> zeroinitializer
...
bb.t:                                             ; preds = %bb.i
  ...
  %i.ef = load float, ptr %i.ee, align 4, !tbaa !80
...
bb.u:                                             ; preds = %bb.i
  ...
  %i.er = load double, ptr %i.t, align 8, !tbaa !132
...
bb.y:                                             ; preds = %bb.x
  ...
  %i.fk = load i32, ptr %i.fj, align 4, !tbaa !145
...
bb.aa:                                            ; preds = %bb.w
  ...
  %i.ft = load i32, ptr %i.fs, align 4, !tbaa !145
...
.loopexit:                                        ; preds = %bb.c, %.thread, %bb.b
  ...
  %i.gb = load ptr, ptr %i.ga, align 8, !tbaa !75 ; 2 uses
