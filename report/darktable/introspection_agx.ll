...
dt_RGB_2_HSV.exit.i:                              ; preds = %_dt_RGB_2_Hue.exit.i.i, %bb.af, %bb.ae
  ...
  %7 = call reassoc nsz arcp contract afn float @llvm.maxnum.f32(float %i.ps, float 1.800000e-07)
  %8 = fmul reassoc nnan nsz arcp contract afn float %7, f0x40B1C71C
...
_apply_curve.exit.i:                              ; preds = %bb.av, %_fallback_toe.exit.i.i
  ...
  %9 = call reassoc nsz arcp contract afn float @llvm.maxnum.f32(float %i.px, float 1.800000e-07)
  %10 = fmul reassoc nnan nsz arcp contract afn float %9, f0x40B1C71C
...
_apply_curve.exit.1.i:                            ; preds = %bb.bg, %_fallback_toe.exit.i.1.i
  ...
  %11 = call reassoc nsz arcp contract afn float @llvm.maxnum.f32(float %i.qc, float 1.800000e-07)
  %12 = fmul reassoc nnan nsz arcp contract afn float %11, f0x40B1C71C
