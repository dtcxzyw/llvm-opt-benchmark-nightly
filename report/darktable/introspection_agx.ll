...
bb.ae:                                            ; preds = %bb.ac, %bb.ad
  ...
  %reass.mul.i = fmul reassoc nsz arcp contract afn float %.sroa.18.0, f0x3E0AF81D
  %10 = fadd reassoc nsz arcp contract afn float %9, %reass.mul.i
  ...
  %reass.mul58.i = fmul reassoc nsz arcp contract afn float %i.oi, f0xBE88194D
  %.neg52.i = fmul reassoc nsz arcp contract afn float %i.oj, f0xBF193552
  %reass.mul61.i = fmul reassoc nsz arcp contract afn float %i.ok, f0xBE0AF81D
  %.neg53.i = fadd reassoc nsz arcp contract afn float %10, %reass.mul58.i
  %i.ox = fadd reassoc nsz arcp contract afn float %.neg52.i, %.neg53.i
  %i.oy = fadd reassoc nsz arcp contract afn float %reass.mul61.i, %i.ox
  ...
  %reass.mul68.i = fmul reassoc nsz arcp contract afn float %i.or, f0x3E0AF81D
  %16 = fadd reassoc nsz arcp contract afn float %reass.mul68.i, %15
  %reass.mul71.i = fmul reassoc nsz arcp contract afn float %i.ou, f0xBE88194D
  %.neg57.i = fmul reassoc nsz arcp contract afn float %i.ov, f0xBF193552
  %reass.mul74.i = fmul reassoc nsz arcp contract afn float %i.ow, f0xBE0AF81D
  %.neg58.i = fadd reassoc nsz arcp contract afn float %16, %reass.mul71.i
  %i.pc = fadd reassoc nsz arcp contract afn float %.neg57.i, %.neg58.i
  %i.pd = fadd reassoc nsz arcp contract afn float %reass.mul74.i, %i.pc
...
bb.a:
  ...
  %.neg371 = fadd reassoc nsz arcp contract afn float %.neg369, %i.bh
...
bb.e:                                             ; preds = %.lr.ph, %bb.g
  ...
  %.0275378 = phi i32 [ %i.fi, %.lr.ph ], [ %i.gt, %bb.g ] ; 3 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.gf = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) %i.a, i64 noundef 32, ptr noundef nonnull @.str.102, i32 noundef %.0275378) #22 ; 0 uses
  call void @pango_layout_set_text(ptr noundef %i.aj, ptr noundef nonnull %i.a, i32 noundef -1) #22
  call void @pango_layout_get_pixel_extents(ptr noundef %i.aj, ptr noundef nonnull %i.av, ptr noundef null) #22
...
bb.g:                                             ; preds = %bb.e, %bb.f
  %i.gt = add nsw i32 %.0275378, 1                ; 2 uses
