...
bb.ae:                                            ; preds = %bb.ac, %bb.ad
  ...
  %i.ox = fmul reassoc nsz arcp contract afn float %reass.add.i, f0x3E0AF81D
  %reass.add57.i = fsub reassoc nsz arcp contract afn float %.sroa.1176.0, %i.oj
  %.neg.i = fmul reassoc nsz arcp contract afn float %reass.add57.i, f0x3F193552
  %reass.add60.i = fsub reassoc nsz arcp contract afn float %.sroa.071.0, %i.oi
  %.neg54.i = fmul reassoc nsz arcp contract afn float %reass.add60.i, f0x3E88194D
  %.neg55.i = fadd reassoc nsz arcp contract afn float %8, %i.ox
  %i.oy = fadd reassoc nsz arcp contract afn float %.neg.i, %.neg54.i
  %i.oz = fadd reassoc nsz arcp contract afn float %i.oy, %.neg55.i ; 2 uses
  ...
  %i.pc = fmul reassoc nsz arcp contract afn float %reass.add67.i, f0x3E0AF81D
  %reass.add70.i = fsub reassoc nsz arcp contract afn float %i.oq, %i.ov
  %.neg56.i = fmul reassoc nsz arcp contract afn float %reass.add70.i, f0x3F193552
  %reass.add73.i = fsub reassoc nsz arcp contract afn float %i.op, %i.ou
  %.neg59.i = fmul reassoc nsz arcp contract afn float %reass.add73.i, f0x3E88194D
  %.neg60.i = fadd reassoc nsz arcp contract afn float %i.pb, %i.pc
  %i.pd = fadd reassoc nsz arcp contract afn float %.neg56.i, %.neg59.i
  %i.pe = fadd reassoc nsz arcp contract afn float %i.pd, %.neg60.i ; 3 uses
