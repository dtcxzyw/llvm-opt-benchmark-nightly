...
.split.loop.exit39:                               ; preds = %bb.b, %bb.a, %.split.loop.exit
  ...
  %i.as = fadd reassoc nsz arcp contract afn double %i.aj, %i.ar
...
.split.loop.exit48:                               ; preds = %bb.b, %bb.a, %.split.loop.exit
  ...
  %i.z = fsub reassoc nsz arcp contract afn double 1.000000e+00, %i.y
  %i.aa = fadd reassoc nsz arcp contract afn double %i.z, %i.w
  ...
  %reass.add = fadd reassoc nsz arcp contract afn float %i.am, %i.an
  %reass.mul = fmul reassoc nsz arcp contract afn float %reass.add, %i.q
  %8 = fadd reassoc nsz arcp contract afn float %7, %i.al
  %i.ao = fadd reassoc nsz arcp contract afn float %8, %reass.mul
  ret float %i.ao
}
