...
.split.loop.exit48:                               ; preds = %bb.b, %bb.a, %.split.loop.exit
  ...
  %reass.add = fadd reassoc nsz arcp contract afn float %i.an, %6
  %reass.mul = fmul reassoc nsz arcp contract afn float %i.q, %i.l
  %9 = fmul reassoc nsz arcp contract afn float %reass.mul, %i.ai
  %i.ao = fadd reassoc nsz arcp contract afn float %reass.add, %9
  ret float %i.ao
}
