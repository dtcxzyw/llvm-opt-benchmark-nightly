...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load6 = load <8 x float>, ptr %i.y, align 4, !tbaa !12 ; 5 uses
  ...
  %wide.load7 = load <8 x float>, ptr %i.ae, align 4, !tbaa !12
  ...
  tail call void @llvm.masked.scatter.v8f32.v8p0(<8 x float> %i.ao, <8 x ptr> align 4 %wide.gep9, <8 x i1> splat (i1 true)), !tbaa !12
  ...
  tail call void @llvm.masked.scatter.v8f32.v8p0(<8 x float> %i.at, <8 x ptr> align 4 %wide.gep11, <8 x i1> splat (i1 true)), !tbaa !12
