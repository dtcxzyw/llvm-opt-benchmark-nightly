...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vector.recur = phi <8 x float> [ %vector.recur.init, %vector.ph ], [ %wide.load6.a, %vector.body ]
  ...
  %wide.load = load <8 x float>, ptr %i.v, align 4, !tbaa !12 ; 4 uses
  ...
  %wide.load6.a = load <8 x float>, ptr %i.y, align 4, !tbaa !12 ; 5 uses
  %i.z = shufflevector <8 x float> %vector.recur, <8 x float> %wide.load6.a, <8 x i32> <i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14> ; 2 uses
  %i.aa = fsub reassoc nsz arcp contract afn <8 x float> %wide.load6.a, %i.z ; 2 uses
  ...
  %wide.load7.a = load <8 x float>, ptr %i.ae, align 4, !tbaa !12
  %i.af = fsub reassoc nsz arcp contract afn <8 x float> %i.w, %wide.load7.a
  %i.ag = getelementptr inbounds [4 x i8], ptr %1, i64 %i.ad
  %wide.load8 = load <8 x float>, ptr %i.ag, align 4, !tbaa !12 ; 2 uses
  ...
  store <8 x float> %i.aj, ptr %i.al, align 4, !tbaa !12
  ...
  %wide.gep9.a = getelementptr i8, <8 x ptr> %wide.gep, i64 8
  tail call void @llvm.masked.scatter.v8f32.v8p0(<8 x float> %i.ao, <8 x ptr> align 4 %wide.gep9.a, <8 x i1> splat (i1 true)), !tbaa !12
  %i.aq = fsub reassoc nsz arcp contract afn <8 x float> %wide.load6.a, %wide.load8
  ...
  %wide.gep10.a = getelementptr inbounds nuw i8, ptr %i.j, <8 x i64> %i.au
  %wide.gep11.a = getelementptr inbounds nuw i8, <8 x ptr> %wide.gep10.a, i64 4
  tail call void @llvm.masked.scatter.v8f32.v8p0(<8 x float> %i.at, <8 x ptr> align 4 %wide.gep11.a, <8 x i1> splat (i1 true)), !tbaa !12
  ...
  tail call void @llvm.masked.scatter.v8f32.v8p0(<8 x float> %i.ax, <8 x ptr> align 4 %wide.gep12, <8 x i1> splat (i1 true)), !tbaa !12
...
middle.block:                                     ; preds = %vector.body
  %vector.recur.extract = extractelement <8 x float> %wide.load6.a, i64 7
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  ...
  %i.bd = load float, ptr %i.bc, align 4, !tbaa !12 ; 2 uses
  ...
  %i.bg = load float, ptr %i.bf, align 4, !tbaa !12 ; 3 uses
  ...
  store float %i.bv, ptr %i.bx, align 4, !tbaa !12
  ...
  store float %i.cb, ptr %i.cd, align 4, !tbaa !12
...
._crit_edge.i:                                    ; preds = %.lr.ph.i, %middle.block, %._crit_edge
  ...
  store float 0.000000e+00, ptr %i.ck, align 4, !tbaa !12
  %i.cl = mul nuw nsw i32 %i.b, 3
  %i.cm = zext nneg i32 %i.cl to i64
  %i.cn = getelementptr inbounds nuw [4 x i8], ptr %i.j, i64 %i.cm
  %i.co = getelementptr inbounds nuw i8, ptr %i.cn, i64 4
  store float 1.000000e+00, ptr %i.co, align 4, !tbaa !12
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load58.a = load <8 x float>, ptr %i.x, align 4, !tbaa !12
  %i.y = getelementptr inbounds [4 x i8], ptr %2, i64 %index ; 2 uses
  %i.z = getelementptr inbounds nuw i8, ptr %i.y, i64 32
  %wide.load59.a = load <8 x float>, ptr %i.y, align 4, !tbaa !12
  %wide.load60.a = load <8 x float>, ptr %i.z, align 4, !tbaa !12
  %i.aa = fsub reassoc nsz arcp contract afn <8 x float> %wide.load, %wide.load59.a
  %i.ab = fsub reassoc nsz arcp contract afn <8 x float> %wide.load58.a, %wide.load60.a
  %i.ac = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.v ; 2 uses
  %i.ad = getelementptr inbounds nuw i8, ptr %i.ac, i64 32
  %wide.load61.a = load <8 x float>, ptr %i.ac, align 4, !tbaa !12
  ...
  %wide.load64.a = load <8 x float>, ptr %i.af, align 4, !tbaa !12
  %i.ag = fsub reassoc nsz arcp contract afn <8 x float> %wide.load61.a, %wide.load63
  %i.ah = fsub reassoc nsz arcp contract afn <8 x float> %wide.load62, %wide.load64.a
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load67.a = load <4 x float>, ptr %i.aq, align 4, !tbaa !12
  %i.ar = getelementptr inbounds [4 x i8], ptr %2, i64 %index66
  %wide.load68 = load <4 x float>, ptr %i.ar, align 4, !tbaa !12
  %i.as = fsub reassoc nsz arcp contract afn <4 x float> %wide.load67.a, %wide.load68
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.af = shufflevector <8 x float> %wide.load127.a, <8 x float> %wide.load128, <8 x i32> <i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14>
...
vector.body137:                                   ; preds = %vector.body137, %vector.ph135
  ...
  %i.bl = fadd reassoc nsz arcp contract afn <8 x float> %wide.load145, %wide.load141.a
