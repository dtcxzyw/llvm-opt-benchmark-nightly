...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %2 = shufflevector <8 x float> %i.eh, <8 x float> %i.ej, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %3 = fptosi <16 x float> %2 to <16 x i32>
  %4 = tail call <16 x i32> @llvm.smax.v16i32(<16 x i32> %3, <16 x i32> zeroinitializer)
  %i.ep = tail call <16 x i32> @llvm.umin.v16i32(<16 x i32> %4, <16 x i32> splat (i32 65535))
