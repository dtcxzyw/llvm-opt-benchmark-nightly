...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %broadcast.splatinsert114 = insertelement <8 x float> poison, float %i.ah, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.az = fadd reassoc nsz arcp contract afn <8 x float> %i.au, splat (float f0xC2F87377)
  %i.ba = fadd reassoc nsz arcp contract afn <8 x float> %i.az, %i.ax
  %6 = fsub reassoc nsz arcp contract afn <8 x float> %i.ay, %broadcast.splat115
  %i.bb = fadd reassoc nsz arcp contract afn <8 x float> %6, %i.ba
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %.neg7.i = fadd reassoc nsz arcp contract afn float %i.bs, f0xC2F87377
  %7 = fadd reassoc nsz arcp contract afn float %.neg7.i, %.neg.i
  %8 = load float, ptr %i.ac, align 4, !tbaa !50
  %9 = fsub reassoc nsz arcp contract afn float %.neg6.i, %8
  %i.bv = fadd reassoc nsz arcp contract afn float %9, %7
