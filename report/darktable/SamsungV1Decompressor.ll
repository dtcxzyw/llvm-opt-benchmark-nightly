...
iter.check:
  ...
  %broadcast.splat235 = shufflevector <8 x i16> %17, <8 x i16> poison, <8 x i32> zeroinitializer
  store <8 x i16> %broadcast.splat235, ptr %i.bj, align 1
  %i.bk = getelementptr inbounds nuw i8, ptr %i.a, i64 1938
  %broadcast.splat235.1 = shufflevector <8 x i16> %17, <8 x i16> poison, <8 x i32> zeroinitializer
  ...
  %broadcast.splat235.2 = shufflevector <8 x i16> %18, <8 x i16> poison, <8 x i32> zeroinitializer
  store <8 x i16> %broadcast.splat235.2, ptr %i.bl, align 1
  %i.bm = getelementptr inbounds nuw i8, ptr %i.a, i64 1970
  %broadcast.splat235.3 = shufflevector <8 x i16> %18, <8 x i16> poison, <8 x i32> zeroinitializer
  ...
  %broadcast.splat235.4 = shufflevector <8 x i16> %19, <8 x i16> poison, <8 x i32> zeroinitializer
  store <8 x i16> %broadcast.splat235.4, ptr %i.bn, align 1
  %i.bo = getelementptr inbounds nuw i8, ptr %i.a, i64 2002
  %broadcast.splat235.5 = shufflevector <8 x i16> %19, <8 x i16> poison, <8 x i32> zeroinitializer
  ...
  %broadcast.splat235.6 = shufflevector <8 x i16> %20, <8 x i16> poison, <8 x i32> zeroinitializer
