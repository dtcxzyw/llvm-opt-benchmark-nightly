...
bb.c:                                             ; preds = %bb.b
  %i.f = load i32, ptr %i.d, align 4, !tbaa !20
...
bb.e:                                             ; preds = %_ZN8rawspeed8RawImageD2Ev.exit
  ...
  %i.n = load i8, ptr %i.m, align 1, !tbaa !102
...
bb.m:                                             ; preds = %bb.j
  ...
  %i.s = load i32, ptr %i.r, align 8, !tbaa !104  ; 4 uses
  %i.t = getelementptr inbounds nuw i8, ptr %i.a, i64 44
  %i.u = load i32, ptr %i.t, align 4, !tbaa !105  ; 4 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  tail call void %i.j(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #17, !call_target !98, !inline_history !106
  %i.k = load ptr, ptr %i.b, align 8, !tbaa !93
  %i.l = getelementptr inbounds nuw i8, ptr %i.k, i64 24
  %i.m = load ptr, ptr %i.l, align 8
  tail call void %i.m(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #17, !call_target !100, !inline_history !106
  br label %_ZN8rawspeed8RawImageD2Ev.exit
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i: ; preds = %bb.f, %bb.e
  ...
  br i1 %i.q, label %bb.g, label %_ZN8rawspeed8RawImageD2Ev.exit, !prof !101
...
iter.check:
  ...
  %broadcast.splatinsert234 = insertelement <8 x i16> poison, i16 %17, i64 0
  %broadcast.splat235 = shufflevector <8 x i16> %broadcast.splatinsert234, <8 x i16> poison, <8 x i32> zeroinitializer
  store <8 x i16> %broadcast.splat235, ptr %i.bj, align 1
  %i.bk = getelementptr inbounds nuw i8, ptr %i.a, i64 1938
  %broadcast.splatinsert234.1 = insertelement <8 x i16> poison, i16 %17, i64 0
  %broadcast.splat235.1 = shufflevector <8 x i16> %broadcast.splatinsert234.1, <8 x i16> poison, <8 x i32> zeroinitializer
  store <8 x i16> %broadcast.splat235.1, ptr %i.bk, align 1
  %i.bl = getelementptr inbounds nuw i8, ptr %i.a, i64 1954
  %18 = load i16, ptr %i.a, align 1               ; 2 uses
  %broadcast.splatinsert234.2 = insertelement <8 x i16> poison, i16 %18, i64 0
  %broadcast.splat235.2 = shufflevector <8 x i16> %broadcast.splatinsert234.2, <8 x i16> poison, <8 x i32> zeroinitializer
  store <8 x i16> %broadcast.splat235.2, ptr %i.bl, align 1
  %i.bm = getelementptr inbounds nuw i8, ptr %i.a, i64 1970
  %broadcast.splatinsert234.3 = insertelement <8 x i16> poison, i16 %18, i64 0
  %broadcast.splat235.3 = shufflevector <8 x i16> %broadcast.splatinsert234.3, <8 x i16> poison, <8 x i32> zeroinitializer
  store <8 x i16> %broadcast.splat235.3, ptr %i.bm, align 1
  %i.bn = getelementptr inbounds nuw i8, ptr %i.a, i64 1986
  %19 = load i16, ptr %i.a, align 1               ; 2 uses
  %broadcast.splatinsert234.4 = insertelement <8 x i16> poison, i16 %19, i64 0
  %broadcast.splat235.4 = shufflevector <8 x i16> %broadcast.splatinsert234.4, <8 x i16> poison, <8 x i32> zeroinitializer
  store <8 x i16> %broadcast.splat235.4, ptr %i.bn, align 1
  %i.bo = getelementptr inbounds nuw i8, ptr %i.a, i64 2002
  %broadcast.splatinsert234.5 = insertelement <8 x i16> poison, i16 %19, i64 0
  %broadcast.splat235.5 = shufflevector <8 x i16> %broadcast.splatinsert234.5, <8 x i16> poison, <8 x i32> zeroinitializer
  store <8 x i16> %broadcast.splat235.5, ptr %i.bo, align 1
  %i.bp = getelementptr inbounds nuw i8, ptr %i.a, i64 2018
  %20 = load i16, ptr %i.a, align 1
  %broadcast.splatinsert234.6 = insertelement <8 x i16> poison, i16 %20, i64 0
  %broadcast.splat235.6 = shufflevector <8 x i16> %broadcast.splatinsert234.6, <8 x i16> poison, <8 x i32> zeroinitializer
  store <8 x i16> %broadcast.splat235.6, ptr %i.bp, align 1
  ...
  %i.ee = load ptr, ptr %0, align 8, !tbaa !17    ; 5 uses
  %i.ef = getelementptr inbounds nuw i8, ptr %i.ee, i64 568
  %i.eg = load ptr, ptr %i.ef, align 8, !tbaa !114, !noalias !115 ; 2 uses
  %i.eh = getelementptr inbounds nuw i8, ptr %i.ee, i64 592
  %i.ei = load i32, ptr %i.eh, align 8, !tbaa !91, !noalias !115
  %i.ej = getelementptr inbounds nuw i8, ptr %i.ee, i64 608
  %i.ek = load i32, ptr %i.ej, align 8, !tbaa !116, !noalias !115
  %i.el = mul nsw i32 %i.ek, %i.ei                ; 5 uses
  %i.em = getelementptr inbounds nuw i8, ptr %i.ee, i64 612
  %i.en = load i32, ptr %i.em, align 4, !tbaa !117, !noalias !115 ; 6 uses
  %i.eo = getelementptr inbounds nuw i8, ptr %i.ee, i64 48
  %i.ep = load i32, ptr %i.eo, align 8, !tbaa !118, !noalias !115
  ...
  %i.fc = load i32, ptr %i.fb, align 8, !tbaa !123 ; 3 uses
  %i.fd = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.fe = load i32, ptr %i.fd, align 8, !tbaa !124 ; 3 uses
  ...
  %i.fi = sub nuw nsw i32 %i.fe, %i.fc            ; 5 uses
  %i.fj = load ptr, ptr %i.fa, align 8, !tbaa !125
  %i.fk = getelementptr inbounds nuw i8, ptr %i.fj, i64 %i.fh ; 2 uses
  %i.fl = icmp samesign ult i32 %i.fi, 4
  br i1 %i.fl, label %bb.i, label %_ZN8rawspeed14BitStreamerMSBCI2NS_11BitStreamerIS0_NS_39BitStreamerForwardSequentialReplenisherIS0_EEEEENS_10Array1DRefIKSt4byteEE.exit.preheader
...
.lr.ph189:                                        ; preds = %_ZN8rawspeed14BitStreamerMSBCI2NS_11BitStreamerIS0_NS_39BitStreamerForwardSequentialReplenisherIS0_EEEEENS_10Array1DRefIKSt4byteEE.exit.preheader
  %i.fm = add nuw nsw i32 %i.fi, 8
  %i.fn = zext nneg i32 %i.en to i64
  br i1 %i.ev, label %_ZN8rawspeed14BitStreamerMSBCI2NS_11BitStreamerIS0_NS_39BitStreamerForwardSequentialReplenisherIS0_EEEEENS_10Array1DRefIKSt4byteEE.exit.peel217, label %.lr.ph189.split.us.preheader

.lr.ph189.split.us.preheader:                     ; preds = %.lr.ph189
  %i.fo = zext nneg i32 %i.eq to i64
end_hunk_0
