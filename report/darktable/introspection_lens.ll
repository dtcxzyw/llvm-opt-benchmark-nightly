...
bb.cr:                                            ; preds = %bb.cu, %.lr.ph.i71.i
  ...
  %i.ahj = fcmp reassoc nsz arcp contract afn uge <2 x float> %i.ahi, splat (float 1.000000e-07) ; 2 uses
  %5 = extractelement <2 x i1> %i.ahj, i64 0
  %6 = extractelement <2 x i1> %i.ahj, i64 1
  %7 = or i1 %5, %6
