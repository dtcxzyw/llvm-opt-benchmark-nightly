...
.loopexit.i57:                                    ; preds = %._crit_edge.split.i, %._crit_edge.split.us.us.i, %.preheader2.lr.ph.i, %.preheader3.i, %bb.bm, %bb.bl
  ...
  %i.aby = getelementptr inbounds nuw i8, ptr %4, i64 12 ; 4 uses
  %6 = load <2 x i32>, ptr %i.abx, align 4, !tbaa !24
  %7 = add nsw <2 x i32> %6, splat (i32 -1)
  %8 = sitofp <2 x i32> %7 to <2 x float>         ; 6 uses
...
.preheader.preheader.i59:                         ; preds = %.preheader.lr.ph.i58
  ...
  %9 = extractelement <2 x float> %8, i64 0       ; 4 uses
  %10 = extractelement <2 x float> %8, i64 1      ; 7 uses
  %11 = shufflevector <2 x float> %8, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 poison, i32 poison>
  %12 = shufflevector <4 x float> <float 0.000000e+00, float 0.000000e+00, float poison, float poison>, <4 x float> %11, <4 x i32> <i32 0, i32 1, i32 4, i32 5> ; 2 uses
...
_ZL26_interpolate_linear_splinePKfS0_if.exit151.i: ; preds = %._crit_edge.i143.i, %bb.bv, %bb.bs
  ...
  %i.aer = fadd reassoc nsz arcp contract afn <2 x float> %i.xt, %i.aeq
  %i.aes = load <2 x i32>, ptr %4, align 4, !tbaa !24
  %i.aet = sitofp <2 x i32> %i.aes to <2 x float>
  %i.aeu = fsub reassoc nsz arcp contract afn <2 x float> %i.aer, %i.aet ; 4 uses
  %i.aev = extractelement <2 x float> %i.aeu, i64 0
  %13 = fcmp ogt <2 x float> %i.aeu, %8
  ...
  %i.aey = select reassoc nsz arcp contract afn i1 %14, float %9, float %spec.select.i
  %i.aez = extractelement <2 x float> %i.aeu, i64 1 ; 2 uses
  %i.afa = fcmp reassoc nsz arcp contract afn ogt float %i.aez, %10
  ...
  %i.afc = select reassoc nsz arcp contract afn i1 %i.afa, float %10, float %spec.select141.i
...
_ZL26_interpolate_linear_splinePKfS0_if.exit151.1.i: ; preds = %bb.bz, %._crit_edge.i143.1.i, %bb.bx
  ...
  %i.agk = fadd reassoc nsz arcp contract afn <2 x float> %i.xt, %i.agj
  %i.agl = load <2 x i32>, ptr %4, align 4, !tbaa !24
  %i.agm = sitofp <2 x i32> %i.agl to <2 x float>
  %i.agn = fsub reassoc nsz arcp contract afn <2 x float> %i.agk, %i.agm ; 4 uses
  %i.ago = extractelement <2 x float> %i.agn, i64 0
  %15 = fcmp ogt <2 x float> %i.agn, %8
  ...
  %i.agr = select reassoc nsz arcp contract afn i1 %16, float %9, float %spec.select.1.i
  %i.ags = extractelement <2 x float> %i.agn, i64 1 ; 2 uses
  %i.agt = fcmp reassoc nsz arcp contract afn ogt float %i.ags, %10
  ...
  %i.agv = select reassoc nsz arcp contract afn i1 %i.agt, float %10, float %spec.select141.1.i
...
_ZL26_interpolate_linear_splinePKfS0_if.exit151.2.i: ; preds = %bb.cd, %._crit_edge.i143.2.i, %bb.cb
  ...
  %i.aid = fadd reassoc nsz arcp contract afn <2 x float> %i.xt, %i.aic
  ...
  %17 = shufflevector <2 x float> %i.aig, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 1, i32 0> ; 2 uses
  %18 = fcmp reassoc nsz arcp contract afn olt <4 x float> %17, %12 ; 2 uses
  %19 = fcmp reassoc nsz arcp contract afn ogt <4 x float> %17, %12 ; 2 uses
  %i.aih = extractelement <4 x i1> %18, i64 1
  %20 = extractelement <2 x float> %i.aig, i64 0
  %spec.select.2.i.a = select reassoc nsz arcp contract afn i1 %i.aih, float 0.000000e+00, float %20
  %21 = extractelement <4 x i1> %19, i64 3
  %22 = select reassoc nsz arcp contract afn i1 %21, float %9, float %spec.select.2.i.a
  %i.aii = extractelement <4 x i1> %18, i64 0
  %23 = extractelement <2 x float> %i.aig, i64 1
  %spec.select141.2.i = select reassoc nsz arcp contract afn i1 %i.aii, float 0.000000e+00, float %23
  %24 = extractelement <4 x i1> %19, i64 2
  %i.aij = select reassoc nsz arcp contract afn i1 %24, float %10, float %spec.select141.2.i
  %i.aik = load i32, ptr %i.abx, align 4, !tbaa !106 ; 2 uses
  %i.ail = load i32, ptr %i.aby, align 4, !tbaa !107
  %i.aim = shl nsw i32 %i.aik, 2
  %i.ain = tail call reassoc nsz arcp contract afn float @dt_interpolation_compute_sample(ptr noundef %i.xy, ptr noundef nonnull %i.acn, float noundef %22, float noundef %i.aij, i32 noundef %i.aik, i32 noundef %i.ail, i32 noundef 4, i32 noundef %i.aim)
...
_ZL26_interpolate_linear_splinePKfS0_if.exit151.3.i: ; preds = %bb.ch, %._crit_edge.i143.3.i, %bb.cf
  ...
  %i.ajr = fadd reassoc nsz arcp contract afn <2 x float> %i.xt, %i.ajq
  %i.ajs = load <2 x i32>, ptr %4, align 4, !tbaa !24
  %i.ajt = sitofp <2 x i32> %i.ajs to <2 x float>
  %i.aju = fsub reassoc nsz arcp contract afn <2 x float> %i.ajr, %i.ajt ; 4 uses
  %i.ajv = extractelement <2 x float> %i.aju, i64 0
  %25 = fcmp ogt <2 x float> %i.aju, %8
  ...
  %i.ajy = select reassoc nsz arcp contract afn i1 %26, float %9, float %spec.select.3.i
  %i.ajz = extractelement <2 x float> %i.aju, i64 1 ; 2 uses
  %i.aka = fcmp reassoc nsz arcp contract afn ogt float %i.ajz, %10
  ...
  %i.akc = select reassoc nsz arcp contract afn i1 %i.aka, float %10, float %spec.select141.3.i
...
bb.t:                                             ; preds = %bb.r
  ...
  %i.dx = getelementptr inbounds nuw i8, ptr %4, i64 12 ; 3 uses
  %6 = load <2 x i32>, ptr %i.dw, align 4, !tbaa !24
  %7 = add nsw <2 x i32> %6, splat (i32 -1)
  %8 = sitofp <2 x i32> %7 to <2 x float>         ; 3 uses
...
.preheader.preheader.i:                           ; preds = %.preheader.lr.ph.i
  ...
  %9 = shufflevector <2 x float> %8, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 poison, i32 poison>
  %10 = shufflevector <4 x float> <float 0.000000e+00, float 0.000000e+00, float poison, float poison>, <4 x float> %9, <4 x i32> <i32 0, i32 1, i32 4, i32 5> ; 2 uses
...
_ZL26_interpolate_linear_splinePKfS0_if.exit.i:   ; preds = %._crit_edge.i.i, %bb.x, %bb.u
  ...
  %i.gi = fadd reassoc nsz arcp contract afn <2 x float> %i.dv, %i.gh
  %i.gj = load <2 x i32>, ptr %4, align 4, !tbaa !24
  %i.gk = sitofp <2 x i32> %i.gj to <2 x float>
  %i.gl = fsub reassoc nsz arcp contract afn <2 x float> %i.gi, %i.gk
  %13 = shufflevector <2 x float> %i.gl, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 1, i32 0> ; 3 uses
  %14 = fcmp reassoc nsz arcp contract afn olt <4 x float> %13, %10
  %15 = fcmp reassoc nsz arcp contract afn ogt <4 x float> %13, %10 ; 2 uses
  %16 = extractelement <4 x i1> %15, i64 3
  %17 = shufflevector <4 x i1> %14, <4 x i1> poison, <2 x i32> <i32 0, i32 1>
  %18 = shufflevector <4 x float> %13, <4 x float> poison, <2 x i32> <i32 0, i32 1>
  %i.gm = select <2 x i1> %17, <2 x float> zeroinitializer, <2 x float> %18 ; 2 uses
  %i.gn = extractelement <2 x float> %i.gm, i64 1
  %i.go = select reassoc nsz arcp contract afn i1 %16, float %11, float %i.gn ; 3 uses
  %19 = extractelement <4 x i1> %15, i64 2
  %i.gp = extractelement <2 x float> %i.gm, i64 0
  %i.gq = select reassoc nsz arcp contract afn i1 %19, float %12, float %i.gp ; 3 uses
