...
_ZL26_interpolate_linear_splinePKfS0_if.exit150.i: ; preds = %._crit_edge.i142.i, %bb.bv, %bb.bs
  ...
  %i.aev = fadd reassoc nsz arcp contract afn float %i.xu, %i.aeu
...
bb.by:                                            ; preds = %bb.bx, %bb.bw, %_ZL26_interpolate_linear_splinePKfS0_if.exit150.i
  ...
  %i.afd = fadd reassoc nsz arcp contract afn float %i.xv, %i.afc
...
_ZL26_interpolate_linear_splinePKfS0_if.exit150.1.i: ; preds = %bb.cf, %._crit_edge.i142.1.i, %bb.cd
  ...
  %i.agp = fadd reassoc nsz arcp contract afn float %i.xu, %i.ago
...
bb.ci:                                            ; preds = %bb.ch, %bb.cg, %_ZL26_interpolate_linear_splinePKfS0_if.exit150.1.i
  ...
  %i.agx = fadd reassoc nsz arcp contract afn float %i.xv, %i.agw
...
_ZL26_interpolate_linear_splinePKfS0_if.exit150.2.i: ; preds = %bb.cp, %._crit_edge.i142.2.i, %bb.cn
  ...
  %i.aij = fadd reassoc nsz arcp contract afn float %i.xu, %i.aii
...
bb.cs:                                            ; preds = %bb.cr, %bb.cq, %_ZL26_interpolate_linear_splinePKfS0_if.exit150.2.i
  ...
  %i.air = fadd reassoc nsz arcp contract afn float %i.xv, %i.aiq
...
_ZL26_interpolate_linear_splinePKfS0_if.exit150.3.i: ; preds = %bb.cz, %._crit_edge.i142.3.i, %bb.cx
  ...
  %i.akd = fadd reassoc nsz arcp contract afn float %i.xu, %i.akc
...
bb.dc:                                            ; preds = %bb.db, %bb.da, %_ZL26_interpolate_linear_splinePKfS0_if.exit150.3.i
  ...
  %i.akl = fadd reassoc nsz arcp contract afn float %i.xv, %i.akk
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i
  ...
  %5 = fadd reassoc nsz arcp contract afn float %i.ux, %i.va
  ...
  %6 = extractelement <2 x float> %i.vd, i64 0
  %i.ve = fadd reassoc nsz arcp contract afn float %5, %6
  %i.vf = extractelement <2 x float> %i.vd, i64 1
  %i.vg = fadd reassoc nsz arcp contract afn float %i.ve, %i.vf
  %7 = load float, ptr %i.el, align 4, !tbaa !300
  %i.vh = fadd reassoc nsz arcp contract afn float %i.vg, -1.000000e+00
  %i.vi = fmul reassoc nsz arcp contract afn float %i.vh, %7
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %7 = fadd reassoc nsz arcp contract afn float %i.on, %i.oq
  ...
  %8 = extractelement <2 x float> %i.ot, i64 0
  %i.ou = fadd reassoc nsz arcp contract afn float %7, %8
  %i.ov = extractelement <2 x float> %i.ot, i64 1
  %i.ow = fadd reassoc nsz arcp contract afn float %i.ou, %i.ov
  %9 = load float, ptr %i.i, align 4, !tbaa !300
  %i.ox = fadd reassoc nsz arcp contract afn float %i.ow, -1.000000e+00
  %i.oy = fmul reassoc nsz arcp contract afn float %i.ox, %9
