...
bb.j:                                             ; preds = %bb.i
  %i.am = and i64 %i.aj, 1023
  %i.an = icmp eq i64 %i.am, 0
  %i.ao = add nuw nsw i64 %i.ak, 16384
  %.0.i.i = and i64 %i.ao, 9223372036854759424
  %spec.select = select i1 %i.an, i64 %i.ak, i64 %.0.i.i
  br label %_ZN8rawspeed7roundUpEmm.exit

_ZN8rawspeed7roundUpEmm.exit:                     ; preds = %bb.j, %bb.i
  %i.ap = phi i64 [ %i.ak, %bb.i ], [ %spec.select, %bb.j ] ; 4 uses
  %i.aq = icmp samesign ugt i64 %i.ap, 4294967295
...
bb.n:                                             ; preds = %_ZN8rawspeed7roundUpEmm.exit
  ...
  %i.at = load i32, ptr %i.as, align 8, !tbaa !27, !noalias !148 ; 2 uses
  %i.au = zext i32 %i.at to i64                   ; 2 uses
  %i.av = add nuw nsw i64 %i.ap, %i.au
  %i.aw = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.ax = load i32, ptr %i.aw, align 8, !tbaa !22, !noalias !149 ; 3 uses
...
bb.p:                                             ; preds = %bb.n
  %i.az = trunc nuw i64 %i.ap to i32              ; 2 uses
  %i.ba = load ptr, ptr %2, align 8, !tbaa !21, !noalias !149
  ...
  %i.bh = load i16, ptr %i.bg, align 4, !tbaa !25, !noalias !149
  %.sroa.4.8.insert.ext.i.i = zext i16 %i.bh to i64
  %.sroa.4.8.insert.shift.i.i = shl nuw nsw i64 %.sroa.4.8.insert.ext.i.i, 32
  %.sroa.2.8.insert.insert.i.i = or disjoint i64 %.sroa.4.8.insert.shift.i.i, %i.ap
...
bb.s:                                             ; preds = %bb.m, %bb.r, %bb.f
  ...
  %i.bj = load ptr, ptr %i.l, align 8, !tbaa !108 ; 3 uses
...
bb.t:                                             ; preds = %bb.s
  ...
  %i.bl = load ptr, ptr %i.bk, align 8, !tbaa !109
