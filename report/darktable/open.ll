...
.thread626:                                       ; preds = %bb.gq, %bb.gr, %bb.gs, %bb.gn, %bb.go, %bb.gp, %.thread610, %bb.fr, %bb.fu, %bb.fv, %bb.ft, %bb.fq, %bb.fs, %bb.fo, %bb.fn, %bb.fw, %bb.fz, %bb.ga, %bb.fx, %bb.fy, %.thread601, %bb.gt, %bb.gu, %bb.gy, %bb.gx, %bb.gv
  ...
  br i1 %i.ajr, label %bb.gz, label %.loopexit695
...
bb.hi:                                            ; preds = %bb.hh, %bb.hg
  ...
  %i.akq = icmp ugt i32 %.pre884, 256
  %or.cond1002 = select i1 %i.akp, i1 true, i1 %i.akq
...
.preheader694:                                    ; preds = %bb.hi
  ...
  %i.akx = insertelement <4 x i32> poison, i32 %.pre884, i64 0
...
.lr.ph746:                                        ; preds = %.preheader694, %.lr.ph746
  ...
  %i.alh = add nuw nsw i64 %indvars.iv827, 6
  ...
  %i.alq = icmp samesign ult i64 %indvars.iv.next828, %i.alp
  br i1 %i.alq, label %.lr.ph746, label %.thread630, !llvm.loop !2293
...
.loopexit695:                                     ; preds = %.thread626
  ...
  br i1 %i.als, label %vector.ph984, label %.thread630
...
vector.body985:                                   ; preds = %vector.body985, %vector.ph984
  ...
  %i.aly = uitofp nneg <16 x i32> %vec.ind987 to <16 x double> ; 4 uses
  %i.alz = fmul reassoc nnan nsz arcp contract afn <16 x double> %i.aly, splat (double f0x3F35555555555555) ; 2 uses
  %i.ama = fmul reassoc nnan nsz arcp contract afn <16 x double> %i.alz, %i.alz ; 2 uses
  %i.amb = fmul reassoc nnan nsz arcp contract afn <16 x double> %i.aly, splat (double f0xBE975608FECE194D)
  %i.amc = fmul reassoc nnan nsz arcp contract afn <16 x double> %i.ama, splat (double f0x3F667BCEF737735E)
  %2 = fmul reassoc nnan nsz arcp contract afn <16 x double> %i.aly, splat (double f0xBEB267E8FF27CE95)
  %i.amd = fmul reassoc nsz arcp contract afn <16 x double> %2, %i.ama
  %3 = fadd reassoc nnan nsz arcp contract afn <16 x double> %i.amb, splat (double f0x3EF3C65EA647FFF0)
  %i.ame = fadd reassoc nsz arcp contract afn <16 x double> %3, %i.amc
  ...
  %i.amn = getelementptr inbounds nuw [2 x i8], ptr %i.alt, i64 %index986
  ...
  %i.amo = icmp eq i64 %index.next988, 3072
  br i1 %i.amo, label %scalar.ph, label %vector.body985, !llvm.loop !2295
...
.thread630:                                       ; preds = %.lr.ph746, %bb.hi, %.preheader694, %scalar.ph, %bb.hf, %.loopexit695
  %i.amv = phi i1 [ %i.ajn, %scalar.ph ], [ false, %bb.hf ], [ true, %bb.hi ], [ %i.ajn, %.loopexit695 ], [ true, %.preheader694 ], [ true, %.lr.ph746 ]
...
bb.hk:                                            ; preds = %bb.hj
  ...
  br i1 %i.anh, label %.preheader690, label %.loopexit691
...
.lr.ph752:                                        ; preds = %.preheader690, %.lr.ph752
  ...
  %i.anu = add nuw nsw i64 %indvars.iv846, 6
  ...
  %i.aod = icmp samesign ult i64 %indvars.iv.next847, %i.aoc
  br i1 %i.aod, label %.lr.ph752, label %.loopexit691, !llvm.loop !2296
