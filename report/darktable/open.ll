...
vector.body984:                                   ; preds = %vector.body984, %vector.ph983
  ...
  %i.alw = uitofp nneg <16 x i32> %vec.ind986 to <16 x double> ; 4 uses
  %i.alx = fmul reassoc nnan nsz arcp contract afn <16 x double> %i.alw, splat (double f0x3F35555555555555) ; 2 uses
  %i.aly = fmul reassoc nnan nsz arcp contract afn <16 x double> %i.alx, %i.alx ; 2 uses
  %i.alz = fmul reassoc nnan nsz arcp contract afn <16 x double> %i.alw, splat (double f0xBE975608FECE194D)
  %i.ama = fmul reassoc nnan nsz arcp contract afn <16 x double> %i.aly, splat (double f0x3F667BCEF737735E)
  %2 = fmul reassoc nnan nsz arcp contract afn <16 x double> %i.alw, splat (double f0xBEB267E8FF27CE95)
  %i.amb = fmul reassoc nsz arcp contract afn <16 x double> %2, %i.aly
  %3 = fadd reassoc nnan nsz arcp contract afn <16 x double> %i.alz, splat (double f0x3EF3C65EA647FFF0)
  %i.amc = fadd reassoc nsz arcp contract afn <16 x double> %3, %i.ama
