...
bb.em:                                            ; preds = %.thread598.thread, %.thread598
  ...
  %6 = and i32 %5, 14
  %i.aae = or disjoint i32 %.sroa.0.0, %6
  %7 = and <2 x i32> %4, <i32 -1, i32 14>
  %i.aaf = insertelement <2 x i32> poison, i32 %.sroa.0.0, i64 0
  %8 = shufflevector <2 x i32> %i.aaf, <2 x i32> poison, <2 x i32> zeroinitializer
  %9 = or disjoint <2 x i32> %8, %7
  ...
  %10 = shufflevector <2 x i32> %9, <2 x i32> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %11 = shufflevector <16 x i32> %i.aaw, <16 x i32> %10, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 16, i32 17, i32 poison>
  %12 = insertelement <16 x i32> %11, i32 %i.aae, i64 15 ; 2 uses
  %i.aax = shl nuw nsw <16 x i32> %12, <i32 1, i32 1, i32 1, i32 1, i32 8, i32 1, i32 1, i32 1, i32 16, i32 1, i32 1, i32 1, i32 24, i32 1, i32 1, i32 1>
  %i.aay = or disjoint <16 x i32> %12, <i32 poison, i32 poison, i32 poison, i32 poison, i32 8, i32 poison, i32 poison, i32 poison, i32 16, i32 poison, i32 poison, i32 poison, i32 24, i32 poison, i32 poison, i32 poison>
