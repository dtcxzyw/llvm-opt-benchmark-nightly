...
bb.em:                                            ; preds = %.thread598.thread, %.thread598
  %.sroa.5.0935 = phi i32 [ %.sroa.5.0934, %.thread598.thread ], [ 2, %.thread598 ]
  %.sroa.0.0 = phi i32 [ 1, %.thread598.thread ], [ 0, %.thread598 ] ; 6 uses
  %i.zs = insertelement <4 x i32> poison, i32 %.sroa.5.0935, i64 0
  %i.zt = shufflevector <4 x i32> %i.zs, <4 x i32> poison, <4 x i32> zeroinitializer ; 6 uses
  ...
  %2 = shufflevector <4 x i32> %i.aaa, <4 x i32> <i32 poison, i32 poison, i32 poison, i32 1>, <4 x i32> <i32 3, i32 3, i32 3, i32 7> ; 2 uses
  %3 = or disjoint <4 x i32> %i.aad, %2
  %4 = shl nuw nsw <4 x i32> %i.aad, %2
  %5 = shufflevector <4 x i32> %i.zw, <4 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %6 = shufflevector <4 x i32> %i.zy, <4 x i32> %i.zz, <8 x i32> <i32 0, i32 5, i32 6, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %7 = shufflevector <8 x i32> %5, <8 x i32> %6, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 9, i32 10, i32 11> ; 2 uses
  %8 = insertelement <8 x i32> <i32 poison, i32 poison, i32 poison, i32 1, i32 poison, i32 poison, i32 poison, i32 1>, i32 %.sroa.0.0, i64 0
  %9 = shufflevector <8 x i32> %8, <8 x i32> poison, <8 x i32> <i32 0, i32 0, i32 0, i32 3, i32 0, i32 0, i32 0, i32 7> ; 2 uses
  %10 = or disjoint <8 x i32> %7, %9
  %11 = shl nuw nsw <8 x i32> %7, %9
  %12 = shufflevector <8 x i32> %10, <8 x i32> %11, <8 x i32> <i32 0, i32 1, i32 2, i32 11, i32 4, i32 5, i32 6, i32 15>
  %13 = add nuw nsw <4 x i32> %i.zt, <i32 0, i32 14, i32 14, i32 0>
  %14 = and <4 x i32> %13, <i32 -1, i32 14, i32 14, i32 -1>
  %15 = insertelement <4 x i32> <i32 12, i32 poison, i32 poison, i32 poison>, i32 %.sroa.0.0, i64 1
  %16 = shufflevector <4 x i32> %15, <4 x i32> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 1>
  %17 = or disjoint <4 x i32> %16, %14            ; 3 uses
  %18 = extractelement <4 x i32> %17, i64 0
  %i.aae = or disjoint i32 %.sroa.0.0, %18
  %19 = shufflevector <4 x i32> %17, <4 x i32> poison, <16 x i32> <i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.aaf = shufflevector <8 x i32> %12, <8 x i32> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.aag = shufflevector <16 x i32> %19, <16 x i32> %i.aaf, <16 x i32> <i32 0, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.aah = shufflevector <4 x i32> %3, <4 x i32> %4, <16 x i32> <i32 0, i32 1, i32 2, i32 7, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  ...
  %20 = insertelement <16 x i32> %i.aai, i32 %i.aae, i64 13
  %21 = shufflevector <4 x i32> %17, <4 x i32> poison, <16 x i32> <i32 poison, i32 1, i32 2, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %22 = shufflevector <16 x i32> %20, <16 x i32> %21, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 18, i32 17> ; 2 uses
  %i.aaj = shl nuw nsw <16 x i32> %22, <i32 1, i32 1, i32 1, i32 1, i32 8, i32 1, i32 1, i32 1, i32 16, i32 1, i32 1, i32 1, i32 24, i32 1, i32 1, i32 1>
  %i.aak = or disjoint <16 x i32> %22, <i32 poison, i32 poison, i32 poison, i32 poison, i32 8, i32 poison, i32 poison, i32 poison, i32 16, i32 poison, i32 poison, i32 poison, i32 24, i32 poison, i32 poison, i32 poison>
