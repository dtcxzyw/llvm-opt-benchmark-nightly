...
.lr.ph1139.i:                                     ; preds = %.lr.ph1143.i
  ...
  %13 = zext nneg i32 %i.ovv to i64               ; 2 uses
  %14 = or disjoint i64 %10, %13
  %15 = add nuw nsw i64 %14, 4
  %16 = call i64 @llvm.smax.i64(i64 %15, i64 %i.ors)
  %17 = add nsw i64 %16, -3
  %18 = or disjoint i64 %10, %13
  %i.ovw = sub i64 %17, %18                       ; 2 uses
...
vector.memcheck3892:                              ; preds = %.lr.ph1139.i
  ...
  %i.owa = zext nneg i32 %i.ovz to i64            ; 3 uses
  ...
  %19 = or disjoint i64 %9, %i.owa
  %smax3898 = call i64 @llvm.smax.i64(i64 %19, i64 %i.orp)
  %20 = add nuw i64 %smax3898, 4611686018427387901
  %i.owd = or disjoint i64 %i.orm, %i.owa
  %i.owe = sub nuw i64 %20, %i.owd
...
.preheader.lr.ph.i559:                            ; preds = %.lr.ph1151.i
  ...
  %21 = zext nneg i32 %i.pca to i64               ; 2 uses
  %22 = or disjoint i64 %11, %21
  %23 = add nuw nsw i64 %22, 4
  %24 = call i64 @llvm.smax.i64(i64 %23, i64 %i.orv)
  %25 = add nsw i64 %24, -3
  %26 = or disjoint i64 %11, %21
  %i.pcb = sub i64 %25, %26                       ; 2 uses
...
vector.memcheck3805:                              ; preds = %.preheader.lr.ph.i559
  ...
  %i.pcf = zext nneg i32 %i.pce to i64            ; 3 uses
  ...
  %27 = or disjoint i64 %7, %i.pcf
  %smax3809 = call i64 @llvm.smax.i64(i64 %27, i64 %8)
  %28 = add nuw i64 %smax3809, 4611686018427387901
  %i.pcj = or disjoint i64 %i.orl, %i.pcf
  %i.pck = sub nuw i64 %28, %i.pcj
...
.lr.ph1154.i:                                     ; preds = %.lr.ph1157.i
  ...
  %29 = zext nneg i32 %i.pln to i64               ; 2 uses
  %30 = or disjoint i64 %12, %29
  %31 = add nuw nsw i64 %30, 4
  %32 = call i64 @llvm.smax.i64(i64 %31, i64 %i.ory)
  %33 = add nsw i64 %32, -3
  %34 = or disjoint i64 %12, %29
  %i.plo = sub i64 %33, %34                       ; 2 uses
...
vector.memcheck3744:                              ; preds = %.lr.ph1154.i
  ...
  %i.pls = zext nneg i32 %i.plr to i64            ; 3 uses
  ...
  %35 = or disjoint i64 %6, %i.pls
  %smax3748 = call i64 @llvm.smax.i64(i64 %35, i64 %i.ork)
  %36 = add nuw i64 %smax3748, 4611686018427387901
  %i.ply = or disjoint i64 %i.orh, %i.pls
  %i.plz = sub nuw i64 %36, %i.ply
