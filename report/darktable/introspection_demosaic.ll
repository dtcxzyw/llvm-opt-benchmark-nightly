...
.preheader833.i:                                  ; preds = %._crit_edge939.i, %.preheader833.preheader.i
  ...
  %i.jiv = add nuw i32 %i.jip, %indvars.iv1055.i
...
.preheader1020.i:                                 ; preds = %._crit_edge1180.i, %.preheader1020.preheader.i
  ...
  %indvars.iv1304.i = phi i64 [ %indvars.iv.next1305.i, %._crit_edge1180.i ], [ 0, %.preheader1020.preheader.i ] ; 2 uses
  ...
  %6 = zext nneg i32 %i.lyv to i64
  %7 = add nuw nsw i32 %i.lyv, 4
  %8 = or disjoint i64 %indvars.iv1304.i, %6
...
._crit_edge1180.i:                                ; preds = %._crit_edge1176.split.i
  ...
  %indvars.iv.next1305.i = add nuw nsw i64 %indvars.iv1304.i, 112
...
.lr.ph1168.i.preheader:                           ; preds = %.lr.ph1175.i
  %reass.sub = sub nuw nsw i32 %i.oul, %i.mau
  %.reass1171.i = add nuw nsw i32 %reass.sub, 4
...
.lr.ph1168.i:                                     ; preds = %.lr.ph1168.i.preheader, %._crit_edge1169.i
  %indvars.iv1306.i = phi i64 [ %indvars.iv.next1307.i, %._crit_edge1169.i ], [ %8, %.lr.ph1168.i.preheader ] ; 2 uses
  %indvars.iv1302.i = phi i32 [ %indvars.iv.next1303.i, %._crit_edge1169.i ], [ %7, %.lr.ph1168.i.preheader ] ; 2 uses
