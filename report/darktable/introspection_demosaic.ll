...
.lr.ph1146.i:                                     ; preds = %.lr.ph1150.i
  ...
  %13 = zext nneg i32 %i.osu to i64               ; 2 uses
  %14 = or disjoint i64 %10, %13
  %15 = add nuw nsw i64 %14, 4
  %16 = call i64 @llvm.smax.i64(i64 %15, i64 %i.oor)
  %17 = add nsw i64 %16, -3
  %18 = or disjoint i64 %10, %13
  %i.osv = sub i64 %17, %18                       ; 2 uses
...
vector.memcheck3889:                              ; preds = %.lr.ph1146.i
  ...
  %i.osz = zext nneg i32 %i.osy to i64            ; 3 uses
  ...
  %19 = or disjoint i64 %9, %i.osz
  %smax3895 = call i64 @llvm.smax.i64(i64 %19, i64 %i.ooo)
  %20 = add nuw i64 %smax3895, 4611686018427387901
  %i.otc = or disjoint i64 %i.ool, %i.osz
  %i.otd = sub nuw i64 %20, %i.otc
...
.preheader.lr.ph.i559:                            ; preds = %.lr.ph1158.i
  ...
  %21 = zext nneg i32 %i.oyz to i64               ; 2 uses
  %22 = or disjoint i64 %11, %21
  %23 = add nuw nsw i64 %22, 4
  %24 = call i64 @llvm.smax.i64(i64 %23, i64 %i.oou)
  %25 = add nsw i64 %24, -3
  %26 = or disjoint i64 %11, %21
  %i.oza = sub i64 %25, %26                       ; 2 uses
...
vector.memcheck3802:                              ; preds = %.preheader.lr.ph.i559
  ...
  %i.oze = zext nneg i32 %i.ozd to i64            ; 3 uses
  ...
  %27 = or disjoint i64 %7, %i.oze
  %smax3806 = call i64 @llvm.smax.i64(i64 %27, i64 %8)
  %28 = add nuw i64 %smax3806, 4611686018427387901
  %i.ozi = or disjoint i64 %i.ook, %i.oze
  %i.ozj = sub nuw i64 %28, %i.ozi
...
.lr.ph1161.i:                                     ; preds = %.lr.ph1164.i
  ...
  %29 = zext nneg i32 %i.pim to i64               ; 2 uses
  %30 = or disjoint i64 %12, %29
  %31 = add nuw nsw i64 %30, 4
  %32 = call i64 @llvm.smax.i64(i64 %31, i64 %i.oox)
  %33 = add nsw i64 %32, -3
  %34 = or disjoint i64 %12, %29
  %i.pin = sub i64 %33, %34                       ; 2 uses
...
vector.memcheck3741:                              ; preds = %.lr.ph1161.i
  ...
  %i.pir = zext nneg i32 %i.piq to i64            ; 3 uses
  ...
  %35 = or disjoint i64 %6, %i.pir
  %smax3745 = call i64 @llvm.smax.i64(i64 %35, i64 %i.ooj)
  %36 = add nuw i64 %smax3745, 4611686018427387901
  %i.pix = or disjoint i64 %i.oog, %i.pir
  %i.piy = sub nuw i64 %36, %i.pix
