...
vector.body1738:                                  ; preds = %vector.body1738, %vector.ph1736
  ...
  %i.rym = getelementptr inbounds nuw [4 x i8], ptr %i.rvm, i64 %index1739
  %wide.load1740 = load <4 x float>, ptr %i.rym, align 4, !tbaa !12, !alias.scope !615, !noalias !611 ; 3 uses
  ...
  %i.ryt = fmul reassoc nsz arcp contract afn <4 x float> %i.rys, %wide.load1740
  ...
  %i.ryw = fmul reassoc nsz arcp contract afn <4 x float> %i.ryv, %wide.load1740
