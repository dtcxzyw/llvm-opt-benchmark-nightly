...
.lr.ph430:                                        ; preds = %.lr.ph420, %.preheader
  ...
  %i.oz = sext i32 %2 to i64
  %i.pa = shl nsw i64 %i.oz, 2
  %i.pb = icmp sgt i32 %2, 0
  %i.pc = sub nuw nsw i32 %2, %6                  ; 3 uses
...
.lr.ph425:                                        ; preds = %.lr.ph425.preheader, %._crit_edge426
  ...
  %i.tu = mul nuw nsw i64 %indvars.iv462, %7
  %i.tv = add nuw nsw i64 %i.tu, %8
  %.idx = shl nuw nsw i64 %i.tv, 4
...
bb.ct:                                            ; preds = %.lr.ph425.split
  ...
  br i1 %.not346, label %bb.cx, label %bb.cu, !prof !626
...
bb.ag:                                            ; preds = %bb.af, %bb.ae
  ...
  br i1 %exitcond305.not.1, label %.loopexit, label %scalar.ph, !llvm.loop !722
...
.lr.ph284:                                        ; preds = %.preheader233
  ...
  %i.ny = sub nuw nsw i32 %2, %6                  ; 3 uses
