...
.lr.ph1502.i:                                     ; preds = %._crit_edge1503.i, %.lr.ph1502.preheader.i
  %indvar = phi i32 [ %indvar.next, %._crit_edge1503.i ], [ 0, %.lr.ph1502.preheader.i ] ; 3 uses
  %indvar.a = phi i32 [ %indvars.iv.next1198, %._crit_edge1503.i ], [ 5, %.lr.ph1502.preheader.i ] ; 2 uses
  %indvars.iv1197 = phi i32 [ -96, %._crit_edge1503.i ], [ 0, %.lr.ph1502.preheader.i ]
  ...
  %smin2074 = call i32 @llvm.smin.i32(i32 %indvars.iv1721.i, i32 %i.ccm)
  %7 = extractelement <4 x i32> %i.cdj, i64 3
  %i.cdk = add i32 %smin2074, %7
  ...
  %i.cdt = add i32 %smin1234, %indvar.a
  ...
  %8 = add i32 %smin1234, %indvars.iv1197
...
._crit_edge1503.i:                                ; preds = %._crit_edge1497.split.i
  ...
  %indvars.iv.next1198 = add i32 %indvar.a, -96
...
bb.jq:                                            ; preds = %._crit_edge1497.split.i, %.lr.ph1502.i
  %indvar2043 = phi i32 [ %indvar.next2040, %._crit_edge1497.split.i ], [ 0, %.lr.ph1502.i ] ; 3 uses
  %indvar2039 = phi i32 [ %indvars.iv.next1233, %._crit_edge1497.split.i ], [ 0, %.lr.ph1502.i ] ; 4 uses
  ...
  %indvars.iv1718.i = phi i32 [ -96, %._crit_edge1497.split.i ], [ 0, %.lr.ph1502.i ]
  ...
  %i.cgc = add i32 %smin2050, %indvar2039
  ...
  %i.cgj = add i32 %smin, %indvar2039
  %i.cgk = zext i32 %i.cgj to i64
  %i.cgl = call i64 @llvm.usub.sat.i64(i64 %i.cgk, i64 14) ; 2 uses
  %i.cgm = mul i32 %indvar2043, 384
  %i.cgn = add i32 %i.cdo, %i.cgm
  %smin1231 = call i32 @llvm.smin.i32(i32 %indvars.iv1716.i, i32 %i.aqz) ; 8 uses
  %i.cgo = add i32 %smin1231, %indvar2039         ; 2 uses
  ...
  %9 = add i32 %smin1231, %indvars.iv1718.i
...
._crit_edge1497.split.i:                          ; preds = %._crit_edge1495.i, %.preheader1252.lr.ph.i, %.preheader1258.i, %.preheader1259.split.i
  ...
  %indvars.iv.next1213 = add nuw nsw i32 %indvars.iv1212, -96
  %indvars.iv.next1223 = add nuw nsw i32 %indvars.iv1222, -96
  %indvars.iv.next1233 = add i32 %indvar2039, -96
  %indvar.next2040 = add i32 %indvar2043, 1
