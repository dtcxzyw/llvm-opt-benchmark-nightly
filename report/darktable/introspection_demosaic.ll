...
.lr.ph1491.i:                                     ; preds = %._crit_edge1492.i, %.lr.ph1491.preheader.i
  %indvars.iv1181.a = phi i32 [ %indvar.next, %._crit_edge1492.i ], [ 0, %.lr.ph1491.preheader.i ] ; 3 uses
  %indvars.iv1711.i = phi i32 [ %indvars.iv.next1182, %._crit_edge1492.i ], [ 5, %.lr.ph1491.preheader.i ] ; 2 uses
  ...
  %7 = mul i32 %i.auy, %indvars.iv1181.a
  %smin2054 = call i32 @llvm.smin.i32(i32 %indvars.iv1708.i, i32 %i.ccm)
  %i.cdk = add i32 %smin2054, %6
  ...
  %i.cdo = mul i32 %i.auw, %indvars.iv1181.a
...
._crit_edge1492.i:                                ; preds = %._crit_edge1486.split.i
  ...
  %indvars.iv.next1182 = add i32 %indvars.iv1711.i, -96
  %i.cfz = add <4 x i32> %i.cdj, splat (i32 -96)
  %indvar.next = add i32 %indvars.iv1181.a, 1
  br i1 %i.cfy, label %.lr.ph1491.i, label %._crit_edge1496.split.i

bb.jq:                                            ; preds = %._crit_edge1486.split.i, %.lr.ph1491.i
  %indvars.iv1216 = phi i32 [ %indvar.next2028, %._crit_edge1486.split.i ], [ 0, %.lr.ph1491.i ] ; 3 uses
  ...
  %i.cgc = add i32 %smin2038, %indvars.iv1705.i
  ...
  %i.cgf = mul i32 %indvars.iv1216, 384
  ...
  %i.cgm = mul i32 %indvars.iv1216, 384
  %i.cgn = add i32 %i.cdo, %i.cgm
  %smin1215 = call i32 @llvm.smin.i32(i32 %indvars.iv1703.i, i32 %i.aqz) ; 7 uses
...
._crit_edge1486.split.i:                          ; preds = %._crit_edge1484.i, %.preheader1241.lr.ph.i, %.preheader1247.i, %.preheader1248.split.i
  ...
  %indvars.iv.next1706.i = add i32 %indvars.iv1705.i, -96
  ...
  %indvar.next2028 = add i32 %indvars.iv1216, 1
