...
vector.body3680:                                  ; preds = %vector.body3680, %vector.ph3676
  ...
  %7 = shufflevector <8 x float> %wide.load3685, <8 x float> %wide.load3686, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %8 = fmul reassoc nsz arcp contract afn <16 x float> %7, %i.avy
  %wide.load3687 = load <8 x float>, ptr %next.gep, align 4, !tbaa !12, !noalias !549
  %9 = fmul reassoc nsz arcp contract afn <8 x float> %wide.load3687, %broadcast.splat3679
  %10 = call reassoc nsz arcp contract afn <8 x float> @llvm.maxnum.v8f32(<8 x float> %9, <8 x float> zeroinitializer)
  %i.pro = call reassoc nsz arcp contract afn <16 x float> @llvm.maxnum.v16f32(<16 x float> %8, <16 x float> zeroinitializer)
  %i.prp = shufflevector <8 x float> %10, <8 x float> zeroinitializer, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
