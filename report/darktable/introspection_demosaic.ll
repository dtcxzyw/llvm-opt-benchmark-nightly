...
.lr.ph903.preheader.i:                            ; preds = %bb.og
  %8 = mul nuw nsw i32 %.0763905.i, 112
  %9 = add nsw i32 %8, -113
  %10 = add nsw i32 %9, %i.kqv
  %11 = sdiv i32 %10, 2
  %12 = add i32 %i.kqu, %indvars.iv1021.i
  %13 = lshr i32 %12, 1
  %14 = zext nneg i32 %13 to i64                  ; 5 uses
  %15 = sext i32 %11 to i64                       ; 5 uses
...
vector.memcheck3262:                              ; preds = %.lr.ph903.preheader.i
  ...
  %17 = insertelement <2 x i64> %16, i64 %15, i64 1
  %i.krc = shl nsw <2 x i64> %17, splat (i64 2)
...
vector.ph3278:                                    ; preds = %vector.memcheck3262
  ...
  %i.krm = add nsw i64 %n.vec3279, %15
...
vector.body3280:                                  ; preds = %vector.body3280, %vector.ph3278
  ...
  %i.krs = add i64 %index3281, %15                ; 2 uses
  %i.krt = add nuw i64 %index3281, %14            ; 2 uses
  %i.kru = getelementptr inbounds [4 x i8], ptr %i.jev, i64 %i.krs
  ...
  %i.ksb = getelementptr [4 x i8], ptr %i.jew, i64 %i.krs
  %i.ksc = getelementptr i8, ptr %i.ksb, i64 4
...
._crit_edge904.i:                                 ; preds = %.lr.ph903.i, %middle.block3289, %bb.og
  %i.ksm = add nuw nsw i32 %.0763905.i, 1         ; 2 uses
...
.lr.ph903.i:                                      ; preds = %.lr.ph903.i.preheader, %.lr.ph903.i
  ...
  %i.ksq = getelementptr inbounds [4 x i8], ptr %i.jev, i64 %indvars.iv1025.i
  ...
  %i.ksz = getelementptr inbounds [4 x i8], ptr %i.jew, i64 %indvars.iv.next1026.i
...
.preheader828.i:                                  ; preds = %.preheader828.i.preheader, %._crit_edge914.i
  %indvar3052.a = phi i32 [ 0, %.preheader828.i.preheader ], [ %indvar.next3053, %._crit_edge914.i ] ; 2 uses
  ...
  %.0755915.i = phi i32 [ 4, %.preheader828.i.preheader ], [ %i.kzk, %._crit_edge914.i ] ; 3 uses
  %i.ktn = mul i32 %indvar3052.a, 112
  ...
  %i.ktv = and i32 %i.ktu, 1                      ; 7 uses
  %i.ktw = or disjoint i32 %i.ktv, 4              ; 5 uses
  %i.ktx = icmp slt i32 %i.ktw, %i.kli
  br i1 %i.ktx, label %.lr.ph913.i, label %._crit_edge914.i

.lr.ph913.i:                                      ; preds = %.preheader828.i
  %18 = mul nuw nsw i32 %.0755915.i, 112
  %19 = add nsw i32 %18, -113
  %20 = add nsw i32 %19, %i.ktw
  %21 = sdiv i32 %20, 2
  ...
  %22 = sext i32 %21 to i64                       ; 5 uses
  %i.kui = or disjoint i32 %i.ktv, %indvars.iv1038.i
  %i.kuj = lshr exact i32 %indvars.iv1038.i, 1
...
scalar.ph3204.preheader:                          ; preds = %vector.body3211, %vector.memcheck3040, %.lr.ph913.i
  ...
  %indvars.iv1036.i.ph = phi i64 [ %22, %vector.memcheck3040 ], [ %22, %.lr.ph913.i ], [ %i.kvo, %vector.body3211 ]
...
vector.memcheck3040:                              ; preds = %.lr.ph913.i
  %i.kup = or disjoint i32 %indvars.iv1038.i, %i.ktv
...
vector.ph3206:                                    ; preds = %vector.memcheck3040
  ...
  %i.kvo = add nsw i64 %n.vec3207, %22
...
vector.body3211:                                  ; preds = %vector.body3211, %vector.ph3206
  ...
  %i.kvv = add i64 %index3212, %22                ; 2 uses
  ...
  %i.kvx = getelementptr inbounds [4 x i8], ptr %i.jer, i64 %i.kvv
  %wide.load3215 = load <8 x float>, ptr %i.kvx, align 4, !tbaa !12, !alias.scope !525, !noalias !499
  %i.kvy = getelementptr [4 x i8], ptr %i.jer, i64 %i.kvv
  %i.kvz = getelementptr i8, ptr %i.kvy, i64 4
...
._crit_edge914.i:                                 ; preds = %scalar.ph3204, %.preheader828.i
  ...
  %indvar.next3053 = add i32 %indvar3052.a, 1
...
scalar.ph3204:                                    ; preds = %scalar.ph3204.preheader, %scalar.ph3204
  ...
  %i.kzq = getelementptr inbounds [4 x i8], ptr %i.jer, i64 %indvars.iv1036.i
