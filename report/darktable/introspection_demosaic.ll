...
._crit_edge.i568:                                 ; preds = %_calc_gamma.exit.i.epil, %._crit_edge.i568.loopexit4628.unr-lcssa, %_calc_gamma.exit.us.i, %middle.block4433, %vec.epilog.middle.block4452
...
.lr.ph.split.i:                                   ; preds = %.lr.ph.split.i.preheader, %_calc_gamma.exit.i.1
  ...
  %niter4714 = phi i32 [ %niter4714.next.1, %_calc_gamma.exit.i.1 ], [ 0, %.lr.ph.split.i.preheader ]
...
_calc_gamma.exit.i.1:                             ; preds = %bb.ox, %bb.ow, %_calc_gamma.exit.i
  ...
  %niter4714.next.1 = add i32 %niter4714, 2       ; 2 uses
  %niter4714.ncmp.1.not = icmp eq i32 %niter4714.next.1, %unroll_iter4713
  br i1 %niter4714.ncmp.1.not, label %._crit_edge.i568.loopexit4628.unr-lcssa, label %.lr.ph.split.i
...
vector.ph4371:                                    ; preds = %.lr.ph1041.i
  ...
  %invariant.gep4850 = getelementptr [4 x i8], ptr %i.meu, i64 %i.mey
...
vector.body4376:                                  ; preds = %vector.body4376, %vector.ph4371
  ...
  %gep4851 = getelementptr i8, ptr %invariant.gep4850, i64 %.idx ; 9 uses
  %i.mfm = getelementptr inbounds i8, ptr %gep4851, i64 -548
  ...
  %i.mfn = getelementptr inbounds i8, ptr %gep4851, i64 -544
  ...
  %i.mfp = getelementptr inbounds nuw i8, ptr %gep4851, i64 540
  ...
  %i.mfr = getelementptr inbounds nuw i8, ptr %gep4851, i64 544
  ...
  %wide.vec4389 = load <16 x float>, ptr %gep4851, align 4, !tbaa !12, !noalias !549
  ...
  %i.mfw = getelementptr inbounds i8, ptr %gep4851, i64 -8
  ...
  %i.mfx = getelementptr inbounds nuw i8, ptr %gep4851, i64 4
  ...
  %i.mgh = fcmp reassoc nsz arcp contract afn ule <8 x float> %strided.vec4390, %i.mgg
  ...
  %predphi4398 = select reassoc nsz arcp contract afn <8 x i1> %i.mgi, <8 x float> zeroinitializer, <8 x float> %i.mgk
  ...
  %i.mgq = getelementptr inbounds i8, ptr %gep4851, i64 -1088
  ...
  %i.mgr = getelementptr inbounds nuw i8, ptr %gep4851, i64 1088
  ...
  %i.mhb = fcmp reassoc nsz arcp contract afn ule <8 x float> %strided.vec4390, %i.mha
  ...
  %predphi4405 = select reassoc nsz arcp contract afn <8 x i1> %i.mhc, <8 x float> zeroinitializer, <8 x float> %i.mhe
...
vector.ph4339:                                    ; preds = %.lr.ph1046.i
  ...
  %invariant.gep4852 = getelementptr [4 x i8], ptr %i.mhq, i64 %i.mhu
...
vector.body4344:                                  ; preds = %vector.body4344, %vector.ph4339
  ...
  %gep4853 = getelementptr i8, ptr %invariant.gep4852, i64 %.idx4557 ; 7 uses
  ...
  %i.mii = getelementptr inbounds i8, ptr %gep4853, i64 -8
  ...
  %i.mij = getelementptr inbounds nuw i8, ptr %gep4853, i64 8
  ...
  %wide.vec4354 = load <16 x float>, ptr %gep4853, align 4, !tbaa !12, !noalias !549 ; 2 uses
  ...
  %i.miq = getelementptr inbounds i8, ptr %gep4853, i64 -1088
  ...
  %i.mir = getelementptr inbounds nuw i8, ptr %gep4853, i64 1088
  ...
  %i.miu = getelementptr inbounds i8, ptr %gep4853, i64 -544
  ...
  %i.miw = getelementptr inbounds nuw i8, ptr %gep4853, i64 544
