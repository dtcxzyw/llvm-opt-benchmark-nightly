...
bb.f:                                             ; preds = %.thread91, %bb.d, %bb.e
  ...
  %i.bc = phi <2 x float> [ splat (float 1.000000e+00), %.thread91 ], [ %i.s, %bb.d ], [ %i.s, %bb.e ] ; 5 uses
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.preheader, %dt_RGB_to_Lab.exit.i.i.i
  ...
  %6 = getelementptr inbounds nuw i8, ptr %i.du, i64 8
  %7 = load float, ptr %6, align 4, !tbaa !101, !alias.scope !190, !noalias !189
  %8 = load <2 x float>, ptr %i.du, align 4, !tbaa !101, !alias.scope !190, !noalias !189
  %i.dv = fmul reassoc nsz arcp contract afn <2 x float> %8, %i.bc ; 3 uses
  %i.dw = shufflevector <2 x float> %i.dv, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 1, i32 1> ; 2 uses
  %9 = shufflevector <2 x float> %i.dv, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %10 = insertelement <4 x float> poison, float %7, i64 3
  %11 = shufflevector <4 x float> %9, <4 x float> %10, <4 x i32> <i32 0, i32 1, i32 0, i32 7>
  %12 = fmul reassoc nsz arcp contract afn <4 x float> %11, %i.dj ; 2 uses
  %13 = shufflevector <4 x float> %12, <4 x float> <float poison, float 0.000000e+00, float poison, float poison>, <4 x i32> <i32 3, i32 3, i32 3, i32 5>
  %i.dx = fmul reassoc nsz arcp contract afn <4 x float> %13, %i.dm ; 2 uses
  ...
  %i.ee = fadd reassoc nsz arcp contract afn <4 x float> %i.ed, %12 ; 2 uses
