...
bb.an:                                            ; preds = %bb.am
  ...
  %6 = fmul reassoc nnan nsz arcp contract afn float %i.pp, 2.000000e+00
  %i.mm = tail call reassoc nnan nsz arcp contract afn float @llvm.minnum.f32(float %6, float 1.000000e+00)
  %i.mn = fmul reassoc nnan nsz arcp contract afn float %i.mm, 1.100000e-01
...
vector.body220:                                   ; preds = %.lr.ph.us.i, %vector.body220
  ...
  %7 = fmul reassoc nnan nsz arcp contract afn <8 x float> %i.aig, splat (float 2.000000e+00)
  %i.ain = tail call reassoc nnan nsz arcp contract afn <8 x float> @llvm.minnum.v8f32(<8 x float> %7, <8 x float> splat (float 1.000000e+00))
  %i.aio = fmul reassoc nnan nsz arcp contract afn <8 x float> %i.ain, splat (float 1.100000e-01)
...
bb.ee:                                            ; preds = %bb.ed
  ...
  %8 = fmul reassoc nnan nsz arcp contract afn float %i.aje, 2.000000e+00
  %i.ajk = tail call reassoc nnan nsz arcp contract afn float @llvm.minnum.f32(float %8, float 1.000000e+00)
  %i.ajl = fmul reassoc nnan nsz arcp contract afn float %i.ajk, 1.100000e-01
