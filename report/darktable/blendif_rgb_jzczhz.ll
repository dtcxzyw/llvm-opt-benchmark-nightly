...
bb.bw:                                            ; preds = %_blendif_compute_factor.exit.2.i107, %.lr.ph.i99
  ...
  %6 = fmul reassoc nsz arcp contract afn <2 x float> %i.xn, splat (float f0x3E038026)
  %i.xq = fmul reassoc nsz arcp contract afn float %i.xg, f0x3E038026
  %7 = fcmp reassoc nsz arcp contract afn ogt <2 x float> %i.xn, splat (float f0x3E53DCB1)
  %8 = fcmp reassoc nsz arcp contract afn ogt float %i.xg, f0x3E53DCB1
  %9 = fmul reassoc nsz arcp contract afn <2 x float> %i.xp, %i.xn
  %10 = fmul reassoc nsz arcp contract afn float %i.xo, %i.xg
  %i.xr = fadd reassoc nsz arcp contract afn <2 x float> %6, splat (float f0xBC911AA6)
  %11 = fadd reassoc nsz arcp contract afn float %i.xq, f0xBC911AA6
  %i.xs = select <2 x i1> %7, <2 x float> %9, <2 x float> %i.xr ; 4 uses
  %12 = select reassoc nsz arcp contract afn i1 %8, float %10, float %11 ; 3 uses
