...
bb.b:                                             ; preds = %bb.a
  ...
  %3 = fmul reassoc nsz arcp contract afn float %i.ag, f0x38D1B717
  %4 = tail call reassoc nsz arcp contract afn float @llvm.maxnum.f32(float %3, float 0.000000e+00)
  ...
  %5 = fmul reassoc nsz arcp contract afn <2 x float> %i.ar, splat (float f0x38D1B717)
  %6 = tail call reassoc nsz arcp contract afn <2 x float> @llvm.maxnum.v2f32(<2 x float> %5, <2 x float> zeroinitializer)
...
bb.c:                                             ; preds = %bb.a
  ...
  %7 = fmul reassoc nsz arcp contract afn float %i.co, f0x38D1B717
  %8 = tail call reassoc nsz arcp contract afn float @llvm.maxnum.f32(float %7, float 0.000000e+00)
  ...
  %9 = fmul reassoc nsz arcp contract afn <2 x float> %i.cz, splat (float f0x38D1B717)
  %10 = tail call reassoc nsz arcp contract afn <2 x float> @llvm.maxnum.v2f32(<2 x float> %9, <2 x float> zeroinitializer)
