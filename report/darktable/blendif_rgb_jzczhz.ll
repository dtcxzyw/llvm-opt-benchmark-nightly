...
bb.b:                                             ; preds = %bb.a
  ...
  %3 = fmul reassoc nsz arcp contract afn float %i.n, f0x3ED45F51
  %4 = fmul reassoc nsz arcp contract afn float %i.l, 1.464800e-02
  %5 = fadd reassoc nsz arcp contract afn float %3, %4
  %6 = fmul reassoc nsz arcp contract afn float %i.n, -2.015100e-01
  ...
  %7 = fmul reassoc nsz arcp contract afn float %i.l, 5.310080e-02
  %8 = fadd reassoc nsz arcp contract afn float %6, %7
  ...
  %10 = insertelement <2 x float> %9, float %5, i64 1
  %i.al = fadd reassoc nsz arcp contract afn <2 x float> %10, %i.v
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.bp = load float, ptr %i.bo, align 4, !tbaa !39 ; 4 uses
  %i.bq = fmul reassoc nsz arcp contract afn float %i.bp, f0x3E199998
  %i.br = fsub reassoc nsz arcp contract afn float %i.bn, %i.bq ; 3 uses
  ...
  %11 = fmul reassoc nsz arcp contract afn float %i.br, f0x3ED45F51
  %12 = fmul reassoc nsz arcp contract afn float %i.bp, 1.464800e-02
  %13 = fadd reassoc nsz arcp contract afn float %11, %12
  %14 = fmul reassoc nsz arcp contract afn float %i.br, -2.015100e-01
  ...
  %i.bz = fmul reassoc nsz arcp contract afn <2 x float> %i.by, <float f0x3F8F716D, float 5.799990e-01>
  %15 = fmul reassoc nsz arcp contract afn float %i.bp, 5.310080e-02
  ...
  %i.cp = fadd reassoc nsz arcp contract afn <2 x float> %18, %i.bz
