...
bb.bf:                                            ; preds = %_blendif_compute_factor.exit.2.i, %.lr.ph.i93
  ...
  %i.sg = fmul reassoc nnan nsz arcp contract afn <2 x float> %i.sf, splat (float f0x4196D000)
  %i.sh = fadd reassoc nsz arcp contract afn <2 x float> %i.sg, splat (float f0x3F560000)
  %i.si = fmul reassoc nnan nsz arcp contract afn <2 x float> %i.sf, splat (float 1.868750e+01)
  ...
  %i.so = fmul reassoc nnan nsz arcp contract afn float %i.sn, f0x4196D000
  %i.sp = fadd reassoc nsz arcp contract afn float %i.so, f0x3F560000
  %i.sq = fmul reassoc nnan nsz arcp contract afn float %i.sn, 1.868750e+01
...
bb.bw:                                            ; preds = %_blendif_compute_factor.exit.2.i107, %.lr.ph.i99
  ...
  %i.zn = fmul reassoc nnan nsz arcp contract afn <2 x float> %i.zm, splat (float f0x4196D000)
  %i.zo = fadd reassoc nsz arcp contract afn <2 x float> %i.zn, splat (float f0x3F560000)
  %i.zp = fmul reassoc nnan nsz arcp contract afn <2 x float> %i.zm, splat (float 1.868750e+01)
  ...
  %i.zv = fmul reassoc nnan nsz arcp contract afn float %i.zu, f0x4196D000
  %i.zw = fadd reassoc nsz arcp contract afn float %i.zv, f0x3F560000
  %i.zx = fmul reassoc nnan nsz arcp contract afn float %i.zu, 1.868750e+01
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.al = fmul reassoc nnan nsz arcp contract afn float %i.ak, f0x4196D000
  %i.am = fadd reassoc nsz arcp contract afn float %i.al, f0x3F560000
  %i.an = fmul reassoc nnan nsz arcp contract afn float %i.ak, 1.868750e+01
  ...
  %i.aw = fmul reassoc nnan nsz arcp contract afn <2 x float> %i.av, splat (float f0x4196D000)
  %i.ax = fadd reassoc nsz arcp contract afn <2 x float> %i.aw, splat (float f0x3F560000)
  %i.ay = fmul reassoc nnan nsz arcp contract afn <2 x float> %i.av, splat (float 1.868750e+01)
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.cw = fmul reassoc nnan nsz arcp contract afn float %i.cv, f0x4196D000
  %i.cx = fadd reassoc nsz arcp contract afn float %i.cw, f0x3F560000
  %i.cy = fmul reassoc nnan nsz arcp contract afn float %i.cv, 1.868750e+01
  ...
  %i.dh = fmul reassoc nnan nsz arcp contract afn <2 x float> %i.dg, splat (float f0x4196D000)
  %i.di = fadd reassoc nsz arcp contract afn <2 x float> %i.dh, splat (float f0x3F560000)
  %i.dj = fmul reassoc nnan nsz arcp contract afn <2 x float> %i.dg, splat (float 1.868750e+01)
