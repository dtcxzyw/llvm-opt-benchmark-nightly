...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.fp = icmp eq <8 x i32> %i.fk, zeroinitializer
  ...
  %i.fx = select <8 x i1> %i.fo, <8 x i1> %i.fp, <8 x i1> zeroinitializer ; 2 uses
  ...
  %predphi219 = select <8 x i1> %i.fx, <8 x i32> zeroinitializer, <8 x i32> %i.fv
...
vector.body254:                                   ; preds = %vector.body254, %vector.ph242
  ...
  %i.hy = icmp eq <8 x i32> %i.ht, zeroinitializer
  ...
  %i.ig = select <8 x i1> %i.hx, <8 x i1> %i.hy, <8 x i1> zeroinitializer ; 2 uses
  ...
  %predphi263 = select <8 x i1> %i.ig, <8 x i32> zeroinitializer, <8 x i32> %i.ie
