...
bb.a:
  ...
  %i.w = add nsw <2 x i32> %i.v, %i.t             ; 2 uses
  %i.x = shufflevector <2 x i32> %i.t, <2 x i32> %i.w, <2 x i32> <i32 0, i32 3>
  %i.y = sitofp <2 x i32> %i.x to <2 x float>     ; 4 uses
  %i.z = sitofp <2 x i32> %i.w to <2 x float>     ; 3 uses
  %i.aa = load <2 x float>, ptr %i.k, align 4, !tbaa !33 ; 4 uses
  ...
  %i.ad = fmul reassoc nsz arcp contract afn <2 x float> %i.ac, %i.o ; 4 uses
  %i.ae = insertelement <2 x float> poison, float %i.j, i64 0
  %i.af = insertelement <2 x float> %i.ae, float %i.m, i64 1 ; 3 uses
  %i.ag = insertelement <2 x float> %i.z, float %i.u, i64 1 ; 3 uses
  %i.ah = fmul reassoc nsz arcp contract afn <2 x float> %i.af, %i.ag ; 2 uses
  %i.ai = shufflevector <2 x float> %i.ag, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %i.aj = fmul reassoc nsz arcp contract afn <2 x float> %i.aa, %i.ai
  %i.ak = shufflevector <2 x float> %i.y, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %i.al = fmul reassoc nsz arcp contract afn <2 x float> %i.aa, %i.ak
  %i.am = fmul reassoc nsz arcp contract afn <2 x float> %i.af, %i.y ; 2 uses
  %i.an = shufflevector <2 x float> %i.am, <2 x float> %i.ah, <2 x i32> <i32 0, i32 3>
  %i.ao = shufflevector <2 x float> %i.ag, <2 x float> %i.y, <2 x i32> <i32 1, i32 2>
  %i.ap = fmul reassoc nsz arcp contract afn <2 x float> %i.aa, %i.ao
  %i.aq = fsub reassoc nsz arcp contract afn <2 x float> %i.an, %i.ap
  %i.ar = fadd reassoc nsz arcp contract afn <2 x float> %i.ad, %i.aq ; 2 uses
  %i.as = tail call reassoc nsz arcp contract afn <2 x float> @llvm.minnum.v2f32(<2 x float> %i.ar, <2 x float> splat (float f0x7F7FFFFF))
  %i.at = tail call reassoc nsz arcp contract afn <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.ar, <2 x float> splat (float f0xFF7FFFFF))
  %i.au = shufflevector <2 x float> %i.y, <2 x float> %i.z, <2 x i32> <i32 1, i32 2>
  %i.av = fmul reassoc nsz arcp contract afn <2 x float> %i.aa, %i.au
  %i.aw = fmul reassoc nsz arcp contract afn <2 x float> %i.af, %i.z
  %i.ax = fsub reassoc nsz arcp contract afn <2 x float> %i.ah, %i.aj
  %i.ay = fadd reassoc nsz arcp contract afn <2 x float> %i.ad, %i.ax ; 2 uses
  %i.az = tail call reassoc nsz arcp contract afn <2 x float> @llvm.minnum.v2f32(<2 x float> %i.as, <2 x float> %i.ay)
  %i.ba = tail call reassoc nsz arcp contract afn <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.at, <2 x float> %i.ay)
  %i.bb = fsub reassoc nsz arcp contract afn <2 x float> %i.am, %i.al
  %i.bc = fadd reassoc nsz arcp contract afn <2 x float> %i.ad, %i.bb ; 2 uses
  %i.bd = tail call reassoc nsz arcp contract afn <2 x float> @llvm.minnum.v2f32(<2 x float> %i.az, <2 x float> %i.bc)
  %i.be = tail call reassoc nsz arcp contract afn <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.ba, <2 x float> %i.bc)
  %i.bf = fsub reassoc nsz arcp contract afn <2 x float> %i.aw, %i.av
  %i.bg = fadd reassoc nsz arcp contract afn <2 x float> %i.ad, %i.bf ; 2 uses
  %i.bh = tail call reassoc nsz arcp contract afn <2 x float> @llvm.minnum.v2f32(<2 x float> %i.bd, <2 x float> %i.bg)
  %i.bi = tail call reassoc nsz arcp contract afn <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.be, <2 x float> %i.bg)
  %i.bj = tail call ptr @dt_interpolation_new(i32 noundef 2) #19
  %i.bk = getelementptr inbounds nuw i8, ptr %i.bj, i64 16
  %i.bl = load i64, ptr %i.bk, align 8, !tbaa !44
  %i.bm = uitofp reassoc nsz arcp contract afn i64 %i.bl to float
  %i.bn = fmul reassoc nsz arcp contract afn float %i.e, %i.bm
  %i.bo = load float, ptr %i.a, align 4, !tbaa !39
  %i.bp = load <2 x i32>, ptr %i.p, align 16, !tbaa !32
  ...
  %i.bt = fmul reassoc nsz arcp contract afn <2 x float> %i.bs, %i.bq ; 3 uses
  ...
  %i.bw = fsub reassoc nsz arcp contract afn <2 x float> %i.bh, %i.bv
  %i.bx = tail call reassoc nsz arcp contract afn <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.bw, <2 x float> zeroinitializer)
  %i.by = fptosi <2 x float> %i.bx to <2 x i32>   ; 3 uses
  %i.bz = sitofp <2 x i32> %i.by to <2 x float>   ; 2 uses
  %i.ca = fsub reassoc nsz arcp contract afn <2 x float> %i.bt, %i.bz
  %i.cb = fadd reassoc nsz arcp contract afn <2 x float> %i.bv, %i.bi
  %i.cc = fsub reassoc nsz arcp contract afn <2 x float> %i.cb, %i.bz
  %i.cd = tail call reassoc nsz arcp contract afn <2 x float> @llvm.minnum.v2f32(<2 x float> %i.ca, <2 x float> %i.cc)
  %i.ce = fptosi <2 x float> %i.cd to <2 x i32>   ; 2 uses
  %i.cf = tail call reassoc nsz arcp contract afn <2 x float> @llvm.floor.v2f32(<2 x float> %i.bt)
  %i.cg = fptosi <2 x float> %i.cf to <2 x i32>   ; 2 uses
  %i.ch = icmp sgt <2 x i32> %i.by, %i.cg
  ...
  %i.cp = icmp slt <2 x i32> %i.co, %i.ce
  %i.cq = tail call <2 x i32> @llvm.smax.v2i32(<2 x i32> %i.ce, <2 x i32> splat (i32 1))
  %i.cr = select <2 x i1> %i.cp, <2 x i32> %i.co, <2 x i32> %i.cq
  store <2 x i32> %i.cr, ptr %i.r, align 4, !tbaa !32
  ret void
}
...
bb.b:                                             ; preds = %bb.a
  ...
  store i32 0, ptr %i.n, align 16, !tbaa !59
  br label %bb.c
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 16, !tbaa !71  ; 3 uses
  ...
  store i32 %i.h, ptr %i.i, align 4, !tbaa !81
  ret void
}
...
bb.a:
  %i.a = load i32, ptr @introspection, align 8, !tbaa !84
...
!63 = !{!"p1 _ZTS25dt_develop_blend_params_t", !11, i64 0}
!64 = !{!"", !25, i64 0, !25, i64 8}
!65 = !{!"", !12, i64 0, !8, i64 8}
!66 = !{!"", !64, i64 0, !65, i64 16}
!67 = !{!"p1 _ZTS10_GtkWidget", !11, i64 0}
!68 = !{!"p1 _ZTS7_GSList", !11, i64 0}
!69 = !{!"p1 _ZTS18dt_iop_module_so_t", !11, i64 0}
!70 = !{!"dt_iop_module_t", !8, i64 0, !11, i64 8, !11, i64 16, !11, i64 24, !11, i64 32, !11, i64 40, !11, i64 48, !11, i64 56, !11, i64 64, !11, i64 72, !11, i64 80, !11, i64 88, !11, i64 96, !11, i64 104, !11, i64 112, !11, i64 120, !11, i64 128, !11, i64 136, !11, i64 144, !11, i64 152, !11, i64 160, !11, i64 168, !11, i64 176, !11, i64 184, !11, i64 192, !11, i64 200, !11, i64 208, !11, i64 216, !11, i64 224, !11, i64 232, !11, i64 240, !11, i64 248, !11, i64 256, !11, i64 264, !11, i64 272, !11, i64 280, !11, i64 288, !11, i64 296, !11, i64 304, !11, i64 312, !11, i64 320, !11, i64 328, !11, i64 336, !11, i64 344, !11, i64 352, !11, i64 360, !11, i64 368, !11, i64 376, !11, i64 384, !11, i64 392, !11, i64 400, !11, i64 408, !11, i64 416, !11, i64 424, !11, i64 432, !11, i64 440, !60, i64 448, !7, i64 456, !8, i64 476, !8, i64 480, !8, i64 484, !8, i64 488, !8, i64 492, !8, i64 496, !8, i64 500, !8, i64 504, !7, i64 512, !7, i64 528, !7, i64 544, !7, i64 560, !7, i64 576, !7, i64 592, !16, i64 608, !18, i64 616, !7, i64 640, !8, i64 656, !8, i64 660, !61, i64 664, !8, i64 672, !8, i64 676, !11, i64 680, !11, i64 688, !8, i64 696, !11, i64 704, !62, i64 712, !11, i64 752, !11, i64 760, !63, i64 768, !63, i64 776, !11, i64 784, !66, i64 792, !67, i64 824, !67, i64 832, !67, i64 840, !67, i64 848, !67, i64 856, !67, i64 864, !67, i64 872, !8, i64 880, !67, i64 888, !67, i64 896, !67, i64 904, !68, i64 912, !68, i64 920, !67, i64 928, !67, i64 936, !8, i64 944, !69, i64 952, !8, i64 960, !7, i64 964, !8, i64 1092, !67, i64 1096, !11, i64 1104, !8, i64 1112}
!71 = !{!70, !11, i64 688}
!72 = !{!70, !61, i64 664}
!73 = !{!"dt_image_raw_parameters_t", !8, i64 0, !8, i64 3}
!74 = !{!"double", !7, i64 0}
!75 = !{!"dt_image_geoloc_t", !74, i64 0, !74, i64 8, !74, i64 16}
!76 = !{!"_color_harmony_t", !8, i64 0, !8, i64 4, !8, i64 8, !8, i64 12, !7, i64 16}
!77 = !{!"p1 _ZTS6_GList", !11, i64 0}
!78 = !{!"p1 _ZTS16dt_cache_entry_t", !11, i64 0}
!79 = !{!"dt_image_t", !8, i64 0, !8, i64 4, !19, i64 8, !19, i64 12, !19, i64 16, !19, i64 20, !19, i64 24, !19, i64 28, !19, i64 32, !19, i64 36, !8, i64 40, !7, i64 44, !7, i64 108, !7, i64 172, !7, i64 300, !7, i64 364, !7, i64 428, !7, i64 492, !17, i64 560, !8, i64 568, !7, i64 572, !7, i64 800, !7, i64 864, !7, i64 928, !7, i64 992, !8, i64 1120, !7, i64 1124, !8, i64 1380, !8, i64 1384, !8, i64 1388, !8, i64 1392, !8, i64 1396, !8, i64 1400, !8, i64 1404, !8, i64 1408, !8, i64 1412, !8, i64 1416, !19, i64 1420, !8, i64 1424, !8, i64 1428, !8, i64 1432, !8, i64 1436, !8, i64 1440, !8, i64 1444, !17, i64 1448, !17, i64 1456, !17, i64 1464, !17, i64 1472, !8, i64 1480, !24, i64 1488, !7, i64 1616, !42, i64 1656, !8, i64 1664, !8, i64 1668, !73, i64 1672, !75, i64 1680, !76, i64 1704, !21, i64 1736, !7, i64 1738, !8, i64 1748, !8, i64 1752, !19, i64 1756, !19, i64 1760, !7, i64 1776, !7, i64 1792, !7, i64 1840, !77, i64 1856, !78, i64 1864, !8, i64 1872, !8, i64 1876}
!80 = !{!79, !8, i64 1752}
!81 = !{!70, !8, i64 676}
!82 = !{!"p1 _ZTS24dt_introspection_field_t", !11, i64 0}
!83 = !{!"dt_introspection_t", !8, i64 0, !8, i64 4, !42, i64 8, !17, i64 16, !82, i64 24, !17, i64 32, !17, i64 40}
!84 = !{!83, !8, i64 0}
!85 = !{!7, !7, i64 0}
end_hunk_0
