...
._crit_edge4128:                                  ; preds = %bb.ek, %bb.ej
  ...
  br i1 %i.irr, label %bb.ej, label %.preheader3913, !llvm.loop !308
...
bb.ek:                                            ; preds = %.lr.ph4127, %bb.ek
  ...
  %i.irx = load float, ptr %i.irw, align 4, !tbaa !322 ; 5 uses
  ...
  %i.isc = load float, ptr %i.isb, align 4, !tbaa !322 ; 4 uses
  ...
  %i.ish = load float, ptr %i.isg, align 4, !tbaa !322 ; 3 uses
  ...
  %i.ism = load float, ptr %i.isl, align 4, !tbaa !322 ; 3 uses
  ...
  %i.isr = load float, ptr %i.isq, align 4, !tbaa !322 ; 2 uses
  ...
  %i.isw = load float, ptr %i.isv, align 4, !tbaa !322 ; 3 uses
  ...
  %i.itb = load float, ptr %i.ita, align 4, !tbaa !322 ; 3 uses
  ...
  %i.itg = load float, ptr %i.itf, align 4, !tbaa !322 ; 2 uses
  ...
  %i.itl = load float, ptr %i.itk, align 4, !tbaa !322
  ...
  %i.itq = load float, ptr %i.itp, align 4, !tbaa !322
  ...
  %i.itv = load float, ptr %i.itu, align 4, !tbaa !322
  ...
  %i.iua = load float, ptr %i.itz, align 4, !tbaa !322
  ...
  %i.iuf = load float, ptr %i.iue, align 4, !tbaa !322
  ...
  %i.iuk = load float, ptr %i.iuj, align 4, !tbaa !322
  ...
  store float %i.iwm, ptr %i.iwo, align 4, !tbaa !322
  ...
  br i1 %i.iwq, label %bb.ek, label %._crit_edge4128, !llvm.loop !309
...
bb.en:                                            ; preds = %bb.em
  ...
  %i.iye = load float, ptr %i.iyd, align 4, !tbaa !322 ; 2 uses
  ...
  %i.iyj = load float, ptr %i.iyi, align 4, !tbaa !322 ; 2 uses
  ...
  %i.iyp = load float, ptr %i.iyo, align 8, !tbaa !322
  %i.iyq = getelementptr inbounds [4 x i8], ptr %i.r, i64 %i.ixu
  %i.iyr = load float, ptr %i.iyq, align 4, !tbaa !322
  ...
  %i.iyv = load float, ptr %i.iyu, align 4, !tbaa !322
  ...
  %i.iza = load float, ptr %i.iyz, align 4, !tbaa !322
  ...
  %i.ize = load float, ptr %i.izd, align 4, !tbaa !322
...
_ZL9_clampnanfff.exit:                            ; preds = %bb.eo, %bb.ep, %bb.eq
  ...
  store float %.0.i, ptr %i.izq, align 4, !tbaa !322
  %i.izr = load float, ptr %i.iyo, align 8, !tbaa !322
  %i.izs = load float, ptr %i.ixv, align 4, !tbaa !322
  %i.izt = getelementptr inbounds [4 x i8], ptr %i.am, i64 %i.ixu
  %i.izu = load float, ptr %i.izt, align 4, !tbaa !322
  %i.izv = fmul reassoc nsz arcp contract afn float %i.izu, %i.izs
  %i.izw = load float, ptr %i.ixy, align 4, !tbaa !322
...
_ZL9_clampnanfff.exit3696:                        ; preds = %bb.er, %bb.es, %bb.et
  ...
  store float %.0.i3695, ptr %i.jav, align 4, !tbaa !322
  br label %bb.eu
...
_ZL9_clampnanfff.exit3699:                        ; preds = %bb.ew, %bb.ex, %bb.ey
  ...
  store float %.0.i3698, ptr %i.jbm, align 4, !tbaa !322
  %i.jbn = load float, ptr %i.jaz, align 4, !tbaa !322
  %i.jbo = getelementptr inbounds nuw [4 x i8], ptr %i.am, i64 %i.jbb
  %i.jbp = load float, ptr %i.jbo, align 4, !tbaa !322
...
_ZL9_clampnanfff.exit3702:                        ; preds = %bb.ez, %bb.fa, %bb.fb
  ...
  store float %.0.i3701, ptr %i.jbx, align 4, !tbaa !322
  br label %bb.fc
...
bb.fc:                                            ; preds = %bb.eu, %_ZL9_clampnanfff.exit3702
  ...
  br i1 %i.jbz, label %bb.em, label %._crit_edge4134.loopexit, !llvm.loop !310
