...
bb.g:                                             ; preds = %bb.f
  %i.z = load ptr, ptr %i.m, align 8, !tbaa !83   ; 2 uses
  %i.aa = load ptr, ptr %i.z, align 8, !tbaa !84
  %i.ab = getelementptr inbounds nuw i8, ptr %i.aa, i64 56
  %i.ac = load ptr, ptr %i.ab, align 8
  %i.ad = tail call noundef i32 %i.ac(ptr noundef nonnull align 8 dereferenceable(8) %i.z), !call_target !86
  %i.ae = icmp ne i32 %i.ad, 0                    ; 2 uses
  %i.af = zext i1 %i.ae to i32
  %i.ag = load ptr, ptr %i.h, align 8, !tbaa !11  ; 3 uses
  %i.ah = getelementptr inbounds nuw i8, ptr %i.ag, i64 8
  store i32 %i.af, ptr %i.ah, align 8, !tbaa !74
  br i1 %i.ae, label %.critedge.loopexit, label %bb.h

.critedge24:                                      ; preds = %bb.f
  %i.ai = load ptr, ptr %i.h, align 8, !tbaa !11  ; 2 uses
  %i.aj = getelementptr inbounds nuw i8, ptr %i.ai, i64 8
  store i32 0, ptr %i.aj, align 8, !tbaa !74
  br label %bb.h

bb.h:                                             ; preds = %.critedge24, %bb.g
  %i.ak = phi ptr [ %i.ai, %.critedge24 ], [ %i.ag, %bb.g ] ; 4 uses
  %i.al = load i32, ptr %i.ak, align 8, !tbaa !82
  %i.am = shl i32 %i.al, 8
  %i.an = and i32 %i.v, 255
  %i.ao = or disjoint i32 %i.am, %i.an
  store i32 %i.ao, ptr %i.ak, align 8, !tbaa !82
  ...
  br i1 %i.as, label %.lr.ph37, label %.critedge.loopexit, !llvm.loop !94
...
.critedge.loopexit:                               ; preds = %bb.g, %bb.h, %.lr.ph, %..critedge.loopexit_crit_edge
  ...
  %.pre29 = load i32, ptr %.phi.trans.insert, align 4, !tbaa !81
  br label %.critedge
...
bb.i:                                             ; preds = %.critedge
  %i.ax = load i32, ptr %i.au, align 8, !tbaa !82
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.bf = load i16, ptr %i.be, align 2, !tbaa !96 ; 2 uses
...
.critedge:                                        ; preds = %bb.p, %bb.o, %bb.n, %bb.m, %bb.l, %bb.k, %bb.j, %bb.i, %bb.h, %bb.g, %bb.f, %bb.e, %bb.d, %bb.c, %bb.b, %bb.a
  ...
  %.030.lcssa = phi i32 [ 8, %bb.i ], [ 16, %bb.a ], [ 15, %bb.b ], [ %spec.select52, %bb.p ], [ 14, %bb.c ], [ 6, %bb.k ], [ 13, %bb.d ], [ 2, %bb.o ], [ 12, %bb.e ], [ 7, %bb.j ], [ 11, %bb.f ], [ 3, %bb.n ], [ 10, %bb.g ], [ 5, %bb.l ], [ 9, %bb.h ], [ 4, %bb.m ] ; 4 uses
  %i.ai = shl nuw nsw i32 1, %.030.lcssa          ; 6 uses
  %i.aj = add nuw nsw i32 %i.ai, 1
  %i.ak = zext nneg i32 %i.aj to i64
  %i.al = tail call noundef ptr @_ZN6LibRaw6callocEmm(ptr noundef nonnull align 8 dereferenceable(768512) %0, i64 noundef %i.ak, i64 noundef 2) ; 7 uses
  %i.am = trunc nuw nsw i32 %.030.lcssa to i16
  store i16 %i.am, ptr %i.al, align 2, !tbaa !96
...
.preheader34:                                     ; preds = %.preheader34.preheader, %._crit_edge40
  %indvars.iv.a = phi i64 [ 1, %.preheader34.preheader ], [ %indvars.iv.next, %._crit_edge40 ] ; 4 uses
  ...
  %i.ap = load i8, ptr %i.ao, align 1, !tbaa !98
...
.preheader.us.preheader:                          ; preds = %.preheader34
  %2 = trunc i64 %indvars.iv.a to i32
  %3 = sub i32 %.030.lcssa, %2                    ; 3 uses
  %4 = shl nuw nsw i32 1, %3                      ; 2 uses
  %indvars.iv.tr = trunc i64 %indvars.iv.a to i16
  %5 = shl i16 %indvars.iv.tr, 8                  ; 5 uses
  %6 = icmp ult i32 %3, 2
  %unroll_iter = and i32 %4, 2147483644
  %lcmp.mod54 = icmp ult i32 %3, 2
  br label %.preheader.us

.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge.us
  %.02739.us = phi i32 [ %i.bz, %._crit_edge.us ], [ 0, %.preheader.us.preheader ]
  %.138.us = phi i32 [ %.3.us.lcssa, %._crit_edge.us ], [ %.02844, %.preheader.us.preheader ] ; 2 uses
  br i1 %6, label %.epil.preheader, label %.preheader.us.new

.preheader.us.new:                                ; preds = %.preheader.us, %bb.x
  %.236.us = phi i32 [ %.3.us.3, %bb.x ], [ %.138.us, %.preheader.us ] ; 4 uses
  %niter = phi i32 [ %niter.next.3, %bb.x ], [ 0, %.preheader.us ]
  %.not33.us = icmp sgt i32 %.236.us, %i.ai
  br i1 %.not33.us, label %bb.r, label %bb.q

bb.q:                                             ; preds = %.preheader.us.new
  %i.aq = load ptr, ptr %1, align 8, !tbaa !97
  %i.ar = load i8, ptr %i.aq, align 1, !tbaa !98
  %i.as = zext i8 %i.ar to i16
  %i.at = or disjoint i16 %5, %i.as
  %i.au = add nsw i32 %.236.us, 1
  %i.av = sext i32 %.236.us to i64
  %i.aw = getelementptr inbounds [2 x i8], ptr %i.al, i64 %i.av
  store i16 %i.at, ptr %i.aw, align 2, !tbaa !96
  br label %bb.r

bb.r:                                             ; preds = %bb.q, %.preheader.us.new
  %.3.us = phi i32 [ %i.au, %bb.q ], [ %.236.us, %.preheader.us.new ] ; 4 uses
  %.not33.us.1 = icmp sgt i32 %.3.us, %i.ai
  br i1 %.not33.us.1, label %bb.t, label %bb.s

bb.s:                                             ; preds = %bb.r
  %i.ax = load ptr, ptr %1, align 8, !tbaa !97
  %i.ay = load i8, ptr %i.ax, align 1, !tbaa !98
  %i.az = zext i8 %i.ay to i16
  %i.ba = or disjoint i16 %5, %i.az
  %i.bb = add nsw i32 %.3.us, 1
  %i.bc = sext i32 %.3.us to i64
  %i.bd = getelementptr inbounds [2 x i8], ptr %i.al, i64 %i.bc
  store i16 %i.ba, ptr %i.bd, align 2, !tbaa !96
  br label %bb.t

bb.t:                                             ; preds = %bb.s, %bb.r
  %.3.us.1 = phi i32 [ %i.bb, %bb.s ], [ %.3.us, %bb.r ] ; 4 uses
  %.not33.us.2 = icmp sgt i32 %.3.us.1, %i.ai
  br i1 %.not33.us.2, label %bb.v, label %bb.u

bb.u:                                             ; preds = %bb.t
  %i.be = load ptr, ptr %1, align 8, !tbaa !97
  %i.bf = load i8, ptr %i.be, align 1, !tbaa !98
  %i.bg = zext i8 %i.bf to i16
  %i.bh = or disjoint i16 %5, %i.bg
  %i.bi = add nsw i32 %.3.us.1, 1
  %i.bj = sext i32 %.3.us.1 to i64
  %i.bk = getelementptr inbounds [2 x i8], ptr %i.al, i64 %i.bj
  store i16 %i.bh, ptr %i.bk, align 2, !tbaa !96
  br label %bb.v

bb.v:                                             ; preds = %bb.u, %bb.t
  %.3.us.2 = phi i32 [ %i.bi, %bb.u ], [ %.3.us.1, %bb.t ] ; 4 uses
  %.not33.us.3 = icmp sgt i32 %.3.us.2, %i.ai
  br i1 %.not33.us.3, label %bb.x, label %bb.w

bb.w:                                             ; preds = %bb.v
  %i.bl = load ptr, ptr %1, align 8, !tbaa !97
  %i.bm = load i8, ptr %i.bl, align 1, !tbaa !98
  %i.bn = zext i8 %i.bm to i16
  %i.bo = or disjoint i16 %5, %i.bn
  %i.bp = add nsw i32 %.3.us.2, 1
  %i.bq = sext i32 %.3.us.2 to i64
  %i.br = getelementptr inbounds [2 x i8], ptr %i.al, i64 %i.bq
  store i16 %i.bo, ptr %i.br, align 2, !tbaa !96
  br label %bb.x

bb.x:                                             ; preds = %bb.w, %bb.v
  %.3.us.3 = phi i32 [ %i.bp, %bb.w ], [ %.3.us.2, %bb.v ] ; 2 uses
  %niter.next.3 = add i32 %niter, 4               ; 2 uses
  %niter.ncmp.3 = icmp eq i32 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %._crit_edge.us, label %.preheader.us.new, !llvm.loop !99

.epil.preheader:                                  ; preds = %.preheader.us
  tail call void @llvm.assume(i1 %lcmp.mod54)
  br label %bb.y

bb.y:                                             ; preds = %bb.aa, %.epil.preheader
  %.236.us.epil = phi i32 [ %.138.us, %.epil.preheader ], [ %.3.us.epil, %bb.aa ] ; 4 uses
...
bb.z:                                             ; preds = %bb.y
  %i.bs = load ptr, ptr %1, align 8, !tbaa !97
  %i.bt = load i8, ptr %i.bs, align 1, !tbaa !98
  %i.bu = zext i8 %i.bt to i16
  %i.bv = or disjoint i16 %5, %i.bu
  %i.bw = add nsw i32 %.236.us.epil, 1
  %i.bx = sext i32 %.236.us.epil to i64
  %i.by = getelementptr inbounds [2 x i8], ptr %i.al, i64 %i.bx
  store i16 %i.bv, ptr %i.by, align 2, !tbaa !96
  br label %bb.aa

bb.aa:                                            ; preds = %bb.z, %bb.y
  %.3.us.epil = phi i32 [ %i.bw, %bb.z ], [ %.236.us.epil, %bb.y ] ; 2 uses
...
._crit_edge.us:                                   ; preds = %bb.aa, %bb.x
  %.3.us.lcssa = phi i32 [ %.3.us.3, %bb.x ], [ %.3.us.epil, %bb.aa ] ; 2 uses
  %i.bz = add nuw nsw i32 %.02739.us, 1           ; 2 uses
  %i.ca = load ptr, ptr %1, align 8, !tbaa !97
  %i.cb = getelementptr inbounds nuw i8, ptr %i.ca, i64 1
  store ptr %i.cb, ptr %1, align 8, !tbaa !97
  %i.cc = load i8, ptr %i.ao, align 1, !tbaa !98
  %i.cd = zext i8 %i.cc to i32
  %i.ce = icmp samesign ult i32 %i.bz, %i.cd
  br i1 %i.ce, label %.preheader.us, label %._crit_edge40, !llvm.loop !102
...
bb.a:
  ...
  store ptr %i.j, ptr %i.c, align 8, !tbaa !97
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b)
  store ptr %i.l, ptr %i.b, align 8, !tbaa !97
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #15
  %i.n = load ptr, ptr %i.f, align 8, !tbaa !83   ; 2 uses
  %i.o = load ptr, ptr %i.n, align 8, !tbaa !84
  %i.p = getelementptr inbounds nuw i8, ptr %i.o, i64 32
  %i.q = load ptr, ptr %i.p, align 8
  %i.r = tail call noundef i32 %i.q(ptr noundef nonnull align 8 dereferenceable(8) %i.n, i64 noundef 0, i32 noundef 0), !call_target !105, !inline_history !120 ; 0 uses
  %i.s = load ptr, ptr %i.f, align 8, !tbaa !83   ; 2 uses
  %i.t = load ptr, ptr %i.s, align 8, !tbaa !84
  %i.u = getelementptr inbounds nuw i8, ptr %i.t, i64 24
  %i.v = load ptr, ptr %i.u, align 8
  %i.w = call noundef i32 %i.v(ptr noundef nonnull align 8 dereferenceable(8) %i.s, ptr noundef nonnull %i.a, i64 noundef 1, i64 noundef 16384), !call_target !111, !inline_history !120 ; 0 uses
  br label %.outer
...
bb.e:                                             ; preds = %_ZN6LibRaw17canon_has_lowbitsEv.exit.thread206, %_ZN6LibRaw17canon_has_lowbitsEv.exit
  ...
  store i32 1023, ptr %i.ad, align 8, !tbaa !121
  br label %bb.f
...
bb.f:                                             ; preds = %_ZN6LibRaw17canon_has_lowbitsEv.exit.thread, %bb.e, %_ZN6LibRaw17canon_has_lowbitsEv.exit
  ...
  %i.ae = load ptr, ptr %i.f, align 8, !tbaa !83  ; 2 uses
end_hunk_0
