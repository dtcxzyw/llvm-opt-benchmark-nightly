...
.preheader77:                                     ; preds = %.preheader79.preheader, %.preheader77
  ...
  %i.dp = getelementptr inbounds nuw i8, ptr %i.dn, i64 4 ; 2 uses
  %i.dq = getelementptr inbounds nuw i8, ptr %i.dn, i64 8 ; 2 uses
  %i.dr = getelementptr inbounds nuw i8, ptr %i.dn, i64 12 ; 2 uses
  %i.ds = getelementptr inbounds nuw i8, ptr %i.dn, i64 16 ; 2 uses
  %i.dt = getelementptr inbounds nuw i8, ptr %i.dn, i64 20 ; 2 uses
  %i.du = getelementptr inbounds nuw i8, ptr %i.dn, i64 24 ; 2 uses
  %i.dv = getelementptr inbounds nuw i8, ptr %i.dn, i64 28 ; 2 uses
  %i.dw = load float, ptr %i.dn, align 16, !tbaa !141 ; 2 uses
  %i.dx = load <8 x float>, ptr %i.dn, align 16, !tbaa !141 ; 8 uses
  %2 = load float, ptr %i.dp, align 4, !tbaa !141
  %3 = load float, ptr %i.dq, align 8, !tbaa !141
  %4 = load float, ptr %i.dr, align 4, !tbaa !141
  %5 = load float, ptr %i.ds, align 16, !tbaa !141
  %6 = load float, ptr %i.dt, align 4, !tbaa !141
  %7 = load float, ptr %i.du, align 8, !tbaa !141
  %8 = load float, ptr %i.dv, align 4, !tbaa !141
  ...
  %i.ed = load float, ptr %i.dp, align 4, !tbaa !141
  %i.ee = load float, ptr %i.dq, align 8, !tbaa !141
  %i.ef = load float, ptr %i.dr, align 4, !tbaa !141
  %i.eg = load float, ptr %i.ds, align 16, !tbaa !141
  %i.eh = load float, ptr %i.dt, align 4, !tbaa !141
  ...
  %i.el = insertelement <8 x float> %i.ek, float %2, i64 3
  ...
  %i.er = insertelement <8 x float> %i.eq, float %3, i64 3
  ...
  %i.ex = insertelement <8 x float> %i.ew, float %4, i64 3
  ...
  %i.fd = insertelement <8 x float> %i.fc, float %5, i64 3
  ...
  %i.fj = insertelement <8 x float> %i.fi, float %6, i64 3
  ...
  %i.fo = load float, ptr %i.du, align 8, !tbaa !141
  ...
  %i.fq = insertelement <8 x float> %i.fp, float %7, i64 4
  ...
  %i.fv = load float, ptr %i.dv, align 4, !tbaa !141
  ...
  %i.fx = insertelement <8 x float> %i.fw, float %8, i64 4
