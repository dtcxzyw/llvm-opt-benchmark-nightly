...
begin_hunk_0_@_ZN6LibRaw11ljpeg_startEP5jheadi:bb.a
  %i.ht = invoke noundef ptr @_ZN6LibRaw6callocEmm(ptr noundef nonnull align 8 dereferenceable(768512) %0, i64 noundef %i.hs, i64 noundef 16)
          to label %bb.av unwind label %_ZNSt6vectorIhSaIhEED2Ev.exit.loopexit.split-lp.loopexit.split-lp

bb.av:                                            ; preds = %.loopexit
  %i.hu = getelementptr inbounds nuw i8, ptr %1, i64 632
  store ptr %i.ht, ptr %i.hu, align 8, !tbaa !154
  %i.hv = getelementptr inbounds nuw i8, ptr %0, i64 381848
  store i32 1, ptr %i.hv, align 8, !tbaa !93
  br label %_ZNSt6vectorIhSaIhEED2Ev.exit124

_ZNSt6vectorIhSaIhEED2Ev.exit124:                 ; preds = %bb.k, %bb.i, %bb.h, %bb.f, %bb.e, %bb.z, %bb.aa, %bb.w, %bb.x, %bb.y, %bb.b, %bb.c, %bb.av
  %.095 = phi i32 [ 1, %bb.av ], [ 0, %bb.b ], [ 0, %bb.c ], [ %.mux, %bb.z ], [ 0, %bb.y ], [ 0, %bb.x ], [ 0, %bb.aa ], [ 0, %bb.w ], [ 0, %bb.e ], [ 0, %bb.f ], [ 0, %bb.h ], [ 0, %bb.i ], [ 0, %bb.k ]
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.e = load i32, ptr %i.d, align 4, !tbaa !135  ; 2 uses
...
.preheader122:                                    ; preds = %bb.d
  ...
  %i.l = load i32, ptr %i.k, align 4, !tbaa !140
  ...
  store <4 x i32> %i.q, ptr %i.o, align 4, !tbaa !126
  %i.r = getelementptr inbounds nuw i8, ptr %2, i64 48
  store i32 %i.n, ptr %i.r, align 4, !tbaa !126
  %i.s = getelementptr inbounds nuw i8, ptr %2, i64 52
  store i32 %i.n, ptr %i.s, align 4, !tbaa !126
...
bb.e:                                             ; preds = %.preheader122
  ...
  %i.y = tail call noundef i32 %i.x(ptr noundef nonnull align 8 dereferenceable(8) %i.u, i64 noundef -2, i32 noundef 1), !call_target !105 ; 0 uses
  br label %bb.f
...
bb.f:                                             ; preds = %bb.f, %bb.e
  ...
  %i.ab = load ptr, ptr %i.t, align 8, !tbaa !83  ; 2 uses
  %i.ac = load ptr, ptr %i.ab, align 8, !tbaa !84
  %i.ad = getelementptr inbounds nuw i8, ptr %i.ac, i64 56
  %i.ae = load ptr, ptr %i.ad, align 8
  %i.af = tail call noundef i32 %i.ae(ptr noundef nonnull align 8 dereferenceable(8) %i.ab), !call_target !86 ; 2 uses
  ...
  br i1 %i.ak, label %bb.f, label %.loopexit, !llvm.loop !157
...
.loopexit:                                        ; preds = %bb.f, %.preheader122
  ...
  store i32 0, ptr %i.ao, align 4, !tbaa !81
...
.preheader121:                                    ; preds = %.loopexit, %bb.d, %bb.c
  ...
  %i.aq = load ptr, ptr %i.ap, align 8, !tbaa !154 ; 3 uses
  %i.ar = getelementptr inbounds nuw i8, ptr %2, i64 12 ; 2 uses
  %i.as = load i32, ptr %i.ar, align 4, !tbaa !147 ; 3 uses
  %i.at = getelementptr inbounds nuw i8, ptr %2, i64 16 ; 7 uses
  %i.au = load i32, ptr %i.at, align 8, !tbaa !141 ; 3 uses
...
bb.j:                                             ; preds = %bb.i
  %i.by = load ptr, ptr %i.az, align 8, !tbaa !11 ; 4 uses
  %i.bz = getelementptr inbounds nuw i8, ptr %i.by, i64 4
  %i.ca = load i32, ptr %i.bz, align 4, !tbaa !81 ; 3 uses
...
.preheader.i86:                                   ; preds = %bb.j
  ...
  %i.cd = load i32, ptr %i.cc, align 8, !tbaa !74
...
.lr.ph:                                           ; preds = %.lr.ph.i92, %bb.m
  %i.cf = load ptr, ptr %i.ba, align 8, !tbaa !83 ; 2 uses
  %i.cg = load ptr, ptr %i.cf, align 8, !tbaa !84
  %i.ch = getelementptr inbounds nuw i8, ptr %i.cg, i64 56
  %i.ci = load ptr, ptr %i.ch, align 8
  %i.cj = tail call noundef i32 %i.ci(ptr noundef nonnull align 8 dereferenceable(8) %i.cf), !call_target !86, !inline_history !125 ; 3 uses
...
..critedge.loopexit_crit_edge.i100:               ; preds = %.lr.ph
  %.pre.pre.i101 = load ptr, ptr %i.az, align 8, !tbaa !11
  br label %.critedge.loopexit.i93

bb.k:                                             ; preds = %.lr.ph
  %i.ck = load i32, ptr %i.bb, align 8, !tbaa !93
...
bb.l:                                             ; preds = %bb.k
  %i.cn = load ptr, ptr %i.ba, align 8, !tbaa !83 ; 2 uses
  %i.co = load ptr, ptr %i.cn, align 8, !tbaa !84
  %i.cp = getelementptr inbounds nuw i8, ptr %i.co, i64 56
  %i.cq = load ptr, ptr %i.cp, align 8
  %i.cr = tail call noundef i32 %i.cq(ptr noundef nonnull align 8 dereferenceable(8) %i.cn), !call_target !86, !inline_history !125
  %i.cs = icmp ne i32 %i.cr, 0                    ; 2 uses
  %i.ct = zext i1 %i.cs to i32
  %i.cu = load ptr, ptr %i.az, align 8, !tbaa !11 ; 3 uses
  %i.cv = getelementptr inbounds nuw i8, ptr %i.cu, i64 8
  store i32 %i.ct, ptr %i.cv, align 8, !tbaa !74
  br i1 %i.cs, label %.critedge.loopexit.i93, label %bb.m

.critedge24.i99:                                  ; preds = %bb.k
  %i.cw = load ptr, ptr %i.az, align 8, !tbaa !11 ; 2 uses
...
bb.m:                                             ; preds = %.critedge24.i99, %bb.l
  ...
  %i.cz = load i32, ptr %i.cy, align 8, !tbaa !82
  %i.da = shl i32 %i.cz, 8
  %i.db = and i32 %i.cj, 255
  %i.dc = or disjoint i32 %i.da, %i.db
  store i32 %i.dc, ptr %i.cy, align 8, !tbaa !82
  %i.dd = getelementptr inbounds nuw i8, ptr %i.cy, i64 4 ; 2 uses
  %i.de = load i32, ptr %i.dd, align 4, !tbaa !81
  %i.df = add nsw i32 %i.de, 8                    ; 2 uses
  store i32 %i.df, ptr %i.dd, align 4, !tbaa !81
  %i.dg = icmp slt i32 %i.df, %i.bv
  br i1 %i.dg, label %.lr.ph, label %.critedge.loopexit.i93, !llvm.loop !94
...
.critedge.loopexit.i93:                           ; preds = %bb.m, %bb.l, %.lr.ph.i92, %..critedge.loopexit_crit_edge.i100
  ...
  %.pre29.i96 = load i32, ptr %.phi.trans.insert.i95, align 4, !tbaa !81
...
bb.n:                                             ; preds = %.critedge.i88
  %i.dl = load i32, ptr %i.di, align 8, !tbaa !82
...
bb.o:                                             ; preds = %bb.n, %.critedge.i88
  ...
  %i.dt = load i16, ptr %i.ds, align 2, !tbaa !96 ; 2 uses
  ...
  store i32 %.sink.i90, ptr %i.dj, align 4, !tbaa !81
...
bb.q:                                             ; preds = %_ZN6LibRaw10getbithuffEiPt.exit102
  %i.ea = load i32, ptr %i.bc, align 4, !tbaa !142
...
.split.i.thread.thread114:                        ; preds = %.split.i, %bb.q
  ...
  %i.ed = load ptr, ptr %i.az, align 8, !tbaa !11 ; 4 uses
  %i.ee = getelementptr inbounds nuw i8, ptr %i.ed, i64 4
  %i.ef = load i32, ptr %i.ee, align 4, !tbaa !81 ; 3 uses
...
.preheader.i:                                     ; preds = %.split.i.thread.thread114
  ...
  %i.ei = load i32, ptr %i.eh, align 8, !tbaa !74
...
.lr.ph128:                                        ; preds = %.lr.ph.i, %bb.t
  %i.ek = load ptr, ptr %i.ba, align 8, !tbaa !83 ; 2 uses
  %i.el = load ptr, ptr %i.ek, align 8, !tbaa !84
  %i.em = getelementptr inbounds nuw i8, ptr %i.el, i64 56
  %i.en = load ptr, ptr %i.em, align 8
  %i.eo = tail call noundef i32 %i.en(ptr noundef nonnull align 8 dereferenceable(8) %i.ek), !call_target !86, !inline_history !125 ; 3 uses
...
bb.af:                                            ; preds = %bb.aa
  %i.ht = load i16, ptr %.sroa.6.1, align 2, !tbaa !96
  %i.hu = zext i16 %i.ht to i32
  %i.hv = load i32, ptr %i.at, align 8, !tbaa !141
  %i.hw = sub nsw i32 0, %i.hv
  %i.hx = sext i32 %i.hw to i64
  %i.hy = getelementptr inbounds [2 x i8], ptr %.sroa.6.1, i64 %i.hx
  %i.hz = load i16, ptr %i.hy, align 2, !tbaa !96
...
bb.ag:                                            ; preds = %bb.aa
  %i.ie = load i16, ptr %.sroa.6.1, align 2, !tbaa !96
...
bb.ai:                                            ; preds = %.thread, %bb.aa, %bb.ab, %bb.ac, %bb.ad, %bb.ae, %bb.af, %bb.ag, %bb.ah, %bb.z
  ...
  store i16 %i.ij, ptr %.sroa.0.1, align 2, !tbaa !96
  %i.ik = and i32 %i.ii, 65535
  %i.il = load i32, ptr %i.bg, align 4, !tbaa !140
  %i.im = lshr i32 %i.ik, %i.il
  %.not78 = icmp eq i32 %i.im, 0
  br i1 %.not78, label %bb.al, label %bb.aj

bb.aj:                                            ; preds = %bb.ai
  %i.in = load i32, ptr %i.bh, align 4, !tbaa !158
...
bb.am:                                            ; preds = %bb.al
  %i.ip = load i16, ptr %.sroa.0.1, align 2, !tbaa !96
...
bb.an:                                            ; preds = %bb.am, %bb.al
  ...
  %i.it = load i32, ptr %i.at, align 8, !tbaa !141 ; 2 uses
  %i.iu = sext i32 %i.it to i64
  %i.iv = icmp slt i64 %indvars.iv.next, %i.iu
  br i1 %i.iv, label %bb.g, label %._crit_edge.loopexit, !llvm.loop !159

._crit_edge.loopexit:                             ; preds = %bb.an
  %.pre150 = load i32, ptr %i.ar, align 4, !tbaa !147
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.preheader
  ...
  br i1 %i.iz, label %.preheader, label %._crit_edge138, !llvm.loop !160
...
bb.a:
  ...
  %i.b = load i32, ptr %i.a, align 4, !tbaa !135  ; 2 uses
  %.not = icmp eq i32 %i.b, 0
...
.preheader263:                                    ; preds = %bb.b
  ...
  store <4 x i32> %i.n, ptr %i.l, align 4, !tbaa !126
  %i.o = getelementptr inbounds nuw i8, ptr %2, i64 48
  store i32 %i.k, ptr %i.o, align 4, !tbaa !126
  %i.p = getelementptr inbounds nuw i8, ptr %2, i64 52
  store i32 %i.k, ptr %i.p, align 4, !tbaa !126
...
bb.c:                                             ; preds = %.preheader263
  ...
  %i.v = tail call noundef i32 %i.u(ptr noundef nonnull align 8 dereferenceable(8) %i.r, i64 noundef -2, i32 noundef 1), !call_target !105 ; 0 uses
  br label %bb.d
...
bb.d:                                             ; preds = %bb.d, %bb.c
  ...
  %i.y = load ptr, ptr %i.q, align 8, !tbaa !83   ; 2 uses
  %i.z = load ptr, ptr %i.y, align 8, !tbaa !84
  %i.aa = getelementptr inbounds nuw i8, ptr %i.z, i64 56
  %i.ab = load ptr, ptr %i.aa, align 8
  %i.ac = tail call noundef i32 %i.ab(ptr noundef nonnull align 8 dereferenceable(8) %i.y), !call_target !86 ; 2 uses
  ...
  br i1 %i.ah, label %bb.d, label %.loopexit262, !llvm.loop !162
...
.loopexit262:                                     ; preds = %bb.d, %.preheader263
  ...
  store i32 0, ptr %i.al, align 4, !tbaa !81
...
.preheader261:                                    ; preds = %.loopexit262, %bb.b, %bb.a
  ...
  %i.an = load ptr, ptr %i.am, align 8, !tbaa !154 ; 3 uses
  ...
  %i.ar = load i32, ptr %i.aq, align 8, !tbaa !141 ; 3 uses
...
bb.h:                                             ; preds = %bb.g
  %i.bl = load i32, ptr %i.ay, align 4, !tbaa !142
...
_ZN6LibRaw10ljpeg_diffEPt.exit:                   ; preds = %bb.h, %.split.i
  ...
  %i.bu = load i32, ptr %i.bt, align 4, !tbaa !126
  %i.bv = add nsw i32 %i.bu, %.011.i              ; 3 uses
  store i32 %i.bv, ptr %i.bt, align 4, !tbaa !126
  %i.bw = trunc i32 %i.bv to i16
  store i16 %i.bw, ptr %i.bc, align 2, !tbaa !96
  %i.bx = and i32 %i.bv, 65535
  %i.by = load i32, ptr %i.ba, align 4, !tbaa !140
...
bb.j:                                             ; preds = %bb.i, %_ZN6LibRaw10ljpeg_diffEPt.exit
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.cc = load i32, ptr %i.aq, align 8, !tbaa !141 ; 2 uses
  %i.cd = sext i32 %i.cc to i64
  %i.ce = icmp slt i64 %indvars.iv.next, %i.cd
  br i1 %i.ce, label %bb.e, label %._crit_edge, !llvm.loop !163
...
.preheader254:                                    ; preds = %._crit_edge
  %i.cg = load i32, ptr %i.ao, align 4, !tbaa !147 ; 2 uses
...
.lr.ph305:                                        ; preds = %.preheader, %bb.ab
  ...
  %i.ct = load ptr, ptr %i.cs, align 8, !tbaa !104 ; 3 uses
...
bb.m:                                             ; preds = %bb.l
  %i.cz = load ptr, ptr %i.cj, align 8, !tbaa !11 ; 4 uses
  %i.da = getelementptr inbounds nuw i8, ptr %i.cz, i64 4
  %i.db = load i32, ptr %i.da, align 4, !tbaa !81 ; 3 uses
...
.preheader.i122:                                  ; preds = %bb.m
  ...
  %i.de = load i32, ptr %i.dd, align 8, !tbaa !74
...
.lr.ph296:                                        ; preds = %.lr.ph.i128, %bb.p
  %i.dg = load ptr, ptr %i.ck, align 8, !tbaa !83 ; 2 uses
  %i.dh = load ptr, ptr %i.dg, align 8, !tbaa !84
  %i.di = getelementptr inbounds nuw i8, ptr %i.dh, i64 56
  %i.dj = load ptr, ptr %i.di, align 8
  %i.dk = tail call noundef i32 %i.dj(ptr noundef nonnull align 8 dereferenceable(8) %i.dg), !call_target !86, !inline_history !125 ; 3 uses
...
..critedge.loopexit_crit_edge.i136:               ; preds = %.lr.ph296
  %.pre.pre.i137 = load ptr, ptr %i.cj, align 8, !tbaa !11
  br label %.critedge.loopexit.i129

bb.n:                                             ; preds = %.lr.ph296
  %i.dl = load i32, ptr %i.cl, align 8, !tbaa !93
...
bb.o:                                             ; preds = %bb.n
  %i.do = load ptr, ptr %i.ck, align 8, !tbaa !83 ; 2 uses
  %i.dp = load ptr, ptr %i.do, align 8, !tbaa !84
  %i.dq = getelementptr inbounds nuw i8, ptr %i.dp, i64 56
  %i.dr = load ptr, ptr %i.dq, align 8
  %i.ds = tail call noundef i32 %i.dr(ptr noundef nonnull align 8 dereferenceable(8) %i.do), !call_target !86, !inline_history !125
  %i.dt = icmp ne i32 %i.ds, 0                    ; 2 uses
  %i.du = zext i1 %i.dt to i32
  %i.dv = load ptr, ptr %i.cj, align 8, !tbaa !11 ; 3 uses
  %i.dw = getelementptr inbounds nuw i8, ptr %i.dv, i64 8
  store i32 %i.du, ptr %i.dw, align 8, !tbaa !74
  br i1 %i.dt, label %.critedge.loopexit.i129, label %bb.p

.critedge24.i135:                                 ; preds = %bb.n
  %i.dx = load ptr, ptr %i.cj, align 8, !tbaa !11 ; 2 uses
  %i.dy = getelementptr inbounds nuw i8, ptr %i.dx, i64 8
  store i32 0, ptr %i.dy, align 8, !tbaa !74
  br label %bb.p

bb.p:                                             ; preds = %.critedge24.i135, %bb.o
  %i.dz = phi ptr [ %i.dx, %.critedge24.i135 ], [ %i.dv, %bb.o ] ; 4 uses
  %i.ea = load i32, ptr %i.dz, align 8, !tbaa !82
  %i.eb = shl i32 %i.ea, 8
  %i.ec = and i32 %i.dk, 255
  %i.ed = or disjoint i32 %i.eb, %i.ec
  store i32 %i.ed, ptr %i.dz, align 8, !tbaa !82
  ...
  br i1 %i.eh, label %.lr.ph296, label %.critedge.loopexit.i129, !llvm.loop !94

end_hunk_1
begin_hunk_2_@_ZN6LibRaw18ljpeg_row_unrolledEiP5jhead:bb.a
  %.pre.pre.i188 = load ptr, ptr %i.ib, align 8, !tbaa !11
  br label %.critedge.loopexit.i180

bb.bf:                                            ; preds = %.lr.ph276
  %i.qv = load i32, ptr %i.id, align 8, !tbaa !93
...
bb.bg:                                            ; preds = %bb.bf
  %i.qy = load ptr, ptr %i.ic, align 8, !tbaa !83 ; 2 uses
  %i.qz = load ptr, ptr %i.qy, align 8, !tbaa !84
  %i.ra = getelementptr inbounds nuw i8, ptr %i.qz, i64 56
  %i.rb = load ptr, ptr %i.ra, align 8
  %i.rc = tail call noundef i32 %i.rb(ptr noundef nonnull align 8 dereferenceable(8) %i.qy), !call_target !86, !inline_history !125
  %i.rd = icmp ne i32 %i.rc, 0                    ; 2 uses
  %i.re = zext i1 %i.rd to i32
  %i.rf = load ptr, ptr %i.ib, align 8, !tbaa !11 ; 3 uses
  %i.rg = getelementptr inbounds nuw i8, ptr %i.rf, i64 8
  store i32 %i.re, ptr %i.rg, align 8, !tbaa !74
  br i1 %i.rd, label %.critedge.loopexit.i180, label %bb.bh

.critedge24.i186:                                 ; preds = %bb.bf
  %i.rh = load ptr, ptr %i.ib, align 8, !tbaa !11 ; 2 uses
  %i.ri = getelementptr inbounds nuw i8, ptr %i.rh, i64 8
  store i32 0, ptr %i.ri, align 8, !tbaa !74
  br label %bb.bh

bb.bh:                                            ; preds = %.critedge24.i186, %bb.bg
  %i.rj = phi ptr [ %i.rh, %.critedge24.i186 ], [ %i.rf, %bb.bg ] ; 4 uses
  %i.rk = load i32, ptr %i.rj, align 8, !tbaa !82
  %i.rl = shl i32 %i.rk, 8
  %i.rm = and i32 %i.qu, 255
  %i.rn = or disjoint i32 %i.rl, %i.rm
  store i32 %i.rn, ptr %i.rj, align 8, !tbaa !82
  %i.ro = getelementptr inbounds nuw i8, ptr %i.rj, i64 4 ; 2 uses
  %i.rp = load i32, ptr %i.ro, align 4, !tbaa !81
  %i.rq = add nsw i32 %i.rp, 8                    ; 2 uses
  store i32 %i.rq, ptr %i.ro, align 4, !tbaa !81
  %i.rr = icmp slt i32 %i.rq, %.016.i195222225248
  br i1 %i.rr, label %.lr.ph276, label %.critedge.loopexit.i180, !llvm.loop !94
...
.critedge.loopexit.i180:                          ; preds = %bb.bh, %bb.bg, %.lr.ph.i179, %..critedge.loopexit_crit_edge.i187
  ...
  %.pre29.i183 = load i32, ptr %.phi.trans.insert.i182, align 4, !tbaa !81
...
bb.bi:                                            ; preds = %.critedge.i175
  %i.rw = load i32, ptr %i.rt, align 8, !tbaa !82
...
bb.bj:                                            ; preds = %bb.bi, %.critedge.i175
  ...
  store i32 %.sink.i177, ptr %i.ru, align 4, !tbaa !81
...
bb.bl:                                            ; preds = %_ZN6LibRaw10ljpeg_diffEPt.exit118
  %i.sp = load i16, ptr %.sroa.12.5, align 2, !tbaa !96
...
bb.bq:                                            ; preds = %_ZN6LibRaw10ljpeg_diffEPt.exit118
  %i.tr = load i16, ptr %.sroa.12.5, align 2, !tbaa !96
...
bb.bs:                                            ; preds = %bb.br, %bb.bq, %bb.bp, %bb.bo, %bb.bn, %bb.bm, %bb.bl, %_ZN6LibRaw10ljpeg_diffEPt.exit118
  ...
  store i16 %i.tw, ptr %.sroa.0.7, align 2, !tbaa !96
  %i.tx = and i32 %i.tv, 65535
  %i.ty = load i32, ptr %i.if, align 4, !tbaa !140
...
bb.bt:                                            ; preds = %bb.bs
  tail call void @_ZN6LibRaw6derrorEv(ptr noundef nonnull align 8 dereferenceable(768512) %0)
  %.pre = load i32, ptr %i.aq, align 8, !tbaa !141
  br label %bb.bu
...
bb.bu:                                            ; preds = %bb.bt, %bb.bs
  ...
  br i1 %i.ue, label %.lr.ph281, label %._crit_edge282.loopexit, !llvm.loop !168

._crit_edge282.loopexit:                          ; preds = %bb.bu
  %.pre340 = load i32, ptr %i.ao, align 4, !tbaa !147
...
._crit_edge282:                                   ; preds = %._crit_edge282.loopexit, %.preheader258
  ...
  br i1 %i.ui, label %.preheader258, label %.loopexit, !llvm.loop !169
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.k = load i16, ptr %i.j, align 4, !tbaa !96
  %.not68 = icmp eq i16 %i.k, 0
  br i1 %.not68, label %bb.f, label %.lr.ph92

bb.f:                                             ; preds = %bb.e
  %i.l = tail call ptr @__cxa_allocate_exception(i64 4) #15 ; 2 uses
  store i32 5, ptr %i.l, align 16, !tbaa !155
  tail call void @__cxa_throw(ptr nonnull %i.l, ptr nonnull @_ZTI17LibRaw_exceptions, ptr null) #16
  unreachable

.lr.ph92:                                         ; preds = %bb.d, %bb.e
  %shift = shufflevector <4 x i32> %.fr, <4 x i32> poison, <4 x i32> <i32 poison, i32 poison, i32 3, i32 poison>
  %shift.fr = freeze <4 x i32> %shift
  %foldExtExtBinop = mul <4 x i32> %shift.fr, %.fr
  %i.m = extractelement <4 x i32> %foldExtExtBinop, i64 2 ; 3 uses
  %i.n = getelementptr inbounds nuw i8, ptr %0, i64 381860
  %i.o = getelementptr inbounds nuw i8, ptr %0, i64 20
  %i.p = icmp sgt i32 %i.m, 0
  %i.q = getelementptr inbounds nuw i8, ptr %0, i64 5600
  %i.r = getelementptr inbounds nuw i8, ptr %0, i64 381740
  %i.s = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  %i.t = getelementptr inbounds nuw i8, ptr %0, i64 18 ; 2 uses
  %i.u = getelementptr inbounds nuw i8, ptr %0, i64 193784
  br i1 %i.p, label %.lr.ph92.split.us, label %.lr.ph92.split
...
.lr.ph92.split.us:                                ; preds = %.lr.ph92, %._crit_edge.us
  ...
  %.05588.us = phi i32 [ %i.bz, %._crit_edge.us ], [ 0, %.lr.ph92 ] ; 6 uses
...
bb.g:                                             ; preds = %.lr.ph92.split.us
  %i.v = invoke noundef ptr @_ZN6LibRaw9ljpeg_rowEiP5jhead(ptr noundef nonnull align 8 dereferenceable(768512) %0, i32 noundef %.05588.us, ptr noundef nonnull %1)
          to label %bb.h unwind label %.loopexit.split.us

bb.h:                                             ; preds = %bb.g
  %i.w = load i32, ptr %i.n, align 4, !tbaa !158
  %i.x = and i32 %i.w, 1
  %.not70.us = icmp eq i32 %i.x, 0
  br i1 %.not70.us, label %.lr.ph.us, label %bb.i

bb.i:                                             ; preds = %bb.h
  %i.y = and i32 %.05588.us, 1
  %.not71.us = icmp eq i32 %i.y, 0
  br i1 %.not71.us, label %bb.k, label %bb.j

bb.j:                                             ; preds = %bb.i
  %i.z = load i16, ptr %i.o, align 4, !tbaa !170
  %i.aa = zext i16 %i.z to i32
  %i.ab = lshr i32 %.05588.us, 1
  %i.ac = xor i32 %i.ab, -1
  %i.ad = add nsw i32 %i.aa, %i.ac
  br label %.lr.ph.us

bb.k:                                             ; preds = %bb.i
  %i.ae = lshr exact i32 %.05588.us, 1
  br label %.lr.ph.us

.lr.ph.us:                                        ; preds = %bb.k, %bb.j, %bb.h
  %.149.us = phi i32 [ %.04889.us, %bb.h ], [ %i.ad, %bb.j ], [ %i.ae, %bb.k ]
  %i.af = mul nuw nsw i32 %.05588.us, %i.m
  br label %bb.l

bb.l:                                             ; preds = %.lr.ph.us, %bb.v
  %.086.us = phi ptr [ %i.v, %.lr.ph.us ], [ %i.ag, %bb.v ] ; 2 uses
  %.185.us = phi i32 [ %.04790.us, %.lr.ph.us ], [ %spec.select78.us, %bb.v ]
  %.25084.us = phi i32 [ %.149.us, %.lr.ph.us ], [ %spec.select77.us, %bb.v ]
  %.05483.us = phi i32 [ 0, %.lr.ph.us ], [ %i.by, %bb.v ] ; 2 uses
  %i.ag = getelementptr inbounds nuw i8, ptr %.086.us, i64 2
  %i.ah = load i16, ptr %.086.us, align 2, !tbaa !96
  %i.ai = zext i16 %i.ah to i64
  %i.aj = getelementptr inbounds nuw [2 x i8], ptr %i.q, i64 %i.ai
  %i.ak = load i16, ptr %i.aj, align 2, !tbaa !96
  %i.al = load i16, ptr %i.h, align 2, !tbaa !96  ; 2 uses
  %.not72.us = icmp eq i16 %i.al, 0
  br i1 %.not72.us, label %bb.o, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.am = add nuw nsw i32 %.05483.us, %i.af       ; 2 uses
  %i.an = load i16, ptr %i.r, align 4, !tbaa !96
  %i.ao = zext i16 %i.an to i32                   ; 2 uses
  %i.ap = load i16, ptr %i.s, align 8, !tbaa !122
  %i.aq = zext i16 %i.ap to i32
  %i.ar = mul nuw nsw i32 %i.aq, %i.ao            ; 2 uses
  %i.as = udiv i32 %i.am, %i.ar                   ; 2 uses
  %i.at = zext i16 %i.al to i32                   ; 2 uses
  %.not73.us = icmp slt i32 %i.as, %i.at
  %spec.select.us = select i1 %.not73.us, i64 1, i64 2
  %i.au = getelementptr inbounds nuw [2 x i8], ptr %i.h, i64 %spec.select.us
  %i.av = load i16, ptr %i.au, align 2, !tbaa !96 ; 2 uses
  %.not74.us = icmp eq i16 %i.av, 0
  br i1 %.not74.us, label %.split.us.invoke, label %bb.n

bb.n:                                             ; preds = %bb.m
  %spec.select76.us = tail call i32 @llvm.smin.i32(i32 %i.as, i32 %i.at) ; 2 uses
  %i.aw = mul nuw nsw i32 %spec.select76.us, %i.ar
  %i.ax = sub nsw i32 %i.am, %i.aw                ; 2 uses
  %i.ay = zext i16 %i.av to i32                   ; 2 uses
  %i.az = sdiv i32 %i.ax, %i.ay
  %i.ba = srem i32 %i.ax, %i.ay
  %i.bb = mul nuw nsw i32 %spec.select76.us, %i.ao
  %i.bc = add nsw i32 %i.ba, %i.bb
  br label %bb.o

bb.o:                                             ; preds = %bb.n, %bb.l
  %.351.us = phi i32 [ %i.az, %bb.n ], [ %.25084.us, %bb.l ] ; 3 uses
  %.2.us = phi i32 [ %i.bc, %bb.n ], [ %.185.us, %bb.l ] ; 4 uses
  %i.bd = load i16, ptr %i.t, align 2, !tbaa !123 ; 4 uses
  %i.be = icmp eq i16 %i.bd, 3984
  br i1 %i.be, label %bb.p, label %bb.r

bb.p:                                             ; preds = %bb.o
  %i.bf = add nsw i32 %.2.us, -2
  %i.bg = icmp slt i32 %.2.us, 2
  br i1 %i.bg, label %bb.q, label %bb.r

bb.q:                                             ; preds = %bb.p
  %i.bh = add nsw i32 %.351.us, -1
  %i.bi = add nsw i32 %.2.us, 3982
  br label %bb.r

bb.r:                                             ; preds = %bb.q, %bb.p, %bb.o
  %.452.us = phi i32 [ %i.bh, %bb.q ], [ %.351.us, %bb.p ], [ %.351.us, %bb.o ] ; 4 uses
  %.3.us = phi i32 [ %i.bi, %bb.q ], [ %i.bf, %bb.p ], [ %.2.us, %bb.o ] ; 3 uses
  %i.bj = load i16, ptr %i.s, align 8, !tbaa !122
  %i.bk = zext i16 %i.bj to i32                   ; 2 uses
  %i.bl = icmp sgt i32 %.452.us, %i.bk
  br i1 %i.bl, label %.split.us.invoke, label %bb.s

bb.s:                                             ; preds = %bb.r
  %i.bm = icmp ult i32 %.452.us, %i.bk
  br i1 %i.bm, label %bb.t, label %bb.v

bb.t:                                             ; preds = %bb.s
  %i.bn = zext i16 %i.bd to i32                   ; 2 uses
  %i.bo = icmp ult i32 %.3.us, %i.bn
  br i1 %i.bo, label %bb.u, label %bb.v

bb.u:                                             ; preds = %bb.t
  %i.bp = load ptr, ptr %i.u, align 8, !tbaa !124
  %i.bq = mul nuw nsw i32 %.452.us, %i.bn
  %i.br = add nuw nsw i32 %i.bq, %.3.us
  %i.bs = zext nneg i32 %i.br to i64
  %i.bt = getelementptr inbounds nuw [2 x i8], ptr %i.bp, i64 %i.bs
  store i16 %i.ak, ptr %i.bt, align 2, !tbaa !96
  %.pre = load i16, ptr %i.t, align 2, !tbaa !123
  br label %bb.v

bb.v:                                             ; preds = %bb.u, %bb.t, %bb.s
  %i.bu = phi i16 [ %.pre, %bb.u ], [ %i.bd, %bb.t ], [ %i.bd, %bb.s ]
  %i.bv = add nsw i32 %.3.us, 1                   ; 2 uses
  %i.bw = zext i16 %i.bu to i32
  %.not75.us = icmp sge i32 %i.bv, %i.bw          ; 2 uses
  %i.bx = zext i1 %.not75.us to i32
  %spec.select77.us = add nsw i32 %.452.us, %i.bx ; 2 uses
  %spec.select78.us = select i1 %.not75.us, i32 0, i32 %i.bv ; 2 uses
  %i.by = add nuw nsw i32 %.05483.us, 1           ; 2 uses
  %exitcond.not = icmp eq i32 %i.by, %i.m
  br i1 %exitcond.not, label %._crit_edge.us, label %bb.l, !llvm.loop !171

._crit_edge.us:                                   ; preds = %bb.v
  %i.bz = add nuw nsw i32 %.05588.us, 1           ; 2 uses
  %i.ca = load i32, ptr %i.b, align 8, !tbaa !146
end_hunk_2
