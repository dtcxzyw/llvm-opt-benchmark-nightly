...
bb.e:                                             ; preds = %bb.d, %bb.c
  %.048 = phi i32 [ %.zext, %bb.d ], [ %i.af, %bb.c ] ; 4 uses
  %i.ak = icmp eq i32 %i.t, 68
  br i1 %i.ak, label %bb.f, label %bb.l

bb.f:                                             ; preds = %bb.e
  %i.al = icmp eq i32 %i.v, 32
  br i1 %i.al, label %bb.h, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.am = icmp eq i32 %i.v, 64
  %i.an = icmp samesign ugt i32 %.048, 3
  %or.cond6 = select i1 %i.am, i1 %i.an, i1 false
  br i1 %or.cond6, label %bb.i, label %bb.l

bb.h:                                             ; preds = %bb.f
  %.old5.not = icmp eq i32 %.048, 0
  br i1 %.old5.not, label %bb.l, label %bb.i

bb.i:                                             ; preds = %bb.g, %bb.h
  %i.ao = icmp eq i32 %i.v, 64                    ; 2 uses
  %i.ap = lshr i32 %.048, 2
  %i.aq = lshr i32 %i.af, 2
  %.1 = select i1 %i.ao, i32 %i.ap, i32 %.048     ; 13 uses
  %.0 = select i1 %i.ao, i32 %i.aq, i32 %i.af     ; 4 uses
  %.not = icmp eq i16 %i.ag, 0
  br i1 %.not, label %.preheader, label %.lr.ph

.lr.ph:                                           ; preds = %bb.i
  %i.ar = getelementptr inbounds nuw i8, ptr %0, i64 5600
  %i.as = zext nneg i32 %.1 to i64
  %wide.trip.count = zext i16 %i.ag to i64
  br label %bb.j
...
.lr.ph56:                                         ; preds = %.preheader
  %i.at = getelementptr inbounds nuw i8, ptr %0, i64 5600 ; 9 uses
  %wide.trip.count62 = zext nneg i32 %.0 to i64   ; 2 uses
  %xtraiter = and i64 %wide.trip.count62, 1
...
bb.j:                                             ; preds = %.lr.ph, %bb.j
  ...
  store i16 %i.av, ptr %i.ax, align 2, !tbaa !97
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %.preheader, label %bb.j, !llvm.loop !209
...
bb.k:                                             ; preds = %bb.k, %.lr.ph56.new
  ...
  %i.bc = getelementptr inbounds nuw [2 x i8], ptr %i.at, i64 %i.bb
  %i.bd = load i16, ptr %i.bc, align 2, !tbaa !97
  %i.be = zext i16 %i.bd to i32
  %i.bf = sub nuw nsw i32 %.1, %i.az
  %i.bg = mul nuw nsw i32 %i.bf, %i.be
  %i.bh = add nuw nsw i32 %i.ba, %.1
  %i.bi = zext nneg i32 %i.bh to i64
  %i.bj = getelementptr inbounds nuw [2 x i8], ptr %i.at, i64 %i.bi
  %i.bk = load i16, ptr %i.bj, align 2, !tbaa !97
  %i.bl = zext i16 %i.bk to i32
  %i.bm = mul nuw nsw i32 %i.az, %i.bl
  %i.bn = add nuw nsw i32 %i.bm, %i.bg
  %i.bo = udiv i32 %i.bn, %.1
  %i.bp = trunc i32 %i.bo to i16
  %i.bq = getelementptr inbounds nuw [2 x i8], ptr %i.at, i64 %indvars.iv59
  store i16 %i.bp, ptr %i.bq, align 4, !tbaa !97
  ...
  %i.bv = getelementptr inbounds nuw [2 x i8], ptr %i.at, i64 %i.bu
  %i.bw = load i16, ptr %i.bv, align 2, !tbaa !97
  %i.bx = zext i16 %i.bw to i32
  %i.by = sub nuw nsw i32 %.1, %i.bs
  %i.bz = mul nuw nsw i32 %i.by, %i.bx
  %i.ca = add nuw nsw i32 %i.bt, %.1
  %i.cb = zext nneg i32 %i.ca to i64
  %i.cc = getelementptr inbounds nuw [2 x i8], ptr %i.at, i64 %i.cb
...
bb.a:
  ...
  %i.i = load ptr, ptr %i.f, align 8, !tbaa !88
  %i.j = getelementptr inbounds nuw i8, ptr %i.i, i64 32
  %i.k = load ptr, ptr %i.j, align 8
  %i.l = tail call noundef i32 %i.k(ptr noundef nonnull align 8 dereferenceable(8) %i.f, i64 noundef %i.h, i32 noundef 0), !call_target !107 ; 0 uses
  %i.m = load ptr, ptr %i.e, align 8, !tbaa !86   ; 2 uses
  %i.n = load ptr, ptr %i.m, align 8, !tbaa !88
  %i.o = getelementptr inbounds nuw i8, ptr %i.n, i64 56
  %i.p = load ptr, ptr %i.o, align 8
  %i.q = tail call noundef i32 %i.p(ptr noundef nonnull align 8 dereferenceable(8) %i.m), !call_target !94
  %i.r = load ptr, ptr %i.e, align 8, !tbaa !86   ; 2 uses
  %i.s = load ptr, ptr %i.r, align 8, !tbaa !88
  %i.t = getelementptr inbounds nuw i8, ptr %i.s, i64 56
  %i.u = load ptr, ptr %i.t, align 8
  %i.v = tail call noundef i32 %i.u(ptr noundef nonnull align 8 dereferenceable(8) %i.r), !call_target !94 ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  %i.aa = load ptr, ptr %i.e, align 8, !tbaa !86  ; 2 uses
  %i.ab = load ptr, ptr %i.aa, align 8, !tbaa !88
  %i.ac = getelementptr inbounds nuw i8, ptr %i.ab, i64 32
  %i.ad = load ptr, ptr %i.ac, align 8
  %i.ae = tail call noundef i32 %i.ad(ptr noundef nonnull align 8 dereferenceable(8) %i.aa, i64 noundef 2110, i32 noundef 1), !call_target !107 ; 0 uses
  br label %bb.c
...
bb.c:                                             ; preds = %bb.a, %bb.b
  ...
  %i.al = and i32 %i.ak, 32767                    ; 4 uses
  %i.am = icmp eq i32 %i.w, 68
...
bb.f:                                             ; preds = %bb.d, %bb.e
  %.067 = phi i32 [ %i.an, %bb.e ], [ %i.al, %bb.d ]
  %i.ao = load ptr, ptr %i.e, align 8, !tbaa !86  ; 2 uses
  %i.ap = load i64, ptr %i.g, align 8, !tbaa !142
  %i.aq = add nsw i64 %i.ap, 562
  %i.ar = load ptr, ptr %i.ao, align 8, !tbaa !88
  %i.as = getelementptr inbounds nuw i8, ptr %i.ar, i64 32
  %i.at = load ptr, ptr %i.as, align 8
  %i.au = call noundef i32 %i.at(ptr noundef nonnull align 8 dereferenceable(8) %i.ao, i64 noundef %i.aq, i32 noundef 0), !call_target !107 ; 0 uses
  %i.av = call noundef zeroext i16 @_ZN6LibRaw4get2Ev(ptr noundef nonnull align 8 dereferenceable(768512) %0)
  %i.aw = zext i16 %i.av to i32
  br label %bb.g

bb.g:                                             ; preds = %bb.d, %bb.f, %bb.c
  %.168 = phi i32 [ %.067, %bb.f ], [ %i.al, %bb.d ], [ %i.al, %bb.c ] ; 3 uses
  %.065 = phi i32 [ %i.aw, %bb.f ], [ 0, %bb.d ], [ 0, %bb.c ] ; 2 uses
  %i.ax = getelementptr inbounds nuw i8, ptr %0, i64 5600 ; 2 uses
  %i.ay = icmp samesign ugt i32 %.168, 2
  br i1 %i.ay, label %.lr.ph, label %.critedge

.lr.ph:                                           ; preds = %bb.g, %bb.h
  %.2119 = phi i32 [ %i.bg, %bb.h ], [ %.168, %bb.g ] ; 4 uses
  %i.az = zext nneg i32 %.2119 to i64
  %i.ba = getelementptr [2 x i8], ptr %i.ax, i64 %i.az ; 2 uses
  %i.bb = getelementptr i8, ptr %i.ba, i64 -4
  %i.bc = load i16, ptr %i.bb, align 2, !tbaa !97
...
bb.h:                                             ; preds = %.lr.ph
  %i.bg = add nsw i32 %.2119, -1
  %i.bh = icmp sgt i32 %.2119, 3
  br i1 %i.bh, label %.lr.ph, label %.critedge, !llvm.loop !211
...
.critedge:                                        ; preds = %.lr.ph, %bb.h, %bb.g
  ...
  %i.bk = load ptr, ptr %i.e, align 8, !tbaa !86  ; 2 uses
  %i.bl = getelementptr inbounds nuw i8, ptr %0, i64 381760
  %i.bm = load i64, ptr %i.bl, align 8, !tbaa !144
  %i.bn = load ptr, ptr %i.bk, align 8, !tbaa !88
  %i.bo = getelementptr inbounds nuw i8, ptr %i.bn, i64 32
  %i.bp = load ptr, ptr %i.bo, align 8
  %i.bq = call noundef i32 %i.bp(ptr noundef nonnull align 8 dereferenceable(8) %i.bk, i64 noundef %i.bm, i32 noundef 0), !call_target !107 ; 0 uses
  %i.br = getelementptr inbounds nuw i8, ptr %0, i64 381584 ; 10 uses
  %i.bs = load ptr, ptr %i.br, align 8, !tbaa !76 ; 3 uses
  %i.bt = getelementptr inbounds nuw i8, ptr %i.bs, i64 8
  store i32 0, ptr %i.bt, align 8, !tbaa !83
  %i.bu = getelementptr inbounds nuw i8, ptr %i.bs, i64 4
  store i32 0, ptr %i.bu, align 4, !tbaa !84
  store i32 0, ptr %i.bs, align 8, !tbaa !85
  %i.bv = getelementptr inbounds nuw i8, ptr %0, i64 20 ; 2 uses
  %i.bw = load i16, ptr %i.bv, align 4, !tbaa !137
...
bb.l:                                             ; preds = %bb.k
  ...
  store ptr %i.bx, ptr %i.a, align 8, !tbaa !98
...
bb.o:                                             ; preds = %bb.m, %bb.j
  ...
  %i.cg = load i16, ptr %i.by, align 2, !tbaa !117
...
bb.p:                                             ; preds = %.lr.ph129, %bb.an
  %indvars.iv = phi i64 [ 0, %.lr.ph129 ], [ %indvars.iv.next, %bb.an ] ; 7 uses
  %i.cl = load i16, ptr %.273, align 2, !tbaa !97 ; 2 uses
...
bb.q:                                             ; preds = %bb.p
  %i.co = load ptr, ptr %i.br, align 8, !tbaa !76 ; 4 uses
  %i.cp = getelementptr inbounds nuw i8, ptr %i.co, i64 4
  %i.cq = load i32, ptr %i.cp, align 4, !tbaa !84 ; 3 uses
...
.preheader.i:                                     ; preds = %bb.q
  ...
  %i.ct = load i32, ptr %i.cs, align 8, !tbaa !83
...
.lr.ph122:                                        ; preds = %.lr.ph.i, %bb.t
  %i.cv = load ptr, ptr %i.e, align 8, !tbaa !86  ; 2 uses
  %i.cw = load ptr, ptr %i.cv, align 8, !tbaa !88
  ...
  %i.cz = invoke noundef i32 %i.cy(ptr noundef nonnull align 8 dereferenceable(8) %i.cv)
          to label %.noexc unwind label %.loopexit.split-lp.loopexit, !inline_history !119 ; 3 uses
...
..critedge.loopexit_crit_edge.i:                  ; preds = %.noexc
  %.pre.pre.i = load ptr, ptr %i.br, align 8, !tbaa !76
  br label %.critedge.loopexit.i

bb.r:                                             ; preds = %.noexc
  %i.da = load i32, ptr %i.bz, align 8, !tbaa !95
...
bb.s:                                             ; preds = %bb.r
  %i.dd = load ptr, ptr %i.e, align 8, !tbaa !86  ; 2 uses
  %i.de = load ptr, ptr %i.dd, align 8, !tbaa !88
...
bb.t:                                             ; preds = %.critedge24.i, %.noexc85
  ...
  store i32 %i.dv, ptr %i.dt, align 4, !tbaa !84
  %i.dw = icmp slt i32 %i.dv, %i.cm
  br i1 %i.dw, label %.lr.ph122, label %.critedge.loopexit.i, !llvm.loop !1
...
.critedge.i:                                      ; preds = %.critedge.loopexit.i, %.preheader.i
  ...
  %i.dy = phi ptr [ %.pre.i, %.critedge.loopexit.i ], [ %i.co, %.preheader.i ] ; 2 uses
