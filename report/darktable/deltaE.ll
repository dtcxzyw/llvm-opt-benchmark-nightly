...
bb.h:                                             ; preds = %bb.f, %bb.g, %bb.d
  ...
  %i.bx = fsub reassoc nsz arcp contract afn double %i.bn, %i.bw
  %2 = fadd reassoc nsz arcp contract afn double %i.bx, %i.bt
  %i.by = fptrunc reassoc nsz arcp contract afn double %2 to float
