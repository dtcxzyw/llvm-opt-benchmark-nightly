...
bb.b:                                             ; preds = %.lr.ph110, %bb.d
  %.052108 = phi i64 [ 1, %.lr.ph110 ], [ %i.hl, %bb.d ] ; 3 uses
...
._crit_edge:                                      ; preds = %.lr.ph, %bb.b
  %.051.lcssa = phi ptr [ %i.dd, %bb.b ], [ %i.er, %.lr.ph ]
  %i.eo = phi <2 x float> [ %i.dw, %bb.b ], [ %i.fh, %.lr.ph ]
  %i.ep = phi <2 x float> [ %i.el, %bb.b ], [ %i.fw, %.lr.ph ]
  br i1 %.not.not, label %bb.c, label %bb.d

.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  %.sroa.10.1.a = phi nsz float [ %i.fz, %.lr.ph ], [ %i.em, %.lr.ph.preheader ] ; 2 uses
  %.sroa.6118.1 = phi nsz float [ %i.fy, %.lr.ph ], [ %i.en, %.lr.ph.preheader ]
  %.050105 = phi i64 [ %i.gm, %.lr.ph ], [ 0, %.lr.ph.preheader ] ; 2 uses
  %.051104 = phi ptr [ %i.er, %.lr.ph ], [ %i.dd, %.lr.ph.preheader ] ; 2 uses
  %i.eq = phi <2 x float> [ %i.fw, %.lr.ph ], [ %i.el, %.lr.ph.preheader ] ; 3 uses
  %i.er = getelementptr inbounds nuw i8, ptr %.051104, i64 16 ; 7 uses
  ...
  %.sroa.656.0..sroa_idx.i60 = getelementptr inbounds nuw i8, ptr %.051104, i64 20
  ...
  %i.fx = getelementptr inbounds nuw [4 x i8], ptr %i.dg, i64 %.050105
  ...
  %i.ga = insertelement <2 x float> poison, float %.sroa.6118.1, i64 0
  ...
  %i.gf = fmul reassoc nsz arcp contract afn float %.sroa.10.1.a, 6.000000e+00
  %i.gg = insertelement <2 x float> %foldExtExtBinop, float %.sroa.10.1.a, i64 1
  ...
  %i.gm = add i64 %.050105, 2                     ; 2 uses
  %i.gn = icmp ult i64 %i.gm, %i.g
  br i1 %i.gn, label %.lr.ph, label %._crit_edge

bb.c:                                             ; preds = %._crit_edge
  %i.go = getelementptr inbounds nuw i8, ptr %.051.lcssa, i64 16 ; 5 uses
...
bb.d:                                             ; preds = %bb.c, %._crit_edge
  %i.hl = add nuw nsw i64 %.052108, 1             ; 2 uses
