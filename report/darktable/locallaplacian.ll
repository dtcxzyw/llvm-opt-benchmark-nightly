...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  %.sroa.6118.1.a = phi nsz float [ %i.fz, %.lr.ph ], [ %i.en, %.lr.ph.preheader ]
  %.sroa.10.1 = phi nsz float [ %i.gc, %.lr.ph ], [ %i.em, %.lr.ph.preheader ] ; 2 uses
  ...
  %i.ew = fmul reassoc nsz arcp contract afn float %.sroa.10.1, 6.000000e+00
  ...
  %i.gg = insertelement <2 x float> %i.gf, float %.sroa.6118.1.a, i64 0
  %i.gh = fmul reassoc nsz arcp contract afn <2 x float> %i.gg, <float 4.000000e+00, float 6.000000e+00>
  %i.gi = insertelement <2 x float> %i.gb, float %.sroa.10.1, i64 1
