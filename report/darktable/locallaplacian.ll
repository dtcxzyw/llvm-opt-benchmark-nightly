...
.lr.ph34.i.preheader:                             ; preds = %.lr.ph.i.epil, %.lr.ph34.i.preheader.unr-lcssa
  %xtraiter134 = and i64 %i.m, 7                  ; 3 uses
...
.lr.ph34.i:                                       ; preds = %.lr.ph34.i, %.lr.ph34.i.preheader.new
  ...
  %niter139 = phi i64 [ 0, %.lr.ph34.i.preheader.new ], [ %niter139.next.7, %.lr.ph34.i ]
  ...
  br i1 %niter139.ncmp.7, label %ll_fill_boundary1.exit.loopexit.unr-lcssa, label %.lr.ph34.i

ll_fill_boundary1.exit.loopexit.unr-lcssa:        ; preds = %.lr.ph34.i
  %lcmp.mod136.not = icmp eq i64 %xtraiter134, 0
  br i1 %lcmp.mod136.not, label %ll_fill_boundary1.exit, label %.lr.ph34.i.epil.preheader
...
.lr.ph34.i.epil:                                  ; preds = %.lr.ph34.i.epil, %.lr.ph34.i.epil.preheader
  ...
  %epil.iter135 = phi i64 [ %epil.iter135.next, %.lr.ph34.i.epil ], [ 0, %.lr.ph34.i.epil.preheader ]
  ...
  br i1 %epil.iter135.cmp.not, label %ll_fill_boundary1.exit, label %.lr.ph34.i.epil, !llvm.loop !224
...
bb.b:                                             ; preds = %.lr.ph110, %bb.d
  %.049108 = phi i64 [ 1, %.lr.ph110 ], [ %i.hn, %bb.d ] ; 3 uses
  ...
  %4 = tail call <4 x float> @llvm.masked.load.v4f32.p0(ptr align 4 %i.di, <4 x i1> <i1 true, i1 false, i1 false, i1 true>, <4 x float> poison), !tbaa !20
  %5 = shufflevector <4 x float> %4, <4 x float> poison, <2 x i32> <i32 0, i32 3> ; 2 uses
  ...
  %i.dw = fadd reassoc nsz arcp contract afn <2 x float> %i.dv, %i.dp ; 3 uses
  ...
  %i.ef = fadd reassoc nsz arcp contract afn <2 x float> %5, %i.ea
  %i.eg = fadd reassoc nsz arcp contract afn <2 x float> %i.ef, %i.ec
  %i.eh = fmul reassoc nsz arcp contract afn <2 x float> %5, splat (float 2.000000e+00)
  %i.ei = fmul reassoc nsz arcp contract afn <2 x float> %i.eg, splat (float 4.000000e+00)
  %i.ej = fadd reassoc nsz arcp contract afn <2 x float> %i.eh, %i.dy
  %i.ek = fadd reassoc nsz arcp contract afn <2 x float> %i.ej, %i.ei
  %i.el = fadd reassoc nsz arcp contract afn <2 x float> %i.ek, %i.ee ; 2 uses
...
._crit_edge:                                      ; preds = %.lr.ph, %bb.b
  ...
  %i.eo = phi <2 x float> [ %i.dw, %bb.b ], [ %i.fi, %.lr.ph ]
  %i.ep = phi <2 x float> [ %i.el, %bb.b ], [ %i.fx, %.lr.ph ]
  br i1 %.not.not, label %bb.c, label %bb.d

.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  %.sroa.6118.1.a = phi nsz float [ %i.gc, %.lr.ph ], [ %i.em, %.lr.ph.preheader ] ; 2 uses
  %.sroa.10.1 = phi nsz float [ %i.fz, %.lr.ph ], [ %i.en, %.lr.ph.preheader ]
  %.051105 = phi i64 [ %i.go, %.lr.ph ], [ 0, %.lr.ph.preheader ] ; 2 uses
  %.052104 = phi ptr [ %i.er, %.lr.ph ], [ %i.dd, %.lr.ph.preheader ] ; 2 uses
  %i.eq = phi <2 x float> [ %i.fx, %.lr.ph ], [ %i.el, %.lr.ph.preheader ] ; 2 uses
  %i.er = getelementptr inbounds nuw i8, ptr %.052104, i64 16 ; 7 uses
  %i.es = getelementptr [4 x i8], ptr %i.er, i64 %2 ; 2 uses
  %i.et = getelementptr i8, ptr %i.er, i64 %.idx.i ; 2 uses
  ...
  %6 = tail call <4 x float> @llvm.masked.load.v4f32.p0(ptr align 4 %i.et, <4 x i1> <i1 true, i1 false, i1 false, i1 true>, <4 x float> poison), !tbaa !20
  ...
  %i.ew = fmul reassoc nsz arcp contract afn float %.sroa.6118.1.a, 6.000000e+00
  %i.ex = load <2 x float>, ptr %.sroa.656.0..sroa_idx.i60, align 4, !tbaa !20
  %i.ey = load <2 x float>, ptr %.sroa.554.0..sroa_idx.i67, align 4, !tbaa !20
  %i.ez = load <2 x float>, ptr %.sroa.450.0..sroa_idx.i74, align 4, !tbaa !20 ; 2 uses
  %i.fa = load <2 x float>, ptr %.sroa.446.0..sroa_idx.i81, align 4, !tbaa !20
  %i.fb = load <2 x float>, ptr %.sroa.4.0..sroa_idx.i88, align 4, !tbaa !20
  %i.fc = fadd reassoc nsz arcp contract afn <2 x float> %i.ez, %i.ey
  %i.fd = fadd reassoc nsz arcp contract afn <2 x float> %i.fc, %i.fa
  %i.fe = fmul reassoc nsz arcp contract afn <2 x float> %i.ez, splat (float 2.000000e+00)
  %i.ff = fmul reassoc nsz arcp contract afn <2 x float> %i.fd, splat (float 4.000000e+00)
  %i.fg = fadd reassoc nsz arcp contract afn <2 x float> %i.fe, %i.ex
  %i.fh = fadd reassoc nsz arcp contract afn <2 x float> %i.fg, %i.ff
  %i.fi = fadd reassoc nsz arcp contract afn <2 x float> %i.fh, %i.fb ; 5 uses
  %i.fj = tail call <4 x float> @llvm.masked.load.v4f32.p0(ptr nonnull align 4 %i.er, <4 x i1> <i1 true, i1 false, i1 false, i1 true>, <4 x float> poison), !tbaa !20
  %i.fk = shufflevector <4 x float> %i.fj, <4 x float> poison, <2 x i32> <i32 0, i32 3>
  %i.fl = tail call <4 x float> @llvm.masked.load.v4f32.p0(ptr align 4 %i.es, <4 x i1> <i1 true, i1 false, i1 false, i1 true>, <4 x float> poison), !tbaa !20
  %i.fm = shufflevector <4 x float> %i.fl, <4 x float> poison, <2 x i32> <i32 0, i32 3>
  %i.fn = tail call <4 x float> @llvm.masked.load.v4f32.p0(ptr align 4 %i.eu, <4 x i1> <i1 true, i1 false, i1 false, i1 true>, <4 x float> poison), !tbaa !20
  %i.fo = shufflevector <4 x float> %i.fn, <4 x float> poison, <2 x i32> <i32 0, i32 3>
  %i.fp = tail call <4 x float> @llvm.masked.load.v4f32.p0(ptr nonnull align 4 %i.ev, <4 x i1> <i1 true, i1 false, i1 false, i1 true>, <4 x float> poison), !tbaa !20
  %i.fq = shufflevector <4 x float> %i.fp, <4 x float> poison, <2 x i32> <i32 0, i32 3>
  %i.fr = fadd reassoc nsz arcp contract afn <2 x float> %7, %i.fm
  %i.fs = fadd reassoc nsz arcp contract afn <2 x float> %i.fr, %i.fo
  %i.ft = fmul reassoc nsz arcp contract afn <2 x float> %7, splat (float 2.000000e+00)
  %i.fu = fmul reassoc nsz arcp contract afn <2 x float> %i.fs, splat (float 4.000000e+00)
  %i.fv = fadd reassoc nsz arcp contract afn <2 x float> %i.ft, %i.fk
  %i.fw = fadd reassoc nsz arcp contract afn <2 x float> %i.fv, %i.fu
  %i.fx = fadd reassoc nsz arcp contract afn <2 x float> %i.fw, %i.fq ; 4 uses
  %i.fy = getelementptr inbounds nuw [4 x i8], ptr %i.dg, i64 %.051105
  %i.fz = extractelement <2 x float> %i.fi, i64 0
  %i.ga = shufflevector <2 x float> %i.fx, <2 x float> %i.fi, <2 x i32> <i32 0, i32 2>
  %i.gb = fadd reassoc nsz arcp contract afn <2 x float> %i.eq, %i.ga ; 2 uses
  %i.gc = extractelement <2 x float> %i.fi, i64 1
  %i.gd = shufflevector <2 x float> %i.gb, <2 x float> %i.eq, <2 x i32> <i32 3, i32 1>
  %i.ge = fmul reassoc nsz arcp contract afn <2 x float> %i.gd, splat (float 4.000000e+00)
  %i.gf = shufflevector <2 x float> %i.fx, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %i.gg = insertelement <2 x float> %i.gf, float %.sroa.10.1, i64 0
  %i.gh = fmul reassoc nsz arcp contract afn <2 x float> %i.gg, <float 4.000000e+00, float 6.000000e+00>
  %i.gi = insertelement <2 x float> %i.gb, float %.sroa.6118.1.a, i64 1
  %i.gj = fadd reassoc nsz arcp contract afn <2 x float> %i.gh, %i.gi
  %i.gk = insertelement <2 x float> %i.fi, float %i.ew, i64 0
  %i.gl = fadd reassoc nsz arcp contract afn <2 x float> %i.gj, %i.gk
  %i.gm = fadd reassoc nsz arcp contract afn <2 x float> %i.gl, %i.ge
  %i.gn = fmul reassoc nsz arcp contract afn <2 x float> %i.gm, splat (float 3.906250e-03)
  store <2 x float> %i.gn, ptr %i.fy, align 4, !tbaa !20
  %i.go = add i64 %.051105, 2                     ; 2 uses
  %i.gp = icmp ult i64 %i.go, %i.g
  br i1 %i.gp, label %.lr.ph, label %._crit_edge

bb.c:                                             ; preds = %._crit_edge
  %i.gq = getelementptr inbounds nuw i8, ptr %.052.lcssa, i64 16 ; 5 uses
  %i.gr = getelementptr inbounds nuw [4 x i8], ptr %i.gq, i64 %2
  %i.gs = load float, ptr %i.gr, align 4, !tbaa !20
  %i.gt = getelementptr inbounds nuw i8, ptr %i.gq, i64 %.idx41.i
  %i.gu = load float, ptr %i.gt, align 4, !tbaa !20
  %i.gv = getelementptr inbounds nuw i8, ptr %i.gq, i64 %.idx.i
  %i.gw = load float, ptr %i.gv, align 4, !tbaa !20
  %i.gx = getelementptr inbounds nuw i8, ptr %i.gq, i64 %.idx42.i
  %i.gy = fadd reassoc nsz arcp contract afn float %i.gu, %i.gs
  %i.gz = load float, ptr %i.gq, align 4, !tbaa !20
  %i.ha = load float, ptr %i.gx, align 4, !tbaa !20
  %i.hb = insertelement <8 x float> poison, float %i.gy, i64 0
  %i.hc = insertelement <8 x float> %i.hb, float %i.gw, i64 1
  %i.hd = shufflevector <2 x float> %i.ep, <2 x float> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.he = shufflevector <8 x float> %i.hc, <8 x float> %i.hd, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 9, i32 poison, i32 poison, i32 8>
  %i.hf = insertelement <8 x float> %i.he, float %i.ha, i64 5
  %i.hg = insertelement <8 x float> %i.hf, float %i.gz, i64 6
  %i.hh = shufflevector <2 x float> %i.eo, <2 x float> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.hi = shufflevector <8 x float> %i.hg, <8 x float> %i.hh, <8 x i32> <i32 0, i32 1, i32 8, i32 9, i32 4, i32 5, i32 6, i32 7>
  %i.hj = fmul reassoc nsz arcp contract afn <8 x float> %i.hi, <float 4.000000e+00, float 6.000000e+00, float 4.000000e+00, float 6.000000e+00, float 4.000000e+00, float 1.000000e+00, float 1.000000e+00, float 1.000000e+00>
  %i.hk = tail call reassoc nsz arcp contract afn float @llvm.vector.reduce.fadd.v8f32(float 0.000000e+00, <8 x float> %i.hj)
  %i.hl = fmul reassoc nsz arcp contract afn float %i.hk, 3.906250e-03
  %i.hm = getelementptr inbounds nuw [4 x i8], ptr %i.dg, i64 %i.g
  store float %i.hl, ptr %i.hm, align 4, !tbaa !20
  br label %bb.d

bb.d:                                             ; preds = %bb.c, %._crit_edge
  %i.hn = add nuw nsw i64 %.049108, 1             ; 2 uses
  %exitcond.not = icmp eq i64 %i.hn, %i.e
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.au = add i32 %i.q, %i.l
  %i.av = sext i32 %i.au to i64
  %i.aw = getelementptr inbounds [4 x i8], ptr %0, i64 %i.av
  %i.ax = load float, ptr %i.aw, align 4, !tbaa !20
  %i.ay = getelementptr i8, ptr %i.am, i64 4
  %i.az = load float, ptr %i.ay, align 4, !tbaa !20
  %i.ba = fadd reassoc nsz arcp contract afn float %i.at, %i.ar
  %i.bb = fadd reassoc nsz arcp contract afn float %i.ba, %i.ap
