...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  %.sroa.10.1.a = phi nsz float [ %i.fy, %.lr.ph ], [ %i.en, %.lr.ph.preheader ]
  %.sroa.6118.1 = phi nsz float [ %i.fz, %.lr.ph ], [ %i.em, %.lr.ph.preheader ] ; 2 uses
  ...
  %i.ga = insertelement <2 x float> poison, float %.sroa.10.1.a, i64 0
  ...
  %i.gf = fmul reassoc nsz arcp contract afn float %.sroa.6118.1, 6.000000e+00
  %i.gg = insertelement <2 x float> %foldExtExtBinop, float %.sroa.6118.1, i64 1
