...
vector.body1853:                                  ; preds = %vector.main.loop.iter.check1847, %vector.body1853
  ...
  %i.lh = mul nuw nsw <4 x i64> %vec.ind1855, %broadcast.splat1852
  %i.li = mul nuw nsw <4 x i64> %step.add1860, %broadcast.splat1852
  %i.lj = mul nuw nsw <4 x i64> %step.add.21861, %broadcast.splat1852
  %i.lk = mul nuw nsw <4 x i64> %step.add.31862, %broadcast.splat1852
...
vec.epilog.scalar.ph1885:                         ; preds = %vec.epilog.scalar.ph1885.preheader, %vec.epilog.scalar.ph1885
  ...
  %i.mg = mul nuw nsw i64 %indvars.iv640, %i.b
...
vector.body1805:                                  ; preds = %vector.main.loop.iter.check1799, %vector.body1805
  ...
  %i.ou = mul nuw nsw <4 x i64> %vec.ind1807, %broadcast.splat1804
  %i.ov = mul nuw nsw <4 x i64> %step.add1808, %broadcast.splat1804
  %i.ow = mul nuw nsw <4 x i64> %step.add.21809, %broadcast.splat1804
  %i.ox = mul nuw nsw <4 x i64> %step.add.31810, %broadcast.splat1804
...
vec.epilog.scalar.ph1825.prol:                    ; preds = %vec.epilog.scalar.ph1825.preheader, %vec.epilog.scalar.ph1825.prol
  ...
  %i.ph = mul nuw nsw i64 %indvars.iv656.prol, %i.b
...
vec.epilog.scalar.ph1825:                         ; preds = %vec.epilog.scalar.ph1825.prol.loopexit, %vec.epilog.scalar.ph1825
  ...
  %i.bru = mul nuw nsw i64 %indvars.iv656, %i.b
  ...
  %i.brx = mul nuw nsw i64 %indvars.iv.next657, %i.b
  ...
  %i.bsa = mul nuw nsw i64 %indvars.iv.next657.1, %i.b
  ...
  %i.bsd = mul nuw nsw i64 %indvars.iv.next657.2, %i.b
  ...
  %i.bsg = mul nuw nsw i64 %indvars.iv.next657.3, %i.b
  ...
  %i.bsj = mul nuw nsw i64 %indvars.iv.next657.4, %i.b
  ...
  %i.bsm = mul nuw nsw i64 %indvars.iv.next657.5, %i.b
  ...
  %i.bsp = mul nuw nsw i64 %indvars.iv.next657.6, %i.b
...
iter.check863:                                    ; preds = %bb.ak
  ...
  %11 = trunc i64 %indvars.iv667 to i32
...
vector.ph832:                                     ; preds = %vector.main.loop.iter.check830
  ...
  %broadcast.splatinsert834 = insertelement <4 x i32> poison, i32 %12, i64 0
...
vector.body834:                                   ; preds = %vector.body834, %vector.ph832
  ...
  %13 = add nsw <4 x i32> %wide.load, %broadcast.splat835
  %14 = add nsw <4 x i32> %wide.load840, %broadcast.splat835
  %15 = add nsw <4 x i32> %wide.load841, %broadcast.splat835
  %16 = add nsw <4 x i32> %wide.load842, %broadcast.splat835
  ...
  %wide.gep843 = getelementptr inbounds [8 x i8], ptr %i.e, <4 x i64> %i.bta
  %wide.gep844 = getelementptr inbounds [8 x i8], ptr %i.e, <4 x i64> %i.btb
  %wide.gep845 = getelementptr inbounds [8 x i8], ptr %i.e, <4 x i64> %i.btc
  %wide.gep846 = getelementptr inbounds [8 x i8], ptr %i.e, <4 x i64> %i.btd
  ...
  %i.bte = getelementptr inbounds nuw [8 x i8], ptr %10, i64 %index835 ; 4 uses
...
vec.epilog.ph867:                                 ; preds = %vector.main.loop.iter.check830, %vec.epilog.iter.check865
  ...
  %broadcast.splatinsert871 = insertelement <4 x i32> poison, i32 %12, i64 0
...
vec.epilog.vector.body869:                        ; preds = %vec.epilog.vector.body869, %vec.epilog.ph867
  ...
  %17 = add nsw <4 x i32> %wide.load872, %broadcast.splat872
  %i.btu = sext <4 x i32> %17 to <4 x i64>
  %wide.gep873 = getelementptr inbounds [8 x i8], ptr %i.e, <4 x i64> %i.btu
  ...
  %i.btv = getelementptr inbounds nuw [8 x i8], ptr %10, i64 %index870
...
vec.epilog.scalar.ph864:                          ; preds = %vec.epilog.scalar.ph864.preheader, %vec.epilog.scalar.ph864
  ...
  %i.bug = getelementptr inbounds nuw [8 x i8], ptr %10, i64 %indvars.iv664
