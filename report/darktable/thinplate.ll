...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph
  ...
  %i.hw = mul nsw i64 %indvars.iv610, %i.b
...
vector.body1848:                                  ; preds = %vector.main.loop.iter.check1842, %vector.body1848
  ...
  %i.lh = mul nsw <4 x i64> %vec.ind1850, %broadcast.splat1847
  %i.li = mul nsw <4 x i64> %step.add1855, %broadcast.splat1847
  %i.lj = mul nsw <4 x i64> %step.add.21856, %broadcast.splat1847
  %i.lk = mul nsw <4 x i64> %step.add.31857, %broadcast.splat1847
...
vec.epilog.scalar.ph1880:                         ; preds = %vec.epilog.scalar.ph1880.preheader, %vec.epilog.scalar.ph1880
  ...
  %i.mg = mul nsw i64 %indvars.iv635, %i.b
...
vector.body1800:                                  ; preds = %vector.main.loop.iter.check1794, %vector.body1800
  ...
  %i.ou = mul nsw <4 x i64> %vec.ind1802, %broadcast.splat1799
  %i.ov = mul nsw <4 x i64> %step.add1803, %broadcast.splat1799
  %i.ow = mul nsw <4 x i64> %step.add.21804, %broadcast.splat1799
  %i.ox = mul nsw <4 x i64> %step.add.31805, %broadcast.splat1799
...
vec.epilog.scalar.ph1820.prol:                    ; preds = %vec.epilog.scalar.ph1820.preheader, %vec.epilog.scalar.ph1820.prol
  ...
  %i.ph = mul nsw i64 %indvars.iv651.prol, %i.b
...
vec.epilog.scalar.ph1820:                         ; preds = %vec.epilog.scalar.ph1820.prol.loopexit, %vec.epilog.scalar.ph1820
  ...
  %i.bru = mul nsw i64 %indvars.iv651, %i.b
  ...
  %i.brx = mul nsw i64 %indvars.iv.next652, %i.b
  ...
  %i.bsa = mul nsw i64 %indvars.iv.next652.1, %i.b
  ...
  %i.bsd = mul nsw i64 %indvars.iv.next652.2, %i.b
  ...
  %i.bsg = mul nsw i64 %indvars.iv.next652.3, %i.b
  ...
  %i.bsj = mul nsw i64 %indvars.iv.next652.4, %i.b
  ...
  %i.bsm = mul nsw i64 %indvars.iv.next652.5, %i.b
  ...
  %i.bsp = mul nsw i64 %indvars.iv.next652.6, %i.b
...
iter.check858:                                    ; preds = %bb.ak
  %10 = mul nsw i64 %indvars.iv662, %i.b
...
vector.body829:                                   ; preds = %vector.body829, %vector.ph827
  ...
  %i.btb = sext <4 x i32> %wide.load835 to <4 x i64>
  %i.btc = sext <4 x i32> %wide.load836 to <4 x i64>
  %i.btd = sext <4 x i32> %wide.load837 to <4 x i64>
  %wide.gep838 = getelementptr [8 x i8], ptr %12, <4 x i64> %i.bta
  %wide.gep839 = getelementptr [8 x i8], ptr %12, <4 x i64> %i.btb
  %wide.gep840 = getelementptr [8 x i8], ptr %12, <4 x i64> %i.btc
  %wide.gep841 = getelementptr [8 x i8], ptr %12, <4 x i64> %i.btd
  ...
  %i.bte = getelementptr inbounds nuw [8 x i8], ptr %11, i64 %index830 ; 4 uses
...
vec.epilog.vector.body864:                        ; preds = %vec.epilog.vector.body864, %vec.epilog.ph862
  ...
  %i.btu = sext <4 x i32> %wide.load867 to <4 x i64>
  %wide.gep868 = getelementptr [8 x i8], ptr %12, <4 x i64> %i.btu
  ...
  %i.btv = getelementptr inbounds nuw [8 x i8], ptr %11, i64 %index865
...
vec.epilog.scalar.ph859:                          ; preds = %vec.epilog.scalar.ph859.preheader, %vec.epilog.scalar.ph859
  ...
  %i.bug = getelementptr inbounds nuw [8 x i8], ptr %11, i64 %indvars.iv659
