...
vector.body1257:                                  ; preds = %vector.main.loop.iter.check1248, %vector.body1257
  ...
  %i.amj = mul nsw <4 x i64> %vec.ind1259, %broadcast.splat1253
  %i.amk = mul nsw <4 x i64> %step.add1264, %broadcast.splat1253
  %i.aml = mul nsw <4 x i64> %step.add.21265, %broadcast.splat1253
  %i.amm = mul nsw <4 x i64> %step.add.31266, %broadcast.splat1253
...
vec.epilog.vector.body1300:                       ; preds = %vec.epilog.vector.body1300, %vec.epilog.ph1293
  ...
  %i.amz = mul nsw <4 x i64> %vec.ind1302, %broadcast.splat1296
