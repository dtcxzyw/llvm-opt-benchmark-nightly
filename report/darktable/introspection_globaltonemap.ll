...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load.fr = freeze <8 x float> %wide.load
  %i.dj = fmul reassoc nsz arcp contract afn <8 x float> %wide.load.fr, splat (float f0x3C23D70A) ; 2 uses
  %wide.load69.fr = freeze <8 x float> %wide.load69
  %i.dk = fmul reassoc nsz arcp contract afn <8 x float> %wide.load69.fr, splat (float f0x3C23D70A) ; 2 uses
  %wide.load70.fr = freeze <8 x float> %wide.load70
  %i.dl = fmul reassoc nsz arcp contract afn <8 x float> %wide.load70.fr, splat (float f0x3C23D70A) ; 2 uses
  %wide.load71.fr = freeze <8 x float> %wide.load71
  %i.dm = fmul reassoc nsz arcp contract afn <8 x float> %wide.load71.fr, splat (float f0x3C23D70A) ; 2 uses
