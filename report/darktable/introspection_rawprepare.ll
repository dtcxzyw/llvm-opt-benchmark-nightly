...
.preheader274.lr.ph.split.split:                  ; preds = %.preheader274.lr.ph
  ...
  %i.lx = shl i64 %i.lw, 2
  %scevgep440 = getelementptr i8, ptr %2, i64 %i.lv
...
iter.check475:                                    ; preds = %.preheader274, %._crit_edge294
  ...
  %i.ms = getelementptr [4 x i8], ptr %2, i64 %i.mp ; 8 uses
...
vector.memcheck437:                               ; preds = %iter.check475
  ...
  %i.mw = mul i64 %i.ly, %i.mv
  %scevgep440.a = getelementptr i8, ptr %scevgep440, i64 %i.mw
  %bound0444 = icmp ult ptr %scevgep438, %scevgep440.a
  %bound1445 = icmp ult ptr %i.ms, %scevgep439
