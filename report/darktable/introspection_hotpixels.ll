...
bb.ah:                                            ; preds = %bb.ag
  ...
  %i.qb = load i8, ptr %i.qa, align 1, !tbaa !79
...
bb.ai:                                            ; preds = %bb.ak, %bb.ah
  ...
  %i.qf = load <2 x i32>, ptr %i.qe, align 8, !tbaa !80 ; 3 uses
  ...
  %i.qo = load i8, ptr %i.qn, align 1, !tbaa !79
...
bb.al:                                            ; preds = %bb.ak
  ...
  %i.ra = load i8, ptr %i.qz, align 1, !tbaa !79
...
bb.am:                                            ; preds = %bb.ao, %bb.al
  ...
  %i.re = load <2 x i32>, ptr %i.rd, align 8, !tbaa !80 ; 3 uses
  ...
  %i.rn = load i8, ptr %i.rm, align 1, !tbaa !79
...
bb.ap:                                            ; preds = %bb.ao
  ...
  %i.rz = load i8, ptr %i.ry, align 1, !tbaa !79
...
bb.aq:                                            ; preds = %bb.as, %bb.ap
  ...
  %i.sd = load <2 x i32>, ptr %i.sc, align 8, !tbaa !80 ; 3 uses
  ...
  %i.sm = load i8, ptr %i.sl, align 1, !tbaa !79
...
bb.au:                                            ; preds = %bb.aw, %.preheader121.i
  ...
  %i.sy = load <2 x i32>, ptr %i.sx, align 8, !tbaa !80 ; 3 uses
  ...
  %i.th = load i8, ptr %i.tg, align 1, !tbaa !79
...
.lr.ph112.split.us.i:                             ; preds = %.lr.ph112.i
  ...
  %i.uk = load i32, ptr %i.uj, align 4, !tbaa !50
...
.lr.ph108.us.us.i.preheader:                      ; preds = %.lr.ph112.split.us.i
  ...
  %i.up = mul i64 %i.uo, %i.ue                    ; 4 uses
  %i.uq = add nsw i32 %i.uc, -5
  %i.ur = zext i32 %i.uq to i64
  %i.us = shl nuw nsw i64 %i.ur, 2                ; 4 uses
  ...
  %i.uv = shl nuw nsw i64 %6, 2                   ; 2 uses
  ...
  %7 = getelementptr i8, ptr %2, i64 %i.up
  %i.vb = getelementptr i8, ptr %7, i64 %i.us
  %scevgep145 = getelementptr i8, ptr %i.vb, i64 20
  %i.vc = add nuw nsw i64 %i.ul, 8
  %8 = sext i32 %i.ud to i64
  %9 = shl nsw i64 %8, 2                          ; 2 uses
  %i.vd = sub nsw i64 %i.vc, %9
  %scevgep146 = getelementptr i8, ptr %2, i64 %i.vd
  %10 = add i64 %i.up, %i.us
  %i.ve = add i64 %10, 12
  %i.vf = sub i64 %i.ve, %9
...
vector.body165:                                   ; preds = %vector.body165, %vector.ph157
  ...
  %wide.load = load <8 x float>, ptr %next.gep168, align 4, !tbaa !51, !alias.scope !81 ; 2 uses
  %wide.load169 = load <8 x float>, ptr %i.vy, align 4, !tbaa !51, !alias.scope !81 ; 2 uses
  ...
  %wide.masked.load = tail call <8 x float> @llvm.masked.load.v8f32.p0(ptr align 4 %i.wd, <8 x i1> %i.vz, <8 x float> poison), !tbaa !51, !alias.scope !81 ; 3 uses
  %wide.masked.load170 = tail call <8 x float> @llvm.masked.load.v8f32.p0(ptr align 4 %i.we, <8 x i1> %i.wa, <8 x float> poison), !tbaa !51, !alias.scope !81 ; 3 uses
  ...
  %wide.masked.load171 = tail call <8 x float> @llvm.masked.load.v8f32.p0(ptr align 4 %i.wj, <8 x i1> %i.vz, <8 x float> poison), !tbaa !51, !alias.scope !84 ; 3 uses
  %wide.masked.load172 = tail call <8 x float> @llvm.masked.load.v8f32.p0(ptr align 4 %i.wk, <8 x i1> %i.wa, <8 x float> poison), !tbaa !51, !alias.scope !84 ; 3 uses
  ...
  %wide.masked.load173 = tail call <8 x float> @llvm.masked.load.v8f32.p0(ptr align 4 %i.wr, <8 x i1> %i.vz, <8 x float> poison), !tbaa !51, !alias.scope !81 ; 3 uses
  %wide.masked.load174 = tail call <8 x float> @llvm.masked.load.v8f32.p0(ptr align 4 %i.ws, <8 x i1> %i.wa, <8 x float> poison), !tbaa !51, !alias.scope !81 ; 3 uses
  ...
  %wide.masked.load175 = tail call <8 x float> @llvm.masked.load.v8f32.p0(ptr align 4 %i.wz, <8 x i1> %i.vz, <8 x float> poison), !tbaa !51, !alias.scope !86 ; 3 uses
  %wide.masked.load176 = tail call <8 x float> @llvm.masked.load.v8f32.p0(ptr align 4 %i.xa, <8 x i1> %i.wa, <8 x float> poison), !tbaa !51, !alias.scope !86 ; 3 uses
  ...
  tail call void @llvm.masked.store.v8f32.p0(<8 x float> %i.yh, ptr align 4 %next.gep, <8 x i1> %i.xj), !tbaa !51, !alias.scope !88, !noalias !90
  tail call void @llvm.masked.store.v8f32.p0(<8 x float> %i.yi, ptr align 4 %i.yj, <8 x i1> %i.xk), !tbaa !51, !alias.scope !88, !noalias !90
  ...
  br i1 %i.ym, label %middle.block179, label %vector.body165, !llvm.loop !91
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load195 = load <8 x float>, ptr %next.gep194, align 4, !tbaa !51, !alias.scope !81 ; 2 uses
  ...
  %wide.masked.load196 = tail call <8 x float> @llvm.masked.load.v8f32.p0(ptr align 4 %i.yu, <8 x i1> %i.ys, <8 x float> poison), !tbaa !51, !alias.scope !81 ; 3 uses
  ...
  %wide.masked.load197 = tail call <8 x float> @llvm.masked.load.v8f32.p0(ptr align 4 %i.yx, <8 x i1> %i.ys, <8 x float> poison), !tbaa !51, !alias.scope !84 ; 3 uses
  ...
  %wide.masked.load198 = tail call <8 x float> @llvm.masked.load.v8f32.p0(ptr align 4 %i.zb, <8 x i1> %i.ys, <8 x float> poison), !tbaa !51, !alias.scope !81 ; 3 uses
  ...
  %wide.masked.load199 = tail call <8 x float> @llvm.masked.load.v8f32.p0(ptr align 4 %i.zf, <8 x i1> %i.ys, <8 x float> poison), !tbaa !51, !alias.scope !86 ; 3 uses
end_hunk_0
