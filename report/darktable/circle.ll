...
dt_get_debug_wtime.exit:                          ; preds = %bb.a, %bb.b
  ...
  %14 = load <2 x i32>, ptr %i.p, align 16, !tbaa !24 ; 3 uses
  %15 = load <2 x float>, ptr %i.m, align 4, !tbaa !22
  %16 = sitofp <2 x i32> %14 to <2 x float>
  %17 = fmul reassoc nsz arcp contract afn <2 x float> %15, %16 ; 7 uses
  %18 = extractelement <2 x i32> %14, i64 0
  %19 = extractelement <2 x i32> %14, i64 1
  %i.q = tail call i32 @llvm.smin.i32(i32 %18, i32 %19)
...
vector.ph:                                        ; preds = %.lr.ph
  ...
  %broadcast.splat534 = shufflevector <2 x float> %17, <2 x float> poison, <8 x i32> zeroinitializer ; 4 uses
  %broadcast.splat536 = shufflevector <2 x float> %17, <2 x float> poison, <8 x i32> <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1> ; 4 uses
...
scalar.ph.preheader:                              ; preds = %.lr.ph, %middle.block
  ...
  %20 = shufflevector <2 x float> %17, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 4 uses
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %i.do = shufflevector <4 x float> %20, <4 x float> %i.dn, <4 x i32> <i32 0, i32 1, i32 4, i32 5> ; 2 uses
  %i.dp = shufflevector <4 x float> %i.dn, <4 x float> %20, <4 x i32> <i32 1, i32 0, i32 5, i32 4> ; 2 uses
  ...
  %i.du = shufflevector <4 x float> %20, <4 x float> %i.dn, <4 x i32> <i32 0, i32 1, i32 5, i32 4> ; 2 uses
  %i.dv = shufflevector <4 x float> %i.dn, <4 x float> %20, <4 x i32> <i32 0, i32 1, i32 5, i32 4> ; 2 uses
...
.preheader.preheader:                             ; preds = %bb.z, %bb.y
  ...
  %broadcast.splat606 = shufflevector <2 x float> %17, <2 x float> poison, <8 x i32> zeroinitializer
  %broadcast.splat608 = shufflevector <2 x float> %17, <2 x float> poison, <8 x i32> <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>
...
scalar.ph599:                                     ; preds = %scalar.ph599.preheader, %scalar.ph599
  ...
  %i.na = fsub reassoc nsz arcp contract afn float %i.mz, %21 ; 2 uses
  %i.nb = getelementptr inbounds nuw i8, ptr %i.my, i64 4
  %i.nc = load float, ptr %i.nb, align 4, !tbaa !22
  %i.nd = fsub reassoc nsz arcp contract afn float %i.nc, %22 ; 2 uses
