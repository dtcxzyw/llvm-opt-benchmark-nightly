...
.preheader298:                                    ; preds = %vec.epilog.scalar.ph950
  ...
  %i.dg = shl nuw nsw i64 %wide.trip.count359, 2  ; 2 uses
  ...
  %i.do = shl nuw nsw i64 %i.cw, 2                ; 2 uses
  ...
  %scevgep865.a = getelementptr i8, ptr %.0233, i64 %i.dt
  %scevgep870 = getelementptr i8, ptr %scevgep869, i64 %i.dt
  %scevgep873 = getelementptr i8, ptr %.0233, i64 %i.dt
...
.lr.ph312:                                        ; preds = %bb.g
  ...
  %i.ff = shl nuw nsw i64 %i.ew, 2                ; 5 uses
  %1 = add nuw nsw i64 %i.do, %i.ff               ; 2 uses
  %2 = shl nuw nsw i64 %i.ez, 2                   ; 4 uses
  %3 = sub nsw i64 %i.ff, %2
  %i.fg = sub nsw i64 %1, %2
  ...
  %scevgep864 = getelementptr i8, ptr %scevgep863, i64 %2 ; 3 uses
  %i.fr = add nuw nsw i64 %2, %i.fh               ; 3 uses
  %scevgep866 = getelementptr i8, ptr %scevgep865.a, i64 %i.fr
  %scevgep868 = getelementptr i8, ptr %scevgep867, i64 %i.fh
  %scevgep871 = getelementptr i8, ptr %scevgep870, i64 %i.fr
  %scevgep872 = getelementptr i8, ptr %.0233, i64 %i.fr
  %i.fs = shl nuw nsw i64 %i.ez, 3
  %i.ft = getelementptr i8, ptr %scevgep873, i64 %i.fs
  %scevgep874 = getelementptr i8, ptr %i.ft, i64 %i.fh
  %i.fu = getelementptr i8, ptr %.0233, i64 %i.ff
  %i.fv = getelementptr i8, ptr %.0233, i64 %1
  %i.fw = getelementptr i8, ptr %.0233, i64 %3
...
.lr.ph318:                                        ; preds = %.preheader296
  ...
  %i.gp = shl nuw nsw i64 %i.gi, 2                ; 5 uses
  %4 = add nuw nsw i64 %i.dg, %i.gp               ; 2 uses
  %5 = shl nuw nsw i64 %i.gl, 2                   ; 5 uses
  %6 = sub nsw i64 %i.gp, %5
  %i.gq = sub nsw i64 %4, %5
  ...
  %scevgep650 = getelementptr i8, ptr %scevgep649, i64 %5 ; 3 uses
  %i.hb = getelementptr i8, ptr %scevgep652, i64 %5
  %scevgep653 = getelementptr i8, ptr %i.hb, i64 %i.gr
  %scevgep655 = getelementptr i8, ptr %scevgep654, i64 %i.gr
  %i.hc = add nuw nsw i64 %i.gr, %5               ; 2 uses
  ...
  %i.hg = getelementptr i8, ptr %.0233, i64 %4
  %i.hh = getelementptr i8, ptr %.0233, i64 %6
