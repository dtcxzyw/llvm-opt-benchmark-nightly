...
.thread24.i:                                      ; preds = %bb.g, %bb.f
  ...
  %6 = getelementptr inbounds nuw i8, ptr %i.a, i64 32
  ...
  %i.bs = sitofp <2 x i32> %i.br to <2 x float>   ; 4 uses
  %i.bt = extractelement <2 x float> %i.bs, i64 0 ; 4 uses
  %i.bu = fptosi float %i.bt to i32               ; 2 uses
  %i.bv = extractelement <2 x float> %i.bs, i64 1 ; 4 uses
  ...
  %i.bz = load float, ptr %i.bm, align 8, !tbaa !15, !noalias !421 ; 2 uses
  %7 = load float, ptr %6, align 32, !tbaa !15, !noalias !421 ; 2 uses
  %8 = load float, ptr %i.bn, align 4, !tbaa !15, !noalias !421 ; 2 uses
  ...
  %9 = fmul reassoc nsz arcp contract afn float %i.bz, %i.bt
  %10 = fmul reassoc nsz arcp contract afn float %i.bz, 0.000000e+00
  %11 = fadd reassoc nsz arcp contract afn float %7, %9 ; 2 uses
  %12 = fmul reassoc nsz arcp contract afn float %8, %i.bv ; 2 uses
  %13 = fadd reassoc nsz arcp contract afn float %7, %10 ; 2 uses
  %14 = fmul reassoc nsz arcp contract afn float %8, 0.000000e+00 ; 2 uses
  %15 = fadd reassoc nsz arcp contract afn <2 x float> %i.cm, %i.cd
  %16 = fadd reassoc nsz arcp contract afn float %11, %14
  %17 = fadd reassoc nsz arcp contract afn float %11, %12
  %18 = fadd reassoc nsz arcp contract afn float %13, %12
  %19 = fadd reassoc nsz arcp contract afn float %13, %14
  ...
  %i.co = fdiv reassoc nsz arcp contract afn <2 x float> %i.cj, %24 ; 9 uses
  %25 = insertelement <2 x float> poison, float %17, i64 0
  %26 = shufflevector <2 x float> %25, <2 x float> poison, <2 x i32> zeroinitializer
  %i.cp = fdiv reassoc nsz arcp contract afn <2 x float> %i.cn, %26 ; 9 uses
  ...
  %i.cr = fdiv reassoc nsz arcp contract afn <2 x float> %15, %28 ; 10 uses
...
.lr.ph.i.i.i:                                     ; preds = %bb.g, %dt_XYZ_to_Lab.exit.i.i.i
  ...
  %i.de = getelementptr inbounds nuw [4 x i8], ptr %i.ah, i64 %.02943.i.i.i ; 4 uses
  %4 = getelementptr inbounds nuw i8, ptr %i.de, i64 4
  ...
  %5 = load float, ptr %i.de, align 16, !tbaa !15
  %6 = load float, ptr %4, align 4, !tbaa !15
  %7 = insertelement <4 x float> poison, float %5, i64 0
  %i.dk = shufflevector <4 x float> %7, <4 x float> poison, <4 x i32> zeroinitializer
  ...
  %8 = insertelement <4 x float> poison, float %6, i64 0
  %9 = shufflevector <4 x float> %8, <4 x float> poison, <4 x i32> zeroinitializer
  %i.dm = fmul reassoc nsz arcp contract afn <4 x float> %9, <float f0x3EC5273A, float f0x3F37855B, float f0x3DC6DEB9, float 1.000000e+00>
