...
bb.a:
  ...
  %i.dx = fmul reassoc nsz arcp contract afn <2 x float> %i.dw, %i.dv ; 2 uses
  %i.dy = extractelement <2 x float> %i.dx, i64 0 ; 4 uses
  %i.dz = extractelement <2 x float> %i.dx, i64 1 ; 4 uses
  %i.ea = fcmp reassoc nsz arcp contract afn ogt float %i.dy, %i.dz
  %4 = fdiv reassoc nsz arcp contract afn float %i.dy, %i.dz
  %5 = fdiv reassoc nsz arcp contract afn float %i.dz, %i.dy
  %i.eb = select reassoc nsz arcp contract afn i1 %i.ea, float %4, float %5
...
bb.a:
  ...
  %i.dz = fmul reassoc nsz arcp contract afn <2 x float> %i.dy, %i.dx ; 2 uses
  %i.ea = extractelement <2 x float> %i.dz, i64 0 ; 4 uses
  %i.eb = extractelement <2 x float> %i.dz, i64 1 ; 4 uses
  %i.ec = fcmp reassoc nsz arcp contract afn ogt float %i.ea, %i.eb
  %4 = fdiv reassoc nsz arcp contract afn float %i.ea, %i.eb
  %5 = fdiv reassoc nsz arcp contract afn float %i.eb, %i.ea
  %i.ed = select reassoc nsz arcp contract afn i1 %i.ec, float %4, float %5
