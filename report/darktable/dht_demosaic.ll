...
.lr.ph:                                           ; preds = %_ZN6LibRaw5COLOREii.exit141
  ...
  %i.bo = load i32, ptr %i.bn, align 4, !tbaa !79 ; 8 uses
  ...
  %2 = insertelement <2 x i32> poison, i32 %i.bk, i64 0
  %3 = shufflevector <2 x i32> %2, <2 x i32> poison, <2 x i32> zeroinitializer
  %4 = insertelement <2 x i32> poison, i32 %i.bo, i64 0
...
bb.l:                                             ; preds = %bb.k, %bb.j
  ...
  %.0124 = phi i32 [ 0, %bb.j ], [ 1, %bb.k ]
  %.0123 = phi i32 [ -1, %bb.j ], [ 0, %bb.k ]
  %.0122 = phi i32 [ 0, %bb.j ], [ -1, %bb.k ]
  %.0121 = phi i32 [ 1, %bb.j ], [ 0, %bb.k ]
  %.0120 = phi nsz float [ %i.cy, %bb.j ], [ %i.dp, %bb.k ]
  %.0119 = phi nsz float [ %i.de, %bb.j ], [ %i.dy, %bb.k ]
  %6 = phi <2 x i32> [ zeroinitializer, %bb.j ], [ <i32 2, i32 -2>, %bb.k ]
  %7 = phi <2 x i32> [ <i32 -2, i32 2>, %bb.j ], [ zeroinitializer, %bb.k ]
  %i.ea = getelementptr inbounds [12 x i8], ptr %i.ca, i64 %i.co
  %8 = trunc nsw i64 %i.cn to i32                 ; 3 uses
  %9 = add nsw <2 x i32> %7, %3
  %10 = insertelement <2 x i32> poison, i32 %8, i64 0
  %11 = shufflevector <2 x i32> %10, <2 x i32> poison, <2 x i32> zeroinitializer
  %12 = add nsw <2 x i32> %6, %11
  %13 = mul nsw <2 x i32> %9, %5
  %14 = add nsw <2 x i32> %12, %13                ; 2 uses
  %15 = extractelement <2 x i32> %14, i64 0
  %i.eb = sext i32 %15 to i64
