...
bb.b:                                             ; preds = %bb.a
  ...
  %i.an = getelementptr inbounds nuw i8, ptr %i.h, i64 4
...
bb.c:                                             ; preds = %bb.d
  ...
  %5 = load <2 x float>, ptr %i.h, align 4, !tbaa !17
  %6 = fmul reassoc nsz arcp contract afn <2 x float> %5, splat (float 3.906250e-03)
  %7 = fadd reassoc nsz arcp contract afn <2 x float> %6, splat (float 5.000000e-01) ; 2 uses
  %8 = extractelement <2 x float> %7, i64 0
  %i.bk = fmul reassoc nsz arcp contract afn float %8, %i.as
  %9 = extractelement <2 x float> %7, i64 1
  %reass.mul68 = fmul reassoc nsz arcp contract afn float %9, %i.av
