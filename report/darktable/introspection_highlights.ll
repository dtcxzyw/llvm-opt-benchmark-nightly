...
.preheader.preheader.i.i:                         ; preds = %.preheader.lr.ph.i.i
  ...
  %7 = shufflevector <4 x float> %i.zt, <4 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
...
bb.ev:                                            ; preds = %bb.eu
  ...
  %8 = insertelement <4 x float> poison, float %i.alb, i64 0
  %9 = insertelement <4 x float> %8, float %i.ald, i64 1
  %10 = insertelement <4 x float> %9, float %i.alh, i64 2
  %11 = insertelement <4 x float> %10, float %i.alf, i64 3
  %12 = fcmp reassoc nsz arcp contract afn ogt <4 x float> %11, %7
  %13 = freeze <4 x i1> %12
  %14 = bitcast <4 x i1> %13 to i4
  %15 = icmp ne i4 %14, 0
  %i.alx = zext i1 %15 to i32                     ; 2 uses
