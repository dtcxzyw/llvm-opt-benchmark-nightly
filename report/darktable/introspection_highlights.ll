...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ahh = select <8 x i1> %i.afi, <8 x i1> %i.ahg, <8 x i1> zeroinitializer
  %7 = or <8 x i1> %i.ahh, %i.aez                 ; 2 uses
  ...
  %i.ahm = select <8 x i1> %7, <8 x i1> %i.ahl, <8 x i1> zeroinitializer ; 2 uses
  ...
  %i.aht = select <8 x i1> %7, <8 x i1> %i.ahs, <8 x i1> zeroinitializer
