...
.preheader293.i:                                  ; preds = %bb.p
  ...
  %i.nf = fsub reassoc nsz arcp contract afn float %i.ne, %i.lv
  ...
  %factor.op.fmul.8.i = fmul reassoc nsz arcp contract afn float %i.nf, f0x3DE38E39 ; 3 uses
  %.reass.8.i = fmul reassoc nsz arcp contract afn float %factor.op.fmul.8.i, %i.ng
  %foldExtExtBinop49 = fadd reassoc nsz arcp contract afn <4 x float> %foldExtExtBinop, %foldExtExtBinop42
  %op.rdx37 = fadd reassoc nsz arcp contract afn float %.reass.7.i, %.reass.8.i
  %13 = insertelement <2 x float> %i.nm, float %factor.op.fmul.8.i, i64 1 ; 2 uses
  %14 = fmul reassoc nsz arcp contract afn <2 x float> %13, %i.nn
  %15 = fadd reassoc nsz arcp contract afn <2 x float> %i.nl, %14 ; 2 uses
  %16 = fmul reassoc nsz arcp contract afn <2 x float> %13, %i.nr
  %17 = fadd reassoc nsz arcp contract afn <2 x float> %i.nq, %16 ; 2 uses
  %18 = shufflevector <4 x float> %i.mc, <4 x float> poison, <2 x i32> <i32 1, i32 poison>
  %19 = insertelement <2 x float> %18, float %factor.op.fmul.8.i, i64 1
  %20 = shufflevector <2 x float> %19, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
  %i.oi = shufflevector <4 x float> %i.kp, <4 x float> %i.lk, <4 x i32> <i32 0, i32 1, i32 2, i32 7>
  %i.oj = fmul reassoc nsz arcp contract afn <4 x float> %20, %i.oi
  ...
  %i.oo = shufflevector <2 x float> %15, <2 x float> %17, <4 x i32> <i32 poison, i32 0, i32 2, i32 poison>
  %i.op = insertelement <4 x float> %i.oo, float -0.000000e+00, i64 3
  %i.oq = shufflevector <4 x float> %foldExtExtBinop49, <4 x float> %i.op, <4 x i32> <i32 0, i32 5, i32 6, i32 7>
  %i.or = fadd reassoc nsz arcp contract afn <4 x float> %i.on, %i.oq
  %21 = call reassoc nsz arcp contract afn float @llvm.vector.reduce.fadd.v4f32(float 0.000000e+00, <4 x float> %rdx.op)
  %i.os = shufflevector <2 x float> %15, <2 x float> %17, <4 x i32> <i32 poison, i32 1, i32 3, i32 poison>
  %i.ot = insertelement <4 x float> %i.os, float %op.rdx37, i64 0
  %i.ou = insertelement <4 x float> %i.ot, float %21, i64 3
