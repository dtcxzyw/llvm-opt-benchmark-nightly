...
bb.al:                                            ; preds = %._crit_edge627.split
  ...
  %9 = tail call reassoc nsz arcp contract afn float @llvm.minnum.f32(float %i.bk, float 2.000000e-01)
  %10 = fmul reassoc nnan nsz arcp contract afn float %9, 5.000000e+00
...
poisson_noise.exit.i:                             ; preds = %bb.eb
  ...
  %11 = tail call reassoc nnan nsz arcp contract afn float @llvm.maxnum.f32(float %i.cdd, float f0x0C800000)
  %12 = fmul reassoc nnan nsz arcp contract afn float %11, f0x33800000
  %i.cde = tail call reassoc nnan nsz arcp contract afn float @llvm.log.f32(float %12)
...
bb.ek:                                            ; preds = %bb.ej
  ...
  %13 = tail call reassoc nsz arcp contract afn float @llvm.minnum.f32(float %i.cjl, float 1.000000e+00)
  %14 = fmul reassoc nnan nsz arcp contract afn float %13, 2.000000e-01 ; 6 uses
...
bb.r:                                             ; preds = %.preheader294.preheader.i
  ...
  %13 = call reassoc nnan nsz arcp contract afn float @llvm.maxnum.f32(float %i.us, float f0x0C800000)
  %14 = fmul reassoc nnan nsz arcp contract afn float %13, f0x33800000
  %i.ut = call reassoc nnan nsz arcp contract afn float @llvm.log.f32(float %14)
  ...
  %15 = call reassoc nnan nsz arcp contract afn <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.vb, <2 x float> splat (float f0x0C800000))
  %16 = fmul reassoc nnan nsz arcp contract afn <2 x float> %15, splat (float f0x33800000)
  %i.vc = call reassoc nnan nsz arcp contract afn <2 x float> @llvm.log.v2f32(<2 x float> %16)
