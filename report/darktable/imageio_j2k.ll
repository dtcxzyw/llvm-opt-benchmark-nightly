...
bb.a:
  ...
  %i.p = load ptr, ptr %i.o, align 8, !tbaa !57   ; 5 uses
  ...
  %i.u = load ptr, ptr %i.t, align 8, !tbaa !57   ; 4 uses
  %i.v = ptrtoaddr ptr %i.u to i64
  %i.w = tail call noalias ptr @calloc(i64 noundef %i.n, i64 noundef 4) #18 ; 7 uses
  %i.x = ptrtoaddr ptr %i.w to i64                ; 3 uses
  %i.y = tail call noalias ptr @calloc(i64 noundef %i.n, i64 noundef 4) #18 ; 7 uses
  %1 = insertelement <4 x ptr> poison, ptr %i.s, i64 0
  %2 = insertelement <4 x ptr> %1, ptr %i.u, i64 1
  %3 = insertelement <4 x ptr> %2, ptr %i.y, i64 2 ; 2 uses
  %4 = insertelement <4 x ptr> %3, ptr %i.p, i64 3
  %5 = shufflevector <4 x ptr> %4, <4 x ptr> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 3, i32 0>
  %6 = ptrtoaddr <8 x ptr> %5 to <8 x i64>
  %i.z = ptrtoaddr ptr %i.y to i64
  %i.aa = tail call noalias ptr @calloc(i64 noundef %i.n, i64 noundef 4) #18 ; 7 uses
  %7 = shufflevector <4 x ptr> %3, <4 x ptr> poison, <3 x i32> <i32 poison, i32 poison, i32 2>
  %8 = insertelement <3 x ptr> %7, ptr %i.w, i64 0
  %9 = insertelement <3 x ptr> %8, ptr %i.aa, i64 1
  %10 = shufflevector <3 x ptr> %9, <3 x ptr> poison, <8 x i32> <i32 0, i32 0, i32 1, i32 2, i32 2, i32 2, i32 1, i32 1>
  %11 = ptrtoaddr <8 x ptr> %10 to <8 x i64>
...
vector.memcheck:                                  ; preds = %.lr.ph.preheader
  ...
  %diff.check61 = icmp ugt i64 %i.ah, -32
  %12 = sub <8 x i64> %6, %11
  %13 = icmp ugt <8 x i64> %12, splat (i64 -32)
  %i.ai = sub i64 %i.v, %i.ab
  %diff.check65 = icmp ugt i64 %i.ai, -32
  %14 = bitcast <8 x i1> %13 to i8
  %15 = icmp ne i8 %14, 0
  %conflict.rdx68 = or i1 %15, %diff.check
  %conflict.rdx70 = or i1 %diff.check54, %diff.check61
  %conflict.rdx72 = or i1 %conflict.rdx68, %conflict.rdx70
  %conflict.rdx74 = or i1 %conflict.rdx72, %diff.check65
