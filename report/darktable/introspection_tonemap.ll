...
bb.h:                                             ; preds = %.lr.ph130, %bb.h
  ...
  %i.eb = fadd reassoc nsz arcp contract afn float %i.dp, %i.ea
  ...
  %i.ef = fadd reassoc nsz arcp contract afn float %i.ds, %i.ee
  ...
  %i.fb = fadd reassoc nsz arcp contract afn float %i.fa, %i.eo
  ...
  %i.ff = fadd reassoc nsz arcp contract afn float %i.fe, %i.es
  ...
  %8 = fmul reassoc nsz arcp contract afn float %i.fw, %i.bv
  %i.fx = fadd reassoc nsz arcp contract afn float %8, %7
  %i.fy = fadd reassoc nsz arcp contract afn float %i.fx, -1.000000e+00
