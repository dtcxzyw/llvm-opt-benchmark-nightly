...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.vec266 = load <12 x i8>, ptr %i.rd, align 1, !tbaa !56, !alias.scope !192
  %strided.vec267 = shufflevector <12 x i8> %wide.vec266, <12 x i8> poison, <4 x i32> <i32 0, i32 3, i32 6, i32 9>
