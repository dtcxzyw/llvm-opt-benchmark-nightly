...
dt_iop_colorreconstruct_bilateral_thaw.exit:      ; preds = %bb.z, %.loopexit
  ...
  br i1 %i.jn, label %.lr.ph338.i, label %dt_iop_colorreconstruct_bilateral_slice.exit

.lr.ph338.i:                                      ; preds = %dt_iop_colorreconstruct_bilateral_thaw.exit
  %i.jo = extractelement <2 x i64> %i.jd, i64 0   ; 4 uses
  %factor.op.mul335.i = shl i64 %i.jo, 32         ; 2 uses
  ...
  %factor.op.mul.reass.i = mul i64 %factor.op.mul335.i, %i.js
  ...
  %i.kg = ashr exact i64 %factor.op.mul335.i, 32  ; 2 uses
...
.lr.ph.preheader.i77:                             ; preds = %.lr.ph338.i
...
._crit_edge.i83:                                  ; preds = %.thread.i
  ...
  %exitcond341.not.i = icmp eq i64 %indvars.iv.next.i84, %wide.trip.count.i78
  br i1 %exitcond341.not.i, label %dt_iop_colorreconstruct_bilateral_slice.exit, label %.lr.ph.i79

bb.an:                                            ; preds = %.thread.i, %.lr.ph.i79
  %.0332.i = phi i32 [ 0, %.lr.ph.i79 ], [ %i.sp, %.thread.i ] ; 2 uses
  %.0272331.i = phi i64 [ %.reass.i81, %.lr.ph.i79 ], [ %i.sq, %.thread.i ] ; 6 uses
  %i.kq = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %.0272331.i
  %i.kr = load float, ptr %i.kq, align 4, !tbaa !11 ; 4 uses
  %i.ks = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %.0272331.i
  store float %i.kr, ptr %i.ks, align 4, !tbaa !11
  %i.kt = or disjoint i64 %.0272331.i, 1          ; 2 uses
  ...
  %i.kx = or disjoint i64 %.0272331.i, 2          ; 2 uses
  ...
  %i.lb = or disjoint i64 %.0272331.i, 3          ; 2 uses
...
.thread294.i:                                     ; preds = %bb.an
  ...
  %i.lk = insertelement <2 x i32> %i.kp, i32 %.0332.i, i64 0
  ...
  %i.mu = fsub reassoc nsz arcp contract afn float %i.ma, %i.mt ; 14 uses
  ...
  %i.nh = fsub reassoc nsz arcp contract afn float 1.000000e+00, %i.mu ; 13 uses
  %i.ni = extractelement <2 x float> %i.mw, i64 0 ; 8 uses
  %i.nj = fsub reassoc nsz arcp contract afn float 1.000000e+00, %i.ni ; 6 uses
  ...
  %6 = fmul reassoc nsz arcp contract afn float %i.nj, %i.nh ; 4 uses
  %i.on = fmul reassoc nsz arcp contract afn float %6, %i.om
  %i.oo = getelementptr inbounds nuw i8, ptr %i.no, i64 12
  %i.op = load float, ptr %i.oo, align 4, !tbaa !115
  %7 = fmul reassoc nsz arcp contract afn float %i.nj, %i.mu ; 4 uses
  %i.oq = fmul reassoc nsz arcp contract afn float %7, %i.op
  ...
  %reass.add297.i.a = fadd reassoc nsz arcp contract afn float %reass.mul300.i, %i.oq
  %reass.add = fadd reassoc nsz arcp contract afn float %reass.add297.i.a, %i.on
  %i.ox = extractelement <2 x float> %i.mw, i64 1 ; 4 uses
  %reass.mul = fmul reassoc nsz arcp contract afn float %reass.add, %i.ox
  %i.oy = fadd reassoc nsz arcp contract afn float %reass.mul, %i.ok
...
bb.ao:                                            ; preds = %.thread294.i
  ...
  %reass.add301.i = fadd reassoc nsz arcp contract afn float %i.pl, %i.pj
  %reass.mul302.i.a = fmul reassoc nsz arcp contract afn float %reass.add301.i, %i.ni
  %i.pm = fadd reassoc nsz arcp contract afn float %reass.mul302.i.a, %i.ph
  %i.pn = fmul reassoc nsz arcp contract afn float %i.pm, %i.oj
  %i.po = load float, ptr %i.nn, align 4, !tbaa !117
  %i.pp = fmul reassoc nsz arcp contract afn float %i.po, %6
  %i.pq = load float, ptr %i.no, align 4, !tbaa !117
  %i.pr = fmul reassoc nsz arcp contract afn float %i.pq, %7
  ...
  %reass.add315.i.a = fadd reassoc nsz arcp contract afn float %i.pv, %i.pt
  %reass.mul316.i.a = fmul reassoc nsz arcp contract afn float %reass.add315.i.a, %i.ni
  %reass.add313.i.a = fadd reassoc nsz arcp contract afn float %i.pr, %i.pp
  %reass.add325.i.a = fadd reassoc nsz arcp contract afn float %reass.add313.i.a, %reass.mul316.i.a
  %reass.mul326.i.a = fmul reassoc nsz arcp contract afn float %reass.add325.i.a, %i.ox
  %i.pw = fadd reassoc nsz arcp contract afn float %reass.mul326.i.a, %i.pn
  ...
  %reass.add305.i = fadd reassoc nsz arcp contract afn float %i.ql, %i.qi
  %reass.mul306.i = fmul reassoc nsz arcp contract afn float %reass.add305.i, %i.ni
  %i.qm = fadd reassoc nsz arcp contract afn float %reass.mul306.i, %i.qf
  ...
  %i.qq = fmul reassoc nsz arcp contract afn float %i.qp, %6
  %i.qr = getelementptr inbounds nuw i8, ptr %i.no, i64 8
  %i.qs = load float, ptr %i.qr, align 4, !tbaa !118
  %i.qt = fmul reassoc nsz arcp contract afn float %i.qs, %7
  ...
  %reass.add319.i.a = fadd reassoc nsz arcp contract afn float %i.qz, %i.qw
  %reass.mul320.i.a = fmul reassoc nsz arcp contract afn float %reass.add319.i.a, %i.ni
  %reass.add317.i = fadd reassoc nsz arcp contract afn float %i.qt, %i.qq
  %reass.add327.i = fadd reassoc nsz arcp contract afn float %reass.add317.i, %reass.mul320.i.a
  %reass.mul328.i.a = fmul reassoc nsz arcp contract afn float %reass.add327.i, %i.ox
  %i.ra = fadd reassoc nsz arcp contract afn float %reass.mul328.i.a, %i.qn
  ...
  %reass.add309.i = fadd reassoc nsz arcp contract afn float %i.ro, %i.rl
  %reass.mul310.i = fmul reassoc nsz arcp contract afn float %reass.add309.i, %i.ni
  %i.rp = fadd reassoc nsz arcp contract afn float %reass.mul310.i, %i.ri
  ...
  %i.rt = fmul reassoc nsz arcp contract afn float %i.rs, %6
  %i.ru = getelementptr inbounds nuw i8, ptr %i.no, i64 4
  %i.rv = load float, ptr %i.ru, align 4, !tbaa !119
  %i.rw = fmul reassoc nsz arcp contract afn float %i.rv, %7
  ...
  %reass.add323.i = fadd reassoc nsz arcp contract afn float %i.sc, %i.rz
  %reass.mul324.i.a = fmul reassoc nsz arcp contract afn float %reass.add323.i, %i.ni
  %reass.add321.i = fadd reassoc nsz arcp contract afn float %i.rw, %i.rt
  %reass.add329.i = fadd reassoc nsz arcp contract afn float %reass.add321.i, %reass.mul324.i.a
  %reass.mul330.i = fmul reassoc nsz arcp contract afn float %reass.add329.i, %i.ox
  %i.sd = fadd reassoc nsz arcp contract afn float %reass.mul330.i, %i.rq
...
.thread.i:                                        ; preds = %.critedge.i, %bb.an
  %i.sp = add nuw nsw i32 %.0332.i, 1             ; 2 uses
  %i.sq = add i64 %.0272331.i, 4
  %exitcond.not.i82 = icmp eq i32 %i.sp, %i.jq
  br i1 %exitcond.not.i82, label %._crit_edge.i83, label %bb.an

dt_iop_colorreconstruct_bilateral_slice.exit:     ; preds = %._crit_edge.i83, %dt_iop_colorreconstruct_bilateral_thaw.exit, %.lr.ph338.i
