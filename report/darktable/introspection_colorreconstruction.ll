...
bb.al:                                            ; preds = %bb.ak, %image_to_grid.exit.i
  ...
  %i.ir = insertelement <4 x float> poison, float %.065.i, i64 0
...
bb.am:                                            ; preds = %bb.al, %bb.ac
  %i.iz = add nuw nsw i32 %.0643.i, 1             ; 2 uses
  %i.ja = add i64 %.0634.i, 4
...
dt_iop_colorreconstruct_bilateral_thaw.exit:      ; preds = %bb.z, %.loopexit
  ...
  %.0 = phi ptr [ %i.dt, %.loopexit ], [ %i.cu, %bb.z ] ; 14 uses
  ...
  %i.jh = getelementptr inbounds nuw i8, ptr %.0, i64 40
...
.lr.ph340.i:                                      ; preds = %dt_iop_colorreconstruct_bilateral_thaw.exit
  ...
  %i.ju = getelementptr i8, ptr %.0, i64 32
  %i.jv = getelementptr inbounds nuw i8, ptr %.0, i64 44
  %i.jw = add i64 %i.jo, -1
  ...
  %i.kf = getelementptr inbounds nuw i8, ptr %.0, i64 56
...
bb.an:                                            ; preds = %.thread.i, %.lr.ph.i79
  %.0272334.i = phi i64 [ %.reass.i81, %.lr.ph.i79 ], [ %i.sq, %.thread.i ] ; 6 uses
  %.0273333.i = phi i32 [ 0, %.lr.ph.i79 ], [ %i.sp, %.thread.i ] ; 2 uses
  %i.kq = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %.0272334.i
  %i.kr = load float, ptr %i.kq, align 4, !tbaa !11 ; 4 uses
  %i.ks = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %.0272334.i
  store float %i.kr, ptr %i.ks, align 4, !tbaa !11
  %i.kt = or disjoint i64 %.0272334.i, 1          ; 2 uses
  ...
  %i.kx = or disjoint i64 %.0272334.i, 2          ; 2 uses
  ...
  %i.lb = or disjoint i64 %.0272334.i, 3          ; 2 uses
...
.thread294.i:                                     ; preds = %bb.an
  ...
  %i.lk = insertelement <2 x i32> %i.kp, i32 %.0273333.i, i64 0
  ...
  %reass.add301.i.a = fadd reassoc nsz arcp contract afn float %reass.mul300.i, %i.oq
  %reass.add297.i = fadd reassoc nsz arcp contract afn float %reass.add301.i.a, %i.on
...
bb.ao:                                            ; preds = %.thread294.i
  ...
  %reass.add307.i = fadd reassoc nsz arcp contract afn float %reass.add323.i.a, %reass.mul322.i
  ...
  %reass.add313.i = fadd reassoc nsz arcp contract afn float %reass.add327.i.a, %reass.mul326.i
  ...
  %reass.add319.i = fadd reassoc nsz arcp contract afn float %reass.add331.i, %reass.mul330.i.a
...
.thread.i:                                        ; preds = %.critedge.i, %bb.an
  %i.sp = add nuw nsw i32 %.0273333.i, 1          ; 2 uses
  %i.sq = add i64 %.0272334.i, 4
...
bb.at:                                            ; preds = %dt_iop_colorreconstruct_bilateral_dump.exit
  %i.tl = load i64, ptr %.0, align 8, !tbaa !107  ; 2 uses
  ...
  %i.to = getelementptr inbounds nuw i8, ptr %.0, i64 16 ; 2 uses
  ...
  %i.tw = getelementptr inbounds nuw i8, ptr %.0, i64 48
...
bb.au:                                            ; preds = %bb.at
  %i.ue = getelementptr inbounds nuw i8, ptr %.0, i64 56
...
bb.av:                                            ; preds = %bb.au
  %i.ug = load i64, ptr %.0, align 8, !tbaa !107
  %i.uh = shl i64 %i.ug, 4
...
dt_iop_colorreconstruct_bilateral_free.exit:      ; preds = %dt_iop_colorreconstruct_bilateral_freeze.exit, %bb.ap, %dt_iop_colorreconstruct_bilateral_slice.exit
  %i.uo = getelementptr inbounds nuw i8, ptr %.0, i64 56
