...
image_to_grid.exit:                               ; preds = %.preheader, %image_to_grid.exit
  ...
  %i.cs = fsub reassoc nsz arcp contract afn float 1.000000e+00, %i.cr ; 2 uses
  ...
  %i.df = fmul reassoc nsz arcp contract afn float %i.de, %i.ci
  ...
  %reass.add68.a = fadd reassoc nsz arcp contract afn float %i.df, %i.dc
  %reass.mul69 = fmul reassoc nsz arcp contract afn float %reass.add68.a, %i.cs
  %reass.add63 = fsub reassoc nsz arcp contract afn float %reass.mul67, %i.cz
  %reass.add64 = fadd reassoc nsz arcp contract afn float %reass.add63, %reass.mul69
...
image_to_grid.exit:                               ; preds = %.preheader, %image_to_grid.exit
  ...
  %reass.add69.a = fadd reassoc nsz arcp contract afn float %i.df, %i.dc
  %reass.mul70 = fmul reassoc nsz arcp contract afn float %reass.add69.a, %i.cs
  %reass.add64 = fsub reassoc nsz arcp contract afn float %reass.mul68, %i.cz
  %reass.add65 = fadd reassoc nsz arcp contract afn float %reass.add64, %reass.mul70
