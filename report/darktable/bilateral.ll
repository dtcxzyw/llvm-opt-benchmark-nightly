...
image_to_grid.exit:                               ; preds = %.preheader, %image_to_grid.exit
  ...
  %4 = fsub reassoc nsz arcp contract afn <2 x float> splat (float 1.000000e+00), %i.bx ; 3 uses
  %5 = extractelement <2 x float> %4, i64 1       ; 3 uses
  ...
  %i.cu = fmul reassoc nsz arcp contract afn float %i.ct, %i.cm
  %reass.add = fadd reassoc nsz arcp contract afn float %i.cu, %i.cs
  %i.cv = extractelement <2 x float> %i.bx, i64 0
  ...
  %i.da = fmul reassoc nsz arcp contract afn float %i.cz, %i.cp
  %6 = getelementptr i8, ptr %i.ck, i64 4
  %7 = load float, ptr %6, align 4, !tbaa !18
  %8 = fmul reassoc nsz arcp contract afn float %7, %i.cm
  %i.db = getelementptr i8, ptr %gep, i64 4
  %i.dc = load float, ptr %i.db, align 4, !tbaa !18
  %9 = insertelement <2 x float> poison, float %8, i64 0
  %10 = insertelement <2 x float> %9, float %i.dc, i64 1
  %11 = fmul reassoc nsz arcp contract afn <2 x float> %10, %4
  %i.dd = getelementptr i8, ptr %gep74, i64 4
  %i.de = load float, ptr %i.dd, align 4, !tbaa !18
  %i.df = fmul reassoc nsz arcp contract afn float %i.de, %i.cm
  %12 = fsub reassoc nsz arcp contract afn float %i.da, %i.cw
  %13 = insertelement <2 x float> poison, float %12, i64 0
  %14 = insertelement <2 x float> %13, float %i.df, i64 1
  %15 = fadd reassoc nsz arcp contract afn <2 x float> %14, %11 ; 2 uses
  %shift = shufflevector <2 x float> %15, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop = fmul reassoc nsz arcp contract afn <2 x float> %shift, %i.bx
  %foldExtExtBinop86 = fadd reassoc nsz arcp contract afn <2 x float> %15, %foldExtExtBinop
  %reass.add64 = extractelement <2 x float> %foldExtExtBinop86, i64 0
  %reass.mul69 = fmul reassoc nsz arcp contract afn float %reass.add64, %i.bi
...
image_to_grid.exit:                               ; preds = %.preheader, %image_to_grid.exit
  ...
  %10 = insertelement <2 x float> %9, float %i.dc, i64 1
  %11 = fmul reassoc nsz arcp contract afn <2 x float> %10, %4
  %i.dd = getelementptr i8, ptr %gep75, i64 4
  %i.de = load float, ptr %i.dd, align 4, !tbaa !18
  %i.df = fmul reassoc nsz arcp contract afn float %i.de, %i.cm
  %12 = fsub reassoc nsz arcp contract afn float %i.da, %i.cw
  %13 = insertelement <2 x float> poison, float %12, i64 0
  ...
  %shift = shufflevector <2 x float> %15, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop = fmul reassoc nsz arcp contract afn <2 x float> %shift, %i.bx
  %foldExtExtBinop87 = fadd reassoc nsz arcp contract afn <2 x float> %15, %foldExtExtBinop
  %reass.add65 = extractelement <2 x float> %foldExtExtBinop87, i64 0
  %reass.mul70 = fmul reassoc nsz arcp contract afn float %reass.add65, %i.bi
