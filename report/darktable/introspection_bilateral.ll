...
begin_hunk_1_@process:bb.a
  ...
  br i1 %exitcond348.not, label %._crit_edge292, label %vec.epilog.scalar.ph, !llvm.loop !80
...
vector.body473:                                   ; preds = %vector.body473, %vector.ph469
  ...
  %wide.load475 = load <8 x float>, ptr %i.go, align 4, !tbaa !37
  %wide.load476 = load <8 x float>, ptr %i.gp, align 4, !tbaa !37
  %wide.load477 = load <8 x float>, ptr %i.gq, align 4, !tbaa !37
  %i.gr = fmul reassoc nsz arcp contract afn <8 x float> %wide.load, %i.fx
  %i.gs = fmul reassoc nsz arcp contract afn <8 x float> %wide.load475, %i.fy
  %i.gt = fmul reassoc nsz arcp contract afn <8 x float> %wide.load476, %i.fz
  ...
  br i1 %i.gv, label %middle.block479, label %vector.body473, !llvm.loop !81
...
vec.epilog.iter.check485:                         ; preds = %middle.block479
  br i1 %min.epilog.iters.check486, label %vec.epilog.scalar.ph484.preheader, label %vec.epilog.ph487, !prof !77
...
vec.epilog.vector.body491:                        ; preds = %vec.epilog.vector.body491, %vec.epilog.ph487
  ...
  br i1 %i.gx, label %vec.epilog.middle.block495, label %vec.epilog.vector.body491, !llvm.loop !82
...
._crit_edge301:                                   ; preds = %vec.epilog.scalar.ph484, %vec.epilog.middle.block495, %middle.block479
  ...
  br i1 %exitcond363.not, label %.preheader270, label %iter.check483, !llvm.loop !83
...
vec.epilog.scalar.ph484:                          ; preds = %vec.epilog.scalar.ph484.preheader, %vec.epilog.scalar.ph484
  ...
  br i1 %exitcond358.not, label %._crit_edge301, label %vec.epilog.scalar.ph484, !llvm.loop !84
...
.lr.ph305:                                        ; preds = %.lr.ph305.preheader, %.lr.ph305
  ...
  %.val263 = load <4 x float>, ptr %i.hr, align 16, !tbaa !85
  store <4 x float> %.val263, ptr %i.hq, align 16, !tbaa !85, !alias.scope !86, !nontemporal !89
  ...
  %.val263.1 = load <4 x float>, ptr %i.hv, align 16, !tbaa !85
  store <4 x float> %.val263.1, ptr %i.hu, align 16, !tbaa !85, !alias.scope !86, !nontemporal !89
  ...
  %.val263.2 = load <4 x float>, ptr %i.hz, align 16, !tbaa !85
  store <4 x float> %.val263.2, ptr %i.hy, align 16, !tbaa !85, !alias.scope !86, !nontemporal !89
