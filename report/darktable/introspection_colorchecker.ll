...
bb.e:                                             ; preds = %bb.d
  ...
  %4 = extractelement <4 x float> %i.ce, i64 0
  %5 = fmul reassoc nsz arcp contract afn float %4, 9.642000e-01
  ...
  %6 = shufflevector <4 x float> %i.ce, <4 x float> <float f0x3FCEF57D, float f0x3F719831, float poison, float poison>, <4 x i32> <i32 4, i32 5, i32 1, i32 1> ; 2 uses
  %7 = shufflevector <4 x float> %i.ce, <4 x float> <float poison, float poison, float f0x3E6A7CB9, float poison>, <4 x i32> <i32 1, i32 0, i32 6, i32 poison>
  %8 = insertelement <4 x float> %7, float %5, i64 3 ; 2 uses
  %i.ci = fmul reassoc nsz arcp contract afn <4 x float> %6, %8
  %i.cj = fadd reassoc nsz arcp contract afn <4 x float> %6, %8
