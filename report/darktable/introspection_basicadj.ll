...
.critedge5.i.i:                                   ; preds = %bb.bc, %bb.bd, %.critedge5.loopexit.split.loop.exit456.i.i
  ...
  %.0229.i.i.a = fmul reassoc nsz arcp contract afn float %9, 5.000000e-01 ; 3 uses
  %10 = call reassoc nsz arcp contract afn float @llvm.fabs.f32(float %i.rh) ; 3 uses
  %11 = call reassoc nsz arcp contract afn float @llvm.fabs.f32(float %.0229.i.i.a) ; 3 uses
...
bb.be:                                            ; preds = %.critedge5.i.i
  ...
  %i.rn = fmul reassoc nsz arcp contract afn float %10, %.0229.i.i.a
...
bb.bf:                                            ; preds = %.critedge5.i.i
  ...
  %i.rs = fpext reassoc nsz arcp contract afn float %.0229.i.i.a to double
