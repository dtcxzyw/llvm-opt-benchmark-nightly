...
bb.aq:                                            ; preds = %bb.ap
  %i.ik = sext i32 %.1249337.i.i to i64
...
bb.ar:                                            ; preds = %bb.aq
  %i.ip = icmp eq i32 %.1249337.i.i, 7
...
bb.at:                                            ; preds = %bb.as, %bb.aq
  ...
  %i.km = add nsw i32 %.1249337.i.i, 1
  br label %._crit_edge412.i.i

._crit_edge412.i.i:                               ; preds = %bb.at, %bb.as, %bb.ar, %bb.ap
  %.2250.i.i = phi i32 [ %i.km, %bb.at ], [ %.1249337.i.i, %bb.ar ], [ 7, %bb.as ], [ %.1249337.i.i, %bb.ap ] ; 2 uses
  %i.kn = fadd reassoc nsz arcp contract afn float %.0243339.i.i, %i.ij ; 2 uses
...
bb.au:                                            ; preds = %._crit_edge413.i.i, %.lr.ph348.i.i
  ...
  %.0236347.i.i = phi float [ 0.000000e+00, %.lr.ph348.i.i ], [ %i.mv, %._crit_edge413.i.i ]
  %.3345.i.i = phi i32 [ %.1249.lcssa.i19.i, %.lr.ph348.i.i ], [ %.4.i.i, %._crit_edge413.i.i ] ; 6 uses
  %i.ko = icmp slt i32 %.3345.i.i, 8
...
bb.ay:                                            ; preds = %bb.ax, %bb.av
  ...
  %i.mu = add nsw i32 %.3345.i.i, 1
  br label %._crit_edge413.i.i

._crit_edge413.i.i:                               ; preds = %bb.ay, %bb.ax, %bb.aw, %bb.au
  %.4.i.i = phi i32 [ %i.mu, %bb.ay ], [ %.3345.i.i, %bb.aw ], [ 7, %bb.ax ], [ %.3345.i.i, %bb.au ]
  %i.mv = fadd reassoc nsz arcp contract afn float %.0236347.i.i, %i.kr ; 2 uses
...
._crit_edge349.i.i:                               ; preds = %._crit_edge413.i.i
  ...
  %or.cond3.i.i = select i1 %.0243.lcssa.i21.i, i1 true, i1 %i.mw
...
.lr.ph363.i.i:                                    ; preds = %bb.bd, %.lr.ph363.preheader.i.i
  ...
  %.2240361.i.i = phi i32 [ 0, %.lr.ph363.preheader.i.i ], [ %i.qt, %bb.bd ]
  %i.qr = getelementptr inbounds nuw [4 x i8], ptr %i.cm, i64 %indvars.iv402.i.i
  %i.qs = load i32, ptr %i.qr, align 4, !tbaa !26
  %i.qt = add i32 %i.qs, %.2240361.i.i            ; 2 uses
  %.not264.i.i = icmp ugt i32 %i.qt, %i.pm
  br i1 %.not264.i.i, label %.critedge5.loopexit.split.loop.exit457.i.i, label %bb.bd
...
.critedge5.loopexit.split.loop.exit457.i.i:       ; preds = %.lr.ph363.i.i
  %i.qu = trunc nuw nsw i64 %indvars.iv402.i.i to i32
  br label %.critedge5.i.i

.critedge5.i.i:                                   ; preds = %bb.bc, %bb.bd, %.critedge5.loopexit.split.loop.exit457.i.i
  %.0235.lcssa.i23.i = phi i32 [ %i.qp, %bb.bd ], [ %i.qp, %.critedge5.loopexit.split.loop.exit457.i.i ], [ 1, %bb.bc ]
  %.0234.lcssa.i.i = phi i32 [ %i.qq, %bb.bd ], [ %i.qu, %.critedge5.loopexit.split.loop.exit457.i.i ], [ 0, %bb.bc ]
  %i.qv = shl i32 %i.pk, 3
  %i.qw = shl i32 %.0235.lcssa.i23.i, 3
  %i.qx = fmul reassoc nsz arcp contract afn float %i.hm, 8.000000e+00 ; 2 uses
  %i.qy = shl i32 %i.hw, 3
  %i.qz = shl i32 %.0234.lcssa.i.i, 3
...
bb.bg:                                            ; preds = %bb.bf, %bb.be
  %.0.i.i = phi nsz float [ %i.rq, %bb.be ], [ %i.rv, %bb.bf ] ; 5 uses
  %i.rw = fmul reassoc nsz arcp contract afn float %.0.i.i, f0x3F317218
  ...
  %i.sg = call reassoc nsz arcp contract afn float @llvm.maxnum.f32(float %.0.i.i, float 0.000000e+00)
...
.lr.ph370.i.i:                                    ; preds = %gamma2.exit275.i.i.1, %gamma2.exit.i.i
  ...
  %.0218368.i.i = phi float [ 0.000000e+00, %gamma2.exit.i.i ], [ %.reass, %gamma2.exit275.i.i.1 ] ; 3 uses
  %.0219367.i.i = phi float [ 0.000000e+00, %gamma2.exit.i.i ], [ %i.vd, %gamma2.exit275.i.i.1 ]
  ...
  %i.tz = fpext reassoc nsz arcp contract afn float %.0218368.i.i to double ; 3 uses
...
gamma2.exit275.i.i:                               ; preds = %bb.bn, %bb.bm
  ...
  %i.uj = fpext reassoc nsz arcp contract afn float %.0219367.i.i to double
  %i.uk = fadd reassoc nsz arcp contract afn double %i.ui, %i.uj
  %i.ul = fptrunc reassoc nsz arcp contract afn double %i.uk to float
  %i.um = fadd reassoc nsz arcp contract afn float %.0218368.i.i, %i.tt
...
gamma2.exit275.i.i.1:                             ; preds = %bb.bp, %bb.bo
  ...
  %.reass = fadd reassoc nsz arcp contract afn float %.0218368.i.i, %invariant.op358
...
bb.bq:                                            ; preds = %._crit_edge371.i.i
  ...
  %.0220.i.i = select nsz i1 %i.vj, double %i.vi, double %i.ts
  br label %bb.br

bb.br:                                            ; preds = %bb.bq, %._crit_edge371.i.i
  %.1221.i.i = phi nsz double [ %.0220.i.i, %bb.bq ], [ %i.ts, %._crit_edge371.i.i ] ; 3 uses
  %i.vk = fcmp reassoc nsz arcp contract afn ugt double %.1221.i.i, 3.928000e-02
  br i1 %i.vk, label %bb.bt, label %bb.bs

bb.bs:                                            ; preds = %bb.br
  %i.vl = fmul reassoc nnan nsz arcp contract afn double %.1221.i.i, f0x3FB3D0722149B580
  br label %bb.bu

bb.bt:                                            ; preds = %bb.br
  %i.vm = fmul reassoc nsz arcp contract afn double %.1221.i.i, f0x3FEE54EDCD0AEB60
...
bb.bu:                                            ; preds = %bb.bt, %bb.bs
  ...
  %i.vv = fcmp reassoc nsz arcp contract afn ogt float %.0.i.i, 1.200000e+01
  %i.vw = fcmp reassoc nsz arcp contract afn olt float %.0.i.i, -5.000000e+00
  %i.vx = select reassoc nsz arcp contract afn i1 %i.vw, float -5.000000e+00, float %.0.i.i
