...
.critedge5.i.i:                                   ; preds = %bb.bc, %bb.bd, %.critedge5.loopexit.split.loop.exit456.i.i
  ...
  %.461.i.i = select i1 %i.ri, float %i.ng, float %6
  %.462.i.i = select i1 %i.ri, float %6, float %i.og
  ...
  %8 = fadd reassoc nsz arcp contract afn float %7, %.461.i.i
  %9 = fadd reassoc nsz arcp contract afn float %8, %.462.i.i
  %i.rm = fmul reassoc nsz arcp contract afn float %9, 5.000000e-01 ; 3 uses
  %10 = call reassoc nsz arcp contract afn float @llvm.fabs.f32(float %i.rh) ; 3 uses
  %11 = call reassoc nsz arcp contract afn float @llvm.fabs.f32(float %i.rm) ; 3 uses
...
bb.be:                                            ; preds = %.critedge5.i.i
  %i.rn = fmul reassoc nsz arcp contract afn float %i.rh, %11
  %i.ro = fmul reassoc nsz arcp contract afn float %10, %i.rm
  %i.rp = fadd reassoc nsz arcp contract afn float %i.ro, %i.rn
  %i.rq = fadd reassoc nsz arcp contract afn float %10, %11
  %i.rr = fdiv reassoc nsz arcp contract afn float %i.rp, %i.rq
  br label %bb.bg

bb.bf:                                            ; preds = %.critedge5.i.i
  %i.rs = fpext reassoc nsz arcp contract afn float %i.rh to double
  %i.rt = fpext reassoc nsz arcp contract afn float %i.rm to double
  %i.ru = fadd reassoc nsz arcp contract afn double %i.rs, %i.rt
  %i.rv = fmul reassoc nsz arcp contract afn double %i.ru, 5.000000e-01
  %i.rw = fptrunc reassoc nsz arcp contract afn double %i.rv to float
  br label %bb.bg

bb.bg:                                            ; preds = %bb.bf, %bb.be
  %.0215.i.i = phi nsz float [ %i.rr, %bb.be ], [ %i.rw, %bb.bf ] ; 5 uses
  %i.rx = fmul reassoc nsz arcp contract afn float %.0215.i.i, f0x3F317218
  %i.ry = call reassoc nsz arcp contract afn float @llvm.exp.f32(float %i.rx) ; 3 uses
  %i.rz = fmul reassoc nsz arcp contract afn float %i.ry, 6.553600e+04
  %i.sa = fdiv reassoc nsz arcp contract afn float %i.rz, %i.rj
  %i.sb = call reassoc nsz arcp contract afn float @llvm.sqrt.f32(float %i.sa) ; 3 uses
  %i.sc = fmul reassoc nsz arcp contract afn float %i.sb, %i.rb ; 4 uses
  %i.sd = sitofp reassoc nsz arcp contract afn i32 %i.qw to float ; 2 uses
  %i.se = fmul reassoc nnan nsz arcp contract afn float %i.sd, f0x38133333
  %i.sf = fmul reassoc nsz arcp contract afn float %i.se, %i.ry
  %i.sg = fadd reassoc nsz arcp contract afn float %i.sf, -2.300000e+00
  %i.sh = call reassoc nsz arcp contract afn float @llvm.maxnum.f32(float %.0215.i.i, float 0.000000e+00)
  %i.si = fadd reassoc nsz arcp contract afn float %i.sh, 1.000000e+00
  %i.sj = fdiv reassoc nsz arcp contract afn float %i.sg, %i.si
  %i.sk = call reassoc nsz arcp contract afn float @llvm.minnum.f32(float %i.sj, float 1.000000e+02)
  %i.sl = call reassoc nsz arcp contract afn float @llvm.maxnum.f32(float %i.sk, float 0.000000e+00) ; 2 uses
  %i.sm = sitofp reassoc nsz arcp contract afn i32 %i.qy to float
  %i.sn = fmul reassoc nsz arcp contract afn float %i.qx, %i.sm
  %i.so = call reassoc nsz arcp contract afn float @llvm.sqrt.f32(float %i.sn)
  %i.sp = fmul reassoc nsz arcp contract afn float %i.ry, %i.so ; 2 uses
  %i.sq = fmul reassoc nsz arcp contract afn float %i.sp, f0x37800000 ; 3 uses
  %i.sr = fcmp reassoc nsz arcp contract afn olt float %i.sq, 1.000000e-01
  %i.ss = fsub reassoc nsz arcp contract afn float %i.cg, %i.sq
  %i.st = fmul reassoc nsz arcp contract afn float %i.ss, 1.500000e+01 ; 2 uses
  br i1 %i.sr, label %bb.bh, label %bb.bi

bb.bh:                                            ; preds = %bb.bg
  %i.su = fdiv reassoc nsz arcp contract afn float %i.st, %i.sq
  br label %bb.bj

bb.bi:                                            ; preds = %bb.bg
  %i.sv = fpext reassoc nsz arcp contract afn float %i.st to double
  %i.sw = fmul reassoc nsz arcp contract afn float %i.sp, f0x35AA9931
  %i.sx = fpext reassoc nsz arcp contract afn float %i.sw to double
  %i.sy = fsub reassoc nsz arcp contract afn double 1.083300e-01, %i.sx
  %i.sz = fdiv reassoc nsz arcp contract afn double %i.sv, %i.sy
  %i.ta = fptrunc reassoc nsz arcp contract afn double %i.sz to float
  br label %bb.bj

bb.bj:                                            ; preds = %bb.bi, %bb.bh
  %.0222.i.i = phi nsz float [ %i.su, %bb.bh ], [ %i.ta, %bb.bi ] ; 2 uses
  %i.tb = fcmp reassoc nsz arcp contract afn olt float %.0222.i.i, 0.000000e+00
  %i.tc = select reassoc nsz arcp contract afn i1 %i.tb, float 0.000000e+00, float %.0222.i.i
  %i.td = fmul reassoc nsz arcp contract afn float %i.tc, 2.500000e-01 ; 2 uses
  %i.te = fsub reassoc nsz arcp contract afn float 1.100000e+00, %i.pd
  %i.tf = fmul reassoc nsz arcp contract afn float %i.te, %i.cf ; 2 uses
  %i.tg = fcmp reassoc nsz arcp contract afn ogt float %i.tf, 1.000000e+02
  %i.th = select reassoc nsz arcp contract afn i1 %i.tg, float 1.000000e+02, float %i.tf ; 2 uses
  %i.ti = fcmp reassoc nsz arcp contract afn olt float %i.th, 0.000000e+00
  %i.tj = select reassoc nsz arcp contract afn i1 %i.ti, float 0.000000e+00, float %i.th
  %i.tk = fmul reassoc nsz arcp contract afn float %i.sb, %i.sd
  %i.tl = fpext reassoc nsz arcp contract afn float %i.tk to double ; 3 uses
  %i.tm = fcmp reassoc nsz arcp contract afn ugt double %i.tl, 3.040000e-03
  br i1 %i.tm, label %bb.bl, label %bb.bk

bb.bk:                                            ; preds = %bb.bj
  %i.tn = fmul reassoc nnan nsz arcp contract afn double %i.tl, 1.292000e+01
  br label %gamma2.exit.i.i

bb.bl:                                            ; preds = %bb.bj
  %i.to = call reassoc nsz arcp contract afn double @llvm.log.f64(double %i.tl)
  %i.tp = fmul reassoc nsz arcp contract afn double %i.to, f0x3FDAAAAAAAAAAAAB
  %i.tq = call reassoc nsz arcp contract afn double @llvm.exp.f64(double %i.tp)
  %i.tr = fmul reassoc nsz arcp contract afn double %i.tq, 1.055000e+00
  %i.ts = fadd reassoc nsz arcp contract afn double %i.tr, -5.500000e-02
  br label %gamma2.exit.i.i

gamma2.exit.i.i:                                  ; preds = %bb.bl, %bb.bk
  %i.tt = phi reassoc nsz arcp contract afn double [ %i.tn, %bb.bk ], [ %i.ts, %bb.bl ] ; 3 uses
  %i.tu = fmul reassoc nsz arcp contract afn float %i.sb, 8.000000e+00 ; 3 uses
  %invariant.op358 = fadd reassoc nsz arcp contract afn float %i.tu, %i.tu
  br label %.lr.ph370.i.i

._crit_edge371.i.i:                               ; preds = %gamma2.exit275.i.i.1
  %i.tv = fdiv reassoc nsz arcp contract afn float %i.ve, %i.hk ; 2 uses
  %i.tw = fcmp reassoc nsz arcp contract afn olt float %i.sc, %i.tv
  br i1 %i.tw, label %bb.bq, label %bb.br
...
.lr.ph370.i.i:                                    ; preds = %gamma2.exit275.i.i.1, %gamma2.exit.i.i
  ...
  %.0217367.i.i = phi float [ 0.000000e+00, %gamma2.exit.i.i ], [ %i.ve, %gamma2.exit275.i.i.1 ]
  %i.tx = getelementptr inbounds nuw [4 x i8], ptr %i.cm, i64 %indvars.iv407.i.i
  %i.ty = load i32, ptr %i.tx, align 8, !tbaa !26
  %i.tz = uitofp reassoc nsz arcp contract afn i32 %i.ty to double
  %i.ua = fpext reassoc nsz arcp contract afn float %.0216368.i.i to double ; 3 uses
  %i.ub = fcmp reassoc nsz arcp contract afn ugt double %i.ua, 3.040000e-03
  br i1 %i.ub, label %bb.bn, label %bb.bm

bb.bm:                                            ; preds = %.lr.ph370.i.i
  %i.uc = fmul reassoc nnan nsz arcp contract afn double %i.ua, 1.292000e+01
  br label %gamma2.exit275.i.i

bb.bn:                                            ; preds = %.lr.ph370.i.i
  %i.ud = call reassoc nsz arcp contract afn double @llvm.log.f64(double %i.ua)
  %i.ue = fmul reassoc nsz arcp contract afn double %i.ud, f0x3FDAAAAAAAAAAAAB
  %i.uf = call reassoc nsz arcp contract afn double @llvm.exp.f64(double %i.ue)
  %i.ug = fmul reassoc nsz arcp contract afn double %i.uf, 1.055000e+00
  %i.uh = fadd reassoc nsz arcp contract afn double %i.ug, -5.500000e-02
  br label %gamma2.exit275.i.i

gamma2.exit275.i.i:                               ; preds = %bb.bn, %bb.bm
  %i.ui = phi reassoc nsz arcp contract afn double [ %i.uc, %bb.bm ], [ %i.uh, %bb.bn ]
  %i.uj = fmul reassoc nsz arcp contract afn double %i.ui, %i.tz
  %i.uk = fpext reassoc nsz arcp contract afn float %.0217367.i.i to double
  %i.ul = fadd reassoc nsz arcp contract afn double %i.uj, %i.uk
  %i.um = fptrunc reassoc nsz arcp contract afn double %i.ul to float
  %i.un = fadd reassoc nsz arcp contract afn float %.0216368.i.i, %i.tu
  %i.uo = getelementptr inbounds nuw [4 x i8], ptr %i.cm, i64 %indvars.iv407.i.i
  %i.up = getelementptr inbounds nuw i8, ptr %i.uo, i64 4
  %i.uq = load i32, ptr %i.up, align 4, !tbaa !26
  %i.ur = uitofp reassoc nsz arcp contract afn i32 %i.uq to double
  %i.us = fpext reassoc nsz arcp contract afn float %i.un to double ; 3 uses
  %i.ut = fcmp reassoc nsz arcp contract afn ugt double %i.us, 3.040000e-03
  br i1 %i.ut, label %bb.bp, label %bb.bo

bb.bo:                                            ; preds = %gamma2.exit275.i.i
  %i.uu = fmul reassoc nnan nsz arcp contract afn double %i.us, 1.292000e+01
  br label %gamma2.exit275.i.i.1

bb.bp:                                            ; preds = %gamma2.exit275.i.i
  %i.uv = call reassoc nsz arcp contract afn double @llvm.log.f64(double %i.us)
  %i.uw = fmul reassoc nsz arcp contract afn double %i.uv, f0x3FDAAAAAAAAAAAAB
  %i.ux = call reassoc nsz arcp contract afn double @llvm.exp.f64(double %i.uw)
  %i.uy = fmul reassoc nsz arcp contract afn double %i.ux, 1.055000e+00
  %i.uz = fadd reassoc nsz arcp contract afn double %i.uy, -5.500000e-02
  br label %gamma2.exit275.i.i.1

gamma2.exit275.i.i.1:                             ; preds = %bb.bp, %bb.bo
  %i.va = phi reassoc nsz arcp contract afn double [ %i.uu, %bb.bo ], [ %i.uz, %bb.bp ]
  %i.vb = fmul reassoc nsz arcp contract afn double %i.va, %i.ur
  %i.vc = fpext reassoc nsz arcp contract afn float %i.um to double
  %i.vd = fadd reassoc nsz arcp contract afn double %i.vb, %i.vc
  %i.ve = fptrunc reassoc nsz arcp contract afn double %i.vd to float ; 2 uses
...
bb.bq:                                            ; preds = %._crit_edge371.i.i
  %i.vf = fsub reassoc nsz arcp contract afn float %i.tv, %i.sc
  %i.vg = fmul reassoc nsz arcp contract afn float %i.vf, f0x3FAAAAAB
  %i.vh = fadd reassoc nsz arcp contract afn float %i.vg, %i.sc
  %i.vi = fptosi float %i.vh to i32
  %i.vj = sitofp reassoc nsz arcp contract afn i32 %i.vi to double ; 2 uses
  %i.vk = fcmp reassoc nsz arcp contract afn olt double %i.tt, %i.vj
  %.0218.i.i = select nsz i1 %i.vk, double %i.vj, double %i.tt
  br label %bb.br

bb.br:                                            ; preds = %bb.bq, %._crit_edge371.i.i
  %.1219.i.i = phi nsz double [ %.0218.i.i, %bb.bq ], [ %i.tt, %._crit_edge371.i.i ] ; 3 uses
  %i.vl = fcmp reassoc nsz arcp contract afn ugt double %.1219.i.i, 3.928000e-02
  br i1 %i.vl, label %bb.bt, label %bb.bs

bb.bs:                                            ; preds = %bb.br
  %i.vm = fmul reassoc nnan nsz arcp contract afn double %.1219.i.i, f0x3FB3D0722149B580
  br label %bb.bu

bb.bt:                                            ; preds = %bb.br
  %i.vn = fmul reassoc nsz arcp contract afn double %.1219.i.i, f0x3FEE54EDCD0AEB60
  %i.vo = fadd reassoc nsz arcp contract afn double %i.vn, f0x3FAAB1232F514A03
  %i.vp = call reassoc nsz arcp contract afn double @llvm.log.f64(double %i.vo)
  %i.vq = fmul reassoc nsz arcp contract afn double %i.vp, 2.400000e+00
  %i.vr = call reassoc nsz arcp contract afn double @llvm.exp.f64(double %i.vq)
  br label %bb.bu

bb.bu:                                            ; preds = %bb.bt, %bb.bs
  %i.vs = phi reassoc nsz arcp contract afn double [ %i.vm, %bb.bs ], [ %i.vr, %bb.bt ]
  %i.vt = fpext reassoc nsz arcp contract afn float %i.sc to double
  %i.vu = fdiv reassoc nsz arcp contract afn double %i.vt, %i.vs
  %i.vv = fptrunc reassoc nsz arcp contract afn double %i.vu to float
  %i.vw = fcmp reassoc nsz arcp contract afn ogt float %.0215.i.i, 1.200000e+01
  %i.vx = fcmp reassoc nsz arcp contract afn olt float %.0215.i.i, -5.000000e+00
  %i.vy = select reassoc nsz arcp contract afn i1 %i.vx, float -5.000000e+00, float %.0215.i.i
  %i.vz = select reassoc nsz arcp contract afn i1 %i.vw, float 1.200000e+01, float %i.vy ; 2 uses
  %i.wa = fcmp reassoc nsz arcp contract afn olt float %i.td, 1.000000e+02
  %i.wb = select reassoc nsz arcp contract afn i1 %i.wa, float %i.td, float 1.000000e+02 ; 2 uses
  %i.wc = fcmp reassoc nsz arcp contract afn olt float %i.wb, -1.000000e+02
  %i.wd = select reassoc nsz arcp contract afn i1 %i.wc, float -1.000000e+02, float %i.wb
  %i.we = fmul reassoc nsz arcp contract afn float %i.vv, f0x3C23D70A ; 2 uses
  %i.wf = fmul reassoc nsz arcp contract afn float %i.wd, f0x3C23D70A ; 2 uses
  %i.wg = fmul reassoc nsz arcp contract afn float %i.tj, f0x3C23D70A ; 2 uses
  %i.wh = fcmp ord float %i.vz, 0.000000e+00
  br i1 %i.wh, label %bb.bw, label %bb.bv
...
bb.bw:                                            ; preds = %bb.bv, %bb.bu
  %.2.i.i = phi nsz float [ %i.vz, %bb.bu ], [ 0.000000e+00, %bb.bv ] ; 2 uses
  %i.wi = fcmp ord float %i.we, 0.000000e+00
  br i1 %i.wi, label %bb.by, label %bb.bx
