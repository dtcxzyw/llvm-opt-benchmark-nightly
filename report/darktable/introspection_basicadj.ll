...
bb.at:                                            ; preds = %bb.as, %bb.aq
  ...
  %i.is = uitofp nsz nneg i32 %i.ir to float
...
bb.ay:                                            ; preds = %bb.ax, %bb.av
  ...
  %i.la = uitofp nsz nneg i32 %i.kz to float
...
bb.cn:                                            ; preds = %bb.cl
  ...
  %i.abi = call i32 @llvm.umin.i32(i32 %i.abh, i32 65535)
...
bb.cs:                                            ; preds = %bb.cq
  ...
  %i.abv = call i32 @llvm.umin.i32(i32 %i.abu, i32 65535)
...
bb.cw:                                            ; preds = %bb.cv
  ...
  %i.acg = call i32 @llvm.umin.i32(i32 %i.acf, i32 65535)
...
bb.db:                                            ; preds = %bb.da
  ...
  %i.acs = call i32 @llvm.umin.i32(i32 %i.acr, i32 65535)
...
bb.dg:                                            ; preds = %bb.df
  ...
  %i.adg = call i32 @llvm.umin.i32(i32 %i.adf, i32 65535)
...
bb.dl:                                            ; preds = %bb.dk
  ...
  %i.ads = call i32 @llvm.umin.i32(i32 %i.adr, i32 65535)
