...
.preheader227.lr.ph:                              ; preds = %._crit_edge237
  ...
  %.neg220 = fmul reassoc nsz arcp contract afn float %sin, %i.fj ; 2 uses
...
bb.m:                                             ; preds = %.preheader227, %bb.p
  ...
  %.reass243 = fmul reassoc nsz arcp contract afn float %reass.add223, %factor.op.fmul242
  %reass.add225 = fsub reassoc nsz arcp contract afn float %i.kl, %i.fq
  %reass.mul226.reass = fmul reassoc nsz arcp contract afn float %reass.add225, %.neg220
  %i.km = fadd reassoc nsz arcp contract afn float %reass.mul226.reass, %.reass243 ; 2 uses
  ...
  %reass.mul224.reass = fmul reassoc nsz arcp contract afn float %reass.add223, %.neg220
...
.preheader.lr.ph:                                 ; preds = %._crit_edge232
  %factor.op.fmul250 = fmul reassoc nsz arcp contract afn float %cos, %i.ep ; 2 uses
...
bb.m:                                             ; preds = %.preheader, %bb.p
  ...
  %.reass238 = fmul reassoc nsz arcp contract afn float %reass.add219, %factor.op.fmul250
  %reass.add221 = fsub reassoc nsz arcp contract afn float %i.jk, %i.ew
  %reass.mul222.reass = fmul reassoc nsz arcp contract afn float %reass.add221, %factor.op.fmul235
  %i.jl = fadd reassoc nsz arcp contract afn float %reass.mul222.reass, %.reass238 ; 2 uses
  %reass.add = fsub reassoc nsz arcp contract afn float %i.ew, %i.jk
  %reass.mul.reass = fmul reassoc nsz arcp contract afn float %reass.add, %factor.op.fmul250
