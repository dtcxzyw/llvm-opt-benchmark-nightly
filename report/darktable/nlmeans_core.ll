...
vector.body797:                                   ; preds = %vector.body797, %vector.ph785
  ...
  %i.pb = fadd reassoc nsz arcp contract afn <8 x float> %i.on, %vec.phi799
  %i.pc = fadd reassoc nsz arcp contract afn <8 x float> %i.oo, %vec.phi800
...
vec.epilog.vector.body847:                        ; preds = %vec.epilog.vector.body847, %vec.epilog.ph834
  ...
  %i.pu = fadd reassoc nsz arcp contract afn <4 x float> %i.pn, %vec.phi850
...
vec.epilog.scalar.ph831:                          ; preds = %vec.epilog.scalar.ph831.preheader, %vec.epilog.scalar.ph831
  ...
  %i.qx = fadd reassoc nsz arcp contract afn float %i.qp, %.0123143.i
  %i.qy = extractelement <2 x float> %i.qw, i64 0
  %i.qz = fadd reassoc nsz arcp contract afn float %i.qx, %i.qy
  %5 = extractelement <2 x float> %i.qw, i64 1
  %i.ra = fadd reassoc nsz arcp contract afn float %i.qz, %5 ; 2 uses
...
.lr.ph498:                                        ; preds = %bb.w, %.lr.ph498
  ...
  %i.yc = fadd reassoc nsz arcp contract afn float %i.yb, %i.xs
...
.lr.ph495:                                        ; preds = %bb.y, %.lr.ph495
  ...
  %i.yv = getelementptr inbounds [4 x i8], ptr %i.yo, i64 %i.yu ; 4 uses
  %i.yw = getelementptr inbounds [4 x i8], ptr %i.yt, i64 %i.yu ; 5 uses
  %i.yx = getelementptr inbounds [4 x i8], ptr %i.yw, i64 %i.rj ; 4 uses
  %i.yy = getelementptr inbounds [4 x i8], ptr %i.yv, i64 %i.rj ; 3 uses
  ...
  %6 = getelementptr inbounds nuw i8, ptr %i.yw, i64 4
  %7 = load float, ptr %6, align 4, !tbaa !11
  %i.zk = getelementptr inbounds nuw i8, ptr %i.yx, i64 4
  %8 = load float, ptr %i.zk, align 4, !tbaa !11
  %9 = fsub reassoc nsz arcp contract afn float %7, %8 ; 2 uses
  %i.zl = getelementptr inbounds nuw i8, ptr %i.yv, i64 4
  %10 = load float, ptr %i.zl, align 4, !tbaa !11
  %i.zm = getelementptr inbounds nuw i8, ptr %i.yy, i64 4
  %11 = load float, ptr %i.zm, align 4, !tbaa !11
  ...
  %16 = load float, ptr %i.jj, align 4, !tbaa !11
  %17 = fmul reassoc nsz arcp contract afn float %15, %16
  %i.zn = getelementptr inbounds nuw i8, ptr %i.yw, i64 8
  %18 = load float, ptr %i.zn, align 4, !tbaa !11
  %19 = getelementptr inbounds nuw i8, ptr %i.yx, i64 8
  %20 = load float, ptr %19, align 4, !tbaa !11
  %21 = fsub reassoc nsz arcp contract afn float %18, %20 ; 2 uses
  %22 = getelementptr inbounds nuw i8, ptr %i.yv, i64 8
  %23 = load float, ptr %22, align 4, !tbaa !11
  %24 = getelementptr inbounds nuw i8, ptr %i.yy, i64 8
  ...
  %30 = load float, ptr %i.jk, align 4, !tbaa !11
  %31 = fmul reassoc nsz arcp contract afn float %29, %30
  %i.zo = fadd reassoc nsz arcp contract afn float %17, %i.zj
  ...
  %32 = fadd reassoc nsz arcp contract afn float %i.zo, %i.zr
  %i.zs = fadd reassoc nsz arcp contract afn float %32, %31
...
vector.body730:                                   ; preds = %vector.body730, %vector.ph728
  ...
  %i.aaq = fadd reassoc nsz arcp contract afn <8 x float> %i.aan, %i.aal
  %i.aar = fadd reassoc nsz arcp contract afn <8 x float> %i.aaq, %i.aap
...
.lr.ph492:                                        ; preds = %.lr.ph492.preheader870, %.lr.ph492
  ...
  %33 = load float, ptr %i.aau, align 4, !tbaa !11
  %i.aaw = load float, ptr %i.aav, align 4, !tbaa !11
  %34 = fsub reassoc nsz arcp contract afn float %33, %i.aaw ; 2 uses
  %i.aax = load float, ptr %i.jd, align 4, !tbaa !11
  %35 = getelementptr inbounds nuw i8, ptr %i.aau, i64 4
  %36 = getelementptr inbounds nuw i8, ptr %i.aav, i64 4
  ...
  %.neg455 = fmul reassoc nsz arcp contract afn float %37, %i.aax
  %i.aba = load <2 x float>, ptr %35, align 4, !tbaa !11
  %i.abb = load <2 x float>, ptr %36, align 4, !tbaa !11
  %i.abc = fsub reassoc nsz arcp contract afn <2 x float> %i.aba, %i.abb ; 2 uses
  %i.abd = load <2 x float>, ptr %i.jj, align 4, !tbaa !11
  ...
  %i.abg = extractelement <2 x float> %i.abf, i64 0
  %reass.add = fadd reassoc nsz arcp contract afn float %i.abg, %.neg455
  %i.abh = extractelement <2 x float> %i.abf, i64 1
