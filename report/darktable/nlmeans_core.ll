...
bb.r:                                             ; preds = %.lr.ph520, %.loopexit470
  ...
  %5 = or disjoint i64 %indvars.iv544, 1
  %6 = mul i64 %.0.i, %indvar
  ...
  %7 = or disjoint i64 %indvars.iv544, 1
  %8 = mul i64 %.0.i, %indvar
...
.preheader462.lr.ph.preheader:                    ; preds = %.lr.ph509
  ...
  %smax670 = tail call i64 @llvm.smax.i64(i64 %i.kk, i64 %5) ; 2 uses
  %i.kt = sub i64 %smax670, %6                    ; 2 uses
...
.preheader.lr.ph.preheader:                       ; preds = %.lr.ph516
  ...
  %smax = tail call i64 @llvm.smax.i64(i64 %i.la, i64 %7) ; 2 uses
  %i.lc = sub i64 %smax, %8                       ; 2 uses
...
.lr.ph502:                                        ; preds = %init_column_sums.exit
  ...
  %9 = add i64 %i.hq, %i.ri
  %smax725 = tail call i64 @llvm.smax.i64(i64 %9, i64 %i.rk)
  %10 = add i64 %indvars.iv544, %i.ri
  %11 = sub i64 %smax725, %10                     ; 3 uses
  ...
  %min.iters.check727 = icmp ult i64 %11, 9
