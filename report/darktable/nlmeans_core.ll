...
.preheader473:                                    ; preds = %.preheader473.loopexit, %bb.r
  ...
  %i.jd = getelementptr inbounds nuw i8, ptr %i.ix, i64 4 ; 4 uses
...
vector.body797:                                   ; preds = %vector.body797, %vector.ph785
  ...
  %i.ov = fadd reassoc nsz arcp contract afn <8 x float> %i.oh, %i.on
  %i.ow = fadd reassoc nsz arcp contract afn <8 x float> %i.oi, %i.oo
  %i.ox = fadd reassoc nsz arcp contract afn <8 x float> %i.ov, %i.ot
  %i.oy = fadd reassoc nsz arcp contract afn <8 x float> %i.ow, %i.ou
  %i.oz = fadd reassoc nsz arcp contract afn <8 x float> %i.ox, %vec.phi799 ; 2 uses
  %i.pa = fadd reassoc nsz arcp contract afn <8 x float> %i.oy, %vec.phi800 ; 2 uses
...
vec.epilog.vector.body847:                        ; preds = %vec.epilog.vector.body847, %vec.epilog.ph834
  ...
  %i.po = fadd reassoc nsz arcp contract afn <4 x float> %i.ph, %i.pk
  %i.pp = fadd reassoc nsz arcp contract afn <4 x float> %i.po, %i.pn
  %i.pq = fadd reassoc nsz arcp contract afn <4 x float> %i.pp, %vec.phi850 ; 2 uses
...
vec.epilog.scalar.ph831:                          ; preds = %vec.epilog.scalar.ph831.preheader, %vec.epilog.scalar.ph831
  ...
  %5 = extractelement <2 x float> %i.qq, i64 0
  %i.qr = fadd reassoc nsz arcp contract afn float %i.qj, %5
  %i.qs = extractelement <2 x float> %i.qq, i64 1
  %i.qt = fadd reassoc nsz arcp contract afn float %i.qr, %i.qs
  %i.qu = fadd reassoc nsz arcp contract afn float %i.qt, %.0121143.i ; 2 uses
...
.lr.ph499:                                        ; preds = %bb.w, %.lr.ph499
  ...
  %i.xw = fadd reassoc nsz arcp contract afn float %i.xm, %i.xv
...
.lr.ph496:                                        ; preds = %bb.y, %.lr.ph496
  ...
  %i.yp = getelementptr inbounds [4 x i8], ptr %i.yi, i64 %i.yo ; 3 uses
  %i.yq = getelementptr inbounds [4 x i8], ptr %i.yn, i64 %i.yo ; 4 uses
  %i.yr = getelementptr inbounds [4 x i8], ptr %i.yq, i64 %i.rd ; 3 uses
  %i.ys = getelementptr inbounds [4 x i8], ptr %i.yp, i64 %i.rd ; 2 uses
  ...
  %i.ze = getelementptr inbounds nuw i8, ptr %i.yq, i64 4
  %i.zf = getelementptr inbounds nuw i8, ptr %i.yr, i64 4
  %i.zg = getelementptr inbounds nuw i8, ptr %i.yp, i64 4
  %i.zh = getelementptr inbounds nuw i8, ptr %i.ys, i64 4
  %6 = load <2 x float>, ptr %i.ze, align 4, !tbaa !11
  %7 = load <2 x float>, ptr %i.zf, align 4, !tbaa !11
  %8 = fsub reassoc nsz arcp contract afn <2 x float> %6, %7 ; 2 uses
  %9 = load <2 x float>, ptr %i.zg, align 4, !tbaa !11
  %10 = load <2 x float>, ptr %i.zh, align 4, !tbaa !11
  ...
  %15 = load <2 x float>, ptr %i.jd, align 4, !tbaa !11
  %16 = fmul reassoc nsz arcp contract afn <2 x float> %14, %15 ; 2 uses
  %17 = extractelement <2 x float> %16, i64 0
  %18 = fadd reassoc nsz arcp contract afn float %i.zd, %17
  %19 = extractelement <2 x float> %16, i64 1
  %i.zi = fadd reassoc nsz arcp contract afn float %18, %19
  ...
  %i.zm = fadd reassoc nsz arcp contract afn float %i.zi, %i.zl
...
vector.body730:                                   ; preds = %vector.body730, %vector.ph728
  ...
  %i.aak = fadd reassoc nsz arcp contract afn <8 x float> %i.aaj, %i.aah
  %i.aal = fadd reassoc nsz arcp contract afn <8 x float> %i.aak, %i.aaf
...
.lr.ph493:                                        ; preds = %.lr.ph493.preheader870, %.lr.ph493
  ...
  %20 = getelementptr inbounds nuw i8, ptr %i.aao, i64 8
  %i.aaq = load float, ptr %20, align 4, !tbaa !11
  %21 = getelementptr inbounds nuw i8, ptr %i.aap, i64 8
  %i.aar = load float, ptr %21, align 4, !tbaa !11
  %22 = fsub reassoc nsz arcp contract afn float %i.aaq, %i.aar ; 2 uses
  %23 = load float, ptr %i.je, align 4, !tbaa !11
  %i.aas = getelementptr inbounds [4 x i8], ptr %i.ic, i64 %indvars.iv548 ; 2 uses
  %i.aat = load float, ptr %i.aas, align 4, !tbaa !11
  %i.aau = load <2 x float>, ptr %i.aao, align 4, !tbaa !11
  %i.aav = load <2 x float>, ptr %i.aap, align 4, !tbaa !11
  %i.aaw = fsub reassoc nsz arcp contract afn <2 x float> %i.aau, %i.aav ; 2 uses
  %i.aax = load <2 x float>, ptr %i.ix, align 4, !tbaa !11
  ...
  %.neg459 = fmul reassoc nsz arcp contract afn float %24, %23
  %i.aba = extractelement <2 x float> %i.aaz, i64 1
  %reass.add = fadd reassoc nsz arcp contract afn float %.neg459, %i.aba
  %i.abb = extractelement <2 x float> %i.aaz, i64 0
