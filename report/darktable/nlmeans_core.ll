...
bb.r:                                             ; preds = %.lr.ph520, %.loopexit470
  ...
  %i.hs = add nuw nsw i64 %.0.i, %indvars.iv544
...
bb.t:                                             ; preds = %.preheader473, %._crit_edge503
  ...
  %i.ls = sext i16 %i.lq to i32                   ; 3 uses
  %i.lt = sub nsw i32 0, %i.ls                    ; 2 uses
  %i.lu = select i1 %i.lr, i32 0, i32 %i.lt
...
.lr.ph502:                                        ; preds = %init_column_sums.exit
  ...
  %i.rt = add nsw i64 %indvars.iv544, %i.rs       ; 7 uses
  %i.ru = sext i32 %i.mt to i64                   ; 4 uses
  %i.rv = sext i32 %i.lt to i64
  %smax563 = tail call i32 @llvm.smax.i32(i32 %i.ls, i32 0)
  %5 = zext nneg i32 %smax563 to i64
  %6 = add nsw i64 %i.rv, %5
  %smax563.a = tail call i64 @llvm.smax.i64(i64 %indvars.iv561, i64 %6) ; 3 uses
