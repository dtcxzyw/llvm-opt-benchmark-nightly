...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %5 = load <2 x float>, ptr %i.w, align 4, !tbaa !61
  %6 = fmul reassoc nsz arcp contract afn <2 x float> %5, <float 2.000000e-03, float 5.000000e-03> ; 2 uses
  ...
  %9 = fadd reassoc nsz arcp contract afn <2 x float> %8, %6
  %10 = fsub reassoc nsz arcp contract afn <2 x float> %8, %6
  %11 = shufflevector <2 x float> %9, <2 x float> %10, <2 x i32> <i32 0, i32 3> ; 5 uses
  %12 = fcmp reassoc nsz arcp contract afn ogt float %i.bk, f0x3E53DCB1
  %i.bl = fmul reassoc nsz arcp contract afn float %i.bk, %i.bk
  %13 = fmul reassoc nsz arcp contract afn <2 x float> %11, %11
  %i.bm = fmul reassoc nsz arcp contract afn float %i.bl, %i.bk
  %14 = fmul reassoc nsz arcp contract afn float %i.bk, f0x3E038026
  %i.bn = fmul reassoc nsz arcp contract afn <2 x float> %11, splat (float f0x3E038026)
  %15 = fadd reassoc nsz arcp contract afn float %14, f0xBC911AA6
  %16 = fcmp reassoc nsz arcp contract afn ogt <2 x float> %11, splat (float f0x3E53DCB1)
  %17 = fmul reassoc nsz arcp contract afn <2 x float> %13, %11
  %18 = fadd reassoc nsz arcp contract afn <2 x float> %i.bn, splat (float f0xBC911AA6)
  %19 = select reassoc nsz arcp contract afn i1 %12, float %i.bm, float %15 ; 3 uses
  %20 = select <2 x i1> %16, <2 x float> %17, <2 x float> %18 ; 4 uses
  %21 = extractelement <2 x float> %20, i64 0
  %22 = fmul reassoc nsz arcp contract afn float %19, 2.303930e-02
  %i.bo = fmul reassoc nsz arcp contract afn <2 x float> %20, <float f0x3F6BDEB5, float f0x3D556AA4> ; 2 uses
  %23 = extractelement <2 x float> %i.bo, i64 0
  %24 = fsub reassoc nsz arcp contract afn float %23, %22
  %i.bp = extractelement <2 x float> %i.bo, i64 1
  %25 = fadd reassoc nsz arcp contract afn float %24, %i.bp ; 2 uses
  %.reass53 = fmul reassoc nsz arcp contract afn float %21, f0xBC937A4A
  %.reass52 = fmul reassoc nsz arcp contract afn float %19, f0x3F2AA3C6
  %26 = fmul reassoc nsz arcp contract afn <2 x float> %20, <float f0x3C4247BE, float f0x3C3B638A> ; 2 uses
  %i.bq = fadd reassoc nsz arcp contract afn float %.reass53, %.reass52
  %i.br = fmul reassoc nsz arcp contract afn float %19, 2.048300e-02
  %27 = insertelement <2 x float> poison, float %i.br, i64 0
  %28 = insertelement <2 x float> %27, float %i.bq, i64 1 ; 2 uses
  %29 = fsub reassoc nsz arcp contract afn <2 x float> %26, %28
  %30 = fadd reassoc nsz arcp contract afn <2 x float> %26, %28
  %31 = shufflevector <2 x float> %29, <2 x float> %30, <2 x i32> <i32 0, i32 3>
  %32 = fmul reassoc nsz arcp contract afn float %25, 1.150000e+00
  %33 = shufflevector <2 x float> %20, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %34 = insertelement <2 x float> %33, float %25, i64 1
  %35 = fmul reassoc nsz arcp contract afn <2 x float> %34, <float f0x3F8C6BE4, float f0x3EAE147A>
  %36 = fadd reassoc nsz arcp contract afn <2 x float> %31, %35 ; 4 uses
  %37 = extractelement <2 x float> %36, i64 0
  %i.bs = fmul reassoc nsz arcp contract afn float %37, f0x3E199998
  %38 = fsub reassoc nsz arcp contract afn float %32, %i.bs ; 2 uses
  %.reass56 = fmul reassoc nsz arcp contract afn float %38, f0x382DF9B4
  %39 = fmul reassoc nsz arcp contract afn <2 x float> %36, <float 1.464800e-06, float f0x387344EC> ; 2 uses
  %40 = extractelement <2 x float> %39, i64 0
  %i.bt = fadd reassoc nsz arcp contract afn float %.reass56, %40
  %41 = extractelement <2 x float> %39, i64 1
  %42 = fadd reassoc nsz arcp contract afn float %i.bt, %41
  %43 = call reassoc nsz arcp contract afn float @llvm.maxnum.f32(float %42, float 0.000000e+00)
  %i.bu = call reassoc nsz arcp contract afn float @llvm.pow.f32(float %43, float f0x3E232000) ; 2 uses
  ...
  %i.cd = insertelement <2 x float> poison, float %38, i64 0
  %i.ce = shufflevector <2 x float> %i.cd, <2 x float> poison, <2 x i32> zeroinitializer
  %i.cf = fmul reassoc nsz arcp contract afn <2 x float> %i.ce, <float -2.015100e-05, float -1.660080e-06>
  %44 = shufflevector <2 x float> %36, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.cg = fmul reassoc nsz arcp contract afn <2 x float> %44, <float f0x38EB0462, float 2.648000e-05>
  %i.ch = shufflevector <2 x float> %36, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ci = fmul reassoc nsz arcp contract afn <2 x float> %i.ch, <float 5.310080e-06, float f0x388C30BE>
  ...
  %i.cm = call reassoc nsz arcp contract afn <2 x float> @llvm.pow.v2f32(<2 x float> %i.cl, <2 x float> splat (float f0x3E232000)) ; 2 uses
...
rgb_to_JzCzhz.exit:                               ; preds = %dt_ioppr_rgb_matrix_to_xyz.exit.i, %bb.q
  ...
  %6 = fmul reassoc nsz arcp contract afn float %.sink59.i, 1.229820e-02
  %i.fv = fmul reassoc nsz arcp contract afn float %i.ft, 2.048300e-02
  %i.fw = fmul reassoc nsz arcp contract afn float %i.fs, 1.150000e+00
  %7 = fadd reassoc nsz arcp contract afn float %i.fu, %.reass
  %8 = fsub reassoc nsz arcp contract afn float %6, %i.fv
  ...
  %i.fz = insertelement <2 x float> poison, float %7, i64 0
  %i.ga = insertelement <2 x float> %i.fz, float %8, i64 1
  ...
  %i.ge = fsub reassoc nsz arcp contract afn float %i.fw, %i.gd ; 2 uses
  %.reass11 = fmul reassoc nsz arcp contract afn float %i.ge, f0x382DF9B4
  %i.gf = extractelement <2 x float> %i.gb, i64 0
  %.reass13 = fmul reassoc nsz arcp contract afn float %i.gf, f0x387344EC
  %.reass12 = fmul reassoc nsz arcp contract afn float %i.gc, 1.464800e-06
  ...
  %i.gk = fmul reassoc nsz arcp contract afn <2 x float> %i.gj, <float -1.660080e-06, float -2.015100e-05>
  %i.gl = fmul reassoc nsz arcp contract afn <2 x float> %i.gb, <float 2.648000e-05, float 5.310080e-06>
  %i.gm = fmul reassoc nsz arcp contract afn <2 x float> %i.gb, <float f0x38EB0462, float f0x388C30BE>
  ...
  %i.gr = tail call reassoc nsz arcp contract afn float @llvm.pow.f32(float %i.gq, float f0x3E232000) ; 2 uses
  ...
  %i.gz = tail call reassoc nsz arcp contract afn <2 x float> @llvm.pow.v2f32(<2 x float> %i.gy, <2 x float> splat (float f0x3E232000)) ; 2 uses
