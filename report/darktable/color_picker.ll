...
bb.g:                                             ; preds = %bb.e, %bb.f, %.split106.us, %bb.d
  %.0 = phi i32 [ 1, %.split106.us ], [ 1, %bb.d ], [ %i.eg, %bb.f ], [ 1, %bb.e ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #14
  br label %bb.h

bb.h:                                             ; preds = %bb.b, %bb.g
  %.1 = phi i32 [ %.0, %bb.g ], [ 1, %bb.b ]
  ret i32 %.1
}
...
vector.body:                                      ; preds = %.lr.ph.i.i.preheader, %vector.body
  ...
  %13 = fadd reassoc nsz arcp contract afn <16 x float> %wide.vec425, %wide.vec415
  %i.cb = fmul reassoc nsz arcp contract afn <16 x float> %13, splat (float 2.500000e-01)
  %i.cc = fmul reassoc nsz arcp contract afn <16 x float> %wide.vec420, splat (float 3.750000e-01)
  %i.cd = fadd reassoc nsz arcp contract afn <16 x float> %i.cb, %i.cc
  %i.ce = fadd reassoc nsz arcp contract afn <16 x float> %wide.vec430, %wide.vec
  %i.cf = fmul reassoc nsz arcp contract afn <16 x float> %i.ce, splat (float 6.250000e-02)
  %interleaved.vec = fadd reassoc nsz arcp contract afn <16 x float> %i.cd, %i.cf
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader444, %.lr.ph.i.i
  ...
  %14 = load <4 x float>, ptr %i.cl, align 4, !tbaa !61, !alias.scope !148, !noalias !149
  %i.cq = load <4 x float>, ptr %i.cm, align 4, !tbaa !61, !alias.scope !148, !noalias !149
  %i.cr = fmul reassoc nsz arcp contract afn <4 x float> %i.cq, splat (float 3.750000e-01)
  %i.cs = load <4 x float>, ptr %i.cn, align 4, !tbaa !61, !alias.scope !148, !noalias !149
  %15 = load <4 x float>, ptr %i.co, align 4, !tbaa !61, !alias.scope !148, !noalias !149
  %i.ct = fadd reassoc nsz arcp contract afn <4 x float> %i.cs, %14
  %i.cu = fmul reassoc nsz arcp contract afn <4 x float> %i.ct, splat (float 2.500000e-01)
  %i.cv = fadd reassoc nsz arcp contract afn <4 x float> %15, %i.cp
  %16 = fmul reassoc nsz arcp contract afn <4 x float> %i.cv, splat (float 6.250000e-02)
  %17 = fadd reassoc nsz arcp contract afn <4 x float> %i.cu, %i.cr
  %i.cw = fadd reassoc nsz arcp contract afn <4 x float> %17, %16
...
bb.h:                                             ; preds = %bb.h, %.lr.ph.i
  ...
  %18 = load <4 x float>, ptr %i.dp, align 16, !tbaa !61, !alias.scope !159, !noalias !160
  %i.du = load <4 x float>, ptr %i.dq, align 16, !tbaa !61, !alias.scope !159, !noalias !160
  %i.dv = fmul reassoc nsz arcp contract afn <4 x float> %i.du, splat (float 3.750000e-01)
  %i.dw = load <4 x float>, ptr %i.dr, align 16, !tbaa !61, !alias.scope !159, !noalias !160
  %19 = load <4 x float>, ptr %i.ds, align 16, !tbaa !61, !alias.scope !159, !noalias !160
  %i.dx = fadd reassoc nsz arcp contract afn <4 x float> %i.dw, %18
  %i.dy = fmul reassoc nsz arcp contract afn <4 x float> %i.dx, splat (float 2.500000e-01)
  %i.dz = fadd reassoc nsz arcp contract afn <4 x float> %19, %i.dt
  %20 = fmul reassoc nsz arcp contract afn <4 x float> %i.dz, splat (float 6.250000e-02)
  %21 = fadd reassoc nsz arcp contract afn <4 x float> %i.dy, %i.dv
  %i.ea = fadd reassoc nsz arcp contract afn <4 x float> %21, %20
...
bb.j:                                             ; preds = %blur_2D_Bspline.exit, %bb.i, %bb.c
  %.1 = phi ptr [ %1, %bb.c ], [ %i.ak, %blur_2D_Bspline.exit ], [ %1, %bb.i ] ; 8 uses
  %.093 = phi ptr [ null, %bb.c ], [ %i.ak, %blur_2D_Bspline.exit ], [ null, %bb.i ]
...
bb.am:                                            ; preds = %bb.al
  ...
  %22 = fsub reassoc nsz arcp contract afn <2 x double> %i.ss, %i.y
  %23 = fadd reassoc nsz arcp contract afn <2 x double> %22, %i.sv ; 2 uses
  %i.sw = extractelement <2 x double> %23, i64 0
  %i.sx = extractelement <2 x double> %23, i64 1
