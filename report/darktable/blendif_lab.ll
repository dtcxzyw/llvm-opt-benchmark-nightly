...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %9 = shufflevector <8 x float> %i.ab, <8 x float> %i.v, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %10 = tail call reassoc nsz arcp contract afn <16 x float> @llvm.maxnum.v16f32(<16 x float> %9, <16 x float> %7)
  %11 = tail call reassoc nsz arcp contract afn <8 x float> @llvm.maxnum.v8f32(<8 x float> %i.w, <8 x float> %broadcast.splat54)
  %12 = tail call reassoc nsz arcp contract afn <8 x float> @llvm.minnum.v8f32(<8 x float> %11, <8 x float> %broadcast.splat56)
  %13 = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %i.r
  %14 = fmul reassoc nsz arcp contract afn <8 x float> %12, splat (float 1.280000e+02)
  %i.ac = tail call reassoc nsz arcp contract afn <16 x float> @llvm.minnum.v16f32(<16 x float> %10, <16 x float> %8)
  ...
  %i.ae = shufflevector <8 x float> %14, <8 x float> %wide.load, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  ...
  store <32 x float> %interleaved.vec, ptr %13, align 4, !tbaa !34, !alias.scope !438, !noalias !439
  %index.next = add nuw i64 %index, 8             ; 2 uses
