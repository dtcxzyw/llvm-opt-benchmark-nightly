...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %7 = fadd reassoc nsz arcp contract afn <8 x float> %i.ai, %i.ao
  %8 = fsub reassoc nsz arcp contract afn <8 x float> %7, %i.p
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %9 = fadd reassoc nsz arcp contract afn float %i.cf, %i.ck
  %10 = fsub reassoc nsz arcp contract afn float %9, %i.cc
...
dt_Lab_2_LCH.exit30:                              ; preds = %bb.e, %bb.f
  ...
  %i.bh = fadd reassoc nsz arcp contract afn float %.0.i, %i.bg
  %i.bi = fadd reassoc nsz arcp contract afn float %i.bh, 1.000000e+00
