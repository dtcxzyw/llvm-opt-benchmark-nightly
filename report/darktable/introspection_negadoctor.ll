...
bb.i:                                             ; preds = %bb.h
  ...
  %i.bq = load ptr, ptr %i.bp, align 8, !tbaa !101 ; 9 uses
  %6 = getelementptr inbounds nuw i8, ptr %i.bq, i64 56
  ...
  %7 = load float, ptr %i.bu, align 4, !tbaa !33  ; 2 uses
  %8 = load float, ptr %6, align 4, !tbaa !34     ; 2 uses
  %i.ce = fmul reassoc nsz arcp contract afn float %i.bv, %8
  %i.cf = fdiv reassoc nsz arcp contract afn float %i.ca, %7
  ...
  %i.ck = fmul reassoc nsz arcp contract afn <2 x float> %i.cj, %10
  ...
  %i.cq = shufflevector <2 x float> %11, <2 x float> poison, <2 x i32> zeroinitializer
