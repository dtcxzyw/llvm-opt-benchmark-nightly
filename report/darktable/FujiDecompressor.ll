...
bb.en:                                            ; preds = %bb.en, %.preheader54.lr.ph.i.i.i.i.i
  ...
  %i.cjd = shl i32 %indvars.iv.tr.i.i.i.i.i, 1    ; 3 uses
  %i.cje = add nsw i32 %i.cjc, %i.cjd             ; 2 uses
  ...
  %i.cjh = zext i32 %i.cje to i64                 ; 3 uses
  ...
  %i.cjz = add nsw i32 %i.cjy, %i.cjd             ; 2 uses
  ...
  %i.ckt = add nsw i32 %i.cks, %i.cjd             ; 2 uses
