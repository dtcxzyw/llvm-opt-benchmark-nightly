...
_PQ_fct.exit4.i:                                  ; preds = %bb.m
  ...
  %i.ey = fmul reassoc nsz arcp contract afn double %i.eu, 1.868750e+01
...
_PQ_fct.exit4.i.1:                                ; preds = %_PQ_fct.exit.i
  ...
  %i.fr = fmul reassoc nsz arcp contract afn double %i.fn, 1.868750e+01
...
_PQ_fct.exit4.i269:                               ; preds = %bb.r
  ...
  %i.id = fmul reassoc nsz arcp contract afn double %i.hz, 1.868750e+01
...
_PQ_fct.exit4.i269.1:                             ; preds = %_PQ_fct.exit.i270
  ...
  %i.iw = fmul reassoc nsz arcp contract afn double %i.is, 1.868750e+01
