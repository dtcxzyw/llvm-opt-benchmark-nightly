...
bb.c:                                             ; preds = %bb.b
  ...
  %spec.select262 = select i1 %i.j, float %i.h, float 1.000000e+00
  ...
  store float %spec.select262, ptr %.sroa.0243.sroa.4.0..sroa_idx, align 4
...
bb.d:                                             ; preds = %bb.a
  ...
  %.not263 = icmp eq ptr %i.n, null
  br i1 %.not263, label %bb.ay, label %bb.e
...
bb.p:                                             ; preds = %bb.o, %bb.n
  ...
  %.not265 = icmp eq ptr %i.bw, null
  br i1 %.not265, label %_ZNK8rawspeed10ByteStream12hasPatternAtESt17basic_string_viewIcSt11char_traitsIcEEj.exit, label %bb.q
...
bb.q:                                             ; preds = %bb.p
  ...
  %.not266 = icmp eq ptr %i.bx, null
  br i1 %.not266, label %_ZNK8rawspeed10ByteStream12hasPatternAtESt17basic_string_viewIcSt11char_traitsIcEEj.exit, label %bb.r
...
.lr.ph.epil.preheader:                            ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph.preheader
  %.076271.epil.init = phi i32 [ 0, %.lr.ph.preheader ], [ %.1.1, %._crit_edge.loopexit.unr-lcssa ] ; 2 uses
  %.sroa.0226.0270.epil.init = phi ptr [ %i.cc, %.lr.ph.preheader ], [ %i.do, %._crit_edge.loopexit.unr-lcssa ]
  %lcmp.mod303 = trunc i64 %i.bz to i1
  call void @llvm.assume(i1 %lcmp.mod303)
  %i.cf = load i8, ptr %.sroa.0226.0270.epil.init, align 1, !tbaa !18 ; 3 uses
  %i.cg = add i8 %i.cf, -48
  %or.cond5.epil = icmp ult i8 %i.cg, 10
  br i1 %or.cond5.epil, label %bb.x, label %bb.w

bb.w:                                             ; preds = %.lr.ph.epil.preheader
  %i.ch = mul i32 %.076271.epil.init, 10
...
bb.x:                                             ; preds = %.lr.ph.epil.preheader
  ...
  %i.cl = mul i32 %.076271.epil.init, 10
...
.lr.ph:                                           ; preds = %bb.ad, %.lr.ph.preheader.new
  %.076271 = phi i32 [ 0, %.lr.ph.preheader.new ], [ %.1.1, %bb.ad ] ; 2 uses
  %.sroa.0226.0270 = phi ptr [ %i.cc, %.lr.ph.preheader.new ], [ %i.do, %bb.ad ] ; 3 uses
  %niter = phi i64 [ 0, %.lr.ph.preheader.new ], [ %niter.next.1, %bb.ad ]
  %i.cv = load i8, ptr %.sroa.0226.0270, align 1, !tbaa !18 ; 3 uses
  %i.cw = add i8 %i.cv, -48
...
bb.z:                                             ; preds = %.lr.ph
  ...
  %i.cy = mul i32 %.076271, 10
  %i.cz = add i32 %i.cy, -48
  %i.da = add i32 %i.cz, %i.cx
  br label %.lr.ph.1

bb.aa:                                            ; preds = %.lr.ph
  %i.db = mul i32 %.076271, 10
...
.lr.ph.1:                                         ; preds = %bb.aa, %bb.z
  ...
  %i.de = getelementptr inbounds nuw i8, ptr %.sroa.0226.0270, i64 1
...
bb.ad:                                            ; preds = %bb.ac, %bb.ab
  ...
  %i.do = getelementptr inbounds nuw i8, ptr %.sroa.0226.0270, i64 2 ; 2 uses
...
bb.ag:                                            ; preds = %bb.ae
  ...
  %or.cond301 = select i1 %i.eu, i1 true, i1 %i.ew
  br i1 %or.cond301, label %bb.aj, label %bb.ak
...
bb.al:                                            ; preds = %bb.ak
  ...
  %.sroa.3.1..073.ptr276.7.sroa_idx = getelementptr inbounds nuw i8, ptr %.sroa.3, i64 1
  store i8 %i.fl, ptr %.sroa.3.1..073.ptr276.7.sroa_idx, align 1, !tbaa !18
...
bb.am:                                            ; preds = %bb.al
  ...
  %.sroa.3.2..073.ptr276.8.sroa_idx = getelementptr inbounds nuw i8, ptr %.sroa.3, i64 2
  store i8 %i.fq, ptr %.sroa.3.2..073.ptr276.8.sroa_idx, align 1, !tbaa !18
...
bb.an:                                            ; preds = %bb.am
  ...
  %.sroa.3.3..073.ptr276.9.sroa_idx = getelementptr inbounds nuw i8, ptr %.sroa.3, i64 3
  store i8 %i.fv, ptr %.sroa.3.3..073.ptr276.9.sroa_idx, align 1, !tbaa !18
  %.off = add i32 %i.et, -10
...
bb.ap:                                            ; preds = %bb.ao
  ...
  %.sroa.10.1..073.ptr276.13.sroa_idx = getelementptr inbounds nuw i8, ptr %.sroa.10, i64 1
  store i8 %i.gj, ptr %.sroa.10.1..073.ptr276.13.sroa_idx, align 1, !tbaa !18
...
bb.ar:                                            ; preds = %bb.aq
  ...
  %.sroa.13.1..073.ptr276.15.sroa_idx = getelementptr inbounds nuw i8, ptr %.sroa.13, i64 1
  store i8 %i.gt, ptr %.sroa.13.1..073.ptr276.15.sroa_idx, align 1, !tbaa !18
...
bb.as:                                            ; preds = %bb.ar
  ...
  %.sroa.13.2..073.ptr276.16.sroa_idx = getelementptr inbounds nuw i8, ptr %.sroa.13, i64 2
  store i8 %i.gy, ptr %.sroa.13.2..073.ptr276.16.sroa_idx, align 1, !tbaa !18
...
bb.at:                                            ; preds = %bb.as
  ...
  %.sroa.13.3..073.ptr276.17.sroa_idx = getelementptr inbounds nuw i8, ptr %.sroa.13, i64 3
  store i8 %i.hd, ptr %.sroa.13.3..073.ptr276.17.sroa_idx, align 1, !tbaa !18
  %.off306 = add i32 %i.et, -18
  %switch307 = icmp ult i32 %.off306, 3
  br i1 %switch307, label %bb.aj, label %bb.au
...
bb.av:                                            ; preds = %bb.au
  ...
  %.sroa.20.1..073.ptr276.21.sroa_idx = getelementptr inbounds nuw i8, ptr %.sroa.20, i64 1
  store i8 %i.hr, ptr %.sroa.20.1..073.ptr276.21.sroa_idx, align 1, !tbaa !18
...
bb.ay:                                            ; preds = %bb.d
  ...
  %.not264 = icmp eq ptr %i.ik, null
  br i1 %.not264, label %_ZNK8rawspeed10ByteStream12hasPatternAtESt17basic_string_viewIcSt11char_traitsIcEEj.exit, label %bb.az
