...
bb.aj:                                            ; preds = %bb.ai
  ...
  %i.jh = mul nsw i32 %i.jg, %i.dk
  %i.ji = add nsw i32 %i.jh, 512
  %5 = ashr i32 %i.ji, 10
  %.sroa.speculate.load.false.sroa.speculated.i247 = call i32 @llvm.smax.i32(i32 %5, i32 0)
  %i.jj = call i32 @llvm.umin.i32(i32 %.sroa.speculate.load.false.sroa.speculated.i247, i32 32767)
...
bb.al:                                            ; preds = %bb.ak
  ...
  %i.kh = mul nsw i32 %i.kg, %i.dm
  %i.ki = add nsw i32 %i.kh, 512
  %6 = ashr i32 %i.ki, 10
  %.sroa.speculate.load.false.sroa.speculated.i259 = call i32 @llvm.smax.i32(i32 %6, i32 0)
  %i.kj = call i32 @llvm.umin.i32(i32 %.sroa.speculate.load.false.sroa.speculated.i259, i32 32767)
...
bb.am:                                            ; preds = %bb.al
  ...
  %i.ky = mul nsw i32 %i.kx, %i.dk
  %i.kz = add nsw i32 %i.ky, 512
  %7 = ashr i32 %i.kz, 10
  %.sroa.speculate.load.false.sroa.speculated.i266 = call i32 @llvm.smax.i32(i32 %7, i32 0)
  %i.la = call i32 @llvm.umin.i32(i32 %.sroa.speculate.load.false.sroa.speculated.i266, i32 32767)
...
bb.ao:                                            ; preds = %bb.an
  ...
  %i.ly = mul nsw i32 %i.lx, %i.dm
  %i.lz = add nsw i32 %i.ly, 512
  %8 = ashr i32 %i.lz, 10
  %.sroa.speculate.load.false.sroa.speculated.i278 = call i32 @llvm.smax.i32(i32 %8, i32 0)
  %i.ma = call i32 @llvm.umin.i32(i32 %.sroa.speculate.load.false.sroa.speculated.i278, i32 32767)
