...
bb.b:                                             ; preds = %bb.a
  ...
  %i.f = load float, ptr %i.e, align 8, !tbaa !11 ; 2 uses
  ...
  %i.j = load float, ptr %i.i, align 8, !tbaa !11 ; 2 uses
  ...
  %i.o = load <8 x float>, ptr %i.b, align 64, !tbaa !11 ; 4 uses
  %i.p = load <4 x float>, ptr %gep.2.i, align 32, !tbaa !11 ; 2 uses
  ...
  %i.z = load <2 x float>, ptr %i.c, align 64, !tbaa !11 ; 5 uses
  ...
  %i.ae = load <2 x float>, ptr %i.g, align 16, !tbaa !11 ; 5 uses
  ...
  %i.bd = load <2 x float>, ptr %i.k, align 32, !tbaa !11 ; 4 uses
  %i.be = load float, ptr %i.l, align 8, !tbaa !11 ; 2 uses
