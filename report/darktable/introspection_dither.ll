...
_nearest_color.exit355.i:                         ; preds = %.loopexit.loopexit32.i353.i, %.preheader.preheader.i354.i
  ...
  %i.aed = getelementptr inbounds nuw [4 x i8], ptr %i.acs, i64 %i.sk ; 6 uses
  ...
  %i.aek = fadd reassoc nsz arcp contract afn <4 x float> %i.aei, %i.aej ; 4 uses
...
.loopexit.loopexit32.i357.i:                      ; preds = %_nearest_color.exit355.i
  ...
  %i.afb = fadd reassoc nsz arcp contract afn float %i.afa, %.reass252.i
...
_nearest_color.exit367.i:                         ; preds = %.loopexit.loopexit32.i365.i, %.preheader.preheader.i366.i
  ...
  %i.akf = getelementptr inbounds nuw [4 x i8], ptr %i.aic, i64 %i.sk ; 6 uses
  ...
  %i.aki = fadd reassoc nsz arcp contract afn <4 x float> %i.akh, %i.akg ; 4 uses
