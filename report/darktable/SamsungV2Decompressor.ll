...
.preheader:                                       ; preds = %bb.ef, %bb.ee
  ...
  %i.xv = load i32, ptr %i.ac, align 4, !tbaa !107 ; 2 uses
  %i.xw = trunc nuw i64 %indvars.iv.next459 to i32
  %i.xx = icmp sgt i32 %i.xv, %i.xw
  br i1 %i.xx, label %bb.g, label %._crit_edge, !llvm.loop !142
}
...
!0 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>", scope: !117, file: !112, line: 125, size: 128, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: "_ZTSSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE")
