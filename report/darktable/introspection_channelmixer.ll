...
hsl2rgb.exit.i:                                   ; preds = %bb.bh, %bb.bg, %bb.bf, %rgb2hsl.exit.i42, %bb.ah
  ...
  %i.oz = fadd reassoc nsz arcp contract afn float %i.ox, %i.oy
  ...
  %i.pf = fadd reassoc nsz arcp contract afn float %i.pd, %i.pe
  ...
  %i.pm = fadd reassoc nsz arcp contract afn float %i.pk, %i.pl
