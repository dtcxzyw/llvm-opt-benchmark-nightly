...
dt_get_debug_wtime.exit:                          ; preds = %bb.b, %bb.c
  ...
  br i1 %i.x, label %bb.y, label %.preheader146

.preheader146:                                    ; preds = %dt_get_debug_wtime.exit
  %.088148 = load ptr, ptr %2, align 8, !tbaa !11 ; 2 uses
  %.not92149 = icmp eq ptr %.088148, null
  br i1 %.not92149, label %._crit_edge, label %.lr.ph153
...
.lr.ph153:                                        ; preds = %.preheader146
  ...
  %min.iters.check497 = icmp ult i64 %i.t, 4
  %min.iters.check499 = icmp ult i64 %i.t, 32
  %i.ab = and i64 %i.t, 28
  %n.vec501 = and i64 %i.t, -32                   ; 4 uses
  %cmp.n516 = icmp eq i64 %i.t, %n.vec501
  %min.epilog.iters.check521 = icmp eq i64 %i.ab, 0
  %n.vec523 = and i64 %i.t, -4                    ; 3 uses
  %cmp.n532 = icmp eq i64 %i.t, %n.vec523
  %min.iters.check459 = icmp ult i64 %i.t, 4
  %min.iters.check461 = icmp ult i64 %i.t, 32
  %i.ac = and i64 %i.t, 28
  %n.vec463 = and i64 %i.t, -32                   ; 4 uses
  %cmp.n478 = icmp eq i64 %i.t, %n.vec463
  %min.epilog.iters.check483 = icmp eq i64 %i.ac, 0
  %n.vec485 = and i64 %i.t, -4                    ; 3 uses
  %cmp.n494 = icmp eq i64 %i.t, %n.vec485
  %min.iters.check421 = icmp ult i64 %i.t, 4
  %min.iters.check423 = icmp ult i64 %i.t, 32
  %i.ad = and i64 %i.t, 28
  %n.vec425 = and i64 %i.t, -32                   ; 4 uses
  %cmp.n440 = icmp eq i64 %i.t, %n.vec425
  %min.epilog.iters.check445 = icmp eq i64 %i.ad, 0
  %n.vec447 = and i64 %i.t, -4                    ; 3 uses
  %cmp.n456 = icmp eq i64 %i.t, %n.vec447
  %min.iters.check383 = icmp ult i64 %i.t, 4
  %min.iters.check385 = icmp ult i64 %i.t, 32
  %i.ae = and i64 %i.t, 28
  %n.vec387 = and i64 %i.t, -32                   ; 4 uses
  %cmp.n402 = icmp eq i64 %i.t, %n.vec387
  %min.epilog.iters.check407 = icmp eq i64 %i.ae, 0
  %n.vec409 = and i64 %i.t, -4                    ; 3 uses
  %cmp.n418 = icmp eq i64 %i.t, %n.vec409
  %min.iters.check345 = icmp ult i64 %i.t, 8
  %min.iters.check347 = icmp ult i64 %i.t, 32
  %i.af = and i64 %i.t, 24
  %n.vec349 = and i64 %i.t, -32                   ; 4 uses
  %cmp.n364 = icmp eq i64 %i.t, %n.vec349
  %min.epilog.iters.check369 = icmp eq i64 %i.af, 0
  %n.vec371 = and i64 %i.t, -8                    ; 3 uses
  %cmp.n380 = icmp eq i64 %i.t, %n.vec371
  %min.iters.check307 = icmp ult i64 %i.t, 8
  %min.iters.check309 = icmp ult i64 %i.t, 32
  %i.ag = and i64 %i.t, 24
  %n.vec311 = and i64 %i.t, -32                   ; 4 uses
  %cmp.n326 = icmp eq i64 %i.t, %n.vec311
  %min.epilog.iters.check331 = icmp eq i64 %i.ag, 0
  %n.vec333 = and i64 %i.t, -8                    ; 3 uses
  %cmp.n342 = icmp eq i64 %i.t, %n.vec333
  %min.iters.check269 = icmp ult i64 %i.t, 4
  %min.iters.check271 = icmp ult i64 %i.t, 32
  %i.ah = and i64 %i.t, 28
  %n.vec273 = and i64 %i.t, -32                   ; 4 uses
  %cmp.n288 = icmp eq i64 %i.t, %n.vec273
end_hunk_2
