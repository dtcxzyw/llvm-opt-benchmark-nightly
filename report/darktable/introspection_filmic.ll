...
bb.d:                                             ; preds = %bb.c
  ...
  %i.di = fadd reassoc nnan nsz arcp contract afn float %i.df, f0xC2F87377
  %i.dj = fadd reassoc nsz arcp contract afn float %i.di, %.neg.i.i
  %6 = fsub reassoc nsz arcp contract afn float %.neg6.i.i, %i.p
  %i.dk = fadd reassoc nsz arcp contract afn float %6, %i.dj
...
bb.f:                                             ; preds = %.loopexit.i
  ...
  %7 = shufflevector <2 x float> %i.ei, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %8 = insertelement <2 x float> %7, float %i.ek, i64 1
  %9 = bitcast <2 x float> %8 to <2 x i32>        ; 2 uses
  %i.em = lshr i32 %i.el, 23
  %10 = shufflevector <2 x i32> %9, <2 x i32> poison, <4 x i32> <i32 poison, i32 poison, i32 0, i32 1>
  %11 = insertelement <4 x i32> %10, i32 %i.el, i64 0
  %12 = insertelement <4 x i32> %11, i32 %i.em, i64 1
  %13 = and <4 x i32> %12, <i32 8388607, i32 255, i32 8388607, i32 8388607> ; 3 uses
  %14 = extractelement <4 x i32> %13, i64 0
  %15 = or disjoint i32 %14, 1065353216
  %16 = bitcast i32 %15 to float                  ; 5 uses
  %17 = extractelement <4 x i32> %13, i64 1
  %18 = add nsw i32 %17, -127
  %19 = sitofp i32 %18 to float
  %i.en = fmul reassoc nnan nsz arcp contract afn float %16, f0x3D74552F
  %i.eo = fadd reassoc nnan nsz arcp contract afn float %i.en, f0xBEEE7397
  %i.ep = fmul reassoc nnan nsz arcp contract afn float %i.eo, %16
  %i.eq = fadd reassoc nnan nsz arcp contract afn float %i.ep, f0x3FBD96DD
  %i.er = fmul reassoc nnan nsz arcp contract afn float %i.eq, %16
  %i.es = fadd reassoc nnan nsz arcp contract afn float %i.er, f0xC02153F6
  %i.et = fmul reassoc nnan nsz arcp contract afn float %i.es, %16
  %i.eu = fadd reassoc nnan nsz arcp contract afn float %i.et, f0x4038D96C
  %i.ev = fadd reassoc nnan nsz arcp contract afn float %16, -1.000000e+00
  %i.ew = fmul reassoc nsz arcp contract afn float %i.eu, %i.ev
  %20 = fadd reassoc nsz arcp contract afn float %i.ew, %19
  %21 = shufflevector <4 x i32> %13, <4 x i32> poison, <2 x i32> <i32 2, i32 3>
  %i.ex = or disjoint <2 x i32> %21, splat (i32 1065353216)
  %i.ey = bitcast <2 x i32> %i.ex to <2 x float>  ; 5 uses
  %22 = lshr <2 x i32> %9, splat (i32 23)
  %23 = and <2 x i32> %22, splat (i32 255)
  %24 = add nsw <2 x i32> %23, splat (i32 -127)
  ...
  %26 = fadd reassoc nsz arcp contract afn <2 x float> %i.fi, %25
...
bb.g:                                             ; preds = %bb.f
  ...
  %27 = fadd reassoc nsz arcp contract afn float %i.fx, %i.ga
  %28 = fsub reassoc nsz arcp contract afn float %27, %i.p
  %i.gb = fmul reassoc nsz arcp contract afn float %28, %i.s
...
.preheader.preheader.i:                           ; preds = %bb.g, %bb.f
  ...
  %i.ge = fsub reassoc nsz arcp contract afn float %20, %i.p
  %i.gf = fmul reassoc nsz arcp contract afn float %i.ge, %i.s
  ...
  %i.gi = fsub reassoc nsz arcp contract afn <2 x float> %26, %i.ak
  %i.gj = extractelement <2 x i1> %i.gd, i64 1
  %i.gk = fcmp reassoc nsz arcp contract afn ogt float %i.ek, f0x37800000
  %i.gl = fmul reassoc nsz arcp contract afn <2 x float> %i.gi, %i.am ; 2 uses
...
bb.j:                                             ; preds = %bb.i, %bb.h, %bb.g
  ...
  %i.ay = fsub reassoc nsz arcp contract afn float %i.x, %i.ax ; 2 uses
  %i.az = fmul reassoc nsz arcp contract afn float %i.ao, %i.at
  %6 = fadd reassoc nsz arcp contract afn float %i.az, %i.ay
  %i.ba = fmul reassoc nsz arcp contract afn float %i.ao, %i.aw
  %7 = fadd reassoc nsz arcp contract afn float %i.ba, %i.ay
  ...
  %i.bg = fdiv reassoc nsz arcp contract afn float %i.bf, %sqrt ; 2 uses
  %i.bh = fadd reassoc nsz arcp contract afn float %i.bg, %6 ; 3 uses
  %i.bi = fadd reassoc nsz arcp contract afn float %i.bg, %7 ; 3 uses
