...
bb.e:                                             ; preds = %bb.d
  ...
  %i.dm = fadd reassoc nnan nsz arcp contract afn float %i.dj, f0xC2F87377
  %i.dn = fadd reassoc nsz arcp contract afn float %i.dm, %.neg.i.i
  %6 = fsub reassoc nsz arcp contract afn float %.neg6.i.i, %i.q
  %i.do = fadd reassoc nsz arcp contract afn float %6, %i.dn
...
bb.g:                                             ; preds = %.loopexit.i
  ...
  %7 = lshr i32 %i.eo, 23
  %8 = insertelement <2 x float> %i.em, float %i.en, i64 1
  ...
  %11 = insertelement <4 x i32> %10, i32 %i.eo, i64 0
  %12 = insertelement <4 x i32> %11, i32 %7, i64 1
  ...
  %i.ep = fmul reassoc nnan nsz arcp contract afn float %16, f0x3D74552F
  ...
  %i.ev = fmul reassoc nnan nsz arcp contract afn float %i.eu, %16
  %i.ew = fadd reassoc nnan nsz arcp contract afn float %i.ev, f0x4038D96C
  %i.ex = fadd reassoc nnan nsz arcp contract afn float %16, -1.000000e+00
  %i.ey = fmul reassoc nsz arcp contract afn float %i.ew, %i.ex
  %20 = fadd reassoc nsz arcp contract afn float %i.ey, %19
  %21 = shufflevector <4 x i32> %13, <4 x i32> poison, <2 x i32> <i32 2, i32 3>
  %i.ez = or disjoint <2 x i32> %21, splat (i32 1065353216)
  ...
  %26 = fadd reassoc nsz arcp contract afn <2 x float> %i.fk, %25
...
bb.h:                                             ; preds = %bb.g
  ...
  %27 = fadd reassoc nsz arcp contract afn float %i.fz, %i.gc
  %28 = fsub reassoc nsz arcp contract afn float %27, %i.q
  %i.gd = fmul reassoc nsz arcp contract afn float %28, %i.t
...
.preheader.preheader.i:                           ; preds = %bb.h, %bb.g
  ...
  %i.gg = fsub reassoc nsz arcp contract afn float %20, %i.q
  %i.gh = fmul reassoc nsz arcp contract afn float %i.gg, %i.t
  ...
  %i.gk = fsub reassoc nsz arcp contract afn <2 x float> %26, %i.ak
  %i.gl = extractelement <2 x i1> %i.gf, i64 0
  %i.gm = fcmp reassoc nsz arcp contract afn ogt float %i.en, f0x37800000
  %i.gn = fmul reassoc nsz arcp contract afn <2 x float> %i.gk, %i.am ; 2 uses
