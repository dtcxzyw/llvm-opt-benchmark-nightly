...
.lr.ph:                                           ; preds = %bb.c, %bb.m
  ...
  %i.ds = load ptr, ptr %.0165201, align 8, !tbaa !223 ; 6 uses
  %i.dt = getelementptr inbounds nuw i8, ptr %i.ds, i64 8
  %i.du = load ptr, ptr %i.dt, align 8, !tbaa !225 ; 4 uses
...
bb.k:                                             ; preds = %bb.j
  %i.ej = load ptr, ptr %i.ds, align 8, !tbaa !226
  ...
  %i.el = load ptr, ptr %i.ds, align 8, !tbaa !226
...
_aspect_format.exit189:                           ; preds = %bb.j
  ...
  %i.er = load ptr, ptr %i.ds, align 8, !tbaa !226
...
bb.l:                                             ; preds = %.critedge
  %i.ez = load ptr, ptr %i.ds, align 8, !tbaa !226
  ...
  %i.fb = load ptr, ptr %i.ds, align 8, !tbaa !226
...
bb.m:                                             ; preds = %bb.k, %_aspect_format.exit189, %bb.l
  ...
  %i.fd = load ptr, ptr %i.fc, align 8, !tbaa !227 ; 2 uses
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.fs = load ptr, ptr %i.fr, align 8, !tbaa !228 ; 2 uses
...
bb.p:                                             ; preds = %bb.o, %bb.n
  ...
  %i.fx = load ptr, ptr %i.fw, align 8, !tbaa !229 ; 2 uses
...
dt_bauhaus_widget_set_quad.exit:                  ; preds = %._crit_edge210, %bb.q
  ...
  %i.gn = load ptr, ptr %i.gm, align 8, !tbaa !230
  %i.go = getelementptr inbounds nuw i8, ptr %0, i64 824 ; 2 uses
  store ptr %i.gn, ptr %i.go, align 8, !tbaa !231
