...
bb.a:
  ...
  %i.h = load i32, ptr %i.a, align 4, !tbaa !111
  %i.i = load i32, ptr %i.b, align 4, !tbaa !111
  %i.j = insertelement <2 x i32> poison, i32 %i.h, i64 0
  %i.k = insertelement <2 x i32> %i.j, i32 %i.i, i64 1
  %i.l = sitofp <2 x i32> %i.k to <2 x double>    ; 7 uses
...
_aspect_ratio_get.exit:                           ; preds = %bb.c, %.critedge.i, %bb.f, %bb.g, %bb.i, %bb.l
  ...
  %2 = extractelement <2 x double> %i.l, i64 0
  %3 = extractelement <2 x double> %i.l, i64 1    ; 2 uses
  %4 = fcmp reassoc nsz arcp contract afn olt double %2, %3
  %i.br = fcmp reassoc nsz arcp contract afn une float %.4.i, 0.000000e+00
  %or.cond = and i1 %4, %i.br
