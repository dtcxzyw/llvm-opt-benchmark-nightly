...
bb.ab:                                            ; preds = %bb.aa, %bb.z
  ...
  %.5182 = phi nsz double [ %.4181, %bb.aa ], [ %i.fn, %bb.z ] ; 5 uses
...
bb.ad:                                            ; preds = %bb.ac, %bb.ab
  ...
  %.5 = phi nsz double [ %.4, %bb.ac ], [ %i.fg, %bb.ab ] ; 3 uses
  ...
  %2 = insertelement <2 x double> poison, double %.5, i64 0
  %3 = insertelement <2 x double> %2, double %.5182, i64 1 ; 2 uses
  %4 = fsub reassoc nsz arcp contract afn <2 x double> splat (double 1.000000e+00), %3 ; 2 uses
  %5 = fcmp reassoc nsz arcp contract afn olt <2 x double> %i.gl, zeroinitializer
  %6 = insertelement <2 x double> poison, double %.4187, i64 0
  %i.gq = insertelement <2 x double> %6, double %.4192, i64 1
  %7 = fcmp reassoc nsz arcp contract afn ogt <2 x double> %i.gq, %4
  %i.gr = fcmp reassoc nsz arcp contract afn oge <2 x double> %3, zeroinitializer
  %i.gs = select <2 x i1> %5, <2 x double> zeroinitializer, <2 x double> %i.gl
  %8 = shufflevector <2 x i1> %i.gr, <2 x i1> %7, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.gt = insertelement <4 x double> poison, double %i.gn, i64 0
  %i.gu = insertelement <4 x double> %i.gt, double %i.gp, i64 1
  %9 = shufflevector <2 x double> %4, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %10 = shufflevector <4 x double> %i.gu, <4 x double> %9, <4 x i32> <i32 0, i32 1, i32 4, i32 5>
  ...
  %i.gx = select <4 x i1> %8, <4 x double> %10, <4 x double> %i.gw
