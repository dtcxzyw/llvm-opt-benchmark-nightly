...
.preheader1968.preheader:                         ; preds = %bb.o
  ...
  %scevgep3848 = getelementptr i8, ptr %i.btr, i64 64000
  %scevgep3850 = getelementptr i8, ptr %i.btr, i64 67076
...
.preheader1968:                                   ; preds = %.preheader1968.preheader, %._crit_edge2081
  %indvar3808 = phi i64 [ 0, %.preheader1968.preheader ], [ %indvar.next3809, %._crit_edge2081 ] ; 2 uses
  ...
  %invariant.op4502 = add i64 1, %i.bvu
  br label %bb.p
...
._crit_edge2081:                                  ; preds = %bb.aj
  ...
  %indvar.next3809 = add i64 %indvar3808, 1
  br i1 %i.bvz, label %.preheader1968, label %.preheader1975.loopexit

bb.p:                                             ; preds = %.preheader1968, %bb.aj
  %indvar3752 = phi i32 [ 0, %.preheader1968 ], [ %indvar.next3753, %bb.aj ] ; 5 uses
  ...
  %i.bwb = mul nsw i32 %indvar3752, -112
  %i.bwc = or disjoint i32 %i.bwb, 1
  %i.bwd = mul nsw i32 %indvar3752, -112
  %i.bwe = or disjoint i32 %i.bwd, 1
  %smax3812 = call i32 @llvm.smax.i32(i32 %indvars.iv2458, i32 0)
  %i.bwf = zext nneg i32 %smax3812 to i64         ; 2 uses
  %i.bwg = add nuw nsw i64 %i.bwf, 1
  %smin = call i32 @llvm.smin.i32(i32 %indvars.iv2401, i32 %i.eu)
  %i.bwh = add i32 %smin, -3
  %smin3813 = call i32 @llvm.smin.i32(i32 %i.ae, i32 %i.bwh)
  %i.bwi = zext i32 %smin3813 to i64
  %umax3814 = call i64 @llvm.umax.i64(i64 %i.bwg, i64 %i.bwi)
  %i.bwj = sub nsw i64 %umax3814, %i.bwf          ; 7 uses
  ...
  %i.bwn = mul nsw i32 %indvar3752, -112
  %i.bwo = add i32 %i.bwn, -9
  %.neg4053 = mul i32 %indvar3752, 112
...
.lr.ph1995.preheader:                             ; preds = %bb.p
  ...
  %invariant.gep2968 = getelementptr [4 x i8], ptr %i.av, i64 %indvars.iv2494
...
.prol.preheader4220:                              ; preds = %.preheader1918.preheader, %.prol.preheader4220
  %indvars.iv2345.prol = phi i64 [ %indvars.iv.next2346.prol, %.prol.preheader4220 ], [ %i.bxi, %.preheader1918.preheader ] ; 4 uses
  ...
  %i.bxl = shl i32 %indvars.iv2345.tr.prol, 1
...
.prol.loopexit4221:                               ; preds = %.prol.preheader4220, %.preheader1918.preheader
  %indvars.iv2345.unr = phi i64 [ %i.bxi, %.preheader1918.preheader ], [ %indvars.iv.next2346.prol, %.prol.preheader4220 ]
...
.lr.ph1995:                                       ; preds = %.lr.ph1995.preheader, %._crit_edge1996
  ...
  %gep2969 = getelementptr [4 x i8], ptr %invariant.gep2968, i64 %i.byg ; 9 uses
...
.prol.preheader:                                  ; preds = %.lr.ph1995, %.prol.preheader
  ...
  %gep.prol = getelementptr [4 x i8], ptr %gep2969, i64 %indvars.iv.prol
...
bb.q:                                             ; preds = %bb.q, %.lr.ph1995.new
  ...
  %gep = getelementptr [4 x i8], ptr %gep2969, i64 %indvars.iv
  ...
  %gep.1 = getelementptr [4 x i8], ptr %gep2969, i64 %indvars.iv.next
  ...
  %gep.2 = getelementptr [4 x i8], ptr %gep2969, i64 %indvars.iv.next.1
  ...
  %gep.3 = getelementptr [4 x i8], ptr %gep2969, i64 %indvars.iv.next.2
  ...
  %gep.4 = getelementptr [4 x i8], ptr %gep2969, i64 %indvars.iv.next.3
  ...
  %gep.5 = getelementptr [4 x i8], ptr %gep2969, i64 %indvars.iv.next.4
  ...
  %gep.6 = getelementptr [4 x i8], ptr %gep2969, i64 %indvars.iv.next.5
  ...
  %gep.7 = getelementptr [4 x i8], ptr %gep2969, i64 %indvars.iv.next.6
...
._crit_edge2003:                                  ; preds = %._crit_edge2003.prol.loopexit, %._crit_edge2003
  %indvars.iv2345.1 = phi i64 [ %indvars.iv.next2346.1.3, %._crit_edge2003 ], [ %indvars.iv2345.1.unr, %._crit_edge2003.prol.loopexit ] ; 8 uses
  %indvars.iv2345.1.tr = trunc i64 %indvars.iv2345.1 to i32
  %i.cao = shl i32 %indvars.iv2345.1.tr, 1
  ...
  %sext2914 = add i64 %i.caw, 8246337208320
  %i.cax = ashr exact i64 %sext2914, 30
  ...
  %indvars.iv2345.1.tr.1 = trunc i64 %indvars.iv.next2346.1 to i32
  %i.cbc = shl i32 %indvars.iv2345.1.tr.1, 1
  ...
  %sext2914.1 = add i64 %i.cbk, 8246337208320
  %i.cbl = ashr exact i64 %sext2914.1, 30
  ...
  %indvars.iv.next2346.1.1 = add nuw nsw i64 %indvars.iv2345.1, 2 ; 2 uses
  %indvars.iv2345.1.tr.2 = trunc i64 %indvars.iv2345.1 to i32
  %i.cbq = shl i32 %indvars.iv2345.1.tr.2, 1
  ...
  %sext2914.2 = add i64 %i.cby, 8246337208320
  %i.cbz = ashr exact i64 %sext2914.2, 30
  ...
  %indvars.iv2345.1.tr.3 = trunc i64 %indvars.iv.next2346.1.2 to i32
  %i.cce = shl i32 %indvars.iv2345.1.tr.3, 1
  ...
  %sext2914.3 = add i64 %i.ccm, 8246337208320
  %i.ccn = ashr exact i64 %sext2914.3, 30
...
._crit_edge2003.1.preheader:                      ; preds = %._crit_edge2003, %._crit_edge2003.prol.loopexit
  %xtraiter4237 = and i64 %wide.trip.count2349, 3 ; 2 uses
  %lcmp.mod4238.not = icmp eq i64 %xtraiter4237, 0
  br i1 %lcmp.mod4238.not, label %._crit_edge2003.1.prol.loopexit, label %._crit_edge2003.1.prol
...
._crit_edge2003.1.prol:                           ; preds = %._crit_edge2003.1.preheader, %._crit_edge2003.1.prol
  ...
  %prol.iter4239 = phi i64 [ %prol.iter4239.next, %._crit_edge2003.1.prol ], [ 0, %._crit_edge2003.1.preheader ]
  %indvars.iv2345.2.tr.prol = trunc i64 %indvars.iv2345.2.prol to i32
  %i.ccs = shl i32 %indvars.iv2345.2.tr.prol, 1
  ...
  %sext2915.prol = add i64 %i.cda, 7696581394432
  %i.cdb = ashr exact i64 %sext2915.prol, 30
  ...
  %prol.iter4239.next = add i64 %prol.iter4239, 1 ; 2 uses
  %prol.iter4239.cmp.not = icmp eq i64 %prol.iter4239.next, %xtraiter4237
  br i1 %prol.iter4239.cmp.not, label %._crit_edge2003.1.prol.loopexit, label %._crit_edge2003.1.prol, !llvm.loop !63
...
._crit_edge2003.1:                                ; preds = %._crit_edge2003.1.prol.loopexit, %._crit_edge2003.1
  %indvars.iv2345.2 = phi i64 [ %indvars.iv.next2346.2.3, %._crit_edge2003.1 ], [ %indvars.iv2345.2.unr, %._crit_edge2003.1.prol.loopexit ] ; 8 uses
  %indvars.iv2345.2.tr = trunc i64 %indvars.iv2345.2 to i32
  %i.cdh = shl i32 %indvars.iv2345.2.tr, 1
  ...
  %sext2915 = add i64 %i.cdp, 7696581394432
  %i.cdq = ashr exact i64 %sext2915, 30
  ...
  %indvars.iv2345.2.tr.1 = trunc i64 %indvars.iv.next2346.2 to i32
  %i.cdv = shl i32 %indvars.iv2345.2.tr.1, 1
  ...
  %sext2915.1 = add i64 %i.ced, 7696581394432
  %i.cee = ashr exact i64 %sext2915.1, 30
  ...
  %indvars.iv.next2346.2.1 = add nuw nsw i64 %indvars.iv2345.2, 2 ; 2 uses
  %indvars.iv2345.2.tr.2 = trunc i64 %indvars.iv2345.2 to i32
  %i.cej = shl i32 %indvars.iv2345.2.tr.2, 1
  ...
  %sext2915.2 = add i64 %i.cer, 7696581394432
  %i.ces = ashr exact i64 %sext2915.2, 30
  ...
  %indvars.iv2345.2.tr.3 = trunc i64 %indvars.iv.next2346.2.2 to i32
  %i.cex = shl i32 %indvars.iv2345.2.tr.3, 1
  ...
  %sext2915.3 = add i64 %i.cff, 7696581394432
  %i.cfg = ashr exact i64 %sext2915.3, 30
...
._crit_edge2003.2.preheader:                      ; preds = %._crit_edge2003.1, %._crit_edge2003.1.prol.loopexit
  %xtraiter4240 = and i64 %wide.trip.count2349, 3 ; 2 uses
  %lcmp.mod4241.not = icmp eq i64 %xtraiter4240, 0
  br i1 %lcmp.mod4241.not, label %._crit_edge2003.2.prol.loopexit, label %._crit_edge2003.2.prol
...
._crit_edge2003.2.prol:                           ; preds = %._crit_edge2003.2.preheader, %._crit_edge2003.2.prol
  ...
  %prol.iter4242 = phi i64 [ %prol.iter4242.next, %._crit_edge2003.2.prol ], [ 0, %._crit_edge2003.2.preheader ]
  %indvars.iv2345.3.tr.prol = trunc i64 %indvars.iv2345.3.prol to i32
  %i.cfl = shl i32 %indvars.iv2345.3.tr.prol, 1
  ...
  %sext2916.prol = add i64 %i.cft, 7146825580544
  %i.cfu = ashr exact i64 %sext2916.prol, 30
  ...
  %prol.iter4242.next = add i64 %prol.iter4242, 1 ; 2 uses
  %prol.iter4242.cmp.not = icmp eq i64 %prol.iter4242.next, %xtraiter4240
  br i1 %prol.iter4242.cmp.not, label %._crit_edge2003.2.prol.loopexit, label %._crit_edge2003.2.prol, !llvm.loop !64
...
._crit_edge2003.2:                                ; preds = %._crit_edge2003.2.prol.loopexit, %._crit_edge2003.2
  %indvars.iv2345.3 = phi i64 [ %indvars.iv.next2346.3.3, %._crit_edge2003.2 ], [ %indvars.iv2345.3.unr, %._crit_edge2003.2.prol.loopexit ] ; 8 uses
  %indvars.iv2345.3.tr = trunc i64 %indvars.iv2345.3 to i32
  %i.cga = shl i32 %indvars.iv2345.3.tr, 1
  ...
  %sext2916 = add i64 %i.cgi, 7146825580544
  %i.cgj = ashr exact i64 %sext2916, 30
  ...
  %indvars.iv2345.3.tr.1 = trunc i64 %indvars.iv.next2346.3 to i32
  %i.cgo = shl i32 %indvars.iv2345.3.tr.1, 1
  ...
  %sext2916.1 = add i64 %i.cgw, 7146825580544
  %i.cgx = ashr exact i64 %sext2916.1, 30
  ...
  %indvars.iv.next2346.3.1 = add nuw nsw i64 %indvars.iv2345.3, 2 ; 2 uses
  %indvars.iv2345.3.tr.2 = trunc i64 %indvars.iv2345.3 to i32
  %i.chc = shl i32 %indvars.iv2345.3.tr.2, 1
  ...
  %sext2916.2 = add i64 %i.chk, 7146825580544
  %i.chl = ashr exact i64 %sext2916.2, 30
  ...
  %indvars.iv2345.3.tr.3 = trunc i64 %indvars.iv.next2346.3.2 to i32
  %i.chq = shl i32 %indvars.iv2345.3.tr.3, 1
  ...
  %sext2916.3 = add i64 %i.chy, 7146825580544
  %i.chz = ashr exact i64 %sext2916.3, 30
...
._crit_edge2003.3.preheader:                      ; preds = %._crit_edge2003.2, %._crit_edge2003.2.prol.loopexit
  %xtraiter4243 = and i64 %wide.trip.count2349, 3 ; 2 uses
  %lcmp.mod4244.not = icmp eq i64 %xtraiter4243, 0
  br i1 %lcmp.mod4244.not, label %._crit_edge2003.3.prol.loopexit, label %._crit_edge2003.3.prol
...
._crit_edge2003.3.prol:                           ; preds = %._crit_edge2003.3.preheader, %._crit_edge2003.3.prol
  ...
  %prol.iter4245 = phi i64 [ %prol.iter4245.next, %._crit_edge2003.3.prol ], [ 0, %._crit_edge2003.3.preheader ]
  %indvars.iv2345.4.tr.prol = trunc i64 %indvars.iv2345.4.prol to i32
  %i.cie = shl i32 %indvars.iv2345.4.tr.prol, 1
  ...
  %sext2917.prol = add i64 %i.cim, 6597069766656
  %i.cin = ashr exact i64 %sext2917.prol, 30
  ...
  %prol.iter4245.next = add i64 %prol.iter4245, 1 ; 2 uses
  %prol.iter4245.cmp.not = icmp eq i64 %prol.iter4245.next, %xtraiter4243
  br i1 %prol.iter4245.cmp.not, label %._crit_edge2003.3.prol.loopexit, label %._crit_edge2003.3.prol, !llvm.loop !65
...
._crit_edge2003.3:                                ; preds = %._crit_edge2003.3.prol.loopexit, %._crit_edge2003.3
  %indvars.iv2345.4 = phi i64 [ %indvars.iv.next2346.4.3, %._crit_edge2003.3 ], [ %indvars.iv2345.4.unr, %._crit_edge2003.3.prol.loopexit ] ; 8 uses
  %indvars.iv2345.4.tr = trunc i64 %indvars.iv2345.4 to i32
  %i.cit = shl i32 %indvars.iv2345.4.tr, 1
  ...
  %sext2917 = add i64 %i.cjb, 6597069766656
  %i.cjc = ashr exact i64 %sext2917, 30
  ...
  %indvars.iv2345.4.tr.1 = trunc i64 %indvars.iv.next2346.4 to i32
  %i.cjh = shl i32 %indvars.iv2345.4.tr.1, 1
  ...
  %sext2917.1 = add i64 %i.cjp, 6597069766656
  %i.cjq = ashr exact i64 %sext2917.1, 30
  ...
  %indvars.iv.next2346.4.1 = add nuw nsw i64 %indvars.iv2345.4, 2 ; 2 uses
  %indvars.iv2345.4.tr.2 = trunc i64 %indvars.iv2345.4 to i32
  %i.cjv = shl i32 %indvars.iv2345.4.tr.2, 1
  ...
  %sext2917.2 = add i64 %i.ckd, 6597069766656
  %i.cke = ashr exact i64 %sext2917.2, 30
  ...
  %indvars.iv2345.4.tr.3 = trunc i64 %indvars.iv.next2346.4.2 to i32
  %i.ckj = shl i32 %indvars.iv2345.4.tr.3, 1
  ...
  %sext2917.3 = add i64 %i.ckr, 6597069766656
  %i.cks = ashr exact i64 %sext2917.3, 30
...
._crit_edge2003.4.preheader:                      ; preds = %._crit_edge2003.3, %._crit_edge2003.3.prol.loopexit
  %xtraiter4246 = and i64 %wide.trip.count2349, 3 ; 2 uses
  %lcmp.mod4247.not = icmp eq i64 %xtraiter4246, 0
  br i1 %lcmp.mod4247.not, label %._crit_edge2003.4.prol.loopexit, label %._crit_edge2003.4.prol
...
._crit_edge2003.4.prol:                           ; preds = %._crit_edge2003.4.preheader, %._crit_edge2003.4.prol
  ...
  %prol.iter4248 = phi i64 [ %prol.iter4248.next, %._crit_edge2003.4.prol ], [ 0, %._crit_edge2003.4.preheader ]
  %indvars.iv2345.5.tr.prol = trunc i64 %indvars.iv2345.5.prol to i32
  %i.ckx = shl i32 %indvars.iv2345.5.tr.prol, 1
  ...
  %sext2918.prol = add i64 %i.clf, 6047313952768
  %i.clg = ashr exact i64 %sext2918.prol, 30
  ...
  %prol.iter4248.next = add i64 %prol.iter4248, 1 ; 2 uses
  %prol.iter4248.cmp.not = icmp eq i64 %prol.iter4248.next, %xtraiter4246
  br i1 %prol.iter4248.cmp.not, label %._crit_edge2003.4.prol.loopexit, label %._crit_edge2003.4.prol, !llvm.loop !66
...
._crit_edge2003.4:                                ; preds = %._crit_edge2003.4.prol.loopexit, %._crit_edge2003.4
  %indvars.iv2345.5 = phi i64 [ %indvars.iv.next2346.5.3, %._crit_edge2003.4 ], [ %indvars.iv2345.5.unr, %._crit_edge2003.4.prol.loopexit ] ; 8 uses
  %indvars.iv2345.5.tr = trunc i64 %indvars.iv2345.5 to i32
  %i.clm = shl i32 %indvars.iv2345.5.tr, 1
  ...
  %sext2918 = add i64 %i.clu, 6047313952768
  %i.clv = ashr exact i64 %sext2918, 30
  ...
  %indvars.iv2345.5.tr.1 = trunc i64 %indvars.iv.next2346.5 to i32
  %i.cma = shl i32 %indvars.iv2345.5.tr.1, 1
  ...
  %sext2918.1 = add i64 %i.cmi, 6047313952768
  %i.cmj = ashr exact i64 %sext2918.1, 30
  ...
  %indvars.iv.next2346.5.1 = add nuw nsw i64 %indvars.iv2345.5, 2 ; 2 uses
  %indvars.iv2345.5.tr.2 = trunc i64 %indvars.iv2345.5 to i32
  %i.cmo = shl i32 %indvars.iv2345.5.tr.2, 1
  ...
  %sext2918.2 = add i64 %i.cmw, 6047313952768
  %i.cmx = ashr exact i64 %sext2918.2, 30
  ...
  %indvars.iv2345.5.tr.3 = trunc i64 %indvars.iv.next2346.5.2 to i32
  %i.cnc = shl i32 %indvars.iv2345.5.tr.3, 1
  ...
  %sext2918.3 = add i64 %i.cnk, 6047313952768
  %i.cnl = ashr exact i64 %sext2918.3, 30
...
._crit_edge2003.5.preheader:                      ; preds = %._crit_edge2003.4, %._crit_edge2003.4.prol.loopexit
  %xtraiter4249 = and i64 %wide.trip.count2349, 3 ; 2 uses
  %lcmp.mod4250.not = icmp eq i64 %xtraiter4249, 0
  br i1 %lcmp.mod4250.not, label %._crit_edge2003.5.prol.loopexit, label %._crit_edge2003.5.prol
...
._crit_edge2003.5.prol:                           ; preds = %._crit_edge2003.5.preheader, %._crit_edge2003.5.prol
  ...
  %prol.iter4251 = phi i64 [ %prol.iter4251.next, %._crit_edge2003.5.prol ], [ 0, %._crit_edge2003.5.preheader ]
  %indvars.iv2345.6.tr.prol = trunc i64 %indvars.iv2345.6.prol to i32
  %i.cnq = shl i32 %indvars.iv2345.6.tr.prol, 1
  ...
  %sext2919.prol = add i64 %i.cny, 5497558138880
  %i.cnz = ashr exact i64 %sext2919.prol, 30
  ...
  %prol.iter4251.next = add i64 %prol.iter4251, 1 ; 2 uses
  %prol.iter4251.cmp.not = icmp eq i64 %prol.iter4251.next, %xtraiter4249
  br i1 %prol.iter4251.cmp.not, label %._crit_edge2003.5.prol.loopexit, label %._crit_edge2003.5.prol, !llvm.loop !67
...
._crit_edge2003.5:                                ; preds = %._crit_edge2003.5.prol.loopexit, %._crit_edge2003.5
  %indvars.iv2345.6 = phi i64 [ %indvars.iv.next2346.6.3, %._crit_edge2003.5 ], [ %indvars.iv2345.6.unr, %._crit_edge2003.5.prol.loopexit ] ; 8 uses
  %indvars.iv2345.6.tr = trunc i64 %indvars.iv2345.6 to i32
  %i.cof = shl i32 %indvars.iv2345.6.tr, 1
  ...
  %sext2919 = add i64 %i.con, 5497558138880
  %i.coo = ashr exact i64 %sext2919, 30
  ...
  %indvars.iv2345.6.tr.1 = trunc i64 %indvars.iv.next2346.6 to i32
  %i.cot = shl i32 %indvars.iv2345.6.tr.1, 1
  ...
  %sext2919.1 = add i64 %i.cpb, 5497558138880
  %i.cpc = ashr exact i64 %sext2919.1, 30
  ...
  %indvars.iv.next2346.6.1 = add nuw nsw i64 %indvars.iv2345.6, 2 ; 2 uses
  %indvars.iv2345.6.tr.2 = trunc i64 %indvars.iv2345.6 to i32
  %i.cph = shl i32 %indvars.iv2345.6.tr.2, 1
  ...
  %sext2919.2 = add i64 %i.cpp, 5497558138880
  %i.cpq = ashr exact i64 %sext2919.2, 30
  ...
  %indvars.iv2345.6.tr.3 = trunc i64 %indvars.iv.next2346.6.2 to i32
  %i.cpv = shl i32 %indvars.iv2345.6.tr.3, 1
  ...
  %sext2919.3 = add i64 %i.cqd, 5497558138880
  %i.cqe = ashr exact i64 %sext2919.3, 30
...
._crit_edge2003.6.preheader:                      ; preds = %._crit_edge2003.5, %._crit_edge2003.5.prol.loopexit
  %xtraiter4252 = and i64 %wide.trip.count2349, 3 ; 2 uses
  %lcmp.mod4253.not = icmp eq i64 %xtraiter4252, 0
  br i1 %lcmp.mod4253.not, label %._crit_edge2003.6.prol.loopexit, label %._crit_edge2003.6.prol
...
._crit_edge2003.6.prol:                           ; preds = %._crit_edge2003.6.preheader, %._crit_edge2003.6.prol
  ...
  %prol.iter4254 = phi i64 [ %prol.iter4254.next, %._crit_edge2003.6.prol ], [ 0, %._crit_edge2003.6.preheader ]
  %indvars.iv2345.7.tr.prol = trunc i64 %indvars.iv2345.7.prol to i32
  %i.cqj = shl i32 %indvars.iv2345.7.tr.prol, 1
  ...
  %sext2920.prol = add i64 %i.cqr, 4947802324992
  %i.cqs = ashr exact i64 %sext2920.prol, 30
  ...
  %prol.iter4254.next = add i64 %prol.iter4254, 1 ; 2 uses
  %prol.iter4254.cmp.not = icmp eq i64 %prol.iter4254.next, %xtraiter4252
  br i1 %prol.iter4254.cmp.not, label %._crit_edge2003.6.prol.loopexit, label %._crit_edge2003.6.prol, !llvm.loop !68
...
._crit_edge2003.6:                                ; preds = %._crit_edge2003.6.prol.loopexit, %._crit_edge2003.6
  %indvars.iv2345.7 = phi i64 [ %indvars.iv.next2346.7.3, %._crit_edge2003.6 ], [ %indvars.iv2345.7.unr, %._crit_edge2003.6.prol.loopexit ] ; 8 uses
  %indvars.iv2345.7.tr = trunc i64 %indvars.iv2345.7 to i32
  %i.cqy = shl i32 %indvars.iv2345.7.tr, 1
  ...
  %sext2920 = add i64 %i.crg, 4947802324992
  %i.crh = ashr exact i64 %sext2920, 30
  ...
  %indvars.iv2345.7.tr.1 = trunc i64 %indvars.iv.next2346.7 to i32
  %i.crm = shl i32 %indvars.iv2345.7.tr.1, 1
  ...
  %sext2920.1 = add i64 %i.cru, 4947802324992
  %i.crv = ashr exact i64 %sext2920.1, 30
  ...
  %indvars.iv.next2346.7.1 = add nuw nsw i64 %indvars.iv2345.7, 2 ; 2 uses
  %indvars.iv2345.7.tr.2 = trunc i64 %indvars.iv2345.7 to i32
  %i.csa = shl i32 %indvars.iv2345.7.tr.2, 1
  ...
  %sext2920.2 = add i64 %i.csi, 4947802324992
  %i.csj = ashr exact i64 %sext2920.2, 30
  ...
  %indvars.iv2345.7.tr.3 = trunc i64 %indvars.iv.next2346.7.2 to i32
  %i.cso = shl i32 %indvars.iv2345.7.tr.3, 1
  ...
  %sext2920.3 = add i64 %i.csw, 4947802324992
  %i.csx = ashr exact i64 %sext2920.3, 30
...
.preheader1918.preheader.new:                     ; preds = %.prol.loopexit4221, %.preheader1918.preheader.new
  %indvars.iv2345 = phi i64 [ %indvars.iv.next2346.34230, %.preheader1918.preheader.new ], [ %indvars.iv2345.unr, %.prol.loopexit4221 ] ; 8 uses
  %indvars.iv2345.tr = trunc i64 %indvars.iv2345 to i32
  %i.ctc = shl i32 %indvars.iv2345.tr, 1
  ...
  %indvars.iv2345.tr.1 = trunc i64 %indvars.iv.next2346 to i32
  %i.cto = shl i32 %indvars.iv2345.tr.1, 1
  ...
  %indvars.iv.next2346.14226 = add nuw nsw i64 %indvars.iv2345, 2 ; 2 uses
  %indvars.iv2345.tr.2 = trunc i64 %indvars.iv2345 to i32
  %i.cua = shl i32 %indvars.iv2345.tr.2, 1
  ...
  %i.cuh = shl i64 %indvars.iv.next2346.14226, 32
  ...
  %i.cul = getelementptr inbounds nuw [4 x i8], ptr %i.cug, i64 %indvars.iv.next2346.14226
  store float %i.cuk, ptr %i.cul, align 4, !tbaa !58
  %indvars.iv.next2346.24228 = add nuw nsw i64 %indvars.iv2345, 3 ; 3 uses
  %indvars.iv2345.tr.3 = trunc i64 %indvars.iv.next2346.24228 to i32
  %i.cum = shl i32 %indvars.iv2345.tr.3, 1
  ...
  %i.cut = shl i64 %indvars.iv.next2346.24228, 32
  ...
  %i.cux = getelementptr inbounds nuw [4 x i8], ptr %i.cus, i64 %indvars.iv.next2346.24228
  store float %i.cuw, ptr %i.cux, align 4, !tbaa !58
  %indvars.iv.next2346.34230 = add nuw nsw i64 %indvars.iv2345, 4 ; 2 uses
  %exitcond2350.not.3 = icmp eq i64 %indvars.iv.next2346.34230, %wide.trip.count2349
  br i1 %exitcond2350.not.3, label %._crit_edge2003.preheader, label %.preheader1918.preheader.new

._crit_edge2003.preheader:                        ; preds = %.preheader1918.preheader.new, %.prol.loopexit4221
  %xtraiter4231 = and i64 %wide.trip.count2349, 3 ; 2 uses
  %lcmp.mod4232.not = icmp eq i64 %xtraiter4231, 0
  br i1 %lcmp.mod4232.not, label %._crit_edge2003.prol.loopexit, label %._crit_edge2003.prol
...
._crit_edge2003.prol:                             ; preds = %._crit_edge2003.preheader, %._crit_edge2003.prol
  ...
  %prol.iter4233 = phi i64 [ %prol.iter4233.next, %._crit_edge2003.prol ], [ 0, %._crit_edge2003.preheader ]
  %indvars.iv2345.1.tr.prol = trunc i64 %indvars.iv2345.1.prol to i32
  %i.cuy = shl i32 %indvars.iv2345.1.tr.prol, 1
  ...
  %sext2914.prol = add i64 %i.cvg, 8246337208320
  %i.cvh = ashr exact i64 %sext2914.prol, 30
  ...
  br i1 %prol.iter4233.cmp.not, label %._crit_edge2003.prol.loopexit, label %._crit_edge2003.prol, !llvm.loop !69
...
.preheader1917.preheader:                         ; preds = %.loopexit1959.split
  ...
  %xtraiter4257 = and i64 %wide.trip.count2358, 3 ; 2 uses
  %lcmp.mod4258.not = icmp eq i64 %xtraiter4257, 0
...
.preheader1917:                                   ; preds = %.preheader1917.preheader, %._crit_edge2007
  ...
  %.idx2921 = shl i64 %i.cvv, 9                   ; 5 uses
  br i1 %lcmp.mod4258.not, label %.prol.loopexit4256, label %.prol.preheader4255

.prol.preheader4255:                              ; preds = %.preheader1917, %.prol.preheader4255
  %indvars.iv2355.prol = phi i64 [ %indvars.iv.next2356.prol, %.prol.preheader4255 ], [ %i.cvn, %.preheader1917 ] ; 4 uses
  %prol.iter4259 = phi i64 [ %prol.iter4259.next, %.prol.preheader4255 ], [ 0, %.preheader1917 ]
  ...
  %i.cwk = getelementptr i8, ptr %i.cwj, i64 %.idx2921
  store float %i.cwf, ptr %i.cwk, align 4, !tbaa !58
  %indvars.iv.next2356.prol = add nuw nsw i64 %indvars.iv2355.prol, 1 ; 2 uses
  %prol.iter4259.next = add i64 %prol.iter4259, 1 ; 2 uses
  %prol.iter4259.cmp.not = icmp eq i64 %prol.iter4259.next, %xtraiter4257
  br i1 %prol.iter4259.cmp.not, label %.prol.loopexit4256, label %.prol.preheader4255, !llvm.loop !70

.prol.loopexit4256:                               ; preds = %.prol.preheader4255, %.preheader1917
  %indvars.iv2355.unr = phi i64 [ %i.cvn, %.preheader1917 ], [ %indvars.iv.next2356.prol, %.prol.preheader4255 ]
  br i1 %i.cvq, label %._crit_edge2007, label %.preheader1917.new

._crit_edge2007:                                  ; preds = %.preheader1917.new, %.prol.loopexit4256
...
.preheader1917.new:                               ; preds = %.prol.loopexit4256, %.preheader1917.new
  %indvars.iv2355 = phi i64 [ %indvars.iv.next2356.3, %.preheader1917.new ], [ %indvars.iv2355.unr, %.prol.loopexit4256 ] ; 8 uses
  ...
  %i.cwy = getelementptr i8, ptr %i.cwx, i64 %.idx2921
  ...
  %i.cxl = getelementptr i8, ptr %i.cxk, i64 %.idx2921
  ...
  %i.cxy = getelementptr i8, ptr %i.cxx, i64 %.idx2921
  ...
  %i.cyl = getelementptr i8, ptr %i.cyk, i64 %.idx2921
...
.preheader1916:                                   ; preds = %.loopexit1957, %.preheader1916
  ...
  %i.cym = shl i32 %indvars.iv2367.tr, 1
...
.preheader1915.preheader:                         ; preds = %.loopexit1955
  ...
  %umax4260 = zext i32 %i.dat to i64              ; 2 uses
  %xtraiter4261 = and i64 %umax4260, 3            ; 3 uses
  %i.dau = icmp ult i32 %i.dar, 4
  %unroll_iter4264 = and i64 %umax4260, 4294967292
  %lcmp.mod4262.not = icmp eq i64 %xtraiter4261, 0
  %lcmp.mod4263 = icmp ne i64 %xtraiter4261, 0
...
.preheader1915:                                   ; preds = %.preheader1915.preheader, %._crit_edge2013
  ...
  %i.dav = shl i32 %indvars.iv2375.tr, 1
  ...
  %.idx2922 = shl i64 %indvars.iv2375, 9          ; 5 uses
...
.preheader1915.new:                               ; preds = %.preheader1915
  ...
  %i.dbh = getelementptr i8, ptr %i.dbg, i64 %.idx2922
  ...
  %i.dbq = getelementptr i8, ptr %i.dbp, i64 %.idx2922
  ...
  %i.dby = getelementptr i8, ptr %i.dbx, i64 %.idx2922
  ...
  %i.dch = getelementptr i8, ptr %i.dcg, i64 %.idx2922
  %i.dci = getelementptr [4 x i8], ptr %i.dch, i64 %i.das
  br label %bb.s

._crit_edge2013.unr-lcssa:                        ; preds = %bb.s
  br i1 %lcmp.mod4262.not, label %._crit_edge2013, label %.epil.preheader
...
.epil.preheader:                                  ; preds = %._crit_edge2013.unr-lcssa, %.preheader1915
  ...
  call void @llvm.assume(i1 %lcmp.mod4263)
  br label %bb.r
...
bb.r:                                             ; preds = %bb.r, %.epil.preheader
  ...
  %i.dcw = getelementptr i8, ptr %i.dcv, i64 %.idx2922
  ...
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter4261
...
bb.s:                                             ; preds = %bb.s, %.preheader1915.new
  ...
  %niter4265 = phi i64 [ 0, %.preheader1915.new ], [ %niter4265.next.3, %bb.s ]
  ...
  %niter4265.next.3 = add i64 %niter4265, 4       ; 2 uses
  %niter4265.ncmp.3.not = icmp eq i64 %niter4265.next.3, %unroll_iter4264
  br i1 %niter4265.ncmp.3.not, label %._crit_edge2013.unr-lcssa, label %bb.s
...
.preheader1914:                                   ; preds = %.loopexit1953, %.preheader1914
  ...
  %sext2923 = add i64 %i.deq, 64424509440
  %i.der = ashr exact i64 %sext2923, 30
  ...
  %sext2924 = add i64 %i.dez, 60129542144
  %i.dfa = ashr exact i64 %sext2924, 30
  ...
  %sext2925 = add i64 %i.dff, 55834574848
  %i.dfg = ashr exact i64 %sext2925, 30
  ...
  %sext2926 = add i64 %i.dfl, 51539607552
  %i.dfm = ashr exact i64 %sext2926, 30
  ...
  %sext2927 = add i64 %i.dfr, 47244640256
  %i.dfs = ashr exact i64 %sext2927, 30
  ...
  %sext2928 = add i64 %i.dfx, 42949672960
  %i.dfy = ashr exact i64 %sext2928, 30
  ...
  %sext2929 = add i64 %i.dgd, 38654705664
  %i.dge = ashr exact i64 %sext2929, 30
...
.preheader1913.preheader:                         ; preds = %.loopexit1951
  ...
  %umax4267 = zext i32 %i.dgm to i64              ; 2 uses
  %xtraiter4268 = and i64 %umax4267, 3            ; 3 uses
  %i.dgn = icmp ult i32 %i.dgk, 4
  %unroll_iter4272 = and i64 %umax4267, 4294967292
  %lcmp.mod4270.not = icmp eq i64 %xtraiter4268, 0
  %lcmp.mod4271 = icmp ne i64 %xtraiter4268, 0
...
.preheader1913:                                   ; preds = %.preheader1913.preheader, %._crit_edge2019
  ...
  %.idx2930 = shl i64 %i.dgs, 9                   ; 5 uses
  br i1 %i.dgn, label %.epil.preheader4266, label %.preheader1913.new
...
.preheader1913.new:                               ; preds = %.preheader1913
  ...
  %i.dgz = getelementptr i8, ptr %i.dgy, i64 %.idx2930
  ...
  %i.dhh = getelementptr i8, ptr %i.dhg, i64 %.idx2930
  ...
  %i.dho = getelementptr i8, ptr %i.dhn, i64 %.idx2930
  ...
  %i.dhw = getelementptr i8, ptr %i.dhv, i64 %.idx2930
  %i.dhx = getelementptr [4 x i8], ptr %i.dhw, i64 %i.dgl
  br label %bb.u

._crit_edge2019.unr-lcssa:                        ; preds = %bb.u
  br i1 %lcmp.mod4270.not, label %._crit_edge2019, label %.epil.preheader4266

.epil.preheader4266:                              ; preds = %._crit_edge2019.unr-lcssa, %.preheader1913
  %indvars.iv2388.epil.init = phi i64 [ 0, %.preheader1913 ], [ %indvars.iv.next2389.3, %._crit_edge2019.unr-lcssa ]
  call void @llvm.assume(i1 %lcmp.mod4271)
  br label %bb.t

bb.t:                                             ; preds = %bb.t, %.epil.preheader4266
  %indvars.iv2388.epil = phi i64 [ %indvars.iv2388.epil.init, %.epil.preheader4266 ], [ %indvars.iv.next2389.epil, %bb.t ] ; 3 uses
  %epil.iter4269 = phi i64 [ 0, %.epil.preheader4266 ], [ %epil.iter4269.next, %bb.t ]
  ...
  %i.dil = getelementptr i8, ptr %i.dik, i64 %.idx2930
  ...
  %epil.iter4269.next = add i64 %epil.iter4269, 1 ; 2 uses
  %epil.iter4269.cmp.not = icmp eq i64 %epil.iter4269.next, %xtraiter4268
  br i1 %epil.iter4269.cmp.not, label %._crit_edge2019, label %bb.t, !llvm.loop !72
...
bb.u:                                             ; preds = %bb.u, %.preheader1913.new
  ...
  %niter4273 = phi i64 [ 0, %.preheader1913.new ], [ %niter4273.next.3, %bb.u ]
  ...
  %niter4273.next.3 = add i64 %niter4273, 4       ; 2 uses
  %niter4273.ncmp.3.not = icmp eq i64 %niter4273.next.3, %unroll_iter4272
  br i1 %niter4273.ncmp.3.not, label %._crit_edge2019.unr-lcssa, label %bb.u
...
._crit_edge2023.14288:                            ; preds = %._crit_edge2023.preheader
  ...
  br i1 %exitcond2430.not.1, label %._crit_edge2023.1, label %._crit_edge2023.24289

._crit_edge2023.24289:                            ; preds = %._crit_edge2023.14288
  ...
  br i1 %exitcond2430.not.2, label %._crit_edge2023.1, label %._crit_edge2023.34290

._crit_edge2023.34290:                            ; preds = %._crit_edge2023.24289
  ...
  br i1 %exitcond2430.not.3, label %._crit_edge2023.1, label %._crit_edge2023.44291

._crit_edge2023.44291:                            ; preds = %._crit_edge2023.34290
  ...
  br i1 %exitcond2430.not.4, label %._crit_edge2023.1, label %._crit_edge2023.54292

._crit_edge2023.54292:                            ; preds = %._crit_edge2023.44291
  ...
  br i1 %exitcond2430.not.5, label %._crit_edge2023.1, label %._crit_edge2023.64293

._crit_edge2023.64293:                            ; preds = %._crit_edge2023.54292
...
._crit_edge2023.7:                                ; preds = %._crit_edge2023.64293
...
._crit_edge2023.1:                                ; preds = %._crit_edge2023.preheader, %._crit_edge2023.14288, %._crit_edge2023.24289, %._crit_edge2023.34290, %._crit_edge2023.44291, %._crit_edge2023.54292, %._crit_edge2023.64293, %._crit_edge2023.7
...
._crit_edge2023.preheader:                        ; preds = %bb.ab, %bb.aa, %bb.z, %bb.y, %bb.x, %bb.w, %bb.v, %.preheader1912.preheader
  ...
  br i1 %exitcond2430.not, label %._crit_edge2023.1, label %._crit_edge2023.14288
...
.preheader1911:                                   ; preds = %.loopexit1947.split, %.preheader1911
  ...
  %i.dtq = shl i32 %indvars.iv2439.tr, 2
  ...
  %indvars.iv2439.tr2931 = trunc i64 %indvars.iv2439 to i32
  %i.dua = shl i32 %indvars.iv2439.tr2931, 2
...
.lr.ph2038:                                       ; preds = %.loopexit1945
  ...
  %min.iters.check3816 = icmp ult i64 %i.bwj, 8
  %min.iters.check3818 = icmp ult i64 %i.bwj, 32
  %i.dwk = and i64 %i.bwj, 24
  %n.vec3820 = and i64 %i.bwj, -32                ; 5 uses
  %i.dwl = add nsw i64 %n.vec3820, %i.bwp
  %cmp.n3829 = icmp eq i64 %i.bwj, %n.vec3820
  %min.epilog.iters.check3836 = icmp eq i64 %i.dwk, 0
  %n.vec3838 = and i64 %i.bwj, -8                 ; 4 uses
  %i.dwm = add nsw i64 %n.vec3838, %i.bwp
  %cmp.n3844 = icmp eq i64 %i.bwj, %n.vec3838
  br label %bb.ac
...
bb.ac:                                            ; preds = %.lr.ph2038, %.loopexit1910
  %indvar3810 = phi i64 [ 0, %.lr.ph2038 ], [ %indvar.next3811, %.loopexit1910 ] ; 2 uses
...
.lr.ph2030:                                       ; preds = %bb.ac
  ...
  %min.iters.check3860 = icmp ult i32 %i.dxl, 16
  br i1 %min.iters.check3860, label %scalar.ph3859.preheader, label %vector.memcheck3847

scalar.ph3859.preheader:                          ; preds = %vector.body3866, %vector.memcheck3847, %.lr.ph2030
  %indvars.iv2444.ph = phi i64 [ %i.dxk, %vector.memcheck3847 ], [ %i.dxk, %.lr.ph2030 ], [ %i.dxy, %vector.body3866 ]
  %.017062027.ph = phi i32 [ %i.dwz, %vector.memcheck3847 ], [ %i.dwz, %.lr.ph2030 ], [ %i.dyb, %vector.body3866 ]
  br label %scalar.ph3859

vector.memcheck3847:                              ; preds = %.lr.ph2030
  %i.dxo = shl nuw nsw i64 %i.dxk, 2              ; 3 uses
  %scevgep3849 = getelementptr i8, ptr %scevgep3848, i64 %i.dxo
  ...
  %scevgep3851 = getelementptr i8, ptr %scevgep3850, i64 %i.dxt
  %scevgep3852 = getelementptr i8, ptr %i.dxi, i64 -1024
  %scevgep3853 = getelementptr i8, ptr %scevgep3852, i64 %i.dxo
  %scevgep3854 = getelementptr i8, ptr %i.dxi, i64 1028
  %scevgep3855 = getelementptr i8, ptr %scevgep3854, i64 %i.dxt
  %bound03856 = icmp ult ptr %scevgep3849, %scevgep3855
  %bound13857 = icmp ult ptr %scevgep3853, %scevgep3851
  %found.conflict3858 = and i1 %bound03856, %bound13857
  br i1 %found.conflict3858, label %scalar.ph3859.preheader, label %vector.ph3861

vector.ph3861:                                    ; preds = %vector.memcheck3847
  %i.dxu = and i64 %i.dxn, 7                      ; 2 uses
  %i.dxv = icmp eq i64 %i.dxu, 0
  %i.dxw = select i1 %i.dxv, i64 8, i64 %i.dxu
  %n.vec3862 = sub nsw i64 %i.dxn, %i.dxw         ; 3 uses
  %i.dxx = shl nsw i64 %n.vec3862, 1
  %i.dxy = add nsw i64 %i.dxx, %i.dxk
  %i.dxz = trunc i64 %n.vec3862 to i32
  %i.dya = shl i32 %i.dxz, 1
  %i.dyb = add i32 %i.dwz, %i.dya
  %broadcast.splatinsert3863 = insertelement <8 x i64> poison, i64 %i.dxk, i64 0
  %broadcast.splat3864 = shufflevector <8 x i64> %broadcast.splatinsert3863, <8 x i64> poison, <8 x i32> zeroinitializer
  %induction3865 = add nuw nsw <8 x i64> %broadcast.splat3864, <i64 0, i64 2, i64 4, i64 6, i64 8, i64 10, i64 12, i64 14>
  br label %vector.body3866

vector.body3866:                                  ; preds = %vector.body3866, %vector.ph3861
  %index3867 = phi i64 [ 0, %vector.ph3861 ], [ %index.next3896, %vector.body3866 ] ; 2 uses
  %vec.ind3868 = phi <8 x i64> [ %induction3865, %vector.ph3861 ], [ %vec.ind.next3897, %vector.body3866 ] ; 2 uses
  %i.dyc = shl nuw i64 %index3867, 1
  %i.dyd = add nuw i64 %i.dyc, %i.dxk             ; 2 uses
  %wide.gep3869 = getelementptr inbounds nuw [4 x i8], ptr %i.bts, <8 x i64> %vec.ind3868 ; 2 uses
  %i.dye = extractelement <8 x ptr> %wide.gep3869, i64 0 ; 8 uses
  %i.dyf = getelementptr inbounds nuw i8, ptr %i.dye, i64 512
  %wide.vec3870 = load <16 x float>, ptr %i.dyf, align 4, !tbaa !58, !alias.scope !73, !noalias !76
  %strided.vec3871 = shufflevector <16 x float> %wide.vec3870, <16 x float> poison, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14> ; 4 uses
  %i.dyg = getelementptr i8, ptr %i.dye, i64 -512
  %wide.vec3872 = load <16 x float>, ptr %i.dyg, align 4, !tbaa !58, !alias.scope !73, !noalias !76
  %strided.vec3873 = shufflevector <16 x float> %wide.vec3872, <16 x float> poison, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14> ; 4 uses
  %i.dyh = fsub reassoc nsz arcp contract afn <8 x float> %strided.vec3871, %strided.vec3873
  ...
  %wide.vec3874 = load <16 x float>, ptr %i.dyk, align 4, !tbaa !58, !alias.scope !76
  %strided.vec3875 = shufflevector <16 x float> %wide.vec3874, <16 x float> poison, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14> ; 4 uses
  %i.dyl = getelementptr i8, ptr %i.dyk, i64 -1024
  %wide.vec3876 = load <16 x float>, ptr %i.dyl, align 4, !tbaa !58, !alias.scope !76
  %strided.vec3877 = shufflevector <16 x float> %wide.vec3876, <16 x float> poison, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14>
  %i.dym = fsub reassoc nsz arcp contract afn <8 x float> %strided.vec3875, %strided.vec3877
  ...
  %wide.vec3878 = load <16 x float>, ptr %i.dyp, align 4, !tbaa !58, !alias.scope !73, !noalias !76
  %strided.vec3879 = shufflevector <16 x float> %wide.vec3878, <16 x float> poison, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14>
  %i.dyq = fsub reassoc nsz arcp contract afn <8 x float> %strided.vec3873, %strided.vec3879
  ...
  %i.dyv = fsub reassoc nsz arcp contract afn <8 x float> %strided.vec3873, %strided.vec3871
  ...
  %wide.vec3880 = load <16 x float>, ptr %i.dyy, align 4, !tbaa !58, !alias.scope !76
  %strided.vec3881 = shufflevector <16 x float> %wide.vec3880, <16 x float> poison, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14>
  %i.dyz = fsub reassoc nsz arcp contract afn <8 x float> %strided.vec3875, %strided.vec3881
  ...
  %wide.vec3882 = load <16 x float>, ptr %i.dzc, align 4, !tbaa !58, !alias.scope !73, !noalias !76
  %strided.vec3883 = shufflevector <16 x float> %wide.vec3882, <16 x float> poison, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14>
  %i.dzd = fsub reassoc nsz arcp contract afn <8 x float> %strided.vec3871, %strided.vec3883
  ...
  %wide.vec3884 = load <16 x float>, ptr %i.dzi, align 4, !tbaa !58, !alias.scope !73, !noalias !76
  %strided.vec3885 = shufflevector <16 x float> %wide.vec3884, <16 x float> poison, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14> ; 4 uses
  %i.dzj = getelementptr i8, ptr %i.dye, i64 -4
  %wide.vec3886 = load <16 x float>, ptr %i.dzj, align 4, !tbaa !58, !alias.scope !73, !noalias !76
  %strided.vec3887 = shufflevector <16 x float> %wide.vec3886, <16 x float> poison, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14> ; 4 uses
  %i.dzk = fsub reassoc nsz arcp contract afn <8 x float> %strided.vec3885, %strided.vec3887
  ...
  %wide.vec3888 = load <16 x float>, ptr %i.dzn, align 4, !tbaa !58, !alias.scope !76
  %strided.vec3889 = shufflevector <16 x float> %wide.vec3888, <16 x float> poison, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14>
  %i.dzo = fsub reassoc nsz arcp contract afn <8 x float> %strided.vec3875, %strided.vec3889
  ...
  %wide.vec3890 = load <16 x float>, ptr %i.dzr, align 4, !tbaa !58, !alias.scope !73, !noalias !76
  %strided.vec3891 = shufflevector <16 x float> %wide.vec3890, <16 x float> poison, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14>
  %i.dzs = fsub reassoc nsz arcp contract afn <8 x float> %strided.vec3887, %strided.vec3891
  ...
  %i.dzx = fsub reassoc nsz arcp contract afn <8 x float> %strided.vec3887, %strided.vec3885
  ...
  %wide.vec3892 = load <16 x float>, ptr %i.eab, align 4, !tbaa !58, !alias.scope !76
  %strided.vec3893 = shufflevector <16 x float> %wide.vec3892, <16 x float> poison, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14>
  %i.eac = fsub reassoc nsz arcp contract afn <8 x float> %strided.vec3875, %strided.vec3893
  ...
  %wide.vec3894 = load <16 x float>, ptr %i.eaf, align 4, !tbaa !58, !alias.scope !73, !noalias !76
  %strided.vec3895 = shufflevector <16 x float> %wide.vec3894, <16 x float> poison, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14>
  %i.eag = fsub reassoc nsz arcp contract afn <8 x float> %strided.vec3885, %strided.vec3895
  ...
  %i.eal = fmul reassoc nsz arcp contract afn <8 x float> %i.dyu, %strided.vec3873
  %i.eam = fmul reassoc nsz arcp contract afn <8 x float> %i.dzh, %strided.vec3871
  %i.ean = fadd reassoc nsz arcp contract afn <8 x float> %i.eam, %i.eal
  %i.eao = fmul reassoc nsz arcp contract afn <8 x float> %i.dzw, %strided.vec3887
  %i.eap = fadd reassoc nsz arcp contract afn <8 x float> %i.ean, %i.eao
  %i.eaq = fmul reassoc nsz arcp contract afn <8 x float> %i.eak, %strided.vec3885
  ...
  call void @llvm.masked.scatter.v8f32.v8p0(<8 x float> %i.eav, <8 x ptr> align 4 %wide.gep3869, <8 x i1> splat (i1 true)), !tbaa !58, !alias.scope !73, !noalias !76
  %index.next3896 = add nuw i64 %index3867, 8     ; 2 uses
  %vec.ind.next3897 = add nuw nsw <8 x i64> %vec.ind3868, splat (i64 16)
  %i.eaw = icmp eq i64 %index.next3896, %n.vec3862
  br i1 %i.eaw, label %scalar.ph3859.preheader, label %vector.body3866, !llvm.loop !78

._crit_edge2031:                                  ; preds = %scalar.ph3859, %bb.ac
  %i.eax = icmp slt i64 %i.dwt, 0
  %i.eay = icmp sge i64 %i.dwt, %i.bk
  %or.cond1798.not3006 = or i1 %i.eax, %i.eay
  %brmerge2998 = select i1 %or.cond1798.not3006, i1 true, i1 %i.dwe
  br i1 %brmerge2998, label %.loopexit1910, label %iter.check3833

scalar.ph3859:                                    ; preds = %scalar.ph3859.preheader, %scalar.ph3859
  %indvars.iv2444 = phi i64 [ %indvars.iv.next2445, %scalar.ph3859 ], [ %indvars.iv2444.ph, %scalar.ph3859.preheader ] ; 3 uses
  %.017062027 = phi i32 [ %i.ecf, %scalar.ph3859 ], [ %.017062027.ph, %scalar.ph3859.preheader ]
...
.lr.ph2127.preheader:                             ; preds = %bb.be
  ...
  %xtraiter4342 = and i64 %wide.trip.count2597, 1
  %lcmp.mod4343.not = icmp eq i64 %xtraiter4342, 0
...
.preheader1906.preheader:                         ; preds = %._crit_edge2132.split
  ...
  br i1 %lcmp.mod4348.not, label %.prol.loopexit4346, label %.prol.loopexit4346.unr-lcssa

.prol.loopexit4346.unr-lcssa:                     ; preds = %.preheader1906.preheader
  %i.fze = load ptr, ptr %i.azh, align 8, !tbaa !59 ; 2 uses
  %sext2935.prol = or disjoint i64 %i.fzb, 2048   ; 2 uses
  %i.fzf = getelementptr inbounds nuw [4 x i8], ptr %i.fze, i64 %sext2935.prol
  ...
  %i.fzi = getelementptr inbounds nuw [4 x i8], ptr %i.bts, i64 %sext2935.prol
  ...
  br label %.prol.loopexit4346

.prol.loopexit4346:                               ; preds = %.prol.loopexit4346.unr-lcssa, %.preheader1906.preheader
  %indvars.iv2604.unr = phi i64 [ %i.fzb, %.preheader1906.preheader ], [ %indvars.iv.next2605.prol, %.prol.loopexit4346.unr-lcssa ]
...
.lr.ph2127:                                       ; preds = %.lr.ph2127.preheader, %._crit_edge2128
  ...
  br i1 %lcmp.mod4343.not, label %.prol.loopexit4341, label %.prol.preheader4340

.prol.preheader4340:                              ; preds = %.lr.ph2127
  ...
  br i1 %i.gae, label %bb.bf, label %.prol.loopexit4341.unr-lcssa

bb.bf:                                            ; preds = %.prol.preheader4340
  ...
  br label %.prol.loopexit4341.unr-lcssa

.prol.loopexit4341.unr-lcssa:                     ; preds = %bb.bf, %.prol.preheader4340
  %i.gai = and i32 %i.fzr, 3
  br label %.prol.loopexit4341

.prol.loopexit4341:                               ; preds = %.prol.loopexit4341.unr-lcssa, %.lr.ph2127
  %indvars.iv2594.unr = phi i64 [ %i.fyx, %.lr.ph2127 ], [ %indvars.iv.next2595.prol, %.prol.loopexit4341.unr-lcssa ]
  %.016542124.unr = phi i32 [ %i.fzp, %.lr.ph2127 ], [ %i.gai, %.prol.loopexit4341.unr-lcssa ] ; 3 uses
  br i1 %i.fyz, label %._crit_edge2128, label %.lr.ph2127.new

.lr.ph2127.new:                                   ; preds = %.prol.loopexit4341
...
._crit_edge2128:                                  ; preds = %bb.bk, %.prol.loopexit4341
...
._crit_edge2135:                                  ; preds = %._crit_edge2135.prol.loopexit, %._crit_edge2135
  ...
  %indvars.iv2604.1.tr = trunc i64 %indvars.iv2604.1 to i32
  %i.gbi = shl i32 %indvars.iv2604.1.tr, 1
  ...
  %sext2936 = add i64 %i.gbq, 8246337208320
  %i.gbr = ashr exact i64 %sext2936, 32           ; 2 uses
  ...
  %indvars.iv2604.1.tr.1 = trunc i64 %indvars.iv.next2605.1 to i32
  %i.gbz = shl i32 %indvars.iv2604.1.tr.1, 1
  ...
  %sext2936.1 = add i64 %i.gch, 8246337208320
  %i.gci = ashr exact i64 %sext2936.1, 32         ; 2 uses
...
._crit_edge2135.1.preheader:                      ; preds = %._crit_edge2135, %._crit_edge2135.prol.loopexit
  %xtraiter4356 = and i64 %wide.trip.count2608, 1
  %lcmp.mod4357.not = icmp eq i64 %xtraiter4356, 0
  br i1 %lcmp.mod4357.not, label %._crit_edge2135.1.prol.loopexit, label %._crit_edge2135.1.prol

._crit_edge2135.1.prol:                           ; preds = %._crit_edge2135.1.preheader
  %i.gcq = load ptr, ptr %i.azp, align 8, !tbaa !59 ; 2 uses
  %sext2937.prol = or disjoint i64 %i.fzb, 1792   ; 2 uses
  %i.gcr = getelementptr inbounds nuw [4 x i8], ptr %i.gcq, i64 %sext2937.prol
  ...
  %i.gcv = getelementptr inbounds nuw [4 x i8], ptr %i.bts, i64 %sext2937.prol
...
._crit_edge2135.1:                                ; preds = %._crit_edge2135.1.prol.loopexit, %._crit_edge2135.1
  ...
  %indvars.iv2604.2.tr = trunc i64 %indvars.iv2604.2 to i32
  %i.gcz = shl i32 %indvars.iv2604.2.tr, 1
  ...
  %sext2937 = add i64 %i.gdh, 7696581394432
  %i.gdi = ashr exact i64 %sext2937, 32           ; 2 uses
  ...
  %indvars.iv2604.2.tr.1 = trunc i64 %indvars.iv.next2605.2 to i32
  %i.gdq = shl i32 %indvars.iv2604.2.tr.1, 1
  ...
  %sext2937.1 = add i64 %i.gdy, 7696581394432
  %i.gdz = ashr exact i64 %sext2937.1, 32         ; 2 uses
...
._crit_edge2135.2.preheader:                      ; preds = %._crit_edge2135.1, %._crit_edge2135.1.prol.loopexit
  %xtraiter4359 = and i64 %wide.trip.count2608, 1
  %lcmp.mod4360.not = icmp eq i64 %xtraiter4359, 0
  br i1 %lcmp.mod4360.not, label %._crit_edge2135.2.prol.loopexit, label %._crit_edge2135.2.prol

._crit_edge2135.2.prol:                           ; preds = %._crit_edge2135.2.preheader
  %i.geh = load ptr, ptr %i.azt, align 8, !tbaa !59 ; 2 uses
  %sext2938.prol = or disjoint i64 %i.fzb, 1664   ; 2 uses
  %i.gei = getelementptr inbounds nuw [4 x i8], ptr %i.geh, i64 %sext2938.prol
  ...
  %i.gem = getelementptr inbounds nuw [4 x i8], ptr %i.bts, i64 %sext2938.prol
...
._crit_edge2135.2:                                ; preds = %._crit_edge2135.2.prol.loopexit, %._crit_edge2135.2
  ...
  %indvars.iv2604.3.tr = trunc i64 %indvars.iv2604.3 to i32
  %i.geq = shl i32 %indvars.iv2604.3.tr, 1
  ...
  %sext2938 = add i64 %i.gey, 7146825580544
  %i.gez = ashr exact i64 %sext2938, 32           ; 2 uses
  ...
  %indvars.iv2604.3.tr.1 = trunc i64 %indvars.iv.next2605.3 to i32
  %i.gfh = shl i32 %indvars.iv2604.3.tr.1, 1
  ...
  %sext2938.1 = add i64 %i.gfp, 7146825580544
  %i.gfq = ashr exact i64 %sext2938.1, 32         ; 2 uses
...
._crit_edge2135.3.preheader:                      ; preds = %._crit_edge2135.2, %._crit_edge2135.2.prol.loopexit
  %xtraiter4362 = and i64 %wide.trip.count2608, 1
  %lcmp.mod4363.not = icmp eq i64 %xtraiter4362, 0
  br i1 %lcmp.mod4363.not, label %._crit_edge2135.3.prol.loopexit, label %._crit_edge2135.3.prol

._crit_edge2135.3.prol:                           ; preds = %._crit_edge2135.3.preheader
  %i.gfy = load ptr, ptr %i.azx, align 8, !tbaa !59 ; 2 uses
  %sext2939.prol = or disjoint i64 %i.fzb, 1536   ; 2 uses
  %i.gfz = getelementptr inbounds nuw [4 x i8], ptr %i.gfy, i64 %sext2939.prol
  ...
  %i.ggd = getelementptr inbounds nuw [4 x i8], ptr %i.bts, i64 %sext2939.prol
...
._crit_edge2135.3:                                ; preds = %._crit_edge2135.3.prol.loopexit, %._crit_edge2135.3
  ...
  %indvars.iv2604.4.tr = trunc i64 %indvars.iv2604.4 to i32
  %i.ggh = shl i32 %indvars.iv2604.4.tr, 1
  ...
  %sext2939 = add i64 %i.ggp, 6597069766656
  %i.ggq = ashr exact i64 %sext2939, 32           ; 2 uses
  ...
  %indvars.iv2604.4.tr.1 = trunc i64 %indvars.iv.next2605.4 to i32
  %i.ggy = shl i32 %indvars.iv2604.4.tr.1, 1
  ...
  %sext2939.1 = add i64 %i.ghg, 6597069766656
  %i.ghh = ashr exact i64 %sext2939.1, 32         ; 2 uses
...
._crit_edge2135.4.preheader:                      ; preds = %._crit_edge2135.3, %._crit_edge2135.3.prol.loopexit
  %xtraiter4365 = and i64 %wide.trip.count2608, 1
  %lcmp.mod4366.not = icmp eq i64 %xtraiter4365, 0
  br i1 %lcmp.mod4366.not, label %._crit_edge2135.4.prol.loopexit, label %._crit_edge2135.4.prol

._crit_edge2135.4.prol:                           ; preds = %._crit_edge2135.4.preheader
  %i.ghp = load ptr, ptr %i.bab, align 8, !tbaa !59 ; 2 uses
  %sext2940.prol = or disjoint i64 %i.fzb, 1408   ; 2 uses
  %i.ghq = getelementptr inbounds nuw [4 x i8], ptr %i.ghp, i64 %sext2940.prol
  ...
  %i.ghu = getelementptr inbounds nuw [4 x i8], ptr %i.bts, i64 %sext2940.prol
...
._crit_edge2135.4:                                ; preds = %._crit_edge2135.4.prol.loopexit, %._crit_edge2135.4
  ...
  %indvars.iv2604.5.tr = trunc i64 %indvars.iv2604.5 to i32
  %i.ghy = shl i32 %indvars.iv2604.5.tr, 1
  ...
  %sext2940 = add i64 %i.gig, 6047313952768
  %i.gih = ashr exact i64 %sext2940, 32           ; 2 uses
  ...
  %indvars.iv2604.5.tr.1 = trunc i64 %indvars.iv.next2605.5 to i32
  %i.gip = shl i32 %indvars.iv2604.5.tr.1, 1
  ...
  %sext2940.1 = add i64 %i.gix, 6047313952768
  %i.giy = ashr exact i64 %sext2940.1, 32         ; 2 uses
...
._crit_edge2135.5.preheader:                      ; preds = %._crit_edge2135.4, %._crit_edge2135.4.prol.loopexit
  %xtraiter4368 = and i64 %wide.trip.count2608, 1
  %lcmp.mod4369.not = icmp eq i64 %xtraiter4368, 0
  br i1 %lcmp.mod4369.not, label %._crit_edge2135.5.prol.loopexit, label %._crit_edge2135.5.prol

._crit_edge2135.5.prol:                           ; preds = %._crit_edge2135.5.preheader
  %i.gjg = load ptr, ptr %i.baf, align 8, !tbaa !59 ; 2 uses
  %sext2941.prol = or disjoint i64 %i.fzb, 1280   ; 2 uses
  %i.gjh = getelementptr inbounds nuw [4 x i8], ptr %i.gjg, i64 %sext2941.prol
  ...
  %i.gjl = getelementptr inbounds nuw [4 x i8], ptr %i.bts, i64 %sext2941.prol
...
._crit_edge2135.5:                                ; preds = %._crit_edge2135.5.prol.loopexit, %._crit_edge2135.5
  ...
  %indvars.iv2604.6.tr = trunc i64 %indvars.iv2604.6 to i32
  %i.gjp = shl i32 %indvars.iv2604.6.tr, 1
  ...
  %sext2941 = add i64 %i.gjx, 5497558138880
  %i.gjy = ashr exact i64 %sext2941, 32           ; 2 uses
  ...
  %indvars.iv2604.6.tr.1 = trunc i64 %indvars.iv.next2605.6 to i32
  %i.gkg = shl i32 %indvars.iv2604.6.tr.1, 1
  ...
  %sext2941.1 = add i64 %i.gko, 5497558138880
  %i.gkp = ashr exact i64 %sext2941.1, 32         ; 2 uses
...
._crit_edge2135.6.preheader:                      ; preds = %._crit_edge2135.5, %._crit_edge2135.5.prol.loopexit
  %xtraiter4371 = and i64 %wide.trip.count2608, 1
  %lcmp.mod4372.not = icmp eq i64 %xtraiter4371, 0
  br i1 %lcmp.mod4372.not, label %._crit_edge2135.6.prol.loopexit, label %._crit_edge2135.6.prol

._crit_edge2135.6.prol:                           ; preds = %._crit_edge2135.6.preheader
  %i.gkx = load ptr, ptr %i.baj, align 8, !tbaa !59 ; 2 uses
  %sext2942.prol = or disjoint i64 %i.fzb, 1152   ; 2 uses
  %i.gky = getelementptr inbounds nuw [4 x i8], ptr %i.gkx, i64 %sext2942.prol
  ...
  %i.glc = getelementptr inbounds nuw [4 x i8], ptr %i.bts, i64 %sext2942.prol
...
._crit_edge2135.6:                                ; preds = %._crit_edge2135.6.prol.loopexit, %._crit_edge2135.6
  ...
  %indvars.iv2604.7.tr = trunc i64 %indvars.iv2604.7 to i32
  %i.glg = shl i32 %indvars.iv2604.7.tr, 1
  ...
  %sext2942 = add i64 %i.glo, 4947802324992
  %i.glp = ashr exact i64 %sext2942, 32           ; 2 uses
  ...
  %indvars.iv2604.7.tr.1 = trunc i64 %indvars.iv.next2605.7 to i32
  %i.glx = shl i32 %indvars.iv2604.7.tr.1, 1
  ...
  %sext2942.1 = add i64 %i.gmf, 4947802324992
  %i.gmg = ashr exact i64 %sext2942.1, 32         ; 2 uses
...
.preheader1906.preheader.new:                     ; preds = %.prol.loopexit4346, %.preheader1906.preheader.new
  %indvars.iv2604 = phi i64 [ %indvars.iv.next2605.14351, %.preheader1906.preheader.new ], [ %indvars.iv2604.unr, %.prol.loopexit4346 ] ; 6 uses
  %indvars.iv2604.tr = trunc i64 %indvars.iv2604 to i32
  %i.gmo = shl i32 %indvars.iv2604.tr, 1
  ...
  %sext2935 = add i64 %i.gmv, 8796093022208
  %i.gmw = ashr exact i64 %sext2935, 32           ; 2 uses
  ...
  %indvars.iv2604.tr.1 = trunc i64 %indvars.iv.next2605 to i32
  %i.gnd = shl i32 %indvars.iv2604.tr.1, 1
  ...
  %sext2935.1 = add i64 %i.gnk, 8796093022208
  %i.gnl = ashr exact i64 %sext2935.1, 32         ; 2 uses
  ...
  %indvars.iv.next2605.14351 = add nuw nsw i64 %indvars.iv2604, 2 ; 2 uses
  %exitcond2609.not.1 = icmp eq i64 %indvars.iv.next2605.14351, %wide.trip.count2608
  br i1 %exitcond2609.not.1, label %._crit_edge2135.preheader, label %.preheader1906.preheader.new

._crit_edge2135.preheader:                        ; preds = %.preheader1906.preheader.new, %.prol.loopexit4346
  %xtraiter4352 = and i64 %wide.trip.count2608, 1
  %lcmp.mod4353.not = icmp eq i64 %xtraiter4352, 0
  br i1 %lcmp.mod4353.not, label %._crit_edge2135.prol.loopexit, label %._crit_edge2135.prol

._crit_edge2135.prol:                             ; preds = %._crit_edge2135.preheader
  %i.gns = load ptr, ptr %i.azl, align 8, !tbaa !59 ; 2 uses
  %sext2936.prol = or disjoint i64 %i.fzb, 1920   ; 2 uses
  %i.gnt = getelementptr inbounds nuw [4 x i8], ptr %i.gns, i64 %sext2936.prol
  ...
  %i.gnx = getelementptr inbounds nuw [4 x i8], ptr %i.bts, i64 %sext2936.prol
...
.preheader1905.preheader:                         ; preds = %.loopexit1936.split
  ...
  %xtraiter4376 = and i64 %wide.trip.count2618, 1
  %lcmp.mod4377.not = icmp eq i64 %xtraiter4376, 0
...
.preheader1905:                                   ; preds = %.preheader1905.preheader, %._crit_edge2139
  ...
  br i1 %lcmp.mod4377.not, label %.prol.loopexit4375, label %.prol.loopexit4375.unr-lcssa

.prol.loopexit4375.unr-lcssa:                     ; preds = %.preheader1905
  ...
  br label %.prol.loopexit4375

.prol.loopexit4375:                               ; preds = %.prol.loopexit4375.unr-lcssa, %.preheader1905
  %indvars.iv2615.unr = phi i64 [ %i.gob, %.preheader1905 ], [ %indvars.iv.next2616.prol, %.prol.loopexit4375.unr-lcssa ]
  br i1 %i.god, label %._crit_edge2139, label %.preheader1905.new

._crit_edge2139:                                  ; preds = %.preheader1905.new, %.prol.loopexit4375
...
.preheader1905.new:                               ; preds = %.prol.loopexit4375, %.preheader1905.new
  %indvars.iv2615 = phi i64 [ %indvars.iv.next2616.1, %.preheader1905.new ], [ %indvars.iv2615.unr, %.prol.loopexit4375 ] ; 5 uses
...
.preheader1904:                                   ; preds = %.loopexit1934, %.preheader1904
  ...
  %i.gqi = shl i32 %indvars.iv2627.tr, 1
...
.preheader1903.preheader:                         ; preds = %.loopexit1932
  ...
  %umax4380 = zext i32 %i.gtn to i64              ; 2 uses
  %xtraiter4381 = and i64 %umax4380, 1
  %i.gto = icmp ult i32 %i.gtl, 2
  %unroll_iter4385 = and i64 %umax4380, 4294967294
  %lcmp.mod4383.not = icmp eq i64 %xtraiter4381, 0
  %lcmp.mod4384 = trunc i32 %i.gtn to i1
...
.preheader1903:                                   ; preds = %.preheader1903.preheader, %._crit_edge2145
  ...
  %i.gtp = shl i32 %indvars.iv2635.tr, 1
  ...
  br i1 %i.gto, label %.epil.preheader4379, label %.preheader1903.new
...
._crit_edge2145.unr-lcssa:                        ; preds = %bb.bl
  br i1 %lcmp.mod4383.not, label %._crit_edge2145, label %.epil.preheader4379

.epil.preheader4379:                              ; preds = %._crit_edge2145.unr-lcssa, %.preheader1903
  %indvars.iv2632.epil.init = phi i64 [ 0, %.preheader1903 ], [ %indvars.iv.next2633.1, %._crit_edge2145.unr-lcssa ] ; 2 uses
  call void @llvm.assume(i1 %lcmp.mod4384)
...
._crit_edge2145:                                  ; preds = %._crit_edge2145.unr-lcssa, %.epil.preheader4379
...
bb.bl:                                            ; preds = %bb.bl, %.preheader1903.new
  ...
  %niter4386 = phi i64 [ 0, %.preheader1903.new ], [ %niter4386.next.1, %bb.bl ]
  ...
  %niter4386.next.1 = add i64 %niter4386, 2       ; 2 uses
  %niter4386.ncmp.1.not = icmp eq i64 %niter4386.next.1, %unroll_iter4385
  br i1 %niter4386.ncmp.1.not, label %._crit_edge2145.unr-lcssa, label %bb.bl
...
.preheader1902:                                   ; preds = %.loopexit1930, %.preheader1902
  ...
  %sext2943 = add i64 %i.gws, 64424509440
  %i.gwt = ashr exact i64 %sext2943, 32           ; 2 uses
  ...
  %sext2944 = add i64 %i.gxe, 60129542144
  %i.gxf = ashr exact i64 %sext2944, 32           ; 2 uses
  ...
  %sext2945 = add i64 %i.gxn, 55834574848
  %i.gxo = ashr exact i64 %sext2945, 32           ; 2 uses
...
.preheader1901.preheader:                         ; preds = %.loopexit1928
  ...
  %umax4388 = zext i32 %i.gzk to i64              ; 2 uses
  %xtraiter4389 = and i64 %umax4388, 1
  %i.gzl = icmp ult i32 %i.gzi, 2
  %unroll_iter4393 = and i64 %umax4388, 4294967294
  %lcmp.mod4391.not = icmp eq i64 %xtraiter4389, 0
  %lcmp.mod4392 = trunc i32 %i.gzk to i1
...
.preheader1901:                                   ; preds = %.preheader1901.preheader, %._crit_edge2151
  ...
  %indvars.iv2651.tr = trunc i64 %indvars.iv2651 to i32
  %i.gzt = shl i32 %indvars.iv2651.tr, 2          ; 3 uses
  br i1 %i.gzl, label %.epil.preheader4387, label %.preheader1901.new
...
._crit_edge2151.unr-lcssa:                        ; preds = %bb.bm
  br i1 %lcmp.mod4391.not, label %._crit_edge2151, label %.epil.preheader4387

.epil.preheader4387:                              ; preds = %._crit_edge2151.unr-lcssa, %.preheader1901
  %indvars.iv2648.epil.init = phi i64 [ 0, %.preheader1901 ], [ %indvars.iv.next2649.1, %._crit_edge2151.unr-lcssa ] ; 2 uses
  call void @llvm.assume(i1 %lcmp.mod4392)
...
._crit_edge2151:                                  ; preds = %._crit_edge2151.unr-lcssa, %.epil.preheader4387
...
bb.bm:                                            ; preds = %bb.bm, %.preheader1901.new
  ...
  %niter4394 = phi i64 [ 0, %.preheader1901.new ], [ %niter4394.next.1, %bb.bm ]
  ...
  %niter4394.next.1 = add i64 %niter4394, 2       ; 2 uses
  %niter4394.ncmp.1.not = icmp eq i64 %niter4394.next.1, %unroll_iter4393
  br i1 %niter4394.ncmp.1.not, label %._crit_edge2151.unr-lcssa, label %bb.bm
...
.preheader1899:                                   ; preds = %.loopexit1924.split, %.preheader1899
  ...
  %indvars.iv2701.tr = trunc i64 %indvars.iv2701 to i32
  %i.hqt = shl i32 %indvars.iv2701.tr, 2
  ...
  %indvars.iv2701.tr2950 = trunc i64 %indvars.iv2701 to i32
  %i.hrg = shl i32 %indvars.iv2701.tr2950, 2
...
.preheader1898.lr.ph:                             ; preds = %.preheader1899, %.loopexit1924.split
  ...
  %invariant.op4505 = fmul reassoc nsz arcp contract afn float %i.hub, %i.hub
...
.preheader1898:                                   ; preds = %.preheader1898.lr.ph, %._crit_edge2170
  ...
  %i.huc = phi <2 x float> [ zeroinitializer, %.preheader1898.lr.ph ], [ %.lcssa4212, %._crit_edge2170 ] ; 2 uses
  %i.hud = phi <2 x float> [ zeroinitializer, %.preheader1898.lr.ph ], [ %.lcssa4214, %._crit_edge2170 ] ; 2 uses
  %i.hue = mul nuw nsw i64 %indvars.iv2709, %i.fxa ; 3 uses
  br i1 %i.fxb, label %.epil.preheader4409, label %.preheader1898.new

._crit_edge2193:                                  ; preds = %._crit_edge2170
  %i.huf = fcmp reassoc nsz arcp contract afn oge <2 x double> %.lcssa4215, splat (double f0xC00FEB852FFFFFFF)
  %i.hug = fcmp reassoc nsz arcp contract afn ole <2 x float> %.lcssa4214, splat (float 3.990000e+00)
  %i.huh = select <2 x i1> %i.hug, <2 x float> %.lcssa4214, <2 x float> splat (float 3.990000e+00)
  %i.hui = select <2 x i1> %i.huf, <2 x float> %i.huh, <2 x float> splat (float -3.990000e+00) ; 3 uses
  %i.huj = fcmp reassoc nsz arcp contract afn oge <2 x double> %.lcssa4213, splat (double f0xC00FEB852FFFFFFF)
  %i.huk = fcmp reassoc nsz arcp contract afn ole <2 x float> %.lcssa4212, splat (float 3.990000e+00)
  %i.hul = select <2 x i1> %i.huk, <2 x float> %.lcssa4212, <2 x float> splat (float 3.990000e+00)
...
._crit_edge2170.unr-lcssa:                        ; preds = %.preheader1898.new
  br i1 %lcmp.mod4414.not, label %._crit_edge2170, label %.epil.preheader4409

.epil.preheader4409:                              ; preds = %._crit_edge2170.unr-lcssa, %.preheader1898
  %indvars.iv2704.epil.init = phi i64 [ 0, %.preheader1898 ], [ %indvars.iv.next2705.1, %._crit_edge2170.unr-lcssa ]
  %.016242167.epil.init = phi float [ %.016262191, %.preheader1898 ], [ %.reass4506, %._crit_edge2170.unr-lcssa ]
  %.epil.init = phi <2 x float> [ %i.huc, %.preheader1898 ], [ %i.hxq, %._crit_edge2170.unr-lcssa ]
  %.epil.init4413 = phi <2 x float> [ %i.hud, %.preheader1898 ], [ %i.hxg, %._crit_edge2170.unr-lcssa ]
  call void @llvm.assume(i1 %lcmp.mod4419)
  ...
  %i.hux = fpext <2 x float> %.epil.init4413 to <2 x double>
...
._crit_edge2170:                                  ; preds = %._crit_edge2170.unr-lcssa, %.epil.preheader4409
  %.lcssa4215 = phi <2 x double> [ %i.hxf, %._crit_edge2170.unr-lcssa ], [ %i.hvf, %.epil.preheader4409 ]
  %.lcssa4214 = phi <2 x float> [ %i.hxg, %._crit_edge2170.unr-lcssa ], [ %i.hvg, %.epil.preheader4409 ] ; 3 uses
  %.lcssa4213 = phi <2 x double> [ %i.hxp, %._crit_edge2170.unr-lcssa ], [ %i.hvp, %.epil.preheader4409 ]
  %.lcssa4212 = phi <2 x float> [ %i.hxq, %._crit_edge2170.unr-lcssa ], [ %i.hvq, %.epil.preheader4409 ] ; 3 uses
...
.preheader1898.new:                               ; preds = %.preheader1898, %.preheader1898.new
  ...
  %.016242167 = phi float [ %.reass4506, %.preheader1898.new ], [ %.016262191, %.preheader1898 ] ; 3 uses
  ...
  %niter4421 = phi i64 [ %niter4421.next.1, %.preheader1898.new ], [ 0, %.preheader1898 ]
  ...
  %.reass4506 = fmul reassoc nsz arcp contract afn float %.016242167, %invariant.op4505 ; 2 uses
  %indvars.iv.next2705.1 = add nuw nsw i64 %indvars.iv2704, 2 ; 2 uses
  %niter4421.next.1 = add i64 %niter4421, 2       ; 2 uses
  %niter4421.ncmp.1 = icmp eq i64 %niter4421.next.1, %unroll_iter4420
  br i1 %niter4421.ncmp.1, label %._crit_edge2170.unr-lcssa, label %.preheader1898.new
...
bb.dy:                                            ; preds = %.lr.ph2208, %._crit_edge2206
  ...
  %indvars.iv2720.tr = trunc i64 %indvars.iv2720 to i32
  %i.hzm = shl i32 %indvars.iv2720.tr, 1
...
.lr.ph2205:                                       ; preds = %bb.dy
  ...
  %invariant.gep2983 = getelementptr [4 x i8], ptr %i.bts, i64 %i.iaw
  %invariant.gep2985 = getelementptr [4 x i8], ptr %i.bts, i64 %i.iax
  %invariant.gep2987 = getelementptr [4 x i8], ptr %i.bts, i64 %i.iaw
  %invariant.gep2989 = getelementptr [4 x i8], ptr %i.bts, i64 %i.iax
  br label %bb.dz
...
bb.dz:                                            ; preds = %.lr.ph2205, %bb.dz
  ...
  %gep2984 = getelementptr [4 x i8], ptr %invariant.gep2983, i64 %i.iba
  %i.ibb = load float, ptr %gep2984, align 4, !tbaa !58
  %gep2986 = getelementptr [4 x i8], ptr %invariant.gep2985, i64 %i.iba
  %i.ibc = load float, ptr %gep2986, align 4, !tbaa !58 ; 2 uses
  ...
  %gep2988 = getelementptr [4 x i8], ptr %invariant.gep2987, i64 %i.ibg
  %i.ibh = load float, ptr %gep2988, align 4, !tbaa !58
  %gep2990 = getelementptr [4 x i8], ptr %invariant.gep2989, i64 %i.ibg
  %i.ibi = load float, ptr %gep2990, align 4, !tbaa !58 ; 2 uses
...
bb.ed:                                            ; preds = %bb.eb
  ...
  %i.ifc = insertelement <4 x float> poison, float %i.iev, i64 0
  %i.ifd = insertelement <4 x float> %i.ifc, float %i.iet, i64 1
