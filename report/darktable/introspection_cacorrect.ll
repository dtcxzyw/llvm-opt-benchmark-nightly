...
bb.a:
  ...
  %i.l = alloca [2 x [2 x [256 x double]]], align 16 ; 216 uses
...
bb.aw:                                            ; preds = %bb.au, %._crit_edge2119.split
  ...
  %6 = add nuw nsw i64 %i.fev, 8                  ; 2 uses
  %i.few = shl nuw nsw i64 %i.fen, 3
  %7 = shl nuw nsw i64 %i.fen, 3
  ...
  %i.ffa = shl nuw nsw i64 %i.fen, 3              ; 2 uses
  %8 = add nuw nsw i64 %i.ffa, 8
...
.preheader1961:                                   ; preds = %bb.aw, %_LinEqSolve.exit.1
  ...
  %i.ffj = shl nuw nsw i64 %indvars.iv2591, 12    ; 7 uses
  %i.ffk = add nuw nsw i64 %i.fev, %i.ffj         ; 2 uses
  %scevgep3260 = getelementptr i8, ptr %scevgep3259.a, i64 %i.ffj
  %scevgep3310 = getelementptr i8, ptr %i.l, i64 %i.ffj
  %i.ffl = getelementptr i8, ptr %i.l, i64 %i.ffj
  %i.ffm = getelementptr i8, ptr %i.fff, i64 %i.ffj
  %i.ffn = getelementptr i8, ptr %i.l, i64 %i.ffj
  %i.ffo = getelementptr i8, ptr %i.l, i64 %i.ffk
  %i.ffp = getelementptr i8, ptr %i.l, i64 %i.ffj
...
.lr.ph.preheader.i:                               ; preds = %.loopexit135.i, %.preheader1961
  %.0121153.i = phi i64 [ %i.fgc, %.loopexit135.i ], [ 0, %.preheader1961 ] ; 27 uses
  %i.ffr = sub i64 %i.feo, %.0121153.i
  %i.ffs = sub i64 %i.ffd, %.0121153.i
  %9 = mul i64 %8, %.0121153.i
  %scevgep3306 = getelementptr i8, ptr %i.ffl, i64 %9
  %i.fft = mul i64 %i.ffb, %.0121153.i
  %scevgep3307.a = getelementptr i8, ptr %i.ffm, i64 %i.fft
  %i.ffu = shl i64 %.0121153.i, 3
  %scevgep3308 = getelementptr i8, ptr %i.ffn, i64 %i.ffu
  %i.ffv = sub nsw i64 %i.fen, %.0121153.i        ; 10 uses
  %i.ffw = mul i64 %6, %.0121153.i                ; 2 uses
  %scevgep3258 = getelementptr i8, ptr %i.ffo, i64 %i.ffw
  ...
  %i.fga = getelementptr inbounds nuw [8 x i8], ptr %i.ffz, i64 %.0121153.i ; 3 uses
...
vector.memcheck3305:                              ; preds = %.lr.ph143.i
  ...
  %scevgep3311 = getelementptr i8, ptr %scevgep3310, i64 %i.fhj
  %bound03312 = icmp ult ptr %scevgep3306, %scevgep3311
...
.lr.ph150.i:                                      ; preds = %bb.ax
  ...
  %bound03263 = icmp ult ptr %scevgep3258, %scevgep3262
  %bound13264 = icmp ult ptr %scevgep3261, %scevgep3260
...
_LinEqSolve.exit:                                 ; preds = %._crit_edge162.i, %bb.ay, %bb.az
  ...
  %scevgep3141 = getelementptr i8, ptr %scevgep3140, i64 %i.fod
  %10 = or disjoint i64 %i.fod, 2048              ; 3 uses
  %scevgep3191 = getelementptr i8, ptr %scevgep3190.a, i64 %i.fod
  %i.fof = getelementptr i8, ptr %i.l, i64 %10
  %i.fog = getelementptr i8, ptr %i.ffh, i64 %i.fod
  %i.foh = getelementptr i8, ptr %i.l, i64 %10
  %i.foi = getelementptr i8, ptr %i.l, i64 %i.foe
  %i.foj = getelementptr i8, ptr %i.l, i64 %10
...
.lr.ph.preheader.i.1:                             ; preds = %.loopexit135.i.1, %_LinEqSolve.exit
  %.0121153.i.1 = phi i64 [ %i.fow, %.loopexit135.i.1 ], [ 0, %_LinEqSolve.exit ] ; 27 uses
  %i.fol = sub i64 %i.ffe, %.0121153.i.1
  %i.fom = sub i64 %i.ffd, %.0121153.i.1
  %11 = mul i64 %6, %.0121153.i.1
  %scevgep3186 = getelementptr i8, ptr %i.fof, i64 %11
  %i.fon = mul i64 %i.few, %.0121153.i.1
  %scevgep3187.a = getelementptr i8, ptr %i.fog, i64 %i.fon
  %i.foo = shl i64 %.0121153.i.1, 3
  %scevgep3188 = getelementptr i8, ptr %i.foh, i64 %i.foo
  %i.fop = sub nsw i64 %i.fen, %.0121153.i.1      ; 10 uses
  %i.foq = mul i64 %i.fer, %.0121153.i.1          ; 2 uses
  %scevgep3138 = getelementptr i8, ptr %i.foi, i64 %i.foq
  ...
  %i.fou = getelementptr inbounds nuw [8 x i8], ptr %i.fot, i64 %.0121153.i.1 ; 3 uses
...
vector.memcheck3185:                              ; preds = %.lr.ph143.i.1
  %i.fqa = mul i64 %7, %spec.select133.i.1.lcssa
  ...
  %scevgep3192 = getelementptr i8, ptr %scevgep3191, i64 %i.fqd
  %bound03193 = icmp ult ptr %scevgep3186, %scevgep3192
...
.lr.ph150.i.1:                                    ; preds = %bb.ba
  ...
  %bound03144 = icmp ult ptr %scevgep3138, %scevgep3143
  %bound13145 = icmp ult ptr %scevgep3142.a, %scevgep3141
