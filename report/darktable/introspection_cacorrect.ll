...
vector.body3774:                                  ; preds = %vector.body3774, %vector.ph3772
  ...
  %i.elu = fadd reassoc nsz arcp contract afn <8 x float> %i.elq, %i.elt
  ...
  %i.end = fadd reassoc nsz arcp contract afn <8 x float> %i.emz, %i.enc
...
scalar.ph3770:                                    ; preds = %scalar.ph3770.preheader, %scalar.ph3770
  ...
  %i.eqi = fadd reassoc nsz arcp contract afn float %i.eqc, %i.eqh
  ...
  %i.esa = fadd reassoc nsz arcp contract afn float %i.eru, %i.erz
...
bb.dz:                                            ; preds = %.lr.ph2205, %bb.dz
  ...
  %6 = fadd reassoc nsz arcp contract afn float %i.ibo, %i.ibq
  %7 = fsub reassoc nsz arcp contract afn float %6, %i.ibl
...
bb.eb:                                            ; preds = %.lr.ph2213, %bb.eh
  ...
  %8 = fadd reassoc nsz arcp contract afn float %i.ieg, %i.iei
  %9 = fsub reassoc nsz arcp contract afn float %8, %i.idw
...
bb.ed:                                            ; preds = %bb.eb
  ...
  %i.ife = insertelement <4 x float> poison, float %i.iev, i64 0
  %i.iff = insertelement <4 x float> %i.ife, float %i.iex, i64 1
  ...
  %i.ifm = insertelement <4 x float> poison, float %i.idt, i64 0
  %i.ifn = insertelement <4 x float> %i.ifm, float %i.idq, i64 1
