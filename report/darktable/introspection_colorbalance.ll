...
.lr.ph.i.us:                                      ; preds = %.lr.ph.split.us, %dt_XYZ_to_Lab.exit.i.us
  ...
  %i.fa = insertelement <2 x float> <float f0x3E6A7CB9, float poison>, float %i.eo, i64 1 ; 2 uses
  %6 = insertelement <2 x float> poison, float %i.dx, i64 0
  %7 = shufflevector <2 x float> %6, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.fb = fmul reassoc nsz arcp contract afn <2 x float> %i.fa, %7
  %i.fc = fadd reassoc nsz arcp contract afn <2 x float> %i.fa, %7
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.dv = fadd reassoc nsz arcp contract afn float %i.du, f0x3E0D3DCB ; 5 uses
  %i.dw = fmul reassoc nsz arcp contract afn float %i.ds, 5.000000e-03
  %i.dx = fadd reassoc nsz arcp contract afn float %i.dv, %i.dt ; 3 uses
  %i.dy = fmul reassoc nsz arcp contract afn float %i.dx, %i.dx
  %i.dz = fmul reassoc nsz arcp contract afn float %i.dv, %i.dv
  %3 = insertelement <2 x float> poison, float %i.dx, i64 0
  %4 = insertelement <2 x float> %3, float %i.dv, i64 1 ; 3 uses
  %5 = fmul reassoc nsz arcp contract afn <2 x float> %4, splat (float f0x3E038026)
  ...
  %6 = fcmp reassoc nsz arcp contract afn ogt <2 x float> %4, splat (float f0x3E53DCB1)
  %7 = insertelement <2 x float> poison, float %i.dy, i64 0
  %8 = insertelement <2 x float> %7, float %i.dz, i64 1
  %9 = fmul reassoc nsz arcp contract afn <2 x float> %8, %4
  %10 = fadd reassoc nsz arcp contract afn <2 x float> %5, splat (float f0xBC911AA6)
  %11 = select <2 x i1> %6, <2 x float> %9, <2 x float> %10 ; 4 uses
  %12 = extractelement <2 x float> %11, i64 0
  %i.er = fmul reassoc nsz arcp contract afn float %12, 9.642000e-01
  %13 = fmul reassoc nsz arcp contract afn <2 x float> %11, <float f0x3F066D1A, float f0x3E82DEFC>
  %14 = shufflevector <2 x float> %13, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %15 = fmul reassoc nsz arcp contract afn <2 x float> %11, <float f0x3FA61CF4, float f0x3FC10BA0>
  %i.es = fsub reassoc nsz arcp contract afn <2 x float> %15, %14
  ...
  %16 = extractelement <2 x float> %11, i64 1     ; 2 uses
  %i.ex = fadd reassoc nsz arcp contract afn float %i.er, %16
  ...
  %i.fc = tail call reassoc nsz arcp contract afn float @llvm.log.f32(float %16) ; 2 uses
  ...
  %i.fg = fadd reassoc nsz arcp contract afn <2 x float> %i.ff, splat (float -1.000000e+00)
  %i.fh = fadd reassoc nsz arcp contract afn <2 x float> %i.fg, %i.fe
  ...
  %i.fp = fadd reassoc nsz arcp contract afn float %i.fo, -1.000000e+00
  %i.fq = fadd reassoc nsz arcp contract afn float %i.fp, %i.fn
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.nl = fadd reassoc nsz arcp contract afn float %i.nk, -1.000000e+00
  %i.nm = fadd reassoc nsz arcp contract afn float %i.nl, %i.ni ; 2 uses
...
bb.o:                                             ; preds = %bb.n, %bb.m, %bb.l
  ...
  %i.ce = fadd reassoc nsz arcp contract afn float %i.cb, -1.000000e+00
  %i.cf = fadd reassoc nsz arcp contract afn float %i.ce, %i.cd ; 2 uses
...
.preheader192:                                    ; preds = %bb.f, %.preheader193, %bb.c
  ...
  %i.dq = getelementptr inbounds nuw i8, ptr %i.b, i64 8 ; 3 uses
  %i.dr = load float, ptr %i.dq, align 4, !tbaa !11
  %i.ds = fadd reassoc nsz arcp contract afn float %i.dr, -1.000000e+00
end_hunk_2
