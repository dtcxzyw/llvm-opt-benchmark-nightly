...
bb.u:                                             ; preds = %bb.t
  ...
  %i.rd = select reassoc nsz arcp contract afn i1 %i.qy, float %i.ra, float %i.rc ; 2 uses
  ...
  %3 = fmul reassoc nsz arcp contract afn float %i.rr, 9.642000e-01
  %i.rs = fmul reassoc nsz arcp contract afn float %i.rd, f0x3F532CA5
  ...
  %i.ry = fadd reassoc nsz arcp contract afn float %3, %i.rx ; 2 uses
  %i.rz = fmul reassoc nsz arcp contract afn float %i.ry, 0.000000e+00
  %i.sa = insertelement <4 x float> <float poison, float 1.000000e+00, float poison, float poison>, float %i.rd, i64 0
  ...
  %4 = shufflevector <12 x float> %i.sh, <12 x float> poison, <2 x i32> <i32 0, i32 poison>
  %5 = insertelement <2 x float> %4, float %i.rs, i64 1
  %6 = fadd reassoc nsz arcp contract afn <2 x float> %5, <float -2.000000e+00, float -0.000000e+00>
  %7 = shufflevector <2 x float> %6, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
  ...
  %i.sn = fadd reassoc nsz arcp contract afn <4 x float> %i.sm, %7 ; 2 uses
...
rgb2hsl.exit.thread:                              ; preds = %bb.a, %rgb2hsl.exit
  %.0.i17 = phi float [ %i.y, %rgb2hsl.exit ], [ 0.000000e+00, %bb.a ]
  %.1.i16 = phi float [ %.1.i, %rgb2hsl.exit ], [ 0.000000e+00, %bb.a ] ; 2 uses
  %i.as = fmul reassoc nsz arcp contract afn float %.1.i16, 3.600000e+02
  tail call void @dt_bauhaus_slider_set(ptr noundef %0, float noundef %i.as) #23
  %i.at = fmul reassoc nsz arcp contract afn float %.0.i17, 1.000000e+02
  tail call void @dt_bauhaus_slider_set(ptr noundef %1, float noundef %i.at) #23
  %i.au = fmul reassoc nsz arcp contract afn float %.1.i16, 6.000000e+00 ; 8 uses
