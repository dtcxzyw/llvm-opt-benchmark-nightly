...
.preheader197:                                    ; preds = %bb.f, %.preheader198, %bb.c
  ...
  %1 = fsub reassoc nsz arcp contract afn float 2.000000e+00, %i.bt ; 4 uses
  %2 = fadd reassoc nsz arcp contract afn float %i.br, -1.000000e+00 ; 4 uses
  ...
  %5 = shufflevector <2 x float> %4, <2 x float> poison, <2 x i32> zeroinitializer ; 3 uses
  ...
  %i.dc = tail call reassoc nsz arcp contract afn <2 x float> @llvm.pow.v2f32(<2 x float> %i.db, <2 x float> %5) ; 3 uses
  ...
  %i.dl = fadd reassoc nsz arcp contract afn float %2, %i.bz ; 2 uses
  ...
  %i.do = tail call reassoc nsz arcp contract afn noundef float @llvm.pow.f32(float %i.dn, float %1) ; 2 uses
  %i.dp = fadd reassoc nsz arcp contract afn float %i.cc, %2 ; 2 uses
  ...
  %i.ds = tail call reassoc nsz arcp contract afn noundef float @llvm.pow.f32(float %i.dr, float %1) ; 2 uses
  %i.dt = fadd reassoc nsz arcp contract afn float %i.cf, %2 ; 2 uses
  ...
  %i.dw = tail call reassoc nsz arcp contract afn noundef float @llvm.pow.f32(float %i.dv, float %1) ; 3 uses
