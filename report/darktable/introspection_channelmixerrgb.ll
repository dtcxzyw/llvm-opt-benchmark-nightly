...
bb.t:                                             ; preds = %.loopexit.i.i.i.i, %transpose_dot_vector.exit.i.i
  %indvars.iv142.i.i.i.i = phi i64 [ 0, %transpose_dot_vector.exit.i.i ], [ %indvars.iv.next143.i.i.i.i, %.loopexit.i.i.i.i ] ; 20 uses
  ...
  %i.anu = shl nuw nsw i64 %indvars.iv142.i.i.i.i, 3
  %6 = getelementptr i8, ptr %i.ps, i64 %i.anu
  ...
  %i.anx = mul nuw nsw i64 %indvars.iv142.i.i.i.i, 72
  %7 = getelementptr i8, ptr %i.ps, i64 %i.anx
  %scevgep1430 = getelementptr i8, ptr %7, i64 72
  %i.any = sub nsw i64 8, %indvars.iv142.i.i.i.i  ; 3 uses
  %i.anz = mul nuw nsw i64 %indvars.iv142.i.i.i.i, 80 ; 3 uses
  %i.aoa = getelementptr i8, ptr %i.ps, i64 %i.anz
  %scevgep = getelementptr i8, ptr %i.aoa, i64 80 ; 2 uses
  %i.aob = getelementptr i8, ptr %i.ps, i64 %i.anz
  ...
  %i.aoe = getelementptr i8, ptr %i.ps, i64 %i.anz
  %scevgep1406 = getelementptr i8, ptr %i.aoe, i64 8
  %i.aof = mul nuw nsw i64 %indvars.iv142.i.i.i.i, 72
  %8 = getelementptr i8, ptr %i.ps, i64 %i.aof
