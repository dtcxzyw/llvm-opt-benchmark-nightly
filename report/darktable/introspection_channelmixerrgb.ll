...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %i.jc = getelementptr inbounds nuw i8, ptr %4, i64 %.idx289 ; 4 uses
  ...
  %i.jp = load <2 x float>, ptr %i.jf, align 4, !tbaa !12
  %i.jq = fmul reassoc nsz arcp contract afn <2 x float> %i.jp, <float 2.000000e-03, float 5.000000e-03> ; 2 uses
  %6 = insertelement <2 x float> poison, float %i.ji, i64 0
  %7 = shufflevector <2 x float> %6, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.jr = fadd reassoc nsz arcp contract afn <2 x float> %7, %i.jq
  %8 = fsub reassoc nsz arcp contract afn <2 x float> %7, %i.jq
  %9 = shufflevector <2 x float> %i.jr, <2 x float> %8, <2 x i32> <i32 0, i32 3> ; 5 uses
  %10 = fcmp reassoc nsz arcp contract afn ogt <2 x float> %9, splat (float f0x3E53DCB1)
  %i.js = fmul reassoc nsz arcp contract afn <2 x float> %9, %9
  %11 = fmul reassoc nsz arcp contract afn <2 x float> %i.js, %9
  %12 = fmul reassoc nsz arcp contract afn <2 x float> %9, splat (float f0x3E038026)
  %i.jt = fadd reassoc nsz arcp contract afn <2 x float> %12, splat (float f0xBC911AA6)
  %13 = select <2 x i1> %10, <2 x float> %11, <2 x float> %i.jt ; 2 uses
  %14 = extractelement <2 x float> %13, i64 0
  %15 = fmul reassoc nsz arcp contract afn float %14, 9.642000e-01 ; 2 uses
  %16 = extractelement <2 x float> %13, i64 1
  %17 = fmul reassoc nsz arcp contract afn float %16, f0x3F532CA5 ; 2 uses
  %18 = load float, ptr %i.jc, align 4, !tbaa !12 ; 3 uses
  %19 = fmul reassoc nsz arcp contract afn float %18, %18
  %20 = getelementptr inbounds nuw i8, ptr %i.jc, i64 4 ; 2 uses
  %21 = load float, ptr %20, align 4, !tbaa !12   ; 3 uses
  %22 = fmul reassoc nsz arcp contract afn float %21, %21
  %23 = fadd reassoc nsz arcp contract afn float %22, %19
  %24 = getelementptr inbounds nuw i8, ptr %i.jc, i64 8 ; 2 uses
  %25 = load float, ptr %24, align 4, !tbaa !12   ; 3 uses
  %26 = fmul reassoc nsz arcp contract afn float %25, %25
  %i.ju = fadd reassoc nsz arcp contract afn float %23, %26
  %i.jv = tail call reassoc nsz arcp contract afn float @llvm.sqrt.f32(float %i.ju)
  %27 = tail call reassoc nsz arcp contract afn float @llvm.maxnum.f32(float %i.jv, float f0x37800000)
  %28 = fmul reassoc nsz arcp contract afn float %15, %15
  %29 = fmul reassoc nsz arcp contract afn float %i.jo, %i.jo
  %30 = fadd reassoc nsz arcp contract afn float %28, %29
  %i.jw = fmul reassoc nsz arcp contract afn float %17, %17
  %31 = fadd reassoc nsz arcp contract afn float %30, %i.jw
  %32 = tail call reassoc nsz arcp contract afn float @llvm.sqrt.f32(float %31)
  %33 = tail call reassoc nsz arcp contract afn float @llvm.maxnum.f32(float %32, float f0x37800000)
  %i.jx = fmul reassoc nnan nsz arcp contract afn float %27, %i.bz ; 3 uses
  %34 = fmul reassoc nsz arcp contract afn float %i.gv, %33 ; 3 uses
  %35 = fmul reassoc nsz arcp contract afn float %34, %18
  %.reass = fdiv reassoc nsz arcp contract afn float %35, %i.jx
  store float %.reass, ptr %i.jc, align 4, !tbaa !12
  %36 = fmul reassoc nsz arcp contract afn float %34, %21
  %.reass.1 = fdiv reassoc nsz arcp contract afn float %36, %i.jx
  store float %.reass.1, ptr %20, align 4, !tbaa !12
  %i.jy = fmul reassoc nsz arcp contract afn float %34, %25
  %.reass.2 = fdiv reassoc nsz arcp contract afn float %i.jy, %i.jx
  store float %.reass.2, ptr %24, align 4, !tbaa !12
