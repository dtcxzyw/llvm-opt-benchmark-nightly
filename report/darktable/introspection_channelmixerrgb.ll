...
convert_any_LMS_to_XYZ.exit.i:                    ; preds = %bb.o, %bb.n, %bb.m
  ...
  %i.it = fdiv reassoc nsz arcp contract afn float %i.io, %i.iq ; 6 uses
  ...
  %i.iw = fdiv reassoc nsz arcp contract afn float %i.iv, %i.iq ; 6 uses
...
switch.lookup:                                    ; preds = %convert_any_LMS_to_XYZ.exit.i
  ...
  %6 = fmul reassoc nsz arcp contract afn float %switch.load1470, %i.it
  %7 = fmul reassoc nsz arcp contract afn float %switch.load, %i.it
  %8 = fadd reassoc nsz arcp contract afn float %6, %switch.load1472
  %9 = fadd reassoc nsz arcp contract afn float %7, %switch.load1466
  %10 = fmul reassoc nsz arcp contract afn float %switch.load1474, %i.iw
  %11 = fmul reassoc nsz arcp contract afn float %switch.load1468, %i.iw
  %12 = fadd reassoc nsz arcp contract afn float %11, %9
  %13 = fadd reassoc nsz arcp contract afn float %10, %8
...
convert_any_XYZ_to_LMS.exit294.i:                 ; preds = %convert_any_LMS_to_XYZ.exit.i, %switch.lookup
  %.sroa.0300.0.i = phi nsz float [ %i.it, %convert_any_LMS_to_XYZ.exit.i ], [ %12, %switch.lookup ]
  %.sroa.14307.0.i = phi nsz float [ 1.000000e+00, %convert_any_LMS_to_XYZ.exit.i ], [ %13, %switch.lookup ]
...
.lr.ph.i:                                         ; preds = %convert_any_XYZ_to_LMS.exit294.i
  ...
  %15 = insertelement <2 x float> %14, float %.sroa.14307.0.i, i64 1 ; 3 uses
  %i.ju = fdiv reassoc nsz arcp contract afn <2 x float> splat (float 1.000000e+00), %15
  ...
  %i.jx = fdiv reassoc nsz arcp contract afn <2 x float> splat (float 1.000000e+00), %15
  ...
  %i.ka = fdiv reassoc nsz arcp contract afn <2 x float> splat (float 1.000000e+00), %15
  br label %bb.p
...
bb.p:                                             ; preds = %convert_any_LMS_to_XYZ.exit297.i, %.lr.ph.i
  %.0264232.i = phi i64 [ 0, %.lr.ph.i ], [ %i.pe, %convert_any_LMS_to_XYZ.exit297.i ] ; 2 uses
...
xy_to_CCT.exit:                                   ; preds = %bb.a
  ...
  %i.m = fadd reassoc nsz arcp contract afn float %i.l, %i.i
...
xy_to_CCT.exit:                                   ; preds = %dt_Lch_to_xyY.exit
  ...
  %i.ao = fadd reassoc nsz arcp contract afn float %i.an, %i.ak
...
._crit_edge:                                      ; preds = %bb.v, %bb.a
  %.0127.lcssa = phi float [ 0.000000e+00, %bb.a ], [ %i.eh, %bb.v ]
  %.0125.lcssa = phi float [ 0.000000e+00, %bb.a ], [ %.1126, %bb.v ]
  store float %.0127.lcssa, ptr %3, align 4, !tbaa !14
  store float %.0125.lcssa, ptr %4, align 4, !tbaa !14
  ret void

bb.b:                                             ; preds = %.lr.ph, %bb.v
  %.0124143 = phi i64 [ 0, %.lr.ph ], [ %i.ej, %bb.v ] ; 4 uses
  %.0125142 = phi float [ 0.000000e+00, %.lr.ph ], [ %.1126, %bb.v ] ; 2 uses
  %.0127141 = phi float [ 0.000000e+00, %.lr.ph ], [ %i.eh, %bb.v ]
  %.idx = shl i64 %.0124143, 4
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 %.idx ; 3 uses
  %.sroa.0.0.copyload = load float, ptr %i.e, align 4, !tbaa !14 ; 2 uses
  %.sroa.4.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.e, i64 4
  %.sroa.4.0.copyload = load float, ptr %.sroa.4.0..sroa_idx, align 4, !tbaa !14 ; 3 uses
  %.sroa.5.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.e, i64 8
  %.sroa.5.0.copyload = load float, ptr %.sroa.5.0..sroa_idx, align 4, !tbaa !14 ; 2 uses
...
dt_XYZ_to_Lab.exit:                               ; preds = %bb.j, %bb.i
  ...
  %i.ac = getelementptr inbounds nuw [48 x i8], ptr %1, i64 %.0124143 ; 3 uses
  ...
  %.0121 = select nsz i1 %i.bh, float 0.000000e+00, float %i.bf ; 3 uses
  ...
  %i.bj = fcmp reassoc nsz arcp contract afn olt float %.0121, 0.000000e+00
  %i.bk = fsub reassoc nsz arcp contract afn float f0x40C90FDB, %.0121
  %.1122 = select nsz i1 %i.bj, float %i.bk, float %.0121
...
bb.o:                                             ; preds = %bb.n, %dt_XYZ_to_Lab.exit, %bb.k, %bb.m
  %.0119 = phi nsz float [ %spec.select, %bb.n ], [ %i.bp, %bb.k ], [ %i.bu, %bb.m ], [ 0.000000e+00, %dt_XYZ_to_Lab.exit ] ; 2 uses
...
bb.v:                                             ; preds = %bb.q, %bb.t, %bb.u, %bb.s, %bb.o
  %.0 = phi nsz float [ %i.ce, %bb.o ], [ %i.cg, %bb.q ], [ %i.ck, %bb.s ], [ %i.cn, %bb.u ], [ %i.ce, %bb.t ] ; 5 uses
  %i.co = fmul reassoc nsz arcp contract afn float %.0, f0x3C8EFA36
  ...
  %5 = fadd reassoc nsz arcp contract afn float %.neg, 1.000000e+00
  %i.cr = fmul reassoc nsz arcp contract afn float %.0, f0x3D0EFA36
  ...
  %6 = fadd reassoc nsz arcp contract afn float %i.ct, %5
  %i.cu = fmul reassoc nsz arcp contract afn float %.0, f0x3D567751
  ...
  %i.cx = fmul reassoc nsz arcp contract afn float %i.cw, 3.200000e-01
  %i.cy = fadd reassoc nsz arcp contract afn float %i.cx, %6
  %.neg139.a = fmul reassoc nsz arcp contract afn float %.0, f0x3D8EFA36
  %i.cz = fadd reassoc nsz arcp contract afn float %.neg139.a, f0xBF8CBE4D
  %7 = tail call reassoc nsz arcp contract afn float @llvm.cos.f32(float %i.cz)
  %.neg139 = fmul reassoc nsz arcp contract afn float %7, -2.000000e-01
  %i.da = fadd reassoc nsz arcp contract afn float %i.cy, %.neg139
  ...
  %i.dn = fmul reassoc nsz arcp contract afn float %.0, 4.000000e-02
  ...
  %8 = fadd reassoc nsz arcp contract afn float %i.dx, %i.dv
  ...
  %i.ed = fadd reassoc nsz arcp contract afn float %8, %reass.mul
  %i.ee = tail call reassoc nsz arcp contract afn float @llvm.sqrt.f32(float %i.ed) ; 4 uses
  %i.ef = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %.0124143
  store float %i.ee, ptr %i.ef, align 4, !tbaa !14
  %i.eg = fmul reassoc nsz arcp contract afn float %i.ee, %i.d
  %i.eh = fadd reassoc nsz arcp contract afn float %i.eg, %.0127141 ; 2 uses
  %i.ei = fcmp reassoc nsz arcp contract afn ogt float %i.ee, %.0125142
  %.1126 = select nsz i1 %i.ei, float %i.ee, float %.0125142 ; 2 uses
  %i.ej = add nuw i64 %.0124143, 1                ; 2 uses
