...
bb.l:                                             ; preds = %bb.h
  ...
  %i.ft = fadd reassoc nsz arcp contract afn float %.reass188.i, %.reass187.i
  ...
  %i.fx = tail call reassoc nsz arcp contract afn float @llvm.pow.f32(float %i.fw, float f0x3E232000) ; 2 uses
  ...
  %5 = fadd reassoc nsz arcp contract afn float %i.ft, %.reass186.i
  %6 = fadd reassoc nsz arcp contract afn float %i.fs, %.reass183.i
  %i.ge = insertelement <2 x float> poison, float %5, i64 0
  %7 = insertelement <2 x float> %i.ge, float %6, i64 1
  %8 = tail call reassoc nsz arcp contract afn <2 x float> @llvm.maxnum.v2f32(<2 x float> %7, <2 x float> zeroinitializer)
  %i.gf = tail call reassoc nsz arcp contract afn <2 x float> @llvm.pow.v2f32(<2 x float> %8, <2 x float> splat (float f0x3E232000)) ; 2 uses
...
bb.e:                                             ; preds = %bb.a
  ...
  %5 = fmul reassoc nsz arcp contract afn float %i.ch, f0x38D1B717
  ...
  %7 = fmul reassoc nsz arcp contract afn <2 x float> %i.ct, splat (float f0x38D1B717)
  %8 = tail call reassoc nsz arcp contract afn <2 x float> @llvm.maxnum.v2f32(<2 x float> %7, <2 x float> zeroinitializer)
