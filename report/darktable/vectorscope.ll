...
bb.l:                                             ; preds = %bb.h
  ...
  %.reass185.i = fmul reassoc nsz arcp contract afn float %i.fp, f0x382DF9B4
  %.reass183.i = fmul reassoc nsz arcp contract afn float %i.fr, f0x387344EC
  %.reass184.i = fmul reassoc nsz arcp contract afn float %i.fm, 1.464800e-06
  %i.fs = fadd reassoc nsz arcp contract afn float %.reass185.i, %.reass184.i
  %.reass188.i = fmul reassoc nsz arcp contract afn float %i.fp, -2.015100e-05
  %.reass186.i = fmul reassoc nsz arcp contract afn float %i.fr, f0x38EB0462
  %.reass187.i = fmul reassoc nsz arcp contract afn float %i.fm, 5.310080e-06
  %5 = fadd reassoc nsz arcp contract afn float %.reass188.i, %.reass187.i
  ...
  %i.ft = fadd reassoc nsz arcp contract afn float %.reass191.i, %.reass190.i
  %6 = fadd reassoc nsz arcp contract afn float %i.ft, %.reass189.i
  %i.fu = tail call reassoc nsz arcp contract afn float @llvm.maxnum.f32(float %6, float 0.000000e+00)
  %7 = tail call reassoc nsz arcp contract afn float @llvm.pow.f32(float %i.fu, float f0x3E232000) ; 2 uses
  %8 = fmul reassoc nsz arcp contract afn float %7, f0x4196D000
  %9 = fadd reassoc nsz arcp contract afn float %8, f0x3F560000
  %10 = fmul reassoc nsz arcp contract afn float %7, 1.868750e+01
  %11 = fadd reassoc nsz arcp contract afn float %10, 1.000000e+00
  %12 = fdiv reassoc nsz arcp contract afn float %9, %11
  %13 = tail call reassoc nsz arcp contract afn float @llvm.pow.f32(float %12, float f0x430608CD)
  %14 = fadd reassoc nsz arcp contract afn float %5, %.reass186.i
  %15 = fadd reassoc nsz arcp contract afn float %i.fs, %.reass183.i
  %16 = insertelement <2 x float> poison, float %14, i64 0
  %17 = insertelement <2 x float> %16, float %15, i64 1
  %i.fv = tail call reassoc nsz arcp contract afn <2 x float> @llvm.maxnum.v2f32(<2 x float> %17, <2 x float> zeroinitializer)
  ...
  %i.gh = insertelement <2 x float> poison, float %13, i64 0
