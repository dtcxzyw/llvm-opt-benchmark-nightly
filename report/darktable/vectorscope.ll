...
bb.l:                                             ; preds = %bb.h
  ...
  %i.gp = fmul reassoc nnan nsz arcp contract afn <2 x float> %i.go, splat (float f0x4196D000)
  %i.gq = fadd reassoc nsz arcp contract afn <2 x float> %i.gp, splat (float f0x3F560000)
  %i.gr = fmul reassoc nnan nsz arcp contract afn <2 x float> %i.go, splat (float 1.868750e+01)
...
bb.e:                                             ; preds = %bb.a
  ...
  %i.cl = fmul reassoc nnan nsz arcp contract afn float %i.ck, f0x4196D000
  %i.cm = fadd reassoc nsz arcp contract afn float %i.cl, f0x3F560000
  %i.cn = fmul reassoc nnan nsz arcp contract afn float %i.ck, 1.868750e+01
  ...
  %i.cz = fmul reassoc nnan nsz arcp contract afn <2 x float> %i.cy, splat (float f0x4196D000)
  %i.da = fadd reassoc nsz arcp contract afn <2 x float> %i.cz, splat (float f0x3F560000)
  %i.db = fmul reassoc nnan nsz arcp contract afn <2 x float> %i.cy, splat (float 1.868750e+01)
