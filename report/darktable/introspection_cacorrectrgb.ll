...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.df = shufflevector <8 x float> %i.co, <8 x float> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.dg = shufflevector <8 x float> %wide.masked.gather73, <8 x float> %wide.masked.gather80, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %i.dh = fmul reassoc nsz arcp contract afn <16 x float> %i.df, %i.dg
  %6 = shufflevector <8 x float> %i.cv, <8 x float> %i.cy, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %7 = fsub reassoc nsz arcp contract afn <16 x float> %i.dh, %6
  %8 = shufflevector <8 x float> %i.cp, <8 x float> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %9 = shufflevector <8 x float> %wide.masked.gather74, <8 x float> %wide.masked.gather82, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %10 = fmul reassoc nsz arcp contract afn <16 x float> %8, %9
  %11 = fadd reassoc nsz arcp contract afn <16 x float> %7, %10
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %i.eo = getelementptr inbounds nuw i8, ptr %2, i64 %.idx80.i
  ...
  %12 = fsub reassoc nsz arcp contract afn float 1.000000e+00, %i.eu
  %13 = add i64 %.08488.i.i, %i.bs
  %.idx83.i = shl i64 %13, 4
  %i.ev = getelementptr inbounds nuw i8, ptr %i.au, i64 %.idx83.i
  ...
  %i.ez = fmul reassoc nsz arcp contract afn <4 x float> %i.ey, %i.ew
  %i.fa = load <4 x float>, ptr %i.eq, align 4, !tbaa !64, !alias.scope !65, !noalias !66
  %i.fb = insertelement <4 x float> poison, float %12, i64 0
  %i.fc = shufflevector <4 x float> %i.fb, <4 x float> poison, <4 x i32> zeroinitializer ; 2 uses
  %i.fd = fmul reassoc nsz arcp contract afn <4 x float> %i.fc, %i.fa
  %i.fe = fadd reassoc nsz arcp contract afn <4 x float> %i.fd, %i.ez ; 2 uses
  %i.ff = load <4 x float>, ptr %i.em, align 4, !tbaa !64, !alias.scope !65, !noalias !66
  %i.fg = fmul reassoc nsz arcp contract afn <4 x float> %i.ey, %i.ff
  %14 = load <4 x float>, ptr %i.eo, align 4, !tbaa !64, !alias.scope !65, !noalias !66
  %i.fh = fmul reassoc nsz arcp contract afn <4 x float> %i.fc, %14
  %i.fi = fsub reassoc nsz arcp contract afn <4 x float> %i.fg, %i.fe
  %i.fj = fadd reassoc nsz arcp contract afn <4 x float> %i.fi, %i.fh
  %i.fk = fmul reassoc nsz arcp contract afn <4 x float> %i.fj, %i.dz
  %i.fl = fadd reassoc nsz arcp contract afn <4 x float> %i.fk, %i.fe
  store <4 x float> %i.fl, ptr %i.ev, align 16, !tbaa !64, !alias.scope !62, !noalias !67
...
vector.body438:                                   ; preds = %vector.body438, %vector.ph420
  ...
  %15 = fsub reassoc nsz arcp contract afn <8 x float> %i.tz, %i.ty
  %16 = fadd reassoc nsz arcp contract afn <8 x float> %15, %i.ua
  %i.ub = fmul reassoc nsz arcp contract afn <8 x float> %16, %broadcast.splat427
  ...
  %17 = fsub reassoc nsz arcp contract afn <8 x float> %i.ug, %i.uf
  %18 = fadd reassoc nsz arcp contract afn <8 x float> %17, %i.uh
  %i.ui = fmul reassoc nsz arcp contract afn <8 x float> %18, %broadcast.splat427
...
scalar.ph418:                                     ; preds = %scalar.ph418.preheader, %scalar.ph418
  ...
  %i.wn = getelementptr inbounds nuw i8, ptr %i.aw, i64 %.idx85.i ; 2 uses
  ...
  %19 = fsub reassoc nsz arcp contract afn float 1.000000e+00, %i.wt ; 2 uses
  %20 = add i64 %.08488.i60.i, %i.sy
  %.idx88.i = mul i64 %20, 24
  %i.wu = getelementptr inbounds nuw i8, ptr %i.sc, i64 %.idx88.i ; 2 uses
  ...
  %i.wy = fmul reassoc nsz arcp contract afn <4 x float> %i.wx, %i.wv
  %i.wz = load <4 x float>, ptr %i.wp, align 8, !tbaa !64, !alias.scope !114, !noalias !119
  %i.xa = insertelement <4 x float> poison, float %19, i64 0
  %i.xb = shufflevector <4 x float> %i.xa, <4 x float> poison, <4 x i32> zeroinitializer ; 2 uses
  %i.xc = fmul reassoc nsz arcp contract afn <4 x float> %i.xb, %i.wz
  %i.xd = fadd reassoc nsz arcp contract afn <4 x float> %i.xc, %i.wy ; 2 uses
  %i.xe = load <4 x float>, ptr %i.wl, align 8, !tbaa !64, !alias.scope !114, !noalias !119
  %i.xf = fmul reassoc nsz arcp contract afn <4 x float> %i.wx, %i.xe
  %21 = load <4 x float>, ptr %i.wn, align 8, !tbaa !64, !alias.scope !114, !noalias !119
  %i.xg = fmul reassoc nsz arcp contract afn <4 x float> %i.xb, %21
  %i.xh = fsub reassoc nsz arcp contract afn <4 x float> %i.xf, %i.xd
  %i.xi = fadd reassoc nsz arcp contract afn <4 x float> %i.xh, %i.xg
  %i.xj = fmul reassoc nsz arcp contract afn <4 x float> %i.xi, %i.vw
  %i.xk = fadd reassoc nsz arcp contract afn <4 x float> %i.xj, %i.xd
  store <4 x float> %i.xk, ptr %i.wu, align 8, !tbaa !64, !alias.scope !117, !noalias !120
  ...
  %i.xp = getelementptr inbounds nuw i8, ptr %i.wu, i64 16
  ...
  %i.xv = insertelement <2 x float> poison, float %19, i64 0
