...
gaussian_noise_simd.exit.i.i:                     ; preds = %bb.k
  ...
  %7 = call reassoc nnan nsz arcp contract afn float @llvm.maxnum.f32(float %i.pk, float f0x0C800000)
  %8 = fmul reassoc nnan nsz arcp contract afn float %7, f0x33800000
  %i.pl = call reassoc nnan nsz arcp contract afn float @llvm.log.f32(float %8)
  ...
  %9 = call reassoc nnan nsz arcp contract afn <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.pt, <2 x float> splat (float f0x0C800000))
  %10 = fmul reassoc nnan nsz arcp contract afn <2 x float> %9, splat (float f0x33800000)
  %i.pu = call reassoc nnan nsz arcp contract afn <2 x float> @llvm.log.v2f32(<2 x float> %10)
...
poisson_noise_simd.exit.i.i:                      ; preds = %bb.k
  ...
  %11 = call reassoc nnan nsz arcp contract afn float @llvm.maxnum.f32(float %i.rs, float f0x0C800000)
  %12 = fmul reassoc nnan nsz arcp contract afn float %11, f0x33800000
  %i.rt = call reassoc nnan nsz arcp contract afn float @llvm.log.f32(float %12)
  ...
  %13 = call reassoc nnan nsz arcp contract afn <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.sd, <2 x float> splat (float f0x0C800000))
  %14 = fmul reassoc nnan nsz arcp contract afn <2 x float> %13, splat (float f0x33800000)
  %i.se = call reassoc nnan nsz arcp contract afn <2 x float> @llvm.log.v2f32(<2 x float> %14)
