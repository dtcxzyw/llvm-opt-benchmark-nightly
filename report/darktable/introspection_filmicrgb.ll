...
bb.b:                                             ; preds = %.loopexit.i, %bb.a
  ...
  %i.ad = xor i64 %indvars.iv147.i, -1
  %i.ae = add nsw i64 %i.ad, %i.g                 ; 2 uses
  %i.af = sub nsw i64 %i.r, %indvars.iv147.i      ; 2 uses
  %i.ag = shl nuw nsw i64 %indvars.iv147.i, 3
  %i.ah = getelementptr i8, ptr %0, i64 %i.ag
  %scevgep27 = getelementptr i8, ptr %i.ah, i64 8
...
.lr.ph115.i.preheader:                            ; preds = %.preheader111.i
  %xtraiter81 = and i64 %i.ae, 3                  ; 2 uses
...
vector.ph59:                                      ; preds = %vector.memcheck48
  ...
  %wide.load68 = load <4 x double>, ptr %i.ic, align 8, !tbaa !184, !alias.scope !528, !noalias !527
...
.lr.ph.i12.preheader:                             ; preds = %vector.memcheck48, %.lr.ph.preheader.i9, %vector.ph59
  ...
  %xtraiter90 = and i64 %i.ie, 3                  ; 2 uses
