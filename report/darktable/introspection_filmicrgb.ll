...
iter.check:                                       ; preds = %._crit_edge120.i, %.preheader.preheader.i
  ...
  %i.fd = mul nuw nsw i64 %indvars.iv141.i, %i.g  ; 2 uses
  %gep165.i = getelementptr inbounds nuw [8 x i8], ptr %i.bh, i64 %i.fd ; 7 uses
  %invariant.gep162.i = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %i.fd ; 7 uses
...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  %i.fe = load double, ptr %gep165.i, align 8, !tbaa !383, !alias.scope !509
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.fg = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep160.i, i64 %i.ff ; 4 uses
  ...
  %i.fo = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep162.i, i64 %i.ff ; 5 uses
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %i.fx = load double, ptr %gep165.i, align 8, !tbaa !383, !alias.scope !509
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.fz = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep160.i, i64 %i.fy
  ...
  %i.gb = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep162.i, i64 %i.fy ; 2 uses
...
vec.epilog.scalar.ph.preheader:                   ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv136.i.ph = phi i64 [ %indvars.iv.i, %iter.check ], [ %i.fc, %vec.epilog.middle.block ], [ %i.fb, %vec.epilog.iter.check ] ; 4 uses
  %i.ge = sub i64 %i.g, %indvars.iv136.i.ph
...
vec.epilog.scalar.ph.prol:                        ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph.prol
  ...
  %i.gf = load double, ptr %gep165.i, align 8, !tbaa !383
  %gep161.i.prol = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep160.i, i64 %indvars.iv136.i.prol
  %i.gg = load double, ptr %gep161.i.prol, align 8, !tbaa !383
  ...
  %i.gi = load double, ptr %gep163.i.prol, align 8, !tbaa !383
  %i.gj = fadd reassoc nsz arcp contract afn double %i.gi, %i.gh
  store double %i.gj, ptr %gep163.i.prol, align 8, !tbaa !383
...
vec.epilog.scalar.ph.prol.loopexit:               ; preds = %vec.epilog.scalar.ph.prol, %vec.epilog.scalar.ph.preheader
  ...
  %i.gk = sub i64 %indvars.iv136.i.ph, %i.g
  %i.gl = icmp ugt i64 %i.gk, -4
  br i1 %i.gl, label %._crit_edge120.i, label %vec.epilog.scalar.ph
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph
  ...
  %i.gm = load double, ptr %gep165.i, align 8, !tbaa !383
  %gep161.i = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep160.i, i64 %indvars.iv136.i
  %i.gn = load double, ptr %gep161.i, align 8, !tbaa !383
  ...
  %i.he = load double, ptr %gep163.i.3, align 8, !tbaa !383
  %i.hf = fadd reassoc nsz arcp contract afn double %i.he, %i.hd
  store double %i.hf, ptr %gep163.i.3, align 8, !tbaa !383
