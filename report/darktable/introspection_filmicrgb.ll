...
bb.b:                                             ; preds = %.loopexit.i, %bb.a
  ...
  %i.ar = icmp samesign ult i64 %indvars.iv.next147.i, %i.g ; 2 uses
...
.preheader110.i:                                  ; preds = %._crit_edge.i
  br i1 %i.ar, label %.lr.ph114.i.preheader, label %.loopexit.i

.lr.ph114.i.preheader:                            ; preds = %.preheader110.i
  %xtraiter81 = and i64 %i.af, 3                  ; 2 uses
  %lcmp.mod82.not = icmp eq i64 %xtraiter81, 0
  br i1 %lcmp.mod82.not, label %.lr.ph114.i.prol.loopexit, label %.lr.ph114.i.prol.preheader
...
.lr.ph114.i.prol:                                 ; preds = %.lr.ph114.i.prol, %.lr.ph114.i.prol.preheader
  ...
  %prol.iter83 = phi i64 [ %prol.iter83.next, %.lr.ph114.i.prol ], [ 0, %.lr.ph114.i.prol.preheader ]
  ...
  br i1 %prol.iter83.cmp.not, label %.lr.ph114.i.prol.loopexit, label %.lr.ph114.i.prol, !llvm.loop !500
...
.lr.ph.preheader.i9:                              ; preds = %.lr.ph.preheader.i9.preheader, %.loopexit.i15
  ...
  %i.hn = xor i64 %indvars.iv63.i, -1
  %i.ho = add nsw i64 %i.hn, %i.g                 ; 3 uses
  %i.hp = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %indvars.iv63.i
  %i.hq = load i32, ptr %i.hp, align 4, !tbaa !24
  %i.hr = sext i32 %i.hq to i64
  %i.hs = getelementptr inbounds [8 x i8], ptr %1, i64 %i.hr ; 2 uses
  %i.ht = load double, ptr %i.hs, align 8, !tbaa !383 ; 7 uses
  %i.hu = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv63.i ; 2 uses
  %i.hv = load double, ptr %i.hu, align 8, !tbaa !383
  store double %i.hv, ptr %i.hs, align 8, !tbaa !383
  store double %i.ht, ptr %i.hu, align 8, !tbaa !383
  %invariant.gep.i11 = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %indvars.iv63.i ; 6 uses
  %min.iters.check58 = icmp ult i64 %i.ho, 4
...
vector.ph59:                                      ; preds = %vector.memcheck48
  ...
  %broadcast.splatinsert61 = insertelement <4 x double> poison, double %i.ht, i64 0
  ...
  %cmp.n70 = icmp eq i64 %i.ho, %n.vec60
...
.lr.ph.i12.prol:                                  ; preds = %.lr.ph.i12.preheader, %.lr.ph.i12.prol
  ...
  %i.ii = fmul reassoc nsz arcp contract afn double %i.ih, %i.ht
...
.lr.ph.i12:                                       ; preds = %.lr.ph.i12.prol.loopexit, %.lr.ph.i12
  ...
  %i.iq = fmul reassoc nsz arcp contract afn double %i.ip, %i.ht
  ...
  %i.iw = fmul reassoc nsz arcp contract afn double %i.iv, %i.ht
  ...
  %i.jc = fmul reassoc nsz arcp contract afn double %i.jb, %i.ht
  ...
  %i.ji = fmul reassoc nsz arcp contract afn double %i.jh, %i.ht
