...
norm_tone_mapping_v4.exit.i:                      ; preds = %bb.ag, %bb.af, %filmic_spline.exit.i
  ...
  %7 = fmul reassoc nsz arcp contract afn <4 x float> %i.afu, <float f0xBD53224F, float f0xBD53224F, float f0x3CA8E841, float f0x3CA8E841>
  %8 = fadd reassoc nsz arcp contract afn <4 x float> %i.afv, <float -5.437140e-01, float -5.437140e-01, float f0xBE604727, float f0xBE604727>
  %i.afx = fadd reassoc nsz arcp contract afn <4 x float> %8, %i.afw
  %i.afy = fadd reassoc nsz arcp contract afn <4 x float> %i.afx, %7 ; 5 uses
...
norm_tone_mapping_v4.exit.i281:                   ; preds = %bb.ea, %bb.dz, %filmic_spline.exit.i279
  ...
  %9 = fmul reassoc nsz arcp contract afn <4 x float> %i.bjv, <float f0xBD53224F, float f0xBD53224F, float f0x3CA8E841, float f0x3CA8E841>
  %10 = fadd reassoc nsz arcp contract afn <4 x float> %i.bjw, <float -5.437140e-01, float -5.437140e-01, float f0xBE604727, float f0xBE604727>
  %i.bjy = fadd reassoc nsz arcp contract afn <4 x float> %10, %i.bjx
  %i.bjz = fadd reassoc nsz arcp contract afn <4 x float> %i.bjy, %9 ; 5 uses
...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %10 = fmul reassoc nsz arcp contract afn <4 x float> %i.cf, <float f0xBD53224F, float f0xBD53224F, float f0x3CA8E841, float f0x3CA8E841>
  %11 = fadd reassoc nsz arcp contract afn <4 x float> %i.cg, <float -5.437140e-01, float -5.437140e-01, float f0xBE604727, float f0xBE604727>
  %i.ci = fadd reassoc nsz arcp contract afn <4 x float> %11, %i.ch
  %i.cj = fadd reassoc nsz arcp contract afn <4 x float> %i.ci, %10 ; 5 uses
...
bb.y:                                             ; preds = %bb.x, %bb.w, %bb.v
  ...
  %i.cm = fsub reassoc nsz arcp contract afn float %.0, %i.cl
  ...
  %i.cw = fdiv reassoc nsz arcp contract afn float %i.cv, %i.cr
  %2 = fadd reassoc nsz arcp contract afn float %i.cw, %i.cm ; 2 uses
  %i.cx = fadd reassoc nsz arcp contract afn float %2, %i.cn
  %i.cy = fadd reassoc nsz arcp contract afn float %2, %i.co
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.ax = fadd reassoc nsz arcp contract afn double %.neg, %i.at
  %i.ay = fadd reassoc nsz arcp contract afn double %i.ax, %i.aw
...
bb.bm:                                            ; preds = %bb.bh, %bb.bl, %bb.bk, %bb.bi
  ...
  %i.aht = fadd reassoc nsz arcp contract afn double %.neg1263, %.neg1261
...
vector.body48:                                    ; preds = %.lr.ph.i.preheader, %vector.body48
  ...
  %i.aw = fadd reassoc nsz arcp contract afn <4 x float> %strided.vec66, %strided.vec56
  %i.ax = fmul reassoc nsz arcp contract afn <4 x float> %i.aw, splat (float 2.500000e-01)
  %6 = fadd reassoc nsz arcp contract afn <4 x float> %strided.vec71, %strided.vec51
  %7 = fmul reassoc nsz arcp contract afn <4 x float> %6, splat (float 6.250000e-02)
  %8 = fadd reassoc nsz arcp contract afn <4 x float> %i.ax, %i.av
  %i.ay = fadd reassoc nsz arcp contract afn <4 x float> %8, %7 ; 2 uses
  %i.az = fmul reassoc nsz arcp contract afn <4 x float> %strided.vec62, splat (float 3.750000e-01)
  %i.ba = fadd reassoc nsz arcp contract afn <4 x float> %strided.vec67, %strided.vec57
  %i.bb = fmul reassoc nsz arcp contract afn <4 x float> %i.ba, splat (float 2.500000e-01)
  %i.bc = fadd reassoc nsz arcp contract afn <4 x float> %strided.vec72, %strided.vec52
  %i.bd = fmul reassoc nsz arcp contract afn <4 x float> %i.bc, splat (float 6.250000e-02)
  %9 = fadd reassoc nsz arcp contract afn <4 x float> %i.bb, %i.az
  %i.be = fadd reassoc nsz arcp contract afn <4 x float> %9, %i.bd ; 2 uses
  %i.bf = fmul reassoc nsz arcp contract afn <4 x float> %strided.vec63, splat (float 3.750000e-01)
  %i.bg = fadd reassoc nsz arcp contract afn <4 x float> %strided.vec68, %strided.vec58
  %i.bh = fmul reassoc nsz arcp contract afn <4 x float> %i.bg, splat (float 2.500000e-01)
  %i.bi = fadd reassoc nsz arcp contract afn <4 x float> %strided.vec73, %strided.vec53
  %i.bj = fmul reassoc nsz arcp contract afn <4 x float> %i.bi, splat (float 6.250000e-02)
  %i.bk = fadd reassoc nsz arcp contract afn <4 x float> %i.bh, %i.bf
  %10 = fadd reassoc nsz arcp contract afn <4 x float> %i.bk, %i.bj ; 2 uses
  %i.bl = fmul reassoc nsz arcp contract afn <4 x float> %strided.vec64, splat (float 3.750000e-01)
  %i.bm = fadd reassoc nsz arcp contract afn <4 x float> %strided.vec69, %strided.vec59
  %i.bn = fmul reassoc nsz arcp contract afn <4 x float> %i.bm, splat (float 2.500000e-01)
  %i.bo = fadd reassoc nsz arcp contract afn <4 x float> %strided.vec74, %strided.vec54
  %i.bp = fmul reassoc nsz arcp contract afn <4 x float> %i.bo, splat (float 6.250000e-02)
  %i.bq = fadd reassoc nsz arcp contract afn <4 x float> %i.bn, %i.bl
  %i.br = fadd reassoc nsz arcp contract afn <4 x float> %i.bq, %i.bp ; 2 uses
  %i.bs = shufflevector <4 x float> %i.ay, <4 x float> %i.be, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.bt = fcmp reassoc nsz arcp contract afn olt <8 x float> %i.bs, zeroinitializer
  %i.bu = shufflevector <4 x float> %i.ay, <4 x float> %i.be, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.bv = select reassoc nsz arcp contract afn <8 x i1> %i.bt, <8 x float> zeroinitializer, <8 x float> %i.bu
  %i.bw = shufflevector <4 x float> %10, <4 x float> %i.br, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.bx = fcmp reassoc nsz arcp contract afn olt <8 x float> %i.bw, zeroinitializer
  %i.by = shufflevector <4 x float> %10, <4 x float> %i.br, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader80, %.lr.ph.i
  ...
  %11 = load <4 x float>, ptr %i.cf, align 4, !tbaa !16, !alias.scope !484, !noalias !487
  %i.ck = load <4 x float>, ptr %i.cg, align 4, !tbaa !16, !alias.scope !484, !noalias !487
  %i.cl = fmul reassoc nsz arcp contract afn <4 x float> %i.ck, splat (float 3.750000e-01)
  %i.cm = load <4 x float>, ptr %i.ch, align 4, !tbaa !16, !alias.scope !484, !noalias !487
  %12 = load <4 x float>, ptr %i.ci, align 4, !tbaa !16, !alias.scope !484, !noalias !487
  %i.cn = fadd reassoc nsz arcp contract afn <4 x float> %i.cm, %11
  %i.co = fmul reassoc nsz arcp contract afn <4 x float> %i.cn, splat (float 2.500000e-01)
  %i.cp = fadd reassoc nsz arcp contract afn <4 x float> %12, %i.cj
  %13 = fmul reassoc nsz arcp contract afn <4 x float> %i.cp, splat (float 6.250000e-02)
  %14 = fadd reassoc nsz arcp contract afn <4 x float> %i.co, %i.cl
  %i.cq = fadd reassoc nsz arcp contract afn <4 x float> %14, %13 ; 2 uses
...
vector.body:                                      ; preds = %.lr.ph, %vector.body
  ...
  %wide.masked.gather17 = tail call <8 x float> @llvm.masked.gather.v8f32.v8p0(<8 x ptr> align 4 %wide.gep11, <8 x i1> splat (i1 true), <8 x float> poison), !tbaa !16, !alias.scope !491, !noalias !494
  %wide.masked.gather18.a = tail call <8 x float> @llvm.masked.gather.v8f32.v8p0(<8 x ptr> align 4 %wide.gep12, <8 x i1> splat (i1 true), <8 x float> poison), !tbaa !16, !alias.scope !491, !noalias !494
  %15 = fadd reassoc nsz arcp contract afn <8 x float> %wide.masked.gather17, %wide.masked.gather13
  %i.dp = fmul reassoc nsz arcp contract afn <8 x float> %15, splat (float 2.500000e-01)
  %i.dq = fadd reassoc nsz arcp contract afn <8 x float> %wide.masked.gather18.a, %wide.masked.gather
  %16 = fmul reassoc nsz arcp contract afn <8 x float> %i.dq, splat (float 6.250000e-02)
  %17 = fadd reassoc nsz arcp contract afn <8 x float> %i.dp, %i.do
  %i.dr = fadd reassoc nsz arcp contract afn <8 x float> %17, %16 ; 2 uses
  ...
  %i.ds = fmul reassoc nsz arcp contract afn <8 x float> %strided.vec14, splat (float 3.750000e-01)
  %wide.gep23 = getelementptr i8, <8 x ptr> %wide.gep11, i64 4
  %wide.masked.gather24 = tail call <8 x float> @llvm.masked.gather.v8f32.v8p0(<8 x ptr> align 4 %wide.gep23, <8 x i1> splat (i1 true), <8 x float> poison), !tbaa !16, !alias.scope !491, !noalias !494
  %wide.gep25.a = getelementptr i8, <8 x ptr> %wide.gep12, i64 4
  ...
  %i.dt = fadd reassoc nsz arcp contract afn <8 x float> %wide.masked.gather24, %wide.masked.gather22
  %18 = fmul reassoc nsz arcp contract afn <8 x float> %i.dt, splat (float 2.500000e-01)
  %19 = fadd reassoc nsz arcp contract afn <8 x float> %wide.masked.gather26.a, %wide.masked.gather20
  %i.du = fmul reassoc nsz arcp contract afn <8 x float> %19, splat (float 6.250000e-02)
  %i.dv = fadd reassoc nsz arcp contract afn <8 x float> %18, %i.ds
  %20 = fadd reassoc nsz arcp contract afn <8 x float> %i.dv, %i.du ; 2 uses
  ...
  %i.dw = fmul reassoc nsz arcp contract afn <8 x float> %strided.vec15, splat (float 3.750000e-01)
  %wide.gep31 = getelementptr i8, <8 x ptr> %wide.gep11, i64 8
  %wide.masked.gather32 = tail call <8 x float> @llvm.masked.gather.v8f32.v8p0(<8 x ptr> align 4 %wide.gep31, <8 x i1> splat (i1 true), <8 x float> poison), !tbaa !16, !alias.scope !491, !noalias !494
  %wide.gep33.a = getelementptr i8, <8 x ptr> %wide.gep12, i64 8
  ...
  %i.dx = fadd reassoc nsz arcp contract afn <8 x float> %wide.masked.gather32, %wide.masked.gather30
  %21 = fmul reassoc nsz arcp contract afn <8 x float> %i.dx, splat (float 2.500000e-01)
  %22 = fadd reassoc nsz arcp contract afn <8 x float> %wide.masked.gather34.a, %wide.masked.gather28
  %i.dy = fmul reassoc nsz arcp contract afn <8 x float> %22, splat (float 6.250000e-02)
  %i.dz = fadd reassoc nsz arcp contract afn <8 x float> %21, %i.dw
  %23 = fadd reassoc nsz arcp contract afn <8 x float> %i.dz, %i.dy ; 2 uses
  ...
  %i.ea = fmul reassoc nsz arcp contract afn <8 x float> %strided.vec16, splat (float 3.750000e-01)
  %wide.gep39 = getelementptr i8, <8 x ptr> %wide.gep11, i64 12
  %wide.masked.gather40 = tail call <8 x float> @llvm.masked.gather.v8f32.v8p0(<8 x ptr> align 4 %wide.gep39, <8 x i1> splat (i1 true), <8 x float> poison), !tbaa !16, !alias.scope !491, !noalias !494
  %wide.gep41.a = getelementptr i8, <8 x ptr> %wide.gep12, i64 12
  ...
  %24 = fadd reassoc nsz arcp contract afn <8 x float> %wide.masked.gather40, %wide.masked.gather38
  %25 = fmul reassoc nsz arcp contract afn <8 x float> %24, splat (float 2.500000e-01)
  %26 = fadd reassoc nsz arcp contract afn <8 x float> %wide.masked.gather42.a, %wide.masked.gather36
  %27 = fmul reassoc nsz arcp contract afn <8 x float> %26, splat (float 6.250000e-02)
  %28 = fadd reassoc nsz arcp contract afn <8 x float> %25, %i.ea
  %i.eb = fadd reassoc nsz arcp contract afn <8 x float> %28, %27 ; 2 uses
  %i.ec = shufflevector <8 x float> %i.dr, <8 x float> %20, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %i.ed = fcmp reassoc nsz arcp contract afn olt <16 x float> %i.ec, zeroinitializer
  %i.ee = shufflevector <8 x float> %i.dr, <8 x float> %20, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %i.ef = select reassoc nsz arcp contract afn <16 x i1> %i.ed, <16 x float> zeroinitializer, <16 x float> %i.ee
  %i.eg = shufflevector <8 x float> %23, <8 x float> %i.eb, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %i.eh = fcmp reassoc nsz arcp contract afn olt <16 x float> %i.eg, zeroinitializer
  %i.ei = shufflevector <8 x float> %23, <8 x float> %i.eb, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %29 = load <4 x float>, ptr %i.fb, align 16, !tbaa !16, !alias.scope !491, !noalias !494
  %i.fg = load <4 x float>, ptr %i.fc, align 16, !tbaa !16, !alias.scope !491, !noalias !494
  %i.fh = fmul reassoc nsz arcp contract afn <4 x float> %i.fg, splat (float 3.750000e-01)
  %i.fi = load <4 x float>, ptr %i.fd, align 16, !tbaa !16, !alias.scope !491, !noalias !494
  %30 = load <4 x float>, ptr %i.fe, align 16, !tbaa !16, !alias.scope !491, !noalias !494
  %i.fj = fadd reassoc nsz arcp contract afn <4 x float> %i.fi, %29
  %i.fk = fmul reassoc nsz arcp contract afn <4 x float> %i.fj, splat (float 2.500000e-01)
  %i.fl = fadd reassoc nsz arcp contract afn <4 x float> %30, %i.ff
  %31 = fmul reassoc nsz arcp contract afn <4 x float> %i.fl, splat (float 6.250000e-02)
  %32 = fadd reassoc nsz arcp contract afn <4 x float> %i.fk, %i.fh
  %i.fm = fadd reassoc nsz arcp contract afn <4 x float> %32, %31 ; 2 uses
