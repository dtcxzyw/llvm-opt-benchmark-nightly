...
bb.b:                                             ; preds = %.loopexit.i, %bb.a
  ...
  %i.ae = xor i64 %indvars.iv147.i, -1
  %i.af = add nsw i64 %i.ae, %i.g                 ; 2 uses
  %i.ag = sub nsw i64 %i.r, %indvars.iv147.i      ; 2 uses
  %i.ah = shl nuw nsw i64 %indvars.iv.i, 3
  %scevgep27 = getelementptr i8, ptr %0, i64 %i.ah
  %i.ai = mul i64 %i.p, %indvars.iv147.i
  %i.aj = getelementptr i8, ptr %0, i64 %i.ai
  %scevgep31 = getelementptr i8, ptr %i.aj, i64 8
  %i.ak = mul i64 %i.q, %indvars.iv147.i
  %scevgep32 = getelementptr i8, ptr %i.s, i64 %i.ak
  %i.al = xor i64 %indvars.iv147.i, -1
  %i.am = add nsw i64 %i.al, %i.g                 ; 10 uses
  %i.an = mul i64 %i.i, %indvars.iv147.i          ; 3 uses
  %scevgep = getelementptr i8, ptr %i.t, i64 %i.an ; 2 uses
  %scevgep2 = getelementptr i8, ptr %i.u, i64 %i.an
  %i.ao = shl nuw nsw i64 %indvars.iv147.i, 3
  %scevgep3 = getelementptr i8, ptr %i.w, i64 %i.ao
  %i.ap = getelementptr i8, ptr %0, i64 %i.an
  %scevgep4 = getelementptr i8, ptr %i.ap, i64 8
  %i.aq = mul i64 %i.n, %indvars.iv147.i
  %scevgep5 = getelementptr i8, ptr %i.x, i64 %i.aq
  %indvars149.i = trunc i64 %indvars.iv147.i to i32 ; 4 uses
  %indvars.iv.next148.i = add nuw nsw i64 %indvars.iv147.i, 1 ; 3 uses
  %i.ar = icmp samesign ult i64 %indvars.iv.next148.i, %i.g ; 2 uses
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.preheader.i, %.lr.ph.i.prol
  ...
  %i.bb = trunc nuw nsw i64 %indvars.iv124.i.prol to i32
  %spec.select.i.prol = select i1 %i.ba, i32 %i.bb, i32 %.0100112.i.prol ; 3 uses
...
._crit_edge.i:                                    ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i, %bb.b
  ...
  %i.bd = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %indvars.iv147.i
  store i32 %.0100.lcssa.i, ptr %i.bd, align 4, !tbaa !14
  %i.be = mul nsw i32 %.0100.lcssa.i, %2
  %i.bf = sext i32 %i.be to i64                   ; 3 uses
  %i.bg = getelementptr [8 x i8], ptr %0, i64 %indvars.iv147.i ; 8 uses
  %i.bh = getelementptr [8 x i8], ptr %i.bg, i64 %i.bf ; 2 uses
  %i.bi = load double, ptr %i.bh, align 8, !tbaa !184 ; 7 uses
  %i.bj = mul nuw nsw i64 %indvars.iv147.i, %i.g  ; 2 uses
  %i.bk = mul nuw nsw i32 %2, %indvars149.i
  %i.bl = zext nneg i32 %i.bk to i64
  %i.bm = getelementptr inbounds nuw [8 x i8], ptr %i.bg, i64 %i.bl ; 2 uses
  %i.bn = load double, ptr %i.bm, align 8, !tbaa !184
  store double %i.bn, ptr %i.bh, align 8, !tbaa !184
  store double %i.bi, ptr %i.bm, align 8, !tbaa !184
  %i.bo = fcmp reassoc nsz arcp contract afn une double %i.bi, 0.000000e+00
  br i1 %i.bo, label %.preheader111.i, label %gauss_make_triangular.exit.thread

.preheader111.i:                                  ; preds = %._crit_edge.i
  br i1 %i.ar, label %.lr.ph115.i.preheader, label %.loopexit.i

.lr.ph115.i.preheader:                            ; preds = %.preheader111.i
  %xtraiter81 = and i64 %i.af, 3                  ; 2 uses
  %lcmp.mod82.not = icmp eq i64 %xtraiter81, 0
  br i1 %lcmp.mod82.not, label %.lr.ph115.i.prol.loopexit, label %.lr.ph115.i.prol.preheader
...
.lr.ph115.i.prol:                                 ; preds = %.lr.ph115.i.prol, %.lr.ph115.i.prol.preheader
  ...
  %prol.iter83 = phi i64 [ %prol.iter83.next, %.lr.ph115.i.prol ], [ 0, %.lr.ph115.i.prol.preheader ]
  %i.bq = mul nuw nsw i64 %indvars.iv127.i.prol, %i.g
  %gep156.i.prol = getelementptr inbounds nuw [8 x i8], ptr %i.bg, i64 %i.bq ; 2 uses
  %i.br = load double, ptr %gep156.i.prol, align 8, !tbaa !184
  %i.bs = fneg reassoc nsz arcp contract afn double %i.br
  %i.bt = fmul reassoc nsz arcp contract afn double %i.bs, %i.bp
  store double %i.bt, ptr %gep156.i.prol, align 8, !tbaa !184
  ...
  br i1 %prol.iter83.cmp.not, label %.lr.ph115.i.prol.loopexit, label %.lr.ph115.i.prol, !llvm.loop !499
...
.lr.ph115.i.prol.loopexit:                        ; preds = %.lr.ph115.i.prol, %.lr.ph115.i.preheader
  ...
  %i.bu = icmp ult i64 %i.ag, 3
  br i1 %i.bu, label %._crit_edge116.i, label %.lr.ph115.i.preheader.new
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  %i.ci = trunc nuw nsw i64 %indvars.iv124.i to i32
  %spec.select.i = select i1 %i.ch, i32 %i.ci, i32 %.0100112.i ; 2 uses
  %indvars.iv.next125.i = add nuw nsw i64 %indvars.iv124.i, 1 ; 2 uses
  %i.cj = mul nuw nsw i64 %indvars.iv.next125.i, %i.g
  %gep.i.1 = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep.i, i64 %i.cj
  %i.ck = load double, ptr %gep.i.1, align 8, !tbaa !184
  %i.cl = tail call reassoc nsz arcp contract afn double @llvm.fabs.f64(double %i.ck)
  %i.cm = mul nsw i32 %spec.select.i, %2
  %i.cn = sext i32 %i.cm to i64
  %i.co = getelementptr [8 x i8], ptr %invariant.gep.i, i64 %i.cn
  %i.cp = load double, ptr %i.co, align 8, !tbaa !184
  ...
  %i.dc = trunc nuw nsw i64 %indvars.iv.next125.i.1 to i32
  %spec.select.i.2 = select i1 %i.db, i32 %i.dc, i32 %spec.select.i.1 ; 2 uses
  %indvars.iv.next125.i.2 = add nuw nsw i64 %indvars.iv124.i, 3 ; 2 uses
  %i.dd = mul nuw nsw i64 %indvars.iv.next125.i.2, %i.g
  %gep.i.3 = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep.i, i64 %i.dd
  %i.de = load double, ptr %gep.i.3, align 8, !tbaa !184
  %i.df = tail call reassoc nsz arcp contract afn double @llvm.fabs.f64(double %i.de)
  %i.dg = mul nsw i32 %spec.select.i.2, %2
  %i.dh = sext i32 %i.dg to i64
  %i.di = getelementptr [8 x i8], ptr %invariant.gep.i, i64 %i.dh
  %i.dj = load double, ptr %i.di, align 8, !tbaa !184
  ...
  %i.dm = trunc nuw nsw i64 %indvars.iv.next125.i.2 to i32
  %spec.select.i.3 = select i1 %i.dl, i32 %i.dm, i32 %spec.select.i.2 ; 2 uses
...
._crit_edge116.i:                                 ; preds = %.lr.ph115.i, %.lr.ph115.i.prol.loopexit
  ...
  %.not.not.i = icmp eq i64 %indvars.iv147.i, %i.dn
  br i1 %.not.not.i, label %.preheader.preheader.i, label %.lr.ph118.preheader.i

.lr.ph118.preheader.i:                            ; preds = %._crit_edge116.i
  %invariant.gep157.i = getelementptr [8 x i8], ptr %0, i64 %i.bf ; 6 uses
  %invariant.gep159.i = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %i.bj ; 6 uses
  %min.iters.check36 = icmp ult i64 %i.am, 8
...
vector.body39:                                    ; preds = %vector.body39, %vector.ph37
  ...
  %i.dr = getelementptr [8 x i8], ptr %invariant.gep157.i, i64 %i.dq ; 3 uses
  %i.ds = getelementptr i8, ptr %i.dr, i64 32     ; 2 uses
end_hunk_0
begin_hunk_1_@gauss_solve:bb.a
  %invariant.gep161.i = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %i.bj ; 7 uses
  ...
  %min.iters.check9 = icmp ult i64 %i.am, 16
  %i.ez = and i64 %i.am, 12
  ...
  %n.vec17 = and i64 %i.am, -4                    ; 3 uses
  %i.fb = add i64 %indvars.iv.i, %n.vec17
  %cmp.n24 = icmp eq i64 %i.am, %n.vec17
  br label %iter.check
...
iter.check:                                       ; preds = %._crit_edge121.i, %.preheader.preheader.i
  ...
  %i.fc = mul nuw nsw i64 %indvars.iv142.i, %i.g  ; 2 uses
  %gep166.i = getelementptr inbounds nuw [8 x i8], ptr %i.bg, i64 %i.fc ; 7 uses
  %invariant.gep163.i = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %i.fc ; 7 uses
...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  %i.fd = load double, ptr %gep166.i, align 8, !tbaa !184, !alias.scope !522
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ff = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep161.i, i64 %i.fe ; 4 uses
  ...
  %wide.load = load <4 x double>, ptr %i.ff, align 8, !tbaa !184, !alias.scope !523
  %wide.load10 = load <4 x double>, ptr %i.fg, align 8, !tbaa !184, !alias.scope !523
  %wide.load11 = load <4 x double>, ptr %i.fh, align 8, !tbaa !184, !alias.scope !523
  %wide.load12 = load <4 x double>, ptr %i.fi, align 8, !tbaa !184, !alias.scope !523
  ...
  %i.fn = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep163.i, i64 %i.fe ; 5 uses
  ...
  %wide.load13 = load <4 x double>, ptr %i.fn, align 8, !tbaa !184, !alias.scope !524, !noalias !525
  %wide.load14 = load <4 x double>, ptr %i.fo, align 8, !tbaa !184, !alias.scope !524, !noalias !525
  %wide.load15 = load <4 x double>, ptr %i.fp, align 8, !tbaa !184, !alias.scope !524, !noalias !525
  %wide.load16 = load <4 x double>, ptr %i.fq, align 8, !tbaa !184, !alias.scope !524, !noalias !525
  ...
  store <4 x double> %i.fr, ptr %i.fn, align 8, !tbaa !184, !alias.scope !524, !noalias !525
  ...
  br i1 %i.fv, label %middle.block, label %vector.body, !llvm.loop !510
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %i.fw = load double, ptr %gep166.i, align 8, !tbaa !184, !alias.scope !522
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.fy = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep161.i, i64 %i.fx
  %wide.load19 = load <4 x double>, ptr %i.fy, align 8, !tbaa !184, !alias.scope !523
  %i.fz = fmul reassoc nsz arcp contract afn <4 x double> %wide.load19, %broadcast.splat21
  %i.ga = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep163.i, i64 %i.fx ; 2 uses
  %wide.load22 = load <4 x double>, ptr %i.ga, align 8, !tbaa !184, !alias.scope !524, !noalias !525
  %i.gb = fadd reassoc nsz arcp contract afn <4 x double> %wide.load22, %i.fz
  store <4 x double> %i.gb, ptr %i.ga, align 8, !tbaa !184, !alias.scope !524, !noalias !525
  %index.next23 = add nuw i64 %index18, 4         ; 2 uses
  %i.gc = icmp eq i64 %index.next23, %n.vec17
  br i1 %i.gc, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !511

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  br i1 %cmp.n24, label %._crit_edge121.i, label %vec.epilog.scalar.ph.preheader

vec.epilog.scalar.ph.preheader:                   ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv137.i.ph = phi i64 [ %indvars.iv.i, %iter.check ], [ %i.fb, %vec.epilog.middle.block ], [ %i.fa, %vec.epilog.iter.check ] ; 4 uses
  %i.gd = sub i64 %i.g, %indvars.iv137.i.ph
  %xtraiter87 = and i64 %i.gd, 3                  ; 2 uses
...
vec.epilog.scalar.ph.prol:                        ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph.prol
  ...
  %i.ge = load double, ptr %gep166.i, align 8, !tbaa !184
  %gep162.i.prol = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep161.i, i64 %indvars.iv137.i.prol
  %i.gf = load double, ptr %gep162.i.prol, align 8, !tbaa !184
  ...
  %i.gh = load double, ptr %gep164.i.prol, align 8, !tbaa !184
  %i.gi = fadd reassoc nsz arcp contract afn double %i.gh, %i.gg
  store double %i.gi, ptr %gep164.i.prol, align 8, !tbaa !184
  ...
  br i1 %prol.iter89.cmp.not, label %vec.epilog.scalar.ph.prol.loopexit, label %vec.epilog.scalar.ph.prol, !llvm.loop !512
...
vec.epilog.scalar.ph.prol.loopexit:               ; preds = %vec.epilog.scalar.ph.prol, %vec.epilog.scalar.ph.preheader
  ...
  %i.gj = sub i64 %indvars.iv137.i.ph, %i.g
  %i.gk = icmp ugt i64 %i.gj, -4
  br i1 %i.gk, label %._crit_edge121.i, label %vec.epilog.scalar.ph
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph
  ...
  %i.gl = load double, ptr %gep166.i, align 8, !tbaa !184
  %gep162.i = getelementptr inbounds nuw [8 x i8], ptr %invariant.gep161.i, i64 %indvars.iv137.i
  %i.gm = load double, ptr %gep162.i, align 8, !tbaa !184
  ...
  %i.hd = load double, ptr %gep164.i.3, align 8, !tbaa !184
  %i.he = fadd reassoc nsz arcp contract afn double %i.hd, %i.hc
  store double %i.he, ptr %gep164.i.3, align 8, !tbaa !184
...
.lr.ph58.i:                                       ; preds = %.loopexit.i15
  ...
  %i.hj = load double, ptr %i.hi, align 8, !tbaa !184
  %i.hk = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %i.e ; 2 uses
  %i.hl = load double, ptr %i.hk, align 8, !tbaa !184
  %i.hm = fdiv reassoc nsz arcp contract afn double %i.hl, %i.hj ; 6 uses
  store double %i.hm, ptr %i.hk, align 8, !tbaa !184
...
.lr.ph.preheader.i9:                              ; preds = %.lr.ph.preheader.i9.preheader, %.loopexit.i15
  ...
  %i.ho = load i32, ptr %i.hn, align 4, !tbaa !14
  %i.hp = sext i32 %i.ho to i64
  %i.hq = getelementptr inbounds [8 x i8], ptr %1, i64 %i.hp ; 2 uses
  %i.hr = load double, ptr %i.hq, align 8, !tbaa !184 ; 7 uses
  %i.hs = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv63.i ; 2 uses
  %i.ht = load double, ptr %i.hs, align 8, !tbaa !184
  store double %i.ht, ptr %i.hq, align 8, !tbaa !184
  store double %i.hr, ptr %i.hs, align 8, !tbaa !184
  %invariant.gep.i11 = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %indvars.iv63.i ; 6 uses
  %i.hu = xor i64 %indvars.iv63.i, -1
  %i.hv = add nsw i64 %i.hu, %i.g                 ; 3 uses
  %min.iters.check58 = icmp ult i64 %i.hv, 4
  br i1 %min.iters.check58, label %.lr.ph.i12.preheader, label %vector.memcheck48

vector.memcheck48:                                ; preds = %.lr.ph.preheader.i9
  %i.hw = shl nuw nsw i64 %indvars.iv63.i, 3
  %scevgep51 = getelementptr i8, ptr %i.ac, i64 %i.hw ; 4 uses
  %i.hx = mul i64 %i.ab, %indvars.iv63.i
  %scevgep52 = getelementptr i8, ptr %i.ad, i64 %i.hx ; 4 uses
  %i.hy = icmp ugt ptr %scevgep51, %scevgep52
  %umax = select i1 %i.hy, ptr %scevgep51, ptr %scevgep52
  %scevgep53 = getelementptr i8, ptr %umax, i64 8
  %i.hz = icmp ult ptr %scevgep51, %scevgep52
  %umin = select i1 %i.hz, ptr %scevgep51, ptr %scevgep52
...
vector.ph59:                                      ; preds = %vector.memcheck48
  ...
  %wide.load68 = load <4 x double>, ptr %i.id, align 8, !tbaa !184, !alias.scope !528, !noalias !527
  %i.ie = fadd reassoc nsz arcp contract afn <4 x double> %wide.load68, %i.ic
  store <4 x double> %i.ie, ptr %i.id, align 8, !tbaa !184, !alias.scope !528, !noalias !527
  %cmp.n70 = icmp eq i64 %i.hv, %n.vec60
...
.lr.ph.i12.prol:                                  ; preds = %.lr.ph.i12.preheader, %.lr.ph.i12.prol
  ...
  %i.ih = load double, ptr %gep.i13.prol, align 8, !tbaa !184
  %i.ii = fmul reassoc nsz arcp contract afn double %i.ih, %i.hr
  %i.ij = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv60.i.prol ; 2 uses
  %i.ik = load double, ptr %i.ij, align 8, !tbaa !184
  %i.il = fadd reassoc nsz arcp contract afn double %i.ik, %i.ii
  store double %i.il, ptr %i.ij, align 8, !tbaa !184
  ...
  br i1 %prol.iter92.cmp.not, label %.lr.ph.i12.prol.loopexit, label %.lr.ph.i12.prol, !llvm.loop !517
...
.lr.ph.i12:                                       ; preds = %.lr.ph.i12.prol.loopexit, %.lr.ph.i12
  ...
  %i.ip = load double, ptr %gep.i13, align 8, !tbaa !184
  %i.iq = fmul reassoc nsz arcp contract afn double %i.ip, %i.hr
  %i.ir = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv60.i ; 2 uses
  %i.is = load double, ptr %i.ir, align 8, !tbaa !184
  %i.it = fadd reassoc nsz arcp contract afn double %i.is, %i.iq
  store double %i.it, ptr %i.ir, align 8, !tbaa !184
  ...
  %i.iv = load double, ptr %gep.i13.1, align 8, !tbaa !184
  %i.iw = fmul reassoc nsz arcp contract afn double %i.iv, %i.hr
  %i.ix = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv.next61.i ; 2 uses
  %i.iy = load double, ptr %i.ix, align 8, !tbaa !184
  %i.iz = fadd reassoc nsz arcp contract afn double %i.iy, %i.iw
  store double %i.iz, ptr %i.ix, align 8, !tbaa !184
  ...
  %i.jb = load double, ptr %gep.i13.2, align 8, !tbaa !184
  %i.jc = fmul reassoc nsz arcp contract afn double %i.jb, %i.hr
  %i.jd = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv.next61.i.1 ; 2 uses
  %i.je = load double, ptr %i.jd, align 8, !tbaa !184
  %i.jf = fadd reassoc nsz arcp contract afn double %i.je, %i.jc
  store double %i.jf, ptr %i.jd, align 8, !tbaa !184
  ...
  %i.jh = load double, ptr %gep.i13.3, align 8, !tbaa !184
  %i.ji = fmul reassoc nsz arcp contract afn double %i.jh, %i.hr
  %i.jj = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv.next61.i.2 ; 2 uses
  %i.jk = load double, ptr %i.jj, align 8, !tbaa !184
  %i.jl = fadd reassoc nsz arcp contract afn double %i.jk, %i.ji
  store double %i.jl, ptr %i.jj, align 8, !tbaa !184
...
bb.c:                                             ; preds = %bb.c, %.epil.preheader
  ...
  %i.jn = load double, ptr %gep77.i.epil, align 8, !tbaa !184
  %i.jo = fmul reassoc nsz arcp contract afn double %i.jn, %i.hm
  %i.jp = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv68.i.epil ; 2 uses
  %i.jq = load double, ptr %i.jp, align 8, !tbaa !184
  %i.jr = fsub reassoc nsz arcp contract afn double %i.jq, %i.jo
  store double %i.jr, ptr %i.jp, align 8, !tbaa !184
...
bb.d:                                             ; preds = %bb.d, %.epilog-lcssa
  ...
  %i.jz = load double, ptr %gep77.i.epil.1, align 8, !tbaa !184
  ...
  %i.kc = load double, ptr %i.kb, align 8, !tbaa !184
  %i.kd = fsub reassoc nsz arcp contract afn double %i.kc, %i.ka
  store double %i.kd, ptr %i.kb, align 8, !tbaa !184
...
bb.e:                                             ; preds = %bb.e, %.epilog-lcssa.1
  ...
  %i.kl = load double, ptr %gep77.i.epil.2, align 8, !tbaa !184
  ...
  %i.ko = load double, ptr %i.kn, align 8, !tbaa !184
  %i.kp = fsub reassoc nsz arcp contract afn double %i.ko, %i.km
  store double %i.kp, ptr %i.kn, align 8, !tbaa !184
...
.epilog-lcssa.2:                                  ; preds = %bb.e
  ...
  br i1 %.not103, label %gauss_solve_triangular.exit, label %bb.f

bb.f:                                             ; preds = %.epilog-lcssa.2
  %i.kq = mul nuw nsw i64 %indvars.iv.next74.i.2, %i.hg
  %i.kr = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %i.kq
  %i.ks = load double, ptr %i.kr, align 8, !tbaa !184
  %i.kt = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv.next74.i.2 ; 2 uses
  %i.ku = load double, ptr %i.kt, align 8, !tbaa !184
  %i.kv = fdiv reassoc nsz arcp contract afn double %i.ku, %i.ks ; 6 uses
  store double %i.kv, ptr %i.kt, align 8, !tbaa !184
  %invariant.gep76.i.3 = getelementptr [8 x i8], ptr %0, i64 %indvars.iv.next74.i.2 ; 5 uses
  %xtraiter93.3 = and i64 %indvars.iv.next74.i.2, 3 ; 3 uses
  %i.kw = add nsw i32 %2, -5
  %i.kx = icmp ult i32 %i.kw, 3
  br i1 %i.kx, label %.epil.preheader.3, label %.new.3
end_hunk_1
