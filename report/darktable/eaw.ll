...
bb.i:                                             ; preds = %bb.g, %bb.i
  ...
  %i.ei = getelementptr [4 x i8], ptr @eaw_dn_decompose.filter, i64 %.0192277
  ...
  %i.fn = getelementptr [4 x i8], ptr @eaw_dn_decompose.filter, i64 %.0192277
  ...
  %i.gs = getelementptr [4 x i8], ptr @eaw_dn_decompose.filter, i64 %.0192277
  ...
  %i.hx = getelementptr [4 x i8], ptr @eaw_dn_decompose.filter, i64 %.0192277
...
.preheader:                                       ; preds = %bb.j, %.preheader
  ...
  %.0201285 = phi i64 [ 0, %bb.j ], [ %i.pu, %.preheader ]
  %.0202284 = phi i64 [ 0, %bb.j ], [ %9, %.preheader ] ; 6 uses
  ...
  %i.kw = getelementptr [4 x i8], ptr @eaw_dn_decompose.filter, i64 %.0202284
  ...
  %i.mc = getelementptr [4 x i8], ptr @eaw_dn_decompose.filter, i64 %.0202284
  ...
  %i.ni = getelementptr [4 x i8], ptr @eaw_dn_decompose.filter, i64 %.0202284
  %i.nj = getelementptr i8, ptr %i.ni, i64 12
  ...
  %i.oo = getelementptr [4 x i8], ptr @eaw_dn_decompose.filter, i64 %.0202284
  ...
  %i.pu = add nuw nsw i64 %.0201285, 1            ; 2 uses
  %exitcond317.not = icmp eq i64 %i.pu, 5
...
bb.n:                                             ; preds = %bb.l, %bb.n
  ...
  %i.tp = getelementptr [4 x i8], ptr @eaw_dn_decompose.filter, i64 %.0195296
  ...
  %i.uu = getelementptr [4 x i8], ptr @eaw_dn_decompose.filter, i64 %.0195296
  ...
  %i.vz = getelementptr [4 x i8], ptr @eaw_dn_decompose.filter, i64 %.0195296
  ...
  %i.xe = getelementptr [4 x i8], ptr @eaw_dn_decompose.filter, i64 %.0195296
