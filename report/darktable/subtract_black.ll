...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %1 = shufflevector <8 x i32> %i.ef, <8 x i32> %i.er, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %i.es = sub nsw <8 x i32> %i.eo, %broadcast.splat137 ; 2 uses
  %2 = shufflevector <8 x i32> %i.eg, <8 x i32> %i.es, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %i.et = sub nsw <8 x i32> %i.ep, %broadcast.splat137 ; 2 uses
  %3 = shufflevector <8 x i32> %i.eh, <8 x i32> %i.et, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %i.eu = sub nsw <8 x i32> %i.eq, %broadcast.splat137 ; 2 uses
  %4 = shufflevector <8 x i32> %i.ei, <8 x i32> %i.eu, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %5 = tail call <16 x i32> @llvm.smax.v16i32(<16 x i32> %1, <16 x i32> zeroinitializer)
  %6 = tail call <16 x i32> @llvm.smax.v16i32(<16 x i32> %2, <16 x i32> zeroinitializer)
  %7 = tail call <16 x i32> @llvm.smax.v16i32(<16 x i32> %3, <16 x i32> zeroinitializer)
  %8 = tail call <16 x i32> @llvm.smax.v16i32(<16 x i32> %4, <16 x i32> zeroinitializer)
  ...
  %i.fp = sub nsw <8 x i32> %i.fl, %broadcast.splat141 ; 2 uses
  %9 = shufflevector <8 x i32> %i.fd, <8 x i32> %i.fp, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %i.fq = sub nsw <8 x i32> %i.fm, %broadcast.splat141 ; 2 uses
  %i.fr = shufflevector <8 x i32> %i.fe, <8 x i32> %i.fq, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %10 = sub nsw <8 x i32> %i.fn, %broadcast.splat141 ; 2 uses
  %11 = shufflevector <8 x i32> %i.ff, <8 x i32> %10, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %12 = sub nsw <8 x i32> %i.fo, %broadcast.splat141 ; 2 uses
  %i.fs = shufflevector <8 x i32> %i.fg, <8 x i32> %12, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %i.ft = tail call <16 x i32> @llvm.smax.v16i32(<16 x i32> %9, <16 x i32> zeroinitializer)
  %i.fu = tail call <16 x i32> @llvm.smax.v16i32(<16 x i32> %i.fr, <16 x i32> zeroinitializer)
  %13 = tail call <16 x i32> @llvm.smax.v16i32(<16 x i32> %11, <16 x i32> zeroinitializer)
  %i.fv = tail call <16 x i32> @llvm.smax.v16i32(<16 x i32> %i.fs, <16 x i32> zeroinitializer)
  %i.fw = tail call <16 x i32> @llvm.umin.v16i32(<16 x i32> %5, <16 x i32> splat (i32 65535))
  %i.fx = trunc nuw <16 x i32> %i.fw to <16 x i16>
  %i.fy = tail call <16 x i32> @llvm.umin.v16i32(<16 x i32> %i.ft, <16 x i32> splat (i32 65535))
  ...
  store <32 x i16> %interleaved.vec163.a, ptr %i.du, align 2, !tbaa !96
  %14 = tail call <16 x i32> @llvm.umin.v16i32(<16 x i32> %6, <16 x i32> splat (i32 65535))
  %15 = trunc nuw <16 x i32> %14 to <16 x i16>
  %i.ga = tail call <16 x i32> @llvm.umin.v16i32(<16 x i32> %i.fu, <16 x i32> splat (i32 65535))
  %i.gb = trunc nuw <16 x i32> %i.ga to <16 x i16>
  %interleaved.vec163 = shufflevector <16 x i16> %15, <16 x i16> %i.gb, <32 x i32> <i32 0, i32 8, i32 16, i32 24, i32 1, i32 9, i32 17, i32 25, i32 2, i32 10, i32 18, i32 26, i32 3, i32 11, i32 19, i32 27, i32 4, i32 12, i32 20, i32 28, i32 5, i32 13, i32 21, i32 29, i32 6, i32 14, i32 22, i32 30, i32 7, i32 15, i32 23, i32 31>
  store <32 x i16> %interleaved.vec163, ptr %i.dw, align 2, !tbaa !96
  %i.gc = tail call <16 x i32> @llvm.umin.v16i32(<16 x i32> %7, <16 x i32> splat (i32 65535))
  %i.gd = trunc nuw <16 x i32> %i.gc to <16 x i16>
  %16 = tail call <16 x i32> @llvm.umin.v16i32(<16 x i32> %13, <16 x i32> splat (i32 65535))
  %17 = trunc nuw <16 x i32> %16 to <16 x i16>
  %interleaved.vec164 = shufflevector <16 x i16> %i.gd, <16 x i16> %17, <32 x i32> <i32 0, i32 8, i32 16, i32 24, i32 1, i32 9, i32 17, i32 25, i32 2, i32 10, i32 18, i32 26, i32 3, i32 11, i32 19, i32 27, i32 4, i32 12, i32 20, i32 28, i32 5, i32 13, i32 21, i32 29, i32 6, i32 14, i32 22, i32 30, i32 7, i32 15, i32 23, i32 31>
  store <32 x i16> %interleaved.vec164, ptr %i.dy, align 2, !tbaa !96
  %i.ge = tail call <16 x i32> @llvm.umin.v16i32(<16 x i32> %8, <16 x i32> splat (i32 65535))
  %i.gf = trunc nuw <16 x i32> %i.ge to <16 x i16>
  %i.gg = tail call <16 x i32> @llvm.umin.v16i32(<16 x i32> %i.fv, <16 x i32> splat (i32 65535))
  ...
  %i.gi = tail call <8 x i32> @llvm.smax.v8i32(<8 x i32> %i.fh, <8 x i32> %i.fp) ; 2 uses
  %i.gj = tail call <8 x i32> @llvm.smax.v8i32(<8 x i32> %i.fi, <8 x i32> %i.fq) ; 2 uses
  %i.gk = tail call <8 x i32> @llvm.smax.v8i32(<8 x i32> %i.fj, <8 x i32> %10) ; 2 uses
  %i.gl = tail call <8 x i32> @llvm.smax.v8i32(<8 x i32> %i.fk, <8 x i32> %12) ; 2 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %18 = shufflevector <8 x i32> %i.gq, <8 x i32> %i.gt, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  ...
  %i.ha = shufflevector <8 x i32> %i.gw, <8 x i32> %i.gz, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %i.hb = tail call <16 x i32> @llvm.smax.v16i32(<16 x i32> %i.ha, <16 x i32> zeroinitializer)
  %i.hc = tail call <16 x i32> @llvm.umin.v16i32(<16 x i32> %19, <16 x i32> splat (i32 65535))
  %i.hd = trunc nuw <16 x i32> %i.hc to <16 x i16>
  %i.he = tail call <16 x i32> @llvm.umin.v16i32(<16 x i32> %i.hb, <16 x i32> splat (i32 65535))
