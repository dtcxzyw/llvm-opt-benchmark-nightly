...
.preheader71:                                     ; preds = %.preheader74.us.preheader, %bb.a
  ...
  %i.az = insertelement <2 x double> poison, double %.sroa.93.0, i64 0
  %i.ba = shufflevector <2 x double> %i.az, <2 x double> poison, <2 x i32> zeroinitializer
  %i.bb = fmul reassoc nsz arcp contract afn <2 x double> %i.at, %i.ba
  %i.bc = fneg reassoc nsz arcp contract afn double %.sroa.93.0
  %i.bd = extractelement <2 x double> %i.au, i64 0 ; 3 uses
  %i.be = fmul reassoc nsz arcp contract afn double %i.bd, %i.bc ; 2 uses
  %i.bf = insertelement <2 x double> <double poison, double 1.000000e+00>, double %.sroa.126.0, i64 0
  %i.bg = fsub reassoc nsz arcp contract afn <2 x double> %i.bf, %i.bb ; 2 uses
  %i.bh = fneg reassoc nsz arcp contract afn double %.sroa.93.0
  %i.bi = fmul reassoc nsz arcp contract afn double %i.aw, %i.bh ; 2 uses
  %i.bj = fmul reassoc nsz arcp contract afn double %i.av, %.sroa.184.0
  %i.bk = fsub reassoc nsz arcp contract afn double %.sroa.200.0, %i.bj ; 4 uses
  %i.bl = extractelement <2 x double> %i.at, i64 0 ; 2 uses
  %i.bm = fmul reassoc nsz arcp contract afn double %i.bl, %.sroa.184.0
  %i.bn = fneg reassoc nsz arcp contract afn double %.sroa.184.0
  %i.bo = fmul reassoc nsz arcp contract afn double %i.bd, %i.bn
  %i.bp = fmul reassoc nsz arcp contract afn double %i.aw, %.sroa.184.0 ; 2 uses
  %i.bq = tail call reassoc nsz arcp contract afn double @llvm.fabs.f64(double %i.ay)
  %i.br = fcmp reassoc nsz arcp contract afn ogt double %i.bq, f0x3EE4F8B580000000 ; 3 uses
  %i.bs = fdiv reassoc nsz arcp contract afn double %i.be, %i.ay
  ...
  %i.bv = fdiv reassoc nsz arcp contract afn <2 x double> %i.bg, %i.bu
  %i.bw = fdiv reassoc nsz arcp contract afn double %i.bi, %i.ay
  %.sroa.170.2 = select nsz i1 %i.br, double %i.bw, double %i.bi ; 3 uses
  %.sroa.142.2 = select nsz i1 %i.br, double %i.bs, double %i.be ; 3 uses
  %i.bx = select i1 %i.br, <2 x double> %i.bv, <2 x double> %i.bg ; 2 uses
  %i.by = extractelement <2 x double> %i.bx, i64 0 ; 5 uses
  %i.bz = fmul reassoc nsz arcp contract afn double %i.by, %i.av
  %i.ca = fsub reassoc nsz arcp contract afn double %i.bl, %i.bz ; 3 uses
  %i.cb = fmul reassoc nsz arcp contract afn double %.sroa.142.2, %i.av
  %i.cc = extractelement <2 x double> %i.bx, i64 1 ; 3 uses
  %i.cd = fmul reassoc nsz arcp contract afn double %i.cc, %i.av
  %i.ce = fmul reassoc nsz arcp contract afn double %.sroa.170.2, %i.av
  %i.cf = fmul reassoc nsz arcp contract afn double %i.by, %i.bk
  %i.cg = fadd reassoc nsz arcp contract afn double %i.bm, %i.cf
end_hunk_0
