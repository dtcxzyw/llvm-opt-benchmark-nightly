...
bb.h:                                             ; preds = %gamut_check_Yrg.exit
  ...
  %i.ul = fmul reassoc nnan nsz arcp contract afn float %i.uk, f0x4196D000
  %i.um = fadd reassoc nsz arcp contract afn float %i.ul, f0x3F560000
  %i.un = fmul reassoc nnan nsz arcp contract afn float %i.uk, 1.868750e+01
...
.thread.i:                                        ; preds = %bb.w, %bb.v
  ...
  %i.akh = fmul reassoc nnan nsz arcp contract afn float %i.akg, f0x417EED8B
...
bb.ae:                                            ; preds = %.preheader252, %bb.ae
  ...
  %i.us = fmul reassoc nnan nsz arcp contract afn float %i.ur, f0x4196D000
  %i.ut = fadd reassoc nsz arcp contract afn float %i.us, f0x3F560000
  %i.uu = fmul reassoc nnan nsz arcp contract afn float %i.ur, 1.868750e+01
  ...
  %i.vn = fmul reassoc nnan nsz arcp contract afn <2 x float> %i.vm, splat (float f0x4196D000)
  %i.vo = fadd reassoc nsz arcp contract afn <2 x float> %i.vn, splat (float f0x3F560000)
  %i.vp = fmul reassoc nnan nsz arcp contract afn <2 x float> %i.vm, splat (float 1.868750e+01)
