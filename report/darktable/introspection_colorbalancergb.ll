...
.preheader253.preheader:                          ; preds = %bb.aa, %bb.ab
  ...
  %i.qg = extractelement <4 x float> %i.pu, i64 2
  %4 = shufflevector <4 x float> <float poison, float f0x3EAE147A, float poison, float poison>, <4 x float> %i.pu, <2 x i32> <i32 5, i32 1>
...
.preheader252:                                    ; preds = %.preheader253, %bb.ad
  ...
  %5 = insertelement <2 x float> poison, float %i.tw, i64 0
  br label %bb.ae
...
bb.ae:                                            ; preds = %.preheader252, %bb.ae
  ...
  %i.ub = fmul reassoc nsz arcp contract afn float %i.ua, %i.qg
  ...
  %6 = insertelement <2 x float> poison, float %i.ua, i64 0
  %7 = insertelement <2 x float> %6, float %i.uc, i64 1
  %8 = fmul reassoc nsz arcp contract afn <2 x float> %7, %4
  %9 = insertelement <2 x float> %5, float %i.ug, i64 1
  %10 = fadd reassoc nsz arcp contract afn <2 x float> %9, %8 ; 4 uses
  %11 = extractelement <2 x float> %10, i64 0     ; 2 uses
  %i.uh = fmul reassoc nsz arcp contract afn float %11, f0x3E199998
  ...
  %.reass = fmul reassoc nsz arcp contract afn float %12, f0x387344EC
  %.reass258 = fmul reassoc nsz arcp contract afn float %11, 1.464800e-06
  ...
  %i.uo = fmul reassoc nsz arcp contract afn <2 x float> %13, <float f0x38EB0462, float 2.648000e-05>
  %i.up = shufflevector <2 x float> %10, <2 x float> poison, <2 x i32> zeroinitializer
