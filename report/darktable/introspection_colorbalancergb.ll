...
dt_ioppr_rgb_matrix_to_xyz.exit:                  ; preds = %bb.c, %bb.d
  %.sroa.010.0 = phi nsz float [ %i.bh, %bb.d ], [ %i.ab, %bb.c ] ; 2 uses
  %i.bw = phi <2 x float> [ %i.bv, %bb.d ], [ %i.ap, %bb.c ] ; 4 uses
  %i.bx = extractelement <2 x float> %i.bw, i64 0
  %i.by = extractelement <2 x float> %i.bw, i64 1
  %i.bz = fmul reassoc nsz arcp contract afn float %.sroa.010.0, 4.039210e-04
  %4 = fmul reassoc nsz arcp contract afn float %i.bx, f0x3C7704B2
  %5 = fsub reassoc nsz arcp contract afn float %4, %i.bz
  %i.ca = fmul reassoc nsz arcp contract afn float %i.by, f0x3FA6AB48
  %6 = fadd reassoc nsz arcp contract afn float %5, %i.ca
  %7 = shufflevector <2 x float> %i.bw, <2 x float> poison, <3 x i32> zeroinitializer ; 2 uses
  %8 = insertelement <3 x float> %7, float %.sroa.010.0, i64 1 ; 2 uses
  %9 = fmul reassoc nsz arcp contract afn <3 x float> %8, <float f0x3D23F6FB, float f0x3BB11DFF, float f0x3D23F6FB>
  %10 = shufflevector <3 x float> %7, <3 x float> %8, <3 x i32> <i32 4, i32 1, i32 4>
  %11 = fmul reassoc nsz arcp contract afn <3 x float> %10, <float f0x3F7D4DA9, float f0x3F80DA42, float f0x3F7D4DA9>
  %12 = fsub reassoc nsz arcp contract afn <3 x float> %11, %9
  %13 = shufflevector <2 x float> %i.bw, <2 x float> poison, <3 x i32> <i32 1, i32 1, i32 1>
  %14 = fmul reassoc nsz arcp contract afn <3 x float> %13, <float f0x3D3470F4, float f0xBAE61976, float f0x3D3470F4>
  %15 = fadd reassoc nsz arcp contract afn <3 x float> %12, %14 ; 2 uses
  %16 = fmul reassoc nsz arcp contract afn <3 x float> %15, <float 2.570850e-01, float 1.175800e+00, float 6.485600e-02> ; 2 uses
  %17 = shufflevector <3 x float> %15, <3 x float> poison, <3 x i32> <i32 1, i32 0, i32 1>
  %18 = fmul reassoc nsz arcp contract afn <3 x float> %17, <float f0x3F5C2539, float 3.944270e-01, float 7.625000e-02> ; 2 uses
  %19 = fadd reassoc nsz arcp contract afn <3 x float> %16, %18
  %20 = fsub reassoc nsz arcp contract afn <3 x float> %16, %18
  %21 = shufflevector <3 x float> %19, <3 x float> %20, <3 x i32> <i32 0, i32 4, i32 5>
  %22 = insertelement <3 x float> poison, float %6, i64 0
  %23 = shufflevector <3 x float> %22, <3 x float> poison, <3 x i32> zeroinitializer
  %24 = fmul reassoc nsz arcp contract afn <3 x float> %23, <float -3.106100e-02, float 1.064230e-01, float 5.590670e-01>
  %25 = fadd reassoc nsz arcp contract afn <3 x float> %21, %24 ; 4 uses
  %26 = extractelement <3 x float> %25, i64 0     ; 2 uses
  %27 = extractelement <3 x float> %25, i64 1     ; 2 uses
  %i.cb = fadd reassoc nsz arcp contract afn float %27, %26
  %28 = extractelement <3 x float> %25, i64 2
  %i.cc = fadd reassoc nsz arcp contract afn float %i.cb, %28 ; 2 uses
  %i.cd = fcmp reassoc nsz arcp contract afn oeq float %i.cc, 0.000000e+00
  %29 = insertelement <3 x float> poison, float %i.cc, i64 0
  %30 = shufflevector <3 x float> %29, <3 x float> poison, <3 x i32> zeroinitializer
  %31 = fdiv reassoc nsz arcp contract afn <3 x float> %25, %30
  %32 = insertelement <3 x i1> poison, i1 %i.cd, i64 0
  %33 = shufflevector <3 x i1> %32, <3 x i1> poison, <3 x i32> zeroinitializer
  %34 = select <3 x i1> %33, <3 x float> zeroinitializer, <3 x float> %31 ; 3 uses
  %i.ce = fmul reassoc nsz arcp contract afn float %26, f0x3F309D77
  %i.cf = fmul reassoc nsz arcp contract afn float %27, f0x3EB2573F
  %i.cg = fadd reassoc nsz arcp contract afn float %i.cf, %i.ce
  %35 = shufflevector <3 x float> %34, <3 x float> poison, <2 x i32> zeroinitializer
  %36 = fmul reassoc nsz arcp contract afn <2 x float> %35, <float f0x3F8B3A63, float f0xBDB3A62D>
  %37 = shufflevector <3 x float> %34, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %38 = fmul reassoc nsz arcp contract afn <2 x float> %37, <float f0xBF2AAAAB, float f0x3FD55555>
  %39 = shufflevector <3 x float> %34, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %40 = fmul reassoc nsz arcp contract afn <2 x float> %39, <float f0x3CA8E841, float f0xBD53224F>
  %41 = fadd reassoc nsz arcp contract afn <2 x float> %36, <float f0xBE604727, float -5.437140e-01>
  %42 = fadd reassoc nsz arcp contract afn <2 x float> %41, %38
  %43 = fadd reassoc nsz arcp contract afn <2 x float> %42, %40 ; 3 uses
  %44 = extractelement <2 x float> %43, i64 0
  %45 = extractelement <2 x float> %43, i64 1
  %46 = tail call reassoc nsz arcp contract afn float @hypotf(float noundef %45, float noundef %44) #25 ; 3 uses
