...
gamut_check_Yrg.exit:                             ; preds = %bb.f, %bb.g
  ...
  %6 = fmul reassoc nsz arcp contract afn float %.sroa.0.0.i339, f0x3F8B3A63
  %7 = fmul reassoc nsz arcp contract afn float %.sroa.6.0.i340, f0x3F2AAAAB
  %8 = fsub reassoc nsz arcp contract afn float %6, %7
  %9 = fmul reassoc nsz arcp contract afn float %.sroa.8.0.i341, f0x3CA8E841
  %10 = fadd reassoc nsz arcp contract afn float %8, %9 ; 3 uses
  %i.rq = fmul reassoc nsz arcp contract afn float %.sroa.0.0.i339, f0x3DB3A62D
  %11 = fmul reassoc nsz arcp contract afn float %.sroa.6.0.i340, f0x3FD55555
  %12 = fsub reassoc nsz arcp contract afn float %11, %i.rq
  %13 = fmul reassoc nsz arcp contract afn float %.sroa.8.0.i341, f0xBD53224F
  %14 = fadd reassoc nsz arcp contract afn float %12, %13 ; 3 uses
  %15 = fdiv reassoc nsz arcp contract afn float %i.rp, %i.pp ; 2 uses
  %16 = fcmp reassoc nsz arcp contract afn ogt float %15, 0.000000e+00
  %spec.select = select reassoc nsz arcp contract afn i1 %16, float %15, float 0.000000e+00
  %17 = load float, ptr %i.fs, align 16, !tbaa !138
  %18 = tail call reassoc nsz arcp contract afn float @llvm.pow.f32(float %spec.select, float %17)
  %19 = fmul reassoc nsz arcp contract afn float %18, %i.pp
  %20 = load float, ptr %i.ft, align 16, !tbaa !139 ; 2 uses
  %21 = fdiv reassoc nsz arcp contract afn float %19, %20
  %22 = load float, ptr %i.fu, align 8, !tbaa !140
  %23 = tail call reassoc nsz arcp contract afn float @llvm.pow.f32(float %21, float %22)
  %24 = fmul reassoc nsz arcp contract afn float %23, %20
  %i.rr = fadd reassoc nsz arcp contract afn float %14, %10 ; 2 uses
  %i.rs = fsub reassoc nsz arcp contract afn float 1.000000e+00, %i.rr ; 3 uses
  %i.rt = fmul reassoc nsz arcp contract afn float %10, f0x3F733333
  %i.ru = fmul reassoc nsz arcp contract afn float %14, 3.800000e-01
  %25 = fadd reassoc nsz arcp contract afn float %i.ru, %i.rt
  %i.rv = fmul reassoc nsz arcp contract afn float %i.rs, 0.000000e+00
  %i.rw = fadd reassoc nsz arcp contract afn float %25, %i.rv ; 2 uses
  %26 = fmul reassoc nsz arcp contract afn float %10, 5.000000e-02
  %i.rx = fmul reassoc nsz arcp contract afn float %14, 6.200000e-01
  %27 = fadd reassoc nsz arcp contract afn float %i.rx, %26
  %28 = fmul reassoc nsz arcp contract afn float %i.rs, 3.000000e-02
  %i.ry = fadd reassoc nsz arcp contract afn float %27, %28 ; 2 uses
  ...
  %i.sc = fmul reassoc nsz arcp contract afn float %i.rw, f0x3F309D77
  %i.sd = fmul reassoc nsz arcp contract afn float %i.ry, f0x3EB2573F
  ...
  %i.sg = fdiv reassoc nsz arcp contract afn float %24, %i.se
  %i.sh = select reassoc nsz arcp contract afn i1 %i.sf, float 0.000000e+00, float %i.sg ; 3 uses
  %i.si = fmul reassoc nsz arcp contract afn float %i.sh, %i.rw ; 4 uses
  ...
  %i.sl = fmul reassoc nsz arcp contract afn float %i.si, f0x3FE76ACB
  %i.sm = fmul reassoc nsz arcp contract afn float %i.sj, f0x3FA65D1D
  %29 = fsub reassoc nsz arcp contract afn float %i.sl, %i.sm
  %i.sn = fmul reassoc nsz arcp contract afn float %i.sk, f0x3EB21A8C
  %30 = fadd reassoc nsz arcp contract afn float %29, %i.sn ; 3 uses
  %.sroa.0404.0.vec.insert = insertelement <4 x float> poison, float %30, i64 0
  %i.so = fmul reassoc nsz arcp contract afn float %i.si, f0x3F1E2ABC
  %i.sp = fmul reassoc nsz arcp contract afn float %i.sj, f0x3ECABA8D
  %i.sq = fadd reassoc nsz arcp contract afn float %i.sp, %i.so
  %i.sr = fmul reassoc nsz arcp contract afn float %i.sk, f0xBD2820C3
  %31 = fadd reassoc nsz arcp contract afn float %i.sq, %i.sr ; 2 uses
  %.sroa.0404.4.vec.insert = insertelement <4 x float> %.sroa.0404.0.vec.insert, float %31, i64 1
  %i.ss = fmul reassoc nsz arcp contract afn float %i.si, f0x3E007B1A
  %i.st = fmul reassoc nsz arcp contract afn float %i.sj, f0x3E51B1F3
  %32 = fsub reassoc nsz arcp contract afn float %i.st, %i.ss
  %33 = fmul reassoc nsz arcp contract afn float %i.sk, f0x3FDF122A
  %i.su = fadd reassoc nsz arcp contract afn float %32, %33 ; 5 uses
  %.sroa.0404.8.vec.insert = insertelement <4 x float> %.sroa.0404.4.vec.insert, float %i.su, i64 2
  %i.sv = fadd reassoc nsz arcp contract afn float %i.sj, %i.si
...
bb.h:                                             ; preds = %gamut_check_Yrg.exit
  %i.ta = fmul reassoc nsz arcp contract afn float %30, 1.150000e+00
  %i.tb = fmul reassoc nsz arcp contract afn float %i.su, f0x3E199998
  %34 = fsub reassoc nsz arcp contract afn float %i.ta, %i.tb ; 3 uses
  %35 = fmul reassoc nsz arcp contract afn float %31, 6.600000e-01
  %36 = fmul reassoc nsz arcp contract afn float %30, f0x3EAE147A
  %37 = fadd reassoc nsz arcp contract afn float %35, %36 ; 3 uses
  %.reass596.a = fmul reassoc nsz arcp contract afn float %34, f0x382DF9B4
  %.reass.a = fmul reassoc nsz arcp contract afn float %37, f0x387344EC
  %.reass595 = fmul reassoc nsz arcp contract afn float %i.su, 1.464800e-06
  %38 = fadd reassoc nsz arcp contract afn float %.reass596.a, %.reass595
  %39 = fadd reassoc nsz arcp contract afn float %38, %.reass.a
  %.reass599 = fmul reassoc nsz arcp contract afn float %34, -2.015100e-05
  %.reass597 = fmul reassoc nsz arcp contract afn float %37, f0x38EB0462
  %.reass598 = fmul reassoc nsz arcp contract afn float %i.su, 5.310080e-06
  %40 = fadd reassoc nsz arcp contract afn float %.reass599, %.reass598
  %i.tc = fadd reassoc nsz arcp contract afn float %40, %.reass597
  %.reass602 = fmul reassoc nsz arcp contract afn float %34, -1.660080e-06
  %.reass600 = fmul reassoc nsz arcp contract afn float %37, 2.648000e-05
  %.reass601 = fmul reassoc nsz arcp contract afn float %i.su, f0x388C30BE
  %i.td = fadd reassoc nsz arcp contract afn float %.reass602, %.reass601
  %i.te = fadd reassoc nsz arcp contract afn float %i.td, %.reass600
  %41 = tail call reassoc nsz arcp contract afn float @llvm.maxnum.f32(float %39, float 0.000000e+00)
  %42 = tail call reassoc nsz arcp contract afn float @llvm.pow.f32(float %41, float f0x3E232000) ; 2 uses
  %43 = fmul reassoc nnan nsz arcp contract afn float %42, f0x4196D000
  %44 = fadd reassoc nsz arcp contract afn float %43, f0x3F560000
  %45 = fmul reassoc nnan nsz arcp contract afn float %42, 1.868750e+01
  %46 = fadd reassoc nsz arcp contract afn float %45, 1.000000e+00
  %47 = fdiv reassoc nsz arcp contract afn float %44, %46
  %48 = tail call reassoc nsz arcp contract afn float @llvm.pow.f32(float %47, float f0x430608CD) ; 3 uses
  %i.tf = tail call reassoc nsz arcp contract afn float @llvm.maxnum.f32(float %i.tc, float 0.000000e+00)
  ...
  %49 = tail call reassoc nsz arcp contract afn float @llvm.maxnum.f32(float %i.te, float 0.000000e+00)
  %50 = tail call reassoc nsz arcp contract afn float @llvm.pow.f32(float %49, float f0x3E232000) ; 2 uses
  %51 = fmul reassoc nnan nsz arcp contract afn float %50, f0x4196D000
  %52 = fadd reassoc nsz arcp contract afn float %51, f0x3F560000
  %53 = fmul reassoc nnan nsz arcp contract afn float %50, 1.868750e+01
  %54 = fadd reassoc nsz arcp contract afn float %53, 1.000000e+00
  %55 = fdiv reassoc nsz arcp contract afn float %52, %54
  %56 = tail call reassoc nsz arcp contract afn float @llvm.pow.f32(float %55, float f0x430608CD) ; 3 uses
  %i.tn = fadd reassoc nsz arcp contract afn float %i.tm, %48 ; 2 uses
  %i.to = fmul reassoc nsz arcp contract afn float %i.tn, 5.000000e-01
  %i.tp = fmul reassoc nsz arcp contract afn float %56, 0.000000e+00 ; 2 uses
  %i.tq = fadd reassoc nsz arcp contract afn float %i.to, %i.tp ; 2 uses
  %i.tr = fmul reassoc nsz arcp contract afn float %48, 3.524000e+00
  %i.ts = fmul reassoc nsz arcp contract afn float %i.tm, f0x40822279
  %i.tt = fsub reassoc nsz arcp contract afn float %i.tr, %i.ts
  %i.tu = fmul reassoc nsz arcp contract afn float %56, 5.427080e-01
  %i.tv = fadd reassoc nsz arcp contract afn float %i.tt, %i.tu ; 2 uses
  %i.tw = fmul reassoc nsz arcp contract afn float %48, 1.990760e-01
  %57 = fmul reassoc nsz arcp contract afn float %i.tm, f0x3F8C63E9
  %i.tx = fadd reassoc nsz arcp contract afn float %57, %i.tw
  %58 = fmul reassoc nsz arcp contract afn float %56, f0xBFA5DF3B
