...
bb.f:                                             ; preds = %.lr.ph, %bb.ae
  ...
  %i.hd = fadd reassoc nsz arcp contract afn <2 x float> %i.ha, %i.hc ; 2 uses
  %i.he = extractelement <2 x float> %i.hd, i64 0 ; 3 uses
  %i.hf = fadd reassoc nsz arcp contract afn float %i.he, %i.gv
  %i.hg = extractelement <2 x float> %i.hd, i64 1 ; 2 uses
  %i.hh = fadd reassoc nsz arcp contract afn float %i.hf, %i.hg ; 4 uses
  %i.hi = fcmp reassoc nsz arcp contract afn oeq float %i.hh, 0.000000e+00 ; 3 uses
  %i.hj = fdiv reassoc nsz arcp contract afn float %i.gv, %i.hh
  %6 = fdiv reassoc nsz arcp contract afn float %i.he, %i.hh
  %7 = fdiv reassoc nsz arcp contract afn float %i.hg, %i.hh
  %.sroa.0.0.i = select nsz i1 %i.hi, float 0.000000e+00, float %i.hj ; 2 uses
  %.sroa.6.0.i = select nsz i1 %i.hi, float 0.000000e+00, float %6 ; 2 uses
  %.sroa.8.0.i = select nsz i1 %i.hi, float 0.000000e+00, float %7 ; 2 uses
  %8 = fmul reassoc nsz arcp contract afn float %i.gv, f0x3F309D77
  %i.hk = fmul reassoc nsz arcp contract afn float %i.he, f0x3EB2573F
  %i.hl = fadd reassoc nsz arcp contract afn float %i.hk, %8 ; 2 uses
  %i.hm = fmul reassoc nsz arcp contract afn float %.sroa.0.0.i, f0x3F8B3A63
  %i.hn = fmul reassoc nsz arcp contract afn float %.sroa.6.0.i, f0xBF2AAAAB
  %i.ho = fadd reassoc nsz arcp contract afn float %i.hn, %i.hm
  %9 = fmul reassoc nsz arcp contract afn float %.sroa.8.0.i, f0x3CA8E841
  %i.hp = fadd reassoc nsz arcp contract afn float %9, %i.ho
  %10 = fmul reassoc nsz arcp contract afn float %.sroa.0.0.i, f0xBDB3A62D
  %11 = fmul reassoc nsz arcp contract afn float %.sroa.6.0.i, f0x3FD55555
  %i.hq = fadd reassoc nsz arcp contract afn float %11, %10
  %12 = fmul reassoc nsz arcp contract afn float %.sroa.8.0.i, f0xBD53224F
  %i.hr = fadd reassoc nsz arcp contract afn float %12, %i.hq
  %13 = fadd reassoc nsz arcp contract afn float %i.hp, f0xBE604727 ; 2 uses
  %i.hs = fadd reassoc nsz arcp contract afn float %i.hr, -5.437140e-01 ; 2 uses
  %i.ht = tail call reassoc nsz arcp contract afn float @hypotf(float noundef %i.hs, float noundef %13) #25 ; 5 uses
  %i.hu = fcmp reassoc nsz arcp contract afn une float %i.ht, 0.000000e+00 ; 2 uses
  %i.hv = fdiv reassoc nsz arcp contract afn float %13, %i.ht
  ...
  %i.jk = shufflevector <2 x float> %i.ji, <2 x float> %i.jj, <2 x i32> <i32 0, i32 3> ; 2 uses
  ...
  %14 = fadd reassoc nsz arcp contract afn float %i.jn, %i.jp
  %i.jq = load float, ptr %i.fq, align 16, !tbaa !14
  %i.jr = fmul reassoc nsz arcp contract afn float %i.jq, %i.is
  %15 = fadd reassoc nsz arcp contract afn float %i.jr, %14
  ...
  %i.jx = fadd reassoc nsz arcp contract afn float %i.jl, 1.000000e+00
  %i.jy = fadd reassoc nsz arcp contract afn float %i.jx, %15
  ...
  %i.kd = extractelement <2 x float> %i.ji, i64 0 ; 2 uses
  ...
  %i.kg = extractelement <2 x float> %i.jj, i64 1 ; 2 uses
  ...
  %16 = fcmp reassoc nsz arcp contract afn olt float %i.kf, 0.000000e+00
  %i.kj = fcmp reassoc nsz arcp contract afn olt float %i.ki, 0.000000e+00
  %17 = fdiv reassoc nsz arcp contract afn <2 x float> <float f0xBE604727, float -5.437140e-01>, %i.jk ; 2 uses
  %18 = extractelement <2 x float> %17, i64 0
  %19 = tail call reassoc nsz arcp contract afn float @llvm.minnum.f32(float %18, float %i.kc)
  %.0.i = select nsz i1 %16, float %19, float %i.kc ; 2 uses
  %20 = extractelement <2 x float> %17, i64 1
  %i.kk = tail call reassoc nsz arcp contract afn float @llvm.minnum.f32(float %20, float %.0.i)
  %.1.i = select nsz i1 %i.kj, float %i.kk, float %.0.i ; 2 uses
...
bb.h:                                             ; preds = %gamut_check_Yrg.exit
  ...
  %21 = fadd reassoc nsz arcp contract afn float %i.vu, 1.000000e+00
  ...
  %22 = fadd reassoc nsz arcp contract afn float %i.vw, %i.vy
  %i.vz = load float, ptr %i.gb, align 16, !tbaa !14
  %i.wa = fmul reassoc nsz arcp contract afn float %i.vz, %i.is
  %i.wb = fadd reassoc nsz arcp contract afn float %i.wa, %22
  %i.wc = fadd reassoc nsz arcp contract afn float %21, %i.wb
  ...
  %23 = fadd reassoc nsz arcp contract afn float %i.wf, %i.wh
  %i.wi = load float, ptr %i.fy, align 8, !tbaa !14
  %i.wj = fmul reassoc nsz arcp contract afn float %i.wi, %i.is
  %i.wk = fadd reassoc nsz arcp contract afn float %i.wj, %23
  %i.wl = fadd reassoc nsz arcp contract afn float %i.wk, %i.wd
...
soft_clip.exit:                                   ; preds = %bb.k, %bb.j, %lookup_gamut.exit
  ...
  %24 = fadd reassoc nsz arcp contract afn float %i.zg, %i.zd
  %25 = fmul reassoc nsz arcp contract afn float %i.zf, f0x3D6DC306
  %i.zh = fadd reassoc nsz arcp contract afn float %24, %25
  %i.zi = fmul reassoc nsz arcp contract afn float %i.ze, f0xBE0DEE7B
  %26 = fadd reassoc nsz arcp contract afn float %i.zi, %i.zd
  %27 = fmul reassoc nsz arcp contract afn float %i.zf, f0xBD6DC306
  %i.zj = fadd reassoc nsz arcp contract afn float %26, %27
  %i.zk = fmul reassoc nsz arcp contract afn float %i.ze, f0xBDC4A5BD
  %28 = fadd reassoc nsz arcp contract afn float %i.zk, %i.zd
  %29 = fmul reassoc nsz arcp contract afn float %i.zf, f0xBF4FD826
  %i.zl = fadd reassoc nsz arcp contract afn float %28, %29
...
bb.q:                                             ; preds = %bb.p, %bb.o
  ...
  %i.aap = fadd reassoc nsz arcp contract afn <4 x float> %i.aao, %i.aam
  ...
  %i.abq = fadd reassoc nsz arcp contract afn float %i.abo, %i.abp
  %i.abr = fmul reassoc nsz arcp contract afn float %i.abn, f0x43BC41CC
  %i.abs = fadd reassoc nsz arcp contract afn float %i.abr, %i.abq
  ...
  %i.abt = fadd reassoc nsz arcp contract afn float %.reass603.a, %.reass604.a
  %.reass602 = fmul reassoc nsz arcp contract afn float %i.abn, f0xC477AB14
  %i.abu = fadd reassoc nsz arcp contract afn float %.reass602, %i.abt
  ...
  %i.acb = fadd reassoc nsz arcp contract afn float %i.aca, %i.abs ; 2 uses
  ...
  %i.acd = fadd reassoc nsz arcp contract afn float %.reass601, %i.abu
...
bb.r:                                             ; preds = %gamut_check_Yrg.exit
  ...
  %30 = fadd reassoc nsz arcp contract afn float %i.aew, 1.000000e+00
  ...
  %31 = fadd reassoc nsz arcp contract afn float %i.aey, %i.afa
  %i.afb = load float, ptr %i.fy, align 8, !tbaa !14
  %i.afc = fmul reassoc nsz arcp contract afn float %i.afb, %i.is
  %i.afd = fadd reassoc nsz arcp contract afn float %i.afc, %31
  %i.afe = fadd reassoc nsz arcp contract afn float %30, %i.afd ; 2 uses
  ...
  %32 = fadd reassoc nsz arcp contract afn float %i.afh, 1.000000e+00
  ...
  %33 = fadd reassoc nsz arcp contract afn float %i.afj, %i.afl
  %i.afm = load float, ptr %i.gb, align 16, !tbaa !14
  %i.afn = fmul reassoc nsz arcp contract afn float %i.afm, %i.is
  %i.afo = fadd reassoc nsz arcp contract afn float %i.afn, %33
  %i.afp = fadd reassoc nsz arcp contract afn float %32, %i.afo ; 2 uses
...
dt_UCS_JCH_to_xyY.exit:                           ; preds = %soft_clip.exit344, %bb.w, %.thread.i
  ...
  %i.akg = fadd reassoc nsz arcp contract afn float %i.akb, %i.akf
  %i.akh = fadd reassoc nsz arcp contract afn float %i.akg, f0xBCD1FB74 ; 5 uses
...
bb.an:                                            ; preds = %bb.am, %bb.al, %bb.ak, %bb.ai
  ...
  %i.aig = fadd reassoc nsz arcp contract afn float %i.aie, %i.aif
...
dt_ioppr_rgb_matrix_to_xyz.exit:                  ; preds = %bb.c, %bb.d
  ...
  %4 = fadd reassoc nsz arcp contract afn float %i.dp, %i.do
  %i.dq = fmul reassoc nsz arcp contract afn float %.sroa.8.0.i.i, f0x3CA8E841
  %5 = fadd reassoc nsz arcp contract afn float %i.dq, %4
  %i.dr = fmul reassoc nsz arcp contract afn float %.sroa.0.0.i.i, f0xBDB3A62D
  %6 = fmul reassoc nsz arcp contract afn float %.sroa.6.0.i.i, f0x3FD55555
  %i.ds = fadd reassoc nsz arcp contract afn float %6, %i.dr
  %7 = fmul reassoc nsz arcp contract afn float %.sroa.8.0.i.i, f0xBD53224F
  %i.dt = fadd reassoc nsz arcp contract afn float %7, %i.ds
  %i.du = fadd reassoc nsz arcp contract afn float %5, f0xBE604727 ; 2 uses
  %i.dv = fadd reassoc nsz arcp contract afn float %i.dt, -5.437140e-01 ; 2 uses
  %i.dw = tail call reassoc nsz arcp contract afn float @hypotf(float noundef %i.dv, float noundef %i.du) #25 ; 4 uses
  %i.dx = fcmp reassoc nsz arcp contract afn une float %i.dw, 0.000000e+00 ; 2 uses
  %i.dy = fdiv reassoc nsz arcp contract afn float %i.du, %i.dw
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.da = fadd reassoc nsz arcp contract afn <2 x float> %i.ap, %i.cy
  ...
  %i.dg = fadd reassoc nsz arcp contract afn float %i.df, %i.de
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.w = fadd reassoc nsz arcp contract afn float %i.d, %i.v
...
bb.c:                                             ; preds = %_clip_chroma_black.exit.i
  ...
  %i.aq = fadd reassoc nsz arcp contract afn float %i.ae, %i.ap
