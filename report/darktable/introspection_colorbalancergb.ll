...
bb.h:                                             ; preds = %gamut_check_Yrg.exit
  ...
  %.reass594.a = fmul reassoc nsz arcp contract afn float %i.uf, f0x3ED45F51
  %.reass.a = fmul reassoc nsz arcp contract afn float %i.ui, 5.799990e-01
  %.reass593.a = fmul reassoc nsz arcp contract afn float %i.tx, 1.464800e-02
  ...
  %i.un = fmul reassoc nsz arcp contract afn <2 x float> %i.um, <float 5.310080e-02, float f0x3F2B2180>
  %i.uo = tail call reassoc nsz arcp contract afn float @llvm.maxnum.f32(float %i.uk, float 0.000000e+00)
  %6 = fmul reassoc nnan nsz arcp contract afn float %i.uo, f0x38D1B717
  %i.up = tail call reassoc nsz arcp contract afn float @llvm.pow.f32(float %6, float f0x3E232000) ; 2 uses
  ...
  %i.va = fmul reassoc nsz arcp contract afn <2 x float> %i.uz, <float -2.015100e-01, float -1.660080e-02>
  ...
  %i.vd = fmul reassoc nsz arcp contract afn <2 x float> %i.vc, <float f0x3F8F716D, float 2.648000e-01>
  ...
  %7 = fmul reassoc nnan nsz arcp contract afn <2 x float> %i.vg, splat (float f0x38D1B717)
  %i.vh = tail call reassoc nsz arcp contract afn <2 x float> @llvm.pow.v2f32(<2 x float> %7, <2 x float> splat (float f0x3E232000)) ; 2 uses
...
bb.ae:                                            ; preds = %.preheader252, %bb.ae
  ...
  %.reass259 = fmul reassoc nsz arcp contract afn float %i.uk, f0x3ED45F51
  %.reass = fmul reassoc nsz arcp contract afn float %i.un, 5.799990e-01
  %.reass258 = fmul reassoc nsz arcp contract afn float %i.uh, 1.464800e-02
  ...
  %4 = fmul reassoc nnan nsz arcp contract afn float %i.uq, f0x38D1B717
  %i.ur = tail call reassoc nsz arcp contract afn float @llvm.pow.f32(float %4, float f0x3E232000) ; 2 uses
  ...
  %i.vc = fmul reassoc nsz arcp contract afn <2 x float> %i.vb, <float -2.015100e-01, float -1.660080e-02>
  ...
  %i.vf = fmul reassoc nsz arcp contract afn <2 x float> %i.ve, <float f0x3F8F716D, float 2.648000e-01>
  ...
  %i.vi = fmul reassoc nsz arcp contract afn <2 x float> %i.vh, <float 5.310080e-02, float f0x3F2B2180>
  ...
  %5 = fmul reassoc nnan nsz arcp contract afn <2 x float> %i.vl, splat (float f0x38D1B717)
  %i.vm = tail call reassoc nsz arcp contract afn <2 x float> @llvm.pow.v2f32(<2 x float> %5, <2 x float> splat (float f0x3E232000)) ; 2 uses
