...
vector.scevcheck:                                 ; preds = %.lr.ph.split.us.preheader
  ...
  %umin = tail call i64 @llvm.umin.i64(i64 %i.br, i64 %i.bx) ; 2 uses
  %i.by = trunc i64 %umin to i16                  ; 2 uses
  %i.bz = xor i16 %i.ad, -1
  %i.ca = icmp ult i16 %i.bz, %i.by
  %i.cb = sub i16 -2, %i.ad
  %i.cc = icmp ult i16 %i.cb, %i.by
...
vector.scevcheck135:                              ; preds = %.lr.ph.split.split.us.split.preheader
  ...
  %umin138 = tail call i64 @llvm.umin.i64(i64 %i.dp, i64 %i.dv) ; 2 uses
  %i.dw = trunc i64 %umin138 to i16               ; 2 uses
  %i.dx = xor i16 %i.ad, -1
  %i.dy = icmp ult i16 %i.dx, %i.dw
  %i.dz = sub i16 -2, %i.ad
  %i.ea = icmp ult i16 %i.dz, %i.dw
...
vector.scevcheck114:                              ; preds = %.lr.ph.split.split.us.split.us.preheader
  ...
  %umin117 = tail call i64 @llvm.umin.i64(i64 %i.gb, i64 %i.gh) ; 2 uses
  %i.gi = trunc i64 %umin117 to i16               ; 2 uses
  %i.gj = xor i16 %i.ad, -1
  %i.gk = icmp ult i16 %i.gj, %i.gi
  %i.gl = sub i16 -2, %i.ad
  %i.gm = icmp ult i16 %i.gl, %i.gi
