...
dt_UCS_JCH_to_xyY.exit.i.i8:                      ; preds = %dt_UCS_JCH_to_sRGB.exit16, %bb.b
  ...
  %i.as = fadd reassoc nsz arcp contract afn float %i.an, %i.ar
  %i.at = fadd reassoc nsz arcp contract afn float %i.as, f0xBCD1FB74 ; 5 uses
...
dt_UCS_JCH_to_xyY.exit.i.i:                       ; preds = %dt_UCS_JCH_to_sRGB.exit, %_find_max_chroma.exit.i
  ...
  %i.eb = fadd reassoc nsz arcp contract afn float %i.dw, %i.ea
  %i.ec = fadd reassoc nsz arcp contract afn float %i.eb, f0xBCD1FB74 ; 5 uses
