...
begin_hunk_0_@process_v1:bb.a
  %i.v = load float, ptr %i.u, align 4, !tbaa !12 ; 2 uses
  %i.w = getelementptr inbounds nuw i8, ptr %i.s, i64 4
  %i.x = load float, ptr %i.w, align 4, !tbaa !12 ; 2 uses
...
dt_Lab_2_LCH.exit:                                ; preds = %bb.c, %bb.d
  ...
  %i.ae = load float, ptr %i.s, align 4, !tbaa !12 ; 2 uses
...
bb.g:                                             ; preds = %dt_Lab_2_LCH.exit, %bb.f, %bb.e
  ...
  %i.bj = load float, ptr %i.bi, align 4, !tbaa !12 ; 2 uses
  ...
  %i.bs = load float, ptr %i.br, align 4, !tbaa !12 ; 2 uses
  ...
  store float %i.bf, ptr %i.t, align 4, !tbaa !12
  ...
  store float %i.ce, ptr %i.cf, align 4, !tbaa !12
...
.lr.ph:                                           ; preds = %bb.a
  ...
  %i.n = load i32, ptr %i.m, align 8, !tbaa !58
...
bb.c:                                             ; preds = %bb.b
  %i.ad = load float, ptr %i.s, align 4, !tbaa !12
...
bb.f:                                             ; preds = %bb.e, %bb.d, %bb.c
  %.051 = phi nsz float [ %i.ab, %bb.e ], [ %i.af, %bb.c ], [ %i.ah, %bb.d ]
  %.050 = phi nsz float [ %i.ak, %bb.e ], [ 0.000000e+00, %bb.c ], [ 0.000000e+00, %bb.d ] ; 2 uses
  %i.al = fmul reassoc nsz arcp contract afn float %.050, 5.000000e-01 ; 2 uses
  %i.am = fsub reassoc nsz arcp contract afn float 1.000000e+00, %.050 ; 2 uses
  %i.an = fmul reassoc nsz arcp contract afn float %.051, 6.553600e+04 ; 2 uses
  ...
  %i.bw = load float, ptr %i.s, align 4, !tbaa !12
  ...
  store float %i.cg, ptr %i.ch, align 4, !tbaa !12
  ...
  store float %i.cj, ptr %i.ck, align 4, !tbaa !12
...
bb.d:                                             ; preds = %bb.c
  %i.n = load ptr, ptr %i.e, align 8, !tbaa !59
...
bb.f:                                             ; preds = %bb.d, %bb.c, %bb.b, %bb.a
  ...
  %i.u = load i32, ptr %i.t, align 4, !tbaa !93
...
.preheader116.preheader:
  ...
  store i32 1, ptr %i.a, align 4, !tbaa !95
  %i.c = load ptr, ptr getelementptr inbounds nuw (i8, ptr @darktable, i64 136), align 8, !tbaa !234
  tail call void @dt_database_start_transaction(ptr noundef %i.c) #30
  store i32 2, ptr %1, align 4, !tbaa !133
  ...
  store float 5.000000e-01, ptr %i.g, align 4, !tbaa !15
  %i.h = getelementptr inbounds nuw i8, ptr %1, i64 168 ; 2 uses
  %i.i = getelementptr inbounds nuw i8, ptr %1, i64 328 ; 3 uses
  store float 5.000000e-01, ptr %i.i, align 4, !tbaa !15
  store float 0.000000e+00, ptr %i.d, align 4, !tbaa !14
  store float 0.000000e+00, ptr %i.e, align 4, !tbaa !14
  store float 0.000000e+00, ptr %i.f, align 4, !tbaa !14
  ...
  store float 0.000000e+00, ptr %i.m, align 4, !tbaa !15
  ...
  store float 0.000000e+00, ptr %i.s, align 4, !tbaa !15
  %i.t = getelementptr inbounds nuw i8, ptr %1, i64 340
  %i.u = getelementptr inbounds nuw i8, ptr %1, i64 344
  store float f0x3E924925, ptr %i.r, align 4, !tbaa !14
  ...
  store <8 x float> <float f0x3E124925, float 5.000000e-01, float f0x3E924925, float 5.000000e-01, float f0x3EDB6DB8, float 5.000000e-01, float f0x3F124925, float 5.000000e-01>, ptr %i.j, align 4, !tbaa !12
  store <8 x float> <float f0x3E124925, float 5.000000e-01, float f0x3E924925, float 5.000000e-01, float f0x3EDB6DB8, float 5.000000e-01, float f0x3F124925, float 5.000000e-01>, ptr %i.n, align 4, !tbaa !12
  %i.ae = getelementptr inbounds nuw i8, ptr %1, i64 44 ; 3 uses
  %i.af = getelementptr inbounds nuw i8, ptr %1, i64 48 ; 3 uses
  store float 5.000000e-01, ptr %i.af, align 4, !tbaa !15
  ...
  store float 5.000000e-01, ptr %i.aj, align 4, !tbaa !15
  store float f0x3F36DB6E, ptr %i.ae, align 4, !tbaa !14
  store float f0x3F36DB6E, ptr %i.ai, align 4, !tbaa !14
  %i.ak = getelementptr inbounds nuw i8, ptr %1, i64 52 ; 3 uses
  %i.al = getelementptr inbounds nuw i8, ptr %1, i64 56 ; 3 uses
  store float 5.000000e-01, ptr %i.al, align 4, !tbaa !15
  ...
  store float 5.000000e-01, ptr %i.ap, align 4, !tbaa !15
  store float f0x3F5B6DB8, ptr %i.ak, align 4, !tbaa !14
  store float f0x3F5B6DB8, ptr %i.ao, align 4, !tbaa !14
  %i.aq = getelementptr inbounds nuw i8, ptr %1, i64 224
  store float 6.500000e-01, ptr %i.aq, align 4, !tbaa !15
  %i.ar = getelementptr inbounds nuw i8, ptr %1, i64 168
  store float 6.500000e-01, ptr %i.ar, align 4, !tbaa !15
  %i.as = getelementptr inbounds nuw i8, ptr %1, i64 172
  store float 1.875000e-01, ptr %i.as, align 4, !tbaa !14
  %i.at = getelementptr inbounds nuw i8, ptr %1, i64 188
  store <8 x float> <float 5.000000e-01, float 0.000000e+00, float 5.100000e-01, float 0.000000e+00, float f0x3F36DB6E, float 0.000000e+00, float 9.375000e-01, float 0.000000e+00>, ptr %i.at, align 4, !tbaa !12
  %i.au = getelementptr inbounds nuw i8, ptr %1, i64 484 ; 6 uses
  %i.av = getelementptr inbounds nuw i8, ptr %1, i64 500 ; 6 uses
  store i32 1, ptr %i.av, align 4, !tbaa !16
  store <4 x i32> <i32 7, i32 7, i32 7, i32 1>, ptr %i.au, align 4, !tbaa !16
  %i.aw = getelementptr inbounds nuw i8, ptr %1, i64 504 ; 6 uses
  store i32 1, ptr %i.aw, align 4, !tbaa !16
  ...
  store float 5.000000e-01, ptr %i.g, align 4, !tbaa !15
  store float 0.000000e+00, ptr %i.d, align 4, !tbaa !14
  store <8 x float> <float 0.000000e+00, float 5.000000e-01, float f0x3E124925, float 5.000000e-01, float f0x3E924925, float 5.000000e-01, float f0x3EDB6DB8, float 5.000000e-01>, ptr %i.f, align 4, !tbaa !12
  store float 0.000000e+00, ptr %i.ab, align 4, !tbaa !15
  store float 5.000000e-01, ptr %i.ad, align 4, !tbaa !15
  store <8 x float> <float f0x3E124925, float 5.000000e-01, float f0x3E924925, float 5.000000e-01, float f0x3EDB6DB8, float 5.000000e-01, float f0x3F124925, float 5.000000e-01>, ptr %i.j, align 4, !tbaa !12
  store float f0x3F124925, ptr %i.aa, align 4, !tbaa !14
  store float f0x3F124925, ptr %i.ac, align 4, !tbaa !14
  store float 5.000000e-01, ptr %i.af, align 4, !tbaa !15
  store float 0.000000e+00, ptr %i.ah, align 4, !tbaa !15
  store float 5.000000e-01, ptr %i.aj, align 4, !tbaa !15
  store float f0x3F36DB6E, ptr %i.ae, align 4, !tbaa !14
  store float f0x3F36DB6E, ptr %i.ag, align 4, !tbaa !14
  store float f0x3F36DB6E, ptr %i.ai, align 4, !tbaa !14
  store float 5.000000e-01, ptr %i.al, align 4, !tbaa !15
  store float 0.000000e+00, ptr %i.an, align 4, !tbaa !15
  store float 5.000000e-01, ptr %i.ap, align 4, !tbaa !15
  store float f0x3F5B6DB8, ptr %i.ak, align 4, !tbaa !14
  store float f0x3F5B6DB8, ptr %i.am, align 4, !tbaa !14
  store float f0x3F5B6DB8, ptr %i.ao, align 4, !tbaa !14
  store <8 x float> <float 0.000000e+00, float 5.000000e-01, float 1.600000e-01, float 3.000000e-01, float 2.500000e-01, float 0.000000e+00, float f0x3EDB6DB8, float 0.000000e+00>, ptr %i.e, align 4, !tbaa !12
  store i32 1, ptr %i.av, align 4, !tbaa !16
  store <4 x i32> <i32 7, i32 7, i32 7, i32 1>, ptr %i.au, align 4, !tbaa !16
  store i32 1, ptr %i.aw, align 4, !tbaa !16
  ...
  store i32 1, ptr %1, align 4, !tbaa !133
  store float 5.000000e-01, ptr %i.g, align 4, !tbaa !15
end_hunk_0
