...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  %6 = load float, ptr %i.ai, align 8, !tbaa !27
  %i.aj = getelementptr inbounds nuw i8, ptr %0, i64 1956
  %7 = load float, ptr %i.aj, align 4, !tbaa !28
  %8 = getelementptr inbounds nuw i8, ptr %0, i64 1960
  %9 = fsub reassoc nsz arcp contract afn float %i.aa, %6
  %10 = fsub reassoc nsz arcp contract afn float %i.ag, %7
  %i.ak = load <2 x float>, ptr %8, align 8, !tbaa !26
  %i.al = shufflevector <2 x float> %i.ak, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %i.am = insertelement <4 x float> poison, float %9, i64 0
  %i.an = insertelement <4 x float> %i.am, float %10, i64 1
  %11 = insertelement <4 x float> %i.an, float %i.e, i64 2
  %12 = insertelement <4 x float> %11, float %i.i, i64 3
  %i.ao = fdiv reassoc nsz arcp contract afn <4 x float> %12, %i.al
