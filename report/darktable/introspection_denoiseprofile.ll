...
vector.ph234:                                     ; preds = %vector.memcheck226
  ...
  %7 = shufflevector <8 x float> %broadcast.splatinsert238, <8 x float> %broadcast.splatinsert242, <16 x i32> <i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 8, i32 8, i32 8, i32 8, i32 8, i32 8, i32 8, i32 8>
  %i.ha = fdiv reassoc nsz arcp contract afn <8 x float> splat (float 1.000000e+00), %broadcast.splat245
  %8 = fdiv reassoc nsz arcp contract afn <8 x float> splat (float 1.000000e+00), %broadcast.splat249
...
vector.body250:                                   ; preds = %vector.body250, %vector.ph234
  ...
  %9 = shufflevector <8 x float> %i.hd, <8 x float> %i.hf, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %10 = fadd reassoc nsz arcp contract afn <16 x float> %7, %9
  %i.hg = fmul reassoc nsz arcp contract afn <8 x float> %strided.vec255, %i.ha
  %11 = fadd reassoc nsz arcp contract afn <8 x float> %broadcast.splat247, %i.hg
  %12 = fmul reassoc nsz arcp contract afn <8 x float> %strided.vec256, %8
  %i.hh = shufflevector <8 x float> %11, <8 x float> %12, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %i.hi = shufflevector <16 x float> %10, <16 x float> %i.hh, <32 x i32> <i32 0, i32 8, i32 16, i32 24, i32 1, i32 9, i32 17, i32 25, i32 2, i32 10, i32 18, i32 26, i32 3, i32 11, i32 19, i32 27, i32 4, i32 12, i32 20, i32 28, i32 5, i32 13, i32 21, i32 29, i32 6, i32 14, i32 22, i32 30, i32 7, i32 15, i32 23, i32 31>
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %13 = shufflevector <8 x float> %broadcast.splatinsert135, <8 x float> %broadcast.splatinsert139, <16 x i32> <i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 8, i32 8, i32 8, i32 8, i32 8, i32 8, i32 8, i32 8>
  %14 = fdiv reassoc nsz arcp contract afn <8 x float> splat (float 1.000000e+00), %broadcast.splat142
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %15 = shufflevector <8 x float> %i.zm, <8 x float> %i.zo, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %16 = fadd reassoc nsz arcp contract afn <16 x float> %13, %15
  %i.zp = fmul reassoc nsz arcp contract afn <8 x float> %strided.vec146, %14
  %17 = fadd reassoc nsz arcp contract afn <8 x float> %broadcast.splat144, %i.zp
  %18 = fmul reassoc nsz arcp contract afn <8 x float> %strided.vec147, splat (float +inf)
  %i.zq = shufflevector <8 x float> %17, <8 x float> %18, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %i.zr = shufflevector <16 x float> %16, <16 x float> %i.zq, <32 x i32> <i32 0, i32 8, i32 16, i32 24, i32 1, i32 9, i32 17, i32 25, i32 2, i32 10, i32 18, i32 26, i32 3, i32 11, i32 19, i32 27, i32 4, i32 12, i32 20, i32 28, i32 5, i32 13, i32 21, i32 29, i32 6, i32 14, i32 22, i32 30, i32 7, i32 15, i32 23, i32 31>
