...
compute_wb_factors.exit.i.i:                      ; preds = %.preheader1.preheader.i.i.i, %bb.k, %bb.j, %.preheader.i.i.i
  ...
  %i.er = select reassoc nsz arcp contract afn i1 %i.eq, float %i.ep, float 0.000000e+00 ; 2 uses
  ...
  %7 = shufflevector <2 x float> %i.ff, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %8 = insertelement <4 x float> %7, float 0.000000e+00, i64 3
  %9 = insertelement <4 x float> %8, float %i.er, i64 2 ; 2 uses
  store <4 x float> %9, ptr %i.r, align 16, !tbaa !16
...
.lr.ph.preheader.i.i.i:                           ; preds = %bb.m
  ...
  %i.jr = fsub reassoc nsz arcp contract afn <4 x float> <float 2.000000e+00, float 2.000000e+00, float 2.000000e+00, float 1.000000e+00>, %9
...
compute_wb_factors.exit.i:                        ; preds = %.preheader1.preheader.i.i, %bb.af, %bb.ae, %.preheader.i.i
  ...
  %10 = shufflevector <2 x float> %i.ss, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %11 = insertelement <4 x float> %10, float 0.000000e+00, i64 3
  %12 = insertelement <4 x float> %11, float %i.tb, i64 2 ; 2 uses
  store <4 x float> %12, ptr %i.j, align 16, !tbaa !16
...
.lr.ph.preheader.i.i:                             ; preds = %bb.ak
  ...
  %i.abz = fsub reassoc nsz arcp contract afn <4 x float> <float 2.000000e+00, float 2.000000e+00, float 2.000000e+00, float 1.000000e+00>, %12
