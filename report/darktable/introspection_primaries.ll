...
bb.b:                                             ; preds = %bb.a
  ...
  %6 = load <4 x float>, ptr %i.bt, align 32
  %7 = getelementptr inbounds nuw i8, ptr %i.c, i64 36
  ...
  %i.bz = shufflevector <4 x float> %6, <4 x float> poison, <4 x i32> zeroinitializer
