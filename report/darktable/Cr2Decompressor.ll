...
begin_hunk_0_@_ZNK8rawspeed15Cr2DecompressorINS_20PrefixCodeLUTDecoderINS_15BaselineCodeTagENS_23PrefixCodeLookupDecoderIS2_EEEEE23getVerticalOutputStripsEv:bb.a
  ...
  store i32 %spec.select201.i, ptr %.sroa.16104.0..sroa_idx, align 8, !tbaa !19
  ...
  store i32 %spec.select200.i, ptr %.sroa.19.0..sroa_idx, align 8, !tbaa !19
  %i.au = getelementptr inbounds nuw i8, ptr %0, i64 96
  store ptr %i.f, ptr %i.au, align 8, !tbaa !24
  ...
  store i32 %spec.select201.i, ptr %.sroa.7111.0..sroa_idx, align 8, !tbaa !19
  ...
  store i32 %spec.select200.i, ptr %.sroa.10114.0..sroa_idx, align 8, !tbaa !19
  ...
  store i32 %spec.select201.i, ptr %.sroa.16120.0..sroa_idx, align 8, !tbaa !19
  ...
  store i32 %spec.select200.i, ptr %.sroa.19123.0..sroa_idx, align 8, !tbaa !19
  ret void
}
...
bb.a:
  ...
  %i.c = load <2 x ptr>, ptr %1, align 8, !tbaa !211
  store ptr null, ptr %i.b, align 8, !tbaa !28
  store <2 x ptr> %i.c, ptr %0, align 8, !tbaa !211
  ...
  store i32 0, ptr %i.l, align 4, !tbaa !212
  ...
  store ptr %i.u, ptr %i.s, align 8, !tbaa !213
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %6, i8 0, i64 24, i1 false)
  %i.v = getelementptr inbounds nuw i8, ptr %0, i64 80
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.v, ptr noundef nonnull align 8 dereferenceable(16) %7, i64 16, i1 false), !tbaa.struct !214
  %i.w = load ptr, ptr %0, align 8, !tbaa !31     ; 6 uses
  %i.x = getelementptr inbounds nuw i8, ptr %i.w, i64 553
  %i.y = load i8, ptr %i.x, align 1, !tbaa !215
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.ad = load i32, ptr %i.ac, align 4, !tbaa !216
...
bb.n:                                             ; preds = %bb.l
  store i32 %i.bg, ptr %i.l, align 4, !tbaa !217
  %i.bi = load i32, ptr %i.n, align 4, !tbaa !212 ; 3 uses
...
bb.q:                                             ; preds = %bb.p
  ...
  store i32 %i.bv, ptr %i.bk, align 8, !tbaa !218
  %i.bw = load i32, ptr %i.ax, align 8, !tbaa !219 ; 2 uses
  %i.bx = icmp sgt i32 %i.bw, 19440
  %.phi.trans.insert = getelementptr inbounds nuw i8, ptr %i.w, i64 44
  %.pre243 = load i32, ptr %.phi.trans.insert, align 4, !tbaa !220 ; 2 uses
...
.preheader195:                                    ; preds = %bb.q
  %i.bz = load i32, ptr %i.o, align 4, !tbaa !221 ; 10 uses
...
bb.s:                                             ; preds = %.lr.ph297
  ...
  br i1 %exitcond.not, label %._crit_edge298, label %.lr.ph297, !llvm.loop !209

._crit_edge298:                                   ; preds = %bb.s, %.preheader195
  %i.ca = getelementptr inbounds nuw i8, ptr %i.w, i64 56
  %i.cb = load i8, ptr %i.ca, align 8, !tbaa !222, !range !121, !noundef !122
...
.lr.ph297:                                        ; preds = %.preheader195, %bb.s
  ...
  br i1 %i.cf, label %bb.t, label %bb.s, !llvm.loop !209
...
bb.w:                                             ; preds = %._crit_edge298
  %i.ch = load ptr, ptr %i.q, align 8, !tbaa !223 ; 3 uses
...
.lr.ph:                                           ; preds = %.preheader, %bb.x
  ...
  %i.cw = load i8, ptr %i.cv, align 8, !tbaa !224, !range !121, !noundef !122
...
_ZN8rawspeed21Cr2OutputTileIteratorppEv.exit:     ; preds = %_ZN8rawspeed12_GLOBAL__N_124evaluateConsecutiveTilesERKNS_12iRectangle2DES3_.exit.thread
  ...
  br i1 %i.es, label %.loopexit.thread, label %bb.ah, !llvm.loop !210
...
bb.an:                                            ; preds = %bb.am
  %i.fb = load ptr, ptr %i.s, align 8, !tbaa !213
...
bb.c:                                             ; preds = %bb.b
  store i32 0, ptr %i.c, align 8, !tbaa !228
  %i.g = getelementptr inbounds nuw i8, ptr %i.b, i64 12
  store i32 0, ptr %i.g, align 4, !tbaa !229
  %i.h = load ptr, ptr %i.b, align 8, !tbaa !142
  %i.i = getelementptr inbounds nuw i8, ptr %i.h, i64 16
  %i.j = load ptr, ptr %i.i, align 8
  tail call void %i.j(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #20, !call_target !147, !inline_history !226
  %i.k = load ptr, ptr %i.b, align 8, !tbaa !142
  %i.l = getelementptr inbounds nuw i8, ptr %i.k, i64 24
  %i.m = load ptr, ptr %i.l, align 8
  tail call void %i.m(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #20, !call_target !149, !inline_history !226
