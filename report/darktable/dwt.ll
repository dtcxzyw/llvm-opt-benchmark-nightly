...
vector.body140:                                   ; preds = %.lr.ph.us.us.i.i.i, %vector.body140
  ...
  %i.hf = fadd reassoc nsz arcp contract afn <4 x float> %strided.vec146, %wide.masked.gather144
  %i.hg = fadd reassoc nsz arcp contract afn <4 x float> %i.hf, %i.he
  ...
  %i.hm = fadd reassoc nsz arcp contract afn <4 x float> %strided.vec147, %wide.masked.gather161
  %i.hn = fadd reassoc nsz arcp contract afn <4 x float> %i.hm, %i.hl
  ...
  %i.hr = fadd reassoc nsz arcp contract afn <4 x float> %strided.vec148, %wide.masked.gather163
  %i.hs = fadd reassoc nsz arcp contract afn <4 x float> %i.hr, %i.hq
  ...
  %i.hw = fadd reassoc nsz arcp contract afn <4 x float> %strided.vec149, %wide.masked.gather165
  %i.hx = fadd reassoc nsz arcp contract afn <4 x float> %i.hw, %i.hv
...
scalar.ph134:                                     ; preds = %scalar.ph134.preheader, %scalar.ph134
  ...
  %i.iu = fadd reassoc nsz arcp contract afn <4 x float> %i.ir, %i.iq
  %i.iv = fadd reassoc nsz arcp contract afn <4 x float> %i.iu, %i.it
...
vector.body103:                                   ; preds = %._crit_edge.us.us.i15.i.i.preheader, %vector.body103
  ...
  %i.jn = fadd reassoc nsz arcp contract afn <4 x float> %reverse, %wide.masked.gather
  %i.jo = fadd reassoc nsz arcp contract afn <4 x float> %i.jn, %i.jm
  ...
  %i.ju = fadd reassoc nsz arcp contract afn <4 x float> %reverse107, %wide.masked.gather123
  %i.jv = fadd reassoc nsz arcp contract afn <4 x float> %i.ju, %i.jt
  ...
  %i.jz = fadd reassoc nsz arcp contract afn <4 x float> %reverse109, %wide.masked.gather125
  %i.ka = fadd reassoc nsz arcp contract afn <4 x float> %i.jz, %i.jy
  ...
  %i.ke = fadd reassoc nsz arcp contract afn <4 x float> %reverse111, %wide.masked.gather127
  %i.kf = fadd reassoc nsz arcp contract afn <4 x float> %i.ke, %i.kd
...
._crit_edge.us.us.i15.i.i:                        ; preds = %._crit_edge.us.us.i15.i.i.preheader310, %._crit_edge.us.us.i15.i.i
  ...
  %i.ld = fadd reassoc nsz arcp contract afn <4 x float> %i.la, %i.kz
  %i.le = fadd reassoc nsz arcp contract afn <4 x float> %i.ld, %i.lc
...
vector.body182:                                   ; preds = %.lr.ph92.us.i.i.i, %vector.body182
  ...
  %i.lz = fadd reassoc nsz arcp contract afn <4 x float> %reverse189, %wide.masked.gather186
  %i.ma = fadd reassoc nsz arcp contract afn <4 x float> %i.lz, %i.ly
  ...
  %i.mg = fadd reassoc nsz arcp contract afn <4 x float> %reverse191, %wide.masked.gather207
  %i.mh = fadd reassoc nsz arcp contract afn <4 x float> %i.mg, %i.mf
  ...
  %i.ml = fadd reassoc nsz arcp contract afn <4 x float> %reverse193, %wide.masked.gather209
  ...
  %i.mq = fadd reassoc nsz arcp contract afn <4 x float> %reverse195, %wide.masked.gather211
...
scalar.ph173:                                     ; preds = %scalar.ph173.preheader, %scalar.ph173
  ...
  %i.np = fadd reassoc nsz arcp contract afn <4 x float> %i.nm, %i.nl
  %i.nq = fadd reassoc nsz arcp contract afn <4 x float> %i.np, %i.no
...
vector.body225:                                   ; preds = %.lr.ph.us103.i.i.i, %vector.body225
  ...
  %i.oj = fadd reassoc nsz arcp contract afn <4 x float> %strided.vec231, %wide.masked.gather229
  %i.ok = fadd reassoc nsz arcp contract afn <4 x float> %i.oj, %i.oi
  ...
  %i.oq = fadd reassoc nsz arcp contract afn <4 x float> %strided.vec232, %wide.masked.gather246
  %i.or = fadd reassoc nsz arcp contract afn <4 x float> %i.oq, %i.op
  ...
  %i.ov = fadd reassoc nsz arcp contract afn <4 x float> %strided.vec233, %wide.masked.gather248
  %i.ow = fadd reassoc nsz arcp contract afn <4 x float> %i.ov, %i.ou
  ...
  %i.pa = fadd reassoc nsz arcp contract afn <4 x float> %strided.vec234, %wide.masked.gather250
  %i.pb = fadd reassoc nsz arcp contract afn <4 x float> %i.pa, %i.oz
...
scalar.ph219:                                     ; preds = %scalar.ph219.preheader, %scalar.ph219
  ...
  %i.py = fadd reassoc nsz arcp contract afn <4 x float> %i.pv, %i.pu
  %i.pz = fadd reassoc nsz arcp contract afn <4 x float> %i.py, %i.px
...
vector.body77:                                    ; preds = %.lr.ph127.i.preheader, %vector.body77
  ...
  %i.lm = fadd reassoc nsz arcp contract afn <8 x float> %wide.load81, %reverse
  %i.ln = fadd reassoc nsz arcp contract afn <8 x float> %i.lm, %i.lj
...
.lr.ph127.i:                                      ; preds = %.lr.ph127.i.preheader240, %.lr.ph127.i
  ...
  %i.oa = fadd reassoc nsz arcp contract afn float %i.nz, %i.nv
