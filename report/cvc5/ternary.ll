...
bb.w:                                             ; preds = %bb.w, %.lr.ph110.new
  ...
  %3 = tail call noundef i32 @llvm.abs.i32(i32 %.sroa.062.0108, i1 true)
  %i.en = zext nneg i32 %3 to i64
  ...
  %i.eu = add nuw i32 %.sroa.062.0108, 1
  %4 = tail call noundef i32 @llvm.abs.i32(i32 %i.eu, i1 true)
  %5 = zext nneg i32 %4 to i64
  %6 = getelementptr inbounds nuw [4 x i8], ptr %i.ec, i64 %5
  %i.ev = load i32, ptr %6, align 1               ; 2 uses
  ...
  %i.fa = add nuw i32 %.sroa.062.0108, 2          ; 2 uses
