...
_ZN4cvc58internal12NodeTemplateILb0EEaSERKS2_.exit: ; preds = %_ZNSolsEj.exit, %_ZNKSt6vectorISt5tupleIJN4cvc58internal12NodeTemplateILb0EEEmiEESaIS5_EE12_M_check_lenEmPKc.exit.i
  %.sroa.0109.0.a = phi ptr [ %i.k, %_ZNKSt6vectorISt5tupleIJN4cvc58internal12NodeTemplateILb0EEEmiEESaIS5_EE12_M_check_lenEmPKc.exit.i ], [ %.sroa.0109.1.a, %_ZNSolsEj.exit ] ; 12 uses
  %.sroa.11.0.a = phi ptr [ %i.o, %_ZNKSt6vectorISt5tupleIJN4cvc58internal12NodeTemplateILb0EEEmiEESaIS5_EE12_M_check_lenEmPKc.exit.i ], [ %.sroa.11.4, %_ZNSolsEj.exit ] ; 13 uses
  %.sroa.34.0 = phi ptr [ %i.o, %_ZNKSt6vectorISt5tupleIJN4cvc58internal12NodeTemplateILb0EEEmiEESaIS5_EE12_M_check_lenEmPKc.exit.i ], [ %.sroa.34.1, %_ZNSolsEj.exit ] ; 12 uses
  %.sroa.0103.0 = phi ptr [ %i.j, %_ZNKSt6vectorISt5tupleIJN4cvc58internal12NodeTemplateILb0EEEmiEESaIS5_EE12_M_check_lenEmPKc.exit.i ], [ %spec.select, %_ZNSolsEj.exit ] ; 2 uses
  ...
  %i.q = getelementptr inbounds i8, ptr %.sroa.11.0.a, i64 -24 ; 6 uses
  %i.r = getelementptr inbounds i8, ptr %.sroa.11.0.a, i64 -8
  %i.s = load ptr, ptr %i.r, align 8, !tbaa !8    ; 2 uses
  %.not.i46 = icmp eq ptr %.sroa.0103.0, %i.s
  %spec.select = select i1 %.not.i46, ptr %.sroa.0103.0, ptr %i.s, !prof !23 ; 10 uses
  %i.t = getelementptr inbounds i8, ptr %.sroa.11.0.a, i64 -16 ; 3 uses
...
bb.ah:                                            ; preds = %bb.ag
  ...
  %.not.i64 = icmp eq ptr %.sroa.11.0.a, %.sroa.34.0
  br i1 %.not.i64, label %bb.aj, label %bb.ai

bb.ai:                                            ; preds = %bb.ah
  store i32 %i.dp, ptr %.sroa.11.0.a, align 8, !tbaa !51
  %i.dq = getelementptr inbounds nuw i8, ptr %.sroa.11.0.a, i64 8
  store i64 0, ptr %i.dq, align 8, !tbaa !53
  %i.dr = getelementptr inbounds nuw i8, ptr %.sroa.11.0.a, i64 16
  store ptr %i.dm, ptr %i.dr, align 8, !tbaa !8
  %i.ds = getelementptr inbounds nuw i8, ptr %.sroa.11.0.a, i64 24
  br label %_ZNSolsEj.exit

bb.aj:                                            ; preds = %bb.ah
  %i.dt = ptrtoint ptr %.sroa.11.0.a to i64
  %i.du = ptrtoint ptr %.sroa.0109.0.a to i64
...
.noexc96:                                         ; preds = %_ZNKSt6vectorISt5tupleIJN4cvc58internal12NodeTemplateILb0EEEmiEESaIS5_EE12_M_check_lenEmPKc.exit.i77
  ...
  %.not13.i.i.i.i.i.i80 = icmp eq ptr %.sroa.0109.0.a, %.sroa.11.0.a
...
.lr.ph.i.i.i.i.i.i81:                             ; preds = %.noexc96, %.lr.ph.i.i.i.i.i.i81
  ...
  %.01214.i.i.i.i.i.i83 = phi ptr [ %i.ek, %.lr.ph.i.i.i.i.i.i81 ], [ %.sroa.0109.0.a, %.noexc96 ] ; 3 uses
...
.noexc66:                                         ; preds = %.lr.ph.i.i.i.i.i.i81, %.noexc96
  ...
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0109.0.a, i64 noundef %i.dv) #25
...
_ZNSolsEj.exit:                                   ; preds = %bb.s, %bb.ai, %.noexc66, %_ZStlsIcSt11char_traitsIcESaIcEERSt13basic_ostreamIT_T0_ES7_RKNSt7__cxx1112basic_stringIS4_S5_T1_EE.exit, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %bb.ap, %bb.w
  %.sroa.0109.1.a = phi ptr [ %.sroa.0109.0.a, %bb.ai ], [ %.sroa.0109.0.a, %bb.w ], [ %.sroa.0109.0.a, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ %.sroa.0109.0.a, %_ZStlsIcSt11char_traitsIcESaIcEERSt13basic_ostreamIT_T0_ES7_RKNSt7__cxx1112basic_stringIS4_S5_T1_EE.exit ], [ %.sroa.0109.0.a, %bb.ap ], [ %i.ed, %.noexc66 ], [ %.sroa.0109.0.a, %bb.s ] ; 4 uses
  ...
  %.sroa.34.1 = phi ptr [ %.sroa.34.0, %bb.ai ], [ %.sroa.34.0, %bb.w ], [ %.sroa.34.0, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ %.sroa.34.0, %_ZStlsIcSt11char_traitsIcESaIcEERSt13basic_ostreamIT_T0_ES7_RKNSt7__cxx1112basic_stringIS4_S5_T1_EE.exit ], [ %.sroa.34.0, %bb.ap ], [ %i.en, %.noexc66 ], [ %.sroa.34.0, %bb.s ] ; 2 uses
  ...
  %i.ex = icmp eq ptr %.sroa.0109.1.a, %.sroa.11.4
...
_ZNSt6vectorISt5tupleIJN4cvc58internal12NodeTemplateILb0EEEmiEESaIS5_EED2Ev.exit: ; preds = %_ZNSolsEj.exit
  %i.ey = ptrtoint ptr %.sroa.34.1 to i64
  %i.ez = ptrtoint ptr %.sroa.0109.1.a to i64
  %i.fa = sub i64 %i.ey, %i.ez
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0109.1.a, i64 noundef %i.fa) #25
  ret void

.body:                                            ; preds = %bb.al, %bb.q, %bb.r, %bb.t, %bb.p, %.loopexit.split-lp, %.loopexit
  %.sroa.34.0168 = phi ptr [ %.sroa.34.0, %bb.q ], [ %.sroa.34.0, %bb.al ], [ %.sroa.34.0, %bb.p ], [ %.sroa.34.0, %bb.r ], [ %.sroa.34.0, %bb.t ], [ %.sroa.11.0.a, %.loopexit ], [ %.sroa.11.0.a, %.loopexit.split-lp ]
  ...
  %i.fc = ptrtoint ptr %.sroa.0109.0.a to i64
  %i.fd = sub i64 %i.fb, %i.fc
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0109.0.a, i64 noundef %i.fd) #25
  br label %_ZNSt6vectorISt5tupleIJN4cvc58internal12NodeTemplateILb0EEEmiEESaIS5_EED2Ev.exit73
