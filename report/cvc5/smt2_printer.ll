...
_ZN4cvc58internal12NodeTemplateILb0EEaSERKS2_.exit: ; preds = %_ZNSolsEj.exit, %_ZNKSt6vectorISt5tupleIJN4cvc58internal12NodeTemplateILb0EEEmiEESaIS5_EE12_M_check_lenEmPKc.exit.i
  %.sroa.0109.0.a = phi ptr [ %i.j, %_ZNKSt6vectorISt5tupleIJN4cvc58internal12NodeTemplateILb0EEEmiEESaIS5_EE12_M_check_lenEmPKc.exit.i ], [ %spec.select, %_ZNSolsEj.exit ] ; 2 uses
  %.sroa.11.0.a = phi ptr [ %i.o, %_ZNKSt6vectorISt5tupleIJN4cvc58internal12NodeTemplateILb0EEEmiEESaIS5_EE12_M_check_lenEmPKc.exit.i ], [ %.sroa.0109.1.a, %_ZNSolsEj.exit ] ; 11 uses
  %.sroa.34.0 = phi ptr [ %i.o, %_ZNKSt6vectorISt5tupleIJN4cvc58internal12NodeTemplateILb0EEEmiEESaIS5_EE12_M_check_lenEmPKc.exit.i ], [ %.sroa.11.4, %_ZNSolsEj.exit ] ; 8 uses
  %.sroa.0103.0 = phi ptr [ %i.k, %_ZNKSt6vectorISt5tupleIJN4cvc58internal12NodeTemplateILb0EEEmiEESaIS5_EE12_M_check_lenEmPKc.exit.i ], [ %.sroa.34.1, %_ZNSolsEj.exit ] ; 12 uses
  %.030 = phi i1 [ %5, %_ZNKSt6vectorISt5tupleIJN4cvc58internal12NodeTemplateILb0EEEmiEESaIS5_EE12_M_check_lenEmPKc.exit.i ], [ %.333, %_ZNSolsEj.exit ] ; 3 uses
  %i.q = getelementptr inbounds i8, ptr %.sroa.34.0, i64 -24 ; 6 uses
  %i.r = getelementptr inbounds i8, ptr %.sroa.34.0, i64 -8
  %i.s = load ptr, ptr %i.r, align 8, !tbaa !8    ; 2 uses
  %.not.i46 = icmp eq ptr %.sroa.0109.0.a, %i.s
  %spec.select = select i1 %.not.i46, ptr %.sroa.0109.0.a, ptr %i.s, !prof !23 ; 10 uses
  %i.t = getelementptr inbounds i8, ptr %.sroa.34.0, i64 -16 ; 3 uses
...
bb.f:                                             ; preds = %_ZN4cvc58internal12NodeTemplateILb0EEaSERKS2_.exit
  %brmerge.not = select i1 %.not, i1 %.030, i1 false
  %.030.mux = select i1 %.not, i1 true, i1 %.030
...
_ZNSolsEj.exit.thread:                            ; preds = %bb.f, %_ZN4cvc58internal12NodeTemplateILb1EED2Ev.exit
  %.131 = phi i1 [ true, %_ZN4cvc58internal12NodeTemplateILb1EED2Ev.exit ], [ %.030.mux, %bb.f ] ; 4 uses
...
bb.aa:                                            ; preds = %bb.u, %_ZN4cvc58internal12NodeTemplateILb0EEaSERKS2_.exit
  %.232 = phi i1 [ %.131, %bb.u ], [ %.030, %_ZN4cvc58internal12NodeTemplateILb0EEaSERKS2_.exit ] ; 3 uses
...
bb.ah:                                            ; preds = %bb.ag
  ...
  %.not.i64 = icmp eq ptr %.sroa.34.0, %.sroa.11.0.a
  br i1 %.not.i64, label %bb.aj, label %bb.ai

bb.ai:                                            ; preds = %bb.ah
  store i32 %i.dp, ptr %.sroa.34.0, align 8, !tbaa !51
  %i.dq = getelementptr inbounds nuw i8, ptr %.sroa.34.0, i64 8
  store i64 0, ptr %i.dq, align 8, !tbaa !53
  %i.dr = getelementptr inbounds nuw i8, ptr %.sroa.34.0, i64 16
  store ptr %i.dm, ptr %i.dr, align 8, !tbaa !8
  %i.ds = getelementptr inbounds nuw i8, ptr %.sroa.34.0, i64 24
  br label %_ZNSolsEj.exit

bb.aj:                                            ; preds = %bb.ah
  %i.dt = ptrtoint ptr %.sroa.11.0.a to i64
  %i.du = ptrtoint ptr %.sroa.0103.0 to i64
...
.noexc96:                                         ; preds = %_ZNKSt6vectorISt5tupleIJN4cvc58internal12NodeTemplateILb0EEEmiEESaIS5_EE12_M_check_lenEmPKc.exit.i77
  ...
  %.not13.i.i.i.i.i.i80 = icmp eq ptr %.sroa.0103.0, %.sroa.11.0.a
...
.lr.ph.i.i.i.i.i.i81:                             ; preds = %.noexc96, %.lr.ph.i.i.i.i.i.i81
  ...
  %.01214.i.i.i.i.i.i83 = phi ptr [ %i.ek, %.lr.ph.i.i.i.i.i.i81 ], [ %.sroa.0103.0, %.noexc96 ] ; 3 uses
  ...
  %.not.i.i.i.i.i.i84 = icmp eq ptr %i.ek, %.sroa.11.0.a
...
.noexc66:                                         ; preds = %.lr.ph.i.i.i.i.i.i81, %.noexc96
  ...
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0103.0, i64 noundef %i.dv) #25
...
_ZNSolsEj.exit:                                   ; preds = %bb.s, %bb.ai, %.noexc66, %_ZStlsIcSt11char_traitsIcESaIcEERSt13basic_ostreamIT_T0_ES7_RKNSt7__cxx1112basic_stringIS4_S5_T1_EE.exit, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %bb.ap, %bb.w
  %.sroa.0109.1.a = phi ptr [ %.sroa.11.0.a, %bb.ai ], [ %.sroa.11.0.a, %bb.w ], [ %.sroa.11.0.a, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ %.sroa.11.0.a, %_ZStlsIcSt11char_traitsIcESaIcEERSt13basic_ostreamIT_T0_ES7_RKNSt7__cxx1112basic_stringIS4_S5_T1_EE.exit ], [ %.sroa.11.0.a, %bb.ap ], [ %i.en, %.noexc66 ], [ %.sroa.11.0.a, %bb.s ] ; 2 uses
  %.sroa.11.4 = phi ptr [ %i.ds, %bb.ai ], [ %i.q, %bb.w ], [ %i.q, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ %i.q, %_ZStlsIcSt11char_traitsIcESaIcEERSt13basic_ostreamIT_T0_ES7_RKNSt7__cxx1112basic_stringIS4_S5_T1_EE.exit ], [ %i.q, %bb.ap ], [ %i.em, %.noexc66 ], [ %i.q, %bb.s ] ; 3 uses
  %.sroa.34.1 = phi ptr [ %.sroa.0103.0, %bb.ai ], [ %.sroa.0103.0, %bb.w ], [ %.sroa.0103.0, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ %.sroa.0103.0, %_ZStlsIcSt11char_traitsIcESaIcEERSt13basic_ostreamIT_T0_ES7_RKNSt7__cxx1112basic_stringIS4_S5_T1_EE.exit ], [ %.sroa.0103.0, %bb.ap ], [ %i.ed, %.noexc66 ], [ %.sroa.0103.0, %bb.s ] ; 3 uses
  %.333 = phi i1 [ %.232, %bb.ai ], [ %.131, %bb.w ], [ %.131, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ true, %_ZStlsIcSt11char_traitsIcESaIcEERSt13basic_ostreamIT_T0_ES7_RKNSt7__cxx1112basic_stringIS4_S5_T1_EE.exit ], [ %.232, %bb.ap ], [ %.232, %.noexc66 ], [ %.131, %bb.s ]
  %i.ex = icmp eq ptr %.sroa.34.1, %.sroa.11.4
...
_ZNSt6vectorISt5tupleIJN4cvc58internal12NodeTemplateILb0EEEmiEESaIS5_EED2Ev.exit: ; preds = %_ZNSolsEj.exit
  %i.ey = ptrtoint ptr %.sroa.0109.1.a to i64
  %i.ez = ptrtoint ptr %.sroa.11.4 to i64
  %i.fa = sub i64 %i.ey, %i.ez
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.34.1, i64 noundef %i.fa) #25
  ret void
...
.body:                                            ; preds = %bb.al, %bb.q, %bb.r, %bb.t, %bb.p, %.loopexit.split-lp, %.loopexit
  ...
  %i.fb = ptrtoint ptr %.sroa.11.0.a to i64
  %i.fc = ptrtoint ptr %.sroa.0103.0 to i64
  %i.fd = sub i64 %i.fb, %i.fc
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0103.0, i64 noundef %i.fd) #25
  br label %_ZNSt6vectorISt5tupleIJN4cvc58internal12NodeTemplateILb0EEEmiEESaIS5_EED2Ev.exit73
