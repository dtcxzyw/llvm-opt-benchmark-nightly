...
bb.f:                                             ; preds = %bb.b
  ...
  %i.aw = load ptr, ptr %i.at, align 8, !tbaa !179 ; 2 uses
  %i.ax = getelementptr inbounds nuw [8 x i8], ptr %i.aw, i64 %i.av
  %i.ay = load i64, ptr %i.ax, align 8, !tbaa !180
  %i.az = getelementptr inbounds nuw i8, ptr %0, i64 324
  %i.ba = load i32, ptr %i.az, align 4, !tbaa !164 ; 3 uses
  %i.bb = icmp sgt i32 %i.ba, %i.p
  br i1 %i.bb, label %.lr.ph, label %.thread

.lr.ph:                                           ; preds = %bb.f
  %i.bc = load ptr, ptr %i.i, align 8, !tbaa !171
  %sext = shl i64 %i.o, 32
...
bb.g:                                             ; preds = %.lr.ph, %bb.i
  ...
  %i.bg = load i32, ptr %i.bf, align 4, !tbaa !172 ; 2 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.bk = load i64, ptr %i.bj, align 8, !tbaa !180
...
bb.j:                                             ; preds = %.thread
  %i.br = getelementptr inbounds nuw i8, ptr %0, i64 4552 ; 2 uses
  %i.bs = zext nneg i32 %i.bp to i64
  %i.bt = load <2 x i64>, ptr %i.br, align 8, !tbaa !180
  %i.bu = insertelement <2 x i64> <i64 1, i64 poison>, i64 %i.bs, i64 1
  %i.bv = add nsw <2 x i64> %i.bt, %i.bu
  store <2 x i64> %i.bv, ptr %i.br, align 8, !tbaa !180
  br i1 %i.x, label %bb.k, label %bb.l

bb.k:                                             ; preds = %bb.j
  %i.bw = getelementptr inbounds nuw i8, ptr %0, i64 4568 ; 2 uses
  %i.bx = load i64, ptr %i.bw, align 8, !tbaa !181
  %i.by = add nsw i64 %i.bx, 1
  store i64 %i.by, ptr %i.bw, align 8, !tbaa !181
  br label %bb.l
