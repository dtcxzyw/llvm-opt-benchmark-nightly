...
.lr.ph.i.i:                                       ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit39, %bb.z
  %.02230.i.i = phi i32 [ %i.bv, %bb.z ], [ %i.bn, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit39 ] ; 5 uses
  %.02329.i.i = phi i32 [ %i.bw, %bb.z ], [ 1, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit39 ] ; 4 uses
  %i.bp = icmp ult i32 %.02230.i.i, 100
...
bb.v:                                             ; preds = %.lr.ph.i.i
  %i.br = icmp ult i32 %.02230.i.i, 1000
...
bb.x:                                             ; preds = %bb.v
  %i.bt = icmp ult i32 %.02230.i.i, 10000
...
bb.z:                                             ; preds = %bb.x
  %i.bv = udiv i32 %.02230.i.i, 10000
  %i.bw = add i32 %.02329.i.i, 4                  ; 2 uses
  %i.bx = icmp ult i32 %.02230.i.i, 100000
...
._crit_edge:                                      ; preds = %_ZN4cvc58internal12NodeTemplateILb1EED2Ev.exit288, %bb.ai
  %.sroa.17.0.lcssa.a = phi ptr [ null, %bb.ai ], [ %.sroa.17.1.a, %_ZN4cvc58internal12NodeTemplateILb1EED2Ev.exit288 ] ; 3 uses
  %.sroa.11.0.lcssa = phi ptr [ null, %bb.ai ], [ %.sroa.11.1, %_ZN4cvc58internal12NodeTemplateILb1EED2Ev.exit288 ] ; 2 uses
  %.sroa.0350.0.lcssa = phi ptr [ null, %bb.ai ], [ %.sroa.0350.1, %_ZN4cvc58internal12NodeTemplateILb1EED2Ev.exit288 ] ; 9 uses
  %.079.lcssa = phi i32 [ %i.cr, %bb.ai ], [ %.281, %_ZN4cvc58internal12NodeTemplateILb1EED2Ev.exit288 ] ; 2 uses
...
.lr.ph476:                                        ; preds = %.lr.ph476.preheader, %_ZN4cvc58internal12NodeTemplateILb1EED2Ev.exit288
  ...
  %.079474 = phi i32 [ %i.cr, %.lr.ph476.preheader ], [ %.281, %_ZN4cvc58internal12NodeTemplateILb1EED2Ev.exit288 ] ; 4 uses
  %.sroa.0350.0472 = phi ptr [ null, %.lr.ph476.preheader ], [ %.sroa.0350.1, %_ZN4cvc58internal12NodeTemplateILb1EED2Ev.exit288 ] ; 9 uses
  %.sroa.11.0470 = phi ptr [ null, %.lr.ph476.preheader ], [ %.sroa.11.1, %_ZN4cvc58internal12NodeTemplateILb1EED2Ev.exit288 ] ; 9 uses
  %.sroa.17.0468 = phi ptr [ null, %.lr.ph476.preheader ], [ %.sroa.17.1.a, %_ZN4cvc58internal12NodeTemplateILb1EED2Ev.exit288 ] ; 12 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %9) #22
...
.loopexit:                                        ; preds = %bb.ap, %bb.br, %_ZNKSt6vectorIjSaIjEE12_M_check_lenEmPKc.exit.i.i
  %.sroa.17.0468.lcssa481 = phi ptr [ %.sroa.17.0468, %bb.ap ], [ %.sroa.17.0468, %bb.br ], [ %.sroa.11.0470, %_ZNKSt6vectorIjSaIjEE12_M_check_lenEmPKc.exit.i.i ]
...
bb.cj:                                            ; preds = %_ZN4cvc58internal8TypeNodeD2Ev.exit258
  ...
  %.not.i283 = icmp eq ptr %.sroa.11.0470, %.sroa.17.0468
  br i1 %.not.i283, label %bb.cl, label %bb.ck

bb.ck:                                            ; preds = %bb.cj
  %i.je = load i32, ptr %i.jd, align 4, !tbaa !22
  store i32 %i.je, ptr %.sroa.11.0470, align 4, !tbaa !22
  %i.jf = getelementptr inbounds nuw i8, ptr %.sroa.11.0470, i64 4
  br label %_ZNSt6vectorIjSaIjEE9push_backERKj.exit

bb.cl:                                            ; preds = %bb.cj
  %i.jg = ptrtoint ptr %.sroa.11.0470 to i64
...
_ZNSt6vectorIjSaIjEE9push_backERKj.exit:          ; preds = %_ZN4cvc58internal8TypeNodeD2Ev.exit193, %_ZNSt6vectorIjSaIjEE17_M_realloc_insertIJRKjEEEvN9__gnu_cxx17__normal_iteratorIPjS1_EEDpOT_.exit.i, %bb.ck, %_ZN4cvc58internal8TypeNodeD2Ev.exit258, %.critedge374
  %.sroa.17.1.a = phi ptr [ %.sroa.17.0468, %.critedge374 ], [ %.sroa.17.0468, %bb.ck ], [ %.sroa.17.0468, %_ZN4cvc58internal8TypeNodeD2Ev.exit258 ], [ %i.jv, %_ZNSt6vectorIjSaIjEE17_M_realloc_insertIJRKjEEEvN9__gnu_cxx17__normal_iteratorIPjS1_EEDpOT_.exit.i ], [ %.sroa.17.0468, %_ZN4cvc58internal8TypeNodeD2Ev.exit193 ] ; 2 uses
  %.sroa.11.1 = phi ptr [ %.sroa.11.0470, %.critedge374 ], [ %i.jf, %bb.ck ], [ %.sroa.11.0470, %_ZN4cvc58internal8TypeNodeD2Ev.exit258 ], [ %i.ju, %_ZNSt6vectorIjSaIjEE17_M_realloc_insertIJRKjEEEvN9__gnu_cxx17__normal_iteratorIPjS1_EEDpOT_.exit.i ], [ %.sroa.11.0470, %_ZN4cvc58internal8TypeNodeD2Ev.exit193 ] ; 2 uses
  ...
  %.281 = phi i32 [ %i.gl, %.critedge374 ], [ %.079474, %bb.ck ], [ %.079474, %_ZN4cvc58internal8TypeNodeD2Ev.exit258 ], [ %.079474, %_ZNSt6vectorIjSaIjEE17_M_realloc_insertIJRKjEEEvN9__gnu_cxx17__normal_iteratorIPjS1_EEDpOT_.exit.i ], [ %.079474, %_ZN4cvc58internal8TypeNodeD2Ev.exit193 ] ; 2 uses
...
bb.cy:                                            ; preds = %.loopexit, %.loopexit.split-lp, %bb.bj, %bb.bo, %bb.bi, %bb.cu
  %.sroa.17.0468500 = phi ptr [ %.sroa.17.0468, %bb.bi ], [ %.sroa.17.0468, %bb.bo ], [ %.sroa.17.0468, %bb.bj ], [ %.sroa.17.0468, %bb.cu ], [ %.sroa.17.0468.lcssa481, %.loopexit ], [ %.sroa.11.0470, %.loopexit.split-lp ]
...
bb.cz:                                            ; preds = %bb.cy, %bb.bf
  %.sroa.17.0468499 = phi ptr [ %.sroa.17.0468500, %bb.cy ], [ %.sroa.17.0468, %bb.bf ]
  %.pn106.pn.pn = phi { ptr, i32 } [ %.pn106.pn, %bb.cy ], [ %i.fs, %bb.bf ]
  call void @llvm.lifetime.end.p0(ptr nonnull %9) #22
  br label %bb.dl

bb.da:                                            ; preds = %._crit_edge
  %i.kk = zext i32 %.079.lcssa to i64
  %.not = icmp eq i64 %i.da, %i.kk
  %i.kl = icmp eq ptr %.sroa.0350.0.lcssa, %.sroa.11.0.lcssa
...
bb.dc:                                            ; preds = %bb.db
  ...
  store i32 %.079.lcssa, ptr %i.kn, align 8, !tbaa !369
  %i.ko = getelementptr inbounds nuw i8, ptr %i.km, i64 16 ; 2 uses
  %i.kp = ptrtoint ptr %.sroa.11.0.lcssa to i64
...
bb.dk:                                            ; preds = %bb.dj
  %i.lc = ptrtoint ptr %.sroa.17.0.lcssa.a to i64
...
bb.dl:                                            ; preds = %bb.di, %bb.dh, %bb.cz
  %.sroa.17.0458 = phi ptr [ %.sroa.17.0468499, %bb.cz ], [ %.sroa.17.0.lcssa.a, %bb.di ], [ %.sroa.17.0.lcssa.a, %bb.dh ]
...
bb.dm:                                            ; preds = %bb.dl
  %i.lf = ptrtoint ptr %.sroa.17.0458 to i64
