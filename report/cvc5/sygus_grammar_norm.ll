...
._crit_edge:                                      ; preds = %_ZN4cvc58internal12NodeTemplateILb1EED2Ev.exit288, %bb.ai
  %.sroa.17.0.lcssa.a = phi ptr [ null, %bb.ai ], [ %.sroa.17.1.a, %_ZN4cvc58internal12NodeTemplateILb1EED2Ev.exit288 ] ; 2 uses
  %.sroa.11.0.lcssa = phi ptr [ null, %bb.ai ], [ %.sroa.11.1, %_ZN4cvc58internal12NodeTemplateILb1EED2Ev.exit288 ] ; 3 uses
...
bb.ck:                                            ; preds = %bb.cj
  ...
  store i32 %i.je, ptr %.sroa.17.0468, align 4, !tbaa !22
  %i.jf = getelementptr inbounds nuw i8, ptr %.sroa.17.0468, i64 4
  br label %_ZNSt6vectorIjSaIjEE9push_backERKj.exit
...
_ZNSt6vectorIjSaIjEE9push_backERKj.exit:          ; preds = %_ZN4cvc58internal8TypeNodeD2Ev.exit193, %_ZNSt6vectorIjSaIjEE17_M_realloc_insertIJRKjEEEvN9__gnu_cxx17__normal_iteratorIPjS1_EEDpOT_.exit.i, %bb.ck, %_ZN4cvc58internal8TypeNodeD2Ev.exit258, %.critedge374
  %.sroa.17.1.a = phi ptr [ %.sroa.17.0468, %.critedge374 ], [ %i.jf, %bb.ck ], [ %.sroa.17.0468, %_ZN4cvc58internal8TypeNodeD2Ev.exit258 ], [ %i.ju, %_ZNSt6vectorIjSaIjEE17_M_realloc_insertIJRKjEEEvN9__gnu_cxx17__normal_iteratorIPjS1_EEDpOT_.exit.i ], [ %.sroa.17.0468, %_ZN4cvc58internal8TypeNodeD2Ev.exit193 ] ; 2 uses
  %.sroa.11.1 = phi ptr [ %.sroa.11.0470, %.critedge374 ], [ %.sroa.11.0470, %bb.ck ], [ %.sroa.11.0470, %_ZN4cvc58internal8TypeNodeD2Ev.exit258 ], [ %i.jv, %_ZNSt6vectorIjSaIjEE17_M_realloc_insertIJRKjEEEvN9__gnu_cxx17__normal_iteratorIPjS1_EEDpOT_.exit.i ], [ %.sroa.11.0470, %_ZN4cvc58internal8TypeNodeD2Ev.exit193 ] ; 2 uses
...
bb.da:                                            ; preds = %._crit_edge
  ...
  %i.kl = icmp eq ptr %.sroa.0350.0.lcssa, %.sroa.17.0.lcssa.a
...
bb.dc:                                            ; preds = %bb.db
  ...
  %i.kp = ptrtoint ptr %.sroa.17.0.lcssa.a to i64
...
bb.dk:                                            ; preds = %bb.dj
  %i.lc = ptrtoint ptr %.sroa.11.0.lcssa to i64
...
bb.dl:                                            ; preds = %bb.di, %bb.dh, %bb.cz
  %.sroa.17.0458 = phi ptr [ %.sroa.11.0470, %bb.cz ], [ %.sroa.11.0.lcssa, %bb.di ], [ %.sroa.11.0.lcssa, %bb.dh ]
