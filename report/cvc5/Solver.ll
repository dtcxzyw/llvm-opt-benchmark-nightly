...
_ZN4cvc58internal7Minisat6Solver16uncheckedEnqueueENS1_3LitEj.exit: ; preds = %.noexc54, %bb.g, %bb.j, %_ZNSt6vectorIN4cvc58internal4prop10SatLiteralESaIS3_EED2Ev.exit64
  ...
  br i1 %exitcond.not, label %._crit_edge, label %bb.f, !llvm.loop !494
...
.preheader.i.i71:                                 ; preds = %bb.w
  ...
  store i32 0, ptr %i.cj, align 8, !tbaa !101
...
bb.x:                                             ; preds = %_ZN4cvc58internal7Minisat3vecINS1_3LitEED2Ev.exit72, %bb.d
  ...
  %i.ck = load ptr, ptr %2, align 8, !tbaa !363   ; 3 uses
...
bb.a:
  ...
  %i.d = load i32, ptr %i.c, align 8, !tbaa !101  ; 2 uses
...
bb.b:                                             ; preds = %bb.f, %.lr.ph.i
  ...
  %i.j = load ptr, ptr %i.b, align 8, !tbaa !102
  %i.k = getelementptr inbounds nuw [4 x i8], ptr %i.j, i64 %indvars.iv.i ; 2 uses
  %.sroa.0.0.copyload.i = load i32, ptr %i.k, align 4, !tbaa !79
  %i.l = load ptr, ptr %i.f, align 8, !tbaa !104
...
.lr.ph.i.i:                                       ; preds = %bb.c, %bb.e
  ...
  %i.v = load ptr, ptr %i.q, align 8, !tbaa !125  ; 2 uses
  %i.w = getelementptr inbounds nuw [8 x i8], ptr %i.v, i64 %indvars.iv.i.i ; 2 uses
  %i.x = load ptr, ptr %i.g, align 8, !tbaa !389, !nonnull !77, !align !130
  %i.y = load i32, ptr %i.w, align 4, !tbaa !379
  %i.z = load ptr, ptr %i.x, align 8, !tbaa !107
...
bb.d:                                             ; preds = %.lr.ph.i.i
  ...
  %.pre.i.i = load i32, ptr %i.r, align 8, !tbaa !126
  br label %bb.e
...
bb.e:                                             ; preds = %bb.d, %.lr.ph.i.i
  ...
  br i1 %i.al, label %.lr.ph.i.i, label %._crit_edge.i.i, !llvm.loop !8
...
.lr.ph.i.i.i:                                     ; preds = %._crit_edge.i.i
  ...
  store i32 %i.ap, ptr %i.r, align 8, !tbaa !126
...
_ZN4cvc58internal7Minisat8OccListsINS1_3LitENS1_3vecINS1_6Solver7WatcherEEENS5_14WatcherDeletedEE5cleanERKS3_.exit.i: ; preds = %.lr.ph.i.i.i, %._crit_edge.i.i, %bb.c
  %.sroa.0.0.copyload.i.i = load i32, ptr %i.k, align 4, !tbaa !79
  %i.aq = load ptr, ptr %i.f, align 8, !tbaa !104
  %i.ar = sext i32 %.sroa.0.0.copyload.i.i to i64
  %i.as = getelementptr inbounds i8, ptr %i.aq, i64 %i.ar
  store i8 0, ptr %i.as, align 1, !tbaa !98
  %.pre.i = load i32, ptr %i.c, align 8, !tbaa !101
  br label %bb.f
...
bb.f:                                             ; preds = %_ZN4cvc58internal7Minisat8OccListsINS1_3LitENS1_3vecINS1_6Solver7WatcherEEENS5_14WatcherDeletedEE5cleanERKS3_.exit.i, %bb.b
  ...
  br i1 %i.av, label %bb.b, label %._crit_edge.i, !llvm.loop !9
...
_ZN4cvc58internal7Minisat8OccListsINS1_3LitENS1_3vecINS1_6Solver7WatcherEEENS5_14WatcherDeletedEE8cleanAllEv.exit: ; preds = %._crit_edge.i, %.preheader.i.i
  ...
  %i.az = load i32, ptr %i.aw, align 8, !tbaa !376 ; 2 uses
  %i.ba = load i32, ptr %i.ay, align 8, !tbaa !101
...
bb.g:                                             ; preds = %.lr.ph170, %_ZN4cvc58internal7Minisat3vecINS1_6Solver7WatcherEE6shrinkEi.exit
  ...
  store i32 %i.bk, ptr %i.aw, align 8, !tbaa !376
  %i.bl = load ptr, ptr %i.ax, align 8, !tbaa !102
  ...
  %i.bp = load ptr, ptr %i.a, align 8, !tbaa !121
  ...
  %i.bt = load ptr, ptr %i.br, align 8, !tbaa !125 ; 6 uses
  %i.bu = getelementptr inbounds nuw i8, ptr %i.br, i64 8 ; 3 uses
  %i.bv = load i32, ptr %i.bu, align 8, !tbaa !126 ; 2 uses
...
bb.i:                                             ; preds = %bb.h
  ...
  br label %_ZN4cvc58internal7Minisat6Solver16uncheckedEnqueueENS1_3LitEj.exit, !llvm.loop !495

bb.j:                                             ; preds = %bb.h
  %i.cn = load i32, ptr %.068160, align 4, !tbaa !379 ; 5 uses
  %i.co = load ptr, ptr %i.bd, align 8, !tbaa !107
  ...
  %i.cs = load i32, ptr %i.cr, align 4, !tbaa !371 ; 2 uses
  %i.ct = icmp eq i32 %i.cs, %i.by
  br i1 %i.ct, label %bb.k, label %bb.l

bb.k:                                             ; preds = %bb.j
  %i.cu = getelementptr inbounds nuw i8, ptr %i.cq, i64 12 ; 2 uses
  %i.cv = load i32, ptr %i.cu, align 4, !tbaa !79 ; 2 uses
  store i32 %i.cv, ptr %i.cr, align 4, !tbaa !79
  store i32 %i.by, ptr %i.cu, align 4, !tbaa !79
  br label %bb.l
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.dc = load i8, ptr %i.da, align 1, !tbaa !373
  %i.dd = and i8 %i.db, 1
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.o
  ...
  %.sroa.03.0.copyload = load i32, ptr %i.dk, align 4, !tbaa !79 ; 3 uses
  ...
  %i.dp = load i8, ptr %i.dn, align 1, !tbaa !373
  %i.dq = and i8 %i.do, 1
...
bb.p:                                             ; preds = %.lr.ph
  ...
  store i32 %.sroa.03.0.copyload, ptr %i.dt, align 4, !tbaa !79
  store i32 %i.by, ptr %i.ds, align 4, !tbaa !79
  %.sroa.02.0.copyload = load i32, ptr %i.dt, align 4, !tbaa !79
  %i.du = xor i32 %.sroa.02.0.copyload, 1
  %i.dv = load ptr, ptr %i.a, align 8, !tbaa !121
  ...
  %i.dz = load i32, ptr %i.dy, align 8, !tbaa !126 ; 5 uses
  %i.ea = getelementptr inbounds nuw i8, ptr %i.dx, i64 12 ; 2 uses
  %i.eb = load i32, ptr %i.ea, align 4, !tbaa !368
...
._ZN4cvc58internal7Minisat3vecINS1_6Solver7WatcherEE8capacityEi.exit_crit_edge.i: ; preds = %bb.p
  %.pre.i100 = load ptr, ptr %i.dx, align 8, !tbaa !125
  br label %bb.s
...
bb.s:                                             ; preds = %._crit_edge183, %._ZN4cvc58internal7Minisat3vecINS1_6Solver7WatcherEE8capacityEi.exit_crit_edge.i
  ...
  store i32 %i.es, ptr %i.dy, align 8, !tbaa !126
...
bb.t:                                             ; preds = %._crit_edge
  %i.ff = load i32, ptr %i.ay, align 8, !tbaa !101
  store i32 %i.ff, ptr %i.aw, align 8, !tbaa !376
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.fr, label %middle.block, label %vector.body, !llvm.loop !497
...
.lr.ph156:                                        ; preds = %.lr.ph156.preheader220, %.lr.ph156
  ...
  br i1 %i.fv, label %.lr.ph156, label %_ZN4cvc58internal7Minisat6Solver16uncheckedEnqueueENS1_3LitEj.exit, !llvm.loop !498

bb.u:                                             ; preds = %._crit_edge
  store i8 %i.fc, ptr %i.ez, align 1, !tbaa !98
  %i.fw = load i32, ptr %i.be, align 8, !tbaa !99
  %i.fx = load i32, ptr %i.bf, align 8, !tbaa !71
  %i.fy = load ptr, ptr %i.bg, align 8, !tbaa !100
  %i.fz = getelementptr inbounds [20 x i8], ptr %i.fy, i64 %i.ey ; 4 uses
  %i.ga = load i32, ptr %i.ay, align 8, !tbaa !101
  store i32 %i.cn, ptr %i.fz, align 4, !tbaa !79
  %.sroa.4.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.fz, i64 4
  store i32 %i.fw, ptr %.sroa.4.0..sroa_idx.i, align 4, !tbaa !79
  %.sroa.5.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.fz, i64 8
  store i32 %i.fx, ptr %.sroa.5.0..sroa_idx.i, align 4, !tbaa !79
  %.sroa.7.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.fz, i64 16
  store i32 %i.ga, ptr %.sroa.7.0..sroa_idx.i, align 4, !tbaa !79
  %i.gb = load ptr, ptr %i.ax, align 8, !tbaa !102
  %i.gc = load i32, ptr %i.ay, align 8, !tbaa !101 ; 2 uses
  %i.gd = add nsw i32 %i.gc, 1
  store i32 %i.gd, ptr %i.ay, align 8, !tbaa !101
  %i.ge = sext i32 %i.gc to i64
  %i.gf = getelementptr inbounds [4 x i8], ptr %i.gb, i64 %i.ge
  store i32 %i.cw, ptr %i.gf, align 4, !tbaa !79
  %i.gg = load ptr, ptr %i.bh, align 8, !tbaa !103
  %i.gh = getelementptr inbounds i8, ptr %i.gg, i64 %i.ey
  %i.gi = load i8, ptr %i.gh, align 1, !tbaa !75, !range !76, !noundef !77
...
bb.v:                                             ; preds = %bb.u
  %i.gk = load ptr, ptr %i.bi, align 8, !tbaa !69
...
.lr.ph.i101:                                      ; preds = %._crit_edge164
  %.promoted.i = load i32, ptr %i.bu, align 8, !tbaa !126
  %i.gs = sub i32 %.promoted.i, %i.gq
  store i32 %i.gs, ptr %i.bu, align 8, !tbaa !126
...
_ZN4cvc58internal7Minisat3vecINS1_6Solver7WatcherEE6shrinkEi.exit: ; preds = %._crit_edge164, %.lr.ph.i101
  %i.gt = load i32, ptr %i.aw, align 8, !tbaa !376 ; 2 uses
  %i.gu = load i32, ptr %i.ay, align 8, !tbaa !101
  %i.gv = icmp slt i32 %i.gt, %i.gu
  br i1 %i.gv, label %bb.g, label %._crit_edge171.loopexit, !llvm.loop !499
...
._crit_edge171:                                   ; preds = %._crit_edge171.loopexit, %_ZN4cvc58internal7Minisat8OccListsINS1_3LitENS1_3vecINS1_6Solver7WatcherEEENS5_14WatcherDeletedEE8cleanAllEv.exit
  ...
  %i.gy = load i64, ptr %i.gx, align 8, !tbaa !390
  %i.gz = add nsw i64 %i.gy, %.067.lcssa
  store i64 %i.gz, ptr %i.gx, align 8, !tbaa !390
  %i.ha = getelementptr inbounds nuw i8, ptr %0, i64 624 ; 2 uses
  %i.hb = load i64, ptr %i.ha, align 8, !tbaa !391
  %i.hc = sub nsw i64 %i.hb, %.067.lcssa
  store i64 %i.hc, ptr %i.ha, align 8, !tbaa !391
  ret i32 %.0.lcssa
}
...
bb.a:
  ...
  %i.b = load double, ptr %i.a, align 8, !tbaa !90
  ...
  %i.i = load ptr, ptr %i.c, align 8, !tbaa !113
  ...
  %i.j = load i32, ptr %i.d, align 8, !tbaa !114  ; 2 uses
...
bb.b:                                             ; preds = %.lr.ph, %bb.h
  ...
  %i.o = load ptr, ptr %i.c, align 8, !tbaa !113  ; 2 uses
  %i.p = getelementptr inbounds nuw [4 x i8], ptr %i.o, i64 %indvars.iv
  %i.q = load i32, ptr %i.p, align 4, !tbaa !79   ; 4 uses
  %i.r = load ptr, ptr %i.h, align 8, !tbaa !107
