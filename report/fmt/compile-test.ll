...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.ch, align 1, !tbaa !76
  %wide.load31 = load <16 x i8>, ptr %i.ci, align 1, !tbaa !76
  %i.cj = getelementptr inbounds nuw i8, ptr %i.cd, i64 %index ; 2 uses
  %i.ck = getelementptr inbounds nuw i8, ptr %i.cj, i64 16
  store <16 x i8> %wide.load, ptr %i.cj, align 1, !tbaa !76
  store <16 x i8> %wide.load31, ptr %i.ck, align 1, !tbaa !76
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.cl = icmp eq i64 %index.next, %n.vec
  br i1 %i.cl, label %middle.block, label %vector.body, !llvm.loop !1248
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load34 = load <4 x i8>, ptr %i.cm, align 1, !tbaa !76
  %i.cn = getelementptr inbounds nuw i8, ptr %i.cd, i64 %index33
  store <4 x i8> %wide.load34, ptr %i.cn, align 1, !tbaa !76
  %index.next35 = add nuw i64 %index33, 4         ; 2 uses
  %i.co = icmp eq i64 %index.next35, %n.vec32
  br i1 %i.co, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !1249
...
.lr.ph.i.i.i.prol:                                ; preds = %.lr.ph.i.i.i.preheader, %.lr.ph.i.i.i.prol
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.i.prol.loopexit, label %.lr.ph.i.i.i.prol, !llvm.loop !1250
...
._crit_edge.loopexit.i.i.i:                       ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i.i.i = load i64, ptr %i.q, align 8, !tbaa !128
...
._crit_edge.i.i.i:                                ; preds = %._crit_edge.loopexit.i.i.i, %bb.l
  ...
  store i64 %i.cw, ptr %i.q, align 8, !tbaa !128
  %i.cx = getelementptr inbounds nuw i8, ptr %.02732.i.i.i, i64 %.025.i.i.i ; 2 uses
  %.not.i.i.i = icmp eq ptr %i.cx, %i.bm
  br i1 %.not.i.i.i, label %_ZN3fmt3v126detail17write_significandIcNS0_14basic_appenderIcEEEET0_S5_PKci.exit, label %bb.j, !llvm.loop !12
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i
  ...
  br i1 %exitcond.not.i.i.i.3, label %._crit_edge.loopexit.i.i.i, label %.lr.ph.i.i.i, !llvm.loop !1251
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.d = load double, ptr %i.c, align 8, !tbaa !288
...
bb.d:                                             ; preds = %bb.b
  ...
  %i.h = load double, ptr %i.g, align 8, !tbaa !288
...
_ZN3fmt3v126detail18to_nonnegative_intIdiTnNSt9enable_ifIXntsr3std11is_integralIT_EE5valueEiE4typeELi0EEET0_S4_S7_.exit: ; preds = %bb.d
  ...
  store i32 %i.k, ptr %i.p, align 8, !tbaa !266
...
bb.d:                                             ; preds = %bb.b
  ...
  %i.j = load double, ptr %i.i, align 8, !tbaa !288
...
bb.e:                                             ; preds = %bb.d
  ...
  invoke void @_ZN3fmt3v1212format_errorCI2St13runtime_errorEPKc(ptr noundef nonnull align 8 dereferenceable(16) %i.p, ptr noundef nonnull @.str.307)
          to label %bb.f unwind label %bb.g
...
bb.g:                                             ; preds = %bb.e
  %i.q = landingpad { ptr, i32 }
          cleanup
  tail call void @__cxa_free_exception(ptr nonnull %i.p) #28
  resume { ptr, i32 } %i.q
...
_ZN3fmt3v126detail18to_nonnegative_intIdiTnNSt9enable_ifIXntsr3std11is_integralIT_EE5valueEiE4typeELi0EEET0_S4_S7_.exit: ; preds = %bb.d
  ...
  store i32 %i.k, ptr %i.p, align 4, !tbaa !267
...
bb.c:                                             ; preds = %bb.b
  ...
  store ptr @_ZN3fmt3v1219basic_memory_bufferIcLm500ENS0_6detail9allocatorIcEEE4growERNS2_6bufferIcEEm, ptr %i.d, align 8, !tbaa !130
  %i.f = getelementptr inbounds nuw i8, ptr %4, i64 32 ; 3 uses
  store ptr %i.f, ptr %4, align 8, !tbaa !127
  store i64 500, ptr %i.c, align 8, !tbaa !129
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.h = load double, ptr %i.g, align 8, !tbaa !99 ; 3 uses
  %i.i = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.j = load i32, ptr %i.i, align 8, !tbaa !286  ; 2 uses
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #28
  store double %i.o, ptr %3, align 16, !tbaa !76
  %i.p = getelementptr inbounds nuw i8, ptr %3, i64 16
  store i32 %.0.i, ptr %i.p, align 16, !tbaa !76
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.r = load i8, ptr %i.q, align 8, !tbaa !285, !range !87, !noundef !88
  %i.s = trunc nuw i8 %i.r to i1
  br i1 %i.s, label %bb.g, label %bb.l

bb.g:                                             ; preds = %bb.f
  %.sroa.0.0.copyload.i = load ptr, ptr %0, align 8, !tbaa !134 ; 5 uses
  %i.t = getelementptr inbounds nuw i8, ptr %.sroa.0.0.copyload.i, i64 8 ; 3 uses
  %i.u = load i64, ptr %i.t, align 8, !tbaa !128  ; 2 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  invoke void %i.aa(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.0.0.copyload.i, i64 noundef %i.v)
          to label %.noexc unwind label %bb.k, !inline_history !38

.noexc:                                           ; preds = %bb.h
  %.pre.i.i = load i64, ptr %i.t, align 8, !tbaa !128 ; 2 uses
...
bb.i:                                             ; preds = %.noexc, %bb.g
  ...
  %i.ac = load ptr, ptr %.sroa.0.0.copyload.i, align 8, !tbaa !127
  store i64 %.pre-phi.i.i, ptr %i.t, align 8, !tbaa !128
  %i.ad = getelementptr inbounds nuw i8, ptr %i.ac, i64 %i.ab
  store i8 45, ptr %i.ad, align 1, !tbaa !76
  br label %bb.l
...
bb.l:                                             ; preds = %bb.i, %bb.f
  %i.ag = load i64, ptr %i.e, align 8, !tbaa !128 ; 3 uses
  %i.ah = icmp ult i64 %i.ag, 2
  br i1 %i.ah, label %bb.n, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.ai = load ptr, ptr %4, align 8, !tbaa !127   ; 3 uses
...
.thread:                                          ; preds = %bb.m
  %.sroa.01.0.copyload.pre = load ptr, ptr %0, align 8, !tbaa !134
  %i.am = getelementptr inbounds nuw i8, ptr %i.ai, i64 %i.ag
  br label %.lr.ph34.i.i

bb.n:                                             ; preds = %bb.m, %bb.l
  %.sroa.03.0.copyload = load ptr, ptr %0, align 8, !tbaa !134 ; 8 uses
