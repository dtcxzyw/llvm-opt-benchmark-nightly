...
begin_hunk_0_@_ZN3fmt3v126detail5writeIcNS0_14basic_appenderIcEEfTnNSt9enable_ifIXsr17is_floating_pointIT1_EE5valueEiE4typeELi0EEET0_S9_S6_NS0_12format_specsENS0_10locale_refE:bb.a
  ...
  store i64 1, ptr %i.az, align 8, !tbaa !255
  store i8 %i.bf, ptr %i.ba, align 8, !tbaa !26
  br label %bb.p
...
bb.q:                                             ; preds = %bb.p
  %i.bg = load ptr, ptr %11, align 8, !tbaa !240
  %i.bh = load i64, ptr %i.az, align 8, !tbaa !255 ; 3 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #28
  store ptr %i.bg, ptr %5, align 8, !tbaa !496
  %.sroa.2.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %5, i64 8
  store i64 %i.bh, ptr %.sroa.2.0..sroa_idx.i, align 8, !tbaa !256
...
bb.t:                                             ; preds = %bb.s
  invoke void @_ZN3fmt3v1212report_errorEPKc(ptr noundef nonnull @.str.400) #31
...
bb.w:                                             ; preds = %bb.v
  ...
  store i32 %i.bm, ptr %8, align 16, !tbaa !242
  br label %bb.aa
...
bb.y:                                             ; preds = %bb.x
  ...
  store i32 %i.bn, ptr %8, align 16, !tbaa !242
  br label %bb.aa
...
bb.ab:                                            ; preds = %bb.aa
  store i32 %.1, ptr %i.ar, align 4, !tbaa !244
  call void @llvm.lifetime.start.p0(ptr nonnull %12) #28
  %i.bp = load ptr, ptr %11, align 8, !tbaa !240
  store ptr %i.bp, ptr %12, align 8, !tbaa !1645
  %i.bq = getelementptr inbounds nuw i8, ptr %12, i64 8
  %i.br = load i64, ptr %i.az, align 8, !tbaa !255
  %i.bs = trunc i64 %i.br to i32
  store i32 %i.bs, ptr %i.bq, align 8, !tbaa !1647
  %i.bt = getelementptr inbounds nuw i8, ptr %12, i64 12
  store i32 %i.bo, ptr %i.bt, align 4, !tbaa !1648
...
bb.ae:                                            ; preds = %_ZN3fmt3v126detail11write_bytesIcLNS0_5alignE2ENS0_14basic_appenderIcEEEET1_S6_NS0_17basic_string_viewIcEERKNS0_12format_specsE.exit, %_ZN3fmt3v126detail11write_floatIcNS0_14basic_appenderIcEENS1_14big_decimal_fpEEET0_S6_RKT1_RKNS0_12format_specsENS0_4signEiNS0_10locale_refE.exit
  ...
  %i.bx = load ptr, ptr %11, align 8, !tbaa !240  ; 2 uses
...
bb.af:                                            ; preds = %bb.ae
  call void @free(ptr noundef %i.bx) #28
...
bb.ag:                                            ; preds = %bb.ac, %bb.ad, %bb.r
  ...
  %i.by = load ptr, ptr %11, align 8, !tbaa !240  ; 2 uses
...
bb.d:                                             ; preds = %bb.b, %bb.c, %bb.a
  ...
  %.str.407..str.408.i.i = select i1 %.not88, ptr @.str.408, ptr @.str.407
  br label %.split.i.i
...
.split.i.i:                                       ; preds = %.split.i.i, %bb.d
  ...
  %i.aa = getelementptr inbounds nuw i8, ptr %.str.407..str.408.i.i, i64 %i.z
  %i.ab = load i8, ptr %i.aa, align 1, !tbaa !26
  %i.ac = getelementptr inbounds i8, ptr %.0.i.i38, i64 -1 ; 2 uses
  store i8 %i.ab, ptr %i.ac, align 1, !tbaa !26
  %i.ad = lshr i64 %.012.i.i, 4                   ; 2 uses
  %.not.i.i = icmp eq i64 %i.ad, 0
  br i1 %.not.i.i, label %_ZN3fmt3v126detail13format_base2eIcmEEPT_iS4_T0_ib.exit.preheader, label %.split.i.i, !llvm.loop !1273
...
_ZN3fmt3v126detail13format_base2eIcmEEPT_iS4_T0_ib.exit: ; preds = %.lr.ph
  ...
  br i1 %.not89, label %.critedge, label %.lr.ph, !llvm.loop !1649
...
.critedge:                                        ; preds = %_ZN3fmt3v126detail13format_base2eIcmEEPT_iS4_T0_ib.exit, %.critedge.loopexit.split.loop.exit117, %_ZN3fmt3v126detail13format_base2eIcmEEPT_iS4_T0_ib.exit.preheader
  ...
  %i.ai = load i64, ptr %i.ah, align 8, !tbaa !255 ; 2 uses
  %i.aj = add i64 %i.ai, 1                        ; 3 uses
  %i.ak = getelementptr inbounds nuw i8, ptr %3, i64 16 ; 9 uses
  %i.al = load i64, ptr %i.ak, align 8, !tbaa !241
...
bb.e:                                             ; preds = %.critedge
  ...
  tail call void %i.ao(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.aj), !inline_history !1650
  %.pre.i = load i64, ptr %i.ah, align 8, !tbaa !255 ; 2 uses
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit:  ; preds = %.critedge, %bb.e
  ...
  %i.aq = load ptr, ptr %3, align 8, !tbaa !240
  store i64 %.pre-phi.i, ptr %i.ah, align 8, !tbaa !255
  ...
  %i.at = load i64, ptr %i.ah, align 8, !tbaa !255 ; 2 uses
  %i.au = add i64 %i.at, 1                        ; 3 uses
  %i.av = load i64, ptr %i.ak, align 8, !tbaa !241
...
bb.f:                                             ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit
  ...
  %i.ay = load ptr, ptr %i.ax, align 8, !tbaa !238
  tail call void %i.ay(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.au), !inline_history !1650
  %.pre.i40 = load i64, ptr %i.ah, align 8, !tbaa !255 ; 2 uses
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit42: ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit, %bb.f
  ...
  %i.ba = load ptr, ptr %3, align 8, !tbaa !240
  store i64 %.pre-phi.i39, ptr %i.ah, align 8, !tbaa !255
  %i.bb = getelementptr inbounds nuw i8, ptr %i.ba, i64 %i.az
  store i8 %i.as, ptr %i.bb, align 1, !tbaa !26
  %i.bc = load i64, ptr %i.ah, align 8, !tbaa !255 ; 2 uses
  %i.bd = add i64 %i.bc, 1                        ; 3 uses
  %i.be = load i64, ptr %i.ak, align 8, !tbaa !241
...
bb.g:                                             ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit42
  ...
  tail call void %i.bh(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.bd), !inline_history !1650
  %.pre.i44 = load i64, ptr %i.ah, align 8, !tbaa !255 ; 2 uses
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit46: ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit42, %bb.g
  ...
  %i.bj = load i8, ptr %i.a, align 16, !tbaa !26
  %i.bk = load ptr, ptr %3, align 8, !tbaa !240
  store i64 %.pre-phi.i43, ptr %i.ah, align 8, !tbaa !255
  %i.bl = getelementptr inbounds nuw i8, ptr %i.bk, i64 %i.bi
  store i8 %i.bj, ptr %i.bl, align 1, !tbaa !26
...
bb.h:                                             ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit46
  %i.bp = load i64, ptr %i.ah, align 8, !tbaa !255 ; 2 uses
  %i.bq = add i64 %i.bp, 1                        ; 3 uses
  %i.br = load i64, ptr %i.ak, align 8, !tbaa !241
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.bu = load ptr, ptr %i.bt, align 8, !tbaa !238
  tail call void %i.bu(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.bq), !inline_history !1650
  %.pre.i48 = load i64, ptr %i.ah, align 8, !tbaa !255 ; 2 uses
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit50: ; preds = %bb.h, %bb.i
  ...
  %i.bw = load ptr, ptr %3, align 8, !tbaa !240
  store i64 %.pre-phi.i47, ptr %i.ah, align 8, !tbaa !255
  %i.bx = getelementptr inbounds nuw i8, ptr %i.bw, i64 %i.bv
  store i8 46, ptr %i.bx, align 1, !tbaa !26
  br label %bb.j
...
.lr.ph34.i:                                       ; preds = %bb.j
  ...
  %.pre.i51 = load i64, ptr %i.ah, align 8, !tbaa !255
  br label %bb.k
...
bb.k:                                             ; preds = %._crit_edge.i, %.lr.ph34.i
  ...
  %i.ce = load i64, ptr %i.ak, align 8, !tbaa !241
...
bb.l:                                             ; preds = %bb.k
  %i.cj = load ptr, ptr %i.cc, align 8, !tbaa !238
  %i.ck = add i64 %i.ch, %i.cd
  call void %i.cj(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.ck), !inline_history !1651
  %i.cl = load i64, ptr %i.ah, align 8, !tbaa !255 ; 2 uses
  %i.cm = load i64, ptr %i.ak, align 8, !tbaa !241
...
bb.m:                                             ; preds = %bb.l, %bb.k
  ...
  %i.cp = load ptr, ptr %3, align 8, !tbaa !240   ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.cv, align 1, !tbaa !26
  %wide.load118 = load <16 x i8>, ptr %i.cw, align 1, !tbaa !26
  %i.cx = getelementptr inbounds nuw i8, ptr %i.cr, i64 %index ; 2 uses
  %i.cy = getelementptr inbounds nuw i8, ptr %i.cx, i64 16
  store <16 x i8> %wide.load, ptr %i.cx, align 1, !tbaa !26
  store <16 x i8> %wide.load118, ptr %i.cy, align 1, !tbaa !26
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.cz = icmp eq i64 %index.next, %n.vec
  br i1 %i.cz, label %middle.block, label %vector.body, !llvm.loop !1652
...
vec.epilog.iter.check:                            ; preds = %middle.block
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph.i.preheader, label %vec.epilog.ph, !prof !1102
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load121 = load <4 x i8>, ptr %i.da, align 1, !tbaa !26
  %i.db = getelementptr inbounds nuw i8, ptr %i.cr, i64 %index120
  store <4 x i8> %wide.load121, ptr %i.db, align 1, !tbaa !26
  %index.next122 = add nuw i64 %index120, 4       ; 2 uses
  %i.dc = icmp eq i64 %index.next122, %n.vec119
  br i1 %i.dc, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !1653
