...
begin_hunk_0_@_ZN23bigint_test_square_Test8TestBodyEv:_ZN3fmt3v126detail6bigintC2Em.exit
  call void %i.ix(ptr noundef nonnull align 8 dereferenceable(128) %i.iu) #30, !inline_history !0
...
_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEEC2EOS5_.exit: ; preds = %.noexc120, %bb.h, %_ZN3fmt3v126detail4copyIjPjS3_TnNSt9enable_ifIXoontcvNS1_23is_back_insert_iteratorIT1_St17integral_constantIbLb1EEEE_EntoocvNS1_10has_appendIS6_T0_vEE_EcvNS1_10has_insertIS6_SB_vEE_EEiE4typeELi0EEES6_SB_SB_S6_.exit.i.i
  ...
  store i64 %i.ae, ptr %i.ad, align 8, !tbaa !88
...
bb.k:                                             ; preds = %bb.j
  store ptr getelementptr inbounds nuw inrange(-16, 32) (i8, ptr @_ZTV17assertion_failure, i64 16), ptr %i.ag, align 8, !tbaa !45
...
_ZN3fmt3v126detail11to_unsignedIiEENSt13make_unsignedIT_E4typeES4_.exit: ; preds = %_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEEC2EOS5_.exit
  ...
  %i.aj = load i64, ptr %i.h, align 8, !tbaa !61  ; 2 uses
...
_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit: ; preds = %_ZN3fmt3v126detail11to_unsignedIiEENSt13make_unsignedIT_E4typeES4_.exit, %.noexc43
  ...
  store i64 %i.ao, ptr %i.a, align 8, !tbaa !88
...
.preheader53.lr.ph:                               ; preds = %_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit
  %i.ap = load ptr, ptr %1, align 8, !tbaa !60    ; 6 uses
...
bb.q:                                             ; preds = %.lr.ph146
  ...
  br i1 %i.cg, label %.lr.ph146, label %_ZN3fmt3v126detail11to_unsignedIiEENSt13make_unsignedIT_E4typeES4_.exit.i, !llvm.loop !6
...
.lr.ph146:                                        ; preds = %._crit_edge69, %bb.q
  ...
  br i1 %i.ck, label %bb.q, label %._ZN3fmt3v126detail11to_unsignedIiEENSt13make_unsignedIT_E4typeES4_.exit.i_crit_edge, !llvm.loop !6
...
bb.t:                                             ; preds = %.noexc47, %_ZN3fmt3v126detail11to_unsignedIiEENSt13make_unsignedIT_E4typeES4_.exit.i
  ...
  store i64 %i.dz, ptr %i.a, align 8, !tbaa !88
  %i.ea = getelementptr inbounds nuw i8, ptr %0, i64 168 ; 2 uses
  %i.eb = load i32, ptr %i.ea, align 8, !tbaa !65
  %i.ec = shl nsw i32 %i.eb, 1
  store i32 %i.ec, ptr %i.ea, align 8, !tbaa !65
  %i.ed = load ptr, ptr %1, align 8, !tbaa !60    ; 2 uses
...
.body:                                            ; preds = %bb.v, %bb.n, %bb.l
  ...
  %i.eg = load ptr, ptr %1, align 8, !tbaa !60    ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  store i32 1, ptr %i.e, align 4, !tbaa !87
...
bb.g:                                             ; preds = %bb.f
  ...
  tail call void %i.i(ptr noundef nonnull align 8 dereferenceable(172) %0, i64 noundef 1), !inline_history !377
  %.pre.i.i.i.i = load i64, ptr %i.f, align 8, !tbaa !61
...
bb.i:                                             ; preds = %bb.h
  ...
  tail call void %i.t(ptr noundef nonnull align 8 dereferenceable(172) %0, i64 noundef 1), !inline_history !377
  %.pre.i.i.i.i12 = load i64, ptr %i.q, align 8, !tbaa !61
...
_ZN3fmt3v126detail6bigintaSIiEEvT_.exit13:        ; preds = %bb.h, %bb.i
  ...
  store i64 %i.w, ptr %i.x, align 8, !tbaa !88
...
bb.k:                                             ; preds = %bb.j
  %i.ab = load i64, ptr %i.x, align 8, !tbaa !88  ; 7 uses
...
.lr.ph.i.i:                                       ; preds = %bb.k
  %i.ac = load ptr, ptr %0, align 8, !tbaa !60    ; 4 uses
...
.epil.preheader:                                  ; preds = %._crit_edge.i.i.unr-lcssa, %.lr.ph.i.i
  ...
  store i32 %i.aj, ptr %i.ae, align 4, !tbaa !87
...
bb.l:                                             ; preds = %bb.l, %.lr.ph.i.i.new
  ...
  store i32 %i.ar, ptr %i.am, align 4, !tbaa !87
