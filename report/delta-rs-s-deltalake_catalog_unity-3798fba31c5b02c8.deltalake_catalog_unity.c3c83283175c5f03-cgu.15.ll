...
.lr.ph:                                           ; preds = %.lr.ph29, %.split24.us
  %11 = phi ptr [ %39, %.split24.us ], [ %10, %.lr.ph29 ] ; 3 uses
  %storemerge26 = phi i64 [ %.fr31, %.split24.us ], [ %9, %.lr.ph29 ]
  %12 = getelementptr inbounds nuw i8, ptr %11, i64 24
  %13 = load atomic i64, ptr %12 monotonic, align 8
  %.fr31 = freeze i64 %13                         ; 3 uses
  %14 = load ptr, ptr %11, align 8, !nonnull !16, !noundef !16 ; 3 uses
  %15 = getelementptr inbounds nuw i8, ptr %11, i64 8
  %16 = load i64, ptr %15, align 8, !noundef !16
  %17 = getelementptr inbounds nuw [8 x i8], ptr %14, i64 %16 ; 2 uses
  %18 = icmp ult i64 %.fr31, 8
