...
.lr.ph:                                           ; preds = %.lr.ph29, %.split24.us
  ...
  %storemerge26 = phi i64 [ %.fr31, %.split24.us ], [ %9, %.lr.ph29 ] ; [#uses=1 type=i64]
  %12 = getelementptr inbounds nuw i8, ptr %11, i64 24 ; [#uses=1 type=ptr]
  %13 = load atomic i64, ptr %12 monotonic, align 8 ; [#uses=1 type=i64]
  %.fr31 = freeze i64 %13                         ; [#uses=3 type=i64]
  ...
  %18 = icmp ult i64 %.fr31, 8                    ; [#uses=1 type=i1]
