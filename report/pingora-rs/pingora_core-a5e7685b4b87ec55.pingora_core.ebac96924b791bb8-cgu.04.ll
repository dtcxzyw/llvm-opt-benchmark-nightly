...
.lr.ph.i.i.i:                                     ; preds = %.noexc.i.i
  ...
  %2 = zext i1 %i.en to i32
  %.sroa.04.0.i.i.i.i = add nuw nsw i32 %i.er, %2
  ...
  %i.ez = trunc nuw nsw i32 %.sroa.04.0.i.i.i.i to i8 ; 2 uses
  %i.fa = udiv i8 %i.ez, 10
  ...
  %i.gz = trunc nuw nsw i32 %i.dk to i16
  ...
  %spec.select.i131.i.i.i.i = zext nneg i16 %i.dn to i32 ; 2 uses
  %3 = add nuw nsw i32 %spec.select.i131.i.i.i.i, 7
  %.pn.i.i.i.i.i = select i1 %i.do, i32 %3, i32 %spec.select.i131.i.i.i.i
  %.sroa.0.0.neg.i.i.i.i.i = add nuw nsw i32 %i.dk, 6
  %4 = sub nsw i32 %.sroa.0.0.neg.i.i.i.i.i, %.pn.i.i.i.i.i
  %5 = trunc nsw i32 %4 to i16
  %.lhs.trunc1.i.i.i.i.i = add nsw i16 %5, 6
  ...
  %i.hz = insertelement <8 x i8> %i.hy, i8 %i.ez, i64 2
