...
_RNvMsa_NtNtCsiRgJJXJ4lb7_6brotli3enc10prior_evalNtB5_3CDF4cost.exit129: ; preds = %bb.b, %bb.c
  ...
  %6 = insertelement <4 x i8> poison, i8 %i.m, i64 0
  %7 = insertelement <4 x i8> %6, i8 %5, i64 1
  %8 = shufflevector <4 x i8> %7, <4 x i8> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 1>
  %9 = icmp ult <4 x i8> %8, <i8 1, i8 32, i8 48, i8 64>
  ...
  %10 = shufflevector <4 x i1> %9, <4 x i1> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.at = shufflevector <4 x i1> %i.an, <4 x i1> %i.ao, <8 x i32> <i32 0, i32 1, i32 2, i32 7, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.au = shufflevector <8 x i1> %10, <8 x i1> %i.at, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 9, i32 10, i32 11> ; 3 uses
...
_RNvMsa_NtNtCsiRgJJXJ4lb7_6brotli3enc10prior_evalNtB5_3CDF4cost.exit127: ; preds = %bb.f, %bb.g
  ...
  %11 = load <8 x i16>, ptr %i.cd, align 2, !noalias !1339
  %.sroa.0.i924.sroa.16.0..sroa.02523.0.2525.sroa_idx = getelementptr inbounds nuw i8, ptr %i.cd, i64 16 ; 2 uses
  %12 = insertelement <8 x i8> poison, i8 %i.ce, i64 0
  %13 = shufflevector <8 x i8> %12, <8 x i8> poison, <8 x i32> zeroinitializer
  %14 = icmp samesign ult <8 x i8> %13, <i8 1, i8 2, i8 3, i8 4, i8 5, i8 6, i8 7, i8 8> ; 2 uses
  %i.ct = insertelement <4 x i8> poison, i8 %i.ce, i64 0
  %i.cu = shufflevector <4 x i8> %i.ct, <4 x i8> poison, <4 x i32> zeroinitializer
  ...
  %i.da = select <8 x i1> %14, <8 x i16> %i.cz, <8 x i16> zeroinitializer ; 2 uses
  ...
  %i.dh = add <8 x i16> %i.da, %11                ; 2 uses
...
_RNvMsa_NtNtCsiRgJJXJ4lb7_6brotli3enc10prior_evalNtB5_3CDF4cost.exit115: ; preds = %bb.ab, %bb.ac
  ...
  %15 = load <8 x i16>, ptr %i.lt, align 2, !noalias !1375
  ...
  %i.mi = select <8 x i1> %14, <8 x i16> %i.mh, <8 x i16> zeroinitializer ; 5 uses
  ...
  %i.mp = add <8 x i16> %i.mi, %15                ; 2 uses
