...
_RINvMNtCsbvkFyIu7lgC_4core6optionINtB3_6OptionReE11map_or_elseNtNtCs6Po7BT7Nknu_5alloc6string6StringNCNvNtB12_3fmt6format0NvYeNtNtB12_6borrow7ToOwned8to_ownedECs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i: ; preds = %bb.aw
  ...
  %i.ed = load i64, ptr %i.ec, align 8, !noalias !1115, !noundef !12 ; 19 uses
...
_RNvNtNtCsbvkFyIu7lgC_4core3str7pattern13simd_contains.exit.i.i.i.i: ; preds = %bb.bh, %bb.bg, %bb.bb
...
bb.bg:                                            ; preds = %bb.bf
  %i.ey = call i64 @llvm.usub.sat.i64(i64 range(i64 2, 33) %i.ed, i64 4) ; 2 uses
  %3 = icmp ult i64 %i.ey, %i.ed
...
.lr.ph:                                           ; preds = %bb.bg, %bb.bh
  %i.fa = phi i64 [ %i.fb, %bb.bh ], [ %i.ed, %bb.bg ]
