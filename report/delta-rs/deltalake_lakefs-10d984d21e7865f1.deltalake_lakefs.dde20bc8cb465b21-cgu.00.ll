...
begin_hunk_0_@_RNCNvXs1_NtCsj34PGqTgg0L_16deltalake_lakefs8logstoreNtB7_14LakeFSLogStoreNtNtCs14kWLkQVSKO_14deltalake_core8logstore8LogStore18get_latest_version0B9_:bb.a
  store ptr %i.n, ptr %i.m, align 8, !noalias !1507
  %i.cv = getelementptr inbounds nuw i8, ptr %i.m, i64 8
  store ptr @218, ptr %i.cv, align 8, !noalias !1507
  %i.cw = invoke noundef zeroext i1 @_RNvXs_NtNtNtCskQDtHcQtBkN_5tokio7runtime4task5errorNtB4_9JoinErrorNtNtCsbvkFyIu7lgC_4core3fmt7Display3fmt(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.o, ptr noalias noundef nonnull align 8 dereferenceable(24) %i.m)
          to label %bb.ae unwind label %bb.ad, !noalias !1512
...
bb.ad:                                            ; preds = %bb.af, %bb.ac
  ...
  invoke void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6Po7BT7Nknu_5alloc6string6StringECsj34PGqTgg0L_16deltalake_lakefs(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.n) #32
          to label %.body.i.i.i unwind label %bb.ag, !noalias !1512
...
bb.af:                                            ; preds = %bb.ae
  invoke void @_RNvNtCsbvkFyIu7lgC_4core6result13unwrap_failed(ptr noalias noundef nonnull readonly captures(address, read_provenance) @219, i64 noundef 55, ptr noundef nonnull %i.a, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) @78, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @221) #36
          to label %.noexc.i.i.i.i unwind label %bb.ad, !noalias !1512
...
bb.ag:                                            ; preds = %bb.ad
  ...
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #30, !noalias !1512
  unreachable
...
.body.i.i.i:                                      ; preds = %bb.ad
  invoke void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtNtCskQDtHcQtBkN_5tokio7runtime4task5error9JoinErrorECsj34PGqTgg0L_16deltalake_lakefs(ptr noalias noundef nonnull readonly align 8 dereferenceable(24) %i.ct) #32
          to label %.body28.i unwind label %bb.ao, !noalias !1483

bb.ah:                                            ; preds = %bb.ae
  %.sroa.4.i.sroa.0.0.copyload.i = load i64, ptr %i.n, align 8, !noalias !1513
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.4.i.sroa.4.i, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.42.0..sroa_idx.i.i.i.i, i64 16, i1 false), !noalias !1513
  ...
  %.val.i.i.i.i = load ptr, ptr %i.cz, align 8, !alias.scope !1517, !noalias !1518, !noundef !3 ; 4 uses
  %i.da = getelementptr inbounds nuw i8, ptr %i.o, i64 16
  %.val1.i.i.i.i = load ptr, ptr %i.da, align 8, !alias.scope !1517, !noalias !1518 ; 6 uses
...
bb.ai:                                            ; preds = %bb.ah
  ...
  %i.dc = load ptr, ptr %.val1.i.i.i.i, align 8, !invariant.load !3, !noalias !1519 ; 2 uses
...
bb.aj:                                            ; preds = %bb.ai
  invoke void %i.dc(ptr noundef nonnull %.val.i.i.i.i)
          to label %bb.ak unwind label %bb.am, !noalias !1519

bb.ak:                                            ; preds = %bb.aj, %bb.ai
  %i.dd = getelementptr inbounds nuw i8, ptr %.val1.i.i.i.i, i64 8
  %i.de = load i64, ptr %i.dd, align 8, !range !4, !invariant.load !3, !noalias !1519 ; 2 uses
  %i.df = icmp eq i64 %i.de, 0
  br i1 %i.df, label %bb.eq, label %bb.al

bb.al:                                            ; preds = %bb.ak
  %i.dg = getelementptr inbounds nuw i8, ptr %.val1.i.i.i.i, i64 16
  %i.dh = load i64, ptr %i.dg, align 8, !range !5, !invariant.load !3, !noalias !1519
  call void @_RNvCs8mYq7K4qqSA_7___rustc14___rust_dealloc(ptr noundef nonnull %.val.i.i.i.i, i64 noundef range(i64 1, 0) %i.de, i64 noundef range(i64 1, 536870913) %i.dh) #31, !noalias !1519
  br label %bb.eq
...
bb.am:                                            ; preds = %bb.aj
  ...
  %i.dk = load i64, ptr %i.dj, align 8, !range !4, !invariant.load !3, !noalias !1519 ; 2 uses
  %i.dl = icmp eq i64 %i.dk, 0
  br i1 %i.dl, label %.body28.i, label %bb.an

bb.an:                                            ; preds = %bb.am
  %i.dm = getelementptr inbounds nuw i8, ptr %.val1.i.i.i.i, i64 16
  %i.dn = load i64, ptr %i.dm, align 8, !range !5, !invariant.load !3, !noalias !1519
  call void @_RNvCs8mYq7K4qqSA_7___rustc14___rust_dealloc(ptr noundef nonnull %.val.i.i.i.i, i64 noundef range(i64 1, 0) %i.dk, i64 noundef range(i64 1, 536870913) %i.dn) #31, !noalias !1519
  br label %.body28.i

bb.ao:                                            ; preds = %.body.i.i.i
  %i.do = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #30, !noalias !1520
  unreachable
...
bb.ap:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtNtCskQDtHcQtBkN_5tokio7runtime4task4join10JoinHandleINtNtB4_6result6ResultNtNtCs8ulvy0Wg6Ot_12delta_kernel11log_segment10LogSegmentNtNtB23_5error5ErrorEEECsj34PGqTgg0L_16deltalake_lakefs.exit19.i
  ...
  %.sroa.1148.0.copyload.i = load i64, ptr %.sroa.1148.0..sroa_idx.i, align 16, !noalias !1479
  %i.dp = load <2 x i64>, ptr %i.ct, align 8, !noalias !1479
  %.sroa.1349.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.p, i64 24
  %.sroa.1349.sroa.0.0.copyload.i = load i64, ptr %.sroa.1349.0..sroa_idx.i, align 8, !noalias !1479 ; 2 uses
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.10.sroa.11.sroa.10.i, ptr noundef nonnull align 16 dereferenceable(16) %.sroa.1349.sroa.10.0..sroa.1349.0..sroa_idx.sroa_idx.i, i64 16, i1 false), !noalias !1479
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(64) %.sroa.10.sroa.13.i, ptr noundef nonnull align 16 dereferenceable(64) %.sroa.14.0..sroa_idx.i, i64 64, i1 false), !noalias !1479
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %.sroa.9.i, ptr noundef nonnull align 16 dereferenceable(16) %.sroa.1349.sroa.10.0..sroa.1349.0..sroa_idx.sroa_idx.i, i64 16, i1 false), !noalias !1479
  %.sroa.9.48..sroa_idx.i = getelementptr inbounds nuw i8, ptr %.sroa.9.i, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(64) %.sroa.9.48..sroa_idx.i, ptr noundef nonnull align 16 dereferenceable(64) %.sroa.14.0..sroa_idx.i, i64 64, i1 false), !noalias !1479
...
bb.aq:                                            ; preds = %bb.ap
  call void @llvm.lifetime.start.p0(ptr nonnull %i.l), !noalias !1524
  store i64 %.sroa.1148.0.copyload.i, ptr %i.l, align 16, !noalias !1527
  %.sroa.7.16..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.l, i64 8
  store i64 %.sroa.1349.sroa.0.0.copyload.i, ptr %.sroa.7.16..sroa_idx.i, align 8, !noalias !1527
  %.sroa.9.16..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.l, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(80) %.sroa.9.16..sroa_idx.i, ptr noundef nonnull align 16 dereferenceable(80) %.sroa.9.i, i64 80, i1 false), !noalias !1527
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.6.i.i)
  call void @llvm.experimental.noalias.scope.decl(metadata !1528)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.k), !noalias !1531
  call void @llvm.lifetime.start.p0(ptr nonnull %i.g), !noalias !1534
  store i64 0, ptr %i.g, align 8, !noalias !1534
  %.sroa.42.0..sroa_idx.i.i.i20.i = getelementptr inbounds nuw i8, ptr %i.g, i64 8
  store ptr inttoptr (i64 1 to ptr), ptr %.sroa.42.0..sroa_idx.i.i.i20.i, align 8, !noalias !1534
  %.sroa.53.0..sroa_idx.i.i.i21.i = getelementptr inbounds nuw i8, ptr %i.g, i64 16
  store i64 0, ptr %.sroa.53.0..sroa_idx.i.i.i21.i, align 8, !noalias !1534
  call void @llvm.lifetime.start.p0(ptr nonnull %i.f), !noalias !1534
  %i.ds = getelementptr inbounds nuw i8, ptr %i.f, i64 16
  store i32 1610612768, ptr %i.ds, align 8, !noalias !1534
  %.sroa.4.0..sroa_idx.i.i.i22.i = getelementptr inbounds nuw i8, ptr %i.f, i64 20
  store i16 0, ptr %.sroa.4.0..sroa_idx.i.i.i22.i, align 4, !noalias !1534
  %.sroa.5.0..sroa_idx.i.i.i23.i = getelementptr inbounds nuw i8, ptr %i.f, i64 22
  store i16 0, ptr %.sroa.5.0..sroa_idx.i.i.i23.i, align 2, !noalias !1534
  store ptr %i.g, ptr %i.f, align 8, !noalias !1534
  %i.dt = getelementptr inbounds nuw i8, ptr %i.f, i64 8
  store ptr @218, ptr %i.dt, align 8, !noalias !1534
  %i.du = invoke noundef zeroext i1 @_RNvXs2_NtCs8ulvy0Wg6Ot_12delta_kernel5errorNtB5_5ErrorNtNtCsbvkFyIu7lgC_4core3fmt7Display3fmt(ptr noalias noundef nonnull readonly align 16 captures(address, read_provenance) dereferenceable(96) %i.l, ptr noalias noundef nonnull align 8 dereferenceable(24) %i.f)
          to label %bb.as unwind label %bb.ar, !noalias !1538
...
bb.ar:                                            ; preds = %bb.at, %bb.aq
  ...
  invoke void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6Po7BT7Nknu_5alloc6string6StringECsj34PGqTgg0L_16deltalake_lakefs(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.g) #32
          to label %.body.i.i24.i unwind label %bb.au, !noalias !1539
...
bb.at:                                            ; preds = %bb.as
  invoke void @_RNvNtCsbvkFyIu7lgC_4core6result13unwrap_failed(ptr noalias noundef nonnull readonly captures(address, read_provenance) @219, i64 noundef 55, ptr noundef nonnull %i.a, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) @78, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @221) #36
          to label %.noexc.i.i.i27.i unwind label %bb.ar, !noalias !1539
...
bb.au:                                            ; preds = %bb.ar
  %i.dw = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #30, !noalias !1539
  unreachable
...
.body.i.i24.i:                                    ; preds = %bb.dp, %bb.dk, %bb.di, %.body24.i.i.i, %bb.av, %bb.ar
  ...
  invoke void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs8ulvy0Wg6Ot_12delta_kernel5error5ErrorECsj34PGqTgg0L_16deltalake_lakefs(ptr noalias noundef nonnull align 16 dereferenceable(96) %i.l) #32
          to label %.body28.i unwind label %bb.dr, !noalias !1540
...
bb.aw:                                            ; preds = %bb.as
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.k, ptr noundef nonnull align 8 dereferenceable(24) %i.g, i64 24, i1 false), !noalias !1541
  call void @llvm.lifetime.end.p0(ptr nonnull %i.f), !noalias !1534
  call void @llvm.lifetime.end.p0(ptr nonnull %i.g), !noalias !1534
  %i.dy = getelementptr inbounds nuw i8, ptr %i.k, i64 8
  %i.dz = load ptr, ptr %i.dy, align 8, !noalias !1531, !nonnull !3, !noundef !3 ; 10 uses
  %i.ea = getelementptr inbounds nuw i8, ptr %i.k, i64 16
  %i.eb = load i64, ptr %i.ea, align 8, !noalias !1531, !noundef !3 ; 16 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.j), !noalias !1531
  call void @llvm.lifetime.start.p0(ptr nonnull %i.i), !noalias !1531
  call void @llvm.lifetime.start.p0(ptr nonnull %i.h), !noalias !1531
  store ptr %i.dq, ptr %i.h, align 8, !noalias !1531
  %.sroa.42.0..sroa_idx.i.i.i = getelementptr inbounds nuw i8, ptr %i.h, i64 8
  store ptr @_RNvXse_NtNtNtCsbvkFyIu7lgC_4core3fmt3num3impxNtB9_7Display3fmt, ptr %.sroa.42.0..sroa_idx.i.i.i, align 8, !noalias !1531
  invoke void @_RNvNvNtCs6Po7BT7Nknu_5alloc3fmt6format12format_inner(ptr noalias noundef nonnull sret([24 x i8]) align 8 captures(none) dereferenceable(24) %i.i, ptr noundef nonnull @22, ptr noundef nonnull %i.h)
          to label %_RINvMNtCsbvkFyIu7lgC_4core6optionINtB3_6OptionReE11map_or_elseNtNtCs6Po7BT7Nknu_5alloc6string6StringNCNvNtB12_3fmt6format0NvYeNtNtB12_6borrow7ToOwned8to_ownedECsj34PGqTgg0L_16deltalake_lakefs.exit.i.i.i unwind label %bb.ax, !noalias !1540
...
.body24.i.i.i:                                    ; preds = %bb.dg, %bb.de, %.loopexit.split-lp.i.i.i, %bb.ax
  ...
  invoke void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6Po7BT7Nknu_5alloc6string6StringECsj34PGqTgg0L_16deltalake_lakefs(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.k) #32
          to label %.body.i.i24.i unwind label %bb.dr, !noalias !1540
...
_RINvMNtCsbvkFyIu7lgC_4core6optionINtB3_6OptionReE11map_or_elseNtNtCs6Po7BT7Nknu_5alloc6string6StringNCNvNtB12_3fmt6format0NvYeNtNtB12_6borrow7ToOwned8to_ownedECsj34PGqTgg0L_16deltalake_lakefs.exit.i.i.i: ; preds = %bb.aw
  call void @llvm.lifetime.end.p0(ptr nonnull %i.h), !noalias !1531
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.j, ptr noundef nonnull align 8 dereferenceable(24) %i.i, i64 24, i1 false), !noalias !1531
  call void @llvm.lifetime.end.p0(ptr nonnull %i.i), !noalias !1531
  %i.ed = getelementptr inbounds nuw i8, ptr %i.j, i64 8
  %i.ee = load ptr, ptr %i.ed, align 8, !noalias !1531, !nonnull !3, !noundef !3 ; 9 uses
  %i.ef = getelementptr inbounds nuw i8, ptr %i.j, i64 16
  %i.eg = load i64, ptr %i.ef, align 8, !noalias !1531, !noundef !3 ; 18 uses
...
bb.bc:                                            ; preds = %bb.az
  %i.em = load i8, ptr %i.ee, align 1, !alias.scope !1542, !noalias !1547, !noundef !3 ; 2 uses
...
bb.bd:                                            ; preds = %bb.bc
  %i.eo = invoke { i64, i64 } @_RNvNtNtCsbvkFyIu7lgC_4core5slice6memchr14memchr_aligned(i8 noundef %i.em, ptr noalias noundef nonnull readonly captures(address, read_provenance) %i.dz, i64 noundef range(i64 0, -9223372036854775808) %i.eb)
          to label %.noexc.i.i.i unwind label %.loopexit.split-lp.loopexit.split-lp.i.i.i, !noalias !1540
...
.lr.ph.i.i.i.i.i:                                 ; preds = %bb.bc, %bb.be
  ...
  %i.et = load i8, ptr %i.es, align 1, !alias.scope !1548, !noalias !1551, !noundef !3
...
_RNvNtNtCsbvkFyIu7lgC_4core3str7pattern13simd_contains.exit.i.i.i.i: ; preds = %bb.cp, %bb.bb
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e), !noalias !1552
  invoke void @_RNvMsu_NtNtCsbvkFyIu7lgC_4core3str7patternNtB5_11StrSearcher3new(ptr noalias noundef nonnull sret([104 x i8]) align 8 captures(none) dereferenceable(104) %i.e, ptr noalias noundef nonnull readonly captures(address, read_provenance) %i.dz, i64 noundef %i.eb, ptr noalias noundef nonnull readonly captures(address, read_provenance) %i.ee, i64 noundef %i.eg)
          to label %.noexc9.i.i.i unwind label %.loopexit.split-lp.loopexit.split-lp.i.i.i, !noalias !1540
...
.noexc9.i.i.i:                                    ; preds = %_RNvNtNtCsbvkFyIu7lgC_4core3str7pattern13simd_contains.exit.i.i.i.i
  ...
  %i.ew = load i64, ptr %i.e, align 8, !range !9, !alias.scope !1553, !noalias !1556, !noundef !3
...
.preheader.i4.i.i.i.i:                            ; preds = %.noexc9.i.i.i
  ...
  %i.fa = load i8, ptr %i.ez, align 2, !range !295, !alias.scope !1558, !noalias !1561, !noundef !3
...
.lr.ph.i5.i.i.i.i:                                ; preds = %.preheader.i4.i.i.i.i
  %.promoted.i.i.i.i.i = load i64, ptr %i.ey, align 8, !alias.scope !1553, !noalias !1556 ; 12 uses
  %i.fc = getelementptr inbounds nuw i8, ptr %i.e, i64 24
  %i.fd = getelementptr inbounds nuw i8, ptr %i.e, i64 72
  %i.fe = load ptr, ptr %i.fd, align 8, !alias.scope !1558, !noalias !1561, !nonnull !3, !noundef !3 ; 5 uses
  %i.ff = getelementptr inbounds nuw i8, ptr %i.e, i64 80
  %i.fg = load i64, ptr %i.ff, align 8, !alias.scope !1558, !noalias !1561, !noundef !3 ; 14 uses
  %.promoted26.i.i.i.i.i = load i8, ptr %i.fc, align 8, !alias.scope !1558, !noalias !1561 ; 2 uses
...
bb.bg:                                            ; preds = %bb.bf
  ...
  %i.fl = load i8, ptr %i.fk, align 1, !alias.scope !1563, !noalias !1566, !noundef !3
...
bb.bi:                                            ; preds = %bb.bh
  %i.fp = load i8, ptr %i.fn, align 1, !noalias !1568, !noundef !3 ; 5 uses
...
_RNvXs2J_NtNtCsbvkFyIu7lgC_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits8iterator8Iterator4nextCsj34PGqTgg0L_16deltalake_lakefs.exit12.i.i.i.peel.i.i.i.i: ; preds = %bb.bi
  ...
  %i.fw = load i8, ptr %i.fr, align 1, !noalias !1568, !noundef !3
...
_RNvXs2J_NtNtCsbvkFyIu7lgC_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits8iterator8Iterator4nextCsj34PGqTgg0L_16deltalake_lakefs.exit14.i.i.i.peel.i.i.i.i: ; preds = %_RNvXs2J_NtNtCsbvkFyIu7lgC_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits8iterator8Iterator4nextCsj34PGqTgg0L_16deltalake_lakefs.exit12.i.i.i.peel.i.i.i.i
  ...
  %i.gf = load i8, ptr %i.gc, align 1, !noalias !1568, !noundef !3
...
_RNvXs2J_NtNtCsbvkFyIu7lgC_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits8iterator8Iterator4nextCsj34PGqTgg0L_16deltalake_lakefs.exit16.i.i.i.peel.i.i.i.i: ; preds = %_RNvXs2J_NtNtCsbvkFyIu7lgC_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits8iterator8Iterator4nextCsj34PGqTgg0L_16deltalake_lakefs.exit14.i.i.i.peel.i.i.i.i
  ...
  %i.gq = load i8, ptr %i.gn, align 1, !noalias !1568, !noundef !3
...
bb.bo:                                            ; preds = %.noexc9.i.i.i
  ...
  %i.he = load i64, ptr %i.hd, align 8, !alias.scope !1553, !noalias !1556, !noundef !3 ; 2 uses
  %i.hf = icmp eq i64 %i.he, -1
  %i.hg = getelementptr inbounds nuw i8, ptr %i.e, i64 72
  %i.hh = load ptr, ptr %i.hg, align 8, !alias.scope !1553, !noalias !1556, !nonnull !3, !noundef !3 ; 6 uses
  %i.hi = getelementptr inbounds nuw i8, ptr %i.e, i64 80
  %i.hj = load i64, ptr %i.hi, align 8, !alias.scope !1553, !noalias !1556, !noundef !3 ; 14 uses
  %i.hk = getelementptr inbounds nuw i8, ptr %i.e, i64 88
  %i.hl = load ptr, ptr %i.hk, align 8, !alias.scope !1553, !noalias !1556, !nonnull !3, !noundef !3 ; 4 uses
  %i.hm = getelementptr inbounds nuw i8, ptr %i.e, i64 96
  %i.hn = load i64, ptr %i.hm, align 8, !alias.scope !1553, !noalias !1556, !noundef !3 ; 12 uses
...
bb.br:                                            ; preds = %bb.bq
  ...
  %i.hu = load i8, ptr %i.ht, align 1, !alias.scope !1563, !noalias !1572, !noundef !3
...
bb.bt:                                            ; preds = %bb.bs
  ...
  %i.hy = load i8, ptr %i.hx, align 1, !noalias !1573, !noundef !3 ; 3 uses
...
.loopexit.i.i.i.i:                                ; preds = %bb.br, %.split.i.i.i.i.i.i.i, %bb.bg, %.split.i.i.i.peel.i.i.i.i
  ...
  invoke void @_RNvNtCsbvkFyIu7lgC_4core3str16slice_error_fail(ptr noalias noundef nonnull readonly captures(address, read_provenance) %i.fe, i64 noundef %i.fg, i64 noundef %.lcssa150.i.i.i.i, i64 noundef %i.fg, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @342) #35
          to label %.noexc10.i.i.i unwind label %.loopexit.split-lp.loopexit.split-lp.i.i.i, !noalias !1540
...
bb.by:                                            ; preds = %.lr.ph205
  ...
  %i.ji = load i8, ptr %i.jh, align 1, !alias.scope !1579, !noalias !1584, !noundef !3
  %i.jj = getelementptr inbounds nuw i8, ptr %i.hh, i64 %i.jf
  %i.jk = load i8, ptr %i.jj, align 1, !alias.scope !1577, !noalias !1583, !noundef !3
...
bb.bz:                                            ; preds = %.lr.ph202
  ...
  %i.jp = load i8, ptr %i.jo, align 1, !alias.scope !1579, !noalias !1584, !noundef !3
  %i.jq = getelementptr inbounds nuw i8, ptr %i.hh, i64 %i.jm
  %i.jr = load i8, ptr %i.jq, align 1, !alias.scope !1577, !noalias !1583, !noundef !3
...
bb.cc:                                            ; preds = %bb.bo
  ...
  %.promoted.i11.i.i.i.i = load i64, ptr %i.ho, align 8, !alias.scope !1585, !noalias !1592 ; 2 uses
...
.lr.ph.i14.i.i.i.i:                               ; preds = %bb.cc
  ...
  %i.jx = load i64, ptr %i.jw, align 8, !alias.scope !1585, !noalias !1592, !noundef !3
  %i.jy = load i64, ptr %i.ey, align 8, !alias.scope !1585, !noalias !1592 ; 4 uses
  %i.jz = getelementptr inbounds nuw i8, ptr %i.e, i64 24
  %i.ka = load i64, ptr %i.jz, align 8, !alias.scope !1585, !noalias !1592 ; 2 uses
...
bb.cd:                                            ; preds = %.sink.split.i.i.i.i.i, %.lr.ph.i14.i.i.i.i
  ...
  %i.kg = load i8, ptr %i.kf, align 1, !alias.scope !1588, !noalias !1594, !noundef !3
  %i.kh = and i8 %i.kg, 63
...
bb.ci:                                            ; preds = %bb.ch
  ...
  %i.kz = load i8, ptr %i.ky, align 1, !alias.scope !1590, !noalias !1595, !noundef !3
  %i.la = getelementptr inbounds nuw i8, ptr %i.hh, i64 %i.kw
  %i.lb = load i8, ptr %i.la, align 1, !alias.scope !1588, !noalias !1594, !noundef !3
...
bb.ck:                                            ; preds = %.lr.ph197
  ...
  %i.le = load i8, ptr %i.ld, align 1, !alias.scope !1590, !noalias !1595, !noundef !3
  %i.lf = getelementptr inbounds nuw i8, ptr %i.hh, i64 %i.kr
  %i.lg = load i8, ptr %i.lf, align 1, !alias.scope !1588, !noalias !1594, !noundef !3
...
_RNvXsv_NtNtCsbvkFyIu7lgC_4core3str7patternNtB5_11StrSearcherNtB5_8Searcher10next_match.exit.i.i.i.i: ; preds = %.sink.split.i.i.i.i.i, %.preheader35.i.i.i.i.preheader, %.preheader35.i.i.i.i, %bb.bx, %.preheader.i.us.i.i.i.preheader, %.preheader.i.us.i.i.i, %_RNvXs2J_NtNtCsbvkFyIu7lgC_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits8iterator8Iterator4nextCsj34PGqTgg0L_16deltalake_lakefs.exit12.i.i.i.i.i.i.i, %_RNvXs2J_NtNtCsbvkFyIu7lgC_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits8iterator8Iterator4nextCsj34PGqTgg0L_16deltalake_lakefs.exit14.i.i.i.i.i.i.i, %_RNvXs2J_NtNtCsbvkFyIu7lgC_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits8iterator8Iterator4nextCsj34PGqTgg0L_16deltalake_lakefs.exit16.i.i.i.i.i.i.i, %bb.bt, %bb.cc, %.preheader.i.i.i.i, %bb.bu, %bb.bs, %bb.bk, %bb.bh, %.preheader.i4.i.i.i.i
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e), !noalias !1552
  br label %bb.dd

bb.cn:                                            ; preds = %bb.bb
  call void @llvm.experimental.noalias.scope.decl(metadata !1596)
  call void @llvm.experimental.noalias.scope.decl(metadata !1599)
  %i.lj = load i8, ptr %i.ee, align 1, !alias.scope !1601, !noalias !1602, !noundef !3 ; 3 uses
...
.invoke.i.i.i:                                    ; preds = %.lr.ph, %bb.ch, %.lr.ph199, %.lr.ph205, %bb.cl, %bb.ca, %.preheader.i.i.i.i
  ...
  invoke void @_RNvNtCsbvkFyIu7lgC_4core9panicking18panic_bounds_check(i64 noundef %i.lr, i64 noundef range(i64 0, -9223372036854775808) %i.ls, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.lt) #35
          to label %.cont.i.i.i unwind label %.loopexit.split-lp.loopexit.split-lp.i.i.i, !noalias !1540
...
_RNCINvNvNtNtNtNtCsbvkFyIu7lgC_4core4iter6traits12double_ended19DoubleEndedIterator5rfind5checkjNCNvNtNtBe_3str7pattern13simd_contains0E0Csj34PGqTgg0L_16deltalake_lakefs.exit.i.i.i.i.i.i: ; preds = %.lr.ph
  ...
  %i.lv = load i8, ptr %i.lu, align 1, !alias.scope !1601, !noalias !1603, !noundef !3 ; 2 uses
...
.thread93.i.i.i.i.i:                              ; preds = %.thread.i.i.i.i.i
  ...
  %.pre.i.i.i.i.i = load i8, ptr %.phi.trans.insert.i.i.i.i.i, align 1, !alias.scope !1601, !noalias !1602
  br label %bb.cs
...
.lr.ph.split.us.i.i.i.i.i.i:                      ; preds = %.thread.i.i.i.i.i, %bb.cq
  %bcmp.i.i.us23.i.i.i.i.i.i = call i32 @bcmp(ptr noundef nonnull readonly dereferenceable(1) %i.dz, ptr noundef nonnull readonly dereferenceable(1) %i.ee, i64 range(i64 2, 33) %i.eg), !alias.scope !1611, !noalias !1612
...
.split.us.i.i.i.i.i.i:                            ; preds = %_RNCINvNvNtNtNtNtCsbvkFyIu7lgC_4core4iter6traits8iterator8Iterator3any5checkRShNCNvNtNtBe_3str7pattern13simd_containss_0E0Csj34PGqTgg0L_16deltalake_lakefs.exit.backedge.us.i.i.i.i.i.i
  ...
  %bcmp.i.i.us.i.i.i.i.i.i = call i32 @bcmp(ptr noundef nonnull readonly dereferenceable(1) %i.me, ptr noundef nonnull readonly dereferenceable(1) %i.ee, i64 range(i64 2, 33) %i.eg), !alias.scope !1611, !noalias !1612
...
bb.cs:                                            ; preds = %bb.cr, %.thread93.i.i.i.i.i
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d), !noalias !1616
  store ptr %i.dz, ptr %i.d, align 8, !noalias !1616
  %i.mm = getelementptr inbounds nuw i8, ptr %i.d, i64 8
  store i64 %i.eb, ptr %i.mm, align 8, !noalias !1616
  %i.mn = getelementptr inbounds nuw i8, ptr %i.d, i64 16
  store ptr %i.ml, ptr %i.mn, align 8, !noalias !1616
  %i.mo = getelementptr inbounds nuw i8, ptr %i.d, i64 24
  store i64 %i.lk, ptr %i.mo, align 8, !noalias !1616
...
.lr.ph.i10.i.i.i.i:                               ; preds = %bb.cs, %bb.cw
  ...
  %.sroa.0.0.copyload.i.i.i.i.i.i = load <16 x i8>, ptr %i.mu, align 1, !alias.scope !1617, !noalias !1618
  %i.mv = getelementptr inbounds nuw i8, ptr %i.mu, i64 %storemerge9295.i.i.i.i.i
  %.sroa.02.0.copyload.i.i.i.i.i.i = load <16 x i8>, ptr %i.mv, align 1, !alias.scope !1617, !noalias !1618
  ...
  %.sroa.0.0.copyload.i.1.i.i.i.i.i = load <16 x i8>, ptr %i.na, align 1, !alias.scope !1617, !noalias !1618
  %i.nb = getelementptr inbounds nuw i8, ptr %i.na, i64 %storemerge9295.i.i.i.i.i
  %.sroa.02.0.copyload.i.1.i.i.i.i.i = load <16 x i8>, ptr %i.nb, align 1, !alias.scope !1617, !noalias !1618
  ...
  %.sroa.0.0.copyload.i.2.i.i.i.i.i = load <16 x i8>, ptr %i.ng, align 1, !alias.scope !1617, !noalias !1618
  %i.nh = getelementptr inbounds nuw i8, ptr %i.ng, i64 %storemerge9295.i.i.i.i.i
  %.sroa.02.0.copyload.i.2.i.i.i.i.i = load <16 x i8>, ptr %i.nh, align 1, !alias.scope !1617, !noalias !1618
  ...
  %.sroa.0.0.copyload.i.3.i.i.i.i.i = load <16 x i8>, ptr %i.nm, align 1, !alias.scope !1617, !noalias !1618
  %i.nn = getelementptr inbounds nuw i8, ptr %i.nm, i64 %storemerge9295.i.i.i.i.i
  %.sroa.02.0.copyload.i.3.i.i.i.i.i = load <16 x i8>, ptr %i.nn, align 1, !alias.scope !1617, !noalias !1618
...
bb.ct:                                            ; preds = %.preheader96.1.i.i.i.i.i
  ...
  %i.nw = invoke fastcc noundef zeroext i1 @_RNCNvNtNtCsbvkFyIu7lgC_4core3str7pattern13simd_containss0_0Csj34PGqTgg0L_16deltalake_lakefs(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) %i.d, i64 noundef %i.nu, i16 noundef %i.nf, i1 noundef zeroext %i.nv) #34
          to label %.noexc18.i.i.i unwind label %.loopexit.split-lp.loopexit.i.i.i, !noalias !1540
...
bb.cu:                                            ; preds = %.preheader96.2.i.i.i.i.i
  ...
  %i.oc = invoke fastcc noundef zeroext i1 @_RNCNvNtNtCsbvkFyIu7lgC_4core3str7pattern13simd_containss0_0Csj34PGqTgg0L_16deltalake_lakefs(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) %i.d, i64 noundef %i.oa, i16 noundef %i.nl, i1 noundef zeroext %i.ob) #34
          to label %.noexc19.i.i.i unwind label %.loopexit.split-lp.loopexit.i.i.i, !noalias !1540
...
bb.cv:                                            ; preds = %.preheader96.3.i.i.i.i.i
  ...
  %i.oi = invoke fastcc noundef zeroext i1 @_RNCNvNtNtCsbvkFyIu7lgC_4core3str7pattern13simd_containss0_0Csj34PGqTgg0L_16deltalake_lakefs(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) %i.d, i64 noundef %i.og, i16 noundef %i.nr, i1 noundef zeroext %i.oh) #34
          to label %.noexc20.i.i.i unwind label %.loopexit.split-lp.loopexit.i.i.i, !noalias !1540
...
bb.cx:                                            ; preds = %.lr.ph.i10.i.i.i.i
  %i.op = invoke fastcc noundef zeroext i1 @_RNCNvNtNtCsbvkFyIu7lgC_4core3str7pattern13simd_containss0_0Csj34PGqTgg0L_16deltalake_lakefs(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) %i.d, i64 noundef %.sroa.06.0103.i.i.i.i.i, i16 noundef %i.mz, i1 noundef zeroext false) #34
          to label %.noexc21.i.i.i unwind label %.loopexit.split-lp.loopexit.i.i.i, !noalias !1540
...
._crit_edge.i9.i.i.i.i:                           ; preds = %bb.cy, %.preheader.i8.i.i.i.i
  ...
  %i.or = sub nuw i64 %i.eb, %i.lk
  %i.os = add i64 %i.or, -16                      ; 2 uses
  %i.ot = getelementptr inbounds nuw i8, ptr %i.dz, i64 %i.os ; 2 uses
  %.sroa.0.0.copyload.i58.i.i.i.i.i = load <16 x i8>, ptr %i.ot, align 1, !alias.scope !1617, !noalias !1621
  %i.ou = getelementptr inbounds nuw i8, ptr %i.ot, i64 %storemerge9295.i.i.i.i.i
  %.sroa.02.0.copyload.i59.i.i.i.i.i = load <16 x i8>, ptr %i.ou, align 1, !alias.scope !1617, !noalias !1621
