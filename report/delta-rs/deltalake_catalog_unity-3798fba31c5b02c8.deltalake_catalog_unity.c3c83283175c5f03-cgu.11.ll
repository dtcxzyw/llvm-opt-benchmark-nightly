...
.body.thread:                                     ; preds = %bb.g, %_RNvXs_NtCs6Po7BT7Nknu_5alloc5allocNtB4_6GlobalNtNtCsbvkFyIu7lgC_4core5alloc9Allocator10deallocate.exit.i.i.i, %.body.thread219
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsgO6CtM78C4N_7reqwest10async_impl6client13ClientBuilderECsgO8S5jLFugx_23deltalake_catalog_unity(ptr noalias noundef align 8 dereferenceable(1016) %i.q) #37
...
bb.ab:                                            ; preds = %bb.aa
  ...
  call void @_RINvMs2_NtNtCsgO6CtM78C4N_7reqwest10async_impl6clientNtB6_13ClientBuilder17pool_idle_timeoutNtNtCsbvkFyIu7lgC_4core4time8DurationECsgO8S5jLFugx_23deltalake_catalog_unity(ptr noalias noundef nonnull sret([1016 x i8]) align 8 captures(none) dereferenceable(1016) %i.t, ptr noalias noundef nonnull align 8 captures(address) dereferenceable(1016) %i.l, i64 noundef %i.bq, i32 noundef %i.bo)
...
bb.af:                                            ; preds = %bb.ae
  ...
  call void @_RINvMs2_NtNtCsgO6CtM78C4N_7reqwest10async_impl6clientNtB6_13ClientBuilder25http2_keep_alive_intervalNtNtCsbvkFyIu7lgC_4core4time8DurationECsgO8S5jLFugx_23deltalake_catalog_unity(ptr noalias noundef nonnull sret([1016 x i8]) align 8 captures(none) dereferenceable(1016) %i.t, ptr noalias noundef nonnull align 8 captures(address) dereferenceable(1016) %i.k, i64 noundef %i.by, i32 noundef %i.bw)
