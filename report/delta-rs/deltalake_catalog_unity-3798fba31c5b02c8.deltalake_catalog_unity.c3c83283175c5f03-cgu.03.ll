...
bb.dn:                                            ; preds = %bb.dl, %bb.dk
  ...
  %6 = load i64, ptr %i.fj, align 8, !alias.scope !811, !noalias !729, !noundef !3 ; 2 uses
...
bb.do:                                            ; preds = %bb.dn
  ...
  %7 = load i64, ptr %1, align 8, !range !162, !alias.scope !811, !noalias !729, !noundef !3
  %i.mh = icmp ult i64 %i.mg, %7
  call void @llvm.assume(i1 %i.mh)
  %8 = load ptr, ptr %i.fl, align 8, !alias.scope !811, !noalias !729, !nonnull !3, !noundef !3
...
bb.at:                                            ; preds = %bb.ar, %bb.aq
  ...
  %0 = load i64, ptr %i.ad, align 8, !alias.scope !1776, !noundef !3 ; 2 uses
...
bb.au:                                            ; preds = %bb.at
  ...
  %1 = load i64, ptr %.0.val, align 8, !range !162, !alias.scope !1776, !noundef !3
  %i.dh = icmp ult i64 %i.dg, %1
  tail call void @llvm.assume(i1 %i.dh)
  %2 = load ptr, ptr %i.af, align 8, !alias.scope !1776, !nonnull !3, !noundef !3
