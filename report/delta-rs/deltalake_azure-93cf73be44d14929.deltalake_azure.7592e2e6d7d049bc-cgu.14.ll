Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/delta-rs/original/deltalake_azure-93cf73be44d14929.deltalake_azure.7592e2e6d7d049bc-cgu.14?download=true
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %i.b, label %bb.h, label %bb.c, !prof !1615
...
bb.h:                                             ; preds = %bb.c, %bb.e, %bb.b, %bb.g
  %.sroa.3.0 = phi i64 [ undef, %bb.g ], [ undef, %bb.c ], [ %i.q, %bb.e ], [ undef, %bb.b ]
  %.sroa.0.0 = phi i64 [ -9223372036854775807, %bb.g ], [ 0, %bb.c ], [ %i.o, %bb.e ], [ 0, %bb.b ]
