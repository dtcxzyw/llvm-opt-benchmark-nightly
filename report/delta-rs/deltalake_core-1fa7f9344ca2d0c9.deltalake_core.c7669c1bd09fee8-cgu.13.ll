...
bb.f:                                             ; preds = %bb.g
  %i.as = getelementptr inbounds nuw i8, ptr %i.au, i64 8 ; 2 uses
...
..loopexit.i.loopexit.i.loopexit_crit_edge:       ; preds = %bb.f
  %.lcssa91 = phi ptr [ %i.as, %bb.f ]
  br label %.loopexit.i.loopexit.i.loopexit

.loopexit.i.loopexit.i.loopexit:                  ; preds = %.loopexit.i.loopexit.i.loopexitsplit, %..loopexit.i.loopexit.i.loopexit_crit_edge
  %.ph = phi ptr [ %i.ak, %..loopexit.i.loopexit.i.loopexit_crit_edge ], [ %scevgep40.i, %.loopexit.i.loopexit.i.loopexitsplit ]
  %.lcssa19.i.ph = phi ptr [ %.lcssa91, %..loopexit.i.loopexit.i.loopexit_crit_edge ], [ %i.ad, %.loopexit.i.loopexit.i.loopexitsplit ]
...
bb.d:                                             ; preds = %.lr.ph3
  ...
  %i.h = icmp eq i64 %lsr.iv, %lsr.iv.next9
...
.lr.ph3:                                          ; preds = %.lr.ph3.preheader, %bb.d
  %lsr.iv13 = phi ptr [ %lsr.iv11, %.lr.ph3.preheader ], [ %scevgep14, %bb.d ] ; 2 uses
