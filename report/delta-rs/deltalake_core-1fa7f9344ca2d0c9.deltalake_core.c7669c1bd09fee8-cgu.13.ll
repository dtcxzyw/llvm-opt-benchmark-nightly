...
bb.b:                                             ; preds = %bb.a
  %i.g = load ptr, ptr %1, align 8, !nonnull !8, !align !11, !noundef !8 ; 4 uses
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.d, ptr noundef nonnull align 8 dereferenceable(24) %i.h, i64 24, i1 false), !alias.scope !17531
  store i64 0, ptr %i.h, align 8, !alias.scope !17532, !noalias !17530
  %.sroa.4.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.g, i64 264
  store ptr inttoptr (i64 1 to ptr), ptr %.sroa.4.0..sroa_idx.i, align 8, !alias.scope !17532, !noalias !17530
  %.sroa.5.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.g, i64 272
  store i64 0, ptr %.sroa.5.0..sroa_idx.i, align 8, !alias.scope !17532, !noalias !17530
...
bb.h:                                             ; preds = %bb.i
  ...
  %.val9 = load ptr, ptr %i.p, align 8, !nonnull !8, !align !11, !noundef !8
...
bb.j:                                             ; preds = %bb.i
  %i.r = load i64, ptr %i.b, align 8, !range !35, !noundef !8 ; 4 uses
...
bb.l:                                             ; preds = %bb.j
  ...
  %.val7 = load ptr, ptr %i.t, align 8, !nonnull !8, !align !11, !noundef !8 ; 5 uses
  %i.u = load ptr, ptr %.val7, align 8, !invariant.load !8 ; 2 uses
...
bb.n:                                             ; preds = %bb.m, %bb.l
  ...
  %i.w = load i64, ptr %i.v, align 8, !range !9, !invariant.load !8 ; 2 uses
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.z = load i64, ptr %i.y, align 8, !range !7, !invariant.load !8
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.val) ]
...
bb.p:                                             ; preds = %bb.m
  ...
  %i.ac = load i64, ptr %i.ab, align 8, !range !9, !invariant.load !8 ; 2 uses
  %i.ad = icmp eq i64 %i.ac, 0
  br i1 %i.ad, label %.body, label %bb.q

bb.q:                                             ; preds = %bb.p
  %i.ae = getelementptr inbounds nuw i8, ptr %.val7, i64 16
  %i.af = load i64, ptr %i.ae, align 8, !range !7, !invariant.load !8
...
bb.r:                                             ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_3pin3PinINtNtCs6Po7BT7Nknu_5alloc5boxed3BoxDNtNtNtB4_6future6future6Futurep6OutputINtNtB4_6result6ResultuNtNtCs4tdlwR1I4n2_7parquet6errors12ParquetErrorENtNtB4_6marker4SendEL_EEECs14kWLkQVSKO_14deltalake_core.exit
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !17533
  store i64 %i.r, ptr %i.a, align 8, !noalias !17534
  %.sroa.4.0..sroa_idx23 = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %.sroa.4.0..sroa_idx23, ptr noundef nonnull align 8 dereferenceable(24) %.sroa.4, i64 24, i1 false), !noalias !17534
  call void @_RNvCs8mYq7K4qqSA_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #40, !noalias !17535
  %i.ag = call noundef align 8 dereferenceable_or_null(32) ptr @_RNvCs8mYq7K4qqSA_7___rustc12___rust_alloc(i64 noundef range(i64 8, 16481) 32, i64 noundef range(i64 8, 17) 8) #40, !noalias !17535 ; 4 uses
  %i.ah = icmp eq ptr %i.ag, null
  br i1 %i.ah, label %bb.s, label %bb.w, !prof !12

bb.s:                                             ; preds = %bb.r
  invoke void @_RNvNtCs6Po7BT7Nknu_5alloc5alloc18handle_alloc_error(i64 noundef 8, i64 noundef 32) #48
          to label %.noexc.i.i unwind label %bb.t, !noalias !17536
...
bb.t:                                             ; preds = %bb.s
  ...
  invoke void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs4tdlwR1I4n2_7parquet6errors12ParquetErrorECs14kWLkQVSKO_14deltalake_core(ptr noalias noundef nonnull align 8 dereferenceable(32) %i.a) #46
          to label %.body unwind label %bb.u, !noalias !17537

bb.u:                                             ; preds = %bb.t
  %i.aj = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #47, !noalias !17537
  unreachable
...
bb.v:                                             ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_3pin3PinINtNtCs6Po7BT7Nknu_5alloc5boxed3BoxDNtNtNtB4_6future6future6Futurep6OutputINtNtB4_6result6ResultuNtNtCs4tdlwR1I4n2_7parquet6errors12ParquetErrorENtNtB4_6marker4SendEL_EEECs14kWLkQVSKO_14deltalake_core.exit, %bb.w
  ...
  store ptr %.sroa.1019.13338, ptr %.sroa.328.0..sroa_idx, align 8
  %.sroa.429.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 16
  store ptr @221, ptr %.sroa.429.0..sroa_idx, align 8
  br label %common.ret

bb.w:                                             ; preds = %bb.r
  store i64 %i.r, ptr %i.ag, align 8, !noalias !17534
  %.sroa.4.0..sroa_idx24 = getelementptr inbounds nuw i8, ptr %i.ag, i64 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %.sroa.4.0..sroa_idx24, ptr noundef nonnull align 8 dereferenceable(24) %.sroa.4, i64 24, i1 false), !noalias !17534
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !17533
  br label %bb.v
...
bb.a:
  ...
  %i.bj = load i8, ptr %i.bi, align 8, !range !32, !noundef !8
...
bb.b:                                             ; preds = %bb.a
  ...
  %.val145 = load ptr, ptr %i.br, align 8, !nonnull !8, !noundef !8 ; 2 uses
  %i.bs = getelementptr i8, ptr %1, i64 408
  %.val146 = load i64, ptr %i.bs, align 8, !noundef !8 ; 2 uses
...
.lr.ph:                                           ; preds = %bb.b, %bb.c
  ...
  %.val.i = load i64, ptr %i.bv, align 8, !range !35, !noalias !17742, !noundef !8 ; 2 uses
...
._crit_edge:                                      ; preds = %bb.c, %bb.b
  ...
  %.val149 = load i64, ptr %i.by, align 8, !noundef !8 ; 2 uses
...
bb.e:                                             ; preds = %._crit_edge
  ...
  %i.cc = load ptr, ptr %i.cb, align 8, !noundef !8 ; 7 uses
...
bb.g:                                             ; preds = %bb.e
  ...
  %i.cf = load i64, ptr %i.ce, align 8, !range !10, !alias.scope !17743, !noalias !17744, !noundef !8
...
bb.i:                                             ; preds = %bb.e
  ...
  %i.cg = load ptr, ptr %i.cd, align 8, !nonnull !8, !align !11, !noundef !8 ; 5 uses
  ...
  %i.cj = load i64, ptr %i.ci, align 8, !range !7, !invariant.load !8
  ...
  %i.cp = load ptr, ptr %i.co, align 8, !invariant.load !8, !nonnull !8
...
bb.k:                                             ; preds = %bb.l, %bb.i
  %i.cr = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.be)
  %i.cs = atomicrmw sub ptr %i.cc, i64 1 release, align 8, !noalias !17745
...
bb.eh:                                            ; preds = %_RNvMNtCsbvkFyIu7lgC_4core6optionINtB2_6OptionINtNtCs6Po7BT7Nknu_5alloc3vec3VecNtNtBM_6string6StringEE17unwrap_or_defaultCs14kWLkQVSKO_14deltalake_core.exit
  call void @llvm.lifetime.end.p0(ptr nonnull %i.w)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.x)
  call void @llvm.experimental.noalias.scope.decl(metadata !17817)
  %i.jz = load i64, ptr %i.y, align 8, !range !25, !alias.scope !17818, !noalias !17817, !noundef !8 ; 2 uses
  %i.ka = icmp eq i64 %i.jz, 2
  %i.kb = getelementptr inbounds nuw i8, ptr %i.y, i64 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(72) %.sroa.8383, ptr noundef nonnull align 8 dereferenceable(72) %i.kb, i64 72, i1 false), !alias.scope !17819
...
bb.ei:                                            ; preds = %bb.eh
  ...
  %i.kd = load i64, ptr %i.kc, align 8, !range !10, !noundef !8
...
bb.ek:                                            ; preds = %bb.en, %bb.ei
  ...
  %i.kg = load i64, ptr %i.kf, align 8, !range !10, !noundef !8
...
bb.em:                                            ; preds = %bb.ej
  ...
  %i.ki = load i64, ptr %i.u, align 8, !range !25, !alias.scope !17821, !noalias !17820, !noundef !8 ; 2 uses
  %i.kj = icmp eq i64 %i.ki, 2
  %i.kk = getelementptr inbounds nuw i8, ptr %i.u, i64 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(72) %.sroa.8396, ptr noundef nonnull align 8 dereferenceable(72) %i.kk, i64 72, i1 false), !alias.scope !17822
...
bb.eo:                                            ; preds = %bb.em
  ...
  store i64 -9223372036854775720, ptr %i.kl, align 16, !alias.scope !17823, !noalias !17824
  store i64 1, ptr %i.j, align 16, !alias.scope !17823, !noalias !17824
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.8396)
  br label %bb.ep
...
bb.es:                                            ; preds = %bb.ev, %bb.ek
  ...
  %i.ko = load i8, ptr %i.kn, align 1, !range !32, !noundef !8
...
bb.eu:                                            ; preds = %bb.er
  call void @llvm.lifetime.end.p0(ptr nonnull %i.q)
  call void @llvm.experimental.noalias.scope.decl(metadata !17825)
  %i.kq = load i64, ptr %i.r, align 8, !range !25, !alias.scope !17826, !noalias !17825, !noundef !8 ; 2 uses
  %i.kr = icmp eq i64 %i.kq, 2
  %i.ks = getelementptr inbounds nuw i8, ptr %i.r, i64 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(72) %.sroa.8405, ptr noundef nonnull align 8 dereferenceable(72) %i.ks, i64 72, i1 false), !alias.scope !17827
...
bb.ew:                                            ; preds = %bb.eu
  ...
  store i64 -9223372036854775720, ptr %i.kt, align 16, !alias.scope !17828, !noalias !17829
  store i64 1, ptr %i.j, align 16, !alias.scope !17828, !noalias !17829
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.8405)
  br label %bb.ep
...
bb.fd:                                            ; preds = %bb.fa
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(56) %.sroa.4.0..sroa_idx, ptr noundef nonnull align 8 dereferenceable(56) %i.af, i64 56, i1 false)
  %.sroa.45.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.lb, i64 280
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(256) %.sroa.45.0..sroa_idx, ptr noundef nonnull align 8 dereferenceable(256) %i.z, i64 256, i1 false)
  store i64 3, ptr %i.lb, align 8
  %i.ld = getelementptr inbounds nuw i8, ptr %i.lb, i64 272
  store i64 2, ptr %i.ld, align 8
  store i64 2, ptr %i.l, align 8, !alias.scope !17830, !noalias !17831
  %i.le = getelementptr inbounds nuw i8, ptr %i.l, i64 8
  store ptr %i.lb, ptr %i.le, align 8, !alias.scope !17830, !noalias !17831
  %i.lf = getelementptr inbounds nuw i8, ptr %i.l, i64 16
  store i64 2, ptr %i.lf, align 8, !alias.scope !17830, !noalias !17831
  ...
  %.sroa.5421.0.copyload = load ptr, ptr %i.im, align 8, !nonnull !8, !noundef !8 ; 3 uses
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !17832
  store ptr %.sroa.5421.0.copyload, ptr %i.a, align 8, !alias.scope !17833, !noalias !17834
  %.sroa.5417.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  store ptr %.sroa.5421.0.copyload, ptr %.sroa.5417.0..sroa_idx, align 8, !alias.scope !17833, !noalias !17834
  %.sroa.6418.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  store i64 %.sroa.0420.0.copyload, ptr %.sroa.6418.0..sroa_idx, align 8, !alias.scope !17833, !noalias !17834
  %.sroa.7419.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.a, i64 24
  store ptr %i.li, ptr %.sroa.7419.0..sroa_idx, align 8, !alias.scope !17833, !noalias !17834
...
bb.ff:                                            ; preds = %bb.fd
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !17832
...
bb.fi:                                            ; preds = %bb.fh
  ...
  %i.lv = load ptr, ptr %i.lu, align 8, !alias.scope !17835, !noundef !8
...
bb.fk:                                            ; preds = %bb.fh
  ...
  %i.ly = load ptr, ptr %i.lx, align 8, !alias.scope !17836, !noundef !8
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionINtNtNtNtCs2pqxYH9ZEk8_3std11collections4hash3map7HashMapNtNtCs6Po7BT7Nknu_5alloc6string6StringB1X_EEECs14kWLkQVSKO_14deltalake_core.exit: ; preds = %bb.fi, %bb.fj, %bb.fo
  ...
  call void @llvm.experimental.noalias.scope.decl(metadata !17837)
  %i.mb = load ptr, ptr %i.ma, align 8, !alias.scope !17837, !noundef !8 ; 2 uses
...
bb.fm:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionINtNtNtNtCs2pqxYH9ZEk8_3std11collections4hash3map7HashMapNtNtCs6Po7BT7Nknu_5alloc6string6StringB1X_EEECs14kWLkQVSKO_14deltalake_core.exit
  %i.md = atomicrmw sub ptr %i.mb, i64 1 release, align 8, !noalias !17838
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionINtNtNtNtCs2pqxYH9ZEk8_3std11collections4hash3map7HashMapNtNtCs6Po7BT7Nknu_5alloc6string6StringB1X_EEECs14kWLkQVSKO_14deltalake_core.exit199: ; preds = %bb.fk, %bb.fl
  ...
  call void @llvm.experimental.noalias.scope.decl(metadata !17839)
  %i.mh = load ptr, ptr %i.mg, align 8, !alias.scope !17839, !noundef !8 ; 2 uses
...
bb.fp:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionINtNtNtNtCs2pqxYH9ZEk8_3std11collections4hash3map7HashMapNtNtCs6Po7BT7Nknu_5alloc6string6StringB1X_EEECs14kWLkQVSKO_14deltalake_core.exit199
  %i.mj = atomicrmw sub ptr %i.mh, i64 1 release, align 8, !noalias !17840
...
bb.ft:                                            ; preds = %bb.fw, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtNtCs2pqxYH9ZEk8_3std11collections4hash3map7HashMapNtNtCs6Po7BT7Nknu_5alloc6string6StringINtNtB4_6option6OptionB1B_EEECs14kWLkQVSKO_14deltalake_core.exit
  ...
  call void @llvm.experimental.noalias.scope.decl(metadata !17841)
  %i.mq = load ptr, ptr %i.mp, align 8, !alias.scope !17841, !noundef !8 ; 2 uses
...
bb.fu:                                            ; preds = %bb.ft
  %i.ms = atomicrmw sub ptr %i.mq, i64 1 release, align 8, !noalias !17842
...
bb.fx:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtNtCs2pqxYH9ZEk8_3std11collections4hash3map7HashMapNtNtCs6Po7BT7Nknu_5alloc6string6StringINtNtB4_6option6OptionB1B_EEECs14kWLkQVSKO_14deltalake_core.exit205
  ...
  call void @llvm.experimental.noalias.scope.decl(metadata !17843)
  %i.mw = load ptr, ptr %i.mv, align 8, !alias.scope !17843, !noundef !8 ; 2 uses
...
bb.fy:                                            ; preds = %bb.fx
  %i.my = atomicrmw sub ptr %i.mw, i64 1 release, align 8, !noalias !17844
...
bb.ei:                                            ; preds = %bb.eg
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNCNvNtNtNtCs14kWLkQVSKO_14deltalake_core10operations5write9execution15write_data_plan0EBQ_(ptr noundef nonnull align 16 %i.in)
...
bb.ek:                                            ; preds = %bb.er, %bb.ei
  %i.ir = getelementptr inbounds nuw i8, ptr %1, i64 669
  store i8 0, ptr %i.ir, align 1
  call void @llvm.lifetime.end.p0(ptr nonnull %i.l)
  %i.is = getelementptr inbounds nuw i8, ptr %1, i64 666
  store i8 0, ptr %i.is, align 2
  %i.it = getelementptr inbounds nuw i8, ptr %1, i64 632 ; 2 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !20941)
  call void @llvm.experimental.noalias.scope.decl(metadata !20942)
  %i.iu = load ptr, ptr %i.it, align 8, !alias.scope !20943, !nonnull !8, !noundef !8
  %i.iv = atomicrmw sub ptr %i.iu, i64 1 release, align 8, !noalias !20943
  %i.iw = icmp eq i64 %i.iv, 1
  br i1 %i.iw, label %bb.el, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcNtNtCsfYVtenZkBsn_12arrow_schema6schema6SchemaEECs14kWLkQVSKO_14deltalake_core.exit114

bb.el:                                            ; preds = %bb.ek
  fence acquire
  invoke void @_RNvMsn_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcNtNtCsfYVtenZkBsn_12arrow_schema6schema6SchemaE9drop_slowCs1N9T06jgEdt_11arrow_array(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.it) #45
...
bb.em:                                            ; preds = %bb.en, %bb.es, %bb.ee, %bb.ej
  %i.ix = phi ptr [ %i.im, %bb.ee ], [ %i.im, %bb.ej ], [ %i.jc, %bb.es ], [ %i.jc, %bb.en ]
  %.pn43.pn = phi { ptr, i32 } [ %i.il, %bb.ee ], [ %i.iq, %bb.ej ], [ %i.jg, %bb.es ], [ %i.jb, %bb.en ] ; 3 uses
  %i.iy = getelementptr inbounds nuw i8, ptr %1, i64 669
  %i.iz = load i8, ptr %i.iy, align 1, !range !18, !noundef !8
  %i.ja = trunc nuw i8 %i.iz to i1
  br i1 %i.ja, label %bb.et, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDNtNtCs5wg436RVUAP_24datafusion_physical_plan14execution_plan13ExecutionPlanEL_EECs14kWLkQVSKO_14deltalake_core.exit116

bb.en:                                            ; preds = %bb.eo
  %i.jb = landingpad { ptr, i32 }
          cleanup
  call void @llvm.lifetime.end.p0(ptr nonnull %i.h)
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNCNvNtNtNtCs14kWLkQVSKO_14deltalake_core10operations5write9execution14write_cdc_plan0EBQ_(ptr noundef nonnull align 16 %i.jd) #46
          to label %bb.em unwind label %bb.y

bb.eo:                                            ; preds = %bb.c, %bb.cr
  %i.jc = phi ptr [ undef, %bb.c ], [ %i.gb, %bb.cr ] ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.h)
  %i.jd = getelementptr inbounds nuw i8, ptr %1, i64 688 ; 3 uses
  invoke fastcc void @_RNCNvNtNtNtCs14kWLkQVSKO_14deltalake_core10operations5write9execution14write_cdc_plan0B9_(ptr noalias noundef align 16 captures(none) dereferenceable(96) %i.h, ptr noundef nonnull align 16 %i.jd, ptr noalias noundef align 8 dereferenceable(32) %2)
          to label %bb.ep unwind label %bb.en

bb.ep:                                            ; preds = %bb.eo
  %i.je = load i64, ptr %i.h, align 16, !range !27, !noundef !8
  %i.jf = icmp eq i64 %i.je, -9223372036854775710
  br i1 %i.jf, label %bb.eq, label %bb.er
...
bb.er:                                            ; preds = %bb.ep
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.h)
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNCNvNtNtNtCs14kWLkQVSKO_14deltalake_core10operations5write9execution14write_cdc_plan0EBQ_(ptr noundef nonnull align 16 %i.jd)
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcNtNtCsfYVtenZkBsn_12arrow_schema6schema6SchemaEECs14kWLkQVSKO_14deltalake_core.exit114: ; preds = %bb.ek, %bb.el
  %i.jh = getelementptr inbounds nuw i8, ptr %1, i64 667
  store i8 0, ptr %i.jh, align 1
  %i.ji = getelementptr inbounds nuw i8, ptr %1, i64 670
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ag)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ah)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ai)
  store <4 x i8> zeroinitializer, ptr %i.ji, align 2
  call void @llvm.lifetime.end.p0(ptr nonnull %i.aj)
  %i.jj = getelementptr inbounds nuw i8, ptr %1, i64 668
  store i8 0, ptr %i.jj, align 4
  br label %bb.eb

bb.et:                                            ; preds = %bb.em
  %i.jk = atomicrmw sub ptr %i.ix, i64 1 release, align 8, !noalias !20944
  %i.jl = icmp eq i64 %i.jk, 1
  br i1 %i.jl, label %bb.eu, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDNtNtCs5wg436RVUAP_24datafusion_physical_plan14execution_plan13ExecutionPlanEL_EECs14kWLkQVSKO_14deltalake_core.exit116
...
bb.ev:                                            ; preds = %bb.cl
  %i.jm = getelementptr inbounds nuw i8, ptr %1, i64 640
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VecNtNtCs8VI8w5SIoU4_15datafusion_expr4expr4ExprEECs14kWLkQVSKO_14deltalake_core(ptr noalias noundef align 8 dereferenceable(24) %i.jm) #46
          to label %bb.ad unwind label %bb.y

bb.ew:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcNtNtCsfYVtenZkBsn_12arrow_schema6schema6SchemaEECs14kWLkQVSKO_14deltalake_core.exit88
  %i.jn = getelementptr inbounds nuw i8, ptr %1, i64 667
  %i.jo = load i8, ptr %i.jn, align 1, !range !18, !noundef !8
  %i.jp = trunc nuw i8 %i.jo to i1
  br i1 %i.jp, label %bb.ex, label %bb.dn
...
bb.ex:                                            ; preds = %bb.ew
  invoke void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs8VI8w5SIoU4_15datafusion_expr4expr4ExprECs14kWLkQVSKO_14deltalake_core(ptr noalias noundef nonnull align 16 dereferenceable(112) %i.cf) #46
          to label %bb.dn unwind label %bb.y
...
bb.fa:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionNtNtNtCs4tdlwR1I4n2_7parquet4file10properties16WriterPropertiesEECs14kWLkQVSKO_14deltalake_core.exit118
  call void @llvm.experimental.noalias.scope.decl(metadata !20945)
  call void @llvm.experimental.noalias.scope.decl(metadata !20946)
  %i.jq = load ptr, ptr %i.ai, align 16, !alias.scope !20947, !nonnull !8, !noundef !8
  %i.jr = atomicrmw sub ptr %i.jq, i64 1 release, align 8, !noalias !20947
  %i.js = icmp eq i64 %i.jr, 1
  br i1 %i.js, label %bb.fb, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDNtCsjyY8HP3IvQ6_12object_store11ObjectStoreEL_EECs14kWLkQVSKO_14deltalake_core.exit120
...
bb.fc:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDNtCsjyY8HP3IvQ6_12object_store11ObjectStoreEL_EECs14kWLkQVSKO_14deltalake_core.exit120
...
bb.fd:                                            ; preds = %.body110
  %i.jt = getelementptr inbounds nuw i8, ptr %1, i64 176 ; 2 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !20948)
  call void @llvm.experimental.noalias.scope.decl(metadata !20949)
  %i.ju = load ptr, ptr %i.jt, align 16, !alias.scope !20950, !nonnull !8, !noundef !8
  %i.jv = atomicrmw sub ptr %i.ju, i64 1 release, align 8, !noalias !20950
  %i.jw = icmp eq i64 %i.jv, 1
  br i1 %i.jw, label %bb.fe, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDNtNtCs5wg436RVUAP_24datafusion_physical_plan14execution_plan13ExecutionPlanEL_EECs14kWLkQVSKO_14deltalake_core.exit122

bb.fe:                                            ; preds = %bb.fd
  fence acquire
  invoke void @_RNvMsn_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcDNtNtCs5wg436RVUAP_24datafusion_physical_plan14execution_plan13ExecutionPlanEL_E9drop_slowBL_(ptr noalias noundef nonnull align 8 dereferenceable(16) %i.jt) #45
...
; Function Attrs: inlinehint nonlazybind uwtable
define internal void @_RNCNvXs0_NtNtCs14kWLkQVSKO_14deltalake_core10operations18set_tbl_propertiesNtB7_25SetTablePropertiesBuilderNtNtNtCsbvkFyIu7lgC_4core6future11into_future10IntoFuture11into_future0Bb_(ptr dead_on_unwind noalias nofree noundef writable writeonly sret([128 x i8]) align 16 captures(none) dereferenceable(128) %0, ptr noundef nonnull align 8 %1, ptr noalias noundef align 8 dereferenceable(32) %2) unnamed_addr #1 personality ptr @rust_eh_personality {
bb.a:
  ...
  %.sroa.8255.sroa.8 = alloca [56 x i8], align 8  ; 7 uses
  ...
  %i.al = load i8, ptr %i.ak, align 8, !range !37, !noundef !8
...
default.unreachable398:                           ; preds = %bb.ak, %bb.a
  unreachable
...
bb.b:                                             ; preds = %bb.a
  ...
  tail call void @llvm.experimental.noalias.scope.decl(metadata !21057)
  %i.ar = load i64, ptr %i.aq, align 8, !range !10, !alias.scope !21057, !noalias !21058, !noundef !8
  %.not.i = icmp eq i64 %i.ar, -9223372036854775808
  br i1 %.not.i, label %bb.k, label %bb.c

bb.c:                                             ; preds = %bb.b
  tail call void @llvm.experimental.noalias.scope.decl(metadata !21059)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.i), !noalias !21060
  %i.as = getelementptr inbounds nuw i8, ptr %1, i64 112
  %i.at = load ptr, ptr %i.as, align 8, !alias.scope !21061, !noalias !21062, !nonnull !8, !noundef !8 ; 4 uses
  %i.au = atomicrmw add ptr %i.at, i64 1 monotonic, align 8, !noalias !21060
  %i.av = icmp slt i64 %i.au, 0
  br i1 %i.av, label %bb.e, label %bb.d

bb.d:                                             ; preds = %bb.c
  store ptr %i.at, ptr %i.i, align 8, !noalias !21060
  call void @llvm.lifetime.start.p0(ptr nonnull %i.h), !noalias !21060
  invoke void @_RNvXsa_NtCs6Po7BT7Nknu_5alloc3vecINtB5_3VecNtNtCs1N9T06jgEdt_11arrow_array12record_batch11RecordBatchENtNtCsbvkFyIu7lgC_4core5clone5Clone5cloneCs14kWLkQVSKO_14deltalake_core(ptr noalias noundef nonnull sret([24 x i8]) align 8 captures(address) dereferenceable(24) %i.h, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(32) %i.aq)
          to label %_RNvXs5_NtNtCs14kWLkQVSKO_14deltalake_core6kernel8snapshotNtB5_13EagerSnapshotNtNtCsbvkFyIu7lgC_4core5clone5Clone5clone.exit.i unwind label %bb.f, !noalias !21062
...
bb.f:                                             ; preds = %bb.d
  %i.aw = landingpad { ptr, i32 }
          cleanup
  %i.ax = atomicrmw sub ptr %i.at, i64 1 release, align 8, !noalias !21063
...
bb.g:                                             ; preds = %bb.f
  ...
  invoke void @_RNvMsn_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcNtNtNtCs14kWLkQVSKO_14deltalake_core6kernel8snapshot8SnapshotE9drop_slowBM_(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.i) #45
          to label %.body unwind label %bb.h, !noalias !21062

bb.h:                                             ; preds = %bb.g
  %i.az = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #47, !noalias !21062
  unreachable
...
_RNvXs5_NtNtCs14kWLkQVSKO_14deltalake_core6kernel8snapshotNtB5_13EagerSnapshotNtNtCsbvkFyIu7lgC_4core5clone5Clone5clone.exit.i: ; preds = %bb.d
  %.sroa.0215.0.copyload216 = load i64, ptr %i.h, align 8, !noalias !21057
  %.sroa.6217.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.h, i64 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.6217, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.6217.0..sroa_idx, i64 16, i1 false), !noalias !21057
  call void @llvm.lifetime.end.p0(ptr nonnull %i.h), !noalias !21060
  call void @llvm.lifetime.end.p0(ptr nonnull %i.i), !noalias !21060
  br label %bb.k
...
bb.k:                                             ; preds = %_RNvXs5_NtNtCs14kWLkQVSKO_14deltalake_core6kernel8snapshotNtB5_13EagerSnapshotNtNtCsbvkFyIu7lgC_4core5clone5Clone5clone.exit.i, %bb.b
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.8211.sroa.9.0..sroa.8211.0..sroa_idx.sroa_idx, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.6217, i64 16, i1 false)
...
bb.n:                                             ; preds = %bb.o
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNCNvNtNtCs14kWLkQVSKO_14deltalake_core6kernel8snapshot16resolve_snapshot0EBO_(ptr noundef nonnull align 8 %i.bd) #46
          to label %.body109 unwind label %bb.ah
...
bb.p:                                             ; preds = %bb.o
  %i.be = load i64, ptr %i.aj, align 16, !range !27, !noundef !8 ; 3 uses
  %i.bf = icmp eq i64 %i.be, -9223372036854775710
  br i1 %i.bf, label %bb.q, label %bb.r

common.ret:                                       ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs14kWLkQVSKO_14deltalake_core6kernel11transaction16CommitPropertiesEBM_.exit, %bb.fn, %bb.ep, %bb.bg, %bb.q
  %.sink = phi i8 [ 1, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs14kWLkQVSKO_14deltalake_core6kernel11transaction16CommitPropertiesEBM_.exit ], [ 6, %bb.fn ], [ 5, %bb.ep ], [ 4, %bb.bg ], [ 3, %bb.q ]
...
bb.r:                                             ; preds = %bb.p
  ...
  %i.bh = load i8, ptr %i.bg, align 1, !range !41, !noundef !8
...
bb.s:                                             ; preds = %bb.r
  %i.bi = getelementptr inbounds nuw i8, ptr %1, i64 1072 ; 2 uses
  %i.bj = load i64, ptr %i.bi, align 8, !range !10, !alias.scope !21064, !noundef !8
  %i.bk = icmp eq i64 %i.bj, -9223372036854775808
  br i1 %i.bk, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNCNvNtNtCs14kWLkQVSKO_14deltalake_core6kernel8snapshot16resolve_snapshot0EBO_.exit, label %bb.t

bb.t:                                             ; preds = %bb.s
  invoke void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs14kWLkQVSKO_14deltalake_core6kernel8snapshot13EagerSnapshotEBM_(ptr noalias noundef nonnull align 8 dereferenceable(32) %i.bi)
          to label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNCNvNtNtCs14kWLkQVSKO_14deltalake_core6kernel8snapshot16resolve_snapshot0EBO_.exit unwind label %bb.aa

bb.u:                                             ; preds = %bb.r
  %i.bl = getelementptr inbounds nuw i8, ptr %1, i64 1192
end_hunk_2
begin_hunk_3_@_RNCNvXs0_NtNtCs14kWLkQVSKO_14deltalake_core10operations18set_tbl_propertiesNtB7_25SetTablePropertiesBuilderNtNtNtCsbvkFyIu7lgC_4core6future11into_future10IntoFuture11into_future0Bb_:bb.a
  ...
  %i.fp = load <2 x i32>, ptr %i.fo, align 8, !alias.scope !21079, !noalias !21078
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e), !noalias !21080
  %i.fq = load i64, ptr %i.fj, align 8, !range !10, !alias.scope !21079, !noalias !21078, !noundef !8
  %.not.i121 = icmp eq i64 %i.fq, -9223372036854775808
  br i1 %.not.i121, label %bb.bp, label %bb.bo
...
bb.bo:                                            ; preds = %bb.bn
  invoke void @_RNvXsa_NtCs6Po7BT7Nknu_5alloc3vecINtB5_3VecNtNtCs8ulvy0Wg6Ot_12delta_kernel14table_features12TableFeatureENtNtCsbvkFyIu7lgC_4core5clone5Clone5cloneCs14kWLkQVSKO_14deltalake_core(ptr noalias noundef nonnull sret([24 x i8]) align 8 captures(address) dereferenceable(24) %i.e, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(56) %i.fj)
          to label %.noexc123 unwind label %bb.bu

bb.bp:                                            ; preds = %bb.bn
  store i64 -9223372036854775808, ptr %i.e, align 8, !noalias !21080
  br label %.noexc123

.noexc123:                                        ; preds = %bb.bo, %bb.bp
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.5.i)
  %i.fr = getelementptr inbounds nuw i8, ptr %i.fi, i64 1184 ; 2 uses
  %i.fs = load i64, ptr %i.fr, align 8, !range !10, !alias.scope !21079, !noalias !21078, !noundef !8
  %.not4.i = icmp eq i64 %i.fs, -9223372036854775808
  br i1 %.not4.i, label %bb.bv, label %bb.bq

bb.bq:                                            ; preds = %.noexc123
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d), !noalias !21080
  invoke void @_RNvXsa_NtCs6Po7BT7Nknu_5alloc3vecINtB5_3VecNtNtCs8ulvy0Wg6Ot_12delta_kernel14table_features12TableFeatureENtNtCsbvkFyIu7lgC_4core5clone5Clone5cloneCs14kWLkQVSKO_14deltalake_core(ptr noalias noundef nonnull sret([24 x i8]) align 8 captures(address) dereferenceable(24) %i.d, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.fr)
          to label %bb.bs unwind label %bb.br, !noalias !21078
...
bb.br:                                            ; preds = %bb.bq
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionINtNtCs6Po7BT7Nknu_5alloc3vec3VecNtNtCs8ulvy0Wg6Ot_12delta_kernel14table_features12TableFeatureEEECs14kWLkQVSKO_14deltalake_core(ptr noalias noundef align 8 dereferenceable(24) %i.e) #46
          to label %.body124 unwind label %bb.bt, !noalias !21078

bb.bs:                                            ; preds = %bb.bq
  %.sroa.0.0.copyload1.i = load i64, ptr %i.d, align 8, !noalias !21080
  %.sroa.5.0..sroa_idx2.i = getelementptr inbounds nuw i8, ptr %i.d, i64 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.5.i, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.5.0..sroa_idx2.i, i64 16, i1 false), !noalias !21080
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d), !noalias !21080
  br label %bb.bv

bb.bt:                                            ; preds = %bb.br
  %i.fu = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #47, !noalias !21078
  unreachable
...
bb.bv:                                            ; preds = %bb.bs, %.noexc123
  %.sroa.0.0.i122 = phi i64 [ %.sroa.0.0.copyload1.i, %bb.bs ], [ -9223372036854775808, %.noexc123 ]
  %i.fw = getelementptr inbounds nuw i8, ptr %i.ag, i64 48
  store <2 x i32> %i.fp, ptr %i.fw, align 8, !alias.scope !21078, !noalias !21079
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(56) %i.ag, ptr noundef nonnull align 8 dereferenceable(24) %i.e, i64 24, i1 false), !noalias !21079
  %i.fx = getelementptr inbounds nuw i8, ptr %i.ag, i64 24
  store i64 %.sroa.0.0.i122, ptr %i.fx, align 8, !alias.scope !21078, !noalias !21079
  %.sroa.5.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.ag, i64 32
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.5.0..sroa_idx.i, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.5.i, i64 16, i1 false), !noalias !21079
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.5.i)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e), !noalias !21080
  %i.fy = getelementptr inbounds nuw i8, ptr %1, i64 200
  %i.fz = load i8, ptr %i.fy, align 8, !range !18, !noundef !8
...
bb.bx:                                            ; preds = %bb.bv
  ...
  %i.gc = load i64, ptr %i.ah, align 8, !range !84, !alias.scope !21082, !noalias !21081, !noundef !8 ; 2 uses
  %.not.i126 = icmp eq i64 %i.gc, -9223372036854775771
  %i.gd = getelementptr inbounds nuw i8, ptr %i.ah, i64 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(56) %.sroa.8245, ptr noundef nonnull align 8 dereferenceable(56) %i.gd, i64 56, i1 false), !alias.scope !21083
  br i1 %.not.i126, label %bb.by, label %bb.eh
...
bb.by:                                            ; preds = %bb.bx
  ...
  invoke void @_RNvMs1_NtNtNtCs2pqxYH9ZEk8_3std11collections4hash3mapINtB5_7HashMapNtNtCs6Po7BT7Nknu_5alloc6string6StringB13_E4iterCs14kWLkQVSKO_14deltalake_core(ptr noalias noundef nonnull sret([40 x i8]) align 8 captures(none) dereferenceable(40) %i.af, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(48) %i.fm)
          to label %_RNvXsx_NtNtNtCs2pqxYH9ZEk8_3std11collections4hash3mapRINtB5_7HashMapNtNtCs6Po7BT7Nknu_5alloc6string6StringB14_ENtNtNtNtCsbvkFyIu7lgC_4core4iter6traits7collect12IntoIterator9into_iterCs14kWLkQVSKO_14deltalake_core.exit unwind label %bb.bz
...
_RNvXsx_NtNtNtCs2pqxYH9ZEk8_3std11collections4hash3mapRINtB5_7HashMapNtNtCs6Po7BT7Nknu_5alloc6string6StringB14_ENtNtNtNtCsbvkFyIu7lgC_4core4iter6traits7collect12IntoIterator9into_iterCs14kWLkQVSKO_14deltalake_core.exit: ; preds = %bb.by
...
bb.ca:                                            ; preds = %bb.dz, %_RNvXsx_NtNtNtCs2pqxYH9ZEk8_3std11collections4hash3mapRINtB5_7HashMapNtNtCs6Po7BT7Nknu_5alloc6string6StringB14_ENtNtNtNtCsbvkFyIu7lgC_4core4iter6traits7collect12IntoIterator9into_iterCs14kWLkQVSKO_14deltalake_core.exit
  %i.gi = invoke { ptr, ptr } @_RNvXsG_NtCs3gpiEk3WpjL_9hashbrown3mapINtB5_4IterNtNtCs6Po7BT7Nknu_5alloc6string6StringBK_ENtNtNtNtCsbvkFyIu7lgC_4core4iter6traits8iterator8Iterator4nextCs14kWLkQVSKO_14deltalake_core(ptr noalias noundef nonnull align 8 dereferenceable(40) %i.ae)
          to label %_RNvXsA_NtNtNtCs2pqxYH9ZEk8_3std11collections4hash3mapINtB5_4IterNtNtCs6Po7BT7Nknu_5alloc6string6StringB10_ENtNtNtNtCsbvkFyIu7lgC_4core4iter6traits8iterator8Iterator4nextCs14kWLkQVSKO_14deltalake_core.exit unwind label %bb.cc ; 2 uses

bb.cb:                                            ; preds = %bb.ed, %bb.cc
  %.pn62.pn = phi { ptr, i32 } [ %.pn58348, %bb.ed ], [ %i.gj, %bb.cc ]
...
_RNvXsA_NtNtNtCs2pqxYH9ZEk8_3std11collections4hash3mapINtB5_4IterNtNtCs6Po7BT7Nknu_5alloc6string6StringB10_ENtNtNtNtCsbvkFyIu7lgC_4core4iter6traits8iterator8Iterator4nextCs14kWLkQVSKO_14deltalake_core.exit: ; preds = %bb.ca
  %i.gk = extractvalue { ptr, ptr } %i.gi, 0      ; 2 uses
  %i.gl = extractvalue { ptr, ptr } %i.gi, 1      ; 3 uses
  %.not22 = icmp eq ptr %i.gk, null
  br i1 %.not22, label %bb.ce, label %bb.cd

bb.cd:                                            ; preds = %_RNvXsA_NtNtNtCs2pqxYH9ZEk8_3std11collections4hash3mapINtB5_4IterNtNtCs6Po7BT7Nknu_5alloc6string6StringB10_ENtNtNtNtCsbvkFyIu7lgC_4core4iter6traits8iterator8Iterator4nextCs14kWLkQVSKO_14deltalake_core.exit
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %i.gl) ]
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.8255.sroa.8)
...
bb.ce:                                            ; preds = %_RNvXsA_NtNtNtCs2pqxYH9ZEk8_3std11collections4hash3mapINtB5_4IterNtNtCs6Po7BT7Nknu_5alloc6string6StringB10_ENtNtNtNtCsbvkFyIu7lgC_4core4iter6traits8iterator8Iterator4nextCs14kWLkQVSKO_14deltalake_core.exit
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ae)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.af)
...
bb.cg:                                            ; preds = %bb.ce
  ...
  %i.gq = getelementptr inbounds nuw i8, ptr %1, i64 624
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %i.gq, ptr noundef nonnull align 8 dereferenceable(48) %i.fm, i64 48, i1 false)
  %i.gr = getelementptr inbounds nuw i8, ptr %1, i64 616 ; 2 uses
  store i64 12, ptr %i.gr, align 8
  %i.gs = invoke fastcc noundef nonnull align 8 ptr @_RNvNtCs6Po7BT7Nknu_5alloc5boxed14box_new_uninit(i64 noundef 8, i64 noundef 272) #49
          to label %bb.ci unwind label %bb.ch     ; 3 uses

.body147:                                         ; preds = %bb.ga, %bb.fh, %bb.ch, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs14kWLkQVSKO_14deltalake_core6kernel11transaction15FinalizedCommitEBM_.exit
  %.pn52 = phi { ptr, i32 } [ %.pn49.pn, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs14kWLkQVSKO_14deltalake_core6kernel11transaction15FinalizedCommitEBM_.exit ], [ %i.ln, %bb.fh ], [ %i.gu, %bb.ch ], [ %i.mq, %bb.ga ]
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs14kWLkQVSKO_14deltalake_core8protocol14DeltaOperationEBK_(ptr noalias noundef align 8 dereferenceable(408) %i.gt) #46
          to label %bb.gd unwind label %bb.ah

bb.ch:                                            ; preds = %bb.gb, %bb.fi, %bb.cg
...
bb.ci:                                            ; preds = %bb.cg
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(256) %.sroa.4.0..sroa_idx, ptr noundef nonnull align 8 dereferenceable(256) %i.fd, i64 256, i1 false)
  store i64 2, ptr %i.gs, align 8
  %i.gv = getelementptr inbounds nuw i8, ptr %1, i64 1024 ; 3 uses
  store i64 1, ptr %i.gv, align 8, !alias.scope !21084, !noalias !21085
  %i.gw = getelementptr inbounds nuw i8, ptr %1, i64 1032
  store ptr %i.gs, ptr %i.gw, align 8, !alias.scope !21084, !noalias !21085
  %i.gx = getelementptr inbounds nuw i8, ptr %1, i64 1040
  store i64 1, ptr %i.gx, align 8, !alias.scope !21084, !noalias !21085
...
bb.ck:                                            ; preds = %bb.ci
  br i1 %i.gy, label %bb.cm, label %bb.cl

bb.cl:                                            ; preds = %bb.co, %bb.ck
...
bb.cr:                                            ; preds = %bb.cs, %bb.cp
  %.pn25 = phi { ptr, i32 } [ %i.hd, %bb.cs ], [ %i.hc, %bb.cp ]
...
bb.ct:                                            ; preds = %bb.cq
  ...
  invoke void @_RNvXsa_NtCs6Po7BT7Nknu_5alloc3vecINtB5_3VecNtNtNtCs14kWLkQVSKO_14deltalake_core6kernel6models6ActionENtNtCsbvkFyIu7lgC_4core5clone5Clone5cloneBL_(ptr noalias noundef nonnull sret([24 x i8]) align 8 captures(address) dereferenceable(24) %i.r, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.gv)
          to label %bb.cu unwind label %bb.dq
...
bb.cw:                                            ; preds = %bb.cu
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(144) %i.v, ptr noundef nonnull align 8 dereferenceable(144) %i.u, i64 144, i1 false), !alias.scope !21086, !noalias !21087
  call void @llvm.lifetime.end.p0(ptr nonnull %i.u)
  %i.hh = getelementptr inbounds nuw i8, ptr %1, i64 184
  %.val107 = load ptr, ptr %i.hh, align 8, !noundef !8 ; 3 uses
  %i.hi = getelementptr i8, ptr %1, i64 192
  %.val108 = load ptr, ptr %i.hi, align 8         ; 2 uses
  %.not.i130 = icmp eq ptr %.val107, null
  br i1 %.not.i130, label %bb.cz, label %bb.cx

bb.cx:                                            ; preds = %bb.cw
  %i.hj = atomicrmw add ptr %.val107, i64 1 monotonic, align 8
  %i.hk = icmp slt i64 %i.hj, 0
  br i1 %i.hk, label %bb.cy, label %_RNvXsu_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcDNtNtCs14kWLkQVSKO_14deltalake_core10operations20CustomExecuteHandlerEL_ENtNtCsbvkFyIu7lgC_4core5clone5Clone5cloneBL_.exit.i

bb.cy:                                            ; preds = %bb.cx
  call void @llvm.trap()
  unreachable

_RNvXsu_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcDNtNtCs14kWLkQVSKO_14deltalake_core10operations20CustomExecuteHandlerEL_ENtNtCsbvkFyIu7lgC_4core5clone5Clone5cloneBL_.exit.i: ; preds = %bb.cx
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.val108) ]
  br label %bb.cz

bb.cz:                                            ; preds = %_RNvXsu_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcDNtNtCs14kWLkQVSKO_14deltalake_core10operations20CustomExecuteHandlerEL_ENtNtCsbvkFyIu7lgC_4core5clone5Clone5cloneBL_.exit.i, %bb.cw
  %.sroa.3.0.i = phi ptr [ %.val108, %_RNvXsu_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcDNtNtCs14kWLkQVSKO_14deltalake_core10operations20CustomExecuteHandlerEL_ENtNtCsbvkFyIu7lgC_4core5clone5Clone5cloneBL_.exit.i ], [ undef, %bb.cw ]
...
bb.db:                                            ; preds = %bb.cz
  ...
  %.val99 = load ptr, ptr %i.hm, align 8, !nonnull !8, !noundef !8 ; 2 uses
...
bb.dd:                                            ; preds = %bb.db
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.p)
  invoke fastcc void @_RNvXsx_NtCs14kWLkQVSKO_14deltalake_core8protocolNtB5_14DeltaOperationNtNtCsbvkFyIu7lgC_4core5clone5Clone5clone(ptr noalias noundef align 8 captures(none) dereferenceable(408) %i.p, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(408) %i.gr)
          to label %bb.de unwind label %bb.dk

bb.de:                                            ; preds = %bb.dd
  %i.hr = load ptr, ptr %i.q, align 8, !nonnull !8, !noundef !8
  %i.hs = load ptr, ptr %i.hq, align 8, !nonnull !8, !align !11, !noundef !8
...
bb.dg:                                            ; preds = %bb.dm, %bb.dh
  %.pn38 = phi { ptr, i32 } [ %i.hu, %bb.dh ], [ %.pn35.pn342, %bb.dm ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.x)
  br label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs14kWLkQVSKO_14deltalake_core6kernel11transaction15FinalizedCommitEBM_.exit
...
bb.dk:                                            ; preds = %bb.dd
  %i.hy = landingpad { ptr, i32 }
          cleanup
  call void @llvm.lifetime.end.p0(ptr nonnull %i.p)
  call void @llvm.experimental.noalias.scope.decl(metadata !21088)
  call void @llvm.experimental.noalias.scope.decl(metadata !21089)
  %i.hz = load ptr, ptr %i.q, align 8, !alias.scope !21090, !nonnull !8, !noundef !8
  %i.ia = atomicrmw sub ptr %i.hz, i64 1 release, align 8, !noalias !21090
  %i.ib = icmp eq i64 %i.ia, 1
  br i1 %i.ib, label %bb.dl, label %bb.dn
...
bb.dl:                                            ; preds = %bb.dk
  ...
  invoke void @_RNvMsn_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcDNtNtCs14kWLkQVSKO_14deltalake_core8logstore8LogStoreEL_E9drop_slowBL_(ptr noalias noundef nonnull align 8 dereferenceable(16) %i.q) #45
          to label %bb.dn unwind label %bb.ah

bb.dm:                                            ; preds = %bb.dj, %bb.dn
  %.pn35.pn342 = phi { ptr, i32 } [ %i.hy, %bb.dn ], [ %i.hx, %bb.dj ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.w)
end_hunk_3
...
bb.c:                                             ; preds = %switch.lookup
  ...
  %i.q = load ptr, ptr %i.p, align 8, !invariant.load !8, !nonnull !8
...
bb.d:                                             ; preds = %bb.c
  %i.s = load i64, ptr %0, align 8, !range !25, !noundef !8
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.u = load ptr, ptr %i.t, align 8, !noundef !8 ; 2 uses
  %.not76 = icmp eq ptr %i.u, null
  br i1 %.not76, label %bb.h, label %bb.g

bb.f:                                             ; preds = %bb.d
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a)
  %i.v = load ptr, ptr %i.t, align 8, !noundef !8 ; 2 uses
...
bb.h:                                             ; preds = %bb.e, %bb.g
  ...
  %i.z = load ptr, ptr %i.y, align 8, !noundef !8 ; 2 uses
...
bb.j:                                             ; preds = %bb.h, %bb.i
  ...
  %i.ae = load i64, ptr %i.ad, align 8, !range !62, !noundef !8
  ...
  %i.ai = load ptr, ptr %i.ah, align 8, !invariant.load !8, !nonnull !8
...
bb.l:                                             ; preds = %bb.f, %bb.k
  ...
  %i.am = load ptr, ptr %i.al, align 8, !noundef !8 ; 2 uses
...
bb.n:                                             ; preds = %bb.l, %bb.m
  ...
  %i.as = load ptr, ptr %i.ar, align 8, !invariant.load !8, !nonnull !8
...
define void @_RNvMNtNtCs14kWLkQVSKO_14deltalake_core10operations8optimizeNtB2_13MetricDetails3add(ptr noalias nofree noundef align 8 captures(none) dereferenceable(40) initializes((0, 8)) %0, ptr noalias noundef readonly align 8 captures(none) dereferenceable(40) %1) unnamed_addr #2 personality ptr @rust_eh_personality {
bb.a:
...
; Function Attrs: nonlazybind uwtable
define hidden noalias noundef nonnull ptr @_RNvMNtNtNtCs14kWLkQVSKO_14deltalake_core10operations5write7metricsNtB2_27WriteMetricExtensionPlanner3new() unnamed_addr #0 personality ptr @rust_eh_personality {
bb.a:
  tail call void @_RNvCs8mYq7K4qqSA_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #40, !noalias !26823
  %i.a = tail call noundef align 8 dereferenceable_or_null(16) ptr @_RNvCs8mYq7K4qqSA_7___rustc12___rust_alloc(i64 noundef range(i64 8, 16481) 16, i64 noundef range(i64 8, 17) 8) #40, !noalias !26823 ; 4 uses
  %i.b = icmp eq ptr %i.a, null
  br i1 %i.b, label %bb.b, label %_RNvNtCs6Po7BT7Nknu_5alloc5boxed14box_new_uninit.exit, !prof !12

bb.b:                                             ; preds = %bb.a
  tail call void @_RNvNtCs6Po7BT7Nknu_5alloc5alloc18handle_alloc_error(i64 noundef 8, i64 noundef 16) #48, !noalias !26823
  unreachable
...
; Function Attrs: nonlazybind uwtable
define hidden void @_RNvMNtNtNtCs14kWLkQVSKO_14deltalake_core16delta_datafusion14table_provider9data_sinkNtB2_13DeltaDataSink3new(ptr dead_on_unwind noalias nofree noundef writable writeonly sret([72 x i8]) align 8 captures(none) dereferenceable(72) %0, ptr noundef nonnull %1, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(192) %2, ptr noalias noundef align 8 captures(address) dead_on_return dereferenceable(32) %3, i8 noundef range(i8 0, 4) %4) unnamed_addr #0 personality ptr @rust_eh_personality {
bb.a:
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcNtNtCsfYVtenZkBsn_12arrow_schema6schema6SchemaEECs14kWLkQVSKO_14deltalake_core.exit: ; preds = %bb.h, %bb.i, %bb.c
  ...
  call void @llvm.experimental.noalias.scope.decl(metadata !26833)
  %i.f = load ptr, ptr %i.c, align 8, !alias.scope !26834, !nonnull !8, !noundef !8
  %i.g = atomicrmw sub ptr %i.f, i64 1 release, align 8, !noalias !26834
...
bb.h:                                             ; preds = %bb.e
  %i.r = atomicrmw sub ptr %i.e, i64 1 release, align 8, !noalias !26835
...
bb.a:
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b)
  %i.f = load ptr, ptr %i.c, align 8, !nonnull !8, !noundef !8 ; 2 uses
  %i.g = load ptr, ptr %i.e, align 8, !nonnull !8, !noundef !8
...
bb.b:                                             ; preds = %bb.f
  %i.j = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !26852)
  call void @llvm.experimental.noalias.scope.decl(metadata !26853)
  call void @llvm.experimental.noalias.scope.decl(metadata !26854)
  call void @llvm.experimental.noalias.scope.decl(metadata !26855)
  %i.k = load ptr, ptr %i.a, align 8, !alias.scope !26856, !nonnull !8, !noundef !8
  %i.l = atomicrmw sub ptr %i.k, i64 1 release, align 8, !noalias !26856
...
bb.d:                                             ; preds = %.lr.ph, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5waker5EntryECs14kWLkQVSKO_14deltalake_core.exit5
  ...
  %i.p = load i64, ptr %i.i, align 8, !noundef !8
...
bb.e:                                             ; preds = %bb.d
  %i.t = load ptr, ptr %i.a, align 8, !nonnull !8, !noundef !8
...
bb.g:                                             ; preds = %bb.e, %bb.f, %bb.d
  call void @llvm.experimental.noalias.scope.decl(metadata !26857)
  call void @llvm.experimental.noalias.scope.decl(metadata !26858)
  call void @llvm.experimental.noalias.scope.decl(metadata !26859)
  call void @llvm.experimental.noalias.scope.decl(metadata !26860)
  %i.aa = load ptr, ptr %i.a, align 8, !alias.scope !26861, !nonnull !8, !noundef !8
  %i.ab = atomicrmw sub ptr %i.aa, i64 1 release, align 8, !noalias !26861
...
bb.a:
  ...
  %i.d = load ptr, ptr %i.c, align 8, !noundef !8 ; 3 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.i = load i64, ptr %i.h, align 8, !range !7, !invariant.load !8
...
bb.d:                                             ; preds = %bb.g, %bb.f, %bb.b
  ...
  %i.s = load ptr, ptr %i.b, align 8, !alias.scope !26872, !nonnull !8, !noundef !8
  %i.t = atomicrmw sub ptr %i.s, i64 1 release, align 8, !noalias !26872
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.ac = load ptr, ptr %i.ab, align 8, !invariant.load !8, !nonnull !8
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.ad = load ptr, ptr %i.b, align 8, !alias.scope !26875, !nonnull !8, !noundef !8
  %i.ae = atomicrmw sub ptr %i.ad, i64 1 release, align 8, !noalias !26875
...
bb.d:                                             ; preds = %bb.g, %bb.f, %bb.b
  ...
  call void @llvm.experimental.noalias.scope.decl(metadata !26885)
  %i.s = load ptr, ptr %i.b, align 8, !alias.scope !26886, !nonnull !8, !noundef !8
  %i.t = atomicrmw sub ptr %i.s, i64 1 release, align 8, !noalias !26886
  %i.u = icmp eq i64 %i.t, 1
  br i1 %i.u, label %bb.e, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDNtNtNtCs8ulvy0Wg6Ot_12delta_kernel7metrics8reporter15MetricsReporterEL_EECs14kWLkQVSKO_14deltalake_core.exit
...
bb.h:                                             ; preds = %bb.g
  ...
  call void @llvm.experimental.noalias.scope.decl(metadata !26888)
  %i.ad = load ptr, ptr %i.b, align 8, !alias.scope !26889, !nonnull !8, !noundef !8
  %i.ae = atomicrmw sub ptr %i.ad, i64 1 release, align 8, !noalias !26889
  %i.af = icmp eq i64 %i.ae, 1
  br i1 %i.af, label %bb.i, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDNtNtNtCs8ulvy0Wg6Ot_12delta_kernel7metrics8reporter15MetricsReporterEL_EECs14kWLkQVSKO_14deltalake_core.exit4
...
; Function Attrs: nonlazybind uwtable
define hidden noalias noundef nonnull ptr @_RNvMs0_NtNtCs14kWLkQVSKO_14deltalake_core10operations6updateNtB5_28UpdateMetricExtensionPlanner3new() unnamed_addr #0 personality ptr @rust_eh_personality {
bb.a:
  tail call void @_RNvCs8mYq7K4qqSA_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #40, !noalias !26892
  %i.a = tail call noundef align 8 dereferenceable_or_null(16) ptr @_RNvCs8mYq7K4qqSA_7___rustc12___rust_alloc(i64 noundef range(i64 8, 16481) 16, i64 noundef range(i64 8, 17) 8) #40, !noalias !26892 ; 4 uses
  %i.b = icmp eq ptr %i.a, null
  br i1 %i.b, label %bb.b, label %_RNvNtCs6Po7BT7Nknu_5alloc5boxed14box_new_uninit.exit, !prof !12

bb.b:                                             ; preds = %bb.a
  tail call void @_RNvNtCs6Po7BT7Nknu_5alloc5alloc18handle_alloc_error(i64 noundef 8, i64 noundef 16) #48, !noalias !26892
  unreachable
...
bb.a:
  ...
  tail call void @llvm.experimental.noalias.scope.decl(metadata !26899)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !26900)
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 32 ; 2 uses
  %i.f = load i64, ptr %i.e, align 8, !alias.scope !26899, !noalias !26900, !noundef !8
  %i.g = getelementptr inbounds nuw i8, ptr %1, i64 32
  %i.h = load i64, ptr %i.g, align 8, !alias.scope !26900, !noalias !26899, !noundef !8
  %.sroa.0.0.i.i = tail call noundef i64 @llvm.smin.i64(i64 %i.h, i64 %i.f)
  store i64 %.sroa.0.0.i.i, ptr %i.e, align 8, !alias.scope !26899, !noalias !26900
  %i.i = getelementptr inbounds nuw i8, ptr %0, i64 24 ; 2 uses
  %i.j = load i64, ptr %i.i, align 8, !alias.scope !26899, !noalias !26900, !noundef !8
  %i.k = getelementptr inbounds nuw i8, ptr %1, i64 24
  %i.l = load i64, ptr %i.k, align 8, !alias.scope !26900, !noalias !26899, !noundef !8
  %.sroa.0.0.i1.i = tail call noundef i64 @llvm.smax.i64(i64 %i.l, i64 %i.j)
  store i64 %.sroa.0.0.i1.i, ptr %i.i, align 8, !alias.scope !26899, !noalias !26900
  %i.m = getelementptr inbounds nuw i8, ptr %1, i64 40
  %i.n = getelementptr inbounds nuw i8, ptr %0, i64 40 ; 2 uses
  %i.o = load <2 x i64>, ptr %i.m, align 8, !alias.scope !26900, !noalias !26899
  %i.p = load <2 x i64>, ptr %i.n, align 8, !alias.scope !26899, !noalias !26900
  %i.q = add <2 x i64> %i.p, %i.o                 ; 3 uses
  store <2 x i64> %i.q, ptr %i.n, align 8, !alias.scope !26899, !noalias !26900
  %i.r = getelementptr inbounds nuw i8, ptr %0, i64 56
  tail call void @llvm.experimental.noalias.scope.decl(metadata !26901)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !26902)
  %i.s = getelementptr inbounds nuw i8, ptr %0, i64 72 ; 2 uses
  %i.t = load i64, ptr %i.s, align 8, !alias.scope !26901, !noalias !26902, !noundef !8
  %i.u = getelementptr inbounds nuw i8, ptr %1, i64 72
  %i.v = load i64, ptr %i.u, align 8, !alias.scope !26902, !noalias !26901, !noundef !8
  %.sroa.0.0.i.i1 = tail call noundef i64 @llvm.smin.i64(i64 %i.v, i64 %i.t)
  store i64 %.sroa.0.0.i.i1, ptr %i.s, align 8, !alias.scope !26901, !noalias !26902
  %i.w = getelementptr inbounds nuw i8, ptr %0, i64 64 ; 2 uses
  %i.x = load i64, ptr %i.w, align 8, !alias.scope !26901, !noalias !26902, !noundef !8
  %i.y = getelementptr inbounds nuw i8, ptr %1, i64 64
  %i.z = load i64, ptr %i.y, align 8, !alias.scope !26902, !noalias !26901, !noundef !8
  %.sroa.0.0.i1.i2 = tail call noundef i64 @llvm.smax.i64(i64 %i.z, i64 %i.x)
  store i64 %.sroa.0.0.i1.i2, ptr %i.w, align 8, !alias.scope !26901, !noalias !26902
  %i.aa = getelementptr inbounds nuw i8, ptr %1, i64 80
  %i.ab = getelementptr inbounds nuw i8, ptr %0, i64 80 ; 2 uses
  %i.ac = load <2 x i64>, ptr %i.aa, align 8, !alias.scope !26902, !noalias !26901
  %i.ad = load <2 x i64>, ptr %i.ab, align 8, !alias.scope !26901, !noalias !26902
  %i.ae = add <2 x i64> %i.ad, %i.ac              ; 3 uses
  store <2 x i64> %i.ae, ptr %i.ab, align 8, !alias.scope !26901, !noalias !26902
  %i.af = shufflevector <2 x i64> %i.q, <2 x i64> %i.ae, <2 x i32> <i32 1, i32 3>
  %i.ag = sitofp <2 x i64> %i.af to <2 x double>
  %i.ah = shufflevector <2 x i64> %i.q, <2 x i64> %i.ae, <2 x i32> <i32 0, i32 2>
  %i.ai = uitofp <2 x i64> %i.ah to <2 x double>
  %i.aj = fdiv <2 x double> %i.ag, %i.ai          ; 2 uses
  %i.ak = extractelement <2 x double> %i.aj, i64 0
  store double %i.ak, ptr %i.d, align 8, !alias.scope !26899, !noalias !26900
  %i.al = extractelement <2 x double> %i.aj, i64 1
  store double %i.al, ptr %i.r, align 8, !alias.scope !26901, !noalias !26902
...
bb.d:                                             ; preds = %bb.c
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c)
  %i.l = load ptr, ptr %i.g, align 8, !nonnull !8, !noundef !8
...
bb.f:                                             ; preds = %bb.d
  %i.o = load ptr, ptr %i.g, align 8, !nonnull !8, !noundef !8 ; 3 uses
  store ptr %i.o, ptr %i.c, align 8
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a)
...
bb.j:                                             ; preds = %bb.i
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d)
  %i.q = load i64, ptr %i.e, align 8, !range !10, !noundef !8 ; 2 uses
...
bb.k:                                             ; preds = %bb.j
  ...
  call void @llvm.experimental.noalias.scope.decl(metadata !26933)
  call void @llvm.experimental.noalias.scope.decl(metadata !26934)
  call void @llvm.experimental.noalias.scope.decl(metadata !26935)
  %i.u = load ptr, ptr %i.f, align 8, !alias.scope !26936, !nonnull !8, !noundef !8
  %i.v = atomicrmw sub ptr %i.u, i64 1 release, align 8, !noalias !26936
...
_RNvMs2_NtNtNtCslw7hBPHc6qc_14regex_automata4util4pool5innerINtB5_4PoolNtNtNtBb_4meta5regex5CacheINtNtCs6Po7BT7Nknu_5alloc5boxed3BoxDINtNtNtCsbvkFyIu7lgC_4core3ops8function2FnuEp6OutputB16_NtNtB2d_6marker4SyncNtB32_4SendNtNtNtB2d_5panic11unwind_safe13RefUnwindSafeNtB3x_10UnwindSafeEL_EE3getCs14kWLkQVSKO_14deltalake_core.exit.i.thread: ; preds = %.noexc
  store atomic i64 1, ptr %i.ak release, align 8, !noalias !27420
  %i.an = inttoptr i64 %i.aj to ptr
  %i.ao = getelementptr inbounds nuw i8, ptr %i.b, i64 16
  store ptr %.val9, ptr %i.ao, align 8, !noalias !27418
  store i64 1, ptr %i.b, align 8, !noalias !27418
  %i.ap = getelementptr inbounds nuw i8, ptr %i.b, i64 8
  store ptr %i.an, ptr %i.ap, align 8, !noalias !27418
  %i.aq = getelementptr inbounds nuw i8, ptr %i.b, i64 24
  store i8 0, ptr %i.aq, align 8, !noalias !27418
  %i.ar = load ptr, ptr %i.k, align 8, !noalias !27418, !nonnull !8, !noundef !8
  %i.as = getelementptr inbounds nuw i8, ptr %.val, i64 24
  %i.at = load ptr, ptr %i.as, align 8, !noalias !27418, !nonnull !8, !align !11, !noundef !8 ; 2 uses
  %i.au = getelementptr inbounds nuw i8, ptr %i.at, i64 16
  %i.av = load i64, ptr %i.au, align 8, !range !7, !invariant.load !8, !noalias !27418
...
_RNvMs2_NtNtNtCslw7hBPHc6qc_14regex_automata4util4pool5innerINtB5_4PoolNtNtNtBb_4meta5regex5CacheINtNtCs6Po7BT7Nknu_5alloc5boxed3BoxDINtNtNtCsbvkFyIu7lgC_4core3ops8function2FnuEp6OutputB16_NtNtB2d_6marker4SyncNtB32_4SendNtNtNtB2d_5panic11unwind_safe13RefUnwindSafeNtB3x_10UnwindSafeEL_EE3getCs14kWLkQVSKO_14deltalake_core.exit.i: ; preds = %bb.e
  %.pre = load i64, ptr %i.b, align 8, !range !13, !noalias !27418
  %i.ba = trunc nuw i64 %.pre to i1
  %i.bb = load ptr, ptr %i.k, align 8, !noalias !27418, !nonnull !8, !noundef !8
  %i.bc = getelementptr inbounds nuw i8, ptr %.val, i64 24
  %i.bd = load ptr, ptr %i.bc, align 8, !noalias !27418, !nonnull !8, !align !11, !noundef !8 ; 3 uses
  %i.be = getelementptr inbounds nuw i8, ptr %i.bd, i64 16
  %i.bf = load i64, ptr %i.be, align 8, !range !7, !invariant.load !8, !noalias !27418
...
bb.f:                                             ; preds = %_RNvMs2_NtNtNtCslw7hBPHc6qc_14regex_automata4util4pool5innerINtB5_4PoolNtNtNtBb_4meta5regex5CacheINtNtCs6Po7BT7Nknu_5alloc5boxed3BoxDINtNtNtCsbvkFyIu7lgC_4core3ops8function2FnuEp6OutputB16_NtNtB2d_6marker4SyncNtB32_4SendNtNtNtB2d_5panic11unwind_safe13RefUnwindSafeNtB3x_10UnwindSafeEL_EE3getCs14kWLkQVSKO_14deltalake_core.exit.i.thread, %_RNvMs2_NtNtNtCslw7hBPHc6qc_14regex_automata4util4pool5innerINtB5_4PoolNtNtNtBb_4meta5regex5CacheINtNtCs6Po7BT7Nknu_5alloc5boxed3BoxDINtNtNtCsbvkFyIu7lgC_4core3ops8function2FnuEp6OutputB16_NtNtB2d_6marker4SyncNtB32_4SendNtNtNtB2d_5panic11unwind_safe13RefUnwindSafeNtB3x_10UnwindSafeEL_EE3getCs14kWLkQVSKO_14deltalake_core.exit.i
  ...
  %i.bn = load ptr, ptr %i.bm, align 8, !noalias !27418, !nonnull !8, !align !11, !noundef !8
...
bb.g:                                             ; preds = %_RNvMs2_NtNtNtCslw7hBPHc6qc_14regex_automata4util4pool5innerINtB5_4PoolNtNtNtBb_4meta5regex5CacheINtNtCs6Po7BT7Nknu_5alloc5boxed3BoxDINtNtNtCsbvkFyIu7lgC_4core3ops8function2FnuEp6OutputB16_NtNtB2d_6marker4SyncNtB32_4SendNtNtNtB2d_5panic11unwind_safe13RefUnwindSafeNtB3x_10UnwindSafeEL_EE3getCs14kWLkQVSKO_14deltalake_core.exit.i
  ...
  %i.bq = load ptr, ptr %i.bp, align 8, !noalias !27418, !nonnull !8, !noundef !8
  br label %bb.h
...
bb.h:                                             ; preds = %bb.g, %bb.f
  ...
  %i.bv = load ptr, ptr %i.bu, align 8, !invariant.load !8, !noalias !27418, !nonnull !8
...
bb.i:                                             ; preds = %bb.h
  ...
  %.sroa.2.0.copyload.i = load ptr, ptr %.sroa.2.0..sroa_idx.i, align 8, !noalias !27418 ; 5 uses
  %.sroa.3.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.b, i64 16
  %.sroa.3.0.copyload.i = load ptr, ptr %.sroa.3.0..sroa_idx.i, align 8, !noalias !27418 ; 4 uses
  %.sroa.46.0..sroa_idx.i10 = getelementptr inbounds nuw i8, ptr %i.b, i64 24
  %.sroa.46.0.copyload.i = load i8, ptr %.sroa.46.0..sroa_idx.i10, align 8, !noalias !27418
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !27418
  %i.bx = ptrtoint ptr %.sroa.2.0.copyload.i to i64 ; 2 uses
  br i1 %i.bt, label %bb.j, label %bb.k

bb.j:                                             ; preds = %bb.i
  store i64 %i.bx, ptr %i.a, align 8, !noalias !27421
  %i.by = icmp eq ptr %.sroa.2.0.copyload.i, inttoptr (i64 2 to ptr)
  br i1 %i.by, label %.noexc10.i, label %.noexc11.i, !prof !12
...
bb.q:                                             ; preds = %.noexc11.i, %bb.l, %bb.m
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !27418
...
bb.r:                                             ; preds = %bb.q
  %i.ch = load ptr, ptr %i.l, align 8, !nonnull !8, !noundef !8
  %i.ci = getelementptr inbounds nuw i8, ptr %i.ch, i64 168
  %i.cj = load ptr, ptr %i.ci, align 8, !nonnull !8, !noundef !8 ; 2 uses
  %i.ck = getelementptr inbounds nuw i8, ptr %i.cj, i64 32
  %i.cl = load i64, ptr %i.ck, align 8, !range !13, !noundef !8
...
; Function Attrs: nonlazybind uwtable
define hidden noalias noundef nonnull ptr @_RNvMs5_NtNtCs14kWLkQVSKO_14deltalake_core10operations5mergeNtB5_27MergeMetricExtensionPlanner3new() unnamed_addr #0 personality ptr @rust_eh_personality {
bb.a:
  tail call void @_RNvCs8mYq7K4qqSA_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #40, !noalias !27424
  %i.a = tail call noundef align 8 dereferenceable_or_null(16) ptr @_RNvCs8mYq7K4qqSA_7___rustc12___rust_alloc(i64 noundef range(i64 8, 16481) 16, i64 noundef range(i64 8, 17) 8) #40, !noalias !27424 ; 4 uses
  %i.b = icmp eq ptr %i.a, null
  br i1 %i.b, label %bb.b, label %_RNvNtCs6Po7BT7Nknu_5alloc5boxed14box_new_uninit.exit, !prof !12

bb.b:                                             ; preds = %bb.a
  tail call void @_RNvNtCs6Po7BT7Nknu_5alloc5alloc18handle_alloc_error(i64 noundef 8, i64 noundef 16) #48, !noalias !27424
  unreachable
...
; Function Attrs: nonlazybind uwtable
define void @_RNvMs6_NtNtNtCs14kWLkQVSKO_14deltalake_core6kernel6models7actionsNtB5_13TableFeatures25to_reader_writer_features(ptr dead_on_unwind noalias nofree noundef writable writeonly sret([48 x i8]) align 8 captures(none) dereferenceable(48) %0, ptr noalias noundef readonly captures(address, read_provenance) dereferenceable(1) %1) unnamed_addr #0 personality ptr @rust_eh_personality {
bb.a:
  ...
  %i.c = load i64, ptr %i.b, align 8, !range !27425, !noundef !8 ; 4 uses
...
; Function Attrs: nonlazybind uwtable
define void @_RNvMs7_NtNtCs14kWLkQVSKO_14deltalake_core6kernel11transactionNtB5_13CommitBuilder12with_actions(ptr dead_on_unwind noalias nofree noundef writable writeonly sret([144 x i8]) align 8 captures(none) dereferenceable(144) %0, ptr noalias noundef align 8 captures(address) dead_on_return dereferenceable(144) %1, ptr noalias noundef readonly align 8 captures(none) dead_on_return dereferenceable(24) %2) unnamed_addr #0 personality ptr @rust_eh_personality {
bb.a:
...
; Function Attrs: nonlazybind uwtable
define void @_RNvMs7_NtNtCs14kWLkQVSKO_14deltalake_core6kernel11transactionNtB5_13CommitBuilder17with_app_metadata(ptr dead_on_unwind noalias nofree noundef writable writeonly sret([144 x i8]) align 8 captures(none) dereferenceable(144) %0, ptr noalias noundef align 8 captures(address) dead_on_return dereferenceable(144) %1, ptr noalias noundef readonly align 8 captures(none) dead_on_return dereferenceable(48) %2) unnamed_addr #0 personality ptr @rust_eh_personality {
bb.a:
...
; Function Attrs: nonlazybind uwtable
define void @_RNvMs7_NtNtCs14kWLkQVSKO_14deltalake_core6kernel11transactionNtB5_13CommitBuilder29with_post_commit_hook_handler(ptr dead_on_unwind noalias nofree noundef writable writeonly sret([144 x i8]) align 8 captures(none) dereferenceable(144) %0, ptr noalias noundef align 8 captures(address) dead_on_return dereferenceable(144) %1, ptr noundef %2, ptr %3) unnamed_addr #0 personality ptr @rust_eh_personality {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %1, i64 104 ; 4 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !27432)
  %i.b = load ptr, ptr %i.a, align 8, !alias.scope !27432, !noundef !8 ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  %i.d = atomicrmw sub ptr %i.b, i64 1 release, align 8, !noalias !27433
...
bb.ct:                                            ; preds = %bb.f, %bb.f, %bb.f, %bb.f
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c), !noalias !29018
...
.noexc101:                                        ; preds = %bb.ct
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !29018
  invoke fastcc void @_RNvXs2_NtCsfYVtenZkBsn_12arrow_schema8datatypeNtB5_8DataTypeNtNtCsbvkFyIu7lgC_4core5clone5Clone5clone(ptr noalias noundef align 8 captures(none) dereferenceable(24) %i.b, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.bp)
          to label %bb.cw unwind label %bb.cv, !noalias !29016
...
bb.cu:                                            ; preds = %bb.cx, %bb.cv
  ...
  invoke void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6Po7BT7Nknu_5alloc6string6StringECs14kWLkQVSKO_14deltalake_core(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.c) #46
          to label %.body unwind label %bb.cy, !noalias !29016
...
bb.cw:                                            ; preds = %.noexc101
  ...
  %i.ix = load i8, ptr %i.iw, align 8, !range !18, !alias.scope !29017, !noalias !29016, !noundef !8
  %i.iy = getelementptr inbounds nuw i8, ptr %i.bo, i64 112
  %i.iz = load i64, ptr %i.iy, align 8, !alias.scope !29017, !noalias !29016, !noundef !8
  %i.ja = getelementptr inbounds nuw i8, ptr %i.bo, i64 121
  %i.jb = load i8, ptr %i.ja, align 1, !range !18, !alias.scope !29017, !noalias !29016, !noundef !8
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !29018
  ...
  invoke void @_RNvXNtCs3gpiEk3WpjL_9hashbrown3mapINtB2_7HashMapNtNtCs6Po7BT7Nknu_5alloc6string6StringBK_NtNtNtCs2pqxYH9ZEk8_3std4hash6random11RandomStateENtNtCsbvkFyIu7lgC_4core5clone5Clone5cloneCs14kWLkQVSKO_14deltalake_core(ptr noalias noundef nonnull sret([48 x i8]) align 8 captures(none) dereferenceable(48) %i.a, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(48) %i.jc)
          to label %bb.cz unwind label %bb.cx, !noalias !29016
...
bb.cx:                                            ; preds = %bb.cw
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCsfYVtenZkBsn_12arrow_schema8datatype8DataTypeECs14kWLkQVSKO_14deltalake_core(ptr noalias noundef align 8 dereferenceable(24) %i.b) #46
          to label %bb.cu unwind label %bb.cy, !noalias !29016

bb.cy:                                            ; preds = %bb.cx, %bb.cu
  %i.je = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #47, !noalias !29016
  unreachable

bb.cz:                                            ; preds = %bb.cw
  %i.jf = getelementptr inbounds nuw i8, ptr %i.ay, i64 48
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %i.jf, ptr noundef nonnull align 8 dereferenceable(48) %i.a, i64 48, i1 false), !noalias !29017
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !29018
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(112) %i.ay, ptr noundef nonnull align 8 dereferenceable(24) %i.c, i64 24, i1 false), !noalias !29017
  %i.jg = getelementptr inbounds nuw i8, ptr %i.ay, i64 24
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.jg, ptr noundef nonnull align 8 dereferenceable(24) %i.b, i64 24, i1 false), !noalias !29017
  %i.jh = getelementptr inbounds nuw i8, ptr %i.ay, i64 104
  store i8 %i.ix, ptr %i.jh, align 8, !alias.scope !29016, !noalias !29017
  %i.ji = getelementptr inbounds nuw i8, ptr %i.ay, i64 96
  store i64 %i.iz, ptr %i.ji, align 8, !alias.scope !29016, !noalias !29017
  %i.jj = getelementptr inbounds nuw i8, ptr %i.ay, i64 105
  store i8 %i.jb, ptr %i.jj, align 1, !alias.scope !29016, !noalias !29017
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !29018
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c), !noalias !29018
  call void @llvm.lifetime.start.p0(ptr nonnull %i.ax)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.aw)
  %i.jk = load ptr, ptr %i.ba, align 8, !nonnull !8, !noundef !8
...
bb.dd:                                            ; preds = %bb.dc
  ...
  call void @_RNvCs8mYq7K4qqSA_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #40, !noalias !29019
  %i.jo = call noundef align 8 dereferenceable_or_null(128) ptr @_RNvCs8mYq7K4qqSA_7___rustc12___rust_alloc(i64 noundef range(i64 8, 16481) 128, i64 noundef range(i64 8, 17) 8) #40, !noalias !29019 ; 4 uses
  %i.jp = icmp eq ptr %i.jo, null
  br i1 %i.jp, label %bb.de, label %bb.dh, !prof !12
...
bb.dh:                                            ; preds = %bb.dd
  ...
  call void @llvm.experimental.noalias.scope.decl(metadata !29020)
  call void @llvm.experimental.noalias.scope.decl(metadata !29021)
  %i.js = load ptr, ptr %i.ba, align 8, !alias.scope !29022, !nonnull !8, !noundef !8
  %i.jt = atomicrmw sub ptr %i.js, i64 1 release, align 8, !noalias !29022
...
define internal fastcc noundef i64 @_RNvMsa_NtCs2HSpDNxY7OE_9hashbrown3rawNtB5_13RawTableInner17find_insert_index(ptr nofree readonly captures(none) %.0.val, i64 %.8.val, i64 noundef %0) unnamed_addr #12 {
bb.a:
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.0.val) ]
  %.sroa.0.07 = and i64 %0, %.8.val               ; 3 uses
  %i.a = getelementptr inbounds nuw i8, ptr %.0.val, i64 %.sroa.0.07
  %.sroa.0.0.copyload.i68 = load <16 x i8>, ptr %i.a, align 1, !noalias !29025
  %i.b = icmp slt <16 x i8> %.sroa.0.0.copyload.i68, zeroinitializer
  %i.c = bitcast <16 x i1> %i.b to i16            ; 2 uses
  %.not.i9 = icmp eq i16 %i.c, 0
  br i1 %.not.i9, label %.lr.ph, label %._crit_edge, !prof !92
...
._crit_edge:                                      ; preds = %.lr.ph, %bb.a
  ...
  br i1 %i.j, label %bb.b, label %_RNvMsa_NtCs2HSpDNxY7OE_9hashbrown3rawNtB5_13RawTableInner16fix_insert_index.exit, !prof !12
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  %.sroa.0.0.copyload.i6 = load <16 x i8>, ptr %i.r, align 1, !noalias !29025
  %i.s = icmp slt <16 x i8> %.sroa.0.0.copyload.i6, zeroinitializer
  %i.t = bitcast <16 x i1> %i.s to i16            ; 2 uses
  %.not.i = icmp eq i16 %i.t, 0
  br i1 %.not.i, label %.lr.ph, label %._crit_edge, !prof !93
}

; Function Attrs: inlinehint nonlazybind uwtable
define internal fastcc noalias noundef nonnull ptr @_RNvMse_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcINtNtCs2HSpDNxY7OE_9hashbrown3set7HashSetNtNtB7_6string6StringEE3newCs14kWLkQVSKO_14deltalake_core(ptr noalias noundef nonnull readonly align 8 captures(none) dead_on_return dereferenceable(40) %0) unnamed_addr #1 personality ptr @rust_eh_personality {
bb.a:
  ...
  tail call void @_RNvCs8mYq7K4qqSA_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #40, !noalias !29028
  %i.d = tail call noundef align 8 dereferenceable_or_null(56) ptr @_RNvCs8mYq7K4qqSA_7___rustc12___rust_alloc(i64 noundef range(i64 8, 16481) 56, i64 noundef range(i64 8, 17) 8) #40, !noalias !29028 ; 3 uses
  %i.e = icmp eq ptr %i.d, null
  br i1 %i.e, label %bb.b, label %_RNvMNtCs6Po7BT7Nknu_5alloc5boxedINtB2_3BoxINtNtB4_4sync8ArcInnerINtNtCs2HSpDNxY7OE_9hashbrown3set7HashSetNtNtB4_6string6StringEEE3newCs14kWLkQVSKO_14deltalake_core.exit, !prof !12
...
; Function Attrs: inlinehint nonlazybind uwtable
define internal fastcc noalias noundef nonnull ptr @_RNvMse_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcNtCseo6ZV82fEK1_3url3UrlE3newCs14kWLkQVSKO_14deltalake_core(ptr noalias noundef nonnull readonly align 8 captures(none) dead_on_return dereferenceable(88) %0) unnamed_addr #1 personality ptr @rust_eh_personality {
bb.a:
  ...
  tail call void @_RNvCs8mYq7K4qqSA_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #40, !noalias !29031
  %i.d = tail call noundef align 8 dereferenceable_or_null(104) ptr @_RNvCs8mYq7K4qqSA_7___rustc12___rust_alloc(i64 noundef range(i64 8, 16481) 104, i64 noundef range(i64 8, 17) 8) #40, !noalias !29031 ; 3 uses
  %i.e = icmp eq ptr %i.d, null
  br i1 %i.e, label %bb.b, label %_RNvMNtCs6Po7BT7Nknu_5alloc5boxedINtB2_3BoxINtNtB4_4sync8ArcInnerNtCseo6ZV82fEK1_3url3UrlEE3newCs14kWLkQVSKO_14deltalake_core.exit, !prof !12
...
; Function Attrs: inlinehint nonlazybind uwtable
define internal fastcc noalias noundef nonnull ptr @_RNvMse_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcNtNtB7_6string6StringE3newCs14kWLkQVSKO_14deltalake_core(ptr noalias noundef nonnull readonly align 8 captures(none) dead_on_return dereferenceable(24) %0) unnamed_addr #1 personality ptr @rust_eh_personality {
bb.a:
  ...
  tail call void @_RNvCs8mYq7K4qqSA_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #40, !noalias !29034
  %i.d = tail call noundef align 8 dereferenceable_or_null(40) ptr @_RNvCs8mYq7K4qqSA_7___rustc12___rust_alloc(i64 noundef range(i64 8, 16481) 40, i64 noundef range(i64 8, 17) 8) #40, !noalias !29034 ; 3 uses
  %i.e = icmp eq ptr %i.d, null
  br i1 %i.e, label %bb.b, label %_RNvMNtCs6Po7BT7Nknu_5alloc5boxedINtB2_3BoxINtNtB4_4sync8ArcInnerNtNtB4_6string6StringEE3newCs14kWLkQVSKO_14deltalake_core.exit, !prof !12
...
; Function Attrs: inlinehint nonlazybind uwtable
define internal fastcc noalias noundef nonnull ptr @_RNvMse_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcNtNtCs5wg436RVUAP_24datafusion_physical_plan5limit14LocalLimitExecE3newCs14kWLkQVSKO_14deltalake_core(ptr noalias noundef nonnull readonly align 8 captures(none) dead_on_return dereferenceable(384) %0) unnamed_addr #1 personality ptr @rust_eh_personality {
bb.a:
  ...
  tail call void @_RNvCs8mYq7K4qqSA_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #40, !noalias !29037
  %i.d = tail call noundef align 8 dereferenceable_or_null(400) ptr @_RNvCs8mYq7K4qqSA_7___rustc12___rust_alloc(i64 noundef range(i64 8, 16481) 400, i64 noundef range(i64 8, 17) 8) #40, !noalias !29037 ; 3 uses
  %i.e = icmp eq ptr %i.d, null
  br i1 %i.e, label %bb.b, label %_RNvMNtCs6Po7BT7Nknu_5alloc5boxedINtB2_3BoxINtNtB4_4sync8ArcInnerNtNtCs5wg436RVUAP_24datafusion_physical_plan5limit14LocalLimitExecEE3newCs14kWLkQVSKO_14deltalake_core.exit, !prof !12
...
; Function Attrs: inlinehint nonlazybind uwtable
define internal fastcc noalias noundef nonnull ptr @_RNvMse_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcNtNtCs5wg436RVUAP_24datafusion_physical_plan6filter10FilterExecE3newCs14kWLkQVSKO_14deltalake_core(ptr noalias noundef nonnull readonly align 8 captures(none) dead_on_return dereferenceable(448) %0) unnamed_addr #1 personality ptr @rust_eh_personality {
bb.a:
  ...
  tail call void @_RNvCs8mYq7K4qqSA_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #40, !noalias !29040
  %i.d = tail call noundef align 8 dereferenceable_or_null(464) ptr @_RNvCs8mYq7K4qqSA_7___rustc12___rust_alloc(i64 noundef range(i64 8, 16481) 464, i64 noundef range(i64 8, 17) 8) #40, !noalias !29040 ; 3 uses
  %i.e = icmp eq ptr %i.d, null
  br i1 %i.e, label %bb.b, label %_RNvMNtCs6Po7BT7Nknu_5alloc5boxedINtB2_3BoxINtNtB4_4sync8ArcInnerNtNtCs5wg436RVUAP_24datafusion_physical_plan6filter10FilterExecEE3newCs14kWLkQVSKO_14deltalake_core.exit, !prof !12
...
; Function Attrs: inlinehint nonlazybind uwtable
define internal fastcc noalias noundef nonnull ptr @_RNvMse_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcNtNtCs8ulvy0Wg6Ot_12delta_kernel11expressions9PredicateE3newCs14kWLkQVSKO_14deltalake_core(ptr noalias noundef nonnull readonly align 16 captures(none) dead_on_return dereferenceable(112) %0) unnamed_addr #1 personality ptr @rust_eh_personality {
bb.a:
  ...
  tail call void @_RNvCs8mYq7K4qqSA_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #40, !noalias !29043
  %i.d = tail call noundef align 16 dereferenceable_or_null(128) ptr @_RNvCs8mYq7K4qqSA_7___rustc12___rust_alloc(i64 noundef range(i64 8, 16481) 128, i64 noundef range(i64 8, 17) 16) #40, !noalias !29043 ; 3 uses
  %i.e = icmp eq ptr %i.d, null
  br i1 %i.e, label %bb.b, label %_RNvMNtCs6Po7BT7Nknu_5alloc5boxedINtB2_3BoxINtNtB4_4sync8ArcInnerNtNtCs8ulvy0Wg6Ot_12delta_kernel11expressions9PredicateEE3newCs14kWLkQVSKO_14deltalake_core.exit, !prof !12
...
; Function Attrs: inlinehint nonlazybind uwtable
define internal fastcc noalias noundef nonnull ptr @_RNvMse_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcNtNtCs8ulvy0Wg6Ot_12delta_kernel6schema10StructTypeE3newCs14kWLkQVSKO_14deltalake_core(ptr noalias noundef nonnull readonly align 8 captures(none) dead_on_return dereferenceable(144) %0) unnamed_addr #1 personality ptr @rust_eh_personality {
bb.a:
  ...
  tail call void @_RNvCs8mYq7K4qqSA_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #40, !noalias !29046
  %i.d = tail call noundef align 8 dereferenceable_or_null(160) ptr @_RNvCs8mYq7K4qqSA_7___rustc12___rust_alloc(i64 noundef range(i64 8, 16481) 160, i64 noundef range(i64 8, 17) 8) #40, !noalias !29046 ; 3 uses
  %i.e = icmp eq ptr %i.d, null
  br i1 %i.e, label %bb.b, label %_RNvMNtCs6Po7BT7Nknu_5alloc5boxedINtB2_3BoxINtNtB4_4sync8ArcInnerNtNtCs8ulvy0Wg6Ot_12delta_kernel6schema10StructTypeEE3newCs14kWLkQVSKO_14deltalake_core.exit, !prof !12
...
; Function Attrs: inlinehint nonlazybind uwtable
define internal fastcc noalias noundef nonnull ptr @_RNvMse_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcNtNtCsfYVtenZkBsn_12arrow_schema6schema6SchemaE3newCs14kWLkQVSKO_14deltalake_core(ptr noalias noundef nonnull readonly align 8 captures(none) dead_on_return dereferenceable(64) %0) unnamed_addr #1 personality ptr @rust_eh_personality {
bb.a:
  ...
  tail call void @_RNvCs8mYq7K4qqSA_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #40, !noalias !29049
  %i.d = tail call noundef align 8 dereferenceable_or_null(80) ptr @_RNvCs8mYq7K4qqSA_7___rustc12___rust_alloc(i64 noundef range(i64 8, 16481) 80, i64 noundef range(i64 8, 17) 8) #40, !noalias !29049 ; 3 uses
  %i.e = icmp eq ptr %i.d, null
  br i1 %i.e, label %bb.b, label %_RNvMNtCs6Po7BT7Nknu_5alloc5boxedINtB2_3BoxINtNtB4_4sync8ArcInnerNtNtCsfYVtenZkBsn_12arrow_schema6schema6SchemaEE3newCs14kWLkQVSKO_14deltalake_core.exit, !prof !12
...
; Function Attrs: inlinehint nonlazybind uwtable
define internal fastcc noalias noundef nonnull ptr @_RNvMse_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcNtNtCsjhHCjzi9uUI_17datafusion_common8dfschema8DFSchemaE3newCs14kWLkQVSKO_14deltalake_core(ptr noalias noundef nonnull readonly align 8 captures(none) dead_on_return dereferenceable(56) %0) unnamed_addr #1 personality ptr @rust_eh_personality {
bb.a:
  ...
  tail call void @_RNvCs8mYq7K4qqSA_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #40, !noalias !29052
  %i.d = tail call noundef align 8 dereferenceable_or_null(72) ptr @_RNvCs8mYq7K4qqSA_7___rustc12___rust_alloc(i64 noundef range(i64 8, 16481) 72, i64 noundef range(i64 8, 17) 8) #40, !noalias !29052 ; 3 uses
  %i.e = icmp eq ptr %i.d, null
  br i1 %i.e, label %bb.b, label %_RNvMNtCs6Po7BT7Nknu_5alloc5boxedINtB2_3BoxINtNtB4_4sync8ArcInnerNtNtCsjhHCjzi9uUI_17datafusion_common8dfschema8DFSchemaEE3newCs14kWLkQVSKO_14deltalake_core.exit, !prof !12
...
; Function Attrs: inlinehint nonlazybind uwtable
define internal fastcc noalias noundef nonnull ptr @_RNvMse_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcNtNtNtCs14kWLkQVSKO_14deltalake_core16delta_datafusion7logical14MetricObserverE3newBM_(ptr noalias noundef nonnull readonly align 16 captures(none) dead_on_return dereferenceable(352) %0) unnamed_addr #1 personality ptr @rust_eh_personality {
bb.a:
  ...
  tail call void @_RNvCs8mYq7K4qqSA_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #40, !noalias !29055
  %i.d = tail call noundef align 16 dereferenceable_or_null(368) ptr @_RNvCs8mYq7K4qqSA_7___rustc12___rust_alloc(i64 noundef range(i64 8, 16481) 368, i64 noundef range(i64 8, 17) 16) #40, !noalias !29055 ; 3 uses
  %i.e = icmp eq ptr %i.d, null
  br i1 %i.e, label %bb.b, label %_RNvMNtCs6Po7BT7Nknu_5alloc5boxedINtB2_3BoxINtNtB4_4sync8ArcInnerNtNtNtCs14kWLkQVSKO_14deltalake_core16delta_datafusion7logical14MetricObserverEE3newB16_.exit, !prof !12
...
; Function Attrs: inlinehint nonlazybind uwtable
define internal fastcc noalias noundef nonnull ptr @_RNvMse_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcNtNtNtNtCs14kWLkQVSKO_14deltalake_core10operations5merge7barrier12MergeBarrierE3newBO_(ptr noalias noundef nonnull readonly align 16 captures(none) dead_on_return dereferenceable(448) %0) unnamed_addr #1 personality ptr @rust_eh_personality {
bb.a:
  ...
  tail call void @_RNvCs8mYq7K4qqSA_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #40, !noalias !29058
  %i.d = tail call noundef align 16 dereferenceable_or_null(464) ptr @_RNvCs8mYq7K4qqSA_7___rustc12___rust_alloc(i64 noundef range(i64 8, 16481) 464, i64 noundef range(i64 8, 17) 16) #40, !noalias !29058 ; 3 uses
  %i.e = icmp eq ptr %i.d, null
  br i1 %i.e, label %bb.b, label %_RNvMNtCs6Po7BT7Nknu_5alloc5boxedINtB2_3BoxINtNtB4_4sync8ArcInnerNtNtNtNtCs14kWLkQVSKO_14deltalake_core10operations5merge7barrier12MergeBarrierEE3newB18_.exit, !prof !12
...
; Function Attrs: nonlazybind uwtable
define void @_RNvMse_NtNtCs14kWLkQVSKO_14deltalake_core6kernel11transactionNtB5_15FinalizedCommit8snapshot(ptr dead_on_unwind noalias nofree noundef writable writeonly sret([32 x i8]) align 8 captures(none) dereferenceable(32) %0, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(64) %1) unnamed_addr #0 personality ptr @rust_eh_personality {
bb.a:
  %i.a = alloca [24 x i8], align 8                ; 4 uses
  %i.b = alloca [8 x i8], align 8                 ; 4 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !29066)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !29067
  %i.c = getelementptr inbounds nuw i8, ptr %1, i64 24
  %i.d = load ptr, ptr %i.c, align 8, !alias.scope !29066, !noalias !29068, !nonnull !8, !noundef !8 ; 4 uses
  %i.e = atomicrmw add ptr %i.d, i64 1 monotonic, align 8, !noalias !29067
  %i.f = icmp slt i64 %i.e, 0
  br i1 %i.f, label %bb.c, label %bb.b

bb.b:                                             ; preds = %bb.a
  store ptr %i.d, ptr %i.b, align 8, !noalias !29067
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !29067
  invoke void @_RNvXsa_NtCs6Po7BT7Nknu_5alloc3vecINtB5_3VecNtNtCs1N9T06jgEdt_11arrow_array12record_batch11RecordBatchENtNtCsbvkFyIu7lgC_4core5clone5Clone5cloneCs14kWLkQVSKO_14deltalake_core(ptr noalias noundef nonnull sret([24 x i8]) align 8 captures(address) dereferenceable(24) %i.a, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(32) %1)
          to label %_RNvXs5_NtNtCs14kWLkQVSKO_14deltalake_core6kernel8snapshotNtB5_13EagerSnapshotNtNtCsbvkFyIu7lgC_4core5clone5Clone5clone.exit unwind label %bb.d, !noalias !29068
...
bb.d:                                             ; preds = %bb.b
  %i.g = landingpad { ptr, i32 }
          cleanup
  %i.h = atomicrmw sub ptr %i.d, i64 1 release, align 8, !noalias !29069
...
bb.e:                                             ; preds = %bb.d
  ...
  invoke void @_RNvMsn_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcNtNtNtCs14kWLkQVSKO_14deltalake_core6kernel8snapshot8SnapshotE9drop_slowBM_(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.b) #45
          to label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcNtNtNtCs14kWLkQVSKO_14deltalake_core6kernel8snapshot8SnapshotEEB1k_.exit.i unwind label %bb.f, !noalias !29068

bb.f:                                             ; preds = %bb.e
  %i.j = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #47, !noalias !29068
  unreachable
...
_RNvXs5_NtNtCs14kWLkQVSKO_14deltalake_core6kernel8snapshotNtB5_13EagerSnapshotNtNtCsbvkFyIu7lgC_4core5clone5Clone5clone.exit: ; preds = %bb.b
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !29067
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !29067
...
bb.b:                                             ; preds = %bb.a
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a)
  call void @_RNvCs8mYq7K4qqSA_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #40, !noalias !29074
  %i.j = call noundef align 16 dereferenceable_or_null(112) ptr @_RNvCs8mYq7K4qqSA_7___rustc12___rust_alloc(i64 noundef range(i64 8, 16481) 112, i64 noundef range(i64 8, 17) 16) #40, !noalias !29074 ; 4 uses
  %i.k = icmp eq ptr %i.j, null
  br i1 %i.k, label %bb.c, label %bb.f, !prof !12
...
bb.h:                                             ; preds = %bb.f
  call void @_RNvCs8mYq7K4qqSA_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #40, !noalias !29075
  %i.o = call noundef align 16 dereferenceable_or_null(112) ptr @_RNvCs8mYq7K4qqSA_7___rustc12___rust_alloc(i64 noundef range(i64 8, 16481) 112, i64 noundef range(i64 8, 17) 16) #40, !noalias !29075 ; 3 uses
  %i.p = icmp eq ptr %i.o, null
  br i1 %i.p, label %bb.i, label %bb.l, !prof !12
...
begin_hunk_8_@_RNvNCNCNvNtNtCs14kWLkQVSKO_14deltalake_core10operations5merge7execute0011update_case:bb.a
  ...
  %i.cv = load i64, ptr %i.ac, align 8, !alias.scope !29108, !noalias !29109, !noundef !8 ; 3 uses
  %i.cw = load i64, ptr %i.p, align 8, !range !9, !alias.scope !29108, !noalias !29109, !noundef !8
...
bb.aw:                                            ; preds = %bb.av
  invoke void @_RNvMs3_NtCs6Po7BT7Nknu_5alloc7raw_vecINtB5_6RawVecNtNtCs14kWLkQVSKO_14deltalake_core8protocol14MergePredicateE8grow_oneBQ_(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.p)
          to label %bb.bd unwind label %bb.ax, !noalias !29109
...
bb.bd:                                            ; preds = %bb.aw, %bb.av
  %i.dd = load ptr, ptr %i.ab, align 8, !alias.scope !29108, !noalias !29109, !nonnull !8, !noundef !8
  ...
  %i.df = add i64 %i.cv, 1
  store i64 %i.df, ptr %i.ac, align 8, !alias.scope !29108, !noalias !29109
  call void @llvm.lifetime.end.p0(ptr nonnull %i.g)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.h)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.n)
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.8122)
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.8122)
  %i.dg = load ptr, ptr %.sroa.7.0..sroa_idx, align 8, !alias.scope !29110, !noalias !29099, !nonnull !8, !noundef !8
  %i.dh = load ptr, ptr %.sroa.5.0..sroa_idx, align 8, !alias.scope !29110, !noalias !29099, !nonnull !8, !noundef !8 ; 2 uses
...
bb.bg:                                            ; preds = %bb.ag
  %i.dk = load i64, ptr %i.e, align 8, !range !13, !noundef !8
  %i.dl = trunc nuw i64 %i.dk to i1
  %i.dm = getelementptr inbounds nuw i8, ptr %i.e, i64 8
  %i.dn = load i64, ptr %i.dm, align 8, !range !10, !noundef !8 ; 3 uses
  %i.do = getelementptr inbounds nuw i8, ptr %i.e, i64 16 ; 2 uses
  br i1 %i.dl, label %bb.bh, label %bb.bi, !prof !12
...
bb.bi:                                            ; preds = %bb.bg
  %i.ds = load ptr, ptr %i.do, align 8, !nonnull !8, !noundef !8
...
.thread162:                                       ; preds = %bb.bm, %.thread150
  br i1 %.sroa.032.0144, label %bb.bn, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtNtCs2pqxYH9ZEk8_3std11collections4hash3map7HashMapNtNtCsjhHCjzi9uUI_17datafusion_common6column6ColumnNtNtCs8VI8w5SIoU4_15datafusion_expr4expr4ExprEECs14kWLkQVSKO_14deltalake_core.exit

.thread150:                                       ; preds = %.thread170.loopexit, %.thread170.loopexit.split-lp, %bb.q, %bb.bl, %bb.aa, %bb.w, %bb.n
  %.sroa.032.0144 = phi i1 [ false, %bb.aa ], [ true, %bb.q ], [ true, %bb.w ], [ true, %bb.n ], [ true, %bb.bl ], [ %.sroa.032.1.ph.ph, %.thread170.loopexit ], [ false, %.thread170.loopexit.split-lp ]
  %.pn142 = phi { ptr, i32 } [ %i.bx, %bb.aa ], [ %i.be, %bb.q ], [ %i.bo, %bb.w ], [ %i.bc, %bb.n ], [ %i.dw, %bb.bl ], [ %lpad.loopexit, %.thread170.loopexit ], [ %lpad.loopexit.split-lp, %.thread170.loopexit.split-lp ] ; 2 uses
  %i.dx = load i64, ptr %i.n, align 16, !range !14, !alias.scope !29111, !noundef !8
...
; Function Attrs: inlinehint nonlazybind uwtable
define internal fastcc noalias noundef nonnull ptr @_RNvNtCs6Po7BT7Nknu_5alloc5boxed14box_new_uninit(i64 noundef range(i64 8, 17) %0, i64 noundef range(i64 8, 16481) %1) unnamed_addr #1 {
bb.a:
...
define internal void @_RNvNtCs9Ct3XQYJhun_5bytes5bytes12static_clone(ptr dead_on_unwind noalias nofree noundef writable writeonly sret([32 x i8]) align 8 captures(none) dereferenceable(32) initializes((0, 32)) %0, ptr nofree nonnull readnone align 8 captures(none) %1, ptr noundef %2, i64 noundef %3) unnamed_addr #6 {
bb.a:
...
; Function Attrs: nonlazybind uwtable
define void @_RNvNtNtCs14kWLkQVSKO_14deltalake_core10operations5merge13modify_schema(ptr dead_on_unwind noalias nofree noundef writable writeonly sret([96 x i8]) align 16 captures(none) dereferenceable(96) %0, ptr noalias noundef align 8 dereferenceable(72) %1, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(56) %2, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(56) %3, ptr noalias noundef nonnull readonly align 16 captures(address, read_provenance) %4, i64 noundef range(i64 0, 52405522936674863) %5) unnamed_addr #0 personality ptr @rust_eh_personality {
bb.a:
...
bb.b:                                             ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6result6ResultRINtNtCs6Po7BT7Nknu_5alloc4sync3ArcNtNtCsfYVtenZkBsn_12arrow_schema5field5FieldENtNtCsjhHCjzi9uUI_17datafusion_common5error15DataFusionErrorEECs14kWLkQVSKO_14deltalake_core.exit82, %bb.a
  call void @llvm.experimental.noalias.scope.decl(metadata !29165)
  br label %bb.c

bb.c:                                             ; preds = %bb.j, %bb.b
  %i.y = load ptr, ptr %.sroa.328.0..sroa_idx, align 8, !alias.scope !29166, !noundef !8
...
bb.d:                                             ; preds = %bb.c
  ...
  br i1 %.not4.i.i, label %bb.e, label %_RNvXsi_NtNtNtCsbvkFyIu7lgC_4core4iter8adapters7flattenINtB5_13FlattenCompatINtNtB7_3map3MapINtNtB7_6filter6FilterINtNtNtBb_5slice4iter4IterNtNtNtCs14kWLkQVSKO_14deltalake_core10operations5merge14MergeOperationENCNvB2f_13modify_schema0ENCB3o_s_0EINtNtNtNtCs2pqxYH9ZEk8_3std11collections4hash3map4KeysNtNtCsjhHCjzi9uUI_17datafusion_common6column6ColumnNtNtCs8VI8w5SIoU4_15datafusion_expr4expr4ExprEENtNtNtB9_6traits8iterator8Iterator4nextB2j_.exit.thread

bb.e:                                             ; preds = %bb.d
  store ptr null, ptr %.sroa.328.0..sroa_idx, align 8, !alias.scope !29166
  br label %bb.f

bb.f:                                             ; preds = %bb.e, %bb.c
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d), !noalias !29165
  call void @llvm.experimental.noalias.scope.decl(metadata !29167)
  %i.ab = load ptr, ptr %i.q, align 8, !alias.scope !29168, !noalias !29169, !noundef !8 ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  call void @llvm.experimental.noalias.scope.decl(metadata !29170)
  call void @llvm.experimental.noalias.scope.decl(metadata !29171)
  call void @llvm.experimental.noalias.scope.decl(metadata !29172)
  %i.ac = load ptr, ptr %.sroa.227.0..sroa_idx, align 8, !alias.scope !29173, !noalias !29174, !nonnull !8, !noundef !8
  br label %bb.h
...
bb.i:                                             ; preds = %bb.h
  ...
  store ptr %i.af, ptr %i.q, align 8, !alias.scope !29173, !noalias !29174
  %i.ag = getelementptr inbounds nuw i8, ptr %i.ad, i64 160
  %i.ah = load i8, ptr %i.ag, align 16, !range !41, !noalias !29175, !noundef !8
...
_RNvXs9_NtNtNtCsbvkFyIu7lgC_4core4iter8adapters4fuseINtB5_4FuseINtNtB7_3map3MapINtNtB7_6filter6FilterINtNtNtBb_5slice4iter4IterNtNtNtCs14kWLkQVSKO_14deltalake_core10operations5merge14MergeOperationENCNvB22_13modify_schema0ENCB3b_s_0EEINtB5_8FuseImplBY_E4nextB26_.exit.i: ; preds = %bb.i, %bb.i
  ...
  call void @_RNvMs1_NtNtNtCs2pqxYH9ZEk8_3std11collections4hash3mapINtB5_7HashMapNtNtCsjhHCjzi9uUI_17datafusion_common6column6ColumnNtNtCs8VI8w5SIoU4_15datafusion_expr4expr4ExprE4iterCs14kWLkQVSKO_14deltalake_core(ptr noalias noundef nonnull sret([40 x i8]) align 8 captures(none) dereferenceable(40) %i.d, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(48) %i.ai), !noalias !29176
  %.pr.i = load ptr, ptr %i.d, align 8, !noalias !29165
...
bb.j:                                             ; preds = %_RNvXs9_NtNtNtCsbvkFyIu7lgC_4core4iter8adapters4fuseINtB5_4FuseINtNtB7_3map3MapINtNtB7_6filter6FilterINtNtNtBb_5slice4iter4IterNtNtNtCs14kWLkQVSKO_14deltalake_core10operations5merge14MergeOperationENCNvB22_13modify_schema0ENCB3b_s_0EEINtB5_8FuseImplBY_E4nextB26_.exit.i
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d), !noalias !29165
  br label %bb.c
...
_RNvXs9_NtNtNtCsbvkFyIu7lgC_4core4iter8adapters4fuseINtB5_4FuseINtNtB7_3map3MapINtNtB7_6filter6FilterINtNtNtBb_5slice4iter4IterNtNtNtCs14kWLkQVSKO_14deltalake_core10operations5merge14MergeOperationENCNvB22_13modify_schema0ENCB3b_s_0EEINtB5_8FuseImplBY_E4nextB26_.exit.thread.i: ; preds = %_RNvXs9_NtNtNtCsbvkFyIu7lgC_4core4iter8adapters4fuseINtB5_4FuseINtNtB7_3map3MapINtNtB7_6filter6FilterINtNtNtBb_5slice4iter4IterNtNtNtCs14kWLkQVSKO_14deltalake_core10operations5merge14MergeOperationENCNvB22_13modify_schema0ENCB3b_s_0EEINtB5_8FuseImplBY_E4nextB26_.exit.i, %bb.f, %bb.h
  %i.aj = load ptr, ptr %.sroa.429.0..sroa_idx, align 8, !alias.scope !29177, !noundef !8
  %.not.i3.i = icmp eq ptr %i.aj, null
  br i1 %.not.i3.i, label %.loopexit, label %bb.k
...
bb.k:                                             ; preds = %_RNvXs9_NtNtNtCsbvkFyIu7lgC_4core4iter8adapters4fuseINtB5_4FuseINtNtB7_3map3MapINtNtB7_6filter6FilterINtNtNtBb_5slice4iter4IterNtNtNtCs14kWLkQVSKO_14deltalake_core10operations5merge14MergeOperationENCNvB22_13modify_schema0ENCB3b_s_0EEINtB5_8FuseImplBY_E4nextB26_.exit.thread.i
  ...
  br i1 %.not4.i4.i, label %.loopexit, label %_RNvXsi_NtNtNtCsbvkFyIu7lgC_4core4iter8adapters7flattenINtB5_13FlattenCompatINtNtB7_3map3MapINtNtB7_6filter6FilterINtNtNtBb_5slice4iter4IterNtNtNtCs14kWLkQVSKO_14deltalake_core10operations5merge14MergeOperationENCNvB2f_13modify_schema0ENCB3o_s_0EINtNtNtNtCs2pqxYH9ZEk8_3std11collections4hash3map4KeysNtNtCsjhHCjzi9uUI_17datafusion_common6column6ColumnNtNtCs8VI8w5SIoU4_15datafusion_expr4expr4ExprEENtNtNtB9_6traits8iterator8Iterator4nextB2j_.exit

_RNvXsi_NtNtNtCsbvkFyIu7lgC_4core4iter8adapters7flattenINtB5_13FlattenCompatINtNtB7_3map3MapINtNtB7_6filter6FilterINtNtNtBb_5slice4iter4IterNtNtNtCs14kWLkQVSKO_14deltalake_core10operations5merge14MergeOperationENCNvB2f_13modify_schema0ENCB3o_s_0EINtNtNtNtCs2pqxYH9ZEk8_3std11collections4hash3map4KeysNtNtCsjhHCjzi9uUI_17datafusion_common6column6ColumnNtNtCs8VI8w5SIoU4_15datafusion_expr4expr4ExprEENtNtNtB9_6traits8iterator8Iterator4nextB2j_.exit: ; preds = %bb.k
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d), !noalias !29165
  br label %_RNvXsi_NtNtNtCsbvkFyIu7lgC_4core4iter8adapters7flattenINtB5_13FlattenCompatINtNtB7_3map3MapINtNtB7_6filter6FilterINtNtNtBb_5slice4iter4IterNtNtNtCs14kWLkQVSKO_14deltalake_core10operations5merge14MergeOperationENCNvB2f_13modify_schema0ENCB3o_s_0EINtNtNtNtCs2pqxYH9ZEk8_3std11collections4hash3map4KeysNtNtCsjhHCjzi9uUI_17datafusion_common6column6ColumnNtNtCs8VI8w5SIoU4_15datafusion_expr4expr4ExprEENtNtNtB9_6traits8iterator8Iterator4nextB2j_.exit.thread

_RNvXsi_NtNtNtCsbvkFyIu7lgC_4core4iter8adapters7flattenINtB5_13FlattenCompatINtNtB7_3map3MapINtNtB7_6filter6FilterINtNtNtBb_5slice4iter4IterNtNtNtCs14kWLkQVSKO_14deltalake_core10operations5merge14MergeOperationENCNvB2f_13modify_schema0ENCB3o_s_0EINtNtNtNtCs2pqxYH9ZEk8_3std11collections4hash3map4KeysNtNtCsjhHCjzi9uUI_17datafusion_common6column6ColumnNtNtCs8VI8w5SIoU4_15datafusion_expr4expr4ExprEENtNtNtB9_6traits8iterator8Iterator4nextB2j_.exit.thread: ; preds = %bb.d, %_RNvXsi_NtNtNtCsbvkFyIu7lgC_4core4iter8adapters7flattenINtB5_13FlattenCompatINtNtB7_3map3MapINtNtB7_6filter6FilterINtNtNtBb_5slice4iter4IterNtNtNtCs14kWLkQVSKO_14deltalake_core10operations5merge14MergeOperationENCNvB2f_13modify_schema0ENCB3o_s_0EINtNtNtNtCs2pqxYH9ZEk8_3std11collections4hash3map4KeysNtNtCsjhHCjzi9uUI_17datafusion_common6column6ColumnNtNtCs8VI8w5SIoU4_15datafusion_expr4expr4ExprEENtNtNtB9_6traits8iterator8Iterator4nextB2j_.exit
  %.sroa.0.0.i99 = phi ptr [ %i.al, %_RNvXsi_NtNtNtCsbvkFyIu7lgC_4core4iter8adapters7flattenINtB5_13FlattenCompatINtNtB7_3map3MapINtNtB7_6filter6FilterINtNtNtBb_5slice4iter4IterNtNtNtCs14kWLkQVSKO_14deltalake_core10operations5merge14MergeOperationENCNvB2f_13modify_schema0ENCB3o_s_0EINtNtNtNtCs2pqxYH9ZEk8_3std11collections4hash3map4KeysNtNtCsjhHCjzi9uUI_17datafusion_common6column6ColumnNtNtCs8VI8w5SIoU4_15datafusion_expr4expr4ExprEENtNtNtB9_6traits8iterator8Iterator4nextB2j_.exit ], [ %i.aa, %bb.d ] ; 3 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.p)
  %i.am = getelementptr inbounds nuw i8, ptr %.sroa.0.0.i99, i64 64
  %i.an = load ptr, ptr %i.am, align 8, !nonnull !8, !noundef !8
  %i.ao = getelementptr inbounds nuw i8, ptr %.sroa.0.0.i99, i64 72
  %i.ap = load i64, ptr %i.ao, align 8, !noundef !8
  ...
  %i.aq = load i64, ptr %i.p, align 8, !range !19, !noundef !8 ; 2 uses
  %.not62 = icmp eq i64 %i.aq, 20
  %i.ar = load ptr, ptr %i.s, align 8             ; 2 uses
  br i1 %.not62, label %bb.n, label %bb.m

.loopexit:                                        ; preds = %_RNvXs9_NtNtNtCsbvkFyIu7lgC_4core4iter8adapters4fuseINtB5_4FuseINtNtB7_3map3MapINtNtB7_6filter6FilterINtNtNtBb_5slice4iter4IterNtNtNtCs14kWLkQVSKO_14deltalake_core10operations5merge14MergeOperationENCNvB22_13modify_schema0ENCB3b_s_0EEINtB5_8FuseImplBY_E4nextB26_.exit.thread.i, %bb.k
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d), !noalias !29165
  call void @llvm.lifetime.end.p0(ptr nonnull %i.q)
  store i64 -9223372036854775711, ptr %0, align 16
  br label %bb.l

bb.l:                                             ; preds = %bb.bj, %.loopexit
  ret void

bb.m:                                             ; preds = %_RNvXsi_NtNtNtCsbvkFyIu7lgC_4core4iter8adapters7flattenINtB5_13FlattenCompatINtNtB7_3map3MapINtNtB7_6filter6FilterINtNtNtBb_5slice4iter4IterNtNtNtCs14kWLkQVSKO_14deltalake_core10operations5merge14MergeOperationENCNvB2f_13modify_schema0ENCB3o_s_0EINtNtNtNtCs2pqxYH9ZEk8_3std11collections4hash3map4KeysNtNtCsjhHCjzi9uUI_17datafusion_common6column6ColumnNtNtCs8VI8w5SIoU4_15datafusion_expr4expr4ExprEENtNtNtB9_6traits8iterator8Iterator4nextB2j_.exit.thread
...
bb.n:                                             ; preds = %_RNvXsi_NtNtNtCsbvkFyIu7lgC_4core4iter8adapters7flattenINtB5_13FlattenCompatINtNtB7_3map3MapINtNtB7_6filter6FilterINtNtNtBb_5slice4iter4IterNtNtNtCs14kWLkQVSKO_14deltalake_core10operations5merge14MergeOperationENCNvB2f_13modify_schema0ENCB3o_s_0EINtNtNtNtCs2pqxYH9ZEk8_3std11collections4hash3map4KeysNtNtCsjhHCjzi9uUI_17datafusion_common6column6ColumnNtNtCs8VI8w5SIoU4_15datafusion_expr4expr4ExprEENtNtNtB9_6traits8iterator8Iterator4nextB2j_.exit.thread
  call void @llvm.lifetime.end.p0(ptr nonnull %i.p)
  %i.as = load ptr, ptr %i.ar, align 8, !nonnull !8, !noundef !8 ; 5 uses
end_hunk_8
