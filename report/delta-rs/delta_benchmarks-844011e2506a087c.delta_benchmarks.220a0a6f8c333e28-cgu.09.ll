...
bb.co:                                            ; preds = %bb.cj, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs8Hz2sPNgbCO_10datafusion9execution13session_state22SessionContextProviderECs2VbMhdeEr66_16delta_benchmarks.exit.i.i.i
  %4 = phi ptr [ %i.ft, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs8Hz2sPNgbCO_10datafusion9execution13session_state22SessionContextProviderECs2VbMhdeEr66_16delta_benchmarks.exit.i.i.i ], [ %i.gs, %bb.cj ] ; 4 uses
  %5 = phi ptr [ %i.fu, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs8Hz2sPNgbCO_10datafusion9execution13session_state22SessionContextProviderECs2VbMhdeEr66_16delta_benchmarks.exit.i.i.i ], [ %i.gt, %bb.cj ] ; 3 uses
  %6 = phi ptr [ %i.fv, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs8Hz2sPNgbCO_10datafusion9execution13session_state22SessionContextProviderECs2VbMhdeEr66_16delta_benchmarks.exit.i.i.i ], [ %i.gu, %bb.cj ] ; 4 uses
  %7 = phi ptr [ %i.fw, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs8Hz2sPNgbCO_10datafusion9execution13session_state22SessionContextProviderECs2VbMhdeEr66_16delta_benchmarks.exit.i.i.i ], [ %i.gv, %bb.cj ]
  %8 = phi ptr [ %i.fx, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs8Hz2sPNgbCO_10datafusion9execution13session_state22SessionContextProviderECs2VbMhdeEr66_16delta_benchmarks.exit.i.i.i ], [ %i.gw, %bb.cj ]
  %.sroa.024.0.copyload25.i.i = load i64, ptr %i.br, align 16, !noalias !7581 ; 3 uses
  %.sroa.826.0..sroa_idx27.i.i = getelementptr inbounds nuw i8, ptr %i.br, i64 8
  %.sroa.826.i.sroa.0.0.copyload.i.a = load i64, ptr %.sroa.826.0..sroa_idx27.i.i, align 8, !noalias !7581 ; 2 uses
...
bb.cw:                                            ; preds = %bb.co, %.thread.i.i
  %i.qg = phi ptr [ %i.hk, %.thread.i.i ], [ %4, %bb.co ]
  %i.qh = phi ptr [ %i.hm, %.thread.i.i ], [ %6, %bb.co ]
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.826.i.sroa.7.i)
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.826.i.sroa.8.i)
...
begin_hunk_12_@_RNCNvMs3_NtNtCs8Hz2sPNgbCO_10datafusion9execution7contextNtB7_14SessionContext3sql0Cs2VbMhdeEr66_16delta_benchmarks:bb.a
  ...
  %.sroa.433.i.sroa.0.0.i = phi i64 [ %.sroa.8.i.sroa.0.0.copyload.i, %bb.r ], [ %.sroa.826.i.sroa.0.0.copyload.i.a, %bb.ct ], [ %.sroa.826.i.sroa.0.0.copyload.i.a, %bb.cs ] ; 2 uses
  %.sroa.032.1.i.i = phi i64 [ 36, %bb.r ], [ 36, %bb.ct ], [ %.sroa.024.0.copyload25.i.i, %bb.cs ] ; 2 uses
