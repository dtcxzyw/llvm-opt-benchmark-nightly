...
.lr.ph:                                           ; preds = %.preheader9.i.i.i.i.i.preheader
  %.sroa.012.0.i.i.i.i.i122.a = getelementptr inbounds nuw i8, ptr %i.by, i64 32
  br label %bb.af
...
bb.af:                                            ; preds = %.lr.ph, %.preheader9.i.i.i.i.i
  %.sroa.012.0.i.i.i.i.i123 = phi ptr [ %.sroa.012.0.i.i.i.i.i122.a, %.lr.ph ], [ %.sroa.012.0.i.i.i.i.i, %.preheader9.i.i.i.i.i ] ; 2 uses
...
.lr.ph126:                                        ; preds = %.preheader.i.i.i.i.i.preheader
  %.sroa.011.0.i.i.i.i.i124.a = getelementptr inbounds nuw i8, ptr %i.ci, i64 32
  br label %bb.ba
...
.preheader.i.i.i.i.i:                             ; preds = %bb.bb
  %.sroa.011.0.i.i.i.i.i = getelementptr inbounds nuw i8, ptr %.sroa.011.0.i.i.i.i.i125, i64 32 ; 2 uses
  %i.cn = icmp eq ptr %.sroa.011.0.i.i.i.i.i, %i.ck
  br i1 %i.cn, label %.loopexit20.i.i.i.i.i, label %bb.ba, !llvm.loop !196

.loopexit20.i.i.i.i.i:                            ; preds = %.preheader.i.i.i.i.i, %.preheader.i.i.i.i.i.preheader, %.preheader.preheader.i.i.i.i.i
  invoke void @_RNvNtCsBGNUbrdbJ0_5quote9___private14push_fat_arrow(ptr noalias noundef nonnull align 8 dereferenceable(32) %i.k)
          to label %bb.bc unwind label %.loopexit.split-lp.i.i.i.i.i, !noalias !175

bb.ba:                                            ; preds = %.lr.ph126, %.preheader.i.i.i.i.i
  %.sroa.011.0.i.i.i.i.i125 = phi ptr [ %.sroa.011.0.i.i.i.i.i124.a, %.lr.ph126 ], [ %.sroa.011.0.i.i.i.i.i, %.preheader.i.i.i.i.i ] ; 2 uses
  invoke void @_RNvNtCsBGNUbrdbJ0_5quote9___private7push_or(ptr noalias noundef nonnull align 8 dereferenceable(32) %i.k)
          to label %bb.bb unwind label %.loopexit.loopexit.i.i.i.i.i, !noalias !175

bb.bb:                                            ; preds = %bb.ba
  invoke void @_RNvXsu_NtCsBGNUbrdbJ0_5quote9to_tokensNtCsbjGuDcEILED_11proc_macro211TokenStreamNtB5_8ToTokens9to_tokens(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(32) %.sroa.011.0.i.i.i.i.i125, ptr noalias noundef nonnull align 8 dereferenceable(32) %i.k)
          to label %.preheader.i.i.i.i.i unwind label %.loopexit.loopexit.i.i.i.i.i, !noalias !175, !llvm.loop !196

bb.bc:                                            ; preds = %.loopexit20.i.i.i.i.i
  invoke void @_RNvNtCsBGNUbrdbJ0_5quote9___private10push_ident(ptr noalias noundef nonnull align 8 dereferenceable(32) %i.k, ptr noalias noundef nonnull readonly captures(address, read_provenance) @1, i64 noundef 4)
          to label %bb.bd unwind label %.loopexit.split-lp.i.i.i.i.i, !noalias !175

bb.bd:                                            ; preds = %bb.bc
  invoke void @_RNvNtCsBGNUbrdbJ0_5quote9___private8push_dot(ptr noalias noundef nonnull align 8 dereferenceable(32) %i.k)
          to label %bb.be unwind label %.loopexit.split-lp.i.i.i.i.i, !noalias !175

bb.be:                                            ; preds = %bb.bd
  invoke void @_RNvXNtCsBGNUbrdbJ0_5quote9to_tokensRNtCsbjGuDcEILED_11proc_macro25IdentNtB2_8ToTokens9to_tokensCshbKHpCRGxgC_16deltalake_derive(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(8) %i.w, ptr noalias noundef nonnull align 8 dereferenceable(32) %i.k)
          to label %bb.bf unwind label %.loopexit.split-lp.i.i.i.i.i, !noalias !175

bb.bf:                                            ; preds = %bb.be
  invoke void @_RNvNtCsBGNUbrdbJ0_5quote9___private7push_eq(ptr noalias noundef nonnull align 8 dereferenceable(32) %i.k)
          to label %bb.bg unwind label %.loopexit.split-lp.i.i.i.i.i, !noalias !175

bb.bg:                                            ; preds = %bb.bf
  invoke void @_RNvNtCsBGNUbrdbJ0_5quote9___private10push_ident(ptr noalias noundef nonnull align 8 dereferenceable(32) %i.k, ptr noalias noundef nonnull readonly captures(address, read_provenance) @17, i64 noundef 4)
          to label %bb.bh unwind label %.loopexit.split-lp.i.i.i.i.i, !noalias !175

bb.bh:                                            ; preds = %bb.bg
  call void @llvm.lifetime.start.p0(ptr nonnull %i.j), !noalias !175
  call void @llvm.lifetime.start.p0(ptr nonnull %i.i), !noalias !175
  invoke void @_RNvMCsbjGuDcEILED_11proc_macro2NtB2_11TokenStream3new(ptr noalias noundef nonnull sret([32 x i8]) align 8 captures(address) dereferenceable(32) %i.i)
          to label %bb.bi unwind label %.loopexit.split-lp.i.i.i.i.i, !noalias !175

bb.bi:                                            ; preds = %bb.bh
  invoke void @_RNvXsu_NtCsBGNUbrdbJ0_5quote9to_tokensNtCsbjGuDcEILED_11proc_macro211TokenStreamNtB5_8ToTokens9to_tokens(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(32) %i.s, ptr noalias noundef nonnull align 8 dereferenceable(32) %i.i)
          to label %bb.bl unwind label %bb.bk, !noalias !175

bb.bj:                                            ; preds = %bb.bn, %bb.bk
  %.pn19.i.i.i.i.i = phi { ptr, i32 } [ %i.co, %bb.bk ], [ %i.cp, %bb.bn ]
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtCsbjGuDcEILED_11proc_macro211TokenStreamECshbKHpCRGxgC_16deltalake_derive(ptr noalias noundef align 8 dereferenceable(32) %i.i) #14
          to label %.loopexit.i.i.i.i.i unwind label %bb.ax, !noalias !175

bb.bk:                                            ; preds = %bb.bp, %bb.bo, %bb.bl, %bb.bi
  %i.co = landingpad { ptr, i32 }
          cleanup
  br label %bb.bj

bb.bl:                                            ; preds = %bb.bi
  call void @llvm.lifetime.start.p0(ptr nonnull %i.h), !noalias !175
  call void @llvm.lifetime.start.p0(ptr nonnull %i.g), !noalias !175
  invoke void @_RNvMCsbjGuDcEILED_11proc_macro2NtB2_11TokenStream3new(ptr noalias noundef nonnull sret([32 x i8]) align 8 captures(address) dereferenceable(32) %i.g)
          to label %bb.bm unwind label %bb.bk, !noalias !175

bb.bm:                                            ; preds = %bb.bl
  invoke void @_RNvNtCsBGNUbrdbJ0_5quote9___private10push_ident(ptr noalias noundef nonnull align 8 dereferenceable(32) %i.g, ptr noalias noundef nonnull readonly captures(address, read_provenance) @21, i64 noundef 1)
          to label %bb.bo unwind label %bb.bn, !noalias !175

bb.bn:                                            ; preds = %bb.bm
  %i.cp = landingpad { ptr, i32 }
          cleanup
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtCsbjGuDcEILED_11proc_macro211TokenStreamECshbKHpCRGxgC_16deltalake_derive(ptr noalias noundef align 8 dereferenceable(32) %i.g) #14
          to label %bb.bj unwind label %bb.ax, !noalias !175

bb.bo:                                            ; preds = %bb.bm
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.h, ptr noundef nonnull align 8 dereferenceable(32) %i.g, i64 32, i1 false), !noalias !175
  call void @llvm.lifetime.end.p0(ptr nonnull %i.g), !noalias !175
  invoke void @_RNvNtCsBGNUbrdbJ0_5quote9___private10push_group(ptr noalias noundef nonnull align 8 dereferenceable(32) %i.i, i8 noundef 0, ptr noalias noundef nonnull align 8 captures(address) dereferenceable(32) %i.h)
          to label %bb.bp unwind label %bb.bk, !noalias !175

bb.bp:                                            ; preds = %bb.bo
  call void @llvm.lifetime.end.p0(ptr nonnull %i.h), !noalias !175
  invoke void @_RNvNtCsBGNUbrdbJ0_5quote9___private13push_question(ptr noalias noundef nonnull align 8 dereferenceable(32) %i.i)
          to label %bb.bq unwind label %bb.bk, !noalias !175

bb.bq:                                            ; preds = %bb.bp
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.j, ptr noundef nonnull align 8 dereferenceable(32) %i.i, i64 32, i1 false), !noalias !175
  call void @llvm.lifetime.end.p0(ptr nonnull %i.i), !noalias !175
  invoke void @_RNvNtCsBGNUbrdbJ0_5quote9___private10push_group(ptr noalias noundef nonnull align 8 dereferenceable(32) %i.k, i8 noundef 0, ptr noalias noundef nonnull align 8 captures(address) dereferenceable(32) %i.j)
          to label %bb.br unwind label %.loopexit.split-lp.i.i.i.i.i, !noalias !175

bb.br:                                            ; preds = %bb.bq
  call void @llvm.lifetime.end.p0(ptr nonnull %i.j), !noalias !175
  invoke void @_RNvNtCsBGNUbrdbJ0_5quote9___private10push_comma(ptr noalias noundef nonnull align 8 dereferenceable(32) %i.k)
          to label %bb.bs unwind label %.loopexit.split-lp.i.i.i.i.i, !noalias !175

bb.bs:                                            ; preds = %bb.br
  %.sroa.05.0.copyload6.i.i.i.i = load i64, ptr %i.k, align 8, !noalias !175
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %.sroa.5.i.i.i.i, ptr noundef nonnull align 8 dereferenceable(24) %.sroa.5.0..sroa_idx7.i.i.i.i, i64 24, i1 false), !noalias !186
  call void @llvm.lifetime.end.p0(ptr nonnull %i.k), !noalias !175
  br label %bb.at

_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VecNtCsbjGuDcEILED_11proc_macro211TokenStreamEECshbKHpCRGxgC_16deltalake_derive.exit.i.i.i.i.i: ; preds = %bb.av
  call void @llvm.lifetime.end.p0(ptr nonnull %i.q), !noalias !175
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtCsbjGuDcEILED_11proc_macro211TokenStreamECshbKHpCRGxgC_16deltalake_derive(ptr noalias noundef align 8 dereferenceable(32) %i.s)
          to label %bb.bt unwind label %bb.o, !noalias !175

bb.bt:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VecNtCsbjGuDcEILED_11proc_macro211TokenStreamEECshbKHpCRGxgC_16deltalake_derive.exit.i.i.i.i.i
  call void @llvm.lifetime.end.p0(ptr nonnull %i.s), !noalias !175
  invoke void @_RNvXso_NtCs6Po7BT7Nknu_5alloc3vecINtB5_3VecNtNtB7_6string6StringENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCshbKHpCRGxgC_16deltalake_derive(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.ak)
          to label %bb.bv unwind label %bb.bu, !noalias !175

bb.bu:                                            ; preds = %bb.bt
  %i.cq = landingpad { ptr, i32 }
          cleanup
  invoke void @_RNvXs1_NtCs6Po7BT7Nknu_5alloc7raw_vecINtB5_6RawVecNtNtB7_6string6StringENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCshbKHpCRGxgC_16deltalake_derive(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.ak)
          to label %.body37.i.i.i.i.i unwind label %bb.bw, !noalias !175

bb.bv:                                            ; preds = %bb.bt
  invoke void @_RNvXs1_NtCs6Po7BT7Nknu_5alloc7raw_vecINtB5_6RawVecNtNtB7_6string6StringENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCshbKHpCRGxgC_16deltalake_derive(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.ak)
          to label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VecNtNtBL_6string6StringEECshbKHpCRGxgC_16deltalake_derive.exit.i.i.i.i.i unwind label %bb.bx, !noalias !175
...
.body37.i.i.i.i.i:                                ; preds = %bb.bx, %bb.bu
  %eh.lpad-body38.i.i.i.i.i = phi { ptr, i32 } [ %i.cs, %bb.bx ], [ %i.cq, %bb.bu ]
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionNtNtCs6Po7BT7Nknu_5alloc6string6StringEECshbKHpCRGxgC_16deltalake_derive(ptr noalias noundef align 8 dereferenceable(24) %i.al) #14
          to label %.body39.i.i.i.i.i unwind label %bb.ax, !noalias !175

_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VecNtNtBL_6string6StringEECshbKHpCRGxgC_16deltalake_derive.exit.i.i.i.i.i: ; preds = %bb.bv
  %i.ct = load i64, ptr %i.al, align 8, !range !3, !alias.scope !197, !noalias !175, !noundef !4
  %i.cu = icmp eq i64 %i.ct, -9223372036854775808
  br i1 %i.cu, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionNtNtCs6Po7BT7Nknu_5alloc6string6StringEECshbKHpCRGxgC_16deltalake_derive.exit.i.i.i.i.i, label %bb.by

bb.by:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VecNtNtBL_6string6StringEECshbKHpCRGxgC_16deltalake_derive.exit.i.i.i.i.i
  invoke void @_RNvXso_NtCs6Po7BT7Nknu_5alloc3vecINtB5_3VechENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCshbKHpCRGxgC_16deltalake_derive(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.al)
          to label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6Po7BT7Nknu_5alloc6string6StringECshbKHpCRGxgC_16deltalake_derive.exit.i.i.i.i.i.i unwind label %bb.bz, !noalias !175

bb.bz:                                            ; preds = %bb.by
  %i.cv = landingpad { ptr, i32 }
          cleanup
  invoke void @_RNvXs1_NtCs6Po7BT7Nknu_5alloc7raw_vecINtB5_6RawVechENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCshbKHpCRGxgC_16deltalake_derive(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.al)
          to label %.body39.i.i.i.i.i unwind label %bb.ca, !noalias !175
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6Po7BT7Nknu_5alloc6string6StringECshbKHpCRGxgC_16deltalake_derive.exit.i.i.i.i.i.i: ; preds = %bb.by
  invoke void @_RNvXs1_NtCs6Po7BT7Nknu_5alloc7raw_vecINtB5_6RawVechENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCshbKHpCRGxgC_16deltalake_derive(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.al)
          to label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionNtNtCs6Po7BT7Nknu_5alloc6string6StringEECshbKHpCRGxgC_16deltalake_derive.exit.i.i.i.i.i unwind label %bb.i, !noalias !175

_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionNtNtCs6Po7BT7Nknu_5alloc6string6StringEECshbKHpCRGxgC_16deltalake_derive.exit.i.i.i.i.i: ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6Po7BT7Nknu_5alloc6string6StringECshbKHpCRGxgC_16deltalake_derive.exit.i.i.i.i.i.i, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VecNtNtBL_6string6StringEECshbKHpCRGxgC_16deltalake_derive.exit.i.i.i.i.i
  call void @llvm.lifetime.end.p0(ptr nonnull %i.u), !noalias !175
  invoke void @_RNvXso_NtCs6Po7BT7Nknu_5alloc3vecINtB5_3VechENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCshbKHpCRGxgC_16deltalake_derive(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.v)
          to label %_RNCNvCshbKHpCRGxgC_16deltalake_derive23generate_try_update_key0B3_.exit.i.i.i.i unwind label %bb.cb, !noalias !175

bb.cb:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionNtNtCs6Po7BT7Nknu_5alloc6string6StringEECshbKHpCRGxgC_16deltalake_derive.exit.i.i.i.i.i
  %i.cx = landingpad { ptr, i32 }
          cleanup
  invoke void @_RNvXs1_NtCs6Po7BT7Nknu_5alloc7raw_vecINtB5_6RawVechENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCshbKHpCRGxgC_16deltalake_derive(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.v)
          to label %common.resume.i.i.i.i unwind label %bb.cc, !noalias !175
...
.body42.i.i.i.i.i:                                ; preds = %bb.ci, %bb.cf, %bb.cd
  %.pn23.i.i.i.i.i = phi { ptr, i32 } [ %i.da, %bb.cf ], [ %i.cz, %bb.cd ], [ %i.de, %bb.ci ]
  invoke void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6Po7BT7Nknu_5alloc6string6StringECshbKHpCRGxgC_16deltalake_derive(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.n) #14
          to label %.body45.i.i.i.i.i unwind label %bb.ax, !noalias !175
...
bb.ce:                                            ; preds = %bb.z
  invoke void @_RNvXs6_NtCsBGNUbrdbJ0_5quote9to_tokensNtNtCs6Po7BT7Nknu_5alloc6string6StringNtB5_8ToTokens9to_tokens(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.n, ptr noalias noundef nonnull align 8 dereferenceable(32) %i.l)
          to label %bb.cg unwind label %bb.cf, !noalias !175

bb.cf:                                            ; preds = %bb.ce
  %i.da = landingpad { ptr, i32 }
          cleanup
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtCsbjGuDcEILED_11proc_macro211TokenStreamECshbKHpCRGxgC_16deltalake_derive(ptr noalias noundef align 8 dereferenceable(32) %i.l) #14
          to label %.body42.i.i.i.i.i unwind label %bb.ax, !noalias !175

bb.cg:                                            ; preds = %bb.ce
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.m, ptr noundef nonnull align 8 dereferenceable(32) %i.l, i64 32, i1 false), !noalias !175
  call void @llvm.lifetime.end.p0(ptr nonnull %i.l), !noalias !175
  %i.db = load i64, ptr %i.ah, align 8, !alias.scope !200, !noalias !203, !noundef !4 ; 3 uses
  %i.dc = load i64, ptr %i.q, align 8, !range !187, !alias.scope !200, !noalias !203, !noundef !4
  %i.dd = icmp eq i64 %i.db, %i.dc
  br i1 %i.dd, label %bb.ch, label %bb.ck

bb.ch:                                            ; preds = %bb.cg
  invoke void @_RNvMs3_NtCs6Po7BT7Nknu_5alloc7raw_vecINtB5_6RawVecNtCsbjGuDcEILED_11proc_macro211TokenStreamE8grow_oneCshbKHpCRGxgC_16deltalake_derive(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.q)
          to label %bb.ck unwind label %bb.ci, !noalias !203

bb.ci:                                            ; preds = %bb.ch
  %i.de = landingpad { ptr, i32 }
          cleanup
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtCsbjGuDcEILED_11proc_macro211TokenStreamECshbKHpCRGxgC_16deltalake_derive(ptr noalias noundef nonnull align 8 dereferenceable(32) %i.m) #14
          to label %.body42.i.i.i.i.i unwind label %bb.cj, !noalias !175
...
bb.ck:                                            ; preds = %bb.ch, %bb.cg
  %i.dg = load ptr, ptr %i.ag, align 8, !alias.scope !200, !noalias !203, !nonnull !4, !noundef !4
  %i.dh = getelementptr inbounds nuw [32 x i8], ptr %i.dg, i64 %i.db
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.dh, ptr noundef nonnull align 8 dereferenceable(32) %i.m, i64 32, i1 false), !noalias !175
  %i.di = add i64 %i.db, 1
  store i64 %i.di, ptr %i.ah, align 8, !alias.scope !200, !noalias !203
  call void @llvm.lifetime.end.p0(ptr nonnull %i.m), !noalias !175
  invoke void @_RNvXso_NtCs6Po7BT7Nknu_5alloc3vecINtB5_3VechENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCshbKHpCRGxgC_16deltalake_derive(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.n)
          to label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VechEECshbKHpCRGxgC_16deltalake_derive.exit.i.i.i.i.i.i unwind label %bb.cl, !noalias !175

bb.cl:                                            ; preds = %bb.ck
  %i.dj = landingpad { ptr, i32 }
          cleanup
  invoke void @_RNvXs1_NtCs6Po7BT7Nknu_5alloc7raw_vecINtB5_6RawVechENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCshbKHpCRGxgC_16deltalake_derive(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.n)
          to label %.body45.i.i.i.i.i unwind label %bb.cm, !noalias !175
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VechEECshbKHpCRGxgC_16deltalake_derive.exit.i.i.i.i.i.i: ; preds = %bb.ck
  invoke void @_RNvXs1_NtCs6Po7BT7Nknu_5alloc7raw_vecINtB5_6RawVechENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCshbKHpCRGxgC_16deltalake_derive(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.n)
          to label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6Po7BT7Nknu_5alloc6string6StringECshbKHpCRGxgC_16deltalake_derive.exit48.i.i.i.i.i unwind label %bb.y, !noalias !175

_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6Po7BT7Nknu_5alloc6string6StringECshbKHpCRGxgC_16deltalake_derive.exit48.i.i.i.i.i: ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VechEECshbKHpCRGxgC_16deltalake_derive.exit.i.i.i.i.i.i
  call void @llvm.lifetime.end.p0(ptr nonnull %i.n), !noalias !175
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.7.i.i.i.i.i)
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.7.i.i.i.i.i)
  %i.dl = load ptr, ptr %.sroa.6.0..sroa_idx.i.i.i.i.i, align 8, !alias.scope !205, !noalias !191, !nonnull !4, !noundef !4
  %i.dm = load ptr, ptr %.sroa.45.0..sroa_idx.i.i.i.i.i, align 8, !alias.scope !205, !noalias !191, !nonnull !4, !noundef !4 ; 2 uses
  %i.dn = icmp eq ptr %i.dm, %i.dl
  br i1 %i.dn, label %_RNvXs4_NtNtCs6Po7BT7Nknu_5alloc3vec9into_iterINtB5_8IntoIterNtNtB9_6string6StringENtNtNtNtCsbvkFyIu7lgC_4core4iter6traits8iterator8Iterator4nextCshbKHpCRGxgC_16deltalake_derive.exit.thread.i.i.i.i.i, label %_RNvXs4_NtNtCs6Po7BT7Nknu_5alloc3vec9into_iterINtB5_8IntoIterNtNtB9_6string6StringENtNtNtNtCsbvkFyIu7lgC_4core4iter6traits8iterator8Iterator4nextCshbKHpCRGxgC_16deltalake_derive.exit.i.i.i.i.i

bb.cn:                                            ; preds = %bb.q, %bb.l
  %.sroa.0.0.i6.i.i.i = phi i64 [ -9223372036854775807, %bb.q ], [ -9223372036854775806, %bb.l ]
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtCshbKHpCRGxgC_16deltalake_derive15FieldAttributesEBI_(ptr noalias noundef align 8 dereferenceable(80) %i.u)
          to label %bb.cr unwind label %bb.i, !noalias !175

bb.co:                                            ; preds = %bb.cp, %bb.o, %bb.n
  %.pn25.pn.pn.pn4.i.i.i.i.i = phi { ptr, i32 } [ %i.bf, %bb.o ], [ %.pn25.pn.pn.pn5.i.i.i.i.i, %bb.cp ], [ %.pn25.pn.pn.i.i.i.i.i, %bb.n ]
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VecNtNtBL_6string6StringEECshbKHpCRGxgC_16deltalake_derive(ptr noalias noundef align 8 dereferenceable(24) %i.ak) #14
          to label %bb.cq unwind label %bb.ax, !noalias !175

bb.cp:                                            ; preds = %bb.n, %.thread.i.i.i.i.i
  %.pn25.pn.pn.pn5.i.i.i.i.i = phi { ptr, i32 } [ %i.be, %.thread.i.i.i.i.i ], [ %.pn25.pn.pn.i.i.i.i.i, %bb.n ]
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VecNtNtBL_6string6StringEECshbKHpCRGxgC_16deltalake_derive(ptr noalias noundef align 8 dereferenceable(24) %i.u) #14
          to label %bb.co unwind label %bb.ax, !noalias !175

bb.cq:                                            ; preds = %bb.co
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionNtNtCs6Po7BT7Nknu_5alloc6string6StringEECshbKHpCRGxgC_16deltalake_derive(ptr noalias noundef align 8 dereferenceable(24) %i.al) #14
          to label %.body39.i.i.i.i.i unwind label %bb.ax, !noalias !175

bb.cr:                                            ; preds = %bb.cn, %bb.k
  %.sroa.0.1.i.i.i.i = phi i64 [ -9223372036854775807, %bb.k ], [ %.sroa.0.0.i6.i.i.i, %bb.cn ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.u), !noalias !175
  invoke void @_RNvXso_NtCs6Po7BT7Nknu_5alloc3vecINtB5_3VechENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCshbKHpCRGxgC_16deltalake_derive(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.v)
          to label %_RNCNvCshbKHpCRGxgC_16deltalake_derive23generate_try_update_key0B3_.exit.i.i.i.i unwind label %bb.cs, !noalias !175

bb.cs:                                            ; preds = %bb.cr
  %i.do = landingpad { ptr, i32 }
          cleanup
  invoke void @_RNvXs1_NtCs6Po7BT7Nknu_5alloc7raw_vecINtB5_6RawVechENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCshbKHpCRGxgC_16deltalake_derive(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.v)
          to label %common.resume.i.i.i.i unwind label %bb.ct, !noalias !175
...
_RNCNvCshbKHpCRGxgC_16deltalake_derive23generate_try_update_key0B3_.exit.i.i.i.i: ; preds = %bb.cr, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionNtNtCs6Po7BT7Nknu_5alloc6string6StringEECshbKHpCRGxgC_16deltalake_derive.exit.i.i.i.i.i
  %.sroa.0.2.i.i.i.i = phi i64 [ %.sroa.0.1.i.i.i.i, %bb.cr ], [ %.sroa.05.0.i.i.i.i, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionNtNtCs6Po7BT7Nknu_5alloc6string6StringEECshbKHpCRGxgC_16deltalake_derive.exit.i.i.i.i.i ] ; 2 uses
  call void @_RNvXs1_NtCs6Po7BT7Nknu_5alloc7raw_vecINtB5_6RawVechENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCshbKHpCRGxgC_16deltalake_derive(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.v), !noalias !175
  call void @llvm.lifetime.end.p0(ptr nonnull %i.v), !noalias !175
  call void @llvm.lifetime.end.p0(ptr nonnull %i.w), !noalias !175
  switch i64 %.sroa.0.2.i.i.i.i, label %.thread [
    i64 -9223372036854775806, label %bb.cz
    i64 -9223372036854775807, label %bb.cu
  ]

bb.cu:                                            ; preds = %_RNCNvCshbKHpCRGxgC_16deltalake_derive23generate_try_update_key0B3_.exit.i.i.i.i
  %i.dq = load i64, ptr %i.y, align 8, !range !3, !alias.scope !207, !noalias !210, !noundef !4
  %i.dr = icmp eq i64 %i.dq, -9223372036854775808
  br i1 %i.dr, label %bb.da, label %bb.cv

bb.cv:                                            ; preds = %bb.cu
  invoke void @_RNvXso_NtCs6Po7BT7Nknu_5alloc3vecINtB5_3VecNtNtCs7nQiqFc7Txl_3syn5error12ErrorMessageENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCshbKHpCRGxgC_16deltalake_derive(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.y)
          to label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6result6ResultNtNtB4_7convert10InfallibleNtNtCs7nQiqFc7Txl_3syn5error5ErrorEECshbKHpCRGxgC_16deltalake_derive.exit.i.i.i.i.i.i unwind label %bb.cw, !noalias !210

bb.cw:                                            ; preds = %bb.cv
  %i.ds = landingpad { ptr, i32 }
          cleanup
  invoke void @_RNvXs1_NtCs6Po7BT7Nknu_5alloc7raw_vecINtB5_6RawVecNtNtCs7nQiqFc7Txl_3syn5error12ErrorMessageENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCshbKHpCRGxgC_16deltalake_derive(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.y)
          to label %.body.i3.i.i.i.i unwind label %bb.cx, !noalias !210

bb.cx:                                            ; preds = %bb.cw
  %i.dt = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #13, !noalias !210
  unreachable

_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6result6ResultNtNtB4_7convert10InfallibleNtNtCs7nQiqFc7Txl_3syn5error5ErrorEECshbKHpCRGxgC_16deltalake_derive.exit.i.i.i.i.i.i: ; preds = %bb.cv
  invoke void @_RNvXs1_NtCs6Po7BT7Nknu_5alloc7raw_vecINtB5_6RawVecNtNtCs7nQiqFc7Txl_3syn5error12ErrorMessageENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCshbKHpCRGxgC_16deltalake_derive(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.y)
          to label %bb.da unwind label %bb.cy, !noalias !210

bb.cy:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6result6ResultNtNtB4_7convert10InfallibleNtNtCs7nQiqFc7Txl_3syn5error5ErrorEECshbKHpCRGxgC_16deltalake_derive.exit.i.i.i.i.i.i
  %i.du = landingpad { ptr, i32 }
          cleanup
  br label %.body.i3.i.i.i.i

.body.i3.i.i.i.i:                                 ; preds = %bb.cy, %bb.cw
  %eh.lpad-body.i.i.i.i.i = phi { ptr, i32 } [ %i.du, %bb.cy ], [ %i.ds, %bb.cw ]
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.y, ptr noundef nonnull align 8 dereferenceable(24) %.sroa.5.i.i.i.i, i64 24, i1 false), !noalias !214
  br label %common.resume.i.i.i.i

bb.cz:                                            ; preds = %_RNCNvCshbKHpCRGxgC_16deltalake_derive23generate_try_update_key0B3_.exit.i.i.i.i
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.5.i.i.i.i)
  %i.dv = icmp eq ptr %i.ap, %i.aa
...
bb.da:                                            ; preds = %bb.cu, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6result6ResultNtNtB4_7convert10InfallibleNtNtCs7nQiqFc7Txl_3syn5error5ErrorEECshbKHpCRGxgC_16deltalake_derive.exit.i.i.i.i.i.i
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.y, ptr noundef nonnull align 8 dereferenceable(24) %.sroa.5.i.i.i.i, i64 24, i1 false), !noalias !215
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.5.i.i.i.i)
  br label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtB4_3ops12control_flow11ControlFlowNtCsbjGuDcEILED_11proc_macro211TokenStreamEECshbKHpCRGxgC_16deltalake_derive.exit

bb.db:                                            ; preds = %.thread, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtB4_3ops12control_flow11ControlFlowNtCsbjGuDcEILED_11proc_macro211TokenStreamEECshbKHpCRGxgC_16deltalake_derive.exit
  %.sroa.0.2.i.i.i.i.lcssa.sink = phi i64 [ %.sroa.0.2.i.i.i.i, %.thread ], [ -9223372036854775807, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtB4_3ops12control_flow11ControlFlowNtCsbjGuDcEILED_11proc_macro211TokenStreamEECshbKHpCRGxgC_16deltalake_derive.exit ]
  store i64 %.sroa.0.2.i.i.i.i.lcssa.sink, ptr %0, align 8
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.6)
  ret void
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind nonlazybind willreturn memory(read, argmem: readwrite, inaccessiblemem: none, target_mem: none) uwtable
define hidden void @_RNvXNtNtCsbvkFyIu7lgC_4core4iter8adaptersINtB2_12GenericShuntINtNtB2_10filter_map9FilterMapINtNtNtB6_5slice4iter4IterRNtNtCs7nQiqFc7Txl_3syn4data5FieldENCNvCshbKHpCRGxgC_16deltalake_derive23generate_try_update_key0EINtNtB6_6result6ResultNtNtB6_7convert10InfallibleNtNtB1W_5error5ErrorEENtNtNtB4_6traits8iterator8Iterator9size_hintB2u_(ptr dead_on_unwind noalias nofree noundef writable writeonly sret([24 x i8]) align 8 captures(none) dereferenceable(24) initializes((0, 24)) %0, ptr noalias noundef readonly align 8 captures(none) dereferenceable(24) %1) unnamed_addr #1 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.b = load ptr, ptr %i.a, align 8, !nonnull !4, !align !113, !noundef !4
  %i.c = load i64, ptr %i.b, align 8, !range !3, !noundef !4
...
; Function Attrs: nonlazybind uwtable
define hidden void @_RNvXNtNtCsbvkFyIu7lgC_4core4iter8adaptersINtB2_12GenericShuntINtNtB2_3map3MapINtNtNtB6_5slice4iter4IterRNtNtCs7nQiqFc7Txl_3syn4data5FieldENCNvCshbKHpCRGxgC_16deltalake_derive20generate_config_keys0EINtNtB6_6result6ResultNtNtB6_7convert10InfallibleNtNtB1I_5error5ErrorEENtNtNtB4_6traits8iterator8Iterator4nextB2g_(ptr dead_on_unwind noalias nofree noundef writable writeonly sret([32 x i8]) align 8 captures(none) dereferenceable(32) initializes((0, 8)) %0, ptr noalias noundef align 8 dereferenceable(24) %1) unnamed_addr #0 personality ptr @rust_eh_personality {
bb.a:
  %i.a = alloca [0 x i8], align 1
  ...
  %i.d = load ptr, ptr %i.c, align 8, !alias.scope !216, !noalias !221, !nonnull !4, !align !113, !noundef !4
  call void @_RINvXs0_NtNtNtCsbvkFyIu7lgC_4core4iter8adapters3mapINtB6_3MapINtNtNtBc_5slice4iter4IterRNtNtCs7nQiqFc7Txl_3syn4data5FieldENCNvCshbKHpCRGxgC_16deltalake_derive20generate_config_keys0ENtNtNtBa_6traits8iterator8Iterator8try_folduNCINvXB8_INtB8_12GenericShuntBN_INtNtBc_6result6ResultNtNtBc_7convert10InfallibleNtNtB1s_5error5ErrorEEB2U_8try_folduNCINvNvB2U_12try_for_each4callNtCsbjGuDcEILED_11proc_macro211TokenStreamINtNtNtBc_3ops12control_flow11ControlFlowB5Z_ENcNtB6F_5Break0E0B6F_E0IB6G_B6F_EEB20_(ptr noalias noundef nonnull sret([32 x i8]) align 8 captures(address) dereferenceable(32) %i.b, ptr noalias noundef nonnull align 8 dereferenceable(24) %1, ptr noalias noundef nonnull %i.a, ptr noalias noundef nonnull align 8 dereferenceable(24) %i.d), !noalias !221
  %i.e = load i64, ptr %i.b, align 8, !range !222, !noalias !219, !noundef !4 ; 3 uses
  %.not.i = icmp eq i64 %i.e, -9223372036854775806
  br i1 %.not.i, label %_RINvXNtNtCsbvkFyIu7lgC_4core4iter8adaptersINtB3_12GenericShuntINtNtB3_3map3MapINtNtNtB7_5slice4iter4IterRNtNtCs7nQiqFc7Txl_3syn4data5FieldENCNvCshbKHpCRGxgC_16deltalake_derive20generate_config_keys0EINtNtB7_6result6ResultNtNtB7_7convert10InfallibleNtNtB1J_5error5ErrorEENtNtNtB5_6traits8iterator8Iterator8try_folduNCINvNvB4k_12try_for_each4callNtCsbjGuDcEILED_11proc_macro211TokenStreamINtNtNtB7_3ops12control_flow11ControlFlowB5w_ENcNtB6c_5Break0E0B6c_EB2h_.exit.thread, label %_RINvXNtNtCsbvkFyIu7lgC_4core4iter8adaptersINtB3_12GenericShuntINtNtB3_3map3MapINtNtNtB7_5slice4iter4IterRNtNtCs7nQiqFc7Txl_3syn4data5FieldENCNvCshbKHpCRGxgC_16deltalake_derive20generate_config_keys0EINtNtB7_6result6ResultNtNtB7_7convert10InfallibleNtNtB1J_5error5ErrorEENtNtNtB5_6traits8iterator8Iterator8try_folduNCINvNvB4k_12try_for_each4callNtCsbjGuDcEILED_11proc_macro211TokenStreamINtNtNtB7_3ops12control_flow11ControlFlowB5w_ENcNtB6c_5Break0E0B6c_EB2h_.exit

_RINvXNtNtCsbvkFyIu7lgC_4core4iter8adaptersINtB3_12GenericShuntINtNtB3_3map3MapINtNtNtB7_5slice4iter4IterRNtNtCs7nQiqFc7Txl_3syn4data5FieldENCNvCshbKHpCRGxgC_16deltalake_derive20generate_config_keys0EINtNtB7_6result6ResultNtNtB7_7convert10InfallibleNtNtB1J_5error5ErrorEENtNtNtB5_6traits8iterator8Iterator8try_folduNCINvNvB4k_12try_for_each4callNtCsbjGuDcEILED_11proc_macro211TokenStreamINtNtNtB7_3ops12control_flow11ControlFlowB5w_ENcNtB6c_5Break0E0B6c_EB2h_.exit.thread: ; preds = %bb.a
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !219
  br label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtB4_3ops12control_flow11ControlFlowNtCsbjGuDcEILED_11proc_macro211TokenStreamEECshbKHpCRGxgC_16deltalake_derive.exit

_RINvXNtNtCsbvkFyIu7lgC_4core4iter8adaptersINtB3_12GenericShuntINtNtB3_3map3MapINtNtNtB7_5slice4iter4IterRNtNtCs7nQiqFc7Txl_3syn4data5FieldENCNvCshbKHpCRGxgC_16deltalake_derive20generate_config_keys0EINtNtB7_6result6ResultNtNtB7_7convert10InfallibleNtNtB1J_5error5ErrorEENtNtNtB5_6traits8iterator8Iterator8try_folduNCINvNvB4k_12try_for_each4callNtCsbjGuDcEILED_11proc_macro211TokenStreamINtNtNtB7_3ops12control_flow11ControlFlowB5w_ENcNtB6c_5Break0E0B6c_EB2h_.exit: ; preds = %bb.a
  %.sroa.6.0..sroa_idx7 = getelementptr inbounds nuw i8, ptr %i.b, i64 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %.sroa.6, ptr noundef nonnull align 8 dereferenceable(24) %.sroa.6.0..sroa_idx7, i64 24, i1 false), !noalias !216
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !219
  %.not = icmp eq i64 %i.e, -9223372036854775807
  br i1 %.not, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtB4_3ops12control_flow11ControlFlowNtCsbjGuDcEILED_11proc_macro211TokenStreamEECshbKHpCRGxgC_16deltalake_derive.exit, label %bb.b

bb.b:                                             ; preds = %_RINvXNtNtCsbvkFyIu7lgC_4core4iter8adaptersINtB3_12GenericShuntINtNtB3_3map3MapINtNtNtB7_5slice4iter4IterRNtNtCs7nQiqFc7Txl_3syn4data5FieldENCNvCshbKHpCRGxgC_16deltalake_derive20generate_config_keys0EINtNtB7_6result6ResultNtNtB7_7convert10InfallibleNtNtB1J_5error5ErrorEENtNtNtB5_6traits8iterator8Iterator8try_folduNCINvNvB4k_12try_for_each4callNtCsbjGuDcEILED_11proc_macro211TokenStreamINtNtNtB7_3ops12control_flow11ControlFlowB5w_ENcNtB6c_5Break0E0B6c_EB2h_.exit
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtB4_3ops12control_flow11ControlFlowNtCsbjGuDcEILED_11proc_macro211TokenStreamEECshbKHpCRGxgC_16deltalake_derive.exit: ; preds = %_RINvXNtNtCsbvkFyIu7lgC_4core4iter8adaptersINtB3_12GenericShuntINtNtB3_3map3MapINtNtNtB7_5slice4iter4IterRNtNtCs7nQiqFc7Txl_3syn4data5FieldENCNvCshbKHpCRGxgC_16deltalake_derive20generate_config_keys0EINtNtB7_6result6ResultNtNtB7_7convert10InfallibleNtNtB1J_5error5ErrorEENtNtNtB5_6traits8iterator8Iterator8try_folduNCINvNvB4k_12try_for_each4callNtCsbjGuDcEILED_11proc_macro211TokenStreamINtNtNtB7_3ops12control_flow11ControlFlowB5w_ENcNtB6c_5Break0E0B6c_EB2h_.exit, %_RINvXNtNtCsbvkFyIu7lgC_4core4iter8adaptersINtB3_12GenericShuntINtNtB3_3map3MapINtNtNtB7_5slice4iter4IterRNtNtCs7nQiqFc7Txl_3syn4data5FieldENCNvCshbKHpCRGxgC_16deltalake_derive20generate_config_keys0EINtNtB7_6result6ResultNtNtB7_7convert10InfallibleNtNtB1J_5error5ErrorEENtNtNtB5_6traits8iterator8Iterator8try_folduNCINvNvB4k_12try_for_each4callNtCsbjGuDcEILED_11proc_macro211TokenStreamINtNtNtB7_3ops12control_flow11ControlFlowB5w_ENcNtB6c_5Break0E0B6c_EB2h_.exit.thread, %bb.b
  %.sink = phi i64 [ %i.e, %bb.b ], [ -9223372036854775807, %_RINvXNtNtCsbvkFyIu7lgC_4core4iter8adaptersINtB3_12GenericShuntINtNtB3_3map3MapINtNtNtB7_5slice4iter4IterRNtNtCs7nQiqFc7Txl_3syn4data5FieldENCNvCshbKHpCRGxgC_16deltalake_derive20generate_config_keys0EINtNtB7_6result6ResultNtNtB7_7convert10InfallibleNtNtB1J_5error5ErrorEENtNtNtB5_6traits8iterator8Iterator8try_folduNCINvNvB4k_12try_for_each4callNtCsbjGuDcEILED_11proc_macro211TokenStreamINtNtNtB7_3ops12control_flow11ControlFlowB5w_ENcNtB6c_5Break0E0B6c_EB2h_.exit.thread ], [ -9223372036854775807, %_RINvXNtNtCsbvkFyIu7lgC_4core4iter8adaptersINtB3_12GenericShuntINtNtB3_3map3MapINtNtNtB7_5slice4iter4IterRNtNtCs7nQiqFc7Txl_3syn4data5FieldENCNvCshbKHpCRGxgC_16deltalake_derive20generate_config_keys0EINtNtB7_6result6ResultNtNtB7_7convert10InfallibleNtNtB1J_5error5ErrorEENtNtNtB5_6traits8iterator8Iterator8try_folduNCINvNvB4k_12try_for_each4callNtCsbjGuDcEILED_11proc_macro211TokenStreamINtNtNtB7_3ops12control_flow11ControlFlowB5w_ENcNtB6c_5Break0E0B6c_EB2h_.exit ]
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind nonlazybind willreturn memory(read, argmem: readwrite, inaccessiblemem: none, target_mem: none) uwtable
define hidden void @_RNvXNtNtCsbvkFyIu7lgC_4core4iter8adaptersINtB2_12GenericShuntINtNtB2_3map3MapINtNtNtB6_5slice4iter4IterRNtNtCs7nQiqFc7Txl_3syn4data5FieldENCNvCshbKHpCRGxgC_16deltalake_derive20generate_config_keys0EINtNtB6_6result6ResultNtNtB6_7convert10InfallibleNtNtB1I_5error5ErrorEENtNtNtB4_6traits8iterator8Iterator9size_hintB2g_(ptr dead_on_unwind noalias nofree noundef writable writeonly sret([24 x i8]) align 8 captures(none) dereferenceable(24) initializes((0, 24)) %0, ptr noalias noundef readonly align 8 captures(none) dereferenceable(24) %1) unnamed_addr #1 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.b = load ptr, ptr %i.a, align 8, !nonnull !4, !align !113, !noundef !4
  %i.c = load i64, ptr %i.b, align 8, !range !3, !noundef !4
...
bb.a:
  ...
  %i.b = load i64, ptr %i.a, align 8, !alias.scope !223, !noundef !4 ; 2 uses
...
bb.d:                                             ; preds = %bb.c, %bb.b, %bb.a
  ...
  %i.h = load ptr, ptr %i.g, align 8, !alias.scope !223, !nonnull !4, !noundef !4
  %i.i = load i64, ptr %i.a, align 8, !alias.scope !223, !noundef !4 ; 2 uses
...
_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String4push.exit: ; preds = %bb.f, %bb.g, %bb.i, %bb.j
  ...
  store i64 %i.ak, ptr %i.a, align 8, !alias.scope !223
  ret i1 false
}
...
bb.a:
  tail call void @_RNvMs_NtCs6Po7BT7Nknu_5alloc3vecINtB4_3VechE7reserveCshbKHpCRGxgC_16deltalake_derive(ptr noalias noundef nonnull align 8 dereferenceable(24) %0, i64 noundef %2), !noalias !226
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 3 uses
  %i.b = load i64, ptr %i.a, align 8, !alias.scope !229, !noalias !226, !noundef !4 ; 3 uses
  %i.c = icmp sgt i64 %i.b, -1
  tail call void @llvm.assume(i1 %i.c)
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.e = load ptr, ptr %i.d, align 8, !alias.scope !229, !noalias !226, !nonnull !4, !noundef !4
