...
bb.cq:                                            ; preds = %bb.co
  ...
  invoke void @_RNvMs0_NtNtNtCs9hC3HWJ95bf_11aws_sdk_sts9operation11assume_role8buildersNtB5_23AssumeRoleFluentBuilder15set_policy_arns(ptr noalias noundef nonnull sret([776 x i8]) align 8 captures(none) dereferenceable(776) %i.n, ptr noalias noundef nonnull align 8 captures(address) dereferenceable(776) %i.m, ptr noalias noundef nonnull align 8 captures(address) dereferenceable(24) %i.d)
...
begin_hunk_10_@_RNCNvNtCs9rVkZwOUgsI_13deltalake_aws11credentials19resolve_credentials0B5_:bb.a
  ...
  %.sroa.2.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.n, i64 264
  %.sroa.3.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.n, i64 268
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(776) %i.o, ptr noundef nonnull align 8 dereferenceable(776) %i.n, i64 776, i1 false), !alias.scope !3831, !noalias !3778
  ...
  invoke void @_RNvMs0_NtNtNtCs9hC3HWJ95bf_11aws_sdk_sts9operation11assume_role8buildersNtB5_23AssumeRoleFluentBuilder8set_tags(ptr noalias noundef nonnull sret([776 x i8]) align 8 captures(none) dereferenceable(776) %3, ptr noalias noundef nonnull align 8 captures(address) dereferenceable(776) %i.o, ptr noalias noundef nonnull align 8 captures(address) dereferenceable(24) %i.c)
...
bb.cu:                                            ; preds = %bb.cs
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.o), !noalias !3778
...
bb.eb:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs9PsDcNHE0mC_16aws_smithy_async4time16SharedTimeSourceECs9rVkZwOUgsI_13deltalake_aws.exit.i
  ...
  %.sroa.055.0.copyload56 = load i64, ptr %3, align 8, !noalias !3876 ; 2 uses
  %.sroa.857.0..sroa_idx58 = getelementptr inbounds nuw i8, ptr %3, i64 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(768) %.sroa.857, ptr noundef nonnull align 8 dereferenceable(768) %.sroa.857.0..sroa_idx58, i64 768, i1 false), !noalias !3876
  store i8 1, ptr %i.ea, align 8, !noalias !3778
  call void @llvm.lifetime.end.p0(ptr nonnull %3)
  %i.mw = icmp eq i64 %.sroa.055.0.copyload56, -9223372036854775807
  br i1 %i.mw, label %bb.ec, label %bb.ed

bb.ec:                                            ; preds = %.thread66, %bb.eb
end_hunk_14
begin_hunk_15_@_RNCNvNtCs9rVkZwOUgsI_13deltalake_aws11credentials19resolve_credentials0B5_:bb.a
  br label %common.ret

bb.ed:                                            ; preds = %bb.eb
  store i64 %.sroa.055.0.copyload56, ptr %i.ap, align 8
