...
.loopexit.split-lp.loopexit.i:                    ; preds = %.lr.ph1794
...
92:                                               ; preds = %76
  %.sroa.016.sroa.0.0.copyload.i = load i64, ptr %8, align 8, !noalias !15032
...
begin_hunk_2
  ...
  %93 = trunc nuw i64 %.sroa.016.sroa.0.0.copyload.i.fr to i1
...
.preheader264.i.preheader:                        ; preds = %189
  br i1 %188, label %.lr.ph1786, label %.preheader263.i.preheader
...
.preheader264.i:                                  ; preds = %219
  %205 = add nuw nsw i64 %.sroa.04.0.i251.i1785, 1 ; 2 uses
  %206 = icmp ult i64 %205, %.sroa.102.2.i.lcssa
  br i1 %206, label %.lr.ph1786, label %.preheader263.i.preheader

.preheader263.i.preheader:                        ; preds = %.preheader264.i, %.preheader264.i.preheader
  br i1 %.first_iter.i.fr, label %.preheader263.i.us.preheader, label %.preheader263.i.preheader.split

.preheader263.i.us.preheader:                     ; preds = %.preheader263.i.preheader
  br i1 %.not259.i.us1787, label %.split786.us, label %.lr.ph1789

.preheader263.i.us:                               ; preds = %210
  %.not259.i.us = icmp eq i64 %207, 0
  br i1 %.not259.i.us, label %.split786.us, label %.lr.ph1789

.lr.ph1789:                                       ; preds = %.preheader263.i.us.preheader, %.preheader263.i.us
  %.sroa.2.0.i252.i.us1788 = phi i64 [ %207, %.preheader263.i.us ], [ %.sroa.63.2.i.lcssa302, %.preheader263.i.us.preheader ]
  %207 = add i64 %.sroa.2.0.i252.i.us1788, -1     ; 4 uses
...
.preheader263.i.preheader.split:                  ; preds = %.preheader263.i.preheader
  br i1 %.not259.i.us1787, label %.split786.us, label %.invoke.i

.lr.ph1786:                                       ; preds = %.preheader264.i.preheader, %.preheader264.i
  %.sroa.04.0.i251.i1785 = phi i64 [ %205, %.preheader264.i ], [ %.sroa.63.2.i.lcssa302, %.preheader264.i.preheader ] ; 4 uses
  %216 = add i64 %.sroa.04.0.i251.i1785, %191     ; 2 uses
...
219:                                              ; preds = %.lr.ph1786
  %220 = getelementptr inbounds nuw i8, ptr %.sroa.101.2.i.lcssa, i64 %.sroa.04.0.i251.i1785
...
226:                                              ; preds = %219
  ...
  %228 = add i64 %227, %.sroa.04.0.i251.i1785
  br label %201
...
244:                                              ; preds = %231
  ...
  br i1 %245, label %.lr.ph1780, label %.preheader265.i.preheader
...
248:                                              ; preds = %268
  %249 = add nuw nsw i64 %.sroa.04.0.i233.i1778, 1 ; 2 uses
  %250 = icmp ult i64 %249, %.sroa.102.2.i.lcssa
  br i1 %250, label %.lr.ph1780, label %.preheader265.i.preheader

.preheader265.i.preheader:                        ; preds = %248, %244
  %251 = icmp ult i64 %232, %.sroa.63.2.i.lcssa302
  br i1 %251, label %.lr.ph1782, label %.preheader265.i.preheader._crit_edge

.lr.ph1780:                                       ; preds = %244, %248
  %.sroa.04.0.i233.i1778 = phi i64 [ %249, %248 ], [ %.sroa.0.0.i.i232.i, %244 ] ; 4 uses
  %252 = add i64 %.sroa.04.0.i233.i1778, %234     ; 2 uses
  %253 = icmp ult i64 %252, %.sroa.99.2.i.lcssa
  br i1 %253, label %268, label %273

.preheader265.i:                                  ; preds = %261
  %254 = icmp ult i64 %232, %256
  br i1 %254, label %.lr.ph1782, label %.preheader265.i.preheader._crit_edge
...
.lr.ph1782:                                       ; preds = %.preheader265.i.preheader, %.preheader265.i
  %.sroa.2.0.i234.i1781 = phi i64 [ %256, %.preheader265.i ], [ %.sroa.63.2.i.lcssa302, %.preheader265.i.preheader ]
  %256 = add i64 %.sroa.2.0.i234.i1781, -1        ; 6 uses
...
268:                                              ; preds = %.lr.ph1780
  %269 = getelementptr inbounds nuw i8, ptr %.sroa.101.2.i.lcssa, i64 %.sroa.04.0.i233.i1778
...
275:                                              ; preds = %268
  ...
  %277 = add i64 %276, %.sroa.04.0.i233.i1778
  br label %.sink.split.i236.i
...
begin_hunk_13
  ...
  %.first_iter1639.i.fr = freeze i1 %.first_iter1639.i
...
.preheader261.i.preheader:                        ; preds = %371
  br i1 %370, label %.lr.ph1772, label %.preheader.i.preheader
...
.preheader261.i:                                  ; preds = %401
  %387 = add nuw nsw i64 %.sroa.04.0.i218.i1771, 1 ; 2 uses
  %388 = icmp ult i64 %387, %.sroa.016.sroa.15.0.copyload.i
  br i1 %388, label %.lr.ph1772, label %.preheader.i.preheader

.preheader.i.preheader:                           ; preds = %.preheader261.i, %.preheader261.i.preheader
  br i1 %.first_iter1639.i.fr, label %.preheader.i.us.preheader, label %.preheader.i.preheader.split

.preheader.i.us.preheader:                        ; preds = %.preheader.i.preheader
  br i1 %.not260.i.us1773, label %.split.us, label %.lr.ph1775

.preheader.i.us:                                  ; preds = %392
  %.not260.i.us = icmp eq i64 %389, 0
  br i1 %.not260.i.us, label %.split.us, label %.lr.ph1775

.lr.ph1775:                                       ; preds = %.preheader.i.us.preheader, %.preheader.i.us
  %.sroa.2.0.i219.i.us1774 = phi i64 [ %389, %.preheader.i.us ], [ %.sroa.5.0.i, %.preheader.i.us.preheader ]
  %389 = add i64 %.sroa.2.0.i219.i.us1774, -1     ; 4 uses
...
.preheader.i.preheader.split:                     ; preds = %.preheader.i.preheader
  br i1 %.not260.i.us1773, label %.split.us, label %.invoke.i

.lr.ph1772:                                       ; preds = %.preheader261.i.preheader, %.preheader261.i
  %.sroa.04.0.i218.i1771 = phi i64 [ %387, %.preheader261.i ], [ %.sroa.5.0.i, %.preheader261.i.preheader ] ; 4 uses
  %398 = add i64 %.sroa.04.0.i218.i1771, %373     ; 2 uses
...
401:                                              ; preds = %.lr.ph1772
  %402 = getelementptr inbounds nuw i8, ptr %.sroa.016.sroa.14.0.copyload.i, i64 %.sroa.04.0.i218.i1771
...
408:                                              ; preds = %401
  ...
  %410 = add i64 %409, %.sroa.04.0.i218.i1771
  br label %383
...
427:                                              ; preds = %414
  ...
  br i1 %428, label %.lr.ph1767, label %.preheader262.i.preheader
...
431:                                              ; preds = %454
  %432 = add nuw nsw i64 %.sroa.04.0.i200.i1765, 1 ; 2 uses
  %433 = icmp ult i64 %432, %.sroa.016.sroa.15.0.copyload.i
  br i1 %433, label %.lr.ph1767, label %.preheader262.i.preheader

.preheader262.i.preheader:                        ; preds = %431, %427
  %434 = icmp ult i64 %415, %.sroa.5.0.i
  br i1 %434, label %.lr.ph1769, label %.preheader262.i.preheader._crit_edge

.lr.ph1767:                                       ; preds = %427, %431
  %.sroa.04.0.i200.i1765 = phi i64 [ %432, %431 ], [ %.sroa.0.0.i.i199.i, %427 ] ; 4 uses
  %435 = add i64 %.sroa.04.0.i200.i1765, %417     ; 2 uses
...
.preheader262.i:                                  ; preds = %447
  ...
  br i1 %437, label %.lr.ph1769, label %.preheader262.i.preheader._crit_edge
...
.lr.ph1769:                                       ; preds = %.preheader262.i.preheader, %.preheader262.i
  %.sroa.2.0.i201.i1768 = phi i64 [ %439, %.preheader262.i ], [ %.sroa.5.0.i, %.preheader262.i.preheader ]
  %439 = add i64 %.sroa.2.0.i201.i1768, -1        ; 6 uses
...
.invoke.i:                                        ; preds = %.preheader.i.preheader.split, %.preheader263.i.preheader.split, %441, %.lr.ph1769, %.lr.ph1775, %258, %.lr.ph1782, %.lr.ph1789, %459, %406, %273, %224
  %444 = phi i64 [ %umax.i239.i, %273 ], [ %umax.i254.i, %224 ], [ %umax.i206.i, %459 ], [ %259, %258 ], [ %208, %.lr.ph1789 ], [ %umax.i221.i, %406 ], [ %439, %.lr.ph1769 ], [ %390, %.lr.ph1775 ], [ %256, %.lr.ph1782 ], [ %442, %441 ], [ %368, %.preheader.i.preheader.split ], [ %187, %.preheader263.i.preheader.split ]
  %445 = phi i64 [ %.sroa.99.2.i.lcssa, %273 ], [ %.sroa.99.2.i.lcssa, %224 ], [ %.sroa.016.sroa.13.0.copyload.i, %459 ], [ %.sroa.99.2.i.lcssa, %258 ], [ %.sroa.99.2.i.lcssa, %.lr.ph1789 ], [ %.sroa.016.sroa.13.0.copyload.i, %406 ], [ %.sroa.016.sroa.15.0.copyload.i, %.lr.ph1769 ], [ %.sroa.016.sroa.13.0.copyload.i, %.lr.ph1775 ], [ %.sroa.102.2.i.lcssa, %.lr.ph1782 ], [ %.sroa.016.sroa.13.0.copyload.i, %441 ], [ %.sroa.016.sroa.15.0.copyload.i, %.preheader.i.preheader.split ], [ %.sroa.102.2.i.lcssa, %.preheader263.i.preheader.split ]
  %446 = phi ptr [ @16, %273 ], [ @16, %224 ], [ @16, %459 ], [ @15, %258 ], [ @15, %.lr.ph1789 ], [ @16, %406 ], [ @14, %.lr.ph1769 ], [ @15, %.lr.ph1775 ], [ @14, %.lr.ph1782 ], [ @15, %441 ], [ @14, %.preheader263.i.preheader.split ], [ @14, %.preheader.i.preheader.split ]
...
454:                                              ; preds = %.lr.ph1767
  %455 = getelementptr inbounds nuw i8, ptr %.sroa.016.sroa.14.0.copyload.i, i64 %.sroa.04.0.i200.i1765
...
461:                                              ; preds = %454
  ...
  %463 = add i64 %462, %.sroa.04.0.i200.i1765
  br label %.sink.split.i203.i
...
begin_hunk_23
  ...
  %.not.not.not.i.not.i1792 = icmp eq i64 %474, 0
  br i1 %.not.not.not.i.not.i1792, label %_RINvXs2J_NtNtCsbvkFyIu7lgC_4core5slice4iterINtB7_4IterReENtNtNtNtBb_4iter6traits8iterator8Iterator3anyNCNvXNtCs7p2uQeJxui2_9deltalake5errorINtB1H_18DisplaySourceChainNtCsjyY8HP3IvQ6_12object_store5ErrorENtNtBb_3fmt7Display3fmts_0EB1J_.exit.i, label %.lr.ph1794

476:                                              ; preds = %.noexc107.i
  %477 = getelementptr inbounds nuw i8, ptr %478, i64 16 ; 2 uses
  %.not.not.not.i.not.i = icmp eq ptr %477, %475
  br i1 %.not.not.not.i.not.i, label %_RINvXs2J_NtNtCsbvkFyIu7lgC_4core5slice4iterINtB7_4IterReENtNtNtNtBb_4iter6traits8iterator8Iterator3anyNCNvXNtCs7p2uQeJxui2_9deltalake5errorINtB1H_18DisplaySourceChainNtCsjyY8HP3IvQ6_12object_store5ErrorENtNtBb_3fmt7Display3fmts_0EB1J_.exit.i, label %.lr.ph1794

.lr.ph1794:                                       ; preds = %472, %476
