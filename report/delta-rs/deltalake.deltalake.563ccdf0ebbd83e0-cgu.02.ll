begin_hunk_0
  ...
  %invariant.op2406 = sub i64 1, %.sroa.63.2.i.lcssa302
...
bb.aw:                                            ; preds = %bb.au
  %i.fu = add i64 %i.eq, %invariant.op2406
...
begin_hunk_2
  ...
  %2 = sub i64 %.sroa.102.2.i.lcssa, %.sroa.6818.sroa.0.0.insert.insert.i
  %i.fw = sub i64 1, %.sroa.63.2.i.lcssa302
  br label %bb.ay
...
.sink.split.i236.i:                               ; preds = %bb.bh, %bb.be, %bb.az
  %.sink.i237.i = phi i64 [ %2, %bb.be ], [ 0, %bb.bh ], [ 0, %bb.az ] ; 2 uses
...
begin_hunk_5
  ...
  %invariant.op2404 = sub i64 1, %.sroa.5.0.i
...
bb.cf:                                            ; preds = %bb.cd
  %i.ll = add i64 %i.kh, %invariant.op2404
...
begin_hunk_7
  ...
  %3 = sub i64 %.sroa.016.sroa.15.0.copyload.i, %.sroa.93.sroa.0.0.insert.insert.i
  %i.lo = sub i64 1, %.sroa.5.0.i
  br label %bb.ch
...
.sink.split.i203.i:                               ; preds = %bb.cq, %bb.cn, %bb.ci
  %.sink.i204.i = phi i64 [ %3, %bb.cn ], [ 0, %bb.cq ], [ 0, %bb.ci ] ; 2 uses
