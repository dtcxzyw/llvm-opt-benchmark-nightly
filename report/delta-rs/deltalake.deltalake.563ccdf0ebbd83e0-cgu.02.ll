...
bb.aq:                                            ; preds = %bb.as, %.lr.ph.i256.i
  ...
  %i.ep = phi i64 [ %.sroa.78.2.i.lcssa, %.lr.ph.i256.i ], [ %i.ey, %bb.as ] ; 8 uses
...
.lr.ph1797:                                       ; preds = %.preheader961.i.preheader, %.preheader961.i
  %.sroa.04.0.i260.i1796 = phi i64 [ %i.fb, %.preheader961.i ], [ %.sroa.63.2.i.lcssa302, %.preheader961.i.preheader ] ; 4 uses
  %i.fk = add i64 %.sroa.04.0.i260.i1796, %i.ep   ; 2 uses
...
bb.aw:                                            ; preds = %bb.au
  %.reass2053.i.reass.reass = add i64 %i.ep, %invariant.op2410.a
  %i.fs = add i64 %.reass2053.i.reass.reass, %.sroa.04.0.i260.i1796
  br label %bb.as
...
bb.ay:                                            ; preds = %.sink.split.i244.i, %.lr.ph.i236.i
  ...
  %i.fw = phi i64 [ %.sroa.78.2.i.lcssa, %.lr.ph.i236.i ], [ %.ph76.i246.i, %.sink.split.i244.i ] ; 8 uses
...
.lr.ph1790:                                       ; preds = %bb.ba, %bb.bb
  %.sroa.04.0.i240.i1788 = phi i64 [ %i.gh, %bb.bb ], [ %.sroa.0.0.i.i238.i, %bb.ba ] ; 4 uses
  %i.gj = add i64 %.sroa.04.0.i240.i1788, %i.fw   ; 2 uses
...
bb.bh:                                            ; preds = %bb.bf
  %.reass2051.i.reass.reass = add i64 %i.fw, %invariant.op2409
  %i.hb = add i64 %.reass2051.i.reass.reass, %.sroa.04.0.i240.i1788
...
bb.bz:                                            ; preds = %bb.cb, %.lr.ph.i219.i
  ...
  %i.ka = phi i64 [ %.sroa.19.0.i, %.lr.ph.i219.i ], [ %i.kj, %bb.cb ] ; 8 uses
...
.lr.ph1781:                                       ; preds = %.preheader960.i.preheader, %.preheader960.i
  %.sroa.04.0.i223.i1780 = phi i64 [ %i.km, %.preheader960.i ], [ %.sroa.5.0.i, %.preheader960.i.preheader ] ; 4 uses
  %i.kv = add i64 %.sroa.04.0.i223.i1780, %i.ka   ; 2 uses
...
bb.cf:                                            ; preds = %bb.cd
  %.reass2049.i.reass.reass = add i64 %i.ka, %invariant.op2408
  %i.ld = add i64 %.reass2049.i.reass.reass, %.sroa.04.0.i223.i1780
  br label %bb.cb
...
bb.ch:                                            ; preds = %.sink.split.i207.i, %.lr.ph.i199.i
  ...
  %i.li = phi i64 [ %.sroa.19.0.i, %.lr.ph.i199.i ], [ %.ph76.i209.i, %.sink.split.i207.i ] ; 8 uses
...
.lr.ph1775:                                       ; preds = %bb.cj, %bb.ck
  %.sroa.04.0.i203.i1773 = phi i64 [ %i.lt, %bb.ck ], [ %.sroa.0.0.i.i201.i, %bb.cj ] ; 4 uses
  %i.lv = add i64 %.sroa.04.0.i203.i1773, %i.li   ; 2 uses
...
bb.cq:                                            ; preds = %bb.co
  %.reass2047.i.reass.reass = add i64 %i.li, %invariant.op2407
  %i.mq = add i64 %.reass2047.i.reass.reass, %.sroa.04.0.i203.i1773
...
begin_hunk_19_@_RNvXsC_NtCs6Po7BT7Nknu_5alloc6stringINtNtCs7p2uQeJxui2_9deltalake5error18DisplaySourceChainNtCsjyY8HP3IvQ6_12object_store5ErrorENtB5_12SpecToString14spec_to_stringBD_:bb.a
  ...
  %.reass.i = add i64 %invariant.op953.i, %.sroa.8.0949.i
