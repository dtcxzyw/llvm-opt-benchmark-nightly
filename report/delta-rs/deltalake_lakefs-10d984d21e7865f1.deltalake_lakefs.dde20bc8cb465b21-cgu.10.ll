...
begin_hunk_0_@_RNvXs1_NtNtCsdLO2CoGLRSt_6base645write7encoderINtB5_13EncoderWriterNtNtNtB9_6engine15general_purpose14GeneralPurposeQINtNtCs6Po7BT7Nknu_5alloc3vec3VechEENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCsj34PGqTgg0L_16deltalake_lakefs:bb.a
  %i.k = load i64, ptr %i.j, align 8, !alias.scope !726, !noalias !721, !noundef !7 ; 2 uses
  %i.l = icmp sgt i64 %i.k, -1
  tail call void @llvm.assume(i1 %i.l)
  %i.m = load ptr, ptr %i.i, align 8, !alias.scope !726, !noalias !721, !nonnull !7, !noundef !7
  ...
  %.pre.i.i.i.i.us.i.i = load i64, ptr %i.j, align 8, !alias.scope !726, !noalias !721
  %i.o = add i64 %.pre.i.i.i.i.us.i.i, %.promoted.i.i
  store i64 %i.o, ptr %i.j, align 8, !alias.scope !726, !noalias !721
  store i8 0, ptr %i.b, align 1, !alias.scope !719
  store i64 0, ptr %i.g, align 8, !alias.scope !719
...
.split.us6.i.i:                                   ; preds = %.lr.ph.split.split.us.i.i
  tail call void @_RNvNtNtCsbvkFyIu7lgC_4core5slice5index16slice_index_fail(i64 noundef 0, i64 noundef %.promoted.i.i, i64 noundef 1024, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @14) #25, !noalias !719
  unreachable
...
_RNvMs_NtNtCsdLO2CoGLRSt_6base645write7encoderINtB4_13EncoderWriterNtNtNtB8_6engine15general_purpose14GeneralPurposeQINtNtCs6Po7BT7Nknu_5alloc3vec3VechEE24write_all_encoded_outputCsj34PGqTgg0L_16deltalake_lakefs.exit.i: ; preds = %._crit_edge.split.us.i.i, %bb.c
  ...
  %i.q = load i64, ptr %i.p, align 8, !alias.scope !709, !noundef !7 ; 4 uses
...
bb.d:                                             ; preds = %_RNvMs_NtNtCsdLO2CoGLRSt_6base645write7encoderINtB4_13EncoderWriterNtNtNtB8_6engine15general_purpose14GeneralPurposeQINtNtCs6Po7BT7Nknu_5alloc3vec3VechEE24write_all_encoded_outputCsj34PGqTgg0L_16deltalake_lakefs.exit.i
  ...
  br i1 %i.r, label %bb.f, label %bb.e, !prof !720

bb.e:                                             ; preds = %bb.d
  tail call void @_RNvNtNtCsbvkFyIu7lgC_4core5slice5index16slice_index_fail(i64 noundef 0, i64 noundef %i.q, i64 noundef 3, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @17) #25, !noalias !709
  unreachable

bb.f:                                             ; preds = %bb.d
  %i.s = getelementptr inbounds nuw i8, ptr %0, i64 1056
  %i.t = getelementptr inbounds nuw i8, ptr %0, i64 1048
  %i.u = load ptr, ptr %i.t, align 8, !alias.scope !709, !nonnull !7, !noundef !7
  ...
  br i1 %i.y, label %bb.g, label %_RNvMNtCsbvkFyIu7lgC_4core6resultINtB2_6ResultjNtNtCsdLO2CoGLRSt_6base646encode16EncodeSliceErrorE6expectCsj34PGqTgg0L_16deltalake_lakefs.exit.i, !prof !3
...
_RNvMNtCsbvkFyIu7lgC_4core6resultINtB2_6ResultjNtNtCsdLO2CoGLRSt_6base646encode16EncodeSliceErrorE6expectCsj34PGqTgg0L_16deltalake_lakefs.exit.i: ; preds = %bb.f
  store i64 %i.x, ptr %i.g, align 8, !alias.scope !709
...
.lr.ph.i10.i:                                     ; preds = %_RNvMNtCsbvkFyIu7lgC_4core6resultINtB2_6ResultjNtNtCsdLO2CoGLRSt_6base646encode16EncodeSliceErrorE6expectCsj34PGqTgg0L_16deltalake_lakefs.exit.i
  %i.z = load ptr, ptr %i.e, align 8, !alias.scope !733, !align !29, !noundef !7 ; 4 uses
  %.not.i.i11.i = icmp eq ptr %i.z, null
  %i.aa = getelementptr inbounds nuw i8, ptr %i.z, i64 16 ; 3 uses
  %i.ab = getelementptr inbounds nuw i8, ptr %i.z, i64 8
  tail call void @llvm.experimental.noalias.scope.decl(metadata !736)
  store i8 1, ptr %i.b, align 1, !alias.scope !733
  br i1 %.not.i.i11.i, label %.lr.ph.split.us.i16.i, label %.lr.ph.split.split.us.i12.i, !prof !3

.lr.ph.split.us.i16.i:                            ; preds = %.lr.ph.i10.i
  tail call void @_RNvNtCsbvkFyIu7lgC_4core6option13expect_failed(ptr noalias noundef nonnull readonly captures(address, read_provenance) @12, i64 noundef 22, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @13) #25, !noalias !737
  unreachable

.lr.ph.split.split.us.i12.i:                      ; preds = %.lr.ph.i10.i
  %i.ac = icmp ult i64 %i.x, 1025
  br i1 %i.ac, label %._crit_edge.split.us.i14.i, label %.split.us6.i13.i, !prof !720

._crit_edge.split.us.i14.i:                       ; preds = %.lr.ph.split.split.us.i12.i
  tail call void @_RNvMs_NtCs6Po7BT7Nknu_5alloc3vecINtB4_3VechE7reserveCsj34PGqTgg0L_16deltalake_lakefs(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.z, i64 noundef range(i64 0, 1025) %i.x), !noalias !738
  %i.ad = load i64, ptr %i.aa, align 8, !alias.scope !743, !noalias !738, !noundef !7 ; 2 uses
  %i.ae = icmp sgt i64 %i.ad, -1
  tail call void @llvm.assume(i1 %i.ae)
  %i.af = load ptr, ptr %i.ab, align 8, !alias.scope !743, !noalias !738, !nonnull !7, !noundef !7
  ...
  %.pre.i.i.i.i.us.i15.i = load i64, ptr %i.aa, align 8, !alias.scope !743, !noalias !738
  %i.ah = add i64 %.pre.i.i.i.i.us.i15.i, %i.x
  store i64 %i.ah, ptr %i.aa, align 8, !alias.scope !743, !noalias !738
  store i8 0, ptr %i.b, align 1, !alias.scope !733
  store i64 0, ptr %i.g, align 8, !alias.scope !733
...
.split.us6.i13.i:                                 ; preds = %.lr.ph.split.split.us.i12.i
  tail call void @_RNvNtNtCsbvkFyIu7lgC_4core5slice5index16slice_index_fail(i64 noundef 0, i64 noundef %i.x, i64 noundef 1024, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @14) #25, !noalias !737
  unreachable
...
bb.a:
  %i.a = load ptr, ptr %0, align 8, !nonnull !7, !align !29, !noundef !7
...
bb.a:
  %i.a = load i64, ptr %2, align 8, !range !28, !noundef !7
