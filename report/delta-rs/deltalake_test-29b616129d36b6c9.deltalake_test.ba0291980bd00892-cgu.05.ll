...
begin_hunk_1_@_RINvNtCs3TL38MOHY2H_17pretty_assertions7printer11write_linesNtNtCsbvkFyIu7lgC_4core3fmt9FormatterECsfY7SmN0bPrO_14deltalake_test:bb.a
  ...
  %5 = getelementptr inbounds nuw i8, ptr %i.n, i64 16
  %.sroa.440.0..sroa_idx.a = getelementptr inbounds nuw i8, ptr %i.n, i64 24
  %i.aj = getelementptr inbounds nuw i8, ptr %i.q, i64 8
  %.sroa.446.0..sroa_idx.a = getelementptr inbounds nuw i8, ptr %i.m, i64 8
  %i.ak = getelementptr inbounds nuw i8, ptr %i.l, i64 8
  %i.al = getelementptr inbounds nuw i8, ptr %i.c, i64 8 ; 4 uses
  %i.am = getelementptr inbounds nuw i8, ptr %i.d, i64 8 ; 2 uses
  %i.an = getelementptr inbounds nuw i8, ptr %i.d, i64 16 ; 2 uses
  %.sroa.2.0..sroa_idx.i.a = getelementptr inbounds nuw i8, ptr %i.b, i64 8
  %.sroa.3.0..sroa_idx.i.a = getelementptr inbounds nuw i8, ptr %i.b, i64 10
  %.sroa.4.0..sroa_idx.i100.a = getelementptr inbounds nuw i8, ptr %i.b, i64 12
  %.sroa.582.0..sroa_idx.i.a = getelementptr inbounds nuw i8, ptr %i.b, i64 16
  %.sroa.6.0..sroa_idx.i.a = getelementptr inbounds nuw i8, ptr %i.b, i64 20
  %.sroa.2101.0..sroa_idx.i.a = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  %.sroa.3102.0..sroa_idx.i.a = getelementptr inbounds nuw i8, ptr %i.a, i64 10
  %.sroa.4103.0..sroa_idx.i.a = getelementptr inbounds nuw i8, ptr %i.a, i64 12
  %.sroa.5104.0..sroa_idx.i.a = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  %.sroa.6105.0..sroa_idx.i.a = getelementptr inbounds nuw i8, ptr %i.a, i64 20
  %.sroa.450.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.h, i64 8
...
bb.l:                                             ; preds = %bb.h, %bb.m
  ...
  store i64 %.sroa.10.1, ptr %i.ak, align 8
...
begin_hunk_3_@_RINvNtCs3TL38MOHY2H_17pretty_assertions7printer11write_linesNtNtCsbvkFyIu7lgC_4core3fmt9FormatterECsfY7SmN0bPrO_14deltalake_test:bb.a
  ...
  store ptr @10, ptr %i.n, align 8
  store ptr @_RNvXsk_NtCsbvkFyIu7lgC_4core3fmtcNtB5_7Display3fmt, ptr %.sroa.436.0..sroa_idx, align 8
  store ptr %i.r, ptr %5, align 8
  store ptr @_RNvXs1i_NtCsbvkFyIu7lgC_4core3fmtReNtB6_7Display3fmtCsfY7SmN0bPrO_14deltalake_test, ptr %.sroa.440.0..sroa_idx.a, align 8
...
bb.x:                                             ; preds = %_RINvMNtCsbvkFyIu7lgC_4core6optionINtB3_6OptionReE11map_or_elseNtNtCs6Po7BT7Nknu_5alloc6string6StringNCNvNtB12_3fmt6format0NvYeNtNtB12_6borrow7ToOwned8to_ownedECsfY7SmN0bPrO_14deltalake_test.exit
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.aj, ptr noundef nonnull align 8 dereferenceable(24) %i.f, i64 24, i1 false)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.f)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.m)
  store ptr %i.q, ptr %i.m, align 8
  store ptr @_RNvXs4_NtCsfxCIOvQJdVR_5yansi5paintINtB5_7PaintedRNtNtCs6Po7BT7Nknu_5alloc6string6StringENtNtCsbvkFyIu7lgC_4core3fmt7Display3fmtCsfY7SmN0bPrO_14deltalake_test, ptr %.sroa.446.0..sroa_idx.a, align 8
...
.noexc101:                                        ; preds = %bb.ah
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.al, ptr noundef nonnull align 8 dereferenceable(24) @11, i64 24, i1 false), !noalias !69
...
bb.aj:                                            ; preds = %bb.ai
  %i.cd = load ptr, ptr %i.am, align 8, !noalias !69, !nonnull !3, !noundef !3 ; 2 uses
  %i.ce = load i64, ptr %i.an, align 8, !noalias !69, !noundef !3 ; 2 uses
...
._crit_edge.i:                                    ; preds = %bb.an, %bb.aj
  ...
  %i.cn = invoke noundef zeroext i1 @_RNvMNtCsfxCIOvQJdVR_5yansi5styleNtB2_5Style10fmt_suffix(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.al, ptr noundef nonnull %i.cm, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(48) @4)
...
begin_hunk_8_@_RINvNtCs3TL38MOHY2H_17pretty_assertions7printer11write_linesNtNtCsbvkFyIu7lgC_4core3fmt9FormatterECsfY7SmN0bPrO_14deltalake_test:bb.a
  ...
  store i16 1, ptr %.sroa.2.0..sroa_idx.i.a, align 8, !noalias !69
  store i16 0, ptr %.sroa.3.0..sroa_idx.i.a, align 2, !noalias !69
  store i32 4, ptr %.sroa.4.0..sroa_idx.i100.a, align 4, !noalias !69
  store i32 13313, ptr %.sroa.582.0..sroa_idx.i.a, align 8, !noalias !69
  store i32 0, ptr %.sroa.6.0..sroa_idx.i.a, align 4, !noalias !69
...
bb.au:                                            ; preds = %bb.at
  %i.db = load ptr, ptr %i.am, align 8, !noalias !69, !nonnull !3, !noundef !3 ; 2 uses
  %i.dc = load i64, ptr %i.an, align 8, !noalias !69, !noundef !3 ; 2 uses
...
._crit_edge199.i:                                 ; preds = %bb.ay, %bb.au
  ...
  %i.dl = invoke noundef zeroext i1 @_RNvMNtCsfxCIOvQJdVR_5yansi5styleNtB2_5Style10fmt_suffix(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.al, ptr noundef nonnull %i.dk, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(48) @4)
...
begin_hunk_12_@_RINvNtCs3TL38MOHY2H_17pretty_assertions7printer11write_linesNtNtCsbvkFyIu7lgC_4core3fmt9FormatterECsfY7SmN0bPrO_14deltalake_test:bb.a
  ...
  store i16 1, ptr %.sroa.2101.0..sroa_idx.i.a, align 8, !noalias !69
  store i16 0, ptr %.sroa.3102.0..sroa_idx.i.a, align 2, !noalias !69
  store i32 5, ptr %.sroa.4103.0..sroa_idx.i.a, align 4, !noalias !69
  store i32 5633, ptr %.sroa.5104.0..sroa_idx.i.a, align 8, !noalias !69
  store i32 0, ptr %.sroa.6105.0..sroa_idx.i.a, align 4, !noalias !69
...
begin_hunk_13_@_RINvNtCs3TL38MOHY2H_17pretty_assertions7printer11write_linesNtNtCsbvkFyIu7lgC_4core3fmt9FormatterECsfY7SmN0bPrO_14deltalake_test:bb.a
  ...
  store ptr @10, ptr %i.h, align 8
  store ptr @_RNvXsk_NtCsbvkFyIu7lgC_4core3fmtcNtB5_7Display3fmt, ptr %.sroa.450.0..sroa_idx, align 8
