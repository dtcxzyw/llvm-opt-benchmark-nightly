...
bb.a:
  ...
  %i.aw = alloca [112 x i8], align 8              ; 5 uses
  %i.ax = alloca [16 x i8], align 16              ; 12 uses
  %i.ay = alloca [24 x i8], align 8               ; 8 uses
  %i.az = alloca [112 x i8], align 8              ; 13 uses
  ...
  %i.do = alloca [112 x i8], align 8              ; 5 uses
  %i.dp = alloca [112 x i8], align 8              ; 9 uses
  ...
  %i.er = alloca [112 x i8], align 8              ; 6 uses
  ...
  %i.ez = alloca [48 x i8], align 8               ; 5 uses
  %i.fa = alloca [48 x i8], align 8               ; 4 uses
  %i.fb = alloca [112 x i8], align 8              ; 6 uses
  %i.fc = alloca [16 x i8], align 8               ; 6 uses
  %i.fd = alloca [16 x i8], align 8               ; 6 uses
  %i.fe = alloca [32 x i8], align 8               ; 8 uses
  ...
  %i.fj = alloca [48 x i8], align 8               ; 5 uses
  ...
  %.sroa.81056 = alloca [32 x i8], align 8        ; 10 uses
  %i.fx = alloca [112 x i8], align 8              ; 13 uses
  ...
  %i.go = alloca [112 x i8], align 8              ; 5 uses
...
bb.ga:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtCs6Po7BT7Nknu_5alloc11collections9vec_deque8VecDequeNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesEECs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i
  %i.sr = landingpad { ptr, i32 }
          cleanup
  br label %.body14.i.i

bb.gb:                                            ; preds = %bb.fz, %.thread28.i
  %i.ss = phi ptr [ %i.sd, %.thread28.i ], [ %i.sc, %bb.fz ]
  %i.st = phi ptr [ %i.se, %.thread28.i ], [ %i.sb, %bb.fz ]
  %i.su = phi ptr [ %.sroa.7.0..sroa_idx.i, %.thread28.i ], [ %.phi.trans.insert.i, %bb.fz ]
  %i.sv = phi ptr [ %i.sf, %.thread28.i ], [ %i.si, %bb.fz ] ; 3 uses
...
bb.gc:                                            ; preds = %bb.fz
  invoke void @_RNvNtNtCsbvkFyIu7lgC_4core9panicking11panic_const28panic_const_async_fn_resumed(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @74) #28
          to label %.noexc.i unwind label %bb.hb, !noalias !1188
...
bb.gd:                                            ; preds = %bb.fz
  invoke void @_RNvNtNtCsbvkFyIu7lgC_4core9panicking11panic_const34panic_const_async_fn_resumed_panic(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @74) #28
          to label %.noexc6.i unwind label %bb.hb, !noalias !1188

.noexc6.i:                                        ; preds = %bb.gd
  unreachable
...
bb.ge:                                            ; preds = %bb.fz
  ...
  switch i8 %.pre.i.i, label %default.unreachable1454 [
...
bb.gf:                                            ; preds = %.thread.i.i, %._crit_edge.i
...
bb.gg:                                            ; preds = %bb.ge
  invoke void @_RNvNtNtCsbvkFyIu7lgC_4core9panicking11panic_const28panic_const_async_fn_resumed(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @73) #28
          to label %.noexc.i.i unwind label %bb.gk, !noalias !1194

.noexc.i.i:                                       ; preds = %bb.gg
  unreachable
...
bb.gh:                                            ; preds = %bb.ge
  invoke void @_RNvNtNtCsbvkFyIu7lgC_4core9panicking11panic_const34panic_const_async_fn_resumed_panic(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @73) #28
          to label %.noexc13.i.i unwind label %bb.gk, !noalias !1194

.noexc13.i.i:                                     ; preds = %bb.gh
  unreachable

bb.gi:                                            ; preds = %bb.gf, %bb.ge
  %i.tk = phi ptr [ %i.tc, %bb.gf ], [ %i.sc, %bb.ge ] ; 10 uses
  %i.tl = phi ptr [ %i.td, %bb.gf ], [ %i.sb, %bb.ge ] ; 7 uses
  %i.tm = phi ptr [ %i.te, %bb.gf ], [ %.phi.trans.insert.i, %bb.ge ] ; 9 uses
  %i.tn = phi ptr [ %i.tf, %bb.gf ], [ %i.si, %bb.ge ] ; 7 uses
  %i.to = phi ptr [ %i.th, %bb.gf ], [ %.phi.trans.insert48.i.i, %bb.ge ] ; 2 uses
  ...
  invoke void @_RNvXs0_NtNtCsbvkFyIu7lgC_4core6future7poll_fnINtB5_6PollFnNCNCNvMs0_NtCs2DiVQAxFeQE_16aws_smithy_types4bodyNtB14_7SdkBody4next00ENtNtB7_6future6Future4pollCs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull sret([40 x i8]) align 8 captures(address) dereferenceable(40) %i.k, ptr noalias noundef nonnull align 8 dereferenceable(8) %i.tp, ptr noalias noundef nonnull align 8 dereferenceable(32) %1)
          to label %bb.gl unwind label %bb.gj, !noalias !1195
...
bb.gl:                                            ; preds = %bb.gi
  ...
  br i1 %i.tt, label %.thread.i, label %bb.gn

.thread.i:                                        ; preds = %bb.gl
...
bb.gm:                                            ; preds = %.body.i.i, %bb.gq
  %i.tu = phi ptr [ %i.uy, %.body.i.i ], [ %i.tk, %bb.gq ]
  %i.tv = phi ptr [ %i.uz, %.body.i.i ], [ %i.tl, %bb.gq ]
  %i.tw = phi ptr [ %i.va, %.body.i.i ], [ %i.tm, %bb.gq ]
  %i.tx = phi ptr [ %i.vb, %.body.i.i ], [ %i.tn, %bb.gq ]
  %.pn5.pn.i.i = phi { ptr, i32 } [ %.pn3.i.i, %.body.i.i ], [ %i.uf, %bb.gq ]
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs2DiVQAxFeQE_16aws_smithy_types4body7SdkBodyECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef align 8 dereferenceable(120) %i.ty) #24
          to label %bb.gs unwind label %bb.gx, !noalias !1195
...
bb.gn:                                            ; preds = %bb.gl
  ...
  br i1 %i.tz, label %bb.go, label %bb.gp

bb.go:                                            ; preds = %bb.gn
  %i.ua = getelementptr inbounds nuw i8, ptr %0, i64 576 ; 4 uses
  %i.ub = icmp eq ptr %.sroa.2.sroa.0.0.copyload.i.i, null
  br i1 %i.ub, label %bb.gr, label %_RNvXsp_NtCsbvkFyIu7lgC_4core6resultINtB5_6ResultNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesINtNtCs6Po7BT7Nknu_5alloc5boxed3BoxDNtNtB7_5error5ErrorNtNtB7_6marker4SyncNtB2f_4SendEL_EENtNtNtB7_3ops9try_trait3Try6branchCs9rVkZwOUgsI_13deltalake_aws.exit.i.i
...
bb.gp:                                            ; preds = %bb.gn
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs2DiVQAxFeQE_16aws_smithy_types4body7SdkBodyECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef align 8 dereferenceable(120) %i.ue)
          to label %bb.hc unwind label %bb.gt, !noalias !1195

_RNvXsp_NtCsbvkFyIu7lgC_4core6resultINtB5_6ResultNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesINtNtCs6Po7BT7Nknu_5alloc5boxed3BoxDNtNtB7_5error5ErrorNtNtB7_6marker4SyncNtB2f_4SendEL_EENtNtNtB7_3ops9try_trait3Try6branchCs9rVkZwOUgsI_13deltalake_aws.exit.i.i: ; preds = %bb.go
  ...
  invoke void @_RNvMs1_NtCsezuMeTmAxXc_11bytes_utils9segmentedINtB5_12SegmentedBufNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesE4pushCs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull align 8 dereferenceable(40) %i.ua, ptr noalias noundef nonnull align 8 captures(address) dereferenceable(32) %i.j)
          to label %_RNvXsp_NtCsbvkFyIu7lgC_4core6resultINtB5_6ResultNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesINtNtCs6Po7BT7Nknu_5alloc5boxed3BoxDNtNtB7_5error5ErrorNtNtB7_6marker4SyncNtB2f_4SendEL_EENtNtNtB7_3ops9try_trait3Try6branchCs9rVkZwOUgsI_13deltalake_aws.exit._crit_edge.i.i unwind label %bb.gq, !noalias !1195
...
bb.gq:                                            ; preds = %_RNvXsp_NtCsbvkFyIu7lgC_4core6resultINtB5_6ResultNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesINtNtCs6Po7BT7Nknu_5alloc5boxed3BoxDNtNtB7_5error5ErrorNtNtB7_6marker4SyncNtB2f_4SendEL_EENtNtNtB7_3ops9try_trait3Try6branchCs9rVkZwOUgsI_13deltalake_aws.exit.i.i
  %i.uf = landingpad { ptr, i32 }
          cleanup
  br label %bb.gm

.thread.i.i:                                      ; preds = %_RNvXsp_NtCsbvkFyIu7lgC_4core6resultINtB5_6ResultNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesINtNtCs6Po7BT7Nknu_5alloc5boxed3BoxDNtNtB7_5error5ErrorNtNtB7_6marker4SyncNtB2f_4SendEL_EENtNtNtB7_3ops9try_trait3Try6branchCs9rVkZwOUgsI_13deltalake_aws.exit._crit_edge.i.i, %bb.gb
  %i.ug = phi ptr [ %i.tk, %_RNvXsp_NtCsbvkFyIu7lgC_4core6resultINtB5_6ResultNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesINtNtCs6Po7BT7Nknu_5alloc5boxed3BoxDNtNtB7_5error5ErrorNtNtB7_6marker4SyncNtB2f_4SendEL_EENtNtNtB7_3ops9try_trait3Try6branchCs9rVkZwOUgsI_13deltalake_aws.exit._crit_edge.i.i ], [ %i.ss, %bb.gb ]
  %i.uh = phi ptr [ %i.tl, %_RNvXsp_NtCsbvkFyIu7lgC_4core6resultINtB5_6ResultNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesINtNtCs6Po7BT7Nknu_5alloc5boxed3BoxDNtNtB7_5error5ErrorNtNtB7_6marker4SyncNtB2f_4SendEL_EENtNtNtB7_3ops9try_trait3Try6branchCs9rVkZwOUgsI_13deltalake_aws.exit._crit_edge.i.i ], [ %i.st, %bb.gb ]
  %i.ui = phi ptr [ %i.tm, %_RNvXsp_NtCsbvkFyIu7lgC_4core6resultINtB5_6ResultNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesINtNtCs6Po7BT7Nknu_5alloc5boxed3BoxDNtNtB7_5error5ErrorNtNtB7_6marker4SyncNtB2f_4SendEL_EENtNtNtB7_3ops9try_trait3Try6branchCs9rVkZwOUgsI_13deltalake_aws.exit._crit_edge.i.i ], [ %i.su, %bb.gb ]
  %i.uj = phi ptr [ %i.tn, %_RNvXsp_NtCsbvkFyIu7lgC_4core6resultINtB5_6ResultNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesINtNtCs6Po7BT7Nknu_5alloc5boxed3BoxDNtNtB7_5error5ErrorNtNtB7_6marker4SyncNtB2f_4SendEL_EENtNtNtB7_3ops9try_trait3Try6branchCs9rVkZwOUgsI_13deltalake_aws.exit._crit_edge.i.i ], [ %i.sv, %bb.gb ]
  %.val.i.i = phi ptr [ %.val.pre.i.i, %_RNvXsp_NtCsbvkFyIu7lgC_4core6resultINtB5_6ResultNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesINtNtCs6Po7BT7Nknu_5alloc5boxed3BoxDNtNtB7_5error5ErrorNtNtB7_6marker4SyncNtB2f_4SendEL_EENtNtNtB7_3ops9try_trait3Try6branchCs9rVkZwOUgsI_13deltalake_aws.exit._crit_edge.i.i ], [ %i.ta, %bb.gb ] ; 2 uses
...
bb.gs:                                            ; preds = %bb.gt, %bb.gm
  %i.um = phi ptr [ %i.tk, %bb.gt ], [ %i.tu, %bb.gm ] ; 2 uses
  %i.un = phi ptr [ %i.tl, %bb.gt ], [ %i.tv, %bb.gm ] ; 2 uses
  %i.uo = phi ptr [ %i.tm, %bb.gt ], [ %i.tw, %bb.gm ] ; 2 uses
  %i.up = phi ptr [ %i.tn, %bb.gt ], [ %i.tx, %bb.gm ] ; 2 uses
  %.pn9.i.i = phi { ptr, i32 } [ %i.ut, %bb.gt ], [ %.pn5.pn.i.i, %bb.gm ] ; 2 uses
  ...
  br i1 %i.us, label %bb.gy, label %.body14.i.i

bb.gt:                                            ; preds = %bb.gr, %bb.gp
...
bb.gu:                                            ; preds = %bb.gr
  invoke void @_RNvXs_NtNtCs6Po7BT7Nknu_5alloc11collections9vec_dequeINtB4_8VecDequeNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull align 8 dereferenceable(40) %i.ua)
          to label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtCs6Po7BT7Nknu_5alloc11collections9vec_deque8VecDequeNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesEECs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i unwind label %bb.gv, !noalias !1195
...
bb.gv:                                            ; preds = %bb.gu
  ...
  invoke void @_RNvXs1_NtCs6Po7BT7Nknu_5alloc7raw_vecINtB5_6RawVecNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull align 8 dereferenceable(40) %i.ua)
          to label %.body14.i.i unwind label %bb.gw, !noalias !1195
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtCs6Po7BT7Nknu_5alloc11collections9vec_deque8VecDequeNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesEECs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i: ; preds = %bb.gu
  invoke void @_RNvXs1_NtCs6Po7BT7Nknu_5alloc7raw_vecINtB5_6RawVecNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull align 8 dereferenceable(40) %i.ua)
          to label %.thread18.i unwind label %bb.ga, !noalias !1195
...
.body.i.i:                                        ; preds = %bb.gk, %bb.gj
  %i.uy = phi ptr [ %i.tk, %bb.gj ], [ %i.sc, %bb.gk ]
  %i.uz = phi ptr [ %i.tl, %bb.gj ], [ %i.sb, %bb.gk ]
  %i.va = phi ptr [ %i.tm, %bb.gj ], [ %.phi.trans.insert.i, %bb.gk ]
  %i.vb = phi ptr [ %i.tn, %bb.gj ], [ %i.si, %bb.gk ]
  %.pn3.i.i = phi { ptr, i32 } [ %i.tq, %bb.gj ], [ %i.tr, %bb.gk ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.k), !noalias !1181
  br label %bb.gm

bb.gx:                                            ; preds = %bb.ha, %bb.gy, %bb.gm
...
bb.gy:                                            ; preds = %bb.gs
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCsezuMeTmAxXc_11bytes_utils9segmented12SegmentedBufNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesEECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef align 8 dereferenceable(40) %i.vd) #24
          to label %.body14.i.i unwind label %bb.gx, !noalias !1195

bb.gz:                                            ; preds = %bb.ha, %.body14.i.i
  store i8 0, ptr %i.so, align 2, !noalias !1181
  store i8 2, ptr %i.sl, align 8, !noalias !1181
  br label %.body.i

bb.ha:                                            ; preds = %.body14.i.i
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs2DiVQAxFeQE_16aws_smithy_types4body7SdkBodyECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef align 8 dereferenceable(120) %i.ve) #24
          to label %bb.gz unwind label %bb.gx, !noalias !1195

bb.hb:                                            ; preds = %bb.gd, %bb.gc
...
bb.hc:                                            ; preds = %bb.gp
  ...
  br i1 %i.vh, label %bb.hj, label %bb.hd

bb.hd:                                            ; preds = %bb.hc, %.thread18.i
  %.sroa.432.0.i24.i = phi ptr [ %.sroa.2.sroa.3.0.copyload.i.i, %.thread18.i ], [ %.sroa.543.0.copyload.i.i, %bb.hc ] ; 3 uses
  %.sroa.329.0.i23.i = phi ptr [ %.sroa.2.sroa.2.0.copyload.i.i, %.thread18.i ], [ %.sroa.442.0.copyload.i.i, %bb.hc ] ; 3 uses
  %.sroa.027.0.i22.i = phi i64 [ -9223372036854775808, %.thread18.i ], [ %.sroa.041.0.copyload.i.i, %bb.hc ] ; 3 uses
...
bb.hf:                                            ; preds = %bb.hd
  ...
  br i1 %i.vj, label %bb.hg, label %_RINvMNtCsbvkFyIu7lgC_4core6resultINtB3_6ResultNtNtCs2DiVQAxFeQE_16aws_smithy_types11byte_stream15AggregatedBytesNtNtBK_5error5ErrorE7map_errINtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client12orchestrator17OrchestratorErrorNtNtNtB2j_12interceptors7context5ErrorEINvMs0_B2h_B2e_5otherB1M_EECs9rVkZwOUgsI_13deltalake_aws.exit.thread
...
.body.i:                                          ; preds = %bb.hb, %bb.gz
  ...
  %i.vl = phi ptr [ %i.sk, %bb.gz ], [ %i.sb, %bb.hb ]
  %i.vm = phi ptr [ %i.sm, %bb.gz ], [ %i.si, %bb.hb ]
  %.pn2.i = phi { ptr, i32 } [ %.pn11.i.i, %bb.gz ], [ %i.vf, %bb.hb ]
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.10.i)
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNCNvMs5_NtCs2DiVQAxFeQE_16aws_smithy_types11byte_streamNtBO_5Inner7collect0ECs9rVkZwOUgsI_13deltalake_aws(ptr noundef nonnull align 8 %i.vm) #24
          to label %bb.fw unwind label %bb.hh, !noalias !1188
...
3:                                                ; preds = %bb.hg
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.81056, ptr noundef nonnull align 8 dereferenceable(32) %2, i64 32, i1 false), !noalias !1204
  store i8 1, ptr %i.tk, align 8, !noalias !1177
  call void @llvm.lifetime.end.p0(ptr nonnull %i.l)
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.713.i)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.3, ptr noundef nonnull align 8 dereferenceable(32) %.sroa.81056, i64 32, i1 false)
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.81056)
...
_RINvMNtCsbvkFyIu7lgC_4core6resultINtB3_6ResultNtNtCs2DiVQAxFeQE_16aws_smithy_types11byte_stream15AggregatedBytesNtNtBK_5error5ErrorE7map_errINtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client12orchestrator17OrchestratorErrorNtNtNtB2j_12interceptors7context5ErrorEINvMs0_B2h_B2e_5otherB1M_EECs9rVkZwOUgsI_13deltalake_aws.exit.thread: ; preds = %bb.hf
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.81056, ptr noundef nonnull align 8 dereferenceable(32) %.sroa.3.0..sroa_idx.i, i64 32, i1 false), !noalias !1204
  store i8 1, ptr %i.tk, align 8, !noalias !1177
  call void @llvm.lifetime.end.p0(ptr nonnull %i.l)
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.713.i)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.3, ptr noundef nonnull align 8 dereferenceable(32) %.sroa.81056, i64 32, i1 false)
...
_RINvMNtCsbvkFyIu7lgC_4core6resultINtB3_6ResultNtNtCs2DiVQAxFeQE_16aws_smithy_types11byte_stream15AggregatedBytesNtNtBK_5error5ErrorE7map_errINtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client12orchestrator17OrchestratorErrorNtNtNtB2j_12interceptors7context5ErrorEINvMs0_B2h_B2e_5otherB1M_EECs9rVkZwOUgsI_13deltalake_aws.exit: ; preds = %3
  ...
  %.pr1301 = load i16, ptr %i.fx, align 8
  %.not89 = icmp eq i16 %.pr1301, 11
  br i1 %.not89, label %bb.hl, label %bb.pw

bb.hl:                                            ; preds = %_RINvMNtCsbvkFyIu7lgC_4core6resultINtB3_6ResultNtNtCs2DiVQAxFeQE_16aws_smithy_types11byte_stream15AggregatedBytesNtNtBK_5error5ErrorE7map_errINtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client12orchestrator17OrchestratorErrorNtNtNtB2j_12interceptors7context5ErrorEINvMs0_B2h_B2e_5otherB1M_EECs9rVkZwOUgsI_13deltalake_aws.exit.thread, %_RINvMNtCsbvkFyIu7lgC_4core6resultINtB3_6ResultNtNtCs2DiVQAxFeQE_16aws_smithy_types11byte_stream15AggregatedBytesNtNtBK_5error5ErrorE7map_errINtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client12orchestrator17OrchestratorErrorNtNtNtB2j_12interceptors7context5ErrorEINvMs0_B2h_B2e_5otherB1M_EECs9rVkZwOUgsI_13deltalake_aws.exit
...
bb.hm:                                            ; preds = %bb.hl
  ...
  invoke void %i.vt(ptr noalias noundef nonnull sret([32 x i8]) align 8 captures(address) dereferenceable(32) %i.fl, ptr noundef nonnull align 8 %i.vu, ptr noundef %i.vw, i64 noundef %i.vy)
          to label %_RNvXs2_NtCs9Ct3XQYJhun_5bytes5bytesNtB5_5BytesNtNtCsbvkFyIu7lgC_4core5clone5Clone5clone.exit unwind label %bb.hn, !inline_history !1215
...
_RNvXs2_NtCs9Ct3XQYJhun_5bytes5bytesNtB5_5BytesNtNtCsbvkFyIu7lgC_4core5clone5Clone5clone.exit: ; preds = %bb.hm
  invoke void @_RNvXs2_NtCs2DiVQAxFeQE_16aws_smithy_types4bodyNtB5_7SdkBodyINtNtCsbvkFyIu7lgC_4core7convert4FromNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesE4from(ptr noalias noundef nonnull sret([120 x i8]) align 8 captures(none) dereferenceable(120) %i.fm, ptr noalias noundef nonnull align 8 captures(address) dereferenceable(32) %i.fl)
          to label %bb.hq unwind label %bb.hp

bb.ho:                                            ; preds = %bb.hp, %bb.hn
  %.pn90 = phi { ptr, i32 } [ %i.wa, %bb.hp ], [ %i.vz, %bb.hn ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.fl)
  br label %bb.pv

bb.hp:                                            ; preds = %_RNvXs2_NtCs9Ct3XQYJhun_5bytes5bytesNtB5_5BytesNtNtCsbvkFyIu7lgC_4core5clone5Clone5clone.exit
...
bb.hq:                                            ; preds = %_RNvXs2_NtCs9Ct3XQYJhun_5bytes5bytesNtB5_5BytesNtNtCsbvkFyIu7lgC_4core5clone5Clone5clone.exit
  ...
  br i1 %.not.i747, label %bb.hr, label %bb.hu, !prof !9
...
bb.hr:                                            ; preds = %bb.hq
  invoke void @_RNvNtCsbvkFyIu7lgC_4core6option13expect_failed(ptr noalias noundef nonnull readonly captures(address, read_provenance) @45, i64 noundef 9, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @49) #28
          to label %.noexc752 unwind label %bb.hs

.noexc752:                                        ; preds = %bb.hr
  unreachable
...
bb.hs:                                            ; preds = %bb.hr
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs2DiVQAxFeQE_16aws_smithy_types4body7SdkBodyECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef align 8 dereferenceable(120) %i.fm) #24
          to label %bb.pv unwind label %bb.af
...
bb.hv:                                            ; preds = %bb.hu
  ...
  %i.wl = invoke noundef nonnull align 8 ptr @_RINvMs6_NtCs2DiVQAxFeQE_16aws_smithy_types10config_bagNtB6_5Layer9store_putNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client12orchestrator17LoadedRequestBodyECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull align 8 dereferenceable(56) %i.wj, ptr noalias noundef nonnull readonly align 8 captures(none) dereferenceable(40) %i.fk)
          to label %bb.hw unwind label %bb.pu     ; 0 uses
...
bb.ia:                                            ; preds = %bb.hy
  %i.wx = load i64, ptr %i.fa, align 8, !range !22, !noundef !7
  %.not97 = icmp eq i64 %i.wx, -9223372036854775807
  br i1 %.not97, label %bb.ib, label %bb.ou
...
bb.id:                                            ; preds = %bb.ib
  %i.xf = load i64, ptr %i.eq, align 8, !range !22, !noundef !7
  %.not98 = icmp eq i64 %i.xf, -9223372036854775807
  br i1 %.not98, label %bb.ie, label %bb.nu
...
bb.ie:                                            ; preds = %bb.id
  ...
  br i1 %i.xk, label %bb.if, label %bb.ig
...
bb.ig:                                            ; preds = %bb.ie
  ...
  invoke void @_RNvXs0_NtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client7retriesNtB5_19SharedRetryStrategyNtB5_13RetryStrategy30should_attempt_initial_request(ptr noalias noundef nonnull sret([24 x i8]) align 8 captures(address) dereferenceable(24) %i.xn, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %i.ep, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(392) %i.xl, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(80) %i.xm)
          to label %bb.ij unwind label %bb.ih
...
bb.ih:                                            ; preds = %bb.ig
  ...
  br i1 %i.xr, label %bb.ii, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client7retries19SharedRetryStrategyECs9rVkZwOUgsI_13deltalake_aws.exit
...
bb.ij:                                            ; preds = %bb.ig
  ...
  br i1 %i.xv, label %bb.ik, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client7retries19SharedRetryStrategyECs9rVkZwOUgsI_13deltalake_aws.exit755

bb.ik:                                            ; preds = %bb.ij
  fence acquire
  invoke void @_RNvMsn_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcDNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client7retries13RetryStrategyEL_E9drop_slowBN_(ptr noalias noundef nonnull align 8 dereferenceable(16) %i.ep) #26
          to label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client7retries19SharedRetryStrategyECs9rVkZwOUgsI_13deltalake_aws.exit755 unwind label %bb.il
end_hunk_1
begin_hunk_2_@_RNCNvNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator11try_attempt0Cs9rVkZwOUgsI_13deltalake_aws:bb.a
  ...
  %i.fe = alloca [48 x i8], align 8               ; 5 uses
  ...
  %i.ft = alloca [112 x i8], align 8              ; 6 uses
  %i.fu = alloca [16 x i8], align 8               ; 6 uses
  %i.fv = alloca [16 x i8], align 8               ; 6 uses
  %i.fw = alloca [32 x i8], align 8               ; 8 uses
  %i.fx = alloca [24 x i8], align 8               ; 5 uses
  %i.fy = alloca [16 x i8], align 8               ; 6 uses
  %i.fz = alloca [16 x i8], align 8               ; 6 uses
  %i.ga = alloca [32 x i8], align 8               ; 8 uses
  %i.gb = alloca [48 x i8], align 8               ; 5 uses
  %i.gc = alloca [48 x i8], align 8               ; 4 uses
  %i.gd = alloca [112 x i8], align 8              ; 6 uses
  %i.ge = alloca [16 x i8], align 8               ; 6 uses
  %i.gf = alloca [16 x i8], align 8               ; 6 uses
  %i.gg = alloca [32 x i8], align 8               ; 8 uses
  %i.gh = alloca [24 x i8], align 8               ; 5 uses
  %i.gi = alloca [16 x i8], align 8               ; 6 uses
  %i.gj = alloca [16 x i8], align 8               ; 6 uses
  %i.gk = alloca [32 x i8], align 8               ; 8 uses
  %i.gl = alloca [48 x i8], align 8               ; 5 uses
  %i.gm = alloca [48 x i8], align 8               ; 4 uses
  %i.gn = alloca [112 x i8], align 8              ; 6 uses
  ...
  %i.gu = alloca [32 x i8], align 8               ; 8 uses
  %i.gv = alloca [48 x i8], align 8               ; 5 uses
  ...
  %i.ho = alloca [112 x i8], align 8              ; 5 uses
  %.sroa.101111 = alloca [112 x i8], align 8      ; 4 uses
  ...
  %i.ib = alloca [112 x i8], align 8              ; 5 uses
  %i.ic = alloca [112 x i8], align 8              ; 9 uses
  ...
  %i.it = alloca [48 x i8], align 8               ; 4 uses
  %i.iu = alloca [112 x i8], align 8              ; 6 uses
  %i.iv = alloca [16 x i8], align 8               ; 6 uses
  %i.iw = alloca [16 x i8], align 8               ; 6 uses
  %i.ix = alloca [32 x i8], align 8               ; 8 uses
  %i.iy = alloca [24 x i8], align 8               ; 5 uses
  %i.iz = alloca [16 x i8], align 8               ; 6 uses
  %i.ja = alloca [16 x i8], align 8               ; 6 uses
  %i.jb = alloca [32 x i8], align 8               ; 8 uses
  %i.jc = alloca [48 x i8], align 8               ; 5 uses
  %i.jd = alloca [48 x i8], align 8               ; 4 uses
  %i.je = alloca [112 x i8], align 8              ; 6 uses
  %i.jf = alloca [16 x i8], align 8               ; 6 uses
  %i.jg = alloca [16 x i8], align 8               ; 6 uses
  %i.jh = alloca [32 x i8], align 8               ; 8 uses
  %i.ji = alloca [24 x i8], align 8               ; 5 uses
  %i.jj = alloca [16 x i8], align 8               ; 6 uses
  %i.jk = alloca [16 x i8], align 8               ; 6 uses
  %i.jl = alloca [32 x i8], align 8               ; 8 uses
  %i.jm = alloca [48 x i8], align 8               ; 5 uses
  %i.jn = alloca [48 x i8], align 8               ; 4 uses
  %i.jo = alloca [112 x i8], align 8              ; 6 uses
  %i.jp = alloca [16 x i8], align 8               ; 6 uses
  %i.jq = alloca [16 x i8], align 8               ; 6 uses
  %i.jr = alloca [32 x i8], align 8               ; 8 uses
  %i.js = alloca [24 x i8], align 8               ; 5 uses
  %i.jt = alloca [16 x i8], align 8               ; 6 uses
  %i.ju = alloca [16 x i8], align 8               ; 6 uses
  %i.jv = alloca [32 x i8], align 8               ; 8 uses
  %i.jw = alloca [48 x i8], align 8               ; 5 uses
  ...
  %i.kf = alloca [112 x i8], align 8              ; 5 uses
  %i.kg = alloca [112 x i8], align 8              ; 8 uses
  %i.kh = alloca [48 x i8], align 8               ; 4 uses
  %i.ki = alloca [112 x i8], align 8              ; 6 uses
  %i.kj = alloca [16 x i8], align 8               ; 6 uses
  %i.kk = alloca [16 x i8], align 8               ; 6 uses
  %i.kl = alloca [32 x i8], align 8               ; 8 uses
  %i.km = alloca [24 x i8], align 8               ; 5 uses
  %i.kn = alloca [16 x i8], align 8               ; 6 uses
  %i.ko = alloca [16 x i8], align 8               ; 6 uses
  %i.kp = alloca [32 x i8], align 8               ; 8 uses
  %i.kq = alloca [48 x i8], align 8               ; 5 uses
  %i.kr = alloca [48 x i8], align 8               ; 4 uses
  %i.ks = alloca [112 x i8], align 8              ; 6 uses
  %i.kt = alloca [16 x i8], align 8               ; 6 uses
  %i.ku = alloca [16 x i8], align 8               ; 6 uses
  %i.kv = alloca [32 x i8], align 8               ; 8 uses
  %i.kw = alloca [24 x i8], align 8               ; 5 uses
  %i.kx = alloca [16 x i8], align 8               ; 6 uses
  %i.ky = alloca [16 x i8], align 8               ; 6 uses
  %i.kz = alloca [32 x i8], align 8               ; 8 uses
  %i.la = alloca [48 x i8], align 8               ; 5 uses
  ...
  %i.lj = alloca [112 x i8], align 8              ; 5 uses
  ...
  %i.lr = alloca [112 x i8], align 8              ; 10 uses
  ...
  %i.mb = alloca [112 x i8], align 8              ; 5 uses
  %i.mc = alloca [112 x i8], align 8              ; 8 uses
  ...
  %i.mp = alloca [112 x i8], align 8              ; 6 uses
  %i.mq = alloca [16 x i8], align 8               ; 6 uses
  %i.mr = alloca [16 x i8], align 8               ; 6 uses
  %i.ms = alloca [32 x i8], align 8               ; 8 uses
  %i.mt = alloca [24 x i8], align 8               ; 5 uses
  %i.mu = alloca [16 x i8], align 8               ; 6 uses
  %i.mv = alloca [16 x i8], align 8               ; 6 uses
  %i.mw = alloca [32 x i8], align 8               ; 8 uses
  %i.mx = alloca [48 x i8], align 8               ; 5 uses
...
default.unreachable1479:                          ; preds = %bb.apd, %_RNvMNtCscTw95cGIolY_7tracing4spanNtB2_4Span8do_enter.exit.i.i.i, %_RNvMNtCscTw95cGIolY_7tracing4spanNtB2_4Span8do_enter.exit.i896, %_RNvMNtCscTw95cGIolY_7tracing4spanNtB2_4Span8do_enter.exit.i, %bb.dr, %bb.bo, %bb.aj, %bb.a
  unreachable
...
bb.f:                                             ; preds = %bb.d
  %i.ns = load i64, ptr %i.mo, align 8, !range !22, !noundef !7
...
bb.g:                                             ; preds = %bb.f
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %i.mx, ptr noundef nonnull align 8 dereferenceable(48) %i.mo, i64 48, i1 false)
...
bb.r:                                             ; preds = %bb.p
  ...
  store i64 4, ptr %i.mt, align 8, !alias.scope !1597
  %.sroa.6961.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.mt, i64 8
  store ptr %.val610, ptr %.sroa.6961.0..sroa_idx, align 8, !alias.scope !1597
  %.sroa.8962.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.mt, i64 16
...
bb.s:                                             ; preds = %bb.r
  ...
  %i.ou = invoke noundef zeroext i1 %i.ot(ptr noundef %i.oq, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.mt)
...
bb.v:                                             ; preds = %bb.u
  ...
  store ptr @47, ptr %i.mq, align 8
  %i.oy = getelementptr inbounds nuw i8, ptr %i.mq, i64 8
  store ptr inttoptr (i64 79 to ptr), ptr %i.oy, align 8
  store ptr %i.mq, ptr %i.mr, align 8
  %i.oz = getelementptr inbounds nuw i8, ptr %i.mr, i64 8
  store ptr @8, ptr %i.oz, align 8
  store i64 1, ptr %i.ms, align 8, !alias.scope !1601, !noalias !1604
  %.sroa.4.0..sroa_idx.i636 = getelementptr inbounds nuw i8, ptr %i.ms, i64 8
  store ptr %i.mr, ptr %.sroa.4.0..sroa_idx.i636, align 8, !alias.scope !1601, !noalias !1604
  %.sroa.5.0..sroa_idx.i637 = getelementptr inbounds nuw i8, ptr %i.ms, i64 16
  store i64 1, ptr %.sroa.5.0..sroa_idx.i637, align 8, !alias.scope !1601, !noalias !1604
  %i.pa = getelementptr inbounds nuw i8, ptr %i.ms, i64 24
end_hunk_2
begin_hunk_3_@_RNCNvNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator11try_attempt0Cs9rVkZwOUgsI_13deltalake_aws:bb.a
  ...
  %i.pv = invoke noundef align 8 ptr @_RINvMs8_NtCs2DiVQAxFeQE_16aws_smithy_types10config_bagNtB6_9ConfigBag4loadNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth30AuthSchemeOptionResolverParamsECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(80) %i.pt)
          to label %bb.ap unwind label %bb.ao, !noalias !1619 ; 2 uses
...
bb.ap:                                            ; preds = %bb.al
  ...
  br i1 %.not.i146.i, label %bb.aq, label %_RNvMNtCsbvkFyIu7lgC_4core6optionINtB2_6OptionRNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth30AuthSchemeOptionResolverParamsE6expectCs9rVkZwOUgsI_13deltalake_aws.exit.i, !prof !9
...
bb.aq:                                            ; preds = %bb.ap
  invoke void @_RNvNtCsbvkFyIu7lgC_4core6option13expect_failed(ptr noalias noundef nonnull readonly captures(address, read_provenance) @102, i64 noundef 46, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @104) #28
          to label %.noexc.i unwind label %bb.ar, !noalias !1619
...
_RNvMNtCsbvkFyIu7lgC_4core6optionINtB2_6OptionRNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth30AuthSchemeOptionResolverParamsE6expectCs9rVkZwOUgsI_13deltalake_aws.exit.i: ; preds = %bb.ap
  ...
  br i1 %i.qd, label %bb.as, label %bb.au

bb.as:                                            ; preds = %_RNvMNtCsbvkFyIu7lgC_4core6optionINtB2_6OptionRNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth30AuthSchemeOptionResolverParamsE6expectCs9rVkZwOUgsI_13deltalake_aws.exit.i
  tail call void @llvm.trap()
  unreachable

_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth30SharedAuthSchemeOptionResolverECs9rVkZwOUgsI_13deltalake_aws.exit149.i: ; preds = %bb.bn, %bb.bm, %bb.at, %bb.ar, %bb.ao
  %i.qe = phi ptr [ %i.qg, %bb.at ], [ %i.pm, %bb.ao ], [ %i.pm, %bb.ar ], [ %i.rl, %bb.bn ], [ %i.rl, %bb.bm ]
  %i.qf = phi ptr [ %i.qh, %bb.at ], [ %i.pn, %bb.ao ], [ %i.pn, %bb.ar ], [ %i.rm, %bb.bn ], [ %i.rm, %bb.bm ]
  %.pn104.i = phi { ptr, i32 } [ %i.qi, %bb.at ], [ %i.pw, %bb.ao ], [ %i.py, %bb.ar ], [ %.pn101.pn.i, %bb.bn ], [ %.pn101.pn.i, %bb.bm ]
  store i8 2, ptr %i.qe, align 1, !noalias !1615
  br label %.body

bb.at:                                            ; preds = %bb.ik, %bb.bl
  %i.qg = phi ptr [ %i.vh, %bb.ik ], [ %i.rf, %bb.bl ]
  %i.qh = phi ptr [ %i.vi, %bb.ik ], [ %i.rg, %bb.bl ]
  %i.qi = landingpad { ptr, i32 }
          cleanup
  br label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth30SharedAuthSchemeOptionResolverECs9rVkZwOUgsI_13deltalake_aws.exit149.i

bb.au:                                            ; preds = %_RNvMNtCsbvkFyIu7lgC_4core6optionINtB2_6OptionRNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth30AuthSchemeOptionResolverParamsE6expectCs9rVkZwOUgsI_13deltalake_aws.exit.i
  ...
  invoke void @_RNvXsb_NtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4authNtB5_30SharedAuthSchemeOptionResolverNtB5_24ResolveAuthSchemeOptions30resolve_auth_scheme_options_v2(ptr noalias noundef nonnull sret([24 x i8]) align 8 captures(address) dereferenceable(24) %i.ej, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %i.pn, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(48) %i.qk, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(80) %i.ql, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(392) %i.qm)
          to label %bb.aw unwind label %bb.av, !noalias !1619
...
bb.ax:                                            ; preds = %bb.bf, %bb.bb, %bb.av
  %i.qp = phi ptr [ %i.qr, %bb.bf ], [ %i.qr, %bb.bb ], [ %i.pm, %bb.av ]
  %i.qq = phi ptr [ %i.qs, %bb.bf ], [ %i.qs, %bb.bb ], [ %i.pn, %bb.av ]
  %.pn101.i = phi { ptr, i32 } [ %i.qx, %bb.bf ], [ %i.qu, %bb.bb ], [ %i.qn, %bb.av ]
...
bb.ay:                                            ; preds = %bb.aj
  invoke void @_RNvNtNtCsbvkFyIu7lgC_4core9panicking11panic_const28panic_const_async_fn_resumed(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @105) #28
          to label %.noexc643 unwind label %bb.lw

.noexc643:                                        ; preds = %bb.ay
  unreachable
...
bb.az:                                            ; preds = %bb.aj
  invoke void @_RNvNtNtCsbvkFyIu7lgC_4core9panicking11panic_const34panic_const_async_fn_resumed_panic(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @105) #28
          to label %.noexc644 unwind label %bb.lw

.noexc644:                                        ; preds = %bb.az
  unreachable

bb.ba:                                            ; preds = %bb.aw, %bb.am
  %i.qr = phi ptr [ %i.pm, %bb.aw ], [ %i.pl, %bb.am ] ; 6 uses
  %i.qs = phi ptr [ %i.pn, %bb.aw ], [ %i.pk, %bb.am ] ; 5 uses
  ...
  invoke void @_RNvXsB_NtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4authNtB5_23AuthSchemeOptionsFutureNtNtNtCsbvkFyIu7lgC_4core6future6future6Future4poll(ptr noalias noundef nonnull sret([24 x i8]) align 8 captures(address) dereferenceable(24) %i.ei, ptr noalias noundef nonnull align 8 dereferenceable(24) %i.qt, ptr noalias noundef nonnull align 8 dereferenceable(32) %1)
          to label %bb.bc unwind label %bb.bb, !noalias !1619
...
bb.be:                                            ; preds = %bb.bc
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth23AuthSchemeOptionsFutureECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef align 8 dereferenceable(24) %i.qt)
          to label %bb.bg unwind label %bb.bf, !noalias !1619
...
bb.bg:                                            ; preds = %bb.be
  ...
  br i1 %i.qy, label %bb.bk, label %_RNvXsp_NtCsbvkFyIu7lgC_4core6resultINtB5_6ResultINtNtCs6Po7BT7Nknu_5alloc3vec3VecNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth16AuthSchemeOptionEINtNtBP_5boxed3BoxDNtNtB7_5error5ErrorNtNtB7_6marker4SyncNtB37_4SendEL_EENtNtNtB7_3ops9try_trait3Try6branchCs9rVkZwOUgsI_13deltalake_aws.exit.i
...
_RNvXsp_NtCsbvkFyIu7lgC_4core6resultINtB5_6ResultINtNtCs6Po7BT7Nknu_5alloc3vec3VecNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth16AuthSchemeOptionEINtNtBP_5boxed3BoxDNtNtB7_5error5ErrorNtNtB7_6marker4SyncNtB37_4SendEL_EENtNtNtB7_3ops9try_trait3Try6branchCs9rVkZwOUgsI_13deltalake_aws.exit.i: ; preds = %bb.bg
  ...
  %i.rc = invoke noundef align 8 ptr @_RINvMs8_NtCs2DiVQAxFeQE_16aws_smithy_types10config_bagNtB6_9ConfigBag4loadNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth20AuthSchemePreferenceECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(80) %i.rb)
          to label %.thread.i unwind label %bb.bi, !noalias !1619 ; 2 uses
...
bb.bi:                                            ; preds = %_RNvXsp_NtCsbvkFyIu7lgC_4core6resultINtB5_6ResultINtNtCs6Po7BT7Nknu_5alloc3vec3VecNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth16AuthSchemeOptionEINtNtBP_5boxed3BoxDNtNtB7_5error5ErrorNtNtB7_6marker4SyncNtB37_4SendEL_EENtNtNtB7_3ops9try_trait3Try6branchCs9rVkZwOUgsI_13deltalake_aws.exit.i
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VecNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth16AuthSchemeOptionEECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef align 8 dereferenceable(24) %i.eh) #24
          to label %bb.bh unwind label %bb.bj, !noalias !1619

bb.bj:                                            ; preds = %bb.lv, %bb.lu, %bb.lt, %bb.lr, %bb.lo, %bb.ku, %bb.ji, %.body167.i, %bb.iz, %bb.hr, %.body.i, %bb.dq, %bb.bn, %bb.bi, %bb.bb
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VecNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth16AuthSchemeOptionEECs9rVkZwOUgsI_13deltalake_aws.exit226.i: ; preds = %bb.ll, %bb.bk
  %i.rf = phi ptr [ %i.qr, %bb.bk ], [ %i.aip, %bb.ll ] ; 2 uses
  %i.rg = phi ptr [ %i.qs, %bb.bk ], [ %i.aiq, %bb.ll ] ; 4 uses
  %.sroa.0328.0.i = phi i64 [ -9223372036854775807, %bb.bk ], [ %.sroa.0328.2.i, %bb.ll ] ; 2 uses
  %.sroa.7330.0.i = phi ptr [ %.sroa.3.0.copyload.i, %bb.bk ], [ %.sroa.7330.2.i, %bb.ll ]
  %.sroa.12333.0.i = phi ptr [ %.sroa.5.0.copyload.i, %bb.bk ], [ %.sroa.12333.2.i, %bb.ll ]
  ...
  br i1 %i.rk, label %bb.bl, label %bb.lx

bb.bl:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VecNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth16AuthSchemeOptionEECs9rVkZwOUgsI_13deltalake_aws.exit226.i
  fence acquire
  invoke void @_RNvMsn_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcDNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth24ResolveAuthSchemeOptionsEL_E9drop_slowBN_(ptr noalias noundef nonnull align 8 dereferenceable(16) %i.rg) #26
          to label %bb.lx unwind label %bb.at, !noalias !1619

bb.bm:                                            ; preds = %bb.lv, %.body192.i, %bb.ax
  %i.rl = phi ptr [ %i.qp, %bb.ax ], [ %i.wd, %bb.lv ], [ %i.wd, %.body192.i ] ; 2 uses
  %i.rm = phi ptr [ %i.qq, %bb.ax ], [ %i.we, %bb.lv ], [ %i.we, %.body192.i ] ; 4 uses
  %.pn101.pn.i = phi { ptr, i32 } [ %.pn101.i, %bb.ax ], [ %.pn95.pn.pn.pn.pn.i, %bb.lv ], [ %.pn95.pn.pn.pn.pn.i, %.body192.i ] ; 2 uses
  ...
  br i1 %i.rq, label %bb.bn, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth30SharedAuthSchemeOptionResolverECs9rVkZwOUgsI_13deltalake_aws.exit149.i
...
bb.bn:                                            ; preds = %bb.bm
  ...
  invoke void @_RNvMsn_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcDNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth24ResolveAuthSchemeOptionsEL_E9drop_slowBN_(ptr noalias noundef nonnull align 8 dereferenceable(16) %i.rm) #26
          to label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth30SharedAuthSchemeOptionResolverECs9rVkZwOUgsI_13deltalake_aws.exit149.i unwind label %bb.bj, !noalias !1619
...
bb.bp:                                            ; preds = %._crit_edge, %.thread.i
  ...
  br i1 %.not.i150.i, label %bb.br, label %bb.bq
...
bb.bq:                                            ; preds = %bb.bp
  ...
  invoke void @_RNvXsa_NtCs6Po7BT7Nknu_5alloc3vecINtB5_3VecNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth12AuthSchemeIdENtNtCsbvkFyIu7lgC_4core5clone5Clone5cloneCs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull sret([24 x i8]) align 8 captures(address) dereferenceable(24) %i.cm, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.ru)
          to label %bb.bt unwind label %bb.bs, !noalias !1649
...
bb.bt:                                            ; preds = %bb.bq
  ...
  invoke void @_RINvXs1e_NtNtNtCs2pqxYH9ZEk8_3std11collections4hash3mapINtB7_7HashMapNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth12AuthSchemeIdjEINtNtNtNtCsbvkFyIu7lgC_4core4iter6traits7collect12FromIteratorTB15_jEE9from_iterINtNtNtB2l_8adapters3map3MapINtNtB3B_9enumerate9EnumerateINtNtNtCs6Po7BT7Nknu_5alloc3vec9into_iter8IntoIterB15_EENCNCNvNtNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator4auth40reprioritize_with_auth_scheme_preference00EECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull sret([48 x i8]) align 8 captures(none) dereferenceable(48) %i.co, ptr noalias noundef nonnull align 8 captures(address) dereferenceable(40) %i.cn)
          to label %bb.bv unwind label %bb.bu, !noalias !1649
...
bb.bv:                                            ; preds = %bb.bt
  ...
  invoke void @_RINvYINtNtNtCs6Po7BT7Nknu_5alloc3vec9into_iter8IntoIterNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth16AuthSchemeOptionENtNtNtNtCsbvkFyIu7lgC_4core4iter6traits8iterator8Iterator9partitionINtB8_3VecBR_ENCNCNvNtNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator4auth40reprioritize_with_auth_scheme_preference0s_0ECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull sret([48 x i8]) align 8 captures(none) dereferenceable(48) %i.cj, ptr noalias noundef nonnull align 8 captures(address) dereferenceable(32) %i.ci, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(48) %i.co)
          to label %bb.bx unwind label %bb.bw, !noalias !1649
...
bb.bx:                                            ; preds = %bb.bv
  ...
  br i1 %i.sl, label %bb.cc, label %bb.by, !prof !62

bb.by:                                            ; preds = %bb.bx
  %i.sm = icmp samesign ult i64 %.val17.i.i, 21
  br i1 %i.sm, label %bb.ca, label %bb.bz, !prof !62
...
bb.bz:                                            ; preds = %bb.by
  invoke void @_RINvNtNtNtCsbvkFyIu7lgC_4core5slice4sort6stable14driftsort_mainNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth16AuthSchemeOptionNCINvMNtCs6Po7BT7Nknu_5alloc5sliceSBZ_11sort_by_keyRjNCNCNvNtNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator4auth40reprioritize_with_auth_scheme_preference0s0_0E0INtNtB2i_3vec3VecBZ_EEB3d_(ptr noalias noundef nonnull align 8 %.val.i.i, i64 noundef range(i64 0, 288230376151711744) %.val17.i.i, ptr noalias noundef nonnull align 8 dereferenceable(8) %i.cg)
          to label %bb.cc unwind label %bb.cb, !noalias !1649
...
bb.cb:                                            ; preds = %bb.ca, %bb.bz
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VecNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth16AuthSchemeOptionEECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef align 8 dereferenceable(24) %i.ck) #24
          to label %bb.cg unwind label %bb.ch, !noalias !1649

bb.cc:                                            ; preds = %bb.ca, %bb.bz, %bb.bx
...
bb.ka:                                            ; preds = %bb.jz
  ...
  %i.akg = invoke noundef zeroext i1 %i.akf(ptr noundef %i.akc, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.dd)
          to label %bb.kc unwind label %bb.kb, !noalias !1619
...
bb.kc:                                            ; preds = %bb.ka
  br i1 %i.akg, label %bb.kd, label %bb.kg
...
bb.kd:                                            ; preds = %bb.kc
  ...
  invoke void @_RNvNtCscTw95cGIolY_7tracing15___macro_support13___tracing_log(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(120) %i.ajy, ptr noundef nonnull %i.akc, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(48) %i.akd, ptr noalias noundef nonnull readonly align 8 captures(none) dereferenceable(24) %i.cq, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(32) %i.dc)
          to label %bb.kf unwind label %bb.ke, !noalias !1619
...
bb.kg:                                            ; preds = %bb.kj, %bb.kf, %bb.kc, %bb.jx, %bb.jw
  %i.akq = invoke noundef align 8 ptr @_RINvMs5_NtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8identityNtB6_8Identity8propertyNtNtCs2DiVQAxFeQE_16aws_smithy_types10config_bag11FrozenLayerECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(96) %i.dm)
          to label %bb.kl unwind label %bb.kk, !noalias !1619
...
bb.kh:                                            ; preds = %bb.jv
  ...
  invoke fastcc void @_RNCNCNvNtNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator4auth16resolve_identity0s0_0Cs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef align 8 captures(address) dereferenceable(32) %i.dh)
          to label %bb.kj unwind label %bb.ki, !noalias !1619
...
bb.kl:                                            ; preds = %bb.kg
  %i.akz = invoke noundef ptr @_RNvMs1_NtCsbvkFyIu7lgC_4core6optionINtB5_6OptionRNtNtCs2DiVQAxFeQE_16aws_smithy_types10config_bag11FrozenLayerE6clonedCs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable_or_null(8) %i.akq)
          to label %bb.kn unwind label %bb.km, !noalias !1619 ; 2 uses
...
bb.kn:                                            ; preds = %bb.kl
  ...
  br i1 %.not73.i, label %bb.kp, label %bb.ko
...
bb.ko:                                            ; preds = %bb.kn
  ...
  %i.ald = invoke noundef nonnull align 8 ptr @_RNvMs8_NtCs2DiVQAxFeQE_16aws_smithy_types10config_bagNtB5_9ConfigBag17push_shared_layer(ptr noalias noundef nonnull align 8 dereferenceable(80) %i.alc, ptr noundef nonnull %i.akz)
          to label %bb.kp unwind label %bb.kq, !noalias !1619 ; 0 uses
...
bb.kp:                                            ; preds = %bb.ko, %bb.kn
  ...
  invoke void @_RNvXs0_NtCs6Po7BT7Nknu_5alloc6borrowINtB5_3CoweENtNtCsbvkFyIu7lgC_4core5clone5Clone5cloneCs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull sret([24 x i8]) align 8 captures(none) dereferenceable(24) %i.cy, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.alf)
          to label %_RNvXsr_NtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4authNtB5_12AuthSchemeIdNtNtCsbvkFyIu7lgC_4core5clone5Clone5clone.exit214.i unwind label %bb.kr, !noalias !1619
...
_RNvXsr_NtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4authNtB5_12AuthSchemeIdNtNtCsbvkFyIu7lgC_4core5clone5Clone5clone.exit214.i: ; preds = %bb.kp
...
bb.ks:                                            ; preds = %bb.kw, %_RNvXsr_NtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4authNtB5_12AuthSchemeIdNtNtCsbvkFyIu7lgC_4core5clone5Clone5clone.exit214.i
  %.sroa.0328.3.i = phi i64 [ -9223372036854775807, %bb.kw ], [ %.sroa.0337.0.copyload.i, %_RNvXsr_NtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4authNtB5_12AuthSchemeIdNtNtCsbvkFyIu7lgC_4core5clone5Clone5clone.exit214.i ]
  %.sroa.7330.3.i = phi ptr [ %.sroa.0306.0.copyload.i, %bb.kw ], [ %.sroa.5338.0.copyload.i, %_RNvXsr_NtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4authNtB5_12AuthSchemeIdNtNtCsbvkFyIu7lgC_4core5clone5Clone5clone.exit214.i ]
  %.sroa.12333.3.i = phi ptr [ %.sroa.3307.0.copyload.i, %bb.kw ], [ %.sroa.6339.0.copyload.i, %_RNvXsr_NtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4authNtB5_12AuthSchemeIdNtNtCsbvkFyIu7lgC_4core5clone5Clone5clone.exit214.i ]
  ...
  br i1 %i.aln, label %bb.kt, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8identity19SharedIdentityCacheECs9rVkZwOUgsI_13deltalake_aws.exit216.i
...
bb.kt:                                            ; preds = %bb.ks
  ...
  invoke void @_RNvMsn_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcDNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8identity21ResolveCachedIdentityEL_E9drop_slowBN_(ptr noalias noundef nonnull align 8 dereferenceable(16) %i.alk) #26
          to label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8identity19SharedIdentityCacheECs9rVkZwOUgsI_13deltalake_aws.exit216.i unwind label %bb.kx, !noalias !1619

bb.ku:                                            ; preds = %bb.kr, %bb.kq, %bb.km, %bb.kk, %bb.ki, %bb.ke, %bb.kb, %bb.jy, %bb.jt, %bb.jr
  %.pn76.i = phi { ptr, i32 } [ %i.alh, %bb.kr ], [ %i.ala, %bb.km ], [ %i.akx, %bb.ki ], [ %i.alg, %bb.kq ], [ %i.aky, %bb.kk ], [ %i.akp, %bb.ke ], [ %i.akh, %bb.kb ], [ %i.ajq, %bb.jt ], [ %i.ajx, %bb.jy ], [ %i.ajo, %bb.jr ]
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8identity8IdentityECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef align 8 dereferenceable(96) %i.dm) #24
          to label %bb.kv unwind label %bb.bj, !noalias !1619

bb.kv:                                            ; preds = %bb.ku, %bb.hp
  %i.alo = phi ptr [ %i.aes, %bb.hp ], [ %i.aja, %bb.ku ]
  %i.alp = phi ptr [ %i.aet, %bb.hp ], [ %i.ajb, %bb.ku ]
  %.pn78.pn.i = phi { ptr, i32 } [ %.pn78.i, %bb.hp ], [ %.pn76.i, %bb.ku ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.dm), !noalias !1615
  br label %bb.hq
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8identity19SharedIdentityCacheECs9rVkZwOUgsI_13deltalake_aws.exit216.i: ; preds = %bb.kt, %bb.ks
  ...
  br i1 %i.alt, label %bb.ky, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionNtNtCs2DiVQAxFeQE_16aws_smithy_types8endpoint8EndpointEECs9rVkZwOUgsI_13deltalake_aws.exit.i

_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionNtNtCs2DiVQAxFeQE_16aws_smithy_types8endpoint8EndpointEECs9rVkZwOUgsI_13deltalake_aws.exit.i: ; preds = %bb.kz, %bb.ky, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8identity19SharedIdentityCacheECs9rVkZwOUgsI_13deltalake_aws.exit216.i
  store i8 0, ptr %i.alr, align 8, !noalias !1615
  br label %bb.jf

bb.ky:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8identity19SharedIdentityCacheECs9rVkZwOUgsI_13deltalake_aws.exit216.i
  ...
  br i1 %i.alw, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionNtNtCs2DiVQAxFeQE_16aws_smithy_types8endpoint8EndpointEECs9rVkZwOUgsI_13deltalake_aws.exit.i, label %bb.kz
...
bb.kz:                                            ; preds = %bb.ky
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs2DiVQAxFeQE_16aws_smithy_types8endpoint8EndpointECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull align 8 dereferenceable(120) %i.alu)
          to label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionNtNtCs2DiVQAxFeQE_16aws_smithy_types8endpoint8EndpointEECs9rVkZwOUgsI_13deltalake_aws.exit.i unwind label %bb.la, !noalias !1619

_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionNtNtCs2DiVQAxFeQE_16aws_smithy_types8endpoint8EndpointEECs9rVkZwOUgsI_13deltalake_aws.exit228.i: ; preds = %bb.lo, %bb.ln, %bb.la, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8identity19SharedIdentityCacheECs9rVkZwOUgsI_13deltalake_aws.exit.i
  %i.alx = phi ptr [ %i.aja, %bb.la ], [ %i.afa, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8identity19SharedIdentityCacheECs9rVkZwOUgsI_13deltalake_aws.exit.i ], [ %i.afa, %bb.lo ], [ %i.afa, %bb.ln ]
  %i.aly = phi ptr [ %i.ajb, %bb.la ], [ %i.afb, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8identity19SharedIdentityCacheECs9rVkZwOUgsI_13deltalake_aws.exit.i ], [ %i.afb, %bb.lo ], [ %i.afb, %bb.ln ]
  %.pn84.i = phi { ptr, i32 } [ %i.ama, %bb.la ], [ %.pn82.i, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8identity19SharedIdentityCacheECs9rVkZwOUgsI_13deltalake_aws.exit.i ], [ %.pn82.i, %bb.lo ], [ %.pn82.i, %bb.ln ]
...
bb.lb:                                            ; preds = %bb.jf
  ...
  br i1 %i.amd, label %bb.le, label %bb.ld

bb.lc:                                            ; preds = %bb.ld, %bb.jf
  ...
  br i1 %i.amh, label %bb.lh, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8identity22SharedIdentityResolverECs9rVkZwOUgsI_13deltalake_aws.exit221.i

bb.ld:                                            ; preds = %bb.lf, %bb.le, %bb.lb
...
bb.le:                                            ; preds = %bb.lb
  ...
  br i1 %i.aml, label %bb.ld, label %bb.lf
...
bb.lf:                                            ; preds = %bb.le
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator4auth22AuthOrchestrationErrorECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef align 8 dereferenceable(24) %i.ami)
          to label %bb.ld unwind label %.body173.i, !noalias !1619

_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8identity22SharedIdentityResolverECs9rVkZwOUgsI_13deltalake_aws.exit221.i: ; preds = %bb.li, %bb.lh, %bb.lc
  ...
  br i1 %i.amp, label %bb.lg, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth16SharedAuthSchemeECs9rVkZwOUgsI_13deltalake_aws.exit219.i

bb.lg:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8identity22SharedIdentityResolverECs9rVkZwOUgsI_13deltalake_aws.exit221.i
  fence acquire
...
bb.lh:                                            ; preds = %bb.lc
  ...
  br i1 %i.amt, label %bb.li, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8identity22SharedIdentityResolverECs9rVkZwOUgsI_13deltalake_aws.exit221.i
...
bb.li:                                            ; preds = %bb.lh
  ...
  invoke void @_RNvMsn_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcDNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8identity15ResolveIdentityEL_E9drop_slowBN_(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.amq) #26
          to label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8identity22SharedIdentityResolverECs9rVkZwOUgsI_13deltalake_aws.exit221.i unwind label %bb.id, !noalias !1619

_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth16SharedAuthSchemeECs9rVkZwOUgsI_13deltalake_aws.exit219.i: ; preds = %bb.lg, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8identity22SharedIdentityResolverECs9rVkZwOUgsI_13deltalake_aws.exit221.i
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator4auth12ExploredListECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef align 8 dereferenceable(272) %i.amu)
          to label %bb.lj unwind label %bb.do, !noalias !1619

bb.lj:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth16SharedAuthSchemeECs9rVkZwOUgsI_13deltalake_aws.exit219.i
  ...
  invoke void @_RNvXso_NtCs6Po7BT7Nknu_5alloc3vecINtB5_3VecNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth16AuthSchemeOptionENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.amw)
          to label %bb.ll unwind label %bb.lk, !noalias !1619
...
bb.lk:                                            ; preds = %bb.lj
  ...
  invoke void @_RNvXs1_NtCs6Po7BT7Nknu_5alloc7raw_vecINtB5_6RawVecNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth16AuthSchemeOptionENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.amw)
          to label %.body192.i unwind label %bb.lm, !noalias !1619

bb.ll:                                            ; preds = %bb.lj
  invoke void @_RNvXs1_NtCs6Po7BT7Nknu_5alloc7raw_vecINtB5_6RawVecNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth16AuthSchemeOptionENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.amw)
          to label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VecNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth16AuthSchemeOptionEECs9rVkZwOUgsI_13deltalake_aws.exit226.i unwind label %bb.ij, !noalias !1619
...
bb.ln:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8identity19SharedIdentityCacheECs9rVkZwOUgsI_13deltalake_aws.exit.i
  ...
  br i1 %i.anb, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionNtNtCs2DiVQAxFeQE_16aws_smithy_types8endpoint8EndpointEECs9rVkZwOUgsI_13deltalake_aws.exit228.i, label %bb.lo
...
bb.lo:                                            ; preds = %bb.ln
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs2DiVQAxFeQE_16aws_smithy_types8endpoint8EndpointECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull align 8 dereferenceable(120) %i.amz)
          to label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionNtNtCs2DiVQAxFeQE_16aws_smithy_types8endpoint8EndpointEECs9rVkZwOUgsI_13deltalake_aws.exit228.i unwind label %bb.bj, !noalias !1619
...
bb.lp:                                            ; preds = %bb.je
  ...
  br i1 %i.ane, label %bb.lq, label %bb.gc
...
bb.lq:                                            ; preds = %bb.lp
  ...
  br i1 %i.ani, label %bb.gc, label %bb.lr
...
bb.lr:                                            ; preds = %bb.lq
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator4auth22AuthOrchestrationErrorECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef align 8 dereferenceable(24) %i.anf) #24
          to label %bb.gc unwind label %bb.bj, !noalias !1619
...
bb.ls:                                            ; preds = %bb.gc
  ...
  br i1 %i.anm, label %bb.lt, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8identity22SharedIdentityResolverECs9rVkZwOUgsI_13deltalake_aws.exit230.i
...
bb.lt:                                            ; preds = %bb.ls
  ...
  invoke void @_RNvMsn_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcDNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8identity15ResolveIdentityEL_E9drop_slowBN_(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.anj) #26
          to label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8identity22SharedIdentityResolverECs9rVkZwOUgsI_13deltalake_aws.exit230.i unwind label %bb.bj, !noalias !1619

bb.lu:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth16SharedAuthSchemeECs9rVkZwOUgsI_13deltalake_aws.exit203.i
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator4auth12ExploredListECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef align 8 dereferenceable(272) %i.ann) #24
          to label %bb.dn unwind label %bb.bj, !noalias !1619

bb.lv:                                            ; preds = %.body192.i
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VecNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth16AuthSchemeOptionEECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef align 8 dereferenceable(24) %i.el) #24
          to label %bb.bm unwind label %bb.bj, !noalias !1619

bb.lw:                                            ; preds = %bb.az, %bb.ay
  %i.ano = landingpad { ptr, i32 }
          cleanup
  br label %.body

.thread1259:                                      ; preds = %bb.bd, %bb.cq, %bb.gb, %bb.jk
  %i.anp = phi ptr [ %i.qr, %bb.bd ], [ %i.rs, %bb.cq ], [ %i.zn, %bb.gb ], [ %i.aja, %bb.jk ]
  %.sink.i.ph = phi i8 [ 3, %bb.bd ], [ 4, %bb.cq ], [ 5, %bb.gb ], [ 6, %bb.jk ]
...
.thread1265:                                      ; preds = %bb.ik, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VecNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth16AuthSchemeOptionEECs9rVkZwOUgsI_13deltalake_aws.exit.i
...
bb.lx:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VecNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client4auth16AuthSchemeOptionEECs9rVkZwOUgsI_13deltalake_aws.exit226.i, %bb.bl
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(216) %.sroa.13, ptr noundef nonnull align 8 dereferenceable(216) %.sroa.7340.i, i64 216, i1 false), !noalias !1899
  ...
  br i1 %i.anq, label %bb.ly, label %bb.lz

bb.ly:                                            ; preds = %.thread1259, %bb.lx
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.13)
  br label %common.ret

bb.lz:                                            ; preds = %.thread1265, %bb.lx
  %i.anr = phi ptr [ %i.vi, %.thread1265 ], [ %i.rg, %bb.lx ] ; 2 uses
  %.sroa.12333.1.i1271 = phi ptr [ %i.agm, %.thread1265 ], [ %.sroa.12333.0.i, %bb.lx ] ; 3 uses
  %.sroa.7330.1.i1270 = phi ptr [ %i.agl, %.thread1265 ], [ %.sroa.7330.0.i, %bb.lx ] ; 3 uses
  %.sroa.0328.1.i1269 = phi i64 [ -9223372036854775807, %.thread1265 ], [ %.sroa.0328.0.i, %bb.lx ] ; 2 uses
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNCNvNtNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator4auth16resolve_identity0ECs9rVkZwOUgsI_13deltalake_aws(ptr noundef nonnull align 8 %i.anr)
          to label %bb.mb unwind label %bb.ma
...
bb.md:                                            ; preds = %bb.mb
  ...
  br i1 %.not48, label %bb.mf, label %bb.me
...
bb.me:                                            ; preds = %bb.md
  ...
  %i.aod = invoke { ptr, ptr } @_RNvNtNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator9endpoints14apply_endpoint(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(120) %i.md, ptr noalias noundef nonnull align 8 dereferenceable(1160) %i.aoa, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(80) %i.aoc)
          to label %bb.ni unwind label %bb.nh     ; 2 uses
...
bb.mf:                                            ; preds = %bb.md
  ...
  br i1 %i.aoj, label %bb.mh, label %bb.mg
...
bb.mg:                                            ; preds = %bb.mf
  ...
  br i1 %i.aoq, label %bb.mj, label %bb.mi
...
bb.mi:                                            ; preds = %bb.mg
  ...
  invoke void @_RNvXNtCs3gpiEk3WpjL_9hashbrown3mapINtB2_7HashMapNtNtCsbvkFyIu7lgC_4core3any6TypeIdINtNtCs6Po7BT7Nknu_5alloc4sync3ArcNtNtCs2DiVQAxFeQE_16aws_smithy_types12type_erasure13TypeErasedBoxENtNtNtCs2pqxYH9ZEk8_3std4hash6random11RandomStateENtNtBO_5clone5Clone5cloneCs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull sret([48 x i8]) align 8 captures(none) dereferenceable(48) %i.bl, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(96) %0)
          to label %bb.mo unwind label %bb.mk, !noalias !1905
...
bb.mk:                                            ; preds = %bb.mi
  ...
  br i1 %i.aoy, label %bb.ml, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDG_INtNtNtB4_3ops8function2FnTRL0_IBH_DNtNtB4_3any3AnyNtNtB4_6marker4SyncNtB28_4SendEL_EEEp6OutputRL0_DNtNtB4_3fmt5DebugEL0_B26_B2p_EL_EECs9rVkZwOUgsI_13deltalake_aws.exit.i
...
bb.ml:                                            ; preds = %bb.mk
  ...
  invoke void @_RNvMsn_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcDG_INtNtNtCsbvkFyIu7lgC_4core3ops8function2FnTRL0_IBx_DNtNtBQ_3any3AnyNtNtBQ_6marker4SyncNtB1Q_4SendEL_EEEp6OutputRL0_DNtNtBQ_3fmt5DebugEL0_B1O_B27_EL_E9drop_slowCsVcNsP0WZIc_22aws_smithy_runtime_api(ptr noalias noundef nonnull align 8 dereferenceable(16) %i.bm) #26
          to label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDG_INtNtNtB4_3ops8function2FnTRL0_IBH_DNtNtB4_3any3AnyNtNtB4_6marker4SyncNtB28_4SendEL_EEEp6OutputRL0_DNtNtB4_3fmt5DebugEL0_B26_B2p_EL_EECs9rVkZwOUgsI_13deltalake_aws.exit.i unwind label %bb.mm, !noalias !1905

bb.mm:                                            ; preds = %bb.mn, %bb.ml
  %i.aoz = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #25, !noalias !1905
  unreachable

_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDG_INtNtNtB4_3ops8function2FnTRL0_IBH_DNtNtB4_3any3AnyNtNtB4_6marker4SyncNtB28_4SendEL_EEEp6OutputRL0_DNtNtB4_3fmt5DebugEL0_B26_B2p_EL_EECs9rVkZwOUgsI_13deltalake_aws.exit.i: ; preds = %bb.ml, %bb.mk
  ...
  br i1 %i.apc, label %bb.mn, label %.body646

bb.mn:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDG_INtNtNtB4_3ops8function2FnTRL0_IBH_DNtNtB4_3any3AnyNtNtB4_6marker4SyncNtB28_4SendEL_EEEp6OutputRL0_DNtNtB4_3fmt5DebugEL0_B26_B2p_EL_EECs9rVkZwOUgsI_13deltalake_aws.exit.i
  fence acquire
  invoke void @_RNvMsn_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcDNtNtCsbvkFyIu7lgC_4core3any3AnyNtNtBL_6marker4SyncNtB1e_4SendEL_E9drop_slowCsVcNsP0WZIc_22aws_smithy_runtime_api(ptr noalias noundef nonnull align 8 dereferenceable(16) %i.bn) #26
          to label %.body646 unwind label %bb.mm, !noalias !1905
...
bb.mo:                                            ; preds = %bb.mi
  ...
  br i1 %i.apn, label %bb.mp, label %bb.my
...
bb.mp:                                            ; preds = %bb.mo
  ...
  br i1 %i.app, label %bb.ms, label %bb.mq, !prof !1044
...
bb.ms:                                            ; preds = %bb.mq, %bb.mp
  %.sroa.0.0.i648 = phi i8 [ %i.apo, %bb.mp ], [ %i.apq, %bb.mq ] ; 2 uses
  %i.aps = icmp eq i8 %.sroa.0.0.i648, 0
  br i1 %i.aps, label %bb.my, label %bb.mt
...
bb.mt:                                            ; preds = %bb.ms
  ...
  %i.apu = invoke noundef zeroext i1 @_RNvNtCscTw95cGIolY_7tracing15___macro_support12___is_enabled(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(120) %i.apt, i8 noundef %.sroa.0.0.i648)
          to label %bb.mv unwind label %bb.mu
...
bb.mv:                                            ; preds = %bb.mt
  br i1 %i.apu, label %bb.nd, label %bb.my

bb.mw:                                            ; preds = %bb.na
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ll)
  br label %bb.ng

bb.mx:                                            ; preds = %bb.my, %bb.nb
...
bb.my:                                            ; preds = %bb.mo, %bb.mv, %bb.ms
  ...
  br i1 %.not1394, label %bb.mz, label %bb.mx
...
bb.sk:                                            ; preds = %bb.sw, %bb.ss, %bb.si
  %.pn37.i.i = phi { ptr, i32 } [ %i.bae, %bb.sw ], [ %i.bab, %bb.ss ], [ %i.azs, %bb.si ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ap)
  br label %bb.tg

bb.sl:                                            ; preds = %bb.tg, %bb.sg, %bb.rz, %bb.rw, %bb.rt, %bb.ro, %bb.rm, %bb.rg
  %.pn42.pn.i.i = phi { ptr, i32 } [ %i.ayb, %bb.rt ], [ %.pn37.pn.i.i, %bb.tg ], [ %i.azr, %bb.sg ], [ %i.axs, %bb.rm ], [ %i.axk, %bb.rg ], [ %i.ayl, %bb.rw ], [ %i.ayt, %bb.rz ], [ %i.axu, %bb.ro ] ; 2 uses
  ...
  br i1 %i.azw, label %bb.sm, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8endpoint22SharedEndpointResolverECs9rVkZwOUgsI_13deltalake_aws.exit.i.i675
...
bb.sm:                                            ; preds = %bb.sl
  ...
  invoke void @_RNvMsn_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcDNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8endpoint15ResolveEndpointEL_E9drop_slowBN_(ptr noalias noundef nonnull align 8 dereferenceable(16) %i.atw) #26
          to label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8endpoint22SharedEndpointResolverECs9rVkZwOUgsI_13deltalake_aws.exit.i.i675 unwind label %bb.tj, !noalias !1992

bb.sn:                                            ; preds = %bb.ti, %bb.ri
  %.pn.pn.i.i = phi { ptr, ptr } [ %.pn.i.i, %bb.ti ], [ %i.axj, %bb.ri ]
  %.sroa.5.0.copyload.pn.pn.i.i = phi ptr [ %.sroa.5.0.copyload.pn.i.i, %bb.ti ], [ %i.axm, %bb.ri ]
  ...
  br i1 %i.azz, label %bb.so, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8endpoint22SharedEndpointResolverECs9rVkZwOUgsI_13deltalake_aws.exit93.i.i

bb.so:                                            ; preds = %bb.sn
  fence acquire
  invoke void @_RNvMsn_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcDNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8endpoint15ResolveEndpointEL_E9drop_slowBN_(ptr noalias noundef nonnull align 8 dereferenceable(16) %i.atw) #26
          to label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8endpoint22SharedEndpointResolverECs9rVkZwOUgsI_13deltalake_aws.exit93.i.i unwind label %bb.re, !noalias !1992

bb.sp:                                            ; preds = %_RNvMNtCscTw95cGIolY_7tracing4spanNtB2_4Span8do_enter.exit.i
  invoke void @_RNvNtNtCsbvkFyIu7lgC_4core9panicking11panic_const28panic_const_async_fn_resumed(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @129) #28
          to label %.noexc.i682 unwind label %bb.tn, !noalias !1987

.noexc.i682:                                      ; preds = %bb.sp
  unreachable
...
bb.sq:                                            ; preds = %_RNvMNtCscTw95cGIolY_7tracing4spanNtB2_4Span8do_enter.exit.i
  invoke void @_RNvNtNtCsbvkFyIu7lgC_4core9panicking11panic_const34panic_const_async_fn_resumed_panic(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @129) #28
          to label %.noexc3.i unwind label %bb.tn, !noalias !1987

.noexc3.i:                                        ; preds = %bb.sq
  unreachable

bb.sr:                                            ; preds = %bb.sj, %bb.px
  ...
  invoke void @_RNvXs6_NtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8endpointNtB5_14EndpointFutureNtNtNtCsbvkFyIu7lgC_4core6future6future6Future4poll(ptr noalias noundef nonnull sret([120 x i8]) align 8 captures(address) dereferenceable(120) %i.an, ptr noalias noundef nonnull align 8 dereferenceable(120) %i.baa, ptr noalias noundef nonnull align 8 dereferenceable(32) %1)
          to label %bb.st unwind label %bb.ss, !noalias !1992
...
bb.sv:                                            ; preds = %bb.st
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8endpoint14EndpointFutureECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef align 8 dereferenceable(120) %i.baa)
          to label %bb.sx unwind label %bb.sw, !noalias !1992
...
bb.sx:                                            ; preds = %bb.sv
  ...
  br i1 %i.baf, label %bb.tk, label %bb.sy
...
bb.sy:                                            ; preds = %bb.sx
  ...
  %i.bak = invoke { ptr, ptr } @_RNvNtNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator9endpoints14apply_endpoint(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(120) %i.aq, ptr noalias noundef nonnull align 8 dereferenceable(1160) %i.bah, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(80) %i.baj)
          to label %bb.ta unwind label %bb.sz, !noalias !1992 ; 3 uses
...
bb.sz:                                            ; preds = %bb.sy
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs2DiVQAxFeQE_16aws_smithy_types8endpoint8EndpointECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef align 8 dereferenceable(120) %i.aq) #24
          to label %bb.tg unwind label %bb.tj, !noalias !1992

bb.ta:                                            ; preds = %bb.sy
  %i.bam = extractvalue { ptr, ptr } %i.bak, 0
  %.not33.i.i = icmp eq ptr %i.bam, null
  br i1 %.not33.i.i, label %bb.tb, label %bb.tf
...
bb.tb:                                            ; preds = %bb.ta
  ...
  %i.bap = invoke noundef nonnull align 8 ptr @_RINvMs6_NtCs2DiVQAxFeQE_16aws_smithy_types10config_bagNtB6_5Layer9store_putNtNtB8_8endpoint8EndpointECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull align 8 dereferenceable(56) %i.bao, ptr noalias noundef nonnull readonly align 8 captures(none) dereferenceable(120) %i.am)
          to label %bb.tc unwind label %bb.te, !noalias !1992 ; 0 uses
...
bb.tc:                                            ; preds = %bb.tb
  ...
  br i1 %i.bas, label %bb.td, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8endpoint22SharedEndpointResolverECs9rVkZwOUgsI_13deltalake_aws.exit97.i.i

bb.td:                                            ; preds = %bb.tc
  fence acquire
  invoke void @_RNvMsn_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcDNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8endpoint15ResolveEndpointEL_E9drop_slowBN_(ptr noalias noundef nonnull align 8 dereferenceable(16) %i.atw) #26
          to label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8endpoint22SharedEndpointResolverECs9rVkZwOUgsI_13deltalake_aws.exit97.i.i unwind label %bb.re, !noalias !1992

_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8endpoint22SharedEndpointResolverECs9rVkZwOUgsI_13deltalake_aws.exit97.i.i: ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8endpoint22SharedEndpointResolverECs9rVkZwOUgsI_13deltalake_aws.exit93.i.i, %bb.td, %bb.tc
  %.sroa.010.1.i.i = phi ptr [ %.sroa.010.0.i.i, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8endpoint22SharedEndpointResolverECs9rVkZwOUgsI_13deltalake_aws.exit93.i.i ], [ null, %bb.tc ], [ null, %bb.td ]
  %.sroa.5.1.i.i = phi ptr [ %.sroa.5.0.copyload.pn.pn.i.i, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8endpoint22SharedEndpointResolverECs9rVkZwOUgsI_13deltalake_aws.exit93.i.i ], [ undef, %bb.tc ], [ undef, %bb.td ]
...
bb.tf:                                            ; preds = %bb.ta
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs2DiVQAxFeQE_16aws_smithy_types8endpoint8EndpointECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef align 8 dereferenceable(120) %i.aq)
          to label %bb.ti unwind label %bb.th, !noalias !1992

bb.tg:                                            ; preds = %bb.th, %bb.te, %bb.sz, %bb.sk
  %.pn37.pn.i.i = phi { ptr, i32 } [ %.pn37.i.i, %bb.sk ], [ %i.baw, %bb.th ], [ %i.bal, %bb.sz ], [ %i.bau, %bb.te ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.aq), !noalias !1988
  br label %bb.sl
...
bb.ti:                                            ; preds = %bb.tk, %bb.tf
  %.pn.i.i = phi { ptr, ptr } [ %i.bay, %bb.tk ], [ %i.bak, %bb.tf ]
  %.sroa.5.0.copyload.pn.i.i = phi ptr [ %.sroa.5.0.copyload.i.i680, %bb.tk ], [ %i.bav, %bb.tf ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.aq), !noalias !1988
  br label %bb.sn

bb.tj:                                            ; preds = %bb.tm, %bb.sz, %bb.ss, %bb.sm
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8endpoint22SharedEndpointResolverECs9rVkZwOUgsI_13deltalake_aws.exit93.i.i: ; preds = %bb.so, %bb.sn
...
bb.tl:                                            ; preds = %bb.tm, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8endpoint22SharedEndpointResolverECs9rVkZwOUgsI_13deltalake_aws.exit.i.i675
  store i8 0, ptr %i.axe, align 8, !noalias !1988
  call void @llvm.lifetime.end.p0(ptr nonnull %i.bi), !noalias !1988
  store i8 2, ptr %i.aui, align 1, !noalias !1988
  br label %.body.i676

bb.tm:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8endpoint22SharedEndpointResolverECs9rVkZwOUgsI_13deltalake_aws.exit.i.i675
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8identity8IdentityECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef align 8 dereferenceable(96) %i.bi) #24
          to label %bb.tl unwind label %bb.tj, !noalias !1992

bb.tn:                                            ; preds = %bb.sq, %bb.sp
  %i.baz = landingpad { ptr, i32 }
          cleanup
  br label %.body.i676

.body.i676:                                       ; preds = %bb.tn, %bb.tl
  %eh.lpad-body.i = phi { ptr, i32 } [ %i.baz, %bb.tn ], [ %.pn47.i.i, %bb.tl ]
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCscTw95cGIolY_7tracing4span7EnteredECs9rVkZwOUgsI_13deltalake_aws(ptr nonnull align 8 %i.atv) #24
          to label %.body693 unwind label %bb.ts, !noalias !1987

bb.to:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8endpoint22SharedEndpointResolverECs9rVkZwOUgsI_13deltalake_aws.exit97.i.i, %bb.su
  %.sroa.91012.0 = phi ptr [ undef, %bb.su ], [ %.sroa.5.1.i.i, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8endpoint22SharedEndpointResolverECs9rVkZwOUgsI_13deltalake_aws.exit97.i.i ] ; 2 uses
  %.sroa.71011.0 = phi ptr [ undef, %bb.su ], [ %.sroa.010.1.i.i, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8endpoint22SharedEndpointResolverECs9rVkZwOUgsI_13deltalake_aws.exit97.i.i ] ; 2 uses
  %.sroa.01010.0 = phi i1 [ true, %bb.su ], [ false, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8endpoint22SharedEndpointResolverECs9rVkZwOUgsI_13deltalake_aws.exit97.i.i ]
  %storemerge.i.i = phi i8 [ 3, %bb.su ], [ 1, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client8endpoint22SharedEndpointResolverECs9rVkZwOUgsI_13deltalake_aws.exit97.i.i ]
  ...
  br i1 %.not.i.i.i.i, label %.noexc691, label %bb.tp
...
bb.tp:                                            ; preds = %bb.to
  ...
  invoke void @_RNvMs2_NtCs2y6mmZ7bjoM_12tracing_core10dispatcherNtB5_8Dispatch4exit(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(40) %i.atv, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(8) %i.bbb)
          to label %.noexc691 unwind label %bb.tt

.noexc691:                                        ; preds = %bb.tp, %bb.to
  ...
  br i1 %i.bbd, label %bb.tq, label %_RNvXs0_NtCscTw95cGIolY_7tracing10instrumentINtB5_12InstrumentedNCNvNtNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator9endpoints20orchestrate_endpoint0ENtNtNtCsbvkFyIu7lgC_4core6future6future6Future4pollCs9rVkZwOUgsI_13deltalake_aws.exit

bb.tq:                                            ; preds = %.noexc691
  ...
  br i1 %.not4.i.i.i.i, label %_RNvXs0_NtCscTw95cGIolY_7tracing10instrumentINtB5_12InstrumentedNCNvNtNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator9endpoints20orchestrate_endpoint0ENtNtNtCsbvkFyIu7lgC_4core6future6future6Future4pollCs9rVkZwOUgsI_13deltalake_aws.exit, label %bb.tr
...
bb.tr:                                            ; preds = %bb.tq
  ...
  invoke fastcc void @_RNvMNtCscTw95cGIolY_7tracing4spanNtB2_4Span3log(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(40) %i.atv, ptr noalias noundef nonnull readonly captures(address, read_provenance) @135, i64 noundef 21, ptr noundef nonnull @134, ptr noundef nonnull %i.ah) #27
          to label %.noexc692 unwind label %bb.tt

.noexc692:                                        ; preds = %bb.tr
...
bb.ts:                                            ; preds = %.body.i676
  %i.bbl = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #25, !noalias !1987
  unreachable

bb.tt:                                            ; preds = %bb.pw, %bb.tr, %bb.tp, %bb.pu
  %i.bbm = landingpad { ptr, i32 }
          cleanup
  br label %.body693

_RNvXs0_NtCscTw95cGIolY_7tracing10instrumentINtB5_12InstrumentedNCNvNtNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator9endpoints20orchestrate_endpoint0ENtNtNtCsbvkFyIu7lgC_4core6future6future6Future4pollCs9rVkZwOUgsI_13deltalake_aws.exit: ; preds = %.noexc692, %bb.tq, %.noexc691
  br i1 %.sroa.01010.0, label %bb.tu, label %bb.tv

bb.tu:                                            ; preds = %_RNvXs0_NtCscTw95cGIolY_7tracing10instrumentINtB5_12InstrumentedNCNvNtNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator9endpoints20orchestrate_endpoint0ENtNtNtCsbvkFyIu7lgC_4core6future6future6Future4pollCs9rVkZwOUgsI_13deltalake_aws.exit
...
bb.tw:                                            ; preds = %bb.tv
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCscTw95cGIolY_7tracing4span4SpanECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull align 8 dereferenceable(40) %i.atv) #24
          to label %.body696 unwind label %bb.ty
...
bb.tx:                                            ; preds = %bb.tv
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCscTw95cGIolY_7tracing4span4SpanECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull align 8 dereferenceable(40) %i.atv)
          to label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCscTw95cGIolY_7tracing10instrument12InstrumentedNCNvNtNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator9endpoints20orchestrate_endpoint0EECs9rVkZwOUgsI_13deltalake_aws.exit unwind label %bb.tz
...
bb.tz:                                            ; preds = %bb.ua, %bb.tx
  %i.bbp = landingpad { ptr, i32 }
          cleanup
  br label %.body696

_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCscTw95cGIolY_7tracing10instrument12InstrumentedNCNvNtNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator9endpoints20orchestrate_endpoint0EECs9rVkZwOUgsI_13deltalake_aws.exit: ; preds = %bb.tx
  %.not.i698 = icmp eq ptr %.sroa.71011.0, null
  br i1 %.not.i698, label %_RINvMNtCsbvkFyIu7lgC_4core6resultINtB3_6ResultuINtNtCs6Po7BT7Nknu_5alloc5boxed3BoxDNtNtB5_5error5ErrorNtNtB5_6marker4SyncNtB1E_4SendEL_EE7map_errINtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client12orchestrator17OrchestratorErrorNtNtNtB2o_12interceptors7context5ErrorEINvMs0_B2m_B2j_5otherBJ_EECs9rVkZwOUgsI_13deltalake_aws.exit700.thread, label %bb.ua

bb.ua:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCscTw95cGIolY_7tracing10instrument12InstrumentedNCNvNtNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator9endpoints20orchestrate_endpoint0EECs9rVkZwOUgsI_13deltalake_aws.exit
...
bb.ub:                                            ; preds = %_RINvMNtCsbvkFyIu7lgC_4core6resultINtB3_6ResultuINtNtCs6Po7BT7Nknu_5alloc5boxed3BoxDNtNtB5_5error5ErrorNtNtB5_6marker4SyncNtB1E_4SendEL_EE7map_errINtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client12orchestrator17OrchestratorErrorNtNtNtB2o_12interceptors7context5ErrorEINvMs0_B2m_B2j_5otherBJ_EECs9rVkZwOUgsI_13deltalake_aws.exit700.thread, %bb.nl
...
bb.ud:                                            ; preds = %bb.ub
  %i.bca = load i64, ptr %i.kr, align 8, !range !22, !noundef !7
  %.not79 = icmp eq i64 %i.bca, -9223372036854775807
  br i1 %.not79, label %bb.ue, label %bb.ado
...
bb.ug:                                            ; preds = %bb.ue
  %i.bci = load i64, ptr %i.kh, align 8, !range !22, !noundef !7
  %.not80 = icmp eq i64 %i.bci, -9223372036854775807
  br i1 %.not80, label %bb.uh, label %bb.aco
...
bb.uh:                                            ; preds = %bb.ug
  ...
  %i.bcn = invoke { ptr, ptr } @_RNvNtNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator4auth12sign_request(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.bcj, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(96) %0, ptr noalias noundef nonnull align 8 dereferenceable(1160) %i.bck, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(392) %i.bcl, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(80) %i.bcm)
          to label %bb.uj unwind label %bb.ui     ; 2 uses
...
bb.apa:                                           ; preds = %.body.i.i.i.i, %bb.aqg, %bb.aqb
  %.pn7.pn.i.i.i.i = phi { ptr, i32 } [ %.pn5.i.i.i.i, %bb.aqg ], [ %i.ckp, %bb.aqb ], [ %.pn3.i.i.i.i, %.body.i.i.i.i ]
  ...
  br i1 %i.cjq, label %bb.aqm, label %bb.aox

bb.apb:                                           ; preds = %_RNvMNtCscTw95cGIolY_7tracing4spanNtB2_4Span8do_enter.exit.i.i.i
  invoke void @_RNvNtNtCsbvkFyIu7lgC_4core9panicking11panic_const28panic_const_async_fn_resumed(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @122) #28
          to label %.noexc.i.i.i unwind label %bb.aqn, !noalias !2455

.noexc.i.i.i:                                     ; preds = %bb.apb
  unreachable

bb.apc:                                           ; preds = %_RNvMNtCscTw95cGIolY_7tracing4spanNtB2_4Span8do_enter.exit.i.i.i
  invoke void @_RNvNtNtCsbvkFyIu7lgC_4core9panicking11panic_const34panic_const_async_fn_resumed_panic(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @122) #28
          to label %.noexc2.i.i.i unwind label %bb.aqn, !noalias !2455

.noexc2.i.i.i:                                    ; preds = %bb.apc
  unreachable

bb.apd:                                           ; preds = %_RNvMNtCscTw95cGIolY_7tracing4spanNtB2_4Span8do_enter.exit.i.i.i
...
bb.ape:                                           ; preds = %bb.apd, %.thread.i.i.i.i
  %i.cjr = phi ptr [ %.sroa.8.0..sroa_idx.i.i.i.i, %.thread.i.i.i.i ], [ %.phi.trans.insert.i.i.i.i, %bb.apd ]
...
.body.i.i.i.i.i:                                  ; preds = %bb.aps, %bb.apq, %.body.i.i.i.i.i.i.i.i, %bb.api
  %.pn2.pn.i.i.i.i.i = phi { ptr, i32 } [ %i.ckj, %bb.aps ], [ %eh.lpad-body.i.i.i.i.i.i.i.i, %.body.i.i.i.i.i.i.i.i ], [ %i.cjx, %bb.api ], [ %i.ckh, %bb.apq ]
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs2DiVQAxFeQE_16aws_smithy_types4body7SdkBodyECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef align 8 dereferenceable(120) %i.cju) #24
          to label %bb.apu unwind label %bb.apx, !noalias !2468
...
bb.apf:                                           ; preds = %bb.apd
  invoke void @_RNvNtNtCsbvkFyIu7lgC_4core9panicking11panic_const28panic_const_async_fn_resumed(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @121) #28
          to label %.noexc.i.i.i.i unwind label %bb.apy, !noalias !2463

.noexc.i.i.i.i:                                   ; preds = %bb.apf
  unreachable
...
bb.apg:                                           ; preds = %bb.apd
  invoke void @_RNvNtNtCsbvkFyIu7lgC_4core9panicking11panic_const34panic_const_async_fn_resumed_panic(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @121) #28
          to label %.noexc11.i.i.i.i unwind label %bb.apy, !noalias !2463

.noexc11.i.i.i.i:                                 ; preds = %bb.apg
  unreachable

bb.aph:                                           ; preds = %bb.ape, %bb.apd
  %i.cjv = phi ptr [ %.phi.trans.insert.i.i.i.i, %bb.apd ], [ %i.cjr, %bb.ape ] ; 3 uses
  ...
  invoke void @_RNvXNtNtCs3eCsZ2Mx498_14http_body_util11combinators7collectINtB2_7CollectINtNtCsbvkFyIu7lgC_4core3pin3PinQNtNtCs2DiVQAxFeQE_16aws_smithy_types4body7SdkBodyEENtNtNtB1e_6future6future6Future4pollCs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull sret([128 x i8]) align 8 captures(none) dereferenceable(128) %i.n, ptr noalias noundef nonnull align 8 dereferenceable(136) %i.cjw, ptr noalias noundef nonnull align 8 dereferenceable(32) %1)
          to label %bb.apj unwind label %bb.api, !noalias !2468
...
bb.apk:                                           ; preds = %bb.apj
  ...
  br i1 %i.ckb, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtCs3eCsZ2Mx498_14http_body_util11combinators7collect7CollectINtNtB4_3pin3PinQNtNtCs2DiVQAxFeQE_16aws_smithy_types4body7SdkBodyEEECs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.i.i, label %bb.apl
...
bb.apl:                                           ; preds = %bb.apk
  ...
  invoke void @_RNvXs_NtNtCs6Po7BT7Nknu_5alloc11collections9vec_dequeINtB4_8VecDequeNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull align 8 dereferenceable(32) %i.ckc)
          to label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtCs6Po7BT7Nknu_5alloc11collections9vec_deque8VecDequeNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesEECs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.i.i.i.i.i.i unwind label %bb.apm, !noalias !2468
...
bb.apm:                                           ; preds = %bb.apl
  ...
  invoke void @_RNvXs1_NtCs6Po7BT7Nknu_5alloc7raw_vecINtB5_6RawVecNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull align 8 dereferenceable(32) %i.ckc)
          to label %.body.i.i.i.i.i.i.i.i unwind label %bb.apn, !noalias !2468
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtCs6Po7BT7Nknu_5alloc11collections9vec_deque8VecDequeNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesEECs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.i.i.i.i.i.i: ; preds = %bb.apl
  invoke void @_RNvXs1_NtCs6Po7BT7Nknu_5alloc7raw_vecINtB5_6RawVecNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull align 8 dereferenceable(32) %i.ckc)
          to label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs3eCsZ2Mx498_14http_body_util9collected9CollectedNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesEECs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.i.i.i.i unwind label %bb.apo, !noalias !2468

bb.apo:                                           ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtCs6Po7BT7Nknu_5alloc11collections9vec_deque8VecDequeNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesEECs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.i.i.i.i.i.i
  %i.ckf = landingpad { ptr, i32 }
          cleanup
  br label %.body.i.i.i.i.i.i.i.i

.body.i.i.i.i.i.i.i.i:                            ; preds = %bb.apo, %bb.apm
  %eh.lpad-body.i.i.i.i.i.i.i.i = phi { ptr, i32 } [ %i.ckf, %bb.apo ], [ %i.ckd, %bb.apm ]
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionNtNtNtCs4j34XAPZOn0_4http6header3map9HeaderMapEECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull align 8 dereferenceable(136) %i.cjw) #24
          to label %.body.i.i.i.i.i unwind label %bb.app, !noalias !2468

bb.app:                                           ; preds = %.body.i.i.i.i.i.i.i.i
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs3eCsZ2Mx498_14http_body_util9collected9CollectedNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesEECs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.i.i.i.i: ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtCs6Po7BT7Nknu_5alloc11collections9vec_deque8VecDequeNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesEECs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.i.i.i.i.i.i
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionNtNtNtCs4j34XAPZOn0_4http6header3map9HeaderMapEECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull align 8 dereferenceable(136) %i.cjw)
          to label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtCs3eCsZ2Mx498_14http_body_util11combinators7collect7CollectINtNtB4_3pin3PinQNtNtCs2DiVQAxFeQE_16aws_smithy_types4body7SdkBodyEEECs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.i.i unwind label %bb.apq, !noalias !2468

bb.apq:                                           ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs3eCsZ2Mx498_14http_body_util9collected9CollectedNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesEECs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.i.i.i.i
  %i.ckh = landingpad { ptr, i32 }
          cleanup
  br label %.body.i.i.i.i.i

_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtCs3eCsZ2Mx498_14http_body_util11combinators7collect7CollectINtNtB4_3pin3PinQNtNtCs2DiVQAxFeQE_16aws_smithy_types4body7SdkBodyEEECs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.i.i: ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs3eCsZ2Mx498_14http_body_util9collected9CollectedNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesEECs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.i.i.i.i, %bb.apk
  %i.cki = icmp eq i64 %i.cjy, 4
  br i1 %i.cki, label %bb.apw, label %bb.apr

bb.apr:                                           ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtCs3eCsZ2Mx498_14http_body_util11combinators7collect7CollectINtNtB4_3pin3PinQNtNtCs2DiVQAxFeQE_16aws_smithy_types4body7SdkBodyEEECs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.i.i
  ...
  invoke void @_RNvMNtCs3eCsZ2Mx498_14http_body_util9collectedINtB2_9CollectedNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesE8to_bytesCs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull sret([32 x i8]) align 8 captures(address) dereferenceable(32) %i.l, ptr noalias noundef nonnull align 8 captures(address) dereferenceable(128) %i.m)
          to label %bb.apt unwind label %bb.aps, !noalias !2468
...
bb.apu:                                           ; preds = %bb.apv, %.body.i.i.i.i.i
  %.pn5.i.i.i.i.i = phi { ptr, i32 } [ %i.ckl, %bb.apv ], [ %.pn2.pn.i.i.i.i.i, %.body.i.i.i.i.i ]
  store i8 2, ptr %i.cjv, align 8, !noalias !2464
  br label %.body.i.i.i.i

bb.apv:                                           ; preds = %bb.apw, %bb.apt
...
bb.apx:                                           ; preds = %bb.api, %.body.i.i.i.i.i
  %i.ckn = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #25, !noalias !2468
  unreachable

bb.apy:                                           ; preds = %bb.apg, %bb.apf
...
bb.aqa:                                           ; preds = %bb.apw, %bb.apt
  %.sroa.623.0.ph.i.i.i.i = phi ptr [ %.sroa.022.0.copyload.i.i.i.i.i, %bb.apt ], [ null, %bb.apw ] ; 2 uses
  %.sroa.824.0.ph.i.i.i.i = phi ptr [ %.sroa.324.0.copyload.i.i.i.i.i, %bb.apt ], [ %.sroa.3.0.copyload.i.i.i.i.i, %bb.apw ] ; 3 uses
  %.sroa.925.0.ph.i.i.i.i = phi ptr [ %.sroa.4.0.copyload.i.i.i.i.i, %bb.apt ], [ %.sroa.520.0.copyload.i.i.i.i.i, %bb.apw ] ; 3 uses
  %.sroa.1026.0.ph.i.i.i.i = phi i64 [ %.sroa.529.0.copyload.i.i.i.i.i, %bb.apt ], [ undef, %bb.apw ]
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNCNvNtNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator4http13body_to_bytes0ECs9rVkZwOUgsI_13deltalake_aws(ptr noundef nonnull align 8 %i.ciq)
          to label %bb.aqc unwind label %bb.aqb, !noalias !2463
...
bb.aqc:                                           ; preds = %bb.aqa
  ...
  br i1 %i.ckq, label %bb.aql, label %_RNvXsp_NtCsbvkFyIu7lgC_4core6resultINtB5_6ResultNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesINtNtCs6Po7BT7Nknu_5alloc5boxed3BoxDNtNtB7_5error5ErrorNtNtB7_6marker4SyncNtB2f_4SendEL_EENtNtNtB7_3ops9try_trait3Try6branchCs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.i

_RNvXsp_NtCsbvkFyIu7lgC_4core6resultINtB5_6ResultNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesINtNtCs6Po7BT7Nknu_5alloc5boxed3BoxDNtNtB7_5error5ErrorNtNtB7_6marker4SyncNtB2f_4SendEL_EENtNtNtB7_3ops9try_trait3Try6branchCs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.i: ; preds = %bb.aqc
  ...
  invoke void @_RNvXs2_NtCs2DiVQAxFeQE_16aws_smithy_types4bodyNtB5_7SdkBodyINtNtCsbvkFyIu7lgC_4core7convert4FromNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesE4from(ptr noalias noundef nonnull sret([120 x i8]) align 8 captures(none) dereferenceable(120) %i.o, ptr noalias noundef nonnull align 8 captures(address) dereferenceable(32) %i.p)
          to label %bb.aqe unwind label %bb.aqd, !noalias !2463

bb.aqd:                                           ; preds = %_RNvXsp_NtCsbvkFyIu7lgC_4core6resultINtB5_6ResultNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesINtNtCs6Po7BT7Nknu_5alloc5boxed3BoxDNtNtB7_5error5ErrorNtNtB7_6marker4SyncNtB2f_4SendEL_EENtNtNtB7_3ops9try_trait3Try6branchCs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.i
  %i.ckr = landingpad { ptr, i32 }
          cleanup
  br label %bb.aqg

bb.aqe:                                           ; preds = %_RNvXsp_NtCsbvkFyIu7lgC_4core6resultINtB5_6ResultNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesINtNtCs6Po7BT7Nknu_5alloc5boxed3BoxDNtNtB7_5error5ErrorNtNtB7_6marker4SyncNtB2f_4SendEL_EENtNtNtB7_3ops9try_trait3Try6branchCs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.i
  ...
  invoke void @_RINvNvNtCsbvkFyIu7lgC_4core3ptr25swap_nonoverlapping_bytes26swap_nonoverlapping_chunksKj8_ECs9rVkZwOUgsI_13deltalake_aws(ptr noundef nonnull align 8 dereferenceable(120) %i.o, ptr noundef nonnull align 8 dereferenceable(120) %i.cku, i64 noundef 15)
          to label %_RINvNtCsbvkFyIu7lgC_4core3mem4swapNtNtCs2DiVQAxFeQE_16aws_smithy_types4body7SdkBodyECs9rVkZwOUgsI_13deltalake_aws.exit12.i.i.i.i unwind label %bb.aqf, !noalias !2463
...
_RINvNtCsbvkFyIu7lgC_4core3mem4swapNtNtCs2DiVQAxFeQE_16aws_smithy_types4body7SdkBodyECs9rVkZwOUgsI_13deltalake_aws.exit12.i.i.i.i: ; preds = %bb.aqe
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs2DiVQAxFeQE_16aws_smithy_types4body7SdkBodyECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef align 8 dereferenceable(120) %i.o)
          to label %bb.aqi unwind label %bb.aqh, !noalias !2463

bb.aqg:                                           ; preds = %bb.aqh, %bb.aqd
  %.pn5.i.i.i.i = phi { ptr, i32 } [ %i.ckw, %bb.aqh ], [ %i.ckr, %bb.aqd ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.o), !noalias !2456
  br label %bb.apa

bb.aqh:                                           ; preds = %_RINvNtCsbvkFyIu7lgC_4core3mem4swapNtNtCs2DiVQAxFeQE_16aws_smithy_types4body7SdkBodyECs9rVkZwOUgsI_13deltalake_aws.exit12.i.i.i.i
  %i.ckw = landingpad { ptr, i32 }
          cleanup
  br label %bb.aqg

bb.aqi:                                           ; preds = %_RINvNtCsbvkFyIu7lgC_4core3mem4swapNtNtCs2DiVQAxFeQE_16aws_smithy_types4body7SdkBodyECs9rVkZwOUgsI_13deltalake_aws.exit12.i.i.i.i
  call void @llvm.lifetime.end.p0(ptr nonnull %i.o), !noalias !2456
  br label %bb.aqj

bb.aqj:                                           ; preds = %bb.aql, %bb.aqi
  %.sroa.3.0.i.i.i.i = phi ptr [ %.sroa.925.0.ph.i.i.i.i, %bb.aql ], [ undef, %bb.aqi ]
  %.sroa.0.0.i.i.i.i = phi ptr [ %.sroa.824.0.ph.i.i.i.i, %bb.aql ], [ null, %bb.aqi ]
  %i.ckx = getelementptr inbounds nuw i8, ptr %0, i64 1040
  store i8 0, ptr %i.ckx, align 8, !noalias !2456
  br label %bb.aqo

bb.aqk:                                           ; preds = %bb.aqm, %.body.i.i.i.i
...
.body.i.i.i.i:                                    ; preds = %bb.apy, %bb.apu
  %.pn3.i.i.i.i = phi { ptr, i32 } [ %.pn5.i.i.i.i.i, %bb.apu ], [ %i.cko, %bb.apy ]
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNCNvNtNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator4http13body_to_bytes0ECs9rVkZwOUgsI_13deltalake_aws(ptr noundef nonnull align 8 %i.ciq) #24
          to label %bb.apa unwind label %bb.aqk, !noalias !2463
...
bb.aqm:                                           ; preds = %bb.apa
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs2DiVQAxFeQE_16aws_smithy_types4body7SdkBodyECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef align 8 dereferenceable(120) %i.ckz) #24
          to label %bb.aox unwind label %bb.aqk, !noalias !2463

bb.aqn:                                           ; preds = %bb.apc, %bb.apb
  %i.cla = landingpad { ptr, i32 }
          cleanup
  br label %.body.i.i.i

.body.i.i.i:                                      ; preds = %bb.aqn, %bb.aox
  %eh.lpad-body.i.i.i = phi { ptr, i32 } [ %i.cla, %bb.aqn ], [ %.pn7.pn.i.i.i.i, %bb.aox ]
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCscTw95cGIolY_7tracing4span7EnteredECs9rVkZwOUgsI_13deltalake_aws(ptr nonnull align 8 %i.cip) #24
          to label %.body66.i.i unwind label %bb.aqs, !noalias !2455

bb.aqo:                                           ; preds = %bb.aqj, %bb.apz
  %.sroa.6.0.i.i = phi ptr [ undef, %bb.apz ], [ %.sroa.0.0.i.i.i.i, %bb.aqj ] ; 2 uses
  %.sroa.8.0.i.i = phi ptr [ undef, %bb.apz ], [ %.sroa.3.0.i.i.i.i, %bb.aqj ] ; 2 uses
  %storemerge.i.i.i.i = phi i8 [ 3, %bb.apz ], [ 1, %bb.aqj ]
  ...
  br i1 %.not.i.i.i.i.i.i, label %.noexc64.i.i, label %bb.aqp
...
bb.aqp:                                           ; preds = %bb.aqo
  ...
  invoke void @_RNvMs2_NtCs2y6mmZ7bjoM_12tracing_core10dispatcherNtB5_8Dispatch4exit(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(40) %i.cip, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(8) %i.clc)
          to label %.noexc64.i.i unwind label %bb.aqt, !noalias !2403

.noexc64.i.i:                                     ; preds = %bb.aqp, %bb.aqo
  ...
  br i1 %i.cle, label %bb.aqq, label %_RNvXs0_NtCscTw95cGIolY_7tracing10instrumentINtB5_12InstrumentedNCNvNtNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator4http9read_body0ENtNtNtCsbvkFyIu7lgC_4core6future6future6Future4pollCs9rVkZwOUgsI_13deltalake_aws.exit.i.i

bb.aqq:                                           ; preds = %.noexc64.i.i
  ...
  br i1 %.not4.i.i.i.i.i.i, label %_RNvXs0_NtCscTw95cGIolY_7tracing10instrumentINtB5_12InstrumentedNCNvNtNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator4http9read_body0ENtNtNtCsbvkFyIu7lgC_4core6future6future6Future4pollCs9rVkZwOUgsI_13deltalake_aws.exit.i.i, label %bb.aqr
...
bb.aqr:                                           ; preds = %bb.aqq
  ...
  invoke fastcc void @_RNvMNtCscTw95cGIolY_7tracing4spanNtB2_4Span3log(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(40) %i.cip, ptr noalias noundef nonnull readonly captures(address, read_provenance) @135, i64 noundef 21, ptr noundef nonnull @134, ptr noundef nonnull %i.j) #27
          to label %.noexc65.i.i unwind label %bb.aqt

.noexc65.i.i:                                     ; preds = %bb.aqr
...
bb.aqs:                                           ; preds = %.body.i.i.i
  %i.clm = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #25, !noalias !2455
  unreachable

bb.aqt:                                           ; preds = %bb.aow, %bb.aqr, %bb.aqp, %bb.aou
  %i.cln = landingpad { ptr, i32 }
          cleanup
  br label %.body66.i.i

_RNvXs0_NtCscTw95cGIolY_7tracing10instrumentINtB5_12InstrumentedNCNvNtNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator4http9read_body0ENtNtNtCsbvkFyIu7lgC_4core6future6future6Future4pollCs9rVkZwOUgsI_13deltalake_aws.exit.i.i: ; preds = %.noexc65.i.i, %bb.aqq, %.noexc64.i.i
  br i1 %i.cjz, label %bb.aqu, label %bb.aqv

bb.aqu:                                           ; preds = %_RNvXs0_NtCscTw95cGIolY_7tracing10instrumentINtB5_12InstrumentedNCNvNtNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator4http9read_body0ENtNtNtCsbvkFyIu7lgC_4core6future6future6Future4pollCs9rVkZwOUgsI_13deltalake_aws.exit.i.i
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.011.i)
  br label %bb.aru

bb.aqv:                                           ; preds = %_RNvXs0_NtCscTw95cGIolY_7tracing10instrumentINtB5_12InstrumentedNCNvNtNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator4http9read_body0ENtNtNtCsbvkFyIu7lgC_4core6future6future6Future4pollCs9rVkZwOUgsI_13deltalake_aws.exit.i.i
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCscTw95cGIolY_7tracing10instrument12InstrumentedNCNvNtNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator4http9read_body0EECs9rVkZwOUgsI_13deltalake_aws(ptr noundef nonnull align 8 %i.cip)
          to label %bb.aqx unwind label %bb.aqw, !noalias !2403
...
bb.aqx:                                           ; preds = %bb.aqv
  ...
  br i1 %.not.i68.i.i, label %bb.aqz, label %bb.aqy
...
bb.aqz:                                           ; preds = %bb.aqx
  ...
  br i1 %i.clw, label %bb.ara, label %bb.arg
...
bb.arb:                                           ; preds = %bb.ara
  %i.cly = invoke noundef i8 @_RNvMNtCs2y6mmZ7bjoM_12tracing_core8callsiteNtB2_15DefaultCallsite8register(ptr noundef nonnull align 8 @_RNvNCNCNCNvNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator11try_attempt00010___CALLSITE) #26
          to label %.noexc75.i.i905 unwind label %bb.ars, !noalias !2403 ; 2 uses

.noexc75.i.i905:                                  ; preds = %bb.arb
  %.not.i.i74.i.i = icmp eq i8 %i.cly, 0
  br i1 %.not.i.i74.i.i, label %bb.arg, label %bb.arc

bb.arc:                                           ; preds = %bb.ara, %.noexc75.i.i905, %bb.ara
  %.sroa.05.0.i.i.i.i = phi i8 [ %i.cly, %.noexc75.i.i905 ], [ %i.clx, %bb.ara ], [ %i.clx, %bb.ara ]
  ...
  %i.cma = invoke noundef zeroext i1 @_RNvNtCscTw95cGIolY_7tracing15___macro_support12___is_enabled(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(120) %i.clz, i8 noundef %.sroa.05.0.i.i.i.i)
          to label %.noexc76.i.i903 unwind label %bb.ars, !noalias !2403

.noexc76.i.i903:                                  ; preds = %bb.arc
  br i1 %i.cma, label %bb.ard, label %bb.arg

bb.ard:                                           ; preds = %.noexc76.i.i903
  ...
  invoke void @_RNvMNtCscTw95cGIolY_7tracing4spanNtB2_4Span3new(ptr noalias noundef nonnull sret([40 x i8]) align 8 captures(address) dereferenceable(40) %i.h, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(120) %i.cmb, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(32) %i.g)
          to label %.noexc77.i.i904 unwind label %bb.ars, !noalias !2403

.noexc77.i.i904:                                  ; preds = %bb.ard
  call void @llvm.lifetime.end.p0(ptr nonnull %i.g), !noalias !2490
  br label %bb.arj

bb.are:                                           ; preds = %bb.ari, %bb.arg
...
bb.arf:                                           ; preds = %bb.arh
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCscTw95cGIolY_7tracing4span4SpanECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef align 8 dereferenceable(40) %i.f) #24
          to label %.body78.i.i unwind label %bb.arp, !noalias !2495

bb.arg:                                           ; preds = %.noexc76.i.i903, %.noexc75.i.i905, %bb.ara, %bb.aqz
  ...
  br i1 %i.cmi, label %bb.arh, label %bb.are
