...
bb.d:                                             ; preds = %bb.c
  ...
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #38, !noalias !6486
  unreachable
...
bb.d:                                             ; preds = %bb.b
  ...
  %i.r = call noundef i32 @PyList_SetItem(ptr noundef %i.q, i64 noundef %.sroa.0.029, ptr noundef nonnull %.sroa.4.8.copyload.i) #39, !noalias !6515 ; 0 uses
...
bb.d:                                             ; preds = %bb.b
  %i.l = landingpad { ptr, i32 }
          cleanup
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtCs6Po7BT7Nknu_5alloc3vec13in_place_drop11InPlaceDropNtNtCshCk07IZuEAL_24datafusion_physical_expr10projection14ProjectionExprEECs7p2uQeJxui2_9deltalake(ptr noalias noundef align 8 dereferenceable(16) %i.b) #37
          to label %bb.c unwind label %bb.e, !noalias !6973

bb.e:                                             ; preds = %bb.d
  %i.m = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #38, !noalias !6973
  unreachable
...
bb.d:                                             ; preds = %bb.b
  ...
  %i.r = call noundef i32 @PyList_SetItem(ptr noundef %i.q, i64 noundef %.sroa.0.029, ptr noundef nonnull %.sroa.4.8.copyload.i) #39, !noalias !6996 ; 0 uses
  %i.s = add i64 %.sroa.0.029, 1
...
bb.d:                                             ; preds = %bb.b
  ...
  %i.r = call noundef i32 @PyList_SetItem(ptr noundef %i.q, i64 noundef %.sroa.0.029, ptr noundef nonnull %.sroa.4.8.copyload.i) #39, !noalias !7027 ; 0 uses
  %i.s = add i64 %.sroa.0.029, 1
