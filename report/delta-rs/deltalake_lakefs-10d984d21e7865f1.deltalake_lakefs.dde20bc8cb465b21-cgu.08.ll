...
.preheader56.split.split.i.i:                     ; preds = %.preheader56.split.split.i.i.preheader, %_RNvNtCsbvkFyIu7lgC_4core3ptr25swap_nonoverlapping_bytes.exit55.i.i
  ...
  %.sroa.010.3.i.i = phi ptr [ %.sroa.010.0.i.i, %.preheader56.split.split.i.i.preheader ], [ %i.cs, %_RNvNtCsbvkFyIu7lgC_4core3ptr25swap_nonoverlapping_bytes.exit55.i.i ] ; 7 uses
  %.sroa.0.2.i.i = phi i64 [ %.sroa.0.0.i.i, %.preheader56.split.split.i.i.preheader ], [ %i.dp, %_RNvNtCsbvkFyIu7lgC_4core3ptr25swap_nonoverlapping_bytes.exit55.i.i ]
  %i.cm = mul i64 %.sroa.016.0.i.i, %indvar86     ; 3 uses
  %i.cn = add i64 %.sroa.016.0.i.i, %i.cm
  %i.co = sub i64 0, %i.cn
  %scevgep88 = getelementptr i8, ptr %.sroa.010.0.i.i, i64 %i.co
  %i.cp = add i64 %.sroa.016.0.i.i, %i.cm
  %i.cq = sub i64 %i.r, %i.cp
  %scevgep89 = getelementptr i8, ptr %.sroa.010.0.i.i, i64 %i.cq
  %i.cr = sub i64 %i.r, %i.cm
  %scevgep90 = getelementptr i8, ptr %.sroa.010.0.i.i, i64 %i.cr
  %i.cs = getelementptr i8, ptr %.sroa.010.3.i.i, i64 %i.i ; 7 uses
...
vector.body99:                                    ; preds = %vector.memcheck85, %vector.body99
  ...
  %i.ct = getelementptr inbounds nuw [8 x i8], ptr %i.cs, i64 %index100 ; 3 uses
  %i.cu = getelementptr inbounds nuw [8 x i8], ptr %.sroa.010.3.i.i, i64 %index100 ; 3 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !175)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !178)
  %i.cv = getelementptr inbounds nuw i8, ptr %i.ct, i64 16 ; 2 uses
  %wide.load101 = load <2 x i64>, ptr %i.ct, align 1, !alias.scope !222, !noalias !225
  %wide.load102 = load <2 x i64>, ptr %i.cv, align 1, !alias.scope !222, !noalias !225
  %i.cw = getelementptr inbounds nuw i8, ptr %i.cu, i64 16 ; 2 uses
  %wide.load103 = load <2 x i64>, ptr %i.cu, align 1, !alias.scope !225, !noalias !175
  %wide.load104 = load <2 x i64>, ptr %i.cw, align 1, !alias.scope !225, !noalias !175
  store <2 x i64> %wide.load103, ptr %i.ct, align 1, !alias.scope !222, !noalias !225
  store <2 x i64> %wide.load104, ptr %i.cv, align 1, !alias.scope !222, !noalias !225
  store <2 x i64> %wide.load101, ptr %i.cu, align 1, !alias.scope !225, !noalias !175
  store <2 x i64> %wide.load102, ptr %i.cw, align 1, !alias.scope !225, !noalias !175
  %index.next105 = add nuw i64 %index100, 4       ; 2 uses
  %i.cx = icmp eq i64 %index.next105, %n.vec98
  br i1 %i.cx, label %middle.block106, label %vector.body99, !llvm.loop !227

middle.block106:                                  ; preds = %vector.body99
  br i1 %cmp.n107, label %_RINvNvNtCsbvkFyIu7lgC_4core3ptr25swap_nonoverlapping_bytes26swap_nonoverlapping_chunksKj8_ECsj34PGqTgg0L_16deltalake_lakefs.exit.i45.i.i, label %.preheader.i40.i.i.preheader110

.preheader.i40.i.i.preheader110:                  ; preds = %vector.memcheck85, %.preheader.i40.i.i.preheader, %middle.block106
  %.sroa.0.04.i.i41.i.i.ph = phi i64 [ 0, %vector.memcheck85 ], [ 0, %.preheader.i40.i.i.preheader ], [ %n.vec98, %middle.block106 ] ; 5 uses
...
.preheader.i40.i.i.prol:                          ; preds = %.preheader.i40.i.i.preheader110
  %i.cy = or disjoint i64 %.sroa.0.04.i.i41.i.i.ph, 1
  %i.cz = getelementptr inbounds nuw [8 x i8], ptr %i.cs, i64 %.sroa.0.04.i.i41.i.i.ph ; 2 uses
  %i.da = getelementptr inbounds nuw [8 x i8], ptr %.sroa.010.3.i.i, i64 %.sroa.0.04.i.i41.i.i.ph ; 2 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !175)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !178)
  %.sroa.0.0.copyload.i.i.i42.i.i.prol = load i64, ptr %i.cz, align 1, !alias.scope !175, !noalias !178
  %.sroa.02.0.copyload.i.i.i43.i.i.prol = load i64, ptr %i.da, align 1, !alias.scope !178, !noalias !175
  store i64 %.sroa.02.0.copyload.i.i.i43.i.i.prol, ptr %i.cz, align 1, !alias.scope !175, !noalias !178
  store i64 %.sroa.0.0.copyload.i.i.i42.i.i.prol, ptr %i.da, align 1, !alias.scope !178, !noalias !175
  br label %.preheader.i40.i.i.prol.loopexit

.preheader.i40.i.i.prol.loopexit:                 ; preds = %.preheader.i40.i.i.prol, %.preheader.i40.i.i.preheader110
  %.sroa.0.04.i.i41.i.i.unr = phi i64 [ %.sroa.0.04.i.i41.i.i.ph, %.preheader.i40.i.i.preheader110 ], [ %i.cy, %.preheader.i40.i.i.prol ]
  %i.db = icmp eq i64 %i.j, %.neg
  br i1 %i.db, label %_RINvNvNtCsbvkFyIu7lgC_4core3ptr25swap_nonoverlapping_bytes26swap_nonoverlapping_chunksKj8_ECsj34PGqTgg0L_16deltalake_lakefs.exit.i45.i.i, label %.preheader.i40.i.i

.preheader.i40.i.i:                               ; preds = %.preheader.i40.i.i.prol.loopexit, %.preheader.i40.i.i
  %.sroa.0.04.i.i41.i.i = phi i64 [ %i.df, %.preheader.i40.i.i ], [ %.sroa.0.04.i.i41.i.i.unr, %.preheader.i40.i.i.prol.loopexit ] ; 4 uses
  %i.dc = add nuw nsw i64 %.sroa.0.04.i.i41.i.i, 1 ; 2 uses
  %i.dd = getelementptr inbounds nuw [8 x i8], ptr %i.cs, i64 %.sroa.0.04.i.i41.i.i ; 2 uses
  %i.de = getelementptr inbounds nuw [8 x i8], ptr %.sroa.010.3.i.i, i64 %.sroa.0.04.i.i41.i.i ; 2 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !175)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !178)
  %.sroa.0.0.copyload.i.i.i42.i.i = load i64, ptr %i.dd, align 1, !alias.scope !175, !noalias !178
  %.sroa.02.0.copyload.i.i.i43.i.i = load i64, ptr %i.de, align 1, !alias.scope !178, !noalias !175
  store i64 %.sroa.02.0.copyload.i.i.i43.i.i, ptr %i.dd, align 1, !alias.scope !175, !noalias !178
  store i64 %.sroa.0.0.copyload.i.i.i42.i.i, ptr %i.de, align 1, !alias.scope !178, !noalias !175
  %i.df = add nuw nsw i64 %.sroa.0.04.i.i41.i.i, 2 ; 2 uses
  %i.dg = getelementptr inbounds nuw [8 x i8], ptr %i.cs, i64 %i.dc ; 2 uses
  %i.dh = getelementptr inbounds nuw [8 x i8], ptr %.sroa.010.3.i.i, i64 %i.dc ; 2 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !228)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !230)
  %.sroa.0.0.copyload.i.i.i42.i.i.1 = load i64, ptr %i.dg, align 1, !alias.scope !228, !noalias !230
  %.sroa.02.0.copyload.i.i.i43.i.i.1 = load i64, ptr %i.dh, align 1, !alias.scope !230, !noalias !228
  store i64 %.sroa.02.0.copyload.i.i.i43.i.i.1, ptr %i.dg, align 1, !alias.scope !228, !noalias !230
  store i64 %.sroa.0.0.copyload.i.i.i42.i.i.1, ptr %i.dh, align 1, !alias.scope !230, !noalias !228
  %exitcond.not.i.i44.i.i.1 = icmp eq i64 %i.df, %i.j
...
_RINvNvNtCsbvkFyIu7lgC_4core3ptr25swap_nonoverlapping_bytes26swap_nonoverlapping_chunksKj8_ECsj34PGqTgg0L_16deltalake_lakefs.exit.i45.i.i: ; preds = %.preheader.i40.i.i.prol.loopexit, %.preheader.i40.i.i, %middle.block106, %.preheader56.split.split.i.i
  %i.di = getelementptr inbounds nuw i8, ptr %i.cs, i64 %i.l ; 4 uses
  %i.dj = getelementptr inbounds nuw i8, ptr %.sroa.010.3.i.i, i64 %i.l ; 4 uses
...
bb.o:                                             ; preds = %_RINvNvNtCsbvkFyIu7lgC_4core3ptr25swap_nonoverlapping_bytes26swap_nonoverlapping_chunksKj8_ECsj34PGqTgg0L_16deltalake_lakefs.exit.i45.i.i
  ...
  %.sroa.0.0.copyload.i.i5.i47.i.i = load i32, ptr %i.di, align 1, !alias.scope !233, !noalias !236
  %.sroa.02.0.copyload.i.i6.i48.i.i = load i32, ptr %i.dj, align 1, !alias.scope !236, !noalias !233
  store i32 %.sroa.02.0.copyload.i.i6.i48.i.i, ptr %i.di, align 1, !alias.scope !233, !noalias !236
  store i32 %.sroa.0.0.copyload.i.i5.i47.i.i, ptr %i.dj, align 1, !alias.scope !236, !noalias !233
  br label %bb.p
...
bb.q:                                             ; preds = %bb.p
  ...
  %i.dl = getelementptr inbounds nuw i8, ptr %i.dj, i64 %.sroa.0.0.i.i49.i.i ; 2 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !238)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !241)
  %.sroa.0.0.copyload.i9.i.i50.i.i = load i16, ptr %i.dk, align 1, !alias.scope !238, !noalias !241
  %.sroa.02.0.copyload.i10.i.i51.i.i = load i16, ptr %i.dl, align 1, !alias.scope !241, !noalias !238
  store i16 %.sroa.02.0.copyload.i10.i.i51.i.i, ptr %i.dk, align 1, !alias.scope !238, !noalias !241
  store i16 %.sroa.0.0.copyload.i9.i.i50.i.i, ptr %i.dl, align 1, !alias.scope !241, !noalias !238
  %i.dm = or disjoint i64 %.sroa.0.0.i.i49.i.i, 2
  br label %bb.r

bb.r:                                             ; preds = %bb.q, %bb.p
  %.sroa.0.1.i.i52.i.i = phi i64 [ %.sroa.0.0.i.i49.i.i, %bb.p ], [ %i.dm, %bb.q ] ; 2 uses
...
bb.s:                                             ; preds = %bb.r
  ...
  %i.do = getelementptr inbounds nuw i8, ptr %i.dj, i64 %.sroa.0.1.i.i52.i.i ; 2 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !243)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !246)
  %.sroa.0.0.copyload.i11.i.i53.i.i = load i8, ptr %i.dn, align 1, !alias.scope !243, !noalias !246
  %.sroa.02.0.copyload.i12.i.i54.i.i = load i8, ptr %i.do, align 1, !alias.scope !246, !noalias !243
  store i8 %.sroa.02.0.copyload.i12.i.i54.i.i, ptr %i.dn, align 1, !alias.scope !243, !noalias !246
  store i8 %.sroa.0.0.copyload.i11.i.i53.i.i, ptr %i.do, align 1, !alias.scope !246, !noalias !243
