...
begin_hunk_0_@_RNCINvMs6_NtNtCs95DO3lnzZ3L_4moka6future5cacheINtB8_5CacheNtNtCs6Po7BT7Nknu_5alloc6string6StringNtNtCsgO8S5jLFugx_23deltalake_catalog_unity6models25TemporaryTableCredentialsE28try_insert_with_hash_and_funNCNvMs3_NtB1A_10datafusionNtB3o_19UnitySchemaProvider9get_creds0NtB1A_17UnityCatalogErrorE0B1A_:bb.a
  ...
  %i.ajh = invoke fastcc noundef ptr @_RNvNtCsee2lL6QbnsJ_15crossbeam_epoch7default3pin()
          to label %bb.mc unwind label %bb.mb, !noalias !1758 ; 7 uses
...
bb.mc:                                            ; preds = %bb.jp
  ...
  invoke void @_RNvMNtCsee2lL6QbnsJ_15crossbeam_epoch5guardNtB2_5Guard5flush(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(8) %i.i)
          to label %3 unwind label %bb.md, !noalias !1758

bb.md:                                            ; preds = %bb.mc
  %i.aou = landingpad { ptr, i32 }
          cleanup
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCsee2lL6QbnsJ_15crossbeam_epoch5guard5GuardECsgO8S5jLFugx_23deltalake_catalog_unity(ptr %i.ajh) #32
...
bb.qs:                                            ; preds = %bb.qr
  %i.bam = landingpad { ptr, i32 }
          cleanup
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCsee2lL6QbnsJ_15crossbeam_epoch5guard5GuardECsgO8S5jLFugx_23deltalake_catalog_unity(ptr %i.baj) #32
...
bb.rf:                                            ; preds = %bb.re
  %i.bbh = landingpad { ptr, i32 }
          cleanup
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCsee2lL6QbnsJ_15crossbeam_epoch5guard5GuardECsgO8S5jLFugx_23deltalake_catalog_unity(ptr %i.bak) #32
