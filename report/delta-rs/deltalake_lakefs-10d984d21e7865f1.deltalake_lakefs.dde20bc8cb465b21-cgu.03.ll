...
bb.a:
  ...
  %i.b = icmp eq i64 %4, 0
  br i1 %i.b, label %bb.e, label %bb.b, !prof !90
...
bb.c:                                             ; preds = %bb.b
  %i.e = load i64, ptr %0, align 8, !range !111, !alias.scope !310, !noundef !7 ; 2 uses
  ...
  %.val13.i = load ptr, ptr %i.i, align 8, !alias.scope !310
  call fastcc void @_RNvMs4_NtCs6Po7BT7Nknu_5alloc7raw_vecNtB5_11RawVecInner11finish_growCsj34PGqTgg0L_16deltalake_lakefs(ptr noalias noundef align 8 captures(none) dereferenceable(24) %i.a, i64 %i.e, ptr %.val13.i, i64 noundef %.sroa.0.0.i14.i, i64 noundef range(i64 1, -9223372036854775807) %3, i64 noundef %4), !noalias !310
  %i.j = load i64, ptr %i.a, align 8, !range !313, !noalias !310, !noundef !7
  %i.k = trunc nuw i64 %i.j to i1
  %i.l = getelementptr inbounds nuw i8, ptr %i.a, i64 8 ; 2 uses
  br i1 %i.k, label %bb.d, label %bb.f

bb.d:                                             ; preds = %bb.c
  %i.m = load i64, ptr %i.l, align 8, !range !3, !noalias !310, !noundef !7
  %i.n = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  %i.o = load i64, ptr %i.n, align 8, !noalias !310
...
bb.f:                                             ; preds = %bb.c
  %i.p = load ptr, ptr %i.l, align 8, !noalias !310, !nonnull !7, !noundef !7
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !310
  store ptr %i.p, ptr %i.i, align 8, !alias.scope !310
  %i.q = icmp sgt i64 %.sroa.0.0.i14.i, -1
  tail call void @llvm.assume(i1 %i.q)
  store i64 %.sroa.0.0.i14.i, ptr %0, align 8, !alias.scope !310
  ret void
}
...
bb.a:
  ...
  %i.b = load ptr, ptr %1, align 8, !nonnull !7, !align !110, !noundef !7 ; 4 uses
  ...
  %i.j = load ptr, ptr %i.c, align 8, !alias.scope !314, !noalias !317, !nonnull !7, !noundef !7 ; 3 uses
  %i.k = getelementptr inbounds nuw i8, ptr %i.j, i64 %i.g ; 2 uses
  %i.l = load i8, ptr %i.k, align 1, !noalias !319, !noundef !7
  %i.m = and i8 %i.l, 1
  ...
  %i.t = load i64, ptr %i.s, align 8, !alias.scope !314, !noalias !317, !noundef !7
  %i.u = and i64 %i.t, %i.r
  store i8 %i.q, ptr %i.k, align 1, !noalias !319
  %i.v = getelementptr i8, ptr %i.j, i64 %i.u
  %i.w = getelementptr i8, ptr %i.v, i64 16
  store i8 %i.q, ptr %i.w, align 1, !noalias !319
  %i.x = load <2 x i64>, ptr %i.o, align 8, !alias.scope !314, !noalias !317
  %i.y = insertelement <2 x i64> <i64 poison, i64 -1>, i64 %i.n, i64 0
  %i.z = sub <2 x i64> %i.x, %i.y
  store <2 x i64> %i.z, ptr %i.o, align 8, !alias.scope !314, !noalias !317
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(40) %i.ac, ptr noundef nonnull readonly align 8 dereferenceable(40) %i.a, i64 40, i1 false), !noalias !314
...
bb.a:
  ...
  %i.h = load ptr, ptr %i.c, align 8, !alias.scope !320, !noalias !323, !nonnull !7, !noundef !7 ; 3 uses
  %i.i = getelementptr inbounds nuw i8, ptr %i.h, i64 %i.g ; 2 uses
  %i.j = load i8, ptr %i.i, align 1, !noalias !325, !noundef !7
  %i.k = and i8 %i.j, 1
  ...
  %i.r = load i64, ptr %i.q, align 8, !alias.scope !320, !noalias !323, !noundef !7
  %i.s = and i64 %i.r, %i.p
  store i8 %i.o, ptr %i.i, align 1, !noalias !325
...
bb.a:
  ...
  %i.c = load i64, ptr %0, align 8, !range !111   ; 4 uses
...
6:                                                ; preds = %5, %_RNvMs4_NtCs6Po7BT7Nknu_5alloc7raw_vecNtB5_11RawVecInner14grow_amortizedCsj34PGqTgg0L_16deltalake_lakefs.exit
  %.sroa.06.0 = phi i64 [ %spec.select, %5 ], [ %.sroa.0.0.i14.i, %_RNvMs4_NtCs6Po7BT7Nknu_5alloc7raw_vecNtB5_11RawVecInner14grow_amortizedCsj34PGqTgg0L_16deltalake_lakefs.exit ]
...
bb.g:                                             ; preds = %bb.a, %_RNvMs2_NtCs6Po7BT7Nknu_5alloc7raw_vecNtB5_11RawVecInner10grow_exactCsj34PGqTgg0L_16deltalake_lakefs.exit.i
  ret void
}
