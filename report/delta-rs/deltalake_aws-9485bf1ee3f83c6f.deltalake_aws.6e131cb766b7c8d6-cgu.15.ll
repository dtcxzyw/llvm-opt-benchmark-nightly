...
bb.gx:                                            ; preds = %bb.gk
  ...
  br i1 %i.vu, label %bb.hd, label %bb.gy
...
bb.ha:                                            ; preds = %bb.gy
  ...
  br i1 %i.vw, label %.thread1359, label %bb.hf

.thread1359:                                      ; preds = %bb.ha
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.329.0.i23.i) ]
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.432.0.i24.i) ]
  %.sroa.61092.8..sroa_idx = getelementptr inbounds nuw i8, ptr %i.t, i64 8 ; 2 uses
  invoke void @_RINvMNtNtCs2DiVQAxFeQE_16aws_smithy_types11byte_stream5errorNtB3_5Error9streamingINtNtCs6Po7BT7Nknu_5alloc5boxed3BoxDNtNtCsbvkFyIu7lgC_4core5error5ErrorNtNtB1V_6marker4SyncNtB2s_4SendEL_EECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull sret([24 x i8]) align 8 captures(none) dereferenceable(24) %.sroa.61092.8..sroa_idx, ptr noundef nonnull %.sroa.329.0.i23.i, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(80) %.sroa.432.0.i24.i)
          to label %2 unwind label %bb.gz, !noalias !1381

.body.i:                                          ; preds = %bb.gw, %bb.gu
  %i.vx = phi ptr [ %i.sw, %bb.gu ], [ %i.sp, %bb.gw ]
  %i.vy = phi ptr [ %i.sx, %bb.gu ], [ %i.so, %bb.gw ]
  %i.vz = phi ptr [ %i.sz, %bb.gu ], [ %i.sv, %bb.gw ]
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNCNvMs5_NtCs2DiVQAxFeQE_16aws_smithy_types11byte_streamNtBO_5Inner7collect0ECs9rVkZwOUgsI_13deltalake_aws(ptr noundef nonnull align 8 %i.vz) #23
          to label %bb.fr unwind label %bb.hb, !noalias !1381
...
bb.hc:                                            ; preds = %bb.ft, %bb.fs
  %i.wb = landingpad { ptr, i32 }
          cleanup
  br label %.body738

bb.hd:                                            ; preds = %bb.gx, %.thread.i
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.10.i)
...
2:                                                ; preds = %.thread1359
  %.sroa.81089.sroa.0.0.copyload1357 = load ptr, ptr %.sroa.61092.8..sroa_idx, align 8, !noalias !1391
  %.sroa.81089.sroa.6.0..sroa.81089.0..sroa_idx1090.sroa_idx1358 = getelementptr inbounds nuw i8, ptr %i.t, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %.sroa.81088.sroa.6, ptr noundef nonnull align 8 dereferenceable(24) %.sroa.81089.sroa.6.0..sroa.81089.0..sroa_idx1090.sroa_idx1358, i64 24, i1 false), !noalias !1391
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.61093.8..sroa_idx, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.61092, i64 16, i1 false), !noalias !1396
  %3 = invoke { ptr, ptr } @_RNvXse_NtNtCs6Po7BT7Nknu_5alloc5boxed7convertINtB7_3BoxDNtNtCsbvkFyIu7lgC_4core5error5ErrorNtNtBW_6marker4SyncNtB1t_4SendEL_EINtNtBW_7convert4FromNtNtNtCs2DiVQAxFeQE_16aws_smithy_types11byte_stream5error5ErrorE4fromCs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull align 8 captures(address) dereferenceable(24) %i.q)
          to label %bb.pn unwind label %bb.he     ; 2 uses
...
bb.hg:                                            ; preds = %bb.hf
  ...
  invoke void %i.wf(ptr noalias noundef nonnull sret([32 x i8]) align 8 captures(address) dereferenceable(32) %i.ft, ptr noundef nonnull align 8 %i.wg, ptr noundef %i.wi, i64 noundef %i.wk)
          to label %_RNvXs2_NtCs9Ct3XQYJhun_5bytes5bytesNtB5_5BytesNtNtCsbvkFyIu7lgC_4core5clone5Clone5clone.exit unwind label %bb.hh, !inline_history !1404
...
_RNvXs2_NtCs9Ct3XQYJhun_5bytes5bytesNtB5_5BytesNtNtCsbvkFyIu7lgC_4core5clone5Clone5clone.exit: ; preds = %bb.hg
...
bb.hi:                                            ; preds = %bb.hj, %bb.hh
  %.pn90 = phi { ptr, i32 } [ %i.wm, %bb.hj ], [ %i.wl, %bb.hh ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ft)
  br label %bb.pm

bb.hj:                                            ; preds = %_RNvXs2_NtCs9Ct3XQYJhun_5bytes5bytesNtB5_5BytesNtNtCsbvkFyIu7lgC_4core5clone5Clone5clone.exit
...
bb.hk:                                            ; preds = %_RNvXs2_NtCs9Ct3XQYJhun_5bytes5bytesNtB5_5BytesNtNtCsbvkFyIu7lgC_4core5clone5Clone5clone.exit
  ...
  br i1 %.not.i748, label %bb.hl, label %bb.ho, !prof !16
...
bb.hl:                                            ; preds = %bb.hk
  invoke void @_RNvNtCsbvkFyIu7lgC_4core6option13expect_failed(ptr noalias noundef nonnull readonly captures(address, read_provenance) @40, i64 noundef 9, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @44) #25
          to label %.noexc753 unwind label %bb.hm

.noexc753:                                        ; preds = %bb.hl
  unreachable
...
bb.hp:                                            ; preds = %bb.ho
  ...
  invoke void @_RINvMs0_NtCs2DiVQAxFeQE_16aws_smithy_types12type_erasureNtB6_13TypeErasedBox3newINtNtNtB8_10config_bag5value5ValueNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client12orchestrator17LoadedRequestBodyEECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull sret([48 x i8]) align 8 captures(none) dereferenceable(48) %i.n, ptr noalias noundef nonnull align 8 captures(address) dereferenceable(40) %i.p)
          to label %.noexc754 unwind label %bb.pl

.noexc754:                                        ; preds = %bb.hp
  ...
  invoke void @_RNvMs1_NtCs3gpiEk3WpjL_9hashbrown3mapINtB5_7HashMapNtNtCsbvkFyIu7lgC_4core3any6TypeIdNtNtCs2DiVQAxFeQE_16aws_smithy_types12type_erasure13TypeErasedBoxINtNtBR_4hash18BuildHasherDefaultNtNtNtB1p_10config_bag10typeid_map8IdHasherEE6insertCs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull sret([48 x i8]) align 8 captures(none) dereferenceable(48) %i.o, ptr noalias noundef nonnull align 8 dereferenceable(32) %i.wv, ptr noalias noundef nonnull readonly align 8 captures(address) dereferenceable(16) %i.m, ptr noalias noundef nonnull align 8 captures(address) dereferenceable(48) %i.n)
          to label %.noexc755 unwind label %bb.pl
...
.noexc755:                                        ; preds = %.noexc754
  ...
  br i1 %i.wx, label %bb.hr, label %bb.hq

bb.hq:                                            ; preds = %.noexc755
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs2DiVQAxFeQE_16aws_smithy_types12type_erasure13TypeErasedBoxECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull align 8 dereferenceable(48) %i.o)
          to label %bb.hr unwind label %bb.pl

bb.hr:                                            ; preds = %.noexc755, %bb.hq
...
bb.hv:                                            ; preds = %bb.ht
  %i.xj = load i64, ptr %i.fj, align 8, !range !666, !noundef !14
  %.not97 = icmp eq i64 %i.xj, -9223372036854775807
  br i1 %.not97, label %bb.hw, label %bb.ol
...
bb.hy:                                            ; preds = %bb.hw
  %i.xr = load i64, ptr %i.ez, align 8, !range !666, !noundef !14
  %.not98 = icmp eq i64 %i.xr, -9223372036854775807
  br i1 %.not98, label %bb.hz, label %bb.nl
...
bb.hz:                                            ; preds = %bb.hy
  ...
  br i1 %i.xw, label %bb.ia, label %bb.ib
...
bb.ib:                                            ; preds = %bb.hz
  ...
  invoke void @_RNvXs0_NtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client7retriesNtB5_19SharedRetryStrategyNtB5_13RetryStrategy30should_attempt_initial_request(ptr noalias noundef nonnull sret([24 x i8]) align 8 captures(address) dereferenceable(24) %i.xz, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %i.ey, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(392) %i.xx, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(80) %i.xy)
          to label %bb.ie unwind label %bb.ic
...
bb.op:                                            ; preds = %bb.on, %bb.om
  %.sroa.0.0.i826 = phi i8 [ %i.aiz, %bb.om ], [ %i.ajb, %bb.on ] ; 2 uses
  %i.ajd = icmp eq i8 %.sroa.0.0.i826, 0
  br i1 %i.ajd, label %bb.ot, label %bb.or
...
bb.or:                                            ; preds = %bb.op
  ...
  %i.ajg = invoke noundef zeroext i1 @_RNvNtCscTw95cGIolY_7tracing15___macro_support12___is_enabled(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(120) %i.ajf, i8 noundef %.sroa.0.0.i826)
          to label %bb.os unwind label %bb.oq

bb.os:                                            ; preds = %bb.or
  br i1 %i.ajg, label %bb.pd, label %bb.ot

bb.ot:                                            ; preds = %bb.ol, %bb.op, %bb.os
  ...
  br i1 %.not1461, label %bb.ou, label %bb.pg
...
bb.ou:                                            ; preds = %bb.ot
  ...
  br i1 %i.ajk, label %bb.ow, label %bb.pg
...
bb.ox:                                            ; preds = %bb.ow
  ...
  %i.aju = invoke noundef zeroext i1 %i.ajt(ptr noundef %i.ajq, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.fo)
          to label %bb.oz unwind label %bb.oy
...
bb.oz:                                            ; preds = %bb.ox
  br i1 %i.aju, label %bb.pa, label %bb.pg
...
bb.pa:                                            ; preds = %bb.oz
  ...
  %i.ajy = getelementptr inbounds nuw i8, ptr %i.fl, i64 8
  store ptr inttoptr (i64 79 to ptr), ptr %i.ajy, align 8
  store ptr %i.fl, ptr %i.fm, align 8
  %i.ajz = getelementptr inbounds nuw i8, ptr %i.fm, i64 8
  ...
  %i.aka = getelementptr inbounds nuw i8, ptr %i.fn, i64 24
  store ptr %i.ajx, ptr %i.aka, align 8, !alias.scope !1542, !noalias !1545
  invoke void @_RNvNtCscTw95cGIolY_7tracing15___macro_support13___tracing_log(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(120) %i.ajm, ptr noundef nonnull %i.ajq, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(48) %i.ajr, ptr noalias noundef nonnull readonly align 8 captures(none) dereferenceable(24) %i.fo, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(32) %i.fn)
...
bb.pd:                                            ; preds = %bb.os
  ...
  %i.ake = getelementptr inbounds nuw i8, ptr %i.fp, i64 8
  store ptr inttoptr (i64 79 to ptr), ptr %i.ake, align 8
  store ptr %i.fp, ptr %i.fq, align 8
  %i.akf = getelementptr inbounds nuw i8, ptr %i.fq, i64 8
  store ptr @24, ptr %i.akf, align 8
  store i64 1, ptr %i.fr, align 8
  %.sroa.61111.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.fr, i64 8
  store ptr %i.fq, ptr %.sroa.61111.0..sroa_idx, align 8
  %.sroa.71112.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.fr, i64 16
  store i64 1, ptr %.sroa.71112.0..sroa_idx, align 8
  %.sroa.81113.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.fr, i64 24
...
bb.pg:                                            ; preds = %bb.pf, %bb.ot, %bb.ou, %bb.oz, %bb.pc
  ...
  invoke void @_RNvMs2_NtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client12interceptors7contextNtB5_18InterceptorContext4failCs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull align 8 dereferenceable(1160) %i.akh, ptr noalias noundef nonnull align 8 captures(address) dereferenceable(112) %i.fk)
...
bb.pj:                                            ; preds = %bb.ph, %bb.pk
  %.pn288.pn1402 = phi { ptr, i32 } [ %.pn288.pn.ph, %bb.pk ], [ %i.aki, %bb.ph ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.fs)
  br label %bb.dn

bb.pk:                                            ; preds = %bb.pe, %bb.oq, %bb.oo, %bb.oy, %bb.pb, %bb.ov
  %.pn288.pn.ph = phi { ptr, i32 } [ %i.aje, %bb.oq ], [ %i.akg, %bb.pe ], [ %i.ajl, %bb.ov ], [ %i.ajv, %bb.oy ], [ %i.akb, %bb.pb ], [ %i.ajc, %bb.oo ]
  invoke void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client12interceptors5error16InterceptorErrorECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull align 8 dereferenceable(48) %i.fs) #23
          to label %bb.pj unwind label %bb.af

bb.pl:                                            ; preds = %bb.hp, %.noexc754, %bb.hq
  %i.akj = landingpad { ptr, i32 }
          cleanup
  br label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesECs9rVkZwOUgsI_13deltalake_aws.exit

_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesECs9rVkZwOUgsI_13deltalake_aws.exit: ; preds = %bb.he, %bb.ql, %.body738, %bb.pm, %bb.pl
  %.pn300.pn.pn.pn = phi { ptr, i32 } [ %.pn95.ph, %bb.pm ], [ %i.akj, %bb.pl ], [ %.pn300.pn1413, %bb.ql ], [ %i.wc, %bb.he ], [ %.pn87, %.body738 ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.gf)
  br label %bb.ci

bb.pm:                                            ; preds = %bb.hm, %bb.hn, %bb.hi
  %.pn95.ph = phi { ptr, i32 } [ %.pn90, %bb.hi ], [ %i.wq, %bb.hm ], [ %i.wr, %bb.hn ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.fu)
...
bb.pn:                                            ; preds = %2
  %i.akp = extractvalue { ptr, ptr } %3, 0
  %i.akq = extractvalue { ptr, ptr } %3, 1
  ...
  br i1 %i.aks, label %bb.po, label %bb.pv
...
bb.po:                                            ; preds = %bb.pn
  ...
  br i1 %i.aku, label %bb.pr, label %bb.pp, !prof !1223
...
bb.pp:                                            ; preds = %bb.po
  %i.akv = invoke noundef i8 @_RNvMNtCs2y6mmZ7bjoM_12tracing_core8callsiteNtB2_15DefaultCallsite8register(ptr noundef nonnull align 8 @_RNvNCNCNvNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator6try_op00s3_10___CALLSITE) #26
          to label %bb.pr unwind label %bb.pq
...
bb.pr:                                            ; preds = %bb.pp, %bb.po
  %.sroa.0.0.i839 = phi i8 [ %i.akt, %bb.po ], [ %i.akv, %bb.pp ] ; 2 uses
  %i.akx = icmp eq i8 %.sroa.0.0.i839, 0
  br i1 %i.akx, label %bb.pv, label %bb.pt
...
bb.pt:                                            ; preds = %bb.pr
  ...
  %i.ala = invoke noundef zeroext i1 @_RNvNtCscTw95cGIolY_7tracing15___macro_support12___is_enabled(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(120) %i.akz, i8 noundef %.sroa.0.0.i839)
          to label %bb.pu unwind label %bb.ps

bb.pu:                                            ; preds = %bb.pt
  br i1 %i.ala, label %bb.qf, label %bb.pv

bb.pv:                                            ; preds = %bb.pn, %bb.pr, %bb.pu
  ...
  br i1 %.not1460, label %bb.pw, label %bb.qi
...
bb.pw:                                            ; preds = %bb.pv
  ...
  br i1 %i.ale, label %bb.py, label %bb.qi
...
bb.py:                                            ; preds = %bb.pw
  ...
  %i.alj = invoke { ptr, ptr } @_RNvCsaljjC7ZTCQu_3log6logger()
          to label %bb.pz unwind label %bb.px     ; 2 uses
...
bb.pz:                                            ; preds = %bb.py
  ...
  %i.alo = invoke noundef zeroext i1 %i.aln(ptr noundef %i.alk, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.fz)
          to label %bb.qb unwind label %bb.qa
...
bb.qb:                                            ; preds = %bb.pz
  br i1 %i.alo, label %bb.qc, label %bb.qi
...
bb.qf:                                            ; preds = %bb.pu
  ...
  invoke fastcc void @_RNCNCNCNvNtNtCs2HJ6gJZ22Qg_18aws_smithy_runtime6client12orchestrator6try_op00s4_0Cs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef align 8 captures(address) dereferenceable(32) %i.gc)
          to label %bb.qh unwind label %bb.qg
...
bb.qi:                                            ; preds = %bb.qh, %bb.pv, %bb.pw, %bb.qb, %bb.qe
...
bb.ql:                                            ; preds = %bb.qj, %bb.qm
  %.pn300.pn1413 = phi { ptr, i32 } [ %.pn300.pn.ph, %bb.qm ], [ %i.amd, %bb.qj ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.gd)
  br label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs9Ct3XQYJhun_5bytes5bytes5BytesECs9rVkZwOUgsI_13deltalake_aws.exit

bb.qm:                                            ; preds = %bb.qg, %bb.ps, %bb.pq, %bb.qa, %bb.qd, %bb.px
  %.pn300.pn.ph = phi { ptr, i32 } [ %i.aky, %bb.ps ], [ %i.ama, %bb.qg ], [ %i.alf, %bb.px ], [ %i.alp, %bb.qa ], [ %i.alv, %bb.qd ], [ %i.akw, %bb.pq ]
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtCsVcNsP0WZIc_22aws_smithy_runtime_api6client12orchestrator17OrchestratorErrorNtNtNtBL_12interceptors7context5ErrorEECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef align 8 dereferenceable(112) %i.gd) #23
          to label %bb.ql unwind label %bb.af

.body738:                                         ; preds = %bb.hc, %bb.fr
  %i.amf = phi ptr [ %i.su, %bb.fr ], [ %i.so, %bb.hc ]
  %.pn87 = phi { ptr, i32 } [ %.pn4.i, %bb.fr ], [ %i.wb, %bb.hc ]
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.81088.sroa.6)
