...
bb.a:
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.0.val) ]
  %i.a = load i64, ptr %.0.val, align 8, !range !25, !alias.scope !203, !noundef !10
...
bb.em:                                            ; preds = %bb.e
  ...
  %i.fo = load i64, ptr %.val3, align 8, !range !25, !alias.scope !509, !noundef !10
...
bb.a:
  ...
  %i.g = load i64, ptr %i.f, align 8, !range !25, !alias.scope !784, !noalias !781, !noundef !10 ; 2 uses
...
bb.d:                                             ; preds = %bb.b
  %i.q = load i8, ptr %i.o, align 8, !range !26, !noalias !791, !noundef !10
...
bb.g:                                             ; preds = %bb.e
  %i.eg = load i8, ptr %i.ch, align 8, !range !26, !noalias !809, !noundef !10
