...
bb.y:                                             ; preds = %bb.w
  ...
  %i.fe = load i64, ptr %i.ca, align 8, !range !120, !alias.scope !6935, !noalias !6937, !noundef !8 ; 3 uses
...
begin_hunk_3_@_RNCNvMs3_NtNtCs8Hz2sPNgbCO_10datafusion9execution7contextNtB7_14SessionContext3sql0Cs2VbMhdeEr66_16delta_benchmarks:bb.a
  ...
  %.sroa.826.i.sroa.0.0.copyload.i = phi i64 [ %i.hx, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtCs6Po7BT7Nknu_5alloc3vec9into_iter8IntoIterNtNtCsjhHCjzi9uUI_17datafusion_common15table_reference14TableReferenceEECs2VbMhdeEr66_16delta_benchmarks.exit75.i.i.i ], [ %i.fe, %bb.ad ]
...
bb.aj:                                            ; preds = %bb.ai
  %i.hx = load i64, ptr %i.bv, align 8, !range !5488, !noalias !6927, !noundef !8 ; 4 uses
...
begin_hunk_5_@_RNCNvMs3_NtNtCs8Hz2sPNgbCO_10datafusion9execution7contextNtB7_14SessionContext3sql0Cs2VbMhdeEr66_16delta_benchmarks:bb.a
  ...
  invoke void @_RNvXsg_NtCs3gpiEk3WpjL_9hashbrown3rawINtB5_8RawTableTNtNtCsjhHCjzi9uUI_17datafusion_common15table_reference22ResolvedTableReferenceINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDNtNtCs8VI8w5SIoU4_15datafusion_expr12table_source11TableSourceEL_EEENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCs2VbMhdeEr66_16delta_benchmarks(ptr noalias noundef nonnull align 8 dereferenceable(48) %i.mw)
          to label %bb.co unwind label %bb.bn, !noalias !6931
...
.thread50.i.i:                                    ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs8Hz2sPNgbCO_10datafusion9execution13session_state22SessionContextProviderECs2VbMhdeEr66_16delta_benchmarks.exit77.i.i.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.826.i.sroa.8.i.a, ptr noundef nonnull align 16 dereferenceable(32) %.sroa.826.i.sroa.8.0..sroa.826.0..sroa_idx2752.i.sroa_idx.i, i64 32, i1 false), !noalias !7035
  %.sroa.826.i.sroa.9.0..sroa.826.0..sroa_idx2752.i.sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.br, i64 48
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(272) %.sroa.826.i.sroa.9.i, ptr noundef nonnull align 16 dereferenceable(272) %.sroa.826.i.sroa.9.0..sroa.826.0..sroa_idx2752.i.sroa_idx.i, i64 272, i1 false), !noalias !7035
  store i8 1, ptr %i.hc, align 8, !noalias !6927
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.by), !noalias !6914
...
bb.co:                                            ; preds = %bb.bm
  ...
  %.sroa.024.0.copyload25.pre.i.i = load i64, ptr %i.br, align 16, !noalias !7035 ; 2 uses
  %.sroa.826.0..sroa_idx27.i.i = getelementptr inbounds nuw i8, ptr %i.br, i64 8
  %.sroa.826.i.sroa.0.0.copyload95.i = load i64, ptr %.sroa.826.0..sroa_idx27.i.i, align 8, !noalias !7035
  %.sroa.826.i.sroa.8.0..sroa.826.0..sroa_idx27.i.sroa_idx.i.a = getelementptr inbounds nuw i8, ptr %i.br, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.826.i.sroa.8.i.a, ptr noundef nonnull align 16 dereferenceable(32) %.sroa.826.i.sroa.8.0..sroa.826.0..sroa_idx27.i.sroa_idx.i.a, i64 32, i1 false), !noalias !7035
  %.sroa.826.i.sroa.9.0..sroa.826.0..sroa_idx27.i.sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.br, i64 48
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(272) %.sroa.826.i.sroa.9.i, ptr noundef nonnull align 16 dereferenceable(272) %.sroa.826.i.sroa.9.0..sroa.826.0..sroa_idx27.i.sroa_idx.i, i64 272, i1 false), !noalias !7035
  store i8 1, ptr %i.gd, align 8, !noalias !6927
  call void @llvm.lifetime.end.p0(ptr nonnull %i.br), !noalias !6914
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.7.i.i.i)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.bx), !noalias !6914
end_hunk_8
begin_hunk_9_@_RNCNvMs3_NtNtCs8Hz2sPNgbCO_10datafusion9execution7contextNtB7_14SessionContext3sql0Cs2VbMhdeEr66_16delta_benchmarks:bb.a
  %i.qj = icmp eq i64 %.sroa.024.0.copyload25.pre.i.i, 37
  br i1 %i.qj, label %bb.cw, label %bb.cp

bb.cp:                                            ; preds = %bb.co, %.thread50.i.i
  %4 = phi ptr [ %i.ga, %bb.co ], [ %i.gz, %.thread50.i.i ] ; 3 uses
  %5 = phi ptr [ %i.gb, %bb.co ], [ %i.ha, %.thread50.i.i ] ; 3 uses
  %6 = phi ptr [ %i.gc, %bb.co ], [ %i.hb, %.thread50.i.i ] ; 3 uses
  %.sroa.826.i.sroa.0.0.i = phi i64 [ %.sroa.826.i.sroa.0.0.copyload95.i, %bb.co ], [ %.sroa.826.i.sroa.0.0.copyload.i, %.thread50.i.i ] ; 2 uses
  %.sroa.024.0.copyload2553.i.i = phi i64 [ %.sroa.024.0.copyload25.pre.i.i, %bb.co ], [ 36, %.thread50.i.i ] ; 2 uses
  %7 = phi ptr [ %i.ge, %bb.co ], [ %i.hd, %.thread50.i.i ]
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.3.i.sroa.5.i, ptr noundef nonnull align 8 dereferenceable(32) %.sroa.826.i.sroa.8.i.a, i64 32, i1 false), !noalias !6914
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(272) %.sroa.3.i.sroa.7.i, ptr noundef nonnull align 8 dereferenceable(272) %.sroa.826.i.sroa.9.i, i64 272, i1 false), !noalias !6914
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNCNvMs_NtNtCs8Hz2sPNgbCO_10datafusion9execution13session_stateNtBN_12SessionState17statement_to_plan0ECs2VbMhdeEr66_16delta_benchmarks(ptr noundef nonnull align 8 %7)
          to label %bb.cr unwind label %bb.cq, !noalias !6918
...
bb.cr:                                            ; preds = %bb.cp
  %i.ql = icmp eq i64 %.sroa.024.0.copyload2553.i.i, 36
  br i1 %i.ql, label %bb.ct, label %bb.cs
...
begin_hunk_11_@_RNCNvMs3_NtNtCs8Hz2sPNgbCO_10datafusion9execution7contextNtB7_14SessionContext3sql0Cs2VbMhdeEr66_16delta_benchmarks:bb.a
          to label %.body16.thread.i unwind label %bb.cu, !noalias !6918

bb.cw:                                            ; preds = %bb.co, %.thread.i.i
  %i.qn = phi ptr [ %i.hr, %.thread.i.i ], [ %i.ga, %bb.co ]
  %i.qo = phi ptr [ %i.ht, %.thread.i.i ], [ %i.gc, %bb.co ]
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.826.i.sroa.8.i.a)
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.826.i.sroa.9.i)
...
begin_hunk_12_@_RNCNvMs3_NtNtCs8Hz2sPNgbCO_10datafusion9execution7contextNtB7_14SessionContext3sql0Cs2VbMhdeEr66_16delta_benchmarks:bb.a
  %i.qp = phi ptr [ %i.dm, %bb.r ], [ %4, %bb.ct ], [ %4, %bb.cs ] ; 7 uses
  %i.qq = phi ptr [ %i.dn, %bb.r ], [ %5, %bb.ct ], [ %5, %bb.cs ] ; 7 uses
  %i.qr = phi ptr [ %i.dr, %bb.r ], [ %6, %bb.ct ], [ %6, %bb.cs ]
  ...
  %.sroa.032.1.i.i = phi i64 [ 36, %bb.r ], [ 36, %bb.ct ], [ %.sroa.024.0.copyload2553.i.i, %bb.cs ] ; 2 uses
...
bb.ov:                                            ; preds = %bb.oy, %bb.ox, %bb.ow, %bb.eu
  ...
  %.sroa.078.0.copyload79.pre.i = load i64, ptr %i.av, align 16, !noalias !7326
  br label %bb.ph
...
bb.pb:                                            ; preds = %bb.ou
  ...
  call void @llvm.experimental.noalias.scope.decl(metadata !7327)
  %i.all = getelementptr inbounds nuw i8, ptr %i.av, i64 8
  store i64 %.sroa.0254.0.copyload255.i.i, ptr %i.all, align 8, !alias.scope !7330, !noalias !7042
  store i64 36, ptr %i.av, align 16, !alias.scope !7332, !noalias !7333
  br label %bb.fi
...
begin_hunk_15_@_RNCNvMs3_NtNtCs8Hz2sPNgbCO_10datafusion9execution7contextNtB7_14SessionContext3sql0Cs2VbMhdeEr66_16delta_benchmarks:bb.a
  %i.alx = phi ptr [ %i.um, %bb.ov ], [ %i.vc, %bb.pe ]
  %i.aly = phi ptr [ %i.un, %bb.ov ], [ %i.vd, %bb.pe ]
  %i.alz = phi ptr [ %i.uo, %bb.ov ], [ %i.ve, %bb.pe ]
  ...
  %.sroa.18.sroa.0.0.copyload.i = load i64, ptr %.sroa.18.0..sroa_idx80.i, align 8, !noalias !7326
  %.sroa.18.sroa.6.0..sroa.18.0..sroa_idx80.sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.av, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.18.sroa.6.i, ptr noundef nonnull align 16 dereferenceable(32) %.sroa.18.sroa.6.0..sroa.18.0..sroa_idx80.sroa_idx.i, i64 32, i1 false), !noalias !7326
  %.sroa.18.sroa.7.0..sroa.18.0..sroa_idx80.sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.av, i64 48
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(288) %.sroa.18.sroa.7.i, ptr noundef nonnull align 16 dereferenceable(288) %.sroa.18.sroa.7.0..sroa.18.0..sroa_idx80.sroa_idx.i, i64 288, i1 false), !noalias !7326
...
begin_hunk_16_@_RNvXsf_NtNtCsbZMnTeWjWd9_9hashbrown3raw5innerINtB5_8RawTableTNtNtCs6Po7BT7Nknu_5alloc6string6StringINtNtCs3JXekYNd0JR_7dashmap4util11SharedValueINtNtB11_4sync3ArcDNtNtCsanCXJAiNsO_18datafusion_catalog5table13TableProviderEL_EEEENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCs2VbMhdeEr66_16delta_benchmarks:bb.a
  ...
  %.pre.i = load ptr, ptr %0, align 8, !alias.scope !9453 ; 4 uses
...
bb.c:                                             ; preds = %bb.b
  %i.g = load <16 x i8>, ptr %.pre.i, align 16, !noalias !9460
...
begin_hunk_17_@_RNvXsf_NtNtCsbZMnTeWjWd9_9hashbrown3raw5innerINtB5_8RawTableTNtNtCs6Po7BT7Nknu_5alloc6string6StringINtNtCs3JXekYNd0JR_7dashmap4util11SharedValueINtNtB11_4sync3ArcDNtNtCsanCXJAiNsO_18datafusion_catalog5table13TableProviderEL_EEEENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCs2VbMhdeEr66_16delta_benchmarks:bb.a
  ...
  %i.at = getelementptr inbounds i8, ptr %.pre.i, i64 %i.as
...
begin_hunk_18_@_RNvXsf_NtNtCsbZMnTeWjWd9_9hashbrown3raw5innerINtB5_8RawTableTNtNtCs6Po7BT7Nknu_5alloc6string6StringINtNtCs3JXekYNd0JR_7dashmap4util11SharedValueINtNtB11_4sync3ArcDNtNtCsanCXJAiNsO_18datafusion_catalog6schema14SchemaProviderEL_EEEENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCs2VbMhdeEr66_16delta_benchmarks:bb.a
  ...
  %i.f = icmp eq i64 %i.e, 0
  %.pre.i = load ptr, ptr %0, align 8, !alias.scope !9500 ; 4 uses
...
bb.c:                                             ; preds = %bb.b
  %i.g = load <16 x i8>, ptr %.pre.i, align 16, !noalias !9507
  %i.h = icmp sgt <16 x i8> %i.g, splat (i8 -1)
  %i.i = getelementptr inbounds nuw i8, ptr %.pre.i, i64 16
  %i.j = bitcast <16 x i1> %i.h to i16
  br label %bb.d
...
!7326 = !{!7045, !6910, !6912}
!7327 = !{!7328}
!7328 = distinct !{!7328, !7329, !"_RNvXsq_NtCsbvkFyIu7lgC_4core6resultINtB5_6ResultNtNtCs8Hz2sPNgbCO_10datafusion9dataframe9DataFrameNtNtCsjhHCjzi9uUI_17datafusion_common5error15DataFusionErrorEINtNtNtB7_3ops9try_trait12FromResidualIBy_NtNtB7_7convert10InfallibleB1y_EE13from_residualCs2VbMhdeEr66_16delta_benchmarks: argument 1"}
!7329 = distinct !{!7329, !"_RNvXsq_NtCsbvkFyIu7lgC_4core6resultINtB5_6ResultNtNtCs8Hz2sPNgbCO_10datafusion9dataframe9DataFrameNtNtCsjhHCjzi9uUI_17datafusion_common5error15DataFusionErrorEINtNtNtB7_3ops9try_trait12FromResidualIBy_NtNtB7_7convert10InfallibleB1y_EE13from_residualCs2VbMhdeEr66_16delta_benchmarks"}
!7330 = !{!7331, !7328}
!7331 = distinct !{!7331, !7329, !"_RNvXsq_NtCsbvkFyIu7lgC_4core6resultINtB5_6ResultNtNtCs8Hz2sPNgbCO_10datafusion9dataframe9DataFrameNtNtCsjhHCjzi9uUI_17datafusion_common5error15DataFusionErrorEINtNtNtB7_3ops9try_trait12FromResidualIBy_NtNtB7_7convert10InfallibleB1y_EE13from_residualCs2VbMhdeEr66_16delta_benchmarks: argument 0"}
!7332 = !{!7331}
!7333 = !{!7328, !7043, !7045, !6910, !6912}
!7334 = !{!6912}
!7335 = !{!7336}
