...
begin_hunk_5_@_RNCNvMs3_NtNtCs8Hz2sPNgbCO_10datafusion9execution7contextNtB7_14SessionContext3sql0Cs2VbMhdeEr66_16delta_benchmarks:bb.a
  ...
  invoke void @_RNvXsg_NtCs3gpiEk3WpjL_9hashbrown3rawINtB5_8RawTableTNtNtCsjhHCjzi9uUI_17datafusion_common15table_reference22ResolvedTableReferenceINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDNtNtCs8VI8w5SIoU4_15datafusion_expr12table_source11TableSourceEL_EEENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCs2VbMhdeEr66_16delta_benchmarks(ptr noalias noundef nonnull align 8 dereferenceable(48) %i.mw)
          to label %bb.cp unwind label %bb.bn, !noalias !6931
...
bb.ck:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs8Hz2sPNgbCO_10datafusion9execution13session_state22SessionContextProviderECs2VbMhdeEr66_16delta_benchmarks.exit77.i.i.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.826.i.sroa.7.i, ptr noundef nonnull align 16 dereferenceable(32) %.sroa.826.i.sroa.8.0..sroa.826.0..sroa_idx2752.i.sroa_idx.i, i64 32, i1 false), !noalias !7035
  %.sroa.826.i.sroa.9.0..sroa.826.0..sroa_idx2752.i.sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.br, i64 48
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(272) %.sroa.826.i.sroa.8.i, ptr noundef nonnull align 16 dereferenceable(272) %.sroa.826.i.sroa.9.0..sroa.826.0..sroa_idx2752.i.sroa_idx.i, i64 272, i1 false), !noalias !7035
...
bb.cp:                                            ; preds = %bb.bm
  ...
  %.sroa.024.0.copyload25.i.i = load i64, ptr %i.br, align 16, !noalias !7035 ; 2 uses
  %.sroa.826.0..sroa_idx27.i.i = getelementptr inbounds nuw i8, ptr %i.br, i64 8
  %.sroa.826.i.sroa.0.0.copyload.i.a = load i64, ptr %.sroa.826.0..sroa_idx27.i.i, align 8, !noalias !7035
...
bb.cq:                                            ; preds = %bb.cp, %bb.ck
  %4 = phi ptr [ %i.ga, %bb.cp ], [ %i.gz, %bb.ck ] ; 3 uses
  %5 = phi ptr [ %i.gb, %bb.cp ], [ %i.ha, %bb.ck ] ; 3 uses
  %6 = phi ptr [ %i.gc, %bb.cp ], [ %i.hb, %bb.ck ] ; 3 uses
  %.sroa.826.i.sroa.0.0.i = phi i64 [ %.sroa.826.i.sroa.0.0.copyload.i.a, %bb.cp ], [ %.sroa.826.i.sroa.0.0.copyload.i, %bb.ck ] ; 2 uses
  %.sroa.024.0.copyload2553.i.i = phi i64 [ %.sroa.024.0.copyload25.i.i, %bb.cp ], [ 36, %bb.ck ] ; 2 uses
  %7 = phi ptr [ %i.ge, %bb.cp ], [ %i.hd, %bb.ck ]
...
bb.cx:                                            ; preds = %bb.cp, %.thread.i.i
  %i.qn = phi ptr [ %i.hr, %.thread.i.i ], [ %i.ga, %bb.cp ]
  %i.qo = phi ptr [ %i.ht, %.thread.i.i ], [ %i.gc, %bb.cp ]
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.826.i.sroa.7.i)
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.826.i.sroa.8.i)
...
begin_hunk_12_@_RNCNvMs3_NtNtCs8Hz2sPNgbCO_10datafusion9execution7contextNtB7_14SessionContext3sql0Cs2VbMhdeEr66_16delta_benchmarks:bb.a
  ...
  %.sroa.433.i.sroa.0.0.i = phi i64 [ %.sroa.8.i.sroa.0.0.copyload.i, %bb.r ], [ %.sroa.826.i.sroa.0.0.i, %bb.cu ], [ %.sroa.826.i.sroa.0.0.i, %bb.ct ] ; 2 uses
  %.sroa.032.1.i.i = phi i64 [ 36, %bb.r ], [ 36, %bb.cu ], [ %.sroa.024.0.copyload2553.i.i, %bb.ct ] ; 2 uses
...
begin_hunk_15_@_RNCNvMs3_NtNtCs8Hz2sPNgbCO_10datafusion9execution7contextNtB7_14SessionContext3sql0Cs2VbMhdeEr66_16delta_benchmarks:bb.a
  ...
  %.sroa.078.0.copyload79.i = phi i64 [ %.sroa.078.0.copyload79.pre.i, %bb.ow ], [ 36, %bb.pf ] ; 2 uses
