...
bb.g:                                             ; preds = %.lr.ph
  ...
  %i.s = load i8, ptr %i.r, align 8, !range !2194, !noundef !4
  %i.t = icmp eq i8 %i.s, 35
  br i1 %i.t, label %bb.j, label %.loopexit

bb.h:                                             ; preds = %.lr.ph
  %i.u = getelementptr i8, ptr %i.f, i64 15
  %i.v = load i8, ptr %i.u, align 8, !range !2194, !noundef !4
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.l = load ptr, ptr %1, align 8, !noalias !5468, !noundef !4 ; 2 uses
  %i.m = icmp ne ptr %i.l, null
  %i.n = zext i1 %i.m to i64
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !5473
  store i64 %i.n, ptr %i.b, align 8, !noalias !5473
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !5473
  %.not.i.i = icmp eq ptr %i.l, null
  %i.o = getelementptr i8, ptr %1, i64 8          ; 2 uses
  br i1 %.not.i.i, label %bb.d, label %bb.c

bb.c:                                             ; preds = %bb.b
  %.val.i.i = load ptr, ptr %i.o, align 8, !noalias !5468, !noundef !4
  %i.p = getelementptr i8, ptr %1, i64 16
  %.val1.i.i = load i64, ptr %i.p, align 8, !noalias !5468, !noundef !4
...
bb.d:                                             ; preds = %bb.b
  %i.q = load i8, ptr %i.o, align 8, !range !1436, !noalias !5468, !noundef !4
  %i.r = zext nneg i8 %i.q to i64
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !5478
  store i64 %i.r, ptr %i.a, align 8, !noalias !5478
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !5478
  br label %_RINvXsz_NtNtCs4j34XAPZOn0_4http6header4nameNtB6_10HeaderNameNtNtCsbvkFyIu7lgC_4core4hash4Hash4hashNtNtNtCs2pqxYH9ZEk8_3std4hash6random13DefaultHasherECs7p2uQeJxui2_9deltalake.exit
...
_RINvXsz_NtNtCs4j34XAPZOn0_4http6header4nameNtB6_10HeaderNameNtNtCsbvkFyIu7lgC_4core4hash4Hash4hashNtNtNtCs2pqxYH9ZEk8_3std4hash6random13DefaultHasherECs7p2uQeJxui2_9deltalake.exit: ; preds = %bb.c, %bb.d
  %.sroa.0.0.copyload.i = load i64, ptr %i.c, align 16, !alias.scope !5483
  %.sroa.10.0.copyload.i = load i64, ptr %.sroa.412.0..sroa_idx, align 8, !alias.scope !5483
  %.sroa.17.0.copyload.i = load i64, ptr %.sroa.513.0..sroa_idx, align 16, !alias.scope !5483 ; 3 uses
  %.sroa.22.0.copyload.i = load i64, ptr %.sroa.614.0..sroa_idx, align 8, !alias.scope !5483
  %i.s = load i64, ptr %.sroa.915.0..sroa_idx, align 16, !alias.scope !5483, !noundef !4
  %i.t = shl i64 %i.s, 56
  %i.u = load i64, ptr %.sroa.10.0..sroa_idx, align 8, !alias.scope !5483, !noundef !4
...
bb.e:                                             ; preds = %bb.a
  %i.cc = load ptr, ptr %1, align 8, !noalias !5486, !noundef !4 ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  %.val.i.i21 = load ptr, ptr %i.ch, align 8, !noalias !5486, !noundef !4 ; 3 uses
  %i.ci = getelementptr i8, ptr %1, i64 16
  %.val1.i.i22 = load i64, ptr %i.ci, align 8, !noalias !5486, !noundef !4 ; 4 uses
...
.lr.ph.i.i.i.i.prol:                              ; preds = %.lr.ph.i.i.i.i.preheader, %.lr.ph.i.i.i.i.prol
  ...
  %i.cm = load i8, ptr %.sroa.03.05.i.i.i.i.prol, align 1, !alias.scope !5491, !noalias !5494, !noundef !4
  %i.cn = zext i8 %i.cm to i64
  %i.co = xor i64 %.sroa.0.06.i.i.i.i.prol, %i.cn
  %i.cp = mul i64 %i.co, 1099511628211            ; 3 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.i.i.prol.loopexit, label %.lr.ph.i.i.i.i.prol, !llvm.loop !5498
...
.lr.ph.i.i.i.i:                                   ; preds = %.lr.ph.i.i.i.i.prol.loopexit, %.lr.ph.i.i.i.i
  ...
  %i.cs = load i8, ptr %.sroa.03.05.i.i.i.i, align 1, !alias.scope !5491, !noalias !5494, !noundef !4
  ...
  %i.dm = load i8, ptr %i.dg, align 1, !alias.scope !5491, !noalias !5494, !noundef !4
  %i.dn = zext i8 %i.dm to i64
  %i.do = xor i64 %i.dk, %i.dn
  %i.dp = mul i64 %i.do, 1099511628211
  %i.dq = getelementptr inbounds nuw i8, ptr %.sroa.03.05.i.i.i.i, i64 6
  %i.dr = load i8, ptr %i.dl, align 1, !alias.scope !5491, !noalias !5494, !noundef !4
end_hunk_0
