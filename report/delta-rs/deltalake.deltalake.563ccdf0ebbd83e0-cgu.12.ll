...
bb.ae:                                            ; preds = %_RINvMNtNtCs2pqxYH9ZEk8_3std4sync9once_lockINtB3_8OnceLockmE15get_or_try_initNCINvB2_11get_or_initNCNvNtCs7p2uQeJxui2_9deltalake5utils2rt0E0zEB1D_.exit.i.i
  ...
  invoke void @_RNvNtCsbvkFyIu7lgC_4core9panicking9panic_fmt(ptr noundef nonnull @193, ptr noundef nonnull %i.a, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @195) #46
...
bb.ao:                                            ; preds = %bb.an
  ...
  call void @_RNvCs8mYq7K4qqSA_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #42, !noalias !59
  %i.cv = call noundef align 8 dereferenceable_or_null(144) ptr @_RNvCs8mYq7K4qqSA_7___rustc12___rust_alloc(i64 noundef range(i64 16, 1697) 144, i64 noundef range(i64 8, 17) 8) #42, !noalias !59 ; 3 uses
  %i.cw = icmp eq ptr %i.cv, null
  br i1 %i.cw, label %bb.ap, label %bb.as, !prof !9

bb.ap:                                            ; preds = %bb.ao
  invoke void @_RNvNtCs6Po7BT7Nknu_5alloc5alloc18handle_alloc_error(i64 noundef 8, i64 noundef 144) #43
...
bb.ar:                                            ; preds = %bb.aq
  ...
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #45, !noalias !49
  unreachable

.body.i:                                          ; preds = %bb.aq
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs7p2uQeJxui2_9deltalake10filesystem8FsConfigEBK_(ptr noalias noundef align 8 dereferenceable(136) %i.o) #44
...
bb.au:                                            ; preds = %bb.an, %bb.am
  %i.db = landingpad { ptr, i32 }
          cleanup
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs14kWLkQVSKO_14deltalake_core5table10DeltaTableECs7p2uQeJxui2_9deltalake(ptr noalias noundef align 8 dereferenceable(120) %i.q) #44
...
bb.az:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtNtCs2pqxYH9ZEk8_3std11collections4hash3map7HashMapNtNtCs6Po7BT7Nknu_5alloc6string6StringB1B_EECs7p2uQeJxui2_9deltalake.exit131.i, %.thread140.i
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs14kWLkQVSKO_14deltalake_core5table7builder17DeltaTableBuilderECs7p2uQeJxui2_9deltalake(ptr noalias noundef align 8 dereferenceable(336) %i.y) #44
          to label %bb.c unwind label %bb.at, !noalias !49

bb.ba:                                            ; preds = %bb.h
  %i.di = landingpad { ptr, i32 }
          cleanup
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs14kWLkQVSKO_14deltalake_core5table7builder17DeltaTableBuilderECs7p2uQeJxui2_9deltalake(ptr noalias noundef align 8 dereferenceable(336) %i.x) #44
          to label %bb.c unwind label %bb.at, !noalias !49
...
bb.g:                                             ; preds = %bb.f
  %i.ba = landingpad { ptr, i32 }
          cleanup
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtNtCs2pqxYH9ZEk8_3std4sync6poison5mutex10MutexGuardNtNtCs14kWLkQVSKO_14deltalake_core5table10DeltaTableEECs7p2uQeJxui2_9deltalake(ptr nonnull %i.av, i8 %i.ax) #44
...
bb.j:                                             ; preds = %bb.i
  %i.bg = invoke noundef zeroext i1 @_RNvNtNtCs2pqxYH9ZEk8_3std9panicking11panic_count17is_zero_slow_path() #47
...
bb.u:                                             ; preds = %bb.s
  %i.br = landingpad { ptr, i32 }
          cleanup
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs14kWLkQVSKO_14deltalake_core10operations6delete13DeleteBuilderECs7p2uQeJxui2_9deltalake(ptr noalias noundef align 16 dereferenceable(544) %i.s) #44
          to label %.thread.i unwind label %bb.ae, !noalias !679
...
bb.ae:                                            ; preds = %bb.cj, %bb.ch, %bb.cf, %bb.cb, %bb.bw, %bb.bs, %.thread154.i, %bb.bo, %bb.an, %bb.ad, %bb.u, %bb.g
  %i.cb = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #45, !noalias !674
  unreachable
...
bb.an:                                            ; preds = %.body.i
  fence acquire
  invoke void @_RNvMsn_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcDNtNtCs14kWLkQVSKO_14deltalake_core8logstore8LogStoreEL_E9drop_slowBL_(ptr noalias noundef nonnull align 8 dereferenceable(16) %i.m) #47
...
bb.as:                                            ; preds = %bb.ar
  %i.dk = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #45, !noalias !679
  unreachable
...
bb.g:                                             ; preds = %bb.f
  %i.bk = landingpad { ptr, i32 }
          cleanup
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtNtCs2pqxYH9ZEk8_3std4sync6poison5mutex10MutexGuardNtNtCs14kWLkQVSKO_14deltalake_core5table10DeltaTableEECs7p2uQeJxui2_9deltalake(ptr nonnull %i.bf, i8 %i.bh) #44
...
bb.j:                                             ; preds = %bb.i
  %i.bq = invoke noundef zeroext i1 @_RNvNtNtCs2pqxYH9ZEk8_3std9panicking11panic_count17is_zero_slow_path() #47
...
bb.q:                                             ; preds = %bb.o
  %i.bz = landingpad { ptr, i32 }
          cleanup
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs14kWLkQVSKO_14deltalake_core10operations6update13UpdateBuilderECs7p2uQeJxui2_9deltalake(ptr noalias noundef align 16 dereferenceable(592) %i.af) #44
...
bb.ab:                                            ; preds = %bb.dd, %bb.db, %.thread245.i, %bb.cz, %bb.cx, %bb.cv, %bb.cn, %bb.ck, %.thread184.i, %bb.cj, %bb.ci, %bb.ch, %.body125.i, %bb.bu, %bb.at, %.body131.i, %bb.aa, %bb.q, %bb.g
  %i.cj = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #45, !noalias !716
  unreachable
...
bb.at:                                            ; preds = %.body.i
  fence acquire
  invoke void @_RNvMsn_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcDNtNtCs14kWLkQVSKO_14deltalake_core8logstore8LogStoreEL_E9drop_slowBL_(ptr noalias noundef nonnull align 8 dereferenceable(16) %i.o) #47
