...
bb.bh:                                            ; preds = %.body150
  fence acquire
  invoke void @_RNvMsn_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcNtNtNtCs8VI8w5SIoU4_15datafusion_expr12logical_plan4plan11LogicalPlanE9drop_slowBM_(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.i) #58
...
bb.bi:                                            ; preds = %bb.am
  ...
  call void @_RNvCs8mYq7K4qqSA_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #61, !noalias !1013
  %i.fc = call noundef align 8 dereferenceable_or_null(72) ptr @_RNvCs8mYq7K4qqSA_7___rustc12___rust_alloc(i64 noundef range(i64 8, 2113) 72, i64 noundef range(i64 8, 17) 8) #61, !noalias !1013 ; 3 uses
  %i.fd = icmp eq ptr %i.fc, null
  br i1 %i.fd, label %bb.bj, label %bb.bn, !prof !67

bb.bj:                                            ; preds = %bb.bi
  invoke void @_RNvNtCs6Po7BT7Nknu_5alloc5alloc18handle_alloc_error(i64 noundef 8, i64 noundef 72) #57
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionNtNtCs8VI8w5SIoU4_15datafusion_expr4expr4ExprEECs14kWLkQVSKO_14deltalake_core.exit: ; preds = %.body, %bb.bm
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VecTNtNtCs8VI8w5SIoU4_15datafusion_expr4expr4ExprB1e_EEECs14kWLkQVSKO_14deltalake_core(ptr noalias noundef align 8 dereferenceable(24) %i.g) #60
...
bb.bq:                                            ; preds = %bb.bp
  fence acquire
  invoke void @_RNvMsn_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcNtNtNtCs8VI8w5SIoU4_15datafusion_expr12logical_plan4plan11LogicalPlanE9drop_slowBM_(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.h) #58
...
.thread325:                                       ; preds = %bb.au, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcNtNtNtCs8VI8w5SIoU4_15datafusion_expr12logical_plan4plan11LogicalPlanEECs14kWLkQVSKO_14deltalake_core.exit
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCsjhHCjzi9uUI_17datafusion_common8dfschema8DFSchemaECs14kWLkQVSKO_14deltalake_core(ptr noalias noundef align 8 dereferenceable(56) %i.q) #60
...
bb.br:                                            ; preds = %.thread325, %bb.ag
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VecTNtNtCs8VI8w5SIoU4_15datafusion_expr4expr4ExprB1e_EEECs14kWLkQVSKO_14deltalake_core(ptr noalias noundef align 8 dereferenceable(24) %i.s) #60
...
bb.bt:                                            ; preds = %bb.y
  %lpad.thr_comm.split-lp310 = landingpad { ptr, i32 }
          cleanup
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VecNtNtCsjhHCjzi9uUI_17datafusion_common6column6ColumnEECs14kWLkQVSKO_14deltalake_core(ptr noalias noundef align 8 dereferenceable(24) %i.x) #60
          to label %.thread278 unwind label %bb.o
...
bb.bw:                                            ; preds = %bb.r
  %i.fx = landingpad { ptr, i32 }
          cleanup
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VecINtNtB4_6result6ResultNtNtCsjhHCjzi9uUI_17datafusion_common6column6ColumnNtNtB1D_5error15DataFusionErrorEEECs14kWLkQVSKO_14deltalake_core(ptr noalias noundef align 8 dereferenceable(24) %i.aa) #60
          to label %.thread278 unwind label %bb.o
...
.body194:                                         ; preds = %bb.ce, %bb.bz, %bb.cd
  ...
  invoke void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6Po7BT7Nknu_5alloc6string6StringECs14kWLkQVSKO_14deltalake_core(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.ai) #60
          to label %.body199 unwind label %bb.o
...
bb.cb:                                            ; preds = %bb.ca
  ...
  invoke void @_RNvNtCs6Po7BT7Nknu_5alloc7raw_vec12handle_error(i64 noundef %i.gg, i64 %i.gi) #57
...
bb.cd:                                            ; preds = %bb.cc
  %i.gl = landingpad { ptr, i32 }
          cleanup
  invoke void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6Po7BT7Nknu_5alloc6string6StringECs14kWLkQVSKO_14deltalake_core(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.ah) #60
...
.body205:                                         ; preds = %bb.ck, %bb.cn
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VecNtNtCsjhHCjzi9uUI_17datafusion_common6column6ColumnEECs14kWLkQVSKO_14deltalake_core(ptr noalias noundef align 8 dereferenceable(24) %i.ar) #60
...
bb.g:                                             ; preds = %bb.f
  %i.p = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #59, !noalias !21110
  unreachable
...
bb.n:                                             ; preds = %bb.m
  %i.x = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #59, !noalias !21150
  unreachable
...
bb.a:
  ...
  call fastcc void @_RINvMNtCsbvkFyIu7lgC_4core6optionINtB3_6OptionRINtNtNtNtB5_4iter8adapters6filter6FilterINtNtBO_3map3MapINtNtBO_5chain5ChainIB1E_NtNtNtCs8ulvy0Wg6Ot_12delta_kernel10log_reader6commit12CommitReaderIB1o_INtNtCscVxtfYSVfE7_9itertools10flatten_ok9FlattenOkIB1o_INtNtCs6Po7BT7Nknu_5alloc5boxed3BoxDNtNtNtBQ_6traits8iterator8Iteratorp4ItemINtNtB5_6result6ResultIB47_DNtNtB28_11engine_data10EngineDataEL_ENtNtB28_5error5ErrorENtNtB5_6marker4SendEL_ENCNvMNtB28_11log_segmentNtB7a_10LogSegment24create_checkpoint_streams_0EINtNtNtB3h_8adaptors3map14MapSpecialCaseIB1E_INtNtNtBQ_7sources4once4OnceB5k_EINtNtBO_7flatten7FlattenINtB3_8IntoIterB46_EEEINtB8i_18MapSpecialCaseFnOkNCNCB77_s_00EEB6n_ENCB77_s0_0EEIB1o_IB47_IB1o_IB1o_IB47_INtNtNtB4b_3vec9into_iter8IntoIterNtNtCs1N9T06jgEdt_11arrow_array12record_batch11RecordBatchEENCINvMs1_NtNtNtCs14kWLkQVSKO_14deltalake_core6kernel8snapshot4scanNtBdf_4Scan18scan_metadata_fromBbA_E0ENCBd8_s_0EENCINvMs6_NtB28_4scanNtBf6_4Scan18scan_metadata_fromBbg_E0EENCINvYNtNtBf6_10log_replay22ScanLogReplayProcessorNtNtB28_10log_replay18LogReplayProcessor20process_actions_iterB1D_E0ENCBfW_s_0EE6map_orTjIBw_jEENvYBJ_B4G_9size_hintEBdl_(ptr noalias noundef align 8 captures(address) dereferenceable(24) %i.b, ptr noalias noundef readonly align 16 captures(address, read_provenance) dereferenceable_or_null(704) %.sroa.018.0.i, ptr noalias noundef readonly align 8 captures(none) dereferenceable(24) %i.a) #63, !noalias !21167
...
bb.f:                                             ; preds = %bb.e
  %i.g = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  tail call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #59
  unreachable
