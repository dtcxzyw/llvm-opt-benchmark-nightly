...
_RNvXs4_NtNtCs6Po7BT7Nknu_5alloc3vec9into_iterINtB5_8IntoIterINtNtNtCs4j34XAPZOn0_4http6header3map6BucketNtNtB11_5value11HeaderValueEENtNtNtNtCsbvkFyIu7lgC_4core4iter6traits8iterator8Iterator4nextCs9rVkZwOUgsI_13deltalake_aws.exit.i.i: ; preds = %bb.d
  ...
  %.sroa.0.0.copyload.i.i = load i64, ptr %i.p, align 8, !noalias !432 ; 3 uses
...
bb.h:                                             ; preds = %_RNvXs4_NtNtCs6Po7BT7Nknu_5alloc3vec9into_iterINtB5_8IntoIterINtNtNtCs4j34XAPZOn0_4http6header3map6BucketNtNtB11_5value11HeaderValueEENtNtNtNtCsbvkFyIu7lgC_4core4iter6traits8iterator8Iterator4nextCs9rVkZwOUgsI_13deltalake_aws.exit.i.i
  ...
  store i64 %.sroa.05.0.i.i, ptr %0, align 8, !alias.scope !420, !noalias !423
...
bb.y:                                             ; preds = %_RNvXs4_NtNtCs6Po7BT7Nknu_5alloc3vec9into_iterINtB5_8IntoIterINtNtNtCs4j34XAPZOn0_4http6header3map6BucketNtNtB11_5value11HeaderValueEENtNtNtNtCsbvkFyIu7lgC_4core4iter6traits8iterator8Iterator4nextCs9rVkZwOUgsI_13deltalake_aws.exit.i
  ...
  %.sroa.05.0.i = and i64 %.sroa.0.0.copyload.i, 1
  %.sroa.56.0.i = select i1 %i.df, i64 %.sroa.7.0.copyload.i, i64 undef
  store i64 %.sroa.05.0.i, ptr %i.w, align 8, !alias.scope !3259, !noalias !3256
...
bb.ah:                                            ; preds = %bb.af
  invoke void @_RNvMs12_NtNtCs4j34XAPZOn0_4http6header3mapNtB6_6Danger7set_red(ptr noalias noundef nonnull align 8 dereferenceable(96) %0)
          to label %.noexc.i unwind label %.loopexit169, !noalias !3288
...
.lr.ph.i.i.preheader:                             ; preds = %.noexc.i
  ...
  br i1 %min.iters.check, label %.lr.ph.i.i.preheader725, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep719 = getelementptr i8, ptr %i.ga, i64 16
  store <8 x i16> <i16 -1, i16 0, i16 -1, i16 0, i16 -1, i16 0, i16 -1, i16 0>, ptr %next.gep, align 2, !noalias !3288
  store <8 x i16> <i16 -1, i16 0, i16 -1, i16 0, i16 -1, i16 0, i16 -1, i16 0>, ptr %next.gep719, align 2, !noalias !3288
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %._crit_edge.i.i, label %.lr.ph.i.i.preheader725

.lr.ph.i.i.preheader725:                          ; preds = %.lr.ph.i.i.preheader, %middle.block
...
bb.ai:                                            ; preds = %bb.af
  ...
  %i.gd = invoke fastcc noundef zeroext i1 @_RNvMs0_NtNtCs4j34XAPZOn0_4http6header3mapNtB5_9HeaderMap8try_growCs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull align 8 dereferenceable(96) %0, i64 noundef %i.gc) #33
          to label %.noexc65.i unwind label %.loopexit169, !noalias !3288
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader725, %.lr.ph.i.i
  %.sroa.01.018.i.i = phi ptr [ %i.ge, %.lr.ph.i.i ], [ %.sroa.01.018.i.i.ph, %.lr.ph.i.i.preheader725 ] ; 3 uses
...
bb.do:                                            ; preds = %bb.dj
  %i.ql = getelementptr inbounds nuw [72 x i8], ptr %i.no, i64 %i.ps ; 2 uses
  %i.qm = getelementptr inbounds nuw i8, ptr %i.ql, i64 16
  store i64 1, ptr %i.qm, align 8, !noalias !3477
  %i.qn = getelementptr inbounds nuw i8, ptr %i.ql, i64 24
  store i64 %.sroa.0.062.i.i, ptr %i.qn, align 8, !noalias !3477
  br label %bb.dn

bb.dp:                                            ; preds = %bb.dn
  %i.qo = icmp ult i64 %i.pq, %i.oh
  br i1 %i.qo, label %bb.dt, label %.invoke.i.i.i

bb.dq:                                            ; preds = %bb.dn
  %i.qp = icmp ult i64 %i.pq, %i.my
  br i1 %i.qp, label %bb.dr, label %.invoke.i.i.i

bb.dr:                                            ; preds = %bb.dq
  %i.qq = getelementptr inbounds nuw [104 x i8], ptr %i.na, i64 %i.pq ; 2 uses
  %i.qr = load i64, ptr %i.qq, align 8, !range !204, !noalias !3477, !noundef !22
  %i.qs = trunc nuw i64 %i.qr to i1
  br i1 %i.qs, label %bb.ds, label %.invoke98.i.i.i, !prof !3154

bb.ds:                                            ; preds = %bb.dr
  %i.qt = getelementptr inbounds nuw i8, ptr %i.qq, i64 16
  store i64 %.sroa.0.062.i.i, ptr %i.qt, align 8, !noalias !3477
...
.invoke98.i.i.i:                                  ; preds = %bb.dr, %bb.dl
  %i.qu = phi ptr [ @33, %bb.dl ], [ @36, %bb.dr ]
  invoke void @_RNvNtCsbvkFyIu7lgC_4core6option13unwrap_failed(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.qu) #28
          to label %.cont99.i.i.i unwind label %bb.di, !noalias !3477

.cont99.i.i.i:                                    ; preds = %.invoke98.i.i.i
  unreachable

bb.dt:                                            ; preds = %bb.dp
  %i.qv = getelementptr inbounds nuw [72 x i8], ptr %i.no, i64 %i.pq ; 2 uses
  store i64 1, ptr %i.qv, align 8, !noalias !3477
  %i.qw = getelementptr inbounds nuw i8, ptr %i.qv, i64 8
  store i64 %.sroa.0.062.i.i, ptr %i.qw, align 8, !noalias !3477
  br label %_RINvNtNtCs4j34XAPZOn0_4http6header3map18remove_extra_valueNtNtB4_5value11HeaderValueECs9rVkZwOUgsI_13deltalake_aws.exit.i.i

.invoke.i.i.i:                                    ; preds = %bb.dq, %bb.dp, %bb.dk, %bb.dj, %bb.dg
  %i.qx = phi i64 [ %i.pq, %bb.dq ], [ %i.ps, %bb.dj ], [ %i.ps, %bb.dk ], [ %i.pq, %bb.dp ], [ %.sroa.0.062.i.i, %bb.dg ]
  %i.qy = phi i64 [ %i.my, %bb.dq ], [ %i.oh, %bb.dj ], [ %i.my, %bb.dk ], [ %i.oh, %bb.dp ], [ %i.oh, %bb.dg ]
  %i.qz = phi ptr [ @35, %bb.dq ], [ @34, %bb.dj ], [ @32, %bb.dk ], [ @37, %bb.dp ], [ @31, %bb.dg ]
  invoke void @_RNvNtCsbvkFyIu7lgC_4core9panicking18panic_bounds_check(i64 noundef %i.qx, i64 noundef %i.qy, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.qz) #28
          to label %.cont.i.i.i unwind label %bb.di, !noalias !3477
...
_RINvNtNtCs4j34XAPZOn0_4http6header3map18remove_extra_valueNtNtB4_5value11HeaderValueECs9rVkZwOUgsI_13deltalake_aws.exit.i.i: ; preds = %bb.dt, %bb.ds, %bb.de
  ...
  %i.rb = load i64, ptr %i.dv, align 8, !range !204, !noalias !3475, !noundef !22
  %i.rc = trunc nuw i64 %i.rb to i1
  br i1 %i.rc, label %bb.dv, label %bb.dw

bb.dv:                                            ; preds = %_RINvNtNtCs4j34XAPZOn0_4http6header3map18remove_extra_valueNtNtB4_5value11HeaderValueECs9rVkZwOUgsI_13deltalake_aws.exit.i.i
  %i.rd = load i64, ptr %i.dw, align 8, !noalias !3475, !noundef !22 ; 3 uses
  ...
  %i.re = load ptr, ptr %i.dx, align 8, !alias.scope !3514, !noalias !3475, !nonnull !22, !align !153, !noundef !22
  %i.rf = getelementptr inbounds nuw i8, ptr %i.re, i64 32
  %i.rg = load ptr, ptr %i.rf, align 8, !noalias !3515, !nonnull !22, !noundef !22
  %i.rh = load ptr, ptr %i.dz, align 8, !alias.scope !3514, !noalias !3475, !noundef !22
  %i.ri = load i64, ptr %i.ea, align 8, !alias.scope !3514, !noalias !3475, !noundef !22
  invoke void %i.rg(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.dy, ptr noundef %i.rh, i64 noundef %i.ri)
          to label %.noexc12.i unwind label %.loopexit.i, !noalias !3454, !inline_history !3516

.noexc12.i:                                       ; preds = %bb.dv
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e), !noalias !3475
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e), !noalias !3475
  %i.rj = icmp ult i64 %i.rd, %i.oh
  br i1 %i.rj, label %.lr.ph.i.i45, label %._crit_edge.i.invoke.i

bb.dw:                                            ; preds = %_RINvNtNtCs4j34XAPZOn0_4http6header3map18remove_extra_valueNtNtB4_5value11HeaderValueECs9rVkZwOUgsI_13deltalake_aws.exit.i.i
  ...
  %i.rk = load ptr, ptr %i.dx, align 8, !alias.scope !3529, !noalias !3475, !nonnull !22, !align !153, !noundef !22
  %i.rl = getelementptr inbounds nuw i8, ptr %i.rk, i64 32
  %i.rm = load ptr, ptr %i.rl, align 8, !noalias !3530, !nonnull !22, !noundef !22
  %i.rn = load ptr, ptr %i.dz, align 8, !alias.scope !3529, !noalias !3475, !noundef !22
  %i.ro = load i64, ptr %i.ea, align 8, !alias.scope !3529, !noalias !3475, !noundef !22
  invoke void %i.rm(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.dy, ptr noundef %i.rn, i64 noundef %i.ro)
...
_RNvMs0_NtNtCs4j34XAPZOn0_4http6header3mapNtB5_9HeaderMap23remove_all_extra_valuesCs9rVkZwOUgsI_13deltalake_aws.exit.i: ; preds = %bb.dw
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e), !noalias !3475
  br label %bb.dy

bb.dx:                                            ; preds = %.body.i43
  %i.rp = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #30, !noalias !3465
  unreachable

bb.dy:                                            ; preds = %_RNvMs0_NtNtCs4j34XAPZOn0_4http6header3mapNtB5_9HeaderMap23remove_all_extra_valuesCs9rVkZwOUgsI_13deltalake_aws.exit.i, %bb.cj
  %i.rq = getelementptr inbounds nuw i8, ptr %i.nb, i64 24 ; 2 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(40) %i.t, ptr noundef nonnull align 8 dereferenceable(40) %i.rq, i64 40, i1 false), !noalias !3531
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(40) %i.rq, ptr noundef nonnull align 8 dereferenceable(40) %i.v, i64 40, i1 false)
  ...
  %i.rr = load ptr, ptr %i.t, align 8, !alias.scope !3541, !nonnull !22, !align !153, !noundef !22
  %i.rs = getelementptr inbounds nuw i8, ptr %i.rr, i64 32
  %i.rt = load ptr, ptr %i.rs, align 8, !noalias !3541, !nonnull !22, !noundef !22
  %i.ru = load ptr, ptr %i.ec, align 8, !alias.scope !3541, !noundef !22
  %i.rv = load i64, ptr %i.ed, align 8, !alias.scope !3541, !noundef !22
  invoke void %i.rt(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.eb, ptr noundef %i.ru, i64 noundef %i.rv)
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs4j34XAPZOn0_4http6header5value11HeaderValueECs9rVkZwOUgsI_13deltalake_aws.exit52: ; preds = %bb.dy
  call void @llvm.lifetime.end.p0(ptr nonnull %i.t)
  br label %bb.dz

bb.dz:                                            ; preds = %bb.eb, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs4j34XAPZOn0_4http6header5value11HeaderValueECs9rVkZwOUgsI_13deltalake_aws.exit52
  %.sroa.7.0 = phi i64 [ %i.ju, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs4j34XAPZOn0_4http6header5value11HeaderValueECs9rVkZwOUgsI_13deltalake_aws.exit52 ], [ %i.li, %bb.eb ] ; 6 uses
  %i.rw = load i64, ptr %i.w, align 8, !range !204, !alias.scope !3542, !noalias !3545, !noundef !22
  %i.rx = trunc nuw i64 %i.rw to i1
  br i1 %i.rx, label %.lr.ph, label %._crit_edge

bb.ea:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs4j34XAPZOn0_4http6header5value11HeaderValueECs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i, %bb.ca
  call void @llvm.lifetime.end.p0(ptr nonnull %i.g), !noalias !3372
...
bb.eb:                                            ; preds = %bb.cf, %bb.ch, %bb.ci
  call void @llvm.lifetime.end.p0(ptr nonnull %i.g), !noalias !3372
  call void @llvm.lifetime.end.p0(ptr nonnull %i.r)
  br label %bb.dz

.lr.ph:                                           ; preds = %bb.dz, %_RNvMsO_NtNtCs4j34XAPZOn0_4http6header3mapINtB5_13OccupiedEntryNtNtB7_5value11HeaderValueE6appendCs9rVkZwOUgsI_13deltalake_aws.exit
  call void @llvm.experimental.noalias.scope.decl(metadata !3547)
  %i.ry = load i64, ptr %i.cm, align 8, !alias.scope !3547, !noalias !3545, !noundef !22 ; 3 uses
  %i.rz = load i64, ptr %i.eh, align 8, !alias.scope !3547, !noalias !3545, !noundef !22 ; 2 uses
  %i.sa = icmp ult i64 %i.ry, %i.rz
  br i1 %i.sa, label %bb.ec, label %bb.ed

._crit_edge:                                      ; preds = %_RNvMsO_NtNtCs4j34XAPZOn0_4http6header3mapINtB5_13OccupiedEntryNtNtB7_5value11HeaderValueE6appendCs9rVkZwOUgsI_13deltalake_aws.exit, %bb.dz
  call void @llvm.experimental.noalias.scope.decl(metadata !3549)
  %i.sb = load ptr, ptr %.sroa.6.0..sroa_idx.i, align 8, !alias.scope !3552, !noalias !3553, !nonnull !22, !noundef !22
  %i.sc = load ptr, ptr %.sroa.4.0..sroa_idx.i, align 8, !alias.scope !3552, !noalias !3553, !nonnull !22, !noundef !22 ; 6 uses
  %i.sd = icmp eq ptr %i.sc, %i.sb
  br i1 %i.sd, label %bb.ef, label %_RNvXs4_NtNtCs6Po7BT7Nknu_5alloc3vec9into_iterINtB5_8IntoIterINtNtNtCs4j34XAPZOn0_4http6header3map6BucketNtNtB11_5value11HeaderValueEENtNtNtNtCsbvkFyIu7lgC_4core4iter6traits8iterator8Iterator4nextCs9rVkZwOUgsI_13deltalake_aws.exit.i54
...
_RNvXs4_NtNtCs6Po7BT7Nknu_5alloc3vec9into_iterINtB5_8IntoIterINtNtNtCs4j34XAPZOn0_4http6header3map6BucketNtNtB11_5value11HeaderValueEENtNtNtNtCsbvkFyIu7lgC_4core4iter6traits8iterator8Iterator4nextCs9rVkZwOUgsI_13deltalake_aws.exit.i54: ; preds = %._crit_edge
  %i.se = getelementptr inbounds nuw i8, ptr %i.sc, i64 104
  store ptr %i.se, ptr %.sroa.4.0..sroa_idx.i, align 8, !alias.scope !3552, !noalias !3553
  %.sroa.0.0.copyload.i55 = load i64, ptr %i.sc, align 8, !noalias !3555 ; 3 uses
  %.not.i56 = icmp eq i64 %.sroa.0.0.copyload.i55, 2
  br i1 %.not.i56, label %bb.ef, label %bb.eg

bb.ec:                                            ; preds = %.lr.ph
  %i.sf = load ptr, ptr %i.ei, align 8, !alias.scope !3547, !noalias !3545, !nonnull !22, !noundef !22
  %i.sg = getelementptr inbounds nuw [72 x i8], ptr %i.sf, i64 %i.ry ; 3 uses
  %i.sh = getelementptr inbounds nuw i8, ptr %i.sg, i64 16
  %i.si = load i64, ptr %i.sh, align 8, !range !204, !noalias !3556, !noundef !22
  %i.sj = trunc nuw i64 %i.si to i1
  br i1 %i.sj, label %bb.ee, label %bb.eh

bb.ed:                                            ; preds = %.lr.ph
  invoke void @_RNvNtCsbvkFyIu7lgC_4core9panicking18panic_bounds_check(i64 noundef %i.ry, i64 noundef %i.rz, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @323) #32
...
bb.ee:                                            ; preds = %bb.ec
  ...
  %i.sl = load i64, ptr %i.sk, align 8, !noalias !3556, !noundef !22
  br label %bb.eh

bb.ef:                                            ; preds = %_RNvXs4_NtNtCs6Po7BT7Nknu_5alloc3vec9into_iterINtB5_8IntoIterINtNtNtCs4j34XAPZOn0_4http6header3map6BucketNtNtB11_5value11HeaderValueEENtNtNtNtCsbvkFyIu7lgC_4core4iter6traits8iterator8Iterator4nextCs9rVkZwOUgsI_13deltalake_aws.exit.i54, %._crit_edge
  call void @llvm.lifetime.end.p0(ptr nonnull %i.v)
  br label %bb.x

bb.eg:                                            ; preds = %_RNvXs4_NtNtCs6Po7BT7Nknu_5alloc3vec9into_iterINtB5_8IntoIterINtNtNtCs4j34XAPZOn0_4http6header3map6BucketNtNtB11_5value11HeaderValueEENtNtNtNtCsbvkFyIu7lgC_4core4iter6traits8iterator8Iterator4nextCs9rVkZwOUgsI_13deltalake_aws.exit.i54
  %.sroa.9.0..sroa_idx.i57 = getelementptr inbounds nuw i8, ptr %i.sc, i64 64
  %.sroa.7.0..sroa_idx.i58 = getelementptr inbounds nuw i8, ptr %i.sc, i64 8
  ...
  %i.sm = getelementptr inbounds nuw i8, ptr %i.sc, i64 24
  %i.sn = trunc nuw i64 %.sroa.0.0.copyload.i55 to i1
  %.sroa.05.0.i62 = and i64 %.sroa.0.0.copyload.i55, 1
  %.sroa.56.0.i63 = select i1 %i.sn, i64 %.sroa.7.0.copyload.i59, i64 undef
  store i64 %.sroa.05.0.i62, ptr %i.w, align 8, !alias.scope !3547, !noalias !3545
  store i64 %.sroa.56.0.i63, ptr %i.cm, align 8, !alias.scope !3547, !noalias !3545
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(40) %i.v, ptr noundef nonnull align 8 dereferenceable(40) %i.sm, i64 40, i1 false)
  br label %bb.ae

bb.eh:                                            ; preds = %bb.ee, %bb.ec
  %.sroa.5.0.i65 = phi i64 [ %i.sl, %bb.ee ], [ undef, %bb.ec ]
  %.sroa.0.0.i66 = phi i64 [ 1, %bb.ee ], [ 0, %bb.ec ]
  ...
  %i.so = getelementptr inbounds nuw i8, ptr %i.sg, i64 32 ; 3 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(40) %i.p, ptr noundef nonnull align 8 dereferenceable(40) %i.so, i64 40, i1 false)
  call void @llvm.experimental.noalias.scope.decl(metadata !3557)
  %i.sp = load i64, ptr %i.ah, align 8, !noalias !3557, !noundef !22 ; 2 uses
  %.not.i70 = icmp ult i64 %.sroa.7.0, %i.sp
  br i1 %.not.i70, label %bb.ei, label %bb.es

bb.ei:                                            ; preds = %bb.eh
  %i.sq = load ptr, ptr %.sroa.5.0..sroa_idx5.i.i, align 8, !noalias !3557, !nonnull !22, !noundef !22
  %i.sr = getelementptr inbounds nuw [104 x i8], ptr %i.sq, i64 %.sroa.7.0 ; 6 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !3560)
  call void @llvm.experimental.noalias.scope.decl(metadata !3563)
  %i.ss = load i64, ptr %i.sr, align 8, !range !204, !alias.scope !3560, !noalias !3565, !noundef !22
  %i.st = trunc nuw i64 %i.ss to i1
  br i1 %i.st, label %bb.ej, label %bb.en

bb.ej:                                            ; preds = %bb.ei
  %i.su = getelementptr inbounds nuw i8, ptr %i.sr, i64 16 ; 2 uses
  %i.sv = load i64, ptr %i.su, align 8, !alias.scope !3560, !noalias !3565, !noundef !22 ; 4 uses
  %i.sw = load i64, ptr %i.dr, align 8, !alias.scope !3563, !noalias !3567, !noundef !22 ; 7 uses
  %i.sx = icmp ult i64 %i.sw, 128102389400760776
  call void @llvm.assume(i1 %i.sx)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c), !noalias !3568
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(40) %i.eo, ptr noundef nonnull align 8 dereferenceable(40) %i.so, i64 40, i1 false)
  store i64 1, ptr %i.c, align 8, !noalias !3568
  store i64 %i.sv, ptr %i.ep, align 8, !noalias !3568
  ...
  %i.sy = load i64, ptr %i.ej, align 8, !range !161, !alias.scope !3574, !noalias !3575, !noundef !22
  %i.sz = icmp eq i64 %i.sw, %i.sy
  br i1 %i.sz, label %bb.ek, label %_RNvMsF_NtCs6Po7BT7Nknu_5alloc3vecINtB5_3VecINtNtNtCs4j34XAPZOn0_4http6header3map10ExtraValueNtNtBK_5value11HeaderValueEE8push_mutCs9rVkZwOUgsI_13deltalake_aws.exit.i.i
...
bb.ek:                                            ; preds = %bb.ej
  invoke void @_RNvMs3_NtCs6Po7BT7Nknu_5alloc7raw_vecINtB5_6RawVecINtNtNtCs4j34XAPZOn0_4http6header3map10ExtraValueNtNtBR_5value11HeaderValueEE8grow_oneCs2DiVQAxFeQE_16aws_smithy_types(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.ej)
          to label %_RNvMsF_NtCs6Po7BT7Nknu_5alloc3vecINtB5_3VecINtNtNtCs4j34XAPZOn0_4http6header3map10ExtraValueNtNtBK_5value11HeaderValueEE8push_mutCs9rVkZwOUgsI_13deltalake_aws.exit.i.i unwind label %bb.el, !noalias !3575
...
bb.el:                                            ; preds = %bb.ek
  ...
  %i.tb = load ptr, ptr %i.eo, align 8, !alias.scope !3588, !noalias !3589, !nonnull !22, !align !153, !noundef !22
  %i.tc = getelementptr inbounds nuw i8, ptr %i.tb, i64 32
  %i.td = load ptr, ptr %i.tc, align 8, !noalias !3590, !nonnull !22, !noundef !22
  %i.te = getelementptr inbounds nuw i8, ptr %i.c, i64 56
  %i.tf = getelementptr inbounds nuw i8, ptr %i.c, i64 40
  %i.tg = load ptr, ptr %i.tf, align 8, !alias.scope !3588, !noalias !3589, !noundef !22
  %i.th = getelementptr inbounds nuw i8, ptr %i.c, i64 48
  %i.ti = load i64, ptr %i.th, align 8, !alias.scope !3588, !noalias !3589, !noundef !22
  invoke void %i.td(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.te, ptr noundef %i.tg, i64 noundef %i.ti)
          to label %.body unwind label %bb.em, !noalias !3567, !inline_history !3500
...
_RNvMsF_NtCs6Po7BT7Nknu_5alloc3vecINtB5_3VecINtNtNtCs4j34XAPZOn0_4http6header3map10ExtraValueNtNtBK_5value11HeaderValueEE8push_mutCs9rVkZwOUgsI_13deltalake_aws.exit.i.i: ; preds = %bb.ek, %bb.ej
  %i.tk = load ptr, ptr %i.dq, align 8, !alias.scope !3574, !noalias !3575, !nonnull !22, !noundef !22
  %i.tl = getelementptr inbounds nuw [72 x i8], ptr %i.tk, i64 %i.sw
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(72) %i.tl, ptr noundef nonnull align 8 dereferenceable(72) %i.c, i64 72, i1 false), !noalias !3567
  %i.tm = add nuw nsw i64 %i.sw, 1                ; 2 uses
  store i64 %i.tm, ptr %i.dr, align 8, !alias.scope !3574, !noalias !3575
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c), !noalias !3568
  %.not.i.i = icmp ugt i64 %i.sv, %i.sw
  br i1 %.not.i.i, label %.noexc.i72, label %bb.er

bb.en:                                            ; preds = %bb.ei
  %i.tn = load i64, ptr %i.dr, align 8, !alias.scope !3563, !noalias !3567, !noundef !22 ; 6 uses
  %i.to = icmp ult i64 %i.tn, 128102389400760776
  call void @llvm.assume(i1 %i.to)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !3568
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(40) %i.ek, ptr noundef nonnull align 8 dereferenceable(40) %i.so, i64 40, i1 false)
  ...
  %i.tp = load i64, ptr %i.ej, align 8, !range !161, !alias.scope !3596, !noalias !3597, !noundef !22
  %i.tq = icmp eq i64 %i.tn, %i.tp
  br i1 %i.tq, label %bb.eo, label %_RNvMsF_NtCs6Po7BT7Nknu_5alloc3vecINtB5_3VecINtNtNtCs4j34XAPZOn0_4http6header3map10ExtraValueNtNtBK_5value11HeaderValueEE8push_mutCs9rVkZwOUgsI_13deltalake_aws.exit9.i.i

bb.eo:                                            ; preds = %bb.en
  invoke void @_RNvMs3_NtCs6Po7BT7Nknu_5alloc7raw_vecINtB5_6RawVecINtNtNtCs4j34XAPZOn0_4http6header3map10ExtraValueNtNtBR_5value11HeaderValueEE8grow_oneCs2DiVQAxFeQE_16aws_smithy_types(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.ej)
          to label %_RNvMsF_NtCs6Po7BT7Nknu_5alloc3vecINtB5_3VecINtNtNtCs4j34XAPZOn0_4http6header3map10ExtraValueNtNtBK_5value11HeaderValueEE8push_mutCs9rVkZwOUgsI_13deltalake_aws.exit9.i.i unwind label %bb.ep, !noalias !3597
...
bb.ep:                                            ; preds = %bb.eo
  ...
  %i.ts = load ptr, ptr %i.ek, align 8, !alias.scope !3610, !noalias !3611, !nonnull !22, !align !153, !noundef !22
  %i.tt = getelementptr inbounds nuw i8, ptr %i.ts, i64 32
  %i.tu = load ptr, ptr %i.tt, align 8, !noalias !3612, !nonnull !22, !noundef !22
  %i.tv = getelementptr inbounds nuw i8, ptr %i.b, i64 56
  %i.tw = getelementptr inbounds nuw i8, ptr %i.b, i64 40
  %i.tx = load ptr, ptr %i.tw, align 8, !alias.scope !3610, !noalias !3611, !noundef !22
  %i.ty = getelementptr inbounds nuw i8, ptr %i.b, i64 48
  %i.tz = load i64, ptr %i.ty, align 8, !alias.scope !3610, !noalias !3611, !noundef !22
  invoke void %i.tu(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.tv, ptr noundef %i.tx, i64 noundef %i.tz)
          to label %.body unwind label %bb.eq, !noalias !3567, !inline_history !3500
...
_RNvMsF_NtCs6Po7BT7Nknu_5alloc3vecINtB5_3VecINtNtNtCs4j34XAPZOn0_4http6header3map10ExtraValueNtNtBK_5value11HeaderValueEE8push_mutCs9rVkZwOUgsI_13deltalake_aws.exit9.i.i: ; preds = %bb.eo, %bb.en
  %i.ub = load ptr, ptr %i.dq, align 8, !alias.scope !3596, !noalias !3597, !nonnull !22, !noundef !22
  %i.uc = getelementptr inbounds nuw [72 x i8], ptr %i.ub, i64 %i.tn
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(72) %i.uc, ptr noundef nonnull align 8 dereferenceable(72) %i.b, i64 72, i1 false), !noalias !3567
  %i.ud = add nuw nsw i64 %i.tn, 1
  store i64 %i.ud, ptr %i.dr, align 8, !alias.scope !3596, !noalias !3597
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !3568
  store i64 1, ptr %i.sr, align 8, !alias.scope !3560, !noalias !3565
  %.sroa.42.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.sr, i64 8
  store i64 %i.tn, ptr %.sroa.42.0..sroa_idx.i.i, align 8, !alias.scope !3560, !noalias !3565
  %.sroa.53.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.sr, i64 16
  store i64 %i.tn, ptr %.sroa.53.0..sroa_idx.i.i, align 8, !alias.scope !3560, !noalias !3565
...
bb.er:                                            ; preds = %_RNvMsF_NtCs6Po7BT7Nknu_5alloc3vecINtB5_3VecINtNtNtCs4j34XAPZOn0_4http6header3map10ExtraValueNtNtBK_5value11HeaderValueEE8push_mutCs9rVkZwOUgsI_13deltalake_aws.exit.i.i
  %i.ue = load ptr, ptr %i.dq, align 8, !alias.scope !3563, !noalias !3567, !nonnull !22, !noundef !22
  %i.uf = getelementptr inbounds nuw [72 x i8], ptr %i.ue, i64 %i.sv ; 2 uses
  %i.ug = getelementptr inbounds nuw i8, ptr %i.uf, i64 16
  store i64 1, ptr %i.ug, align 8, !noalias !3567
  %i.uh = getelementptr inbounds nuw i8, ptr %i.uf, i64 24
  store i64 %i.sw, ptr %i.uh, align 8, !noalias !3567
  store i64 1, ptr %i.sr, align 8, !alias.scope !3560, !noalias !3565
  store i64 %i.sw, ptr %i.su, align 8, !alias.scope !3560, !noalias !3565
  br label %_RNvMsO_NtNtCs4j34XAPZOn0_4http6header3mapINtB5_13OccupiedEntryNtNtB7_5value11HeaderValueE6appendCs9rVkZwOUgsI_13deltalake_aws.exit
...
.noexc.i72:                                       ; preds = %_RNvMsF_NtCs6Po7BT7Nknu_5alloc3vecINtB5_3VecINtNtNtCs4j34XAPZOn0_4http6header3map10ExtraValueNtNtBK_5value11HeaderValueEE8push_mutCs9rVkZwOUgsI_13deltalake_aws.exit.i.i
  invoke void @_RNvNtCsbvkFyIu7lgC_4core9panicking18panic_bounds_check(i64 noundef %i.sv, i64 noundef %i.tm, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @20) #28
...
bb.es:                                            ; preds = %bb.eh
  invoke void @_RNvNtCsbvkFyIu7lgC_4core9panicking18panic_bounds_check(i64 noundef %.sroa.7.0, i64 noundef %i.sp, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @101) #28
          to label %bb.et unwind label %bb.eu, !noalias !3557
...
bb.eu:                                            ; preds = %bb.es
  ...
  %i.uj = load ptr, ptr %i.p, align 8, !alias.scope !3622, !nonnull !22, !align !153, !noundef !22
  %i.uk = getelementptr inbounds nuw i8, ptr %i.uj, i64 32
  %i.ul = load ptr, ptr %i.uk, align 8, !noalias !3622, !nonnull !22, !noundef !22
  %i.um = getelementptr inbounds nuw i8, ptr %i.p, i64 24
  %i.un = getelementptr inbounds nuw i8, ptr %i.p, i64 8
  %i.uo = load ptr, ptr %i.un, align 8, !alias.scope !3622, !noundef !22
  %i.up = getelementptr inbounds nuw i8, ptr %i.p, i64 16
  %i.uq = load i64, ptr %i.up, align 8, !alias.scope !3622, !noundef !22
  invoke void %i.ul(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.um, ptr noundef %i.uo, i64 noundef %i.uq)
          to label %.body unwind label %bb.ev, !inline_history !405
...
_RNvMsO_NtNtCs4j34XAPZOn0_4http6header3mapINtB5_13OccupiedEntryNtNtB7_5value11HeaderValueE6appendCs9rVkZwOUgsI_13deltalake_aws.exit: ; preds = %bb.er, %_RNvMsF_NtCs6Po7BT7Nknu_5alloc3vecINtB5_3VecINtNtNtCs4j34XAPZOn0_4http6header3map10ExtraValueNtNtBK_5value11HeaderValueEE8push_mutCs9rVkZwOUgsI_13deltalake_aws.exit9.i.i
  %i.us = load i64, ptr %i.w, align 8, !range !204, !alias.scope !3623, !noalias !3545, !noundef !22
  %i.ut = trunc nuw i64 %i.us to i1
  br i1 %i.ut, label %.lr.ph, label %._crit_edge

.body36.thread122:                                ; preds = %.body36.loopexit, %.body36.loopexit.split-lp, %bb.br, %.body.i32
  %eh.lpad-body37125 = phi { ptr, i32 } [ %eh.lpad-body.i33, %bb.br ], [ %eh.lpad-body.i33, %.body.i32 ], [ %lpad.loopexit170, %.body36.loopexit ], [ %lpad.loopexit.split-lp171, %.body36.loopexit.split-lp ]
  ...
  %i.uu = load ptr, ptr %i.v, align 8, !alias.scope !3634, !nonnull !22, !align !153, !noundef !22
  %i.uv = getelementptr inbounds nuw i8, ptr %i.uu, i64 32
  %i.uw = load ptr, ptr %i.uv, align 8, !noalias !3634, !nonnull !22, !noundef !22
end_hunk_2
...
bb.ac:                                            ; preds = %bb.ab
  ...
  br i1 %.not29, label %2, label %bb.ad
...
bb.aj:                                            ; preds = %_RNCNvMs2_NtCs9rVkZwOUgsI_13deltalake_aws7storageNtB7_16S3StorageOptions8from_maps1_0B9_.exit, %2
  %.sroa.02.0 = phi i8 [ %i.cs, %_RNCNvMs2_NtCs9rVkZwOUgsI_13deltalake_aws7storageNtB7_16S3StorageOptions8from_maps1_0B9_.exit ], [ 0, %2 ]
