...
bb.o:                                             ; preds = %bb.a
  ...
  %i.au = call noundef zeroext i1 @_RNvMsa_NtCsbvkFyIu7lgC_4core3fmtNtB5_9Formatter25debug_tuple_field2_finish(ptr noalias noundef nonnull align 8 dereferenceable(24) %1, ptr noalias noundef nonnull readonly captures(address, read_provenance) @505, i64 noundef 7, ptr noundef nonnull %0, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) @196, ptr noundef nonnull %i.f, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) @504)
...
bb.p:                                             ; preds = %bb.a
  ...
  %i.aw = call noundef zeroext i1 @_RNvMsa_NtCsbvkFyIu7lgC_4core3fmtNtB5_9Formatter25debug_tuple_field1_finish(ptr noalias noundef nonnull align 8 dereferenceable(24) %1, ptr noalias noundef nonnull readonly captures(address, read_provenance) @506, i64 noundef 8, ptr noundef nonnull %i.e, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) @241)
...
bb.q:                                             ; preds = %bb.a
  ...
  %i.ay = call noundef zeroext i1 @_RNvMsa_NtCsbvkFyIu7lgC_4core3fmtNtB5_9Formatter25debug_tuple_field1_finish(ptr noalias noundef nonnull align 8 dereferenceable(24) %1, ptr noalias noundef nonnull readonly captures(address, read_provenance) @507, i64 noundef 20, ptr noundef nonnull %i.d, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) @241)
...
bb.r:                                             ; preds = %bb.a
  ...
  %i.ba = call noundef zeroext i1 @_RNvMsa_NtCsbvkFyIu7lgC_4core3fmtNtB5_9Formatter25debug_tuple_field1_finish(ptr noalias noundef nonnull align 8 dereferenceable(24) %1, ptr noalias noundef nonnull readonly captures(address, read_provenance) @508, i64 noundef 12, ptr noundef nonnull %i.c, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) @241)
...
bb.s:                                             ; preds = %bb.a
  ...
  %i.bc = call noundef zeroext i1 @_RNvMsa_NtCsbvkFyIu7lgC_4core3fmtNtB5_9Formatter25debug_tuple_field1_finish(ptr noalias noundef nonnull align 8 dereferenceable(24) %1, ptr noalias noundef nonnull readonly captures(address, read_provenance) @509, i64 noundef 14, ptr noundef nonnull %i.b, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) @241)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b)
  br label %bb.w

bb.t:                                             ; preds = %bb.a
  %i.bd = tail call noundef zeroext i1 @_RNvMsa_NtCsbvkFyIu7lgC_4core3fmtNtB5_9Formatter9write_str(ptr noalias noundef nonnull align 8 dereferenceable(24) %1, ptr noalias noundef nonnull readonly captures(address, read_provenance) @510, i64 noundef 26)
  br label %bb.w

bb.u:                                             ; preds = %bb.a
  %i.be = tail call noundef zeroext i1 @_RNvMsa_NtCsbvkFyIu7lgC_4core3fmtNtB5_9Formatter9write_str(ptr noalias noundef nonnull align 8 dereferenceable(24) %1, ptr noalias noundef nonnull readonly captures(address, read_provenance) @511, i64 noundef 24)
  br label %bb.w
...
bb.v:                                             ; preds = %bb.a
  ...
  %i.bg = call noundef zeroext i1 @_RNvMsa_NtCsbvkFyIu7lgC_4core3fmtNtB5_9Formatter25debug_tuple_field1_finish(ptr noalias noundef nonnull align 8 dereferenceable(24) %1, ptr noalias noundef nonnull readonly captures(address, read_provenance) @513, i64 noundef 19, ptr noundef nonnull %i.a, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) @512)
...
bb.a:
  %i.a = load i8, ptr %0, align 8, !range !1805, !noundef !3 ; 2 uses
  %i.b = load i8, ptr %1, align 8, !range !1805, !noundef !3
...
bb.b:                                             ; preds = %.lr.ph
  ...
  %i.f = load i8, ptr %i.e, align 1, !range !852, !noundef !3
  %i.g = getelementptr inbounds nuw i8, ptr %.tr2969, i64 1
  %i.h = load i8, ptr %i.g, align 1, !range !852, !noundef !3
...
bb.c:                                             ; preds = %.lr.ph
  ...
  %i.k = load i8, ptr %i.j, align 1, !range !852, !noundef !3
  %i.l = getelementptr inbounds nuw i8, ptr %.tr2969, i64 1
  %i.m = load i8, ptr %i.l, align 1, !range !852, !noundef !3
...
bb.h:                                             ; preds = %.lr.ph
  ...
  %i.al = load ptr, ptr %i.ak, align 8, !nonnull !3, !noundef !3 ; 2 uses
...
bb.i:                                             ; preds = %.lr.ph
  ...
  %i.aq = load ptr, ptr %i.ap, align 8, !nonnull !3, !noundef !3 ; 2 uses
...
bb.j:                                             ; preds = %.lr.ph
  ...
  %i.at = load i32, ptr %i.as, align 4, !noundef !3
  %i.au = getelementptr inbounds nuw i8, ptr %.tr2969, i64 4
  %i.av = load i32, ptr %i.au, align 4, !noundef !3
...
bb.k:                                             ; preds = %.lr.ph
  ...
  %i.ay = load ptr, ptr %i.ax, align 8, !nonnull !3, !noundef !3 ; 2 uses
...
bb.l:                                             ; preds = %.lr.ph
  ...
  %i.bd = load ptr, ptr %i.bc, align 8, !nonnull !3, !noundef !3 ; 2 uses
  %i.be = getelementptr inbounds nuw i8, ptr %.tr2969, i64 8
  %i.bf = load ptr, ptr %i.be, align 8, !nonnull !3, !noundef !3 ; 2 uses
...
bb.m:                                             ; preds = %.lr.ph
  ...
  %.val20 = load i64, ptr %i.bh, align 8, !noundef !3 ; 2 uses
  %i.bi = getelementptr inbounds nuw i8, ptr %.tr2969, i64 16
  %.val22 = load i64, ptr %i.bi, align 8, !noundef !3
...
bb.n:                                             ; preds = %bb.m
  ...
  %.val.a = load ptr, ptr %i.bk, align 8, !nonnull !3, !noundef !3
  %i.bl = getelementptr inbounds nuw i8, ptr %.tr68, i64 8
  %.val21 = load ptr, ptr %i.bl, align 8, !nonnull !3, !noundef !3
...
bb.o:                                             ; preds = %.lr.ph
  ...
  %.val24 = load i64, ptr %i.bp, align 8, !noundef !3 ; 2 uses
  %i.bq = getelementptr inbounds nuw i8, ptr %.tr2969, i64 16
  %.val26 = load i64, ptr %i.bq, align 8, !noundef !3
...
_RNvXsn_NtCsfYVtenZkBsn_12arrow_schema6fieldsNtB5_11UnionFieldsNtNtCsbvkFyIu7lgC_4core3cmp9PartialEq2eq.exit: ; preds = %bb.o
  ...
  %.val23.a = load ptr, ptr %i.bs, align 8, !nonnull !3, !noundef !3
  %i.bt = getelementptr inbounds nuw i8, ptr %.tr68, i64 8
  %.val25 = load ptr, ptr %i.bt, align 8, !nonnull !3, !noundef !3
...
bb.p:                                             ; preds = %.lr.ph
  ...
  %i.cb = tail call fastcc noundef zeroext i1 @_RNvXs5_NtCsfYVtenZkBsn_12arrow_schema8datatypeNtB5_8DataTypeNtNtCsbvkFyIu7lgC_4core3cmp9PartialEq2eq(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.by, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.ca) #57
...
bb.q:                                             ; preds = %.lr.ph
  ...
  %i.cd = load i8, ptr %i.cc, align 1, !noundef !3
  %i.ce = getelementptr inbounds nuw i8, ptr %.tr2969, i64 1
  %i.cf = load i8, ptr %i.ce, align 1, !noundef !3
...
bb.s:                                             ; preds = %.lr.ph
  ...
  %i.cp = load i8, ptr %i.co, align 1, !noundef !3
...
bb.u:                                             ; preds = %.lr.ph
  ...
  %i.cx = load i8, ptr %i.cw, align 1, !range !135, !noundef !3
  %i.cy = getelementptr inbounds nuw i8, ptr %.tr2969, i64 1
  %i.cz = load i8, ptr %i.cy, align 1, !range !135, !noundef !3
...
bb.v:                                             ; preds = %.lr.ph
  ...
  %i.dc = load ptr, ptr %i.db, align 8, !nonnull !3, !noundef !3 ; 2 uses
...
bb.w:                                             ; preds = %bb.b
  ...
  %i.dh = load ptr, ptr %i.dg, align 8, !noundef !3 ; 2 uses
  %.not = icmp eq ptr %i.dh, null                 ; 2 uses
  %i.di = getelementptr inbounds nuw i8, ptr %.tr2969, i64 8
  %i.dj = load ptr, ptr %i.di, align 8, !noundef !3 ; 2 uses
...
bb.x:                                             ; preds = %bb.w
  ...
  %i.dn = load i64, ptr %i.dl, align 8, !noundef !3 ; 2 uses
  %i.do = load i64, ptr %i.dm, align 8, !noundef !3
...
bb.ab:                                            ; preds = %bb.j
  ...
  %i.ea = load ptr, ptr %i.dz, align 8, !nonnull !3, !noundef !3 ; 2 uses
...
bb.af:                                            ; preds = %_RNvXsn_NtCsfYVtenZkBsn_12arrow_schema6fieldsNtB5_11UnionFieldsNtNtCsbvkFyIu7lgC_4core3cmp9PartialEq2eq.exit
  ...
  %i.eo = load i8, ptr %i.en, align 1, !range !135, !noundef !3
  %i.ep = getelementptr inbounds nuw i8, ptr %.tr2969, i64 1
  %i.eq = load i8, ptr %i.ep, align 1, !range !135, !noundef !3
...
tailrecurse:                                      ; preds = %bb.p
  ...
  %i.ev = load ptr, ptr %i.eu, align 8, !nonnull !3, !noundef !3 ; 2 uses
  %i.ew = load i8, ptr %i.et, align 8, !range !1805, !noundef !3 ; 2 uses
  %i.ex = load i8, ptr %i.ev, align 8, !range !1805, !noundef !3
...
bb.an:                                            ; preds = %bb.v, %bb.am
  ...
  %i.gf = load ptr, ptr %i.ge, align 8, !nonnull !3, !noundef !3 ; 2 uses
  %i.gg = getelementptr inbounds nuw i8, ptr %.tr2969, i64 16
  %i.gh = load ptr, ptr %i.gg, align 8, !nonnull !3, !noundef !3 ; 2 uses
