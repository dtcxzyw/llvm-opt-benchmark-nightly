...
bb.w:                                             ; preds = %_RNvXs_NtNtCsbvkFyIu7lgC_4core3str7patternNtB4_12CharSearcherNtB4_8Searcher10next_match.exit.i
  %i.bf = load i8, ptr %i.ak, align 1, !alias.scope !1956, !noalias !1959, !noundef !9 ; 2 uses
...
thread-pre-split.i:                               ; preds = %_RNvXs_NtNtCsbvkFyIu7lgC_4core3str7patternNtB4_12CharSearcherNtB4_8Searcher10next_match.exit.i
  %.pr.i = load i8, ptr %i.ak, align 1, !alias.scope !1956, !noalias !1959
  br label %bb.x
...
.preheader56.i.preheader:                         ; preds = %bb.x, %.preheader56.i
  ...
  br i1 %i.bm, label %.loopexit, label %bb.y, !prof !26

bb.y:                                             ; preds = %.preheader56.i.preheader
  %i.bn = extractvalue { i64, i1 } %i.bl, 0       ; 2 uses
  %i.bo = load i8, ptr %.sroa.0.1.i153311, align 1, !alias.scope !1956, !noalias !1959, !noundef !9
  ...
  %or.cond201 = select i1 %i.br, i1 true, i1 %i.bu, !prof !42
...
.lr.ph.i:                                         ; preds = %.preheader.i, %bb.z
  ...
  %i.bv = load i8, ptr %.sroa.0.269.i, align 1, !alias.scope !1956, !noalias !1959, !noundef !9
...
bb.aa:                                            ; preds = %_RNvMsD_NtCsbvkFyIu7lgC_4core3numy16from_ascii_radix.exit
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c), !noalias !1966
  ...
  %i.cg = load i8, ptr %i.cf, align 1, !range !1716, !alias.scope !1973, !noalias !1961, !noundef !9
  %i.ch = trunc nuw i8 %i.cg to i1
  br i1 %i.ch, label %.thread283, label %bb.ab

bb.ab:                                            ; preds = %bb.aa
  %i.ci = getelementptr inbounds nuw i8, ptr %i.l, i64 16
  %.val.i.i.i = load ptr, ptr %i.ci, align 8, !alias.scope !1973, !noalias !1961, !nonnull !9, !noundef !9 ; 3 uses
  %i.cj = getelementptr inbounds nuw i8, ptr %i.l, i64 24
  %.val1.i.i.i = load i64, ptr %i.cj, align 8, !alias.scope !1973, !noalias !1961, !noundef !9 ; 2 uses
  ...
  %i.cm = load i64, ptr %i.cl, align 8, !alias.scope !1977, !noalias !1978, !noundef !9 ; 5 uses
  %.promoted.i.i.i.i = load i64, ptr %i.ck, align 8, !alias.scope !1977, !noalias !1978 ; 2 uses
  %i.cn = icmp ult i64 %i.cm, %.promoted.i.i.i.i
  br i1 %i.cn, label %_RNvMsf_NtNtCsbvkFyIu7lgC_4core3str4iterINtB5_13SplitInternalcE7get_endCs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i, label %.lr.ph.split.preheader.i.i.i.i
...
.lr.ph.split.preheader.i.i.i.i:                   ; preds = %bb.ab
  ...
  %i.cq = load i8, ptr %i.cp, align 8, !alias.scope !1977, !noalias !1978 ; 2 uses
  %i.cr = zext nneg i8 %i.cq to i64               ; 4 uses
  %i.cs = icmp ult i8 %i.cq, 5
  br i1 %.not.i.i.i.i, label %_RNvMsf_NtNtCsbvkFyIu7lgC_4core3str4iterINtB5_13SplitInternalcE7get_endCs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i, label %.lr.ph.split.i.i.i.i
...
.lr.ph.split.i.i.i.i:                             ; preds = %.lr.ph.split.preheader.i.i.i.i
  ...
  %.pre.i.i.i.i = load i8, ptr %3, align 1, !alias.scope !1977, !noalias !1978 ; 2 uses
...
.lr.ph.i.i.i.i.i:                                 ; preds = %.preheader.i.i.i.i.i, %bb.ad
  ...
  %i.db = load i8, ptr %i.da, align 1, !alias.scope !1980, !noalias !1983, !noundef !9
...
_RNvNtNtCsbvkFyIu7lgC_4core5slice6memchr6memchr.exit.i.i.i.i: ; preds = %bb.ac, %._crit_edge.i.i.i.i.i
  ...
  br i1 %i.df, label %bb.ae, label %_RNvMsf_NtNtCsbvkFyIu7lgC_4core3str4iterINtB5_13SplitInternalcE7get_endCs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.sink.split
...
bb.af:                                            ; preds = %bb.ag, %bb.ae
  ...
  br i1 %i.dj, label %_RNvMsf_NtNtCsbvkFyIu7lgC_4core3str4iterINtB5_13SplitInternalcE7get_endCs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.sink.split, label %.lr.ph.split.i.i.i.i.a

bb.ag:                                            ; preds = %bb.ae
  %i.dk = sub nuw i64 %i.di, %i.cr                ; 2 uses
  %i.dl = getelementptr inbounds nuw i8, ptr %.val.i.i.i, i64 %i.dk
  %bcmp.i.i.i.i = call i32 @bcmp(ptr nonnull %i.dl, ptr nonnull %i.co, i64 %i.cr), !noalias !1978
...
_RNvXs_NtNtCsbvkFyIu7lgC_4core3str7patternNtB4_12CharSearcherNtB4_8Searcher10next_match.exit.i.i.i: ; preds = %bb.ag
  ...
  %i.dn = load i64, ptr %i.l, align 8, !alias.scope !1973, !noalias !1961, !noundef !9 ; 2 uses
  %i.do = sub nuw i64 %i.dk, %i.dn
  store i64 %i.di, ptr %i.l, align 8, !alias.scope !1973, !noalias !1961
  br label %select.unfold.i

_RNvMsf_NtNtCsbvkFyIu7lgC_4core3str4iterINtB5_13SplitInternalcE7get_endCs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.sink.split: ; preds = %bb.af, %_RNvNtNtCsbvkFyIu7lgC_4core5slice6memchr6memchr.exit.i.i.i.i
  %.sink = phi i64 [ %i.cm, %_RNvNtNtCsbvkFyIu7lgC_4core5slice6memchr6memchr.exit.i.i.i.i ], [ %i.di, %bb.af ]
  store i64 %.sink, ptr %i.ck, align 8
  br label %_RNvMsf_NtNtCsbvkFyIu7lgC_4core3str4iterINtB5_13SplitInternalcE7get_endCs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i

_RNvMsf_NtNtCsbvkFyIu7lgC_4core3str4iterINtB5_13SplitInternalcE7get_endCs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i: ; preds = %_RNvMsf_NtNtCsbvkFyIu7lgC_4core3str4iterINtB5_13SplitInternalcE7get_endCs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.sink.split, %.lr.ph.split.preheader.i.i.i.i, %bb.ab
  store i8 1, ptr %i.cf, align 1, !alias.scope !1984, !noalias !1961
  %i.dp = getelementptr inbounds nuw i8, ptr %i.l, i64 64
  %i.dq = load i8, ptr %i.dp, align 8, !range !1716, !alias.scope !1984, !noalias !1961, !noundef !9
  %i.dr = trunc nuw i8 %i.dq to i1
  %.pre.i2.i.i.i = load i64, ptr %i.l, align 8, !alias.scope !1984, !noalias !1961 ; 3 uses
  %.phi.trans.insert.i.i.i.i = getelementptr inbounds nuw i8, ptr %i.l, i64 8
  %.pre2.i.i.i.i = load i64, ptr %.phi.trans.insert.i.i.i.i, align 8, !alias.scope !1984, !noalias !1961 ; 2 uses
...
select.unfold.i:                                  ; preds = %_RNvMsf_NtNtCsbvkFyIu7lgC_4core3str4iterINtB5_13SplitInternalcE7get_endCs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i, %_RNvXs_NtNtCsbvkFyIu7lgC_4core3str7patternNtB4_12CharSearcherNtB4_8Searcher10next_match.exit.i.i.i
  %.sroa.4.1.i.i.i = phi i64 [ %i.do, %_RNvXs_NtNtCsbvkFyIu7lgC_4core3str7patternNtB4_12CharSearcherNtB4_8Searcher10next_match.exit.i.i.i ], [ %i.ds, %_RNvMsf_NtNtCsbvkFyIu7lgC_4core3str4iterINtB5_13SplitInternalcE7get_endCs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i ]
  %.pn.i = phi i64 [ %i.dn, %_RNvXs_NtNtCsbvkFyIu7lgC_4core3str7patternNtB4_12CharSearcherNtB4_8Searcher10next_match.exit.i.i.i ], [ %.pre.i2.i.i.i, %_RNvMsf_NtNtCsbvkFyIu7lgC_4core3str4iterINtB5_13SplitInternalcE7get_endCs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i ]
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !1966
  invoke void @_RNvMs4_NtCs6Po7BT7Nknu_5alloc7raw_vecNtB5_11RawVecInner15try_allocate_inCs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull sret([24 x i8]) align 8 captures(none) dereferenceable(24) %i.a, i64 noundef 4, i1 noundef zeroext false, i64 noundef 8, i64 noundef 16)
          to label %.noexc158 unwind label %.thread192.loopexit.split-lp.loopexit.split-lp

.noexc158:                                        ; preds = %select.unfold.i
  %i.dt = load i64, ptr %i.a, align 8, !range !24, !noalias !1966, !noundef !9
  %i.du = trunc nuw i64 %i.dt to i1
  %i.dv = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  %i.dw = load i64, ptr %i.dv, align 8, !range !25, !noalias !1966, !noundef !9 ; 3 uses
  %i.dx = getelementptr inbounds nuw i8, ptr %i.a, i64 16 ; 2 uses
  br i1 %i.du, label %bb.ah, label %_RNvMs4_NtCs6Po7BT7Nknu_5alloc7raw_vecNtB5_11RawVecInner16with_capacity_inCs9rVkZwOUgsI_13deltalake_aws.exit.i, !prof !26

bb.ah:                                            ; preds = %.noexc158
  %i.dy = load i64, ptr %i.dx, align 8, !noalias !1966
  invoke void @_RNvNtCs6Po7BT7Nknu_5alloc7raw_vec12handle_error(i64 noundef %i.dw, i64 %i.dy) #32
          to label %.noexc159 unwind label %.thread192.loopexit.split-lp.loopexit.split-lp

.noexc159:                                        ; preds = %bb.ah
  unreachable

_RNvMs4_NtCs6Po7BT7Nknu_5alloc7raw_vecNtB5_11RawVecInner16with_capacity_inCs9rVkZwOUgsI_13deltalake_aws.exit.i: ; preds = %.noexc158
  %.sroa.0.1.i.i.i154 = getelementptr inbounds nuw i8, ptr %.val.i.i.i, i64 %.pn.i
  %i.dz = load ptr, ptr %i.dx, align 8, !noalias !1966, !nonnull !9, !noundef !9 ; 5 uses
  %i.ea = icmp ugt i64 %i.dw, 3
  tail call void @llvm.assume(i1 %i.ea)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !1966
  store ptr %.sroa.0.1.i.i.i154, ptr %i.dz, align 8, !noalias !1966
  %i.eb = getelementptr inbounds nuw i8, ptr %i.dz, i64 8
  store i64 %.sroa.4.1.i.i.i, ptr %i.eb, align 8, !noalias !1966
  store i64 %i.dw, ptr %i.c, align 8, !noalias !1966
  %.sroa.4.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.c, i64 8 ; 2 uses
  store ptr %i.dz, ptr %.sroa.4.0..sroa_idx.i, align 8, !noalias !1966
  %.sroa.64.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.c, i64 16 ; 4 uses
  store i64 1, ptr %.sroa.64.0..sroa_idx.i, align 8, !noalias !1966
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !1966
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(72) %i.b, ptr noundef nonnull align 8 dereferenceable(72) %i.l, i64 72, i1 false), !noalias !1961
  ...
  %.promoted.i.i.i = load i8, ptr %i.ec, align 1, !alias.scope !1997, !noalias !2002
  %.promoted13.i.i.i = load i64, ptr %i.b, align 8, !alias.scope !2003, !noalias !2002 ; 4 uses
  %i.ed = trunc nuw i8 %.promoted.i.i.i to i1
  br i1 %i.ed, label %.loopexit285, label %.lr.ph.i.i.i155

.lr.ph.i.i.i155:                                  ; preds = %_RNvMs4_NtCs6Po7BT7Nknu_5alloc7raw_vecNtB5_11RawVecInner16with_capacity_inCs9rVkZwOUgsI_13deltalake_aws.exit.i
  %i.ee = getelementptr inbounds nuw i8, ptr %i.b, i64 16
  %.val.i.i.i.i.i = load ptr, ptr %i.ee, align 8, !alias.scope !1997, !noalias !2002, !nonnull !9, !noundef !9 ; 4 uses
  %i.ef = getelementptr inbounds nuw i8, ptr %i.b, i64 24
  %.val1.i.i.i.i.i = load i64, ptr %i.ef, align 8, !alias.scope !1997, !noalias !2002, !noundef !9 ; 2 uses
  %i.eg = getelementptr inbounds nuw i8, ptr %i.b, i64 40
  %i.eh = load i64, ptr %i.eg, align 8, !alias.scope !2004, !noalias !2007, !noundef !9 ; 5 uses
  ...
  %i.ek = load i8, ptr %i.ej, align 8, !alias.scope !2003, !noalias !2002 ; 2 uses
  ...
  %i.eq = load i8, ptr %i.ep, align 8, !range !1716, !alias.scope !2003, !noalias !2002
  %i.er = trunc nuw i8 %i.eq to i1                ; 2 uses
  %.phi.trans.insert.i.i.i.i.i.i = getelementptr inbounds nuw i8, ptr %i.b, i64 8
  %.pre2.i.i.i.i.i.i = load i64, ptr %.phi.trans.insert.i.i.i.i.i.i, align 8, !alias.scope !2003, !noalias !2002 ; 4 uses
...
.lr.ph.split.preheader.i.i.i:                     ; preds = %.lr.ph.i.i.i155
  ...
  %.promoted17.i.i.i = load i64, ptr %i.es, align 8, !alias.scope !2004, !noalias !2007
...
._crit_edge.split.us.split.us.i.i.i:              ; preds = %.lr.ph.split.us.i.i.i
  ...
  store ptr %.sroa.0.1.i.i.us.i.i.i, ptr %i.eu, align 8, !noalias !2012
  %i.ev = getelementptr inbounds nuw i8, ptr %i.dz, i64 24
  store i64 %i.et, ptr %i.ev, align 8, !noalias !2012
  store i64 2, ptr %.sroa.64.0..sroa_idx.i, align 8, !alias.scope !2013, !noalias !2012
...
.lr.ph.split.i.i.i:                               ; preds = %.lr.ph.split.preheader.i.i.i, %.noexc11.i
  ...
  br i1 %i.ex, label %_RNvMsf_NtNtCsbvkFyIu7lgC_4core3str4iterINtB5_13SplitInternalcE7get_endCs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.i.i, label %.lr.ph.split.preheader.i.i.i.i.i.i

.lr.ph.split.preheader.i.i.i.i.i.i:               ; preds = %.lr.ph.split.i.i.i
  call void @llvm.assume(i1 %i.em)
  %.pre.i.i.i.i.i.i = load i8, ptr %i.eo, align 1, !alias.scope !2004, !noalias !2007 ; 2 uses
...
bb.ai:                                            ; preds = %.lr.ph.split.i.i.i.i.i.i
  %i.fc = invoke { i64, i64 } @_RNvNtNtCsbvkFyIu7lgC_4core5slice6memchr14memchr_aligned(i8 noundef %.pre.i.i.i.i.i.i, ptr noalias noundef nonnull readonly captures(address, read_provenance) %i.fa, i64 noundef range(i64 0, -9223372036854775808) %i.ez)
          to label %_RNvNtNtCsbvkFyIu7lgC_4core5slice6memchr6memchr.exit.i.i.i.i.i.i unwind label %.loopexit.i156, !noalias !1966
...
.lr.ph.i.i.i.i.i.i.i:                             ; preds = %.preheader.i.i.i.i.i.i.i, %bb.aj
  ...
  %i.fg = load i8, ptr %i.ff, align 1, !alias.scope !2014, !noalias !2017, !noundef !9
...
_RNvNtNtCsbvkFyIu7lgC_4core5slice6memchr6memchr.exit.i.i.i.i.i.i: ; preds = %._crit_edge.i.i.i.i.i.i.i, %bb.ai
  ...
  br i1 %i.fk, label %bb.ak, label %_RNvMsf_NtNtCsbvkFyIu7lgC_4core3str4iterINtB5_13SplitInternalcE7get_endCs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.i.i
...
bb.al:                                            ; preds = %bb.am, %bb.ak
  ...
  br i1 %i.fo, label %_RNvMsf_NtNtCsbvkFyIu7lgC_4core3str4iterINtB5_13SplitInternalcE7get_endCs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.i.i, label %.lr.ph.split.i.i.i.i.i.i

bb.am:                                            ; preds = %bb.ak
  %i.fp = sub nuw i64 %i.fn, %i.el                ; 2 uses
  %i.fq = getelementptr inbounds nuw i8, ptr %.val.i.i.i.i.i, i64 %i.fp
  %bcmp.i.i.i.i.i.i = call i32 @bcmp(ptr nonnull %i.fq, ptr nonnull %i.ei, i64 %i.el), !noalias !2018
  %i.fr = icmp eq i32 %bcmp.i.i.i.i.i.i, 0
  br i1 %i.fr, label %select.unfold.i.i.i, label %bb.al

_RNvMsf_NtNtCsbvkFyIu7lgC_4core3str4iterINtB5_13SplitInternalcE7get_endCs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.i.i: ; preds = %bb.al, %_RNvNtNtCsbvkFyIu7lgC_4core5slice6memchr6memchr.exit.i.i.i.i.i.i, %.lr.ph.split.i.i.i
  %i.fs = phi i64 [ %i.ew, %.lr.ph.split.i.i.i ], [ %i.fn, %bb.al ], [ %i.eh, %_RNvNtNtCsbvkFyIu7lgC_4core5slice6memchr6memchr.exit.i.i.i.i.i.i ]
  store i8 1, ptr %i.ec, align 1, !alias.scope !2019, !noalias !2002
...
select.unfold.i.i.i:                              ; preds = %bb.am, %_RNvMsf_NtNtCsbvkFyIu7lgC_4core3str4iterINtB5_13SplitInternalcE7get_endCs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.i.i
  %i.ft = phi i64 [ %i.fs, %_RNvMsf_NtNtCsbvkFyIu7lgC_4core3str4iterINtB5_13SplitInternalcE7get_endCs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.i.i ], [ %i.fn, %bb.am ]
  %.lcssa1114.i.i.i = phi i64 [ %.lcssa111516.i.i.i, %_RNvMsf_NtNtCsbvkFyIu7lgC_4core3str4iterINtB5_13SplitInternalcE7get_endCs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.i.i ], [ %i.fn, %bb.am ]
  %i.fu = phi i1 [ true, %_RNvMsf_NtNtCsbvkFyIu7lgC_4core3str4iterINtB5_13SplitInternalcE7get_endCs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.i.i ], [ false, %bb.am ]
  %.pn.i.i.i = phi i64 [ %.pre2.i.i.i.i.i.i, %_RNvMsf_NtNtCsbvkFyIu7lgC_4core3str4iterINtB5_13SplitInternalcE7get_endCs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.i.i ], [ %i.fp, %bb.am ]
  ...
  %i.fv = load i64, ptr %.sroa.64.0..sroa_idx.i, align 8, !alias.scope !2013, !noalias !2012, !noundef !9 ; 5 uses
  %i.fw = icmp ult i64 %i.fv, 576460752303423488
  call void @llvm.assume(i1 %i.fw)
  %i.fx = load i64, ptr %i.c, align 8, !range !44, !alias.scope !2013, !noalias !2012, !noundef !9
  %i.fy = icmp eq i64 %i.fv, %i.fx
  br i1 %i.fy, label %_RNvMs_NtCs6Po7BT7Nknu_5alloc3vecINtB4_3VecReE7reserveCs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i, label %.noexc11.i

_RNvMs_NtCs6Po7BT7Nknu_5alloc3vecINtB4_3VecReE7reserveCs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i: ; preds = %select.unfold.i.i.i
  invoke void @_RINvNvMs2_NtCs6Po7BT7Nknu_5alloc7raw_vecINtB8_11RawVecInnerpE7reserve21do_reserve_and_handleNtNtBa_5alloc6GlobalECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.c, i64 noundef %i.fv, i64 noundef range(i64 1, 0) 1, i64 noundef 8, i64 noundef 16)
          to label %.noexc11.i unwind label %.loopexit.split-lp.i, !noalias !1966

.noexc11.i:                                       ; preds = %_RNvMs_NtCs6Po7BT7Nknu_5alloc3vecINtB4_3VecReE7reserveCs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i, %select.unfold.i.i.i
  %i.fz = load ptr, ptr %.sroa.4.0..sroa_idx.i, align 8, !alias.scope !2013, !noalias !2012, !nonnull !9, !noundef !9
  %i.ga = getelementptr inbounds nuw [16 x i8], ptr %i.fz, i64 %i.fv ; 2 uses
  store ptr %.sroa.0.1.i.i.i.i9.i, ptr %i.ga, align 8, !noalias !2012
  %i.gb = getelementptr inbounds nuw i8, ptr %i.ga, i64 8
  store i64 %.sroa.4.1.i.i.i.i.i, ptr %i.gb, align 8, !noalias !2012
  %i.gc = add nuw nsw i64 %i.fv, 1
  store i64 %i.gc, ptr %.sroa.64.0..sroa_idx.i, align 8, !alias.scope !2013, !noalias !2012
  br i1 %i.fu, label %.loopexit285, label %.lr.ph.split.i.i.i

.thread283:                                       ; preds = %bb.aa, %_RNvMsf_NtNtCsbvkFyIu7lgC_4core3str4iterINtB5_13SplitInternalcE7get_endCs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i
  store i64 0, ptr %i.m, align 8, !alias.scope !1961, !noalias !1964
  %i.gd = getelementptr inbounds nuw i8, ptr %i.m, i64 8
  store ptr inttoptr (i64 8 to ptr), ptr %i.gd, align 8, !alias.scope !1961, !noalias !1964
  %i.ge = getelementptr inbounds nuw i8, ptr %i.m, i64 16
  store i64 0, ptr %i.ge, align 8, !alias.scope !1961, !noalias !1964
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c), !noalias !1966
...
.loopexit.split-lp.i:                             ; preds = %_RNvMs_NtCs6Po7BT7Nknu_5alloc3vecINtB4_3VecReE7reserveCs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i
...
bb.an:                                            ; preds = %.loopexit.split-lp.i, %.loopexit.i156
  ...
  invoke void @_RNvXs1_NtCs6Po7BT7Nknu_5alloc7raw_vecINtB5_6RawVecReENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.c)
          to label %.thread188 unwind label %bb.ao, !noalias !1966

bb.ao:                                            ; preds = %bb.an
  %i.gf = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #34, !noalias !1966
  unreachable

.loopexit285:                                     ; preds = %_RNvMsf_NtNtCsbvkFyIu7lgC_4core3str4iterINtB5_13SplitInternalcE7get_endCs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.i.i, %.noexc11.i, %_RNvMs4_NtCs6Po7BT7Nknu_5alloc7raw_vecNtB5_11RawVecInner16with_capacity_inCs9rVkZwOUgsI_13deltalake_aws.exit.i, %.lr.ph.split.us.i.i.i, %._crit_edge.split.us.split.us.i.i.i
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !1966
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.m, ptr noundef nonnull align 8 dereferenceable(24) %i.c, i64 24, i1 false), !noalias !1964
...
bb.ap:                                            ; preds = %.thread283, %.loopexit285
  store i64 -9223372036854775808, ptr %0, align 16
  br label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6Po7BT7Nknu_5alloc6string6StringECs9rVkZwOUgsI_13deltalake_aws.exit170

bb.aq:                                            ; preds = %.loopexit285
  %i.gi = load ptr, ptr %i.gg, align 8, !nonnull !9, !noundef !9
  %i.gj = getelementptr [16 x i8], ptr %i.gi, i64 %.pre ; 2 uses
  %i.gk = getelementptr i8, ptr %i.gj, i64 -16
  %i.gl = load ptr, ptr %i.gk, align 8, !nonnull !9, !noundef !9
  %i.gm = getelementptr i8, ptr %i.gj, i64 -8
  %i.gn = load i64, ptr %i.gm, align 8, !noundef !9 ; 5 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d)
  invoke void @_RNvMs4_NtCs6Po7BT7Nknu_5alloc7raw_vecNtB5_11RawVecInner15try_allocate_inCs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull sret([24 x i8]) align 8 captures(none) dereferenceable(24) %i.d, i64 noundef %i.gn, i1 noundef zeroext false, i64 noundef 1, i64 noundef 1)
          to label %bb.as unwind label %bb.ar

_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6Po7BT7Nknu_5alloc6string6StringECs9rVkZwOUgsI_13deltalake_aws.exit170: ; preds = %bb.ch, %bb.ap
  call void @llvm.lifetime.end.p0(ptr nonnull %i.k)
  invoke void @_RNvXs1_NtCs6Po7BT7Nknu_5alloc7raw_vecINtB5_6RawVecReENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.m)
          to label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VecReEECs9rVkZwOUgsI_13deltalake_aws.exit unwind label %.thread192.loopexit.split-lp.loopexit.split-lp

_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6Po7BT7Nknu_5alloc6string6StringECs9rVkZwOUgsI_13deltalake_aws.exit164: ; preds = %bb.ba, %bb.ar
...
bb.ar:                                            ; preds = %bb.ch, %bb.at, %bb.aq
  %i.go = landingpad { ptr, i32 }
          cleanup
  br label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6Po7BT7Nknu_5alloc6string6StringECs9rVkZwOUgsI_13deltalake_aws.exit164

bb.as:                                            ; preds = %bb.aq
  %i.gp = load i64, ptr %i.d, align 8, !range !24, !noundef !9
  %i.gq = trunc nuw i64 %i.gp to i1
  %i.gr = getelementptr inbounds nuw i8, ptr %i.d, i64 8
  %i.gs = load i64, ptr %i.gr, align 8, !range !25, !noundef !9 ; 3 uses
  %i.gt = getelementptr inbounds nuw i8, ptr %i.d, i64 16 ; 2 uses
  br i1 %i.gq, label %bb.at, label %bb.au, !prof !26

bb.at:                                            ; preds = %bb.as
  %i.gu = load i64, ptr %i.gt, align 8
  invoke void @_RNvNtCs6Po7BT7Nknu_5alloc7raw_vec12handle_error(i64 noundef %i.gs, i64 %i.gu) #32
          to label %bb.i unwind label %bb.ar

bb.au:                                            ; preds = %bb.as
  %i.gv = load ptr, ptr %i.gt, align 8, !nonnull !9, !noundef !9 ; 2 uses
