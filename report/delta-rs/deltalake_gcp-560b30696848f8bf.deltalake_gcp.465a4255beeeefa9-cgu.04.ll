...
bb.j:                                             ; preds = %bb.f
  %i.as = landingpad { ptr, i32 }
          cleanup
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCsjyY8HP3IvQ6_12object_store3gcp7builder25GoogleCloudStorageBuilderECs62u4JVtZyFF_13deltalake_gcp(ptr noalias noundef align 8 dereferenceable(872) %i.y) #20
