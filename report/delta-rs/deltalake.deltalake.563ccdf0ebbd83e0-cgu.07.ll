...
common.resume:                                    ; preds = %bb.dd, %.body.i.a, %.body.i.i, %.body.thread.i2, %bb.v, %bb.y, %.body.thread.i
  %common.resume.op = phi { ptr, i32 } [ %eh.lpad-body.i.i, %.body.i.i ], [ %i.ch, %bb.v ], [ %eh.lpad-body26.i, %.body.thread.i ], [ %i.cj, %bb.y ], [ %.pn.pn63.i, %.body.thread.i2 ], [ %eh.lpad-body21.i, %.body.i.a ], [ %i.iz, %bb.dd ]
...
.body.thread.i2:                                  ; preds = %bb.cy, %bb.ax, %bb.au, %.body.i.a
  %.pn.pn63.i = phi { ptr, i32 } [ %eh.lpad-body21.i, %.body.i.a ], [ %i.ez, %bb.ax ], [ %lpad.thr_comm.i, %bb.cy ], [ %lpad.thr_comm.split-lp.i, %bb.au ]
