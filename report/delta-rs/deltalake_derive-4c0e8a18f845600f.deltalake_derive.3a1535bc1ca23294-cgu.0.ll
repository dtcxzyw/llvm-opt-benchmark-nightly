...
define hidden void @_RNvXNtNtCsbvkFyIu7lgC_4core3ops12control_flowINtB2_11ControlFlowNtCsbjGuDcEILED_11proc_macro211TokenStreamENtNtB4_9try_trait3Try11from_outputCs4ZaLwAtrTbk_16deltalake_derive(ptr writeonly sret([32 x i8]) align 8 captures(none) initializes((0, 8)) %0) unnamed_addr #6 {
bb.a:
...
define hidden void @_RNvXNtNtCsjJ0p09o2jmV_10proc_macro6bridge3rpcuINtB2_6EncodeuE6encodeCs4ZaLwAtrTbk_16deltalake_derive(ptr readnone align 8 captures(none) %0, ptr readnone captures(none) %1) unnamed_addr #7 {
bb.a:
  ret void
}
...
; Function Attrs: inlinehint nonlazybind uwtable
define hidden i32 @_RNvXs1_NtCsbvkFyIu7lgC_4core7convertNtCsbjGuDcEILED_11proc_macro211TokenStreamINtB5_4IntoNtCsjJ0p09o2jmV_10proc_macro11TokenStreamE4intoCs4ZaLwAtrTbk_16deltalake_derive(ptr align 8 %0, ptr readnone align 8 captures(none) %1) unnamed_addr #3 {
bb.a:
...
define hidden void @_RNvXs1_NtNtCsjJ0p09o2jmV_10proc_macro6bridge6clientNtB5_11TokenStreamINtNtB7_3rpc6EncodeuE6encodeCs4ZaLwAtrTbk_16deltalake_derive(i32 %0, ptr align 8 %1, ptr readnone captures(none) %2) unnamed_addr #0 {
bb.a:
...
define hidden zeroext i1 @_RNvXs3_NtNtCsbvkFyIu7lgC_4core3str7patternNvMNtNtB9_4char7methodsc13is_whitespaceNtB5_11MultiCharEq7matchesCs4ZaLwAtrTbk_16deltalake_derive(ptr readnone captures(none) %0, i32 %1) unnamed_addr #8 {
bb.a:
...
; Function Attrs: nonlazybind uwtable
define hidden range(i32 1, 0) i32 @_RNvXs3_NtNtCsjJ0p09o2jmV_10proc_macro6bridge6clientNtB5_11TokenStreamINtNtB7_3rpc6DecodeuE6decodeCs4ZaLwAtrTbk_16deltalake_derive(ptr align 8 captures(none) %0, ptr readnone captures(none) %1) unnamed_addr #0 {
bb.a:
...
; Function Attrs: nonlazybind uwtable
define hidden void @_RNvXs5_NtCsBGNUbrdbJ0_5quote9___privateINtB5_9RepInterpRNtCsbjGuDcEILED_11proc_macro211TokenStreamENtNtB7_9to_tokens8ToTokens9to_tokensCs4ZaLwAtrTbk_16deltalake_derive(ptr readonly align 8 captures(none) %0, ptr align 8 %1) unnamed_addr #0 {
bb.a:
...
; Function Attrs: nonlazybind uwtable
define hidden range(i32 1, 0) i32 @_RNvXs7_NtNtCsjJ0p09o2jmV_10proc_macro6bridge6clientNtB5_4SpanINtNtB7_3rpc6DecodeuE6decodeCs4ZaLwAtrTbk_16deltalake_derive(ptr align 8 captures(none) %0, ptr readnone captures(none) %1) unnamed_addr #0 {
bb.a:
  %i.a = alloca [4 x i8], align 4                 ; 5 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a)
  store i32 0, ptr %i.a, align 4
