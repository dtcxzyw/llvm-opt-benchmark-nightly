...
.noexc39.i.i:                                     ; preds = %.noexc38.i.i
  ...
  %i.y = load i32, ptr %i.x, align 4, !range !63, !noalias !60, !noundef !9
  ...
  %i.aa = getelementptr inbounds nuw i8, ptr %i.f, i64 8 ; 3 uses
...
bb.c:                                             ; preds = %.noexc39.i.i
  ...
  %2 = load i32, ptr %i.aa, align 8, !range !63, !noalias !64, !noundef !9
  %i.ac = invoke noundef i32 @_RNvCshbKHpCRGxgC_16deltalake_derive19derive_delta_config(i32 noundef range(i32 1, 0) %2)
