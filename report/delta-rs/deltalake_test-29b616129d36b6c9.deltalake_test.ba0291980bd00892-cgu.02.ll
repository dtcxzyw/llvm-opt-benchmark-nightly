...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.z, label %.lr.ph.i.preheader6, label %vector.body, !llvm.loop !1234
...
bb.c:                                             ; preds = %.lr.ph.i
  ...
  %i.af = load <2 x i64>, ptr %.sroa.014.022.i, align 8, !alias.scope !1229, !noalias !1235
