...
.body.a:                                          ; preds = %bb.an, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6D2ubN3bMGD_16aws_sdk_dynamodb6client6ClientECs9rVkZwOUgsI_13deltalake_aws.exit
  %.sroa.032.0 = phi i8 [ %.sroa.032.2, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6D2ubN3bMGD_16aws_sdk_dynamodb6client6ClientECs9rVkZwOUgsI_13deltalake_aws.exit ], [ %.sroa.032.1, %bb.an ]
  ...
  %.pn118.pn.pn = phi { ptr, i32 } [ %.pn118.pn, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6D2ubN3bMGD_16aws_sdk_dynamodb6client6ClientECs9rVkZwOUgsI_13deltalake_aws.exit ], [ %i.df, %bb.an ] ; 2 uses
  %10 = trunc nuw i8 %.sroa.032.0 to i1
  br i1 %10, label %.body.thread, label %bb.dl
...
bb.an:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6D2ubN3bMGD_16aws_sdk_dynamodb6client6ClientECs9rVkZwOUgsI_13deltalake_aws.exit209, %bb.cx
  %.sroa.032.1 = phi i8 [ %.sroa.032.8, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6D2ubN3bMGD_16aws_sdk_dynamodb6client6ClientECs9rVkZwOUgsI_13deltalake_aws.exit209 ], [ 0, %bb.cx ]
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6D2ubN3bMGD_16aws_sdk_dynamodb6client6ClientECs9rVkZwOUgsI_13deltalake_aws.exit: ; preds = %.body126, %bb.ax, %bb.ap
  %.sroa.032.2 = phi i8 [ %.sroa.032.3, %bb.ap ], [ %.sroa.032.4, %bb.ax ], [ %.sroa.032.4, %.body126 ]
  ...
  %.pn118.pn = phi { ptr, i32 } [ %i.dh, %bb.ap ], [ %.pn118, %bb.ax ], [ %.pn118, %.body126 ]
...
bb.ap:                                            ; preds = %bb.dg, %bb.ao
  %.sroa.032.3 = phi i8 [ %.sroa.032.8, %bb.dg ], [ 1, %bb.ao ]
...
.body126:                                         ; preds = %bb.cz, %bb.cw, %bb.bd, %.body129, %bb.au, %bb.ay, %bb.do, %bb.dm
  %.sroa.032.4 = phi i8 [ 1, %bb.do ], [ 1, %.body129 ], [ 1, %bb.bd ], [ %.sroa.032.6.ph, %bb.dm ], [ 1, %bb.au ], [ %.sroa.032.8, %bb.ay ], [ 0, %bb.cw ], [ %.sroa.032.8, %bb.cz ] ; 2 uses
...
bb.bm:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6Po7BT7Nknu_5alloc6string6StringECs9rVkZwOUgsI_13deltalake_aws.exit.i202, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs6D2ubN3bMGD_16aws_sdk_dynamodb10primitives19sealed_enum_unknown19UnknownVariantValueECs9rVkZwOUgsI_13deltalake_aws.exit.i, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6Po7BT7Nknu_5alloc6string6StringECs9rVkZwOUgsI_13deltalake_aws.exit.i171
  %.sroa.032.7 = phi i8 [ 1, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6Po7BT7Nknu_5alloc6string6StringECs9rVkZwOUgsI_13deltalake_aws.exit.i202 ], [ 0, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs6D2ubN3bMGD_16aws_sdk_dynamodb10primitives19sealed_enum_unknown19UnknownVariantValueECs9rVkZwOUgsI_13deltalake_aws.exit.i ], [ 1, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6Po7BT7Nknu_5alloc6string6StringECs9rVkZwOUgsI_13deltalake_aws.exit.i171 ]
...
begin_hunk_4_@_RNvMs1_Cs9rVkZwOUgsI_13deltalake_awsNtB5_18DynamoDbLockClient7try_new:bb.a
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCsjPG5xYjJYir_9aws_types10sdk_config9SdkConfigECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef align 8 dereferenceable(416) %i.ak)
          to label %11 unwind label %bb.an
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionNtNtCs6Po7BT7Nknu_5alloc6string6StringEECs9rVkZwOUgsI_13deltalake_aws.exit215: ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6Po7BT7Nknu_5alloc6string6StringECs9rVkZwOUgsI_13deltalake_aws.exit.i211, %bb.dh, %11
  ret void
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs6D2ubN3bMGD_16aws_sdk_dynamodb5types13__billing_mode11BillingModeECs9rVkZwOUgsI_13deltalake_aws.exit: ; preds = %bb.cr, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs6D2ubN3bMGD_16aws_sdk_dynamodb10primitives19sealed_enum_unknown19UnknownVariantValueECs9rVkZwOUgsI_13deltalake_aws.exit.i, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionNtNtCs6Po7BT7Nknu_5alloc6string6StringEECs9rVkZwOUgsI_13deltalake_aws.exit207
  %.sroa.032.8 = phi i8 [ 1, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionNtNtCs6Po7BT7Nknu_5alloc6string6StringEECs9rVkZwOUgsI_13deltalake_aws.exit207 ], [ 0, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs6D2ubN3bMGD_16aws_sdk_dynamodb10primitives19sealed_enum_unknown19UnknownVariantValueECs9rVkZwOUgsI_13deltalake_aws.exit.i ], [ 0, %bb.cr ] ; 5 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.ae)
...
bb.dl:                                            ; preds = %.body.thread, %.body.a
  %.sroa.037.6 = phi i8 [ %.sroa.037.0261, %.body.thread ], [ %.sroa.037.0, %.body.a ]
  %.sroa.038.4 = phi i8 [ %.sroa.038.0262, %.body.thread ], [ %.sroa.038.0, %.body.a ]
  %.pn118.pn.pn.pn = phi { ptr, i32 } [ %.pn118.pn.pn263, %.body.thread ], [ %.pn118.pn.pn, %.body.a ] ; 2 uses
...
bb.dm:                                            ; preds = %.body166, %.thread234, %bb.bm, %bb.bj, %bb.cf, %bb.ct, %bb.de
  %.sroa.032.6.ph = phi i8 [ 0, %.thread234 ], [ 1, %.body166 ], [ 1, %bb.bj ], [ 0, %bb.ct ], [ %.sroa.032.7, %bb.bm ], [ 1, %bb.cf ], [ 1, %bb.de ]
...
.body.thread:                                     ; preds = %bb.ak, %bb.am, %.body.a
  %.pn118.pn.pn263 = phi { ptr, i32 } [ %.pn118.pn.pn, %.body.a ], [ %.pn2090.i, %bb.am ], [ %.pn2090.i, %bb.ak ]
  %.sroa.038.0262 = phi i8 [ %.sroa.038.0, %.body.a ], [ 1, %bb.am ], [ 1, %bb.ak ]
  %.sroa.037.0261 = phi i8 [ %.sroa.037.0, %.body.a ], [ 1, %bb.am ], [ 1, %bb.ak ]
...
.thread248.thread:                                ; preds = %bb.dj, %bb.dq, %.thread248
  %.pn118.pn.pn.pn253256 = phi { ptr, i32 } [ %.pn118.pn.pn.pn, %.thread248 ], [ %.pn118.pn.pn.pn, %bb.dq ], [ %i.iu, %bb.dj ]
  resume { ptr, i32 } %.pn118.pn.pn.pn253256
