begin_hunk_0
  ...
  %i.gq = load ptr, ptr %.sroa.7.0..sroa_idx222, align 8, !alias.scope !1277, !noalias !1280, !nonnull !12, !noundef !12 ; 3 uses
  ...
  switch i64 %i.gs, label %thread-pre-split.i.i.i [
    i64 0, label %_RNvMsD_NtCsbvkFyIu7lgC_4core3numy16from_ascii_radix.exit.i.i
    i64 1, label %bb.cj
  ]

bb.cj:                                            ; preds = %bb.ci
  %i.gt = load i8, ptr %i.gq, align 1, !alias.scope !1282, !noalias !1285, !noundef !12 ; 2 uses
  switch i8 %i.gt, label %bb.ck [
...
thread-pre-split.i.i.i:                           ; preds = %bb.ci
  %.pr.i.i.i = load i8, ptr %i.gq, align 1, !alias.scope !1282, !noalias !1285
  br label %bb.ck

bb.ck:                                            ; preds = %thread-pre-split.i.i.i, %bb.cj
  %10 = phi i8 [ %.pr.i.i.i, %thread-pre-split.i.i.i ], [ %i.gt, %bb.cj ]
  %cond.i.i.i = icmp eq i8 %10, 43                ; 2 uses
  %i.gu = sext i1 %cond.i.i.i to i64
  %.sroa.15.0.i.i.i = add nsw i64 %i.gs, %i.gu    ; 4 uses
  ...
  br i1 %i.gv, label %.preheader.i.i.i, label %.preheader56.i.i.i.preheader

.preheader.i.i.i:                                 ; preds = %bb.ck
  %.not5366.i.i.i = icmp eq i64 %.sroa.15.0.i.i.i, 0
  br i1 %.not5366.i.i.i, label %_RNvMsD_NtCsbvkFyIu7lgC_4core3numy16from_ascii_radix.exit.i.i, label %.lr.ph.i.i.i
...
.lr.ph.i.i.i:                                     ; preds = %.preheader.i.i.i, %bb.co
  %.sroa.0.269.i.i.i = phi ptr [ %i.hq, %bb.co ], [ %.sroa.0.0.i.i.i, %.preheader.i.i.i ] ; 2 uses
  %.sroa.15.268.i.i.i = phi i64 [ %i.hp, %bb.co ], [ %.sroa.15.0.i.i.i, %.preheader.i.i.i ]
  %.sroa.042.267.i.i.i = phi i64 [ %i.hs, %bb.co ], [ 0, %.preheader.i.i.i ]
...
_RNvMsD_NtCsbvkFyIu7lgC_4core3numy16from_ascii_radix.exit.i.i: ; preds = %bb.cl, %bb.cn, %.preheader56.i.i.i, %.lr.ph.i.i.i, %bb.co, %bb.ci, %bb.cj, %bb.cj, %bb.cm, %.preheader.i.i.i
  %.sroa.0.0 = phi i64 [ %i.gs, %bb.ci ], [ %i.hs, %bb.co ], [ 0, %.preheader.i.i.i ], [ 1, %bb.cj ], [ %spec.select.i.i, %bb.cm ], [ 1, %bb.cj ], [ 1, %.lr.ph.i.i.i ], [ 2, %bb.cn ], [ 1, %bb.cl ], [ %i.hi, %.preheader56.i.i.i ] ; 2 uses
  %11 = phi i1 [ true, %bb.ci ], [ %i.hn, %.lr.ph.i.i.i ], [ false, %.preheader.i.i.i ], [ true, %bb.cj ], [ true, %bb.cm ], [ true, %bb.cj ], [ %i.hn, %bb.co ], [ true, %bb.cn ], [ true, %bb.cl ], [ false, %.preheader56.i.i.i ]
  %.sink.i.i = phi i32 [ 1000000000, %bb.ci ], [ 0, %bb.co ], [ 0, %.preheader.i.i.i ], [ 1000000000, %bb.cj ], [ 1000000000, %bb.cm ], [ 1000000000, %bb.cj ], [ 1000000000, %.lr.ph.i.i.i ], [ 1000000000, %bb.cn ], [ 1000000000, %bb.cl ], [ 0, %.preheader56.i.i.i ]
...
_RINvMNtCsbvkFyIu7lgC_4core6optionINtB3_6OptionNtNtCs6Po7BT7Nknu_5alloc6string6StringE11map_or_elseINtNtB5_6result6ResultNtNtB5_4time8DurationNtNtNtB5_3num5error13ParseIntErrorENCNvMs1_Cs9rVkZwOUgsI_13deltalake_awsNtB2W_18DynamoDbLockClient7try_news2_0NCB2Q_s3_0EB2W_.exit: ; preds = %_RNCNvMs1_Cs9rVkZwOUgsI_13deltalake_awsNtB7_18DynamoDbLockClient7try_news3_0B7_.exit.i
  ...
  br i1 %11, label %bb.cr, label %bb.cv
...
bb.bx:                                            ; preds = %bb.bw
  %i.kc = load i8, ptr %.val, align 1, !alias.scope !1753, !noalias !1756, !noundef !12 ; 2 uses
...
bb.by:                                            ; preds = %thread-pre-split.i.i, %bb.bx
  %2 = phi i8 [ %.pr.i.i, %thread-pre-split.i.i ], [ %i.kc, %bb.bx ]
  %cond.i.i = icmp eq i8 %2, 43                   ; 2 uses
  %i.kd = sext i1 %cond.i.i to i64
  %.sroa.15.0.i.i = add nsw i64 %.val192, %i.kd   ; 4 uses
  ...
  br i1 %i.ke, label %.preheader.i.i, label %.preheader56.i.i.preheader

.preheader.i.i:                                   ; preds = %bb.by
  %.not5366.i.i = icmp eq i64 %.sroa.15.0.i.i, 0
  br i1 %.not5366.i.i, label %.loopexit, label %.lr.ph.i.i
...
.lr.ph.i.i:                                       ; preds = %.preheader.i.i, %bb.cc
  %.sroa.0.269.i.i = phi ptr [ %i.kz, %bb.cc ], [ %.sroa.0.0.i.i199, %.preheader.i.i ] ; 2 uses
  %.sroa.15.268.i.i = phi i64 [ %i.ky, %bb.cc ], [ %.sroa.15.0.i.i, %.preheader.i.i ]
  %.sroa.042.267.i.i = phi i64 [ %i.lb, %bb.cc ], [ 0, %.preheader.i.i ]
...
.loopexit:                                        ; preds = %.preheader56.i.i, %bb.cc, %.preheader.i.i
  %.sroa.5.0.ph = phi i64 [ %i.lb, %bb.cc ], [ 0, %.preheader.i.i ], [ %i.kr, %.preheader56.i.i ]
