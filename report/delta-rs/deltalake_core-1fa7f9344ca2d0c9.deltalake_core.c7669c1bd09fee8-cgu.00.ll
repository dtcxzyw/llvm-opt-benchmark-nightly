...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <2 x ptr> %vector.gep, ptr %i.s, align 8, !noalias !22298
  store <2 x ptr> %step.add3, ptr %i.t, align 8, !noalias !22298
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %ptr.ind = getelementptr i8, ptr %pointer.phi, i64 160
  %i.u = icmp eq i64 %index.next, %n.vec
  br i1 %i.u, label %middle.block, label %vector.body, !llvm.loop !22304
...
.lr.ph.i.i.i.i:                                   ; preds = %.lr.ph.i.i.i.i.preheader4, %.lr.ph.i.i.i.i
  ...
  store ptr %.sroa.0.06.i.i.i.i, ptr %i.w, align 8, !noalias !22298
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.s = getelementptr inbounds nuw [8 x i8], ptr %i.l, i64 %index ; 2 uses
  %i.t = getelementptr inbounds nuw i8, ptr %i.s, i64 16
  store <2 x ptr> %vector.gep, ptr %i.s, align 8, !noalias !39235
  store <2 x ptr> %step.add8, ptr %i.t, align 8, !noalias !39235
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %ptr.ind = getelementptr i8, ptr %pointer.phi, i64 448
  %i.u = icmp eq i64 %index.next, %n.vec
  br i1 %i.u, label %middle.block, label %vector.body, !llvm.loop !39241
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.preheader9, %.lr.ph.i.i.i
  ...
  %i.w = getelementptr inbounds nuw [8 x i8], ptr %i.l, i64 %i.v
  store ptr %.sroa.0.06.i.i.i, ptr %i.w, align 8, !noalias !39235
  %i.x = add nuw nsw i64 %i.v, 1                  ; 2 uses
  %i.y = getelementptr inbounds nuw i8, ptr %.sroa.0.06.i.i.i, i64 112 ; 2 uses
  %i.z = icmp eq ptr %i.y, %2
  br i1 %i.z, label %.loopexit, label %.lr.ph.i.i.i, !llvm.loop !39242
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.s = getelementptr inbounds nuw [8 x i8], ptr %i.l, i64 %index ; 2 uses
  %i.t = getelementptr inbounds nuw i8, ptr %i.s, i64 16
  store <2 x ptr> %vector.gep, ptr %i.s, align 8, !noalias !39243
  store <2 x ptr> %step.add8, ptr %i.t, align 8, !noalias !39243
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %ptr.ind = getelementptr i8, ptr %pointer.phi, i64 512
  %i.u = icmp eq i64 %index.next, %n.vec
  br i1 %i.u, label %middle.block, label %vector.body, !llvm.loop !39249
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.preheader9, %.lr.ph.i.i.i
  ...
  %.sroa.0.06.i.i.i = phi ptr [ %i.y, %.lr.ph.i.i.i ], [ %.sroa.0.06.i.i.i.ph, %.lr.ph.i.i.i.preheader9 ] ; 2 uses
  %i.w = getelementptr inbounds nuw [8 x i8], ptr %i.l, i64 %i.v
  store ptr %.sroa.0.06.i.i.i, ptr %i.w, align 8, !noalias !39243
  %i.x = add nuw nsw i64 %i.v, 1                  ; 2 uses
  %i.y = getelementptr inbounds nuw i8, ptr %.sroa.0.06.i.i.i, i64 128 ; 2 uses
  %i.z = icmp eq ptr %i.y, %2
  br i1 %i.z, label %.loopexit, label %.lr.ph.i.i.i, !llvm.loop !39250
