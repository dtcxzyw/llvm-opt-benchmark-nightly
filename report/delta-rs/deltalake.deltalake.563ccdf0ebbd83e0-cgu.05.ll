...
bb.f:                                             ; preds = %bb.d, %bb.e
  ...
  %.sroa.0.0.i18 = tail call noundef range(i64 0, -1) i64 @llvm.umin.i64(i64 range(i64 -164703072086692424, 192153584101141163) %1, i64 range(i64 0, -1) %i.d) ; 3 uses
  %2 = icmp uge i64 %1, %.sroa.04.0
