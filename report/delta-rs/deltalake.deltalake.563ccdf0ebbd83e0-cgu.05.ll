...
.preheader:                                       ; preds = %.critedge, %.preheader
  ...
  %6 = icmp sgt i64 %spec.select.i.i.i.i.i.i, -1  ; 2 uses
  %..i = select i1 %6, ptr %i.l, ptr %i.k
...
.lr.ph.i:                                         ; preds = %.critedge, %.lr.ph.i
  ...
  %spec.select.i.i.i.i.i.i21 = select i1 %i.ai, i64 %i.aj, i64 %i.ah ; 2 uses
  %i.ak = icmp sgt i64 %spec.select.i.i.i.i.i.i21, -1 ; 2 uses
  %spec.select.i = select i1 %i.ak, ptr %i.ab, ptr %.sroa.0.02.i
