...
begin_hunk_0_@_RNvMs6_NtCs2HSpDNxY7OE_9hashbrown3rawINtB5_8RawTablejE16with_capacity_inCs7p2uQeJxui2_9deltalake:bb.a
...
bb.a:
  ...
  %.sroa.0.0.copyload.i68.i = load <16 x i8>, ptr %i.b, align 1, !noalias !11365
...
bb.b:                                             ; preds = %._crit_edge.i
  %i.l = load <16 x i8>, ptr %.val, align 16, !noalias !11368
...
.lr.ph.i:                                         ; preds = %bb.a, %.lr.ph.i
  ...
  %.sroa.0.0.copyload.i6.i = load <16 x i8>, ptr %i.t, align 1, !noalias !11365
...
bb.a:
  ...
  %i.m = load atomic i64, ptr %i.k monotonic, align 128, !noalias !11371 ; 2 uses
  %i.n = load i64, ptr %i.l, align 16, !noalias !11371, !noundef !4 ; 2 uses
  %i.o = and i64 %i.n, %i.m
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.lr.ph, %bb.ah
  %i.w = phi i64 [ %i.n, %.lr.ph.i.lr.ph ], [ %i.cv, %bb.ah ]
  %i.x = phi i64 [ %i.m, %.lr.ph.i.lr.ph ], [ %i.cu, %bb.ah ]
...
bb.b:                                             ; preds = %_RNvMs1_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5utilsNtB5_7Backoff10spin_light.exit22.i, %.lr.ph.i
  ...
  %.sroa.0.02832.i = phi i32 [ 0, %.lr.ph.i ], [ %.sroa.0.1.i, %_RNvMs1_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5utilsNtB5_7Backoff10spin_light.exit22.i ] ; 11 uses
  %i.z = add i64 %i.y, -1
  %i.aa = and i64 %i.z, %.sroa.02.033.i           ; 3 uses
  %i.ab = load i64, ptr %i.q, align 8, !noalias !11374, !noundef !4
  %i.ac = sub i64 0, %i.ab
  %i.ad = and i64 %.sroa.02.033.i, %i.ac
  %i.ae = load ptr, ptr %i.r, align 8, !noalias !11374, !nonnull !4, !noundef !4
  %i.af = load i64, ptr %i.s, align 32, !noalias !11374, !noundef !4
  %i.ag = icmp ult i64 %i.aa, %i.af
  call void @llvm.assume(i1 %i.ag)
  %i.ah = getelementptr inbounds nuw [32 x i8], ptr %i.ae, i64 %i.aa ; 5 uses
  %i.ai = load atomic i64, ptr %i.ah acquire, align 8, !noalias !11374 ; 2 uses
  %i.aj = icmp eq i64 %.sroa.02.033.i, %i.ai
  br i1 %i.aj, label %bb.d, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.ak = load i64, ptr %i.q, align 8, !noalias !11374, !noundef !4
...
bb.d:                                             ; preds = %bb.b
  ...
  %i.ap = load i64, ptr %i.t, align 128, !noalias !11374, !noundef !4
...
.lr.ph.i.i.preheader:                             ; preds = %bb.g
  %i.as = mul nuw i32 %.sroa.0.02832.i, %.sroa.0.02832.i ; 3 uses
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i, %.lr.ph.i.i.preheader.new
  ...
  call void @llvm.x86.sse2.pause(), !noalias !11374
  call void @llvm.x86.sse2.pause(), !noalias !11374
  call void @llvm.x86.sse2.pause(), !noalias !11374
  call void @llvm.x86.sse2.pause(), !noalias !11374
  call void @llvm.x86.sse2.pause(), !noalias !11374
...
.lr.ph.i.i.epil:                                  ; preds = %.lr.ph.i.i.epil, %.lr.ph.i.i.epil.preheader
  ...
  br i1 %epil.iter.cmp.not, label %_RNvMs1_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5utilsNtB5_7Backoff10spin_heavy.exit.i, label %.lr.ph.i.i.epil, !llvm.loop !11376
...
bb.h:                                             ; preds = %bb.c
  fence seq_cst
  %i.av = load atomic i64, ptr %1 monotonic, align 128, !noalias !11374
  %i.aw = load i64, ptr %i.q, align 8, !noalias !11374, !noundef !4
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.az = mul nuw nsw i32 %.sroa.0.0.i.i.i, %.sroa.0.0.i.i.i ; 3 uses
...
.lr.ph.i12.i.preheader:                           ; preds = %bb.i
  ...
  %i.ba = icmp samesign ult i32 %i.az, 8
...
.lr.ph.i12.i.epil:                                ; preds = %.lr.ph.i12.i.epil, %.lr.ph.i12.i.epil.preheader
  ...
  br i1 %epil.iter93.cmp.not, label %._crit_edge.loopexit.i.i, label %.lr.ph.i12.i.epil, !llvm.loop !11377
...
_RNvMs1_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5utilsNtB5_7Backoff10spin_light.exit22.i: ; preds = %._crit_edge.loopexit.i20.i, %bb.m, %._crit_edge.loopexit.i.i, %bb.i, %_RNvMs1_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5utilsNtB5_7Backoff10spin_heavy.exit.i
  ...
  %i.bc = load atomic i64, ptr %i.k monotonic, align 128, !noalias !11374 ; 2 uses
  %i.bd = load i64, ptr %i.l, align 16, !noalias !11374, !noundef !4 ; 2 uses
...
bb.j:                                             ; preds = %bb.d
  %i.bg = load i64, ptr %i.q, align 8, !noalias !11374, !noundef !4
...
bb.l:                                             ; preds = %bb.k, %bb.j
  ...
  %i.bj = cmpxchg weak ptr %i.k, i64 %.sroa.02.033.i, i64 %.sroa.01.0.i seq_cst monotonic, align 8, !noalias !11374
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.bk = mul nuw nsw i32 %.sroa.0.0.i.i15.i, %.sroa.0.0.i.i15.i ; 3 uses
...
.lr.ph.i17.i.preheader:                           ; preds = %bb.m
  ...
  %i.bl = icmp samesign ult i32 %i.bk, 8
...
.lr.ph.i17.i.epil:                                ; preds = %.lr.ph.i17.i.epil, %.lr.ph.i17.i.epil.preheader
  ...
  br i1 %epil.iter99.cmp.not, label %._crit_edge.loopexit.i20.i, label %.lr.ph.i17.i.epil, !llvm.loop !11378
...
_RNvMs_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5arrayINtB4_7ChannelINtNtCsbvkFyIu7lgC_4core6result6ResultuNtNtCscq8Lx7CD32J_17opentelemetry_sdk5error12OTelSdkErrorEE10start_sendCs7p2uQeJxui2_9deltalake.exit: ; preds = %bb.h
  %i.bn = load i32, ptr %i.i, align 8, !range !11110, !noundef !4 ; 2 uses
...
_RNvMs_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5arrayINtB4_7ChannelINtNtCsbvkFyIu7lgC_4core6result6ResultuNtNtCscq8Lx7CD32J_17opentelemetry_sdk5error12OTelSdkErrorEE5writeCs7p2uQeJxui2_9deltalake.exit.thread: ; preds = %bb.l
  store ptr %i.ah, ptr %i.g, align 8, !alias.scope !11374
  %i.bo = add i64 %.sroa.02.033.i, 1              ; 2 uses
  store i64 %i.bo, ptr %i.j, align 8, !alias.scope !11374
  ...
  store i64 %.sroa.018.0.copyload35, ptr %i.bp, align 8, !noalias !11379
  ...
  store atomic i64 %i.bo, ptr %i.ah release, align 8, !noalias !11382
...
bb.o:                                             ; preds = %bb.ad, %bb.ae, %_RNvMs_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5arrayINtB4_7ChannelINtNtCsbvkFyIu7lgC_4core6result6ResultuNtNtCscq8Lx7CD32J_17opentelemetry_sdk5error12OTelSdkErrorEE10start_sendCs7p2uQeJxui2_9deltalake.exit
  call void @llvm.lifetime.start.p0(ptr nonnull %i.f), !noalias !11384
  store ptr %i.g, ptr %i.f, align 8
  store ptr %1, ptr %.sroa.422.0..sroa_idx, align 8
  store ptr %i.h, ptr %.sroa.7.0..sroa_idx, align 8
  %i.bt = load i8, ptr %i.v, align 8, !range !1966, !noalias !11387, !noundef !4
...
_RNvYNCNKNvNvMNtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc7contextNtBb_7Context4with7CONTEXT00INtNtNtCsbvkFyIu7lgC_4core3ops8function6FnOnceTINtNtB1q_6option6OptionQIB25_INtNtB1q_4cell4CellIB25_BR_EEEEEE9call_onceCs7p2uQeJxui2_9deltalake.exit.thread.i.i: ; preds = %.noexc10, %bb.o
  ...
  %i.bx = load ptr, ptr %.sroa.0.0.i.i.i2.i.i, align 8, !noalias !11384, !noundef !4 ; 7 uses
  store ptr null, ptr %.sroa.0.0.i.i.i2.i.i, align 8, !noalias !11384
...
bb.p:                                             ; preds = %_RNvYNCNKNvNvMNtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc7contextNtBb_7Context4with7CONTEXT00INtNtNtCsbvkFyIu7lgC_4core3ops8function6FnOnceTINtNtB1q_6option6OptionQIB25_INtNtB1q_4cell4CellIB25_BR_EEEEEE9call_onceCs7p2uQeJxui2_9deltalake.exit.thread.i.i
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e), !noalias !11384
...
bb.q:                                             ; preds = %bb.p
  store ptr %i.by, ptr %i.e, align 8, !noalias !11384
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c), !noalias !11384
  store ptr %i.g, ptr %i.c, align 8, !noalias !11384
  ...
  invoke fastcc void @_RNCNvMs_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5arrayINtB6_7ChannelINtNtCsbvkFyIu7lgC_4core6result6ResultuNtNtCscq8Lx7CD32J_17opentelemetry_sdk5error12OTelSdkErrorEE4send0Cs7p2uQeJxui2_9deltalake(ptr noalias noundef align 8 captures(address) dereferenceable(24) %i.c, ptr nonnull %i.by)
          to label %bb.t unwind label %bb.r, !noalias !11384
...
bb.r:                                             ; preds = %bb.q
  ...
  %i.ca = load ptr, ptr %i.e, align 8, !alias.scope !11403, !noalias !11384, !nonnull !4, !noundef !4
  %i.cb = atomicrmw sub ptr %i.ca, i64 1 release, align 8, !noalias !11404
...
bb.s:                                             ; preds = %bb.r
  ...
  invoke void @_RNvMsn_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcNtNtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc7context5InnerE9drop_slowCs14kWLkQVSKO_14deltalake_core(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.e) #38
          to label %.body.thread unwind label %bb.v, !noalias !11384

bb.t:                                             ; preds = %bb.q
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c), !noalias !11384
  ...
  %i.cd = load ptr, ptr %i.e, align 8, !alias.scope !11414, !noalias !11384, !nonnull !4, !noundef !4
  %i.ce = atomicrmw sub ptr %i.cd, i64 1 release, align 8, !noalias !11415
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc7context7ContextECs7p2uQeJxui2_9deltalake.exit19.i.i.i: ; preds = %bb.u, %bb.t
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e), !noalias !11384
  br label %bb.ah

bb.v:                                             ; preds = %bb.ab, %bb.s
  %i.cg = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #39, !noalias !11384
  unreachable
...
bb.w:                                             ; preds = %_RNvYNCNKNvNvMNtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc7contextNtBb_7Context4with7CONTEXT00INtNtNtCsbvkFyIu7lgC_4core3ops8function6FnOnceTINtNtB1q_6option6OptionQIB25_INtNtB1q_4cell4CellIB25_BR_EEEEEE9call_onceCs7p2uQeJxui2_9deltalake.exit.thread.i.i
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d), !noalias !11384
  store ptr %i.bx, ptr %i.d, align 8, !noalias !11384
  %i.ch = getelementptr inbounds nuw i8, ptr %i.bx, i64 24
  store atomic i64 0, ptr %i.ch release, align 8, !noalias !11384
  %i.ci = getelementptr inbounds nuw i8, ptr %i.bx, i64 32
  store atomic ptr null, ptr %i.ci release, align 8, !noalias !11384
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !11384
  store ptr %i.g, ptr %i.b, align 8, !noalias !11384
  ...
  invoke fastcc void @_RNCNvMs_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5arrayINtB6_7ChannelINtNtCsbvkFyIu7lgC_4core6result6ResultuNtNtCscq8Lx7CD32J_17opentelemetry_sdk5error12OTelSdkErrorEE4send0Cs7p2uQeJxui2_9deltalake(ptr noalias noundef align 8 captures(address) dereferenceable(24) %i.b, ptr nonnull %i.bx)
          to label %bb.x unwind label %bb.aa, !noalias !11384

bb.x:                                             ; preds = %bb.w
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !11384
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !11384
  %i.cj = load ptr, ptr %.sroa.0.0.i.i.i2.i.i, align 8, !noalias !11384, !noundef !4 ; 3 uses
  store ptr %i.cj, ptr %i.a, align 8, !noalias !11384
  store ptr %i.bx, ptr %.sroa.0.0.i.i.i2.i.i, align 8, !noalias !11384
...
bb.y:                                             ; preds = %bb.x
  %i.cl = atomicrmw sub ptr %i.cj, i64 1 release, align 8, !noalias !11416
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionNtNtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc7context7ContextEECs7p2uQeJxui2_9deltalake.exit.i.i.i: ; preds = %bb.z, %bb.y, %bb.x
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !11384
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d), !noalias !11384
  br label %bb.ah

bb.aa:                                            ; preds = %bb.w
  %i.cn = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.co = atomicrmw sub ptr %i.bx, i64 1 release, align 8, !noalias !11425
...
_RINvMs2_NtNtCs2pqxYH9ZEk8_3std6thread5localINtB6_8LocalKeyINtNtCsbvkFyIu7lgC_4core4cell4CellINtNtBZ_6option6OptionNtNtNtNtBa_4sync4mpmc7context7ContextEEE8try_withNCINvMB1Q_B1O_4withNCNvMs_NtB1S_5arrayINtB31_7ChannelINtNtBZ_6result6ResultuNtNtCscq8Lx7CD32J_17opentelemetry_sdk5error12OTelSdkErrorEE4send0uEs_0uECs7p2uQeJxui2_9deltalake.exit.i: ; preds = %.noexc10
  invoke fastcc void @_RNCINvMNtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc7contextNtB5_7Context4withNCNvMs_NtB7_5arrayINtB1a_7ChannelINtNtCsbvkFyIu7lgC_4core6result6ResultuNtNtCscq8Lx7CD32J_17opentelemetry_sdk5error12OTelSdkErrorEE4send0uEs0_0Cs7p2uQeJxui2_9deltalake(ptr nonnull %i.f)
          to label %bb.ah unwind label %.body.thread30.loopexit.split-lp
...
bb.ad:                                            ; preds = %bb.ac
  ...
  br i1 %.not44, label %bb.o, label %bb.af

bb.ae:                                            ; preds = %bb.ac
  %.not43 = icmp slt i64 %i.cq, %i.br
  br i1 %.not43, label %bb.o, label %bb.af
...
bb.ag:                                            ; preds = %bb.ai, %bb.aj, %bb.af
  call void @llvm.lifetime.end.p0(ptr nonnull %i.g)
  ret void

bb.ah:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionNtNtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc7context7ContextEECs7p2uQeJxui2_9deltalake.exit.i.i.i, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc7context7ContextECs7p2uQeJxui2_9deltalake.exit19.i.i.i, %_RINvMs2_NtNtCs2pqxYH9ZEk8_3std6thread5localINtB6_8LocalKeyINtNtCsbvkFyIu7lgC_4core4cell4CellINtNtBZ_6option6OptionNtNtNtNtBa_4sync4mpmc7context7ContextEEE8try_withNCINvMB1Q_B1O_4withNCNvMs_NtB1S_5arrayINtB31_7ChannelINtNtBZ_6result6ResultuNtNtCscq8Lx7CD32J_17opentelemetry_sdk5error12OTelSdkErrorEE4send0uEs_0uECs7p2uQeJxui2_9deltalake.exit.i
  call void @llvm.lifetime.end.p0(ptr nonnull %i.f), !noalias !11384
  %i.cu = load atomic i64, ptr %i.k monotonic, align 128, !noalias !11432 ; 2 uses
  %i.cv = load i64, ptr %i.l, align 16, !noalias !11432, !noundef !4 ; 2 uses
  %i.cw = and i64 %i.cv, %i.cu
  %i.cx = icmp eq i64 %i.cw, 0
  br i1 %i.cx, label %.lr.ph.i, label %_RNvMs_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5arrayINtB4_7ChannelINtNtCsbvkFyIu7lgC_4core6result6ResultuNtNtCscq8Lx7CD32J_17opentelemetry_sdk5error12OTelSdkErrorEE5writeCs7p2uQeJxui2_9deltalake.exit

_RNvMs_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5arrayINtB4_7ChannelINtNtCsbvkFyIu7lgC_4core6result6ResultuNtNtCscq8Lx7CD32J_17opentelemetry_sdk5error12OTelSdkErrorEE5writeCs7p2uQeJxui2_9deltalake.exit: ; preds = %bb.ah, %_RNvMs1_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5utilsNtB5_7Backoff10spin_light.exit22.i, %bb.a
  %.sroa.018.0.copyload = load i64, ptr %2, align 8 ; 2 uses
  %.not7 = icmp eq i64 %.sroa.018.0.copyload, -9223372036854775805
  br i1 %.not7, label %bb.aj, label %bb.ai

bb.ai:                                            ; preds = %_RNvMs_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5arrayINtB4_7ChannelINtNtCsbvkFyIu7lgC_4core6result6ResultuNtNtCscq8Lx7CD32J_17opentelemetry_sdk5error12OTelSdkErrorEE5writeCs7p2uQeJxui2_9deltalake.exit
  %.sroa.5.0..sroa_idx = getelementptr inbounds nuw i8, ptr %2, i64 8
  %.sroa.43.sroa.4.0..sroa.43.0..sroa_idx.sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.43.sroa.4.0..sroa.43.0..sroa_idx.sroa_idx, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.5.0..sroa_idx, i64 16, i1 false)
  store i64 1, ptr %0, align 8
  %.sroa.43.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i64 %.sroa.018.0.copyload, ptr %.sroa.43.0..sroa_idx, align 8
  br label %bb.ag

bb.aj:                                            ; preds = %_RNvMs_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5arrayINtB4_7ChannelINtNtCsbvkFyIu7lgC_4core6result6ResultuNtNtCscq8Lx7CD32J_17opentelemetry_sdk5error12OTelSdkErrorEE5writeCs7p2uQeJxui2_9deltalake.exit.thread, %_RNvMs_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5arrayINtB4_7ChannelINtNtCsbvkFyIu7lgC_4core6result6ResultuNtNtCscq8Lx7CD32J_17opentelemetry_sdk5error12OTelSdkErrorEE5writeCs7p2uQeJxui2_9deltalake.exit
...
bb.d:                                             ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCscq8Lx7CD32J_17opentelemetry_sdk5trace14span_processor12BatchMessageECs7p2uQeJxui2_9deltalake.exit.i, %bb.c
  ...
  %.sroa.0.07.i = phi i32 [ 0, %bb.c ], [ %.sroa.0.18.i, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCscq8Lx7CD32J_17opentelemetry_sdk5trace14span_processor12BatchMessageECs7p2uQeJxui2_9deltalake.exit.i ] ; 11 uses
...
.lr.ph.i.i.preheader:                             ; preds = %bb.i
  %i.ai = mul nuw i32 %.sroa.0.07.i, %.sroa.0.07.i ; 3 uses
...
.lr.ph.i.i.epil:                                  ; preds = %.lr.ph.i.i.epil, %.lr.ph.i.i.epil.preheader
  ...
  %epil.iter.next = add i32 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %_RNvMs1_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5utilsNtB5_7Backoff10spin_heavy.exit.i, label %.lr.ph.i.i.epil, !llvm.loop !11435
...
bb.k:                                             ; preds = %bb.j, %bb.f
  ...
  %i.ao = load i64, ptr %i.an, align 8, !range !2400, !alias.scope !11436, !noundef !4
...
bb.l:                                             ; preds = %bb.k
  tail call void @llvm.experimental.noalias.scope.decl(metadata !11439)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !11442)
  %i.aq = load ptr, ptr %i.ap, align 8, !alias.scope !11445, !nonnull !4, !noundef !4
  %i.ar = atomicrmw sub ptr %i.aq, i64 1 release, align 8, !noalias !11445
...
bb.n:                                             ; preds = %bb.k
  tail call void @llvm.experimental.noalias.scope.decl(metadata !11446)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !11449)
  %i.at = load ptr, ptr %i.ap, align 8, !alias.scope !11452, !nonnull !4, !noundef !4
  %i.au = atomicrmw sub ptr %i.at, i64 1 release, align 8, !noalias !11452
...
bb.b:                                             ; preds = %_RINvMNtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc7contextNtB3_7Context4withNCNvMs_NtB5_5arrayINtB18_7ChannelNtNtNtCscq8Lx7CD32J_17opentelemetry_sdk5trace14span_processor12BatchMessageE4recvs_0uECs7p2uQeJxui2_9deltalake.exit, %bb.a
  call void @llvm.experimental.noalias.scope.decl(metadata !11453)
  br label %_RNvMs1_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5utilsNtB5_7Backoff10spin_light.exit22.i
...
_RNvMs1_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5utilsNtB5_7Backoff10spin_light.exit22.i: ; preds = %_RNvMs1_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5utilsNtB5_7Backoff10spin_light.exit22.i.backedge, %bb.b
  %.sroa.0.028.i = phi i32 [ 0, %bb.b ], [ %.sroa.0.028.i.be, %_RNvMs1_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5utilsNtB5_7Backoff10spin_light.exit22.i.backedge ] ; 11 uses
  %i.u = load atomic i64, ptr %1 monotonic, align 128, !noalias !11453 ; 7 uses
  %i.v = load i64, ptr %i.m, align 16, !noalias !11453, !noundef !4
  %i.w = add i64 %i.v, -1
  %i.x = and i64 %i.w, %i.u                       ; 3 uses
  %i.y = load i64, ptr %i.n, align 8, !noalias !11453, !noundef !4
  %i.z = sub i64 0, %i.y
  %i.aa = and i64 %i.u, %i.z
  %i.ab = load ptr, ptr %i.o, align 8, !noalias !11453, !nonnull !4, !noundef !4
  %i.ac = load i64, ptr %i.p, align 32, !noalias !11453, !noundef !4
  %i.ad = icmp ult i64 %i.x, %i.ac
  call void @llvm.assume(i1 %i.ad)
  %i.ae = getelementptr inbounds nuw [32 x i8], ptr %i.ab, i64 %i.x ; 4 uses
  %i.af = load atomic i64, ptr %i.ae acquire, align 8, !noalias !11453 ; 3 uses
  %i.ag = add i64 %i.u, 1
...
bb.d:                                             ; preds = %_RNvMs1_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5utilsNtB5_7Backoff10spin_light.exit22.i
  ...
  %i.ak = load i64, ptr %i.r, align 128, !noalias !11453, !noundef !4
...
bb.f:                                             ; preds = %bb.e
  call void @_RNvNtNtCs2pqxYH9ZEk8_3std6thread9functions9yield_now(), !noalias !11453
  br label %_RNvMs1_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5utilsNtB5_7Backoff10spin_heavy.exit.i
...
.lr.ph.i.i.preheader:                             ; preds = %bb.g
  %i.an = mul nuw i32 %.sroa.0.028.i, %.sroa.0.028.i ; 3 uses
  %xtraiter = and i32 %i.an, 7                    ; 3 uses
  %i.ao = icmp ult i32 %i.an, 8
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i, %.lr.ph.i.i.preheader.new
  %niter = phi i32 [ 0, %.lr.ph.i.i.preheader.new ], [ %niter.next.7, %.lr.ph.i.i ]
  call void @llvm.x86.sse2.pause(), !noalias !11453
  call void @llvm.x86.sse2.pause(), !noalias !11453
  call void @llvm.x86.sse2.pause(), !noalias !11453
  call void @llvm.x86.sse2.pause(), !noalias !11453
  call void @llvm.x86.sse2.pause(), !noalias !11453
...
.lr.ph.i.i.epil:                                  ; preds = %.lr.ph.i.i.epil, %.lr.ph.i.i.epil.preheader
  ...
  %epil.iter.next = add i32 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %_RNvMs1_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5utilsNtB5_7Backoff10spin_heavy.exit.i, label %.lr.ph.i.i.epil, !llvm.loop !11456
...
bb.h:                                             ; preds = %bb.c
  fence seq_cst
  %i.aq = load atomic i64, ptr %i.q monotonic, align 128, !noalias !11453 ; 2 uses
  %i.ar = load i64, ptr %i.m, align 16, !noalias !11453, !noundef !4 ; 2 uses
  %i.as = xor i64 %i.ar, -1
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.av = mul nuw nsw i32 %.sroa.0.0.i.i.i, %.sroa.0.0.i.i.i ; 3 uses
...
.lr.ph.i12.i.preheader:                           ; preds = %bb.i
  ...
  %i.aw = icmp samesign ult i32 %i.av, 8
...
.lr.ph.i12.i.epil:                                ; preds = %.lr.ph.i12.i.epil, %.lr.ph.i12.i.epil.preheader
  ...
  br i1 %epil.iter64.cmp.not, label %._crit_edge.loopexit.i.i, label %.lr.ph.i12.i.epil, !llvm.loop !11457
...
bb.k:                                             ; preds = %bb.d
  %i.ba = load i64, ptr %i.n, align 8, !noalias !11453, !noundef !4
  %i.bb = add i64 %i.ba, %i.aa
  br label %bb.l

bb.l:                                             ; preds = %bb.k, %bb.d
  %.sroa.01.0.i = phi i64 [ %i.bb, %bb.k ], [ %i.af, %bb.d ]
  %i.bc = cmpxchg weak ptr %1, i64 %i.u, i64 %.sroa.01.0.i seq_cst monotonic, align 8, !noalias !11453
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.bd = mul nuw nsw i32 %.sroa.0.0.i.i15.i, %.sroa.0.0.i.i15.i ; 3 uses
...
.lr.ph.i17.i.preheader:                           ; preds = %bb.m
  ...
  %i.be = icmp samesign ult i32 %i.bd, 8
...
.lr.ph.i17.i.epil:                                ; preds = %.lr.ph.i17.i.epil, %.lr.ph.i17.i.epil.preheader
  ...
  br i1 %epil.iter70.cmp.not, label %._crit_edge.loopexit.i20.i, label %.lr.ph.i17.i.epil, !llvm.loop !11458
...
_RNvMs_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5arrayINtB4_7ChannelNtNtNtCscq8Lx7CD32J_17opentelemetry_sdk5trace14span_processor12BatchMessageE10start_recvCs7p2uQeJxui2_9deltalake.exit: ; preds = %bb.j
  %i.bg = load i32, ptr %i.k, align 8, !range !11110, !noundef !4 ; 2 uses
  %.not = icmp eq i32 %i.bg, 1000000000
  br i1 %.not, label %bb.r, label %bb.q

bb.n:                                             ; preds = %bb.l
  store ptr %i.ae, ptr %i.i, align 8, !alias.scope !11453
  %i.bh = load i64, ptr %i.n, align 8, !noalias !11453, !noundef !4
  %i.bi = add i64 %i.bh, %i.u                     ; 2 uses
  store i64 %i.bi, ptr %i.l, align 8, !alias.scope !11453
  call void @llvm.lifetime.start.p0(ptr nonnull %i.h), !noalias !11459
  call void @llvm.lifetime.start.p0(ptr nonnull %i.g)
  %i.bj = getelementptr inbounds nuw i8, ptr %i.ae, i64 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.g, ptr noundef nonnull align 8 dereferenceable(24) %i.bj, i64 24, i1 false), !noalias !11459
  store atomic i64 %i.bi, ptr %i.ae release, align 8, !noalias !11459
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.h, ptr noundef nonnull align 8 dereferenceable(24) %i.g, i64 24, i1 false), !noalias !11459
  call void @llvm.lifetime.end.p0(ptr nonnull %i.g)
  ...
  invoke fastcc void @_RNvMs0_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5wakerNtB5_9SyncWaker6notify(ptr noundef nonnull align 8 %i.bk)
          to label %_RNvMs_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5arrayINtB4_7ChannelNtNtNtCscq8Lx7CD32J_17opentelemetry_sdk5trace14span_processor12BatchMessageE4readCs7p2uQeJxui2_9deltalake.exit unwind label %bb.o, !noalias !11459
...
bb.o:                                             ; preds = %bb.n
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCscq8Lx7CD32J_17opentelemetry_sdk5trace14span_processor12BatchMessageECs7p2uQeJxui2_9deltalake(ptr noalias noundef align 8 dereferenceable(24) %i.h) #37
          to label %common.resume unwind label %bb.p, !noalias !11459

bb.p:                                             ; preds = %bb.o
  %i.bm = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #39, !noalias !11459
  unreachable
...
_RNvMs_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5arrayINtB4_7ChannelNtNtNtCscq8Lx7CD32J_17opentelemetry_sdk5trace14span_processor12BatchMessageE4readCs7p2uQeJxui2_9deltalake.exit: ; preds = %bb.n
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.h), !noalias !11459
  %i.bn = icmp eq i64 %.sroa.0.0.copyload2, 4
  br i1 %i.bn, label %_RNvMs_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5arrayINtB4_7ChannelNtNtNtCscq8Lx7CD32J_17opentelemetry_sdk5trace14span_processor12BatchMessageE4readCs7p2uQeJxui2_9deltalake.exit.thread, label %bb.ai
...
bb.r:                                             ; preds = %bb.ae, %bb.af, %_RNvMs_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5arrayINtB4_7ChannelNtNtNtCscq8Lx7CD32J_17opentelemetry_sdk5trace14span_processor12BatchMessageE10start_recvCs7p2uQeJxui2_9deltalake.exit
  call void @llvm.lifetime.start.p0(ptr nonnull %i.f), !noalias !11462
  store ptr %i.i, ptr %i.f, align 8
  store ptr %1, ptr %.sroa.45.0..sroa_idx, align 8
  store ptr %i.j, ptr %.sroa.7.0..sroa_idx, align 8
  %i.bs = load i8, ptr %i.t, align 8, !range !1966, !noalias !11465, !noundef !4
...
_RNvYNCNKNvNvMNtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc7contextNtBb_7Context4with7CONTEXT00INtNtNtCsbvkFyIu7lgC_4core3ops8function6FnOnceTINtNtB1q_6option6OptionQIB25_INtNtB1q_4cell4CellIB25_BR_EEEEEE9call_onceCs7p2uQeJxui2_9deltalake.exit.thread.i.i: ; preds = %_RNvYNCNKNvNvMNtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc7contextNtBb_7Context4with7CONTEXT00INtNtNtCsbvkFyIu7lgC_4core3ops8function6FnOnceTINtNtB1q_6option6OptionQIB25_INtNtB1q_4cell4CellIB25_BR_EEEEEE9call_onceCs7p2uQeJxui2_9deltalake.exit.i.i, %bb.r
  ...
  %i.bw = load ptr, ptr %.sroa.0.0.i.i.i2.i.i, align 8, !noalias !11462, !noundef !4 ; 7 uses
  store ptr null, ptr %.sroa.0.0.i.i.i2.i.i, align 8, !noalias !11462
...
bb.s:                                             ; preds = %_RNvYNCNKNvNvMNtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc7contextNtBb_7Context4with7CONTEXT00INtNtNtCsbvkFyIu7lgC_4core3ops8function6FnOnceTINtNtB1q_6option6OptionQIB25_INtNtB1q_4cell4CellIB25_BR_EEEEEE9call_onceCs7p2uQeJxui2_9deltalake.exit.thread.i.i
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e), !noalias !11462
  %i.bx = call noundef nonnull ptr @_RNvMNtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc7contextNtB2_7Context3new(), !noalias !11462 ; 2 uses
  store ptr %i.bx, ptr %i.e, align 8, !noalias !11462
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c), !noalias !11462
  store ptr %i.i, ptr %i.c, align 8, !noalias !11462
  store ptr %1, ptr %.sroa.5.0..sroa_idx5.i.i.i, align 8
  ...
  invoke fastcc void @_RNCNvMs_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5arrayINtB6_7ChannelNtNtNtCscq8Lx7CD32J_17opentelemetry_sdk5trace14span_processor12BatchMessageE4recvs_0Cs7p2uQeJxui2_9deltalake(ptr noalias noundef align 8 captures(address) dereferenceable(24) %i.c, ptr nonnull %i.bx)
          to label %bb.v unwind label %bb.t, !noalias !11462

bb.t:                                             ; preds = %bb.s
  %i.by = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !11472)
  call void @llvm.experimental.noalias.scope.decl(metadata !11475)
  call void @llvm.experimental.noalias.scope.decl(metadata !11478)
  %i.bz = load ptr, ptr %i.e, align 8, !alias.scope !11481, !noalias !11462, !nonnull !4, !noundef !4
  %i.ca = atomicrmw sub ptr %i.bz, i64 1 release, align 8, !noalias !11482
...
bb.u:                                             ; preds = %bb.t
  fence acquire
  invoke void @_RNvMsn_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcNtNtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc7context5InnerE9drop_slowCs14kWLkQVSKO_14deltalake_core(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.e) #38
          to label %common.resume unwind label %bb.x, !noalias !11462

bb.v:                                             ; preds = %bb.s
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c), !noalias !11462
  call void @llvm.experimental.noalias.scope.decl(metadata !11483)
  call void @llvm.experimental.noalias.scope.decl(metadata !11486)
  call void @llvm.experimental.noalias.scope.decl(metadata !11489)
  %i.cc = load ptr, ptr %i.e, align 8, !alias.scope !11492, !noalias !11462, !nonnull !4, !noundef !4
  %i.cd = atomicrmw sub ptr %i.cc, i64 1 release, align 8, !noalias !11493
...
bb.w:                                             ; preds = %bb.v
  fence acquire
  call void @_RNvMsn_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcNtNtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc7context5InnerE9drop_slowCs14kWLkQVSKO_14deltalake_core(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.e) #38, !noalias !11462
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc7context7ContextECs7p2uQeJxui2_9deltalake.exit19.i.i.i: ; preds = %bb.w, %bb.v
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e), !noalias !11462
...
bb.x:                                             ; preds = %bb.ad, %bb.u
  %i.cf = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #39, !noalias !11462
  unreachable
...
bb.y:                                             ; preds = %_RNvYNCNKNvNvMNtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc7contextNtBb_7Context4with7CONTEXT00INtNtNtCsbvkFyIu7lgC_4core3ops8function6FnOnceTINtNtB1q_6option6OptionQIB25_INtNtB1q_4cell4CellIB25_BR_EEEEEE9call_onceCs7p2uQeJxui2_9deltalake.exit.thread.i.i
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d), !noalias !11462
  store ptr %i.bw, ptr %i.d, align 8, !noalias !11462
  %i.cg = getelementptr inbounds nuw i8, ptr %i.bw, i64 24
  store atomic i64 0, ptr %i.cg release, align 8, !noalias !11462
  %i.ch = getelementptr inbounds nuw i8, ptr %i.bw, i64 32
  store atomic ptr null, ptr %i.ch release, align 8, !noalias !11462
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !11462
  store ptr %i.i, ptr %i.b, align 8, !noalias !11462
  store ptr %1, ptr %.sroa.59.0..sroa_idx10.i.i.i, align 8
  ...
  invoke fastcc void @_RNCNvMs_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5arrayINtB6_7ChannelNtNtNtCscq8Lx7CD32J_17opentelemetry_sdk5trace14span_processor12BatchMessageE4recvs_0Cs7p2uQeJxui2_9deltalake(ptr noalias noundef align 8 captures(address) dereferenceable(24) %i.b, ptr nonnull %i.bw)
          to label %bb.z unwind label %bb.ac, !noalias !11462

bb.z:                                             ; preds = %bb.y
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !11462
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !11462
  %i.ci = load ptr, ptr %.sroa.0.0.i.i.i2.i.i, align 8, !noalias !11462, !noundef !4 ; 3 uses
  store ptr %i.ci, ptr %i.a, align 8, !noalias !11462
  store ptr %i.bw, ptr %.sroa.0.0.i.i.i2.i.i, align 8, !noalias !11462
...
bb.aa:                                            ; preds = %bb.z
  %i.ck = atomicrmw sub ptr %i.ci, i64 1 release, align 8, !noalias !11494
...
bb.ab:                                            ; preds = %bb.aa
  fence acquire
  call void @_RNvMsn_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcNtNtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc7context5InnerE9drop_slowCs14kWLkQVSKO_14deltalake_core(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.a) #38, !noalias !11462
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionNtNtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc7context7ContextEECs7p2uQeJxui2_9deltalake.exit.i.i.i: ; preds = %bb.ab, %bb.aa, %bb.z
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !11462
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d), !noalias !11462
  br label %_RINvMNtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc7contextNtB3_7Context4withNCNvMs_NtB5_5arrayINtB18_7ChannelNtNtNtCscq8Lx7CD32J_17opentelemetry_sdk5trace14span_processor12BatchMessageE4recvs_0uECs7p2uQeJxui2_9deltalake.exit

bb.ac:                                            ; preds = %bb.y
  %i.cm = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.cn = atomicrmw sub ptr %i.bw, i64 1 release, align 8, !noalias !11503
...
_RINvMs2_NtNtCs2pqxYH9ZEk8_3std6thread5localINtB6_8LocalKeyINtNtCsbvkFyIu7lgC_4core4cell4CellINtNtBZ_6option6OptionNtNtNtNtBa_4sync4mpmc7context7ContextEEE8try_withNCINvMB1Q_B1O_4withNCNvMs_NtB1S_5arrayINtB31_7ChannelNtNtNtCscq8Lx7CD32J_17opentelemetry_sdk5trace14span_processor12BatchMessageE4recvs_0uEs_0uECs7p2uQeJxui2_9deltalake.exit.i: ; preds = %_RNvYNCNKNvNvMNtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc7contextNtBb_7Context4with7CONTEXT00INtNtNtCsbvkFyIu7lgC_4core3ops8function6FnOnceTINtNtB1q_6option6OptionQIB25_INtNtB1q_4cell4CellIB25_BR_EEEEEE9call_onceCs7p2uQeJxui2_9deltalake.exit.i.i
  call fastcc void @_RNCINvMNtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc7contextNtB5_7Context4withNCNvMs_NtB7_5arrayINtB1a_7ChannelNtNtNtCscq8Lx7CD32J_17opentelemetry_sdk5trace14span_processor12BatchMessageE4recvs_0uEs0_0Cs7p2uQeJxui2_9deltalake(ptr nonnull %i.f), !noalias !11462
  br label %_RINvMNtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc7contextNtB3_7Context4withNCNvMs_NtB5_5arrayINtB18_7ChannelNtNtNtCscq8Lx7CD32J_17opentelemetry_sdk5trace14span_processor12BatchMessageE4recvs_0uECs7p2uQeJxui2_9deltalake.exit
...
_RINvMNtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc7contextNtB3_7Context4withNCNvMs_NtB5_5arrayINtB18_7ChannelNtNtNtCscq8Lx7CD32J_17opentelemetry_sdk5trace14span_processor12BatchMessageE4recvs_0uECs7p2uQeJxui2_9deltalake.exit: ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc7context7ContextECs7p2uQeJxui2_9deltalake.exit19.i.i.i, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionNtNtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc7context7ContextEECs7p2uQeJxui2_9deltalake.exit.i.i.i, %_RINvMs2_NtNtCs2pqxYH9ZEk8_3std6thread5localINtB6_8LocalKeyINtNtCsbvkFyIu7lgC_4core4cell4CellINtNtBZ_6option6OptionNtNtNtNtBa_4sync4mpmc7context7ContextEEE8try_withNCINvMB1Q_B1O_4withNCNvMs_NtB1S_5arrayINtB31_7ChannelNtNtNtCscq8Lx7CD32J_17opentelemetry_sdk5trace14span_processor12BatchMessageE4recvs_0uEs_0uECs7p2uQeJxui2_9deltalake.exit.i
  call void @llvm.lifetime.end.p0(ptr nonnull %i.f), !noalias !11462
  br label %bb.b
...
bb.ae:                                            ; preds = %bb.q
  ...
  br i1 %.not18, label %bb.r, label %bb.ag

bb.af:                                            ; preds = %bb.q
  %.not17 = icmp slt i64 %i.bq, %i.bo
  br i1 %.not17, label %bb.r, label %bb.ag
...
bb.ah:                                            ; preds = %_RNvMs_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5arrayINtB4_7ChannelNtNtNtCscq8Lx7CD32J_17opentelemetry_sdk5trace14span_processor12BatchMessageE4readCs7p2uQeJxui2_9deltalake.exit.thread, %bb.ai, %bb.ag
  %storemerge = phi i64 [ 4, %bb.ag ], [ %.sroa.0.0.copyload2, %bb.ai ], [ 4, %_RNvMs_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5arrayINtB4_7ChannelNtNtNtCscq8Lx7CD32J_17opentelemetry_sdk5trace14span_processor12BatchMessageE4readCs7p2uQeJxui2_9deltalake.exit.thread ]
...
bb.ai:                                            ; preds = %_RNvMs_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5arrayINtB4_7ChannelNtNtNtCscq8Lx7CD32J_17opentelemetry_sdk5trace14span_processor12BatchMessageE4readCs7p2uQeJxui2_9deltalake.exit
...
bb.d:                                             ; preds = %bb.j, %bb.c
  ...
  %.sroa.0.07.i = phi i32 [ 0, %bb.c ], [ %.sroa.0.18.i, %bb.j ] ; 6 uses
...
.lr.ph.i.i.epil:                                  ; preds = %.lr.ph.i.i.epil, %.lr.ph.i.i.epil.preheader
  ...
  %epil.iter.next = add i32 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %_RNvMs1_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5utilsNtB5_7Backoff10spin_heavy.exit.i, label %.lr.ph.i.i.epil, !llvm.loop !11510
...
bb.a:
  ...
  %i.c = load atomic i64, ptr %1 monotonic, align 128, !noalias !11511
...
bb.b:                                             ; preds = %_RNvMs1_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5utilsNtB5_7Backoff10spin_light.exit22.i, %bb.a
  %.sroa.0.028.i = phi i32 [ 0, %bb.a ], [ %.sroa.0.1.i, %_RNvMs1_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5utilsNtB5_7Backoff10spin_light.exit22.i ] ; 11 uses
  ...
  %i.j = load i64, ptr %i.d, align 16, !noalias !11511, !noundef !4
  %i.k = add i64 %i.j, -1
  %i.l = and i64 %i.k, %.sroa.02.0.i              ; 3 uses
  %i.m = load i64, ptr %i.e, align 8, !noalias !11511, !noundef !4
  %i.n = sub i64 0, %i.m
  %i.o = and i64 %.sroa.02.0.i, %i.n
  %i.p = load ptr, ptr %i.f, align 8, !noalias !11511, !nonnull !4, !noundef !4
  %i.q = load i64, ptr %i.g, align 32, !noalias !11511, !noundef !4
  ...
  %i.u = load atomic i64, ptr %i.t acquire, align 8, !noalias !11511 ; 3 uses
...
bb.d:                                             ; preds = %bb.b
  ...
  %i.z = load i64, ptr %i.i, align 128, !noalias !11511, !noundef !4
...
bb.f:                                             ; preds = %bb.e
  tail call void @_RNvNtNtCs2pqxYH9ZEk8_3std6thread9functions9yield_now(), !noalias !11511
  br label %_RNvMs1_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5utilsNtB5_7Backoff10spin_heavy.exit.i
...
.lr.ph.i.i.preheader:                             ; preds = %bb.g
  %i.ac = mul nuw i32 %.sroa.0.028.i, %.sroa.0.028.i ; 3 uses
...
.lr.ph.i.i.epil:                                  ; preds = %.lr.ph.i.i.epil, %.lr.ph.i.i.epil.preheader
  ...
  %epil.iter.next = add i32 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %_RNvMs1_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5utilsNtB5_7Backoff10spin_heavy.exit.i, label %.lr.ph.i.i.epil, !llvm.loop !11514
...
bb.h:                                             ; preds = %bb.c
  fence seq_cst
  %i.af = load atomic i64, ptr %i.h monotonic, align 128, !noalias !11511 ; 2 uses
  %i.ag = load i64, ptr %i.d, align 16, !noalias !11511, !noundef !4 ; 2 uses
  %i.ah = xor i64 %i.ag, -1
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.ak = mul nuw nsw i32 %.sroa.0.0.i.i.i, %.sroa.0.0.i.i.i ; 3 uses
  %.not.i11.i = icmp eq i32 %.sroa.0.028.i, 0
  br i1 %.not.i11.i, label %_RNvMs1_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5utilsNtB5_7Backoff10spin_light.exit22.i, label %.lr.ph.i12.i.preheader
...
.lr.ph.i12.i.epil:                                ; preds = %.lr.ph.i12.i.epil, %.lr.ph.i12.i.epil.preheader
  ...
  br i1 %epil.iter40.cmp.not, label %._crit_edge.loopexit.i.i, label %.lr.ph.i12.i.epil, !llvm.loop !11515
...
_RNvMs1_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5utilsNtB5_7Backoff10spin_light.exit22.i: ; preds = %._crit_edge.loopexit.i20.i, %bb.m, %._crit_edge.loopexit.i.i, %bb.i, %_RNvMs1_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5utilsNtB5_7Backoff10spin_heavy.exit.i
  ...
  %i.ap = load atomic i64, ptr %1 monotonic, align 128, !noalias !11511
  br label %bb.b

bb.k:                                             ; preds = %bb.d
  %i.aq = load i64, ptr %i.e, align 8, !noalias !11511, !noundef !4
  %i.ar = add i64 %i.aq, %i.o
  br label %bb.l

bb.l:                                             ; preds = %bb.k, %bb.d
  %.sroa.01.0.i = phi i64 [ %i.ar, %bb.k ], [ %i.u, %bb.d ]
  %i.as = cmpxchg weak ptr %1, i64 %.sroa.02.0.i, i64 %.sroa.01.0.i seq_cst monotonic, align 8, !noalias !11511
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.at = mul nuw nsw i32 %.sroa.0.0.i.i15.i, %.sroa.0.0.i.i15.i ; 3 uses
  %.not.i16.i = icmp eq i32 %.sroa.0.028.i, 0
  br i1 %.not.i16.i, label %_RNvMs1_NtNtNtCs2pqxYH9ZEk8_3std4sync4mpmc5utilsNtB5_7Backoff10spin_light.exit22.i, label %.lr.ph.i17.i.preheader

.lr.ph.i17.i.preheader:                           ; preds = %bb.m
  %xtraiter45 = and i32 %i.at, 5                  ; 3 uses
  %i.au = icmp samesign ult i32 %i.at, 8
...
bb.p:                                             ; preds = %bb.o
  %i.bc = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #39, !noalias !11517
  unreachable
