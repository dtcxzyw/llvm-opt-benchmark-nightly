...
end_hunk_0
begin_hunk_1_@_RINvNtNtNtCsbvkFyIu7lgC_4core5slice4sort8unstable7ipnsortNtNtNtNtCs14kWLkQVSKO_14deltalake_core16delta_datafusion14table_provider4next23DeletionVectorSelectionNCINvMB6_SBT_16sort_unstable_byNCNCNvNtBV_4scan23replay_deletion_vectors0s0_0E0ECs7p2uQeJxui2_9deltalake:bb.a
  %i.af = tail call range(i64 6, 64) i64 @llvm.ctlz.i64(i64 %i.ae, i1 true)
  %i.ag = trunc nuw nsw i64 %i.af to i32
  %i.ah = shl nuw nsw i32 %i.ag, 1
  %3 = sub nuw nsw i32 126, %i.ah
  tail call fastcc void @_RINvNtNtNtNtCsbvkFyIu7lgC_4core5slice4sort8unstable9quicksort9quicksortNtNtNtNtCs14kWLkQVSKO_14deltalake_core16delta_datafusion14table_provider4next23DeletionVectorSelectionNCINvMB8_SB17_16sort_unstable_byNCNCNvNtB19_4scan23replay_deletion_vectors0s0_0E0ECs7p2uQeJxui2_9deltalake(ptr noalias noundef nonnull align 8 %0, i64 noundef %1, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable_or_null(48) null, i32 noundef %3, ptr noalias noundef align 8 dereferenceable(8) %2)
