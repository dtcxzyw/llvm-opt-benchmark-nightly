...
bb.p:                                             ; preds = %bb.j, %bb.g
  ...
  %i.ae = load ptr, ptr %i.d, align 8, !alias.scope !10531, !noundef !4
...
bb.a:
  ...
  %i.c = load i64, ptr %i.b, align 8, !alias.scope !10534, !noalias !10537, !noundef !4 ; 5 uses
...
_RNvMsd_Cs3fLsjMQPbhe_8smallvecINtB5_8SmallVecANtNtNtCsbG4i8A5DnWX_18tracing_subscriber6filter9directive15StaticDirectivej8_E6tripleCs7p2uQeJxui2_9deltalake.exit: ; preds = %bb.a
  ...
  %i.f = load i64, ptr %i.e, align 8, !alias.scope !10534, !noalias !10537, !noundef !4 ; 2 uses
  %i.g = icmp eq i64 %i.f, -1
  br i1 %i.g, label %bb.q, label %_RNvMsd_Cs3fLsjMQPbhe_8smallvecINtB5_8SmallVecANtNtNtCsbG4i8A5DnWX_18tracing_subscriber6filter9directive15StaticDirectivej8_E6tripleCs7p2uQeJxui2_9deltalake.exit.thread, !prof !10539
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.p = load ptr, ptr %i.o, align 8, !alias.scope !10543, !noalias !10546, !nonnull !4, !noundef !4
  %.pre = load i64, ptr %i.n, align 8, !alias.scope !10540
...
bb.d:                                             ; preds = %_RNvMsd_Cs3fLsjMQPbhe_8smallvecINtB5_8SmallVecANtNtNtCsbG4i8A5DnWX_18tracing_subscriber6filter9directive15StaticDirectivej8_E10triple_mutCs7p2uQeJxui2_9deltalake.exit.i
  tail call void @_RNvNtCsbvkFyIu7lgC_4core9panicking5panic(ptr noalias noundef nonnull readonly captures(address, read_provenance) @289, i64 noundef 32, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @290) #36, !noalias !10540
  unreachable
...
bb.j:                                             ; preds = %_RINvCs3fLsjMQPbhe_8smallvec12layout_arrayNtNtNtCsbG4i8A5DnWX_18tracing_subscriber6filter9directive15StaticDirectiveECs7p2uQeJxui2_9deltalake.exit.i
  tail call void @_RNvCs8mYq7K4qqSA_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #41, !noalias !10540
  %i.t = tail call noundef align 8 ptr @_RNvCs8mYq7K4qqSA_7___rustc12___rust_alloc(i64 noundef %i.s, i64 noundef 8) #41, !noalias !10540 ; 3 uses
...
bb.n:                                             ; preds = %bb.m
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !10548
  store i64 0, ptr %i.a, align 8, !noalias !10548
  %i.ab = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  store i64 %i.aa, ptr %i.ab, align 8, !noalias !10548
  call void @_RNvNtCsbvkFyIu7lgC_4core6result13unwrap_failed(ptr noalias noundef nonnull readonly captures(address, read_provenance) @237, i64 noundef 43, ptr noundef nonnull %i.a, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) @239, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @1) #37, !noalias !10548
  unreachable
...
bb.a:
  ...
  %i.c = load i64, ptr %i.b, align 8, !alias.scope !10551, !noalias !10554, !noundef !4 ; 5 uses
  %i.d = icmp ugt i64 %i.c, 8                     ; 2 uses
...
_RNvMsd_Cs3fLsjMQPbhe_8smallvecINtB5_8SmallVecANtNtNtNtCsbG4i8A5DnWX_18tracing_subscriber6filter3env9directive9Directivej8_E6tripleCs7p2uQeJxui2_9deltalake.exit: ; preds = %bb.a
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.f = load i64, ptr %i.e, align 8, !alias.scope !10551, !noalias !10554, !noundef !4 ; 2 uses
  %i.g = icmp eq i64 %i.f, -1
  br i1 %i.g, label %bb.q, label %_RNvMsd_Cs3fLsjMQPbhe_8smallvecINtB5_8SmallVecANtNtNtNtCsbG4i8A5DnWX_18tracing_subscriber6filter3env9directive9Directivej8_E6tripleCs7p2uQeJxui2_9deltalake.exit.thread, !prof !10539
...
bb.b:                                             ; preds = %_RNvMsd_Cs3fLsjMQPbhe_8smallvecINtB5_8SmallVecANtNtNtNtCsbG4i8A5DnWX_18tracing_subscriber6filter3env9directive9Directivej8_E6tripleCs7p2uQeJxui2_9deltalake.exit.thread
  %i.l = add nuw i64 %.sroa.02.0, 1               ; 4 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !10556)
  %i.m = icmp ult i64 %i.c, 9                     ; 2 uses
  %i.n = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 4 uses
...
bb.c:                                             ; preds = %bb.b
  %i.o = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.p = load ptr, ptr %i.o, align 8, !alias.scope !10559, !noalias !10562, !nonnull !4, !noundef !4
  %.pre = load i64, ptr %i.n, align 8, !alias.scope !10556
...
bb.d:                                             ; preds = %_RNvMsd_Cs3fLsjMQPbhe_8smallvecINtB5_8SmallVecANtNtNtNtCsbG4i8A5DnWX_18tracing_subscriber6filter3env9directive9Directivej8_E10triple_mutCs7p2uQeJxui2_9deltalake.exit.i
  tail call void @_RNvNtCsbvkFyIu7lgC_4core9panicking5panic(ptr noalias noundef nonnull readonly captures(address, read_provenance) @289, i64 noundef 32, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @290) #36, !noalias !10556
  unreachable
...
bb.j:                                             ; preds = %_RINvCs3fLsjMQPbhe_8smallvec12layout_arrayNtNtNtNtCsbG4i8A5DnWX_18tracing_subscriber6filter3env9directive9DirectiveECs7p2uQeJxui2_9deltalake.exit.i
  tail call void @_RNvCs8mYq7K4qqSA_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #41, !noalias !10556
  %i.t = tail call noundef align 8 ptr @_RNvCs8mYq7K4qqSA_7___rustc12___rust_alloc(i64 noundef %i.s, i64 noundef 8) #41, !noalias !10556 ; 3 uses
  %i.u = icmp eq ptr %i.t, null
  br i1 %i.u, label %bb.o, label %bb.l
...
bb.k:                                             ; preds = %bb.l, %_RINvCs3fLsjMQPbhe_8smallvec12layout_arrayNtNtNtNtCsbG4i8A5DnWX_18tracing_subscriber6filter3env9directive9DirectiveECs7p2uQeJxui2_9deltalake.exit48.i
  ...
  store i64 1, ptr %0, align 8, !alias.scope !10556
  store i64 %i.q, ptr %i.n, align 8, !alias.scope !10556
  %.sroa.540.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %0, i64 16
  store ptr %.sroa.031.0.i, ptr %.sroa.540.0..sroa_idx.i, align 8, !alias.scope !10556
  store i64 %i.l, ptr %i.b, align 8, !alias.scope !10556
  br label %_RINvCs3fLsjMQPbhe_8smallvec10infallibleuECs7p2uQeJxui2_9deltalake.exit

bb.l:                                             ; preds = %bb.j
  %i.y = mul nuw i64 %i.q, 80
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %i.t, ptr nonnull align 8 %.sink11.i.i, i64 %i.y, i1 false)
  br label %bb.k

bb.m:                                             ; preds = %bb.g
  store i64 0, ptr %0, align 8, !alias.scope !10556
  %i.z = mul nuw i64 %i.q, 80
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %i.n, ptr nonnull align 8 %.sink11.i.i, i64 %i.z, i1 false)
  store i64 %i.q, ptr %i.b, align 8, !alias.scope !10556
...
bb.n:                                             ; preds = %bb.m
  ...
  store i64 0, ptr %i.a, align 8, !noalias !10564
  %i.ab = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  store i64 %i.aa, ptr %i.ab, align 8, !noalias !10564
  call void @_RNvNtCsbvkFyIu7lgC_4core6result13unwrap_failed(ptr noalias noundef nonnull readonly captures(address, read_provenance) @237, i64 noundef 43, ptr noundef nonnull %i.a, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) @239, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @1) #37, !noalias !10564
  unreachable
...
.body:                                            ; preds = %.body.i, %bb.q, %bb.d
  ...
  %i.t = load ptr, ptr %i.j, align 8, !alias.scope !10567, !noundef !4
  %i.u = icmp eq ptr %i.t, null
...
bb.k:                                             ; preds = %bb.i
  ...
  store ptr %.sroa.016.0.copyload, ptr %i.g, align 8, !noalias !10570
  store ptr %.sroa.022.0.copyload, ptr %i.f, align 8, !noalias !10570
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e), !noalias !10570
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d), !noalias !10570
  store ptr %i.g, ptr %i.d, align 8, !noalias !10570
  %.sroa.43.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.d, i64 8
  store ptr @_RNvXs1g_NtCsbvkFyIu7lgC_4core3fmtRNtNtCs7p2uQeJxui2_9deltalake10filesystem22DeltaFileSystemHandlerNtB6_5Debug3fmtBA_, ptr %.sroa.43.0..sroa_idx.i, align 8, !noalias !10570
...
.noexc29:                                         ; preds = %bb.k
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d), !noalias !10570
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c), !noalias !10570
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !10570
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !10570
  store ptr %i.f, ptr %i.a, align 8, !noalias !10570
  %.sroa.48.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  store ptr @_RNvXs1g_NtCsbvkFyIu7lgC_4core3fmtRNtNtCs7p2uQeJxui2_9deltalake10filesystem22DeltaFileSystemHandlerNtB6_5Debug3fmtBA_, ptr %.sroa.48.0..sroa_idx.i, align 8, !noalias !10570
  invoke void @_RNvNvNtCs6Po7BT7Nknu_5alloc3fmt6format12format_inner(ptr noalias noundef nonnull sret([24 x i8]) align 8 captures(none) dereferenceable(24) %i.b, ptr noundef nonnull @4, ptr noundef nonnull %i.a)
          to label %_RINvMNtCsbvkFyIu7lgC_4core6optionINtB3_6OptionReE11map_or_elseNtNtCs6Po7BT7Nknu_5alloc6string6StringNCNvNtB12_3fmt6format0NvYeNtNtB12_6borrow7ToOwned8to_ownedECs7p2uQeJxui2_9deltalake.exit.i unwind label %bb.l, !noalias !10575
...
.body.i:                                          ; preds = %bb.o, %bb.l
  ...
  invoke void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6Po7BT7Nknu_5alloc6string6StringECs7p2uQeJxui2_9deltalake(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.e) #38
          to label %.body unwind label %bb.s, !noalias !10575

_RINvMNtCsbvkFyIu7lgC_4core6optionINtB3_6OptionReE11map_or_elseNtNtCs6Po7BT7Nknu_5alloc6string6StringNCNvNtB12_3fmt6format0NvYeNtNtB12_6borrow7ToOwned8to_ownedECs7p2uQeJxui2_9deltalake.exit.i: ; preds = %.noexc29
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !10570
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.c, ptr noundef nonnull align 8 dereferenceable(24) %i.b, i64 24, i1 false), !noalias !10570
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !10570
  %i.ac = getelementptr inbounds nuw i8, ptr %i.e, i64 16
  %i.ad = load i64, ptr %i.ac, align 8, !noalias !10570, !noundef !4 ; 2 uses
  %i.ae = getelementptr inbounds nuw i8, ptr %i.c, i64 16
  %i.af = load i64, ptr %i.ae, align 8, !noalias !10570, !noundef !4
  %i.ag = icmp eq i64 %i.ad, %i.af
  br i1 %i.ag, label %bb.m, label %bb.n

bb.m:                                             ; preds = %_RINvMNtCsbvkFyIu7lgC_4core6optionINtB3_6OptionReE11map_or_elseNtNtCs6Po7BT7Nknu_5alloc6string6StringNCNvNtB12_3fmt6format0NvYeNtNtB12_6borrow7ToOwned8to_ownedECs7p2uQeJxui2_9deltalake.exit.i
  %i.ah = getelementptr inbounds nuw i8, ptr %i.c, i64 8
  %i.ai = load ptr, ptr %i.ah, align 8, !noalias !10570, !nonnull !4, !noundef !4
  %i.aj = getelementptr inbounds nuw i8, ptr %i.e, i64 8
  %i.ak = load ptr, ptr %i.aj, align 8, !noalias !10570, !nonnull !4, !noundef !4
  %bcmp.i = call i32 @bcmp(ptr nonnull %i.ak, ptr nonnull %i.ai, i64 %i.ad), !noalias !10575
  %i.al = icmp eq i32 %bcmp.i, 0
  %i.am = select i1 %i.al, ptr @_Py_TrueStruct, ptr @_Py_FalseStruct
  br label %bb.n

bb.n:                                             ; preds = %bb.m, %_RINvMNtCsbvkFyIu7lgC_4core6optionINtB3_6OptionReE11map_or_elseNtNtCs6Po7BT7Nknu_5alloc6string6StringNCNvNtB12_3fmt6format0NvYeNtNtB12_6borrow7ToOwned8to_ownedECs7p2uQeJxui2_9deltalake.exit.i
  %.sroa.0.0.i = phi ptr [ %i.am, %bb.m ], [ @_Py_FalseStruct, %_RINvMNtCsbvkFyIu7lgC_4core6optionINtB3_6OptionReE11map_or_elseNtNtCs6Po7BT7Nknu_5alloc6string6StringNCNvNtB12_3fmt6format0NvYeNtNtB12_6borrow7ToOwned8to_ownedECs7p2uQeJxui2_9deltalake.exit.i ]
  invoke void @_RNvXso_NtCs6Po7BT7Nknu_5alloc3vecINtB5_3VechENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCs7p2uQeJxui2_9deltalake(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.c)
          to label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VechEECs7p2uQeJxui2_9deltalake.exit.i.i unwind label %bb.o, !noalias !10575
...
bb.o:                                             ; preds = %bb.n
  ...
  invoke void @_RNvXs1_NtCs6Po7BT7Nknu_5alloc7raw_vecINtB5_6RawVechENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCs7p2uQeJxui2_9deltalake(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.c)
          to label %.body.i unwind label %bb.p, !noalias !10575

bb.p:                                             ; preds = %bb.o
  %i.ao = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #39, !noalias !10575
  unreachable
