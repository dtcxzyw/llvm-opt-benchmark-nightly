...
bb.c:                                             ; preds = %.lr.ph3
  ...
  %i.d = icmp eq i64 %lsr.iv, %lsr.iv.next9
...
bb.c:                                             ; preds = %.lr.ph4
  ...
  %i.e = icmp eq i64 %lsr.iv, %lsr.iv.next10
...
.lr.ph4:                                          ; preds = %.lr.ph4.preheader, %bb.c
  %lsr.iv14 = phi ptr [ %lsr.iv12, %.lr.ph4.preheader ], [ %scevgep15, %bb.c ] ; 2 uses
...
bb.c:                                             ; preds = %.lr.ph4
  ...
  %i.j = icmp eq i64 %lsr.iv, %lsr.iv.next10
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtNtCsbG4i8A5DnWX_18tracing_subscriber6filter3env5field13CallsiteMatchECs7p2uQeJxui2_9deltalake.exit7.i: ; preds = %.lr.ph4
  ...
  %i.j = icmp eq i64 %lsr.iv, %lsr.iv.next11
  br i1 %i.j, label %common.resume.loopexit, label %.lr.ph4
...
.lr.ph4:                                          ; preds = %.lr.ph4.preheader, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtNtCsbG4i8A5DnWX_18tracing_subscriber6filter3env5field13CallsiteMatchECs7p2uQeJxui2_9deltalake.exit7.i
  %lsr.iv15 = phi ptr [ %lsr.iv13, %.lr.ph4.preheader ], [ %scevgep16, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtNtCsbG4i8A5DnWX_18tracing_subscriber6filter3env5field13CallsiteMatchECs7p2uQeJxui2_9deltalake.exit7.i ] ; 2 uses
...
.lr.ph4:                                          ; preds = %.lr.ph4.preheader, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtNtCsbG4i8A5DnWX_18tracing_subscriber6filter3env5field9SpanMatchECs7p2uQeJxui2_9deltalake.exit7.i
  %lsr.iv15 = phi ptr [ %lsr.iv13, %.lr.ph4.preheader ], [ %scevgep16, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtNtCsbG4i8A5DnWX_18tracing_subscriber6filter3env5field9SpanMatchECs7p2uQeJxui2_9deltalake.exit7.i ] ; 2 uses
