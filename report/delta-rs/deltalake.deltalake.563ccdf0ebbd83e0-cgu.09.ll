...
bb.hm:                                            ; preds = %bb.hk
  %i.rv = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.rw = atomicrmw sub ptr %i.pa, i64 1 release, align 8, !noalias !12619
...
bb.a:
  ...
  %i.b = load i64, ptr %i.a, align 8, !alias.scope !12624, !noundef !4 ; 2 uses
...
bb.d:                                             ; preds = %bb.c, %bb.b, %bb.a
  ...
  %i.h = load ptr, ptr %i.g, align 8, !alias.scope !12624, !nonnull !4, !noundef !4
  %i.i = load i64, ptr %i.a, align 8, !alias.scope !12624, !noundef !4 ; 2 uses
...
_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String4push.exit: ; preds = %bb.f, %bb.g, %bb.i, %bb.j
  ...
  store i64 %i.ak, ptr %i.a, align 8, !alias.scope !12624
  ret i1 false
}
...
bb.a:
  tail call void @_RNvMs_NtCs6Po7BT7Nknu_5alloc3vecINtB4_3VechE7reserveCs7p2uQeJxui2_9deltalake(ptr noalias noundef nonnull align 8 dereferenceable(24) %0, i64 noundef %2), !noalias !12627
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 3 uses
  %i.b = load i64, ptr %i.a, align 8, !alias.scope !12630, !noalias !12627, !noundef !4 ; 3 uses
  %i.c = icmp sgt i64 %i.b, -1
  tail call void @llvm.assume(i1 %i.c)
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.e = load ptr, ptr %i.d, align 8, !alias.scope !12630, !noalias !12627, !nonnull !4, !noundef !4
  %i.f = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.b
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.f, ptr nonnull readonly align 1 %1, i64 %2, i1 false)
  %.pre.i.i = load i64, ptr %i.a, align 8, !alias.scope !12630, !noalias !12627
...
_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String8push_str.exit: ; preds = %bb.a, %bb.b
  ...
  %i.h = add i64 %i.g, %2
  store i64 %i.h, ptr %i.a, align 8, !alias.scope !12630, !noalias !12627
  ret i1 false
}
...
bb.a:
  ...
  %.pre = load i64, ptr %1, align 8, !range !1145
...
bb.b:                                             ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionINtNtNtCsbZMnTeWjWd9_9hashbrown3raw5inner11RawIntoIterTNtNtCs6Po7BT7Nknu_5alloc6string6StringINtNtCs3JXekYNd0JR_7dashmap4util11SharedValueINtNtB1Z_3vec3VecbEEEEEECs7p2uQeJxui2_9deltalake.exit, %bb.a
  tail call void @llvm.experimental.noalias.scope.decl(metadata !12634)
  %i.l = load i64, ptr %i.b, align 8, !alias.scope !12634, !noalias !12637, !noundef !4 ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  tail call void @llvm.experimental.noalias.scope.decl(metadata !12639)
  %i.n = load i16, ptr %i.d, align 8, !alias.scope !12642, !noalias !12637, !noundef !4 ; 2 uses
  %.not9.i.i = icmp eq i16 %i.n, 0
  %.promoted.i.i = load ptr, ptr %i.c, align 8, !alias.scope !12642, !noalias !12637 ; 2 uses
  br i1 %.not9.i.i, label %.lr.ph.i.i, label %_RNvXsA_NtNtCsbZMnTeWjWd9_9hashbrown3raw5innerINtB5_11RawIntoIterTNtNtCs6Po7BT7Nknu_5alloc6string6StringINtNtCs3JXekYNd0JR_7dashmap4util11SharedValueINtNtB15_3vec3VecbEEEENtNtNtNtCsbvkFyIu7lgC_4core4iter6traits8iterator8Iterator4nextCs7p2uQeJxui2_9deltalake.exit

.lr.ph.i.i:                                       ; preds = %bb.c
  %.promoted11.i.i = load ptr, ptr %i.e, align 8, !alias.scope !12642, !noalias !12637
  br label %bb.d

._crit_edge.i.i:                                  ; preds = %bb.d
  store ptr %i.t, ptr %i.e, align 8, !alias.scope !12642, !noalias !12637
  store ptr %i.s, ptr %i.c, align 8, !alias.scope !12642, !noalias !12637
...
bb.d:                                             ; preds = %bb.d, %.lr.ph.i.i
  %i.o = phi ptr [ %.promoted11.i.i, %.lr.ph.i.i ], [ %i.t, %bb.d ] ; 2 uses
  %i.p = phi ptr [ %.promoted.i.i, %.lr.ph.i.i ], [ %i.s, %bb.d ]
  %i.q = load <16 x i8>, ptr %i.o, align 16, !noalias !12643
  %i.r = icmp sgt <16 x i8> %i.q, splat (i8 -1)
  %i.s = getelementptr inbounds i8, ptr %i.p, i64 -768 ; 3 uses
  %i.t = getelementptr inbounds nuw i8, ptr %i.o, i64 16 ; 2 uses
  %.cast.i.i = bitcast <16 x i1> %i.r to i16      ; 2 uses
...
_RNvXsA_NtNtCsbZMnTeWjWd9_9hashbrown3raw5innerINtB5_11RawIntoIterTNtNtCs6Po7BT7Nknu_5alloc6string6StringINtNtCs3JXekYNd0JR_7dashmap4util11SharedValueINtNtB15_3vec3VecbEEEENtNtNtNtCsbvkFyIu7lgC_4core4iter6traits8iterator8Iterator4nextCs7p2uQeJxui2_9deltalake.exit: ; preds = %bb.c, %._crit_edge.i.i
  %i.u = phi ptr [ %i.s, %._crit_edge.i.i ], [ %.promoted.i.i, %bb.c ]
  %.lcssa.i.i = phi i16 [ %.cast.i.i, %._crit_edge.i.i ], [ %i.n, %bb.c ] ; 3 uses
  %i.v = add i16 %.lcssa.i.i, -1
  %i.w = tail call range(i16 0, 17) i16 @llvm.cttz.i16(i16 %.lcssa.i.i, i1 true)
  %i.x = zext nneg i16 %i.w to i64
  %i.y = and i16 %i.v, %.lcssa.i.i
  store i16 %i.y, ptr %i.d, align 8, !alias.scope !12642, !noalias !12637
  %i.z = sub nsw i64 0, %i.x
  %i.aa = getelementptr inbounds [48 x i8], ptr %i.u, i64 %i.z ; 3 uses
  %i.ab = add i64 %i.l, -1
  store i64 %i.ab, ptr %i.b, align 8, !alias.scope !12634, !noalias !12637
  %i.ac = getelementptr inbounds i8, ptr %i.aa, i64 -48
  %.sroa.0.0.copyload = load i64, ptr %i.ac, align 8, !noalias !12634 ; 2 uses
...
bb.g:                                             ; preds = %_RNvXsA_NtNtCsbZMnTeWjWd9_9hashbrown3raw5innerINtB5_11RawIntoIterTNtNtCs6Po7BT7Nknu_5alloc6string6StringINtNtCs3JXekYNd0JR_7dashmap4util11SharedValueINtNtB15_3vec3VecbEEEENtNtNtNtCsbvkFyIu7lgC_4core4iter6traits8iterator8Iterator4nextCs7p2uQeJxui2_9deltalake.exit.thread
  %i.ah = tail call noundef nonnull align 8 ptr @_RNvXs2_Cs3JXekYNd0JR_7dashmapINtB5_7DashMapNtNtCs6Po7BT7Nknu_5alloc6string6StringINtNtBJ_3vec3VecbEEINtNtB5_1t3MapBF_B1h_NtNtNtCs2pqxYH9ZEk8_3std4hash6random11RandomStateE18__yield_write_shardCs7p2uQeJxui2_9deltalake(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(40) %i.h, i64 noundef %i.ad) ; 3 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a)
  %i.ai = getelementptr inbounds nuw i8, ptr %i.ah, i64 8 ; 2 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.a, ptr noundef nonnull align 8 dereferenceable(32) %i.ai, i64 32, i1 false)
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.ai, ptr noundef nonnull align 8 dereferenceable(32) @10, i64 32, i1 false)
  %i.aj = cmpxchg ptr %i.ah, i64 -4, i64 0 release monotonic, align 8
  %.sroa.18.0.in.i.i.i.i = extractvalue { i64, i1 } %i.aj, 1
...
common.resume.i:                                  ; preds = %.body.i, %bb.o, %bb.s
  ...
  store ptr %i.ax, ptr %.sroa.9.0..sroa_idx36, align 8
  store <16 x i1> %i.av, ptr %i.d, align 8
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCslfDARg5dRCJ_8lock_api6rwlock16RwLockWriteGuardNtNtCs3JXekYNd0JR_7dashmap4lock9RawRwLockINtNtNtCsbZMnTeWjWd9_9hashbrown3raw5inner8RawTableTNtNtCs6Po7BT7Nknu_5alloc6string6StringINtNtB1B_4util11SharedValueINtNtB35_3vec3VecbEEEEEECs7p2uQeJxui2_9deltalake.exit: ; preds = %bb.g, %bb.h
  ...
  %i.ak = load <16 x i8>, ptr %.sroa.018.0.copyload, align 16, !noalias !12646
  %i.al = icmp eq i64 %.sroa.419.0.copyload, 0
  br i1 %i.al, label %bb.i, label %_RNvMs1_NtNtCsbZMnTeWjWd9_9hashbrown3raw5innerNtB5_11TableLayout20calculate_layout_for.exit.i.i
...
_RNvMs1_NtNtCsbZMnTeWjWd9_9hashbrown3raw5innerNtB5_11TableLayout20calculate_layout_for.exit.i.i: ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCslfDARg5dRCJ_8lock_api6rwlock16RwLockWriteGuardNtNtCs3JXekYNd0JR_7dashmap4lock9RawRwLockINtNtNtCsbZMnTeWjWd9_9hashbrown3raw5inner8RawTableTNtNtCs6Po7BT7Nknu_5alloc6string6StringINtNtB1B_4util11SharedValueINtNtB35_3vec3VecbEEEEEECs7p2uQeJxui2_9deltalake.exit
  %i.am = mul i64 %.sroa.419.0.copyload, 48       ; 2 uses
  %i.an = add i64 %i.am, 48                       ; 2 uses
  %i.ao = add i64 %.sroa.419.0.copyload, 17
  ...
  %i.at = getelementptr inbounds i8, ptr %.sroa.018.0.copyload, i64 %i.as
  br label %bb.i
...
bb.i:                                             ; preds = %_RNvMs1_NtNtCsbZMnTeWjWd9_9hashbrown3raw5innerNtB5_11TableLayout20calculate_layout_for.exit.i.i, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCslfDARg5dRCJ_8lock_api6rwlock16RwLockWriteGuardNtNtCs3JXekYNd0JR_7dashmap4lock9RawRwLockINtNtNtCsbZMnTeWjWd9_9hashbrown3raw5inner8RawTableTNtNtCs6Po7BT7Nknu_5alloc6string6StringINtNtB1B_4util11SharedValueINtNtB35_3vec3VecbEEEEEECs7p2uQeJxui2_9deltalake.exit
  ...
  %i.au = getelementptr inbounds nuw i8, ptr %.sroa.018.0.copyload, i64 16 ; 2 uses
  %i.av = icmp sgt <16 x i8> %i.ak, splat (i8 -1) ; 2 uses
  %i.aw = getelementptr i8, ptr %.sroa.018.0.copyload, i64 %.sroa.419.0.copyload
  %i.ax = getelementptr i8, ptr %i.aw, i64 1      ; 2 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !12654)
  %i.ay = load i64, ptr %1, align 8, !range !1145, !alias.scope !12654, !noundef !4 ; 3 uses
  %i.az = icmp eq i64 %i.ay, -9223372036854775807
  br i1 %i.az, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionINtNtNtCsbZMnTeWjWd9_9hashbrown3raw5inner11RawIntoIterTNtNtCs6Po7BT7Nknu_5alloc6string6StringINtNtCs3JXekYNd0JR_7dashmap4util11SharedValueINtNtB1Z_3vec3VecbEEEEEECs7p2uQeJxui2_9deltalake.exit, label %bb.j
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.ba = load i64, ptr %i.b, align 8, !alias.scope !12666, !noundef !4 ; 2 uses
  %i.bb = icmp eq i64 %i.ba, 0
  br i1 %i.bb, label %_RNvMsn_NtNtCsbZMnTeWjWd9_9hashbrown3raw5innerINtB5_7RawIterTNtNtCs6Po7BT7Nknu_5alloc6string6StringINtNtCs3JXekYNd0JR_7dashmap4util11SharedValueINtNtB10_3vec3VecbEEEE13drop_elementsCs7p2uQeJxui2_9deltalake.exit.i.i.i, label %.preheader.i.i.i.i

.preheader.i.i.i.i:                               ; preds = %bb.j
  %.promoted.i.i.i = load i16, ptr %i.d, align 8, !alias.scope !12667
  %.promoted2.i.i.i = load ptr, ptr %i.c, align 8, !alias.scope !12670
  %.promoted5.i.i.i = load ptr, ptr %i.e, align 8, !alias.scope !12670
  br label %bb.k

bb.k:                                             ; preds = %.noexc5, %.preheader.i.i.i.i
  %.promoted11.i.i7.i.i.i = phi ptr [ %.promoted5.i.i.i, %.preheader.i.i.i.i ], [ %.promoted11.i.i6.i.i.i, %.noexc5 ] ; 2 uses
  %.lcssa14.i.i.i = phi ptr [ %.promoted2.i.i.i, %.preheader.i.i.i.i ], [ %.lcssa13.i.i.i, %.noexc5 ] ; 2 uses
  %i.bc = phi i16 [ %.promoted.i.i.i, %.preheader.i.i.i.i ], [ %i.bn, %.noexc5 ] ; 2 uses
  %i.bd = phi i64 [ %i.ba, %.preheader.i.i.i.i ], [ %i.bq, %.noexc5 ]
  tail call void @llvm.experimental.noalias.scope.decl(metadata !12671)
  %.not9.i.i.i.i.i = icmp eq i16 %i.bc, 0
  br i1 %.not9.i.i.i.i.i, label %.lr.ph.i.i.i.i.i, label %_RINvMsh_NtNtCsbZMnTeWjWd9_9hashbrown3raw5innerINtB6_12RawIterRangeTNtNtCs6Po7BT7Nknu_5alloc6string6StringINtNtCs3JXekYNd0JR_7dashmap4util11SharedValueINtNtB17_3vec3VecbEEEE9next_implKb0_ECs7p2uQeJxui2_9deltalake.exit.i.i.i.i

._crit_edge.i.i.i.i.i:                            ; preds = %.lr.ph.i.i.i.i.i
  store ptr %i.bj, ptr %i.e, align 8, !alias.scope !12667
  store ptr %i.bi, ptr %i.c, align 8, !alias.scope !12667
...
.lr.ph.i.i.i.i.i:                                 ; preds = %bb.k, %.lr.ph.i.i.i.i.i
  %i.be = phi ptr [ %i.bj, %.lr.ph.i.i.i.i.i ], [ %.promoted11.i.i7.i.i.i, %bb.k ] ; 2 uses
  %i.bf = phi ptr [ %i.bi, %.lr.ph.i.i.i.i.i ], [ %.lcssa14.i.i.i, %bb.k ]
  %i.bg = load <16 x i8>, ptr %i.be, align 16, !noalias !12672
  %i.bh = icmp sgt <16 x i8> %i.bg, splat (i8 -1)
  %i.bi = getelementptr inbounds i8, ptr %i.bf, i64 -768 ; 3 uses
  %i.bj = getelementptr inbounds nuw i8, ptr %i.be, i64 16 ; 3 uses
  %.cast.i.i.i.i.i = bitcast <16 x i1> %i.bh to i16 ; 2 uses
...
_RINvMsh_NtNtCsbZMnTeWjWd9_9hashbrown3raw5innerINtB6_12RawIterRangeTNtNtCs6Po7BT7Nknu_5alloc6string6StringINtNtCs3JXekYNd0JR_7dashmap4util11SharedValueINtNtB17_3vec3VecbEEEE9next_implKb0_ECs7p2uQeJxui2_9deltalake.exit.i.i.i.i: ; preds = %._crit_edge.i.i.i.i.i, %bb.k
  %.promoted11.i.i6.i.i.i = phi ptr [ %i.bj, %._crit_edge.i.i.i.i.i ], [ %.promoted11.i.i7.i.i.i, %bb.k ]
  %.lcssa13.i.i.i = phi ptr [ %i.bi, %._crit_edge.i.i.i.i.i ], [ %.lcssa14.i.i.i, %bb.k ] ; 2 uses
  %.lcssa.i.i.i.i.i = phi i16 [ %.cast.i.i.i.i.i, %._crit_edge.i.i.i.i.i ], [ %i.bc, %bb.k ] ; 3 uses
  %i.bk = add i16 %.lcssa.i.i.i.i.i, -1
  %i.bl = tail call range(i16 0, 17) i16 @llvm.cttz.i16(i16 %.lcssa.i.i.i.i.i, i1 true)
  %i.bm = zext nneg i16 %i.bl to i64
  %i.bn = and i16 %i.bk, %.lcssa.i.i.i.i.i        ; 2 uses
  store i16 %i.bn, ptr %i.d, align 8, !alias.scope !12667
  %i.bo = sub nsw i64 0, %i.bm
  %i.bp = getelementptr inbounds [48 x i8], ptr %.lcssa13.i.i.i, i64 %i.bo ; 3 uses
  %i.bq = add i64 %i.bd, -1                       ; 3 uses
  store i64 %i.bq, ptr %i.b, align 8, !alias.scope !12666
  %i.br = getelementptr inbounds i8, ptr %i.bp, i64 -48 ; 3 uses
  invoke void @_RNvXso_NtCs6Po7BT7Nknu_5alloc3vecINtB5_3VechENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCs7p2uQeJxui2_9deltalake(ptr noalias noundef nonnull align 8 dereferenceable(48) %i.br)
...
bb.l:                                             ; preds = %_RINvMsh_NtNtCsbZMnTeWjWd9_9hashbrown3raw5innerINtB6_12RawIterRangeTNtNtCs6Po7BT7Nknu_5alloc6string6StringINtNtCs3JXekYNd0JR_7dashmap4util11SharedValueINtNtB17_3vec3VecbEEEE9next_implKb0_ECs7p2uQeJxui2_9deltalake.exit.i.i.i.i
  %i.bs = landingpad { ptr, i32 }
          cleanup
  invoke void @_RNvXs1_NtCs6Po7BT7Nknu_5alloc7raw_vecINtB5_6RawVechENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCs7p2uQeJxui2_9deltalake(ptr noalias noundef nonnull align 8 dereferenceable(48) %i.br)
...
.body.i:                                          ; preds = %bb.n, %bb.l
  %eh.lpad-body.i = phi { ptr, i32 } [ %i.bu, %bb.n ], [ %i.bs, %bb.l ]
  %i.bv = getelementptr inbounds i8, ptr %i.bp, i64 -24
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs3JXekYNd0JR_7dashmap4util11SharedValueINtNtCs6Po7BT7Nknu_5alloc3vec3VecbEEECs7p2uQeJxui2_9deltalake(ptr noalias noundef align 8 dereferenceable(24) %i.bv) #38
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6Po7BT7Nknu_5alloc6string6StringECs7p2uQeJxui2_9deltalake.exit.i: ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VechEECs7p2uQeJxui2_9deltalake.exit.i.i
  %i.bw = getelementptr inbounds i8, ptr %i.bp, i64 -24 ; 3 uses
  invoke void @_RNvXso_NtCs6Po7BT7Nknu_5alloc3vecINtB5_3VecbENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCs7p2uQeJxui2_9deltalake(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.bw)
...
bb.o:                                             ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6Po7BT7Nknu_5alloc6string6StringECs7p2uQeJxui2_9deltalake.exit.i
  %i.bx = landingpad { ptr, i32 }
          cleanup
  invoke void @_RNvXs1_NtCs6Po7BT7Nknu_5alloc7raw_vecINtB5_6RawVecbENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCs7p2uQeJxui2_9deltalake(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.bw)
...
.noexc5:                                          ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs3JXekYNd0JR_7dashmap4util11SharedValueINtNtCs6Po7BT7Nknu_5alloc3vec3VecbEEECs7p2uQeJxui2_9deltalake.exit.i
  %.old3.i.i.i.i = icmp eq i64 %i.bq, 0
...
bb.r:                                             ; preds = %_RNvMsn_NtNtCsbZMnTeWjWd9_9hashbrown3raw5innerINtB5_7RawIterTNtNtCs6Po7BT7Nknu_5alloc6string6StringINtNtCs3JXekYNd0JR_7dashmap4util11SharedValueINtNtB10_3vec3VecbEEEE13drop_elementsCs7p2uQeJxui2_9deltalake.exit.i.i.i
  %i.ca = load ptr, ptr %i.i, align 8, !alias.scope !12670, !nonnull !4, !noundef !4
  %i.cb = load i64, ptr %i.j, align 8, !alias.scope !12670, !noundef !4
  tail call void @_RNvCs8mYq7K4qqSA_7___rustc14___rust_dealloc(ptr noundef nonnull %i.ca, i64 noundef %i.cb, i64 noundef range(i64 1, -9223372036854775807) %i.ay) #41, !noalias !12670
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionINtNtNtCsbZMnTeWjWd9_9hashbrown3raw5inner11RawIntoIterTNtNtCs6Po7BT7Nknu_5alloc6string6StringINtNtCs3JXekYNd0JR_7dashmap4util11SharedValueINtNtB1Z_3vec3VecbEEEEEECs7p2uQeJxui2_9deltalake.exit: ; preds = %bb.r, %_RNvMsn_NtNtCsbZMnTeWjWd9_9hashbrown3raw5innerINtB5_7RawIterTNtNtCs6Po7BT7Nknu_5alloc6string6StringINtNtCs3JXekYNd0JR_7dashmap4util11SharedValueINtNtB10_3vec3VecbEEEE13drop_elementsCs7p2uQeJxui2_9deltalake.exit.i.i.i, %bb.i
  ...
  store <16 x i1> %i.av, ptr %i.d, align 8
  store i64 %.sroa.521.0.copyload, ptr %i.b, align 8
  %i.cd = load i64, ptr %i.f, align 8, !noundef !4
  %i.ce = add i64 %i.cd, 1
...
bb.t:                                             ; preds = %common.resume.i, %bb.u
  %.pn47 = phi { ptr, i32 } [ %i.cf, %bb.u ], [ %eh.lpad-body, %common.resume.i ]
  resume { ptr, i32 } %.pn47
