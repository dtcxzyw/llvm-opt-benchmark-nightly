...
bb.a:
  ...
  %i.f = alloca [168 x i8], align 8               ; 22 uses
  ...
  %.sroa.52.0..sroa_idx.a = getelementptr inbounds nuw i8, ptr %i.f, i64 88
  store i8 0, ptr %.sroa.52.0..sroa_idx.a, align 8
  %.sroa.63.0..sroa_idx.a = getelementptr inbounds nuw i8, ptr %i.f, i64 89
  store i8 0, ptr %.sroa.63.0..sroa_idx.a, align 1
  %.sroa.04.sroa.4.0..sroa_idx.a = getelementptr inbounds nuw i8, ptr %i.f, i64 90
  store i8 0, ptr %.sroa.04.sroa.4.0..sroa_idx.a, align 2
  store i64 1, ptr %i.f, align 8
  %.sroa.04.sroa.6.0..sroa_idx.a = getelementptr inbounds nuw i8, ptr %i.f, i64 8
  store i64 4, ptr %.sroa.04.sroa.6.0..sroa_idx.a, align 8
  %.sroa.04.sroa.7.0..sroa_idx.a = getelementptr inbounds nuw i8, ptr %i.f, i64 16
  store ptr @7, ptr %.sroa.04.sroa.7.0..sroa_idx.a, align 8
  %.sroa.04.sroa.11.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.f, i64 24
  store i64 1, ptr %.sroa.04.sroa.11.0..sroa_idx, align 8
  %.sroa.04.sroa.12.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.f, i64 32
  store <6 x i8> <i8 0, i8 1, i8 1, i8 0, i8 0, i8 0>, ptr %.sroa.04.sroa.12.0..sroa_idx, align 8
