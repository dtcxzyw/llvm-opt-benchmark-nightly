...
bb.ab:                                            ; preds = %.noexc58.i
  ...
  %.val.i.i = load ptr, ptr %i.co, align 8, !alias.scope !10997, !noalias !10974, !nonnull !4, !noundef !4 ; 3 uses
  %i.cp = getelementptr i8, ptr %i.ce, i64 -8
  %.val5.i.i = load i64, ptr %i.cp, align 8, !alias.scope !10997, !noalias !10974, !noundef !4 ; 2 uses
  switch i64 %.val5.i.i, label %thread-pre-split.i.i.i.i [
...
bb.ac:                                            ; preds = %bb.ab
  %i.cq = load i8, ptr %.val.i.i, align 1, !alias.scope !11000, !noalias !11003, !noundef !4 ; 2 uses
...
bb.ad:                                            ; preds = %thread-pre-split.i.i.i.i, %bb.ac
  %5 = phi i8 [ %.pr.i.i.i.i, %thread-pre-split.i.i.i.i ], [ %i.cq, %bb.ac ]
  %cond.i.i.i.i = icmp eq i8 %5, 43               ; 2 uses
  %i.cr = sext i1 %cond.i.i.i.i to i64
  %.sroa.15.0.i.i.i.i = add nsw i64 %.val5.i.i, %i.cr ; 4 uses
  ...
  br i1 %i.cs, label %.preheader.i.i.i.i, label %.preheader56.i.i.i.i.preheader

.preheader.i.i.i.i:                               ; preds = %bb.ad
  %.not5366.i.i.i.i = icmp eq i64 %.sroa.15.0.i.i.i.i, 0
  br i1 %.not5366.i.i.i.i, label %_RINvMNtCsbvkFyIu7lgC_4core6optionINtB3_6OptionRNtNtCs6Po7BT7Nknu_5alloc6string6StringE6map_orjNCNvMsg_NtCs7p2uQeJxui2_9deltalake10filesystemNtB1C_22DeltaFileSystemHandler18open_output_stream0EB1E_.exit.thread105.i, label %.lr.ph.i.i.i.i

_RINvMNtCsbvkFyIu7lgC_4core6optionINtB3_6OptionRNtNtCs6Po7BT7Nknu_5alloc6string6StringE6map_orjNCNvMsg_NtCs7p2uQeJxui2_9deltalake10filesystemNtB1C_22DeltaFileSystemHandler18open_output_stream0EB1E_.exit.thread105.i: ; preds = %.preheader.i.i.i.i
  store i64 0, ptr %i.o, align 8, !noalias !10967
  br label %bb.al
...
.lr.ph.i.i.i.i:                                   ; preds = %.preheader.i.i.i.i, %bb.af
  %.sroa.0.269.i.i.i.i = phi ptr [ %i.dl, %bb.af ], [ %.sroa.0.0.i.i.i.i, %.preheader.i.i.i.i ] ; 2 uses
  %.sroa.15.268.i.i.i.i = phi i64 [ %i.dk, %bb.af ], [ %.sroa.15.0.i.i.i.i, %.preheader.i.i.i.i ]
  %.sroa.042.267.i.i.i.i = phi i64 [ %i.dn, %bb.af ], [ 0, %.preheader.i.i.i.i ]
...
bb.al:                                            ; preds = %_RINvMNtCsbvkFyIu7lgC_4core6optionINtB3_6OptionRNtNtCs6Po7BT7Nknu_5alloc6string6StringE6map_orjNCNvMsg_NtCs7p2uQeJxui2_9deltalake10filesystemNtB1C_22DeltaFileSystemHandler18open_output_stream0EB1E_.exit.i, %_RINvMNtCsbvkFyIu7lgC_4core6optionINtB3_6OptionRNtNtCs6Po7BT7Nknu_5alloc6string6StringE6map_orjNCNvMsg_NtCs7p2uQeJxui2_9deltalake10filesystemNtB1C_22DeltaFileSystemHandler18open_output_stream0EB1E_.exit.thread105.i
