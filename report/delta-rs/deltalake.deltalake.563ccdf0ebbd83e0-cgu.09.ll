...
bb.ai:                                            ; preds = %bb.bx, %bb.x
  %i.hm = phi ptr [ %i.cr, %bb.x ], [ %i.fw, %bb.bx ] ; 15 uses
  %i.hn = phi ptr [ %i.cq, %bb.x ], [ %i.fx, %bb.bx ] ; 14 uses
  %i.ho = phi ptr [ %.phi.trans.insert.i, %bb.x ], [ %i.fy, %bb.bx ] ; 15 uses
  %i.hp = phi ptr [ %.phi.trans.insert.i.i, %bb.x ], [ %i.fz, %bb.bx ] ; 15 uses
  %i.hq = phi ptr [ %i.es, %bb.x ], [ %i.ga, %bb.bx ] ; 14 uses
...
bb.aj:                                            ; preds = %_RNvXs_NtNtCsbvkFyIu7lgC_4core6future6futureINtNtB8_3pin3PinINtNtCs6Po7BT7Nknu_5alloc5boxed3BoxDNtB4_6Futurep6OutputINtNtB8_6result6ResultINtNtB8_6option6OptionINtNtB10_4sync3ArcDNtNtCsanCXJAiNsO_18datafusion_catalog5table13TableProviderEL_EENtNtCsjhHCjzi9uUI_17datafusion_common5error15DataFusionErrorENtNtB8_6marker4SendEL_EEB1v_4pollCs7p2uQeJxui2_9deltalake.exit.i.i.i
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.bw), !noalias !8879
  %.val.i.i.i = load ptr, ptr %i.hr, align 8, !noalias !8879 ; 5 uses
  %.val37.i.i.i = load ptr, ptr %i.hs, align 16, !noalias !8879, !nonnull !4, !align !344, !noundef !4 ; 5 uses
  %3 = load ptr, ptr %.val37.i.i.i, align 8, !invariant.load !4, !noalias !8883 ; 2 uses
...
4:                                                ; preds = %bb.aj
  ...
  invoke void %3(ptr noundef nonnull %.val.i.i.i)
          to label %5 unwind label %12, !noalias !8883

5:                                                ; preds = %4, %bb.aj
  %6 = getelementptr inbounds nuw i8, ptr %.val37.i.i.i, i64 8
  %7 = load i64, ptr %6, align 8, !range !276, !invariant.load !4, !noalias !8883 ; 2 uses
  %8 = icmp eq i64 %7, 0
  br i1 %8, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_3pin3PinINtNtCs6Po7BT7Nknu_5alloc5boxed3BoxDNtNtNtB4_6future6future6Futurep6OutputINtNtB4_6result6ResultINtNtB4_6option6OptionINtNtB11_4sync3ArcDNtNtCsanCXJAiNsO_18datafusion_catalog5table13TableProviderEL_EENtNtCsjhHCjzi9uUI_17datafusion_common5error15DataFusionErrorENtNtB4_6marker4SendEL_EEECs7p2uQeJxui2_9deltalake.exit.i.i.i, label %9

9:                                                ; preds = %5
  %10 = getelementptr inbounds nuw i8, ptr %.val37.i.i.i, i64 16
  %11 = load i64, ptr %10, align 8, !range !605, !invariant.load !4, !noalias !8883
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.val.i.i.i) ]
  call void @_RNvCs8mYq7K4qqSA_7___rustc14___rust_dealloc(ptr noundef nonnull %.val.i.i.i, i64 noundef range(i64 1, 0) %7, i64 noundef range(i64 1, 536870913) %11) #41, !noalias !8883
...
12:                                               ; preds = %4
  %13 = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %14 = getelementptr inbounds nuw i8, ptr %.val37.i.i.i, i64 8
  %15 = load i64, ptr %14, align 8, !range !276, !invariant.load !4, !noalias !8883 ; 2 uses
  %16 = icmp eq i64 %15, 0
  br i1 %16, label %.body.i.i.i.a, label %17

17:                                               ; preds = %12
  %18 = getelementptr inbounds nuw i8, ptr %.val37.i.i.i, i64 16
  %19 = load i64, ptr %18, align 8, !range !605, !invariant.load !4, !noalias !8883
  call void @_RNvCs8mYq7K4qqSA_7___rustc14___rust_dealloc(ptr noundef nonnull %.val.i.i.i, i64 noundef range(i64 1, 0) %15, i64 noundef range(i64 1, 536870913) %19) #41, !noalias !8883
  br label %.body.i.i.i.a

.body.i.i.i.a:                                    ; preds = %bb.bv, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtNtCs2pqxYH9ZEk8_3std11collections4hash3map11VacantEntryNtNtCsjhHCjzi9uUI_17datafusion_common15table_reference22ResolvedTableReferenceINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDNtNtCs8VI8w5SIoU4_15datafusion_expr12table_source11TableSourceEL_EEECs7p2uQeJxui2_9deltalake.exit.i.i.i, %17, %12, %bb.ah
  %20 = phi ptr [ %i.hm, %17 ], [ %i.hm, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtNtCs2pqxYH9ZEk8_3std11collections4hash3map11VacantEntryNtNtCsjhHCjzi9uUI_17datafusion_common15table_reference22ResolvedTableReferenceINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDNtNtCs8VI8w5SIoU4_15datafusion_expr12table_source11TableSourceEL_EEECs7p2uQeJxui2_9deltalake.exit.i.i.i ], [ %i.hm, %bb.ah ], [ %i.fw, %bb.bv ], [ %i.hm, %12 ] ; 2 uses
  %21 = phi ptr [ %i.hn, %17 ], [ %i.hn, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtNtCs2pqxYH9ZEk8_3std11collections4hash3map11VacantEntryNtNtCsjhHCjzi9uUI_17datafusion_common15table_reference22ResolvedTableReferenceINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDNtNtCs8VI8w5SIoU4_15datafusion_expr12table_source11TableSourceEL_EEECs7p2uQeJxui2_9deltalake.exit.i.i.i ], [ %i.hn, %bb.ah ], [ %i.fx, %bb.bv ], [ %i.hn, %12 ] ; 2 uses
  %22 = phi ptr [ %i.ho, %17 ], [ %i.ho, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtNtCs2pqxYH9ZEk8_3std11collections4hash3map11VacantEntryNtNtCsjhHCjzi9uUI_17datafusion_common15table_reference22ResolvedTableReferenceINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDNtNtCs8VI8w5SIoU4_15datafusion_expr12table_source11TableSourceEL_EEECs7p2uQeJxui2_9deltalake.exit.i.i.i ], [ %i.ho, %bb.ah ], [ %i.fy, %bb.bv ], [ %i.ho, %12 ] ; 2 uses
  %23 = phi ptr [ %i.hp, %17 ], [ %i.hp, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtNtCs2pqxYH9ZEk8_3std11collections4hash3map11VacantEntryNtNtCsjhHCjzi9uUI_17datafusion_common15table_reference22ResolvedTableReferenceINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDNtNtCs8VI8w5SIoU4_15datafusion_expr12table_source11TableSourceEL_EEECs7p2uQeJxui2_9deltalake.exit.i.i.i ], [ %i.hp, %bb.ah ], [ %i.fz, %bb.bv ], [ %i.hp, %12 ] ; 2 uses
  %24 = phi ptr [ %i.hq, %17 ], [ %i.hq, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtNtCs2pqxYH9ZEk8_3std11collections4hash3map11VacantEntryNtNtCsjhHCjzi9uUI_17datafusion_common15table_reference22ResolvedTableReferenceINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDNtNtCs8VI8w5SIoU4_15datafusion_expr12table_source11TableSourceEL_EEECs7p2uQeJxui2_9deltalake.exit.i.i.i ], [ %i.hq, %bb.ah ], [ %i.ga, %bb.bv ], [ %i.hq, %12 ] ; 2 uses
  %.pn18.i.i.i = phi { ptr, i32 } [ %13, %17 ], [ %i.jx, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtNtCs2pqxYH9ZEk8_3std11collections4hash3map11VacantEntryNtNtCsjhHCjzi9uUI_17datafusion_common15table_reference22ResolvedTableReferenceINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDNtNtCs8VI8w5SIoU4_15datafusion_expr12table_source11TableSourceEL_EEECs7p2uQeJxui2_9deltalake.exit.i.i.i ], [ %i.hl, %bb.ah ], [ %i.nx, %bb.bv ], [ %13, %12 ] ; 2 uses
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDNtNtCsanCXJAiNsO_18datafusion_catalog6schema14SchemaProviderEL_EECs7p2uQeJxui2_9deltalake.exit.i.i.i: ; preds = %bb.as, %bb.ak, %.body.i.i.i.a
  %i.iq = phi ptr [ %i.hm, %bb.as ], [ %20, %bb.ak ], [ %20, %.body.i.i.i.a ] ; 2 uses
  %i.ir = phi ptr [ %i.hn, %bb.as ], [ %21, %bb.ak ], [ %21, %.body.i.i.i.a ] ; 2 uses
  %i.is = phi ptr [ %i.ho, %bb.as ], [ %22, %bb.ak ], [ %22, %.body.i.i.i.a ] ; 2 uses
  %i.it = phi ptr [ %i.hp, %bb.as ], [ %23, %bb.ak ], [ %23, %.body.i.i.i.a ] ; 2 uses
  %i.iu = phi ptr [ %i.hq, %bb.as ], [ %24, %bb.ak ], [ %24, %.body.i.i.i.a ] ; 2 uses
...
bb.ca:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDNtNtCsanCXJAiNsO_18datafusion_catalog6schema14SchemaProviderEL_EECs7p2uQeJxui2_9deltalake.exit71.i.i.i
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCsjhHCjzi9uUI_17datafusion_common5error15DataFusionErrorECs7p2uQeJxui2_9deltalake(ptr noalias noundef nonnull align 8 dereferenceable(40) %i.ox)
