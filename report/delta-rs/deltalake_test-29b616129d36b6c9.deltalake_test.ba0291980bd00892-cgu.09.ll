begin_hunk_0
  ...
  %.not73.us.i.us.i.i201 = icmp eq i64 %.sroa.442.0.copyload.i.i.i, 0
  br label %283
...
300:                                              ; preds = %319
  %301 = add nuw nsw i64 %.sroa.04.0.i.us.i.i.i195, 1 ; 2 uses
...
.lr.ph197:                                        ; preds = %.preheader76.us.i.i.i.preheader, %.preheader76.us.i.i.i
  %.sroa.2.0.i.us.i.i.i196 = phi i64 [ %305, %.preheader76.us.i.i.i ], [ %.sroa.442.0.copyload.i.i.i, %.preheader76.us.i.i.i.preheader ]
  %305 = add i64 %.sroa.2.0.i.us.i.i.i196, -1     ; 6 uses
...
.lr.ph:                                           ; preds = %298, %300
  %.sroa.04.0.i.us.i.i.i195 = phi i64 [ %301, %300 ], [ %.sroa.0.0.i.i.us.i.i.i, %298 ] ; 4 uses
  %317 = add i64 %.sroa.04.0.i.us.i.i.i195, %290  ; 2 uses
  %318 = icmp ult i64 %317, %.sroa.1351.0.copyload.i.i.i
  br i1 %318, label %319, label %.split136.us.i.i.i

319:                                              ; preds = %.lr.ph
  %320 = getelementptr inbounds nuw i8, ptr %.sroa.14.0.copyload.i.i.i, i64 %.sroa.04.0.i.us.i.i.i195
...
324:                                              ; preds = %319
  ...
  %326 = add i64 %325, %.sroa.04.0.i.us.i.i.i195
  br label %.sink.split.i.us.i.i.i
...
.preheader75.us.i.i.i:                            ; preds = %371
  %341 = add nuw nsw i64 %.sroa.04.0.i50.us.i.i.i199, 1 ; 2 uses
...
.lr.ph203:                                        ; preds = %.preheader.us.i.us.i.i.preheader, %.preheader.us.i.us.i.i
  %.sroa.2.0.i51.us.i.us.i.i202 = phi i64 [ %343, %.preheader.us.i.us.i.i ], [ %.sroa.442.0.copyload.i.i.i, %.preheader.us.i.us.i.i.preheader ]
  %343 = add i64 %.sroa.2.0.i51.us.i.us.i.i202, -1 ; 4 uses
...
.lr.ph200:                                        ; preds = %.preheader75.us.i.i.i.preheader, %.preheader75.us.i.i.i
  %.sroa.04.0.i50.us.i.i.i199 = phi i64 [ %341, %.preheader75.us.i.i.i ], [ %.sroa.442.0.copyload.i.i.i, %.preheader75.us.i.i.i.preheader ] ; 4 uses
  %369 = add i64 %.sroa.04.0.i50.us.i.i.i199, %333 ; 2 uses
  %370 = icmp ult i64 %369, %.sroa.1351.0.copyload.i.i.i
  br i1 %370, label %371, label %.split148.us.i.i.i

371:                                              ; preds = %.lr.ph200
  %372 = getelementptr inbounds nuw i8, ptr %.sroa.14.0.copyload.i.i.i, i64 %.sroa.04.0.i50.us.i.i.i199
...
376:                                              ; preds = %371
  ...
  %378 = add i64 %377, %.sroa.04.0.i50.us.i.i.i199
  br label %381
...
.lr.ph.i.i43.i.i.sink.split:                      ; preds = %.noexc35.i.peel.i.i, %577
  %.sink207 = phi i64 [ %575, %577 ], [ %476, %.noexc35.i.peel.i.i ]
  ...
  %479 = getelementptr inbounds nuw i8, ptr %478, i64 %.sink207
...
.lr.ph.i.i43.i.i.preheader:                       ; preds = %.noexc35.i.peel.i.i, %.lr.ph.i.i43.i.i.sink.split
  %.pn109.i.i.ph = phi i64 [ %.pre.i34.i.i.i, %.lr.ph.i.i43.i.i.sink.split ], [ %476, %.noexc35.i.peel.i.i ]
  %.sroa.04.0156.i.i.i.ph245 = phi i64 [ %.sroa.04.0156.i.i.i.ph, %.lr.ph.i.i43.i.i.sink.split ], [ %.sroa.48.1203.i.peel.i.i, %.noexc35.i.peel.i.i ]
  br label %.lr.ph.i.i43.i.i

.lr.ph.i.i43.i.i:                                 ; preds = %.lr.ph.i.i43.i.i.preheader, %.noexc35.i.i.i
  %.pn109.i.i = phi i64 [ %575, %.noexc35.i.i.i ], [ %.pn109.i.i.ph, %.lr.ph.i.i43.i.i.preheader ]
  %.sroa.04.0156.i.i.i = phi i64 [ %.sroa.48.1203.i.i.i, %.noexc35.i.i.i ], [ %.sroa.04.0156.i.i.i.ph245, %.lr.ph.i.i43.i.i.preheader ] ; 14 uses
  %storemerge.i.i = add i64 %.pn109.i.i, %266
...
.split.us.invoke.i.i.i:                           ; preds = %.preheader.us.i.preheader.split.i.i, %307, %.lr.ph197, %.lr.ph203, %.split136.us.i.i.i, %.split148.us.i.i.i
  %558 = phi i64 [ %umax.i53.i.i.i, %.split148.us.i.i.i ], [ %344, %.lr.ph203 ], [ %umax.i.i.i.i, %.split136.us.i.i.i ], [ %308, %307 ], [ %305, %.lr.ph197 ], [ %281, %.preheader.us.i.preheader.split.i.i ]
  %559 = phi i64 [ %.sroa.1351.0.copyload.i.i.i, %.split148.us.i.i.i ], [ %.sroa.1351.0.copyload.i.i.i, %.lr.ph203 ], [ %.sroa.1351.0.copyload.i.i.i, %.split136.us.i.i.i ], [ %.sroa.1351.0.copyload.i.i.i, %307 ], [ %.sroa.15.0.copyload.i.i.i, %.lr.ph197 ], [ %.sroa.15.0.copyload.i.i.i, %.preheader.us.i.preheader.split.i.i ]
  %560 = phi ptr [ @20, %.split148.us.i.i.i ], [ @19, %.lr.ph203 ], [ @20, %.split136.us.i.i.i ], [ @19, %307 ], [ @18, %.lr.ph197 ], [ @18, %.preheader.us.i.preheader.split.i.i ]
