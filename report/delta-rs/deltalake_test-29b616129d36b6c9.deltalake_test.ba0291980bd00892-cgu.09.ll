...
bb.t:                                             ; preds = %_RINvMs_Cseo6ZV82fEK1_3urlNtB5_3Url14from_file_pathNtNtCs2pqxYH9ZEk8_3std4path7PathBufECsfY7SmN0bPrO_14deltalake_test.exit
  ...
  %i.ae = getelementptr inbounds nuw i8, ptr %i.e, i64 16 ; 4 uses
...
bb.v:                                             ; preds = %bb.u
  %2 = load i64, ptr %i.ae, align 8, !alias.scope !15, !noundef !4 ; 2 uses
  %i.ah = icmp sgt i64 %2, -1
...
.noexc14:                                         ; preds = %.noexc13
  ...
  %storemerge.i = select i1 %i.dy, i32 %i.dz, i32 %i.dx
...
.noexc23:                                         ; preds = %.noexc22
  ...
  %2 = load i32, ptr %i.h, align 4, !noalias !48, !noundef !4 ; 5 uses
  %i.gj = icmp eq i32 %2, 0
...
bb.l:                                             ; preds = %.noexc23
  %i.gl = urem i32 %2, 1000000
  %i.gm = udiv i32 %2, 1000000
...
bb.m:                                             ; preds = %bb.l
  %i.gp = urem i32 %2, 1000
  %i.gq = udiv i32 %2, 1000
