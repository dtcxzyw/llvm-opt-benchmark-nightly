...
begin_hunk_0_@_RNCNvXsi_NtNtCs9rVkZwOUgsI_13deltalake_aws8logstore17dynamodb_logstoreNtB7_18S3DynamoDbLogStoreNtNtCs14kWLkQVSKO_14deltalake_core8logstore8LogStore18get_latest_version0Bb_:bb.a
  store ptr inttoptr (i64 1 to ptr), ptr %.sroa.42.0..sroa_idx.i.i.i.i, align 8, !noalias !2607
  %.sroa.53.0..sroa_idx.i.i.i.i = getelementptr inbounds nuw i8, ptr %i.n, i64 16
  store i64 0, ptr %.sroa.53.0..sroa_idx.i.i.i.i, align 8, !noalias !2607
  call void @llvm.lifetime.start.p0(ptr nonnull %i.m), !noalias !2607
  %i.gz = getelementptr inbounds nuw i8, ptr %i.m, i64 16
  store i32 1610612768, ptr %i.gz, align 8, !noalias !2607
  %.sroa.4.0..sroa_idx.i.i.i.i = getelementptr inbounds nuw i8, ptr %i.m, i64 20
  store i16 0, ptr %.sroa.4.0..sroa_idx.i.i.i.i, align 4, !noalias !2607
  %.sroa.5.0..sroa_idx.i.i.i.i = getelementptr inbounds nuw i8, ptr %i.m, i64 22
  store i16 0, ptr %.sroa.5.0..sroa_idx.i.i.i.i, align 2, !noalias !2607
  store ptr %i.n, ptr %i.m, align 8, !noalias !2607
  %i.ha = getelementptr inbounds nuw i8, ptr %i.m, i64 8
  store ptr @166, ptr %i.ha, align 8, !noalias !2607
  ...
  %i.hd = invoke noundef zeroext i1 @_RNvXs_NtNtNtCskQDtHcQtBkN_5tokio7runtime4task5errorNtB4_9JoinErrorNtNtCsbvkFyIu7lgC_4core3fmt7Display3fmt(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.o, ptr noalias noundef nonnull align 8 dereferenceable(24) %i.m)
          to label %bb.ck unwind label %bb.cj, !noalias !2614
...
bb.cj:                                            ; preds = %bb.cl, %bb.ci
  ...
  invoke void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6Po7BT7Nknu_5alloc6string6StringECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.n) #31
          to label %.body.i.i.i unwind label %bb.cm, !noalias !2614
...
bb.cl:                                            ; preds = %bb.ck
  invoke void @_RNvNtCsbvkFyIu7lgC_4core6result13unwrap_failed(ptr noalias noundef nonnull readonly captures(address, read_provenance) @167, i64 noundef 55, ptr noundef nonnull %i.a, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) @93, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @169) #35
          to label %.noexc.i.i.i.i unwind label %bb.cj, !noalias !2614
...
bb.cm:                                            ; preds = %bb.cj
  ...
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #30, !noalias !2614
  unreachable
...
.body.i.i.i:                                      ; preds = %bb.cj
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtNtCskQDtHcQtBkN_5tokio7runtime4task5error9JoinErrorECs9rVkZwOUgsI_13deltalake_aws(ptr %i.hb, ptr %i.hc) #31
          to label %.body28.i unwind label %bb.cu, !noalias !2615

bb.cn:                                            ; preds = %bb.ck
  %.sroa.4.i.sroa.0.0.copyload.i = load i64, ptr %i.n, align 8, !noalias !2616
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.4.i.sroa.4.i, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.42.0..sroa_idx.i.i.i.i, i64 16, i1 false), !noalias !2616
  call void @llvm.lifetime.end.p0(ptr nonnull %i.m), !noalias !2607
  call void @llvm.lifetime.end.p0(ptr nonnull %i.n), !noalias !2607
  %i.hg = icmp eq i64 %.sroa.5.0.copyload.i, 0
  br i1 %i.hg, label %bb.gw, label %bb.co

bb.co:                                            ; preds = %bb.cn
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %i.hc) ]
  %i.hh = load ptr, ptr %i.hc, align 8, !invariant.load !3, !noalias !2615 ; 2 uses
...
bb.cp:                                            ; preds = %bb.co
  invoke void %i.hh(ptr noundef nonnull %i.hb)
          to label %bb.cq unwind label %bb.cs, !noalias !2615

bb.cq:                                            ; preds = %bb.cp, %bb.co
  %i.hi = getelementptr inbounds nuw i8, ptr %i.hc, i64 8
  %i.hj = load i64, ptr %i.hi, align 8, !range !4, !invariant.load !3, !noalias !2615 ; 2 uses
  %i.hk = icmp eq i64 %i.hj, 0
  br i1 %i.hk, label %bb.gw, label %bb.cr

bb.cr:                                            ; preds = %bb.cq
  %i.hl = getelementptr inbounds nuw i8, ptr %i.hc, i64 16
  %i.hm = load i64, ptr %i.hl, align 8, !range !5, !invariant.load !3, !noalias !2615
  call void @_RNvCs8mYq7K4qqSA_7___rustc14___rust_dealloc(ptr noundef nonnull %i.hb, i64 noundef range(i64 1, 0) %i.hj, i64 noundef range(i64 1, 536870913) %i.hm) #29, !noalias !2615
  br label %bb.gw
...
bb.cs:                                            ; preds = %bb.cp
  ...
  %i.hp = load i64, ptr %i.ho, align 8, !range !4, !invariant.load !3, !noalias !2615 ; 2 uses
  %i.hq = icmp eq i64 %i.hp, 0
  br i1 %i.hq, label %.body28.i, label %bb.ct

bb.ct:                                            ; preds = %bb.cs
  %i.hr = getelementptr inbounds nuw i8, ptr %i.hc, i64 16
  %i.hs = load i64, ptr %i.hr, align 8, !range !5, !invariant.load !3, !noalias !2615
  call void @_RNvCs8mYq7K4qqSA_7___rustc14___rust_dealloc(ptr noundef nonnull %i.hb, i64 noundef range(i64 1, 0) %i.hp, i64 noundef range(i64 1, 536870913) %i.hs) #29, !noalias !2615
  br label %.body28.i

bb.cu:                                            ; preds = %.body.i.i.i
  %i.ht = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #30, !noalias !2615
  unreachable
...
bb.cv:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtNtCskQDtHcQtBkN_5tokio7runtime4task4join10JoinHandleINtNtB4_6result6ResultNtNtCs8ulvy0Wg6Ot_12delta_kernel11log_segment10LogSegmentNtNtB23_5error5ErrorEEECs9rVkZwOUgsI_13deltalake_aws.exit19.i
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.10.sroa.11.sroa.10.i, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.6.sroa.3.i, i64 16, i1 false), !noalias !2581
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(64) %.sroa.10.sroa.13.i, ptr noundef nonnull align 16 dereferenceable(64) %.sroa.7.i, i64 64, i1 false), !noalias !2581
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %.sroa.9.i, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.6.sroa.3.i, i64 16, i1 false), !noalias !2581
  %.sroa.9.48..sroa_idx.i = getelementptr inbounds nuw i8, ptr %.sroa.9.i, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(64) %.sroa.9.48..sroa_idx.i, ptr noundef nonnull align 16 dereferenceable(64) %.sroa.7.i, i64 64, i1 false), !noalias !2581
...
bb.cw:                                            ; preds = %bb.cv
  call void @llvm.lifetime.start.p0(ptr nonnull %i.l), !noalias !2620
  store i64 %.sroa.5.0.copyload.i, ptr %i.l, align 16, !noalias !2623
  %.sroa.755.16..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.l, i64 8
  store i64 %.sroa.6.sroa.0.0.copyload.i, ptr %.sroa.755.16..sroa_idx.i, align 8, !noalias !2623
  %.sroa.9.16..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.l, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(80) %.sroa.9.16..sroa_idx.i, ptr noundef nonnull align 16 dereferenceable(80) %.sroa.9.i, i64 80, i1 false), !noalias !2623
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.6.i.i)
  call void @llvm.experimental.noalias.scope.decl(metadata !2624)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.k), !noalias !2627
  call void @llvm.lifetime.start.p0(ptr nonnull %i.g), !noalias !2630
  store i64 0, ptr %i.g, align 8, !noalias !2630
  %.sroa.42.0..sroa_idx.i.i.i20.i = getelementptr inbounds nuw i8, ptr %i.g, i64 8
  store ptr inttoptr (i64 1 to ptr), ptr %.sroa.42.0..sroa_idx.i.i.i20.i, align 8, !noalias !2630
  %.sroa.53.0..sroa_idx.i.i.i21.i = getelementptr inbounds nuw i8, ptr %i.g, i64 16
  store i64 0, ptr %.sroa.53.0..sroa_idx.i.i.i21.i, align 8, !noalias !2630
  call void @llvm.lifetime.start.p0(ptr nonnull %i.f), !noalias !2630
  %i.hw = getelementptr inbounds nuw i8, ptr %i.f, i64 16
  store i32 1610612768, ptr %i.hw, align 8, !noalias !2630
  %.sroa.4.0..sroa_idx.i.i.i22.i = getelementptr inbounds nuw i8, ptr %i.f, i64 20
  store i16 0, ptr %.sroa.4.0..sroa_idx.i.i.i22.i, align 4, !noalias !2630
  %.sroa.5.0..sroa_idx.i.i.i23.i = getelementptr inbounds nuw i8, ptr %i.f, i64 22
  store i16 0, ptr %.sroa.5.0..sroa_idx.i.i.i23.i, align 2, !noalias !2630
  store ptr %i.g, ptr %i.f, align 8, !noalias !2630
  %i.hx = getelementptr inbounds nuw i8, ptr %i.f, i64 8
  store ptr @166, ptr %i.hx, align 8, !noalias !2630
  %i.hy = invoke noundef zeroext i1 @_RNvXs2_NtCs8ulvy0Wg6Ot_12delta_kernel5errorNtB5_5ErrorNtNtCsbvkFyIu7lgC_4core3fmt7Display3fmt(ptr noalias noundef nonnull readonly align 16 captures(address, read_provenance) dereferenceable(96) %i.l, ptr noalias noundef nonnull align 8 dereferenceable(24) %i.f)
          to label %bb.cy unwind label %bb.cx, !noalias !2634
...
bb.cx:                                            ; preds = %bb.cz, %bb.cw
  ...
  invoke void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6Po7BT7Nknu_5alloc6string6StringECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.g) #31
          to label %.body.i.i24.i unwind label %bb.da, !noalias !2635
...
bb.cz:                                            ; preds = %bb.cy
  invoke void @_RNvNtCsbvkFyIu7lgC_4core6result13unwrap_failed(ptr noalias noundef nonnull readonly captures(address, read_provenance) @167, i64 noundef 55, ptr noundef nonnull %i.a, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) @93, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @169) #35
          to label %.noexc.i.i.i27.i unwind label %bb.cx, !noalias !2635
...
bb.da:                                            ; preds = %bb.cx
  %i.ia = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCsbvkFyIu7lgC_4core9panicking16panic_in_cleanup() #30, !noalias !2635
  unreachable
...
.body.i.i24.i:                                    ; preds = %bb.fv, %bb.fq, %bb.fo, %.body24.i.i.i, %bb.db, %bb.cx
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs8ulvy0Wg6Ot_12delta_kernel5error5ErrorECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull align 16 dereferenceable(96) %i.l) #31
          to label %.body28.i unwind label %bb.fx, !noalias !2636
...
bb.dc:                                            ; preds = %bb.cy
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.k, ptr noundef nonnull align 8 dereferenceable(24) %i.g, i64 24, i1 false), !noalias !2637
  call void @llvm.lifetime.end.p0(ptr nonnull %i.f), !noalias !2630
  call void @llvm.lifetime.end.p0(ptr nonnull %i.g), !noalias !2630
  %i.ic = getelementptr inbounds nuw i8, ptr %i.k, i64 8
  %i.id = load ptr, ptr %i.ic, align 8, !noalias !2627, !nonnull !3, !noundef !3 ; 10 uses
  %i.ie = getelementptr inbounds nuw i8, ptr %i.k, i64 16
  %i.if = load i64, ptr %i.ie, align 8, !noalias !2627, !noundef !3 ; 16 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.j), !noalias !2627
  call void @llvm.lifetime.start.p0(ptr nonnull %i.i), !noalias !2627
  call void @llvm.lifetime.start.p0(ptr nonnull %i.h), !noalias !2627
  store ptr %i.hu, ptr %i.h, align 8, !noalias !2627
  %.sroa.42.0..sroa_idx.i.i.i = getelementptr inbounds nuw i8, ptr %i.h, i64 8
  store ptr @_RNvXse_NtNtNtCsbvkFyIu7lgC_4core3fmt3num3impxNtB9_7Display3fmt, ptr %.sroa.42.0..sroa_idx.i.i.i, align 8, !noalias !2627
  invoke void @_RNvNvNtCs6Po7BT7Nknu_5alloc3fmt6format12format_inner(ptr noalias noundef nonnull sret([24 x i8]) align 8 captures(none) dereferenceable(24) %i.i, ptr noundef nonnull @33, ptr noundef nonnull %i.h)
          to label %_RINvMNtCsbvkFyIu7lgC_4core6optionINtB3_6OptionReE11map_or_elseNtNtCs6Po7BT7Nknu_5alloc6string6StringNCNvNtB12_3fmt6format0NvYeNtNtB12_6borrow7ToOwned8to_ownedECs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i unwind label %bb.dd, !noalias !2636
...
.body24.i.i.i:                                    ; preds = %bb.fm, %bb.fk, %.loopexit.split-lp.i.i.i, %bb.dd
  ...
  invoke void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6Po7BT7Nknu_5alloc6string6StringECs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.k) #31
          to label %.body.i.i24.i unwind label %bb.fx, !noalias !2636
...
_RINvMNtCsbvkFyIu7lgC_4core6optionINtB3_6OptionReE11map_or_elseNtNtCs6Po7BT7Nknu_5alloc6string6StringNCNvNtB12_3fmt6format0NvYeNtNtB12_6borrow7ToOwned8to_ownedECs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i: ; preds = %bb.dc
  call void @llvm.lifetime.end.p0(ptr nonnull %i.h), !noalias !2627
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.j, ptr noundef nonnull align 8 dereferenceable(24) %i.i, i64 24, i1 false), !noalias !2627
  call void @llvm.lifetime.end.p0(ptr nonnull %i.i), !noalias !2627
  %i.ih = getelementptr inbounds nuw i8, ptr %i.j, i64 8
  %i.ii = load ptr, ptr %i.ih, align 8, !noalias !2627, !nonnull !3, !noundef !3 ; 9 uses
  %i.ij = getelementptr inbounds nuw i8, ptr %i.j, i64 16
  %i.ik = load i64, ptr %i.ij, align 8, !noalias !2627, !noundef !3 ; 19 uses
...
bb.di:                                            ; preds = %bb.df
  %i.iq = load i8, ptr %i.ii, align 1, !alias.scope !2638, !noalias !2643, !noundef !3 ; 2 uses
...
bb.dj:                                            ; preds = %bb.di
  %i.is = invoke { i64, i64 } @_RNvNtNtCsbvkFyIu7lgC_4core5slice6memchr14memchr_aligned(i8 noundef %i.iq, ptr noalias noundef nonnull readonly captures(address, read_provenance) %i.id, i64 noundef range(i64 0, -9223372036854775808) %i.if)
          to label %.noexc.i.i.i unwind label %.loopexit.split-lp.loopexit.split-lp.i.i.i, !noalias !2636
...
.lr.ph.i.i.i.i.i:                                 ; preds = %bb.di, %bb.dk
  ...
  %i.ix = load i8, ptr %i.iw, align 1, !alias.scope !2644, !noalias !2647, !noundef !3
...
_RNvNtNtCsbvkFyIu7lgC_4core3str7pattern13simd_contains.exit.i.i.i.i: ; preds = %bb.ev, %bb.eu, %bb.dh
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e), !noalias !2648
  invoke void @_RNvMsu_NtNtCsbvkFyIu7lgC_4core3str7patternNtB5_11StrSearcher3new(ptr noalias noundef nonnull sret([104 x i8]) align 8 captures(none) dereferenceable(104) %i.e, ptr noalias noundef nonnull readonly captures(address, read_provenance) %i.id, i64 noundef %i.if, ptr noalias noundef nonnull readonly captures(address, read_provenance) %i.ii, i64 noundef %i.ik)
          to label %.noexc9.i.i.i unwind label %.loopexit.split-lp.loopexit.split-lp.i.i.i, !noalias !2636
...
.noexc9.i.i.i:                                    ; preds = %_RNvNtNtCsbvkFyIu7lgC_4core3str7pattern13simd_contains.exit.i.i.i.i
  ...
  %i.ja = load i64, ptr %i.e, align 8, !range !65, !alias.scope !2649, !noalias !2652, !noundef !3
...
.preheader.i4.i.i.i.i:                            ; preds = %.noexc9.i.i.i
  ...
  %i.je = load i8, ptr %i.jd, align 2, !range !703, !alias.scope !2654, !noalias !2657, !noundef !3
...
.lr.ph.i5.i.i.i.i:                                ; preds = %.preheader.i4.i.i.i.i
  %.promoted.i.i.i.i.i = load i64, ptr %i.jc, align 8, !alias.scope !2649, !noalias !2652 ; 12 uses
  %i.jg = getelementptr inbounds nuw i8, ptr %i.e, i64 24
  %i.jh = getelementptr inbounds nuw i8, ptr %i.e, i64 72
  %i.ji = load ptr, ptr %i.jh, align 8, !alias.scope !2654, !noalias !2657, !nonnull !3, !noundef !3 ; 5 uses
  %i.jj = getelementptr inbounds nuw i8, ptr %i.e, i64 80
  %i.jk = load i64, ptr %i.jj, align 8, !alias.scope !2654, !noalias !2657, !noundef !3 ; 14 uses
  %.promoted26.i.i.i.i.i = load i8, ptr %i.jg, align 8, !alias.scope !2654, !noalias !2657 ; 2 uses
...
bb.ee:                                            ; preds = %.lr.ph373
  ...
  %i.nm = load i8, ptr %i.nl, align 1, !alias.scope !2675, !noalias !2680, !noundef !3
  %i.nn = getelementptr inbounds nuw i8, ptr %i.ll, i64 %i.nj
  %i.no = load i8, ptr %i.nn, align 1, !alias.scope !2673, !noalias !2679, !noundef !3
...
bb.ef:                                            ; preds = %.lr.ph370
  ...
  %i.nt = load i8, ptr %i.ns, align 1, !alias.scope !2675, !noalias !2680, !noundef !3
  %i.nu = getelementptr inbounds nuw i8, ptr %i.ll, i64 %i.nq
  %i.nv = load i8, ptr %i.nu, align 1, !alias.scope !2673, !noalias !2679, !noundef !3
...
.lr.ph.i14.i.i.i.i:                               ; preds = %bb.ei
  ...
  %i.ob = load i64, ptr %i.oa, align 8, !alias.scope !2681, !noalias !2688, !noundef !3
  %i.oc = load i64, ptr %i.jc, align 8, !alias.scope !2681, !noalias !2688 ; 4 uses
  %i.od = getelementptr inbounds nuw i8, ptr %i.e, i64 24
  %i.oe = load i64, ptr %i.od, align 8, !alias.scope !2681, !noalias !2688 ; 2 uses
...
bb.ej:                                            ; preds = %.sink.split.i.i.i.i.i, %.lr.ph.i14.i.i.i.i
  ...
  %i.ok = load i8, ptr %i.oj, align 1, !alias.scope !2684, !noalias !2690, !noundef !3
  %i.ol = and i8 %i.ok, 63
...
bb.eo:                                            ; preds = %bb.en
  ...
  %i.pd = load i8, ptr %i.pc, align 1, !alias.scope !2686, !noalias !2691, !noundef !3
  %i.pe = getelementptr inbounds nuw i8, ptr %i.ll, i64 %i.pa
  %i.pf = load i8, ptr %i.pe, align 1, !alias.scope !2684, !noalias !2690, !noundef !3
...
bb.eq:                                            ; preds = %.lr.ph365
  ...
  %i.pi = load i8, ptr %i.ph, align 1, !alias.scope !2686, !noalias !2691, !noundef !3
  %i.pj = getelementptr inbounds nuw i8, ptr %i.ll, i64 %i.ov
  %i.pk = load i8, ptr %i.pj, align 1, !alias.scope !2684, !noalias !2690, !noundef !3
...
bb.et:                                            ; preds = %bb.dh
  ...
  %i.pn = load i8, ptr %i.ii, align 1, !alias.scope !2697, !noalias !2698, !noundef !3 ; 3 uses
  %i.po = add nsw i64 %i.ik, -1                   ; 2 uses
  %i.pp = icmp eq i64 %i.ik, 2
  br i1 %i.pp, label %.thread.i.i.i.i.i, label %bb.eu

bb.eu:                                            ; preds = %bb.et
  %i.pq = call i64 @llvm.usub.sat.i64(i64 range(i64 2, 33) %i.ik, i64 4) ; 2 uses
  %3 = icmp ult i64 %i.pq, %i.ik
...
.lr.ph:                                           ; preds = %bb.eu, %bb.ev
  %i.ps = phi i64 [ %i.pt, %bb.ev ], [ %i.ik, %bb.eu ]
...
_RNCINvNvNtNtNtNtCsbvkFyIu7lgC_4core4iter6traits12double_ended19DoubleEndedIterator5rfind5checkjNCNvNtNtBe_3str7pattern13simd_contains0E0Cs9rVkZwOUgsI_13deltalake_aws.exit.i.i.i.i.i.i: ; preds = %.lr.ph
  ...
  %i.pz = load i8, ptr %i.py, align 1, !alias.scope !2697, !noalias !2699, !noundef !3 ; 2 uses
...
.split.us.i.i.i.i.i.i:                            ; preds = %_RNCINvNvNtNtNtNtCsbvkFyIu7lgC_4core4iter6traits8iterator8Iterator3any5checkRShNCNvNtNtBe_3str7pattern13simd_containss_0E0Cs9rVkZwOUgsI_13deltalake_aws.exit.backedge.us.i.i.i.i.i.i
  ...
  %bcmp.i.i.us.i.i.i.i.i.i = call i32 @bcmp(ptr noundef nonnull readonly dereferenceable(1) %i.qi, ptr noundef nonnull readonly dereferenceable(1) %i.ii, i64 range(i64 2, 33) %i.ik), !alias.scope !2707, !noalias !2708
...
bb.ey:                                            ; preds = %bb.ex, %.thread93.i.i.i.i.i
  ...
  store i64 %i.if, ptr %i.qq, align 8, !noalias !2712
  %i.qr = getelementptr inbounds nuw i8, ptr %i.d, i64 16
  store ptr %i.qp, ptr %i.qr, align 8, !noalias !2712
  %i.qs = getelementptr inbounds nuw i8, ptr %i.d, i64 24
  store i64 %i.po, ptr %i.qs, align 8, !noalias !2712
...
.lr.ph.i10.i.i.i.i:                               ; preds = %bb.ey, %bb.fc
  ...
  %.sroa.0.0.copyload.i.i.i.i.i.i = load <16 x i8>, ptr %i.qy, align 1, !alias.scope !2713, !noalias !2714
  %i.qz = getelementptr inbounds nuw i8, ptr %i.qy, i64 %storemerge9295.i.i.i.i.i
  %.sroa.02.0.copyload.i.i.i.i.i.i = load <16 x i8>, ptr %i.qz, align 1, !alias.scope !2713, !noalias !2714
  ...
  %.sroa.0.0.copyload.i.1.i.i.i.i.i = load <16 x i8>, ptr %i.re, align 1, !alias.scope !2713, !noalias !2714
  %i.rf = getelementptr inbounds nuw i8, ptr %i.re, i64 %storemerge9295.i.i.i.i.i
  %.sroa.02.0.copyload.i.1.i.i.i.i.i = load <16 x i8>, ptr %i.rf, align 1, !alias.scope !2713, !noalias !2714
  ...
  %.sroa.0.0.copyload.i.2.i.i.i.i.i = load <16 x i8>, ptr %i.rk, align 1, !alias.scope !2713, !noalias !2714
  %i.rl = getelementptr inbounds nuw i8, ptr %i.rk, i64 %storemerge9295.i.i.i.i.i
  %.sroa.02.0.copyload.i.2.i.i.i.i.i = load <16 x i8>, ptr %i.rl, align 1, !alias.scope !2713, !noalias !2714
  ...
  %.sroa.0.0.copyload.i.3.i.i.i.i.i = load <16 x i8>, ptr %i.rq, align 1, !alias.scope !2713, !noalias !2714
  %i.rr = getelementptr inbounds nuw i8, ptr %i.rq, i64 %storemerge9295.i.i.i.i.i
  %.sroa.02.0.copyload.i.3.i.i.i.i.i = load <16 x i8>, ptr %i.rr, align 1, !alias.scope !2713, !noalias !2714
...
bb.ez:                                            ; preds = %.preheader96.1.i.i.i.i.i
  ...
  %i.sa = invoke fastcc noundef zeroext i1 @_RNCNvNtNtCsbvkFyIu7lgC_4core3str7pattern13simd_containss0_0Cs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) %i.d, i64 noundef %i.ry, i16 noundef %i.rj, i1 noundef zeroext %i.rz) #33
          to label %.noexc18.i.i.i unwind label %.loopexit.split-lp.loopexit.i.i.i, !noalias !2636
...
bb.fa:                                            ; preds = %.preheader96.2.i.i.i.i.i
  ...
  %i.sg = invoke fastcc noundef zeroext i1 @_RNCNvNtNtCsbvkFyIu7lgC_4core3str7pattern13simd_containss0_0Cs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) %i.d, i64 noundef %i.se, i16 noundef %i.rp, i1 noundef zeroext %i.sf) #33
          to label %.noexc19.i.i.i unwind label %.loopexit.split-lp.loopexit.i.i.i, !noalias !2636
...
bb.fb:                                            ; preds = %.preheader96.3.i.i.i.i.i
  ...
  %i.sm = invoke fastcc noundef zeroext i1 @_RNCNvNtNtCsbvkFyIu7lgC_4core3str7pattern13simd_containss0_0Cs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) %i.d, i64 noundef %i.sk, i16 noundef %i.rv, i1 noundef zeroext %i.sl) #33
          to label %.noexc20.i.i.i unwind label %.loopexit.split-lp.loopexit.i.i.i, !noalias !2636
...
bb.fd:                                            ; preds = %.lr.ph.i10.i.i.i.i
  %i.st = invoke fastcc noundef zeroext i1 @_RNCNvNtNtCsbvkFyIu7lgC_4core3str7pattern13simd_containss0_0Cs9rVkZwOUgsI_13deltalake_aws(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) %i.d, i64 noundef %.sroa.06.0103.i.i.i.i.i, i16 noundef %i.rd, i1 noundef zeroext false) #33
          to label %.noexc21.i.i.i unwind label %.loopexit.split-lp.loopexit.i.i.i, !noalias !2636
...
._crit_edge.i9.i.i.i.i:                           ; preds = %bb.fe, %.preheader.i8.i.i.i.i
  ...
  %i.sv = sub i64 %i.if, %i.po
  %i.sw = add i64 %i.sv, -16                      ; 2 uses
  %i.sx = getelementptr inbounds nuw i8, ptr %i.id, i64 %i.sw ; 2 uses
  %.sroa.0.0.copyload.i58.i.i.i.i.i = load <16 x i8>, ptr %i.sx, align 1, !alias.scope !2713, !noalias !2717
  %i.sy = getelementptr inbounds nuw i8, ptr %i.sx, i64 %storemerge9295.i.i.i.i.i
  %.sroa.02.0.copyload.i59.i.i.i.i.i = load <16 x i8>, ptr %i.sy, align 1, !alias.scope !2713, !noalias !2717
