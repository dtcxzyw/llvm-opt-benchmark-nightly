...
begin_hunk_0_@_RNCNvNtNtNtCs8ulvy0Wg6Ot_12delta_kernel6engine7default7parquet23read_parquet_files_impl0Cs14kWLkQVSKO_14deltalake_core:bb.a
  ...
  %i.j = alloca [8 x i8], align 8                 ; 14 uses
...
begin_hunk_1_@_RNCNvNtNtNtCs8ulvy0Wg6Ot_12delta_kernel6engine7default7parquet23read_parquet_files_impl0Cs14kWLkQVSKO_14deltalake_core:bb.a
  ...
  %i.y = invoke noundef zeroext i1 @_RNvXs2_NtNtCs8ulvy0Wg6Ot_12delta_kernel6engine7defaultNtCseo6ZV82fEK1_3url3UrlNtB5_6UrlExt12is_presigned(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(88) %.val40)
          to label %bb.d unwind label %.thread44
...
bb.t:                                             ; preds = %bb.m, %bb.s
  %.sroa.01.1 = phi i8 [ 1, %bb.s ], [ 0, %bb.m ] ; 10 uses
...
bb.ak:                                            ; preds = %bb.aj
  ...
  invoke void @_RNvMsn_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcNtNtCs8ulvy0Wg6Ot_12delta_kernel6schema10StructTypeE9drop_slowBK_(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.j) #43
          to label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcNtNtCs8ulvy0Wg6Ot_12delta_kernel6schema10StructTypeEECs14kWLkQVSKO_14deltalake_core.exit unwind label %bb.al

_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcNtNtCs8ulvy0Wg6Ot_12delta_kernel6schema10StructTypeEECs14kWLkQVSKO_14deltalake_core.exit65.a: ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionINtNtCs6Po7BT7Nknu_5alloc4sync3ArcNtNtCs8ulvy0Wg6Ot_12delta_kernel11expressions9PredicateEEECs14kWLkQVSKO_14deltalake_core.exit72, %bb.bb, %bb.al
  %.pn29 = phi { ptr, i32 } [ %3, %bb.al ], [ %.pn27, %bb.bb ], [ %.pn27, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionINtNtCs6Po7BT7Nknu_5alloc4sync3ArcNtNtCs8ulvy0Wg6Ot_12delta_kernel11expressions9PredicateEEECs14kWLkQVSKO_14deltalake_core.exit72 ] ; 2 uses
  %.sroa.08.0 = phi i8 [ %.sroa.08.1, %bb.al ], [ %.sroa.08.7, %bb.bb ], [ %.sroa.08.7, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionINtNtCs6Po7BT7Nknu_5alloc4sync3ArcNtNtCs8ulvy0Wg6Ot_12delta_kernel11expressions9PredicateEEECs14kWLkQVSKO_14deltalake_core.exit72 ]
  %.sroa.01.2 = phi i8 [ %.sroa.01.3, %bb.al ], [ %.sroa.01.7, %bb.bb ], [ %.sroa.01.7, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionINtNtCs6Po7BT7Nknu_5alloc4sync3ArcNtNtCs8ulvy0Wg6Ot_12delta_kernel11expressions9PredicateEEECs14kWLkQVSKO_14deltalake_core.exit72 ] ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.j)
  %2 = trunc nuw i8 %.sroa.08.0 to i1
  br i1 %2, label %bb.bl, label %.body67

bb.al:                                            ; preds = %bb.ax, %bb.ak
  %.sroa.08.1 = phi i8 [ %.sroa.08.528, %bb.ax ], [ 0, %bb.ak ]
  %.sroa.01.3 = phi i8 [ %.sroa.01.529, %bb.ax ], [ %.sroa.01.1, %bb.ak ]
  %3 = landingpad { ptr, i32 }
          cleanup
  br label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcNtNtCs8ulvy0Wg6Ot_12delta_kernel6schema10StructTypeEECs14kWLkQVSKO_14deltalake_core.exit65.a
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcNtNtCs8ulvy0Wg6Ot_12delta_kernel6schema10StructTypeEECs14kWLkQVSKO_14deltalake_core.exit: ; preds = %bb.aj, %bb.ak
  ...
  %4 = trunc nuw i8 %.sroa.01.1 to i1
  br i1 %4, label %bb.am, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDNtCsjyY8HP3IvQ6_12object_store11ObjectStoreEL_EECs14kWLkQVSKO_14deltalake_core.exit70
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionINtNtCs6Po7BT7Nknu_5alloc4sync3ArcNtNtCs8ulvy0Wg6Ot_12delta_kernel11expressions9PredicateEEECs14kWLkQVSKO_14deltalake_core.exit: ; preds = %bb.ao, %bb.ar, %bb.as, %bb.az, %bb.ay, %bb.ba
  %.sroa.01.529 = phi i8 [ 1, %bb.az ], [ 1, %bb.ba ], [ 1, %bb.ay ], [ %.sroa.01.1, %bb.as ], [ %.sroa.01.1, %bb.ar ], [ %.sroa.01.1, %bb.ao ] ; 4 uses
  %.sroa.08.528 = phi i8 [ 1, %bb.az ], [ 1, %bb.ba ], [ 1, %bb.ay ], [ 1, %bb.as ], [ 1, %bb.ar ], [ 0, %bb.ao ] ; 2 uses
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionINtNtCs6Po7BT7Nknu_5alloc4sync3ArcNtNtCs8ulvy0Wg6Ot_12delta_kernel11expressions9PredicateEEECs14kWLkQVSKO_14deltalake_core.exit72: ; preds = %.body35, %.body37, %bb.ah, %bb.ad, %bb.au, %bb.at, %bb.av, %bb.bj, %.thread44, %bb.bk, %bb.bc
  ...
  %.sroa.08.7 = phi i8 [ 1, %bb.bc ], [ 1, %bb.bj ], [ 0, %bb.ah ], [ 1, %bb.bk ], [ 1, %.thread44 ], [ 1, %bb.at ], [ 1, %bb.au ], [ 0, %bb.ad ], [ 1, %bb.av ], [ 1, %.body35 ], [ 1, %.body37 ] ; 2 uses
...
begin_hunk_6_@_RNCNvNtNtNtCs8ulvy0Wg6Ot_12delta_kernel6engine7default7parquet23read_parquet_files_impl0Cs14kWLkQVSKO_14deltalake_core:bb.a
  ...
  br i1 %i.cw, label %bb.bb, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcNtNtCs8ulvy0Wg6Ot_12delta_kernel6schema10StructTypeEECs14kWLkQVSKO_14deltalake_core.exit65.a
...
bb.bb:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionINtNtCs6Po7BT7Nknu_5alloc4sync3ArcNtNtCs8ulvy0Wg6Ot_12delta_kernel11expressions9PredicateEEECs14kWLkQVSKO_14deltalake_core.exit72
  fence acquire
  invoke void @_RNvMsn_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcNtNtCs8ulvy0Wg6Ot_12delta_kernel6schema10StructTypeE9drop_slowBK_(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.j) #43
          to label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcNtNtCs8ulvy0Wg6Ot_12delta_kernel6schema10StructTypeEECs14kWLkQVSKO_14deltalake_core.exit65.a unwind label %bb.aw
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcNtNtCs8ulvy0Wg6Ot_12delta_kernel6schema10StructTypeEECs14kWLkQVSKO_14deltalake_core.exit62: ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionINtNtCs6Po7BT7Nknu_5alloc4sync3ArcNtNtCs8ulvy0Wg6Ot_12delta_kernel11expressions9PredicateEEECs14kWLkQVSKO_14deltalake_core.exit, %bb.ax
  call void @llvm.lifetime.end.p0(ptr nonnull %i.j)
  %5 = trunc nuw i8 %.sroa.08.528 to i1
  br i1 %5, label %bb.bd, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VecNtCs8ulvy0Wg6Ot_12delta_kernel8FileMetaEECs14kWLkQVSKO_14deltalake_core.exit
...
.body67:                                          ; preds = %bb.bh, %bb.be, %bb.bl, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcNtNtCs8ulvy0Wg6Ot_12delta_kernel6schema10StructTypeEECs14kWLkQVSKO_14deltalake_core.exit65.a
  %.pn31 = phi { ptr, i32 } [ %.pn29, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcNtNtCs8ulvy0Wg6Ot_12delta_kernel6schema10StructTypeEECs14kWLkQVSKO_14deltalake_core.exit65.a ], [ %.pn29, %bb.bl ], [ %i.dc, %bb.bh ], [ %i.cz, %bb.be ] ; 3 uses
  %.sroa.01.8 = phi i8 [ %.sroa.01.2, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcNtNtCs8ulvy0Wg6Ot_12delta_kernel6schema10StructTypeEECs14kWLkQVSKO_14deltalake_core.exit65.a ], [ %.sroa.01.2, %bb.bl ], [ %.sroa.01.529, %bb.bh ], [ %.sroa.01.529, %bb.be ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.k)
...
bb.bl:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcNtNtCs8ulvy0Wg6Ot_12delta_kernel6schema10StructTypeEECs14kWLkQVSKO_14deltalake_core.exit65.a
...
.body.thread67:                                   ; preds = %.body.i, %.body.thread, %.body.a
  %.pn.pn63 = phi { ptr, i32 } [ %.pn.pn64, %.body.thread ], [ %eh.lpad-body21, %.body.a ], [ %eh.lpad-body.i, %.body.i ]
  resume { ptr, i32 } %.pn.pn63

.body.thread:                                     ; preds = %bb.b, %bb.e, %bb.bi, %.body.a
  %.pn.pn64 = phi { ptr, i32 } [ %eh.lpad-body21, %.body.a ], [ %i.y, %bb.e ], [ %lpad.thr_comm, %bb.bi ], [ %lpad.thr_comm.split-lp, %bb.b ]
...
.body.thread66:                                   ; preds = %.body.i, %.body.thread, %.body.a
  %.pn.pn62 = phi { ptr, i32 } [ %.pn.pn63, %.body.thread ], [ %i.bx, %.body.a ], [ %eh.lpad-body.i, %.body.i ]
  resume { ptr, i32 } %.pn.pn62

.body.thread:                                     ; preds = %bb.b, %bb.e, %bb.be, %.body.a
  %.pn.pn63 = phi { ptr, i32 } [ %i.bx, %.body.a ], [ %i.y, %bb.e ], [ %lpad.thr_comm, %bb.be ], [ %lpad.thr_comm.split-lp, %bb.b ]
...
.body.thread68:                                   ; preds = %.body.i, %.body.thread, %.body.a
  %.pn.pn64 = phi { ptr, i32 } [ %.pn.pn65, %.body.thread ], [ %eh.lpad-body21, %.body.a ], [ %eh.lpad-body.i, %.body.i ]
  resume { ptr, i32 } %.pn.pn64

.body.thread:                                     ; preds = %bb.b, %bb.e, %bb.be, %.body.a
  %.pn.pn65 = phi { ptr, i32 } [ %eh.lpad-body21, %.body.a ], [ %i.y, %bb.e ], [ %lpad.thr_comm, %bb.be ], [ %lpad.thr_comm.split-lp, %bb.b ]
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6result6ResultuNtNtCs8ulvy0Wg6Ot_12delta_kernel5error5ErrorEECs14kWLkQVSKO_14deltalake_core.exit: ; preds = %bb.ba, %.body.i, %.body.thread66, %bb.bm, %.body.a
  %.pn.pn63 = phi { ptr, i32 } [ %i.bx, %.body.a ], [ %.pn.pn69, %.body.thread66 ], [ %.pn.pn69, %bb.bm ], [ %eh.lpad-body.i, %.body.i ], [ %i.ds, %bb.ba ]
  resume { ptr, i32 } %.pn.pn63

.body.thread66:                                   ; preds = %bb.b, %bb.e, %bb.bl, %.body.a
  %.pn.pn69 = phi { ptr, i32 } [ %i.bx, %.body.a ], [ %i.y, %bb.e ], [ %lpad.thr_comm, %bb.bl ], [ %lpad.thr_comm.split-lp, %bb.b ] ; 2 uses
...
.body.thread.a:                                   ; preds = %bb.ay, %.body.i, %.body.thread65, %.body.a
  %.pn.pn62 = phi { ptr, i32 } [ %i.bx, %.body.a ], [ %.pn.pn68, %.body.thread65 ], [ %eh.lpad-body.i, %.body.i ], [ %i.do, %bb.ay ]
  resume { ptr, i32 } %.pn.pn62

.body.thread65:                                   ; preds = %bb.b, %bb.e, %bb.bk, %.body.a
  %.pn.pn68 = phi { ptr, i32 } [ %i.bx, %.body.a ], [ %i.y, %bb.e ], [ %lpad.thr_comm, %bb.bk ], [ %lpad.thr_comm.split-lp, %bb.b ]
