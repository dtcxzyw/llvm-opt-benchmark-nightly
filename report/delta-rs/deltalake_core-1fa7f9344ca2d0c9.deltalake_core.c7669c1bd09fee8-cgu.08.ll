...
.lr.ph.i20:                                       ; preds = %bb.z
  ...
  %umax54.i23 = tail call i64 @llvm.umax.i64(i64 %i.di, i64 range(i64 0, -9223372036854775808) %i.cj)
  %i.dl = add i64 %i.di, -1
...
.preheader97:                                     ; preds = %bb.ai
  %i.dz = add i64 %.sroa.04.0.i24281, 1           ; 2 uses
  %exitcond.not.i25 = icmp eq i64 %i.dz, %umax54.i23
...
.lr.ph282:                                        ; preds = %.preheader97.preheader, %.preheader97
  %.sroa.04.0.i24281 = phi i64 [ %i.dz, %.preheader97 ], [ %i.di, %.preheader97.preheader ] ; 4 uses
  %i.ea = add i64 %.sroa.04.0.i24281, %i.dm       ; 2 uses
...
bb.ai:                                            ; preds = %.lr.ph282
  %i.ek = getelementptr inbounds nuw i8, ptr %i.ch, i64 %.sroa.04.0.i24281
  ...
  %.not23.i27 = icmp eq i8 %i.el, %i.en
  br i1 %.not23.i27, label %.preheader97, label %bb.ak
...
bb.ak:                                            ; preds = %bb.ai
  ...
  %i.ep = add i64 %.reass237.reass, %.sroa.04.0.i24281
  br label %bb.ac
...
bb.am:                                            ; preds = %.sink.split.i, %.lr.ph.i14
  %i.ey = phi i64 [ %.promoted.i11, %.lr.ph.i14 ], [ %.ph76.i, %.sink.split.i ] ; 6 uses
...
bb.ao:                                            ; preds = %bb.am
  ...
  %umax54.i = tail call i64 @llvm.umax.i64(i64 %.sroa.0.0.i.i, i64 range(i64 0, -9223372036854775808) %i.cj)
...
.sink.split.i:                                    ; preds = %bb.ax, %bb.au, %bb.an
  ...
  %.ph76.i = phi i64 [ %i.fy, %bb.au ], [ %i.ge, %bb.ax ], [ %i.fi, %bb.an ] ; 2 uses
  %i.fj = add i64 %.ph76.i, %i.cl                 ; 2 uses
...
bb.ap:                                            ; preds = %bb.av
  %i.fl = add i64 %.sroa.04.0.i276, 1             ; 2 uses
  %exitcond.not.i15 = icmp eq i64 %i.fl, %umax54.i
...
.lr.ph277.a:                                      ; preds = %bb.ao, %bb.ap
  %.sroa.04.0.i276 = phi i64 [ %i.fl, %bb.ap ], [ %.sroa.0.0.i.i, %bb.ao ] ; 4 uses
  %i.fn = add i64 %.sroa.04.0.i276, %i.ey         ; 2 uses
...
bb.av:                                            ; preds = %.lr.ph277.a
  %i.fz = getelementptr inbounds nuw i8, ptr %i.ch, i64 %.sroa.04.0.i276
  ...
  %.not23.i = icmp eq i8 %i.ga, %i.gc
  br i1 %.not23.i, label %bb.ap, label %bb.ax
