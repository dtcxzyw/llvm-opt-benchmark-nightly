...
_RNvNtNtCsbvkFyIu7lgC_4core3str7pattern13simd_contains.exit: ; preds = %bb.ay, %bb.e
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b)
...
.loopexit:                                        ; preds = %bb.u, %.split.i.i.i, %bb.j, %.split.i.i.i.peel
  ...
  tail call void @_RNvNtCsbvkFyIu7lgC_4core3str16slice_error_fail(ptr noalias noundef nonnull readonly captures(address, read_provenance) %i.aa, i64 noundef %i.ac, i64 noundef %.lcssa150, i64 noundef %i.ac, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @926) #41, !noalias !42424
  unreachable
...
bb.ax:                                            ; preds = %bb.aw
  %i.gi = tail call i64 @llvm.usub.sat.i64(i64 range(i64 2, 33) %1, i64 4)
  br label %.lr.ph
...
.lr.ph:                                           ; preds = %bb.ax, %bb.ay
  %i.gk = phi i64 [ %1, %bb.ax ], [ %i.gl, %bb.ay ]
...
bb.az:                                            ; preds = %.lr.ph
  tail call void @_RNvNtCsbvkFyIu7lgC_4core9panicking18panic_bounds_check(i64 noundef %i.gl, i64 noundef range(i64 2, 33) %1, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @235) #41, !noalias !42455
  unreachable
...
_RNCINvNvNtNtNtNtCsbvkFyIu7lgC_4core4iter6traits12double_ended19DoubleEndedIterator5rfind5checkjNCNvNtNtBe_3str7pattern13simd_contains0E0Cs14kWLkQVSKO_14deltalake_core.exit.i.i: ; preds = %.lr.ph
  ...
  %i.go = load i8, ptr %i.gn, align 1, !alias.scope !42450, !noalias !42463, !noundef !4 ; 2 uses
...
.split.us.i.i:                                    ; preds = %_RNCINvNvNtNtNtNtCsbvkFyIu7lgC_4core4iter6traits8iterator8Iterator3any5checkRShNCNvNtNtBe_3str7pattern13simd_containss_0E0Cs14kWLkQVSKO_14deltalake_core.exit.backedge.us.i.i
  ...
  %bcmp.i.i.us.i.i = tail call i32 @bcmp(ptr noundef nonnull readonly dereferenceable(1) %i.gx, ptr noundef nonnull readonly dereferenceable(1) %0, i64 range(i64 2, 33) %1), !alias.scope !42464, !noalias !42465
...
bb.bc:                                            ; preds = %bb.bb, %.thread93.i
  ...
  store i64 %3, ptr %i.hf, align 8, !noalias !42464
  %i.hg = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  store ptr %i.he, ptr %i.hg, align 8, !noalias !42464
  %i.hh = getelementptr inbounds nuw i8, ptr %i.a, i64 24
  store i64 %i.gg, ptr %i.hh, align 8, !noalias !42464
...
.lr.ph.i10:                                       ; preds = %bb.bc, %bb.bg
  ...
  %.sroa.0.0.copyload.i.i = load <16 x i8>, ptr %i.hn, align 1, !alias.scope !42453, !noalias !42469
  %i.ho = getelementptr inbounds nuw i8, ptr %i.hn, i64 %storemerge9295.i
  %.sroa.02.0.copyload.i.i = load <16 x i8>, ptr %i.ho, align 1, !alias.scope !42453, !noalias !42469
  ...
  %.sroa.0.0.copyload.i.1.i = load <16 x i8>, ptr %i.ht, align 1, !alias.scope !42453, !noalias !42469
  %i.hu = getelementptr inbounds nuw i8, ptr %i.ht, i64 %storemerge9295.i
  %.sroa.02.0.copyload.i.1.i = load <16 x i8>, ptr %i.hu, align 1, !alias.scope !42453, !noalias !42469
  ...
  %.sroa.0.0.copyload.i.2.i = load <16 x i8>, ptr %i.hz, align 1, !alias.scope !42453, !noalias !42469
  %i.ia = getelementptr inbounds nuw i8, ptr %i.hz, i64 %storemerge9295.i
  %.sroa.02.0.copyload.i.2.i = load <16 x i8>, ptr %i.ia, align 1, !alias.scope !42453, !noalias !42469
  ...
  %.sroa.0.0.copyload.i.3.i = load <16 x i8>, ptr %i.if, align 1, !alias.scope !42453, !noalias !42469
  %i.ig = getelementptr inbounds nuw i8, ptr %i.if, i64 %storemerge9295.i
  %.sroa.02.0.copyload.i.3.i = load <16 x i8>, ptr %i.ig, align 1, !alias.scope !42453, !noalias !42469
...
._crit_edge.i9:                                   ; preds = %bb.bi, %.preheader.i8
  ...
  %.sroa.0.0.copyload.i58.i = load <16 x i8>, ptr %i.jm, align 1, !alias.scope !42453, !noalias !42472
  %i.jn = getelementptr inbounds nuw i8, ptr %i.jm, i64 %storemerge9295.i
  %.sroa.02.0.copyload.i59.i = load <16 x i8>, ptr %i.jn, align 1, !alias.scope !42453, !noalias !42472
...
.lr.ph107.i:                                      ; preds = %.preheader.i8, %bb.bi
  ...
  %.sroa.0.0.copyload.i60.i = load <16 x i8>, ptr %i.jt, align 1, !alias.scope !42453, !noalias !42475
  %i.ju = getelementptr inbounds nuw i8, ptr %i.jt, i64 %storemerge9295.i
  %.sroa.02.0.copyload.i61.i = load <16 x i8>, ptr %i.ju, align 1, !alias.scope !42453, !noalias !42475
