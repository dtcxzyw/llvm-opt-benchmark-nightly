...
bb.k:                                             ; preds = %bb.i
  ...
  %.sroa.5.0.i.i.i.i.a = select i1 %.not37.i.i.i.i, i64 %i.ar, i64 undef ; 2 uses
  ...
  store i64 %.sroa.5.0.i.i.i.i.a, ptr %.sroa.05.sroa.5.sroa.6.0..sroa.05.sroa.5.0..sroa_idx.sroa_idx.i.i.i.i, align 8, !noalias !139
  ...
  store i64 %.sroa.5.0.i.i.i.i.a, ptr %.sroa.05.sroa.7.sroa.6.0..sroa.05.sroa.7.0..sroa_idx.sroa_idx.i.i.i.i, align 8, !noalias !139
  store i64 %.sroa.5.0.i.i.i.i, ptr %.sroa.56.0..sroa_idx.i.i.i.i, align 8, !noalias !139
...
bb.am:                                            ; preds = %bb.aj, %.thread25.i.i.i
  ...
  %.sroa.411.0.copyload.i.i = load i64, ptr %.sroa.411.0..sroa_idx.i.i, align 16, !noalias !233
  %.sroa.512.0.copyload.i.i = load i64, ptr %.sroa.512.0..sroa_idx.i.i, align 8, !noalias !233
  br label %bb.aq
...
.body66.thread129:                                ; preds = %.body66.thread, %.body66
  %.sroa.032.0 = phi i1 [ %.sroa.031.2, %.body66 ], [ %.sroa.032.2127, %.body66.thread ]
...
.body66:                                          ; preds = %.body59
  br i1 %.sroa.032.4.a, label %.body66.thread, label %.body66.thread129
...
.body59:                                          ; preds = %.thread107, %.thread107.thread, %bb.bv, %bb.p, %bb.e
  %.sroa.032.4.a = phi i1 [ false, %.thread107 ], [ true, %bb.p ], [ true, %bb.e ], [ true, %bb.bv ], [ true, %.thread107.thread ]
  %.sroa.031.2 = phi i1 [ false, %.thread107 ], [ false, %bb.p ], [ %.sroa.032.5, %bb.e ], [ false, %bb.bv ], [ false, %.thread107.thread ] ; 2 uses
...
.body66.thread:                                   ; preds = %.split143.thread, %bb.bo, %.body66
  ...
  %.sroa.032.2127 = phi i1 [ %.sroa.031.2, %.body66 ], [ false, %bb.bo ], [ %.sroa.032.3.ph, %.split143.thread ]
...
_RNvNtCs1N9T06jgEdt_11arrow_array20temporal_conversions18date64_to_datetime.exit.i: ; preds = %bb.b, %.noexc42.i
  %.sroa.6.0.a = phi i32 [ undef, %.noexc42.i ], [ %i.o, %bb.b ]
  %.sroa.4.0 = phi i32 [ undef, %.noexc42.i ], [ %i.n, %bb.b ]
...
bb.g:                                             ; preds = %bb.f
  ...
  store i32 %.sroa.6.0.a, ptr %i.s, align 4
  %i.t = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i32 %.sroa.4.0, ptr %i.t, align 4
  br label %bb.h
...
_RNvNtCs1N9T06jgEdt_11arrow_array20temporal_conversions18date64_to_datetime.exit.i: ; preds = %bb.b, %.noexc32.i
  %.sroa.6.0.a = phi i32 [ undef, %.noexc32.i ], [ %i.p, %bb.b ]
  %.sroa.4.0 = phi i32 [ undef, %.noexc32.i ], [ %i.o, %bb.b ]
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCsfYVtenZkBsn_12arrow_schema8datatype8DataTypeECs14kWLkQVSKO_14deltalake_core(ptr noalias noundef align 8 dereferenceable(24) %i.a)
          to label %bb.f unwind label %bb.e
...
bb.g:                                             ; preds = %bb.f
  ...
  store i32 %.sroa.6.0.a, ptr %i.t, align 4
  %i.u = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i32 %.sroa.4.0, ptr %i.u, align 4
  br label %bb.h
