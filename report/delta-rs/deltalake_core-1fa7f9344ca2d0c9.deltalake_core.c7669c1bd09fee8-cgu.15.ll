...
begin_hunk_0_@_RINvMs1_NtNtCsdFjMDJQAyx6_10arrow_json6reader4tapeNtB6_11TapeDecoder9serializeNtNtCseqDwI8vvjGQ_10serde_json5value5ValueECs14kWLkQVSKO_14deltalake_core:bb.a
  ...
  store i64 %.sroa.04.sroa.5.sroa.6.0.i.i.i.i, ptr %.sroa.05.sroa.5.sroa.6.0..sroa.05.sroa.5.0..sroa_idx.sroa_idx.i.i.i.i, align 8, !noalias !138
  ...
  store i64 %.sroa.04.sroa.5.sroa.6.0.i.i.i.i, ptr %.sroa.05.sroa.7.sroa.6.0..sroa.05.sroa.7.0..sroa_idx.sroa_idx.i.i.i.i, align 8, !noalias !138
  store i64 %.sroa.04.sroa.5.sroa.6.0.i.i.i.i.a, ptr %.sroa.56.0..sroa_idx.i.i.i.i, align 8, !noalias !138
...
bb.am:                                            ; preds = %bb.aj, %.thread25.i.i.i
  ...
  %3 = load <2 x i64>, ptr %.sroa.411.0..sroa_idx.i.i, align 16, !noalias !232
  br label %bb.aq
...
.body66.thread132:                                ; preds = %.body66.thread, %.body66
  %.sroa.032.0 = phi i1 [ %.sroa.031.2.a, %.body66 ], [ %.sroa.032.2130, %.body66.thread ]
...
.body66:                                          ; preds = %.body59
  br i1 %.sroa.032.4, label %.body66.thread, label %.body66.thread132
...
.body66.thread:                                   ; preds = %.thread, %bb.bo, %.body66
  ...
  %.sroa.032.2130 = phi i1 [ %.sroa.031.2.a, %.body66 ], [ false, %bb.bo ], [ %.sroa.032.3.ph, %.thread ]
...
.noexc17:                                         ; preds = %bb.x, %.thread
  br i1 %.sroa.02.026, label %bb.y, label %.thread27

.thread:                                          ; preds = %.noexc11..thread_crit_edge, %bb.b, %bb.d
  %i.ay = phi ptr [ %.pre31, %.noexc11..thread_crit_edge ], [ %3, %bb.d ], [ %3, %bb.b ]
  %.sroa.02.026 = phi i1 [ false, %.noexc11..thread_crit_edge ], [ true, %bb.d ], [ true, %bb.b ]
  %.pn.pn.pn24 = phi { ptr, i32 } [ %.pn.pn, %.noexc11..thread_crit_edge ], [ %i.v, %bb.d ], [ %i.t, %bb.b ] ; 2 uses
...
.thread27:                                        ; preds = %.noexc11, %bb.y, %.noexc17
  %.pn.pn.pn2530 = phi { ptr, i32 } [ %.pn.pn.pn24, %.noexc17 ], [ %.pn.pn.pn24, %bb.y ], [ %.pn.pn, %.noexc11 ]
