...
.lr.ph.split.i.i:                                 ; preds = %bb.v, %.lr.ph.split.preheader.i.i
  %i.aj = phi i64 [ %i.ay, %bb.v ], [ 0, %.lr.ph.split.preheader.i.i ] ; 5 uses
...
bb.u:                                             ; preds = %_RNvNtNtCsbvkFyIu7lgC_4core5slice6memchr6memchr.exit.i.i
  %i.aw = extractvalue { i64, i64 } %.merged.i.i.i, 1 ; 3 uses
  %i.ax = add i64 %i.aj, 1
...
bb.w:                                             ; preds = %bb.u
  %3 = add i64 %i.aj, %i.aw                       ; 2 uses
  %i.az = getelementptr inbounds nuw i8, ptr %i.ai, i64 %3
...
begin_hunk_2_@_RINvNtCs8ulvy0Wg6Ot_12delta_kernel6schema19deserialize_decimalINtNtNtNtCs6sYutav3ODB_5serde7private2de7content22ContentRefDeserializerNtNtCseqDwI8vvjGQ_10serde_json5error5ErrorEECs7p2uQeJxui2_9deltalake:bb.a
  ...
  %.sroa.4.1.i = phi i64 [ %3, %bb.w ], [ %i.ah, %bb.v ], [ %i.ah, %_RNvNtNtCsbvkFyIu7lgC_4core5slice6memchr6memchr.exit.i.i ]
...
.lr.ph.split.i.i75:                               ; preds = %bb.ac, %.lr.ph.split.i.i75.backedge
  %i.ck = phi i64 [ %i.cz, %.lr.ph.split.i.i75.backedge ], [ %.promoted176, %bb.ac ] ; 5 uses
...
bb.af:                                            ; preds = %_RNvNtNtCsbvkFyIu7lgC_4core5slice6memchr6memchr.exit.i.i76
  %i.cx = extractvalue { i64, i64 } %.merged.i.i.i77, 1 ; 3 uses
  %i.cy = add i64 %i.ck, 1
  %i.cz = add i64 %i.cy, %i.cx                    ; 2 uses
  %.not13.i.i90 = icmp ugt i64 %i.cz, %i.ah       ; 2 uses
  %4 = add i64 %i.ck, %i.cx
  %or.cond.i.i91.not = icmp ult i64 %4, %i.ah
...
bb.ah:                                            ; preds = %bb.af
  %5 = add i64 %i.ck, %i.cx                       ; 2 uses
  %i.da = getelementptr inbounds nuw i8, ptr %i.ai, i64 %5
...
_RNvXs_NtNtCsbvkFyIu7lgC_4core3str7patternNtB4_12CharSearcherNtB4_8Searcher10next_match.exit.i93.loopexit.split.loop.exit245: ; preds = %bb.ah
  %.mux.le = select i1 %i.db, i64 %5, i64 %i.ah
...
bb.v:                                             ; preds = %_RNvNtNtCsbvkFyIu7lgC_4core5slice6memchr6memchr.exit.i.i
  %i.ax = extractvalue { i64, i64 } %.merged.i.i.i, 1 ; 3 uses
  %i.ay = add nuw i64 %i.ak, 1
  %i.az = add i64 %i.ay, %i.ax                    ; 5 uses
  %.not13.i.i = icmp ugt i64 %i.az, %i.ae
  %2 = add i64 %i.ak, %i.ax
  %or.cond.i.i.not = icmp ult i64 %2, %i.ae
...
bb.x:                                             ; preds = %bb.v
  %3 = add i64 %i.ak, %i.ax                       ; 2 uses
  %i.ba = getelementptr inbounds nuw i8, ptr %i.aj, i64 %3
...
begin_hunk_8_@_RNvMs0_NtCs8ulvy0Wg6Ot_12delta_kernel4pathINtB5_13ParsedLogPathNtCseo6ZV82fEK1_3url3UrlE8try_fromCs7p2uQeJxui2_9deltalake:bb.a
  ...
  %.sroa.4.1.i = phi i64 [ %3, %bb.x ], [ %i.ae, %bb.w ], [ %i.ae, %_RNvNtNtCsbvkFyIu7lgC_4core5slice6memchr6memchr.exit.i.i ] ; 3 uses
...
.lr.ph.split.i.i.i.i:                             ; preds = %.lr.ph.split.i.i.i.i.backedge, %bb.aa
  %i.dd = phi i64 [ 0, %bb.aa ], [ %i.ds, %.lr.ph.split.i.i.i.i.backedge ] ; 4 uses
...
bb.ad:                                            ; preds = %_RNvNtNtCsbvkFyIu7lgC_4core5slice6memchr6memchr.exit.i.i.i.i
  %i.dq = extractvalue { i64, i64 } %.merged.i.i.i.i.i, 1 ; 2 uses
  %i.dr = add i64 %i.dd, 1
  %i.ds = add i64 %i.dr, %i.dq                    ; 2 uses
  %.not13.i.i.i.i = icmp ugt i64 %i.ds, %i.dc     ; 2 uses
  %5 = add i64 %i.dq, %i.dd                       ; 3 uses
  %or.cond.i.i.not.i.i = icmp ult i64 %5, %i.dc
...
bb.af:                                            ; preds = %bb.ad
  %i.dt = getelementptr inbounds nuw i8, ptr %i.da, i64 %5
...
_RNvXs_NtNtCsbvkFyIu7lgC_4core3str7patternNtB4_12CharSearcherNtB4_8Searcher10next_match.exit.i.i.split.loop.exit.i: ; preds = %bb.af
  %spec.select = select i1 %i.du, i64 %5, i64 %i.dc
