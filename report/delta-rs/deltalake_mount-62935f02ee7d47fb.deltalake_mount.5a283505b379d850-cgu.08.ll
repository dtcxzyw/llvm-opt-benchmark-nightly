...
bb.c:                                             ; preds = %.lr.ph6
  ...
  %i.q = icmp eq i64 %lsr.iv.lcssa, %lsr.iv.next12
  br i1 %i.q, label %.body.loopexit, label %.lr.ph6

bb.d:                                             ; preds = %.lr.ph
  %lsr.iv15.lcssa = phi ptr [ %lsr.iv14, %.lr.ph ]
...
.lr.ph6:                                          ; preds = %.lr.ph6.preheader, %bb.c
  %lsr.iv16 = phi ptr [ %lsr.iv15.lcssa, %.lr.ph6.preheader ], [ %scevgep17, %bb.c ] ; 2 uses
