begin_hunk_0
  ...
  %i.x = load ptr, ptr %.sroa.59.0..sroa_idx.i.i.i, align 8, !alias.scope !7215, !nonnull !12, !noundef !12 ; 4 uses
...
bb.e:                                             ; preds = %bb.d
  %i.aa = load i8, ptr %i.x, align 1, !alias.scope !7218, !noalias !7221, !noundef !12
  switch i8 %i.aa, label %thread-pre-split.i.i.i.i.i [
...
thread-pre-split.i.i.i.i.i:                       ; preds = %bb.f, %bb.e
  %.sroa.0.270.i.i.i.i.i.ph = phi ptr [ %i.x, %bb.e ], [ %.sroa.0.0.i.i.i.i.i, %bb.f ]
  %.sroa.15.269.i.i.i.i.i.ph = phi i64 [ 1, %bb.e ], [ %.sroa.15.0.i.i.i.i.i, %bb.f ]
  br label %.lr.ph.i.i.i.i.i

bb.f:                                             ; preds = %bb.d
  %.pr.i.i.i.i.i = load i8, ptr %i.x, align 1, !alias.scope !7218, !noalias !7221
  %cond.i.i.i.i.i = icmp eq i8 %.pr.i.i.i.i.i, 43 ; 2 uses
  %i.ab = sext i1 %cond.i.i.i.i.i to i64
  %.sroa.15.0.i.i.i.i.i = add nsw i64 %i.z, %i.ab ; 3 uses
  ...
  br i1 %i.ac, label %thread-pre-split.i.i.i.i.i, label %.preheader56.i.i.i.i.i.preheader
...
.lr.ph.i.i.i.i.i:                                 ; preds = %thread-pre-split.i.i.i.i.i, %bb.h
  %.sroa.0.269.i.i.i.i.i = phi ptr [ %i.av, %bb.h ], [ %.sroa.0.270.i.i.i.i.i.ph, %thread-pre-split.i.i.i.i.i ] ; 2 uses
  %.sroa.15.268.i.i.i.i.i = phi i64 [ %i.au, %bb.h ], [ %.sroa.15.269.i.i.i.i.i.ph, %thread-pre-split.i.i.i.i.i ]
  %.sroa.042.267.i.i.i.i.i = phi i64 [ %i.ax, %bb.h ], [ 0, %thread-pre-split.i.i.i.i.i ]
...
_RNvMsv_NtCsbvkFyIu7lgC_4core3numj16from_ascii_radix.exit.i.i.i.i: ; preds = %bb.g, %.preheader56.i.i.i.i.i.preheader, %.preheader56.i.i.i.i.i, %bb.h, %.lr.ph.i.i.i.i.i, %bb.e, %bb.e, %bb.d
  %.sroa.102.0.i.i.i.i = phi i64 [ undef, %bb.e ], [ undef, %bb.e ], [ undef, %.lr.ph.i.i.i.i.i ], [ undef, %bb.d ], [ %i.ax, %bb.h ], [ undef, %bb.g ], [ %i.an, %.preheader56.i.i.i.i.i ], [ undef, %.preheader56.i.i.i.i.i.preheader ] ; 3 uses
  %.sink.i.i.i.i.i = phi i1 [ true, %bb.e ], [ true, %bb.e ], [ %i.as, %bb.h ], [ true, %bb.d ], [ %i.as, %.lr.ph.i.i.i.i.i ], [ true, %bb.g ], [ false, %.preheader56.i.i.i.i.i ], [ true, %.preheader56.i.i.i.i.i.preheader ]
...
begin_hunk_3
  ...
  %i.h = load ptr, ptr %.sroa.5.0..sroa_idx.i.i.i, align 8, !alias.scope !7230, !nonnull !12, !noundef !12 ; 4 uses
...
bb.e:                                             ; preds = %bb.d
  %i.k = load i8, ptr %i.h, align 1, !alias.scope !7233, !noalias !7236, !noundef !12
  switch i8 %i.k, label %thread-pre-split.i.i.i.i.i [
    i8 43, label %_RNvMsv_NtCsbvkFyIu7lgC_4core3numj16from_ascii_radix.exit.i.i.i.i
    i8 45, label %_RNvMsv_NtCsbvkFyIu7lgC_4core3numj16from_ascii_radix.exit.i.i.i.i
  ]

thread-pre-split.i.i.i.i.i:                       ; preds = %bb.f, %bb.e
  %.sroa.0.270.i.i.i.i.i.ph = phi ptr [ %i.h, %bb.e ], [ %.sroa.0.0.i.i.i.i.i, %bb.f ]
  %.sroa.15.269.i.i.i.i.i.ph = phi i64 [ 1, %bb.e ], [ %.sroa.15.0.i.i.i.i.i, %bb.f ]
  br label %.lr.ph.i.i.i.i.i
...
bb.f:                                             ; preds = %bb.d
  ...
  %.sroa.15.0.i.i.i.i.i = add nsw i64 %i.j, %i.l  ; 3 uses
  %.sroa.0.0.idx.i.i.i.i.i = zext i1 %cond.i.i.i.i.i to i64
  ...
  br i1 %i.m, label %thread-pre-split.i.i.i.i.i, label %.preheader56.i.i.i.i.i.preheader
...
.lr.ph.i.i.i.i.i:                                 ; preds = %thread-pre-split.i.i.i.i.i, %bb.h
  %.sroa.0.269.i.i.i.i.i = phi ptr [ %i.af, %bb.h ], [ %.sroa.0.270.i.i.i.i.i.ph, %thread-pre-split.i.i.i.i.i ] ; 2 uses
  %.sroa.15.268.i.i.i.i.i = phi i64 [ %i.ae, %bb.h ], [ %.sroa.15.269.i.i.i.i.i.ph, %thread-pre-split.i.i.i.i.i ]
  %.sroa.042.267.i.i.i.i.i = phi i64 [ %i.ah, %bb.h ], [ 0, %thread-pre-split.i.i.i.i.i ]
...
_RNvMsv_NtCsbvkFyIu7lgC_4core3numj16from_ascii_radix.exit.i.i.i.i: ; preds = %bb.g, %.preheader56.i.i.i.i.i.preheader, %.preheader56.i.i.i.i.i, %bb.h, %.lr.ph.i.i.i.i.i, %bb.e, %bb.e, %bb.d
  %.sink.i.i.i.i.i = phi i64 [ 10, %bb.e ], [ 10, %bb.e ], [ 10, %.lr.ph.i.i.i.i.i ], [ 10, %bb.d ], [ %i.ah, %bb.h ], [ 10, %bb.g ], [ %i.x, %.preheader56.i.i.i.i.i ], [ 10, %.preheader56.i.i.i.i.i.preheader ]
...
begin_hunk_6
  ...
  %i.h = load ptr, ptr %.sroa.5.0..sroa_idx.i.i.i, align 8, !alias.scope !7238, !nonnull !12, !noundef !12 ; 4 uses
  %i.i = getelementptr inbounds nuw i8, ptr %i.a, i64 16
...
bb.e:                                             ; preds = %bb.d
  %i.k = load i8, ptr %i.h, align 1, !alias.scope !7241, !noalias !7244, !noundef !12
  switch i8 %i.k, label %thread-pre-split.i.i.i.i.i [
    i8 43, label %_RNvMsv_NtCsbvkFyIu7lgC_4core3numj16from_ascii_radix.exit.i.i.i.i
    i8 45, label %_RNvMsv_NtCsbvkFyIu7lgC_4core3numj16from_ascii_radix.exit.i.i.i.i
  ]
...
_RNvMsv_NtCsbvkFyIu7lgC_4core3numj16from_ascii_radix.exit.i.i.i.i: ; preds = %bb.g, %.preheader56.i.i.i.i.i.preheader, %.preheader56.i.i.i.i.i, %bb.h, %.lr.ph.i.i.i.i.i, %bb.e, %bb.e, %bb.d
  %.sroa.102.0.i.i.i.i = phi i64 [ undef, %bb.e ], [ undef, %bb.e ], [ undef, %.lr.ph.i.i.i.i.i ], [ undef, %bb.d ], [ %i.ah, %bb.h ], [ undef, %bb.g ], [ %i.x, %.preheader56.i.i.i.i.i ], [ undef, %.preheader56.i.i.i.i.i.preheader ]
  %.sink.i.i.i.i.i = phi i1 [ true, %bb.e ], [ true, %bb.e ], [ %i.ac, %bb.h ], [ true, %bb.d ], [ %i.ac, %.lr.ph.i.i.i.i.i ], [ true, %bb.g ], [ false, %.preheader56.i.i.i.i.i ], [ true, %.preheader56.i.i.i.i.i.preheader ]
  invoke void @_RNvXso_NtCs6Po7BT7Nknu_5alloc3vecINtB5_3VechENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCs14kWLkQVSKO_14deltalake_core(ptr noalias noundef nonnull align 8 dereferenceable(24) %i.a)
