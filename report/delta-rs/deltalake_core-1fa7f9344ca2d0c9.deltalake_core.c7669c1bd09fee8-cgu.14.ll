...
begin_hunk_0_@_RNvXss1_NtCs4lawaffTVVK_9sqlparser3astNtB6_12OutputClauseNtNtCsbvkFyIu7lgC_4core3cmp10PartialOrd11partial_cmp:bb.a
  %.val9.i = load i64, ptr %i.ce, align 8, !alias.scope !17402, !noalias !17399, !noundef !12
  %i.cf = tail call noundef range(i8 -1, 3) i8 @_RNvXs4_NtNtCsbvkFyIu7lgC_4core5slice3cmpNtNtCs4lawaffTVVK_9sqlparser3ast14ObjectNamePartNtB5_15SlicePartialOrd15partial_compareCs14kWLkQVSKO_14deltalake_core(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) %.val.i7, i64 noundef %.val7.i, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) %.val8.i, i64 noundef %.val9.i), !noalias !17404
...
.lr.ph41:                                         ; preds = %bb.aa, %.backedge
  ...
  tail call void @llvm.experimental.noalias.scope.decl(metadata !17405)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !17408)
  ...
  %i.cs = load i64, ptr %i.cq, align 8, !range !5504, !alias.scope !17415, !noalias !17416, !noundef !12 ; 4 uses
  ...
  %i.cx = load i64, ptr %i.cr, align 8, !range !5504, !alias.scope !17416, !noalias !17415, !noundef !12 ; 4 uses
...
bb.ae:                                            ; preds = %bb.ab
  ...
  %i.df = tail call fastcc noundef i8 @_RNvXs6K_NtCs4lawaffTVVK_9sqlparser3astNtB6_4ExprNtNtCsbvkFyIu7lgC_4core3cmp10PartialOrd11partial_cmp(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(328) %i.dd, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(328) %i.de) #55, !inline_history !14101
  br label %_RNCNvXs4_NtNtCsbvkFyIu7lgC_4core5slice3cmpNtNtNtCs4lawaffTVVK_9sqlparser3ast5query10SelectItemNtB7_15SlicePartialOrd15partial_compare0Cs14kWLkQVSKO_14deltalake_core.exit20

bb.af:                                            ; preds = %bb.ab
  %i.dg = getelementptr inbounds nuw i8, ptr %i.cq, i64 8
  %i.dh = getelementptr inbounds nuw i8, ptr %i.cr, i64 8
  %i.di = tail call fastcc noundef i8 @_RNvXs6K_NtCs4lawaffTVVK_9sqlparser3astNtB6_4ExprNtNtCsbvkFyIu7lgC_4core3cmp10PartialOrd11partial_cmp(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(328) %i.dg, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(328) %i.dh) #55, !inline_history !14101 ; 2 uses
...
bb.ag:                                            ; preds = %bb.ab
  tail call void @llvm.experimental.noalias.scope.decl(metadata !17417)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !17420)
...
bb.am:                                            ; preds = %bb.ab
  ...
  %i.dx = tail call fastcc noundef i8 @_RNvXs4k_NtNtCs4lawaffTVVK_9sqlparser3ast5queryNtB6_25WildcardAdditionalOptionsNtNtCsbvkFyIu7lgC_4core3cmp10PartialOrd11partial_cmp(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(416) %i.dv, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(416) %i.dw) #55, !inline_history !14101
  br label %_RNCNvXs4_NtNtCsbvkFyIu7lgC_4core5slice3cmpNtNtNtCs4lawaffTVVK_9sqlparser3ast5query10SelectItemNtB7_15SlicePartialOrd15partial_compare0Cs14kWLkQVSKO_14deltalake_core.exit20

bb.an:                                            ; preds = %bb.af
  %i.dy = getelementptr inbounds nuw i8, ptr %i.cr, i64 336
  %i.dz = getelementptr inbounds nuw i8, ptr %i.cq, i64 336
  %i.ea = tail call noundef i8 @_RNvXs2_NtCs4lawaffTVVK_9sqlparser3astNtB5_5IdentNtNtCsbvkFyIu7lgC_4core3cmp10PartialOrd11partial_cmp(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(64) %i.dz, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(64) %i.dy), !inline_history !14101
  br label %_RNCNvXs4_NtNtCsbvkFyIu7lgC_4core5slice3cmpNtNtNtCs4lawaffTVVK_9sqlparser3ast5query10SelectItemNtB7_15SlicePartialOrd15partial_compare0Cs14kWLkQVSKO_14deltalake_core.exit20
...
bb.ao:                                            ; preds = %_RNvXs3Q_NtNtCs4lawaffTVVK_9sqlparser3ast5queryNtB6_31SelectItemQualifiedWildcardKindNtNtCsbvkFyIu7lgC_4core3cmp10PartialOrd11partial_cmp.exit30
  ...
  %i.ed = tail call fastcc noundef i8 @_RNvXs4k_NtNtCs4lawaffTVVK_9sqlparser3ast5queryNtB6_25WildcardAdditionalOptionsNtNtCsbvkFyIu7lgC_4core3cmp10PartialOrd11partial_cmp(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(416) %i.ec, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(416) %i.eb) #55, !inline_history !14101
  br label %_RNCNvXs4_NtNtCsbvkFyIu7lgC_4core5slice3cmpNtNtNtCs4lawaffTVVK_9sqlparser3ast5query10SelectItemNtB7_15SlicePartialOrd15partial_compare0Cs14kWLkQVSKO_14deltalake_core.exit20
...
.lr.ph.i:                                         ; preds = %bb.d, %bb.f
  ...
  %i.o = load i8, ptr %i.n, align 1, !alias.scope !17423, !noundef !12
...
bb.g:                                             ; preds = %bb.b
  tail call void @llvm.experimental.noalias.scope.decl(metadata !17426)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !17429)
  %i.r = load i8, ptr %0, align 1, !alias.scope !17426, !noalias !17429, !noundef !12 ; 3 uses
...
bb.j:                                             ; preds = %.lr.ph
  tail call void @_RNvNtCsbvkFyIu7lgC_4core9panicking18panic_bounds_check(i64 noundef %i.x, i64 noundef range(i64 2, 24) %1, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @250) #56, !noalias !17431
  unreachable
...
_RNCINvNvNtNtNtNtCsbvkFyIu7lgC_4core4iter6traits12double_ended19DoubleEndedIterator5rfind5checkjNCNvNtNtBe_3str7pattern13simd_contains0E0Cs14kWLkQVSKO_14deltalake_core.exit.i.i: ; preds = %.lr.ph
  ...
  %i.aa = load i8, ptr %i.z, align 1, !alias.scope !17426, !noalias !17439, !noundef !12 ; 2 uses
...
.thread93.i:                                      ; preds = %.thread.i
  ...
  %.pre.i = load i8, ptr %.phi.trans.insert.i, align 1, !alias.scope !17426, !noalias !17429
  br label %bb.m
...
.lr.ph.split.us.i.i:                              ; preds = %bb.k, %.thread.i
  %bcmp.i.i.us23.i.i = tail call i32 @bcmp(ptr noundef nonnull readonly dereferenceable(1) %2, ptr noundef nonnull readonly dereferenceable(1) %0, i64 range(i64 2, 24) %1), !alias.scope !17440, !noalias !17441
...
.split.us.i.i:                                    ; preds = %_RNCINvNvNtNtNtNtCsbvkFyIu7lgC_4core4iter6traits8iterator8Iterator3any5checkRShNCNvNtNtBe_3str7pattern13simd_containss_0E0Cs14kWLkQVSKO_14deltalake_core.exit.backedge.us.i.i.preheader, %_RNCINvNvNtNtNtNtCsbvkFyIu7lgC_4core4iter6traits8iterator8Iterator3any5checkRShNCNvNtNtBe_3str7pattern13simd_containss_0E0Cs14kWLkQVSKO_14deltalake_core.exit.backedge.us.i.i
  ...
  %bcmp.i.i.us.i.i = tail call i32 @bcmp(ptr noundef nonnull readonly dereferenceable(1) %i.al, ptr noundef nonnull readonly dereferenceable(1) %0, i64 range(i64 2, 24) %1), !alias.scope !17440, !noalias !17441
...
bb.m:                                             ; preds = %bb.l, %.thread93.i
  ...
  store ptr %2, ptr %i.a, align 8, !noalias !17440
  %i.at = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  store i64 %3, ptr %i.at, align 8, !noalias !17440
  %i.au = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  store ptr %i.as, ptr %i.au, align 8, !noalias !17440
  %i.av = getelementptr inbounds nuw i8, ptr %i.a, i64 24
  store i64 %i.s, ptr %i.av, align 8, !noalias !17440
...
.lr.ph.i8:                                        ; preds = %bb.m, %bb.q
  ...
  %.sroa.0.0.copyload.i.i = load <16 x i8>, ptr %i.bb, align 1, !alias.scope !17429, !noalias !17445
  %i.bc = getelementptr inbounds nuw i8, ptr %i.bb, i64 %storemerge9295.i
  %.sroa.02.0.copyload.i.i = load <16 x i8>, ptr %i.bc, align 1, !alias.scope !17429, !noalias !17445
  ...
  %.sroa.0.0.copyload.i.1.i = load <16 x i8>, ptr %i.bh, align 1, !alias.scope !17429, !noalias !17445
  %i.bi = getelementptr inbounds nuw i8, ptr %i.bh, i64 %storemerge9295.i
  %.sroa.02.0.copyload.i.1.i = load <16 x i8>, ptr %i.bi, align 1, !alias.scope !17429, !noalias !17445
  ...
  %.sroa.0.0.copyload.i.2.i = load <16 x i8>, ptr %i.bn, align 1, !alias.scope !17429, !noalias !17445
  %i.bo = getelementptr inbounds nuw i8, ptr %i.bn, i64 %storemerge9295.i
  %.sroa.02.0.copyload.i.2.i = load <16 x i8>, ptr %i.bo, align 1, !alias.scope !17429, !noalias !17445
  ...
  %.sroa.0.0.copyload.i.3.i = load <16 x i8>, ptr %i.bt, align 1, !alias.scope !17429, !noalias !17445
  %i.bu = getelementptr inbounds nuw i8, ptr %i.bt, i64 %storemerge9295.i
  %.sroa.02.0.copyload.i.3.i = load <16 x i8>, ptr %i.bu, align 1, !alias.scope !17429, !noalias !17445
...
._crit_edge.i7:                                   ; preds = %bb.s, %.preheader.i6
  ...
  %.sroa.0.0.copyload.i58.i = load <16 x i8>, ptr %i.da, align 1, !alias.scope !17429, !noalias !17448
  %i.db = getelementptr inbounds nuw i8, ptr %i.da, i64 %storemerge9295.i
  %.sroa.02.0.copyload.i59.i = load <16 x i8>, ptr %i.db, align 1, !alias.scope !17429, !noalias !17448
...
.lr.ph107.i:                                      ; preds = %.preheader.i6, %bb.s
  ...
  %.sroa.0.0.copyload.i60.i = load <16 x i8>, ptr %i.dh, align 1, !alias.scope !17429, !noalias !17451
  %i.di = getelementptr inbounds nuw i8, ptr %i.dh, i64 %storemerge9295.i
  %.sroa.02.0.copyload.i61.i = load <16 x i8>, ptr %i.di, align 1, !alias.scope !17429, !noalias !17451
...
bb.g:                                             ; preds = %bb.b
  tail call void @llvm.experimental.noalias.scope.decl(metadata !17454)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !17457)
  %i.p = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.q = load ptr, ptr %i.p, align 8, !alias.scope !17454, !noalias !17457, !nonnull !12, !noundef !12
  %i.r = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.s = load i64, ptr %i.r, align 8, !alias.scope !17454, !noalias !17457, !noundef !12 ; 2 uses
  %i.t = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.u = load ptr, ptr %i.t, align 8, !alias.scope !17457, !noalias !17454, !nonnull !12, !noundef !12
  %i.v = getelementptr inbounds nuw i8, ptr %1, i64 24
  %i.w = load i64, ptr %i.v, align 8, !alias.scope !17457, !noalias !17454, !noundef !12 ; 2 uses
