...
bb.aqw:                                           ; preds = %bb.aqv
  %i.bsh = landingpad { ptr, i32 }
          cleanup
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeTINtNtCs6Po7BT7Nknu_5alloc5boxed3BoxNtNtCs8VI8w5SIoU4_15datafusion_expr4expr4ExprEBH_EECs14kWLkQVSKO_14deltalake_core(ptr noalias noundef align 8 dereferenceable(16) %i.a) #52
...
bb.aqy:                                           ; preds = %bb.aqt
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs8VI8w5SIoU4_15datafusion_expr4expr4ExprECs14kWLkQVSKO_14deltalake_core(ptr noalias noundef align 16 dereferenceable(112) %i.brq) #57
          to label %bb.arc unwind label %bb.aqz, !noalias !14489, !inline_history !507

bb.aqz:                                           ; preds = %bb.aqy
  %i.bsj = landingpad { ptr, i32 }
          cleanup
  call void @_RNvCs8mYq7K4qqSA_7___rustc14___rust_dealloc(ptr noundef nonnull %i.brq, i64 noundef 112, i64 noundef 16) #51, !noalias !14489, !inline_history !507
  br label %.thread7033
...
bb.arc:                                           ; preds = %bb.aqy
  call void @_RNvCs8mYq7K4qqSA_7___rustc14___rust_dealloc(ptr noundef nonnull %i.brq, i64 noundef 112, i64 noundef 16) #51, !noalias !14489, !inline_history !507
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs8VI8w5SIoU4_15datafusion_expr4expr4ExprECs14kWLkQVSKO_14deltalake_core(ptr noalias noundef align 16 dereferenceable(112) %i.bro) #57
...
bb.ard:                                           ; preds = %bb.arc
  %i.bss = landingpad { ptr, i32 }
          cleanup
  call void @_RNvCs8mYq7K4qqSA_7___rustc14___rust_dealloc(ptr noundef nonnull %i.bro, i64 noundef 112, i64 noundef 16) #51, !noalias !14494, !inline_history !507
  br label %.body6308
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtCs6Po7BT7Nknu_5alloc3vec9into_iter8IntoIterTINtNtBN_5boxed3BoxNtNtCs8VI8w5SIoU4_15datafusion_expr4expr4ExprEB1v_EEECs14kWLkQVSKO_14deltalake_core.exit6295: ; preds = %.body6308, %bb.arg
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VecTINtNtBL_5boxed3BoxNtNtCs8VI8w5SIoU4_15datafusion_expr4expr4ExprEB1e_EEECs14kWLkQVSKO_14deltalake_core(ptr noalias noundef align 8 dereferenceable(24) %i.fa) #52
...
bb.arj:                                           ; preds = %bb.arh
  ...
  call void @_RNvCs8mYq7K4qqSA_7___rustc14___rust_dealloc(ptr noundef nonnull %i.bry, i64 noundef 112, i64 noundef 16) #51
  br label %bb.arl
...
bb.aru:                                           ; preds = %bb.apf, %bb.auv, %bb.qn
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs8VI8w5SIoU4_15datafusion_expr4expr4ExprECs14kWLkQVSKO_14deltalake_core(ptr noalias noundef align 16 dereferenceable(112) %i.btg) #57
...
.body6311:                                        ; preds = %bb.aru
  %i.bth = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  call void @_RNvCs8mYq7K4qqSA_7___rustc14___rust_dealloc(ptr noundef nonnull %i.btg, i64 noundef 112, i64 noundef 16) #51, !noalias !14497, !inline_history !507
...
.thread7033:                                      ; preds = %.body6303, %bb.aqz
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc5boxed3BoxNtNtCs8VI8w5SIoU4_15datafusion_expr4expr4ExprEECs14kWLkQVSKO_14deltalake_core(ptr noalias noundef align 8 dereferenceable(8) %i.ey) #52
...
bb.arz:                                           ; preds = %.thread7008
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc5boxed3BoxNtNtCs8VI8w5SIoU4_15datafusion_expr4expr4ExprEECs14kWLkQVSKO_14deltalake_core(ptr noalias noundef align 8 dereferenceable(8) %i.fd) #52
          to label %bb.arv unwind label %bb.bt

bb.asa:                                           ; preds = %bb.arv
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc3vec3VecTINtNtBL_5boxed3BoxNtNtCs8VI8w5SIoU4_15datafusion_expr4expr4ExprEB1e_EEECs14kWLkQVSKO_14deltalake_core(ptr noalias noundef align 8 dereferenceable(24) %i.fe) #52
...
bb.asc:                                           ; preds = %bb.asb
  fence acquire
  invoke void @_RNvMsn_NtCs6Po7BT7Nknu_5alloc4syncINtB5_3ArcNtNtCs8VI8w5SIoU4_15datafusion_expr3udf9ScalarUDFE9drop_slowBK_(ptr noalias noundef nonnull align 8 dereferenceable(8) %i.dm) #54
          to label %.thread6569 unwind label %bb.bt
...
bb.n:                                             ; preds = %.preheader96.1.i
  ...
  %i.ce = call fastcc noundef zeroext i1 @_RNCNvNtNtCsbvkFyIu7lgC_4core3str7pattern13simd_containss0_0Cs14kWLkQVSKO_14deltalake_core(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) %i.a, i64 noundef %i.cc, i16 noundef %i.bn, i1 noundef zeroext %i.cd) #55
...
bb.o:                                             ; preds = %.preheader96.2.i
  ...
  %i.ck = call fastcc noundef zeroext i1 @_RNCNvNtNtCsbvkFyIu7lgC_4core3str7pattern13simd_containss0_0Cs14kWLkQVSKO_14deltalake_core(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) %i.a, i64 noundef %i.ci, i16 noundef %i.bt, i1 noundef zeroext %i.cj) #55
...
bb.p:                                             ; preds = %.preheader96.3.i
  ...
  %i.cq = call fastcc noundef zeroext i1 @_RNCNvNtNtCsbvkFyIu7lgC_4core3str7pattern13simd_containss0_0Cs14kWLkQVSKO_14deltalake_core(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) %i.a, i64 noundef %i.co, i16 noundef %i.bz, i1 noundef zeroext %i.cp) #55
...
bb.r:                                             ; preds = %.lr.ph.i8
  %i.cx = call fastcc noundef zeroext i1 @_RNCNvNtNtCsbvkFyIu7lgC_4core3str7pattern13simd_containss0_0Cs14kWLkQVSKO_14deltalake_core(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) %i.a, i64 noundef %.sroa.06.0103.i, i16 noundef %i.bh, i1 noundef zeroext false) #55
...
bb.t:                                             ; preds = %.lr.ph107.i
  %i.dt = call fastcc noundef zeroext i1 @_RNCNvNtNtCsbvkFyIu7lgC_4core3str7pattern13simd_containss0_0Cs14kWLkQVSKO_14deltalake_core(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) %i.a, i64 noundef %.sroa.06.1106.i, i16 noundef %i.dn, i1 noundef zeroext false) #55
...
bb.v:                                             ; preds = %._crit_edge.i7
  %i.dv = call fastcc noundef zeroext i1 @_RNCNvNtNtCsbvkFyIu7lgC_4core3str7pattern13simd_containss0_0Cs14kWLkQVSKO_14deltalake_core(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) %i.a, i64 noundef %i.da, i16 noundef %i.dg, i1 noundef zeroext %.lcssa.i) #55
