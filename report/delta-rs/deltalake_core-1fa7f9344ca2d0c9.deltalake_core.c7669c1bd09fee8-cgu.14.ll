...
bb.aks:                                           ; preds = %bb.ala, %bb.akr
  ...
  %.sroa.201.15 = phi ptr [ %.sroa.8817.sroa.8.0.copyload, %bb.ala ], [ undef, %bb.akr ]
  ...
  %.sroa.178.15 = phi ptr [ %.sroa.8817.sroa.9.0.copyload.a, %bb.ala ], [ undef, %bb.akr ]
...
bb.ala:                                           ; preds = %bb.akz
  ...
  %.sroa.8817.sroa.9.0.copyload.a = load ptr, ptr %.sroa.8817.sroa.8.0..sroa.8817.0..sroa_idx.sroa_idx, align 16
  %.sroa.8817.sroa.8.0.copyload = load ptr, ptr %.sroa.8817.sroa.9.0..sroa.8817.0..sroa_idx.sroa_idx, align 8
