...
bb.b:                                             ; preds = %bb.a
  %i.a = load i8, ptr %0, align 1, !alias.scope !34, !noundef !6
...
.lr.ph.i.i.5:                                     ; preds = %bb.d
  ...
  br i1 %i.r, label %_RNvXsA_NtCsbvkFyIu7lgC_4core3nummNtNtNtB7_3str6traits7FromStr8from_str.exit, label %.preheader60.i.i, !prof !8
...
.lr.ph.i.i.6:                                     ; preds = %thread-pre-split.i.i, %.lr.ph.i.i.7
  ...
  %i.s = load i8, ptr %.sroa.0.272.i.i, align 1, !alias.scope !34, !noundef !6
...
bb.b:                                             ; preds = %bb.a
  %i.a = load i8, ptr %0, align 1, !alias.scope !39, !noalias !44, !noundef !6
  switch i8 %i.a, label %thread-pre-split.i.i [
...
.lr.ph.split.preheader.i.i:                       ; preds = %bb.o
  %i.ak = load ptr, ptr %.sroa.474.0..sroa_idx, align 8, !nonnull !6, !noundef !6 ; 7 uses
...
bb.w:                                             ; preds = %_RNvXs_NtNtCsbvkFyIu7lgC_4core3str7patternNtB4_12CharSearcherNtB4_8Searcher10next_match.exit.i
  %i.bf = load i8, ptr %i.ak, align 1, !alias.scope !329, !noalias !332, !noundef !6
