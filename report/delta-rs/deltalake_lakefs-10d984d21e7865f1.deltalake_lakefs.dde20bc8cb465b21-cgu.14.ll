...
3:                                                ; preds = %bb.d
  ...
  br i1 %5, label %_RNvXsA_NtCsbvkFyIu7lgC_4core3nummNtNtNtB7_3str6traits7FromStr8from_str.exit, label %.preheader60.i.i, !prof !8

.lr.ph.i.i:                                       ; preds = %.preheader.i.i
  %6 = load i8, ptr %.sroa.0.0.i.i, align 1, !alias.scope !34, !noundef !6
  %7 = zext i8 %6 to i32
...
.lr.ph.i.i.1:                                     ; preds = %10
  ...
  %12 = load i8, ptr %11, align 1, !alias.scope !34, !noundef !6
...
.lr.ph.i.i.2:                                     ; preds = %16
  ...
  %20 = load i8, ptr %19, align 1, !alias.scope !34, !noundef !6
...
.lr.ph.i.i.3:                                     ; preds = %24
  ...
  %28 = load i8, ptr %27, align 1, !alias.scope !34, !noundef !6
...
.lr.ph.i.i.4:                                     ; preds = %32
  ...
  %36 = load i8, ptr %35, align 1, !alias.scope !34, !noundef !6
...
.lr.ph.i.i.5:                                     ; preds = %40
  ...
  %44 = load i8, ptr %43, align 1, !alias.scope !34, !noundef !6
...
.lr.ph.i.i.6:                                     ; preds = %46
  ...
  %i.s = load i8, ptr %49, align 1, !alias.scope !34, !noundef !6
...
.lr.ph.i.i.7:                                     ; preds = %50
  ...
  %54 = load i8, ptr %53, align 1, !alias.scope !34, !noundef !6
...
begin_hunk_4
; Function Attrs: nofree norecurse nosync nounwind nonlazybind memory(argmem: read) uwtable
define internal fastcc { i64, i64 } @_RINvNtCs8ulvy0Wg6Ot_12delta_kernel4path15parse_path_partyECsj34PGqTgg0L_16deltalake_lakefs(ptr noalias noundef nonnull readonly captures(none) %0, i64 noundef %1) unnamed_addr #2 {
bb.a:
  switch i64 %1, label %thread-pre-split.i.i [
...
bb.b:                                             ; preds = %bb.a
  %i.a = load i8, ptr %0, align 1, !alias.scope !39, !noalias !44, !noundef !6 ; 2 uses
  switch i8 %i.a, label %bb.c [
...
end_hunk_4
begin_hunk_5
  %or.cond = select i1 %i.l, i1 true, i1 %i.o, !prof !47
...
.lr.ph.i.i:                                       ; preds = %.preheader.i.i, %bb.e
  ...
  %i.p = load i8, ptr %.sroa.0.269.i.i, align 1, !alias.scope !39, !noalias !44, !noundef !6
...
bb.w:                                             ; preds = %_RNvXs_NtNtCsbvkFyIu7lgC_4core3str7patternNtB4_12CharSearcherNtB4_8Searcher10next_match.exit.i
  %i.bf = load i8, ptr %i.ak, align 1, !alias.scope !329, !noalias !332, !noundef !6 ; 2 uses
...
thread-pre-split.i:                               ; preds = %_RNvXs_NtNtCsbvkFyIu7lgC_4core3str7patternNtB4_12CharSearcherNtB4_8Searcher10next_match.exit.i
  %.pr.i = load i8, ptr %i.ak, align 1, !alias.scope !329, !noalias !332
  br label %bb.x

bb.x:                                             ; preds = %thread-pre-split.i, %bb.w
  %2 = phi i8 [ %.pr.i, %thread-pre-split.i ], [ %i.bf, %bb.w ]
  %cond.i = icmp eq i8 %2, 43                     ; 2 uses
  %i.bg = sext i1 %cond.i to i64
  %.sroa.15.0.i = add nsw i64 %.sroa.4.1.i, %i.bg ; 4 uses
...
end_hunk_8
begin_hunk_9
  %or.cond201 = select i1 %i.bq, i1 true, i1 %i.bt, !prof !47
  br i1 %or.cond201, label %.loopexit, label %.preheader56.i, !prof !47

.lr.ph.i:                                         ; preds = %.preheader.i, %bb.z
  %.sroa.0.269.i = phi ptr [ %i.ca, %bb.z ], [ %.sroa.0.0.i, %.preheader.i ] ; 2 uses
  %.sroa.15.268.i = phi i64 [ %i.bz, %bb.z ], [ %.sroa.15.0.i, %.preheader.i ]
  %.sroa.042.267.i = phi i64 [ %i.cc, %bb.z ], [ 0, %.preheader.i ]
  %i.bu = load i8, ptr %.sroa.0.269.i, align 1, !alias.scope !329, !noalias !332, !noundef !6
...
_RNvMsD_NtCsbvkFyIu7lgC_4core3numy16from_ascii_radix.exit: ; preds = %.preheader56.i, %bb.z, %.preheader.i
  %.sroa.11177.0 = phi i64 [ %i.cc, %bb.z ], [ 0, %.preheader.i ], [ %i.bs, %.preheader56.i ]
