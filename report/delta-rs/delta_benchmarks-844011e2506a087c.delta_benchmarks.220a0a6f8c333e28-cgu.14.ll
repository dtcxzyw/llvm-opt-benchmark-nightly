...
begin_hunk_0_@_RNCNvMs3_NtNtCs8Hz2sPNgbCO_10datafusion9execution7contextNtB7_14SessionContext3sql0Cs2VbMhdeEr66_16delta_benchmarks:bb.a
  ...
  %.sroa.826.i.sroa.8.i.a = alloca [32 x i8], align 8 ; 8 uses
...
bb.z:                                             ; preds = %bb.w
  ...
  %i.fd = load i64, ptr %i.bz, align 8, !range !1787, !alias.scope !17887, !noalias !17889, !noundef !17 ; 3 uses
...
begin_hunk_3_@_RNCNvMs3_NtNtCs8Hz2sPNgbCO_10datafusion9execution7contextNtB7_14SessionContext3sql0Cs2VbMhdeEr66_16delta_benchmarks:bb.a
  ...
  %.sroa.826.i.sroa.0.0.copyload.i = phi i64 [ %i.hr, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtNtCs6Po7BT7Nknu_5alloc3vec9into_iter8IntoIterNtNtCsjhHCjzi9uUI_17datafusion_common15table_reference14TableReferenceEECs2VbMhdeEr66_16delta_benchmarks.exit75.i.i.i ], [ %i.fd, %bb.ad ]
...
_RNvXs_NtNtCsbvkFyIu7lgC_4core6future6futureINtNtB8_3pin3PinINtNtCs6Po7BT7Nknu_5alloc5boxed3BoxDNtB4_6Futurep6OutputINtNtB8_6result6ResultINtNtB8_6option6OptionINtNtB10_4sync3ArcDNtNtCsanCXJAiNsO_18datafusion_catalog5table13TableProviderEL_EENtNtCsjhHCjzi9uUI_17datafusion_common5error15DataFusionErrorENtNtB8_6marker4SendEL_EEB1v_4pollCs2VbMhdeEr66_16delta_benchmarks.exit.i.i.i: ; preds = %bb.ai
  %i.hr = load i64, ptr %i.bu, align 8, !range !1799, !noalias !17873, !noundef !17 ; 4 uses
...
begin_hunk_5_@_RNCNvMs3_NtNtCs8Hz2sPNgbCO_10datafusion9execution7contextNtB7_14SessionContext3sql0Cs2VbMhdeEr66_16delta_benchmarks:bb.a
  ...
  invoke void @_RNvXsg_NtCs3gpiEk3WpjL_9hashbrown3rawINtB5_8RawTableTNtNtCsjhHCjzi9uUI_17datafusion_common15table_reference22ResolvedTableReferenceINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDNtNtCs8VI8w5SIoU4_15datafusion_expr12table_source11TableSourceEL_EEENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCs2VbMhdeEr66_16delta_benchmarks(ptr noalias noundef nonnull align 8 dereferenceable(48) %i.mp)
          to label %bb.cl unwind label %bb.bk, !noalias !17877
...
.thread49.i.i:                                    ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs8Hz2sPNgbCO_10datafusion9execution13session_state22SessionContextProviderECs2VbMhdeEr66_16delta_benchmarks.exit77.i.i.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.826.i.sroa.8.i.a, ptr noundef nonnull align 16 dereferenceable(32) %.sroa.826.i.sroa.8.0..sroa.826.0..sroa_idx2751.i.sroa_idx.i, i64 32, i1 false), !noalias !17974
  %.sroa.826.i.sroa.9.0..sroa.826.0..sroa_idx2751.i.sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.bq, i64 48
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(272) %.sroa.826.i.sroa.9.i, ptr noundef nonnull align 16 dereferenceable(272) %.sroa.826.i.sroa.9.0..sroa.826.0..sroa_idx2751.i.sroa_idx.i, i64 272, i1 false), !noalias !17974
  store i8 1, ptr %i.gu, align 8, !noalias !17873
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.bx), !noalias !17860
...
bb.cl:                                            ; preds = %bb.bj
  ...
  %.sroa.024.0.copyload25.pre.i.i = load i64, ptr %i.bq, align 16, !noalias !17974 ; 2 uses
  %.sroa.826.0..sroa_idx27.i.i = getelementptr inbounds nuw i8, ptr %i.bq, i64 8
  %.sroa.826.i.sroa.0.0.copyload95.i = load i64, ptr %.sroa.826.0..sroa_idx27.i.i, align 8, !noalias !17974
  %.sroa.826.i.sroa.8.0..sroa.826.0..sroa_idx27.i.sroa_idx.i.a = getelementptr inbounds nuw i8, ptr %i.bq, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.826.i.sroa.8.i.a, ptr noundef nonnull align 16 dereferenceable(32) %.sroa.826.i.sroa.8.0..sroa.826.0..sroa_idx27.i.sroa_idx.i.a, i64 32, i1 false), !noalias !17974
  %.sroa.826.i.sroa.9.0..sroa.826.0..sroa_idx27.i.sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.bq, i64 48
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(272) %.sroa.826.i.sroa.9.i, ptr noundef nonnull align 16 dereferenceable(272) %.sroa.826.i.sroa.9.0..sroa.826.0..sroa_idx27.i.sroa_idx.i, i64 272, i1 false), !noalias !17974
  store i8 1, ptr %i.fv, align 8, !noalias !17873
  call void @llvm.lifetime.end.p0(ptr nonnull %i.bq), !noalias !17860
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.7.i.i.i)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.bw), !noalias !17860
end_hunk_8
...
bb.cm:                                            ; preds = %bb.cl, %.thread49.i.i
  %4 = phi ptr [ %i.fs, %bb.cl ], [ %i.gr, %.thread49.i.i ] ; 3 uses
  %5 = phi ptr [ %i.ft, %bb.cl ], [ %i.gs, %.thread49.i.i ] ; 3 uses
  %6 = phi ptr [ %i.fu, %bb.cl ], [ %i.gt, %.thread49.i.i ] ; 3 uses
  ...
  %7 = phi ptr [ %i.fw, %bb.cl ], [ %i.gv, %.thread49.i.i ]
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.3.i.sroa.5.i, ptr noundef nonnull align 8 dereferenceable(32) %.sroa.826.i.sroa.8.i.a, i64 32, i1 false), !noalias !17860
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(272) %.sroa.3.i.sroa.7.i, ptr noundef nonnull align 8 dereferenceable(272) %.sroa.826.i.sroa.9.i, i64 272, i1 false), !noalias !17860
  ...
  invoke fastcc void @_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNCNvMs_NtNtCs8Hz2sPNgbCO_10datafusion9execution13session_stateNtBN_12SessionState17statement_to_plan0ECs2VbMhdeEr66_16delta_benchmarks(ptr noundef nonnull align 8 %7)
          to label %bb.co unwind label %bb.cn, !noalias !17864
...
bb.co:                                            ; preds = %bb.cm
  ...
  br i1 %i.qe, label %bb.cq, label %bb.cp
...
begin_hunk_11_@_RNCNvMs3_NtNtCs8Hz2sPNgbCO_10datafusion9execution7contextNtB7_14SessionContext3sql0Cs2VbMhdeEr66_16delta_benchmarks:bb.a
          to label %.body16.thread.i unwind label %bb.cr, !noalias !17864

bb.ct:                                            ; preds = %bb.cl, %.thread.i.i
  %i.qg = phi ptr [ %i.hi, %.thread.i.i ], [ %i.fs, %bb.cl ]
  %i.qh = phi ptr [ %i.hk, %.thread.i.i ], [ %i.fu, %bb.cl ]
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.826.i.sroa.8.i.a)
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.826.i.sroa.9.i)
...
begin_hunk_12_@_RNCNvMs3_NtNtCs8Hz2sPNgbCO_10datafusion9execution7contextNtB7_14SessionContext3sql0Cs2VbMhdeEr66_16delta_benchmarks:bb.a
  %i.qi = phi ptr [ %i.dl, %bb.r ], [ %4, %bb.cq ], [ %4, %bb.cp ] ; 7 uses
  %i.qj = phi ptr [ %i.dm, %bb.r ], [ %5, %bb.cq ], [ %5, %bb.cp ] ; 7 uses
  %i.qk = phi ptr [ %i.dq, %bb.r ], [ %6, %bb.cq ], [ %6, %bb.cp ]
...
bb.om:                                            ; preds = %bb.op, %bb.oo, %bb.on, %bb.er
  store i8 0, ptr %i.ug, align 2, !noalias !17981
  %.sroa.078.0.copyload79.pre.i = load i64, ptr %i.au, align 16, !noalias !18320
  br label %bb.oy
...
bb.os:                                            ; preds = %bb.ol
  ...
  call void @llvm.experimental.noalias.scope.decl(metadata !18321)
  %i.akz = getelementptr inbounds nuw i8, ptr %i.au, i64 8
  store i64 %.sroa.0266.0.copyload267.i.i, ptr %i.akz, align 8, !alias.scope !18324, !noalias !17981
  store i64 36, ptr %i.au, align 16, !alias.scope !18326, !noalias !18327
  br label %bb.ff
...
begin_hunk_15_@_RNCNvMs3_NtNtCs8Hz2sPNgbCO_10datafusion9execution7contextNtB7_14SessionContext3sql0Cs2VbMhdeEr66_16delta_benchmarks:bb.a
  %i.all = phi ptr [ %i.ud, %bb.om ], [ %i.us, %bb.ov ]
  %i.alm = phi ptr [ %i.ue, %bb.om ], [ %i.ut, %bb.ov ]
  %i.aln = phi ptr [ %i.uf, %bb.om ], [ %i.uu, %bb.ov ]
  %.sroa.078.0.copyload79.i = phi i64 [ %.sroa.078.0.copyload79.pre.i, %bb.om ], [ 36, %bb.ov ] ; 2 uses
  ...
  %.sroa.18.sroa.0.0.copyload.i = load i64, ptr %.sroa.18.0..sroa_idx80.i, align 8, !noalias !18320
  %.sroa.18.sroa.6.0..sroa.18.0..sroa_idx80.sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.au, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.18.sroa.6.i, ptr noundef nonnull align 16 dereferenceable(32) %.sroa.18.sroa.6.0..sroa.18.0..sroa_idx80.sroa_idx.i, i64 32, i1 false), !noalias !18320
  %.sroa.18.sroa.7.0..sroa.18.0..sroa_idx80.sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.au, i64 48
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(288) %.sroa.18.sroa.7.i, ptr noundef nonnull align 16 dereferenceable(288) %.sroa.18.sroa.7.0..sroa.18.0..sroa_idx80.sroa_idx.i, i64 288, i1 false), !noalias !18320
...
!18320 = !{!17984, !17856, !17858}
!18321 = !{!18322}
!18322 = distinct !{!18322, !18323, !"_RNvXsq_NtCsbvkFyIu7lgC_4core6resultINtB5_6ResultNtNtCs8Hz2sPNgbCO_10datafusion9dataframe9DataFrameNtNtCsjhHCjzi9uUI_17datafusion_common5error15DataFusionErrorEINtNtNtB7_3ops9try_trait12FromResidualIBy_NtNtB7_7convert10InfallibleB1y_EE13from_residualCs2VbMhdeEr66_16delta_benchmarks: argument 1"}
!18323 = distinct !{!18323, !"_RNvXsq_NtCsbvkFyIu7lgC_4core6resultINtB5_6ResultNtNtCs8Hz2sPNgbCO_10datafusion9dataframe9DataFrameNtNtCsjhHCjzi9uUI_17datafusion_common5error15DataFusionErrorEINtNtNtB7_3ops9try_trait12FromResidualIBy_NtNtB7_7convert10InfallibleB1y_EE13from_residualCs2VbMhdeEr66_16delta_benchmarks"}
!18324 = !{!18325, !18322}
!18325 = distinct !{!18325, !18323, !"_RNvXsq_NtCsbvkFyIu7lgC_4core6resultINtB5_6ResultNtNtCs8Hz2sPNgbCO_10datafusion9dataframe9DataFrameNtNtCsjhHCjzi9uUI_17datafusion_common5error15DataFusionErrorEINtNtNtB7_3ops9try_trait12FromResidualIBy_NtNtB7_7convert10InfallibleB1y_EE13from_residualCs2VbMhdeEr66_16delta_benchmarks: argument 0"}
!18326 = !{!18325}
!18327 = !{!18322, !17982, !17984, !17856, !17858}
!18328 = !{!17858}
!18329 = !{!18330}
