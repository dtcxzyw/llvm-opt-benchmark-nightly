...
begin_hunk_5_@_RNCNvMs3_NtNtCs8Hz2sPNgbCO_10datafusion9execution7contextNtB7_14SessionContext3sql0Cs2VbMhdeEr66_16delta_benchmarks:bb.a
  ...
  invoke void @_RNvXsg_NtCs3gpiEk3WpjL_9hashbrown3rawINtB5_8RawTableTNtNtCsjhHCjzi9uUI_17datafusion_common15table_reference22ResolvedTableReferenceINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDNtNtCs8VI8w5SIoU4_15datafusion_expr12table_source11TableSourceEL_EEENtNtNtCsbvkFyIu7lgC_4core3ops4drop4Drop4dropCs2VbMhdeEr66_16delta_benchmarks(ptr noalias noundef nonnull align 8 dereferenceable(48) %i.mp)
          to label %bb.cm unwind label %bb.bk, !noalias !17877
...
bb.ch:                                            ; preds = %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs8Hz2sPNgbCO_10datafusion9execution13session_state22SessionContextProviderECs2VbMhdeEr66_16delta_benchmarks.exit77.i.i.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.826.i.sroa.7.i, ptr noundef nonnull align 16 dereferenceable(32) %.sroa.826.i.sroa.8.0..sroa.826.0..sroa_idx2751.i.sroa_idx.i, i64 32, i1 false), !noalias !17974
  %.sroa.826.i.sroa.9.0..sroa.826.0..sroa_idx2751.i.sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.bq, i64 48
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(272) %.sroa.826.i.sroa.8.i, ptr noundef nonnull align 16 dereferenceable(272) %.sroa.826.i.sroa.9.0..sroa.826.0..sroa_idx2751.i.sroa_idx.i, i64 272, i1 false), !noalias !17974
...
bb.cm:                                            ; preds = %bb.bj
  ...
  %.sroa.024.0.copyload25.i.i = load i64, ptr %i.bq, align 16, !noalias !17974 ; 2 uses
  %.sroa.826.0..sroa_idx27.i.i = getelementptr inbounds nuw i8, ptr %i.bq, i64 8
  %.sroa.826.i.sroa.0.0.copyload.i.a = load i64, ptr %.sroa.826.0..sroa_idx27.i.i, align 8, !noalias !17974
...
bb.cn:                                            ; preds = %bb.cm, %bb.ch
  %4 = phi ptr [ %i.fs, %bb.cm ], [ %i.gr, %bb.ch ] ; 3 uses
  %5 = phi ptr [ %i.ft, %bb.cm ], [ %i.gs, %bb.ch ] ; 3 uses
  %6 = phi ptr [ %i.fu, %bb.cm ], [ %i.gt, %bb.ch ] ; 3 uses
  %.sroa.826.i.sroa.0.0.i = phi i64 [ %.sroa.826.i.sroa.0.0.copyload.i.a, %bb.cm ], [ %.sroa.826.i.sroa.0.0.copyload.i, %bb.ch ] ; 2 uses
  %.sroa.024.0.copyload2552.i.i = phi i64 [ %.sroa.024.0.copyload25.i.i, %bb.cm ], [ 36, %bb.ch ] ; 2 uses
  %7 = phi ptr [ %i.fw, %bb.cm ], [ %i.gv, %bb.ch ]
...
bb.cu:                                            ; preds = %bb.cm, %.thread.i.i
  %i.qg = phi ptr [ %i.hi, %.thread.i.i ], [ %i.fs, %bb.cm ]
  %i.qh = phi ptr [ %i.hk, %.thread.i.i ], [ %i.fu, %bb.cm ]
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.826.i.sroa.7.i)
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.826.i.sroa.8.i)
...
begin_hunk_12_@_RNCNvMs3_NtNtCs8Hz2sPNgbCO_10datafusion9execution7contextNtB7_14SessionContext3sql0Cs2VbMhdeEr66_16delta_benchmarks:bb.a
  ...
  %.sroa.433.i.sroa.0.0.i = phi i64 [ %.sroa.8.i.sroa.0.0.copyload.i, %bb.r ], [ %.sroa.826.i.sroa.0.0.i, %bb.cr ], [ %.sroa.826.i.sroa.0.0.i, %bb.cq ] ; 2 uses
  %.sroa.032.1.i.i = phi i64 [ 36, %bb.r ], [ 36, %bb.cr ], [ %.sroa.024.0.copyload2552.i.i, %bb.cq ] ; 2 uses
...
begin_hunk_15_@_RNCNvMs3_NtNtCs8Hz2sPNgbCO_10datafusion9execution7contextNtB7_14SessionContext3sql0Cs2VbMhdeEr66_16delta_benchmarks:bb.a
  ...
  %.sroa.078.0.copyload79.i = phi i64 [ %.sroa.078.0.copyload79.pre.i, %bb.on ], [ 36, %bb.ow ] ; 2 uses
