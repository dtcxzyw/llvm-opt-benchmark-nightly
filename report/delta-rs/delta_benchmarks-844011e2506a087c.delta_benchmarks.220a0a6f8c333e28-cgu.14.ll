...
bb.cl:                                            ; preds = %.thread49.i.i, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs8Hz2sPNgbCO_10datafusion9execution13session_state22SessionContextProviderECs2VbMhdeEr66_16delta_benchmarks.exit.i.i.i
  %4 = phi ptr [ %i.fs, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs8Hz2sPNgbCO_10datafusion9execution13session_state22SessionContextProviderECs2VbMhdeEr66_16delta_benchmarks.exit.i.i.i ], [ %i.gr, %.thread49.i.i ] ; 4 uses
  %5 = phi ptr [ %i.ft, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs8Hz2sPNgbCO_10datafusion9execution13session_state22SessionContextProviderECs2VbMhdeEr66_16delta_benchmarks.exit.i.i.i ], [ %i.gs, %.thread49.i.i ] ; 3 uses
  %6 = phi ptr [ %i.fu, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs8Hz2sPNgbCO_10datafusion9execution13session_state22SessionContextProviderECs2VbMhdeEr66_16delta_benchmarks.exit.i.i.i ], [ %i.gt, %.thread49.i.i ] ; 4 uses
  %7 = phi ptr [ %i.fv, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs8Hz2sPNgbCO_10datafusion9execution13session_state22SessionContextProviderECs2VbMhdeEr66_16delta_benchmarks.exit.i.i.i ], [ %i.gu, %.thread49.i.i ]
  %8 = phi ptr [ %i.fw, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtNtCs8Hz2sPNgbCO_10datafusion9execution13session_state22SessionContextProviderECs2VbMhdeEr66_16delta_benchmarks.exit.i.i.i ], [ %i.gv, %.thread49.i.i ]
  %.sroa.024.0.copyload25.pre.i.i = load i64, ptr %i.bq, align 16, !noalias !17974 ; 3 uses
  %.sroa.826.0..sroa_idx27.i.i = getelementptr inbounds nuw i8, ptr %i.bq, i64 8
  %.sroa.826.i.sroa.0.0.copyload95.i = load i64, ptr %.sroa.826.0..sroa_idx27.i.i, align 8, !noalias !17974 ; 2 uses
...
bb.ct:                                            ; preds = %bb.cl, %.thread.i.i
  %i.qg = phi ptr [ %i.hi, %.thread.i.i ], [ %4, %bb.cl ]
  %i.qh = phi ptr [ %i.hk, %.thread.i.i ], [ %6, %bb.cl ]
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.826.i.sroa.8.i.a)
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.826.i.sroa.9.i)
...
begin_hunk_12_@_RNCNvMs3_NtNtCs8Hz2sPNgbCO_10datafusion9execution7contextNtB7_14SessionContext3sql0Cs2VbMhdeEr66_16delta_benchmarks:bb.a
  ...
  %.sroa.433.i.sroa.0.0.i = phi i64 [ %.sroa.8.i.sroa.0.0.copyload.i, %bb.r ], [ %.sroa.826.i.sroa.0.0.copyload95.i, %bb.cq ], [ %.sroa.826.i.sroa.0.0.copyload95.i, %bb.cp ] ; 2 uses
  %.sroa.032.1.i.i = phi i64 [ 36, %bb.r ], [ 36, %bb.cq ], [ %.sroa.024.0.copyload25.pre.i.i, %bb.cp ] ; 2 uses
