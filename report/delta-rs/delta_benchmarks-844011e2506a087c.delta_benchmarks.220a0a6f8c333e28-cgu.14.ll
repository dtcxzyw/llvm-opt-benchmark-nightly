...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeTbINtNtB4_6option6OptionINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDNtNtCsanCXJAiNsO_18datafusion_catalog7catalog15CatalogProviderEL_EEEECs2VbMhdeEr66_16delta_benchmarks.exit65.i: ; preds = %bb.aw, %bb.aa, %bb.z, %bb.y
  %.sroa.01.8.i = phi i8 [ %.sroa.01.1.i, %bb.aw ], [ %.sroa.01.2.i, %bb.aa ], [ %.sroa.01.2.i, %bb.y ], [ %.sroa.01.2.i, %bb.z ]
  %.pn30.i = phi { ptr, i32 } [ %i.cl, %bb.aw ], [ %.pn28.i, %bb.aa ], [ %.pn28.i, %bb.y ], [ %.pn28.i, %bb.z ] ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.l), !noalias !20682
  %3 = trunc nuw i8 %.sroa.01.8.i to i1
  br i1 %3, label %.thread.i, label %.body82.i
...
bb.u:                                             ; preds = %bb.at, %bb.ab, %bb.t
  %.sroa.01.1.i = phi i8 [ 1, %bb.ab ], [ 0, %bb.at ], [ 1, %bb.t ] ; 2 uses
...
bb.y:                                             ; preds = %bb.av, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcNtNtNtCsanCXJAiNsO_18datafusion_catalog6memory7catalog21MemoryCatalogProviderEECs2VbMhdeEr66_16delta_benchmarks.exit.i, %.body60.i
  %.sroa.01.2.i = phi i8 [ 1, %bb.av ], [ %.sroa.01.7.i, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcNtNtNtCsanCXJAiNsO_18datafusion_catalog6memory7catalog21MemoryCatalogProviderEECs2VbMhdeEr66_16delta_benchmarks.exit.i ], [ 1, %.body60.i ] ; 3 uses
  %.pn28.i = phi { ptr, i32 } [ %i.ck, %bb.av ], [ %.pn25.pn.i, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtCs6Po7BT7Nknu_5alloc4sync3ArcNtNtNtCsanCXJAiNsO_18datafusion_catalog6memory7catalog21MemoryCatalogProviderEECs2VbMhdeEr66_16delta_benchmarks.exit.i ], [ %.pn14.i, %.body60.i ] ; 3 uses
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeTbINtNtB4_6option6OptionINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDNtNtCsanCXJAiNsO_18datafusion_catalog7catalog15CatalogProviderEL_EEEECs2VbMhdeEr66_16delta_benchmarks.exit.i: ; preds = %bb.w, %bb.v, %bb.u
  call void @llvm.lifetime.end.p0(ptr nonnull %i.l), !noalias !20682
  %4 = trunc nuw i8 %.sroa.01.1.i to i1
  br i1 %4, label %bb.ay, label %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6Po7BT7Nknu_5alloc6string6StringECs2VbMhdeEr66_16delta_benchmarks.exit84.i
...
.body82.i:                                        ; preds = %.thread.i, %bb.ba, %bb.az, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeTbINtNtB4_6option6OptionINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDNtNtCsanCXJAiNsO_18datafusion_catalog7catalog15CatalogProviderEL_EEEECs2VbMhdeEr66_16delta_benchmarks.exit65.i
  %.pn33.i = phi { ptr, i32 } [ %.pn30.i, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeTbINtNtB4_6option6OptionINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDNtNtCsanCXJAiNsO_18datafusion_catalog7catalog15CatalogProviderEL_EEEECs2VbMhdeEr66_16delta_benchmarks.exit65.i ], [ %.pn30.pn10.i, %.thread.i ], [ %i.cq, %bb.az ], [ %i.cq, %bb.ba ] ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.m), !noalias !20682
...
.thread.i:                                        ; preds = %bb.c, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeTbINtNtB4_6option6OptionINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDNtNtCsanCXJAiNsO_18datafusion_catalog7catalog15CatalogProviderEL_EEEECs2VbMhdeEr66_16delta_benchmarks.exit65.i
  %.pn30.pn10.i = phi { ptr, i32 } [ %.pn30.i, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeTbINtNtB4_6option6OptionINtNtCs6Po7BT7Nknu_5alloc4sync3ArcDNtNtCsanCXJAiNsO_18datafusion_catalog7catalog15CatalogProviderEL_EEEECs2VbMhdeEr66_16delta_benchmarks.exit65.i ], [ %i.x, %bb.c ]
