...
bb.b:                                             ; preds = %bb.a
  ...
  call void @_RNvXs8_NtCs6Po7BT7Nknu_5alloc5sliceINtNtB7_3vec3VecxEINtNtNtNtCsbvkFyIu7lgC_4core5slice4sort6stable8BufGuardxE13with_capacityCs14kWLkQVSKO_14deltalake_core(ptr noalias noundef nonnull sret([24 x i8]) align 8 captures(none) dereferenceable(24) %3, i64 noundef %.sroa.0.0.i8)
