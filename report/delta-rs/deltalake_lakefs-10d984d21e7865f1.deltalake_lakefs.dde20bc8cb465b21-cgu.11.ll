...
bb.cc:                                            ; preds = %bb.ca
  ...
  %i.ft = load i8, ptr %i.r, align 8, !range !11, !noalias !535, !noundef !3
...
.thread111:                                       ; preds = %bb.cd
  %.sroa.0.0.copyload120 = load i8, ptr %i.s, align 8
  %.sroa.18.0..sroa_idx123 = getelementptr inbounds nuw i8, ptr %i.s, i64 1
  %.sroa.18.0.copyload124 = load i8, ptr %.sroa.18.0..sroa_idx123, align 1
  %.sroa.20.0..sroa_idx126 = getelementptr inbounds nuw i8, ptr %i.s, i64 2
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 2 dereferenceable(6) %.sroa.20, ptr noundef nonnull align 2 dereferenceable(6) %.sroa.20.0..sroa_idx126, i64 6, i1 false)
  %.sroa.20127.0..sroa_idx130 = getelementptr inbounds nuw i8, ptr %i.s, i64 8
  %.sroa.20127.0.copyload131 = load i64, ptr %.sroa.20127.0..sroa_idx130, align 8
  %.sroa.29.0..sroa_idx134 = getelementptr inbounds nuw i8, ptr %i.s, i64 16
  %.sroa.29.0.copyload135 = load i64, ptr %.sroa.29.0..sroa_idx134, align 8
  %.sroa.33.0..sroa_idx138 = getelementptr inbounds nuw i8, ptr %i.s, i64 24
  %.sroa.33.0.copyload139 = load i64, ptr %.sroa.33.0..sroa_idx138, align 8
...
begin_hunk_5_@_RINvXNtNtCseqDwI8vvjGQ_10serde_json5value2deNtB5_5ValueNtNtCs1gOyXocuPRE_10serde_core2de11Deserialize11deserializeQINtNtB7_2de12DeserializerNtNtB7_4read9SliceReadEECsj34PGqTgg0L_16deltalake_lakefs:bb.a
  ...
  %.sroa.0.3 = phi i8 [ 6, %bb.ce ], [ 6, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCseqDwI8vvjGQ_10serde_json5error5ErrorECsj34PGqTgg0L_16deltalake_lakefs.exit ], [ %.sroa.0.0.copyload120, %.thread111 ], [ 6, %bb.cf ]
