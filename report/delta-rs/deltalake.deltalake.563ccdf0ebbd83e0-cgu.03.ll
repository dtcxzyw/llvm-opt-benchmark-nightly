...
bb.i:                                             ; preds = %bb.g
  ...
  %i.y = load ptr, ptr %i.x, align 8, !noalias !7102, !nonnull !11, !noundef !11 ; 4 uses
...
bb.j:                                             ; preds = %bb.i
  %i.ab = load i8, ptr %i.y, align 1, !alias.scope !7105, !noalias !7108, !noundef !11
  switch i8 %i.ab, label %thread-pre-split.i.i.i [
...
thread-pre-split.i.i.i:                           ; preds = %bb.k, %bb.j
  %.sroa.0.270.i.i.i.ph = phi ptr [ %i.y, %bb.j ], [ %.sroa.0.0.i.i.i, %bb.k ]
  %.sroa.15.269.i.i.i.ph = phi i64 [ 1, %bb.j ], [ %.sroa.15.0.i.i.i, %bb.k ]
...
bb.k:                                             ; preds = %bb.i
  ...
  %.sroa.15.0.i.i.i = add nsw i64 %i.aa, %i.ac    ; 3 uses
  ...
  br i1 %i.ad, label %thread-pre-split.i.i.i, label %.preheader56.i.i.i.preheader
...
.lr.ph.i.i.i:                                     ; preds = %thread-pre-split.i.i.i, %bb.m
  %.sroa.0.269.i.i.i = phi ptr [ %i.aw, %bb.m ], [ %.sroa.0.270.i.i.i.ph, %thread-pre-split.i.i.i ] ; 2 uses
  %.sroa.15.268.i.i.i = phi i64 [ %i.av, %bb.m ], [ %.sroa.15.269.i.i.i.ph, %thread-pre-split.i.i.i ]
  %.sroa.042.267.i.i.i = phi i64 [ %i.ay, %bb.m ], [ 0, %thread-pre-split.i.i.i ]
...
_RNvMsv_NtCsbvkFyIu7lgC_4core3numj16from_ascii_radix.exit.i.i: ; preds = %bb.l, %.preheader56.i.i.i.preheader, %.preheader56.i.i.i, %bb.m, %.lr.ph.i.i.i, %bb.j, %bb.j, %bb.i, %bb.h
  %.sroa.0.1.i.i = phi i64 [ 2097152, %bb.h ], [ 2097152, %bb.j ], [ 2097152, %bb.j ], [ 2097152, %bb.i ], [ %i.ay, %bb.m ], [ 2097152, %.lr.ph.i.i.i ], [ 2097152, %bb.l ], [ 2097152, %.preheader56.i.i.i.preheader ], [ %i.ao, %.preheader56.i.i.i ]
