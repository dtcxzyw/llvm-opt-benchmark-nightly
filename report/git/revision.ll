...
bb.c:                                             ; preds = %bb.b
  %i.o = load ptr, ptr %i.c, align 8, !tbaa !104
...
bb.e:                                             ; preds = %bb.c
  ...
  %i.t = load i32, ptr %i.k, align 4, !tbaa !52
  ...
  %.pre = load i32, ptr %i.a, align 4, !tbaa !156
  br label %bb.f
...
bb.f:                                             ; preds = %bb.b, %bb.e
  ...
  br i1 %i.x, label %bb.b, label %._crit_edge, !llvm.loop !277
...
bb.h:                                             ; preds = %bb.g, %._crit_edge
  ...
  %.val = load ptr, ptr %i.aa, align 8, !tbaa !279 ; 4 uses
  %.not.i = icmp eq ptr %.val, null
  br i1 %.not.i, label %add_resolve_undo_to_pending.exit, label %bb.i

bb.i:                                             ; preds = %bb.h
  %i.ab = load ptr, ptr %.val, align 8, !tbaa !280 ; 2 uses
...
.lr.ph.i:                                         ; preds = %bb.i
  ...
  %i.ae = load i64, ptr %i.ac, align 8, !tbaa !281
  %.not36 = icmp eq i64 %i.ae, 0
  br i1 %.not36, label %add_resolve_undo_to_pending.exit, label %.lr.ph25

.lr.ph25:                                         ; preds = %.lr.ph.i, %.loopexit.i
  %.0273.i24 = phi ptr [ %i.bo, %.loopexit.i ], [ %i.ab, %.lr.ph.i ] ; 3 uses
  %i.af = load ptr, ptr %.0273.i24, align 8, !tbaa !108 ; 3 uses
  %i.ag = getelementptr inbounds nuw i8, ptr %.0273.i24, i64 8
  %i.ah = load ptr, ptr %i.ag, align 8, !tbaa !282 ; 8 uses
...
bb.k:                                             ; preds = %bb.j
  %i.ao = load i32, ptr @git_gettext_enabled, align 4, !tbaa !52
...
bb.m:                                             ; preds = %bb.j
  %i.ar = load i32, ptr %i.ah, align 4, !tbaa !52
...
bb.o:                                             ; preds = %bb.n
  %i.aw = load ptr, ptr %i.ad, align 8, !tbaa !104
...
bb.p:                                             ; preds = %bb.o
  %i.az = load i32, ptr %i.as, align 4, !tbaa !52
...
bb.q:                                             ; preds = %bb.o
  %i.ba = load i32, ptr @git_gettext_enabled, align 4, !tbaa !52
...
bb.t:                                             ; preds = %bb.s
  %i.bh = load ptr, ptr %i.ad, align 8, !tbaa !104
...
bb.u:                                             ; preds = %bb.t
  %i.bk = load i32, ptr %i.bd, align 4, !tbaa !52
...
bb.v:                                             ; preds = %bb.t
  %i.bl = load i32, ptr @git_gettext_enabled, align 4, !tbaa !52
...
.loopexit.i:                                      ; preds = %_.exit.2.i, %bb.u, %bb.s, %.lr.ph25
  %i.bo = getelementptr inbounds nuw i8, ptr %.0273.i24, i64 16 ; 2 uses
  %i.bp = load ptr, ptr %.val, align 8, !tbaa !280
  %i.bq = load i64, ptr %i.ac, align 8, !tbaa !281
...
bb.a:
  ...
  %i.a = load i32, ptr @default_abbrev, align 4, !tbaa !52
  store ptr null, ptr %1, align 8
  %.sroa.4.0..sroa_idx = getelementptr inbounds nuw i8, ptr %1, i64 8
  store ptr @compare_commits_by_commit_date, ptr %.sroa.4.0..sroa_idx, align 8
  %.sroa.51.0..sroa_idx = getelementptr inbounds nuw i8, ptr %1, i64 328
  store i32 0, ptr %.sroa.51.0..sroa_idx, align 8
  %.sroa.6.0..sroa_idx = getelementptr inbounds nuw i8, ptr %1, i64 332
  ...
  store ptr %0, ptr %i.c, align 8, !tbaa !283
  %i.d = getelementptr inbounds nuw i8, ptr %1, i64 2632
  store ptr @file_add_remove, ptr %i.d, align 8, !tbaa !284
  %i.e = getelementptr inbounds nuw i8, ptr %1, i64 2624
  store ptr @file_change, ptr %i.e, align 8, !tbaa !285
  ...
  store i32 1, ptr %i.i, align 8, !tbaa !287
  %i.j = load ptr, ptr %i.b, align 8, !tbaa !104
...
bb.a:
  ...
  %i.e = load i32, ptr @tree_difference, align 4, !tbaa !52
  %i.f = or i32 %i.e, %i.b                        ; 2 uses
  store i32 %i.f, ptr @tree_difference, align 4, !tbaa !52
...
bb.b:                                             ; preds = %bb.a
  ...
  store i32 1, ptr %i.l, align 8, !tbaa !161
  br label %bb.c
...
bb.a:
  store i32 3, ptr @tree_difference, align 4, !tbaa !52
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 136
  store i32 1, ptr %i.a, align 8, !tbaa !161
  ret void
}
...
sub_0.i:                                          ; preds = %bb.a
  ...
  %.not122.i = icmp eq i8 %i.f, 46
  br i1 %.not122.i, label %sub_1.i, label %.tail.thread.i

sub_1.i:                                          ; preds = %sub_0.i
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 1
  %i.h = load i8, ptr %i.g, align 1
  %.not123.i = icmp eq i8 %i.h, 46
  br i1 %.not123.i, label %.tail.i, label %.tail.thread.i
...
bb.b:                                             ; preds = %.tail.thread.i
  ...
  %i.r = load i8, ptr %i.q, align 1, !tbaa !114
