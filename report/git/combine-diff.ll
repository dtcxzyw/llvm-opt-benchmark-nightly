...
begin_hunk_0_@diff_tree_combined:bb.a
  ...
  %i.ee = load i32, ptr getelementptr inbounds nuw (i8, ptr @diff_queued_diff, i64 12), align 4, !tbaa !257
  %i.ef = sext i32 %i.ee to i64
  %i.eg = icmp slt i64 %indvars.iv.next112.i.i, %i.ef
  br i1 %i.eg, label %.lr.ph107.split.i.i, label %intersect_paths.exit.i, !llvm.loop !219
...
thread-pre-split.i.i:                             ; preds = %bb.ag, %bb.ac, %._crit_edge.i.loopexit.i
  ...
  %.pr.i.i = load ptr, ptr %.2.ph.i.i, align 8, !tbaa !127 ; 2 uses
...
.lr.ph104.i.i:                                    ; preds = %.preheader98.i.i, %thread-pre-split.i.i
  ...
  %i.ei = load i32, ptr getelementptr inbounds nuw (i8, ptr @diff_queued_diff, i64 12), align 4, !tbaa !257
...
._crit_edge.i.i.i:                                ; preds = %bb.z
  ...
  %i.fc = load ptr, ptr %i.fb, align 8, !tbaa !268 ; 2 uses
...
compare_paths.exit.thread.i.i:                    ; preds = %compare_paths.exit.i.i, %.lr.ph104.i.i
  %i.fi = load ptr, ptr %i.eh, align 8, !tbaa !127
  store ptr %i.fi, ptr %.2102.i.i, align 8, !tbaa !127
  br label %.lr.ph.i.i
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i, %compare_paths.exit.thread.i.i
  ...
  br i1 %exitcond.not.i.i, label %._crit_edge.i.loopexit.i, label %.lr.ph.i.i, !llvm.loop !220
...
bb.ad:                                            ; preds = %bb.ab
  ...
  %i.fq = load ptr, ptr @diff_queued_diff, align 8, !tbaa !258
  %i.fr = getelementptr inbounds [8 x i8], ptr %i.fq, i64 %i.ek
  %i.fs = load ptr, ptr %i.fr, align 8, !tbaa !260
  %i.ft = load ptr, ptr %i.fs, align 8, !tbaa !270 ; 2 uses
  ...
  %i.fv = load i32, ptr %i.fu, align 4, !tbaa !128
  %i.fw = getelementptr inbounds nuw i8, ptr %i.fo, i64 40
  store i32 %i.fv, ptr %i.fw, align 4, !tbaa !128
  %i.fx = load ptr, ptr @diff_queued_diff, align 8, !tbaa !258
...
._crit_edge170:                                   ; preds = %._crit_edge170.loopexit.unr-lcssa, %.lr.ph169.epil, %._crit_edge166
  ...
  %i.hy = load ptr, ptr %i.hx, align 8, !tbaa !273
  store ptr null, ptr %i.hy, align 8, !tbaa !127
...
bb.aq:                                            ; preds = %._crit_edge, %._crit_edge170
  ...
  %i.ia = load i32, ptr %i.hz, align 8, !tbaa !28 ; 3 uses
...
.lr.ph174:                                        ; preds = %.preheader, %.lr.ph174
  ...
  %i.ic = load ptr, ptr %.2111173, align 8, !tbaa !127 ; 2 uses
...
bb.at:                                            ; preds = %bb.as
  ...
  store ptr %i.ig, ptr %3, align 8, !tbaa !258
  %i.ih = getelementptr inbounds nuw i8, ptr %3, i64 8
  store i32 %i.gy, ptr %i.ih, align 8, !tbaa !274
  %i.ii = getelementptr inbounds nuw i8, ptr %3, i64 12
  store i32 %i.gy, ptr %i.ii, align 4, !tbaa !257
...
st_add.exit.i.us.i:                               ; preds = %.lr.ph.split.i, %._crit_edge.loopexit.i.us.i
  ...
  store ptr %i.ir, ptr %i.ip, align 8, !tbaa !270
  %i.is = getelementptr inbounds nuw i8, ptr %i.ip, i64 8 ; 3 uses
  store ptr %i.iq, ptr %i.is, align 8, !tbaa !265
...
bb.au:                                            ; preds = %bb.au, %st_add.exit.i.us.i
  ...
  %i.iv = load ptr, ptr %i.it, align 8, !tbaa !77
  %i.iw = load ptr, ptr %i.ip, align 8, !tbaa !270
  ...
  store ptr %i.iv, ptr %i.iy, align 8, !tbaa !268
  ...
  store i16 %i.jc, ptr %i.jd, align 8, !tbaa !269
  ...
  %i.jg = load i32, ptr %i.jf, align 4, !tbaa !128
  %i.jh = getelementptr inbounds nuw i8, ptr %i.ix, i64 32
  store i32 %i.jg, ptr %i.jh, align 8, !tbaa !128
  ...
  %i.jo = load ptr, ptr %i.ip, align 8, !tbaa !270
  ...
  %i.jw = load ptr, ptr %i.ip, align 8, !tbaa !270
...
._crit_edge.loopexit.i.us.i:                      ; preds = %bb.au
  %.pre.i.us.i = load ptr, ptr %i.ip, align 8, !tbaa !270
  ...
  %i.kf = load ptr, ptr %i.it, align 8, !tbaa !77
  %i.kg = load ptr, ptr %i.is, align 8, !tbaa !265 ; 4 uses
  %i.kh = getelementptr inbounds nuw i8, ptr %i.kg, i64 40
  store ptr %i.kf, ptr %i.kh, align 8, !tbaa !268
  %i.ki = getelementptr inbounds nuw i8, ptr %.01517.us20.i, i64 16
  %i.kj = load i32, ptr %i.ki, align 8, !tbaa !74
  %i.kk = trunc i32 %i.kj to i16
  %i.kl = getelementptr inbounds nuw i8, ptr %i.kg, i64 80
  store i16 %i.kk, ptr %i.kl, align 8, !tbaa !269
  ...
  %i.ko = load i32, ptr %i.kn, align 4, !tbaa !128
  %i.kp = getelementptr inbounds nuw i8, ptr %i.kg, i64 32
  store i32 %i.ko, ptr %i.kp, align 8, !tbaa !128
  ...
  %i.kw = load ptr, ptr %i.is, align 8, !tbaa !265
  ...
  store ptr %i.ip, ptr %i.ld, align 8, !tbaa !260
  %i.le = load ptr, ptr %.01517.us20.i, align 8, !tbaa !127 ; 2 uses
...
st_add.exit.i.i:                                  ; preds = %.lr.ph.split.i, %st_add.exit.i.i
  ...
  store ptr %i.lh, ptr %i.lf, align 8, !tbaa !270
  %i.li = getelementptr inbounds nuw i8, ptr %i.lf, i64 8 ; 3 uses
  store ptr %i.lg, ptr %i.li, align 8, !tbaa !265
  ...
  %i.lo = load ptr, ptr %i.ln, align 8, !tbaa !77
  %i.lp = load ptr, ptr %i.li, align 8, !tbaa !265 ; 4 uses
  %i.lq = getelementptr inbounds nuw i8, ptr %i.lp, i64 40
  store ptr %i.lo, ptr %i.lq, align 8, !tbaa !268
  %i.lr = getelementptr inbounds nuw i8, ptr %.01517.i, i64 16
  %i.ls = load i32, ptr %i.lr, align 8, !tbaa !74
  %i.lt = trunc i32 %i.ls to i16
  %i.lu = getelementptr inbounds nuw i8, ptr %i.lp, i64 80
  store i16 %i.lt, ptr %i.lu, align 8, !tbaa !269
  ...
  store i32 %i.lx, ptr %i.ly, align 8, !tbaa !128
