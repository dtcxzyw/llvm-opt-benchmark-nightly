...
bb.af:                                            ; preds = %bb.ae
  ...
  %i.dy = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %.0104141, ptr noundef nonnull dereferenceable(1) %i.dx) #24
...
bb.ah:                                            ; preds = %bb.p, %bb.a, %_.exit133, %_.exit130, %_.exit
  %.0107 = phi ptr [ null, %bb.a ], [ null, %_.exit ], [ null, %_.exit130 ], [ %i.v, %_.exit133 ], [ %i.v, %bb.p ] ; 2 uses
  %.0106 = phi i64 [ undef, %bb.a ], [ undef, %_.exit ], [ %i.k, %_.exit130 ], [ %i.k, %_.exit133 ], [ %i.k, %bb.p ]
  %.0103 = phi ptr [ null, %bb.a ], [ null, %_.exit ], [ null, %_.exit130 ], [ null, %_.exit133 ], [ %i.bz, %bb.p ]
  %.0102 = phi ptr [ null, %bb.a ], [ null, %_.exit ], [ null, %_.exit130 ], [ %i.x, %_.exit133 ], [ %i.x, %bb.p ]
  tail call void @free(ptr noundef %.0102) #21
  tail call void @free_chunkfile(ptr noundef %.0103) #21
  %.not127 = icmp eq ptr %.0107, null
  br i1 %.not127, label %bb.aj, label %bb.ai

bb.ai:                                            ; preds = %bb.ah
  %i.ej = tail call i32 @munmap(ptr noundef nonnull %.0107, i64 noundef %.0106) #21 ; 0 uses
  br label %bb.aj
...
bb.al:                                            ; preds = %bb.aj, %bb.ak, %._crit_edge
  %.0 = phi ptr [ %i.x, %._crit_edge ], [ null, %bb.ak ], [ null, %bb.aj ]
...
.lr.ph55.split.us:                                ; preds = %.lr.ph55, %bb.h
  %.03453.us = phi i32 [ %spec.select50.us, %bb.h ], [ 0, %.lr.ph55 ] ; 3 uses
  %.03752.us = phi i32 [ %spec.select.us, %bb.h ], [ %i.b, %.lr.ph55 ] ; 2 uses
  %i.u = sub nuw i32 %.03752.us, %.03453.us
  %i.v = lshr i32 %i.u, 1
  %i.w = add i32 %i.v, %.03453.us                 ; 3 uses
  %i.x = zext i32 %i.w to i64
  %i.y = getelementptr inbounds nuw [8 x i8], ptr %i.t, i64 %i.x
  %.033.us = load ptr, ptr %i.y, align 8, !tbaa !99 ; 3 uses
  %i.z = load i8, ptr %.033.us, align 1, !tbaa !81 ; 2 uses
...
.lr.ph.i.us:                                      ; preds = %.lr.ph55.split.us, %bb.f
  ...
  %.016.i.us = phi ptr [ %i.ad, %bb.f ], [ %.033.us, %.lr.ph55.split.us ] ; 2 uses
...
.critedge.i.us:                                   ; preds = %.lr.ph.i.us, %bb.f, %.lr.ph55.split.us
  ...
  %.0.lcssa.i.us = phi ptr [ %.033.us, %.lr.ph55.split.us ], [ %.016.i.us, %.lr.ph.i.us ], [ %i.ad, %bb.f ] ; 2 uses
...
bb.h:                                             ; preds = %cmp_idx_or_pack_name.exit.us
  ...
  %i.ak = add i32 %i.w, 1
  %spec.select.us = select i1 %i.aj, i32 %.03752.us, i32 %i.w ; 2 uses
  %spec.select50.us = select i1 %i.aj, i32 %i.ak, i32 %.03453.us ; 2 uses
  %i.al = icmp ult i32 %spec.select50.us, %spec.select.us
  br i1 %i.al, label %.lr.ph55.split.us, label %.thread

.lr.ph55.split:                                   ; preds = %.lr.ph55, %bb.k
  %.03453 = phi i32 [ %spec.select50, %bb.k ], [ 0, %.lr.ph55 ] ; 3 uses
  %.03752 = phi i32 [ %spec.select, %bb.k ], [ %i.b, %.lr.ph55 ] ; 2 uses
  %i.am = sub nuw i32 %.03752, %.03453
  %i.an = lshr i32 %i.am, 1
  %i.ao = add i32 %i.an, %.03453                  ; 3 uses
  ...
  %.033 = load ptr, ptr %i.as, align 8, !tbaa !99 ; 3 uses
  %i.at = load i8, ptr %.033, align 1, !tbaa !81  ; 2 uses
...
.lr.ph.i:                                         ; preds = %.lr.ph55.split, %bb.i
  ...
  %.016.i = phi ptr [ %i.ax, %bb.i ], [ %.033, %.lr.ph55.split ] ; 2 uses
...
.critedge.i:                                      ; preds = %bb.i, %.lr.ph.i, %.lr.ph55.split
  ...
  %.0.lcssa.i = phi ptr [ %.033, %.lr.ph55.split ], [ %.016.i, %.lr.ph.i ], [ %i.ax, %bb.i ] ; 2 uses
...
bb.k:                                             ; preds = %cmp_idx_or_pack_name.exit
  ...
  %i.be = add i32 %i.ao, 1
  %spec.select = select i1 %i.bd, i32 %.03752, i32 %i.ao ; 2 uses
  %spec.select50 = select i1 %i.bd, i32 %i.be, i32 %.03453 ; 2 uses
  %i.bf = icmp ult i32 %spec.select50, %spec.select
...
bb.bs:                                            ; preds = %stop_progress.exit199, %_.exit124
  %.096 = phi ptr [ null, %_.exit124 ], [ %i.fc, %stop_progress.exit199 ]
  call void @free(ptr noundef %.096) #21
