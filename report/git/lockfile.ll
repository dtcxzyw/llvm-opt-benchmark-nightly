Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/git/original/lockfile?download=true
...
bb.e:                                             ; preds = %bb.f, %.lr.ph.i
  ...
  %.02746.i = phi i32 [ 1, %.lr.ph.i ], [ %.130.i, %bb.f ] ; 2 uses
...
lock_file_timeout.exit.thread13:                  ; preds = %bb.e, %lock_file_timeout.exit
  %.235.i15 = phi i32 [ %i.x, %lock_file_timeout.exit ], [ -1, %bb.e ] ; 2 uses
  %i.z = and i32 %2, 1
...
lock_file_timeout.exit.thread:                    ; preds = %bb.f, %bb.d, %bb.h, %bb.i, %lock_file_timeout.exit
  %.235.i12 = phi i32 [ %i.x, %lock_file_timeout.exit ], [ %.235.i15, %bb.h ], [ %.235.i15, %bb.i ], [ %i.d, %bb.d ], [ %i.v, %bb.f ]
  ret i32 %.235.i12
}
