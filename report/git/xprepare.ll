...
@.str = private unnamed_addr constant [17 x i8] c"xdiff/xprepare.c\00", align 1
@.str.1 = private unnamed_addr constant [25 x i8] c"Illegal state for action\00", align 1
@.str.2 = private unnamed_addr constant [32 x i8] c"Illegal value for action[i - r]\00", align 1
@.str.3 = private unnamed_addr constant [32 x i8] c"Illegal value for action[i + r]\00", align 1

; Function Attrs: mustprogress nounwind willreturn memory(readwrite, target_mem: none) uwtable
define dso_local void @xdl_free_env(ptr nofree noundef readonly captures(none) %0) local_unnamed_addr #0 {
bb.a:
  ...
  tail call void @free(ptr noundef %i.g) #8
...
define dso_local range(i32 -1, 1) i32 @xdl_prepare_env(ptr noundef %0, ptr noundef %1, ptr nofree noundef readonly captures(none) %2, ptr nofree noundef captures(none) %3) local_unnamed_addr #1 {
bb.a:
  %4 = alloca %struct.s_xdlclassifier, align 8    ; 14 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #8
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(112) %4, i8 0, i64 104, i1 false)
  %i.a = load i64, ptr %2, align 8, !tbaa !25
  %i.b = and i64 %i.a, 49153
  %i.c = icmp eq i64 %i.b, 32768
  %i.d = select i1 %i.c, i64 20, i64 256          ; 2 uses
  %i.e = tail call i64 @xdl_guess_lines(ptr noundef %0, i64 noundef %i.d) #8 ; 2 uses
  %i.f = add nsw i64 %i.e, 1
  %i.g = tail call i64 @xdl_guess_lines(ptr noundef %1, i64 noundef %i.d) #8
  %i.h = add nsw i64 %i.g, 1                      ; 2 uses
  %i.i = add i64 %i.e, 2
  %i.j = add i64 %i.i, %i.h                       ; 5 uses
  %i.k = load i64, ptr %2, align 8, !tbaa !25
  %i.l = getelementptr inbounds nuw i8, ptr %4, i64 104 ; 2 uses
  store i64 %i.k, ptr %i.l, align 8, !tbaa !30
  %i.m = trunc i64 %i.j to i32
  %i.n = tail call i32 @xdl_hashbits(i32 noundef %i.m) #8 ; 2 uses
  store i32 %i.n, ptr %4, align 8, !tbaa !31
  ...
  %i.u = call i32 @xdl_cha_init(ptr noundef nonnull %i.r, i64 noundef 56, i64 noundef %i.t) #8
  %i.v = icmp slt i32 %i.u, 0
  br i1 %i.v, label %xdl_init_classifier.exit.thread, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.w = load i64, ptr %i.q, align 8, !tbaa !55
  %i.x = call ptr @xcalloc(i64 noundef %i.w, i64 noundef 8) #8 ; 3 uses
  %i.y = getelementptr inbounds nuw i8, ptr %4, i64 16 ; 6 uses
  store ptr %i.x, ptr %i.y, align 8, !tbaa !32
  %.not.i = icmp eq ptr %i.x, null
  br i1 %.not.i, label %xdl_init_classifier.exit.thread.sink.split, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.z = getelementptr inbounds nuw i8, ptr %4, i64 88
  store i64 %i.j, ptr %i.z, align 8, !tbaa !33
  %i.aa = icmp ult i64 %i.j, 2305843009213693952
  br i1 %i.aa, label %bb.d, label %.thread.i

.thread.i:                                        ; preds = %bb.c
  %i.ab = getelementptr inbounds nuw i8, ptr %4, i64 80
  store ptr null, ptr %i.ab, align 8, !tbaa !34
  br label %xdl_init_classifier.exit.thread.sink.split.sink.split

bb.d:                                             ; preds = %bb.c
  %i.ac = shl nuw i64 %i.j, 3
  %i.ad = call ptr @xmalloc(i64 noundef %i.ac) #8 ; 2 uses
  %i.ae = getelementptr inbounds nuw i8, ptr %4, i64 80 ; 7 uses
  store ptr %i.ad, ptr %i.ae, align 8, !tbaa !34
  %.not20.i = icmp eq ptr %i.ad, null
  br i1 %.not20.i, label %._crit_edge.i, label %bb.e

._crit_edge.i:                                    ; preds = %bb.d
  %.pre.i = load ptr, ptr %i.y, align 8, !tbaa !32
  br label %xdl_init_classifier.exit.thread.sink.split.sink.split

bb.e:                                             ; preds = %bb.d
  %i.af = getelementptr inbounds nuw i8, ptr %4, i64 96
  store i64 0, ptr %i.af, align 8, !tbaa !35
  %i.ag = call fastcc i32 @xdl_prepare_ctx(i32 noundef 1, ptr noundef %0, i64 noundef %i.f, ptr noundef nonnull %2, ptr noundef %4, ptr noundef %3)
  %i.ah = icmp slt i32 %i.ag, 0
  br i1 %i.ah, label %bb.f, label %bb.g

bb.f:                                             ; preds = %bb.e
  %i.ai = load ptr, ptr %i.ae, align 8, !tbaa !34
  call void @free(ptr noundef %i.ai) #8
