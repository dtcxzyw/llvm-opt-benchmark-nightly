...
bb.fg:                                            ; preds = %bb.fe
  ...
  %i.vs = select i1 %.not266.i, i32 %i.vr, i32 0
  %.1218.i = add i32 %i.vs, %.0217347.i           ; 3 uses
  %i.vt = select i1 %.not266.i, i32 %i.vq, i32 0
  %.1215.i = add i32 %i.vt, %.0214348.i           ; 3 uses
  %i.vu = icmp samesign ult i64 %indvars.iv360.i, %i.ra
  br i1 %i.vu, label %bb.fj, label %bb.fh

bb.fh:                                            ; preds = %bb.fg
  %.not267.i = icmp eq i32 %.0233345.i, 0
...
bb.fj:                                            ; preds = %bb.fi, %bb.fh, %bb.fg, %bb.ff
  ...
  %.1234.i = phi i32 [ %.0233345.i, %bb.ff ], [ %.0233345.i, %bb.fg ], [ 1, %bb.fi ], [ 1, %bb.fh ]
  %.1228.i = phi i32 [ %i.vo, %bb.ff ], [ %.0227346.i, %bb.fg ], [ %.0227346.i, %bb.fi ], [ %.0227346.i, %bb.fh ] ; 2 uses
  %.2219.i = phi i32 [ %.0217347.i, %bb.ff ], [ %.1218.i, %bb.fg ], [ %.1218.i, %bb.fi ], [ %.1218.i, %bb.fh ] ; 2 uses
  %.2216.i = phi i32 [ %.0214348.i, %bb.ff ], [ %.1215.i, %bb.fg ], [ %.1215.i, %bb.fi ], [ %.1215.i, %bb.fh ] ; 2 uses
...
._crit_edge.i:                                    ; preds = %bb.fj, %.preheader.i
  %.0227.lcssa.i = phi i32 [ %i.mh, %.preheader.i ], [ %.1228.i, %bb.fj ]
  %.0217.lcssa.i = phi i32 [ 0, %.preheader.i ], [ %.2219.i, %bb.fj ]
  %.0214.lcssa.i = phi i32 [ 0, %.preheader.i ], [ %.2216.i, %bb.fj ]
  call fastcc void @print_stat_summary_inserts_deletes(ptr noundef %0, i32 noundef %.0227.lcssa.i, i32 noundef %.0214.lcssa.i, i32 noundef %.0217.lcssa.i)
...
.lr.ph.i128:                                      ; preds = %bb.fq, %.lr.ph.preheader.i
  ...
  %.0253.i = phi i32 [ 0, %.lr.ph.preheader.i ], [ %.1.i, %bb.fq ] ; 3 uses
  %.0262.i = phi i32 [ %.pre300.pre304, %.lr.ph.preheader.i ], [ %.127.i, %bb.fq ] ; 3 uses
  %.0281.i = phi i32 [ 0, %.lr.ph.preheader.i ], [ %.129.i, %bb.fq ] ; 3 uses
...
bb.fp:                                            ; preds = %bb.fo
  %i.ws = add nsw i32 %.0253.i, %i.wg
  %i.wt = add nsw i32 %.0281.i, %i.wj
  br label %bb.fq

bb.fq:                                            ; preds = %bb.fp, %bb.fo, %bb.fn
  %.129.i = phi i32 [ %.0281.i, %bb.fn ], [ %.0281.i, %bb.fo ], [ %i.wt, %bb.fp ] ; 2 uses
  %.127.i = phi i32 [ %i.wq, %bb.fn ], [ %.0262.i, %bb.fo ], [ %.0262.i, %bb.fp ] ; 2 uses
  %.1.i = phi i32 [ %.0253.i, %bb.fn ], [ %.0253.i, %bb.fo ], [ %i.ws, %bb.fp ] ; 2 uses
...
._crit_edge.i126:                                 ; preds = %bb.fq, %.preheader.i125
  %.028.lcssa.i = phi i32 [ 0, %.preheader.i125 ], [ %.129.i, %bb.fq ]
  %.026.lcssa.i = phi i32 [ %.pre300.pre304, %.preheader.i125 ], [ %.127.i, %bb.fq ]
  %.025.lcssa.i = phi i32 [ 0, %.preheader.i125 ], [ %.1.i, %bb.fq ]
  call fastcc void @print_stat_summary_inserts_deletes(ptr noundef %0, i32 noundef %.026.lcssa.i, i32 noundef %.025.lcssa.i, i32 noundef %.028.lcssa.i)
...
show_shortstats.exit.thread:                      ; preds = %bb.fl
  %or.cond3383 = and i1 %i.jp, %i.js
  br i1 %or.cond3383, label %.thread385, label %free_diffstat_info.exit

.thread385:                                       ; preds = %show_shortstats.exit.thread
...
bb.ft:                                            ; preds = %bb.fv, %.lr.ph.i134
  ...
  %.01834.i = phi i64 [ 0, %.lr.ph.i134 ], [ %i.yf, %bb.fv ]
...
bb.fv:                                            ; preds = %st_mult.exit.i, %bb.ft
  ...
  %i.yf = add i64 %.0.i137, %.01834.i             ; 3 uses
...
show_dirstat_by_line.exit:                        ; preds = %.thread385, %bb.fr, %conclude_dirstat.exit.i
  %.pre = phi i32 [ 0, %bb.fr ], [ %.pre.pre, %conclude_dirstat.exit.i ], [ 0, %.thread385 ]
...
bb.ga:                                            ; preds = %bb.cb, %free_diffstat_info.exit
  %.180 = phi i32 [ 1, %free_diffstat_info.exit ], [ %.079, %bb.cb ]
...
bb.gc:                                            ; preds = %bb.hp, %.lr.ph.i148
  ...
  %.04390.i = phi i64 [ 0, %.lr.ph.i148 ], [ %.1.i156, %bb.hp ] ; 2 uses
...
.split.i.i.i:                                     ; preds = %bb.kr
  ...
  %.not56.i.i.i = icmp eq i32 %i.atv, %i.atw
  br i1 %.not56.i.i.i, label %.critedge.i.i52.i, label %.thread46.i.i.i

cmp_in_block_with_wsd.exit.i.i.i:                 ; preds = %bb.kq
  %.not55.i.i.i = icmp eq i32 %i.atp, %i.atr
  br i1 %.not55.i.i.i, label %.critedge.i.i52.i, label %.thread46.i.i.i

.critedge.i.i52.i:                                ; preds = %cmp_in_block_with_wsd.exit.i.i.i, %.split.i.i.i, %cmp_in_block_with_wsd.exit.thread.i.i.i, %bb.kp
  %i.atx = sext i32 %.02649.i.i.i to i64
  ...
  %i.atz = add nsw i32 %.02649.i.i.i, 1
  store ptr %i.atj, ptr %i.aty, align 8, !tbaa !359
  br label %.thread46.i.i.i

.thread46.i.i.i:                                  ; preds = %.critedge.i.i52.i, %cmp_in_block_with_wsd.exit.i.i.i, %.split.i.i.i, %bb.kr, %bb.ko, %bb.kn, %bb.kl
  %.1.i.i50.i = phi i32 [ %i.atz, %.critedge.i.i52.i ], [ %.02649.i.i.i, %cmp_in_block_with_wsd.exit.i.i.i ], [ %.02649.i.i.i, %bb.kn ], [ %.02649.i.i.i, %bb.kr ], [ %.02649.i.i.i, %bb.kl ], [ %.02649.i.i.i, %bb.ko ], [ %.02649.i.i.i, %.split.i.i.i ] ; 3 uses
...
pmb_advance_or_null.exit.i.i:                     ; preds = %.thread46.i.i.i
  %i.aua = icmp eq i32 %.1.i.i50.i, 0
  br i1 %i.aua, label %bb.ks, label %.thread211.i.i

bb.ks:                                            ; preds = %pmb_advance_or_null.exit.i.i
  %.pr.i51.i = load i32, ptr %i.aik, align 8, !tbaa !167
  %i.aub = icmp eq i32 %.pr.i51.i, 1
...
.preheader37.i82.i.i:                             ; preds = %bb.ks, %bb.kk, %.thread175.thread.i.i
  %.253185283302.i.i = phi i32 [ %.051259.i.i, %bb.ks ], [ %.051259.i.i, %bb.kk ], [ %.253.i.i, %.thread175.thread.i.i ] ; 4 uses
  %.259184287301.i.i = phi ptr [ %.057.i.i, %bb.ks ], [ %.057.i.i, %bb.kk ], [ %.259.i.i, %.thread175.thread.i.i ] ; 4 uses
  %.165183288298.i.i = phi i32 [ %.064255.i.i, %bb.ks ], [ %.064255.i.i, %bb.kk ], [ %.165.i.i, %.thread175.thread.i.i ] ; 6 uses
  %.not42.i83.i.i = icmp slt i32 %.165183288298.i.i, 1
...
.lr.ph45.i84.i.i:                                 ; preds = %.preheader37.i82.i.i
  ...
  %i.aue = add nuw i32 %.165183288298.i.i, 1
...
.preheader.i99.i.i.preheader:                     ; preds = %._crit_edge.i95.i.i
  %i.aus = zext nneg i32 %.165183288298.i.i to i64 ; 2 uses
  %xtraiter497 = and i64 %i.aus, 3                ; 3 uses
  %i.aut = icmp ult i32 %.165183288298.i.i, 4
...
.preheader.i99.i.i.preheader.new:                 ; preds = %.preheader.i99.i.i.preheader
  %unroll_iter501 = and i64 %i.aus, 2147483644
  %invariant.gep544 = getelementptr [32 x i8], ptr %i.aud, i64 %i.aqq
...
.preheader.i99.i.i:                               ; preds = %.preheader.i99.i.i, %.preheader.i99.i.i.preheader.new
  ...
  %niter502 = phi i64 [ 0, %.preheader.i99.i.i.preheader.new ], [ %niter502.next.3, %.preheader.i99.i.i ]
  ...
  %gep545 = getelementptr [32 x i8], ptr %invariant.gep544, i64 %indvars.iv.next52.i102.i.i.neg
  %i.auz = getelementptr inbounds nuw i8, ptr %gep545, i64 12 ; 2 uses
  ...
  %niter502.next.3 = add nuw i64 %niter502, 4     ; 2 uses
  %niter502.ncmp.3 = icmp eq i64 %niter502.next.3, %unroll_iter501
  br i1 %niter502.ncmp.3, label %adjust_last_block.exit105.i.i.loopexit.unr-lcssa, label %.preheader.i99.i.i, !llvm.loop !356

adjust_last_block.exit105.i.i.loopexit.unr-lcssa: ; preds = %.preheader.i99.i.i
  %lcmp.mod499.not = icmp eq i64 %xtraiter497, 0
  br i1 %lcmp.mod499.not, label %adjust_last_block.exit105.i.i, label %.preheader.i99.i.i.epil.preheader
...
.preheader.i99.i.i.epil.preheader:                ; preds = %adjust_last_block.exit105.i.i.loopexit.unr-lcssa, %.preheader.i99.i.i.preheader
  ...
  %lcmp.mod500 = icmp ne i64 %xtraiter497, 0
...
.preheader.i99.i.i.epil:                          ; preds = %.preheader.i99.i.i.epil, %.preheader.i99.i.i.epil.preheader
  ...
  %epil.iter498 = phi i64 [ %epil.iter498.next, %.preheader.i99.i.i.epil ], [ 0, %.preheader.i99.i.i.epil.preheader ]
  ...
  %epil.iter498.next = add i64 %epil.iter498, 1   ; 2 uses
  %epil.iter498.cmp.not = icmp eq i64 %epil.iter498.next, %xtraiter497
  br i1 %epil.iter498.cmp.not, label %adjust_last_block.exit105.i.i, label %.preheader.i99.i.i.epil, !llvm.loop !364

adjust_last_block.exit105.i.i:                    ; preds = %adjust_last_block.exit105.i.i.loopexit.unr-lcssa, %.preheader.i99.i.i.epil, %bb.ks
  %.259184287299.i.i = phi ptr [ %.057.i.i, %bb.ks ], [ %.259184287301.i.i, %.preheader.i99.i.i.epil ], [ %.259184287301.i.i, %adjust_last_block.exit105.i.i.loopexit.unr-lcssa ]
  %.165183288297.i.i = phi i32 [ %.064255.i.i, %bb.ks ], [ %.165183288298.i.i, %.preheader.i99.i.i.epil ], [ %.165183288298.i.i, %adjust_last_block.exit105.i.i.loopexit.unr-lcssa ] ; 2 uses
  %.253185285.i.i = phi i32 [ %.051259.i.i, %bb.ks ], [ %.253185283302.i.i, %.preheader.i99.i.i.epil ], [ %.253185283302.i.i, %adjust_last_block.exit105.i.i.loopexit.unr-lcssa ]
  %.226.i104.i.i = phi i32 [ %.064255.i.i, %bb.ks ], [ 0, %.preheader.i99.i.i.epil ], [ 0, %adjust_last_block.exit105.i.i.loopexit.unr-lcssa ] ; 2 uses
  %i.avr = icmp eq i32 %.226.i104.i.i, 0
  %i.avs = icmp sgt i32 %.165183288297.i.i, 1
...
.thread223.i.i:                                   ; preds = %adjust_last_block.exit105.i.i
  %i.avt = sub nsw i32 %.0260.i.i, %.165183288297.i.i
  br label %.thread168.i.i

adjust_last_block.exit105.thread.i.i:             ; preds = %bb.ku, %adjust_last_block.exit105.i.i, %.preheader37.i82.i.i
  %.259184287300.i.i = phi ptr [ %.259184287299.i.i, %adjust_last_block.exit105.i.i ], [ %.259184287301.i.i, %.preheader37.i82.i.i ], [ %.259184287301.i.i, %bb.ku ]
  %.253185286.i.i = phi i32 [ %.253185285.i.i, %adjust_last_block.exit105.i.i ], [ %.253185283302.i.i, %.preheader37.i82.i.i ], [ %.253185283302.i.i, %bb.ku ]
...
bb.kw:                                            ; preds = %bb.la, %adjust_last_block.exit105.thread.i.i
  ...
  %.03141.i.i.i = phi ptr [ %.259184287300.i.i, %adjust_last_block.exit105.thread.i.i ], [ %i.awl, %bb.la ] ; 3 uses
...
bb.lb:                                            ; preds = %bb.la
  ...
  %.pre.i45.i = load i32, ptr %i.aqs, align 4, !tbaa !58 ; 2 uses
  %i.awn = icmp eq i32 %.060256.i.i, %.pre.i45.i
  %or.cond321.i.i = select i1 %.not244.i.i, i1 %i.awn, i1 false
  br i1 %or.cond321.i.i, label %bb.lc, label %.thread211.thread.i.i

bb.lc:                                            ; preds = %bb.lb
  %i.awo = xor i32 %.253185286.i.i, 1
...
.thread211.i.i:                                   ; preds = %bb.lc, %pmb_advance_or_null.exit.i.i
  ...
  %.3152.i.i = phi i32 [ %.1.i.i50.i, %pmb_advance_or_null.exit.i.i ], [ %i.awm, %bb.lc ] ; 3 uses
  %.2147.i.i = phi i32 [ %.0146254.i.i, %pmb_advance_or_null.exit.i.i ], [ %.2.i109.i.i, %bb.lc ] ; 3 uses
  %.266.i.i = phi i32 [ %.064255.i.i, %pmb_advance_or_null.exit.i.i ], [ 0, %bb.lc ]
  %.455.i.i = phi i32 [ %.051259.i.i, %pmb_advance_or_null.exit.i.i ], [ %i.awo, %bb.lc ]
  %i.aws = add nsw i32 %.266.i.i, 1               ; 3 uses
  ...
  %.not74.i.i = icmp eq i32 %.455.i.i, 0
...
.thread168.i.i:                                   ; preds = %bb.le, %bb.ld, %.thread211.i.i, %.thread211.thread.i.i, %.thread223.i.i, %bb.kj, %adjust_last_block.exit.thread.i.i, %adjust_last_block.exit.i.i, %.thread.i.i
  ...
  %.4153.i.i = phi i32 [ 0, %adjust_last_block.exit.thread.i.i ], [ %.1150182291.i.i, %bb.kj ], [ 0, %adjust_last_block.exit.i.i ], [ %.3152.i.i, %.thread211.i.i ], [ %.3152.i.i, %bb.ld ], [ %.3152.i.i, %bb.le ], [ 0, %.thread.i.i ], [ 0, %.thread223.i.i ], [ %i.awm, %.thread211.thread.i.i ]
  ...
  %.468.i.i = phi i32 [ %.165.i.i, %adjust_last_block.exit.thread.i.i ], [ %.165183289.i.i, %bb.kj ], [ 0, %adjust_last_block.exit.i.i ], [ %i.aws, %.thread211.i.i ], [ %i.aws, %bb.ld ], [ %i.aws, %bb.le ], [ %.064255.i.i, %.thread.i.i ], [ 0, %.thread223.i.i ], [ 1, %.thread211.thread.i.i ] ; 5 uses
  %.363.i.i = phi i32 [ 0, %adjust_last_block.exit.thread.i.i ], [ %.060256.i.i, %bb.kj ], [ 0, %adjust_last_block.exit.i.i ], [ %.060256.i.i, %.thread211.i.i ], [ %.060256.i.i, %bb.ld ], [ %.060256.i.i, %bb.le ], [ 0, %.thread.i.i ], [ 0, %.thread223.i.i ], [ %.pre.i45.i, %.thread211.thread.i.i ]
  %.556.i.i = phi i32 [ %.253.i.i, %adjust_last_block.exit.thread.i.i ], [ %.253185284.i.i.a, %bb.kj ], [ 0, %adjust_last_block.exit.i.i ], [ 0, %.thread211.i.i ], [ 1, %bb.ld ], [ 1, %bb.le ], [ 0, %.thread.i.i ], [ 0, %.thread223.i.i ], [ 0, %.thread211.thread.i.i ]
  %.5.i.i = phi i32 [ %.0260.i.i, %adjust_last_block.exit.thread.i.i ], [ %.0260.i.i, %bb.kj ], [ %i.asu, %adjust_last_block.exit.i.i ], [ %.0260.i.i, %.thread211.i.i ], [ %.0260.i.i, %bb.ld ], [ %.0260.i.i, %bb.le ], [ %.0260.i.i, %.thread.i.i ], [ %i.avt, %.thread223.i.i ], [ %.0260.i.i, %.thread211.thread.i.i ]
  %i.awy = add nsw i32 %.5.i.i, 1                 ; 3 uses
  ...
  br i1 %i.axc, label %bb.ka, label %._crit_edge.i46.i, !llvm.loop !366

._crit_edge.i46.i:                                ; preds = %.thread168.i.i
  %i.axd = sext i32 %i.awy to i64                 ; 6 uses
  %i.axe = load i32, ptr %i.aik, align 8, !tbaa !167
  %i.axf = icmp eq i32 %i.axe, 1
  %.not42.i113.i.i = icmp slt i32 %.468.i.i, 1
...
.lr.ph45.i114.i.i:                                ; preds = %._crit_edge.i46.i
  %i.axg = load ptr, ptr %i.awz, align 8, !tbaa !64 ; 6 uses
  %i.axh = add nuw i32 %.468.i.i, 1
...
.preheader.i129.i.i.preheader:                    ; preds = %._crit_edge.i125.i.i
  %i.axv = zext nneg i32 %.468.i.i to i64         ; 2 uses
  %xtraiter503 = and i64 %i.axv, 3                ; 3 uses
  %i.axw = add nsw i32 %.468.i.i, -1
...
.preheader.i129.i.i.preheader.new:                ; preds = %.preheader.i129.i.i.preheader
  %unroll_iter507 = and i64 %i.axv, 2147483644
  %invariant.gep546 = getelementptr [32 x i8], ptr %i.axg, i64 %i.axd
...
.preheader.i129.i.i:                              ; preds = %.preheader.i129.i.i, %.preheader.i129.i.i.preheader.new
  ...
  %niter508 = phi i64 [ 0, %.preheader.i129.i.i.preheader.new ], [ %niter508.next.3, %.preheader.i129.i.i ]
  ...
  %gep547 = getelementptr [32 x i8], ptr %invariant.gep546, i64 %indvars.iv.next52.i132.i.i.neg
  %i.ayd = getelementptr inbounds nuw i8, ptr %gep547, i64 12 ; 2 uses
  ...
  %niter508.next.3 = add nuw i64 %niter508, 4     ; 2 uses
  %niter508.ncmp.3 = icmp eq i64 %niter508.next.3, %unroll_iter507
  br i1 %niter508.ncmp.3, label %mark_color_as_moved.exit.i.loopexit.unr-lcssa, label %.preheader.i129.i.i, !llvm.loop !356

mark_color_as_moved.exit.i.loopexit.unr-lcssa:    ; preds = %.preheader.i129.i.i
  %lcmp.mod505.not = icmp eq i64 %xtraiter503, 0
  br i1 %lcmp.mod505.not, label %mark_color_as_moved.exit.i, label %.preheader.i129.i.i.epil.preheader
...
.preheader.i129.i.i.epil:                         ; preds = %.preheader.i129.i.i.epil, %.preheader.i129.i.i.epil.preheader
  ...
  %epil.iter504 = phi i64 [ %epil.iter504.next, %.preheader.i129.i.i.epil ], [ 0, %.preheader.i129.i.i.epil.preheader ]
