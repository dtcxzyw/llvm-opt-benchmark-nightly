...
.lr.ph:                                           ; preds = %sane_qsort.exit
  ...
  %invariant.gep = getelementptr inbounds nuw [16 x i8], ptr %i.o, i64 %i.e
  br label %bb.e

bb.e:                                             ; preds = %.lr.ph, %bb.e
  %indvars.iv = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next, %bb.e ] ; 2 uses
  %.042 = phi i64 [ 0, %.lr.ph ], [ %i.t, %bb.e ]
  %i.p = getelementptr inbounds nuw [16 x i8], ptr %invariant.gep, i64 %indvars.iv
...
.lr.ph45:                                         ; preds = %.lr.ph45.preheader, %.lr.ph45
  ...
  %5 = getelementptr inbounds nuw [16 x i8], ptr %i.u, i64 %indvars.iv50
  %i.v = getelementptr inbounds nuw [16 x i8], ptr %5, i64 %i.e ; 2 uses
