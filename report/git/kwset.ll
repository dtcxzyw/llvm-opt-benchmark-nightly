...
._crit_edge179:                                   ; preds = %bb.m, %._crit_edge179.loopexit.split.loop.exit, %._crit_edge175.thread, %._crit_edge175
  %i.dw = phi i32 [ 1, %._crit_edge175 ], [ %i.bj, %._crit_edge175.thread ], [ %.pre198, %._crit_edge179.loopexit.split.loop.exit ], [ %.pre198, %bb.m ]
  %.2132.lcssa = phi i32 [ -1, %._crit_edge175 ], [ %i.bk, %._crit_edge175.thread ], [ %2, %._crit_edge179.loopexit.split.loop.exit ], [ -1, %bb.m ]
...
bb.z:                                             ; preds = %.preheader152
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %i.fn, ptr noundef nonnull readonly align 16 dereferenceable(2048) %i.c, i64 2048, i1 false)
  br label %.loopexit
