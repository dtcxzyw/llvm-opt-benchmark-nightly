...
begin_hunk_0_@get_oid_1:bb.a
  %i.ci = call ptr @parse_object(ptr noundef %0, ptr noundef nonnull %8) #18, !inline_history !120 ; 3 uses
...
bb.ac:                                            ; preds = %bb.ab
  %i.cj = call ptr @deref_tag(ptr noundef %0, ptr noundef nonnull %i.ci, ptr noundef %1, i32 noundef %i.cg) #18, !inline_history !120 ; 5 uses
...
bb.ae:                                            ; preds = %bb.ad
  ...
  %i.cn = call ptr @parse_object(ptr noundef %0, ptr noundef nonnull %i.cm) #18, !inline_history !120
...
bb.ag:                                            ; preds = %bb.ab
  %i.cs = call ptr @repo_peel_to_type(ptr noundef %0, ptr noundef %1, i32 noundef %2, ptr noundef nonnull %i.ci, i32 noundef %.068.i108112), !inline_history !120 ; 4 uses
...
bb.ah:                                            ; preds = %bb.ag
  ...
  %i.cx = load i8, ptr %i.bp, align 1, !tbaa !44
...
bb.ai:                                            ; preds = %bb.ah
  ...
  %i.da = load i8, ptr %i.cz, align 1, !tbaa !44
...
peel_onion.exit:                                  ; preds = %bb.ai
  ...
  %i.df = call ptr @xstrndup(ptr noundef nonnull %i.cz, i64 noundef %i.de) #18, !inline_history !120 ; 2 uses
  %i.dg = call ptr @commit_list_insert(ptr noundef nonnull %i.cs, ptr noundef nonnull %i.f) #18, !inline_history !120 ; 0 uses
  %i.dh = load ptr, ptr %i.f, align 8, !tbaa !62
  %i.di = call fastcc i32 @get_oid_oneline(ptr noundef %0, ptr noundef %i.df, ptr noundef nonnull %3, ptr noundef %i.dh), !inline_history !120
  %i.dj = load ptr, ptr %i.f, align 8, !tbaa !62
  call void @commit_list_free(ptr noundef %i.dj) #18, !inline_history !120
  call void @free(ptr noundef %i.df) #18, !inline_history !120
  call void @llvm.lifetime.end.p0(ptr nonnull %i.f) #18
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #18
...
bb.aj:                                            ; preds = %peel_onion.exit.thread, %peel_onion.exit
  ...
  %i.dl = load ptr, ptr @the_repository, align 8, !tbaa !57
...
bb.aq:                                            ; preds = %bb.ap
  %i.ea = load ptr, ptr @stderr, align 8, !tbaa !131
  %i.eb = load i32, ptr @git_gettext_enabled, align 4, !tbaa !54
...
bb.as:                                            ; preds = %_.exit.i, %bb.ap, %bb.ao
  %i.ee = load ptr, ptr %i.a, align 8, !tbaa !72
...
bb.au:                                            ; preds = %bb.at
  ...
  %i.ei = load i8, ptr %i.eh, align 1, !tbaa !44
...
bb.ax:                                            ; preds = %bb.aw
  ...
  %i.ev = load i8, ptr %i.eu, align 1, !tbaa !44
...
bb.bb:                                            ; preds = %bb.aw, %.lr.ph.i
  ...
  %.not293.i = icmp eq i64 %indvars.iv.i, 0
  br i1 %.not293.i, label %upstream_mark.exit.thread.i, label %.lr.ph.i, !llvm.loop !121
...
.lr.ph.i.i:                                       ; preds = %.thread180.i, %bb.be
  ...
  %i.fh = load i8, ptr %.067.i.i, align 1, !tbaa !44
...
bb.be:                                            ; preds = %bb.bd, %bb.bc, %.lr.ph.i.i
  ...
  br i1 %exitcond.not.i.i, label %ambiguous_path.exit.i, label %.lr.ph.i.i, !llvm.loop !122
...
bb.bh:                                            ; preds = %bb.bg
  ...
  %i.fm = load i64, ptr %i.fl, align 8, !tbaa !50
  %i.fn = load ptr, ptr %i.dn, align 8, !tbaa !51
  %i.fo = getelementptr inbounds nuw i8, ptr %i.fn, i64 24
  %i.fp = load i64, ptr %i.fo, align 8, !tbaa !53
...
bb.bu:                                            ; preds = %bb.bt
  ...
  br i1 %i.ge, label %.lr.ph249.i, label %.thread286.i
...
bb.bv:                                            ; preds = %bb.bv, %.lr.ph249.i
  ...
  %i.gi = load i8, ptr %i.gh, align 1, !tbaa !44  ; 2 uses
  %i.gj = add i8 %i.gi, -48
  ...
  br i1 %i.gq, label %bb.bv, label %._crit_edge.i, !llvm.loop !123
...
bb.bw:                                            ; preds = %._crit_edge.i
  %i.gs = zext nneg i32 %.1104.i to i64
  br label %.thread286.i

bb.bx:                                            ; preds = %._crit_edge.i
  br i1 %i.go, label %.thread286.i, label %bb.by
