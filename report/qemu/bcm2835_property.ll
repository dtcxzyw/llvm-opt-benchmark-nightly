...
bb.au:                                            ; preds = %bb.au, %.lr.ph310.i
  ...
  %indvars.iv336.tr.i = trunc nuw nsw i64 %indvars.iv336.i to i32 ; 2 uses
  %i.fi = shl nuw nsw i32 %indvars.iv336.tr.i, 2
...
bb.bc:                                            ; preds = %bb.bc, %.lr.ph308.i
  ...
  %i.gw = shl nuw nsw i32 %.tr389.i, 2
...
bb.bg:                                            ; preds = %bb.bg, %.lr.ph305.i
  ...
  %i.hp = shl nuw nsw i32 %.tr388.i, 2
...
bb.bi:                                            ; preds = %bb.bi, %.lr.ph302.i
  ...
  %i.im = shl nuw nsw i32 %.tr387.i, 2
