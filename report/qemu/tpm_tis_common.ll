...
.lr.ph296:                                        ; preds = %.lr.ph296.2, %.lr.ph296.3
  %indvars.iv297 = phi i64 [ %indvars.iv.next, %.lr.ph296.3 ], [ %4, %.lr.ph296.2 ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv297, 1 ; 3 uses
...
bb.av:                                            ; preds = %bb.au
  ...
  tail call fastcc void @tpm_tis_raise_irq(ptr noundef nonnull %0, i8 noundef zeroext %i.g, i32 noundef 128)
  %.pre281.a = load i32, ptr %i.fe, align 8
  br label %bb.aw

bb.aw:                                            ; preds = %bb.av, %bb.au
  %i.fj = phi i32 [ %.pre281.a, %bb.av ], [ %i.ff, %bb.au ]
