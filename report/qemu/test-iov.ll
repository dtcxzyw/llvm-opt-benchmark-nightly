Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/qemu/original/test-iov?download=true
...
bb.b:                                             ; preds = %bb.a, %test_to_from_buf_1.exit
  %.02 = phi i32 [ 0, %bb.a ], [ %i.cp, %test_to_from_buf_1.exit ]
...
vector.main.loop.iter.check:                      ; preds = %vector.scevcheck
  %min.iters.check13 = icmp ult i64 %i.j, 32
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.z, label %middle.block, label %vector.body, !llvm.loop !17
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec14 = and i64 %i.j, 8589934588             ; 3 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %vec.ind16 = phi <4 x i8> [ %induction, %vec.epilog.ph ], [ %vec.ind.next18, %vec.epilog.vector.body ] ; 2 uses
  %i.ab = getelementptr inbounds nuw i8, ptr %i.m, i64 %index15
  store <4 x i8> %vec.ind16, ptr %i.ab, align 1
  %index.next17 = add nuw i64 %index15, 4         ; 2 uses
  %vec.ind.next18 = add <4 x i8> %vec.ind16, splat (i8 4)
  %i.ac = icmp eq i64 %index.next17, %n.vec14
  br i1 %i.ac, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !18

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n19 = icmp eq i64 %i.j, %n.vec14
  br i1 %cmp.n19, label %.preheader.i, label %.lr.ph.i.preheader

.lr.ph.i.preheader:                               ; preds = %vector.scevcheck, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv.i.ph = phi i64 [ 0, %iter.check ], [ 0, %vector.scevcheck ], [ %n.vec, %vec.epilog.iter.check ], [ %n.vec14, %vec.epilog.middle.block ]
  br label %.lr.ph.i
...
iov_from_buf.exit.i:                              ; preds = %bb.c
  %i.al = getelementptr inbounds nuw i8, ptr %i.m, i64 %i.ai ; 2 uses
  %i.am = sub nuw nsw i64 %i.j, %i.ai             ; 5 uses
  %i.an = tail call i64 @iov_from_buf_full(ptr noundef %i.d, i32 noundef %i.a, i64 noundef range(i64 0, 4294967296) %i.ai, ptr noundef nonnull %i.al, i64 noundef range(i64 -4294967295, 4294967296) %i.am) #15
  %i.ao = and i64 %i.an, 4294967295
  %.not145.i = icmp eq i64 %i.ao, %i.am
...
iov_to_buf.exit.i:                                ; preds = %iov_from_buf.exit.i
  %i.ap = getelementptr inbounds nuw i8, ptr %i.p, i64 %i.ai ; 7 uses
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 %i.ap, i8 noundef 0, i64 noundef range(i64 -4294967295, 4294967296) %i.am, i1 noundef false) #15
  %i.aq = tail call i64 @iov_to_buf_full(ptr noundef %i.d, i32 noundef %i.a, i64 noundef range(i64 0, 4294967296) %i.ai, ptr noundef nonnull %i.ap, i64 noundef range(i64 -4294967295, 4294967296) %i.am) #15
  %i.ar = and i64 %i.aq, 4294967295
  %.not147.i = icmp eq i64 %i.ar, %i.am
...
bb.j:                                             ; preds = %bb.i
  %i.as = load i64, ptr %i.ad, align 8
  %or.cond22.i178.not.i = icmp ugt i64 %i.as, %i.ai
...
iov_to_buf.exit179.i:                             ; preds = %bb.j, %bb.i
  %i.at = tail call i64 @iov_to_buf_full(ptr noundef %i.d, i32 noundef %i.a, i64 noundef range(i64 0, 4294967296) %i.ai, ptr noundef nonnull %i.ap, i64 noundef 1) #15
  %i.au = trunc i64 %i.at to i32                  ; 2 uses
  %i.av = icmp samesign ugt i64 %i.j, %i.ai
  %i.aw = zext i1 %i.av to i32
  %.not152.i = icmp eq i32 %i.au, %i.aw
...
iov_to_buf.exit179.thread.i:                      ; preds = %bb.j
  ...
  %i.ba = icmp samesign ugt i64 %i.j, %i.ai
  br i1 %i.ba, label %.thread.i, label %bb.k, !prof !15
...
iov_to_buf.exit191.i:                             ; preds = %iov_from_buf.exit185.i
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 %i.ap, i8 noundef 0, i64 noundef range(i64 -4294967295, 4294967296) %i.bg, i1 noundef false) #15
  %i.bk = tail call i64 @iov_to_buf_full(ptr noundef %i.d, i32 noundef %i.a, i64 noundef range(i64 0, 4294967296) %i.ai, ptr noundef nonnull %i.ap, i64 noundef range(i64 -4294967295, 4294967296) %i.bg) #15
...
.lr.ph40.i.i:                                     ; preds = %bb.t
  %i.bn = add nuw nsw i64 %i.ai, %i.bg
  br label %bb.u
...
.lr.ph.i193.i:                                    ; preds = %bb.z, %.lr.ph.preheader.i.i
  ...
  %.not.i194.i = icmp uge i64 %.135.i.i, %i.ai
...
bb.z:                                             ; preds = %bb.x, %bb.v
  ...
  br i1 %exitcond.not.i196.i, label %._crit_edge.i.i, label %.lr.ph.i193.i, !llvm.loop !1
...
._crit_edge.i.i:                                  ; preds = %bb.z, %bb.u
  ...
  br i1 %exitcond45.not.i.i, label %test_iov_bytes.exit.i, label %bb.u, !llvm.loop !2
...
bb.aa:                                            ; preds = %._crit_edge.i
  ...
  %i.cc = icmp ne i32 %i.cb, 1633771873
  %i.cd = zext i1 %i.cc to i32
  %.not133.i = icmp eq i32 %i.cd, 0
  br i1 %.not133.i, label %bb.ab, label %.critedge.i

bb.ab:                                            ; preds = %bb.aa
  %i.ce = load i32, ptr %i.n, align 1
  %i.cf = icmp ne i32 %i.ce, 1650614882
  %i.cg = zext i1 %i.cf to i32
  %.not135.i = icmp eq i32 %i.cg, 0
...
bb.ac:                                            ; preds = %bb.ab
  ...
  %i.ch = load i32, ptr %i.o, align 1
  %i.ci = icmp ne i32 %i.ch, 2021161080
  %i.cj = zext i1 %i.ci to i32
  %.not138.i = icmp eq i32 %i.cj, 0
  br i1 %.not138.i, label %bb.ad, label %.critedge167.i

bb.ad:                                            ; preds = %bb.ac
  %i.ck = load i32, ptr %i.q, align 1
  %i.cl = icmp ne i32 %i.ck, 2038004089
  %i.cm = zext i1 %i.cl to i32
  %.not140.i = icmp eq i32 %i.cm, 0
...
.lr.ph.i201.i:                                    ; preds = %bb.ae, %.lr.ph.i201.i
  ...
  %i.cn = getelementptr inbounds nuw [16 x i8], ptr %i.d, i64 %indvars.iv.i202.i
  %i.co = load ptr, ptr %i.cn, align 8
  tail call void @g_free(ptr noundef %i.co) #15
  ...
  br i1 %exitcond.not.i204.i, label %test_to_from_buf_1.exit, label %.lr.ph.i201.i, !llvm.loop !3

test_to_from_buf_1.exit:                          ; preds = %.lr.ph.i201.i, %bb.ae
  tail call void @g_free(ptr noundef %i.d) #15
  %i.cp = add nuw nsw i32 %.02, 1                 ; 2 uses
  %exitcond.not.a = icmp eq i32 %i.cp, 4
  br i1 %exitcond.not.a, label %bb.af, label %bb.b, !llvm.loop !22
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.v, label %middle.block, label %vector.body, !llvm.loop !23
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  br i1 %i.ac, label %.lr.ph, label %._crit_edge, !llvm.loop !25

._crit_edge:                                      ; preds = %.lr.ph, %iov_random.exit, %vec.epilog.middle.block, %middle.block
  %i.ad = tail call i64 @iov_from_buf_full(ptr noundef %i.f, i32 noundef %i.c, i64 noundef 0, ptr noundef %i.m, i64 noundef range(i64 -4294967295, 4294967296) %i.l) #15 ; 0 uses
  store i64 0, ptr %i.a, align 8, !annotation !16
  store i32 0, ptr %i.b, align 4, !annotation !16
  %i.ae = tail call ptr @g_memdup2(ptr noundef %i.f, i64 noundef range(i64 0, 68719476721) %i.e) #18 ; 4 uses
  %i.af = call i32 @socketpair(i32 noundef 1, i32 noundef 1, i32 noundef 0, ptr noundef nonnull %i.a) #15
  %i.ag = icmp slt i32 %i.af, 0
  br i1 %i.ag, label %bb.b, label %.preheader144.preheader
...
.preheader144.preheader:                          ; preds = %._crit_edge
  ...
  %i.ah = call i32 @fork() #15
  %i.ai = icmp eq i32 %i.ah, 0
  %i.aj = lshr i64 %i.l, 1
  %i.ak = trunc nuw nsw i64 %i.aj to i32          ; 2 uses
  %i.al = trunc nuw i64 %i.l to i32               ; 2 uses
  br i1 %i.ai, label %bb.c, label %bb.m
...
bb.c:                                             ; preds = %.preheader144.preheader
  ...
  %i.ao = getelementptr inbounds nuw i8, ptr %i.a, i64 4 ; 5 uses
  %i.ap = load i32, ptr %i.ao, align 4            ; 2 uses
  %i.aq = srem i32 %i.ap, 64
  %i.ar = zext nneg i32 %i.aq to i64
  %i.as = shl nuw i64 1, %i.ar
  %i.at = sext i32 %i.ap to i64
  %i.au = call i64 @__fdelt_chk(i64 noundef %i.at) #15
  ...
  %i.az = call zeroext i1 @qemu_set_blocking(i32 noundef %i.ay, i1 noundef zeroext false, ptr noundef nonnull @error_abort) #15 ; 0 uses
  %i.ba = call i32 @g_test_rand_int_range(i32 noundef %i.ak, i32 noundef %i.al) #15
  store i32 %i.ba, ptr %i.b, align 4
  %i.bb = load i32, ptr %i.ao, align 4
...
bb.d:                                             ; preds = %.preheader, %bb.k
  ...
  %bcmp104 = call i32 @bcmp(ptr %i.f, ptr %i.ae, i64 %i.e)
...
bb.k:                                             ; preds = %bb.j
  %i.bs = load i32, ptr %i.ao, align 4
  %i.bt = add i32 %i.bs, 1
...
bb.l:                                             ; preds = %._crit_edge154
  ...
  call void @g_free(ptr noundef %i.ae) #15
...
bb.m:                                             ; preds = %.preheader144.preheader
  ...
  %i.by = call i32 @close(i32 noundef %i.bx) #15  ; 0 uses
  %i.bz = load i32, ptr %i.a, align 8             ; 2 uses
  %i.ca = srem i32 %i.bz, 64
  %i.cb = zext nneg i32 %i.ca to i64
  %i.cc = shl nuw i64 1, %i.cb
  %i.cd = sext i32 %i.bz to i64
  %i.ce = call i64 @__fdelt_chk(i64 noundef %i.cd) #15
  %i.cf = getelementptr inbounds [8 x i8], ptr %0, i64 %i.ce ; 2 uses
  %i.cg = load i64, ptr %i.cf, align 8
  %i.ch = or i64 %i.cg, %i.cc
  store i64 %i.ch, ptr %i.cf, align 8
  %i.ci = load i32, ptr %i.a, align 8
  %i.cj = call zeroext i1 @qemu_set_blocking(i32 noundef %i.ci, i1 noundef zeroext false, ptr noundef nonnull @error_abort) #15 ; 0 uses
  %i.ck = call i32 @g_test_rand_int_range(i32 noundef %i.ak, i32 noundef %i.al) #15
  store i32 %i.ck, ptr %i.b, align 4
  %i.cl = load i32, ptr %i.a, align 8
  %i.cm = call i32 @setsockopt(i32 noundef %i.cl, i32 noundef 1, i32 noundef 8, ptr noundef nonnull %i.b, i32 noundef 4) #15 ; 0 uses
...
bb.n:                                             ; preds = %bb.w, %.lr.ph149
  ...
  %i.cu = zext i32 %.184 to i64
  %i.cv = zext i32 %i.cs to i64
  %i.cw = call i64 @iov_send_recv(i32 noundef %i.ct, ptr noundef %i.f, i32 noundef %i.c, i64 noundef %i.cu, i64 noundef %i.cv, i1 noundef zeroext false) #15
  %i.cx = trunc i64 %i.cw to i32                  ; 4 uses
  store i32 %i.cx, ptr %i.b, align 4
  %bcmp = call i32 @bcmp(ptr %i.f, ptr %i.ae, i64 %i.e)
...
bb.s:                                             ; preds = %bb.r
  %.not101 = icmp eq i32 %i.cs, 0
  br i1 %.not101, label %bb.w, label %bb.x

bb.t:                                             ; preds = %bb.r
  %i.da = tail call ptr @__errno_location() #21
  %i.db = load i32, ptr %i.da, align 4
  %i.dc = icmp eq i32 %i.db, 11
  br i1 %i.dc, label %bb.u, label %bb.v

bb.u:                                             ; preds = %bb.t
  %i.dd = load i32, ptr %i.a, align 8
  %i.de = add i32 %i.dd, 1
  %i.df = call i32 @select(i32 noundef %i.de, ptr noundef nonnull %0, ptr noundef null, ptr noundef null, ptr noundef null) #15 ; 0 uses
  br label %bb.w

bb.v:                                             ; preds = %bb.t
  call void @perror(ptr noundef nonnull @.str.24) #19
  call void @exit(i32 noundef 1) #20
  unreachable

bb.w:                                             ; preds = %bb.q, %bb.s, %bb.u
  %.285 = phi i32 [ %i.cz, %bb.q ], [ %.184, %bb.u ], [ %.184, %bb.s ] ; 2 uses
  %i.dg = icmp ult i32 %.285, %.182148
  br i1 %i.dg, label %bb.n, label %bb.x, !llvm.loop !29
...
bb.y:                                             ; preds = %._crit_edge.i, %.lr.ph40.i
  %indvars.iv.i108 = phi i64 [ 0, %.lr.ph40.i ], [ %indvars.iv.next.i113, %._crit_edge.i ] ; 2 uses
  %.02637.i = phi i64 [ 0, %.lr.ph40.i ], [ %.1.lcssa.i, %._crit_edge.i ] ; 3 uses
  %i.dk = getelementptr inbounds nuw [16 x i8], ptr %i.f, i64 %indvars.iv.i108 ; 2 uses
  %i.dl = load ptr, ptr %i.dk, align 8
  %i.dm = getelementptr inbounds nuw i8, ptr %i.dk, i64 8
  %i.dn = load i64, ptr %i.dm, align 8            ; 3 uses
  %.not43.i = icmp eq i64 %i.dn, 0
  br i1 %.not43.i, label %._crit_edge.i, label %.lr.ph.preheader.i

.lr.ph.preheader.i:                               ; preds = %bb.y
  %i.do = add i64 %i.dn, %.02637.i
  br label %.lr.ph.i109

.lr.ph.i109:                                      ; preds = %bb.ad, %.lr.ph.preheader.i
  %.02436.i = phi i64 [ %i.du, %bb.ad ], [ 0, %.lr.ph.preheader.i ] ; 2 uses
  %.135.i = phi i64 [ %i.dt, %bb.ad ], [ %.02637.i, %.lr.ph.preheader.i ] ; 4 uses
  %.not.i110 = icmp uge i64 %.135.i, %i.co
  %i.dp = icmp ult i64 %.135.i, %i.dj
  %or.cond.i111 = select i1 %.not.i110, i1 %i.dp, i1 false
  %i.dq = getelementptr inbounds nuw i8, ptr %i.dl, i64 %.02436.i
  %i.dr = load i8, ptr %i.dq, align 1             ; 2 uses
  br i1 %or.cond.i111, label %bb.z, label %bb.ab

bb.z:                                             ; preds = %.lr.ph.i109
  %i.ds = trunc i64 %.135.i to i8
  %.not31.i = icmp eq i8 %i.dr, %i.ds
  br i1 %.not31.i, label %bb.ad, label %bb.aa, !prof !15

bb.aa:                                            ; preds = %bb.z
  call void @g_assertion_message_expr(ptr noundef null, ptr noundef nonnull @.str.10, i32 noundef 52, ptr noundef nonnull @__func__.test_iov_bytes, ptr noundef nonnull @.str.19) #17
  unreachable

bb.ab:                                            ; preds = %.lr.ph.i109
  %.not29.i = icmp eq i8 %i.dr, -1
  br i1 %.not29.i, label %bb.ad, label %bb.ac, !prof !15

bb.ac:                                            ; preds = %bb.ab
  call void @g_assertion_message_expr(ptr noundef null, ptr noundef nonnull @.str.10, i32 noundef 54, ptr noundef nonnull @__func__.test_iov_bytes, ptr noundef nonnull @.str.20) #17
  unreachable

bb.ad:                                            ; preds = %bb.ab, %bb.z
  %i.dt = add i64 %.135.i, 1
  %i.du = add nuw i64 %.02436.i, 1                ; 2 uses
  %exitcond.not.i112 = icmp eq i64 %i.du, %i.dn
  br i1 %exitcond.not.i112, label %._crit_edge.i, label %.lr.ph.i109, !llvm.loop !1

._crit_edge.i:                                    ; preds = %bb.ad, %bb.y
  %.1.lcssa.i = phi i64 [ %.02637.i, %bb.y ], [ %i.do, %bb.ad ]
  %indvars.iv.next.i113 = add nuw nsw i64 %indvars.iv.i108, 1 ; 2 uses
  %exitcond45.not.i = icmp eq i64 %indvars.iv.next.i113, %i.d
  br i1 %exitcond45.not.i, label %test_iov_bytes.exit, label %bb.y, !llvm.loop !2

test_iov_bytes.exit:                              ; preds = %._crit_edge.i, %bb.x
  %i.dv = zext i32 %i.cq to i64
...
.lr.ph.i117:                                      ; preds = %bb.ae, %.lr.ph.i117
  %indvars.iv.i118 = phi i64 [ %indvars.iv.next.i119, %.lr.ph.i117 ], [ 0, %bb.ae ] ; 2 uses
  %i.dw = getelementptr inbounds nuw [16 x i8], ptr %i.f, i64 %indvars.iv.i118
  %i.dx = load ptr, ptr %i.dw, align 8
  call void @g_free(ptr noundef %i.dx) #15
  %indvars.iv.next.i119 = add nuw nsw i64 %indvars.iv.i118, 1 ; 2 uses
  %exitcond.not.i120 = icmp eq i64 %indvars.iv.next.i119, %i.d
  br i1 %exitcond.not.i120, label %iov_free.exit, label %.lr.ph.i117, !llvm.loop !3

iov_free.exit:                                    ; preds = %.lr.ph.i117, %bb.ae
  call void @g_free(ptr noundef %i.f) #15
  call void @g_free(ptr noundef %i.m) #15
  call void @g_free(ptr noundef %i.ae) #15
...
; Function Attrs: nounwind sspstrong uwtable
define internal void @test_discard_front() #2 {
bb.a:
  %i.a = alloca ptr, align 8                      ; 18 uses
  %i.b = alloca i32, align 4                      ; 20 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #15
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #15
  %i.c = tail call i32 @g_test_rand_int_range(i32 noundef 3, i32 noundef 8) #15 ; 4 uses
  %i.d = zext i32 %i.c to i64                     ; 3 uses
  %i.e = shl nuw nsw i64 %i.d, 4
  %i.f = tail call noalias ptr @g_malloc(i64 noundef %i.e) #16 ; 5 uses
...
iov_random.exit:                                  ; preds = %.lr.ph.i, %bb.a
  ...
  %i.l = call i64 @iov_discard_front(ptr noundef nonnull %i.a, ptr noundef nonnull %i.b, i64 noundef 0) #15
  %.not = icmp eq i64 %i.l, 0
  br i1 %.not, label %bb.c, label %bb.b, !prof !15

bb.b:                                             ; preds = %iov_random.exit
  call void @g_assertion_message_expr(ptr noundef null, ptr noundef nonnull @.str.10, i32 noundef 279, ptr noundef nonnull @__func__.test_discard_front, ptr noundef nonnull @.str.25) #17
  unreachable

bb.c:                                             ; preds = %iov_random.exit
  %i.m = load ptr, ptr %i.a, align 8
  %.not73 = icmp eq ptr %i.m, %i.f
  br i1 %.not73, label %bb.e, label %bb.d, !prof !15

bb.d:                                             ; preds = %bb.c
  call void @g_assertion_message_expr(ptr noundef null, ptr noundef nonnull @.str.10, i32 noundef 280, ptr noundef nonnull @__func__.test_discard_front, ptr noundef nonnull @.str.26) #17
  unreachable

bb.e:                                             ; preds = %bb.c
  %i.n = load i32, ptr %i.b, align 4
  %.not75 = icmp eq i32 %i.n, %i.c
  br i1 %.not75, label %bb.g, label %bb.f, !prof !15

bb.f:                                             ; preds = %bb.e
  call void @g_assertion_message_expr(ptr noundef null, ptr noundef nonnull @.str.10, i32 noundef 281, ptr noundef nonnull @__func__.test_discard_front, ptr noundef nonnull @.str.27) #17
  unreachable

bb.g:                                             ; preds = %bb.e
  br i1 %.not.i, label %iov_free.exit, label %.lr.ph.i107

.lr.ph.i107:                                      ; preds = %bb.g, %.lr.ph.i107
  %indvars.iv.i108 = phi i64 [ %indvars.iv.next.i109, %.lr.ph.i107 ], [ 0, %bb.g ] ; 2 uses
  %i.o = getelementptr inbounds nuw [16 x i8], ptr %i.f, i64 %indvars.iv.i108
  %i.p = load ptr, ptr %i.o, align 8
  call void @g_free(ptr noundef %i.p) #15
  %indvars.iv.next.i109 = add nuw nsw i64 %indvars.iv.i108, 1 ; 2 uses
  %exitcond.not.i110 = icmp eq i64 %indvars.iv.next.i109, %i.d
  br i1 %exitcond.not.i110, label %iov_free.exit, label %.lr.ph.i107, !llvm.loop !3

iov_free.exit:                                    ; preds = %.lr.ph.i107, %bb.g
  call void @g_free(ptr noundef %i.f) #15
  %i.q = call i32 @g_test_rand_int_range(i32 noundef 3, i32 noundef 8) #15 ; 4 uses
  %i.r = zext i32 %i.q to i64                     ; 3 uses
  %i.s = shl nuw nsw i64 %i.r, 4
  %i.t = call noalias ptr @g_malloc(i64 noundef %i.s) #16 ; 5 uses
  %.not.i111 = icmp eq i32 %i.q, 0                ; 2 uses
  br i1 %.not.i111, label %iov_random.exit116, label %.lr.ph.i112

.lr.ph.i112:                                      ; preds = %iov_free.exit, %.lr.ph.i112
  %indvars.iv.i113 = phi i64 [ %indvars.iv.next.i114, %.lr.ph.i112 ], [ 0, %iov_free.exit ] ; 2 uses
  %i.u = call i32 @g_test_rand_int_range(i32 noundef 5, i32 noundef 20) #15
  %i.v = sext i32 %i.u to i64                     ; 2 uses
  %i.w = getelementptr inbounds nuw [16 x i8], ptr %i.t, i64 %indvars.iv.i113 ; 2 uses
  %i.x = getelementptr inbounds nuw i8, ptr %i.w, i64 8
  store i64 %i.v, ptr %i.x, align 8
  %i.y = call noalias ptr @g_malloc(i64 noundef %i.v) #16
  store ptr %i.y, ptr %i.w, align 8
  %indvars.iv.next.i114 = add nuw nsw i64 %indvars.iv.i113, 1 ; 2 uses
  %exitcond.not.i115 = icmp eq i64 %indvars.iv.next.i114, %i.r
  br i1 %exitcond.not.i115, label %iov_random.exit116, label %.lr.ph.i112, !llvm.loop !0

iov_random.exit116:                               ; preds = %.lr.ph.i112, %iov_free.exit
  store ptr %i.t, ptr %i.a, align 8
  store i32 %i.q, ptr %i.b, align 4
  %i.z = call i64 @iov_size(ptr noundef %i.t, i32 noundef %i.q) #15 ; 2 uses
  %i.aa = add i64 %i.z, 1
  %i.ab = call i64 @iov_discard_front(ptr noundef nonnull %i.a, ptr noundef nonnull %i.b, i64 noundef %i.aa) #15
  %.not77 = icmp eq i64 %i.ab, %i.z
  br i1 %.not77, label %bb.i, label %bb.h, !prof !15

bb.h:                                             ; preds = %iov_random.exit116
  call void @g_assertion_message_expr(ptr noundef null, ptr noundef nonnull @.str.10, i32 noundef 290, ptr noundef nonnull @__func__.test_discard_front, ptr noundef nonnull @.str.28) #17
  unreachable

bb.i:                                             ; preds = %iov_random.exit116
  %i.ac = load i32, ptr %i.b, align 4
  %.not79 = icmp eq i32 %i.ac, 0
  br i1 %.not79, label %bb.k, label %bb.j, !prof !15

bb.j:                                             ; preds = %bb.i
  call void @g_assertion_message_expr(ptr noundef null, ptr noundef nonnull @.str.10, i32 noundef 291, ptr noundef nonnull @__func__.test_discard_front, ptr noundef nonnull @.str.29) #17
  unreachable

bb.k:                                             ; preds = %bb.i
  br i1 %.not.i111, label %iov_free.exit124, label %.lr.ph.i120

.lr.ph.i120:                                      ; preds = %bb.k, %.lr.ph.i120
  %indvars.iv.i121 = phi i64 [ %indvars.iv.next.i122, %.lr.ph.i120 ], [ 0, %bb.k ] ; 2 uses
  %i.ad = getelementptr inbounds nuw [16 x i8], ptr %i.t, i64 %indvars.iv.i121
  %i.ae = load ptr, ptr %i.ad, align 8
  call void @g_free(ptr noundef %i.ae) #15
  %indvars.iv.next.i122 = add nuw nsw i64 %indvars.iv.i121, 1 ; 2 uses
  %exitcond.not.i123 = icmp eq i64 %indvars.iv.next.i122, %i.r
  br i1 %exitcond.not.i123, label %iov_free.exit124, label %.lr.ph.i120, !llvm.loop !3

iov_free.exit124:                                 ; preds = %.lr.ph.i120, %bb.k
  call void @g_free(ptr noundef %i.t) #15
  %i.af = call i32 @g_test_rand_int_range(i32 noundef 3, i32 noundef 8) #15 ; 4 uses
  %i.ag = zext i32 %i.af to i64                   ; 3 uses
  %i.ah = shl nuw nsw i64 %i.ag, 4
  %i.ai = call noalias ptr @g_malloc(i64 noundef %i.ah) #16 ; 5 uses
  %.not.i125 = icmp eq i32 %i.af, 0               ; 2 uses
  br i1 %.not.i125, label %iov_random.exit130, label %.lr.ph.i126

.lr.ph.i126:                                      ; preds = %iov_free.exit124, %.lr.ph.i126
  %indvars.iv.i127 = phi i64 [ %indvars.iv.next.i128, %.lr.ph.i126 ], [ 0, %iov_free.exit124 ] ; 2 uses
  %i.aj = call i32 @g_test_rand_int_range(i32 noundef 5, i32 noundef 20) #15
  %i.ak = sext i32 %i.aj to i64                   ; 2 uses
  %i.al = getelementptr inbounds nuw [16 x i8], ptr %i.ai, i64 %indvars.iv.i127 ; 2 uses
  %i.am = getelementptr inbounds nuw i8, ptr %i.al, i64 8
  store i64 %i.ak, ptr %i.am, align 8
  %i.an = call noalias ptr @g_malloc(i64 noundef %i.ak) #16
  store ptr %i.an, ptr %i.al, align 8
  %indvars.iv.next.i128 = add nuw nsw i64 %indvars.iv.i127, 1 ; 2 uses
  %exitcond.not.i129 = icmp eq i64 %indvars.iv.next.i128, %i.ag
  br i1 %exitcond.not.i129, label %iov_random.exit130, label %.lr.ph.i126, !llvm.loop !0

iov_random.exit130:                               ; preds = %.lr.ph.i126, %iov_free.exit124
  store ptr %i.ai, ptr %i.a, align 8
  store i32 %i.af, ptr %i.b, align 4
  %i.ao = call i64 @iov_size(ptr noundef %i.ai, i32 noundef %i.af) #15 ; 2 uses
  %i.ap = call i64 @iov_discard_front(ptr noundef nonnull %i.a, ptr noundef nonnull %i.b, i64 noundef %i.ao) #15
  %.not81 = icmp eq i64 %i.ap, %i.ao
  br i1 %.not81, label %bb.m, label %bb.l, !prof !15

bb.l:                                             ; preds = %iov_random.exit130
  call void @g_assertion_message_expr(ptr noundef null, ptr noundef nonnull @.str.10, i32 noundef 300, ptr noundef nonnull @__func__.test_discard_front, ptr noundef nonnull @.str.28) #17
  unreachable

bb.m:                                             ; preds = %iov_random.exit130
  %i.aq = load i32, ptr %i.b, align 4
  %.not83 = icmp eq i32 %i.aq, 0
  br i1 %.not83, label %bb.o, label %bb.n, !prof !15

bb.n:                                             ; preds = %bb.m
  call void @g_assertion_message_expr(ptr noundef null, ptr noundef nonnull @.str.10, i32 noundef 301, ptr noundef nonnull @__func__.test_discard_front, ptr noundef nonnull @.str.29) #17
  unreachable

bb.o:                                             ; preds = %bb.m
  br i1 %.not.i125, label %iov_free.exit138, label %.lr.ph.i134

.lr.ph.i134:                                      ; preds = %bb.o, %.lr.ph.i134
  %indvars.iv.i135 = phi i64 [ %indvars.iv.next.i136, %.lr.ph.i134 ], [ 0, %bb.o ] ; 2 uses
  %i.ar = getelementptr inbounds nuw [16 x i8], ptr %i.ai, i64 %indvars.iv.i135
  %i.as = load ptr, ptr %i.ar, align 8
  call void @g_free(ptr noundef %i.as) #15
  %indvars.iv.next.i136 = add nuw nsw i64 %indvars.iv.i135, 1 ; 2 uses
  %exitcond.not.i137 = icmp eq i64 %indvars.iv.next.i136, %i.ag
end_hunk_0
