...
.split.us.thread:                                 ; preds = %bb.e
  ...
  %i.ah = getelementptr inbounds [8 x i8], ptr %i.ag, i64 %i.y
...
.lr.ph.split:                                     ; preds = %.lr.ph, %bb.m
  ...
  %i.aq = getelementptr inbounds [8 x i8], ptr %i.v, i64 %i.ap ; 2 uses
...
.split.us:                                        ; preds = %bb.j
  ...
  %i.bi = getelementptr inbounds [8 x i8], ptr %i.bh, i64 %i.ap
...
.thread:                                          ; preds = %.split.us.thread, %bb.l, %bb.k, %.split.us
  ...
  %i.br = getelementptr inbounds [8 x i8], ptr %i.bq, i64 %.us-phi6293
