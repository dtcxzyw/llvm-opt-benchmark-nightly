...
bb.a:
  ...
  %i.p = icmp eq i32 %.v.i, 16                    ; 2 uses
  %8 = and i32 %i.o, 1
  %9 = select i1 %i.p, i32 %8, i32 0
  %i.q = zext nneg i32 %9 to i64                  ; 2 uses
  %i.r = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %i.q
  %i.s = load i64, ptr %i.r, align 8
  %10 = shl nuw nsw i32 %i.o, 5
  %i.t = and i32 %10, 32
  %11 = select i1 %i.p, i32 0, i32 %i.t
  %i.u = zext nneg i32 %11 to i64                 ; 2 uses
...
bb.a:
  ...
  %i.p = lshr i32 %4, 12
  %i.q = and i32 %i.p, 7
  %i.r = icmp eq i32 %.v.i, 16                    ; 2 uses
  %8 = and i32 %i.o, 1
  %9 = select i1 %i.r, i32 %8, i32 0
  %i.s = zext nneg i32 %9 to i64
  %i.t = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %i.s
  %i.u = load i64, ptr %i.t, align 8
  %10 = shl nuw nsw i32 %i.o, 5
  %i.v = and i32 %10, 32
  %11 = select i1 %i.r, i32 0, i32 %i.v
  %i.w = zext nneg i32 %11 to i64
