...
.critedge:                                        ; preds = %..critedge_crit_edge, %bb.f
  ...
  %3 = select i1 %i.s, i32 4, i32 0
  %.not.i = icmp eq i32 %i.r, 0
  %i.t = select i1 %.not.i, i32 2, i32 0
  ...
  %4 = icmp eq i32 %.fr, 16
  %spec.select = select i1 %4, i32 16, i32 0
  %.not23.i = icmp eq i32 %.fr, 0
  %i.x = select i1 %.not23.i, i32 8, i32 0
  %5 = or disjoint i32 %3, %i.t
  %6 = or disjoint i32 %5, %i.w
  %7 = or disjoint i32 %6, %spec.select
  %i.y = or disjoint i32 %7, %i.x                 ; 2 uses
