...
bb.i:                                             ; preds = %bb.h
  ...
  %spec.select25 = select i1 %.not.i.i, i32 2, i32 %spec.select
  br label %.thread19

.thread19:                                        ; preds = %bb.h, %bb.i
  %i.ab = phi i32 [ %.pre.fr, %bb.i ], [ 0, %bb.h ]
  %.11723 = phi i32 [ %i.x, %bb.i ], [ 0, %bb.h ]
  %i.ac = phi i32 [ %spec.select25, %bb.i ], [ 2, %bb.h ]
...
uart_ctrl_update.exit:                            ; preds = %bb.g, %bb.h, %bb.i, %bb.l, %bb.k, %bb.j, %bb.n, %bb.m, %bb.p, %bb.o, %bb.w, %bb.v, %bb.f, %bb.x, %bb.q
  ...
  %8 = select i1 %.not.i25, i32 2, i32 %7
...
.critedge:                                        ; preds = %..critedge_crit_edge, %bb.f
  ...
  %i.u = select i1 %.not.i, i32 2, i32 %i.t
  ...
  %3 = or disjoint i32 %i.u, %i.x
  %4 = icmp eq i32 %.fr, 16
  %.not23.i = icmp eq i32 %.fr, 0
  %i.y = select i1 %.not23.i, i32 8, i32 0
  %5 = select i1 %4, i32 16, i32 %i.y
  %i.z = or disjoint i32 %3, %5                   ; 2 uses
...
bb.a:
  ...
  %2 = select i1 %.not.i, i32 2, i32 %i.i
