...
bb.i:                                             ; preds = %bb.h
  ...
  %spec.select = select i1 %i.aa, i32 4, i32 %spec.select25
  br label %.thread19

.thread19:                                        ; preds = %bb.h, %bb.i
  %i.ab = phi i32 [ %.pre.fr, %bb.i ], [ 0, %bb.h ]
  %.11723 = phi i32 [ %i.x, %bb.i ], [ 0, %bb.h ]
  %i.ac = phi i32 [ %spec.select, %bb.i ], [ 2, %bb.h ]
  ...
  %6 = select i1 %i.aj, i32 16, i32 %i.ak
  %i.al = or disjoint i32 %5, %6                  ; 2 uses
...
.loopexit:                                        ; preds = %.epil.preheader, %.loopexit.loopexit.unr-lcssa, %.preheader
  ...
  %spec.select = select i1 %i.at, i32 4, i32 %spec.select28
  br label %bb.d

bb.d:                                             ; preds = %.loopexit, %.thread25
  %i.au = phi i32 [ %.pre22, %.loopexit ], [ %i.n, %.thread25 ]
  %i.av = phi i32 [ %.pre21.fr, %.loopexit ], [ 16, %.thread25 ]
  %i.aw = phi i32 [ %spec.select, %.loopexit ], [ 4, %.thread25 ]
  ...
  %4 = select i1 %i.bd, i32 16, i32 %i.be
  %i.bf = or disjoint i32 %3, %4                  ; 2 uses
...
.critedge:                                        ; preds = %..critedge_crit_edge, %bb.f
  ...
  %3 = select i1 %.not.i, i32 2, i32 0
  %i.t = select i1 %i.s, i32 4, i32 %3
  %i.u = getelementptr inbounds nuw i8, ptr %2, i64 1120
  %i.v = load i32, ptr %i.u, align 16
  %.not22.i = icmp uge i32 %i.r, %i.v
  %i.w = zext i1 %.not22.i to i32
  %4 = or disjoint i32 %i.t, %i.w
  %5 = icmp eq i32 %.fr, 16
  %.not23.i = icmp eq i32 %.fr, 0
  %i.x = select i1 %.not23.i, i32 8, i32 0
  %6 = select i1 %5, i32 16, i32 %i.x
  %i.y = or disjoint i32 %4, %6                   ; 2 uses
  %i.z = getelementptr inbounds nuw i8, ptr %2, i64 1156
  %i.aa = load i32, ptr %i.z, align 4
  %.not24.i = icmp ult i32 %.fr, %i.aa            ; 2 uses
  %i.ab = select i1 %.not24.i, i32 0, i32 8192
  %i.ac = or disjoint i32 %i.y, %i.ab
  store i32 %i.ac, ptr %i.p, align 4
  %i.ad = getelementptr inbounds nuw i8, ptr %2, i64 1108 ; 2 uses
  %i.ae = load i32, ptr %i.ad, align 4
  %i.af = select i1 %.not24.i, i32 0, i32 1024
  %i.ag = or i32 %i.ae, %i.af
  %i.ah = or i32 %i.ag, %i.y                      ; 2 uses
  store i32 %i.ah, ptr %i.ad, align 4
  %i.ai = getelementptr inbounds nuw i8, ptr %2, i64 1272
  %i.aj = load ptr, ptr %i.ai, align 8
  %i.ak = getelementptr inbounds nuw i8, ptr %2, i64 1104
  %i.al = load i32, ptr %i.ak, align 16
  %i.am = and i32 %i.al, %i.ah
  %i.an = icmp ne i32 %i.am, 0
  %i.ao = zext i1 %i.an to i32
  tail call void @qemu_set_irq(ptr noundef %i.aj, i32 noundef %i.ao) #6
  br label %bb.i
...
bb.a:
  ...
  %2 = icmp eq i32 %i.g, 16
  %i.h = icmp eq i32 %i.g, 0
  %i.i = select i1 %i.h, i32 2, i32 0
  %3 = select i1 %2, i32 4, i32 %i.i
  ...
  %i.m = or disjoint i32 %3, %i.l
  %i.n = or disjoint i32 %i.m, 8                  ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %1 = load i32, ptr %i.g, align 4                ; 3 uses
  %2 = icmp eq i32 %1, 16
  ...
  %.not22.i = icmp uge i32 %1, %i.i
  %5 = zext i1 %.not22.i to i32
  %6 = or disjoint i32 %4, %5
  %7 = getelementptr inbounds nuw i8, ptr %0, i64 1200
  %8 = load i32, ptr %7, align 16                 ; 3 uses
  %9 = icmp eq i32 %8, 16
  %.not23.i = icmp eq i32 %8, 0
  %10 = select i1 %.not23.i, i32 8, i32 0
  %11 = select i1 %9, i32 16, i32 %10
  %op.rdx = or disjoint i32 %6, %11               ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %2 = load i32, ptr %i.h, align 4                ; 3 uses
  %3 = icmp eq i32 %2, 16
  %.not.i = icmp eq i32 %2, 0
  %4 = select i1 %.not.i, i32 2, i32 0
  %5 = select i1 %3, i32 4, i32 %4
