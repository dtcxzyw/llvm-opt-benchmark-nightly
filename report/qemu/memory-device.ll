...
.lr.ph:                                           ; preds = %range_init.exit102.thread, %range_init.exit125.thread
  ...
  %i.al = call ptr %i.ak(ptr noundef %i.ae, ptr noundef nonnull %i.a) #9, !inline_history !0
...
bb.m:                                             ; preds = %memory_device_is_empty.exit.thread, %memory_device_is_empty.exit
  ...
  %i.au = call ptr %i.at(ptr noundef %i.ae, ptr noundef nonnull @error_abort) #9, !inline_history !19 ; 2 uses
...
range_init.exit125.thread:                        ; preds = %range_upb.exit133, %bb.t, %memory_device_is_empty.exit
  ...
  br i1 %.not50, label %range_is_empty.exit.i136, label %.lr.ph, !llvm.loop !18
...
bb.a:
  ...
  br i1 %.not, label %bb.e, label %bb.b, !prof !12
...
bb.a:
  ...
  %i.h = call ptr %i.g(ptr noundef %0, ptr noundef nonnull %i.a) #9, !inline_history !0
...
bb.c:                                             ; preds = %bb.b
  %i.n = call i32 %i.m(ptr noundef %0) #9, !inline_history !1
...
memory_device_get_memslots.exit:                  ; preds = %bb.b, %bb.c
  ...
  br i1 %.not, label %bb.d, label %bb.e, !prof !13
