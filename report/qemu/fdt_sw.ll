...
bb.c:                                             ; preds = %fdt_sw_probe_struct_.exit.thread
  ...
  %3 = or disjoint i64 %i.bc, %i.bj
  %i.bk = or disjoint i64 %3, %i.bg
...
fdt_sw_probe_struct_.exit.thread:                 ; preds = %bb.b
  ...
  %2 = or disjoint i64 %i.av, %i.bc
  %i.bd = or disjoint i64 %2, %i.az
...
bb.h:                                             ; preds = %bb.g
  ...
  %5 = or disjoint i64 %i.cc, %i.cj
  %i.ck = or disjoint i64 %5, %i.cg
...
fdt_sw_probe_struct_.exit.thread:                 ; preds = %bb.b
  ...
  %2 = or disjoint i64 %i.aw, %i.bd
  %i.be = or disjoint i64 %2, %i.ba
