...
bb.g:                                             ; preds = %.thread8, %bb.f
  ...
  %i.au = mul i64 %i.at, %i.as                    ; 2 uses
  %4 = tail call i64 @llvm.umulh.i64(i64 %i.au, i64 %spec.select) ; 2 uses
  %5 = tail call i64 @llvm.umulh.i64(i64 %i.au, i64 %4)
  %i.av = sub i64 -4611686018427387904, %5
  %6 = tail call i64 @llvm.umulh.i64(i64 %i.av, i64 %4)
  %i.aw = add i64 %6, -2
...
bb.g:                                             ; preds = %.thread4, %bb.f
  ...
  %i.av = mul i64 %i.at, %i.au                    ; 2 uses
  %4 = tail call i64 @llvm.umulh.i64(i64 %i.av, i64 %spec.select.i) ; 2 uses
  %5 = tail call i64 @llvm.umulh.i64(i64 %i.av, i64 %4)
  %i.aw = sub i64 -4611686018427387904, %5
  %6 = tail call i64 @llvm.umulh.i64(i64 %i.aw, i64 %4)
  %i.ax = add i64 %6, -2
...
bb.i:                                             ; preds = %bb.h, %bb.g
  %i.ab = phi i64 [ %i.z, %bb.h ], [ %.pre77.a, %bb.g ] ; 3 uses
  %i.ac = phi i64 [ %i.aa, %bb.h ], [ %i.t, %bb.g ] ; 4 uses
  ...
  %i.aq = mul i64 %i.ap, %i.ao                    ; 3 uses
  %i.ar = zext i64 %i.ac to i128                  ; 2 uses
  %5 = tail call i64 @llvm.umulh.i64(i64 %i.aq, i64 %i.ac)
  %6 = tail call i64 @llvm.umulh.i64(i64 %i.aq, i64 %5)
  %i.as = sub i64 -4611686018427387904, %6
  %7 = tail call i64 @llvm.umulh.i64(i64 %i.aq, i64 %i.as)
  %8 = shl i64 %7, 1                              ; 3 uses
  %9 = zext i64 %8 to i128
  %10 = tail call i64 @llvm.umulh.i64(i64 %8, i64 %i.ac)
  %11 = tail call i64 @llvm.umulh.i64(i64 %8, i64 %10)
  %i.at = sub i64 -4611686018427387904, %11
  %i.au = zext i64 %i.at to i128
  %i.av = mul nuw i128 %i.au, %9                  ; 2 uses
  ...
  %i.az = extractvalue { i64, i1 } %i.ax, 0       ; 3 uses
  ...
  %i.bj = zext i64 %i.az to i128                  ; 2 uses
  %i.bk = mul nuw i128 %i.bj, %i.ar               ; 2 uses
  %i.bl = trunc i128 %i.bk to i64
  %i.bm = lshr i128 %i.bk, 64
  %i.bn = trunc nuw i128 %i.bm to i64
  %12 = tail call i64 @llvm.umulh.i64(i64 %i.az, i64 %i.ab)
  %i.bo = mul nuw i128 %i.be, %i.ar               ; 2 uses
  ...
  %i.ce = tail call { i64, i1 } @llvm.uadd.with.overflow.i64(i64 %i.bu, i64 %12)
  ...
  %13 = tail call i64 @llvm.umulh.i64(i64 %i.az, i64 %i.cm)
  ...
  %i.dq = tail call { i64, i1 } @llvm.uadd.with.overflow.i64(i64 %i.dh, i64 %13)
  ...
  %i.ec = extractvalue { i64, i1 } %i.ea, 0       ; 2 uses
  ...
  %14 = tail call i64 @llvm.umulh.i64(i64 %i.cm, i64 %i.ec)
  ...
  %i.fe = tail call { i64, i1 } @llvm.uadd.with.overflow.i64(i64 %i.eu, i64 %14)
...
._crit_edge.i:                                    ; preds = %bb.k, %bb.j
  %i.ag = phi i64 [ %i.ae, %bb.k ], [ %i.ad, %bb.j ] ; 3 uses
  %i.ah = phi i64 [ %i.af, %bb.k ], [ %i.w, %bb.j ] ; 4 uses
  %i.ai = lshr i64 %i.ah, 32
  ...
  %i.av = mul i64 %i.at, %i.au                    ; 3 uses
  %i.aw = zext i64 %i.ah to i128                  ; 2 uses
  %5 = tail call i64 @llvm.umulh.i64(i64 %i.av, i64 %i.ah)
  %6 = tail call i64 @llvm.umulh.i64(i64 %i.av, i64 %5)
  %i.ax = sub i64 -4611686018427387904, %6
  %7 = tail call i64 @llvm.umulh.i64(i64 %i.av, i64 %i.ax)
  %8 = shl i64 %7, 1                              ; 3 uses
  %9 = zext i64 %8 to i128
  %10 = tail call i64 @llvm.umulh.i64(i64 %8, i64 %i.ah)
  %11 = tail call i64 @llvm.umulh.i64(i64 %8, i64 %10)
  %i.ay = sub i64 -4611686018427387904, %11
  %i.az = zext i64 %i.ay to i128
  %i.ba = mul nuw i128 %i.az, %9                  ; 2 uses
  ...
  %i.be = extractvalue { i64, i1 } %i.bc, 0       ; 3 uses
  ...
  %i.bi = zext i64 %i.ag to i128
  %i.bj = zext i64 %i.bh to i128                  ; 4 uses
  %i.bk = mul nuw i128 %i.bj, %i.bi               ; 2 uses
  %i.bl = trunc i128 %i.bk to i64
  %i.bm = lshr i128 %i.bk, 64
  %i.bn = trunc nuw i128 %i.bm to i64
  %i.bo = zext i64 %i.be to i128                  ; 2 uses
  %i.bp = mul nuw i128 %i.bo, %i.aw               ; 2 uses
  %i.bq = trunc i128 %i.bp to i64
  %i.br = lshr i128 %i.bp, 64
  %i.bs = trunc nuw i128 %i.br to i64
  %12 = tail call i64 @llvm.umulh.i64(i64 %i.be, i64 %i.ag)
  %i.bt = mul nuw i128 %i.bj, %i.aw               ; 2 uses
  ...
  %i.cj = tail call { i64, i1 } @llvm.uadd.with.overflow.i64(i64 %i.bz, i64 %12)
  ...
  %13 = tail call i64 @llvm.umulh.i64(i64 %i.be, i64 %i.cr)
  ...
  %i.dv = tail call { i64, i1 } @llvm.uadd.with.overflow.i64(i64 %i.dm, i64 %13)
  ...
  %14 = tail call i64 @llvm.umulh.i64(i64 %i.cr, i64 %i.eh)
  ...
  %i.fj = tail call { i64, i1 } @llvm.uadd.with.overflow.i64(i64 %i.ez, i64 %14)
...
bb.m:                                             ; preds = %bb.l
  ...
  %2 = tail call i64 @llvm.umulh.i64(i64 %.01729, i64 %.01729)
  ...
  %i.az = tail call { i64, i1 } @llvm.uadd.with.overflow.i64(i64 %i.ap, i64 %2)
