...
bb.f:                                             ; preds = %bb.e
  ...
  %.069.i = select i1 %i.ac, ptr %i.aa, ptr %i.z
  br label %bb.h
...
bb.g:                                             ; preds = %bb.e
  ...
  %spec.select77.i = select i1 %i.ae, ptr %i.af, ptr %i.z
  br label %bb.h

bb.h:                                             ; preds = %bb.g, %bb.f
  %.sink.i = phi i1 [ %i.ae, %bb.g ], [ %i.ac, %bb.f ] ; 3 uses
  %.1.i = phi ptr [ %spec.select77.i, %bb.g ], [ %.069.i, %bb.f ] ; 15 uses
  %.1.i51 = ptrtoaddr ptr %.1.i to i64
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.be = getelementptr inbounds nuw [8 x i8], ptr %.1.i, i64 %index ; 2 uses
...
.lr.ph.split.i.i.prol:                            ; preds = %.lr.ph.split.i.i.preheader104, %.lr.ph.split.i.i.prol
  ...
  %i.bj = getelementptr inbounds nuw [8 x i8], ptr %.1.i, i64 %indvars.iv.i.i.prol
...
vector.memcheck53:                                ; preds = %.lr.ph.split.us.i.i.preheader
  ...
  %scevgep54 = getelementptr i8, ptr %.1.i, i64 %i.bp
  %bound0 = icmp ult ptr %i.aw, %scevgep54
  %bound1 = icmp ult ptr %.1.i, %scevgep
...
vector.body59:                                    ; preds = %vector.body59, %vector.ph57
  ...
  %i.bq = getelementptr inbounds nuw [4 x i8], ptr %.1.i, i64 %index60 ; 2 uses
...
.lr.ph.split.us.i.i.prol:                         ; preds = %.lr.ph.split.us.i.i.preheader103, %.lr.ph.split.us.i.i.prol
  ...
  %i.bx = getelementptr inbounds nuw [4 x i8], ptr %.1.i, i64 %indvars.iv14.i.i.prol
...
.lr.ph.split.us.i.i:                              ; preds = %.lr.ph.split.us.i.i.prol.loopexit, %.lr.ph.split.us.i.i
  ...
  %i.cd = getelementptr inbounds nuw [4 x i8], ptr %.1.i, i64 %indvars.iv14.i.i
  ...
  %i.ch = getelementptr inbounds nuw [4 x i8], ptr %.1.i, i64 %indvars.iv.next15.i.i
  ...
  %i.cl = getelementptr inbounds nuw [4 x i8], ptr %.1.i, i64 %indvars.iv.next15.i.i.1
  ...
  %i.cp = getelementptr inbounds nuw [4 x i8], ptr %.1.i, i64 %indvars.iv.next15.i.i.2
...
.lr.ph.split.i.i:                                 ; preds = %.lr.ph.split.i.i.prol.loopexit, %.lr.ph.split.i.i
  ...
  %i.ct = getelementptr inbounds nuw [8 x i8], ptr %.1.i, i64 %indvars.iv.i.i
  ...
  %i.cw = getelementptr inbounds nuw [8 x i8], ptr %.1.i, i64 %indvars.iv.next.i.i
  ...
  %i.cz = getelementptr inbounds nuw [8 x i8], ptr %.1.i, i64 %indvars.iv.next.i.i.1
  ...
  %i.dc = getelementptr inbounds nuw [8 x i8], ptr %.1.i, i64 %indvars.iv.next.i.i.2
...
bb.d:                                             ; preds = %.lr.ph192, %bb.d
  ...
  %.0140189 = phi ptr [ %gep197, %.lr.ph192 ], [ %i.bt, %bb.d ] ; 2 uses
  ...
  store i16 %i.bk, ptr %.0140189, align 2
  ...
  %i.br = ptrtoint ptr %.0140189 to i64
  %i.bs = add i64 %i.br, 2
...
bb.e:                                             ; preds = %.lr.ph182, %bb.e
  ...
  %.0143179 = phi ptr [ %gep187, %.lr.ph182 ], [ %i.dd, %bb.e ] ; 2 uses
  ...
  store i32 %i.cu, ptr %.0143179, align 4
  ...
  %i.db = ptrtoint ptr %.0143179 to i64
  %i.dc = add i64 %i.db, 4
...
bb.g:                                             ; preds = %.lr.ph172, %bb.g
  ...
  %.0146169 = phi ptr [ %gep177, %.lr.ph172 ], [ %i.fl, %bb.g ] ; 2 uses
  ...
  store i16 %i.fc, ptr %.0146169, align 2
  ...
  %i.fj = ptrtoint ptr %.0146169 to i64
  %i.fk = add i64 %i.fj, 2
...
.prol.loopexit:                                   ; preds = %.prol.loopexit.unr-lcssa, %.lr.ph
  ...
  %.0149164.unr = phi ptr [ %gep, %.lr.ph ], [ %i.gn, %.prol.loopexit.unr-lcssa ]
...
.lr.ph.new:                                       ; preds = %.prol.loopexit, %.lr.ph.new
  ...
  %.0149164 = phi ptr [ %i.hh, %.lr.ph.new ], [ %.0149164.unr, %.prol.loopexit ] ; 2 uses
  ...
  store i32 %i.gp, ptr %.0149164, align 4
  ...
  %i.gw = ptrtoint ptr %.0149164 to i64           ; 2 uses
  %i.gx = add i64 %i.gw, 4
