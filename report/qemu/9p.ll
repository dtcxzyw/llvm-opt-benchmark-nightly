...
begin_hunk_0_@v9fs_renameat:bb.a
...
sub_135:                                          ; preds = %.tail
  ...
  %i.q = sub nsw i32 46, %i.p
  %.not39 = icmp eq i8 %i.o, 46
...
.tail33:                                          ; preds = %.tail.thread, %sub_135, %sub_2
  %i.v = phi i32 [ %i.m, %.tail.thread ], [ %i.q, %sub_135 ], [ %i.u, %sub_2 ]
...
bb.d:                                             ; preds = %bb.c
  ...
  br i1 %i.aa, label %name_is_illegal.exit.thread, label %bb.e

bb.e:                                             ; preds = %bb.d
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %2, i8 0, i64 16, i1 false)
  %i.ab = getelementptr inbounds nuw i8, ptr %i.z, i64 8 ; 2 uses
  %i.ac = load ptr, ptr %i.c, align 8
  %i.ad = call i32 @v9fs_co_name_to_path(ptr noundef %0, ptr noundef nonnull %i.ab, ptr noundef %i.ac, ptr noundef nonnull %2) #23 ; 2 uses
  %i.ae = icmp slt i32 %i.ad, 0
  br i1 %i.ae, label %bb.h, label %bb.f

bb.f:                                             ; preds = %bb.e
  %i.af = call i32 @v9fs_mark_fids_unreclaim(ptr noundef %0, ptr noundef nonnull %2) ; 2 uses
...
bb.h:                                             ; preds = %bb.g, %bb.f, %bb.e
  %.020 = phi i32 [ %i.ad, %bb.e ], [ %i.af, %bb.f ], [ %spec.select30, %bb.g ]
  %i.ai = getelementptr inbounds nuw i8, ptr %i.z, i64 260 ; 2 uses
  %i.aj = load i32, ptr %i.ai, align 4            ; 2 uses
  %.not.i31 = icmp eq i32 %i.aj, 0
...
bb.k:                                             ; preds = %bb.j
  %i.al = getelementptr inbounds nuw i8, ptr %i.z, i64 264
  %i.am = load i8, ptr %i.al, align 8, !range !14, !noundef !15
  %i.an = trunc nuw i8 %i.am to i1
  br i1 %i.an, label %bb.l, label %put_fid.exit
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.as = getelementptr inbounds nuw i8, ptr %i.ar, i64 7368
  %i.at = load i32, ptr %i.as, align 8
  %i.au = icmp eq i32 %i.ap, %i.at
  br i1 %i.au, label %bb.m, label %bb.n

bb.m:                                             ; preds = %bb.l
  %i.av = getelementptr inbounds nuw i8, ptr %i.ar, i64 7376
  call void @migrate_del_blocker(ptr noundef nonnull %i.av) #23
  br label %bb.n

bb.n:                                             ; preds = %bb.m, %bb.l
  %i.aw = call i32 @free_fid(ptr noundef nonnull %0, ptr noundef nonnull %i.z) ; 0 uses
  br label %put_fid.exit

put_fid.exit:                                     ; preds = %bb.j, %bb.k, %bb.n
  %i.ax = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.ay = load ptr, ptr %i.ax, align 8
  call void @g_free(ptr noundef %i.ay) #23
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %2, i8 0, i64 16, i1 false)
...
name_is_illegal.exit.thread:                      ; preds = %bb.b, %bb.d, %bb.c, %.tail33, %.tail, %name_is_illegal.exit, %bb.a, %put_fid.exit
  ...
  call void @pdu_complete(ptr noundef %0, i64 noundef %i.az)
  call void @v9fs_string_free(ptr noundef nonnull %1) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #23
...
bb.n:                                             ; preds = %bb.m
  %i.aq = call zeroext i1 (ptr, ptr, ...) @warn_report_once_cond(ptr noundef nonnull @v9fs_version.print_once_.97, ptr noundef nonnull @.str.98) #23 ; 0 uses
  br label %bb.o

bb.o:                                             ; preds = %thread-pre-split, %bb.m, %bb.n, %bb.g
  %i.ar = load i32, ptr %i.d, align 4
  %i.as = call i64 (ptr, i64, ptr, ...) @pdu_marshal(ptr noundef nonnull %0, i64 noundef 7, ptr noundef nonnull @.str.91, i32 noundef %i.ar, ptr noundef nonnull %1) ; 3 uses
  %i.at = icmp slt i64 %i.as, 0
  br i1 %i.at, label %trace_v9fs_version_return.exit, label %bb.p

bb.p:                                             ; preds = %bb.o
  %i.au = add nuw i64 %i.as, 7                    ; 4 uses
  %i.av = load i16, ptr %i.g, align 4
  %i.aw = load i8, ptr %i.i, align 2
  %i.ax = load i32, ptr %i.d, align 4
  %i.ay = load ptr, ptr %i.c, align 8
  %i.az = load i32, ptr @trace_events_enabled_count, align 4
  %.not.i39 = icmp eq i32 %i.az, 0
  br i1 %.not.i39, label %trace_v9fs_version_return.exit, label %bb.q, !prof !16

bb.q:                                             ; preds = %bb.p
  %i.ba = load i16, ptr @_TRACE_V9FS_VERSION_RETURN_DSTATE, align 2
  %.not3.i40 = icmp eq i16 %i.ba, 0
  br i1 %.not3.i40, label %trace_v9fs_version_return.exit, label %bb.r
