...
.lr.ph.i:                                         ; preds = %bb.c, %bb.e
  %.01428.i = phi i64 [ %i.y, %bb.e ], [ %4, %bb.c ] ; 2 uses
  %.01627.i = phi i64 [ %i.x, %bb.e ], [ %3, %bb.c ] ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #19
  store i64 0, ptr %i.b, align 8, !annotation !11
  %i.p = call i32 @blk_co_block_status_above(ptr noundef %2, ptr noundef null, i64 noundef %.01627.i, i64 noundef %.01428.i, ptr noundef nonnull %i.b, ptr noundef null, ptr noundef null) #19 ; 3 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.x = add i64 %i.w, %.01627.i
  %i.y = sub i64 %.01428.i, %i.w                  ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #19
...
.lr.ph.i21:                                       ; preds = %bb.f, %bb.h
  %.01224.i = phi i64 [ %i.ag, %bb.h ], [ %4, %bb.f ] ; 2 uses
  %.01423.i = phi i64 [ %i.af, %bb.h ], [ %3, %bb.f ] ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #19
  store i64 0, ptr %i.a, align 8, !annotation !11
  %i.z = call i32 @blk_co_is_allocated_above(ptr noundef %2, ptr noundef null, i1 noundef zeroext false, i64 noundef %.01423.i, i64 noundef %.01224.i, ptr noundef nonnull %i.a) #19 ; 3 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.af = add i64 %i.ae, %.01423.i
  %i.ag = sub i64 %.01224.i, %i.ae                ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #19
...
blockstatus_to_extents.exit:                      ; preds = %.thread.i24, %.thread.i
  %.0 = phi i32 [ %.1.ph.i25, %.thread.i24 ], [ %.1.ph.i, %.thread.i ] ; 2 uses
  %i.ah = icmp slt i32 %.0, 0
...
glib_autoptr_cleanup_NBDExtentArray.exit:         ; preds = %blockstatus_to_extents.exit.thread, %bb.i
  %.020 = phi i32 [ %i.aj, %bb.i ], [ %i.ak, %blockstatus_to_extents.exit.thread ]
...
.lr.ph.i:                                         ; preds = %nbd_extent_array_new.exit, %bb.d
  %.01618.i = phi i64 [ %i.aa, %bb.d ], [ %3, %nbd_extent_array_new.exit ]
  %i.r = load i64, ptr %i.a, align 8
  %i.s = sub i64 %i.r, %.01618.i
...
.critedge.i:                                      ; preds = %bb.d, %nbd_extent_array_new.exit
  %.016.lcssa.i = phi i64 [ %3, %nbd_extent_array_new.exit ], [ %i.aa, %bb.d ]
  %i.ac = sub i64 %i.o, %.016.lcssa.i
...
bb.c:                                             ; preds = %.lr.ph, %.thread67
  %.05488 = phi i64 [ 0, %.lr.ph ], [ %i.bt, %.thread67 ] ; 5 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #19
  store i64 0, ptr %i.a, align 8, !annotation !11
  %i.o = load ptr, ptr %i.e, align 8
  %i.p = add i64 %.05488, %2                      ; 5 uses
  %i.q = sub nuw nsw i64 %4, %.05488              ; 2 uses
...
bb.n:                                             ; preds = %bb.f
  ...
  %i.bl = getelementptr inbounds nuw i8, ptr %3, i64 %.05488 ; 2 uses
...
.thread67:                                        ; preds = %nbd_co_send_iov.exit, %bb.p
  ...
  %i.bt = add i64 %i.bs, %.05488                  ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #19
