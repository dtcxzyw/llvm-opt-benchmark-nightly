...
bb.e:                                             ; preds = %bb.d
  ...
  %i.p = load i8, ptr %i.o, align 16, !range !12, !noundef !13
...
bb.c:                                             ; preds = %bb.b, %.lr.ph.i
  ...
  br i1 %exitcond.not.i, label %read_hvipriox.exit, label %.lr.ph.i, !llvm.loop !3
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.m = load i8, ptr %i.l, align 16, !range !12, !noundef !13
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.n = load i8, ptr %i.m, align 16, !range !12, !noundef !13
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.l = load i8, ptr %i.k, align 16, !range !12, !noundef !13
...
!18 = !{i64 2897998}
!19 = distinct !{ptr @riscv_csrrw, null}
!20 = distinct !{ptr @riscv_csrrw, null}
!21 = distinct !{ptr @riscv_csrr, null}
!22 = distinct !{ptr @riscv_csrr, null}
!23 = distinct !{!23, !17, !29, !30}
!24 = distinct !{!24, !17, !29}
!25 = distinct !{!25, !17, !29, !30}
!26 = distinct !{!26, !17, !29, !30}
!27 = distinct !{!27, !17, !29}
!28 = distinct !{null}
!29 = !{!"llvm.loop.isvectorized", i32 1}
!30 = !{!"llvm.loop.unroll.runtime.disable"}
!31 = !{!"branch_weights", i32 8, i32 8}
!32 = distinct !{!32, !17, !33}
!33 = !{!"llvm.loop.peeled.count", i32 3}
!34 = distinct !{!34, !17}
!35 = distinct !{!35, !17}
!36 = distinct !{!36, !37}
