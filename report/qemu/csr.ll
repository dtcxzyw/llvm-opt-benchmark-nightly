...
.thread:                                          ; preds = %bb.a
  ...
  %i.i = and i32 %.val26, 1048576
  %.not = icmp eq i32 %i.i, 0                     ; 2 uses
  %4 = select i1 %.not, i64 -4323455642275676161, i64 -3170534137668829185
  %i.j = and i32 %.val26, 262144
  %.not16 = icmp eq i32 %i.j, 0                   ; 2 uses
  %5 = select i1 %.not16, i64 0, i64 2305843009213693952
  %i.k = or disjoint i64 %4, %5
  %i.l = and i32 %.val26, 128
  %.not17 = icmp eq i32 %i.l, 0
  %6 = select i1 %.not, i64 0, i64 288230376151711744
  %7 = select i1 %.not16, i64 0, i64 576460752303423488
  %i.m = or disjoint i64 %6, %7
...
.thread:                                          ; preds = %bb.a
  ...
  %i.d = and i32 %.val25, 1048576
  %.not = icmp eq i32 %i.d, 0                     ; 2 uses
  %4 = select i1 %.not, i64 -4323455642275676161, i64 -3170534137668829185
  %i.e = and i32 %.val25, 262144
  %.not15 = icmp eq i32 %i.e, 0                   ; 2 uses
  %5 = select i1 %.not15, i64 0, i64 2305843009213693952
  %i.f = or disjoint i64 %4, %5
  %i.g = and i32 %.val25, 128
  %.not16 = icmp eq i32 %i.g, 0
  %6 = select i1 %.not, i64 0, i64 288230376151711744
  %7 = select i1 %.not15, i64 0, i64 576460752303423488
  %i.h = or disjoint i64 %6, %7
  %i.i = select i1 %.not16, i64 0, i64 %i.h
  %i.j = or disjoint i64 %i.f, %i.i
  %i.k = and i64 %i.j, %2
  br label %bb.b
...
.thread:                                          ; preds = %bb.a
  ...
  %i.l = and i32 %.val32, 1048576
  %.not = icmp eq i32 %i.l, 0                     ; 2 uses
  %4 = select i1 %.not, i64 -4323455642275676161, i64 -3170534137668829185
  %i.m = and i32 %.val32, 262144
  %.not22 = icmp eq i32 %i.m, 0                   ; 2 uses
  %5 = select i1 %.not22, i64 0, i64 2305843009213693952
  %i.n = or disjoint i64 %4, %5
  %i.o = and i32 %.val32, 128
  %.not23 = icmp eq i32 %i.o, 0
  %6 = select i1 %.not, i64 0, i64 288230376151711744
  %7 = select i1 %.not22, i64 0, i64 576460752303423488
  %i.p = or disjoint i64 %6, %7
...
.thread:
  ...
  %4 = select i1 %.not, i64 3288334335, i64 3556769791
  %i.c = and i32 %.val22, 262144
  %.not13 = icmp eq i32 %i.c, 0                   ; 2 uses
  %5 = select i1 %.not13, i64 0, i64 536870912
  %6 = or disjoint i64 %4, %5
  %7 = and i32 %.val22, 128
  %.not14 = icmp eq i32 %7, 0
  %8 = select i1 %.not, i64 0, i64 67108864
  %9 = select i1 %.not13, i64 0, i64 134217728
  %10 = or disjoint i64 %8, %9
  %11 = select i1 %.not14, i64 0, i64 %10
...
.thread:
  ...
  %i.b = and i32 %.val29, 1048576
  %.not = icmp eq i32 %i.b, 0                     ; 2 uses
  %4 = select i1 %.not, i64 3288334335, i64 3556769791
  %i.c = and i32 %.val29, 262144
  %.not20 = icmp eq i32 %i.c, 0                   ; 2 uses
  %5 = select i1 %.not20, i64 0, i64 536870912
  %6 = or disjoint i64 %4, %5
  %7 = and i32 %.val29, 128
  %.not21 = icmp eq i32 %7, 0
  %8 = select i1 %.not, i64 0, i64 67108864
  %9 = select i1 %.not20, i64 0, i64 134217728
  %10 = or disjoint i64 %8, %9
  %11 = select i1 %.not21, i64 0, i64 %10
  %12 = or disjoint i64 %6, %11
