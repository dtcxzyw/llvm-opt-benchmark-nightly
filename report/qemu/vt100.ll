...
.lr.ph.i29:                                       ; preds = %bb.cz, %.lr.ph.i29
  ...
  br i1 %exitcond.not.i, label %.loopexit46.i, label %.lr.ph.i29, !llvm.loop !37
...
.lr.ph49.i:                                       ; preds = %.loopexit46.i, %.lr.ph49.i
  ...
  br i1 %i.sy, label %.lr.ph49.i, label %vt100_putchar.exit, !llvm.loop !38

bb.da:                                            ; preds = %trace_console_putchar_csi.exit.i
  %i.sz = load i32, ptr @trace_events_enabled_count, align 4
  %.not.i = icmp eq i32 %i.sz, 0
  br i1 %.not.i, label %vt100_putchar.exit, label %bb.db, !prof !40
...
bb.di:                                            ; preds = %._crit_edge
  ...
  tail call void %i.to(ptr noundef nonnull %0, i32 noundef %i.tg, i32 noundef %i.tj, i32 noundef %i.tk, i32 noundef %i.tm) #10, !inline_history !0
  br label %bb.dj
...
bb.a:
  %i.a = load i8, ptr @cursor_visible_phase, align 1, !range !13, !noundef !14
  %i.b = xor i8 %i.a, 1
...
.preheader.i:                                     ; preds = %bb.a, %.preheader.i
  ...
  br i1 %.not.i, label %bb.b, label %.preheader.i, !llvm.loop !2
...
bb.g:                                             ; preds = %._crit_edge
  ...
  store i64 4503599627370496, ptr %2, align 8, !annotation !10
