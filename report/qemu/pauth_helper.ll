...
extract64.exit41:
  ...
  %i.ak = lshr i64 %0, 36
  %i.al = lshr i64 %0, 52
  %i.am = trunc i64 %0 to i32
  %i.an = trunc i64 %0 to i32
  %1 = lshr i32 %i.an, 20
  %2 = lshr i32 %i.am, 4
  %3 = and i32 %2, 15
  %4 = and i32 %1, 15
  %5 = mul nuw nsw i32 %3, 17                     ; 2 uses
  %6 = mul nuw nsw i32 %4, 17                     ; 2 uses
  %7 = lshr i32 %5, 3                             ; 2 uses
  %8 = insertelement <4 x i32> poison, i32 %6, i64 0
  %9 = lshr i32 %5, 2
  %10 = lshr i32 %6, 2
  %i.ao = trunc nuw nsw i64 %i.al to i32
  %i.ap = trunc nuw nsw i64 %i.ak to i32
  %11 = and i32 %i.ao, 15
  %12 = and i32 %i.ap, 15
  %13 = mul nuw nsw i32 %11, 17                   ; 2 uses
  %14 = mul nuw nsw i32 %12, 17                   ; 2 uses
  %i.aq = insertelement <4 x i32> %8, i32 %14, i64 1
  %i.ar = insertelement <4 x i32> %i.aq, i32 %13, i64 2
  %15 = lshr <4 x i32> %i.ar, <i32 3, i32 3, i32 3, i32 poison> ; 3 uses
  %16 = shufflevector <4 x i32> %15, <4 x i32> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 1>
  %17 = insertelement <2 x i32> poison, i32 %14, i64 0
  %18 = insertelement <2 x i32> %17, i32 %13, i64 1
  %19 = lshr <2 x i32> %18, splat (i32 2)
  %20 = shufflevector <4 x i32> %15, <4 x i32> poison, <2 x i32> <i32 2, i32 poison>
  %21 = insertelement <2 x i32> %20, i32 %7, i64 1
  %22 = xor <2 x i32> %21, %19
  %23 = extractelement <4 x i32> %15, i64 0
  %24 = xor i32 %23, %9
  %25 = xor i32 %7, %10
  %26 = shufflevector <2 x i32> %22, <2 x i32> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %27 = insertelement <4 x i32> %26, i32 %24, i64 2
  %28 = insertelement <4 x i32> %27, i32 %25, i64 3
  %i.as = xor <4 x i32> %28, %16
  %i.at = lshr i64 %0, 40
  %i.au = lshr i64 %0, 56
  %i.av = trunc i64 %0 to i32
  %i.aw = trunc i64 %0 to i32
  %29 = lshr i32 %i.aw, 24
  %30 = lshr i32 %i.av, 8
  %31 = and i32 %30, 15
  %32 = and i32 %29, 15
  %33 = mul nuw nsw i32 %31, 17                   ; 2 uses
  %34 = mul nuw nsw i32 %32, 17                   ; 2 uses
  %35 = lshr i32 %33, 3                           ; 2 uses
  %36 = insertelement <4 x i32> poison, i32 %34, i64 0
  %37 = lshr i32 %33, 2
  %38 = lshr i32 %34, 2
  %i.ax = trunc nuw nsw i64 %i.au to i32
  %i.ay = trunc nuw nsw i64 %i.at to i32
  %39 = and i32 %i.ax, 15
  %40 = and i32 %i.ay, 15
  %41 = mul nuw nsw i32 %39, 17                   ; 2 uses
  %42 = mul nuw nsw i32 %40, 17                   ; 2 uses
  %i.az = insertelement <4 x i32> %36, i32 %42, i64 1
  %i.ba = insertelement <4 x i32> %i.az, i32 %41, i64 2
  %43 = lshr <4 x i32> %i.ba, <i32 3, i32 3, i32 3, i32 poison> ; 3 uses
  %44 = shufflevector <4 x i32> %43, <4 x i32> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 1>
  %45 = insertelement <2 x i32> poison, i32 %42, i64 0
  %46 = insertelement <2 x i32> %45, i32 %41, i64 1
  %47 = lshr <2 x i32> %46, splat (i32 2)
  %48 = shufflevector <4 x i32> %43, <4 x i32> poison, <2 x i32> <i32 2, i32 poison>
  %49 = insertelement <2 x i32> %48, i32 %35, i64 1
  %50 = xor <2 x i32> %49, %47
  %51 = extractelement <4 x i32> %43, i64 0
  %52 = xor i32 %51, %37
  %53 = xor i32 %35, %38
  %54 = shufflevector <2 x i32> %50, <2 x i32> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %55 = insertelement <4 x i32> %54, i32 %52, i64 2
  %56 = insertelement <4 x i32> %55, i32 %53, i64 3
  %i.bb = xor <4 x i32> %56, %44
  %i.bc = lshr i64 %0, 44
  %i.bd = lshr i64 %0, 60
  ...
  %57 = mul nuw nsw i32 %i.bi, 17                 ; 2 uses
  %i.bj = mul nuw nsw i32 %i.bg, 17               ; 2 uses
  %58 = lshr i32 %57, 3                           ; 2 uses
  %59 = insertelement <4 x i32> poison, i32 %i.bj, i64 0
  %60 = lshr i32 %57, 2
  %i.bk = lshr i32 %i.bj, 2
  %61 = trunc nuw nsw i64 %i.bd to i32
  %62 = trunc nuw nsw i64 %i.bc to i32
  %63 = and i32 %62, 15
  %64 = mul nuw nsw i32 %61, 17                   ; 2 uses
  %65 = mul nuw nsw i32 %63, 17                   ; 2 uses
  %i.bl = insertelement <4 x i32> %59, i32 %65, i64 1
  %i.bm = insertelement <4 x i32> %i.bl, i32 %64, i64 2
  %i.bn = lshr <4 x i32> %i.bm, <i32 3, i32 3, i32 3, i32 poison> ; 3 uses
  %66 = shufflevector <4 x i32> %i.bn, <4 x i32> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 1>
  %67 = insertelement <2 x i32> poison, i32 %65, i64 0
  %68 = insertelement <2 x i32> %67, i32 %64, i64 1
  %69 = lshr <2 x i32> %68, splat (i32 2)
  %70 = shufflevector <4 x i32> %i.bn, <4 x i32> poison, <2 x i32> <i32 2, i32 poison>
  %71 = insertelement <2 x i32> %70, i32 %58, i64 1
  %72 = xor <2 x i32> %71, %69
  %73 = extractelement <4 x i32> %i.bn, i64 0
  %74 = xor i32 %73, %60
  %75 = xor i32 %58, %i.bk
  %76 = shufflevector <2 x i32> %72, <2 x i32> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %77 = insertelement <4 x i32> %76, i32 %74, i64 2
  %78 = insertelement <4 x i32> %77, i32 %75, i64 3
  %i.bo = xor <4 x i32> %78, %66
  ...
  %i.bu = shl nuw nsw <4 x i64> %i.bt, <i64 4, i64 20, i64 36, i64 52>
  %i.bv = and <4 x i32> %i.bb, splat (i32 15)
  %i.bw = zext nneg <4 x i32> %i.bv to <4 x i64>
  %i.bx = shl nuw nsw <4 x i64> %i.bw, <i64 8, i64 24, i64 40, i64 56>
  %i.by = and <4 x i32> %i.bo, splat (i32 15)
  %i.bz = zext nneg <4 x i32> %i.by to <4 x i64>
  %i.ca = shl nuw <4 x i64> %i.bz, <i64 12, i64 28, i64 44, i64 60>
