...
extract64.exit41:
  ...
  %i.c = trunc nuw i64 %i.a to i32
  %2 = lshr i32 %i.b, 16
  %3 = and i32 %2, 15
  %i.d = and i32 %i.c, 15
  %i.e = mul nuw nsw i32 %3, 17                   ; 2 uses
  %i.f = mul nuw nsw i32 %i.d, 17                 ; 2 uses
  %i.g = lshr i32 %i.e, 2
  %i.h = lshr i32 %i.f, 2
  ...
  %i.i = and i32 %4, 15
  %6 = and i32 %5, 15
  %7 = mul nuw nsw i32 %i.i, 17                   ; 2 uses
  %8 = mul nuw nsw i32 %6, 17                     ; 2 uses
  %i.j = lshr i32 %8, 3                           ; 2 uses
  %9 = insertelement <4 x i32> poison, i32 %7, i64 0
  %10 = insertelement <4 x i32> %9, i32 %i.f, i64 1
  %11 = insertelement <4 x i32> %10, i32 %i.e, i64 2
  %12 = lshr <4 x i32> %11, <i32 3, i32 3, i32 3, i32 poison> ; 3 uses
  %13 = shufflevector <4 x i32> %12, <4 x i32> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 1>
  %14 = insertelement <2 x i32> poison, i32 %8, i64 0
  %15 = insertelement <2 x i32> %14, i32 %7, i64 1
  %16 = lshr <2 x i32> %15, splat (i32 2)
  %i.k = xor i32 %i.j, %i.g
  %17 = extractelement <4 x i32> %12, i64 0
  %18 = xor i32 %17, %i.h
  %19 = shufflevector <4 x i32> %12, <4 x i32> poison, <2 x i32> <i32 2, i32 poison>
  %20 = insertelement <2 x i32> %19, i32 %i.j, i64 1
  %21 = xor <2 x i32> %20, %16
  %22 = shufflevector <2 x i32> %21, <2 x i32> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %23 = insertelement <4 x i32> %22, i32 %18, i64 2
  %24 = insertelement <4 x i32> %23, i32 %i.k, i64 3
  %25 = xor <4 x i32> %24, %13
  %i.l = lshr i64 %0, 36
  %26 = lshr i64 %0, 52
  ...
  %i.p = lshr i32 %i.n, 4
  %i.q = lshr i32 %i.o, 20
  %28 = insertelement <4 x i32> poison, i32 %i.q, i64 0
  %29 = insertelement <4 x i32> %28, i32 %i.p, i64 1
  %30 = insertelement <4 x i32> %29, i32 %27, i64 2
  %31 = insertelement <4 x i32> %30, i32 %i.m, i64 3
  %32 = and <4 x i32> %31, splat (i32 15)
  %33 = mul nuw nsw <4 x i32> %32, splat (i32 17) ; 3 uses
  %34 = extractelement <4 x i32> %33, i64 1
  %i.r = lshr i32 %34, 3
  %35 = lshr <4 x i32> %33, <i32 3, i32 poison, i32 3, i32 3>
  %36 = shufflevector <4 x i32> %35, <4 x i32> poison, <4 x i32> <i32 3, i32 2, i32 3, i32 0> ; 2 uses
  %37 = lshr <4 x i32> %33, splat (i32 2)
  %38 = insertelement <4 x i32> poison, i32 %i.r, i64 0
  %39 = shufflevector <4 x i32> %38, <4 x i32> %36, <4 x i32> <i32 0, i32 7, i32 0, i32 5>
  %40 = xor <4 x i32> %39, %37
  %41 = xor <4 x i32> %40, %36
  %i.s = lshr i64 %0, 40
  %42 = lshr i64 %0, 56
  ...
  %i.w = lshr i32 %i.u, 8
  %i.x = lshr i32 %i.v, 24
  %44 = insertelement <4 x i32> poison, i32 %i.x, i64 0
  %45 = insertelement <4 x i32> %44, i32 %i.w, i64 1
  %46 = insertelement <4 x i32> %45, i32 %43, i64 2
  %47 = insertelement <4 x i32> %46, i32 %i.t, i64 3
  %48 = and <4 x i32> %47, splat (i32 15)
  %49 = mul nuw nsw <4 x i32> %48, splat (i32 17) ; 3 uses
  %50 = extractelement <4 x i32> %49, i64 1
  %i.y = lshr i32 %50, 3
  %51 = lshr <4 x i32> %49, <i32 3, i32 poison, i32 3, i32 3>
  %52 = shufflevector <4 x i32> %51, <4 x i32> poison, <4 x i32> <i32 3, i32 2, i32 3, i32 0> ; 2 uses
  %53 = lshr <4 x i32> %49, splat (i32 2)
  %54 = insertelement <4 x i32> poison, i32 %i.y, i64 0
  %55 = shufflevector <4 x i32> %54, <4 x i32> %52, <4 x i32> <i32 0, i32 7, i32 0, i32 5>
  %56 = xor <4 x i32> %55, %53
  %57 = xor <4 x i32> %56, %52
  %58 = lshr i64 %0, 44
  %i.z = lshr i64 %0, 60
  %i.aa = trunc nuw nsw i64 %58 to i32
  %59 = trunc nuw nsw i64 %i.z to i32
  %i.ab = trunc i64 %0 to i32
  %60 = trunc i64 %0 to i32
  %61 = lshr i32 %i.ab, 12
  %i.ac = lshr i32 %60, 28
  %i.ad = and i32 %i.aa, 15
  %62 = and i32 %61, 15
  %63 = mul nuw nsw i32 %i.ad, 17                 ; 2 uses
  %i.ae = mul nuw nsw i32 %59, 17                 ; 2 uses
  %64 = mul nuw nsw i32 %62, 17                   ; 2 uses
  %i.af = mul nuw nsw i32 %i.ac, 17               ; 2 uses
  %i.ag = lshr i32 %64, 3
  %65 = insertelement <4 x i32> poison, i32 %63, i64 0
  %66 = insertelement <4 x i32> %65, i32 %i.ae, i64 1
  %67 = insertelement <4 x i32> %66, i32 %i.af, i64 2
  %68 = lshr <4 x i32> %67, <i32 3, i32 3, i32 3, i32 poison>
  %69 = shufflevector <4 x i32> %68, <4 x i32> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 2> ; 2 uses
  %70 = insertelement <4 x i32> poison, i32 %i.af, i64 0
  %71 = insertelement <4 x i32> %70, i32 %64, i64 1
  %72 = insertelement <4 x i32> %71, i32 %i.ae, i64 2
  %73 = insertelement <4 x i32> %72, i32 %63, i64 3
  %74 = lshr <4 x i32> %73, splat (i32 2)
  %75 = insertelement <4 x i32> poison, i32 %i.ag, i64 0
  %76 = shufflevector <4 x i32> %75, <4 x i32> %69, <4 x i32> <i32 0, i32 7, i32 0, i32 5>
  %77 = xor <4 x i32> %76, %74
  %78 = xor <4 x i32> %77, %69
  %79 = and <4 x i32> %25, splat (i32 15)
  %80 = zext nneg <4 x i32> %79 to <4 x i64>
  %81 = shl nuw nsw <4 x i64> %80, <i64 32, i64 16, i64 0, i64 48>
  %82 = and <4 x i32> %41, splat (i32 15)
  %83 = zext nneg <4 x i32> %82 to <4 x i64>
  %84 = shl nuw nsw <4 x i64> %83, <i64 52, i64 36, i64 20, i64 4>
  %85 = and <4 x i32> %57, splat (i32 15)
  %86 = zext nneg <4 x i32> %85 to <4 x i64>
  %87 = shl nuw nsw <4 x i64> %86, <i64 56, i64 40, i64 24, i64 8>
  %88 = and <4 x i32> %78, splat (i32 15)
  %89 = zext nneg <4 x i32> %88 to <4 x i64>
  %90 = shl nuw <4 x i64> %89, <i64 60, i64 44, i64 28, i64 12>
  %rdx.op = or disjoint <4 x i64> %81, %84
  %rdx.op45 = or disjoint <4 x i64> %rdx.op, %87
  %rdx.op46 = or disjoint <4 x i64> %rdx.op45, %90
  %91 = tail call i64 @llvm.vector.reduce.or.v4i64(<4 x i64> %rdx.op46)
  ret i64 %91
}
