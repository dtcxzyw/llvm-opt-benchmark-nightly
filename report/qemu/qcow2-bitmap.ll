...
begin_hunk_0_@qcow2_store_persistent_dirty_bitmaps:bb.a
  %i.w = call zeroext i1 @bdrv_dirty_bitmap_inconsistent(ptr noundef nonnull %.0136239) #13
  br i1 %i.w, label %find_bitmap_by_name.exit.thread, label %bb.f

bb.f:                                             ; preds = %bb.e
  %i.x = call zeroext i1 @bdrv_dirty_bitmap_readonly(ptr noundef nonnull %.0136239) #13
  br i1 %i.x, label %bb.g, label %bb.i

bb.g:                                             ; preds = %bb.f
  %.08.i = load ptr, ptr %.0129, align 8          ; 2 uses
...
bb.h:                                             ; preds = %.lr.ph.i
  ...
  br i1 %.not.i159, label %find_bitmap_by_name.exit.thread, label %.lr.ph.i, !llvm.loop !2

find_bitmap_by_name.exit:                         ; preds = %.lr.ph.i
  %i.ad = getelementptr inbounds nuw i8, ptr %.010.i, i64 40
  store ptr %.0136239, ptr %i.ad, align 8
...
bb.k:                                             ; preds = %bb.i
  %.08.i160 = load ptr, ptr %.0129, align 8       ; 2 uses
...
bb.l:                                             ; preds = %.lr.ph.i162
  ...
  br i1 %.not.i165, label %.loopexit, label %.lr.ph.i162, !llvm.loop !2

.loopexit:                                        ; preds = %bb.l, %bb.k
  %i.al = add i32 %.0133240.ph, 1                 ; 2 uses
...
bb.n:                                             ; preds = %.loopexit
  ...
  %i.aq = and i64 %sext, -8
  %i.ar = add i64 %i.aq, %.0130241.ph             ; 2 uses
...
find_bitmap_by_name.exit.thread:                  ; preds = %bb.h, %bb.g, %.backedge, %bb.e, %find_bitmap_by_name.exit
  %i.bf = call ptr @bdrv_dirty_bitmap_next(ptr noundef nonnull %.0136239) #13 ; 2 uses
...
find_bitmap_by_name.exit.thread.thread:           ; preds = %g_strdup_inline.exit, %bb.q
  %.1134 = phi i32 [ %i.al, %g_strdup_inline.exit ], [ %.0133240.ph, %bb.q ]
  %.1131 = phi i64 [ %i.ar, %g_strdup_inline.exit ], [ %.0130241.ph, %bb.q ]
  %.0127 = phi ptr [ %i.at, %g_strdup_inline.exit ], [ %.010.i163, %bb.q ] ; 3 uses
  %i.bg = call zeroext i1 @bdrv_dirty_bitmap_enabled(ptr noundef nonnull %.0136239) #13
  %i.bh = select i1 %i.bg, i32 2, i32 0
  %i.bi = getelementptr inbounds nuw i8, ptr %.0127, i64 24
  store i32 %i.bh, ptr %i.bi, align 8
  %i.bj = call i32 @bdrv_dirty_bitmap_granularity(ptr noundef nonnull %.0136239) #13
  %i.bk = call range(i32 0, 33) i32 @llvm.cttz.i32(i32 %i.bj, i1 false)
  %i.bl = trunc nuw nsw i32 %i.bk to i8
  %i.bm = getelementptr inbounds nuw i8, ptr %.0127, i64 28
  store i8 %i.bl, ptr %i.bm, align 4
  %i.bn = getelementptr inbounds nuw i8, ptr %.0127, i64 40
  store ptr %.0136239, ptr %i.bn, align 8
  %i.bo = call ptr @bdrv_dirty_bitmap_next(ptr noundef nonnull %.0136239) #13 ; 2 uses
...
._crit_edge:                                      ; preds = %find_bitmap_by_name.exit.thread
  br i1 %.0124242.ph, label %._crit_edge.thread, label %.critedge
...
.preheader193:                                    ; preds = %can_write.exit
  %.1128243 = load ptr, ptr %.0129, align 8       ; 2 uses
  %.not150244 = icmp eq ptr %.1128243, null
...
bb.r:                                             ; preds = %.lr.ph248, %bb.az
  %.1128245 = phi ptr [ %.1128243, %.lr.ph248 ], [ %.1128, %bb.az ] ; 4 uses
  %i.bt = getelementptr inbounds nuw i8, ptr %.1128245, i64 40 ; 2 uses
...
bb.ao:                                            ; preds = %bb.an, %bb.am
  ...
  br i1 %exitcond.not.i.i.i, label %clear_bitmap_table.exit.i.i, label %bb.am, !llvm.loop !3
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader460, %.lr.ph.i.i
  ...
  br i1 %exitcond.not.i.i, label %bitmap_table_bswap_be.exit.thread.i, label %.lr.ph.i.i, !llvm.loop !24
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.fl, label %middle.block, label %vector.body, !llvm.loop !25
...
.lr.ph.i47.i:                                     ; preds = %.lr.ph.i47.i.preheader459, %.lr.ph.i47.i
  ...
  br i1 %exitcond.not.i49.i, label %bitmap_table_bswap_be.exit50.i, label %.lr.ph.i47.i, !llvm.loop !26
...
store_bitmap.exit.thread191:                      ; preds = %bitmap_table_bswap_be.exit.i, %bitmap_table_bswap_be.exit.thread.i
  call void @g_free(ptr noundef nonnull %i.cn) #13
  store i64 %i.ek, ptr %.1128245, align 8
  %i.fs = getelementptr inbounds nuw i8, ptr %.1128245, i64 8
  store i32 %i.ei, ptr %i.fs, align 8
  br label %bb.az

bb.au:                                            ; preds = %bitmap_table_bswap_be.exit50.i, %bb.as, %bb.aq
  %.0.i170 = phi i1 [ %i.eo, %bb.aq ], [ true, %bb.as ], [ true, %bitmap_table_bswap_be.exit50.i ]
...
bb.ax:                                            ; preds = %bb.aw, %bb.av
  ...
  br i1 %exitcond.not.i53.i, label %clear_bitmap_table.exit.i, label %bb.av, !llvm.loop !3
...
store_bitmap.exit:                                ; preds = %clear_bitmap_table.exit.i, %bb.ay
  call void @g_free(ptr noundef nonnull %i.cn) #13
  br i1 %.0.i170, label %store_bitmap.exit.thread, label %bb.az

bb.az:                                            ; preds = %store_bitmap.exit.thread191, %store_bitmap.exit, %bb.r, %bb.s
  %i.gb = getelementptr inbounds nuw i8, ptr %.1128245, i64 48
  %.1128 = load ptr, ptr %i.gb, align 8           ; 2 uses
  %.not150 = icmp eq ptr %.1128, null
  br i1 %.not150, label %._crit_edge249, label %bb.r, !llvm.loop !27

._crit_edge249:                                   ; preds = %bb.az, %.preheader193
  %i.gc = call fastcc i32 @update_ext_header_and_dir(ptr noundef nonnull %0, ptr noundef nonnull %.0129) ; 2 uses
...
.lr.ph253:                                        ; preds = %bb.bb, %.lr.ph253
  %.0125251 = phi ptr [ %i.gh, %.lr.ph253 ], [ %i.gf, %bb.bb ] ; 3 uses
  %i.gg = getelementptr inbounds nuw i8, ptr %.0125251, i64 16
  %i.gh = load ptr, ptr %i.gg, align 8            ; 2 uses
  call fastcc void @free_bitmap_clusters(ptr noundef nonnull %0, ptr noundef %.0125251)
  call void @g_free(ptr noundef nonnull %.0125251) #13
  %.not151 = icmp eq ptr %i.gh, null
  br i1 %.not151, label %.critedge, label %.lr.ph253, !llvm.loop !28

.critedge:                                        ; preds = %.lr.ph253, %bb.d, %bb.bb, %._crit_edge
  %.pre308 = load ptr, ptr %.0129, align 8        ; 3 uses
...
.lr.ph257:                                        ; preds = %.preheader, %bb.bd
  %.2256 = phi ptr [ %.2, %bb.bd ], [ %.pre308, %.preheader ] ; 2 uses
  %i.gi = getelementptr inbounds nuw i8, ptr %.2256, i64 40
...
bb.bd:                                            ; preds = %.lr.ph257, %bb.bc
  %i.gl = getelementptr inbounds nuw i8, ptr %.2256, i64 48
  %.2 = load ptr, ptr %i.gl, align 8              ; 2 uses
  %.not152 = icmp eq ptr %.2, null
  br i1 %.not152, label %.preheader.i.loopexit, label %.lr.ph257, !llvm.loop !29

.preheader.i.loopexit:                            ; preds = %bb.bd
  %.pre = load ptr, ptr %.0129, align 8
...
.lr.ph.i171:                                      ; preds = %.preheader.i
  %i.gn = getelementptr inbounds nuw i8, ptr %.0129, i64 8
  br label %bb.be
...
bitmap_free.exit.i:                               ; preds = %bb.bf, %bb.be
  ...
  %i.gu = load ptr, ptr %.0129, align 8           ; 2 uses
  %.not.i172 = icmp eq ptr %i.gu, null
  br i1 %.not.i172, label %.sink.split, label %bb.be, !llvm.loop !0
...
store_bitmap.exit.thread:                         ; preds = %store_bitmap.exit, %clear_bitmap_table.exit.i.i, %bb.y, %bb.w, %bb.j, %bb.m, %bb.o, %bb.p, %bb.ba, %can_write.exit.thread
  %.3258 = load ptr, ptr %.0129, align 8          ; 2 uses
...
bb.bj:                                            ; preds = %.lr.ph261, %bb.bg, %bb.bh, %bb.bi
  ...
  br i1 %.not155, label %._crit_edge262, label %.lr.ph261, !llvm.loop !30
...
.lr.ph266:                                        ; preds = %._crit_edge262, %.lr.ph266
  %.1126264 = phi ptr [ %i.he, %.lr.ph266 ], [ %i.hc, %._crit_edge262 ] ; 2 uses
  %i.hd = getelementptr inbounds nuw i8, ptr %.1126264, i64 16
  %i.he = load ptr, ptr %i.hd, align 8            ; 2 uses
  call void @g_free(ptr noundef nonnull %.1126264) #13
  %.not156 = icmp eq ptr %i.he, null
  br i1 %.not156, label %.preheader.i173, label %.lr.ph266, !llvm.loop !31

.preheader.i173:                                  ; preds = %.lr.ph266, %._crit_edge262
  %i.hf = load ptr, ptr %.0129, align 8           ; 2 uses
...
bitmap_free.exit.i176:                            ; preds = %bb.bk, %.lr.ph.i175
  ...
  %i.hm = load ptr, ptr %.0129, align 8           ; 2 uses
  %.not.i177 = icmp eq ptr %i.hm, null
  br i1 %.not.i177, label %.sink.split, label %.lr.ph.i175, !llvm.loop !0
...
.sink.split:                                      ; preds = %bitmap_free.exit.i176, %bitmap_free.exit.i, %.preheader.i173, %.preheader.i, %.preheader
  ...
  call void @g_free(ptr noundef nonnull %.0129) #13
  br label %bb.bl
