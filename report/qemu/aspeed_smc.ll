...
bb.i:                                             ; preds = %bb.g
  ...
  br i1 %.not.i.i.i, label %aspeed_smc_flash_select.exit, label %bb.j, !prof !10
...
._crit_edge:                                      ; preds = %bb.m, %aspeed_smc_flash_select.exit
  ...
  br i1 %.not.i.i.i35, label %aspeed_smc_flash_unselect.exit, label %bb.n, !prof !10
...
bb.q:                                             ; preds = %bb.g
  ...
  br i1 %.not39, label %.loopexit, label %bb.r, !prof !10
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %.not1.i, label %aspeed_smc_flash_cmd.exit, label %bb.c, !prof !10
...
bb.f:                                             ; preds = %aspeed_smc_flash_addr_width.exit
  ...
  br i1 %.not12.i, label %aspeed_smc_check_segment_addr.exit, label %bb.g, !prof !10
