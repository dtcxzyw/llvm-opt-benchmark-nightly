...
._crit_edge:                                      ; preds = %.lr.ph.preheader, %bb.av
  ...
  %.0.lcssa = phi i32 [ 0, %bb.av ], [ %i.fh, %.lr.ph.preheader ] ; 2 uses
  %i.fl = add i32 %i.fk, 7
...
.lr.ph176.preheader:                              ; preds = %._crit_edge
  ...
  %scevgep185 = getelementptr i8, ptr %6, i64 %i.fp
  %i.fq = add nuw nsw i32 %i.fh, %i.fm
  %i.fr = add nuw nsw i32 %i.fq, 6
  %i.fs = sub nsw i32 %i.fr, %.0117.lcssa
  %i.ft = zext i32 %i.fs to i64
  %i.fu = add nuw nsw i64 %i.ft, 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %scevgep185, i8 -1, i64 %i.fu, i1 false)
  %i.fv = add nuw nsw i32 %.0.lcssa, %i.fh
  %i.fw = add nuw nsw i32 %i.fv, %i.fm
  %i.fx = add nuw nsw i32 %i.fw, 7
  %i.fy = sub nsw i32 %i.fx, %.0117.lcssa
  br label %._crit_edge177

._crit_edge177:                                   ; preds = %.lr.ph176.preheader, %._crit_edge
  %.1.lcssa = phi i32 [ %.0.lcssa, %._crit_edge ], [ %i.fy, %.lr.ph176.preheader ]
  %i.fz = add nsw i32 %.1.lcssa, 7                ; 2 uses
  %i.ga = getelementptr inbounds nuw i8, ptr %1, i64 88
  store i32 %i.fz, ptr %i.ga, align 8
  %i.gb = trunc i32 %i.fz to i8
  store i8 %i.gb, ptr %6, align 1
  br label %.thread167
...
usb_hub_port_clear.exit153:                       ; preds = %trace_usb_hub_clear_port_feature.exit, %bb.ah, %trace_usb_hub_set_port_feature.exit, %bb.s, %bb.h, %bb.e, %bb.m, %bb.f
  %i.gc = getelementptr inbounds nuw i8, ptr %1, i64 84
  store i32 -3, ptr %i.gc, align 4
  br label %.thread167
