...
deposit32.exit.i.i:                               ; preds = %.split.i.i.a
  ...
  br i1 %i.ed, label %.split.i.i.a, label %pflash_devid_query.exit.i, !llvm.loop !12
...
deposit32.exit43.i.i:                             ; preds = %.preheader.split.i.i.a
  ...
  br i1 %i.hg, label %.preheader.split.i.i.a, label %pflash_cfi_query.exit.i, !llvm.loop !14
...
!17 = !{!"branch_weights", !"expected", i32 2145070326, i32 2413322}
