...
begin_hunk_0_@pflash_mem_read_with_attrs:bb.a
  br i1 %.not.i97.i, label %pflash_read.exit, label %bb.m, !prof !7
...
bb.y:                                             ; preds = %bb.x
  ...
  br i1 %.not.i.i.i, label %trace_pflash_manufacturer_id.exit.i.i, label %bb.z, !prof !7
...
bb.ac:                                            ; preds = %bb.x
  ...
  br i1 %.not.i28.i.i, label %trace_pflash_manufacturer_id.exit.i.i, label %bb.ad, !prof !7
...
bb.ag:                                            ; preds = %bb.x
  ...
  br i1 %.not.i31.i.i, label %pflash_devid_query.exit.i, label %bb.ah, !prof !7
...
deposit32.exit.i.i:                               ; preds = %.split.i.i.a, %deposit32.exit.i.i
  ...
  br i1 %i.ed, label %deposit32.exit.i.i, label %pflash_devid_query.exit.i, !llvm.loop !12
...
deposit32.exit.i:                                 ; preds = %pflash_devid_query.exit.i
  ...
  br i1 %i.es, label %bb.x, label %trace_pflash_read_status.exit.i, !llvm.loop !13
...
bb.au:                                            ; preds = %bb.at
  ...
  br i1 %.not.i.i104.i, label %pflash_cfi_query.exit.i, label %bb.av, !prof !7
...
.preheader.i.i:                                   ; preds = %.loopexit.i.i
  ...
  br i1 %i.gw, label %.split.i104.i, label %.preheader.split.i.i.a
...
.preheader.split.i.i.a:                           ; preds = %.preheader.i.i
  ...
  %umax53.i.i = tail call i32 @llvm.umax.i32(i32 %i.gy, i32 %i.fm)
  %16 = xor i32 %i.gy, -1
  %17 = add nsw i32 %16, %i.fx
  %18 = add nsw i32 %17, %umax53.i.i
  %19 = udiv i32 %18, %i.fx
  %.not57.i.i = icmp ugt i32 %15, %19
  br i1 %.not57.i.i, label %deposit32.exit43.i.i, label %.split.i104.i
...
deposit32.exit43.i.i:                             ; preds = %.preheader.split.i.i.a, %deposit32.exit43.i.i
  ...
  br i1 %i.hg, label %deposit32.exit43.i.i, label %pflash_cfi_query.exit.i, !llvm.loop !14

.split.i104.i:                                    ; preds = %.preheader.split.i.i.a, %.preheader.i.i
  tail call void @__assert_fail(ptr noundef nonnull @.str.30, ptr noundef nonnull @.str.31, i32 noundef 649, ptr noundef nonnull @__PRETTY_FUNCTION__.deposit32) #15
  unreachable
...
deposit32.exit109.i:                              ; preds = %pflash_cfi_query.exit.i
  ...
  br i1 %i.hv, label %bb.ar, label %trace_pflash_read_status.exit.i, !llvm.loop !15
...
trace_pflash_read_status.exit.i:                  ; preds = %deposit32.exit109.i, %deposit32.exit.i, %bb.aq, %bb.ap, %.preheader123.i, %bb.w, %bb.v, %bb.u, %.preheader.i, %bb.o, %bb.n, %bb.h
  ...
  br i1 %.not.i110.i, label %pflash_read.exit, label %trace_pflash_read_status.exit.trace_pflash_read_status.exit.thread116_crit_edge.i, !prof !17
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %.not.i.i, label %trace_pflash_io_write.exit.i, label %bb.c, !prof !7
...
bb.i:                                             ; preds = %bb.h, %bb.h
  ...
  br i1 %.not.i123.i, label %trace_pflash_write.exit.i, label %bb.j, !prof !7
...
bb.m:                                             ; preds = %bb.h
  ...
  %i.ag = load i8, ptr %i.af, align 1, !range !8, !noundef !9
...
bb.a:
  ...
  br i1 %.not.i, label %trace_pflash_postload_cb.exit, label %bb.b, !prof !7
...
!17 = !{!"branch_weights", !"expected", i32 2145070426, i32 2413222}
