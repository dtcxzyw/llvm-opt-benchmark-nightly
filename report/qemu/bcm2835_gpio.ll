...
bb.b:                                             ; preds = %bb.a, %bb.a, %bb.a, %bb.a, %bb.a, %bb.a
  ...
  %3 = load <4 x i8>, ptr %i.d, align 1           ; 4 uses
  %4 = and <4 x i8> %3, splat (i8 7)
  %5 = zext nneg <4 x i8> %4 to <4 x i32>
  %6 = shl nuw nsw <4 x i32> %5, <i32 0, i32 3, i32 6, i32 9>
...
bb.c:                                             ; preds = %bb.b
  ...
  %8 = load <2 x i8>, ptr %i.g, align 1
  %i.h = and <4 x i8> %i.f, splat (i8 7)
  %i.i = zext nneg <4 x i8> %i.h to <4 x i32>
  %i.j = shl <4 x i32> %i.i, <i32 12, i32 15, i32 18, i32 21>
  %9 = shufflevector <2 x i8> %8, <2 x i8> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %10 = shufflevector <4 x i8> %9, <4 x i8> %3, <4 x i32> <i32 0, i32 1, i32 4, i32 5>
  %11 = and <4 x i8> %10, splat (i8 7)
  %12 = zext nneg <4 x i8> %11 to <4 x i32>
  %13 = shl nuw nsw <4 x i32> %12, <i32 24, i32 27, i32 0, i32 3>
  %rdx.op = or <4 x i32> %i.j, %13
  %14 = tail call i32 @llvm.vector.reduce.or.v4i32(<4 x i32> %rdx.op)
  %15 = extractelement <4 x i8> %3, i64 2
  %i.k = and i8 %15, 7
  %i.l = zext nneg i8 %i.k to i32
  %i.m = shl nuw nsw i32 %i.l, 6
  %op.rdx8 = or i32 %14, %i.m
  %16 = extractelement <4 x i8> %3, i64 3
  %i.n = and i8 %16, 7
  %i.o = zext nneg i8 %i.n to i32
  %i.p = shl nuw nsw i32 %i.o, 9
  %op.rdx11 = or i32 %op.rdx8, %i.p
  br label %gpfsel_get.exit

bb.d:                                             ; preds = %bb.a
  %i.q = getelementptr inbounds nuw i8, ptr %0, i64 1280
  %i.r = load i32, ptr %i.q, align 16
  br label %gpfsel_get.exit

bb.e:                                             ; preds = %bb.a
  %i.s = getelementptr inbounds nuw i8, ptr %0, i64 1284
...
gpfsel_get.exit:                                  ; preds = %bb.c, %bb.b, %bb.g, %bb.f, %bb.a, %bb.a, %bb.a, %bb.a, %bb.a, %bb.a, %bb.a, %bb.a, %bb.a, %bb.a, %bb.a, %bb.a, %bb.a, %bb.a, %bb.a, %bb.a, %bb.a, %bb.a, %bb.a, %bb.a, %bb.a, %bb.e, %bb.d
  %.0.shrunk = phi i32 [ 0, %bb.a ], [ 0, %bb.g ], [ 0, %bb.a ], [ 0, %bb.a ], [ %i.r, %bb.d ], [ %i.t, %bb.e ], [ 0, %bb.a ], [ 0, %bb.a ], [ 0, %bb.a ], [ 0, %bb.a ], [ 0, %bb.a ], [ 0, %bb.a ], [ 0, %bb.a ], [ 0, %bb.a ], [ 0, %bb.a ], [ 0, %bb.a ], [ 0, %bb.a ], [ 0, %bb.a ], [ 0, %bb.a ], [ 0, %bb.a ], [ 0, %bb.a ], [ 0, %bb.a ], [ 0, %bb.a ], [ 0, %bb.a ], [ 0, %bb.f ], [ %op.rdx11, %bb.c ], [ %7, %bb.b ]
...
gpfsel_is_out.exit.thread.i31:                    ; preds = %bb.k, %gpfsel_is_out.exit.i34, %bb.j
  ...
  br i1 %exitcond.not.i33, label %gpclr.exit, label %bb.j, !llvm.loop !9
...
bb.m:                                             ; preds = %gpfsel_is_out.exit.thread.i40, %bb.l
  %indvars.iv.i36 = phi i64 [ 0, %bb.l ], [ %indvars.iv.next.i41, %gpfsel_is_out.exit.thread.i40 ] ; 2 uses
  %.01520.i37 = phi i32 [ 1, %bb.l ], [ %i.bj, %gpfsel_is_out.exit.thread.i40 ] ; 2 uses
  %i.bd = and i32 %i.ba, %.01520.i37
  %.not.i38 = icmp eq i32 %i.bd, 0
  br i1 %.not.i38, label %gpfsel_is_out.exit.thread.i40, label %gpfsel_is_out.exit.i43

gpfsel_is_out.exit.i43:                           ; preds = %bb.m
  %i.be = add nuw nsw i64 %indvars.iv.i36, 32     ; 2 uses
  %i.bf = getelementptr inbounds nuw i8, ptr %i.bb, i64 %i.be
  %i.bg = load i8, ptr %i.bf, align 1
  %.not19.i44 = icmp eq i8 %i.bg, 1
  br i1 %.not19.i44, label %bb.n, label %gpfsel_is_out.exit.thread.i40

bb.n:                                             ; preds = %gpfsel_is_out.exit.i43
  %i.bh = getelementptr inbounds nuw [8 x i8], ptr %i.bc, i64 %i.be
  %i.bi = load ptr, ptr %i.bh, align 8
  tail call void @qemu_set_irq(ptr noundef %i.bi, i32 noundef 0) #3
  br label %gpfsel_is_out.exit.thread.i40

gpfsel_is_out.exit.thread.i40:                    ; preds = %bb.n, %gpfsel_is_out.exit.i43, %bb.m
end_hunk_0
