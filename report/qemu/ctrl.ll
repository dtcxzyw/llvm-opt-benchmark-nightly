...
.loopexit:                                        ; preds = %.critedge44, %.preheader, %bb.b
  ...
  %.03756 = load ptr, ptr %i.ah, align 8          ; 2 uses
...
.lr.ph59:                                         ; preds = %.loopexit, %bb.g
  ...
  %i.ai = getelementptr inbounds nuw i8, ptr %.03758, i64 52
...
bb.e:                                             ; preds = %.lr.ph59
  %i.am = getelementptr inbounds nuw i8, ptr %.03758, i64 16
  %i.an = load ptr, ptr %i.am, align 8            ; 2 uses
  %.not41 = icmp eq ptr %i.an, null
  br i1 %.not41, label %.critedge, label %bb.f

bb.f:                                             ; preds = %bb.e
  %i.ao = getelementptr inbounds nuw i8, ptr %.03758, i64 24
  store i16 7, ptr %i.ao, align 8
  tail call void @blk_aio_cancel_async(ptr noundef nonnull %i.an) #23
  br label %.critedge

bb.g:                                             ; preds = %.lr.ph59
  %i.ap = getelementptr inbounds nuw i8, ptr %.03758, i64 200
  %.037 = load ptr, ptr %i.ap, align 8            ; 2 uses
