...
.preheader.i:                                     ; preds = %bb.n, %trace_pci_nvme_err_addr_read.exit149.i
  ...
  %.0122169.i = phi i32 [ %.1123.i, %trace_pci_nvme_err_addr_read.exit149.i ], [ %i.cc, %bb.n ] ; 2 uses
  %.0125168.i = phi i32 [ %i.dr, %trace_pci_nvme_err_addr_read.exit149.i ], [ 0, %bb.n ] ; 3 uses
  %i.cm = sext i32 %.0125168.i to i64
  %i.cn = getelementptr inbounds [8 x i8], ptr %i.bu, i64 %i.cm
  %i.co = load i64, ptr %i.cn, align 8            ; 5 uses
  %i.cp = add i32 %.0122169.i, -1
  %i.cq = icmp eq i32 %.0125168.i, %i.cp
...
bb.aa:                                            ; preds = %bb.z, %.preheader.i
  ...
  %.1126.i = phi i32 [ 0, %bb.z ], [ %.0125168.i, %.preheader.i ]
  %.1123.i = phi i32 [ %i.db, %bb.z ], [ %.0122169.i, %.preheader.i ]
  %.0121.i = phi i64 [ %i.di, %bb.z ], [ %i.co, %.preheader.i ] ; 3 uses
  %i.dk = add i32 %i.dj, -1
  %i.dl = zext i32 %i.dk to i64
  %i.dm = and i64 %.0121.i, %i.dl
  %.not143.i = icmp eq i64 %i.dm, 0
  br i1 %.not143.i, label %bb.ac, label %bb.ab, !prof !7

bb.ab:                                            ; preds = %bb.aa
  tail call fastcc void @trace_pci_nvme_err_invalid_prplist_ent(i64 noundef %.0121.i)
  br label %trace_pci_nvme_err_addr_read.exit.thread.i

bb.ac:                                            ; preds = %bb.aa
  %i.dn = tail call i32 @llvm.umin.i32(i32 %.0116170.i, i32 %i.dj) ; 2 uses
  %i.do = zext i32 %i.dn to i64
  %i.dp = tail call fastcc zeroext i16 @nvme_map_addr(ptr noundef nonnull %0, ptr noundef nonnull %1, i64 noundef %.0121.i, i64 noundef %i.do) ; 2 uses
...
bb.ak:                                            ; preds = %bb.aj, %bb.ai
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(48) %1, i8 noundef 0, i64 noundef 48, i1 noundef false) #23
  br label %nvme_map_prp.exit
...
trace_pci_nvme_err_addr_read.exit:                ; preds = %trace_pci_nvme_err_addr_read.exit.preheader, %bb.at
  ...
  %.058 = phi ptr [ %i.dj, %bb.at ], [ %5, %trace_pci_nvme_err_addr_read.exit.preheader ] ; 2 uses
  %.051 = phi i64 [ %i.dq, %bb.at ], [ %2, %trace_pci_nvme_err_addr_read.exit.preheader ] ; 3 uses
  %i.bn = getelementptr inbounds nuw i8, ptr %.058, i64 15 ; 2 uses
...
bb.u:                                             ; preds = %trace_pci_nvme_err_addr_read.exit
  %i.bq = getelementptr inbounds nuw i8, ptr %.058, i64 8
...
.lr.ph:                                           ; preds = %bb.w, %nvme_map_sgl_data.exit92
  %.15251 = phi i64 [ %i.da, %nvme_map_sgl_data.exit92 ], [ %.051, %bb.w ] ; 3 uses
  %.05750 = phi i64 [ %i.cz, %nvme_map_sgl_data.exit92 ], [ %i.bw, %bb.w ]
  %.lcssa424449 = phi i64 [ %.lcssa4245, %nvme_map_sgl_data.exit92 ], [ %.promoted43, %bb.w ] ; 2 uses
  %i.by = call fastcc i32 @nvme_addr_read(ptr noundef %0, i64 noundef %.15251, ptr noundef nonnull %6, i32 noundef 4096)
...
bb.aa:                                            ; preds = %bb.z
  call void (ptr, ...) @qemu_log(ptr noundef nonnull @.str.19, i64 noundef %.15251) #23
  br label %nvme_map_sgl_data.exit.thread
...
nvme_map_sgl_data.exit92:                         ; preds = %trace_pci_nvme_err_invalid_sgl_excess_length.exit.i87, %bb.ad
  ...
  %i.cz = add nsw i64 %.05750, -256               ; 3 uses
  %i.da = add i64 %.15251, 4096                   ; 2 uses
...
._crit_edge:                                      ; preds = %nvme_map_sgl_data.exit92, %bb.w
  ...
  %.057.lcssa = phi i64 [ %i.bw, %bb.w ], [ %i.cz, %nvme_map_sgl_data.exit92 ] ; 3 uses
  %.152.lcssa = phi i64 [ %.051, %bb.w ], [ %i.da, %nvme_map_sgl_data.exit92 ] ; 2 uses
  store i64 %.lcssa4244.lcssa, ptr %i.a, align 8
  %.057.tr = trunc nuw nsw i64 %.057.lcssa to i32
  %i.dc = shl nuw nsw i32 %.057.tr, 4
  %i.dd = call fastcc i32 @nvme_addr_read(ptr noundef %0, i64 noundef %.152.lcssa, ptr noundef nonnull %6, i32 noundef %i.dc)
...
bb.ao:                                            ; preds = %bb.an
  call void (ptr, ...) @qemu_log(ptr noundef nonnull @.str.19, i64 noundef %.152.lcssa) #23
  br label %nvme_map_sgl_data.exit.thread

bb.ap:                                            ; preds = %._crit_edge
  %i.di = add nsw i64 %.057.lcssa, -1             ; 2 uses
...
bb.aq:                                            ; preds = %bb.ap
  %i.dn = call fastcc zeroext i16 @nvme_map_sgl_data(ptr noundef %0, ptr noundef nonnull %1, ptr noundef %6, i64 noundef %.057.lcssa, ptr noundef %i.a) ; 2 uses
...
nvme_map_sgl_data.exit.thread.loopexit:           ; preds = %.lr.ph.i82, %bb.ai, %bb.aj
  %.256.ph = phi i16 [ 16401, %.lr.ph.i82 ], [ 16399, %bb.ai ], [ %i.cw, %bb.aj ]
  store i64 %i.cd, ptr %i.a, align 8
  br label %nvme_map_sgl_data.exit.thread
...
nvme_map_sgl_data.exit.thread:                    ; preds = %bb.at, %bb.ar, %bb.as, %nvme_map_sgl_data.exit.thread.loopexit, %bb.ag, %bb.af, %bb.ae, %.thread.loopexit.i84, %bb.ah, %bb.ao, %bb.an, %bb.am, %bb.al, %bb.z, %bb.y, %bb.x, %bb.aq, %bb.aa, %bb.s, %bb.r, %.lr.ph.i, %bb.p, %bb.o, %bb.n, %.thread.loopexit.i, %bb.q, %nvme_map_sgl_data.exit
  %.256 = phi i16 [ 16399, %nvme_map_sgl_data.exit ], [ 16399, %bb.q ], [ %i.bl, %bb.s ], [ 16399, %bb.r ], [ 16401, %.lr.ph.i ], [ 16399, %bb.p ], [ 16399, %bb.o ], [ 16399, %bb.n ], [ 16398, %.thread.loopexit.i ], [ 16399, %bb.ah ], [ 4, %bb.ao ], [ 4, %bb.an ], [ 4, %bb.am ], [ 4, %bb.al ], [ 4, %bb.z ], [ 4, %bb.y ], [ 4, %bb.x ], [ 16399, %bb.ag ], [ %i.dn, %bb.aq ], [ 4, %bb.aa ], [ 16399, %bb.af ], [ 16399, %bb.ae ], [ 16398, %.thread.loopexit.i84 ], [ %.256.ph, %nvme_map_sgl_data.exit.thread.loopexit ], [ 16397, %bb.at ], [ 16397, %bb.ar ], [ %i.dr, %bb.as ] ; 2 uses
...
bb.ax:                                            ; preds = %bb.aw, %bb.av
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(48) %1, i8 noundef 0, i64 noundef 48, i1 noundef false) #23
...
nvme_sg_unmap.exit:                               ; preds = %bb.v, %bb.u, %trace_pci_nvme_err_addr_read.exit, %bb.m, %bb.ax, %nvme_map_sgl_data.exit.thread, %nvme_map_sgl_data.exit
  %.2 = phi i16 [ 0, %nvme_map_sgl_data.exit ], [ %.256, %bb.ax ], [ %.256, %nvme_map_sgl_data.exit.thread ], [ 0, %bb.m ], [ 16397, %bb.u ], [ 16399, %bb.v ], [ 16397, %trace_pci_nvme_err_addr_read.exit ]
...
trace_pci_nvme_err_zasl.exit.thread174:           ; preds = %bb.ao, %bb.an, %.critedge, %bb.al, %bb.ac
  %.1112 = phi i64 [ %i.e, %bb.ac ], [ %i.cv, %bb.al ], [ %i.cv, %.critedge ], [ %i.cv, %bb.an ], [ %i.cv, %bb.ao ] ; 3 uses
  %i.df = tail call fastcc zeroext i16 @nvme_check_zone_write(ptr noundef nonnull %i.c, ptr noundef nonnull %i.cb, i64 noundef %.1112, i32 noundef %i.i) ; 2 uses
...
nvme_do_write_fdp.exit:                           ; preds = %bb.ay, %bb.ax, %bb.as, %bb.at, %bb.aq, %bb.ar
  %.2 = phi i64 [ %.1112, %bb.aq ], [ %.1112, %bb.ar ], [ %i.e, %bb.as ], [ %i.e, %bb.at ], [ %i.e, %bb.ax ], [ %i.e, %bb.ay ]
...
nvme_check_mdts.exit.thread:                      ; preds = %bb.x, %bb.w, %bb.v, %bb.u, %trace_pci_nvme_err_zasl.exit, %nvme_check_bounds.exit, %bb.bb, %bb.ap, %trace_pci_nvme_err_zasl.exit.thread174
  %.1116 = phi i16 [ 16512, %nvme_check_bounds.exit ], [ %i.df, %trace_pci_nvme_err_zasl.exit.thread174 ], [ %i.dg, %bb.ap ], [ %i.fw, %bb.bb ], [ 2, %trace_pci_nvme_err_zasl.exit ], [ 16386, %bb.u ], [ 16386, %bb.v ], [ 16386, %bb.w ], [ 16386, %bb.x ]
  %i.gb = tail call ptr @blk_get_stats(ptr noundef %i.r) #23
  tail call void @block_acct_invalid(ptr noundef %i.gb, i32 noundef 2) #23
  %i.gc = or i16 %.1116, 16384
  br label %trace_pci_nvme_err_zasl.exit.thread
...
bb.a:
  ...
  %.val33 = load i64, ptr %i.b, align 8           ; 3 uses
  %i.c = add i64 %.val33, %.val                   ; 2 uses
  %i.d = getelementptr i8, ptr %1, i64 1
  %.val34 = load i8, ptr %i.d, align 1
  %i.e = lshr i8 %.val34, 4
...
trace_pci_nvme_err_zone_is_full.exit.sink.split.i: ; preds = %bb.j, %bb.g, %bb.d
  ...
  tail call void (ptr, ...) @qemu_log(ptr noundef nonnull %.str.164.sink.i, i64 noundef %.val33) #23
...
nvme_check_zone_state_for_write.exit:             ; preds = %bb.a, %bb.a, %bb.a, %bb.a
  ...
  br i1 %.not31, label %bb.q, label %bb.l
...
end_hunk_2
begin_hunk_3_@nvme_identify:bb.a
  unreachable
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.ae = add i8 %i.ad, -1
  store i8 %i.ae, ptr %i.p, align 16
  %i.af = getelementptr inbounds nuw i8, ptr %i.v, i64 24
  store i16 7, ptr %i.af, align 8
  store i32 0, ptr %i.d, align 8
  %i.ag = getelementptr inbounds nuw i8, ptr %0, i64 26400
  tail call fastcc void @nvme_enqueue_req_completion(ptr noundef nonnull %i.ag, ptr noundef nonnull %i.v)
  br label %.critedge
...
.loopexit:                                        ; preds = %.critedge44, %.preheader, %bb.b
  %i.ah = getelementptr inbounds nuw i8, ptr %i.n, i64 96
  %.03856 = load ptr, ptr %i.ah, align 8          ; 2 uses
  %.not4057 = icmp eq ptr %.03856, null
  br i1 %.not4057, label %.critedge, label %.lr.ph59

.lr.ph59:                                         ; preds = %.loopexit, %bb.g
  %.03858 = phi ptr [ %.038, %bb.g ], [ %.03856, %.loopexit ] ; 4 uses
  %i.ai = getelementptr inbounds nuw i8, ptr %.03858, i64 52
  %i.aj = load i16, ptr %i.ai, align 4
  %i.ak = zext i16 %i.aj to i32
  %i.al = icmp eq i32 %i.c, %i.ak
  br i1 %i.al, label %bb.e, label %bb.g

bb.e:                                             ; preds = %.lr.ph59
  %i.am = getelementptr inbounds nuw i8, ptr %.03858, i64 16
  %i.an = load ptr, ptr %i.am, align 8            ; 2 uses
  %.not41 = icmp eq ptr %i.an, null
  br i1 %.not41, label %.critedge, label %bb.f

bb.f:                                             ; preds = %bb.e
  %i.ao = getelementptr inbounds nuw i8, ptr %.03858, i64 24
  store i16 7, ptr %i.ao, align 8
  tail call void @blk_aio_cancel_async(ptr noundef nonnull %i.an) #23
  br label %.critedge

bb.g:                                             ; preds = %.lr.ph59
  %i.ap = getelementptr inbounds nuw i8, ptr %.03858, i64 200
  %.038 = load ptr, ptr %i.ap, align 8            ; 2 uses
  %.not40 = icmp eq ptr %.038, null
  br i1 %.not40, label %.critedge, label %.lr.ph59, !llvm.loop !86

.critedge:                                        ; preds = %bb.g, %.loopexit, %bb.a, %bb.d, %bb.f, %bb.e, %nvme_check_sqid.exit
  %.2 = phi i16 [ 16386, %nvme_check_sqid.exit ], [ 0, %bb.d ], [ 16386, %bb.a ], [ 0, %bb.e ], [ 0, %bb.f ], [ 0, %.loopexit ], [ 0, %bb.g ]
  ret i16 %.2
}

; Function Attrs: nounwind sspstrong uwtable
define internal fastcc zeroext range(i16 0, 16684) i16 @nvme_set_feature(ptr noundef %0, ptr noundef %1) unnamed_addr #0 {
nvme_cid.exit:
  %i.a = getelementptr inbounds nuw i8, ptr %1, i64 96
  %i.b = load i32, ptr %i.a, align 1              ; 5 uses
  %i.c = getelementptr inbounds nuw i8, ptr %1, i64 100 ; 2 uses
  %i.d = load i32, ptr %i.c, align 1
  %.fr165 = freeze i32 %i.d                       ; 13 uses
  %i.e = getelementptr inbounds nuw i8, ptr %1, i64 60
  %i.f = load i32, ptr %i.e, align 1              ; 7 uses
  %i.g = trunc i32 %i.b to i8                     ; 2 uses
  %i.h = lshr i32 %i.b, 31
  ...
  %.not.i134 = icmp eq i32 %i.k, 0
  br i1 %.not.i134, label %trace_pci_nvme_setfeat.exit, label %bb.a, !prof !7

bb.a:                                             ; preds = %nvme_cid.exit
  %i.l = load i16, ptr @_TRACE_PCI_NVME_SETFEAT_DSTATE, align 2
  %.not5.i = icmp eq i16 %i.l, 0
  br i1 %.not5.i, label %trace_pci_nvme_setfeat.exit, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.m = load i32, ptr @qemu_loglevel, align 4
  %i.n = and i32 %i.m, 32768
  %.not6.i = icmp eq i32 %i.n, 0
  br i1 %.not6.i, label %trace_pci_nvme_setfeat.exit, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.o = zext i16 %i.j to i32
  %i.p = and i32 %i.b, 255
  tail call void (ptr, ...) @qemu_log(ptr noundef nonnull @.str.269, i32 noundef %i.o, i32 noundef %i.f, i32 noundef %i.p, i32 noundef %i.h, i32 noundef %.fr165) #23
  br label %trace_pci_nvme_setfeat.exit

trace_pci_nvme_setfeat.exit:                      ; preds = %nvme_cid.exit, %bb.a, %bb.b, %bb.c
  %.not = icmp sgt i32 %i.b, -1
  br i1 %.not, label %bb.d, label %nvme_smart_event.exit

bb.d:                                             ; preds = %trace_pci_nvme_setfeat.exit
  %.mask = and i32 %i.b, 255
  %i.q = zext nneg i32 %.mask to i64              ; 2 uses
  %i.r = getelementptr inbounds nuw i8, ptr @nvme_feature_support, i64 %i.q
  %i.s = load i8, ptr %i.r, align 1, !range !8, !noundef !9
  %i.t = trunc nuw i8 %i.s to i1
  br i1 %i.t, label %bb.e, label %nvme_smart_event.exit

bb.e:                                             ; preds = %bb.d
  %i.u = getelementptr inbounds nuw [4 x i8], ptr @nvme_feature_cap, i64 %i.q
...
bb.f:                                             ; preds = %bb.e, %bb.e
  %.not119 = icmp eq i32 %i.f, -1
  br i1 %.not119, label %bb.j, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.v = add i32 %i.f, -1
  %i.w = icmp ult i32 %i.v, 256
  br i1 %i.w, label %nvme_ns.exit, label %nvme_smart_event.exit

nvme_ns.exit:                                     ; preds = %bb.g
  %i.x = getelementptr inbounds nuw i8, ptr %0, i64 24192
  %i.y = zext nneg i32 %i.f to i64
  %i.z = getelementptr inbounds nuw [8 x i8], ptr %i.x, i64 %i.y
  %i.aa = load ptr, ptr %i.z, align 8             ; 2 uses
  %.not120 = icmp eq ptr %i.aa, null
  br i1 %.not120, label %nvme_smart_event.exit, label %bb.j, !prof !37
...
bb.i:                                             ; preds = %bb.h
  %i.ac = icmp ult i32 %i.f, 257
  %. = select i1 %i.ac, i16 16655, i16 16395
  br label %nvme_smart_event.exit

bb.j:                                             ; preds = %bb.h, %bb.f, %nvme_ns.exit
  %.0104 = phi ptr [ %i.aa, %nvme_ns.exit ], [ null, %bb.f ], [ null, %bb.h ] ; 4 uses
  %i.ad = load i32, ptr %i.u, align 4
  %i.ae = and i32 %i.ad, 4
  %.not121 = icmp eq i32 %i.ae, 0
  br i1 %.not121, label %nvme_smart_event.exit, label %bb.k

bb.k:                                             ; preds = %bb.j
  switch i8 %i.g, label %bb.as [
    i8 4, label %bb.m
    i8 5, label %bb.t
    i8 6, label %.preheader158
    i8 7, label %bb.af
    i8 11, label %bb.aj
    i8 14, label %bb.ak
    i8 22, label %bb.al
    i8 25, label %bb.ao
    i8 29, label %nvme_smart_event.exit
    i8 30, label %bb.aq
    i8 10, label %bb.ar
  ]

.preheader158:                                    ; preds = %bb.k
  %i.af = getelementptr inbounds nuw i8, ptr %0, i64 24192 ; 2 uses
  %i.ag = trunc i32 %.fr165 to i1
  br i1 %i.ag, label %nvme_ns.exit146.us, label %nvme_ns.exit146

nvme_ns.exit146.us:                               ; preds = %.preheader158, %nvme_ns.exit146.thread.us
  %indvars.iv174 = phi i64 [ %indvars.iv.next175, %nvme_ns.exit146.thread.us ], [ 1, %.preheader158 ] ; 2 uses
  %i.ah = getelementptr inbounds nuw [8 x i8], ptr %i.af, i64 %indvars.iv174
  %i.ai = load ptr, ptr %i.ah, align 8            ; 2 uses
  %.not126.us = icmp eq ptr %i.ai, null
  br i1 %.not126.us, label %nvme_ns.exit146.thread.us, label %bb.l

bb.l:                                             ; preds = %nvme_ns.exit146.us
  %i.aj = getelementptr inbounds nuw i8, ptr %i.ai, i64 152
  %i.ak = load ptr, ptr %i.aj, align 8
  tail call void @blk_set_enable_write_cache(ptr noundef %i.ak, i1 noundef zeroext true) #23
  br label %nvme_ns.exit146.thread.us

nvme_ns.exit146.thread.us:                        ; preds = %bb.l, %nvme_ns.exit146.us
  %indvars.iv.next175 = add nuw nsw i64 %indvars.iv174, 1 ; 2 uses
  %exitcond177.not = icmp eq i64 %indvars.iv.next175, 257
  br i1 %exitcond177.not, label %nvme_smart_event.exit, label %nvme_ns.exit146.us, !llvm.loop !87

bb.m:                                             ; preds = %bb.k
  %i.al = and i32 %.fr165, 983040
  %.not131 = icmp eq i32 %i.al, 0
  br i1 %.not131, label %bb.n, label %nvme_smart_event.exit

bb.n:                                             ; preds = %bb.m
  %i.am = lshr i32 %.fr165, 20
  %i.an = and i32 %i.am, 3
  switch i32 %i.an, label %nvme_smart_event.exit [
    i32 0, label %bb.o
    i32 1, label %bb.p
  ]

bb.o:                                             ; preds = %bb.n
  %i.ao = trunc i32 %.fr165 to i16                ; 2 uses
  %i.ap = getelementptr inbounds nuw i8, ptr %0, i64 30608
  store i16 %i.ao, ptr %i.ap, align 16
  br label %bb.q

bb.p:                                             ; preds = %bb.n
  %i.aq = trunc i32 %.fr165 to i16
end_hunk_3
