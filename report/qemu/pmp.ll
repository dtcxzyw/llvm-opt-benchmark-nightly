Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/qemu/original/pmp?download=true
...
bb.g:                                             ; preds = %bb.f
  ...
  %or.cond44.i = select i1 %.not.i.i, i1 %.not2.i.not.i, i1 false
  br i1 %or.cond44.i, label %bb.h, label %pmp_is_readonly.exit.thread.i
...
pmp_is_invalid_smepmp_cfg.exit.i:                 ; preds = %bb.i, %bb.i, %bb.i, %bb.i
  ...
  %.not37.i = icmp eq i32 %i.aq, 0
  br i1 %.not37.i, label %pmp_write_cfg.exit, label %pmp_write_cfg.exit.sink.split, !prof !15
...
bb.n:                                             ; preds = %bb.m, %bb.l, %bb.k
  %.0.i = phi i8 [ %i.az, %bb.m ], [ %i.t, %bb.l ], [ %i.au, %bb.k ] ; 2 uses
...
bb.p:                                             ; preds = %bb.o, %bb.n
  %.0.i32.i = phi i64 [ %i.bk, %bb.o ], [ 0, %bb.n ]
...
bb.q:                                             ; preds = %bb.p
  ...
  %i.bo = and i64 %.0.i32.i, %.neg.i.i            ; 2 uses
...
bb.t:                                             ; preds = %bb.p
  ...
  %.128.i.i = or i64 %i.bz, %i.bg
  %i.ca = shl i64 %.128.i.i, 2                    ; 3 uses
...
bb.b:                                             ; preds = %pmp_read_cfg.exit.1, %.lr.ph
  ...
  %.015 = phi i64 [ 0, %.lr.ph ], [ %i.ae, %pmp_read_cfg.exit.1 ]
...
._crit_edge:                                      ; preds = %pmp_read_cfg.exit.1, %bb.a
  %.0.lcssa = phi i64 [ 0, %bb.a ], [ %i.ae, %pmp_read_cfg.exit.1 ] ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  tail call void (ptr, ...) @qemu_log(ptr noundef nonnull @.str.12, i64 noundef %i.ag, i32 noundef %1, i64 noundef %.0.lcssa) #10
...
.critedge:                                        ; preds = %bb.g, %pmp_is_readonly.exit, %bb.f
  %.029 = phi i1 [ %i.w, %pmp_is_readonly.exit ], [ false, %bb.f ], [ %i.w, %bb.g ]
...
bb.k:                                             ; preds = %bb.j, %pmp_is_readonly.exit37.thread
  %.0.i = phi i64 [ %i.am, %bb.j ], [ 0, %pmp_is_readonly.exit37.thread ]
  %i.an = lshr i8 %i.ae, 3
  %i.ao = and i8 %i.an, 3
...
pmp_update_rule_addr.exit:                        ; preds = %bb.k, %bb.l, %bb.m, %bb.n, %bb.o
  ...
  br i1 %.029, label %bb.p, label %bb.u
...
bb.t:                                             ; preds = %bb.p
  ...
  %.128.i42 = or i64 %i.cf, %i.bo
  %i.cg = shl i64 %.128.i42, 2                    ; 3 uses
