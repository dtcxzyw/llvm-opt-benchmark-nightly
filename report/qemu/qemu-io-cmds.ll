...
bb.b:                                             ; preds = %.backedge, %bb.a
  %.0106.a = phi i1 [ false, %bb.a ], [ %.0106.be.a, %.backedge ] ; 9 uses
  %.0104 = phi i1 [ false, %bb.a ], [ %.0104.be, %.backedge ] ; 10 uses
  %.0102 = phi i1 [ false, %bb.a ], [ %.0102.be, %.backedge ] ; 9 uses
  %.0100 = phi i1 [ false, %bb.a ], [ %.0100.be, %.backedge ] ; 10 uses
  %.098 = phi i1 [ false, %bb.a ], [ %.098.be, %.backedge ] ; 10 uses
  %.093 = phi i32 [ 0, %bb.a ], [ %.093.be, %.backedge ] ; 9 uses
  %.091 = phi i64 [ 0, %bb.a ], [ %.091.be, %.backedge ] ; 12 uses
  %.089 = phi i64 [ 0, %bb.a ], [ %.089.be, %.backedge ] ; 9 uses
  %.087 = phi i32 [ 0, %bb.a ], [ %.087.be, %.backedge ] ; 12 uses
...
.backedge:                                        ; preds = %parse_pattern.exit, %bb.b, %bb.k, %bb.e, %bb.m, %bb.j, %bb.i, %bb.d, %bb.c
  %.0106.be.a = phi i1 [ %.0106.a, %bb.c ], [ %.0106.a, %bb.d ], [ %.0106.a, %bb.e ], [ %.0106.a, %bb.b ], [ %.0106.a, %parse_pattern.exit ], [ %.0106.a, %bb.i ], [ %.0106.a, %bb.j ], [ %.0106.a, %bb.k ], [ true, %bb.m ]
  %.0104.be = phi i1 [ %.0104, %bb.c ], [ %.0104, %bb.d ], [ %.0104, %bb.e ], [ %.0104, %bb.b ], [ true, %parse_pattern.exit ], [ %.0104, %bb.i ], [ %.0104, %bb.j ], [ %.0104, %bb.k ], [ %.0104, %bb.m ]
  %.0102.be = phi i1 [ %.0102, %bb.c ], [ %.0102, %bb.d ], [ %.0102, %bb.e ], [ %.0102, %bb.b ], [ %.0102, %parse_pattern.exit ], [ %.0102, %bb.i ], [ %.0102, %bb.j ], [ true, %bb.k ], [ %.0102, %bb.m ]
  %.0100.be = phi i1 [ %.0100, %bb.c ], [ %.0100, %bb.d ], [ true, %bb.e ], [ %.0100, %bb.b ], [ %.0100, %parse_pattern.exit ], [ %.0100, %bb.i ], [ %.0100, %bb.j ], [ %.0100, %bb.k ], [ %.0100, %bb.m ]
  %.098.be = phi i1 [ true, %bb.c ], [ %.098, %bb.d ], [ %.098, %bb.e ], [ %.098, %bb.b ], [ %.098, %parse_pattern.exit ], [ %.098, %bb.i ], [ %.098, %bb.j ], [ %.098, %bb.k ], [ %.098, %bb.m ]
  %.093.be = phi i32 [ %.093, %bb.c ], [ %.093, %bb.d ], [ %.093, %bb.e ], [ %.093, %bb.b ], [ %i.v, %parse_pattern.exit ], [ %.093, %bb.i ], [ %.093, %bb.j ], [ %.093, %bb.k ], [ %.093, %bb.m ]
  %.091.be = phi i64 [ %.091, %bb.c ], [ %.091, %bb.d ], [ %.091, %bb.e ], [ %.091, %bb.b ], [ %.091, %parse_pattern.exit ], [ %.091, %bb.i ], [ %.091, %bb.j ], [ %.0.i128, %bb.k ], [ %.091, %bb.m ]
  %.089.be = phi i64 [ %.089, %bb.c ], [ %.089, %bb.d ], [ %.0.i, %bb.e ], [ %.089, %bb.b ], [ %.089, %parse_pattern.exit ], [ %.089, %bb.i ], [ %.089, %bb.j ], [ %.089, %bb.k ], [ %.089, %bb.m ]
  %.087.be = phi i32 [ %.087, %bb.c ], [ %.087, %bb.d ], [ %.087, %bb.e ], [ %.087, %bb.b ], [ %.087, %parse_pattern.exit ], [ %.087, %bb.i ], [ %i.w, %bb.j ], [ %.087, %bb.k ], [ %.087, %bb.m ]
...
bb.y:                                             ; preds = %bb.w
  %i.bx = sub nsw i64 %.0.i140, %.091
  %spec.select = select i1 %.0100, i64 %.089, i64 %i.bx ; 6 uses
  %i.by = icmp slt i64 %spec.select, 0
  %i.bz = add nuw i64 %spec.select, %.091
...
bb.aa:                                            ; preds = %bb.y
  br i1 %.098, label %bb.ab, label %._crit_edge
...
bb.ah:                                            ; preds = %._crit_edge, %bb.af
  ...
  br i1 %.098, label %bb.ai, label %bb.aj
...
bb.aj:                                            ; preds = %bb.ah
  %i.cr = call i32 @blk_pread(ptr noundef %0, i64 noundef range(i64 0, -9223372036854775808) %.0.i134, i64 noundef range(i64 0, 2147483137) %.0.i140, ptr noundef %i.cl, i32 noundef range(i32 0, 16) %.087) #24 ; 2 uses
  %i.cs = icmp slt i32 %i.cr, 0
  br i1 %i.cs, label %select.unfold, label %bb.ak

select.unfold:                                    ; preds = %bb.ai, %bb.aj
  %.095.ph = phi i32 [ %i.cr, %bb.aj ], [ %i.co, %bb.ai ] ; 2 uses
  %i.ct = call i32 @clock_gettime(i32 noundef 1, ptr noundef nonnull %4) #24 ; 0 uses
  %i.cu = sub i32 0, %.095.ph
...
bb.al:                                            ; preds = %bb.ak
  ...
  %i.da = getelementptr inbounds nuw i8, ptr %i.cl, i64 %.091
...
bb.an:                                            ; preds = %bb.am, %bb.al
  %.196 = phi i32 [ -22, %bb.am ], [ 0, %bb.al ]
  call void @g_free(ptr noundef nonnull %i.cy) #24
  br label %bb.ao

bb.ao:                                            ; preds = %bb.an, %bb.ak
  %.297 = phi i32 [ %.196, %bb.an ], [ 0, %bb.ak ] ; 2 uses
  br i1 %.085, label %bb.as, label %bb.ap

bb.ap:                                            ; preds = %bb.ao
  br i1 %.0106.a, label %bb.aq, label %bb.ar
...
bb.as:                                            ; preds = %bb.ao, %bb.ar, %select.unfold
  %.3 = phi i32 [ %.095.ph, %select.unfold ], [ %.297, %bb.ao ], [ %.297, %bb.ar ]
...
.outer:                                           ; preds = %.loopexit162, %bb.a
  %.052.ph = phi i1 [ true, %.loopexit162 ], [ false, %bb.a ]
  %.048.ph = phi i32 [ %.048.ph124, %.loopexit162 ], [ 0, %bb.a ]
  %.046.ph = phi i1 [ %.046.ph125.a, %.loopexit162 ], [ false, %bb.a ]
  %.044.ph = phi i32 [ %.044.ph130, %.loopexit162 ], [ 0, %bb.a ]
  %.042.ph = phi i1 [ %.042.ph134, %.loopexit162 ], [ false, %bb.a ]
  %.041.ph = phi i1 [ %.041.lcssa140, %.loopexit162 ], [ false, %bb.a ]
  br label %.outer123

.outer123:                                        ; preds = %.outer, %parse_pattern.exit
  %.048.ph124 = phi i32 [ %.048.ph, %.outer ], [ %i.k, %parse_pattern.exit ] ; 2 uses
  %.046.ph125.a = phi i1 [ %.046.ph, %.outer ], [ true, %parse_pattern.exit ] ; 2 uses
  %.044.ph126.a = phi i32 [ %.044.ph, %.outer ], [ %.044.ph130, %parse_pattern.exit ] ; 2 uses
  %.042.ph127.a = phi i1 [ %.042.ph, %.outer ], [ %.042.ph134, %parse_pattern.exit ]
  %.041.ph128 = phi i1 [ %.041.ph, %.outer ], [ %.041.lcssa137.a, %parse_pattern.exit ]
  %6 = or i32 %.044.ph126.a, 8
  br label %.outer129

.outer129:                                        ; preds = %.outer123, %.loopexit161.a
  %.044.ph130 = phi i32 [ %.044.ph126.a, %.outer123 ], [ %6, %.loopexit161.a ] ; 4 uses
  %.042.ph131 = phi i1 [ %.042.ph127.a, %.outer123 ], [ %.042.ph134, %.loopexit161.a ]
  %.041.ph132 = phi i1 [ %.041.ph128, %.outer123 ], [ %.041.lcssa139, %.loopexit161.a ]
  br label %.outer133

.outer133:                                        ; preds = %.outer129, %.loopexit160
  %.042.ph134 = phi i1 [ %.042.ph131, %.outer129 ], [ true, %.loopexit160 ] ; 4 uses
  %.041.ph135 = phi i1 [ %.041.ph132, %.outer129 ], [ %.041.lcssa138, %.loopexit160 ] ; 5 uses
  %i.d = call i32 @getopt(i32 noundef %1, ptr noundef %2, ptr noundef nonnull @.str.58) #24
  switch i32 %i.d, label %.loopexit [
    i32 -1, label %.loopexit158
    i32 67, label %.outer133.peel.newph
    i32 80, label %.loopexit159
    i32 113, label %.loopexit160
    i32 114, label %.loopexit161.a
    i32 118, label %.loopexit162
  ]

.outer133.peel.newph:                             ; preds = %.outer133, %.outer133.peel.newph
...
.loopexit159:                                     ; preds = %.outer133, %.outer133.peel.newph
  %.041.lcssa137.a = phi i1 [ true, %.outer133.peel.newph ], [ %.041.ph135, %.outer133 ]
...
bb.b:                                             ; preds = %.loopexit159
  %i.h = load ptr, ptr %i.c, align 8
  %i.i = load i8, ptr %i.h, align 1
  %.not.i = icmp eq i8 %i.i, 0
  br i1 %.not.i, label %parse_pattern.exit, label %parse_pattern.exit.thread

parse_pattern.exit.thread:                        ; preds = %.loopexit159, %bb.b
...
.loopexit160:                                     ; preds = %.outer133.peel.newph, %.outer133
  %.041.lcssa138 = phi i1 [ %.041.ph135, %.outer133 ], [ true, %.outer133.peel.newph ]
  br label %.outer133, !llvm.loop !23

.loopexit161.a:                                   ; preds = %.outer133, %.outer133.peel.newph
  %.041.lcssa139 = phi i1 [ true, %.outer133.peel.newph ], [ %.041.ph135, %.outer133 ]
  br label %.outer129, !llvm.loop !23

.loopexit162:                                     ; preds = %.outer133, %.outer133.peel.newph
  %.041.lcssa140 = phi i1 [ true, %.outer133.peel.newph ], [ %.041.ph135, %.outer133 ]
  br label %.outer, !llvm.loop !23

.loopexit:                                        ; preds = %.outer133, %.outer133.peel.newph
...
.loopexit158:                                     ; preds = %.outer133, %.outer133.peel.newph
  %.041.lcssa136 = phi i1 [ true, %.outer133.peel.newph ], [ %.041.ph135, %.outer133 ]
  %i.m = load i32, ptr @optind, align 4           ; 2 uses
  %i.n = add i32 %1, -2
  %i.o = icmp sgt i32 %i.m, %i.n
  br i1 %i.o, label %bb.c, label %bb.d

bb.c:                                             ; preds = %.loopexit158
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.ao = call ptr @blk_aio_preadv(ptr noundef %0, i64 noundef range(i64 0, -9223372036854775808) %.0.i63, ptr noundef nonnull %5, i32 noundef range(i32 0, 16) %.044.ph130, ptr noundef nonnull @aio_rw_done, ptr noundef nonnull %i.a) #24 ; 0 uses
...
bb.i:                                             ; preds = %do_aio_readv.exit
  br i1 %.046.ph125.a, label %bb.j, label %bb.m
...
bb.l:                                             ; preds = %bb.k, %bb.j
  %.050 = phi i32 [ -22, %bb.k ], [ 0, %bb.j ]
  call void @g_free(ptr noundef nonnull %i.bb) #24
  br label %bb.m

bb.m:                                             ; preds = %bb.l, %bb.i
  %.151 = phi i32 [ %.050, %bb.l ], [ 0, %bb.i ]  ; 2 uses
...
bb.p:                                             ; preds = %bb.o, %bb.n
  ...
  call fastcc void @print_report(ptr noundef nonnull @.str.18, ptr noundef %4, i64 noundef %.0.i63, i64 noundef %i.bq, i64 noundef %i.br, i32 noundef 1, i1 noundef zeroext %.041.lcssa136)
  br label %bb.q

bb.q:                                             ; preds = %bb.m, %bb.p, %bb.h
  %.2 = phi i32 [ %.lcssa.i, %bb.h ], [ %.151, %bb.m ], [ %.151, %bb.p ]
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.g
  ...
  %.05469 = phi i64 [ 0, %.lr.ph.preheader ], [ %i.t, %bb.g ] ; 2 uses
...
bb.g:                                             ; preds = %bb.e
  ...
  %i.t = add nuw nsw i64 %.0.i, %.05469           ; 2 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %._crit_edge, label %.lr.ph, !llvm.loop !25

._crit_edge:                                      ; preds = %bb.g, %bb.a
  %.054.lcssa = phi i64 [ 0, %bb.a ], [ %i.t, %bb.g ]
  ...
  %spec.select.i = add nuw nsw i64 %.054.lcssa, %i.w ; 3 uses
...
.lr.ph73:                                         ; preds = %.lr.ph73.preheader, %.lr.ph73
  ...
  %.05271 = phi ptr [ %spec.select12.i, %.lr.ph73.preheader ], [ %i.af, %.lr.ph73 ] ; 2 uses
  %i.ac = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %indvars.iv82 ; 2 uses
  %i.ad = load i64, ptr %i.ac, align 8
  call void @qemu_iovec_add(ptr noundef %1, ptr noundef %.05271, i64 noundef %i.ad) #24
  %i.ae = load i64, ptr %i.ac, align 8
  %i.af = getelementptr inbounds nuw i8, ptr %.05271, i64 %i.ae
...
.thread:                                          ; preds = %.lr.ph73, %qemu_io_alloc.exit, %bb.f, %bb.d, %bb.b
  %.053 = phi ptr [ null, %bb.f ], [ null, %bb.b ], [ null, %bb.d ], [ %spec.select12.i, %qemu_io_alloc.exit ], [ %spec.select12.i, %.lr.ph73 ]
