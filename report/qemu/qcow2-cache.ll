...
bb.c:                                             ; preds = %bb.b
  ...
  %i.p = load i8, ptr %i.o, align 4, !range !9, !noundef !10
...
can_clean_entry.exit.thread:                      ; preds = %bb.b, %bb.c, %bb.d, %can_clean_entry.exit
  ...
  br i1 %i.v, label %bb.b, label %._crit_edge, !llvm.loop !13
...
.lr.ph:                                           ; preds = %bb.f
  ...
  br i1 %i.ah, label %.lr.ph67, label %.critedge2, !llvm.loop !14
...
.lr.ph67:                                         ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %i.al = load i8, ptr %i.ak, align 4, !range !9, !noundef !10
...
bb.f:                                             ; preds = %can_clean_entry.exit28
  ...
  br i1 %i.ax, label %.lr.ph, label %..critedge2_crit_edge, !llvm.loop !14
...
qcow2_cache_table_release.exit:                   ; preds = %.critedge, %bb.h, %bb.g, %.critedge2
  ...
  br i1 %i.bv, label %.preheader, label %._crit_edge, !llvm.loop !15
...
bb.b:                                             ; preds = %bb.c
  ...
  br i1 %exitcond.not, label %._crit_edge, label %bb.c, !llvm.loop !16
...
bb.a:
  ...
  br i1 %.not.i, label %trace_qcow2_cache_flush.exit, label %bb.b, !prof !12
...
bb.a:
  ...
  br i1 %.not.i.i, label %trace_qcow2_cache_flush.exit.i, label %bb.b, !prof !12
...
.lr.ph:                                           ; preds = %trace_qcow2_cache_flush.exit.i, %.lr.ph
  ...
  %i.s = load i32, ptr %i.l, align 8
  %i.t = icmp slt i32 %i.r, %i.s
  br i1 %i.t, label %.lr.ph, label %qcow2_cache_write.exit, !llvm.loop !0
...
bb.b:                                             ; preds = %bb.a
  %i.c = tail call i32 @qcow2_cache_flush(ptr noundef %0, ptr noundef nonnull %i.b), !inline_history !1 ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  %i.h = tail call i32 @qcow2_cache_flush(ptr noundef %0, ptr noundef nonnull %i.g), !inline_history !1 ; 2 uses
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.h = load i32, ptr @trace_events_enabled_count, align 4
  %.not.i = icmp eq i32 %i.h, 0
  br i1 %.not.i, label %trace_qcow2_cache_get.exit, label %bb.d, !prof !12
...
bb.p:                                             ; preds = %bb.n
  ...
  br i1 %.not.i86, label %trace_qcow2_cache_get_replace_entry.exit, label %bb.q, !prof !12
...
bb.t:                                             ; preds = %trace_qcow2_cache_get_replace_entry.exit
  ...
  br i1 %.not.i88, label %trace_qcow2_cache_get_read.exit, label %bb.u, !prof !12
