...
begin_hunk_0_@img_convert:bb.a
  %i.bb = load ptr, ptr @optarg, align 8          ; 2 uses
...
bb.at:                                            ; preds = %bb.ar
  %i.bm = load i8, ptr %i.p, align 1, !range !12, !noundef !13
  %i.bn = trunc nuw i8 %i.bm to i1
  %i.bo = load i8, ptr %i.o, align 1, !range !12
...
bb.ax:                                            ; preds = %bb.av
  %i.bq = load i8, ptr %i.r, align 2, !range !12
...
bb.bd:                                            ; preds = %bb.bb
  %i.bv = load i8, ptr %i.q, align 8, !range !12, !noundef !13
...
bb.bq:                                            ; preds = %bb.bo
  %i.cp = load i8, ptr %i.n, align 1, !range !12, !noundef !13
  %5 = trunc nuw i8 %i.cp to i1
  %6 = select i1 %5, i8 0, i8 %.0303
  %i.cq = zext nneg i8 %6 to i32
  call void @qemu_progress_init(i32 noundef %i.cq, float noundef 1.000000e+00) #22
...
bb.br:                                            ; preds = %.lr.ph, %bb.bw
  ...
  %i.dm = load i8, ptr %i.i, align 1, !range !12, !noundef !13
...
bb.bw:                                            ; preds = %bb.bv, %bb.bu
  ...
  br i1 %i.fm, label %bb.br, label %._crit_edge.loopexit, !llvm.loop !20
