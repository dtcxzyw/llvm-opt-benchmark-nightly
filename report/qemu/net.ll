...
bb.a:
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(69632) %i.f, i8 noundef 0, i64 noundef 69632, i1 noundef false) #25
...
bb.g:                                             ; preds = %bb.d, %bb.e, %bb.f
  %.046 = phi ptr [ %i.s, %bb.f ], [ null, %bb.e ], [ null, %bb.d ] ; 2 uses
  %i.v = and i32 %1, 1
...
bb.i:                                             ; preds = %bb.h
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 %i.ae, ptr noundef nonnull align 1 %2, i64 noundef %i.ag, i1 noundef false) #25
  br label %bb.j

bb.j:                                             ; preds = %bb.i, %bb.h, %bb.g
  %.054 = phi ptr [ null, %bb.g ], [ null, %bb.h ], [ %i.aa, %bb.i ]
  %.044 = phi i32 [ %3, %bb.g ], [ %3, %bb.h ], [ %i.y, %bb.i ] ; 4 uses
  %.043 = phi ptr [ %2, %bb.g ], [ %2, %bb.h ], [ %i.aa, %bb.i ] ; 5 uses
...
bb.k:                                             ; preds = %bb.j
  %i.ak = call i64 %i.aj(ptr noundef nonnull %4, ptr noundef %.043, i32 noundef %.044) #25
  br label %nc_sendv_compat.exit

bb.l:                                             ; preds = %bb.j
  %i.al = icmp eq i32 %.044, 1
  br i1 %i.al, label %bb.m, label %bb.n

bb.m:                                             ; preds = %bb.l
  %i.am = load ptr, ptr %.043, align 8
  %i.an = getelementptr inbounds nuw i8, ptr %.043, i64 8
  %i.ao = load i64, ptr %i.an, align 8
  br label %iov_to_buf.exit.i

bb.n:                                             ; preds = %bb.l
  %i.ap = call i64 @iov_size(ptr noundef %.043, i32 noundef %.044) #25 ; 3 uses
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.as = call i64 @iov_to_buf_full(ptr noundef %.043, i32 noundef range(i32 2, 1) %.044, i64 noundef 0, ptr noundef %i.ar, i64 noundef range(i64 0, 69633) %i.ap) #25
  br label %iov_to_buf.exit.i
...
nc_sendv_compat.exit:                             ; preds = %iov_to_buf.exit.i, %bb.n, %bb.k
  %.045.in = phi i64 [ %i.ak, %bb.k ], [ %i.aw, %iov_to_buf.exit.i ], [ -1, %bb.n ] ; 2 uses
...
bb.q:                                             ; preds = %bb.p, %nc_sendv_compat.exit
  %i.ax = and i64 %.045.in, 4294967295
