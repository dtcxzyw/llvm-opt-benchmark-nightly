...
bb.a:
  ...
  %i.ag = xor <2 x i16> %i.af, splat (i16 255)    ; 2 uses
  %4 = extractelement <2 x i16> %i.ag, i64 1
  %5 = mul nuw nsw i16 %4, 38
  %i.ah = udiv i16 %5, 51
  %i.ai = trunc nuw i16 %i.ah to i8
  %i.aj = extractelement <2 x i16> %i.ag, i64 0
  %6 = mul nuw nsw i16 %i.aj, 38
  %i.ak = udiv i16 %6, 51
