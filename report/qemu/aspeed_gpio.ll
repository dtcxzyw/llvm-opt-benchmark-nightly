...
bb.e:                                             ; preds = %trace_aspeed_gpio_write.exit
  ...
  %i.m = trunc i64 %2 to i32                      ; 14 uses
  %i.n = lshr i32 %i.m, 16
...
bb.k:                                             ; preds = %bb.h
  ...
  %4 = insertelement <4 x i32> poison, i32 %i.m, i64 0
  %5 = shufflevector <4 x i32> %4, <4 x i32> poison, <4 x i32> zeroinitializer
  %6 = lshr <4 x i32> %5, <i32 20, i32 21, i32 22, i32 23>
  ...
  %i.dm = load i32, ptr %i.dk, align 4            ; 4 uses
  %i.dn = load i32, ptr %i.dl, align 4            ; 4 uses
  %i.do = lshr i32 %i.dm, 24
  %i.dp = lshr i32 %i.dm, 16
  %i.dq = lshr i32 %i.dm, 8
  %i.dr = and i32 %i.do, 1
  %i.ds = and i32 %i.dq, 1
  %i.dt = lshr i32 %i.dn, 23
  %i.du = lshr i32 %i.dn, 7
  %i.dv = and i32 %i.dt, 2
  %i.dw = and i32 %i.du, 2
  %i.dx = or disjoint i32 %i.dv, %i.dr
  %i.dy = insertelement <2 x i32> poison, i32 %i.dm, i64 0
  %i.dz = insertelement <2 x i32> %i.dy, i32 %i.dp, i64 1
  %i.ea = and <2 x i32> %i.dz, splat (i32 1)
  %i.eb = lshr i32 %i.dn, 15
  %i.ec = shl i32 %i.dn, 1
  ...
  %i.eo = and <4 x i32> %6, splat (i32 1)
...
bb.s:                                             ; preds = %bb.p
  ...
  %i.ak = getelementptr inbounds nuw [56 x i8], ptr %i.ai, i64 %i.aj ; 12 uses
  ...
  %4 = insertelement <4 x i32> poison, i32 %i.x, i64 0
  %5 = shufflevector <4 x i32> %4, <4 x i32> poison, <4 x i32> zeroinitializer
  %6 = lshr <4 x i32> %5, <i32 2, i32 3, i32 4, i32 5>
  %i.bm = load i32, ptr %i.bd, align 4            ; 4 uses
  %i.bn = load i32, ptr %i.be, align 4            ; 4 uses
  %i.bo = lshr i32 %i.bm, 24
  %i.bp = lshr i32 %i.bm, 16
  %i.bq = lshr i32 %i.bm, 8
  %i.br = and i32 %i.bo, 1
  %i.bs = and i32 %i.bq, 1
  %i.bt = lshr i32 %i.bn, 23
  %i.bu = lshr i32 %i.bn, 7
  %i.bv = and i32 %i.bt, 2
  %i.bw = and i32 %i.bu, 2
  %i.bx = or disjoint i32 %i.bv, %i.br
  %i.by = insertelement <2 x i32> poison, i32 %i.bm, i64 0
  %i.bz = insertelement <2 x i32> %i.by, i32 %i.bp, i64 1
  %i.ca = and <2 x i32> %i.bz, splat (i32 1)
  %i.cb = lshr i32 %i.bn, 15
  %i.cc = shl i32 %i.bn, 1
  %i.cd = insertelement <2 x i32> poison, i32 %i.cc, i64 0
  %i.ce = insertelement <2 x i32> %i.cd, i32 %i.cb, i64 1
  %i.cf = and <2 x i32> %i.ce, splat (i32 2)
  %i.cg = or disjoint <2 x i32> %i.cf, %i.ca
  %i.ch = or disjoint i32 %i.bw, %i.bs
  %i.ci = insertelement <4 x i32> poison, i32 %i.ch, i64 0
  %i.cj = shufflevector <2 x i32> %i.cg, <2 x i32> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.ck = shufflevector <4 x i32> %i.ci, <4 x i32> %i.cj, <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
  %i.cl = insertelement <4 x i32> %i.ck, i32 %i.bx, i64 3
  %i.cm = icmp eq <4 x i32> %i.cl, zeroinitializer ; 8 uses
  %i.cn = extractelement <4 x i1> %i.cm, i64 1    ; 5 uses
  %.pn.v.i.i = select i1 %i.cn, i32 %i.bc, i32 %i.ap
  %.pn.i.i = and i32 %.pn.v.i.i, 255
  %i.co = extractelement <4 x i1> %i.cm, i64 0    ; 5 uses
  %.pn.v.1.i.i = select i1 %i.co, i32 %i.bc, i32 %i.ap
  %.pn.1.i.i = and i32 %.pn.v.1.i.i, 65280
  %.1.1.i.i = or disjoint i32 %.pn.1.i.i, %.pn.i.i
  %i.cp = extractelement <4 x i1> %i.cm, i64 2    ; 5 uses
  %.pn.v.2.i.i = select i1 %i.cp, i32 %i.bc, i32 %i.ap
  %.pn.2.i.i = and i32 %.pn.v.2.i.i, 16711680
  %.1.2.i.i = or disjoint i32 %.1.1.i.i, %.pn.2.i.i
  %i.cq = extractelement <4 x i1> %i.cm, i64 3    ; 5 uses
  %.pn.v.3.i.i = select i1 %i.cq, i32 %i.bc, i32 %i.ap
  %.pn.3.i.i = and i32 %.pn.v.3.i.i, -16777216
  %.1.3.i.i = or disjoint i32 %.1.2.i.i, %.pn.3.i.i
  store i32 %.1.3.i.i, ptr %i.ao, align 4
  %i.cr = load i32, ptr %i.ba, align 4
  %i.cs = and i32 %i.bk, %i.cr                    ; 4 uses
  %.pn.v.i111.i = select i1 %i.cn, i32 %i.cs, i32 %i.bg
  %.pn.i112.i = and i32 %.pn.v.i111.i, 255
  %.pn.v.1.i113.i = select i1 %i.co, i32 %i.cs, i32 %i.bg
  %.pn.1.i114.i = and i32 %.pn.v.1.i113.i, 65280
  %.1.1.i115.i = or disjoint i32 %.pn.1.i114.i, %.pn.i112.i
  %.pn.v.2.i116.i = select i1 %i.cp, i32 %i.cs, i32 %i.bg
  %.pn.2.i117.i = and i32 %.pn.v.2.i116.i, 16711680
  %.1.2.i118.i = or disjoint i32 %.1.1.i115.i, %.pn.2.i117.i
  %.pn.v.3.i119.i = select i1 %i.cq, i32 %i.cs, i32 %i.bg
  ...
  %i.ct = load <4 x i32>, ptr %i.bl, align 4      ; 5 uses
  %i.cu = and <4 x i32> %6, splat (i32 1)
  %i.cv = insertelement <4 x i32> poison, i32 %i.at, i64 0
  %i.cw = shufflevector <4 x i32> %i.cv, <4 x i32> poison, <4 x i32> zeroinitializer
  %i.cx = and <4 x i32> %i.ct, %i.cw
  %i.cy = insertelement <4 x i32> poison, i32 %i.ad, i64 0
  %i.cz = shufflevector <4 x i32> %i.cy, <4 x i32> poison, <4 x i32> zeroinitializer
  %i.da = shl nuw <4 x i32> %i.cu, %i.cz
  %i.db = or <4 x i32> %i.cx, %i.da               ; 4 uses
  %i.dc = shufflevector <4 x i1> %i.cm, <4 x i1> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %i.dd = select <4 x i1> %i.dc, <4 x i32> %i.db, <4 x i32> %i.ct
  %i.de = and <4 x i32> %i.dd, splat (i32 255)
  %i.df = shufflevector <4 x i1> %i.cm, <4 x i1> poison, <4 x i32> zeroinitializer
  %i.dg = select <4 x i1> %i.df, <4 x i32> %i.db, <4 x i32> %i.ct
  %i.dh = and <4 x i32> %i.dg, splat (i32 65280)
  %i.di = or disjoint <4 x i32> %i.dh, %i.de
  %i.dj = shufflevector <4 x i1> %i.cm, <4 x i1> poison, <4 x i32> <i32 2, i32 2, i32 2, i32 2>
  %i.dk = select <4 x i1> %i.dj, <4 x i32> %i.db, <4 x i32> %i.ct
  %i.dl = and <4 x i32> %i.dk, splat (i32 16711680)
  %i.dm = or disjoint <4 x i32> %i.di, %i.dl
  %i.dn = shufflevector <4 x i1> %i.cm, <4 x i1> poison, <4 x i32> <i32 3, i32 3, i32 3, i32 3>
  %i.do = select <4 x i1> %i.dn, <4 x i32> %i.db, <4 x i32> %i.ct
  %i.dp = and <4 x i32> %i.do, splat (i32 -16777216)
  %i.dq = or disjoint <4 x i32> %i.dm, %i.dp
  store <4 x i32> %i.dq, ptr %i.bl, align 4
  %i.dr = getelementptr inbounds nuw i8, ptr %i.ak, i64 32 ; 2 uses
  %i.ds = load i32, ptr %i.dr, align 4            ; 5 uses
  %i.dt = lshr i32 %i.x, 6
  %i.du = and i32 %i.dt, 1
  %i.dv = and i32 %i.ds, %i.at
  %i.dw = shl nuw i32 %i.du, %i.ad
  %i.dx = or i32 %i.dv, %i.dw                     ; 4 uses
  %.pn.v.i166.i = select i1 %i.cn, i32 %i.dx, i32 %i.ds
  %.pn.i167.i = and i32 %.pn.v.i166.i, 255
  %.pn.v.1.i168.i = select i1 %i.co, i32 %i.dx, i32 %i.ds
  %.pn.1.i169.i = and i32 %.pn.v.1.i168.i, 65280
  %.1.1.i170.i = or disjoint i32 %.pn.1.i169.i, %.pn.i167.i
  %.pn.v.2.i171.i = select i1 %i.cp, i32 %i.dx, i32 %i.ds
  %.pn.2.i172.i = and i32 %.pn.v.2.i171.i, 16711680
  %.1.2.i173.i = or disjoint i32 %.1.1.i170.i, %.pn.2.i172.i
  %.pn.v.3.i174.i = select i1 %i.cq, i32 %i.dx, i32 %i.ds
  %.pn.3.i175.i = and i32 %.pn.v.3.i174.i, -16777216
  %.1.3.i176.i = or disjoint i32 %.1.2.i173.i, %.pn.3.i175.i
  store i32 %.1.3.i176.i, ptr %i.dr, align 4
  %i.dy = getelementptr inbounds nuw i8, ptr %i.ak, i64 44 ; 2 uses
  %i.dz = load i32, ptr %i.dy, align 4            ; 5 uses
  %i.ea = lshr i32 %i.x, 7
  %i.eb = and i32 %i.ea, 1
  %i.ec = and i32 %i.dz, %i.at
  %i.ed = shl nuw i32 %i.eb, %i.ad
  %i.ee = or i32 %i.ec, %i.ed                     ; 4 uses
  %.pn.v.i177.i = select i1 %i.cn, i32 %i.ee, i32 %i.dz
  %.pn.i178.i = and i32 %.pn.v.i177.i, 255
  %.pn.v.1.i179.i = select i1 %i.co, i32 %i.ee, i32 %i.dz
  %.pn.1.i180.i = and i32 %.pn.v.1.i179.i, 65280
  %.1.1.i181.i = or disjoint i32 %.pn.1.i180.i, %.pn.i178.i
  %.pn.v.2.i182.i = select i1 %i.cp, i32 %i.ee, i32 %i.dz
  %.pn.2.i183.i = and i32 %.pn.v.2.i182.i, 16711680
  %.1.2.i184.i = or disjoint i32 %.1.1.i181.i, %.pn.2.i183.i
  %.pn.v.3.i185.i = select i1 %i.cq, i32 %i.ee, i32 %i.dz
  %.pn.3.i186.i = and i32 %.pn.v.3.i185.i, -16777216
  %.1.3.i187.i = or disjoint i32 %.1.2.i184.i, %.pn.3.i186.i
  store i32 %.1.3.i187.i, ptr %i.dy, align 4
  %i.ef = getelementptr inbounds nuw i8, ptr %i.ak, i64 48 ; 2 uses
  %i.eg = load i32, ptr %i.ef, align 4            ; 5 uses
  %i.eh = lshr i32 %i.x, 8
  %i.ei = and i32 %i.eh, 1
  %i.ej = and i32 %i.eg, %i.at
  %i.ek = shl nuw i32 %i.ei, %i.ad
  %i.el = or i32 %i.ej, %i.ek                     ; 4 uses
  %.pn.v.i188.i = select i1 %i.cn, i32 %i.el, i32 %i.eg
  %.pn.i189.i = and i32 %.pn.v.i188.i, 255
  %.pn.v.1.i190.i = select i1 %i.co, i32 %i.el, i32 %i.eg
  %.pn.1.i191.i = and i32 %.pn.v.1.i190.i, 65280
  %.1.1.i192.i = or disjoint i32 %.pn.1.i191.i, %.pn.i189.i
  %.pn.v.2.i193.i = select i1 %i.cp, i32 %i.el, i32 %i.eg
  %.pn.2.i194.i = and i32 %.pn.v.2.i193.i, 16711680
  %.1.2.i195.i = or disjoint i32 %.1.1.i192.i, %.pn.2.i194.i
  %.pn.v.3.i196.i = select i1 %i.cq, i32 %i.el, i32 %i.eg
  %.pn.3.i197.i = and i32 %.pn.v.3.i196.i, -16777216
  %.1.3.i198.i = or disjoint i32 %.1.2.i195.i, %.pn.3.i197.i
  store i32 %.1.3.i198.i, ptr %i.ef, align 4
  %i.em = getelementptr inbounds nuw i8, ptr %i.ak, i64 52 ; 2 uses
  %i.en = load i32, ptr %i.em, align 4
  %i.eo = lshr i32 %i.x, 9
  %i.ep = and i32 %i.eo, 1
  %i.eq = and i32 %i.en, %i.at
  %i.er = shl nuw i32 %i.ep, %i.ad
  %i.es = or i32 %i.eq, %i.er
  %i.et = load i32, ptr %i.an, align 4
  %i.eu = and i32 %i.es, %i.et
  store i32 %i.eu, ptr %i.em, align 4
  %i.ev = and i32 %i.x, 4096
  %.not109.i = icmp eq i32 %i.ev, 0
  br i1 %.not109.i, label %bb.w, label %bb.t

bb.t:                                             ; preds = %bb.s
  %i.ew = getelementptr inbounds nuw i8, ptr %i.ak, i64 28 ; 2 uses
  %i.ex = load i32, ptr %i.ew, align 4            ; 2 uses
  %i.ey = lshr i32 %i.ex, %i.ad
  %i.ez = and i32 %i.ey, 1                        ; 2 uses
  %i.fa = getelementptr inbounds nuw i8, ptr %i.a, i64 1088 ; 2 uses
  %i.fb = load i32, ptr %i.fa, align 16           ; 2 uses
  %.not110.i = icmp ult i32 %i.fb, %i.ez
...
bb.v:                                             ; preds = %bb.t
  %i.fc = sub nuw i32 %i.fb, %i.ez
  store i32 %i.fc, ptr %i.fa, align 16
  %i.fd = and i32 %i.ex, %i.at
  store i32 %i.fd, ptr %i.ew, align 4
  br label %bb.w

bb.w:                                             ; preds = %bb.v, %bb.s
  %i.fe = load i32, ptr %i.ak, align 4
  tail call fastcc void @aspeed_gpio_update(ptr noundef nonnull %i.a, ptr noundef nonnull %i.ak, i32 noundef %i.fe, i32 noundef -1)
  br label %aspeed_gpio_2700_write_control_reg.exit

bb.x:                                             ; preds = %bb.l
  %i.ff = load i32, ptr @qemu_loglevel, align 4
  %i.fg = and i32 %i.ff, 2048
  %.not32 = icmp eq i32 %i.fg, 0
