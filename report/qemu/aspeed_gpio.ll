...
bb.s:                                             ; preds = %bb.p
  ...
  %7 = load i32, ptr %i.bd, align 4               ; 4 uses
  %i.bm = load i32, ptr %i.be, align 4            ; 4 uses
  %i.bn = lshr i32 %7, 24
  %i.bo = lshr i32 %7, 16
  %i.bp = lshr i32 %7, 8
  %i.bq = and i32 %i.bn, 1
  ...
  %i.cl = icmp eq <4 x i32> %i.ck, zeroinitializer ; 8 uses
  %i.cm = extractelement <4 x i1> %i.cl, i64 1    ; 5 uses
  %.pn.v.i.i = select i1 %i.cm, i32 %i.bc, i32 %i.ap
  %.pn.i.i = and i32 %.pn.v.i.i, 255
  %i.cn = extractelement <4 x i1> %i.cl, i64 0    ; 5 uses
  %.pn.v.1.i.i = select i1 %i.cn, i32 %i.bc, i32 %i.ap
  %.pn.1.i.i = and i32 %.pn.v.1.i.i, 65280
  %.1.1.i.i = or disjoint i32 %.pn.1.i.i, %.pn.i.i
  %i.co = extractelement <4 x i1> %i.cl, i64 2    ; 5 uses
  %.pn.v.2.i.i = select i1 %i.co, i32 %i.bc, i32 %i.ap
  %.pn.2.i.i = and i32 %.pn.v.2.i.i, 16711680
  %.1.2.i.i = or disjoint i32 %.1.1.i.i, %.pn.2.i.i
  %i.cp = extractelement <4 x i1> %i.cl, i64 3    ; 5 uses
  ...
  %i.ct = and <4 x i32> %6, splat (i32 1)
  ...
  %8 = load i32, ptr %i.dx, align 4               ; 5 uses
  %i.dy = lshr i32 %i.x, 7
  %9 = and i32 %i.dy, 1
  %10 = and i32 %8, %i.at
  %11 = shl nuw i32 %9, %i.ad
  %12 = or i32 %10, %11                           ; 4 uses
  %.pn.v.i177.i = select i1 %i.cm, i32 %12, i32 %8
  %.pn.i178.i = and i32 %.pn.v.i177.i, 255
  %.pn.v.1.i179.i = select i1 %i.cn, i32 %12, i32 %8
  %i.dz = and i32 %.pn.v.1.i179.i, 65280
  %.1.1.i181.i = or disjoint i32 %i.dz, %.pn.i178.i
  %.pn.v.2.i182.i = select i1 %i.co, i32 %12, i32 %8
  %i.ea = and i32 %.pn.v.2.i182.i, 16711680
  %.1.2.i184.i = or disjoint i32 %.1.1.i181.i, %i.ea
  %.pn.v.3.i185.i = select i1 %i.cp, i32 %12, i32 %8
  %.pn.3.i186.i = and i32 %.pn.v.3.i185.i, -16777216
  %.1.3.i187.i = or disjoint i32 %.1.2.i184.i, %.pn.3.i186.i
  store i32 %.1.3.i187.i, ptr %i.dx, align 4
  %13 = getelementptr inbounds nuw i8, ptr %i.ak, i64 48 ; 2 uses
  %14 = load i32, ptr %13, align 4                ; 5 uses
  %15 = lshr i32 %i.x, 8
  %16 = and i32 %15, 1
  %17 = and i32 %14, %i.at
  %18 = shl nuw i32 %16, %i.ad
  %19 = or i32 %17, %18                           ; 4 uses
  %.pn.v.i188.i = select i1 %i.cm, i32 %19, i32 %14
  %.pn.i189.i = and i32 %.pn.v.i188.i, 255
  %.pn.v.1.i190.i = select i1 %i.cn, i32 %19, i32 %14
  %.pn.1.i191.i = and i32 %.pn.v.1.i190.i, 65280
  %.1.1.i192.i = or disjoint i32 %.pn.1.i191.i, %.pn.i189.i
  %.pn.v.2.i193.i = select i1 %i.co, i32 %19, i32 %14
  %.pn.2.i194.i = and i32 %.pn.v.2.i193.i, 16711680
  %.1.2.i195.i = or disjoint i32 %.1.1.i192.i, %.pn.2.i194.i
  %.pn.v.3.i196.i = select i1 %i.cp, i32 %19, i32 %14
  %.pn.3.i197.i = and i32 %.pn.v.3.i196.i, -16777216
  %.1.3.i198.i = or disjoint i32 %.1.2.i195.i, %.pn.3.i197.i
  store i32 %.1.3.i198.i, ptr %13, align 4
