...
bb.f:                                             ; preds = %bb.a
  %i.t = getelementptr inbounds nuw i8, ptr %0, i64 1284
  %i.u = load i32, ptr %i.t, align 4
  br label %gpfsel_get.exit

bb.g:                                             ; preds = %bb.a
  %i.v = getelementptr inbounds nuw i8, ptr %0, i64 1288
...
gpfsel_get.exit:                                  ; preds = %bb.c, %bb.b, %bb.k, %bb.l, %bb.h, %bb.i, %bb.d, %bb.e, %bb.j, %bb.g, %bb.f
  %.0.shrunk = phi i32 [ 0, %bb.l ], [ 0, %bb.k ], [ %i.ad, %bb.j ], [ 0, %bb.e ], [ 0, %bb.d ], [ %i.u, %bb.f ], [ %i.w, %bb.g ], [ 0, %bb.i ], [ 0, %bb.h ], [ %i.q, %bb.c ], [ %i.e, %bb.b ]
...
bb.j:                                             ; preds = %bb.i
end_hunk_0
begin_hunk_1_@bcm2838_gpio_write:bb.a
  %i.dd = add nuw nsw i64 %indvars.iv.i25, 32     ; 2 uses
  %i.de = getelementptr inbounds nuw i8, ptr %i.da, i64 %i.dd
  %i.df = load i8, ptr %i.de, align 1
  %.not19.i33 = icmp eq i8 %i.df, 1
  br i1 %.not19.i33, label %bb.w, label %gpfsel_is_out.exit.thread.i29

bb.w:                                             ; preds = %gpfsel_is_out.exit.i32
  %i.dg = getelementptr inbounds nuw [8 x i8], ptr %i.db, i64 %i.dd
  %i.dh = load ptr, ptr %i.dg, align 8
  tail call void @qemu_set_irq(ptr noundef %i.dh, i32 noundef 1) #4
  br label %gpfsel_is_out.exit.thread.i29

gpfsel_is_out.exit.thread.i29:                    ; preds = %bb.w, %gpfsel_is_out.exit.i32, %bb.v
  %i.di = shl nuw nsw i32 %.01520.i26, 1
  %indvars.iv.next.i30 = add nuw nsw i64 %indvars.iv.i25, 1 ; 2 uses
  %exitcond.not.i31 = icmp eq i64 %indvars.iv.next.i30, 22
  br i1 %exitcond.not.i31, label %gpset.exit34, label %bb.v, !llvm.loop !8

gpset.exit34:                                     ; preds = %gpfsel_is_out.exit.thread.i29
  %i.dj = load i32, ptr %i.cw, align 4
  %i.dk = or i32 %i.dj, %i.cv
  store i32 %i.dk, ptr %i.cw, align 4
  br label %gpfsel_set.exit

bb.x:                                             ; preds = %bb.a
  %i.dl = trunc i64 %2 to i32                     ; 2 uses
  %i.dm = getelementptr inbounds nuw i8, ptr %0, i64 1284 ; 3 uses
  %i.dn = load i32, ptr %i.dm, align 4
  %i.do = and i32 %i.dn, %i.dl
  %i.dp = getelementptr inbounds nuw i8, ptr %0, i64 1224
  %i.dq = getelementptr inbounds nuw i8, ptr %0, i64 1296
  br label %bb.y

bb.y:                                             ; preds = %gpfsel_is_out.exit.thread.i39, %bb.x
  %indvars.iv.i35 = phi i64 [ 0, %bb.x ], [ %indvars.iv.next.i40, %gpfsel_is_out.exit.thread.i39 ] ; 3 uses
  %.01520.i36 = phi i32 [ 1, %bb.x ], [ %i.dw, %gpfsel_is_out.exit.thread.i39 ] ; 2 uses
  %i.dr = and i32 %i.do, %.01520.i36
  %.not.i37.not = icmp eq i32 %i.dr, 0
  br i1 %.not.i37.not, label %gpfsel_is_out.exit.thread.i39, label %gpfsel_is_out.exit.i42

gpfsel_is_out.exit.i42:                           ; preds = %bb.y
  %i.ds = getelementptr inbounds nuw i8, ptr %i.dp, i64 %indvars.iv.i35
  %i.dt = load i8, ptr %i.ds, align 1
  %.not19.i43 = icmp eq i8 %i.dt, 1
  br i1 %.not19.i43, label %bb.z, label %gpfsel_is_out.exit.thread.i39

bb.z:                                             ; preds = %gpfsel_is_out.exit.i42
  %i.du = getelementptr inbounds nuw [8 x i8], ptr %i.dq, i64 %indvars.iv.i35
  %i.dv = load ptr, ptr %i.du, align 8
  tail call void @qemu_set_irq(ptr noundef %i.dv, i32 noundef 0) #4
  br label %gpfsel_is_out.exit.thread.i39

gpfsel_is_out.exit.thread.i39:                    ; preds = %bb.z, %gpfsel_is_out.exit.i42, %bb.y
  %i.dw = shl i32 %.01520.i36, 1
  %indvars.iv.next.i40 = add nuw nsw i64 %indvars.iv.i35, 1 ; 2 uses
  %exitcond.not.i41 = icmp eq i64 %indvars.iv.next.i40, 32
  br i1 %exitcond.not.i41, label %gpclr.exit, label %bb.y, !llvm.loop !9

gpclr.exit:                                       ; preds = %gpfsel_is_out.exit.thread.i39
  %i.dx = xor i32 %i.dl, -1
  %i.dy = load i32, ptr %i.dm, align 4
  %i.dz = and i32 %i.dy, %i.dx
  store i32 %i.dz, ptr %i.dm, align 4
  br label %gpfsel_set.exit

bb.aa:                                            ; preds = %bb.a
  %i.ea = trunc i64 %2 to i32                     ; 2 uses
  %i.eb = getelementptr inbounds nuw i8, ptr %0, i64 1288 ; 3 uses
  %i.ec = load i32, ptr %i.eb, align 4
  %i.ed = and i32 %i.ec, %i.ea
  %i.ee = getelementptr inbounds nuw i8, ptr %0, i64 1224
  %i.ef = getelementptr inbounds nuw i8, ptr %0, i64 1296
  br label %bb.ab

bb.ab:                                            ; preds = %gpfsel_is_out.exit.thread.i48, %bb.aa
  %indvars.iv.i44 = phi i64 [ 0, %bb.aa ], [ %indvars.iv.next.i49, %gpfsel_is_out.exit.thread.i48 ] ; 2 uses
  %.01520.i45 = phi i32 [ 1, %bb.aa ], [ %i.em, %gpfsel_is_out.exit.thread.i48 ] ; 2 uses
  %i.eg = and i32 %i.ed, %.01520.i45
  %.not.i46 = icmp eq i32 %i.eg, 0
  br i1 %.not.i46, label %gpfsel_is_out.exit.thread.i48, label %gpfsel_is_out.exit.i51

gpfsel_is_out.exit.i51:                           ; preds = %bb.ab
  %i.eh = add nuw nsw i64 %indvars.iv.i44, 32     ; 2 uses
  %i.ei = getelementptr inbounds nuw i8, ptr %i.ee, i64 %i.eh
  %i.ej = load i8, ptr %i.ei, align 1
  %.not19.i52 = icmp eq i8 %i.ej, 1
  br i1 %.not19.i52, label %bb.ac, label %gpfsel_is_out.exit.thread.i48

bb.ac:                                            ; preds = %gpfsel_is_out.exit.i51
  %i.ek = getelementptr inbounds nuw [8 x i8], ptr %i.ef, i64 %i.eh
  %i.el = load ptr, ptr %i.ek, align 8
  tail call void @qemu_set_irq(ptr noundef %i.el, i32 noundef 0) #4
  br label %gpfsel_is_out.exit.thread.i48

gpfsel_is_out.exit.thread.i48:                    ; preds = %bb.ac, %gpfsel_is_out.exit.i51, %bb.ab
  %i.em = shl nuw nsw i32 %.01520.i45, 1
  %indvars.iv.next.i49 = add nuw nsw i64 %indvars.iv.i44, 1 ; 2 uses
  %exitcond.not.i50 = icmp eq i64 %indvars.iv.next.i49, 22
  br i1 %exitcond.not.i50, label %gpclr.exit53, label %bb.ab, !llvm.loop !9

gpclr.exit53:                                     ; preds = %gpfsel_is_out.exit.thread.i48
  %i.en = xor i32 %i.ea, -1
  %i.eo = load i32, ptr %i.eb, align 4
  %i.ep = and i32 %i.eo, %i.en
  store i32 %i.ep, ptr %i.eb, align 4
  br label %gpfsel_set.exit

bb.ad:                                            ; preds = %bb.a, %bb.a
  %i.eq = load i32, ptr @qemu_loglevel, align 4
  %i.er = and i32 %i.eq, 2048
  %.not56 = icmp eq i32 %i.er, 0
  br i1 %.not56, label %gpfsel_set.exit, label %bb.ae, !prof !7

bb.ae:                                            ; preds = %bb.ad
  tail call void (ptr, ...) @qemu_log(ptr noundef nonnull @.str.13, ptr noundef nonnull @.str, ptr noundef nonnull @__func__.bcm2838_gpio_write, i64 noundef %2, i64 noundef %1, i32 noundef %3) #4
  br label %gpfsel_set.exit

bb.af:                                            ; preds = %bb.a, %bb.a, %bb.a, %bb.a, %bb.a, %bb.a, %bb.a, %bb.a, %bb.a, %bb.a, %bb.a, %bb.a, %bb.a, %bb.a
  %i.es = load i32, ptr @qemu_loglevel, align 4
  %i.et = and i32 %i.es, 1024
  %.not = icmp eq i32 %i.et, 0
  br i1 %.not, label %gpfsel_set.exit, label %bb.ag, !prof !7

bb.ag:                                            ; preds = %bb.af
  tail call void (ptr, ...) @qemu_log(ptr noundef nonnull @.str.11, ptr noundef nonnull @.str, ptr noundef nonnull @__func__.bcm2838_gpio_write, i64 noundef %1) #4
  br label %gpfsel_set.exit

bb.ah:                                            ; preds = %bb.a, %bb.a, %bb.a, %bb.a
  %i.eu = trunc i64 %2 to i32
  %i.ev = getelementptr inbounds nuw i8, ptr %0, i64 1760
  %i.ew = add nsw i64 %1, -228
  %i.ex = lshr i64 %i.ew, 2
  %i.ey = getelementptr inbounds nuw [4 x i8], ptr %i.ev, i64 %i.ex
  store i32 %i.eu, ptr %i.ey, align 4
  br label %gpfsel_set.exit

bb.ai:                                            ; preds = %bb.a
  %i.ez = load i32, ptr @qemu_loglevel, align 4
  %i.fa = and i32 %i.ez, 2048
  %.not57 = icmp eq i32 %i.fa, 0
  br i1 %.not57, label %gpfsel_set.exit, label %bb.aj, !prof !7

bb.aj:                                            ; preds = %bb.ai
  tail call void (ptr, ...) @qemu_log(ptr noundef nonnull @.str.12, ptr noundef nonnull @.str, ptr noundef nonnull @__func__.bcm2838_gpio_write, i64 noundef %1) #4
  br label %gpfsel_set.exit

gpfsel_set.exit:                                  ; preds = %bb.e, %bb.f, %bb.g, %bb.h, %bb.i, %.sink.split.i, %bb.p, %bb.o, %bb.n, %bb.m, %bb.l, %.thread.i, %bb.k, %bb.ai, %bb.aj, %bb.af, %bb.ag, %bb.ad, %bb.ae, %bb.ah, %gpclr.exit53, %gpclr.exit, %gpset.exit34, %gpset.exit
  ret void
}

declare void @qemu_log(ptr noundef, ...) local_unnamed_addr #1

declare void @sdbus_reparent_card(ptr noundef, ptr noundef) local_unnamed_addr #1

declare void @qemu_set_irq(ptr noundef, i32 noundef) local_unnamed_addr #1

; Function Attrs: nounwind sspstrong uwtable
define internal void @bcm2838_gpio_realize(ptr noundef %0, ptr nofree readnone captures(none) %1) #0 {
bb.a:
  %i.a = tail call ptr @object_dynamic_cast_assert(ptr noundef %0, ptr noundef nonnull @.str, ptr noundef nonnull @.str.5, i32 noundef 22, ptr noundef nonnull @__func__.BCM2838_GPIO) #4 ; 2 uses
  %i.b = tail call ptr @object_property_get_link(ptr noundef %0, ptr noundef nonnull @.str.20, ptr noundef nonnull @error_abort) #4
  %i.c = tail call ptr @object_dynamic_cast_assert(ptr noundef %i.b, ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.22, i32 noundef 149, ptr noundef nonnull @__func__.SD_BUS) #4
  %i.d = getelementptr inbounds nuw i8, ptr %i.a, i64 1208
  store ptr %i.c, ptr %i.d, align 8
  %i.e = tail call ptr @object_property_get_link(ptr noundef %0, ptr noundef nonnull @.str.21, ptr noundef nonnull @error_abort) #4
  %i.f = tail call ptr @object_dynamic_cast_assert(ptr noundef %i.e, ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.22, i32 noundef 149, ptr noundef nonnull @__func__.SD_BUS) #4
  %i.g = getelementptr inbounds nuw i8, ptr %i.a, i64 1216
  store ptr %i.f, ptr %i.g, align 16
  ret void
}
...
; Function Attrs: nounwind sspstrong uwtable
define internal void @bcm2838_gpio_reset(ptr noundef %0) #0 {
bb.a:
  %i.a = tail call ptr @object_dynamic_cast_assert(ptr noundef %0, ptr noundef nonnull @.str, ptr noundef nonnull @.str.5, i32 noundef 22, ptr noundef nonnull @__func__.BCM2838_GPIO) #4 ; 7 uses
  %i.b = getelementptr inbounds nuw i8, ptr %i.a, i64 1224 ; 2 uses
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(58) %i.b, i8 noundef 0, i64 noundef 58, i1 noundef false) #4
  %i.c = getelementptr inbounds nuw i8, ptr %i.a, i64 1292
  store i8 0, ptr %i.c, align 4
  %i.d = getelementptr inbounds nuw i8, ptr %i.a, i64 1088
  %i.e = getelementptr inbounds nuw i8, ptr %i.a, i64 1208
  %i.f = load ptr, ptr %i.e, align 8
  tail call void @sdbus_reparent_card(ptr noundef nonnull %i.d, ptr noundef %i.f) #4
  %i.g = getelementptr inbounds nuw i8, ptr %i.a, i64 1284
  store i32 0, ptr %i.g, align 4
  %i.h = getelementptr inbounds nuw i8, ptr %i.a, i64 1288
  store i32 0, ptr %i.h, align 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(58) %i.b, i8 noundef 0, i64 noundef 58, i1 noundef false) #4
  %i.i = getelementptr inbounds nuw i8, ptr %i.a, i64 1760
  store <4 x i32> <i32 -1431743147, i32 -1599427926, i32 1353361754, i32 349525>, ptr %i.i, align 16
  ret void
}
