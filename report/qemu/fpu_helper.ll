...
bb.a:
  ...
  %8 = load i32, ptr %i.a, align 4                ; 2 uses
  %i.b = getelementptr inbounds nuw i8, ptr %1, i64 4
  %9 = load i32, ptr %i.b, align 4                ; 2 uses
  %10 = and i32 %9, %8
  %11 = or i32 %10, %5
  %12 = xor i32 %9, -1
  %13 = and i32 %8, %12
  ...
  %31 = and i32 %25, %30
  %32 = or i32 %31, %23
  %.not.inv = icmp slt i32 %29, 0
  %33 = select i1 %.not.inv, i64 0, i64 64
  %.not = icmp sgt i32 %32, -1
  %i.c = zext i1 %.not to i64
  %i.d = or disjoint i64 %33, %i.c
...
bb.a:
  ...
  %8 = load i64, ptr %i.a, align 8                ; 2 uses
  %i.b = getelementptr inbounds nuw i8, ptr %1, i64 8
  %9 = load i64, ptr %i.b, align 8                ; 2 uses
  %10 = and i64 %9, %8
  %11 = or i64 %10, %5
  %12 = xor i64 %9, -1
  %13 = and i64 %8, %12
  ...
  %25 = load i64, ptr %24, align 8                ; 2 uses
  ...
  %i.c = select i1 %.not, i64 64, i64 0
  %.not17 = icmp eq i64 %32, 0
  %i.d = zext i1 %.not17 to i64
