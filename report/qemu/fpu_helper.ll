...
bb.a:
  ...
  %i.p = xor <2 x i32> %i.o, <i32 -1, i32 0>
...
bb.a:
  ...
  %3 = shufflevector <2 x i64> %i.f, <2 x i64> poison, <2 x i32> <i32 1, i32 0>
  %4 = xor <2 x i64> %i.d, <i64 0, i64 -1>
  %5 = and <2 x i64> %i.c, %4
  %i.g = or <2 x i64> %3, %5
  %i.h = load <2 x i64>, ptr %i.b, align 8        ; 2 uses
  %i.i = shufflevector <2 x i64> %i.h, <2 x i64> poison, <2 x i32> zeroinitializer
  %i.j = xor <2 x i64> %i.i, <i64 0, i64 -1>
  ...
  %i.p = xor <2 x i64> %i.o, <i64 0, i64 -1>
  ...
  %i.w = extractelement <2 x i1> %i.t, i64 1
...
bb.a:
  ...
  %4 = load i32, ptr %1, align 4                  ; 2 uses
  %5 = and i32 %4, %3
  %6 = xor i32 %4, -1
  %7 = and i32 %3, %6
  ...
  %16 = or i32 %15, %7
  %i.a = getelementptr inbounds nuw i8, ptr %2, i64 8
  %17 = load i32, ptr %i.a, align 4               ; 2 uses
  %i.b = getelementptr inbounds nuw i8, ptr %1, i64 8
  %18 = load i32, ptr %i.b, align 4               ; 2 uses
  %19 = and i32 %18, %17
  %20 = or i32 %19, %13
  %21 = xor i32 %18, -1
  %22 = and i32 %17, %21
  ...
  %25 = load i32, ptr %24, align 4                ; 2 uses
  ...
  %34 = load i32, ptr %33, align 4                ; 2 uses
  %35 = getelementptr inbounds nuw i8, ptr %1, i64 16
  %36 = load i32, ptr %35, align 4                ; 2 uses
  %37 = and i32 %36, %34
  %38 = or i32 %37, %29
  %39 = xor i32 %36, -1
  %40 = and i32 %34, %39
  ...
  %43 = load i32, ptr %42, align 4                ; 2 uses
  %44 = getelementptr inbounds nuw i8, ptr %1, i64 20
  %45 = load i32, ptr %44, align 4                ; 2 uses
  %46 = and i32 %45, %43
  %47 = or i32 %46, %38
  %48 = xor i32 %45, -1
  %49 = and i32 %43, %48
  ...
  %52 = load i32, ptr %51, align 4                ; 2 uses
  %53 = getelementptr inbounds nuw i8, ptr %1, i64 24
  %54 = load i32, ptr %53, align 4                ; 2 uses
  %55 = and i32 %54, %52
  %56 = or i32 %55, %47
  %57 = xor i32 %54, -1
  %58 = and i32 %52, %57
  ...
  %61 = load i32, ptr %60, align 4                ; 2 uses
  %62 = getelementptr inbounds nuw i8, ptr %1, i64 28
  %63 = load i32, ptr %62, align 4                ; 2 uses
  %64 = and i32 %63, %61
  %65 = or i32 %64, %56
  %66 = xor i32 %63, -1
  %67 = and i32 %61, %66
  %68 = or i32 %67, %59
  %.not.inv = icmp slt i32 %65, 0
  %69 = select i1 %.not.inv, i64 0, i64 64
  %.not = icmp sgt i32 %68, -1
  %i.c = zext i1 %.not to i64
  %i.d = or disjoint i64 %69, %i.c
