...
bb.o:                                             ; preds = %bb.n, %.thread99, %bb.m
  %i.bg = phi i1 [ true, %bb.m ], [ false, %.thread99 ], [ false, %bb.n ]
  %i.bh = phi i1 [ %i.ak, %bb.m ], [ %i.av, %.thread99 ], [ %i.av, %bb.n ]
  %i.bi = phi i1 [ false, %bb.m ], [ %i.aw, %.thread99 ], [ %i.aw, %bb.n ]
  %i.bj = load i64, ptr @tpm_tis_base_addr, align 8
  %i.bk = add i64 %i.bj, %i.b
  %i.bl = load ptr, ptr @global_qtest, align 8
  tail call void @qtest_writeb(ptr noundef %i.bl, i64 noundef %i.bk, i8 noundef zeroext 32) #4
  %i.bm = icmp samesign ult i64 %indvars.iv, 2
  br i1 %i.bg, label %bb.t, label %bb.p

bb.p:                                             ; preds = %bb.o
  %i.bn = load i64, ptr @tpm_tis_base_addr, align 8
  %i.bo = add i64 %i.bn, 12288
  %i.bp = load ptr, ptr @global_qtest, align 8
  %i.bq = tail call zeroext i8 @qtest_readb(ptr noundef %i.bp, i64 noundef %i.bo) #4 ; 2 uses
  %i.br = icmp eq i8 %i.bq, -91
  br i1 %i.br, label %bb.r, label %bb.q

bb.q:                                             ; preds = %bb.p
  %i.bs = uitofp i8 %i.bq to x86_fp80
  tail call void @g_assertion_message_cmpnum(ptr noundef null, ptr noundef nonnull @.str, i32 noundef 355, ptr noundef nonnull @__func__.tpm_tis_test_check_access_reg_release, ptr noundef nonnull @.str.14, x86_fp80 noundef %i.bs, ptr noundef nonnull @.str.2, x86_fp80 noundef 1.650000e+02, i8 noundef signext 105) #4
  br label %bb.r

bb.r:                                             ; preds = %bb.p, %bb.q
  %i.bt = load i64, ptr @tpm_tis_base_addr, align 8
  %i.bu = add i64 %i.bt, 12288
  %i.bv = load ptr, ptr @global_qtest, align 8
  tail call void @qtest_writeb(ptr noundef %i.bv, i64 noundef %i.bu, i8 noundef zeroext 32) #4
  %i.bw = load i64, ptr @tpm_tis_base_addr, align 8
  %i.bx = add i64 %i.bw, 12288
  %i.by = load ptr, ptr @global_qtest, align 8
  %i.bz = tail call zeroext i8 @qtest_readb(ptr noundef %i.by, i64 noundef %i.bx) #4 ; 2 uses
  %i.ca = icmp eq i8 %i.bz, -123
  br i1 %i.ca, label %bb.t, label %bb.s

bb.s:                                             ; preds = %bb.r
  %i.cb = uitofp i8 %i.bz to x86_fp80
  tail call void @g_assertion_message_cmpnum(ptr noundef null, ptr noundef nonnull @.str, i32 noundef 366, ptr noundef nonnull @__func__.tpm_tis_test_check_access_reg_release, ptr noundef nonnull @.str.11, x86_fp80 noundef %i.cb, ptr noundef nonnull @.str.2, x86_fp80 noundef 1.330000e+02, i8 noundef signext 105) #4
  br label %bb.t

bb.t:                                             ; preds = %bb.s, %bb.r, %bb.o
  br i1 %i.bi, label %bb.y, label %bb.u

bb.u:                                             ; preds = %bb.t
  %i.cc = load i64, ptr @tpm_tis_base_addr, align 8
  %i.cd = add i64 %i.cc, 8192
  %i.ce = load ptr, ptr @global_qtest, align 8
  %i.cf = tail call zeroext i8 @qtest_readb(ptr noundef %i.ce, i64 noundef %i.cd) #4 ; 2 uses
  %i.cg = icmp eq i8 %i.cf, -91
  br i1 %i.cg, label %bb.w, label %bb.v

bb.v:                                             ; preds = %bb.u
  %i.ch = uitofp i8 %i.cf to x86_fp80
  tail call void @g_assertion_message_cmpnum(ptr noundef null, ptr noundef nonnull @.str, i32 noundef 355, ptr noundef nonnull @__func__.tpm_tis_test_check_access_reg_release, ptr noundef nonnull @.str.14, x86_fp80 noundef %i.ch, ptr noundef nonnull @.str.2, x86_fp80 noundef 1.650000e+02, i8 noundef signext 105) #4
  br label %bb.w

bb.w:                                             ; preds = %bb.v, %bb.u
  %i.ci = load i64, ptr @tpm_tis_base_addr, align 8
  %i.cj = add i64 %i.ci, 8192
  %i.ck = load ptr, ptr @global_qtest, align 8
  tail call void @qtest_writeb(ptr noundef %i.ck, i64 noundef %i.cj, i8 noundef zeroext 32) #4
  %i.cl = load i64, ptr @tpm_tis_base_addr, align 8
  %i.cm = add i64 %i.cl, 8192
  %i.cn = load ptr, ptr @global_qtest, align 8
  %i.co = tail call zeroext i8 @qtest_readb(ptr noundef %i.cn, i64 noundef %i.cm) #4 ; 2 uses
  %.3.1 = select i1 %i.bm, i8 0, i8 4             ; 3 uses
  %i.cp = or disjoint i8 %.3.1, -127              ; 2 uses
  %i.cq = icmp eq i8 %i.co, %i.cp
  br i1 %i.cq, label %bb.y, label %bb.x

bb.x:                                             ; preds = %bb.w
  %i.cr = uitofp i8 %i.co to x86_fp80
  %i.cs = uitofp i8 %i.cp to x86_fp80
  tail call void @g_assertion_message_cmpnum(ptr noundef null, ptr noundef nonnull @.str, i32 noundef 366, ptr noundef nonnull @__func__.tpm_tis_test_check_access_reg_release, ptr noundef nonnull @.str.11, x86_fp80 noundef %i.cr, ptr noundef nonnull @.str.2, x86_fp80 noundef %i.cs, i8 noundef signext 105) #4
  br label %bb.y

bb.y:                                             ; preds = %bb.x, %bb.w, %bb.t
  %.4.1 = phi i8 [ 4, %bb.t ], [ %.3.1, %bb.w ], [ %.3.1, %bb.x ] ; 2 uses
  br i1 %i.bh, label %bb.ad, label %bb.z

bb.z:                                             ; preds = %bb.y
  %i.ct = load i64, ptr @tpm_tis_base_addr, align 8
  %i.cu = add i64 %i.ct, 4096
  %i.cv = load ptr, ptr @global_qtest, align 8
end_hunk_0
