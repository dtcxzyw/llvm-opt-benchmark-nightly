...
begin_hunk_0_@_RINvNtNtCs6f1wo00zwKs_8lz4_flex5block15decompress_safe19decompress_internalKb0_NtNtB6_4sink9SliceSinkECs31YAwBA1AlL_19xet_core_structures:bb.a
  ...
  %.val157 = load i64, ptr %i.c, align 8, !noundef !5 ; 2 uses
...
.lr.ph:                                           ; preds = %bb.a, %.backedge
  ...
  %i.f = load i8, ptr %i.e, align 1, !noundef !5  ; 5 uses
...
bb.d:                                             ; preds = %bb.b
  ...
  br i1 %.not, label %bb.aq, label %bb.ar, !prof !29
...
.lr.ph132:                                        ; preds = %.preheader175.preheader, %.preheader175
  ...
  %i.u = load i8, ptr %i.t, align 1, !alias.scope !30, !noalias !33, !noundef !5 ; 2 uses
...
bb.k:                                             ; preds = %bb.i
  ...
  br i1 %or.cond150, label %bb.m, label %bb.n, !prof !29
...
_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj2_NtNtB4_5array17TryFromSliceErrorE6unwrapCs31YAwBA1AlL_19xet_core_structures.exit.i: ; preds = %bb.o
  ...
  %.sroa.030.0.copyload.i = load i16, ptr %i.aj, align 1, !alias.scope !36, !noalias !39 ; 4 uses
...
bb.p:                                             ; preds = %bb.f
  %.val164 = load i64, ptr %i.a, align 8, !noundef !5
...
.lr.ph136:                                        ; preds = %.preheader.preheader, %.preheader
  ...
  %i.ar = load i8, ptr %i.aq, align 1, !alias.scope !42, !noalias !45, !noundef !5 ; 2 uses
...
bb.s:                                             ; preds = %_RNvNtNtCs6f1wo00zwKs_8lz4_flex5block15decompress_safe17read_match_offset.exit, %bb.r
  ...
  %.val163 = load i64, ptr %i.a, align 8, !noundef !5 ; 23 uses
  %i.ax = add i64 %.val163, %.sroa.066.0          ; 12 uses
  %.val154 = load i64, ptr %i.c, align 8, !noundef !5 ; 26 uses
...
bb.y:                                             ; preds = %bb.x
  %.val1.i = load ptr, ptr %3, align 8, !alias.scope !48, !noalias !51 ; 3 uses
...
bb.z:                                             ; preds = %bb.y
  tail call void @_RNvNtCskKLDkoKarTP_4core9panicking18panic_bounds_check(i64 noundef %i.bc, i64 noundef %.val154, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @79) #19, !noalias !55
  unreachable

_RNvXs_NtCs6f1wo00zwKs_8lz4_flex4sinkNtB4_9SliceSinkNtB4_4Sink7byte_at.exit.i: ; preds = %bb.y
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.val1.i) ], !noalias !56
  %i.bg = icmp ult i64 %i.ax, %.val163
  br i1 %i.bg, label %bb.aa, label %_RNvXs_NtCs6f1wo00zwKs_8lz4_flex4sinkNtB4_9SliceSinkNtB4_4Sink16extend_with_fill.exit.i, !prof !29

bb.aa:                                            ; preds = %_RNvXs_NtCs6f1wo00zwKs_8lz4_flex4sinkNtB4_9SliceSinkNtB4_4Sink7byte_at.exit.i
  tail call void @_RNvNtNtCskKLDkoKarTP_4core5slice5index16slice_index_fail(i64 noundef %.val163, i64 noundef %i.ax, i64 noundef %.val154, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @71) #19, !noalias !57
  unreachable
...
_RNvXs_NtCs6f1wo00zwKs_8lz4_flex4sinkNtB4_9SliceSinkNtB4_4Sink16extend_with_fill.exit.i: ; preds = %_RNvXs_NtCs6f1wo00zwKs_8lz4_flex4sinkNtB4_9SliceSinkNtB4_4Sink7byte_at.exit.i
  ...
  %i.bi = load i8, ptr %i.bh, align 1, !noalias !55, !noundef !5
  %i.bj = getelementptr inbounds nuw i8, ptr %.val1.i, i64 %.val163
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %i.bj, i8 %i.bi, i64 range(i64 1, 0) %.sroa.066.0, i1 false), !noalias !57
  br label %.backedge

bb.ab:                                            ; preds = %bb.x
  tail call void @llvm.experimental.noalias.scope.decl(metadata !60), !noalias !56
  %i.bk = icmp ult i64 %.val163, %i.ax
  br i1 %i.bk, label %.lr.ph.i.i, label %.backedge

.lr.ph.i.i:                                       ; preds = %bb.ab
  %i.bl = load ptr, ptr %3, align 8, !alias.scope !63, !noalias !51, !nonnull !5 ; 4 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.cb, align 1, !noalias !64
  %i.cc = getelementptr inbounds nuw i8, ptr %i.bl, i64 %i.bz
  store <16 x i8> %wide.load, ptr %i.cc, align 1, !noalias !64
  %index.next = add nuw i64 %index, 16            ; 2 uses
  %i.cd = icmp eq i64 %index.next, %n.vec
  br i1 %i.cd, label %scalar.ph.preheader, label %vector.body, !llvm.loop !65
...
bb.ad:                                            ; preds = %scalar.ph
  tail call void @_RNvNtCskKLDkoKarTP_4core9panicking18panic_bounds_check(i64 noundef %i.cf, i64 noundef %.val154, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @76) #19, !noalias !64
  unreachable

bb.ae:                                            ; preds = %bb.ac
  %i.ch = getelementptr inbounds nuw i8, ptr %i.bl, i64 %i.cf
  %i.ci = load i8, ptr %i.ch, align 1, !noalias !64, !noundef !5
  %i.cj = getelementptr inbounds nuw i8, ptr %i.bl, i64 %.sroa.01.010.i.i
  store i8 %i.ci, ptr %i.cj, align 1, !noalias !64
  %exitcond15.not.i.i = icmp eq i64 %i.ce, %i.ax
  br i1 %exitcond15.not.i.i, label %.backedge, label %scalar.ph, !llvm.loop !68

bb.af:                                            ; preds = %bb.ac
  tail call void @_RNvNtCskKLDkoKarTP_4core9panicking18panic_bounds_check(i64 noundef %.val154, i64 noundef %.val154, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @77) #19, !noalias !64
  unreachable
...
bb.ah:                                            ; preds = %bb.ag
  ...
  %.pre273 = load ptr, ptr %3, align 8, !noalias !56 ; 3 uses
  br i1 %or.cond78, label %bb.aj, label %bb.al

bb.ai:                                            ; preds = %bb.ag
  %i.cn = add i64 %.val163, 32
  %.not4.i = icmp ugt i64 %i.cn, %.val154
  %.pre = load ptr, ptr %3, align 8, !noalias !56 ; 3 uses
  br i1 %.not4.i, label %bb.aj, label %bb.an

bb.aj:                                            ; preds = %bb.ai, %bb.ah
  %i.co = phi ptr [ %.pre, %bb.ai ], [ %.pre273, %bb.ah ] ; 2 uses
  %i.cp = add i64 %i.ba, %.sroa.066.0
  tail call void @llvm.experimental.noalias.scope.decl(metadata !69), !noalias !56
  %i.cq = tail call { i64, i64 } @_RINvNtNtCskKLDkoKarTP_4core5slice5index5rangeINtNtNtB6_3ops5range5RangejEECs31YAwBA1AlL_19xet_core_structures(i64 noundef %i.ba, i64 noundef %i.cp, i64 noundef range(i64 0, -9223372036854775808) %.val154, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @72), !noalias !72 ; 2 uses
  ...
  br i1 %.not.i.i178, label %bb.ak, label %_RNvXs_NtCs6f1wo00zwKs_8lz4_flex4sinkNtB4_9SliceSinkNtB4_4Sink18extend_from_within.exit, !prof !6

bb.ak:                                            ; preds = %bb.aj
  tail call void @_RNvNtCskKLDkoKarTP_4core9panicking9panic_fmt(ptr noundef nonnull @0, ptr noundef nonnull inttoptr (i64 43 to ptr), ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @72) #19, !noalias !72
  unreachable
...
_RNvXs_NtCs6f1wo00zwKs_8lz4_flex4sinkNtB4_9SliceSinkNtB4_4Sink18extend_from_within.exit: ; preds = %bb.aj
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 1 %i.cw, ptr nonnull align 1 %i.cv, i64 %i.ct, i1 false), !alias.scope !69, !noalias !75
  br label %.backedge

bb.al:                                            ; preds = %bb.ah
  %i.cx = add i64 %i.ba, 64
  tail call void @llvm.experimental.noalias.scope.decl(metadata !76), !noalias !56
  %i.cy = tail call { i64, i64 } @_RINvNtNtCskKLDkoKarTP_4core5slice5index5rangeINtNtNtB6_3ops5range5RangejEECs31YAwBA1AlL_19xet_core_structures(i64 noundef %i.ba, i64 noundef %i.cx, i64 noundef range(i64 0, -9223372036854775808) %.val154, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @72), !noalias !79 ; 2 uses
  ...
  br i1 %.not.i.i179, label %bb.am, label %_RNvXs_NtCs6f1wo00zwKs_8lz4_flex4sinkNtB4_9SliceSinkNtB4_4Sink18extend_from_within.exit180, !prof !6

bb.am:                                            ; preds = %bb.al
  tail call void @_RNvNtCskKLDkoKarTP_4core9panicking9panic_fmt(ptr noundef nonnull @0, ptr noundef nonnull inttoptr (i64 43 to ptr), ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @72) #19, !noalias !79
  unreachable
...
_RNvXs_NtCs6f1wo00zwKs_8lz4_flex4sinkNtB4_9SliceSinkNtB4_4Sink18extend_from_within.exit180: ; preds = %bb.al
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 1 %i.de, ptr nonnull align 1 %i.dd, i64 %i.db, i1 false), !alias.scope !76, !noalias !82
  br label %.backedge

bb.an:                                            ; preds = %bb.ai
  %i.df = add i64 %i.ba, 32
  tail call void @llvm.experimental.noalias.scope.decl(metadata !83), !noalias !56
  %i.dg = tail call { i64, i64 } @_RINvNtNtCskKLDkoKarTP_4core5slice5index5rangeINtNtNtB6_3ops5range5RangejEECs31YAwBA1AlL_19xet_core_structures(i64 noundef %i.ba, i64 noundef %i.df, i64 noundef range(i64 0, -9223372036854775808) %.val154, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @72), !noalias !86 ; 2 uses
  ...
  br i1 %.not.i.i181, label %bb.ao, label %_RNvXs_NtCs6f1wo00zwKs_8lz4_flex4sinkNtB4_9SliceSinkNtB4_4Sink18extend_from_within.exit182, !prof !6

bb.ao:                                            ; preds = %bb.an
  tail call void @_RNvNtCskKLDkoKarTP_4core9panicking9panic_fmt(ptr noundef nonnull @0, ptr noundef nonnull inttoptr (i64 43 to ptr), ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @72) #19, !noalias !86
  unreachable
...
_RNvXs_NtCs6f1wo00zwKs_8lz4_flex4sinkNtB4_9SliceSinkNtB4_4Sink18extend_from_within.exit182: ; preds = %bb.an
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 1 %i.dm, ptr nonnull align 1 %i.dl, i64 %i.dj, i1 false), !alias.scope !83, !noalias !89
  br label %.backedge
...
bb.ar:                                            ; preds = %bb.d
  ...
  br i1 %.not4.i184, label %bb.as, label %_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj2_NtNtB4_5array17TryFromSliceErrorE6unwrapCs31YAwBA1AlL_19xet_core_structures.exit.i188, !prof !29

bb.as:                                            ; preds = %bb.ar
  tail call void @_RNvNtNtCskKLDkoKarTP_4core5slice5index16slice_index_fail(i64 noundef %.val166, i64 noundef %i.dp, i64 noundef %.val156, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @75) #19, !noalias !93
  unreachable
...
_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj2_NtNtB4_5array17TryFromSliceErrorE6unwrapCs31YAwBA1AlL_19xet_core_structures.exit.i188: ; preds = %bb.ar
  ...
  %i.dr = load ptr, ptr %3, align 8, !alias.scope !90, !noalias !95, !nonnull !5, !noundef !5 ; 7 uses
  %i.ds = getelementptr inbounds nuw i8, ptr %i.dr, i64 %.val166 ; 2 uses
  tail call void @_RINvNtCskKLDkoKarTP_4core5slice20copy_from_slice_implhECs31YAwBA1AlL_19xet_core_structures(ptr noalias nofree noundef nonnull %i.ds, i64 noundef 8, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %i.dq, i64 noundef 8, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @5), !noalias !90
  %i.dt = getelementptr inbounds nuw i8, ptr %i.ds, i64 8
  %i.du = getelementptr inbounds nuw i8, ptr %i.dq, i64 8
  tail call void @_RINvNtCskKLDkoKarTP_4core5slice20copy_from_slice_implhECs31YAwBA1AlL_19xet_core_structures(ptr noalias nofree noundef nonnull %i.dt, i64 noundef 8, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %i.du, i64 noundef 8, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @6), !noalias !90
  %i.dv = add i64 %.val166, %i.p                  ; 11 uses
  store i64 %i.dv, ptr %i.a, align 8, !alias.scope !90, !noalias !95
  %i.dw = getelementptr inbounds nuw i8, ptr %i.dq, i64 %i.p
  %.sroa.030.0.copyload.i189 = load i16, ptr %i.dw, align 1, !alias.scope !96, !noalias !99 ; 3 uses
...
bb.at:                                            ; preds = %_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj2_NtNtB4_5array17TryFromSliceErrorE6unwrapCs31YAwBA1AlL_19xet_core_structures.exit.i188
  ...
  %i.ec = sub nuw i64 %i.dv, %i.dy                ; 2 uses
...
vector.body143:                                   ; preds = %vector.body143, %vector.ph141
  ...
  %wide.load145 = load <16 x i8>, ptr %i.ey, align 1, !noalias !102
  %i.ez = getelementptr inbounds nuw i8, ptr %i.dr, i64 %i.ew
  store <16 x i8> %wide.load145, ptr %i.ez, align 1, !noalias !102
  %index.next146 = add nuw i64 %index144, 16      ; 2 uses
  %i.fa = icmp eq i64 %index.next146, %n.vec142
  br i1 %i.fa, label %scalar.ph139.preheader, label %vector.body143, !llvm.loop !105
...
bb.ax:                                            ; preds = %scalar.ph139
  tail call void @_RNvNtCskKLDkoKarTP_4core9panicking18panic_bounds_check(i64 noundef %i.fc, i64 noundef %.val156, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @76) #19, !noalias !102
  unreachable

bb.ay:                                            ; preds = %bb.aw
  %i.fe = getelementptr inbounds nuw i8, ptr %i.dr, i64 %i.fc
  %i.ff = load i8, ptr %i.fe, align 1, !noalias !102, !noundef !5
  %i.fg = getelementptr inbounds nuw i8, ptr %i.dr, i64 %.sroa.01.010.i
  store i8 %i.ff, ptr %i.fg, align 1, !noalias !102
  %exitcond15.not.i = icmp eq i64 %i.fb, %i.ee
  br i1 %exitcond15.not.i, label %.backedge, label %scalar.ph139, !llvm.loop !106

bb.az:                                            ; preds = %bb.aw
  tail call void @_RNvNtCskKLDkoKarTP_4core9panicking18panic_bounds_check(i64 noundef %umax.i192, i64 noundef %.val156, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @77) #19, !noalias !102
  unreachable

bb.ba:                                            ; preds = %bb.au
  %i.fh = add nuw i64 %i.ec, 18
  tail call void @llvm.experimental.noalias.scope.decl(metadata !107)
  %i.fi = tail call { i64, i64 } @_RINvNtNtCskKLDkoKarTP_4core5slice5index5rangeINtNtNtB6_3ops5range5RangejEECs31YAwBA1AlL_19xet_core_structures(i64 noundef %i.ec, i64 noundef %i.fh, i64 noundef range(i64 0, -9223372036854775808) %.val156, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @72), !noalias !110 ; 2 uses
  ...
  br i1 %.not.i.i194, label %bb.bb, label %_RNvXs_NtCs6f1wo00zwKs_8lz4_flex4sinkNtB4_9SliceSinkNtB4_4Sink18extend_from_within.exit195, !prof !6

bb.bb:                                            ; preds = %bb.ba
  tail call void @_RNvNtCskKLDkoKarTP_4core9panicking9panic_fmt(ptr noundef nonnull @0, ptr noundef nonnull inttoptr (i64 43 to ptr), ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @72) #19, !noalias !110
  unreachable
...
_RNvXs_NtCs6f1wo00zwKs_8lz4_flex4sinkNtB4_9SliceSinkNtB4_4Sink18extend_from_within.exit195: ; preds = %bb.ba
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 1 %i.fo, ptr nonnull align 1 %i.fn, i64 %i.fl, i1 false), !alias.scope !107, !noalias !113
...
.split:
  ...
  %.val226 = load i64, ptr %i.a, align 8, !noundef !5
  %i.b = tail call i64 @llvm.usub.sat.i64(i64 %2, i64 18)
  %i.c = getelementptr inbounds nuw i8, ptr %3, i64 8 ; 9 uses
  %.val213 = load i64, ptr %i.c, align 8, !noundef !5
...
.lr.ph:                                           ; preds = %.split, %.backedge
  ...
  %i.f = load i8, ptr %i.e, align 1, !noundef !5  ; 4 uses
...
bb.c:                                             ; preds = %bb.a
  %.val225 = load i64, ptr %i.a, align 8, !noundef !5 ; 5 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %.not = icmp ugt i64 %i.q, %2
  br i1 %.not, label %bb.av, label %bb.aw, !prof !29
...
.lr.ph835:                                        ; preds = %.preheader478.preheader, %.preheader478
  ...
  %i.u = load i8, ptr %i.t, align 1, !alias.scope !114, !noalias !117, !noundef !5 ; 2 uses
...
bb.i:                                             ; preds = %bb.h
  %.val212 = load i64, ptr %i.c, align 8, !noundef !5 ; 2 uses
  %.val224 = load i64, ptr %i.a, align 8, !noundef !5 ; 2 uses
...
bb.k:                                             ; preds = %bb.i
  ...
  br i1 %or.cond206, label %bb.m, label %bb.n, !prof !29
...
_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj2_NtNtB4_5array17TryFromSliceErrorE6unwrapCs31YAwBA1AlL_19xet_core_structures.exit.i: ; preds = %bb.o
  %i.aj = getelementptr inbounds nuw i8, ptr %1, i64 %.sroa.0.1
  %.sroa.030.0.copyload.i = load i16, ptr %i.aj, align 1, !alias.scope !120, !noalias !123 ; 4 uses
  %i.ak = icmp eq i16 %.sroa.030.0.copyload.i, 0
  br i1 %i.ak, label %bb.q, label %_RNvNtNtCs6f1wo00zwKs_8lz4_flex5block15decompress_safe17read_match_offset.exit

bb.p:                                             ; preds = %bb.f
  %.val222 = load i64, ptr %i.a, align 8, !noundef !5
...
.lr.ph839:                                        ; preds = %.preheader.preheader, %.preheader
  ...
  %i.ar = load i8, ptr %i.aq, align 1, !alias.scope !126, !noalias !129, !noundef !5 ; 2 uses
...
bb.s:                                             ; preds = %_RNvNtNtCs6f1wo00zwKs_8lz4_flex5block15decompress_safe17read_match_offset.exit, %bb.r
  ...
  %.val221 = load i64, ptr %i.a, align 8, !noundef !5 ; 3 uses
  %i.ax = add i64 %.val221, %.sroa.085.0          ; 2 uses
  %.val210 = load i64, ptr %i.c, align 8, !noundef !5 ; 2 uses
...
bb.w:                                             ; preds = %bb.v
  ...
  tail call fastcc void @_RNvXs_NtCs6f1wo00zwKs_8lz4_flex4sinkNtB4_9SliceSinkNtB4_4Sink22extend_from_slice_wild(ptr noalias nofree noundef nonnull align 8 dereferenceable(24) %3, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %i.bd, i64 noundef range(i64 0, -9223372036854775808) %..i.i, i64 noundef range(i64 0, -9223372036854775808) %..i.i) #20, !noalias !132
...
bb.y:                                             ; preds = %bb.x
  %.val216 = load i64, ptr %i.a, align 8, !noundef !5 ; 13 uses
...
bb.z:                                             ; preds = %bb.x
  ...
  %.val.i237 = load i64, ptr %i.a, align 8, !alias.scope !135, !noalias !138, !noundef !5 ; 15 uses
...
bb.ab:                                            ; preds = %bb.aa
  %.val1.i = load ptr, ptr %3, align 8, !alias.scope !135, !noalias !138 ; 3 uses
  %.val2.i = load i64, ptr %i.c, align 8, !alias.scope !135, !noalias !138, !noundef !5 ; 4 uses
...
bb.ac:                                            ; preds = %bb.ab
  tail call void @_RNvNtCskKLDkoKarTP_4core9panicking18panic_bounds_check(i64 noundef %i.bh, i64 noundef %.val2.i, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @79) #19, !noalias !142
  unreachable

_RNvXs_NtCs6f1wo00zwKs_8lz4_flex4sinkNtB4_9SliceSinkNtB4_4Sink7byte_at.exit.i: ; preds = %bb.ab
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.val1.i) ], !noalias !143
  ...
  br i1 %or.cond.i.i, label %bb.ad, label %_RNvXs_NtCs6f1wo00zwKs_8lz4_flex4sinkNtB4_9SliceSinkNtB4_4Sink16extend_with_fill.exit.i, !prof !29

bb.ad:                                            ; preds = %_RNvXs_NtCs6f1wo00zwKs_8lz4_flex4sinkNtB4_9SliceSinkNtB4_4Sink7byte_at.exit.i
  tail call void @_RNvNtNtCskKLDkoKarTP_4core5slice5index16slice_index_fail(i64 noundef %.val.i237, i64 noundef %i.bl, i64 noundef %.val2.i, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @71) #19, !noalias !144
  unreachable

_RNvXs_NtCs6f1wo00zwKs_8lz4_flex4sinkNtB4_9SliceSinkNtB4_4Sink16extend_with_fill.exit.i: ; preds = %_RNvXs_NtCs6f1wo00zwKs_8lz4_flex4sinkNtB4_9SliceSinkNtB4_4Sink7byte_at.exit.i
  %i.bn = getelementptr inbounds nuw i8, ptr %.val1.i, i64 %i.bh
  %i.bo = load i8, ptr %i.bn, align 1, !noalias !142, !noundef !5
  %i.bp = getelementptr inbounds nuw i8, ptr %.val1.i, i64 %.val.i237
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %i.bp, i8 %i.bo, i64 range(i64 1, 0) %.sroa.085.1, i1 false), !noalias !144
  br label %.backedge.sink.split

bb.ae:                                            ; preds = %bb.aa
  tail call void @llvm.experimental.noalias.scope.decl(metadata !147), !noalias !143
...
.lr.ph.i.i:                                       ; preds = %bb.ae
  %i.bs = load i64, ptr %i.c, align 8, !alias.scope !150, !noalias !138, !noundef !5 ; 5 uses
  %i.bt = load ptr, ptr %3, align 8, !alias.scope !150, !noalias !138, !nonnull !5 ; 4 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.cj, align 1, !noalias !151
  %i.ck = getelementptr inbounds nuw i8, ptr %i.bt, i64 %i.ch
  store <16 x i8> %wide.load, ptr %i.ck, align 1, !noalias !151
  %index.next = add nuw i64 %index, 16            ; 2 uses
...
bb.ag:                                            ; preds = %scalar.ph
  tail call void @_RNvNtCskKLDkoKarTP_4core9panicking18panic_bounds_check(i64 noundef %i.cn, i64 noundef %i.bs, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @76) #19, !noalias !151
  unreachable

bb.ah:                                            ; preds = %bb.af
  %i.cp = getelementptr inbounds nuw i8, ptr %i.bt, i64 %i.cn
  %i.cq = load i8, ptr %i.cp, align 1, !noalias !151, !noundef !5
  %i.cr = getelementptr inbounds nuw i8, ptr %i.bt, i64 %.sroa.01.010.i.i
  store i8 %i.cq, ptr %i.cr, align 1, !noalias !151
  %exitcond15.not.i.i = icmp eq i64 %i.cm, %i.bq
  br i1 %exitcond15.not.i.i, label %.backedge.sink.split, label %scalar.ph, !llvm.loop !153

bb.ai:                                            ; preds = %bb.af
  tail call void @_RNvNtCskKLDkoKarTP_4core9panicking18panic_bounds_check(i64 noundef %umax.i.i, i64 noundef %i.bs, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @77) #19, !noalias !151
  unreachable
...
._crit_edge585:                                   ; preds = %bb.ak
  %.pre = load ptr, ptr %3, align 8, !alias.scope !154, !noalias !143
  br label %bb.am

bb.al:                                            ; preds = %bb.aj
  %i.cu = add i64 %.val216, 32
  %.not4.i = icmp ugt i64 %i.cu, %.val
  %.pre587 = load ptr, ptr %3, align 8, !noalias !143 ; 3 uses
...
bb.am:                                            ; preds = %._crit_edge585, %bb.ao, %bb.al
  ...
  tail call void @llvm.experimental.noalias.scope.decl(metadata !157), !noalias !143
  %i.cx = tail call { i64, i64 } @_RINvNtNtCskKLDkoKarTP_4core5slice5index5rangeINtNtNtB6_3ops5range5RangejEECs31YAwBA1AlL_19xet_core_structures(i64 noundef %i.bf, i64 noundef %i.cw, i64 noundef range(i64 0, -9223372036854775808) %.val, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @72), !noalias !160 ; 2 uses
  ...
  br i1 %.not.i.i240.a, label %bb.an, label %_RNvXs_NtCs6f1wo00zwKs_8lz4_flex4sinkNtB4_9SliceSinkNtB4_4Sink18extend_from_within.exit, !prof !6

bb.an:                                            ; preds = %bb.am
  tail call void @_RNvNtCskKLDkoKarTP_4core9panicking9panic_fmt(ptr noundef nonnull @0, ptr noundef nonnull inttoptr (i64 43 to ptr), ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @72) #19, !noalias !160
  unreachable
...
_RNvXs_NtCs6f1wo00zwKs_8lz4_flex4sinkNtB4_9SliceSinkNtB4_4Sink18extend_from_within.exit: ; preds = %bb.am
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 1 %i.dd, ptr nonnull align 1 %i.dc, i64 %i.da, i1 false), !alias.scope !157, !noalias !161
...
bb.ao:                                            ; preds = %bb.ak
  ...
  %.pre586 = load ptr, ptr %3, align 8, !noalias !143 ; 3 uses
  br i1 %.not.i, label %bb.am, label %bb.ap

bb.ap:                                            ; preds = %bb.ao
  %i.dg = add i64 %i.bf, 64
  tail call void @llvm.experimental.noalias.scope.decl(metadata !162), !noalias !143
  %i.dh = tail call { i64, i64 } @_RINvNtNtCskKLDkoKarTP_4core5slice5index5rangeINtNtNtB6_3ops5range5RangejEECs31YAwBA1AlL_19xet_core_structures(i64 noundef %i.bf, i64 noundef %i.dg, i64 noundef range(i64 0, -9223372036854775808) %.val, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @72), !noalias !165 ; 2 uses
  ...
  br i1 %.not.i.i241, label %bb.aq, label %_RNvXs_NtCs6f1wo00zwKs_8lz4_flex4sinkNtB4_9SliceSinkNtB4_4Sink18extend_from_within.exit242, !prof !6

bb.aq:                                            ; preds = %bb.ap
  tail call void @_RNvNtCskKLDkoKarTP_4core9panicking9panic_fmt(ptr noundef nonnull @0, ptr noundef nonnull inttoptr (i64 43 to ptr), ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @72) #19, !noalias !165
  unreachable
...
_RNvXs_NtCs6f1wo00zwKs_8lz4_flex4sinkNtB4_9SliceSinkNtB4_4Sink18extend_from_within.exit242: ; preds = %bb.ap
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 1 %i.dn, ptr nonnull align 1 %i.dm, i64 %i.dk, i1 false), !alias.scope !162, !noalias !168
  %i.do = add i64 %.val216, %.sroa.085.1
  br label %.backedge.sink.split

bb.ar:                                            ; preds = %bb.al
  %i.dp = add i64 %i.bf, 32
  tail call void @llvm.experimental.noalias.scope.decl(metadata !169), !noalias !143
  %i.dq = tail call { i64, i64 } @_RINvNtNtCskKLDkoKarTP_4core5slice5index5rangeINtNtNtB6_3ops5range5RangejEECs31YAwBA1AlL_19xet_core_structures(i64 noundef %i.bf, i64 noundef %i.dp, i64 noundef range(i64 0, -9223372036854775808) %.val, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @72), !noalias !172 ; 2 uses
  ...
  br i1 %.not.i.i243, label %bb.as, label %_RNvXs_NtCs6f1wo00zwKs_8lz4_flex4sinkNtB4_9SliceSinkNtB4_4Sink18extend_from_within.exit244, !prof !6

bb.as:                                            ; preds = %bb.ar
  tail call void @_RNvNtCskKLDkoKarTP_4core9panicking9panic_fmt(ptr noundef nonnull @0, ptr noundef nonnull inttoptr (i64 43 to ptr), ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @72) #19, !noalias !172
  unreachable
...
_RNvXs_NtCs6f1wo00zwKs_8lz4_flex4sinkNtB4_9SliceSinkNtB4_4Sink18extend_from_within.exit244: ; preds = %bb.ar
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 1 %i.dw, ptr nonnull align 1 %i.dv, i64 %i.dt, i1 false), !alias.scope !169, !noalias !175
...
bb.aw:                                            ; preds = %bb.d
  ...
  %i.ea = load i64, ptr %i.c, align 8, !alias.scope !176, !noalias !179, !noundef !5 ; 2 uses
  %i.eb = add nuw i64 %.val225, 16                ; 2 uses
  %.not4.i246 = icmp ugt i64 %i.eb, %i.ea
  br i1 %.not4.i246, label %bb.ax, label %_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj2_NtNtB4_5array17TryFromSliceErrorE6unwrapCs31YAwBA1AlL_19xet_core_structures.exit.i250, !prof !29

bb.ax:                                            ; preds = %bb.aw
  tail call void @_RNvNtNtCskKLDkoKarTP_4core5slice5index16slice_index_fail(i64 noundef %.val225, i64 noundef %i.eb, i64 noundef %i.ea, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @75) #19, !noalias !181
  unreachable
...
_RNvMNtCskKLDkoKarTP_4core6resultINtB2_6ResultAhj2_NtNtB4_5array17TryFromSliceErrorE6unwrapCs31YAwBA1AlL_19xet_core_structures.exit.i250: ; preds = %bb.aw
  ...
  %i.ed = load ptr, ptr %3, align 8, !alias.scope !176, !noalias !179, !nonnull !5, !noundef !5
  %i.ee = getelementptr inbounds nuw i8, ptr %i.ed, i64 %.val225 ; 2 uses
  tail call void @_RINvNtCskKLDkoKarTP_4core5slice20copy_from_slice_implhECs31YAwBA1AlL_19xet_core_structures(ptr noalias nofree noundef nonnull %i.ee, i64 noundef 8, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %i.ec, i64 noundef 8, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @5), !noalias !176
  %i.ef = getelementptr inbounds nuw i8, ptr %i.ee, i64 8
  %i.eg = getelementptr inbounds nuw i8, ptr %i.ec, i64 8
  tail call void @_RINvNtCskKLDkoKarTP_4core5slice20copy_from_slice_implhECs31YAwBA1AlL_19xet_core_structures(ptr noalias nofree noundef nonnull %i.ef, i64 noundef 8, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %i.eg, i64 noundef 8, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @6), !noalias !176
  %i.eh = add nuw i64 %.val225, %i.p              ; 4 uses
  store i64 %i.eh, ptr %i.a, align 8, !alias.scope !176, !noalias !179
  %i.ei = getelementptr inbounds nuw i8, ptr %i.ec, i64 %i.p
  %.sroa.030.0.copyload.i251 = load i16, ptr %i.ei, align 1, !alias.scope !182, !noalias !185 ; 3 uses
...
bb.ba:                                            ; preds = %bb.az
  ...
  tail call fastcc void @_RNvXs_NtCs6f1wo00zwKs_8lz4_flex4sinkNtB4_9SliceSinkNtB4_4Sink22extend_from_slice_wild(ptr noalias nofree noundef nonnull align 8 dereferenceable(24) %3, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %i.es, i64 noundef range(i64 0, -9223372036854775808) %..i.i255, i64 noundef range(i64 0, -9223372036854775808) %..i.i255) #20, !noalias !188
...
.lr.ph.i:                                         ; preds = %bb.bf
  %i.ey = load i64, ptr %i.c, align 8, !alias.scope !191, !noundef !5 ; 5 uses
  %i.ez = load ptr, ptr %3, align 8, !alias.scope !191, !nonnull !5 ; 4 uses
...
vector.body846:                                   ; preds = %vector.body846, %vector.ph844
  ...
  %wide.load848 = load <16 x i8>, ptr %i.fp, align 1, !noalias !191
  %i.fq = getelementptr inbounds nuw i8, ptr %i.ez, i64 %i.fn
  store <16 x i8> %wide.load848, ptr %i.fq, align 1, !noalias !191
  %index.next849 = add nuw i64 %index847, 16      ; 2 uses
  %i.fr = icmp eq i64 %index.next849, %n.vec845
  br i1 %i.fr, label %scalar.ph842.preheader, label %vector.body846, !llvm.loop !194
...
bb.bh:                                            ; preds = %scalar.ph842
  tail call void @_RNvNtCskKLDkoKarTP_4core9panicking18panic_bounds_check(i64 noundef %i.ft, i64 noundef %i.ey, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @76) #19, !noalias !191
  unreachable

bb.bi:                                            ; preds = %bb.bg
  %i.fv = getelementptr inbounds nuw i8, ptr %i.ez, i64 %i.ft
  %i.fw = load i8, ptr %i.fv, align 1, !noalias !191, !noundef !5
  %i.fx = getelementptr inbounds nuw i8, ptr %i.ez, i64 %.sroa.01.010.i
  store i8 %i.fw, ptr %i.fx, align 1, !noalias !191
  %exitcond15.not.i = icmp eq i64 %i.fs, %i.ew
  br i1 %exitcond15.not.i, label %.backedge.sink.split, label %scalar.ph842, !llvm.loop !195

bb.bj:                                            ; preds = %bb.bg
  tail call void @_RNvNtCskKLDkoKarTP_4core9panicking18panic_bounds_check(i64 noundef %umax.i260, i64 noundef %i.ey, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @77) #19, !noalias !191
  unreachable

bb.bk:                                            ; preds = %bb.bd
  tail call void @llvm.experimental.noalias.scope.decl(metadata !196)
  %i.fy = load ptr, ptr %3, align 8, !alias.scope !196, !nonnull !5, !noundef !5 ; 2 uses
  %i.fz = load i64, ptr %i.c, align 8, !alias.scope !196, !noundef !5 ; 2 uses
  %i.ga = add i64 %i.et, 18
  tail call void @llvm.experimental.noalias.scope.decl(metadata !199)
  %i.gb = tail call { i64, i64 } @_RINvNtNtCskKLDkoKarTP_4core5slice5index5rangeINtNtNtB6_3ops5range5RangejEECs31YAwBA1AlL_19xet_core_structures(i64 noundef %i.et, i64 noundef %i.ga, i64 noundef range(i64 0, -9223372036854775808) %i.fz, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @72), !noalias !202 ; 2 uses
  ...
  br i1 %.not.i.i262, label %bb.bl, label %_RNvXs_NtCs6f1wo00zwKs_8lz4_flex4sinkNtB4_9SliceSinkNtB4_4Sink18extend_from_within.exit263, !prof !6

bb.bl:                                            ; preds = %bb.bk
  tail call void @_RNvNtCskKLDkoKarTP_4core9panicking9panic_fmt(ptr noundef nonnull @0, ptr noundef nonnull inttoptr (i64 43 to ptr), ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @72) #19, !noalias !202
  unreachable
...
_RNvXs_NtCs6f1wo00zwKs_8lz4_flex4sinkNtB4_9SliceSinkNtB4_4Sink18extend_from_within.exit263: ; preds = %bb.bk
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 1 %i.gh, ptr nonnull align 1 %i.gg, i64 %i.ge, i1 false), !alias.scope !199, !noalias !196
...
bb.c:                                             ; preds = %bb.a
  %i.c = icmp eq i64 %6, 0
  br i1 %i.c, label %bb.e, label %bb.d, !prof !203
...
bb.e:                                             ; preds = %bb.c
  ...
  %.val = load i64, ptr %i.d, align 8, !noundef !5 ; 2 uses
  %i.e = getelementptr inbounds nuw i8, ptr %3, i64 16 ; 10 uses
  %.val37 = load i64, ptr %i.e, align 8, !noundef !5 ; 4 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %i.l, label %bb.h, label %bb.g, !prof !6
...
bb.h:                                             ; preds = %bb.f
  ...
  %.val35 = load i64, ptr %i.e, align 8, !noundef !5
...
_RNvYNtNtNtCs6f1wo00zwKs_8lz4_flex5block9hashtable11HashTable4KNtB4_9HashTable11get_hash_atCs31YAwBA1AlL_19xet_core_structures.exit: ; preds = %bb.g
  %.sroa.01.0.copyload.i.i = load i64, ptr %0, align 1, !alias.scope !204
...
bb.i:                                             ; preds = %bb.g, %_RNvYNtNtNtCs6f1wo00zwKs_8lz4_flex5block9hashtable11HashTable4KNtB4_9HashTable11get_hash_atCs31YAwBA1AlL_19xet_core_structures.exit
  ...
  br i1 %i.t, label %.split._crit_edge, label %.lr.ph.preheader, !prof !209
