...
bb.a:
  ...
  %.sroa.0.0.copyload = load ptr, ptr %1, align 8, !alias.scope !31 ; 4 uses
  %.sroa.4.0..sroa_idx3 = getelementptr inbounds nuw i8, ptr %1, i64 8
  %.sroa.4.0.copyload = load ptr, ptr %.sroa.4.0..sroa_idx3, align 8, !alias.scope !31 ; 3 uses
  %.sroa.5.0..sroa_idx4 = getelementptr inbounds nuw i8, ptr %1, i64 16
  %.sroa.5.0.copyload = load ptr, ptr %.sroa.5.0..sroa_idx4, align 8, !alias.scope !31 ; 4 uses
  %.sroa.6.0..sroa_idx = getelementptr inbounds nuw i8, ptr %1, i64 24
  %.sroa.6.0.copyload = load ptr, ptr %.sroa.6.0..sroa_idx, align 8, !alias.scope !31 ; 3 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  store i64 0, ptr %i.d, align 8, !noalias !32
  %.sroa.7.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.d, i64 8 ; 2 uses
  store ptr inttoptr (i64 1 to ptr), ptr %.sroa.7.0..sroa_idx, align 8, !noalias !32
  %.sroa.9.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.d, i64 16 ; 2 uses
  store i64 0, ptr %.sroa.9.0..sroa_idx, align 8, !noalias !32
...
bb.d:                                             ; preds = %bb.d, %bb.c
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.c, ptr noundef nonnull align 8 dereferenceable(24) %i.d, i64 24, i1 false), !noalias !34
  %i.k = getelementptr inbounds nuw [24 x i8], ptr %.sroa.0.0.copyload, i64 %.sroa.01.0.i.i ; 2 uses
  store ptr %i.k, ptr %i.j, align 8, !noalias !35
  call fastcc void @_RNCINvCskAvCZhvKF0K_11shell_words4joinINtNtNtNtCskKLDkoKarTP_4core4iter8adapters5chain5ChainINtNtNtBJ_5slice4iter4IterNtNtCsexYYUdYSQU6_5alloc6string6StringEB1s_ERB1S_E0Cs1YANDSn9Kib_7git_xet(ptr noalias nofree noundef nonnull align 8 captures(address) dereferenceable(24) %i.d, ptr noalias nofree noundef align 8 captures(address) dereferenceable(24) %i.c, ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.k) #17, !noalias !34
...
_RINvXs2J_NtNtCskKLDkoKarTP_4core5slice4iterINtB7_4IterNtNtCsexYYUdYSQU6_5alloc6string6StringENtNtNtNtBb_4iter6traits8iterator8Iterator4foldBQ_QNCINvCskAvCZhvKF0K_11shell_words4joinINtNtNtB1z_8adapters5chain5ChainBF_BF_ERBQ_E0ECs1YANDSn9Kib_7git_xet.exit.i.loopexit: ; preds = %bb.d
  %.sroa.019.0.copyload20.pre = load i64, ptr %i.d, align 8, !noalias !32
  %.sroa.7.0.copyload23.pre = load ptr, ptr %.sroa.7.0..sroa_idx, align 8, !noalias !32
  %.sroa.9.0.copyload27.pre = load i64, ptr %.sroa.9.0..sroa_idx, align 8, !noalias !32
  br label %bb.e

bb.e:                                             ; preds = %bb.b, %_RINvXs2J_NtNtCskKLDkoKarTP_4core5slice4iterINtB7_4IterNtNtCsexYYUdYSQU6_5alloc6string6StringENtNtNtNtBb_4iter6traits8iterator8Iterator4foldBQ_QNCINvCskAvCZhvKF0K_11shell_words4joinINtNtNtB1z_8adapters5chain5ChainBF_BF_ERBQ_E0ECs1YANDSn9Kib_7git_xet.exit.i.loopexit, %bb.a
  %.sroa.9.0..sroa.9.0.copyload29 = phi i64 [ 0, %bb.a ], [ %.sroa.9.0.copyload27.pre, %_RINvXs2J_NtNtCskKLDkoKarTP_4core5slice4iterINtB7_4IterNtNtCsexYYUdYSQU6_5alloc6string6StringENtNtNtNtBb_4iter6traits8iterator8Iterator4foldBQ_QNCINvCskAvCZhvKF0K_11shell_words4joinINtNtNtB1z_8adapters5chain5ChainBF_BF_ERBQ_E0ECs1YANDSn9Kib_7git_xet.exit.i.loopexit ], [ 0, %bb.b ] ; 3 uses
  %.sroa.7.0..sroa.7.0.copyload25 = phi ptr [ inttoptr (i64 1 to ptr), %bb.a ], [ %.sroa.7.0.copyload23.pre, %_RINvXs2J_NtNtCskKLDkoKarTP_4core5slice4iterINtB7_4IterNtNtCsexYYUdYSQU6_5alloc6string6StringENtNtNtNtBb_4iter6traits8iterator8Iterator4foldBQ_QNCINvCskAvCZhvKF0K_11shell_words4joinINtNtNtB1z_8adapters5chain5ChainBF_BF_ERBQ_E0ECs1YANDSn9Kib_7git_xet.exit.i.loopexit ], [ inttoptr (i64 1 to ptr), %bb.b ] ; 3 uses
  %.sroa.019.0 = phi i64 [ 0, %bb.a ], [ %.sroa.019.0.copyload20.pre, %_RINvXs2J_NtNtCskKLDkoKarTP_4core5slice4iterINtB7_4IterNtNtCsexYYUdYSQU6_5alloc6string6StringENtNtNtNtBb_4iter6traits8iterator8Iterator4foldBQ_QNCINvCskAvCZhvKF0K_11shell_words4joinINtNtNtB1z_8adapters5chain5ChainBF_BF_ERBQ_E0ECs1YANDSn9Kib_7git_xet.exit.i.loopexit ], [ 0, %bb.b ] ; 3 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  store i64 %.sroa.019.0, ptr %i.b, align 8, !noalias !32
  store ptr %.sroa.7.0..sroa.7.0.copyload25, ptr %.sink.i.sroa.gep, align 8, !noalias !32
  store i64 %.sroa.9.0..sroa.9.0.copyload29, ptr %.sink.i.sroa.gep16, align 8, !noalias !32
...
bb.h:                                             ; preds = %bb.h, %bb.g
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.a, ptr noundef nonnull align 8 dereferenceable(24) %i.b, i64 24, i1 false), !noalias !34
  %i.t = getelementptr inbounds nuw [24 x i8], ptr %.sroa.5.0.copyload, i64 %.sroa.01.0.i3.i ; 2 uses
  store ptr %i.t, ptr %i.s, align 8, !noalias !36
  call fastcc void @_RNCINvCskAvCZhvKF0K_11shell_words4joinINtNtNtNtCskKLDkoKarTP_4core4iter8adapters5chain5ChainINtNtNtBJ_5slice4iter4IterNtNtCsexYYUdYSQU6_5alloc6string6StringEB1s_ERB1S_E0Cs1YANDSn9Kib_7git_xet(ptr noalias nofree noundef align 8 captures(address) dereferenceable(24) %i.b, ptr noalias nofree noundef align 8 captures(address) dereferenceable(24) %i.a, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.t), !noalias !34
...
_RINvXs_NtNtNtCskKLDkoKarTP_4core4iter8adapters5chainINtB5_5ChainINtNtNtBb_5slice4iter4IterNtNtCsexYYUdYSQU6_5alloc6string6StringEB10_ENtNtNtB9_6traits8iterator8Iterator4foldB1q_NCINvCskAvCZhvKF0K_11shell_words4joinBO_RB1q_E0ECs1YANDSn9Kib_7git_xet.exit: ; preds = %_RINvXs_NtNtNtCskKLDkoKarTP_4core4iter8adapters5chainINtB5_5ChainINtNtNtBb_5slice4iter4IterNtNtCsexYYUdYSQU6_5alloc6string6StringEB10_ENtNtNtB9_6traits8iterator8Iterator4foldB1q_NCINvCskAvCZhvKF0K_11shell_words4joinBO_RB1q_E0ECs1YANDSn9Kib_7git_xet.exit.loopexit, %bb.e, %bb.f
  ...
  %.sroa.4.0.copyload9 = phi ptr [ %.sroa.7.0..sroa.7.0.copyload25, %bb.f ], [ %.sroa.7.0..sroa.7.0.copyload25, %bb.e ], [ %.sroa.4.0.copyload9.pre, %_RINvXs_NtNtNtCskKLDkoKarTP_4core4iter8adapters5chainINtB5_5ChainINtNtNtBb_5slice4iter4IterNtNtCsexYYUdYSQU6_5alloc6string6StringEB10_ENtNtNtB9_6traits8iterator8Iterator4foldB1q_NCINvCskAvCZhvKF0K_11shell_words4joinBO_RB1q_E0ECs1YANDSn9Kib_7git_xet.exit.loopexit ] ; 3 uses
...
bb.i:                                             ; preds = %_RINvXs_NtNtNtCskKLDkoKarTP_4core4iter8adapters5chainINtB5_5ChainINtNtNtBb_5slice4iter4IterNtNtCsexYYUdYSQU6_5alloc6string6StringEB10_ENtNtNtB9_6traits8iterator8Iterator4foldB1q_NCINvCskAvCZhvKF0K_11shell_words4joinBO_RB1q_E0ECs1YANDSn9Kib_7git_xet.exit
  ...
  %i.z = load i8, ptr %i.y, align 1, !noalias !38, !noundef !4
...
_RNvXs2K_NtNtCskKLDkoKarTP_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits12double_ended19DoubleEndedIterator9next_backCs1YANDSn9Kib_7git_xet.exit17.i.i: ; preds = %bb.i
  ...
  %i.ad = load i8, ptr %i.ac, align 1, !noalias !38, !noundef !4 ; 3 uses
  %i.ae = and i8 %i.ad, 31
...
_RNvXs2K_NtNtCskKLDkoKarTP_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits12double_ended19DoubleEndedIterator9next_backCs1YANDSn9Kib_7git_xet.exit19.i.i: ; preds = %_RNvXs2K_NtNtCskKLDkoKarTP_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits12double_ended19DoubleEndedIterator9next_backCs1YANDSn9Kib_7git_xet.exit17.i.i
  ...
  %i.ak = load i8, ptr %i.aj, align 1, !noalias !38, !noundef !4 ; 3 uses
  %i.al = and i8 %i.ak, 15
...
_RNvXs2K_NtNtCskKLDkoKarTP_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits12double_ended19DoubleEndedIterator9next_backCs1YANDSn9Kib_7git_xet.exit21.i.i: ; preds = %_RNvXs2K_NtNtCskKLDkoKarTP_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits12double_ended19DoubleEndedIterator9next_backCs1YANDSn9Kib_7git_xet.exit19.i.i
  ...
  %i.aq = load i8, ptr %i.ap, align 1, !noalias !38, !noundef !4
  %i.ar = and i8 %i.aq, 7
...
.lr.ph.i.i:                                       ; preds = %bb.a, %_RNvXs8_NtNtCskKLDkoKarTP_4core3str7patternINtB5_19MultiCharEqSearcherNvMNtNtB9_4char7methodsc13is_whitespaceENtB5_8Searcher4nextCs1YANDSn9Kib_7git_xet.exit.i.i
  ...
  %i.g = load i8, ptr %i.d, align 1, !noalias !65, !noundef !4 ; 5 uses
...
_RNvXs2J_NtNtCskKLDkoKarTP_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits8iterator8Iterator4nextCs1YANDSn9Kib_7git_xet.exit12.i.i.i.i.i: ; preds = %.lr.ph.i.i
  ...
  %i.m = load i8, ptr %i.f, align 1, !noalias !65, !noundef !4
...
_RNvXs2J_NtNtCskKLDkoKarTP_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits8iterator8Iterator4nextCs1YANDSn9Kib_7git_xet.exit14.i.i.i.i.i: ; preds = %_RNvXs2J_NtNtCskKLDkoKarTP_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits8iterator8Iterator4nextCs1YANDSn9Kib_7git_xet.exit12.i.i.i.i.i
  ...
  %i.v = load i8, ptr %i.l, align 1, !noalias !65, !noundef !4
...
_RNvXs2J_NtNtCskKLDkoKarTP_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits8iterator8Iterator4nextCs1YANDSn9Kib_7git_xet.exit16.i.i.i.i.i: ; preds = %_RNvXs2J_NtNtCskKLDkoKarTP_4core5slice4iterINtB6_4IterhENtNtNtNtBa_4iter6traits8iterator8Iterator4nextCs1YANDSn9Kib_7git_xet.exit14.i.i.i.i.i
  ...
  %i.af = load i8, ptr %i.u, align 1, !noalias !65, !noundef !4
...
bb.h:                                             ; preds = %bb.e
  ...
  %i.ba = load i8, ptr %i.az, align 1, !noalias !66, !noundef !4
end_hunk_0
