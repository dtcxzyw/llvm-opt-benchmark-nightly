...
bb.a:
  ...
  %9 = alloca %"struct.rocksdb::DBOptions", align 8 ; 11 uses
  ...
  %25 = alloca %"class.std::unique_ptr.72", align 8 ; 13 uses
  ...
  %31 = alloca %"class.std::function.98", align 8 ; 11 uses
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.aq = load i64, ptr %i.ap, align 8, !tbaa !67 ; 3 uses
...
.loopexit:                                        ; preds = %bb.p, %bb.m
  ...
  invoke void @_ZN7rocksdb6StatusC2ENS0_4CodeENS0_7SubCodeERKNS_5SliceES5_NS0_8SeverityE(ptr noundef nonnull align 8 dereferenceable(16) %0, i8 noundef zeroext 4, i8 noundef zeroext 0, ptr noundef nonnull align 8 dereferenceable(16) %14, ptr noundef nonnull align 8 dereferenceable(16) %15, i8 noundef zeroext 0)
          to label %_ZN7rocksdb6Status15InvalidArgumentERKNS_5SliceES3_.exit96 unwind label %bb.r

_ZN7rocksdb6Status15InvalidArgumentERKNS_5SliceES3_.exit96: ; preds = %.loopexit
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE16find_last_not_ofEcm.exit: ; preds = %bb.o
  ...
  store ptr %i.az, ptr %17, align 8, !tbaa !66, !alias.scope !113
...
.noexc11.i.i:                                     ; preds = %bb.t
  invoke void @_ZSt17__throw_bad_allocv() #32
          to label %.noexc97 unwind label %bb.am

.noexc97:                                         ; preds = %.noexc11.i.i
  unreachable
...
.noexc98:                                         ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm.exit.i.i.i
...
._crit_edge.i.i.i:                                ; preds = %.noexc98, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE16find_last_not_ofEcm.exit
  %i.bf = phi ptr [ %i.be, %.noexc98 ], [ %i.az, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE16find_last_not_ofEcm.exit ] ; 3 uses
...
bb.w:                                             ; preds = %bb.v, %bb.u
  ...
  store i64 %spec.select.i.i.i, ptr %i.bh, align 8, !tbaa !67, !alias.scope !113
  %i.bi = getelementptr inbounds nuw i8, ptr %i.bf, i64 %spec.select.i.i.i
  store i8 0, ptr %i.bi, align 1, !tbaa !15
  call void @llvm.experimental.noalias.scope.decl(metadata !117)
  %i.bj = load i64, ptr %i.bh, align 8, !tbaa !67, !noalias !117 ; 5 uses
  %i.bk = and i64 %i.bj, -4
...
bb.x:                                             ; preds = %bb.w
  invoke void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.72) #32
          to label %.noexc99 unwind label %bb.an
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i: ; preds = %bb.z, %bb.y
  store i64 %i.bm, ptr %i.bh, align 8, !tbaa !67, !noalias !117
  ...
  store ptr %i.bv, ptr %16, align 8, !tbaa !66, !alias.scope !117
...
bb.aa:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i
  %i.by = load i64, ptr %i.bh, align 8, !tbaa !67, !noalias !117 ; 3 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i
  ...
  %.pre.i = load i64, ptr %i.bh, align 8, !tbaa !67, !noalias !117
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i, %bb.aa
  ...
  store i64 %i.cd, ptr %i.ce, align 8, !tbaa !67, !alias.scope !117
...
bb.ad:                                            ; preds = %_ZN7rocksdb6StatusD2Ev.exit
  ...
  %i.cu = load i64, ptr %i.ce, align 8, !tbaa !67, !noalias !123
...
bb.ae:                                            ; preds = %bb.ad
  ...
  %i.cw = load i64, ptr %i.cv, align 8, !tbaa !67, !noalias !126 ; 5 uses
  %i.cx = icmp sgt i64 %i.cw, 9223372036854775770
  br i1 %i.cx, label %bb.af, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE15_M_check_lengthEmmPKc.exit.i.i105

bb.af:                                            ; preds = %bb.ae
  invoke void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.72) #32
          to label %.noexc115 unwind label %bb.ar

.noexc115:                                        ; preds = %bb.af
  unreachable

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE15_M_check_lengthEmmPKc.exit.i.i105: ; preds = %bb.ae
  ...
  br i1 %i.db, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i.i.i114, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i106

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i.i.i114: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE15_M_check_lengthEmmPKc.exit.i.i105
  %i.dc = icmp ult i64 %i.cw, 16
  call void @llvm.assume(i1 %i.dc)
  br label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i.i.i107

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i106: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE15_M_check_lengthEmmPKc.exit.i.i105
  %i.dd = load i64, ptr %i.da, align 8, !tbaa !15, !noalias !126
  br label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i.i.i107

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i.i.i107: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i106, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i.i.i114
  %i.de = phi i64 [ %i.dd, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i106 ], [ 15, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i.i.i114 ]
  %.not.i.i.i108 = icmp ugt i64 %i.cy, %i.de
  br i1 %.not.i.i.i108, label %bb.ah, label %bb.ag

bb.ag:                                            ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i.i.i107
  ...
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i111

bb.ah:                                            ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i.i.i107
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_mutateEmmPKcm(ptr noundef nonnull align 8 dereferenceable(32) %22, i64 noundef %i.cw, i64 noundef 0, ptr noundef nonnull @.str.51, i64 noundef 37)
          to label %._ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i111_crit_edge unwind label %bb.ar

._ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i111_crit_edge: ; preds = %bb.ah
  %.pre293 = load ptr, ptr %22, align 8, !tbaa !9, !noalias !126
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i111

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i111: ; preds = %._ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i111_crit_edge, %bb.ag
  %i.dg = phi ptr [ %.pre293, %._ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i111_crit_edge ], [ %i.cz, %bb.ag ]
  store i64 %i.cy, ptr %i.cv, align 8, !tbaa !67, !noalias !126
  ...
  store ptr %i.di, ptr %21, align 8, !tbaa !66, !alias.scope !126
  %i.dj = load ptr, ptr %22, align 8, !tbaa !9, !noalias !126 ; 2 uses
  %i.dk = icmp eq ptr %i.dj, %i.da
  br i1 %i.dk, label %bb.ai, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i112

bb.ai:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i111
  %i.dl = load i64, ptr %i.cv, align 8, !tbaa !67, !noalias !126 ; 3 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i112: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i111
  ...
  %.pre.i113 = load i64, ptr %i.cv, align 8, !tbaa !67, !noalias !126
end_hunk_0
