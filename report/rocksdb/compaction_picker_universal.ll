...
bb.fw:                                            ; preds = %bb.gi, %.lr.ph.i.i59
  ...
  %i.asw = phi i64 [ 1, %.lr.ph.i.i59 ], [ %i.avs, %bb.gi ] ; 3 uses
  %.02493104.i.i = add i64 %i.asw, -1             ; 3 uses
  %i.asx = getelementptr inbounds nuw [40 x i8], ptr %.val45108.i.i, i64 %.02493104.i.i
...
bb.fx:                                            ; preds = %bb.fw
  ...
  %i.atf = getelementptr inbounds nuw [8 x i8], ptr %i.ate, i64 %.02493104.i.i
...
bb.gj:                                            ; preds = %_ZNSt6vectorIPN7rocksdb12FileMetaDataESaIS2_EE17_M_realloc_insertIJRKS2_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i.i.i, %bb.gd
  ...
  %i.awa = and i64 %.02493104.i.i, 2147483648
  %i.awb = icmp eq i64 %i.awa, 0
  br i1 %i.awb, label %bb.gk, label %.critedge43.i.i

bb.gk:                                            ; preds = %bb.gj
  %i.awc = and i64 %i.asw, 4294967295             ; 2 uses
