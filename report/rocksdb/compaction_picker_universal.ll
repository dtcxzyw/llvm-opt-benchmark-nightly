...
.lr.ph.split.i.i:                                 ; preds = %.lr.ph.i.i, %bb.o
  ...
  %i.fe = load i32, ptr %.0.i.i.i.i, align 8, !tbaa !249
...
_ZN7rocksdb12_GLOBAL__N_126UniversalCompactionBuilder27MaybePickPeriodicCompactionEPNS_10CompactionE.exit: ; preds = %bb.o, %bb.n, %bb.m, %_ZN7rocksdb12_GLOBAL__N_126UniversalCompactionBuilder22PickPeriodicCompactionEv.exit.i
  ...
  %i.fi = load ptr, ptr %i.cp, align 8, !tbaa !84
  %i.fj = load ptr, ptr %i.cr, align 8, !tbaa !235, !nonnull !51, !align !52
  %i.fk = load ptr, ptr %i.fj, align 8, !tbaa !9
...
_ZN7rocksdb12_GLOBAL__N_126UniversalCompactionBuilder27MaybePickPeriodicCompactionEPNS_10CompactionE.exit.thread: ; preds = %_ZN7rocksdb12_GLOBAL__N_126UniversalCompactionBuilder22PickPeriodicCompactionEv.exit.i, %.critedge.i.i, %bb.h, %_ZN7rocksdb12_GLOBAL__N_126UniversalCompactionBuilder27MaybePickPeriodicCompactionEPNS_10CompactionE.exit
  %.val.i = load ptr, ptr %i.ag, align 8, !tbaa !231 ; 3 uses
  %.val7.i = load ptr, ptr %i.ai, align 8, !tbaa !234 ; 2 uses
...
bb.p:                                             ; preds = %_ZN7rocksdb12_GLOBAL__N_126UniversalCompactionBuilder27MaybePickPeriodicCompactionEPNS_10CompactionE.exit.thread
  %i.fr = load ptr, ptr %i.q, align 8, !tbaa !196, !nonnull !51, !align !52
  %i.fs = getelementptr inbounds nuw i8, ptr %i.fr, i64 352
  %i.ft = load i64, ptr %i.fs, align 8, !tbaa !250
...
.lr.ph.i.i.i:                                     ; preds = %.preheader.i.i.i
  ...
  %i.ji = add i64 %.074121.i.i, %.038100.i.i.i
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi732.a = phi <4 x i64> [ zeroinitializer, %vector.ph ], [ %i.ka, %vector.body ]
  %vec.phi733.a = phi <4 x i64> [ zeroinitializer, %vector.ph ], [ %i.kb, %vector.body ]
  ...
  %i.ka = sub <4 x i64> %vec.phi732.a, %strided.vec736 ; 2 uses
  %i.kb = sub <4 x i64> %vec.phi733.a, %strided.vec738 ; 2 uses
...
middle.block:                                     ; preds = %vector.body
  ...
  %bin.rdx741.a = add <4 x i64> %i.kb, %bin.rdx
  %bin.rdx742 = add <4 x i64> %i.kc, %bin.rdx741.a
...
bb.an:                                            ; preds = %bb.am
  ...
  br i1 %i.mz, label %.lr.ph416.i.i.i, label %._crit_edge.i53.i.i

.lr.ph416.i.i.i:                                  ; preds = %bb.an
  %i.na = getelementptr inbounds nuw i8, ptr %i.ml, i64 8 ; 6 uses
  %i.nb = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 8 uses
  %i.nc = getelementptr inbounds nuw i8, ptr %22, i64 8 ; 2 uses
  %i.nd = getelementptr inbounds nuw i8, ptr %23, i64 8 ; 2 uses
  %.not.i.i.i.i.i.i.i = icmp eq ptr @_ZTHN7rocksdb10perf_levelE, null ; 7 uses
  %i.ne = call align 1 ptr @llvm.threadlocal.address.p0(ptr align 1 @_ZN7rocksdb10perf_levelE) ; 8 uses
  %.not.i3.i.i.i.i.i.i = icmp eq ptr @_ZTHN7rocksdb12perf_contextE, null ; 8 uses
  %i.nf = call align 8 ptr @llvm.threadlocal.address.p0(ptr align 8 @_ZN7rocksdb12perf_contextE) ; 16 uses
  %i.ng = getelementptr inbounds nuw i8, ptr %20, i64 8 ; 2 uses
  %i.nh = getelementptr inbounds nuw i8, ptr %21, i64 8 ; 2 uses
  %i.ni = getelementptr inbounds nuw i8, ptr %18, i64 8 ; 2 uses
  %i.nj = getelementptr inbounds nuw i8, ptr %19, i64 8 ; 2 uses
  %i.nk = getelementptr inbounds nuw i8, ptr %16, i64 8 ; 2 uses
  %i.nl = getelementptr inbounds nuw i8, ptr %17, i64 8 ; 2 uses
  br label %bb.ao
...
._crit_edge.i53.i.i:                              ; preds = %.loopexit345.i.i.i, %bb.an
  ...
  %.0164.lcssa.i.i.i = phi double [ %i.lx, %bb.an ], [ %.2166.i.i.i, %.loopexit345.i.i.i ]
  %i.nm = fcmp ult double %.0164.lcssa.i.i.i, %i.lx
  br i1 %i.nm, label %bb.cf, label %_ZN7rocksdb12_GLOBAL__N_126UniversalCompactionBuilder31PickIncrementalForReduceSizeAmpEd.exit.thread.i.i
...
bb.ao:                                            ; preds = %.loopexit345.i.i.i, %.lr.ph416.i.i.i
  ...
  %i.nn = phi ptr [ %i.mt, %.lr.ph416.i.i.i ], [ %i.ack, %.loopexit345.i.i.i ]
  ...
  %.0164407.i.i.i = phi double [ %i.lx, %.lr.ph416.i.i.i ], [ %.2166.i.i.i, %.loopexit345.i.i.i ] ; 4 uses
  ...
  %i.no = getelementptr inbounds nuw [8 x i8], ptr %i.nn, i64 %indvars.iv457.i.i.i
  %i.np = load ptr, ptr %i.no, align 8, !tbaa !332 ; 5 uses
  %i.nq = load ptr, ptr %i.na, align 8, !tbaa !328
  %i.nr = load ptr, ptr %i.ml, align 8, !tbaa !331 ; 2 uses
  %i.ns = ptrtoint ptr %i.nq to i64
  %i.nt = ptrtoint ptr %i.nr to i64
  %i.nu = sub i64 %i.ns, %i.nt
  %i.nv = lshr exact i64 %i.nu, 3
  %i.nw = trunc i64 %i.nv to i32
  %i.nx = icmp slt i32 %.0157409.i.i.i, %i.nw
  br i1 %i.nx, label %.lr.ph.i57.i.i, label %.critedge.thread.i.i.i

.lr.ph.i57.i.i:                                   ; preds = %bb.ao
  %i.ny = getelementptr inbounds nuw i8, ptr %i.np, i64 48 ; 2 uses
  %i.nz = getelementptr inbounds nuw i8, ptr %i.np, i64 56 ; 2 uses
  %i.oa = sext i32 %.0157409.i.i.i to i64         ; 3 uses
  %i.ob = load ptr, ptr %i.nb, align 8, !tbaa !55
  %i.oc = getelementptr inbounds nuw [8 x i8], ptr %i.nr, i64 %i.oa
  %i.od = load ptr, ptr %i.oc, align 8, !tbaa !332 ; 2 uses
  %i.oe = getelementptr inbounds nuw i8, ptr %i.od, i64 80
  %i.of = load ptr, ptr %i.oe, align 8, !tbaa !9  ; 2 uses
  %i.og = getelementptr inbounds nuw i8, ptr %i.od, i64 88
  %i.oh = load i64, ptr %i.og, align 8, !tbaa !333 ; 2 uses
  %i.oi = load ptr, ptr %i.ny, align 8, !tbaa !9  ; 2 uses
  %i.oj = load i64, ptr %i.nz, align 8, !tbaa !333 ; 2 uses
  %i.ok = getelementptr inbounds nuw i8, ptr %i.ob, i64 8
  call void @llvm.lifetime.start.p0(ptr nonnull %22) #29
  %i.ol = add i64 %i.oh, -8
  store ptr %i.of, ptr %22, align 8
  store i64 %i.ol, ptr %i.nc, align 8
  call void @llvm.lifetime.start.p0(ptr nonnull %23) #29
  %i.om = add i64 %i.oj, -8
  store ptr %i.oi, ptr %23, align 8
...
_ZTWN7rocksdb10perf_levelE.exit.i.i.i.peel.i.i.i: ; preds = %bb.ap, %.lr.ph.i57.i.i
  %i.on = load i8, ptr %i.ne, align 1, !tbaa !334
  %i.oo = icmp ugt i8 %i.on, 1
  br i1 %i.oo, label %bb.aq, label %_ZNK7rocksdb21UserComparatorWrapper7CompareERKNS_5SliceES3_.exit.i.i.peel.i.i.i
