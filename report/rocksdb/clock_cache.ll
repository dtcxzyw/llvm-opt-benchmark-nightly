...
_ZN7rocksdb11clock_cache20FixedHyperClockTable12CalcHashBitsEmmNS_25CacheMetadataChargePolicyE.exit: ; preds = %.preheader.i, %._ZN7rocksdb11clock_cache20FixedHyperClockTable12CalcHashBitsEmmNS_25CacheMetadataChargePolicyE.exit_crit_edge
  %.pre-phi14 = phi i64 [ %.pre13, %._ZN7rocksdb11clock_cache20FixedHyperClockTable12CalcHashBitsEmmNS_25CacheMetadataChargePolicyE.exit_crit_edge ], [ %i.ab, %.preheader.i ]
...
bb.b:                                             ; preds = %.unr-lcssa
  ...
  %i.bi = load i32, ptr %i.k, align 32, !tbaa !112
  %i.bj = zext nneg i32 %i.bi to i64
  %i.bk = shl i64 64, %i.bj
  %i.bl = atomicrmw add ptr %i.bh, i64 %i.bk monotonic, align 8 ; 0 uses
  br label %bb.c
