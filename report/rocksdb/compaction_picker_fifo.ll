...
_ZNK7rocksdb18VersionStorageInfo12GetBlobStatsEv.exit: ; preds = %.lr.ph.i, %._crit_edge
  ...
  %spec.select222 = add i64 %i.y, %.071.lcssa     ; 7 uses
...
_ZN7rocksdb12_GLOBAL__N_117GetTotalFilesSizeERKSt6vectorIPNS_12FileMetaDataESaIS3_EE.exit: ; preds = %.lr.ph.i92, %vec.epilog.middle.block, %middle.block
  ...
  %i.bm = add i64 %.lcssa293, %.071233
  %.not90 = icmp eq i64 %.lcssa293, 0
  %i.bn = trunc nuw nsw i64 %indvars.iv to i32
  %spec.select223 = select i1 %.not90, i32 %.072232, i32 %i.bn
...
_ZN7rocksdb12_GLOBAL__N_117GetTotalFilesSizeERKSt6vectorIPNS_12FileMetaDataESaIS3_EE.exit.thread: ; preds = %_ZN7rocksdb12_GLOBAL__N_117GetTotalFilesSizeERKSt6vectorIPNS_12FileMetaDataESaIS3_EE.exit, %bb.b
  ...
  %i.bp = phi i32 [ %spec.select223, %_ZN7rocksdb12_GLOBAL__N_117GetTotalFilesSizeERKSt6vectorIPNS_12FileMetaDataESaIS3_EE.exit ], [ %.072232, %bb.b ] ; 2 uses
...
bb.i:                                             ; preds = %bb.t, %bb.h
  %.0212 = phi i64 [ %spec.select222, %bb.h ], [ %i.cs, %bb.t ]
...
._crit_edge:                                      ; preds = %_ZNSt6vectorImSaImEE9push_backERKm.exit
  %i.co = icmp eq ptr %.sroa.22.3.a, %.sroa.13.2
...
.lr.ph314:                                        ; preds = %bb.j, %_ZNSt6vectorImSaImEE9push_backERKm.exit
  ...
  %.sroa.0224.0312 = phi ptr [ %.sroa.0224.3, %_ZNSt6vectorImSaImEE9push_backERKm.exit ], [ null, %bb.j ] ; 5 uses
  %.sroa.13.0311 = phi ptr [ %.sroa.13.2, %_ZNSt6vectorImSaImEE9push_backERKm.exit ], [ null, %bb.j ] ; 3 uses
  %.sroa.22.0310 = phi ptr [ %.sroa.22.3.a, %_ZNSt6vectorImSaImEE9push_backERKm.exit ], [ null, %bb.j ] ; 7 uses
  %.not.i = icmp eq ptr %.sroa.13.0311, %.sroa.0224.0312
...
bb.l:                                             ; preds = %.lr.ph314
  %i.cp = ptrtoint ptr %.sroa.0224.0312 to i64
  %i.cq = ptrtoint ptr %.sroa.22.0310 to i64
...
bb.n:                                             ; preds = %.noexc152
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.cz, ptr align 8 %.sroa.22.0310, i64 %i.cr, i1 false)
  br label %_ZNSt6vectorImSaImEE11_S_relocateEPmS2_S2_RS0_.exit16.i.i

_ZNSt6vectorImSaImEE11_S_relocateEPmS2_S2_RS0_.exit16.i.i: ; preds = %bb.n, %.noexc152
  %.not.i17.i.i = icmp eq ptr %.sroa.22.0310, null
...
bb.o:                                             ; preds = %_ZNSt6vectorImSaImEE11_S_relocateEPmS2_S2_RS0_.exit16.i.i
  tail call void @_ZdlPvm(ptr noundef nonnull %.sroa.22.0310, i64 noundef %i.cr) #27
...
_ZNSt6vectorImSaImEE9push_backERKm.exit:          ; preds = %_ZNSt6vectorImSaImEE17_M_realloc_insertIJRKmEEEvN9__gnu_cxx17__normal_iteratorIPmS1_EEDpOT_.exit.i, %bb.k
  %.sroa.22.3.a = phi ptr [ %i.cz, %_ZNSt6vectorImSaImEE17_M_realloc_insertIJRKmEEEvN9__gnu_cxx17__normal_iteratorIPmS1_EEDpOT_.exit.i ], [ %.sroa.22.0310, %bb.k ] ; 6 uses
  ...
  %.sroa.0224.3 = phi ptr [ %i.dc, %_ZNSt6vectorImSaImEE17_M_realloc_insertIJRKmEEEvN9__gnu_cxx17__normal_iteratorIPmS1_EEDpOT_.exit.i ], [ %.sroa.0224.0312, %bb.k ] ; 4 uses
...
bb.p:                                             ; preds = %._crit_edge
  %.not.i153 = icmp eq ptr %.sroa.22.3.a, %.sroa.0224.3
...
_ZNKSt6vectorImSaImEE12_M_check_lenEmPKc.exit.i.i154: ; preds = %bb.j, %bb.p
  %.sroa.22.0.lcssa396404 = phi ptr [ %.sroa.22.3.a, %bb.p ], [ null, %bb.j ] ; 4 uses
...
bb.r:                                             ; preds = %_ZNSt6vectorImSaImEE11_S_relocateEPmS2_S2_RS0_.exit16.i.i157
  tail call void @_ZdlPvm(ptr noundef nonnull %.sroa.22.0.lcssa396404, i64 noundef 0) #27
  br label %_ZNSt6vectorImSaImEE9push_backERKm.exit162
...
_ZNSt6vectorImSaImEE9push_backERKm.exit162:       ; preds = %_ZNSt6vectorImSaImEE11_S_relocateEPmS2_S2_RS0_.exit16.i.i157, %bb.r, %bb.q, %._crit_edge
  %.sroa.22.1.a = phi ptr [ %.sroa.22.3.a, %._crit_edge ], [ %.sroa.22.3.a, %bb.q ], [ %i.dg, %bb.r ], [ %i.dg, %_ZNSt6vectorImSaImEE11_S_relocateEPmS2_S2_RS0_.exit16.i.i157 ] ; 11 uses
  ...
  %.sroa.0224.1 = phi ptr [ %.sroa.0224.3, %._crit_edge ], [ %.sroa.0224.3, %bb.q ], [ %i.dh, %bb.r ], [ %i.dh, %_ZNSt6vectorImSaImEE11_S_relocateEPmS2_S2_RS0_.exit16.i.i157 ] ; 4 uses
  %i.dj = icmp ne ptr %.sroa.22.1.a, %.sroa.13.1
  %.sroa.0.010.i.i = getelementptr inbounds i8, ptr %.sroa.13.1, i64 -8 ; 2 uses
  %.not11.i.i = icmp ult ptr %.sroa.22.1.a, %.sroa.0.010.i.i
...
.lr.ph.i.i:                                       ; preds = %_ZNSt6vectorImSaImEE9push_backERKm.exit162, %.lr.ph.i.i
  ...
  %.sroa.07.012.i.i = phi ptr [ %i.dm, %.lr.ph.i.i ], [ %.sroa.22.1.a, %_ZNSt6vectorImSaImEE9push_backERKm.exit162 ] ; 3 uses
...
_ZSt7reverseIN9__gnu_cxx17__normal_iteratorIPmSt6vectorImSaImEEEEEvT_S7_.exit: ; preds = %.lr.ph.i.i, %_ZNSt6vectorImSaImEE9push_backERKm.exit162
  %i.dn = icmp eq ptr %.sroa.22.1.a, %.sroa.13.1
...
.lr.ph327:                                        ; preds = %_ZSt7reverseIN9__gnu_cxx17__normal_iteratorIPmSt6vectorImSaImEEEEEvT_S7_.exit, %.thread266
  %.sroa.0219.0326 = phi ptr [ %i.ka, %.thread266 ], [ %.sroa.22.1.a, %_ZSt7reverseIN9__gnu_cxx17__normal_iteratorIPmSt6vectorImSaImEEEEEvT_S7_.exit ] ; 2 uses
...
.loopexit272:                                     ; preds = %.thread266, %_ZSt7reverseIN9__gnu_cxx17__normal_iteratorIPmSt6vectorImSaImEEEEEvT_S7_.exit, %bb.bg
  ...
  %.not.i.i.i198 = icmp eq ptr %.sroa.22.1.a, null
  br i1 %.not.i.i.i198, label %.critedge147, label %bb.bh

bb.bh:                                            ; preds = %.loopexit272
  %i.kc = ptrtoint ptr %.sroa.0224.1 to i64
  %i.kd = ptrtoint ptr %.sroa.22.1.a to i64
  %i.ke = sub i64 %i.kc, %i.kd
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.22.1.a, i64 noundef %i.ke) #27
  br label %.critedge147
...
_ZNSt6vectorIPN7rocksdb12FileMetaDataESaIS2_EED2Ev.exit197: ; preds = %.loopexit273, %.loopexit.split-lp274, %bb.bf, %bb.be, %.thread260, %bb.s
  %.sroa.22.2.a = phi ptr [ %.sroa.22.1.a, %bb.bf ], [ %.sroa.22.0.lcssa396404, %bb.s ], [ %.sroa.22.1.a, %.thread260 ], [ %.sroa.22.1.a, %bb.be ], [ %.sroa.22.0310, %.loopexit273 ], [ %.sroa.22.0310, %.loopexit.split-lp274 ] ; 3 uses
  %.sroa.0224.2 = phi ptr [ %.sroa.0224.1, %bb.bf ], [ %.sroa.22.0.lcssa396404, %bb.s ], [ %.sroa.0224.1, %.thread260 ], [ %.sroa.0224.1, %bb.be ], [ %.sroa.0224.0312, %.loopexit273 ], [ %.sroa.0224.0312, %.loopexit.split-lp274 ]
  ...
  %.not.i.i.i199 = icmp eq ptr %.sroa.22.2.a, null
...
bb.bi:                                            ; preds = %_ZNSt6vectorIPN7rocksdb12FileMetaDataESaIS2_EED2Ev.exit197
  %i.kf = ptrtoint ptr %.sroa.0224.2 to i64
  %i.kg = ptrtoint ptr %.sroa.22.2.a to i64
  %i.kh = sub i64 %i.kf, %i.kg
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.22.2.a, i64 noundef %i.kh) #27
