...
_ZNSt12__shared_ptrIKN7rocksdb15TablePropertiesELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit28: ; preds = %bb.i, %bb.k, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i26, %bb.o
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #25
  %.not = icmp eq i64 %i.ab, 0
  br i1 %.not, label %.critedge.thread, label %bb.r

.critedge.thread:                                 ; preds = %bb.a, %_ZNSt12__shared_ptrIKN7rocksdb15TablePropertiesELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit28, %.critedge
  %.not22.a = icmp eq ptr %1, null
  br i1 %.not22.a, label %bb.q, label %bb.p
...
bb.p:                                             ; preds = %.critedge.thread
  ...
  br i1 %.not23, label %bb.q, label %bb.r

bb.q:                                             ; preds = %bb.p, %.critedge.thread
  br label %bb.r

bb.r:                                             ; preds = %_ZNSt12__shared_ptrIKN7rocksdb15TablePropertiesELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit28, %bb.p, %bb.q
  %.3 = phi i64 [ 0, %bb.q ], [ %i.at, %bb.p ], [ %i.ab, %_ZNSt12__shared_ptrIKN7rocksdb15TablePropertiesELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit28 ]
  ret i64 %.3
}
...
._crit_edge:                                      ; preds = %_ZN7rocksdb12_GLOBAL__N_117GetTotalFilesSizeERKSt6vectorIPNS_12FileMetaDataESaIS3_EE.exit.thread, %bb.a
  %.072.lcssa = phi i32 [ 0, %bb.a ], [ %i.bp, %_ZN7rocksdb12_GLOBAL__N_117GetTotalFilesSizeERKSt6vectorIPNS_12FileMetaDataESaIS3_EE.exit.thread ] ; 4 uses
  %.071.lcssa = phi i64 [ 0, %bb.a ], [ %i.bo, %_ZN7rocksdb12_GLOBAL__N_117GetTotalFilesSizeERKSt6vectorIPNS_12FileMetaDataESaIS3_EE.exit.thread ]
  %i.i = sext i32 %.072.lcssa to i64
...
_ZNK7rocksdb18VersionStorageInfo12GetBlobStatsEv.exit: ; preds = %.lr.ph.i, %._crit_edge
  ...
  %spec.select219 = add i64 %i.y, %.071.lcssa     ; 7 uses
  %i.z = icmp ne i32 %.072.lcssa, 0               ; 2 uses
  %.not = icmp ugt i64 %spec.select219, %spec.select ; 2 uses
  %or.cond222 = select i1 %i.z, i1 true, i1 %.not
  br i1 %or.cond222, label %bb.c, label %bb.aw
...
bb.b:                                             ; preds = %.lr.ph, %_ZN7rocksdb12_GLOBAL__N_117GetTotalFilesSizeERKSt6vectorIPNS_12FileMetaDataESaIS3_EE.exit.thread
  ...
  %.071233 = phi i64 [ 0, %.lr.ph ], [ %i.bo, %_ZN7rocksdb12_GLOBAL__N_117GetTotalFilesSizeERKSt6vectorIPNS_12FileMetaDataESaIS3_EE.exit.thread ] ; 2 uses
  %.072232 = phi i32 [ 0, %.lr.ph ], [ %i.bp, %_ZN7rocksdb12_GLOBAL__N_117GetTotalFilesSizeERKSt6vectorIPNS_12FileMetaDataESaIS3_EE.exit.thread ] ; 2 uses
...
iter.check:                                       ; preds = %bb.b
  %.val91291 = ptrtoaddr ptr %.val91 to i64
  %.val292 = ptrtoaddr ptr %.val to i64
  %i.ad = add i64 %.val91291, -8
  %i.ae = sub i64 %i.ad, %.val292                 ; 3 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi294 = phi <4 x i64> [ zeroinitializer, %vector.ph ], [ %i.at, %vector.body ]
  %vec.phi295 = phi <4 x i64> [ zeroinitializer, %vector.ph ], [ %i.au, %vector.body ]
  %vec.phi296 = phi <4 x i64> [ zeroinitializer, %vector.ph ], [ %i.av, %vector.body ]
  ...
  %wide.load297 = load <4 x ptr>, ptr %i.al, align 8, !tbaa !108
  %wide.load298 = load <4 x ptr>, ptr %i.am, align 8, !tbaa !108
  %wide.load299 = load <4 x ptr>, ptr %i.an, align 8, !tbaa !108
  %wide.gep = getelementptr inbounds nuw i8, <4 x ptr> %wide.load, i64 24
  %wide.gep300 = getelementptr inbounds nuw i8, <4 x ptr> %wide.load297, i64 24
  %wide.gep301 = getelementptr inbounds nuw i8, <4 x ptr> %wide.load298, i64 24
  %wide.gep302 = getelementptr inbounds nuw i8, <4 x ptr> %wide.load299, i64 24
  ...
  %wide.masked.gather303 = tail call <4 x i64> @llvm.masked.gather.v4i64.v4p0(<4 x ptr> align 8 %wide.gep300, <4 x i1> splat (i1 true), <4 x i64> poison), !tbaa !110
  %wide.masked.gather304 = tail call <4 x i64> @llvm.masked.gather.v4i64.v4p0(<4 x ptr> align 8 %wide.gep301, <4 x i1> splat (i1 true), <4 x i64> poison), !tbaa !110
  %wide.masked.gather305 = tail call <4 x i64> @llvm.masked.gather.v4i64.v4p0(<4 x ptr> align 8 %wide.gep302, <4 x i1> splat (i1 true), <4 x i64> poison), !tbaa !110
  %i.ao = freeze <4 x i64> %wide.masked.gather
  %i.ap = freeze <4 x i64> %wide.masked.gather303
  %i.aq = freeze <4 x i64> %wide.masked.gather304
  %i.ar = freeze <4 x i64> %wide.masked.gather305
  %i.as = add <4 x i64> %i.ao, %vec.phi           ; 2 uses
  %i.at = add <4 x i64> %i.ap, %vec.phi294        ; 2 uses
  %i.au = add <4 x i64> %i.aq, %vec.phi295        ; 2 uses
  %i.av = add <4 x i64> %i.ar, %vec.phi296        ; 2 uses
...
middle.block:                                     ; preds = %vector.body
  ...
  %bin.rdx306 = add <4 x i64> %i.au, %bin.rdx
  %bin.rdx307 = add <4 x i64> %i.av, %bin.rdx306
  %i.ax = tail call i64 @llvm.vector.reduce.add.v4i64(<4 x i64> %bin.rdx307) ; 3 uses
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec308 = and i64 %i.ag, 4611686018427387900  ; 3 uses
  %i.ay = shl i64 %n.vec308, 3
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index309 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next315, %vec.epilog.vector.body ] ; 2 uses
  %vec.phi310 = phi <4 x i64> [ %i.ba, %vec.epilog.ph ], [ %i.bd, %vec.epilog.vector.body ]
  %i.bb = shl i64 %index309, 3
  %next.gep311 = getelementptr i8, ptr %.val, i64 %i.bb
  %wide.load312 = load <4 x ptr>, ptr %next.gep311, align 8, !tbaa !108
  %wide.gep313 = getelementptr inbounds nuw i8, <4 x ptr> %wide.load312, i64 24
  %wide.masked.gather314 = tail call <4 x i64> @llvm.masked.gather.v4i64.v4p0(<4 x ptr> align 8 %wide.gep313, <4 x i1> splat (i1 true), <4 x i64> poison), !tbaa !110
  %i.bc = freeze <4 x i64> %wide.masked.gather314
  %i.bd = add <4 x i64> %i.bc, %vec.phi310        ; 2 uses
  %index.next315 = add nuw i64 %index309, 4       ; 2 uses
  %i.be = icmp eq i64 %index.next315, %n.vec308
...
vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  ...
  %cmp.n316 = icmp eq i64 %i.ag, %n.vec308
  br i1 %cmp.n316, label %_ZN7rocksdb12_GLOBAL__N_117GetTotalFilesSizeERKSt6vectorIPNS_12FileMetaDataESaIS3_EE.exit, label %.lr.ph.i92.preheader
...
.lr.ph.i92:                                       ; preds = %.lr.ph.i92.preheader, %.lr.ph.i92
  ...
  %.fr223 = freeze i64 %i.bi
  %i.bj = add i64 %.fr223, %.05.i                 ; 2 uses
...
_ZN7rocksdb12_GLOBAL__N_117GetTotalFilesSizeERKSt6vectorIPNS_12FileMetaDataESaIS3_EE.exit: ; preds = %.lr.ph.i92, %vec.epilog.middle.block, %middle.block
  %.lcssa288 = phi i64 [ %i.bf, %vec.epilog.middle.block ], [ %i.ax, %middle.block ], [ %i.bj, %.lr.ph.i92 ] ; 2 uses
  %i.bm = add i64 %.lcssa288, %.071233
  %.not90 = icmp eq i64 %.lcssa288, 0
  %i.bn = trunc nuw nsw i64 %indvars.iv to i32
  %spec.select220 = select i1 %.not90, i32 %.072232, i32 %i.bn
...
_ZN7rocksdb12_GLOBAL__N_117GetTotalFilesSizeERKSt6vectorIPNS_12FileMetaDataESaIS3_EE.exit.thread: ; preds = %_ZN7rocksdb12_GLOBAL__N_117GetTotalFilesSizeERKSt6vectorIPNS_12FileMetaDataESaIS3_EE.exit, %bb.b
  %i.bo = phi i64 [ %i.bm, %_ZN7rocksdb12_GLOBAL__N_117GetTotalFilesSizeERKSt6vectorIPNS_12FileMetaDataESaIS3_EE.exit ], [ %.071233, %bb.b ] ; 2 uses
  %i.bp = phi i32 [ %spec.select220, %_ZN7rocksdb12_GLOBAL__N_117GetTotalFilesSizeERKSt6vectorIPNS_12FileMetaDataESaIS3_EE.exit ], [ %.072232, %bb.b ] ; 2 uses
...
_ZNSt6vectorIN7rocksdb20CompactionInputFilesESaIS1_EE12emplace_backIJEEERS1_DpOT_.exit: ; preds = %bb.e
  ...
  store i32 %.072.lcssa, ptr %i.bw, align 8, !tbaa !214
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.ch = udiv i64 %spec.select219, %i.cg
  %i.ci = icmp ugt i64 %i.cg, %spec.select219
...
bb.i:                                             ; preds = %bb.t, %bb.h
  %.0212 = phi i64 [ %spec.select219, %bb.h ], [ %i.cs, %bb.t ]
...
.loopexit226:                                     ; preds = %_ZNKSt6vectorIPN7rocksdb12FileMetaDataESaIS2_EE12_M_check_lenEmPKc.exit.i.i
  %lpad.loopexit228 = landingpad { ptr, i32 }
          cleanup
  br label %bb.av

.loopexit.split-lp227:                            ; preds = %bb.p
...
bb.m:                                             ; preds = %bb.k, %bb.l
  ...
  %i.cs = call i64 @llvm.usub.sat.i64(i64 %.0212, i64 %.sink) ; 2 uses
...
bb.p:                                             ; preds = %bb.o
  invoke void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.58) #24
          to label %.noexc97 unwind label %.loopexit.split-lp227
...
_ZNKSt6vectorIPN7rocksdb12FileMetaDataESaIS2_EE12_M_check_lenEmPKc.exit.i.i: ; preds = %bb.o
  ...
  %i.dl = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.dk) #26
          to label %.noexc98 unwind label %.loopexit226 ; 4 uses
...
bb.x:                                             ; preds = %bb.w
  ...
  %i.el = udiv i64 %spec.select219, %i.ek
  %i.em = icmp ugt i64 %i.ek, %spec.select219
...
bb.y:                                             ; preds = %bb.w, %bb.x
  ...
  br i1 %i.eo, label %.loopexit, label %.lr.ph239

.lr.ph239:                                        ; preds = %bb.y, %select.unfold
  %.0237 = phi i64 [ %.1.ph, %select.unfold ], [ %spec.select219, %bb.y ] ; 2 uses
  %.sroa.0136.0236 = phi ptr [ %i.gi, %select.unfold ], [ %i.ed, %bb.y ] ; 5 uses
  %i.ep = load ptr, ptr %.sroa.0136.0236, align 8, !tbaa !108 ; 3 uses
...
.loopexit224:                                     ; preds = %_ZNKSt6vectorIPN7rocksdb12FileMetaDataESaIS2_EE12_M_check_lenEmPKc.exit.i.i103
...
bb.ab:                                            ; preds = %bb.z, %bb.aa
  %.sink286 = phi i64 [ %i.ev, %bb.aa ], [ %i.en, %bb.z ]
  %i.ew = call i64 @llvm.usub.sat.i64(i64 %.0237, i64 %.sink286) ; 3 uses
...
_ZNKSt6vectorIPN7rocksdb12FileMetaDataESaIS2_EE12_M_check_lenEmPKc.exit.i.i103: ; preds = %bb.ad
  ...
  %i.fp = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.fo) #26
          to label %.noexc110 unwind label %.loopexit224 ; 4 uses
...
.noexc110:                                        ; preds = %_ZNKSt6vectorIPN7rocksdb12FileMetaDataESaIS2_EE12_M_check_lenEmPKc.exit.i.i103
  ...
  %i.fr = load ptr, ptr %.sroa.0136.0236, align 8, !tbaa !108
...
_ZNSt6vectorIPN7rocksdb12FileMetaDataESaIS2_EE9push_backERKS2_.exit111: ; preds = %_ZNSt6vectorIPN7rocksdb12FileMetaDataESaIS2_EE17_M_realloc_insertIJRKS2_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i108, %bb.ac
  ...
  %i.fy = load ptr, ptr %.sroa.0136.0236, align 8, !tbaa !108
...
bb.ah:                                            ; preds = %_ZNSt6vectorIPN7rocksdb12FileMetaDataESaIS2_EE9push_backERKS2_.exit111
  ...
  %i.gd = load ptr, ptr %.sroa.0136.0236, align 8, !tbaa !108
...
select.unfold:                                    ; preds = %bb.ai, %.lr.ph239
  %.1.ph = phi i64 [ %.0237, %.lr.ph239 ], [ %i.ew, %bb.ai ]
  %i.gi = getelementptr inbounds nuw i8, ptr %.sroa.0136.0236, i64 8 ; 2 uses
  %i.gj = icmp eq ptr %i.gi, %i.ec
  br i1 %i.gj, label %.loopexit, label %.lr.ph239
...
_ZNSt6vectorIN7rocksdb20CompactionInputFilesESaIS1_EED2Ev.exit: ; preds = %bb.ao, %_ZSt8_DestroyIPN7rocksdb20CompactionInputFilesES1_EvT_S3_RSaIT0_E.exit.i, %bb.v
  %.074 = phi ptr [ null, %bb.v ], [ %i.gk, %_ZSt8_DestroyIPN7rocksdb20CompactionInputFilesES1_EvT_S3_RSaIT0_E.exit.i ], [ %i.gk, %bb.ao ]
...
bb.av:                                            ; preds = %.loopexit224, %.loopexit.split-lp, %.loopexit226, %.loopexit.split-lp227, %bb.aj, %bb.u, %bb.ap, %_ZNSt6vectorIPN7rocksdb12FileMetaDataESaIS2_EED2Ev.exit121, %bb.j
  %.pn86.pn.pn = phi { ptr, i32 } [ %i.cm, %bb.j ], [ %i.ie, %bb.ap ], [ %lpad.loopexit.split-lp229, %.loopexit.split-lp227 ], [ %i.if, %_ZNSt6vectorIPN7rocksdb12FileMetaDataESaIS2_EED2Ev.exit121 ], [ %i.ea, %bb.u ], [ %i.gh, %bb.aj ], [ %lpad.loopexit228, %.loopexit226 ], [ %lpad.loopexit, %.loopexit224 ], [ %lpad.loopexit.split-lp, %.loopexit.split-lp ]
...
bb.aw:                                            ; preds = %_ZNK7rocksdb18VersionStorageInfo12GetBlobStatsEv.exit, %_ZNSt6vectorIN7rocksdb20CompactionInputFilesESaIS1_EED2Ev.exit134, %bb.d
  %.175 = phi ptr [ null, %bb.d ], [ %.074, %_ZNSt6vectorIN7rocksdb20CompactionInputFilesESaIS1_EED2Ev.exit134 ], [ null, %_ZNK7rocksdb18VersionStorageInfo12GetBlobStatsEv.exit ]
  ret ptr %.175
}
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x ptr>, ptr %next.gep, align 8, !tbaa !108
  %wide.load456 = load <4 x ptr>, ptr %i.ar, align 8, !tbaa !108
  %wide.load457 = load <4 x ptr>, ptr %i.as, align 8, !tbaa !108
  %wide.load458 = load <4 x ptr>, ptr %i.at, align 8, !tbaa !108
  %wide.gep = getelementptr inbounds nuw i8, <4 x ptr> %wide.load, i64 24
  ...
  %wide.masked.gather = tail call <4 x i64> @llvm.masked.gather.v4i64.v4p0(<4 x ptr> align 8 %wide.gep, <4 x i1> splat (i1 true), <4 x i64> poison), !tbaa !110
  %wide.masked.gather462 = tail call <4 x i64> @llvm.masked.gather.v4i64.v4p0(<4 x ptr> align 8 %wide.gep459, <4 x i1> splat (i1 true), <4 x i64> poison), !tbaa !110
  %wide.masked.gather463 = tail call <4 x i64> @llvm.masked.gather.v4i64.v4p0(<4 x ptr> align 8 %wide.gep460, <4 x i1> splat (i1 true), <4 x i64> poison), !tbaa !110
  %wide.masked.gather464 = tail call <4 x i64> @llvm.masked.gather.v4i64.v4p0(<4 x ptr> align 8 %wide.gep461, <4 x i1> splat (i1 true), <4 x i64> poison), !tbaa !110
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load471 = load <4 x ptr>, ptr %next.gep470, align 8, !tbaa !108
  %wide.gep472 = getelementptr inbounds nuw i8, <4 x ptr> %wide.load471, i64 24
  %wide.masked.gather473 = tail call <4 x i64> @llvm.masked.gather.v4i64.v4p0(<4 x ptr> align 8 %wide.gep472, <4 x i1> splat (i1 true), <4 x i64> poison), !tbaa !110
...
._crit_edge:                                      ; preds = %_ZNSt6vectorImSaImEE9push_backERKm.exit
  %i.co = icmp eq ptr %.sroa.0224.3.a, %.sroa.13.2
...
.lr.ph314:                                        ; preds = %bb.j, %_ZNSt6vectorImSaImEE9push_backERKm.exit
  ...
  %.sroa.22.0312 = phi ptr [ %.sroa.22.3, %_ZNSt6vectorImSaImEE9push_backERKm.exit ], [ null, %bb.j ] ; 5 uses
  %.sroa.13.0311 = phi ptr [ %.sroa.13.2, %_ZNSt6vectorImSaImEE9push_backERKm.exit ], [ null, %bb.j ] ; 3 uses
  %.sroa.0224.0310 = phi ptr [ %.sroa.0224.3.a, %_ZNSt6vectorImSaImEE9push_backERKm.exit ], [ null, %bb.j ] ; 7 uses
  %.not.i = icmp eq ptr %.sroa.13.0311, %.sroa.22.0312
...
bb.l:                                             ; preds = %.lr.ph314
  %i.cp = ptrtoint ptr %.sroa.22.0312 to i64
  %i.cq = ptrtoint ptr %.sroa.0224.0310 to i64
...
bb.n:                                             ; preds = %.noexc152
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.cz, ptr align 8 %.sroa.0224.0310, i64 %i.cr, i1 false)
  br label %_ZNSt6vectorImSaImEE11_S_relocateEPmS2_S2_RS0_.exit16.i.i

_ZNSt6vectorImSaImEE11_S_relocateEPmS2_S2_RS0_.exit16.i.i: ; preds = %bb.n, %.noexc152
  %.not.i17.i.i = icmp eq ptr %.sroa.0224.0310, null
...
bb.o:                                             ; preds = %_ZNSt6vectorImSaImEE11_S_relocateEPmS2_S2_RS0_.exit16.i.i
  tail call void @_ZdlPvm(ptr noundef nonnull %.sroa.0224.0310, i64 noundef %i.cr) #27
...
_ZNSt6vectorImSaImEE9push_backERKm.exit:          ; preds = %_ZNSt6vectorImSaImEE17_M_realloc_insertIJRKmEEEvN9__gnu_cxx17__normal_iteratorIPmS1_EEDpOT_.exit.i, %bb.k
  %.sroa.0224.3.a = phi ptr [ %i.cz, %_ZNSt6vectorImSaImEE17_M_realloc_insertIJRKmEEEvN9__gnu_cxx17__normal_iteratorIPmS1_EEDpOT_.exit.i ], [ %.sroa.0224.0310, %bb.k ] ; 6 uses
  ...
  %.sroa.22.3 = phi ptr [ %i.dc, %_ZNSt6vectorImSaImEE17_M_realloc_insertIJRKmEEEvN9__gnu_cxx17__normal_iteratorIPmS1_EEDpOT_.exit.i ], [ %.sroa.22.0312, %bb.k ] ; 4 uses
  %.sroa.13.2 = getelementptr inbounds nuw i8, ptr %.pn270, i64 8 ; 4 uses
...
bb.p:                                             ; preds = %._crit_edge
  %.not.i153 = icmp eq ptr %.sroa.0224.3.a, %.sroa.22.3
...
_ZNKSt6vectorImSaImEE12_M_check_lenEmPKc.exit.i.i154: ; preds = %bb.j, %bb.p
  %.sroa.0224.0.lcssa396403 = phi ptr [ %.sroa.0224.3.a, %bb.p ], [ null, %bb.j ] ; 4 uses
...
_ZNSt6vectorImSaImEE9push_backERKm.exit162:       ; preds = %_ZNSt6vectorImSaImEE11_S_relocateEPmS2_S2_RS0_.exit16.i.i157, %bb.r, %bb.q, %._crit_edge
  %.sroa.0224.1.a = phi ptr [ %.sroa.0224.3.a, %._crit_edge ], [ %.sroa.0224.3.a, %bb.q ], [ %i.dg, %bb.r ], [ %i.dg, %_ZNSt6vectorImSaImEE11_S_relocateEPmS2_S2_RS0_.exit16.i.i157 ] ; 11 uses
  ...
  %i.dj = icmp ne ptr %.sroa.0224.1.a, %.sroa.13.1
  %.sroa.0.010.i.i = getelementptr inbounds i8, ptr %.sroa.13.1, i64 -8 ; 2 uses
  %.not11.i.i = icmp ult ptr %.sroa.0224.1.a, %.sroa.0.010.i.i
...
.lr.ph.i.i:                                       ; preds = %_ZNSt6vectorImSaImEE9push_backERKm.exit162, %.lr.ph.i.i
  ...
  %.sroa.07.012.i.i = phi ptr [ %i.dm, %.lr.ph.i.i ], [ %.sroa.0224.1.a, %_ZNSt6vectorImSaImEE9push_backERKm.exit162 ] ; 3 uses
...
_ZSt7reverseIN9__gnu_cxx17__normal_iteratorIPmSt6vectorImSaImEEEEEvT_S7_.exit: ; preds = %.lr.ph.i.i, %_ZNSt6vectorImSaImEE9push_backERKm.exit162
  %i.dn = icmp eq ptr %.sroa.0224.1.a, %.sroa.13.1
...
.lr.ph327:                                        ; preds = %_ZSt7reverseIN9__gnu_cxx17__normal_iteratorIPmSt6vectorImSaImEEEEEvT_S7_.exit, %.thread266
  %.sroa.0219.0326 = phi ptr [ %i.ka, %.thread266 ], [ %.sroa.0224.1.a, %_ZSt7reverseIN9__gnu_cxx17__normal_iteratorIPmSt6vectorImSaImEEEEEvT_S7_.exit ] ; 2 uses
...
.backedge:                                        ; preds = %bb.bd, %bb.bc, %bb.t, %bb.u
  %.0101.be = phi i64 [ %i.dw, %bb.t ], [ %i.dw, %bb.u ], [ %.099.lcssa, %bb.bc ], [ %.099.lcssa, %bb.bd ] ; 2 uses
...
.loopexit272:                                     ; preds = %.thread266, %_ZSt7reverseIN9__gnu_cxx17__normal_iteratorIPmSt6vectorImSaImEEEEEvT_S7_.exit, %bb.bg
  ...
  %.not.i.i.i198 = icmp eq ptr %.sroa.0224.1.a, null
  br i1 %.not.i.i.i198, label %.critedge147, label %bb.bh

bb.bh:                                            ; preds = %.loopexit272
  %i.kc = ptrtoint ptr %.sroa.22.1 to i64
  %i.kd = ptrtoint ptr %.sroa.0224.1.a to i64
  %i.ke = sub i64 %i.kc, %i.kd
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0224.1.a, i64 noundef %i.ke) #27
  br label %.critedge147
...
_ZNSt6vectorIPN7rocksdb12FileMetaDataESaIS2_EED2Ev.exit197: ; preds = %.loopexit273, %.loopexit.split-lp274, %bb.bf, %bb.be, %.thread260, %bb.s
  %.sroa.0224.2.a = phi ptr [ %.sroa.0224.1.a, %bb.bf ], [ %.sroa.0224.0.lcssa396403, %bb.s ], [ %.sroa.0224.1.a, %.thread260 ], [ %.sroa.0224.1.a, %bb.be ], [ %.sroa.0224.0310, %.loopexit273 ], [ %.sroa.0224.0310, %.loopexit.split-lp274 ] ; 3 uses
  %.sroa.22.2 = phi ptr [ %.sroa.22.1, %bb.bf ], [ %.sroa.0224.0.lcssa396403, %bb.s ], [ %.sroa.22.1, %.thread260 ], [ %.sroa.22.1, %bb.be ], [ %.sroa.22.0312, %.loopexit273 ], [ %.sroa.22.0312, %.loopexit.split-lp274 ]
  ...
  %.not.i.i.i199 = icmp eq ptr %.sroa.0224.2.a, null
...
bb.bi:                                            ; preds = %_ZNSt6vectorIPN7rocksdb12FileMetaDataESaIS2_EED2Ev.exit197
  %i.kf = ptrtoint ptr %.sroa.22.2 to i64
  %i.kg = ptrtoint ptr %.sroa.0224.2.a to i64
  %i.kh = sub i64 %i.kf, %i.kg
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0224.2.a, i64 noundef %i.kh) #27
