...
._crit_edge531:                                   ; preds = %vec.epilog.scalar.ph, %middle.block, %vec.epilog.middle.block, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit379
  %.086.lcssa = phi i64 [ 0, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit379 ], [ %i.wf, %vec.epilog.middle.block ], [ %i.vs, %middle.block ], [ %i.xx, %vec.epilog.scalar.ph ] ; 3 uses
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph
  ...
  %.086526 = phi i64 [ %i.xx, %vec.epilog.scalar.ph ], [ %.086526.ph, %vec.epilog.scalar.ph.preheader ]
  ...
  %i.xv = load i64, ptr %i.xu, align 8, !tbaa !815
  %i.xw = load i64, ptr %i.xt, align 8, !tbaa !814
  %24 = load i64, ptr %i.xr, align 8, !tbaa !818
  %25 = load i64, ptr %i.xq, align 8, !tbaa !817
  %26 = add i64 %i.xs, %25
  %27 = add i64 %i.xw, %.085527
  %i.xx = add i64 %26, %24                        ; 2 uses
  %i.xy = add i64 %27, %i.xv                      ; 2 uses
