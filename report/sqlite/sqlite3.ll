...
bb.c:                                             ; preds = %bb.b
  ...
  %i.r = load i8, ptr %.0105, align 1, !tbaa !733 ; 3 uses
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.e
  ...
  %i.ab = load i8, ptr %.1107249, align 1, !tbaa !733
...
bb.e:                                             ; preds = %.lr.ph
  ...
  br i1 %exitcond.not, label %.critedge, label %.lr.ph, !llvm.loop !5806
...
bb.i:                                             ; preds = %bb.i, %.thread184
  ...
  %i.be = load i32, ptr %i.bd, align 4, !tbaa !570
...
sqlite3FtsUnicodeIsalnum.exit.i:                  ; preds = %bb.j, %bb.h, %bb.g
  ...
  %i.bp = load i32, ptr %i.m, align 4, !tbaa !2597 ; 2 uses
...
.lr.ph.preheader.i.i:                             ; preds = %sqlite3FtsUnicodeIsalnum.exit.i
  %i.br = load ptr, ptr %i.n, align 8, !tbaa !2589
...
.lr.ph.i.i:                                       ; preds = %bb.k, %.lr.ph.preheader.i.i
  ...
  %i.bx = load i32, ptr %i.bw, align 4, !tbaa !570 ; 2 uses
...
bb.k:                                             ; preds = %.lr.ph.i.i
  ...
  br i1 %.not.not.i.i, label %unicodeIsException.exit.loopexit.i, label %.lr.ph.i.i, !llvm.loop !5807
...
unicodeIsAlnum.exit:                              ; preds = %sqlite3FtsUnicodeIsalnum.exit.i, %unicodeIsException.exit.loopexit.i
  ...
  br i1 %.not, label %bb.b, label %bb.l, !llvm.loop !5808

bb.l:                                             ; preds = %unicodeIsAlnum.exit
  %i.cc = getelementptr inbounds nuw i8, ptr %0, i64 32 ; 5 uses
  %i.cd = load ptr, ptr %i.cc, align 8, !tbaa !2596 ; 2 uses
...
.critedge4:                                       ; preds = %.critedge4.backedge, %bb.l
  ...
  %i.ck = load i32, ptr %i.ce, align 8, !tbaa !5815 ; 2 uses
...
bb.m:                                             ; preds = %.critedge4
  %i.cn = tail call i32 @sqlite3_initialize(), !inline_history !1233
...
sqlite3_realloc64.exit:                           ; preds = %bb.m
  ...
  %i.cq = tail call fastcc ptr @sqlite3Realloc(ptr noundef %i.cg, i64 noundef %i.cp), !inline_history !1233 ; 3 uses
  %.not136.not = icmp eq ptr %i.cq, null
  br i1 %.not136.not, label %.thread189, label %bb.n

bb.n:                                             ; preds = %sqlite3_realloc64.exit
  %i.cr = load ptr, ptr %i.cc, align 8, !tbaa !2596
  %i.cs = ptrtoint ptr %i.cr to i64
  %i.ct = sub i64 %i.ch, %i.cs
  %i.cu = getelementptr inbounds i8, ptr %i.cq, i64 %i.ct
  store ptr %i.cq, ptr %i.cc, align 8, !tbaa !2596
  %i.cv = load i32, ptr %i.ce, align 8, !tbaa !5815
  %i.cw = add nsw i32 %i.cv, 64
  store i32 %i.cw, ptr %i.ce, align 8, !tbaa !5815
  br label %bb.o
...
.preheader.i:                                     ; preds = %bb.q, %.preheader.i
  ...
  %i.dg = load i16, ptr %i.df, align 4, !tbaa !5817
  ...
  br i1 %.not.i149, label %bb.r, label %.preheader.i, !llvm.loop !5809
...
bb.s:                                             ; preds = %bb.r
  ...
  %i.du = load i8, ptr %i.dt, align 2, !tbaa !5819
...
bb.t:                                             ; preds = %bb.s
  ...
  %i.ec = getelementptr inbounds nuw [2 x i8], ptr @sqlite3FtsUnicodeFold.aiOff, i64 %i.eb
  %i.ed = load i16, ptr %i.ec, align 2, !tbaa !783
...
bb.w:                                             ; preds = %bb.w, %bb.v
  ...
  %i.ek = getelementptr inbounds [2 x i8], ptr @__const.remove_diacritic.aDia, i64 %i.ej
  %i.el = load i16, ptr %i.ek, align 2, !tbaa !783
  ...
  br i1 %.not.i.i152, label %bb.x, label %bb.w, !llvm.loop !5810
...
bb.y:                                             ; preds = %bb.x
  %i.eq = getelementptr inbounds i8, ptr @__const.remove_diacritic.aChar, i64 %i.ep
...
._crit_edge.i.i:                                  ; preds = %bb.y, %bb.x
  %i.es = getelementptr inbounds [2 x i8], ptr @__const.remove_diacritic.aDia, i64 %i.ep
  %i.et = load i16, ptr %i.es, align 2, !tbaa !783
...
bb.z:                                             ; preds = %._crit_edge.i.i
  %i.ez = getelementptr inbounds i8, ptr @__const.remove_diacritic.aChar, i64 %i.ep
  %i.fa = load i8, ptr %i.ez, align 1, !tbaa !733
...
bb.ag:                                            ; preds = %bb.af
  ...
  %i.ft = load i8, ptr %.4, align 1, !tbaa !733   ; 3 uses
...
bb.ah:                                            ; preds = %bb.ag
  ...
  %i.fz = load i8, ptr %i.fy, align 1, !tbaa !733
...
.lr.ph256:                                        ; preds = %.lr.ph256.preheader, %bb.ai
  ...
  %i.gd = load i8, ptr %.5255, align 1, !tbaa !733
...
bb.ai:                                            ; preds = %.lr.ph256
  ...
  br i1 %exitcond270.not, label %.critedge2, label %.lr.ph256, !llvm.loop !5811
...
bb.ak:                                            ; preds = %bb.aj
  ...
  %i.gu = load i32, ptr %i.gt, align 4, !tbaa !570
...
bb.am:                                            ; preds = %bb.am, %.thread230
  ...
  %i.hg = load i32, ptr %i.hf, align 4, !tbaa !570
...
sqlite3FtsUnicodeIsalnum.exit.i154:               ; preds = %bb.an, %bb.al, %bb.ak
  ...
  %i.hr = load i32, ptr %i.m, align 4, !tbaa !2597 ; 2 uses
...
.lr.ph.preheader.i.i157:                          ; preds = %sqlite3FtsUnicodeIsalnum.exit.i154
  %i.ht = load ptr, ptr %i.n, align 8, !tbaa !2589
...
.lr.ph.i.i158:                                    ; preds = %bb.ao, %.lr.ph.preheader.i.i157
  ...
  %i.hz = load i32, ptr %i.hy, align 4, !tbaa !570 ; 2 uses
...
bb.ao:                                            ; preds = %.lr.ph.i.i158
  ...
  br i1 %.not.not.i.i164, label %unicodeIsException.exit.loopexit.i165, label %.lr.ph.i.i158, !llvm.loop !5807
...
.critedge4.backedge:                              ; preds = %sqlite3FtsUnicodeIsdiacritic.exit, %unicodeIsAlnum.exit175
  %.pre = load ptr, ptr %i.cc, align 8, !tbaa !2596
  br label %.critedge4, !llvm.loop !5812
