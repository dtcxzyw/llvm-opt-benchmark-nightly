...
bb.bo:                                            ; preds = %bb.bn
  ...
  %.neg.i107 = sdiv i32 %i.kl, -4
  %i.km = add nuw nsw i32 %i.kg, 1498
  %i.kn = add i32 %i.km, %i.kk
  %6 = add i32 %i.kn, %.neg.i107                  ; 2 uses
...
bb.dv:                                            ; preds = %.thread77
  ...
  %i.xa = add nsw i32 %i.wz, 48
  %.neg.i70 = sdiv i32 %i.xa, -4
  %i.xb = add nuw nsw i32 %i.wv, 1498
  %i.xc = add i32 %i.xb, %i.wz
  %7 = add i32 %i.xc, %.neg.i70                   ; 2 uses
