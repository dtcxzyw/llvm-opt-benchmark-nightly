...
.thread252.i.i:                                   ; preds = %._crit_edge371.i.i, %bb.z, %bb.t
  ...
  %.0169.val.i.i = load ptr, ptr %i.hx, align 8, !tbaa !527
  %i.hy = getelementptr i8, ptr %.0169337.i.i, i64 48
  %.0169.val231.i.i = load i32, ptr %i.hy, align 8, !tbaa !536
  %i.hz = call fastcc i32 @walWriteOneFrame(ptr noundef %4, ptr %.0169.val.i.i, i32 %.0169.val231.i.i, i32 noundef %i.hw, i64 noundef %.0180333.i.i), !inline_history !1924 ; 2 uses
...
bb.ae:                                            ; preds = %sqlite3_malloc.exit.i.i.i
  ...
  %i.jc = call i32 %i.jb(ptr noundef nonnull %i.iy, ptr noundef nonnull %i.iq, i32 noundef 8, i64 noundef %.038.i.i.i) #58, !inline_history !1942 ; 2 uses
...
walChecksumBytes.exit.i.i.i.i:                    ; preds = %bb.ag
  ...
  %6 = load i8, ptr %i.kw, align 1, !tbaa !1860
  %7 = icmp eq i8 %6, 0                           ; 3 uses
  %8 = zext i1 %7 to i32
  %9 = load i32, ptr %i.ju, align 8, !tbaa !27
  %10 = load i32, ptr %i.kn, align 4, !tbaa !27   ; 2 uses
  %11 = add i32 %10, %9
  ...
  store i32 %.sink30.i.i.i.i, ptr %i.ju, align 8, !tbaa !27
  store i32 %i.lt, ptr %i.kn, align 4, !tbaa !27
  %i.lu = load i32, ptr %i.gm, align 8, !tbaa !1841
  call fastcc void @walChecksumBytes(i32 noundef %8, ptr noundef nonnull readonly %i.ku, i32 noundef %i.lu, ptr noundef nonnull %i.ju, ptr noundef nonnull %i.ju), !inline_history !1943
...
bb.ap:                                            ; preds = %bb.aq, %.lr.ph344.i.i
  ...
  %.0177.val.i.i = load ptr, ptr %i.ny, align 8, !tbaa !527
  %.0177.val230.i.i = load i32, ptr %i.nz, align 8, !tbaa !536
  %i.oa = call fastcc i32 @walWriteOneFrame(ptr noundef %4, ptr %.0177.val.i.i, i32 %.0177.val230.i.i, i32 noundef %2, i64 noundef %.2182343.i.i), !inline_history !1924 ; 2 uses
...
walChecksumBytes.exit.i:                          ; preds = %bb.a
  ...
  %8 = load i8, ptr %7, align 1, !tbaa !1860
  %9 = icmp eq i8 %8, 0                           ; 3 uses
  %10 = zext i1 %9 to i32
  %11 = load i32, ptr %3, align 8, !tbaa !27
  %12 = getelementptr inbounds nuw i8, ptr %i.b, i64 100 ; 3 uses
  %13 = load i32, ptr %12, align 4, !tbaa !27     ; 2 uses
  %14 = add i32 %13, %11
  ...
  store i32 %.sink30.i, ptr %3, align 8, !tbaa !27
  store i32 %i.ab, ptr %12, align 4, !tbaa !27
  ...
  %i.af = load i32, ptr %3, align 8, !tbaa !27    ; 4 uses
  ...
  %i.ar = load i32, ptr %12, align 4, !tbaa !27   ; 4 uses
...
bb.g:                                             ; preds = %bb.f, %walEncodeFrame.exit
  ...
  %i.cj = call i32 %i.ci(ptr noundef nonnull %i.cf, ptr noundef nonnull %.137.i, i32 noundef %.135.i, i64 noundef %.133.i) #58, !inline_history !1965
...
bb.m:                                             ; preds = %bb.l, %bb.h
  ...
  %i.ds = call i32 %i.dr(ptr noundef nonnull %i.do, ptr noundef %.137.i15, i32 noundef %.135.i16, i64 noundef %.133.i17) #58, !inline_history !1965
