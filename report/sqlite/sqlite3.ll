...
.critedge63:                                      ; preds = %bb.d, %sqlite3PagerWrite.exit
  ...
  tail call void @llvm.memset.p0.i64(ptr nonnull align 1 %i.i, i8 0, i64 %i.aj, i1 false)
  br label %.critedge65

bb.j:                                             ; preds = %bb.a
  %i.ak = icmp slt i32 %i.c, %4
  br i1 %i.ak, label %bb.k, label %bb.l

bb.k:                                             ; preds = %bb.j
  %i.al = zext nneg i32 %i.c to i64
  %i.am = getelementptr inbounds nuw i8, ptr %1, i64 %i.al
  %i.an = sub nsw i32 %4, %i.c
  %i.ao = tail call fastcc i32 @btreeOverwriteContent(ptr noundef %0, ptr noundef nonnull %i.am, ptr noundef %2, i32 noundef %i.b, i32 noundef %i.an) ; 2 uses
...
bb.l:                                             ; preds = %bb.k, %bb.j
  ...
  %i.aq = load ptr, ptr %i.ap, align 8, !tbaa !2346 ; 2 uses
  %i.ar = sext i32 %3 to i64                      ; 2 uses
  %i.as = getelementptr inbounds i8, ptr %i.aq, i64 %i.ar
  %i.at = sext i32 %.150 to i64                   ; 2 uses
  %bcmp = tail call i32 @bcmp(ptr %1, ptr %i.as, i64 %i.at)
  %.not60 = icmp eq i32 %bcmp, 0
  br i1 %.not60, label %.critedge65, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.au = getelementptr inbounds nuw i8, ptr %0, i64 112
  %i.av = load ptr, ptr %i.au, align 8, !tbaa !698 ; 6 uses
  %i.aw = getelementptr inbounds nuw i8, ptr %i.av, i64 40
  %i.ax = load ptr, ptr %i.aw, align 8, !tbaa !531 ; 5 uses
  %i.ay = getelementptr inbounds nuw i8, ptr %i.av, i64 52
  %i.az = load i16, ptr %i.ay, align 4, !tbaa !530
  %i.ba = and i16 %i.az, 4
  %.not.i66 = icmp eq i16 %i.ba, 0
  br i1 %.not.i66, label %bb.q, label %bb.n

bb.n:                                             ; preds = %bb.m
  %i.bb = getelementptr inbounds nuw i8, ptr %i.ax, i64 32
  %i.bc = load i32, ptr %i.bb, align 8, !tbaa !684
  %i.bd = getelementptr inbounds nuw i8, ptr %i.av, i64 48
  %i.be = load i32, ptr %i.bd, align 8, !tbaa !536
  %.not13.i67 = icmp ult i32 %i.bc, %i.be
  br i1 %.not13.i67, label %bb.q, label %bb.o

bb.o:                                             ; preds = %bb.n
  %i.bf = getelementptr inbounds nuw i8, ptr %i.ax, i64 128
  %i.bg = load i32, ptr %i.bf, align 8, !tbaa !671
  %.not15.i68 = icmp eq i32 %i.bg, 0
  br i1 %.not15.i68, label %sqlite3PagerWrite.exit71.thread, label %bb.p

bb.p:                                             ; preds = %bb.o
  %i.bh = tail call fastcc i32 @subjournalPageIfRequired(ptr noundef nonnull %i.av), !inline_history !685
  br label %sqlite3PagerWrite.exit71

bb.q:                                             ; preds = %bb.n, %bb.m
  %i.bi = getelementptr inbounds nuw i8, ptr %i.ax, i64 48
  %i.bj = load i32, ptr %i.bi, align 8, !tbaa !686 ; 2 uses
  %.not14.i70 = icmp eq i32 %i.bj, 0
  br i1 %.not14.i70, label %bb.r, label %.critedge65

bb.r:                                             ; preds = %bb.q
  %i.bk = getelementptr inbounds nuw i8, ptr %i.ax, i64 184
  %i.bl = load i32, ptr %i.bk, align 8, !tbaa !687
  %i.bm = getelementptr inbounds nuw i8, ptr %i.ax, i64 200
...
bb.s:                                             ; preds = %bb.r
  %i.bq = tail call fastcc i32 @pagerWriteLargeSector(ptr noundef nonnull %i.av), !inline_history !685
  br label %sqlite3PagerWrite.exit71

bb.t:                                             ; preds = %bb.r
  %i.br = tail call fastcc i32 @pager_write(ptr noundef nonnull %i.av), !inline_history !685
  br label %sqlite3PagerWrite.exit71

sqlite3PagerWrite.exit71:                         ; preds = %bb.p, %bb.s, %bb.t
  %.0.i69 = phi i32 [ %i.bh, %bb.p ], [ %i.br, %bb.t ], [ %i.bq, %bb.s ] ; 2 uses
...
sqlite3PagerWrite.exit71.sqlite3PagerWrite.exit71.thread_crit_edge: ; preds = %sqlite3PagerWrite.exit71
  %.pre = load ptr, ptr %i.ap, align 8, !tbaa !2346
...
sqlite3PagerWrite.exit71.thread:                  ; preds = %sqlite3PagerWrite.exit71.sqlite3PagerWrite.exit71.thread_crit_edge, %bb.o
  %i.bs = phi ptr [ %.pre, %sqlite3PagerWrite.exit71.sqlite3PagerWrite.exit71.thread_crit_edge ], [ %i.aq, %bb.o ]
  %i.bt = getelementptr inbounds i8, ptr %i.bs, i64 %i.ar
  tail call void @llvm.memmove.p0.p0.i64(ptr align 1 %1, ptr align 1 %i.bt, i64 %i.at, i1 false)
  br label %.critedge65
...
.critedge65:                                      ; preds = %bb.b, %.preheader, %bb.q, %sqlite3PagerWrite.exit71, %.critedge63, %bb.f, %bb.l, %sqlite3PagerWrite.exit71.thread, %sqlite3PagerWrite.exit, %bb.k
  %.6 = phi i32 [ %.0.i, %sqlite3PagerWrite.exit ], [ %i.ao, %bb.k ], [ %i.bj, %bb.q ], [ 0, %bb.l ], [ 0, %sqlite3PagerWrite.exit71.thread ], [ %i.z, %bb.f ], [ 0, %.critedge63 ], [ %.0.i69, %sqlite3PagerWrite.exit71 ], [ 0, %.preheader ], [ 0, %bb.b ]
  ret i32 %.6
}
...
bb.p:                                             ; preds = %bb.n
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 1 %i.cf, ptr nonnull align 1 %i.ch, i64 %i.cj, i1 false)
  %i.ck = add nuw nsw i32 %i.ca, %i.bg
  br label %bb.s

bb.q:                                             ; preds = %bb.k
  %i.cl = icmp sgt i32 %i.bp, %i.q
...
bb.s:                                             ; preds = %bb.q, %bb.p
  ...
  %.0 = phi i32 [ %i.ck, %bb.p ], [ %i.bg, %bb.q ] ; 2 uses
  %i.cm = add nuw nsw i32 %.0, %i.bo              ; 3 uses
  %i.cn = zext nneg i32 %i.cm to i64
  %i.co = getelementptr inbounds nuw i8, ptr %i.b, i64 %i.cn
  %i.cp = zext nneg i32 %i.bo to i64
  %i.cq = getelementptr inbounds nuw i8, ptr %i.b, i64 %i.cp
  %i.cr = sub nsw i32 %i.ac, %i.bo
  %i.cs = zext nneg i32 %i.cr to i64
  tail call void @llvm.memmove.p0.p0.i64(ptr align 1 %i.co, ptr align 1 %i.cq, i64 %i.cs, i1 false)
  %i.ct = zext i16 %i.g to i64                    ; 2 uses
  %i.cu = icmp samesign ult i64 %i.ct, %i.ax
  br i1 %i.cu, label %.lr.ph.preheader, label %.loopexit218

.lr.ph.preheader:                                 ; preds = %bb.s
  %i.cv = getelementptr inbounds nuw i8, ptr %i.b, i64 %i.ct
  br label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.u
  %.0166221 = phi ptr [ %i.dj, %bb.u ], [ %i.cv, %.lr.ph.preheader ] ; 4 uses
  %i.cw = load i8, ptr %.0166221, align 1, !tbaa !231
  %i.cx = zext i8 %i.cw to i32
  %i.cy = shl nuw nsw i32 %i.cx, 8
  %i.cz = getelementptr inbounds nuw i8, ptr %.0166221, i64 1 ; 2 uses
  %i.da = load i8, ptr %i.cz, align 1, !tbaa !231
  %i.db = zext i8 %i.da to i32
  %i.dc = or disjoint i32 %i.cy, %i.db            ; 3 uses
  %i.dd = icmp samesign ult i32 %i.dc, %i.ac
  br i1 %i.dd, label %.sink.split, label %bb.t

bb.t:                                             ; preds = %.lr.ph
  %i.de = icmp samesign ult i32 %i.dc, %i.an
  br i1 %i.de, label %.sink.split, label %bb.u

.sink.split:                                      ; preds = %bb.t, %.lr.ph
  %.0.sink = phi i32 [ %.0, %.lr.ph ], [ %.0165, %bb.t ]
  %i.df = add nuw nsw i32 %i.dc, %.0.sink         ; 2 uses
  %i.dg = lshr i32 %i.df, 8
  %i.dh = trunc i32 %i.dg to i8
  store i8 %i.dh, ptr %.0166221, align 1, !tbaa !231
  %i.di = trunc i32 %i.df to i8
  store i8 %i.di, ptr %i.cz, align 1, !tbaa !231
  br label %bb.u

bb.u:                                             ; preds = %.sink.split, %bb.t
  %i.dj = getelementptr inbounds nuw i8, ptr %.0166221, i64 2 ; 2 uses
  %i.dk = icmp ult ptr %i.dj, %i.ay
  br i1 %i.dk, label %.lr.ph, label %.loopexit218, !llvm.loop !2878

.thread200:                                       ; preds = %..thread200_crit_edge, %bb.h, %bb.g, %bb.c
  %.pre-phi = phi i32 [ %.pre, %..thread200_crit_edge ], [ %i.ad, %bb.h ], [ %i.ad, %bb.g ], [ %i.ad, %bb.c ]
  %i.dl = getelementptr inbounds nuw i8, ptr %i.r, i64 5
  %i.dm = load i8, ptr %i.dl, align 1, !tbaa !231
  %i.dn = zext i8 %i.dm to i32
  %i.do = shl nuw nsw i32 %i.dn, 8
  %i.dp = getelementptr inbounds nuw i8, ptr %i.r, i64 6
...
bb.v:                                             ; preds = %.thread200
  %i.dt = load ptr, ptr %i.o, align 8, !tbaa !77
  %i.du = getelementptr i8, ptr %i.dt, i64 280
  %.val = load ptr, ptr %i.du, align 8, !tbaa !1663 ; 2 uses
  %i.dv = sext i32 %i.q to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %.val, ptr nonnull align 1 %i.b, i64 %i.dv, i1 false)
  %i.dw = getelementptr inbounds nuw i8, ptr %0, i64 120
  %i.dx = zext i16 %i.g to i64
  %wide.trip.count = zext i16 %i.j to i64
  %invariant.gep = getelementptr inbounds nuw i8, ptr %i.b, i64 %i.dx
  br label %bb.w

bb.w:                                             ; preds = %bb.v, %bb.aa
  %indvars.iv = phi i64 [ 0, %bb.v ], [ %indvars.iv.next, %bb.aa ] ; 2 uses
  %.4223 = phi i32 [ %i.q, %bb.v ], [ %i.em, %bb.aa ]
  %i.dy = shl nuw nsw i64 %indvars.iv, 1
  %gep = getelementptr inbounds nuw i8, ptr %invariant.gep, i64 %i.dy ; 3 uses
  %i.dz = load i8, ptr %gep, align 1, !tbaa !231
  %i.ea = zext i8 %i.dz to i32
  %i.eb = shl nuw nsw i32 %i.ea, 8
  %i.ec = getelementptr inbounds nuw i8, ptr %gep, i64 1 ; 2 uses
  %i.ed = load i8, ptr %i.ec, align 1, !tbaa !231
  %i.ee = zext i8 %i.ed to i32
  %i.ef = or disjoint i32 %i.eb, %i.ee            ; 3 uses
  %i.eg = icmp sgt i32 %i.ef, %.pre-phi
...
bb.y:                                             ; preds = %bb.w
  %i.eh = load ptr, ptr %i.dw, align 8, !tbaa !1607
  %i.ei = zext nneg i32 %i.ef to i64
  %i.ej = getelementptr inbounds nuw i8, ptr %.val, i64 %i.ei ; 2 uses
  %i.ek = tail call zeroext i16 %i.eh(ptr noundef nonnull %0, ptr noundef %i.ej) #58 ; 2 uses
  %i.el = zext i16 %i.ek to i32                   ; 2 uses
  %i.em = sub nsw i32 %.4223, %i.el               ; 6 uses
  %i.en = icmp slt i32 %i.em, %i.ds
  %i.eo = add nuw nsw i32 %i.ef, %i.el
  %i.ep = icmp sgt i32 %i.eo, %i.q
  %or.cond = select i1 %i.en, i1 true, i1 %i.ep
...
bb.aa:                                            ; preds = %bb.y
  %i.eq = lshr i32 %i.em, 8
  %i.er = trunc i32 %i.eq to i8
  store i8 %i.er, ptr %gep, align 1, !tbaa !231
  %i.es = trunc i32 %i.em to i8
  store i8 %i.es, ptr %i.ec, align 1, !tbaa !231
  %i.et = zext nneg i32 %i.em to i64
  %i.eu = getelementptr inbounds nuw i8, ptr %i.b, i64 %i.et
  %i.ev = zext i16 %i.ek to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %i.eu, ptr align 1 %i.ej, i64 %i.ev, i1 false)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %.loopexit, label %bb.w, !llvm.loop !2879

.loopexit:                                        ; preds = %bb.aa, %.thread200
  %.6 = phi i32 [ %i.q, %.thread200 ], [ %i.em, %bb.aa ]
  store i8 0, ptr %i.s, align 1, !tbaa !231
  br label %.loopexit218

.loopexit218:                                     ; preds = %bb.u, %bb.s, %.loopexit
  %.7 = phi i32 [ %.6, %.loopexit ], [ %i.cm, %bb.s ], [ %i.cm, %bb.u ] ; 3 uses
  %i.ew = load i8, ptr %i.s, align 1, !tbaa !231
  %i.ex = zext i8 %i.ew to i32
  %i.ey = sub i32 %.7, %i.m                       ; 2 uses
  %i.ez = add i32 %i.ey, %i.ex
  %i.fa = getelementptr inbounds nuw i8, ptr %0, i64 20
  %i.fb = load i32, ptr %i.fa, align 4, !tbaa !1603
  %.not195 = icmp eq i32 %i.ez, %i.fb
...
bb.ac:                                            ; preds = %.loopexit218
  ...
  %i.fe = getelementptr inbounds nuw i8, ptr %i.r, i64 5
  store i8 %i.fd, ptr %i.fe, align 1, !tbaa !231
  %i.ff = trunc i32 %.7 to i8
  %i.fg = getelementptr inbounds nuw i8, ptr %i.r, i64 6
  store i8 %i.ff, ptr %i.fg, align 1, !tbaa !231
  %i.fh = getelementptr inbounds nuw i8, ptr %i.r, i64 1
  store i8 0, ptr %i.fh, align 1, !tbaa !231
  %i.fi = getelementptr inbounds nuw i8, ptr %i.r, i64 2
  store i8 0, ptr %i.fi, align 1, !tbaa !231
  %i.fj = zext nneg i32 %i.m to i64
  %i.fk = getelementptr inbounds nuw i8, ptr %i.b, i64 %i.fj
  %i.fl = sext i32 %i.ey to i64
  tail call void @llvm.memset.p0.i64(ptr align 1 %i.fk, i8 0, i64 %i.fl, i1 false)
  br label %.thread204
...
bb.c:                                             ; preds = %.lr.ph, %bb.g
  %.036 = phi i32 [ 0, %.lr.ph ], [ %i.y, %bb.g ] ; 2 uses
  %.02835 = phi ptr [ %i.g, %.lr.ph ], [ %i.z, %bb.g ] ; 4 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  store i32 %i.v, ptr %i.x, align 4, !tbaa !27
  br label %bb.g

bb.g:                                             ; preds = %bb.d, %bb.c, %bb.f
  %i.y = add nuw nsw i32 %.036, 1                 ; 2 uses
  %i.z = getelementptr inbounds nuw i8, ptr %.02835, i64 12
  %exitcond.not = icmp eq i32 %i.y, %i.i
...
end_hunk_13
begin_hunk_14_@wherePathSolver:bb.a
...
bb.ap:                                            ; preds = %bb.an
  ...
  %i.fu = getelementptr inbounds nuw i8, ptr @sqlite3LogEstAdd.x, i64 %i.ft
...
bb.at:                                            ; preds = %bb.ar
  ...
  %i.gf = getelementptr inbounds nuw i8, ptr @sqlite3LogEstAdd.x, i64 %i.ge
...
bb.ax:                                            ; preds = %bb.av
  ...
  %i.gt = getelementptr inbounds nuw i8, ptr @sqlite3LogEstAdd.x, i64 %i.gs
...
bb.bb:                                            ; preds = %bb.az
  ...
  %i.he = getelementptr inbounds nuw i8, ptr @sqlite3LogEstAdd.x, i64 %i.hd
...
bb.bs:                                            ; preds = %bb.bq
  ...
  %i.ld = getelementptr inbounds nuw i8, ptr @sqlite3LogEstAdd.x, i64 %i.lc
...
bb.bw:                                            ; preds = %bb.bu
  ...
  %i.lo = getelementptr inbounds nuw i8, ptr @sqlite3LogEstAdd.x, i64 %i.ln
...
end_hunk_14
begin_hunk_15_@constructAutomaticIndex:bb.a
...
end_hunk_15
begin_hunk_16_@sqlite3ConstructBloomFilter:bb.a
...
end_hunk_16
begin_hunk_17_@sqlite3WhereCodeOneLoopStart:bb.a
...
end_hunk_18
begin_hunk_19_@porterDestroy:bb.a
; Function Attrs: nounwind uwtable
...
bb.b:                                             ; preds = %sqlite3_malloc.exit
  %i.d = getelementptr inbounds nuw i8, ptr %i.b, i64 8
  store ptr %1, ptr %i.d, align 8, !tbaa !5498
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !5503 ; 4 uses
  %i.c = icmp eq ptr %i.b, null
...
bb.a:
  ...
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !5498 ; 5 uses
  ...
  %i.l = load i32, ptr %i.f, align 4, !tbaa !5501 ; 2 uses
  %i.m = load i32, ptr %i.g, align 8, !tbaa !5500 ; 2 uses
  %i.n = icmp slt i32 %i.l, %i.m
  br i1 %i.n, label %.lr.ph.preheader, label %.thread450

.lr.ph.preheader:                                 ; preds = %bb.a, %.backedge
  %i.o = phi i32 [ %i.aty, %.backedge ], [ %i.m, %bb.a ] ; 4 uses
  %i.p = phi i32 [ %i.atx, %.backedge ], [ %i.l, %bb.a ] ; 3 uses
  ...
  br i1 %i.t, label %.lr.ph951, label %.critedge

.lr.ph:                                           ; preds = %.critedge3
  %i.u = getelementptr inbounds i8, ptr %i.d, i64 %indvars.iv.next
  %i.v = load i8, ptr %i.u, align 1, !tbaa !231   ; 2 uses
  %i.w = icmp sgt i8 %i.v, -1
  br i1 %i.w, label %.lr.ph951, label %.critedge, !llvm.loop !5505

.lr.ph951:                                        ; preds = %.lr.ph.preheader, %.lr.ph
  %i.x = phi i8 [ %i.v, %.lr.ph ], [ %i.s, %.lr.ph.preheader ] ; 2 uses
  %indvars.iv950 = phi i64 [ %indvars.iv.next, %.lr.ph ], [ %i.q, %.lr.ph.preheader ] ; 2 uses
  %.promoted559703949 = phi i32 [ %i.ad, %.lr.ph ], [ %i.p, %.lr.ph.preheader ]
...
.critedge3:                                       ; preds = %.lr.ph951, %bb.b
  %indvars.iv.next = add nsw i64 %indvars.iv950, 1 ; 4 uses
  %i.ad = trunc i64 %indvars.iv.next to i32       ; 4 uses
  store i32 %i.ad, ptr %i.f, align 4, !tbaa !5501
  %exitcond.not = icmp eq i32 %i.o, %i.ad
  br i1 %exitcond.not, label %.backedge, label %.lr.ph, !llvm.loop !5505

.critedge:                                        ; preds = %.lr.ph, %bb.b, %.lr.ph.preheader
  %.promoted559703.lcssa = phi i32 [ %i.p, %.lr.ph.preheader ], [ %i.ad, %.lr.ph ], [ %.promoted559703949, %bb.b ] ; 3 uses
  %indvars.iv.lcssa = phi i64 [ %i.q, %.lr.ph.preheader ], [ %indvars.iv.next, %.lr.ph ], [ %indvars.iv950, %bb.b ] ; 4 uses
  %i.ae = trunc nsw i64 %indvars.iv.lcssa to i32  ; 11 uses
  %i.af = icmp slt i32 %.promoted559703.lcssa, %i.o
  br i1 %i.af, label %.lr.ph560.preheader, label %.critedge5

.lr.ph560.preheader:                              ; preds = %.critedge
  %i.ag = sext i32 %.promoted559703.lcssa to i64
  br label %.lr.ph560
...
.critedge68:                                      ; preds = %.lr.ph560, %bb.d
  ...
  store i32 %i.ap, ptr %i.f, align 4, !tbaa !5501
  %exitcond658.not = icmp eq i32 %i.o, %i.ap
  br i1 %exitcond658.not, label %.critedge5, label %.lr.ph560, !llvm.loop !5506
...
.critedge5:                                       ; preds = %.critedge68, %.critedge5.loopexit.split.loop.exit, %.critedge5.loopexit.split.loop.exit888, %.critedge
  %.lcssa497 = phi i32 [ %.promoted559703.lcssa, %.critedge ], [ %i.aq, %.critedge5.loopexit.split.loop.exit ], [ %i.ar, %.critedge5.loopexit.split.loop.exit888 ], [ %i.o, %.critedge68 ] ; 10 uses
  %.not66 = icmp sgt i32 %.lcssa497, %i.ae
  br i1 %.not66, label %bb.e, label %.backedge

bb.e:                                             ; preds = %.critedge5
  %i.as = sub nsw i32 %.lcssa497, %i.ae           ; 18 uses
  %i.at = load i32, ptr %i.h, align 8, !tbaa !5504
  %i.au = icmp sgt i32 %i.as, %i.at
  %.pre = load ptr, ptr %i.i, align 8, !tbaa !5503 ; 2 uses
  br i1 %i.au, label %bb.f, label %bb.h

bb.f:                                             ; preds = %bb.e
  %i.av = add nsw i32 %i.as, 20                   ; 2 uses
  store i32 %i.av, ptr %i.h, align 8, !tbaa !5504
...
bb.g:                                             ; preds = %sqlite3_realloc64.exit
  store ptr %i.ay, ptr %i.i, align 8, !tbaa !5503
  br label %bb.h
...
bb.h:                                             ; preds = %bb.g, %bb.e
  ...
  %wide.trip.count.i.i = zext i32 %i.as to i64    ; 11 uses
...
.lr.ph.i.i.preheader:                             ; preds = %bb.h
  ...
  br i1 %min.iters.check984, label %.lr.ph.i.i.preheader1043, label %vector.memcheck981

vector.memcheck981:                               ; preds = %.lr.ph.i.i.preheader
  %i.bd = add i64 %indvars.iv.lcssa, %i.e
  %i.be = sub i64 %i.bd, %i.ba
  %diff.check982 = icmp ugt i64 %i.be, -8
  br i1 %diff.check982, label %.lr.ph.i.i.preheader1043, label %vector.ph985

vector.ph985:                                     ; preds = %vector.memcheck981
  %n.vec986 = and i64 %wide.trip.count.i.i, 4294967288 ; 3 uses
  br label %vector.body987

vector.body987:                                   ; preds = %vector.body987, %vector.ph985
  %index988 = phi i64 [ 0, %vector.ph985 ], [ %index.next993, %vector.body987 ] ; 3 uses
  %vec.phi989 = phi <4 x i1> [ zeroinitializer, %vector.ph985 ], [ %i.bt, %vector.body987 ]
  %vec.phi990 = phi <4 x i1> [ zeroinitializer, %vector.ph985 ], [ %i.bu, %vector.body987 ]
  %i.bf = getelementptr inbounds nuw i8, ptr %i.bb, i64 %index988 ; 2 uses
  %i.bg = getelementptr inbounds nuw i8, ptr %i.bf, i64 4
  %wide.load991 = load <4 x i8>, ptr %i.bf, align 1, !tbaa !231 ; 4 uses
  %wide.load992 = load <4 x i8>, ptr %i.bg, align 1, !tbaa !231 ; 4 uses
  %i.bh = add <4 x i8> %wide.load991, splat (i8 -65)
  %i.bi = add <4 x i8> %wide.load992, splat (i8 -65)
  %i.bj = icmp ult <4 x i8> %i.bh, splat (i8 26)
  %i.bk = icmp ult <4 x i8> %i.bi, splat (i8 26)
  %i.bl = or disjoint <4 x i8> %wide.load991, splat (i8 32)
  %i.bm = or disjoint <4 x i8> %wide.load992, splat (i8 32)
  %i.bn = select <4 x i1> %i.bj, <4 x i8> %i.bl, <4 x i8> %wide.load991
  %i.bo = select <4 x i1> %i.bk, <4 x i8> %i.bm, <4 x i8> %wide.load992
  %i.bp = add <4 x i8> %wide.load991, splat (i8 -48)
  %i.bq = icmp ult <4 x i8> %i.bp, splat (i8 10)
  %i.br = add <4 x i8> %wide.load992, splat (i8 -48)
  %i.bs = icmp ult <4 x i8> %i.br, splat (i8 10)
  %i.bt = or <4 x i1> %vec.phi989, %i.bq          ; 2 uses
  %i.bu = or <4 x i1> %vec.phi990, %i.bs          ; 2 uses
  %i.bv = getelementptr inbounds nuw i8, ptr %i.az, i64 %index988 ; 2 uses
  ...
  %index.next993 = add nuw i64 %index988, 8       ; 2 uses
  %i.bx = icmp eq i64 %index.next993, %n.vec986
  br i1 %i.bx, label %middle.block994, label %vector.body987, !llvm.loop !5507

middle.block994:                                  ; preds = %vector.body987
  %bin.rdx995 = or <4 x i1> %i.bu, %i.bt
  %bin.rdx995.fr = freeze <4 x i1> %bin.rdx995
  %i.by = bitcast <4 x i1> %bin.rdx995.fr to i4
  %.not1036 = icmp ne i4 %i.by, 0
  %rdx.select996 = zext i1 %.not1036 to i32       ; 2 uses
  %cmp.n997 = icmp eq i64 %n.vec986, %wide.trip.count.i.i
  br i1 %cmp.n997, label %._crit_edge.loopexit.i.i, label %.lr.ph.i.i.preheader1043

.lr.ph.i.i.preheader1043:                         ; preds = %vector.memcheck981, %.lr.ph.i.i.preheader, %middle.block994
  %indvars.iv.i.i.ph = phi i64 [ 0, %vector.memcheck981 ], [ 0, %.lr.ph.i.i.preheader ], [ %n.vec986, %middle.block994 ] ; 5 uses
  %.045.i.i.ph = phi i32 [ 0, %vector.memcheck981 ], [ 0, %.lr.ph.i.i.preheader ], [ %rdx.select996, %middle.block994 ] ; 2 uses
  %xtraiter1106 = and i64 %wide.trip.count.i.i, 1
  %lcmp.mod1107.not = icmp eq i64 %xtraiter1106, 0
  br i1 %lcmp.mod1107.not, label %.lr.ph.i.i.prol.loopexit, label %.lr.ph.i.i.prol

.lr.ph.i.i.prol:                                  ; preds = %.lr.ph.i.i.preheader1043
...
.lr.ph.i.i.prol.loopexit:                         ; preds = %.lr.ph.i.i.prol, %.lr.ph.i.i.preheader1043
  %.2.i.i.lcssa1044.unr = phi i32 [ poison, %.lr.ph.i.i.preheader1043 ], [ %.2.i.i.prol, %.lr.ph.i.i.prol ]
  %indvars.iv.i.i.unr = phi i64 [ %indvars.iv.i.i.ph, %.lr.ph.i.i.preheader1043 ], [ %indvars.iv.next.i.i.prol, %.lr.ph.i.i.prol ]
  %.045.i.i.unr = phi i32 [ %.045.i.i.ph, %.lr.ph.i.i.preheader1043 ], [ %.2.i.i.prol, %.lr.ph.i.i.prol ]
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i
  ...
  br i1 %exitcond.not.i.i.1, label %._crit_edge.loopexit.i.i, label %.lr.ph.i.i, !llvm.loop !5508

._crit_edge.loopexit.i.i:                         ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i, %middle.block994
  %.2.i.i.lcssa = phi i32 [ %rdx.select996, %middle.block994 ], [ %.2.i.i.lcssa1044.unr, %.lr.ph.i.i.prol.loopexit ], [ %.2.i.i.1, %.lr.ph.i.i ]
  %i.cx = icmp eq i32 %.2.i.i.lcssa, 0            ; 2 uses
  %.neg1037 = select i1 %i.cx, i32 -10, i32 -3
  %i.cy = select i1 %i.cx, i32 10, i32 3          ; 6 uses
  %i.cz = shl nuw nsw i32 %i.cy, 1
  %i.da = icmp sgt i32 %i.as, %i.cz
  br i1 %i.da, label %iter.check1021, label %.loopexit.sink.split.i

iter.check1021:                                   ; preds = %._crit_edge.loopexit.i.i
  %i.db = sub i32 %i.as, %i.cy                    ; 8 uses
  %i.dc = zext nneg i32 %i.cy to i64              ; 7 uses
  %i.dd = add nsw i32 %i.cy, -1
  %i.de = add i32 %.lcssa497, 1
  %i.df = add i32 %i.cy, %i.ae
  %i.dg = sub i32 %i.de, %i.df
  %smax1004 = tail call i32 @llvm.smax.i32(i32 %i.dg, i32 %i.as)
  %i.dh = add i32 %i.dd, %smax1004
  %i.di = add i32 %i.dh, %i.ae
  %i.dj = sub i32 %i.di, %.lcssa497               ; 3 uses
  %i.dk = zext i32 %i.dj to i64
  %i.dl = add nuw nsw i64 %i.dk, 1                ; 5 uses
  %min.iters.check1006 = icmp ult i32 %i.dj, 7
  br i1 %min.iters.check1006, label %.lr.ph50.i.i.preheader, label %vector.scevcheck1000

vector.scevcheck1000:                             ; preds = %iter.check1021
  %i.dm = add i32 %.lcssa497, 1
  %i.dn = add i32 %i.cy, %i.ae
  %i.do = sub i32 %i.dm, %i.dn
  %smax1001 = tail call i32 @llvm.smax.i32(i32 %i.do, i32 %i.as)
  %i.dp = add i32 %smax1001, %i.ae
  %i.dq = sub i32 %.neg1037, %i.dp
  %i.dr = add i32 %i.dq, %.lcssa497
  %i.ds = icmp ult i32 %i.dr, %i.db
  %i.dt = zext i32 %i.db to i64
  %i.du = sub nsw i64 %i.dt, %i.dc
  %diff.check1003 = icmp ugt i64 %i.du, -32
  %or.cond1039 = select i1 %i.ds, i1 true, i1 %diff.check1003
  br i1 %or.cond1039, label %.lr.ph50.i.i.preheader, label %vector.main.loop.iter.check1007

vector.main.loop.iter.check1007:                  ; preds = %vector.scevcheck1000
  %min.iters.check1008 = icmp ult i32 %i.dj, 31
  br i1 %min.iters.check1008, label %vec.epilog.ph1025, label %vector.ph1009

vector.ph1009:                                    ; preds = %vector.main.loop.iter.check1007
  %i.dv = and i64 %i.dl, 24
  %n.vec1010 = and i64 %i.dl, 8589934560          ; 5 uses
  %i.dw = or disjoint i64 %n.vec1010, %i.dc       ; 2 uses
  %i.dx = trunc i64 %n.vec1010 to i32
  %i.dy = add i32 %i.db, %i.dx
  %invariant.gep1146 = getelementptr i8, ptr %i.az, i64 %i.dc
  br label %vector.body1011

vector.body1011:                                  ; preds = %vector.body1011, %vector.ph1009
end_hunk_19
begin_hunk_20_@porterNext:bb.a
  %wide.load1013.a = load <16 x i8>, ptr %i.ec, align 1, !tbaa !231
  %wide.load1014 = load <16 x i8>, ptr %i.ed, align 1, !tbaa !231
  %gep1147 = getelementptr i8, ptr %invariant.gep1146, i64 %index1012 ; 2 uses
  %i.ee = getelementptr inbounds nuw i8, ptr %gep1147, i64 16
  store <16 x i8> %wide.load1013.a, ptr %gep1147, align 1, !tbaa !231
  store <16 x i8> %wide.load1014, ptr %i.ee, align 1, !tbaa !231
  %index.next1015 = add nuw i64 %index1012, 32    ; 2 uses
  %i.ef = icmp eq i64 %index.next1015, %n.vec1010
  br i1 %i.ef, label %middle.block1016, label %vector.body1011, !llvm.loop !5509

middle.block1016:                                 ; preds = %vector.body1011
  %cmp.n1017 = icmp eq i64 %i.dl, %n.vec1010
  br i1 %cmp.n1017, label %.loopexit.loopexit.i.i, label %vec.epilog.iter.check1023

vec.epilog.iter.check1023:                        ; preds = %middle.block1016
  %min.epilog.iters.check1024 = icmp eq i64 %i.dv, 0
  br i1 %min.epilog.iters.check1024, label %.lr.ph50.i.i.preheader, label %vec.epilog.ph1025, !prof !2739

vec.epilog.ph1025:                                ; preds = %vector.main.loop.iter.check1007, %vec.epilog.iter.check1023
  %vec.epilog.resume.val1018 = phi i64 [ %n.vec1010, %vec.epilog.iter.check1023 ], [ 0, %vector.main.loop.iter.check1007 ]
  %n.vec1026 = and i64 %i.dl, 8589934584          ; 4 uses
  %i.eg = add nuw nsw i64 %n.vec1026, %i.dc       ; 2 uses
  %i.eh = trunc i64 %n.vec1026 to i32
  %i.ei = add i32 %i.db, %i.eh
  %invariant.gep1148 = getelementptr i8, ptr %i.az, i64 %i.dc
  br label %vec.epilog.vector.body1027

vec.epilog.vector.body1027:                       ; preds = %vec.epilog.vector.body1027, %vec.epilog.ph1025
  %index1028 = phi i64 [ %vec.epilog.resume.val1018, %vec.epilog.ph1025 ], [ %index.next1030, %vec.epilog.vector.body1027 ] ; 3 uses
  %i.ej = trunc i64 %index1028 to i32
  %i.ek = add i32 %i.db, %i.ej
  %i.el = zext nneg i32 %i.ek to i64
  %i.em = getelementptr inbounds nuw i8, ptr %i.az, i64 %i.el
  %wide.load1029 = load <8 x i8>, ptr %i.em, align 1, !tbaa !231
  %gep1149 = getelementptr i8, ptr %invariant.gep1148, i64 %index1028
  store <8 x i8> %wide.load1029, ptr %gep1149, align 1, !tbaa !231
  %index.next1030 = add nuw i64 %index1028, 8     ; 2 uses
  %i.en = icmp eq i64 %index.next1030, %n.vec1026
  br i1 %i.en, label %vec.epilog.middle.block1031, label %vec.epilog.vector.body1027, !llvm.loop !5510

vec.epilog.middle.block1031:                      ; preds = %vec.epilog.vector.body1027
  %cmp.n1032 = icmp eq i64 %i.dl, %n.vec1026
  br i1 %cmp.n1032, label %.loopexit.loopexit.i.i, label %.lr.ph50.i.i.preheader

.lr.ph50.i.i.preheader:                           ; preds = %vector.scevcheck1000, %iter.check1021, %vec.epilog.iter.check1023, %vec.epilog.middle.block1031
  %indvars.iv54.i.i.ph = phi i64 [ %i.dc, %vector.scevcheck1000 ], [ %i.dc, %iter.check1021 ], [ %i.dw, %vec.epilog.iter.check1023 ], [ %i.eg, %vec.epilog.middle.block1031 ]
  %.14047.i.i.ph = phi i32 [ %i.db, %vector.scevcheck1000 ], [ %i.db, %iter.check1021 ], [ %i.dy, %vec.epilog.iter.check1023 ], [ %i.ei, %vec.epilog.middle.block1031 ]
  br label %.lr.ph50.i.i

.lr.ph50.i.i:                                     ; preds = %.lr.ph50.i.i.preheader, %.lr.ph50.i.i
  %indvars.iv54.i.i = phi i64 [ %indvars.iv.next55.i.i, %.lr.ph50.i.i ], [ %indvars.iv54.i.i.ph, %.lr.ph50.i.i.preheader ] ; 2 uses
  %.14047.i.i = phi i32 [ %i.es, %.lr.ph50.i.i ], [ %.14047.i.i.ph, %.lr.ph50.i.i.preheader ] ; 2 uses
  %i.eo = zext nneg i32 %.14047.i.i to i64
  %i.ep = getelementptr inbounds nuw i8, ptr %i.az, i64 %i.eo
  %i.eq = load i8, ptr %i.ep, align 1, !tbaa !231
  %i.er = getelementptr inbounds nuw i8, ptr %i.az, i64 %indvars.iv54.i.i
  store i8 %i.eq, ptr %i.er, align 1, !tbaa !231
  %i.es = add nsw i32 %.14047.i.i, 1              ; 2 uses
  %indvars.iv.next55.i.i = add nuw nsw i64 %indvars.iv54.i.i, 1 ; 2 uses
  %i.et = icmp slt i32 %i.es, %i.as
  br i1 %i.et, label %.lr.ph50.i.i, label %.loopexit.loopexit.i.i, !llvm.loop !5511

.loopexit.loopexit.i.i:                           ; preds = %.lr.ph50.i.i, %vec.epilog.middle.block1031, %middle.block1016
  %indvars.iv.next55.i.i.lcssa = phi i64 [ %i.eg, %vec.epilog.middle.block1031 ], [ %i.dw, %middle.block1016 ], [ %indvars.iv.next55.i.i, %.lr.ph50.i.i ]
  %i.eu = trunc nuw i64 %indvars.iv.next55.i.i.lcssa to i32
  br label %.loopexit.sink.split.i

.lr.ph.i:                                         ; preds = %bb.h, %bb.k
  %indvars.iv785.i = phi i64 [ %indvars.iv.next786.i, %bb.k ], [ 0, %bb.h ] ; 2 uses
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %bb.k ], [ 22, %bb.h ] ; 3 uses
  %i.ev = getelementptr inbounds nuw i8, ptr %i.bb, i64 %indvars.iv785.i
  %i.ew = load i8, ptr %i.ev, align 1, !tbaa !231 ; 4 uses
  %i.ex = add i8 %i.ew, -65
  %or.cond4.i = icmp ult i8 %i.ex, 26
  br i1 %or.cond4.i, label %bb.i, label %bb.j

bb.i:                                             ; preds = %.lr.ph.i
  %i.ey = or disjoint i8 %i.ew, 32
  br label %bb.k

bb.j:                                             ; preds = %.lr.ph.i
  %i.ez = add i8 %i.ew, -97
  %or.cond7.i = icmp ult i8 %i.ez, 26
  br i1 %or.cond7.i, label %bb.k, label %.lr.ph.i110.i.preheader

.lr.ph.i110.i.preheader:                          ; preds = %bb.j
  %min.iters.check = icmp ult i32 %i.as, 8
  br i1 %min.iters.check, label %.lr.ph.i110.i.preheader1098, label %vector.memcheck

vector.memcheck:                                  ; preds = %.lr.ph.i110.i.preheader
  %i.fa = add i64 %indvars.iv.lcssa, %i.e
  %i.fb = sub i64 %i.fa, %i.ba
  %diff.check = icmp ugt i64 %i.fb, -8
  br i1 %diff.check, label %.lr.ph.i110.i.preheader1098, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi = phi <4 x i1> [ zeroinitializer, %vector.ph ], [ %i.fq, %vector.body ]
  %vec.phi955 = phi <4 x i1> [ zeroinitializer, %vector.ph ], [ %i.fr, %vector.body ]
  %i.fc = getelementptr inbounds nuw i8, ptr %i.bb, i64 %index ; 2 uses
  %i.fd = getelementptr inbounds nuw i8, ptr %i.fc, i64 4
  %wide.load = load <4 x i8>, ptr %i.fc, align 1, !tbaa !231 ; 4 uses
  %wide.load956 = load <4 x i8>, ptr %i.fd, align 1, !tbaa !231 ; 4 uses
  %i.fe = add <4 x i8> %wide.load, splat (i8 -65)
  %i.ff = add <4 x i8> %wide.load956, splat (i8 -65)
  %i.fg = icmp ult <4 x i8> %i.fe, splat (i8 26)
  %i.fh = icmp ult <4 x i8> %i.ff, splat (i8 26)
  %i.fi = or disjoint <4 x i8> %wide.load, splat (i8 32)
  %i.fj = or disjoint <4 x i8> %wide.load956, splat (i8 32)
  %i.fk = select <4 x i1> %i.fg, <4 x i8> %i.fi, <4 x i8> %wide.load
  %i.fl = select <4 x i1> %i.fh, <4 x i8> %i.fj, <4 x i8> %wide.load956
  %i.fm = add <4 x i8> %wide.load, splat (i8 -48)
  %i.fn = icmp ult <4 x i8> %i.fm, splat (i8 10)
  %i.fo = add <4 x i8> %wide.load956, splat (i8 -48)
  %i.fp = icmp ult <4 x i8> %i.fo, splat (i8 10)
  %i.fq = or <4 x i1> %vec.phi, %i.fn             ; 2 uses
  %i.fr = or <4 x i1> %vec.phi955, %i.fp          ; 2 uses
  %i.fs = getelementptr inbounds nuw i8, ptr %i.az, i64 %index ; 2 uses
  %i.ft = getelementptr inbounds nuw i8, ptr %i.fs, i64 4
  store <4 x i8> %i.fk, ptr %i.fs, align 1, !tbaa !231
  store <4 x i8> %i.fl, ptr %i.ft, align 1, !tbaa !231
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.fu = icmp eq i64 %index.next, %n.vec
  br i1 %i.fu, label %middle.block, label %vector.body, !llvm.loop !5512

middle.block:                                     ; preds = %vector.body
  %bin.rdx = or <4 x i1> %i.fr, %i.fq
  %bin.rdx.fr = freeze <4 x i1> %bin.rdx
  %i.fv = bitcast <4 x i1> %bin.rdx.fr to i4
  %.not1035 = icmp ne i4 %i.fv, 0
  %rdx.select = zext i1 %.not1035 to i32          ; 2 uses
  %cmp.n = icmp eq i64 %n.vec, %wide.trip.count.i.i
  br i1 %cmp.n, label %._crit_edge.loopexit.i118.i, label %.lr.ph.i110.i.preheader1098

.lr.ph.i110.i.preheader1098:                      ; preds = %vector.memcheck, %.lr.ph.i110.i.preheader, %middle.block
  %indvars.iv.i111.i.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %.lr.ph.i110.i.preheader ], [ %n.vec, %middle.block ] ; 5 uses
  %.045.i112.i.ph = phi i32 [ 0, %vector.memcheck ], [ 0, %.lr.ph.i110.i.preheader ], [ %rdx.select, %middle.block ] ; 2 uses
  %xtraiter = and i64 %wide.trip.count.i.i, 1
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %.lr.ph.i110.i.prol.loopexit, label %.lr.ph.i110.i.prol

.lr.ph.i110.i.prol:                               ; preds = %.lr.ph.i110.i.preheader1098
  %i.fw = getelementptr inbounds nuw i8, ptr %i.bb, i64 %indvars.iv.i111.i.ph
  %i.fx = load i8, ptr %i.fw, align 1, !tbaa !231 ; 4 uses
  %i.fy = add i8 %i.fx, -65
  %or.cond.i113.i.prol = icmp ult i8 %i.fy, 26
  %i.fz = or disjoint i8 %i.fx, 32
  %.sink.i114.i.prol = select i1 %or.cond.i113.i.prol, i8 %i.fz, i8 %i.fx
  %i.ga = add i8 %i.fx, -58
  %i.gb = icmp ult i8 %i.ga, -10
  %.2.i115.i.prol = select i1 %i.gb, i32 %.045.i112.i.ph, i32 1 ; 2 uses
  %i.gc = getelementptr inbounds nuw i8, ptr %i.az, i64 %indvars.iv.i111.i.ph
  store i8 %.sink.i114.i.prol, ptr %i.gc, align 1, !tbaa !231
  %indvars.iv.next.i116.i.prol = or disjoint i64 %indvars.iv.i111.i.ph, 1
  br label %.lr.ph.i110.i.prol.loopexit

.lr.ph.i110.i.prol.loopexit:                      ; preds = %.lr.ph.i110.i.prol, %.lr.ph.i110.i.preheader1098
  %.2.i115.i.lcssa1099.unr = phi i32 [ poison, %.lr.ph.i110.i.preheader1098 ], [ %.2.i115.i.prol, %.lr.ph.i110.i.prol ]
  %indvars.iv.i111.i.unr = phi i64 [ %indvars.iv.i111.i.ph, %.lr.ph.i110.i.preheader1098 ], [ %indvars.iv.next.i116.i.prol, %.lr.ph.i110.i.prol ]
  %.045.i112.i.unr = phi i32 [ %.045.i112.i.ph, %.lr.ph.i110.i.preheader1098 ], [ %.2.i115.i.prol, %.lr.ph.i110.i.prol ]
  %i.gd = add nsw i64 %wide.trip.count.i.i, -1
  %i.ge = icmp eq i64 %indvars.iv.i111.i.ph, %i.gd
  br i1 %i.ge, label %._crit_edge.loopexit.i118.i, label %.lr.ph.i110.i

.lr.ph.i110.i:                                    ; preds = %.lr.ph.i110.i.prol.loopexit, %.lr.ph.i110.i
  %indvars.iv.i111.i = phi i64 [ %indvars.iv.next.i116.i.1, %.lr.ph.i110.i ], [ %indvars.iv.i111.i.unr, %.lr.ph.i110.i.prol.loopexit ] ; 4 uses
  %.045.i112.i = phi i32 [ %.2.i115.i.1, %.lr.ph.i110.i ], [ %.045.i112.i.unr, %.lr.ph.i110.i.prol.loopexit ]
  %i.gf = getelementptr inbounds nuw i8, ptr %i.bb, i64 %indvars.iv.i111.i
  %i.gg = load i8, ptr %i.gf, align 1, !tbaa !231 ; 4 uses
  %i.gh = add i8 %i.gg, -65
  %or.cond.i113.i = icmp ult i8 %i.gh, 26
  %i.gi = or disjoint i8 %i.gg, 32
  %.sink.i114.i = select i1 %or.cond.i113.i, i8 %i.gi, i8 %i.gg
  %i.gj = add i8 %i.gg, -58
  %i.gk = icmp ult i8 %i.gj, -10
  %i.gl = getelementptr inbounds nuw i8, ptr %i.az, i64 %indvars.iv.i111.i
  store i8 %.sink.i114.i, ptr %i.gl, align 1, !tbaa !231
  %indvars.iv.next.i116.i = add nuw nsw i64 %indvars.iv.i111.i, 1 ; 2 uses
  %i.gm = getelementptr inbounds nuw i8, ptr %i.bb, i64 %indvars.iv.next.i116.i
  %i.gn = load i8, ptr %i.gm, align 1, !tbaa !231 ; 4 uses
  %i.go = add i8 %i.gn, -65
  %or.cond.i113.i.1 = icmp ult i8 %i.go, 26
  %i.gp = or disjoint i8 %i.gn, 32
  %.sink.i114.i.1 = select i1 %or.cond.i113.i.1, i8 %i.gp, i8 %i.gn
  %i.gq = add i8 %i.gn, -58
  %i.gr = icmp ult i8 %i.gq, -10
  %i.gs = select i1 %i.gr, i1 %i.gk, i1 false
  %.2.i115.i.1 = select i1 %i.gs, i32 %.045.i112.i, i32 1 ; 2 uses
  %i.gt = getelementptr inbounds nuw i8, ptr %i.az, i64 %indvars.iv.next.i116.i
  store i8 %.sink.i114.i.1, ptr %i.gt, align 1, !tbaa !231
  %indvars.iv.next.i116.i.1 = add nuw nsw i64 %indvars.iv.i111.i, 2 ; 2 uses
  %exitcond.not.i117.i.1 = icmp eq i64 %indvars.iv.next.i116.i.1, %wide.trip.count.i.i
  br i1 %exitcond.not.i117.i.1, label %._crit_edge.loopexit.i118.i, label %.lr.ph.i110.i, !llvm.loop !5513

._crit_edge.loopexit.i118.i:                      ; preds = %.lr.ph.i110.i.prol.loopexit, %.lr.ph.i110.i, %middle.block
  %.2.i115.i.lcssa = phi i32 [ %rdx.select, %middle.block ], [ %.2.i115.i.lcssa1099.unr, %.lr.ph.i110.i.prol.loopexit ], [ %.2.i115.i.1, %.lr.ph.i110.i ]
  %i.gu = icmp eq i32 %.2.i115.i.lcssa, 0         ; 2 uses
  %.neg = select i1 %i.gu, i32 -10, i32 -3
  %i.gv = select i1 %i.gu, i32 10, i32 3          ; 6 uses
  %i.gw = shl nuw nsw i32 %i.gv, 1
  %i.gx = icmp sgt i32 %i.as, %i.gw
  br i1 %i.gx, label %iter.check, label %.loopexit.sink.split.i

iter.check:                                       ; preds = %._crit_edge.loopexit.i118.i
  %i.gy = sub nsw i32 %i.as, %i.gv                ; 8 uses
  %i.gz = zext nneg i32 %i.gv to i64              ; 7 uses
  %i.ha = add nsw i32 %i.gv, -1
  %i.hb = add i32 %.lcssa497, 1
  %i.hc = add i32 %i.gv, %i.ae
  %i.hd = sub i32 %i.hb, %i.hc
  %smax959 = tail call i32 @llvm.smax.i32(i32 %i.hd, i32 %i.as)
  %i.he = add nuw i32 %i.ha, %smax959
  %i.hf = add i32 %i.he, %i.ae
  %i.hg = sub i32 %i.hf, %.lcssa497               ; 3 uses
  %i.hh = zext i32 %i.hg to i64
  %i.hi = add nuw nsw i64 %i.hh, 1                ; 5 uses
  %min.iters.check961 = icmp ult i32 %i.hg, 7
  br i1 %min.iters.check961, label %.lr.ph50.i103.i.preheader, label %vector.scevcheck

vector.scevcheck:                                 ; preds = %iter.check
  %6 = add i32 %.lcssa497, 1
  %7 = add i32 %i.gv, %i.ae
  %8 = sub i32 %6, %7
  %smax = tail call i32 @llvm.smax.i32(i32 %8, i32 %i.as)
  %9 = add i32 %smax, %i.ae
  %10 = sub i32 %.neg, %9
  %11 = add i32 %10, %.lcssa497
  %12 = icmp ult i32 %11, %i.gy
  %13 = zext i32 %i.gy to i64
  %14 = sub nsw i64 %13, %i.gz
  %diff.check958 = icmp ugt i64 %14, -32
  %or.cond1041 = select i1 %12, i1 true, i1 %diff.check958
  br i1 %or.cond1041, label %.lr.ph50.i103.i.preheader, label %vector.main.loop.iter.check

vector.main.loop.iter.check:                      ; preds = %vector.scevcheck
  %min.iters.check962 = icmp ult i32 %i.hg, 31
  br i1 %min.iters.check962, label %vec.epilog.ph, label %vector.ph963

vector.ph963:                                     ; preds = %vector.main.loop.iter.check
  %i.hj = and i64 %i.hi, 24
  %n.vec964 = and i64 %i.hi, 8589934560           ; 5 uses
  %15 = or disjoint i64 %n.vec964, %i.gz          ; 2 uses
  %16 = trunc i64 %n.vec964 to i32
  %17 = add i32 %i.gy, %16
  %invariant.gep.a = getelementptr i8, ptr %i.az, i64 %i.gz
  br label %vector.body965

vector.body965:                                   ; preds = %vector.body965, %vector.ph963
  %index966 = phi i64 [ 0, %vector.ph963 ], [ %index.next969, %vector.body965 ] ; 3 uses
  %18 = trunc i64 %index966 to i32
  %19 = add i32 %i.gy, %18
  %20 = zext nneg i32 %19 to i64
  %i.hk = getelementptr inbounds nuw i8, ptr %i.az, i64 %20 ; 2 uses
  %i.hl = getelementptr inbounds nuw i8, ptr %i.hk, i64 16
  %wide.load967 = load <16 x i8>, ptr %i.hk, align 1, !tbaa !231
  %wide.load968 = load <16 x i8>, ptr %i.hl, align 1, !tbaa !231
  %gep = getelementptr i8, ptr %invariant.gep.a, i64 %index966 ; 2 uses
  %i.hm = getelementptr inbounds nuw i8, ptr %gep, i64 16
  store <16 x i8> %wide.load967, ptr %gep, align 1, !tbaa !231
  store <16 x i8> %wide.load968, ptr %i.hm, align 1, !tbaa !231
  %index.next969 = add nuw i64 %index966, 32      ; 2 uses
  %i.hn = icmp eq i64 %index.next969, %n.vec964
  br i1 %i.hn, label %middle.block970, label %vector.body965, !llvm.loop !5514

middle.block970:                                  ; preds = %vector.body965
  %cmp.n971 = icmp eq i64 %i.hi, %n.vec964
  br i1 %cmp.n971, label %.loopexit.loopexit.i107.i, label %vec.epilog.iter.check

vec.epilog.iter.check:                            ; preds = %middle.block970
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec974 = and i64 %i.hi, 8589934584           ; 4 uses
  %i.ho = add nuw nsw i64 %n.vec974, %i.gz        ; 2 uses
  %21 = trunc i64 %n.vec974 to i32
  %22 = add i32 %i.gy, %21
  %invariant.gep1144 = getelementptr i8, ptr %i.az, i64 %i.gz
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index975 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next977, %vec.epilog.vector.body ] ; 3 uses
  %23 = trunc i64 %index975 to i32
  %24 = add i32 %i.gy, %23
  %25 = zext nneg i32 %24 to i64
  %i.hp = getelementptr inbounds nuw i8, ptr %i.az, i64 %25
  %wide.load976 = load <8 x i8>, ptr %i.hp, align 1, !tbaa !231
  %gep1145 = getelementptr i8, ptr %invariant.gep1144, i64 %index975
  store <8 x i8> %wide.load976, ptr %gep1145, align 1, !tbaa !231
  %index.next977 = add nuw i64 %index975, 8       ; 2 uses
  %i.hq = icmp eq i64 %index.next977, %n.vec974
  br i1 %i.hq, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !5515

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n978 = icmp eq i64 %i.hi, %n.vec974
  br i1 %cmp.n978, label %.loopexit.loopexit.i107.i, label %.lr.ph50.i103.i.preheader

.lr.ph50.i103.i.preheader:                        ; preds = %vector.scevcheck, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv54.i104.i.ph = phi i64 [ %i.gz, %vector.scevcheck ], [ %i.gz, %iter.check ], [ %15, %vec.epilog.iter.check ], [ %i.ho, %vec.epilog.middle.block ]
  %.14047.i105.i.ph = phi i32 [ %i.gy, %vector.scevcheck ], [ %i.gy, %iter.check ], [ %17, %vec.epilog.iter.check ], [ %22, %vec.epilog.middle.block ]
  br label %.lr.ph50.i103.i

.lr.ph50.i103.i:                                  ; preds = %.lr.ph50.i103.i.preheader, %.lr.ph50.i103.i
  %indvars.iv54.i104.i.a = phi i64 [ %indvars.iv.next55.i106.i, %.lr.ph50.i103.i ], [ %indvars.iv54.i104.i.ph, %.lr.ph50.i103.i.preheader ] ; 2 uses
  %.14047.i105.i = phi i32 [ %27, %.lr.ph50.i103.i ], [ %.14047.i105.i.ph, %.lr.ph50.i103.i.preheader ] ; 2 uses
  %26 = zext nneg i32 %.14047.i105.i to i64
  %i.hr = getelementptr inbounds nuw i8, ptr %i.az, i64 %26
  %i.hs = load i8, ptr %i.hr, align 1, !tbaa !231
  %i.ht = getelementptr inbounds nuw i8, ptr %i.az, i64 %indvars.iv54.i104.i.a
  store i8 %i.hs, ptr %i.ht, align 1, !tbaa !231
  %27 = add nsw i32 %.14047.i105.i, 1             ; 2 uses
  %indvars.iv.next55.i106.i = add nuw nsw i64 %indvars.iv54.i104.i.a, 1 ; 2 uses
  %28 = icmp slt i32 %27, %i.as
  br i1 %28, label %.lr.ph50.i103.i, label %.loopexit.loopexit.i107.i, !llvm.loop !5516

.loopexit.loopexit.i107.i:                        ; preds = %.lr.ph50.i103.i, %vec.epilog.middle.block, %middle.block970
  %indvars.iv.next55.i106.i.lcssa = phi i64 [ %i.ho, %vec.epilog.middle.block ], [ %15, %middle.block970 ], [ %indvars.iv.next55.i106.i, %.lr.ph50.i103.i ]
  %i.hu = trunc nuw i64 %indvars.iv.next55.i106.i.lcssa to i32
  br label %.loopexit.sink.split.i

bb.k:                                             ; preds = %bb.j, %bb.i
  %.sink.i = phi i8 [ %i.ey, %bb.i ], [ %i.ew, %bb.j ]
  %i.hv = getelementptr inbounds i8, ptr %i.a, i64 %indvars.iv.i
  store i8 %.sink.i, ptr %i.hv, align 1, !tbaa !231
  %indvars.iv.next786.i = add nuw nsw i64 %indvars.iv785.i, 1 ; 2 uses
  %indvars.iv.next.i = add nsw i64 %indvars.iv.i, -1 ; 2 uses
  %exitcond.not.i = icmp eq i64 %indvars.iv.next786.i, %wide.trip.count.i.i
  br i1 %exitcond.not.i, label %._crit_edge.i, label %.lr.ph.i, !llvm.loop !5517

._crit_edge.i:                                    ; preds = %bb.k
  %i.hw = getelementptr inbounds i8, ptr %i.a, i64 %indvars.iv.i ; 4 uses
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(5) %i.j, i8 0, i64 5, i1 false)
  %i.hx = getelementptr i8, ptr %i.a, i64 %indvars.iv.next.i ; 3 uses
  store ptr %i.hw, ptr %i.b, align 8, !tbaa !259
  %i.hy = load i8, ptr %i.hw, align 1, !tbaa !231 ; 2 uses
  %i.hz = icmp eq i8 %i.hy, 115
  br i1 %i.hz, label %.lr.ph.i120.1.i, label %.lr.ph.i149.i

.lr.ph.i120.1.i:                                  ; preds = %._crit_edge.i
  %i.ia = getelementptr i8, ptr %i.hx, i64 2      ; 4 uses
  %i.ib = load i8, ptr %i.ia, align 1, !tbaa !231 ; 2 uses
  switch i8 %i.ib, label %.lr.ph.i136.1.i.thread [
    i8 101, label %.lr.ph.i120.2.i
    i8 115, label %.lr.ph33.i143.preheader.i
  ]

.lr.ph.i120.2.i:                                  ; preds = %.lr.ph.i120.1.i
  %i.ic = getelementptr i8, ptr %i.hx, i64 3      ; 5 uses
  %i.id = load i8, ptr %i.ic, align 1, !tbaa !231
  switch i8 %i.id, label %.lr.ph.i136.1.i.thread [
    i8 115, label %.lr.ph.i120.3.i
    i8 105, label %.lr.ph33.i130.preheader.i
  ]

.lr.ph.i120.3.i:                                  ; preds = %.lr.ph.i120.2.i
  %i.ie = getelementptr i8, ptr %i.hx, i64 4
  %i.if = load i8, ptr %i.ie, align 1, !tbaa !231
  %i.ig = icmp eq i8 %i.if, 115
  br i1 %i.ig, label %.lr.ph33.i.preheader.i, label %.lr.ph.i136.1.i.thread

.lr.ph33.i.preheader.i:                           ; preds = %.lr.ph.i120.3.i
  store ptr %i.ic, ptr %i.b, align 8, !tbaa !259
  br label %stem.exit161.thread.i.thread

.lr.ph33.i130.preheader.i:                        ; preds = %.lr.ph.i120.2.i
  store ptr %i.ic, ptr %i.b, align 8, !tbaa !259
  br label %stem.exit161.thread.i.thread

.lr.ph33.i143.preheader.i:                        ; preds = %.lr.ph.i120.1.i
  store i8 115, ptr %i.ia, align 1, !tbaa !231
  br label %stem.exit161.thread.i.thread

.lr.ph.i136.1.i.thread:                           ; preds = %.lr.ph.i120.2.i, %.lr.ph.i120.3.i, %.lr.ph.i120.1.i
  store ptr %i.ia, ptr %i.b, align 8, !tbaa !259
  br label %.lr.ph.i149.i

.lr.ph.i149.i:                                    ; preds = %.lr.ph.i136.1.i.thread, %._crit_edge.i
  %i.ih = phi i8 [ %i.hy, %._crit_edge.i ], [ %i.ib, %.lr.ph.i136.1.i.thread ]
  %i.ii = phi ptr [ %i.hw, %._crit_edge.i ], [ %i.ia, %.lr.ph.i136.1.i.thread ] ; 14 uses
  %scevgep797.i = getelementptr i8, ptr %i.ii, i64 3 ; 5 uses
  switch i8 %i.ih, label %stem.exit161.thread.ithread-pre-split [
    i8 100, label %.lr.ph.i149.1.i
    i8 103, label %.lr.ph.i162.1.i
  ]

.lr.ph.i149.1.i:                                  ; preds = %.lr.ph.i149.i
  %i.ij = getelementptr inbounds nuw i8, ptr %i.ii, i64 1 ; 3 uses
  %i.ik = load i8, ptr %i.ij, align 1, !tbaa !231
  %i.il = icmp eq i8 %i.ik, 101
  br i1 %i.il, label %.lr.ph.i149.2.i, label %stem.exit161.thread.ithread-pre-split

.lr.ph.i149.2.i:                                  ; preds = %.lr.ph.i149.1.i
  %i.im = getelementptr i8, ptr %i.ii, i64 2      ; 3 uses
  %i.in = load i8, ptr %i.im, align 1, !tbaa !231 ; 2 uses
  %i.io = icmp eq i8 %i.in, 101
  br i1 %i.io, label %._crit_edge.i154.i, label %._crit_edge.i177.i

._crit_edge.i154.i:                               ; preds = %.lr.ph.i149.2.i
  %i.ip = load i8, ptr %scevgep797.i, align 1, !tbaa !231 ; 2 uses
  %i.iq = icmp eq i8 %i.ip, 0
  br i1 %i.iq, label %stem.exit161.thread.ithread-pre-split, label %.lr.ph.i418.i

.lr.ph.i418.i:                                    ; preds = %._crit_edge.i154.i, %bb.n
  %i.ir = phi i8 [ %i.jc, %bb.n ], [ %i.ip, %._crit_edge.i154.i ]
  %.011.i.i = phi ptr [ %i.jb, %bb.n ], [ %scevgep797.i, %._crit_edge.i154.i ] ; 3 uses
  %i.is = sext i8 %i.ir to i64
  %i.it = getelementptr i8, ptr @cType, i64 %i.is
  %i.iu = getelementptr i8, ptr %i.it, i64 -97
  %i.iv = load i8, ptr %i.iu, align 1, !tbaa !231 ; 2 uses
  %i.iw = icmp slt i8 %i.iv, 2
  br i1 %i.iw, label %bb.l, label %bb.m

bb.l:                                             ; preds = %.lr.ph.i418.i
  %i.ix = sext i8 %i.iv to i32
  %i.iy = sub nsw i32 1, %i.ix
  br label %isVowel.exit.i419.i

bb.m:                                             ; preds = %.lr.ph.i418.i
  %i.iz = getelementptr inbounds nuw i8, ptr %.011.i.i, i64 1
  %i.ja = call fastcc i32 @isConsonant(ptr noundef nonnull readonly %i.iz), !inline_history !5518
  br label %isVowel.exit.i419.i

isVowel.exit.i419.i:                              ; preds = %bb.m, %bb.l
  %.0.i.i420.i = phi i32 [ %i.ja, %bb.m ], [ %i.iy, %bb.l ]
  %.not.i421.i = icmp eq i32 %.0.i.i420.i, 0
  br i1 %.not.i421.i, label %.preheader.i.i, label %bb.n

bb.n:                                             ; preds = %isVowel.exit.i419.i
  %i.jb = getelementptr inbounds nuw i8, ptr %.011.i.i, i64 1 ; 2 uses
  %i.jc = load i8, ptr %i.jb, align 1, !tbaa !231 ; 2 uses
  %i.jd = icmp eq i8 %i.jc, 0
  br i1 %i.jd, label %stem.exit161.thread.ithread-pre-split, label %.lr.ph.i418.i, !llvm.loop !5519

.preheader.i.i:                                   ; preds = %isVowel.exit.i419.i, %.preheader.i.i
  %.1.i.i = phi ptr [ %i.jf, %.preheader.i.i ], [ %.011.i.i, %isVowel.exit.i419.i ] ; 3 uses
  %i.je = call fastcc i32 @isConsonant(ptr noundef nonnull %.1.i.i)
  %.not7.i.i = icmp eq i32 %i.je, 0
  %i.jf = getelementptr inbounds nuw i8, ptr %.1.i.i, i64 1
  br i1 %.not7.i.i, label %m_gt_0.exit.i, label %.preheader.i.i, !llvm.loop !5520

m_gt_0.exit.i:                                    ; preds = %.preheader.i.i
  %i.jg = load i8, ptr %.1.i.i, align 1, !tbaa !231
  %.not618.i = icmp eq i8 %i.jg, 0
  br i1 %.not618.i, label %stem.exit161.thread.ithread-pre-split, label %stem.exit161.thread.thread.i

stem.exit161.thread.thread.i:                     ; preds = %m_gt_0.exit.i
  store ptr %i.ij, ptr %i.b, align 8, !tbaa !259
  br label %stem.exit161.thread.i.thread

.lr.ph.i162.1.i:                                  ; preds = %.lr.ph.i149.i
  %i.jh = getelementptr inbounds nuw i8, ptr %i.ii, i64 1
  %i.ji = load i8, ptr %i.jh, align 1, !tbaa !231
  %i.jj = icmp eq i8 %i.ji, 110
  br i1 %i.jj, label %.lr.ph.i162.2.i, label %stem.exit161.thread.ithread-pre-split

.lr.ph.i162.2.i:                                  ; preds = %.lr.ph.i162.1.i
  %i.jk = getelementptr inbounds nuw i8, ptr %i.ii, i64 2
  %i.jl = load i8, ptr %i.jk, align 1, !tbaa !231
  %i.jm = icmp eq i8 %i.jl, 105
  br i1 %i.jm, label %._crit_edge.i167.i, label %stem.exit161.thread.ithread-pre-split

._crit_edge.i167.i:                               ; preds = %.lr.ph.i162.2.i, %._crit_edge.i167.i
  %.0.i422.i = phi ptr [ %i.jo, %._crit_edge.i167.i ], [ %scevgep797.i, %.lr.ph.i162.2.i ] ; 3 uses
  %i.jn = call fastcc i32 @isConsonant(ptr noundef nonnull %.0.i422.i)
  %.not.i423.i = icmp eq i32 %i.jn, 0
  %i.jo = getelementptr inbounds nuw i8, ptr %.0.i422.i, i64 1
  br i1 %.not.i423.i, label %hasVowel.exit424.i, label %._crit_edge.i167.i, !llvm.loop !5521

hasVowel.exit424.i:                               ; preds = %._crit_edge.i167.i
  %i.jp = load i8, ptr %.0.i422.i, align 1, !tbaa !231
  %.not616.i = icmp eq i8 %i.jp, 0
  br i1 %.not616.i, label %stem.exit161.thread.ithread-pre-split, label %hasVowel.exit424.i..lr.ph.i182.i_crit_edge

hasVowel.exit424.i..lr.ph.i182.i_crit_edge:       ; preds = %hasVowel.exit424.i
  %.pre704 = load i8, ptr %scevgep797.i, align 1, !tbaa !231
  br label %.lr.ph.i182.i

._crit_edge.i177.i:                               ; preds = %.lr.ph.i149.2.i, %._crit_edge.i177.i
  %.0.i425.i = phi ptr [ %i.jr, %._crit_edge.i177.i ], [ %i.im, %.lr.ph.i149.2.i ] ; 3 uses
  %i.jq = call fastcc i32 @isConsonant(ptr noundef nonnull %.0.i425.i)
  %.not.i426.i = icmp eq i32 %i.jq, 0
  %i.jr = getelementptr inbounds nuw i8, ptr %.0.i425.i, i64 1
  br i1 %.not.i426.i, label %hasVowel.exit427.i, label %._crit_edge.i177.i, !llvm.loop !5521

hasVowel.exit427.i:                               ; preds = %._crit_edge.i177.i
  %i.js = load i8, ptr %.0.i425.i, align 1, !tbaa !231
  %.not.i70 = icmp eq i8 %i.js, 0
  br i1 %.not.i70, label %stem.exit161.thread.ithread-pre-split, label %.lr.ph.i182.i

.lr.ph.i182.i:                                    ; preds = %hasVowel.exit424.i..lr.ph.i182.i_crit_edge, %hasVowel.exit427.i
  %i.jt = phi i8 [ %i.in, %hasVowel.exit427.i ], [ %.pre704, %hasVowel.exit424.i..lr.ph.i182.i_crit_edge ] ; 5 uses
  %storemerge = phi ptr [ %i.im, %hasVowel.exit427.i ], [ %scevgep797.i, %hasVowel.exit424.i..lr.ph.i182.i_crit_edge ] ; 18 uses
  store ptr %storemerge, ptr %i.b, align 8, !tbaa !259
  switch i8 %i.jt, label %.lr.ph.i208.thread.i [
    i8 116, label %.lr.ph.i182.1.i
    i8 108, label %.lr.ph.i195.1.i
    i8 122, label %.lr.ph.i208.1.i
  ]

.lr.ph.i182.1.i:                                  ; preds = %.lr.ph.i182.i
  %i.ju = getelementptr inbounds nuw i8, ptr %storemerge, i64 1
  %i.jv = load i8, ptr %i.ju, align 1, !tbaa !231
  %i.jw = icmp eq i8 %i.jv, 97
  br i1 %i.jw, label %.lr.ph33.i189.preheader.i, label %.lr.ph.i208.thread.i

.lr.ph33.i189.preheader.i:                        ; preds = %.lr.ph.i182.1.i
  %i.jx = getelementptr inbounds i8, ptr %storemerge, i64 -1 ; 3 uses
  store i8 101, ptr %i.jx, align 1, !tbaa !231
  store ptr %i.jx, ptr %i.b, align 8, !tbaa !259
  br label %stem.exit161.thread.i.thread

.lr.ph.i195.1.i:                                  ; preds = %.lr.ph.i182.i
  %i.jy = getelementptr inbounds nuw i8, ptr %storemerge, i64 1
  %i.jz = load i8, ptr %i.jy, align 1, !tbaa !231
  %i.ka = icmp eq i8 %i.jz, 98
  br i1 %i.ka, label %.lr.ph33.i202.preheader.i, label %.lr.ph.i208.thread.i
...
sqlite3_free.exit:                                ; preds = %.preheader, %sqlite3_mutex_enter.exit.i, %bb.at, %bb.au
  ...
  br i1 %exitcond.not, label %.loopexit, label %.preheader, !llvm.loop !5854

.loopexit:                                        ; preds = %sqlite3_free.exit, %bb.ap
  %.246 = phi i32 [ 0, %bb.ap ], [ %.2, %sqlite3_free.exit ]
  call fastcc void @sqlite3Fts3SegReaderFinish(ptr noundef %i.f), !inline_history !5830
...
bb.ax:                                            ; preds = %bb.aw
  ...
  call void %i.ft(ptr noundef nonnull %i.fs) #58, !inline_history !5831
...
sqlite3_mutex_enter.exit.i.i41:                   ; preds = %bb.ax, %bb.aw
  ...
  %i.fv = call i32 %i.fu(ptr noundef nonnull %i.f) #58, !inline_history !5832
  ...
  call void %i.gb(ptr noundef nonnull %i.f) #58, !inline_history !5833
...
bb.ay:                                            ; preds = %sqlite3_mutex_enter.exit.i.i41
  ...
  call void %i.gd(ptr noundef nonnull %i.gc) #58, !inline_history !5834
...
bb.az:                                            ; preds = %bb.av
  ...
  call void %i.ge(ptr noundef nonnull %i.f) #58, !inline_history !5833
  br label %fts3SegReaderCursorFree.exit

fts3SegReaderCursorFree.exit:                     ; preds = %.loopexit, %sqlite3_mutex_enter.exit.i.i41, %bb.ay, %bb.az
  store ptr null, ptr %i.e, align 8, !tbaa !5776
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #58
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #58
  ret i32 %.246
}
...
bb.b:                                             ; preds = %bb.a
  %i.k = load ptr, ptr %1, align 8, !tbaa !5764   ; 4 uses
...
sqlite3_free.exit:                                ; preds = %bb.b, %sqlite3_mutex_enter.exit.i, %bb.f, %bb.g
  store ptr null, ptr %1, align 8, !tbaa !5764
  %i.aa = getelementptr inbounds nuw i8, ptr %1, i64 8
  store i32 0, ptr %i.aa, align 8, !tbaa !5835
...
bb.i:                                             ; preds = %bb.h
  store ptr %3, ptr %1, align 8, !tbaa !5764
  %i.ae = getelementptr inbounds nuw i8, ptr %1, i64 8
  store i32 %4, ptr %i.ae, align 8, !tbaa !5835
  br label %sqlite3_free.exit45

bb.j:                                             ; preds = %bb.h
  %i.af = load ptr, ptr %1, align 8, !tbaa !5764  ; 3 uses
...
bb.p:                                             ; preds = %bb.j
  ...
  %i.ax = load i32, ptr %i.aw, align 8, !tbaa !5835 ; 2 uses
...
bb.s:                                             ; preds = %bb.r, %bb.q
  ...
  %i.bb = load i8, ptr %i.ba, align 1, !tbaa !5450
...
bb.t:                                             ; preds = %bb.s
  %i.bg = tail call i32 @sqlite3_initialize(), !inline_history !5855
...
sqlite3_malloc64.exit.i:                          ; preds = %bb.t
  ...
  %i.bi = tail call fastcc ptr @sqlite3Malloc(i64 noundef %i.bh), !inline_history !5855 ; 2 uses
...
bb.v:                                             ; preds = %bb.u
  ...
  %i.bk = call fastcc i32 @sqlite3Fts3GetVarintU(ptr noundef nonnull %.037, ptr noundef nonnull %i.f), !inline_history !5856
...
fts3GetDeltaVarint3.exit42.i:                     ; preds = %fts3GetDeltaVarint3.exit.i
  ...
  %i.bp = call fastcc i32 @sqlite3Fts3GetVarintU(ptr noundef nonnull %.056, ptr noundef nonnull %i.e), !inline_history !5856
...
bb.x:                                             ; preds = %bb.x, %bb.w
  ...
  br i1 %.not.i.i.i, label %fts3PutDeltaVarint3.exit.i, label %bb.x, !llvm.loop !5474
...
fts3PutDeltaVarint3.exit.i:                       ; preds = %bb.x
  ...
  %i.cm = call fastcc i32 @fts3PoslistPhraseMerge(ptr noundef %i.i, i32 noundef %.0, i32 noundef 0, i32 noundef 1, ptr noundef %i.g, ptr noundef %i.h), !inline_history !5856
...
bb.aa:                                            ; preds = %bb.z
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d) #58
  %i.cp = call fastcc i32 @sqlite3Fts3GetVarintU(ptr noundef %i.co, ptr noundef nonnull %i.d), !inline_history !5856
...
bb.ab:                                            ; preds = %fts3GetDeltaVarint3.exit46.i
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c) #58
  %i.cv = call fastcc i32 @sqlite3Fts3GetVarintU(ptr noundef %i.cu, ptr noundef nonnull %i.c), !inline_history !5856
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i, %.lr.ph.preheader.i.i
  ...
  br i1 %.not.i52.i, label %fts3PoslistCopy.exit.i, label %.lr.ph.i.i, !llvm.loop !5480
...
bb.ae:                                            ; preds = %fts3PoslistCopy.exit.i
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #58
  %i.dk = call fastcc i32 @sqlite3Fts3GetVarintU(ptr noundef nonnull %i.dj, ptr noundef nonnull %i.b), !inline_history !5856
...
begin_hunk_22_@fts3PendingListAppendVarint:bb.a
  ...
  store i64 %i.af, ptr %i.ag, align 8, !tbaa !5908
  %i.ah = getelementptr inbounds nuw i8, ptr %i.o, i64 48 ; 2 uses
  %i.ai = getelementptr inbounds nuw i8, ptr %i.o, i64 8
  store ptr %i.ah, ptr %i.ai, align 8, !tbaa !5445
  %.pre54 = load i64, ptr %i.o, align 8, !tbaa !5442
  br label %bb.l
...
bb.m:                                             ; preds = %bb.m, %bb.l
  ...
  br i1 %.not.i40, label %sqlite3Fts3PutVarint.exit, label %bb.m, !llvm.loop !5474
...
sqlite3Fts3PutVarint.exit:                        ; preds = %bb.m
  ...
  %i.av = load i64, ptr %.028, align 8, !tbaa !5442
  %i.aw = add nsw i64 %i.av, %i.au                ; 2 uses
  store i64 %i.aw, ptr %.028, align 8, !tbaa !5442
  %i.ax = load ptr, ptr %i.al, align 8, !tbaa !5445
...
sqlite3_malloc64.exit.thread.sink.split:          ; preds = %sqlite3_realloc64.exit.thread, %sqlite3_mutex_enter.exit.i, %bb.i, %bb.j, %sqlite3Fts3PutVarint.exit
  ...
  store ptr %.sink, ptr %0, align 8, !tbaa !5905
...
bb.a:
  ...
  %i.m = load ptr, ptr %i.l, align 8, !tbaa !5771 ; 7 uses
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i, %.lr.ph.preheader.i.i
  ...
  br i1 %.not.i.i, label %fts3PoslistCopy.exit.i, label %.lr.ph.i.i, !llvm.loop !5480
...
.lr.ph.i20.i:                                     ; preds = %.lr.ph.i20.i, %.lr.ph.preheader.i19.i
  ...
  br i1 %.not.i22.i, label %fts3PoslistCopy.exit25.i, label %.lr.ph.i20.i, !llvm.loop !5480
...
bb.g:                                             ; preds = %bb.c, %fts3PoslistCopy.exit.i, %fts3PoslistCopy.exit25.i
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #58
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a)
  %i.aw = load ptr, ptr %i.l, align 8, !tbaa !5771 ; 4 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.be = load i32, ptr %i.bd, align 8, !tbaa !5793 ; 2 uses
...
bb.i:                                             ; preds = %bb.h
  ...
  store i32 %i.bb, ptr %i.bd, align 8, !tbaa !5793
  %.pre32 = load ptr, ptr %i.l, align 8, !tbaa !5771
  br label %bb.j
...
bb.a:
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.f) #58
  %i.h = call fastcc i32 @fts3SqlStmt(ptr noundef %0, i32 noundef 7, ptr noundef %i.f, ptr noundef nonnull %i.e), !inline_history !5946 ; 2 uses
  %i.i = icmp eq i32 %i.h, 0
  %i.j = load ptr, ptr %i.f, align 8, !tbaa !522  ; 8 uses
  br i1 %i.i, label %bb.b, label %fts3DeleteTerms.exit.thread

bb.b:                                             ; preds = %bb.a
  %i.k = call i32 @sqlite3_step(ptr noundef %i.j), !inline_history !5946
  %i.l = icmp eq i32 %i.k, 100
  br i1 %i.l, label %bb.c, label %fts3DeleteTerms.exit.thread63

fts3DeleteTerms.exit.thread63:                    ; preds = %bb.b
  %i.m = call i32 @sqlite3_reset(ptr noundef %i.j), !inline_history !5946
  call void @llvm.lifetime.end.p0(ptr nonnull %i.f) #58
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.o = load ptr, ptr %i.n, align 8, !tbaa !5543
  %.not.i.i = icmp eq ptr %i.o, null
  br i1 %.not.i.i, label %langidFromSelect.exit.i, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.p = getelementptr inbounds nuw i8, ptr %0, i64 48
  %i.q = load i32, ptr %i.p, align 8, !tbaa !5370
  %i.r = add nsw i32 %i.q, 1
  %i.s = call i32 @sqlite3_column_int(ptr noundef %i.j, i32 noundef %i.r), !inline_history !5946
  br label %langidFromSelect.exit.i

langidFromSelect.exit.i:                          ; preds = %bb.d, %bb.c
  %.0.i.i = phi i32 [ %i.s, %bb.d ], [ 0, %bb.c ] ; 3 uses
  %i.t = call i64 @sqlite3_column_int64(ptr noundef %i.j, i32 noundef 0), !inline_history !5946 ; 3 uses
  %i.u = getelementptr inbounds nuw i8, ptr %0, i64 512 ; 2 uses
  %i.v = load i64, ptr %i.u, align 8, !tbaa !5648 ; 2 uses
...
.lr.ph.i:                                         ; preds = %bb.i, %bb.h
  store i64 %i.t, ptr %i.u, align 8, !tbaa !5648
  %i.aj = getelementptr inbounds nuw i8, ptr %0, i64 520
  store i32 %.0.i.i, ptr %i.aj, align 8, !tbaa !5395
  %i.ak = getelementptr inbounds nuw i8, ptr %0, i64 524
  store i32 1, ptr %i.ak, align 4, !tbaa !5649
...
bb.j:                                             ; preds = %bb.m, %.lr.ph.i
  ...
  %i.an = load i32, ptr %i.al, align 8, !tbaa !5370
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.aq = load ptr, ptr %i.am, align 8, !tbaa !5653
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.av = call ptr @sqlite3_column_text(ptr noundef %i.j, i32 noundef %i.au), !inline_history !5946
  %i.aw = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %i.ap
  %i.ax = call fastcc i32 @fts3PendingTermsAdd(ptr noundef nonnull %0, i32 noundef %.0.i.i, ptr noundef %i.av, i32 noundef -1, ptr noundef nonnull %i.aw), !inline_history !5946
  %i.ay = call i32 @sqlite3_column_bytes(ptr noundef %i.j, i32 noundef %i.au), !inline_history !5946
  %i.az = load i32, ptr %i.al, align 8, !tbaa !5370
  %i.ba = sext i32 %i.az to i64
...
bb.m:                                             ; preds = %bb.l, %bb.k
  ...
  br i1 %i.be, label %bb.j, label %fts3DeleteTerms.exit.thread, !llvm.loop !5948
...
fts3DeleteTerms.exit:                             ; preds = %bb.j
  %i.bg = call i32 @sqlite3_reset(ptr noundef %i.j), !inline_history !5946 ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.f) #58
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e)
...
bb.n:                                             ; preds = %fts3DeleteTerms.exit
  ...
  %i.bj = load ptr, ptr %i.bi, align 8, !tbaa !5542
  %.not.i15 = icmp eq ptr %i.bj, null
  br i1 %.not.i15, label %bb.o, label %.thread48

bb.o:                                             ; preds = %bb.n
  %i.bk = call fastcc i32 @fts3SqlStmt(ptr noundef nonnull %0, i32 noundef 1, ptr noundef %i.d, ptr noundef nonnull %i.c), !inline_history !5949 ; 2 uses
...
bb.p:                                             ; preds = %bb.o
  ...
  %i.bn = call i32 @sqlite3_step(ptr noundef %i.bm), !inline_history !5949
  %i.bo = icmp eq i32 %i.bn, 100
  br i1 %i.bo, label %fts3IsEmpty.exit, label %fts3IsEmpty.exit.thread

fts3IsEmpty.exit:                                 ; preds = %bb.p
  %i.bp = call i32 @sqlite3_column_int(ptr noundef %i.bm, i32 noundef 0), !inline_history !5949
  %i.bq = call i32 @sqlite3_reset(ptr noundef %i.bm), !inline_history !5949 ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d) #58
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c)
...
fts3IsEmpty.exit.thread:                          ; preds = %bb.p
  %i.bs = call i32 @sqlite3_reset(ptr noundef %i.bm), !inline_history !5949 ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d) #58
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c)
...
sqlite3_bind_int64.exit8:                         ; preds = %sqlite3_bind_int64.exit, %sqlite3VdbeMemSetInt64.exit.i6, %bb.i
  %i.aa = load ptr, ptr %i.a, align 8, !tbaa !6484
  %i.ab = tail call i32 @sqlite3_step(ptr noundef %i.aa) ; 0 uses
  %i.ac = load ptr, ptr %i.a, align 8, !tbaa !6484
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !6538 ; 3 uses
...
sqlite3_bind_int64.exit:                          ; preds = %bb.a, %sqlite3VdbeMemSetInt64.exit.i, %bb.e
  %i.n = load ptr, ptr %i.a, align 8, !tbaa !6538 ; 3 uses
...
sqlite3_bind_int64.exit8:                         ; preds = %sqlite3_bind_int64.exit, %sqlite3VdbeMemSetInt64.exit.i6, %bb.i
  %i.aa = load ptr, ptr %i.a, align 8, !tbaa !6538
  %i.ab = tail call i32 @sqlite3_step(ptr noundef %i.aa) ; 0 uses
  %i.ac = load ptr, ptr %i.a, align 8, !tbaa !6538
  %i.ad = tail call i32 @sqlite3_reset(ptr noundef %i.ac)
  ret i32 %i.ad
}
...
bb.b:                                             ; preds = %bb.a
  ...
  %.07.i = load ptr, ptr %i.h, align 8, !tbaa !6439 ; 2 uses
...
.lr.ph.i:                                         ; preds = %bb.b, %bb.c
  ...
  %i.j = load i64, ptr %i.i, align 8, !tbaa !6545
...
bb.c:                                             ; preds = %.lr.ph.i
  ...
  %.0.i = load ptr, ptr %i.k, align 8, !tbaa !6439 ; 2 uses
  %.not.i = icmp eq ptr %.0.i, null
  br i1 %.not.i, label %nodeHashLookup.exit, label %.lr.ph.i, !llvm.loop !6554
...
bb.e:                                             ; preds = %bb.d
  %i.m = load ptr, ptr %.02127, align 8, !tbaa !6546 ; 2 uses
  %.not = icmp eq ptr %i.m, null
  br i1 %.not, label %bb.f, label %bb.d, !llvm.loop !6616
...
bb.g:                                             ; preds = %bb.f
  %i.n = load ptr, ptr %.0.lcssa.i, align 8, !tbaa !6546
  ...
  %i.q = load i32, ptr %i.p, align 8, !tbaa !6544
  %i.r = add nsw i32 %i.q, 1
  store i32 %i.r, ptr %i.p, align 8, !tbaa !6544
  store ptr %2, ptr %.0.lcssa.i, align 8, !tbaa !6546
  br label %.thread

.thread:                                          ; preds = %bb.g, %bb.f, %bb.a
  %i.s = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.t = load i64, ptr %i.s, align 8, !tbaa !6545
  %i.u = tail call i32 %i.b(ptr noundef %0, i64 noundef %1, i64 noundef %i.t) #58, !callees !6618
  br label %.loopexit
...
.lr.ph:                                           ; preds = %bb.a
  ...
  %i.h = load i8, ptr %i.g, align 2, !tbaa !6474
...
bb.f:                                             ; preds = %bb.e, %bb.d
  ...
  br i1 %i.at, label %.lr.ph.split.us, label %.loopexit, !llvm.loop !6640
...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  br i1 %i.cc, label %.lr.ph.split, label %.loopexit, !llvm.loop !6640
...
bb.c:                                             ; preds = %sqlite3_malloc64.exit
  ...
  store ptr %0, ptr %i.h, align 8, !tbaa !6641
  br label %.thread
