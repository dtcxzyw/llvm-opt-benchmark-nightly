...
end_hunk_0
begin_hunk_1_@btreePrevious:bb.a
...
bb.d:                                             ; preds = %.lr.ph
  ...
  br i1 %exitcond.not, label %._crit_edge.thread, label %.lr.ph, !llvm.loop !5173
...
bb.j:                                             ; preds = %bb.i, %sqlite3ExprListAppend.exit, %._crit_edge
  ...
  br i1 %i.ay, label %bb.b, label %.critedge, !llvm.loop !5174
...
.lr.ph495:                                        ; preds = %.lr.ph495, %.lr.ph495.preheader.new
  ...
  br i1 %niter.ncmp.1, label %._crit_edge496.unr-lcssa, label %.lr.ph495, !llvm.loop !5175
...
bb.p:                                             ; preds = %.lr.ph499, %bb.p
  ...
  br i1 %exitcond515.not, label %.loopexit, label %bb.p, !llvm.loop !5176
...
bb.q:                                             ; preds = %.lr.ph503
end_hunk_2
begin_hunk_3_@sqlite3WhereCodeOneLoopStart:bb.a
...
end_hunk_3
begin_hunk_4_@sqlite3GenerateConstraintChecks:bb.a
...
.lr.ph:                                           ; preds = %bb.b
  ...
  br i1 %i.s, label %simpleDelim.exit, label %.critedge, !llvm.loop !5878
...
bb.b:                                             ; preds = %simpleDelim.exit
  ...
  br i1 %exitcond.not, label %.critedge3.thread, label %.lr.ph, !llvm.loop !5878
...
simpleDelim.exit74.thread:                        ; preds = %.lr.ph90, %simpleDelim.exit74
  ...
  br i1 %exitcond100.not, label %.critedge3, label %.lr.ph90, !llvm.loop !5879
...
.lr.ph94:                                         ; preds = %.lr.ph94, %.lr.ph94.preheader.new
  ...
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %.thread.loopexit.unr-lcssa, label %.lr.ph94, !llvm.loop !5880
...
end_hunk_5
begin_hunk_6_@porterClose:bb.a
bb.b:                                             ; preds = %bb.a
  %i.d = load i32, ptr @sqlite3Config, align 8, !tbaa !697
  %.not.i = icmp eq i32 %i.d, 0
  br i1 %.not.i, label %bb.f, label %bb.c
...
.lr.ph:                                           ; preds = %.critedge3
  ...
  br i1 %i.w, label %.lr.ph953, label %.critedge, !llvm.loop !5881
...
.critedge3:                                       ; preds = %.lr.ph953, %bb.b
  ...
  br i1 %exitcond.not, label %.backedge, label %.lr.ph, !llvm.loop !5881
...
end_hunk_6
begin_hunk_7_@fts3EvalNextRow:bb.a
...
bb.bz:                                            ; preds = %.lr.ph.i.i149.i.i
  ...
  br i1 %exitcond.not.i.i151.i.i, label %.critedge.i.i144.i.i, label %.lr.ph.i.i149.i.i, !llvm.loop !6132
...
.critedge.i.i144.i.i:                             ; preds = %bb.bz, %.lr.ph.i.i149.i.i, %fts3PoslistCopy.exit.i.i142.i.i
  ...
  store ptr %.0.lcssa.i.i145.i.i, ptr %i.ga, align 8, !tbaa !6143
...
bb.cb:                                            ; preds = %bb.ca
  ...
  %i.ns = call fastcc i32 @sqlite3Fts3MsrIncrNext(ptr noundef readonly %i.fm, ptr noundef nonnull %i.np, ptr noundef nonnull %i.jc, ptr noundef nonnull %i.nq, ptr noundef nonnull %i.nr), !inline_history !6131
  %i.nt = load ptr, ptr %i.nq, align 16, !tbaa !6145
  %i.nu = icmp eq ptr %i.nt, null
  %spec.select187.i.i = zext i1 %i.nu to i8
  %.pre271.i.i = load i64, ptr %i.jc, align 8, !tbaa !6147
  br label %incrPhraseTokenNext.exit152.i.i

bb.cc:                                            ; preds = %bb.ca
  store i32 1, ptr %i.iz, align 16, !tbaa !6148
  br label %incrPhraseTokenNext.exit152.i.i
...
incrPhraseTokenNext.exit152.i.i:                  ; preds = %bb.cc, %bb.cb, %fts3EvalDlPhraseNext.exit.i136.i.i
  ...
  br i1 %or.cond.i.i, label %.lr.ph222.i.i, label %.critedge5.loopexit.i.i, !llvm.loop !6134
...
.critedge5.i.i:                                   ; preds = %.critedge5.loopexit.i.i, %.preheader.i.i
  ...
  br i1 %i.od, label %.preheader.i.i, label %._crit_edge.i.i, !llvm.loop !6135
...
bb.cd:                                            ; preds = %._crit_edge.i.i
  ...
  %i.oh = load i32, ptr %i.og, align 8, !tbaa !6146 ; 2 uses
  %i.oi = sext i32 %i.oh to i64                   ; 2 uses
  %i.oj = tail call i32 @sqlite3_initialize(), !inline_history !6136
...
sqlite3_malloc64.exit.i.i:                        ; preds = %bb.cd
  ...
  %i.ol = tail call fastcc ptr @sqlite3Malloc(i64 noundef %i.ok), !inline_history !6136 ; 10 uses
...
bb.ce:                                            ; preds = %sqlite3_malloc64.exit.i.i
  ...
  %i.oq = load ptr, ptr %i.op, align 16, !tbaa !6145
...
bb.cf:                                            ; preds = %bb.ch, %.lr.ph248.i.i
  ...
  %i.oz = load i32, ptr %i.oy, align 16, !tbaa !6148
...
bb.cg:                                            ; preds = %bb.cf
  ...
  %i.pc = load ptr, ptr %i.pb, align 16, !tbaa !6145
  ...
  %i.pg = call fastcc i32 @fts3PoslistPhraseMerge(ptr noundef %i.e, i32 noundef %i.pf, i32 noundef 0, i32 noundef 1, ptr noundef %i.c, ptr noundef %i.d), !inline_history !6130
...
bb.ck:                                            ; preds = %bb.cj
  ...
  tail call void %i.pv(ptr noundef nonnull %i.pu) #58, !inline_history !6138
...
sqlite3_mutex_enter.exit.i.i.i:                   ; preds = %bb.ck, %bb.cj
  ...
  %i.px = tail call i32 %i.pw(ptr noundef nonnull %i.ol) #58, !inline_history !6139
  ...
  tail call void %i.qd(ptr noundef nonnull %i.ol) #58, !inline_history !6140
...
bb.cl:                                            ; preds = %sqlite3_mutex_enter.exit.i.i.i
  ...
  tail call void %i.qf(ptr noundef nonnull %i.qe) #58, !inline_history !6141
...
bb.cm:                                            ; preds = %bb.ci
  ...
  tail call void %i.qg(ptr noundef nonnull %i.ol) #58, !inline_history !6140
  br label %.preheader194.i.i.backedge
...
bb.cr:                                            ; preds = %bb.cq
  ...
  tail call fastcc void @sqlite3Fts3DoclistPrev(i32 noundef %i.qk, ptr noundef %i.qn, i32 noundef %i.qm, ptr noundef nonnull %i.qo, ptr noundef nonnull %i.qp, ptr noundef nonnull %i.fl, ptr noundef nonnull %i.h), !inline_history !6142
  %i.qq = load ptr, ptr %i.qo, align 8, !tbaa !6143
...
bb.cs:                                            ; preds = %bb.cq, %bb.cp
  ...
  %i.qs = load ptr, ptr %i.qr, align 8, !tbaa !6143 ; 2 uses
...
bb.cv:                                            ; preds = %.thread.i27.i
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #58
  %i.qz = call fastcc i32 @sqlite3Fts3GetVarintU(ptr noundef nonnull %storemerge27.i.i, ptr noundef nonnull %i.a), !inline_history !6142
...
bb.cw:                                            ; preds = %bb.cv
  %i.re = load ptr, ptr %i.qr, align 8, !tbaa !6143
