...
qrfPrintAligned.exit.i.us:                        ; preds = %.thread.i.i.us, %.thread24.i.i.us, %bb.ea
  ...
  %spec.select.i10.us = select i1 %.not303.i.us, i32 %.0262383.i.us, i32 1 ; 2 uses
  %i.tu = icmp slt i64 %.1258384.i.us, %i.se
...
bb.ef:                                            ; preds = %qrfRTrim.exit.i.us, %bb.ec
  ...
  call void @sqlite3_str_append(ptr noundef %i.ug, ptr noundef nonnull %.2274.i, i32 noundef %i.rj) #45
  br label %bb.eh

bb.eg:                                            ; preds = %qrfPrintAligned.exit.i.us
  %i.uh = load ptr, ptr %i.sa, align 8, !tbaa !38
  call void @sqlite3_str_append(ptr noundef %i.uh, ptr noundef nonnull %.3271.i, i32 noundef %i.rl) #45
  br label %bb.eh
...
bb.eh:                                            ; preds = %bb.eg, %bb.ef
  ...
  %i.ui = add nuw nsw i64 %.1258384.i.us, 1       ; 2 uses
...
bb.ei:                                            ; preds = %._crit_edge387.i.us
  %i.uk = add nuw nsw i32 %.0261.i.us, 1          ; 2 uses
...
.critedge10.i.split.us:                           ; preds = %bb.ei
  ...
  call void @sqlite3_str_append(ptr noundef %i.un, ptr noundef nonnull %.2277.i, i32 noundef %i.rh) #45
  br label %.lr.ph390.i

.preheader360.i.split:                            ; preds = %.preheader362.i
  %i.uo = load ptr, ptr %i.sa, align 8, !tbaa !38
  call void @sqlite3_str_append(ptr noundef %i.uo, ptr noundef nonnull %.2277.i, i32 noundef %i.rh) #45
  br label %.critedge314.i

.lr.ph382.i:                                      ; preds = %.lr.ph382.i.preheader, %.lr.ph382.i
  %.0257381.i = phi i64 [ %i.vg, %.lr.ph382.i ], [ 0, %.lr.ph382.i.preheader ] ; 4 uses
  %niter206 = phi i64 [ %niter206.next.1, %.lr.ph382.i ], [ 0, %.lr.ph382.i.preheader ]
  %i.up = add nsw i64 %.0257381.i, %.4393.i       ; 2 uses
  %i.uq = getelementptr inbounds [8 x i8], ptr %i.sl, i64 %i.up
  %i.ur = load ptr, ptr %i.uq, align 8, !tbaa !66 ; 2 uses
  %i.us = getelementptr inbounds nuw [24 x i8], ptr %i.sm, i64 %.0257381.i ; 2 uses
  ...
  %i.ux = or disjoint i64 %.0257381.i, 1          ; 2 uses
  ...
  %i.vg = add nuw nsw i64 %.0257381.i, 2          ; 2 uses
  %niter206.next.1 = add i64 %niter206, 2         ; 2 uses
  %niter206.ncmp.1 = icmp eq i64 %niter206.next.1, %unroll_iter205
  br i1 %niter206.ncmp.1, label %.lr.ph386.i.preheader.us.preheader.unr-lcssa, label %.lr.ph382.i, !llvm.loop !100

.lr.ph386.i.preheader.us.preheader.unr-lcssa:     ; preds = %.lr.ph382.i
  br i1 %lcmp.mod203.not, label %.lr.ph386.i.preheader.us.preheader, label %.lr.ph382.i.epil.preheader

.lr.ph382.i.epil.preheader:                       ; preds = %.lr.ph386.i.preheader.us.preheader.unr-lcssa, %.lr.ph382.i.preheader
  %.0257381.i.epil.init = phi i64 [ 0, %.lr.ph382.i.preheader ], [ %i.vg, %.lr.ph386.i.preheader.us.preheader.unr-lcssa ] ; 2 uses
  call void @llvm.assume(i1 %lcmp.mod204)
  %i.vh = add nsw i64 %.0257381.i.epil.init, %.4393.i ; 2 uses
  %i.vi = getelementptr inbounds [8 x i8], ptr %i.sl, i64 %i.vh
  %i.vj = load ptr, ptr %i.vi, align 8, !tbaa !66 ; 2 uses
  %i.vk = getelementptr inbounds nuw [24 x i8], ptr %i.sm, i64 %.0257381.i.epil.init ; 2 uses
...
.lr.ph390.i:                                      ; preds = %bb.es, %.critedge10.i.split.us
  %.2259389.i = phi i64 [ %i.wx, %bb.es ], [ 0, %.critedge10.i.split.us ] ; 3 uses
  %i.vp = getelementptr inbounds nuw [24 x i8], ptr %i.sm, i64 %.2259389.i ; 8 uses
...
qrfPrintAligned.exit330.i:                        ; preds = %.thread.i326.i, %.thread24.i327.i, %bb.em, %bb.ej
  %i.wj = icmp slt i64 %.2259389.i, %i.se
  br i1 %i.wj, label %bb.en, label %bb.eo

bb.en:                                            ; preds = %qrfPrintAligned.exit330.i
  %i.wk = load ptr, ptr %i.sa, align 8, !tbaa !38
  call void @sqlite3_str_append(ptr noundef %i.wk, ptr noundef nonnull %.3271.i, i32 noundef %i.rl) #45
  br label %bb.es
...
bb.er:                                            ; preds = %qrfRTrim.exit334.i, %bb.eo
  ...
  call void @sqlite3_str_append(ptr noundef %i.ww, ptr noundef nonnull %.2274.i, i32 noundef %i.rj) #45
  br label %bb.es

bb.es:                                            ; preds = %bb.er, %bb.en
  %i.wx = add nuw nsw i64 %.2259389.i, 1          ; 2 uses
...
bb.et:                                            ; preds = %.critedge314.i
  ...
  %or.cond52 = select i1 %i.wy, i1 %i.xc, i1 false ; 5 uses
  %brmerge.not = select i1 %or.cond52, i1 %i.sp, i1 false
...
bb.fa:                                            ; preds = %qrfLoadAlignment.exit.i
  %or.cond18.i = select i1 %or.cond52, i1 true, i1 %i.rq
...
bb.fc:                                            ; preds = %qrfLoadAlignment.exit.i
  br i1 %or.cond52, label %bb.fd, label %bb.fe
...
bb.fg:                                            ; preds = %qrfLoadAlignment.exit.i
  br i1 %or.cond52, label %bb.fh, label %.loopexit.i9
...
bb.fi:                                            ; preds = %qrfLoadAlignment.exit.i
  br i1 %or.cond52, label %.preheader.i, label %bb.fn

.preheader.i:                                     ; preds = %bb.fi
  br i1 %i.sc, label %.lr.ph392.i, label %.loopexit.i9

.lr.ph392.i:                                      ; preds = %.preheader.i, %bb.fm
  %.3260391.i = phi i64 [ %i.yu, %bb.fm ], [ 0, %.preheader.i ] ; 3 uses
  %i.yd = load ptr, ptr %i.sa, align 8, !tbaa !38
  %i.ye = getelementptr inbounds nuw [24 x i8], ptr %i.sm, i64 %.3260391.i
  ...
  %i.yh = icmp slt i64 %.3260391.i, %i.se
  %i.yi = load ptr, ptr %i.sa, align 8, !tbaa !38 ; 4 uses
  br i1 %i.yh, label %bb.fj, label %bb.fk

bb.fj:                                            ; preds = %.lr.ph392.i
  call void @sqlite3_str_append(ptr noundef %i.yi, ptr noundef nonnull %.3271.i, i32 noundef %i.rl) #45
  br label %bb.fm
...
bb.a:
  ...
  %.029 = select i1 %i.d, i32 %i.a, i32 3
  switch i32 %.029, label %bb.i [
    i32 3, label %bb.b
    i32 1, label %bb.b
    i32 2, label %bb.c
    i32 4, label %bb.d
...
bb.i:                                             ; preds = %bb.b, %bb.a, %bb.c, %bb.d, %bb.e, %bb.h
  %.0 = phi ptr [ null, %bb.h ], [ null, %bb.a ], [ %i.g, %bb.b ], [ %i.j, %bb.c ], [ %i.ay, %bb.e ], [ null, %bb.d ]
  ret ptr %.0
}
