...
.loopexit207._crit_edge:                          ; preds = %.loopexit207
  ...
  %.phi.trans.insert296 = getelementptr i8, ptr %.phi.trans.insert, i64 -8
  %.pre = load ptr, ptr %.phi.trans.insert296, align 8, !tbaa !31
  %.pre297 = load double, ptr %.pre, align 8, !tbaa !70
...
.lr.ph237:                                        ; preds = %.thread
  ...
  %wide.trip.count294.a = zext nneg i32 %.fr238 to i64
  br label %bb.j

bb.j:                                             ; preds = %.lr.ph237, %bb.j
  %indvars.iv290.a = phi i64 [ 0, %.lr.ph237 ], [ %indvars.iv.next291.a, %bb.j ] ; 3 uses
  %i.br = load ptr, ptr %i.bq, align 8, !tbaa !87
  %i.bs = getelementptr inbounds nuw [8 x i8], ptr %i.br, i64 %indvars.iv290.a
  %i.bt = load ptr, ptr %i.bs, align 8, !tbaa !72
  %i.bu = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %indvars.iv290.a
  ...
  %exitcond295.not.a = icmp eq i64 %indvars.iv.next291.a, %wide.trip.count294.a
  br i1 %exitcond295.not.a, label %.loopexit, label %bb.j, !llvm.loop !91

bb.k:                                             ; preds = %.loopexit207._crit_edge, %.thread189
  %i.bw = phi double [ %.pre299, %.thread189 ], [ %i.bh, %.loopexit207._crit_edge ]
  %i.bx = phi double [ %i.ag, %.thread189 ], [ %.pre297, %.loopexit207._crit_edge ]
...
.preheader200.us.preheader:                       ; preds = %.preheader200.lr.ph
  %wide.trip.count267 = zext nneg i32 %.fr238 to i64
  br label %.preheader200.us

.preheader200.us:                                 ; preds = %.preheader200.us.preheader, %.split.us.us
  %indvars.iv278 = phi i64 [ 1, %.preheader200.us.preheader ], [ %indvars.iv.next279, %.split.us.us ] ; 3 uses
  br label %.lr.ph222.us.us

.lr.ph222.us.us:                                  ; preds = %..loopexit199_crit_edge.us.us, %.preheader200.us
  %indvars.iv269 = phi i64 [ %indvars.iv.next270, %..loopexit199_crit_edge.us.us ], [ %i.ew, %.preheader200.us ] ; 6 uses
  %i.ex = getelementptr inbounds nuw [8 x i8], ptr %i.es, i64 %indvars.iv269
  %i.ey = load double, ptr %i.ex, align 8, !tbaa !93
  %5 = sub nuw nsw i64 %indvars.iv269, %indvars.iv278
  ...
  %i.fd = getelementptr inbounds nuw [8 x i8], ptr %i.et, i64 %indvars.iv269
  ...
  %i.fg = and i64 %indvars.iv.next270, 4294967295 ; 2 uses
  %i.fh = getelementptr inbounds nuw [8 x i8], ptr %i.et, i64 %i.fg
  %i.fi = load ptr, ptr %i.fh, align 8, !tbaa !72
  tail call void @N_VLinearSum(double noundef %i.fc, ptr noundef %i.fe, double noundef %i.ff, ptr noundef %i.fi, ptr noundef %i.fe) #7
  %i.fj = getelementptr inbounds nuw [8 x i8], ptr %i.ev, i64 %indvars.iv269
  %i.fk = getelementptr inbounds nuw [8 x i8], ptr %i.ev, i64 %i.fg
  br label %bb.q

bb.q:                                             ; preds = %bb.q, %.lr.ph222.us.us
  %indvars.iv263 = phi i64 [ %indvars.iv.next264, %bb.q ], [ 0, %.lr.ph222.us.us ] ; 3 uses
  %i.fl = load ptr, ptr %i.fj, align 8, !tbaa !74
  %i.fm = getelementptr inbounds nuw [8 x i8], ptr %i.fl, i64 %indvars.iv263
  %i.fn = load ptr, ptr %i.fm, align 8, !tbaa !72 ; 2 uses
  %i.fo = load ptr, ptr %i.fk, align 8, !tbaa !74
  %i.fp = getelementptr inbounds nuw [8 x i8], ptr %i.fo, i64 %indvars.iv263
  %i.fq = load ptr, ptr %i.fp, align 8, !tbaa !72
  tail call void @N_VLinearSum(double noundef %i.fc, ptr noundef %i.fn, double noundef %i.ff, ptr noundef %i.fq, ptr noundef %i.fn) #7
  ...
  br i1 %exitcond268.not, label %..loopexit199_crit_edge.us.us, label %bb.q, !llvm.loop !98

..loopexit199_crit_edge.us.us:                    ; preds = %bb.q
  %sext312 = shl i64 %indvars.iv269, 32
  %6 = ashr exact i64 %sext312, 32
  %.not171.us.us.not = icmp sgt i64 %6, %indvars.iv278
...
.split.us.us:                                     ; preds = %..loopexit199_crit_edge.us.us
  ...
  %exitcond273.not = icmp eq i64 %indvars.iv.next279, %wide.trip.count282
  br i1 %exitcond273.not, label %.loopexit201, label %.preheader200.us, !llvm.loop !100
...
.loopexit199:                                     ; preds = %.preheader200, %.loopexit199
  ...
  %i.fr = getelementptr inbounds nuw [8 x i8], ptr %i.es, i64 %indvars.iv259
  %i.fs = load double, ptr %i.fr, align 8, !tbaa !93
  %7 = sub nuw nsw i64 %indvars.iv259, %indvars.iv262
  %i.ft = getelementptr inbounds nuw [8 x i8], ptr %i.es, i64 %7
  %i.fu = load double, ptr %i.ft, align 8, !tbaa !93
  %i.fv = fsub double %i.fs, %i.fu
  %i.fw = fdiv double %i.bz, %i.fv                ; 2 uses
  %i.fx = getelementptr inbounds nuw [8 x i8], ptr %i.et, i64 %indvars.iv259
  %i.fy = load ptr, ptr %i.fx, align 8, !tbaa !72 ; 2 uses
  %i.fz = fneg double %i.fw
  %indvars.iv.next260 = add nsw i64 %indvars.iv259, -1 ; 2 uses
  %i.ga = and i64 %indvars.iv.next260, 4294967295
  %i.gb = getelementptr inbounds nuw [8 x i8], ptr %i.et, i64 %i.ga
  %i.gc = load ptr, ptr %i.gb, align 8, !tbaa !72
  tail call void @N_VLinearSum(double noundef %i.fw, ptr noundef %i.fy, double noundef %i.fz, ptr noundef %i.gc, ptr noundef %i.fy) #7
  %sext = shl i64 %indvars.iv259, 32
  %8 = ashr exact i64 %sext, 32
  %.not171.not = icmp sgt i64 %8, %indvars.iv262
...
.split:                                           ; preds = %.loopexit199
  ...
  %exitcond262.not = icmp eq i64 %indvars.iv.next263, %wide.trip.count282
  br i1 %exitcond262.not, label %.loopexit201, label %.preheader200, !llvm.loop !100
...
.loopexit201:                                     ; preds = %.split, %.split.us.us, %.thread304, %.loopexit203, %bb.l
  ...
  %i.gd = getelementptr inbounds nuw i8, ptr %i.b, i64 168 ; 2 uses
  %i.ge = sext i32 %.0157308 to i64               ; 2 uses
  %i.gf = getelementptr inbounds [8 x i8], ptr %i.gd, i64 %i.ge
  %i.gg = load ptr, ptr %i.gf, align 8, !tbaa !72
  tail call void @N_VScale(double noundef 1.000000e+00, ptr noundef %i.gg, ptr noundef %2) #7
  %i.gh = icmp sgt i32 %.fr238, 0                 ; 2 uses
  br i1 %i.gh, label %.lr.ph228, label %.preheader

.lr.ph228:                                        ; preds = %.loopexit201
  %i.gi = getelementptr inbounds nuw i8, ptr %i.b, i64 272
  %i.gj = getelementptr inbounds [8 x i8], ptr %i.gi, i64 %i.ge
  %wide.trip.count278 = zext nneg i32 %.fr238 to i64
  br label %bb.r

.preheader:                                       ; preds = %bb.r, %.loopexit201
  %i.gk = icmp sgt i32 %.0157308, 0
  br i1 %i.gk, label %.lr.ph234, label %.loopexit

.lr.ph234:                                        ; preds = %.preheader
  %i.gl = getelementptr inbounds nuw i8, ptr %i.b, i64 376
  %i.gm = getelementptr inbounds nuw i8, ptr %i.b, i64 272
  %i.gn = zext nneg i32 %.0157308 to i64
  %wide.trip.count284 = zext nneg i32 %.fr238 to i64
  br label %bb.s

bb.r:                                             ; preds = %.lr.ph228, %bb.r
  %indvars.iv274 = phi i64 [ 0, %.lr.ph228 ], [ %indvars.iv.next275, %bb.r ] ; 3 uses
  %i.go = load ptr, ptr %i.gj, align 8, !tbaa !74
  %i.gp = getelementptr inbounds nuw [8 x i8], ptr %i.go, i64 %indvars.iv274
  %i.gq = load ptr, ptr %i.gp, align 8, !tbaa !72
  %i.gr = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %indvars.iv274
  %i.gs = load ptr, ptr %i.gr, align 8, !tbaa !72
  tail call void @N_VScale(double noundef 1.000000e+00, ptr noundef %i.gq, ptr noundef %i.gs) #7
  ...
  br i1 %exitcond279.not, label %.preheader, label %bb.r, !llvm.loop !101

.loopexit197:                                     ; preds = %bb.t, %bb.s
  %i.gt = icmp samesign ugt i64 %indvars.iv286, 1
  br i1 %i.gt, label %bb.s, label %.loopexit, !llvm.loop !102

bb.s:                                             ; preds = %.lr.ph234, %.loopexit197
  %indvars.iv286 = phi i64 [ %i.gn, %.lr.ph234 ], [ %indvars.iv.next287, %.loopexit197 ] ; 2 uses
  %indvars.iv.next287 = add nsw i64 %indvars.iv286, -1 ; 4 uses
  %i.gu = getelementptr inbounds nuw [8 x i8], ptr %i.gl, i64 %indvars.iv.next287
  %i.gv = load double, ptr %i.gu, align 8, !tbaa !93
  %i.gw = fsub double %1, %i.gv
  %i.gx = fdiv double %i.gw, %i.bz                ; 2 uses
  %i.gy = getelementptr inbounds nuw [8 x i8], ptr %i.gd, i64 %indvars.iv.next287
  %i.gz = load ptr, ptr %i.gy, align 8, !tbaa !72
  tail call void @N_VLinearSum(double noundef %i.gx, ptr noundef %2, double noundef 1.000000e+00, ptr noundef %i.gz, ptr noundef %2) #7
  br i1 %i.gh, label %.lr.ph231, label %.loopexit197

.lr.ph231:                                        ; preds = %bb.s
  %i.ha = getelementptr inbounds nuw [8 x i8], ptr %i.gm, i64 %indvars.iv.next287
  br label %bb.t

bb.t:                                             ; preds = %.lr.ph231, %bb.t
  %indvars.iv280 = phi i64 [ 0, %.lr.ph231 ], [ %indvars.iv.next281, %bb.t ] ; 3 uses
  %i.hb = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %indvars.iv280
  %i.hc = load ptr, ptr %i.hb, align 8, !tbaa !72 ; 2 uses
  %i.hd = load ptr, ptr %i.ha, align 8, !tbaa !74
  %i.he = getelementptr inbounds nuw [8 x i8], ptr %i.hd, i64 %indvars.iv280
  %i.hf = load ptr, ptr %i.he, align 8, !tbaa !72
  tail call void @N_VLinearSum(double noundef %i.gx, ptr noundef %i.hc, double noundef 1.000000e+00, ptr noundef %i.hf, ptr noundef %i.hc) #7
  ...
  br i1 %exitcond285.not, label %.loopexit197, label %bb.t, !llvm.loop !103
