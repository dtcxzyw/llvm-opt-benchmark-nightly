...
.critedge65:                                      ; preds = %bb.f
  ...
  store double %i.bm, ptr %i.bn, align 8, !tbaa !25
  %i.bo = getelementptr inbounds nuw i8, ptr %i.f, i64 48
  store double %i.bm, ptr %i.bo, align 8, !tbaa !18
  br label %bb.t
...
bb.t:                                             ; preds = %bb.s, %.critedge65, %bb.r, %bb.c, %bb.a, %bb.b, %bb.e
  %.052 = phi ptr [ null, %bb.c ], [ %i.i, %bb.e ], [ null, %bb.a ], [ null, %bb.b ], [ %i.bp, %bb.s ], [ %i.f, %.critedge65 ], [ %i.f, %bb.r ]
  ret ptr %.052
}
...
bb.a:
  ...
  %i.b = load i32, ptr %i.a, align 8, !tbaa !12   ; 11 uses
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 4
  %i.d = load i32, ptr %i.c, align 4, !tbaa !32   ; 11 uses
  ...
  store ptr %i.l, ptr %1, align 8, !tbaa !34
...
.lr.ph154.preheader:                              ; preds = %bb.b
  ...
  tail call void @llvm.memset.p0.i64(ptr align 4 %i.v, i8 -1, i64 %i.ad, i1 false), !tbaa !16
  %i.ae = zext nneg i32 %i.b to i64
  %i.af = shl nuw nsw i64 %i.ae, 2
  tail call void @llvm.memset.p0.i64(ptr align 4 %i.x, i8 -1, i64 %i.af, i1 false), !tbaa !16
  %i.ag = zext nneg i32 %i.b to i64
  %i.ah = shl nuw nsw i64 %i.ag, 2
  tail call void @llvm.memset.p0.i64(ptr align 4 %i.aa, i8 0, i64 %i.ah, i1 false), !tbaa !16
...
.lr.ph156.preheader:                              ; preds = %.preheader147
  ...
  tail call void @llvm.memset.p0.i64(ptr nonnull align 4 %i.m, i8 -1, i64 %i.ak, i1 false), !tbaa !16
...
.loopexit:                                        ; preds = %.lr.ph158, %.lr.ph162
  ...
  br i1 %i.am, label %.lr.ph162, label %.preheader145, !llvm.loop !27
...
.lr.ph158:                                        ; preds = %.lr.ph158.preheader, %.lr.ph158
  ...
  store i32 %i.au, ptr %i.ay, align 4, !tbaa !16
  %indvars.iv.next = add nsw i64 %indvars.iv, 1   ; 2 uses
  %i.az = load i32, ptr %i.aq, align 4, !tbaa !16
  %i.ba = sext i32 %i.az to i64
  %i.bb = icmp slt i64 %indvars.iv.next, %i.ba
  br i1 %i.bb, label %.lr.ph158, label %.loopexit, !llvm.loop !28
...
.lr.ph165:                                        ; preds = %.lr.ph165.preheader, %bb.f
  ...
  store i32 -1, ptr %i.bc, align 4, !tbaa !16
  %i.bd = getelementptr inbounds nuw [4 x i8], ptr %i.m, i64 %indvars.iv.next182
  %i.be = load i32, ptr %i.bd, align 4, !tbaa !16 ; 2 uses
...
bb.c:                                             ; preds = %.lr.ph165
  ...
  %i.bi = load i32, ptr %i.bh, align 4, !tbaa !16 ; 2 uses
  %i.bj = add nsw i32 %i.bi, 1
  store i32 %i.bj, ptr %i.bh, align 4, !tbaa !16
  %i.bk = icmp eq i32 %i.bi, 0
  br i1 %i.bk, label %bb.d, label %._crit_edge193.a

._crit_edge193.a:                                 ; preds = %bb.c
...
bb.e:                                             ; preds = %._crit_edge193.a, %bb.d
  %.pre-phi = phi i32 [ %.pre194, %._crit_edge193.a ], [ %i.bm, %bb.d ]
  ...
  store i32 %.pre-phi, ptr %i.bn, align 4, !tbaa !16
  br label %bb.f
...
bb.g:                                             ; preds = %.lr.ph168
  %i.by = load i32, ptr %i.bs, align 8, !tbaa !36 ; 2 uses
  %i.bz = add nsw i32 %i.by, 1
  store i32 %i.bz, ptr %i.bs, align 8, !tbaa !36
  br label %bb.h

bb.h:                                             ; preds = %bb.g, %.lr.ph168
...
._crit_edge192:                                   ; preds = %bb.j, %bb.k
  ...
  store i32 %i.ct, ptr %i.cv, align 4, !tbaa !16
  %i.cw = getelementptr inbounds [4 x i8], ptr %i.q, i64 %i.ca
  %i.cx = load i32, ptr %i.cw, align 4, !tbaa !16
  store i32 %i.cx, ptr %i.cs, align 4, !tbaa !16
  %i.cy = load i32, ptr %i.cd, align 4, !tbaa !16
  %i.cz = load i32, ptr %i.cm, align 4, !tbaa !16
  %i.da = add nsw i32 %i.cz, %i.cy
  store i32 %i.da, ptr %i.cm, align 4, !tbaa !16
  br label %bb.l
...
.lr.ph171:                                        ; preds = %bb.o, %.lr.ph171.preheader.new
  ...
  %.5170 = phi i32 [ %.4.lcssa, %.lr.ph171.preheader.new ], [ %.6.1, %bb.o ] ; 3 uses
  %niter = phi i64 [ 0, %.lr.ph171.preheader.new ], [ %niter.next.1, %bb.o ]
  %i.dc = getelementptr inbounds nuw [4 x i8], ptr %i.l, i64 %indvars.iv187 ; 2 uses
  %i.dd = load i32, ptr %i.dc, align 4, !tbaa !16
  %i.de = icmp slt i32 %i.dd, 0
  br i1 %i.de, label %bb.m, label %.lr.ph171.1

bb.m:                                             ; preds = %.lr.ph171
  %i.df = add nuw nsw i32 %.5170, 1
  store i32 %.5170, ptr %i.dc, align 4, !tbaa !16
  br label %.lr.ph171.1

.lr.ph171.1:                                      ; preds = %.lr.ph171, %bb.m
  %.6 = phi i32 [ %i.df, %bb.m ], [ %.5170, %.lr.ph171 ] ; 3 uses
  %i.dg = getelementptr inbounds nuw [4 x i8], ptr %i.l, i64 %indvars.iv187
...
bb.n:                                             ; preds = %.lr.ph171.1
  %i.dk = add nuw nsw i32 %.6, 1
  store i32 %.6, ptr %i.dh, align 4, !tbaa !16
  br label %bb.o

bb.o:                                             ; preds = %bb.n, %.lr.ph171.1
  %.6.1 = phi i32 [ %i.dk, %bb.n ], [ %.6, %.lr.ph171.1 ] ; 2 uses
  %indvars.iv.next188.1 = add nuw nsw i64 %indvars.iv187, 2 ; 2 uses
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge172.loopexit.unr-lcssa, label %.lr.ph171, !llvm.loop !31

._crit_edge172.loopexit.unr-lcssa:                ; preds = %bb.o
...
.lr.ph171.epil.preheader:                         ; preds = %._crit_edge172.loopexit.unr-lcssa, %.lr.ph171.preheader
  %indvars.iv187.epil.init = phi i64 [ 0, %.lr.ph171.preheader ], [ %indvars.iv.next188.1, %._crit_edge172.loopexit.unr-lcssa ]
  %.5170.epil.init = phi i32 [ %.4.lcssa, %.lr.ph171.preheader ], [ %.6.1, %._crit_edge172.loopexit.unr-lcssa ]
  %lcmp.mod205 = trunc i32 %i.d to i1
  tail call void @llvm.assume(i1 %lcmp.mod205)
  %i.dl = getelementptr inbounds nuw [4 x i8], ptr %i.l, i64 %indvars.iv187.epil.init ; 2 uses
  %i.dm = load i32, ptr %i.dl, align 4, !tbaa !16
  %i.dn = icmp slt i32 %i.dm, 0
  br i1 %i.dn, label %bb.p, label %._crit_edge172

bb.p:                                             ; preds = %.lr.ph171.epil.preheader
  store i32 %.5170.epil.init, ptr %i.dl, align 4, !tbaa !16
  br label %._crit_edge172

._crit_edge172:                                   ; preds = %._crit_edge172.loopexit.unr-lcssa, %bb.p, %.lr.ph171.epil.preheader, %.preheader, %bb.a
  %.0135 = phi i32 [ 0, %bb.a ], [ 1, %.preheader ], [ 1, %.lr.ph171.epil.preheader ], [ 1, %bb.p ], [ 1, %._crit_edge172.loopexit.unr-lcssa ]
...
!11 = !{!"cs_sparse", !5, i64 0, !5, i64 4, !5, i64 8, !9, i64 16, !9, i64 24, !10, i64 32, !5, i64 40}
!12 = !{!11, !5, i64 8}
!13 = !{!"double", !4, i64 0}
!14 = !{!"cs_symbolic", !9, i64 0, !9, i64 8, !9, i64 16, !9, i64 24, !9, i64 32, !5, i64 40, !13, i64 48, !13, i64 56}
!15 = !{!14, !9, i64 16}
!16 = !{!5, !5, i64 0}
