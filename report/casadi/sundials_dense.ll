...
begin_hunk_0_@denseGETRF:bb.a
  ...
  store double %i.bs, ptr %i.bq, align 8, !tbaa !34
  %i.bt = add nuw nsw i64 %.385.us, 2             ; 2 uses
  %exitcond101.not.1 = icmp eq i64 %i.bt, %1
  br i1 %exitcond101.not.1, label %..loopexit_crit_edge.us, label %scalar.ph, !llvm.loop !43
...
..loopexit_crit_edge.us:                          ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block, %.lr.ph88.split.us
  ...
  br i1 %exitcond102.not, label %.loopexit75, label %.lr.ph88.split.us, !llvm.loop !44
...
vector.memcheck:                                  ; preds = %.preheader.us
  ...
  %scevgep113 = getelementptr i8, ptr %i.be, i64 %i.b
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x double>, ptr %i.bx, align 8, !tbaa !34, !alias.scope !50
  %wide.load116 = load <2 x double>, ptr %i.by, align 8, !tbaa !34, !alias.scope !50
  %i.bz = getelementptr inbounds nuw [8 x i8], ptr %i.be, i64 %i.bw ; 3 uses
  %i.ca = getelementptr inbounds nuw i8, ptr %i.bz, i64 16 ; 2 uses
  %wide.load117 = load <2 x double>, ptr %i.bz, align 8, !tbaa !34, !alias.scope !51, !noalias !50
  %wide.load118 = load <2 x double>, ptr %i.ca, align 8, !tbaa !34, !alias.scope !51, !noalias !50
  %i.cb = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat, <2 x double> %wide.load, <2 x double> %wide.load117)
  %i.cc = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat, <2 x double> %wide.load116, <2 x double> %wide.load118)
  store <2 x double> %i.cb, ptr %i.bz, align 8, !tbaa !34, !alias.scope !51, !noalias !50
  store <2 x double> %i.cc, ptr %i.ca, align 8, !tbaa !34, !alias.scope !51, !noalias !50
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.cd = icmp eq i64 %index.next, %n.vec
  br i1 %i.cd, label %middle.block, label %vector.body, !llvm.loop !48
...
scalar.ph.preheader:                              ; preds = %vector.memcheck, %.preheader.us, %middle.block
  ...
  %xtraiter135 = and i64 %i.ce, 1
  %lcmp.mod136.not = icmp eq i64 %xtraiter135, 0
  br i1 %lcmp.mod136.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol
...
.lr.ph84:                                         ; preds = %.lr.ph84.preheader133, %.lr.ph84
  %.282 = phi i64 [ %i.cp, %.lr.ph84 ], [ %.282.ph, %.lr.ph84.preheader133 ] ; 2 uses
  ...
  store double %i.co, ptr %i.cm, align 8, !tbaa !34
  %i.cp = add nuw nsw i64 %.282, 1                ; 2 uses
  %exitcond100.not = icmp eq i64 %i.cp, %1
  br i1 %exitcond100.not, label %.preheader74, label %.lr.ph84, !llvm.loop !49
...
bb.a:
  ...
  %i.d = load i64, ptr %i.c, align 8, !tbaa !30   ; 12 uses
...
bb.b:                                             ; preds = %.lr.ph.i.epil.preheader
  ...
  %i.j = load double, ptr %i.i, align 8, !tbaa !34
  %i.k = getelementptr inbounds [8 x i8], ptr %2, i64 %i.h ; 2 uses
  %i.l = load double, ptr %i.k, align 8, !tbaa !34
  store double %i.l, ptr %i.i, align 8, !tbaa !34
  store double %i.j, ptr %i.k, align 8, !tbaa !34
...
bb.c:                                             ; preds = %.lr.ph.i
  ...
  store double %i.t, ptr %i.q, align 8, !tbaa !34
  store double %i.r, ptr %i.s, align 8, !tbaa !34
  br label %.lr.ph.i.1

.lr.ph.i.1:                                       ; preds = %bb.c, %.lr.ph.i
  %i.u = or disjoint i64 %.056.i, 1               ; 3 uses
  %i.v = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %i.u
  %i.w = load i64, ptr %i.v, align 8, !tbaa !35   ; 2 uses
...
bb.e:                                             ; preds = %bb.d, %.lr.ph.i.1
  ...
  br i1 %niter.ncmp.1, label %.preheader55.i.unr-lcssa, label %.lr.ph.i, !llvm.loop !0

.loopexit.i:                                      ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  %exitcond65.not.i = icmp eq i64 %i.af, %i.m
  br i1 %exitcond65.not.i, label %.lr.ph63.i.preheader, label %.lr.ph58.i, !llvm.loop !1
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %i.ak = add i64 %i.af, %n.vec
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.al = add nuw i64 %i.af, %index               ; 2 uses
  %i.am = getelementptr inbounds nuw [8 x i8], ptr %i.ae, i64 %i.al ; 2 uses
  %i.an = getelementptr inbounds nuw i8, ptr %i.am, i64 16
  %wide.load = load <2 x double>, ptr %i.am, align 8, !tbaa !34, !alias.scope !64
  %wide.load11 = load <2 x double>, ptr %i.an, align 8, !tbaa !34, !alias.scope !64
  %i.ao = load double, ptr %i.ag, align 8, !tbaa !34, !alias.scope !65
  ...
  %wide.load12 = load <2 x double>, ptr %i.ap, align 8, !tbaa !34, !alias.scope !66, !noalias !64
  %wide.load13 = load <2 x double>, ptr %i.aq, align 8, !tbaa !34, !alias.scope !66, !noalias !64
  ...
  store <2 x double> %i.at, ptr %i.ap, align 8, !tbaa !34, !alias.scope !66, !noalias !64
  store <2 x double> %i.au, ptr %i.aq, align 8, !tbaa !34, !alias.scope !66, !noalias !64
  %index.next = add nuw i64 %index, 4             ; 2 uses
...
scalar.ph.preheader:                              ; preds = %vector.memcheck, %.lr.ph58.i, %middle.block
  %.05057.i.ph = phi i64 [ %i.af, %vector.memcheck ], [ %i.af, %.lr.ph58.i ], [ %i.ak, %middle.block ] ; 6 uses
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader
  %i.ax = getelementptr inbounds nuw [8 x i8], ptr %i.ae, i64 %.05057.i.ph
  %i.ay = load double, ptr %i.ax, align 8, !tbaa !34
  %i.az = load double, ptr %i.ag, align 8, !tbaa !34
  %i.ba = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %.05057.i.ph ; 2 uses
  %i.bb = load double, ptr %i.ba, align 8, !tbaa !34
  %i.bc = fneg double %i.ay
  %i.bd = tail call double @llvm.fmuladd.f64(double %i.bc, double %i.az, double %i.bb)
  store double %i.bd, ptr %i.ba, align 8, !tbaa !34
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  %i.bg = getelementptr inbounds nuw [8 x i8], ptr %i.ae, i64 %.05057.i
  %i.bh = load double, ptr %i.bg, align 8, !tbaa !34
  %i.bi = load double, ptr %i.ag, align 8, !tbaa !34
  ...
  store double %i.bm, ptr %i.bj, align 8, !tbaa !34
  %i.bn = add nuw nsw i64 %.05057.i, 1            ; 2 uses
  %i.bo = getelementptr inbounds nuw [8 x i8], ptr %i.ae, i64 %i.bn
  %i.bp = load double, ptr %i.bo, align 8, !tbaa !34
  %i.bq = load double, ptr %i.ag, align 8, !tbaa !34
  ...
  store double %i.bu, ptr %i.br, align 8, !tbaa !34
  %i.bv = add nuw nsw i64 %.05057.i, 2            ; 2 uses
  %exitcond64.not.i.1 = icmp eq i64 %i.bv, %i.d
  br i1 %exitcond64.not.i.1, label %.loopexit.i, label %scalar.ph, !llvm.loop !57
...
.lr.ph63.i:                                       ; preds = %.lr.ph63.i.preheader, %.loopexit
  ...
  %i.bx = load ptr, ptr %i.bw, align 8, !tbaa !32 ; 6 uses
  %i.by = getelementptr inbounds nuw [8 x i8], ptr %i.bx, i64 %.262.i ; 2 uses
  %i.bz = load double, ptr %i.by, align 8, !tbaa !34
  ...
  store double %i.cc, ptr %i.ca, align 8, !tbaa !34
...
vector.body22:                                    ; preds = %vector.body22, %vector.ph20
  ...
  %wide.load24 = load <2 x double>, ptr %i.cd, align 8, !tbaa !34, !alias.scope !67
  %wide.load25 = load <2 x double>, ptr %i.ce, align 8, !tbaa !34, !alias.scope !67
  %i.cf = load double, ptr %i.ca, align 8, !tbaa !34, !alias.scope !68
  ...
  %wide.load26 = load <2 x double>, ptr %i.cg, align 8, !tbaa !34, !alias.scope !69, !noalias !67
  %wide.load27 = load <2 x double>, ptr %i.ch, align 8, !tbaa !34, !alias.scope !69, !noalias !67
  ...
  store <2 x double> %i.ck, ptr %i.cg, align 8, !tbaa !34, !alias.scope !69, !noalias !67
  store <2 x double> %i.cl, ptr %i.ch, align 8, !tbaa !34, !alias.scope !69, !noalias !67
  %index.next30 = add nuw i64 %index23, 4         ; 2 uses
  %i.cm = icmp eq i64 %index.next30, %n.vec21
  br i1 %i.cm, label %middle.block31, label %vector.body22, !llvm.loop !62
...
scalar.ph18:                                      ; preds = %scalar.ph18.prol.loopexit, %scalar.ph18
  ...
  %i.cz = load double, ptr %i.ca, align 8, !tbaa !34
...
.loopexit:                                        ; preds = %scalar.ph18.prol.loopexit, %scalar.ph18, %middle.block31
  ...
  br i1 %i.do, label %.lr.ph63.i, label %denseGETRS.exit, !llvm.loop !2

denseGETRS.exit:                                  ; preds = %.loopexit, %bb.a, %.preheader55.i
  %i.dp = load ptr, ptr %i.b, align 8, !tbaa !32
  %i.dq = load double, ptr %i.dp, align 8, !tbaa !34
  %i.dr = load double, ptr %2, align 8, !tbaa !34
  %i.ds = fdiv double %i.dr, %i.dq
  store double %i.ds, ptr %2, align 8, !tbaa !34
  ret void
}
...
bb.b:                                             ; preds = %.lr.ph.epil.preheader
  ...
  %i.h = load double, ptr %i.g, align 8, !tbaa !34
  store double %i.h, ptr %i.e, align 8, !tbaa !34
  store double %i.f, ptr %i.g, align 8, !tbaa !34
...
bb.c:                                             ; preds = %.lr.ph
  ...
  %i.n = load double, ptr %i.m, align 8, !tbaa !34
  %i.o = getelementptr inbounds [8 x i8], ptr %3, i64 %i.l ; 2 uses
  %i.p = load double, ptr %i.o, align 8, !tbaa !34
  store double %i.p, ptr %i.m, align 8, !tbaa !34
  store double %i.n, ptr %i.o, align 8, !tbaa !34
  br label %.lr.ph.1
...
bb.d:                                             ; preds = %.lr.ph.1
  ...
  store double %i.w, ptr %i.t, align 8, !tbaa !34
...
bb.e:                                             ; preds = %bb.d, %.lr.ph.1
  ...
  %niter.next.1 = add nuw nsw i64 %niter, 2       ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %.preheader55.unr-lcssa, label %.lr.ph, !llvm.loop !0

.loopexit:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  %exitcond65.not = icmp eq i64 %i.ab, %i.i
  br i1 %exitcond65.not, label %.lr.ph63.preheader, label %.lr.ph58, !llvm.loop !1
...
.lr.ph58:                                         ; preds = %.lr.ph58.preheader, %.loopexit
  ...
  %i.ad = sub i64 %i.i, %.159                     ; 3 uses
  %min.iters.check = icmp ult i64 %i.ad, 4
  br i1 %min.iters.check, label %scalar.ph.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %.lr.ph58
  %i.ae = shl nuw nsw i64 %.159, 3
  %i.af = add nuw i64 %i.ae, 8                    ; 2 uses
  %scevgep = getelementptr i8, ptr %3, i64 %i.af
  %scevgep73 = getelementptr nuw i8, ptr %i.aa, i64 %i.af
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %i.ag = add i64 %i.ab, %n.vec
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.ah = add nuw i64 %i.ab, %index               ; 2 uses
  %i.ai = getelementptr inbounds nuw [8 x i8], ptr %i.aa, i64 %i.ah ; 2 uses
  %i.aj = getelementptr inbounds nuw i8, ptr %i.ai, i64 16
  %wide.load = load <2 x double>, ptr %i.ai, align 8, !tbaa !34, !alias.scope !82
  %wide.load75 = load <2 x double>, ptr %i.aj, align 8, !tbaa !34, !alias.scope !82
  %i.ak = load double, ptr %i.ac, align 8, !tbaa !34, !alias.scope !83
  ...
  %wide.load76 = load <2 x double>, ptr %i.al, align 8, !tbaa !34, !alias.scope !84, !noalias !82
  %wide.load77 = load <2 x double>, ptr %i.am, align 8, !tbaa !34, !alias.scope !84, !noalias !82
  ...
  store <2 x double> %i.ap, ptr %i.al, align 8, !tbaa !34, !alias.scope !84, !noalias !82
  store <2 x double> %i.aq, ptr %i.am, align 8, !tbaa !34, !alias.scope !84, !noalias !82
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ar = icmp eq i64 %index.next, %n.vec
  br i1 %i.ar, label %middle.block, label %vector.body, !llvm.loop !74
...
scalar.ph.preheader:                              ; preds = %vector.memcheck, %.lr.ph58, %middle.block
  %.05057.ph = phi i64 [ %i.ab, %vector.memcheck ], [ %i.ab, %.lr.ph58 ], [ %i.ag, %middle.block ] ; 6 uses
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  %i.bc = getelementptr inbounds nuw [8 x i8], ptr %i.aa, i64 %.05057
  %i.bd = load double, ptr %i.bc, align 8, !tbaa !34
  %i.be = load double, ptr %i.ac, align 8, !tbaa !34
  ...
  store double %i.bi, ptr %i.bf, align 8, !tbaa !34
  %i.bj = add nuw nsw i64 %.05057, 1              ; 2 uses
  %i.bk = getelementptr inbounds nuw [8 x i8], ptr %i.aa, i64 %i.bj
  %i.bl = load double, ptr %i.bk, align 8, !tbaa !34
  %i.bm = load double, ptr %i.ac, align 8, !tbaa !34
  ...
  store double %i.bq, ptr %i.bn, align 8, !tbaa !34
  %i.br = add nuw nsw i64 %.05057, 2              ; 2 uses
  %exitcond64.not.1 = icmp eq i64 %i.br, %1
  br i1 %exitcond64.not.1, label %.loopexit, label %scalar.ph, !llvm.loop !75
...
.lr.ph63:                                         ; preds = %.lr.ph63.preheader, %.loopexit98
  ...
  %i.bt = load ptr, ptr %i.bs, align 8, !tbaa !32 ; 6 uses
  %i.bu = getelementptr inbounds nuw [8 x i8], ptr %i.bt, i64 %.262 ; 2 uses
  %i.bv = load double, ptr %i.bu, align 8, !tbaa !34
  %i.bw = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %.262 ; 7 uses
  %i.bx = load double, ptr %i.bw, align 8, !tbaa !34
  %i.by = fdiv double %i.bx, %i.bv
  store double %i.by, ptr %i.bw, align 8, !tbaa !34
...
vector.body86:                                    ; preds = %vector.body86, %vector.ph84
  ...
  %wide.load88 = load <2 x double>, ptr %i.bz, align 8, !tbaa !34, !alias.scope !85
  %wide.load89 = load <2 x double>, ptr %i.ca, align 8, !tbaa !34, !alias.scope !85
  %i.cb = load double, ptr %i.bw, align 8, !tbaa !34, !alias.scope !86
  ...
  %wide.load90 = load <2 x double>, ptr %i.cc, align 8, !tbaa !34, !alias.scope !87, !noalias !85
  %wide.load91 = load <2 x double>, ptr %i.cd, align 8, !tbaa !34, !alias.scope !87, !noalias !85
  ...
  store <2 x double> %i.cg, ptr %i.cc, align 8, !tbaa !34, !alias.scope !87, !noalias !85
  store <2 x double> %i.ch, ptr %i.cd, align 8, !tbaa !34, !alias.scope !87, !noalias !85
  %index.next94 = add nuw i64 %index87, 4         ; 2 uses
  %i.ci = icmp eq i64 %index.next94, %n.vec85
  br i1 %i.ci, label %middle.block95, label %vector.body86, !llvm.loop !80
...
scalar.ph82:                                      ; preds = %scalar.ph82.prol.loopexit, %scalar.ph82
  ...
  %i.cu = load double, ptr %i.ct, align 8, !tbaa !34
  %i.cv = load double, ptr %i.bw, align 8, !tbaa !34
  %i.cw = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %.15161 ; 2 uses
  %i.cx = load double, ptr %i.cw, align 8, !tbaa !34
  %i.cy = fneg double %i.cu
  %i.cz = tail call double @llvm.fmuladd.f64(double %i.cy, double %i.cv, double %i.cx)
  store double %i.cz, ptr %i.cw, align 8, !tbaa !34
  ...
  %i.dd = load double, ptr %i.bw, align 8, !tbaa !34
...
.preheader:                                       ; preds = %.preheader.preheader, %bb.b
  ...
  %.promoted = load double, ptr %i.f, align 8, !tbaa !34 ; 2 uses
...
.preheader.new:                                   ; preds = %.preheader, %.preheader.new
  ...
  %i.k = load double, ptr %i.j, align 8, !tbaa !34
  ...
  store double %i.o, ptr %i.f, align 8, !tbaa !34
  ...
  store double %i.x, ptr %i.f, align 8, !tbaa !34
  %i.y = add nuw nsw i64 %.041, 2                 ; 2 uses
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %.unr-lcssa, label %.preheader.new, !llvm.loop !3
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x double>, ptr %i.ap, align 8, !tbaa !34
  %i.aq = fdiv <2 x double> %wide.load, %broadcast.splat
  store <2 x double> %i.aq, ptr %i.ap, align 8, !tbaa !34
...
.lr.ph:                                           ; preds = %.lr.ph.preheader56, %.lr.ph
  ...
  br i1 %exitcond49.not, label %._crit_edge, label %.lr.ph, !llvm.loop !91

._crit_edge:                                      ; preds = %.lr.ph, %middle.block
  %i.aw = add nuw nsw i64 %.03344, 1              ; 2 uses
  %exitcond50.not = icmp eq i64 %i.aw, %1
  br i1 %exitcond50.not, label %.loopexit39, label %.lr.ph46, !llvm.loop !5
...
.loopexit.i:                                      ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i, %middle.block
  ...
  br i1 %exitcond64.not.i, label %._crit_edge.i, label %.lr.ph.preheader.i, !llvm.loop !6
...
.lr.ph.preheader.i:                               ; preds = %.lr.ph.preheader.i.preheader, %.loopexit.i
  ...
  store double %i.n, ptr %i.l, align 8, !tbaa !34
  %i.o = add nuw nsw i64 %.053.i, 1               ; 6 uses
  %i.p = sub i64 %i.e, %.053.i                    ; 3 uses
  %min.iters.check = icmp ult i64 %i.p, 4
  br i1 %min.iters.check, label %.lr.ph.i.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %.lr.ph.preheader.i
  %i.q = shl nuw nsw i64 %.053.i, 3
  %i.r = add nuw i64 %i.q, 8                      ; 2 uses
  %scevgep = getelementptr i8, ptr %1, i64 %i.r
  %scevgep5 = getelementptr nuw i8, ptr %i.i, i64 %i.r
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %i.s = add i64 %i.o, %n.vec
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.t = add nuw i64 %i.o, %index                 ; 2 uses
  %i.u = load double, ptr %i.l, align 8, !tbaa !34, !alias.scope !98
  %i.v = getelementptr inbounds nuw [8 x i8], ptr %i.i, i64 %i.t ; 2 uses
  %i.w = getelementptr inbounds nuw i8, ptr %i.v, i64 16
  %wide.load = load <2 x double>, ptr %i.v, align 8, !tbaa !34, !alias.scope !99
  %wide.load7 = load <2 x double>, ptr %i.w, align 8, !tbaa !34, !alias.scope !99
  %i.x = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %i.t ; 3 uses
  %i.y = getelementptr inbounds nuw i8, ptr %i.x, i64 16 ; 2 uses
  %wide.load8 = load <2 x double>, ptr %i.x, align 8, !tbaa !34, !alias.scope !100, !noalias !99
  %wide.load9 = load <2 x double>, ptr %i.y, align 8, !tbaa !34, !alias.scope !100, !noalias !99
  ...
  store <2 x double> %i.ab, ptr %i.x, align 8, !tbaa !34, !alias.scope !100, !noalias !99
  store <2 x double> %i.ac, ptr %i.y, align 8, !tbaa !34, !alias.scope !100, !noalias !99
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ad = icmp eq i64 %index.next, %n.vec
  br i1 %i.ad, label %middle.block, label %vector.body, !llvm.loop !96
...
.lr.ph.i.preheader:                               ; preds = %vector.memcheck, %.lr.ph.preheader.i, %middle.block
  %.04952.i.ph = phi i64 [ %i.o, %vector.memcheck ], [ %i.o, %.lr.ph.preheader.i ], [ %i.s, %middle.block ] ; 6 uses
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  %i.ao = load double, ptr %i.l, align 8, !tbaa !34
  %i.ap = getelementptr inbounds nuw [8 x i8], ptr %i.i, i64 %.04952.i
  %i.aq = load double, ptr %i.ap, align 8, !tbaa !34
  %i.ar = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %.04952.i ; 2 uses
  %i.as = load double, ptr %i.ar, align 8, !tbaa !34
  %i.at = fneg double %i.ao
  %i.au = tail call double @llvm.fmuladd.f64(double %i.at, double %i.aq, double %i.as)
  store double %i.au, ptr %i.ar, align 8, !tbaa !34
  %i.av = add nuw nsw i64 %.04952.i, 1            ; 2 uses
  %i.aw = load double, ptr %i.l, align 8, !tbaa !34
  %i.ax = getelementptr inbounds nuw [8 x i8], ptr %i.i, i64 %i.av
  %i.ay = load double, ptr %i.ax, align 8, !tbaa !34
  ...
  store double %i.bc, ptr %i.az, align 8, !tbaa !34
  %i.bd = add nuw nsw i64 %.04952.i, 2            ; 2 uses
  %exitcond.not.i.1 = icmp eq i64 %i.bd, %i.d
  br i1 %exitcond.not.i.1, label %.loopexit.i, label %.lr.ph.i, !llvm.loop !97
...
._crit_edge.i:                                    ; preds = %.loopexit.i, %bb.a
  ...
  %i.bj = load double, ptr %i.bi, align 8, !tbaa !34
  %i.bk = fdiv double %i.bj, %i.bh                ; 2 uses
  store double %i.bk, ptr %i.bi, align 8, !tbaa !34
  %i.bl = load double, ptr %i.bg, align 8, !tbaa !34
  %i.bm = fdiv double %i.bk, %i.bl
  store double %i.bm, ptr %i.bi, align 8, !tbaa !34
...
.lr.ph62.i:                                       ; preds = %._crit_edge59.i.loopexit, %.lr.ph62.preheader.i
  ...
  %.15060.i = phi i64 [ %i.cp, %._crit_edge59.i.loopexit ], [ %i.bn, %.lr.ph62.preheader.i ] ; 7 uses
  %i.bo = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %.15060.i
  %i.bp = load ptr, ptr %i.bo, align 8, !tbaa !32 ; 4 uses
  %.155.i = add nuw nsw i64 %.15060.i, 1          ; 3 uses
  %i.bq = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %.15060.i ; 5 uses
  %.promoted.i = load double, ptr %i.bq, align 8, !tbaa !34 ; 2 uses
...
.lr.ph58.i.prol:                                  ; preds = %.lr.ph62.i
  %i.bs = getelementptr inbounds nuw [8 x i8], ptr %i.bp, i64 %.155.i
  ...
  store double %i.bx, ptr %i.bq, align 8, !tbaa !34
  %.1.i.prol = add nuw nsw i64 %.15060.i, 2
  br label %.lr.ph58.i.prol.loopexit

.lr.ph58.i.prol.loopexit:                         ; preds = %.lr.ph58.i.prol, %.lr.ph62.i
  %.lcssa.unr = phi double [ poison, %.lr.ph62.i ], [ %i.bx, %.lr.ph58.i.prol ]
  %.unr = phi double [ %.promoted.i, %.lr.ph62.i ], [ %i.bx, %.lr.ph58.i.prol ]
  %.156.i.unr = phi i64 [ %.155.i, %.lr.ph62.i ], [ %.1.i.prol, %.lr.ph58.i.prol ]
  %i.by = icmp eq i64 %indvar, 0
  br i1 %i.by, label %._crit_edge59.i.loopexit, label %.lr.ph58.i
...
.lr.ph58.i:                                       ; preds = %.lr.ph58.i.prol.loopexit, %.lr.ph58.i
  ...
  %i.ca = getelementptr inbounds nuw [8 x i8], ptr %i.bp, i64 %.156.i
  %i.cb = load double, ptr %i.ca, align 8, !tbaa !34
  ...
  store double %i.cf, ptr %i.bq, align 8, !tbaa !34
  %.1.i = add nuw nsw i64 %.156.i, 1              ; 2 uses
  %i.cg = getelementptr inbounds nuw [8 x i8], ptr %i.bp, i64 %.1.i
  %i.ch = load double, ptr %i.cg, align 8, !tbaa !34
  ...
  store double %i.cl, ptr %i.bq, align 8, !tbaa !34
  %.1.i.1 = add nuw nsw i64 %.156.i, 2            ; 2 uses
  %exitcond65.not.i.1 = icmp eq i64 %.1.i.1, %i.d
  br i1 %exitcond65.not.i.1, label %._crit_edge59.i.loopexit, label %.lr.ph58.i, !llvm.loop !7

._crit_edge59.i.loopexit:                         ; preds = %.lr.ph58.i, %.lr.ph58.i.prol.loopexit
  %.lcssa = phi double [ %.lcssa.unr, %.lr.ph58.i.prol.loopexit ], [ %i.cl, %.lr.ph58.i ]
  %i.cm = getelementptr inbounds nuw [8 x i8], ptr %i.bp, i64 %.15060.i
  %i.cn = load double, ptr %i.cm, align 8, !tbaa !34
  %i.co = fdiv double %.lcssa, %i.cn
  store double %i.co, ptr %i.bq, align 8, !tbaa !34
  %i.cp = add nsw i64 %.15060.i, -1
  %i.cq = icmp sgt i64 %.15060.i, 0
  %indvar.next = add i64 %indvar, 1
  br i1 %i.cq, label %.lr.ph62.i, label %densePOTRS.exit, !llvm.loop !8
...
.loopexit:                                        ; preds = %.lr.ph.prol.loopexit, %.lr.ph, %middle.block
  ...
  br i1 %exitcond64.not, label %._crit_edge, label %.lr.ph.preheader, !llvm.loop !6
