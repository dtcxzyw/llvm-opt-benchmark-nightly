...
.noexc102:                                        ; preds = %_ZNSt6vectorIxSaIxEEC2EmRKS0_.exit94.thread
  store ptr %i.dj, ptr %18, align 8, !tbaa !36
  %i.dk = getelementptr inbounds nuw [8 x i8], ptr %i.dj, i64 %i.dh
  %i.dl = getelementptr inbounds nuw i8, ptr %18, i64 16 ; 3 uses
  store ptr %i.dk, ptr %i.dl, align 8, !tbaa !37
  store i64 0, ptr %i.dj, align 8, !tbaa !39
  %i.dm = getelementptr i8, ptr %i.dj, i64 8      ; 3 uses
...
_ZSt6fill_nIPxmxET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i97: ; preds = %.noexc102
  ...
  call void @llvm.memset.p0.i64(ptr align 8 %i.dm, i8 0, i64 %.idx.i.i.i.i.i.i.i98, i1 false), !tbaa !39
  %i.dn = getelementptr inbounds nuw i8, ptr %i.dm, i64 %.idx.i.i.i.i.i.i.i98
  br label %bb.ad

bb.ad:                                            ; preds = %_ZSt6fill_nIPxmxET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i97, %.noexc102
  %i.do = phi ptr [ %i.dn, %_ZSt6fill_nIPxmxET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i97 ], [ %i.dm, %.noexc102 ] ; 2 uses
  %i.dp = getelementptr inbounds nuw i8, ptr %18, i64 8 ; 2 uses
  store ptr %i.do, ptr %i.dp, align 8, !tbaa !40
  %i.dq = invoke noundef ptr @_ZNK6casadi13GenericSharedINS_12SharedObjectENS_20SharedObjectInternalEEptEv(ptr noundef nonnull align 8 dereferenceable(8) %1)
...
bb.ae:                                            ; preds = %bb.ad
  ...
  %i.dt = icmp eq ptr %i.dj, %i.do
  %spec.select.i105 = select i1 %i.dt, ptr null, ptr %i.dj
  invoke void @_ZN6casadi16SparsityInternal10ldl_colindEPKxPxS3_S3_(ptr noundef nonnull %i.ds, ptr noundef %.sroa.0144.0177, ptr noundef %spec.select.i105, ptr noundef %.sroa.0151.0227)
          to label %bb.af unwind label %bb.as

bb.af:                                            ; preds = %bb.ae
  call void @llvm.lifetime.start.p0(ptr nonnull %19) #28
  %i.du = load ptr, ptr %i.dp, align 8, !tbaa !46 ; 2 uses
  %i.dv = getelementptr inbounds i8, ptr %i.du, i64 -8
  %i.dw = load i64, ptr %i.dv, align 8, !tbaa !39 ; 5 uses
  %i.dx = icmp ugt i64 %i.dw, 1152921504606846975
  br i1 %i.dx, label %bb.ag, label %_ZNSt6vectorIxSaIxEE17_S_check_init_lenEmRKS0_.exit.i107
...
_ZNSt6vectorIxSaIxEE17_S_check_init_lenEmRKS0_.exit.i107: ; preds = %bb.af
  %.not.i.i.i.i108 = icmp eq i64 %i.dw, 0
...
bb.ah:                                            ; preds = %_ZNSt6vectorIxSaIxEE17_S_check_init_lenEmRKS0_.exit.i107
  ...
  %i.dz = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.dy) #32
          to label %.noexc114 unwind label %bb.at ; 6 uses

.noexc114:                                        ; preds = %bb.ah
  store ptr %i.dz, ptr %19, align 8, !tbaa !36
  %i.ea = getelementptr inbounds nuw [8 x i8], ptr %i.dz, i64 %i.dw
  %i.eb = getelementptr inbounds nuw i8, ptr %19, i64 16
  store ptr %i.ea, ptr %i.eb, align 8, !tbaa !37
  store i64 0, ptr %i.dz, align 8, !tbaa !39
  %i.ec = getelementptr i8, ptr %i.dz, i64 8      ; 3 uses
  %i.ed = add nsw i64 %i.dw, -1                   ; 2 uses
  %i.ee = icmp eq i64 %i.ed, 0
  br i1 %i.ee, label %bb.ai, label %_ZSt6fill_nIPxmxET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i109

_ZSt6fill_nIPxmxET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i109: ; preds = %.noexc114
  %.idx.i.i.i.i.i.i.i110 = shl nuw nsw i64 %i.ed, 3 ; 2 uses
  call void @llvm.memset.p0.i64(ptr align 8 %i.ec, i8 0, i64 %.idx.i.i.i.i.i.i.i110, i1 false), !tbaa !39
  %i.ef = getelementptr inbounds nuw i8, ptr %i.ec, i64 %.idx.i.i.i.i.i.i.i110
  br label %bb.ai
...
bb.ai:                                            ; preds = %_ZSt6fill_nIPxmxET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i109, %.noexc114, %_ZNSt12_Vector_baseIxSaIxEEC2EmRKS0_.exit.thread.i112
  %i.eg = phi ptr [ null, %_ZNSt12_Vector_baseIxSaIxEEC2EmRKS0_.exit.thread.i112 ], [ %i.dz, %.noexc114 ], [ %i.dz, %_ZSt6fill_nIPxmxET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i109 ] ; 2 uses
  %i.eh = phi ptr [ null, %_ZNSt12_Vector_baseIxSaIxEEC2EmRKS0_.exit.thread.i112 ], [ %i.ec, %.noexc114 ], [ %i.ef, %_ZSt6fill_nIPxmxET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i109 ] ; 2 uses
  %i.ei = getelementptr inbounds nuw i8, ptr %19, i64 8
  store ptr %i.eh, ptr %i.ei, align 8, !tbaa !40
  %i.ej = invoke noundef ptr @_ZNK6casadi13GenericSharedINS_12SharedObjectENS_20SharedObjectInternalEEptEv(ptr noundef nonnull align 8 dereferenceable(8) %1)
...
bb.aj:                                            ; preds = %bb.ai
  ...
  %i.en = icmp eq ptr %i.em, %i.du
  %spec.select.i119 = select i1 %i.en, ptr null, ptr %i.em
  %i.eo = icmp eq ptr %i.eg, %i.eh
  %spec.select.i120 = select i1 %i.eo, ptr null, ptr %i.eg
  invoke void @_ZN6casadi16SparsityInternal7ldl_rowEPKxS2_PxS3_S3_(ptr noundef nonnull %i.el, ptr noundef %.sroa.0144.0177, ptr noundef %spec.select.i119, ptr noundef %spec.select.i120, ptr noundef %.sroa.0151.0227)
...
bb.al:                                            ; preds = %bb.ak
  %i.ep = invoke noundef ptr @_ZNK6casadi13GenericSharedINS_12SharedObjectENS_20SharedObjectInternalEEptEv(ptr noundef nonnull align 8 dereferenceable(8) %20)
          to label %.noexc122 unwind label %bb.aw

.noexc122:                                        ; preds = %bb.al
  invoke void @_ZNK6casadi16SparsityInternal1TEv(ptr dead_on_unwind writable sret(%"class.casadi::Sparsity") align 8 %0, ptr noundef nonnull align 8 dereferenceable(56) %i.ep)
...
bb.am:                                            ; preds = %_ZNK6casadi8Sparsity1TEv.exit
  ...
  call void @__clang_call_terminate(ptr %i.er) #31
  unreachable
...
_ZN6casadi13GenericSharedINS_12SharedObjectENS_20SharedObjectInternalEED2Ev.exit124: ; preds = %_ZNK6casadi8Sparsity1TEv.exit
  ...
  %i.es = load ptr, ptr %19, align 8, !tbaa !36   ; 3 uses
  %.not.i.i.i125 = icmp eq ptr %i.es, null
...
bb.an:                                            ; preds = %_ZN6casadi13GenericSharedINS_12SharedObjectENS_20SharedObjectInternalEED2Ev.exit124
  %i.et = getelementptr inbounds nuw i8, ptr %19, i64 16
  %i.eu = load ptr, ptr %i.et, align 8, !tbaa !37
  %i.ev = ptrtoint ptr %i.eu to i64
  %i.ew = ptrtoint ptr %i.es to i64
  %i.ex = sub i64 %i.ev, %i.ew
  call void @_ZdlPvm(ptr noundef nonnull %i.es, i64 noundef %i.ex) #30
...
bb.ap:                                            ; preds = %_ZNSt6vectorIxSaIxEED2Ev.exit128
  %i.fd = ptrtoint ptr %.sroa.13.0180 to i64
  %i.fe = ptrtoint ptr %.sroa.0144.0177 to i64
  %i.ff = sub i64 %i.fd, %i.fe
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0144.0177, i64 noundef %i.ff) #30
...
bb.ax:                                            ; preds = %bb.aw
  ...
  call void @__clang_call_terminate(ptr %i.fq) #31
  unreachable

_ZN6casadi13GenericSharedINS_12SharedObjectENS_20SharedObjectInternalEED2Ev.exit133: ; preds = %bb.aw, %bb.av
  %.pn45 = phi { ptr, i32 } [ %i.fn, %bb.av ], [ %i.fo, %bb.aw ]
  call void @llvm.lifetime.end.p0(ptr nonnull %20) #28
  br label %bb.ay

bb.ay:                                            ; preds = %_ZN6casadi13GenericSharedINS_12SharedObjectENS_20SharedObjectInternalEED2Ev.exit133, %bb.au
  %.pn45.pn = phi { ptr, i32 } [ %.pn45, %_ZN6casadi13GenericSharedINS_12SharedObjectENS_20SharedObjectInternalEED2Ev.exit133 ], [ %i.fm, %bb.au ] ; 2 uses
  %i.fr = load ptr, ptr %19, align 8, !tbaa !36   ; 3 uses
  %.not.i.i.i134 = icmp eq ptr %i.fr, null
  br i1 %.not.i.i.i134, label %_ZNSt6vectorIxSaIxEED2Ev.exit135, label %bb.az

bb.az:                                            ; preds = %bb.ay
  %i.fs = getelementptr inbounds nuw i8, ptr %19, i64 16
  %i.ft = load ptr, ptr %i.fs, align 8, !tbaa !37
  %i.fu = ptrtoint ptr %i.ft to i64
  %i.fv = ptrtoint ptr %i.fr to i64
  %i.fw = sub i64 %i.fu, %i.fv
  call void @_ZdlPvm(ptr noundef nonnull %i.fr, i64 noundef %i.fw) #30
  br label %_ZNSt6vectorIxSaIxEED2Ev.exit135

_ZNSt6vectorIxSaIxEED2Ev.exit135:                 ; preds = %bb.az, %bb.ay, %bb.at
  %.pn45.pn.pn = phi { ptr, i32 } [ %i.fl, %bb.at ], [ %.pn45.pn, %bb.ay ], [ %.pn45.pn, %bb.az ]
  call void @llvm.lifetime.end.p0(ptr nonnull %19) #28
  br label %bb.ba

bb.ba:                                            ; preds = %_ZNSt6vectorIxSaIxEED2Ev.exit135, %bb.as
  %.pn45.pn.pn.pn = phi { ptr, i32 } [ %.pn45.pn.pn, %_ZNSt6vectorIxSaIxEED2Ev.exit135 ], [ %i.fk, %bb.as ] ; 2 uses
  %i.fx = load ptr, ptr %18, align 8, !tbaa !36   ; 3 uses
  %.not.i.i.i136 = icmp eq ptr %i.fx, null
  br i1 %.not.i.i.i136, label %_ZNSt6vectorIxSaIxEED2Ev.exit137, label %bb.bb

bb.bb:                                            ; preds = %bb.ba
  %i.fy = load ptr, ptr %i.dl, align 8, !tbaa !37
  %i.fz = ptrtoint ptr %i.fy to i64
  %i.ga = ptrtoint ptr %i.fx to i64
  %i.gb = sub i64 %i.fz, %i.ga
  call void @_ZdlPvm(ptr noundef nonnull %i.fx, i64 noundef %i.gb) #30
  br label %_ZNSt6vectorIxSaIxEED2Ev.exit137

_ZNSt6vectorIxSaIxEED2Ev.exit137:                 ; preds = %bb.bb, %bb.ba, %bb.ar
  %.pn45.pn.pn.pn.pn = phi { ptr, i32 } [ %i.fj, %bb.ar ], [ %.pn45.pn.pn.pn, %bb.ba ], [ %.pn45.pn.pn.pn, %bb.bb ] ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %18) #28
...
bb.bc:                                            ; preds = %_ZNSt6vectorIxSaIxEED2Ev.exit137
  %i.gc = ptrtoint ptr %.sroa.13.0180 to i64
  %i.gd = ptrtoint ptr %.sroa.0144.0177 to i64
  %i.ge = sub i64 %i.gc, %i.gd
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0144.0177, i64 noundef %i.ge) #30
