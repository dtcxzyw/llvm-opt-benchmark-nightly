...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x double>, ptr %i.l, align 8, !tbaa !26, !noalias !530
  %wide.load3 = load <2 x double>, ptr %i.m, align 8, !tbaa !26, !noalias !530
  %2 = freeze <2 x double> %wide.load             ; 2 uses
  %3 = freeze <2 x double> %wide.load3            ; 2 uses
  %i.n = tail call nsz <2 x double> @llvm.minnum.v2f64(<2 x double> %vec.phi, <2 x double> %2) ; 2 uses
  %i.o = tail call nsz <2 x double> @llvm.minnum.v2f64(<2 x double> %vec.phi2, <2 x double> %3) ; 2 uses
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.p = fcmp uno <2 x double> %2, %3
  %i.q = bitcast <2 x i1> %i.p to i2
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.l = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %index ; 2 uses
  %i.m = getelementptr inbounds nuw i8, ptr %i.l, i64 16
  %wide.load = load <2 x double>, ptr %i.l, align 8, !tbaa !26, !noalias !535
  %wide.load3 = load <2 x double>, ptr %i.m, align 8, !tbaa !26, !noalias !535
  %2 = freeze <2 x double> %wide.load             ; 2 uses
  %3 = freeze <2 x double> %wide.load3            ; 2 uses
  %i.n = tail call nsz <2 x double> @llvm.maxnum.v2f64(<2 x double> %vec.phi, <2 x double> %2) ; 2 uses
  %i.o = tail call nsz <2 x double> @llvm.maxnum.v2f64(<2 x double> %vec.phi2, <2 x double> %3) ; 2 uses
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.p = fcmp uno <2 x double> %2, %3
  %i.q = bitcast <2 x i1> %i.p to i2
  %i.r = icmp ne i2 %i.q, 0                       ; 5 uses
