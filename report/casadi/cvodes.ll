...
.preheader335.i.i:                                ; preds = %.preheader.i.i303, %.preheader336.i.i
  ...
  %.0298376.i.i = phi double [ %i.cyv, %.preheader336.i.i ], [ %i.dfu, %.preheader.i.i303 ] ; 5 uses
  ...
  %1 = fmul double %.0298376.i.i, %.0298376.i.i   ; 2 uses
  %2 = fmul double %.0298376.i.i, 4.000000e+00    ; 2 uses
  %i.dbt = fneg <2 x double> %i.dbs
  %i.dbu = fmul double %i.czv, %2
  %3 = fneg double %.sroa.10.0.i.i
  %4 = insertelement <2 x double> poison, double %2, i64 0
  %5 = shufflevector <2 x double> %4, <2 x double> poison, <2 x i32> zeroinitializer
  %i.dbv = fmul <2 x double> %i.czg, %5
  ...
  %i.dbx = shufflevector <2 x double> %6, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %7 = insertelement <2 x double> poison, double %.0298376.i.i, i64 0
  %8 = shufflevector <2 x double> %7, <2 x double> poison, <2 x i32> zeroinitializer
  %i.dci = fadd <2 x double> %8, %i.dch           ; 10 uses
  ...
  %i.dcw = tail call double @llvm.fmuladd.f64(double %1, double %i.dcv, double %i.czr) ; 2 uses
  ...
  %i.ddb = insertelement <2 x double> poison, double %3, i64 0
