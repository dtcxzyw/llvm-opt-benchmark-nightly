...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit106: ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit106.preheader, %_ZStlsIcSt11char_traitsIcESaIcEERSt13basic_ostreamIT_T0_ES7_RKNSt7__cxx1112basic_stringIS4_S5_T1_EE.exit
  %.077 = phi i64 [ %i.t, %_ZStlsIcSt11char_traitsIcESaIcEERSt13basic_ostreamIT_T0_ES7_RKNSt7__cxx1112basic_stringIS4_S5_T1_EE.exit ], [ 0, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit106.preheader ] ; 3 uses
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit: ; preds = %bb.e
  %i.t = add nuw nsw i64 %.077, 1                 ; 2 uses
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit105: ; preds = %_ZNSolsEx.exit
  ...
  %i.x = getelementptr inbounds nuw [32 x i8], ptr %i.w, i64 %.077 ; 2 uses
...
bb.j:                                             ; preds = %bb.i
  ...
  %.088.shrunk = select i1 %3, i1 %i.ai, i1 false ; 2 uses
  %i.aj = icmp samesign ugt i64 %i.q, 6
  %i.ak = and i1 %i.aj, %.088.shrunk
  %i.al = icmp sgt i64 %i.ae, 6
  %i.am = and i1 %i.al, %.088.shrunk
...
bb.r:                                             ; preds = %.lr.ph214, %_ZNSolsEPFRSoS_E.exit128
  %.076213 = phi i64 [ 0, %.lr.ph214 ], [ %i.gk, %_ZNSolsEPFRSoS_E.exit128 ] ; 8 uses
  %i.bm = icmp samesign ult i64 %.076213, 3
  %or.cond = select i1 %not., i1 true, i1 %i.bm
  %i.bn = icmp sge i64 %.076213, %i.bb
  %i.bo = select i1 %or.cond, i1 true, i1 %i.bn   ; 4 uses
  %i.bp = icmp eq i64 %.076213, 0
...
.lr.ph:                                           ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit124.peel, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit124
  %.075212 = phi i64 [ %i.dp, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit124 ], [ 1, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit124.peel ] ; 5 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #28
  %i.dn = getelementptr inbounds nuw [8 x i8], ptr %.sroa.0183.0, i64 %.075212 ; 2 uses
  %i.do = load i64, ptr %i.dn, align 8, !tbaa !8  ; 6 uses
  %i.dp = add nuw nsw i64 %.075212, 1             ; 3 uses
...
bb.ah:                                            ; preds = %.critedge
  %i.ep = icmp samesign ult i64 %.075212, 3
  %or.cond3 = select i1 %not.91, i1 true, i1 %i.ep
  %i.eq = icmp sge i64 %.075212, %i.bg
