...
._crit_edge.i:                                    ; preds = %.lr.ph.i.epil.preheader, %._crit_edge.i.loopexit.unr-lcssa, %bb.l
  ...
  %i.gs = shufflevector <2 x double> %i.fh, <2 x double> poison, <2 x i32> zeroinitializer ; 5 uses
  ...
  %i.hc = shufflevector <2 x double> %i.fh, <2 x double> poison, <2 x i32> <i32 1, i32 1>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.hv = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.gs, <2 x double> %wide.load, <2 x double> %i.hu)
  ...
  %i.hy = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.gs, <2 x double> %wide.load193, <2 x double> %i.hx)
...
.lr.ph84.i.preheader:                             ; preds = %vector.memcheck, %.lr.ph84.preheader.i, %middle.block
  ...
  %10 = shufflevector <2 x double> %i.fh, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  br label %.lr.ph84.i
