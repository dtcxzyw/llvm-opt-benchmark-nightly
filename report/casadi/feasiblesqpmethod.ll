...
bb.w:                                             ; preds = %bb.v, %bb.u
  ...
  %5 = fsub nsz double %i.pw, %i.qc
  %6 = call nsz double @llvm.maxnum.f64(double %5, double 0.000000e+00)
  %7 = call nsz double @llvm.maxnum.f64(double %.01924.i, double %6)
  %8 = fsub nsz double %i.pz, %i.pw
  %i.qd = call nsz double @llvm.maxnum.f64(double %8, double 0.000000e+00)
  %i.qe = call nsz double @llvm.maxnum.f64(double %7, double %i.qd) ; 2 uses
...
bb.bx:                                            ; preds = %bb.bw, %bb.bv
  ...
  %9 = fsub nsz double %i.bla, %i.blg
  %10 = call nsz double @llvm.maxnum.f64(double %9, double 0.000000e+00)
  %11 = call nsz double @llvm.maxnum.f64(double %.01924.i489, double %10)
  %12 = fsub nsz double %i.bld, %i.bla
  %i.blh = call nsz double @llvm.maxnum.f64(double %12, double 0.000000e+00)
  %i.bli = call nsz double @llvm.maxnum.f64(double %11, double %i.blh) ; 2 uses
...
bb.bp:                                            ; preds = %bb.bo, %bb.bn
  ...
  %25 = fsub nsz double %i.pw, %i.qc
  %26 = call nsz double @llvm.maxnum.f64(double %25, double 0.000000e+00)
  %27 = call nsz double @llvm.maxnum.f64(double %.01924.i, double %26)
  %28 = fsub nsz double %i.pz, %i.pw
  %i.qd = call nsz double @llvm.maxnum.f64(double %28, double 0.000000e+00)
  %i.qe = call nsz double @llvm.maxnum.f64(double %27, double %i.qd) ; 2 uses
  %i.qf = add nuw nsw i64 %.02023.i, 1            ; 2 uses
...
bb.dw:                                            ; preds = %bb.dv, %bb.du
  ...
  %29 = fsub nsz double %i.adm, %i.ads
  %30 = call nsz double @llvm.maxnum.f64(double %29, double 0.000000e+00)
  %31 = call nsz double @llvm.maxnum.f64(double %.01924.i549, double %30)
  %32 = fsub nsz double %i.adp, %i.adm
  %i.adt = call nsz double @llvm.maxnum.f64(double %32, double 0.000000e+00)
  %i.adu = call nsz double @llvm.maxnum.f64(double %31, double %i.adt) ; 2 uses
...
_ZN6casadi11casadi_copyIdEEvPKT_xPS1_.exit301:    ; preds = %.lr.ph.i294.prol.loopexit, %.lr.ph.i294, %middle.block597, %_ZN6casadi15casadi_mv_denseIdEEvPKT_xxS3_PS1_x.exit, %.preheader35.i, %.preheader37.i, %_ZN6casadi12casadi_clearIdEEvPT_x.exit279, %_ZN6casadi13casadi_norm_2IdEET_xPKS1_.exit, %._crit_edge424, %.loopexit408
  ...
  %6 = insertelement <2 x double> poison, double %i.gv, i64 0
...
.loopexit:                                        ; preds = %scalar.ph655, %middle.block667, %_ZN6casadi15casadi_mv_denseIdEEvPKT_xxS3_PS1_x.exit325, %_ZN6casadi13casadi_norm_2IdEET_xPKS1_.exit363, %_ZN6casadi13casadi_norm_2IdEET_xPKS1_.exit332
  ...
  %.1239 = phi double [ %.0238, %_ZN6casadi13casadi_norm_2IdEET_xPKS1_.exit332 ], [ %sqrt, %_ZN6casadi13casadi_norm_2IdEET_xPKS1_.exit363 ], [ %.0238, %_ZN6casadi15casadi_mv_denseIdEEvPKT_xxS3_PS1_x.exit325 ], [ %sqrt, %middle.block667 ], [ %sqrt, %scalar.ph655 ] ; 4 uses
...
_ZN6casadi13casadi_norm_2IdEET_xPKS1_.exit370:    ; preds = %_ZN6casadi13casadi_norm_2IdEET_xPKS1_.exit370.loopexit.unr-lcssa, %.lr.ph.i.i365.epil, %_ZN6casadi27casadi_dense_lsqr_sym_orthoIdEEvT_S1_PS1_S2_S2_.exit
  ...
  %8 = fmul double %.sink.i, %i.sj                ; 3 uses
  %i.so = fdiv double %i.sn, %8
  %i.sp = insertelement <2 x double> poison, double %i.so, i64 0
  %i.sq = insertelement <2 x double> %i.sp, double %8, i64 1 ; 2 uses
  ...
  %i.sv = tail call double @sqrt(double noundef %i.su) #29
  ...
  %9 = insertelement <2 x double> poison, double %.1239, i64 0
  %10 = shufflevector <2 x double> %9, <2 x double> poison, <2 x i32> zeroinitializer
  %11 = fmul <2 x double> %10, <double 1.000000e+00, double 1.000000e-15>
  %12 = insertelement <2 x double> poison, double %i.sv, i64 0
  %13 = shufflevector <2 x double> %12, <2 x double> poison, <2 x i32> zeroinitializer
  %14 = fmul <2 x double> %11, %13
  %15 = fdiv <2 x double> %14, %7                 ; 2 uses
  %16 = extractelement <2 x double> %15, i64 1
  %i.ts = fadd double %16, 1.000000e-15
  ...
  %i.tz = fadd double %17, 1.000000e+00
