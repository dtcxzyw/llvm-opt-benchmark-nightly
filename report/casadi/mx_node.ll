...
bb.a:
  ...
  %i.f = load ptr, ptr %2, align 8, !tbaa !266    ; 4 uses
...
.lr.ph39.split:                                   ; preds = %.lr.ph39
  ...
  %i.ah = load i64, ptr %i.ag, align 8, !tbaa !319
  br label %.lr.ph
...
bb.j:                                             ; preds = %bb.i
  %i.ap = load double, ptr %.134, align 8, !tbaa !167
...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  %5 = icmp slt i64 %i.as, %i.ae
  br i1 %5, label %bb.i, label %._crit_edge, !llvm.loop !1979
}
...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  %5 = icmp slt i64 %i.au, %i.ae
  br i1 %5, label %bb.i, label %._crit_edge, !llvm.loop !2031
}
