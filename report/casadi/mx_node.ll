...
bb.a:
  ...
  %i.f = load ptr, ptr %2, align 8, !tbaa !267    ; 4 uses
...
.lr.ph39.split:                                   ; preds = %.lr.ph39
  ...
  %i.ah = load i64, ptr %i.ag, align 8, !tbaa !320
  br label %.lr.ph
...
bb.j:                                             ; preds = %bb.i
  %i.ap = load double, ptr %.134, align 8, !tbaa !168
...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  br i1 %5, label %bb.i, label %._crit_edge, !llvm.loop !1974
}
...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  br i1 %5, label %bb.i, label %._crit_edge, !llvm.loop !2025
}
