...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x double>, ptr %next.gep, align 8, !tbaa !145, !alias.scope !953, !noalias !954 ; 2 uses
  %i.hv = getelementptr inbounds [8 x i8], ptr %next.gep, i64 %0 ; 2 uses
  %wide.load193 = load <2 x double>, ptr %i.hv, align 8, !tbaa !145, !alias.scope !954 ; 2 uses
  ...
  store <2 x double> %i.hx, ptr %next.gep, align 8, !tbaa !145, !alias.scope !953, !noalias !954
  ...
  store <2 x double> %i.ia, ptr %i.hv, align 8, !tbaa !145, !alias.scope !954
...
bb.m:                                             ; preds = %.lr.ph164, %_ZN6casadi22casadi_cvx_house_applyIdEEvxxxPT_S2_PKS1_S1_.exit
  ...
  %i.jw = load double, ptr %i.js, align 8, !tbaa !145 ; 4 uses
...
vector.ph210:                                     ; preds = %.lr.ph.us53.i
  %i.lj = load double, ptr %i.lf, align 8, !tbaa !145, !alias.scope !955
...
vector.body212:                                   ; preds = %vector.body212, %vector.ph210
  ...
  %wide.load214.a = load <2 x double>, ptr %i.ll, align 8, !tbaa !145, !alias.scope !956
  %wide.load215 = load <2 x double>, ptr %i.lm, align 8, !tbaa !145, !alias.scope !956
  ...
  %wide.load216 = load <2 x double>, ptr %i.ln, align 8, !tbaa !145, !alias.scope !957, !noalias !958
  %wide.load217 = load <2 x double>, ptr %i.lo, align 8, !tbaa !145, !alias.scope !957, !noalias !958
  ...
  store <2 x double> %i.lr, ptr %i.ln, align 8, !tbaa !145, !alias.scope !957, !noalias !958
  store <2 x double> %i.ls, ptr %i.lo, align 8, !tbaa !145, !alias.scope !957, !noalias !958
...
scalar.ph208:                                     ; preds = %scalar.ph208.prol.loopexit, %scalar.ph208
  ...
  br i1 %exitcond60.not.i.1, label %.lr.ph51.split.i.epil, label %scalar.ph208, !llvm.loop !950
...
.lr.ph51.split.i.epil:                            ; preds = %scalar.ph208.prol.loopexit, %scalar.ph208, %middle.block221
  ...
  br i1 %epil.iter258.cmp.not, label %_ZN6casadi22casadi_cvx_house_applyIdEEvxxxPT_S2_PKS1_S1_.exit, label %.lr.ph.us53.i, !llvm.loop !951
...
_ZN6casadi22casadi_cvx_house_applyIdEEvxxxPT_S2_PKS1_S1_.exit: ; preds = %.lr.ph51.split.i.epil
  ...
  br i1 %i.mv, label %bb.m, label %.loopexit, !llvm.loop !952
...
vector.body35:                                    ; preds = %vector.body35, %vector.ph33
  ...
  %wide.load38 = load <2 x double>, ptr %next.gep37, align 8, !tbaa !145, !alias.scope !970
  %wide.load39 = load <2 x double>, ptr %i.ae, align 8, !tbaa !145, !alias.scope !970
  %i.af = getelementptr i8, ptr %next.gep, i64 16
  store <2 x double> %wide.load38, ptr %next.gep, align 8, !tbaa !145, !alias.scope !971, !noalias !970
  store <2 x double> %wide.load39, ptr %i.af, align 8, !tbaa !145, !alias.scope !971, !noalias !970
  %index.next40 = add nuw i64 %index36, 4         ; 2 uses
  %i.ag = icmp eq i64 %index.next40, %n.vec34
  br i1 %i.ag, label %middle.block41, label %vector.body35, !llvm.loop !962
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader47, %.lr.ph.i.prol
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.prol.loopexit, label %.lr.ph.i.prol, !llvm.loop !963
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  br i1 %exitcond.not.i.7, label %.lr.ph.i25.preheader, label %.lr.ph.i, !llvm.loop !964

.lr.ph.i25.preheader:                             ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i, %middle.block41, %bb.b
  %4 = load double, ptr %i.z, align 8, !tbaa !145 ; 6 uses
...
.lr.ph.i25:                                       ; preds = %.lr.ph.i25, %.lr.ph.i25.preheader.new
  ...
  br i1 %niter.ncmp.3, label %._crit_edge.i.loopexit.unr-lcssa, label %.lr.ph.i25, !llvm.loop !965
...
.lr.ph.i25.epil:                                  ; preds = %.lr.ph.i25.epil, %.lr.ph.i25.epil.preheader
  ...
  br i1 %epil.iter.cmp.not, label %._crit_edge.i, label %.lr.ph.i25.epil, !llvm.loop !966
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.db, label %middle.block, label %vector.body, !llvm.loop !967
...
.lr.ph44.i:                                       ; preds = %.lr.ph44.i.preheader46, %.lr.ph44.i
  ...
  br i1 %exitcond45.not.i, label %_ZN6casadi16casadi_cvx_houseIdEET_PS1_S2_x.exit, label %.lr.ph44.i, !llvm.loop !968
...
_ZN6casadi16casadi_cvx_houseIdEET_PS1_S2_x.exit:  ; preds = %.lr.ph44.i, %middle.block, %bb.c
  ...
  br i1 %exitcond.not, label %._crit_edge, label %bb.b, !llvm.loop !969
...
vector.body:                                      ; preds = %.lr.ph.preheader, %pred.store.continue108
  ...
  %wide.load = load <2 x double>, ptr %i.g, align 8, !tbaa !145, !alias.scope !978, !noalias !979
  %i.h = tail call <2 x double> @llvm.fabs.v2f64(<2 x double> %wide.load)
  %i.i = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %index
  %wide.load105 = load <2 x double>, ptr %i.i, align 8, !tbaa !145, !alias.scope !979
  ...
  %wide.load106 = load <2 x double>, ptr %i.l, align 8, !tbaa !145, !alias.scope !979
...
pred.store.if:                                    ; preds = %vector.body
  store double 0.000000e+00, ptr %i.g, align 8, !tbaa !145, !alias.scope !978, !noalias !979
...
pred.store.if107:                                 ; preds = %pred.store.continue
  ...
  store double 0.000000e+00, ptr %i.t, align 8, !tbaa !145, !alias.scope !978, !noalias !979
  br label %pred.store.continue108

pred.store.continue108:                           ; preds = %pred.store.if107, %pred.store.continue
  %index.next = add nuw i64 %index, 2             ; 2 uses
  %i.u = icmp eq i64 %index.next, %n.vec
  br i1 %i.u, label %middle.block, label %vector.body, !llvm.loop !975
...
bb.c:                                             ; preds = %.lr.ph, %bb.b
  ...
  br i1 %exitcond.not, label %.lr.ph84.preheader, label %.lr.ph, !llvm.loop !976
...
.lr.ph84:                                         ; preds = %.lr.ph84.preheader, %.lr.ph84
  ...
  br i1 %exitcond96.not, label %._crit_edge, label %.lr.ph84, !llvm.loop !977
...
._crit_edge:                                      ; preds = %.lr.ph, %.lr.ph88
  ...
  br i1 %exitcond101.not, label %._crit_edge89, label %.lr.ph88, !llvm.loop !981
...
.lr.ph.i.epil:                                    ; preds = %.lr.ph.i.epil, %.lr.ph.i.epil.preheader
  ...
  br i1 %epil.iter.cmp.not, label %_ZN6casadi10casadi_dotIdEET_xPKS1_S3_.exit, label %.lr.ph.i.epil, !llvm.loop !982
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x double>, ptr %next.gep112, align 8, !tbaa !145, !alias.scope !997
  %wide.load113 = load <2 x double>, ptr %i.bw, align 8, !tbaa !145, !alias.scope !997
  %i.bx = getelementptr i8, ptr %next.gep, i64 16 ; 2 uses
  %wide.load114 = load <2 x double>, ptr %next.gep, align 8, !tbaa !145, !alias.scope !998, !noalias !997
  %wide.load115 = load <2 x double>, ptr %i.bx, align 8, !tbaa !145, !alias.scope !998, !noalias !997
  ...
  store <2 x double> %i.by, ptr %next.gep, align 8, !tbaa !145, !alias.scope !998, !noalias !997
  store <2 x double> %i.bz, ptr %i.bx, align 8, !tbaa !145, !alias.scope !998, !noalias !997
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ca = icmp eq i64 %index.next, %n.vec
  br i1 %i.ca, label %middle.block, label %vector.body, !llvm.loop !986
...
.lr.ph.i78:                                       ; preds = %.lr.ph.i78.preheader162, %.lr.ph.i78
  ...
  br i1 %exitcond.not.i79, label %.lr.ph99.preheader, label %.lr.ph.i78, !llvm.loop !987
...
vector.ph141:                                     ; preds = %vector.memcheck118
  ...
  %i.de = load double, ptr %i.cs, align 8, !tbaa !145, !alias.scope !999
  ...
  %i.df = load double, ptr %i.cu, align 8, !tbaa !145, !alias.scope !1000
...
vector.body143:                                   ; preds = %vector.body143, %vector.ph141
  ...
  %wide.load146 = load <2 x double>, ptr %i.dj, align 8, !tbaa !145, !alias.scope !1001
  %wide.load147 = load <2 x double>, ptr %i.dk, align 8, !tbaa !145, !alias.scope !1001
  %i.dl = getelementptr inbounds nuw [8 x i8], ptr %4, i64 %i.dh ; 2 uses
  %i.dm = getelementptr inbounds nuw i8, ptr %i.dl, i64 16
  %wide.load148 = load <2 x double>, ptr %i.dl, align 8, !tbaa !145, !alias.scope !1002
  %wide.load149 = load <2 x double>, ptr %i.dm, align 8, !tbaa !145, !alias.scope !1002
  ...
  %wide.load154 = load <2 x double>, ptr %i.di, align 8, !tbaa !145, !alias.scope !1003, !noalias !1004
  %wide.load155 = load <2 x double>, ptr %i.dr, align 8, !tbaa !145, !alias.scope !1003, !noalias !1004
  %i.ds = fsub <2 x double> %wide.load154, %i.dp
  %i.dt = fsub <2 x double> %wide.load155, %i.dq
  store <2 x double> %i.ds, ptr %i.di, align 8, !tbaa !145, !alias.scope !1003, !noalias !1004
  store <2 x double> %i.dt, ptr %i.dr, align 8, !tbaa !145, !alias.scope !1003, !noalias !1004
  %index.next156 = add nuw i64 %index144, 4       ; 2 uses
  %i.du = icmp eq i64 %index.next156, %n.vec142
  br i1 %i.du, label %middle.block157, label %vector.body143, !llvm.loop !994
...
.lr.ph94:                                         ; preds = %.lr.ph94.preheader161, %.lr.ph94
  ...
  br i1 %exitcond102.not, label %._crit_edge95, label %.lr.ph94, !llvm.loop !995
...
._crit_edge95:                                    ; preds = %.lr.ph94, %middle.block157, %.lr.ph99
  ...
  br i1 %exitcond103.not, label %._crit_edge100, label %.lr.ph99, !llvm.loop !996
...
bb.m:                                             ; preds = %bb.k, %bb.l
  ...
  br i1 %exitcond.not, label %._crit_edge, label %.lr.ph, !llvm.loop !1005
...
._crit_edge.i.i.i:                                ; preds = %__cxx_global_var_init.2.exit
  ...
  store ptr %i.dc, ptr getelementptr inbounds nuw (i8, ptr @_ZN6casadi9Sqpmethod8options_E, i64 8), align 8, !tbaa !1007
...
!962 = distinct !{!962, !32, !224, !225}
!963 = distinct !{!963, !226}
!964 = distinct !{!964, !32, !224}
!965 = distinct !{!965, !32}
!966 = distinct !{!966, !226}
!967 = distinct !{!967, !32, !224, !225}
!968 = distinct !{!968, !32, !225, !224}
!969 = distinct !{!969, !32}
!970 = !{!960}
!971 = !{!961}
...
!975 = distinct !{!975, !32, !224, !225}
!976 = distinct !{!976, !32, !224}
!977 = distinct !{!977, !32}
!978 = !{!973}
!979 = !{!974}
!980 = distinct !{!980, !32}
!981 = distinct !{!981, !32}
!982 = distinct !{!982, !226}
!983 = distinct !{!983, !"LVerDomain"}
!984 = distinct !{!984, !983}
!985 = distinct !{!985, !983}
!986 = distinct !{!986, !32, !224, !225}
!987 = distinct !{!987, !32, !224}
!988 = distinct !{!988, !"LVerDomain"}
!989 = distinct !{!989, !988}
!990 = distinct !{!990, !988}
!991 = distinct !{!991, !988}
!992 = distinct !{!992, !988}
!993 = distinct !{!993, !988}
!994 = distinct !{!994, !32, !224, !225}
!995 = distinct !{!995, !32, !224}
!996 = distinct !{!996, !32}
!997 = !{!984}
!998 = !{!985}
!999 = !{!989}
...
!1002 = !{!992}
!1003 = !{!993}
!1004 = !{!992, !989, !990, !991}
!1005 = distinct !{!1005, !32, !1006}
!1006 = !{!"llvm.loop.peeled.count", i32 1}
!1007 = !{!139, !138, i64 8}
end_hunk_2
