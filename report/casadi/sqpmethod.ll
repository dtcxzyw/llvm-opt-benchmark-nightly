...
bb.n:                                             ; preds = %bb.m, %bb.l
  ...
  %17 = fsub nsz double %i.ja, %i.jg
  %18 = call nsz double @llvm.maxnum.f64(double %17, double 0.000000e+00)
  %19 = call nsz double @llvm.maxnum.f64(double %.01924.i, double %18)
  %20 = fsub nsz double %i.jd, %i.ja
  %i.jh = call nsz double @llvm.maxnum.f64(double %20, double 0.000000e+00)
  %i.ji = call nsz double @llvm.maxnum.f64(double %19, double %i.jh) ; 2 uses
