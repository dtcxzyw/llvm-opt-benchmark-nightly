...
bb.e:                                             ; preds = %.lr.ph1508, %bb.bi
  %i.hx = phi i64 [ %i.gl, %.lr.ph1508 ], [ %i.acw, %bb.bi ] ; 6 uses
  %i.hy = phi ptr [ %i.gh, %.lr.ph1508 ], [ %i.acs, %bb.bi ] ; 2 uses
...
.preheader.split.us.preheader.i:                  ; preds = %.preheader.i
  %i.jy = add nsw i64 %i.hx, -1                   ; 2 uses
  %i.jz = add nsw i64 %storemerge1499, 1          ; 2 uses
  %i.ka = icmp slt i64 %i.jz, %i.hx
  br i1 %i.ka, label %.lr.ph.us.i.preheader, label %_ZNK6casadi10Integrator9next_stopExPKd.exit
...
.preheader.split.us.i.loopexit:                   ; preds = %.lr.ph36.i, %.lr.ph36.i.preheader
  %i.kb = add i64 %i.kd, 1                        ; 2 uses
  %exitcond.not = icmp eq i64 %i.kb, %i.hx
...
.lr.ph36.i:                                       ; preds = %.lr.ph2047
  %i.kh = add nuw i64 %i.ki, 1                    ; 2 uses
  %exitcond.not.not.i = icmp eq i64 %i.kh, %.fr.i
...
.lr.ph2047:                                       ; preds = %.lr.ph36.i.preheader, %.lr.ph36.i
  %i.ki = phi i64 [ %i.kh, %.lr.ph36.i ], [ 1, %.lr.ph36.i.preheader ] ; 3 uses
  %i.kj = getelementptr inbounds nuw [8 x i8], ptr %.018.us.i1497, i64 %i.ki
  %i.kk = load double, ptr %i.kj, align 8, !tbaa !58
...
.preheader.split.i:                               ; preds = %.preheader.i
  ...
  %i.kp = icmp slt i64 %i.ko, %i.hx
  %i.kq = add nsw i64 %i.hx, -1
...
_ZNK6casadi10Integrator9next_stopExPKd.exit:      ; preds = %.preheader.split.us.i.loopexit, %_ZNK6casadi10Integrator5set_uEPNS_16IntegratorMemoryEPKd.exit.thread.a, %_ZNK6casadi10Integrator9next_stopExPKd.exit.loopexit, %.preheader.split.us.preheader.i, %.preheader.split.i, %_ZNK6casadi10Integrator5set_uEPNS_16IntegratorMemoryEPKd.exit.thread
  ...
  store double %i.kt, ptr %i.gt, align 8, !tbaa !206
...
bb.h:                                             ; preds = %_ZNK6casadi10Integrator9next_stopExPKd.exit, %bb.e
  ...
  %i.ku = load i64, ptr %i.gv, align 8, !tbaa !207 ; 2 uses
  %i.kv = icmp slt i64 %i.ku, 1
  br i1 %i.kv, label %_ZSt6fill_nIPxxiET_S1_T0_RKT1_.exit.preheader, label %.lr.ph.i.i.i.i

.lr.ph.i.i.i.i:                                   ; preds = %bb.h
  %i.kw = load ptr, ptr %i.gu, align 8, !tbaa !208
  %.idx.i.i = shl nuw nsw i64 %i.ku, 3
  call void @llvm.memset.p0.i64(ptr align 8 %i.kw, i8 0, i64 %.idx.i.i, i1 false), !tbaa !209
...
_ZSt6fill_nIPxxiET_S1_T0_RKT1_.exit:              ; preds = %_ZSt6fill_nIPxxiET_S1_T0_RKT1_.exit.preheader, %bb.bc
  ...
  %i.kx = load i8, ptr %i.gc, align 8, !tbaa !623, !range !210, !noundef !211
  %i.ky = trunc nuw i8 %i.kx to i1
  br i1 %i.ky, label %bb.i, label %bb.j

bb.i:                                             ; preds = %_ZSt6fill_nIPxxiET_S1_T0_RKT1_.exit
  %i.kz = load ptr, ptr %0, align 8, !tbaa !49
  %i.la = getelementptr inbounds nuw i8, ptr %i.kz, i64 976
  %i.lb = load ptr, ptr %i.la, align 8
  call void %i.lb(ptr noundef nonnull align 8 dereferenceable(1984) %0, ptr noundef nonnull %5, i1 noundef zeroext %.1209)
  store i8 0, ptr %i.gc, align 8, !tbaa !623
  br label %bb.j
...
bb.j:                                             ; preds = %bb.i, %_ZSt6fill_nIPxxiET_S1_T0_RKT1_.exit
  ...
  %i.lc = load i8, ptr %i.gw, align 8, !tbaa !212, !range !210, !noundef !211
  %i.ld = trunc nuw i8 %i.lc to i1
  br i1 %i.ld, label %bb.k, label %bb.ay

bb.k:                                             ; preds = %bb.j
  %i.le = call noundef nonnull align 8 dereferenceable(8) ptr @_ZN6casadi4uoutEv()
  %i.lf = call noundef nonnull align 8 dereferenceable(8) ptr @_ZN6casadi14message_prefixERSo(ptr noundef nonnull align 8 dereferenceable(8) %i.le) ; 2 uses
  %i.lg = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %i.lf, ptr noundef nonnull @.str.44, i64 noundef 10) ; 0 uses
  ...
  %i.lh = invoke noundef nonnull align 8 dereferenceable(32) ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_replaceEmmPKcm(ptr noundef nonnull align 8 dereferenceable(32) %13, i64 noundef 0, i64 noundef 0, ptr noundef nonnull @.str.45, i64 noundef 9)
          to label %.noexc unwind label %bb.ap    ; 6 uses

.noexc:                                           ; preds = %bb.k
  store ptr %i.gx, ptr %12, align 8, !tbaa !29, !alias.scope !624
  %i.li = load ptr, ptr %i.lh, align 8, !tbaa !33 ; 2 uses
  %i.lj = getelementptr inbounds nuw i8, ptr %i.lh, i64 16 ; 5 uses
  %i.lk = icmp eq ptr %i.li, %i.lj
  br i1 %i.lk, label %bb.l, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i

bb.l:                                             ; preds = %.noexc
  %i.ll = getelementptr inbounds nuw i8, ptr %i.lh, i64 8
  %i.lm = load i64, ptr %i.ll, align 8, !tbaa !35 ; 3 uses
  %i.ln = icmp ult i64 %i.lm, 16
  call void @llvm.assume(i1 %i.ln)
  %i.lo = add nuw nsw i64 %i.lm, 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %i.gx, ptr noundef nonnull align 8 dereferenceable(1) %i.lj, i64 %i.lo, i1 false)
  br label %bb.m

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %.noexc
  store ptr %i.li, ptr %12, align 8, !tbaa !33, !alias.scope !624
  %i.lp = load i64, ptr %i.lj, align 8, !tbaa !34
  store i64 %i.lp, ptr %i.gx, align 8, !tbaa !34, !alias.scope !624
  %.phi.trans.insert.i = getelementptr inbounds nuw i8, ptr %i.lh, i64 8
...
bb.m:                                             ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i, %bb.l
  %i.lq = phi i64 [ %i.lm, %bb.l ], [ %.pre.i, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i ]
  %i.lr = getelementptr inbounds nuw i8, ptr %i.lh, i64 8
  store i64 %i.lq, ptr %i.gy, align 8, !tbaa !35, !alias.scope !624
  store ptr %i.lj, ptr %i.lh, align 8, !tbaa !33
  store i64 0, ptr %i.lr, align 8, !tbaa !35
  store i8 0, ptr %i.lj, align 8, !tbaa !34
  call void @llvm.experimental.noalias.scope.decl(metadata !625)
  %i.ls = load i64, ptr %i.gy, align 8, !tbaa !35, !noalias !625
  %i.lt = add i64 %i.ls, -4611686018427387877
  %i.lu = icmp ult i64 %i.lt, 27
  br i1 %i.lu, label %bb.n, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i: ; preds = %bb.m
  %i.lv = invoke noundef nonnull align 8 dereferenceable(32) ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_appendEPKcm(ptr noundef nonnull align 8 dereferenceable(32) %12, ptr noundef nonnull @.str.46, i64 noundef 27)
...
.noexc342:                                        ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i
  ...
  %i.lw = load ptr, ptr %i.lv, align 8, !tbaa !33 ; 2 uses
  %i.lx = getelementptr inbounds nuw i8, ptr %i.lv, i64 16 ; 5 uses
  %i.ly = icmp eq ptr %i.lw, %i.lx
  br i1 %i.ly, label %bb.o, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i338

bb.o:                                             ; preds = %.noexc342
  %i.lz = getelementptr inbounds nuw i8, ptr %i.lv, i64 8
  %i.ma = load i64, ptr %i.lz, align 8, !tbaa !35 ; 3 uses
  %i.mb = icmp ult i64 %i.ma, 16
  call void @llvm.assume(i1 %i.mb)
  %i.mc = add nuw nsw i64 %i.ma, 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %i.gz, ptr noundef nonnull align 8 dereferenceable(1) %i.lx, i64 %i.mc, i1 false)
  br label %bb.p

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i338: ; preds = %.noexc342
  store ptr %i.lw, ptr %11, align 8, !tbaa !33, !alias.scope !625
  %i.md = load i64, ptr %i.lx, align 8, !tbaa !34
  store i64 %i.md, ptr %i.gz, align 8, !tbaa !34, !alias.scope !625
  %.phi.trans.insert.i339 = getelementptr inbounds nuw i8, ptr %i.lv, i64 8
...
bb.p:                                             ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i338, %bb.o
  %i.me = phi i64 [ %i.ma, %bb.o ], [ %.pre.i340, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i338 ]
  %i.mf = getelementptr inbounds nuw i8, ptr %i.lv, i64 8
  store i64 %i.me, ptr %i.ha, align 8, !tbaa !35, !alias.scope !625
  store ptr %i.lx, ptr %i.lv, align 8, !tbaa !33
  store i64 0, ptr %i.mf, align 8, !tbaa !35
...
bb.q:                                             ; preds = %bb.p
  ...
  %i.mg = load i64, ptr %i.ha, align 8, !tbaa !35, !noalias !626 ; 4 uses
  %i.mh = load i64, ptr %i.hb, align 8, !tbaa !35, !noalias !626 ; 4 uses
  %i.mi = add i64 %i.mh, %i.mg                    ; 2 uses
  %i.mj = load ptr, ptr %11, align 8, !tbaa !33, !noalias !626 ; 2 uses
  %i.mk = icmp eq ptr %i.mj, %i.gz
  br i1 %i.mk, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i343

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i: ; preds = %bb.q
  %i.ml = icmp ult i64 %i.mg, 16
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i343: ; preds = %bb.q
  %i.mm = load i64, ptr %i.gz, align 8, !tbaa !34, !noalias !626
  br label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i343, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i
  %i.mn = phi i64 [ %i.mm, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i343 ], [ 15, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i ]
  %i.mo = icmp ugt i64 %i.mi, %i.mn
  br i1 %i.mo, label %bb.r, label %bb.t

bb.r:                                             ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i
  %i.mp = load ptr, ptr %14, align 8, !tbaa !33, !noalias !626
  %i.mq = icmp eq ptr %i.mp, %i.hc
  br i1 %i.mq, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i13.i, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i12.i

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i13.i: ; preds = %bb.r
  %i.mr = icmp ult i64 %i.mh, 16
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i12.i: ; preds = %bb.r
  %i.ms = load i64, ptr %i.hc, align 8, !tbaa !34, !noalias !626
  br label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit14.i
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit14.i: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i12.i, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i13.i
  %i.mt = phi i64 [ %i.ms, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i12.i ], [ 15, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i13.i ]
  %.not.i = icmp ugt i64 %i.mi, %i.mt
...
.critedge.i:                                      ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit14.i
  %i.mu = invoke noundef nonnull align 8 dereferenceable(32) ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_replaceEmmPKcm(ptr noundef nonnull align 8 dereferenceable(32) %14, i64 noundef 0, i64 noundef 0, ptr noundef %i.mj, i64 noundef %i.mg)
...
.noexc344:                                        ; preds = %.critedge.i
  ...
  %i.mv = load ptr, ptr %i.mu, align 8, !tbaa !33 ; 2 uses
  %i.mw = getelementptr inbounds nuw i8, ptr %i.mu, i64 16 ; 5 uses
  %i.mx = icmp eq ptr %i.mv, %i.mw
  br i1 %i.mx, label %bb.s, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i15.i

bb.s:                                             ; preds = %.noexc344
  %i.my = getelementptr inbounds nuw i8, ptr %i.mu, i64 8
  %i.mz = load i64, ptr %i.my, align 8, !tbaa !35 ; 2 uses
  %i.na = icmp ult i64 %i.mz, 16
  call void @llvm.assume(i1 %i.na)
  %i.nb = add nuw nsw i64 %i.mz, 1
end_hunk_0
