...
.loopexit:                                        ; preds = %scalar.ph649, %middle.block661, %_ZN6casadi9casadi_mvIdEEvPKT_PKxS3_PS1_x.exit333, %_ZN6casadi13casadi_norm_2IdEET_xPKS1_.exit372, %_ZN6casadi13casadi_norm_2IdEET_xPKS1_.exit340
  ...
  %.1241 = phi double [ %.0240, %_ZN6casadi13casadi_norm_2IdEET_xPKS1_.exit340 ], [ %sqrt, %_ZN6casadi13casadi_norm_2IdEET_xPKS1_.exit372 ], [ %.0240, %_ZN6casadi9casadi_mvIdEEvPKT_PKxS3_PS1_x.exit333 ], [ %sqrt, %middle.block661 ], [ %sqrt, %scalar.ph649 ] ; 5 uses
...
_ZN6casadi13casadi_norm_2IdEET_xPKS1_.exit379:    ; preds = %_ZN6casadi13casadi_norm_2IdEET_xPKS1_.exit379.loopexit.unr-lcssa, %.lr.ph.i.i374.epil, %_ZN6casadi21casadi_lsqr_sym_orthoIdEEvT_S1_PS1_S2_S2_.exit
  ...
  %5 = fmul double %.sink.i, %i.vp                ; 3 uses
  ...
  %i.vu = fdiv double %i.vt, %5
  %i.vv = insertelement <2 x double> poison, double %i.vu, i64 0
  %i.vw = insertelement <2 x double> %i.vv, double %5, i64 1 ; 2 uses
  ...
  %i.wb = tail call double @sqrt(double noundef %i.wa) #24 ; 2 uses
  ...
  %6 = fmul double %.1241, %i.wb
  %7 = fdiv double %6, %i.hz
  %8 = fmul double %.1241, 1.000000e-15
  %9 = fmul double %8, %i.wb
  %10 = fdiv double %9, %i.hz
  %i.wy = fadd double %10, 1.000000e-15
  ...
  %i.xf = fadd double %7, 1.000000e+00
