...
bb.y:                                             ; preds = %bb.s
  ...
  %i.gm = load ptr, ptr %i.gd, align 8, !tbaa !111
  ...
  %i.gu = load ptr, ptr %i.gd, align 8, !tbaa !111
  ...
  %i.hb = load ptr, ptr %i.gd, align 8, !tbaa !111
...
.critedge:                                        ; preds = %bb.r
  ...
  %i.hh = load ptr, ptr %.0307, align 8, !tbaa !110
  ...
  %i.hp = load ptr, ptr %.0307, align 8, !tbaa !110
  ...
  %i.hx = load ptr, ptr %.0307, align 8, !tbaa !110
  ...
  %i.ie = load ptr, ptr %.0307, align 8, !tbaa !110
...
.lr.ph.i375:                                      ; preds = %bb.ag, %.lr.ph.i375
  ...
  br i1 %i.jt, label %.lr.ph.i375, label %fill_64.exit378, !llvm.loop !99
...
.lr.ph.i379:                                      ; preds = %.lr.ph.i379.preheader, %.lr.ph.i379
  ...
  br i1 %i.kc, label %.lr.ph.i379, label %.thread2, !llvm.loop !99
...
.lr.ph.i393:                                      ; preds = %.lr.ph.i393.preheader, %.lr.ph.i393
  ...
  br i1 %i.mj, label %.lr.ph.i393, label %.thread2, !llvm.loop !99
...
.lr.ph.i369.epil:                                 ; preds = %.lr.ph.i369.epil, %.lr.ph.i369.epil.preheader
  ...
  br i1 %epil.iter111.cmp.not, label %.thread2, label %.lr.ph.i369.epil, !llvm.loop !100
...
.lr.ph.i383.epil:                                 ; preds = %.lr.ph.i383.epil, %.lr.ph.i383.epil.preheader
  ...
  br i1 %epil.iter105.cmp.not, label %.thread2, label %.lr.ph.i383.epil, !llvm.loop !101
...
.lr.ph.i397.epil:                                 ; preds = %.lr.ph.i397.epil, %.lr.ph.i397.epil.preheader
  ...
  br i1 %epil.iter.cmp.not, label %.thread2, label %.lr.ph.i397.epil, !llvm.loop !102
...
.thread2:                                         ; preds = %.lr.ph.i397, %.lr.ph.i397.epil, %.thread2.loopexit98.unr-lcssa, %.lr.ph.i383.epil, %.lr.ph.i393, %.thread2.loopexit96.unr-lcssa, %.lr.ph.i369.epil, %.lr.ph.i379, %bb.ak, %bb.x, %bb.w, %.critedge, %bb.y, %bb.m, %bb.q, %bb.p, %bb.al, %bb.am, %.lr.ph.i389, %fill_64.exit378, %bb.ae, %bb.ad, %bb.aq
  ...
  br i1 %i.ny, label %.preheader, label %.loopexit, !llvm.loop !103
...
.loopexit:                                        ; preds = %.thread2, %copy_block4.exit
  ...
  br i1 %i.oe, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !104
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.preheader29
  ...
  br i1 %i.ol, label %.preheader29, label %.thread12, !llvm.loop !105
...
!98 = distinct !{!98, !106}
!99 = distinct !{!99, !59}
!100 = distinct !{!100, !106}
!101 = distinct !{!101, !106}
!102 = distinct !{!102, !106}
!103 = distinct !{!103, !59}
!104 = distinct !{!104, !59}
!105 = distinct !{!105, !59}
!106 = !{!"llvm.loop.unroll.disable"}
!107 = !{!"vqEntry", !17, i64 0, !24, i64 8, !5, i64 16, !5, i64 17}
!108 = !{!107, !5, i64 16}
!109 = !{!107, !5, i64 17}
!110 = !{!107, !17, i64 0}
!111 = !{!107, !24, i64 8}
