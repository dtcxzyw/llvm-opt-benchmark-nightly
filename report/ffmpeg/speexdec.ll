...
.lr.ph29.split.i233:                              ; preds = %.lr.ph29.split.i233, %.lr.ph29.split.i233.preheader.new
  ...
  %i.so = load float, ptr %i.sn, align 4, !tbaa !66
  %i.sp = load float, ptr %i.ft, align 8, !tbaa !66
  %i.sq = fadd nsz float %i.so, %i.sp             ; 2 uses
  %i.sr = fneg nsz float %i.sq
  %i.ss = load float, ptr %i.rq, align 4, !tbaa !66
  %i.st = fmul nsz float %i.ss, %i.sr
  store float %i.st, ptr %i.rr, align 4, !tbaa !66
  %i.su = getelementptr inbounds nuw [4 x i8], ptr %i.gn, i64 %indvars.iv.i234
  store float %i.sq, ptr %i.su, align 4, !tbaa !66
  ...
  %i.sw = load float, ptr %i.sv, align 4, !tbaa !66
  %i.sx = load float, ptr %i.ft, align 8, !tbaa !66
  %i.sy = fadd nsz float %i.sw, %i.sx             ; 2 uses
  %i.sz = fneg nsz float %i.sy
  %i.ta = load float, ptr %i.rq, align 4, !tbaa !66
  %i.tb = fmul nsz float %i.ta, %i.sz
  store float %i.tb, ptr %i.rr, align 4, !tbaa !66
  %i.tc = getelementptr inbounds nuw [4 x i8], ptr %i.gn, i64 %indvars.iv.next.i235
  store float %i.sy, ptr %i.tc, align 4, !tbaa !66
  ...
  br i1 %niter486.ncmp.1, label %.lr.ph.preheader.i248.loopexit464.unr-lcssa, label %.lr.ph29.split.i233, !llvm.loop !1
...
.lr.ph29.split.i233.epil.preheader:               ; preds = %.lr.ph.preheader.i248.loopexit464.unr-lcssa, %.lr.ph29.split.i233.preheader
  ...
  %i.te = load float, ptr %i.td, align 4, !tbaa !66
  %i.tf = load float, ptr %i.ft, align 8, !tbaa !66
  %i.tg = fadd nsz float %i.te, %i.tf             ; 2 uses
  %i.th = fneg nsz float %i.tg
  %i.ti = load float, ptr %i.rq, align 4, !tbaa !66
  %i.tj = fmul nsz float %i.ti, %i.th
  store float %i.tj, ptr %i.rr, align 4, !tbaa !66
  %i.tk = getelementptr inbounds nuw [4 x i8], ptr %i.gn, i64 %indvars.iv.i234.epil.init
  store float %i.tg, ptr %i.tk, align 4, !tbaa !66
...
.lr.ph.i250:                                      ; preds = %.lr.ph.i250, %.lr.ph.preheader.i248.new
  ...
  %i.to = load float, ptr %i.tn, align 4, !tbaa !66 ; 2 uses
  ...
  %i.ts = load float, ptr %i.tr, align 4, !tbaa !66 ; 2 uses
  ...
  %i.tw = load float, ptr %i.tv, align 4, !tbaa !66 ; 2 uses
  ...
  %i.ua = load float, ptr %i.tz, align 4, !tbaa !66 ; 2 uses
  ...
  br i1 %niter493.ncmp.3, label %compute_rms.exit.unr-lcssa, label %.lr.ph.i250, !llvm.loop !0
...
.lr.ph.i250.epil:                                 ; preds = %.lr.ph.i250.epil, %.lr.ph.i250.epil.preheader
  ...
  %i.ud = load float, ptr %i.uc, align 4, !tbaa !66 ; 2 uses
  ...
  br i1 %epil.iter488.cmp.not, label %compute_rms.exit, label %.lr.ph.i250.epil, !llvm.loop !170
...
bb.a:
  ...
  %i.x = insertelement <2 x float> %i.w, float %i.n, i64 1 ; 2 uses
...
vector.memcheck:                                  ; preds = %bb.a, %bb.b
  ...
  %.098 = extractelement <2 x float> %foldExtExtBinop, i64 0 ; 2 uses
  %foldExtExtBinop20 = fmul nsz <2 x float> %i.ac, %i.aq ; 2 uses
  %.099 = extractelement <2 x float> %foldExtExtBinop20, i64 1 ; 2 uses
...
vector.body:                                      ; preds = %vector.memcheck
  %broadcast.splat3 = shufflevector <2 x float> %foldExtExtBinop20, <2 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1> ; 20 uses
  %broadcast.splat = shufflevector <2 x float> %foldExtExtBinop, <2 x float> poison, <4 x i32> zeroinitializer ; 20 uses
  %i.as = getelementptr inbounds nuw i8, ptr %0, i64 16
  %wide.load = load <4 x float>, ptr %0, align 4, !tbaa !66
  %wide.load4 = load <4 x float>, ptr %i.as, align 4, !tbaa !66
  %i.at = getelementptr inbounds nuw i8, ptr %i.c, i64 16
  %wide.load5 = load <4 x float>, ptr %i.c, align 16, !tbaa !66
  %wide.load6 = load <4 x float>, ptr %i.at, align 16, !tbaa !66
  ...
  %wide.load7 = load <4 x float>, ptr %i.aw, align 16, !tbaa !66
  %wide.load8 = load <4 x float>, ptr %i.ax, align 16, !tbaa !66
  ...
  store <4 x float> %i.ay, ptr %1, align 4, !tbaa !66
  store <4 x float> %i.az, ptr %i.ba, align 4, !tbaa !66
  %i.bb = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.bc = getelementptr inbounds nuw i8, ptr %0, i64 48
  %wide.load.1 = load <4 x float>, ptr %i.bb, align 4, !tbaa !66
  %wide.load4.1 = load <4 x float>, ptr %i.bc, align 4, !tbaa !66
  %i.bd = getelementptr inbounds nuw i8, ptr %i.c, i64 32
  %i.be = getelementptr inbounds nuw i8, ptr %i.c, i64 48
  %wide.load5.1 = load <4 x float>, ptr %i.bd, align 16, !tbaa !66
  %wide.load6.1 = load <4 x float>, ptr %i.be, align 16, !tbaa !66
  ...
  %wide.load7.1 = load <4 x float>, ptr %i.bh, align 16, !tbaa !66
  %wide.load8.1 = load <4 x float>, ptr %i.bi, align 16, !tbaa !66
  ...
  store <4 x float> %i.bj, ptr %i.bl, align 4, !tbaa !66
  store <4 x float> %i.bk, ptr %i.bm, align 4, !tbaa !66
  %i.bn = getelementptr inbounds nuw i8, ptr %0, i64 64
  %i.bo = getelementptr inbounds nuw i8, ptr %0, i64 80
  %wide.load.2 = load <4 x float>, ptr %i.bn, align 4, !tbaa !66
  %wide.load4.2 = load <4 x float>, ptr %i.bo, align 4, !tbaa !66
  %i.bp = getelementptr inbounds nuw i8, ptr %i.c, i64 64
  %i.bq = getelementptr inbounds nuw i8, ptr %i.c, i64 80
  %wide.load5.2 = load <4 x float>, ptr %i.bp, align 16, !tbaa !66
  %wide.load6.2 = load <4 x float>, ptr %i.bq, align 16, !tbaa !66
  ...
  %wide.load7.2 = load <4 x float>, ptr %i.bt, align 16, !tbaa !66
  %wide.load8.2 = load <4 x float>, ptr %i.bu, align 16, !tbaa !66
  ...
  store <4 x float> %i.bv, ptr %i.bx, align 4, !tbaa !66
  store <4 x float> %i.bw, ptr %i.by, align 4, !tbaa !66
  %i.bz = getelementptr inbounds nuw i8, ptr %0, i64 96
  %i.ca = getelementptr inbounds nuw i8, ptr %0, i64 112
  %wide.load.3 = load <4 x float>, ptr %i.bz, align 4, !tbaa !66
  %wide.load4.3 = load <4 x float>, ptr %i.ca, align 4, !tbaa !66
  %i.cb = getelementptr inbounds nuw i8, ptr %i.c, i64 96
  %i.cc = getelementptr inbounds nuw i8, ptr %i.c, i64 112
  %wide.load5.3 = load <4 x float>, ptr %i.cb, align 16, !tbaa !66
  %wide.load6.3 = load <4 x float>, ptr %i.cc, align 16, !tbaa !66
  ...
  %wide.load7.3 = load <4 x float>, ptr %i.cf, align 16, !tbaa !66
  %wide.load8.3 = load <4 x float>, ptr %i.cg, align 16, !tbaa !66
  ...
  store <4 x float> %i.ch, ptr %i.cj, align 4, !tbaa !66
  store <4 x float> %i.ci, ptr %i.ck, align 4, !tbaa !66
  %i.cl = getelementptr inbounds nuw i8, ptr %0, i64 128
  %i.cm = getelementptr inbounds nuw i8, ptr %0, i64 144
  %wide.load.4 = load <4 x float>, ptr %i.cl, align 4, !tbaa !66
  %wide.load4.4 = load <4 x float>, ptr %i.cm, align 4, !tbaa !66
  %i.cn = getelementptr inbounds nuw i8, ptr %i.c, i64 128
  %i.co = getelementptr inbounds nuw i8, ptr %i.c, i64 144
  %wide.load5.4 = load <4 x float>, ptr %i.cn, align 16, !tbaa !66
  %wide.load6.4 = load <4 x float>, ptr %i.co, align 16, !tbaa !66
  ...
  %wide.load7.4 = load <4 x float>, ptr %i.cr, align 16, !tbaa !66
  %wide.load8.4 = load <4 x float>, ptr %i.cs, align 16, !tbaa !66
  ...
  store <4 x float> %i.ct, ptr %i.cv, align 4, !tbaa !66
  store <4 x float> %i.cu, ptr %i.cw, align 4, !tbaa !66
  %i.cx = getelementptr inbounds nuw i8, ptr %0, i64 160
  %i.cy = getelementptr inbounds nuw i8, ptr %0, i64 176
  %wide.load.5 = load <4 x float>, ptr %i.cx, align 4, !tbaa !66
  %wide.load4.5 = load <4 x float>, ptr %i.cy, align 4, !tbaa !66
  %i.cz = getelementptr inbounds nuw i8, ptr %i.c, i64 160
  %i.da = getelementptr inbounds nuw i8, ptr %i.c, i64 176
  %wide.load5.5 = load <4 x float>, ptr %i.cz, align 16, !tbaa !66
  %wide.load6.5 = load <4 x float>, ptr %i.da, align 16, !tbaa !66
  ...
  %wide.load7.5 = load <4 x float>, ptr %i.dd, align 16, !tbaa !66
  %wide.load8.5 = load <4 x float>, ptr %i.de, align 16, !tbaa !66
  ...
  store <4 x float> %i.df, ptr %i.dh, align 4, !tbaa !66
  store <4 x float> %i.dg, ptr %i.di, align 4, !tbaa !66
  %i.dj = getelementptr inbounds nuw i8, ptr %0, i64 192
  %i.dk = getelementptr inbounds nuw i8, ptr %0, i64 208
  %wide.load.6 = load <4 x float>, ptr %i.dj, align 4, !tbaa !66
  %wide.load4.6 = load <4 x float>, ptr %i.dk, align 4, !tbaa !66
  %i.dl = getelementptr inbounds nuw i8, ptr %i.c, i64 192
  %i.dm = getelementptr inbounds nuw i8, ptr %i.c, i64 208
  %wide.load5.6 = load <4 x float>, ptr %i.dl, align 16, !tbaa !66
  %wide.load6.6 = load <4 x float>, ptr %i.dm, align 16, !tbaa !66
  ...
  %wide.load7.6 = load <4 x float>, ptr %i.dp, align 16, !tbaa !66
  %wide.load8.6 = load <4 x float>, ptr %i.dq, align 16, !tbaa !66
  ...
  store <4 x float> %i.dr, ptr %i.dt, align 4, !tbaa !66
  store <4 x float> %i.ds, ptr %i.du, align 4, !tbaa !66
  %i.dv = getelementptr inbounds nuw i8, ptr %0, i64 224
  %i.dw = getelementptr inbounds nuw i8, ptr %0, i64 240
  %wide.load.7 = load <4 x float>, ptr %i.dv, align 4, !tbaa !66
  %wide.load4.7 = load <4 x float>, ptr %i.dw, align 4, !tbaa !66
  %i.dx = getelementptr inbounds nuw i8, ptr %i.c, i64 224
  %i.dy = getelementptr inbounds nuw i8, ptr %i.c, i64 240
  %wide.load5.7 = load <4 x float>, ptr %i.dx, align 16, !tbaa !66
  %wide.load6.7 = load <4 x float>, ptr %i.dy, align 16, !tbaa !66
  ...
  %wide.load7.7 = load <4 x float>, ptr %i.eb, align 16, !tbaa !66
  %wide.load8.7 = load <4 x float>, ptr %i.ec, align 16, !tbaa !66
  ...
  store <4 x float> %i.ed, ptr %i.ef, align 4, !tbaa !66
  store <4 x float> %i.ee, ptr %i.eg, align 4, !tbaa !66
  %i.eh = getelementptr inbounds nuw i8, ptr %0, i64 256
  %i.ei = getelementptr inbounds nuw i8, ptr %0, i64 272
  %wide.load.8 = load <4 x float>, ptr %i.eh, align 4, !tbaa !66
  %wide.load4.8 = load <4 x float>, ptr %i.ei, align 4, !tbaa !66
  %i.ej = getelementptr inbounds nuw i8, ptr %i.c, i64 256
  %i.ek = getelementptr inbounds nuw i8, ptr %i.c, i64 272
  %wide.load5.8 = load <4 x float>, ptr %i.ej, align 16, !tbaa !66
  %wide.load6.8 = load <4 x float>, ptr %i.ek, align 16, !tbaa !66
  ...
  %wide.load7.8 = load <4 x float>, ptr %i.en, align 16, !tbaa !66
  %wide.load8.8 = load <4 x float>, ptr %i.eo, align 16, !tbaa !66
  ...
  store <4 x float> %i.ep, ptr %i.er, align 4, !tbaa !66
  store <4 x float> %i.eq, ptr %i.es, align 4, !tbaa !66
  %i.et = getelementptr inbounds nuw i8, ptr %0, i64 288
  %i.eu = getelementptr inbounds nuw i8, ptr %0, i64 304
  %wide.load.9 = load <4 x float>, ptr %i.et, align 4, !tbaa !66
  %wide.load4.9 = load <4 x float>, ptr %i.eu, align 4, !tbaa !66
  %i.ev = getelementptr inbounds nuw i8, ptr %i.c, i64 288
  %i.ew = getelementptr inbounds nuw i8, ptr %i.c, i64 304
  %wide.load5.9 = load <4 x float>, ptr %i.ev, align 16, !tbaa !66
  %wide.load6.9 = load <4 x float>, ptr %i.ew, align 16, !tbaa !66
end_hunk_0
