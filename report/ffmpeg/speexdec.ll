...
bb.d:                                             ; preds = %bb.b, %bb.d
  ...
  %i.or = fsub nsz float %i.og, %i.oi
  %i.os = fadd nsz float %i.og, %i.oi
  %i.ot = fsub nsz float %.012015, %.011916
  %i.ou = fadd nsz float %.012015, %.011916
  ...
  %6 = fsub nsz float %i.om, %i.oo
  %7 = fadd nsz float %i.om, %i.oo
  %i.pc = shufflevector <4 x float> %i.ow, <4 x float> poison, <4 x i32> <i32 poison, i32 poison, i32 0, i32 1>
  %i.pd = insertelement <4 x float> %i.pc, float %6, i64 0
  %i.pe = insertelement <4 x float> %i.pd, float %7, i64 1
