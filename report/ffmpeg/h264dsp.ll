...
begin_hunk_0_@biweight_h264_pixels8_9_c:bb.a
  ...
  %i.cl = load i16, ptr %i.ck, align 2, !tbaa !31
  ...
  store i16 %i.cx, ptr %i.co, align 2, !tbaa !31
  %i.cy = getelementptr inbounds nuw i8, ptr %.093, i64 14
  %i.cz = load i16, ptr %i.cy, align 2, !tbaa !31
  ...
  store i16 %i.dl, ptr %i.dc, align 2, !tbaa !31
...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %i.g = load i16, ptr %.053, align 2, !tbaa !31
  %i.h = zext i16 %i.g to i32
  %i.i = mul nsw i32 %6, %i.h
  %i.j = load i16, ptr %.04052, align 2, !tbaa !31
  ...
  store i16 %i.r, ptr %.04052, align 2, !tbaa !31
  ...
  %i.x = load i16, ptr %i.w, align 2, !tbaa !31
  ...
  store i16 %i.af, ptr %i.w, align 2, !tbaa !31
  ...
  %i.al = load i16, ptr %i.ak, align 2, !tbaa !31
  ...
  store i16 %i.at, ptr %i.ak, align 2, !tbaa !31
  ...
  %i.az = load i16, ptr %i.ay, align 2, !tbaa !31
  ...
  store i16 %i.bh, ptr %i.ay, align 2, !tbaa !31
...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %i.g = load i16, ptr %.033, align 2, !tbaa !31
  %i.h = zext i16 %i.g to i32
  %i.i = mul nsw i32 %6, %i.h
  %i.j = load i16, ptr %.02632, align 2, !tbaa !31
  %i.k = zext i16 %i.j to i32
  %i.l = mul nsw i32 %5, %i.k
  %i.m = add i32 %i.i, %i.d
  %i.n = add i32 %i.m, %i.l
  ...
  %i.q = tail call i32 @llvm.umin.i32(i32 %i.p, i32 511)
  %i.r = trunc nuw nsw i32 %i.q to i16
  store i16 %i.r, ptr %.02632, align 2, !tbaa !31
...
bb.d:                                             ; preds = %.preheader, %bb.n
  ...
  %i.w = load i16, ptr %.1102.i9, align 2, !tbaa !31
...
bb.h:                                             ; preds = %bb.g
  ...
  store i16 %i.ay, ptr %i.q, align 2, !tbaa !31
  br label %bb.i
...
bb.k:                                             ; preds = %bb.j
  ...
  store i16 %i.bk, ptr %i.y, align 2, !tbaa !31
  br label %bb.l
...
bb.m:                                             ; preds = %bb.l, %bb.i
  ...
  store i16 %i.bx, ptr %i.n, align 2, !tbaa !31
  ...
  store i16 %i.cb, ptr %.1102.i9, align 2, !tbaa !31
  br label %bb.n
...
bb.n:                                             ; preds = %bb.m, %bb.f, %bb.e, %bb.d
  ...
  br i1 %exitcond.not, label %.loopexit, label %bb.d, !llvm.loop !0

.loopexit:                                        ; preds = %bb.n, %bb.c
  %.2.i = phi ptr [ %i.m, %bb.c ], [ %i.cc, %bb.n ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond14.not = icmp eq i64 %indvars.iv.next, 4
  br i1 %exitcond14.not, label %h264_loop_filter_luma_9_c.exit, label %bb.b, !llvm.loop !1
...
bb.d:                                             ; preds = %.preheader, %bb.n
  ...
  %i.aa = load i16, ptr %i.z, align 2, !tbaa !31
...
bb.h:                                             ; preds = %bb.g
  ...
  store i16 %i.aw, ptr %i.o, align 2, !tbaa !31
  br label %bb.i
...
bb.k:                                             ; preds = %bb.j
  ...
  store i16 %i.bi, ptr %i.w, align 2, !tbaa !31
  br label %bb.l
...
bb.m:                                             ; preds = %bb.l, %bb.i
  ...
  store i16 %i.bv, ptr %i.l, align 2, !tbaa !31
  ...
  store i16 %i.bz, ptr %.1102.i9, align 2, !tbaa !31
  br label %bb.n
...
.preheader:                                       ; preds = %bb.b
  ...
  %i.s = load i16, ptr %i.r, align 2, !tbaa !31
  %i.t = zext i16 %i.s to i32                     ; 2 uses
  %i.u = load i16, ptr %.0101.i11, align 2, !tbaa !31
  %i.v = zext i16 %i.u to i32                     ; 7 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  store i16 %i.ax, ptr %i.o, align 2, !tbaa !31
  br label %bb.h
...
bb.j:                                             ; preds = %bb.i
  ...
  store i16 %i.bj, ptr %i.w, align 2, !tbaa !31
  br label %bb.k
...
bb.l:                                             ; preds = %bb.k, %bb.h
  ...
  store i16 %i.bw, ptr %i.l, align 2, !tbaa !31
  ...
  store i16 %i.ca, ptr %.0101.i11, align 2, !tbaa !31
  br label %bb.m
...
bb.q:                                             ; preds = %bb.p
  ...
  store i16 %i.dn, ptr %i.cf, align 2, !tbaa !31
  br label %bb.r
...
bb.d:                                             ; preds = %.preheader, %bb.n
  ...
  %i.u = load i16, ptr %i.t, align 2, !tbaa !31
  %i.v = zext i16 %i.u to i32                     ; 2 uses
  %i.w = load i16, ptr %.1102.i4, align 2, !tbaa !31
  %i.x = zext i16 %i.w to i32                     ; 7 uses
...
bb.m:                                             ; preds = %bb.l, %bb.i
  ...
  %i.cb = trunc nuw nsw i32 %i.ca to i16
  store i16 %i.cb, ptr %.1102.i4, align 2, !tbaa !31
  br label %bb.n
...
bb.n:                                             ; preds = %bb.m, %bb.f, %bb.e, %bb.d
  ...
  %exitcond.not = icmp eq i32 %i.cd, 4
  br i1 %exitcond.not, label %.loopexit, label %bb.d, !llvm.loop !4

.loopexit:                                        ; preds = %bb.n, %bb.c
  %.2.i = phi ptr [ %i.m, %bb.c ], [ %i.cc, %bb.n ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond9.not = icmp eq i64 %indvars.iv.next, 4
  br i1 %exitcond9.not, label %h264_loop_filter_luma_10_c.exit, label %bb.b, !llvm.loop !5
...
bb.d:                                             ; preds = %.preheader, %bb.n
  ...
  %i.s = load i16, ptr %i.r, align 2, !tbaa !31
  %i.t = zext i16 %i.s to i32                     ; 2 uses
  %i.u = load i16, ptr %.1102.i4, align 2, !tbaa !31
  %i.v = zext i16 %i.u to i32                     ; 7 uses
...
bb.m:                                             ; preds = %bb.l, %bb.i
  ...
  %i.bz = trunc nuw nsw i32 %i.by to i16
  store i16 %i.bz, ptr %.1102.i4, align 2, !tbaa !31
  br label %bb.n
...
.preheader:                                       ; preds = %bb.b
  ...
  %i.s = load i16, ptr %i.r, align 2, !tbaa !31
  %i.t = zext i16 %i.s to i32                     ; 2 uses
  %i.u = load i16, ptr %.0101.i6, align 2, !tbaa !31
  %i.v = zext i16 %i.u to i32                     ; 7 uses
...
bb.l:                                             ; preds = %bb.k, %bb.h
  ...
  %i.ca = trunc nuw nsw i32 %i.bz to i16
  store i16 %i.ca, ptr %.0101.i6, align 2, !tbaa !31
  br label %bb.m
...
bb.n:                                             ; preds = %bb.m, %bb.f, %bb.e, %bb.d
  ...
  %i.cd = add nuw nsw i32 %.099.i5, 1             ; 2 uses
  %exitcond.not = icmp eq i32 %i.cd, 4
  br i1 %exitcond.not, label %.loopexit, label %bb.d, !llvm.loop !8

.loopexit:                                        ; preds = %bb.n, %bb.c
  %.2.i = phi ptr [ %i.m, %bb.c ], [ %i.cc, %bb.n ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond9.not = icmp eq i64 %indvars.iv.next, 4
  br i1 %exitcond9.not, label %h264_loop_filter_luma_12_c.exit, label %bb.b, !llvm.loop !9
...
.loopexit:                                        ; preds = %bb.n, %bb.c
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond9.not = icmp eq i64 %indvars.iv.next, 4
  br i1 %exitcond9.not, label %h264_loop_filter_luma_14_c.exit, label %bb.b, !llvm.loop !13
