...
bb.f:                                             ; preds = %bb.f, %.unr-lcssa
  ...
  %i.pm = call nsz <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.pl, <4 x float> %i.ot, <4 x float> %i.pj) ; 4 uses
...
celt_autocorr.exit.i.i.i:                         ; preds = %.lr.ph48.i.i.i.i.i
  %12 = extractelement <4 x float> %i.pm, i64 0
  ...
  %i.qr = fmul nsz <4 x float> %i.qo, %i.qq       ; 3 uses
  %i.qs = extractelement <4 x float> %i.qr, i64 0
  %i.qt = call nsz float @llvm.fmuladd.f32(float %i.qp, float %i.qp, float %i.qs)
  %i.qu = extractelement <4 x float> %i.qo, i64 2 ; 2 uses
  %i.qv = call nsz float @llvm.fmuladd.f32(float %i.qu, float %i.qu, float %i.qt)
  %i.qw = extractelement <4 x float> %i.qo, i64 3 ; 2 uses
  %i.qx = call nsz float @llvm.fmuladd.f32(float %i.qw, float %i.qw, float %i.qv)
  %13 = fadd nsz float %12, %i.qx
  %foldExtExtBinop = fadd nsz <4 x float> %i.pm, %i.qr
  %14 = extractelement <4 x float> %foldExtExtBinop, i64 3
  %15 = fmul nsz float %13, 1.000100e+00          ; 5 uses
  %16 = shufflevector <4 x float> %i.qo, <4 x float> poison, <2 x i32> <i32 2, i32 poison> ; 2 uses
  %17 = insertelement <2 x float> %16, float 0.000000e+00, i64 1
  %18 = insertelement <2 x float> <float poison, float -0.000000e+00>, float %i.qp, i64 0
  %19 = shufflevector <4 x float> %i.qr, <4 x float> poison, <2 x i32> <i32 1, i32 2>
  %20 = call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %17, <2 x float> %18, <2 x float> %19)
  %21 = shufflevector <4 x float> %i.qo, <4 x float> poison, <2 x i32> <i32 3, i32 3>
  %i.qy = insertelement <2 x float> %16, float %i.qp, i64 1
  %i.qz = call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %21, <2 x float> %i.qy, <2 x float> %20)
  ...
  %i.rj = insertelement <2 x float> %22, float %i.qn, i64 1 ; 2 uses
  ...
  %i.rm = fcmp nsz une float %15, 0.000000e+00
...
._crit_edge60.i.i.i.i:                            ; preds = %celt_autocorr.exit.i.i.i
  ...
  %i.si = fdiv nsz float %i.sh, %15               ; 5 uses
  %i.sj = fneg nsz float %i.si
  %i.sk = fmul nsz float %i.si, %i.sj
  %i.sl = call nsz float @llvm.fmuladd.f32(float %i.sk, float %15, float %15) ; 3 uses
  %i.sm = fmul nsz float %15, 1.000000e-03        ; 3 uses
...
bb.ay:                                            ; preds = %bb.aw
  ...
  %23 = shufflevector <4 x float> %i.avp, <4 x float> poison, <2 x i32> <i32 0, i32 1>
  %24 = shufflevector <4 x float> %i.aus, <4 x float> poison, <2 x i32> <i32 0, i32 1>
  %25 = call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %23, <2 x float> splat (float -2.000000e+00), <2 x float> %24)
  %i.avy = load <2 x float>, ptr %i.avv, align 4, !tbaa !25 ; 3 uses
  %i.avz = load float, ptr %i.avx, align 4, !tbaa !25 ; 2 uses
  %26 = shufflevector <4 x float> %i.auu, <4 x float> %i.avo, <4 x i32> <i32 0, i32 1, i32 4, i32 5> ; 2 uses
  %27 = shufflevector <2 x float> %i.avy, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %28 = shufflevector <2 x float> %i.avy, <2 x float> %25, <4 x i32> <i32 0, i32 1, i32 2, i32 3> ; 2 uses
  %29 = fsub nsz <4 x float> %26, %28
  %30 = fadd nsz <4 x float> %26, %28
  %31 = shufflevector <4 x float> %29, <4 x float> %30, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  store <4 x float> %31, ptr %i.cl, align 8, !tbaa !25
  %32 = load <2 x float>, ptr %i.avu, align 4, !tbaa !25 ; 2 uses
  %33 = load float, ptr %i.avw, align 4, !tbaa !25
  %34 = shufflevector <4 x float> %i.auu, <4 x float> poison, <2 x i32> <i32 0, i32 1>
  %35 = insertelement <2 x float> %32, float %33, i64 1
  %36 = fadd nsz <2 x float> %34, %35
  %37 = insertelement <2 x float> %i.avy, float %i.avz, i64 1
  %38 = fadd nsz <2 x float> %36, %37
  store <2 x float> %38, ptr %i.ce, align 16, !tbaa !25
  %i.awa = shufflevector <2 x float> %32, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  ...
  %39 = shufflevector <4 x float> %i.avo, <4 x float> %27, <4 x i32> <i32 2, i32 3, i32 4, i32 poison>
  %40 = insertelement <4 x float> %39, float %i.avz, i64 3
  %i.awe = fadd nsz <4 x float> %i.awd, %40
