...
bb.a:
  ...
  %i.t = alloca [864 x float], align 16           ; 105 uses
...
.lr.ph:                                           ; preds = %bb.a
  ...
  %12 = getelementptr inbounds nuw i8, ptr %i.t, i64 8
...
.unr-lcssa:                                       ; preds = %scalar.ph348
  ...
  %13 = load float, ptr %i.be, align 4, !tbaa !26
  %14 = load float, ptr %12, align 8, !tbaa !26
  %15 = insertelement <2 x float> poison, float %i.of, i64 0
...
bb.f:                                             ; preds = %bb.f, %.unr-lcssa
  ...
  %.0109123.i.i.i.i.i.i = phi ptr [ %i.bd, %.unr-lcssa ], [ %i.ok, %bb.f ] ; 4 uses
  %.0115120.i.i.i.i.i.i = phi i32 [ 0, %.unr-lcssa ], [ %i.ow, %bb.f ] ; 2 uses
  %.0118119.i.i.i.i.i.i = phi float [ %14, %.unr-lcssa ], [ %i.on, %bb.f ]
  %i.og = phi <4 x float> [ zeroinitializer, %.unr-lcssa ], [ %i.ov, %bb.f ]
  %i.oh = phi <2 x float> [ %16, %.unr-lcssa ], [ %19, %bb.f ]
  %17 = getelementptr inbounds nuw i8, ptr %.0109123.i.i.i.i.i.i, i64 4
  %i.oi = getelementptr inbounds nuw i8, ptr %.0109123.i.i.i.i.i.i, i64 12
  ...
  %i.om = load <4 x float>, ptr %.0109123.i.i.i.i.i.i, align 4, !tbaa !26 ; 4 uses
  %18 = shufflevector <4 x float> %i.om, <4 x float> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  %19 = load <2 x float>, ptr %17, align 4, !tbaa !26
  %i.on = load float, ptr %i.oi, align 4, !tbaa !26
  %i.oo = shufflevector <4 x float> %i.ol, <4 x float> poison, <4 x i32> zeroinitializer
  %20 = insertelement <4 x float> %i.om, float %.0118119.i.i.i.i.i.i, i64 1 ; 2 uses
  %21 = shufflevector <2 x float> %i.oh, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 poison, i32 poison>
  %22 = shufflevector <4 x float> %20, <4 x float> %21, <4 x i32> <i32 0, i32 1, i32 4, i32 5> ; 2 uses
  %i.op = call nsz <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.oo, <4 x float> %22, <4 x float> %i.og)
  %i.oq = shufflevector <4 x float> %i.ol, <4 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %23 = shufflevector <4 x float> %i.om, <4 x float> %22, <4 x i32> <i32 1, i32 0, i32 5, i32 6>
  %i.or = call nsz <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.oq, <4 x float> %23, <4 x float> %i.op)
  %i.os = shufflevector <4 x float> %i.ol, <4 x float> poison, <4 x i32> <i32 2, i32 2, i32 2, i32 2>
  %24 = shufflevector <4 x float> %i.om, <4 x float> %20, <4 x i32> <i32 2, i32 1, i32 0, i32 5>
  %i.ot = call nsz <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.os, <4 x float> %24, <4 x float> %i.or)
  %i.ou = shufflevector <4 x float> %i.ol, <4 x float> poison, <4 x i32> <i32 3, i32 3, i32 3, i32 3>
  %i.ov = call nsz <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ou, <4 x float> %18, <4 x float> %i.ot) ; 3 uses
...
celt_autocorr.exit.i.i.i:                         ; preds = %.lr.ph48.i.i.i.i.i
  ...
  %i.pz = fmul nsz <4 x float> %i.pw, %i.py       ; 3 uses
  ...
  %25 = shufflevector <4 x float> %i.ov, <4 x float> poison, <2 x i32> <i32 3, i32 0>
  %26 = shufflevector <4 x float> %i.pz, <4 x float> poison, <2 x i32> <i32 2, i32 3> ; 2 uses
  %i.qi = insertelement <2 x float> %26, float %i.qf, i64 0
  %i.qj = fadd nsz <2 x float> %25, %i.qi         ; 2 uses
  ...
  %27 = shufflevector <4 x float> %i.pw, <4 x float> poison, <2 x i32> <i32 poison, i32 2>
  %i.qn = insertelement <2 x float> %27, float %i.px, i64 0
  %i.qo = insertelement <2 x float> %26, float %i.qh, i64 1
  ...
  %i.qs = fmul nsz <2 x float> %i.qr, <float -1.600000e-02, float -8.000000e-03> ; 2 uses
  %i.qt = extractelement <2 x float> %i.qs, i64 1
  %i.qu = extractelement <2 x float> %i.qr, i64 1
  %i.qv = call nsz float @llvm.fmuladd.f32(float %i.qt, float 8.000000e-03, float %i.qu) ; 4 uses
  %i.qw = extractelement <2 x float> %i.qs, i64 0
  %i.qx = extractelement <2 x float> %i.qr, i64 0
...
scalar.ph348:                                     ; preds = %scalar.ph348, %scalar.ph348.prol
  ...
  %i.ri = load float, ptr %i.rh, align 4, !tbaa !26
  ...
  %28 = getelementptr i8, ptr %i.nc, i64 %.idx.i.i.i.1 ; 3 uses
  %i.ro = getelementptr i8, ptr %28, i64 -4
  %29 = load float, ptr %i.ro, align 4, !tbaa !26
  %i.rp = getelementptr inbounds nuw i8, ptr %28, i64 4
  %i.rq = load float, ptr %i.rp, align 4, !tbaa !26
  %i.rr = fadd nsz float %29, %i.rq
  %i.rs = load float, ptr %28, align 4, !tbaa !26
