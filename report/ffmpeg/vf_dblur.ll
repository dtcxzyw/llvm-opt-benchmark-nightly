...
.loopexit185:                                     ; preds = %._crit_edge, %._crit_edge195, %._crit_edge200, %.preheader188, %.preheader177.lr.ph, %.preheader186, %.preheader176.lr.ph, %.preheader184, %.preheader175.lr.ph
  ...
  %i.fo = load i32, ptr %i.fn, align 4, !tbaa !35 ; 6 uses
...
.lr.ph19.preheader.i.i:                           ; preds = %.preheader.i.i
  %i.gk = zext nneg i32 %i.fo to i64              ; 10 uses
...
.lr.ph19.i.i:                                     ; preds = %._crit_edge20.i.i, %.lr.ph19.preheader.i.i
  ...
  %2 = trunc i64 %indvars.iv51.i.i to i32
  %3 = add i32 %2, -1
  %4 = mul i32 %3, %i.fo
  %5 = zext i32 %4 to i64
  %invariant.gep77.i.i = getelementptr inbounds nuw [4 x i8], ptr %i.gb, i64 %5 ; 3 uses
...
.epil.preheader330:                               ; preds = %._crit_edge20.i.i.unr-lcssa, %.lr.ph19.i.i
  ...
  %gep78.i.i.epil = getelementptr inbounds nuw [4 x i8], ptr %invariant.gep77.i.i, i64 %indvars.iv46.i.i.epil.init
...
.lr.ph19.i.i.new:                                 ; preds = %.lr.ph19.i.i, %.lr.ph19.i.i.new
  ...
  %gep78.i.i = getelementptr inbounds nuw [4 x i8], ptr %invariant.gep77.i.i, i64 %indvars.iv46.i.i ; 2 uses
  ...
  %gep78.i.i.1 = getelementptr inbounds nuw [4 x i8], ptr %invariant.gep77.i.i, i64 %indvars.iv.next47.i.i ; 2 uses
