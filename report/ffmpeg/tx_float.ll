...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %i.bi = load float, ptr %i.bh, align 4, !tbaa !28
  ...
  %i.es = load float, ptr %i.er, align 4, !tbaa !29
  ...
  store <2 x float> %i.fu, ptr %i.ep, align 4, !tbaa !24
  ...
  %i.hp = load float, ptr %i.ho, align 4, !tbaa !28
  %i.hq = getelementptr inbounds nuw i8, ptr %.0556557, i64 12
  %i.hr = load float, ptr %i.hq, align 4, !tbaa !24 ; 3 uses
  ...
  %i.hv = load float, ptr %i.hu, align 4, !tbaa !24 ; 3 uses
  %i.hw = fneg nsz float %i.hv
  %i.hx = getelementptr i8, ptr %i.r, i64 24      ; 2 uses
  %i.hy = load float, ptr %i.hx, align 4, !tbaa !28
  %i.hz = getelementptr i8, ptr %i.r, i64 28
  %i.ia = load float, ptr %i.hz, align 4, !tbaa !29
  ...
  %i.iw = load <2 x float>, ptr %i.ib, align 4, !tbaa !24 ; 3 uses
  ...
  store float %i.je, ptr %i.hs, align 4, !tbaa !29
  %i.jf = fadd nsz <2 x float> %i.iw, %i.ix
  store <2 x float> %i.jf, ptr %i.ib, align 4, !tbaa !24
  ...
  %i.jj = load float, ptr %i.ji, align 4, !tbaa !24 ; 3 uses
  %i.jk = getelementptr i8, ptr %i.j, i64 44      ; 2 uses
  %i.jl = load float, ptr %i.jk, align 4, !tbaa !29
  %i.jm = getelementptr inbounds nuw i8, ptr %.0554559, i64 8
  %i.jn = load float, ptr %i.jm, align 4, !tbaa !24 ; 3 uses
  %i.jo = fneg nsz float %i.jn
  %i.jp = getelementptr i8, ptr %i.r, i64 40      ; 2 uses
  %i.jq = load float, ptr %i.jp, align 4, !tbaa !28
  %i.jr = getelementptr i8, ptr %i.r, i64 44
  %i.js = load float, ptr %i.jr, align 4, !tbaa !29
  ...
  %i.ko = load <2 x float>, ptr %i.jt, align 4, !tbaa !24 ; 3 uses
  ...
  store float %i.kw, ptr %i.jk, align 4, !tbaa !29
  %i.kx = fadd nsz <2 x float> %i.ko, %i.kp
  store <2 x float> %i.kx, ptr %i.jt, align 4, !tbaa !24
  %i.ky = getelementptr i8, ptr %i.j, i64 56      ; 2 uses
  %i.kz = load float, ptr %i.ky, align 4, !tbaa !28
  %i.la = getelementptr inbounds nuw i8, ptr %.0556557, i64 28
  %i.lb = load float, ptr %i.la, align 4, !tbaa !24 ; 3 uses
  %i.lc = getelementptr i8, ptr %i.j, i64 60      ; 2 uses
  %i.ld = load float, ptr %i.lc, align 4, !tbaa !29
  %i.le = load float, ptr %.0554559, align 4, !tbaa !24 ; 3 uses
  %i.lf = fneg nsz float %i.le
  %i.lg = getelementptr i8, ptr %i.r, i64 56      ; 2 uses
  %i.lh = load float, ptr %i.lg, align 4, !tbaa !28
  %i.li = getelementptr i8, ptr %i.r, i64 60
  %i.lj = load float, ptr %i.li, align 4, !tbaa !29
  ...
  br i1 %i.mp, label %bb.b, label %._crit_edge, !llvm.loop !62
}
...
bb.d:                                             ; preds = %bb.b, %bb.c
  ...
  %.sroa.6.0 = phi nsz float [ %i.bg, %bb.b ], [ %i.bv, %bb.c ]
  %i.bw = ashr i32 %i.x, 1
  %i.bx = sext i32 %i.bw to i64
  %i.by = getelementptr inbounds [8 x i8], ptr %i.b, i64 %i.bx
  %i.bz = load <2 x float>, ptr %i.by, align 4, !tbaa !24 ; 2 uses
  %i.ca = shufflevector <2 x float> %i.bz, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.cb = insertelement <2 x float> poison, float %.sroa.6.0, i64 0
  %i.cc = shufflevector <2 x float> %i.cb, <2 x float> poison, <2 x i32> zeroinitializer
  %i.cd = fneg nsz <2 x float> %i.ca
  %i.ce = shufflevector <2 x float> %i.bz, <2 x float> %i.cd, <2 x i32> <i32 0, i32 2>
  %i.cf = fmul nsz <2 x float> %i.cc, %i.ce
  ...
  %i.ci = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ch, <2 x float> %i.ca, <2 x float> %i.cf) ; 2 uses
  ...
  %i.cp = getelementptr inbounds [4 x i8], ptr %2, i64 %i.co
  %i.cq = load float, ptr %i.cp, align 4, !tbaa !24 ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.cv = load float, ptr %i.cu, align 4, !tbaa !24
  %i.cw = fadd nsz float %i.cq, %i.cv
  %i.cx = fneg nsz float %i.cw
  %i.cy = sub nuw nsw i32 %i.cl, %i.f
  %i.cz = zext nneg i32 %i.cy to i64
  %i.da = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %i.cz
...
bb.f:                                             ; preds = %bb.d
  ...
  %i.ds = getelementptr inbounds [4 x i8], ptr %2, i64 %i.dr
  %i.dt = load float, ptr %i.ds, align 4, !tbaa !24
  %i.du = fadd nsz float %i.dp, %i.dt
  %i.dv = fneg nsz float %i.du
  br label %bb.g

bb.g:                                             ; preds = %bb.f, %bb.e
  %.sroa.077.0.1 = phi nsz float [ %i.dl, %bb.f ], [ %i.cx, %bb.e ]
  %.sroa.6.0.1 = phi nsz float [ %i.dv, %bb.f ], [ %i.dg, %bb.e ]
  %i.dw = ashr i32 %i.cl, 1
  %i.dx = sext i32 %i.dw to i64
  %i.dy = getelementptr inbounds [8 x i8], ptr %i.b, i64 %i.dx
  %i.dz = load <2 x float>, ptr %i.dy, align 4, !tbaa !24 ; 2 uses
  %i.ea = shufflevector <2 x float> %i.dz, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.eb = insertelement <2 x float> poison, float %.sroa.6.0.1, i64 0
  %i.ec = shufflevector <2 x float> %i.eb, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ed = fneg nsz <2 x float> %i.ea
  %i.ee = shufflevector <2 x float> %i.dz, <2 x float> %i.ed, <2 x i32> <i32 0, i32 2>
  %i.ef = fmul nsz <2 x float> %i.ec, %i.ee
  %i.eg = insertelement <2 x float> poison, float %.sroa.077.0.1, i64 0
  %i.eh = shufflevector <2 x float> %i.eg, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ei = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.eh, <2 x float> %i.ea, <2 x float> %i.ef) ; 2 uses
  ...
  %i.eq = load float, ptr %i.ep, align 4, !tbaa !24 ; 2 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.eu = getelementptr inbounds [4 x i8], ptr %2, i64 %i.et
  %i.ev = load float, ptr %i.eu, align 4, !tbaa !24
  %i.ew = fadd nsz float %i.eq, %i.ev
  %i.ex = fneg nsz float %i.ew
  %i.ey = sub nuw nsw i32 %i.el, %i.f
  %i.ez = zext nneg i32 %i.ey to i64
  %i.fa = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %i.ez
  %i.fb = load float, ptr %i.fa, align 4, !tbaa !24
...
bb.d:                                             ; preds = %bb.b, %bb.c
  ...
  %.sroa.6.0 = phi nsz float [ %i.bo, %bb.b ], [ %i.cd, %bb.c ]
  %i.ce = ashr i32 %i.x, 1
  %i.cf = sext i32 %i.ce to i64
  %i.cg = getelementptr inbounds [8 x i8], ptr %i.b, i64 %i.cf
  %i.ch = load <2 x float>, ptr %i.cg, align 4, !tbaa !24 ; 2 uses
  %i.ci = shufflevector <2 x float> %i.ch, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.cj = insertelement <2 x float> poison, float %.sroa.6.0, i64 0
  %i.ck = shufflevector <2 x float> %i.cj, <2 x float> poison, <2 x i32> zeroinitializer
  %i.cl = fneg nsz <2 x float> %i.ci
  %i.cm = shufflevector <2 x float> %i.ch, <2 x float> %i.cl, <2 x i32> <i32 0, i32 2>
  ...
  %i.cq = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cp, <2 x float> %i.ci, <2 x float> %i.cn) ; 5 uses
...
bb.f:                                             ; preds = %bb.d
  ...
  %i.ds = load float, ptr %i.dr, align 4, !tbaa !24
  %i.dt = fsub nsz float %i.ds, %i.cy
  %i.du = add nsw i32 %i.ct, %i.g
  %i.dv = sext i32 %i.du to i64
  %i.dw = getelementptr inbounds [4 x i8], ptr %2, i64 %i.dv
  %i.dx = load float, ptr %i.dw, align 4, !tbaa !24
  %i.dy = add i32 %i.g, %i.cz
  %i.dz = sext i32 %i.dy to i64
  %i.ea = getelementptr inbounds [4 x i8], ptr %2, i64 %i.dz
  %i.eb = load float, ptr %i.ea, align 4, !tbaa !24
  %i.ec = fadd nsz float %i.dx, %i.eb
  %i.ed = fneg nsz float %i.ec
  br label %bb.g

bb.g:                                             ; preds = %bb.f, %bb.e
  %.sroa.077.0.1 = phi nsz float [ %i.dt, %bb.f ], [ %i.df, %bb.e ]
  %.sroa.6.0.1 = phi nsz float [ %i.ed, %bb.f ], [ %i.do, %bb.e ]
  %i.ee = ashr i32 %i.ct, 1
  %i.ef = sext i32 %i.ee to i64
  %i.eg = getelementptr inbounds [8 x i8], ptr %i.b, i64 %i.ef
  %i.eh = load <2 x float>, ptr %i.eg, align 4, !tbaa !24 ; 2 uses
  %i.ei = shufflevector <2 x float> %i.eh, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.ej = insertelement <2 x float> poison, float %.sroa.6.0.1, i64 0
  %i.ek = shufflevector <2 x float> %i.ej, <2 x float> poison, <2 x i32> zeroinitializer
  %i.el = fneg nsz <2 x float> %i.ei
  %i.em = shufflevector <2 x float> %i.eh, <2 x float> %i.el, <2 x i32> <i32 0, i32 2>
  %i.en = fmul nsz <2 x float> %i.ek, %i.em
  %i.eo = insertelement <2 x float> poison, float %.sroa.077.0.1, i64 0
  %i.ep = shufflevector <2 x float> %i.eo, <2 x float> poison, <2 x i32> zeroinitializer
  %i.eq = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ep, <2 x float> %i.ei, <2 x float> %i.en) ; 2 uses
  ...
  %i.ey = load float, ptr %i.ex, align 4, !tbaa !24 ; 2 uses
...
begin_hunk_3_@ff_tx_mdct_pfa_5xM_fwd_float_c:bb.a
  %i.io = insertelement <2 x float> poison, float %.sroa.077.0.3, i64 0
  %i.ip = shufflevector <2 x float> %i.io, <2 x float> poison, <2 x i32> zeroinitializer
  %i.iq = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ip, <2 x float> %i.ii, <2 x float> %i.in) ; 2 uses
...
bb.n:                                             ; preds = %bb.m
  ...
  %i.je = fadd nsz float %i.iy, %i.jd
  %i.jf = fneg nsz float %i.je
  %i.jg = sub nuw nsw i32 %i.it, %i.f
  %i.jh = zext nneg i32 %i.jg to i64
  %i.ji = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %i.jh
  %i.jj = load float, ptr %i.ji, align 4, !tbaa !24
  %i.jk = add i32 %i.g, %i.iz
  %i.jl = sext i32 %i.jk to i64
  %i.jm = getelementptr inbounds [4 x i8], ptr %2, i64 %i.jl
  %i.jn = load float, ptr %i.jm, align 4, !tbaa !24
  %i.jo = fsub nsz float %i.jj, %i.jn
  br label %bb.p
...
bb.o:                                             ; preds = %bb.m
  ...
  %i.js = load float, ptr %i.jr, align 4, !tbaa !24
  %i.jt = fsub nsz float %i.js, %i.iy
  %i.ju = add nsw i32 %i.it, %i.g
  %i.jv = sext i32 %i.ju to i64
  %i.jw = getelementptr inbounds [4 x i8], ptr %2, i64 %i.jv
  %i.jx = load float, ptr %i.jw, align 4, !tbaa !24
  %i.jy = add i32 %i.g, %i.iz
  %i.jz = sext i32 %i.jy to i64
  %i.ka = getelementptr inbounds [4 x i8], ptr %2, i64 %i.jz
  %i.kb = load float, ptr %i.ka, align 4, !tbaa !24
  %i.kc = fadd nsz float %i.jx, %i.kb
  %i.kd = fneg nsz float %i.kc
  br label %bb.p

bb.p:                                             ; preds = %bb.o, %bb.n
  %.sroa.077.0.4 = phi nsz float [ %i.jt, %bb.o ], [ %i.jf, %bb.n ]
  %.sroa.6.0.4 = phi nsz float [ %i.kd, %bb.o ], [ %i.jo, %bb.n ]
  %i.ke = ashr i32 %i.it, 1
  %i.kf = sext i32 %i.ke to i64
  %i.kg = getelementptr inbounds [8 x i8], ptr %i.b, i64 %i.kf
  ...
  %i.kk = getelementptr inbounds [8 x i8], ptr %i.t, i64 %i.kj ; 5 uses
  %i.kl = fsub nsz <2 x float> %i.gq, %i.iq       ; 2 uses
  %i.km = fadd nsz <2 x float> %i.gq, %i.iq       ; 3 uses
  %i.kn = getelementptr inbounds nuw [8 x i8], ptr %i.kk, i64 %i.u
  ...
  %i.kr = load <2 x float>, ptr %i.kg, align 4, !tbaa !24 ; 2 uses
  %i.ks = shufflevector <2 x float> %i.kr, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.kt = insertelement <2 x float> poison, float %.sroa.6.0.4, i64 0
  %i.ku = shufflevector <2 x float> %i.kt, <2 x float> poison, <2 x i32> zeroinitializer
  %i.kv = fneg nsz <2 x float> %i.ks
  %i.kw = shufflevector <2 x float> %i.kr, <2 x float> %i.kv, <2 x i32> <i32 0, i32 2>
  %i.kx = fmul nsz <2 x float> %i.ku, %i.kw
  %i.ky = insertelement <2 x float> poison, float %.sroa.077.0.4, i64 0
  %i.kz = shufflevector <2 x float> %i.ky, <2 x float> poison, <2 x i32> zeroinitializer
  %i.la = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.kz, <2 x float> %i.ks, <2 x float> %i.kx) ; 2 uses
  %i.lb = fsub nsz <2 x float> %i.eq, %i.la       ; 2 uses
  %i.lc = fadd nsz <2 x float> %i.eq, %i.la       ; 3 uses
  %i.ld = fadd nsz <2 x float> %i.cq, %i.lc
  %i.le = fadd nsz <2 x float> %i.ld, %i.km
  store <2 x float> %i.le, ptr %i.kk, align 4, !tbaa !24
  %i.lf = load <4 x float>, ptr @ff_tx_tab_53_float, align 16
  %i.lg = load <4 x float>, ptr getelementptr inbounds nuw (i8, ptr @ff_tx_tab_53_float, i64 8), align 8
  %i.lh = fneg nsz <2 x float> %i.km
  %i.li = shufflevector <4 x float> %i.lg, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.lj = fmul nsz <2 x float> %i.li, %i.lh
  %i.lk = shufflevector <4 x float> %i.lf, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.ll = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.lk, <2 x float> %i.lc, <2 x float> %i.lj) ; 2 uses
  %i.lm = load <4 x float>, ptr getelementptr inbounds nuw (i8, ptr @ff_tx_tab_53_float, i64 16), align 16
  %i.ln = load <4 x float>, ptr getelementptr inbounds nuw (i8, ptr @ff_tx_tab_53_float, i64 24), align 8
  %i.lo = shufflevector <4 x float> %i.ln, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.lp = fmul nsz <2 x float> %i.kl, %i.lo
  %i.lq = shufflevector <4 x float> %i.lm, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.lr = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.lq, <2 x float> %i.lb, <2 x float> %i.lp)
  %i.ls = shufflevector <2 x float> %i.lr, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.lt = fsub nsz <2 x float> %i.ll, %i.ls       ; 2 uses
  %i.lu = fadd nsz <2 x float> %i.ll, %i.ls       ; 2 uses
  %i.lv = shufflevector <2 x float> %i.lt, <2 x float> %i.lu, <2 x i32> <i32 0, i32 3>
  %i.lw = shufflevector <2 x float> %i.lu, <2 x float> %i.lt, <2 x i32> <i32 0, i32 3>
  %i.lx = fadd nsz <2 x float> %i.cq, %i.lw
  store <2 x float> %i.lx, ptr %i.kn, align 4, !tbaa !24
  %i.ly = fneg nsz <2 x float> %i.lc
  %i.lz = fmul nsz <2 x float> %i.li, %i.ly
  %i.ma = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.lk, <2 x float> %i.km, <2 x float> %i.lz) ; 2 uses
  %i.mb = fneg nsz <2 x float> %i.lb
  %i.mc = fmul nsz <2 x float> %i.lo, %i.mb
  %i.md = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.lq, <2 x float> %i.kl, <2 x float> %i.mc)
  %i.me = shufflevector <2 x float> %i.md, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.mf = fadd nsz <2 x float> %i.ma, %i.me       ; 2 uses
  %i.mg = fsub nsz <2 x float> %i.ma, %i.me       ; 2 uses
  %i.mh = shufflevector <2 x float> %i.mf, <2 x float> %i.mg, <2 x i32> <i32 0, i32 3>
  %i.mi = shufflevector <2 x float> %i.mg, <2 x float> %i.mf, <2 x i32> <i32 0, i32 3>
  %i.mj = fadd nsz <2 x float> %i.cq, %i.mi
  store <2 x float> %i.mj, ptr %i.ko, align 4, !tbaa !24
  %i.mk = fadd nsz <2 x float> %i.cq, %i.mh
  store <2 x float> %i.mk, ptr %i.kp, align 4, !tbaa !24
  %i.ml = fadd nsz <2 x float> %i.cq, %i.lv
  store <2 x float> %i.ml, ptr %i.kq, align 4, !tbaa !24
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
...
.lr.ph:                                           ; preds = %.preheader136
  %i.mm = load ptr, ptr %i.ag, align 8, !tbaa !31 ; 2 uses
...
bb.q:                                             ; preds = %.lr.ph, %bb.q
  ...
  %i.mw = getelementptr inbounds [8 x i8], ptr %i.mm, i64 %i.mv ; 2 uses
  %i.mx = load float, ptr %i.mw, align 4, !tbaa !28 ; 2 uses
  %i.my = getelementptr inbounds nuw i8, ptr %i.mw, i64 4
  %i.mz = load float, ptr %i.my, align 4, !tbaa !29 ; 2 uses
  %i.na = sext i32 %i.ms to i64
  %i.nb = getelementptr inbounds [8 x i8], ptr %i.mm, i64 %i.na ; 2 uses
  %i.nc = load float, ptr %i.nb, align 4, !tbaa !28 ; 2 uses
  %i.nd = getelementptr inbounds nuw i8, ptr %i.nb, i64 4
  %i.ne = load float, ptr %i.nd, align 4, !tbaa !29 ; 2 uses
  %i.nf = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %i.mo ; 3 uses
  %i.ng = getelementptr inbounds nuw i8, ptr %i.nf, i64 4 ; 2 uses
  %i.nh = load float, ptr %i.ng, align 4, !tbaa !29
  %i.ni = load float, ptr %i.nf, align 4, !tbaa !28
  %i.nj = fneg nsz float %i.ni
  %i.nk = fmul nsz float %i.ne, %i.nj
  %i.nl = tail call nsz float @llvm.fmuladd.f32(float %i.nc, float %i.nh, float %i.nk)
  %i.nm = shl nsw i64 %i.mq, 1
  %i.nn = mul nsw i64 %i.p, %i.nm
  %i.no = getelementptr [4 x i8], ptr %1, i64 %i.nn ; 2 uses
  %i.np = getelementptr [4 x i8], ptr %i.no, i64 %i.p
  store float %i.nl, ptr %i.np, align 4, !tbaa !24
  %i.nq = load float, ptr %i.nf, align 4, !tbaa !28
  %i.nr = load float, ptr %i.ng, align 4, !tbaa !29
  %i.ns = fmul nsz float %i.ne, %i.nr
  %i.nt = tail call nsz float @llvm.fmuladd.f32(float %i.nc, float %i.nq, float %i.ns)
  %i.nu = shl nuw nsw i64 %i.mo, 1
  %i.nv = mul nuw nsw i64 %i.p, %i.nu
  %i.nw = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.nv ; 2 uses
  store float %i.nt, ptr %i.nw, align 4, !tbaa !24
  %i.nx = getelementptr inbounds [8 x i8], ptr %i.b, i64 %i.mq ; 3 uses
  %i.ny = getelementptr inbounds nuw i8, ptr %i.nx, i64 4 ; 2 uses
  %i.nz = load float, ptr %i.ny, align 4, !tbaa !29
  %i.oa = load float, ptr %i.nx, align 4, !tbaa !28
  %i.ob = fneg nsz float %i.oa
  %i.oc = fmul nsz float %i.mz, %i.ob
  %i.od = tail call nsz float @llvm.fmuladd.f32(float %i.mx, float %i.nz, float %i.oc)
  %i.oe = getelementptr [4 x i8], ptr %i.nw, i64 %i.p
  store float %i.od, ptr %i.oe, align 4, !tbaa !24
  %i.of = load float, ptr %i.nx, align 4, !tbaa !28
  %i.og = load float, ptr %i.ny, align 4, !tbaa !29
  %i.oh = fmul nsz float %i.mz, %i.og
  %i.oi = tail call nsz float @llvm.fmuladd.f32(float %i.mx, float %i.of, float %i.oh)
  store float %i.oi, ptr %i.no, align 4, !tbaa !24
  %indvars.iv.next149 = add nuw nsw i64 %indvars.iv148, 1 ; 2 uses
  %exitcond152.not = icmp eq i64 %indvars.iv.next149, %wide.trip.count151
...
bb.f:                                             ; preds = %bb.d, %bb.e
  ...
  %.sroa.6.0 = phi nsz float [ %i.gi, %bb.d ], [ %i.gx, %bb.e ]
  ...
  %i.hc = load <2 x float>, ptr %i.ha, align 4, !tbaa !24 ; 2 uses
  %i.hd = shufflevector <2 x float> %i.hc, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.he = insertelement <2 x float> poison, float %.sroa.6.0, i64 0
  %i.hf = shufflevector <2 x float> %i.he, <2 x float> poison, <2 x i32> zeroinitializer
  %i.hg = fneg nsz <2 x float> %i.hd
  %i.hh = shufflevector <2 x float> %i.hc, <2 x float> %i.hg, <2 x i32> <i32 0, i32 2>
  %i.hi = fmul nsz <2 x float> %i.hf, %i.hh
  ...
  %i.hl = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.hk, <2 x float> %i.hd, <2 x float> %i.hi)
  store <2 x float> %i.hl, ptr %i.hb, align 8, !tbaa !24
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, 7
  br i1 %exitcond.not, label %bb.b, label %bb.c, !llvm.loop !101

.lr.ph:                                           ; preds = %.preheader136
  %i.hm = load ptr, ptr %i.ae, align 8, !tbaa !31 ; 2 uses
  %i.hn = zext nneg i32 %i.i to i64               ; 2 uses
...
bb.g:                                             ; preds = %.lr.ph, %bb.g
  ...
  %i.ho = add nuw nsw i64 %indvars.iv151, %i.hn   ; 3 uses
  %i.hp = xor i64 %indvars.iv151, -1
  %i.hq = add nsw i64 %i.hn, %i.hp                ; 3 uses
  %i.hr = getelementptr inbounds nuw [4 x i8], ptr %i.m, i64 %i.ho
  %i.hs = load i32, ptr %i.hr, align 4, !tbaa !12
  %i.ht = getelementptr inbounds [4 x i8], ptr %i.m, i64 %i.hq
  %i.hu = load i32, ptr %i.ht, align 4, !tbaa !12
  %i.hv = sext i32 %i.hu to i64
  %i.hw = getelementptr inbounds [8 x i8], ptr %i.hm, i64 %i.hv ; 2 uses
  %i.hx = load float, ptr %i.hw, align 4, !tbaa !28 ; 2 uses
...
bb.b:                                             ; preds = %bb.f
  ...
  %i.dd = load <4 x float>, ptr getelementptr inbounds nuw (i8, ptr @ff_tx_tab_9_float, i64 12), align 4
  %i.de = load <4 x float>, ptr getelementptr inbounds nuw (i8, ptr @ff_tx_tab_9_float, i64 8), align 8
  %i.df = load <2 x float>, ptr @ff_tx_tab_9_float, align 16, !tbaa !24 ; 3 uses
  %i.dg = fsub nsz <2 x float> %i.cf, %i.cj
  %i.dh = fadd nsz <2 x float> %i.dg, %i.cr
  %i.di = shufflevector <2 x float> %i.df, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.dj = fmul nsz <2 x float> %i.dh, %i.di
  %i.dk = shufflevector <2 x float> %i.dj, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.dl = shufflevector <2 x float> %i.df, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.dm = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.dl, <2 x float> %i.db, <2 x float> %i.cz) ; 2 uses
  %i.dn = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.dl, <2 x float> %i.co, <2 x float> %i.cc) ; 3 uses
  %i.do = shufflevector <4 x float> %i.de, <4 x float> poison, <2 x i32> zeroinitializer
  %i.dp = shufflevector <4 x float> %i.dd, <4 x float> poison, <2 x i32> zeroinitializer
  %i.dq = shufflevector <2 x float> %i.df, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.dr = fmul nsz <2 x float> %i.cn, %i.dq       ; 3 uses
  %i.ds = fsub nsz <2 x float> %i.dm, %i.dk       ; 2 uses
  %i.dt = fadd nsz <2 x float> %i.dm, %i.dk       ; 2 uses
  %i.du = shufflevector <2 x float> %i.ds, <2 x float> %i.dt, <2 x i32> <i32 0, i32 3>
  %i.dv = load <4 x float>, ptr getelementptr inbounds nuw (i8, ptr @ff_tx_tab_9_float, i64 16), align 16, !tbaa !24 ; 6 uses
  %i.dw = shufflevector <4 x float> %i.dv, <4 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.dx = fmul nsz <2 x float> %i.cu, %i.dw
  %i.dy = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.do, <2 x float> %i.ct, <2 x float> %i.dx) ; 2 uses
  %i.dz = shufflevector <4 x float> %i.dv, <4 x float> poison, <2 x i32> <i32 2, i32 2>
  %i.ea = fmul nsz <2 x float> %i.dz, %i.cx
  %i.eb = shufflevector <4 x float> %i.dv, <4 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.ec = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.eb, <2 x float> %i.ct, <2 x float> %i.ea) ; 2 uses
  %i.ed = shufflevector <4 x float> %i.dv, <4 x float> poison, <2 x i32> zeroinitializer
  %i.ee = shufflevector <4 x float> %i.dv, <4 x float> poison, <2 x i32> zeroinitializer
  %i.ef = fmul nsz <2 x float> %i.cw, %i.ee
  %i.eg = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.dp, <2 x float> %i.cv, <2 x float> %i.ef) ; 2 uses
  %i.eh = shufflevector <4 x float> %i.dv, <4 x float> poison, <2 x i32> <i32 3, i32 3>
  %i.ei = fmul nsz <2 x float> %i.eh, %i.cy
  %i.ej = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ed, <2 x float> %i.cv, <2 x float> %i.ei) ; 2 uses
  %i.ek = fadd nsz <2 x float> %i.dn, %i.dy       ; 2 uses
  %i.el = fadd nsz <2 x float> %i.dr, %i.eg
  %i.em = shufflevector <2 x float> %i.el, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.en = fadd nsz <2 x float> %i.dn, %i.ec       ; 2 uses
  %i.eo = fsub nsz <2 x float> %i.ej, %i.dr
  %i.ep = shufflevector <2 x float> %i.eo, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.eq = fadd nsz <2 x float> %i.ek, %i.em       ; 2 uses
  %i.er = fsub nsz <2 x float> %i.ek, %i.em       ; 2 uses
  %i.es = shufflevector <2 x float> %i.eq, <2 x float> %i.er, <2 x i32> <i32 0, i32 3>
  store <2 x float> %i.es, ptr %i.bu, align 4, !tbaa !24
  %i.et = fadd nsz <2 x float> %i.en, %i.ep       ; 2 uses
  %i.eu = fsub nsz <2 x float> %i.en, %i.ep       ; 2 uses
  %i.ev = shufflevector <2 x float> %i.et, <2 x float> %i.eu, <2 x i32> <i32 0, i32 3>
  store <2 x float> %i.ev, ptr %i.bv, align 4, !tbaa !24
  %i.ew = shufflevector <2 x float> %i.dt, <2 x float> %i.ds, <2 x i32> <i32 0, i32 3>
  store <2 x float> %i.ew, ptr %i.bw, align 4, !tbaa !24
  %i.ex = fadd nsz <2 x float> %i.dy, %i.ec
  %i.ey = fsub nsz <2 x float> %i.dn, %i.ex       ; 2 uses
  %i.ez = fsub nsz <2 x float> %i.ej, %i.eg
  %i.fa = fadd nsz <2 x float> %i.dr, %i.ez
  %i.fb = shufflevector <2 x float> %i.fa, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.fc = fadd nsz <2 x float> %i.ey, %i.fb       ; 2 uses
  %i.fd = fsub nsz <2 x float> %i.ey, %i.fb       ; 2 uses
  %i.fe = shufflevector <2 x float> %i.fc, <2 x float> %i.fd, <2 x i32> <i32 0, i32 3>
  store <2 x float> %i.fe, ptr %i.bx, align 4, !tbaa !24
  %i.ff = shufflevector <2 x float> %i.fd, <2 x float> %i.fc, <2 x i32> <i32 0, i32 3>
  store <2 x float> %i.ff, ptr %i.by, align 4, !tbaa !24
  store <2 x float> %i.du, ptr %i.bz, align 4, !tbaa !24
  %i.fg = shufflevector <2 x float> %i.eu, <2 x float> %i.et, <2 x i32> <i32 0, i32 3>
  store <2 x float> %i.fg, ptr %i.ca, align 4, !tbaa !24
  %i.fh = shufflevector <2 x float> %i.er, <2 x float> %i.eq, <2 x i32> <i32 0, i32 3>
  store <2 x float> %i.fh, ptr %i.cb, align 4, !tbaa !24
  %indvars.iv.next144 = add nuw nsw i64 %indvars.iv143, 1 ; 2 uses
  %exitcond146.not = icmp eq i64 %indvars.iv.next144, %i.u
...
bb.c:                                             ; preds = %.preheader137, %bb.f
  %indvars.iv = phi i64 [ 0, %.preheader137 ], [ %indvars.iv.next, %bb.f ] ; 3 uses
  %gep = getelementptr inbounds nuw [4 x i8], ptr %invariant.gep, i64 %indvars.iv
  %i.fi = load i32, ptr %gep, align 4, !tbaa !12  ; 6 uses
  %i.fj = icmp slt i32 %i.fi, %i.f
  %i.fk = add nsw i32 %i.fi, %i.f
  %i.fl = sext i32 %i.fk to i64
  %i.fm = getelementptr inbounds [4 x i8], ptr %2, i64 %i.fl
  %i.fn = load float, ptr %i.fm, align 4, !tbaa !24 ; 2 uses
  %i.fo = xor i32 %i.fi, -1                       ; 4 uses
  br i1 %i.fj, label %bb.d, label %bb.e

bb.d:                                             ; preds = %bb.c
  %i.fp = add i32 %i.f, %i.fo
  %i.fq = sext i32 %i.fp to i64
  %i.fr = getelementptr inbounds [4 x i8], ptr %2, i64 %i.fq
  %i.fs = load float, ptr %i.fr, align 4, !tbaa !24
  %i.ft = fsub nsz float %i.fs, %i.fn
  %i.fu = add nsw i32 %i.fi, %i.g
  %i.fv = sext i32 %i.fu to i64
  %i.fw = getelementptr inbounds [4 x i8], ptr %2, i64 %i.fv
  %i.fx = load float, ptr %i.fw, align 4, !tbaa !24
  %i.fy = add i32 %i.g, %i.fo
  %i.fz = sext i32 %i.fy to i64
  %i.ga = getelementptr inbounds [4 x i8], ptr %2, i64 %i.fz
  %i.gb = load float, ptr %i.ga, align 4, !tbaa !24
  %i.gc = fadd nsz float %i.fx, %i.gb
  %i.gd = fneg nsz float %i.gc
  br label %bb.f

bb.e:                                             ; preds = %bb.c
  %i.ge = add i32 %i.r, %i.fo
  %i.gf = sext i32 %i.ge to i64
  %i.gg = getelementptr inbounds [4 x i8], ptr %2, i64 %i.gf
  %i.gh = load float, ptr %i.gg, align 4, !tbaa !24
  %i.gi = fadd nsz float %i.fn, %i.gh
  %i.gj = fneg nsz float %i.gi
  %i.gk = sub nuw nsw i32 %i.fi, %i.f
  %i.gl = zext nneg i32 %i.gk to i64
  %i.gm = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %i.gl
  %i.gn = load float, ptr %i.gm, align 4, !tbaa !24
  %i.go = add i32 %i.g, %i.fo
  %i.gp = sext i32 %i.go to i64
  %i.gq = getelementptr inbounds [4 x i8], ptr %2, i64 %i.gp
  %i.gr = load float, ptr %i.gq, align 4, !tbaa !24
  %i.gs = fsub nsz float %i.gn, %i.gr
  br label %bb.f

bb.f:                                             ; preds = %bb.d, %bb.e
  %.sroa.077.0 = phi nsz float [ %i.ft, %bb.d ], [ %i.gj, %bb.e ]
  %.sroa.6.0 = phi nsz float [ %i.gd, %bb.d ], [ %i.gs, %bb.e ]
  %i.gt = ashr i32 %i.fi, 1
  %i.gu = sext i32 %i.gt to i64
  %i.gv = getelementptr inbounds [8 x i8], ptr %i.b, i64 %i.gu
  %i.gw = getelementptr inbounds nuw [8 x i8], ptr %4, i64 %indvars.iv
  %i.gx = load <2 x float>, ptr %i.gv, align 4, !tbaa !24 ; 2 uses
  %i.gy = shufflevector <2 x float> %i.gx, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.gz = insertelement <2 x float> poison, float %.sroa.6.0, i64 0
  %i.ha = shufflevector <2 x float> %i.gz, <2 x float> poison, <2 x i32> zeroinitializer
  %i.hb = fneg nsz <2 x float> %i.gy
  %i.hc = shufflevector <2 x float> %i.gx, <2 x float> %i.hb, <2 x i32> <i32 0, i32 2>
  %i.hd = fmul nsz <2 x float> %i.ha, %i.hc
  %i.he = insertelement <2 x float> poison, float %.sroa.077.0, i64 0
  %i.hf = shufflevector <2 x float> %i.he, <2 x float> poison, <2 x i32> zeroinitializer
  %i.hg = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.hf, <2 x float> %i.gy, <2 x float> %i.hd)
  store <2 x float> %i.hg, ptr %i.gw, align 8, !tbaa !24
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, 9
  br i1 %exitcond.not, label %bb.b, label %bb.c, !llvm.loop !104

.lr.ph:                                           ; preds = %.preheader136
  %i.hh = load ptr, ptr %i.af, align 8, !tbaa !31 ; 2 uses
  %i.hi = zext nneg i32 %i.i to i64               ; 2 uses
  %wide.trip.count154 = zext nneg i32 %i.i to i64
  br label %bb.g
...
bb.g:                                             ; preds = %.lr.ph, %bb.g
  %indvars.iv151 = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next152, %bb.g ] ; 3 uses
  %i.hj = add nuw nsw i64 %indvars.iv151, %i.hi   ; 3 uses
  %i.hk = xor i64 %indvars.iv151, -1
  %i.hl = add nsw i64 %i.hi, %i.hk                ; 3 uses
  %i.hm = getelementptr inbounds nuw [4 x i8], ptr %i.m, i64 %i.hj
  %i.hn = load i32, ptr %i.hm, align 4, !tbaa !12
  %i.ho = getelementptr inbounds [4 x i8], ptr %i.m, i64 %i.hl
  %i.hp = load i32, ptr %i.ho, align 4, !tbaa !12
  %i.hq = sext i32 %i.hp to i64
  %i.hr = getelementptr inbounds [8 x i8], ptr %i.hh, i64 %i.hq ; 2 uses
  %i.hs = load float, ptr %i.hr, align 4, !tbaa !28 ; 2 uses
  %i.ht = getelementptr inbounds nuw i8, ptr %i.hr, i64 4
  %i.hu = load float, ptr %i.ht, align 4, !tbaa !29 ; 2 uses
  %i.hv = sext i32 %i.hn to i64
  %i.hw = getelementptr inbounds [8 x i8], ptr %i.hh, i64 %i.hv ; 2 uses
  %i.hx = load float, ptr %i.hw, align 4, !tbaa !28 ; 2 uses
  %i.hy = getelementptr inbounds nuw i8, ptr %i.hw, i64 4
  %i.hz = load float, ptr %i.hy, align 4, !tbaa !29 ; 2 uses
  %i.ia = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %i.hj ; 3 uses
  %i.ib = getelementptr inbounds nuw i8, ptr %i.ia, i64 4 ; 2 uses
  %i.ic = load float, ptr %i.ib, align 4, !tbaa !29
  %i.id = load float, ptr %i.ia, align 4, !tbaa !28
  %i.ie = fneg nsz float %i.id
  %i.if = fmul nsz float %i.hz, %i.ie
  %i.ig = tail call nsz float @llvm.fmuladd.f32(float %i.hx, float %i.ic, float %i.if)
  %i.ih = shl nsw i64 %i.hl, 1
  %i.ii = mul nsw i64 %i.p, %i.ih
  %i.ij = getelementptr [4 x i8], ptr %1, i64 %i.ii ; 2 uses
  %i.ik = getelementptr [4 x i8], ptr %i.ij, i64 %i.p
  store float %i.ig, ptr %i.ik, align 4, !tbaa !24
  %i.il = load float, ptr %i.ia, align 4, !tbaa !28
  %i.im = load float, ptr %i.ib, align 4, !tbaa !29
  %i.in = fmul nsz float %i.hz, %i.im
  %i.io = tail call nsz float @llvm.fmuladd.f32(float %i.hx, float %i.il, float %i.in)
  %i.ip = shl nuw nsw i64 %i.hj, 1
  %i.iq = mul nuw nsw i64 %i.p, %i.ip
  %i.ir = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.iq ; 2 uses
  store float %i.io, ptr %i.ir, align 4, !tbaa !24
  %i.is = getelementptr inbounds [8 x i8], ptr %i.b, i64 %i.hl ; 3 uses
  %i.it = getelementptr inbounds nuw i8, ptr %i.is, i64 4 ; 2 uses
  %i.iu = load float, ptr %i.it, align 4, !tbaa !29
  %i.iv = load float, ptr %i.is, align 4, !tbaa !28
  %i.iw = fneg nsz float %i.iv
  %i.ix = fmul nsz float %i.hu, %i.iw
  %i.iy = tail call nsz float @llvm.fmuladd.f32(float %i.hs, float %i.iu, float %i.ix)
  %i.iz = getelementptr [4 x i8], ptr %i.ir, i64 %i.p
  store float %i.iy, ptr %i.iz, align 4, !tbaa !24
  %i.ja = load float, ptr %i.is, align 4, !tbaa !28
  %i.jb = load float, ptr %i.it, align 4, !tbaa !29
  %i.jc = fmul nsz float %i.hu, %i.jb
  %i.jd = tail call nsz float @llvm.fmuladd.f32(float %i.hs, float %i.ja, float %i.jc)
  store float %i.jd, ptr %i.ij, align 4, !tbaa !24
  %indvars.iv.next152 = add nuw nsw i64 %indvars.iv151, 1 ; 2 uses
  %exitcond155.not = icmp eq i64 %indvars.iv.next152, %wide.trip.count154
...
fft15.exit:                                       ; preds = %bb.e
  ...
  %i.dn = load <2 x float>, ptr getelementptr inbounds nuw (i8, ptr @ff_tx_tab_53_float, i64 32), align 16, !tbaa !24 ; 5 uses
  %i.do = load <2 x float>, ptr %4, align 16, !tbaa !24 ; 2 uses
  %i.dp = load <2 x float>, ptr %i.v, align 8, !tbaa !24 ; 2 uses
  %i.dq = load <2 x float>, ptr %i.w, align 16, !tbaa !24 ; 2 uses
  ...
  %i.ec = load <2 x float>, ptr %i.x, align 8, !tbaa !24 ; 2 uses
  %i.ed = load <2 x float>, ptr %i.y, align 16, !tbaa !24 ; 2 uses
  %i.ee = load <2 x float>, ptr %i.z, align 8, !tbaa !24 ; 2 uses
  ...
  %i.eo = load <2 x float>, ptr %i.aa, align 16, !tbaa !24 ; 2 uses
  %i.ep = load <2 x float>, ptr %i.ab, align 8, !tbaa !24 ; 2 uses
  %i.eq = load <2 x float>, ptr %i.ac, align 16, !tbaa !24 ; 2 uses
end_hunk_3
