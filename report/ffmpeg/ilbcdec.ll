...
.sink.split:                                      ; preds = %bb.a, %bb.b, %bb.d
  ...
  store ptr null, ptr %.sroa.4.0..sroa_idx, align 8, !tbaa !46
  ...
  store i16 %.38, ptr %i.r, align 8, !tbaa !47
...
bb.a:
  ...
  %i.l = load ptr, ptr %i.k, align 8, !tbaa !71   ; 112 uses
  %i.m = getelementptr inbounds nuw i8, ptr %3, i64 32 ; 2 uses
  %i.n = load i32, ptr %i.m, align 8, !tbaa !72   ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  store i16 %i.ay, ptr %i.az, align 2, !tbaa !73
  ...
  store i16 %i.bl, ptr %i.bm, align 2, !tbaa !74
  ...
  store i16 %i.bx, ptr %i.by, align 8, !tbaa !75
...
bb.d:                                             ; preds = %bb.b
  ...
  store i16 %i.fs, ptr %i.ft, align 2, !tbaa !73
  ...
  store i16 %i.gf, ptr %i.gg, align 2, !tbaa !74
  ...
  store i16 %i.gr, ptr %i.gs, align 8, !tbaa !75
...
bb.f:                                             ; preds = %bb.f, %bb.e
  ...
  br i1 %exitcond.not.i.1, label %bb.g, label %bb.f, !llvm.loop !48
...
bb.i:                                             ; preds = %bb.i, %bb.h
  ...
  br i1 %exitcond722.not.i, label %bb.j, label %bb.i, !llvm.loop !49
...
unpack_frame.exit:                                ; preds = %bb.k, %bb.l
  ...
  store i32 %i.bbt, ptr %i.bbu, align 8, !tbaa !80
...
bb.m:                                             ; preds = %unpack_frame.exit
  ...
  %i.bcc = load i16, ptr %i.bcb, align 2, !tbaa !81 ; 3 uses
...
._crit_edge.i100:                                 ; preds = %bb.ad
  br i1 %i.bff, label %.preheader37.i, label %lsf_check_stability.exit, !llvm.loop !50
...
bb.ad:                                            ; preds = %.sink.split92.i, %bb.ac
  ...
  br i1 %exitcond.not.i99, label %._crit_edge.i100, label %.preheader.i, !llvm.loop !51
...
bb.ae:                                            ; preds = %bb.ae, %.lr.ph.i
  ...
  br i1 %i.bqq, label %bb.ae, label %lsp_interpolate.exit, !llvm.loop !52
...
lsp_interpolate.exit:                             ; preds = %bb.ae, %lsp_interpolate.exit.loopexit, %.preheader.i102
  ...
  %i.bra = load i16, ptr %i.bqz, align 2, !tbaa !74 ; 2 uses
  ...
  %i.brg = load i16, ptr %i.brf, align 8, !tbaa !75 ; 3 uses
...
bb.af:                                            ; preds = %bb.af, %.lr.ph116.i.i.new
  ...
  br i1 %niter313.ncmp.1, label %.loopexit.i.i.loopexit.unr-lcssa, label %bb.af, !llvm.loop !53
...
bb.ah:                                            ; preds = %bb.ah, %.lr.ph112.i.i.new
  ...
  br i1 %niter307.ncmp.1, label %.loopexit.i.i.loopexit297.unr-lcssa, label %bb.ah, !llvm.loop !54
...
bb.ai:                                            ; preds = %bb.ai, %.lr.ph.i.i.new
  ...
  br i1 %niter.ncmp.1, label %.loopexit.i.i.loopexit298.unr-lcssa, label %bb.ai, !llvm.loop !55
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.byi, label %middle.block, label %vector.body, !llvm.loop !56
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  br i1 %exitcond28.not.i.i.i, label %filter_mafq12.exit.i.i, label %scalar.ph, !llvm.loop !57
...
.preheader.i.i.i:                                 ; preds = %.preheader.i.i.i, %.preheader.preheader.i.i.i
  ...
  br i1 %exitcond.not.i74.i.i, label %iter.check, label %.preheader.i.i.i, !llvm.loop !58
...
vector.body259:                                   ; preds = %vector.body259, %vector.ph257
  ...
  br i1 %i.ccj, label %middle.block269, label %vector.body259, !llvm.loop !59
...
vec.epilog.iter.check:                            ; preds = %middle.block269
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph121.i.i.preheader, label %vec.epilog.ph, !prof !82
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.ccv, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !60
...
.lr.ph121.i.i:                                    ; preds = %.lr.ph121.i.i.preheader, %.lr.ph121.i.i
  ...
  br i1 %exitcond127.not.i.i, label %state_construct.exit.loopexit.i, label %.lr.ph121.i.i, !llvm.loop !61

state_construct.exit.loopexit.i:                  ; preds = %.lr.ph121.i.i, %vec.epilog.middle.block, %middle.block269
  %.pre.i112 = load i16, ptr %i.bqz, align 2, !tbaa !74
...
.lr.ph.i112.i:                                    ; preds = %.lr.ph.i112.i, %.lr.ph.i112.preheader.i.new
  ...
  br i1 %niter318.ncmp.7, label %reverse_memcpy.exit.i.loopexit.unr-lcssa, label %.lr.ph.i112.i, !llvm.loop !62
...
.lr.ph.i112.i.epil:                               ; preds = %.lr.ph.i112.i.epil, %.lr.ph.i112.i.epil.preheader
  ...
  br i1 %epil.iter.cmp.not, label %reverse_memcpy.exit.i, label %.lr.ph.i112.i.epil, !llvm.loop !63
...
.lr.ph.i114.i:                                    ; preds = %.lr.ph.i114.i, %.lr.ph.i114.i.preheader.new
  ...
  br i1 %niter324.ncmp.7, label %reverse_memcpy.exit119.i.loopexit.unr-lcssa, label %.lr.ph.i114.i, !llvm.loop !62
...
.lr.ph.i114.i.epil:                               ; preds = %.lr.ph.i114.i.epil, %.lr.ph.i114.i.epil.preheader
  ...
  br i1 %epil.iter320.cmp.not, label %reverse_memcpy.exit119.i, label %.lr.ph.i114.i.epil, !llvm.loop !64
...
reverse_memcpy.exit119.i:                         ; preds = %reverse_memcpy.exit119.i.loopexit.unr-lcssa, %.lr.ph.i114.i.epil, %reverse_memcpy.exit.i, %bb.aj
  ...
  %i.cfz = load i16, ptr %i.bcb, align 2, !tbaa !73 ; 5 uses
...
bb.am:                                            ; preds = %bb.am, %bb.al
  ...
  %i.cgv = load i16, ptr %i.bcb, align 2, !tbaa !73 ; 3 uses
  ...
  br i1 %exitcond.not.i111, label %.loopexit.loopexit.i, label %bb.am, !llvm.loop !65
...
.lr.ph.i120.i:                                    ; preds = %.lr.ph.i120.i, %.lr.ph.i120.preheader.i.new
  ...
  br i1 %niter330.ncmp.7, label %.lr.ph.i107.loopexit.unr-lcssa, label %.lr.ph.i120.i, !llvm.loop !62
...
.lr.ph.i120.i.epil:                               ; preds = %.lr.ph.i120.i.epil, %.lr.ph.i120.i.epil.preheader
  ...
  br i1 %epil.iter326.cmp.not, label %.lr.ph.i107, label %.lr.ph.i120.i.epil, !llvm.loop !66
...
bb.ao:                                            ; preds = %bb.ao, %.lr.ph.i107
  ...
  br i1 %i.cjl, label %bb.ao, label %._crit_edge.i108, !llvm.loop !67
...
.lr.ph.i126.i:                                    ; preds = %.lr.ph.i126.i, %._crit_edge.i108
  ...
  br i1 %exitcond.not.i130.i.7, label %decode_residual.exit.loopexit, label %.lr.ph.i126.i, !llvm.loop !62
...
.preheader.i113:                                  ; preds = %.preheader.i113, %bb.au
  ...
  br i1 %exitcond.not.i116, label %filter_arfq12.exit, label %.preheader.i113, !llvm.loop !58
...
filter_arfq12.exit:                               ; preds = %.preheader.i113
  ...
  br i1 %i.cna, label %bb.au, label %._crit_edge, !llvm.loop !68
...
bb.aw:                                            ; preds = %bb.aw, %.lr.ph.i119
  ...
  br i1 %exitcond.not.i126, label %hp_output.exit, label %bb.aw, !llvm.loop !69
...
hp_output.exit:                                   ; preds = %bb.aw, %bb.av
  ...
  %i.cpn = load i32, ptr %i.m, align 8, !tbaa !72
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi2 = phi <4 x i32> [ zeroinitializer, %vector.ph ], [ %9, %vector.body ]
  ...
  %4 = tail call <4 x i16> @llvm.abs.v4i16(<4 x i16> %wide.load, i1 false)
  %5 = tail call <4 x i16> @llvm.abs.v4i16(<4 x i16> %wide.load3, i1 false)
  %6 = zext <4 x i16> %4 to <4 x i32>
  %7 = zext <4 x i16> %5 to <4 x i32>
  %8 = tail call <4 x i32> @llvm.umax.v4i32(<4 x i32> %vec.phi, <4 x i32> %6) ; 2 uses
  %9 = tail call <4 x i32> @llvm.umax.v4i32(<4 x i32> %vec.phi2, <4 x i32> %7) ; 2 uses
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.i = icmp eq i64 %index.next, %n.vec
  br i1 %i.i, label %middle.block.a, label %vector.body, !llvm.loop !89

middle.block.a:                                   ; preds = %vector.body
  %rdx.minmax = tail call <4 x i32> @llvm.umax.v4i32(<4 x i32> %8, <4 x i32> %9)
  %10 = tail call i32 @llvm.vector.reduce.umax.v4i32(<4 x i32> %rdx.minmax) ; 2 uses
  %cmp.n.a = icmp eq i64 %n.vec, %wide.trip.count.i
  br i1 %cmp.n.a, label %max_abs_value_w16.exit, label %.preheader.i

.preheader.i:                                     ; preds = %middle.block.a, %.preheader.i
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %.preheader.i ], [ %n.vec, %middle.block.a ] ; 2 uses
  %.025.i = phi i32 [ %.1.i, %.preheader.i ], [ %10, %middle.block.a ]
  ...
  %11 = zext i16 %i.l to i32
  %.1.i = tail call i32 @llvm.umax.i32(i32 %.025.i, i32 %11) ; 2 uses
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %wide.trip.count.i
  br i1 %exitcond.not.i, label %max_abs_value_w16.exit, label %.preheader.i, !llvm.loop !90

max_abs_value_w16.exit:                           ; preds = %.preheader.i, %middle.block.a
  %.1.i.lcssa = phi i32 [ %10, %middle.block.a ], [ %.1.i, %.preheader.i ]
  %i.m = icmp samesign ugt i32 %.1.i.lcssa, 5000
...
vector.body7:                                     ; preds = %vector.body7, %max_abs_value_w16.exit
  ...
  br i1 %i.z, label %middle.block14, label %vector.body7, !llvm.loop !91
...
vector.body21:                                    ; preds = %vector.body21, %vector.ph17
  ...
  br i1 %i.bb, label %middle.block30, label %vector.body21, !llvm.loop !93
...
bb.f:                                             ; preds = %bb.d, %bb.e, %scale_dot_product.exit121
  ...
  br i1 %exitcond.not, label %bb.g, label %vector.ph17, !llvm.loop !95
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i, %.lr.ph.preheader.i.i.new
  ...
  br i1 %niter187.ncmp.1, label %.lr.ph.preheader.i30.i.unr-lcssa, label %.lr.ph.i.i, !llvm.loop !98
...
.lr.ph.i32.i:                                     ; preds = %.lr.ph.preheader.i30.i, %.lr.ph.i32.i
  ...
  br i1 %exitcond.not.i35.i, label %iter.check, label %.lr.ph.i32.i, !llvm.loop !99
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.cp, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !100
...
.lr.ph.i38.i:                                     ; preds = %.lr.ph.i38.i.preheader, %.lr.ph.i38.i
  ...
  br i1 %exitcond.not.i41.i, label %create_augmented_vector.exit, label %.lr.ph.i38.i, !llvm.loop !101
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <8 x i16>, ptr %i.dq, align 2, !tbaa !39, !alias.scope !112
  ...
  %wide.load105 = load <8 x i16>, ptr %i.dr, align 2, !tbaa !39, !alias.scope !112
  ...
  %wide.load106 = load <8 x i16>, ptr %i.du, align 2, !tbaa !39, !alias.scope !112
  ...
  %wide.load107 = load <8 x i16>, ptr %i.dy, align 2, !tbaa !39, !alias.scope !112
  ...
  %wide.load108 = load <8 x i16>, ptr %i.ec, align 2, !tbaa !39, !alias.scope !112
  ...
  %wide.load109 = load <8 x i16>, ptr %i.eg, align 2, !tbaa !39, !alias.scope !112
  ...
  %wide.load110 = load <8 x i16>, ptr %i.ek, align 2, !tbaa !39, !alias.scope !112
  %i.ep = sext <8 x i16> %wide.load110 to <8 x i32>
  %i.eq = mul nsw <8 x i32> %i.ep, splat (i32 343)
  %i.er = add nsw <8 x i32> %i.eq, %i.en
  %wide.load111 = load <8 x i16>, ptr %i.eo, align 2, !tbaa !39, !alias.scope !112
  ...
  store <8 x i16> %i.ez, ptr %i.fa, align 2, !tbaa !39, !alias.scope !113, !noalias !112
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.fb = icmp eq i64 %index.next, %n.vec
  br i1 %i.fb, label %middle.block, label %vector.body, !llvm.loop !105
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  br i1 %exitcond28.not.i, label %filter_mafq12.exit, label %scalar.ph, !llvm.loop !106
...
vector.body116:                                   ; preds = %vector.body116, %vector.ph114
  ...
  br i1 %i.hj, label %middle.block127, label %vector.body116, !llvm.loop !107
...
scalar.ph112:                                     ; preds = %scalar.ph112.preheader, %scalar.ph112
  ...
  br i1 %exitcond28.not.i75, label %filter_mafq12.exit76, label %scalar.ph112, !llvm.loop !108
...
.lr.ph.i32.i85:                                   ; preds = %.lr.ph.i32.i85, %.lr.ph.preheader.i30.i84.new
  ...
  br i1 %niter.ncmp.1, label %.lr.ph.i38.i89.preheader.unr-lcssa, label %.lr.ph.i32.i85, !llvm.loop !109
...
.lr.ph.i38.i89:                                   ; preds = %.lr.ph.i38.i89, %.lr.ph.i38.i89.preheader.new
  ...
  br i1 %niter181.ncmp.3, label %create_augmented_vector.exit93.loopexit.unr-lcssa, label %.lr.ph.i38.i89, !llvm.loop !110
...
.lr.ph.i38.i89.epil:                              ; preds = %.lr.ph.i38.i89.epil, %.lr.ph.i38.i89.epil.preheader
  ...
  br i1 %epil.iter.cmp.not, label %create_augmented_vector.exit93, label %.lr.ph.i38.i89.epil, !llvm.loop !111
...
!57 = distinct !{!57, !40, !42, !41}
!58 = distinct !{!58, !40}
!59 = distinct !{!59, !40, !41, !42}
!60 = distinct !{!60, !40, !41, !42}
!61 = distinct !{!61, !40, !42, !41}
!62 = distinct !{!62, !40}
!63 = distinct !{!63, !43}
!64 = distinct !{!64, !43}
!65 = distinct !{!65, !40}
...
!68 = distinct !{!68, !40}
!69 = distinct !{!69, !40}
!70 = !{!"AVPacket", !21, i64 0, !13, i64 8, !13, i64 16, !14, i64 24, !6, i64 32, !6, i64 36, !6, i64 40, !23, i64 48, !6, i64 56, !13, i64 64, !13, i64 72, !9, i64 80, !21, i64 88, !15, i64 96}
!71 = !{!70, !14, i64 24}
!72 = !{!70, !6, i64 32}
!73 = !{!30, !29, i64 194}
!74 = !{!30, !29, i64 74}
!75 = !{!30, !29, i64 72}
!76 = !{!"p2 omnipotent char", !25, i64 0}
!77 = !{!"p2 _ZTS11AVBufferRef", !25, i64 0}
!78 = !{!"p1 _ZTS12AVDictionary", !9, i64 0}
!79 = !{!"AVFrame", !5, i64 0, !5, i64 64, !76, i64 96, !6, i64 104, !6, i64 108, !6, i64 112, !6, i64 116, !6, i64 120, !15, i64 124, !13, i64 136, !13, i64 144, !15, i64 152, !6, i64 160, !9, i64 168, !6, i64 176, !6, i64 180, !5, i64 184, !77, i64 248, !6, i64 256, !26, i64 264, !6, i64 272, !6, i64 276, !6, i64 280, !6, i64 284, !6, i64 288, !6, i64 292, !6, i64 296, !13, i64 304, !78, i64 312, !6, i64 320, !21, i64 328, !21, i64 336, !13, i64 344, !13, i64 352, !13, i64 360, !13, i64 368, !9, i64 376, !18, i64 384, !13, i64 408, !6, i64 416}
!80 = !{!79, !6, i64 112}
!81 = !{!31, !29, i64 210}
...
!90 = distinct !{!90, !40, !42, !41}
!91 = distinct !{!91, !40, !41, !42}
!92 = distinct !{!92, !40, !42, !41}
!93 = distinct !{!93, !40, !41, !42}
!94 = distinct !{!94, !40, !42, !41}
!95 = distinct !{!95, !40}
!96 = distinct !{!96, !40, !41, !42}
!97 = distinct !{!97, !40, !42, !41}
!98 = distinct !{!98, !40, !41}
!99 = distinct !{!99, !40, !42, !41}
!100 = distinct !{!100, !40, !41, !42}
!101 = distinct !{!101, !40, !42, !41}
!102 = distinct !{!102, !"LVerDomain"}
!103 = distinct !{!103, !102}
!104 = distinct !{!104, !102}
!105 = distinct !{!105, !40, !41, !42}
!106 = distinct !{!106, !40, !41}
!107 = distinct !{!107, !40, !41, !42}
!108 = distinct !{!108, !40, !42, !41}
!109 = distinct !{!109, !40}
!110 = distinct !{!110, !40}
!111 = distinct !{!111, !43}
!112 = !{!103}
