...
.preheader.preheader:                             ; preds = %scale_dot_product.exit121
  ...
  %4 = lshr i32 %.0.i.i120, 1
  %i.by = tail call range(i32 2, 33) i32 @llvm.ctlz.i32(i32 %4, i1 false)
  %i.bz = trunc nuw nsw i32 %i.by to i16
  %5 = lshr i32 %.094132, 1
  %6 = tail call range(i32 2, 33) i32 @llvm.ctlz.i32(i32 %5, i1 false)
  %7 = trunc nuw nsw i32 %6 to i16
  %8 = add nsw i16 %i.bz, -17                     ; 2 uses
  %9 = sext i16 %8 to i32                         ; 2 uses
  %i.ca = shl i32 %.0.i.i120, %9
  %i.cb = sub nsw i32 0, %9
  %i.cc = lshr i32 %.0.i.i120, %i.cb
  %10 = icmp samesign ugt i64 %.lcssa, 65535
  %11 = select i1 %10, i32 %i.cc, i32 %i.ca
  %i.cd = add nsw i16 %7, -17                     ; 2 uses
  %i.ce = sext i16 %i.cd to i32                   ; 2 uses
  %i.cf = shl i32 %.094132, %i.ce
  %i.cg = sub nsw i32 0, %i.ce
  %i.ch = lshr i32 %.094132, %i.cg
  %12 = icmp samesign ugt i32 %.094132, 65535
  %i.ci = select i1 %12, i32 %i.ch, i32 %i.cf     ; 3 uses
  ...
  %i.co = shl nsw i16 %8, 1
  %i.cp = sub nsw i16 %i.cd, %i.co                ; 2 uses
  %i.cq = sub i16 %i.cp, %.087134                 ; 2 uses
