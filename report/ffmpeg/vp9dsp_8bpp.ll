...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %8 = insertelement <2 x i8> poison, i8 %i.az, i64 0
  %9 = insertelement <2 x i8> %8, i8 %i.av, i64 1
  %10 = load <2 x i8>, ptr %i.ax, align 1, !tbaa !11
  %11 = shufflevector <2 x i8> %10, <2 x i8> %9, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.bd = zext <8 x i8> %11 to <8 x i32>
  %12 = zext <4 x i8> %i.bb to <4 x i32>
  %13 = shufflevector <4 x i32> %12, <4 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %14 = shufflevector <8 x i32> %i.bd, <8 x i32> %13, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 9, i32 10, i32 11>
  %i.be = mul nsw <8 x i32> %14, %i.e
