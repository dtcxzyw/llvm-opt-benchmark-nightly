...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  store <2 x double> %i.av, ptr %i.r, align 8, !tbaa !24
  %3 = fadd nsz <2 x double> %i.ar, %i.au
  %4 = fsub nsz <2 x double> %i.ap, %i.aq
  store <2 x double> %4, ptr %i.j, align 8, !tbaa !24
  store <2 x double> %3, ptr %i.v, align 8, !tbaa !24
  ...
  store <2 x double> %i.cl, ptr %i.bg, align 8, !tbaa !24
  %5 = fadd nsz <2 x double> %i.ch, %i.ck
  %6 = fsub nsz <2 x double> %i.cf, %i.cg
  store <2 x double> %6, ptr %i.ax, align 8, !tbaa !24
  store <2 x double> %5, ptr %i.bl, align 8, !tbaa !24
  ...
  store <2 x double> %i.eb, ptr %i.cw, align 8, !tbaa !24
  %7 = fadd nsz <2 x double> %i.dx, %i.ea
  %8 = fsub nsz <2 x double> %i.dv, %i.dw
  store <2 x double> %8, ptr %i.cn, align 8, !tbaa !24
  store <2 x double> %7, ptr %i.db, align 8, !tbaa !24
  ...
  store <2 x double> %i.fr, ptr %i.em, align 8, !tbaa !24
  %9 = fadd nsz <2 x double> %i.fn, %i.fq
  %10 = fsub nsz <2 x double> %i.fl, %i.fm
  store <2 x double> %10, ptr %i.ed, align 8, !tbaa !24
  store <2 x double> %9, ptr %i.er, align 8, !tbaa !24
  ...
  store <2 x double> %i.hh, ptr %i.gc, align 8, !tbaa !24
  %11 = fadd nsz <2 x double> %i.hd, %i.hg
  %12 = fsub nsz <2 x double> %i.hb, %i.hc
  store <2 x double> %12, ptr %i.ft, align 8, !tbaa !24
  store <2 x double> %11, ptr %i.gh, align 8, !tbaa !24
  ...
  store <2 x double> %i.ix, ptr %i.hs, align 8, !tbaa !24
  %13 = fadd nsz <2 x double> %i.it, %i.iw
  %14 = fsub nsz <2 x double> %i.ir, %i.is
  store <2 x double> %14, ptr %i.hj, align 8, !tbaa !24
  store <2 x double> %13, ptr %i.hx, align 8, !tbaa !24
  ...
  store <2 x double> %i.kn, ptr %i.ji, align 8, !tbaa !24
  %15 = fadd nsz <2 x double> %i.kj, %i.km
  %16 = fsub nsz <2 x double> %i.kh, %i.ki
  store <2 x double> %16, ptr %i.iz, align 8, !tbaa !24
  store <2 x double> %15, ptr %i.jn, align 8, !tbaa !24
  ...
  store <2 x double> %i.mc, ptr %i.kx, align 8, !tbaa !24
  %17 = fadd nsz <2 x double> %i.ly, %i.mb
  %18 = fsub nsz <2 x double> %i.lw, %i.lx
  store <2 x double> %18, ptr %i.kp, align 8, !tbaa !24
  store <2 x double> %17, ptr %i.lc, align 8, !tbaa !24
...
bb.b:                                             ; preds = %bb.f
  ...
  %i.dd = load <2 x double>, ptr getelementptr inbounds nuw (i8, ptr @ff_tx_tab_9_double, i64 24), align 8
  %i.de = load <2 x double>, ptr getelementptr inbounds nuw (i8, ptr @ff_tx_tab_9_double, i64 16), align 16
  %i.df = load <2 x double>, ptr @ff_tx_tab_9_double, align 16, !tbaa !24 ; 3 uses
  %i.dg = fsub nsz <2 x double> %i.cf, %i.cj
  %i.dh = fadd nsz <2 x double> %i.dg, %i.cr
  %i.di = shufflevector <2 x double> %i.df, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.dj = fmul nsz <2 x double> %i.dh, %i.di
  %i.dk = shufflevector <2 x double> %i.dj, <2 x double> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.dl = shufflevector <2 x double> %i.df, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.dm = tail call nsz <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.dl, <2 x double> %i.db, <2 x double> %i.cz) ; 2 uses
  %i.dn = tail call nsz <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.dl, <2 x double> %i.co, <2 x double> %i.cc) ; 3 uses
  %i.do = shufflevector <2 x double> %i.de, <2 x double> poison, <2 x i32> zeroinitializer
  %i.dp = shufflevector <2 x double> %i.dd, <2 x double> poison, <2 x i32> zeroinitializer
  %i.dq = shufflevector <2 x double> %i.df, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.dr = fmul nsz <2 x double> %i.cn, %i.dq      ; 3 uses
  %i.ds = fsub nsz <2 x double> %i.dm, %i.dk      ; 2 uses
  %i.dt = fadd nsz <2 x double> %i.dm, %i.dk      ; 2 uses
  %i.du = shufflevector <2 x double> %i.ds, <2 x double> %i.dt, <2 x i32> <i32 0, i32 3>
  %i.dv = load <4 x double>, ptr getelementptr inbounds nuw (i8, ptr @ff_tx_tab_9_double, i64 32), align 16, !tbaa !24 ; 6 uses
  %i.dw = shufflevector <4 x double> %i.dv, <4 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.dx = fmul nsz <2 x double> %i.cu, %i.dw
  %i.dy = tail call nsz <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.do, <2 x double> %i.ct, <2 x double> %i.dx) ; 2 uses
  %i.dz = shufflevector <4 x double> %i.dv, <4 x double> poison, <2 x i32> <i32 2, i32 2>
  %i.ea = fmul nsz <2 x double> %i.dz, %i.cx
  %i.eb = shufflevector <4 x double> %i.dv, <4 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.ec = tail call nsz <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.eb, <2 x double> %i.ct, <2 x double> %i.ea) ; 2 uses
  %i.ed = shufflevector <4 x double> %i.dv, <4 x double> poison, <2 x i32> zeroinitializer
  %i.ee = shufflevector <4 x double> %i.dv, <4 x double> poison, <2 x i32> zeroinitializer
  %i.ef = fmul nsz <2 x double> %i.cw, %i.ee
  %i.eg = tail call nsz <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.dp, <2 x double> %i.cv, <2 x double> %i.ef) ; 2 uses
  %i.eh = shufflevector <4 x double> %i.dv, <4 x double> poison, <2 x i32> <i32 3, i32 3>
  %i.ei = fmul nsz <2 x double> %i.eh, %i.cy
  %i.ej = tail call nsz <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ed, <2 x double> %i.cv, <2 x double> %i.ei) ; 2 uses
  %i.ek = fadd nsz <2 x double> %i.dn, %i.dy      ; 2 uses
  %i.el = fadd nsz <2 x double> %i.dr, %i.eg
  %i.em = shufflevector <2 x double> %i.el, <2 x double> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.en = fadd nsz <2 x double> %i.dn, %i.ec      ; 2 uses
  %i.eo = fsub nsz <2 x double> %i.ej, %i.dr
  %i.ep = shufflevector <2 x double> %i.eo, <2 x double> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.eq = fadd nsz <2 x double> %i.ek, %i.em      ; 2 uses
  %i.er = fsub nsz <2 x double> %i.ek, %i.em      ; 2 uses
  %i.es = shufflevector <2 x double> %i.eq, <2 x double> %i.er, <2 x i32> <i32 0, i32 3>
  store <2 x double> %i.es, ptr %i.bu, align 8, !tbaa !24
  %i.et = fadd nsz <2 x double> %i.en, %i.ep      ; 2 uses
  %i.eu = fsub nsz <2 x double> %i.en, %i.ep      ; 2 uses
  %i.ev = shufflevector <2 x double> %i.et, <2 x double> %i.eu, <2 x i32> <i32 0, i32 3>
  store <2 x double> %i.ev, ptr %i.bv, align 8, !tbaa !24
  %i.ew = shufflevector <2 x double> %i.dt, <2 x double> %i.ds, <2 x i32> <i32 0, i32 3>
  store <2 x double> %i.ew, ptr %i.bw, align 8, !tbaa !24
  %i.ex = fadd nsz <2 x double> %i.dy, %i.ec
  %i.ey = fsub nsz <2 x double> %i.dn, %i.ex      ; 2 uses
  %i.ez = fsub nsz <2 x double> %i.ej, %i.eg
  %i.fa = fadd nsz <2 x double> %i.dr, %i.ez
  %i.fb = shufflevector <2 x double> %i.fa, <2 x double> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.fc = fadd nsz <2 x double> %i.ey, %i.fb      ; 2 uses
  %i.fd = fsub nsz <2 x double> %i.ey, %i.fb      ; 2 uses
  %i.fe = shufflevector <2 x double> %i.fc, <2 x double> %i.fd, <2 x i32> <i32 0, i32 3>
  store <2 x double> %i.fe, ptr %i.bx, align 8, !tbaa !24
  %i.ff = shufflevector <2 x double> %i.fd, <2 x double> %i.fc, <2 x i32> <i32 0, i32 3>
  store <2 x double> %i.ff, ptr %i.by, align 8, !tbaa !24
  store <2 x double> %i.du, ptr %i.bz, align 8, !tbaa !24
  %i.fg = shufflevector <2 x double> %i.eu, <2 x double> %i.et, <2 x i32> <i32 0, i32 3>
  store <2 x double> %i.fg, ptr %i.ca, align 8, !tbaa !24
  %i.fh = shufflevector <2 x double> %i.er, <2 x double> %i.eq, <2 x i32> <i32 0, i32 3>
  store <2 x double> %i.fh, ptr %i.cb, align 8, !tbaa !24
  %indvars.iv.next144 = add nuw nsw i64 %indvars.iv143, 1 ; 2 uses
  %exitcond146.not = icmp eq i64 %indvars.iv.next144, %i.u
...
bb.c:                                             ; preds = %.preheader137, %bb.f
  ...
  %i.fn = load double, ptr %i.fm, align 8, !tbaa !24 ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.ft = fsub nsz double %i.fs, %i.fn
...
bb.e:                                             ; preds = %bb.c
  ...
  %i.gg = getelementptr inbounds [8 x i8], ptr %2, i64 %i.gf
  %i.gh = load double, ptr %i.gg, align 8, !tbaa !24
  %i.gi = fadd nsz double %i.fn, %i.gh
  %i.gj = fneg nsz double %i.gi
  %i.gk = sub nuw nsw i32 %i.fi, %i.f
  %i.gl = zext nneg i32 %i.gk to i64
  %i.gm = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %i.gl
  %i.gn = load double, ptr %i.gm, align 8, !tbaa !24
  %i.go = add i32 %i.g, %i.fo
  %i.gp = sext i32 %i.go to i64
  %i.gq = getelementptr inbounds [8 x i8], ptr %2, i64 %i.gp
  %i.gr = load double, ptr %i.gq, align 8, !tbaa !24
  %i.gs = fsub nsz double %i.gn, %i.gr
  br label %bb.f

bb.f:                                             ; preds = %bb.d, %bb.e
  %.sroa.077.0 = phi nsz double [ %i.ft, %bb.d ], [ %i.gj, %bb.e ]
  %.sroa.6.0 = phi nsz double [ %i.gd, %bb.d ], [ %i.gs, %bb.e ]
  %i.gt = ashr i32 %i.fi, 1
  %i.gu = sext i32 %i.gt to i64
  %i.gv = getelementptr inbounds [16 x i8], ptr %i.b, i64 %i.gu
  %i.gw = getelementptr inbounds nuw [16 x i8], ptr %4, i64 %indvars.iv
  %i.gx = load <2 x double>, ptr %i.gv, align 8, !tbaa !24 ; 2 uses
  %i.gy = shufflevector <2 x double> %i.gx, <2 x double> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.gz = insertelement <2 x double> poison, double %.sroa.6.0, i64 0
  %i.ha = shufflevector <2 x double> %i.gz, <2 x double> poison, <2 x i32> zeroinitializer
  %i.hb = fneg nsz <2 x double> %i.gy
  %i.hc = shufflevector <2 x double> %i.gx, <2 x double> %i.hb, <2 x i32> <i32 0, i32 2>
  %i.hd = fmul nsz <2 x double> %i.ha, %i.hc
  %i.he = insertelement <2 x double> poison, double %.sroa.077.0, i64 0
  %i.hf = shufflevector <2 x double> %i.he, <2 x double> poison, <2 x i32> zeroinitializer
  %i.hg = tail call nsz <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.hf, <2 x double> %i.gy, <2 x double> %i.hd)
  store <2 x double> %i.hg, ptr %i.gw, align 16, !tbaa !24
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, 9
  br i1 %exitcond.not, label %bb.b, label %bb.c, !llvm.loop !101

.lr.ph:                                           ; preds = %.preheader136
  %i.hh = load ptr, ptr %i.af, align 8, !tbaa !32 ; 2 uses
...
bb.g:                                             ; preds = %.lr.ph, %bb.g
  ...
  %i.hr = getelementptr inbounds [16 x i8], ptr %i.hh, i64 %i.hq ; 2 uses
  ...
  %i.hw = getelementptr inbounds [16 x i8], ptr %i.hh, i64 %i.hv ; 2 uses
  %i.hx = load double, ptr %i.hw, align 8, !tbaa !29 ; 2 uses
  %i.hy = getelementptr inbounds nuw i8, ptr %i.hw, i64 8
  %i.hz = load double, ptr %i.hy, align 8, !tbaa !30 ; 2 uses
  %i.ia = getelementptr inbounds nuw [16 x i8], ptr %i.b, i64 %i.hj ; 3 uses
  %i.ib = getelementptr inbounds nuw i8, ptr %i.ia, i64 8 ; 2 uses
  %i.ic = load double, ptr %i.ib, align 8, !tbaa !30
  %i.id = load double, ptr %i.ia, align 8, !tbaa !29
  %i.ie = fneg nsz double %i.id
  %i.if = fmul nsz double %i.hz, %i.ie
  %i.ig = tail call nsz double @llvm.fmuladd.f64(double %i.hx, double %i.ic, double %i.if)
  %i.ih = shl nsw i64 %i.hl, 1
  %i.ii = mul nsw i64 %i.p, %i.ih
  %i.ij = getelementptr [8 x i8], ptr %1, i64 %i.ii ; 2 uses
  %i.ik = getelementptr [8 x i8], ptr %i.ij, i64 %i.p
  store double %i.ig, ptr %i.ik, align 8, !tbaa !24
  %i.il = load double, ptr %i.ia, align 8, !tbaa !29
  %i.im = load double, ptr %i.ib, align 8, !tbaa !30
  %i.in = fmul nsz double %i.hz, %i.im
  %i.io = tail call nsz double @llvm.fmuladd.f64(double %i.hx, double %i.il, double %i.in)
  %i.ip = shl nuw nsw i64 %i.hj, 1
  %i.iq = mul nuw nsw i64 %i.p, %i.ip
  %i.ir = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %i.iq ; 2 uses
  store double %i.io, ptr %i.ir, align 8, !tbaa !24
  %i.is = getelementptr inbounds [16 x i8], ptr %i.b, i64 %i.hl ; 3 uses
  %i.it = getelementptr inbounds nuw i8, ptr %i.is, i64 8 ; 2 uses
  %i.iu = load double, ptr %i.it, align 8, !tbaa !30
  %i.iv = load double, ptr %i.is, align 8, !tbaa !29
  %i.iw = fneg nsz double %i.iv
  %i.ix = fmul nsz double %i.hu, %i.iw
  %i.iy = tail call nsz double @llvm.fmuladd.f64(double %i.hs, double %i.iu, double %i.ix)
  %i.iz = getelementptr [8 x i8], ptr %i.ir, i64 %i.p
  store double %i.iy, ptr %i.iz, align 8, !tbaa !24
  %i.ja = load double, ptr %i.is, align 8, !tbaa !29
  %i.jb = load double, ptr %i.it, align 8, !tbaa !30
  %i.jc = fmul nsz double %i.hu, %i.jb
  %i.jd = tail call nsz double @llvm.fmuladd.f64(double %i.hs, double %i.ja, double %i.jc)
  store double %i.jd, ptr %i.ij, align 8, !tbaa !24
  %indvars.iv.next152 = add nuw nsw i64 %indvars.iv151, 1 ; 2 uses
  %exitcond155.not = icmp eq i64 %indvars.iv.next152, %wide.trip.count154
