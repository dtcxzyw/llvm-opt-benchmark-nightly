...
copy_superblock.exit:                             ; preds = %.preheader.preheader.i, %.preheader14.preheader.i, %.critedge2
  ...
  %i.up = getelementptr inbounds nuw i8, ptr %.0126380, i64 16
  %spec.select = select i1 %.not156, ptr null, ptr %i.up ; 2 uses
  %i.uq = icmp eq i32 %i.un, %i.h                 ; 3 uses
  %i.ur = getelementptr inbounds [2 x i8], ptr %spec.select, i64 %i.fj
