...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.loopexit
  ...
  %.sroa.19.6350 = phi i32 [ %i.mf, %.loopexit ], [ %.sroa.19.5332, %.lr.ph.preheader ] ; 4 uses
...
.lr.ph361:                                        ; preds = %bb.ce, %decode_macroblock.exit221
  ...
  %.sroa.19.12359 = phi i32 [ %i.to, %decode_macroblock.exit221 ], [ %spec.select.i191, %bb.ce ] ; 4 uses
