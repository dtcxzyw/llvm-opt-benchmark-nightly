...
bb.ae:                                            ; preds = %bb.ac
  store ptr %i.fn, ptr %i.c, align 8, !tbaa !68
...
bb.af:                                            ; preds = %bytestream2_get_byte.exit205.us.i
  %i.fw = load ptr, ptr %i.m, align 8, !tbaa !70  ; 2 uses
  %i.fx = load ptr, ptr %i.c, align 8, !tbaa !68  ; 3 uses
...
bb.ag:                                            ; preds = %bb.af
  ...
  store ptr %i.gc, ptr %i.c, align 8, !tbaa !71
  %i.gd = load i8, ptr %i.fx, align 1, !tbaa !40
  br label %bytestream2_get_byte.exit197.us.i

bb.ah:                                            ; preds = %bb.af
  store ptr %i.fw, ptr %i.c, align 8, !tbaa !68
  br label %bytestream2_get_byte.exit197.us.i
...
bytestream2_get_byte.exit197.us.i:                ; preds = %bb.ah, %bb.ag
  ...
  store i8 %.0.i196.us.i, ptr %i.gi, align 1, !tbaa !40
  %i.gj = load ptr, ptr %i.m, align 8, !tbaa !70  ; 2 uses
  %i.gk = load ptr, ptr %i.c, align 8, !tbaa !68  ; 3 uses
...
bb.ai:                                            ; preds = %bytestream2_get_byte.exit197.us.i
  ...
  store ptr %i.gp, ptr %i.c, align 8, !tbaa !71
  %i.gq = load i8, ptr %i.gk, align 1, !tbaa !40
  br label %bytestream2_get_byte.exit195.us.i

bb.aj:                                            ; preds = %bytestream2_get_byte.exit197.us.i
  store ptr %i.gj, ptr %i.c, align 8, !tbaa !68
  br label %bytestream2_get_byte.exit195.us.i
...
bytestream2_get_byte.exit195.us.i:                ; preds = %bb.aj, %bb.ai
  ...
  store i8 %.0.i194.us.i, ptr %i.gv, align 1, !tbaa !40
  %i.gw = load ptr, ptr %i.m, align 8, !tbaa !70  ; 2 uses
  %i.gx = load ptr, ptr %i.c, align 8, !tbaa !68  ; 3 uses
...
bb.ak:                                            ; preds = %bytestream2_get_byte.exit195.us.i
  ...
  store ptr %i.hc, ptr %i.c, align 8, !tbaa !71
  %i.hd = load i8, ptr %i.gx, align 1, !tbaa !40
  br label %bytestream2_get_byte.exit193.us.i

bb.al:                                            ; preds = %bytestream2_get_byte.exit195.us.i
  store ptr %i.gw, ptr %i.c, align 8, !tbaa !68
  br label %bytestream2_get_byte.exit193.us.i
...
bytestream2_get_byte.exit193.us.i:                ; preds = %bb.al, %bb.ak
  ...
  store i8 %.0.i192.us.i, ptr %i.hk, align 1, !tbaa !40
  %i.hl = load ptr, ptr %i.m, align 8, !tbaa !70  ; 2 uses
  %i.hm = load ptr, ptr %i.c, align 8, !tbaa !68  ; 3 uses
...
bb.am:                                            ; preds = %bytestream2_get_byte.exit193.us.i
  ...
  store ptr %i.hr, ptr %i.c, align 8, !tbaa !71
  %i.hs = load i8, ptr %i.hm, align 1, !tbaa !40
  br label %bytestream2_get_byte.exit.us.i

bb.an:                                            ; preds = %bytestream2_get_byte.exit193.us.i
  store ptr %i.hl, ptr %i.c, align 8, !tbaa !68
  br label %bytestream2_get_byte.exit.us.i
...
bb.ao:                                            ; preds = %bytestream2_get_byte.exit205.us.i
  ...
  %.pre144 = load ptr, ptr %i.m, align 8, !tbaa !70 ; 6 uses
  %.pre145 = load ptr, ptr %i.c, align 8, !tbaa !68 ; 4 uses
...
bb.aq:                                            ; preds = %bb.ap
  ...
  store ptr %i.ie, ptr %i.c, align 8, !tbaa !71
  %i.if = load i8, ptr %.pre145, align 1, !tbaa !40
  %i.ig = zext i8 %i.if to i32
  br label %bytestream2_get_byte.exit203.us.i

bb.ar:                                            ; preds = %bb.ap
  store ptr %.pre144, ptr %i.c, align 8, !tbaa !68
  br label %bytestream2_get_byte.exit203.us.i
...
bb.at:                                            ; preds = %bb.as
  ...
  store ptr %i.il, ptr %i.c, align 8, !tbaa !71
  %i.im = load i8, ptr %i.ih, align 1, !tbaa !40
...
bb.av:                                            ; preds = %bytestream2_get_byte.exit199.us.i
  ...
  %i.ix = load i8, ptr %i.iw, align 1, !tbaa !40
  ...
  store i8 %i.ix, ptr %i.jb, align 1, !tbaa !40
  ...
  %i.ji = load i8, ptr %i.jh, align 1, !tbaa !40
  ...
  store i8 %i.ji, ptr %i.jl, align 1, !tbaa !40
  ...
  %i.jt = load i8, ptr %i.js, align 1, !tbaa !40
  ...
  store i8 %i.jt, ptr %i.jx, align 1, !tbaa !40
  ...
  %i.kc = load i8, ptr %i.kb, align 1, !tbaa !40
...
bb.ax:                                            ; preds = %bb.aw
  ...
  store ptr %i.ke, ptr %i.c, align 8, !tbaa !71
  %i.kf = load i8, ptr %i.ih, align 1, !tbaa !40
...
bytestream2_get_byte.exit201.us.i:                ; preds = %bb.ay, %bb.ax
  ...
  store i8 %.0.i200.us.i, ptr %i.kk, align 1, !tbaa !40
  ...
  store i8 %.0.i200.us.i, ptr %i.kp, align 1, !tbaa !40
  ...
  store i8 %.0.i200.us.i, ptr %i.kw, align 1, !tbaa !40
...
bb.az:                                            ; preds = %bytestream2_get_byte.exit201.us.i, %bb.av, %bytestream2_get_byte.exit.us.i
  ...
  store i8 %.0.i200.us.sink.i, ptr %i.lc, align 1, !tbaa !40
  %i.ld = add nuw nsw i32 %.2281.us.i, 1          ; 2 uses
  %exitcond.not.i = icmp eq i32 %i.ld, 4
  br i1 %exitcond.not.i, label %.loopexit.us.i, label %.preheader260.us.i, !llvm.loop !51
...
bb.ba:                                            ; preds = %bytestream2_get_byte.exit213.us.i
  ...
  %.pre146 = load ptr, ptr %i.m, align 8, !tbaa !70 ; 6 uses
  %.pre147 = load ptr, ptr %i.c, align 8, !tbaa !68 ; 4 uses
...
bb.bc:                                            ; preds = %bb.bb
  ...
  store ptr %i.lm, ptr %i.c, align 8, !tbaa !71
  %i.ln = load i8, ptr %.pre147, align 1, !tbaa !40
  %i.lo = zext i8 %i.ln to i32
  br label %bytestream2_get_byte.exit211.us.i

bb.bd:                                            ; preds = %bb.bb
  store ptr %.pre146, ptr %i.c, align 8, !tbaa !68
  br label %bytestream2_get_byte.exit211.us.i
...
bb.bf:                                            ; preds = %bb.be
  ...
  store ptr %i.lt, ptr %i.c, align 8, !tbaa !71
  %i.lu = load i8, ptr %i.lp, align 1, !tbaa !40
...
.preheader.us.i:                                  ; preds = %bytestream2_get_byte.exit207.us.i, %.preheader.us.i
  ...
  %i.mp = load i8, ptr %i.mo, align 1, !tbaa !40
  ...
  store i8 %i.mp, ptr %i.mt, align 1, !tbaa !40
  %i.mu = add nuw nsw i32 %.1282.us.i, 1          ; 2 uses
  %exitcond303.not.i = icmp eq i32 %i.mu, 16
  br i1 %exitcond303.not.i, label %.loopexit.us.i, label %.preheader.us.i, !llvm.loop !52
...
bb.bi:                                            ; preds = %bb.bh
  ...
  store ptr %i.mv, ptr %i.c, align 8, !tbaa !71
  %i.mw = load i8, ptr %i.lp, align 1, !tbaa !40
...
bytestream2_get_byte.exit209.us.i:                ; preds = %bb.bj, %bb.bi
  ...
  store i8 %.0.i208.us.i, ptr %i.nb, align 1, !tbaa !40
  ...
  store i8 %.0.i208.us.i, ptr %i.ng, align 1, !tbaa !40
  ...
  store i8 %.0.i208.us.i, ptr %i.nl, align 1, !tbaa !40
  ...
  store i8 %.0.i208.us.i, ptr %i.nq, align 1, !tbaa !40
...
begin_hunk_1_@decode_frame:bb.a
  store ptr %i.te, ptr %i.c, align 8, !tbaa !68
...
bb.cc:                                            ; preds = %bytestream2_get_byte.exit230.us.i
  %i.tn = load ptr, ptr %i.m, align 8, !tbaa !70  ; 2 uses
  %i.to = load ptr, ptr %i.c, align 8, !tbaa !68  ; 3 uses
...
bb.cd:                                            ; preds = %bb.cc
  ...
  store ptr %i.tt, ptr %i.c, align 8, !tbaa !71
  %i.tu = load i8, ptr %i.to, align 1, !tbaa !40
  br label %bytestream2_get_byte.exit222.us.i

bb.ce:                                            ; preds = %bb.cc
  store ptr %i.tn, ptr %i.c, align 8, !tbaa !68
  br label %bytestream2_get_byte.exit222.us.i
...
bytestream2_get_byte.exit222.us.i:                ; preds = %bb.ce, %bb.cd
  ...
  store i8 %.0.i221.us.i, ptr %i.tz, align 1, !tbaa !40
  %i.ua = load ptr, ptr %i.m, align 8, !tbaa !70  ; 2 uses
  %i.ub = load ptr, ptr %i.c, align 8, !tbaa !68  ; 3 uses
...
bb.cf:                                            ; preds = %bytestream2_get_byte.exit222.us.i
  ...
  store ptr %i.ug, ptr %i.c, align 8, !tbaa !71
  %i.uh = load i8, ptr %i.ub, align 1, !tbaa !40
  br label %bytestream2_get_byte.exit220.us.i

bb.cg:                                            ; preds = %bytestream2_get_byte.exit222.us.i
  store ptr %i.ua, ptr %i.c, align 8, !tbaa !68
  br label %bytestream2_get_byte.exit220.us.i
...
bytestream2_get_byte.exit220.us.i:                ; preds = %bb.cg, %bb.cf
  ...
  store i8 %.0.i219.us.i, ptr %i.um, align 1, !tbaa !40
  %i.un = load ptr, ptr %i.m, align 8, !tbaa !70  ; 2 uses
  %i.uo = load ptr, ptr %i.c, align 8, !tbaa !68  ; 3 uses
...
bb.ch:                                            ; preds = %bytestream2_get_byte.exit220.us.i
  ...
  store ptr %i.ut, ptr %i.c, align 8, !tbaa !71
  %i.uu = load i8, ptr %i.uo, align 1, !tbaa !40
  br label %bytestream2_get_byte.exit218.us.i

bb.ci:                                            ; preds = %bytestream2_get_byte.exit220.us.i
  store ptr %i.un, ptr %i.c, align 8, !tbaa !68
  br label %bytestream2_get_byte.exit218.us.i
...
bytestream2_get_byte.exit218.us.i:                ; preds = %bb.ci, %bb.ch
  ...
  store i8 %.0.i217.us.i, ptr %i.vb, align 1, !tbaa !40
  %i.vc = load ptr, ptr %i.m, align 8, !tbaa !70  ; 2 uses
  %i.vd = load ptr, ptr %i.c, align 8, !tbaa !68  ; 3 uses
...
bb.cj:                                            ; preds = %bytestream2_get_byte.exit218.us.i
  ...
  store ptr %i.vi, ptr %i.c, align 8, !tbaa !71
  %i.vj = load i8, ptr %i.vd, align 1, !tbaa !40
  br label %bytestream2_get_byte.exit.us.i94

bb.ck:                                            ; preds = %bytestream2_get_byte.exit218.us.i
  store ptr %i.vc, ptr %i.c, align 8, !tbaa !68
  br label %bytestream2_get_byte.exit.us.i94
...
bb.cl:                                            ; preds = %bytestream2_get_byte.exit230.us.i
  ...
  %.pre = load ptr, ptr %i.m, align 8, !tbaa !70  ; 6 uses
  %.pre141 = load ptr, ptr %i.c, align 8, !tbaa !68 ; 4 uses
...
bb.cn:                                            ; preds = %bb.cm
  ...
  store ptr %i.vu, ptr %i.c, align 8, !tbaa !71
  %i.vv = load i8, ptr %.pre141, align 1, !tbaa !40
  %i.vw = zext i8 %i.vv to i32
  br label %bytestream2_get_byte.exit228.us.i

bb.co:                                            ; preds = %bb.cm
  store ptr %.pre, ptr %i.c, align 8, !tbaa !68
  br label %bytestream2_get_byte.exit228.us.i
...
bb.cq:                                            ; preds = %bb.cp
  ...
  store ptr %i.wb, ptr %i.c, align 8, !tbaa !71
  %i.wc = load i8, ptr %i.vx, align 1, !tbaa !40
...
bb.cs:                                            ; preds = %bytestream2_get_byte.exit224.us.i
  ...
  %i.wp = load i8, ptr %i.wo, align 1, !tbaa !40
  ...
  store i8 %i.wp, ptr %i.wu, align 1, !tbaa !40
  ...
  %i.xb = load i8, ptr %i.xa, align 1, !tbaa !40
  ...
  store i8 %i.xb, ptr %i.xf, align 1, !tbaa !40
  ...
  %i.xn = load i8, ptr %i.xm, align 1, !tbaa !40
  ...
  store i8 %i.xn, ptr %i.xs, align 1, !tbaa !40
  ...
  %i.xx = load i8, ptr %i.xw, align 1, !tbaa !40
...
bb.cu:                                            ; preds = %bb.ct
  ...
  store ptr %i.xz, ptr %i.c, align 8, !tbaa !71
  %i.ya = load i8, ptr %i.vx, align 1, !tbaa !40
...
bytestream2_get_byte.exit226.us.i:                ; preds = %bb.cv, %bb.cu
  ...
  store i8 %.0.i225.us.i, ptr %i.yf, align 1, !tbaa !40
  ...
  store i8 %.0.i225.us.i, ptr %i.yk, align 1, !tbaa !40
  ...
  store i8 %.0.i225.us.i, ptr %i.yr, align 1, !tbaa !40
...
bb.cw:                                            ; preds = %bytestream2_get_byte.exit226.us.i, %bb.cs, %bytestream2_get_byte.exit.us.i94
  ...
  store i8 %.0.i225.us.sink.i, ptr %i.yw, align 1, !tbaa !40
  %i.yx = add nuw nsw i32 %.2314.us.i, 1          ; 2 uses
  %exitcond.not.i98 = icmp eq i32 %i.yx, 4
  br i1 %exitcond.not.i98, label %.loopexit.us.i99, label %.preheader289.us.i, !llvm.loop !57
...
bb.cx:                                            ; preds = %bytestream2_get_byte.exit238.us.i
  ...
  %.pre142 = load ptr, ptr %i.m, align 8, !tbaa !70 ; 6 uses
  %.pre143 = load ptr, ptr %i.c, align 8, !tbaa !68 ; 4 uses
...
bb.cz:                                            ; preds = %bb.cy
  ...
  store ptr %i.zg, ptr %i.c, align 8, !tbaa !71
  %i.zh = load i8, ptr %.pre143, align 1, !tbaa !40
  %i.zi = zext i8 %i.zh to i32
  br label %bytestream2_get_byte.exit236.us.i

bb.da:                                            ; preds = %bb.cy
  store ptr %.pre142, ptr %i.c, align 8, !tbaa !68
  br label %bytestream2_get_byte.exit236.us.i
...
bb.dc:                                            ; preds = %bb.db
  ...
  store ptr %i.zn, ptr %i.c, align 8, !tbaa !71
  %i.zo = load i8, ptr %i.zj, align 1, !tbaa !40
...
.preheader.us.i105:                               ; preds = %bytestream2_get_byte.exit232.us.i, %.preheader.us.i105
  ...
  %i.aal = load i8, ptr %i.aak, align 1, !tbaa !40
  ...
  store i8 %i.aal, ptr %i.aaq, align 1, !tbaa !40
  %i.aar = add nuw nsw i32 %.1315.us.i, 1         ; 2 uses
  %exitcond340.not.i = icmp eq i32 %i.aar, 16
  br i1 %exitcond340.not.i, label %.loopexit.us.i99, label %.preheader.us.i105, !llvm.loop !58
...
bb.df:                                            ; preds = %bb.de
  ...
  store ptr %i.aas, ptr %i.c, align 8, !tbaa !71
  %i.aat = load i8, ptr %i.zj, align 1, !tbaa !40
...
bytestream2_get_byte.exit234.us.i:                ; preds = %bb.dg, %bb.df
  ...
  store i8 %.0.i233.us.i, ptr %i.aay, align 1, !tbaa !40
  ...
  store i8 %.0.i233.us.i, ptr %i.abd, align 1, !tbaa !40
  ...
  store i8 %.0.i233.us.i, ptr %i.abi, align 1, !tbaa !40
  ...
  store i8 %.0.i233.us.i, ptr %i.abn, align 1, !tbaa !40
