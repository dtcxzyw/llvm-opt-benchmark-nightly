...
bb.b:                                             ; preds = %bb.a
  ...
  store i64 %2, ptr %i.o, align 8, !tbaa !38
  %i.p = getelementptr inbounds nuw i8, ptr %i.j, i64 408
  store i64 %3, ptr %i.p, align 8, !tbaa !39
  store ptr %i.j, ptr %4, align 8, !tbaa !53
  %i.q = getelementptr inbounds nuw i8, ptr %4, i64 8
  store ptr %1, ptr %i.q, align 8, !tbaa !54
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.aa = load i32, ptr %i.z, align 4, !tbaa !55
  %.not29 = icmp eq i32 %i.aa, 0
  %i.ab = zext i1 %.not29 to i32
  store i32 %i.ab, ptr %i.z, align 4, !tbaa !55
  br label %bb.d
...
bb.a:
  ...
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !19   ; 11 uses
  %i.d = load ptr, ptr %1, align 8, !tbaa !53     ; 2 uses
...
bb.f:                                             ; preds = %.lr.ph157, %._crit_edge154
  %indvars.iv181 = phi i64 [ 0, %.lr.ph157 ], [ %indvars.iv.next182, %._crit_edge154 ] ; 8 uses
  %i.ao = getelementptr inbounds nuw [8 x i8], ptr %i.f, i64 %indvars.iv181
  %i.ap = load ptr, ptr %i.ao, align 8, !tbaa !82 ; 7 uses
  %i.aq = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %indvars.iv181
  %i.ar = load ptr, ptr %i.aq, align 8, !tbaa !82 ; 2 uses
  %i.as = getelementptr inbounds nuw [4 x i8], ptr %i.ad, i64 %indvars.iv181
  %i.at = load i32, ptr %i.as, align 4, !tbaa !46 ; 3 uses
  %i.au = getelementptr inbounds nuw [4 x i8], ptr %i.ae, i64 %indvars.iv181
  %i.av = load i32, ptr %i.au, align 4, !tbaa !46 ; 2 uses
  %i.aw = getelementptr inbounds nuw [4 x i8], ptr %i.af, i64 %indvars.iv181
  %i.ax = load i32, ptr %i.aw, align 4, !tbaa !46 ; 8 uses
  %i.ay = getelementptr inbounds nuw [4 x i8], ptr %i.ag, i64 %indvars.iv181
  %i.az = load i32, ptr %i.ay, align 4, !tbaa !46 ; 4 uses
...
.lr.ph:                                           ; preds = %bb.f
  ...
  %i.br = getelementptr inbounds nuw [4 x i8], ptr %i.ac, i64 %indvars.iv181
  %i.bs = load i32, ptr %i.br, align 4, !tbaa !46
...
._crit_edge154:                                   ; preds = %._crit_edge149, %._crit_edge
  ...
  %i.de = load i32, ptr %i.z, align 4, !tbaa !47
  %i.df = sext i32 %i.de to i64
  %i.dg = icmp slt i64 %indvars.iv.next182, %i.df
...
.lr.ph148:                                        ; preds = %.preheader142, %.lr.ph148
  ...
  %i.eu = load ptr, ptr %i.an, align 8, !tbaa !50
  ...
  br i1 %exitcond.not, label %._crit_edge149, label %.lr.ph148, !llvm.loop !78
}
...
bb.a:
  ...
  %i.h = load i32, ptr %i.g, align 8, !tbaa !60   ; 4 uses
  %i.i = add nsw i32 %9, -1                       ; 13 uses
  %i.j = load i32, ptr %13, align 4, !tbaa !46
...
.lr.ph188.split.us.split:                         ; preds = %.lr.ph188, %.lr.ph188.split.us.split
  ...
  %i.af = load i8, ptr %i.ae, align 1, !tbaa !61
  ...
  br i1 %exitcond219.not, label %.lr.ph209.thread, label %.lr.ph188.split.us.split, !llvm.loop !83
...
.critedge.us:                                     ; preds = %.critedge.us.preheader, %.critedge.us
  ...
  %i.bt = load i8, ptr %i.bs, align 1, !tbaa !61
  ...
  %i.bz = load i8, ptr %i.by, align 1, !tbaa !61
  ...
  br i1 %exitcond222.not, label %.critedge._crit_edge, label %.critedge.us, !llvm.loop !84
...
bb.a:
  ...
  %i.e = load i16, ptr %i.d, align 2, !tbaa !63
  ...
  %i.k = load i16, ptr %i.j, align 2, !tbaa !63
  ...
  %i.z = load i16, ptr %i.y, align 2, !tbaa !63
  %i.aa = zext i16 %i.z to i32
  ...
  %i.an = load i16, ptr %i.am, align 2, !tbaa !63
...
bb.e:                                             ; preds = %bb.d
  %i.n = load ptr, ptr %i.k, align 8, !tbaa !31
  ...
  store i32 1, ptr %i.d, align 8, !tbaa !91
  %i.aa = load ptr, ptr %i.f, align 8, !tbaa !65
...
!30 = !{!"ESTDIFContext", !10, i64 0, !6, i64 8, !6, i64 12, !6, i64 16, !6, i64 20, !6, i64 24, !6, i64 28, !6, i64 32, !6, i64 36, !6, i64 40, !5, i64 44, !5, i64 60, !5, i64 76, !6, i64 92, !6, i64 96, !6, i64 100, !6, i64 104, !6, i64 108, !6, i64 112, !29, i64 120, !9, i64 128, !5, i64 136, !5, i64 160}
!31 = !{!30, !29, i64 120}
!32 = !{!"p2 omnipotent char", !14, i64 0}
!33 = !{!"long", !5, i64 0}
!34 = !{!"p2 _ZTS11AVBufferRef", !14, i64 0}
!35 = !{!"p1 _ZTS12AVDictionary", !9, i64 0}
!36 = !{!"AVFrame", !5, i64 0, !5, i64 64, !32, i64 96, !6, i64 104, !6, i64 108, !6, i64 112, !6, i64 116, !6, i64 120, !21, i64 124, !33, i64 136, !33, i64 144, !21, i64 152, !6, i64 160, !9, i64 168, !6, i64 176, !6, i64 180, !5, i64 184, !34, i64 248, !6, i64 256, !23, i64 264, !6, i64 272, !6, i64 276, !6, i64 280, !6, i64 284, !6, i64 288, !6, i64 292, !6, i64 296, !33, i64 304, !35, i64 312, !6, i64 320, !17, i64 328, !17, i64 336, !33, i64 344, !33, i64 352, !33, i64 360, !33, i64 368, !9, i64 376, !22, i64 384, !33, i64 408, !6, i64 416}
!37 = !{!36, !6, i64 276}
!38 = !{!36, !33, i64 136}
!39 = !{!36, !33, i64 408}
!40 = !{!18, !15, i64 56}
!41 = !{!"p1 _ZTS12AVFilterLink", !9, i64 0}
!42 = !{!41, !41, i64 0}
!43 = !{!30, !6, i64 8}
!44 = !{!27, !6, i64 40}
!45 = !{!27, !6, i64 44}
...
!50 = !{!30, !9, i64 128}
!51 = !{!9, !9, i64 0}
!52 = !{!"ThreadData", !29, i64 0, !29, i64 8}
!53 = !{!52, !29, i64 0}
!54 = !{!52, !29, i64 8}
!55 = !{!30, !6, i64 92}
...
!67 = !{!18, !6, i64 104}
!68 = !{!27, !6, i64 36}
!69 = !{!"AVPixFmtDescriptor", !12, i64 0, !5, i64 8, !5, i64 9, !5, i64 10, !33, i64 16, !5, i64 24, !12, i64 104}
!70 = !{!69, !5, i64 10}
!71 = !{!69, !5, i64 9}
