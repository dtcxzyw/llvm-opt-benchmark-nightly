...
bytestream2_peek_byte.exit.ithread-pre-split.i:   ; preds = %bytestream2_get_le32.exit.i.i
  %.pr.i = load i8, ptr %i.cm, align 1, !tbaa !54
...
.preheader14.i.i.preheader:                       ; preds = %bytestream2_peek_byte.exit495.i, %bytestream2_peek_byte.exit.ithread-pre-split.i
  %.promoted162126.i.i365 = phi ptr [ %i.cm, %bytestream2_peek_byte.exit.ithread-pre-split.i ], [ %i.cb, %bytestream2_peek_byte.exit495.i ] ; 2 uses
  %4 = ptrtoint ptr %.promoted162126.i.i365 to i64
  %5 = sub i64 %i.bv, %4
  %6 = icmp slt i64 %5, 1
...
bb.l:                                             ; preds = %.loopexit.1.i.i
  ...
  store ptr %i.ci, ptr %i.i, align 8, !tbaa !53
  %i.cj = load i32, ptr %.promoted1623.1.i.i, align 1, !tbaa !54
...
bytestream2_get_le32.exit.i.i:                    ; preds = %.loopexit.1.i.i, %bb.l
  ...
  store ptr %i.cm, ptr %i.i, align 8, !tbaa !44
...
.preheader14.i.i:                                 ; preds = %bytestream2_get_byte.exit.i.i
  ...
  br i1 %i.cu, label %.loopexit.i.i, label %bytestream2_get_byte.exit.i.i, !llvm.loop !101

bytestream2_get_byte.exit.i.i:                    ; preds = %.preheader14.i.i.preheader, %.preheader14.i.i
  %7 = phi ptr [ %i.cv, %.preheader14.i.i ], [ %.promoted162126.i.i365, %.preheader14.i.i.preheader ] ; 2 uses
  %i.cv = getelementptr inbounds nuw i8, ptr %7, i64 1 ; 4 uses
  store ptr %i.cv, ptr %i.i, align 8, !tbaa !53
  %i.cw = load i8, ptr %7, align 1, !tbaa !54
  %.not7.i.i = icmp eq i8 %i.cw, 0
  br i1 %.not7.i.i, label %.preheader14.i.i.backedge, label %.preheader14.i.i, !llvm.loop !101
...
bb.m:                                             ; preds = %bytestream2_get_byte.exit.1.i.i
  ...
  br i1 %i.db, label %.loopexit.1.i.i, label %bytestream2_get_byte.exit.1.i.i, !llvm.loop !101
...
bytestream2_get_byte.exit.1.i.i:                  ; preds = %.loopexit.i.i, %bb.m
  ...
  store ptr %i.dd, ptr %i.i, align 8, !tbaa !53
  %i.de = load i8, ptr %i.dc, align 1, !tbaa !54
...
bytestream2_peek_byte.exit495.thread.i:           ; preds = %bytestream2_peek_byte.exit495.i, %bb.k
  ...
  store ptr %i.dh, ptr %i.i, align 8, !tbaa !44
...
bytestream2_peek_byte.exit493.i:                  ; preds = %bytestream2_peek_byte.exit495.thread.i
  %i.dl = load i8, ptr %i.dh, align 1, !tbaa !54
...
skip_header_chunk.exit.i:                         ; preds = %skip_header_chunk.exit.loopexit.i, %bytestream2_peek_byte.exit493.i
  ...
  store ptr %i.do, ptr %i.i, align 8, !tbaa !44
  %i.dp = add i32 %i.ca, 1                        ; 3 uses
  store i32 %i.dp, ptr %i.ao, align 8, !tbaa !122
...
bytestream2_peek_byte.exit491.i:                  ; preds = %.critedge.i
  %i.dt = load i8, ptr %i.dr, align 1, !tbaa !54
...
bb.n:                                             ; preds = %bytestream2_peek_byte.exit491.thread.i
  ...
  store ptr %i.du, ptr %i.i, align 8, !tbaa !44
  %i.dv = load i32, ptr %i.ao, align 8, !tbaa !122 ; 2 uses
  %i.dw = load i32, ptr %i.bi, align 8, !tbaa !121
  ...
  %or.cond886.i = select i1 %i.dx, i1 %i.eb, i1 false
...
bytestream2_peek_byte.exit489.i:                  ; preds = %.lr.ph674.i
  %i.eg = load i8, ptr %i.ee, align 1, !tbaa !54
...
bb.p:                                             ; preds = %.loopexit.1.i521.i
  ...
  store ptr %i.en, ptr %i.i, align 8, !tbaa !53
  %i.eo = load i32, ptr %.promoted1623.1.i523.i, align 1, !tbaa !54
...
bytestream2_get_le32.exit.i525.i:                 ; preds = %.loopexit.1.i521.i, %bb.p
  ...
  store ptr %i.er, ptr %i.i, align 8, !tbaa !44
  ...
  br i1 %or.cond.i530.i, label %skip_header_chunk.exit531.i, label %bytestream2_peek_byte.exit.i509.i, !llvm.loop !100
...
.preheader14.i512.i:                              ; preds = %bytestream2_get_byte.exit.i513.i
  ...
  br i1 %i.ez, label %.loopexit.i515.i, label %bytestream2_get_byte.exit.i513.i, !llvm.loop !101
...
bytestream2_get_byte.exit.i513.i:                 ; preds = %.preheader14.i512.i.preheader, %.preheader14.i512.i
  ...
  store ptr %i.fa, ptr %i.i, align 8, !tbaa !53
  %i.fb = load i8, ptr %11, align 1, !tbaa !54
  %.not7.i514.i = icmp eq i8 %i.fb, 0
  br i1 %.not7.i514.i, label %bytestream2_get_byte.exit.i513.i..loopexit.i515.i_crit_edge, label %.preheader14.i512.i, !llvm.loop !101

bytestream2_get_byte.exit.i513.i..loopexit.i515.i_crit_edge: ; preds = %bytestream2_get_byte.exit.i513.i
  br label %.loopexit.i515.i, !llvm.loop !101
...
bb.q:                                             ; preds = %bytestream2_get_byte.exit.1.i517.i
  ...
  br i1 %i.fg, label %.loopexit.1.i521.i, label %bytestream2_get_byte.exit.1.i517.i, !llvm.loop !101
...
bytestream2_get_byte.exit.1.i517.i:               ; preds = %.loopexit.i515.i, %bb.q
  ...
  store ptr %i.fi, ptr %i.i, align 8, !tbaa !53
  %i.fj = load i8, ptr %i.fh, align 1, !tbaa !54
  %.not7.1.i518.i = icmp eq i8 %i.fj, 0
  %.pre.i520.i = ptrtoint ptr %i.fi to i64        ; 2 uses
  br i1 %.not7.1.i518.i, label %.loopexit.1.i521.i, label %bb.q, !llvm.loop !101
...
bytestream2_peek_byte.exit489.thread.i:           ; preds = %bytestream2_peek_byte.exit489.i, %.lr.ph674.i
  ...
  store ptr %i.fm, ptr %i.i, align 8, !tbaa !44
...
bytestream2_peek_byte.exit487.i:                  ; preds = %bytestream2_peek_byte.exit489.thread.i
  %i.fq = load i8, ptr %i.fm, align 1, !tbaa !54
...
skip_header_chunk.exit531.i:                      ; preds = %bytestream2_get_le32.exit.i525.i, %bytestream2_peek_byte.exit.i509.i, %bytestream2_peek_byte.exit487.i, %bb.o
  ...
  br i1 %i.fv, label %.lr.ph674.i, label %bytestream2_peek_byte.exit487.thread.i, !llvm.loop !102

bytestream2_peek_byte.exit487.thread.i:           ; preds = %skip_header_chunk.exit531.i, %bb.n
  %.pre-phi550 = phi i64 [ %i.dz, %bb.n ], [ %i.ft, %skip_header_chunk.exit531.i ]
  %i.fw = phi ptr [ %i.du, %bb.n ], [ %i.fr, %skip_header_chunk.exit531.i ] ; 3 uses
  %i.fx = icmp slt i64 %.pre-phi550, 1
...
bytestream2_peek_byte.exit485.i:                  ; preds = %bytestream2_peek_byte.exit487.thread.i
  %.pr = load i8, ptr %i.fw, align 1, !tbaa !54
...
bb.r:                                             ; preds = %bytestream2_peek_byte.exit485.i
  ...
  store i32 %i.fy, ptr %i.ao, align 8, !tbaa !122
  br label %bb.s
...
bb.u:                                             ; preds = %bb.t
  %i.gb = load ptr, ptr %i.i, align 8, !tbaa !44  ; 4 uses
...
.lr.ph691.i:                                      ; preds = %bytestream2_init.exit.i, %bb.bb
  %.1316690.i = phi i32 [ %.2317.i, %bb.bb ], [ %.0315.ph.i391, %bytestream2_init.exit.i ] ; 4 uses
  %.sroa.0.0689.i = phi ptr [ %i.is, %bb.bb ], [ %i.gb, %bytestream2_init.exit.i ] ; 6 uses
  %i.gg = load ptr, ptr %i.bo, align 8, !tbaa !123 ; 3 uses
...
bb.w:                                             ; preds = %.lr.ph691.i
  ...
  %i.gk = load ptr, ptr %i.bk, align 8, !tbaa !41 ; 2 uses
...
bb.x:                                             ; preds = %bb.w
  ...
  %i.gl = load ptr, ptr %i.bo, align 8, !tbaa !123
...
bb.z:                                             ; preds = %.critedge417.i
  %i.gs = load i8, ptr %.sroa.0.1.i, align 1, !tbaa !54 ; 2 uses
  ...
  %or.cond.i245 = icmp ult i32 %i.gw, 26
  br i1 %or.cond.i245, label %bb.aa, label %bb.ab

bb.aa:                                            ; preds = %bb.z
  %i.gx = shl nuw nsw i32 1, %i.gw
  %i.gy = load i32, ptr %i.an, align 8, !tbaa !124
  %i.gz = or i32 %i.gy, %i.gx
  store i32 %i.gz, ptr %i.an, align 8, !tbaa !124
  br label %bb.ab

bb.ab:                                            ; preds = %bb.aa, %bb.z
  %i.ha = load ptr, ptr %i.bk, align 8, !tbaa !41
