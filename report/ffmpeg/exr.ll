...
.thread:                                          ; preds = %bb.y, %bb.z, %bb.p
  ...
  %spec.select512 = tail call i32 @llvm.smin.i32(i32 %i.gd, i32 %spec.select485) ; 3 uses
  ...
  %i.gj = tail call i32 @llvm.smin.i32(i32 %i.gd, i32 %spec.select487) ; 2 uses
  ...
  %i.gq = sub nsw i32 %i.gj, %spec.select512      ; 11 uses
...
.lr.ph535.us.us.preheader:                        ; preds = %.preheader523
  ...
  %4 = xor i32 %spec.select512, -1
  %i.lg = add i32 %i.gj, %4                       ; 4 uses
  %xtraiter = and i32 %i.gq, 7                    ; 3 uses
  %i.lh = icmp ult i32 %i.lg, 7
  %unroll_iter = and i32 %i.gq, 2147483640
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  %lcmp.mod690 = icmp ne i32 %xtraiter, 0
  %xtraiter691 = and i32 %i.gq, 7                 ; 3 uses
  %i.li = icmp ult i32 %i.lg, 7
  %unroll_iter696 = and i32 %i.gq, 2147483640
  %lcmp.mod693.not = icmp eq i32 %xtraiter691, 0
  %lcmp.mod695 = icmp ne i32 %xtraiter691, 0
  %xtraiter698 = and i32 %i.gq, 7                 ; 3 uses
  %i.lj = icmp ult i32 %i.lg, 7
  %unroll_iter703 = and i32 %i.gq, 2147483640
  %lcmp.mod700.not = icmp eq i32 %xtraiter698, 0
  %lcmp.mod702 = icmp ne i32 %xtraiter698, 0
  %xtraiter705 = and i32 %i.gq, 7                 ; 3 uses
  %i.lk = icmp ult i32 %i.lg, 7
  %unroll_iter710 = and i32 %i.gq, 2147483640
...
bb.bb:                                            ; preds = %bb.ba, %.preheader.us
  ...
  %exitcond612.not = icmp eq i32 %i.tg, %i.gq
...
bb.bd:                                            ; preds = %bb.bc, %.preheader
  ...
  %exitcond606.not.a = icmp eq i32 %i.ub, %i.gq
