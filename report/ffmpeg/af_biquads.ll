...
bb.v:                                             ; preds = %bb.u, %bb.l
  %.1459 = phi nsz double [ %i.gw, %bb.u ], [ %i.by, %bb.l ] ; 2 uses
...
bb.z:                                             ; preds = %bb.v
  ...
  %i.in = insertelement <2 x double> poison, double %.1459, i64 0 ; 2 uses
  ...
  %i.it = shufflevector <2 x double> %i.in, <2 x double> %2, <2 x i32> <i32 0, i32 2>
  %3 = shufflevector <2 x double> %2, <2 x double> %i.ik, <2 x i32> <i32 1, i32 3>
  ...
  %4 = shufflevector <2 x double> %i.ik, <2 x double> poison, <2 x i32> zeroinitializer
  %i.iw = tail call nsz <2 x double> @llvm.fmuladd.v2f64(<2 x double> %3, <2 x double> %i.iv, <2 x double> %4) ; 4 uses
  %5 = shufflevector <2 x double> %i.iw, <2 x double> %i.ik, <2 x i32> <i32 0, i32 3>
  %i.ix = tail call nsz <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.it, <2 x double> %i.ip, <2 x double> %5) ; 2 uses
  ...
  %6 = shufflevector <2 x double> %i.in, <2 x double> %i.ik, <2 x i32> <i32 0, i32 2>
  %7 = shufflevector <2 x double> %i.iw, <2 x double> %i.ik, <2 x i32> <i32 1, i32 3>
  %i.jc = tail call nsz <2 x double> @llvm.fmuladd.v2f64(<2 x double> %6, <2 x double> %i.ip, <2 x double> %7)
...
bb.cd:                                            ; preds = %convert_width2qfactor.exit.i
  ...
  %8 = tail call nsz double @llvm.tan.f64(double %i.xi)
  %i.xj = tail call nsz double @llvm.exp2.f64(double %i.xg) ; 6 uses
  %i.xk = tail call nsz double @llvm.sqrt.f64(double %i.xj)
  %9 = insertelement <2 x double> <double poison, double 1.000000e+00>, double %8, i64 0
  %10 = insertelement <2 x double> poison, double %i.xk, i64 0
  %11 = insertelement <2 x double> %10, double %.0.i.i, i64 1
  %12 = fdiv nsz <2 x double> %9, %11             ; 5 uses
  %shift574 = shufflevector <2 x double> %12, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop575 = fadd nsz <2 x double> %12, %shift574
  %13 = insertelement <2 x double> %12, double %i.xj, i64 1
  %i.xl = insertelement <2 x double> %foldExtExtBinop575, double %i.xj, i64 1
  %14 = tail call nsz <2 x double> @llvm.fmuladd.v2f64(<2 x double> %13, <2 x double> %i.xl, <2 x double> <double 1.000000e+00, double -1.000000e+00>) ; 2 uses
  %i.xm = insertelement <2 x double> %14, double 1.000000e+00, i64 0
  %15 = insertelement <2 x double> %14, double %i.xj, i64 1
  %i.xn = fdiv nsz <2 x double> %i.xm, %15        ; 3 uses
  %16 = extractelement <2 x double> %i.xn, i64 0
  %17 = fadd nsz double %i.xj, -1.000000e+00
  %foldExtExtBinop577 = fmul nsz <2 x double> %12, %i.xn ; 2 uses
  %18 = extractelement <2 x double> %foldExtExtBinop577, i64 0
  %i.xo = insertelement <2 x double> %foldExtExtBinop577, double %17, i64 1
  %19 = fmul nsz <2 x double> %12, %i.xo          ; 2 uses
  %i.xp = insertelement <2 x double> %19, double 1.000000e+00, i64 0
  %20 = insertelement <2 x double> poison, double %i.xj, i64 0
  %21 = shufflevector <2 x double> %20, <2 x double> poison, <2 x i32> zeroinitializer
  %22 = fdiv nsz <2 x double> %i.xp, %21
  %23 = extractelement <2 x double> %i.xn, i64 1
  %i.xq = extractelement <2 x double> %19, i64 0
  br label %convert_dir2zdf.exit
...
convert_dir2zdf.exit:                             ; preds = %bb.ca, %bb.cb, %bb.cc, %bb.cd, %bb.ce, %bb.cf, %bb.cg, %bb.ch, %bb.ci, %bb.cj
  %.sroa.42.0.i = phi nsz double [ %i.vg, %bb.ca ], [ %i.wd, %bb.cb ], [ %i.xb, %bb.cc ], [ %i.xq, %bb.cd ], [ %i.yr, %bb.ce ], [ %i.zb, %bb.cf ], [ %i.zo, %bb.cg ], [ %i.zz, %bb.ch ], [ %i.aai, %bb.ci ], [ %i.aat, %bb.cj ] ; 2 uses
  %.sroa.22.0.i = phi nsz double [ %i.ve, %bb.ca ], [ %i.wc, %bb.cb ], [ %i.xa, %bb.cc ], [ %18, %bb.cd ], [ %i.yq, %bb.ce ], [ %i.za, %bb.cf ], [ %i.zn, %bb.cg ], [ %i.zy, %bb.ch ], [ %i.aah, %bb.ci ], [ %i.aas, %bb.cj ] ; 2 uses
  %.sroa.01.0.i = phi nsz double [ %i.vc, %bb.ca ], [ %i.wb, %bb.cb ], [ %i.wz, %bb.cc ], [ %16, %bb.cd ], [ %i.yp, %bb.ce ], [ %i.yz, %bb.cf ], [ %i.zm, %bb.cg ], [ %i.zx, %bb.ch ], [ %i.aag, %bb.ci ], [ %i.aar, %bb.cj ]
  %.sroa.24.0.i = phi nsz double [ %i.vk, %bb.ca ], [ 0.000000e+00, %bb.cb ], [ %i.xd, %bb.cc ], [ %23, %bb.cd ], [ %i.ys, %bb.ce ], [ 0.000000e+00, %bb.cf ], [ 0.000000e+00, %bb.cg ], [ 1.000000e+00, %bb.ch ], [ -1.000000e+00, %bb.ci ], [ 0.000000e+00, %bb.cj ] ; 2 uses
  %i.aaw = phi <2 x double> [ %i.vi, %bb.ca ], [ %i.wg, %bb.cb ], [ %i.xc, %bb.cc ], [ %22, %bb.cd ], [ %i.yh, %bb.ce ], [ %i.zf, %bb.cf ], [ %i.zq, %bb.cg ], [ zeroinitializer, %bb.ch ], [ %i.aak, %bb.ci ], [ %i.aav, %bb.cj ] ; 2 uses
...
bb.a:
  ...
  %i.p = load double, ptr %i.o, align 8, !tbaa !43 ; 5 uses
  %i.q = load double, ptr %i.h, align 8, !tbaa !43 ; 5 uses
...
.lr.ph.split.us.preheader:                        ; preds = %.lr.ph
  ...
  %i.ab = insertelement <2 x double> %i.aa, double %i.p, i64 1
...
.lr.ph.split.us:                                  ; preds = %.lr.ph.split.us.preheader, %.lr.ph.split.us
  ...
  %i.af = fmul nsz double %i.p, %.0109114.us
  ...
  %i.ak = tail call nsz double @llvm.fmuladd.f64(double %i.ah, double %i.q, double %i.aj)
  ...
  %i.ax = tail call nsz double @llvm.fmuladd.f64(double %i.av, double %i.q, double %i.aw)
...
.lr.ph.split:                                     ; preds = %.lr.ph.split.preheader, %.lr.ph.split
  ...
  %i.bg = fmul nsz double %i.p, %.0109114
  ...
  %7 = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %i.bf
  %8 = tail call nsz double @llvm.fmuladd.f64(double %.0107115, double %i.s, double %i.bg)
  %9 = fmul nsz double %i.p, %i.bi
  %i.bk = tail call nsz double @llvm.fmuladd.f64(double %i.bi, double %i.q, double %8)
  ...
  %i.bo = insertelement <2 x double> %i.bn, double %9, i64 1
  ...
  %i.bs = load double, ptr %7, align 8, !tbaa !43 ; 4 uses
  %i.bt = extractelement <2 x double> %i.bp, i64 1
  %i.bu = tail call nsz double @llvm.fmuladd.f64(double %i.bs, double %i.q, double %i.bt)
...
.sink.split:                                      ; preds = %._crit_edge
  ...
  %i.cg = fmul nsz double %i.p, %.0109.lcssa
  %i.ch = tail call nsz double @llvm.fmuladd.f64(double %i.cf, double %i.q, double %i.cg)
