...
.loopexit.i:                                      ; preds = %bb.i, %.thread34.i.i, %bb.g, %bb.f
  ...
  %i.bo = load i8, ptr %i.ak, align 1, !tbaa !9
  %i.bp = and i8 %i.bo, 27
  %or.cond.i = icmp eq i8 %i.bp, 1
  %i.bq = icmp sgt i32 %i.bn, 48
  %or.cond5.i = and i1 %or.cond.i, %i.bq
  br i1 %or.cond5.i, label %bb.j, label %bb.p

bb.j:                                             ; preds = %.loopexit.i
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c) #6
  %i.br = load ptr, ptr %1, align 8, !tbaa !47
  %i.bs = call i32 @av_aes_init(ptr noundef %i.br, ptr noundef nonnull %i.l, i32 noundef 128, i32 noundef 1) #6 ; 2 uses
  %i.bt = icmp slt i32 %i.bs, 0
  br i1 %i.bt, label %decrypt_nal_unit.exit.i, label %.lr.ph.i.i.i

.lr.ph.i.i.i:                                     ; preds = %bb.j, %bb.m
  %.029.i.i.i = phi i32 [ %.1.i.i.i, %bb.m ], [ 0, %bb.j ] ; 4 uses
  %.02528.i.i.i = phi i32 [ %.126.i.i.i, %bb.m ], [ 0, %bb.j ] ; 4 uses
  %i.bu = sub nsw i32 %i.bn, %.02528.i.i.i
  %i.bv = icmp sgt i32 %i.bu, 3
  %i.bw = sext i32 %.02528.i.i.i to i64
  %i.bx = getelementptr inbounds i8, ptr %i.ak, i64 %i.bw ; 3 uses
  %i.by = load i8, ptr %i.bx, align 1, !tbaa !9   ; 3 uses
  br i1 %i.bv, label %bb.k, label %.lr.ph._crit_edge.i.i.i
...
bb.k:                                             ; preds = %.lr.ph.i.i.i
  ...
  %i.cg = getelementptr inbounds nuw i8, ptr %i.bx, i64 2
  %i.ch = load i8, ptr %i.cg, align 1, !tbaa !9
  %i.ci = zext i8 %i.ch to i32
  %i.cj = or disjoint i32 %i.cf, %i.ci
  %i.ck = icmp eq i32 %i.cj, 3
  br i1 %i.ck, label %bb.l, label %.lr.ph._crit_edge.i.i.i

bb.l:                                             ; preds = %bb.k
  %i.cl = sext i32 %.029.i.i.i to i64
  %i.cm = getelementptr inbounds i8, ptr %i.ak, i64 %i.cl ; 2 uses
  store i8 %i.by, ptr %i.cm, align 1, !tbaa !9
  %i.cn = load i8, ptr %i.cb, align 1, !tbaa !9
  %i.co = add nsw i32 %.029.i.i.i, 2
  %i.cp = getelementptr i8, ptr %i.cm, i64 1
  store i8 %i.cn, ptr %i.cp, align 1, !tbaa !9
  %i.cq = add nsw i32 %.02528.i.i.i, 3
  br label %bb.m

.lr.ph._crit_edge.i.i.i:                          ; preds = %bb.k, %.lr.ph.i.i.i
  %i.cr = add nsw i32 %.02528.i.i.i, 1
  %i.cs = add nsw i32 %.029.i.i.i, 1
  %i.ct = sext i32 %.029.i.i.i to i64
  %i.cu = getelementptr inbounds i8, ptr %i.ak, i64 %i.ct
  store i8 %i.by, ptr %i.cu, align 1, !tbaa !9
  br label %bb.m

bb.m:                                             ; preds = %.lr.ph._crit_edge.i.i.i, %bb.l
  %.126.i.i.i = phi i32 [ %i.cq, %bb.l ], [ %i.cr, %.lr.ph._crit_edge.i.i.i ] ; 2 uses
  %.1.i.i.i = phi i32 [ %i.co, %bb.l ], [ %i.cs, %.lr.ph._crit_edge.i.i.i ] ; 5 uses
  %i.cv = icmp slt i32 %.126.i.i.i, %i.bn
  br i1 %i.cv, label %.lr.ph.i.i.i, label %remove_scep_3_bytes.exit.i.i, !llvm.loop !50
...
remove_scep_3_bytes.exit.i.i:                     ; preds = %bb.m
  ...
  %i.cw = icmp sgt i32 %.1.i.i.i, 32
  br i1 %i.cw, label %.lr.ph.preheader.i.i, label %decrypt_nal_unit.exit.thread.i

.lr.ph.preheader.i.i:                             ; preds = %remove_scep_3_bytes.exit.i.i
  %i.cx = add nsw i32 %.1.i.i.i, -32
  %i.cy = getelementptr inbounds nuw i8, ptr %i.ak, i64 32
  br label %.lr.ph.i31.i

.lr.ph.i31.i:                                     ; preds = %bb.o, %.lr.ph.preheader.i.i
  %.026.i.i = phi ptr [ %i.df, %bb.o ], [ %i.cy, %.lr.ph.preheader.i.i ] ; 4 uses
  %.02125.i.i = phi i32 [ %i.dg, %bb.o ], [ %i.cx, %.lr.ph.preheader.i.i ] ; 3 uses
  %i.cz = icmp samesign ugt i32 %.02125.i.i, 16
  br i1 %i.cz, label %bb.n, label %bb.o

bb.n:                                             ; preds = %.lr.ph.i31.i
  %i.da = load ptr, ptr %1, align 8, !tbaa !47
  call void @av_aes_crypt(ptr noundef %i.da, ptr noundef %.026.i.i, ptr noundef %.026.i.i, i32 noundef 1, ptr noundef nonnull %i.c, i32 noundef 1) #6
  %i.db = getelementptr inbounds nuw i8, ptr %.026.i.i, i64 16
  %i.dc = add nsw i32 %.02125.i.i, -16
  br label %bb.o

bb.o:                                             ; preds = %bb.n, %.lr.ph.i31.i
  %.122.i.i = phi i32 [ %i.dc, %bb.n ], [ %.02125.i.i, %.lr.ph.i31.i ] ; 2 uses
  %.1.i.i = phi ptr [ %i.db, %bb.n ], [ %.026.i.i, %.lr.ph.i31.i ]
  %i.dd = call i32 @llvm.umin.i32(i32 %.122.i.i, i32 144) ; 2 uses
  %i.de = zext nneg i32 %i.dd to i64
  %i.df = getelementptr inbounds nuw i8, ptr %.1.i.i, i64 %i.de
  %i.dg = sub nsw i32 %.122.i.i, %i.dd            ; 2 uses
  %i.dh = icmp sgt i32 %i.dg, 0
  br i1 %i.dh, label %.lr.ph.i31.i, label %decrypt_nal_unit.exit.thread.i, !llvm.loop !51

decrypt_nal_unit.exit.thread.i:                   ; preds = %bb.o, %remove_scep_3_bytes.exit.i.i
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #6
  %i.di = icmp ne i32 %.1.i.i.i, %i.bn
...
bb.p:                                             ; preds = %decrypt_nal_unit.exit.thread.i, %.loopexit.i
  %.sroa.9.0.i = phi i32 [ %.1.i.i.i, %decrypt_nal_unit.exit.thread.i ], [ %i.bn, %.loopexit.i ] ; 2 uses
  %.2.i = phi i32 [ %i.dj, %decrypt_nal_unit.exit.thread.i ], [ %.02263.i, %.loopexit.i ] ; 2 uses
...
bb.q:                                             ; preds = %bb.p
  %i.dk = zext nneg i32 %.sink.i.i to i64
  %i.dl = sub nsw i64 0, %i.dk
  %i.dm = getelementptr inbounds i8, ptr %i.ak, i64 %i.dl
  %i.dn = add nsw i32 %.sroa.9.0.i, %.sink.i.i
  %i.do = sext i32 %i.dn to i64                   ; 2 uses
  call void @llvm.memmove.p0.p0.i64(ptr align 1 %.02362.i, ptr nonnull align 1 %i.dm, i64 %i.do, i1 false)
  br label %bb.r

bb.r:                                             ; preds = %bb.q, %._crit_edge66.i
  %.pre-phi69.i = phi i64 [ %.pre68.i, %._crit_edge66.i ], [ %i.do, %bb.q ]
  %i.dp = getelementptr inbounds i8, ptr %.02362.i, i64 %.pre-phi69.i ; 2 uses
  %i.dq = icmp ult ptr %.sroa.045.1.i, %i.i
  br i1 %i.dq, label %bb.c, label %._crit_edge.loopexit.i, !llvm.loop !52
...
._crit_edge.i:                                    ; preds = %._crit_edge.loopexit.i, %bb.b
  %i.dr = phi ptr [ %i.e, %bb.b ], [ %.pre.i, %._crit_edge.loopexit.i ]
  %.023.lcssa.i = phi ptr [ %i.e, %bb.b ], [ %i.dp, %._crit_edge.loopexit.i ]
  %i.ds = ptrtoint ptr %.023.lcssa.i to i64
  %i.dt = ptrtoint ptr %i.dr to i64
  %i.du = sub i64 %i.ds, %i.dt
  %i.dv = trunc i64 %i.du to i32
  call void @av_shrink_packet(ptr noundef nonnull %2, i32 noundef %i.dv) #6
  br label %decrypt_video_frame.exit

bb.s:                                             ; preds = %bb.a, %bb.a, %bb.a
  %i.dw = getelementptr i8, ptr %2, i64 24
  %.val = load ptr, ptr %i.dw, align 8, !tbaa !43 ; 3 uses
  %i.dx = getelementptr i8, ptr %2, i64 32
  %.val13 = load i32, ptr %i.dx, align 8, !tbaa !44 ; 2 uses
  %i.dy = sext i32 %.val13 to i64
  %i.dz = getelementptr i8, ptr %.val, i64 %i.dy  ; 5 uses
  %i.ea = icmp sgt i32 %.val13, 0
  br i1 %i.ea, label %.lr.ph.i14, label %decrypt_video_frame.exit

.lr.ph.i14:                                       ; preds = %bb.s
  %i.eb = getelementptr inbounds i8, ptr %i.dz, i64 -1 ; 2 uses
  %i.ec = ptrtoaddr ptr %i.dz to i64
  %i.ed = ptrtoint ptr %i.dz to i64               ; 3 uses
...
.lr.ph.split.split.us.i:                          ; preds = %.lr.ph.i14, %bb.aa
  %.sroa.09.023.us.i = phi ptr [ %i.fn, %bb.aa ], [ %.val, %.lr.ph.i14 ] ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #6
  store ptr null, ptr %i.b, align 8, !tbaa !53
  %i.eg = icmp ult ptr %.sroa.09.023.us.i, %i.eb
  br i1 %i.eg, label %.lr.ph.preheader.i.i.us.i, label %get_next_adts_frame.exit.i.us.thread.i

.lr.ph.preheader.i.i.us.i:                        ; preds = %.lr.ph.split.split.us.i
  %.promoted24.i.i.us.i = ptrtoaddr ptr %.sroa.09.023.us.i to i64
  %i.eh = xor i64 %.promoted24.i.i.us.i, -1
  %i.ei = getelementptr i8, ptr %.sroa.09.023.us.i, i64 %i.eh
  %scevgep.i.i.us.i = getelementptr i8, ptr %i.ei, i64 %i.ed
  br label %.lr.ph.i.i.us.i

.lr.ph.i.i.us.i:                                  ; preds = %bb.u, %.lr.ph.preheader.i.i.us.i
  %.sroa.09.1.us.i = phi ptr [ %.sroa.09.023.us.i, %.lr.ph.preheader.i.i.us.i ], [ %i.eo, %bb.u ] ; 7 uses
  %i.ej = load i8, ptr %.sroa.09.1.us.i, align 1, !tbaa !9
  %i.ek = icmp eq i8 %i.ej, -1
  br i1 %i.ek, label %bb.t, label %bb.u

bb.t:                                             ; preds = %.lr.ph.i.i.us.i
  %i.el = getelementptr inbounds nuw i8, ptr %.sroa.09.1.us.i, i64 1
  %i.em = load i8, ptr %i.el, align 1, !tbaa !9
  %i.en = icmp ugt i8 %i.em, -17
  br i1 %i.en, label %bb.v, label %bb.u
end_hunk_0
