...
begin_hunk_0_@config_props:bb.a
  %i.ir = load i32, ptr %i.bu, align 8, !tbaa !44
  %i.is = icmp eq i32 %i.ir, 0
  br i1 %i.is, label %bb.q, label %bb.r

bb.q:                                             ; preds = %bb.p
  %.val.2 = load i64, ptr %i.bv, align 8, !tbaa !48
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #10
  %i.it = sitofp nsz i64 %.val.2 to double
  store double %i.it, ptr %i.bw, align 16, !tbaa !50
  %i.iu = getelementptr inbounds nuw i8, ptr %i.i, i64 32
  %i.iv = load i32, ptr %i.iu, align 8, !tbaa !24
  %i.iw = sitofp nsz i32 %i.iv to double
  store double %i.iw, ptr %i.bx, align 16, !tbaa !50
  %i.ix = getelementptr inbounds nuw i8, ptr %i.i, i64 48
  %i.iy = load i32, ptr %i.ix, align 8, !tbaa !24
  %i.iz = sitofp nsz i32 %i.iy to double
  store double %i.iz, ptr %i.by, align 8, !tbaa !50
  %i.ja = load i64, ptr %i.ik, align 8, !tbaa !51 ; 3 uses
  %i.jb = load i64, ptr %i.im, align 8, !tbaa !51 ; 2 uses
  ...
  store <2 x double> %i.je, ptr %i.bz, align 8, !tbaa !50
...
.lr.ph4.split.i.2:                                ; preds = %.lr.ph4.i.2, %._crit_edge.i.2
  ...
  %i.jj = uitofp nsz nneg i32 %i.ji to double
  store double %i.jj, ptr %i.a, align 16, !tbaa !50
...
.lr.ph.i.2:                                       ; preds = %.lr.ph4.split.i.2, %.lr.ph.i.2
  ...
  %i.jl = uitofp nsz nneg i32 %i.jk to double
  store double %i.jl, ptr %i.ca, align 8, !tbaa !50
  %i.jm = load ptr, ptr %i.jf, align 8, !tbaa !28
  %i.jn = call nsz double @av_expr_eval(ptr noundef %i.jm, ptr noundef nonnull %i.a, ptr noundef nonnull %i.i) #10
  %i.jo = load ptr, ptr %i.iq, align 8, !tbaa !53
  %i.jp = load i64, ptr %i.im, align 8, !tbaa !51 ; 3 uses
  ...
  store double %i.jn, ptr %i.js, align 8, !tbaa !50
  %indvars.iv.next.i.2 = add nuw nsw i64 %indvars.iv.i.2, 1 ; 2 uses
  %i.jt = icmp ugt i64 %i.jp, %indvars.iv.next.i.2
  br i1 %i.jt, label %.lr.ph.i.2, label %._crit_edge.loopexit.i.2, !llvm.loop !0

._crit_edge.loopexit.i.2:                         ; preds = %.lr.ph.i.2
  %.pre.i.2 = load i64, ptr %i.ik, align 8, !tbaa !51
...
._crit_edge.i.2:                                  ; preds = %._crit_edge.loopexit.i.2, %.lr.ph4.split.i.2
  ...
  br i1 %i.jw, label %.lr.ph4.split.i.2, label %do_eval.exit.2, !llvm.loop !1
...
bb.r:                                             ; preds = %do_eval.exit.2, %bb.p
  %i.jx = load i32, ptr %i.o, align 4, !tbaa !45
...
bb.s:                                             ; preds = %bb.r
  store ptr @rdft_horizontal8, ptr %i.jz, align 8, !tbaa !42
  store ptr @irdft_horizontal8, ptr %i.ka, align 8, !tbaa !59
  br label %.thread187

bb.t:                                             ; preds = %bb.r
  store ptr @rdft_horizontal16, ptr %i.jz, align 8, !tbaa !42
  store ptr @irdft_horizontal16, ptr %i.ka, align 8, !tbaa !59
  br label %.thread187
...
bb.b:                                             ; preds = %.lr.ph, %._crit_edge49
  ...
  %i.t = load i64, ptr %i.s, align 8, !tbaa !51   ; 4 uses
  ...
  %i.y = load i64, ptr %i.x, align 8, !tbaa !51   ; 3 uses
  %sext = shl i64 %i.r, 32
  ...
  %i.ah = load i32, ptr %i.ag, align 4, !tbaa !24 ; 9 uses
  ...
  %i.al = load ptr, ptr %i.ak, align 8, !tbaa !56 ; 6 uses
...
.preheader.us.preheader:                          ; preds = %.preheader.lr.ph
  ...
  %i.bm = ashr exact i64 %sext100, 30             ; 2 uses
  %4 = getelementptr i8, ptr %i.aj, i64 %i.bl
  %i.bn = getelementptr i8, ptr %4, i64 %i.bm
  %i.bo = getelementptr i8, ptr %i.aj, i64 %i.bm
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %copy_rev.exit.us
  ...
  %indvars.iv80 = phi i64 [ %i.ax, %.preheader.us.preheader ], [ %indvars.iv.next81, %copy_rev.exit.us ] ; 3 uses
  %i.bs = shl i64 %indvar, 2                      ; 2 uses
  %scevgep110 = getelementptr i8, ptr %i.bn, i64 %i.bs ; 4 uses
  %scevgep111 = getelementptr i8, ptr %i.bo, i64 %i.bs ; 4 uses
...
vector.body:                                      ; preds = %vector.memcheck, %vector.body
  ...
  %i.co = load float, ptr %i.ck, align 4, !tbaa !58, !alias.scope !101
  %i.cp = load float, ptr %i.cl, align 4, !tbaa !58, !alias.scope !101
  %i.cq = load float, ptr %i.cm, align 4, !tbaa !58, !alias.scope !101
  %i.cr = load float, ptr %i.cn, align 4, !tbaa !58, !alias.scope !101
  ...
  store <4 x float> %i.cv, ptr %i.cw, align 4, !tbaa !58, !alias.scope !102, !noalias !101
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.cx = icmp eq i64 %index.next, %n.vec
  br i1 %i.cx, label %middle.block, label %vector.body, !llvm.loop !94
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  ...
  %i.cz = load float, ptr %gep.prol, align 4, !tbaa !58
  %gep106.prol = getelementptr [4 x i8], ptr %invariant.gep105, i64 %indvars.iv75.prol
  store float %i.cz, ptr %gep106.prol, align 4, !tbaa !58
  ...
  br i1 %prol.iter117.cmp.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol, !llvm.loop !95
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  %i.dd = load float, ptr %gep, align 4, !tbaa !58
  %gep106 = getelementptr [4 x i8], ptr %invariant.gep105, i64 %indvars.iv75
  store float %i.dd, ptr %gep106, align 4, !tbaa !58
  ...
  %i.df = load float, ptr %gep.1, align 4, !tbaa !58
  %gep106.1 = getelementptr [4 x i8], ptr %invariant.gep105, i64 %indvars.iv.next76
  store float %i.df, ptr %gep106.1, align 4, !tbaa !58
  ...
  %i.dh = load float, ptr %gep.2, align 4, !tbaa !58
  %gep106.2 = getelementptr [4 x i8], ptr %invariant.gep105, i64 %indvars.iv.next76.1
  store float %i.dh, ptr %gep106.2, align 4, !tbaa !58
  ...
  %i.dj = load float, ptr %gep.3, align 4, !tbaa !58
  %gep106.3 = getelementptr [4 x i8], ptr %invariant.gep105, i64 %indvars.iv.next76.2
  store float %i.dj, ptr %gep106.3, align 4, !tbaa !58
  ...
  br i1 %exitcond79.not.3, label %._crit_edge.us, label %scalar.ph, !llvm.loop !96
...
.lr.ph.i.us:                                      ; preds = %._crit_edge.us, %.lr.ph.i.us
  ...
  store float %i.dp, ptr %i.dq, align 4, !tbaa !58
  %indvars.iv.next.i.us = add nuw nsw i64 %indvars.iv.i.us, 1 ; 3 uses
  %i.dr = icmp slt i64 %indvars.iv.next.i.us, %i.au
  br i1 %i.dr, label %.lr.ph.i.us, label %.preheader.loopexit.i.us, !llvm.loop !2
...
.lr.ph21.i.us.prol:                               ; preds = %.lr.ph21.preheader.i.us, %.lr.ph21.i.us.prol
  ...
  %i.dy = load float, ptr %i.dx, align 4, !tbaa !58
  ...
  br i1 %prol.iter120.cmp.not, label %.lr.ph21.i.us.prol.loopexit, label %.lr.ph21.i.us.prol, !llvm.loop !97
...
.lr.ph21.i.us:                                    ; preds = %.lr.ph21.i.us.prol.loopexit, %.lr.ph21.i.us
  ...
  %i.ee = load float, ptr %i.ed, align 4, !tbaa !58
  %i.ef = getelementptr inbounds [4 x i8], ptr %i.es, i64 %indvars.iv23.i.us
  store float %i.ee, ptr %i.ef, align 4, !tbaa !58
  ...
  %i.em = load float, ptr %i.el, align 4, !tbaa !58
  %i.en = getelementptr inbounds [4 x i8], ptr %i.es, i64 %indvars.iv.next24.i.us.1
  store float %i.em, ptr %i.en, align 4, !tbaa !58
  ...
  store float %i.eq, ptr %i.er, align 4, !tbaa !58
  ...
  br i1 %exitcond.not.i.us.3, label %copy_rev.exit.us, label %.lr.ph21.i.us, !llvm.loop !3
...
copy_rev.exit.us:                                 ; preds = %.lr.ph21.i.us.prol.loopexit, %.lr.ph21.i.us, %.preheader.i.us
  ...
  br i1 %exitcond84.not, label %._crit_edge49, label %.preheader.us, !llvm.loop !98
...
.lr.ph21.i.prol:                                  ; preds = %.lr.ph21.preheader.i, %.lr.ph21.i.prol
  ...
  %i.cr = load float, ptr %i.cq, align 4, !tbaa !58
  %i.cs = getelementptr inbounds [4 x i8], ptr %i.bx, i64 %indvars.iv23.i.prol
  store float %i.cr, ptr %i.cs, align 4, !tbaa !58
  ...
  br i1 %prol.iter105.cmp.not, label %.lr.ph21.i.prol.loopexit, label %.lr.ph21.i.prol, !llvm.loop !122
...
.lr.ph.i:                                         ; preds = %._crit_edge, %.lr.ph.i
  ...
  %i.da = load float, ptr %i.cz, align 4, !tbaa !58
  %i.db = getelementptr inbounds [4 x i8], ptr %i.bx, i64 %indvars.iv.i
  store float %i.da, ptr %i.db, align 4, !tbaa !58
  %indvars.iv.next.i = add nsw i64 %indvars.iv.i, 1 ; 3 uses
  %i.dc = icmp slt i64 %indvars.iv.next.i, %i.ay
  br i1 %i.dc, label %.lr.ph.i, label %.preheader.loopexit.i, !llvm.loop !2
...
.lr.ph21.i:                                       ; preds = %.lr.ph21.i.prol.loopexit, %.lr.ph21.i
  ...
  %i.df = load float, ptr %i.de, align 4, !tbaa !58
  %i.dg = getelementptr inbounds [4 x i8], ptr %i.bx, i64 %indvars.iv23.i
  store float %i.df, ptr %i.dg, align 4, !tbaa !58
  ...
  store float %i.dj, ptr %i.dk, align 4, !tbaa !58
  ...
  %i.dn = load float, ptr %i.dm, align 4, !tbaa !58
  %i.do = getelementptr inbounds [4 x i8], ptr %i.bx, i64 %indvars.iv.next24.i.1
  store float %i.dn, ptr %i.do, align 4, !tbaa !58
...
._crit_edge72:                                    ; preds = %bb.b, %._crit_edge72.loopexit
  ...
  br i1 %i.el, label %bb.b, label %._crit_edge76, !llvm.loop !125

bb.d:                                             ; preds = %.lr.ph71, %bb.d
  %indvars.iv83 = phi i64 [ %i.bt, %.lr.ph71 ], [ %indvars.iv.next84, %bb.d ] ; 2 uses
  %i.em = load ptr, ptr %i.p, align 8, !tbaa !66
  %i.en = load ptr, ptr %i.bp, align 8, !tbaa !65
  %i.eo = load ptr, ptr %i.bq, align 8, !tbaa !56
  %i.ep = load i64, ptr %i.br, align 8, !tbaa !51
  %i.eq = mul i64 %i.ep, %indvars.iv83            ; 2 uses
  %i.er = getelementptr inbounds nuw [4 x i8], ptr %i.eo, i64 %i.eq
  %i.es = load ptr, ptr %i.bs, align 8, !tbaa !56
  ...
  br i1 %exitcond86.not, label %._crit_edge72.loopexit, label %bb.d, !llvm.loop !126
}
...
bb.b:                                             ; preds = %.lr.ph70, %._crit_edge67.split
  ...
  %i.v = load i32, ptr %i.u, align 4, !tbaa !24   ; 3 uses
...
bb.c:                                             ; preds = %.lr.ph, %bb.c
  ...
  %i.av = load ptr, ptr %i.l, align 8, !tbaa !67
  %i.aw = load ptr, ptr %i.ag, align 8, !tbaa !65
  %i.ax = load ptr, ptr %i.ah, align 8, !tbaa !56
  %i.ay = load i64, ptr %i.ai, align 8, !tbaa !51
  %i.az = mul i64 %i.ay, %indvars.iv              ; 2 uses
  %i.ba = getelementptr inbounds nuw [4 x i8], ptr %i.ax, i64 %i.az
  %i.bb = load ptr, ptr %i.aj, align 8, !tbaa !56
  ...
  br i1 %exitcond.not, label %.lr.ph66, label %bb.c, !llvm.loop !129

._crit_edge67.split:                              ; preds = %._crit_edge, %bb.b, %.lr.ph66
  %indvars.iv.next83 = add nuw nsw i64 %indvars.iv82, 1 ; 2 uses
  %i.bd = load i32, ptr %i.c, align 8, !tbaa !43
  %i.be = sext i32 %i.bd to i64
  %i.bf = icmp slt i64 %indvars.iv.next83, %i.be
  br i1 %i.bf, label %bb.b, label %._crit_edge71, !llvm.loop !130

.lr.ph64:                                         ; preds = %.lr.ph64.preheader, %._crit_edge
  %indvar = phi i64 [ 0, %.lr.ph64.preheader ], [ %indvar.next, %._crit_edge ] ; 2 uses
  %indvars.iv77 = phi i64 [ %i.as, %.lr.ph64.preheader ], [ %indvars.iv.next78, %._crit_edge ] ; 3 uses
  %i.bg = load i64, ptr %i.al, align 8, !tbaa !51
  %i.bh = load i64, ptr %i.am, align 8, !tbaa !51
  %i.bi = mul i64 %i.bh, %i.bg
  %i.bj = uitofp nsz i64 %i.bi to float
  %i.bk = fdiv nnan nsz float 1.000000e+00, %i.bj ; 4 uses
  %i.bl = load ptr, ptr %i.an, align 8, !tbaa !56 ; 2 uses
  %i.bm = load i64, ptr %i.ao, align 8, !tbaa !51 ; 2 uses
  %i.bn = mul i64 %i.bm, %indvars.iv77
  %i.bo = getelementptr inbounds nuw [4 x i8], ptr %i.bl, i64 %i.bn ; 5 uses
  %i.bp = load ptr, ptr %i.ap, align 8, !tbaa !25 ; 2 uses
  %i.bq = load i32, ptr %i.aq, align 4, !tbaa !24
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x float>, ptr %i.bw, align 4, !tbaa !58, !alias.scope !137
  ...
  store <4 x i8> %i.ce, ptr %i.cf, align 1, !tbaa !60, !alias.scope !138, !noalias !137
  %index.next = add nuw i64 %index, 4             ; 2 uses
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader
  ...
  store i8 %.0.i.prol, ptr %i.co, align 1, !tbaa !60
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  store i8 %.0.i, ptr %i.cx, align 1, !tbaa !60
  ...
  %i.cz = load float, ptr %i.cy, align 4, !tbaa !58
  ...
  store i8 %.0.i.1, ptr %i.df, align 1, !tbaa !60
...
bb.b:                                             ; preds = %.lr.ph75, %._crit_edge72
  ...
  %i.v = load i32, ptr %i.u, align 4, !tbaa !24   ; 8 uses
...
.lr.ph69:                                         ; preds = %bb.b
  ...
  %i.aq = load i64, ptr %i.ap, align 8, !tbaa !51 ; 3 uses
...
vector.body:                                      ; preds = %.lr.ph.preheader, %vector.body
  ...
  %wide.load = load <4 x i16>, ptr %i.bl, align 2, !tbaa !69
  %wide.load97 = load <4 x i16>, ptr %i.bm, align 2, !tbaa !69
  ...
  store <4 x float> %i.bn, ptr %i.bp, align 4, !tbaa !58
  store <4 x float> %i.bo, ptr %i.bq, align 4, !tbaa !58
...
.lr.ph21.i.prol:                                  ; preds = %.lr.ph21.preheader.i, %.lr.ph21.i.prol
  ...
  %i.by = load float, ptr %i.bx, align 4, !tbaa !58
  %i.bz = getelementptr inbounds [4 x i8], ptr %i.bk, i64 %indvars.iv23.i.prol
  store float %i.by, ptr %i.bz, align 4, !tbaa !58
  %indvars.iv.next24.i.prol = add nsw i64 %indvars.iv23.i.prol, 1 ; 2 uses
