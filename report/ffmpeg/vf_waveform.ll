...
.preheader.lr.ph:                                 ; preds = %bb.a
  ...
  %i.ba = load ptr, ptr %i.az, align 8, !tbaa !119 ; 4 uses
  ...
  %i.bf = load i32, ptr %i.be, align 4, !tbaa !103 ; 3 uses
  ...
  %i.bl = load i32, ptr %i.bk, align 4, !tbaa !84
...
.preheader.preheader:                             ; preds = %.preheader.lr.ph
  ...
  %i.dh = load ptr, ptr %i.dg, align 8, !tbaa !104
  ...
  %i.dp = load i32, ptr %i.do, align 8, !tbaa !122
  ...
  %i.dt = load ptr, ptr %i.ds, align 8, !tbaa !104
  ...
  %i.dz = load ptr, ptr %i.dy, align 8, !tbaa !104
...
bb.b:                                             ; preds = %.preheader, %bb.b
  ...
  %i.eh = load i16, ptr %i.eg, align 2, !tbaa !106
  ...
  %i.en = load i16, ptr %i.em, align 2, !tbaa !106
  ...
  %i.et = load i16, ptr %i.es, align 2, !tbaa !106
  ...
  %i.ey = load i16, ptr %i.ex, align 2, !tbaa !106
  ...
  store i16 %storemerge.i, ptr %i.ex, align 2, !tbaa !106
  %i.fb = add i32 %i.ep, %.
  %i.fc = sext i32 %i.fb to i64
  %i.fd = getelementptr inbounds [2 x i8], ptr %.0166202, i64 %i.fc ; 2 uses
  %i.fe = load i16, ptr %i.fd, align 2, !tbaa !106
  ...
  store i16 %storemerge.i193, ptr %i.fd, align 2, !tbaa !106
  %i.fh = add i32 %i.ev, %.
  %i.fi = sext i32 %i.fh to i64
  %i.fj = getelementptr inbounds [2 x i8], ptr %.0203, i64 %i.fi ; 2 uses
  %i.fk = load i16, ptr %i.fj, align 2, !tbaa !106
  ...
  store i16 %storemerge.i195, ptr %i.fj, align 2, !tbaa !106
  %i.fn = add nuw nsw i32 %.0174196, 1            ; 2 uses
  %exitcond.not = icmp eq i32 %i.fn, %i.am
  br i1 %exitcond.not, label %._crit_edge, label %bb.b, !llvm.loop !264
...
._crit_edge:                                      ; preds = %bb.b
  ...
  br i1 %exitcond205.not, label %._crit_edge204.split, label %.preheader, !llvm.loop !265
...
bb.b:                                             ; preds = %bb.b, %.lr.ph.new
  ...
  %11 = load i8, ptr %.01112, align 1, !tbaa !96
  ...
  store i8 %15, ptr %.01112, align 1, !tbaa !96
  %16 = getelementptr inbounds i8, ptr %.01112, i64 %i.d ; 3 uses
  %i.e = load i8, ptr %16, align 1, !tbaa !96
...
.epil.preheader:                                  ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph
  ...
  %18 = load i8, ptr %.01112.epil.init, align 1, !tbaa !96
  ...
  store i8 %22, ptr %.01112.epil.init, align 1, !tbaa !96
  br label %._crit_edge
...
bb.b:                                             ; preds = %bb.b, %.lr.ph.new
  ...
  %11 = load i16, ptr %.01213, align 2, !tbaa !106
  %12 = uitofp i16 %11 to float
  %13 = fmul nsz float %4, %12
  %14 = tail call nsz float @llvm.fmuladd.f32(float %i.b, float %3, float %13)
  %15 = fptoui float %14 to i16
  store i16 %15, ptr %.01213, align 2, !tbaa !106
  %16 = getelementptr inbounds [2 x i8], ptr %.01213, i64 %i.e ; 3 uses
  %i.f = load i16, ptr %16, align 2, !tbaa !106
  ...
  store i16 %i.j, ptr %16, align 2, !tbaa !106
  ...
  br i1 %niter.ncmp.1.not, label %._crit_edge.loopexit.unr-lcssa, label %bb.b, !llvm.loop !267
...
.epil.preheader:                                  ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph
  ...
  %18 = load i16, ptr %.01213.epil.init, align 2, !tbaa !106
  %19 = uitofp i16 %18 to float
  %20 = fmul nsz float %4, %19
  %21 = tail call nsz float @llvm.fmuladd.f32(float %i.b, float %3, float %20)
  %22 = fptoui float %21 to i16
  store i16 %22, ptr %.01213.epil.init, align 2, !tbaa !106
  br label %._crit_edge
...
.preheader:                                       ; preds = %bb.b
  %i.f = load i8, ptr %6, align 1, !tbaa !96
...
bb.c:                                             ; preds = %.lr.ph, %bb.u
  ...
  %i.j = load i8, ptr %i.g, align 1, !tbaa !96
...
bb.d:                                             ; preds = %bb.c, %bb.t
  ...
  %i.p = load ptr, ptr %i.d, align 8, !tbaa !104
  %i.q = load i32, ptr %i.h, align 4, !tbaa !84   ; 2 uses
  ...
  %i.v = load i8, ptr %i.i, align 1, !tbaa !96
...
bb.e:                                             ; preds = %bb.d
  ...
  store i8 %i.ah, ptr %i.ad, align 1, !tbaa !96
  %.pre = load i32, ptr %i.h, align 4, !tbaa !84
  %.pre57 = load i8, ptr %i.i, align 1, !tbaa !96
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.ap = load i8, ptr %i.ao, align 1, !tbaa !96
  ...
  store i8 %i.as, ptr %i.ao, align 1, !tbaa !96
  %.pre58 = load i32, ptr %i.h, align 4, !tbaa !84
  %.pre59 = load i8, ptr %i.i, align 1, !tbaa !96
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.ay = load i8, ptr %i.ax, align 1, !tbaa !96
  ...
  store i8 %i.bb, ptr %i.ax, align 1, !tbaa !96
  %.pre60 = load i32, ptr %i.h, align 4, !tbaa !84
  %.pre61 = load i8, ptr %i.i, align 1, !tbaa !96
...
bb.j:                                             ; preds = %bb.i, %bb.h
  ...
  %i.be = load i8, ptr %i.bd, align 1, !tbaa !96
  %i.bf = and i8 %i.be, 16
...
bb.k:                                             ; preds = %bb.j
  ...
  store i8 %i.bk, ptr %i.bg, align 1, !tbaa !96
  %.pre62 = load i32, ptr %i.h, align 4, !tbaa !84
  %.pre63 = load i8, ptr %i.i, align 1, !tbaa !96
...
bb.l:                                             ; preds = %bb.k, %bb.j
  ...
  %i.bn = load i8, ptr %i.bm, align 1, !tbaa !96
  %i.bo = and i8 %i.bn, 8
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.bq = load i8, ptr %i.bp, align 1, !tbaa !96
  ...
  store i8 %i.bt, ptr %i.bp, align 1, !tbaa !96
  %.pre64 = load i32, ptr %i.h, align 4, !tbaa !84
  %.pre65 = load i8, ptr %i.i, align 1, !tbaa !96
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.bz = load i8, ptr %i.by, align 1, !tbaa !96
...
bb.d:                                             ; preds = %.preheader
  %i.ab = load i16, ptr %.047, align 2, !tbaa !106
  ...
  store i16 %i.ae, ptr %.047, align 2, !tbaa !106
  %.pre = load i8, ptr %i.o, align 1, !tbaa !96
...
bb.e:                                             ; preds = %bb.d, %.preheader
  ...
  %i.ag = load i8, ptr %i.af, align 1, !tbaa !96
  %i.ah = and i8 %i.ag, 64
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.aj = load i16, ptr %i.ai, align 2, !tbaa !106
  ...
  store i16 %i.am, ptr %i.ai, align 2, !tbaa !106
  %.pre56 = load i8, ptr %i.o, align 1, !tbaa !96
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  %i.ao = load i8, ptr %i.an, align 1, !tbaa !96
  %i.ap = and i8 %i.ao, 32
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.ar = load i16, ptr %i.aq, align 2, !tbaa !106
  ...
  store i16 %i.au, ptr %i.aq, align 2, !tbaa !106
  %.pre57 = load i8, ptr %i.o, align 1, !tbaa !96
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.az = load i16, ptr %i.ay, align 2, !tbaa !106
  ...
  store i16 %i.bc, ptr %i.ay, align 2, !tbaa !106
  %.pre58 = load i8, ptr %i.o, align 1, !tbaa !96
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.bh = load i16, ptr %i.bg, align 2, !tbaa !106
  ...
  store i16 %i.bk, ptr %i.bg, align 2, !tbaa !106
  %.pre59 = load i8, ptr %i.o, align 1, !tbaa !96
...
bb.m:                                             ; preds = %bb.l, %bb.k
  ...
  %i.bm = load i8, ptr %i.bl, align 1, !tbaa !96
  %i.bn = and i8 %i.bm, 4
...
bb.n:                                             ; preds = %bb.m
  ...
  %i.bp = load i16, ptr %i.bo, align 2, !tbaa !106
  ...
  store i16 %i.bs, ptr %i.bo, align 2, !tbaa !106
  %.pre60 = load i8, ptr %i.o, align 1, !tbaa !96
...
bb.p:                                             ; preds = %bb.o
  ...
  %i.bx = load i16, ptr %i.bw, align 2, !tbaa !106
  ...
  store i16 %i.ca, ptr %i.bw, align 2, !tbaa !106
  %.pre61 = load i8, ptr %i.o, align 1, !tbaa !96
...
bb.q:                                             ; preds = %bb.p, %bb.o
  ...
  %i.cc = load i8, ptr %i.cb, align 1, !tbaa !96
  %i.cd = and i8 %i.cc, 1
...
bb.r:                                             ; preds = %bb.q
  ...
  store i16 %i.ci, ptr %i.ce, align 2, !tbaa !106
  br label %bb.s
...
bb.s:                                             ; preds = %bb.r, %bb.q
  ...
  br i1 %exitcond.not, label %bb.t, label %.preheader, !llvm.loop !282

bb.t:                                             ; preds = %bb.s
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.cl = getelementptr inbounds nuw i8, ptr %6, i64 %indvars.iv.next
  %i.cm = load i8, ptr %i.cl, align 1, !tbaa !96
  %.not40 = icmp eq i8 %i.cm, 0
  br i1 %.not40, label %._crit_edge, label %bb.c, !llvm.loop !283
...
._crit_edge:                                      ; preds = %bb.t, %.preheader43
  ...
  br i1 %exitcond55.not, label %.critedge, label %bb.b, !llvm.loop !284
...
bb.b:                                             ; preds = %bb.b, %.lr.ph.new
  ...
  %11 = load i8, ptr %.01213, align 1, !tbaa !96  ; 2 uses
  ...
  store i8 %18, ptr %.01213, align 1, !tbaa !96
  %19 = getelementptr inbounds i8, ptr %.01213, i64 %i.c ; 3 uses
  %i.d = load i8, ptr %19, align 1, !tbaa !96     ; 2 uses
...
.epil.preheader:                                  ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph
  ...
  %lcmp.mod15 = trunc i32 %9 to i1
  tail call void @llvm.assume(i1 %lcmp.mod15)
  %21 = load i8, ptr %.01213.epil.init, align 1, !tbaa !96 ; 2 uses
  ...
  store i8 %28, ptr %.01213.epil.init, align 1, !tbaa !96
  br label %._crit_edge
...
bb.b:                                             ; preds = %bb.b, %.lr.ph.new
  ...
  %11 = load i16, ptr %.01314, align 2, !tbaa !106 ; 2 uses
  ...
  store i16 %18, ptr %.01314, align 2, !tbaa !106
  %19 = getelementptr inbounds [2 x i8], ptr %.01314, i64 %i.d ; 3 uses
  %i.e = load i16, ptr %19, align 2, !tbaa !106   ; 2 uses
  ...
  store i16 %i.l, ptr %19, align 2, !tbaa !106
  ...
  br i1 %niter.ncmp.1.not, label %._crit_edge.loopexit.unr-lcssa, label %bb.b, !llvm.loop !286
...
.epil.preheader:                                  ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph
  ...
  %21 = load i16, ptr %.01314.epil.init, align 2, !tbaa !106 ; 2 uses
  ...
  store i16 %28, ptr %.01314.epil.init, align 2, !tbaa !106
  br label %._crit_edge
...
bb.d:                                             ; preds = %bb.c, %bb.t
  %indvars.iv = phi i64 [ 7, %bb.c ], [ %indvars.iv.next, %bb.t ] ; 11 uses
  %i.o = load ptr, ptr %i.d, align 8, !tbaa !104
  %i.p = load i32, ptr %i.h, align 4, !tbaa !84   ; 2 uses
  ...
  %i.u = load i8, ptr %i.i, align 1, !tbaa !96
  ...
  %i.ab = load i8, ptr %i.aa, align 1, !tbaa !96
...
bb.e:                                             ; preds = %bb.d
  ...
  store i8 %i.ak, ptr %i.ac, align 1, !tbaa !96
  %.pre = load i32, ptr %i.h, align 4, !tbaa !84
  %.pre59 = load i8, ptr %i.i, align 1, !tbaa !96
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.as = load i8, ptr %i.ar, align 1, !tbaa !96  ; 2 uses
  ...
  store i8 %i.az, ptr %i.ar, align 1, !tbaa !96
  %.pre60 = load i32, ptr %i.h, align 4, !tbaa !84
  %.pre61 = load i8, ptr %i.i, align 1, !tbaa !96
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.bf = load i8, ptr %i.be, align 1, !tbaa !96  ; 2 uses
  ...
  store i8 %i.bm, ptr %i.be, align 1, !tbaa !96
  %.pre62 = load i32, ptr %i.h, align 4, !tbaa !84
  %.pre63 = load i8, ptr %i.i, align 1, !tbaa !96
...
bb.j:                                             ; preds = %bb.i, %bb.h
  ...
  %i.bp = load i8, ptr %i.bo, align 1, !tbaa !96
  %i.bq = and i8 %i.bp, 16
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.bs = load i8, ptr %i.br, align 1, !tbaa !96  ; 2 uses
  ...
  store i8 %i.bz, ptr %i.br, align 1, !tbaa !96
  %.pre64 = load i32, ptr %i.h, align 4, !tbaa !84
  %.pre65 = load i8, ptr %i.i, align 1, !tbaa !96
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.cf = load i8, ptr %i.ce, align 1, !tbaa !96  ; 2 uses
  ...
  store i8 %i.cm, ptr %i.ce, align 1, !tbaa !96
  %.pre66 = load i32, ptr %i.h, align 4, !tbaa !84
  %.pre67 = load i8, ptr %i.i, align 1, !tbaa !96
