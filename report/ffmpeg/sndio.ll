...
bb.c:                                             ; preds = %bb.a
  ...
  store i32 %i.h, ptr %..sroa.sel, align 4, !tbaa !33
  ...
  store i32 %i.j, ptr %i.k, align 4, !tbaa !35
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  %i.p = load i32, ptr %i.i, align 8, !tbaa !34
...
bb.f:                                             ; preds = %bb.d
  ...
  %.pre59 = load i32, ptr %.phi.trans.insert, align 4, !tbaa !30 ; 5 uses
...
.critedge:                                        ; preds = %bb.g
  ...
  %i.x = load i32, ptr %i.w, align 4, !tbaa !37   ; 2 uses
...
bb.i:                                             ; preds = %bb.h, %.critedge
  ...
  %i.z = load i32, ptr %i.k, align 4, !tbaa !35   ; 2 uses
  %i.aa = load i32, ptr %i.i, align 8, !tbaa !34
...
._crit_edge58:                                    ; preds = %bb.f, %bb.i, %.critedge, %bb.h
  ...
  %i.ac = load i32, ptr %i.i, align 8, !tbaa !34
...
bb.k:                                             ; preds = %bb.j
  ...
  store ptr %i.aq, ptr %i.ar, align 8, !tbaa !41
  %.not52 = icmp eq ptr %i.aq, null
  br i1 %.not52, label %bb.l, label %._crit_edge

._crit_edge:                                      ; preds = %bb.k
  %.pre = load i32, ptr %i.ai, align 4
  %.pre56 = load i32, ptr %i.k, align 4, !tbaa !35
  %.pre57 = load i32, ptr %i.af, align 4, !tbaa !39
  br label %bb.m
...
bb.o:                                             ; preds = %bb.m
  ...
  store ptr %i.d, ptr %i.ba, align 8, !tbaa !44
  br label %bb.q
...
!29 = !{!27, !6, i64 12}
!30 = !{!31, !6, i64 60}
!31 = !{!"SndioData", !11, i64 0, !32, i64 8, !6, i64 16, !21, i64 24, !21, i64 32, !20, i64 40, !6, i64 48, !6, i64 52, !6, i64 56, !6, i64 60, !6, i64 64}
!32 = !{!"p1 _ZTS7sio_hdl", !12, i64 0}
!33 = !{!6, !6, i64 0}
!34 = !{!31, !6, i64 64}
!35 = !{!27, !6, i64 28}
!36 = !{!27, !6, i64 24}
