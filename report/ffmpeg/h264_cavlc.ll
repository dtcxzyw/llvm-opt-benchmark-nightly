...
.thread1604:                                      ; preds = %bb.di
  %indvars.iv1399.tr1606 = trunc i64 %indvars.iv1399 to i32
  %i.akb = shl i32 %indvars.iv1399.tr1606, 1
...
bb.dj:                                            ; preds = %bb.di
  ...
  %indvars.iv1399.tr = trunc i64 %indvars.iv1399 to i32
  %i.akj = shl i32 %indvars.iv1399.tr, 1
...
.preheader1178:                                   ; preds = %.preheader1178.lr.ph, %bb.fm
  ...
  %indvars.iv1409.tr = trunc i64 %indvars.iv1409 to i32
  %i.ask = shl i32 %indvars.iv1409.tr, 1          ; 2 uses
...
bb.fq:                                            ; preds = %.lr.ph, %bb.fw
  ...
  %indvars.iv1339.tr = trunc i64 %indvars.iv1339 to i32
  %i.bgf = shl i32 %indvars.iv1339.tr, 1
...
bb.fx:                                            ; preds = %.lr.ph1222, %bb.gp
  ...
  %indvars.iv1342.tr = trunc i64 %indvars.iv1342 to i32
  %i.bhz = shl i32 %indvars.iv1342.tr, 1
...
.preheader1170:                                   ; preds = %bb.lv
  ...
  %indvars.iv1424.tr1592 = trunc i64 %indvars.iv1424 to i32
  %i.dta = shl i32 %indvars.iv1424.tr1592, 6
...
bb.lw:                                            ; preds = %bb.lv
  %indvars.iv1424.tr = trunc i64 %indvars.iv1424 to i32
  %i.dtl = shl i32 %indvars.iv1424.tr, 6
...
bb.ma:                                            ; preds = %.preheader1170
  ...
  %.tr1593 = trunc i64 %i.dvv to i32
  %i.dvw = shl i32 %.tr1593, 4
...
bb.mb:                                            ; preds = %bb.ma
  ...
  %.tr1594 = trunc i64 %i.dwn to i32
  %i.dwo = shl i32 %.tr1594, 4
...
bb.mc:                                            ; preds = %bb.mb
  ...
  %.tr1595 = trunc i64 %i.dxf to i32
  %i.dxg = shl i32 %.tr1595, 4
...
.preheader1154:                                   ; preds = %bb.mw
  ...
  %.tr1596 = trunc i64 %i.efk to i32
  %i.efl = shl i32 %.tr1596, 4
...
bb.nb:                                            ; preds = %.preheader1154
  ...
  %.tr1597 = trunc i64 %i.eij to i32
  %i.eik = shl i32 %.tr1597, 4
...
bb.nc:                                            ; preds = %bb.nb
  ...
  %.tr1598 = trunc i64 %i.ejb to i32
  %i.ejc = shl i32 %.tr1598, 4
...
bb.nd:                                            ; preds = %bb.nc
  ...
  %.tr1599 = trunc i64 %i.ejt to i32
  %i.eju = shl i32 %.tr1599, 4
...
.preheader:                                       ; preds = %bb.nv
  ...
  %.tr1600 = trunc i64 %i.erm to i32
  %i.ern = shl i32 %.tr1600, 4
...
bb.oa:                                            ; preds = %.preheader
  ...
  %.tr1601 = trunc i64 %i.eul to i32
  %i.eum = shl i32 %.tr1601, 4
...
bb.ob:                                            ; preds = %bb.oa
  ...
  %.tr1602 = trunc i64 %i.evd to i32
  %i.eve = shl i32 %.tr1602, 4
...
bb.oc:                                            ; preds = %bb.ob
  ...
  %.tr1603 = trunc i64 %i.evv to i32
  %i.evw = shl i32 %.tr1603, 4
