...
._crit_edge264:                                   ; preds = %scalar.ph403, %middle.block414, %bb.da
  ...
  %i.asc = xor i32 %i.asb, %i.asa                 ; 4 uses
  ...
  %18 = lshr i32 %17, 1
  %19 = xor i32 %18, %17
  %20 = shl nuw nsw i32 %i.asx, 2
  %21 = shl nuw nsw i32 %10, 1
  %22 = xor i32 %10, %21
  %23 = and i32 %22, 2
  %i.asy = or disjoint i32 %20, %23
  %24 = and i32 %19, 1
  %i.asz = or disjoint i32 %24, %i.asy
