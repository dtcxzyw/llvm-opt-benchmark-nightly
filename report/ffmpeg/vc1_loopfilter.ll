...
bb.e:                                             ; preds = %bb.d
  ...
  %i.bk = shl i32 %indvars.iv.tr, 2               ; 3 uses
...
bb.x:                                             ; preds = %bb.w
  ...
  %i.ie = shl i32 %indvars.iv1222.tr, 2           ; 3 uses
...
bb.as:                                            ; preds = %bb.ar
  ...
  %i.pc = shl i32 %indvars.iv1226.tr, 2           ; 3 uses
...
.thread1315:                                      ; preds = %bb.bj
  ...
  %i.va = shl i32 %indvars.iv1230.tr, 2           ; 2 uses
...
bb.cc:                                            ; preds = %bb.cb
  ...
  %i.aaw = shl i32 %indvars.iv1234.tr, 2          ; 3 uses
...
.thread1319:                                      ; preds = %bb.ct
  ...
  %i.agq = shl i32 %indvars.iv1238.tr, 2          ; 2 uses
...
bb.dm:                                            ; preds = %bb.dl
  ...
  %i.amt = shl i32 %indvars.iv1242.tr, 2          ; 3 uses
...
bb.eh:                                            ; preds = %bb.eg
  ...
  %i.atg = shl i32 %indvars.iv1246.tr, 2          ; 3 uses
...
bb.ez:                                            ; preds = %bb.ey
  ...
  %i.azb = shl i32 %indvars.iv1250.tr, 2          ; 4 uses
...
bb.ft:                                            ; preds = %bb.fs
  ...
  %i.bfu = shl i32 %indvars.iv1254.tr, 2          ; 3 uses
...
bb.go:                                            ; preds = %bb.gn
  ...
  %i.bmf = shl i32 %indvars.iv1258.tr, 2          ; 3 uses
...
bb.hg:                                            ; preds = %bb.hf
  ...
  %i.brz = shl i32 %indvars.iv1262.tr, 2          ; 4 uses
...
bb.hy:                                            ; preds = %bb.hx
  ...
  %i.byc = shl i32 %indvars.iv1266.tr, 2          ; 3 uses
...
bb.it:                                            ; preds = %bb.is
  ...
  %i.cea = shl i32 %indvars.iv1270.tr, 2          ; 3 uses
...
bb.jl:                                            ; preds = %bb.jk
  ...
  %i.cjj = shl i32 %indvars.iv1274.tr, 2          ; 4 uses
...
bb.t:                                             ; preds = %bb.d
  ...
  %indvars.iv.tr1066 = trunc i64 %indvars.iv to i32
  %i.dg = shl i32 %indvars.iv.tr1066, 2
...
bb.ao:                                            ; preds = %bb.y
  ...
  %indvars.iv621.tr1068 = trunc i64 %indvars.iv621 to i32
  %i.ia = shl i32 %indvars.iv621.tr1068, 2
...
bb.ce:                                            ; preds = %bb.bs
  ...
  %indvars.iv652.tr1070 = trunc i64 %indvars.iv652 to i32
  %i.ur = shl i32 %indvars.iv652.tr1070, 2
...
bb.cw:                                            ; preds = %bb.ck
  ...
  %indvars.iv656.tr1072 = trunc i64 %indvars.iv656 to i32
  %i.yj = shl i32 %indvars.iv656.tr1072, 2
...
bb.dt:                                            ; preds = %.peel.next665
  ...
  %indvars.iv660.tr1074 = trunc i64 %indvars.iv660 to i32
...
bb.ek:                                            ; preds = %bb.dy
  ...
  %indvars.iv667.tr1076 = trunc i64 %indvars.iv667 to i32
  %i.ahl = shl i32 %indvars.iv667.tr1076, 2
...
bb.fc:                                            ; preds = %bb.eq
  ...
  %indvars.iv671.tr1078 = trunc i64 %indvars.iv671 to i32
  %i.alc = shl i32 %indvars.iv671.tr1078, 2
...
bb.fz:                                            ; preds = %.peel.next680
  ...
  %indvars.iv675.tr1080 = trunc i64 %indvars.iv675 to i32
...
bb.go:                                            ; preds = %bb.gc
  ...
  %indvars.iv682.tr1082 = trunc i64 %indvars.iv682 to i32
  %i.att = shl i32 %indvars.iv682.tr1082, 2
...
bb.hg:                                            ; preds = %bb.gu
  ...
  %indvars.iv686.tr1084 = trunc i64 %indvars.iv686 to i32
  %i.axg = shl i32 %indvars.iv686.tr1084, 2
...
bb.id:                                            ; preds = %.peel.next695
  ...
  %indvars.iv690.tr1086 = trunc i64 %indvars.iv690 to i32
...
.thread321:                                       ; preds = %bb.c
  ...
  %indvars.iv.tr323 = trunc i64 %indvars.iv to i32
  %i.ae = shl i32 %indvars.iv.tr323, 2            ; 2 uses
...
.thread327:                                       ; preds = %bb.bl
  ...
  %indvars.iv258.tr329 = trunc i64 %indvars.iv258 to i32
  %i.pi = shl i32 %indvars.iv258.tr329, 2         ; 2 uses
...
.thread330:                                       ; preds = %bb.cy
  ...
  %indvars.iv299.tr332 = trunc i64 %indvars.iv299 to i32
  %i.xo = shl i32 %indvars.iv299.tr332, 2         ; 2 uses
