...
.preheader772:                                    ; preds = %.preheader772.lr.ph.split, %._crit_edge872
  ...
  %i.aat = shl nuw nsw i64 %indvars.iv967, 1
  %2 = mul nsw i64 %i.aaq, %indvars.iv967         ; 2 uses
  %indvars.iv967.tr = trunc i64 %indvars.iv967 to i32
  %3 = shl i32 %indvars.iv967.tr, 4
  %indvars.iv967.tr1076 = trunc i64 %indvars.iv967 to i32
  %4 = shl i32 %indvars.iv967.tr1076, 3           ; 2 uses
  br label %bb.dh
...
.preheader769:                                    ; preds = %bb.dk
  %11 = sext i32 %i.abl to i64                    ; 7 uses
  %12 = sext i32 %i.abi to i64                    ; 7 uses
  ...
  %i.arz = getelementptr inbounds i8, ptr %i.arq, i64 %12
  %i.asa = getelementptr inbounds i8, ptr %i.ars, i64 %11
  ...
  %i.ash = shl nsw i64 %12, 1
  %i.asi = shl nsw i64 %11, 1
  ...
  %i.asr = mul nsw i64 %12, 3
  %i.ass = mul nsw i64 %11, 3
  ...
  %i.atb = shl nsw i64 %12, 2
  %i.atc = shl nsw i64 %11, 2
  ...
  %i.atl = mul nsw i64 %12, 5
  %i.atm = mul nsw i64 %11, 5
  ...
  %i.atv = mul nsw i64 %12, 6
  %i.atw = mul nsw i64 %11, 6
  ...
  %i.auf = mul nsw i64 %12, 7
  %i.aug = mul nsw i64 %11, 7
  ...
  %i.aut = getelementptr [2 x i8], ptr %i.aus, i64 %2
  ...
  %i.auz = getelementptr [2 x i8], ptr %i.auy, i64 %2
...
.lr.ph877:                                        ; preds = %.preheader
  %i.azi = shl nuw nsw i64 %indvars.iv975, 1
  %indvars.iv975.tr = trunc i64 %indvars.iv975 to i32
  %13 = shl i32 %indvars.iv975.tr, 4
  %indvars.iv975.tr1078 = trunc i64 %indvars.iv975 to i32
  %14 = shl i32 %indvars.iv975.tr1078, 3          ; 2 uses
  br label %bb.dm
...
bb.do:                                            ; preds = %bb.dn
  ...
  %15 = mul nsw i32 %13, %i.azz
  %16 = sext i32 %15 to i64
  %i.baa = getelementptr inbounds i8, ptr %i.azy, i64 %16 ; 8 uses
  ...
  %indvars.iv972.tr = trunc i64 %indvars.iv972 to i32
  %i.bai = shl i32 %indvars.iv972.tr, 1
  br label %bb.dp
...
bb.dp:                                            ; preds = %bb.ds, %bb.do
  ...
  %i.bap = add nuw nsw i64 %i.azi, %i.bao
...
bb.dt:                                            ; preds = %bb.ds
  ...
  %17 = mul nsw i32 %i.bad, %14
  %18 = sext i32 %17 to i64
  %i.bdb = getelementptr inbounds i8, ptr %i.bda, i64 %18 ; 8 uses
  %i.bdc = getelementptr inbounds nuw i8, ptr %i.baf, i64 %i.bcz
  %19 = mul nsw i32 %i.bag, %14
  %20 = sext i32 %19 to i64
  %i.bdd = getelementptr inbounds i8, ptr %i.bdc, i64 %20 ; 8 uses
