...
.preheader.i:                                     ; preds = %.preheader.i, %.preheader44.i
  %indvars.iv54.i = phi i64 [ 0, %.preheader44.i ], [ %indvars.iv.next55.i, %.preheader.i ] ; 9 uses
  %4 = shl nuw nsw i64 %indvars.iv54.i, 3         ; 4 uses
  %i.p = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %4
  %i.q = shl nuw nsw i64 %indvars.iv54.i, 35
  ...
  %i.y = or disjoint i64 %4, 2                    ; 2 uses
  ...
  %i.ae = shl i64 %indvars.iv54.i, 35
  ...
  %i.ai = or disjoint i64 %4, 4                   ; 2 uses
  ...
  %i.ao = shl i64 %indvars.iv54.i, 35
  ...
  %i.as = or disjoint i64 %4, 6                   ; 2 uses
  ...
  %i.ay = shl i64 %indvars.iv54.i, 35
...
.preheader.i:                                     ; preds = %.preheader.i, %.preheader44.i
  %indvars.iv54.i = phi i64 [ 0, %.preheader44.i ], [ %indvars.iv.next55.i, %.preheader.i ] ; 7 uses
  %4 = shl nuw nsw i64 %indvars.iv54.i, 2         ; 2 uses
  %i.j = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %4
  %i.k = shl nuw nsw i64 %indvars.iv54.i, 34
  ...
  %i.s = or disjoint i64 %4, 2                    ; 2 uses
