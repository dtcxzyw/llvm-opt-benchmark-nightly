...
vector.ph414:                                     ; preds = %vector.memcheck300
  ...
  %i.wt = shl i32 %i.ws, 2
  %broadcast.splatinsert416 = insertelement <4 x float> poison, float %i.vv, i64 0
  %i.wu = shufflevector <4 x float> %broadcast.splatinsert416, <4 x float> poison, <8 x i32> zeroinitializer ; 2 uses
...
vector.body418:                                   ; preds = %vector.body418, %vector.ph414
  ...
  %5 = shufflevector <4 x float> %i.xi, <4 x float> %i.yj, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  ...
  %6 = shufflevector <4 x float> %i.xx, <4 x float> %i.yv, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  ...
  %i.aas = shufflevector <4 x float> %i.zt, <4 x float> %i.aar, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.aat = tail call nsz <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.wu, <8 x float> %5, <8 x float> %6)
  %i.aau = tail call nsz <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.wu, <8 x float> %7, <8 x float> %i.aas)
