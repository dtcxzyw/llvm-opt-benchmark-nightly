...
.loopexit254:                                     ; preds = %bb.e, %bb.as
  ...
  %i.cx = load ptr, ptr %i.c, align 8, !tbaa !93  ; 2 uses
...
bb.bc:                                            ; preds = %bb.bb, %bb.ba
  ...
  store ptr %i.do, ptr %i.d, align 8, !tbaa !93
...
bb.bk:                                            ; preds = %bb.bj
  %i.ea = load ptr, ptr %i.k, align 8, !tbaa !67  ; 8 uses
  %i.eb = load i32, ptr %i.ea, align 8, !tbaa !82
...
bb.bq:                                            ; preds = %bb.bp, %bb.bo
  ...
  %i.eu = load i32, ptr %i.et, align 4, !tbaa !157
...
bb.bt:                                            ; preds = %bb.bs
  ...
  %i.ex = load i32, ptr %i.ew, align 4, !tbaa !89
...
.thread:                                          ; preds = %bb.p, %bb.o, %.thread237, %.loopexit250
  ...
  br i1 %.not, label %.thread245, label %bb.b, !llvm.loop !152
...
bb.a:
  ...
  br i1 %.not, label %.critedge.a, label %bb.b
...
.critedge.a:                                      ; preds = %bb.a
  store i64 4294967296, ptr %3, align 8
  call void @llvm.lifetime.start.p0(ptr nonnull %4)
  br label %bb.d

bb.d:                                             ; preds = %bb.b, %.critedge.a, %bb.c
  %6 = phi i64 [ %i.e, %bb.c ], [ 1, %.critedge.a ], [ %i.e, %bb.b ]
  %7 = phi i64 [ %i.b, %bb.c ], [ 0, %.critedge.a ], [ %i.b, %bb.b ]
  %storemerge16 = phi i64 [ %i.g, %bb.c ], [ 4294967296, %.critedge.a ], [ 4294967296, %bb.b ]
  store i64 %storemerge16, ptr %4, align 8
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #12
  %.not17 = icmp eq ptr %2, null
  %8 = getelementptr inbounds nuw i8, ptr %2, i64 124
  %storemerge18.in = select i1 %.not17, ptr %4, ptr %8
  ...
  %i.l = load i32, ptr %3, align 8, !tbaa !96
...
bb.f:                                             ; preds = %bb.d, %bb.e
  ...
  %i.s = call i32 @av_reduce(ptr noundef nonnull %5, ptr noundef nonnull %i.p, i64 noundef %i.q, i64 noundef %i.r, i64 noundef 2147483647) #12 ; 0 uses
  %i.t = load i32, ptr %5, align 8, !tbaa !96
  ...
  %i.x = load i32, ptr %3, align 8, !tbaa !96
...
bb.a:
  ...
  %.sroa.037.0.copyload = load i32, ptr %i.a, align 4, !tbaa !64 ; 5 uses
  %.sroa.9.0..sroa_idx = getelementptr inbounds nuw i8, ptr %1, i64 208
  %.sroa.9.0.copyload = load i32, ptr %.sroa.9.0..sroa_idx, align 4, !tbaa !64 ; 5 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %.sroa.6.0.copyload = load i32, ptr %.sroa.6.0..sroa_idx, align 4, !tbaa !64 ; 3 uses
  %.sroa.012.0.copyload = load i32, ptr %i.y, align 4, !tbaa !64 ; 3 uses
...
bb.b:                                             ; preds = %bb.a
  %i.e = load i32, ptr %4, align 8, !tbaa !96     ; 2 uses
...
bb.e:                                             ; preds = %bb.b, %bb.c, %bb.d
  %i.k = load i32, ptr %4, align 8, !tbaa !96     ; 2 uses
...
bb.i:                                             ; preds = %bb.h, %bb.g
  ...
  store i32 %1, ptr %i.v, align 4, !tbaa !65
  br label %bb.j
