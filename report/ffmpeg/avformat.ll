...
bb.d:                                             ; preds = %bb.b, %.critedge, %bb.c
  ...
  %sext23 = shl nuw i64 %i.h, 32
  %i.m = ashr exact i64 %sext23, 32
  %i.n = call i32 @av_reduce(ptr noundef nonnull %3, ptr noundef nonnull %i.k, i64 noundef %i.l, i64 noundef %i.m, i64 noundef 2147483647) #12 ; 0 uses
  %i.o = load i32, ptr %3, align 8, !tbaa !149
