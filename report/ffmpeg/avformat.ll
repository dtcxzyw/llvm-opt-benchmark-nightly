...
bb.f:                                             ; preds = %bb.d, %bb.e
  ...
  %i.t = load i32, ptr %5, align 8, !tbaa !149
  ...
  %.sroa.0.0.a = select i1 %.not19, i64 %.val, i64 %.val20
...
bb.a:
  ...
  br i1 %or.cond8, label %bb.b, label %bb.e
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.s = fcmp nsz ogt double %i.r, 2.100000e+02
...
bb.e:                                             ; preds = %bb.d, %bb.c, %bb.b, %bb.a
  %.sroa.037.0 = phi i32 [ %i.e, %bb.d ], [ %.sroa.037.0.copyload, %bb.c ], [ %.sroa.037.0.copyload, %bb.b ], [ %.sroa.037.0.copyload, %bb.a ] ; 8 uses
  %.sroa.9.0 = phi i32 [ %i.g, %bb.d ], [ %.sroa.9.0.copyload, %bb.c ], [ %.sroa.9.0.copyload, %bb.b ], [ %.sroa.9.0.copyload, %bb.a ] ; 7 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %.not67, label %bb.l, label %bb.g
...
bb.g:                                             ; preds = %bb.f
  ...
  br i1 %or.cond11, label %bb.h, label %bb.l
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.aq = sitofp nsz i32 %.sroa.0.0.extract.trunc.i71 to double
...
bb.l:                                             ; preds = %bb.g, %bb.i, %bb.j, %bb.k, %bb.f, %bb.e
  %.sroa.037.2 = phi i32 [ %.sroa.037.0, %bb.e ], [ %.sroa.037.0, %bb.f ], [ %.sroa.012.0.copyload, %bb.k ], [ %.sroa.037.0, %bb.j ], [ %.sroa.037.0, %bb.i ], [ %.sroa.037.0, %bb.g ]
  %.sroa.9.2 = phi i32 [ %.sroa.9.0, %bb.e ], [ %.sroa.9.0, %bb.f ], [ %.sroa.6.0.copyload, %bb.k ], [ %.sroa.9.0, %bb.j ], [ %.sroa.9.0, %bb.i ], [ %.sroa.9.0, %bb.g ]
