...
5:                                                ; preds = %bb.b, %.critedge, %bb.c
  ...
  %.sroa.0.0 = phi i64 [ %i.g, %bb.c ], [ 4294967296, %.critedge ], [ 4294967296, %bb.b ]
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #12
  %.not23 = icmp eq ptr %2, null
  br i1 %.not23, label %bb.d, label %.critedge.a
...
bb.d:                                             ; preds = %5, %.critedge.a
  %storemerge24 = phi i64 [ %9, %.critedge.a ], [ %.sroa.0.0, %5 ] ; 3 uses
  store i64 %storemerge24, ptr %4, align 8
