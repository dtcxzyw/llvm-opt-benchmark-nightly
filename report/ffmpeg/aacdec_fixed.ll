...
.preheader:                                       ; preds = %bb.b
  ...
  %4 = shl nuw nsw i32 4096, %i.m
  %5 = zext nneg i32 %4 to i64                    ; 2 uses
  %scevgep = getelementptr i8, ptr %i.i, i64 %5
  %scevgep44 = getelementptr i8, ptr %i.g, i64 %5
...
vector.memcheck48:                                ; preds = %bb.b
  ...
  %wide.trip.count40 = zext nneg i32 %i.n to i64  ; 2 uses
  %6 = shl nuw nsw i32 4096, %i.m
  %7 = zext nneg i32 %6 to i64                    ; 2 uses
  %scevgep49 = getelementptr i8, ptr %i.i, i64 %7
  %scevgep50 = getelementptr i8, ptr %i.g, i64 %7
