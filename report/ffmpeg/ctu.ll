...
bb.gi:                                            ; preds = %bb.gh
  ...
  %.val44.i.i.i = load ptr, ptr %i.hm, align 16, !tbaa !90 ; 10 uses
...
bb.go:                                            ; preds = %bb.gm, %bb.gl, %bb.gj, %bb.gi
  ...
  %21 = load <2 x i32>, ptr %i.arm, align 4, !tbaa !109
  %22 = sdiv <2 x i32> %21, splat (i32 2)         ; 2 uses
  %23 = extractelement <2 x i32> %22, i64 0
  %24 = add nsw i32 %23, %i.aqc
  %25 = ashr i32 %24, %i.aqf
  %26 = extractelement <2 x i32> %22, i64 1
  %i.arn = add nsw i32 %26, %i.aqi
  %i.aro = ashr i32 %i.arn, %i.aqf
  %i.arp = mul nsw i32 %i.aro, %i.aqm
  %i.arq = add nsw i32 %i.arp, %25
