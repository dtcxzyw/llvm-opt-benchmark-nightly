...
bb.e:                                             ; preds = %bb.a, %bb.d
  ...
  store ptr %.0, ptr %i.l, align 8, !tbaa !40
...
bb.a:
  ...
  %i.g = load ptr, ptr %i.f, align 8, !tbaa !19   ; 19 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  store <2 x double> %i.bw, ptr %i.aw, align 8, !tbaa !46
  %i.ca = getelementptr inbounds nuw i8, ptr %i.g, i64 32
  store double %i.bx, ptr %i.ca, align 8, !tbaa !47
  %i.cb = getelementptr inbounds nuw i8, ptr %i.g, i64 40
  store double %i.by, ptr %i.cb, align 8, !tbaa !48
  %i.cc = getelementptr inbounds nuw i8, ptr %i.g, i64 48
  store double %i.bz, ptr %i.cc, align 8, !tbaa !49
  %i.cd = getelementptr inbounds nuw i8, ptr %i.g, i64 112
  store i32 0, ptr %i.cd, align 8, !tbaa !50
  br label %bb.h
...
switch.lookup:                                    ; preds = %.thread
  ...
  %switch.load245 = load double, ptr %switch.gep244, align 8
  br label %.thread176

.thread176:                                       ; preds = %switch.lookup, %bb.c
  %.0155184 = phi double [ f0x40CA0AAAAAAAAAAB, %bb.c ], [ %switch.load, %switch.lookup ] ; 5 uses
  %.0156183 = phi double [ f0x40A8914EE4A1019C, %bb.c ], [ %switch.load243, %switch.lookup ] ; 4 uses
  %.0157182 = phi double [ f0x4073A7725080CE16, %bb.c ], [ %switch.load245, %switch.lookup ] ; 3 uses
  ...
  store i32 1, ptr %i.cj, align 8, !tbaa !50
  %i.ck = getelementptr inbounds nuw i8, ptr %i.g, i64 8
  %i.cl = load i32, ptr %i.ck, align 8, !tbaa !59
...
bb.f:                                             ; preds = %.thread176
  ...
  %1 = insertelement <2 x double> poison, double %.0157182, i64 0
  %2 = shufflevector <2 x double> %1, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ec = fmul nsz <2 x double> %2, <double 1.000000e+00, double 2.000000e+00> ; 2 uses
  ...
  %3 = insertelement <2 x double> poison, double %.0155184, i64 0
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !19   ; 14 uses
  %i.c = getelementptr inbounds nuw i8, ptr %i.b, i64 24
  %i.d = load double, ptr %i.c, align 8, !tbaa !65 ; 2 uses
  %i.e = getelementptr inbounds nuw i8, ptr %i.b, i64 16
  %i.f = load double, ptr %i.e, align 8, !tbaa !66 ; 2 uses
  %i.g = load ptr, ptr %1, align 8, !tbaa !39     ; 3 uses
...
.lr.ph:                                           ; preds = %bb.a
  ...
  %i.ac = load ptr, ptr %i.ab, align 8, !tbaa !68 ; 2 uses
  ...
  %i.ah = load i32, ptr %i.ag, align 8, !tbaa !50
  ...
  %i.as = load i32, ptr %i.ar, align 8, !tbaa !37 ; 2 uses
...
.lr.ph.preheader.i54.us.us:                       ; preds = %.lr.ph.split.us, %biquad_process.exit62.loopexit.us.us
  ...
  %i.ay = load ptr, ptr %i.ax, align 8, !tbaa !69 ; 3 uses
  %i.az = getelementptr inbounds [8 x i8], ptr %i.ae, i64 %indvars.iv83
  %i.ba = load ptr, ptr %i.az, align 8, !tbaa !69
  %i.bb = load double, ptr %i.af, align 8, !tbaa !47
  %i.bc = load double, ptr %i.an, align 8, !tbaa !48
  %i.bd = load double, ptr %i.ao, align 8, !tbaa !49
end_hunk_0
