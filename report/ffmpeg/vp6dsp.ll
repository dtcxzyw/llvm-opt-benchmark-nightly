...
bb.a:
  ...
  %i.b = sub i64 0, %2
  %5 = getelementptr inbounds i8, ptr %1, i64 %i.b
  %6 = getelementptr inbounds nuw i8, ptr %3, i64 2
  %7 = getelementptr inbounds nuw i8, ptr %3, i64 4
  %i.c = getelementptr inbounds nuw i8, ptr %3, i64 6
  %8 = load i16, ptr %i.c, align 2, !tbaa !15
  %9 = load i16, ptr %7, align 2, !tbaa !15
  %10 = load i16, ptr %6, align 2, !tbaa !15
  %11 = load i16, ptr %3, align 2, !tbaa !15
  %12 = sext i16 %11 to i32
  %13 = sext i16 %10 to i32
  %14 = sext i16 %9 to i32
  %15 = sext i16 %8 to i32
  %16 = insertelement <4 x i32> poison, i32 %12, i64 0
  %17 = shufflevector <4 x i32> %16, <4 x i32> poison, <4 x i32> zeroinitializer ; 2 uses
  %18 = insertelement <4 x i32> poison, i32 %13, i64 0
  %i.d = shufflevector <4 x i32> %18, <4 x i32> poison, <4 x i32> zeroinitializer ; 2 uses
  %19 = insertelement <4 x i32> poison, i32 %14, i64 0
  %20 = shufflevector <4 x i32> %19, <4 x i32> poison, <4 x i32> zeroinitializer ; 2 uses
  %21 = insertelement <4 x i32> poison, i32 %15, i64 0
  %22 = shufflevector <4 x i32> %21, <4 x i32> poison, <4 x i32> zeroinitializer ; 2 uses
  br label %.preheader52

.preheader52:                                     ; preds = %bb.a, %.preheader52
  %.056 = phi ptr [ %i.a, %bb.a ], [ %i.az, %.preheader52 ] ; 3 uses
  %.04355 = phi i32 [ 0, %bb.a ], [ %i.ba, %.preheader52 ]
  %.04854 = phi ptr [ %5, %bb.a ], [ %i.ay, %.preheader52 ] ; 8 uses
  ...
  %i.s = mul nsw <4 x i32> %17, %i.o
  %i.t = mul nsw <4 x i32> %i.d, %i.p
  %i.u = mul nsw <4 x i32> %20, %i.q
  %i.v = mul nsw <4 x i32> %22, %i.r
  ...
  %i.am = mul nsw <4 x i32> %17, %i.al
  %i.an = shufflevector <4 x i32> %i.q, <4 x i32> %i.ai, <4 x i32> <i32 3, i32 4, i32 5, i32 6>
  %i.ao = mul nsw <4 x i32> %i.d, %i.an
  %i.ap = mul nsw <4 x i32> %20, %i.ai
  %i.aq = mul nsw <4 x i32> %22, %i.aj
