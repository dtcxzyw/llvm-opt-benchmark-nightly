...
append_left_ext.exit283.i:                        ; preds = %conv_up.exit243.i, %conv_up.exit309.i
  ...
  %4 = trunc i64 %indvars.iv.i226 to i32
  %5 = sub i32 %i.ye, %4
  %mulshl.i279.i = shl i32 %i.aiw, %5
  %6 = lshr i64 %i.ads, %indvars.iv.i226
  %i.ajd = trunc nuw nsw i64 %6 to i32
  %reass.sub.i280.i = add nuw i32 %i.ajd, 2
  %7 = sub i32 %reass.sub.i280.i, %i.aiv
  %i.aje = add i32 %7, %mulshl.i279.i             ; 2 uses
