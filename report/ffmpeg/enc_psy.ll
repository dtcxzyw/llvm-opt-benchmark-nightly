...
pvq_band_cost.exit:                               ; preds = %pvq_band_cost.exit.loopexit.unr-lcssa, %.lr.ph.split.i.epil, %bb.h, %._crit_edge.loopexit.i
  ...
  %.neg21 = ashr i32 %i.gn, 31
  %i.gp = lshr i32 %i.gn, 31
  %i.gq = mul i32 %i.gk, 1073741822
  %.neg23 = add i32 %i.gq, 1073741822
  %.neg24 = add i32 %.neg21, %.neg23
  %i.gr = lshr i32 %i.go, %i.gp                   ; 2 uses
  %i.gs = mul i32 %i.gr, %i.gr                    ; 3 uses
  %5 = lshr i32 %i.gs, 15
  %6 = lshr i32 %i.gs, 31
  %7 = lshr i32 %5, %6                            ; 2 uses
  %8 = mul i32 %7, %7
  %.neg27 = ashr i32 %8, 31
  %.neg25 = shl i32 %.neg24, 2
  %i.gt = ashr i32 %i.gs, 30
