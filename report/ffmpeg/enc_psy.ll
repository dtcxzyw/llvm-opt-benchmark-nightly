...
celt_gauge_psy_weight.exit:                       ; preds = %bb.b, %.preheader77.us.preheader.i, %.preheader76.loopexit.i
  ...
  %3 = fdiv nsz float %.us-phi100.i, 2.100000e+01
  %4 = fdiv nsz float %3, f0x49A2BC80
  %5 = tail call i64 @llvm.lrint.i64.f32(float %4)
  %6 = trunc i64 %5 to i32
  %7 = tail call i32 @llvm.smax.i32(i32 %6, i32 0)
  %8 = tail call i32 @llvm.umin.i32(i32 %7, i32 3)
  %i.fr = getelementptr inbounds nuw i8, ptr %1, i64 34064
  store i32 %8, ptr %i.fr, align 16, !tbaa !148
  %9 = getelementptr inbounds nuw i8, ptr %i.m, i64 56
  %10 = load i64, ptr %9, align 8, !tbaa !84
  %11 = sitofp nsz i64 %10 to float
  %12 = getelementptr inbounds nuw i8, ptr %0, i64 13764
  %13 = load float, ptr %12, align 4, !tbaa !85
  %14 = fmul nsz float %13, %11
  %15 = getelementptr inbounds nuw i8, ptr %i.m, i64 344
  %16 = load i32, ptr %15, align 8, !tbaa !61
  %17 = sdiv i32 %16, %i.l
  %18 = sitofp nsz i32 %17 to float
  %19 = fdiv nsz float %14, %18
  %i.fs = tail call i64 @llvm.lrint.i64.f32(float %19)
