...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.i = getelementptr inbounds nuw i8, ptr %1, i64 %i.h
  %i.j = lshr <4 x i32> %wide.load, splat (i32 4)
  %3 = shufflevector <4 x i32> %i.f, <4 x i32> %i.j, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %4 = and <8 x i32> %3, splat (i32 65472)
  %5 = shufflevector <4 x i32> %i.g, <4 x i32> %i.f, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %6 = and <8 x i32> %5, splat (i32 63)
  %7 = or disjoint <8 x i32> %4, %6
  %8 = trunc nuw <8 x i32> %7 to <8 x i16>
  %9 = and <4 x i32> %wide.load, splat (i32 1023) ; 2 uses
  %10 = shl nuw nsw <4 x i32> %9, splat (i32 6)
  %11 = lshr <4 x i32> %9, splat (i32 4)
  %12 = or disjoint <4 x i32> %10, %11
  %13 = trunc nuw <4 x i32> %12 to <4 x i16>
  %i.k = shufflevector <4 x i16> %13, <4 x i16> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.l = shufflevector <8 x i16> %8, <8 x i16> %i.k, <12 x i32> <i32 0, i32 4, i32 8, i32 1, i32 5, i32 9, i32 2, i32 6, i32 10, i32 3, i32 7, i32 11>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %12 = or disjoint <4 x i32> %10, %11
  %13 = trunc nuw <4 x i32> %12 to <4 x i16>
  %14 = tail call <4 x i16> @llvm.bswap.v4i16(<4 x i16> %13)
  %i.k = tail call <8 x i16> @llvm.bswap.v8i16(<8 x i16> %8)
  %i.l = shufflevector <4 x i16> %14, <4 x i16> splat (i16 -1), <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %7 = and <4 x i32> %i.m, splat (i32 65472)
  %8 = lshr <4 x i32> %wide.load, splat (i32 24)
  %9 = and <4 x i32> %8, splat (i32 63)
  %10 = or disjoint <4 x i32> %7, %9
  %11 = trunc nuw <4 x i32> %10 to <4 x i16>
  %i.o = shufflevector <4 x i16> %11, <4 x i16> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.p = shufflevector <8 x i16> %6, <8 x i16> %i.o, <12 x i32> <i32 0, i32 4, i32 8, i32 1, i32 5, i32 9, i32 2, i32 6, i32 10, i32 3, i32 7, i32 11>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %10 = or disjoint <4 x i32> %7, %9
  %11 = trunc nuw <4 x i32> %10 to <4 x i16>
  %12 = tail call <4 x i16> @llvm.bswap.v4i16(<4 x i16> %11)
  %i.o = tail call <8 x i16> @llvm.bswap.v8i16(<8 x i16> %6)
  %i.p = shufflevector <4 x i16> %12, <4 x i16> splat (i16 -1), <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
