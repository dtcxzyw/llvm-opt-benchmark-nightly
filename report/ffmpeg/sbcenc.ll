...
bb.m:                                             ; preds = %bb.l, %bb.k
  ...
  %1 = insertelement <2 x i64> poison, i64 %i.aw, i64 0
  %2 = shufflevector <2 x i64> %1, <2 x i64> poison, <2 x i32> zeroinitializer
  %3 = sdiv <2 x i64> %2, <i64 4000000, i64 8000000> ; 2 uses
  %4 = extractelement <2 x i64> %3, i64 0
  %5 = extractelement <2 x i64> %3, i64 1
  %6 = select i1 %brmerge.sink, i64 %4, i64 %5
  %i.ax = trunc i64 %6 to i32
