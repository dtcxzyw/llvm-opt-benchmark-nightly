...
bb.az:                                            ; preds = %.sink.split.i, %bb.ax, %bb.av
  ...
  %.lhs.trunc.i = shl nuw nsw i16 %.tr.i, 5
  %i.fl = udiv i16 %.lhs.trunc.i, 25
...
bb.p:                                             ; preds = %bb.o
  ...
  %i.ep = mul nsw i32 %i.dc, 9
  %i.eq = sdiv i32 %i.ep, 10                      ; 2 uses
  %i.er = mul nsw i32 %i.dc, 11
  %i.es = sdiv i32 %i.er, 10
