...
bb.ac:                                            ; preds = %apply_grain_row_8.exit.i, %.lr.ph106.i
  ...
  %i.vm = load ptr, ptr %1, align 8, !tbaa !30    ; 3 uses
  %i.vn = load i32, ptr %i.ak, align 8, !tbaa !31
  %i.vo = mul i32 %i.vn, %i.ve
  %i.vp = sext i32 %i.vo to i64                   ; 3 uses
...
bb.ad:                                            ; preds = %bb.ac
  ...
  %i.vt = load ptr, ptr %0, align 8, !tbaa !30    ; 3 uses
...
.lr.ph311.i.i:                                    ; preds = %.preheader232.i.i
  ...
  %scevgep = getelementptr i8, ptr %i.vt, i64 %i.wn
  %invariant.gep = getelementptr i8, ptr %i.vt, i64 %i.wn
  %scevgep224 = getelementptr i8, ptr %i.vm, i64 %i.vp
...
bb.ae:                                            ; preds = %._crit_edge297.i.i, %.lr.ph311.i.i
  ...
  %indvars.iv359.i.i = phi i64 [ %6, %._crit_edge297.i.i ], [ 0, %.lr.ph311.i.i ] ; 4 uses
  %.0204310.i.i = phi i32 [ %5, %._crit_edge297.i.i ], [ 0, %.lr.ph311.i.i ] ; 3 uses
  ...
  %i.xj = sub i32 %i.ux, %.0204310.i.i            ; 4 uses
  ...
  %i.xo = icmp ne i32 %.0204310.i.i, 0
...
.preheader226.lr.ph.i.i:                          ; preds = %.preheader229.i.i
  ...
  %i.aao = zext nneg i32 %i.xq to i64             ; 9 uses
  ...
  %3 = add nuw nsw i64 %indvars.iv359.i.i, %i.aao ; 2 uses
  %scevgep218 = getelementptr i8, ptr %scevgep, i64 %3 ; 2 uses
  ...
  %4 = add i64 %umax220, %i.abc
  %i.abd = add i64 %4, %indvars.iv359.i.i         ; 2 uses
  %scevgep221 = getelementptr i8, ptr %invariant.gep, i64 %i.abd ; 2 uses
  %scevgep223 = getelementptr i8, ptr %scevgep224, i64 %3
  %scevgep224.a = getelementptr i8, ptr %invariant.gep301, i64 %i.abd
...
._crit_edge297.i.i:                               ; preds = %._crit_edge275.i.i, %.preheader229.i.i
  %5 = add i32 %.0204310.i.i, 32                  ; 2 uses
  %6 = zext i32 %5 to i64                         ; 2 uses
  %7 = icmp ugt i64 %i.wq, %6
  %indvar.next = add i32 %indvar, 1
  br i1 %7, label %bb.ae, label %fgy_32x32xn_c_8.exit.i, !llvm.loop !81
...
bb.t:                                             ; preds = %._crit_edge313.i, %.lr.ph327.i
  ...
  %indvars.iv375.i = phi i64 [ %5, %._crit_edge313.i ], [ 0, %.lr.ph327.i ] ; 2 uses
  %.0221326.i = phi i32 [ %4, %._crit_edge313.i ], [ 0, %.lr.ph327.i ] ; 3 uses
  ...
  %i.ke = sub i32 %i.hm, %.0221326.i              ; 4 uses
  %i.kf = tail call i32 @llvm.umin.i32(i32 %i.ke, i32 32) ; 2 uses
  %i.kg = icmp ne i32 %.0221326.i, 0
...
._crit_edge313.i:                                 ; preds = %._crit_edge291.i, %.preheader245.i
  %4 = add i32 %.0221326.i, 32                    ; 2 uses
  %5 = zext i32 %4 to i64                         ; 2 uses
  %6 = icmp ugt i64 %i.jh, %5
  %indvar.next = add i32 %indvar, 1
