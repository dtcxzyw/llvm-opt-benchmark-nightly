...
bb.e:                                             ; preds = %bb.d, %bb.v
  %indvars.iv = phi i64 [ 0, %bb.d ], [ %indvars.iv.next, %bb.v ] ; 9 uses
...
.loopexit:                                        ; preds = %.thread, %.loopexit.loopexit259, %.loopexit.loopexit, %bb.n
  ...
  %i.et = trunc nuw nsw i64 %indvars.iv to i32    ; 5 uses
...
bb.m:                                             ; preds = %bb.l, %bb.k
  ...
  %i.ce = shl nuw nsw i64 %indvars.iv, 3
  %i.cf = and i64 %i.ce, 8
