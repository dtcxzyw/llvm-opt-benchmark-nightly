...
bb.a:
  ...
  %i.i = load i32, ptr %i.h, align 8, !tbaa !13   ; 11 uses
...
.lr.ph225:                                        ; preds = %.loopexit188
  ...
  %invariant.op = add nsw i64 %5, -1              ; 3 uses
  %smax = tail call i64 @llvm.smax.i64(i64 %invariant.op, i64 2)
  %i.ed = add nsw i64 %smax, -1
  %i.ee = lshr i64 %i.ed, 1                       ; 2 uses
  %i.ef = shl nuw nsw i64 %i.ee, 4
  %i.eg = shl nsw i64 %i.dv, 3
  %i.eh = shl nuw nsw i64 %i.ee, 3
  ...
  %6 = tail call i64 @llvm.smax.i64(i64 %invariant.op, i64 2)
  %i.en = add nsw i64 %6, -1
  %i.eo = lshr i64 %i.en, 1
  %i.ep = add nuw nsw i64 %i.eo, 1                ; 2 uses
  %min.iters.check = icmp ult i32 %i.i, 10
  %i.eq = and i64 %i.ep, 3                        ; 2 uses
  %i.er = icmp eq i64 %i.eq, 0
  %i.es = select i1 %i.er, i64 4, i64 %i.eq
  %n.vec = sub nsw i64 %i.ep, %i.es               ; 2 uses
