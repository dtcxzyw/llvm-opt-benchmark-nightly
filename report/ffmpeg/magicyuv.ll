...
.preheader.lr.ph:                                 ; preds = %bb.aj
  ...
  %i.rv = load <3 x i32>, ptr %i.ru, align 8, !tbaa !34 ; 3 uses
  ...
  %4 = extractelement <3 x i32> %i.rv, i64 1      ; 2 uses
  %5 = sdiv i32 %4, 2
  %6 = sext i32 %5 to i64                         ; 2 uses
  %7 = extractelement <3 x i32> %i.rv, i64 2      ; 2 uses
  %8 = sdiv i32 %7, 2
...
._crit_edge526:                                   ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  ...
  %i.wa = getelementptr inbounds [2 x i8], ptr %.0284529, i64 %6
