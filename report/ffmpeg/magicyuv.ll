...
begin_hunk_0_@magy_decode_slice10:bb.a
  ...
  %i.tp = add nsw i64 %wide.trip.count562, -1
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %._crit_edge526
  %.0530 = phi ptr [ %i.we, %._crit_edge526 ], [ %i.sx, %.preheader.preheader ] ; 5 uses
  %.0284529 = phi ptr [ %i.wf, %._crit_edge526 ], [ %i.sr, %.preheader.preheader ] ; 5 uses
  %.0285528 = phi ptr [ %i.wg, %._crit_edge526 ], [ %i.sl, %.preheader.preheader ] ; 5 uses
  %.1299527 = phi i32 [ %i.wh, %._crit_edge526 ], [ 0, %.preheader.preheader ]
...
vector.body:                                      ; preds = %.preheader, %vector.body
  ...
  %i.tq = getelementptr inbounds nuw [2 x i8], ptr %.0530, i64 %index ; 2 uses
  %wide.load = load <8 x i16>, ptr %i.tq, align 2, !tbaa !63, !alias.scope !123, !noalias !124
  %i.tr = zext <8 x i16> %wide.load to <8 x i32>
  %i.ts = getelementptr inbounds nuw [2 x i8], ptr %.0284529, i64 %index ; 2 uses
  %wide.load627 = load <8 x i16>, ptr %i.ts, align 2, !tbaa !63, !alias.scope !125
  %i.tt = zext <8 x i16> %wide.load627 to <8 x i32>
  %i.tu = add nuw nsw <8 x i32> %i.tt, %i.tr
  %i.tv = and <8 x i32> %i.tu, %broadcast.splat
  %i.tw = trunc <8 x i32> %i.tv to <8 x i16>
  store <8 x i16> %i.tw, ptr %i.tq, align 2, !tbaa !63, !alias.scope !123, !noalias !124
  %i.tx = getelementptr inbounds nuw [2 x i8], ptr %.0285528, i64 %index ; 2 uses
  %wide.load628 = load <8 x i16>, ptr %i.tx, align 2, !tbaa !63, !alias.scope !126, !noalias !125
  %i.ty = zext <8 x i16> %wide.load628 to <8 x i32>
