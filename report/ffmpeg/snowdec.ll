...
.lr.ph650:                                        ; preds = %.preheader622
  ...
  %smax1037 = zext nneg i32 %i.abh to i64
  %i.abi = add nsw i64 %smax1037, -1              ; 3 uses
  %i.abj = mul nsw i64 %i.abi, %i.aav             ; 5 uses
  %scevgep1038 = getelementptr i8, ptr %i.zq, i64 %i.abj
  %i.abk = add nsw i64 %.1234.i.idx, %i.aax       ; 2 uses
  %5 = getelementptr i8, ptr %i.zk, i64 %i.abk
  %scevgep1042 = getelementptr i8, ptr %5, i64 %i.aaz
  %i.abl = mul nsw i64 %i.abi, %i.abc             ; 4 uses
  %i.abm = getelementptr i8, ptr %i.zk, i64 %i.abk
  %i.abn = getelementptr i8, ptr %i.abm, i64 %i.abl
  %scevgep1045 = getelementptr i8, ptr %i.abn, i64 %i.aaz
  %i.abo = getelementptr i8, ptr %i.zk, i64 %.1234.i.idx
  %scevgep1047 = getelementptr i8, ptr %i.abo, i64 %i.aaz
  %6 = getelementptr i8, ptr %i.zk, i64 %.1234.i.idx
  %i.abp = getelementptr i8, ptr %6, i64 %i.abl
  %scevgep1049 = getelementptr i8, ptr %i.abp, i64 %i.aaz
...
bb.dr:                                            ; preds = %.lr.ph650, %add_yblock.exit
  ...
  %scevgep1046 = getelementptr i8, ptr %scevgep1045, i64 %i.aeo
  %scevgep1048 = getelementptr i8, ptr %scevgep1047, i64 %i.aen
