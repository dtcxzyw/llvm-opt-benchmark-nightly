...
bb.a:
  ...
  %cos = extractvalue { double, double } %sincos, 1 ; 2 uses
  ...
  %1 = insertelement <2 x double> poison, double %i.ac, i64 0
  %2 = shufflevector <2 x double> %1, <2 x double> poison, <2 x i32> zeroinitializer
  %3 = fmul nsz <2 x double> %2, <double 1.000000e+00, double 2.000000e+00>
  %i.ai = insertelement <2 x double> %i.af, double %i.ac, i64 1
  %i.aj = fadd nsz <2 x double> %i.ai, splat (double -1.000000e+00) ; 4 uses
  %i.ak = insertelement <2 x double> poison, double %i.ah, i64 0
  %i.al = insertelement <2 x double> %i.ak, double %cos, i64 1
  %4 = fadd nsz double %i.ac, 1.000000e+00        ; 4 uses
  %i.am = insertelement <2 x double> <double 2.000000e+00, double poison>, double %4, i64 1
  %i.an = tail call nsz <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.aj, <2 x double> %i.al, <2 x double> %i.am) ; 3 uses
  ...
  %i.ar = fmul nsz double %i.aq, 2.000000e+00     ; 2 uses
  %i.as = extractelement <2 x double> %i.ap, i64 0
  %i.at = fmul nsz double %i.v, %i.as             ; 2 uses
  %i.au = insertelement <2 x double> poison, double %i.ar, i64 0 ; 2 uses
  %i.av = insertelement <2 x double> %i.au, double %4, i64 1
  %i.aw = insertelement <2 x double> poison, double %i.at, i64 0
  %5 = insertelement <2 x double> %i.aw, double %cos, i64 1 ; 3 uses
  %6 = shufflevector <2 x double> %i.an, <2 x double> %i.aj, <2 x i32> <i32 1, i32 3>
  %i.ax = tail call nsz <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.av, <2 x double> %5, <2 x double> %6) ; 3 uses
  %i.ay = extractelement <2 x double> %i.ax, i64 0 ; 2 uses
  store double %i.ay, ptr %i.y, align 8, !tbaa !52
  %i.az = insertelement <2 x double> %i.aj, double %i.ar, i64 0
  %7 = fneg nsz <2 x double> %i.az                ; 2 uses
  %8 = shufflevector <2 x double> %i.an, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %9 = insertelement <2 x double> %8, double %4, i64 1
  %10 = tail call nsz <2 x double> @llvm.fmuladd.v2f64(<2 x double> %7, <2 x double> %5, <2 x double> %9) ; 3 uses
  %11 = shufflevector <2 x double> %i.ax, <2 x double> %10, <2 x i32> <i32 1, i32 2>
  %i.ba = fmul nsz <2 x double> %11, <double -2.000000e+00, double 1.000000e+00>
  %i.bb = fneg nsz double %4
  %i.bc = insertelement <2 x double> %i.au, double %i.bb, i64 1
  %12 = shufflevector <2 x double> %10, <2 x double> %i.aj, <2 x i32> <i32 1, i32 3>
  %13 = tail call nsz <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bc, <2 x double> %5, <2 x double> %12)
  %14 = fmul nsz <2 x double> %3, %13
  %15 = extractelement <2 x double> %10, i64 1
  %16 = extractelement <2 x double> %7, i64 0
  %i.bd = tail call nsz double @llvm.fmuladd.f64(double %16, double %i.at, double %15)
  %i.be = fmul nsz double %i.ac, %i.bd
  %i.bf = shufflevector <2 x double> %i.ax, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.bg = fdiv nsz <2 x double> %i.ba, %i.bf
  store <2 x double> %i.bg, ptr %i.z, align 8, !tbaa !41
  %i.bh = fdiv nsz <2 x double> %14, %i.bf
