...
ff_clz_c.exit.us.us:                              ; preds = %scalar.ph75, %middle.block83
  ...
  %i.az = tail call range(i32 1, 33) i32 @llvm.ctlz.i32(i32 %5, i1 false)
...
.preheader166.loopexit:                           ; preds = %scalar.ph, %middle.block
  ...
  %i.ct = tail call range(i32 1, 33) i32 @llvm.ctlz.i32(i32 %5, i1 false)
  %i.cu = sub nuw nsw i32 17, %i.ct
  %6 = lshr i32 %.1.lcssa, 1
  %i.cv = tail call range(i32 1, 33) i32 @llvm.ctlz.i32(i32 %6, i1 false)
...
ff_clz_c.exit152:                                 ; preds = %bb.d, %middle.block291
  ...
  %i.gw = tail call range(i32 1, 33) i32 @llvm.ctlz.i32(i32 %11, i1 false)
...
.preheader.loopexit:                              ; preds = %.lr.ph200, %middle.block271
  ...
  %12 = lshr i32 %i.id, 1
  %i.ie = tail call range(i32 1, 33) i32 @llvm.ctlz.i32(i32 %12, i1 false)
  %13 = extractelement <2 x i32> %i.ic, i64 1
  %14 = lshr i32 %13, 1
  %i.if = tail call range(i32 1, 33) i32 @llvm.ctlz.i32(i32 %14, i1 false)
