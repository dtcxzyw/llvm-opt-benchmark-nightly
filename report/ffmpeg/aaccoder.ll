...
bb.aq:                                            ; preds = %bb.ap
  ...
  %i.nk = uitofp nsz nneg i32 %.22091 to float
...
vector.body.preheader:                            ; preds = %._crit_edge, %._crit_edge2079.thread2659
  ...
  %i.xy = uitofp nsz nneg i32 %i.xx to float
...
.lr.ph2255:                                       ; preds = %.critedge
  ...
  %i.avo = uitofp nsz nneg i32 %.01423 to float
...
bb.l:                                             ; preds = %bb.k, %bb.j
  ...
  %i.dv = uitofp nsz nneg i32 %spec.select.i.3 to float
...
bb.h:                                             ; preds = %bb.g, %bb.f
  ...
  %i.bz = uitofp nsz nneg i32 %spec.select.i.1 to float
...
bb.g:                                             ; preds = %bb.e
  ...
  %i.ay = tail call i32 @llvm.umin.i32(i32 %i.ax, i32 8191) ; 3 uses
  %i.az = uitofp nsz nneg i32 %i.ay to float      ; 2 uses
  %i.ba = tail call nsz float @cbrtf(float noundef %i.az) #14
  %i.bb = fmul nsz float %i.ba, %i.az
  %i.bc = fmul nsz float %i.j, %i.bb
  %.not11.i = icmp samesign ult i32 %i.ax, 256    ; 2 uses
...
bb.o:                                             ; preds = %bb.m
  ...
  %i.cn = tail call i32 @llvm.umin.i32(i32 %i.cm, i32 8191) ; 3 uses
  %i.co = uitofp nsz nneg i32 %i.cn to float      ; 2 uses
  %i.cp = tail call nsz float @cbrtf(float noundef %i.co) #14
  %i.cq = fmul nsz float %i.cp, %i.co
  %i.cr = fmul nsz float %i.j, %i.cq
  %.not11.i.1 = icmp samesign ult i32 %i.cm, 256  ; 2 uses
...
bb.ak:                                            ; preds = %.preheader.preheader
  ...
  %i.gz = tail call i32 @llvm.umax.i32(i32 %i.gy, i32 16)
  %i.ha = tail call i32 @llvm.umin.i32(i32 %i.gz, i32 8191) ; 3 uses
  %.not11.i17 = icmp samesign ult i32 %i.gy, 256  ; 2 uses
...
bb.av:                                            ; preds = %.preheader.1
  ...
  %i.jj = tail call i32 @llvm.umax.i32(i32 %i.ji, i32 16)
  %i.jk = tail call i32 @llvm.umin.i32(i32 %i.jj, i32 8191) ; 3 uses
  %.not11.i17.1 = icmp samesign ult i32 %i.ji, 256 ; 2 uses
