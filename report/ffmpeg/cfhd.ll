...
.preheader2261.preheader:                         ; preds = %bb.hp
  ...
  %i.aip = shl nsw i32 %i.agl, 1
  %4 = sext i32 %i.aip to i64
...
._crit_edge2442:                                  ; preds = %vec.epilog.scalar.ph3215, %vec.epilog.middle.block3224, %middle.block3211
  %i.aja = getelementptr inbounds [2 x i8], ptr %.017852443, i64 %4
...
.preheader2260.preheader:                         ; preds = %bb.hr
  ...
  %i.akq = shl nsw i32 %i.ajj, 1
  %5 = sext i32 %i.akq to i64
...
._crit_edge2447:                                  ; preds = %vec.epilog.scalar.ph3189, %vec.epilog.middle.block3198, %middle.block3185
  %i.aln = getelementptr inbounds [2 x i8], ptr %.117862448, i64 %5
...
.lr.ph2462:                                       ; preds = %bb.if
  ...
  %7 = insertelement <4 x i32> poison, i32 %i.apv, i64 0
  %8 = shufflevector <4 x i32> %7, <4 x i32> poison, <4 x i32> zeroinitializer
  %9 = insertelement <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>, i32 %i.apy, i64 1
  %10 = shufflevector <4 x i32> %9, <4 x i32> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 1>
  ...
  %bound03134 = icmp ult ptr %i.apt, %scevgep3122
  %bound13135 = icmp ult ptr %i.apq, %scevgep3118
  %found.conflict3136 = and i1 %bound03134, %bound13135
  %bound03140 = icmp ult ptr %scevgep3119, %scevgep3121
  %bound13141 = icmp ult ptr %i.apr, %scevgep3120
  %found.conflict3142 = and i1 %bound03140, %bound13141
  %11 = or <4 x i32> %8, %10
  %12 = icmp slt <4 x i32> %11, zeroinitializer
  %bound03146 = icmp ult ptr %scevgep3119, %scevgep3122
  %bound13147 = icmp ult ptr %i.apq, %scevgep3120
  %found.conflict3148 = and i1 %bound03146, %bound13147
  %13 = or i32 %i.apy, %i.apv
  %14 = icmp slt i32 %13, 0
  %15 = bitcast <4 x i1> %12 to i4
  %16 = icmp ne i4 %15, 0
  %op.rdx3279 = or i1 %16, %14
  %op.rdx3280 = or i1 %found.conflict3125, %found.conflict3130
  %op.rdx3281 = or i1 %found.conflict3136, %found.conflict3142
  %op.rdx3282 = or i1 %op.rdx3279, %op.rdx3280
  %op.rdx3283 = or i1 %op.rdx3281, %found.conflict3148
  %op.rdx3284 = or i1 %op.rdx3282, %op.rdx3283
...
interlaced_vertical_filter.exit:                  ; preds = %scalar.ph3152, %middle.block3161
  %i.arw = getelementptr inbounds [2 x i8], ptr %.117902457, i64 %6
  %i.arx = getelementptr inbounds [2 x i8], ptr %.117882458, i64 %6
...
.preheader2268.preheader:                         ; preds = %bb.is
  ...
  %i.ava = shl nsw i32 %i.asx, 1
  %17 = sext i32 %i.ava to i64
...
._crit_edge2408:                                  ; preds = %vec.epilog.scalar.ph3105, %vec.epilog.middle.block3114, %middle.block3101
  %i.avl = getelementptr inbounds [2 x i8], ptr %.017652409, i64 %17
...
.preheader2267.preheader:                         ; preds = %bb.iu
  ...
  %i.axb = shl nsw i32 %i.avu, 1
  %18 = sext i32 %i.axb to i64
...
._crit_edge2413:                                  ; preds = %vec.epilog.scalar.ph3079, %vec.epilog.middle.block3088, %middle.block3075
  %i.ayp = getelementptr inbounds [2 x i8], ptr %.117662414, i64 %18
...
bb.jp:                                            ; preds = %bb.jo, %bb.jn
  %i.bhy = phi i32 [ %i.bhq, %bb.jn ], [ %i.bhw, %bb.jo ] ; 5 uses
...
.lr.ph2478:                                       ; preds = %bb.jz
  ...
  %i.bkh = shl i32 %i.bid, 1                      ; 3 uses
  %19 = sext i32 %i.bkh to i64                    ; 3 uses
  ...
  %20 = insertelement <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>, i32 %i.bkh, i64 1
  %21 = shufflevector <4 x i32> %20, <4 x i32> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 1>
  %22 = insertelement <4 x i32> poison, i32 %i.bhy, i64 0
  ...
  %bound03244 = icmp ult ptr %i.bke, %scevgep3232
  %bound13245 = icmp ult ptr %i.bka, %scevgep3228.a
  %found.conflict3246 = and i1 %bound03244, %bound13245
  %bound03250 = icmp ult ptr %scevgep3229, %scevgep3231
  %bound13251 = icmp ult ptr %i.bkc, %scevgep3230
  %found.conflict3252 = and i1 %bound03250, %bound13251
  %24 = or <4 x i32> %21, %23
  %25 = icmp slt <4 x i32> %24, zeroinitializer
  %bound03256 = icmp ult ptr %scevgep3229, %scevgep3232
  %bound13257 = icmp ult ptr %i.bka, %scevgep3230
  %found.conflict3258 = and i1 %bound03256, %bound13257
  %26 = or i32 %i.bkh, %i.bhy
  %27 = icmp slt i32 %26, 0
  %28 = bitcast <4 x i1> %25 to i4
  %29 = icmp ne i4 %28, 0
  %op.rdx = or i1 %29, %27
  %op.rdx3274 = or i1 %found.conflict3235, %found.conflict3240
  %op.rdx3275 = or i1 %found.conflict3246, %found.conflict3252
  %op.rdx3276 = or i1 %op.rdx, %op.rdx3274
  %op.rdx3277 = or i1 %op.rdx3275, %found.conflict3258
  %op.rdx3278 = or i1 %op.rdx3276, %op.rdx3277
...
interlaced_vertical_filter.exit2085:              ; preds = %scalar.ph3262, %middle.block3271
  %i.bmf = getelementptr inbounds [2 x i8], ptr %.117522473, i64 %19
  %i.bmg = getelementptr inbounds [2 x i8], ptr %.117502474, i64 %19
