...
bb.az:                                            ; preds = %bb.ax
  ...
  %i.er = call i32 @llvm.bswap.i32(i32 %i.eq)     ; 6 uses
...
bb.be:                                            ; preds = %bb.bd
  ...
  %i.fg = shl nsw i32 %i.ff, 3                    ; 2 uses
  %or.cond.i.i = icmp samesign ult i32 %i.fg, 2147483135 ; 2 uses
...
.preheader176.lr.ph.i:                            ; preds = %bb.dx
  ...
  %3 = shl nuw nsw i64 %indvars.iv365.i, 2
...
.preheader176.i:                                  ; preds = %._crit_edge260.i, %.preheader176.lr.ph.i
  ...
  %i.aza = add nuw nsw i64 %i.ayz, %2             ; 5 uses
...
bb.dy:                                            ; preds = %propagate_block_data.exit.i, %.preheader176.i
  ...
  %i.azd = add nuw nsw i64 %i.azc, %4             ; 9 uses
...
bb.i:                                             ; preds = %bb.g
  ...
  %i.ag = mul nsw i32 %i.af, 6
  %i.ah = add nsw i32 %i.ag, %i.p
  %i.ai = trunc nsw i32 %i.ah to i16
...
bb.i:                                             ; preds = %bb.g
  ...
  %i.ap = mul nsw i32 %i.ao, 6
  %i.aq = add nsw i32 %i.ap, %i.u
