...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  store i16 %i.ex, ptr %i.ey, align 2, !tbaa !30
  %indvars.iv.next.i.1 = add nuw nsw i64 %indvars.iv.i, 2 ; 2 uses
  %exitcond.not.i.1 = icmp eq i64 %indvars.iv.next.i.1, %wide.trip.count.i
  br i1 %exitcond.not.i.1, label %iter.check98, label %.lr.ph.i, !llvm.loop !36

iter.check98:                                     ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i, %vec.epilog.middle.block, %middle.block
  %i.ez = load ptr, ptr %.val35.val, align 8, !tbaa !51 ; 6 uses
  %i.fa = getelementptr inbounds nuw i8, ptr %.val35.val36, i64 8
  %i.fb = load ptr, ptr %i.fa, align 8, !tbaa !51 ; 6 uses
  %i.fc = getelementptr inbounds nuw i8, ptr %i.l, i64 8
  %i.fd = load ptr, ptr %i.fc, align 8, !tbaa !51 ; 6 uses
...
vector.body88:                                    ; preds = %vector.body88, %vector.ph86
  ...
  %wide.load90 = load <8 x i16>, ptr %i.fk, align 2, !tbaa !30
  %wide.load91 = load <8 x i16>, ptr %i.fl, align 2, !tbaa !30
  %i.fm = getelementptr inbounds nuw [2 x i8], ptr %i.fb, i64 %index89 ; 2 uses
  %i.fn = getelementptr inbounds nuw i8, ptr %i.fm, i64 16
  %wide.load92 = load <8 x i16>, ptr %i.fm, align 2, !tbaa !30
  %wide.load93 = load <8 x i16>, ptr %i.fn, align 2, !tbaa !30
  ...
  store <8 x i16> %i.fo, ptr %i.fq, align 2, !tbaa !30
  store <8 x i16> %i.fp, ptr %i.fr, align 2, !tbaa !30
  %index.next94 = add nuw i64 %index89, 16        ; 2 uses
  %i.fs = icmp eq i64 %index.next94, %n.vec87
  br i1 %i.fs, label %middle.block95, label %vector.body88, !llvm.loop !37
...
vec.epilog.iter.check100:                         ; preds = %middle.block95
  ...
  br i1 %min.epilog.iters.check101, label %.lr.ph.i49.preheader, label %vec.epilog.ph102, !prof !52
...
vec.epilog.vector.body104:                        ; preds = %vec.epilog.vector.body104, %vec.epilog.ph102
  ...
  %wide.load106 = load <4 x i16>, ptr %i.ft, align 2, !tbaa !30
  %i.fu = getelementptr inbounds nuw [2 x i8], ptr %i.fb, i64 %index105
  %wide.load107 = load <4 x i16>, ptr %i.fu, align 2, !tbaa !30
  ...
  store <4 x i16> %i.fv, ptr %i.fw, align 2, !tbaa !30
  %index.next108 = add nuw i64 %index105, 4       ; 2 uses
  %i.fx = icmp eq i64 %index.next108, %n.vec103
  br i1 %i.fx, label %vec.epilog.middle.block109, label %vec.epilog.vector.body104, !llvm.loop !38
...
.lr.ph.i49.prol:                                  ; preds = %.lr.ph.i49.preheader
  ...
  %i.gb = load i16, ptr %i.ga, align 2, !tbaa !30
  ...
  store i16 %i.gc, ptr %i.gd, align 2, !tbaa !30
...
.lr.ph.i49:                                       ; preds = %.lr.ph.i49.prol.loopexit, %.lr.ph.i49
  ...
  %i.gn = load i16, ptr %i.gm, align 2, !tbaa !30
  ...
  store i16 %i.gq, ptr %i.gr, align 2, !tbaa !30
  ...
  br i1 %exitcond.not.i52.1, label %mix.exit53, label %.lr.ph.i49, !llvm.loop !39
...
bb.a:
  ...
  store <8 x i16> <i16 4, i16 4, i16 -1, i16 3, i16 -2, i16 -5, i16 9, i16 6>, ptr %i.d, align 2, !tbaa !30
  store <8 x i16> <i16 -6, i16 -11, i16 -5, i16 3, i16 5, i16 0, i16 1, i16 3>, ptr %i.e, align 2, !tbaa !30
  %i.f = getelementptr inbounds nuw i8, ptr %i.d, i64 16
  %i.g = getelementptr inbounds nuw i8, ptr %i.d, i64 80
  store <8 x i16> <i16 -4, i16 -5, i16 -2, i16 -7, i16 6, i16 30, i16 12, i16 -11>, ptr %i.f, align 2, !tbaa !30
  store <8 x i16> <i16 -1, i16 -3, i16 -5, i16 1, i16 -7, i16 -29, i16 -3, i16 4>, ptr %i.g, align 2, !tbaa !30
  %i.h = getelementptr inbounds nuw i8, ptr %i.d, i64 32
  %i.i = getelementptr inbounds nuw i8, ptr %i.d, i64 96
  store <8 x i16> <i16 -3, i16 -20, i16 2, i16 1, i16 -14, i16 15, i16 6, i16 15>, ptr %i.h, align 2, !tbaa !30
  store <8 x i16> <i16 7, i16 23, i16 0, i16 -6, i16 -5, i16 -18, i16 7, i16 -10>, ptr %i.i, align 2, !tbaa !30
  %i.j = getelementptr inbounds nuw i8, ptr %i.d, i64 48
  %i.k = getelementptr inbounds nuw i8, ptr %i.d, i64 112
  store <8 x i16> <i16 -14, i16 -7, i16 -4, i16 6, i16 6, i16 0, i16 0, i16 4>, ptr %i.j, align 2, !tbaa !30
  store <8 x i16> <i16 22, i16 -2, i16 9, i16 -12, i16 -6, i16 -11, i16 -5, i16 0>, ptr %i.k, align 2, !tbaa !30
  ret i32 0
}
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %i.au = load i16, ptr %2, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.aw = load i16, ptr %i.d, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.ay = load i16, ptr %i.e, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.ba = load i16, ptr %i.f, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.bc = load i16, ptr %i.g, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.be = load i16, ptr %i.h, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.bg = load i16, ptr %i.i, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.bi = load i16, ptr %i.j, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.bk = load i16, ptr %i.k, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.bm = load i16, ptr %i.l, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.bo = load i16, ptr %i.m, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.bq = load i16, ptr %i.n, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.bs = load i16, ptr %i.o, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.bu = load i16, ptr %i.p, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.bw = load i16, ptr %i.q, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.by = load i16, ptr %i.r, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.ca = load i16, ptr %i.s, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.cc = load i16, ptr %i.t, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.ce = load i16, ptr %i.u, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.cg = load i16, ptr %i.v, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.ci = load i16, ptr %i.w, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.ck = load i16, ptr %i.x, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.cm = load i16, ptr %i.y, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.co = load i16, ptr %i.z, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.cq = load i16, ptr %i.aa, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.cs = load i16, ptr %i.ab, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.cu = load i16, ptr %i.ac, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.cw = load i16, ptr %i.ad, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.cy = load i16, ptr %i.ae, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.da = load i16, ptr %i.af, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.dc = load i16, ptr %i.ag, align 2, !tbaa !30, !alias.scope !59
  ...
  %i.de = load i16, ptr %i.ah, align 2, !tbaa !30, !alias.scope !59
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <8 x i16>, ptr %next.gep90, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load91 = load <8 x i16>, ptr %i.dj, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load92 = load <8 x i16>, ptr %i.dn, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load93 = load <8 x i16>, ptr %i.dr, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load94 = load <8 x i16>, ptr %i.dv, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load95 = load <8 x i16>, ptr %i.dz, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load96 = load <8 x i16>, ptr %i.ed, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load97 = load <8 x i16>, ptr %i.eh, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load98 = load <8 x i16>, ptr %i.el, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load99 = load <8 x i16>, ptr %i.ep, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load100 = load <8 x i16>, ptr %i.et, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load101 = load <8 x i16>, ptr %i.ex, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load102 = load <8 x i16>, ptr %i.fb, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load103 = load <8 x i16>, ptr %i.ff, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load104 = load <8 x i16>, ptr %i.fj, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load105 = load <8 x i16>, ptr %i.fn, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load106 = load <8 x i16>, ptr %i.fr, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load107 = load <8 x i16>, ptr %i.fv, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load108 = load <8 x i16>, ptr %i.fz, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load109 = load <8 x i16>, ptr %i.gd, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load110 = load <8 x i16>, ptr %i.gh, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load111 = load <8 x i16>, ptr %i.gl, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load112 = load <8 x i16>, ptr %i.gp, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load113 = load <8 x i16>, ptr %i.gt, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load114 = load <8 x i16>, ptr %i.gx, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load115 = load <8 x i16>, ptr %i.hb, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load116 = load <8 x i16>, ptr %i.hf, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load117 = load <8 x i16>, ptr %i.hj, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load118 = load <8 x i16>, ptr %i.hn, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load119 = load <8 x i16>, ptr %i.hr, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load120 = load <8 x i16>, ptr %i.hv, align 2, !tbaa !30, !alias.scope !60
  ...
  %wide.load121 = load <8 x i16>, ptr %i.hz, align 2, !tbaa !30, !alias.scope !60
  ...
  store <8 x i16> %i.ig, ptr %next.gep, align 2, !tbaa !30, !alias.scope !61, !noalias !62
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.ih = icmp eq i64 %index.next, %n.vec
  br i1 %i.ih, label %middle.block, label %vector.body, !llvm.loop !57
...
.preheader:                                       ; preds = %.preheader.preheader123, %.preheader
  ...
  %i.ij = load <32 x i16>, ptr %.01518, align 2, !tbaa !30
  %i.ik = sext <32 x i16> %i.ij to <32 x i32>
  %i.il = load <32 x i16>, ptr %2, align 2, !tbaa !30
  ...
  store i16 %.0.i, ptr %.01419, align 2, !tbaa !30
  %i.is = getelementptr inbounds nuw i8, ptr %.01419, i64 2 ; 2 uses
  %i.it = icmp ult ptr %i.ii, %1
  br i1 %i.it, label %.preheader, label %._crit_edge, !llvm.loop !58
...
!37 = distinct !{!37, !31, !32, !33}
!38 = distinct !{!38, !31, !32, !33}
!39 = distinct !{!39, !31, !32}
!40 = !{!"p1 _ZTS7AVFrame", !9, i64 0}
!41 = !{!40, !40, i64 0}
!42 = !{!18, !15, i64 56}
...
!48 = !{!"p1 _ZTS12AVDictionary", !9, i64 0}
!49 = !{!"AVFrame", !5, i64 0, !5, i64 64, !45, i64 96, !6, i64 104, !6, i64 108, !6, i64 112, !6, i64 116, !6, i64 120, !21, i64 124, !46, i64 136, !46, i64 144, !21, i64 152, !6, i64 160, !9, i64 168, !6, i64 176, !6, i64 180, !5, i64 184, !47, i64 248, !6, i64 256, !23, i64 264, !6, i64 272, !6, i64 276, !6, i64 280, !6, i64 284, !6, i64 288, !6, i64 292, !6, i64 296, !46, i64 304, !48, i64 312, !6, i64 320, !17, i64 328, !17, i64 336, !46, i64 344, !46, i64 352, !46, i64 360, !46, i64 368, !9, i64 376, !22, i64 384, !46, i64 408, !6, i64 416}
!50 = !{!49, !6, i64 112}
!51 = !{!12, !12, i64 0}
