...
.lr.ph1020:                                       ; preds = %.preheader913
  ...
  %i.vj = zext nneg i32 %i.vi to i64              ; 5 uses
  %i.vk = mul nuw nsw i32 %i.vi, %i.ty
  %i.vl = zext i32 %i.vk to i64                   ; 2 uses
  %i.vm = sext i32 %i.ue to i64                   ; 2 uses
  %i.vn = sext i32 %spec.select265.i.i to i64
  %i.vo = zext i32 %i.ty to i64                   ; 4 uses
  ...
  %smax1866 = zext nneg i32 %i.vt to i64          ; 2 uses
  ...
  %i.vx = add nuw nsw i64 %i.vo, 1
  %4 = mul nuw i64 %i.vx, %i.vj
  %5 = add i64 %.1234.i.i.idx, %4                 ; 2 uses
  %scevgep1872 = getelementptr i8, ptr %i.tz, i64 %5
  %i.vy = mul nsw i64 %i.vu, %i.vo                ; 3 uses
  %i.vz = getelementptr i8, ptr %i.tz, i64 %5
  %i.wa = getelementptr i8, ptr %i.vz, i64 %i.vy
  %scevgep1875 = getelementptr i8, ptr %i.tz, i64 %.1234.i.i.idx
  %i.wb = getelementptr i8, ptr %scevgep1875, i64 %i.vl
  %6 = add nsw i64 %smax1866, -1
  %7 = add nsw i64 %6, %i.vj
  %8 = mul i64 %7, %i.vo
  %i.wc = getelementptr i8, ptr %i.tz, i64 %.1234.i.i.idx
  %scevgep1879 = getelementptr i8, ptr %i.wc, i64 %8
...
bb.av:                                            ; preds = %.lr.ph1020, %add_yblock.exit.i
  ...
  %scevgep1876 = getelementptr i8, ptr %i.wa, i64 %i.xy
  %scevgep1878 = getelementptr i8, ptr %i.wb, i64 %i.xx
...
.lr.ph1072:                                       ; preds = %.preheader908
  ...
  %i.cfe = zext nneg i32 %i.cfd to i64            ; 5 uses
  %i.cff = mul nuw nsw i32 %i.cfd, %i.cdq
  %i.cfg = zext i32 %i.cff to i64                 ; 2 uses
  %i.cfh = sext i32 %i.cdy to i64                 ; 2 uses
  %i.cfi = sext i32 %spec.select265.i.i621 to i64
  %i.cfj = zext i32 %i.cdq to i64                 ; 4 uses
  ...
  %smax1489 = zext nneg i32 %i.cfo to i64         ; 2 uses
  %i.cfp = add nsw i64 %smax1489, -1              ; 3 uses
  %i.cfq = mul nsw i64 %i.cfp, %i.cfc             ; 5 uses
  %scevgep1490 = getelementptr i8, ptr %i.cdx, i64 %i.cfq
  %i.cfr = add nuw nsw i64 %i.cfj, 1
  %9 = mul nuw i64 %i.cfr, %i.cfe
  %10 = add i64 %.1234.i.i620.idx, %9             ; 2 uses
  %scevgep1494 = getelementptr i8, ptr %i.cdr, i64 %10
  %i.cfs = mul nsw i64 %i.cfp, %i.cfj             ; 3 uses
  %i.cft = getelementptr i8, ptr %i.cdr, i64 %10
  %i.cfu = getelementptr i8, ptr %i.cft, i64 %i.cfs
  %scevgep1497 = getelementptr i8, ptr %i.cdr, i64 %.1234.i.i620.idx
  %i.cfv = getelementptr i8, ptr %scevgep1497, i64 %i.cfg
  %11 = add nsw i64 %smax1489, -1
  %12 = add nsw i64 %11, %i.cfe
  %13 = mul i64 %12, %i.cfj
  %i.cfw = getelementptr i8, ptr %i.cdr, i64 %.1234.i.i620.idx
  %scevgep1501 = getelementptr i8, ptr %i.cfw, i64 %13
...
bb.gn:                                            ; preds = %.lr.ph1072, %add_yblock.exit.i647
  ...
  %scevgep1498 = getelementptr i8, ptr %i.cfu, i64 %i.civ
  %scevgep1500 = getelementptr i8, ptr %i.cfv, i64 %i.ciu
...
.lr.ph993:                                        ; preds = %.preheader917
  ...
  %i.ddd = zext nneg i32 %i.ddc to i64            ; 5 uses
  %i.dde = mul nuw nsw i32 %i.ddc, %i.dbp
  %i.ddf = zext i32 %i.dde to i64                 ; 2 uses
  %i.ddg = sext i32 %i.dbx to i64                 ; 2 uses
  %i.ddh = sext i32 %spec.select265.i.i711 to i64
  %i.ddi = zext i32 %i.dbp to i64                 ; 4 uses
  ...
  %smax2022 = zext nneg i32 %i.ddn to i64         ; 2 uses
  %i.ddo = add nsw i64 %smax2022, -1              ; 3 uses
  %i.ddp = mul nsw i64 %i.ddo, %i.ddb             ; 5 uses
  %scevgep2023 = getelementptr i8, ptr %i.dbw, i64 %i.ddp
  %i.ddq = add nuw nsw i64 %i.ddi, 1
  %14 = mul nuw i64 %i.ddq, %i.ddd
  %15 = add i64 %.1234.i.i710.idx, %14            ; 2 uses
  %scevgep2028 = getelementptr i8, ptr %i.dbq, i64 %15
  %i.ddr = mul nsw i64 %i.ddo, %i.ddi             ; 3 uses
  %i.dds = getelementptr i8, ptr %i.dbq, i64 %15
  %i.ddt = getelementptr i8, ptr %i.dds, i64 %i.ddr
  %scevgep2031 = getelementptr i8, ptr %i.dbq, i64 %.1234.i.i710.idx
  %i.ddu = getelementptr i8, ptr %scevgep2031, i64 %i.ddf
  %16 = add nsw i64 %smax2022, -1
  %17 = add nsw i64 %16, %i.ddd
  %18 = mul i64 %17, %i.ddi
  %i.ddv = getelementptr i8, ptr %i.dbq, i64 %.1234.i.i710.idx
  %scevgep2035 = getelementptr i8, ptr %i.ddv, i64 %18
...
bb.hl:                                            ; preds = %.lr.ph993, %add_yblock.exit.i737
  ...
  %scevgep2032 = getelementptr i8, ptr %i.ddt, i64 %i.dgu
  %scevgep2034 = getelementptr i8, ptr %i.ddu, i64 %i.dgt
...
bb.s:                                             ; preds = %bb.r, %bb.q
  ...
  %i.mn = zext nneg i32 %i.mm to i64              ; 5 uses
  %i.mo = mul nuw nsw i32 %i.mm, %i.kv
  ...
  %i.ms = zext i32 %i.kv to i64                   ; 5 uses
  ...
  %20 = add nuw nsw i64 %i.ms, 1
  %21 = mul nuw i64 %20, %i.mn
  %22 = add nsw i64 %i.mn, -1
...
bb.t:                                             ; preds = %._crit_edge208.i.us.us.us.i, %bb.s
  ...
  %umax263 = zext i32 %i.nu to i64                ; 4 uses
  %i.nv = shl nuw nsw i64 %umax263, 1
  %i.nw = mul nuw i64 %i.nl, %i.ms
  %23 = add i64 %i.nw, %umax263                   ; 3 uses
  %umax268 = call i64 @llvm.umax.i64(i64 %i.nk, i64 1)
  %i.nx = add nsw i64 %22, %umax268
  %24 = mul i64 %i.nx, %i.ms
...
bb.ab:                                            ; preds = %bb.aa, %bb.z
  ...
  %.1234.i.i.us.us.us.i = phi ptr [ %i.sr, %bb.aa ], [ %.0233.i.i.us.us.us.i, %bb.z ] ; 6 uses
...
.lr.ph.preheader.i.us.us.us.i:                    ; preds = %bb.ak, %same_block.exit.i.i.us.us.us.i, %.split302.i.us.us.us.i, %same_block.exit272.i.i.us.us.us.i, %.split301.i.us.us.us.i, %same_block.exit279.i.i.us.us.us.i, %.split300.i.us.us.us.i
  ...
  %i.adh = getelementptr i8, ptr %.1234.i.i.us.us.us.i, i64 %21 ; 2 uses
  %scevgep265 = getelementptr i8, ptr %i.adh, i64 %23
  %scevgep266 = getelementptr i8, ptr %.1234.i.i.us.us.us.i, i64 %i.mp
  %scevgep267 = getelementptr i8, ptr %.1234.i.i.us.us.us.i, i64 %24
  %scevgep268 = getelementptr i8, ptr %scevgep267, i64 %umax263
  %scevgep269 = getelementptr i8, ptr %.1234.i.i.us.us.us.i, i64 %i.mn ; 2 uses
  %scevgep270 = getelementptr i8, ptr %scevgep269, i64 %23
  %scevgep271 = getelementptr i8, ptr %.1234.i.i.us.us.us.i, i64 %23
  ...
  %i.adi = insertelement <8 x ptr> poison, ptr %scevgep265, i64 0
  ...
  %i.adw = insertelement <2 x ptr> poison, ptr %i.adh, i64 0
  %i.adx = insertelement <2 x ptr> %i.adw, ptr %scevgep266, i64 1
