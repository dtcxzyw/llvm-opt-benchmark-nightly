...
bb.c:                                             ; preds = %bb.c, %bb.b
  ...
  %.0232352.i = phi i16 [ %i.jr, %bb.b ], [ %spec.select297.i, %bb.c ]
  %.0256351.i = phi i32 [ 0, %bb.b ], [ %spec.select.i, %bb.c ] ; 2 uses
  ...
  %i.jy = icmp sgt i32 %i.jx, %.0256351.i
  %i.jz = trunc i64 %indvars.iv387.i to i16
  %spec.select.i = call i32 @llvm.smax.i32(i32 %i.jx, i32 %.0256351.i) ; 3 uses
  %spec.select297.i = select i1 %i.jy, i16 %i.jz, i16 %.0232352.i ; 3 uses
...
.preheader338.i:                                  ; preds = %bb.d
  ...
  %.1262..i = call i32 @llvm.smax.i32(i32 %i.kj, i32 %i.la)
  %spec.select333.i = call i32 @llvm.smax.i32(i32 %.1262..i, i32 %i.lf)
  ...
  %.1262..1.i = call i32 @llvm.smax.i32(i32 %spec.select333.i, i32 %i.ln)
  %spec.select333.1.i = call i32 @llvm.smax.i32(i32 %.1262..1.i, i32 %i.lt)
  ...
  %.1262..2.i = call i32 @llvm.smax.i32(i32 %spec.select333.1.i, i32 %i.mb)
  %spec.select333.2.i = call i32 @llvm.smax.i32(i32 %.1262..2.i, i32 %i.mh)
  ...
  %.1262..3.i = call i32 @llvm.smax.i32(i32 %spec.select333.2.i, i32 %i.mp)
  %spec.select333.3.i = call i32 @llvm.smax.i32(i32 %.1262..3.i, i32 %i.mv)
  ...
  %.1262..4.i = call i32 @llvm.smax.i32(i32 %spec.select333.3.i, i32 %i.nd)
  %spec.select333.4.i = call i32 @llvm.smax.i32(i32 %.1262..4.i, i32 %i.nj)
  ...
  %.1262..5.i = call i32 @llvm.smax.i32(i32 %spec.select333.4.i, i32 %i.nr)
  %spec.select333.5.i = call i32 @llvm.smax.i32(i32 %.1262..5.i, i32 %i.nx)
  ...
  %.1262..6.i = call i32 @llvm.smax.i32(i32 %spec.select333.5.i, i32 %i.of)
  %spec.select333.6.i = call i32 @llvm.smax.i32(i32 %.1262..6.i, i32 %i.ol) ; 3 uses
...
.preheader337.i:                                  ; preds = %bb.i, %bb.e
  ...
  %.0227367.i = phi i16 [ 1, %bb.e ], [ %.2.1.i, %bb.i ]
  %.0228366.i = phi i16 [ 0, %bb.e ], [ %.2230.1.i, %bb.i ]
  %.0237365.i = phi i32 [ %i.pf, %bb.e ], [ %.2239.1.i, %bb.i ] ; 2 uses
  %.0246364.i = phi i16 [ %i.pb, %bb.e ], [ %.2248.1.i, %bb.i ] ; 2 uses
  %.0250363.i = phi i16 [ %i.pd, %bb.e ], [ %.2252.1.i, %bb.i ]
  ...
  %i.pu = sext i16 %.0246364.i to i64             ; 2 uses
  %i.pv = mul nsw i64 %i.pt, %i.pu
  %i.pw = lshr i64 %i.pv, 15
  %i.px = trunc i64 %i.pw to i32
  %i.py = zext nneg i32 %.0237365.i to i64        ; 2 uses
...
bb.g:                                             ; preds = %bb.f, %.preheader337.i
  ...
  %.2252.i = phi i16 [ %i.qe, %bb.f ], [ %.0250363.i, %.preheader337.i ]
  %.2248.i = phi i16 [ %i.ps, %bb.f ], [ %.0246364.i, %.preheader337.i ]
  %.2239.i = phi i32 [ %i.pp, %bb.f ], [ %.0237365.i, %.preheader337.i ]
  %.2230.i = phi i16 [ %i.pj, %bb.f ], [ %.0228366.i, %.preheader337.i ]
  %.2.i = phi i16 [ 0, %bb.f ], [ %.0227367.i, %.preheader337.i ]
...
bb.i:                                             ; preds = %bb.h, %bb.g
  %.2252.1.i = phi i16 [ %i.qz, %bb.h ], [ %.2252.i, %bb.g ] ; 5 uses
  %.2248.1.i = phi i16 [ %i.qp, %bb.h ], [ %.2248.i, %bb.g ] ; 4 uses
  %.2239.1.i = phi i32 [ %i.ql, %bb.h ], [ %.2239.i, %bb.g ] ; 2 uses
  %.2230.1.i = phi i16 [ %i.pj, %bb.h ], [ %.2230.i, %bb.g ] ; 4 uses
  %.2.1.i = phi i16 [ 1, %bb.h ], [ %.2.i, %bb.g ] ; 3 uses
...
bb.j:                                             ; preds = %bb.i
  ...
  %.not293.i = icmp eq i16 %.2252.1.i, 0
...
bb.n:                                             ; preds = %bb.m, %bb.l
  %.0236.i = phi i16 [ %i.sg, %bb.m ], [ 0, %bb.l ] ; 2 uses
  %.0235.i = phi i16 [ %i.sh, %bb.m ], [ 0, %bb.l ] ; 2 uses
  ...
  %i.sw = sext i16 %.2252.1.i to i32              ; 2 uses
  ...
  %i.td = sext i16 %.0236.i to i32                ; 2 uses
  ...
  %i.tj = zext nneg i16 %.0235.i to i32
...
bb.q:                                             ; preds = %bb.p, %bb.o
  %.0260.i = phi i32 [ %i.to, %bb.o ], [ %i.tc, %bb.p ]
  %.0259.i = phi i32 [ %i.ti, %bb.o ], [ %i.tr, %bb.p ]
  %i.ts = icmp sgt i32 %.0259.i, %.0260.i
  br i1 %i.ts, label %bb.s, label %bb.r

bb.r:                                             ; preds = %bb.q
  %i.tt = sext i16 %.2230.1.i to i64
...
bb.s:                                             ; preds = %bb.r, %bb.q
  %.4254.i = phi i16 [ %.2252.1.i, %bb.r ], [ %.0236.i, %bb.q ] ; 8 uses
  %.4.i = phi i16 [ %.2248.1.i, %bb.r ], [ %i.su, %bb.q ] ; 8 uses
  %.1244.i = phi i16 [ %i.ra, %bb.r ], [ %.0235.i, %bb.q ] ; 8 uses
  %.1241.i = phi i16 [ %i.ow, %bb.r ], [ %i.sv, %bb.q ] ; 8 uses
  %.0226.i = phi ptr [ %i.tw, %bb.r ], [ %i.jf, %bb.q ] ; 14 uses
...
iter.check218:                                    ; preds = %.preheader335.i
  %i.tx = sub nsw i32 0, %.0258423.i              ; 3 uses
...
vector.body210:                                   ; preds = %vector.body210, %vector.ph206
  ...
  %i.tz = getelementptr inbounds nuw [2 x i8], ptr %.0226.i, i64 %index211 ; 3 uses
...
vec.epilog.vector.body226:                        ; preds = %vec.epilog.vector.body226, %vec.epilog.ph222
  ...
  %i.ui = getelementptr inbounds nuw [2 x i8], ptr %.0226.i, i64 %index227 ; 2 uses
...
vector.ph237:                                     ; preds = %vector.main.loop.iter.check235
  ...
  %broadcast.splatinsert239 = insertelement <8 x i32> poison, i32 %.0258423.i, i64 0
...
vector.body241:                                   ; preds = %vector.body241, %vector.ph237
  ...
  %i.uo = getelementptr inbounds nuw [2 x i8], ptr %.0226.i, i64 %index242 ; 3 uses
...
vec.epilog.vector.body257:                        ; preds = %vec.epilog.vector.body257, %vec.epilog.ph253
  ...
  %i.ux = getelementptr inbounds nuw [2 x i8], ptr %.0226.i, i64 %index258 ; 2 uses
...
.lr.ph371.i:                                      ; preds = %.lr.ph371.i.preheader, %.lr.ph371.i
  ...
  %i.vc = getelementptr inbounds nuw [2 x i8], ptr %.0226.i, i64 %indvars.iv407.i ; 2 uses
  %i.vd = load i16, ptr %i.vc, align 2, !tbaa !9
  %i.ve = zext i16 %i.vd to i32
  %i.vf = shl i32 %i.ve, %.0258423.i
...
vec.epilog.scalar.ph219:                          ; preds = %vec.epilog.scalar.ph219.preheader, %vec.epilog.scalar.ph219
  ...
  %i.vh = getelementptr inbounds nuw [2 x i8], ptr %.0226.i, i64 %indvars.iv402.i ; 2 uses
