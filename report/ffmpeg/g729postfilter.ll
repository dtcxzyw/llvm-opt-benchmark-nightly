...
vec.epilog.iter.check251:                         ; preds = %middle.block246
  %min.epilog.iters.check252 = icmp eq i64 %i.ul, 0
...
vec.epilog.vector.body257:                        ; preds = %vec.epilog.vector.body257, %vec.epilog.ph253
  ...
  %i.uv = getelementptr inbounds nuw [2 x i8], ptr %.0226.i, i64 %index258 ; 2 uses
  %wide.load259 = load <4 x i16>, ptr %i.uv, align 2, !tbaa !10
  %i.uw = zext <4 x i16> %wide.load259 to <4 x i32>
  %i.ux = shl <4 x i32> %i.uw, %broadcast.splat256
  %i.uy = trunc <4 x i32> %i.ux to <4 x i16>
  store <4 x i16> %i.uy, ptr %i.uv, align 2, !tbaa !10
  %index.next260 = add nuw i64 %index258, 4       ; 2 uses
  %i.uz = icmp eq i64 %index.next260, %n.vec254
  br i1 %i.uz, label %vec.epilog.middle.block261, label %vec.epilog.vector.body257, !llvm.loop !32
...
vector.ph287:                                     ; preds = %vector.memcheck277
  ...
  %i.yt = shufflevector <8 x i32> %broadcast.splatinsert289, <8 x i32> poison, <8 x i32> zeroinitializer
  %i.yu = shufflevector <8 x i32> %broadcast.splatinsert291, <8 x i32> poison, <8 x i32> zeroinitializer
  %i.yv = shufflevector <8 x i32> %broadcast.splatinsert293, <8 x i32> poison, <8 x i32> zeroinitializer
  %i.yw = shufflevector <8 x i32> %broadcast.splatinsert295, <8 x i32> poison, <8 x i32> zeroinitializer
...
vector.body297:                                   ; preds = %vector.body297, %vector.ph287
  ...
  %i.yx = sub i64 %i.yp, %index298                ; 2 uses
  %i.yy = getelementptr [2 x i8], ptr %i.xr, i64 %i.yx ; 2 uses
  %i.yz = getelementptr i8, ptr %i.yy, i64 -16
  %wide.load299 = load <8 x i16>, ptr %i.yz, align 2, !tbaa !10, !alias.scope !52
  %i.za = getelementptr i8, ptr %i.yy, i64 -14
  %wide.load301 = load <8 x i16>, ptr %i.za, align 2, !tbaa !10, !alias.scope !52
  %i.zb = getelementptr inbounds nuw [2 x i8], ptr %8, i64 %i.yx
  %i.zc = getelementptr inbounds i8, ptr %i.zb, i64 -14
  %i.zd = sext <8 x i16> %wide.load299 to <8 x i32>
  %i.ze = mul <8 x i32> %i.yt, %i.zd
  %i.zf = add nsw <8 x i32> %i.ze, splat (i32 16384)
  %i.zg = ashr <8 x i32> %i.zf, splat (i32 15)
  %i.zh = sext <8 x i16> %wide.load301 to <8 x i32>
  %i.zi = add nsw <8 x i32> %i.zg, %i.zh
  %i.zj = mul nsw <8 x i32> %i.zi, %i.yu
  %i.zk = add nsw <8 x i32> %i.zj, %i.yv
  %i.zl = ashr <8 x i32> %i.zk, %i.yw
  %reverse303 = trunc <8 x i32> %i.zl to <8 x i16>
  store <8 x i16> %reverse303, ptr %i.zc, align 2, !tbaa !10, !alias.scope !53, !noalias !52
  %index.next304 = add nuw i64 %index298, 8       ; 2 uses
  %i.zm = icmp eq i64 %index.next304, %n.vec288
...
scalar.ph285:                                     ; preds = %scalar.ph285.preheader, %scalar.ph285
  ...
  %i.zn = getelementptr [2 x i8], ptr %i.xr, i64 %indvars.iv.i69 ; 2 uses
  %i.zo = getelementptr i8, ptr %i.zn, i64 -2
  %i.zp = load i16, ptr %i.zo, align 2, !tbaa !10
  %i.zq = sext i16 %i.zp to i32
  %i.zr = mul i32 %i.yo, %i.zq
  %i.zs = add nsw i32 %i.zr, 16384
  %i.zt = load i16, ptr %i.zn, align 2, !tbaa !10
  %i.zu = sext i16 %i.zt to i32
  %i.zv = ashr i32 %i.zs, 15
  %i.zw = add nsw i32 %i.zv, %i.zu
  %i.zx = mul nsw i32 %i.zw, %i.yi
  %i.zy = add nsw i32 %i.zx, %.036.i
  %i.zz = ashr i32 %i.zy, %.0.i65
  %i.aaa = trunc i32 %i.zz to i16
  %i.aab = getelementptr inbounds nuw [2 x i8], ptr %8, i64 %indvars.iv.i69
  store i16 %i.aaa, ptr %i.aab, align 2, !tbaa !10
  %indvars.iv.next.i70 = add nsw i64 %indvars.iv.i69, -1
  %i.aac = icmp samesign ugt i64 %indvars.iv.i69, 1
  br i1 %i.aac, label %scalar.ph285, label %apply_tilt_comp.exit, !llvm.loop !42

apply_tilt_comp.exit:                             ; preds = %scalar.ph285, %middle.block305, %bb.x
  %i.aad = ashr i32 %.037.i, 1
  %i.aae = sext i16 %i.xu to i32
  %i.aaf = shl nsw i32 %i.aae, 1
  %i.aag = mul nsw i32 %i.aaf, %i.aad
  %i.aah = add nsw i32 %i.aag, 16384
  %i.aai = load i16, ptr %i.xr, align 2, !tbaa !10
  %i.aaj = sext i16 %i.aai to i32
  %i.aak = ashr i32 %i.aah, 15
  %i.aal = add nsw i32 %i.aak, %i.aaj
  %i.aam = mul nsw i32 %i.aal, %i.yi
  %i.aan = add nsw i32 %i.aam, %.036.i
  %i.aao = ashr i32 %i.aan, %.0.i65
  %i.aap = trunc i32 %i.aao to i16
  store i16 %i.aap, ptr %8, align 2, !tbaa !10
