...
.lr.ph417.i:                                      ; preds = %.preheader375.i
  ...
  %i.ap = uitofp nneg i32 %i.ao to double         ; 3 uses
...
.lr.ph423.i:                                      ; preds = %.preheader373.i
  ...
  %i.av = uitofp nneg i32 %i.au to double         ; 2 uses
...
.lr.ph426.i:                                      ; preds = %.preheader372.i
  ...
  %i.ay = uitofp nneg i32 %i.ax to double         ; 3 uses
...
.lr.ph429.i:                                      ; preds = %.preheader371.i
  ...
  %i.bb = uitofp nneg i32 %i.ba to double         ; 3 uses
...
.lr.ph432.i:                                      ; preds = %.preheader370.i
  ...
  %i.be = uitofp nneg i32 %i.bd to double         ; 10 uses
...
.lr.ph438.i:                                      ; preds = %.preheader368.i
  ...
  %i.bl = uitofp nneg i32 %i.bk to double         ; 2 uses
...
bb.f:                                             ; preds = %bb.f, %.lr.ph438.i
  ...
  %i.cy = uitofp nneg i32 %i.cx to double         ; 2 uses
  %1 = fmul nnan nsz double %i.cy, f0x401921FB54442D18
  %2 = fdiv nsz double %1, %i.bl
  %3 = tail call nsz double @llvm.cos.f64(double %2)
  %4 = tail call nsz double @llvm.fmuladd.f64(double %3, double -4.965600e-01, double 4.265900e-01)
  %5 = fmul nnan nsz double %i.cy, f0x402921FB54442D18
  %6 = fdiv nsz double %5, %i.bl
  %i.cz = tail call nsz double @llvm.cos.f64(double %6)
  %i.da = tail call nsz double @llvm.fmuladd.f64(double %i.cz, double 7.684900e-02, double %4)
...
bb.h:                                             ; preds = %bb.h, %.lr.ph432.i
  ...
  %i.dn = uitofp nneg i32 %i.dm to double         ; 10 uses
  %7 = fmul nnan nsz double %i.dn, f0x401921FB54442D18
  %8 = fdiv nsz double %7, %i.be
  %9 = tail call nsz double @llvm.cos.f64(double %8)
  %10 = tail call nsz double @llvm.fmuladd.f64(double %9, double f0xBFFFC60487BC5429, double 1.000000e+00)
  %11 = fmul nnan nsz double %i.dn, f0x402921FB54442D18
  %12 = fdiv nsz double %11, %i.be
  %i.do = tail call nsz double @llvm.cos.f64(double %12)
  %i.dp = tail call nsz double @llvm.fmuladd.f64(double %i.do, double f0x3FFCA8A8A00BFC02, double %10)
  %13 = fmul nnan nsz double %i.dn, f0x4032D97C7F3321D2
  %14 = fdiv nsz double %13, %i.be
  %15 = tail call nsz double @llvm.cos.f64(double %14)
  %16 = tail call nsz double @llvm.fmuladd.f64(double %15, double f0xBFF483615F7CFB71, double %i.dp)
  %17 = fmul nnan nsz double %i.dn, f0x403921FB54442D18
  %18 = fdiv nsz double %17, %i.be
  %i.dq = tail call nsz double @llvm.cos.f64(double %18)
  %i.dr = tail call nsz double @llvm.fmuladd.f64(double %i.dq, double f0x3FE55E6EFBAFE037, double %16)
  %19 = fmul nnan nsz double %i.dn, f0x403F6A7A2955385E
  %20 = fdiv nsz double %19, %i.be
  %21 = tail call nsz double @llvm.cos.f64(double %20)
  %22 = tail call nsz double @llvm.fmuladd.f64(double %21, double f0xBFCEBD96C789A119, double %i.dr)
  %23 = fmul nnan nsz double %i.dn, f0x4042D97C7F3321D2
  %24 = fdiv nsz double %23, %i.be
  %i.ds = tail call nsz double @llvm.cos.f64(double %24)
  %i.dt = tail call nsz double @llvm.fmuladd.f64(double %i.ds, double f0x3FAD0210B59277DF, double %22)
  %25 = fmul nnan nsz double %i.dn, f0x4045FDBBE9BBA775
  %26 = fdiv nsz double %25, %i.be
  %27 = tail call nsz double @llvm.cos.f64(double %26)
  %28 = tail call nsz double @llvm.fmuladd.f64(double %27, double f0xBF80A911CABA9273, double %i.dt)
  %29 = fmul nnan nsz double %i.dn, f0x404921FB54442D18
  %30 = fdiv nsz double %29, %i.be
  %i.du = tail call nsz double @llvm.cos.f64(double %30)
  %i.dv = tail call nsz double @llvm.fmuladd.f64(double %i.du, double f0x3F44770F6C5EC1E5, double %28)
  %31 = fmul nnan nsz double %i.dn, f0x404C463ABECCB2BB
  %32 = fdiv nsz double %31, %i.be
  %33 = tail call nsz double @llvm.cos.f64(double %32)
  %34 = tail call nsz double @llvm.fmuladd.f64(double %33, double f0xBEF4C56FFA2B6206, double %i.dv)
  %35 = fmul nnan nsz double %i.dn, f0x404F6A7A2955385E
  %36 = fdiv nsz double %35, %i.be
  %i.dw = tail call nsz double @llvm.cos.f64(double %36)
  %i.dx = tail call nsz double @llvm.fmuladd.f64(double %i.dw, double 1.329740e-07, double %34)
...
bb.i:                                             ; preds = %bb.i, %.lr.ph429.i
  ...
  %i.eb = uitofp nneg i32 %i.ea to double         ; 3 uses
  %37 = fmul nnan nsz double %i.eb, f0x401921FB54442D18
  %38 = fdiv nsz double %37, %i.bb
  %39 = tail call nsz double @llvm.cos.f64(double %38)
  %40 = tail call nsz double @llvm.fmuladd.f64(double %39, double -4.882900e-01, double 3.587500e-01)
  %41 = fmul nnan nsz double %i.eb, f0x402921FB54442D18
  %42 = fdiv nsz double %41, %i.bb
  %i.ec = tail call nsz double @llvm.cos.f64(double %42)
  %i.ed = tail call nsz double @llvm.fmuladd.f64(double %i.ec, double 1.412800e-01, double %40)
...
bb.j:                                             ; preds = %bb.j, %.lr.ph426.i
  ...
  %i.el = uitofp nneg i32 %i.ek to double         ; 3 uses
  %43 = fmul nnan nsz double %i.el, f0x401921FB54442D18
  %44 = fdiv nsz double %43, %i.ay
  %45 = tail call nsz double @llvm.cos.f64(double %44)
  %46 = tail call nsz double @llvm.fmuladd.f64(double %45, double f0xBFDF4EAF251C193B, double f0x3FD744ED047AB904)
  %47 = fmul nnan nsz double %i.el, f0x402921FB54442D18
  %48 = fdiv nsz double %47, %i.ay
  %i.em = tail call nsz double @llvm.cos.f64(double %48)
  %i.en = tail call nsz double @llvm.fmuladd.f64(double %i.em, double f0x3FC17C17A89331A1, double %46)
...
bb.k:                                             ; preds = %bb.k, %.lr.ph423.i
  ...
  %i.ev = uitofp nneg i32 %i.eu to double         ; 2 uses
  %49 = fdiv nsz double %i.ev, %i.av
  %i.ew = fadd nsz double %49, -5.000000e-01
  ...
  %50 = fmul nnan nsz double %i.ev, f0x401921FB54442D18
  %51 = fdiv nsz double %50, %i.av
  %i.ez = tail call nsz double @llvm.cos.f64(double %51)
...
bb.m:                                             ; preds = %bb.m, %.lr.ph417.i
  ...
  %i.fl = uitofp nneg i32 %i.fk to double         ; 3 uses
  %52 = fmul nnan nsz double %i.fl, f0x401921FB54442D18
  %53 = fdiv nsz double %52, %i.ap
  %54 = tail call nsz double @llvm.cos.f64(double %53)
  %55 = tail call nsz double @llvm.fmuladd.f64(double %54, double -4.873960e-01, double 3.557680e-01)
  %56 = fmul nnan nsz double %i.fl, f0x402921FB54442D18
  %57 = fdiv nsz double %56, %i.ap
  %i.fm = tail call nsz double @llvm.cos.f64(double %57)
  %i.fn = tail call nsz double @llvm.fmuladd.f64(double %i.fm, double 1.442320e-01, double %55)
