...
bb.ok:                                            ; preds = %bb.ok, %.lr.ph223.i
  ...
  %.idx509.i = shl nsw i64 %indvars.iv480.i, 5
  %8 = getelementptr inbounds i8, ptr %i.epm, i64 %.idx509.i
  ...
  %i.ept = tail call fastcc i32 @decode_coeffs_b_8bpp(ptr %.val3.i, ptr noundef %8, i32 noundef 16, ptr noundef nonnull %i.emf, ptr noundef nonnull %i.emi, ptr noundef nonnull %i.emc, i32 noundef %i.eps, ptr noundef %i.dxo, ptr noundef %i.dxq, ptr noundef nonnull %i.dyc, ptr noundef nonnull %i.emw) #8 ; 2 uses
...
bb.op:                                            ; preds = %bb.op, %.preheader51.us.i
  ...
  %.idx513.i = shl nsw i64 %indvars.iv398.i, 6
  %9 = getelementptr inbounds i8, ptr %i.fif, i64 %.idx513.i
  ...
  %i.fis = tail call fastcc i32 @decode_coeffs_b_16bpp(i8 %.val.val.us.i, ptr %.val1.us.i623, ptr noundef %9, i32 noundef 16, ptr noundef nonnull %i.dwa, ptr noundef nonnull %i.dwd, ptr noundef nonnull %i.dvx, i32 noundef %i.fil, ptr noundef %i.fio, ptr noundef %i.fiq, ptr noundef nonnull %i.dyb, ptr noundef nonnull %i.dxb) #8 ; 2 uses
...
bb.oq:                                            ; preds = %bb.oq, %.preheader57.us.i
  ...
  %.idx512.i = shl nsw i64 %indvars.iv382.i612, 6
  %10 = getelementptr inbounds i8, ptr %i.fki, i64 %.idx512.i
  ...
  %i.fkv = tail call fastcc i32 @decode_coeffs_b_16bpp(i8 %.val2.val.us.i, ptr %.val3.us.i, ptr noundef %10, i32 noundef 64, ptr noundef nonnull %i.dwa, ptr noundef nonnull %i.dwd, ptr noundef nonnull %i.dvx, i32 noundef %i.fko, ptr noundef %i.fkr, ptr noundef %i.fkt, ptr noundef nonnull %i.dyb, ptr noundef nonnull %i.dxb) #8 ; 2 uses
...
bb.or:                                            ; preds = %bb.or, %.preheader69.us.i
  ...
  %.idx511.i = shl nsw i64 %indvars.iv354.i595, 6
  %11 = getelementptr inbounds i8, ptr %i.fna, i64 %.idx511.i
  ...
  %i.fnn = tail call fastcc i32 @decode_coeffs_b_16bpp(i8 %.val4.val.us.i, ptr %.val5.us.i, ptr noundef %11, i32 noundef 256, ptr noundef nonnull %i.dwa, ptr noundef nonnull %i.dwd, ptr noundef nonnull %i.dvx, i32 noundef %i.fng, ptr noundef %i.fnj, ptr noundef %i.fnl, ptr noundef nonnull %i.dyb, ptr noundef nonnull %i.dxb) #8 ; 2 uses
...
bb.os:                                            ; preds = %bb.os, %.preheader81.us.i
  ...
  %.idx.i522 = shl nsw i64 %indvars.iv326.i521, 6
  %12 = getelementptr inbounds i8, ptr %i.frh, i64 %.idx.i522
  ...
  %i.fru = tail call fastcc i32 @decode_coeffs_b32_16bpp(i8 %.val12.val.us.i, ptr %.val13.us.i, ptr noundef %12, i32 noundef 1024, ptr noundef nonnull %i.dwa, ptr noundef nonnull %i.dwd, ptr noundef nonnull %i.dvx, i32 noundef %i.frn, ptr noundef %i.frq, ptr noundef %i.frs, ptr noundef nonnull %i.dyb, ptr noundef nonnull %i.dxb) #8 ; 2 uses
...
bb.ou:                                            ; preds = %bb.ou, %.lr.ph231.i
  ...
  %.idx517.i = shl nsw i64 %indvars.iv488.i, 6
  %13 = getelementptr inbounds i8, ptr %i.fyk, i64 %.idx517.i
  ...
  %i.fys = tail call fastcc i32 @decode_coeffs_b_16bpp(i8 %.val6.val.i, ptr %.val7.i584, ptr noundef %13, i32 noundef 16, ptr noundef nonnull %i.fvd, ptr noundef nonnull %i.fvg, ptr noundef nonnull %i.fva, i32 noundef %i.fyq, ptr noundef %i.dxo, ptr noundef %i.dxq, ptr noundef nonnull %i.dyc, ptr noundef nonnull %i.fvu) #8 ; 2 uses
...
bb.ov:                                            ; preds = %bb.ov, %.lr.ph216.i
  ...
  %.idx516.i = shl nsw i64 %indvars.iv472.i573, 6
  %14 = getelementptr inbounds i8, ptr %i.gaz, i64 %.idx516.i
  ...
  %i.gbh = tail call fastcc i32 @decode_coeffs_b_16bpp(i8 %.val8.val.i, ptr %.val9.i, ptr noundef %14, i32 noundef 64, ptr noundef nonnull %i.fvd, ptr noundef nonnull %i.fvg, ptr noundef nonnull %i.fva, i32 noundef %i.gbf, ptr noundef %i.dxo, ptr noundef %i.dxq, ptr noundef nonnull %i.dyc, ptr noundef nonnull %i.fvu) #8 ; 2 uses
...
bb.ow:                                            ; preds = %bb.ow, %.lr.ph192.i
  ...
  %.idx515.i = shl nsw i64 %indvars.iv444.i559, 6
  %15 = getelementptr inbounds i8, ptr %i.gex, i64 %.idx515.i
  ...
  %i.gff = tail call fastcc i32 @decode_coeffs_b_16bpp(i8 %.val10.val.i, ptr %.val11.i, ptr noundef %15, i32 noundef 256, ptr noundef nonnull %i.fvd, ptr noundef nonnull %i.fvg, ptr noundef nonnull %i.fva, i32 noundef %i.gfd, ptr noundef %i.dxo, ptr noundef %i.dxq, ptr noundef nonnull %i.dyc, ptr noundef nonnull %i.fvu) #8 ; 2 uses
...
bb.ox:                                            ; preds = %bb.ox, %.lr.ph170.i537
  ...
  %.idx514.i = shl nsw i64 %indvars.iv416.i538, 6
  %16 = getelementptr inbounds i8, ptr %i.gks, i64 %.idx514.i
  ...
  %i.gla = tail call fastcc i32 @decode_coeffs_b32_16bpp(i8 %.val14.val.i, ptr %.val15.i, ptr noundef %16, i32 noundef 1024, ptr noundef nonnull %i.fvd, ptr noundef nonnull %i.fvg, ptr noundef nonnull %i.fva, i32 noundef %i.gky, ptr noundef %i.dxo, ptr noundef %i.dxq, ptr noundef nonnull %i.dyc, ptr noundef nonnull %i.fvu) #8 ; 2 uses
