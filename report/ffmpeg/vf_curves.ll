...
begin_hunk_0_@config_input:bb.a
  ...
  %i.ac = load i64, ptr %i.ab, align 8, !tbaa !131
...
bb.b:                                             ; preds = %bb.a, %interpolate_pchip.exit.thread
  ...
  %.pre230 = load i32, ptr %i.v, align 8, !tbaa !129 ; 2 uses
...
..thread_crit_edge:                               ; preds = %bb.c
  %.pre = load i32, ptr %i.v, align 8, !tbaa !129
  br label %.thread
...
.thread:                                          ; preds = %..thread_crit_edge, %bb.b
  ...
  %i.ap = load ptr, ptr %i.ao, align 8, !tbaa !21 ; 3 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #13
  store ptr %i.ap, ptr %i.b, align 8, !tbaa !21
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.av = load ptr, ptr %i.b, align 8, !tbaa !21
  %i.aw = call nsz double @av_strtod(ptr noundef %i.av, ptr noundef nonnull %i.b) #13
  store double %i.aw, ptr %i.au, align 8, !tbaa !135
  %i.ax = load ptr, ptr %i.b, align 8, !tbaa !21  ; 4 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  store ptr %i.az, ptr %i.b, align 8, !tbaa !21
  br label %bb.i
...
bb.i:                                             ; preds = %bb.h, %bb.g, %bb.f
  ...
  store double %i.bb, ptr %i.bc, align 8, !tbaa !136
  %i.bd = load ptr, ptr %i.b, align 8, !tbaa !21  ; 4 uses
...
bb.k:                                             ; preds = %bb.j
  ...
  store ptr %i.bf, ptr %i.b, align 8, !tbaa !21
  br label %bb.l

bb.l:                                             ; preds = %bb.k, %bb.j, %bb.i
  %.pr.i = phi ptr [ %i.bf, %bb.k ], [ %i.bd, %bb.j ], [ null, %bb.i ] ; 2 uses
  %i.bg = load double, ptr %i.au, align 8, !tbaa !135 ; 5 uses
...
bb.p:                                             ; preds = %bb.o
  %i.bl = load double, ptr %.03672.i, align 8, !tbaa !135 ; 2 uses
...
bb.q:                                             ; preds = %bb.p
  ...
  %i.br = load double, ptr %i.bq, align 8, !tbaa !136
...
bb.r:                                             ; preds = %bb.p
  ...
  store ptr %i.au, ptr %i.bs, align 8, !tbaa !137
  br label %thread-pre-split.i

thread-pre-split.i:                               ; preds = %bb.r, %bb.o
  %i.bt = load ptr, ptr %i.an, align 8, !tbaa !138 ; 2 uses
...
.critedge.ithread-pre-split:                      ; preds = %bb.d, %.thread
  %.pr = load ptr, ptr %i.an, align 8, !tbaa !138
  br label %.critedge.i
...
bb.t:                                             ; preds = %bb.s
  %i.bx = load double, ptr %i.bu, align 8, !tbaa !135
  %i.by = getelementptr inbounds nuw i8, ptr %i.bu, i64 8
  %i.bz = load double, ptr %i.by, align 8, !tbaa !136
...
bb.u:                                             ; preds = %bb.t, %bb.s
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #13
  %i.ca = load i32, ptr %i.ah, align 8, !tbaa !139
  %i.cb = icmp eq i32 %i.ca, 1
  %i.cc = load ptr, ptr %i.ai, align 8, !tbaa !49 ; 46 uses
  %i.cd = load i32, ptr %i.t, align 8, !tbaa !128 ; 23 uses
  %i.ce = shl nuw i32 1, %i.cd                    ; 22 uses
  br i1 %i.cb, label %.lr.ph.i.i, label %bb.au

.thread284:                                       ; preds = %.critedge.i
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #13
  %i.cf = load i32, ptr %i.ah, align 8, !tbaa !139
  %i.cg = icmp eq i32 %i.cf, 1
  %i.ch = load ptr, ptr %i.ai, align 8, !tbaa !49 ; 14 uses
  %i.ci = load i32, ptr %i.t, align 8, !tbaa !128 ; 4 uses
...
.lr.ph.i.i:                                       ; preds = %bb.u, %.lr.ph.i.i
  ...
  br i1 %.not.i255.i, label %get_nb_points.exit.i, label %.lr.ph.i.i, !llvm.loop !76
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <8 x i16> %vec.ind, ptr %i.co, align 2, !tbaa !51
  store <8 x i16> %step.add, ptr %i.cp, align 2, !tbaa !51
  %index.next = add nuw i64 %index, 16            ; 2 uses
  %vec.ind.next = add <8 x i16> %vec.ind, splat (i16 16)
  %i.cq = icmp eq i64 %index.next, %n.vec
  br i1 %i.cq, label %interpolate_pchip.exit.thread, label %vector.body, !llvm.loop !77

vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check
  %n.vec359 = and i64 %wide.trip.count319.i, 2147483644 ; 2 uses
  store <4 x i16> <i16 0, i16 1, i16 2, i16 3>, ptr %i.ch, align 2, !tbaa !51
...
vec.epilog.vector.body.1:                         ; preds = %vec.epilog.ph
  ...
  store <4 x i16> <i16 4, i16 5, i16 6, i16 7>, ptr %i.cs, align 2, !tbaa !51
...
vec.epilog.vector.body.2:                         ; preds = %vec.epilog.vector.body.1
  ...
  store <4 x i16> <i16 8, i16 9, i16 10, i16 11>, ptr %i.cu, align 2, !tbaa !51
  br label %interpolate_pchip.exit.thread

.lr.ph269.i:                                      ; preds = %iter.check
  store i16 0, ptr %i.ch, align 2, !tbaa !51
...
.lr.ph269.i.1:                                    ; preds = %.lr.ph269.i
  ...
  store i16 1, ptr %i.cv, align 2, !tbaa !51
...
vector.body403:                                   ; preds = %vector.body403, %vector.ph399
  ...
  store <8 x i16> %broadcast.splat402, ptr %i.dj, align 2, !tbaa !51
  store <8 x i16> %broadcast.splat402, ptr %i.dk, align 2, !tbaa !51
  %index.next405 = add nuw i64 %index404, 16      ; 2 uses
  %i.dl = icmp eq i64 %index.next405, %n.vec400
  br i1 %i.dl, label %interpolate_pchip.exit.thread, label %vector.body403, !llvm.loop !78
...
vec.epilog.ph413:                                 ; preds = %vector.main.loop.iter.check397
  ...
  store <4 x i16> %broadcast.splat416, ptr %i.cc, align 2, !tbaa !51
...
vec.epilog.vector.body417.1:                      ; preds = %vec.epilog.ph413
  ...
  store <4 x i16> %broadcast.splat416, ptr %i.dn, align 2, !tbaa !51
...
vec.epilog.vector.body417.2:                      ; preds = %vec.epilog.vector.body417.1
  ...
  store <4 x i16> %broadcast.splat416, ptr %i.dp, align 2, !tbaa !51
  br label %interpolate_pchip.exit.thread

.lr.ph.i99:                                       ; preds = %iter.check409
  store i16 %i.di, ptr %i.cc, align 2, !tbaa !51
...
.lr.ph.i99.1:                                     ; preds = %.lr.ph.i99
  ...
  store i16 %i.di, ptr %i.dq, align 2, !tbaa !51
...
.lr.ph.i99.2:                                     ; preds = %.lr.ph.i99.1
  ...
  store i16 %i.di, ptr %i.dr, align 2, !tbaa !51
  br label %interpolate_pchip.exit.thread
...
.lr.ph274.preheader.i:                            ; preds = %.lr.ph274.preheader.i.unr-lcssa, %.epil.preheader
  ...
  %.pre.i = load double, ptr %i.dw, align 8, !tbaa !142 ; 4 uses
  %.pre349.i = load double, ptr %i.dy, align 8, !tbaa !142 ; 4 uses
...
vector.body480:                                   ; preds = %vector.body480, %vector.ph478
  ...
  %wide.load484 = load <2 x double>, ptr %i.ep, align 8, !tbaa !142 ; 4 uses
  ...
  store <2 x double> %i.er, ptr %i.es, align 8, !tbaa !142
  %i.et = getelementptr inbounds nuw [8 x i8], ptr %i.dy, i64 %i.eo
  %wide.load485 = load <2 x double>, ptr %i.et, align 8, !tbaa !142 ; 4 uses
  ...
  store <2 x double> %i.ew, ptr %i.ex, align 8, !tbaa !142
  %index.next486 = add nuw i64 %index481, 2       ; 2 uses
  %i.ey = icmp eq i64 %index.next486, %n.vec479
  br i1 %i.ey, label %middle.block487, label %vector.body480, !llvm.loop !79
...
.lr.ph274.i.preheader:                            ; preds = %vector.memcheck, %.lr.ph274.preheader.i, %middle.block487
  ...
  %.ph691 = phi double [ %.pre.i, %vector.memcheck ], [ %.pre.i, %.lr.ph274.preheader.i ], [ %vector.recur.extract488, %middle.block487 ] ; 2 uses
  ...
  %xtraiter734 = and i64 %indvar, 1
  %lcmp.mod735.not = icmp eq i64 %xtraiter734, 0
  br i1 %lcmp.mod735.not, label %.lr.ph274.i.prol.loopexit, label %.lr.ph274.i.prol
...
.lr.ph274.i.prol:                                 ; preds = %.lr.ph274.i.preheader
  ...
  %i.fa = load double, ptr %i.ez, align 8, !tbaa !142 ; 2 uses
  %i.fb = fsub nsz double %i.fa, %.ph691          ; 2 uses
  %i.fc = getelementptr inbounds nuw [8 x i8], ptr %i.ej, i64 %indvars.iv326.i.ph
  store double %i.fb, ptr %i.fc, align 8, !tbaa !142
  %i.fd = getelementptr inbounds nuw [8 x i8], ptr %i.dy, i64 %indvars.iv.next327.i.prol
  %i.fe = load double, ptr %i.fd, align 8, !tbaa !142 ; 2 uses
  ...
  store double %i.fg, ptr %i.fh, align 8, !tbaa !142
  br label %.lr.ph274.i.prol.loopexit

.lr.ph274.i.prol.loopexit:                        ; preds = %.lr.ph274.i.prol, %.lr.ph274.i.preheader
  %.unr736 = phi double [ %.ph, %.lr.ph274.i.preheader ], [ %i.fe, %.lr.ph274.i.prol ]
  %.unr737 = phi double [ %.ph691, %.lr.ph274.i.preheader ], [ %i.fa, %.lr.ph274.i.prol ]
...
.lr.ph274.i:                                      ; preds = %.lr.ph274.i.prol.loopexit, %.lr.ph274.i
  %i.gc = phi double [ %i.gs, %.lr.ph274.i ], [ %.unr736, %.lr.ph274.i.prol.loopexit ]
  %i.gd = phi double [ %i.go, %.lr.ph274.i ], [ %.unr737, %.lr.ph274.i.prol.loopexit ]
  ...
  store double %i.gl, ptr %i.gm, align 8, !tbaa !142
...
bb.aa:                                            ; preds = %._crit_edge.i
  %i.gw = load double, ptr %i.el, align 8, !tbaa !142 ; 10 uses
...
vector.body450:                                   ; preds = %vector.body450, %vector.ph440
  ...
  store <8 x i16> %i.hk, ptr %i.hl, align 2, !tbaa !51
  ...
  br i1 %i.hm, label %interpolate_pchip.exit, label %vector.body450, !llvm.loop !82
