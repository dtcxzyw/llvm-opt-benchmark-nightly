...
begin_hunk_0_@filter_slice_gbrap32:bb.a
  %i.hc = insertelement <2 x ptr> poison, ptr %i.ap, i64 0
  %i.hd = insertelement <2 x ptr> %i.hc, ptr %i.bd, i64 1
  %i.he = insertelement <2 x ptr> %i.ha, ptr %scevgep24, i64 1
  %i.hf = insertelement <2 x ptr> poison, ptr %scevgep22, i64 0
  %i.hg = insertelement <2 x ptr> %i.hf, ptr %scevgep18, i64 1
  %i.hh = insertelement <2 x ptr> poison, ptr %i.al, i64 0
  %i.hi = insertelement <2 x ptr> %i.hh, ptr %i.bd, i64 1
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %4 = fpext nsz float %i.lq to double
  %5 = fpext nsz float %i.lo to double
  %6 = insertelement <4 x double> poison, double %4, i64 0
  %7 = shufflevector <4 x double> %6, <4 x double> poison, <4 x i32> zeroinitializer
  %i.ly = fmul nsz <4 x double> %i.jo, %7
  %8 = insertelement <4 x double> poison, double %5, i64 0
  %i.lz = shufflevector <4 x double> %8, <4 x double> poison, <4 x i32> zeroinitializer
  %i.ma = tail call nsz <4 x double> @llvm.fmuladd.v4f64(<4 x double> %i.jr, <4 x double> %i.lz, <4 x double> %i.ly) ; 3 uses
  %i.mb = fpext nsz float %i.lu to double         ; 3 uses
  %i.mc = fpext nsz float %i.ls to double         ; 3 uses
  ...
  %i.mf = fmul nsz <2 x double> %i.js, %i.me
  %i.mg = fmul nsz double %i.cz, %i.mb
  ...
  %i.mj = shufflevector <4 x double> %i.ma, <4 x double> poison, <2 x i32> <i32 0, i32 1>
  %i.mk = tail call nsz <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.jt, <2 x double> %i.mi, <2 x double> %i.mj)
  %i.ml = fadd nsz <2 x double> %i.mk, %i.mf
  %i.mm = fptrunc <2 x double> %i.ml to <2 x float> ; 2 uses
  %i.mn = extractelement <4 x double> %i.ma, i64 2
  %i.mo = tail call nsz double @llvm.fmuladd.f64(double %i.cy, double %i.mc, double %i.mn)
  %i.mp = fadd nsz double %i.mo, %i.mg
  %i.mq = fptrunc nsz double %i.mp to float
  %i.mr = extractelement <2 x float> %i.mm, i64 0
  store float %i.mr, ptr %i.lv, align 4, !tbaa !83
  %i.ms = extractelement <2 x float> %i.mm, i64 1
  store float %i.ms, ptr %i.lw, align 4, !tbaa !83
  store float %i.mq, ptr %i.lx, align 4, !tbaa !83
  %i.mt = extractelement <4 x double> %i.ma, i64 3
  %i.mu = tail call nsz double @llvm.fmuladd.f64(double %i.de, double %i.mc, double %i.mt)
  %i.mv = tail call nsz double @llvm.fmuladd.f64(double %i.df, double %i.mb, double %i.mu)
  %i.mw = fptrunc nsz double %i.mv to float
  %i.mx = getelementptr inbounds nuw [4 x i8], ptr %.0137.i11, i64 %indvars.iv
  store float %i.mw, ptr %i.mx, align 4, !tbaa !83
