...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %4 = insertelement <2 x float> poison, float %i.lo, i64 0
  %5 = insertelement <2 x float> %4, float %i.lq, i64 1
  ...
  %i.lz = shufflevector <2 x double> %6, <2 x double> poison, <4 x i32> zeroinitializer
