...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %i.gd = tail call nsz float @llvm.exp.f32(float %i.gb)
  %5 = tail call nsz float @llvm.exp.f32(float %i.gc)
  %6 = tail call nsz float @llvm.fmuladd.f32(float %i.fq, float 5.773500e-01, float %4)
  %7 = insertelement <4 x float> poison, float %6, i64 0
  %8 = insertelement <4 x float> %7, float %5, i64 1
  %i.ge = shufflevector <4 x float> %8, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 1>
