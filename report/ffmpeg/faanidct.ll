...
vector.body17:                                    ; preds = %vector.ph, %vector.body17
  ...
  %1 = shufflevector <4 x float> %i.dt, <4 x float> %i.eg, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %2 = shufflevector <4 x float> %i.gj, <4 x float> %i.gl, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %3 = fadd nsz <8 x float> %1, %2
  ...
  %4 = shufflevector <4 x float> %i.gl, <4 x float> %i.gj, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %5 = shufflevector <4 x float> %i.eg, <4 x float> %i.dt, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %6 = fsub nsz <8 x float> %4, %5
...
vector.body14:                                    ; preds = %vector.ph, %vector.body14
  ...
  %i.gp = fsub nsz <4 x float> %i.gk, %i.ei
  %i.gq = fadd nsz <4 x float> %i.gk, %i.ei
  %3 = shufflevector <4 x float> %i.dt, <4 x float> %i.eg, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %4 = shufflevector <4 x float> %i.gj, <4 x float> %i.gl, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %5 = fadd nsz <8 x float> %3, %4
  %i.gr = shufflevector <4 x float> %i.gn, <4 x float> %i.gp, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.gs = shufflevector <4 x float> %i.gq, <4 x float> %i.go, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %6 = shufflevector <4 x float> %i.gl, <4 x float> %i.gj, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %7 = shufflevector <4 x float> %i.eg, <4 x float> %i.dt, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
