...
begin_hunk_0_@ff_h264_filter_mb:bb.a
  ...
  %i.bnx = zext nneg i16 %.sroa.0824.4 to i64
  ...
  %i.boa = zext nneg i16 %.sroa.14.2 to i64
  ...
  %i.bod = zext nneg i16 %.sroa.24.2 to i64
  ...
  %i.bog = zext nneg i16 %.sroa.34.2 to i64
...
bb.fr:                                            ; preds = %bb.fq
  ...
  %i.bpg = zext nneg i16 %.sroa.0824.4 to i64
  ...
  %i.bpk = zext nneg i16 %.sroa.14.2 to i64
  ...
  %i.bpo = zext nneg i16 %.sroa.24.2 to i64
  ...
  %i.bps = zext nneg i16 %.sroa.34.2 to i64
...
bb.fs:                                            ; preds = %filter_mb_edgecv.exit426
  ...
  %i.bqq = zext nneg i16 %.sroa.0824.4 to i64
  ...
  %i.bqu = zext nneg i16 %.sroa.14.2 to i64
  ...
  %i.bqy = zext nneg i16 %.sroa.24.2 to i64
  ...
  %i.brc = zext nneg i16 %.sroa.34.2 to i64
...
bb.fy:                                            ; preds = %bb.fx, %filter_mb_edgeh.exit
  ...
  %.0462.i463 = phi i32 [ %i.bsl, %bb.fx ], [ %i.cba, %filter_mb_edgeh.exit ] ; 2 uses
  %i.btq = load ptr, ptr %i.be, align 8, !tbaa !82
  %i.btr = sext i32 %.0462.i463 to i64            ; 5 uses
...
filter_mb_edgeh.exit:                             ; preds = %bb.gl, %filter_mb_edgech.exit433, %bb.gi, %filter_mb_edgeh.exit407, %filter_mb_edgeh.exit409
  ...
  %i.cba = add nsw i32 %i.caz, %.0462.i463
...
bb.gr:                                            ; preds = %bb.gq, %bb.gp
  ...
  br i1 %or.cond508.i, label %.thread992, label %bb.gs
...
bb.gt:                                            ; preds = %bb.gq, %bb.gs
  ...
  %spec.select1024 = select i1 %.not471.i, i16 %.sroa.17806.0, i16 2
  br label %bb.gv

.thread992:                                       ; preds = %bb.gr
  ...
  %.not471.i995 = icmp eq i8 %i.cbs, 0
  br i1 %.not471.i995, label %bb.gu, label %bb.gv

bb.gu:                                            ; preds = %.thread992
...
bb.gv:                                            ; preds = %bb.gt, %.thread992, %bb.gu
  %.not472.i999 = phi i1 [ true, %bb.gu ], [ true, %.thread992 ], [ false, %bb.gt ] ; 3 uses
  %.sroa.17806.0996 = phi i16 [ undef, %bb.gu ], [ undef, %.thread992 ], [ %.sroa.17806.0, %bb.gt ] ; 4 uses
  %.sroa.0805.1 = phi i16 [ %i.cbu, %bb.gu ], [ 2, %.thread992 ], [ %spec.select1024, %bb.gt ] ; 3 uses
...
bb.gw:                                            ; preds = %bb.gv
  br i1 %.not472.i999, label %.thread1012, label %.thread1005
...
bb.gx:                                            ; preds = %bb.gv
  ...
  %brmerge.not = and i1 %.not471.i.2, %.not472.i999
  %.mux = select i1 %.not471.i.2, i16 %.sroa.17806.0996, i16 2
  br i1 %brmerge.not, label %.thread1015, label %.thread1010

.thread1012:                                      ; preds = %bb.gw
  ...
  %.not471.i.21014 = icmp eq i8 %i.ccl, 0
  br i1 %.not471.i.21014, label %.thread1015, label %.thread1010

.thread1005:                                      ; preds = %bb.gw
  ...
  %.not471.i.21007 = icmp eq i8 %i.ccq, 0
  %spec.select1025 = select i1 %.not471.i.21007, i16 %.sroa.17806.0996, i16 2
  br label %.thread1010

.thread1015:                                      ; preds = %bb.gx, %.thread1012
  %.sroa.9.310091017 = phi i16 [ 2, %bb.gx ], [ %i.ccg, %.thread1012 ]
...
.thread1010:                                      ; preds = %.thread1005, %bb.gx, %.thread1012, %.thread1015
  %.sroa.9.31008 = phi i16 [ %.sroa.9.310091017, %.thread1015 ], [ %i.ccg, %.thread1012 ], [ 2, %bb.gx ], [ %.sroa.17806.0996, %.thread1005 ] ; 3 uses
  %.sroa.13.3 = phi i16 [ %i.ccs, %.thread1015 ], [ 2, %.thread1012 ], [ %.mux, %bb.gx ], [ %spec.select1025, %.thread1005 ] ; 3 uses
...
bb.gy:                                            ; preds = %.thread1010
  br i1 %.not472.i999, label %bb.gz, label %thread-pre-split447
...
thread-pre-split447:                              ; preds = %bb.go, %.thread1010, %bb.gz, %bb.gy, %bb.gn
  %.sroa.17806.2 = phi i16 [ 4, %bb.gn ], [ 2, %.thread1010 ], [ 3, %bb.go ], [ %i.ccz, %bb.gz ], [ %.sroa.17806.0996, %bb.gy ] ; 6 uses
  %.sroa.13.2 = phi i16 [ 4, %bb.gn ], [ %.sroa.13.3, %.thread1010 ], [ 3, %bb.go ], [ %.sroa.13.3, %bb.gz ], [ %.sroa.13.3, %bb.gy ] ; 6 uses
  %.sroa.9.2 = phi i16 [ 4, %bb.gn ], [ %.sroa.9.31008, %.thread1010 ], [ 3, %bb.go ], [ %.sroa.9.31008, %bb.gz ], [ %.sroa.9.31008, %bb.gy ] ; 6 uses
  %i.cda = phi i16 [ 4, %bb.gn ], [ %.sroa.0805.1, %.thread1010 ], [ 3, %bb.go ], [ %.sroa.0805.1, %bb.gz ], [ %.sroa.0805.1, %bb.gy ] ; 11 uses
