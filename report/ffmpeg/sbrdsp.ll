...
bb.b:                                             ; preds = %bb.a, %bb.b
  %2 = phi float [ %.pre111, %bb.a ], [ %15, %bb.b ] ; 5 uses
  %.094103.a = phi float [ %.pre, %bb.a ], [ %5, %bb.b ] ; 3 uses
  %indvars.iv = phi i64 [ 1, %bb.a ], [ %indvars.iv.next, %bb.b ] ; 2 uses
  %.094103 = phi float [ 0.000000e+00, %bb.a ], [ %i.m, %bb.b ]
  %i.j = phi <2 x float> [ %i.i, %bb.a ], [ %i.aa, %bb.b ]
  %3 = phi <2 x float> [ zeroinitializer, %bb.a ], [ %i.t, %bb.b ]
  %4 = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %indvars.iv
  %i.k = fmul nsz float %2, %2
  %i.l = tail call nsz float @llvm.fmuladd.f32(float %.094103.a, float %.094103.a, float %i.k)
  %i.m = fadd nsz float %.094103, %i.l            ; 3 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 3 uses
  %i.n = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %indvars.iv.next ; 2 uses
  %i.o = getelementptr inbounds nuw i8, ptr %4, i64 16
  %5 = load float, ptr %i.n, align 4, !tbaa !11   ; 2 uses
  %i.p = load <2 x float>, ptr %i.n, align 4, !tbaa !11 ; 3 uses
  %6 = shufflevector <2 x float> %i.p, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %i.q = fneg nsz float %5
  %7 = insertelement <2 x float> poison, float %2, i64 0
  %8 = shufflevector <2 x float> %7, <2 x float> poison, <2 x i32> zeroinitializer
  %9 = insertelement <2 x float> %i.p, float %i.q, i64 0
  %10 = fmul nsz <2 x float> %8, %9
  %i.r = insertelement <2 x float> poison, float %.094103.a, i64 0
  %11 = shufflevector <2 x float> %i.r, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.s = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %11, <2 x float> %6, <2 x float> %10)
  %i.t = fadd nsz <2 x float> %3, %i.s            ; 3 uses
  %i.u = load <2 x float>, ptr %i.o, align 4, !tbaa !11 ; 3 uses
  %i.v = extractelement <2 x float> %i.u, i64 0
  %i.w = fneg nsz float %i.v
  %i.x = fmul nsz float %2, %i.w
  %12 = extractelement <2 x float> %i.u, i64 1
  %13 = fmul nsz float %2, %12
  %14 = insertelement <2 x float> poison, float %13, i64 0
  %i.y = insertelement <2 x float> %14, float %i.x, i64 1
  %i.z = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %11, <2 x float> %i.u, <2 x float> %i.y)
  %i.aa = fadd nsz <2 x float> %i.j, %i.z         ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.ar = extractelement <2 x float> %i.t, i64 1  ; 2 uses
  ...
  %i.ba = extractelement <2 x float> %i.t, i64 0  ; 2 uses
