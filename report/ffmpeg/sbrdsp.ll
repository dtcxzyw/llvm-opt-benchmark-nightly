...
bb.b:                                             ; preds = %bb.a, %bb.b
  ...
  %i.o = extractelement <2 x float> %i.k, i64 1   ; 3 uses
  ...
  %2 = shufflevector <2 x float> %i.k, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %3 = fneg nsz <2 x float> %i.ae
  %4 = shufflevector <2 x float> %i.ae, <2 x float> %3, <2 x i32> <i32 1, i32 2>
  %i.af = fmul nsz <2 x float> %2, %4
  %i.ag = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.z, <2 x float> %i.ae, <2 x float> %i.af)
