...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load23 = load <2 x float>, ptr %i.o, align 4, !tbaa !11, !alias.scope !49
  %i.w = shufflevector <2 x float> %i.n, <2 x float> %i.v, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  %5 = shufflevector <2 x float> %wide.load, <2 x float> %wide.load23, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
