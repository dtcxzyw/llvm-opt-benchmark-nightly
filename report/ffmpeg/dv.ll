...
.preheader:                                       ; preds = %.preheader.lr.ph.split, %._crit_edge
  ...
  %2 = shl nuw nsw i64 %indvars.iv60, 2           ; 2 uses
...
bb.b:                                             ; preds = %.preheader, %bb.h
  ...
  %indvars.iv57.tr = trunc nuw i64 %indvars.iv57 to i32
  %i.bp = shl nuw i32 %indvars.iv57.tr, 1
...
.thread:                                          ; preds = %bb.c, %bb.d, %bb.e
  ...
  %i.ci = add nuw nsw i64 %4, %i.ch               ; 4 uses
  ...
  %i.cq = add nuw nsw i64 %i.cp, %2               ; 2 uses
