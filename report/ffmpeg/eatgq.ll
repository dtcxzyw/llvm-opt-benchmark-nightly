...
.preheader.i:                                     ; preds = %.preheader.i, %bb.i
  ...
  %i.bm = mul nsw i64 %i.bh, %i.ay
  %i.bn = mul nsw i64 %indvars.iv.i, %i.ay
...
.preheader:                                       ; preds = %.preheader.lr.ph, %._crit_edge
  %i.dy = phi i32 [ %i.dh, %.preheader.lr.ph ], [ %i.acd, %._crit_edge ]
  %i.dz = phi i32 [ %.pre, %.preheader.lr.ph ], [ %i.ace, %._crit_edge ] ; 2 uses
...
bb.n:                                             ; preds = %.loopexit.i.i, %bb.m
  %.val63.i.i = phi i32 [ %i.fg, %bb.m ], [ %.sroa.4.3.i, %.loopexit.i.i ] ; 7 uses
  %.05867.i.i = phi i32 [ 1, %bb.m ], [ %.3.i.i, %.loopexit.i.i ] ; 14 uses
  %i.fj = lshr i32 %.val63.i.i, 3
  %i.fk = zext nneg i32 %i.fj to i64
  %i.fl = getelementptr inbounds nuw i8, ptr %i.ek, i64 %i.fk
  %i.fm = load i32, ptr %i.fl, align 1, !tbaa !39
  %i.fn = and i32 %.val63.i.i, 7
  %i.fo = lshr i32 %i.fm, %i.fn
  %i.fp = and i32 %i.fo, 7
  switch i32 %i.fp, label %default.unreachable [
    i32 4, label %bb.o
    i32 0, label %bb.q
    i32 5, label %bb.r
    i32 1, label %bb.r
...
bb.o:                                             ; preds = %bb.n
  %i.fq = icmp eq i32 %.05867.i.i, 63
  br i1 %i.fq, label %tgq_decode_mb.exit.thread, label %bb.p

bb.p:                                             ; preds = %bb.o
  %i.fr = add nsw i32 %.05867.i.i, 1
  %i.fs = sext i32 %.05867.i.i to i64
  %i.ft = getelementptr inbounds i8, ptr @ff_zigzag_direct, i64 %i.fs
  %i.fu = load i8, ptr %i.ft, align 1, !tbaa !39
  %i.fv = zext i8 %i.fu to i64
  %i.fw = getelementptr inbounds nuw [2 x i8], ptr %i.ew, i64 %i.fv
  store i16 0, ptr %i.fw, align 2, !tbaa !44
  br label %bb.q

bb.q:                                             ; preds = %bb.p, %bb.n
  %.1.i.i = phi i32 [ %i.fr, %bb.p ], [ %.05867.i.i, %bb.n ] ; 2 uses
  %i.fx = add nsw i32 %.1.i.i, 1
  %i.fy = sext i32 %.1.i.i to i64
  %i.fz = getelementptr inbounds i8, ptr @ff_zigzag_direct, i64 %i.fy
end_hunk_0
