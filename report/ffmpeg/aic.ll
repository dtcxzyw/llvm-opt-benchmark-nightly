...
begin_hunk_0_@aic_decode_frame:bb.a
  ...
  %i.ek = load i32, ptr %i.bm, align 16, !tbaa !70 ; 2 uses
...
bb.n:                                             ; preds = %.loopexit80
  ...
  br i1 %i.ew, label %bytestream2_get_le16.exit.thread, label %bytestream2_get_le16.exit, !llvm.loop !47
...
bytestream2_get_le16.exit:                        ; preds = %.lr.ph, %bb.n
  ...
  %i.ez = load i16, ptr %.sroa.0.1105242, align 1, !tbaa !34 ; 2 uses
...
bb.q:                                             ; preds = %bb.p, %bb.o
  ...
  %i.fo = load ptr, ptr %i.bp, align 8, !tbaa !42
  store ptr %i.fo, ptr %i.a, align 8, !tbaa !42
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #8
  %i.fp = load ptr, ptr %i.bq, align 16, !tbaa !42
  store ptr %i.fp, ptr %i.b, align 8, !tbaa !42
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c) #8
  %i.fq = load ptr, ptr %i.br, align 8, !tbaa !42
  store ptr %i.fq, ptr %i.c, align 8, !tbaa !42
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d) #8
  %i.fr = load ptr, ptr %i.bs, align 16, !tbaa !42
  store ptr %i.fr, ptr %i.d, align 8, !tbaa !42
  %i.fs = load ptr, ptr %i.k, align 8, !tbaa !64  ; 6 uses
  %i.ft = getelementptr inbounds nuw i8, ptr %i.fs, i64 64
  %i.fu = load i32, ptr %i.ft, align 8, !tbaa !36 ; 5 uses
  br i1 %i.fn, label %bb.r, label %bb.s

bb.r:                                             ; preds = %bb.q
  %i.fv = load ptr, ptr %i.f, align 16, !tbaa !33
  %i.fw = getelementptr inbounds nuw i8, ptr %i.fv, i64 116
  %i.fx = load i32, ptr %i.fw, align 4, !tbaa !67 ; 2 uses
...
bb.s:                                             ; preds = %bb.q, %bb.r
  ...
  %i.gr = load i32, ptr %i.gq, align 8, !tbaa !36
...
bb.u:                                             ; preds = %bb.t
  ...
  %i.hy = load i8, ptr %i.hx, align 1, !tbaa !34
  %spec.select.i.i.i = add nsw i32 %.sroa.4.0136.i, 1 ; 2 uses
  ...
  %spec.select.i87.i.i = add nsw i32 %.sroa.4.0136.i, 2 ; 2 uses
  ...
  %i.in = load i32, ptr %i.im, align 1, !tbaa !34
  ...
  %i.is = add nsw i32 %.sroa.4.0136.i, 5          ; 2 uses
...
.split.loop.exit353:                              ; preds = %bb.w, %bb.x, %.split.loop.exit
  ...
  store i16 %i.jt, ptr %i.jx, align 2, !tbaa !41
  ...
  br i1 %exitcond174.not.i.i, label %._crit_edge.split.us.us.split.us.us.i.i, label %bb.v, !llvm.loop !48
...
._crit_edge.split.us.us.split.us.us.i.i:          ; preds = %.split.loop.exit353
  ...
  br i1 %exitcond175.not.i.i, label %.loopexit.i, label %.preheader.us.us.i.i, !llvm.loop !49
...
bb.ab:                                            ; preds = %bb.ae, %bb.aa
  ...
  %i.ke = load i8, ptr %i.kd, align 1, !tbaa !34
...
bb.af:                                            ; preds = %get_ue_golomb.exit119.loopexit.us.us.i.i
  ...
  store i16 %i.ky, ptr %i.lc, align 2, !tbaa !41
  ...
  br i1 %exitcond168.not.i.i, label %._crit_edge.split.us.us.split.i.i, label %bb.aa, !llvm.loop !48
...
get_ue_golomb.exit119.loopexit.us.us.i.i:         ; preds = %bb.ab, %bb.ac, %get_ue_golomb.exit119.loopexit.us.us.i.i.split.loop.exit
  ...
  %i.lh = load i32, ptr %i.lg, align 1, !tbaa !34
...
._crit_edge.split.us.us.split.i.i:                ; preds = %bb.af
  ...
  br i1 %exitcond169.not.i.i, label %.loopexit.i, label %.preheader.us.i.i, !llvm.loop !49
