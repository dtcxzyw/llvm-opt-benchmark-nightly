...
begin_hunk_0_@ac3_decode_frame:bb.a
  %.pre829 = load i32, ptr %i.ci, align 4, !tbaa !207
  %.not593.i = icmp eq i32 %.pre829, 0
  %i.byw = zext nneg i32 %i.byt to i64
  br label %bb.gt

.preheader764.i:                                  ; preds = %bb.gx, %.loopexit765.i
  br i1 %.not520795.i, label %._crit_edge.i479, label %.lr.ph812.i

.lr.ph812.i:                                      ; preds = %.preheader764.i
  %i.byx = getelementptr inbounds nuw [28 x i8], ptr %i.ed, i64 %indvars.iv798
  %i.byy = add nuw i32 %i.aqo, 1
  %wide.trip.count914.i = zext i32 %i.byy to i64
  br label %bb.gy

bb.gt:                                            ; preds = %bb.gx, %.lr.ph809.i
  %indvars.iv908.i = phi i64 [ %i.byv, %.lr.ph809.i ], [ %indvars.iv.next909.i, %bb.gx ] ; 6 uses
  br i1 %.not593.i, label %bb.gu, label %._crit_edge977.i

._crit_edge977.i:                                 ; preds = %bb.gt
  %.phi.trans.insert.i = getelementptr inbounds nuw [4 x i8], ptr %i.byu, i64 %indvars.iv908.i
  %.pre978.i = load i32, ptr %.phi.trans.insert.i, align 4, !tbaa !43
  br label %bb.gv

bb.gu:                                            ; preds = %bb.gt
  %i.byz = load i32, ptr %i.bj, align 4, !tbaa !185
  %i.bza = zext i32 %i.byz to i64
  %i.bzb = icmp eq i64 %indvars.iv908.i, %i.bza
  %i.bzc = select i1 %i.bzb, i32 1, i32 2         ; 2 uses
  %i.bzd = load i32, ptr %i.ao, align 8, !tbaa !50 ; 3 uses
  %i.bze = load i32, ptr %i.an, align 16, !tbaa !49
  %i.bzf = load ptr, ptr %i.al, align 16, !tbaa !48
  %i.bzg = lshr i32 %i.bzd, 3
  %i.bzh = zext nneg i32 %i.bzg to i64
  %i.bzi = getelementptr inbounds nuw i8, ptr %i.bzf, i64 %i.bzh
  %i.bzj = load i32, ptr %i.bzi, align 1, !tbaa !44
  ...
  store i32 %i.bzq, ptr %i.ao, align 8, !tbaa !50
  %i.bzr = getelementptr inbounds nuw [4 x i8], ptr %i.byu, i64 %indvars.iv908.i
  store i32 %i.bzo, ptr %i.bzr, align 4, !tbaa !43
  br label %bb.gv

bb.gv:                                            ; preds = %bb.gu, %._crit_edge977.i
  %i.bzs = phi i32 [ %.pre978.i, %._crit_edge977.i ], [ %i.bzo, %bb.gu ]
  %.not594.i = icmp eq i32 %i.bzs, 0
  br i1 %.not594.i, label %bb.gx, label %bb.gw

bb.gw:                                            ; preds = %bb.gv
  %i.bzt = getelementptr inbounds nuw i8, ptr %i.e, i64 %indvars.iv908.i
  store i8 3, ptr %i.bzt, align 1, !tbaa !44
  br label %bb.gx

bb.gx:                                            ; preds = %bb.gw, %bb.gv
  %indvars.iv.next909.i = add nuw nsw i64 %indvars.iv908.i, 1
  %.not542.not.i = icmp samesign ult i64 %indvars.iv908.i, %i.byw
  br i1 %.not542.not.i, label %bb.gt, label %.preheader764.i, !llvm.loop !103

bb.gy:                                            ; preds = %bb.hh, %.lr.ph812.i
  %indvars.iv911.i = phi i64 [ 1, %.lr.ph812.i ], [ %indvars.iv.next912.i, %bb.hh ] ; 7 uses
  %i.bzu = getelementptr inbounds nuw [4 x i8], ptr %i.ce, i64 %indvars.iv911.i
  store i32 0, ptr %i.bzu, align 4, !tbaa !43
  %i.bzv = getelementptr inbounds nuw [4 x i8], ptr %i.byx, i64 %indvars.iv911.i
  %i.bzw = load i32, ptr %i.bzv, align 4, !tbaa !43 ; 2 uses
  %.not589.i = icmp eq i32 %i.bzw, 0
  br i1 %.not589.i, label %bb.hh, label %bb.gz

bb.gz:                                            ; preds = %bb.gy
  %i.bzx = getelementptr inbounds nuw [4 x i8], ptr %i.cf, i64 %indvars.iv911.i ; 2 uses
  %i.bzy = load i32, ptr %i.bzx, align 4, !tbaa !43
  %i.bzz = getelementptr inbounds nuw [4 x i8], ptr %i.ch, i64 %indvars.iv911.i
  %i.caa = load i32, ptr %i.bzz, align 4, !tbaa !43
  %.not590.i = icmp eq i32 %i.caa, 0
  br i1 %.not590.i, label %bb.hb, label %bb.ha

bb.ha:                                            ; preds = %bb.gz
  %i.cab = load i32, ptr %i.ce, align 4, !tbaa !43
  br label %bb.hf

bb.hb:                                            ; preds = %bb.gz
  %i.cac = getelementptr inbounds nuw i8, ptr %i.fs, i64 %indvars.iv911.i
  %i.cad = load i8, ptr %i.cac, align 1, !tbaa !44
  %.not591.i = icmp eq i8 %i.cad, 0
  br i1 %.not591.i, label %bb.hd, label %bb.hc

bb.hc:                                            ; preds = %bb.hb
  %i.cae = load i32, ptr %i.fw, align 4, !tbaa !254
  br label %bb.hf

bb.hd:                                            ; preds = %bb.hb
  %i.caf = load i32, ptr %i.ao, align 8, !tbaa !50 ; 3 uses
  %i.cag = load i32, ptr %i.an, align 16, !tbaa !49
  %i.cah = load ptr, ptr %i.al, align 16, !tbaa !48
  %i.cai = lshr i32 %i.caf, 3
  %i.caj = zext nneg i32 %i.cai to i64
  %i.cak = getelementptr inbounds nuw i8, ptr %i.cah, i64 %i.caj
  %i.cal = load i32, ptr %i.cak, align 1, !tbaa !44
  ...
  store i32 %i.car, ptr %i.ao, align 8, !tbaa !50
  %i.cas = icmp ult i32 %i.cao, -201326592
  br i1 %i.cas, label %.thread737.i, label %bb.he

.thread737.i:                                     ; preds = %bb.hd
  %i.cat = mul nuw nsw i32 %i.cap, 3
  %i.cau = add nuw nsw i32 %i.cat, 73
  br label %bb.hf

bb.he:                                            ; preds = %bb.hd
  %i.cav = load ptr, ptr %i.ck, align 8, !tbaa !40
  call void (ptr, i32, ptr, ...) @av_log(ptr noundef %i.cav, i32 noundef 16, ptr noundef nonnull @.str.38, i32 noundef %i.cap) #11
  br label %bb.mx

bb.hf:                                            ; preds = %.thread737.i, %bb.hc, %bb.ha
  %.sink1045 = phi i32 [ %i.cau, %.thread737.i ], [ %i.cae, %bb.hc ], [ %i.cab, %bb.ha ] ; 3 uses
  store i32 %.sink1045, ptr %i.bzx, align 4, !tbaa !43
  %i.caw = add nsw i32 %i.bzw, -1
  %i.cax = shl i32 3, %i.caw                      ; 2 uses
  %i.cay = add i32 %i.cax, -4
  %i.caz = add i32 %i.cay, %.sink1045
  %i.cba = sdiv i32 %i.caz, %i.cax
  %i.cbb = getelementptr inbounds nuw [4 x i8], ptr %i.cg, i64 %indvars.iv911.i
  store i32 %i.cba, ptr %i.cbb, align 4, !tbaa !43
  %.not592.i = icmp eq i32 %.sink1045, %i.bzy
  %or.cond748.i = select i1 %i.atj, i1 true, i1 %.not592.i
  br i1 %or.cond748.i, label %bb.hh, label %bb.hg
...
bb.hh:                                            ; preds = %bb.hg, %bb.hf, %bb.gy
  ...
  br i1 %exitcond915.not.i, label %._crit_edge.i479, label %bb.gy, !llvm.loop !104

._crit_edge.i479:                                 ; preds = %bb.hh, %.preheader764.i
  br i1 %.not539.i, label %bb.hk, label %bb.hi

bb.hi:                                            ; preds = %._crit_edge.i479
  %i.cbc = getelementptr inbounds nuw [28 x i8], ptr %i.ed, i64 %indvars.iv798
  %i.cbd = load i32, ptr %i.cbc, align 4, !tbaa !43 ; 2 uses
  %.not544.i = icmp eq i32 %i.cbd, 0
  br i1 %.not544.i, label %bb.hk, label %bb.hj

bb.hj:                                            ; preds = %bb.hi
  %i.cbe = load i32, ptr %i.cf, align 16, !tbaa !43
...
bb.hk:                                            ; preds = %bb.hj, %bb.hi, %._crit_edge.i479
  br i1 %.not542807.i, label %._crit_edge817.i, label %.lr.ph816.i

.lr.ph816.i:                                      ; preds = %bb.hk
  %i.cbk = getelementptr inbounds nuw [28 x i8], ptr %i.ed, i64 %indvars.iv798
  %i.cbl = zext i1 %.not539.i to i64
  br label %bb.hl

bb.hl:                                            ; preds = %bb.hx, %.lr.ph816.i
  %indvars.iv916.i = phi i64 [ %i.cbl, %.lr.ph816.i ], [ %indvars.iv.next917.i, %bb.hx ] ; 8 uses
  %i.cbm = getelementptr inbounds nuw [4 x i8], ptr %i.cbk, i64 %indvars.iv916.i ; 2 uses
...
bb.hm:                                            ; preds = %bb.hl
  ...
  %i.ccb = icmp ne i64 %indvars.iv916.i, 0        ; 3 uses
  ...
  %i.ccg = getelementptr inbounds nuw [256 x i8], ptr %i.gm, i64 %indvars.iv916.i ; 2 uses
  store i8 %i.ccf, ptr %i.ccg, align 16, !tbaa !44
  %i.cch = load i32, ptr %i.cbm, align 4, !tbaa !43 ; 2 uses
  %i.cci = getelementptr inbounds nuw [4 x i8], ptr %i.cg, i64 %indvars.iv916.i
  %i.ccj = load i32, ptr %i.cci, align 4, !tbaa !43 ; 3 uses
  %i.cck = getelementptr inbounds nuw [4 x i8], ptr %i.ce, i64 %indvars.iv916.i
...
._crit_edge64.i.i:                                ; preds = %bb.hq
  %.pre.i652.i = trunc nuw nsw i32 %i.cds to i8
  br label %bb.hs

._crit_edge63.i.i:                                ; preds = %bb.hq
  %.pre65.i651.i = trunc nuw nsw i32 %i.cds to i8
  br label %bb.ht
...
bb.hs:                                            ; preds = %bb.hr, %._crit_edge64.i.i
  %.pre-phi.i.i = phi i8 [ %.pre.i652.i, %._crit_edge64.i.i ], [ %i.cdv, %bb.hr ] ; 2 uses
  %.1.i653.i = phi i32 [ %.03851.i.i, %._crit_edge64.i.i ], [ %i.cdy, %bb.hr ] ; 2 uses
  %i.cea = add nsw i32 %.1.i653.i, 1
  %i.ceb = sext i32 %.1.i653.i to i64
...
bb.ht:                                            ; preds = %bb.hs, %._crit_edge63.i.i
  %.pre-phi66.i.i = phi i8 [ %.pre65.i651.i, %._crit_edge63.i.i ], [ %.pre-phi.i.i, %bb.hs ]
...
bb.hv:                                            ; preds = %.loopexit763.i
  ...
  %.not588.i = icmp eq i64 %indvars.iv916.i, %i.ceh
...
bb.hx:                                            ; preds = %bb.hw, %bb.hv, %.loopexit763.i, %bb.hl
  ...
  %.not545.not.i = icmp slt i64 %indvars.iv916.i, %i.cen
  br i1 %.not545.not.i, label %bb.hl, label %._crit_edge817.i, !llvm.loop !107

._crit_edge817.i:                                 ; preds = %bb.hx, %bb.hk
...
bb.hz:                                            ; preds = %bb.hy
  ...
  %.not549819.i = icmp slt i32 %i.ceo, %i.bys
  br i1 %.not549819.i, label %.loopexit762.i, label %iter.check

iter.check:                                       ; preds = %bb.hz
  %i.chy = zext i1 %.not539.i to i64              ; 4 uses
  %i.chz = add nuw i32 %i.ceo, 1
  %wide.trip.count922.i = zext i32 %i.chz to i64  ; 2 uses
  %i.cia = sub nsw i64 %wide.trip.count922.i, %i.chy ; 7 uses
  %min.iters.check1166 = icmp ult i64 %i.cia, 8
  br i1 %min.iters.check1166, label %.lr.ph822.i.preheader, label %vector.main.loop.iter.check

vector.main.loop.iter.check:                      ; preds = %iter.check
  %min.iters.check1167 = icmp ult i64 %i.cia, 32
  br i1 %min.iters.check1167, label %vec.epilog.ph, label %vector.ph1168

vector.ph1168:                                    ; preds = %vector.main.loop.iter.check
  %i.cib = and i64 %i.cia, 24
  %n.vec1169 = and i64 %i.cia, -32                ; 4 uses
  %i.cic = or disjoint i64 %n.vec1169, %i.chy
...
vector.body1170:                                  ; preds = %vector.body1170, %vector.ph1168
  %index1171 = phi i64 [ 0, %vector.ph1168 ], [ %index.next1174, %vector.body1170 ] ; 2 uses
  %i.cid = getelementptr inbounds nuw i8, ptr %i.e, i64 %index1171 ; 2 uses
  ...
  %wide.load1172 = load <16 x i8>, ptr %.sroa.sel, align 1, !tbaa !44
end_hunk_0
