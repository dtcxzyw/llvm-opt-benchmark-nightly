...
.preheader.lr.ph:                                 ; preds = %bb.d
  ...
  %4 = load <3 x i32>, ptr %i.u, align 8, !tbaa !35
  %5 = shufflevector <3 x i32> %4, <3 x i32> poison, <4 x i32> <i32 2, i32 1, i32 2, i32 0>
  %i.v = ashr <4 x i32> %5, splat (i32 1)         ; 7 uses
  %6 = shl i32 %i.f, 1                            ; 3 uses
  %i.w = extractelement <4 x i32> %i.v, i64 3
  %i.x = sext i32 %i.w to i64                     ; 2 uses
  %i.y = extractelement <4 x i32> %i.v, i64 1
  %i.z = sext i32 %i.y to i64                     ; 2 uses
  %i.aa = extractelement <4 x i32> %i.v, i64 0
  %i.ab = sext i32 %i.aa to i64                   ; 2 uses
  %i.ac = sext i32 %6 to i64                      ; 2 uses
...
.preheader.preheader:                             ; preds = %.preheader.lr.ph
  ...
  %8 = shufflevector <4 x i32> %i.v, <4 x i32> %7, <4 x i32> <i32 1, i32 4, i32 3, i32 4>
  %9 = shufflevector <4 x i32> %i.v, <4 x i32> poison, <2 x i32> <i32 poison, i32 3>
  %10 = insertelement <2 x i32> %9, i32 %6, i64 0
  %11 = shufflevector <4 x i32> %i.v, <4 x i32> poison, <2 x i32> <i32 0, i32 1>
  %min.iters.check = icmp ult i32 %i.s, 16
  %bound0 = icmp ult ptr %i.af, %scevgep73
  %bound1 = icmp ult ptr %i.ad, %scevgep
  %found.conflict = and i1 %bound0, %bound1
  %bound077 = icmp ult ptr %i.af, %scevgep74
  %bound178.a = icmp ult ptr %i.ah, %scevgep
  %found.conflict79 = and i1 %bound077, %bound178.a
  %12 = or <4 x i32> %i.v, %8
  ...
  %bound094 = icmp ult ptr %i.ad, %scevgep75
  %bound195.a = icmp ult ptr %i.b, %scevgep73
  %found.conflict96 = and i1 %bound094, %bound195.a
  ...
  %14 = or <2 x i32> %10, %11
  %15 = icmp slt <2 x i32> %14, zeroinitializer   ; 2 uses
  %16 = bitcast <4 x i1> %13 to i4
  %17 = icmp ne i4 %16, 0
  %18 = extractelement <2 x i1> %15, i64 1
  %op.rdx = or i1 %17, %18
  %19 = extractelement <2 x i1> %15, i64 0
  %op.rdx106 = or i1 %19, %found.conflict
  %op.rdx107 = or i1 %found.conflict79, %found.conflict84
  %op.rdx108 = or i1 %found.conflict90, %found.conflict96
  %op.rdx109 = or i1 %op.rdx, %op.rdx106
  %op.rdx110 = or i1 %op.rdx107, %op.rdx108
