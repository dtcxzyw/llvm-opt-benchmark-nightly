...
calculate_lanczos_coeffs.exit24:                  ; preds = %bb.n, %bb.o
  ...
  %6 = fadd nsz float %i.m, %i.aa
  %7 = fadd nsz float %i.bo, %i.cc
  ...
  %8 = fadd nsz float %7, %i.cq
  %9 = fadd nsz float %6, %i.ao
  %10 = fadd nsz float %8, %.sink30.i23
  %11 = fadd nsz float %9, %.sink30.i
  %12 = insertelement <4 x float> poison, float %i.m, i64 0
  %i.gd = insertelement <4 x float> %12, float %i.aa, i64 1
  %i.ge = insertelement <4 x float> %i.gd, float %i.ao, i64 2
  %i.gf = insertelement <4 x float> %i.ge, float %.sink30.i, i64 3 ; 2 uses
  %i.gg = insertelement <4 x float> poison, float %11, i64 0
  %i.gh = shufflevector <4 x float> %i.gf, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %i.gi = shufflevector <4 x float> %i.gf, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  ...
  %i.gk = shufflevector <4 x float> %i.gg, <4 x float> poison, <16 x i32> zeroinitializer
  %i.gl = fdiv nsz <16 x float> %i.gj, %i.gk
  %i.gm = insertelement <4 x float> poison, float %i.bo, i64 0
  %13 = insertelement <4 x float> %i.gm, float %i.cc, i64 1
  %i.gn = insertelement <4 x float> %13, float %i.cq, i64 2
  %i.go = insertelement <4 x float> %i.gn, float %.sink30.i23, i64 3
  %i.gp = insertelement <4 x float> poison, float %10, i64 0
  %14 = shufflevector <4 x float> %i.gp, <4 x float> poison, <4 x i32> zeroinitializer
  %i.gq = fdiv nsz <4 x float> %i.go, %14
...
calculate_gaussian_coeffs.exit24:                 ; preds = %bb.n, %bb.o
  ...
  %6 = fadd nsz float %i.k, %i.u
  %7 = fadd nsz float %i.ba, %i.bk
  ...
  %8 = fadd nsz float %7, %i.bv
  %9 = fadd nsz float %6, %i.af
  %10 = fadd nsz float %8, %.sink30.i23
  %11 = fadd nsz float %9, %.sink30.i
  %12 = insertelement <4 x float> poison, float %i.k, i64 0
  %i.ff = insertelement <4 x float> %12, float %i.u, i64 1
  %i.fg = insertelement <4 x float> %i.ff, float %i.af, i64 2
  %i.fh = insertelement <4 x float> %i.fg, float %.sink30.i, i64 3 ; 2 uses
  %i.fi = insertelement <4 x float> poison, float %11, i64 0
  %i.fj = shufflevector <4 x float> %i.fh, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %i.fk = shufflevector <4 x float> %i.fh, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  ...
  %i.fm = shufflevector <4 x float> %i.fi, <4 x float> poison, <16 x i32> zeroinitializer
  %i.fn = fdiv nsz <16 x float> %i.fl, %i.fm
  %i.fo = insertelement <4 x float> poison, float %i.ba, i64 0
  %13 = insertelement <4 x float> %i.fo, float %i.bk, i64 1
  %i.fp = insertelement <4 x float> %13, float %i.bv, i64 2
  %i.fq = insertelement <4 x float> %i.fp, float %.sink30.i23, i64 3
  %i.fr = insertelement <4 x float> poison, float %10, i64 0
  %14 = shufflevector <4 x float> %i.fr, <4 x float> poison, <4 x i32> zeroinitializer
  %i.fs = fdiv nsz <4 x float> %i.fq, %14
