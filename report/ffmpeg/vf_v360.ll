...
._crit_edge123.split:                             ; preds = %._crit_edge123.split.loopexit, %.preheader.lr.ph, %bb.b
  ...
  br i1 %i.cj, label %bb.b, label %._crit_edge126, !llvm.loop !160
...
._crit_edge:                                      ; preds = %bb.t
  ...
  br i1 %exitcond131.not, label %._crit_edge123.split.loopexit, label %.preheader, !llvm.loop !161
...
bb.o:                                             ; preds = %bb.n, %bb.m
  ...
  %i.hk = load i32, ptr %i.ap, align 8, !tbaa !163
  %i.hl = load i32, ptr %i.aq, align 4, !tbaa !164
