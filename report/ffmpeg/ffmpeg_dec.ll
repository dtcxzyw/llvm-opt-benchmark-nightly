...
bb.a:
  %i.a = load ptr, ptr %0, align 8, !tbaa !11     ; 13 uses
...
bb.g:                                             ; preds = %bb.f
  %i.g = load i32, ptr %1, align 4, !tbaa !27     ; 2 uses
  %.not67 = icmp eq i32 %i.g, 0
  br i1 %.not67, label %bb.h, label %bb.i

bb.h:                                             ; preds = %bb.g, %bb.f
  store i32 1, ptr %.sroa.0, align 8, !tbaa !27
...
bb.j:                                             ; preds = %.lr.ph.split.us
  ...
  br i1 %exitcond89.not, label %.critedge71, label %.lr.ph.split.us, !llvm.loop !102
...
bb.l:                                             ; preds = %bb.k, %.lr.ph.split
  ...
  br i1 %exitcond.not, label %.critedge71, label %.lr.ph.split, !llvm.loop !102
...
bb.q:                                             ; preds = %._crit_edge, %bb.o
  ...
  store i32 %.056, ptr %i.av, align 4, !tbaa !103
...
bb.b:                                             ; preds = %bb.a
  %i.f = load ptr, ptr %i.a, align 8, !tbaa !40   ; 5 uses
  %i.g = load ptr, ptr %2, align 8, !tbaa !41
