...
.preheader103.lr.ph.i:                            ; preds = %.preheader104.i
  ...
  %i.ai = shl nuw nsw i32 %i.z, 4                 ; 8 uses
...
.preheader102.us.us.i:                            ; preds = %.preheader102.us.us.i.preheader, %.preheader102.us.us.i
  ...
  %2 = zext i8 %i.gx to i32
  %3 = zext i8 %i.gs to i32
  %4 = sub nsw i32 %2, %i.ai
  %5 = sub nsw i32 %3, %i.ai
  %6 = trunc nsw i32 %5 to i16
  %7 = insertelement <2 x i16> poison, i16 %6, i64 0
  %8 = trunc nsw i32 %4 to i16
  %9 = insertelement <2 x i16> %7, i16 %8, i64 1
  %i.iu = sitofp <2 x i16> %9 to <2 x float>
