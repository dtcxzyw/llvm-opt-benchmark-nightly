...
vector.body240:                                   ; preds = %vector.body240, %vector.ph238
  ...
  %i.hf = mul nsw <4 x i32> %i.he, splat (i32 341)
  %i.hg = sdiv <4 x i32> %i.hf, splat (i32 292)
  ...
  %i.hr = mul nsw <4 x i32> %i.hq, splat (i32 341)
  %i.hs = sdiv <4 x i32> %i.hr, splat (i32 292)
  ...
  %i.ib = mul nsw <4 x i32> %i.ia, splat (i32 341)
  %i.ic = sdiv <4 x i32> %i.ib, splat (i32 292)
  ...
  %i.il = mul nsw <4 x i32> %i.ik, splat (i32 341)
  %i.im = sdiv <4 x i32> %i.il, splat (i32 292)
  ...
  %i.iw = mul nsw <4 x i32> %i.iv, splat (i32 341)
  %i.ix = sdiv <4 x i32> %i.iw, splat (i32 292)
  ...
  %i.jj = mul nsw <4 x i32> %i.ji, splat (i32 341)
  %i.jk = sdiv <4 x i32> %i.jj, splat (i32 292)
  ...
  %i.js = mul nsw <4 x i32> %i.jr, splat (i32 341)
  %i.jt = sdiv <4 x i32> %i.js, splat (i32 292)
  ...
  %i.kc = mul nsw <4 x i32> %i.kb, splat (i32 341)
  %i.kd = sdiv <4 x i32> %i.kc, splat (i32 292)
...
.preheader.us.us.i:                               ; preds = %.preheader.us.us.i.preheader, %.preheader.us.us.i
  ...
  %i.lq = mul nsw <2 x i32> %i.lp, splat (i32 341)
  %i.lr = sdiv <2 x i32> %i.lq, splat (i32 292)
  ...
  %i.me = mul nsw <2 x i32> %i.md, splat (i32 341)
  %i.mf = sdiv <2 x i32> %i.me, splat (i32 292)
  ...
  %i.mq = mul nsw <2 x i32> %i.mp, splat (i32 341)
  %i.mr = sdiv <2 x i32> %i.mq, splat (i32 292)
  ...
  %i.nf = mul nsw <2 x i32> %i.ne, splat (i32 341)
  %i.ng = sdiv <2 x i32> %i.nf, splat (i32 292)
...
vector.body330:                                   ; preds = %.preheader.us.us.i52, %vector.body330
  ...
  %i.yo = mul nsw <4 x i32> %i.yn, splat (i32 341)
  %i.yp = sdiv <4 x i32> %i.yo, splat (i32 292)   ; 2 uses
...
scalar.ph326:                                     ; preds = %scalar.ph326.preheader, %scalar.ph326
  ...
  %i.zg = mul nsw i32 %i.zf, 341
  %i.zh = sdiv i32 %i.zg, 292                     ; 2 uses
...
vector.body312:                                   ; preds = %.preheader.us.i, %vector.body312
  ...
  %i.aaa = mul nsw <4 x i32> %i.zz, splat (i32 341)
  %i.aab = sdiv <4 x i32> %i.aaa, splat (i32 292)
...
scalar.ph308:                                     ; preds = %scalar.ph308.preheader, %scalar.ph308
  ...
  %i.aao = mul nsw i32 %i.aan, 341
  %i.aap = sdiv i32 %i.aao, 292
