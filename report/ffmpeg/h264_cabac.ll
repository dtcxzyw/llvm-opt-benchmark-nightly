...
.preheader1517:                                   ; preds = %.preheader1517.lr.ph, %bb.el
  ...
  %i.bhk = shl nuw i32 %indvars.iv1672.tr, 1
...
bb.fx:                                            ; preds = %.lr.ph, %bb.gb
  ...
  %i.bxi = shl nuw nsw i32 %indvars.iv.tr, 1
...
bb.gc:                                            ; preds = %.lr.ph1558, %bb.gr
  ...
  %i.byf = shl nuw nsw i32 %indvars.iv1630.tr, 1
...
bb.kz:                                            ; preds = %bb.ky, %decode_cabac_residual_nondc.exit1082
  ...
  %indvars.iv1692.tr = trunc nuw nsw i64 %indvars.iv1692 to i32
  %i.drf = shl nuw nsw i32 %indvars.iv1692.tr, 4
...
bb.lg:                                            ; preds = %bb.lf
  ...
  %indvars.iv1700.tr = trunc nuw nsw i64 %indvars.iv1700 to i32
  %i.dum = shl nuw nsw i32 %indvars.iv1700.tr, 6
...
bb.lk:                                            ; preds = %bb.lj, %decode_cabac_residual_nondc.exit
  ...
  %.tr1856 = trunc nuw nsw i64 %i.dxt to i32
  %i.dxu = shl nuw nsw i32 %.tr1856, 4
...
bb.lt:                                            ; preds = %bb.ls, %decode_cabac_residual_nondc.exit1088
  ...
  %.tr1860 = trunc nuw nsw i64 %i.ebv to i32
  %i.ebw = shl nuw nsw i32 %.tr1860, 4
...
bb.ma:                                            ; preds = %bb.lz
  ...
  %.tr1861 = trunc nuw nsw i64 %i.efc to i32
  %i.efd = shl nuw nsw i32 %.tr1861, 4
...
bb.me:                                            ; preds = %bb.md, %decode_cabac_residual_nondc.exit1084
  ...
  %.tr1862 = trunc nuw nsw i64 %i.eig to i32
  %i.eih = shl nuw nsw i32 %.tr1862, 4
...
bb.mm:                                            ; preds = %bb.ml, %decode_cabac_residual_nondc.exit1094
  ...
  %.tr1863 = trunc nuw nsw i64 %i.emf to i32
  %i.emg = shl nuw nsw i32 %.tr1863, 4
...
bb.mt:                                            ; preds = %bb.ms
  ...
  %.tr1864 = trunc nuw nsw i64 %i.epm to i32
  %i.epn = shl nuw nsw i32 %.tr1864, 4
...
bb.mx:                                            ; preds = %bb.mw, %decode_cabac_residual_nondc.exit1090
  ...
  %.tr1865 = trunc nuw nsw i64 %i.esq to i32
  %i.esr = shl nuw nsw i32 %.tr1865, 4
...
bb.nz:                                            ; preds = %decode_cabac_residual_nondc.exit1096.1, %.loopexit
  ...
  %.tr1869 = trunc nuw nsw i64 %i.fss to i32
  %i.fst = shl nuw nsw i32 %.tr1869, 4
...
bb.oc:                                            ; preds = %.preheader, %decode_cabac_residual_nondc.exit1096
  ...
  %.tr1868 = trunc nuw nsw i64 %i.fvk to i32
  %i.fvl = shl nuw nsw i32 %.tr1868, 4
...
begin_hunk_4_@fill_decode_caches:bb.a
  %i.kt = getelementptr inbounds nuw i8, ptr %i.ia, i64 %i.ks
...
bb.bc:                                            ; preds = %.lr.ph, %.critedge663
  ...
  %indvars.iv.tr = trunc nuw nsw i64 %indvars.iv to i32
  %i.pi = shl nuw nsw i32 %indvars.iv.tr, 1
