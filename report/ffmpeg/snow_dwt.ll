...
vector.memcheck70:                                ; preds = %.lr.ph35.preheader
  %i.ct = shl nuw nsw i64 %wide.trip.count48, 2   ; 2 uses
  %i.cu = getelementptr i8, ptr %1, i64 %i.ct
  %scevgep71 = getelementptr i8, ptr %i.cu, i64 4 ; 3 uses
  %i.cv = shl nsw i64 %i.e, 2                     ; 2 uses
  %3 = add nsw i64 %i.cv, %i.ct                   ; 2 uses
  %scevgep72.a = getelementptr i8, ptr %1, i64 %3
  %i.cw = getelementptr i8, ptr %1, i64 %i.cv
  %scevgep73 = getelementptr i8, ptr %i.cw, i64 4
  %i.cx = getelementptr i8, ptr %1, i64 %3
