...
.preheader136.us:                                 ; preds = %.preheader136.us.preheader, %._crit_edge173.split.us.us
  ...
  %.0118193.us = phi ptr [ %i.jz, %._crit_edge173.split.us.us ], [ %i.gh, %.preheader136.us.preheader ]
...
.preheader.us.us:                                 ; preds = %bb.q, %.preheader136.us
  ...
  %.1119171.us.us = phi ptr [ %i.jz, %bb.q ], [ %.0118193.us, %.preheader136.us ] ; 4 uses
...
.epil.preheader:                                  ; preds = %._crit_edge168.us.us.unr-lcssa, %.preheader.us.us
  ...
  %i.in = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %indvars.iv239.epil.init
  %i.io = load i32, ptr %i.in, align 4, !tbaa !35
  %i.ip = sext i32 %i.io to i64
  %i.iq = getelementptr inbounds [4 x i8], ptr %.1119171.us.us, i64 %i.ip
  %i.ir = load i32, ptr %i.iq, align 4, !tbaa !35
  %i.is = xor i32 %i.ir, -2139062144              ; 2 uses
  %i.it = lshr i32 %i.is, 8
  %i.iu = and i32 %i.it, 16711935
  %i.iv = add i32 %i.iu, %.0100165.us.us.epil.init
  %i.iw = and i32 %i.is, 16711935
  %i.ix = add i32 %i.iw, %.0166.us.us.epil.init
  br label %._crit_edge168.us.us

._crit_edge168.us.us:                             ; preds = %._crit_edge168.us.us.unr-lcssa, %.epil.preheader
  %.lcssa316 = phi i32 [ %i.ik, %._crit_edge168.us.us.unr-lcssa ], [ %i.iv, %.epil.preheader ] ; 5 uses
  %.lcssa315 = phi i32 [ %i.im, %._crit_edge168.us.us.unr-lcssa ], [ %i.ix, %.epil.preheader ] ; 5 uses
  %i.iy = and i32 %.lcssa316, -16711936
  %.not130.us.us = icmp eq i32 %i.iy, 0
  br i1 %.not130.us.us, label %bb.o, label %bb.n

bb.n:                                             ; preds = %._crit_edge168.us.us
  %i.iz = lshr i32 %.lcssa316, 15
  %i.ja = and i32 %i.iz, 65537
  %i.jb = add nuw nsw i32 %i.ja, 16711935
  %i.jc = add i32 %.lcssa316, 32512
  %i.jd = sub i32 -2130738945, %.lcssa316
...
bb.o:                                             ; preds = %bb.n, %._crit_edge168.us.us
  %.1101.us.us = phi i32 [ %i.jj, %bb.n ], [ %.lcssa316, %._crit_edge168.us.us ]
  %i.jk = and i32 %.lcssa315, -16711936
  %.not131.us.us = icmp eq i32 %i.jk, 0
  br i1 %.not131.us.us, label %bb.q, label %bb.p

bb.p:                                             ; preds = %bb.o
  %i.jl = lshr i32 %.lcssa315, 15
  %i.jm = and i32 %i.jl, 65537
  %i.jn = add nuw nsw i32 %i.jm, 16711935
  %i.jo = add i32 %.lcssa315, 32512
  %i.jp = sub i32 -2130738945, %.lcssa315
  %i.jq = lshr i32 %i.jp, 15
  %i.jr = and i32 %i.jq, 65537
  %i.js = add nuw nsw i32 %i.jr, 16711935
  %i.jt = or i32 %i.js, %i.jo
  %i.ju = and i32 %i.jn, 16711935
  %i.jv = and i32 %i.ju, %i.jt
  br label %bb.q

bb.q:                                             ; preds = %bb.p, %bb.o
  %.1.us.us = phi i32 [ %i.jv, %bb.p ], [ %.lcssa315, %bb.o ]
  %i.jw = shl nuw i32 %.1101.us.us, 8
  %i.jx = or i32 %.1.us.us, %i.jw
  %i.jy = getelementptr inbounds nuw [4 x i8], ptr %.0120189.us, i64 %indvars.iv245
  store i32 %i.jx, ptr %i.jy, align 4, !tbaa !35
  %indvars.iv.next246 = add nuw nsw i64 %indvars.iv245, 1 ; 2 uses
  %i.jz = getelementptr inbounds nuw i8, ptr %.1119171.us.us, i64 4 ; 2 uses
