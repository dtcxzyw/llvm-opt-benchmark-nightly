...
.preheader136.us:                                 ; preds = %.preheader136.us.preheader, %._crit_edge173.split.us.us
  ...
  %.0118193.us = phi ptr [ %i.kd, %._crit_edge173.split.us.us ], [ %i.gh, %.preheader136.us.preheader ]
...
.preheader.us.us:                                 ; preds = %bb.q, %.preheader136.us
  ...
  %.1119171.us.us = phi ptr [ %i.kd, %bb.q ], [ %.0118193.us, %.preheader136.us ] ; 4 uses
...
.epil.preheader:                                  ; preds = %._crit_edge168.us.us.unr-lcssa, %.preheader.us.us
  ...
  %i.ir = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %indvars.iv239.epil.init
  %i.is = load i32, ptr %i.ir, align 4, !tbaa !35
  %i.it = sext i32 %i.is to i64
  %i.iu = getelementptr inbounds [4 x i8], ptr %.1119171.us.us, i64 %i.it
  %i.iv = load i32, ptr %i.iu, align 4, !tbaa !35
  %i.iw = xor i32 %i.iv, -2139062144              ; 2 uses
  %i.ix = lshr i32 %i.iw, 8
  %i.iy = and i32 %i.ix, 16711935
  %i.iz = add i32 %i.iy, %.0100165.us.us.epil.init
  %i.ja = and i32 %i.iw, 16711935
  %i.jb = add i32 %i.ja, %.0166.us.us.epil.init
  br label %._crit_edge168.us.us

._crit_edge168.us.us:                             ; preds = %._crit_edge168.us.us.unr-lcssa, %.epil.preheader
  %.lcssa316 = phi i32 [ %i.io, %._crit_edge168.us.us.unr-lcssa ], [ %i.iz, %.epil.preheader ] ; 5 uses
  %.lcssa315 = phi i32 [ %i.iq, %._crit_edge168.us.us.unr-lcssa ], [ %i.jb, %.epil.preheader ] ; 5 uses
  %i.jc = and i32 %.lcssa316, -16711936
  %.not130.us.us = icmp eq i32 %i.jc, 0
  br i1 %.not130.us.us, label %bb.o, label %bb.n

bb.n:                                             ; preds = %._crit_edge168.us.us
  %i.jd = lshr i32 %.lcssa316, 15
  %i.je = and i32 %i.jd, 65537
  %i.jf = add nuw nsw i32 %i.je, 16711935
  %i.jg = add i32 %.lcssa316, 32512
  %i.jh = sub i32 -2130738945, %.lcssa316
...
bb.o:                                             ; preds = %bb.n, %._crit_edge168.us.us
  %.1101.us.us = phi i32 [ %i.jn, %bb.n ], [ %.lcssa316, %._crit_edge168.us.us ]
  %i.jo = and i32 %.lcssa315, -16711936
  %.not131.us.us = icmp eq i32 %i.jo, 0
  br i1 %.not131.us.us, label %bb.q, label %bb.p

bb.p:                                             ; preds = %bb.o
  %i.jp = lshr i32 %.lcssa315, 15
  %i.jq = and i32 %i.jp, 65537
  %i.jr = add nuw nsw i32 %i.jq, 16711935
  %i.js = add i32 %.lcssa315, 32512
  %i.jt = sub i32 -2130738945, %.lcssa315
  %i.ju = lshr i32 %i.jt, 15
  %i.jv = and i32 %i.ju, 65537
  %i.jw = add nuw nsw i32 %i.jv, 16711935
  %i.jx = or i32 %i.jw, %i.js
  %i.jy = and i32 %i.jr, 16711935
  %i.jz = and i32 %i.jy, %i.jx
  br label %bb.q

bb.q:                                             ; preds = %bb.p, %bb.o
  %.1.us.us = phi i32 [ %i.jz, %bb.p ], [ %.lcssa315, %bb.o ]
  %i.ka = shl nuw i32 %.1101.us.us, 8
  %i.kb = or i32 %.1.us.us, %i.ka
  %i.kc = getelementptr inbounds nuw [4 x i8], ptr %.0120189.us, i64 %indvars.iv245
  store i32 %i.kb, ptr %i.kc, align 4, !tbaa !35
  %indvars.iv.next246 = add nuw nsw i64 %indvars.iv245, 1 ; 2 uses
  %i.kd = getelementptr inbounds nuw i8, ptr %.1119171.us.us, i64 4 ; 2 uses
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge163.split.us.us
  ...
  %.0109167.us = phi ptr [ %i.jd, %._crit_edge163.split.us.us ], [ %i.ez, %.preheader.us.preheader ]
...
.lr.ph156.us.us:                                  ; preds = %bb.r, %.preheader.us
  ...
  %.1110160.us.us = phi ptr [ %i.jd, %bb.r ], [ %.0109167.us, %.preheader.us ] ; 4 uses
...
.epil.preheader:                                  ; preds = %._crit_edge157.us.us.unr-lcssa, %.lr.ph156.us.us
  ...
  %i.hs = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %indvars.iv190.epil.init
  %i.ht = load i32, ptr %i.hs, align 4, !tbaa !35
  %i.hu = sext i32 %i.ht to i64
  %i.hv = getelementptr inbounds [4 x i8], ptr %.1110160.us.us, i64 %i.hu
  %i.hw = load i32, ptr %i.hv, align 4, !tbaa !35
  %i.hx = xor i32 %i.hw, -2139062144              ; 2 uses
  %i.hy = lshr i32 %i.hx, 8
  %i.hz = and i32 %i.hy, 16711935
  %i.ia = add i32 %i.hz, %.092153.us.us.epil.init
  %i.ib = and i32 %i.hx, 16711935
  %i.ic = add i32 %i.ib, %.0154.us.us.epil.init
  br label %._crit_edge157.us.us

._crit_edge157.us.us:                             ; preds = %._crit_edge157.us.us.unr-lcssa, %.epil.preheader
  %.lcssa260 = phi i32 [ %i.hp, %._crit_edge157.us.us.unr-lcssa ], [ %i.ia, %.epil.preheader ] ; 5 uses
  %.lcssa259 = phi i32 [ %i.hr, %._crit_edge157.us.us.unr-lcssa ], [ %i.ic, %.epil.preheader ] ; 5 uses
  %i.id = and i32 %.lcssa260, -16711936
  %.not123.us.us = icmp eq i32 %i.id, 0
  br i1 %.not123.us.us, label %bb.p, label %bb.o

bb.o:                                             ; preds = %._crit_edge157.us.us
  %i.ie = lshr i32 %.lcssa260, 15
  %i.if = and i32 %i.ie, 65537
  %i.ig = add nuw nsw i32 %i.if, 16711935
  %i.ih = add i32 %.lcssa260, 32512
  %i.ii = sub i32 -2130738945, %.lcssa260
...
bb.p:                                             ; preds = %bb.o, %._crit_edge157.us.us
  %.193.us.us = phi i32 [ %i.io, %bb.o ], [ %.lcssa260, %._crit_edge157.us.us ]
  %i.ip = and i32 %.lcssa259, -16711936
  %.not124.us.us = icmp eq i32 %i.ip, 0
  br i1 %.not124.us.us, label %bb.r, label %bb.q

bb.q:                                             ; preds = %bb.p
  %i.iq = lshr i32 %.lcssa259, 15
  %i.ir = and i32 %i.iq, 65537
  %i.is = add nuw nsw i32 %i.ir, 16711935
  %i.it = add i32 %.lcssa259, 32512
  %i.iu = sub i32 -2130738945, %.lcssa259
  %i.iv = lshr i32 %i.iu, 15
  %i.iw = and i32 %i.iv, 65537
  %i.ix = add nuw nsw i32 %i.iw, 16711935
  %i.iy = or i32 %i.ix, %i.it
  %i.iz = and i32 %i.is, 16711935
  %i.ja = and i32 %i.iz, %i.iy
  br label %bb.r

bb.r:                                             ; preds = %bb.q, %bb.p
  %.1.us.us = phi i32 [ %i.ja, %bb.q ], [ %.lcssa259, %bb.p ]
  %i.jb = shl nuw i32 %.193.us.us, 8
  %i.jc = or i32 %.1.us.us, %i.jb
  store i32 %i.jc, ptr %i.go, align 4, !tbaa !35
  %i.jd = getelementptr inbounds nuw i8, ptr %.1110160.us.us, i64 4 ; 2 uses
