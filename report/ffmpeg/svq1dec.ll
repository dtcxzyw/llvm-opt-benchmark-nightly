...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ha = shl <4 x i32> %vec.ind311, splat (i32 4)
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %i.hl = shl i32 %indvars.iv236.tr, 4
...
vector.body249:                                   ; preds = %vector.body249, %vector.ph241
  ...
  %i.fs = shl <4 x i32> %vec.ind251, splat (i32 4)
...
scalar.ph239:                                     ; preds = %scalar.ph239.preheader, %scalar.ph239
  ...
  %i.gd = shl i32 %indvars.iv186.tr, 4
