...
.preheader936.preheader:                          ; preds = %.preheader936.lr.ph
  ...
  %wide.trip.count = zext i32 %i.cxd to i64       ; 5 uses
  %scevgep = getelementptr i8, ptr %i.cww, i64 %i.cxk
  %i.cxm = add nsw i32 %..12, -1
  %i.cxn = zext i32 %i.cxm to i64
  %i.cxo = mul nsw i64 %i.cxj, %i.cxn
  %9 = add i64 %i.cxo, %wide.trip.count           ; 2 uses
  %scevgep3218 = getelementptr i8, ptr %i.cww, i64 %9
  %i.cxp = sub i64 %9, %i.cxk
