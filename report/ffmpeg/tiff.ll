...
bb.mk:                                            ; preds = %bb.mi, %bb.me
  %.2308.i = phi i32 [ %.0306.i, %bb.me ], [ %i.bbf, %bb.mi ] ; 38 uses
...
bb.po:                                            ; preds = %horizontal_fill.exit363.i
  ...
  %i.cfw = icmp ugt i32 %i.cfv, 8                 ; 3 uses
  %i.cfx = select i1 %i.cfw, i32 %9, i32 %i.byr
  %i.cfy = udiv i32 %i.cfx, %i.cft
...
.thread:                                          ; preds = %bb.l, %bb.m
  ...
  %i.bo = load i32, ptr %i.bn, align 8, !tbaa !29 ; 3 uses
  %i.bp = mul nsw i32 %i.bo, %4                   ; 2 uses
  %i.bq = sdiv i32 %i.bp, 2
  %7 = select i1 %i.an, i32 %i.bq, i32 %i.bp
  %i.br = add nsw i32 %7, %3
  ...
  %i.bx = sdiv i32 %i.bo, 2                       ; 2 uses
  %i.by = getelementptr inbounds nuw i8, ptr %i.ap, i64 64
  %i.bz = load i32, ptr %i.by, align 8, !tbaa !29 ; 2 uses
...
.preheader105.lr.ph:                              ; preds = %.preheader106
  ...
  %i.gt = sext i32 %i.bo to i64
  %i.gu = sext i32 %i.bz to i64
