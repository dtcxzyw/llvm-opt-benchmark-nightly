...
.preheader.i.i.i.epil.preheader:                  ; preds = %deinvert_buffer.exit.i.i.unr-lcssa, %.preheader.i.i.i.preheader
  ...
  %lcmp.mod3719 = trunc i32 %.0721 to i1
...
.lr.ph102.i.i:                                    ; preds = %.preheader91.i.i
  ...
  %invariant.gep3967 = getelementptr i8, ptr %i.bcd, i64 %i.bdt
  %min.iters.check3417 = icmp ult i32 %.2.i, 8
  %n.vec3419 = and i64 %i.bdt, 2147483640         ; 2 uses
  %i.bdw = and i64 %i.bdt, 7
  %cmp.n3429 = icmp eq i64 %n.vec3419, %i.bdt
  br label %bb.nb
...
bb.nb:                                            ; preds = %bb.nf, %.lr.ph102.i.i
  %indvar3409 = phi i64 [ %indvar.next3410, %bb.nf ], [ 0, %.lr.ph102.i.i ] ; 3 uses
  ...
  %i.bdy = mul i64 %indvar3409, %i.bds
  %scevgep3411 = getelementptr i8, ptr %i.bdv, i64 %i.bdy
  %i.bdz = mul i64 %indvar3409, %i.bdm
  %gep3968 = getelementptr i8, ptr %invariant.gep3967, i64 %i.bdz
...
.lr.ph.i.i.preheader:                             ; preds = %.preheader89.i.i
  br i1 %min.iters.check3417, label %.lr.ph.i.i.preheader3480, label %vector.memcheck3408

vector.memcheck3408:                              ; preds = %.lr.ph.i.i.preheader
  %bound03413 = icmp ult ptr %.05899.i.i, %gep3968
  %bound13414 = icmp ult ptr %.16097.i.i, %scevgep3411
  %found.conflict3415 = and i1 %bound03413, %bound13414
  br i1 %found.conflict3415, label %.lr.ph.i.i.preheader3480, label %vector.body3420

vector.body3420:                                  ; preds = %vector.memcheck3408, %vector.body3420
  %index3421 = phi i64 [ %index.next3427, %vector.body3420 ], [ 0, %vector.memcheck3408 ] ; 2 uses
  %i.beg = xor i64 %index3421, -1
  ...
  %wide.load3422 = load <8 x i8>, ptr %i.bej, align 1, !tbaa !80, !alias.scope !153 ; 2 uses
  %i.bek = shl nuw nsw i64 %i.beh, 1
  %i.bel = getelementptr i8, ptr %.05899.i.i, i64 %i.bek
  %i.bem = getelementptr i8, ptr %i.bel, i64 -14
  %reverse3424 = lshr <8 x i8> %wide.load3422, splat (i8 4)
  %reverse3425 = and <8 x i8> %wide.load3422, splat (i8 15)
  %interleaved.vec3426 = shufflevector <8 x i8> %reverse3424, <8 x i8> %reverse3425, <16 x i32> <i32 0, i32 8, i32 1, i32 9, i32 2, i32 10, i32 3, i32 11, i32 4, i32 12, i32 5, i32 13, i32 6, i32 14, i32 7, i32 15>
  store <16 x i8> %interleaved.vec3426, ptr %i.bem, align 1, !tbaa !80, !alias.scope !156, !noalias !153
  %index.next3427 = add nuw i64 %index3421, 8     ; 2 uses
  %i.ben = icmp eq i64 %index.next3427, %n.vec3419
  br i1 %i.ben, label %middle.block3428, label %vector.body3420, !llvm.loop !158

middle.block3428:                                 ; preds = %vector.body3420
  br i1 %cmp.n3429, label %horizontal_fill.exit.i.i, label %.lr.ph.i.i.preheader3480

.lr.ph.i.i.preheader3480:                         ; preds = %vector.memcheck3408, %.lr.ph.i.i.preheader, %middle.block3428
  %indvars.iv.i.i.ph = phi i64 [ %i.bdt, %vector.memcheck3408 ], [ %i.bdt, %.lr.ph.i.i.preheader ], [ %i.bdw, %middle.block3428 ]
  br label %.lr.ph.i.i
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader3480, %.lr.ph.i.i
  %indvars.iv.i.i = phi i64 [ %indvars.iv.next.i.i, %.lr.ph.i.i ], [ %indvars.iv.i.i.ph, %.lr.ph.i.i.preheader3480 ] ; 2 uses
...
horizontal_fill.exit.i.i:                         ; preds = %.lr.ph.i.i, %.lr.ph94.i.i, %.lr.ph96.i.i, %middle.block3428, %horizontal_fill.exit.sink.split.i.i, %.preheader.i.i, %.preheader87.i.i, %.preheader89.i.i
  br i1 %i.bac, label %bb.ne, label %bb.nf

bb.ne:                                            ; preds = %horizontal_fill.exit.i.i
  %i.bft = add nsw i32 %.0101.i375.i, %.121602
...
bb.nf:                                            ; preds = %bb.ne, %horizontal_fill.exit.i.i
  ...
  %indvar.next3410 = add i64 %indvar3409, 1
  br i1 %i.bga, label %bb.nb, label %tiff_unpack_strip.exit.thread892.sink.split, !llvm.loop !162
...
.preheader.i.i381.i.preheader:                    ; preds = %bb.nk
  %xtraiter3712 = and i64 %.pre.i.i, 1
...
.preheader.i.i381.i.preheader.new:                ; preds = %.preheader.i.i381.i.preheader
  %unroll_iter3715 = and i64 %.pre.i.i, 2147483646
...
.preheader.i.i381.i:                              ; preds = %.preheader.i.i381.i, %.preheader.i.i381.i.preheader.new
  ...
  %niter3716 = phi i64 [ 0, %.preheader.i.i381.i.preheader.new ], [ %niter3716.next.1, %.preheader.i.i381.i ]
  ...
  %niter3716.next.1 = add i64 %niter3716, 2       ; 2 uses
  %niter3716.ncmp.1 = icmp eq i64 %niter3716.next.1, %unroll_iter3715
  br i1 %niter3716.ncmp.1, label %deinvert_buffer.exit.i385.i.unr-lcssa, label %.preheader.i.i381.i, !llvm.loop !145
...
deinvert_buffer.exit.i385.i.unr-lcssa:            ; preds = %.preheader.i.i381.i
  %lcmp.mod3713.not = icmp eq i64 %xtraiter3712, 0
  br i1 %lcmp.mod3713.not, label %deinvert_buffer.exit.i385.i, label %.preheader.i.i381.i.epil.preheader
...
.preheader.i.i381.i.epil.preheader:               ; preds = %deinvert_buffer.exit.i385.i.unr-lcssa, %.preheader.i.i381.i.preheader
  ...
  %lcmp.mod3714 = trunc i32 %.0721 to i1
  call void @llvm.assume(i1 %lcmp.mod3714)
...
bb.nm:                                            ; preds = %._crit_edge113.i.i
  ...
  br i1 %switch.i389.i, label %tiff_uncompress_lzma.exit.thread.i.i, label %.loopexit948

.loopexit948:                                     ; preds = %bb.nm, %tiff_uncompress_lzma.exit.thread82.i.i
...
.preheader92.i.i:                                 ; preds = %tiff_uncompress_lzma.exit.thread.i.i
  ...
  br i1 %i.bhq, label %.lr.ph103.i.i, label %tiff_unpack_strip.exit.thread892.sink.split
...
.lr.ph103.i.i:                                    ; preds = %.preheader92.i.i
  ...
  %invariant.gep3965 = getelementptr i8, ptr %i.bgj, i64 %i.bht
  %min.iters.check3440 = icmp ult i32 %.2.i, 8
  %n.vec3442 = and i64 %i.bht, 2147483640         ; 2 uses
  %i.bhw = and i64 %i.bht, 7
  %cmp.n3452 = icmp eq i64 %n.vec3442, %i.bht
  br label %bb.no
...
bb.no:                                            ; preds = %bb.ns, %.lr.ph103.i.i
  %indvar3432 = phi i64 [ %indvar.next3433, %bb.ns ], [ 0, %.lr.ph103.i.i ] ; 3 uses
  ...
  %i.bhy = mul i64 %indvar3432, %i.bhs
  %scevgep3434 = getelementptr i8, ptr %i.bhv, i64 %i.bhy
  %i.bhz = mul i64 %indvar3432, %i.bgb
  %gep3966 = getelementptr i8, ptr %invariant.gep3965, i64 %i.bhz
...
.lr.ph.i394.i.preheader:                          ; preds = %.preheader90.i.i
  br i1 %min.iters.check3440, label %.lr.ph.i394.i.preheader3483, label %vector.memcheck3431

vector.memcheck3431:                              ; preds = %.lr.ph.i394.i.preheader
  %bound03436 = icmp ult ptr %.058100.i.i, %gep3966
  %bound13437 = icmp ult ptr %.16098.i.i, %scevgep3434
  %found.conflict3438 = and i1 %bound03436, %bound13437
  br i1 %found.conflict3438, label %.lr.ph.i394.i.preheader3483, label %vector.body3443

vector.body3443:                                  ; preds = %vector.memcheck3431, %vector.body3443
  %index3444 = phi i64 [ %index.next3450, %vector.body3443 ], [ 0, %vector.memcheck3431 ] ; 2 uses
  %i.big = xor i64 %index3444, -1
  ...
  %wide.load3445 = load <8 x i8>, ptr %i.bij, align 1, !tbaa !80, !alias.scope !170 ; 2 uses
  %i.bik = shl nuw nsw i64 %i.bih, 1
  %i.bil = getelementptr i8, ptr %.058100.i.i, i64 %i.bik
  %i.bim = getelementptr i8, ptr %i.bil, i64 -14
  %reverse3447 = lshr <8 x i8> %wide.load3445, splat (i8 4)
  %reverse3448 = and <8 x i8> %wide.load3445, splat (i8 15)
  %interleaved.vec3449 = shufflevector <8 x i8> %reverse3447, <8 x i8> %reverse3448, <16 x i32> <i32 0, i32 8, i32 1, i32 9, i32 2, i32 10, i32 3, i32 11, i32 4, i32 12, i32 5, i32 13, i32 6, i32 14, i32 7, i32 15>
  store <16 x i8> %interleaved.vec3449, ptr %i.bim, align 1, !tbaa !80, !alias.scope !173, !noalias !170
  %index.next3450 = add nuw i64 %index3444, 8     ; 2 uses
  %i.bin = icmp eq i64 %index.next3450, %n.vec3442
  br i1 %i.bin, label %middle.block3451, label %vector.body3443, !llvm.loop !175

middle.block3451:                                 ; preds = %vector.body3443
  br i1 %cmp.n3452, label %horizontal_fill.exit.i392.i, label %.lr.ph.i394.i.preheader3483

.lr.ph.i394.i.preheader3483:                      ; preds = %vector.memcheck3431, %.lr.ph.i394.i.preheader, %middle.block3451
  %indvars.iv.i395.i.ph = phi i64 [ %i.bht, %vector.memcheck3431 ], [ %i.bht, %.lr.ph.i394.i.preheader ], [ %i.bhw, %middle.block3451 ]
...
.lr.ph.i394.i:                                    ; preds = %.lr.ph.i394.i.preheader3483, %.lr.ph.i394.i
  %indvars.iv.i395.i = phi i64 [ %indvars.iv.next.i396.i, %.lr.ph.i394.i ], [ %indvars.iv.i395.i.ph, %.lr.ph.i394.i.preheader3483 ] ; 2 uses
...
horizontal_fill.exit.i392.i:                      ; preds = %.lr.ph.i394.i, %.lr.ph95.i.i, %.lr.ph97.i.i, %middle.block3451, %horizontal_fill.exit.sink.split.i391.i, %.preheader.i397.i, %.preheader88.i.i, %.preheader90.i.i
  br i1 %i.bac, label %bb.nr, label %bb.ns

bb.nr:                                            ; preds = %horizontal_fill.exit.i392.i
  %i.bjt = add nsw i32 %.0102.i.i, %.121602
...
bb.ns:                                            ; preds = %bb.nr, %horizontal_fill.exit.i392.i
  ...
  %indvar.next3433 = add i64 %indvar3432, 1
  br i1 %i.bka, label %bb.no, label %tiff_unpack_strip.exit.thread892.sink.split, !llvm.loop !177
...
.preheader.i399.i.preheader.new:                  ; preds = %.preheader.i399.i.preheader
  %unroll_iter3702 = and i64 %i.bkc, 2147483646
...
.preheader.i399.i:                                ; preds = %.preheader.i399.i, %.preheader.i399.i.preheader.new
  ...
  %niter3703 = phi i64 [ 0, %.preheader.i399.i.preheader.new ], [ %niter3703.next.1, %.preheader.i399.i ]
  ...
  %niter3703.next.1 = add i64 %niter3703, 2       ; 2 uses
  %niter3703.ncmp.1 = icmp eq i64 %niter3703.next.1, %unroll_iter3702
  br i1 %niter3703.ncmp.1, label %deinvert_buffer.exit.i.unr-lcssa, label %.preheader.i399.i, !llvm.loop !145

deinvert_buffer.exit.i.unr-lcssa:                 ; preds = %.preheader.i399.i
  %lcmp.mod3700.not = icmp eq i64 %xtraiter3699, 0
  br i1 %lcmp.mod3700.not, label %deinvert_buffer.exit.i, label %.preheader.i399.i.epil.preheader
...
.preheader.i399.i.epil.preheader:                 ; preds = %deinvert_buffer.exit.i.unr-lcssa, %.preheader.i399.i.preheader
  ...
  %lcmp.mod3701 = trunc i32 %.0721 to i1
  call void @llvm.assume(i1 %lcmp.mod3701)
...
.preheader516.i:                                  ; preds = %bb.nz
  ...
  br i1 %i.blj, label %.lr.ph532.i, label %tiff_unpack_strip.exit.thread892
...
.lr.ph532.i:                                      ; preds = %.preheader516.i
  ...
  %xtraiter3704 = and i64 %i.blp, 1
  %lcmp.mod3705.not = icmp eq i64 %xtraiter3704, 0
  %indvars.iv.next.i853.prol = add nsw i64 %i.blp, -1 ; 3 uses
  %i.blq = shl nuw nsw i64 %indvars.iv.next.i853.prol, 1
...
.preheader514.i:                                  ; preds = %bb.of
  br i1 %i.blk, label %.lr.ph.i851.preheader, label %horizontal_fill.exit369.i

.lr.ph.i851.preheader:                            ; preds = %.preheader514.i
  br i1 %lcmp.mod3705.not, label %.lr.ph.i851.prol.loopexit, label %.lr.ph.i851.prol

.lr.ph.i851.prol:                                 ; preds = %.lr.ph.i851.preheader
  %i.bmd = getelementptr inbounds nuw i8, ptr %.3300530.i, i64 %indvars.iv.next.i853.prol ; 2 uses
  ...
  br label %.lr.ph.i851.prol.loopexit

.lr.ph.i851.prol.loopexit:                        ; preds = %.lr.ph.i851.prol, %.lr.ph.i851.preheader
  %indvars.iv.i852.unr = phi i64 [ %i.blp, %.lr.ph.i851.preheader ], [ %indvars.iv.next.i853.prol, %.lr.ph.i851.prol ]
  br i1 %i.blr, label %horizontal_fill.exit369.i, label %.lr.ph.i851
...
.lr.ph.i851:                                      ; preds = %.lr.ph.i851.prol.loopexit, %.lr.ph.i851
  %indvars.iv.i852 = phi i64 [ %indvars.iv.next.i853.1, %.lr.ph.i851 ], [ %indvars.iv.i852.unr, %.lr.ph.i851.prol.loopexit ] ; 3 uses
  %indvars.iv.next.i853 = add nsw i64 %indvars.iv.i852, -1 ; 2 uses
  %i.boe = getelementptr inbounds nuw i8, ptr %.3300530.i, i64 %indvars.iv.next.i853 ; 2 uses
  %i.bof = load i8, ptr %i.boe, align 1, !tbaa !80
  %i.bog = and i8 %i.bof, 15
  %i.boh = shl nuw nsw i64 %indvars.iv.next.i853, 1
  ...
  %indvars.iv.next.i853.1 = add nsw i64 %indvars.iv.i852, -2 ; 3 uses
  %i.bom = getelementptr inbounds nuw i8, ptr %.3300530.i, i64 %indvars.iv.next.i853.1 ; 2 uses
  %i.bon = load i8, ptr %i.bom, align 1, !tbaa !80
  %i.boo = and i8 %i.bon, 15
  %i.bop = shl nuw nsw i64 %indvars.iv.next.i853.1, 1
  ...
  %i.bou = icmp sgt i64 %indvars.iv.i852, 2
  br i1 %i.bou, label %.lr.ph.i851, label %horizontal_fill.exit369.i, !llvm.loop !178

horizontal_fill.exit369.i:                        ; preds = %.lr.ph.i851.prol.loopexit, %.lr.ph.i851, %.lr.ph527.i, %.lr.ph529.i, %.preheader511.i, %.preheader512.i, %.preheader514.i, %bb.of, %bb.oe, %bb.od
  br i1 %i.bac, label %bb.og, label %bb.oh

bb.og:                                            ; preds = %horizontal_fill.exit369.i
  %i.bov = add nsw i32 %.0292531.i, %.121602
...
bb.oi:                                            ; preds = %bb.oh
  %i.bpb = add nsw i32 %.0292531.i, %.121602
...
.lr.ph.i406.i:                                    ; preds = %bb.oi
  ...
  %xtraiter3707 = and i64 %wide.trip.count.i.i, 1
  %i.bpl = icmp eq i32 %i.bpi, 1
  br i1 %i.bpl, label %.epil.preheader3706, label %.lr.ph.i406.i.new

.lr.ph.i406.i.new:                                ; preds = %.lr.ph.i406.i
  %unroll_iter3710 = and i64 %wide.trip.count.i.i, 2147483646
  br label %bb.oj
...
bb.oj:                                            ; preds = %bb.oj, %.lr.ph.i406.i.new
  ...
  %niter3711 = phi i64 [ 0, %.lr.ph.i406.i.new ], [ %niter3711.next.1, %bb.oj ]
  ...
  %niter3711.next.1 = add i64 %niter3711, 2       ; 2 uses
  %niter3711.ncmp.1 = icmp eq i64 %niter3711.next.1, %unroll_iter3710
  br i1 %niter3711.ncmp.1, label %unpack_gray.exit.i.loopexit.unr-lcssa, label %bb.oj, !llvm.loop !179

unpack_gray.exit.i.loopexit.unr-lcssa:            ; preds = %bb.oj
  %lcmp.mod3708.not = icmp eq i64 %xtraiter3707, 0
  br i1 %lcmp.mod3708.not, label %unpack_gray.exit.i, label %.epil.preheader3706

.epil.preheader3706:                              ; preds = %unpack_gray.exit.i.loopexit.unr-lcssa, %.lr.ph.i406.i
  ...
  %lcmp.mod3709 = trunc i32 %i.bpi to i1
  call void @llvm.assume(i1 %lcmp.mod3709)
...
unpack_gray.exit.i:                               ; preds = %.epil.preheader3706, %unpack_gray.exit.i.loopexit.unr-lcssa, %bb.oi, %bb.oh, %bb.og
  %.1293.i = phi i32 [ %i.boy, %bb.og ], [ %.0292531.i, %bb.oh ], [ %.0292531.i, %bb.oi ], [ %.0292531.i, %unpack_gray.exit.i.loopexit.unr-lcssa ], [ %.0292531.i, %.epil.preheader3706 ]
  %i.bqv = getelementptr inbounds i8, ptr %.3300530.i, i64 %i.blo
  %i.bqw = add nsw i32 %.1293.i, 1                ; 2 uses
  %i.bqx = icmp slt i32 %i.bqw, %.829
  br i1 %i.bqx, label %bb.ob, label %tiff_unpack_strip.exit.thread892, !llvm.loop !180
...
.preheader.i.i412.i.epil.preheader:               ; preds = %deinvert_buffer.exit.i416.i.unr-lcssa, %.preheader.i.i412.i.preheader
  ...
  %lcmp.mod3691 = trunc i32 %.0721 to i1
  call void @llvm.assume(i1 %lcmp.mod3691)
...
deinvert_buffer.exit.i416.i:                      ; preds = %deinvert_buffer.exit.i416.i.unr-lcssa, %.preheader.i.i412.i.epil.preheader
  ...
  %.pre.i850 = load i32, ptr %i.av, align 8, !tbaa !59
  br label %bb.oo

bb.oo:                                            ; preds = %deinvert_buffer.exit.i416.i, %bb.om
  %i.bsa = phi i32 [ %.pre.i850, %deinvert_buffer.exit.i416.i ], [ %i.bbv, %bb.om ]
...
.lr.ph49.i.i:                                     ; preds = %bb.op
  ...
  %xtraiter3697 = and i64 %i.bsq, 1
  %lcmp.mod3698.not = icmp eq i64 %xtraiter3697, 0
...
.lr.ph41.i.i.preheader:                           ; preds = %.preheader34.i.i
  br i1 %lcmp.mod3698.not, label %.lr.ph41.i.i.prol.loopexit, label %.lr.ph41.i.i.prol
...
bb.os:                                            ; preds = %bb.os, %.lr.ph.i422.i.new
  ...
  %niter3696 = phi i64 [ 0, %.lr.ph.i422.i.new ], [ %niter3696.next.1, %bb.os ]
  ...
  br i1 %niter3696.ncmp.1, label %horizontal_fill.exit.i421.i.loopexit3489.unr-lcssa, label %bb.os, !llvm.loop !181

horizontal_fill.exit.i421.i.loopexit3489.unr-lcssa: ; preds = %bb.os
  %lcmp.mod3693.not = icmp eq i64 %xtraiter3692, 0
  br i1 %lcmp.mod3693.not, label %horizontal_fill.exit.i421.i, label %.epil.preheader

.epil.preheader:                                  ; preds = %horizontal_fill.exit.i421.i.loopexit3489.unr-lcssa, %.lr.ph.i422.i
  %indvars.iv.i424.i.epil.init = phi i64 [ 0, %.lr.ph.i422.i ], [ %indvars.iv.next.i425.i.1, %horizontal_fill.exit.i421.i.loopexit3489.unr-lcssa ]
  %.sroa.4.038.i.i.epil.init = phi i32 [ 0, %.lr.ph.i422.i ], [ %i.bws, %horizontal_fill.exit.i421.i.loopexit3489.unr-lcssa ] ; 2 uses
  %lcmp.mod3694 = trunc i32 %i.bvo to i1
...
horizontal_fill.exit.i421.i:                      ; preds = %.epil.preheader, %horizontal_fill.exit.i421.i.loopexit3489.unr-lcssa, %.lr.ph41.i.i.prol.loopexit, %.lr.ph41.i.i, %.lr.ph43.i.i, %.lr.ph45.i.i, %bb.or, %.preheader.i427.i, %.preheader32.i.i, %.preheader34.i.i, %bb.oq
...
.preheader506.i:                                  ; preds = %bb.pd
  ...
  br i1 %i.bye, label %.lr.ph583.i, label %tiff_unpack_strip.exit.thread892
...
.lr.ph583.i:                                      ; preds = %.preheader506.i
  ...
  %xtraiter3728 = and i64 %i.byp, 3               ; 3 uses
  %i.byt = icmp ult i32 %.2.i, 4
  %unroll_iter3731 = and i64 %i.byp, 2147483644
  %lcmp.mod3729.not = icmp eq i64 %xtraiter3728, 0
  %lcmp.mod3730 = icmp ne i64 %xtraiter3728, 0
  %xtraiter3733 = and i64 %i.byp, 3               ; 3 uses
  %i.byu = icmp ult i32 %.2.i, 4
  %unroll_iter3737 = and i64 %i.byp, 2147483644
  %lcmp.mod3735.not = icmp eq i64 %xtraiter3733, 0
  %lcmp.mod3736 = icmp ne i64 %xtraiter3733, 0
  %min.iters.check3326 = icmp ult i32 %.2.i, 8
  %n.vec3328 = and i64 %i.byp, 2147483640         ; 2 uses
  %i.byv = and i64 %i.byp, 7
  %cmp.n3338 = icmp eq i64 %n.vec3328, %i.byp
  br label %bb.pe

bb.pe:                                            ; preds = %bb.qm, %.lr.ph583.i
  %indvar3318 = phi i64 [ %indvar.next3319, %bb.qm ], [ 0, %.lr.ph583.i ] ; 3 uses
  ...
  %i.byw = mul i64 %indvar3318, %i.byo
  %i.byx = getelementptr i8, ptr %.2299.i, i64 %i.byw
  %i.byy = mul i64 %indvar3318, %i.byo
  %scevgep3320 = getelementptr i8, ptr %i.bys, i64 %i.byy
...
bb.pg:                                            ; preds = %bb.pe
  ...
  br i1 %or.cond473.i, label %bytestream2_seek_p.exit.i, label %tiff_unpack_strip.exit.thread892
...
.lr.ph560.i.preheader:                            ; preds = %.preheader498.i
  br i1 %min.iters.check3326, label %.lr.ph560.i.preheader3475, label %vector.memcheck3317

vector.memcheck3317:                              ; preds = %.lr.ph560.i.preheader
  %scevgep3321 = getelementptr i8, ptr %.1305576.i, i64 %i.byp
  %bound03322 = icmp ult ptr %.4578.i, %scevgep3321
  %bound13323 = icmp ult ptr %.1305576.i, %scevgep3320
  %found.conflict3324 = and i1 %bound03322, %bound13323
  br i1 %found.conflict3324, label %.lr.ph560.i.preheader3475, label %vector.body3329
...
vector.body3329:                                  ; preds = %vector.memcheck3317, %vector.body3329
  ...
  %wide.load3331 = load <8 x i8>, ptr %i.bzz, align 1, !tbaa !80, !alias.scope !184 ; 2 uses
  %i.caa = and <8 x i8> %wide.load3331, splat (i8 15)
  %i.cab = shl nuw nsw i64 %i.bzx, 1
  %i.cac = getelementptr i8, ptr %.4578.i, i64 %i.cab
  %i.cad = lshr <8 x i8> %wide.load3331, splat (i8 4)
  ...
  %i.caf = icmp eq i64 %index.next3336, %n.vec3328
  br i1 %i.caf, label %middle.block3337, label %vector.body3329, !llvm.loop !189

middle.block3337:                                 ; preds = %vector.body3329
  br i1 %cmp.n3338, label %horizontal_fill.exit363.i, label %.lr.ph560.i.preheader3475

.lr.ph560.i.preheader3475:                        ; preds = %vector.memcheck3317, %.lr.ph560.i.preheader, %middle.block3337
  %indvars.iv656.i.ph = phi i64 [ %i.byp, %vector.memcheck3317 ], [ %i.byp, %.lr.ph560.i.preheader ], [ %i.byv, %middle.block3337 ]
  br label %.lr.ph560.i
...
.lr.ph560.i:                                      ; preds = %.lr.ph560.i.preheader3475, %.lr.ph560.i
  %indvars.iv656.i = phi i64 [ %indvars.iv.next657.i, %.lr.ph560.i ], [ %indvars.iv656.i.ph, %.lr.ph560.i.preheader3475 ] ; 2 uses
...
.lr.ph558.i:                                      ; preds = %bb.pm
  ...
  %xtraiter3740 = and i64 %wide.trip.count654.i, 1
  %i.ccu = icmp eq i32 %i.ccn, 1
  br i1 %i.ccu, label %.epil.preheader3739, label %.lr.ph558.i.new

.lr.ph558.i.new:                                  ; preds = %.lr.ph558.i
  %unroll_iter3744 = and i64 %wide.trip.count654.i, 2147483646
  br label %bb.pn
...
bb.pn:                                            ; preds = %bb.pn, %.lr.ph558.i.new
  ...
  %niter3745 = phi i64 [ 0, %.lr.ph558.i.new ], [ %niter3745.next.1, %bb.pn ]
...
.lr.ph554.i:                                      ; preds = %.lr.ph554.i.preheader, %.lr.ph554.i
  ...
  %niter3738 = phi i64 [ %niter3738.next.3, %.lr.ph554.i ], [ 0, %.lr.ph554.i.preheader ]
  ...
  br i1 %niter3738.ncmp.3, label %horizontal_fill.exit363.i.loopexit3478.unr-lcssa, label %.lr.ph554.i, !llvm.loop !191
...
.epil.preheader3739:                              ; preds = %horizontal_fill.exit363.i.loopexit3477.unr-lcssa, %.lr.ph558.i
  %indvars.iv651.i.epil.init = phi i64 [ 0, %.lr.ph558.i ], [ %indvars.iv.next652.i.1, %horizontal_fill.exit363.i.loopexit3477.unr-lcssa ]
  %.sroa.4457.0555.i.epil.init = phi i32 [ 0, %.lr.ph558.i ], [ %i.cdr, %horizontal_fill.exit363.i.loopexit3477.unr-lcssa ] ; 2 uses
  %lcmp.mod3743 = trunc i32 %i.ccn to i1
...
horizontal_fill.exit363.i.loopexit3478.unr-lcssa: ; preds = %.lr.ph554.i
  br i1 %lcmp.mod3735.not, label %horizontal_fill.exit363.i, label %.lr.ph554.i.epil.preheader

.lr.ph554.i.epil.preheader:                       ; preds = %horizontal_fill.exit363.i.loopexit3478.unr-lcssa, %.lr.ph554.i.preheader
  %indvars.iv646.i.epil.init = phi i64 [ 0, %.lr.ph554.i.preheader ], [ %indvars.iv.next647.i.3, %horizontal_fill.exit363.i.loopexit3478.unr-lcssa ]
...
.lr.ph554.i.epil:                                 ; preds = %.lr.ph554.i.epil, %.lr.ph554.i.epil.preheader
  ...
  %epil.iter3734 = phi i64 [ %epil.iter3734.next, %.lr.ph554.i.epil ], [ 0, %.lr.ph554.i.epil.preheader ]
  ...
  br i1 %epil.iter3734.cmp.not, label %horizontal_fill.exit363.i, label %.lr.ph554.i.epil, !llvm.loop !192

horizontal_fill.exit363.i:                        ; preds = %horizontal_fill.exit363.i.loopexit3478.unr-lcssa, %.lr.ph554.i.epil, %.epil.preheader3739, %horizontal_fill.exit363.i.loopexit3477.unr-lcssa, %.lr.ph560.i, %.lr.ph562.i, %.lr.ph564.i, %middle.block3337, %.thread472.i, %bb.pm, %.preheader495.i, %.preheader496.i, %.preheader498.i, %.preheader501.i
