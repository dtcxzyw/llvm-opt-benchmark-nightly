...
bb.c:                                             ; preds = %bb.b
  ...
  store i32 8191, ptr %i.n, align 8, !tbaa !27
  %i.o = getelementptr inbounds nuw i8, ptr %i.d, i64 404 ; 4 uses
  store i32 16384, ptr %i.o, align 4, !tbaa !28
  ...
  %i.r = load i32, ptr %i.o, align 4, !tbaa !28
  ...
  %i.v = load i32, ptr %i.o, align 4, !tbaa !28
  ...
  %i.z = load i32, ptr %i.o, align 4, !tbaa !28
  ...
  %i.ae = load ptr, ptr %i.q, align 8, !tbaa !29
...
bb.d:                                             ; preds = %bb.c
  ...
  %.val = load ptr, ptr %i.s, align 8, !tbaa !39  ; 2 uses
  ...
  %i.w = load ptr, ptr %i.v, align 8, !tbaa !29   ; 4 uses
...
.lr.ph27.i:                                       ; preds = %.preheader4.i
  ...
  %scevgep86 = getelementptr i8, ptr %i.w, i64 8
  br label %bb.f
...
bb.f:                                             ; preds = %._crit_edge25.i, %.lr.ph27.i
  ...
  %i.as = load ptr, ptr %i.ai, align 8, !tbaa !55
  %i.at = getelementptr inbounds nuw [8 x i8], ptr %i.as, i64 %indvars.iv60.i
  %i.au = load ptr, ptr %i.at, align 8, !tbaa !56 ; 7 uses
  %i.av = ptrtoaddr ptr %i.au to i64
  %i.aw = load ptr, ptr %i.aj, align 8, !tbaa !57
  ...
  %i.ba = load ptr, ptr %i.az, align 8, !tbaa !56 ; 22 uses
  %i.bb = ptrtoaddr ptr %i.ba to i64              ; 2 uses
  %i.bc = load ptr, ptr %i.ak, align 8, !tbaa !55
  %i.bd = getelementptr inbounds nuw [8 x i8], ptr %i.bc, i64 %indvars.iv60.i
  %i.be = load ptr, ptr %i.bd, align 8, !tbaa !56 ; 7 uses
  %i.bf = load i32, ptr %i.ac, align 8, !tbaa !48 ; 6 uses
...
vector.body111:                                   ; preds = %vector.body111, %vector.ph109
  ...
  br i1 %i.bn, label %middle.block116, label %vector.body111, !llvm.loop !58
...
.preheader3.i:                                    ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i, %middle.block116, %bb.f
  ...
  %i.bt = load i32, ptr %i.al, align 4, !tbaa !28 ; 2 uses
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  br i1 %exitcond.not.i.3, label %.preheader3.i, label %.lr.ph.i, !llvm.loop !64

._crit_edge.i:                                    ; preds = %.lr.ph9.preheader.i, %.preheader3.i
  %i.co = load ptr, ptr %i.am, align 8, !tbaa !65
  %i.cp = load ptr, ptr %i.an, align 8, !tbaa !66
  call void %i.co(ptr noundef %i.cp, ptr noundef %i.y, ptr noundef %i.aa, i64 noundef 4) #7, !inline_history !67
...
.lr.ph13.preheader.i:                             ; preds = %._crit_edge.i
  ...
  %wide.trip.count37.i = zext nneg i32 %i.cs to i64 ; 3 uses
...
vector.memcheck83:                                ; preds = %.lr.ph13.preheader.i
  %1 = zext i32 %i.cr to i64
  %i.ct = shl nuw nsw i64 %1, 3                   ; 2 uses
  %scevgep85.a = getelementptr i8, ptr %scevgep84, i64 %i.ct
  %scevgep87 = getelementptr i8, ptr %scevgep86, i64 %i.ct
...
vector.body95:                                    ; preds = %vector.body95, %vector.ph93
  ...
  %wide.vec = load <8 x float>, ptr %i.cv, align 4, !tbaa !20, !alias.scope !68 ; 2 uses
  ...
  %wide.vec98 = load <8 x float>, ptr %i.cw, align 4, !tbaa !20, !alias.scope !71, !noalias !68 ; 2 uses
  ...
  store <8 x float> %interleaved.vec, ptr %i.cw, align 4, !tbaa !20, !alias.scope !71, !noalias !68
  %index.next101 = add nuw i64 %index96, 4        ; 2 uses
  %i.dc = icmp eq i64 %index.next101, %n.vec94
  br i1 %i.dc, label %middle.block102, label %vector.body95, !llvm.loop !73
...
.lr.ph13.i:                                       ; preds = %.lr.ph13.i.preheader, %.lr.ph13.i
  ...
  br i1 %exitcond38.not.i, label %._crit_edge14.i, label %.lr.ph13.i, !llvm.loop !74

._crit_edge14.i:                                  ; preds = %.lr.ph13.i, %middle.block102, %._crit_edge.i
  %i.dt = load ptr, ptr %i.ao, align 8, !tbaa !75
  %i.du = load ptr, ptr %i.ap, align 8, !tbaa !76
  call void %i.dt(ptr noundef %i.du, ptr noundef %i.aa, ptr noundef %i.y, i64 noundef 8) #7, !inline_history !67
  %i.dv = load i32, ptr %i.aq, align 8, !tbaa !27 ; 7 uses
  %i.dw = icmp sgt i32 %i.dv, 0                   ; 2 uses
  %.pre.i = load i32, ptr %i.al, align 4, !tbaa !28 ; 4 uses
...
vector.body75:                                    ; preds = %vector.body75, %vector.ph71
  ...
  %wide.load77 = load <4 x float>, ptr %i.dz, align 4, !tbaa !20, !alias.scope !77
  %i.ea = fdiv nsz <4 x float> %wide.load77, %broadcast.splat74
  %i.eb = getelementptr inbounds nuw [4 x i8], ptr %i.ba, i64 %index76 ; 2 uses
  %wide.load78 = load <4 x float>, ptr %i.eb, align 4, !tbaa !20, !alias.scope !80, !noalias !77
  %i.ec = fadd nsz <4 x float> %wide.load78, %i.ea
  store <4 x float> %i.ec, ptr %i.eb, align 4, !tbaa !20, !alias.scope !80, !noalias !77
  %index.next79 = add nuw i64 %index76, 4         ; 2 uses
  %i.ed = icmp eq i64 %index.next79, %n.vec72
  br i1 %i.ed, label %middle.block80, label %vector.body75, !llvm.loop !82
...
vector.body60:                                    ; preds = %vector.body60, %vector.ph58
  ...
  br i1 %i.ew, label %middle.block64, label %vector.body60, !llvm.loop !83
...
scalar.ph56.prol:                                 ; preds = %scalar.ph56.preheader, %scalar.ph56.prol
  ...
  br i1 %prol.iter126.cmp.not, label %scalar.ph56.prol.loopexit, label %scalar.ph56.prol, !llvm.loop !84
