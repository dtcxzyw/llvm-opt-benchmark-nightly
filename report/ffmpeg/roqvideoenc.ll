...
.lr.ph.i.i.i:                                     ; preds = %bb.j
  ...
  %5 = load i32, ptr %gep.i.i, align 1            ; 4 uses
  %wide.trip.count.i.i.i = zext nneg i32 %i.ww to i64
  %.sroa.0.1.extract.shift.i.i = lshr i32 %5, 8
  %.sroa.0.2.extract.shift.i.i = lshr i32 %5, 16
  %.sroa.0.3.extract.shift.i.i = lshr i32 %5, 24
  ...
  %6 = and i32 %5, 255
  %7 = and i32 %.sroa.0.1.extract.shift.i.i, 255
  %8 = and i32 %.sroa.0.2.extract.shift.i.i, 255
...
eval_sse.exit.i.i.i.i:                            ; preds = %eval_sse.exit.i.i.i.i, %.lr.ph.i.i.i
  ...
  %9 = getelementptr inbounds nuw i8, ptr %i.vv, i64 %i.xe ; 5 uses
  %10 = getelementptr inbounds nuw i8, ptr %9, i64 1
  %11 = load i8, ptr %9, align 1, !tbaa !55
  %12 = getelementptr inbounds nuw i8, ptr %9, i64 2
  %13 = load i8, ptr %10, align 1, !tbaa !55
  %i.xf = getelementptr inbounds nuw i8, ptr %9, i64 3
  %14 = load i8, ptr %12, align 1, !tbaa !55
  %15 = load i8, ptr %i.xf, align 1, !tbaa !55
  %i.xg = getelementptr inbounds nuw i8, ptr %9, i64 4
