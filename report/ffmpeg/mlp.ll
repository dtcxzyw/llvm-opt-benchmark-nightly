...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load51 = load <4 x i32>, ptr %i.r, align 4, !tbaa !15
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  br i1 %i.ae, label %.lr.ph, label %.preheader, !llvm.loop !11
...
vector.body56:                                    ; preds = %vector.body56, %vector.ph54
  ...
  br i1 %i.ax, label %middle.block64, label %vector.body56, !llvm.loop !13
...
.lr.ph33:                                         ; preds = %.lr.ph33.preheader69, %.lr.ph33
  ...
  br i1 %exitcond.not, label %._crit_edge34, label %.lr.ph33, !llvm.loop !14
...
!11 = distinct !{!11, !16}
!12 = distinct !{!12, !16, !18, !17}
!13 = distinct !{!13, !16, !17, !18}
