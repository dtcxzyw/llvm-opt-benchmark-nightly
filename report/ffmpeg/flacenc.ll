...
begin_hunk_0_@encode_residual_fixed:bb.a
  ...
  br i1 %i.fw, label %.lr.ph172, label %.loopexit, !llvm.loop !232
...
bb.a:
  ...
  %i.f = load i32, ptr %i.e, align 8, !tbaa !66   ; 7 uses
...
get_max_p_order.exit38:                           ; preds = %get_max_p_order.exit, %bb.b
  ...
  %i.aj = load i32, ptr %i.ai, align 8, !tbaa !72 ; 3 uses
  %i.ak = add i32 %i.ah, %i.aj
  %i.al = zext i32 %i.ak to i64                   ; 2 uses
  %i.am = load i32, ptr %1, align 8, !tbaa !79
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.bq, label %middle.block, label %vector.body, !llvm.loop !235
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  ...
  br i1 %exitcond.not.i, label %._crit_edge.i, label %.lr.ph.i, !llvm.loop !236
...
.lr.ph47.us.us.i.i.preheader:                     ; preds = %.preheader.us.us.i.i
  ...
  %i.cp = ptrtoaddr ptr %.03753.us.us.i.i to i64  ; 2 uses
  %4 = add i64 %i.cp, 4
  %5 = tail call i64 @llvm.umax.i64(i64 %i.co, i64 %4)
  %6 = xor i64 %i.cp, -1
  %7 = add i64 %5, %6                             ; 2 uses
  %i.cq = lshr i64 %7, 2
  %i.cr = add nuw nsw i64 %i.cq, 1                ; 2 uses
  %min.iters.check91 = icmp ult i64 %7, 12
...
vector.body94:                                    ; preds = %vector.body94, %vector.ph92
  ...
  br i1 %i.da, label %middle.block102, label %vector.body94, !llvm.loop !237
...
.lr.ph47.us.us.i.i:                               ; preds = %.lr.ph47.us.us.i.i.preheader126, %.lr.ph47.us.us.i.i
  ...
  br i1 %i.dg, label %.lr.ph47.us.us.i.i, label %._crit_edge48.us.us.i.i, !llvm.loop !238
...
._crit_edge48.us.us.i.i:                          ; preds = %.lr.ph47.us.us.i.i, %middle.block102, %.preheader.us.us.i.i
  ...
  store i64 %.0.lcssa.us.us.i.i, ptr %i.dh, align 8, !tbaa !77
  ...
  br i1 %exitcond82.not.i.i, label %calc_sum_top.exit.i, label %.preheader.us.us.i.i, !llvm.loop !239
...
bb.e:                                             ; preds = %._crit_edge.i.i, %.lr.ph56.i.i
  ...
  %i.dm = ptrtoint ptr %.03753.i.i to i64         ; 3 uses
...
.lr.ph.i.i.preheader:                             ; preds = %bb.e
  ...
  %8 = add i64 %i.cg, %i.dr
  %i.ds = add i64 %i.dm, 4
  %9 = tail call i64 @llvm.umax.i64(i64 %8, i64 %i.ds)
  %10 = xor i64 %i.dm, -1
...
vector.body81:                                    ; preds = %vector.body81, %vector.ph79
  ...
  br i1 %i.eg, label %middle.block87, label %vector.body81, !llvm.loop !240
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader131, %.lr.ph.i.i
  ...
  br i1 %i.en, label %.lr.ph.i.i, label %._crit_edge.i.i, !llvm.loop !241
...
._crit_edge.i.i:                                  ; preds = %.lr.ph.i.i, %middle.block87, %bb.e
  ...
  store i64 %.035.lcssa.i.i, ptr %i.eo, align 8, !tbaa !77
  %indvars.iv.next.i.i = add nuw nsw i64 %indvars.iv.i.i, 1 ; 2 uses
  %.036.i.i = getelementptr inbounds [4 x i8], ptr %.03654.i.i, i64 %i.cc
  %exitcond.not.i.i = icmp eq i64 %indvars.iv.next.i.i, %wide.trip.count.i.i
  br i1 %exitcond.not.i.i, label %._crit_edge57.split.i.i, label %bb.e, !llvm.loop !239

._crit_edge57.split.i.i:                          ; preds = %._crit_edge.i.i
  %exitcond76.not.i.i = icmp eq i64 %i.di, %wide.trip.count75.i.i
  br i1 %exitcond76.not.i.i, label %calc_sum_top.exit.i, label %.lr.ph56.i.i, !llvm.loop !242
...
calc_sum_top.exit.i:                              ; preds = %._crit_edge57.split.i.i, %._crit_edge48.us.us.i.i, %.lr.ph62.i.i, %._crit_edge.i
  ...
  store i64 4294967295, ptr %i.eq, align 8, !tbaa !77
...
.lr.ph.split.us.preheader.i.i:                    ; preds = %.lr.ph.i44.i
  %i.fg = load i64, ptr %i.av, align 8, !tbaa !77 ; 2 uses
...
.lr.ph.split.us.i.i:                              ; preds = %find_optimal_param.exit.us.i.i, %.lr.ph.split.us.peel.next.i.i
  ...
  %i.gi = load i64, ptr %i.gh, align 8, !tbaa !77 ; 2 uses
...
find_optimal_param.exit.us.i.i:                   ; preds = %bb.g, %.lr.ph.split.us.i.i
  ...
  br i1 %exitcond61.not.i.i, label %calc_optimal_rice_params.exit.i, label %.lr.ph.split.us.i.i, !llvm.loop !243
end_hunk_0
...
bb.e:                                             ; preds = %._crit_edge.us.i79
  ...
  br i1 %exitcond69.not.i82, label %lpc_encode_with_residual_limit_33bps.exit, label %.preheader.us.i72, !llvm.loop !1
...
bb.f:                                             ; preds = %.preheader.i57
  ...
  br i1 %exitcond59.not.i61, label %lpc_encode_with_residual_limit_33bps.exit, label %.preheader.i57, !llvm.loop !1
...
lpc_encode_with_residual_limit_33bps.exit.sink.split: ; preds = %.thread109, %bb.d
  ...
  %i.hh = load i32, ptr %i.hg, align 8, !tbaa !81
  ...
  %i.hu = load ptr, ptr %i.ht, align 8, !tbaa !84
...
!30 = !{!29, !8, i64 344}
!31 = !{!29, !11, i64 32}
!32 = !{!"PutBitContext", !8, i64 0, !8, i64 4, !16, i64 8, !16, i64 16, !16, i64 24}
!33 = !{!"FlacFrame", !7, i64 0, !7, i64 6825536, !8, i64 7349816, !7, i64 7349820, !7, i64 7349828, !8, i64 7349832, !8, i64 7349836}
!34 = !{!"CompressionOptions", !8, i64 0, !8, i64 4, !8, i64 8, !8, i64 12, !8, i64 16, !8, i64 20, !8, i64 24, !8, i64 28, !8, i64 32, !8, i64 36, !8, i64 40, !8, i64 44, !8, i64 48}
!35 = !{!"p1 _ZTS14AVCodecContext", !11, i64 0}
!36 = !{!"p1 double", !11, i64 0}
!37 = !{!"LPCContext", !8, i64 0, !8, i64 4, !8, i64 8, !36, i64 16, !36, i64 24, !11, i64 32, !11, i64 40, !7, i64 48}
!38 = !{!"p1 _ZTS5AVMD5", !11, i64 0}
!39 = !{!"BswapDSPContext", !11, i64 0, !11, i64 8}
!40 = !{!"FLACEncDSPContext", !11, i64 0, !11, i64 8}
!41 = !{!"FlacEncodeContext", !12, i64 0, !32, i64 8, !8, i64 40, !8, i64 44, !7, i64 48, !8, i64 56, !8, i64 60, !8, i64 64, !8, i64 68, !8, i64 72, !8, i64 76, !15, i64 80, !7, i64 88, !33, i64 104, !34, i64 7349944, !35, i64 7350000, !37, i64 7350016, !38, i64 7387760, !16, i64 7387768, !8, i64 7387776, !39, i64 7387784, !40, i64 7387800, !8, i64 7387816, !15, i64 7387824}
!42 = !{!41, !35, i64 7350000}
!43 = !{!29, !8, i64 348}
!44 = !{!29, !8, i64 652}
!45 = !{!41, !8, i64 56}
!46 = !{!41, !8, i64 40}
...
!66 = !{!41, !8, i64 7349920}
!67 = !{!33, !8, i64 7349816}
!68 = !{!"RiceContext", !8, i64 0, !8, i64 4, !7, i64 8}
!69 = !{!"FlacSubframe", !8, i64 0, !8, i64 4, !8, i64 8, !8, i64 12, !8, i64 16, !7, i64 20, !8, i64 148, !68, i64 152, !7, i64 1184, !7, i64 263328, !7, i64 328864, !7, i64 591004}
!70 = !{!69, !8, i64 12}
!71 = !{!69, !8, i64 8}
!72 = !{!69, !8, i64 152}
...
!99 = distinct !{!99, !49}
!100 = distinct !{!100, !49}
!101 = distinct !{!101, !49, !75, !76}
!102 = distinct !{!102, !49, !75, !76}
!103 = distinct !{!103, !49, !76, !75}
!104 = distinct !{!104, !49, !76, !75}
!105 = distinct !{!105, !49, !75, !76}
!106 = distinct !{!106, !49, !75, !76}
!107 = distinct !{!107, !49, !75, !76}
!108 = distinct !{!108, !49, !76, !75}
!109 = distinct !{!109, !49, !76, !75}
!110 = distinct !{!110, !49, !76, !75}
!111 = distinct !{!111, !49, !75, !76}
!112 = distinct !{!112, !49, !75, !76}
!113 = distinct !{!113, !49, !75, !76}
!114 = distinct !{!114, !49, !76, !75}
!115 = distinct !{!115, !49, !76, !75}
!116 = distinct !{!116, !49, !76, !75}
!117 = distinct !{!117, !49}
!118 = distinct !{!118, !49}
!119 = distinct !{!119, !49}
!120 = distinct !{!120, !49}
...
!136 = distinct !{!136, !49}
!137 = !{!41, !8, i64 72}
!138 = !{!41, !8, i64 7387816}
!139 = !{!41, !15, i64 7387824}
!140 = !{!"AVPacket", !23, i64 0, !15, i64 8, !15, i64 16, !16, i64 24, !8, i64 32, !8, i64 36, !8, i64 40, !25, i64 48, !8, i64 56, !15, i64 64, !15, i64 72, !11, i64 80, !23, i64 88, !17, i64 96}
!141 = !{!140, !15, i64 8}
!142 = !{!"p2 omnipotent char", !27, i64 0}
!143 = !{!"p2 _ZTS11AVBufferRef", !27, i64 0}
!144 = !{!"p1 _ZTS12AVDictionary", !11, i64 0}
!145 = !{!"AVFrame", !7, i64 0, !7, i64 64, !142, i64 96, !8, i64 104, !8, i64 108, !8, i64 112, !8, i64 116, !8, i64 120, !17, i64 124, !15, i64 136, !15, i64 144, !17, i64 152, !8, i64 160, !11, i64 168, !8, i64 176, !8, i64 180, !7, i64 184, !143, i64 248, !8, i64 256, !28, i64 264, !8, i64 272, !8, i64 276, !8, i64 280, !8, i64 284, !8, i64 288, !8, i64 292, !8, i64 296, !15, i64 304, !144, i64 312, !8, i64 320, !23, i64 328, !23, i64 336, !15, i64 344, !15, i64 352, !15, i64 360, !15, i64 368, !11, i64 376, !20, i64 384, !15, i64 408, !8, i64 416}
!146 = !{!145, !8, i64 112}
!147 = !{!16, !16, i64 0}
!148 = !{!"short", !7, i64 0}
!149 = !{!148, !148, i64 0}
!150 = !{!41, !8, i64 7349984}
!151 = !{!33, !8, i64 7349832}
!152 = !{!41, !8, i64 7349940}
!153 = !{!140, !16, i64 24}
!154 = !{!140, !8, i64 32}
!155 = !{!32, !16, i64 8}
!156 = !{!32, !16, i64 24}
...
!173 = distinct !{!173, !49}
!174 = distinct !{!174, !49}
!175 = distinct !{!175, !49, !75, !76}
!176 = distinct !{!176, !49, !76, !75}
end_hunk_1
