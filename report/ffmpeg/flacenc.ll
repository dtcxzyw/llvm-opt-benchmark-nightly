...
vector.body95:                                    ; preds = %vector.body95, %vector.ph93
  ...
  %vec.phi97.a = phi <2 x i64> [ zeroinitializer, %vector.ph93 ], [ %i.cw, %vector.body95 ]
  ...
  %wide.load100.a = load <2 x i32>, ptr %next.gep99, align 4, !tbaa !47
  %wide.load101 = load <2 x i32>, ptr %i.ct, align 4, !tbaa !47
  %i.cu = zext <2 x i32> %wide.load100.a to <2 x i64>
  %i.cv = zext <2 x i32> %wide.load101 to <2 x i64>
  %i.cw = add <2 x i64> %vec.phi97.a, %i.cu       ; 2 uses
