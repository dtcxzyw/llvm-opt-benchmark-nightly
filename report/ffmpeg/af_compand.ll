...
bb.m:                                             ; preds = %bb.l, %bb.e, %bb.c
  %.0 = phi i32 [ %i.bv, %bb.l ], [ %i.q, %bb.e ], [ -12, %bb.c ]
...
update_volume.exit.us:                            ; preds = %update_volume.exit.lr.ph.us, %bb.n
  ...
  %.168114.us = phi i32 [ %i.ar, %update_volume.exit.lr.ph.us ], [ %i.dg, %bb.n ] ; 3 uses
  %.071113.us = phi i32 [ 0, %update_volume.exit.lr.ph.us ], [ %.172.us, %bb.n ] ; 3 uses
  %.175112.us = phi i32 [ %i.aq, %update_volume.exit.lr.ph.us ], [ %.276.us, %bb.n ] ; 3 uses
  ...
  %.not87.us = icmp slt i32 %.175112.us, %i.au
...
bb.h:                                             ; preds = %bb.g, %bb.d
  ...
  %i.bw = sext i32 %.168114.us to i64             ; 2 uses
...
get_volume.exit.us:                               ; preds = %bb.l, %._crit_edge.i.us
  ...
  %i.cx = add nsw i32 %.071113.us, 1
  %i.cy = sext i32 %.071113.us to i64
...
bb.n:                                             ; preds = %bb.m, %get_volume.exit.us
  ...
  %.276.us = phi i32 [ %i.da, %bb.m ], [ %.175112.us, %get_volume.exit.us ] ; 2 uses
  %.172.us = phi i32 [ %.071113.us, %bb.m ], [ %i.cx, %get_volume.exit.us ]
  %i.dd = getelementptr inbounds [8 x i8], ptr %i.an, i64 %.pre-phi
  store double %i.ax, ptr %i.dd, align 8, !tbaa !57
  %i.de = add nsw i32 %.168114.us, 1              ; 2 uses
...
._crit_edge121:                                   ; preds = %._crit_edge.us, %.lr.ph.split, %bb.c
  ...
  %.074.lcssa = phi i32 [ undef, %bb.c ], [ %i.dh, %.lr.ph.split ], [ %.276.us, %._crit_edge.us ]
  %.067.lcssa = phi i32 [ undef, %bb.c ], [ %i.di, %.lr.ph.split ], [ %i.dg, %._crit_edge.us ]
  %i.dk = getelementptr inbounds nuw i8, ptr %i.d, i64 116
  store i32 %.074.lcssa, ptr %i.dk, align 4, !tbaa !42
  %i.dl = getelementptr inbounds nuw i8, ptr %i.d, i64 120
  store i32 %.067.lcssa, ptr %i.dl, align 8, !tbaa !54
  call void @av_frame_free(ptr noundef nonnull %i.a) #12
