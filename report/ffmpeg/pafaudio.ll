...
bb.b:                                             ; preds = %bb.a
  ...
  store i32 %i.i, ptr %i.j, align 8, !tbaa !36
...
vector.body:                                      ; preds = %vector.memcheck
  ...
  store <8 x i16> %wide.load, ptr %i.a, align 16, !tbaa !42
  store <8 x i16> %wide.load47, ptr %i.n, align 16, !tbaa !42
  ...
  store <8 x i16> %wide.load.1, ptr %i.o, align 16, !tbaa !42
  store <8 x i16> %wide.load47.1, ptr %i.p, align 16, !tbaa !42
  ...
  store <8 x i16> %wide.load.2, ptr %i.q, align 16, !tbaa !42
  store <8 x i16> %wide.load47.2, ptr %i.r, align 16, !tbaa !42
  ...
  store <8 x i16> %wide.load.3, ptr %i.s, align 16, !tbaa !42
  store <8 x i16> %wide.load47.3, ptr %i.t, align 16, !tbaa !42
  ...
  store <8 x i16> %wide.load.4, ptr %i.u, align 16, !tbaa !42
  store <8 x i16> %wide.load47.4, ptr %i.v, align 16, !tbaa !42
  ...
  store <8 x i16> %wide.load.5, ptr %i.w, align 16, !tbaa !42
  store <8 x i16> %wide.load47.5, ptr %i.x, align 16, !tbaa !42
  ...
  store <8 x i16> %wide.load.6, ptr %i.y, align 16, !tbaa !42
  store <8 x i16> %wide.load47.6, ptr %i.z, align 16, !tbaa !42
  ...
  store <8 x i16> %wide.load.7, ptr %i.aa, align 16, !tbaa !42
  store <8 x i16> %wide.load47.7, ptr %i.ab, align 16, !tbaa !42
  ...
  store <8 x i16> %wide.load.8, ptr %i.ac, align 16, !tbaa !42
  store <8 x i16> %wide.load47.8, ptr %i.ad, align 16, !tbaa !42
  ...
  store <8 x i16> %wide.load.9, ptr %i.ae, align 16, !tbaa !42
  store <8 x i16> %wide.load47.9, ptr %i.af, align 16, !tbaa !42
  ...
  store <8 x i16> %wide.load.10, ptr %i.ag, align 16, !tbaa !42
  store <8 x i16> %wide.load47.10, ptr %i.ah, align 16, !tbaa !42
  ...
  store <8 x i16> %wide.load.11, ptr %i.ai, align 16, !tbaa !42
  store <8 x i16> %wide.load47.11, ptr %i.aj, align 16, !tbaa !42
  ...
  store <8 x i16> %wide.load.12, ptr %i.ak, align 16, !tbaa !42
  store <8 x i16> %wide.load47.12, ptr %i.al, align 16, !tbaa !42
  ...
  store <8 x i16> %wide.load.13, ptr %i.am, align 16, !tbaa !42
  store <8 x i16> %wide.load47.13, ptr %i.an, align 16, !tbaa !42
  ...
  store <8 x i16> %wide.load.14, ptr %i.ao, align 16, !tbaa !42
  store <8 x i16> %wide.load47.14, ptr %i.ap, align 16, !tbaa !42
  ...
  store <8 x i16> %wide.load.15, ptr %i.aq, align 16, !tbaa !42
  store <8 x i16> %wide.load47.15, ptr %i.ar, align 16, !tbaa !42
...
scalar.ph:                                        ; preds = %vector.memcheck, %scalar.ph
  ...
  store i16 %i.ca, ptr %i.cb, align 8, !tbaa !42
  ...
  store i16 %i.ce, ptr %i.cf, align 2, !tbaa !42
  ...
  store i16 %i.ci, ptr %i.cj, align 4, !tbaa !42
  ...
  store i16 %i.cm, ptr %i.cn, align 2, !tbaa !42
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4 ; 2 uses
  %exitcond.not.3 = icmp eq i64 %indvars.iv.next.3, 256
  br i1 %exitcond.not.3, label %middle.block, label %scalar.ph, !llvm.loop !44
...
bb.c:                                             ; preds = %bb.c, %middle.block
  ...
  store i16 %i.ct, ptr %.12833, align 2, !tbaa !42
  ...
  %i.cz = load i16, ptr %i.cy, align 2, !tbaa !42
  %i.da = getelementptr inbounds nuw i8, ptr %.12833, i64 4
  store i16 %i.cz, ptr %i.cu, align 2, !tbaa !42
  ...
  %i.df = load i16, ptr %i.de, align 2, !tbaa !42
  %i.dg = getelementptr inbounds nuw i8, ptr %.12833, i64 6
  store i16 %i.df, ptr %i.da, align 2, !tbaa !42
  ...
  %i.dl = load i16, ptr %i.dk, align 2, !tbaa !42
  %i.dm = getelementptr inbounds nuw i8, ptr %.12833, i64 8
  store i16 %i.dl, ptr %i.dg, align 2, !tbaa !42
  ...
  %i.dr = load i16, ptr %i.dq, align 2, !tbaa !42
  %i.ds = getelementptr inbounds nuw i8, ptr %.12833, i64 10
  store i16 %i.dr, ptr %i.dm, align 2, !tbaa !42
  ...
  store i16 %i.dx, ptr %i.ds, align 2, !tbaa !42
  %i.dz = add nuw nsw i32 %.135, 6                ; 2 uses
  %exitcond41.not.5 = icmp eq i32 %i.dz, 4410
  br i1 %exitcond41.not.5, label %bb.d, label %bb.c, !llvm.loop !47

bb.d:                                             ; preds = %bb.c
  %i.ea = add nuw nsw i32 %.038, 1                ; 2 uses
  %exitcond42.not = icmp eq i32 %i.ea, %i.g
  br i1 %exitcond42.not, label %._crit_edge, label %vector.memcheck, !llvm.loop !48

._crit_edge:                                      ; preds = %bb.d
  store i32 1, ptr %2, align 4, !tbaa !29
  %i.eb = load i32, ptr %i.e, align 8, !tbaa !35
  br label %bb.e
...
!35 = !{!34, !6, i64 32}
!36 = !{!37, !6, i64 112}
!37 = !{!"AVFrame", !7, i64 0, !7, i64 64, !38, i64 96, !6, i64 104, !6, i64 108, !6, i64 112, !6, i64 116, !6, i64 120, !17, i64 124, !15, i64 136, !15, i64 144, !17, i64 152, !6, i64 160, !12, i64 168, !6, i64 176, !6, i64 180, !7, i64 184, !39, i64 248, !6, i64 256, !27, i64 264, !6, i64 272, !6, i64 276, !6, i64 280, !6, i64 284, !6, i64 288, !6, i64 292, !6, i64 296, !15, i64 304, !40, i64 312, !6, i64 320, !23, i64 328, !23, i64 336, !15, i64 344, !15, i64 352, !15, i64 360, !15, i64 368, !12, i64 376, !20, i64 384, !15, i64 408, !6, i64 416}
!38 = !{!"p2 omnipotent char", !28, i64 0}
!39 = !{!"p2 _ZTS11AVBufferRef", !28, i64 0}
