...
.lr.ph.split.us:                                  ; preds = %.lr.ph, %.loopexit279.us
  ...
  %i.dl = shl i32 %indvars.iv334.tr, 1
...
bb.ai:                                            ; preds = %bb.ah
  ...
  %indvars.iv382.tr506 = trunc i64 %indvars.iv382 to i32
  %i.aev = shl i32 %indvars.iv382.tr506, 8
...
.preheader.us:                                    ; preds = %bb.ah
  ...
  %i.afh = shl i32 %indvars.iv382.tr, 8
...
.thread522:                                       ; preds = %bb.am
  ...
  %indvars.iv366.tr = trunc i64 %indvars.iv366 to i32
  %i.ald = shl i32 %indvars.iv366.tr, 4
...
bb.ck:                                            ; preds = %bb.cj
  ...
  %indvars.iv359.tr = trunc i64 %indvars.iv359 to i32
  %i.aro = shl i32 %indvars.iv359.tr, 4
...
bb.ew:                                            ; preds = %.loopexit.i, %.preheader215.i
  ...
  %i.blx = shl i32 %indvars.iv.i.tr, 1            ; 2 uses
...
bb.bx:                                            ; preds = %.loopexit.i, %.preheader209.i
  ...
  %i.xm = shl i32 %indvars.iv.i.tr, 1             ; 2 uses
...
bb.bj:                                            ; preds = %bb.bi
  ...
  %indvars.iv622.tr = trunc i64 %indvars.iv622 to i32
  %i.aln = shl i32 %indvars.iv622.tr, 4
...
bb.cx:                                            ; preds = %.loopexit.i, %.preheader215.i
  ...
  %i.bdc = shl i32 %indvars.iv.i.tr, 1            ; 2 uses
...
bb.dp:                                            ; preds = %.loopexit.i427, %.preheader215.i423
  ...
  %i.blt = shl i32 %indvars.iv.i424.tr, 1         ; 2 uses
...
bb.bi:                                            ; preds = %.loopexit.i, %.preheader209.i
  ...
  %i.uu = shl i32 %indvars.iv.i.tr, 1             ; 2 uses
...
bb.ca:                                            ; preds = %.loopexit.i160, %.preheader209.i156
  ...
  %i.act = shl i32 %indvars.iv.i157.tr, 1         ; 2 uses
...
bb.bj:                                            ; preds = %.loopexit.i, %.preheader209.i
  ...
  %i.sp = shl i32 %indvars.iv.i.tr, 1             ; 2 uses
...
bb.cb:                                            ; preds = %.loopexit.i153, %.preheader209.i149
  ...
  %i.aao = shl i32 %indvars.iv.i150.tr, 1         ; 2 uses
