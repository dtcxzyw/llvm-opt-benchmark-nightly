...
.preheader105.lr.ph:                              ; preds = %bb.a
  ...
  %i.t = add i32 %smax, 1
  %wide.trip.count = zext i32 %5 to i64           ; 13 uses
  %wide.trip.count125 = zext nneg i32 %5 to i64
  %i.u = add nsw i32 %6, -1
  %i.v = zext i32 %i.u to i64
  %i.w = mul nsw i64 %i.e, %i.v
  %7 = add i64 %i.w, %wide.trip.count             ; 2 uses
  %scevgep = getelementptr i8, ptr %0, i64 %7
  %scevgep130 = getelementptr i8, ptr %3, i64 -3
  %i.x = getelementptr i8, ptr %3, i64 %7
  %scevgep131 = getelementptr i8, ptr %i.x, i64 4
  %i.y = add nsw i32 %6, -1
  %i.z = zext i32 %i.y to i64
  %i.aa = mul nsw i64 %i.e, %i.z
  %8 = add i64 %i.aa, %wide.trip.count            ; 2 uses
  %scevgep154 = getelementptr i8, ptr %2, i64 %8
...
.preheader.preheader:                             ; preds = %.preheader.lr.ph
  ...
  %i.h = mul nsw i64 %i.c, %i.g                   ; 2 uses
