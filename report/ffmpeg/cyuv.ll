...
bb.a:
  ...
  %i.i = load i32, ptr %i.h, align 8, !tbaa !28   ; 2 uses
...
bb.d:                                             ; preds = %bb.b, %bb.a
  ...
  store i32 %.sink, ptr %i.w, align 8, !tbaa !37
...
bb.e:                                             ; preds = %bb.d
  %i.z = load ptr, ptr %1, align 8, !tbaa !38     ; 4 uses
...
.preheader:                                       ; preds = %bb.e
  %i.ag = load i32, ptr %i.f, align 4, !tbaa !35
  %i.ah = load i32, ptr %i.af, align 8, !tbaa !39
...
.lr.ph182:                                        ; preds = %bb.f
  %i.ao = load i32, ptr %i.h, align 8, !tbaa !28
  %i.ap = shl i32 %i.ao, 1
  %i.aq = add i32 %i.ap, 2
  %i.ar = and i32 %i.aq, -4
  %i.as = load i32, ptr %i.f, align 4, !tbaa !35
  %i.at = load i32, ptr %i.af, align 8, !tbaa !39
...
bb.g:                                             ; preds = %bb.g, %.lr.ph182.new
  ...
  %8 = load i32, ptr %i.af, align 8, !tbaa !39
  %9 = sext i32 %8 to i64
  %10 = sub nsw i64 0, %9
  ...
  %i.az = load i32, ptr %i.af, align 8, !tbaa !39
  ...
  br i1 %niter.ncmp.1.not, label %.loopexit.loopexit.unr-lcssa, label %bb.g, !llvm.loop !29
...
bb.h:                                             ; preds = %.lr.ph178, %._crit_edge
  ...
  store i8 %i.bw, ptr %i.bx, align 1, !tbaa !41
  %i.by = getelementptr i8, ptr %i.bf, i64 2
  %i.bz = load i8, ptr %i.by, align 1, !tbaa !41
  ...
  store i8 %i.cf, ptr %i.cg, align 1, !tbaa !41
  ...
  store i8 %i.cl, ptr %i.cm, align 1, !tbaa !41
  %i.cn = load i32, ptr %i.h, align 8, !tbaa !28  ; 2 uses
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  store i8 %i.di, ptr %i.dj, align 1, !tbaa !41
  %i.dk = getelementptr i8, ptr %i.cv, i64 1
  %i.dl = load i8, ptr %i.dk, align 1, !tbaa !41
  ...
  %i.eg = load i8, ptr %i.ef, align 1, !tbaa !41
  %i.eh = add i8 %i.eg, %i.dx                     ; 2 uses
  %i.ei = getelementptr i8, ptr %i.dj, i64 2
  store i8 %i.eh, ptr %i.ei, align 1, !tbaa !41
  ...
  store i8 %i.en, ptr %i.ep, align 1, !tbaa !41
...
.epil.preheader:                                  ; preds = %.loopexit.loopexit.unr-lcssa, %.lr.ph182
  ...
  %14 = load i32, ptr %i.af, align 8, !tbaa !39
...
!30 = distinct !{!30, !40}
!31 = distinct !{!31, !40}
!32 = !{!"AVPacket", !21, i64 0, !13, i64 8, !13, i64 16, !14, i64 24, !6, i64 32, !6, i64 36, !6, i64 40, !23, i64 48, !6, i64 56, !13, i64 64, !13, i64 72, !9, i64 80, !21, i64 88, !15, i64 96}
!33 = !{!32, !14, i64 24}
!34 = !{!32, !6, i64 32}
!35 = !{!27, !6, i64 116}
!36 = !{!27, !6, i64 24}
