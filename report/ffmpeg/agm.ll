...
bb.f:                                             ; preds = %.lr.ph523, %.critedge344
  ...
  %i.bi = load i16, ptr %i.bh, align 2, !tbaa !105 ; 3 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.bv = load i16, ptr %i.bu, align 2, !tbaa !109 ; 2 uses
  %i.bw = sdiv i16 %i.bv, 2
  %.v459 = select i1 %i.ad, i16 %i.bv, i16 %i.bw
  %.sext = sext i16 %.v459 to i32
  %i.bx = sdiv i16 %i.bi, 2
  %.v460 = select i1 %i.ad, i16 %i.bi, i16 %i.bx
  %.sext453 = sext i16 %.v460 to i32
...
bb.m:                                             ; preds = %.lr.ph, %bb.as
  ...
  %i.hv = load i16, ptr %i.hu, align 2, !tbaa !105 ; 3 uses
  %i.hw = sdiv i16 %i.hv, 2
  %.v = select i1 %i.gh, i16 %i.hv, i16 %i.hw
  %.sext456 = sext i16 %.v to i32
  %i.hx = getelementptr inbounds nuw i8, ptr %i.hu, i64 2
  %i.hy = load i16, ptr %i.hx, align 2, !tbaa !109 ; 2 uses
  %i.hz = sdiv i16 %i.hy, 2
  %.v458 = select i1 %i.gh, i16 %i.hy, i16 %i.hz
  %.sext459 = sext i16 %.v458 to i32
