...
tailrecurse._crit_edge:                           ; preds = %tailrecurse, %bb.a
  ...
  %i.t = load ptr, ptr %i.s, align 8, !tbaa !85   ; 7 uses
...
.lr.ph111:                                        ; preds = %.lr.ph111.preheader162, %.lr.ph111
  ...
  %6 = load float, ptr %i.ay, align 4, !tbaa !67
  %i.az = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %indvars.iv
  %7 = or disjoint i64 %indvars.iv, 1             ; 2 uses
  %i.ba = getelementptr inbounds nuw [4 x i8], ptr %i.t, i64 %7
  %8 = load float, ptr %i.ba, align 4, !tbaa !67
  %9 = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %7
  %i.bb = load float, ptr %9, align 4, !tbaa !67
  ...
  %i.bg = fmul nsz <2 x float> %11, %i.bf
  %12 = insertelement <2 x float> poison, float %6, i64 0
  %i.bh = shufflevector <2 x float> %12, <2 x float> poison, <2 x i32> zeroinitializer
