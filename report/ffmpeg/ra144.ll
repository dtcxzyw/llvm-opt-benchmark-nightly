...
ff_copy_and_dup.exit:                             ; preds = %bb.b, %bb.c
  ...
  %i.t = tail call i32 %i.s(ptr noundef nonnull %i.d, ptr noundef nonnull %i.d, i32 noundef 40) #10, !inline_history !40 ; 5 uses
...
bb.g:                                             ; preds = %bb.a, %ff_irms.exit
  ...
  %exitcond.not.i.1.not.a = icmp eq i64 %indvars.iv.next.i, 3
  br i1 %exitcond.not.i.1.not.a, label %bb.i, label %7
...
vector.body:                                      ; preds = %vector.memcheck
  ...
  %wide.load = load <8 x i16>, ptr %i.de, align 4, !tbaa !11, !alias.scope !41, !noalias !42
  %i.dq = sext <8 x i16> %wide.load to <8 x i32>
  %i.dr = mul <8 x i32> %broadcast.splat, %i.dq
  %wide.load51 = load <8 x i8>, ptr %i.df, align 8, !tbaa !14, !alias.scope !43
  %i.ds = sext <8 x i8> %wide.load51 to <8 x i32>
  %i.dt = mul nsw <8 x i32> %broadcast.splat48, %i.ds
  %i.du = add <8 x i32> %i.dt, %i.dr
  %wide.load52 = load <8 x i8>, ptr %i.dg, align 8, !tbaa !14, !alias.scope !44
  ...
  store <8 x i16> %i.dz, ptr %i.dd, align 4, !tbaa !11, !alias.scope !41, !noalias !42
  %i.ea = getelementptr inbounds nuw i8, ptr %0, i64 38656
  %wide.load.1 = load <8 x i16>, ptr %i.ea, align 4, !tbaa !11, !alias.scope !41, !noalias !42
  ...
  %wide.load51.1 = load <8 x i8>, ptr %i.ed, align 8, !tbaa !14, !alias.scope !43
  ...
  %wide.load52.1 = load <8 x i8>, ptr %i.eh, align 8, !tbaa !14, !alias.scope !44
  ...
  store <8 x i16> %i.em, ptr %i.en, align 4, !tbaa !11, !alias.scope !41, !noalias !42
  %i.eo = getelementptr inbounds nuw i8, ptr %0, i64 38672
  %wide.load.2 = load <8 x i16>, ptr %i.eo, align 4, !tbaa !11, !alias.scope !41, !noalias !42
  ...
  %wide.load51.2 = load <8 x i8>, ptr %i.er, align 8, !tbaa !14, !alias.scope !43
  ...
  %wide.load52.2 = load <8 x i8>, ptr %i.ev, align 8, !tbaa !14, !alias.scope !44
  ...
  store <8 x i16> %i.fa, ptr %i.fb, align 4, !tbaa !11, !alias.scope !41, !noalias !42
  %i.fc = getelementptr inbounds nuw i8, ptr %0, i64 38688
  %wide.load.3 = load <8 x i16>, ptr %i.fc, align 4, !tbaa !11, !alias.scope !41, !noalias !42
  ...
  %wide.load51.3 = load <8 x i8>, ptr %i.ff, align 8, !tbaa !14, !alias.scope !43
  ...
  %wide.load52.3 = load <8 x i8>, ptr %i.fj, align 8, !tbaa !14, !alias.scope !44
  ...
  store <8 x i16> %i.fo, ptr %i.fp, align 4, !tbaa !11, !alias.scope !41, !noalias !42
  %i.fq = getelementptr inbounds nuw i8, ptr %0, i64 38704
  %wide.load.4 = load <8 x i16>, ptr %i.fq, align 4, !tbaa !11, !alias.scope !41, !noalias !42
  ...
  %wide.load51.4 = load <8 x i8>, ptr %i.ft, align 8, !tbaa !14, !alias.scope !43
  ...
  %wide.load52.4 = load <8 x i8>, ptr %i.fx, align 8, !tbaa !14, !alias.scope !44
  ...
  store <8 x i16> %i.gc, ptr %i.gd, align 4, !tbaa !11, !alias.scope !41, !noalias !42
...
vector.body70:                                    ; preds = %vector.memcheck53
  ...
  %wide.load72 = load <8 x i8>, ptr %i.df, align 8, !tbaa !14, !alias.scope !45
  %i.ge = sext <8 x i8> %wide.load72 to <8 x i32>
  %i.gf = mul nsw <8 x i32> %broadcast.splat67, %i.ge
  %wide.load73 = load <8 x i8>, ptr %i.dg, align 8, !tbaa !14, !alias.scope !46
  ...
  store <8 x i16> %i.gk, ptr %i.dd, align 4, !tbaa !11, !alias.scope !47, !noalias !48
  %i.gl = getelementptr inbounds nuw i8, ptr %i.df, i64 8
  %wide.load72.1 = load <8 x i8>, ptr %i.gl, align 8, !tbaa !14, !alias.scope !45
  ...
  %wide.load73.1 = load <8 x i8>, ptr %i.go, align 8, !tbaa !14, !alias.scope !46
  ...
  store <8 x i16> %i.gt, ptr %i.gu, align 4, !tbaa !11, !alias.scope !47, !noalias !48
  %i.gv = getelementptr inbounds nuw i8, ptr %i.df, i64 16
  %wide.load72.2 = load <8 x i8>, ptr %i.gv, align 8, !tbaa !14, !alias.scope !45
  ...
  %wide.load73.2 = load <8 x i8>, ptr %i.gy, align 8, !tbaa !14, !alias.scope !46
  ...
  store <8 x i16> %i.hd, ptr %i.he, align 4, !tbaa !11, !alias.scope !47, !noalias !48
  %i.hf = getelementptr inbounds nuw i8, ptr %i.df, i64 24
  %wide.load72.3 = load <8 x i8>, ptr %i.hf, align 8, !tbaa !14, !alias.scope !45
  ...
  %wide.load73.3 = load <8 x i8>, ptr %i.hi, align 8, !tbaa !14, !alias.scope !46
  ...
  store <8 x i16> %i.hn, ptr %i.ho, align 4, !tbaa !11, !alias.scope !47, !noalias !48
  %i.hp = getelementptr inbounds nuw i8, ptr %i.df, i64 32
  %wide.load72.4 = load <8 x i8>, ptr %i.hp, align 8, !tbaa !14, !alias.scope !45
  ...
  %wide.load73.4 = load <8 x i8>, ptr %i.hs, align 8, !tbaa !14, !alias.scope !46
  ...
  store <8 x i16> %i.hx, ptr %i.hy, align 4, !tbaa !11, !alias.scope !47, !noalias !48
end_hunk_0
