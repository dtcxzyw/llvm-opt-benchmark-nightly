...
define void @ff_copy_and_dup(ptr nofree noundef writeonly captures(none) %0, ptr nofree noundef readonly captures(none) %1, i32 noundef %2) local_unnamed_addr #0 {
bb.a:
  %i.a = sub nsw i32 146, %2
  %i.b = sext i32 %i.a to i64
  %i.c = getelementptr inbounds [2 x i8], ptr %1, i64 %i.b ; 2 uses
  %i.d = icmp slt i32 %2, 40
  %i.e = tail call i32 @llvm.smin.i32(i32 %2, i32 40)
  %i.f = sext i32 %i.e to i64
  %i.g = shl nsw i64 %i.f, 1
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 2 %0, ptr align 2 %i.c, i64 %i.g, i1 false)
  br i1 %i.d, label %bb.b, label %bb.c

bb.b:                                             ; preds = %bb.a
  %i.h = sext i32 %2 to i64
  %i.i = getelementptr inbounds [2 x i8], ptr %0, i64 %i.h
  %i.j = shl i32 %2, 1
  %i.k = sub i32 80, %i.j
  %i.l = zext i32 %i.k to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 2 %i.i, ptr nonnull align 2 %i.c, i64 %i.l, i1 false)
  br label %bb.c
...
define range(i32 0, 2) i32 @ff_eval_refl(ptr nofree noundef captures(none) initializes((36, 40)) %0, ptr nofree noundef readonly captures(none) %1, ptr noundef %2) local_unnamed_addr #2 {
bb.a:
  %i.a = alloca [10 x i32], align 16              ; 3 uses
  %i.b = alloca [10 x i32], align 16              ; 7 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #10
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #10
  %i.c = load <4 x i16>, ptr %1, align 2, !tbaa !9
  %i.d = sext <4 x i16> %i.c to <4 x i32>
  store <4 x i32> %i.d, ptr %i.b, align 16, !tbaa !11
  %i.e = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.f = getelementptr inbounds nuw i8, ptr %i.b, i64 16
  %i.g = load <4 x i16>, ptr %i.e, align 2, !tbaa !9
  %i.h = sext <4 x i16> %i.g to <4 x i32>
  store <4 x i32> %i.h, ptr %i.f, align 16, !tbaa !11
  %i.i = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.j = load i16, ptr %i.i, align 2, !tbaa !9
  %i.k = sext i16 %i.j to i32
  %i.l = getelementptr inbounds nuw i8, ptr %i.b, i64 32
  store i32 %i.k, ptr %i.l, align 16, !tbaa !11
  ...
  store i32 %i.o, ptr %i.q, align 4, !tbaa !11
  %i.r = add nsw i32 %i.o, -4096
  %i.s = icmp ult i32 %i.r, -8192
  br i1 %i.s, label %bb.b, label %.preheader

bb.b:                                             ; preds = %bb.a
  tail call void (ptr, i32, ptr, ...) @av_log(ptr noundef %2, i32 noundef 16, ptr noundef nonnull @.str) #10
  br label %.loopexit
...
.preheader:                                       ; preds = %bb.a, %bb.e
  ...
  %i.t = add nuw nsw i64 %indvars.iv55, 1         ; 2 uses
  %i.u = getelementptr inbounds nuw [4 x i8], ptr %.03948, i64 %i.t
  %i.v = load i32, ptr %i.u, align 4, !tbaa !11   ; 2 uses
  %i.w = mul nsw i32 %i.v, %i.v
  %i.x = lshr i32 %i.w, 12                        ; 2 uses
  %i.y = sub nsw i32 4096, %i.x
  %.not = icmp eq i32 %i.x, 4096
  %spec.store.select = select i1 %.not, i32 -2, i32 %i.y
...
.preheader.new:                                   ; preds = %.preheader
  %unroll_iter = and i64 %indvars.iv53, -2
  br label %bb.c

bb.c:                                             ; preds = %bb.c, %.preheader.new
  %indvars.iv = phi i64 [ 0, %.preheader.new ], [ %indvars.iv.next.1, %bb.c ] ; 5 uses
  %niter = phi i64 [ 0, %.preheader.new ], [ %niter.next.1, %bb.c ]
  %i.ac = getelementptr inbounds nuw [4 x i8], ptr %.03948, i64 %indvars.iv
  %i.ad = load i32, ptr %i.ac, align 8, !tbaa !11
  %i.ae = load i32, ptr %i.aa, align 4, !tbaa !11
  %i.af = sub nsw i64 %indvars.iv55, %indvars.iv
  %i.ag = getelementptr inbounds nuw [4 x i8], ptr %.03948, i64 %i.af
  %i.ah = load i32, ptr %i.ag, align 4, !tbaa !11
  %i.ai = mul i32 %i.ah, %i.ae
  %i.aj = ashr i32 %i.ai, 12
  %i.ak = sub nsw i32 %i.ad, %i.aj
  %i.al = mul i32 %i.ak, %i.z
  %i.am = ashr i32 %i.al, 12
  %i.an = getelementptr inbounds nuw [4 x i8], ptr %.04047, i64 %indvars.iv
  store i32 %i.am, ptr %i.an, align 8, !tbaa !11
  %indvars.iv.next = or disjoint i64 %indvars.iv, 1 ; 3 uses
  %i.ao = getelementptr inbounds nuw [4 x i8], ptr %.03948, i64 %indvars.iv.next
  %i.ap = load i32, ptr %i.ao, align 4, !tbaa !11
  %i.aq = load i32, ptr %i.aa, align 4, !tbaa !11
  %i.ar = sub nsw i64 %indvars.iv55, %indvars.iv.next
  %i.as = getelementptr inbounds nuw [4 x i8], ptr %.03948, i64 %i.ar
  %i.at = load i32, ptr %i.as, align 4, !tbaa !11
  %i.au = mul i32 %i.at, %i.aq
  %i.av = ashr i32 %i.au, 12
  %i.aw = sub nsw i32 %i.ap, %i.av
  %i.ax = mul i32 %i.aw, %i.z
  %i.ay = ashr i32 %i.ax, 12
  %i.az = getelementptr inbounds nuw [4 x i8], ptr %.04047, i64 %indvars.iv.next
  store i32 %i.ay, ptr %i.az, align 4, !tbaa !11
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2 ; 2 uses
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %.unr-lcssa, label %bb.c, !llvm.loop !12
...
.epil.preheader:                                  ; preds = %.unr-lcssa, %.preheader
  %indvars.iv.epil.init = phi i64 [ 0, %.preheader ], [ %indvars.iv.next.1, %.unr-lcssa ] ; 3 uses
  %lcmp.mod61 = trunc i64 %indvars.iv53 to i1
  tail call void @llvm.assume(i1 %lcmp.mod61)
  %i.ba = getelementptr inbounds nuw [4 x i8], ptr %.03948, i64 %indvars.iv.epil.init
  %i.bb = load i32, ptr %i.ba, align 4, !tbaa !11
  %i.bc = load i32, ptr %i.aa, align 4, !tbaa !11
  %i.bd = sub nsw i64 %indvars.iv55, %indvars.iv.epil.init
  %i.be = getelementptr inbounds nuw [4 x i8], ptr %.03948, i64 %i.bd
  %i.bf = load i32, ptr %i.be, align 4, !tbaa !11
  %i.bg = mul i32 %i.bf, %i.bc
  %i.bh = ashr i32 %i.bg, 12
  %i.bi = sub nsw i32 %i.bb, %i.bh
  %i.bj = mul i32 %i.bi, %i.z
  %i.bk = ashr i32 %i.bj, 12
  %i.bl = getelementptr inbounds nuw [4 x i8], ptr %.04047, i64 %indvars.iv.epil.init
  store i32 %i.bk, ptr %i.bl, align 4, !tbaa !11
  br label %bb.d

bb.d:                                             ; preds = %.unr-lcssa, %.epil.preheader
  %i.bm = getelementptr inbounds nuw [4 x i8], ptr %.04047, i64 %indvars.iv55
  %i.bn = load i32, ptr %i.bm, align 4, !tbaa !11 ; 2 uses
  %i.bo = add i32 %i.bn, -4096
  %i.bp = icmp ult i32 %i.bo, -8192
  br i1 %i.bp, label %.loopexit, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.bq = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %indvars.iv55
  store i32 %i.bn, ptr %i.bq, align 4, !tbaa !11
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite) uwtable
define void @ff_eval_coefs(ptr nofree noundef captures(none) initializes((0, 40)) %0, ptr nofree noundef readonly captures(none) %1) local_unnamed_addr #0 {
._crit_edge.9:
  %i.a = load i32, ptr %1, align 4, !tbaa !11
  %i.b = shl nsw i32 %i.a, 4                      ; 2 uses
  %i.c = getelementptr inbounds nuw i8, ptr %1, i64 4 ; 2 uses
  %i.d = load i32, ptr %i.c, align 4, !tbaa !11
  %i.e = shl nsw i32 %i.d, 4                      ; 3 uses
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 4 ; 6 uses
  store i32 %i.e, ptr %i.f, align 4, !tbaa !11
  %i.g = load i32, ptr %i.c, align 4, !tbaa !11
  %i.h = mul i32 %i.b, %i.g
  %i.i = ashr i32 %i.h, 12
  %i.j = add nsw i32 %i.i, %i.b                   ; 3 uses
  store i32 %i.j, ptr %0, align 4, !tbaa !11
  %i.k = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.l = load i32, ptr %i.k, align 4, !tbaa !11   ; 3 uses
  %i.m = shl nsw i32 %i.l, 4                      ; 2 uses
  %i.n = mul i32 %i.e, %i.l
  %i.o = ashr i32 %i.n, 12
  %i.p = add nsw i32 %i.o, %i.j                   ; 2 uses
  %i.q = mul i32 %i.j, %i.l
  %i.r = ashr i32 %i.q, 12
  %i.s = add nsw i32 %i.r, %i.e                   ; 2 uses
  %i.t = getelementptr inbounds nuw i8, ptr %1, i64 12 ; 4 uses
  %i.u = load i32, ptr %i.t, align 4, !tbaa !11
  %i.v = shl nsw i32 %i.u, 4                      ; 3 uses
  %i.w = getelementptr inbounds nuw i8, ptr %0, i64 12 ; 5 uses
  store i32 %i.v, ptr %i.w, align 4, !tbaa !11
  %i.x = load i32, ptr %i.t, align 4, !tbaa !11
  %i.y = mul i32 %i.m, %i.x
  %i.z = ashr i32 %i.y, 12
  %i.aa = add nsw i32 %i.z, %i.p
  store i32 %i.aa, ptr %0, align 4, !tbaa !11
  %i.ab = load i32, ptr %i.t, align 4, !tbaa !11
  %i.ac = mul i32 %i.s, %i.ab
  %i.ad = ashr i32 %i.ac, 12
  %i.ae = add nsw i32 %i.ad, %i.s                 ; 3 uses
  store i32 %i.ae, ptr %i.f, align 4, !tbaa !11
  %i.af = load i32, ptr %i.t, align 4, !tbaa !11
  %i.ag = mul i32 %i.p, %i.af
  %i.ah = ashr i32 %i.ag, 12
  %i.ai = add nsw i32 %i.ah, %i.m
  %i.aj = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i32 %i.ai, ptr %i.aj, align 4, !tbaa !11
  %i.ak = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.al = load i32, ptr %i.ak, align 4, !tbaa !11 ; 5 uses
  %i.am = shl nsw i32 %i.al, 4                    ; 2 uses
  %i.an = mul i32 %i.v, %i.al
  %i.ao = ashr i32 %i.an, 12
  %i.ap = load i32, ptr %0, align 4, !tbaa !11    ; 2 uses
  %i.aq = add nsw i32 %i.ao, %i.ap                ; 2 uses
  %i.ar = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.as = load i32, ptr %i.ar, align 4, !tbaa !11 ; 2 uses
  %i.at = mul i32 %i.as, %i.al
  %i.au = ashr i32 %i.at, 12
  %i.av = add nsw i32 %i.au, %i.ae                ; 2 uses
  %i.aw = mul i32 %i.ae, %i.al
  %i.ax = ashr i32 %i.aw, 12
  %i.ay = add nsw i32 %i.ax, %i.as                ; 2 uses
  %i.az = mul i32 %i.ap, %i.al
  %i.ba = ashr i32 %i.az, 12
  %i.bb = add nsw i32 %i.ba, %i.v                 ; 2 uses
  %i.bc = getelementptr inbounds nuw i8, ptr %1, i64 20 ; 6 uses
  %i.bd = load i32, ptr %i.bc, align 4, !tbaa !11
  %i.be = shl nsw i32 %i.bd, 4                    ; 3 uses
  %i.bf = getelementptr inbounds nuw i8, ptr %0, i64 20 ; 4 uses
  store i32 %i.be, ptr %i.bf, align 4, !tbaa !11
  %i.bg = load i32, ptr %i.bc, align 4, !tbaa !11
  %i.bh = mul i32 %i.am, %i.bg
  %i.bi = ashr i32 %i.bh, 12
  %i.bj = add nsw i32 %i.bi, %i.aq
  store i32 %i.bj, ptr %0, align 4, !tbaa !11
  %i.bk = load i32, ptr %i.bc, align 4, !tbaa !11
  %i.bl = mul i32 %i.bb, %i.bk
  %i.bm = ashr i32 %i.bl, 12
  %i.bn = add nsw i32 %i.bm, %i.av                ; 3 uses
  store i32 %i.bn, ptr %i.f, align 4, !tbaa !11
  %i.bo = load i32, ptr %i.bc, align 4, !tbaa !11
  %i.bp = mul i32 %i.ay, %i.bo
  %i.bq = ashr i32 %i.bp, 12
  %i.br = add nsw i32 %i.bq, %i.ay
  %i.bs = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i32 %i.br, ptr %i.bs, align 4, !tbaa !11
  %i.bt = load i32, ptr %i.bc, align 4, !tbaa !11
  %i.bu = mul i32 %i.av, %i.bt
  %i.bv = ashr i32 %i.bu, 12
  %i.bw = add nsw i32 %i.bv, %i.bb                ; 3 uses
  store i32 %i.bw, ptr %i.w, align 4, !tbaa !11
  %i.bx = load i32, ptr %i.bc, align 4, !tbaa !11
  %i.by = mul i32 %i.aq, %i.bx
  %i.bz = ashr i32 %i.by, 12
  %i.ca = add nsw i32 %i.bz, %i.am
  ...
  %i.cd = load i32, ptr %i.cc, align 4, !tbaa !11 ; 7 uses
  %i.ce = shl nsw i32 %i.cd, 4                    ; 2 uses
  %i.cf = mul i32 %i.be, %i.cd
  %i.cg = ashr i32 %i.cf, 12
  %i.ch = load i32, ptr %0, align 4, !tbaa !11    ; 2 uses
  %i.ci = add nsw i32 %i.cg, %i.ch                ; 2 uses
  ...
  %i.cn = add nsw i32 %i.cm, %i.bn                ; 2 uses
  %i.co = mul i32 %i.bw, %i.cd
  %i.cp = ashr i32 %i.co, 12
  %i.cq = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.cr = load i32, ptr %i.cq, align 4, !tbaa !11 ; 2 uses
  %i.cs = add nsw i32 %i.cp, %i.cr                ; 2 uses
  %i.ct = mul i32 %i.cr, %i.cd
  %i.cu = ashr i32 %i.ct, 12
  %i.cv = add nsw i32 %i.cu, %i.bw                ; 2 uses
  %i.cw = mul i32 %i.bn, %i.cd
  %i.cx = ashr i32 %i.cw, 12
  %i.cy = add nsw i32 %i.cx, %i.ck                ; 2 uses
  %i.cz = mul i32 %i.ch, %i.cd
  %i.da = ashr i32 %i.cz, 12
  %i.db = add nsw i32 %i.da, %i.be                ; 2 uses
  %i.dc = getelementptr inbounds nuw i8, ptr %1, i64 28 ; 8 uses
  %i.dd = load i32, ptr %i.dc, align 4, !tbaa !11
  %i.de = shl nsw i32 %i.dd, 4                    ; 3 uses
  %i.df = getelementptr inbounds nuw i8, ptr %0, i64 28 ; 3 uses
  store i32 %i.de, ptr %i.df, align 4, !tbaa !11
  %i.dg = load i32, ptr %i.dc, align 4, !tbaa !11
  %i.dh = mul i32 %i.ce, %i.dg
  %i.di = ashr i32 %i.dh, 12
  %i.dj = add nsw i32 %i.di, %i.ci
  store i32 %i.dj, ptr %0, align 4, !tbaa !11
  %i.dk = load i32, ptr %i.dc, align 4, !tbaa !11
  %i.dl = mul i32 %i.db, %i.dk
  %i.dm = ashr i32 %i.dl, 12
  %i.dn = add nsw i32 %i.dm, %i.cn                ; 3 uses
  store i32 %i.dn, ptr %i.f, align 4, !tbaa !11
  %i.do = load i32, ptr %i.dc, align 4, !tbaa !11
  %i.dp = mul i32 %i.cy, %i.do
  %i.dq = ashr i32 %i.dp, 12
  %i.dr = add nsw i32 %i.dq, %i.cs
  %i.ds = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i32 %i.dr, ptr %i.ds, align 4, !tbaa !11
  %i.dt = load i32, ptr %i.dc, align 4, !tbaa !11
  %i.du = mul i32 %i.cv, %i.dt
  %i.dv = ashr i32 %i.du, 12
  %i.dw = add nsw i32 %i.dv, %i.cv                ; 3 uses
  store i32 %i.dw, ptr %i.w, align 4, !tbaa !11
  %i.dx = load i32, ptr %i.dc, align 4, !tbaa !11
  %i.dy = mul i32 %i.cs, %i.dx
  %i.dz = ashr i32 %i.dy, 12
  %i.ea = add nsw i32 %i.dz, %i.cy
  %i.eb = getelementptr inbounds nuw i8, ptr %0, i64 16
  store i32 %i.ea, ptr %i.eb, align 4, !tbaa !11
  %i.ec = load i32, ptr %i.dc, align 4, !tbaa !11
  %i.ed = mul i32 %i.cn, %i.ec
  %i.ee = ashr i32 %i.ed, 12
  %i.ef = add nsw i32 %i.ee, %i.db                ; 3 uses
  store i32 %i.ef, ptr %i.bf, align 4, !tbaa !11
  %i.eg = load i32, ptr %i.dc, align 4, !tbaa !11
  %i.eh = mul i32 %i.ci, %i.eg
  %i.ei = ashr i32 %i.eh, 12
  %i.ej = add nsw i32 %i.ei, %i.ce
  %i.ek = getelementptr inbounds nuw i8, ptr %0, i64 24
  store i32 %i.ej, ptr %i.ek, align 4, !tbaa !11
  %i.el = getelementptr inbounds nuw i8, ptr %1, i64 32
  %i.em = load i32, ptr %i.el, align 4, !tbaa !11 ; 9 uses
  %i.en = shl nsw i32 %i.em, 4                    ; 2 uses
  %i.eo = mul i32 %i.de, %i.em
  %i.ep = ashr i32 %i.eo, 12
  %i.eq = load i32, ptr %0, align 4, !tbaa !11    ; 2 uses
  %i.er = add nsw i32 %i.ep, %i.eq                ; 2 uses
  %i.es = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.et = load i32, ptr %i.es, align 4, !tbaa !11 ; 2 uses
  ...
  %i.fa = load i32, ptr %i.ez, align 4, !tbaa !11 ; 2 uses
  %i.fb = add nsw i32 %i.ey, %i.fa                ; 2 uses
  %i.fc = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.fd = load i32, ptr %i.fc, align 4, !tbaa !11 ; 2 uses
end_hunk_0
