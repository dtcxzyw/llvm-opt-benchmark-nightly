...
begin_hunk_0_@aac_encode_frame:bb.a
  %i.auc = lshr i32 %i.aty, 24
  %i.aud = trunc nuw i32 %i.auc to i8
  %i.aue = getelementptr inbounds nuw i8, ptr %i.atz, i64 1
  store ptr %i.aue, ptr %i.jy, align 16, !tbaa !83
  store i8 %i.aud, ptr %i.atz, align 1, !tbaa !61
  %i.auf = load i32, ptr %i.jt, align 16, !tbaa !85
  %i.aug = shl i32 %i.auf, 8                      ; 2 uses
  store i32 %i.aug, ptr %i.jt, align 16, !tbaa !85
  %i.auh = load i32, ptr %i.jz, align 4, !tbaa !84 ; 2 uses
  %i.aui = add nsw i32 %i.auh, 8
  store i32 %i.aui, ptr %i.jz, align 4, !tbaa !84
  %i.auj = icmp slt i32 %i.auh, 24
  br i1 %i.auj, label %bb.gh, label %flush_put_bits.exit, !llvm.loop !0
...
flush_put_bits.exit:                              ; preds = %bb.gj, %put_bits.exit614
  ...
  %i.auk = load ptr, ptr %i.jy, align 16, !tbaa !83
  %i.aul = load ptr, ptr %i.jw, align 8, !tbaa !81
  %i.aum = ptrtoint ptr %i.auk to i64
  %i.aun = ptrtoint ptr %i.aul to i64
  %i.auo = sub i64 %i.aum, %i.aun
  %.tr.i617 = trunc i64 %i.auo to i32             ; 2 uses
  %i.aup = shl i32 %.tr.i617, 3
  store i32 %i.aup, ptr %i.ke, align 4, !tbaa !53
  store i32 %.tr.i617, ptr %i.jv, align 8, !tbaa !193
  %i.auq = load float, ptr %i.kh, align 16, !tbaa !56
  %i.aur = getelementptr inbounds nuw i8, ptr %i.d, i64 38248 ; 2 uses
  %i.aus = load float, ptr %i.aur, align 8, !tbaa !86
  %i.aut = fadd nsz float %i.auq, %i.aus
  store float %i.aut, ptr %i.aur, align 8, !tbaa !86
  %i.auu = getelementptr inbounds nuw i8, ptr %i.d, i64 38252 ; 2 uses
  %i.auv = load i32, ptr %i.auu, align 4, !tbaa !87
  %i.auw = add nsw i32 %i.auv, 1
  store i32 %i.auw, ptr %i.auu, align 4, !tbaa !87
  %i.aux = getelementptr inbounds nuw i8, ptr %i.d, i64 38264
  %i.auy = getelementptr inbounds nuw i8, ptr %0, i64 376
  %i.auz = load i32, ptr %i.auy, align 8, !tbaa !54
  %i.ava = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.avb = getelementptr inbounds nuw i8, ptr %1, i64 64
  call void @ff_af_queue_remove(ptr noundef nonnull %i.aux, i32 noundef %i.auz, ptr noundef nonnull %i.ava, ptr noundef nonnull %i.avb) #9
  %i.avc = getelementptr inbounds nuw i8, ptr %1, i64 40 ; 2 uses
  %i.avd = load i32, ptr %i.avc, align 8, !tbaa !224
  %i.ave = or i32 %i.avd, 1
  store i32 %i.ave, ptr %i.avc, align 8, !tbaa !224
  store i32 1, ptr %3, align 4, !tbaa !60
  br label %.loopexit646

.loopexit646:                                     ; preds = %.thread919, %._crit_edge707, %copy_input_samples.exit, %bb.c, %bb.e, %bb.b, %flush_put_bits.exit
  %.4 = phi i32 [ %i.g, %bb.b ], [ %i.jr, %._crit_edge707 ], [ 0, %copy_input_samples.exit ], [ 0, %flush_put_bits.exit ], [ 0, %bb.c ], [ 0, %bb.e ], [ -22, %.thread919 ]
...
put_bits.exit94.us.i:                             ; preds = %bb.e, %bb.d, %bb.c
  ...
  br i1 %i.cm, label %.lr.ph.split.us.i, label %._crit_edge.i, !llvm.loop !227
...
put_bits.exit94.i:                                ; preds = %bb.m, %bb.l, %bb.j
  ...
  br i1 %i.ei, label %.lr.ph.split.i, label %._crit_edge.i, !llvm.loop !227
