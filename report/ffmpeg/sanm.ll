...
bb.bh:                                            ; preds = %bytestream2_get_byte.exit307.thread, %bytestream2_get_byte.exit307, %bb.t
  ...
  %i.if = add nuw nsw i32 %i.ie, %i.bc            ; 2 uses
  %i.ig = zext nneg i32 %i.if to i64
  %i.ih = getelementptr inbounds nuw i8, ptr @c37_mv, i64 %i.ig
  %i.ii = load i8, ptr %i.ih, align 2, !tbaa !49  ; 2 uses
  %i.ij = sext i8 %i.ii to i32
  %6 = zext nneg i32 %i.if to i64
  %7 = getelementptr inbounds nuw i8, ptr @c37_mv, i64 %6
  %i.ik = getelementptr inbounds nuw i8, ptr %7, i64 1
