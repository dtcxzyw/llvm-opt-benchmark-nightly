...
.preheader48:
  ...
  %i.g = getelementptr inbounds nuw i8, ptr %i.d, i64 14
...
.split.us.2:                                      ; preds = %get_pixel16_uv.exit.1.2, %bb.f, %.split.us.1
  ...
  %4 = load <2 x i16>, ptr %i.e, align 4, !tbaa !51
  %5 = zext <2 x i16> %4 to <2 x i32>             ; 4 uses
  %i.ir = shufflevector <2 x i32> %5, <2 x i32> poison, <8 x i32> zeroinitializer
  %i.is = sub nsw <8 x i32> %i.ih, %i.ir          ; 2 uses
  %6 = shufflevector <2 x i32> %5, <2 x i32> poison, <8 x i32> <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>
  %i.it = sub nsw <8 x i32> %i.iq, %6             ; 2 uses
