...
bb.d:                                             ; preds = %bb.c
  ...
  %.085.in.v = select i1 %i.y, i64 8, i64 12
...
bb.g:                                             ; preds = %bb.f, %bb.e
  %.sink108 = phi i64 [ 6124, %bb.f ], [ 6120, %bb.e ]
  %.087 = phi i32 [ -1, %bb.f ], [ 0, %bb.e ]
  %.084 = phi i32 [ 0, %bb.f ], [ 1, %bb.e ]      ; 3 uses
  %.083 = phi ptr [ %i.ap, %bb.f ], [ %i.aj, %bb.e ] ; 2 uses
  %.082 = phi ptr [ %i.al, %bb.f ], [ %i.v, %bb.e ] ; 10 uses
  %i.aq = getelementptr inbounds nuw i8, ptr %0, i64 %.sink108
  %.081.in = load i32, ptr %i.aq, align 4, !tbaa !49
  %.081 = shl nsw i32 %.081.in, 13                ; 2 uses
  %i.ar = sub i32 2097151, %.081                  ; 2 uses
  %i.as = shl i32 %i.ar, 1
...
bb.h:                                             ; preds = %bb.g, %bb.i
  %.089100 = phi i32 [ 63, %bb.g ], [ %i.bi, %bb.i ] ; 4 uses
  %i.av = zext nneg i32 %.089100 to i64
  %i.aw = getelementptr inbounds nuw i8, ptr %.082, i64 %i.av
  ...
  %i.bc = getelementptr inbounds nuw [4 x i8], ptr %.083, i64 %i.ay
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.bi = add nsw i32 %.089100, -1
  %.not94.not = icmp samesign ugt i32 %.089100, %.084
  br i1 %.not94.not, label %bb.h, label %bb.j, !llvm.loop !87

bb.j:                                             ; preds = %bb.h, %bb.i
  %.3 = phi i32 [ %.087, %bb.i ], [ %.089100, %bb.h ] ; 6 uses
  %.not95101 = icmp sgt i32 %.084, %.3
  br i1 %.not95101, label %._crit_edge, label %.lr.ph

.lr.ph:                                           ; preds = %bb.j
  %i.bj = sext i32 %.081 to i64                   ; 2 uses
  %i.bk = zext nneg i32 %.084 to i64
...
bb.k:                                             ; preds = %.lr.ph, %bb.q
  ...
  %.080103 = phi i32 [ 0, %.lr.ph ], [ %.1, %bb.q ] ; 2 uses
  %i.bm = getelementptr inbounds nuw i8, ptr %.082, i64 %indvars.iv
  ...
  %i.bs = getelementptr inbounds nuw [4 x i8], ptr %.083, i64 %i.bo
...
begin_hunk_1_@dct_quantize_trellis_c:bb.a
  %.7564 = phi i32 [ %.1389.lcssa, %.lr.ph567.new ], [ %.8.1, %bb.bc ]
  %.7401563 = phi i32 [ 2013265920, %.lr.ph567.new ], [ %.8402.1, %bb.bc ] ; 2 uses
  %.7411562 = phi i32 [ %.1405.lcssa, %.lr.ph567.new ], [ %.8412.1, %bb.bc ]
  %.7421561 = phi i32 [ %.1415.lcssa, %.lr.ph567.new ], [ %.8422.1, %bb.bc ]
  ...
  %.0355 = add nsw i32 %i.lt, %i.lv               ; 2 uses
  %i.lw = icmp slt i32 %.0355, %.7401563
...
bb.ba:                                            ; preds = %bb.az, %bb.ay
  %.8422 = phi i32 [ %i.ma, %bb.az ], [ %.7421561, %bb.ay ]
  %.8412 = phi i32 [ %i.ly, %bb.az ], [ %.7411562, %bb.ay ]
  %.8402 = phi i32 [ %.0355, %bb.az ], [ %.7401563, %bb.ay ] ; 2 uses
  %.8 = phi i32 [ %i.mb, %bb.az ], [ %.7564, %bb.ay ]
  ...
  %.0355.1 = add nsw i32 %i.md, %i.mf             ; 2 uses
  %i.mg = icmp slt i32 %.0355.1, %.8402
...
bb.bc:                                            ; preds = %bb.bb, %bb.ba
  %.8422.1 = phi i32 [ %i.mk, %bb.bb ], [ %.8422, %bb.ba ] ; 3 uses
  %.8412.1 = phi i32 [ %i.mi, %bb.bb ], [ %.8412, %bb.ba ] ; 3 uses
  %.8402.1 = phi i32 [ %.0355.1, %bb.bb ], [ %.8402, %bb.ba ] ; 3 uses
  %.8.1 = phi i32 [ %i.ml, %bb.bb ], [ %.8, %bb.ba ] ; 3 uses
...
.epil.preheader:                                  ; preds = %.loopexit483.loopexit.unr-lcssa, %.lr.ph567
  ...
  %.7564.epil.init = phi i32 [ %.1389.lcssa, %.lr.ph567 ], [ %.8.1, %.loopexit483.loopexit.unr-lcssa ]
  %.7401563.epil.init = phi i32 [ 2013265920, %.lr.ph567 ], [ %.8402.1, %.loopexit483.loopexit.unr-lcssa ] ; 2 uses
  %.7411562.epil.init = phi i32 [ %.1405.lcssa, %.lr.ph567 ], [ %.8412.1, %.loopexit483.loopexit.unr-lcssa ]
  %.7421561.epil.init = phi i32 [ %.1415.lcssa, %.lr.ph567 ], [ %.8422.1, %.loopexit483.loopexit.unr-lcssa ]
  ...
  %.0355.epil = add nsw i32 %i.mn, %i.mp          ; 2 uses
  %i.mq = icmp slt i32 %.0355.epil, %.7401563.epil.init
...
.loopexit483:                                     ; preds = %.loopexit483.loopexit.unr-lcssa, %bb.bd, %.epil.preheader, %bb.ax, %bb.aw
  %.9423 = phi i32 [ %.1415.lcssa, %bb.aw ], [ %.1415.lcssa, %bb.ax ], [ %.8422.1, %.loopexit483.loopexit.unr-lcssa ], [ %i.mu, %bb.bd ], [ %.7421561.epil.init, %.epil.preheader ]
  %.9413 = phi i32 [ %.1405.lcssa, %bb.aw ], [ %.1405.lcssa, %bb.ax ], [ %.8412.1, %.loopexit483.loopexit.unr-lcssa ], [ %i.ms, %bb.bd ], [ %.7411562.epil.init, %.epil.preheader ]
  %.9403 = phi i32 [ %.1395.lcssa, %bb.aw ], [ 2013265920, %bb.ax ], [ %.8402.1, %.loopexit483.loopexit.unr-lcssa ], [ %.0355.epil, %bb.bd ], [ %.7401563.epil.init, %.epil.preheader ]
  %.9 = phi i32 [ %.1389.lcssa, %bb.aw ], [ %.1389.lcssa, %bb.ax ], [ %.8.1, %.loopexit483.loopexit.unr-lcssa ], [ %i.mv, %bb.bd ], [ %.7564.epil.init, %.epil.preheader ] ; 3 uses
...
bb.bg:                                            ; preds = %.lr.ph579, %bb.bl
  ...
  %.0352577 = phi i32 [ %i.ni, %.lr.ph579 ], [ %spec.select475, %bb.bl ] ; 2 uses
  %.0353576 = phi i32 [ 0, %.lr.ph579 ], [ %spec.select, %bb.bl ]
...
bb.bi:                                            ; preds = %bb.bg
  ...
  %i.nu = mul nsw i32 %i.nt, %.0370
  %i.nv = load i16, ptr %.0434, align 2, !tbaa !48
...
bb.bj:                                            ; preds = %bb.bi, %bb.bh
  %.0351 = phi i32 [ %i.nr, %bb.bh ], [ %i.nz, %bb.bi ]
  %i.oa = shl nsw i32 %.0351, 3
...
bb.bk:                                            ; preds = %bb.bj
  ...
  %i.oi = getelementptr inbounds nuw i8, ptr %.1372, i64 %i.oh
...
bb.bl:                                            ; preds = %bb.bj, %bb.bk
  ...
  %.0 = add nsw i32 %.pn.pre-phi, %i.oe           ; 2 uses
  %i.ol = icmp slt i32 %.0, %.0352577
  %spec.select = select i1 %i.ol, i32 %i.nn, i32 %.0353576 ; 2 uses
  %spec.select475 = tail call i32 @llvm.smin.i32(i32 %.0, i32 %.0352577) ; 2 uses
...
._crit_edge580:                                   ; preds = %bb.bl, %bb.bf
  %.0353.lcssa = phi i32 [ 0, %bb.bf ], [ %spec.select, %bb.bl ] ; 2 uses
  %.0352.lcssa = phi i32 [ %i.ni, %bb.bf ], [ %spec.select475, %bb.bl ]
  %i.om = trunc i32 %.0353.lcssa to i16
  store i16 %i.om, ptr %1, align 2, !tbaa !48
  %i.on = sub nsw i32 %.0352.lcssa, %i.ni
  store i32 %i.on, ptr %i.my, align 4, !tbaa !49
  %i.oo = icmp eq i32 %.0353.lcssa, 0
  %.476 = sext i1 %i.oo to i32
  br label %.loopexit

bb.bm:                                            ; preds = %bb.be
  %i.op = trunc i32 %.9413 to i16
  %i.oq = zext nneg i32 %i.nc to i64
  %i.or = getelementptr inbounds nuw i8, ptr %.0432, i64 %i.oq
  ...
  %.neg = xor i32 %.9423, -1
  %i.ov = add i32 %.9, %.neg                      ; 2 uses
  %i.ow = icmp sgt i32 %i.ov, %.0385
  br i1 %i.ow, label %.lr.ph574, label %.loopexit

.lr.ph574:                                        ; preds = %bb.bm, %.lr.ph574
  %.5380572 = phi i32 [ %i.pi, %.lr.ph574 ], [ %i.ov, %bb.bm ] ; 3 uses
  %i.ox = zext nneg i32 %.5380572 to i64          ; 2 uses
  %i.oy = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %i.ox
  %i.oz = load i32, ptr %i.oy, align 4, !tbaa !49
  %i.pa = trunc i32 %i.oz to i16
  %5 = sext i32 %.5380572 to i64
  %i.pb = getelementptr i8, ptr %.0432, i64 %5
  ...
  %i.pi = add i32 %.5380572, %.neg468             ; 2 uses
  %i.pj = icmp sgt i32 %i.pi, %.0385
...
.loopexit:                                        ; preds = %.lr.ph574, %bb.bm, %.loopexit483, %._crit_edge580, %._crit_edge.thread
  %.1437 = phi i32 [ %.3384, %._crit_edge.thread ], [ %i.nc, %.loopexit483 ], [ %.476, %._crit_edge580 ], [ %i.nc, %bb.bm ], [ %i.nc, %.lr.ph574 ]
