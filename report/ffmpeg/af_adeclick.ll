...
bb.a:
  ...
  %i.ah = load ptr, ptr %i.ag, align 8, !tbaa !48 ; 23 uses
  %i.ai = ptrtoaddr ptr %i.ah to i64              ; 2 uses
  %i.aj = getelementptr inbounds nuw i8, ptr %i.b, i64 184
  %i.ak = load ptr, ptr %i.aj, align 8, !tbaa !68 ; 6 uses
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i
  ...
  %i.ca = load double, ptr %i.bz, align 8, !tbaa !50
  ...
  %i.cm = load double, ptr %i.cl, align 8, !tbaa !50
...
._crit_edge.i.i:                                  ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i, %.preheader.i.i
  ...
  store double %i.co, ptr %i.cp, align 8, !tbaa !50
...
autocorrelation.exit.i:                           ; preds = %._crit_edge.i.i, %bb.a
  ...
  %i.cr = load double, ptr %i.cq, align 8, !tbaa !50
  %i.cs = fneg nsz double %i.cr
  %i.ct = load double, ptr %i.aw, align 8, !tbaa !50
  %i.cu = fdiv nsz double %i.cs, %i.ct            ; 4 uses
  store double %i.cu, ptr %i.ay, align 8, !tbaa !50
  store double %i.cu, ptr %i.at, align 8, !tbaa !50
  %i.cv = load double, ptr %i.aw, align 8, !tbaa !50
...
bb.b:                                             ; preds = %bb.b, %.preheader71.i.new
  ...
  %i.dl = load double, ptr %i.dk, align 8, !tbaa !50
  ...
  %i.ea = load double, ptr %i.dz, align 8, !tbaa !50
...
.epilog-lcssa:                                    ; preds = %bb.c, %.unr-lcssa
  ...
  %i.em = load double, ptr %i.el, align 8, !tbaa !50
  ...
  store double %i.ep, ptr %i.eq, align 8, !tbaa !50
...
vector.body235:                                   ; preds = %vector.body235, %vector.ph233
  ...
  %wide.load237 = load <2 x double>, ptr %i.ev, align 8, !tbaa !50, !alias.scope !194
  %wide.load238 = load <2 x double>, ptr %i.ew, align 8, !tbaa !50, !alias.scope !194
  ...
  %i.ex = load double, ptr %i.eq, align 8, !tbaa !50, !alias.scope !195
  ...
  %wide.load240 = load <2 x double>, ptr %i.ey, align 8, !tbaa !50, !alias.scope !194
  %wide.load241 = load <2 x double>, ptr %i.ez, align 8, !tbaa !50, !alias.scope !194
  ...
  store <2 x double> %reverse242, ptr %i.fd, align 8, !tbaa !50, !alias.scope !196, !noalias !194
  store <2 x double> %reverse243, ptr %i.fe, align 8, !tbaa !50, !alias.scope !196, !noalias !194
  %index.next244 = add nuw i64 %index236, 4       ; 2 uses
  %i.ff = icmp eq i64 %index.next244, %n.vec234
  br i1 %i.ff, label %middle.block245, label %vector.body235, !llvm.loop !157
...
scalar.ph231:                                     ; preds = %scalar.ph231.preheader, %scalar.ph231
  ...
  %i.fh = load double, ptr %i.fg, align 8, !tbaa !50
  %i.fi = load double, ptr %i.eq, align 8, !tbaa !50
  %i.fj = sub nuw nsw i64 %indvars.iv85.i, %indvars.iv87.i
  %i.fk = getelementptr inbounds nuw [8 x i8], ptr %i.ay, i64 %i.fj
  %i.fl = load double, ptr %i.fk, align 8, !tbaa !50
  ...
  store double %i.fm, ptr %i.fn, align 8, !tbaa !50
  %i.fo = icmp sgt i64 %indvars.iv87.i, 1
  br i1 %i.fo, label %scalar.ph231, label %.preheader.i.preheader, !llvm.loop !158
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x double>, ptr %i.fp, align 8, !tbaa !50
  %wide.load229 = load <2 x double>, ptr %i.fq, align 8, !tbaa !50
  %i.fr = getelementptr inbounds nuw [8 x i8], ptr %i.ay, i64 %index ; 2 uses
  %i.fs = getelementptr inbounds nuw i8, ptr %i.fr, i64 16
  store <2 x double> %wide.load, ptr %i.fr, align 8, !tbaa !50
  store <2 x double> %wide.load229, ptr %i.fs, align 8, !tbaa !50
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ft = icmp eq i64 %index.next, %n.vec
  br i1 %i.ft, label %middle.block, label %vector.body, !llvm.loop !159
...
.preheader.i.prol:                                ; preds = %.preheader.i.preheader325, %.preheader.i.prol
  ...
  store double %i.fw, ptr %i.fx, align 8, !tbaa !50
  ...
  br i1 %prol.iter335.cmp.not, label %.preheader.i.prol.loopexit, label %.preheader.i.prol, !llvm.loop !160
