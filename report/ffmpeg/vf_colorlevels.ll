...
bb.a:
  ...
  %4 = load <2 x i32>, ptr %i.t, align 8, !tbaa !34 ; 4 uses
  %5 = extractelement <2 x i32> %4, i64 1         ; 3 uses
  %6 = sext i32 %5 to i64                         ; 5 uses
  %7 = extractelement <2 x i32> %4, i64 0         ; 3 uses
  %i.u = sext i32 %7 to i64                       ; 5 uses
...
.preheader156.us.us.preheader:                    ; preds = %.preheader156.lr.ph
  ...
  %8 = shufflevector <2 x i32> %4, <2 x i32> poison, <8 x i32> <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>
  %9 = shufflevector <2 x i32> %4, <2 x i32> poison, <8 x i32> zeroinitializer
  ...
  %stride.check187 = icmp slt i32 %7, 0
...
.critedge.us.us:                                  ; preds = %bb.e, %..preheader_crit_edge.us.us
  %i.jl = getelementptr inbounds i8, ptr %.0133161.us.us, i64 %6
  %i.jm = getelementptr inbounds i8, ptr %.0132162.us.us, i64 %6
  %i.jn = getelementptr inbounds i8, ptr %.0131163.us.us, i64 %6
  %i.jo = getelementptr inbounds i8, ptr %.0130164.us.us, i64 %6
