...
bb.a:
  ...
  %i.v = load i32, ptr %i.u, align 8, !tbaa !35   ; 4 uses
  %i.w = load i32, ptr %i.t, align 4, !tbaa !36   ; 4 uses
  %i.x = sext i32 %i.w to i64                     ; 5 uses
  %i.y = sext i32 %i.v to i64                     ; 5 uses
  %i.z = load ptr, ptr %1, align 8, !tbaa !38     ; 2 uses
  %i.aa = mul i32 %i.w, %i.n
...
.preheader156.us.us.preheader:                    ; preds = %.preheader156.lr.ph
  ...
  %i.dm = insertelement <8 x i32> poison, i32 %i.w, i64 0
  %i.dn = insertelement <8 x i32> poison, i32 %i.v, i64 0
  ...
  %stride.check187 = icmp slt i32 %i.v, 0
...
vector.body:                                      ; preds = %vector.main.loop.iter.check, %vector.body
  ...
  store <16 x i8> %i.fp, ptr %i.fq, align 1, !tbaa !40, !alias.scope !111, !noalias !112
  ...
  store <16 x i8> %i.fz, ptr %i.ga, align 1, !tbaa !40, !alias.scope !113, !noalias !114
  ...
  store <16 x i8> %i.gj, ptr %i.gk, align 1, !tbaa !40, !alias.scope !115, !noalias !116
  %index.next = add nuw i64 %index, 16            ; 2 uses
  %i.gl = icmp eq i64 %index.next, %n.vec
  br i1 %i.gl, label %middle.block, label %vector.body, !llvm.loop !103
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load289.a = load <4 x i8>, ptr %i.gm, align 1, !tbaa !40, !alias.scope !108
end_hunk_0
...
.preheader156.lr.ph.split.us.split.us:            ; preds = %.preheader156.lr.ph
  ...
  %i.cy = sext i32 %i.f to i64                    ; 4 uses
  ...
  %i.de = shl i64 %i.dd, 1
  %smax = tail call i64 @llvm.smax.i64(i64 %i.cy, i64 %i.cz)
  ...
  %i.dm = shl i64 %i.dl, 1
  %smax206 = tail call i64 @llvm.smax.i64(i64 %i.cy, i64 %i.cz)
  ...
  %i.eb = shl nuw nsw i64 %smax206, 1
...
.preheader156.us.us:                              ; preds = %.critedge.us.us, %.preheader156.lr.ph.split.us.split.us
  %.0125169.us.us = phi i32 [ %i.n, %.preheader156.lr.ph.split.us.split.us ], [ %i.jx, %.critedge.us.us ]
  %.0126168.us.us = phi ptr [ %i.av, %.preheader156.lr.ph.split.us.split.us ], [ %i.jw, %.critedge.us.us ] ; 3 uses
  %.0127167.us.us = phi ptr [ %i.as, %.preheader156.lr.ph.split.us.split.us ], [ %i.jv, %.critedge.us.us ] ; 3 uses
  %.0128166.us.us = phi ptr [ %i.ap, %.preheader156.lr.ph.split.us.split.us ], [ %i.ju, %.critedge.us.us ] ; 3 uses
  %.0129165.us.us = phi ptr [ %i.am, %.preheader156.lr.ph.split.us.split.us ], [ %i.jt, %.critedge.us.us ] ; 3 uses
  %.0130164.us.us = phi ptr [ %i.aj, %.preheader156.lr.ph.split.us.split.us ], [ %i.js, %.critedge.us.us ] ; 3 uses
  %.0131163.us.us = phi ptr [ %i.ag, %.preheader156.lr.ph.split.us.split.us ], [ %i.jr, %.critedge.us.us ] ; 3 uses
  %.0132162.us.us = phi ptr [ %i.ad, %.preheader156.lr.ph.split.us.split.us ], [ %i.jq, %.critedge.us.us ] ; 3 uses
  %.0133161.us.us = phi ptr [ %i.aa, %.preheader156.lr.ph.split.us.split.us ], [ %i.jp, %.critedge.us.us ] ; 3 uses
  %or.cond.not = xor i1 %or.cond, true
...
vector.body:                                      ; preds = %.lr.ph159.split.us.us.preheader, %vector.body
  ...
  %i.ir = getelementptr inbounds [2 x i8], ptr %.0130164.us.us, i64 %index
  %wide.load = load <8 x i16>, ptr %i.ir, align 2, !tbaa !49, !alias.scope !144
  %i.is = zext <8 x i16> %wide.load to <8 x i32>
  %i.it = sub nsw <8 x i32> %i.is, %broadcast.splat
  %i.iu = sitofp nsz <8 x i32> %i.it to <8 x float>
  %i.iv = tail call nsz <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.iu, <8 x float> %broadcast.splat200, <8 x float> %broadcast.splat202)
  %i.iw = fptosi <8 x float> %i.iv to <8 x i32>   ; 3 uses
  %i.ix = icmp ult <8 x i32> %i.iw, splat (i32 65536)
  %i.iy = icmp sgt <8 x i32> %i.iw, splat (i32 -1)
  %i.iz = sext <8 x i1> %i.iy to <8 x i16>
  %i.ja = trunc nuw <8 x i32> %i.iw to <8 x i16>
  %i.jb = select <8 x i1> %i.ix, <8 x i16> %i.ja, <8 x i16> %i.iz
  %i.jc = getelementptr inbounds [2 x i8], ptr %.0126168.us.us, i64 %index
  store <8 x i16> %i.jb, ptr %i.jc, align 2, !tbaa !49, !alias.scope !145, !noalias !144
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.jd = icmp eq i64 %index.next, %n.vec
  br i1 %i.jd, label %middle.block, label %vector.body, !llvm.loop !132
...
.lr.ph159.split.us.us:                            ; preds = %.lr.ph159.split.us.us.preheader320, %.lr.ph159.split.us.us
  ...
  %i.je = getelementptr inbounds [2 x i8], ptr %.0130164.us.us, i64 %indvars.iv190
  %i.jf = load i16, ptr %i.je, align 2, !tbaa !49
  %i.jg = zext i16 %i.jf to i32
  %i.jh = sub nsw i32 %i.jg, %i.by
  %i.ji = sitofp nsz i32 %i.jh to float
  %i.jj = tail call nsz float @llvm.fmuladd.f32(float %i.ji, float %i.ch, float %i.cr)
  %i.jk = fptosi float %i.jj to i32               ; 3 uses
  %.not.i.us.us = icmp ult i32 %i.jk, 65536
  %isnotneg.i.us.us = icmp sgt i32 %i.jk, -1
  %i.jl = sext i1 %isnotneg.i.us.us to i16
  %i.jm = trunc nuw i32 %i.jk to i16
  %.0.i.us.us = select i1 %.not.i.us.us, i16 %i.jm, i16 %i.jl
  %i.jn = getelementptr inbounds [2 x i8], ptr %.0126168.us.us, i64 %indvars.iv190
  store i16 %.0.i.us.us, ptr %i.jn, align 2, !tbaa !49
  %indvars.iv.next191 = add nsw i64 %indvars.iv190, %i.cy ; 2 uses
  %i.jo = icmp slt i64 %indvars.iv.next191, %i.cz
  br i1 %i.jo, label %.lr.ph159.split.us.us, label %.critedge.us.us, !llvm.loop !133

.critedge.us.us:                                  ; preds = %.lr.ph159.split.us.us, %middle.block, %..preheader_crit_edge.us.us
  %i.jp = getelementptr inbounds [2 x i8], ptr %.0133161.us.us, i64 %i.cs
  %i.jq = getelementptr inbounds [2 x i8], ptr %.0132162.us.us, i64 %i.cs
  %i.jr = getelementptr inbounds [2 x i8], ptr %.0131163.us.us, i64 %i.cs
  %i.js = getelementptr inbounds [2 x i8], ptr %.0130164.us.us, i64 %i.cs
  %i.jt = getelementptr inbounds [2 x i8], ptr %.0129165.us.us, i64 %i.cu
  %i.ju = getelementptr inbounds [2 x i8], ptr %.0128166.us.us, i64 %i.cu
  %i.jv = getelementptr inbounds [2 x i8], ptr %.0127167.us.us, i64 %i.cu
  %i.jw = getelementptr inbounds [2 x i8], ptr %.0126168.us.us, i64 %i.cu
  %i.jx = add nsw i32 %.0125169.us.us, 1          ; 2 uses
  %exitcond.not = icmp eq i32 %i.jx, %i.s
  br i1 %exitcond.not, label %._crit_edge, label %.preheader156.us.us, !llvm.loop !134
...
vector.body:                                      ; preds = %vector.main.loop.iter.check, %vector.body
  %index = phi i64 [ %index.next, %vector.body ], [ 0, %vector.main.loop.iter.check ] ; 7 uses
  %i.fb = getelementptr inbounds i8, ptr %.0133161.us.us, i64 %index
  %wide.load = load <16 x i8>, ptr %i.fb, align 1, !tbaa !40, !alias.scope !167
  %i.fc = zext <16 x i8> %wide.load to <16 x i32>
  %i.fd = getelementptr inbounds i8, ptr %.0132162.us.us, i64 %index
  %wide.load267.a = load <16 x i8>, ptr %i.fd, align 1, !tbaa !40, !alias.scope !168
  %i.fe = zext <16 x i8> %wide.load267.a to <16 x i32>
  %i.ff = getelementptr inbounds i8, ptr %.0131163.us.us, i64 %index
  %wide.load268 = load <16 x i8>, ptr %i.ff, align 1, !tbaa !40, !alias.scope !169
  %i.fg = zext <16 x i8> %wide.load268 to <16 x i32>
  %i.fh = sub nsw <16 x i32> %i.fc, %broadcast.splat
  %i.fi = sitofp nsz <16 x i32> %i.fh to <16 x float>
  %i.fj = tail call nsz <16 x float> @llvm.fmuladd.v16f32(<16 x float> %i.fi, <16 x float> %broadcast.splat252, <16 x float> %broadcast.splat254)
  ...
  %i.fp = select <16 x i1> %i.fl, <16 x i8> %i.fo, <16 x i8> %i.fn
  %i.fq = getelementptr inbounds i8, ptr %.0129165.us.us, i64 %index
  store <16 x i8> %i.fp, ptr %i.fq, align 1, !tbaa !40, !alias.scope !170, !noalias !171
  %i.fr = sub nsw <16 x i32> %i.fe, %broadcast.splat256
  %i.fs = sitofp nsz <16 x i32> %i.fr to <16 x float>
  %i.ft = tail call nsz <16 x float> @llvm.fmuladd.v16f32(<16 x float> %i.fs, <16 x float> %broadcast.splat258, <16 x float> %broadcast.splat260)
  %i.fu = fptosi <16 x float> %i.ft to <16 x i32> ; 3 uses
  ...
  %i.fz = select <16 x i1> %i.fv, <16 x i8> %i.fy, <16 x i8> %i.fx
  %i.ga = getelementptr inbounds i8, ptr %.0128166.us.us, i64 %index
  store <16 x i8> %i.fz, ptr %i.ga, align 1, !tbaa !40, !alias.scope !172, !noalias !173
  %i.gb = sub nsw <16 x i32> %i.fg, %broadcast.splat262
  %i.gc = sitofp nsz <16 x i32> %i.gb to <16 x float>
  %i.gd = tail call nsz <16 x float> @llvm.fmuladd.v16f32(<16 x float> %i.gc, <16 x float> %broadcast.splat264, <16 x float> %broadcast.splat266)
  %i.ge = fptosi <16 x float> %i.gd to <16 x i32> ; 3 uses
  ...
  %i.gj = select <16 x i1> %i.gf, <16 x i8> %i.gi, <16 x i8> %i.gh
  %i.gk = getelementptr inbounds i8, ptr %.0127167.us.us, i64 %index
  store <16 x i8> %i.gj, ptr %i.gk, align 1, !tbaa !40, !alias.scope !174, !noalias !175
  %index.next = add nuw i64 %index, 16            ; 2 uses
  %i.gl = icmp eq i64 %index.next, %n.vec
  br i1 %i.gl, label %middle.block, label %vector.body, !llvm.loop !162
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index288 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next292, %vec.epilog.vector.body ] ; 7 uses
  %i.gm = getelementptr inbounds i8, ptr %.0133161.us.us, i64 %index288
  %wide.load289.a = load <4 x i8>, ptr %i.gm, align 1, !tbaa !40, !alias.scope !167
end_hunk_2
...
.preheader156.us.preheader:                       ; preds = %.preheader156.lr.ph
  ...
  %i.db = sext i32 %i.f to i64                    ; 4 uses
  ...
  %i.dj = shl i64 %i.di, 1
  %smax = tail call i64 @llvm.smax.i64(i64 %i.db, i64 %i.dc)
  ...
  %i.dr = shl i64 %i.dq, 1
  %smax204 = tail call i64 @llvm.smax.i64(i64 %i.db, i64 %i.dc)
  ...
  %i.eg = shl nuw nsw i64 %smax204, 1
...
vector.body:                                      ; preds = %.lr.ph159.split.us.us.preheader, %vector.body
  %index = phi i64 [ %index.next, %vector.body ], [ 0, %.lr.ph159.split.us.us.preheader ] ; 3 uses
  %i.ir = getelementptr inbounds [2 x i8], ptr %.0130164.us.us, i64 %index
  %wide.load = load <8 x i16>, ptr %i.ir, align 2, !tbaa !49, !alias.scope !343
  %i.is = zext <8 x i16> %wide.load to <8 x i32>
  %i.it = sub nsw <8 x i32> %i.is, %broadcast.splat
  %i.iu = sitofp nsz <8 x i32> %i.it to <8 x float>
  %i.iv = tail call nsz <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.iu, <8 x float> %broadcast.splat200, <8 x float> %broadcast.splat202)
  ...
  %i.jb = select <8 x i1> %i.ix, <8 x i16> %i.ja, <8 x i16> %i.iz
  %i.jc = getelementptr inbounds [2 x i8], ptr %.0126168.us.us, i64 %index
  store <8 x i16> %i.jb, ptr %i.jc, align 2, !tbaa !49, !alias.scope !344, !noalias !343
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.jd = icmp eq i64 %index.next, %n.vec
  br i1 %i.jd, label %middle.block, label %vector.body, !llvm.loop !331
...
.lr.ph159.split.us.us:                            ; preds = %.lr.ph159.split.us.us.preheader320, %.lr.ph159.split.us.us
  ...
  %indvars.iv.next191 = add nsw i64 %indvars.iv190, %i.cy ; 2 uses
  %i.jo = icmp slt i64 %indvars.iv.next191, %i.cz
  br i1 %i.jo, label %.lr.ph159.split.us.us, label %.critedge.us.us, !llvm.loop !332
...
.critedge.us.us:                                  ; preds = %.lr.ph159.split.us.us, %middle.block, %..preheader_crit_edge.us.us
  ...
  %i.jx = add nsw i32 %.0125169.us.us, 1          ; 2 uses
  %exitcond.not = icmp eq i32 %i.jx, %i.s
  br i1 %exitcond.not, label %._crit_edge, label %.preheader156.us.us, !llvm.loop !333
...
.preheader141.lr.ph.split.us.split.us:            ; preds = %.preheader141.lr.ph
  ...
  %i.cz = shl i64 %i.cy, 2
  %smax = tail call i64 @llvm.smax.i64(i64 %i.ct, i64 %i.cu)
  ...
  %i.dh = shl i64 %i.dg, 2
  %smax189 = tail call i64 @llvm.smax.i64(i64 %i.ct, i64 %i.cu)
  ...
  %i.dw = shl nuw nsw i64 %smax189, 2
...
.preheader141.us.us:                              ; preds = %.critedge.us.us, %.preheader141.lr.ph.split.us.split.us
  %.0125154.us.us = phi i32 [ %i.n, %.preheader141.lr.ph.split.us.split.us ], [ %i.ia, %.critedge.us.us ]
  %.0126153.us.us = phi ptr [ %i.av, %.preheader141.lr.ph.split.us.split.us ], [ %i.hz, %.critedge.us.us ] ; 3 uses
  %.0127152.us.us = phi ptr [ %i.as, %.preheader141.lr.ph.split.us.split.us ], [ %i.hy, %.critedge.us.us ] ; 3 uses
  %.0128151.us.us = phi ptr [ %i.ap, %.preheader141.lr.ph.split.us.split.us ], [ %i.hx, %.critedge.us.us ] ; 3 uses
  %.0129150.us.us = phi ptr [ %i.am, %.preheader141.lr.ph.split.us.split.us ], [ %i.hw, %.critedge.us.us ] ; 3 uses
  %.0130149.us.us = phi ptr [ %i.aj, %.preheader141.lr.ph.split.us.split.us ], [ %i.hv, %.critedge.us.us ] ; 3 uses
  %.0131148.us.us = phi ptr [ %i.ag, %.preheader141.lr.ph.split.us.split.us ], [ %i.hu, %.critedge.us.us ] ; 3 uses
  %.0132147.us.us = phi ptr [ %i.ad, %.preheader141.lr.ph.split.us.split.us ], [ %i.ht, %.critedge.us.us ] ; 3 uses
  %.0133146.us.us = phi ptr [ %i.aa, %.preheader141.lr.ph.split.us.split.us ], [ %i.hs, %.critedge.us.us ] ; 3 uses
  %or.cond.not = xor i1 %or.cond, true
...
vector.body:                                      ; preds = %.lr.ph144.split.us.us.preheader, %vector.body
  ...
  %i.hd = getelementptr inbounds [4 x i8], ptr %.0130149.us.us, i64 %index ; 2 uses
  %i.he = getelementptr inbounds nuw i8, ptr %i.hd, i64 16
  %wide.load = load <4 x float>, ptr %i.hd, align 4, !tbaa !47, !alias.scope !378
  %wide.load185 = load <4 x float>, ptr %i.he, align 4, !tbaa !47, !alias.scope !378
  %i.hf = fsub nsz <4 x float> %wide.load, %broadcast.splat
  %i.hg = fsub nsz <4 x float> %wide.load185, %broadcast.splat
  %i.hh = tail call nsz <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.hf, <4 x float> %broadcast.splat182, <4 x float> %broadcast.splat184)
  %i.hi = tail call nsz <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.hg, <4 x float> %broadcast.splat182, <4 x float> %broadcast.splat184)
  %i.hj = getelementptr inbounds [4 x i8], ptr %.0126153.us.us, i64 %index ; 2 uses
  %i.hk = getelementptr inbounds nuw i8, ptr %i.hj, i64 16
  store <4 x float> %i.hh, ptr %i.hj, align 4, !tbaa !47, !alias.scope !379, !noalias !378
  store <4 x float> %i.hi, ptr %i.hk, align 4, !tbaa !47, !alias.scope !379, !noalias !378
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.hl = icmp eq i64 %index.next, %n.vec
  br i1 %i.hl, label %middle.block, label %vector.body, !llvm.loop !366
...
.lr.ph144.split.us.us:                            ; preds = %.lr.ph144.split.us.us.preheader303, %.lr.ph144.split.us.us
  ...
  %i.hm = getelementptr inbounds [4 x i8], ptr %.0130149.us.us, i64 %indvars.iv172
  %i.hn = load float, ptr %i.hm, align 4, !tbaa !47
  %i.ho = fsub nsz float %i.hn, %i.fw
  %i.hp = tail call nsz float @llvm.fmuladd.f32(float %i.ho, float %i.ck, float %i.fx)
  %i.hq = getelementptr inbounds [4 x i8], ptr %.0126153.us.us, i64 %indvars.iv172
  store float %i.hp, ptr %i.hq, align 4, !tbaa !47
  %indvars.iv.next173 = add nsw i64 %indvars.iv172, %i.ct ; 2 uses
  %i.hr = icmp slt i64 %indvars.iv.next173, %i.cu
  br i1 %i.hr, label %.lr.ph144.split.us.us, label %.critedge.us.us, !llvm.loop !367

.critedge.us.us:                                  ; preds = %.lr.ph144.split.us.us, %middle.block, %..preheader_crit_edge.us.us
  %i.hs = getelementptr inbounds [4 x i8], ptr %.0133146.us.us, i64 %i.cn
  %i.ht = getelementptr inbounds [4 x i8], ptr %.0132147.us.us, i64 %i.cn
  %i.hu = getelementptr inbounds [4 x i8], ptr %.0131148.us.us, i64 %i.cn
  %i.hv = getelementptr inbounds [4 x i8], ptr %.0130149.us.us, i64 %i.cn
  %i.hw = getelementptr inbounds [4 x i8], ptr %.0129150.us.us, i64 %i.cp
  %i.hx = getelementptr inbounds [4 x i8], ptr %.0128151.us.us, i64 %i.cp
  %i.hy = getelementptr inbounds [4 x i8], ptr %.0127152.us.us, i64 %i.cp
  %i.hz = getelementptr inbounds [4 x i8], ptr %.0126153.us.us, i64 %i.cp
  %i.ia = add nsw i32 %.0125154.us.us, 1          ; 2 uses
  %exitcond.not = icmp eq i32 %i.ia, %i.s
  br i1 %exitcond.not, label %._crit_edge, label %.preheader141.us.us, !llvm.loop !368
