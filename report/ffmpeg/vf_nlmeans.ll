...
.preheader.preheader.i.i:                         ; preds = %._crit_edge82.i
  ...
  %scevgep52 = getelementptr i8, ptr %i.dk, i64 %i.dr ; 3 uses
  %i.ds = mul nsw i64 %i.am, %i.do
  %i.dt = getelementptr i8, ptr %i.aj, i64 %i.ds
  %scevgep53 = getelementptr i8, ptr %i.dt, i64 %wide.trip.count.i.i ; 3 uses
  %i.du = mul nsw i64 %i.at, %i.do
  %i.dv = getelementptr i8, ptr %i.ap, i64 %i.du
  %scevgep54 = getelementptr i8, ptr %i.dv, i64 %wide.trip.count.i.i ; 3 uses
  ...
  %bound0 = icmp ult ptr %i.dl, %scevgep52
  %bound1 = icmp ult ptr %i.dk, %scevgep
  %found.conflict = and i1 %bound0, %bound1
  %stride.check = icmp slt i32 %i.dg, 0
  %bound056 = icmp ult ptr %i.dl, %scevgep53
  %bound157 = icmp ult ptr %i.aj, %scevgep
  %found.conflict58 = and i1 %bound056, %bound157
  %i.eb = or <4 x i32> %i.dy, %i.ea
  %bound061 = icmp ult ptr %i.dl, %scevgep54
  %bound162 = icmp ult ptr %i.ap, %scevgep
  %found.conflict63 = and i1 %bound061, %bound162
  %bound067 = icmp ult ptr %i.dk, %scevgep53
  %bound168 = icmp ult ptr %i.aj, %scevgep52
  %found.conflict69 = and i1 %bound067, %bound168
  %bound073 = icmp ult ptr %i.dk, %scevgep54
  %bound174 = icmp ult ptr %i.ap, %scevgep52
  %found.conflict75 = and i1 %bound073, %bound174
  %i.ec = icmp slt <4 x i32> %i.eb, zeroinitializer
  %bound079 = icmp ult ptr %i.aj, %scevgep54
  %bound180 = icmp ult ptr %i.ap, %scevgep53
  ...
  %op.rdx88 = or i1 %i.ee, %found.conflict
  %op.rdx89 = or i1 %found.conflict58, %found.conflict63
  %op.rdx90 = or i1 %found.conflict69, %found.conflict75
  %op.rdx91 = or i1 %op.rdx, %op.rdx88
  %op.rdx92 = or i1 %op.rdx89, %op.rdx90
  %op.rdx93 = or i1 %op.rdx91, %op.rdx92
  %op.rdx94 = or i1 %op.rdx93, %found.conflict81
...
.preheader.i.i:                                   ; preds = %._crit_edge.i.i, %.preheader.preheader.i.i
  ...
  %brmerge = select i1 %min.iters.check, i1 true, i1 %op.rdx94
...
vector.body:                                      ; preds = %.preheader.i.i, %vector.body
  ...
  %wide.load85 = load <4 x i8>, ptr %i.ej, align 1, !tbaa !75, !alias.scope !76
  %i.ek = uitofp <4 x i8> %wide.load85 to <4 x float>
  %i.el = getelementptr inbounds nuw [4 x i8], ptr %.02931.i.i, i64 %index ; 2 uses
  %wide.load86 = load <4 x float>, ptr %i.el, align 4, !tbaa !31, !alias.scope !77, !noalias !78
  %i.em = fadd nsz <4 x float> %wide.load86, %i.ek ; 2 uses
  store <4 x float> %i.em, ptr %i.el, align 4, !tbaa !31, !alias.scope !77, !noalias !78
  %wide.load87 = load <4 x float>, ptr %i.eh, align 4, !tbaa !31, !alias.scope !68, !noalias !71
  %i.en = fdiv nsz <4 x float> %i.em, %wide.load87
...
.lr.ph.i122.i.i:                                  ; preds = %._crit_edge.i133.i.i, %.lr.ph.preheader.i121.i.i
  ...
  %i.iq = trunc nsw i64 %indvars.iv72.i123.i.i to i32 ; 2 uses
  %3 = sub i32 %i.iq, %i.av
  %..i59.i124.i.i = call i32 @llvm.smin.i32(i32 %3, i32 %i.bv)
  %i.ir = sub i32 %i.iq, %i.cn                    ; 2 uses
...
.lr.ph.i138.i.i:                                  ; preds = %.lr.ph69.i136.i.i, %._crit_edge.i149.i.i
  %indvars.iv72.i139.i.i = phi i64 [ %indvars.iv.next73.i150.i.i, %._crit_edge.i149.i.i ], [ %i.cv, %.lr.ph69.i136.i.i ] ; 4 uses
  ...
  %i.kx = trunc nsw i64 %indvars.iv72.i139.i.i to i32 ; 2 uses
  %4 = sub i32 %i.kx, %i.av
  %..i59.i140.i.i = call i32 @llvm.smin.i32(i32 %4, i32 %i.bv)
  %i.ky = sub i32 %i.kx, %i.cn                    ; 2 uses
...
bb.n:                                             ; preds = %._crit_edge, %bb.b
  %.0 = phi i32 [ %i.ad, %._crit_edge ], [ -12, %bb.b ]
  ret i32 %.0
}
