...
begin_hunk_0_@ff_ivi_inverse_haar_8x8:bb.a
  ...
  %i.na = load i32, ptr %i.mz, align 4, !tbaa !32 ; 2 uses
  ...
  %i.ng = load i32, ptr %i.nf, align 4, !tbaa !32 ; 2 uses
  ...
  %i.nm = load i32, ptr %i.nl, align 4, !tbaa !32 ; 2 uses
  ...
  %i.ns = load i32, ptr %i.nr, align 4, !tbaa !32 ; 2 uses
...
bb.o:                                             ; preds = %bb.n, %bb.m
  ...
  store i32 %.sink178.6, ptr %i.nx, align 4, !tbaa !32
  %i.ny = getelementptr inbounds nuw i8, ptr %i.ma, i64 %.sink177.6
  store i32 %.sink175.6, ptr %i.ny, align 4, !tbaa !32
  %i.nz = getelementptr inbounds nuw i8, ptr %i.a, i64 184
  store i32 %.sink173.6, ptr %i.nz, align 4, !tbaa !32
  %i.oa = getelementptr inbounds nuw i8, ptr %i.ma, i64 %.sink172.6
  store i32 %.sink170.6, ptr %i.oa, align 4, !tbaa !32
  %i.ob = getelementptr inbounds nuw i8, ptr %i.ma, i64 %.sink169.6
  store i32 %.sink167.6, ptr %i.ob, align 4, !tbaa !32
  %i.oc = getelementptr inbounds nuw i8, ptr %i.a, i64 88
  store i32 %.sink165.6, ptr %i.oc, align 4, !tbaa !32
  %i.od = getelementptr inbounds nuw i8, ptr %i.a, i64 56
  store i32 %.sink164.6, ptr %i.od, align 4, !tbaa !32
  store i32 %.sink.6, ptr %i.ma, align 4, !tbaa !32
...
bb.p:                                             ; preds = %bb.o
  ...
  %i.oi = load i32, ptr %i.oh, align 4, !tbaa !32
  %i.oj = getelementptr inbounds nuw i8, ptr %0, i64 60
  %i.ok = load i32, ptr %i.oj, align 4, !tbaa !32
  %i.ol = getelementptr inbounds nuw i8, ptr %0, i64 92
  %i.om = load i32, ptr %i.ol, align 4, !tbaa !32 ; 2 uses
  %i.on = getelementptr inbounds nuw i8, ptr %0, i64 124
  %i.oo = load i32, ptr %i.on, align 4, !tbaa !32 ; 2 uses
  ...
  %i.pe = load i32, ptr %i.pd, align 4, !tbaa !32 ; 2 uses
  ...
  %i.pk = load i32, ptr %i.pj, align 4, !tbaa !32 ; 2 uses
  ...
  %i.pq = load i32, ptr %i.pp, align 4, !tbaa !32 ; 2 uses
  ...
  %i.pw = load i32, ptr %i.pv, align 4, !tbaa !32 ; 2 uses
...
.preheader.preheader:                             ; preds = %bb.p, %bb.o
  ...
  store i32 %.sink178.7, ptr %i.qb, align 4, !tbaa !32
  %i.qc = getelementptr inbounds nuw i8, ptr %i.oe, i64 %.sink177.7
  store i32 %.sink175.7, ptr %i.qc, align 4, !tbaa !32
  %i.qd = getelementptr inbounds nuw i8, ptr %i.a, i64 188
  store i32 %.sink173.7, ptr %i.qd, align 4, !tbaa !32
  %i.qe = getelementptr inbounds nuw i8, ptr %i.oe, i64 %.sink172.7
  store i32 %.sink170.7, ptr %i.qe, align 4, !tbaa !32
  %i.qf = getelementptr inbounds nuw i8, ptr %i.oe, i64 %.sink169.7
  store i32 %.sink167.7, ptr %i.qf, align 4, !tbaa !32
  %i.qg = getelementptr inbounds nuw i8, ptr %i.a, i64 92
  store i32 %.sink165.7, ptr %i.qg, align 4, !tbaa !32
  %i.qh = getelementptr inbounds nuw i8, ptr %i.a, i64 60
  store i32 %.sink164.7, ptr %i.qh, align 4, !tbaa !32
  store i32 %.sink.7, ptr %i.oe, align 4, !tbaa !32
  br label %.preheader
...
.preheader:                                       ; preds = %.preheader.preheader, %bb.x
  ...
  %i.qi = load i32, ptr %.1161, align 4, !tbaa !32 ; 2 uses
  %.not = icmp eq i32 %i.qi, 0
  %i.qj = getelementptr inbounds nuw i8, ptr %.1161, i64 4
  %i.qk = load i32, ptr %i.qj, align 4, !tbaa !32 ; 2 uses
...
bb.q:                                             ; preds = %.preheader
  ...
  %i.qm = load i32, ptr %i.ql, align 4, !tbaa !32
...
.preheader._crit_edge:                            ; preds = %.preheader, %bb.v, %bb.u, %bb.t, %bb.s, %bb.r, %bb.q
  ...
  %4 = insertelement <2 x i32> poison, i32 %i.qi, i64 0
  %5 = insertelement <2 x i32> %4, i32 %i.qx, i64 1
  %6 = shl nsw <2 x i32> %5, splat (i32 1)        ; 2 uses
  ...
  %7 = shufflevector <2 x i32> %6, <2 x i32> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  %i.rb = add nsw <2 x i32> %i.ra, %7
  %i.rc = sub nsw <2 x i32> %i.ra, %7
  ...
  %i.rf = load <2 x i32>, ptr %i.qy, align 4, !tbaa !32
  ...
  %i.rl = load <4 x i32>, ptr %i.qz, align 4, !tbaa !32 ; 2 uses
...
bb.x:                                             ; preds = %.preheader._crit_edge, %bb.w
  ...
  br i1 %exitcond163.not, label %bb.y, label %.preheader, !llvm.loop !41
...
bb.b:                                             ; preds = %bb.a, %bb.j
  ...
  %i.a = load i32, ptr %.06676, align 4, !tbaa !32 ; 2 uses
...
._crit_edge:                                      ; preds = %bb.b, %bb.h, %bb.g, %bb.f, %bb.e, %bb.d, %bb.c
  ...
  %4 = insertelement <2 x i32> poison, i32 %i.a, i64 0
  %5 = insertelement <2 x i32> %4, i32 %i.p, i64 1
  %6 = shl nsw <2 x i32> %5, splat (i32 1)        ; 2 uses
  ...
  %i.ad = load <4 x i32>, ptr %i.r, align 4, !tbaa !32 ; 2 uses
...
bb.j:                                             ; preds = %._crit_edge, %bb.i
  ...
  br i1 %exitcond.not, label %bb.k, label %bb.b, !llvm.loop !42
...
bb.c:                                             ; preds = %bb.b
  %i.c = load i32, ptr %.08296, align 4, !tbaa !32
  ...
  %i.s = load i32, ptr %i.r, align 4, !tbaa !32   ; 2 uses
  ...
  %i.ak = load i32, ptr %i.aj, align 4, !tbaa !32 ; 2 uses
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  br i1 %exitcond.not, label %bb.f, label %bb.b, !llvm.loop !43
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.r = load i32, ptr %i.q, align 4, !tbaa !32   ; 2 uses
