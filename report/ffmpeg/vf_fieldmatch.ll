...
bb.bc:                                            ; preds = %bb.bb
  ...
  %i.jd = load ptr, ptr %i.jc, align 8, !tbaa !33
  ...
  %i.jh = load ptr, ptr %i.jg, align 8, !tbaa !35
...
.thread296:                                       ; preds = %bb.bd
  store ptr null, ptr %i.jk, align 8, !tbaa !36
  br label %bb.bg
...
bb.bg:                                            ; preds = %.thread296, %bb.bf
  ...
  %i.jt = load i32, ptr %i.js, align 4, !tbaa !93 ; 2 uses
  br i1 %.not253, label %bb.bk, label %bb.bh

bb.bh:                                            ; preds = %bb.bg
  %i.ju = or i32 %i.jt, 8
  store i32 %i.ju, ptr %i.js, align 4, !tbaa !93
  %i.jv = getelementptr inbounds nuw i8, ptr %i.h, i64 248
  %i.jw = load i64, ptr %i.jv, align 8, !tbaa !100
  ...
  %i.jy = load i64, ptr %i.jx, align 8, !tbaa !102
  ...
  %i.kb = load i32, ptr %i.js, align 4, !tbaa !93 ; 2 uses
...
bb.bl:                                            ; preds = %bb.bi, %bb.bj, %bb.bk
  ...
  store i32 %.sink, ptr %i.js, align 4, !tbaa !93
  %i.kf = load i32, ptr %i.a, align 16, !tbaa !42
  %i.kg = getelementptr inbounds nuw i8, ptr %i.a, i64 4
  %i.kh = load i32, ptr %i.kg, align 4, !tbaa !42
  %i.ki = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  %i.kj = load i32, ptr %i.ki, align 8, !tbaa !42
  %i.kk = getelementptr inbounds nuw i8, ptr %i.a, i64 12
  %i.kl = load i32, ptr %i.kk, align 4, !tbaa !42
  %i.km = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  %i.kn = load i32, ptr %i.km, align 16, !tbaa !42
  %i.ko = load i32, ptr %i.ix, align 8, !tbaa !29
  %i.kp = and i32 %.sink, 8
...
bb.c:                                             ; preds = %bb.a
  ...
  %.in = load ptr, ptr %.in.in, align 8, !tbaa !103
  %i.e = load ptr, ptr %.in, align 8, !tbaa !39   ; 3 uses
...
bb.b:                                             ; preds = %bb.a, %fill_buf.exit
  ...
  %i.n = load ptr, ptr %i.m, align 8, !tbaa !63   ; 6 uses
  ...
  %i.q = load i32, ptr %i.j, align 8, !tbaa !64   ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.v = load i32, ptr %i.l, align 4, !tbaa !65
...
bb.d:                                             ; preds = %bb.b
  %i.aa = load i32, ptr %i.l, align 4, !tbaa !65
  br label %get_height.exit
...
get_height.exit:                                  ; preds = %bb.c, %bb.d
  ...
  %i.ae = load ptr, ptr %i.ad, align 8, !tbaa !63 ; 7 uses
...
bb.j:                                             ; preds = %.lr.ph, %bb.m
  ...
  %i.bn = load i8, ptr %gep, align 1, !tbaa !66
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.bu = load i8, ptr %gep781, align 1, !tbaa !66
...
bb.l:                                             ; preds = %bb.k
  ...
  store i8 -1, ptr %i.bz, align 1, !tbaa !66
  br label %bb.m
...
bb.n:                                             ; preds = %.preheader584.us, %bb.r
  ...
  %i.cv = load i8, ptr %gep787, align 1, !tbaa !66
...
bb.p:                                             ; preds = %bb.o
  ...
  %i.dh = load i8, ptr %i.dg, align 1, !tbaa !66
  %i.di = zext i8 %i.dh to i32
  %gep789 = getelementptr i8, ptr %invariant.gep788, i64 %indvars.iv690
  %i.dj = load i8, ptr %gep789, align 1, !tbaa !66
...
bb.q:                                             ; preds = %bb.p
  ...
  store i8 -1, ptr %i.dp, align 1, !tbaa !66
  br label %bb.r
...
bb.s:                                             ; preds = %._crit_edge, %bb.w
  ...
  %i.dz = load i8, ptr %gep783, align 1, !tbaa !66
...
bb.u:                                             ; preds = %bb.t
  ...
  %i.ei = load i8, ptr %gep785, align 1, !tbaa !66
...
bb.v:                                             ; preds = %bb.u
  ...
  store i8 -1, ptr %i.en, align 1, !tbaa !66
  br label %bb.w
...
bb.x:                                             ; preds = %.lr.ph603, %bb.ab
  ...
  %i.eu = load i8, ptr %i.et, align 1, !tbaa !66
  ...
  %i.ey = load i8, ptr %gep791, align 1, !tbaa !66
...
bb.z:                                             ; preds = %bb.y
  ...
  %i.fl = load i8, ptr %i.fk, align 1, !tbaa !66
...
bb.aa:                                            ; preds = %bb.z
  ...
  store i8 -1, ptr %i.fq, align 1, !tbaa !66
  br label %bb.ab
...
bb.ae:                                            ; preds = %bb.ad
  ...
  store i8 -1, ptr %i.go, align 1, !tbaa !66
  br label %bb.af
...
fill_buf.exit:                                    ; preds = %bb.af, %fill_buf.exit.loopexit.unr-lcssa, %bb.ag, %.preheader584.lr.ph, %.preheader586, %bb.e
  ...
  %i.gq = load i32, ptr %i.d, align 4, !tbaa !128
...
..loopexit_crit_edge:                             ; preds = %bb.ah
  ...
  %.pre747 = load ptr, ptr %i.f, align 8, !tbaa !63
  %.pre748 = load i32, ptr %i.j, align 8, !tbaa !64
  %.pre749 = load i32, ptr %i.l, align 4, !tbaa !65
  br label %.loopexit

bb.ai:                                            ; preds = %bb.ah
  %i.gt = load ptr, ptr %i.f, align 8, !tbaa !63  ; 7 uses
  %i.gu = getelementptr inbounds nuw i8, ptr %0, i64 240
  %i.gv = load ptr, ptr %i.gu, align 8, !tbaa !63
  %i.gw = getelementptr inbounds nuw i8, ptr %0, i64 248
  %i.gx = load ptr, ptr %i.gw, align 8, !tbaa !63
  %i.gy = load i32, ptr %i.j, align 8, !tbaa !64  ; 4 uses
  %i.gz = load i32, ptr %i.i, align 8, !tbaa !42
  %i.ha = sub nsw i32 0, %i.gy
  %i.hb = ashr i32 %i.ha, %i.gz                   ; 2 uses
  %i.hc = load i32, ptr %i.l, align 4, !tbaa !65  ; 4 uses
  %i.hd = load i32, ptr %i.k, align 8, !tbaa !42
  %i.he = sub nsw i32 0, %i.hc
  %i.hf = ashr i32 %i.he, %i.hd                   ; 2 uses
  %i.hg = load i32, ptr %i.g, align 8, !tbaa !42  ; 4 uses
...
.lr.ph623:                                        ; preds = %bb.ai
  ...
  %i.hl = load i32, ptr %i.hk, align 8, !tbaa !42
...
bb.aj:                                            ; preds = %.lr.ph613, %bb.bb
  ...
  %i.ie = load i8, ptr %i.id, align 1, !tbaa !66
...
bb.ak:                                            ; preds = %bb.aj
  ...
  %i.ii = load i8, ptr %i.ih, align 1, !tbaa !66
...
bb.ap:                                            ; preds = %bb.ao
  ...
  %i.ix = load i8, ptr %gep793, align 1, !tbaa !66
...
bb.au:                                            ; preds = %bb.at
  ...
  %i.jl = load i8, ptr %i.jk, align 1, !tbaa !66
