...
.preheader.lr.ph:                                 ; preds = %bb.j
  ...
  %10 = and <2 x i32> %9, splat (i32 7)           ; 2 uses
  %i.abb = lshr i32 %7, 1
  ...
  %11 = sub nuw nsw <2 x i32> splat (i32 8), %10  ; 2 uses
  %12 = shufflevector <2 x i32> %11, <2 x i32> %10, <4 x i32> <i32 2, i32 0, i32 poison, i32 3> ; 2 uses
  %13 = shufflevector <4 x i32> %12, <4 x i32> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 3>
  %14 = shufflevector <4 x i32> %12, <4 x i32> poison, <4 x i32> <i32 poison, i32 poison, i32 3, i32 1>
  %15 = shufflevector <2 x i32> %11, <2 x i32> poison, <4 x i32> <i32 1, i32 1, i32 poison, i32 poison>
  %16 = shufflevector <4 x i32> %15, <4 x i32> %14, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %17 = mul nuw nsw <4 x i32> %13, %16            ; 9 uses
...
.preheader.preheader:                             ; preds = %.preheader.lr.ph
  ...
  %broadcast.splat817 = shufflevector <4 x i32> %17, <4 x i32> poison, <16 x i32> <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>
  %broadcast.splat819.a = shufflevector <4 x i32> %17, <4 x i32> poison, <16 x i32> zeroinitializer
  %broadcast.splat821 = shufflevector <4 x i32> %17, <4 x i32> poison, <16 x i32> <i32 3, i32 3, i32 3, i32 3, i32 3, i32 3, i32 3, i32 3, i32 3, i32 3, i32 3, i32 3, i32 3, i32 3, i32 3, i32 3>
  %broadcast.splat823 = shufflevector <4 x i32> %17, <4 x i32> poison, <16 x i32> <i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2>
  ...
  %broadcast.splat841 = shufflevector <4 x i32> %17, <4 x i32> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %broadcast.splat843.a = shufflevector <4 x i32> %17, <4 x i32> poison, <4 x i32> zeroinitializer
  %broadcast.splat845 = shufflevector <4 x i32> %17, <4 x i32> poison, <4 x i32> <i32 3, i32 3, i32 3, i32 3>
  %broadcast.splat847 = shufflevector <4 x i32> %17, <4 x i32> poison, <4 x i32> <i32 2, i32 2, i32 2, i32 2>
...
vector.body824:                                   ; preds = %vector.main.loop.iter.check812, %vector.body824
  ...
  %i.adx = mul nuw nsw <16 x i32> %broadcast.splat819.a, %i.adw
  ...
  %i.aea = mul nuw nsw <16 x i32> %broadcast.splat821, %i.adz
...
vec.epilog.vector.body848:                        ; preds = %vec.epilog.vector.body848, %vec.epilog.ph838
  ...
  %i.aer = mul nuw nsw <4 x i32> %broadcast.splat843.a, %i.aeq
  ...
  %i.aeu = mul nuw nsw <4 x i32> %broadcast.splat845, %i.aet
...
vec.epilog.scalar.ph835:                          ; preds = %vec.epilog.scalar.ph835.preheader, %vec.epilog.scalar.ph835
  ...
  %18 = getelementptr inbounds nuw i8, ptr %.0285421, i64 %indvars.iv498
  %19 = load i8, ptr %18, align 1, !tbaa !12
  %20 = insertelement <4 x i8> poison, i8 %i.afj, i64 0
  %21 = insertelement <4 x i8> %20, i8 %i.afh, i64 1
  %22 = insertelement <4 x i8> %21, i8 %19, i64 2
  %23 = insertelement <4 x i8> %22, i8 %i.afl, i64 3
  %24 = zext <4 x i8> %23 to <4 x i32>
  %25 = mul nuw nsw <4 x i32> %17, %24
  %26 = call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %25)
  %op.rdx = add i32 %26, 32
