...
begin_hunk_0_@ac3_decode_frame:bb.a
  %.pre808 = load i32, ptr %i.ci, align 4, !tbaa !201
  %.not602.i = icmp eq i32 %.pre808, 0
  %i.bqr = zext nneg i32 %i.bqo to i64
  br label %bb.ga

.preheader759.i:                                  ; preds = %bb.ge, %.loopexit760.i
  br i1 %.not528785.i, label %._crit_edge.i479, label %.lr.ph802.i

.lr.ph802.i:                                      ; preds = %.preheader759.i
  %i.bqs = getelementptr inbounds nuw [28 x i8], ptr %i.ed, i64 %indvars.iv777
...
bb.ga:                                            ; preds = %bb.ge, %.lr.ph799.i
  ...
  br i1 %.not602.i, label %bb.gb, label %._crit_edge957.i

._crit_edge957.i:                                 ; preds = %bb.ga
  %.phi.trans.insert958.i = getelementptr inbounds nuw [4 x i8], ptr %i.bqp, i64 %indvars.iv889.i
  %.pre959.i = load i32, ptr %.phi.trans.insert958.i, align 4, !tbaa !43
  br label %bb.gc

bb.gb:                                            ; preds = %bb.ga
  %i.bqu = load i32, ptr %i.bj, align 4, !tbaa !179
  %i.bqv = zext i32 %i.bqu to i64
  %i.bqw = icmp eq i64 %indvars.iv889.i, %i.bqv
  %i.bqx = select i1 %i.bqw, i32 1, i32 2         ; 2 uses
  %i.bqy = load i32, ptr %i.ao, align 8, !tbaa !52 ; 3 uses
  %i.bqz = load i32, ptr %i.an, align 16, !tbaa !51
  %i.bra = load ptr, ptr %i.al, align 16, !tbaa !50
  %i.brb = lshr i32 %i.bqy, 3
  %i.brc = zext nneg i32 %i.brb to i64
  %i.brd = getelementptr inbounds nuw i8, ptr %i.bra, i64 %i.brc
  %i.bre = load i32, ptr %i.brd, align 1, !tbaa !44
  ...
  store i32 %i.brl, ptr %i.ao, align 8, !tbaa !52
  %i.brm = getelementptr inbounds nuw [4 x i8], ptr %i.bqp, i64 %indvars.iv889.i
  store i32 %i.brj, ptr %i.brm, align 4, !tbaa !43
  br label %bb.gc

bb.gc:                                            ; preds = %bb.gb, %._crit_edge957.i
  %i.brn = phi i32 [ %.pre959.i, %._crit_edge957.i ], [ %i.brj, %bb.gb ]
...
bb.gd:                                            ; preds = %bb.gc
  ...
  store i8 3, ptr %i.bro, align 1, !tbaa !44
  br label %bb.ge
...
bb.ge:                                            ; preds = %bb.gd, %bb.gc
  ...
  br i1 %.not550.not.i, label %bb.ga, label %.preheader759.i, !llvm.loop !105
...
bb.gf:                                            ; preds = %bb.go, %.lr.ph802.i
  ...
  store i32 0, ptr %i.brp, align 4, !tbaa !43
  %i.brq = getelementptr inbounds nuw [4 x i8], ptr %i.bqs, i64 %indvars.iv892.i
  %i.brr = load i32, ptr %i.brq, align 4, !tbaa !43 ; 2 uses
...
bb.gk:                                            ; preds = %bb.gi
  ...
  store i32 %i.bsm, ptr %i.ao, align 8, !tbaa !52
  %i.bsn = icmp ult i32 %i.bsj, -201326592
  br i1 %i.bsn, label %.thread736.i, label %bb.gl

.thread736.i:                                     ; preds = %bb.gk
  %i.bso = mul nuw nsw i32 %i.bsk, 3
  %i.bsp = add nuw nsw i32 %i.bso, 73
  br label %bb.gm

bb.gl:                                            ; preds = %bb.gk
  %i.bsq = load ptr, ptr %i.ck, align 8, !tbaa !40
  call void (ptr, i32, ptr, ...) @av_log(ptr noundef %i.bsq, i32 noundef 16, ptr noundef nonnull @.str.53, i32 noundef %i.bsk) #11
  br label %bb.ma

bb.gm:                                            ; preds = %.thread736.i, %bb.gj, %bb.gh
  %.sink1002 = phi i32 [ %i.bsp, %.thread736.i ], [ %i.brz, %bb.gj ], [ %i.brw, %bb.gh ] ; 3 uses
  store i32 %.sink1002, ptr %i.brs, align 4, !tbaa !43
  %i.bsr = add nsw i32 %i.brr, -1
  %i.bss = shl i32 3, %i.bsr                      ; 2 uses
  %i.bst = add i32 %i.bss, -4
  %i.bsu = add i32 %i.bst, %.sink1002
  %i.bsv = sdiv i32 %i.bsu, %i.bss
  %i.bsw = getelementptr inbounds nuw [4 x i8], ptr %i.cg, i64 %indvars.iv892.i
  store i32 %i.bsv, ptr %i.bsw, align 4, !tbaa !43
  %.not601.i = icmp eq i32 %.sink1002, %i.brt
  %or.cond747.i = select i1 %i.atk, i1 true, i1 %.not601.i
  br i1 %or.cond747.i, label %bb.go, label %bb.gn
...
bb.go:                                            ; preds = %bb.gn, %bb.gm, %bb.gf
  ...
  br i1 %exitcond896.not.i, label %._crit_edge.i479, label %bb.gf, !llvm.loop !106

._crit_edge.i479:                                 ; preds = %bb.go, %.preheader759.i
  br i1 %.not547.i, label %bb.gr, label %bb.gp

bb.gp:                                            ; preds = %._crit_edge.i479
  %i.bsx = getelementptr inbounds nuw [28 x i8], ptr %i.ed, i64 %indvars.iv777
  %i.bsy = load i32, ptr %i.bsx, align 4, !tbaa !43 ; 2 uses
  %.not552.i = icmp eq i32 %i.bsy, 0
  br i1 %.not552.i, label %bb.gr, label %bb.gq

bb.gq:                                            ; preds = %bb.gp
  %i.bsz = load i32, ptr %i.cf, align 16, !tbaa !43
...
bb.gt:                                            ; preds = %bb.gs
  ...
  %i.buc = load i32, ptr %i.bth, align 4, !tbaa !43 ; 2 uses
...
bb.gz:                                            ; preds = %bb.gy, %._crit_edge64.i.i
  ...
  %.1.i663.i = phi i32 [ %.03851.i.i, %._crit_edge64.i.i ], [ %i.bvt, %bb.gy ] ; 2 uses
  %i.bvv = add nsw i32 %.1.i663.i, 1
  %i.bvw = sext i32 %.1.i663.i to i64
...
bb.he:                                            ; preds = %bb.hd, %bb.hc, %.loopexit758.i, %bb.gs
  ...
  br i1 %.not553.not.i, label %bb.gs, label %._crit_edge807.i, !llvm.loop !109
...
bb.hg:                                            ; preds = %bb.hf
  ...
  br i1 %.not557809.i, label %.loopexit757.i, label %iter.check
...
iter.check:                                       ; preds = %bb.hg
  ...
  %min.iters.check1108 = icmp ult i64 %i.bzv, 8
  br i1 %min.iters.check1108, label %.lr.ph812.i.preheader, label %vector.main.loop.iter.check

vector.main.loop.iter.check:                      ; preds = %iter.check
  %min.iters.check1109 = icmp ult i64 %i.bzv, 32
  br i1 %min.iters.check1109, label %vec.epilog.ph, label %vector.ph1110

vector.ph1110:                                    ; preds = %vector.main.loop.iter.check
  %i.bzw = and i64 %i.bzv, 24
  %n.vec1111 = and i64 %i.bzv, -32                ; 4 uses
  %i.bzx = or disjoint i64 %n.vec1111, %i.bzt
...
vector.body1112:                                  ; preds = %vector.body1112, %vector.ph1110
  %index1113 = phi i64 [ 0, %vector.ph1110 ], [ %index.next1116, %vector.body1112 ] ; 2 uses
  %i.bzy = getelementptr inbounds nuw i8, ptr %i.e, i64 %index1113 ; 2 uses
  ...
  %wide.load1114 = load <16 x i8>, ptr %.sroa.sel, align 1, !tbaa !44
end_hunk_0
