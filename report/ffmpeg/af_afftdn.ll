...
vector.body294:                                   ; preds = %vector.body294, %vector.ph290
  ...
  %i.jb = tail call nsz <2 x double> @llvm.fabs.v2f64(<2 x double> %i.iz) ; 2 uses
  %i.jc = tail call nsz <2 x double> @llvm.fabs.v2f64(<2 x double> %i.ja) ; 2 uses
  ...
  %4 = freeze <2 x i1> %i.jf
  %i.jg = bitcast <2 x i1> %4 to i2
