...
.split7.us:                                       ; preds = %.split, %.split.us
  ...
  %i.dk = ashr exact i32 %sext, 16                ; 7 uses
  ...
  %.1116 = select i1 %or.cond, i32 %i.dh, i32 %i.dk ; 2 uses
  ...
  %.not132.1 = icmp sle i32 %.1116, %i.dm
...
bb.n:                                             ; preds = %bb.m, %bb.l
  ...
  %spec.select106 = select i1 %or.cond134, i32 %i.ez, i32 %i.dk ; 2 uses
  ...
  %i.fc = icmp sgt i32 %spec.select106, %i.dm
...
bb.aa:                                            ; preds = %.thread87, %bb.z
  ...
  %spec.select110 = select i1 %or.cond136, i32 %.1110.790, i32 %i.dk ; 2 uses
  ...
  %i.gg = icmp sgt i32 %spec.select110, %i.dm
...
.preheader2.preheader:                            ; preds = %bb.an
  ...
  %spec.select113 = select i1 %or.cond138, i32 %i.dk, i32 %.211720 ; 2 uses
  ...
  %.not125.1 = icmp sgt i32 %spec.select113, %i.dm
...
.split8.us:                                       ; preds = %.split, %.split.us
  ...
  %i.dm = ashr exact i32 %sext, 16                ; 7 uses
  ...
  %.1121 = select i1 %or.cond, i32 %i.dj, i32 %i.dm ; 2 uses
  ...
  %.not139.1 = icmp sle i32 %.1121, %i.do
...
bb.n:                                             ; preds = %bb.m, %bb.l
  ...
  %spec.select116 = select i1 %or.cond141, i32 %i.fb, i32 %i.dm ; 2 uses
  ...
  %i.fe = icmp sgt i32 %spec.select116, %i.do
...
bb.aa:                                            ; preds = %.thread97, %bb.z
  ...
  %spec.select120 = select i1 %or.cond143, i32 %.1115.7100, i32 %i.dm ; 2 uses
  ...
  %i.gi = icmp sgt i32 %spec.select120, %i.do
...
.preheader2.preheader:                            ; preds = %bb.an
  ...
  %spec.select123 = select i1 %or.cond145, i32 %i.dm, i32 %.212221 ; 2 uses
  ...
  %.not132.1 = icmp sgt i32 %spec.select123, %i.do
