...
bb.d:                                             ; preds = %bb.c
  ...
  %i.u = add nsw i64 %3, -8                       ; 2 uses
  %i.v = icmp eq i32 %2, 1868788851               ; 2 uses
  %4 = sdiv i64 %i.u, 4
  %i.w = sdiv i64 %i.u, 8
  %5 = select i1 %i.v, i64 %4, i64 %i.w
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.s = add nsw i64 %3, -8                       ; 7 uses
  %.fr112 = freeze i32 %i.p
  %i.t = icmp eq i32 %.fr112, 1                   ; 3 uses
  %i.u = select i1 %i.t, i64 20, i64 12           ; 2 uses
...
bb.f:                                             ; preds = %bb.d
  %4 = sdiv i64 %i.s, 20
  %i.ab = sdiv i64 %i.s, 12
  %5 = select i1 %i.t, i64 %4, i64 %i.ab          ; 2 uses
  %i.ac = trunc i64 %5 to i32                     ; 3 uses
  %sext = shl i64 %5, 32
