...
.preheader3.lr.ph.i:                              ; preds = %._crit_edge.i
  ...
  %i.cn = sext i8 %i.cm to i32                    ; 4 uses
  ...
  %4 = or disjoint i32 %i.ce, 2
  %5 = add i32 %4, %i.aq                          ; 2 uses
  %6 = sub i32 %5, %i.cn
  %i.de = add i32 %i.ad, -1                       ; 4 uses
  %n.vec48 = and i64 %wide.trip.count.i, 2147483646 ; 4 uses
  %i.df = trunc nuw nsw i64 %n.vec48 to i32       ; 2 uses
  %i.dg = shl nuw i32 %i.df, 1                    ; 2 uses
  %i.dh = shl nuw i32 %i.df, 1
  %broadcast.splatinsert49 = insertelement <2 x i32> poison, i32 %i.de, i64 0
  %broadcast.splat50 = shufflevector <2 x i32> %broadcast.splatinsert49, <2 x i32> poison, <2 x i32> zeroinitializer
...
.preheader3.i:                                    ; preds = %bb.k, %.preheader3.lr.ph.i
  %indvars.iv12 = phi i32 [ %indvars.iv.next13, %bb.k ], [ %5, %.preheader3.lr.ph.i ] ; 2 uses
  %indvars.iv = phi i32 [ %indvars.iv.next, %bb.k ], [ %6, %.preheader3.lr.ph.i ] ; 3 uses
  %indvars.iv39.i = phi i32 [ %indvars.iv.next40.i, %bb.k ], [ %i.dd, %.preheader3.lr.ph.i ] ; 2 uses
  %indvars.iv34.i = phi i32 [ %indvars.iv.next35.i, %bb.k ], [ %i.da, %.preheader3.lr.ph.i ] ; 2 uses
  %indvars.iv26.i = phi i32 [ %indvars.iv.next27.i, %bb.k ], [ %i.dc, %.preheader3.lr.ph.i ] ; 3 uses
  %indvars.iv.i = phi i32 [ %indvars.iv.next.i, %bb.k ], [ %i.db, %.preheader3.lr.ph.i ] ; 3 uses
  %.121.i = phi i32 [ %i.fx, %bb.k ], [ %i.cf, %.preheader3.lr.ph.i ]
  %.113320.i = phi ptr [ %i.fy, %bb.k ], [ %i.cj, %.preheader3.lr.ph.i ] ; 2 uses
  br i1 %i.co, label %vector.ph47, label %._crit_edge11.i

vector.ph47:                                      ; preds = %.preheader3.i
  %7 = add i32 %indvars.iv, %i.dg
  %i.di = sub i32 %indvars.iv26.i, %i.dh
  %i.dj = add i32 %indvars.iv.i, %i.dg
  %broadcast.splatinsert53 = insertelement <2 x i32> poison, i32 %indvars.iv, i64 0
  %broadcast.splat54 = shufflevector <2 x i32> %broadcast.splatinsert53, <2 x i32> poison, <2 x i32> zeroinitializer
  %induction55 = add <2 x i32> %broadcast.splat54, <i32 0, i32 2>
...
vector.body62:                                    ; preds = %vector.body62, %vector.ph47
  ...
  %vec.ind64 = phi <2 x i32> [ %induction55, %vector.ph47 ], [ %vec.ind.next69, %vector.body62 ] ; 2 uses
  ...
  %i.dm = and <2 x i32> %i.dl, splat (i32 -2)     ; 2 uses
  %i.dn = add <2 x i32> %vec.ind66, %i.dm         ; 2 uses
  %i.do = add <2 x i32> %vec.ind64, %i.dm
  %8 = call <2 x i32> @llvm.smin.v2i32(<2 x i32> %i.dn, <2 x i32> %broadcast.splat50)
  %9 = sub <2 x i32> %i.do, %8
  ...
  %vec.ind.next69 = add <2 x i32> %vec.ind64, splat (i32 4)
...
.preheader2.preheader.i:                          ; preds = %middle.block72, %.preheader2.preheader.i
  %indvars.iv9 = phi i32 [ %indvars.iv.next10, %.preheader2.preheader.i ], [ %7, %middle.block72 ] ; 2 uses
  ...
  %i.dw = and i32 %i.dv, -2                       ; 2 uses
  %i.dx = add i32 %indvars.iv24.i, %i.dw          ; 2 uses
  %i.dy = add i32 %indvars.iv9, %i.dw
  %smin = call i32 @llvm.smin.i32(i32 %i.dx, i32 %i.de)
  %10 = sub i32 %i.dy, %smin
  %i.dz = and i32 %10, -2
...
.lr.ph15.i:                                       ; preds = %bb.i
  %i.ej = sext i8 %i.ei to i32                    ; 4 uses
  ...
  %11 = sub i32 %indvars.iv12, %i.ej              ; 2 uses
  %n.vec = and i64 %wide.trip.count47.i, 2147483646 ; 4 uses
  %i.em = trunc nuw nsw i64 %n.vec to i32         ; 2 uses
  %i.en = shl nuw i32 %i.em, 1                    ; 2 uses
  %12 = add i32 %11, %i.en
  %i.eo = shl nuw i32 %i.em, 1
  %13 = sub i32 %i.el, %i.eo
  %i.ep = add i32 %i.ek, %i.en
  %broadcast.splatinsert29 = insertelement <2 x i32> poison, i32 %11, i64 0
  %broadcast.splat30 = shufflevector <2 x i32> %broadcast.splatinsert29, <2 x i32> poison, <2 x i32> zeroinitializer
  %induction = add <2 x i32> %broadcast.splat30, <i32 0, i32 2>
...
vector.body:                                      ; preds = %vector.body, %.lr.ph15.i
  ...
  %vec.ind = phi <2 x i32> [ %induction, %.lr.ph15.i ], [ %vec.ind.next, %vector.body ] ; 2 uses
  ...
  %i.es = and <2 x i32> %i.er, splat (i32 -2)     ; 2 uses
  %i.et = add <2 x i32> %vec.ind38, %i.es         ; 2 uses
  %i.eu = add <2 x i32> %vec.ind, %i.es
  %14 = call <2 x i32> @llvm.smin.v2i32(<2 x i32> %i.et, <2 x i32> %broadcast.splat)
  %15 = sub <2 x i32> %i.eu, %14
  %i.ev = and <2 x i32> %15, splat (i32 -2)
...
.preheader.preheader.i:                           ; preds = %middle.block, %.preheader.preheader.i
  %indvars.iv14 = phi i32 [ %indvars.iv.next15, %.preheader.preheader.i ], [ %12, %middle.block ] ; 2 uses
  %indvars.iv43.i = phi i64 [ %indvars.iv.next44.i, %.preheader.preheader.i ], [ %n.vec, %middle.block ] ; 3 uses
  %indvars.iv41.i = phi i32 [ %indvars.iv.next42.i, %.preheader.preheader.i ], [ %13, %middle.block ] ; 2 uses
  ...
  %i.fg = add i32 %indvars.iv36.i, %i.ff          ; 2 uses
  %i.fh = add i32 %indvars.iv14, %i.ff
  %smin16 = call i32 @llvm.smin.i32(i32 %i.fg, i32 %i.de)
  %16 = sub i32 %i.fh, %smin16
  %i.fi = and i32 %16, -2
