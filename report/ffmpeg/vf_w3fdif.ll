...
vector.body46:                                    ; preds = %vector.body46, %vector.ph34
  ...
  %vec.ind64 = phi <2 x i32> [ %induction55, %vector.ph34 ], [ %vec.ind.next69, %vector.body46 ] ; 2 uses
  ...
  %i.dn = add <2 x i32> %vec.ind49, %i.dm         ; 2 uses
  %i.do = add <2 x i32> %vec.ind64, %i.dm
  %8 = call <2 x i32> @llvm.smin.v2i32(<2 x i32> %i.dn, <2 x i32> %broadcast.splat37)
...
.preheader2.preheader.i:                          ; preds = %middle.block54, %.preheader2.preheader.i
  %indvars.iv9 = phi i32 [ %indvars.iv.next10, %.preheader2.preheader.i ], [ %7, %middle.block54 ] ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %.lr.ph15.i
  ...
  %i.et = add <2 x i32> %vec.ind27, %i.es         ; 2 uses
