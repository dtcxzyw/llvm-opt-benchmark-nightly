Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/ffmpeg/original/cbs_vp8?download=true
...
.preheader141:                                    ; preds = %bb.a, %bb.z
  %indvars.iv177 = phi i64 [ 0, %bb.a ], [ %indvars.iv.next178, %bb.z ] ; 5 uses
  %i.o = getelementptr inbounds nuw [264 x i8], ptr @ff_vp8_token_update_probs, i64 %indvars.iv177
  %i.p = getelementptr inbounds nuw [264 x i8], ptr %i.f, i64 %indvars.iv177
  %i.q = getelementptr inbounds nuw [264 x i8], ptr %i.n, i64 %indvars.iv177
  %i.r = trunc nuw nsw i64 %indvars.iv177 to i32
  br label %.preheader140

.preheader140:                                    ; preds = %.preheader141, %bb.y
  %indvars.iv173 = phi i64 [ 0, %.preheader141 ], [ %indvars.iv.next174, %bb.y ] ; 5 uses
  %i.s = getelementptr inbounds nuw [33 x i8], ptr %i.o, i64 %indvars.iv173
  %i.t = getelementptr inbounds nuw [33 x i8], ptr %i.p, i64 %indvars.iv173
  %i.u = getelementptr inbounds nuw [33 x i8], ptr %i.q, i64 %indvars.iv173
  %i.v = trunc nuw nsw i64 %indvars.iv173 to i32
  br label %.preheader

.preheader:                                       ; preds = %.preheader140, %.thread
  %indvars.iv169 = phi i64 [ 0, %.preheader140 ], [ %indvars.iv.next170, %.thread ] ; 5 uses
  %i.w = getelementptr inbounds nuw [11 x i8], ptr %i.s, i64 %indvars.iv169
  %i.x = getelementptr inbounds nuw [11 x i8], ptr %i.t, i64 %indvars.iv169
  %i.y = getelementptr inbounds nuw [11 x i8], ptr %i.u, i64 %indvars.iv169
  %i.z = trunc nuw nsw i64 %indvars.iv169 to i32
  br label %bb.b
