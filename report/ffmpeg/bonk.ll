...
.lr.ph30.preheader.i:                             ; preds = %bb.q
  ...
  %i.ee = zext nneg i32 %i.ds to i64
  br label %.lr.ph30.i

.lr.ph30.i:                                       ; preds = %._crit_edge.i, %.lr.ph30.preheader.i
  %indvars.iv43.i = phi i64 [ %i.ed, %.lr.ph30.preheader.i ], [ %indvars.iv.next44.i, %._crit_edge.i ] ; 2 uses
  ...
  %4 = getelementptr inbounds nuw [4 x i8], ptr %i.dw, i64 %indvars.iv43.i
...
.lr.ph.i:                                         ; preds = %.lr.ph.i, %.lr.ph30.i
  ...
  %.02225.i = phi i32 [ %5, %.lr.ph30.i ], [ %i.em, %.lr.ph.i ] ; 2 uses
