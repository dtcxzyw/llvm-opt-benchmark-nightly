...
.critedge2.i:                                     ; preds = %is_transp.exit109.i, %.critedge2.loopexit.i, %.critedge.i70
  ...
  %i.xc = add nsw i32 %i.ut, -1                   ; 3 uses
...
.lr.ph.i118.i:                                    ; preds = %is_transp.exit123.i, %.critedge4.i
  %.086159.i = phi i32 [ %i.xc, %.critedge4.i ], [ %.086.i, %is_transp.exit123.i ] ; 4 uses
  %4 = zext nneg i32 %.086159.i to i64
  %i.xm = getelementptr inbounds nuw i8, ptr %i.vz, i64 %4
  br label %bb.cv
...
is_transp.exit123.i:                              ; preds = %bb.cw
  %.086.i = add nsw i32 %.086159.i, -1
  %i.xt = icmp sgt i32 %.086159.i, 1
  br i1 %i.xt, label %.lr.ph.i118.i, label %.critedge6.i, !llvm.loop !51

.critedge6.i:                                     ; preds = %is_transp.exit123.i, %bb.cv, %.critedge2.i
  %.087142216.i = phi i32 [ 0, %.critedge2.i ], [ %.087142.i, %bb.cv ], [ %.087142.i, %is_transp.exit123.i ] ; 3 uses
  %.086140.i = phi i32 [ 0, %.critedge2.i ], [ %.086159.i, %bb.cv ], [ 0, %is_transp.exit123.i ]
