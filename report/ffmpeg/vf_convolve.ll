...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %4 = getelementptr inbounds nuw i8, ptr %i.ay, i64 4
  %i.az = load <2 x float>, ptr %i.ax, align 4, !tbaa !51 ; 3 uses
  %5 = load float, ptr %4, align 4, !tbaa !68     ; 4 uses
  %6 = load float, ptr %i.ay, align 4, !tbaa !67  ; 3 uses
  %7 = fmul nsz float %5, %5
  %i.ba = tail call nsz float @llvm.fmuladd.f32(float %6, float %6, float %7)
  %i.bb = fadd nsz float %i.g, %i.ba
  %i.bc = extractelement <2 x float> %i.az, i64 0
  %i.bd = fneg nsz float %i.bc
  %8 = fmul nsz float %5, %i.bd
  %9 = extractelement <2 x float> %i.az, i64 1
  %i.be = fmul nsz float %9, %5
  %10 = insertelement <2 x float> poison, float %6, i64 0
  %i.bf = shufflevector <2 x float> %10, <2 x float> poison, <2 x i32> zeroinitializer
  %11 = insertelement <2 x float> poison, float %i.be, i64 0
  %i.bg = insertelement <2 x float> %11, float %8, i64 1
  %i.bh = tail call nsz <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bf, <2 x float> %i.az, <2 x float> %i.bg)
