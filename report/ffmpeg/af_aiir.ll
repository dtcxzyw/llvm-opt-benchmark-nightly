...
._crit_edge:                                      ; preds = %biquad_process.exit125
  ...
  %unroll_iter106 = and i64 %wide.trip.count.i118, 2147483644
  %lcmp.mod104.not = icmp eq i64 %xtraiter101, 0
...
.preheader112.us.i.new:                           ; preds = %.preheader112.us.i, %.preheader112.us.i.new
  ...
  %gep198.i = getelementptr [8 x i8], ptr %invariant.gep197.i, i64 %i.bp
  %i.bq = load double, ptr %gep198.i, align 8, !tbaa !77
  ...
  %gep198.i.1 = getelementptr [8 x i8], ptr %invariant.gep197.i, i64 %i.bt
  %i.bu = load double, ptr %gep198.i.1, align 8, !tbaa !77
  ...
  %gep198.i.2 = getelementptr [8 x i8], ptr %invariant.gep197.i, i64 %i.bx
  %i.by = load double, ptr %gep198.i.2, align 8, !tbaa !77
  ...
  %gep198.i.3 = getelementptr [8 x i8], ptr %invariant.gep197.i, i64 %i.cb
  %i.cc = load double, ptr %gep198.i.3, align 8, !tbaa !77
...
bb.d:                                             ; preds = %bb.d, %.epil.preheader
  ...
  %gep198.i.epil = getelementptr [8 x i8], ptr %invariant.gep197.i, i64 %i.cf
  %i.cg = load double, ptr %gep198.i.epil, align 8, !tbaa !77
...
._crit_edge.us.i:                                 ; preds = %bb.d, %._crit_edge.us.i.unr-lcssa
  ...
  %gep200.i = getelementptr [8 x i8], ptr %invariant.gep199.i, i64 %i.ci
  %i.cj = load double, ptr %gep200.i, align 8, !tbaa !77
  %i.ck = fsub nsz double %i.cj, %.lcssa
  %gep202.i = getelementptr [8 x i8], ptr %invariant.gep.i, i64 %indvars.iv145.i
  store double %i.ck, ptr %gep202.i, align 8, !tbaa !77
...
.preheader112.i.epil:                             ; preds = %.preheader112.i.epil, %.preheader112.i.epil.preheader
  ...
  %i.dc = mul nuw nsw i64 %indvars.iv148.i.epil, %i.bk
  %i.dd = getelementptr inbounds nuw [8 x i8], ptr %i.q, i64 %i.dc
  %i.de = load double, ptr %i.dd, align 8, !tbaa !77
  %i.df = getelementptr inbounds nuw [8 x i8], ptr %i.ab, i64 %indvars.iv148.i.epil
...
.preheader111.i.prol:                             ; preds = %.split.us.thread.i
  ...
  %i.dm = getelementptr inbounds nuw [8 x i8], ptr %i.q, i64 %indvars.iv156.i
  %i.dn = load double, ptr %i.dm, align 8, !tbaa !77
  %i.do = fmul nsz double %i.dl, %i.dn
  %i.dp = mul nuw nsw i64 %indvars.iv156.i, %i.bk
...
.preheader111.us.preheader.i:                     ; preds = %.split.us.i
  %i.ds = mul nuw nsw i32 %i.i, %indvars168.i
  ...
  %invariant.gep207.i.a = getelementptr [8 x i8], ptr %i.q, i64 %i.bm
...
.preheader111.us.i:                               ; preds = %._crit_edge.us120.i, %.preheader111.us.preheader.i
  ...
  %i.dx = mul nuw nsw i64 %indvars.iv158.i, %i.bk ; 2 uses
  %invariant.gep203.i = getelementptr inbounds nuw [8 x i8], ptr %i.ab, i64 %i.dx ; 5 uses
  br i1 %i.dw, label %.epil.preheader94, label %.preheader111.us.i.new
...
.preheader111.us.i.new:                           ; preds = %.preheader111.us.i, %.preheader111.us.i.new
  ...
  %i.dy = load double, ptr %gep204.i, align 8, !tbaa !77
  %i.dz = mul nuw nsw i64 %indvars.iv151.i, %i.bk
  %gep206.i = getelementptr [8 x i8], ptr %i.du, i64 %i.dz
  %i.ea = load double, ptr %gep206.i, align 8, !tbaa !77
  ...
  %i.ec = load double, ptr %gep204.i.1, align 8, !tbaa !77
  %i.ed = mul nuw nsw i64 %indvars.iv.next152.i, %i.bk
  %gep206.i.1 = getelementptr [8 x i8], ptr %i.du, i64 %i.ed
  %i.ee = load double, ptr %gep206.i.1, align 8, !tbaa !77
  ...
  %i.eg = load double, ptr %gep204.i.2, align 8, !tbaa !77
  %i.eh = mul nuw nsw i64 %indvars.iv.next152.i.1, %i.bk
  %gep206.i.2 = getelementptr [8 x i8], ptr %i.du, i64 %i.eh
  %i.ei = load double, ptr %gep206.i.2, align 8, !tbaa !77
  ...
  %i.ek = load double, ptr %gep204.i.3, align 8, !tbaa !77
  %i.el = mul nuw nsw i64 %indvars.iv.next152.i.2, %i.bk
  %gep206.i.3 = getelementptr [8 x i8], ptr %i.du, i64 %i.el
  %i.em = load double, ptr %gep206.i.3, align 8, !tbaa !77
...
bb.e:                                             ; preds = %bb.e, %.epil.preheader94
  ...
  %.1117.us.i.epil = phi double [ %.1117.us.i.epil.init, %.epil.preheader94 ], [ %i.er, %bb.e ]
  ...
  %i.eo = load double, ptr %gep204.i.epil, align 8, !tbaa !77
  %i.ep = mul nuw nsw i64 %indvars.iv151.i.epil, %i.bk
  %gep206.i.epil = getelementptr [8 x i8], ptr %i.du, i64 %i.ep
  %i.eq = load double, ptr %gep206.i.epil, align 8, !tbaa !77
...
._crit_edge.us120.i:                              ; preds = %bb.e, %._crit_edge.us120.i.unr-lcssa
  %.lcssa81 = phi double [ %i.en, %._crit_edge.us120.i.unr-lcssa ], [ %i.er, %bb.e ]
  %i.es = load double, ptr %i.dv, align 8, !tbaa !77
  %i.et = fdiv nsz double 1.000000e+00, %i.es
  %gep208.i = getelementptr [8 x i8], ptr %invariant.gep207.i.a, i64 %indvars.iv158.i
  %i.eu = load double, ptr %gep208.i, align 8, !tbaa !77
  %i.ev = fsub nsz double %i.eu, %.lcssa81
  %i.ew = fmul nsz double %i.et, %i.ev
  %gep210.i = getelementptr [8 x i8], ptr %i.du, i64 %i.dx
  store double %i.ew, ptr %gep210.i, align 8, !tbaa !77
...
.preheader111.i:                                  ; preds = %.preheader111.i.prol.loopexit, %.preheader111.i
  ...
  %i.ez = getelementptr inbounds nuw [8 x i8], ptr %i.q, i64 %indvars.iv163.i
  %i.fa = load double, ptr %i.ez, align 8, !tbaa !77
  %i.fb = fmul nsz double %i.ey, %i.fa
  %i.fc = mul nuw nsw i64 %indvars.iv163.i, %i.bk
  ...
  %i.fg = getelementptr inbounds nuw [8 x i8], ptr %i.q, i64 %indvars.iv.next164.i
  %i.fh = load double, ptr %i.fg, align 8, !tbaa !77
  %i.fi = fmul nsz double %i.ff, %i.fh
  %i.fj = mul nuw nsw i64 %indvars.iv.next164.i, %i.bk
...
.preheader109.i:                                  ; preds = %.loopexit.i, %._crit_edge.i
  %indvars.iv175.i.a = phi i64 [ %indvars.iv.next176.i.a, %._crit_edge.i ], [ 0, %.loopexit.i ] ; 8 uses
  %.not136.i = icmp eq i64 %indvars.iv175.i.a, 0
  br i1 %.not136.i, label %._crit_edge.i, label %.lr.ph.i115

.lr.ph.i115:                                      ; preds = %.preheader109.i
  %i.fl = mul nuw nsw i64 %indvars.iv175.i.a, %i.bk
  %invariant.gep211.i = getelementptr inbounds nuw [8 x i8], ptr %i.ab, i64 %i.fl ; 5 uses
  %xtraiter111 = and i64 %indvars.iv175.i.a, 3    ; 3 uses
  %i.fm = icmp samesign ult i64 %indvars.iv175.i.a, 4
  br i1 %i.fm, label %.epil.preheader110, label %.lr.ph.i115.new

.lr.ph.i115.new:                                  ; preds = %.lr.ph.i115
  %unroll_iter116 = and i64 %indvars.iv175.i.a, 9223372036854775804
  br label %bb.g
...
bb.f:                                             ; preds = %bb.f, %.epil.preheader110
  ...
  %.2123.i.epil = phi double [ %.2123.i.epil.init, %.epil.preheader110 ], [ %i.fq, %bb.f ]
  ...
  %i.fn = load double, ptr %gep212.i.epil, align 8, !tbaa !77
  %i.fo = getelementptr inbounds nuw [8 x i8], ptr %i.bj, i64 %indvars.iv171.i.epil
...
._crit_edge.i:                                    ; preds = %._crit_edge.i.loopexit.unr-lcssa, %bb.f, %.preheader109.i
  ...
  %i.fr = getelementptr inbounds nuw [8 x i8], ptr %i.bi, i64 %indvars.iv175.i.a
  %i.fs = load double, ptr %i.fr, align 8, !tbaa !77
  %i.ft = fsub nsz double %i.fs, %.2.lcssa.i
  %i.fu = getelementptr inbounds nuw [8 x i8], ptr %i.bj, i64 %indvars.iv175.i.a
  store double %i.ft, ptr %i.fu, align 8, !tbaa !77
  %indvars.iv.next176.i.a = add nuw nsw i64 %indvars.iv175.i.a, 1 ; 2 uses
  %exitcond179.not.i = icmp eq i64 %indvars.iv.next176.i.a, %i.bk
