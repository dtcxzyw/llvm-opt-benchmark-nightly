...
bb.l:                                             ; preds = %bb.l, %.lr.ph.i.i
  ...
  %1 = sitofp nsz i32 %i.ck to double
  %i.cl = call nsz fastcc double @fact(double noundef %1)
  %i.cm = fmul nsz double %i.cj, %i.cl
  %i.cn = sub nsw i32 %i.bt, %.044.i.i
  %2 = sitofp nsz i32 %i.cn to double
...
bb.n:                                             ; preds = %bb.n, %.lr.ph.i48.i
  ...
  %i.ds = sub nsw i32 %i.dc, %.044.i49.i
  %3 = sitofp nsz i32 %i.ds to double
  %i.dt = call nsz fastcc double @fact(double noundef %3)
  %i.du = fmul nsz double %i.dr, %i.dt
  %i.dv = sub nsw i32 %i.db, %.044.i49.i
  %4 = sitofp nsz i32 %i.dv to double
