...
av_channel_layout_ambisonic_order.exit:           ; preds = %bb.h
  ...
  br i1 %i.ap, label %bb.i, label %av_channel_layout_ambisonic_order.exit.thread
...
..lr.ph.i34_crit_edge:                            ; preds = %bb.i
...
bb.k:                                             ; preds = %bb.l
  ...
  br i1 %exitcond.not.i31, label %.lr.ph.i34, label %bb.l, !llvm.loop !3

bb.l:                                             ; preds = %bb.k, %.lr.ph.i27
  %indvars.iv.i29 = phi i64 [ 0, %.lr.ph.i27 ], [ %indvars.iv.next.i30, %bb.k ] ; 2 uses
  ...
  br i1 %.not9.i, label %bb.k, label %has_channel_names.exit.loopexit45

.lr.ph.i34:                                       ; preds = %bb.k, %..lr.ph.i34_crit_edge
  %wide.trip.count.i35.pre-phi = phi i64 [ %.pre46, %..lr.ph.i34_crit_edge ], [ %wide.trip.count.i28, %bb.k ]
  %i.bg = phi ptr [ %.pre, %..lr.ph.i34_crit_edge ], [ %i.bc, %bb.k ] ; 3 uses
  %i.bh = zext nneg i32 %i.al to i64              ; 3 uses
  br label %bb.m

bb.m:                                             ; preds = %bb.o, %.lr.ph.i34
  %indvars.iv.i36 = phi i64 [ %i.bh, %.lr.ph.i34 ], [ %indvars.iv.next.i38, %bb.o ] ; 2 uses
  %.01830.i = phi i64 [ 0, %.lr.ph.i34 ], [ %i.bn, %bb.o ] ; 2 uses
  ...
  br i1 %or.cond.i37, label %bb.n, label %has_channel_names.exit

bb.n:                                             ; preds = %bb.m
  %i.bk = zext nneg i32 %i.bj to i64
  %i.bl = shl nuw nsw i64 1, %i.bk                ; 2 uses
  %i.bm = icmp samesign ult i64 %.01830.i, %i.bl
  br i1 %i.bm, label %bb.o, label %has_channel_names.exit
...
bb.o:                                             ; preds = %bb.n
  ...
  br i1 %exitcond.not.i39, label %masked_description.exit, label %bb.m, !llvm.loop !4

masked_description.exit:                          ; preds = %bb.o
  store i32 1, ptr %2, align 8, !tbaa !29
  %i.bo = trunc i64 %i.bn to i32
  %i.bp = tail call range(i32 0, 33) i32 @llvm.ctpop.i32(i32 %i.bo)
  %i.bq = lshr i64 %i.bn, 32
  %i.br = trunc nuw nsw i64 %i.bq to i32
  %i.bs = tail call range(i32 0, 32) i32 @llvm.ctpop.i32(i32 %i.br)
...
has_channel_names.exit.loopexit45:                ; preds = %bb.l
  %.pre47 = zext nneg i32 %i.al to i64
  br label %has_channel_names.exit

has_channel_names.exit:                           ; preds = %bb.m, %bb.n, %has_channel_names.exit.loopexit45
  %.pre-phi = phi i64 [ %.pre47, %has_channel_names.exit.loopexit45 ], [ %i.bh, %bb.n ], [ %i.bh, %bb.m ]
  %i.bw = phi ptr [ %i.bc, %has_channel_names.exit.loopexit45 ], [ %i.bg, %bb.n ], [ %i.bg, %bb.m ]
...
bb.p:                                             ; preds = %masked_description.exit, %has_channel_names.exit, %bb.j
...
av_channel_layout_ambisonic_order.exit.thread:    ; preds = %bb.g, %bb.d, %bb.e, %bb.h, %bb.a, %.loopexit.i, %av_channel_layout_ambisonic_order.exit, %bb.p
  %.0 = phi i32 [ -22, %bb.d ], [ 0, %bb.p ], [ 0, %av_channel_layout_ambisonic_order.exit ], [ -22, %.loopexit.i ], [ -22, %bb.a ], [ -22, %bb.h ], [ -22, %bb.e ], [ -22, %bb.g ]
  ret i32 %.0
}
...
bb.p:                                             ; preds = %bb.o
  ...
  %i.bp = icmp samesign ult i64 %.01830.i42.i, %i.bo
...
bb.y:                                             ; preds = %bb.x
  ...
  %i.cj = icmp samesign ult i64 %.01830.i, %i.ci
...
av_channel_layout_from_mask.exit:                 ; preds = %bb.aa, %has_channel_names.exit
  ...
  %i.cu = tail call range(i32 0, 32) i32 @llvm.ctpop.i32(i32 %i.ct)
...
bb.at:                                            ; preds = %bb.as
  ...
  %i.fq = icmp samesign ult i64 %.01830.i144, %i.fp
