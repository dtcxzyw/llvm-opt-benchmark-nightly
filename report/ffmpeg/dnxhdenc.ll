Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/ffmpeg/original/dnxhdenc?download=true
...
begin_hunk_0_@dnxhd_encode_picture:bb.a
  store i32 %i.acj, ptr %i.abp, align 4, !tbaa !105
  %i.ack = add nuw nsw i32 %.02730.i, 1           ; 2 uses
  %i.acl = load i32, ptr %i.bs, align 4, !tbaa !80 ; 2 uses
  %i.acm = icmp slt i32 %i.ack, %i.acl
  br i1 %i.acm, label %bb.ah, label %._crit_edge.loopexit.i92, !llvm.loop !154

dnxhd_setup_threads_slices.exit:                  ; preds = %._crit_edge.i89
  %i.acn = icmp sgt i32 %i.abz, 0
  br i1 %i.acn, label %.lr.ph, label %._crit_edge
...
.lr.ph:                                           ; preds = %dnxhd_setup_threads_slices.exit, %.lr.ph
  ...
  %.063121 = phi i32 [ %i.acv, %.lr.ph ], [ 0, %dnxhd_setup_threads_slices.exit ] ; 2 uses
  %i.aco = tail call i32 @llvm.bswap.i32(i32 %.063121)
  %i.acp = load ptr, ptr %i.ck, align 8, !tbaa !116
  %i.acq = shl nuw nsw i64 %indvars.iv, 2
  %i.acr = getelementptr inbounds nuw i8, ptr %i.acp, i64 %i.acq
  store i32 %i.aco, ptr %i.acr, align 1, !tbaa !115
  %i.acs = load ptr, ptr %i.cj, align 16, !tbaa !92
  %i.act = getelementptr inbounds nuw [4 x i8], ptr %i.acs, i64 %indvars.iv
  %i.acu = load i32, ptr %i.act, align 4, !tbaa !105
  %i.acv = add i32 %i.acu, %.063121               ; 2 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.acw = load i32, ptr %i.br, align 8, !tbaa !79 ; 2 uses
  %i.acx = sext i32 %i.acw to i64
  %i.acy = icmp slt i64 %indvars.iv.next, %i.acx
  br i1 %i.acy, label %.lr.ph, label %._crit_edge, !llvm.loop !155

._crit_edge:                                      ; preds = %.lr.ph, %.loopexit, %dnxhd_setup_threads_slices.exit
  %.063.lcssa = phi i32 [ 0, %dnxhd_setup_threads_slices.exit ], [ 0, %.loopexit ], [ %i.acv, %.lr.ph ] ; 2 uses
  %.lcssa119 = phi i32 [ %i.abz, %dnxhd_setup_threads_slices.exit ], [ %i.abk, %.loopexit ], [ %i.acw, %.lr.ph ]
  %i.acz = load ptr, ptr %i.by, align 8, !tbaa !120
  %i.ada = tail call i32 %i.acz(ptr noundef %0, ptr noundef nonnull @dnxhd_encode_thread, ptr noundef %.0, ptr noundef null, i32 noundef %.lcssa119) #12 ; 0 uses
  %i.adb = load i32, ptr %i.cl, align 4, !tbaa !89 ; 2 uses
  %i.adc = sext i32 %i.adb to i64
  %i.add = getelementptr inbounds i8, ptr %.0, i64 %i.adc
  %i.ade = sext i32 %.063.lcssa to i64
  %i.adf = getelementptr inbounds i8, ptr %i.add, i64 %i.ade
  %i.adg = load i32, ptr %i.cm, align 16, !tbaa !87
  %i.adh = add i32 %.063.lcssa, %i.adb
  %reass.sub = sub i32 %i.adg, %i.adh
  %i.adi = add i32 %reass.sub, -4
  %i.adj = sext i32 %i.adi to i64
  tail call void @llvm.memset.p0.i64(ptr align 1 %i.adf, i8 0, i64 %i.adj, i1 false)
  %i.adk = load i32, ptr %i.cm, align 16, !tbaa !87
  %i.adl = sext i32 %i.adk to i64
  %i.adm = getelementptr inbounds i8, ptr %.0, i64 %i.adl
  %i.adn = getelementptr inbounds i8, ptr %i.adm, i64 -4
  store i32 -557839008, ptr %i.adn, align 1, !tbaa !115
  %i.ado = load i32, ptr %i.bk, align 8, !tbaa !82
  %i.adp = icmp ne i32 %i.ado, 0
  %or.cond = and i1 %i.dd, %i.adp
  br i1 %or.cond, label %bb.ai, label %bb.aj

bb.ai:                                            ; preds = %._crit_edge
  %i.adq = load i32, ptr %i.bi, align 4, !tbaa !113
  %i.adr = xor i32 %i.adq, 1                      ; 2 uses
  store i32 %i.adr, ptr %i.bi, align 4, !tbaa !113
  %i.ads = load i32, ptr %i.cm, align 16, !tbaa !87
  %i.adt = sext i32 %i.ads to i64
  %i.adu = getelementptr inbounds i8, ptr %.0, i64 %i.adt
  br label %bb.d

bb.aj:                                            ; preds = %._crit_edge
  %i.adv = load i32, ptr %i.bq, align 4, !tbaa !119
  %i.adw = mul i32 %i.adv, 118
  %i.adx = tail call i32 @ff_encode_add_stats_side_data(ptr noundef %1, i32 noundef %i.adw, ptr noundef null, i32 noundef 0, i32 noundef 1) #12 ; 0 uses
...
bb.b:                                             ; preds = %bb.e, %bb.a
  %.06671 = phi i32 [ 63, %bb.a ], [ %8, %bb.e ]  ; 5 uses
  %5 = zext nneg i32 %.06671 to i64
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.ad = icmp samesign ugt i32 %.06671, 1
  br i1 %i.ad, label %bb.d, label %._crit_edge

bb.d:                                             ; preds = %bb.c
  %6 = add nsw i32 %.06671, -1                    ; 2 uses
  %7 = zext nneg i32 %6 to i64
  %i.ae = getelementptr inbounds nuw i8, ptr %i.b, i64 %7
...
bb.e:                                             ; preds = %bb.d
  ...
  %8 = add nsw i32 %.06671, -2
  br label %bb.b

bb.f:                                             ; preds = %bb.d, %bb.b
  %.06671.lcssa = phi i32 [ %.06671, %bb.b ], [ %6, %bb.d ] ; 4 uses
  %.not72 = icmp slt i32 %.06671.lcssa, 1
  br i1 %.not72, label %._crit_edge, label %.lr.ph.preheader

.lr.ph.preheader:                                 ; preds = %bb.f
  %9 = add nuw nsw i32 %.06671.lcssa, 1
...
._crit_edge:                                      ; preds = %bb.c, %bb.l, %bb.f
  %.06479 = phi i32 [ %.06671.lcssa, %bb.f ], [ %.06671.lcssa, %bb.l ], [ 0, %bb.c ] ; 2 uses
