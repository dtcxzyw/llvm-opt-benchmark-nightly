...
.split.loop.exit229:                              ; preds = %.preheader, %bb.i, %.split.loop.exit226, %.split.loop.exit
  %.011.i.lcssa = phi i32 [ %i.bp, %.split.loop.exit226 ], [ %.011.i, %bb.i ], [ %i.bo, %.split.loop.exit ], [ %.011.i, %.preheader ] ; 2 uses
  %i.bq = phi i32 [ %smax, %.split.loop.exit226 ], [ %spec.select.i.i, %bb.i ], [ %spec.select.i.i.1, %.split.loop.exit ], [ %smax, %.preheader ] ; 3 uses
...
uvlc.exit:                                        ; preds = %bb.k, %.split.loop.exit229, %bb.h
  %.sroa.25.0 = phi i32 [ %spec.select.i65, %bb.h ], [ %i.bu, %.split.loop.exit229 ], [ %i.aw, %bb.k ] ; 4 uses
