...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %i.bi = phi i8 [ %8, %scalar.ph ], [ %.ph, %scalar.ph.preheader ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %scalar.ph ], [ %indvars.iv.ph, %scalar.ph.preheader ] ; 3 uses
  %i.bj = getelementptr i8, ptr %.07883, i64 %indvars.iv ; 2 uses
  %i.bk = getelementptr i8, ptr %i.bj, i64 -3
  %i.bl = getelementptr i8, ptr %i.bj, i64 -1
  %i.bm = load i8, ptr %i.bl, align 1, !tbaa !62
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 3 uses
  %i.bn = getelementptr inbounds nuw i8, ptr %.07883, i64 %indvars.iv.next ; 2 uses
  %i.bo = load <2 x i8>, ptr %i.bk, align 1, !tbaa !62
  %7 = load <4 x i8>, ptr %i.bn, align 1, !tbaa !62
  %8 = load i8, ptr %i.bn, align 1, !tbaa !62
  %9 = shufflevector <2 x i8> %i.bo, <2 x i8> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %10 = shufflevector <4 x i8> %9, <4 x i8> %7, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 4, i32 5, i32 6, i32 7>
  %i.bp = insertelement <8 x i8> %10, i8 %i.bm, i64 2
  %i.bq = insertelement <8 x i8> %i.bp, i8 %i.bi, i64 3
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %i.bi = phi i8 [ %9, %scalar.ph ], [ %.ph, %scalar.ph.preheader ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %scalar.ph ], [ %indvars.iv.ph, %scalar.ph.preheader ] ; 3 uses
  %i.bj = getelementptr i8, ptr %.08286, i64 %indvars.iv ; 2 uses
  %i.bk = getelementptr i8, ptr %i.bj, i64 -3
  %i.bl = getelementptr i8, ptr %i.bj, i64 -1
  %i.bm = load i8, ptr %i.bl, align 1, !tbaa !62
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 3 uses
  %i.bn = getelementptr inbounds nuw i8, ptr %.08286, i64 %indvars.iv.next ; 2 uses
  %i.bo = load <2 x i8>, ptr %i.bk, align 1, !tbaa !62
  %8 = load <4 x i8>, ptr %i.bn, align 1, !tbaa !62
  %9 = load i8, ptr %i.bn, align 1, !tbaa !62
  %10 = shufflevector <2 x i8> %i.bo, <2 x i8> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %11 = shufflevector <4 x i8> %10, <4 x i8> %8, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 4, i32 5, i32 6, i32 7>
  %i.bp = insertelement <8 x i8> %11, i8 %i.bm, i64 2
  %i.bq = insertelement <8 x i8> %i.bp, i8 %i.bi, i64 3
  %i.br = zext <8 x i8> %i.bq to <8 x i16>
  %i.bs = mul nsw <8 x i16> %i.br, %i.f
  %i.bt = tail call i16 @llvm.vector.reduce.add.v8i16(<8 x i16> %i.bs)
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %i.bl = phi i8 [ %12, %scalar.ph ], [ %.ph, %scalar.ph.preheader ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %scalar.ph ], [ %indvars.iv.ph, %scalar.ph.preheader ] ; 3 uses
  %i.bm = getelementptr i8, ptr %.08892, i64 %indvars.iv ; 2 uses
  %i.bn = getelementptr i8, ptr %i.bm, i64 -3
  %i.bo = getelementptr i8, ptr %i.bm, i64 -1
  %i.bp = load i8, ptr %i.bo, align 1, !tbaa !62
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 3 uses
  %i.bq = getelementptr inbounds nuw i8, ptr %.08892, i64 %indvars.iv.next ; 2 uses
  %i.br = load <2 x i8>, ptr %i.bn, align 1, !tbaa !62
  %11 = load <4 x i8>, ptr %i.bq, align 1, !tbaa !62
  %12 = load i8, ptr %i.bq, align 1, !tbaa !62
  %13 = shufflevector <2 x i8> %i.br, <2 x i8> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %14 = shufflevector <4 x i8> %13, <4 x i8> %11, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 4, i32 5, i32 6, i32 7>
  %i.bs = insertelement <8 x i8> %14, i8 %i.bp, i64 2
  %i.bt = insertelement <8 x i8> %i.bs, i8 %i.bl, i64 3
