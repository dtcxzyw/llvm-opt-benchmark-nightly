...
.preheader:                                       ; preds = %.preheader.preheader, %._crit_edge253
  ...
  %indvars.iv324.tr = trunc nuw i64 %indvars.iv324 to i32
  %i.zo = shl nuw i32 %indvars.iv324.tr, 1
...
bb.g:                                             ; preds = %.lr.ph128, %bb.g
  ...
  %indvars.iv149.tr = trunc nuw i64 %indvars.iv149 to i32
  %i.ge = shl nuw i32 %indvars.iv149.tr, 1
...
.lr.ph.us.us:                                     ; preds = %.lr.ph92.split.us.split.us
  %indvars.iv122.tr = trunc nuw i64 %indvars.iv122 to i32
  %i.r = shl nuw i32 %indvars.iv122.tr, 1
...
bb.j:                                             ; preds = %.lr.ph92.split.us.split
  %indvars.iv107.tr = trunc nuw i64 %indvars.iv107 to i32
  %i.ea = shl nuw i32 %indvars.iv107.tr, 1
...
.preheader:                                       ; preds = %.preheader.preheader, %._crit_edge253
  ...
  %i.xt = shl nuw i32 %indvars.iv327.tr, 1
...
vector.body665:                                   ; preds = %vector.body665, %vector.ph651
  ...
  %i.yi = shl nuw <16 x i32> %vec.ind667, splat (i32 1)
...
vec.epilog.vector.body698:                        ; preds = %vec.epilog.vector.body698, %vec.epilog.ph680
  ...
  %i.zl = shl nuw <4 x i32> %vec.ind700, splat (i32 1)
...
vector.body592:                                   ; preds = %vector.body592, %vector.ph584
  ...
  %i.aag = shl nuw <16 x i32> %vec.ind, splat (i32 1)
...
bb.g:                                             ; preds = %.lr.ph128, %bb.g
  ...
  %indvars.iv149.tr = trunc nuw i64 %indvars.iv149 to i32
  %i.hj = shl nuw i32 %indvars.iv149.tr, 1
...
.lr.ph.us.us:                                     ; preds = %.lr.ph92.split.us.split.us
  ...
  %i.r = shl nuw i32 %indvars.iv121.tr, 1
  %i.s = lshr i32 %i.r, %.078
  %i.t = tail call i32 @llvm.umin.i32(i32 %i.s, i32 31)
  %i.u = lshr i32 32, %i.t
...
bb.j:                                             ; preds = %.lr.ph92.split.us.split
  %indvars.iv106.tr = trunc nuw i64 %indvars.iv106 to i32
  %i.ea = shl nuw i32 %indvars.iv106.tr, 1
  %i.eb = lshr i32 %i.ea, %.078
  %i.ec = tail call i32 @llvm.umin.i32(i32 %i.eb, i32 31)
  %i.ed = lshr i32 32, %i.ec
  br label %.lr.ph.us
