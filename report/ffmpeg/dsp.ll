...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.az = mul nuw nsw <8 x i32> %broadcast.splat82, %i.ay
  ...
  %i.be = mul nuw nsw <8 x i32> %i.bd, %i.au
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %i.bt = mul nuw nsw i32 %i.al, %i.bs
  ...
  %i.ce = mul nuw nsw i32 %i.cb, %i.cd
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.aw = mul nuw nsw <16 x i32> %broadcast.splat83, %i.av
  ...
  %i.bb = mul nuw nsw <16 x i32> %i.ba, %i.ar
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.bx = mul nuw nsw <4 x i32> %broadcast.splat106, %i.bw
  ...
  %i.cc = mul nuw nsw <4 x i32> %i.cb, %i.br
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph
  ...
  %i.cr = mul nuw nsw i32 %i.ai, %i.cq
  ...
  %i.dc = mul nuw nsw i32 %i.cz, %i.db
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 3 uses
