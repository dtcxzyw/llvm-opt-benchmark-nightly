...
bb.d:                                             ; preds = %bb.d, %bb.b
  ...
  %6 = select <4 x i1> %i.fz, <4 x i16> zeroinitializer, <4 x i16> %i.fe
  %7 = select <4 x i1> %i.fy, <4 x i16> %i.fd, <4 x i16> %6
  ...
  %8 = sext <4 x i16> %7 to <4 x i32>
  %i.hn = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %8)
