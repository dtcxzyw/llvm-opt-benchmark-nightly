...
.preheader.us.us.us.preheader.i.i.i:              ; preds = %.preheader42.us.us.i.i.i
  %.pre66.pre.i.i.i = load i32, ptr %i.adi, align 8, !tbaa !134 ; 2 uses
...
._crit_edge46.split.us.us.i.i.i:                  ; preds = %._crit_edge.split.us.us.us.us.i.i.i, %.preheader42.us.us.i.i.i
  ...
  br i1 %i.arh, label %.preheader42.us.us.i.i.i, label %encode_sigpass.exit.i.i, !llvm.loop !171
...
bb.bf:                                            ; preds = %bb.bh, %.preheader.us.us.us.i.i.i
  ...
  %i.arr = load i16, ptr %i.arq, align 2, !tbaa !63
...
bb.bg:                                            ; preds = %bb.bf
  ...
  %i.asd = load i8, ptr %i.asc, align 1, !tbaa !58
  ...
  %i.asv = load i32, ptr %i.adi, align 8, !tbaa !134 ; 4 uses
  ...
  %i.atb = load i16, ptr %i.ata, align 2, !tbaa !63
  %i.atc = or i16 %i.atb, 16384
  store i16 %i.atc, ptr %i.ata, align 2, !tbaa !63
  br label %bb.bh
...
bb.bh:                                            ; preds = %bb.bg, %bb.bf
  ...
  br i1 %exitcond64.not.i.i.i, label %._crit_edge.split.us.us.us.us.i.i.i, label %bb.bf, !llvm.loop !172
...
._crit_edge.split.us.us.us.us.i.i.i:              ; preds = %bb.bh
  ...
  br i1 %exitcond65.not.i.i.i, label %._crit_edge46.split.us.us.i.i.i, label %.preheader.us.us.us.i.i.i, !llvm.loop !173
...
.preheader.us52.preheader.i.i.i:                  ; preds = %.preheader42.us.i.i.i
  %.pre.pre.i109.i.i = load i32, ptr %i.adi, align 8, !tbaa !134 ; 2 uses
...
bb.bi:                                            ; preds = %.preheader.us52.i.i.i, %bb.bk
  ...
  %i.atq = load i16, ptr %i.atp, align 2, !tbaa !63
...
bb.bj:                                            ; preds = %bb.bi
  ...
  %i.auc = load i8, ptr %i.aub, align 1, !tbaa !58
  ...
  %i.auw = load i32, ptr %i.adi, align 8, !tbaa !134 ; 4 uses
  ...
  %i.avc = load i16, ptr %i.avb, align 2, !tbaa !63
  %i.avd = or i16 %i.avc, 16384
  store i16 %i.avd, ptr %i.avb, align 2, !tbaa !63
  br label %bb.bk
...
bb.bk:                                            ; preds = %bb.bj, %bb.bi
  ...
  br i1 %exitcond.not.i111.i.i, label %._crit_edge.split.us.i.i.i, label %bb.bi, !llvm.loop !172
...
._crit_edge.split.us.i.i.i:                       ; preds = %bb.bk
  ...
  br i1 %exitcond60.not.i.i.i, label %._crit_edge46.split.us.i.i.i, label %.preheader.us52.i.i.i, !llvm.loop !173
...
._crit_edge46.split.us.i.i.i:                     ; preds = %._crit_edge.split.us.i.i.i, %.preheader42.us.i.i.i
  ...
  br i1 %i.avi, label %.preheader42.us.i.i.i, label %encode_sigpass.exit.i.i, !llvm.loop !171
...
bb.bm:                                            ; preds = %.loopexit.us.i.i.i, %.preheader177.us.i.i.i
  ...
  %.pre.i117.pre.i.i = load i32, ptr %i.adi, align 8, !tbaa !134 ; 2 uses
...
bb.bn:                                            ; preds = %bb.bm
  ...
  %i.avt = load i16, ptr %i.avs, align 2, !tbaa !63
...
bb.bo:                                            ; preds = %bb.bn
  ...
  %i.avz = load i16, ptr %i.avy, align 2, !tbaa !63
...
bb.bp:                                            ; preds = %bb.bo
  ...
  %i.awf = load i16, ptr %i.awe, align 2, !tbaa !63
...
bb.bq:                                            ; preds = %bb.bp
  ...
  %i.awl = load i16, ptr %i.awk, align 2, !tbaa !63
...
.lr.ph.us.i.i.i:                                  ; preds = %bb.bt, %.lr.ph.us.preheader.i.i.i
  ...
  %i.axb = load i16, ptr %i.axa, align 2, !tbaa !63
...
bb.br:                                            ; preds = %.lr.ph.us.i.i.i
  ...
  %i.axg = load i8, ptr %gep.us.i121.i.i, align 1, !tbaa !58
  ...
  %i.axp = load i32, ptr %i.adi, align 8, !tbaa !134 ; 3 uses
...
bb.bs:                                            ; preds = %bb.br
  ...
  %i.axz = load i16, ptr %i.axy, align 2, !tbaa !63 ; 2 uses
  ...
  %i.ayi = load i8, ptr %i.ayh, align 1, !tbaa !58
  ...
  %i.ayl = load i8, ptr %i.ayk, align 1, !tbaa !58
  ...
  %i.aza = load i32, ptr %i.adi, align 8, !tbaa !134
  ...
  %i.azf = load i16, ptr %i.aze, align 2, !tbaa !63
  ...
  %.pre196.i.i.i = load i32, ptr %i.adi, align 8, !tbaa !134
  br label %bb.bt
...
bb.bt:                                            ; preds = %bb.bs, %bb.br, %.lr.ph.us.i.i.i
  ...
  %i.azn = load i16, ptr %i.azm, align 2, !tbaa !63
  %i.azo = and i16 %i.azn, -4097
  store i16 %i.azo, ptr %i.azm, align 2, !tbaa !63
  %i.azp = icmp slt i32 %i.aww, %invariant.smin.us.i115.i.i
  br i1 %i.azp, label %.lr.ph.us.i.i.i, label %.loopexit.us.i.i.i, !llvm.loop !174
...
.lr.ph181.us.preheader.i.i.i:                     ; preds = %.preheader.us.3.i.i.i, %.preheader.us.2.i.i.i, %.preheader.us.1.i.i.i, %.preheader.us.preheader.i123.i.i
  ...
  %.pre197.i.i.i = load i32, ptr %i.adi, align 8, !tbaa !134
...
.lr.ph181.us.i.i.i:                               ; preds = %bb.bz, %.lr.ph181.us.preheader.i.i.i
  ...
  %i.bao = load i16, ptr %i.ban, align 2, !tbaa !63
...
bb.bw:                                            ; preds = %bb.bv
  ...
  %i.bau = load i8, ptr %gep183.us.i.i.i, align 1, !tbaa !58
  ...
  %.pre198.i.i.i = load i32, ptr %i.adi, align 8, !tbaa !134 ; 2 uses
...
bb.by:                                            ; preds = %bb.bx
  ...
  %i.bbk = load i16, ptr %i.bbj, align 2, !tbaa !63 ; 2 uses
  ...
  %i.bbt = load i8, ptr %i.bbs, align 1, !tbaa !58
  ...
  %i.bbw = load i8, ptr %i.bbv, align 1, !tbaa !58
  ...
  %i.bcl = load i32, ptr %i.adi, align 8, !tbaa !134
  ...
  %i.bcq = load i16, ptr %i.bcp, align 2, !tbaa !63
  ...
  %.pre199.i.i.i = load i32, ptr %i.adi, align 8, !tbaa !134 ; 2 uses
...
bb.bz:                                            ; preds = %bb.by, %bb.bx, %.lr.ph181.us.i.i.i
  ...
  %i.bcy = load i16, ptr %i.bcx, align 2, !tbaa !63
  %i.bcz = and i16 %i.bcy, -4097
  store i16 %i.bcz, ptr %i.bcx, align 2, !tbaa !63
  %i.bda = icmp samesign ugt i64 %indvars.iv.next194.i.i.i, %indvars.iv.next32.i.i
  br i1 %i.bda, label %.lr.ph181.us.i.i.i, label %.loopexit.us.i.i.i, !llvm.loop !175
...
.loopexit.us.i.i.i:                               ; preds = %bb.bt, %bb.bz, %bb.bu
  ...
  br i1 %exitcond.not.i119.i.i, label %._crit_edge.us.i120.i.i, label %bb.bm, !llvm.loop !176

._crit_edge.us.i120.i.i:                          ; preds = %.loopexit.us.i.i.i
  %i.bdb = icmp samesign ult i64 %indvars.iv.next194.i.i.i, %i.aip
  br i1 %i.bdb, label %.preheader177.us.i.i.i, label %encode_sigpass.exit.i.i, !llvm.loop !177
...
encode_sigpass.exit.i.i:                          ; preds = %._crit_edge.us.i120.i.i, %._crit_edge46.split.us.i.i.i, %._crit_edge46.split.us.us.i.i.i, %._crit_edge72.split.us.i.i.i, %.preheader177.lr.ph.i.i.i, %bb.bl, %bb.be, %.preheader69.lr.ph.i.i.i, %bb.ay
  ...
  %i.bdc = load ptr, ptr %i.amj, align 8, !tbaa !162
  ...
  %i.bdh = load ptr, ptr %i.amj, align 8, !tbaa !162 ; 2 uses
  ...
  %i.bdk = load i32, ptr %i.bdj, align 4, !tbaa !178
  %i.bdl = sub i32 %i.bdg, %i.bdk
  %i.bdm = trunc i32 %i.bdl to i16
  store i16 %i.bdm, ptr %i.bdi, align 8, !tbaa !180
  ...
  store i64 %i.bdr, ptr %i.bds, align 8, !tbaa !181
