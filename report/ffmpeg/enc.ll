...
bb.ap:                                            ; preds = %bb.ao, %bb.an, %bb.am
  ...
  %i.ni = ashr i32 %i.mz, 29
  %i.nj = and i32 %i.ni, -4
  %i.nk = ashr i32 %i.nd, 30
  %.neg162.i = and i32 %i.nk, -2
  %i.nl = mul i32 %i.mm, %i.mm                    ; 3 uses
  %5 = lshr i32 %i.nl, 15
  %6 = lshr i32 %i.nl, 31
  %i.nm = lshr i32 %5, %6                         ; 2 uses
  ...
  %.neg160.i = ashr i32 %i.nr, 31
  %i.ns = ashr i32 %i.nl, 29
  %7 = and i32 %i.ns, -4
  ...
  %8 = shl i32 %i.mb, 3
  %.neg157.i = add i32 %8, -8
  %i.om = shl nuw nsw i32 %i.mk, 3
  %.neg158.i = sub i32 %.neg157.i, %i.om
  %.neg159.i = add i32 %.neg158.i, %.neg49.i.i
  %.neg129.i = add i32 %.neg159.i, %7
  %.neg38.i.i = add i32 %.neg129.i, %.neg153.i
  %i.on = add i32 %.neg38.i.i, %.neg160.i
  %i.oo = shl i32 %i.mn, 3
  %.neg166.i = add i32 %i.oo, -8
  %.neg167.i.a = add i32 %.neg166.i, %.neg49.i.i
  %9 = shl nuw nsw i32 %i.mw, 3
  %.neg168.i = sub i32 %.neg167.i.a, %9
  %.neg132.i = add i32 %.neg168.i, %i.nj
  %.neg39.i.i = add i32 %.neg132.i, %.neg162.i
