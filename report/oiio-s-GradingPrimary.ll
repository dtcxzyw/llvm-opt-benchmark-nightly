...
7:                                                ; preds = %2
  ...
  %10 = fcmp olt <4 x double> %9, splat (double 0x3F847A5B0FF10ECC)
...
35:                                               ; preds = %2
  ...
  %38 = fcmp olt <4 x double> %37, splat (double 0x3F847A5B0FF10ECC)
  %39 = bitcast <4 x i1> %38 to i4
  %.not57 = icmp eq i4 %39, 0
...
begin_hunk_2
  ...
  %135 = fcmp oeq <4 x float> %134, <float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 1.000000e+00> ; 2 uses
