...
7:                                                ; preds = %2
  ...
  %.fr = freeze <4 x double> %9                   ; [#uses=1 type=<4 x double>]
  %10 = fcmp olt <4 x double> %.fr, splat (double 0x3F847A5B0FF10ECC) ; [#uses=1 type=<4 x i1>]
...
35:                                               ; preds = %2
  ...
  %.fr57 = freeze <4 x double> %37                ; [#uses=1 type=<4 x double>]
  %38 = fcmp olt <4 x double> %.fr57, splat (double 0x3F847A5B0FF10ECC) ; [#uses=1 type=<4 x i1>]
  %39 = bitcast <4 x i1> %38 to i4                ; [#uses=1 type=i4]
  %.not58 = icmp eq i4 %39, 0                     ; [#uses=1 type=i1]
...
begin_hunk_2
  ...
  %.fr = freeze <4 x float> %134                  ; [#uses=1 type=<4 x float>]
  %135 = fcmp oeq <4 x float> %.fr, <float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 1.000000e+00> ; [#uses=2 type=<4 x i1>]
