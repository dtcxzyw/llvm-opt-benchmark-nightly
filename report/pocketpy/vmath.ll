...
bb.g:                                             ; preds = %bb.f
  ...
  %.sroa.513.0.extract.shift.a = lshr i32 %.sroa.0.0.copyload.i, 16
  %.sroa.614.0.extract.shift = lshr i32 %.sroa.0.0.copyload.i, 24
  %.sroa.0.0.copyload.i25 = load i32, ptr %2, align 8, !tbaa !13 ; 4 uses
  %.sroa.48.0.extract.shift.a = lshr i32 %.sroa.0.0.copyload.i25, 8
  %.sroa.412.0.extract.shift.a = lshr i32 %.sroa.0.0.copyload.i, 8
  %.sroa.59.0.extract.shift = lshr i32 %.sroa.0.0.copyload.i25, 16
  %.sroa.610.0.extract.shift = lshr i32 %.sroa.0.0.copyload.i25, 24
  %3 = uitofp nneg i32 %.sroa.614.0.extract.shift to float ; 2 uses
  ...
  %i.j = insertelement <4 x i32> %i.i, i32 %.sroa.412.0.extract.shift.a, i64 2
  %i.k = insertelement <4 x i32> %i.j, i32 %.sroa.48.0.extract.shift.a, i64 3
  ...
  %i.r = and i32 %.sroa.513.0.extract.shift.a, 255
  %i.s = uitofp nneg i32 %i.r to float
  %i.t = and i32 %.sroa.59.0.extract.shift, 255
  %i.u = uitofp nneg i32 %i.t to float
  %i.v = uitofp nneg i32 %.sroa.610.0.extract.shift to float
