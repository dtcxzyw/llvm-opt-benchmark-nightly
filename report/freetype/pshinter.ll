...
.lr.ph.i89:                                       ; preds = %.lr.ph.i89.preheader, %.lr.ph.i89
  ...
  %i.gd = load i16, ptr %i.gc, align 2, !tbaa !28
  %i.ge = load i16, ptr %i.gb, align 2, !tbaa !28
...
psh_calc_max_height.exit95:                       ; preds = %.lr.ph.i89, %middle.block162, %psh_calc_max_height.exit86
  ...
  %i.gh = load i8, ptr %i.do, align 1, !tbaa !244 ; 3 uses
...
vector.body173:                                   ; preds = %vector.body173, %vector.ph169
  ...
  %wide.vec177 = load <8 x i16>, ptr %i.go, align 2, !tbaa !28 ; 2 uses
  ...
  %wide.vec180 = load <8 x i16>, ptr %i.gq, align 2, !tbaa !28 ; 2 uses
...
.lr.ph.i98:                                       ; preds = %.lr.ph.i98.preheader, %.lr.ph.i98
  ...
  %i.ha = load i16, ptr %i.gx, align 2, !tbaa !28
...
psh_calc_max_height.exit104:                      ; preds = %.lr.ph.i98, %middle.block184, %psh_calc_max_height.exit95
  ...
  %i.hf = load i64, ptr %i.he, align 8, !tbaa !245 ; 2 uses
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  store i64 %.sext.sink, ptr %i.ho, align 8, !tbaa !246
  %i.hp = getelementptr inbounds nuw i8, ptr %1, i64 120
  %i.hq = load i32, ptr %i.hp, align 8, !tbaa !247
  %i.hr = getelementptr inbounds nuw i8, ptr %i.b, i64 3936
  store i32 %i.hq, ptr %i.hr, align 8, !tbaa !248
  %i.hs = load i32, ptr %i.di, align 4, !tbaa !242
  %i.ht = getelementptr inbounds nuw i8, ptr %i.b, i64 3944
  store i32 %i.hs, ptr %i.ht, align 8, !tbaa !249
...
.lr.ph21.i:                                       ; preds = %bb.a, %bb.k
  ...
  %.06416.i..06217.i = select i1 %or.cond.not.not.i, i32 %.06416.i, i32 %.06217.i ; 2 uses
...
.lr.ph.i:                                         ; preds = %.lr.ph21.i, %bb.h
  %indvar = phi i64 [ %indvar.next, %bb.h ], [ 0, %.lr.ph21.i ] ; 2 uses
  %.0555.i = phi ptr [ %i.n, %bb.h ], [ %.056.i, %.lr.ph21.i ] ; 5 uses
  %.14.i = phi i32 [ %i.m, %bb.h ], [ %.06416.i..06217.i, %.lr.ph21.i ] ; 2 uses
...
.lr.ph13.preheader.i:                             ; preds = %.lr.ph.i
  %7 = zext i32 %.14.i to i64
  %i.o = mul nuw nsw i64 %indvar, 48
  %i.p = getelementptr i8, ptr %.092..091, i64 %i.o
  %scevgep = getelementptr i8, ptr %i.p, i64 56
  %i.q = mul nuw nsw i64 %7, 48
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep, ptr noundef nonnull align 8 dereferenceable(1) %.0555.i, i64 %i.q, i1 false)
...
._crit_edge14.i:                                  ; preds = %bb.h, %.lr.ph13.preheader.i, %.lr.ph21.i
  ...
  store i32 %i.d, ptr %i.r, align 4, !tbaa !95
...
bb.k:                                             ; preds = %bb.j, %bb.i, %bb.g, %bb.f, %bb.e, %bb.d
  ...
  br i1 %i.w, label %.lr.ph21.i, label %psh_blues_set_zones_0.exit, !llvm.loop !255
...
psh_blues_set_zones_0.exit:                       ; preds = %bb.k, %bb.a
  ...
  store i32 %.064.lcssa.i, ptr %.092, align 8, !tbaa !80
  store i32 %.062.lcssa.i, ptr %.091, align 8, !tbaa !80
...
.lr.ph21.i111:                                    ; preds = %.lr.ph21.i111.preheader, %bb.s
  ...
  %.06217.i114 = phi i32 [ %.163.i135, %bb.s ], [ %.062.lcssa.i, %.lr.ph21.i111.preheader ] ; 7 uses
  %.06615.i116 = phi ptr [ %i.ar, %bb.s ], [ %4, %.lr.ph21.i111.preheader ] ; 3 uses
  %i.aa = getelementptr inbounds nuw i8, ptr %.06615.i116, i64 2
  %.sink39.in.i123 = load i16, ptr %i.aa, align 2, !tbaa !28
  %.sink39.i124 = sext i16 %.sink39.in.i123 to i32 ; 4 uses
  %.sink40.i125 = load i16, ptr %.06615.i116, align 2, !tbaa !28
...
.lr.ph.i128:                                      ; preds = %.lr.ph21.i111, %bb.r
  %indvar180 = phi i64 [ %indvar.next181, %bb.r ], [ 0, %.lr.ph21.i111 ] ; 2 uses
  %.0555.i129 = phi ptr [ %i.am, %bb.r ], [ %.056.i126, %.lr.ph21.i111 ] ; 5 uses
  %.14.i130 = phi i32 [ %i.al, %bb.r ], [ %.06217.i114, %.lr.ph21.i111 ] ; 2 uses
  %i.ad = load i32, ptr %.0555.i129, align 8, !tbaa !47 ; 2 uses
...
bb.o:                                             ; preds = %bb.n
  store i32 %i.ac, ptr %i.ag, align 4, !tbaa !95
  br label %bb.s
...
bb.r:                                             ; preds = %bb.l
  ...
  br i1 %.not.i131, label %._crit_edge14.i132, label %.lr.ph.i128, !llvm.loop !254

.lr.ph13.preheader.i136:                          ; preds = %.lr.ph.i128
  %i.an = zext i32 %.14.i130 to i64
  %i.ao = mul nuw nsw i64 %indvar180, 48
  %scevgep184 = getelementptr i8, ptr %i.z, i64 %i.ao
  %8 = mul nuw nsw i64 %i.an, 48
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep184, ptr noundef nonnull align 8 dereferenceable(1) %.0555.i129, i64 %8, i1 false)
...
._crit_edge14.i132:                               ; preds = %bb.r, %.lr.ph13.preheader.i136, %.lr.ph21.i111
  ...
  store i32 %.sink39.i124, ptr %.055.lcssa33.i133, align 8, !tbaa !47
  %i.ap = getelementptr inbounds nuw i8, ptr %.055.lcssa33.i133, i64 4
  store i32 %i.ac, ptr %i.ap, align 4, !tbaa !95
...
bb.s:                                             ; preds = %._crit_edge14.i132, %bb.q, %bb.p, %bb.o, %bb.n
  ...
  br i1 %i.at, label %.lr.ph21.i111, label %psh_blues_set_zones_0.exit140, !llvm.loop !255
...
psh_blues_set_zones_0.exit140:                    ; preds = %bb.s, %psh_blues_set_zones_0.exit
  ...
  store i32 %.064.lcssa.i, ptr %.092, align 8, !tbaa !80
  store i32 %.062.lcssa.i110, ptr %.091, align 8, !tbaa !80
...
bb.x:                                             ; preds = %._crit_edge188, %bb.v, %bb.w
  ...
  store i32 %i.bf, ptr %i.bg, align 8, !tbaa !83
  %i.bh = add i32 %.093, -1
  %i.bi = getelementptr inbounds nuw i8, ptr %.090, i64 48
  br label %bb.u, !llvm.loop !256
...
bb.ad:                                            ; preds = %.loopexit
  ...
  %i.bz = load i32, ptr %i.by, align 4, !tbaa !82
  %i.ca = sub nsw i32 %i.bz, %5
  store i32 %i.ca, ptr %i.by, align 4, !tbaa !82
  %i.cb = getelementptr inbounds nuw i8, ptr %.092, i64 16
  %.087153 = load i32, ptr %i.cb, align 8, !tbaa !83 ; 2 uses
...
.lr.ph:                                           ; preds = %bb.ad, %.lr.ph
  ...
  %i.ce = load i32, ptr %i.cd, align 4, !tbaa !82 ; 2 uses
  ...
  store i32 %.sink185, ptr %i.cd, align 4, !tbaa !82
  %i.cl = getelementptr inbounds nuw i8, ptr %.1156, i64 8
  store i32 %.sink, ptr %i.cl, align 8, !tbaa !83
  %i.cm = getelementptr inbounds nuw i8, ptr %.1156, i64 56
  %.087 = load i32, ptr %i.cm, align 8, !tbaa !83 ; 2 uses
  %.3 = add i32 %.3158, -1                        ; 2 uses
  %.not106 = icmp eq i32 %.3, 0
  br i1 %.not106, label %._crit_edge, label %.lr.ph, !llvm.loop !258
...
._crit_edge:                                      ; preds = %.lr.ph, %bb.ad
  ...
  store i32 %i.cn, ptr %i.co, align 8, !tbaa !83
  br label %bb.ae
...
bb.af:                                            ; preds = %bb.ae
  ...
  %.087153.1 = load i32, ptr %i.cs, align 8, !tbaa !83 ; 2 uses
...
.lr.ph.1:                                         ; preds = %bb.af, %.lr.ph.1
  ...
  store i32 %.sink187, ptr %i.cu, align 4, !tbaa !82
  %i.dc = getelementptr inbounds nuw i8, ptr %.1156.1, i64 8
  store i32 %.sink186, ptr %i.dc, align 8, !tbaa !83
  %i.dd = getelementptr inbounds nuw i8, ptr %.1156.1, i64 56
  %.087.1 = load i32, ptr %i.dd, align 8, !tbaa !83 ; 2 uses
