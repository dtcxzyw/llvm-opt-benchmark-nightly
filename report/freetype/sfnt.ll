...
.preheader:                                       ; preds = %.preheader.preheader, %._crit_edge222
  ...
  %.0172223 = phi ptr [ %i.fg, %._crit_edge222 ], [ %i.ea, %.preheader.preheader ] ; 2 uses
...
.lr.ph221:                                        ; preds = %.preheader, %.lr.ph221
  ...
  %i.eh = getelementptr inbounds nuw i8, ptr %.0172223, i64 %5 ; 2 uses
  ...
  %6 = sub nsw i16 255, %i.ei
  %7 = load <4 x i8>, ptr %i.eh, align 1, !tbaa !29
  %8 = zext <4 x i8> %7 to <4 x i16>
  %i.eo = insertelement <4 x i16> poison, i16 %6, i64 0
  %9 = shufflevector <4 x i16> %i.eo, <4 x i16> poison, <4 x i32> zeroinitializer
  %10 = mul nuw <4 x i16> %9, %8
  %i.ep = udiv <4 x i16> %10, splat (i16 255)
  ...
  store <4 x i8> %i.ev, ptr %i.eh, align 1, !tbaa !29
