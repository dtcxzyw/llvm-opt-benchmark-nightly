...
.lr.ph.i.i:                                       ; preds = %bb.d, %bb.f
  %.0101.i.i = phi ptr [ %i.ab, %bb.f ], [ %.val37.i, %bb.d ] ; 4 uses
  %i.x = load i64, ptr %.0101.i.i, align 8, !tbaa !158
  %i.y = icmp eq i64 %i.x, %1
  br i1 %i.y, label %bb.e, label %bb.f

bb.e:                                             ; preds = %.lr.ph.i.i
  %i.z = getelementptr inbounds nuw i8, ptr %.0101.i.i, i64 24
...
bb.f:                                             ; preds = %bb.e, %.lr.ph.i.i
  %i.ab = getelementptr inbounds nuw i8, ptr %.0101.i.i, i64 32 ; 2 uses
...
tt_face_lookup_table.exit.i:                      ; preds = %bb.e
  %i.ad = getelementptr inbounds nuw i8, ptr %.0101.i.i, i64 16
  %i.ae = load i64, ptr %i.ad, align 8, !tbaa !163
  %i.af = add i64 %i.ae, %2
  br label %bb.g

bb.g:                                             ; preds = %tt_face_lookup_table.exit.i, %bb.c, %bb.b
  %.029.i = phi i64 [ %2, %bb.b ], [ %i.n, %bb.c ], [ %i.af, %tt_face_lookup_table.exit.i ]
...
.critedge.i:                                      ; preds = %bb.h, %bb.g
  ...
  %i.ak = tail call i32 @FT_Stream_ReadAt(ptr noundef %i.aj, i64 noundef %.029.i, ptr noundef %3, i64 noundef %.1.i) #27
  br label %tt_face_load_any.exit
...
bb.ae:                                            ; preds = %bb.ad
  %i.dl = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %.1143.i) #30
...
bb.ag:                                            ; preds = %bb.af, %bb.ae
  ...
  store ptr %.1143.i, ptr %i.aa, align 8, !tbaa !384
  %i.dp = getelementptr inbounds nuw i8, ptr %0, i64 1232
  store i32 %.0150.i, ptr %i.dp, align 8, !tbaa !773
  br label %bb.ah
...
bb.an:                                            ; preds = %.lr.ph.i
  ...
  store i8 %i.ft, ptr %.0151298.i, align 1, !tbaa !17
  br label %bb.ao
...
.thread281.i:                                     ; preds = %bb.ao, %bb.am
  ...
  store i8 0, ptr %.0151.lcssa.i, align 1, !tbaa !17
...
bb.as:                                            ; preds = %.lr.ph303.i
  ...
  store i8 95, ptr %.4155300.i, align 1, !tbaa !17
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.hx, align 1, !tbaa !17, !alias.scope !791
  %wide.load104 = load <16 x i8>, ptr %i.hy, align 1, !tbaa !17, !alias.scope !791
  ...
  store <16 x i8> %reverse, ptr %next.gep103, align 1, !tbaa !17, !alias.scope !794, !noalias !791
  store <16 x i8> %reverse105, ptr %i.hz, align 1, !tbaa !17, !alias.scope !794, !noalias !791
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.ia = icmp eq i64 %index.next, %n.vec
  br i1 %i.ia, label %middle.block, label %vector.body, !llvm.loop !796
...
vec.epilog.iter.check:                            ; preds = %middle.block
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph80.i.i.preheader, label %vec.epilog.ph, !prof !797
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load111 = load <8 x i8>, ptr %i.if, align 1, !tbaa !17, !alias.scope !791
  %reverse112 = shufflevector <8 x i8> %wide.load111, <8 x i8> poison, <8 x i32> <i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>
  store <8 x i8> %reverse112, ptr %next.gep110, align 1, !tbaa !17, !alias.scope !794, !noalias !791
  %index.next113 = add nuw i64 %index108, 8       ; 2 uses
  %i.ig = icmp eq i64 %index.next113, %n.vec107
  br i1 %i.ig, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !798
...
.lr.ph.i238.i:                                    ; preds = %bb.aw, %.lr.ph.i238.i
  ...
  br i1 %.not.i239.i, label %.preheader.i.i, label %.lr.ph.i238.i, !llvm.loop !799
...
bb.bl:                                            ; preds = %bb.bk
  ...
  store i8 %i.kr, ptr %.5156.i, align 1, !tbaa !17
...
!793 = distinct !{!793, !"LVerDomain"}
!794 = !{!795}
!795 = distinct !{!795, !793}
!796 = distinct !{!796, !20, !106, !107}
!797 = !{!"branch_weights", i32 8, i32 24}
!798 = distinct !{!798, !20, !106, !107}
!799 = distinct !{!799, !20}
