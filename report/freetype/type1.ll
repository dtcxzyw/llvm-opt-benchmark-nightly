...
begin_hunk_0_@T1_Get_MM_Var:bb.a
  ...
  store ptr %i.q, ptr %i.n, align 8, !tbaa !217
  ...
  store i64 %i.t, ptr %i.u, align 8, !tbaa !219
  %i.v = load i8, ptr %i.o, align 8, !tbaa !91
  ...
  store i64 %i.z, ptr %i.aa, align 8, !tbaa !220
  ...
  store ptr %i.ae, ptr %i.ab, align 8, !tbaa !217
  ...
  store i64 %i.ah, ptr %i.ai, align 8, !tbaa !219
  %i.aj = load i8, ptr %i.ac, align 8, !tbaa !91
  ...
  store i64 %i.an, ptr %i.ao, align 8, !tbaa !220
  %indvars.iv.next.i.1 = add nuw nsw i64 %indvars.iv.i, 2 ; 2 uses
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %.loopexit.loopexit.unr-lcssa, label %bb.c, !llvm.loop !1
...
bb.d:                                             ; preds = %.loopexit
  ...
  store ptr %i.bo, ptr %i.bp, align 8, !tbaa !438
  %i.bq = getelementptr inbounds nuw i8, ptr %i.bj, i64 24
  store ptr null, ptr %i.bq, align 8, !tbaa !439
...
.sink.split:                                      ; preds = %bb.j, %bb.i, %bb.h, %bb.g, %bb.f
  ...
  store i64 %.sink, ptr %i.ce, align 8, !tbaa !445
  br label %bb.k

bb.k:                                             ; preds = %.sink.split, %bb.j, %bb.e
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %.pre-phi
  br i1 %exitcond.not, label %._crit_edge, label %bb.e, !llvm.loop !430

._crit_edge:                                      ; preds = %bb.k
  %i.cp = getelementptr inbounds nuw i8, ptr %i.f, i64 272
  %i.cq = load ptr, ptr %i.cp, align 8, !tbaa !222
  %i.cr = load i32, ptr %i.g, align 4, !tbaa !86
...
bb.l:                                             ; preds = %._crit_edge, %mm_axis_unmap.exit
  ...
  %i.cw = load i64, ptr %i.cv, align 8, !tbaa !81 ; 3 uses
  %i.cx = getelementptr inbounds nuw i8, ptr %i.cu, i64 16
  %i.cy = load ptr, ptr %i.cx, align 8, !tbaa !221 ; 3 uses
...
.preheader.i:                                     ; preds = %bb.l
  %i.da = load i8, ptr %i.cu, align 8, !tbaa !91  ; 2 uses
...
.lr.ph.i70:                                       ; preds = %.preheader.i, %bb.o
  ...
  %i.dg = load i64, ptr %i.df, align 8, !tbaa !81 ; 2 uses
...
bb.n:                                             ; preds = %.lr.ph.i70
  ...
  %i.di = load ptr, ptr %i.dh, align 8, !tbaa !218 ; 2 uses
  %3 = shl i64 %indvars.iv.i71, 32
  %sext.i = add i64 %3, -4294967296
  ...
  %i.dl = getelementptr inbounds [8 x i8], ptr %i.cy, i64 %4
  ...
  %i.dp = load i64, ptr %i.do, align 8, !tbaa !81
  ...
  %.pre = load ptr, ptr %i.bp, align 8, !tbaa !438
  br label %mm_axis_unmap.exit
...
bb.o:                                             ; preds = %.lr.ph.i70
  ...
  br i1 %exitcond.not.i73, label %._crit_edge.i, label %.lr.ph.i70, !llvm.loop !4
...
mm_axis_unmap.exit:                               ; preds = %bb.m, %bb.n, %._crit_edge.i
  ...
  store i64 %.024.i, ptr %i.eb, align 8, !tbaa !446
  %indvars.iv.next88 = add nuw nsw i64 %indvars.iv87, 1 ; 2 uses
  %exitcond91.not = icmp eq i64 %indvars.iv.next88, %.pre-phi
  br i1 %exitcond91.not, label %._crit_edge82, label %bb.l, !llvm.loop !431

._crit_edge82:                                    ; preds = %mm_axis_unmap.exit, %bb.d
  store ptr %i.bj, ptr %1, align 8, !tbaa !448
  %.pre92 = load i32, ptr %i.a, align 4, !tbaa !24
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  store i64 %i.e, ptr %i.f, align 8, !tbaa !81
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.g = load i32, ptr %i.f, align 4, !tbaa !86   ; 3 uses
...
.lr.ph31.preheader:                               ; preds = %.preheader
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep, i8 0, i64 %i.p, i1 false), !tbaa !81
  br label %.loopexit
...
bb.e:                                             ; preds = %.lr.ph.i
  ...
  %i.ae = load ptr, ptr %i.ad, align 8, !tbaa !218 ; 2 uses
  %3 = shl i64 %indvars.iv.i, 32
  %sext.i = add i64 %3, -4294967296
  %4 = ashr exact i64 %sext.i, 32                 ; 2 uses
  %i.af = getelementptr inbounds [8 x i8], ptr %i.ae, i64 %4
  %i.ag = load i64, ptr %i.af, align 8, !tbaa !81 ; 2 uses
  %i.ah = getelementptr inbounds [8 x i8], ptr %i.u, i64 %4
...
._crit_edge.i:                                    ; preds = %bb.f, %.preheader.i
  ...
  %i.au = load i64, ptr %i.at, align 8, !tbaa !81
  br label %mm_axis_unmap.exit
...
mm_axis_unmap.exit:                               ; preds = %bb.d, %bb.e, %._crit_edge.i
  ...
  store i64 %.024.i, ptr %i.av, align 8, !tbaa !81
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %.preheader, label %bb.c, !llvm.loop !450
...
bb.b:                                             ; preds = %bb.a
  %i.c = load i32, ptr %i.b, align 8, !tbaa !85   ; 3 uses
...
.lr.ph.i:                                         ; preds = %bb.b
  ...
  %i.e = load ptr, ptr %i.d, align 8, !tbaa !222  ; 7 uses
  %i.f = getelementptr inbounds nuw i8, ptr %i.b, i64 264
  %i.g = load ptr, ptr %i.f, align 8, !tbaa !88   ; 7 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %i.k, align 8, !tbaa !81
  %wide.load2 = load <2 x i64>, ptr %i.l, align 8, !tbaa !81
  %i.m = getelementptr inbounds nuw [8 x i8], ptr %i.g, i64 %index ; 2 uses
  %i.n = getelementptr inbounds nuw i8, ptr %i.m, i64 16
  store <2 x i64> %wide.load, ptr %i.m, align 8, !tbaa !81
  store <2 x i64> %wide.load2, ptr %i.n, align 8, !tbaa !81
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.o = icmp eq i64 %index.next, %n.vec
  br i1 %i.o, label %middle.block, label %vector.body, !llvm.loop !451
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  ...
  store i64 %i.q, ptr %i.r, align 8, !tbaa !81
  %indvars.iv.next.i.prol = add nuw nsw i64 %indvars.iv.i.prol, 1 ; 2 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol, !llvm.loop !452
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  store i64 %i.v, ptr %i.w, align 8, !tbaa !81
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %i.x = getelementptr inbounds nuw [8 x i8], ptr %i.e, i64 %indvars.iv.next.i
  %i.y = load i64, ptr %i.x, align 8, !tbaa !81
  ...
  br i1 %exitcond.not.i.3, label %T1_Set_MM_WeightVector.exit, label %scalar.ph, !llvm.loop !453
...
bb.a:
  ...
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 848
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !83   ; 7 uses
  %.not = icmp eq ptr %i.c, null
  br i1 %.not, label %.loopexit, label %bb.b
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %i.n, align 8, !tbaa !81
  %wide.load57 = load <2 x i64>, ptr %i.o, align 8, !tbaa !81
  %i.p = getelementptr inbounds nuw [8 x i8], ptr %i.j, i64 %index ; 2 uses
  %i.q = getelementptr inbounds nuw i8, ptr %i.p, i64 16
  store <2 x i64> %wide.load, ptr %i.p, align 8, !tbaa !81
  store <2 x i64> %wide.load57, ptr %i.q, align 8, !tbaa !81
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.r = icmp eq i64 %index.next, %n.vec
  br i1 %i.r, label %middle.block, label %vector.body, !llvm.loop !454
