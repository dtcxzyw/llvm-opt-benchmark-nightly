...
.thread32.i:                                      ; preds = %bb.w, %.thread.i.a, %bb.v
  ...
  %i.ck = load i32, ptr %i.b, align 4, !tbaa !15
...
bb.ag:                                            ; preds = %bb.af
  ...
  %i.fh = load i32, ptr %i.a, align 4, !tbaa !15
...
define internal fastcc range(i32 -1, 1) i32 @ft_lzwstate_stack_grow(ptr nofree noundef captures(address) %0) unnamed_addr #0 {
  ...
  %7 = load i64, ptr %6, align 8, !tbaa !29       ; 6 uses
...
8:                                                ; preds = %1
  ...
  %15 = load ptr, ptr %14, align 8, !tbaa !28     ; 3 uses
...
28:                                               ; preds = %25, %27
  store i64 %.024, ptr %6, align 8, !tbaa !29
  br label %.sink.split
