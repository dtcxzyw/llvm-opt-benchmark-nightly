...
begin_hunk_0_@edt8:bb.a
  ...
  br i1 %i.w, label %bb.e, label %compare_neighbor.exit.us.thread80.i

compare_neighbor.exit.us.thread80.i:              ; preds = %bb.d
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.ac = load i32, ptr %gep86.i, align 8, !tbaa !117 ; 2 uses
  %i.ad = icmp sgt i32 %i.ac, %i.ab
  br i1 %i.ad, label %bb.f, label %compare_neighbor.exit.us.i

bb.f:                                             ; preds = %bb.e
  store i32 %i.ab, ptr %gep86.i, align 8, !tbaa !117
  %i.ae = getelementptr inbounds nuw i8, ptr %gep86.i, i64 8
...
bb.g:                                             ; preds = %compare_neighbor.exit.us.i, %compare_neighbor.exit.us.thread80.i
  %i.ah = phi i32 [ %i.q, %compare_neighbor.exit.us.thread80.i ], [ %i.af, %compare_neighbor.exit.us.i ] ; 2 uses
  %i.ai = load i32, ptr %i.s, align 8, !tbaa !117
  %i.aj = add nsw i32 %i.ai, -65536
  %i.ak = icmp slt i32 %i.aj, %i.ah
  br i1 %i.ak, label %bb.h, label %compare_neighbor.exit32.us.thread81.i

compare_neighbor.exit32.us.thread81.i:            ; preds = %bb.g
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.aq = load i32, ptr %gep86.i, align 8, !tbaa !117 ; 2 uses
  %i.ar = icmp sgt i32 %i.aq, %i.ap
  br i1 %i.ar, label %bb.i, label %compare_neighbor.exit32.us.i

bb.i:                                             ; preds = %bb.h
  store i32 %i.ap, ptr %gep86.i, align 8, !tbaa !117
  %i.as = getelementptr inbounds nuw i8, ptr %gep86.i, i64 8
