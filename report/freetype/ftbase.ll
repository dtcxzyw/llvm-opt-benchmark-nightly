...
bb.d:                                             ; preds = %bb.c
  ...
  tail call void %i.f(ptr noundef %0, ptr noundef nonnull %4) #30, !inline_history !147
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.m = tail call ptr %i.k(ptr noundef %0, i64 noundef %i.l) #30, !inline_history !148 ; 2 uses
...
bb.h:                                             ; preds = %bb.f
  ...
  %i.s = tail call ptr %i.r(ptr noundef %0, i64 noundef %i.o, i64 noundef %i.p, ptr noundef %4) #30, !inline_history !148 ; 2 uses
...
ft_mem_qrealloc.exit.thread:                      ; preds = %bb.d, %bb.c, %bb.e, %bb.a, %bb.i, %ft_mem_qrealloc.exit
  ...
  store i32 %.1.i25, ptr %5, align 4, !tbaa !117
  ret ptr %.134.i24
}
...
bb.a:
  ...
  %i.b = load ptr, ptr %0, align 8, !tbaa !114    ; 16 uses
  ...
  %i.f = load i32, ptr %i.e, align 8, !tbaa !134  ; 5 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.q = tail call ptr %i.n(ptr noundef %i.b, i64 noundef %i.p) #30, !inline_history !385 ; 3 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %.pre.i = load i32, ptr %i.e, align 8, !tbaa !134
...
ft_mem_realloc.exit.thread.i:                     ; preds = %bb.f, %bb.c
  ...
  store ptr %.134.i24.i.ph.i, ptr %i.h, align 8, !tbaa !131
  %i.t = getelementptr inbounds nuw i8, ptr %0, i64 20
  store i8 1, ptr %i.t, align 4, !tbaa !139
...
ft_mem_realloc.exit.i:                            ; preds = %bb.e
  store ptr null, ptr %i.h, align 8, !tbaa !131
...
bb.g:                                             ; preds = %ft_mem_realloc.exit.thread.i
  ...
  %i.aa = load i16, ptr %i.z, align 2, !tbaa !141
...
bb.h:                                             ; preds = %bb.g, %ft_mem_realloc.exit.thread.i
  ...
  store ptr %i.ad, ptr %i.ae, align 8, !tbaa !140
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.ai = load i16, ptr %i.ah, align 2, !tbaa !141
...
FT_GlyphLoader_Adjust_Points.exit.i:              ; preds = %bb.k, %bb.j
  ...
  store ptr %i.as, ptr %i.at, align 8, !tbaa !143
  %i.au = getelementptr inbounds nuw i8, ptr %0, i64 26
  %i.av = load i16, ptr %i.au, align 2, !tbaa !141
...
bb.l:                                             ; preds = %bb.a, %bb.b, %FT_GlyphLoader_Adjust_Points.exit.i
  ...
  %i.bd = load i16, ptr %i.bc, align 2, !tbaa !141
  %i.be = zext i16 %i.bd to i32
  %i.bf = getelementptr inbounds nuw i8, ptr %0, i64 98
  %i.bg = load i16, ptr %i.bf, align 2, !tbaa !141
...
bb.n:                                             ; preds = %bb.m
  ...
  %i.bt = load ptr, ptr %i.bs, align 8, !tbaa !140 ; 5 uses
...
bb.p:                                             ; preds = %bb.o
  ...
  tail call void %i.bw(ptr noundef %i.b, ptr noundef nonnull %i.bt) #30, !inline_history !150
  br label %bb.u
...
ft_mem_realloc.exit.thread118:                    ; preds = %3
  store ptr %i.bt, ptr %i.bs, align 8, !tbaa !140
  br label %FT_GlyphLoader_Adjust_Points.exit.thread
...
bb.r:                                             ; preds = %bb.q
  ...
  %i.cb = tail call ptr %i.bz(ptr noundef %i.b, i64 noundef %i.ca) #30, !inline_history !138 ; 2 uses
...
bb.s:                                             ; preds = %bb.q
  ...
  %i.ch = tail call ptr %i.cg(ptr noundef %i.b, i64 noundef %i.cd, i64 noundef %i.ce, ptr noundef %i.bt) #30, !inline_history !138 ; 2 uses
...
ft_mem_realloc.exit:                              ; preds = %ft_mem_qrealloc.exit.i
  store ptr %.134.i.i, ptr %i.bs, align 8, !tbaa !140
...
bb.u:                                             ; preds = %bb.p, %bb.o
  ...
  %i.cp = load ptr, ptr %i.co, align 8, !tbaa !142 ; 2 uses
...
bb.v:                                             ; preds = %bb.u
  ...
  tail call void %i.cr(ptr noundef %i.b, ptr noundef nonnull %i.cp) #30, !inline_history !150
...
bb.w:                                             ; preds = %.thread
  ...
  %i.cv = tail call ptr %i.cu(ptr noundef nonnull %i.b, i64 noundef %i.br) #30, !inline_history !138 ; 2 uses
  %i.cw = icmp eq ptr %i.cv, null
  br label %ft_mem_qrealloc.exit.i91

bb.x:                                             ; preds = %.thread
  %i.cx = load ptr, ptr %i.cs, align 8, !tbaa !142 ; 2 uses
  %i.cy = getelementptr inbounds nuw i8, ptr %i.b, i64 24
  %i.cz = load ptr, ptr %i.cy, align 8, !tbaa !149
  %i.da = tail call ptr %i.cz(ptr noundef nonnull %i.b, i64 noundef %i.bq, i64 noundef %i.br, ptr noundef %i.cx) #30, !inline_history !138 ; 2 uses
...
ft_mem_realloc.exit99.thread:                     ; preds = %bb.y, %bb.v, %bb.u
  ...
  store ptr %.134.i24.i88.ph, ptr %.ph, align 8, !tbaa !142
  br label %bb.z

ft_mem_realloc.exit99:                            ; preds = %ft_mem_qrealloc.exit.i91
  %spec.select41.i.i94 = select i1 %.sink.i92, i32 64, i32 0
  store i32 %spec.select41.i.i94, ptr %i.a, align 4, !tbaa !117
  store ptr %.134.i.i93, ptr %i.cs, align 8, !tbaa !142
...
bb.z:                                             ; preds = %ft_mem_realloc.exit99.thread, %ft_mem_realloc.exit99
  ...
  %i.df = load i8, ptr %i.de, align 4, !tbaa !139
...
bb.aa:                                            ; preds = %bb.z
  ...
  %i.dl = load ptr, ptr %i.dk, align 8, !tbaa !131
  ...
  store ptr %i.dm, ptr %i.dk, align 8, !tbaa !131
  %i.dn = load i32, ptr %i.a, align 4, !tbaa !117 ; 2 uses
...
bb.ah:                                            ; preds = %bb.ag
  ...
  %i.ed = load ptr, ptr %i.ec, align 8, !tbaa !107
  %i.ee = shl i32 %i.du, 5
  %i.ef = zext i32 %i.ee to i64                   ; 2 uses
  %i.eg = tail call ptr %i.ed(ptr noundef %i.dv, i64 noundef %i.ef) #30, !inline_history !385 ; 3 uses
...
bb.ai:                                            ; preds = %bb.ah
  ...
  %.pre.i102 = load i32, ptr %i.e, align 8, !tbaa !134
...
ft_mem_realloc.exit.thread.i103:                  ; preds = %bb.ai, %bb.af
  ...
  store ptr %.134.i24.i.ph.i104, ptr %i.dx, align 8, !tbaa !131
  %i.ej = getelementptr inbounds nuw i8, ptr %0, i64 20
  store i8 1, ptr %i.ej, align 4, !tbaa !139
...
bb.ak:                                            ; preds = %bb.aj, %ft_mem_realloc.exit.thread.i103
  ...
  store ptr %i.es, ptr %i.et, align 8, !tbaa !140
  %i.eu = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.ev = load ptr, ptr %i.eu, align 8, !tbaa !142 ; 2 uses
  %.not23.i.i106 = icmp eq ptr %i.ev, null
  br i1 %.not23.i.i106, label %bb.am, label %bb.al

bb.al:                                            ; preds = %bb.ak
  %i.ew = load i16, ptr %i.bc, align 2, !tbaa !141
...
FT_GlyphLoader_Adjust_Points.exit.i108:           ; preds = %bb.an, %bb.am
  ...
  store ptr %i.fg, ptr %i.fh, align 8, !tbaa !143
  %i.fi = load i16, ptr %i.bc, align 2, !tbaa !141
  ...
  store ptr %i.fk, ptr %i.fl, align 8, !tbaa !145
...
bb.ao:                                            ; preds = %bb.ad, %bb.ae, %FT_GlyphLoader_Adjust_Points.exit.i108
  ...
  %i.fp = load i32, ptr %i.fo, align 4, !tbaa !135 ; 4 uses
  %i.fq = load i16, ptr %i.c, align 8, !tbaa !144
  %i.fr = zext i16 %i.fq to i32
  %i.fs = load i16, ptr %i.d, align 8, !tbaa !144
...
bb.aq:                                            ; preds = %bb.ap
  ...
  %i.gg = load ptr, ptr %i.gf, align 8, !tbaa !143
  ...
  store ptr %i.gh, ptr %i.gf, align 8, !tbaa !143
  %i.gi = load i32, ptr %i.a, align 4, !tbaa !117 ; 2 uses
  %.not82 = icmp eq i32 %i.gi, 0
  br i1 %.not82, label %.thread129, label %FT_GlyphLoader_Adjust_Points.exit.thread

.thread129:                                       ; preds = %bb.aq
  store i32 %spec.store.select1, ptr %i.fo, align 4, !tbaa !135
  br label %bb.as
...
bb.as:                                            ; preds = %.thread129, %bb.ar
  ...
  %i.gk = load ptr, ptr %i.gj, align 8, !tbaa !140 ; 2 uses
  %.not.i111 = icmp eq ptr %i.gk, null
  br i1 %.not.i111, label %bb.au, label %bb.at

bb.at:                                            ; preds = %bb.as
  %i.gl = load i16, ptr %i.bc, align 2, !tbaa !141
...
bb.au:                                            ; preds = %bb.at, %bb.as
  ...
  store ptr %i.go, ptr %i.gp, align 8, !tbaa !140
...
bb.av:                                            ; preds = %bb.au
  %i.gs = load i16, ptr %i.bc, align 2, !tbaa !141
...
bb.aw:                                            ; preds = %bb.av, %bb.au
  ...
  store ptr %i.gv, ptr %i.gw, align 8, !tbaa !142
  %i.gx = getelementptr inbounds nuw i8, ptr %0, i64 48
  %i.gy = load ptr, ptr %i.gx, align 8, !tbaa !143 ; 2 uses
  %.not24.i = icmp eq ptr %i.gy, null
  br i1 %.not24.i, label %bb.ay, label %bb.ax

bb.ax:                                            ; preds = %bb.aw
  %i.gz = load i16, ptr %i.c, align 8, !tbaa !144
...
bb.ay:                                            ; preds = %bb.ax, %bb.aw
  ...
  store ptr %i.hc, ptr %i.hd, align 8, !tbaa !143
  %i.he = getelementptr inbounds nuw i8, ptr %0, i64 20
  %i.hf = load i8, ptr %i.he, align 4, !tbaa !139
...
bb.az:                                            ; preds = %bb.ay
  ...
  %i.hi = load i16, ptr %i.bc, align 2, !tbaa !141
...
FT_GlyphLoader_Adjust_Points.exit.thread:         ; preds = %bb.ap, %ft_mem_realloc.exit.i109, %bb.ag, %bb.m, %ft_mem_realloc.exit.i, %bb.d, %ft_mem_realloc.exit99, %ft_mem_realloc.exit, %bb.aa, %bb.aq, %ft_mem_realloc.exit.thread118
  ...
  %i.hq = load ptr, ptr %0, align 8, !tbaa !114   ; 10 uses
  %i.hr = getelementptr inbounds nuw i8, ptr %0, i64 32 ; 2 uses
  %i.hs = load ptr, ptr %i.hr, align 8, !tbaa !126 ; 2 uses
...
bb.ba:                                            ; preds = %FT_GlyphLoader_Adjust_Points.exit.thread
  ...
  %i.hu = load ptr, ptr %i.ht, align 8, !tbaa !127
  tail call void %i.hu(ptr noundef %i.hq, ptr noundef nonnull %i.hs) #30, !inline_history !137
  br label %ft_mem_free.exit.i

ft_mem_free.exit.i:                               ; preds = %bb.ba, %FT_GlyphLoader_Adjust_Points.exit.thread
  store ptr null, ptr %i.hr, align 8, !tbaa !126
  %i.hv = getelementptr inbounds nuw i8, ptr %0, i64 40 ; 2 uses
  %i.hw = load ptr, ptr %i.hv, align 8, !tbaa !129 ; 2 uses
...
bb.bb:                                            ; preds = %ft_mem_free.exit.i
  ...
  %i.hy = load ptr, ptr %i.hx, align 8, !tbaa !127
  tail call void %i.hy(ptr noundef %i.hq, ptr noundef nonnull %i.hw) #30, !inline_history !137
  br label %ft_mem_free.exit22.i

ft_mem_free.exit22.i:                             ; preds = %bb.bb, %ft_mem_free.exit.i
  store ptr null, ptr %i.hv, align 8, !tbaa !129
...
bb.bc:                                            ; preds = %ft_mem_free.exit22.i
  ...
  %i.ic = load ptr, ptr %i.ib, align 8, !tbaa !127
  tail call void %i.ic(ptr noundef %i.hq, ptr noundef nonnull %i.ia) #30, !inline_history !137
  br label %ft_mem_free.exit24.i

ft_mem_free.exit24.i:                             ; preds = %bb.bc, %ft_mem_free.exit22.i
  store ptr null, ptr %i.hz, align 8, !tbaa !130
  %i.id = getelementptr inbounds nuw i8, ptr %0, i64 64 ; 2 uses
  %i.ie = load ptr, ptr %i.id, align 8, !tbaa !131 ; 2 uses
...
bb.bd:                                            ; preds = %ft_mem_free.exit24.i
  ...
  %i.ig = load ptr, ptr %i.if, align 8, !tbaa !127
  tail call void %i.ig(ptr noundef %i.hq, ptr noundef nonnull %i.ie) #30, !inline_history !137
  br label %ft_mem_free.exit26.i

ft_mem_free.exit26.i:                             ; preds = %bb.bd, %ft_mem_free.exit24.i
  store ptr null, ptr %i.id, align 8, !tbaa !131
  %i.ih = getelementptr inbounds nuw i8, ptr %0, i64 88 ; 2 uses
  %i.ii = load ptr, ptr %i.ih, align 8, !tbaa !132 ; 2 uses
...
bb.be:                                            ; preds = %ft_mem_free.exit26.i
  ...
  %i.ik = load ptr, ptr %i.ij, align 8, !tbaa !127
  tail call void %i.ik(ptr noundef %i.hq, ptr noundef nonnull %i.ii) #30, !inline_history !137
  br label %FT_GlyphLoader_Reset.exit

FT_GlyphLoader_Reset.exit:                        ; preds = %ft_mem_free.exit26.i, %bb.be
  store ptr null, ptr %i.ih, align 8, !tbaa !132
  %i.il = getelementptr inbounds nuw i8, ptr %0, i64 72
  store ptr null, ptr %i.il, align 8, !tbaa !133
  store i32 0, ptr %i.e, align 8, !tbaa !134
  %i.im = getelementptr inbounds nuw i8, ptr %0, i64 12
  store i32 0, ptr %i.im, align 4, !tbaa !135
  ...
  store i16 0, ptr %i.io, align 2, !tbaa !118
  store i16 0, ptr %i.c, align 8, !tbaa !119
  %i.ip = getelementptr inbounds nuw i8, ptr %0, i64 56
  store i32 0, ptr %i.ip, align 8, !tbaa !120
  %i.iq = getelementptr inbounds nuw i8, ptr %0, i64 80
  store i32 0, ptr %i.iq, align 8, !tbaa !121
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(72) %i.d, ptr noundef nonnull align 8 dereferenceable(72) %i.c, i64 72, i1 false), !tbaa.struct !125
  br label %FT_GlyphLoader_Adjust_Points.exit
...
bb.a:
  %i.a = load ptr, ptr %0, align 8, !tbaa !114    ; 6 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 80 ; 2 uses
  %i.c = load i32, ptr %i.b, align 8, !tbaa !121
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 152
  %i.e = load i32, ptr %i.d, align 8, !tbaa !121
  %i.f = add i32 %i.c, %1
  %i.g = add i32 %i.f, %i.e                       ; 2 uses
  %i.h = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  %i.i = load i32, ptr %i.h, align 8, !tbaa !136  ; 4 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.p = load ptr, ptr %i.o, align 8, !tbaa !151  ; 4 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  tail call void %i.s(ptr noundef %i.a, ptr noundef nonnull %i.p) #30, !inline_history !150
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.y = tail call ptr %i.w(ptr noundef %i.a, i64 noundef %i.x) #30, !inline_history !138 ; 2 uses
...
bb.h:                                             ; preds = %bb.f
  ...
  %i.ae = tail call ptr %i.ad(ptr noundef %i.a, i64 noundef %i.aa, i64 noundef %i.ab, ptr noundef %i.p) #30, !inline_history !138 ; 2 uses
...
ft_mem_realloc.exit.thread:                       ; preds = %bb.i, %bb.d, %bb.c
  ...
  store ptr %.134.i24.i.ph, ptr %i.o, align 8, !tbaa !151
  br label %bb.j

ft_mem_realloc.exit:                              ; preds = %ft_mem_qrealloc.exit.i
  store ptr %.134.i.i, ptr %i.o, align 8, !tbaa !151
...
FT_GlyphLoader_Adjust_Subglyphs.exit:             ; preds = %bb.j, %bb.k
  ...
  store ptr %i.ao, ptr %i.ap, align 8, !tbaa !151
...
bb.a:
  ...
  store i16 0, ptr %i.b, align 2, !tbaa !118
  store i16 0, ptr %i.a, align 8, !tbaa !119
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.h = load i16, ptr %i.g, align 2, !tbaa !141
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.p = load i16, ptr %i.o, align 2, !tbaa !141
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  store ptr %i.s, ptr %i.t, align 8, !tbaa !142
  %i.u = getelementptr inbounds nuw i8, ptr %0, i64 48
  %i.v = load ptr, ptr %i.u, align 8, !tbaa !143  ; 2 uses
  %.not24.i = icmp eq ptr %i.v, null
  br i1 %.not24.i, label %bb.g, label %bb.f

bb.f:                                             ; preds = %bb.e
  %i.w = load i16, ptr %i.d, align 8, !tbaa !144
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  store ptr %i.z, ptr %i.aa, align 8, !tbaa !143
  %i.ab = getelementptr inbounds nuw i8, ptr %0, i64 20
  %i.ac = load i8, ptr %i.ab, align 4, !tbaa !139
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.ag = load i16, ptr %i.af, align 2, !tbaa !141
  ...
  store ptr %i.am, ptr %i.an, align 8, !tbaa !146
  br label %FT_GlyphLoader_Adjust_Points.exit
