...
ft_mem_qrealloc.exit.i:                           ; preds = %bb.t, %bb.s
  ...
  %i.cj = icmp ne ptr %.134.i.i, null
  %or.cond.i = select i1 %not..sink.i, i1 %i.cj, i1 false
  %i.ck = icmp ugt i32 %spec.store.select, %i.bb  ; 2 uses
  %or.cond18.i = and i1 %i.ck, %or.cond.i
  br i1 %or.cond18.i, label %bb.u, label %ft_mem_realloc.exit
...
bb.u:                                             ; preds = %ft_mem_qrealloc.exit.i
  %i.cl = shl nuw nsw i64 %i.bq, 4
  %i.cm = getelementptr inbounds nuw i8, ptr %.134.i.i, i64 %i.cl
  %i.cn = sub nuw nsw i64 %i.br, %i.bq
  %i.co = shl nuw nsw i64 %i.cn, 4
  tail call void @llvm.memset.p0.i64(ptr nonnull align 1 %i.cm, i8 0, i64 %i.co, i1 false)
  store ptr %.134.i.i, ptr %i.bs, align 8, !tbaa !121
  br label %.thread

bb.v:                                             ; preds = %bb.p, %bb.o
  store ptr null, ptr %i.bs, align 8, !tbaa !121
  %i.cp = getelementptr inbounds nuw i8, ptr %0, i64 40 ; 3 uses
  %i.cq = load ptr, ptr %i.cp, align 8, !tbaa !123 ; 2 uses
  %.not.i.i.i98 = icmp eq ptr %i.cq, null
  br i1 %.not.i.i.i98, label %ft_mem_realloc.exit99.thread, label %bb.w

bb.w:                                             ; preds = %bb.v
  %i.cr = getelementptr inbounds nuw i8, ptr %i.b, i64 16
  %i.cs = load ptr, ptr %i.cr, align 8, !tbaa !108
  tail call void %i.cs(ptr noundef %i.b, ptr noundef nonnull %i.cq) #30, !inline_history !132
  br label %ft_mem_realloc.exit99.thread

.thread:                                          ; preds = %ft_mem_realloc.exit, %bb.u
  %i.ct = getelementptr inbounds nuw i8, ptr %0, i64 40 ; 3 uses
  br i1 %i.by, label %bb.x, label %bb.y

bb.x:                                             ; preds = %.thread
  %i.cu = getelementptr inbounds nuw i8, ptr %i.b, i64 8
  %i.cv = load ptr, ptr %i.cu, align 8, !tbaa !87
  %i.cw = tail call ptr %i.cv(ptr noundef nonnull %i.b, i64 noundef %i.br) #30, !inline_history !119 ; 2 uses
  %i.cx = icmp eq ptr %i.cw, null
  br label %ft_mem_qrealloc.exit.i91

bb.y:                                             ; preds = %.thread
  %i.cy = load ptr, ptr %i.ct, align 8, !tbaa !123 ; 2 uses
  %i.cz = getelementptr inbounds nuw i8, ptr %i.b, i64 24
  %i.da = load ptr, ptr %i.cz, align 8, !tbaa !130
  %i.db = tail call ptr %i.da(ptr noundef nonnull %i.b, i64 noundef %i.bq, i64 noundef %i.br, ptr noundef %i.cy) #30, !inline_history !119 ; 2 uses
  %.not.i.i89 = icmp eq ptr %i.db, null           ; 2 uses
  %..i.i90 = select i1 %.not.i.i89, ptr %i.cy, ptr %i.db
  br label %ft_mem_qrealloc.exit.i91

ft_mem_qrealloc.exit.i91:                         ; preds = %bb.y, %bb.x
  %.sink.i92 = phi i1 [ %i.cx, %bb.x ], [ %.not.i.i89, %bb.y ] ; 3 uses
  %.134.i.i93 = phi ptr [ %i.cw, %bb.x ], [ %..i.i90, %bb.y ] ; 4 uses
  %not..sink.i95 = xor i1 %.sink.i92, true
  %i.dc = icmp ne ptr %.134.i.i93, null
  %or.cond.i96 = select i1 %not..sink.i95, i1 %i.dc, i1 false
  %or.cond18.i97 = and i1 %i.ck, %or.cond.i96
  br i1 %or.cond18.i97, label %bb.z, label %ft_mem_realloc.exit99

bb.z:                                             ; preds = %ft_mem_qrealloc.exit.i91
  %i.dd = getelementptr inbounds nuw i8, ptr %.134.i.i93, i64 %i.bq
  %i.de = sub nuw nsw i64 %i.br, %i.bq
  tail call void @llvm.memset.p0.i64(ptr nonnull align 1 %i.dd, i8 0, i64 %i.de, i1 false)
  br label %ft_mem_realloc.exit99.thread

ft_mem_realloc.exit99.thread:                     ; preds = %bb.z, %bb.w, %bb.v
  %.ph = phi ptr [ %i.cp, %bb.v ], [ %i.cp, %bb.w ], [ %i.ct, %bb.z ]
  %.134.i24.i88.ph = phi ptr [ null, %bb.v ], [ null, %bb.w ], [ %.134.i.i93, %bb.z ]
...
ft_mem_realloc.exit99:                            ; preds = %ft_mem_qrealloc.exit.i91
  ...
  store ptr %.134.i.i93, ptr %i.ct, align 8, !tbaa !123
  br i1 %.sink.i92, label %FT_GlyphLoader_Adjust_Points.exit.thread, label %bb.aa

bb.aa:                                            ; preds = %ft_mem_realloc.exit99.thread, %ft_mem_realloc.exit99
  %i.df = getelementptr inbounds nuw i8, ptr %0, i64 20
  %i.dg = load i8, ptr %i.df, align 4, !tbaa !120
  %.not79 = icmp eq i8 %i.dg, 0
...
bb.ab:                                            ; preds = %bb.aa
  ...
  %i.dl = getelementptr inbounds nuw i8, ptr %0, i64 64 ; 3 uses
  %i.dm = load ptr, ptr %i.dl, align 8, !tbaa !112
  %i.dn = call ptr @ft_mem_realloc(ptr noundef %i.b, i64 noundef 16, i64 noundef %i.di, i64 noundef %i.dk, ptr noundef %i.dm, ptr noundef nonnull %i.a) ; 3 uses
  store ptr %i.dn, ptr %i.dl, align 8, !tbaa !112
  %i.do = load i32, ptr %i.a, align 4, !tbaa !98  ; 2 uses
  %.not80 = icmp eq i32 %i.do, 0
  br i1 %.not80, label %bb.ac, label %FT_GlyphLoader_Adjust_Points.exit.thread

bb.ac:                                            ; preds = %bb.ab
  %i.dp = getelementptr inbounds nuw [16 x i8], ptr %i.dn, i64 %i.br
  %i.dq = getelementptr inbounds nuw [16 x i8], ptr %i.dn, i64 %i.bq
  %i.dr = shl nuw nsw i64 %i.bq, 4
  tail call void @llvm.memmove.p0.p0.i64(ptr align 8 %i.dp, ptr align 8 %i.dq, i64 %i.dr, i1 false)
  %i.ds = load ptr, ptr %i.dl, align 8, !tbaa !112
  %i.dt = getelementptr inbounds nuw [16 x i8], ptr %i.ds, i64 %i.br
  %i.du = getelementptr inbounds nuw i8, ptr %0, i64 72
  store ptr %i.dt, ptr %i.du, align 8, !tbaa !114
  br label %bb.ad
...
bb.ae:                                            ; preds = %bb.ad, %bb.l
  %i.dv = phi i32 [ %spec.store.select, %bb.ad ], [ %i.bb, %bb.l ] ; 4 uses
  %i.dw = load ptr, ptr %0, align 8, !tbaa !90    ; 2 uses
  %i.dx = icmp eq i32 %i.dv, 0
  br i1 %i.dx, label %bb.ap, label %bb.af

bb.af:                                            ; preds = %bb.ae
  %i.dy = getelementptr inbounds nuw i8, ptr %0, i64 64 ; 3 uses
  %i.dz = load ptr, ptr %i.dy, align 8, !tbaa !112
  %.not.i100 = icmp eq ptr %i.dz, null
  br i1 %.not.i100, label %bb.ag, label %bb.ap

bb.ag:                                            ; preds = %bb.af
  %i.ea = shl i32 %i.dv, 1                        ; 2 uses
  %i.eb = icmp eq i32 %i.ea, 0
  br i1 %i.eb, label %ft_mem_realloc.exit.thread.i103, label %bb.ah

bb.ah:                                            ; preds = %bb.ag
  %i.ec = icmp ugt i32 %i.ea, 134217727
  br i1 %i.ec, label %FT_GlyphLoader_Adjust_Points.exit.thread, label %bb.ai
...
bb.ai:                                            ; preds = %bb.ah
  ...
  %i.eh = tail call ptr %i.ee(ptr noundef %i.dw, i64 noundef %i.eg) #30, !inline_history !131 ; 3 uses
  %i.ei = icmp eq ptr %i.eh, null
  br i1 %i.ei, label %ft_mem_realloc.exit.i109, label %bb.aj

bb.aj:                                            ; preds = %bb.ai
  tail call void @llvm.memset.p0.i64(ptr nonnull align 1 %i.eh, i8 0, i64 %i.eg, i1 false)
  %.pre.i102 = load i32, ptr %i.e, align 8, !tbaa !115
  br label %ft_mem_realloc.exit.thread.i103

ft_mem_realloc.exit.thread.i103:                  ; preds = %bb.aj, %bb.ag
  %i.ej = phi i32 [ %i.dv, %bb.ag ], [ %.pre.i102, %bb.aj ]
  %.134.i24.i.ph.i104 = phi ptr [ null, %bb.ag ], [ %i.eh, %bb.aj ] ; 3 uses
  store ptr %.134.i24.i.ph.i104, ptr %i.dy, align 8, !tbaa !112
  %i.ek = getelementptr inbounds nuw i8, ptr %0, i64 20
  store i8 1, ptr %i.ek, align 4, !tbaa !120
  %i.el = zext i32 %i.ej to i64
  %i.em = getelementptr inbounds nuw [16 x i8], ptr %.134.i24.i.ph.i104, i64 %i.el ; 2 uses
  %i.en = getelementptr inbounds nuw i8, ptr %0, i64 72
  store ptr %i.em, ptr %i.en, align 8, !tbaa !114
  %i.eo = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.ep = load ptr, ptr %i.eo, align 8, !tbaa !121 ; 2 uses
  %.not.i.i105 = icmp eq ptr %i.ep, null
  br i1 %.not.i.i105, label %bb.al, label %bb.ak

ft_mem_realloc.exit.i109:                         ; preds = %bb.ai
  store ptr null, ptr %i.dy, align 8, !tbaa !112
  br label %FT_GlyphLoader_Adjust_Points.exit.thread

bb.ak:                                            ; preds = %ft_mem_realloc.exit.thread.i103
  %i.eq = load i16, ptr %i.bc, align 2, !tbaa !122
  %i.er = zext i16 %i.eq to i64
  %i.es = getelementptr inbounds nuw [16 x i8], ptr %i.ep, i64 %i.er
  br label %bb.al

bb.al:                                            ; preds = %bb.ak, %ft_mem_realloc.exit.thread.i103
  %i.et = phi ptr [ %i.es, %bb.ak ], [ null, %ft_mem_realloc.exit.thread.i103 ]
  %i.eu = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr %i.et, ptr %i.eu, align 8, !tbaa !121
  %i.ev = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.ew = load ptr, ptr %i.ev, align 8, !tbaa !123 ; 2 uses
  %.not23.i.i106 = icmp eq ptr %i.ew, null
  br i1 %.not23.i.i106, label %bb.an, label %bb.am

bb.am:                                            ; preds = %bb.al
  %i.ex = load i16, ptr %i.bc, align 2, !tbaa !122
  %i.ey = zext i16 %i.ex to i64
  %i.ez = getelementptr inbounds nuw i8, ptr %i.ew, i64 %i.ey
  br label %bb.an

bb.an:                                            ; preds = %bb.am, %bb.al
  %i.fa = phi ptr [ %i.ez, %bb.am ], [ null, %bb.al ]
  %i.fb = getelementptr inbounds nuw i8, ptr %0, i64 112
  store ptr %i.fa, ptr %i.fb, align 8, !tbaa !123
  %i.fc = getelementptr inbounds nuw i8, ptr %0, i64 48
  %i.fd = load ptr, ptr %i.fc, align 8, !tbaa !124 ; 2 uses
  %.not24.i.i107 = icmp eq ptr %i.fd, null
  br i1 %.not24.i.i107, label %FT_GlyphLoader_Adjust_Points.exit.i108, label %bb.ao

bb.ao:                                            ; preds = %bb.an
  %i.fe = load i16, ptr %i.c, align 8, !tbaa !125
  %i.ff = zext i16 %i.fe to i64
  %i.fg = getelementptr inbounds nuw [2 x i8], ptr %i.fd, i64 %i.ff
  br label %FT_GlyphLoader_Adjust_Points.exit.i108

FT_GlyphLoader_Adjust_Points.exit.i108:           ; preds = %bb.ao, %bb.an
  %i.fh = phi ptr [ %i.fg, %bb.ao ], [ null, %bb.an ]
  %i.fi = getelementptr inbounds nuw i8, ptr %0, i64 120
  store ptr %i.fh, ptr %i.fi, align 8, !tbaa !124
  %i.fj = load i16, ptr %i.bc, align 2, !tbaa !122
  %i.fk = zext i16 %i.fj to i64                   ; 2 uses
  %i.fl = getelementptr inbounds nuw [16 x i8], ptr %.134.i24.i.ph.i104, i64 %i.fk
  %i.fm = getelementptr inbounds nuw i8, ptr %0, i64 136
  store ptr %i.fl, ptr %i.fm, align 8, !tbaa !126
  %i.fn = getelementptr inbounds nuw [16 x i8], ptr %i.em, i64 %i.fk
  %i.fo = getelementptr inbounds nuw i8, ptr %0, i64 144
  store ptr %i.fn, ptr %i.fo, align 8, !tbaa !127
  br label %bb.ap

bb.ap:                                            ; preds = %bb.ae, %bb.af, %FT_GlyphLoader_Adjust_Points.exit.i108
  %i.fp = getelementptr inbounds nuw i8, ptr %0, i64 12 ; 2 uses
  %i.fq = load i32, ptr %i.fp, align 4, !tbaa !116 ; 4 uses
  %i.fr = load i16, ptr %i.c, align 8, !tbaa !125
  %i.fs = zext i16 %i.fr to i32
  %i.ft = load i16, ptr %i.d, align 8, !tbaa !125
  %i.fu = zext i16 %i.ft to i32
  %i.fv = add i32 %2, %i.fs
  %i.fw = add i32 %i.fv, %i.fu                    ; 3 uses
  %i.fx = icmp ugt i32 %i.fw, %i.fq
  br i1 %i.fx, label %bb.aq, label %bb.as

bb.aq:                                            ; preds = %bb.ap
  %i.fy = icmp ugt i32 %i.fw, 65535
  br i1 %i.fy, label %FT_GlyphLoader_Adjust_Points.exit.thread, label %bb.ar

bb.ar:                                            ; preds = %bb.aq
  %i.fz = lshr i32 %i.fq, 1
  %i.ga = add i32 %i.fz, %i.fq
  %spec.select85 = tail call i32 @llvm.umax.i32(i32 %i.fw, i32 %i.ga)
  %i.gb = add i32 %spec.select85, 3               ; 2 uses
  %i.gc = and i32 %i.gb, -4
  %i.gd = icmp ugt i32 %i.gb, 65535
  %spec.store.select1 = select i1 %i.gd, i32 65535, i32 %i.gc ; 2 uses
  %i.ge = zext i32 %i.fq to i64
  %i.gf = zext i32 %spec.store.select1 to i64
  %i.gg = getelementptr inbounds nuw i8, ptr %0, i64 48 ; 2 uses
  %i.gh = load ptr, ptr %i.gg, align 8, !tbaa !124
  %i.gi = call ptr @ft_mem_realloc(ptr noundef %i.b, i64 noundef 2, i64 noundef %i.ge, i64 noundef %i.gf, ptr noundef %i.gh, ptr noundef nonnull %i.a)
  store ptr %i.gi, ptr %i.gg, align 8, !tbaa !124
  %i.gj = load i32, ptr %i.a, align 4, !tbaa !98  ; 2 uses
  %.not82 = icmp eq i32 %i.gj, 0
  br i1 %.not82, label %.thread129, label %FT_GlyphLoader_Adjust_Points.exit.thread

.thread129:                                       ; preds = %bb.ar
  store i32 %spec.store.select1, ptr %i.fp, align 4, !tbaa !116
  br label %bb.at

bb.as:                                            ; preds = %bb.ap
  br i1 %.not, label %bb.at, label %FT_GlyphLoader_Adjust_Points.exit

bb.at:                                            ; preds = %.thread129, %bb.as
  %i.gk = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.gl = load ptr, ptr %i.gk, align 8, !tbaa !121 ; 2 uses
  %.not.i111 = icmp eq ptr %i.gl, null
  br i1 %.not.i111, label %bb.av, label %bb.au

bb.au:                                            ; preds = %bb.at
  %i.gm = load i16, ptr %i.bc, align 2, !tbaa !122
  %i.gn = zext i16 %i.gm to i64
  %i.go = getelementptr inbounds nuw [16 x i8], ptr %i.gl, i64 %i.gn
  br label %bb.av

bb.av:                                            ; preds = %bb.au, %bb.at
  %i.gp = phi ptr [ %i.go, %bb.au ], [ null, %bb.at ]
  %i.gq = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr %i.gp, ptr %i.gq, align 8, !tbaa !121
  %i.gr = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.gs = load ptr, ptr %i.gr, align 8, !tbaa !123 ; 2 uses
  %.not23.i = icmp eq ptr %i.gs, null
  br i1 %.not23.i, label %bb.ax, label %bb.aw

bb.aw:                                            ; preds = %bb.av
  %i.gt = load i16, ptr %i.bc, align 2, !tbaa !122
  %i.gu = zext i16 %i.gt to i64
  %i.gv = getelementptr inbounds nuw i8, ptr %i.gs, i64 %i.gu
  br label %bb.ax

bb.ax:                                            ; preds = %bb.aw, %bb.av
  %i.gw = phi ptr [ %i.gv, %bb.aw ], [ null, %bb.av ]
end_hunk_0
