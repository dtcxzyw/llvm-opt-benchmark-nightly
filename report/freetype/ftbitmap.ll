...
.lr.ph298:                                        ; preds = %.lr.ph298.preheader, %.lr.ph298
  ...
  %i.ud = load i8, ptr %9, align 1, !tbaa !24
  %13 = load i8, ptr %8, align 1, !tbaa !24
  %i.ue = load i8, ptr %.0212297, align 1, !tbaa !24
  %i.uf = zext i8 %12 to i32
  %i.ug = zext i8 %i.ud to i32
  %14 = zext i8 %13 to i32
  %i.uh = zext i8 %i.ue to i32
  %i.ui = mul nuw nsw i32 %i.uc, %i.uf
  %15 = mul nuw nsw i32 %i.uc, %i.ug
  %i.uj = mul nuw nsw i32 %i.uc, %14
  %16 = mul nuw nsw i32 %i.uc, %i.uh
  %.lhs.trunc332 = trunc nuw i32 %i.ui to i16
  %.lhs.trunc330 = trunc nuw i32 %15 to i16
  %.lhs.trunc328 = trunc nuw i32 %i.uj to i16
  %.lhs.trunc.a = trunc nuw i32 %16 to i16
  %i.uk = insertelement <4 x i16> poison, i16 %.lhs.trunc.a, i64 0
  %i.ul = insertelement <4 x i16> %i.uk, i16 %.lhs.trunc328, i64 1
  %i.um = insertelement <4 x i16> %i.ul, i16 %.lhs.trunc330, i64 2
  %i.un = insertelement <4 x i16> %i.um, i16 %.lhs.trunc332, i64 3
