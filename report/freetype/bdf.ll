...
bb.e:                                             ; preds = %.lr.ph417
  ...
  br i1 %i.ab, label %.lr.ph417, label %.critedge2.i.i, !llvm.loop !43
...
.lr.ph417:                                        ; preds = %.critedge.i.i, %bb.e
  ...
  br i1 %i.ae, label %bb.e, label %bb.k, !llvm.loop !43
...
bb.l:                                             ; preds = %bb.k
  %i.at = load ptr, ptr %i.b, align 8, !tbaa !38
  %i.au = sub i64 %.062.i.i416, %.265.lcssa.i.i
  %i.av = call i32 %i.at(ptr noundef nonnull %i.ar, i64 noundef %i.au, i64 noundef %.17192.i.i, ptr noundef nonnull %i.i, ptr noundef nonnull %i.b) #18, !inline_history !44 ; 2 uses
  store i32 %i.av, ptr %i.c, align 4, !tbaa !28
...
bdf_readstream_.exit.i:                           ; preds = %bb.j, %bb.h, %bb.l, %bb.g, %.preheader83.i.i, %bb.c
  ...
  %i.ay = load i32, ptr %i.c, align 4, !tbaa !28  ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #18
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #18
  store i32 %i.ay, ptr %i.d, align 4, !tbaa !28
...
bb.n:                                             ; preds = %bdf_readstream_.exit.i
  ...
  %.pre.i = load i64, ptr %i.i, align 8, !tbaa !29 ; 4 uses
...
bb.y:                                             ; preds = %bb.x, %bb.w
  ...
  %i.cg = load i16, ptr %i.cf, align 2, !tbaa !62
...
bb.z:                                             ; preds = %bb.y
  ...
  store i16 %i.ci, ptr %i.cf, align 2, !tbaa !62
  br label %bb.aa

bb.aa:                                            ; preds = %bb.z, %bb.y, %bb.p, %bb.o
  %.not71.i = trunc i64 %.pre.i to i1
  br i1 %.not71.i, label %bdf_readstream_.exit._crit_edge.sink.split.i, label %.thread.i

.thread102.i:                                     ; preds = %bb.n
  %.not71103.i = trunc i64 %.pre.i to i1
  br i1 %.not71103.i, label %bdf_readstream_.exit._crit_edge.sink.split.i, label %.thread104.i
...
.thread.i:                                        ; preds = %.thread104.i, %bb.aa, %bdf_readstream_.exit._crit_edge.i, %bb.ab
  ...
  store ptr null, ptr %i.ck, align 8, !tbaa !63
  call void @ft_mem_free(ptr noundef %i.g, ptr noundef nonnull %i.i) #18
  %.pre92.i = load i32, ptr %i.d, align 4, !tbaa !28
...
bdf_load_font.exit:                               ; preds = %bb.ab, %.thread.i
  ...
  store i32 %i.cn, ptr %i.e, align 4, !tbaa !28
...
bb.ad:                                            ; preds = %bb.ac
  ...
  store ptr %.1287, ptr %i.cq, align 8, !tbaa !64
...
bb.af:                                            ; preds = %bb.ad
  ...
  %i.cv = load i64, ptr %i.cu, align 8, !tbaa !69
  %i.cw = or i64 %i.cv, 18
  store i64 %i.cw, ptr %i.cu, align 8, !tbaa !69
...
bb.ag:                                            ; preds = %bb.af
  ...
  %i.cz = load i64, ptr %i.cy, align 8, !tbaa !70
...
bdf_get_font_property.exit:                       ; preds = %bb.ah
  ...
  %i.df = load ptr, ptr %i.de, align 8, !tbaa !72 ; 2 uses
...
bb.ai:                                            ; preds = %bdf_get_font_property.exit
  %i.dg = load i64, ptr %i.dd, align 8, !tbaa !73
...
switch.lookup:                                    ; preds = %switch.hole_check
  ...
  store i32 %switch.ext, ptr %i.dn, align 8, !tbaa !74
...
bdf_get_font_property.exit.thread:                ; preds = %switch.hole_check, %bb.aj, %switch.lookup, %bb.ag, %bb.ah, %bb.af, %bb.ai, %bdf_get_font_property.exit
  ...
  %i.dp = load i32, ptr %i.do, align 8, !tbaa !74
...
bb.ak:                                            ; preds = %bdf_get_font_property.exit.thread, %bdf_get_font_property.exit.thread
  %i.dq = load i64, ptr %i.cu, align 8, !tbaa !69
  %i.dr = or i64 %i.dq, 4
  store i64 %i.dr, ptr %i.cu, align 8, !tbaa !69
  br label %bb.al

bb.al:                                            ; preds = %bb.ak, %bdf_get_font_property.exit.thread
  %i.ds = getelementptr inbounds nuw i8, ptr %.1287, i64 128
  %i.dt = load i64, ptr %i.ds, align 8, !tbaa !70
...
bb.am:                                            ; preds = %bb.al
  ...
  %i.dw = load ptr, ptr %i.dv, align 8, !tbaa !71
...
bdf_get_font_property.exit250:                    ; preds = %bb.am
  ...
  %i.dz = load ptr, ptr %i.dy, align 8, !tbaa !72 ; 2 uses
...
bb.an:                                            ; preds = %bdf_get_font_property.exit250
  %i.ea = load i64, ptr %i.dx, align 8, !tbaa !73
  %i.eb = getelementptr inbounds nuw [24 x i8], ptr %i.dz, i64 %i.ea
  %i.ec = getelementptr inbounds nuw i8, ptr %i.eb, i64 16
  %i.ed = load ptr, ptr %i.ec, align 8, !tbaa !40 ; 2 uses
...
bb.ao:                                            ; preds = %bb.an
  ...
  store ptr %i.ee, ptr %i.ef, align 8, !tbaa !75
  %i.eg = load i32, ptr %i.e, align 4, !tbaa !28  ; 2 uses
...
bdf_get_font_property.exit250.thread:             ; preds = %bb.al, %bb.am, %bb.an, %bdf_get_font_property.exit250
  ...
  store ptr null, ptr %i.eh, align 8, !tbaa !75
  br label %bb.ap

bb.ap:                                            ; preds = %bb.ao, %bdf_get_font_property.exit250.thread
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #18
  store i32 0, ptr %i.a, align 4, !tbaa !28
  %i.ei = load ptr, ptr %i.f, align 8, !tbaa !8
  %i.ej = load ptr, ptr %i.cq, align 8, !tbaa !64 ; 7 uses
  %i.ek = getelementptr inbounds nuw i8, ptr %1, i64 24 ; 5 uses
  store i64 0, ptr %i.ek, align 8, !tbaa !76
...
bb.aq:                                            ; preds = %bb.ap
  ...
  %i.en = load i64, ptr %i.em, align 8, !tbaa !70
...
bdf_get_font_property.exit.i:                     ; preds = %bb.ar
  ...
  %i.et = load ptr, ptr %i.es, align 8, !tbaa !72 ; 2 uses
  %i.eu = load i64, ptr %i.er, align 8, !tbaa !73
...
bb.as:                                            ; preds = %bdf_get_font_property.exit.i
  ...
  %i.ex = load i32, ptr %i.ew, align 8, !tbaa !77
...
bb.au:                                            ; preds = %bb.at
  %i.fb = load i8, ptr %i.fa, align 1, !tbaa !40
...
bb.cr:                                            ; preds = %bb.co, %bb.cp, %bb.cq
  ...
  store i16 %.sink398, ptr %i.tu, align 2, !tbaa !97
...
bb.cs:                                            ; preds = %bb.cr
  ...
  %i.tx = load i64, ptr %i.tw, align 8, !tbaa !40 ; 2 uses
...
bb.cu:                                            ; preds = %bb.cr
  ...
  %i.uc = load i64, ptr %i.ub, align 8, !tbaa !98 ; 3 uses
...
bb.cw:                                            ; preds = %bb.cu
  ...
  %i.ug = load i16, ptr %i.uf, align 2, !tbaa !97
...
bb.cx:                                            ; preds = %bb.cv, %bb.cs, %bb.cw, %bb.ct
  ...
  store i64 %.sink400, ptr %i.uk, align 8, !tbaa !99
...
bb.cy:                                            ; preds = %bb.cx
  ...
  %i.un = load i64, ptr %i.um, align 8, !tbaa !40 ; 2 uses
...
.sink.split:                                      ; preds = %bb.cy, %bb.cz
  ...
  store i64 %.sink402, ptr %i.us, align 8, !tbaa !100
  br label %bb.da
...
bb.da:                                            ; preds = %.sink.split, %bb.cx
  ...
  %.0167 = load i64, ptr %.0167.in, align 8, !tbaa !40 ; 3 uses
...
bb.dd:                                            ; preds = %bb.db, %bb.dc, %bb.da
  ...
  %.1 = load i64, ptr %.1.in, align 8, !tbaa !40  ; 3 uses
...
bb.df:                                            ; preds = %bb.de
  ...
  %i.vg = load i64, ptr %i.vf, align 8, !tbaa !100 ; 2 uses
...
.thread380:                                       ; preds = %bb.dd
  ...
  %i.vj = load i64, ptr %i.vi, align 8, !tbaa !100 ; 2 uses
...
.thread383:                                       ; preds = %.thread380
  ...
  %i.vm = load i64, ptr %i.vl, align 8, !tbaa !99 ; 2 uses
  store i64 %i.vm, ptr %i.vi, align 8, !tbaa !100
  br label %.thread301

.thread:                                          ; preds = %bb.de
  %i.vn = getelementptr inbounds nuw i8, ptr %i.sa, i64 24 ; 3 uses
  %i.vo = load i64, ptr %i.vn, align 8, !tbaa !100 ; 2 uses
...
.thread297:                                       ; preds = %.thread
  ...
  %i.vr = load i64, ptr %i.vq, align 8, !tbaa !99 ; 2 uses
  store i64 %i.vr, ptr %i.vn, align 8, !tbaa !100
  br label %bb.dh

bb.dg:                                            ; preds = %bb.df
  %i.vs = getelementptr inbounds nuw i8, ptr %i.sa, i64 8
  %i.vt = load i64, ptr %i.vs, align 8, !tbaa !99 ; 2 uses
  store i64 %i.vt, ptr %i.vf, align 8, !tbaa !100
  br label %bb.dh
...
.thread301:                                       ; preds = %bb.di, %.thread383, %.thread380, %bb.dj
  ...
  store i64 %.sink404, ptr %i.wc, align 8, !tbaa !101
...
bb.dk:                                            ; preds = %.thread301
  ...
  %i.wf = load i64, ptr %i.we, align 8, !tbaa !40
  br label %bb.dl
...
bb.dl:                                            ; preds = %.thread301, %bb.dk
  ...
  store i64 %.sink324, ptr %i.wg, align 8, !tbaa !102
  %i.wh = getelementptr inbounds nuw i8, ptr %.1287, i64 96
  %i.wi = load ptr, ptr %i.wh, align 8, !tbaa !103 ; 3 uses
  %i.wj = load i64, ptr %i.rv, align 8, !tbaa !89
  ...
  store ptr %i.wk, ptr %i.wl, align 8, !tbaa !104
  %i.wm = load i32, ptr %i.e, align 4, !tbaa !28  ; 2 uses
...
bb.dm:                                            ; preds = %bb.dl
  ...
  store i32 0, ptr %i.wn, align 8, !tbaa !105
  %i.wo = load i64, ptr %i.rv, align 8, !tbaa !89 ; 5 uses
  %.not314 = icmp eq i64 %i.wo, 0
  br i1 %.not314, label %._crit_edge, label %.lr.ph

.lr.ph:                                           ; preds = %bb.dm
  %i.wp = load i64, ptr %i.wg, align 8, !tbaa !102 ; 3 uses
...
bb.do:                                            ; preds = %bb.dn
  ...
  store i32 %i.wz, ptr %i.wn, align 8, !tbaa !105
  br label %bb.dp
...
bb.dq:                                            ; preds = %bb.dp
  ...
  store i32 %i.xj, ptr %i.wn, align 8, !tbaa !105
  br label %bb.dr
...
bb.dr:                                            ; preds = %bb.dq, %bb.dp
  ...
  br i1 %niter.ncmp.1, label %._crit_edge.loopexit.unr-lcssa, label %bb.dn, !llvm.loop !111

._crit_edge.loopexit.unr-lcssa:                   ; preds = %bb.dr
  %lcmp.mod.not = trunc i64 %i.wo to i1
...
bb.ds:                                            ; preds = %.epil.preheader
  ...
  store i32 %i.xt, ptr %i.wn, align 8, !tbaa !105
  br label %._crit_edge
...
bb.dw:                                            ; preds = %bb.dv
  ...
  %i.yh = load ptr, ptr %i.yg, align 8, !tbaa !40 ; 2 uses
...
bb.dx:                                            ; preds = %bb.dw
  ...
  store ptr %i.yi, ptr %i.yj, align 8, !tbaa !112
  %i.yk = load i32, ptr %i.e, align 4, !tbaa !28  ; 2 uses
  %.not233 = icmp eq i32 %i.yk, 0
  br i1 %.not233, label %bb.dy, label %.critedge246

bb.dy:                                            ; preds = %bb.dx
  %i.yl = load ptr, ptr %i.ye, align 8, !tbaa !40
  ...
  store ptr %i.ym, ptr %i.yn, align 8, !tbaa !113
  %i.yo = load i32, ptr %i.e, align 4, !tbaa !28  ; 2 uses
  %.not234 = icmp eq i32 %i.yo, 0
  br i1 %.not234, label %bb.dz, label %.critedge246

bb.dz:                                            ; preds = %bb.dy
  %i.yp = load i8, ptr %i.ym, align 1, !tbaa !40
...
sub_0:                                            ; preds = %bb.ed
  %i.yx = load ptr, ptr %i.yj, align 8, !tbaa !112 ; 2 uses
...
bb.ee:                                            ; preds = %.tail.thread
  %i.zg = load ptr, ptr %i.yj, align 8, !tbaa !112
...
bb.ef:                                            ; preds = %.thread304, %bb.ee
  ...
  store i32 1970170211, ptr %i.zn, align 8, !tbaa !117
  store i16 3, ptr %i.zm, align 4, !tbaa !118
  store i16 1, ptr %i.zl, align 2, !tbaa !119
  br label %bb.eg
...
bb.eh:                                            ; preds = %bb.dt, %bb.du, %bb.dv, %bb.dw, %._crit_edge
  ...
  store i32 1094995778, ptr %i.zq, align 8, !tbaa !117
  %i.zr = getelementptr inbounds nuw i8, ptr %6, i64 12
  store i16 7, ptr %i.zr, align 4, !tbaa !118
  %i.zs = getelementptr inbounds nuw i8, ptr %6, i64 14
  store i16 0, ptr %i.zs, align 2, !tbaa !119
  ...
  %i.zv = load i32, ptr %i.zu, align 8, !tbaa !120
  %.not232 = icmp eq i32 %i.zv, 0
  br i1 %.not232, label %bb.ej, label %bb.ei

bb.ei:                                            ; preds = %bb.eh
  %i.zw = getelementptr inbounds nuw i8, ptr %1, i64 80
  %i.zx = load ptr, ptr %i.zw, align 8, !tbaa !121
  %i.zy = load ptr, ptr %i.zx, align 8, !tbaa !122
  %i.zz = getelementptr inbounds nuw i8, ptr %1, i64 168
  store ptr %i.zy, ptr %i.zz, align 8, !tbaa !123
  br label %bb.ej
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !159  ; 15 uses
  %i.d = load ptr, ptr %0, align 8, !tbaa !160
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.g = load ptr, ptr %i.e, align 8, !tbaa !71
...
bb.d:                                             ; preds = %bb.b, %bb.c
  ...
  store ptr null, ptr %i.h, align 8, !tbaa !161
  %i.j = getelementptr inbounds nuw i8, ptr %0, i64 128 ; 2 uses
  %i.k = load i64, ptr %i.j, align 8, !tbaa !70   ; 2 uses
...
bb.e:                                             ; preds = %.lr.ph, %bb.g
  ...
  %i.q = load i32, ptr %i.p, align 8, !tbaa !77
...
bb.g:                                             ; preds = %bb.e, %bb.f
  ...
  br i1 %i.z, label %bb.e, label %._crit_edge, !llvm.loop !162
...
._crit_edge:                                      ; preds = %bb.g, %bb.d
  ...
  store ptr null, ptr %i.aa, align 8, !tbaa !72
...
.lr.ph76:                                         ; preds = %.lr.ph76.preheader, %.lr.ph76
  ...
  store ptr null, ptr %i.ah, align 8, !tbaa !164
  ...
  br i1 %i.am, label %.lr.ph76, label %._crit_edge77, !llvm.loop !165
...
.lr.ph81:                                         ; preds = %.lr.ph81.preheader, %.lr.ph81
  ...
  store ptr null, ptr %i.as, align 8, !tbaa !164
  %i.au = add nuw i64 %.278, 1                    ; 2 uses
  %i.av = getelementptr inbounds nuw i8, ptr %.179, i64 56
  %i.aw = load i64, ptr %i.ao, align 8, !tbaa !46
  %i.ax = icmp ult i64 %i.au, %i.aw
  br i1 %i.ax, label %.lr.ph81, label %._crit_edge82, !llvm.loop !167

._crit_edge82:                                    ; preds = %.lr.ph81, %._crit_edge77
  %i.ay = load ptr, ptr %i.ac, align 8, !tbaa !103
  tail call void @ft_mem_free(ptr noundef %i.c, ptr noundef %i.ay) #18
  store ptr null, ptr %i.ac, align 8, !tbaa !103
  %i.az = load ptr, ptr %i.an, align 8, !tbaa !166
  tail call void @ft_mem_free(ptr noundef %i.c, ptr noundef %i.az) #18
  store ptr null, ptr %i.an, align 8, !tbaa !166
  ...
  %i.bc = load ptr, ptr %i.bb, align 8, !tbaa !168 ; 2 uses
  %i.bd = getelementptr inbounds nuw i8, ptr %0, i64 200 ; 2 uses
  %i.be = load i64, ptr %i.bd, align 8, !tbaa !169
...
.lr.ph86:                                         ; preds = %._crit_edge82, %.lr.ph86
  ...
  %i.bf = load ptr, ptr %.06983, align 8, !tbaa !170
  tail call void @ft_mem_free(ptr noundef %i.c, ptr noundef %i.bf) #18
  store ptr null, ptr %.06983, align 8, !tbaa !170
  %i.bg = add nuw i64 %.384, 1                    ; 2 uses
  %i.bh = getelementptr inbounds nuw i8, ptr %.06983, i64 24
  %i.bi = load i64, ptr %i.bd, align 8, !tbaa !169
  %i.bj = icmp ult i64 %i.bg, %i.bi
  br i1 %i.bj, label %.lr.ph86, label %._crit_edge87.loopexit, !llvm.loop !171

._crit_edge87.loopexit:                           ; preds = %.lr.ph86
  %.pre92 = load ptr, ptr %i.bb, align 8, !tbaa !168
...
._crit_edge87:                                    ; preds = %._crit_edge87.loopexit, %._crit_edge82
  ...
  store ptr null, ptr %i.bb, align 8, !tbaa !168
  br label %bb.h
...
bb.a:
  ...
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !37   ; 10 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #18
  store i32 0, ptr %i.b, align 4, !tbaa !28
  %i.e = load i64, ptr %3, align 8, !tbaa !29     ; 7 uses
  %.not = trunc i64 %i.e to i1
...
bb.b:                                             ; preds = %bb.a
  ...
  %.not141 = icmp eq i32 %i.f, 0
  br i1 %.not141, label %bb.d, label %bb.c

bb.c:                                             ; preds = %bb.b
  store i32 176, ptr %i.b, align 4, !tbaa !28
  br label %.thread278

bb.d:                                             ; preds = %bb.b
  %i.g = or disjoint i64 %i.e, 1
  store i64 %i.g, ptr %3, align 8, !tbaa !29
  ...
  %.not142 = icmp eq i32 %i.j, 0
  br i1 %.not142, label %bb.e, label %.thread278

bb.e:                                             ; preds = %bb.d
  %i.k = getelementptr inbounds nuw i8, ptr %i.h, i64 184
  store ptr %i.d, ptr %i.k, align 8, !tbaa !159
  br label %.thread278
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.r = load ptr, ptr %i.q, align 8, !tbaa !159
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #18
  store i32 0, ptr %i.a, align 4, !tbaa !28
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.w = load i64, ptr %i.v, align 8, !tbaa !172  ; 2 uses
  ...
  store ptr %i.ab, ptr %i.z, align 8, !tbaa !161
  %i.ac = load i32, ptr %i.a, align 4, !tbaa !28  ; 2 uses
  %.not.i = icmp eq i32 %i.ac, 0
  br i1 %.not.i, label %bb.j, label %bdf_add_comment_.exit

bb.j:                                             ; preds = %bb.i
  %i.ad = load i64, ptr %i.v, align 8, !tbaa !172
  ...
  store i8 0, ptr %i.af, align 1, !tbaa !40
  %i.ag = load i64, ptr %i.v, align 8, !tbaa !172
  %i.ah = add i64 %i.ag, %i.x
  store i64 %i.ah, ptr %i.v, align 8, !tbaa !172
  %.pre.i = load i32, ptr %i.a, align 4, !tbaa !28
...
bb.k:                                             ; preds = %bb.f
  %i.aj = and i64 %i.e, 16
  %.not143 = icmp eq i64 %i.aj, 0
  br i1 %.not143, label %bb.l, label %bb.x
...
bb.l:                                             ; preds = %bb.k
  ...
  br i1 %i.al, label %.preheader290, label %bb.x

.preheader290:                                    ; preds = %bb.l, %bb.m
  %.0.i = phi ptr [ %i.an, %bb.m ], [ %0, %bb.l ] ; 5 uses
  %i.am = load i8, ptr %.0.i, align 1, !tbaa !40
  switch i8 %i.am, label %bb.m [
    i8 0, label %.loopexit.i.preheader
    i8 32, label %bb.n
  ]

bb.m:                                             ; preds = %.preheader290
  %i.an = getelementptr inbounds nuw i8, ptr %.0.i, i64 1
  br label %.preheader290, !llvm.loop !173

bb.n:                                             ; preds = %.preheader290
  %i.ao = getelementptr inbounds nuw i8, ptr %.0.i, i64 1
  store i8 0, ptr %.0.i, align 1, !tbaa !40
  br label %.loopexit.i.preheader

.loopexit.i.preheader:                            ; preds = %.preheader290, %bb.n
  %.2.i.ph = phi ptr [ %i.ao, %bb.n ], [ %.0.i, %.preheader290 ]
  br label %.loopexit.i

.loopexit.i:                                      ; preds = %.loopexit.i.preheader, %.loopexit.i
  %.2.i = phi ptr [ %i.aq, %.loopexit.i ], [ %.2.i.ph, %.loopexit.i.preheader ] ; 3 uses
  %i.ap = load i8, ptr %.2.i, align 1, !tbaa !40  ; 4 uses
  %cond.i = icmp eq i8 %i.ap, 32
  %i.aq = getelementptr inbounds nuw i8, ptr %.2.i, i64 1
  br i1 %cond.i, label %.loopexit.i, label %bdf_strtok_.exit, !llvm.loop !174
...
.thread:                                          ; preds = %.lr.ph.i
  ...
  store i64 -1, ptr %i.bc, align 8, !tbaa !70
  br label %bb.p
...
bb.o:                                             ; preds = %.lr.ph.i
  ...
  %i.bk = load i8, ptr %i.bj, align 1, !tbaa !40  ; 3 uses
  %i.bl = lshr i8 %i.bk, 3
  ...
  br i1 %.not.i161, label %bdf_atoul_.exit, label %.lr.ph.i, !llvm.loop !175
...
bdf_atoul_.exit.thread:                           ; preds = %bdf_strtok_.exit, %bdf_atoul_.exit
  ...
  store i64 %i.bu, ptr %i.bv, align 8, !tbaa !70
...
bb.p:                                             ; preds = %.thread, %bdf_atoul_.exit.thread
  ...
  store i64 0, ptr %i.ca, align 8, !tbaa !70
...
bb.q:                                             ; preds = %bdf_atoul_.exit.thread
  ...
  store ptr %i.cb, ptr %i.cc, align 8, !tbaa !72
  %i.cd = load i32, ptr %i.b, align 4, !tbaa !28
  %.not144 = icmp eq i32 %i.cd, 0
  br i1 %.not144, label %bb.s, label %bb.r

bb.r:                                             ; preds = %bb.q
  store i64 0, ptr %i.bv, align 8, !tbaa !70
  br label %.thread278
...
bb.s:                                             ; preds = %bb.q
  ...
  store ptr %i.ce, ptr %i.cf, align 8, !tbaa !71
  %i.cg = load i32, ptr %i.b, align 4, !tbaa !28
end_hunk_2
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.d
  ...
  %.not29 = trunc i64 %.02531 to i1
  br i1 %.not29, label %bb.b, label %bb.c

bb.b:                                             ; preds = %.lr.ph
  %i.s = getelementptr inbounds nuw i8, ptr %.02630, i64 1
  %i.t = load i8, ptr %.02630, align 1, !tbaa !40
