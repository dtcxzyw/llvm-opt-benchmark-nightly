...
.backedge.us.backedge:                            ; preds = %check_background_thread_creation.exit.thread.us, %background_thread_pause_check.exit.us
  br label %.backedge.us, !llvm.loop !73

check_background_thread_creation.exit.thread37.loopexit.us: ; preds = %bb.m
  %i.cq = load ptr, ptr @je_background_thread_info, align 8, !tbaa !24
  %i.cr = getelementptr inbounds nuw i8, ptr %i.cq, i64 56
  tail call fastcc void @malloc_mutex_lock(ptr noundef %0, ptr noundef nonnull %i.cr), !inline_history !71
  %.pre59 = load ptr, ptr @je_background_thread_info, align 8, !tbaa !24
...
.lr.ph52:                                         ; preds = %.preheader, %bb.u
  ...
  %i.dc = load i8, ptr %i.db, align 1, !tbaa !33, !range !25, !noundef !26
...
bb.q:                                             ; preds = %bb.p, %malloc_mutex_trylock_final.exit.i
  ...
  %i.dl = add i64 %i.dk, 1
  store i64 %i.dl, ptr %i.dj, align 8, !tbaa !19
...
._crit_edge.loopexit:                             ; preds = %bb.u
  %.pre = load ptr, ptr @je_background_thread_info, align 8, !tbaa !24
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.preheader
  %i.dy = phi ptr [ %.pre, %._crit_edge.loopexit ], [ %i.ah, %.preheader ]
  %i.dz = getelementptr inbounds nuw i8, ptr %i.dy, i64 168
  store i32 0, ptr %i.dz, align 8, !tbaa !31
  ret void
}
...
bb.e:                                             ; preds = %._crit_edge
  %i.ae = call i64 @llvm.umax.i64(i64 %.023.lcssa, i64 100000000) ; 2 uses
  ...
  store i64 %i.aj, ptr %7, align 8, !tbaa !84
...
bb.f:                                             ; preds = %bb.e, %bb.d
  ...
  %i.ar = load i64, ptr %3, align 8, !tbaa !81
