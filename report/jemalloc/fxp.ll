...
begin_hunk_0_@je_fxp_parse:bb.a
  %i.ab = icmp ult i8 %i.aa, 10                   ; 2 uses
  %.2.idx.4 = zext i1 %i.ab to i64
  %.2.4 = getelementptr inbounds nuw i8, ptr %.2.3, i64 %.2.idx.4 ; 2 uses
  %i.ac = load i8, ptr %.2.4, align 1, !tbaa !12  ; 2 uses
  %i.ad = add i8 %i.ac, -48
  %i.ae = icmp ult i8 %i.ad, 10                   ; 2 uses
  %.2.idx.5 = zext i1 %i.ae to i64
  %.2.5 = getelementptr inbounds nuw i8, ptr %.2.4, i64 %.2.idx.5 ; 2 uses
  %i.af = load i8, ptr %.2.5, align 1, !tbaa !12  ; 2 uses
  %i.ag = add i8 %i.af, -48
  %i.ah = icmp ult i8 %i.ag, 10                   ; 2 uses
  %.2.idx.6 = zext i1 %i.ah to i64
...
._crit_edge:                                      ; preds = %.lr.ph39.preheader, %.critedge
  %.024.lcssa = phi i64 [ %i.ag, %.critedge ], [ %i.ai, %.lr.ph39.preheader ] ; 2 uses
  %i.aj = getelementptr inbounds nuw i8, ptr %1, i64 %.024.lcssa
  %i.ak = sub i64 21, %.024.lcssa
  %i.al = tail call i64 (ptr, i64, ptr, ...) @je_malloc_snprintf(ptr noundef %i.aj, i64 noundef %i.ak, ptr noundef nonnull @.str.1, i64 noundef %.1.lcssa) #4 ; 0 uses
  ret void
}
