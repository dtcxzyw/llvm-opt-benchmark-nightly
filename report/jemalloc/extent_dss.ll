...
bb.h:                                             ; preds = %bb.g
  ...
  %i.al = tail call i64 @je_extent_sn_next(ptr noundef nonnull %i.u) #6
  %i.am = load i64, ptr %i.d, align 8, !tbaa !75
  %i.an = and i64 %i.am, -17592454479872
  store ptr %i.ag, ptr %i.v, align 8, !tbaa !76
  %i.ao = load i64, ptr %i.w, align 8, !tbaa !77
  %i.ap = and i64 %i.ao, 4095
  %i.aq = or i64 %i.ap, %i.ak
  store i64 %i.aq, ptr %i.w, align 8, !tbaa !77
...
bb.j:                                             ; preds = %atomic_store_p.exit
  %i.ba = tail call ptr @je_arena_get_ehooks(ptr noundef %1) #6
  tail call void @je_extent_dalloc_gap(ptr noundef %0, ptr noundef nonnull %i.u, ptr noundef %i.ba, ptr noundef nonnull %i.d) #6
  br label %bb.l
...
bb.l:                                             ; preds = %bb.k, %bb.j
  %i.bb = load i8, ptr %6, align 1, !tbaa !21, !range !18, !noundef !19
  %i.bc = trunc nuw i8 %i.bb to i1
  br i1 %i.bc, label %.thread112, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.bd = tail call zeroext i1 @je_pages_decommit(ptr noundef nonnull %i.ay, i64 noundef %3) #6 ; 2 uses
  %i.be = zext i1 %i.bd to i8
  store i8 %i.be, ptr %6, align 1, !tbaa !21
  %i.bf = load i8, ptr %5, align 1, !tbaa !21, !range !18, !noundef !19
  %i.bg = trunc nuw i8 %i.bf to i1
  %i.bh = select i1 %i.bg, i1 %i.bd, i1 false
  br i1 %i.bh, label %.thread113, label %.thread

.thread112:                                       ; preds = %bb.l
  %i.bi = load i8, ptr %5, align 1, !tbaa !21, !range !18, !noundef !19
  %i.bj = trunc nuw i8 %i.bi to i1
  br i1 %i.bj, label %.thread113, label %.thread

.thread113:                                       ; preds = %bb.m, %.thread112
  ...
  %i.bl = tail call ptr @je_arena_get_ehooks(ptr noundef nonnull %1) #6
  %.val = load i32, ptr %i.t, align 64, !tbaa !73
  %i.bm = tail call i64 @je_extent_sn_next(ptr noundef nonnull %i.u) #6
  %i.bn = getelementptr inbounds nuw i8, ptr %7, i64 8
  store ptr %i.ay, ptr %i.bn, align 8, !tbaa !76
  %i.bo = getelementptr inbounds nuw i8, ptr %7, i64 16
  store i64 %3, ptr %i.bo, align 8, !tbaa !77
...
.thread:                                          ; preds = %bb.m, %.thread112, %bb.o, %bb.b, %bb.a, %.thread93
  %.4 = phi ptr [ null, %bb.b ], [ null, %bb.a ], [ null, %.thread93 ], [ %i.ay, %bb.m ], [ %i.ay, %bb.o ], [ %i.ay, %.thread112 ]
  ret ptr %.4
}
