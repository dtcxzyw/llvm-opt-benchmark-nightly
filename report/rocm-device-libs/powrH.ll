...
bb.a:
  ...
  %2 = fcmp une <2 x half> %1, zeroinitializer    ; 2 uses
  %i.x = select <2 x i1> %2, <2 x half> %i.u, <2 x half> splat (half +qnan)
  %i.y = select <2 x i1> %i.w, <2 x half> %i.x, <2 x half> %i.s
  %i.z = fcmp oeq <2 x half> %i.f, splat (half +inf)
  %i.aa = and <2 x i1> %2, %i.z
...
bb.a:
  ...
  %2 = fcmp une half %1, 0.000000e+00             ; 2 uses
  %i.l = select i1 %2, half %i.i, half +qnan
