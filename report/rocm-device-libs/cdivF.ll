...
bb.a:
  ...
  %i.ab = tail call float @llvm.ldexp.f32.i32(float %i.v, i32 %i.t) ; 3 uses
  %2 = fmul float %i.k, %i.ab                     ; 2 uses
  %3 = tail call float @llvm.fma.f32(float %i.i, float %i.aa, float %2)
  %4 = fneg float %i.i                            ; 3 uses
  %i.ac = fmul float %i.ab, %4                    ; 2 uses
  ...
  %i.ah = insertelement <2 x float> %i.ag, float %4, i64 1
  ...
  %i.al = tail call float @llvm.fma.f32(float %i.k, float %i.aa, float %i.ac)
