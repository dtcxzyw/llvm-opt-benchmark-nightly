...
.lr.ph.preheader:                                 ; preds = %_ZNSt6vectorISt7complexIdESaIS1_EE17_S_check_init_lenEmRKS2_.exit.i
  ...
  %i.e = getelementptr inbounds nuw [16 x i8], ptr %i.d, i64 %i.a
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x double>, ptr %i.g, align 8, !tbaa !56
  %wide.load85 = load <2 x double>, ptr %i.h, align 8, !tbaa !56
  %i.i = getelementptr inbounds nuw [16 x i8], ptr %i.d, i64 %index
  %i.j = getelementptr inbounds nuw [16 x i8], ptr %i.d, i64 %index
  %i.k = getelementptr inbounds nuw i8, ptr %i.j, i64 32
  %interleaved.vec = shufflevector <2 x double> %wide.load, <2 x double> zeroinitializer, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x double> %interleaved.vec, ptr %i.i, align 8
  %interleaved.vec86 = shufflevector <2 x double> %wide.load85, <2 x double> zeroinitializer, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x double> %interleaved.vec86, ptr %i.k, align 8
...
._crit_edge:                                      ; preds = %.lr.ph, %middle.block, %_ZNSt6vectorISt7complexIdESaIS1_EE17_S_check_init_lenEmRKS2_.exit.i
  ...
  %.sink.i80 = phi i64 [ 0, %_ZNSt6vectorISt7complexIdESaIS1_EE17_S_check_init_lenEmRKS2_.exit.i ], [ %i.f, %middle.block ], [ %i.f, %.lr.ph ] ; 2 uses
...
.lr.ph:                                           ; preds = %.lr.ph.preheader87, %.lr.ph
  ...
  %i.o = getelementptr inbounds nuw [16 x i8], ptr %i.d, i64 %indvars.iv
  %i.p = insertelement <2 x double> <double poison, double 0.000000e+00>, double %i.n, i64 0
  store <2 x double> %i.p, ptr %i.o, align 8
...
bb.c:                                             ; preds = %bb.b
  %i.w = icmp ugt i64 %i.s, 9223372036854775792
  br i1 %i.w, label %.noexc.i.i, label %_ZNSt15__new_allocatorISt7complexIdEE8allocateEmPKv.exit.i.i.i.i, !prof !20
...
_ZNSt15__new_allocatorI5QuregE8allocateEmPKv.exit.i.i.i.i: ; preds = %bb.d
  %i.am = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.aj) #15
...
_ZNSt15__new_allocatorI5QuregE8allocateEmPKv.exit.i.i.i.i..noexc36_crit_edge: ; preds = %_ZNSt15__new_allocatorI5QuregE8allocateEmPKv.exit.i.i.i.i
  ...
  %.pre59 = load ptr, ptr %i.ae, align 8, !tbaa !36
...
.noexc36:                                         ; preds = %_ZNSt15__new_allocatorI5QuregE8allocateEmPKv.exit.i.i.i.i..noexc36_crit_edge, %.loopexit
  %.pre-phi62 = phi i64 [ %.pre61, %_ZNSt15__new_allocatorI5QuregE8allocateEmPKv.exit.i.i.i.i..noexc36_crit_edge ], [ %i.ai, %.loopexit ]
  %.pre-phi = phi i64 [ %.pre60, %_ZNSt15__new_allocatorI5QuregE8allocateEmPKv.exit.i.i.i.i..noexc36_crit_edge ], [ %i.ah, %.loopexit ]
  %i.an = phi ptr [ %.pre, %_ZNSt15__new_allocatorI5QuregE8allocateEmPKv.exit.i.i.i.i..noexc36_crit_edge ], [ %i.ag, %.loopexit ] ; 2 uses
  %i.ao = phi ptr [ %i.am, %_ZNSt15__new_allocatorI5QuregE8allocateEmPKv.exit.i.i.i.i..noexc36_crit_edge ], [ null, %.loopexit ] ; 5 uses
  store ptr %i.ao, ptr %6, align 8, !tbaa !35
  ...
  store ptr %i.aq, ptr %i.ar, align 8, !tbaa !37
  %i.as = sub i64 %.pre-phi, %.pre-phi62          ; 4 uses
  %i.at = icmp sgt i64 %i.as, 104
  br i1 %i.at, label %bb.e, label %bb.f, !prof !23

bb.e:                                             ; preds = %.noexc36
  call void @llvm.memmove.p0.p0.i64(ptr align 8 %i.ao, ptr align 8 %i.an, i64 %i.as, i1 false)
  br label %bb.h
...
bb.g:                                             ; preds = %bb.f
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(104) %i.ao, ptr noundef nonnull align 8 dereferenceable(104) %i.an, i64 104, i1 false), !tbaa.struct !39
  br label %bb.h

bb.h:                                             ; preds = %bb.g, %bb.f, %bb.e
  %i.av = getelementptr inbounds i8, ptr %i.ao, i64 %i.as
  store ptr %i.av, ptr %i.ap, align 8, !tbaa !34
...
bb.i:                                             ; preds = %bb.h
  %i.aw = load ptr, ptr %6, align 8, !tbaa !35    ; 3 uses
  %.not.i.i.i = icmp eq ptr %i.aw, null
  br i1 %.not.i.i.i, label %_ZNSt6vectorI5QuregSaIS0_EED2Ev.exit, label %bb.j

bb.j:                                             ; preds = %bb.i
  %i.ax = load ptr, ptr %i.ar, align 8, !tbaa !37
  %i.ay = ptrtoint ptr %i.ax to i64
  %i.az = ptrtoint ptr %i.aw to i64
  %i.ba = sub i64 %i.ay, %i.az
  call void @_ZdlPvm(ptr noundef nonnull %i.aw, i64 noundef %i.ba) #16
  br label %_ZNSt6vectorI5QuregSaIS0_EED2Ev.exit

_ZNSt6vectorI5QuregSaIS0_EED2Ev.exit:             ; preds = %bb.i, %bb.j
  %i.bb = load ptr, ptr %5, align 8, !tbaa !27    ; 3 uses
  %.not.i.i.i37 = icmp eq ptr %i.bb, null
...
bb.k:                                             ; preds = %_ZNSt6vectorI5QuregSaIS0_EED2Ev.exit
  %i.bc = load ptr, ptr %i.ac, align 8, !tbaa !29
  %i.bd = ptrtoint ptr %i.bc to i64
  %i.be = ptrtoint ptr %i.bb to i64
  %i.bf = sub i64 %i.bd, %i.be
  call void @_ZdlPvm(ptr noundef nonnull %i.bb, i64 noundef %i.bf) #16
...
_ZNSt6vectorISt7complexIdESaIS1_EED2Ev.exit:      ; preds = %_ZNSt6vectorI5QuregSaIS0_EED2Ev.exit, %bb.k
  %i.bg = load ptr, ptr %4, align 8, !tbaa !35    ; 3 uses
  %.not.i.i.i38 = icmp eq ptr %i.bg, null
...
bb.l:                                             ; preds = %_ZNSt6vectorISt7complexIdESaIS1_EED2Ev.exit
  ...
  call void @_ZdlPvm(ptr noundef nonnull %i.bg, i64 noundef %i.bl) #16
...
bb.m:                                             ; preds = %_ZNSt6vectorI5QuregSaIS0_EED2Ev.exit39
  %i.bm = sub i64 %.sink.i80, %i.r
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.050.076, i64 noundef %i.bm) #16
...
bb.q:                                             ; preds = %bb.h
  %i.bq = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.br = load ptr, ptr %6, align 8, !tbaa !35    ; 3 uses
  %.not.i.i.i42 = icmp eq ptr %i.br, null
  br i1 %.not.i.i.i42, label %_ZNSt6vectorI5QuregSaIS0_EED2Ev.exit43, label %bb.r

bb.r:                                             ; preds = %bb.q
  %i.bs = load ptr, ptr %i.ar, align 8, !tbaa !37
  %i.bt = ptrtoint ptr %i.bs to i64
  %i.bu = ptrtoint ptr %i.br to i64
  %i.bv = sub i64 %i.bt, %i.bu
  call void @_ZdlPvm(ptr noundef nonnull %i.br, i64 noundef %i.bv) #16
  br label %_ZNSt6vectorI5QuregSaIS0_EED2Ev.exit43

_ZNSt6vectorI5QuregSaIS0_EED2Ev.exit43:           ; preds = %bb.r, %bb.q, %bb.p
  %.pn = phi { ptr, i32 } [ %i.bp, %bb.p ], [ %i.bq, %bb.q ], [ %i.bq, %bb.r ] ; 2 uses
  %i.bw = load ptr, ptr %5, align 8, !tbaa !27    ; 3 uses
  %.not.i.i.i44 = icmp eq ptr %i.bw, null
  br i1 %.not.i.i.i44, label %_ZNSt6vectorISt7complexIdESaIS1_EED2Ev.exit45, label %bb.s

bb.s:                                             ; preds = %_ZNSt6vectorI5QuregSaIS0_EED2Ev.exit43
  %i.bx = load ptr, ptr %i.ac, align 8, !tbaa !29
  %i.by = ptrtoint ptr %i.bx to i64
  %i.bz = ptrtoint ptr %i.bw to i64
  %i.ca = sub i64 %i.by, %i.bz
  call void @_ZdlPvm(ptr noundef nonnull %i.bw, i64 noundef %i.ca) #16
  br label %_ZNSt6vectorISt7complexIdESaIS1_EED2Ev.exit45

_ZNSt6vectorISt7complexIdESaIS1_EED2Ev.exit45:    ; preds = %bb.s, %_ZNSt6vectorI5QuregSaIS0_EED2Ev.exit43, %bb.o
  %.pn.pn = phi { ptr, i32 } [ %i.bo, %bb.o ], [ %.pn, %_ZNSt6vectorI5QuregSaIS0_EED2Ev.exit43 ], [ %.pn, %bb.s ] ; 2 uses
  %i.cb = load ptr, ptr %4, align 8, !tbaa !35    ; 3 uses
  %.not.i.i.i46 = icmp eq ptr %i.cb, null
  br i1 %.not.i.i.i46, label %_ZNSt6vectorI5QuregSaIS0_EED2Ev.exit47, label %bb.t

bb.t:                                             ; preds = %_ZNSt6vectorISt7complexIdESaIS1_EED2Ev.exit45
...
_ZNSt6vectorI5QuregSaIS0_EED2Ev.exit47:           ; preds = %bb.t, %_ZNSt6vectorISt7complexIdESaIS1_EED2Ev.exit45, %bb.n
  %.pn.pn.pn = phi { ptr, i32 } [ %i.bn, %bb.n ], [ %.pn.pn, %_ZNSt6vectorISt7complexIdESaIS1_EED2Ev.exit45 ], [ %.pn.pn, %bb.t ]
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #13
  %.not.i.i.i48 = icmp eq ptr %.sroa.050.076, null
  br i1 %.not.i.i.i48, label %_ZNSt6vectorISt7complexIdESaIS1_EED2Ev.exit49, label %bb.u

bb.u:                                             ; preds = %_ZNSt6vectorI5QuregSaIS0_EED2Ev.exit47
  %i.ch = ptrtoint ptr %.sroa.050.076 to i64
  %i.ci = sub i64 %.sink.i80, %i.ch
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.050.076, i64 noundef %i.ci) #16
  br label %_ZNSt6vectorISt7complexIdESaIS1_EED2Ev.exit49

_ZNSt6vectorISt7complexIdESaIS1_EED2Ev.exit49:    ; preds = %bb.u, %_ZNSt6vectorI5QuregSaIS0_EED2Ev.exit47
  resume { ptr, i32 } %.pn.pn.pn
}
