...
bb.j:                                             ; preds = %.preheader, %bb.m
  ...
  %4 = getelementptr inbounds nuw i8, ptr %i.bb, i64 8
  %i.bc = load ptr, ptr %i.ax, align 8, !tbaa !90
  %i.bd = getelementptr inbounds nuw [16 x i8], ptr %i.bc, i64 %.084
  %5 = load double, ptr %4, align 8, !tbaa !57    ; 2 uses
  %6 = load double, ptr %i.bb, align 8, !tbaa !57 ; 2 uses
  %i.be = fneg double %5
  %i.bf = load <2 x double>, ptr %i.bd, align 8   ; 4 uses
  %7 = insertelement <2 x double> poison, double %6, i64 0
  %i.bg = shufflevector <2 x double> %7, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.bj = fmul <2 x double> %9, %i.bi             ; 2 uses
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.bt = tail call noundef { double, double } @__muldc3(double noundef %6, double noundef %i.be, double noundef %i.br, double noundef %i.bs) #32 ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.az = tail call noundef { double, double } @__muldc3(double noundef %6, double noundef %i.ak, double noundef %i.ax, double noundef %i.ay) #32 ; 2 uses
