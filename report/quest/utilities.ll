...
bb.j:                                             ; preds = %.preheader, %bb.m
  ...
  %4 = load ptr, ptr %i.ax, align 8, !tbaa !169
  %5 = getelementptr inbounds nuw [16 x i8], ptr %4, i64 %.084
  %6 = load <2 x double>, ptr %i.bb, align 8, !tbaa !71 ; 4 uses
  %7 = extractelement <2 x double> %6, i64 1
  %8 = fneg double %7
  %i.bc = load <2 x double>, ptr %5, align 8      ; 4 uses
  %i.bd = shufflevector <2 x double> %6, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.bg = fmul <2 x double> %9, %i.bf             ; 2 uses
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.bq = tail call noundef { double, double } @__muldc3(double noundef %10, double noundef %8, double noundef %i.bo, double noundef %i.bp) #32 ; 2 uses
...
bb.c:                                             ; preds = %.preheader, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit
  ...
  %4 = load ptr, ptr %i.ad, align 8, !tbaa !63
  %5 = getelementptr inbounds nuw [16 x i8], ptr %4, i64 %.061
  %6 = load <2 x double>, ptr %i.ah, align 8, !tbaa !71 ; 4 uses
  %7 = extractelement <2 x double> %6, i64 1
  %8 = fneg double %7
  %i.ai = load <2 x double>, ptr %5, align 8      ; 4 uses
  %i.aj = shufflevector <2 x double> %6, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ak = fmul <2 x double> %i.aj, %i.ai          ; 2 uses
  %9 = shufflevector <2 x double> %6, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.al = shufflevector <2 x double> %i.ai, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %i.am = fmul <2 x double> %9, %i.al             ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %10 = extractelement <2 x double> %6, i64 0
  %i.aw = tail call noundef { double, double } @__muldc3(double noundef %10, double noundef %8, double noundef %i.au, double noundef %i.av) #32 ; 2 uses
