...
bb.j:                                             ; preds = %.preheader, %bb.m
  %.084 = phi i64 [ 0, %.preheader ], [ %i.ck, %bb.m ] ; 3 uses
  %i.ba = load ptr, ptr %i.an, align 8, !tbaa !90
  %i.bb = getelementptr inbounds nuw [16 x i8], ptr %i.ba, i64 %.04389 ; 2 uses
  %i.bc = getelementptr inbounds nuw i8, ptr %i.bb, i64 8
  %i.bd = load ptr, ptr %i.ax, align 8, !tbaa !90
  %i.be = getelementptr inbounds nuw [16 x i8], ptr %i.bd, i64 %.084
  %i.bf = load double, ptr %i.bc, align 8, !tbaa !57 ; 2 uses
  %i.bg = load double, ptr %i.bb, align 8, !tbaa !57 ; 2 uses
  %i.bh = fneg double %i.bf
  %i.bi = load <2 x double>, ptr %i.be, align 8   ; 4 uses
  %i.bj = insertelement <2 x double> poison, double %i.bg, i64 0
  ...
  %i.bo = shufflevector <2 x double> %i.bi, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %i.bp = fmul <2 x double> %i.bn, %i.bo          ; 2 uses
  %i.bq = fadd <2 x double> %i.bl, %i.bp          ; 2 uses
  %i.br = fsub <2 x double> %i.bl, %i.bp          ; 2 uses
  %i.bs = shufflevector <2 x double> %i.bq, <2 x double> %i.br, <2 x i32> <i32 0, i32 3> ; 2 uses
  %i.bt = extractelement <2 x double> %i.bq, i64 0
  %i.bu = fcmp uno double %i.bt, 0.000000e+00
  br i1 %i.bu, label %bb.k, label %bb.m, !prof !77

bb.k:                                             ; preds = %bb.j
  %i.bv = extractelement <2 x double> %i.br, i64 1
  %i.bw = fcmp uno double %i.bv, 0.000000e+00
  br i1 %i.bw, label %bb.l, label %bb.m, !prof !77

bb.l:                                             ; preds = %bb.k
  %i.bx = extractelement <2 x double> %i.bi, i64 0
  %i.by = extractelement <2 x double> %i.bi, i64 1
  %i.bz = tail call noundef { double, double } @__muldc3(double noundef %i.bg, double noundef %i.bh, double noundef %i.bx, double noundef %i.by) #32 ; 2 uses
...
bb.m:                                             ; preds = %bb.l, %bb.k, %bb.j
  %i.ce = phi <2 x double> [ %i.bs, %bb.j ], [ %i.bs, %bb.k ], [ %i.cd, %bb.l ]
  %i.cf = load ptr, ptr %gep88, align 8, !tbaa !50
  %i.cg = getelementptr [16 x i8], ptr %i.cf, i64 %i.av
  %i.ch = getelementptr [16 x i8], ptr %i.cg, i64 %.084 ; 2 uses
  %i.ci = load <2 x double>, ptr %i.ch, align 8
  %i.cj = fadd <2 x double> %i.ce, %i.ci
  store <2 x double> %i.cj, ptr %i.ch, align 8
  %i.ck = add nuw nsw i64 %.084, 1                ; 2 uses
  %exitcond100.not = icmp eq i64 %i.ck, %smax
...
end_hunk_0
begin_hunk_1_@_ZSt8_DestroyIPSt6vectorIS0_ISt7complexIdESaIS2_EESaIS4_EEEvT_S8_:bb.a
...
bb.c:                                             ; preds = %.preheader, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit
  %.061 = phi i64 [ 0, %.preheader ], [ %i.bq, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit ] ; 3 uses
  ...
  %i.ak = getelementptr inbounds nuw [16 x i8], ptr %i.aj, i64 %.061
  %i.al = load double, ptr %i.ai, align 8, !tbaa !57 ; 2 uses
  %i.am = load double, ptr %i.ah, align 8, !tbaa !57 ; 2 uses
  %i.an = fneg double %i.al
  %i.ao = load <2 x double>, ptr %i.ak, align 8   ; 4 uses
  ...
  %i.ar = fmul <2 x double> %i.aq, %i.ao          ; 2 uses
  ...
  %i.au = shufflevector <2 x double> %i.ao, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %i.av = fmul <2 x double> %i.at, %i.au          ; 2 uses
  %i.aw = fadd <2 x double> %i.ar, %i.av          ; 2 uses
  %i.ax = fsub <2 x double> %i.ar, %i.av          ; 2 uses
  ...
  br i1 %i.ba, label %bb.d, label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit, !prof !77

bb.d:                                             ; preds = %bb.c
  %i.bb = extractelement <2 x double> %i.ax, i64 1
  %i.bc = fcmp uno double %i.bb, 0.000000e+00
  br i1 %i.bc, label %bb.e, label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit, !prof !77

bb.e:                                             ; preds = %bb.d
  %i.bd = extractelement <2 x double> %i.ao, i64 0
  %i.be = extractelement <2 x double> %i.ao, i64 1
  %i.bf = tail call noundef { double, double } @__muldc3(double noundef %i.am, double noundef %i.an, double noundef %i.bd, double noundef %i.be) #32 ; 2 uses
...
_ZStmlIdESt7complexIT_ERKS2_S4_.exit:             ; preds = %bb.c, %bb.d, %bb.e
  %i.bk = phi <2 x double> [ %i.ay, %bb.c ], [ %i.ay, %bb.d ], [ %i.bj, %bb.e ]
  %i.bl = load ptr, ptr %gep65, align 8, !tbaa !50
  %i.bm = getelementptr [16 x i8], ptr %i.bl, i64 %i.ab
  %i.bn = getelementptr [16 x i8], ptr %i.bm, i64 %.061 ; 2 uses
  %i.bo = load <2 x double>, ptr %i.bn, align 8
  %i.bp = fadd <2 x double> %i.bk, %i.bo
  store <2 x double> %i.bp, ptr %i.bn, align 8
  %i.bq = add nuw nsw i64 %.061, 1                ; 2 uses
  %exitcond73.not = icmp eq i64 %i.bq, %smax
