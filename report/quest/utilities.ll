...
.preheader79.new:                                 ; preds = %.preheader79, %.preheader79.new
  ...
  %i.s = load ptr, ptr %i.e, align 8, !tbaa !50
...
bb.c:                                             ; preds = %.lr.ph, %_ZNSt6vectorIS_ISt7complexIdESaIS1_EESaIS3_EED2Ev.exit
  ...
  %i.w = load ptr, ptr %1, align 8, !tbaa !83
  ...
  %i.z = load ptr, ptr %i.y, align 8, !tbaa !88   ; 3 uses
  %i.aa = load ptr, ptr %i.x, align 8, !tbaa !87  ; 3 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  br i1 %i.af, label %.noexc.i.i, label %_ZNSt15__new_allocatorISt6vectorISt7complexIdESaIS2_EEE8allocateEmPKv.exit.i.i.i.i, !prof !38
...
_ZNSt15__new_allocatorISt6vectorISt7complexIdESaIS2_EEE8allocateEmPKv.exit.i.i.i.i: ; preds = %bb.d
  ...
  %.pre = load ptr, ptr %i.x, align 8, !tbaa !93
  %.pre106 = load ptr, ptr %i.y, align 8, !tbaa !93
  br label %bb.e
...
.lr.ph.i.i.i:                                     ; preds = %_ZNSt6vectorIS_ISt7complexIdESaIS1_EESaIS3_EEC2ERKS5_.exit._crit_edge, %_ZSt8_DestroyISt6vectorISt7complexIdESaIS2_EEEvPT_.exit.i.i.i
  ...
  %i.ao = load ptr, ptr %.05.i.i.i, align 8, !tbaa !90 ; 3 uses
...
._crit_edge90:                                    ; preds = %._crit_edge86
  ...
  br i1 %exitcond103.not, label %_ZNSt6vectorIS_ISt7complexIdESaIS1_EESaIS3_EEC2ERKS5_.exit._crit_edge, label %.preheader77, !llvm.loop !217
...
._crit_edge86:                                    ; preds = %._crit_edge
  ...
  br i1 %exitcond102.not, label %._crit_edge90, label %.preheader76, !llvm.loop !218

._crit_edge:                                      ; preds = %bb.m
  %i.az = add nuw nsw i64 %.04285, 1              ; 2 uses
  %exitcond101.not = icmp eq i64 %i.az, %smax
  br i1 %exitcond101.not, label %._crit_edge86, label %.preheader, !llvm.loop !219

bb.j:                                             ; preds = %.preheader, %bb.m
  %.084 = phi i64 [ 0, %.preheader ], [ %i.ce, %bb.m ] ; 3 uses
  %i.ba = load ptr, ptr %i.an, align 8, !tbaa !90
  %i.bb = getelementptr inbounds nuw [16 x i8], ptr %i.ba, i64 %.04389
  %i.bc = load ptr, ptr %i.ax, align 8, !tbaa !90
  %i.bd = getelementptr inbounds nuw [16 x i8], ptr %i.bc, i64 %.084
  %4 = load <2 x double>, ptr %i.bb, align 8, !tbaa !57 ; 4 uses
  %5 = extractelement <2 x double> %4, i64 1
  %i.be = fneg double %5
  %i.bf = load <2 x double>, ptr %i.bd, align 8   ; 4 uses
  %i.bg = shufflevector <2 x double> %4, <2 x double> poison, <2 x i32> zeroinitializer
  %i.bh = fmul <2 x double> %i.bg, %i.bf          ; 2 uses
  %6 = shufflevector <2 x double> %4, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.bi = shufflevector <2 x double> %i.bf, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %i.bj = fmul <2 x double> %6, %i.bi             ; 2 uses
  %i.bk = fadd <2 x double> %i.bh, %i.bj          ; 2 uses
  %i.bl = fsub <2 x double> %i.bh, %i.bj          ; 2 uses
  %i.bm = shufflevector <2 x double> %i.bk, <2 x double> %i.bl, <2 x i32> <i32 0, i32 3> ; 2 uses
  %i.bn = extractelement <2 x double> %i.bk, i64 0
  %i.bo = fcmp uno double %i.bn, 0.000000e+00
  br i1 %i.bo, label %bb.k, label %bb.m, !prof !77

bb.k:                                             ; preds = %bb.j
  %i.bp = extractelement <2 x double> %i.bl, i64 1
  %i.bq = fcmp uno double %i.bp, 0.000000e+00
  br i1 %i.bq, label %bb.l, label %bb.m, !prof !77

bb.l:                                             ; preds = %bb.k
  %i.br = extractelement <2 x double> %i.bf, i64 0
  %i.bs = extractelement <2 x double> %i.bf, i64 1
  %7 = extractelement <2 x double> %4, i64 0
  %i.bt = tail call noundef { double, double } @__muldc3(double noundef %7, double noundef %i.be, double noundef %i.br, double noundef %i.bs) #32 ; 2 uses
...
bb.m:                                             ; preds = %bb.l, %bb.k, %bb.j
  %i.by = phi <2 x double> [ %i.bm, %bb.j ], [ %i.bm, %bb.k ], [ %i.bx, %bb.l ]
  %i.bz = load ptr, ptr %gep88, align 8, !tbaa !50
  %i.ca = getelementptr [16 x i8], ptr %i.bz, i64 %i.av
  %i.cb = getelementptr [16 x i8], ptr %i.ca, i64 %.084 ; 2 uses
  %i.cc = load <2 x double>, ptr %i.cb, align 8
  %i.cd = fadd <2 x double> %i.by, %i.cc
  store <2 x double> %i.cd, ptr %i.cb, align 8
  %i.ce = add nuw nsw i64 %.084, 1                ; 2 uses
  %exitcond100.not = icmp eq i64 %i.ce, %smax
...
_ZSt8_DestroyISt6vectorISt7complexIdESaIS2_EEEvPT_.exit.i.i.i.i.i.i: ; preds = %bb.b, %.lr.ph.i.i.i.i.i.i
  ...
  br i1 %.not.i.i.i.i.i.i, label %_ZSt8_DestroyIPSt6vectorISt7complexIdESaIS2_EES4_EvT_S6_RSaIT0_E.exitthread-pre-split.i.i.i.i, label %.lr.ph.i.i.i.i.i.i, !llvm.loop !8
...
_ZSt8_DestroyIPSt6vectorISt7complexIdESaIS2_EES4_EvT_S6_RSaIT0_E.exitthread-pre-split.i.i.i.i: ; preds = %_ZSt8_DestroyISt6vectorISt7complexIdESaIS2_EEEvPT_.exit.i.i.i.i.i.i
  %.pr.i.i.i.i = load ptr, ptr %.05.i.i, align 8, !tbaa !87
...
_ZSt8_DestroyISt6vectorIS0_ISt7complexIdESaIS2_EESaIS4_EEEvPT_.exit.i.i: ; preds = %bb.c, %_ZSt8_DestroyIPSt6vectorISt7complexIdESaIS2_EES4_EvT_S6_RSaIT0_E.exit.i.i.i.i
  ...
  br i1 %.not.i.i, label %_ZSt8_DestroyIPSt6vectorIS0_ISt7complexIdESaIS2_EESaIS4_EES6_EvT_S8_RSaIT0_E.exitthread-pre-split, label %.lr.ph.i.i, !llvm.loop !9
...
.lr.ph.i.i:                                       ; preds = %bb.a, %_ZSt8_DestroyISt6vectorISt7complexIdESaIS2_EEEvPT_.exit.i.i
  ...
  %i.d = load ptr, ptr %.05.i.i, align 8, !tbaa !90 ; 3 uses
...
_ZSt8_DestroyISt6vectorISt7complexIdESaIS2_EEEvPT_.exit.i.i: ; preds = %bb.b, %.lr.ph.i.i
  ...
  br i1 %.not.i.i, label %_ZSt8_DestroyIPSt6vectorISt7complexIdESaIS2_EES4_EvT_S6_RSaIT0_E.exitthread-pre-split, label %.lr.ph.i.i, !llvm.loop !8
...
.lr.ph:                                           ; preds = %bb.a, %.loopexit
  ...
  %i.c = load ptr, ptr %.sroa.09.017, align 8, !tbaa !90 ; 2 uses
...
bb.b:                                             ; preds = %.lr.ph
  ...
  br i1 %i.g, label %.noexc.i.i.i, label %_ZNSt15__new_allocatorISt7complexIdEE8allocateEmPKv.exit.i.i.i.i.i, !prof !38
...
.noexc8:                                          ; preds = %_ZNSt15__new_allocatorISt7complexIdEE8allocateEmPKv.exit.i.i.i.i.i, %.lr.ph
  ...
  store ptr %i.i, ptr %.018, align 8, !tbaa !90
  ...
  %i.m = load ptr, ptr %.sroa.09.017, align 8, !tbaa !50 ; 2 uses
  %i.n = load ptr, ptr %i.a, align 8, !tbaa !50   ; 2 uses
...
.preheader58.new:                                 ; preds = %.preheader58, %.preheader58.new
  ...
  %i.l = load ptr, ptr %i.e, align 8, !tbaa !50
...
._crit_edge67:                                    ; preds = %._crit_edge63
  ...
  br i1 %exitcond76.not, label %._crit_edge69, label %.preheader56, !llvm.loop !227
...
._crit_edge63:                                    ; preds = %._crit_edge
  ...
  br i1 %exitcond75.not, label %._crit_edge67, label %.preheader55, !llvm.loop !228
...
._crit_edge:                                      ; preds = %_ZStmlIdESt7complexIT_ERKS2_S4_.exit
  ...
  br i1 %exitcond74.not, label %._crit_edge63, label %.preheader, !llvm.loop !229

bb.c:                                             ; preds = %.preheader, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit
  %.061 = phi i64 [ 0, %.preheader ], [ %i.bk, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit ] ; 3 uses
  %i.ag = load ptr, ptr %i.aa, align 8, !tbaa !50
  %i.ah = getelementptr inbounds nuw [16 x i8], ptr %i.ag, i64 %.04466
  %i.ai = load ptr, ptr %i.ad, align 8, !tbaa !50
  %i.aj = getelementptr inbounds nuw [16 x i8], ptr %i.ai, i64 %.061
  %4 = load <2 x double>, ptr %i.ah, align 8, !tbaa !57 ; 4 uses
  %5 = extractelement <2 x double> %4, i64 1
  %i.ak = fneg double %5
  %i.al = load <2 x double>, ptr %i.aj, align 8   ; 4 uses
  %i.am = shufflevector <2 x double> %4, <2 x double> poison, <2 x i32> zeroinitializer
  %i.an = fmul <2 x double> %i.am, %i.al          ; 2 uses
  %6 = shufflevector <2 x double> %4, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.ao = shufflevector <2 x double> %i.al, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %i.ap = fmul <2 x double> %6, %i.ao             ; 2 uses
  %i.aq = fadd <2 x double> %i.an, %i.ap          ; 2 uses
  %i.ar = fsub <2 x double> %i.an, %i.ap          ; 2 uses
  %i.as = shufflevector <2 x double> %i.aq, <2 x double> %i.ar, <2 x i32> <i32 0, i32 3> ; 2 uses
  %i.at = extractelement <2 x double> %i.aq, i64 0
  %i.au = fcmp uno double %i.at, 0.000000e+00
  br i1 %i.au, label %bb.d, label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit, !prof !77

bb.d:                                             ; preds = %bb.c
  %i.av = extractelement <2 x double> %i.ar, i64 1
  %i.aw = fcmp uno double %i.av, 0.000000e+00
  br i1 %i.aw, label %bb.e, label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit, !prof !77

bb.e:                                             ; preds = %bb.d
  %i.ax = extractelement <2 x double> %i.al, i64 0
  %i.ay = extractelement <2 x double> %i.al, i64 1
  %7 = extractelement <2 x double> %4, i64 0
  %i.az = tail call noundef { double, double } @__muldc3(double noundef %7, double noundef %i.ak, double noundef %i.ax, double noundef %i.ay) #32 ; 2 uses
...
_ZStmlIdESt7complexIT_ERKS2_S4_.exit:             ; preds = %bb.c, %bb.d, %bb.e
  %i.be = phi <2 x double> [ %i.as, %bb.c ], [ %i.as, %bb.d ], [ %i.bd, %bb.e ]
  %i.bf = load ptr, ptr %gep65, align 8, !tbaa !50
  %i.bg = getelementptr [16 x i8], ptr %i.bf, i64 %i.ab
  %i.bh = getelementptr [16 x i8], ptr %i.bg, i64 %.061 ; 2 uses
  %i.bi = load <2 x double>, ptr %i.bh, align 8
  %i.bj = fadd <2 x double> %i.be, %i.bi
  store <2 x double> %i.bj, ptr %i.bh, align 8
  %i.bk = add nuw nsw i64 %.061, 1                ; 2 uses
  %exitcond73.not = icmp eq i64 %i.bk, %smax
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.o = add i64 %i.n, -1
  store i64 %i.o, ptr getelementptr inbounds nuw (i8, ptr @_Z21globalStructFieldPtrsB5cxx11, i64 16), align 8, !tbaa !102
...
._crit_edge.i:                                    ; preds = %_ZNSt7__cxx114listIPiSaIS1_EE6spliceESt20_List_const_iteratorIS1_ERS3_S5_.exit.i
  %.pre.i = load ptr, ptr %1, align 8, !tbaa !97  ; 2 uses
...
.lr.ph.i.i.i:                                     ; preds = %._crit_edge.i, %.lr.ph.i.i.i
  ...
  %i.p = load ptr, ptr %.09.i.i.i, align 8, !tbaa !97 ; 2 uses
  call void @_ZdlPvm(ptr noundef nonnull %.09.i.i.i, i64 noundef 24) #31
  %.not.i.i.i = icmp eq ptr %i.p, %1
  br i1 %.not.i.i.i, label %_ZNSt7__cxx114listIPiSaIS1_EE6removeERKS1_.exit, label %.lr.ph.i.i.i, !llvm.loop !11
...
bb.a:
  %.sroa.01.04 = load ptr, ptr @_Z21globalStructFieldPtrsB5cxx11, align 8, !tbaa !97 ; 2 uses
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  %.sroa.01.0 = load ptr, ptr %.sroa.01.06, align 8, !tbaa !97 ; 2 uses
