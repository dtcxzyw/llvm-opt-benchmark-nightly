...
bb.j:                                             ; preds = %.preheader, %bb.m
  ...
  %i.bf = load double, ptr %i.bb, align 8, !tbaa !57 ; 2 uses
  %i.bg = load double, ptr %i.bc, align 8, !tbaa !57 ; 2 uses
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.bz = tail call noundef { double, double } @__muldc3(double noundef %i.bf, double noundef %i.bh, double noundef %i.bx, double noundef %i.by) #32 ; 2 uses
...
bb.c:                                             ; preds = %.preheader, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit
  ...
  %i.al = load double, ptr %i.ah, align 8, !tbaa !57 ; 2 uses
  %i.am = load double, ptr %i.ai, align 8, !tbaa !57 ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.bf = tail call noundef { double, double } @__muldc3(double noundef %i.al, double noundef %i.an, double noundef %i.bd, double noundef %i.be) #32 ; 2 uses
