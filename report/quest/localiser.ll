...
bb.e:                                             ; preds = %bb.f
  ...
  br i1 %i.bp, label %.loopexit217, label %.lr.ph.i.i.i.i, !llvm.loop !209

.lr.ph.i.i.i.i:                                   ; preds = %bb.d, %bb.e
  %.020.i.i.i.i = phi ptr [ %i.bq, %bb.e ], [ %i.bl, %bb.d ]
  %i.bq = load ptr, ptr %.020.i.i.i.i, align 8, !tbaa !43 ; 4 uses
  %.not18.i.i.i.i = icmp eq ptr %i.bq, null
  br i1 %.not18.i.i.i.i, label %.loopexit.i.i, label %bb.f

bb.f:                                             ; preds = %.lr.ph.i.i.i.i
  %i.br = getelementptr inbounds nuw i8, ptr %i.bq, i64 8
  %i.bs = load i64, ptr %i.br, align 8, !tbaa !46 ; 2 uses
  %i.bt = urem i64 %i.bs, %i.bg
  %.not19.i.i.i.i = icmp eq i64 %i.bt, %i.bh
  br i1 %.not19.i.i.i.i, label %bb.e, label %..loopexit_crit_edge21.i.i.i.i, !llvm.loop !209

..loopexit_crit_edge21.i.i.i.i:                   ; preds = %bb.f
  br label %.loopexit.i.i, !llvm.loop !209
...
.noexc:                                           ; preds = %.loopexit.i.i
  store ptr null, ptr %i.bu, align 8, !tbaa !43
  %i.bv = getelementptr inbounds nuw i8, ptr %i.bu, i64 8
  store i64 %i.bf, ptr %i.bv, align 8, !tbaa !221
  ...
  store ptr %i.bu, ptr %i.o, align 8, !tbaa !109
...
.loopexit217:                                     ; preds = %bb.e, %_ZNSt10_HashtableIySt4pairIKySt6vectorISt5tupleIJ8PauliStrSt7complexIdEEESaIS7_EEESaISA_ENSt8__detail10_Select1stESt8equal_toIyESt4hashIyENSC_18_Mod_range_hashingENSC_20_Default_ranged_hashENSC_20_Prime_rehash_policyENSC_17_Hashtable_traitsILb0ELb0ELb1EEEE12_Scoped_nodeD2Ev.exit.i.i, %bb.d
  ...
  %i.ca = load ptr, ptr %i.bz, align 8, !tbaa !222 ; 5 uses
  %i.cb = getelementptr inbounds nuw i8, ptr %.pn.i.i, i64 32 ; 3 uses
  %i.cc = load ptr, ptr %i.cb, align 8, !tbaa !110
...
.lr.ph.i.i.i.i.i:                                 ; preds = %.noexc67, %.lr.ph.i.i.i.i.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.012.i.i.i.i.i, ptr noundef nonnull align 8 dereferenceable(32) %.0911.i.i.i.i.i, i64 16, i1 false), !tbaa.struct !82, !alias.scope !223
  %i.cs = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i.i, i64 16
  %i.ct = getelementptr inbounds nuw i8, ptr %.0911.i.i.i.i.i, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.cs, ptr noundef nonnull align 8 dereferenceable(16) %i.ct, i64 16, i1 false), !tbaa.struct !215, !alias.scope !223
  ...
  br i1 %.not.i.i.i.i.i, label %_ZNSt6vectorISt5tupleIJ8PauliStrSt7complexIdEEESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit22.i.i, label %.lr.ph.i.i.i.i.i, !llvm.loop !213
...
bb.k:                                             ; preds = %_ZNSt6vectorISt5tupleIJ8PauliStrSt7complexIdEEESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit22.i.i
  %i.cx = load ptr, ptr %i.cb, align 8, !tbaa !110
...
_ZNSt6vectorISt5tupleIJ8PauliStrSt7complexIdEEESaIS4_EE17_M_realloc_insertIJRKS4_EEEvN9__gnu_cxx17__normal_iteratorIPS4_S6_EEDpOT_.exit.i: ; preds = %bb.k, %_ZNSt6vectorISt5tupleIJ8PauliStrSt7complexIdEEESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit22.i.i
  store ptr %i.cq, ptr %.1.i.i, align 8, !tbaa !111
  store ptr %i.cw, ptr %i.bz, align 8, !tbaa !222
  %i.da = getelementptr inbounds nuw [32 x i8], ptr %i.cq, i64 %i.co
  store ptr %i.da, ptr %i.cb, align 8, !tbaa !110
  br label %_ZNSt6vectorISt5tupleIJ8PauliStrSt7complexIdEEESaIS4_EE9push_backERKS4_.exit
...
_ZNSt6vectorISt5tupleIJ8PauliStrSt7complexIdEEESaIS4_EE9push_backERKS4_.exit: ; preds = %_ZNSt6vectorISt5tupleIJ8PauliStrSt7complexIdEEESaIS4_EE17_M_realloc_insertIJRKS4_EEEvN9__gnu_cxx17__normal_iteratorIPS4_S6_EEDpOT_.exit.i, %bb.h
  ...
  br i1 %exitcond.not, label %._crit_edge, label %bb.b, !llvm.loop !214
...
._crit_edge311:                                   ; preds = %._crit_edge306, %bb.a, %._crit_edge
  ...
  %i.dd = load i32, ptr %i.dc, align 8, !tbaa !28
...
bb.p:                                             ; preds = %bb.n, %bb.m
  ...
  %i.dm = load ptr, ptr %i.dg, align 8, !tbaa !224 ; 2 uses
  %i.dn = getelementptr inbounds nuw i8, ptr %.sroa.0175.0308, i64 24
  %i.do = load ptr, ptr %i.dn, align 8, !tbaa !224 ; 2 uses
...
._crit_edge306:                                   ; preds = %_ZNSt5arrayISt6vectorIiSaIiEELm3EED2Ev.exit, %bb.p
  %i.dp = phi <2 x double> [ %i.de, %bb.p ], [ %i.kv, %_ZNSt5arrayISt6vectorIiSaIiEELm3EED2Ev.exit ]
  %i.dq = load ptr, ptr %.sroa.0175.0308, align 8, !tbaa !43 ; 2 uses
...
.lr.ph305:                                        ; preds = %bb.p, %_ZNSt5arrayISt6vectorIiSaIiEELm3EED2Ev.exit
  ...
  %.sroa.0.0.copyload = load i64, ptr %i.ds, align 8, !tbaa !46
...
bb.q:                                             ; preds = %.lr.ph305
  ...
  %i.dt = load ptr, ptr %i.s, align 8, !tbaa !17  ; 2 uses
  %i.du = load ptr, ptr %5, align 8, !tbaa !18    ; 3 uses
...
bb.r:                                             ; preds = %bb.q
  ...
  br i1 %i.dy, label %.noexc.i.i, label %_ZNSt15__new_allocatorIiE8allocateEmPKv.exit.i.i.i.i, !prof !29
...
_ZNSt15__new_allocatorIiE8allocateEmPKv.exit.i.i.i.i..noexc70_crit_edge: ; preds = %_ZNSt15__new_allocatorIiE8allocateEmPKv.exit.i.i.i.i
  %.pre315 = load ptr, ptr %5, align 8, !tbaa !15 ; 2 uses
  %.pre316 = load ptr, ptr %i.s, align 8, !tbaa !15
...
.noexc70:                                         ; preds = %_ZNSt15__new_allocatorIiE8allocateEmPKv.exit.i.i.i.i..noexc70_crit_edge, %bb.q
  ...
  store ptr %i.eb, ptr %7, align 8, !tbaa !18
  store ptr %i.eb, ptr %i.t, align 8, !tbaa !17
  %i.ec = getelementptr inbounds nuw i8, ptr %i.eb, i64 %i.dx
  store ptr %i.ec, ptr %i.u, align 8, !tbaa !20
  %i.ed = sub i64 %.pre-phi, %.pre-phi333         ; 4 uses
  %i.ee = icmp sgt i64 %i.ed, 4
  br i1 %i.ee, label %bb.s, label %bb.t, !prof !21
...
bb.u:                                             ; preds = %bb.t
  %i.eg = load i32, ptr %i.ea, align 4, !tbaa !19
  store i32 %i.eg, ptr %i.eb, align 4, !tbaa !19
  br label %bb.v

bb.v:                                             ; preds = %bb.u, %bb.t, %bb.s
  %i.eh = getelementptr inbounds i8, ptr %i.eb, i64 %i.ed
  store ptr %i.eh, ptr %i.t, align 8, !tbaa !17
...
_ZNSt6vectorIiSaIiEED2Ev.exit:                    ; preds = %bb.w, %bb.x
  ...
  %i.en = load ptr, ptr %i.w, align 8, !tbaa !17  ; 2 uses
  %i.eo = load ptr, ptr %i.q, align 8, !tbaa !18  ; 3 uses
...
bb.y:                                             ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit
  ...
  br i1 %i.es, label %.noexc.i.i74, label %_ZNSt15__new_allocatorIiE8allocateEmPKv.exit.i.i.i.i73, !prof !29
...
_ZNSt15__new_allocatorIiE8allocateEmPKv.exit.i.i.i.i73..noexc76_crit_edge: ; preds = %_ZNSt15__new_allocatorIiE8allocateEmPKv.exit.i.i.i.i73
  %.pre317 = load ptr, ptr %i.q, align 8, !tbaa !15 ; 2 uses
  %.pre318 = load ptr, ptr %i.w, align 8, !tbaa !15
...
.noexc76:                                         ; preds = %_ZNSt15__new_allocatorIiE8allocateEmPKv.exit.i.i.i.i73..noexc76_crit_edge, %_ZNSt6vectorIiSaIiEED2Ev.exit
  ...
  store ptr %i.ev, ptr %9, align 8, !tbaa !18
  store ptr %i.ev, ptr %i.x, align 8, !tbaa !17
  %i.ew = getelementptr inbounds nuw i8, ptr %i.ev, i64 %i.er
  store ptr %i.ew, ptr %i.y, align 8, !tbaa !20
  %i.ex = sub i64 %.pre-phi335, %.pre-phi337      ; 4 uses
  %i.ey = icmp sgt i64 %i.ex, 4
  br i1 %i.ey, label %bb.z, label %bb.aa, !prof !21
...
bb.ab:                                            ; preds = %bb.aa
  %i.fa = load i32, ptr %i.eu, align 4, !tbaa !19
  store i32 %i.fa, ptr %i.ev, align 4, !tbaa !19
  br label %bb.ac

bb.ac:                                            ; preds = %bb.ab, %bb.aa, %bb.z
  %i.fb = getelementptr inbounds i8, ptr %i.ev, i64 %i.ex
  store ptr %i.fb, ptr %i.x, align 8, !tbaa !17
...
_ZNSt6vectorIiSaIiEED2Ev.exit79:                  ; preds = %bb.ad, %bb.ae
  ...
  %i.fh = load ptr, ptr %i.aa, align 8, !tbaa !17 ; 2 uses
  %i.fi = load ptr, ptr %i.r, align 8, !tbaa !18  ; 3 uses
...
bb.af:                                            ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit79
  ...
  br i1 %i.fm, label %.noexc.i.i82, label %_ZNSt15__new_allocatorIiE8allocateEmPKv.exit.i.i.i.i81, !prof !29
...
_ZNSt15__new_allocatorIiE8allocateEmPKv.exit.i.i.i.i81..noexc84_crit_edge: ; preds = %_ZNSt15__new_allocatorIiE8allocateEmPKv.exit.i.i.i.i81
  %.pre319 = load ptr, ptr %i.r, align 8, !tbaa !15 ; 2 uses
  %.pre320 = load ptr, ptr %i.aa, align 8, !tbaa !15
...
bb.by:                                            ; preds = %bb.bx
  %i.kx = load ptr, ptr %i.at, align 8, !tbaa !20
  %i.ky = ptrtoint ptr %i.kx to i64
  %i.kz = ptrtoint ptr %i.kw to i64
  %i.la = sub i64 %i.ky, %i.kz
  call void @_ZdlPvm(ptr noundef nonnull %i.kw, i64 noundef %i.la) #20
  br label %_ZNSt6vectorIiSaIiEED2Ev.exit.i

_ZNSt6vectorIiSaIiEED2Ev.exit.i:                  ; preds = %bb.by, %bb.bx
  %i.lb = load ptr, ptr %10, align 8, !tbaa !18   ; 3 uses
  %.not.i.i.i.1.i = icmp eq ptr %i.lb, null
...
bb.bz:                                            ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit.i
  %i.lc = load ptr, ptr %i.au, align 8, !tbaa !20
  %i.ld = ptrtoint ptr %i.lc to i64
  %i.le = ptrtoint ptr %i.lb to i64
  %i.lf = sub i64 %i.ld, %i.le
  call void @_ZdlPvm(ptr noundef nonnull %i.lb, i64 noundef %i.lf) #20
...
_ZNSt5arrayISt6vectorIiSaIiEELm2EED2Ev.exit:      ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit.i, %bb.bz
  ...
  %i.lg = load ptr, ptr %i.z, align 8, !tbaa !18  ; 3 uses
  %.not.i.i.i.i135 = icmp eq ptr %i.lg, null
...
bb.ca:                                            ; preds = %_ZNSt5arrayISt6vectorIiSaIiEELm2EED2Ev.exit
  %i.lh = load ptr, ptr %i.av, align 8, !tbaa !20
  %i.li = ptrtoint ptr %i.lh to i64
  %i.lj = ptrtoint ptr %i.lg to i64
  %i.lk = sub i64 %i.li, %i.lj
  call void @_ZdlPvm(ptr noundef nonnull %i.lg, i64 noundef %i.lk) #20
...
_ZNSt6vectorIiSaIiEED2Ev.exit.i136:               ; preds = %bb.ca, %_ZNSt5arrayISt6vectorIiSaIiEELm2EED2Ev.exit
  %i.ll = load ptr, ptr %8, align 8, !tbaa !18    ; 3 uses
  %.not.i.i.i.1.i137 = icmp eq ptr %i.ll, null
...
bb.cb:                                            ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit.i136
  %i.lm = load ptr, ptr %i.aw, align 8, !tbaa !20
  %i.ln = ptrtoint ptr %i.lm to i64
  %i.lo = ptrtoint ptr %i.ll to i64
  %i.lp = sub i64 %i.ln, %i.lo
  call void @_ZdlPvm(ptr noundef nonnull %i.ll, i64 noundef %i.lp) #20
...
_ZNSt5arrayISt6vectorIiSaIiEELm2EED2Ev.exit138:   ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit.i136, %bb.cb
  ...
  %i.lq = load ptr, ptr %i.v, align 8, !tbaa !18  ; 3 uses
  %.not.i.i.i.i139 = icmp eq ptr %i.lq, null
...
bb.cc:                                            ; preds = %_ZNSt5arrayISt6vectorIiSaIiEELm2EED2Ev.exit138
  %i.lr = load ptr, ptr %i.ax, align 8, !tbaa !20
  %i.ls = ptrtoint ptr %i.lr to i64
  %i.lt = ptrtoint ptr %i.lq to i64
  %i.lu = sub i64 %i.ls, %i.lt
  call void @_ZdlPvm(ptr noundef nonnull %i.lq, i64 noundef %i.lu) #20
...
_ZNSt6vectorIiSaIiEED2Ev.exit.i140:               ; preds = %bb.cc, %_ZNSt5arrayISt6vectorIiSaIiEELm2EED2Ev.exit138
  %i.lv = load ptr, ptr %6, align 8, !tbaa !18    ; 3 uses
  %.not.i.i.i.1.i141 = icmp eq ptr %i.lv, null
...
bb.cd:                                            ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit.i140
  %i.lw = load ptr, ptr %i.ay, align 8, !tbaa !20
  %i.lx = ptrtoint ptr %i.lw to i64
  %i.ly = ptrtoint ptr %i.lv to i64
  %i.lz = sub i64 %i.lx, %i.ly
  call void @_ZdlPvm(ptr noundef nonnull %i.lv, i64 noundef %i.lz) #20
...
_ZNSt5arrayISt6vectorIiSaIiEELm2EED2Ev.exit142:   ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit.i140, %bb.cd
  ...
  %i.ma = load ptr, ptr %i.r, align 8, !tbaa !18  ; 3 uses
  %.not.i.i.i.i143 = icmp eq ptr %i.ma, null
...
bb.ce:                                            ; preds = %_ZNSt5arrayISt6vectorIiSaIiEELm2EED2Ev.exit142
  %i.mb = load ptr, ptr %i.az, align 8, !tbaa !20
  %i.mc = ptrtoint ptr %i.mb to i64
  %i.md = ptrtoint ptr %i.ma to i64
  %i.me = sub i64 %i.mc, %i.md
  call void @_ZdlPvm(ptr noundef nonnull %i.ma, i64 noundef %i.me) #20
...
_ZNSt6vectorIiSaIiEED2Ev.exit.1.i:                ; preds = %bb.cf, %_ZNSt6vectorIiSaIiEED2Ev.exit.i144
  %i.mk = load ptr, ptr %5, align 8, !tbaa !18    ; 3 uses
  %.not.i.i.i.2.i = icmp eq ptr %i.mk, null
...
bb.cg:                                            ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit.1.i
  %i.ml = load ptr, ptr %i.bb, align 8, !tbaa !20
  %i.mm = ptrtoint ptr %i.ml to i64
  %i.mn = ptrtoint ptr %i.mk to i64
  %i.mo = sub i64 %i.mm, %i.mn
  call void @_ZdlPvm(ptr noundef nonnull %i.mk, i64 noundef %i.mo) #20
...
_ZNSt5arrayISt6vectorIiSaIiEELm3EED2Ev.exit:      ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit.1.i, %bb.cg
  ...
  %i.mp = getelementptr inbounds nuw i8, ptr %.sroa.0171.0303, i64 32 ; 2 uses
  %.not181 = icmp eq ptr %i.mp, %i.do
...
bb.ci:                                            ; preds = %bb.v
  %i.mr = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.ms = load ptr, ptr %7, align 8, !tbaa !18    ; 3 uses
  %.not.i.i.i146 = icmp eq ptr %i.ms, null
  br i1 %.not.i.i.i146, label %_ZNSt6vectorIiSaIiEED2Ev.exit147, label %bb.cj

bb.cj:                                            ; preds = %bb.ci
  %i.mt = load ptr, ptr %i.u, align 8, !tbaa !20
...
bb.ck:                                            ; preds = %bb.ac
  %i.mx = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.my = load ptr, ptr %9, align 8, !tbaa !18    ; 3 uses
  %.not.i.i.i148 = icmp eq ptr %i.my, null
  br i1 %.not.i.i.i148, label %_ZNSt6vectorIiSaIiEED2Ev.exit149, label %bb.cl

bb.cl:                                            ; preds = %bb.ck
  %i.mz = load ptr, ptr %i.y, align 8, !tbaa !20
  %i.na = ptrtoint ptr %i.mz to i64
  %i.nb = ptrtoint ptr %i.my to i64
  %i.nc = sub i64 %i.na, %i.nb
  call void @_ZdlPvm(ptr noundef nonnull %i.my, i64 noundef %i.nc) #20
  br label %_ZNSt6vectorIiSaIiEED2Ev.exit149
...
bb.cm:                                            ; preds = %bb.aj
  %i.nd = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.ne = load ptr, ptr %11, align 8, !tbaa !18   ; 3 uses
  %.not.i.i.i150 = icmp eq ptr %i.ne, null
  br i1 %.not.i.i.i150, label %_ZNSt6vectorIiSaIiEED2Ev.exit151, label %bb.cn

bb.cn:                                            ; preds = %bb.cm
  %i.nf = load ptr, ptr %i.ac, align 8, !tbaa !20
end_hunk_1
