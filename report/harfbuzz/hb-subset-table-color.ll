...
.lr.ph.i.i.i.i.i.i:                               ; preds = %.preheader.i.i.i.i.i.i, %bb.ac
  ...
  %i.ft = load i32, ptr %i.fs, align 4, !tbaa !312 ; 2 uses
  %i.fu = getelementptr inbounds nuw i8, ptr %.016.i.i.i.i.i.i, i64 4
  %i.fv = load i32, ptr %i.fu, align 4, !tbaa !312 ; 2 uses
...
.critedge.i.i.i.i.i.i:                            ; preds = %bb.ac, %.lr.ph.i.i.i.i.i.i, %.preheader.i.i.i.i.i.i
  ...
  br i1 %i.gd, label %.preheader.i.i.i.i.i.i, label %_ZN11hb_vector_tIN22hb_serialize_context_t8object_t6link_tELb0EE5qsortEv.exit.i, !llvm.loop !744
...
bb.ac:                                            ; preds = %.lr.ph.i.i.i.i.i.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %i.ge, ptr noundef nonnull align 4 dereferenceable(12) %.016.i.i.i.i.i.i, i64 12, i1 false), !tbaa.struct !319
  store <3 x i32> %.sroa.0.0.copyload, ptr %.016.i.i.i.i.i.i, align 4
  %i.gf = icmp ugt ptr %i.ge, %i.fp
  br i1 %i.gf, label %.lr.ph.i.i.i.i.i.i, label %.critedge.i.i.i.i.i.i, !llvm.loop !745

_ZN11hb_vector_tIN22hb_serialize_context_t8object_t6link_tELb0EE5qsortEv.exit.i: ; preds = %.critedge.i.i.i.i.i.i, %bb.ab, %bb.aa
  %i.gg = load ptr, ptr %i.do, align 8, !tbaa !261 ; 2 uses
  %i.gh = load i32, ptr %i.dq, align 4, !tbaa !260 ; 3 uses
...
.lr.ph.i177.epil:                                 ; preds = %.lr.ph.i177.epil, %.lr.ph.i177.epil.preheader
  ...
  store i32 %.022.i.epil, ptr %i.gn, align 4, !tbaa !312
...
bb.ad:                                            ; preds = %_ZNK5graph20LigatureSubstFormat123current_liga_set_boundsERNS_24gsubgpos_graph_context_tEjRKN22hb_serialize_context_t8object_tE.exit
  ...
  %i.hs = shl i32 %i.hr, 1
  %i.ht = add i32 %i.hs, 2
  %i.hu = call noundef i32 @_ZN5graph24gsubgpos_graph_context_t11create_nodeEj(ptr noundef nonnull align 8 dereferenceable(168) %1, i32 noundef %i.ht) #20 ; 8 uses
  %i.hv = icmp eq i32 %i.hu, -1
  br i1 %i.hv, label %.thread307, label %bb.ae

bb.ae:                                            ; preds = %bb.ad
  %i.hw = load ptr, ptr %i.l, align 8, !tbaa !440, !nonnull !211, !align !445 ; 2 uses
  %i.hx = getelementptr inbounds nuw i8, ptr %i.hw, i64 4
  %i.hy = load i32, ptr %i.hx, align 4, !tbaa !369
  ...
  %.0.i.i.i182 = select i1 %.not.i.i.i181, ptr %i.ic, ptr @_hb_NullPool, !prof !137
  %i.id = load ptr, ptr %.0.i.i.i182, align 8, !tbaa !311
  %i.ie = trunc i32 %i.hr to i16
  %i.if = call i16 @llvm.bswap.i16(i16 %i.ie)
  store i16 %i.if, ptr %i.id, align 1, !tbaa !289
  %i.ig = load ptr, ptr %i.l, align 8, !tbaa !440, !nonnull !211, !align !445
  %i.ih = shl i32 %i.hp, 1
  %i.ii = add i32 %i.ih, 2
  %i.ij = shl i32 %i.hq, 1
  %i.ik = add i32 %i.ij, 2
  ...
  %i.im = load ptr, ptr %i.l, align 8, !tbaa !440, !nonnull !211, !align !445 ; 3 uses
  %i.in = load i16, ptr %i.v, align 1, !tbaa !231
...
_ZN2OT7ArrayOfINS_8OffsetToINS_6Layout9GSUB_impl11LigatureSetINS2_10SmallTypesEEENS_7NumTypeILb1EtLj2EEEvLb1EEES8_EixEi.exit185: ; preds = %bb.af, %bb.ag
  ...
  %i.it = load i32, ptr %i.is, align 4, !tbaa !369
...
bb.ai:                                            ; preds = %_ZN2OT7ArrayOfINS_8OffsetToINS_6Layout9GSUB_impl11LigatureSetINS2_10SmallTypesEEENS_7NumTypeILb1EtLj2EEEvLb1EEES8_EixEi.exit185
  ...
  %i.iv = load ptr, ptr %i.iu, align 8, !tbaa !377
...
_ZN11hb_vector_tIN5graph7graph_t8vertex_tELb0EEixEi.exit.i: ; preds = %bb.ai, %bb.ah
  ...
  %i.iy = load i32, ptr %i.ix, align 4, !tbaa !260 ; 2 uses
...
bb.aj:                                            ; preds = %_ZN11hb_vector_tIN5graph7graph_t8vertex_tELb0EEixEi.exit.i
  ...
  br i1 %i.jc, label %bb.ak, label %bb.an, !prof !308

bb.ak:                                            ; preds = %bb.aj
  %i.jd = load i32, ptr %i.ix, align 4, !tbaa !260 ; 3 uses
...
bb.am:                                            ; preds = %bb.al
  ...
  %i.ji = load ptr, ptr %i.jh, align 8, !tbaa !261
...
bb.ao:                                            ; preds = %bb.am, %bb.al, %bb.ak
  store i32 %i.iz, ptr %i.ix, align 4, !tbaa !260
  %i.jm = getelementptr inbounds nuw i8, ptr %.0.i.i187, i64 24
  %i.jn = load ptr, ptr %i.jm, align 8, !tbaa !261
...
_ZN11hb_vector_tIN22hb_serialize_context_t8object_t6link_tELb0EE4pushEv.exit.i: ; preds = %bb.ao, %bb.an
  ...
  store i32 %i.hu, ptr %i.jt, align 4, !tbaa !309
  %i.ju = load ptr, ptr %.0.i.i187, align 8, !tbaa !448
  ...
  store i32 %i.jy, ptr %i.jz, align 4, !tbaa !312
  %i.ka = load i32, ptr %i.is, align 4, !tbaa !369
...
bb.aq:                                            ; preds = %_ZN11hb_vector_tIN22hb_serialize_context_t8object_t6link_tELb0EE4pushEv.exit.i
  ...
  %i.kc = load ptr, ptr %i.kb, align 8, !tbaa !377
...
_ZNK5graph20LigatureSubstFormat116compact_liga_setERNS_24gsubgpos_graph_context_tEPNS_11LigatureSetERN22hb_serialize_context_t8object_tE.exit: ; preds = %bb.ar, %._crit_edge.i, %_ZN2OT7ArrayOfINS_8OffsetToINS_6Layout9GSUB_impl11LigatureSetINS2_10SmallTypesEEENS_7NumTypeILb1EtLj2EEEvLb1EEES8_EixEi.exit
  ...
  %i.kf = load ptr, ptr %i.l, align 8, !tbaa !440, !nonnull !211, !align !445 ; 3 uses
  %i.kg = getelementptr inbounds nuw i8, ptr %i.kf, i64 4
  %i.kh = load i32, ptr %i.kg, align 4, !tbaa !369
...
_ZN11hb_vector_tIN5graph7graph_t8vertex_tELb0EEixEi.exit190.thread: ; preds = %_ZNK5graph20LigatureSubstFormat116compact_liga_setERNS_24gsubgpos_graph_context_tEPNS_11LigatureSetERN22hb_serialize_context_t8object_tE.exit
  ...
  %i.kj = load ptr, ptr %i.ki, align 8, !tbaa !377
...
_ZN11hb_vector_tIN5graph7graph_t8vertex_tELb0EEixEi.exit190: ; preds = %_ZNK5graph20LigatureSubstFormat116compact_liga_setERNS_24gsubgpos_graph_context_tEPNS_11LigatureSetERN22hb_serialize_context_t8object_tE.exit
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(216) @_hb_CrapPool, ptr noundef nonnull align 16 dereferenceable(216) @_hb_NullPool, i64 216, i1 false)
  %.pre346 = load ptr, ptr %i.l, align 8, !tbaa !440 ; 2 uses
  ...
  br i1 %i.km, label %bb.as, label %_ZN11hb_vector_tIN5graph7graph_t8vertex_tELb0EEixEi.exit.i192, !prof !132
...
bb.as:                                            ; preds = %_ZN11hb_vector_tIN5graph7graph_t8vertex_tELb0EEixEi.exit190.thread, %_ZN11hb_vector_tIN5graph7graph_t8vertex_tELb0EEixEi.exit190
  ...
  %i.kp = load ptr, ptr %i.ko, align 8, !tbaa !377
...
_ZN11hb_vector_tIN5graph7graph_t8vertex_tELb0EEixEi.exit.i192: ; preds = %_ZN11hb_vector_tIN5graph7graph_t8vertex_tELb0EEixEi.exit190, %bb.as
  ...
  %i.kt = load ptr, ptr %i.ks, align 8, !tbaa !261 ; 2 uses
  %i.ku = getelementptr inbounds nuw i8, ptr %.0.i.i193, i64 36 ; 2 uses
  %i.kv = load i32, ptr %i.ku, align 4, !tbaa !260 ; 2 uses
...
.lr.ph.i195:                                      ; preds = %_ZN11hb_vector_tIN5graph7graph_t8vertex_tELb0EEixEi.exit.i192, %_ZN11hb_vector_tIN5graph7graph_t8vertex_tELb0EEixEi.exit15.i
  ...
  %i.ky = load ptr, ptr %i.l, align 8, !tbaa !440, !nonnull !211, !align !445 ; 2 uses
  %i.kz = getelementptr inbounds nuw i8, ptr %.017.i, i64 8
  %i.la = load i32, ptr %i.kz, align 4, !tbaa !309 ; 2 uses
  %i.lb = getelementptr inbounds nuw i8, ptr %i.ky, i64 4
  %i.lc = load i32, ptr %i.lb, align 4, !tbaa !369
...
bb.x:                                             ; preds = %bb.w, %_ZN11hb_vector_tIN22hb_serialize_context_t8object_t6link_tELb0EE4pushEv.exit.i
  ...
  %.pre107 = load i32, ptr %i.n, align 4, !tbaa !3389
...
_ZN22hb_serialize_context_t8add_linkIN2OT8OffsetToINS1_13IndexSubtableENS1_7NumTypeILb1EjLj4EEEvLb1EEEEEvRT_jNS_8whence_tEj.exit: ; preds = %_ZN11hb_vector_tIjLb0EEixEi.exit, %bb.x
  ...
  br i1 %.not35.not, label %_ZN11hb_vector_tIN2OT19IndexSubtableRecordELb0EEixEi.exit, label %.thread80, !llvm.loop !3407
...
_ZN11hb_vector_tIjLb0EED2Ev.exit:                 ; preds = %.thread, %.critedge.i.i.i, %._crit_edge, %bb.y, %.thread80
  ...
  %i.dw = load i32, ptr %4, align 8, !tbaa !3408
  %i.dx = add i32 %i.dw, -1
...
bb.z:                                             ; preds = %_ZN11hb_vector_tIjLb0EED2Ev.exit
  ...
  store i32 0, ptr %i.dy, align 4, !tbaa !3389
  %i.dz = getelementptr inbounds nuw i8, ptr %4, i64 8
  %i.ea = load ptr, ptr %i.dz, align 8, !tbaa !3402
...
_ZN11hb_vector_tIN2OT19IndexSubtableRecordELb0EED2Ev.exit: ; preds = %_ZN11hb_vector_tIjLb0EED2Ev.exit, %bb.z
  ...
  %.pre108 = load i32, ptr %3, align 8, !tbaa !3385
  br label %bb.aa
...
bb.ab:                                            ; preds = %bb.aa
  ...
  store i32 0, ptr %i.ed, align 4, !tbaa !3388
  %i.ee = getelementptr inbounds nuw i8, ptr %3, i64 8
  %i.ef = load ptr, ptr %i.ee, align 8, !tbaa !3392
...
._crit_edge:                                      ; preds = %_ZNK16hb_subset_plan_t19old_gid_for_new_gidEjPj.exit, %bb.a
  ret void

bb.b:                                             ; preds = %.lr.ph, %_ZNK16hb_subset_plan_t19old_gid_for_new_gidEjPj.exit
  %.035 = phi i1 [ false, %.lr.ph ], [ %.4, %_ZNK16hb_subset_plan_t19old_gid_for_new_gidEjPj.exit ] ; 7 uses
  %.01733 = phi i32 [ 0, %.lr.ph ], [ %i.cc, %_ZNK16hb_subset_plan_t19old_gid_for_new_gidEjPj.exit ] ; 7 uses
...
_ZNK12hb_hashmap_tIjjLb1EE3getERKj.exit.i:        ; preds = %.lr.ph.i.i.i, %._crit_edge.i.i.i, %bb.c, %bb.b
  ...
  br i1 %.not, label %_ZNK16hb_subset_plan_t19old_gid_for_new_gidEjPj.exit, label %bb.e

bb.e:                                             ; preds = %_ZNK12hb_hashmap_tIjjLb1EE3getERKj.exit.i
  %i.ar = load i32, ptr %i.e, align 4, !tbaa !3380 ; 2 uses
  %.not27.i = icmp eq i32 %i.ar, 0
  br i1 %.not27.i, label %_ZNK16hb_subset_plan_t19old_gid_for_new_gidEjPj.exit, label %.lr.ph.preheader.i
...
bb.f:                                             ; preds = %.lr.ph.i
  ...
  br i1 %exitcond.not.i, label %_ZNK16hb_subset_plan_t19old_gid_for_new_gidEjPj.exit, label %.lr.ph.i, !llvm.loop !3409
...
_ZNK2OT18IndexSubtableArray10find_tableEjj.exit:  ; preds = %.lr.ph.i
  ...
  switch i16 %i.bi, label %_ZNK16hb_subset_plan_t19old_gid_for_new_gidEjPj.exit [
    i16 1, label %bb.g
    i16 3, label %bb.h
  ]
...
bb.g:                                             ; preds = %_ZNK2OT18IndexSubtableArray10find_tableEjj.exit
  ...
  br i1 %.not.i.i.i, label %_ZNK2OT19IndexSubtableRecord14get_image_dataEjPKvPjS3_S3_.exit, label %_ZNK16hb_subset_plan_t19old_gid_for_new_gidEjPj.exit, !prof !137
...
bb.h:                                             ; preds = %_ZNK2OT18IndexSubtableArray10find_tableEjj.exit
  ...
  br i1 %.not.i8.i.i, label %_ZNK2OT19IndexSubtableRecord14get_image_dataEjPKvPjS3_S3_.exit, label %_ZNK16hb_subset_plan_t19old_gid_for_new_gidEjPj.exit, !prof !137

_ZNK2OT19IndexSubtableRecord14get_image_dataEjPKvPjS3_S3_.exit: ; preds = %bb.h, %bb.g
  %i.bt = load i32, ptr %i.f, align 4, !tbaa !3388 ; 3 uses
  %i.bu = load i32, ptr %3, align 8, !tbaa !3385
...
..critedge_crit_edge.i:                           ; preds = %bb.i
  %.pre.i = load i32, ptr %i.f, align 4, !tbaa !3388
  br label %.critedge.i
...
.critedge.i:                                      ; preds = %..critedge_crit_edge.i, %_ZNK2OT19IndexSubtableRecord14get_image_dataEjPKvPjS3_S3_.exit
  ...
  %i.by = load ptr, ptr %i.g, align 8, !tbaa !3392
  %i.bz = add i32 %i.bx, 1
  store i32 %i.bz, ptr %i.f, align 4, !tbaa !3388
  %i.ca = zext i32 %i.bx to i64
  %i.cb = getelementptr inbounds nuw [16 x i8], ptr %i.by, i64 %i.ca ; 2 uses
  store i32 %.01733, ptr %i.cb, align 8, !tbaa !147
  %.sroa.420.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.cb, i64 8
  store ptr %i.as, ptr %.sroa.420.0..sroa_idx, align 8, !tbaa !3410
  br label %_ZN11hb_vector_tI9hb_pair_tIjPKN2OT19IndexSubtableRecordEELb0EE4pushIJS5_EEEPS5_DpOT_.exit

_ZN11hb_vector_tI9hb_pair_tIjPKN2OT19IndexSubtableRecordEELb0EE4pushIJS5_EEEPS5_DpOT_.exit: ; preds = %bb.j, %.critedge.i
  br i1 %.035, label %bb.l, label %bb.k

bb.k:                                             ; preds = %_ZN11hb_vector_tI9hb_pair_tIjPKN2OT19IndexSubtableRecordEELb0EE4pushIJS5_EEEPS5_DpOT_.exit
  store i32 %.01733, ptr %i.h, align 8, !tbaa !3381
  br label %bb.l

bb.l:                                             ; preds = %bb.k, %_ZN11hb_vector_tI9hb_pair_tIjPKN2OT19IndexSubtableRecordEELb0EE4pushIJS5_EEEPS5_DpOT_.exit
  store i32 %.01733, ptr %i.i, align 4, !tbaa !3382
  br label %_ZNK16hb_subset_plan_t19old_gid_for_new_gidEjPj.exit

_ZNK16hb_subset_plan_t19old_gid_for_new_gidEjPj.exit: ; preds = %bb.f, %bb.g, %_ZNK2OT18IndexSubtableArray10find_tableEjj.exit, %bb.h, %bb.e, %bb.l, %_ZNK12hb_hashmap_tIjjLb1EE3getERKj.exit.i
  %.4 = phi i1 [ %.035, %bb.g ], [ %.035, %_ZNK12hb_hashmap_tIjjLb1EE3getERKj.exit.i ], [ true, %bb.l ], [ %.035, %bb.e ], [ %.035, %bb.h ], [ %.035, %_ZNK2OT18IndexSubtableArray10find_tableEjj.exit ], [ %.035, %bb.f ]
  %i.cc = add nuw i32 %.01733, 1                  ; 2 uses
  %exitcond.not = icmp eq i32 %i.cc, %i.d
  br i1 %exitcond.not, label %._crit_edge, label %bb.b, !llvm.loop !3411
}
...
bb.a:
  ...
  %i.d = load <2 x ptr>, ptr %i.c, align 8, !tbaa !283, !noalias !3412
  %i.e = getelementptr inbounds nuw i8, ptr %i.b, i64 72
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !143, !noalias !3412 ; 4 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.h = load i32, ptr %i.g, align 4, !tbaa !293, !noalias !3412
  %i.i = getelementptr inbounds nuw i8, ptr %i.f, i64 36
  %i.j = load i32, ptr %i.i, align 4, !tbaa !294, !noalias !3412
...
bb.d:                                             ; preds = %bb.c
  %i.y = load i32, ptr %i.t, align 4, !tbaa !3389 ; 3 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.ad = load ptr, ptr %i.ac, align 8, !tbaa !3402
...
_ZN11hb_vector_tIN2OT19IndexSubtableRecordELb0EE6resizeEi.exit.thread: ; preds = %bb.d, %bb.e, %bb.f
  store i32 %i.v, ptr %i.t, align 4, !tbaa !3389
  %i.ah = load i32, ptr %i.l, align 4, !tbaa !105
  %.not.i.i36.not = icmp eq i32 %i.ah, 0
  br i1 %.not.i.i36.not, label %bb.g, label %_ZN22hb_serialize_context_t13check_successEb20hb_serialize_error_t.exit, !prof !3415
...
bb.i:                                             ; preds = %bb.g
  ...
  %i.al = load ptr, ptr %i.ak, align 8, !tbaa !3402
...
_ZN11hb_vector_tIN2OT19IndexSubtableRecordELb0EE4tailEv.exit: ; preds = %bb.h, %bb.i
  ...
  %i.ao = load i32, ptr %i.t, align 4, !tbaa !3389 ; 2 uses
...
bb.k:                                             ; preds = %_ZN11hb_vector_tIN2OT19IndexSubtableRecordELb0EE4tailEv.exit
  ...
  %i.as = load ptr, ptr %i.ar, align 8, !tbaa !3402
...
_ZN11hb_vector_tIN2OT19IndexSubtableRecordELb0EE4tailEv.exit28: ; preds = %bb.j, %bb.k
  ...
  %i.aw = load i32, ptr %i.n, align 8, !tbaa !3379
  %i.ax = add i32 %i.aw, 8
  store i32 %i.ax, ptr %i.n, align 8, !tbaa !3379
  ...
  %i.ba = load i32, ptr %i.t, align 4, !tbaa !3389 ; 2 uses
...
bb.m:                                             ; preds = %_ZN11hb_vector_tIN2OT19IndexSubtableRecordELb0EE4tailEv.exit28
  ...
  %i.be = load ptr, ptr %i.bd, align 8, !tbaa !3402
