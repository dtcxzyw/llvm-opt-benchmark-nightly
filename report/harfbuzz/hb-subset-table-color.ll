...
_ZN11hb_vector_tIjLb0EE6resizeEi.exit38.thread:   ; preds = %bb.g, %3, %1
  ...
  %i.ar = load i8, ptr %i.ab, align 1, !tbaa !363, !range !142, !noundef !211
...
end_hunk_0
begin_hunk_1_@_ZN2OT13VarRegionList9serializeEP22hb_serialize_context_tRK11hb_vector_tIjLb0EERKS3_IPK12hb_hashmap_tIj6TripleLb0EELb0EE:bb.a
...
.preheader217.lr.ph:                              ; preds = %5, %7
  %9 = load i32, ptr %i.c, align 4, !tbaa !2399
...
.preheader217.split:                              ; preds = %.preheader217.split.preheader, %23
  ...
  %.0.i86 = select i1 %.not.i85, ptr %13, ptr @_hb_NullPool, !prof !137
  %14 = load ptr, ptr %.0.i86, align 8, !tbaa !2472
  %15 = getelementptr inbounds nuw i8, ptr %14, i64 8
  %16 = load ptr, ptr %15, align 8, !tbaa !2188
  %17 = getelementptr inbounds nuw [4 x i8], ptr %16, i64 %indvars.iv279
  %18 = load i32, ptr %17, align 4, !tbaa !147    ; 3 uses
...
.split.us:                                        ; preds = %.preheader217.split, %.preheader217.split.us
  br i1 %.not.i89.fr, label %bb.l, label %21, !prof !137
...
_ZN11hb_vector_tIZN2OT7VarData9serializeEP22hb_serialize_context_tbRKS_IPKS_IiLb0EELb0EEE12delta_size_tLb0EEixEi.exit91: ; preds = %22
  store i32 1, ptr @_hb_CrapPool, align 16, !tbaa !3005
  br label %23

bb.l:                                             ; preds = %.split.us, %21
  %.0.i88 = phi ptr [ @_hb_CrapPool, %21 ], [ %i.aq, %.split.us ]
  store i32 2, ptr %.0.i88, align 4, !tbaa !3005
...
23:                                               ; preds = %22, %_ZN11hb_vector_tIZN2OT7VarData9serializeEP22hb_serialize_context_tbRKS_IPKS_IiLb0EELb0EEE12delta_size_tLb0EEixEi.exit91
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %.loopexit, label %.preheader217.split, !llvm.loop !3007
