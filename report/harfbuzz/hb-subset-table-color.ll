...
.critedge.i.i.i.i.i.i:                            ; preds = %bb.ac, %.lr.ph.i.i.i.i.i.i, %.preheader.i.i.i.i.i.i
  ...
  br i1 %i.gd, label %.preheader.i.i.i.i.i.i, label %_ZN11hb_vector_tIN22hb_serialize_context_t8object_t6link_tELb0EE5qsortEv.exit.i, !llvm.loop !741
...
bb.ac:                                            ; preds = %.lr.ph.i.i.i.i.i.i
  ...
  br i1 %i.gf, label %.lr.ph.i.i.i.i.i.i, label %.critedge.i.i.i.i.i.i, !llvm.loop !742
...
.lr.ph.i177.epil:                                 ; preds = %.lr.ph.i177.epil, %.lr.ph.i177.epil.preheader
  ...
  store i32 %.01821.i.epil, ptr %i.gn, align 4, !tbaa !312
...
.lr.ph.i177:                                      ; preds = %.lr.ph.i177, %.lr.ph.i177.preheader.new
  ...
  store i32 %.01821.i, ptr %i.gy, align 4, !tbaa !312
...
bb.ae:                                            ; preds = %bb.ad
  %i.hw = load ptr, ptr %i.l, align 8, !tbaa !438, !nonnull !211, !align !443 ; 2 uses
  ...
  %i.ig = load ptr, ptr %i.l, align 8, !tbaa !438, !nonnull !211, !align !443
  %i.ih = shl i32 %i.hp, 1
  %i.ii = add i32 %i.ih, 2
  %i.ij = shl i32 %i.hq, 1
  %i.ik = add i32 %i.ij, 2
  ...
  %i.im = load ptr, ptr %i.l, align 8, !tbaa !438, !nonnull !211, !align !443 ; 3 uses
...
_ZN11hb_vector_tIN22hb_serialize_context_t8object_t6link_tELb0EE4pushEv.exit.i: ; preds = %bb.ao, %bb.an
  ...
  %i.ju = load ptr, ptr %.0.i.i187, align 8, !tbaa !446
...
_ZNK5graph20LigatureSubstFormat116compact_liga_setERNS_24gsubgpos_graph_context_tEPNS_11LigatureSetERN22hb_serialize_context_t8object_tE.exit: ; preds = %bb.ar, %._crit_edge.i, %_ZN2OT7ArrayOfINS_8OffsetToINS_6Layout9GSUB_impl11LigatureSetINS2_10SmallTypesEEENS_7NumTypeILb1EtLj2EEEvLb1EEES8_EixEi.exit
  ...
  %i.kf = load ptr, ptr %i.l, align 8, !tbaa !438, !nonnull !211, !align !443 ; 3 uses
...
.lr.ph.i195:                                      ; preds = %_ZN11hb_vector_tIN5graph7graph_t8vertex_tELb0EEixEi.exit.i192, %_ZN11hb_vector_tIN5graph7graph_t8vertex_tELb0EEixEi.exit15.i
  ...
  %i.ky = load ptr, ptr %i.l, align 8, !tbaa !438, !nonnull !211, !align !443 ; 2 uses
