...
_ZN11hb_vector_tIjLb0EE14realloc_vectorIjTnPN12hb_enable_ifIXsr3std28is_trivially_copy_assignableIT_EE5valueEvE4typeELPv0EEEPjj11hb_priorityILj0EE.exit.i: ; preds = %.thread.i96
  ...
  br i1 %.not22.i99, label %_ZN11hb_vector_tIjLb0EE6resizeEi.exit38, label %1, !prof !12
...
1:                                                ; preds = %_ZN11hb_vector_tIjLb0EE14realloc_vectorIjTnPN12hb_enable_ifIXsr3std28is_trivially_copy_assignableIT_EE5valueEvE4typeELPv0EEEPjj11hb_priorityILj0EE.exit.i
  ...
  br i1 %.not.i.i.i.i37, label %_ZN11hb_vector_tIjLb0EE6resizeEi.exit38.thread, label %3, !prof !11
...
_ZN11hb_vector_tIjLb0EE6resizeEi.exit38.thread:   ; preds = %bb.g, %3, %1
  ...
  %i.ar = load i8, ptr %i.ab, align 1, !tbaa !28, !range !37, !noundef !38
...
select.unfold78:                                  ; preds = %select.unfold78.backedge, %bb.h
  %.145 = phi ptr [ %.044, %bb.h ], [ %i.bs, %select.unfold78.backedge ] ; 5 uses
...
_ZZN10hb_array_tI13lookup_size_tE6_qsortIS0_TnPN12hb_enable_ifIXsr3std18is_move_assignableIT_EE5valueEvE4typeELPv0EEE17hb_sorted_array_tIS0_E11hb_priorityILj1EEENKUlRKS0_SE_E_clESE_SE_.exit68.a: ; preds = %select.unfold78
  ...
  br i1 %i.ce, label %select.unfold78.backedge, label %.critedge.preheader

select.unfold78.backedge:                         ; preds = %_ZZN10hb_array_tI13lookup_size_tE6_qsortIS0_TnPN12hb_enable_ifIXsr3std18is_move_assignableIT_EE5valueEvE4typeELPv0EEE17hb_sorted_array_tIS0_E11hb_priorityILj1EEENKUlRKS0_SE_E_clESE_SE_.exit68.a, %bb.i
  br label %select.unfold78, !llvm.loop !1794

bb.i:                                             ; preds = %select.unfold78
  %i.cf = fcmp olt double %i.br, %i.bz
  br i1 %i.cf, label %select.unfold78.backedge, label %.critedge.preheader
