...
end_hunk_0
begin_hunk_1_@_ZN3CFF22cff2_instancing_plan_t8finalizeEv:bb.a
...
_ZL14hb_object_finiI12hb_hashmap_tIPKS0_Ij6TripleLb0EEjLb0EEEvPT_.exit.i.i: ; preds = %bb.cq, %_ZN11hb_vector_tIPK12hb_hashmap_tIj6TripleLb0EELb0EED2Ev.exit
  %i.aon = load ptr, ptr %i.s, align 8, !tbaa !509 ; 2 uses
...
_ZL14hb_object_finiI14hb_sparseset_tI23hb_bit_set_invertible_tEEvPT_.exit.i: ; preds = %bb.b, %bb.a
  ...
  %i.f = load i32, ptr %i.e, align 8, !tbaa !532
  %i.g = add i32 %i.f, -1
...
bb.c:                                             ; preds = %_ZL14hb_object_finiI14hb_sparseset_tI23hb_bit_set_invertible_tEEvPT_.exit.i
  ...
  store i32 0, ptr %i.h, align 4, !tbaa !533
  %i.i = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.j = load ptr, ptr %i.i, align 8, !tbaa !534
...
_ZN11hb_vector_tIN12hb_bit_set_t10page_map_tELb1EE4finiEv.exit.i.i.i: ; preds = %bb.c, %_ZL14hb_object_finiI14hb_sparseset_tI23hb_bit_set_invertible_tEEvPT_.exit.i
  ...
  %i.l = load i32, ptr %i.k, align 8, !tbaa !535
  %i.m = add i32 %i.l, -1
...
_ZN14hb_sparseset_tI23hb_bit_set_invertible_tE4finiEv.exit: ; preds = %_ZN11hb_vector_tIN12hb_bit_set_t10page_map_tELb1EE4finiEv.exit.i.i.i
  ...
  store i32 0, ptr %i.n, align 4, !tbaa !536
  %i.o = getelementptr inbounds nuw i8, ptr %0, i64 56
  %i.p = load ptr, ptr %i.o, align 8, !tbaa !537
  tail call void @hb_free(ptr noundef %i.p) #16
  %.pre = load i32, ptr %i.e, align 8, !tbaa !532
  %i.q = add i32 %.pre, -1
...
bb.d:                                             ; preds = %_ZN14hb_sparseset_tI23hb_bit_set_invertible_tE4finiEv.exit
  ...
  store i32 0, ptr %i.s, align 4, !tbaa !533
  %i.t = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.u = load ptr, ptr %i.t, align 8, !tbaa !534
...
bb.a:
  ...
  %i.d = load i32, ptr %i.c, align 8, !tbaa !344  ; 10 uses
  ...
  %.sink2.i.i.i.sroa.gep81 = getelementptr inbounds nuw i8, ptr %4, i64 16804
...
bb.d:                                             ; preds = %bb.c
  ...
  br i1 %.not.i.i.i.i, label %_ZN11hb_vector_tIS_IhLb0EELb0EE12resize_exactEi.exit.thread95, label %bb.e, !prof !99
...
bb.e:                                             ; preds = %bb.d
  ...
  br label %_ZN11hb_vector_tIS_IhLb0EELb0EE12resize_exactEi.exit.thread95
...
_ZN11hb_vector_tIS_IhLb0EELb0EE12resize_exactEi.exit.thread95: ; preds = %bb.d, %bb.e
...
_ZN11hb_vector_tIS_IhLb0EELb0EE12resize_exactEi.exit: ; preds = %_ZN11hb_vector_tIhLb0EED2Ev.exit.i.i.i, %bb.f
  store i32 %i.d, ptr %i.g, align 4, !tbaa !154
  %.not2471 = icmp eq i32 %i.d, 0
  br i1 %.not2471, label %_ZN11hb_vector_tIS_IhLb0EELb0EE12resize_exactEi.exit.thread, label %.lr.ph

.lr.ph:                                           ; preds = %_ZN11hb_vector_tIS_IhLb0EELb0EE12resize_exactEi.exit.thread95, %_ZN11hb_vector_tIS_IhLb0EELb0EE12resize_exactEi.exit
  ...
  %i.am = getelementptr inbounds nuw i8, ptr %4, i64 16464 ; 2 uses
  %i.an = getelementptr inbounds nuw i8, ptr %4, i64 16480
  %i.ao = getelementptr inbounds nuw i8, ptr %4, i64 16816
  %i.ap = getelementptr inbounds nuw i8, ptr %4, i64 16824
  %wide.trip.count = zext nneg i32 %i.d to i64
  br label %bb.h

bb.h:                                             ; preds = %.lr.ph, %.thread
  %indvars.iv = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next, %.thread ] ; 7 uses
  %i.aq = load ptr, ptr %i.a, align 8, !tbaa !395
  %i.ar = getelementptr inbounds nuw i8, ptr %i.aq, i64 48
  %i.as = load ptr, ptr %i.ar, align 8, !tbaa !343 ; 3 uses
  %i.at = getelementptr inbounds nuw i8, ptr %i.as, i64 40
  %i.au = load ptr, ptr %i.at, align 8, !tbaa !203 ; 4 uses
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.az = load i32, ptr %i.ay, align 8, !tbaa !204
  %i.ba = urem i32 %i.ax, %i.az                   ; 2 uses
  %i.bb = zext nneg i32 %i.ba to i64              ; 2 uses
  %i.bc = getelementptr inbounds nuw [12 x i8], ptr %i.au, i64 %i.bb ; 2 uses
  %i.bd = getelementptr inbounds nuw i8, ptr %i.bc, i64 4
  %i.be = load i32, ptr %i.bd, align 4            ; 2 uses
  %i.bf = and i32 %i.be, 2
  %.not15.i.i.i.i = icmp eq i32 %i.bf, 0
  br i1 %.not15.i.i.i.i, label %_ZNK12hb_hashmap_tIjjLb1EE3getERKj.exit.i, label %.lr.ph.i.i.i.i

.lr.ph.i.i.i.i:                                   ; preds = %bb.i
  %i.bg = getelementptr inbounds nuw i8, ptr %i.as, i64 28
  %i.bh = load i32, ptr %i.bg, align 4
  %i.bi = load i32, ptr %i.bc, align 4, !tbaa !101
  %i.bj = zext i32 %i.bi to i64
  %i.bk = icmp eq i64 %indvars.iv, %i.bj
  br i1 %i.bk, label %._crit_edge.i.i.i, label %.lr.ph.i.i.i25

bb.j:                                             ; preds = %.lr.ph.i.i.i25
  %i.bl = load i32, ptr %i.bw, align 4, !tbaa !101
  %i.bm = zext i32 %i.bl to i64
  %i.bn = icmp eq i64 %indvars.iv, %i.bm
  br i1 %i.bn, label %._crit_edge.i.i.i, label %.lr.ph.i.i.i25, !llvm.loop !9

._crit_edge.i.i.i:                                ; preds = %bb.j, %.lr.ph.i.i.i.i
  %.lcssa10.i.i.i = phi i32 [ %i.be, %.lr.ph.i.i.i.i ], [ %i.by, %bb.j ]
  %i.bo = phi i64 [ %i.bb, %.lr.ph.i.i.i.i ], [ %i.bv, %bb.j ]
  %i.bp = getelementptr inbounds nuw [12 x i8], ptr %i.au, i64 %i.bo
  %i.bq = trunc i32 %.lcssa10.i.i.i to i1
  %i.br = getelementptr inbounds nuw i8, ptr %i.bp, i64 8
  %spec.select.i.i.i = select i1 %i.bq, ptr %i.br, ptr @minus_1
  br label %_ZNK12hb_hashmap_tIjjLb1EE3getERKj.exit.i

.lr.ph.i.i.i25:                                   ; preds = %.lr.ph.i.i.i.i, %bb.j
  %.01016.i13.i.i.i = phi i32 [ %i.bu, %bb.j ], [ %i.ba, %.lr.ph.i.i.i.i ]
  %.017.i12.i.i.i = phi i32 [ %i.bs, %bb.j ], [ 0, %.lr.ph.i.i.i.i ]
  %i.bs = add i32 %.017.i12.i.i.i, 1              ; 2 uses
  %i.bt = add i32 %i.bs, %.01016.i13.i.i.i
  %i.bu = and i32 %i.bt, %i.bh                    ; 2 uses
  %i.bv = zext i32 %i.bu to i64                   ; 2 uses
  %i.bw = getelementptr inbounds nuw [12 x i8], ptr %i.au, i64 %i.bv ; 2 uses
  %i.bx = getelementptr inbounds nuw i8, ptr %i.bw, i64 4
  %i.by = load i32, ptr %i.bx, align 4            ; 2 uses
  %i.bz = and i32 %i.by, 2
  %.not.i.i.i.i26 = icmp eq i32 %i.bz, 0
  br i1 %.not.i.i.i.i26, label %_ZNK12hb_hashmap_tIjjLb1EE3getERKj.exit.i, label %bb.j, !llvm.loop !9

_ZNK12hb_hashmap_tIjjLb1EE3getERKj.exit.i:        ; preds = %.lr.ph.i.i.i25, %._crit_edge.i.i.i, %bb.i, %bb.h
  %.0.i.i = phi ptr [ @minus_1, %bb.h ], [ %spec.select.i.i.i, %._crit_edge.i.i.i ], [ @minus_1, %bb.i ], [ @minus_1, %.lr.ph.i.i.i25 ]
  %i.ca = load i32, ptr %.0.i.i, align 4, !tbaa !101 ; 3 uses
  %.not66 = icmp eq i32 %i.ca, -1
  br i1 %.not66, label %.thread, label %bb.k

bb.k:                                             ; preds = %_ZNK12hb_hashmap_tIjjLb1EE3getERKj.exit.i
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #16
  %i.cb = load ptr, ptr %0, align 8, !tbaa !1123, !nonnull !122, !align !151
  %i.cc = getelementptr inbounds nuw i8, ptr %i.cb, i64 128
  %i.cd = load ptr, ptr %i.cc, align 8, !tbaa !348
  %i.ce = call { ptr, i64 } @_ZNK2OT8CFFIndexINS_7NumTypeILb1EjLj4EEEEixEj(ptr noundef nonnull align 1 dereferenceable(6) %i.cd, i32 noundef %i.ca) ; 2 uses
  %i.cf = extractvalue { ptr, i64 } %i.ce, 0
  store ptr %i.cf, ptr %3, align 8
  %i.cg = extractvalue { ptr, i64 } %i.ce, 1
  store i64 %i.cg, ptr %i.ad, align 8
  %i.ch = load ptr, ptr %0, align 8, !tbaa !1123, !nonnull !122, !align !151
  %i.ci = getelementptr inbounds nuw i8, ptr %i.ch, i64 144
  %i.cj = load ptr, ptr %i.ci, align 8, !tbaa !248
  %i.ck = call noundef i32 @_ZNK3CFF12CFF2FDSelect6get_fdEj(ptr noundef nonnull align 1 dereferenceable(11) %i.cj, i32 noundef %i.ca) ; 2 uses
  %i.cl = load ptr, ptr %0, align 8, !tbaa !1123, !nonnull !122, !align !151 ; 2 uses
  %i.cm = getelementptr inbounds nuw i8, ptr %i.cl, i64 152
  %i.cn = load i32, ptr %i.cm, align 8, !tbaa !349
  %.not = icmp ult i32 %i.ck, %i.cn
  br i1 %.not, label %bb.l, label %.thread62, !prof !97

.thread62:                                        ; preds = %bb.k
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #16
  br label %_ZN11hb_vector_tIS_IhLb0EELb0EE12resize_exactEi.exit.thread

bb.l:                                             ; preds = %bb.k
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #16
  %i.co = load ptr, ptr %i.a, align 8, !tbaa !395 ; 2 uses
  %i.cp = getelementptr inbounds nuw i8, ptr %i.co, i64 2360
  %i.cq = load ptr, ptr %i.cp, align 8, !tbaa !444
  %i.cr = getelementptr inbounds nuw i8, ptr %i.co, i64 2356
  %i.cs = load i32, ptr %i.cr, align 4, !tbaa !445
  call void @_ZN3CFF20cff2_cs_interp_env_tINS_11blend_arg_tEEC2IKN2OT4cff220accelerator_subset_tEEERK10hb_array_tIKhERT_jPKij(ptr noundef nonnull align 8 dereferenceable(16835) %4, ptr noundef nonnull align 8 dereferenceable(16) %3, ptr noundef nonnull align 8 dereferenceable(216) %i.cl, i32 noundef %i.ck, ptr noundef %i.cq, i32 noundef %i.cs)
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #16
  %i.ct = load ptr, ptr %i.ae, align 8, !tbaa !155
  %i.cu = getelementptr inbounds nuw [16 x i8], ptr %i.ct, i64 %indvars.iv
  %i.cv = load ptr, ptr %i.a, align 8, !tbaa !395 ; 2 uses
  %i.cw = getelementptr inbounds nuw i8, ptr %i.cv, i64 20
  %i.cx = load i32, ptr %i.cw, align 4, !tbaa !339
  %i.cy = trunc i32 %i.cx to i8
  br i1 %.not23, label %_ZN11hb_vector_tIS_IN3CFF12cs_command_tELb0EELb0EEixEi.exit, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.cz = load i32, ptr %i.af, align 4, !tbaa !538
  %i.da = zext i32 %i.cz to i64
  %.not.i = icmp samesign ult i64 %indvars.iv, %i.da
  br i1 %.not.i, label %bb.o, label %bb.n, !prof !97
...
bb.n:                                             ; preds = %bb.m
  ...
  br label %_ZN11hb_vector_tIS_IN3CFF12cs_command_tELb0EELb0EEixEi.exit

bb.o:                                             ; preds = %bb.m
  %i.db = load ptr, ptr %i.ag, align 8, !tbaa !123
  %i.dc = getelementptr inbounds nuw [16 x i8], ptr %i.db, i64 %indvars.iv
  br label %_ZN11hb_vector_tIS_IN3CFF12cs_command_tELb0EELb0EEixEi.exit

_ZN11hb_vector_tIS_IN3CFF12cs_command_tELb0EELb0EEixEi.exit: ; preds = %bb.o, %bb.n, %bb.l
  %i.dd = phi ptr [ null, %bb.l ], [ @_hb_CrapPool, %bb.n ], [ %i.dc, %bb.o ]
  %i.de = and i8 %i.cy, 1
  store ptr %i.cu, ptr %5, align 8, !tbaa !119
  store i8 %i.de, ptr %i.ah, align 8, !tbaa !389
  store ptr %i.cv, ptr %i.ai, align 8, !tbaa !390
  store ptr %i.dd, ptr %i.aj, align 8, !tbaa !539
  store ptr null, ptr %i.ak, align 8, !tbaa !391
  store i8 0, ptr %i.al, align 8, !tbaa !540
  store i8 0, ptr %i.am, align 8, !tbaa !366
  %.pre.i = load i32, ptr %.sroa.gep, align 4, !tbaa !367
  %.pre19.i = load i32, ptr %.sroa.gep55, align 8, !tbaa !368
  br label %bb.p

bb.p:                                             ; preds = %bb.z, %_ZN11hb_vector_tIS_IN3CFF12cs_command_tELb0EELb0EEixEi.exit
  %i.df = phi i32 [ %.pre19.i, %_ZN11hb_vector_tIS_IN3CFF12cs_command_tELb0EELb0EEixEi.exit ], [ %i.em, %bb.z ] ; 3 uses
  %i.dg = phi i32 [ %.pre.i, %_ZN11hb_vector_tIS_IN3CFF12cs_command_tELb0EELb0EEixEi.exit ], [ %i.el, %bb.z ] ; 3 uses
  %.0.i27 = phi i32 [ 200000, %_ZN11hb_vector_tIS_IN3CFF12cs_command_tELb0EELb0EEixEi.exit ], [ %i.er, %bb.z ]
  %i.dh = add i32 %i.dg, 1                        ; 3 uses
  %.not.i.i28 = icmp ugt i32 %i.dh, %i.df
  br i1 %.not.i.i28, label %bb.t, label %bb.q

bb.q:                                             ; preds = %bb.p
  %i.di = load ptr, ptr %4, align 8, !tbaa !369   ; 2 uses
  %i.dj = zext i32 %i.dg to i64
  %i.dk = getelementptr inbounds nuw i8, ptr %i.di, i64 %i.dj
  %i.dl = load i8, ptr %i.dk, align 1, !tbaa !148 ; 2 uses
  %i.dm = zext i8 %i.dl to i32
  store i32 %i.dh, ptr %.sroa.gep, align 4, !tbaa !367
  %i.dn = icmp eq i8 %i.dl, 12
  br i1 %i.dn, label %bb.r, label %_ZN3CFF20cff2_cs_interp_env_tINS_11blend_arg_tEE8fetch_opEv.exit.i

bb.r:                                             ; preds = %bb.q
  %i.do = add i32 %i.dg, 2                        ; 2 uses
  %.not5.i.i.i = icmp ugt i32 %i.do, %i.df
  br i1 %.not5.i.i.i, label %_ZN3CFF20cff2_cs_interp_env_tINS_11blend_arg_tEE8fetch_opEv.exit.i.thread, label %bb.s, !prof !99

bb.s:                                             ; preds = %bb.r
  %i.dp = zext i32 %i.dh to i64
  %i.dq = getelementptr inbounds nuw i8, ptr %i.di, i64 %i.dp
  %i.dr = load i8, ptr %i.dq, align 1, !tbaa !148
  %i.ds = zext i8 %i.dr to i32
  %i.dt = or disjoint i32 %i.ds, 256
  store i32 %i.do, ptr %.sroa.gep, align 4, !tbaa !367
  br label %_ZN3CFF20cff2_cs_interp_env_tINS_11blend_arg_tEE8fetch_opEv.exit.i

bb.t:                                             ; preds = %bb.p
  %i.du = load i32, ptr %.sroa.gep37, align 4, !tbaa !370
  %.not.i1.i.i = icmp eq i32 %i.du, 0
  %spec.select64 = select i1 %.not.i1.i.i, i32 14, i32 11
  br label %_ZN3CFF20cff2_cs_interp_env_tINS_11blend_arg_tEE8fetch_opEv.exit.i.thread

_ZN3CFF20cff2_cs_interp_env_tINS_11blend_arg_tEE8fetch_opEv.exit.i: ; preds = %bb.s, %bb.q
  %.0.i.i29 = phi i32 [ %i.dm, %bb.q ], [ %i.dt, %bb.s ] ; 3 uses
  switch i32 %.0.i.i29, label %_ZN3CFF20cff2_cs_interp_env_tINS_11blend_arg_tEE8fetch_opEv.exit.i.thread [
    i32 10, label %bb.u
    i32 29, label %bb.u
    i32 16, label %bb.v
    i32 15, label %bb.w
...
bb.u:                                             ; preds = %_ZN3CFF20cff2_cs_interp_env_tINS_11blend_arg_tEE8fetch_opEv.exit.i, %_ZN3CFF20cff2_cs_interp_env_tINS_11blend_arg_tEE8fetch_opEv.exit.i
  call void @_ZN3CFF10cs_opset_tINS_11blend_arg_tE23cff2_cs_opset_flatten_tNS_20cff2_cs_interp_env_tIS1_EENS_15flatten_param_tENS_17path_procs_null_tIS4_S5_EEE10process_opEjRS4_RS5_(i32 noundef %.0.i.i29, ptr noundef nonnull align 8 dereferenceable(16835) %4, ptr noundef nonnull align 8 dereferenceable(41) %5)
...
bb.v:                                             ; preds = %_ZN3CFF20cff2_cs_interp_env_tINS_11blend_arg_tEE8fetch_opEv.exit.i
  call void @_ZN3CFF15cff2_cs_opset_tI23cff2_cs_opset_flatten_tNS_15flatten_param_tENS_11blend_arg_tENS_17path_procs_null_tINS_20cff2_cs_interp_env_tIS3_EES2_EEE13process_blendERS6_RS2_(ptr noundef nonnull align 8 dereferenceable(16835) %4, ptr noundef nonnull align 8 dereferenceable(41) %5)
  br label %_ZN3CFF15cff2_cs_opset_tI23cff2_cs_opset_flatten_tNS_15flatten_param_tENS_11blend_arg_tENS_17path_procs_null_tINS_20cff2_cs_interp_env_tIS3_EES2_EEE10process_opEjRS6_RS2_.exit

bb.w:                                             ; preds = %_ZN3CFF20cff2_cs_interp_env_tINS_11blend_arg_tEE8fetch_opEv.exit.i
  %i.dv = load i32, ptr %.sroa.gep43, align 4, !tbaa !483 ; 2 uses
  %.not.i.i.i.i.i.i = icmp eq i32 %i.dv, 0
  br i1 %.not.i.i.i.i.i.i, label %bb.y, label %bb.x, !prof !99

bb.x:                                             ; preds = %bb.w
  %i.dw = add i32 %i.dv, -1
  %i.dx = zext i32 %i.dw to i64
  %i.dy = getelementptr inbounds nuw [32 x i8], ptr %.sroa.gep46, i64 %i.dx
  br label %_ZN3CFF11cff_stack_tINS_11blend_arg_tELi513EE3popEv.exit.i.i.i.i.i

bb.y:                                             ; preds = %bb.w
  store i8 1, ptr %.sroa.gep40, align 8, !tbaa !541
...
_ZN3CFF11cff_stack_tINS_11blend_arg_tELi513EE3popEv.exit.i.i.i.i.i: ; preds = %bb.y, %bb.x
  %.0.i.i.i.i.i.i = phi ptr [ %i.dy, %bb.x ], [ @_hb_CrapPool, %bb.y ]
  %i.dz = load double, ptr %.0.i.i.i.i.i.i, align 8, !tbaa !145 ; 3 uses
end_hunk_1
