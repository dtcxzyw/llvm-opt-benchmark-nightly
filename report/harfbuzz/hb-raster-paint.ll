...
bb.r:                                             ; preds = %bb.q
  ...
  %10 = sext i32 %.075.i to i64
  %11 = mul nsw i64 %10, %i.da
  %12 = getelementptr [4 x i8], ptr %.2220, i64 %11 ; 2 uses
  %i.gz = getelementptr [4 x i8], ptr %12, i64 %i.gu
  %i.ha = getelementptr [4 x i8], ptr %12, i64 %i.gx
  %13 = load i32, ptr %i.gw, align 1, !tbaa !129  ; 4 uses
  %14 = load i32, ptr %i.gy, align 1, !tbaa !129  ; 4 uses
  %15 = load i32, ptr %i.gz, align 1, !tbaa !129  ; 4 uses
  %16 = load i32, ptr %i.ha, align 1, !tbaa !129  ; 4 uses
  ...
  %21 = insertelement <4 x i32> %20, i32 %19, i64 1
  %22 = insertelement <4 x i32> %21, i32 %17, i64 2
  %23 = insertelement <4 x i32> %22, i32 %18, i64 3
  %24 = and <4 x i32> %23, <i32 255, i32 255, i32 -1, i32 255>
  %i.hf = uitofp <4 x i32> %24 to <4 x float>
  %25 = lshr i32 %14, 24
  %26 = lshr i32 %14, 16
  %27 = lshr i32 %14, 8
  %28 = insertelement <4 x i32> poison, i32 %14, i64 0
  %29 = insertelement <4 x i32> %28, i32 %27, i64 1
  %30 = insertelement <4 x i32> %29, i32 %25, i64 2
  %31 = insertelement <4 x i32> %30, i32 %26, i64 3
  %32 = and <4 x i32> %31, <i32 255, i32 255, i32 -1, i32 255>
  %i.hg = uitofp <4 x i32> %32 to <4 x float>
  ...
  %34 = lshr i32 %15, 16
  %35 = lshr i32 %15, 8
  %36 = insertelement <4 x i32> poison, i32 %15, i64 0
  %37 = insertelement <4 x i32> %36, i32 %35, i64 1
  %38 = insertelement <4 x i32> %37, i32 %33, i64 2
  %39 = insertelement <4 x i32> %38, i32 %34, i64 3
  %40 = and <4 x i32> %39, <i32 255, i32 255, i32 -1, i32 255>
  %i.hn = uitofp <4 x i32> %40 to <4 x float>
  ...
  %42 = lshr i32 %16, 16
  %43 = lshr i32 %16, 8
  %44 = insertelement <4 x i32> poison, i32 %16, i64 0
  %45 = insertelement <4 x i32> %44, i32 %43, i64 1
  %46 = insertelement <4 x i32> %45, i32 %41, i64 2
  %47 = insertelement <4 x i32> %46, i32 %42, i64 3
  %48 = and <4 x i32> %47, <i32 255, i32 255, i32 -1, i32 255>
  %i.hr = uitofp <4 x i32> %48 to <4 x float>
...
bb.x:                                             ; preds = %bb.w
  ...
  %49 = sext i32 %.075.i252 to i64
  %50 = mul nsw i64 %49, %i.da
  %51 = getelementptr [4 x i8], ptr %.2220, i64 %50 ; 2 uses
  %i.lz = getelementptr [4 x i8], ptr %51, i64 %i.lu
  %i.ma = getelementptr [4 x i8], ptr %51, i64 %i.lx
  %52 = load i32, ptr %i.lw, align 1, !tbaa !129  ; 4 uses
  %53 = load i32, ptr %i.ly, align 1, !tbaa !129  ; 4 uses
  %54 = load i32, ptr %i.lz, align 1, !tbaa !129  ; 4 uses
  %55 = load i32, ptr %i.ma, align 1, !tbaa !129  ; 4 uses
  ...
  %57 = lshr i32 %52, 16
  %58 = lshr i32 %52, 8
  %59 = insertelement <4 x i32> poison, i32 %52, i64 0
  %60 = insertelement <4 x i32> %59, i32 %58, i64 1
  %61 = insertelement <4 x i32> %60, i32 %56, i64 2
  %62 = insertelement <4 x i32> %61, i32 %57, i64 3
  %63 = and <4 x i32> %62, <i32 255, i32 255, i32 -1, i32 255>
  %i.mf = uitofp <4 x i32> %63 to <4 x float>
  %64 = lshr i32 %53, 24
  %65 = lshr i32 %53, 16
  %66 = lshr i32 %53, 8
  %67 = insertelement <4 x i32> poison, i32 %53, i64 0
  %68 = insertelement <4 x i32> %67, i32 %66, i64 1
  %69 = insertelement <4 x i32> %68, i32 %64, i64 2
  %70 = insertelement <4 x i32> %69, i32 %65, i64 3
  %71 = and <4 x i32> %70, <i32 255, i32 255, i32 -1, i32 255>
  %i.mg = uitofp <4 x i32> %71 to <4 x float>
  ...
  %73 = lshr i32 %54, 16
  %74 = lshr i32 %54, 8
  %75 = insertelement <4 x i32> poison, i32 %54, i64 0
  %76 = insertelement <4 x i32> %75, i32 %74, i64 1
  %77 = insertelement <4 x i32> %76, i32 %72, i64 2
  %78 = insertelement <4 x i32> %77, i32 %73, i64 3
  %79 = and <4 x i32> %78, <i32 255, i32 255, i32 -1, i32 255>
  %i.mn = uitofp <4 x i32> %79 to <4 x float>
  ...
  %81 = lshr i32 %55, 16
  %82 = lshr i32 %55, 8
  %83 = insertelement <4 x i32> poison, i32 %55, i64 0
  %84 = insertelement <4 x i32> %83, i32 %82, i64 1
  %85 = insertelement <4 x i32> %84, i32 %80, i64 2
  %86 = insertelement <4 x i32> %85, i32 %81, i64 3
  %87 = and <4 x i32> %86, <i32 255, i32 255, i32 -1, i32 255>
  %i.mr = uitofp <4 x i32> %87 to <4 x float>
