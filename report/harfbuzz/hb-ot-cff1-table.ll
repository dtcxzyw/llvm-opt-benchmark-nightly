...
begin_hunk_0_@_ZN3CFF12path_procs_tI25cff1_path_procs_extents_tNS_20cff1_cs_interp_env_tE20cff1_extents_param_tE10rlinecurveERS2_RS3_:bb.a
  store double %i.ao, ptr %i.i, align 8, !tbaa !107
...
bb.u:                                             ; preds = %bb.t
  store double %i.aw, ptr %i.l, align 8, !tbaa !107
...
_ZN25cff1_path_procs_extents_t4lineERN3CFF20cff1_cs_interp_env_tER20cff1_extents_param_tRKNS0_7point_tE.exit: ; preds = %bb.t, %bb.u
  ...
  br i1 %.not, label %._crit_edge, label %bb.b, !llvm.loop !197
...
._crit_edge:                                      ; preds = %_ZN25cff1_path_procs_extents_t4lineERN3CFF20cff1_cs_interp_env_tER20cff1_extents_param_tRKNS0_7point_tE.exit
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %2, ptr noundef nonnull align 8 dereferenceable(16) %i.ba, i64 16, i1 false), !tbaa.struct !194
  %.not.i.i32 = icmp ult i32 %i.n, %i.c
  br i1 %.not.i.i32, label %bb.w, label %bb.v, !prof !51

bb.v:                                             ; preds = %._crit_edge
  store i8 1, ptr %i.a, align 8, !tbaa !180
...
_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit34: ; preds = %bb.v, %bb.w
  ...
  br i1 %.not.i.i35, label %bb.y, label %bb.x, !prof !51
...
bb.y:                                             ; preds = %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit34
  ...
  %.pre58 = load double, ptr %i.bk, align 8, !tbaa !16
  br label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit37

_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit37: ; preds = %bb.x, %bb.y
  %i.bl = phi double [ %i.bh, %bb.x ], [ %.pre58, %bb.y ]
  %i.bm = load double, ptr %.0.i.i33, align 8, !tbaa !16
  %i.bn = load <2 x double>, ptr %2, align 16, !tbaa !16
  ...
  store <2 x double> %i.bq, ptr %2, align 16, !tbaa !16
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %3, ptr noundef nonnull align 16 dereferenceable(16) %2, i64 16, i1 false), !tbaa.struct !194
  %.not.i.i38 = icmp ult i32 %i.az, %i.c
  br i1 %.not.i.i38, label %bb.aa, label %bb.z, !prof !51
...
_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit40: ; preds = %bb.z, %bb.aa
  ...
  br i1 %.not.i.i41, label %bb.ac, label %bb.ab, !prof !51
...
bb.ac:                                            ; preds = %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit40
  ...
  %.pre59 = load double, ptr %i.ca, align 8, !tbaa !16
  br label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit43

_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit43: ; preds = %bb.ab, %bb.ac
  %i.cb = phi double [ %i.bx, %bb.ab ], [ %.pre59, %bb.ac ]
  %i.cc = load double, ptr %.0.i.i39, align 8, !tbaa !16
  %i.cd = load <2 x double>, ptr %3, align 16, !tbaa !16
  ...
  store <2 x double> %i.cg, ptr %3, align 16, !tbaa !16
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %4, ptr noundef nonnull align 16 dereferenceable(16) %3, i64 16, i1 false), !tbaa.struct !194
  %i.ch = add i32 %i.n, 4                         ; 2 uses
  %.not.i.i44 = icmp ult i32 %i.ch, %i.c
  br i1 %.not.i.i44, label %bb.ae, label %bb.ad, !prof !51
...
_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit46: ; preds = %bb.ad, %bb.ae
  ...
  br i1 %.not.i.i47, label %bb.ag, label %bb.af, !prof !51
...
bb.ag:                                            ; preds = %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit46
  ...
  %.pre60 = load double, ptr %i.cr, align 8, !tbaa !16
  br label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit49

_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit49: ; preds = %bb.af, %bb.ag
  %i.cs = phi double [ %i.co, %bb.af ], [ %.pre60, %bb.ag ]
  %i.ct = load double, ptr %.0.i.i45, align 8, !tbaa !16
  %i.cu = load <2 x double>, ptr %4, align 16, !tbaa !16
  ...
  store <2 x double> %i.cx, ptr %4, align 16, !tbaa !16
...
bb.a:
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %2, ptr noundef nonnull align 8 dereferenceable(16) %i.a, i64 16, i1 false), !tbaa.struct !194
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 4 uses
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 20 ; 2 uses
  %i.d = load i32, ptr %i.c, align 4, !tbaa !103  ; 3 uses
  %.not = trunc i32 %i.d to i1
  br i1 %.not, label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit, label %bb.b

_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit: ; preds = %bb.a
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 24
  %.pre = load double, ptr %i.e, align 8, !tbaa !16
  %i.f = load double, ptr %2, align 8, !tbaa !16
  %i.g = fadd double %i.f, %.pre
  store double %i.g, ptr %2, align 8, !tbaa !16
  br label %bb.b
...
bb.c:                                             ; preds = %.lr.ph, %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit30
  ...
  br i1 %.not.i.i19, label %bb.e, label %bb.d, !prof !51

bb.d:                                             ; preds = %bb.c
  store i8 1, ptr %i.b, align 8, !tbaa !180
...
bb.e:                                             ; preds = %bb.c
  ...
  %.pre33 = load double, ptr %i.s, align 8, !tbaa !16
  br label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit21

_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit21: ; preds = %bb.d, %bb.e
  %i.t = phi double [ %i.m, %bb.d ], [ %.pre33, %bb.e ]
  %i.u = load double, ptr %i.k, align 8, !tbaa !16
  %i.v = fadd double %i.u, %i.t
  store double %i.v, ptr %i.k, align 8, !tbaa !16
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %3, ptr noundef nonnull align 8 dereferenceable(16) %2, i64 16, i1 false), !tbaa.struct !194
  %i.w = add i32 %.132, 1                         ; 2 uses
  %.not.i.i22 = icmp ult i32 %i.w, %i.p
  br i1 %.not.i.i22, label %bb.g, label %bb.f, !prof !51
...
_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit24: ; preds = %bb.f, %bb.g
  ...
  br i1 %.not.i.i25, label %bb.i, label %bb.h, !prof !51
...
bb.i:                                             ; preds = %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit24
  ...
  %.pre34 = load double, ptr %i.ab, align 8, !tbaa !16
  br label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit27

_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit27: ; preds = %bb.h, %bb.i
  %i.ac = phi double [ %i.n, %bb.h ], [ %.pre34, %bb.i ]
  %i.ad = load double, ptr %.0.i.i23, align 8, !tbaa !16
  %i.ae = load <2 x double>, ptr %3, align 16, !tbaa !16
  ...
  store <2 x double> %i.ah, ptr %3, align 16, !tbaa !16
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %4, ptr noundef nonnull align 16 dereferenceable(16) %3, i64 16, i1 false), !tbaa.struct !194
  %i.ai = add i32 %.132, 3                        ; 2 uses
  %.not.i.i28 = icmp ult i32 %i.ai, %i.p
  br i1 %.not.i.i28, label %bb.k, label %bb.j, !prof !51
...
bb.k:                                             ; preds = %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit27
  ...
  %.pre35 = load double, ptr %i.ak, align 8, !tbaa !16
  br label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit30

_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit30: ; preds = %bb.j, %bb.k
  %i.al = phi double [ %i.o, %bb.j ], [ %.pre35, %bb.k ]
  %i.am = load double, ptr %i.l, align 8, !tbaa !16
  %i.an = fadd double %i.am, %i.al
  store double %i.an, ptr %i.l, align 8, !tbaa !16
  call void @_ZN25cff1_path_procs_extents_t5curveERN3CFF20cff1_cs_interp_env_tER20cff1_extents_param_tRKNS0_7point_tES7_S7_(ptr noundef nonnull align 8 dereferenceable(4481) %0, ptr noundef nonnull align 8 dereferenceable(48) %1, ptr noundef nonnull align 8 dereferenceable(16) %2, ptr noundef nonnull align 8 dereferenceable(16) %3, ptr noundef nonnull align 8 dereferenceable(16) %4)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %2, ptr noundef nonnull align 8 dereferenceable(16) %i.a, i64 16, i1 false), !tbaa.struct !194
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #5
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #5
  %i.ao = add i32 %i.q, 4                         ; 2 uses
  %i.ap = load i32, ptr %i.c, align 4, !tbaa !103 ; 2 uses
  %.not18 = icmp ugt i32 %i.ao, %i.ap
  br i1 %.not18, label %._crit_edge, label %bb.c, !llvm.loop !198
...
_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit: ; preds = %bb.a
  ...
  store double %i.h, ptr %i.f, align 8, !tbaa !16
  br label %bb.b
...
bb.e:                                             ; preds = %bb.c
  ...
  %.pre33 = load double, ptr %i.r, align 8, !tbaa !16
  br label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit21

_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit21: ; preds = %bb.d, %bb.e
  %i.s = phi double [ %i.l, %bb.d ], [ %.pre33, %bb.e ]
  %i.t = load double, ptr %2, align 8, !tbaa !16
  %i.u = fadd double %i.t, %i.s
  store double %i.u, ptr %2, align 8, !tbaa !16
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %3, ptr noundef nonnull align 8 dereferenceable(16) %2, i64 16, i1 false), !tbaa.struct !194
...
bb.i:                                             ; preds = %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit24
  ...
  %.pre34 = load double, ptr %i.aa, align 8, !tbaa !16
  br label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit27

_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit27: ; preds = %bb.h, %bb.i
  %i.ab = phi double [ %i.m, %bb.h ], [ %.pre34, %bb.i ]
  %i.ac = load double, ptr %.0.i.i23, align 8, !tbaa !16
  %i.ad = load <2 x double>, ptr %3, align 16, !tbaa !16
  ...
  store <2 x double> %i.ag, ptr %3, align 16, !tbaa !16
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %4, ptr noundef nonnull align 16 dereferenceable(16) %3, i64 16, i1 false), !tbaa.struct !194
...
bb.k:                                             ; preds = %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit27
  ...
  %.pre35 = load double, ptr %i.aj, align 8, !tbaa !16
  br label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit30

_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit30: ; preds = %bb.j, %bb.k
  %i.ak = phi double [ %i.n, %bb.j ], [ %.pre35, %bb.k ]
  %i.al = load double, ptr %4, align 8, !tbaa !16
  %i.am = fadd double %i.al, %i.ak
  store double %i.am, ptr %4, align 8, !tbaa !16
  call void @_ZN25cff1_path_procs_extents_t5curveERN3CFF20cff1_cs_interp_env_tER20cff1_extents_param_tRKNS0_7point_tES7_S7_(ptr noundef nonnull align 8 dereferenceable(4481) %0, ptr noundef nonnull align 8 dereferenceable(48) %1, ptr noundef nonnull align 8 dereferenceable(16) %2, ptr noundef nonnull align 8 dereferenceable(16) %3, ptr noundef nonnull align 8 dereferenceable(16) %4)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %2, ptr noundef nonnull align 8 dereferenceable(16) %i.a, i64 16, i1 false), !tbaa.struct !194
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #5
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #5
  %i.an = add i32 %i.p, 4                         ; 2 uses
  %i.ao = load i32, ptr %i.c, align 4, !tbaa !103 ; 2 uses
  %.not18 = icmp ugt i32 %i.an, %i.ao
  br i1 %.not18, label %._crit_edge, label %bb.c, !llvm.loop !199
...
bb.a:
  ...
  %i.c = load i32, ptr %i.b, align 4, !tbaa !103  ; 5 uses
  %i.d = and i32 %i.c, 4
...
_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit82: ; preds = %bb.a
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %5, ptr noundef nonnull align 8 dereferenceable(16) %i.q, i64 16, i1 false), !tbaa.struct !194
  %i.r = getelementptr inbounds nuw i8, ptr %0, i64 24
  %.pre = load double, ptr %i.r, align 8, !tbaa !16
  %i.s = getelementptr inbounds nuw i8, ptr %5, i64 8 ; 4 uses
  %i.t = load double, ptr %i.s, align 8, !tbaa !16
  %i.u = fadd double %i.t, %.pre
  store double %i.u, ptr %i.s, align 8, !tbaa !16
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %6, ptr noundef nonnull align 8 dereferenceable(16) %5, i64 16, i1 false), !tbaa.struct !194
  %i.v = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.w = load <2 x double>, ptr %i.v, align 8, !tbaa !16
  %i.x = load <2 x double>, ptr %6, align 16, !tbaa !16
  %i.y = fadd <2 x double> %i.x, %i.w
  store <2 x double> %i.y, ptr %6, align 16, !tbaa !16
  call void @llvm.lifetime.start.p0(ptr nonnull %7) #5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %7, ptr noundef nonnull align 16 dereferenceable(16) %6, i64 16, i1 false), !tbaa.struct !194
  %i.z = getelementptr inbounds nuw i8, ptr %0, i64 48
  %.pre146 = load double, ptr %i.z, align 8, !tbaa !16
  %i.aa = load double, ptr %7, align 8, !tbaa !16
  %i.ab = fadd double %i.aa, %.pre146
  store double %i.ab, ptr %7, align 8, !tbaa !16
...
begin_hunk_1_@_ZN3CFF12path_procs_tI25cff1_path_procs_extents_tNS_20cff1_cs_interp_env_tE20cff1_extents_param_tE9vhcurvetoERS2_RS3_:bb.a
  ...
  store double %i.ci, ptr %7, align 8, !tbaa !16
  %i.cj = add i32 %i.al, 8                        ; 2 uses
  %.not73 = icmp ugt i32 %i.cj, %i.bl
  br i1 %.not73, label %._crit_edge, label %bb.b, !llvm.loop !200
...
_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit109: ; preds = %._crit_edge
  ...
  %i.cr = load double, ptr %i.co, align 8, !tbaa !16
  %i.cs = fadd double %i.cq, %i.cr
  store double %i.cs, ptr %i.cp, align 8, !tbaa !16
  br label %bb.s
...
bb.t:                                             ; preds = %.lr.ph142, %bb.an
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %2, ptr noundef nonnull align 8 dereferenceable(16) %i.e, i64 16, i1 false), !tbaa.struct !194
  %.not.i.i110 = icmp ult i32 %.1141, %i.ct
  br i1 %.not.i.i110, label %bb.v, label %bb.u, !prof !51
...
_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit115: ; preds = %bb.w, %bb.x
  ...
  br i1 %.not.i.i116, label %bb.z, label %bb.y, !prof !51
...
bb.z:                                             ; preds = %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit115
  ...
  %.pre154 = load double, ptr %i.df, align 8, !tbaa !16
  br label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit118

_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit118: ; preds = %bb.y, %bb.z
  %i.dg = phi double [ %i.k, %bb.y ], [ %.pre154, %bb.z ]
  %i.dh = load double, ptr %.0.i.i114, align 8, !tbaa !16
  %i.di = load <2 x double>, ptr %3, align 16, !tbaa !16
  ...
  store <2 x double> %i.dl, ptr %3, align 16, !tbaa !16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %4, ptr noundef nonnull align 16 dereferenceable(16) %3, i64 16, i1 false), !tbaa.struct !194
  %i.dm = or disjoint i32 %.1141, 3               ; 2 uses
  %.not.i.i119 = icmp ult i32 %i.dm, %i.ct
  br i1 %.not.i.i119, label %bb.ab, label %bb.aa, !prof !51
...
bb.ab:                                            ; preds = %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit118
  ...
  %.pre155 = load double, ptr %i.do, align 8, !tbaa !16
  br label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit121

_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit121: ; preds = %bb.aa, %bb.ab
  %i.dp = phi double [ %i.l, %bb.aa ], [ %.pre155, %bb.ab ]
  %i.dq = load double, ptr %4, align 8, !tbaa !16
  %i.dr = fadd double %i.dq, %i.dp
  store double %i.dr, ptr %4, align 8, !tbaa !16
  call void @_ZN25cff1_path_procs_extents_t5curveERN3CFF20cff1_cs_interp_env_tER20cff1_extents_param_tRKNS0_7point_tES7_S7_(ptr noundef nonnull align 8 dereferenceable(4481) %0, ptr noundef nonnull align 8 dereferenceable(48) %1, ptr noundef nonnull align 8 dereferenceable(16) %2, ptr noundef nonnull align 8 dereferenceable(16) %3, ptr noundef nonnull align 8 dereferenceable(16) %4)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %2, ptr noundef nonnull align 8 dereferenceable(16) %4, i64 16, i1 false), !tbaa.struct !194
  %i.ds = or disjoint i32 %.1141, 4               ; 2 uses
  %i.dt = load i32, ptr %i.b, align 4, !tbaa !103 ; 7 uses
  %.not.i.i122 = icmp ult i32 %i.ds, %i.dt
  br i1 %.not.i.i122, label %bb.ad, label %bb.ac, !prof !51
...
_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit127: ; preds = %bb.ae, %bb.af
  ...
  br i1 %.not.i.i128, label %bb.ah, label %bb.ag, !prof !51
...
bb.ah:                                            ; preds = %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit127
  ...
  %.pre157 = load double, ptr %i.ee, align 8, !tbaa !16
  br label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit130

_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit130: ; preds = %bb.ag, %bb.ah
  %i.ef = phi double [ %i.n, %bb.ag ], [ %.pre157, %bb.ah ]
  %i.eg = load double, ptr %.0.i.i126, align 8, !tbaa !16
  %i.eh = load <2 x double>, ptr %3, align 16, !tbaa !16
  ...
  store <2 x double> %i.ek, ptr %3, align 16, !tbaa !16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %4, ptr noundef nonnull align 16 dereferenceable(16) %3, i64 16, i1 false), !tbaa.struct !194
  %i.el = or disjoint i32 %.1141, 7               ; 2 uses
  %.not.i.i131 = icmp ult i32 %i.el, %i.dt
  br i1 %.not.i.i131, label %bb.aj, label %bb.ai, !prof !51
...
bb.ak:                                            ; preds = %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit133
  ...
  br i1 %.not.i.i134, label %bb.am, label %bb.al, !prof !51
...
bb.an:                                            ; preds = %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit136, %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit133
  ...
  %i.ey = load i32, ptr %i.b, align 4, !tbaa !103 ; 2 uses
  %.not71 = icmp ugt i32 %i.ex, %i.ey
  br i1 %.not71, label %.loopexit, label %bb.t, !llvm.loop !201
...
_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit82: ; preds = %bb.a
  ...
  %i.r = getelementptr inbounds nuw i8, ptr %0, i64 24
  %.pre = load double, ptr %i.r, align 8, !tbaa !16
  %i.s = load double, ptr %5, align 8, !tbaa !16
  %i.t = fadd double %i.s, %.pre
  store double %i.t, ptr %5, align 8, !tbaa !16
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %6, ptr noundef nonnull align 8 dereferenceable(16) %5, i64 16, i1 false), !tbaa.struct !194
  %i.u = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.v = load <2 x double>, ptr %i.u, align 8, !tbaa !16
  %i.w = load <2 x double>, ptr %6, align 16, !tbaa !16
  %i.x = fadd <2 x double> %i.w, %i.v
  store <2 x double> %i.x, ptr %6, align 16, !tbaa !16
  call void @llvm.lifetime.start.p0(ptr nonnull %7) #5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %7, ptr noundef nonnull align 16 dereferenceable(16) %6, i64 16, i1 false), !tbaa.struct !194
  %i.y = getelementptr inbounds nuw i8, ptr %0, i64 48
  %.pre146 = load double, ptr %i.y, align 8, !tbaa !16
  %i.z = getelementptr inbounds nuw i8, ptr %7, i64 8 ; 4 uses
  %i.aa = load double, ptr %i.z, align 8, !tbaa !16
  %i.ab = fadd double %i.aa, %.pre146
  store double %i.ab, ptr %i.z, align 8, !tbaa !16
  %.not73137 = icmp ult i32 %i.c, 12
  br i1 %.not73137, label %._crit_edge, label %.lr.ph
...
bb.b:                                             ; preds = %.lr.ph, %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit106
  ...
  call void @_ZN25cff1_path_procs_extents_t5curveERN3CFF20cff1_cs_interp_env_tER20cff1_extents_param_tRKNS0_7point_tES7_S7_(ptr noundef nonnull align 8 dereferenceable(4481) %0, ptr noundef nonnull align 8 dereferenceable(48) %1, ptr noundef nonnull align 8 dereferenceable(16) %5, ptr noundef nonnull align 8 dereferenceable(16) %6, ptr noundef nonnull align 8 dereferenceable(16) %7)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %5, ptr noundef nonnull align 8 dereferenceable(16) %i.q, i64 16, i1 false), !tbaa.struct !194
  %i.am = load i32, ptr %i.b, align 4, !tbaa !103 ; 4 uses
  %.not.i.i83 = icmp ult i32 %.0138, %i.am
  br i1 %.not.i.i83, label %bb.d, label %bb.c, !prof !51
...
_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit88: ; preds = %bb.e, %bb.f
  ...
  br i1 %.not.i.i89, label %bb.h, label %bb.g, !prof !51
...
bb.h:                                             ; preds = %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit88
  ...
  %.pre148 = load double, ptr %i.ax, align 8, !tbaa !16
  br label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit91

_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit91: ; preds = %bb.g, %bb.h
  %i.ay = phi double [ %i.ag, %bb.g ], [ %.pre148, %bb.h ]
  %i.az = load double, ptr %.0.i.i87, align 8, !tbaa !16
  %i.ba = load <2 x double>, ptr %6, align 16, !tbaa !16
  ...
  store <2 x double> %i.bd, ptr %6, align 16, !tbaa !16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %7, ptr noundef nonnull align 16 dereferenceable(16) %6, i64 16, i1 false), !tbaa.struct !194
  %i.be = or disjoint i32 %.0138, 3               ; 2 uses
  %.not.i.i92 = icmp ult i32 %i.be, %i.am
  br i1 %.not.i.i92, label %bb.j, label %bb.i, !prof !51
...
begin_hunk_2_@_ZN3CFF12path_procs_tI25cff1_path_procs_extents_tNS_20cff1_cs_interp_env_tE20cff1_extents_param_tE9hvcurvetoERS2_RS3_:bb.a
  %i.ch = load double, ptr %i.z, align 8, !tbaa !16
  %i.ci = fadd double %i.ch, %i.cg
  store double %i.ci, ptr %i.z, align 8, !tbaa !16
  %i.cj = add i32 %i.al, 8                        ; 2 uses
  %.not73 = icmp ugt i32 %i.cj, %i.bl
  br i1 %.not73, label %._crit_edge, label %bb.b, !llvm.loop !202
...
_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit109: ; preds = %._crit_edge
  ...
  %i.cn = zext i32 %.0.lcssa to i64
  %i.co = getelementptr inbounds nuw [8 x i8], ptr %i.cm, i64 %i.cn
  %i.cp = load double, ptr %7, align 8, !tbaa !16
  %i.cq = load double, ptr %i.co, align 8, !tbaa !16
  %i.cr = fadd double %i.cp, %i.cq
  store double %i.cr, ptr %7, align 8, !tbaa !16
  br label %bb.s
...
bb.v:                                             ; preds = %bb.t
  ...
  %.pre153 = load double, ptr %i.cv, align 8, !tbaa !16
  br label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit112

_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit112: ; preds = %bb.u, %bb.v
  %i.cw = phi double [ %i.j, %bb.u ], [ %.pre153, %bb.v ]
  %i.cx = load double, ptr %2, align 8, !tbaa !16
  %i.cy = fadd double %i.cx, %i.cw
  store double %i.cy, ptr %2, align 8, !tbaa !16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %3, ptr noundef nonnull align 8 dereferenceable(16) %2, i64 16, i1 false), !tbaa.struct !194
...
bb.z:                                             ; preds = %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit115
  ...
  %.pre154 = load double, ptr %i.de, align 8, !tbaa !16
  br label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit118

_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit118: ; preds = %bb.y, %bb.z
  %i.df = phi double [ %i.k, %bb.y ], [ %.pre154, %bb.z ]
  %i.dg = load double, ptr %.0.i.i114, align 8, !tbaa !16
  %i.dh = load <2 x double>, ptr %3, align 16, !tbaa !16
  ...
  store <2 x double> %i.dk, ptr %3, align 16, !tbaa !16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %4, ptr noundef nonnull align 16 dereferenceable(16) %3, i64 16, i1 false), !tbaa.struct !194
...
bb.ab:                                            ; preds = %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit118
  ...
  %.pre155 = load double, ptr %i.dn, align 8, !tbaa !16
  br label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit121

_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit121: ; preds = %bb.aa, %bb.ab
  %i.do = phi double [ %i.l, %bb.aa ], [ %.pre155, %bb.ab ]
  %i.dp = load double, ptr %i.h, align 8, !tbaa !16
  %i.dq = fadd double %i.dp, %i.do
  store double %i.dq, ptr %i.h, align 8, !tbaa !16
  call void @_ZN25cff1_path_procs_extents_t5curveERN3CFF20cff1_cs_interp_env_tER20cff1_extents_param_tRKNS0_7point_tES7_S7_(ptr noundef nonnull align 8 dereferenceable(4481) %0, ptr noundef nonnull align 8 dereferenceable(48) %1, ptr noundef nonnull align 8 dereferenceable(16) %2, ptr noundef nonnull align 8 dereferenceable(16) %3, ptr noundef nonnull align 8 dereferenceable(16) %4)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %2, ptr noundef nonnull align 8 dereferenceable(16) %4, i64 16, i1 false), !tbaa.struct !194
  %i.dr = or disjoint i32 %.1141, 4               ; 2 uses
  %i.ds = load i32, ptr %i.b, align 4, !tbaa !103 ; 7 uses
...
bb.ad:                                            ; preds = %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit121
  ...
  %.pre156 = load double, ptr %i.du, align 8, !tbaa !16
  br label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit124

_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit124: ; preds = %bb.ac, %bb.ad
  %i.dv = phi double [ %i.m, %bb.ac ], [ %.pre156, %bb.ad ]
  %i.dw = load double, ptr %i.i, align 8, !tbaa !16
  %i.dx = fadd double %i.dw, %i.dv
  store double %i.dx, ptr %i.i, align 8, !tbaa !16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %3, ptr noundef nonnull align 8 dereferenceable(16) %2, i64 16, i1 false), !tbaa.struct !194
...
bb.ah:                                            ; preds = %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit127
  ...
  %.pre157 = load double, ptr %i.ed, align 8, !tbaa !16
  br label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit130

_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit130: ; preds = %bb.ag, %bb.ah
  %i.ee = phi double [ %i.n, %bb.ag ], [ %.pre157, %bb.ah ]
  %i.ef = load double, ptr %.0.i.i126, align 8, !tbaa !16
  %i.eg = load <2 x double>, ptr %3, align 16, !tbaa !16
  ...
  store <2 x double> %i.ej, ptr %3, align 16, !tbaa !16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %4, ptr noundef nonnull align 16 dereferenceable(16) %3, i64 16, i1 false), !tbaa.struct !194
...
bb.aj:                                            ; preds = %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit130
  ...
  %.pre158 = load double, ptr %i.em, align 8, !tbaa !16
  br label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit133

_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit133: ; preds = %bb.ai, %bb.aj
  %i.en = phi double [ %i.o, %bb.ai ], [ %.pre158, %bb.aj ]
  %i.eo = load double, ptr %4, align 8, !tbaa !16
  %i.ep = fadd double %i.eo, %i.en
  store double %i.ep, ptr %4, align 8, !tbaa !16
  %i.eq = sub i32 %i.ds, %.1141
  %8 = icmp ult i32 %i.eq, 16
  %.not72 = trunc i32 %i.ds to i1
  %or.cond = and i1 %8, %.not72
  br i1 %or.cond, label %bb.ak, label %bb.an
...
bb.am:                                            ; preds = %bb.ak
  ...
  %.pre159 = load double, ptr %i.es, align 8, !tbaa !16
  br label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit136

_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit136: ; preds = %bb.al, %bb.am
  %i.et = phi double [ %i.p, %bb.al ], [ %.pre159, %bb.am ]
  %i.eu = load double, ptr %i.h, align 8, !tbaa !16
  %i.ev = fadd double %i.eu, %i.et
  store double %i.ev, ptr %i.h, align 8, !tbaa !16
  br label %bb.an

bb.an:                                            ; preds = %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit136, %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit133
  call void @_ZN25cff1_path_procs_extents_t5curveERN3CFF20cff1_cs_interp_env_tER20cff1_extents_param_tRKNS0_7point_tES7_S7_(ptr noundef nonnull align 8 dereferenceable(4481) %0, ptr noundef nonnull align 8 dereferenceable(48) %1, ptr noundef nonnull align 8 dereferenceable(16) %2, ptr noundef nonnull align 8 dereferenceable(16) %3, ptr noundef nonnull align 8 dereferenceable(16) %4)
  %i.ew = add i32 %i.ct, 8                        ; 2 uses
  %i.ex = load i32, ptr %i.b, align 4, !tbaa !103 ; 2 uses
  %.not71 = icmp ugt i32 %i.ew, %i.ex
  br i1 %.not71, label %.loopexit, label %bb.t, !llvm.loop !203
...
bb.a:
  ...
  br i1 %i.c, label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit29, label %bb.b, !prof !51

_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit29: ; preds = %bb.a
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #5
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 4448
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %2, ptr noundef nonnull align 8 dereferenceable(16) %i.d, i64 16, i1 false), !tbaa.struct !194
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.f = load double, ptr %2, align 8, !tbaa !16
  %i.g = load double, ptr %i.e, align 8, !tbaa !16
  %i.h = fadd double %i.f, %i.g
  store double %i.h, ptr %2, align 8, !tbaa !16
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %3, ptr noundef nonnull align 8 dereferenceable(16) %2, i64 16, i1 false), !tbaa.struct !194
  %i.i = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.j = load <2 x double>, ptr %i.i, align 8, !tbaa !16
  %i.k = load <2 x double>, ptr %3, align 16, !tbaa !16
  %i.l = fadd <2 x double> %i.k, %i.j
  store <2 x double> %i.l, ptr %3, align 16, !tbaa !16
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %4, ptr noundef nonnull align 16 dereferenceable(16) %3, i64 16, i1 false), !tbaa.struct !194
  %i.m = getelementptr inbounds nuw i8, ptr %0, i64 48
  %.pre30 = load double, ptr %i.m, align 8, !tbaa !16
  %i.n = load double, ptr %4, align 8, !tbaa !16
  %i.o = fadd double %i.n, %.pre30
  store double %i.o, ptr %4, align 8, !tbaa !16
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %5, ptr noundef nonnull align 8 dereferenceable(16) %4, i64 16, i1 false), !tbaa.struct !194
  %i.p = getelementptr inbounds nuw i8, ptr %0, i64 56
  %.pre31 = load double, ptr %i.p, align 8, !tbaa !16
  %i.q = load double, ptr %5, align 8, !tbaa !16
  %i.r = fadd double %i.q, %.pre31
  store double %i.r, ptr %5, align 8, !tbaa !16
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %6, ptr noundef nonnull align 8 dereferenceable(16) %5, i64 16, i1 false), !tbaa.struct !194
  %i.s = getelementptr inbounds nuw i8, ptr %0, i64 64
  %.pre32 = load double, ptr %i.s, align 8, !tbaa !16
  %i.t = load double, ptr %6, align 8, !tbaa !16
  %i.u = fadd double %i.t, %.pre32
  store double %i.u, ptr %6, align 8, !tbaa !16
  %i.v = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.w = getelementptr inbounds nuw i8, ptr %6, i64 8
  %i.x = load i64, ptr %i.v, align 8, !tbaa !107
  store i64 %i.x, ptr %i.w, align 8, !tbaa !107
  call void @llvm.lifetime.start.p0(ptr nonnull %7) #5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %7, ptr noundef nonnull align 8 dereferenceable(16) %6, i64 16, i1 false), !tbaa.struct !194
  %i.y = getelementptr inbounds nuw i8, ptr %0, i64 72
  %.pre33 = load double, ptr %i.y, align 8, !tbaa !16
  %i.z = load double, ptr %7, align 8, !tbaa !16
  %i.aa = fadd double %i.z, %.pre33
  store double %i.aa, ptr %7, align 8, !tbaa !16
  call void @_ZN25cff1_path_procs_extents_t5curveERN3CFF20cff1_cs_interp_env_tER20cff1_extents_param_tRKNS0_7point_tES7_S7_(ptr noundef nonnull align 8 dereferenceable(4481) %0, ptr noundef nonnull align 8 dereferenceable(48) %1, ptr noundef nonnull align 8 dereferenceable(16) %2, ptr noundef nonnull align 8 dereferenceable(16) %3, ptr noundef nonnull align 8 dereferenceable(16) %4)
  call void @_ZN25cff1_path_procs_extents_t5curveERN3CFF20cff1_cs_interp_env_tER20cff1_extents_param_tRKNS0_7point_tES7_S7_(ptr noundef nonnull align 8 dereferenceable(4481) %0, ptr noundef nonnull align 8 dereferenceable(48) %1, ptr noundef nonnull align 8 dereferenceable(16) %5, ptr noundef nonnull align 8 dereferenceable(16) %6, ptr noundef nonnull align 8 dereferenceable(16) %7)
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #5
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #5
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.ac = load i32, ptr %i.ab, align 8, !tbaa !109
  %i.ad = add i32 %i.ac, 1
...
bb.a:
  ...
  br i1 %i.c, label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit49, label %bb.b, !prof !51

_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit49: ; preds = %bb.a
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #5
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 4448
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %2, ptr noundef nonnull align 8 dereferenceable(16) %i.d, i64 16, i1 false), !tbaa.struct !194
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.f = load <2 x double>, ptr %i.e, align 8, !tbaa !16
  %i.g = load <2 x double>, ptr %2, align 16, !tbaa !16
  %i.h = fadd <2 x double> %i.g, %i.f
  store <2 x double> %i.h, ptr %2, align 16, !tbaa !16
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %3, ptr noundef nonnull align 16 dereferenceable(16) %2, i64 16, i1 false), !tbaa.struct !194
  ...
  %i.n = load <2 x double>, ptr %i.m, align 8, !tbaa !16
  %i.o = load <2 x double>, ptr %4, align 16, !tbaa !16
  %i.p = fadd <2 x double> %i.o, %i.n
  store <2 x double> %i.p, ptr %4, align 16, !tbaa !16
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %5, ptr noundef nonnull align 16 dereferenceable(16) %4, i64 16, i1 false), !tbaa.struct !194
  %i.q = getelementptr inbounds nuw i8, ptr %0, i64 72
  %i.r = load <2 x double>, ptr %i.q, align 8, !tbaa !16
  %i.s = load <2 x double>, ptr %5, align 16, !tbaa !16
  %i.t = fadd <2 x double> %i.s, %i.r
  store <2 x double> %i.t, ptr %5, align 16, !tbaa !16
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %6, ptr noundef nonnull align 16 dereferenceable(16) %5, i64 16, i1 false), !tbaa.struct !194
  ...
  store <2 x double> %i.x, ptr %6, align 16, !tbaa !16
  call void @llvm.lifetime.start.p0(ptr nonnull %7) #5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %7, ptr noundef nonnull align 16 dereferenceable(16) %6, i64 16, i1 false), !tbaa.struct !194
  %i.y = getelementptr inbounds nuw i8, ptr %0, i64 104
  %i.z = load <2 x double>, ptr %i.y, align 8, !tbaa !16
  %i.aa = load <2 x double>, ptr %7, align 16, !tbaa !16
  %i.ab = fadd <2 x double> %i.aa, %i.z
  store <2 x double> %i.ab, ptr %7, align 16, !tbaa !16
  call void @_ZN25cff1_path_procs_extents_t5curveERN3CFF20cff1_cs_interp_env_tER20cff1_extents_param_tRKNS0_7point_tES7_S7_(ptr noundef nonnull align 8 dereferenceable(4481) %0, ptr noundef nonnull align 8 dereferenceable(48) %1, ptr noundef nonnull align 8 dereferenceable(16) %2, ptr noundef nonnull align 8 dereferenceable(16) %3, ptr noundef nonnull align 8 dereferenceable(16) %4)
  call void @_ZN25cff1_path_procs_extents_t5curveERN3CFF20cff1_cs_interp_env_tER20cff1_extents_param_tRKNS0_7point_tES7_S7_(ptr noundef nonnull align 8 dereferenceable(4481) %0, ptr noundef nonnull align 8 dereferenceable(48) %1, ptr noundef nonnull align 8 dereferenceable(16) %5, ptr noundef nonnull align 8 dereferenceable(16) %6, ptr noundef nonnull align 8 dereferenceable(16) %7)
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #5
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #5
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.ad = load i32, ptr %i.ac, align 8, !tbaa !109
  %i.ae = add i32 %i.ad, 1
  %i.af = getelementptr inbounds nuw i8, ptr %0, i64 12
  store i32 %i.ae, ptr %i.af, align 4, !tbaa !68
  br label %bb.c
...
_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit112: ; preds = %bb.ag, %bb.ah
  ...
  br i1 %.not.i.i113, label %bb.aj, label %bb.ai, !prof !51
...
_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit115: ; preds = %bb.ai, %bb.aj
  ...
  br i1 %.not.i.i116, label %bb.al, label %bb.ak, !prof !51
...
_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit118: ; preds = %bb.ak, %bb.al
  ...
  br i1 %.not.i.i119, label %bb.an, label %bb.am, !prof !51
...
bb.an:                                            ; preds = %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit118
  ...
  %.pre311 = load double, ptr %i.hx, align 8, !tbaa !16
  br label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit121
...
_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit121: ; preds = %bb.am, %bb.an
  ...
  %i.ia = load ptr, ptr %i.h, align 8, !tbaa !122 ; 2 uses
...
bb.ao:                                            ; preds = %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit121
  %i.if = load <2 x double>, ptr %i.ia, align 8, !tbaa !16 ; 3 uses
...
bb.ap:                                            ; preds = %bb.ao, %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit121
  ...
  %i.im = load ptr, ptr %i.i, align 8, !tbaa !115 ; 4 uses
  %i.in = load ptr, ptr %1, align 8, !tbaa !121
  %i.io = getelementptr inbounds nuw i8, ptr %i.in, i64 80
  %i.ip = load <2 x float>, ptr %i.io, align 8, !tbaa !19 ; 3 uses
  %i.iq = load ptr, ptr %i.im, align 8, !tbaa !125 ; 4 uses
  %i.ir = getelementptr inbounds nuw i8, ptr %i.im, i64 8
  %i.is = load ptr, ptr %i.ir, align 8, !tbaa !129 ; 2 uses
  %i.it = getelementptr inbounds nuw i8, ptr %i.im, i64 16 ; 3 uses
  %i.iu = load i32, ptr %i.it, align 8, !tbaa !130
  %.not.i.i194 = icmp eq i32 %i.iu, 0
  br i1 %.not.i.i194, label %bb.aq, label %_ZN15hb_draw_funcs_t8cubic_toEPvR15hb_draw_state_tffffff.exit.i195, !prof !49
...
_ZN15hb_draw_funcs_t8cubic_toEPvR15hb_draw_state_tffffff.exit.i195: ; preds = %bb.aq, %bb.ap
  ...
  %i.iw = load ptr, ptr %i.iv, align 8, !tbaa !211
  %i.ix = getelementptr inbounds nuw i8, ptr %i.iq, i64 56
  %i.iy = load ptr, ptr %i.ix, align 8, !tbaa !144 ; 2 uses
...
bb.ar:                                            ; preds = %_ZN15hb_draw_funcs_t8cubic_toEPvR15hb_draw_state_tffffff.exit.i195
  ...
  %i.ja = load ptr, ptr %i.iz, align 8, !tbaa !212
...
_ZN17cff1_path_param_t8cubic_toERKN3CFF7point_tES3_S3_.exit197: ; preds = %_ZN15hb_draw_funcs_t8cubic_toEPvR15hb_draw_state_tffffff.exit.i195, %bb.ar
  ...
  tail call void %i.iw(ptr noundef nonnull align 8 dereferenceable(72) %i.iq, ptr noundef %i.is, ptr noundef nonnull align 4 dereferenceable(48) %i.it, float noundef %i.jm, float noundef %i.jn, float noundef %i.jf, float noundef %i.jl, float noundef %i.jk, float noundef %i.jl, ptr noundef %i.jb) #5, !inline_history !213
  store <2 x float> %i.jj, ptr %i.ji, align 4, !tbaa !19
  store double %i.hz, ptr %i.e, align 8, !tbaa !107
  store double %i.hu, ptr %.sroa.11.0..sroa_idx, align 8, !tbaa !107
  %i.jo = or disjoint i32 %.1290, 4               ; 2 uses
  %i.jp = load i32, ptr %i.b, align 4, !tbaa !103 ; 7 uses
  %.not.i.i122 = icmp ult i32 %i.jo, %i.jp
  br i1 %.not.i.i122, label %bb.at, label %bb.as, !prof !51
...
bb.at:                                            ; preds = %_ZN17cff1_path_param_t8cubic_toERKN3CFF7point_tES3_S3_.exit197
  ...
  %.pre312 = load double, ptr %i.jr, align 8, !tbaa !16
  br label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit124
...
_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit124: ; preds = %bb.as, %bb.at
  ...
  br i1 %.not.i.i125, label %bb.av, label %bb.au, !prof !51
...
_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit127: ; preds = %bb.au, %bb.av
  ...
  br i1 %.not.i.i128, label %bb.ax, label %bb.aw, !prof !51
...
_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit130: ; preds = %bb.aw, %bb.ax
  ...
  br i1 %.not.i.i131, label %bb.az, label %bb.ay, !prof !51
...
bb.az:                                            ; preds = %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit130
  ...
  %.pre314 = load double, ptr %i.kg, align 8, !tbaa !16
  br label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit133
...
_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit133: ; preds = %bb.ay, %bb.az
  ...
  %.not72 = trunc i32 %i.jp to i1
  %or.cond = and i1 %2, %.not72
...
bb.ba:                                            ; preds = %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit133
  ...
  br i1 %.not.i.i134, label %bb.bc, label %bb.bb, !prof !51
...
bb.bc:                                            ; preds = %bb.ba
  ...
  %.pre315 = load double, ptr %i.kl, align 8, !tbaa !16
  br label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit136
...
bb.bd:                                            ; preds = %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit136, %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit133
  ...
  %i.ko = load ptr, ptr %i.h, align 8, !tbaa !122 ; 2 uses
...
bb.be:                                            ; preds = %bb.bd
  %i.kv = load <2 x double>, ptr %i.ko, align 8, !tbaa !16 ; 2 uses
...
bb.bf:                                            ; preds = %bb.be, %bb.bd
  ...
  %i.lb = load ptr, ptr %i.i, align 8, !tbaa !115 ; 4 uses
  %i.lc = load ptr, ptr %1, align 8, !tbaa !121
  %i.ld = getelementptr inbounds nuw i8, ptr %i.lc, i64 80
  %i.le = load <2 x float>, ptr %i.ld, align 8, !tbaa !19 ; 2 uses
  %i.lf = load ptr, ptr %i.lb, align 8, !tbaa !125 ; 4 uses
  %i.lg = getelementptr inbounds nuw i8, ptr %i.lb, i64 8
  %i.lh = load ptr, ptr %i.lg, align 8, !tbaa !129 ; 2 uses
  %i.li = getelementptr inbounds nuw i8, ptr %i.lb, i64 16 ; 3 uses
  %i.lj = load i32, ptr %i.li, align 8, !tbaa !130
  %.not.i.i214 = icmp eq i32 %i.lj, 0
  br i1 %.not.i.i214, label %bb.bg, label %_ZN15hb_draw_funcs_t8cubic_toEPvR15hb_draw_state_tffffff.exit.i215, !prof !49
...
_ZN15hb_draw_funcs_t8cubic_toEPvR15hb_draw_state_tffffff.exit.i215: ; preds = %bb.bg, %bb.bf
  ...
  %i.ll = load ptr, ptr %i.lk, align 8, !tbaa !211
  %i.lm = getelementptr inbounds nuw i8, ptr %i.lf, i64 56
  %i.ln = load ptr, ptr %i.lm, align 8, !tbaa !144 ; 2 uses
...
bb.bh:                                            ; preds = %_ZN15hb_draw_funcs_t8cubic_toEPvR15hb_draw_state_tffffff.exit.i215
  ...
  %i.lp = load ptr, ptr %i.lo, align 8, !tbaa !212
...
_ZN17cff1_path_param_t8cubic_toERKN3CFF7point_tES3_S3_.exit217: ; preds = %_ZN15hb_draw_funcs_t8cubic_toEPvR15hb_draw_state_tffffff.exit.i215, %bb.bh
  ...
  tail call void %i.ll(ptr noundef nonnull align 8 dereferenceable(72) %i.lf, ptr noundef %i.lh, ptr noundef nonnull align 4 dereferenceable(48) %i.li, float noundef %i.mb, float noundef %i.mc, float noundef %i.lz, float noundef %i.ma, float noundef %i.lx, float noundef %i.ly, ptr noundef %i.lq) #5, !inline_history !213
  store <2 x float> %i.lw, ptr %i.lv, align 4, !tbaa !19
  store double %.sroa.0254.0, ptr %i.e, align 8, !tbaa !107
  store double %i.ki, ptr %.sroa.11.0..sroa_idx, align 8, !tbaa !107
  %i.md = add i32 %i.hg, 8                        ; 2 uses
  %i.me = load i32, ptr %i.b, align 4, !tbaa !103 ; 2 uses
...
.lr.ph290:                                        ; preds = %.preheader
  ...
  %.sroa.0274.0.copyload.pre = load double, ptr %i.e, align 8, !tbaa !107
  %.sroa.11.0.copyload.pre = load double, ptr %.sroa.11.0..sroa_idx, align 8, !tbaa !107
  %i.j = bitcast i64 %i.f to double
  %i.k = bitcast i64 %i.f to double
  %i.l = bitcast i64 %i.f to double
  %i.m = bitcast i64 %i.f to double
...
_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit82: ; preds = %bb.a
  ...
  %.sroa.0249.0.copyload = load double, ptr %i.q, align 8, !tbaa !107
  %.sroa.15.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 4456 ; 4 uses
  %.sroa.15.0.copyload = load double, ptr %.sroa.15.0..sroa_idx, align 8, !tbaa !107 ; 3 uses
  %i.r = getelementptr inbounds nuw i8, ptr %0, i64 24
  %.pre = load double, ptr %i.r, align 8, !tbaa !16
  %i.s = fadd double %.sroa.0249.0.copyload, %.pre ; 3 uses
  %i.t = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.u = getelementptr inbounds nuw i8, ptr %0, i64 40
  %.pre298 = load double, ptr %i.u, align 8, !tbaa !16
  %i.v = load double, ptr %i.t, align 8, !tbaa !16
  %i.w = fadd double %i.s, %i.v                   ; 2 uses
  %i.x = fadd double %.sroa.15.0.copyload, %.pre298 ; 3 uses
  %i.y = getelementptr inbounds nuw i8, ptr %0, i64 48
  %.pre299 = load double, ptr %i.y, align 8, !tbaa !16
...
bb.b:                                             ; preds = %.lr.ph, %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit106
  ...
  %i.al = load ptr, ptr %i.aa, align 8, !tbaa !122 ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  %i.ao = load <2 x double>, ptr %i.al, align 8, !tbaa !16 ; 3 uses
...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  %i.aw = load ptr, ptr %i.ab, align 8, !tbaa !115 ; 5 uses
  %i.ax = load ptr, ptr %1, align 8, !tbaa !121
  %i.ay = getelementptr inbounds nuw i8, ptr %i.ax, i64 80
  %i.az = load <2 x float>, ptr %i.ay, align 8, !tbaa !19 ; 3 uses
  %i.ba = load ptr, ptr %i.aw, align 8, !tbaa !125 ; 4 uses
  %i.bb = getelementptr inbounds nuw i8, ptr %i.aw, i64 8
  %i.bc = load ptr, ptr %i.bb, align 8, !tbaa !129 ; 2 uses
  ...
  br i1 %.not.i.i137, label %bb.e, label %_ZN15hb_draw_funcs_t8cubic_toEPvR15hb_draw_state_tffffff.exit.i, !prof !49
...
bb.f:                                             ; preds = %_ZN15hb_draw_funcs_t8cubic_toEPvR15hb_draw_state_tffffff.exit.i
  ...
  %i.bk = load ptr, ptr %i.bj, align 8, !tbaa !212
...
bb.al:                                            ; preds = %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit115
  %i.hp = zext i32 %i.ho to i64
  %i.hq = getelementptr inbounds nuw [8 x i8], ptr %i.g, i64 %i.hp
  %.pre309 = load double, ptr %i.hq, align 8, !tbaa !16
  br label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit118
...
bb.an:                                            ; preds = %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit118
  %i.hw = zext i32 %i.hv to i64
  %i.hx = getelementptr inbounds nuw [8 x i8], ptr %i.g, i64 %i.hw
  %.pre310 = load double, ptr %i.hx, align 8, !tbaa !16
  br label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit121
...
_ZN17cff1_path_param_t8cubic_toERKN3CFF7point_tES3_S3_.exit197: ; preds = %_ZN15hb_draw_funcs_t8cubic_toEPvR15hb_draw_state_tffffff.exit.i195, %bb.ar
  ...
  %i.jm = extractelement <2 x float> %i.jh, i64 0
  %i.jn = extractelement <2 x float> %i.jh, i64 1
  tail call void %i.iw(ptr noundef nonnull align 8 dereferenceable(72) %i.iq, ptr noundef %i.is, ptr noundef nonnull align 4 dereferenceable(48) %i.it, float noundef %i.jm, float noundef %i.jn, float noundef %i.jk, float noundef %i.jf, float noundef %i.jk, float noundef %i.jl, ptr noundef %i.jb) #5, !inline_history !213
  store <2 x float> %i.jj, ptr %i.ji, align 4, !tbaa !19
  store double %i.ht, ptr %i.e, align 8, !tbaa !107
  store double %i.hz, ptr %.sroa.11.0..sroa_idx, align 8, !tbaa !107
...
bb.at:                                            ; preds = %_ZN17cff1_path_param_t8cubic_toERKN3CFF7point_tES3_S3_.exit197
  %i.jq = zext i32 %i.jo to i64
  %i.jr = getelementptr inbounds nuw [8 x i8], ptr %i.g, i64 %i.jq
  %.pre311 = load double, ptr %i.jr, align 8, !tbaa !16
  br label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit124
...
bb.ax:                                            ; preds = %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit127
  %i.jy = zext i32 %i.jx to i64
  %i.jz = getelementptr inbounds nuw [8 x i8], ptr %i.g, i64 %i.jy
  %.pre312 = load double, ptr %i.jz, align 8, !tbaa !16
  br label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit130
...
bb.az:                                            ; preds = %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit130
  %i.kf = zext i32 %i.ke to i64
  %i.kg = getelementptr inbounds nuw [8 x i8], ptr %i.g, i64 %i.kf
  %.pre313 = load double, ptr %i.kg, align 8, !tbaa !16
  br label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit133
...
bb.bc:                                            ; preds = %bb.ba
  %i.kk = zext i32 %i.hg to i64
  %i.kl = getelementptr inbounds nuw [8 x i8], ptr %i.g, i64 %i.kk
  %.pre314 = load double, ptr %i.kl, align 8, !tbaa !16
  br label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit136
...
_ZN17cff1_path_param_t8cubic_toERKN3CFF7point_tES3_S3_.exit217: ; preds = %_ZN15hb_draw_funcs_t8cubic_toEPvR15hb_draw_state_tffffff.exit.i215, %bb.bh
  ...
  tail call void %i.ll(ptr noundef nonnull align 8 dereferenceable(72) %i.lf, ptr noundef %i.lh, ptr noundef nonnull align 4 dereferenceable(48) %i.li, float noundef %i.mb, float noundef %i.mc, float noundef %i.lz, float noundef %i.ma, float noundef %i.lx, float noundef %i.ly, ptr noundef %i.lq) #5, !inline_history !213
  store <2 x float> %i.lw, ptr %i.lv, align 4, !tbaa !19
  store double %i.ki, ptr %i.e, align 8, !tbaa !107
  store double %.sroa.12.0, ptr %.sroa.11.0..sroa_idx, align 8, !tbaa !107
  %i.md = add i32 %i.hg, 8                        ; 2 uses
  %i.me = load i32, ptr %i.b, align 4, !tbaa !103 ; 2 uses
  %.not71 = icmp ugt i32 %i.md, %i.me
...
bb.a:
  ...
  %i.b = load i32, ptr %i.a, align 4, !tbaa !103
  %i.c = icmp eq i32 %i.b, 7
  br i1 %i.c, label %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit29, label %bb.j, !prof !51

_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit29: ; preds = %bb.a
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 4448 ; 3 uses
  %.sroa.064.0.copyload = load double, ptr %i.d, align 8, !tbaa !107
  %.sroa.765.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 4456 ; 3 uses
  %.sroa.765.0.copyload = load double, ptr %.sroa.765.0..sroa_idx, align 8, !tbaa !107 ; 6 uses
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.f = load double, ptr %i.e, align 8, !tbaa !16
  %i.g = fadd double %.sroa.064.0.copyload, %i.f  ; 3 uses
  %i.h = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.i = getelementptr inbounds nuw i8, ptr %0, i64 40
  %.pre = load double, ptr %i.i, align 8, !tbaa !16
  %i.j = load double, ptr %i.h, align 8, !tbaa !16
  %i.k = fadd double %i.g, %i.j                   ; 3 uses
  %i.l = fadd double %.sroa.765.0.copyload, %.pre ; 5 uses
  %i.m = getelementptr inbounds nuw i8, ptr %0, i64 48
  %.pre66 = load double, ptr %i.m, align 8, !tbaa !16
  %i.n = fadd double %i.k, %.pre66                ; 4 uses
  %i.o = getelementptr inbounds nuw i8, ptr %0, i64 56
  %.pre67 = load double, ptr %i.o, align 8, !tbaa !16
  %i.p = fadd double %i.n, %.pre67                ; 3 uses
  %i.q = getelementptr inbounds nuw i8, ptr %0, i64 64
  %.pre68 = load double, ptr %i.q, align 8, !tbaa !16
  %i.r = fadd double %i.p, %.pre68                ; 3 uses
  %i.s = getelementptr inbounds nuw i8, ptr %0, i64 72
  %.pre69 = load double, ptr %i.s, align 8, !tbaa !16
...
bb.b:                                             ; preds = %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit29
  %i.w = load double, ptr %i.v, align 8, !tbaa !16 ; 3 uses
  %i.x = fadd double %i.g, %i.w
  %i.y = getelementptr inbounds nuw i8, ptr %i.v, i64 8
  %i.z = load double, ptr %i.y, align 8, !tbaa !16 ; 2 uses
...
bb.c:                                             ; preds = %bb.b, %_ZN3CFF12interp_env_tINS_8number_tEE8eval_argEj.exit29
  ...
  %i.ag = load ptr, ptr %1, align 8, !tbaa !121   ; 2 uses
  %i.ah = getelementptr inbounds nuw i8, ptr %i.ag, i64 80
  %i.ai = load float, ptr %i.ah, align 8, !tbaa !216 ; 3 uses
  %i.aj = getelementptr inbounds nuw i8, ptr %i.ag, i64 84
  %i.ak = load float, ptr %i.aj, align 4, !tbaa !232 ; 2 uses
  %i.al = load ptr, ptr %i.af, align 8, !tbaa !125 ; 4 uses
  ...
  br i1 %.not.i.i47, label %bb.d, label %_ZN15hb_draw_funcs_t8cubic_toEPvR15hb_draw_state_tffffff.exit.i48, !prof !49
...
_ZN15hb_draw_funcs_t8cubic_toEPvR15hb_draw_state_tffffff.exit.i48: ; preds = %bb.d, %bb.c
  ...
  %i.at = load ptr, ptr %i.as, align 8, !tbaa !144 ; 2 uses
...
bb.e:                                             ; preds = %_ZN15hb_draw_funcs_t8cubic_toEPvR15hb_draw_state_tffffff.exit.i48
  ...
  %i.av = load ptr, ptr %i.au, align 8, !tbaa !212
...
_ZN17cff1_path_param_t8cubic_toERKN3CFF7point_tES3_S3_.exit50: ; preds = %_ZN15hb_draw_funcs_t8cubic_toEPvR15hb_draw_state_tffffff.exit.i48, %bb.e
  ...
  tail call void %i.ar(ptr noundef nonnull align 8 dereferenceable(72) %i.al, ptr noundef %i.an, ptr noundef nonnull align 4 dereferenceable(48) %i.ao, float noundef %i.bg, float noundef %i.be, float noundef %i.bc, float noundef %i.ay, float noundef %i.ba, float noundef %i.ay, ptr noundef %i.aw) #5, !inline_history !213
  %i.bh = getelementptr inbounds nuw i8, ptr %i.af, i64 28
  store float %i.ba, ptr %i.bh, align 4, !tbaa !132
  %i.bi = getelementptr inbounds nuw i8, ptr %i.af, i64 32
  store float %i.ay, ptr %i.bi, align 8, !tbaa !134
  store double %i.n, ptr %i.d, align 8, !tbaa !107
  store double %i.l, ptr %.sroa.765.0..sroa_idx, align 8, !tbaa !107
  %i.bj = load ptr, ptr %i.u, align 8, !tbaa !122 ; 3 uses
...
bb.f:                                             ; preds = %_ZN17cff1_path_param_t8cubic_toERKN3CFF7point_tES3_S3_.exit50
  ...
  %i.bn = load double, ptr %i.bm, align 8, !tbaa !16 ; 2 uses
