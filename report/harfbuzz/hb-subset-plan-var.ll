...
_ZL10_tent_evalRK6Tripled.exit16.i:               ; preds = %bb.ap, %bb.ao, %bb.am, %bb.al, %bb.af, %_ZNK12hb_hashmap_tIj9hb_pair_tIddELb0EE3hasIS1_EEbRKjPPT_.exit216.thread
  ...
  %.0294.a = select i1 %i.mg, double %.0.i28.i, double %.0.i15.i
  %.sroa.speculated22.i = select i1 %i.ml, double %.sroa.speculated19.i, double 1.000000e+00
  %i.mm = insertelement <2 x double> poison, double %.sroa.speculated22.i, i64 0
  %i.mn = insertelement <2 x double> %i.mm, double %.0294.a, i64 1
