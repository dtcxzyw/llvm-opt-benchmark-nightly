...
_ZNK2OT19SparseVarRegionAxis8evaluateEPKij.exit.thread.i40: ; preds = %_ZNK2OT19SparseVarRegionAxis8evaluateEPKij.exit.i36, %bb.t, %bb.s, %bb.q
  ...
  br i1 %exitcond.not.i43, label %_ZNK2OT19SparseVarRegionList8evaluateEjPKijPNS_17hb_scalar_cache_tE.exit, label %bb.o, !llvm.loop !3174
...
_ZN2OT11TupleValues9fetcher_t10ensure_runEv.exit.thread.i: ; preds = %switch.lookup, %bb.v
  ...
  br i1 %.not.i46, label %_ZN2OT11TupleValues9fetcher_t4skipEj.exit, label %bb.v, !llvm.loop !3175
...
bb.w:                                             ; preds = %_ZN2OT11TupleValues9fetcher_t4skipEj.exit, %_ZNK2OT19SparseVarRegionList8evaluateEjPKijPNS_17hb_scalar_cache_tE.exit.thread
  ...
  br i1 %exitcond.not, label %._crit_edge, label %bb.b, !llvm.loop !3176
}
...
.lr.ph113:                                        ; preds = %bb.a
  ...
  %4 = shufflevector <4 x float> %broadcast.splatinsert201, <4 x float> poison, <8 x i32> zeroinitializer
  ...
  %5 = shufflevector <4 x float> %broadcast.splatinsert159, <4 x float> poison, <8 x i32> zeroinitializer
  %i.f = shufflevector <4 x float> %broadcast.splatinsert159, <4 x float> poison, <8 x i32> zeroinitializer
...
bb.b:                                             ; preds = %.lr.ph113, %bb.g
  %i.i = phi i32 [ %.pre, %.lr.ph113 ], [ %i.mt, %bb.g ] ; 2 uses
  %.068111 = phi i32 [ 0, %.lr.ph113 ], [ %i.mu, %bb.g ] ; 2 uses
...
vector.body161:                                   ; preds = %vector.body161, %vector.ph157
  ...
  %i.dt = insertelement <4 x float> poison, float %i.dp, i64 0
  %i.du = insertelement <4 x float> %i.dt, float %i.dq, i64 1
  %i.dv = insertelement <4 x float> %i.du, float %i.dr, i64 2
  %i.dw = insertelement <4 x float> %i.dv, float %i.ds, i64 3
  %i.dx = shufflevector <4 x float> %i.av, <4 x float> %i.bu, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.dy = shufflevector <4 x float> %i.bh, <4 x float> %i.cg, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.dz = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.dx, <8 x float> %5, <8 x float> %i.dy)
  %i.ea = shufflevector <4 x float> %i.ct, <4 x float> %i.do, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.eb = shufflevector <4 x float> %i.df, <4 x float> %i.dw, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.ec = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.ea, <8 x float> %i.f, <8 x float> %i.eb)
  %interleaved.vec = shufflevector <8 x float> %i.dz, <8 x float> %i.ec, <16 x i32> <i32 0, i32 4, i32 8, i32 12, i32 1, i32 5, i32 9, i32 13, i32 2, i32 6, i32 10, i32 14, i32 3, i32 7, i32 11, i32 15>
  store <16 x float> %interleaved.vec, ptr %next.gep167, align 4, !tbaa !304
  %index.next171 = add nuw i64 %index162, 4       ; 2 uses
  %i.ed = icmp eq i64 %index.next171, %n.vec158
  br i1 %i.ed, label %middle.block172, label %vector.body161, !llvm.loop !3178
...
.preheader.loopexit:                              ; preds = %.lr.ph99, %middle.block172
  %.lcssa146 = phi ptr [ %i.y, %middle.block172 ], [ %i.ex, %.lr.ph99 ]
  %.lcssa145 = phi ptr [ %i.aa, %middle.block172 ], [ %i.ey, %.lr.ph99 ]
  %i.ee = and i32 %.sroa.speculated, -4
  br label %.preheader
...
.preheader:                                       ; preds = %.preheader.loopexit, %bb.d
  ...
  %.064.lcssa = phi i32 [ 0, %bb.d ], [ %i.ee, %.preheader.loopexit ] ; 4 uses
  %i.ef = icmp ult i32 %.064.lcssa, %.sroa.speculated
  br i1 %i.ef, label %.lr.ph106.preheader, label %._crit_edge107

.lr.ph106.preheader:                              ; preds = %.preheader
  %i.eg = xor i32 %.064.lcssa, -1
  %i.eh = add i32 %.sroa.speculated, %i.eg        ; 2 uses
  %i.ei = zext i32 %i.eh to i64
  %i.ej = add nuw nsw i64 %i.ei, 1                ; 2 uses
  %min.iters.check = icmp ult i32 %i.eh, 7
  br i1 %min.iters.check, label %.lr.ph106.preheader241, label %vector.ph

vector.ph:                                        ; preds = %.lr.ph106.preheader
  %n.vec = and i64 %i.ej, 8589934584              ; 5 uses
  %i.ek = trunc i64 %n.vec to i32
  %i.el = add i32 %.064.lcssa, %i.ek
  %i.em = getelementptr i8, ptr %.066.lcssa, i64 %n.vec ; 2 uses
  %i.en = shl nuw nsw i64 %n.vec, 2
  %i.eo = getelementptr i8, ptr %.170.lcssa, i64 %i.en ; 2 uses
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 3 uses
  %next.gep = getelementptr i8, ptr %.066.lcssa, i64 %index ; 2 uses
  %i.ep = shl i64 %index, 2
  %next.gep149 = getelementptr i8, ptr %.170.lcssa, i64 %i.ep ; 3 uses
  %i.eq = getelementptr i8, ptr %next.gep, i64 4
  %wide.load = load <4 x i8>, ptr %next.gep, align 1, !tbaa !300
  %wide.load150 = load <4 x i8>, ptr %i.eq, align 1, !tbaa !300
  %i.er = sitofp <4 x i8> %wide.load to <4 x float>
  %i.es = sitofp <4 x i8> %wide.load150 to <4 x float>
  %i.et = getelementptr i8, ptr %next.gep149, i64 16 ; 2 uses
  %wide.load151 = load <4 x float>, ptr %next.gep149, align 4, !tbaa !304
  %wide.load152 = load <4 x float>, ptr %i.et, align 4, !tbaa !304
  %i.eu = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.er, <4 x float> %broadcast.splat, <4 x float> %wide.load151)
  %i.ev = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.es, <4 x float> %broadcast.splat, <4 x float> %wide.load152)
  store <4 x float> %i.eu, ptr %next.gep149, align 4, !tbaa !304
  store <4 x float> %i.ev, ptr %i.et, align 4, !tbaa !304
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.ew = icmp eq i64 %index.next, %n.vec
  br i1 %i.ew, label %middle.block, label %vector.body, !llvm.loop !3179
...
.lr.ph106.preheader241:                           ; preds = %.lr.ph106.preheader, %middle.block
  %.165105.ph = phi i32 [ %.064.lcssa, %.lr.ph106.preheader ], [ %i.el, %middle.block ]
  %.167104.ph = phi ptr [ %.066.lcssa, %.lr.ph106.preheader ], [ %i.em, %middle.block ]
  %.2103.ph = phi ptr [ %.170.lcssa, %.lr.ph106.preheader ], [ %i.eo, %middle.block ]
  br label %.lr.ph106

.lr.ph99:                                         ; preds = %.lr.ph99.preheader242, %.lr.ph99
  %.06497 = phi i32 [ %i.fd, %.lr.ph99 ], [ %.06497.ph, %.lr.ph99.preheader242 ]
  %.06696 = phi ptr [ %i.ex, %.lr.ph99 ], [ %.06696.ph, %.lr.ph99.preheader242 ] ; 2 uses
  %.17095 = phi ptr [ %i.ey, %.lr.ph99 ], [ %.17095.ph, %.lr.ph99.preheader242 ] ; 3 uses
  %i.ex = getelementptr inbounds nuw i8, ptr %.06696, i64 4 ; 2 uses
  %i.ey = getelementptr inbounds nuw i8, ptr %.17095, i64 16 ; 2 uses
  %i.ez = load <4 x i8>, ptr %.06696, align 1, !tbaa !300
  %i.fa = sitofp <4 x i8> %i.ez to <4 x float>
  %i.fb = load <4 x float>, ptr %.17095, align 4, !tbaa !304
  %i.fc = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.fa, <4 x float> %i.h, <4 x float> %i.fb)
  store <4 x float> %i.fc, ptr %.17095, align 4, !tbaa !304
  %i.fd = add nuw i32 %.06497, 4                  ; 2 uses
  %i.fe = or disjoint i32 %i.fd, 3
  %i.ff = icmp ult i32 %i.fe, %.sroa.speculated
  br i1 %i.ff, label %.lr.ph99, label %.preheader.loopexit, !llvm.loop !3180

.lr.ph106:                                        ; preds = %.lr.ph106.preheader241, %.lr.ph106
  %.165105 = phi i32 [ %i.fm, %.lr.ph106 ], [ %.165105.ph, %.lr.ph106.preheader241 ]
  %.167104 = phi ptr [ %i.fg, %.lr.ph106 ], [ %.167104.ph, %.lr.ph106.preheader241 ] ; 2 uses
  %.2103 = phi ptr [ %i.fj, %.lr.ph106 ], [ %.2103.ph, %.lr.ph106.preheader241 ] ; 3 uses
  %i.fg = getelementptr inbounds nuw i8, ptr %.167104, i64 1 ; 2 uses
  %i.fh = load i8, ptr %.167104, align 1, !tbaa !300
  %i.fi = sitofp i8 %i.fh to float
  %i.fj = getelementptr inbounds nuw i8, ptr %.2103, i64 4 ; 2 uses
  %i.fk = load float, ptr %.2103, align 4, !tbaa !304
  %i.fl = tail call float @llvm.fmuladd.f32(float %i.fi, float %3, float %i.fk)
  store float %i.fl, ptr %.2103, align 4, !tbaa !304
  %i.fm = add nuw i32 %.165105, 1                 ; 2 uses
  %exitcond128.not = icmp eq i32 %i.fm, %.sroa.speculated
  br i1 %exitcond128.not, label %._crit_edge107, label %.lr.ph106, !llvm.loop !3181

._crit_edge107:                                   ; preds = %.lr.ph106, %middle.block, %.preheader
  %.2.lcssa = phi ptr [ %.170.lcssa, %.preheader ], [ %i.eo, %middle.block ], [ %i.fj, %.lr.ph106 ]
  %.167.lcssa = phi ptr [ %.066.lcssa, %.preheader ], [ %i.em, %middle.block ], [ %i.fg, %.lr.ph106 ]
  store ptr %.167.lcssa, ptr %0, align 8, !tbaa !1516
  br label %bb.g

bb.e:                                             ; preds = %_ZN2OT11TupleValues9fetcher_t10ensure_runEv.exit.thread
  %i.fn = load ptr, ptr %0, align 8, !tbaa !1516  ; 7 uses
  %i.fo = icmp ugt i32 %.sroa.speculated, 3
  br i1 %i.fo, label %.lr.ph84.preheader, label %.preheader75

.lr.ph84.preheader:                               ; preds = %bb.e
  %i.fp = add i32 %.sroa.speculated, -4           ; 2 uses
  %i.fq = lshr i32 %i.fp, 2
  %narrow = add nuw nsw i32 %i.fq, 1
  %i.fr = zext nneg i32 %narrow to i64            ; 2 uses
  %min.iters.check198 = icmp ult i32 %i.fp, 12
  br i1 %min.iters.check198, label %.lr.ph84.preheader244, label %vector.ph199

vector.ph199:                                     ; preds = %.lr.ph84.preheader
  %n.vec200 = and i64 %i.fr, 2147483644           ; 5 uses
  %i.fs = trunc nuw nsw i64 %n.vec200 to i32
  %i.ft = shl i32 %i.fs, 2
  %i.fu = shl nuw nsw i64 %n.vec200, 3
  %i.fv = getelementptr i8, ptr %i.fn, i64 %i.fu  ; 2 uses
  %i.fw = shl nuw nsw i64 %n.vec200, 4
  %i.fx = getelementptr i8, ptr %.069110, i64 %i.fw ; 2 uses
...
vector.body203:                                   ; preds = %vector.body203, %vector.ph199
  ...
  %i.fy = shl i64 %index204, 3                    ; 4 uses
  %next.gep205 = getelementptr i8, ptr %i.fn, i64 %i.fy ; 4 uses
  %i.fz = getelementptr i8, ptr %i.fn, i64 %i.fy  ; 4 uses
  %next.gep206 = getelementptr i8, ptr %i.fz, i64 8
  %i.ga = getelementptr i8, ptr %i.fn, i64 %i.fy  ; 4 uses
  %next.gep207 = getelementptr i8, ptr %i.ga, i64 16
  %i.gb = getelementptr i8, ptr %i.fn, i64 %i.fy  ; 4 uses
  %next.gep208 = getelementptr i8, ptr %i.gb, i64 24
  %i.gc = shl i64 %index204, 4                    ; 4 uses
  %next.gep209 = getelementptr i8, ptr %.069110, i64 %i.gc ; 5 uses
  %i.gd = getelementptr i8, ptr %.069110, i64 %i.gc ; 4 uses
  %next.gep210 = getelementptr i8, ptr %i.gd, i64 16
  %i.ge = getelementptr i8, ptr %.069110, i64 %i.gc ; 4 uses
  %next.gep211 = getelementptr i8, ptr %i.ge, i64 32
  %i.gf = getelementptr i8, ptr %.069110, i64 %i.gc ; 4 uses
  %next.gep212 = getelementptr i8, ptr %i.gf, i64 48
  %i.gg = getelementptr inbounds nuw i8, ptr %next.gep205, i64 2
  %i.gh = getelementptr i8, ptr %i.fz, i64 10
  %i.gi = getelementptr i8, ptr %i.ga, i64 18
  %i.gj = getelementptr i8, ptr %i.gb, i64 26
  %i.gk = load i16, ptr %next.gep205, align 1, !tbaa !283
  %i.gl = load i16, ptr %next.gep206, align 1, !tbaa !283
  %i.gm = load i16, ptr %next.gep207, align 1, !tbaa !283
  %i.gn = load i16, ptr %next.gep208, align 1, !tbaa !283
  %i.go = insertelement <4 x i16> poison, i16 %i.gk, i64 0
  %i.gp = insertelement <4 x i16> %i.go, i16 %i.gl, i64 1
  %i.gq = insertelement <4 x i16> %i.gp, i16 %i.gm, i64 2
  %i.gr = insertelement <4 x i16> %i.gq, i16 %i.gn, i64 3
  %i.gs = tail call <4 x i16> @llvm.bswap.v4i16(<4 x i16> %i.gr)
  %i.gt = sitofp <4 x i16> %i.gs to <4 x float>
  %i.gu = getelementptr inbounds nuw i8, ptr %next.gep209, i64 4
  %i.gv = getelementptr i8, ptr %i.gd, i64 20
  %i.gw = getelementptr i8, ptr %i.ge, i64 36
  %i.gx = getelementptr i8, ptr %i.gf, i64 52
  %i.gy = load float, ptr %next.gep209, align 4, !tbaa !304
  %i.gz = load float, ptr %next.gep210, align 4, !tbaa !304
  %i.ha = load float, ptr %next.gep211, align 4, !tbaa !304
  %i.hb = load float, ptr %next.gep212, align 4, !tbaa !304
  ...
  %i.hg = getelementptr inbounds nuw i8, ptr %next.gep205, i64 4
  %i.hh = getelementptr i8, ptr %i.fz, i64 12
  %i.hi = getelementptr i8, ptr %i.ga, i64 20
  %i.hj = getelementptr i8, ptr %i.gb, i64 28
  %i.hk = load i16, ptr %i.gg, align 1, !tbaa !283
  %i.hl = load i16, ptr %i.gh, align 1, !tbaa !283
  %i.hm = load i16, ptr %i.gi, align 1, !tbaa !283
  %i.hn = load i16, ptr %i.gj, align 1, !tbaa !283
  %i.ho = insertelement <4 x i16> poison, i16 %i.hk, i64 0
  %i.hp = insertelement <4 x i16> %i.ho, i16 %i.hl, i64 1
  %i.hq = insertelement <4 x i16> %i.hp, i16 %i.hm, i64 2
  %i.hr = insertelement <4 x i16> %i.hq, i16 %i.hn, i64 3
  %i.hs = tail call <4 x i16> @llvm.bswap.v4i16(<4 x i16> %i.hr)
  %i.ht = sitofp <4 x i16> %i.hs to <4 x float>
  %i.hu = getelementptr inbounds nuw i8, ptr %next.gep209, i64 8
  %i.hv = getelementptr i8, ptr %i.gd, i64 24
  %i.hw = getelementptr i8, ptr %i.ge, i64 40
  %i.hx = getelementptr i8, ptr %i.gf, i64 56
  %i.hy = load float, ptr %i.gu, align 4, !tbaa !304
  ...
  %i.ig = getelementptr inbounds nuw i8, ptr %next.gep205, i64 6
  %i.ih = getelementptr i8, ptr %i.fz, i64 14
  %i.ii = getelementptr i8, ptr %i.ga, i64 22
  %i.ij = getelementptr i8, ptr %i.gb, i64 30
  %i.ik = load i16, ptr %i.hg, align 1, !tbaa !283
  %i.il = load i16, ptr %i.hh, align 1, !tbaa !283
  %i.im = load i16, ptr %i.hi, align 1, !tbaa !283
  %i.in = load i16, ptr %i.hj, align 1, !tbaa !283
  %i.io = insertelement <4 x i16> poison, i16 %i.ik, i64 0
  %i.ip = insertelement <4 x i16> %i.io, i16 %i.il, i64 1
  %i.iq = insertelement <4 x i16> %i.ip, i16 %i.im, i64 2
  %i.ir = insertelement <4 x i16> %i.iq, i16 %i.in, i64 3
  %i.is = tail call <4 x i16> @llvm.bswap.v4i16(<4 x i16> %i.ir)
  %i.it = sitofp <4 x i16> %i.is to <4 x float>
  %i.iu = getelementptr inbounds nuw i8, ptr %next.gep209, i64 12
  %i.iv = getelementptr i8, ptr %i.gd, i64 28
  %i.iw = getelementptr i8, ptr %i.ge, i64 44
  %i.ix = getelementptr i8, ptr %i.gf, i64 60
  %i.iy = load float, ptr %i.hu, align 4, !tbaa !304
  ...
  %i.jg = load i16, ptr %i.ig, align 1, !tbaa !283
  ...
  %i.jo = tail call <4 x i16> @llvm.bswap.v4i16(<4 x i16> %i.jn)
  %i.jp = sitofp <4 x i16> %i.jo to <4 x float>
  %i.jq = load float, ptr %i.iu, align 4, !tbaa !304
  ...
  %i.jx = insertelement <4 x float> %i.jw, float %i.jt, i64 3
  %i.jy = shufflevector <4 x float> %i.gt, <4 x float> %i.ht, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.jz = shufflevector <4 x float> %i.hf, <4 x float> %i.if, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.ka = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.jy, <8 x float> %4, <8 x float> %i.jz)
  %i.kb = shufflevector <4 x float> %i.it, <4 x float> %i.jp, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.kc = shufflevector <4 x float> %i.jf, <4 x float> %i.jx, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.kd = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.kb, <8 x float> %i.c, <8 x float> %i.kc)
  %interleaved.vec213 = shufflevector <8 x float> %i.ka, <8 x float> %i.kd, <16 x i32> <i32 0, i32 4, i32 8, i32 12, i32 1, i32 5, i32 9, i32 13, i32 2, i32 6, i32 10, i32 14, i32 3, i32 7, i32 11, i32 15>
  store <16 x float> %interleaved.vec213, ptr %next.gep209, align 4, !tbaa !304
  %index.next214 = add nuw i64 %index204, 4       ; 2 uses
  %i.ke = icmp eq i64 %index.next214, %n.vec200
  br i1 %i.ke, label %middle.block215, label %vector.body203, !llvm.loop !3182

middle.block215:                                  ; preds = %vector.body203
  %cmp.n216 = icmp eq i64 %n.vec200, %i.fr
...
.lr.ph84.preheader244:                            ; preds = %.lr.ph84.preheader, %middle.block215
  %.06182.ph = phi i32 [ 0, %.lr.ph84.preheader ], [ %i.ft, %middle.block215 ]
  %.06281.ph = phi ptr [ %i.fn, %.lr.ph84.preheader ], [ %i.fv, %middle.block215 ]
  %.380.ph = phi ptr [ %.069110, %.lr.ph84.preheader ], [ %i.fx, %middle.block215 ]
  br label %.lr.ph84

.preheader75.loopexit:                            ; preds = %.lr.ph84, %middle.block215
  %.lcssa142 = phi ptr [ %i.fv, %middle.block215 ], [ %i.lc, %.lr.ph84 ]
  %.lcssa141 = phi ptr [ %i.fx, %middle.block215 ], [ %i.ld, %.lr.ph84 ]
  %i.kf = and i32 %.sroa.speculated, -4
  br label %.preheader75

.preheader75:                                     ; preds = %.preheader75.loopexit, %bb.e
  %.3.lcssa = phi ptr [ %.069110, %bb.e ], [ %.lcssa141, %.preheader75.loopexit ] ; 4 uses
  %.062.lcssa = phi ptr [ %i.fn, %bb.e ], [ %.lcssa142, %.preheader75.loopexit ] ; 4 uses
  %.061.lcssa = phi i32 [ 0, %bb.e ], [ %i.kf, %.preheader75.loopexit ] ; 4 uses
  %i.kg = icmp ult i32 %.061.lcssa, %.sroa.speculated
  br i1 %i.kg, label %.lr.ph91.preheader, label %._crit_edge92

.lr.ph91.preheader:                               ; preds = %.preheader75
  %i.kh = xor i32 %.061.lcssa, -1
  %i.ki = add i32 %.sroa.speculated, %i.kh        ; 2 uses
  %i.kj = zext i32 %i.ki to i64
  %i.kk = add nuw nsw i64 %i.kj, 1                ; 2 uses
  %min.iters.check178 = icmp ult i32 %i.ki, 7
  br i1 %min.iters.check178, label %.lr.ph91.preheader243, label %vector.ph179

vector.ph179:                                     ; preds = %.lr.ph91.preheader
  %n.vec180 = and i64 %i.kk, 8589934584           ; 5 uses
  %i.kl = trunc i64 %n.vec180 to i32
  %i.km = add i32 %.061.lcssa, %i.kl
  %i.kn = shl nuw nsw i64 %n.vec180, 1
  %i.ko = getelementptr i8, ptr %.062.lcssa, i64 %i.kn ; 2 uses
  %i.kp = shl nuw nsw i64 %n.vec180, 2
  %i.kq = getelementptr i8, ptr %.3.lcssa, i64 %i.kp ; 2 uses
...
vector.body183:                                   ; preds = %vector.body183, %vector.ph179
  ...
  %i.kr = shl i64 %index184, 1
  %next.gep185 = getelementptr i8, ptr %.062.lcssa, i64 %i.kr ; 2 uses
  %i.ks = shl i64 %index184, 2
  %next.gep186 = getelementptr i8, ptr %.3.lcssa, i64 %i.ks ; 3 uses
  %i.kt = getelementptr i8, ptr %next.gep185, i64 8
  %wide.load187 = load <4 x i16>, ptr %next.gep185, align 1, !tbaa !283
  %wide.load188 = load <4 x i16>, ptr %i.kt, align 1, !tbaa !283
  %i.ku = tail call <4 x i16> @llvm.bswap.v4i16(<4 x i16> %wide.load187)
  %i.kv = tail call <4 x i16> @llvm.bswap.v4i16(<4 x i16> %wide.load188)
  %i.kw = sitofp <4 x i16> %i.ku to <4 x float>
  %i.kx = sitofp <4 x i16> %i.kv to <4 x float>
  %i.ky = getelementptr i8, ptr %next.gep186, i64 16 ; 2 uses
  %wide.load189 = load <4 x float>, ptr %next.gep186, align 4, !tbaa !304
  %wide.load190 = load <4 x float>, ptr %i.ky, align 4, !tbaa !304
  %i.kz = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.kw, <4 x float> %broadcast.splat182, <4 x float> %wide.load189)
  %i.la = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.kx, <4 x float> %broadcast.splat182, <4 x float> %wide.load190)
  store <4 x float> %i.kz, ptr %next.gep186, align 4, !tbaa !304
  store <4 x float> %i.la, ptr %i.ky, align 4, !tbaa !304
  %index.next191 = add nuw i64 %index184, 8       ; 2 uses
  %i.lb = icmp eq i64 %index.next191, %n.vec180
  br i1 %i.lb, label %middle.block192, label %vector.body183, !llvm.loop !3183

middle.block192:                                  ; preds = %vector.body183
  %cmp.n193 = icmp eq i64 %i.kk, %n.vec180
  br i1 %cmp.n193, label %._crit_edge92, label %.lr.ph91.preheader243

.lr.ph91.preheader243:                            ; preds = %.lr.ph91.preheader, %middle.block192
  %.190.ph = phi i32 [ %.061.lcssa, %.lr.ph91.preheader ], [ %i.km, %middle.block192 ]
  %.16389.ph = phi ptr [ %.062.lcssa, %.lr.ph91.preheader ], [ %i.ko, %middle.block192 ]
  %.488.ph = phi ptr [ %.3.lcssa, %.lr.ph91.preheader ], [ %i.kq, %middle.block192 ]
  br label %.lr.ph91

.lr.ph84:                                         ; preds = %.lr.ph84.preheader244, %.lr.ph84
  %.06182 = phi i32 [ %i.lj, %.lr.ph84 ], [ %.06182.ph, %.lr.ph84.preheader244 ]
  %.06281 = phi ptr [ %i.lc, %.lr.ph84 ], [ %.06281.ph, %.lr.ph84.preheader244 ] ; 2 uses
  %.380 = phi ptr [ %i.ld, %.lr.ph84 ], [ %.380.ph, %.lr.ph84.preheader244 ] ; 3 uses
  %i.lc = getelementptr inbounds nuw i8, ptr %.06281, i64 8 ; 2 uses
  %i.ld = getelementptr inbounds nuw i8, ptr %.380, i64 16 ; 2 uses
  %i.le = load <4 x i16>, ptr %.06281, align 1, !tbaa !283
  %i.lf = tail call <4 x i16> @llvm.bswap.v4i16(<4 x i16> %i.le)
  %i.lg = sitofp <4 x i16> %i.lf to <4 x float>
  %i.lh = load <4 x float>, ptr %.380, align 4, !tbaa !304
  %i.li = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.lg, <4 x float> %i.e, <4 x float> %i.lh)
  store <4 x float> %i.li, ptr %.380, align 4, !tbaa !304
  %i.lj = add nuw i32 %.06182, 4                  ; 2 uses
  %i.lk = or disjoint i32 %i.lj, 3
  %i.ll = icmp ult i32 %i.lk, %.sroa.speculated
  br i1 %i.ll, label %.lr.ph84, label %.preheader75.loopexit, !llvm.loop !3184
...
.lr.ph91:                                         ; preds = %.lr.ph91.preheader243, %.lr.ph91
  ...
  br i1 %exitcond127.not, label %._crit_edge92, label %.lr.ph91, !llvm.loop !3185

._crit_edge92:                                    ; preds = %.lr.ph91, %middle.block192, %.preheader75
  %.4.lcssa = phi ptr [ %.3.lcssa, %.preheader75 ], [ %i.kq, %middle.block192 ], [ %i.lq, %.lr.ph91 ]
  %.163.lcssa = phi ptr [ %.062.lcssa, %.preheader75 ], [ %i.ko, %middle.block192 ], [ %i.lm, %.lr.ph91 ]
...
.lr.ph.preheader:                                 ; preds = %bb.f
  %i.lv = tail call i32 @llvm.umin.i32(i32 %i.l, i32 %i.m) ; 2 uses
...
vector.body226:                                   ; preds = %vector.body226, %vector.ph222
  ...
  br i1 %i.mk, label %middle.block235, label %vector.body226, !llvm.loop !3186
...
.lr.ph:                                           ; preds = %.lr.ph.preheader245, %.lr.ph
  ...
  br i1 %exitcond.not, label %._crit_edge, label %.lr.ph, !llvm.loop !3187
...
bb.g:                                             ; preds = %._crit_edge, %._crit_edge92, %._crit_edge107, %bb.c, %_ZN2OT11TupleValues9fetcher_t10ensure_runEv.exit.thread
  ...
  %i.mt = sub i32 %i.l, %.sroa.speculated         ; 2 uses
end_hunk_0
