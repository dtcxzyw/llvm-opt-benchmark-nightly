...
vector.body161:                                   ; preds = %vector.body161, %vector.ph157
  ...
  %i.dz = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.dx, <8 x float> %i.f, <8 x float> %i.dy)
...
vector.body203:                                   ; preds = %vector.body203, %vector.ph199
  ...
  %i.ka = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.jy, <8 x float> %i.c, <8 x float> %i.jz)
