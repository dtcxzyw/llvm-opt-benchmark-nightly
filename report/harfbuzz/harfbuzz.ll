...
begin_hunk_0_@_ZL24initial_reordering_indicPK18hb_ot_shape_plan_tP9hb_font_tP11hb_buffer_t:bb.a
  ...
  %i.abx = load i32, ptr %i.abw, align 4, !tbaa !589
  %i.aby = or i32 %i.abx, %i.abv
  store i32 %i.aby, ptr %i.abw, align 4, !tbaa !589
...
.loopexit.i:                                      ; preds = %bb.dg, %bb.df
  ...
  br i1 %i.aca, label %bb.df, label %.loopexit71.i, !llvm.loop !4579
...
.lr.ph179.i:                                      ; preds = %.critedge7.i, %.lr.ph179.preheader.i
  ...
  %.val450.i = load i16, ptr %i.acf, align 4, !tbaa !280
...
.split172.us.i:                                   ; preds = %_ZL9is_joinerRK15hb_glyph_info_t.exit542.i
  %i.acn = load i32, ptr %i.vu, align 4, !tbaa !324
  ...
  %i.acr = load i32, ptr %i.acq, align 4, !tbaa !589
  %i.acs = and i32 %i.acr, %i.aco
  store i32 %i.acs, ptr %i.acq, align 4, !tbaa !589
...
.lr.ph174.i:                                      ; preds = %.split172.us.i, %_ZL12is_consonantRK15hb_glyph_info_t.exit545.backedge.us.i
  ...
  %.val458.us.i = load i16, ptr %i.acv, align 4, !tbaa !280
...
_ZL12is_consonantRK15hb_glyph_info_t.exit545.backedge.us.i: ; preds = %.split.us.i, %.lr.ph174.i
  ...
  %i.adf = load i32, ptr %i.vu, align 4, !tbaa !324
  ...
  %i.adj = load i32, ptr %i.adi, align 4, !tbaa !589
  %i.adk = and i32 %i.adj, %i.adg
  store i32 %i.adk, ptr %i.adi, align 4, !tbaa !589
  %.wide.i = icmp ugt i64 %i.ade, %i.ez
  br i1 %.wide.i, label %.lr.ph174.i, label %.critedge7.i, !llvm.loop !4580
...
.critedge7.i:                                     ; preds = %_ZL12is_consonantRK15hb_glyph_info_t.exit545.backedge.us.i, %.split.us.i, %.split172.us.i, %_ZL9is_joinerRK15hb_glyph_info_t.exit542.i, %.lr.ph179.i
  ...
  br i1 %exitcond295.not.i, label %_ZL33initial_reordering_syllable_indicPK18hb_ot_shape_plan_tP9hb_face_tP11hb_buffer_tjj.exit, label %.lr.ph179.i, !llvm.loop !4581
...
_ZL33initial_reordering_syllable_indicPK18hb_ot_shape_plan_tP9hb_face_tP11hb_buffer_tjj.exit: ; preds = %.critedge7.i, %.loopexit71.i, %bb.x
  %.val = load i32, ptr %i.dz, align 8, !tbaa !605 ; 2 uses
  %.val27 = load ptr, ptr %i.em, align 8, !tbaa !587 ; 3 uses
  ...
  %i.adq = load i8, ptr %i.adp, align 1, !tbaa !280 ; 2 uses
  %i.adr = add i32 %.079, 1
...
bb.dh:                                            ; preds = %.lr.ph217
  ...
  br i1 %exitcond107.not, label %_ZL17_hb_next_syllableP11hb_buffer_tj.exit34, label %.lr.ph217, !llvm.loop !185
...
.lr.ph217:                                        ; preds = %_ZL33initial_reordering_syllable_indicPK18hb_ot_shape_plan_tP9hb_face_tP11hb_buffer_tjj.exit, %bb.dh
  ...
  %i.adx = load i8, ptr %i.adw, align 1, !tbaa !280
  %i.ady = icmp eq i8 %i.adq, %i.adx
  br i1 %i.ady, label %bb.dh, label %._ZL17_hb_next_syllableP11hb_buffer_tj.exit34_crit_edge219, !llvm.loop !185

._ZL17_hb_next_syllableP11hb_buffer_tj.exit34_crit_edge219: ; preds = %.lr.ph217
  br label %_ZL17_hb_next_syllableP11hb_buffer_tj.exit34, !llvm.loop !185
...
_ZL17_hb_next_syllableP11hb_buffer_tj.exit34:     ; preds = %bb.dh, %._ZL17_hb_next_syllableP11hb_buffer_tj.exit34_crit_edge219, %_ZL33initial_reordering_syllable_indicPK18hb_ot_shape_plan_tP9hb_face_tP11hb_buffer_tjj.exit
  ...
  br i1 %i.adz, label %bb.x, label %._crit_edge, !llvm.loop !4582
...
bb.a:
  ...
  %i.b = load i32, ptr %i.a, align 8, !tbaa !605
  %.not = icmp eq i32 %i.b, 0
  br i1 %.not, label %bb.ca, label %bb.b, !prof !267
...
bb.e:                                             ; preds = %.lr.ph195
  ...
  br i1 %exitcond.not, label %.lr.ph, label %.lr.ph195, !llvm.loop !185
...
.lr.ph195:                                        ; preds = %bb.d, %bb.e
  ...
  %i.k = load i8, ptr %i.j, align 1, !tbaa !280
  %i.l = icmp eq i8 %i.g, %i.k
  br i1 %i.l, label %bb.e, label %_ZL17_hb_next_syllableP11hb_buffer_tj.exit.split.loop.exit, !llvm.loop !185
...
.lr.ph:                                           ; preds = %bb.e, %_ZL17_hb_next_syllableP11hb_buffer_tj.exit.split.loop.exit, %bb.d
  ...
  %.pre = load ptr, ptr %i.p, align 8, !tbaa !587
  br label %bb.f
...
bb.f:                                             ; preds = %.lr.ph, %_ZL17_hb_next_syllableP11hb_buffer_tj.exit33
  ...
  %i.u = load ptr, ptr %i.o, align 8, !tbaa !1391 ; 4 uses
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.preheader.i
  ...
  %i.ab = load i32, ptr %i.aa, align 4, !tbaa !635
...
bb.g:                                             ; preds = %.lr.ph.i.prol
  ...
  %.val396.i.prol = load i16, ptr %i.ad, align 4, !tbaa !280 ; 2 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  store i8 4, ptr %i.af, align 2, !tbaa !280
  %i.ag = and i16 %.val396.i.prol, -97
  store i16 %i.ag, ptr %i.ad, align 4, !tbaa !280
...
bb.j:                                             ; preds = %bb.i
  ...
  store i8 4, ptr %i.ao, align 2, !tbaa !280
  %i.ap = and i16 %.val396.i, -97
  store i16 %i.ap, ptr %i.am, align 4, !tbaa !280
  br label %.lr.ph.i.1
...
.lr.ph.i.1:                                       ; preds = %bb.j, %bb.i, %.lr.ph.i
  ...
  %i.as = load i32, ptr %i.ar, align 4, !tbaa !635
...
bb.k:                                             ; preds = %.lr.ph.i.1
  ...
  %.val396.i.1 = load i16, ptr %i.au, align 4, !tbaa !280 ; 2 uses
...
bb.l:                                             ; preds = %bb.k
  ...
  store i8 4, ptr %i.aw, align 2, !tbaa !280
  %i.ax = and i16 %.val396.i.1, -97
  store i16 %i.ax, ptr %i.au, align 4, !tbaa !280
  br label %bb.m

bb.m:                                             ; preds = %bb.l, %bb.k, %.lr.ph.i.1
  %indvars.iv.next.i.1 = add nuw nsw i64 %indvars.iv.i, 2 ; 2 uses
  %exitcond.not.i.1 = icmp eq i64 %indvars.iv.next.i.1, %wide.trip.count.i
  br i1 %exitcond.not.i.1, label %.loopexit573.i, label %.lr.ph.i, !llvm.loop !4588

.loopexit573.i:                                   ; preds = %.lr.ph.i.prol.loopexit, %bb.m, %bb.f
  %i.ay = getelementptr inbounds nuw i8, ptr %i.u, i64 152 ; 2 uses
  %i.az = load i32, ptr %i.ay, align 8, !tbaa !324 ; 2 uses
...
.lr.ph588.i:                                      ; preds = %bb.z, %.lr.ph588.preheader.i
  ...
  %i.bh = load i8, ptr %i.bg, align 1, !tbaa !280
...
.preheader569.i:                                  ; preds = %.preheader569.i.preheader, %bb.r
  ...
  %i.bq = load i32, ptr %i.bp, align 4, !tbaa !589
...
bb.o:                                             ; preds = %.preheader569.i
  ...
  %.val394.i = load i16, ptr %i.bs, align 4, !tbaa !280
...
.lr.ph591.i:                                      ; preds = %.preheader568.i, %bb.p
  ...
  %.val424.i = load i16, ptr %i.bv, align 4, !tbaa !280
...
bb.r:                                             ; preds = %.preheader569.i
  ...
  br i1 %exitcond663.not.i, label %.critedge.i, label %.preheader569.i, !llvm.loop !4590
...
bb.s:                                             ; preds = %.critedge._crit_edge.i, %bb.n
  ...
  %i.cd = load i32, ptr %i.q, align 4, !tbaa !695
...
bb.t:                                             ; preds = %bb.u, %.preheader565.i
  ...
  %.val434.i = load i16, ptr %i.ck, align 4, !tbaa !280
...
bb.u:                                             ; preds = %_ZL9is_joinerRK15hb_glyph_info_t.exit.i
  ...
  br i1 %i.ct, label %bb.t, label %.critedge2.i, !llvm.loop !4591
...
bb.v:                                             ; preds = %.critedge2.i
  ...
  %.val422.i = load i16, ptr %i.cz, align 4, !tbaa !280
...
.preheader564.i:                                  ; preds = %_ZL9is_joinerRK15hb_glyph_info_t.exit443.i
  ...
  br i1 %i.dg, label %.lr.ph199, label %.critedge4.i, !llvm.loop !4592
...
.lr.ph199:                                        ; preds = %.preheader564.preheader.i, %.preheader564.i
  ...
  %.val432.i = load i16, ptr %i.dj, align 4, !tbaa !280
...
_ZL9is_joinerRK15hb_glyph_info_t.exit443.i:       ; preds = %.lr.ph199
  ...
  br i1 %i.dr, label %.preheader564.i, label %_ZL12is_consonantRK15hb_glyph_info_t.exit.i, !llvm.loop !4592
...
bb.w:                                             ; preds = %_ZL12is_consonantRK15hb_glyph_info_t.exit.i
  ...
  %i.dw = load i8, ptr %i.dv, align 1, !tbaa !280
  %i.dx = icmp eq i8 %i.dw, 8
  br i1 %i.dx, label %bb.x, label %.critedge4.i

bb.x:                                             ; preds = %bb.w
  store i8 4, ptr %i.dv, align 1, !tbaa !280
...
.critedge4.i:                                     ; preds = %.preheader564.i, %.lr.ph199, %.preheader564.preheader.i, %bb.x, %bb.w, %_ZL12is_consonantRK15hb_glyph_info_t.exit.i
  ...
  br i1 %i.dy, label %.preheader565.i, label %.loopexit567.i, !llvm.loop !4593
...
bb.y:                                             ; preds = %.loopexit567.i
  ...
  %i.ed = load i8, ptr %i.ec, align 1, !tbaa !280
...
bb.z:                                             ; preds = %.lr.ph588.i
  ...
  br i1 %exitcond662.not.i, label %.loopexit571.i.thread, label %.lr.ph588.i, !llvm.loop !4594
...
.loopexit571.i.thread:                            ; preds = %bb.z, %bb.p, %.critedge.i, %.loopexit571.i
  ...
  %.val406.i = load i16, ptr %i.ek, align 4, !tbaa !280
...
.lr.ph602.i:                                      ; preds = %_ZL9is_one_ofRK15hb_glyph_info_tj.exit.thread.i, %bb.aa
  ...
  %.val404.i = load i16, ptr %i.es, align 4, !tbaa !280
...
bb.aa:                                            ; preds = %_ZL9is_one_ofRK15hb_glyph_info_tj.exit448.i
  ...
  br i1 %i.fc, label %.lr.ph602.i, label %.critedge6.thread.i, !llvm.loop !4595
...
bb.ab:                                            ; preds = %.critedge6.i
  ...
  %i.fi = load i32, ptr %i.q, align 4, !tbaa !695
...
.lr.ph608.i:                                      ; preds = %_ZL9is_one_ofRK15hb_glyph_info_tj.exit451.thread.i, %.lr.ph608.preheader.i
  ...
  %.val402.i = load i16, ptr %i.fl, align 4, !tbaa !280
...
_ZL9is_one_ofRK15hb_glyph_info_tj.exit451.thread.i: ; preds = %_ZL9is_one_ofRK15hb_glyph_info_tj.exit451.i, %.lr.ph608.i
  ...
  br i1 %.not638.i, label %.lr.ph608.i, label %.critedge8.i, !llvm.loop !4596
...
.critedge8.i:                                     ; preds = %_ZL9is_one_ofRK15hb_glyph_info_tj.exit451.thread.i, %.critedge8.loopexit.split.loop.exit793.i, %.preheader561.i
  ...
  %.val420.i = load i16, ptr %i.fx, align 4, !tbaa !280
...
bb.ac:                                            ; preds = %.critedge8.i
  ...
  %i.gc = load i8, ptr %i.gb, align 1, !tbaa !280
...
bb.ae:                                            ; preds = %bb.ad
  ...
  %i.gi = load i8, ptr %i.gh, align 2, !tbaa !280
...
bb.ag:                                            ; preds = %.loopexit562.i
  ...
  %i.gp = load i8, ptr %i.go, align 1, !tbaa !280
...
.lr.ph616.i:                                      ; preds = %bb.ag, %bb.an
  ...
  %i.gt = load i8, ptr %i.gs, align 1, !tbaa !280
...
bb.ah:                                            ; preds = %.lr.ph616.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %3, ptr noundef nonnull align 4 dereferenceable(20) %i.gr, i64 20, i1 false), !tbaa.struct !608
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %i.hc, ptr noundef nonnull align 4 dereferenceable(20) %3, i64 20, i1 false), !tbaa.struct !608
  %i.hd = add i32 %.13.i, 1
...
bb.ai:                                            ; preds = %bb.ah
  %i.hg = load i32, ptr %i.r, align 4, !tbaa !607
...
bb.aj:                                            ; preds = %bb.ai
  ...
  br i1 %i.hj, label %_ZN11hb_buffer_t14merge_clustersEjj.exit.i, label %bb.ak, !prof !267

bb.ak:                                            ; preds = %bb.aj
  %i.hk = load i32, ptr %i.a, align 8, !tbaa !324
...
bb.an:                                            ; preds = %_ZN11hb_buffer_t14merge_clustersEjj.exit.i, %.lr.ph616.i
  ...
  br i1 %i.ho, label %.lr.ph616.i, label %_ZN11hb_buffer_t14merge_clustersEjj.exit459.i, !llvm.loop !4597
...
.lr.ph619.i:                                      ; preds = %.lr.ph619.i.preheader, %bb.as
  ...
  %i.hr = load i8, ptr %i.hq, align 1, !tbaa !280
...
bb.ap:                                            ; preds = %bb.ao
  %i.hx = load i32, ptr %i.r, align 4, !tbaa !607
end_hunk_0
