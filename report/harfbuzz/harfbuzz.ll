...
vector.body161:                                   ; preds = %vector.body161, %vector.ph157
  ...
  %6 = load float, ptr %i.cu, align 4, !tbaa !304
  %i.dp = load float, ptr %i.cv, align 4, !tbaa !304
  %i.dq = load float, ptr %i.cw, align 4, !tbaa !304
  %i.dr = load float, ptr %i.cx, align 4, !tbaa !304
  %7 = insertelement <4 x float> poison, float %6, i64 0
  %i.ds = insertelement <4 x float> %7, float %i.dp, i64 1
  %i.dt = insertelement <4 x float> %i.ds, float %i.dq, i64 2
  %i.du = insertelement <4 x float> %i.dt, float %i.dr, i64 3
  %8 = shufflevector <4 x float> %i.av, <4 x float> %i.bu, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.dv = shufflevector <4 x float> %i.bh, <4 x float> %i.cg, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.dw = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %8, <8 x float> %5, <8 x float> %i.dv)
  %9 = shufflevector <4 x float> %i.ct, <4 x float> %i.do, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %10 = shufflevector <4 x float> %i.df, <4 x float> %i.du, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.dx = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %9, <8 x float> %i.f, <8 x float> %10)
...
vector.body203:                                   ; preds = %vector.body203, %vector.ph199
  ...
  %11 = load float, ptr %i.ip, align 4, !tbaa !304
  %i.jl = load float, ptr %i.iq, align 4, !tbaa !304
  %i.jm = load float, ptr %i.ir, align 4, !tbaa !304
  %i.jn = load float, ptr %i.is, align 4, !tbaa !304
  %12 = insertelement <4 x float> poison, float %11, i64 0
  %i.jo = insertelement <4 x float> %12, float %i.jl, i64 1
  %i.jp = insertelement <4 x float> %i.jo, float %i.jm, i64 2
  %i.jq = insertelement <4 x float> %i.jp, float %i.jn, i64 3
  %13 = shufflevector <4 x float> %i.go, <4 x float> %i.ho, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.jr = shufflevector <4 x float> %i.ha, <4 x float> %i.ia, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.js = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %13, <8 x float> %4, <8 x float> %i.jr)
  %14 = shufflevector <4 x float> %i.io, <4 x float> %i.jk, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %15 = shufflevector <4 x float> %i.ja, <4 x float> %i.jq, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.jt = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %14, <8 x float> %i.c, <8 x float> %15)
