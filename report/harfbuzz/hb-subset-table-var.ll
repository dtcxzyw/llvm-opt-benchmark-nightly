...
bb.a:
  ...
  %i.d = load i32, ptr %i.c, align 4, !tbaa !407  ; 5 uses
...
bb.h:                                             ; preds = %_ZN22hb_serialize_context_t10extend_minIN2OT7VarDataEEEPT_S4_.exit
  ...
  %i.ag = load i32, ptr %i.af, align 4, !tbaa !199 ; 7 uses
...
.preheader217.lr.ph:                              ; preds = %_ZN11hb_vector_tIZN2OT7VarData9serializeEP22hb_serialize_context_tbRKS_IPKS_IiLb0EELb0EEE12delta_size_tLb0EE14realloc_vectorISA_TnPN12hb_enable_ifIXsr3std28is_trivially_copy_assignableIT_EE5valueEvE4typeELPv0EEEPSA_j11hb_priorityILj0EE.exit.i
  ...
  %7 = load i32, ptr %i.c, align 4, !tbaa !407
...
bb.l:                                             ; preds = %.preheader217.split.us
  store i32 2, ptr %i.aq, align 4, !tbaa !1225
...
bb.g:                                             ; preds = %bb.f
  ...
  br i1 %.not.i92.not, label %bb.h, label %.preheader.i94, !prof !142
...
_ZN11hb_vector_tIjLb0EE6resizeEi.exit38.thread:   ; preds = %_ZN11hb_vector_tIjLb0EE14realloc_vectorIjTnPN12hb_enable_ifIXsr3std28is_trivially_copy_assignableIT_EE5valueEvE4typeELPv0EEEPjj11hb_priorityILj0EE.exit.i
  ...
  %i.ar = load i8, ptr %i.ab, align 1, !tbaa !1348, !range !132
...
bb.x:                                             ; preds = %_ZNK16hb_concat_iter_tI10hb_array_tIKN22hb_serialize_context_t8object_t6link_tEES5_EneERKS6_.exit.thread
  ...
  %.pre379 = load i8, ptr %i.ee, align 1, !tbaa !226, !range !132
  br label %_ZN11hb_vector_tIbLb0EEixEi.exit62
...
bb.y:                                             ; preds = %_ZN11hb_vector_tIbLb0EEixEi.exit62
  %i.eh = load ptr, ptr %i.au, align 8, !tbaa !1475
  ...
  %i.ep = load ptr, ptr %i.eo, align 8, !tbaa !1207
  %i.eq = load ptr, ptr %i.ej, align 8, !tbaa !399
  %i.er = ptrtoint ptr %i.ep to i64
  %i.es = ptrtoint ptr %i.eq to i64
  %i.et = getelementptr inbounds nuw i8, ptr %i.ej, i64 64
  %i.eu = load i32, ptr %i.et, align 8, !tbaa !1444
  %i.ev = add i32 %i.eu, 1
...
.preheader.i122:                                  ; preds = %bb.ab, %.preheader.i122
  ...
  br i1 %i.fj, label %.preheader.i122, label %.thread.i124, !llvm.loop !1534
...
bb.ae:                                            ; preds = %bb.ad
  ...
  %i.fo = tail call ptr @hb_malloc(i64 noundef %i.fn) #18 ; 4 uses
...
bb.ag:                                            ; preds = %bb.af
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.fo, ptr nonnull readonly align 1 %.sroa.43.1, i64 %i.fq, i1 false), !alias.scope !1575
...
_ZN11hb_vector_tI9hb_pair_tIljELb0EE14realloc_vectorIS1_TnPN12hb_enable_ifIXsr3std28is_trivially_copy_assignableIT_EE5valueEvE4typeELPv0EEEPS1_j11hb_priorityILj0EE.exit.i127: ; preds = %bb.ad, %bb.ac
  ...
  %i.fu = tail call ptr @hb_realloc(ptr noundef %i.fr, i64 noundef %i.ft) #18 ; 2 uses
...
_ZN11hb_vector_tI9hb_pair_tIljELb0EE4pushIJS1_EEEPS1_DpOT_.exit68.thread322: ; preds = %bb.af, %bb.ag, %_ZN11hb_vector_tI9hb_pair_tIljELb0EE14realloc_vectorIS1_TnPN12hb_enable_ifIXsr3std28is_trivially_copy_assignableIT_EE5valueEvE4typeELPv0EEEPS1_j11hb_priorityILj0EE.exit.i127, %bb.ab
  ...
  store i64 %i.fa, ptr %i.fx, align 8, !tbaa !615
  %.sroa.4261.0..sroa_idx325 = getelementptr inbounds nuw i8, ptr %i.fx, i64 8
  store i32 %i.ec, ptr %.sroa.4261.0..sroa_idx325, align 8, !tbaa !137
  br label %bb.ah
...
_ZN11hb_vector_tI9hb_pair_tIljELb0EE4pushIJS1_EEEPS1_DpOT_.exit68: ; preds = %bb.z
  ...
  store i64 %i.fa, ptr %i.fz, align 8, !tbaa !615
  %.sroa.4261.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.fz, i64 8
  store i32 %i.ec, ptr %.sroa.4261.0..sroa_idx, align 8, !tbaa !137
  %i.ga = icmp slt i32 %.sroa.0178.1, 0
  br i1 %i.ga, label %_ZN19hb_priority_queue_tIlE6insertElj.exit, label %bb.ah, !prof !1550
...
.lr.ph358:                                        ; preds = %bb.ah, %bb.ai
  ...
  %i.gg = load i64, ptr %i.gf, align 8, !tbaa !1541 ; 2 uses
...
bb.ai:                                            ; preds = %.lr.ph358
  ...
  store i64 %i.gg, ptr %i.gi, align 8, !tbaa !615
  store i64 %i.fa, ptr %i.gf, align 8, !tbaa !615
  %i.gj = getelementptr inbounds nuw i8, ptr %i.gi, i64 8 ; 2 uses
  %i.gk = getelementptr inbounds nuw i8, ptr %i.gf, i64 8 ; 2 uses
  %i.gl = load i32, ptr %i.gj, align 8, !tbaa !137
  %i.gm = load i32, ptr %i.gk, align 8, !tbaa !137
  store i32 %i.gm, ptr %i.gj, align 8, !tbaa !137
  store i32 %i.gl, ptr %i.gk, align 8, !tbaa !137
...
bb.an:                                            ; preds = %_ZN5graph7graph_t13check_successEb.exit73
  tail call void @hb_free(ptr noundef %.sroa.15.1) #18
...
bb.ao:                                            ; preds = %_ZN11hb_vector_tIbLb0EED2Ev.exit
  tail call void @hb_free(ptr noundef %.sroa.43.0339) #18
  br label %_ZN19hb_priority_queue_tIlED2Ev.exit
...
bb.a:
  %i.a = load i32, ptr %0, align 8, !tbaa !1472   ; 7 uses
  %i.b = icmp slt i32 %i.a, 0
  br i1 %i.b, label %bb.n, label %bb.b, !prof !21

end_hunk_2
begin_hunk_3_@_ZNK2OT9gvar_GVARINS_7NumTypeILb1EtLj2EEELj1735811442EE16sanitize_shallowEP21hb_sanitize_context_t:bb.a
  %i.q = sub i64 %i.o, %i.p
...
bb.h:                                             ; preds = %_ZN22hb_serialize_context_t12allocate_minIN2OT9gvar_GVARINS1_7NumTypeILb1EtLj2EEELj1735811442EEEEEPT_v.exit
  ...
  %i.ax = load ptr, ptr %i.b, align 8, !tbaa !128 ; 5 uses
...
_ZN11hb_vector_tIS_IcLb0EELb0EE14realloc_vectorIS0_TnPN12hb_enable_ifIXsrT_12realloc_moveEvE4typeELPv0EEEPS0_j11hb_priorityILj1EE.exit.i: ; preds = %.thread.i
  ...
  br i1 %.not22.i, label %_ZN11hb_vector_tIS_IcLb0EELb0EE6resizeEi.exit.thread458.thread, label %bb.l, !prof !118
...
bb.l:                                             ; preds = %_ZN11hb_vector_tIS_IcLb0EELb0EE14realloc_vectorIS0_TnPN12hb_enable_ifIXsrT_12realloc_moveEvE4typeELPv0EEEPS0_j11hb_priorityILj1EE.exit.i
  %3 = shl nuw i32 %i.an, 4
  %i.bx = zext i32 %3 to i64
...
bb.n:                                             ; preds = %bb.m
  %i.cc = getelementptr inbounds nuw i8, ptr %4, i64 20
