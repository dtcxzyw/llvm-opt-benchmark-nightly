...
bb.d:                                             ; preds = %bb.c, %.preheader.i
  ...
  %4 = shl nuw i64 1, %i.ag
  %5 = and i64 %4, 587
  %.not89.i = icmp eq i64 %5, 0
...
bb.o:                                             ; preds = %bb.n
  ...
  %7 = fmul nnan double %.1.i.i, 1.000000e+128
  %8 = insertelement <8 x i32> poison, i32 %i.bb, i64 0
