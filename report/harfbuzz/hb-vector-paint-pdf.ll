...
begin_hunk_0_@_ZL35hb_pdf_build_interpolation_functionP15hb_vector_buf_tjj:bb.a
  %i.b = tail call noundef zeroext i1 @_ZN15hb_vector_buf_t10append_strEPKc(ptr noundef nonnull align 8 dereferenceable(20) %0, ptr noundef nonnull @.str.80) ; 0 uses
  %i.c = lshr i32 %1, 8
  %i.d = lshr i32 %1, 16
  %i.e = lshr i32 %2, 8
  %i.f = lshr i32 %1, 24
...
bb.b:                                             ; preds = %_ZL25hb_pdf_encode_color_alphaP15hb_vector_buf_tj.exit332.i, %bb.a
  ...
  %i.bo = shl <4 x i32> %i.bn, <i32 16, i32 8, i32 0, i32 24>
  %i.bp = and <4 x i32> %i.bo, <i32 16711680, i32 65280, i32 255, i32 -1>
  %i.bq = tail call i32 @llvm.vector.reduce.or.v4i32(<4 x i32> %i.bp) ; 2 uses
  %i.br = shufflevector <2 x float> %i.bi, <2 x float> poison, <4 x i32> zeroinitializer
  %i.bs = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.br, <4 x float> %i.aq, <4 x float> %i.ao)
  %i.bt = fadd <4 x float> %i.bs, splat (float 5.000000e-01)
  %i.bu = fptoui <4 x float> %i.bt to <4 x i32>   ; 2 uses
  %i.bv = shl <4 x i32> %i.bu, <i32 16, i32 8, i32 0, i32 24>
  %i.bw = and <4 x i32> %i.bv, <i32 16711680, i32 65280, i32 255, i32 -1>
  %i.bx = tail call i32 @llvm.vector.reduce.or.v4i32(<4 x i32> %i.bw) ; 2 uses
  %i.by = extractelement <2 x float> %i.bj, i64 0 ; 3 uses
  %i.bz = extractelement <2 x float> %i.bj, i64 1 ; 3 uses
  %i.ca = fsub float %i.by, %i.bz
  %i.cb = fmul float %i.ca, 2.500000e-01
  %i.cc = tail call float @tanf(float noundef %i.cb) #12
  %i.cd = fmul float %i.cc, f0x3FAAAAAB           ; 2 uses
  %i.ce = tail call float @cosf(float noundef %i.bz) #12 ; 3 uses
  %i.cf = tail call float @sinf(float noundef %i.bz) #12 ; 3 uses
  %i.cg = tail call float @cosf(float noundef %i.by) #12 ; 3 uses
  %i.ch = tail call float @sinf(float noundef %i.by) #12 ; 3 uses
  ...
  %i.ck = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cj, <2 x float> <float 3.276700e+04, float 5.000000e-01>, <2 x float> %i.au) ; 4 uses
  %i.cl = extractelement <2 x float> %i.ck, i64 1 ; 5 uses
  %i.cm = extractelement <2 x float> %i.ck, i64 0 ; 3 uses
  ...
  %i.cp = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.co, <2 x float> <float 3.276700e+04, float 5.000000e-01>, <2 x float> %i.aw) ; 4 uses
  %i.cq = extractelement <2 x float> %i.cp, i64 1 ; 5 uses
  %i.cr = extractelement <2 x float> %i.cp, i64 0 ; 3 uses
  %i.cs = insertelement <2 x float> poison, float %i.cg, i64 0
  %i.ct = shufflevector <2 x float> %i.cs, <2 x float> poison, <2 x i32> zeroinitializer
  %i.cu = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ct, <2 x float> <float 5.000000e-01, float 3.276700e+04>, <2 x float> %i.au) ; 4 uses
  %i.cv = extractelement <2 x float> %i.cu, i64 1 ; 5 uses
  %i.cw = extractelement <2 x float> %i.cu, i64 0 ; 3 uses
  %i.cx = insertelement <2 x float> poison, float %i.ch, i64 0
  %i.cy = shufflevector <2 x float> %i.cx, <2 x float> poison, <2 x i32> zeroinitializer
  %i.cz = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cy, <2 x float> <float 5.000000e-01, float 3.276700e+04>, <2 x float> %i.aw) ; 4 uses
  %i.da = extractelement <2 x float> %i.cz, i64 1 ; 5 uses
  %i.db = extractelement <2 x float> %i.cz, i64 0 ; 3 uses
  %i.dc = shufflevector <2 x float> %i.ck, <2 x float> %i.cp, <4 x i32> <i32 0, i32 2, i32 0, i32 2>
  %i.dd = shufflevector <2 x float> %i.ck, <2 x float> %i.cp, <4 x i32> <i32 1, i32 3, i32 1, i32 3>
  %i.de = fsub <4 x float> %i.dc, %i.dd
  %i.df = fmul <4 x float> %i.de, <float 1.000000e+00, float 1.000000e+00, float 2.000000e+00, float 2.000000e+00>
  %i.dg = fdiv <4 x float> %i.df, splat (float 3.000000e+00) ; 4 uses
  %i.dh = extractelement <4 x float> %i.dg, i64 0
  %i.di = fadd float %i.cl, %i.dh                 ; 2 uses
  %i.dj = extractelement <4 x float> %i.dg, i64 1
  %i.dk = fadd float %i.cq, %i.dj                 ; 2 uses
  %i.dl = extractelement <4 x float> %i.dg, i64 2
  %i.dm = fadd float %i.cl, %i.dl                 ; 2 uses
  %i.dn = extractelement <4 x float> %i.dg, i64 3
  %i.do = fadd float %i.cq, %i.dn                 ; 2 uses
  %i.dp = fmul float %i.cd, 3.276700e+04          ; 4 uses
  %i.dq = fneg float %i.cf
  %i.dr = tail call float @llvm.fmuladd.f32(float %i.dp, float %i.dq, float %i.cm) ; 2 uses
  %i.ds = tail call float @llvm.fmuladd.f32(float %i.dp, float %i.ce, float %i.cr) ; 2 uses
  %i.dt = fneg float %i.ch
  %i.du = fneg float %i.dp
  %i.dv = tail call float @llvm.fmuladd.f32(float %i.dp, float %i.ch, float %i.cv) ; 2 uses
  %i.dw = tail call float @llvm.fmuladd.f32(float %i.du, float %i.cg, float %i.da) ; 2 uses
  %i.dx = shufflevector <2 x float> %i.cu, <2 x float> %i.cz, <4 x i32> <i32 0, i32 2, i32 0, i32 2>
  %i.dy = shufflevector <2 x float> %i.cu, <2 x float> %i.cz, <4 x i32> <i32 1, i32 3, i32 1, i32 3>
  %i.dz = fsub <4 x float> %i.dx, %i.dy
  %i.ea = fmul <4 x float> %i.dz, <float 1.000000e+00, float 1.000000e+00, float 2.000000e+00, float 2.000000e+00>
  %i.eb = fdiv <4 x float> %i.ea, splat (float 3.000000e+00) ; 4 uses
  %i.ec = extractelement <4 x float> %i.eb, i64 0
  %i.ed = fadd float %i.cv, %i.ec                 ; 2 uses
  %i.ee = extractelement <4 x float> %i.eb, i64 1
  %i.ef = fadd float %i.da, %i.ee                 ; 2 uses
  %i.eg = extractelement <4 x float> %i.eb, i64 2
  %i.eh = fadd float %i.cv, %i.eg                 ; 2 uses
  %i.ei = extractelement <4 x float> %i.eb, i64 3
  %i.ej = fadd float %i.da, %i.ei                 ; 2 uses
  %i.ek = fmul float %i.cd, 5.000000e-01          ; 4 uses
  %i.el = tail call float @llvm.fmuladd.f32(float %i.ek, float %i.dt, float %i.cw) ; 2 uses
  %i.em = tail call float @llvm.fmuladd.f32(float %i.ek, float %i.cg, float %i.db) ; 2 uses
  %i.en = fneg float %i.ek
  %i.eo = tail call float @llvm.fmuladd.f32(float %i.ek, float %i.cf, float %i.cl) ; 2 uses
  %i.ep = tail call float @llvm.fmuladd.f32(float %i.en, float %i.ce, float %i.cq) ; 2 uses
  %i.eq = tail call noundef zeroext i1 @_ZN15hb_vector_buf_t8append_cEc(ptr noundef nonnull align 8 dereferenceable(20) %i.a, i8 noundef signext 0) ; 0 uses
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.a, float noundef %i.cl, float noundef %i.i, float noundef %i.k)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.a, float noundef %i.cq, float noundef %i.m, float noundef %i.o)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.a, float noundef %i.di, float noundef %i.i, float noundef %i.k)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.a, float noundef %i.dk, float noundef %i.m, float noundef %i.o)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.a, float noundef %i.dm, float noundef %i.i, float noundef %i.k)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.a, float noundef %i.do, float noundef %i.m, float noundef %i.o)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.a, float noundef %i.cm, float noundef %i.i, float noundef %i.k)
  ...
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.a, float noundef %i.dr, float noundef %i.i, float noundef %i.k)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.a, float noundef %i.ds, float noundef %i.m, float noundef %i.o)
  ...
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.a, float noundef %i.cv, float noundef %i.i, float noundef %i.k)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.a, float noundef %i.da, float noundef %i.m, float noundef %i.o)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.a, float noundef %i.ed, float noundef %i.i, float noundef %i.k)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.a, float noundef %i.ef, float noundef %i.m, float noundef %i.o)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.a, float noundef %i.eh, float noundef %i.i, float noundef %i.k)
  ...
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.a, float noundef %i.cw, float noundef %i.i, float noundef %i.k)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.a, float noundef %i.db, float noundef %i.m, float noundef %i.o)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.a, float noundef %i.el, float noundef %i.i, float noundef %i.k)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.a, float noundef %i.em, float noundef %i.m, float noundef %i.o)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.a, float noundef %i.eo, float noundef %i.i, float noundef %i.k)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.a, float noundef %i.ep, float noundef %i.m, float noundef %i.o)
  tail call fastcc void @_ZL23hb_pdf_encode_color_rgbP15hb_vector_buf_tj(ptr noundef nonnull %i.a, i32 noundef %i.bq)
  tail call fastcc void @_ZL23hb_pdf_encode_color_rgbP15hb_vector_buf_tj(ptr noundef nonnull %i.a, i32 noundef %i.bq)
  tail call fastcc void @_ZL23hb_pdf_encode_color_rgbP15hb_vector_buf_tj(ptr noundef nonnull %i.a, i32 noundef %i.bx)
  tail call fastcc void @_ZL23hb_pdf_encode_color_rgbP15hb_vector_buf_tj(ptr noundef nonnull %i.a, i32 noundef %i.bx)
  br i1 %.not.i, label %_ZL25hb_pdf_encode_color_alphaP15hb_vector_buf_tj.exit332.i, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.er = tail call noundef zeroext i1 @_ZN15hb_vector_buf_t8append_cEc(ptr noundef nonnull align 8 dereferenceable(20) %i.c, i8 noundef signext 0) ; 0 uses
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.c, float noundef %i.cl, float noundef %i.i, float noundef %i.k)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.c, float noundef %i.cq, float noundef %i.m, float noundef %i.o)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.c, float noundef %i.di, float noundef %i.i, float noundef %i.k)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.c, float noundef %i.dk, float noundef %i.m, float noundef %i.o)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.c, float noundef %i.dm, float noundef %i.i, float noundef %i.k)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.c, float noundef %i.do, float noundef %i.m, float noundef %i.o)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.c, float noundef %i.cm, float noundef %i.i, float noundef %i.k)
  ...
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.c, float noundef %i.dr, float noundef %i.i, float noundef %i.k)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.c, float noundef %i.ds, float noundef %i.m, float noundef %i.o)
  ...
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.c, float noundef %i.cv, float noundef %i.i, float noundef %i.k)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.c, float noundef %i.da, float noundef %i.m, float noundef %i.o)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.c, float noundef %i.ed, float noundef %i.i, float noundef %i.k)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.c, float noundef %i.ef, float noundef %i.m, float noundef %i.o)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.c, float noundef %i.eh, float noundef %i.i, float noundef %i.k)
  ...
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.c, float noundef %i.cw, float noundef %i.i, float noundef %i.k)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.c, float noundef %i.db, float noundef %i.m, float noundef %i.o)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.c, float noundef %i.el, float noundef %i.i, float noundef %i.k)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.c, float noundef %i.em, float noundef %i.m, float noundef %i.o)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.c, float noundef %i.eo, float noundef %i.i, float noundef %i.k)
  tail call fastcc void @_ZL19hb_pdf_encode_coordP15hb_vector_buf_tfff(ptr noundef nonnull %i.c, float noundef %i.ep, float noundef %i.m, float noundef %i.o)
  %i.es = bitcast <4 x i32> %i.bn to <16 x i8>
  %i.et = extractelement <16 x i8> %i.es, i64 8   ; 2 uses
  %i.eu = load i32, ptr %i.ar, align 4, !tbaa !14 ; 2 uses
  %i.ev = tail call { i32, i1 } @llvm.uadd.with.overflow.i32(i32 %i.eu, i32 1) ; 2 uses
  %i.ew = extractvalue { i32, i1 } %i.ev, 1
  %i.ex = extractvalue { i32, i1 } %i.ev, 0       ; 4 uses
  %i.ey = icmp slt i32 %i.ex, 0
  %or.cond.i.i.i = or i1 %i.ew, %i.ey
  br i1 %or.cond.i.i.i, label %_ZL25hb_pdf_encode_color_alphaP15hb_vector_buf_tj.exit.i, label %bb.d, !prof !62

bb.d:                                             ; preds = %bb.c
  %i.ez = load i32, ptr %i.c, align 8, !tbaa !16  ; 4 uses
end_hunk_0
begin_hunk_1_@_ZN18hb_pdf_resources_t19add_extgstate_blendEPKc:_ZN11hb_vector_tIcLb0EE14realloc_vectorIcTnPN12hb_enable_ifIXsr3std28is_trivially_copy_assignableIT_EE5valueEvE4typeELPv0EEEPcj11hb_priorityILj0EE.exit.i.i.i.i
  %i.i = extractvalue { i32, i1 } %i.g, 0         ; 5 uses
  %i.j = or i32 %i.i, %.sroa.0.1
