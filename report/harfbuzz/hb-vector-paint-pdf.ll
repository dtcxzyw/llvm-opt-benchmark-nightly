...
_ZN15hb_vector_buf_t10append_strEPKc.exit434:     ; preds = %.critedge, %bb.er, %_ZN11hb_vector_tIcLb0EE5allocEjb.exit.i.i.i430, %bb.ex
  ...
  %i.wk = load i32, ptr %i.wj, align 4, !tbaa !373 ; 4 uses
  %i.wl = and i32 %i.wk, 255                      ; 2 uses
...
bb.ey:                                            ; preds = %_ZN15hb_vector_buf_t10append_strEPKc.exit434
  ...
  %7 = insertelement <4 x i32> %6, i32 %4, i64 1
  %8 = insertelement <4 x i32> %7, i32 %3, i64 2
  %9 = insertelement <4 x i32> %8, i32 %i.wl, i64 3
  %10 = and <4 x i32> %9, <i32 255, i32 255, i32 -1, i32 -1>
  %i.wm = uitofp nneg <4 x i32> %10 to <4 x float>
...
bb.b:                                             ; preds = %bb.a
  ...
  %11 = insertelement <4 x i32> %10, i32 %8, i64 1
  %12 = insertelement <4 x i32> %11, i32 %7, i64 2
  %13 = insertelement <4 x i32> %12, i32 %5, i64 3
  %14 = and <4 x i32> %13, <i32 255, i32 255, i32 -1, i32 255>
  %i.b = uitofp <4 x i32> %14 to <4 x float>
...
_ZN17hb_vector_paint_t12current_bodyEv.exit.i:    ; preds = %bb.d, %bb.c
  ...
  %10 = insertelement <4 x i32> %9, i32 %5, i64 2
  %11 = insertelement <4 x i32> %10, i32 %3, i64 3
  %12 = and <4 x i32> %11, <i32 255, i32 255, i32 -1, i32 255>
  %i.i = uitofp <4 x i32> %12 to <4 x float>
...
bb.a:
  ...
  %i.v = sub nsw <4 x i32> %20, %12
  %21 = insertelement <4 x i32> poison, i32 %7, i64 2
  %22 = shufflevector <4 x i32> %12, <4 x i32> %21, <4 x i32> <i32 3, i32 2, i32 6, i32 0>
  %i.w = uitofp nneg <4 x i32> %22 to <4 x float> ; 2 uses
  %i.x = sitofp <4 x i32> %i.v to <4 x float>
  %23 = shufflevector <4 x float> %i.x, <4 x float> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0> ; 2 uses
...
bb.b:                                             ; preds = %_ZL25hb_pdf_encode_color_alphaP15hb_vector_buf_tj.exit332.i, %bb.a
  ...
  %i.as = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ar, <4 x float> %23, <4 x float> %i.w)
  ...
  %i.az = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ay, <4 x float> %23, <4 x float> %i.w)
