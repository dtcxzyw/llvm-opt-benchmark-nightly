...
bb.p:                                             ; preds = %bb.o
  ...
  %i.dz = load double, ptr %i.dy, align 8, !tbaa !45
...
bb.q:                                             ; preds = %bb.p
  ...
  %i.eg = load double, ptr %i.ef, align 8, !tbaa !46
...
bb.r:                                             ; preds = %bb.q
  ...
  %i.en = load double, ptr %i.em, align 8, !tbaa !47
...
bb.s:                                             ; preds = %bb.r
  ...
  %i.eu = load ptr, ptr %i.et, align 8, !tbaa !60
...
bb.u:                                             ; preds = %bb.s, %bb.u
  ...
  %i.ft = load <2 x double>, ptr %i.fq, align 8, !tbaa !40, !noalias !61
  ...
  %i.fz = load <2 x double>, ptr %i.fp, align 8, !tbaa !40, !noalias !61
  %i.ga = extractelement <2 x i16> %i.fw, i64 1
  %i.gb = sext i16 %i.ga to i32                   ; 2 uses
  %i.gc = load <2 x double>, ptr %i.fr, align 8, !tbaa !40, !noalias !61
  ...
  store <2 x double> %i.gq, ptr %i.fs, align 8, !tbaa !40
  ...
  store <2 x double> %i.gy, ptr %.sroa.5812.0..sroa_idx, align 8, !tbaa !40
  ...
  store i8 %i.hd, ptr %.sroa.7.0..sroa_idx, align 8, !tbaa !41
  ...
  store i8 %i.hf, ptr %.sroa.8.0..sroa_idx, align 1, !tbaa !41
  %.sroa.9813.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.fs, i64 36
  store <4 x i32> <i32 0, i32 -1, i32 0, i32 -1>, ptr %.sroa.9813.0..sroa_idx, align 4, !tbaa !51
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %bb.t, label %bb.u, !llvm.loop !64

bb.v:                                             ; preds = %bb.t
  %i.hg = getelementptr inbounds nuw i8, ptr %0, i64 140 ; 2 uses
  %i.hh = load i32, ptr %i.hg, align 4, !tbaa !57 ; 3 uses
...
bb.x:                                             ; preds = %bb.w, %bb.v
  store i32 %i.fl, ptr %i.hg, align 4, !tbaa !57
...
bb.y:                                             ; preds = %bb.x
  ...
  %i.ht = load i32, ptr %i.hs, align 4, !tbaa !57 ; 3 uses
...
bb.z:                                             ; preds = %bb.y
  ...
  %i.hy = load ptr, ptr %i.hx, align 8, !tbaa !66
...
_ZN11hb_vector_tIjLb0EE6resizeEi.exit549:         ; preds = %bb.y, %bb.z
  store i32 %i.hq, ptr %i.hs, align 4, !tbaa !57
  %i.ic = getelementptr inbounds nuw i8, ptr %0, i64 144 ; 4 uses
  %i.id = load ptr, ptr %i.ic, align 8, !tbaa !67 ; 4 uses
  %i.ie = zext nneg i32 %i.fl to i64              ; 9 uses
  %i.if = shl nuw nsw i64 %i.ie, 2
  tail call void @llvm.memset.p0.i64(ptr align 4 %i.id, i8 0, i64 %i.if, i1 false), !tbaa !51
  %i.ig = getelementptr inbounds nuw i8, ptr %0, i64 160 ; 4 uses
  %i.ih = load ptr, ptr %i.ig, align 8, !tbaa !68 ; 4 uses
  %i.ii = zext nneg i32 %i.hq to i64              ; 9 uses
  %i.ij = shl nuw nsw i64 %i.ii, 2
  tail call void @llvm.memset.p0.i64(ptr align 4 %i.ih, i8 0, i64 %i.ij, i1 false), !tbaa !51
  %i.ik = load ptr, ptr %i.et, align 8, !tbaa !60
...
bb.ab:                                            ; preds = %bb.aa
  ...
  %i.iy = load i32, ptr %i.ix, align 4, !tbaa !57 ; 3 uses
...
bb.ad:                                            ; preds = %_ZN11hb_vector_tIjLb0EE6resizeEi.exit549, %.loopexit
  ...
  %i.jj = load i8, ptr %i.ji, align 8, !tbaa !69, !range !27, !noundef !28
...
bb.af:                                            ; preds = %bb.ae
  ...
  %i.jo = load <2 x double>, ptr %i.jl, align 8, !tbaa !40
  ...
  store <2 x i32> %i.jv, ptr %i.jm, align 4, !tbaa !51
...
bb.ag:                                            ; preds = %.lr.ph, %bb.ag
  ...
  %i.kb = add i32 %i.ka, 1
  store i32 %i.kb, ptr %i.jz, align 4, !tbaa !51
  %indvars.iv.next974 = add nuw nsw i64 %indvars.iv973, 1
  %i.kc = load i32, ptr %i.jn, align 8, !tbaa !71
  %i.kd = sext i32 %i.kc to i64
  %.not498.not = icmp slt i64 %indvars.iv973, %i.kd
  br i1 %.not498.not, label %bb.ag, label %.loopexit861, !llvm.loop !72
...
bb.ah:                                            ; preds = %bb.ae
  ...
  store i32 0, ptr %i.kf, align 8, !tbaa !71
  %i.kg = load i32, ptr %i.id, align 4, !tbaa !51
  %i.kh = add i32 %i.kg, 1
  store i32 %i.kh, ptr %i.id, align 4, !tbaa !51
  br label %.loopexit861

.loopexit861:                                     ; preds = %bb.ag, %bb.af, %bb.ah, %bb.ad
  %i.ki = getelementptr inbounds nuw i8, ptr %i.jh, i64 33
  %i.kj = load i8, ptr %i.ki, align 1, !tbaa !74, !range !27, !noundef !28
...
bb.aj:                                            ; preds = %bb.ai
  ...
  %i.kn = load <2 x double>, ptr %i.jh, align 8, !tbaa !40
  ...
  store <2 x i32> %i.ku, ptr %i.kl, align 4, !tbaa !51
...
bb.ak:                                            ; preds = %.lr.ph873, %bb.ak
  ...
  %i.kz = load i32, ptr %i.ky, align 4, !tbaa !51
  %i.la = add i32 %i.kz, 1
  store i32 %i.la, ptr %i.ky, align 4, !tbaa !51
  %indvars.iv.next977 = add nuw nsw i64 %indvars.iv976, 1
  %i.lb = load i32, ptr %i.km, align 8, !tbaa !75
  %i.lc = sext i32 %i.lb to i64
  %.not499.not = icmp slt i64 %indvars.iv976, %i.lc
  br i1 %.not499.not, label %bb.ak, label %.loopexit, !llvm.loop !76

bb.al:                                            ; preds = %bb.ai
  %i.ld = getelementptr inbounds nuw i8, ptr %i.jh, i64 44
  store i32 0, ptr %i.ld, align 4, !tbaa !77
  %i.le = getelementptr inbounds nuw i8, ptr %i.jh, i64 48
  store i32 0, ptr %i.le, align 8, !tbaa !75
  %i.lf = load i32, ptr %i.ih, align 4, !tbaa !51
  %i.lg = add i32 %i.lf, 1
  store i32 %i.lg, ptr %i.ih, align 4, !tbaa !51
  br label %.loopexit
...
.loopexit:                                        ; preds = %bb.ak, %bb.aj, %bb.al, %.loopexit861
  ...
  br i1 %exitcond984.not, label %bb.aa, label %bb.ad, !llvm.loop !78

bb.am:                                            ; preds = %bb.ac, %bb.ab
  store i32 %i.fl, ptr %i.ix, align 4, !tbaa !57
...
bb.an:                                            ; preds = %bb.am
  ...
  %i.lj = load i32, ptr %i.li, align 4, !tbaa !57 ; 3 uses
...
bb.ao:                                            ; preds = %bb.an
  ...
  %i.lo = load ptr, ptr %i.ln, align 8, !tbaa !66
...
bb.ap:                                            ; preds = %bb.ao, %bb.an
  store i32 %i.hq, ptr %i.li, align 4, !tbaa !57
  %i.ls = getelementptr inbounds nuw i8, ptr %0, i64 176 ; 4 uses
  %i.lt = load ptr, ptr %i.ls, align 8, !tbaa !79 ; 3 uses
  %i.lu = load ptr, ptr %i.ic, align 8, !tbaa !67 ; 3 uses
...
.critedge505.preheader.unr-lcssa:                 ; preds = %bb.as
  %lcmp.mod.not = trunc i32 %i.fl to i1
  br i1 %lcmp.mod.not, label %.epil.preheader, label %.critedge505.preheader
...
.critedge505.preheader:                           ; preds = %.critedge505.preheader.unr-lcssa, %.critedge505.preheader.epilog-lcssa
  ...
  %i.md = load ptr, ptr %i.mc, align 8, !tbaa !80 ; 3 uses
  %i.me = load ptr, ptr %i.ig, align 8, !tbaa !68 ; 3 uses
...
bb.as:                                            ; preds = %bb.ar
  ...
  br i1 %niter.ncmp.1, label %.critedge505.preheader.unr-lcssa, label %bb.aq, !llvm.loop !81
...
.critedge505.1:                                   ; preds = %.critedge505
  ...
  br i1 %niter1218.ncmp.1, label %.critedge507.unr-lcssa, label %bb.at, !llvm.loop !82

.critedge507.unr-lcssa:                           ; preds = %.critedge505.1
  %lcmp.mod1214.not = trunc i32 %i.hq to i1
  br i1 %lcmp.mod1214.not, label %.epil.preheader1212, label %.critedge507
...
.critedge507:                                     ; preds = %.critedge507.unr-lcssa, %.critedge505.epil
  ...
  br i1 %i.nk, label %.critedge501, label %bb.au, !prof !36
...
bb.au:                                            ; preds = %.critedge507
  ...
  br i1 %i.nl, label %bb.av, label %.critedge501, !prof !58

bb.av:                                            ; preds = %bb.au
  %i.nm = getelementptr inbounds nuw i8, ptr %0, i64 204 ; 3 uses
  %i.nn = load i32, ptr %i.nm, align 4, !tbaa !57 ; 3 uses
...
bb.aw:                                            ; preds = %bb.av
  ...
  br i1 %.not.i.i.i.i564, label %bb.ay, label %bb.ax, !prof !36
...
bb.ay:                                            ; preds = %bb.av, %bb.aw, %bb.ax
  store i32 %.lcssa1209, ptr %i.nm, align 4, !tbaa !57
...
bb.az:                                            ; preds = %bb.ay
  ...
  %i.ny = load i32, ptr %i.nx, align 4, !tbaa !57 ; 3 uses
...
bb.ba:                                            ; preds = %bb.az
  ...
  br i1 %.not.i.i.i.i568, label %bb.bc, label %bb.bb, !prof !36

bb.bb:                                            ; preds = %bb.ba
  %i.oc = getelementptr inbounds nuw i8, ptr %0, i64 224
  %i.od = load ptr, ptr %i.oc, align 8, !tbaa !66
...
bb.bc:                                            ; preds = %bb.az, %bb.ba, %bb.bb
  store i32 %.lcssa1209, ptr %i.nx, align 4, !tbaa !57
  %i.oh = icmp slt i32 %.lcssa1207, 0
  br i1 %i.oh, label %.critedge501, label %bb.bd, !prof !36
...
bb.bd:                                            ; preds = %bb.bc
  ...
  br i1 %i.oi, label %bb.be, label %.critedge501, !prof !58

bb.be:                                            ; preds = %bb.bd
  %i.oj = getelementptr inbounds nuw i8, ptr %0, i64 236 ; 3 uses
  %i.ok = load i32, ptr %i.oj, align 4, !tbaa !57 ; 3 uses
...
bb.bf:                                            ; preds = %bb.be
  ...
  br i1 %.not.i.i.i.i572, label %bb.bh, label %bb.bg, !prof !36

bb.bg:                                            ; preds = %bb.bf
  %i.oo = getelementptr inbounds nuw i8, ptr %0, i64 240
  %i.op = load ptr, ptr %i.oo, align 8, !tbaa !66
...
bb.bh:                                            ; preds = %bb.be, %bb.bf, %bb.bg
  store i32 %.lcssa1207, ptr %i.oj, align 4, !tbaa !57
...
bb.bi:                                            ; preds = %bb.bh
  ...
  %i.ov = load i32, ptr %i.ou, align 4, !tbaa !57 ; 3 uses
...
bb.bj:                                            ; preds = %bb.bi
  ...
  br i1 %.not.i.i.i.i576, label %bb.bl, label %bb.bk, !prof !36

bb.bk:                                            ; preds = %bb.bj
  %i.oz = getelementptr inbounds nuw i8, ptr %0, i64 256
  %i.pa = load ptr, ptr %i.oz, align 8, !tbaa !66
...
bb.bl:                                            ; preds = %bb.bk, %bb.bj, %bb.bi
  store i32 %.lcssa1207, ptr %i.ou, align 4, !tbaa !57
...
bb.bm:                                            ; preds = %bb.bl
  ...
  %i.pg = load i32, ptr %i.pf, align 4, !tbaa !57 ; 3 uses
...
bb.bo:                                            ; preds = %bb.bn, %bb.bm
  store i32 %i.fl, ptr %i.pf, align 4, !tbaa !57
...
bb.bp:                                            ; preds = %bb.bo
  ...
  %i.pr = load i32, ptr %i.pq, align 4, !tbaa !57 ; 3 uses
...
_ZN11hb_vector_tIjLb0EE6resizeEi.exit585:         ; preds = %bb.bp, %bb.bq
  store i32 %i.hq, ptr %i.pq, align 4, !tbaa !57
  %i.qa = load ptr, ptr %i.ls, align 8, !tbaa !79 ; 12 uses
  %i.qb = getelementptr inbounds nuw i8, ptr %0, i64 272
  %i.qc = load ptr, ptr %i.qb, align 8, !tbaa !83 ; 13 uses
...
vector.ph:                                        ; preds = %_ZN11hb_vector_tIjLb0EE6resizeEi.exit585
  ...
  %wide.load = load <4 x i32>, ptr %i.qa, align 4, !tbaa !51
  %wide.load1174 = load <4 x i32>, ptr %i.qg, align 4, !tbaa !51
  %i.qh = getelementptr inbounds nuw i8, ptr %i.qc, i64 16
  store <4 x i32> %wide.load, ptr %i.qc, align 4, !tbaa !51
  store <4 x i32> %wide.load1174, ptr %i.qh, align 4, !tbaa !51
...
begin_hunk_1_@hb_gpu_draw_encode:bb.a
  ...
  br i1 %niter1229.ncmp.3, label %._crit_edge894.loopexit.unr-lcssa, label %.lr.ph893, !llvm.loop !115
...
.cont701:                                         ; preds = %bb.cg
  ...
  br i1 %i.yo, label %.preheader855, label %bb.ch, !prof !29
...
bb.cn:                                            ; preds = %bb.cm
  ...
  store i32 %.0461895, ptr %i.zi, align 4, !tbaa !51
...
bb.cr:                                            ; preds = %bb.cq, %bb.cp
  ...
  %i.aae = load <2 x double>, ptr %i.aab, align 8, !tbaa !40
  ...
  store <2 x i16> %i.aah, ptr %i.aad, align 2, !tbaa !119
...
bb.cs:                                            ; preds = %bb.cr
  ...
  %i.aak = load <2 x double>, ptr %i.aaj, align 8, !tbaa !40
...
bb.ct:                                            ; preds = %bb.cr, %bb.cs
  ...
  store <2 x i16> %i.aao, ptr %i.aap, align 2, !tbaa !119
  %i.aaq = add i32 %.1462, 1
  %exitcond1040.not = icmp eq i64 %indvars.iv.next1037, %wide.trip.count
  br i1 %exitcond1040.not, label %bb.cl, label %bb.cm, !llvm.loop !128

.preheader853:                                    ; preds = %._crit_edge920
  %i.aar = load ptr, ptr %i.mc, align 8, !tbaa !80
  %i.aas = load ptr, ptr %i.ig, align 8, !tbaa !68
...
bb.cu:                                            ; preds = %bb.cl, %._crit_edge920
  ...
  %i.aaz = load i32, ptr %i.aay, align 4, !tbaa !51 ; 8 uses
  %i.aba = getelementptr inbounds nuw [4 x i8], ptr %i.yy, i64 %indvars.iv1062
  %i.abb = load i32, ptr %i.aba, align 4, !tbaa !51 ; 9 uses
  %.not952 = icmp eq i32 %i.abb, 0
  br i1 %.not952, label %._crit_edge920, label %.lr.ph909

.lr.ph909:                                        ; preds = %bb.cu
  %i.abc = load ptr, ptr %i.et, align 8, !tbaa !60 ; 2 uses
  %i.abd = load ptr, ptr %i.sh, align 8, !tbaa !91
...
._crit_edge910:                                   ; preds = %.critedge
  ...
  %i.abh = load ptr, ptr %i.sh, align 8, !tbaa !91 ; 3 uses
...
bb.cv:                                            ; preds = %.lr.ph909, %.critedge
  ...
  %i.abo = load i32, ptr %i.abn, align 4, !tbaa !51
  ...
  %i.abs = load double, ptr %i.abr, align 8, !tbaa !98 ; 2 uses
...
.lr.ph900:                                        ; preds = %bb.cv
  %i.abt = load ptr, ptr %i.si, align 8, !tbaa !92
...
bb.cx:                                            ; preds = %bb.cw
  ...
  br i1 %.not495, label %.critedge, label %bb.cw, !llvm.loop !129
...
.critedge:                                        ; preds = %bb.cw, %bb.cx, %bb.cv
  ...
  br i1 %exitcond1049.not, label %._crit_edge910, label %bb.cv, !llvm.loop !130

.lr.ph919.unr-lcssa:                              ; preds = %bb.cy
  %lcmp.mod1233.not = trunc i32 %i.abb to i1
  br i1 %lcmp.mod1233.not, label %.epil.preheader1230, label %.lr.ph919
...
.epil.preheader1230:                              ; preds = %.lr.ph919.unr-lcssa, %._crit_edge910
  ...
  store <4 x i16> %i.acs, ptr %i.acr, align 2, !tbaa !119
...
.lr.ph919:                                        ; preds = %.lr.ph919.unr-lcssa, %.epil.preheader1230
  ...
  %i.acu = load ptr, ptr %i.si, align 8, !tbaa !92 ; 3 uses
...
bb.cy:                                            ; preds = %bb.cy, %._crit_edge910.new
  ...
  store <4 x i16> %i.adh, ptr %i.adg, align 2, !tbaa !119
  ...
  store <4 x i16> %i.adv, ptr %i.adu, align 2, !tbaa !119
  ...
  br i1 %niter1237.ncmp.1, label %.lr.ph919.unr-lcssa, label %bb.cy, !llvm.loop !131

._crit_edge920.loopexit.unr-lcssa:                ; preds = %bb.cz
  %lcmp.mod1241.not = trunc i32 %i.abb to i1
  br i1 %lcmp.mod1241.not, label %.epil.preheader1238, label %._crit_edge920
...
.epil.preheader1238:                              ; preds = %._crit_edge920.loopexit.unr-lcssa, %.lr.ph919
  ...
  store <4 x i16> %i.aei, ptr %i.aeh, align 2, !tbaa !119
...
bb.cz:                                            ; preds = %bb.cz, %.lr.ph919.new
  ...
  %i.afc = load i32, ptr %i.afb, align 4, !tbaa !51
  ...
  store <4 x i16> %i.afg, ptr %i.aff, align 2, !tbaa !119
  ...
  store <4 x i16> %i.afu, ptr %i.aft, align 2, !tbaa !119
  ...
  br i1 %niter1245.ncmp.1, label %._crit_edge920.loopexit.unr-lcssa, label %bb.cz, !llvm.loop !138

bb.da:                                            ; preds = %._crit_edge947
  %i.afw = load ptr, ptr %i.yc, align 8, !tbaa !118
  store ptr null, ptr %i.yc, align 8, !tbaa !118
  %i.afx = load i32, ptr %i.a, align 4, !tbaa !51
  %i.afy = load ptr, ptr %i.b, align 8, !tbaa !116
...
bb.db:                                            ; preds = %.preheader853, %._crit_edge947
  ...
  %i.agb = load i32, ptr %i.aga, align 4, !tbaa !51 ; 8 uses
  %i.agc = getelementptr inbounds nuw [4 x i8], ptr %i.aas, i64 %indvars.iv1090
  %i.agd = load i32, ptr %i.agc, align 4, !tbaa !51 ; 9 uses
  %.not955 = icmp eq i32 %i.agd, 0
  br i1 %.not955, label %._crit_edge947, label %.lr.ph936

.lr.ph936:                                        ; preds = %bb.db
  %i.age = load ptr, ptr %i.et, align 8, !tbaa !60 ; 2 uses
  %i.agf = load ptr, ptr %i.sj, align 8, !tbaa !93
...
._crit_edge937:                                   ; preds = %.critedge3
  ...
  %i.agj = load ptr, ptr %i.sj, align 8, !tbaa !93 ; 3 uses
...
bb.dc:                                            ; preds = %.lr.ph936, %.critedge3
  ...
  %i.agq = load i32, ptr %i.agp, align 4, !tbaa !51
  ...
  %i.agu = load double, ptr %i.agt, align 8, !tbaa !105 ; 2 uses
...
.lr.ph927:                                        ; preds = %bb.dc
  %i.agv = load ptr, ptr %i.sk, align 8, !tbaa !94
...
bb.dd:                                            ; preds = %.lr.ph927, %bb.de
  ...
  %i.ahf = load double, ptr %i.ahe, align 8, !tbaa !108
...
bb.de:                                            ; preds = %bb.dd
  ...
  br i1 %.not494, label %.critedge3, label %bb.dd, !llvm.loop !139
...
.critedge3:                                       ; preds = %bb.dd, %bb.de, %bb.dc
  ...
  br i1 %exitcond1077.not, label %._crit_edge937, label %bb.dc, !llvm.loop !140

.lr.ph946.unr-lcssa:                              ; preds = %bb.df
  %lcmp.mod1249.not = trunc i32 %i.agd to i1
  br i1 %lcmp.mod1249.not, label %.epil.preheader1246, label %.lr.ph946
...
.epil.preheader1246:                              ; preds = %.lr.ph946.unr-lcssa, %._crit_edge937
  ...
  %i.aho = load i32, ptr %i.ahn, align 4, !tbaa !51
  ...
  store <4 x i16> %i.ahv, ptr %i.ahu, align 2, !tbaa !119
...
.lr.ph946:                                        ; preds = %.lr.ph946.unr-lcssa, %.epil.preheader1246
  ...
  %i.ahx = load ptr, ptr %i.sk, align 8, !tbaa !94 ; 3 uses
...
bb.df:                                            ; preds = %bb.df, %._crit_edge937.new
  ...
  store <4 x i16> %i.aik, ptr %i.aij, align 2, !tbaa !119
  ...
  store <4 x i16> %i.aiy, ptr %i.aix, align 2, !tbaa !119
  ...
  br i1 %niter1253.ncmp.1, label %.lr.ph946.unr-lcssa, label %bb.df, !llvm.loop !141

._crit_edge947.loopexit.unr-lcssa:                ; preds = %bb.dg
  %lcmp.mod1257.not = trunc i32 %i.agd to i1
  br i1 %lcmp.mod1257.not, label %.epil.preheader1254, label %._crit_edge947
...
.epil.preheader1254:                              ; preds = %._crit_edge947.loopexit.unr-lcssa, %.lr.ph946
  ...
  store <4 x i16> %i.ajl, ptr %i.ajk, align 2, !tbaa !119
...
bb.dg:                                            ; preds = %bb.dg, %.lr.ph946.new
  ...
  store <4 x i16> %i.aki, ptr %i.akh, align 2, !tbaa !119
  ...
  store <4 x i16> %i.akw, ptr %i.akv, align 2, !tbaa !119
  ...
  br i1 %niter1261.ncmp.1, label %._crit_edge947.loopexit.unr-lcssa, label %bb.dg, !llvm.loop !143
...
.critedge501:                                     ; preds = %.epil.preheader, %bb.ar, %bb.aq, %.epil.preheader1212, %.critedge505, %bb.at, %bb.bo, %bb.bd, %bb.bc, %bb.au, %.critedge507, %bb.am, %bb.x, %bb.k, %_ZN11hb_vector_tIjLb0EE14reset_if_errorEv.exit540, %_ZL24_hb_gpu_draw_get_extentsP13hb_gpu_draw_tP18hb_glyph_extents_t.exit, %bb.t, %bb.aa, %bb.cc, %_ZN9hb_blob_t13recycle_abortEPcPS_.exit684, %bb.ce, %bb.cf, %._crit_edge894, %bb.cd, %bb.bl, %bb.bh, %bb.ay, %bb.r, %bb.q, %bb.p, %bb.o, %bb.i
  ...
  store i8 1, ptr %i.akz, align 8, !tbaa !30
  %i.ala = getelementptr inbounds nuw i8, ptr %0, i64 52
  store i32 0, ptr %i.ala, align 4, !tbaa !35
  store i8 1, ptr %i.ao, align 8, !tbaa !8
  %i.alb = getelementptr inbounds nuw i8, ptr %0, i64 64 ; 2 uses
  %i.alc = load i32, ptr %i.alb, align 8, !tbaa !38 ; 2 uses
  %i.ald = icmp slt i32 %i.alc, 0
  br i1 %i.ald, label %bb.dh, label %"_ZN16hb_scope_guard_tIZ18hb_gpu_draw_encodeE3$_0ED2Ev.exit", !prof !36

bb.dh:                                            ; preds = %.critedge501
  %i.ale = xor i32 %i.alc, -1
  store i32 %i.ale, ptr %i.alb, align 8, !tbaa !38
...
"_ZN16hb_scope_guard_tIZ18hb_gpu_draw_encodeE3$_0ED2Ev.exit": ; preds = %.critedge501, %bb.dh
  ...
  store i32 0, ptr %i.alf, align 4, !tbaa !37
  %i.alg = getelementptr inbounds nuw i8, ptr %0, i64 80
  store <2 x double> splat (double +inf), ptr %i.alg, align 8, !tbaa !40
  %i.alh = getelementptr inbounds nuw i8, ptr %0, i64 96
  store <2 x double> splat (double -inf), ptr %i.alh, align 8, !tbaa !40
  ret ptr %.13
}
...
bb.a:
  ...
  br i1 %i.a, label %_ZN11hb_vector_tIjLb0EE11resize_fullEibb.exit, label %bb.b, !prof !36
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.d = load i32, ptr %i.c, align 4, !tbaa !57   ; 3 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  br i1 %.not.i.i.i, label %_ZN11hb_vector_tIjLb0EE11grow_vectorIjTnPN12hb_enable_ifIXsr3std26is_trivially_constructibleIT_EE5valueEvE4typeELPv0EEEvj11hb_priorityILj0EE.exit.i, label %bb.e, !prof !36
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.e = load ptr, ptr %i.d, align 8, !tbaa !124  ; 5 uses
  %i.f = getelementptr inbounds nuw i8, ptr %i.e, i64 8 ; 2 uses
  %i.g = load i32, ptr %i.f, align 8, !tbaa !144  ; 2 uses
  %.not34 = icmp ult i32 %i.g, %1
  br i1 %.not34, label %bb.e, label %bb.d

bb.d:                                             ; preds = %bb.c
  store i32 %i.g, ptr %2, align 4, !tbaa !51
  %i.h = load ptr, ptr %i.e, align 8, !tbaa !125
  br label %.thread
