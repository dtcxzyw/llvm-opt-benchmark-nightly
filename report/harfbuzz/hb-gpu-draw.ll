...
bb.a:
  ...
  %12 = insertelement <2 x double> %i.a, double %1, i64 1
  %13 = insertelement <2 x double> poison, double %7, i64 0
  %i.b = insertelement <2 x double> %13, double %8, i64 1
  %i.c = insertelement <2 x double> poison, double %7, i64 1
  br label %tailrecurse

tailrecurse:                                      ; preds = %bb.f, %bb.a
  %.tr52 = phi double [ %1, %bb.a ], [ %i.bl, %bb.f ] ; 5 uses
  %.tr53 = phi double [ %2, %bb.a ], [ %34, %bb.f ] ; 5 uses
  %.tr54 = phi double [ %3, %bb.a ], [ %i.bc, %bb.f ] ; 3 uses
  %.tr55 = phi double [ %4, %bb.a ], [ %i.bg, %bb.f ] ; 4 uses
  %.tr56 = phi double [ %5, %bb.a ], [ %20, %bb.f ] ; 3 uses
  %.tr57 = phi double [ %6, %bb.a ], [ %i.ay, %bb.f ] ; 2 uses
  %.tr61 = phi i32 [ %9, %bb.a ], [ %33, %bb.f ]  ; 2 uses
  %i.d = phi <2 x double> [ %12, %bb.a ], [ %35, %bb.f ]
  %14 = phi <2 x double> [ %11, %bb.a ], [ %i.ax, %bb.f ] ; 3 uses
  %i.e = fsub double %.tr54, %.tr52               ; 3 uses
  %i.f = fsub double %.tr55, %.tr53               ; 2 uses
  %15 = fsub <2 x double> %i.b, %14               ; 4 uses
  %i.g = fneg double %i.f                         ; 2 uses
  %16 = extractelement <2 x double> %15, i64 1
  %i.h = fmul double %i.e, %16
  %17 = extractelement <2 x double> %15, i64 0    ; 2 uses
  %i.i = tail call double @llvm.fmuladd.f64(double %i.g, double %17, double %i.h) ; 2 uses
...
_ZL29hb_gpu_cubic_approx_quadratic20hb_gpu_cu2qu_point_tS_S_S_dPS_.exit: ; preds = %tailrecurse
  ...
  %18 = shufflevector <2 x double> %15, <2 x double> <double poison, double f0x3FE5555555555555>, <2 x i32> <i32 1, i32 3>
  %i.q = insertelement <2 x double> poison, double %i.p, i64 0
  %i.r = tail call double @llvm.fmuladd.f64(double %17, double %i.p, double %.tr56) ; 3 uses
  %i.s = fsub double %i.r, %.tr52
  %i.t = insertelement <2 x double> %i.q, double %i.s, i64 1
  %i.u = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %18, <2 x double> %i.t, <2 x double> %i.d) ; 3 uses
...
bb.f:                                             ; preds = %_ZL29hb_gpu_cubic_approx_quadratic20hb_gpu_cu2qu_point_tS_S_S_dPS_.exit.thread
  %i.av = insertelement <2 x double> poison, double %.tr54, i64 0 ; 2 uses
  %i.aw = insertelement <2 x double> %i.av, double %.tr55, i64 1
  %19 = fsub <2 x double> %14, %i.aw              ; 2 uses
  %i.ax = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %15, <2 x double> splat (double 5.000000e-01), <2 x double> %14) ; 6 uses
  %i.ay = extractelement <2 x double> %i.ax, i64 1
  %20 = extractelement <2 x double> %i.ax, i64 0
  %i.az = insertelement <2 x double> %19, double %i.e, i64 1
  %i.ba = insertelement <2 x double> %i.av, double %.tr52, i64 1
  %21 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.az, <2 x double> splat (double 5.000000e-01), <2 x double> %i.ba) ; 4 uses
  %22 = extractelement <2 x double> %21, i64 1
  %23 = shufflevector <2 x double> %i.ax, <2 x double> %21, <2 x i32> <i32 0, i32 2>
  %24 = fsub <2 x double> %23, %21
  %i.bb = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %24, <2 x double> splat (double 5.000000e-01), <2 x double> %21) ; 4 uses
  %i.bc = extractelement <2 x double> %i.bb, i64 0
  %25 = extractelement <2 x double> %i.bb, i64 1
  %26 = shufflevector <2 x double> %19, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %i.bd = insertelement <2 x double> %26, double %i.f, i64 1
  %27 = insertelement <2 x double> poison, double %.tr55, i64 0
  %28 = insertelement <2 x double> %27, double %.tr53, i64 1
  %29 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bd, <2 x double> splat (double 5.000000e-01), <2 x double> %28) ; 4 uses
  %i.be = extractelement <2 x double> %29, i64 1
  %30 = shufflevector <2 x double> %i.ax, <2 x double> %29, <2 x i32> <i32 1, i32 2>
  %31 = fsub <2 x double> %30, %29
  %i.bf = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %31, <2 x double> splat (double 5.000000e-01), <2 x double> %29) ; 4 uses
  %i.bg = extractelement <2 x double> %i.bf, i64 0
  %i.bh = extractelement <2 x double> %i.bf, i64 1
  %i.bi = shufflevector <2 x double> %i.bb, <2 x double> %i.bf, <2 x i32> <i32 0, i32 2>
  %32 = shufflevector <2 x double> %i.bb, <2 x double> %i.bf, <2 x i32> <i32 1, i32 3> ; 2 uses
  %i.bj = fsub <2 x double> %i.bi, %32
  %i.bk = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bj, <2 x double> splat (double 5.000000e-01), <2 x double> %32) ; 3 uses
  %33 = add nuw nsw i32 %.tr61, 1                 ; 2 uses
  %i.bl = extractelement <2 x double> %i.bk, i64 0 ; 2 uses
  %34 = extractelement <2 x double> %i.bk, i64 1  ; 2 uses
  tail call fastcc void @_ZL26hb_gpu_cubic_to_quadraticsP13hb_gpu_draw_t20hb_gpu_cu2qu_point_tS1_S1_S1_dj(ptr noundef %0, double %.tr52, double %.tr53, double %22, double %i.be, double %25, double %i.bh, double %i.bl, double %34, i32 noundef %33)
  %35 = shufflevector <2 x double> %i.ax, <2 x double> %i.bk, <2 x i32> <i32 1, i32 2>
  br label %tailrecurse
