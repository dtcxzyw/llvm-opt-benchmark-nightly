...
bb.a:
  ...
  %i.d = load i32, ptr %i.c, align 4, !tbaa !373  ; 6 uses
...
bb.h:                                             ; preds = %_ZN22hb_serialize_context_t10extend_minIN2OT7VarDataEEEPT_S4_.exit
  ...
  %i.ag = load i32, ptr %i.af, align 4, !tbaa !313 ; 8 uses
...
_ZN11hb_vector_tIZN2OT7VarData9serializeEP22hb_serialize_context_tbRKS_IPKS_IiLb0EELb0EEE12delta_size_tLb0EE14realloc_vectorISA_TnPN12hb_enable_ifIXsr3std28is_trivially_copy_assignableIT_EE5valueEvE4typeELPv0EEEPSA_j11hb_priorityILj0EE.exit.i: ; preds = %.thread.i
  ...
  br i1 %.not22.i, label %_ZN11hb_vector_tIZN2OT7VarData9serializeEP22hb_serialize_context_tbRKS_IPKS_IiLb0EELb0EEE12delta_size_tLb0EED2Ev.exit, label %5, !prof !117
...
.preheader217.lr.ph:                              ; preds = %5, %7
  %9 = load i32, ptr %i.c, align 4, !tbaa !373
...
.preheader217:                                    ; preds = %.preheader217.lr.ph, %.loopexit
  ...
  br i1 %.not.i89.fr, label %.preheader217.split.us, label %.preheader217.split.preheader, !prof !144
...
.preheader217.split:                              ; preds = %.preheader217.split.preheader, %23
  ...
  %.0.i86 = select i1 %.not.i85, ptr %13, ptr @_hb_NullPool, !prof !144
  %14 = load ptr, ptr %.0.i86, align 8, !tbaa !448
  %15 = getelementptr inbounds nuw i8, ptr %14, i64 8
  %16 = load ptr, ptr %15, align 8, !tbaa !384
  %17 = getelementptr inbounds nuw [4 x i8], ptr %16, i64 %indvars.iv279
  %18 = load i32, ptr %17, align 4, !tbaa !139    ; 3 uses
...
.split.us:                                        ; preds = %.preheader217.split, %.preheader217.split.us
  br i1 %.not.i89.fr, label %bb.l, label %21, !prof !144
...
_ZN11hb_vector_tIZN2OT7VarData9serializeEP22hb_serialize_context_tbRKS_IPKS_IiLb0EELb0EEE12delta_size_tLb0EEixEi.exit91: ; preds = %22
  store i32 1, ptr @_hb_CrapPool, align 16, !tbaa !1046
  br label %23

bb.l:                                             ; preds = %.split.us, %21
  %.0.i88 = phi ptr [ @_hb_CrapPool, %21 ], [ %i.aq, %.split.us ]
  store i32 2, ptr %.0.i88, align 4, !tbaa !1046
...
23:                                               ; preds = %22, %_ZN11hb_vector_tIZN2OT7VarData9serializeEP22hb_serialize_context_tbRKS_IPKS_IiLb0EELb0EEE12delta_size_tLb0EEixEi.exit91
  ...
  br i1 %exitcond.not, label %.loopexit, label %.preheader217.split, !llvm.loop !1048
...
bb.g:                                             ; preds = %bb.f
  ...
  br i1 %.not.i92.not, label %_ZN11hb_vector_tIjLb0EE6resizeEi.exit38.thread, label %.preheader.i94, !prof !144
...
_ZN11hb_vector_tIjLb0EE14realloc_vectorIjTnPN12hb_enable_ifIXsr3std28is_trivially_copy_assignableIT_EE5valueEvE4typeELPv0EEEPjj11hb_priorityILj0EE.exit.i: ; preds = %.thread.i96
  ...
  br i1 %.not22.i99, label %_ZN11hb_vector_tIjLb0EE6resizeEi.exit38, label %1, !prof !117
...
_ZN11hb_vector_tIjLb0EE6resizeEi.exit38.thread:   ; preds = %bb.g, %3, %1
  ...
  %i.ar = load i8, ptr %i.ab, align 1, !tbaa !1406, !range !134, !noundef !212
...
begin_hunk_2_@_ZN5graph7graph_t16update_distancesEv:bb.a
  ...
  %i.cp = load i64, ptr %i.co, align 8, !tbaa !1601 ; 3 uses
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.cs = load i64, ptr %i.cr, align 8, !tbaa !1601 ; 2 uses
...
..thread307_crit_edge:                            ; preds = %bb.n
  ...
  %.pre374 = load i64, ptr %.phi.trans.insert373, align 8, !tbaa !1601
  br label %.thread307
...
.thread307:                                       ; preds = %..thread307_crit_edge, %bb.m
  ...
  %.pre377 = load i64, ptr %.phi.trans.insert376, align 8, !tbaa !482
  br label %bb.o
...
bb.o:                                             ; preds = %bb.n, %.thread307
  ...
  store i64 %i.cv, ptr %i.cm, align 8, !tbaa !482
  store i64 %.pre, ptr %i.cw, align 8, !tbaa !482
  %i.cx = getelementptr inbounds nuw i8, ptr %i.cm, i64 8 ; 2 uses
  %i.cy = getelementptr inbounds nuw i8, ptr %i.cw, i64 8 ; 2 uses
  %i.cz = load i32, ptr %i.cx, align 8, !tbaa !139
  %i.da = load i32, ptr %i.cy, align 8, !tbaa !139
  store i32 %i.da, ptr %i.cx, align 8, !tbaa !139
  store i32 %i.cz, ptr %i.cy, align 8, !tbaa !139
...
_ZN19hb_priority_queue_tIlE11pop_minimumEv.exit:  ; preds = %bb.o, %bb.m, %bb.l, %_ZN11hb_vector_tI9hb_pair_tIljELb0EE6resizeEi.exit.thread, %_ZN11hb_vector_tI9hb_pair_tIljELb0EE6resizeEi.exit
  ...
  br i1 %.not.i49, label %bb.q, label %bb.p, !prof !144
...
bb.q:                                             ; preds = %_ZN19hb_priority_queue_tIlE11pop_minimumEv.exit
  ...
  %.pre378 = load i8, ptr %i.dg, align 1, !tbaa !193, !range !134
  br label %_ZN11hb_vector_tIbLb0EEixEi.exit

_ZN11hb_vector_tIbLb0EEixEi.exit:                 ; preds = %bb.p, %bb.q
  %i.dh = phi i8 [ %i.at, %bb.p ], [ %.pre378, %bb.q ]
  %i.di = trunc nuw i8 %i.dh to i1
  br i1 %i.di, label %.loopexit, label %bb.r, !llvm.loop !1631

bb.r:                                             ; preds = %_ZN11hb_vector_tIbLb0EEixEi.exit
  %i.dj = load i32, ptr %i.d, align 4, !tbaa !1412
  %.not.i51 = icmp ult i32 %.sroa.2.0.copyload.i, %i.dj
  br i1 %.not.i51, label %bb.t, label %bb.s, !prof !144
...
bb.t:                                             ; preds = %bb.r
  %i.dk = load ptr, ptr %i.au, align 8, !tbaa !1420
...
_ZN11hb_vector_tIN5graph7graph_t8vertex_tELb0EEixEi.exit53: ; preds = %bb.s, %bb.t
  ...
  %i.do = load i64, ptr %i.dn, align 8, !tbaa !1595
  br i1 %.not.i49, label %bb.v, label %bb.u, !prof !144
...
_ZNK9hb_iter_tI16hb_concat_iter_tI10hb_array_tIKN22hb_serialize_context_t8object_t6link_tEES6_ERS5_E3endEv.exit: ; preds = %bb.u, %bb.v
  ...
  store i8 1, ptr %.0.i55, align 1, !tbaa !193
  %i.dr = getelementptr inbounds nuw i8, ptr %.0.i52, i64 20
  %.val.i = load i32, ptr %i.dr, align 4, !tbaa !266, !noalias !1632 ; 2 uses
  %i.ds = getelementptr inbounds nuw i8, ptr %.0.i52, i64 24
  %.val1.i = load ptr, ptr %i.ds, align 8, !tbaa !267, !noalias !1632 ; 2 uses
  %i.dt = getelementptr inbounds nuw i8, ptr %.0.i52, i64 36
  %.val2.i = load i32, ptr %i.dt, align 4, !tbaa !266, !noalias !1632 ; 2 uses
  %i.du = getelementptr inbounds nuw i8, ptr %.0.i52, i64 40
  %.val3.i = load ptr, ptr %i.du, align 8, !tbaa !267, !noalias !1632 ; 2 uses
  %.sroa.2.8.insert.ext.i.i.i.i.i.i = zext i32 %.val.i to i64
  %.sroa.2.8.insert.ext.i.i.i.i6.i.i = zext i32 %.val2.i to i64
...
_ZNK16hb_concat_iter_tI10hb_array_tIKN22hb_serialize_context_t8object_t6link_tEES5_EneERKS6_.exit.thread: ; preds = %_ZNR9hb_iter_tI16hb_concat_iter_tI10hb_array_tIKN22hb_serialize_context_t8object_t6link_tEES6_ERS5_EppEv.exit
  ...
  %i.ec = load i32, ptr %i.eb, align 4, !tbaa !333 ; 5 uses
  %.not.i60 = icmp ult i32 %i.ec, %.sroa.8161.0
  br i1 %.not.i60, label %bb.x, label %bb.w, !prof !144
...
bb.x:                                             ; preds = %_ZNK16hb_concat_iter_tI10hb_array_tIKN22hb_serialize_context_t8object_t6link_tEES5_EneERKS6_.exit.thread
  ...
  %.pre379 = load i8, ptr %i.ee, align 1, !tbaa !193, !range !134
  br label %_ZN11hb_vector_tIbLb0EEixEi.exit62
...
bb.y:                                             ; preds = %_ZN11hb_vector_tIbLb0EEixEi.exit62
  %i.eh = load ptr, ptr %i.au, align 8, !tbaa !1535
  ...
  %i.ep = load ptr, ptr %i.eo, align 8, !tbaa !1028
  %i.eq = load ptr, ptr %i.ej, align 8, !tbaa !347
  %i.er = ptrtoint ptr %i.ep to i64
  %i.es = ptrtoint ptr %i.eq to i64
  %i.et = getelementptr inbounds nuw i8, ptr %i.ej, i64 64
  %i.eu = load i32, ptr %i.et, align 8, !tbaa !1503
  %i.ev = add i32 %i.eu, 1
  %i.ew = zext i32 %i.ev to i64
  %i.ex = shl nsw i64 %i.ew, %i.en
...
.preheader.i122:                                  ; preds = %bb.ab, %.preheader.i122
  ...
  br i1 %i.fj, label %.preheader.i122, label %.thread.i124, !llvm.loop !1594
...
bb.ae:                                            ; preds = %bb.ad
  ...
  %i.fo = tail call ptr @hb_malloc(i64 noundef %i.fn) #21 ; 4 uses
...
bb.ag:                                            ; preds = %bb.af
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.fo, ptr nonnull readonly align 1 %.sroa.43.1, i64 %i.fq, i1 false), !alias.scope !1635
...
_ZN11hb_vector_tI9hb_pair_tIljELb0EE14realloc_vectorIS1_TnPN12hb_enable_ifIXsr3std28is_trivially_copy_assignableIT_EE5valueEvE4typeELPv0EEEPS1_j11hb_priorityILj0EE.exit.i127: ; preds = %bb.ad, %bb.ac
  ...
  %i.fu = tail call ptr @hb_realloc(ptr noundef %i.fr, i64 noundef %i.ft) #21 ; 2 uses
  %.not22.i128 = icmp eq ptr %i.fu, null
  br i1 %.not22.i128, label %_ZN11hb_vector_tI9hb_pair_tIljELb0EE14realloc_vectorIS1_TnPN12hb_enable_ifIXsr3std28is_trivially_copy_assignableIT_EE5valueEvE4typeELPv0EEEPS1_j11hb_priorityILj0EE.exit.thread53.i134, label %_ZN11hb_vector_tI9hb_pair_tIljELb0EE4pushIJS1_EEEPS1_DpOT_.exit68.thread322, !prof !117
...
_ZN11hb_vector_tI9hb_pair_tIljELb0EE4pushIJS1_EEEPS1_DpOT_.exit68.thread322: ; preds = %bb.af, %bb.ag, %_ZN11hb_vector_tI9hb_pair_tIljELb0EE14realloc_vectorIS1_TnPN12hb_enable_ifIXsr3std28is_trivially_copy_assignableIT_EE5valueEvE4typeELPv0EEEPS1_j11hb_priorityILj0EE.exit.i127, %bb.ab
  ...
  store i64 %i.fa, ptr %i.fx, align 8, !tbaa !482
  %.sroa.4261.0..sroa_idx325 = getelementptr inbounds nuw i8, ptr %i.fx, i64 8
  store i32 %i.ec, ptr %.sroa.4261.0..sroa_idx325, align 8, !tbaa !139
  br label %bb.ah
...
_ZN11hb_vector_tI9hb_pair_tIljELb0EE4pushIJS1_EEEPS1_DpOT_.exit68: ; preds = %bb.z
  ...
  store i64 %i.fa, ptr %i.fz, align 8, !tbaa !482
  %.sroa.4261.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.fz, i64 8
  store i32 %i.ec, ptr %.sroa.4261.0..sroa_idx, align 8, !tbaa !139
  %i.ga = icmp slt i32 %.sroa.0178.1, 0
  br i1 %i.ga, label %_ZN19hb_priority_queue_tIlE6insertElj.exit, label %bb.ah, !prof !1610
...
.lr.ph358:                                        ; preds = %bb.ah, %bb.ai
  ...
  %i.gg = load i64, ptr %i.gf, align 8, !tbaa !1601 ; 2 uses
...
bb.ai:                                            ; preds = %.lr.ph358
  ...
  store i64 %i.gg, ptr %i.gi, align 8, !tbaa !482
  store i64 %i.fa, ptr %i.gf, align 8, !tbaa !482
  %i.gj = getelementptr inbounds nuw i8, ptr %i.gi, i64 8 ; 2 uses
  %i.gk = getelementptr inbounds nuw i8, ptr %i.gf, i64 8 ; 2 uses
  %i.gl = load i32, ptr %i.gj, align 8, !tbaa !139
  %i.gm = load i32, ptr %i.gk, align 8, !tbaa !139
  store i32 %i.gm, ptr %i.gj, align 8, !tbaa !139
  store i32 %i.gl, ptr %i.gk, align 8, !tbaa !139
...
bb.an:                                            ; preds = %_ZN5graph7graph_t13check_successEb.exit73
  tail call void @hb_free(ptr noundef %.sroa.15.1) #21
...
bb.ao:                                            ; preds = %_ZN11hb_vector_tIbLb0EED2Ev.exit
  tail call void @hb_free(ptr noundef %.sroa.43.0339) #21
  br label %_ZN19hb_priority_queue_tIlED2Ev.exit
...
bb.a:
  %i.a = load i32, ptr %0, align 8, !tbaa !1532   ; 7 uses
  %i.b = icmp slt i32 %i.a, 0
  br i1 %i.b, label %bb.n, label %bb.b, !prof !21
