...
bb.ap:                                            ; preds = %bb.b
  ...
  %3 = insertelement <2 x float> poison, float %i.aaa, i64 0
  %i.aag = insertelement <2 x float> %3, float %i.zr, i64 1
  %4 = shufflevector <2 x float> %foldExtExtBinop106, <2 x float> %i.yr, <4 x i32> <i32 0, i32 0, i32 0, i32 2>
  %i.aah = shufflevector <2 x float> %i.zl, <2 x float> %i.aaf, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %5 = shufflevector <2 x float> %i.aad, <2 x float> %i.aag, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.aai = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %4, <4 x float> %i.aah, <4 x float> %5) ; 2 uses
...
bb.aq:                                            ; preds = %bb.b
  ...
  %6 = insertelement <2 x float> poison, float %i.acr, i64 0
  %i.acx = insertelement <2 x float> %6, float %i.aci, i64 1
  %7 = shufflevector <2 x float> %foldExtExtBinop109, <2 x float> %i.abi, <4 x i32> <i32 0, i32 0, i32 0, i32 2>
  %i.acy = shufflevector <2 x float> %i.acc, <2 x float> %i.acw, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %8 = shufflevector <2 x float> %i.acu, <2 x float> %i.acx, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.acz = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %7, <4 x float> %i.acy, <4 x float> %8) ; 2 uses
