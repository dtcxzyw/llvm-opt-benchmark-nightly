...
bb.ag:                                            ; preds = %bb.b
  ...
  %i.ow = select <2 x i1> %i.ol, <2 x float> %i.ov, <2 x float> zeroinitializer ; 2 uses
  ...
  %i.pd = select <2 x i1> %i.ol, <2 x float> %i.pc, <2 x float> zeroinitializer ; 2 uses
  ...
  %i.pf = extractelement <2 x float> %i.oh, i64 1 ; 3 uses
  %i.pg = extractelement <2 x float> %i.oh, i64 0 ; 2 uses
  %3 = shufflevector <2 x float> %i.ow, <2 x float> %i.pd, <2 x i32> <i32 0, i32 2> ; 2 uses
  %4 = shufflevector <2 x float> %i.ow, <2 x float> %i.pd, <2 x i32> <i32 1, i32 3> ; 2 uses
  %5 = fmul <2 x float> %3, %4
  %i.ph = fadd float %i.pg, %i.pf
  ...
  %foldExtExtBinop97 = fmul <2 x float> %i.oh, %shift96 ; 2 uses
  %6 = fmul float %i.pg, %i.pf                    ; 2 uses
  %i.pj = extractelement <2 x float> %i.pi, i64 0
  %i.pk = fmul float %i.pj, %i.pf
  %foldExtExtBinop99 = fmul <2 x float> %foldExtExtBinop97, %i.ou
  %i.pl = extractelement <2 x float> %foldExtExtBinop99, i64 0
  %7 = shufflevector <2 x float> %foldExtExtBinop97, <2 x float> poison, <2 x i32> zeroinitializer
  %foldExtExtBinop103 = fmul <2 x float> %7, %3
  %8 = tail call float @llvm.fmuladd.f32(float %6, float %i.pe, float %i.pl)
  %9 = insertelement <2 x float> poison, float %6, i64 0
  %10 = shufflevector <2 x float> %9, <2 x float> poison, <2 x i32> zeroinitializer
  %11 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %10, <2 x float> %5, <2 x float> %foldExtExtBinop103)
  ...
  %i.pp = insertelement <2 x float> poison, float %8, i64 0
  %i.pq = insertelement <2 x float> %i.pp, float %i.ph, i64 1
  %12 = shufflevector <2 x float> %i.pm, <2 x float> %i.oh, <4 x i32> <i32 0, i32 0, i32 0, i32 3>
  %13 = shufflevector <2 x float> %4, <2 x float> %i.po, <4 x i32> <i32 1, i32 0, i32 2, i32 3>
  %14 = shufflevector <2 x float> %11, <2 x float> %i.pq, <4 x i32> <i32 1, i32 0, i32 2, i32 3>
  %15 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %12, <4 x float> %13, <4 x float> %14) ; 2 uses
  %i.pr = fcmp oge <4 x float> %15, zeroinitializer
  %i.ps = select <4 x i1> %i.pr, <4 x float> %15, <4 x float> zeroinitializer ; 2 uses
...
bb.ai:                                            ; preds = %bb.b
  ...
  %16 = fcmp ogt <2 x float> %i.tr, zeroinitializer ; 3 uses
  ...
  %18 = select <2 x i1> %17, <2 x float> %i.ub, <2 x float> zeroinitializer ; 5 uses
  ...
  %19 = shufflevector <2 x i1> %16, <2 x i1> poison, <2 x i32> <i32 1, i32 1>
  %20 = select <2 x i1> %19, <2 x float> %i.uf, <2 x float> zeroinitializer ; 4 uses
  ...
  %i.um = select <2 x i1> %16, <2 x float> %i.ul, <2 x float> zeroinitializer ; 5 uses
  %i.un = extractelement <2 x float> %20, i64 1   ; 2 uses
  %i.uo = fcmp ugt float %i.un, 5.000000e-01
  br i1 %i.uo, label %bb.ak, label %bb.aj

bb.aj:                                            ; preds = %bb.ai
  %i.up = extractelement <2 x float> %18, i64 1
  %i.uq = fmul float %i.up, 2.000000e+00
  %i.ur = fmul float %i.uq, %i.un
  br label %_ZL13blend_overlayff.exit188.i

bb.ak:                                            ; preds = %bb.ai
  %i.us = shufflevector <2 x float> %18, <2 x float> %20, <2 x i32> <i32 1, i32 3>
...
bb.am:                                            ; preds = %_ZL13blend_overlayff.exit188.i
  %i.ve = extractelement <2 x float> %18, i64 0
...
_ZL13blend_overlayff.exit.i:                      ; preds = %bb.ao, %bb.an
  ...
  %i.wh = shufflevector <2 x float> %18, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  ...
  %i.wv = shufflevector <2 x float> %i.um, <2 x float> %20, <4 x i32> <i32 1, i32 2, i32 3, i32 poison>
...
bb.ar:                                            ; preds = %bb.b
  ...
  %i.add = fdiv <2 x float> %i.adc, splat (float 2.550000e+02) ; 8 uses
  %i.ade = extractelement <2 x float> %i.add, i64 0 ; 3 uses
  %i.adf = fcmp ogt float %i.ade, 0.000000e+00    ; 2 uses
  %21 = shufflevector <2 x float> %i.add, <2 x float> poison, <2 x i32> zeroinitializer
  %22 = insertelement <2 x i1> poison, i1 %i.adf, i64 0
  %23 = shufflevector <2 x i1> %22, <2 x i1> poison, <2 x i32> zeroinitializer
  %24 = extractelement <2 x float> %i.add, i64 1  ; 3 uses
  %25 = fcmp ogt float %24, 0.000000e+00          ; 2 uses
  %26 = insertelement <4 x i32> poison, i32 %i.acv, i64 0
  %27 = insertelement <4 x i32> %26, i32 %i.acz, i64 1
  %28 = insertelement <4 x i32> %27, i32 %i.acu, i64 2
  %29 = insertelement <4 x i32> %28, i32 %i.acy, i64 3
  %30 = and <4 x i32> %29, splat (i32 255)
  %31 = uitofp nneg <4 x i32> %30 to <4 x float>  ; 2 uses
  %32 = shufflevector <4 x float> %31, <4 x float> poison, <2 x i32> <i32 2, i32 0>
  %i.adg = fdiv <2 x float> %32, splat (float 2.550000e+02)
  %33 = fdiv <2 x float> %i.adg, %21
  %34 = select <2 x i1> %23, <2 x float> %33, <2 x float> zeroinitializer ; 3 uses
  %35 = shufflevector <4 x float> %31, <4 x float> poison, <2 x i32> <i32 3, i32 1>
  %36 = fdiv <2 x float> %35, splat (float 2.550000e+02)
  %37 = shufflevector <2 x float> %i.add, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %38 = fdiv <2 x float> %36, %37
  %39 = insertelement <2 x i1> poison, i1 %25, i64 0
  %40 = shufflevector <2 x i1> %39, <2 x i1> poison, <2 x i32> zeroinitializer
  %41 = select <2 x i1> %40, <2 x float> %38, <2 x float> zeroinitializer ; 3 uses
  %i.adh = uitofp nneg i32 %i.acx to float
  %i.adi = uitofp nneg i32 %i.act to float
  ...
  %i.adm = fdiv <2 x float> %i.adl, %i.add        ; 2 uses
  %42 = extractelement <2 x float> %i.adm, i64 0
  %43 = select i1 %i.adf, float %42, float 0.000000e+00 ; 3 uses
  %44 = extractelement <2 x float> %i.adm, i64 1
  %i.adn = select i1 %25, float %44, float 0.000000e+00 ; 3 uses
  %i.ado = extractelement <2 x float> %41, i64 1  ; 2 uses
  %i.adp = fcmp ugt float %i.ado, 0.000000e+00
  br i1 %i.adp, label %bb.as, label %_ZL17blend_color_dodgeff.exit201.i

bb.as:                                            ; preds = %bb.ar
  %i.adq = extractelement <2 x float> %34, i64 1  ; 2 uses
...
_ZL17blend_color_dodgeff.exit201.i:               ; preds = %bb.at, %bb.as, %bb.ar
  ...
  %i.adv = extractelement <2 x float> %41, i64 0  ; 2 uses
...
bb.au:                                            ; preds = %_ZL17blend_color_dodgeff.exit201.i
  %i.adx = extractelement <2 x float> %34, i64 0  ; 2 uses
...
_ZL17blend_color_dodgeff.exit.i:                  ; preds = %bb.ax, %bb.aw, %_ZL17blend_color_dodgeff.exit198.i
  ...
  %i.aeo = fmul float %i.aen, %24
  %i.aep = insertelement <4 x float> <float poison, float poison, float poison, float 1.000000e+00>, float %43, i64 0
  %i.aeq = shufflevector <2 x float> %34, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  ...
  %i.aff = shufflevector <2 x float> %41, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
...
bb.ay:                                            ; preds = %bb.b
  ...
  %i.aga = fdiv <2 x float> %i.afz, splat (float 2.550000e+02) ; 8 uses
  %i.agb = extractelement <2 x float> %i.aga, i64 0 ; 3 uses
  %i.agc = fcmp ogt float %i.agb, 0.000000e+00    ; 2 uses
  %45 = shufflevector <2 x float> %i.aga, <2 x float> poison, <2 x i32> zeroinitializer
  %46 = insertelement <2 x i1> poison, i1 %i.agc, i64 0
  %47 = shufflevector <2 x i1> %46, <2 x i1> poison, <2 x i32> zeroinitializer
  %48 = extractelement <2 x float> %i.aga, i64 1  ; 3 uses
  %49 = fcmp ogt float %48, 0.000000e+00          ; 2 uses
  %50 = insertelement <4 x i32> poison, i32 %i.afs, i64 0
  %51 = insertelement <4 x i32> %50, i32 %i.afw, i64 1
  %52 = insertelement <4 x i32> %51, i32 %i.afr, i64 2
  %53 = insertelement <4 x i32> %52, i32 %i.afv, i64 3
  %54 = and <4 x i32> %53, splat (i32 255)
  %55 = uitofp nneg <4 x i32> %54 to <4 x float>  ; 2 uses
  %56 = shufflevector <4 x float> %55, <4 x float> poison, <2 x i32> <i32 2, i32 0>
  %i.agd = fdiv <2 x float> %56, splat (float 2.550000e+02)
  %57 = fdiv <2 x float> %i.agd, %45
  %58 = select <2 x i1> %47, <2 x float> %57, <2 x float> zeroinitializer ; 3 uses
  %59 = shufflevector <4 x float> %55, <4 x float> poison, <2 x i32> <i32 3, i32 1>
  %60 = fdiv <2 x float> %59, splat (float 2.550000e+02)
  %61 = shufflevector <2 x float> %i.aga, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %62 = fdiv <2 x float> %60, %61
  %63 = insertelement <2 x i1> poison, i1 %49, i64 0
  %64 = shufflevector <2 x i1> %63, <2 x i1> poison, <2 x i32> zeroinitializer
  %65 = select <2 x i1> %64, <2 x float> %62, <2 x float> zeroinitializer ; 3 uses
  %i.age = uitofp nneg i32 %i.afu to float
  %i.agf = uitofp nneg i32 %i.afq to float
  ...
  %i.agj = fdiv <2 x float> %i.agi, %i.aga        ; 2 uses
  %66 = extractelement <2 x float> %i.agj, i64 0
  %67 = select i1 %i.agc, float %66, float 0.000000e+00 ; 3 uses
  %68 = extractelement <2 x float> %i.agj, i64 1
  %i.agk = select i1 %49, float %68, float 0.000000e+00 ; 3 uses
  %i.agl = extractelement <2 x float> %65, i64 1  ; 2 uses
  %i.agm = fcmp ult float %i.agl, 1.000000e+00
  br i1 %i.agm, label %bb.az, label %_ZL16blend_color_burnff.exit209.i

bb.az:                                            ; preds = %bb.ay
  %i.agn = extractelement <2 x float> %58, i64 1  ; 2 uses
...
_ZL16blend_color_burnff.exit209.i:                ; preds = %bb.ba, %bb.az, %bb.ay
  ...
  %i.agt = extractelement <2 x float> %65, i64 0  ; 2 uses
...
bb.bb:                                            ; preds = %_ZL16blend_color_burnff.exit209.i
  %i.agv = extractelement <2 x float> %58, i64 0  ; 2 uses
...
_ZL16blend_color_burnff.exit.i:                   ; preds = %bb.be, %bb.bd, %_ZL16blend_color_burnff.exit206.i
  ...
  %i.aho = fmul float %i.ahn, %48
  %i.ahp = insertelement <4 x float> <float poison, float poison, float poison, float 1.000000e+00>, float %67, i64 0
  %i.ahq = shufflevector <2 x float> %58, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  ...
  %i.aif = shufflevector <2 x float> %65, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
...
bb.bf:                                            ; preds = %bb.b
  ...
  %69 = fcmp ogt <2 x float> %i.aja, zeroinitializer ; 3 uses
  ...
  %71 = select <2 x i1> %70, <2 x float> %i.ajk, <2 x float> zeroinitializer ; 4 uses
  ...
  %72 = shufflevector <2 x i1> %69, <2 x i1> poison, <2 x i32> <i32 1, i32 1>
  %73 = select <2 x i1> %72, <2 x float> %i.ajo, <2 x float> zeroinitializer ; 5 uses
  ...
  %i.ajv = select <2 x i1> %69, <2 x float> %i.aju, <2 x float> zeroinitializer ; 5 uses
  %i.ajw = extractelement <2 x float> %71, i64 1  ; 2 uses
  %i.ajx = fcmp ugt float %i.ajw, 5.000000e-01
  br i1 %i.ajx, label %bb.bh, label %bb.bg

bb.bg:                                            ; preds = %bb.bf
  %i.ajy = fmul nnan float %i.ajw, 2.000000e+00
  %i.ajz = extractelement <2 x float> %73, i64 1
  %i.aka = fmul float %i.ajy, %i.ajz
  br label %_ZL16blend_hard_lightff.exit211.i

bb.bh:                                            ; preds = %bb.bf
  %i.akb = shufflevector <2 x float> %71, <2 x float> %73, <2 x i32> <i32 1, i32 3>
...
_ZL16blend_hard_lightff.exit211.i:                ; preds = %bb.bh, %bb.bg
  ...
  %i.aki = extractelement <2 x float> %71, i64 0  ; 3 uses
...
bb.bi:                                            ; preds = %_ZL16blend_hard_lightff.exit211.i
  ...
  %i.akl = extractelement <2 x float> %73, i64 0
...
bb.bj:                                            ; preds = %_ZL16blend_hard_lightff.exit211.i
  ...
  %i.ako = extractelement <2 x float> %73, i64 0
...
_ZL16blend_hard_lightff.exit.i:                   ; preds = %bb.bl, %bb.bk
  ...
  %i.alq = shufflevector <2 x float> %71, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  ...
  %i.ame = shufflevector <2 x float> %i.ajv, <2 x float> %73, <4 x i32> <i32 1, i32 2, i32 3, i32 poison>
...
bb.bm:                                            ; preds = %bb.b
  ...
  %i.amy = fdiv <2 x float> %i.amx, splat (float 2.550000e+02) ; 8 uses
  %i.amz = extractelement <2 x float> %i.amy, i64 0 ; 3 uses
  %i.ana = fcmp ogt float %i.amz, 0.000000e+00    ; 2 uses
  %74 = shufflevector <2 x float> %i.amy, <2 x float> poison, <2 x i32> zeroinitializer
  %75 = insertelement <2 x i1> poison, i1 %i.ana, i64 0
  %76 = shufflevector <2 x i1> %75, <2 x i1> poison, <2 x i32> zeroinitializer
  %77 = extractelement <2 x float> %i.amy, i64 1  ; 3 uses
  %78 = fcmp ogt float %77, 0.000000e+00          ; 2 uses
  %79 = insertelement <4 x i32> poison, i32 %i.amq, i64 0
  %80 = insertelement <4 x i32> %79, i32 %i.amu, i64 1
  %81 = insertelement <4 x i32> %80, i32 %i.amp, i64 2
  %82 = insertelement <4 x i32> %81, i32 %i.amt, i64 3
  %83 = and <4 x i32> %82, splat (i32 255)
  %84 = uitofp nneg <4 x i32> %83 to <4 x float>  ; 2 uses
  %85 = shufflevector <4 x float> %84, <4 x float> poison, <2 x i32> <i32 2, i32 0>
  %i.anb = fdiv <2 x float> %85, splat (float 2.550000e+02)
  %86 = fdiv <2 x float> %i.anb, %74
  %87 = select <2 x i1> %76, <2 x float> %86, <2 x float> zeroinitializer ; 3 uses
  %88 = shufflevector <4 x float> %84, <4 x float> poison, <2 x i32> <i32 3, i32 1>
  %89 = fdiv <2 x float> %88, splat (float 2.550000e+02)
  %90 = shufflevector <2 x float> %i.amy, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %91 = fdiv <2 x float> %89, %90
  %92 = insertelement <2 x i1> poison, i1 %78, i64 0
  %93 = shufflevector <2 x i1> %92, <2 x i1> poison, <2 x i32> zeroinitializer
  %94 = select <2 x i1> %93, <2 x float> %91, <2 x float> zeroinitializer ; 5 uses
  %i.anc = uitofp nneg i32 %i.ams to float
  %i.and = uitofp nneg i32 %i.amo to float
  ...
  %i.anh = fdiv <2 x float> %i.ang, %i.amy        ; 2 uses
  %95 = extractelement <2 x float> %i.anh, i64 0
  %96 = select i1 %i.ana, float %95, float 0.000000e+00 ; 4 uses
  %97 = extractelement <2 x float> %i.anh, i64 1
  %i.ani = select i1 %78, float %97, float 0.000000e+00 ; 11 uses
  %i.anj = extractelement <2 x float> %87, i64 1  ; 3 uses
...
bb.bn:                                            ; preds = %bb.bm
  ...
  %i.anm = extractelement <2 x float> %94, i64 1  ; 3 uses
...
bb.bo:                                            ; preds = %bb.bm
  %i.anr = extractelement <2 x float> %94, i64 1  ; 7 uses
...
_ZL16blend_soft_lightff.exit216.i:                ; preds = %bb.br, %bb.bn
  ...
  %i.aoa = extractelement <2 x float> %87, i64 0  ; 3 uses
...
bb.bs:                                            ; preds = %_ZL16blend_soft_lightff.exit216.i
  ...
  %i.aod = extractelement <2 x float> %94, i64 0  ; 3 uses
...
bb.bt:                                            ; preds = %_ZL16blend_soft_lightff.exit216.i
  %i.aoi = extractelement <2 x float> %94, i64 0  ; 7 uses
...
_ZL16blend_soft_lightff.exit214.i:                ; preds = %bb.bw, %bb.bs
  ...
  %i.aor = fcmp ugt float %96, 5.000000e-01
  br i1 %i.aor, label %bb.by, label %bb.bx

bb.bx:                                            ; preds = %_ZL16blend_soft_lightff.exit214.i
  %i.aos = tail call nnan float @llvm.fmuladd.f32(float %96, float -2.000000e+00, float 1.000000e+00)
...
bb.cb:                                            ; preds = %bb.ca, %bb.bz
  ...
  %i.apc = tail call float @llvm.fmuladd.f32(float %96, float 2.000000e+00, float -1.000000e+00)
...
_ZL16blend_soft_lightff.exit.i:                   ; preds = %bb.cb, %bb.bx
  ...
  %i.apm = fmul float %i.apl, %77
  %i.apn = insertelement <4 x float> <float poison, float poison, float poison, float 1.000000e+00>, float %96, i64 0
  %i.apo = shufflevector <2 x float> %87, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  ...
  %i.aqd = shufflevector <2 x float> %94, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
