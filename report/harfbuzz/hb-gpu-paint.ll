...
bb.f:                                             ; preds = %.lr.ph, %bb.e
  ...
  %6 = insertelement <4 x i32> %5, i32 %i.cv, i64 1
  %i.cw = insertelement <4 x i32> %6, i32 %i.cu, i64 2
  %i.cx = insertelement <4 x i32> %i.cw, i32 %3, i64 3
  %7 = and <4 x i32> %i.cx, <i32 255, i32 255, i32 -1, i32 255>
  %8 = mul nuw nsw <4 x i32> %7, splat (i32 32767)
  %i.cy = add nuw nsw <4 x i32> %8, splat (i32 127)
