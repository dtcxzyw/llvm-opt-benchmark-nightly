...
bb.w:                                             ; preds = %_ZNK5graph20LigatureSubstFormat123current_liga_set_boundsERNS_24gsubgpos_graph_context_tEjRKN22hb_serialize_context_t8object_tE.exit
  ...
  %i.ez = load ptr, ptr %i.l, align 8, !tbaa !545, !nonnull !312, !align !313
...
.critedge.i.i.i.i.i.i:                            ; preds = %bb.ac, %.lr.ph.i.i.i.i.i.i, %.preheader.i.i.i.i.i.i
  ...
  br i1 %i.gd, label %.preheader.i.i.i.i.i.i, label %_ZN11hb_vector_tIN22hb_serialize_context_t8object_t6link_tELb0EE5qsortEv.exit.i, !llvm.loop !855
...
bb.ac:                                            ; preds = %.lr.ph.i.i.i.i.i.i
  ...
  br i1 %i.gf, label %.lr.ph.i.i.i.i.i.i, label %.critedge.i.i.i.i.i.i, !llvm.loop !856
...
.lr.ph.i177.epil.preheader:                       ; preds = %._crit_edge.loopexit.i178.unr-lcssa, %.lr.ph.i177.preheader
  %.022.i.epil.init = phi i32 [ 2, %.lr.ph.i177.preheader ], [ %i.hn, %._crit_edge.loopexit.i178.unr-lcssa ]
  %.01821.i.epil.init = phi ptr [ %i.gg, %.lr.ph.i177.preheader ], [ %i.ho, %._crit_edge.loopexit.i178.unr-lcssa ]
...
.lr.ph.i177.epil:                                 ; preds = %.lr.ph.i177.epil, %.lr.ph.i177.epil.preheader
  %.022.i.epil = phi i32 [ %i.go, %.lr.ph.i177.epil ], [ %.022.i.epil.init, %.lr.ph.i177.epil.preheader ] ; 2 uses
  %.01821.i.epil = phi ptr [ %i.gp, %.lr.ph.i177.epil ], [ %.01821.i.epil.init, %.lr.ph.i177.epil.preheader ] ; 2 uses
  %epil.iter = phi i64 [ %epil.iter.next, %.lr.ph.i177.epil ], [ 0, %.lr.ph.i177.epil.preheader ]
  %i.gn = getelementptr inbounds nuw i8, ptr %.01821.i.epil, i64 4
  store i32 %.022.i.epil, ptr %i.gn, align 4, !tbaa !443
  %i.go = add i32 %.022.i.epil, 2
  %i.gp = getelementptr inbounds nuw i8, ptr %.01821.i.epil, i64 12
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter444
  br i1 %epil.iter.cmp.not, label %._crit_edge.loopexit.i178, label %.lr.ph.i177.epil, !llvm.loop !1879
...
.lr.ph.i177:                                      ; preds = %.lr.ph.i177, %.lr.ph.i177.preheader.new
  %.022.i = phi i32 [ 2, %.lr.ph.i177.preheader.new ], [ %i.hn, %.lr.ph.i177 ] ; 9 uses
  %.01821.i = phi ptr [ %i.gg, %.lr.ph.i177.preheader.new ], [ %i.ho, %.lr.ph.i177 ] ; 9 uses
  %niter448 = phi i64 [ 0, %.lr.ph.i177.preheader.new ], [ %niter448.next.7, %.lr.ph.i177 ]
  %i.gy = getelementptr inbounds nuw i8, ptr %.01821.i, i64 4
  store i32 %.022.i, ptr %i.gy, align 4, !tbaa !443
  %i.gz = add nuw nsw i32 %.022.i, 2
  %i.ha = getelementptr inbounds nuw i8, ptr %.01821.i, i64 16
  store i32 %i.gz, ptr %i.ha, align 4, !tbaa !443
  %i.hb = add nuw nsw i32 %.022.i, 4
  %i.hc = getelementptr inbounds nuw i8, ptr %.01821.i, i64 28
  store i32 %i.hb, ptr %i.hc, align 4, !tbaa !443
  %i.hd = add nuw nsw i32 %.022.i, 6
  %i.he = getelementptr inbounds nuw i8, ptr %.01821.i, i64 40
  store i32 %i.hd, ptr %i.he, align 4, !tbaa !443
  %i.hf = add nuw nsw i32 %.022.i, 8
  %i.hg = getelementptr inbounds nuw i8, ptr %.01821.i, i64 52
  store i32 %i.hf, ptr %i.hg, align 4, !tbaa !443
  %i.hh = add nuw nsw i32 %.022.i, 10
  %i.hi = getelementptr inbounds nuw i8, ptr %.01821.i, i64 64
  store i32 %i.hh, ptr %i.hi, align 4, !tbaa !443
  %i.hj = add nuw nsw i32 %.022.i, 12
  %i.hk = getelementptr inbounds nuw i8, ptr %.01821.i, i64 76
  store i32 %i.hj, ptr %i.hk, align 4, !tbaa !443
  %i.hl = add i32 %.022.i, 14
  %i.hm = getelementptr inbounds nuw i8, ptr %.01821.i, i64 88
  store i32 %i.hl, ptr %i.hm, align 4, !tbaa !443
  %i.hn = add i32 %.022.i, 16                     ; 2 uses
  %i.ho = getelementptr inbounds nuw i8, ptr %.01821.i, i64 96 ; 2 uses
...
bb.ad:                                            ; preds = %_ZNK5graph20LigatureSubstFormat123current_liga_set_boundsERNS_24gsubgpos_graph_context_tEjRKN22hb_serialize_context_t8object_tE.exit
  ...
  %i.hp = sub nuw i32 %.sroa.speculated266, %.0115330 ; 2 uses
  %.sroa.speculated257 = call i32 @llvm.umin.i32(i32 %5, i32 %.sroa.speculated)
  %i.hq = sub i32 %.sroa.speculated257, %.0115330 ; 2 uses
...
bb.ae:                                            ; preds = %bb.ad
  %i.hw = load ptr, ptr %i.l, align 8, !tbaa !545, !nonnull !312, !align !313 ; 2 uses
  ...
  %i.ig = load ptr, ptr %i.l, align 8, !tbaa !545, !nonnull !312, !align !313
  %i.ih = shl i32 %i.hp, 1
  %i.ii = add i32 %i.ih, 2
  %i.ij = shl i32 %i.hq, 1
  %i.ik = add i32 %i.ij, 2
  ...
  %spec.select154 = call i32 @llvm.umin.i32(i32 %i.il, i32 %.0126328)
  %i.im = load ptr, ptr %i.l, align 8, !tbaa !545, !nonnull !312, !align !313 ; 3 uses
  %i.in = load i16, ptr %i.v, align 1, !tbaa !255
  %i.io = call noundef i16 @llvm.bswap.i16(i16 %i.in)
  %i.ip = zext i16 %i.io to i32
  %.not.i183 = icmp ult i32 %.0119329, %i.ip
...
bb.ag:                                            ; preds = %bb.ae
  call void asm sideeffect "", "~{memory},~{dirflag},~{fpsr},~{flags}"() #15, !srcloc !254
  %i.iq = zext nneg i32 %.0119329 to i64
...
_ZN11hb_vector_tIN22hb_serialize_context_t8object_t6link_tELb0EE4pushEv.exit.i: ; preds = %bb.ao, %bb.an
  ...
  %i.ju = load ptr, ptr %.0.i.i187, align 8, !tbaa !552
...
_ZNK5graph20LigatureSubstFormat116compact_liga_setERNS_24gsubgpos_graph_context_tEPNS_11LigatureSetERN22hb_serialize_context_t8object_tE.exit: ; preds = %bb.ar, %._crit_edge.i, %_ZN2OT7ArrayOfINS_8OffsetToINS_6Layout9GSUB_impl11LigatureSetINS2_10SmallTypesEEENS_7NumTypeILb1EtLj2EEEvLb1EEES8_EixEi.exit
  %.0143 = phi i32 [ %i.hu, %bb.ar ], [ %i.fj, %_ZN2OT7ArrayOfINS_8OffsetToINS_6Layout9GSUB_impl11LigatureSetINS2_10SmallTypesEEENS_7NumTypeILb1EtLj2EEEvLb1EEES8_EixEi.exit ], [ %i.fj, %._crit_edge.i ] ; 8 uses
  %.4130 = phi i32 [ %spec.select154, %bb.ar ], [ %spec.select, %_ZN2OT7ArrayOfINS_8OffsetToINS_6Layout9GSUB_impl11LigatureSetINS2_10SmallTypesEEENS_7NumTypeILb1EtLj2EEEvLb1EEES8_EixEi.exit ], [ %spec.select, %._crit_edge.i ] ; 2 uses
  %.2121 = add i32 %.0119329, 1                   ; 2 uses
  %i.kf = load ptr, ptr %i.l, align 8, !tbaa !545, !nonnull !312, !align !313 ; 3 uses
  %i.kg = getelementptr inbounds nuw i8, ptr %i.kf, i64 4
  %i.kh = load i32, ptr %i.kg, align 4, !tbaa !473
  %.not.i188 = icmp ult i32 %.0143, %i.kh
...
_ZN11hb_vector_tIN5graph7graph_t8vertex_tELb0EEixEi.exit190: ; preds = %_ZNK5graph20LigatureSubstFormat116compact_liga_setERNS_24gsubgpos_graph_context_tEPNS_11LigatureSetERN22hb_serialize_context_t8object_tE.exit
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(216) @_hb_CrapPool, ptr noundef nonnull align 16 dereferenceable(216) @_hb_NullPool, i64 216, i1 false)
  %.pre346 = load ptr, ptr %i.l, align 8, !tbaa !545 ; 2 uses
...
.lr.ph.i195:                                      ; preds = %_ZN11hb_vector_tIN5graph7graph_t8vertex_tELb0EEixEi.exit.i192, %_ZN11hb_vector_tIN5graph7graph_t8vertex_tELb0EEixEi.exit15.i
  ...
  %i.ky = load ptr, ptr %i.l, align 8, !tbaa !545, !nonnull !312, !align !313 ; 2 uses
