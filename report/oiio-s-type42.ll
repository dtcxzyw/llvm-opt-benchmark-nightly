...
172:                                              ; preds = %169
  ...
  %174 = load i32, ptr %173, align 8, !tbaa !109  ; [#uses=1 type=i32]
  %.fr117.i = freeze i32 %174                     ; [#uses=3 type=i32]
  %175 = getelementptr inbounds nuw i8, ptr %1, i64 640 ; [#uses=1 type=ptr]
  store i32 %.fr117.i, ptr %175, align 8, !tbaa !110
...
begin_hunk_1
  ...
  %202 = icmp sgt i32 %.fr117.i, 0                ; [#uses=1 type=i1]
  %wide.trip.count136.i = zext nneg i32 %194 to i64 ; [#uses=4 type=i64]
...
.lr.ph114.split.i.preheader:                      ; preds = %.lr.ph114.i
  ...
  br i1 %min.iters.check, label %.lr.ph114.split.i.preheader221, label %vector.ph

vector.ph:                                        ; preds = %.lr.ph114.split.i.preheader
  %n.vec = and i64 %wide.trip.count136.i, 2147483644 ; [#uses=3 type=i64]
...
middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %n.vec, %wide.trip.count136.i ; [#uses=1 type=i1]
  br i1 %cmp.n, label %._crit_edge.i, label %.lr.ph114.split.i.preheader221

.lr.ph114.split.i.preheader221:                   ; preds = %.lr.ph114.split.i.preheader, %middle.block
...
.lr.ph114.split.us.preheader.i:                   ; preds = %.lr.ph114.i
  %wide.trip.count131.i = zext nneg i32 %.fr117.i to i64 ; [#uses=1 type=i64]
  br label %.lr.ph114.split.us.i

.lr.ph114.split.us.i:                             ; preds = %.thread.us.i, %.lr.ph114.split.us.preheader.i
  %indvars.iv133.i = phi i64 [ 0, %.lr.ph114.split.us.preheader.i ], [ %indvars.iv.next134.i, %.thread.us.i ] ; [#uses=5 type=i64]
  ...
  %208 = getelementptr inbounds nuw [8 x i8], ptr %197, i64 %indvars.iv133.i ; [#uses=1 type=ptr]
  %209 = load ptr, ptr %208, align 8, !tbaa !124  ; [#uses=2 type=ptr]
  %210 = getelementptr inbounds nuw [2 x i8], ptr %199, i64 %indvars.iv133.i ; [#uses=2 type=ptr]
  store i16 0, ptr %210, align 2, !tbaa !123
  %211 = getelementptr inbounds nuw [8 x i8], ptr %201, i64 %indvars.iv133.i ; [#uses=2 type=ptr]
...
.preheader.us.i:                                  ; preds = %.lr.ph114.split.us.i, %216
  %indvars.iv128.i = phi i64 [ %indvars.iv.next129.i, %216 ], [ 0, %.lr.ph114.split.us.i ] ; [#uses=3 type=i64]
  %212 = getelementptr inbounds nuw [8 x i8], ptr %188, i64 %indvars.iv128.i ; [#uses=1 type=ptr]
...
216:                                              ; preds = %.preheader.us.i
  %indvars.iv.next129.i = add nuw nsw i64 %indvars.iv128.i, 1 ; [#uses=2 type=i64]
  %exitcond132.not.i = icmp eq i64 %indvars.iv.next129.i, %wide.trip.count131.i ; [#uses=1 type=i1]
  br i1 %exitcond132.not.i, label %.thread.us.i, label %.preheader.us.i, !llvm.loop !128

217:                                              ; preds = %.preheader.us.i
  %218 = trunc i64 %indvars.iv128.i to i16        ; [#uses=1 type=i16]
...
220:                                              ; preds = %217
  %221 = trunc i64 %indvars.iv133.i to i32        ; [#uses=2 type=i32]
...
.thread.us.i:                                     ; preds = %216, %220, %217, %.lr.ph114.split.us.i
  ...
  %indvars.iv.next134.i = add nuw nsw i64 %indvars.iv133.i, 1 ; [#uses=2 type=i64]
  %exitcond137.not.i = icmp eq i64 %indvars.iv.next134.i, %wide.trip.count136.i ; [#uses=1 type=i1]
  br i1 %exitcond137.not.i, label %._crit_edge.i, label %.lr.ph114.split.us.i, !llvm.loop !129

.lr.ph114.split.i:                                ; preds = %.lr.ph114.split.i.preheader221, %.lr.ph114.split.i
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %.lr.ph114.split.i ], [ %indvars.iv.i.ph, %.lr.ph114.split.i.preheader221 ] ; [#uses=3 type=i64]
  ...
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %wide.trip.count136.i ; [#uses=1 type=i1]
