...
begin_hunk_1
  ...
  %202 = icmp sgt i32 %.fr117.i, 0
  %wide.trip.count136.i = zext nneg i32 %194 to i64 ; 4 uses
...
vector.ph:                                        ; preds = %.lr.ph114.split.i.preheader
  %n.vec = and i64 %wide.trip.count136.i, 2147483644 ; 3 uses
...
middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %n.vec, %wide.trip.count136.i
...
.lr.ph114.split.us.preheader.i:                   ; preds = %.lr.ph114.i
  %wide.trip.count131.i = zext nneg i32 %.fr117.i to i64
  br label %.lr.ph114.split.us.i

.lr.ph114.split.us.i:                             ; preds = %.thread.us.i, %.lr.ph114.split.us.preheader.i
  %indvars.iv133.i = phi i64 [ 0, %.lr.ph114.split.us.preheader.i ], [ %indvars.iv.next134.i, %.thread.us.i ] ; 5 uses
  ...
  %208 = getelementptr inbounds nuw [8 x i8], ptr %197, i64 %indvars.iv133.i
  %209 = load ptr, ptr %208, align 8, !tbaa !124  ; 2 uses
  %210 = getelementptr inbounds nuw [2 x i8], ptr %199, i64 %indvars.iv133.i ; 2 uses
  store i16 0, ptr %210, align 2, !tbaa !123
  %211 = getelementptr inbounds nuw [8 x i8], ptr %201, i64 %indvars.iv133.i ; 2 uses
...
.preheader.us.i:                                  ; preds = %.lr.ph114.split.us.i, %216
  %indvars.iv128.i = phi i64 [ %indvars.iv.next129.i, %216 ], [ 0, %.lr.ph114.split.us.i ] ; 3 uses
  %212 = getelementptr inbounds nuw [8 x i8], ptr %188, i64 %indvars.iv128.i
...
217:                                              ; preds = %.preheader.us.i
  %218 = trunc i64 %indvars.iv128.i to i16
...
220:                                              ; preds = %217
  %221 = trunc i64 %indvars.iv133.i to i32        ; 2 uses
...
.lr.ph114.split.i:                                ; preds = %.lr.ph114.split.i.preheader221, %.lr.ph114.split.i
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %.lr.ph114.split.i ], [ %indvars.iv.i.ph, %.lr.ph114.split.i.preheader221 ] ; 3 uses
  ...
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %wide.trip.count136.i
