...
bb.h:                                             ; preds = %bb.g, %bb.f, %._crit_edge.i.i
  ...
  %i.au = load i64, ptr %i.k, align 8, !tbaa !49  ; 11 uses
...
.preheader:                                       ; preds = %bb.aj
  ...
  br i1 %.not357, label %._crit_edge.i.i.i.thread, label %.lr.ph346
...
bb.ak:                                            ; preds = %.lr.ph346
  ...
  br i1 %exitcond411.not, label %.critedge, label %.lr.ph346, !llvm.loop !346

.critedge:                                        ; preds = %.lr.ph346, %bb.ak
  %.072.lcssa = phi i64 [ %i.au, %bb.ak ], [ %.072345, %.lr.ph346 ] ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #26
  %i.eb = add i64 %.072.lcssa, -2                 ; 4 uses
  ...
  store i64 %i.eb, ptr %i.c, align 8, !tbaa !81, !noalias !352
  %i.ed = icmp ugt i64 %i.eb, 15
...
.noexc138:                                        ; preds = %.noexc10.i.i
  store ptr %i.ee, ptr %5, align 8, !tbaa !50, !alias.scope !352
  %i.ef = load i64, ptr %i.c, align 8, !tbaa !81, !noalias !352
  store i64 %i.ef, ptr %i.ad, align 8, !tbaa !42, !alias.scope !352
  br label %._crit_edge.i.i.i

._crit_edge.i.i.i:                                ; preds = %.noexc138, %.critedge
  %i.eg = phi ptr [ %i.ee, %.noexc138 ], [ %i.ad, %.critedge ] ; 2 uses
  switch i64 %i.eb, label %bb.am [
    i64 1, label %bb.al
    i64 0, label %bb.an
  ]
...
bb.am:                                            ; preds = %._crit_edge.i.i.i
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %i.eg, ptr nonnull align 1 %i.ec, i64 %i.eb, i1 false)
  br label %bb.an

bb.an:                                            ; preds = %._crit_edge.i.i.i.thread, %bb.am, %bb.al, %._crit_edge.i.i.i
  %.072.lcssa478480 = phi i64 [ 2, %._crit_edge.i.i.i.thread ], [ %.072.lcssa, %bb.am ], [ %.072.lcssa, %bb.al ], [ %.072.lcssa, %._crit_edge.i.i.i ]
  %i.ei = load i64, ptr %i.c, align 8, !tbaa !81, !noalias !352 ; 2 uses
  store i64 %i.ei, ptr %i.ae, align 8, !tbaa !49, !alias.scope !352
  %i.ej = load ptr, ptr %5, align 8, !tbaa !50, !alias.scope !352
  ...
  %i.el = add i64 %.072.lcssa478480, 1            ; 3 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8_M_checkEmPKc.exit.i.i139: ; preds = %bb.an
  ...
  %i.en = load ptr, ptr %4, align 8, !tbaa !50, !noalias !353
  ...
  store i64 %i.ep, ptr %i.b, align 8, !tbaa !81, !noalias !353
...
.noexc144:                                        ; preds = %.noexc10.i.i142
  store ptr %i.er, ptr %6, align 8, !tbaa !50, !alias.scope !353
  %i.es = load i64, ptr %i.b, align 8, !tbaa !81, !noalias !353
  store i64 %i.es, ptr %i.af, align 8, !tbaa !42, !alias.scope !353
...
.thread231:                                       ; preds = %bb.ap, %bb.ao, %._crit_edge.i.i.i141
  %i.ev = load i64, ptr %i.b, align 8, !tbaa !81, !noalias !353 ; 2 uses
  store i64 %i.ev, ptr %i.ag, align 8, !tbaa !49, !alias.scope !353
  %i.ew = load ptr, ptr %6, align 8, !tbaa !50, !alias.scope !353
...
_ZN4DataD2Ev.exit:                                ; preds = %_ZNSt6vectorIhSaIhEED2Ev.exit2.i, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i
  ...
  br i1 %i.pc, label %.peel.next, label %.loopexit, !llvm.loop !350
