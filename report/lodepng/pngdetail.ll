...
bb.c:                                             ; preds = %bb.b, %bb.a
  %.0101.a = phi i8 [ %0, %bb.a ], [ %i.e, %bb.b ] ; 9 uses
  %.0100.a = phi i8 [ %1, %bb.a ], [ %i.i, %bb.b ] ; 8 uses
  %.099 = phi i8 [ %2, %bb.a ], [ %i.m, %bb.b ]   ; 6 uses
  %i.n = zext i8 %.0101.a to i32                  ; 4 uses
  %i.o = zext i8 %.0100.a to i32                  ; 4 uses
  %i.p = zext i8 %.099 to i32                     ; 4 uses
  %i.q = tail call i8 @llvm.umax.i8(i8 %.0100.a, i8 %.099) ; 3 uses
  %i.r = tail call i8 @llvm.umax.i8(i8 %.0101.a, i8 %i.q) ; 6 uses
  br i1 %6, label %bb.d, label %bb.ad

bb.d:                                             ; preds = %bb.c
  %.sroa.speculated29.i = zext i8 %i.r to i32
  %i.s = tail call i8 @llvm.umin.i8(i8 %.099, i8 %.0100.a)
...
bb.e:                                             ; preds = %bb.d
  %.not.i.i = icmp ult i8 %.0101.a, %i.q
...
_Z8RGBtoHSLhhhPhS_S_.exit.i:                      ; preds = %bb.d, %bb.j
  %.098 = phi i32 [ %i.ai, %bb.j ], [ 0, %bb.d ]
  %.sroa.speculated75 = tail call i8 @llvm.umax.i8(i8 %.0101.a, i8 %.0100.a)
  %.sroa.speculated60 = tail call i8 @llvm.umax.i8(i8 %.sroa.speculated75, i8 %.099)
  %i.aj = zext i8 %.sroa.speculated60 to i32
  %.sroa.speculated72 = tail call i8 @llvm.umin.i8(i8 %.0100.a, i8 %.0101.a)
  %.sroa.speculated = tail call i8 @llvm.umin.i8(i8 %.099, i8 %.sroa.speculated72)
...
bb.ad:                                            ; preds = %bb.c
  %i.cm = tail call i8 @llvm.umin.i8(i8 %.099, i8 %.0100.a)
  %i.cn = tail call i8 @llvm.umin.i8(i8 %i.cm, i8 %.0101.a) ; 2 uses
...
_Z11HueToLetteri.exit44.thread:                   ; preds = %bb.ad
  ...
  %spec.select107116 = xor i8 %.0101.a, %i.cp
  br label %bb.at
...
_ZNSolsEPFRSoS_E.exit89.preheader:                ; preds = %_ZNSolsEPFRSoS_E.exit89.preheader.preheader, %_ZNSolsEPFRSoS_E.exit107
  %.058169 = phi i32 [ %i.hu, %_ZNSolsEPFRSoS_E.exit107 ], [ 0, %_ZNSolsEPFRSoS_E.exit89.preheader.preheader ] ; 4 uses
...
bb.ac:                                            ; preds = %bb.ab, %bb.aa
  %.0101.i.a = phi i8 [ %i.cz, %bb.aa ], [ %i.dq, %bb.ab ] ; 6 uses
  %.0100.i.a = phi i8 [ %i.dd, %bb.aa ], [ %i.du, %bb.ab ] ; 6 uses
  %.099.i = phi i8 [ %i.dh, %bb.aa ], [ %i.dy, %bb.ab ] ; 5 uses
  %i.dz = zext i8 %.0101.i.a to i32               ; 2 uses
  %i.ea = zext i8 %.0100.i.a to i32               ; 2 uses
  %i.eb = zext i8 %.099.i to i32                  ; 2 uses
  %i.ec = call i8 @llvm.umax.i8(i8 %.0100.i.a, i8 %.099.i) ; 2 uses
  %i.ed = call i8 @llvm.umax.i8(i8 %.0101.i.a, i8 %i.ec) ; 3 uses
  %.sroa.speculated29.i.i = zext i8 %i.ed to i32
  %i.ee = call i8 @llvm.umin.i8(i8 %.099.i, i8 %.0100.i.a)
...
bb.ad:                                            ; preds = %bb.ac
  %.not.i.i.i100 = icmp ult i8 %.0101.i.a, %i.ec
...
_Z8RGBtoHSLhhhPhS_S_.exit.i.i:                    ; preds = %bb.ai, %bb.ac
  ...
  %.sroa.speculated75.i = call i8 @llvm.umax.i8(i8 %.0101.i.a, i8 %.0100.i.a)
  %.sroa.speculated60.i = call i8 @llvm.umax.i8(i8 %.sroa.speculated75.i, i8 %.099.i)
  %i.ev = zext i8 %.sroa.speculated60.i to i32
  %.sroa.speculated72.i = call i8 @llvm.umin.i8(i8 %.0100.i.a, i8 %.0101.i.a)
...
_ZNSt6vectorImSaImEEC2EmRKmRKS0_.exit._crit_edge: ; preds = %_ZNSt6vectorImSaImEEC2EmRKmRKS0_.exit, %.lr.ph.i.i.i.i.i.i.i.i.i.preheader
  %.023.lcssa = phi i64 [ 0, %.lr.ph.i.i.i.i.i.i.i.i.i.preheader ], [ %spec.select, %_ZNSt6vectorImSaImEEC2EmRKmRKS0_.exit ] ; 2 uses
...
bb.i:                                             ; preds = %.lr.ph, %_ZNSt6vectorImSaImEEC2EmRKmRKS0_.exit
  %.022121 = phi i64 [ 0, %.lr.ph ], [ %i.an, %_ZNSt6vectorImSaImEEC2EmRKmRKS0_.exit ] ; 2 uses
  %.023120 = phi i64 [ 0, %.lr.ph ], [ %spec.select, %_ZNSt6vectorImSaImEEC2EmRKmRKS0_.exit ]
  %i.ae = load ptr, ptr %3, align 8, !tbaa !117
  %i.af = load i32, ptr %i.y, align 4, !tbaa !170
  %i.ag = invoke noundef i32 @_ZN7lodepng15getPaletteValueEPKhmi(ptr noundef nonnull %i.ae, i64 noundef %.022121, i32 noundef %i.af)
...
_ZNSt6vectorImSaImEEC2EmRKmRKS0_.exit:            ; preds = %bb.i
  ...
  %spec.select = add i64 %.023120, %i.am          ; 2 uses
  %i.an = add nuw nsw i64 %.022121, 1             ; 2 uses
...
.lr.ph123:                                        ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit.preheader, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit40
  %.021122 = phi i64 [ %i.bp, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit40 ], [ 0, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit.preheader ] ; 2 uses
  %i.bl = getelementptr inbounds nuw [8 x i8], ptr %i.u, i64 %.021122
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit40: ; preds = %_ZNSolsEm.exit
  %i.bp = add nuw i64 %.021122, 1                 ; 2 uses
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit42: ; preds = %bb.o
  %i.bu = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo9_M_insertImEERSoT_(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i64 noundef %.023.lcssa)
