...
.preheader77:                                     ; preds = %bb.o, %bb.p
  %.sroa.18118.1 = phi double [ 9.999990e+05, %bb.o ], [ %.sroa.speculated75.2, %bb.p ]
  %.sroa.13103.1 = phi double [ 9.999990e+05, %bb.o ], [ %.sroa.speculated75.2.a, %bb.p ]
  %.sroa.097.1 = phi double [ 0.000000e+00, %bb.o ], [ %.sroa.speculated.2.a, %bb.p ]
  %.sroa.0.1 = phi double [ 0.000000e+00, %bb.o ], [ %.sroa.speculated.2, %bb.p ]
  %.04880 = phi i32 [ 0, %bb.o ], [ %i.eh, %bb.p ] ; 2 uses
  %2 = phi <2 x double> [ <double 9.999990e+05, double 0.000000e+00>, %bb.o ], [ %49, %bb.p ]
  %i.cy = phi <2 x double> [ <double 9.999990e+05, double 0.000000e+00>, %bb.o ], [ %i.eg, %bb.p ]
  %3 = phi <4 x double> [ zeroinitializer, %bb.o ], [ %56, %bb.p ]
...
.preheader:                                       ; preds = %bb.p
  ...
  %4 = extractelement <4 x double> %56, i64 0
  %i.dd = fdiv double %4, %i.dc
  %i.de = fdiv double %.sroa.speculated75.2.a, 2.570000e+02
  %i.df = fdiv double %.sroa.speculated.2.a, 2.570000e+02
  %5 = extractelement <4 x double> %56, i64 1
  %i.dg = fdiv double %5, %i.dc
  %i.dh = fdiv <2 x double> %49, splat (double 2.570000e+02) ; 2 uses
  %6 = extractelement <4 x double> %56, i64 2
  %i.di = fdiv double %6, %i.dc
  %i.dj = fdiv double %.sroa.speculated75.2, 2.570000e+02
  %i.dk = fdiv double %.sroa.speculated.2, 2.570000e+02
  %7 = extractelement <4 x double> %56, i64 3
  %i.dl = fdiv double %7, %i.dc
...
.preheader76:                                     ; preds = %.preheader77, %.preheader76
  %.sroa.18118.0 = phi double [ %.sroa.18118.1, %.preheader77 ], [ %.sroa.speculated75.2, %.preheader76 ] ; 2 uses
  %.sroa.13103.0 = phi double [ %.sroa.13103.1, %.preheader77 ], [ %.sroa.speculated75.2.a, %.preheader76 ] ; 2 uses
  %.sroa.097.0 = phi double [ %.sroa.097.1, %.preheader77 ], [ %.sroa.speculated.2.a, %.preheader76 ] ; 2 uses
  %.sroa.0.0 = phi double [ %.sroa.0.1, %.preheader77 ], [ %.sroa.speculated.2, %.preheader76 ] ; 2 uses
  %indvars.iv = phi i64 [ 0, %.preheader77 ], [ %indvars.iv.next, %.preheader76 ] ; 2 uses
  %8 = phi <2 x double> [ %2, %.preheader77 ], [ %49, %.preheader76 ] ; 3 uses
  %i.dp = phi <2 x double> [ %i.cy, %.preheader77 ], [ %i.eg, %.preheader76 ] ; 3 uses
  %9 = phi <4 x double> [ %3, %.preheader77 ], [ %56, %.preheader76 ]
  ...
  %10 = getelementptr inbounds nuw i8, ptr %i.cx, i64 %i.dr
  %11 = getelementptr inbounds nuw i8, ptr %10, i64 1
  %i.dt = getelementptr inbounds nuw i8, ptr %i.cx, i64 %i.dr
  %i.du = getelementptr inbounds nuw i8, ptr %i.dt, i64 2
  %12 = getelementptr inbounds nuw i8, ptr %i.cx, i64 %i.dr
  %13 = getelementptr inbounds nuw i8, ptr %12, i64 3
  %14 = getelementptr inbounds nuw i8, ptr %i.cx, i64 %i.dr
  %15 = getelementptr inbounds nuw i8, ptr %14, i64 4
  %16 = getelementptr inbounds nuw i8, ptr %i.cx, i64 %i.dr
  %17 = getelementptr inbounds nuw i8, ptr %16, i64 5
  %18 = getelementptr inbounds nuw i8, ptr %i.cx, i64 %i.dr
  %19 = getelementptr inbounds nuw i8, ptr %18, i64 6
  %20 = getelementptr inbounds nuw i8, ptr %i.cx, i64 %i.dr
  %i.dv = getelementptr inbounds nuw i8, ptr %20, i64 7
  %21 = load i8, ptr %i.dv, align 1, !tbaa !34
  %i.dw = load i8, ptr %19, align 1, !tbaa !34
  %22 = load i8, ptr %17, align 1, !tbaa !34
  %23 = load i8, ptr %15, align 1, !tbaa !34
  %24 = load i8, ptr %13, align 1, !tbaa !34
  %25 = load i8, ptr %i.du, align 1, !tbaa !34
  %i.dx = load i8, ptr %11, align 1, !tbaa !34
  %26 = load i8, ptr %i.ds, align 1, !tbaa !34
  %27 = zext i8 %i.dw to i32
  ...
  %38 = or disjoint i32 %31, %35
  %39 = or disjoint i32 %32, %36
  %40 = or disjoint i32 %33, %37
  %41 = or disjoint i32 %34, %i.dy
  %42 = uitofp nneg i32 %38 to double             ; 3 uses
  %43 = uitofp nneg i32 %39 to double             ; 5 uses
  %i.dz = uitofp nneg i32 %40 to double           ; 3 uses
  %44 = uitofp nneg i32 %41 to double             ; 5 uses
  %i.ea = fcmp ogt double %.sroa.13103.0, %44
  %.sroa.speculated75.2.a = select i1 %i.ea, double %44, double %.sroa.13103.0 ; 3 uses
  %i.eb = fcmp olt double %.sroa.097.0, %44
  %.sroa.speculated.2.a = select i1 %i.eb, double %44, double %.sroa.097.0 ; 3 uses
  %45 = insertelement <2 x double> %8, double %i.dz, i64 1 ; 2 uses
  %46 = insertelement <2 x double> %8, double %i.dz, i64 0
  %47 = fcmp ogt <2 x double> %45, %46
  %48 = shufflevector <2 x double> %45, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %49 = select <2 x i1> %47, <2 x double> %48, <2 x double> %8 ; 3 uses
  %50 = fcmp ogt double %.sroa.18118.0, %43
  %.sroa.speculated75.2 = select i1 %50, double %43, double %.sroa.18118.0 ; 3 uses
  %51 = fcmp olt double %.sroa.0.0, %43
  %.sroa.speculated.2 = select i1 %51, double %43, double %.sroa.0.0 ; 3 uses
  %52 = insertelement <4 x double> poison, double %44, i64 0
  %53 = insertelement <4 x double> %52, double %i.dz, i64 1
  %54 = insertelement <4 x double> %53, double %43, i64 2
  %55 = insertelement <4 x double> %54, double %42, i64 3
  %56 = fadd <4 x double> %9, %55                 ; 6 uses
  %i.ec = insertelement <2 x double> %i.dp, double %42, i64 1 ; 2 uses
  %i.ed = insertelement <2 x double> %i.dp, double %42, i64 0
  %i.ee = fcmp ogt <2 x double> %i.ec, %i.ed
  %i.ef = shufflevector <2 x double> %i.ec, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.eg = select <2 x i1> %i.ee, <2 x double> %i.ef, <2 x double> %i.dp ; 3 uses
