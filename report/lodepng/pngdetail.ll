...
.preheader190.lr.ph:                              ; preds = %_ZNSt6vectorIhSaIhEEC2EmRKS0_.exit182
  ...
  %8 = insertelement <2 x i32> %7, i32 %4, i64 1
  ...
  %i.ax = shufflevector <2 x double> %9, <2 x double> poison, <2 x i32> zeroinitializer
  %13 = shufflevector <2 x double> %9, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  ...
  %14 = shufflevector <2 x double> %12, <2 x double> poison, <2 x i32> <i32 1, i32 1>
...
.lr.ph207.split.us:                               ; preds = %.lr.ph207
  ...
  %i.cq = load ptr, ptr %1, align 8, !tbaa !100   ; 2 uses
...
.peel.next:                                       ; preds = %.lr.ph203.us, %.peel.next
  ...
  br i1 %i.dv, label %.peel.next, label %._crit_edge204.us, !llvm.loop !175
...
._crit_edge204.us:                                ; preds = %.peel.next, %.lr.ph203.us
  ...
  store i8 %i.eb, ptr %i.ee, align 1, !tbaa !42
...
.lr.ph207.split:                                  ; preds = %.lr.ph207.split.preheader, %.lr.ph207.split
  ...
  store i8 0, ptr %i.el, align 1, !tbaa !42
  ...
  store i8 0, ptr %i.et, align 1, !tbaa !42
...
._crit_edge221.split:                             ; preds = %..loopexit_crit_edge, %.preheader
  ...
  br i1 %i.fb, label %.preheader190, label %._crit_edge224, !llvm.loop !178
...
.lr.ph213.us:                                     ; preds = %.lr.ph213.us.preheader, %._crit_edge214.us
  ...
  %i.gu = load i8, ptr %i.gt, align 1, !tbaa !42
...
.peel.next271:                                    ; preds = %.lr.ph213.us, %.peel.next271
  ...
  %i.hf = load i8, ptr %i.he, align 1, !tbaa !42
  ...
  br i1 %i.hk, label %.peel.next271, label %._crit_edge214.us, !llvm.loop !179
...
._crit_edge214.us:                                ; preds = %.peel.next271, %.lr.ph213.us
  ...
  store i8 %i.hp, ptr %i.hs, align 1, !tbaa !42
...
.lr.ph217.split:                                  ; preds = %.lr.ph217.split.preheader, %.lr.ph217.split
  ...
  store i8 0, ptr %i.hy, align 1, !tbaa !42
...
vector.body:                                      ; preds = %vector.main.loop.iter.check, %vector.body
  ...
  %wide.load = load <16 x i8>, ptr %i.je, align 1, !tbaa !42
  %wide.load315 = load <16 x i8>, ptr %i.jf, align 1, !tbaa !42
  %i.jg = getelementptr i8, ptr %invariant.gep307, i64 %index ; 2 uses
  %i.jh = getelementptr i8, ptr %i.jg, i64 16
  store <16 x i8> %wide.load, ptr %i.jg, align 1, !tbaa !42
  store <16 x i8> %wide.load315, ptr %i.jh, align 1, !tbaa !42
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.ji = icmp eq i64 %index.next, %n.vec
  br i1 %i.ji, label %middle.block, label %vector.body, !llvm.loop !182
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load318 = load <4 x i8>, ptr %i.jj, align 1, !tbaa !42
  %i.jk = getelementptr i8, ptr %invariant.gep307, i64 %index317
  store <4 x i8> %wide.load318, ptr %i.jk, align 1, !tbaa !42
  %index.next319 = add nuw i64 %index317, 4       ; 2 uses
  %i.jl = icmp eq i64 %index.next319, %n.vec316
  br i1 %i.jl, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !183
