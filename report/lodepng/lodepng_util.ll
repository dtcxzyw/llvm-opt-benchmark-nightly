...
begin_hunk_0_@_ZN7lodepngL8parseICCEPNS_10LodePNGICCEPKhm:bb.a
  %i.kx = add nuw nsw i64 %.0.i256, 36            ; 2 uses
  %i.ky = icmp samesign ugt i64 %i.kx, %2
  br i1 %i.ky, label %_ZN7lodepngL18decodeICC15Fixed16EPKhmPm.exit292.6, label %bb.am

bb.am:                                            ; preds = %_ZN7lodepngL18decodeICC15Fixed16EPKhmPm.exit292.5
  %i.kz = getelementptr inbounds nuw i8, ptr %1, i64 %i.kq
  %i.la = load i32, ptr %i.kz, align 1
  %i.lb = tail call i32 @llvm.bswap.i32(i32 %i.la)
  %i.lc = sitofp i32 %i.lb to float
  %i.ld = fmul nnan float %i.lc, f0x37800000
...
_ZN7lodepngL18decodeICC15Fixed16EPKhmPm.exit292.6: ; preds = %bb.am, %_ZN7lodepngL18decodeICC15Fixed16EPKhmPm.exit292.5
  %.0.i.i291.6 = phi float [ %i.ld, %bb.am ], [ 0.000000e+00, %_ZN7lodepngL18decodeICC15Fixed16EPKhmPm.exit292.5 ]
  store float %.0.i.i291.6, ptr %i.dt, align 8, !tbaa !82
  %i.le = add nuw nsw i64 %.0.i256, 40            ; 2 uses
  %i.lf = icmp samesign ugt i64 %i.le, %2
  br i1 %i.lf, label %_ZN7lodepngL18decodeICC15Fixed16EPKhmPm.exit292.7, label %bb.an

bb.an:                                            ; preds = %_ZN7lodepngL18decodeICC15Fixed16EPKhmPm.exit292.6
  %i.lg = getelementptr inbounds nuw i8, ptr %1, i64 %i.kx
  %i.lh = load i32, ptr %i.lg, align 1
  %i.li = tail call i32 @llvm.bswap.i32(i32 %i.lh)
  %i.lj = sitofp i32 %i.li to float
  %i.lk = fmul nnan float %i.lj, f0x37800000
...
_ZN7lodepngL18decodeICC15Fixed16EPKhmPm.exit292.7: ; preds = %bb.an, %_ZN7lodepngL18decodeICC15Fixed16EPKhmPm.exit292.6
  %.0.i.i291.7 = phi float [ %i.lk, %bb.an ], [ 0.000000e+00, %_ZN7lodepngL18decodeICC15Fixed16EPKhmPm.exit292.6 ]
  store float %.0.i.i291.7, ptr %i.du, align 4, !tbaa !82
  %i.ll = add nuw nsw i64 %.0.i256, 44            ; 2 uses
  %i.lm = icmp samesign ugt i64 %i.ll, %2
  br i1 %i.lm, label %_ZN7lodepngL18decodeICC15Fixed16EPKhmPm.exit292.8, label %bb.ao

bb.ao:                                            ; preds = %_ZN7lodepngL18decodeICC15Fixed16EPKhmPm.exit292.7
  %i.ln = getelementptr inbounds nuw i8, ptr %1, i64 %i.le
  %i.lo = load i32, ptr %i.ln, align 1
  %i.lp = tail call i32 @llvm.bswap.i32(i32 %i.lo)
  %i.lq = sitofp i32 %i.lp to float
  %i.lr = fmul nnan float %i.lq, f0x37800000
...
_ZN7lodepngL18decodeICC15Fixed16EPKhmPm.exit292.8: ; preds = %bb.ao, %_ZN7lodepngL18decodeICC15Fixed16EPKhmPm.exit292.7
  %.0.i.i291.8 = phi float [ %i.lr, %bb.ao ], [ 0.000000e+00, %_ZN7lodepngL18decodeICC15Fixed16EPKhmPm.exit292.7 ]
  store float %.0.i.i291.8, ptr %i.dv, align 8, !tbaa !82
  store i32 1, ptr %i.e, align 4, !tbaa !86
  br label %.critedge

bb.ap:                                            ; preds = %_ZN7lodepngL9isICCwordEPKhmmPKc.exit284.thread
  %i.ls = tail call fastcc noundef i32 @_ZN7lodepngL9isICCwordEPKhmmPKc(ptr noundef %1, i64 noundef %2, i64 noundef %.0363399, ptr noundef nonnull @.str.9)
  %.not233 = icmp eq i32 %i.ls, 0
  br i1 %.not233, label %bb.aq, label %bb.at

bb.aq:                                            ; preds = %bb.ap
  %i.lt = tail call fastcc noundef i32 @_ZN7lodepngL9isICCwordEPKhmmPKc(ptr noundef %1, i64 noundef %2, i64 noundef %.0363399, ptr noundef nonnull @.str.10)
  %.not234 = icmp eq i32 %i.lt, 0
  br i1 %.not234, label %bb.ar, label %bb.at

bb.ar:                                            ; preds = %bb.aq
  %i.lu = tail call fastcc noundef i32 @_ZN7lodepngL9isICCwordEPKhmmPKc(ptr noundef %1, i64 noundef %2, i64 noundef %.0363399, ptr noundef nonnull @.str.11)
  %.not235 = icmp eq i32 %i.lu, 0
  br i1 %.not235, label %bb.as, label %bb.at

bb.as:                                            ; preds = %bb.ar
  %i.lv = tail call fastcc noundef i32 @_ZN7lodepngL9isICCwordEPKhmmPKc(ptr noundef %1, i64 noundef %2, i64 noundef %.0363399, ptr noundef nonnull @.str.12)
  %.not236 = icmp eq i32 %i.lv, 0
  br i1 %.not236, label %.critedge, label %bb.at

bb.at:                                            ; preds = %bb.as, %bb.ar, %bb.aq, %bb.ap
  %i.lw = getelementptr inbounds nuw i8, ptr %1, i64 %.0363399
  %i.lx = load i8, ptr %i.lw, align 1, !tbaa !20  ; 2 uses
  %i.ly = icmp eq i8 %i.lx, 98
  %i.lz = icmp eq i8 %i.lx, 103
  %i.ma = zext i1 %i.lz to i32
  %i.mb = select i1 %i.ly, i32 2, i32 %i.ma       ; 2 uses
  %i.mc = tail call fastcc noundef i32 @_ZN7lodepngL9isICCwordEPKhmmPKc(ptr noundef %1, i64 noundef %2, i64 noundef %.0.i256, ptr noundef nonnull @.str.13)
  %.not237 = icmp eq i32 %i.mc, 0
  br i1 %.not237, label %.loopexit, label %bb.au

bb.au:                                            ; preds = %bb.at
  %i.md = zext nneg i32 %i.mb to i64
  %i.me = getelementptr inbounds nuw [56 x i8], ptr %i.f, i64 %i.md ; 6 uses
  store i32 1, ptr %i.d, align 4, !tbaa !81
  %i.mf = add nuw nsw i64 %.0.i256, 12            ; 6 uses
  %i.mg = icmp samesign ugt i64 %i.mf, %2
  br i1 %i.mg, label %_ZN7lodepngL15decodeICCUint32EPKhmPm.exit294.thread, label %_ZN7lodepngL15decodeICCUint32EPKhmPm.exit294

_ZN7lodepngL15decodeICCUint32EPKhmPm.exit294:     ; preds = %bb.au
  %i.mh = getelementptr inbounds nuw i8, ptr %1, i64 %.0.i256
  %i.mi = getelementptr inbounds nuw i8, ptr %i.mh, i64 8
  %i.mj = load i32, ptr %i.mi, align 1
  %i.mk = tail call i32 @llvm.bswap.i32(i32 %i.mj) ; 4 uses
  %i.ml = zext i32 %i.mk to i64                   ; 4 uses
  switch i32 %i.mk, label %bb.ax [
...
_ZN7lodepngL15decodeICCUint32EPKhmPm.exit294.thread: ; preds = %bb.au, %_ZN7lodepngL15decodeICCUint32EPKhmPm.exit294
  store i32 0, ptr %i.me, align 8, !tbaa !87
  br label %.loopexit

bb.av:                                            ; preds = %_ZN7lodepngL15decodeICCUint32EPKhmPm.exit294
  store i32 2, ptr %i.me, align 8, !tbaa !87
  %i.mm = add nuw nsw i64 %.0.i256, 14            ; 2 uses
  %i.mn = icmp samesign ugt i64 %i.mm, %2
  br i1 %i.mn, label %_ZN7lodepngL15decodeICCUint16EPKhmPm.exit, label %bb.aw

bb.aw:                                            ; preds = %bb.av
  %i.mo = getelementptr inbounds nuw i8, ptr %1, i64 %i.mf ; 2 uses
  %i.mp = load i8, ptr %i.mo, align 1, !tbaa !20
  %i.mq = zext i8 %i.mp to i32
  %i.mr = shl nuw nsw i32 %i.mq, 8
  %i.ms = getelementptr i8, ptr %i.mo, i64 1
  %i.mt = load i8, ptr %i.ms, align 1, !tbaa !20
  %i.mu = zext i8 %i.mt to i32
  %i.mv = or disjoint i32 %i.mr, %i.mu
  %i.mw = uitofp nneg i32 %i.mv to float
  %i.mx = fmul nnan float %i.mw, 3.906250e-03
  br label %_ZN7lodepngL15decodeICCUint16EPKhmPm.exit

_ZN7lodepngL15decodeICCUint16EPKhmPm.exit:        ; preds = %bb.av, %bb.aw
  %.0.i295 = phi float [ %i.mx, %bb.aw ], [ 0.000000e+00, %bb.av ]
  %i.my = getelementptr inbounds nuw i8, ptr %i.me, i64 24
  store float %.0.i295, ptr %i.my, align 8, !tbaa !92
  br label %.loopexit

bb.ax:                                            ; preds = %_ZN7lodepngL15decodeICCUint32EPKhmPm.exit294
  store i32 1, ptr %i.me, align 8, !tbaa !87
  %i.mz = shl nuw nsw i64 %i.ml, 1
  %i.na = add nuw nsw i64 %i.mz, %i.mf
  %i.nb = icmp samesign ugt i64 %i.na, %2
  %i.nc = icmp ugt i32 %i.mk, 16777216
  %or.cond = or i1 %i.nc, %i.nb
  br i1 %or.cond, label %.critedge243, label %.lr.ph.preheader

.lr.ph.preheader:                                 ; preds = %bb.ax
  %i.nd = getelementptr inbounds nuw i8, ptr %i.me, i64 16
  store i64 %i.ml, ptr %i.nd, align 8, !tbaa !93
  %i.ne = shl nuw nsw i64 %i.ml, 2
  %i.nf = tail call noalias noundef ptr @malloc(i64 noundef %i.ne) #32 ; 4 uses
  %i.ng = getelementptr inbounds nuw i8, ptr %i.me, i64 8
  store ptr %i.nf, ptr %i.ng, align 8, !tbaa !69
  %umax = tail call i64 @llvm.umax.i64(i64 %i.ml, i64 1) ; 3 uses
  %xtraiter = and i64 %umax, 1
  %i.nh = icmp ult i32 %i.mk, 2
  br i1 %i.nh, label %.lr.ph.epil.preheader, label %.lr.ph.preheader.new
...
.lr.ph:                                           ; preds = %_ZN7lodepngL15decodeICCUint16EPKhmPm.exit297.1, %.lr.ph.preheader.new
  %.1213398 = phi i64 [ 0, %.lr.ph.preheader.new ], [ %i.oj, %_ZN7lodepngL15decodeICCUint16EPKhmPm.exit297.1 ] ; 3 uses
  %.1397 = phi i64 [ %i.mf, %.lr.ph.preheader.new ], [ %i.nv, %_ZN7lodepngL15decodeICCUint16EPKhmPm.exit297.1 ] ; 3 uses
  %niter = phi i64 [ 0, %.lr.ph.preheader.new ], [ %niter.next.1, %_ZN7lodepngL15decodeICCUint16EPKhmPm.exit297.1 ]
  %i.ni = add nuw nsw i64 %.1397, 2               ; 2 uses
  %i.nj = icmp samesign ugt i64 %i.ni, %2
  br i1 %i.nj, label %_ZN7lodepngL15decodeICCUint16EPKhmPm.exit297, label %bb.ay

bb.ay:                                            ; preds = %.lr.ph
  %i.nk = getelementptr inbounds nuw i8, ptr %1, i64 %.1397 ; 2 uses
  %i.nl = load i8, ptr %i.nk, align 1, !tbaa !20
  %i.nm = zext i8 %i.nl to i32
  %i.nn = shl nuw nsw i32 %i.nm, 8
  %i.no = getelementptr i8, ptr %i.nk, i64 1
  %i.np = load i8, ptr %i.no, align 1, !tbaa !20
  %i.nq = zext i8 %i.np to i32
  %i.nr = or disjoint i32 %i.nn, %i.nq
  %i.ns = uitofp nneg i32 %i.nr to float
  %i.nt = fmul nnan float %i.ns, f0x37800080
  br label %_ZN7lodepngL15decodeICCUint16EPKhmPm.exit297

_ZN7lodepngL15decodeICCUint16EPKhmPm.exit297:     ; preds = %.lr.ph, %bb.ay
  %.0.i296 = phi float [ %i.nt, %bb.ay ], [ 0.000000e+00, %.lr.ph ]
  %i.nu = getelementptr inbounds nuw [4 x i8], ptr %i.nf, i64 %.1213398
  store float %.0.i296, ptr %i.nu, align 4, !tbaa !82
  %i.nv = add nuw nsw i64 %.1397, 4               ; 4 uses
  %i.nw = icmp samesign ugt i64 %i.nv, %2
  br i1 %i.nw, label %_ZN7lodepngL15decodeICCUint16EPKhmPm.exit297.1, label %bb.az

bb.az:                                            ; preds = %_ZN7lodepngL15decodeICCUint16EPKhmPm.exit297
  %i.nx = getelementptr inbounds nuw i8, ptr %1, i64 %i.ni ; 2 uses
  %i.ny = load i8, ptr %i.nx, align 1, !tbaa !20
  %i.nz = zext i8 %i.ny to i32
  %i.oa = shl nuw nsw i32 %i.nz, 8
  %i.ob = getelementptr i8, ptr %i.nx, i64 1
  %i.oc = load i8, ptr %i.ob, align 1, !tbaa !20
  %i.od = zext i8 %i.oc to i32
  %i.oe = or disjoint i32 %i.oa, %i.od
  %i.of = uitofp nneg i32 %i.oe to float
  %i.og = fmul nnan float %i.of, f0x37800080
...
_ZN7lodepngL15decodeICCUint16EPKhmPm.exit297.1:   ; preds = %bb.az, %_ZN7lodepngL15decodeICCUint16EPKhmPm.exit297
  %.0.i296.1 = phi float [ %i.og, %bb.az ], [ 0.000000e+00, %_ZN7lodepngL15decodeICCUint16EPKhmPm.exit297 ]
  %i.oh = getelementptr inbounds nuw [4 x i8], ptr %i.nf, i64 %.1213398
  %i.oi = getelementptr inbounds nuw i8, ptr %i.oh, i64 4
  store float %.0.i296.1, ptr %i.oi, align 4, !tbaa !82
  %i.oj = add nuw nsw i64 %.1213398, 2            ; 2 uses
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1.not = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1.not, label %.loopexit.loopexit.unr-lcssa, label %.lr.ph, !llvm.loop !94
...
.lr.ph.epil.preheader:                            ; preds = %.loopexit.loopexit.unr-lcssa, %.lr.ph.preheader
  %.1213398.epil.init = phi i64 [ 0, %.lr.ph.preheader ], [ %i.oj, %.loopexit.loopexit.unr-lcssa ]
  %.1397.epil.init = phi i64 [ %i.mf, %.lr.ph.preheader ], [ %i.nv, %.loopexit.loopexit.unr-lcssa ] ; 2 uses
  %lcmp.mod422 = trunc i64 %umax to i1
  tail call void @llvm.assume(i1 %lcmp.mod422)
  %i.ok = add nuw nsw i64 %.1397.epil.init, 2     ; 2 uses
  %i.ol = icmp samesign ugt i64 %i.ok, %2
  br i1 %i.ol, label %_ZN7lodepngL15decodeICCUint16EPKhmPm.exit297.epil, label %bb.ba

bb.ba:                                            ; preds = %.lr.ph.epil.preheader
  %i.om = getelementptr inbounds nuw i8, ptr %1, i64 %.1397.epil.init ; 2 uses
  %i.on = load i8, ptr %i.om, align 1, !tbaa !20
  %i.oo = zext i8 %i.on to i32
  %i.op = shl nuw nsw i32 %i.oo, 8
  %i.oq = getelementptr i8, ptr %i.om, i64 1
  %i.or = load i8, ptr %i.oq, align 1, !tbaa !20
  %i.os = zext i8 %i.or to i32
  %i.ot = or disjoint i32 %i.op, %i.os
  %i.ou = uitofp nneg i32 %i.ot to float
  %i.ov = fmul nnan float %i.ou, f0x37800080
...
_ZN7lodepngL15decodeICCUint16EPKhmPm.exit297.epil: ; preds = %bb.ba, %.lr.ph.epil.preheader
  %.0.i296.epil = phi float [ %i.ov, %bb.ba ], [ 0.000000e+00, %.lr.ph.epil.preheader ]
  %i.ow = getelementptr inbounds nuw [4 x i8], ptr %i.nf, i64 %.1213398.epil.init
  store float %.0.i296.epil, ptr %i.ow, align 4, !tbaa !82
  br label %.loopexit
...
.loopexit:                                        ; preds = %_ZN7lodepngL15decodeICCUint16EPKhmPm.exit297.epil, %.loopexit.loopexit.unr-lcssa, %_ZN7lodepngL15decodeICCUint16EPKhmPm.exit, %_ZN7lodepngL15decodeICCUint32EPKhmPm.exit294.thread, %bb.at
  %.2 = phi i64 [ %.0.i256, %bb.at ], [ %i.mm, %_ZN7lodepngL15decodeICCUint16EPKhmPm.exit ], [ %i.mf, %_ZN7lodepngL15decodeICCUint32EPKhmPm.exit294.thread ], [ %i.nv, %.loopexit.loopexit.unr-lcssa ], [ %i.ok, %_ZN7lodepngL15decodeICCUint16EPKhmPm.exit297.epil ] ; 12 uses
  %i.ox = tail call fastcc noundef i32 @_ZN7lodepngL9isICCwordEPKhmmPKc(ptr noundef %1, i64 noundef %2, i64 noundef %.2, ptr noundef nonnull @.str.14)
  %.not238 = icmp eq i32 %i.ox, 0
  br i1 %.not238, label %.critedge, label %bb.bb

bb.bb:                                            ; preds = %.loopexit
  %i.oy = zext nneg i32 %i.mb to i64
  %i.oz = getelementptr inbounds nuw [56 x i8], ptr %i.f, i64 %i.oy ; 8 uses
  store i32 1, ptr %i.d, align 4, !tbaa !81
  %i.pa = add i64 %.2, 10
  %i.pb = icmp ugt i64 %i.pa, %2
  br i1 %i.pb, label %_ZN7lodepngL15decodeICCUint16EPKhmPm.exit299.thread, label %_ZN7lodepngL15decodeICCUint16EPKhmPm.exit299

_ZN7lodepngL15decodeICCUint16EPKhmPm.exit299:     ; preds = %bb.bb
  %i.pc = getelementptr i8, ptr %1, i64 %.2       ; 2 uses
  ...
  %i.ph = getelementptr i8, ptr %i.pc, i64 9
  %i.pi = load i8, ptr %i.ph, align 1, !tbaa !20
  %i.pj = zext i8 %i.pi to i32
  %i.pk = or disjoint i32 %i.pg, %i.pj            ; 2 uses
  %i.pl = icmp samesign ult i32 %i.pk, 5
  br i1 %i.pl, label %_ZN7lodepngL15decodeICCUint16EPKhmPm.exit299.thread, label %.critedge243

_ZN7lodepngL15decodeICCUint16EPKhmPm.exit299.thread: ; preds = %bb.bb, %_ZN7lodepngL15decodeICCUint16EPKhmPm.exit299
  %.0.i298381 = phi i32 [ %i.pk, %_ZN7lodepngL15decodeICCUint16EPKhmPm.exit299 ], [ 0, %bb.bb ] ; 5 uses
  %i.pm = add nuw nsw i32 %.0.i298381, 2
  store i32 %i.pm, ptr %i.oz, align 8, !tbaa !87
  %i.pn = add i64 %.2, 16                         ; 3 uses
  %i.po = icmp ugt i64 %i.pn, %2
  br i1 %i.po, label %_ZN7lodepngL18decodeICC15Fixed16EPKhmPm.exit301, label %bb.bc

bb.bc:                                            ; preds = %_ZN7lodepngL15decodeICCUint16EPKhmPm.exit299.thread
  %i.pp = getelementptr i8, ptr %1, i64 %.2
  %i.pq = getelementptr i8, ptr %i.pp, i64 12
  %i.pr = load i32, ptr %i.pq, align 1
  %i.ps = tail call i32 @llvm.bswap.i32(i32 %i.pr)
  %i.pt = sitofp i32 %i.ps to float
  %i.pu = fmul nnan float %i.pt, f0x37800000
...
_ZN7lodepngL18decodeICC15Fixed16EPKhmPm.exit301:  ; preds = %_ZN7lodepngL15decodeICCUint16EPKhmPm.exit299.thread, %bb.bc
  %.0.i.i300 = phi float [ %i.pu, %bb.bc ], [ 0.000000e+00, %_ZN7lodepngL15decodeICCUint16EPKhmPm.exit299.thread ]
  %i.pv = getelementptr inbounds nuw i8, ptr %i.oz, i64 24
  store float %.0.i.i300, ptr %i.pv, align 8, !tbaa !92
...
bb.bd:                                            ; preds = %_ZN7lodepngL18decodeICC15Fixed16EPKhmPm.exit301
  %i.pw = add i64 %.2, 20                         ; 2 uses
  %i.px = icmp ugt i64 %i.pw, %2
  br i1 %i.px, label %_ZN7lodepngL18decodeICC15Fixed16EPKhmPm.exit303, label %bb.be

bb.be:                                            ; preds = %bb.bd
  %i.py = getelementptr inbounds nuw i8, ptr %1, i64 %i.pn
  %i.pz = load i32, ptr %i.py, align 1
  %i.qa = tail call i32 @llvm.bswap.i32(i32 %i.pz)
  %i.qb = sitofp i32 %i.qa to float
  %i.qc = fmul nnan float %i.qb, f0x37800000
...
_ZN7lodepngL18decodeICC15Fixed16EPKhmPm.exit303:  ; preds = %bb.bd, %bb.be
  %.0.i.i302 = phi float [ %i.qc, %bb.be ], [ 0.000000e+00, %bb.bd ]
  %i.qd = getelementptr inbounds nuw i8, ptr %i.oz, i64 28
  store float %.0.i.i302, ptr %i.qd, align 4, !tbaa !95
  %i.qe = add i64 %.2, 24                         ; 3 uses
  %i.qf = icmp ugt i64 %i.qe, %2
  br i1 %i.qf, label %bb.bg, label %bb.bf

bb.bf:                                            ; preds = %_ZN7lodepngL18decodeICC15Fixed16EPKhmPm.exit303
  %i.qg = getelementptr inbounds nuw i8, ptr %1, i64 %i.pw
  %i.qh = load i32, ptr %i.qg, align 1
  %i.qi = tail call i32 @llvm.bswap.i32(i32 %i.qh)
  %i.qj = sitofp i32 %i.qi to float
  %i.qk = fmul nnan float %i.qj, f0x37800000
  br label %bb.bg

bb.bg:                                            ; preds = %bb.bf, %_ZN7lodepngL18decodeICC15Fixed16EPKhmPm.exit303
  %.0.i.i304 = phi float [ %i.qk, %bb.bf ], [ 0.000000e+00, %_ZN7lodepngL18decodeICC15Fixed16EPKhmPm.exit303 ]
  %i.ql = getelementptr inbounds nuw i8, ptr %i.oz, i64 32
  store float %.0.i.i304, ptr %i.ql, align 8, !tbaa !96
  %.not393 = icmp eq i32 %.0.i298381, 1
  br i1 %.not393, label %.critedge, label %bb.bh

bb.bh:                                            ; preds = %bb.bg
  %i.qm = add i64 %.2, 28                         ; 3 uses
  %i.qn = icmp ugt i64 %i.qm, %2
  br i1 %i.qn, label %bb.bj, label %bb.bi

bb.bi:                                            ; preds = %bb.bh
  %i.qo = getelementptr inbounds nuw i8, ptr %1, i64 %i.qe
  %i.qp = load i32, ptr %i.qo, align 1
  %i.qq = tail call i32 @llvm.bswap.i32(i32 %i.qp)
  %i.qr = sitofp i32 %i.qq to float
  %i.qs = fmul nnan float %i.qr, f0x37800000
  br label %bb.bj

bb.bj:                                            ; preds = %bb.bi, %bb.bh
  %.0.i.i306 = phi float [ %i.qs, %bb.bi ], [ 0.000000e+00, %bb.bh ]
  %i.qt = getelementptr inbounds nuw i8, ptr %i.oz, i64 36
  store float %.0.i.i306, ptr %i.qt, align 4, !tbaa !97
...
bb.bm:                                            ; preds = %bb.bl, %bb.bk
  ...
  store float %.0.i.i308, ptr %i.rc, align 8, !tbaa !98
...
_ZN7lodepngL18decodeICC15Fixed16EPKhmPm.exit311:  ; preds = %bb.bn, %bb.bo
  ...
  store float %.0.i.i310, ptr %i.rl, align 4, !tbaa !99
...
_ZN7lodepngL18decodeICC15Fixed16EPKhmPm.exit313:  ; preds = %_ZN7lodepngL18decodeICC15Fixed16EPKhmPm.exit311, %bb.bp
  ...
  store float %.0.i.i312, ptr %i.rt, align 8, !tbaa !100
  br label %.critedge
...
bb.d:                                             ; preds = %bb.c
  ...
  %9 = shufflevector <2 x double> %i.cf, <2 x double> poison, <4 x i32> <i32 1, i32 1, i32 poison, i32 poison>
  %10 = insertelement <4 x double> poison, double %i.au, i64 0
  %11 = shufflevector <4 x double> %10, <4 x double> poison, <4 x i32> <i32 poison, i32 poison, i32 0, i32 0>
  %12 = shufflevector <4 x double> %9, <4 x double> %11, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %13 = shufflevector <4 x double> %i.ck, <4 x double> poison, <4 x i32> <i32 1, i32 2, i32 0, i32 1>
  %i.cy = fmul <4 x double> %12, %13
  %14 = shufflevector <4 x double> %i.cl, <4 x double> poison, <4 x i32> <i32 1, i32 2, i32 0, i32 1>
  %15 = shufflevector <2 x double> %i.bz, <2 x double> poison, <4 x i32> <i32 1, i32 1, i32 poison, i32 poison>
  %16 = insertelement <4 x double> poison, double %i.ar, i64 0
  %17 = shufflevector <4 x double> %16, <4 x double> poison, <4 x i32> <i32 poison, i32 poison, i32 0, i32 0>
  %18 = shufflevector <4 x double> %15, <4 x double> %17, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %i.cz = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %14, <4 x double> %18, <4 x double> %i.cy)
  %19 = shufflevector <4 x double> %i.cm, <4 x double> poison, <4 x i32> <i32 1, i32 2, i32 0, i32 1>
  %20 = shufflevector <2 x double> %i.ci, <2 x double> poison, <4 x i32> <i32 1, i32 1, i32 poison, i32 poison>
  %21 = insertelement <4 x double> poison, double %i.ax, i64 0
  %22 = shufflevector <4 x double> %21, <4 x double> poison, <4 x i32> <i32 poison, i32 poison, i32 0, i32 0>
  %23 = shufflevector <4 x double> %20, <4 x double> %22, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %24 = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %19, <4 x double> %23, <4 x double> %i.cz)
  %25 = fptrunc <4 x double> %24 to <4 x float>
  store <4 x float> %25, ptr %i.ao, align 16, !tbaa !82
...
bb.a:
  ...
  %i.b = alloca [9 x float], align 16             ; 13 uses
...
.loopexit.i:                                      ; preds = %bb.d, %.preheader.i
  ...
  %5 = shufflevector <2 x double> %i.en, <2 x double> poison, <4 x i32> <i32 1, i32 1, i32 poison, i32 poison>
  %6 = insertelement <4 x double> poison, double %.pre-phi89.i, i64 0
  %7 = shufflevector <4 x double> %6, <4 x double> poison, <4 x i32> <i32 poison, i32 poison, i32 0, i32 0>
  %8 = shufflevector <4 x double> %5, <4 x double> %7, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %9 = shufflevector <4 x double> %i.ex, <4 x double> poison, <4 x i32> <i32 1, i32 2, i32 0, i32 1>
  %i.fl = fmul <4 x double> %8, %9
  %10 = shufflevector <4 x double> %i.ez, <4 x double> poison, <4 x i32> <i32 1, i32 2, i32 0, i32 1>
  %11 = shufflevector <2 x double> %i.em, <2 x double> poison, <4 x i32> <i32 1, i32 1, i32 poison, i32 poison>
  %12 = insertelement <4 x double> poison, double %.pre-phi87.i, i64 0
  %13 = shufflevector <4 x double> %12, <4 x double> poison, <4 x i32> <i32 poison, i32 poison, i32 0, i32 0>
  %14 = shufflevector <4 x double> %11, <4 x double> %13, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %i.fm = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %10, <4 x double> %14, <4 x double> %i.fl)
  %15 = shufflevector <4 x double> %i.fd, <4 x double> poison, <4 x i32> <i32 1, i32 2, i32 0, i32 1>
  %16 = shufflevector <2 x double> %i.el, <2 x double> poison, <4 x i32> <i32 1, i32 1, i32 poison, i32 poison>
  %17 = insertelement <4 x double> poison, double %.pre-phi91.i, i64 0
  %18 = shufflevector <4 x double> %17, <4 x double> poison, <4 x i32> <i32 poison, i32 poison, i32 0, i32 0>
  %19 = shufflevector <4 x double> %16, <4 x double> %18, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %i.fn = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %15, <4 x double> %19, <4 x double> %i.fm)
  ...
  store <4 x float> %i.fo, ptr %i.ft, align 16, !tbaa !82
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.it = fdiv <4 x float> %i.is, %i.ib           ; 3 uses
  ...
  %20 = shufflevector <4 x float> %i.it, <4 x float> poison, <2 x i32> <i32 0, i32 1>
  store <2 x float> %20, ptr %i.b, align 16, !tbaa !82
  %21 = getelementptr inbounds nuw i8, ptr %i.b, i64 8 ; 2 uses
  %22 = extractelement <4 x float> %i.it, i64 2
  store float %22, ptr %21, align 8, !tbaa !82
  %23 = getelementptr inbounds nuw i8, ptr %i.b, i64 12
  store <2 x float> splat (float 1.000000e+00), ptr %23, align 4, !tbaa !82
  %24 = getelementptr inbounds nuw i8, ptr %i.b, i64 20
  store float 1.000000e+00, ptr %24, align 4, !tbaa !82
  %i.ja = getelementptr inbounds nuw i8, ptr %i.b, i64 24
  %25 = shufflevector <4 x float> %i.iz, <4 x float> poison, <2 x i32> <i32 1, i32 2>
  store <2 x float> %25, ptr %i.ja, align 8, !tbaa !82
