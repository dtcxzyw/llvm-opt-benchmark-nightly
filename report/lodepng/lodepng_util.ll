...
vector.ph61:                                      ; preds = %vector.memcheck57
  ...
  %9 = shufflevector <2 x double> %i.ef, <2 x double> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 1>
  %10 = shufflevector <2 x double> %i.el, <2 x double> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 1>
...
vector.body79:                                    ; preds = %vector.body79, %vector.ph61
  ...
  %11 = shufflevector <2 x double> %i.fi, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  ...
  %12 = shufflevector <2 x double> %i.ga, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %13 = shufflevector <2 x double> %i.fr, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %14 = fmul <4 x double> %i.ex, %13
  %15 = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %11, <4 x double> %9, <4 x double> %14)
  ...
  %i.gn = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %12, <4 x double> %10, <4 x double> %15)
