...
begin_hunk_1_@_ZN4llvh9FileCheck16CanonicalizeFileERNS_12MemoryBufferERNS_15SmallVectorImplIcEE:bb.a
  ...
  %.pre49 = load ptr, ptr %i.a, align 8, !tbaa !154 ; 2 uses
...
bb.d:                                             ; preds = %.lr.ph48, %.critedge
  %.047 = phi ptr [ %i.n, %.lr.ph48 ], [ %i.bi, %.critedge ] ; 12 uses
...
.lr.ph.preheader:                                 ; preds = %_ZN4llvh23SmallVectorTemplateBaseIcLb1EE9push_backERKc.exit40
  %3 = getelementptr i8, ptr %.047, i64 %.pre-phi
  %scevgep = getelementptr i8, ptr %3, i64 -1
  %4 = sub i64 0, %.04749
  %scevgep50 = getelementptr i8, ptr %scevgep, i64 %4
  br label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.preheader, %.critedge2
  %i.bf = phi ptr [ %i.bh, %.critedge2 ], [ %i.be, %.lr.ph.preheader ] ; 3 uses
  %.143 = phi ptr [ %i.bf, %.critedge2 ], [ %.047, %.lr.ph.preheader ]
