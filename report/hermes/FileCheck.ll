begin_hunk_0
  ...
  %i.df = sub i64 %i.dc, %.sroa.speculated375
...
begin_hunk_1
  ...
  %i.ei = sub i64 %i.ef, %.sroa.speculated333
  ...
  %i.el = sub i64 %i.ef, %.sroa.speculated319
...
begin_hunk_2
  ...
  %i.gt = sub i64 %.sroa.speculated326, %.sroa.speculated235
...
begin_hunk_3
  ...
  %i.hn = sub i64 %i.hk, %.sroa.speculated269     ; 3 uses
...
begin_hunk_11
  ...
  %i.nt = sub i64 %i.nq, %.sroa.speculated265
...
begin_hunk_12
  ...
  %i.oi = sub i64 %i.of, %.sroa.speculated237307
...
begin_hunk_13
  ...
  %i.om = sub i64 %i.oj, %.sroa.speculated237
...
begin_hunk_15
  ...
  %i.an = sub i64 %3, %.sroa.speculated197289     ; 2 uses
...
begin_hunk_16
  ...
  %i.bz = sub i64 %3, %.sroa.speculated197        ; 2 uses
...
begin_hunk_17
  ...
  %i.f = sub i64 %i.c, %.sroa.speculated4854      ; 2 uses
...
begin_hunk_18
  ...
  %i.y = sub i64 %i.v, %.sroa.speculated48        ; 2 uses
...
begin_hunk_19
  ...
  %i.bw = sub i64 %i.bt, %.sroa.speculated52
