...
.lr.ph.preheader.i:                               ; preds = %.lr.ph.preheader.i.lr.ph, %.backedge
  ...
  %.0294327 = phi i32 [ 1, %.lr.ph.preheader.i.lr.ph ], [ %.2, %.backedge ]
...
.lr.ph.i:                                         ; preds = %_ZL8SkipWordN4llvh9StringRefEm.exit.i, %.lr.ph.preheader.i
  %.1 = phi i32 [ %.0294327, %.lr.ph.preheader.i ], [ %.3, %_ZL8SkipWordN4llvh9StringRefEm.exit.i ] ; 3 uses
...
.lr.ph.i.i.preheader442:                          ; preds = %.lr.ph.i.i.preheader, %middle.block
  ...
  %.079.i.i.ph = phi i32 [ 0, %.lr.ph.i.i.preheader ], [ %i.hk, %middle.block ]
  br label %.lr.ph.i.i

.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader442, %.lr.ph.i.i
  %.010.i.i = phi i64 [ %i.hp, %.lr.ph.i.i ], [ %.010.i.i.ph, %.lr.ph.i.i.preheader442 ] ; 2 uses
  %.079.i.i = phi i32 [ %spec.select.i.i, %.lr.ph.i.i ], [ %.079.i.i.ph, %.lr.ph.i.i.preheader442 ]
  %i.hl = getelementptr inbounds nuw i8, ptr %i.gu, i64 %.010.i.i
  %i.hm = load i8, ptr %i.hl, align 1, !tbaa !43
  %i.hn = icmp eq i8 %i.hm, 10
  %i.ho = zext i1 %i.hn to i32
  %spec.select.i.i = add i32 %.079.i.i, %i.ho     ; 2 uses
  %i.hp = add nuw i64 %.010.i.i, 1                ; 2 uses
...
.loopexit.i:                                      ; preds = %bb.l, %_ZNK4llvh9StringRef10startswithES0_.exit30.i.i, %_ZNK4llvh9StringRef10startswithES0_.exit28.i.i, %_ZNK4llvh9StringRef10startswithES0_.exit26.i.i, %_ZNK4llvh9StringRef10startswithES0_.exit26.thread.i.i, %_ZNK4llvh9StringRef10startswithES0_.exit22.i.i, %_ZNK4llvh9StringRef10startswithES0_.exit20.i.i, %_ZNK4llvh9StringRef10startswithES0_.exit18.i.i, %_ZNK4llvh9StringRef10startswithES0_.exit16.i.i, %_ZNK4llvh9StringRef10startswithES0_.exit14.i.i, %_ZNK4llvh9StringRef10startswithES0_.exit12.i.i, %_ZNK4llvh9StringRef10startswithES0_.exit10.i.i, %_ZNK4llvh9StringRef10startswithES0_.exit8.i.i, %_ZNK4llvh9StringRef10startswithES0_.exit6.i.i, %_ZNK4llvh9StringRef10startswithES0_.exit.i.i, %_ZL8SkipWordN4llvh9StringRefEm.exit.i, %.lr.ph.i
  %37 = phi i1 [ false, %_ZL8SkipWordN4llvh9StringRefEm.exit.i ], [ false, %.lr.ph.i ], [ false, %bb.l ], [ true, %_ZNK4llvh9StringRef10startswithES0_.exit16.i.i ], [ true, %_ZNK4llvh9StringRef10startswithES0_.exit14.i.i ], [ true, %_ZNK4llvh9StringRef10startswithES0_.exit12.i.i ], [ true, %_ZNK4llvh9StringRef10startswithES0_.exit10.i.i ], [ true, %_ZNK4llvh9StringRef10startswithES0_.exit8.i.i ], [ true, %_ZNK4llvh9StringRef10startswithES0_.exit6.i.i ], [ false, %_ZNK4llvh9StringRef10startswithES0_.exit20.i.i ], [ false, %_ZNK4llvh9StringRef10startswithES0_.exit22.i.i ], [ false, %_ZNK4llvh9StringRef10startswithES0_.exit26.thread.i.i ], [ false, %_ZNK4llvh9StringRef10startswithES0_.exit26.i.i ], [ false, %_ZNK4llvh9StringRef10startswithES0_.exit28.i.i ], [ false, %_ZNK4llvh9StringRef10startswithES0_.exit30.i.i ], [ true, %_ZNK4llvh9StringRef10startswithES0_.exit18.i.i ], [ true, %_ZNK4llvh9StringRef10startswithES0_.exit.i.i ]
  %38 = phi i1 [ false, %_ZL8SkipWordN4llvh9StringRefEm.exit.i ], [ false, %.lr.ph.i ], [ false, %bb.l ], [ false, %_ZNK4llvh9StringRef10startswithES0_.exit16.i.i ], [ false, %_ZNK4llvh9StringRef10startswithES0_.exit14.i.i ], [ false, %_ZNK4llvh9StringRef10startswithES0_.exit12.i.i ], [ false, %_ZNK4llvh9StringRef10startswithES0_.exit10.i.i ], [ false, %_ZNK4llvh9StringRef10startswithES0_.exit8.i.i ], [ false, %_ZNK4llvh9StringRef10startswithES0_.exit6.i.i ], [ false, %_ZNK4llvh9StringRef10startswithES0_.exit20.i.i ], [ true, %_ZNK4llvh9StringRef10startswithES0_.exit22.i.i ], [ false, %_ZNK4llvh9StringRef10startswithES0_.exit26.thread.i.i ], [ false, %_ZNK4llvh9StringRef10startswithES0_.exit26.i.i ], [ false, %_ZNK4llvh9StringRef10startswithES0_.exit28.i.i ], [ false, %_ZNK4llvh9StringRef10startswithES0_.exit30.i.i ], [ false, %_ZNK4llvh9StringRef10startswithES0_.exit18.i.i ], [ false, %_ZNK4llvh9StringRef10startswithES0_.exit.i.i ]
  %39 = phi ptr [ @.str.37, %_ZL8SkipWordN4llvh9StringRefEm.exit.i ], [ @.str.37, %.lr.ph.i ], [ @.str.37, %bb.l ], [ @.str.37, %_ZNK4llvh9StringRef10startswithES0_.exit16.i.i ], [ @.str.37, %_ZNK4llvh9StringRef10startswithES0_.exit14.i.i ], [ @.str.37, %_ZNK4llvh9StringRef10startswithES0_.exit12.i.i ], [ @.str.37, %_ZNK4llvh9StringRef10startswithES0_.exit10.i.i ], [ @.str.37, %_ZNK4llvh9StringRef10startswithES0_.exit8.i.i ], [ @.str.37, %_ZNK4llvh9StringRef10startswithES0_.exit6.i.i ], [ @.str.36, %_ZNK4llvh9StringRef10startswithES0_.exit20.i.i ], [ @.str.37, %_ZNK4llvh9StringRef10startswithES0_.exit22.i.i ], [ @.str.37, %_ZNK4llvh9StringRef10startswithES0_.exit26.thread.i.i ], [ @.str.37, %_ZNK4llvh9StringRef10startswithES0_.exit26.i.i ], [ @.str.37, %_ZNK4llvh9StringRef10startswithES0_.exit28.i.i ], [ @.str.35, %_ZNK4llvh9StringRef10startswithES0_.exit30.i.i ], [ @.str.37, %_ZNK4llvh9StringRef10startswithES0_.exit18.i.i ], [ @.str.37, %_ZNK4llvh9StringRef10startswithES0_.exit.i.i ] ; 2 uses
  %.2296 = phi i32 [ 0, %_ZL8SkipWordN4llvh9StringRefEm.exit.i ], [ 0, %.lr.ph.i ], [ 1, %bb.l ], [ 9, %_ZNK4llvh9StringRef10startswithES0_.exit16.i.i ], [ 9, %_ZNK4llvh9StringRef10startswithES0_.exit14.i.i ], [ 9, %_ZNK4llvh9StringRef10startswithES0_.exit12.i.i ], [ 9, %_ZNK4llvh9StringRef10startswithES0_.exit10.i.i ], [ 9, %_ZNK4llvh9StringRef10startswithES0_.exit8.i.i ], [ 9, %_ZNK4llvh9StringRef10startswithES0_.exit6.i.i ], [ 7, %_ZNK4llvh9StringRef10startswithES0_.exit20.i.i ], [ 6, %_ZNK4llvh9StringRef10startswithES0_.exit22.i.i ], [ 5, %_ZNK4llvh9StringRef10startswithES0_.exit26.thread.i.i ], [ 4, %_ZNK4llvh9StringRef10startswithES0_.exit26.i.i ], [ 3, %_ZNK4llvh9StringRef10startswithES0_.exit28.i.i ], [ 2, %_ZNK4llvh9StringRef10startswithES0_.exit30.i.i ], [ 9, %_ZNK4llvh9StringRef10startswithES0_.exit18.i.i ], [ 9, %_ZNK4llvh9StringRef10startswithES0_.exit.i.i ] ; 4 uses
...
_ZL23FindFirstMatchingPrefixRN4llvh5RegexERNS_9StringRefERjRNS_5Check13FileCheckTypeE.exit: ; preds = %.loopexit.i, %bb.o
  ...
  store ptr %.sroa.043.0.i, ptr %18, align 8
...
_ZN4llvhplERKNS_5TwineES2_.exit136:               ; preds = %bb.v
  ...
  store ptr %39, ptr %27, align 8, !tbaa !71
  %i.oo = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %39) #21
...
begin_hunk_9_@_ZN4llvh9FileCheck13ReadCheckFileERNS_9SourceMgrENS_9StringRefERNS_5RegexERSt6vectorINS_15FileCheckStringESaIS7_EE:bb.a
  ...
  call void @_ZNK4llvh9SourceMgr12PrintMessageENS_5SMLocENS0_8DiagKindERKNS_5TwineENS_8ArrayRefINS_7SMRangeEEENS6_INS_7SMFixItEEEb(ptr noundef nonnull align 8 dereferenceable(120) %1, ptr %.sroa.043.0.i, i32 noundef 0, ptr noundef nonnull align 8 dereferenceable(18) %28, ptr null, i64 0, ptr noundef nonnull byval(%"class.llvh::ArrayRef.22") align 8 %34, i1 noundef zeroext true) #19
