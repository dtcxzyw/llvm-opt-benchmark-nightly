...
bb.c:                                             ; preds = %tailrecurse
  %.tr.lcssa327 = phi ptr [ %.tr, %tailrecurse ]
  %.tr10.lcssa320 = phi ptr [ %.tr10, %tailrecurse ]
  %.tr.lcssa310 = phi ptr [ %.tr, %tailrecurse ]
  %.tr10.lcssa301 = phi ptr [ %.tr10, %tailrecurse ]
...
begin_hunk_1_@"_ZZNK6hermes2vm11TwineChar1611toChar16StrEPDsmENK3$_0clES2_NS1_4NodeENS1_8NodeKindEm":bb.a
  ...
  %scevgep287.a = getelementptr i8, ptr %.tr10.lcssa301, i64 8
  %scevgep290 = getelementptr i8, ptr %.tr.lcssa310, i64 16 ; 2 uses
...
vec.epilog.vector.body141:                        ; preds = %vec.epilog.vector.body141, %vec.epilog.ph138
  ...
  %scevgep295.a = getelementptr i8, ptr %.tr.lcssa327, i64 %i.ad
  %scevgep294 = getelementptr i8, ptr %.tr10.lcssa320, i64 %index142
...
bb.m:                                             ; preds = %tailrecurse
  %.tr.lcssa294 = phi ptr [ %.tr, %tailrecurse ]
  %.tr.lcssa284 = phi ptr [ %.tr, %tailrecurse ]
...
begin_hunk_4_@"_ZZNK6hermes2vm11TwineChar1611toChar16StrEPDsmENK3$_0clES2_NS1_4NodeENS1_8NodeKindEm":bb.a
  ...
  %scevgep279 = getelementptr i8, ptr %.tr.lcssa284, i64 16 ; 2 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %scevgep283 = getelementptr i8, ptr %.tr.lcssa294, i64 %i.bp
...
bb.n:                                             ; preds = %tailrecurse
  %.tr.lcssa351 = phi ptr [ %.tr, %tailrecurse ]
  %.tr.lcssa341 = phi ptr [ %.tr, %tailrecurse ]
...
begin_hunk_7_@"_ZZNK6hermes2vm11TwineChar1611toChar16StrEPDsmENK3$_0clES2_NS1_4NodeENS1_8NodeKindEm":bb.a
  ...
  %scevgep304 = getelementptr i8, ptr %.tr.lcssa341, i64 16 ; 2 uses
...
vec.epilog.vector.body176:                        ; preds = %vec.epilog.vector.body176, %vec.epilog.ph173
  ...
  %scevgep308 = getelementptr i8, ptr %.tr.lcssa351, i64 %i.cm
...
bb.o:                                             ; preds = %tailrecurse
  %.tr.lcssa374 = phi ptr [ %.tr, %tailrecurse ]
  %.tr.lcssa364 = phi ptr [ %.tr, %tailrecurse ]
...
begin_hunk_10_@"_ZZNK6hermes2vm11TwineChar1611toChar16StrEPDsmENK3$_0clES2_NS1_4NodeENS1_8NodeKindEm":bb.a
  ...
  %scevgep316 = getelementptr i8, ptr %.tr.lcssa364, i64 16 ; 2 uses
...
vec.epilog.vector.body210:                        ; preds = %vec.epilog.vector.body210, %vec.epilog.ph207
  ...
  %scevgep320 = getelementptr i8, ptr %.tr.lcssa374, i64 %i.dj
