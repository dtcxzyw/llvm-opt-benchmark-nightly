...
begin_hunk_1
  ...
  %2 = add nsw i32 %i.na, -4
  %3 = icmp ult i32 %2, -3
  br i1 %3, label %bb.bf, label %.loopexit2610
...
bb.bg:                                            ; preds = %bb.bg, %bb.bf
  ...
  %4 = trunc nuw i64 %indvars.iv2623 to i32
  %5 = shl i32 %4, 2                              ; 5 uses
  %i.nh = add i32 %5, %.0.copyload.i2489
  ...
  %i.nk = add i32 %5, %.0.copyload.i2490
...
begin_hunk_4
  ...
  %i.ny = or disjoint i32 %5, 8                   ; 2 uses
...
begin_hunk_5
  ...
  %i.oh = or disjoint i32 %5, 12                  ; 2 uses
...
begin_hunk_7
  ...
  %4 = add nsw i32 %i.m, -4
  %5 = icmp ult i32 %4, -3
  br i1 %5, label %bb.e, label %.loopexit1600
...
bb.f:                                             ; preds = %bb.f, %bb.e
  ...
  %7 = shl i32 %6, 2                              ; 5 uses
  %i.s = add i32 %7, %.0.copyload.i1503
  ...
  %i.v = add i32 %7, %.0.copyload.i1504
...
begin_hunk_10
  ...
  %i.aj = or disjoint i32 %7, 8                   ; 2 uses
...
begin_hunk_11
  ...
  %i.as = or disjoint i32 %7, 12                  ; 2 uses
