Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/hermes/original/WeakRef?download=true
...
; Function Attrs: mustprogress nounwind uwtable
define hidden { i32, i64 } @_ZN6hermes2vm18weakRefConstructorEPvRNS0_7RuntimeENS0_10NativeArgsE(ptr nofree readnone captures(none) %0, ptr noundef nonnull align 8 dereferenceable(9816) %1, ptr nofree noundef readonly captures(none) dead_on_return %2) #0 {
bb.a:
...
_ZN6hermes2vm5vmisaINS0_8JSObjectEEEbNS0_11HermesValueE.exit.i: ; preds = %bb.c
  ...
  br i1 %i.r, label %5, label %_ZNK6hermes2vm10NativeArgs10dyncastArgINS0_8JSObjectEEENS0_6HandleIT_EEj.exit

5:                                                ; preds = %_ZN6hermes2vm5vmisaINS0_8JSObjectEEEbNS0_11HermesValueE.exit.i
  br label %_ZNK6hermes2vm10NativeArgs10dyncastArgINS0_8JSObjectEEENS0_6HandleIT_EEj.exit

_ZNK6hermes2vm10NativeArgs10dyncastArgINS0_8JSObjectEEENS0_6HandleIT_EEj.exit: ; preds = %bb.b, %bb.c, %_ZN6hermes2vm5vmisaINS0_8JSObjectEEEbNS0_11HermesValueE.exit.i, %5
  %.sroa.03.0.i = phi ptr [ %i.l, %5 ], [ @_ZN6hermes2vm15HandleRootOwner12nullPointer_E, %bb.b ], [ @_ZN6hermes2vm15HandleRootOwner12nullPointer_E, %_ZN6hermes2vm5vmisaINS0_8JSObjectEEEbNS0_11HermesValueE.exit.i ], [ @_ZN6hermes2vm15HandleRootOwner12nullPointer_E, %bb.c ] ; 3 uses
  %i.s = load i64, ptr %.sroa.03.0.i, align 8, !tbaa !28 ; 2 uses
  %i.t = icmp ugt i64 %i.s, -844424930131969
  %i.u = and i64 %i.s, 281474976710655
  %i.v = icmp ne i64 %i.u, 0
  %i.w = and i1 %i.t, %i.v
  br i1 %i.w, label %bb.d, label %_ZN6hermes2vm11TwineChar16C2EPKc.exit7, !prof !22
...
_ZN6hermes2vm11TwineChar16C2EPKc.exit7:           ; preds = %_ZNK6hermes2vm10NativeArgs10dyncastArgINS0_8JSObjectEEENS0_6HandleIT_EEj.exit
  ...
  store i32 1, ptr %i.x, align 8, !tbaa !30
  %i.y = getelementptr inbounds nuw i8, ptr %4, i64 32
  store i64 32, ptr %i.y, align 8, !tbaa !33
  ...
  store i32 3, ptr %i.aa, align 8, !tbaa !36
  %i.ab = call noundef i32 @_ZN6hermes2vm7Runtime14raiseTypeErrorERKNS0_11TwineChar16E(ptr noundef nonnull align 8 dereferenceable(9816) %1, ptr noundef nonnull align 8 dereferenceable(48) %4) #3
...
bb.d:                                             ; preds = %_ZNK6hermes2vm10NativeArgs10dyncastArgINS0_8JSObjectEEENS0_6HandleIT_EEj.exit
  %i.ac = tail call noundef i32 @_ZN6hermes2vm7Runtime16addToKeptObjectsENS0_6HandleINS0_8JSObjectEEE(ptr noundef nonnull align 8 dereferenceable(9816) %1, ptr nonnull %.sroa.03.0.i) #3 ; 0 uses
  %i.ad = load ptr, ptr %2, align 8, !tbaa !38, !noalias !42 ; 2 uses
  %.sroa.0.0.copyload.i.i = load i64, ptr %i.ad, align 8, !tbaa !23
  %i.ae = and i64 %.sroa.0.0.copyload.i.i, 281474976710655
  %i.af = inttoptr i64 %i.ae to ptr
  tail call void @_ZN6hermes2vm9JSWeakRef9setTargetERNS0_7RuntimeENS0_6HandleINS0_8JSObjectEEE(ptr noundef nonnull align 8 dereferenceable(32) %i.af, ptr noundef nonnull align 8 dereferenceable(9816) %1, ptr nonnull %.sroa.03.0.i) #3
  %.sroa.0.0.copyload.i8 = load i64, ptr %i.ad, align 8, !tbaa !23
  br label %bb.e

bb.e:                                             ; preds = %_ZN6hermes2vm11TwineChar16C2EPKc.exit7, %bb.d, %_ZN6hermes2vm11TwineChar16C2EPKc.exit
  %.sroa.011.1 = phi i32 [ %i.h, %_ZN6hermes2vm11TwineChar16C2EPKc.exit ], [ 1, %bb.d ], [ %i.ab, %_ZN6hermes2vm11TwineChar16C2EPKc.exit7 ]
...
; Function Attrs: mustprogress nounwind uwtable
define hidden { i32, i64 } @_ZN6hermes2vm21weakRefPrototypeDerefEPvRNS0_7RuntimeENS0_10NativeArgsE(ptr nofree readnone captures(none) %0, ptr noundef nonnull align 8 dereferenceable(9816) %1, ptr nofree noundef readonly captures(none) dead_on_return %2) #0 {
bb.a:
  %3 = alloca %"class.hermes::vm::TwineChar16", align 8 ; 8 uses
...
_ZN6hermes2vm5vmisaINS0_9JSWeakRefEEEbNS0_11HermesValueE.exit.i: ; preds = %bb.a
  ...
  %i.f = icmp eq i32 %.mask.i.i.i.i.i.i.i.i, 889192448
  br i1 %i.f, label %_ZNK6hermes2vm10NativeArgs11dyncastThisINS0_9JSWeakRefEEENS0_6HandleIT_EEv.exit, label %_ZN6hermes2vm5vmisaINS0_9JSWeakRefEEEbNS0_11HermesValueE.exit.thread.i
...
_ZNK6hermes2vm10NativeArgs11dyncastThisINS0_9JSWeakRefEEENS0_6HandleIT_EEv.exit: ; preds = %_ZN6hermes2vm5vmisaINS0_9JSWeakRefEEEbNS0_11HermesValueE.exit.i, %_ZN6hermes2vm5vmisaINS0_9JSWeakRefEEEbNS0_11HermesValueE.exit.thread.i
  ...
  %i.h = phi i1 [ true, %_ZN6hermes2vm5vmisaINS0_9JSWeakRefEEEbNS0_11HermesValueE.exit.i ], [ %i.g, %_ZN6hermes2vm5vmisaINS0_9JSWeakRefEEEbNS0_11HermesValueE.exit.thread.i ]
  %i.i = icmp ne i64 %.pre-phi, 0
  %i.j = and i1 %i.h, %i.i
  br i1 %i.j, label %bb.b, label %_ZN6hermes2vm11TwineChar16C2EPKc.exit, !prof !22
...
_ZN6hermes2vm11TwineChar16C2EPKc.exit:            ; preds = %_ZNK6hermes2vm10NativeArgs11dyncastThisINS0_9JSWeakRefEEENS0_6HandleIT_EEv.exit
  ...
  store i32 1, ptr %i.k, align 8, !tbaa !30
  %i.l = getelementptr inbounds nuw i8, ptr %3, i64 32
  store i64 54, ptr %i.l, align 8, !tbaa !33
...
bb.b:                                             ; preds = %_ZNK6hermes2vm10NativeArgs11dyncastThisINS0_9JSWeakRefEEENS0_6HandleIT_EEv.exit
  ...
  %i.q = tail call i64 @_ZNK6hermes2vm9JSWeakRef5derefERNS0_7RuntimeE(ptr noundef nonnull align 8 dereferenceable(32) %i.p, ptr noundef nonnull align 8 dereferenceable(9816) %1) #3 ; 3 uses
  %.mask.i = and i64 %i.q, -140737488355328
  %i.r = icmp eq i64 %.mask.i, -1688849860263936
  br i1 %i.r, label %bb.f, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.s = or i64 %i.q, -281474976710656            ; 2 uses
  %i.t = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.u = load ptr, ptr %i.t, align 8, !tbaa !7    ; 3 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  store i64 %i.s, ptr %i.w, align 8, !tbaa !23
  br label %_ZN6hermes2vm15HandleRootOwner10makeHandleINS0_8JSObjectEEENS0_6HandleIT_EENS0_11HermesValueE.exit

bb.e:                                             ; preds = %bb.c
  %i.ab = tail call noundef ptr @_ZN6hermes2vm7GCScope15_newChunkAndPHVENS0_11HermesValueE(ptr noundef nonnull align 8 dereferenceable(212) %i.u, i64 %i.s) #3
  br label %_ZN6hermes2vm15HandleRootOwner10makeHandleINS0_8JSObjectEEENS0_6HandleIT_EENS0_11HermesValueE.exit
...
_ZN6hermes2vm15HandleRootOwner10makeHandleINS0_8JSObjectEEENS0_6HandleIT_EENS0_11HermesValueE.exit: ; preds = %bb.d, %bb.e
  ...
  %i.ac = tail call noundef i32 @_ZN6hermes2vm7Runtime16addToKeptObjectsENS0_6HandleINS0_8JSObjectEEE(ptr noundef nonnull align 8 dereferenceable(9816) %1, ptr %.0.i.i.i.i.i.i) #3 ; 0 uses
...
bb.f:                                             ; preds = %_ZN6hermes2vm15HandleRootOwner10makeHandleINS0_8JSObjectEEENS0_6HandleIT_EENS0_11HermesValueE.exit, %bb.b, %_ZN6hermes2vm11TwineChar16C2EPKc.exit
  %.sroa.4.1 = phi i64 [ undef, %_ZN6hermes2vm11TwineChar16C2EPKc.exit ], [ %.sroa.0.0.copyload.i7, %_ZN6hermes2vm15HandleRootOwner10makeHandleINS0_8JSObjectEEENS0_6HandleIT_EENS0_11HermesValueE.exit ], [ %i.q, %bb.b ]
  %.sroa.013.1 = phi i32 [ %i.o, %_ZN6hermes2vm11TwineChar16C2EPKc.exit ], [ 1, %_ZN6hermes2vm15HandleRootOwner10makeHandleINS0_8JSObjectEEENS0_6HandleIT_EENS0_11HermesValueE.exit ], [ 1, %bb.b ]
