...
_ZN4llvh11ms_demangle14ArenaAllocator5allocINS0_19NamedIdentifierNodeEJEEEPT_DpOT0_.exit.i28: ; preds = %bb.m, %bb.l
  %.sink13.i.i29 = phi ptr [ %i.ck, %bb.m ], [ %i.ci, %bb.l ] ; 5 uses
  ...
  %.sroa.4.0..sroa_idx18.i = getelementptr inbounds nuw i8, ptr %.sink13.i.i29, i64 24
  store <2 x ptr> <ptr @.str.60, ptr getelementptr inbounds nuw (i8, ptr @.str.60, i64 21)>, ptr %.sroa.4.0..sroa_idx18.i, align 8, !tbaa !69
