...
.preheader.i:                                     ; preds = %.preheader.i, %bb.an
  %indvars.iv = phi i64 [ %indvars.iv.next, %.preheader.i ], [ 14, %bb.an ] ; 4 uses
  %.01226.i = phi i32 [ %i.fq, %.preheader.i ], [ %1, %bb.an ] ; 2 uses
  %i.fc = getelementptr inbounds i8, ptr %i.a, i64 %indvars.iv
  ...
  store i8 %i.fp, ptr %i.fk, align 1, !tbaa !9
  %i.fq = lshr i32 %.01226.i, 8                   ; 2 uses
  %2 = getelementptr i8, ptr %i.a, i64 %indvars.iv ; 2 uses
  %i.fr = getelementptr i8, ptr %2, i64 -2
  store i8 120, ptr %i.fr, align 2, !tbaa !9
  %indvars.iv.next = add nsw i64 %indvars.iv, -4  ; 2 uses
  %i.fs = getelementptr i8, ptr %2, i64 -3
  store i8 92, ptr %i.fs, align 1, !tbaa !9
...
bb.ap:                                            ; preds = %bb.ao
  ...
  %i.fz = load i64, ptr %i.fy, align 8, !tbaa !44 ; 2 uses
  %i.ga = add i64 %i.fz, %i.fw                    ; 2 uses
  %i.gb = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  %i.gc = load i64, ptr %i.gb, align 8, !tbaa !46 ; 2 uses
...
bb.aq:                                            ; preds = %bb.ap
  ...
  store ptr %i.ge, ptr %0, align 8, !tbaa !45
...
._ZN12OutputStream4growEm.exit_crit_edge.i.i18.i: ; preds = %bb.aq
  %.pre6.i.i19.i = load i64, ptr %i.fy, align 8, !tbaa !44
...
_ZN12OutputStream4growEm.exit.i.i20.i:            ; preds = %._ZN12OutputStream4growEm.exit_crit_edge.i.i18.i, %bb.ap
  ...
  %i.gj = load i64, ptr %i.fy, align 8, !tbaa !44
  %i.gk = add i64 %i.gj, %i.fw
  store i64 %i.gk, ptr %i.fy, align 8, !tbaa !44
