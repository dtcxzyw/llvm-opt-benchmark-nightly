Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/hermes/original/ArrayStorage?download=true
...
bb.f:                                             ; preds = %bb.e
  ...
  %4 = add nsw i64 %i.ad, -4
  %i.ae = sub nsw i64 %4, %3                      ; 2 uses
...
.lr.ph.i.i.i.preheader:                           ; preds = %bb.f, %middle.block
  %.01320.i.i.i.ph = phi ptr [ %i.aa, %bb.f ], [ %i.ai, %middle.block ]
  br label %.lr.ph.i.i.i

.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.preheader, %.lr.ph.i.i.i
  %.01320.i.i.i = phi ptr [ %i.am, %.lr.ph.i.i.i ], [ %.01320.i.i.i.ph, %.lr.ph.i.i.i.preheader ] ; 2 uses
  store i32 7, ptr %.01320.i.i.i, align 4, !tbaa !3
  %i.am = getelementptr inbounds nuw i8, ptr %.01320.i.i.i, i64 4 ; 2 uses
  %.not.i.i.i = icmp eq ptr %i.am, %i.ac
...
bb.g:                                             ; preds = %bb.e
  %i.an = icmp ult i32 %2, %i.w
  br i1 %i.an, label %bb.h, label %_ZN6hermes2vm16ArrayStorageBaseINS0_13HermesValue32EE20resizeWithinCapacityEPS3_RNS0_7RuntimeEj.exit

bb.h:                                             ; preds = %bb.g
  %i.ao = getelementptr inbounds nuw i8, ptr %i.t, i64 8
  %i.ap = zext i32 %2 to i64
  %.idx18.i.i = shl nuw nsw i64 %i.ap, 2
  %i.aq = getelementptr inbounds nuw i8, ptr %i.ao, i64 %.idx18.i.i ; 2 uses
  %i.ar = ptrtoint ptr %i.aq to i64
  %i.as = getelementptr inbounds nuw i8, ptr %0, i64 1632
  %i.at = load ptr, ptr %i.as, align 8, !tbaa !54
  %i.au = and i64 %i.ar, 1125899902648320
  %i.av = inttoptr i64 %i.au to ptr
  %i.aw = icmp ne ptr %i.at, %i.av
  %i.ax = getelementptr inbounds nuw i8, ptr %0, i64 8489
  %i.ay = load i8, ptr %i.ax, align 1, !range !55
  %i.az = trunc nuw i8 %i.ay to i1
  %or.cond.i.i.i.i = select i1 %i.aw, i1 %i.az, i1 false, !prof !56
...
bb.i:                                             ; preds = %bb.h
  %i.ba = sub i32 %i.w, %2
  tail call void @_ZN6hermes2vm7HadesGC29snapshotWriteBarrierRangeSlowEPKNS0_17GCHermesValueBaseINS0_13HermesValue32EEEj(ptr noundef nonnull align 8 dereferenceable(8112) %i.u, ptr noundef nonnull %i.aq, i32 noundef %i.ba) #6
...
bb.b:                                             ; preds = %bb.a
  ...
  %3 = shl nuw nsw i64 %i.f, 2
  %4 = add nsw i64 %i.j, -4
  %i.k = sub nsw i64 %4, %3                       ; 2 uses
  %i.l = lshr exact i64 %i.k, 2
  %i.m = add nuw nsw i64 %i.l, 1                  ; 2 uses
  %min.iters.check = icmp ult i64 %i.k, 28
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.p = shl i64 %index, 2
  %next.gep = getelementptr i8, ptr %i.g, i64 %i.p ; 2 uses
  %i.q = getelementptr i8, ptr %next.gep, i64 16
  store <4 x i32> splat (i32 7), ptr %next.gep, align 4, !tbaa !3
  store <4 x i32> splat (i32 7), ptr %i.q, align 4, !tbaa !3
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.r = icmp eq i64 %index.next, %n.vec
  br i1 %i.r, label %middle.block, label %vector.body, !llvm.loop !101
...
.lr.ph.i.i.preheader:                             ; preds = %bb.b, %middle.block
  %.01320.i.i.ph = phi ptr [ %i.g, %bb.b ], [ %i.o, %middle.block ]
  br label %.lr.ph.i.i

.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i
  %.01320.i.i = phi ptr [ %i.s, %.lr.ph.i.i ], [ %.01320.i.i.ph, %.lr.ph.i.i.preheader ] ; 2 uses
  store i32 7, ptr %.01320.i.i, align 4, !tbaa !3
  %i.s = getelementptr inbounds nuw i8, ptr %.01320.i.i, i64 4 ; 2 uses
  %.not.i.i = icmp eq ptr %i.s, %i.i
...
bb.c:                                             ; preds = %bb.a
  %i.t = icmp ult i32 %2, %i.c
  br i1 %i.t, label %bb.d, label %_ZN6hermes2vm16ArrayStorageBaseINS0_13HermesValue32EE20resizeWithinCapacityEPS3_RNS0_7HadesGCEj.exit

bb.d:                                             ; preds = %bb.c
  %i.u = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.v = zext i32 %2 to i64
  %.idx18.i = shl nuw nsw i64 %i.v, 2
  %i.w = getelementptr inbounds nuw i8, ptr %i.u, i64 %.idx18.i ; 2 uses
  %i.x = ptrtoint ptr %i.w to i64
  %i.y = getelementptr inbounds nuw i8, ptr %1, i64 1632
  %i.z = load ptr, ptr %i.y, align 8, !tbaa !54
  %i.aa = and i64 %i.x, -4194304
  %i.ab = inttoptr i64 %i.aa to ptr
  %i.ac = icmp ne ptr %i.z, %i.ab
  %i.ad = getelementptr inbounds nuw i8, ptr %1, i64 8489
  %i.ae = load i8, ptr %i.ad, align 1, !range !55
  %i.af = trunc nuw i8 %i.ae to i1
  %or.cond.i.i.i = select i1 %i.ac, i1 %i.af, i1 false, !prof !56
...
bb.e:                                             ; preds = %bb.d
  %i.ag = sub i32 %i.c, %2
  tail call void @_ZN6hermes2vm7HadesGC29snapshotWriteBarrierRangeSlowEPKNS0_17GCHermesValueBaseINS0_13HermesValue32EEEj(ptr noundef nonnull align 8 dereferenceable(8112) %i.a, ptr noundef nonnull %i.w, i32 noundef %i.ag) #6
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.s = add nsw i64 %.idx89.i.i, -4
  %i.t = sub nsw i64 %i.s, %.idx88.i.i            ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.y = shl i64 %index, 2
  %next.gep = getelementptr i8, ptr %i.r, i64 %i.y ; 2 uses
  %i.z = getelementptr i8, ptr %next.gep, i64 16
  store <4 x i32> splat (i32 7), ptr %next.gep, align 4, !tbaa !3
  store <4 x i32> splat (i32 7), ptr %i.z, align 4, !tbaa !3
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.aa = icmp eq i64 %index.next, %n.vec
  br i1 %i.aa, label %middle.block, label %vector.body, !llvm.loop !107
...
.lr.ph.i65.i.i.preheader:                         ; preds = %bb.c, %middle.block
  %.01320.i66.i.i.ph = phi ptr [ %i.r, %bb.c ], [ %i.x, %middle.block ]
  br label %.lr.ph.i65.i.i

.lr.ph.i65.i.i:                                   ; preds = %.lr.ph.i65.i.i.preheader, %.lr.ph.i65.i.i
  %.01320.i66.i.i = phi ptr [ %i.ab, %.lr.ph.i65.i.i ], [ %.01320.i66.i.i.ph, %.lr.ph.i65.i.i.preheader ] ; 2 uses
  store i32 7, ptr %.01320.i66.i.i, align 4, !tbaa !3
  %i.ab = getelementptr inbounds nuw i8, ptr %.01320.i66.i.i, i64 4 ; 2 uses
  %.not.i67.i.i = icmp eq ptr %i.ab, %i.q
...
_ZN6hermes2vm17GCHermesValueBaseINS0_13HermesValue32EE18uninitialized_fillIPS3_EEvT_S6_S2_RNS0_7HadesGCE.exit.i.i: ; preds = %.lr.ph.i65.i.i, %middle.block, %bb.b
  %i.ac = load atomic i32, ptr %i.d monotonic, align 4
  %i.ad = icmp ult i32 %i.f, %i.ac
  br i1 %i.ad, label %bb.d, label %_ZN6hermes2vm16ArrayStorageBaseINS0_13HermesValue32EE6resizeERNS0_13MutableHandleIS3_EERNS0_7RuntimeEj.exit.thread
...
bb.d:                                             ; preds = %_ZN6hermes2vm17GCHermesValueBaseINS0_13HermesValue32EE18uninitialized_fillIPS3_EEvT_S6_S2_RNS0_7HadesGCE.exit.i.i
  ...
  %.idx91.i.i = shl nuw nsw i64 %i.ae, 2
  %i.af = getelementptr inbounds nuw i8, ptr %i.l, i64 %.idx91.i.i ; 2 uses
  %i.ag = load atomic i32, ptr %i.d monotonic, align 4
  %i.ah = ptrtoint ptr %i.af to i64
  %i.ai = getelementptr inbounds nuw i8, ptr %1, i64 1632
  %i.aj = load ptr, ptr %i.ai, align 8, !tbaa !54
  %i.ak = and i64 %i.ah, 1125899902648320
  %i.al = inttoptr i64 %i.ak to ptr
  %i.am = icmp ne ptr %i.aj, %i.al
  %i.an = getelementptr inbounds nuw i8, ptr %1, i64 8489
  %i.ao = load i8, ptr %i.an, align 1, !range !55
  %i.ap = trunc nuw i8 %i.ao to i1
  %or.cond.i.i.i.i = select i1 %i.am, i1 %i.ap, i1 false, !prof !56
...
bb.e:                                             ; preds = %bb.d
  %i.aq = sub i32 %i.ag, %i.f
  tail call void @_ZN6hermes2vm7HadesGC29snapshotWriteBarrierRangeSlowEPKNS0_17GCHermesValueBaseINS0_13HermesValue32EEEj(ptr noundef nonnull align 8 dereferenceable(8112) %i.m, ptr noundef nonnull %i.af, i32 noundef %i.aq) #6
...
_ZN6hermes2vm16ArrayStorageBaseINS0_13HermesValue32EE6resizeERNS0_13MutableHandleIS3_EERNS0_7RuntimeEj.exit: ; preds = %bb.a
  %i.ar = icmp ult i32 %i.i, 2054140
  %i.as = lshr exact i32 %i.i, 1
  %.sroa.speculated.i.i = tail call i32 @llvm.umax.i32(i32 %i.as, i32 %i.f)
  %.0.i.i = select i1 %i.ar, i32 %.sroa.speculated.i.i, i32 1027070
  %i.at = tail call noundef i32 @_ZN6hermes2vm16ArrayStorageBaseINS0_13HermesValue32EE18reallocateToLargerERNS0_13MutableHandleIS3_EERNS0_7RuntimeEjjjj(ptr noundef nonnull align 8 dereferenceable(8) %0, ptr noundef nonnull align 8 dereferenceable(9816) %1, i32 noundef %.0.i.i, i32 noundef 0, i32 noundef 0, i32 noundef %i.f)
  %i.au = icmp eq i32 %i.at, 0
  br i1 %i.au, label %bb.t, label %bb.f
...
bb.f:                                             ; preds = %_ZN6hermes2vm16ArrayStorageBaseINS0_13HermesValue32EE6resizeERNS0_13MutableHandleIS3_EERNS0_7RuntimeEj.exit.thread, %_ZN6hermes2vm16ArrayStorageBaseINS0_13HermesValue32EE6resizeERNS0_13MutableHandleIS3_EERNS0_7RuntimeEj.exit
  ...
  %i.av = ashr i64 %.sroa.0.0.copyload.i.i.i, 47
  switch i64 %i.av, label %bb.n [
    i64 -14, label %_ZN6hermes2vm13HermesValue3217encodeHermesValueENS0_11HermesValueERNS0_7RuntimeE.exit
    i64 -12, label %bb.g
    i64 -11, label %bb.h
    i64 -10, label %bb.i
...
bb.i:                                             ; preds = %bb.f
  %i.aw = trunc i64 %.sroa.0.0.copyload.i.i.i to i1
  %i.ax = select i1 %i.aw, i32 22, i32 6
  br label %_ZN6hermes2vm13HermesValue3217encodeHermesValueENS0_11HermesValueERNS0_7RuntimeE.exit

bb.j:                                             ; preds = %bb.f
  %i.ay = trunc i64 %.sroa.0.0.copyload.i.i.i to i32
  %i.az = shl i32 %i.ay, 3
  %i.ba = or disjoint i32 %i.az, 5
  br label %_ZN6hermes2vm13HermesValue3217encodeHermesValueENS0_11HermesValueERNS0_7RuntimeE.exit

bb.k:                                             ; preds = %bb.f, %bb.f
  %i.bb = ptrtoint ptr %1 to i64
  %i.bc = sub i64 %.sroa.0.0.copyload.i.i.i, %i.bb
...
bb.l:                                             ; preds = %bb.f, %bb.f
  ...
  %i.bg = sub i64 %.sroa.0.0.copyload.i.i.i, %i.bf
...
bb.m:                                             ; preds = %bb.f, %bb.f
  ...
  %i.bk = sub i64 %.sroa.0.0.copyload.i.i.i, %i.bj
  %i.bl = trunc i64 %i.bk to i32
  br label %_ZN6hermes2vm13HermesValue3217encodeHermesValueENS0_11HermesValueERNS0_7RuntimeE.exit

bb.n:                                             ; preds = %bb.f
  %i.bm = bitcast i64 %.sroa.0.0.copyload.i.i.i to double
  %i.bn = fptosi double %i.bm to i32
  %i.bo = shl i32 %i.bn, 3                        ; 2 uses
  %i.bp = ashr exact i32 %i.bo, 3
  %i.bq = sitofp i32 %i.bp to double
  %i.br = bitcast double %i.bq to i64
  %i.bs = icmp eq i64 %.sroa.0.0.copyload.i.i.i, %i.br
  br i1 %i.bs, label %bb.o, label %bb.p, !prof !60

bb.o:                                             ; preds = %bb.n
  %i.bt = or disjoint i32 %i.bo, 4
  br label %_ZN6hermes2vm13HermesValue3217encodeHermesValueENS0_11HermesValueERNS0_7RuntimeE.exit

bb.p:                                             ; preds = %bb.n
  %i.bu = getelementptr inbounds nuw i8, ptr %1, i64 1648 ; 2 uses
  %i.bv = load ptr, ptr %i.bu, align 8, !tbaa !8  ; 2 uses
  %i.bw = getelementptr inbounds nuw i8, ptr %i.bv, i64 16 ; 2 uses
  %i.bx = getelementptr inbounds nuw i8, ptr %1, i64 1656
  %i.by = load ptr, ptr %i.bx, align 8, !tbaa !14
  %.not.i.not.i.i.i.i.i.i.i.i = icmp ugt ptr %i.bw, %i.by
  br i1 %.not.i.not.i.i.i.i.i.i.i.i, label %bb.q, label %bb.r, !prof !7

bb.q:                                             ; preds = %bb.p
  %i.bz = getelementptr inbounds nuw i8, ptr %1, i64 856
  %i.ca = tail call noundef ptr @_ZN6hermes2vm7HadesGC9allocSlowEj(ptr noundef nonnull align 8 dereferenceable(8112) %i.bz, i32 noundef 16) #6
  br label %_ZN6hermes2vm11BoxedDouble6createEdRNS0_7RuntimeE.exit.i.i

bb.r:                                             ; preds = %bb.p
  store ptr %i.bw, ptr %i.bu, align 8, !tbaa !8
  br label %_ZN6hermes2vm11BoxedDouble6createEdRNS0_7RuntimeE.exit.i.i

_ZN6hermes2vm11BoxedDouble6createEdRNS0_7RuntimeE.exit.i.i: ; preds = %bb.r, %bb.q
  %i.cb = phi ptr [ %i.ca, %bb.q ], [ %i.bv, %bb.r ] ; 3 uses
  %i.cc = getelementptr inbounds nuw i8, ptr %i.cb, i64 8
  store i64 %.sroa.0.0.copyload.i.i.i, ptr %i.cc, align 8, !tbaa !103
  store i32 402653200, ptr %i.cb, align 8, !tbaa !15
...
_ZN6hermes2vm13HermesValue3217encodeHermesValueENS0_11HermesValueERNS0_7RuntimeE.exit: ; preds = %bb.f, %bb.g, %bb.h, %bb.i, %bb.j, %bb.k, %bb.l, %bb.m, %bb.o, %_ZN6hermes2vm11BoxedDouble6createEdRNS0_7RuntimeE.exit.i.i
  %.sroa.04.0.i = phi i32 [ 7, %bb.f ], [ %i.bl, %bb.m ], [ 14, %bb.g ], [ 15, %bb.h ], [ %i.ax, %bb.i ], [ %i.ba, %bb.j ], [ %i.be, %bb.k ], [ %i.bi, %bb.l ], [ %i.bt, %bb.o ], [ %i.ch, %_ZN6hermes2vm11BoxedDouble6createEdRNS0_7RuntimeE.exit.i.i ] ; 2 uses
  %i.ci = load ptr, ptr %0, align 8, !tbaa !57
  %.sroa.0.0.copyload.i.i10 = load i64, ptr %i.ci, align 8, !tbaa !51
  %i.cj = and i64 %.sroa.0.0.copyload.i.i10, 281474976710655
  %i.ck = inttoptr i64 %i.cj to ptr
  %i.cl = getelementptr inbounds nuw i8, ptr %i.ck, i64 8
  %i.cm = zext i32 %i.e to i64
  %i.cn = getelementptr inbounds nuw [4 x i8], ptr %i.cl, i64 %i.cm ; 3 uses
  %i.co = getelementptr inbounds nuw i8, ptr %1, i64 1632
  %i.cp = load ptr, ptr %i.co, align 8, !tbaa !54
  %i.cq = ptrtoint ptr %i.cn to i64
  %i.cr = and i64 %i.cq, 1125899902648320
  %i.cs = inttoptr i64 %i.cr to ptr
  %i.ct = icmp eq ptr %i.cp, %i.cs
  br i1 %i.ct, label %_ZN6hermes2vm16ArrayStorageBaseINS0_13HermesValue32EE3setILNS3_6InlineE0EEEvjS2_RNS0_7HadesGCE.exit, label %bb.s, !prof !60

bb.s:                                             ; preds = %_ZN6hermes2vm13HermesValue3217encodeHermesValueENS0_11HermesValueERNS0_7RuntimeE.exit
  %i.cu = getelementptr inbounds nuw i8, ptr %1, i64 856
  tail call void @_ZN6hermes2vm7HadesGC16writeBarrierSlowEPKNS0_17GCHermesValueBaseINS0_13HermesValue32EEES3_(ptr noundef nonnull align 8 dereferenceable(8112) %i.cu, ptr noundef nonnull align 4 dereferenceable(4) %i.cn, i32 %.sroa.04.0.i) #6
...
_ZN6hermes2vm16ArrayStorageBaseINS0_13HermesValue32EE3setILNS3_6InlineE0EEEvjS2_RNS0_7HadesGCE.exit: ; preds = %_ZN6hermes2vm13HermesValue3217encodeHermesValueENS0_11HermesValueERNS0_7RuntimeE.exit, %bb.s
  store i32 %.sroa.04.0.i, ptr %i.cn, align 4, !tbaa !109
  br label %bb.t
end_hunk_0
...
.lr.ph.i38.preheader:                             ; preds = %bb.i
  ...
  %6 = shl nuw nsw i64 %i.bn, 2
  %7 = add nsw i64 %.idx56, -4
  %i.bo = sub nsw i64 %7, %6                      ; 2 uses
  %i.bp = lshr exact i64 %i.bo, 2
  %i.bq = add nuw nsw i64 %i.bp, 1                ; 2 uses
  %min.iters.check63 = icmp ult i64 %i.bo, 28
...
vector.ph64:                                      ; preds = %.lr.ph.i38.preheader
  ...
  %i.br = shl i64 %n.vec65, 2
  %i.bs = getelementptr i8, ptr %i.bm, i64 %i.br
...
vector.body66:                                    ; preds = %vector.body66, %vector.ph64
  ...
  %i.bt = shl i64 %index67, 2
  %next.gep68 = getelementptr i8, ptr %i.bm, i64 %i.bt ; 2 uses
  %i.bu = getelementptr i8, ptr %next.gep68, i64 16
  store <4 x i32> splat (i32 7), ptr %next.gep68, align 4, !tbaa !3
  store <4 x i32> splat (i32 7), ptr %i.bu, align 4, !tbaa !3
  %index.next69 = add nuw i64 %index67, 8         ; 2 uses
  %i.bv = icmp eq i64 %index.next69, %n.vec65
  br i1 %i.bv, label %middle.block70, label %vector.body66, !llvm.loop !113

middle.block70:                                   ; preds = %vector.body66
  %cmp.n71 = icmp eq i64 %i.bq, %n.vec65
...
.lr.ph.i38.preheader73:                           ; preds = %.lr.ph.i38.preheader, %middle.block70
  %.01320.i39.ph = phi ptr [ %i.bm, %.lr.ph.i38.preheader ], [ %i.bs, %middle.block70 ]
  br label %.lr.ph.i38

.lr.ph.i38:                                       ; preds = %.lr.ph.i38.preheader73, %.lr.ph.i38
  %.01320.i39 = phi ptr [ %i.bw, %.lr.ph.i38 ], [ %.01320.i39.ph, %.lr.ph.i38.preheader73 ] ; 2 uses
  store i32 7, ptr %.01320.i39, align 4, !tbaa !3
  %i.bw = getelementptr inbounds nuw i8, ptr %.01320.i39, i64 4 ; 2 uses
  %.not.i40 = icmp eq ptr %i.bw, %i.bk
...
_ZN6hermes2vm17GCHermesValueBaseINS0_13HermesValue32EE18uninitialized_fillIPS3_EEvT_S6_S2_RNS0_7HadesGCE.exit41: ; preds = %.lr.ph.i38, %middle.block70, %bb.i, %_ZN6hermes2vm17GCHermesValueBaseINS0_13HermesValue32EE18uninitialized_fillIPS3_EEvT_S6_S2_RNS0_7HadesGCE.exit
  %i.bx = getelementptr inbounds nuw i8, ptr %i.ac, i64 4
  store atomic i32 %5, ptr %i.bx release, align 4
  %.sroa.0.0.copyload.i.i42 = load i64, ptr %.0.i.i.i.i.i.i, align 8, !tbaa !51
  %i.by = or i64 %.sroa.0.0.copyload.i.i42, -281474976710656
  %i.bz = load ptr, ptr %0, align 8, !tbaa !78
  store i64 %i.by, ptr %i.bz, align 8, !tbaa !61
  br label %bb.j
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.q = add nsw i64 %.idx89.i, -4
  %i.r = sub nsw i64 %i.q, %.idx88.i              ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x i32> splat (i32 7), ptr %next.gep, align 4, !tbaa !3
  store <4 x i32> splat (i32 7), ptr %i.x, align 4, !tbaa !3
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.y = icmp eq i64 %index.next, %n.vec
  br i1 %i.y, label %middle.block, label %vector.body, !llvm.loop !115
...
.lr.ph.i65.i.preheader:                           ; preds = %bb.c, %middle.block
  %.01320.i66.i.ph = phi ptr [ %i.p, %bb.c ], [ %i.v, %middle.block ]
  br label %.lr.ph.i65.i

.lr.ph.i65.i:                                     ; preds = %.lr.ph.i65.i.preheader, %.lr.ph.i65.i
  %.01320.i66.i = phi ptr [ %i.z, %.lr.ph.i65.i ], [ %.01320.i66.i.ph, %.lr.ph.i65.i.preheader ] ; 2 uses
  store i32 7, ptr %.01320.i66.i, align 4, !tbaa !3
  %i.z = getelementptr inbounds nuw i8, ptr %.01320.i66.i, i64 4 ; 2 uses
  %.not.i67.i = icmp eq ptr %i.z, %i.o
...
_ZN6hermes2vm17GCHermesValueBaseINS0_13HermesValue32EE18uninitialized_fillIPS3_EEvT_S6_S2_RNS0_7HadesGCE.exit.i: ; preds = %.lr.ph.i65.i, %middle.block, %bb.b
  %i.aa = load atomic i32, ptr %i.h monotonic, align 4
  %i.ab = icmp ult i32 %2, %i.aa
  br i1 %i.ab, label %bb.d, label %_ZN6hermes2vm17GCHermesValueBaseINS0_13HermesValue32EE28rangeUnreachableWriteBarrierEPS3_S4_RNS0_7HadesGCE.exit.i
...
.lr.ph.i65.preheader:                             ; preds = %bb.l
  ...
  %i.cb = add i64 %.idx89, %i.bz
  %i.cc = add i64 %i.cb, -4
  %i.cd = add i64 %.idx88, %i.ca
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x i32> splat (i32 7), ptr %next.gep, align 4, !tbaa !3
  store <4 x i32> splat (i32 7), ptr %i.ck, align 4, !tbaa !3
  %index.next = add nuw i64 %index, 8             ; 2 uses
...
.lr.ph.i65.preheader108:                          ; preds = %.lr.ph.i65.preheader, %middle.block
  %.01320.i66.ph = phi ptr [ %i.by, %.lr.ph.i65.preheader ], [ %i.ci, %middle.block ]
  br label %.lr.ph.i65

.lr.ph.i65:                                       ; preds = %.lr.ph.i65.preheader108, %.lr.ph.i65
  %.01320.i66 = phi ptr [ %i.cm, %.lr.ph.i65 ], [ %.01320.i66.ph, %.lr.ph.i65.preheader108 ] ; 2 uses
  store i32 7, ptr %.01320.i66, align 4, !tbaa !3
  %i.cm = getelementptr inbounds nuw i8, ptr %.01320.i66, i64 4 ; 2 uses
  %.not.i67 = icmp eq ptr %i.cm, %i.bw
...
_ZN6hermes2vm17GCHermesValueBaseINS0_13HermesValue32EE18uninitialized_fillIPS3_EEvT_S6_S2_RNS0_7HadesGCE.exit: ; preds = %.lr.ph.i65, %middle.block, %bb.l, %_ZN6hermes2vm17GCHermesValueBaseINS0_13HermesValue32EE4fillIPS3_EEvT_S6_S2_RNS0_7HadesGCE.exit
  ...
  %i.co = icmp ult i32 %4, %i.cn
  br i1 %i.co, label %bb.m, label %_ZN6hermes2vm17GCHermesValueBaseINS0_13HermesValue32EE28rangeUnreachableWriteBarrierEPS3_S4_RNS0_7HadesGCE.exit
...
bb.m:                                             ; preds = %_ZN6hermes2vm17GCHermesValueBaseINS0_13HermesValue32EE18uninitialized_fillIPS3_EEvT_S6_S2_RNS0_7HadesGCE.exit
  ...
  %.idx91 = shl nuw nsw i64 %i.cp, 2
  %i.cq = getelementptr inbounds nuw i8, ptr %i.br, i64 %.idx91 ; 2 uses
  %i.cr = load atomic i32, ptr %i.h monotonic, align 4
  %i.cs = ptrtoint ptr %i.cq to i64
  %i.ct = getelementptr inbounds nuw i8, ptr %1, i64 1632
  %i.cu = load ptr, ptr %i.ct, align 8, !tbaa !54
  %i.cv = and i64 %i.cs, 1125899902648320
  %i.cw = inttoptr i64 %i.cv to ptr
  %i.cx = icmp ne ptr %i.cu, %i.cw
  %i.cy = getelementptr inbounds nuw i8, ptr %1, i64 8489
  %i.cz = load i8, ptr %i.cy, align 1, !range !55
  %i.da = trunc nuw i8 %i.cz to i1
  %or.cond.i.i = select i1 %i.cx, i1 %i.da, i1 false, !prof !56
...
bb.n:                                             ; preds = %bb.m
  %i.db = sub i32 %i.cr, %4
  tail call void @_ZN6hermes2vm7HadesGC29snapshotWriteBarrierRangeSlowEPKNS0_17GCHermesValueBaseINS0_13HermesValue32EEEj(ptr noundef nonnull align 8 dereferenceable(8112) %i.bp, ptr noundef nonnull %i.cq, i32 noundef %i.db) #6
...
bb.o:                                             ; preds = %bb.a
  %i.dc = icmp ult i32 %i.f, 2054140
  %i.dd = lshr exact i32 %i.f, 1
  %.sroa.speculated = tail call i32 @llvm.umax.i32(i32 %i.dd, i32 %4)
  %.0 = select i1 %i.dc, i32 %.sroa.speculated, i32 1027070
  %i.de = tail call noundef i32 @_ZN6hermes2vm16ArrayStorageBaseINS0_13HermesValue32EE18reallocateToLargerERNS0_13MutableHandleIS3_EERNS0_7RuntimeEjjjj(ptr noundef nonnull align 8 dereferenceable(8) %0, ptr noundef nonnull align 8 dereferenceable(9816) %1, i32 noundef %.0, i32 noundef %2, i32 noundef %3, i32 noundef %4)
  br label %bb.p
...
bb.p:                                             ; preds = %bb.o, %_ZN6hermes2vm17GCHermesValueBaseINS0_13HermesValue32EE28rangeUnreachableWriteBarrierEPS3_S4_RNS0_7HadesGCE.exit
  %.052 = phi i32 [ 1, %_ZN6hermes2vm17GCHermesValueBaseINS0_13HermesValue32EE28rangeUnreachableWriteBarrierEPS3_S4_RNS0_7HadesGCE.exit ], [ %i.de, %bb.o ]
  ret i32 %.052
}
