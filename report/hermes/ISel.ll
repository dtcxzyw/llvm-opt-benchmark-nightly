...
_ZNSt6vectorIPN6hermes10BasicBlockESaIS2_EE6resizeEm.exit: ; preds = %bb.a, %_ZNSt6vectorIPN6hermes10BasicBlockESaIS2_EE17_M_default_appendEm.exit
  %.sroa.19.0 = phi ptr [ %i.t, %_ZNSt6vectorIPN6hermes10BasicBlockESaIS2_EE17_M_default_appendEm.exit ], [ null, %bb.a ] ; 2 uses
  %.sroa.022.0 = phi ptr [ %i.p, %_ZNSt6vectorIPN6hermes10BasicBlockESaIS2_EE17_M_default_appendEm.exit ], [ null, %bb.a ] ; 8 uses
...
begin_hunk_1_@_ZN6hermes3hbc7HBCISel21generateSwitchImmInstEPNS_13SwitchImmInstEPNS_10BasicBlockE:bb.a
  ...
  %i.al = getelementptr inbounds nuw [8 x i8], ptr %.sroa.022.0, i64 %i.ak
...
begin_hunk_2_@_ZN6hermes3hbc7HBCISel21generateSwitchImmInstEPNS_13SwitchImmInstEPNS_10BasicBlockE:bb.a
  ...
  %i.by = ptrtoint ptr %.sroa.19.0 to i64
  %i.bz = ptrtoint ptr %.sroa.022.0 to i64
  %i.ca = sub i64 %i.by, %i.bz                    ; 8 uses
  %.not.i.i.i.i = icmp eq ptr %.sroa.19.0, %.sroa.022.0
...
bb.g:                                             ; preds = %_ZNSt12_Vector_baseIPN6hermes10BasicBlockESaIS2_EEC2EmRKS3_.exit.i
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %i.cd, ptr align 8 %.sroa.022.0, i64 %i.ca, i1 false)
...
bb.i:                                             ; preds = %bb.h
  %i.ch = load ptr, ptr %.sroa.022.0, align 8, !tbaa !86
...
bb.k:                                             ; preds = %_ZN6hermes3hbc7HBCISel13SwitchImmInfoD2Ev.exit
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.022.0, i64 noundef %i.ca) #23
...
.lr.ph36:                                         ; preds = %.preheader, %bb.m
  ...
  %i.cv = getelementptr inbounds nuw [8 x i8], ptr %.sroa.022.0, i64 %indvars.iv ; 2 uses
...
bb.b:                                             ; preds = %.lr.ph
  %3 = load ptr, ptr %0, align 8, !tbaa !97       ; 2 uses
  %4 = load i32, ptr %i.d, align 8, !tbaa !98     ; 2 uses
  %5 = icmp ne i32 %4, 0
  ...
  %i.ab = getelementptr inbounds nuw [104 x i8], ptr %3, i64 %i.aa ; 3 uses
...
begin_hunk_8_@_ZN4llvh12DenseMapBaseINS_8DenseMapIPN6hermes9CatchInstENS2_17CatchCoverageInfoENS_12DenseMapInfoIS4_EENS_6detail12DenseMapPairIS4_S5_EEEES4_S5_S7_SA_E18moveFromOldBucketsEPSA_SD_:bb.a
  ...
  %i.an = getelementptr inbounds nuw [104 x i8], ptr %3, i64 %i.am ; 3 uses
...
_ZN4llvh12DenseMapBaseINS_8DenseMapIPN6hermes9CatchInstENS2_17CatchCoverageInfoENS_12DenseMapInfoIS4_EENS_6detail12DenseMapPairIS4_S5_EEEES4_S5_S7_SA_E15LookupBucketForIS4_EEbRKT_RPSA_.exit: ; preds = %bb.d, %bb.b, %bb.c
  %.sink.i.i = phi ptr [ %i.ah, %bb.c ], [ %i.ab, %bb.b ], [ %i.an, %bb.d ] ; 7 uses
