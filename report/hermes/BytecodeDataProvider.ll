...
begin_hunk_0_@_ZN6hermes3hbc20BCProviderFromBufferC2ESt10unique_ptrIKNS_6BufferESt14default_deleteIS4_EENS0_12BytecodeFormE:bb.a
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 160) (i8, ptr @_ZTVN6hermes3hbc20BCProviderFromBufferE, i64 16), ptr %0, align 8, !tbaa !39
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 280 ; 2 uses
  %i.h = load i64, ptr %1, align 8, !tbaa !139
  store i64 %i.h, ptr %i.g, align 8, !tbaa !139
  store ptr null, ptr %1, align 8, !tbaa !139
  %i.i = getelementptr inbounds nuw i8, ptr %0, i64 288
  %i.j = load ptr, ptr %i.g, align 8, !tbaa !139  ; 2 uses
  %i.k = getelementptr inbounds nuw i8, ptr %i.j, i64 8
  %i.l = load ptr, ptr %i.k, align 8, !tbaa !143  ; 6 uses
  store ptr %i.l, ptr %i.i, align 8, !tbaa !181
  ...
  store ptr null, ptr %i.o, align 8, !tbaa !182
...
define hidden { ptr, i64 } @_ZNK6hermes3hbc20BCProviderFromBuffer11getEpilogueEv(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(376) %0) unnamed_addr #5 align 2 {
bb.a:
...
define hidden void @_ZNK6hermes3hbc20BCProviderFromBuffer13getSourceHashEv(ptr dead_on_unwind noalias nofree writable writeonly sret(%"struct.std::array") align 1 captures(none) initializes((0, 20)) %0, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(376) %1) unnamed_addr #7 align 2 {
bb.a:
...
define hidden void @_ZN6hermes3hbc20BCProviderFromBuffer25getSourceHashFromBytecodeEN4llvh8ArrayRefIhEE(ptr dead_on_unwind noalias nofree writable writeonly sret(%"struct.std::array") align 1 captures(none) initializes((0, 20)) %0, ptr nofree readonly captures(none) %1, i64 %2) local_unnamed_addr #8 align 2 {
bb.a:
...
define hidden void @_ZN6hermes3hbc20BCProviderFromBuffer15createDebugInfoEv(ptr nofree noundef nonnull align 8 captures(none) dereferenceable(376) %0) unnamed_addr #0 align 2 {
bb.a:
...
._crit_edge.loopexit:                             ; preds = %_ZN4llvh23SmallVectorTemplateBaseIN6hermes3hbc15DebugFileRegionELb1EE9push_backERKS3_.exit
  %i.ai = icmp eq i32 %i.bw, 0
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %_ZN6hermes3hbc12_GLOBAL__N_112castArrayRefIhEEN4llvh8ArrayRefIT_EERPKhmS8_.exit
  %.not.i.i.i = phi i1 [ true, %_ZN6hermes3hbc12_GLOBAL__N_112castArrayRefIhEEN4llvh8ArrayRefIT_EERPKhmS8_.exit ], [ %i.ai, %._crit_edge.loopexit ]
...
_ZNK4llvh8ArrayRefIhEcvSt6vectorIhSaIhEEEv.exit:  ; preds = %_ZNSt6vectorIhSaIhEE17_S_check_init_lenEmRKS0_.exit.i.i.i, %bb.f, %bb.g
  ...
  store ptr %.sroa.025.0, ptr %i.aj, align 8, !tbaa !124
  ...
  %i.ba = getelementptr inbounds nuw i8, ptr %i.aj, i64 32
  ...
  %i.bc = getelementptr inbounds nuw i8, ptr %i.aj, i64 48 ; 2 uses
  %i.bd = getelementptr inbounds nuw i8, ptr %i.aj, i64 64
  store ptr %i.bd, ptr %i.bc, align 8, !tbaa !202
  %i.be = getelementptr inbounds nuw i8, ptr %i.aj, i64 56
  store i32 0, ptr %i.be, align 8, !tbaa !204
  %i.bf = getelementptr inbounds nuw i8, ptr %i.aj, i64 60
...
_ZNSt6vectorIN6hermes16StringTableEntryESaIS1_EED2Ev.exit: ; preds = %bb.h, %_ZNK4llvh8ArrayRefIhEcvSt6vectorIhSaIhEEEv.exit
  %i.bh = getelementptr inbounds nuw i8, ptr %i.aj, i64 80
  store <2 x i32> %i.ar, ptr %i.bh, align 8, !tbaa !3
  %i.bi = getelementptr inbounds nuw i8, ptr %i.aj, i64 88
  store i32 %i.at, ptr %i.bi, align 8, !tbaa !219
  %i.bj = getelementptr inbounds nuw i8, ptr %i.aj, i64 96
  %i.bk = getelementptr inbounds nuw i8, ptr %i.aj, i64 120
  ...
  %.sroa.11.24..sroa_idx = getelementptr inbounds nuw i8, ptr %i.aj, i64 128
  store i64 %i.aw, ptr %.sroa.11.24..sroa_idx, align 8, !tbaa !58
  %i.bl = getelementptr inbounds nuw i8, ptr %0, i64 240
  store ptr %i.aj, ptr %i.bl, align 8, !tbaa !108
...
; Function Attrs: mustprogress nounwind uwtable
define hidden void @_ZNK6hermes3hbc20BCProviderFromBuffer32getExceptionTableAndDebugOffsetsEj(ptr dead_on_unwind noalias nofree writable writeonly sret(%"struct.std::pair") align 8 captures(none) %0, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(376) %1, i32 noundef %2) local_unnamed_addr #0 align 2 {
bb.a:
