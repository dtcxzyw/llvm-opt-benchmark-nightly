...
.lr.ph:                                           ; preds = %_ZN6hermes3hbc12_GLOBAL__N_112castArrayRefIhEEN4llvh8ArrayRefIT_EERPKhmS8_.exit, %_ZN4llvh23SmallVectorTemplateBaseIN6hermes3hbc15DebugFileRegionELb1EE9push_backERKS3_.exit
  %i.bp = phi i32 [ %i.bx, %_ZN4llvh23SmallVectorTemplateBaseIN6hermes3hbc15DebugFileRegionELb1EE9push_backERKS3_.exit ], [ 0, %_ZN6hermes3hbc12_GLOBAL__N_112castArrayRefIhEEN4llvh8ArrayRefIT_EERPKhmS8_.exit ] ; 2 uses
  %.039 = phi i32 [ %i.by, %_ZN4llvh23SmallVectorTemplateBaseIN6hermes3hbc15DebugFileRegionELb1EE9push_backERKS3_.exit ], [ 0, %_ZN6hermes3hbc12_GLOBAL__N_112castArrayRefIhEEN4llvh8ArrayRefIT_EERPKhmS8_.exit ]
  %.03738 = phi ptr [ %i.bq, %_ZN4llvh23SmallVectorTemplateBaseIN6hermes3hbc15DebugFileRegionELb1EE9push_backERKS3_.exit ], [ %i.ac, %_ZN6hermes3hbc12_GLOBAL__N_112castArrayRefIhEEN4llvh8ArrayRefIT_EERPKhmS8_.exit ] ; 2 uses
  %i.bq = getelementptr inbounds nuw i8, ptr %.03738, i64 12 ; 2 uses
  %i.br = load i32, ptr %i.af, align 4, !tbaa !205
  %.not.i17 = icmp ult i32 %i.bp, %i.br
...
_ZN4llvh23SmallVectorTemplateBaseIN6hermes3hbc15DebugFileRegionELb1EE9push_backERKS3_.exit: ; preds = %.lr.ph, %bb.j
  %i.bs = phi i32 [ %.pre.i, %bb.j ], [ %i.bp, %.lr.ph ]
  %i.bt = load ptr, ptr %1, align 8, !tbaa !202
  %i.bu = zext i32 %i.bs to i64
  %i.bv = getelementptr inbounds nuw [12 x i8], ptr %i.bt, i64 %i.bu
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(12) %i.bv, ptr noundef nonnull align 1 dereferenceable(12) %.03738, i64 12, i1 false)
  %i.bw = load i32, ptr %i.ae, align 8, !tbaa !204
  %i.bx = add i32 %i.bw, 1                        ; 3 uses
  store i32 %i.bx, ptr %i.ae, align 8, !tbaa !204
  %i.by = add nuw i32 %.039, 1                    ; 2 uses
  %i.bz = load i32, ptr %i.ag, align 1, !tbaa !206
  %i.ca = icmp ult i32 %i.by, %i.bz
  br i1 %i.ca, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !234
}
