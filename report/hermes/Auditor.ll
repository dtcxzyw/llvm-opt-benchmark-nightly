...
.lr.ph28.i:                                       ; preds = %bb.a, %._crit_edge.i
  %.sroa.017.026.i = phi ptr [ %.sroa.017.0.i, %._crit_edge.i ], [ %.sroa.017.024.i, %bb.a ] ; 3 uses
...
.lr.ph.i:                                         ; preds = %.lr.ph28.i, %bb.d
  %.sroa.013.023.i = phi ptr [ %.sroa.013.0.i, %bb.d ], [ %.sroa.013.021.i, %.lr.ph28.i ] ; 3 uses
...
bb.b:                                             ; preds = %.lr.ph.i
  %i.i = tail call noundef ptr @_ZNK6hermes11Instruction10getOperandEj(ptr noundef nonnull align 8 dereferenceable(144) %.sroa.013.023.i, i32 noundef 0) #4 ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.l = tail call noundef ptr @_ZNK6hermes11Instruction10getOperandEj(ptr noundef nonnull align 8 dereferenceable(132) %i.k, i32 noundef 0) #4
  %i.m = getelementptr inbounds nuw i8, ptr %i.l, i64 56
  %i.n = load ptr, ptr %i.m, align 8, !tbaa !22
  %i.o = tail call noundef zeroext i1 @_ZNK6hermes9ScopeDesc13isGlobalScopeEv(ptr noundef nonnull align 8 dereferenceable(233) %i.n) #4 ; 0 uses
  br label %bb.d
...
_ZNSt10unique_ptrIN6hermes7AuditorESt14default_deleteIS1_EED2Ev.exit:
  %i.a = tail call noalias noundef nonnull dereferenceable(32) ptr @_Znwm(i64 noundef 32) #5, !noalias !29 ; 5 uses
