...
bb.b:                                             ; preds = %.lr.ph.split.split.us
  ...
  %i.ad = mul nuw i64 %i.ac, %i.c                 ; 3 uses
  %i.ae = lshr i64 %i.aa, 32                      ; 2 uses
  %i.af = mul nuw i64 %i.ae, %i.d
  %i.ag = mul nuw i64 %i.ac, %i.d                 ; 3 uses
...
_ZN4llvh7hashing6detail18get_execution_seedEv.exit: ; preds = %bb.a, %bb.b, %bb.c
  %i.f = load i64, ptr @_ZZN4llvh7hashing6detail18get_execution_seedEvE4seed, align 8, !tbaa !10 ; 10 uses
