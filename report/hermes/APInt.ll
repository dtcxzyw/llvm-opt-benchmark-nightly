...
.lr.ph187:                                        ; preds = %.lr.ph187.preheader, %bb.j
  ...
  %.1142186 = phi i32 [ %.0141.lcssa, %.lr.ph187.preheader ], [ %i.ex, %bb.j ] ; 2 uses
...
.lr.ph187..critedge2.loopexit_crit_edge:          ; preds = %.lr.ph187
  %.1142186.lcssa.a = phi i32 [ %.1142186, %.lr.ph187 ]
  br label %.critedge2.loopexit

.critedge2.loopexit:                              ; preds = %.critedge2.loopexitsplit, %.lr.ph187..critedge2.loopexit_crit_edge
  %.1142.lcssa.ph = phi i32 [ %.1142186.lcssa.a, %.lr.ph187..critedge2.loopexit_crit_edge ], [ %i.eq, %.critedge2.loopexitsplit ]
  br label %.critedge2
...
bb.c:                                             ; preds = %.lr.ph, %bb.c
  ...
  %scevgep28 = getelementptr i8, ptr %.tr21, i64 %lsr.iv
