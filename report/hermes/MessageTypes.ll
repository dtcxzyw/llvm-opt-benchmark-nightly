...
_ZN4llvh16dyn_cast_or_nullIN6hermes6parser10JSONObjectEKNS2_9JSONValueEEENS_10cast_rettyIT_PT0_E8ret_typeES9_.exit: ; preds = %bb.c
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVN8facebook6hermes3cdp7message7runtime12EntryPreviewE, i64 16), ptr %i.n, align 8, !tbaa !84, !noalias !2178
  %i.o = getelementptr inbounds nuw i8, ptr %i.n, i64 8 ; 3 uses
  %i.p = getelementptr inbounds nuw i8, ptr %i.n, i64 32 ; 2 uses
  store ptr @_ZNSt17_Function_handlerIFvPN8facebook6hermes3cdp7message7runtime13ObjectPreviewEEPS7_E9_M_invokeERKSt9_Any_dataOS6_, ptr %i.p, align 8, !tbaa !353, !noalias !2178
  %i.q = getelementptr inbounds nuw i8, ptr %i.n, i64 24 ; 4 uses
  store ptr @_ZN8facebook6hermes3cdp7message7deleterINS2_7runtime13ObjectPreviewEEEvPT_, ptr %i.o, align 8, !noalias !2178
  ...
  store ptr @_ZNSt17_Function_handlerIFvPN8facebook6hermes3cdp7message7runtime13ObjectPreviewEEPS7_E10_M_managerERSt9_Any_dataRKSA_St18_Manager_operation, ptr %i.q, align 8, !tbaa !356, !noalias !2178
  %i.r = getelementptr inbounds nuw i8, ptr %i.n, i64 40 ; 3 uses
  %i.s = getelementptr inbounds nuw i8, ptr %i.n, i64 48 ; 3 uses
  %i.t = getelementptr inbounds nuw i8, ptr %i.n, i64 72 ; 2 uses
  store i64 0, ptr %i.r, align 8, !noalias !2178
  store ptr @_ZNSt17_Function_handlerIFvPN8facebook6hermes3cdp7message7runtime13ObjectPreviewEEPS7_E9_M_invokeERKSt9_Any_dataOS6_, ptr %i.t, align 8, !tbaa !353, !noalias !2178
  ...
  store ptr @_ZNSt17_Function_handlerIFvPN8facebook6hermes3cdp7message7runtime13ObjectPreviewEEPS7_E10_M_managerERSt9_Any_dataRKSA_St18_Manager_operation, ptr %i.u, align 8, !tbaa !356, !noalias !2178
...
.lr.ph.i.i:                                       ; preds = %bb.a, %_ZSt19__relocate_object_aIN8facebook6hermes3cdp7message12heapProfiler23SamplingHeapProfileNodeES5_SaIS5_EEvPT_PT0_RT1_.exit.i.i
  %.012.i.i = phi ptr [ %i.bd, %_ZSt19__relocate_object_aIN8facebook6hermes3cdp7message12heapProfiler23SamplingHeapProfileNodeES5_SaIS5_EEvPT_PT0_RT1_.exit.i.i ], [ %2, %bb.a ] ; 16 uses
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVN8facebook6hermes3cdp7message12heapProfiler23SamplingHeapProfileNodeE, i64 16), ptr %.012.i.i, align 8, !tbaa !84, !alias.scope !2303, !noalias !2306
  %4 = getelementptr inbounds nuw i8, ptr %.012.i.i, i64 8
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVN8facebook6hermes3cdp7message7runtime9CallFrameE, i64 16), ptr %4, align 8, !tbaa !84, !alias.scope !2303, !noalias !2306
