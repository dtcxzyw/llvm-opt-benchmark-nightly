...
bb.b:                                             ; preds = %bb.a
  %i.g = call noundef zeroext i1 %i.f(ptr noundef nonnull align 8 dereferenceable(32) %3, ptr noundef nonnull align 8 dereferenceable(32) %3, i32 noundef 3) #7 ; 0 uses
...
bb.e:                                             ; preds = %bb.c
  ...
  store ptr %i.x, ptr %i.p, align 8, !tbaa !21
...
bb.g:                                             ; preds = %_ZN4llvh11raw_ostreamlsEPKc.exit
  ...
  %i.ai = load ptr, ptr %i.ab, align 8, !tbaa !21
  %i.aj = getelementptr inbounds nuw i8, ptr %i.ai, i64 56
  store ptr %i.aj, ptr %i.ab, align 8, !tbaa !21
...
bb.k:                                             ; preds = %bb.i
  ...
  %i.aw = load ptr, ptr %i.ap, align 8, !tbaa !21
  %i.ax = getelementptr inbounds nuw i8, ptr %i.aw, i64 37
  store ptr %i.ax, ptr %i.ap, align 8, !tbaa !21
  br label %_ZN4llvh11raw_ostreamlsEPKc.exit6

bb.l:                                             ; preds = %bb.h
  %i.ay = load i32, ptr %4, align 8, !tbaa !24
  br label %_ZN4llvh11raw_ostreamlsEPKc.exit6
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i: ; preds = %_ZN4llvh11raw_ostreamlsEPKc.exit6
  %i.bd = load i64, ptr %i.bb, align 8, !tbaa !39
  %i.be = add i64 %i.bd, 1
...
_ZN6hermes6driver18BytecodeBufferInfoD2Ev.exit.i: ; preds = %_ZN4llvh11raw_ostreamlsEPKc.exit6, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i
  %i.bf = load ptr, ptr %i.ak, align 8, !tbaa !22 ; 3 uses
...
_ZNKSt14default_deleteIN6hermes3hbc14BCProviderBaseEEclEPS2_.exit.i.i: ; preds = %_ZN6hermes6driver18BytecodeBufferInfoD2Ev.exit.i
  ...
  call void %i.bi(ptr noundef nonnull align 8 dead_on_return(280) dereferenceable(280) %i.bf) #7
...
bb.a:
  ...
  tail call void %i.a(ptr noundef nonnull align 8 dereferenceable(36) %1) #7
  ret void
}
...
!16 = !{!15, !11, i64 16}
!17 = !{!18, !19, i64 16}
!18 = !{!"_ZTSN4llvh11raw_ostreamE", !19, i64 8, !19, i64 16, !19, i64 24, !20, i64 32}
!19 = !{!"p1 omnipotent char", !11, i64 0}
!20 = !{!"_ZTSN4llvh11raw_ostream10BufferKindE", !6, i64 0}
!21 = !{!18, !19, i64 24}
!22 = !{!23, !23, i64 0}
!23 = !{!"p1 _ZTSN6hermes3hbc14BCProviderBaseE", !11, i64 0}
!24 = !{!25, !26, i64 0}
!25 = !{!"_ZTSN6hermes6driver13CompileResultE", !26, i64 0, !27, i64 8, !33, i64 16}
!26 = !{!"_ZTSN6hermes6driver13CompileStatusE", !6, i64 0}
!27 = !{!"_ZTSSt10unique_ptrIN6hermes3hbc14BCProviderBaseESt14default_deleteIS2_EE", !28, i64 0}
!28 = !{!"_ZTSSt15__uniq_ptr_dataIN6hermes3hbc14BCProviderBaseESt14default_deleteIS2_ELb1ELb1EE", !29, i64 0}
!29 = !{!"_ZTSSt15__uniq_ptr_implIN6hermes3hbc14BCProviderBaseESt14default_deleteIS2_EE", !30, i64 0}
!30 = !{!"_ZTSSt5tupleIJPN6hermes3hbc14BCProviderBaseESt14default_deleteIS2_EEE", !31, i64 0}
!31 = !{!"_ZTSSt11_Tuple_implILm0EJPN6hermes3hbc14BCProviderBaseESt14default_deleteIS2_EEE", !32, i64 0}
!32 = !{!"_ZTSSt10_Head_baseILm0EPN6hermes3hbc14BCProviderBaseELb0EE", !23, i64 0}
!33 = !{!"_ZTSN6hermes6driver18BytecodeBufferInfoE", !34, i64 0, !19, i64 8, !35, i64 16, !36, i64 24}
!34 = !{!"bool", !6, i64 0}
!35 = !{!"long", !6, i64 0}
!36 = !{!"_ZTSNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE", !37, i64 0, !35, i64 8, !6, i64 16}
