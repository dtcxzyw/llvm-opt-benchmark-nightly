...
begin_hunk_0_@_ZN6hermes2vm18StatSamplingThreadC2ENSt6chrono8durationIlSt5ratioILl1ELl1000000000EEEE:bb.a
  ...
  call void %i.l(ptr noundef nonnull align 8 dead_on_return(8) dereferenceable(8) %i.i) #11
...
_ZNSt11unique_lockISt5mutexEC2ERS0_.exit.preheader: ; preds = %bb.a
  %i.c = load i8, ptr %0, align 8, !tbaa !7, !range !34, !noundef !35
...
begin_hunk_2_@_ZN6hermes2vm18StatSamplingThread3runEv:bb.a
  ...
  store i64 %i.l, ptr %1, align 8, !tbaa !36
  store i64 %i.m, ptr %i.h, align 8, !tbaa !38
  ...
  %i.p = load i8, ptr %0, align 8, !tbaa !7, !range !34, !noundef !35
  %i.q = trunc nuw i8 %i.p to i1
  br i1 %i.q, label %_ZNSt11unique_lockISt5mutexED2Ev.exit, label %_ZNSt11unique_lockISt5mutexEC2ERS0_.exit, !llvm.loop !39
...
bb.a:
  ...
  %i.c = load ptr, ptr %i.a, align 8, !tbaa !41
  %.unpack.i.i.i.i = load i64, ptr %i.b, align 8, !tbaa !42 ; 3 uses
  %.elt2.i.i.i.i = getelementptr inbounds nuw i8, ptr %0, i64 24
  %.unpack3.i.i.i.i = load i64, ptr %.elt2.i.i.i.i, align 8, !tbaa !42
...
begin_hunk_4_@_ZNSt6thread11_State_implINS_8_InvokerISt5tupleIJMN6hermes2vm18StatSamplingThreadEFvvEPS5_EEEEE6_M_runEv:bb.a
  ...
  %i.i = load ptr, ptr %i.h, align 8, !nosanitize !35
...
_ZNSt6thread8_InvokerISt5tupleIJMN6hermes2vm18StatSamplingThreadEFvvEPS4_EEEclEv.exit: ; preds = %bb.b, %bb.c
  ...
  tail call void %i.k(ptr noundef nonnull align 8 dereferenceable(184) %i.d) #11
  ret void
}
...
!35 = !{}
!36 = !{!37, !15, i64 0}
!37 = !{!"_ZTS8timespec", !15, i64 0, !15, i64 8}
!38 = !{!37, !15, i64 8}
!39 = distinct !{!39, !40}
