...
_ZNKSt6vectorIhSaIhEE12_M_check_lenEmPKc.exit.i.i: ; preds = %bb.l
  ...
  %.not.i.i.i9 = icmp eq i64 %i.cb, 0
  br i1 %.not.i.i.i9, label %_ZNSt12_Vector_baseIhSaIhEE11_M_allocateEm.exit.i.i, label %3

3:                                                ; preds = %_ZNKSt6vectorIhSaIhEE12_M_check_lenEmPKc.exit.i.i
  %4 = call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.cb) #22
...
_ZNSt12_Vector_baseIhSaIhEE11_M_allocateEm.exit.i.i: ; preds = %3, %_ZNKSt6vectorIhSaIhEE12_M_check_lenEmPKc.exit.i.i
  ...
  %6 = getelementptr inbounds nuw i8, ptr %5, i64 %i.bw ; 2 uses
  store i8 %storemerge37, ptr %6, align 1, !tbaa !7
  %7 = icmp sgt i64 %i.bw, 0
  br i1 %7, label %bb.n, label %_ZNSt6vectorIhSaIhEE11_S_relocateEPhS2_S2_RS0_.exit16.i.i

bb.n:                                             ; preds = %_ZNSt12_Vector_baseIhSaIhEE11_M_allocateEm.exit.i.i
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 1 %5, ptr align 1 %.sroa.0.036, i64 %i.bw, i1 false)
...
_ZNSt6vectorIhSaIhEE17_M_realloc_insertIJRKhEEEvN9__gnu_cxx17__normal_iteratorIPhS1_EEDpOT_.exit.i: ; preds = %bb.o, %_ZNSt6vectorIhSaIhEE11_S_relocateEPhS2_S2_RS0_.exit16.i.i
  %i.cc = getelementptr inbounds nuw i8, ptr %5, i64 %i.cb
  br label %_ZNSt6vectorIhSaIhEE9push_backERKh.exit
...
_ZNSt6vectorIhSaIhEE9push_backERKh.exit:          ; preds = %bb.k, %_ZNSt6vectorIhSaIhEE17_M_realloc_insertIJRKhEEEvN9__gnu_cxx17__normal_iteratorIPhS1_EEDpOT_.exit.i
  %.pn = phi ptr [ %6, %_ZNSt6vectorIhSaIhEE17_M_realloc_insertIJRKhEEEvN9__gnu_cxx17__normal_iteratorIPhS1_EEDpOT_.exit.i ], [ %.sroa.13.034, %bb.k ] ; 2 uses
  ...
  %.sroa.0.1 = phi ptr [ %5, %_ZNSt6vectorIhSaIhEE17_M_realloc_insertIJRKhEEEvN9__gnu_cxx17__normal_iteratorIPhS1_EEDpOT_.exit.i ], [ %.sroa.0.036, %bb.k ] ; 10 uses
