...
begin_hunk_0_@_ZN6hermes3hbc12_GLOBAL__N_111SLPToStringB5cxx11EhPKhPi:._crit_edge.i.i
  ...
  %.0.copyload.i = load i8, ptr %i.h, align 1     ; 8 uses
...
begin_hunk_1_@_ZN6hermes3hbc12_GLOBAL__N_111SLPToStringB5cxx11EhPKhPi:._crit_edge.i.i
  ...
  %20 = icmp ult i8 %.0.copyload.i, 10
  %i.m = icmp ult i8 %.0.copyload.i, 100
  %. = select i1 %i.m, i32 2, i32 3               ; 3 uses
  %21 = zext nneg i32 %. to i64
  %i.n = select i1 %20, i64 1, i64 %21
  ...
  %22 = icmp ugt i8 %.0.copyload.i, 99
  br i1 %22, label %._crit_edge.i.i22.thread, label %._crit_edge.i.i22
...
begin_hunk_2_@_ZN6hermes3hbc12_GLOBAL__N_111SLPToStringB5cxx11EhPKhPi:._crit_edge.i.i
  ...
  %24 = getelementptr i8, ptr %i.p, i64 %23
  %i.x = getelementptr i8, ptr %24, i64 -1
  store i8 %i.w, ptr %i.x, align 1, !tbaa !7
  %i.y = load i8, ptr %i.u, align 2, !tbaa !7, !noalias !84
  %25 = zext nneg i32 %. to i64
  %26 = getelementptr i8, ptr %i.p, i64 %25
  %i.z = getelementptr i8, ptr %26, i64 -2
...
bb.m:                                             ; preds = %bb.l
  %i.ds = icmp ult i16 %.0.copyload.i33, 10000
  %.204 = select i1 %i.ds, i32 4, i32 5
...
_ZNSt8__detail14__to_chars_lenIjEEjT_i.exit.i39:  ; preds = %bb.m, %bb.l, %.lr.ph.i.i36, %._crit_edge.i.i34
  %.0.i.i40 = phi i32 [ %.204, %bb.m ], [ 3, %bb.l ], [ 2, %.lr.ph.i.i36 ], [ 1, %._crit_edge.i.i34 ] ; 2 uses
  %27 = zext nneg i32 %.0.i.i40 to i64
  %i.dt = getelementptr inbounds nuw i8, ptr %10, i64 16 ; 5 uses
  store ptr %i.dt, ptr %10, align 8, !tbaa !83, !alias.scope !93
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE12_M_constructEmc(ptr noundef nonnull align 8 dereferenceable(32) %10, i64 noundef %27, i8 noundef signext 45) #19
  %i.du = load ptr, ptr %10, align 8, !tbaa !21, !alias.scope !93 ; 4 uses
  %i.dv = icmp ugt i16 %.0.copyload.i33, 99
  br i1 %i.dv, label %.lr.ph.preheader.i.i45, label %._crit_edge.i.i42

.lr.ph.preheader.i.i45:                           ; preds = %_ZNSt8__detail14__to_chars_lenIjEEjT_i.exit.i39
  %28 = add nsw i32 %.0.i.i40, -1
  br label %.lr.ph.i11.i46

.lr.ph.i11.i46:                                   ; preds = %.lr.ph.i11.i46, %.lr.ph.preheader.i.i45
  %.020.i.i47 = phi i32 [ %i.dy, %.lr.ph.i11.i46 ], [ %i.do, %.lr.ph.preheader.i.i45 ] ; 3 uses
  %.01819.i.i48 = phi i32 [ %i.ej, %.lr.ph.i11.i46 ], [ %28, %.lr.ph.preheader.i.i45 ] ; 3 uses
