...
.lr.ph.i.i.i.i.preheader:                         ; preds = %_ZSt4copyIPSt4pairIjjES2_ET0_T_S4_S3_.exit
  ...
  %min.iters.check103 = icmp ult i64 %i.bg, 72
  %i.bj = sub i64 %i.e, %i.l
...
vector.ph104:                                     ; preds = %.lr.ph.i.i.i.i.preheader
  %n.vec106 = and i64 %i.bi, 4611686018427387900  ; 3 uses
  %i.bk = shl i64 %n.vec106, 3                    ; 2 uses
...
vector.body107:                                   ; preds = %vector.body107, %vector.ph104
  ...
  %i.bn = shl i64 %index108, 3                    ; 2 uses
  %next.gep109 = getelementptr i8, ptr %i.w, i64 %i.bn ; 2 uses
  %next.gep110 = getelementptr i8, ptr %i.an, i64 %i.bn ; 2 uses
  %i.bo = getelementptr i8, ptr %next.gep110, i64 16
  %wide.load = load <2 x i64>, ptr %next.gep110, align 4
  %wide.load111 = load <2 x i64>, ptr %i.bo, align 4
  %i.bp = getelementptr i8, ptr %next.gep109, i64 16
  store <2 x i64> %wide.load, ptr %next.gep109, align 4
  store <2 x i64> %wide.load111, ptr %i.bp, align 4
  %index.next112 = add nuw i64 %index108, 4       ; 2 uses
  %i.bq = icmp eq i64 %index.next112, %n.vec106
  br i1 %i.bq, label %middle.block113, label %vector.body107, !llvm.loop !141

middle.block113:                                  ; preds = %vector.body107
  %cmp.n114 = icmp eq i64 %i.bi, %n.vec106
...
.lr.ph.i.i.i.i.preheader117:                      ; preds = %.lr.ph.i.i.i.i.preheader, %middle.block113
  %.011.i.i.i.i.ph = phi ptr [ %i.w, %.lr.ph.i.i.i.i.preheader ], [ %i.bl, %middle.block113 ]
  %.0810.i.i.i.i.ph = phi ptr [ %i.an, %.lr.ph.i.i.i.i.preheader ], [ %i.bm, %middle.block113 ]
  br label %.lr.ph.i.i.i.i

.lr.ph.i.i.i.i:                                   ; preds = %.lr.ph.i.i.i.i.preheader117, %.lr.ph.i.i.i.i
  %.011.i.i.i.i = phi ptr [ %i.bt, %.lr.ph.i.i.i.i ], [ %.011.i.i.i.i.ph, %.lr.ph.i.i.i.i.preheader117 ] ; 2 uses
  %.0810.i.i.i.i = phi ptr [ %i.bs, %.lr.ph.i.i.i.i ], [ %.0810.i.i.i.i.ph, %.lr.ph.i.i.i.i.preheader117 ] ; 2 uses
...
_ZSt22__uninitialized_copy_aIPSt4pairIjjES2_S1_ET0_T_S4_S3_RSaIT1_E.exit: ; preds = %.lr.ph.i.i.i.i.i, %middle.block, %_ZSt22__uninitialized_copy_aIPSt4pairIjjES2_S1_ET0_T_S4_S3_RSaIT1_E.exit.loopexit, %bb.g, %_ZSt4copyIPSt4pairIjjES2_ET0_T_S4_S3_.exit, %_ZNSt12_Vector_baseISt4pairIjjESaIS1_EE13_M_deallocateEPS1_m.exit
  %i.bu = phi ptr [ %i.p, %_ZNSt12_Vector_baseISt4pairIjjESaIS1_EE13_M_deallocateEPS1_m.exit ], [ %.pre, %_ZSt22__uninitialized_copy_aIPSt4pairIjjES2_S1_ET0_T_S4_S3_RSaIT1_E.exit.loopexit ], [ %i.j, %bb.g ], [ %i.j, %_ZSt4copyIPSt4pairIjjES2_ET0_T_S4_S3_.exit ], [ %i.j, %middle.block ], [ %i.j, %.lr.ph.i.i.i.i.i ]
  %i.bv = getelementptr inbounds nuw i8, ptr %i.bu, i64 %i.f
  %i.bw = getelementptr inbounds nuw i8, ptr %0, i64 8
  store ptr %i.bv, ptr %i.bw, align 8, !tbaa !130
  br label %bb.i
