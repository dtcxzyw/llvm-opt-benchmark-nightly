...
bb.q:                                             ; preds = %bb.p
  ...
  %.sroa.11.12.extract.shift = lshr i64 %i.bs, 32 ; 5 uses
  %i.bu = add nuw nsw i64 %.sroa.11.12.extract.shift, %i.bt
  %.sroa.speculated = call i64 @llvm.umin.i64(i64 %i.bu, i64 %.sroa.19.12.extract.shift) ; 5 uses
...
begin_hunk_2_@_ZN6hermes2vmL21stringDirectedIndexOfERNS0_7RuntimeENS0_6HandleINS0_11HermesValueEEES5_S5_bb:bb.a
  ...
  %.sroa.3.0.idx.i.i373440 = select i1 %.not.i.i372439, i64 %.neg438, i64 0 ; 4 uses
...
_ZNK6hermes2vm10StringView13castToCharPtrEv.exit.i.i69: ; preds = %bb.af, %bb.al, %bb.ak, %bb.aj, %bb.ah
  ...
  %.sroa.3.0.idx.i.i373.pn = phi i64 [ %.sroa.3.0.idx.i.i373, %bb.af ], [ %.sroa.3.0.idx.i.i373440, %bb.ah ], [ %.sroa.3.0.idx.i.i373440, %bb.aj ], [ %.sroa.3.0.idx.i.i373440, %bb.ak ], [ %.sroa.3.0.idx.i.i373440, %bb.al ]
  ...
  %.sroa.3.0.i.i54374444 = getelementptr inbounds [2 x i8], ptr null, i64 %.sroa.3.0.idx.i.i373.pn
...
bb.am:                                            ; preds = %bb.y
  ...
  %.sroa.3.0.i.i54 = getelementptr inbounds nuw [2 x i8], ptr %i.bo, i64 %i.ds
...
bb.an:                                            ; preds = %bb.ae, %bb.ad, %bb.ac, %bb.aa
  ...
  %.sroa.3.0.i.i54450 = getelementptr inbounds nuw [2 x i8], ptr %.0.i.sink.i4.i.i.ph, i64 %i.dt ; 4 uses
...
begin_hunk_4_@_ZN6hermes2vmL21stringDirectedIndexOfERNS0_7RuntimeENS0_6HandleINS0_11HermesValueEEES5_S5_bb:bb.a
  ...
  %.sroa.3.0.i.i54452 = getelementptr inbounds nuw [2 x i8], ptr %.sroa.3.0.i.i54452.a, i64 %.sroa.speculated
...
_ZNK6hermes2vm10StringView4rendEv.exit:           ; preds = %_ZNK6hermes2vm10StringView13castToCharPtrEv.exit.i.i69, %_ZNK6hermes2vm10StringView15castToChar16PtrEv.exit.i.i60
  ...
  %.sroa.3.0.i.i54376 = phi ptr [ %.sroa.3.0.i.i54374444, %_ZNK6hermes2vm10StringView13castToCharPtrEv.exit.i.i69 ], [ %.sroa.3.0.i.i54452, %_ZNK6hermes2vm10StringView15castToChar16PtrEv.exit.i.i60 ]
...
bb.bh:                                            ; preds = %bb.av, %bb.ax, %bb.ay, %bb.az
  ...
  %i.fm = getelementptr inbounds nuw i8, ptr %.0.i.sink.i.i.i85.ph, i64 %i.fl ; 4 uses
...
begin_hunk_6_@_ZN6hermes2vmL21stringDirectedIndexOfERNS0_7RuntimeENS0_6HandleINS0_11HermesValueEEES5_S5_bb:bb.a
  ...
  %13 = getelementptr inbounds nuw i8, ptr %i.ga, i64 %.sroa.11.12.extract.shift
...
bb.bn:                                            ; preds = %bb.ba
  ...
  %i.ge = getelementptr inbounds nuw [2 x i8], ptr %i.br, i64 %i.gd
...
bb.bo:                                            ; preds = %bb.bb
  ...
  %i.gi = getelementptr inbounds nuw [2 x i8], ptr %i.gg, i64 %i.gh
  br label %_ZNK6hermes2vm10StringView15castToChar16PtrEv.exit.i.i91
...
bb.bp:                                            ; preds = %bb.bf, %bb.be, %bb.bd
  ...
  %i.gk = getelementptr inbounds nuw [2 x i8], ptr %.0.i.sink.i4.i.i76.ph.ph, i64 %i.gj ; 3 uses
...
begin_hunk_7_@_ZN6hermes2vmL21stringDirectedIndexOfERNS0_7RuntimeENS0_6HandleINS0_11HermesValueEEES5_S5_bb:bb.a
  ...
  %14 = getelementptr inbounds nuw [2 x i8], ptr %i.gs, i64 %.sroa.11.12.extract.shift
...
_ZNK6hermes2vm10StringView4rendEv.exit103:        ; preds = %_ZNK6hermes2vm10StringView13castToCharPtrEv.exit.i.i100, %_ZNK6hermes2vm10StringView15castToChar16PtrEv.exit.i.i91
  %.sroa.0.0.i.i78384 = phi ptr [ %13, %_ZNK6hermes2vm10StringView13castToCharPtrEv.exit.i.i100 ], [ null, %_ZNK6hermes2vm10StringView15castToChar16PtrEv.exit.i.i91 ]
  %.sroa.3.0.i.i77382 = phi ptr [ null, %_ZNK6hermes2vm10StringView13castToCharPtrEv.exit.i.i100 ], [ %14, %_ZNK6hermes2vm10StringView15castToChar16PtrEv.exit.i.i91 ]
