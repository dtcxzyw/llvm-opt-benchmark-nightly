...
begin_hunk_1_@tdefl_compress_fast:bb.a
  ...
  %i.ax = sub nuw i32 %.0308395, %i.am            ; 2 uses
...
begin_hunk_2_@tdefl_compress_normal:bb.a
  ...
  %i.ba = sub nuw i64 %.0174, %i.ax               ; 2 uses
...
bb.r:                                             ; preds = %bb.q
  ...
  %i.cf = sub nuw i64 %.1134245.us, %i.bx         ; 2 uses
...
bb.u:                                             ; preds = %bb.t
  ...
  %i.cq = sub nuw i64 %.1134245, %i.cj            ; 2 uses
...
bb.p:                                             ; preds = %bb.o
  ...
  %i.al = sub nuw i64 %.030, %i.ag                ; 2 uses
...
bb.x:                                             ; preds = %bb.w
  ...
  %i.cj = sub nuw nsw i64 %.0177271, %i.bz        ; 2 uses
...
bb.ab:                                            ; preds = %bb.aa
  ...
  %i.dc = sub nuw nsw i64 %.2179, %i.cz           ; 2 uses
...
bb.s:                                             ; preds = %bb.q
  ...
  %i.cu = sub nuw nsw i64 %.0105192, %i.cf        ; 2 uses
...
zip_file_move.exit.i.i:                           ; preds = %bb.z
  ...
  %i.is = sub nuw nsw i64 %.02537.i.i, %i.ik      ; 2 uses
  %i.it = add nuw nsw i64 %i.ik, %.038.i.i        ; 2 uses
  %.not.i.i35 = icmp eq i64 %i.is, 0
  br i1 %.not.i.i35, label %.loopexit.i.i, label %.lr.ph.i.i33, !llvm.loop !319
...
begin_hunk_16_@tdefl_compress_block:bb.a
  ...
  %i.arh = sub nuw i32 %.3146175.i, %i.apt        ; 2 uses
