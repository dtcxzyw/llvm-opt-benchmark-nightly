...
.preheader.us.i:                                  ; preds = %.preheader.us.i.preheader, %.preheader.us.i
  ...
  %i.dd = getelementptr inbounds nuw [4 x i8], ptr %.04151.us.i, i64 %indvars.iv65.i ; 2 uses
  %i.de = load i16, ptr %i.dd, align 8, !tbaa !369
  %i.df = zext i16 %i.de to i32
  %i.dg = lshr i32 %i.df, %.03854.us.i
  ...
  %i.dn = getelementptr inbounds nuw [4 x i8], ptr %.04052.us.i, i64 %i.dm
  %i.do = load i32, ptr %i.dd, align 8
  store i32 %i.do, ptr %i.dn, align 4
  %i.dp = getelementptr inbounds nuw [4 x i8], ptr %.04151.us.i, i64 %indvars.iv65.i
  %i.dq = getelementptr inbounds nuw i8, ptr %i.dp, i64 4 ; 2 uses
  %i.dr = load i16, ptr %i.dq, align 4, !tbaa !369
  %i.ds = zext i16 %i.dr to i32
  %i.dt = lshr i32 %i.ds, %.03854.us.i
  ...
  %i.ea = getelementptr inbounds nuw [4 x i8], ptr %.04052.us.i, i64 %i.dz
  %i.eb = load i32, ptr %i.dq, align 4
  ...
  br i1 %niter208.ncmp.1, label %._crit_edge.us.i.unr-lcssa, label %.preheader.us.i, !llvm.loop !374
...
bb.i:                                             ; preds = %bb.i, %.critedge.preheader.split55.us.i
  ...
  %.03748.us.i = phi i32 [ 0, %.critedge.preheader.split55.us.i ], [ %i.er, %bb.i ] ; 2 uses
  %i.ec = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %indvars.iv61.i
  store i32 %.03748.us.i, ptr %i.ec, align 16, !tbaa !3
  %i.ed = getelementptr inbounds nuw [4 x i8], ptr %i.dc, i64 %indvars.iv61.i
  %i.ee = load i32, ptr %i.ed, align 16, !tbaa !3
  %i.ef = add i32 %i.ee, %.03748.us.i             ; 2 uses
  %indvars.iv.next62.i = or disjoint i64 %indvars.iv61.i, 1 ; 2 uses
  %i.eg = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %indvars.iv.next62.i
  store i32 %i.ef, ptr %i.eg, align 4, !tbaa !3
  %i.eh = getelementptr inbounds nuw [4 x i8], ptr %i.dc, i64 %indvars.iv.next62.i
  ...
  %i.ek = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %indvars.iv.next62.i.1
  store i32 %i.ej, ptr %i.ek, align 8, !tbaa !3
  %i.el = getelementptr inbounds nuw [4 x i8], ptr %i.dc, i64 %indvars.iv.next62.i.1
  %i.em = load i32, ptr %i.el, align 8, !tbaa !3
  %i.en = add i32 %i.em, %i.ej                    ; 2 uses
  %indvars.iv.next62.i.2 = or disjoint i64 %indvars.iv61.i, 3 ; 2 uses
  %i.eo = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %indvars.iv.next62.i.2
  store i32 %i.en, ptr %i.eo, align 4, !tbaa !3
  %i.ep = getelementptr inbounds nuw [4 x i8], ptr %i.dc, i64 %indvars.iv.next62.i.2
