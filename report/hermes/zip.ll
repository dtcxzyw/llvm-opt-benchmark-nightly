...
begin_hunk_0_@tdefl_compress_fast:bb.a
  ...
  %i.v = getelementptr inbounds nuw i8, ptr %0, i64 33226 ; 3 uses
...
begin_hunk_1_@tdefl_compress_fast:bb.a
  ...
  %.1270419 = phi ptr [ %.7276, %bb.r ], [ %.0269, %.preheader366 ] ; 6 uses
...
1:                                                ; preds = %bb.m, %bb.l
  %.sink570 = phi i64 [ %i.fb, %bb.m ], [ %i.eb, %bb.l ]
  %.1300 = phi i32 [ %i.ec, %bb.m ], [ 1, %bb.l ]
  %.pn = phi i64 [ 3, %bb.m ], [ 1, %bb.l ]
  %2 = getelementptr inbounds nuw [2 x i8], ptr %i.v, i64 %.sink570 ; 2 uses
  %3 = load i16, ptr %2, align 2, !tbaa !108
  %4 = add i16 %3, 1
  store i16 %4, ptr %2, align 2, !tbaa !108
  %.2271 = getelementptr inbounds nuw i8, ptr %.1270419, i64 %.pn
  br label %bb.o
...
begin_hunk_5_@tdefl_compress_fast:bb.a
  ...
  %5 = getelementptr inbounds nuw [2 x i8], ptr %i.v, i64 %i.fg ; 2 uses
...
bb.o:                                             ; preds = %bb.n, %1
  %.2301 = phi i32 [ %.1300, %1 ], [ 1, %bb.n ]   ; 5 uses
  %.3272 = phi ptr [ %.2271, %1 ], [ %i.fd, %bb.n ] ; 2 uses
