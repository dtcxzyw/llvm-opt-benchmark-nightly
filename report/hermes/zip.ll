...
bb.eg:                                            ; preds = %bb.ef
  ...
  %.v156.i = select i1 %i.alv, i8 %i.alo, i8 %i.alu
  %i.alw = zext i8 %.v156.i to i32                ; 2 uses
  ...
  %notmask187.i = shl nsw i32 -1, %i.alw
  %4 = xor i32 %notmask187.i, -1
  %i.amh = and i32 %4, %i.akn
...
bb.em:                                            ; preds = %._crit_edge171.i, %.lr.ph178.i
  ...
  %i.aox = tail call i32 @llvm.umin.i32(i32 %.3146175.i, i32 16) ; 5 uses
  %i.aoy = trunc i64 %.3142176.i to i32
  %i.aoz = zext nneg i32 %i.aox to i64
  %notmask188.i = shl nsw i32 -1, %i.aox
  %5 = xor i32 %notmask188.i, -1
  %i.apa = and i32 %5, %i.aoy
  %i.apb = shl nuw nsw i32 %i.apa, %i.aow
