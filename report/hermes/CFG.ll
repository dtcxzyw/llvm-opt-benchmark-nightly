...
.lr.ph.i.i.prol:                                  ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i.prol
  %.06.i.i.prol = phi ptr [ %i.ar, %.lr.ph.i.i.prol ], [ %i.ak, %.lr.ph.i.i.preheader ] ; 3 uses
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i
  %.06.i.i = phi ptr [ %i.aw, %.lr.ph.i.i ], [ %.06.i.i.unr, %.lr.ph.i.i.prol.loopexit ] ; 17 uses
  ...
  %3 = getelementptr inbounds nuw i8, ptr %.06.i.i, i64 24
  ...
  %5 = getelementptr inbounds nuw i8, ptr %.06.i.i, i64 72
  ...
  %6 = getelementptr inbounds nuw i8, ptr %.06.i.i, i64 96
  ...
  %i.at = getelementptr inbounds nuw i8, ptr %.06.i.i, i64 120
  ...
  %i.au = getelementptr inbounds nuw i8, ptr %.06.i.i, i64 144
  ...
  %i.av = getelementptr inbounds nuw i8, ptr %.06.i.i, i64 168
...
.lr.ph.i.i35.prol:                                ; preds = %.lr.ph.i.i35.preheader, %.lr.ph.i.i35.prol
  %.06.i.i36.prol = phi ptr [ %i.eh, %.lr.ph.i.i35.prol ], [ %i.ea, %.lr.ph.i.i35.preheader ] ; 3 uses
  %prol.iter60 = phi i64 [ %prol.iter60.next, %.lr.ph.i.i35.prol ], [ 0, %.lr.ph.i.i35.preheader ]
  store ptr inttoptr (i64 -8 to ptr), ptr %.06.i.i36.prol, align 8
  %.sroa.4.0..sroa_idx.i.i37.prol = getelementptr inbounds nuw i8, ptr %.06.i.i36.prol, i64 8
  store ptr inttoptr (i64 -8 to ptr), ptr %.sroa.4.0..sroa_idx.i.i37.prol, align 8
...
.lr.ph.i.i35:                                     ; preds = %.lr.ph.i.i35.prol.loopexit, %.lr.ph.i.i35
  %.06.i.i36 = phi ptr [ %i.em, %.lr.ph.i.i35 ], [ %.06.i.i36.unr, %.lr.ph.i.i35.prol.loopexit ] ; 17 uses
  store ptr inttoptr (i64 -8 to ptr), ptr %.06.i.i36, align 8
  %.sroa.4.0..sroa_idx.i.i37 = getelementptr inbounds nuw i8, ptr %.06.i.i36, i64 8
  store ptr inttoptr (i64 -8 to ptr), ptr %.sroa.4.0..sroa_idx.i.i37, align 8
  %7 = getelementptr inbounds nuw i8, ptr %.06.i.i36, i64 24
  store ptr inttoptr (i64 -8 to ptr), ptr %7, align 8
  %.sroa.4.0..sroa_idx.i.i37.1 = getelementptr inbounds nuw i8, ptr %.06.i.i36, i64 32
  store ptr inttoptr (i64 -8 to ptr), ptr %.sroa.4.0..sroa_idx.i.i37.1, align 8
  %8 = getelementptr inbounds nuw i8, ptr %.06.i.i36, i64 48
  store ptr inttoptr (i64 -8 to ptr), ptr %8, align 8
  %.sroa.4.0..sroa_idx.i.i37.2 = getelementptr inbounds nuw i8, ptr %.06.i.i36, i64 56
  store ptr inttoptr (i64 -8 to ptr), ptr %.sroa.4.0..sroa_idx.i.i37.2, align 8
  %9 = getelementptr inbounds nuw i8, ptr %.06.i.i36, i64 72
  store ptr inttoptr (i64 -8 to ptr), ptr %9, align 8
  %.sroa.4.0..sroa_idx.i.i37.3 = getelementptr inbounds nuw i8, ptr %.06.i.i36, i64 80
  store ptr inttoptr (i64 -8 to ptr), ptr %.sroa.4.0..sroa_idx.i.i37.3, align 8
  %10 = getelementptr inbounds nuw i8, ptr %.06.i.i36, i64 96
  store ptr inttoptr (i64 -8 to ptr), ptr %10, align 8
  %.sroa.4.0..sroa_idx.i.i37.4 = getelementptr inbounds nuw i8, ptr %.06.i.i36, i64 104
  store ptr inttoptr (i64 -8 to ptr), ptr %.sroa.4.0..sroa_idx.i.i37.4, align 8
  %i.ej = getelementptr inbounds nuw i8, ptr %.06.i.i36, i64 120
  store ptr inttoptr (i64 -8 to ptr), ptr %i.ej, align 8
  %.sroa.4.0..sroa_idx.i.i37.5 = getelementptr inbounds nuw i8, ptr %.06.i.i36, i64 128
  store ptr inttoptr (i64 -8 to ptr), ptr %.sroa.4.0..sroa_idx.i.i37.5, align 8
  %i.ek = getelementptr inbounds nuw i8, ptr %.06.i.i36, i64 144
  store ptr inttoptr (i64 -8 to ptr), ptr %i.ek, align 8
  %.sroa.4.0..sroa_idx.i.i37.6 = getelementptr inbounds nuw i8, ptr %.06.i.i36, i64 152
  store ptr inttoptr (i64 -8 to ptr), ptr %.sroa.4.0..sroa_idx.i.i37.6, align 8
  %i.el = getelementptr inbounds nuw i8, ptr %.06.i.i36, i64 168
  store ptr inttoptr (i64 -8 to ptr), ptr %i.el, align 8
  %.sroa.4.0..sroa_idx.i.i37.7 = getelementptr inbounds nuw i8, ptr %.06.i.i36, i64 176
  store ptr inttoptr (i64 -8 to ptr), ptr %.sroa.4.0..sroa_idx.i.i37.7, align 8
...
begin_hunk_4_@_ZN4llvh14DomTreeBuilder11SemiNCAInfoINS_17DominatorTreeBaseIN6hermes10BasicBlockELb0EEEE15InsertReachableERS5_PNS6_15BatchUpdateInfoEPNS_15DomTreeNodeBaseIS4_EESC_:bb.a
  ...
  %6 = alloca %"struct.llvh::DomTreeBuilder::SemiNCAInfo<llvh::DominatorTreeBase<hermes::BasicBlock, false>>::InsertionInfo", align 8 ; 41 uses
...
bb.h:                                             ; preds = %_ZNK4llvh17DominatorTreeBaseIN6hermes10BasicBlockELb0EE7getNodeEPKS2_.exit
  ...
  %9 = getelementptr inbounds nuw i8, ptr %6, i64 16 ; 3 uses
  store ptr %9, ptr %6, align 8, !tbaa !7
  %10 = getelementptr inbounds nuw i8, ptr %6, i64 8 ; 6 uses
  store i32 0, ptr %10, align 8, !tbaa !10
  %11 = getelementptr inbounds nuw i8, ptr %6, i64 12 ; 2 uses
  store i32 8, ptr %11, align 4, !tbaa !11
  %12 = getelementptr inbounds nuw i8, ptr %6, i64 152 ; 3 uses
  store i32 1, ptr %12, align 8
  %13 = getelementptr inbounds nuw i8, ptr %6, i64 156
  store i32 0, ptr %13, align 4, !tbaa !260
  %.07.i.i.i.i.ptr.i.i = getelementptr inbounds nuw i8, ptr %6, i64 160 ; 2 uses
  store ptr inttoptr (i64 -8 to ptr), ptr %.07.i.i.i.i.ptr.i.i, align 8, !tbaa !34
  %.07.i.i.i.i.ptr.1.i.i = getelementptr inbounds nuw i8, ptr %6, i64 168
  store ptr inttoptr (i64 -8 to ptr), ptr %.07.i.i.i.i.ptr.1.i.i, align 8, !tbaa !34
  %.07.i.i.i.i.ptr.2.i.i = getelementptr inbounds nuw i8, ptr %6, i64 176
  store ptr inttoptr (i64 -8 to ptr), ptr %.07.i.i.i.i.ptr.2.i.i, align 8, !tbaa !34
  %.07.i.i.i.i.ptr.3.i.i = getelementptr inbounds nuw i8, ptr %6, i64 184
  store ptr inttoptr (i64 -8 to ptr), ptr %.07.i.i.i.i.ptr.3.i.i, align 8, !tbaa !34
  %.07.i.i.i.i.ptr.4.i.i.a = getelementptr inbounds nuw i8, ptr %6, i64 192
  store ptr inttoptr (i64 -8 to ptr), ptr %.07.i.i.i.i.ptr.4.i.i.a, align 8, !tbaa !34
  %.07.i.i.i.i.ptr.5.i.i = getelementptr inbounds nuw i8, ptr %6, i64 200
  store ptr inttoptr (i64 -8 to ptr), ptr %.07.i.i.i.i.ptr.5.i.i, align 8, !tbaa !34
  %.07.i.i.i.i.ptr.6.i.i = getelementptr inbounds nuw i8, ptr %6, i64 208
  store ptr inttoptr (i64 -8 to ptr), ptr %.07.i.i.i.i.ptr.6.i.i, align 8, !tbaa !34
  %.07.i.i.i.i.ptr.7.i.i = getelementptr inbounds nuw i8, ptr %6, i64 216
  store ptr inttoptr (i64 -8 to ptr), ptr %.07.i.i.i.i.ptr.7.i.i, align 8, !tbaa !34
...
begin_hunk_6_@_ZN4llvh14DomTreeBuilder11SemiNCAInfoINS_17DominatorTreeBaseIN6hermes10BasicBlockELb0EEEE15InsertReachableERS5_PNS6_15BatchUpdateInfoEPNS_15DomTreeNodeBaseIS4_EESC_:bb.a
  ...
  %i.az = load i32, ptr %10, align 8, !tbaa !10   ; 2 uses
  %i.ba = load i32, ptr %11, align 4, !tbaa !11
...
bb.i:                                             ; preds = %bb.h
  call void @_ZN4llvh15SmallVectorBase8grow_podEPvmm(ptr noundef nonnull align 8 dereferenceable(145) %6, ptr noundef nonnull %9, i64 noundef 0, i64 noundef 16) #13
  %.pre.i.i = load i32, ptr %10, align 8, !tbaa !10
...
begin_hunk_7_@_ZN4llvh14DomTreeBuilder11SemiNCAInfoINS_17DominatorTreeBaseIN6hermes10BasicBlockELb0EEEE15InsertReachableERS5_PNS6_15BatchUpdateInfoEPNS_15DomTreeNodeBaseIS4_EESC_:bb.a
  ...
  %i.bf = load i32, ptr %10, align 8, !tbaa !10
  %i.bg = add i32 %i.bf, 1                        ; 4 uses
  store i32 %i.bg, ptr %10, align 8, !tbaa !10
...
begin_hunk_8_@_ZN4llvh14DomTreeBuilder11SemiNCAInfoINS_17DominatorTreeBaseIN6hermes10BasicBlockELb0EEEE15InsertReachableERS5_PNS6_15BatchUpdateInfoEPNS_15DomTreeNodeBaseIS4_EESC_:bb.a
  ...
  %i.cl = load i32, ptr %10, align 8, !tbaa !10
...
bb.p:                                             ; preds = %_ZN4llvh13SmallDenseMapIPNS_15DomTreeNodeBaseIN6hermes10BasicBlockEEEjLj8ENS_12DenseMapInfoIS5_EENS_6detail12DenseMapPairIS5_jEEED2Ev.exit.i
  %i.dh = load ptr, ptr %.07.i.i.i.i.ptr.i.i, align 8, !tbaa !282
