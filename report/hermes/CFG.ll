...
bb.d:                                             ; preds = %bb.e, %bb.c
  %.sroa.014.0 = phi ptr [ %2, %bb.c ], [ %i.h, %bb.e ] ; 2 uses
  %.not18.not.not = icmp ne ptr %.sroa.014.0, %i.g ; 3 uses
  br i1 %.not18.not.not, label %bb.e, label %.loopexit

bb.e:                                             ; preds = %bb.d
  %i.h = load ptr, ptr %.sroa.014.0, align 8, !tbaa !196 ; 2 uses
  %i.i = icmp eq ptr %1, %i.h
  br i1 %i.i, label %.loopexit, label %bb.d, !llvm.loop !197

.loopexit:                                        ; preds = %bb.e, %bb.d, %bb.b
  %.1 = phi i1 [ %i.e, %bb.b ], [ %.not18.not.not, %bb.d ], [ %.not18.not.not, %bb.e ]
  ret i1 %.1
}
...
bb.k:                                             ; preds = %bb.j
  ...
  tail call void @_ZN4llvh15SmallVectorBase8grow_podEPvmm(ptr noundef nonnull align 8 dereferenceable(16) %0, ptr noundef nonnull %i.x, i64 noundef %i.o, i64 noundef 8) #13
...
.lr.ph.i.i:                                       ; preds = %bb.c
  %i.t = load ptr, ptr %.03569, align 8, !tbaa !32 ; 4 uses
  %i.u = and i64 %i.q, -32
  %scevgep.i.i = getelementptr i8, ptr %.03159, i64 %i.u ; 2 uses
  br label %bb.d

bb.d:                                             ; preds = %bb.h, %.lr.ph.i.i
  %.047.i.i = phi i64 [ %i.r, %.lr.ph.i.i ], [ %i.ah, %bb.h ] ; 2 uses
  %.02946.i.i = phi ptr [ %.03159, %.lr.ph.i.i ], [ %i.ag, %bb.h ] ; 9 uses
  %i.v = load ptr, ptr %.02946.i.i, align 8, !tbaa !32
  %i.w = icmp eq ptr %i.v, %i.t
  br i1 %i.w, label %_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.x = getelementptr inbounds nuw i8, ptr %.02946.i.i, i64 8
  %i.y = load ptr, ptr %i.x, align 8, !tbaa !32
  %i.z = icmp eq ptr %i.y, %i.t
  br i1 %i.z, label %_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit.loopexit.split.loop.exit, label %bb.f

bb.f:                                             ; preds = %bb.e
  %i.aa = getelementptr inbounds nuw i8, ptr %.02946.i.i, i64 16
  %i.ab = load ptr, ptr %i.aa, align 8, !tbaa !32
  %i.ac = icmp eq ptr %i.ab, %i.t
  br i1 %i.ac, label %_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit.loopexit.split.loop.exit92, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.ad = getelementptr inbounds nuw i8, ptr %.02946.i.i, i64 24
  %i.ae = load ptr, ptr %i.ad, align 8, !tbaa !32
  %i.af = icmp eq ptr %i.ae, %i.t
  br i1 %i.af, label %_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit.loopexit.split.loop.exit94, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.ag = getelementptr inbounds nuw i8, ptr %.02946.i.i, i64 32
  %i.ah = add nsw i64 %.047.i.i, -1
  %i.ai = icmp sgt i64 %.047.i.i, 1
  br i1 %i.ai, label %bb.d, label %._crit_edge.loopexit.i.i, !llvm.loop !200

._crit_edge.loopexit.i.i:                         ; preds = %bb.h
  %.pre54.i.i = ptrtoint ptr %scevgep.i.i to i64
  %.pre55.i.i = sub i64 %i.p, %.pre54.i.i
  br label %._crit_edge.i.i

._crit_edge.i.i:                                  ; preds = %._crit_edge.loopexit.i.i, %bb.c
  %.pre-phi56.i.i = phi i64 [ %.pre55.i.i, %._crit_edge.loopexit.i.i ], [ %i.q, %bb.c ]
  %.029.lcssa.i.i = phi ptr [ %scevgep.i.i, %._crit_edge.loopexit.i.i ], [ %.03159, %bb.c ] ; 5 uses
  %i.aj = ashr exact i64 %.pre-phi56.i.i, 3
...
bb.i:                                             ; preds = %._crit_edge.i.i
  %i.ak = load ptr, ptr %.029.lcssa.i.i, align 8, !tbaa !32
  %i.al = load ptr, ptr %.03569, align 8, !tbaa !32 ; 2 uses
  %i.am = icmp eq ptr %i.ak, %i.al
  br i1 %i.am, label %_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit, label %bb.j

bb.j:                                             ; preds = %bb.i
  %i.an = getelementptr inbounds nuw i8, ptr %.029.lcssa.i.i, i64 8
  br label %bb.k

bb.k:                                             ; preds = %bb.j, %._crit_edge._crit_edge.i.i
  %i.ao = phi ptr [ %i.al, %bb.j ], [ %.pre.i.i, %._crit_edge._crit_edge.i.i ] ; 2 uses
  %.1.i.i = phi ptr [ %i.an, %bb.j ], [ %.029.lcssa.i.i, %._crit_edge._crit_edge.i.i ] ; 3 uses
  %i.ap = load ptr, ptr %.1.i.i, align 8, !tbaa !32
  %i.aq = icmp eq ptr %i.ap, %i.ao
  br i1 %i.aq, label %_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit, label %bb.l

bb.l:                                             ; preds = %bb.k
  %i.ar = getelementptr inbounds nuw i8, ptr %.1.i.i, i64 8
  br label %bb.m

bb.m:                                             ; preds = %bb.l, %._crit_edge._crit_edge52.i.i
  %i.as = phi ptr [ %i.ao, %bb.l ], [ %.pre53.i.i, %._crit_edge._crit_edge52.i.i ]
  %.2.i.i = phi ptr [ %i.ar, %bb.l ], [ %.029.lcssa.i.i, %._crit_edge._crit_edge52.i.i ] ; 2 uses
  %i.at = load ptr, ptr %.2.i.i, align 8, !tbaa !32
  %i.au = icmp eq ptr %i.at, %i.as
  br i1 %i.au, label %_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit, label %bb.n
...
_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit.loopexit.split.loop.exit: ; preds = %bb.e
  %i.av = getelementptr inbounds nuw i8, ptr %.02946.i.i, i64 8
  br label %_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit
...
_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit.loopexit.split.loop.exit92: ; preds = %bb.f
  %i.aw = getelementptr inbounds nuw i8, ptr %.02946.i.i, i64 16
  br label %_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit
...
_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit.loopexit.split.loop.exit94: ; preds = %bb.g
  %i.ax = getelementptr inbounds nuw i8, ptr %.02946.i.i, i64 24
  br label %_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit
...
_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit: ; preds = %bb.d, %_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit.loopexit.split.loop.exit, %_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit.loopexit.split.loop.exit92, %_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit.loopexit.split.loop.exit94, %bb.i, %bb.k, %bb.m, %bb.n
  %.028.i.i = phi ptr [ %.1.i.i, %bb.k ], [ %.03569, %bb.n ], [ %.2.i.i, %bb.m ], [ %.029.lcssa.i.i, %bb.i ], [ %i.ax, %_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit.loopexit.split.loop.exit94 ], [ %i.av, %_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit.loopexit.split.loop.exit ], [ %i.aw, %_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit.loopexit.split.loop.exit92 ], [ %.02946.i.i, %bb.d ]
...
.lr.ph.i:                                         ; preds = %_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit
  %i.ay = load ptr, ptr %.03569, align 8, !tbaa !32 ; 4 uses
  br i1 %min.iters.check112, label %scalar.ph111.preheader, label %vector.ph113

vector.ph113:                                     ; preds = %.lr.ph.i
  %broadcast.splatinsert115 = insertelement <2 x ptr> poison, ptr %i.ay, i64 0
...
vector.body117:                                   ; preds = %vector.body117, %vector.ph113
  ...
  %vec.phi119 = phi <2 x i64> [ zeroinitializer, %vector.ph113 ], [ %i.bf, %vector.body117 ]
  %vec.phi120 = phi <2 x i64> [ zeroinitializer, %vector.ph113 ], [ %i.bg, %vector.body117 ]
  %i.az = shl i64 %index118, 3
  %next.gep121 = getelementptr i8, ptr %.03258, i64 %i.az ; 2 uses
  %i.ba = getelementptr i8, ptr %next.gep121, i64 16
  %wide.load122 = load <2 x ptr>, ptr %next.gep121, align 8, !tbaa !32
  %wide.load123 = load <2 x ptr>, ptr %i.ba, align 8, !tbaa !32
  %i.bb = icmp eq <2 x ptr> %wide.load122, %broadcast.splat116
  %i.bc = icmp eq <2 x ptr> %wide.load123, %broadcast.splat116
  %i.bd = zext <2 x i1> %i.bb to <2 x i64>
  %i.be = zext <2 x i1> %i.bc to <2 x i64>
  %i.bf = add <2 x i64> %vec.phi119, %i.bd        ; 2 uses
  %i.bg = add <2 x i64> %vec.phi120, %i.be        ; 2 uses
  %index.next124 = add nuw i64 %index118, 4       ; 2 uses
  %i.bh = icmp eq i64 %index.next124, %n.vec114
  br i1 %i.bh, label %middle.block125, label %vector.body117, !llvm.loop !201

middle.block125:                                  ; preds = %vector.body117
  %bin.rdx126 = add <2 x i64> %i.bg, %i.bf
  %i.bi = tail call i64 @llvm.vector.reduce.add.v2i64(<2 x i64> %bin.rdx126) ; 2 uses
...
scalar.ph111.preheader:                           ; preds = %.lr.ph.i, %middle.block125
  %.08.i.ph = phi i64 [ 0, %.lr.ph.i ], [ %i.bi, %middle.block125 ]
  %.057.i.ph = phi ptr [ %.03258, %.lr.ph.i ], [ %i.n, %middle.block125 ]
...
scalar.ph111:                                     ; preds = %scalar.ph111.preheader, %scalar.ph111
  ...
  %.057.i = phi ptr [ %i.bm, %scalar.ph111 ], [ %.057.i.ph, %scalar.ph111.preheader ] ; 2 uses
  %i.bj = load ptr, ptr %.057.i, align 8, !tbaa !32
  %i.bk = icmp eq ptr %i.bj, %i.ay
  %i.bl = zext i1 %i.bk to i64
  %spec.select.i = add nuw nsw i64 %.08.i, %i.bl  ; 2 uses
  %i.bm = getelementptr inbounds nuw i8, ptr %.057.i, i64 8 ; 2 uses
  %.not.i = icmp eq ptr %i.bm, %i.j
...
_ZSt10__count_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEENSt15iterator_traitsIT_E15difference_typeESA_SA_T0_.exit: ; preds = %scalar.ph111, %middle.block125
  %spec.select.i.lcssa = phi i64 [ %i.bi, %middle.block125 ], [ %spec.select.i, %scalar.ph111 ] ; 2 uses
  %i.bn = icmp eq i64 %spec.select.i.lcssa, 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi109 = phi <2 x i64> [ zeroinitializer, %vector.ph ], [ %i.bx, %vector.body ]
  %i.bq = shl i64 %index, 3
  %next.gep = getelementptr i8, ptr %.03569, i64 %i.bq ; 2 uses
  %i.br = getelementptr i8, ptr %next.gep, i64 16
  %wide.load = load <2 x ptr>, ptr %next.gep, align 8, !tbaa !32
  %wide.load110 = load <2 x ptr>, ptr %i.br, align 8, !tbaa !32
  %i.bs = icmp eq <2 x ptr> %wide.load, %broadcast.splat
  %i.bt = icmp eq <2 x ptr> %wide.load110, %broadcast.splat
  %i.bu = zext <2 x i1> %i.bs to <2 x i64>
  %i.bv = zext <2 x i1> %i.bt to <2 x i64>
  %i.bw = add <2 x i64> %vec.phi, %i.bu           ; 2 uses
  %i.bx = add <2 x i64> %vec.phi109, %i.bv        ; 2 uses
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.by = icmp eq i64 %index.next, %n.vec
  br i1 %i.by, label %middle.block, label %vector.body, !llvm.loop !203

middle.block:                                     ; preds = %vector.body
  %bin.rdx = add <2 x i64> %i.bx, %i.bw
  %i.bz = tail call i64 @llvm.vector.reduce.add.v2i64(<2 x i64> %bin.rdx) ; 2 uses
...
.lr.ph.i44.preheader130:                          ; preds = %.lr.ph.i44.preheader, %middle.block
  %.08.i45.ph = phi i64 [ 0, %.lr.ph.i44.preheader ], [ %i.bz, %middle.block ]
  %.057.i46.ph = phi ptr [ %.03569, %.lr.ph.i44.preheader ], [ %i.bp, %middle.block ]
  br label %.lr.ph.i44
...
.lr.ph.i44:                                       ; preds = %.lr.ph.i44.preheader130, %.lr.ph.i44
  ...
  %.057.i46 = phi ptr [ %i.cd, %.lr.ph.i44 ], [ %.057.i46.ph, %.lr.ph.i44.preheader130 ] ; 2 uses
  %i.ca = load ptr, ptr %.057.i46, align 8, !tbaa !32
  %i.cb = icmp eq ptr %i.ca, %i.ay
  %i.cc = zext i1 %i.cb to i64
  %spec.select.i47 = add nuw nsw i64 %.08.i45, %i.cc ; 2 uses
  %i.cd = getelementptr inbounds nuw i8, ptr %.057.i46, i64 8 ; 2 uses
  %.not.i48 = icmp eq ptr %i.cd, %1
...
_ZSt10__count_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEENSt15iterator_traitsIT_E15difference_typeESA_SA_T0_.exit50: ; preds = %.lr.ph.i44, %middle.block
  %spec.select.i47.lcssa = phi i64 [ %i.bz, %middle.block ], [ %spec.select.i47, %.lr.ph.i44 ]
...
.critedge:                                        ; preds = %_ZSt10__count_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEENSt15iterator_traitsIT_E15difference_typeESA_SA_T0_.exit50, %_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit
  %i.ce = getelementptr inbounds nuw i8, ptr %.03569, i64 8 ; 2 uses
  %.not38 = icmp eq ptr %i.ce, %1
...
bb.f:                                             ; preds = %.lr.ph
  ...
  call void @_ZN4llvh15SmallVectorBase8grow_podEPvmm(ptr noundef nonnull align 8 dereferenceable(16) %i.aa, ptr noundef nonnull %i.ai, i64 noundef 0, i64 noundef 8) #13
...
begin_hunk_1_@_ZN4llvh14DomTreeBuilder11SemiNCAInfoINS_17DominatorTreeBaseIN6hermes10BasicBlockELb0EEEE21verifySiblingPropertyERKS5_:bb.a
  store ptr %i.cy, ptr %i.cq, align 8, !tbaa !159
  br label %_ZN4llvh14DomTreeBuilder11SemiNCAInfoINS_17DominatorTreeBaseIN6hermes10BasicBlockELb0EEEE16BlockNamePrinterC2EPNS_15DomTreeNodeBaseIS4_EE.exit

_ZN4llvh14DomTreeBuilder11SemiNCAInfoINS_17DominatorTreeBaseIN6hermes10BasicBlockELb0EEEE16BlockNamePrinterC2EPNS_15DomTreeNodeBaseIS4_EE.exit: ; preds = %bb.v, %bb.w
  %.0.i.i = phi ptr [ %i.cw, %bb.v ], [ %i.cn, %bb.w ] ; 8 uses
  %i.cz = load ptr, ptr %i.bp, align 8, !tbaa !69 ; 2 uses
  %.not.i46 = icmp eq ptr %i.cz, null
  br i1 %.not.i46, label %bb.x, label %bb.aa

bb.x:                                             ; preds = %_ZN4llvh14DomTreeBuilder11SemiNCAInfoINS_17DominatorTreeBaseIN6hermes10BasicBlockELb0EEEE16BlockNamePrinterC2EPNS_15DomTreeNodeBaseIS4_EE.exit
  %i.da = getelementptr inbounds nuw i8, ptr %.0.i.i, i64 16
  %i.db = load ptr, ptr %i.da, align 8, !tbaa !156
  %i.dc = getelementptr inbounds nuw i8, ptr %.0.i.i, i64 24 ; 3 uses
  %i.dd = load ptr, ptr %i.dc, align 8, !tbaa !159 ; 2 uses
...
bb.y:                                             ; preds = %bb.x
  %i.di = tail call noundef nonnull align 8 dereferenceable(36) ptr @_ZN4llvh11raw_ostream5writeEPKcm(ptr noundef nonnull align 8 dereferenceable(36) %.0.i.i, ptr noundef nonnull @.str.26, i64 noundef 7) #13 ; 0 uses
...
bb.z:                                             ; preds = %bb.x
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(7) %i.dd, ptr noundef nonnull align 1 dereferenceable(7) @.str.26, i64 7, i1 false)
  %i.dj = load ptr, ptr %i.dc, align 8, !tbaa !159
  %i.dk = getelementptr inbounds nuw i8, ptr %i.dj, i64 7
  store ptr %i.dk, ptr %i.dc, align 8, !tbaa !159
  br label %_ZN4llvh14DomTreeBuilderlsERNS_11raw_ostreamERKNS0_11SemiNCAInfoINS_17DominatorTreeBaseIN6hermes10BasicBlockELb0EEEE16BlockNamePrinterE.exit
...
bb.aa:                                            ; preds = %_ZN4llvh14DomTreeBuilder11SemiNCAInfoINS_17DominatorTreeBaseIN6hermes10BasicBlockELb0EEEE16BlockNamePrinterC2EPNS_15DomTreeNodeBaseIS4_EE.exit
  tail call void @_ZNK6hermes10BasicBlock14printAsOperandERN4llvh11raw_ostreamEb(ptr noundef nonnull align 8 dereferenceable(80) %i.cz, ptr noundef nonnull align 8 dereferenceable(36) %.0.i.i, i1 noundef zeroext false) #13
  br label %_ZN4llvh14DomTreeBuilderlsERNS_11raw_ostreamERKNS0_11SemiNCAInfoINS_17DominatorTreeBaseIN6hermes10BasicBlockELb0EEEE16BlockNamePrinterE.exit
...
_ZN4llvh14DomTreeBuilderlsERNS_11raw_ostreamERKNS0_11SemiNCAInfoINS_17DominatorTreeBaseIN6hermes10BasicBlockELb0EEEE16BlockNamePrinterE.exit: ; preds = %bb.y, %bb.z, %bb.aa
  %i.dl = getelementptr inbounds nuw i8, ptr %.0.i.i, i64 16
  %i.dm = load ptr, ptr %i.dl, align 8, !tbaa !156
  %i.dn = getelementptr inbounds nuw i8, ptr %.0.i.i, i64 24 ; 3 uses
...
bb.ab:                                            ; preds = %_ZN4llvh14DomTreeBuilderlsERNS_11raw_ostreamERKNS0_11SemiNCAInfoINS_17DominatorTreeBaseIN6hermes10BasicBlockELb0EEEE16BlockNamePrinterE.exit
  %i.dt = tail call noundef nonnull align 8 dereferenceable(36) ptr @_ZN4llvh11raw_ostream5writeEPKcm(ptr noundef nonnull align 8 dereferenceable(36) %.0.i.i, ptr noundef nonnull @.str.46, i64 noundef 32) #13
...
bb.ac:                                            ; preds = %_ZN4llvh14DomTreeBuilderlsERNS_11raw_ostreamERKNS0_11SemiNCAInfoINS_17DominatorTreeBaseIN6hermes10BasicBlockELb0EEEE16BlockNamePrinterE.exit
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(32) %i.do, ptr noundef nonnull align 1 dereferenceable(32) @.str.46, i64 32, i1 false)
  %i.du = load ptr, ptr %i.dn, align 8, !tbaa !159
  %i.dv = getelementptr inbounds nuw i8, ptr %i.du, i64 32
  store ptr %i.dv, ptr %i.dn, align 8, !tbaa !159
  br label %_ZN4llvh14DomTreeBuilder11SemiNCAInfoINS_17DominatorTreeBaseIN6hermes10BasicBlockELb0EEEE16BlockNamePrinterC2EPNS_15DomTreeNodeBaseIS4_EE.exit51
...
_ZN4llvh14DomTreeBuilder11SemiNCAInfoINS_17DominatorTreeBaseIN6hermes10BasicBlockELb0EEEE16BlockNamePrinterC2EPNS_15DomTreeNodeBaseIS4_EE.exit51: ; preds = %bb.ab, %bb.ac
  %.0.i.i48 = phi ptr [ %i.dt, %bb.ab ], [ %.0.i.i, %bb.ac ] ; 7 uses
  %i.dw = load ptr, ptr %i.ac, align 8, !tbaa !69 ; 2 uses
  %.not.i52 = icmp eq ptr %i.dw, null
...
bb.ad:                                            ; preds = %_ZN4llvh14DomTreeBuilder11SemiNCAInfoINS_17DominatorTreeBaseIN6hermes10BasicBlockELb0EEEE16BlockNamePrinterC2EPNS_15DomTreeNodeBaseIS4_EE.exit51
  %i.dx = getelementptr inbounds nuw i8, ptr %.0.i.i48, i64 16
  %i.dy = load ptr, ptr %i.dx, align 8, !tbaa !156
  %i.dz = getelementptr inbounds nuw i8, ptr %.0.i.i48, i64 24 ; 3 uses
  %i.ea = load ptr, ptr %i.dz, align 8, !tbaa !159 ; 2 uses
...
bb.ae:                                            ; preds = %bb.ad
  %i.ef = tail call noundef nonnull align 8 dereferenceable(36) ptr @_ZN4llvh11raw_ostream5writeEPKcm(ptr noundef nonnull align 8 dereferenceable(36) %.0.i.i48, ptr noundef nonnull @.str.26, i64 noundef 7) #13 ; 0 uses
...
bb.af:                                            ; preds = %bb.ad
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(7) %i.ea, ptr noundef nonnull align 1 dereferenceable(7) @.str.26, i64 7, i1 false)
  %i.eg = load ptr, ptr %i.dz, align 8, !tbaa !159
  %i.eh = getelementptr inbounds nuw i8, ptr %i.eg, i64 7
  store ptr %i.eh, ptr %i.dz, align 8, !tbaa !159
  br label %_ZN4llvh14DomTreeBuilderlsERNS_11raw_ostreamERKNS0_11SemiNCAInfoINS_17DominatorTreeBaseIN6hermes10BasicBlockELb0EEEE16BlockNamePrinterE.exit53
...
bb.ag:                                            ; preds = %_ZN4llvh14DomTreeBuilder11SemiNCAInfoINS_17DominatorTreeBaseIN6hermes10BasicBlockELb0EEEE16BlockNamePrinterC2EPNS_15DomTreeNodeBaseIS4_EE.exit51
  tail call void @_ZNK6hermes10BasicBlock14printAsOperandERN4llvh11raw_ostreamEb(ptr noundef nonnull align 8 dereferenceable(80) %i.dw, ptr noundef nonnull align 8 dereferenceable(36) %.0.i.i48, i1 noundef zeroext false) #13
  br label %_ZN4llvh14DomTreeBuilderlsERNS_11raw_ostreamERKNS0_11SemiNCAInfoINS_17DominatorTreeBaseIN6hermes10BasicBlockELb0EEEE16BlockNamePrinterE.exit53
...
_ZN4llvh14DomTreeBuilderlsERNS_11raw_ostreamERKNS0_11SemiNCAInfoINS_17DominatorTreeBaseIN6hermes10BasicBlockELb0EEEE16BlockNamePrinterE.exit53: ; preds = %bb.ae, %bb.af, %bb.ag
  %i.ei = getelementptr inbounds nuw i8, ptr %.0.i.i48, i64 16
  %i.ej = load ptr, ptr %i.ei, align 8, !tbaa !156
  %i.ek = getelementptr inbounds nuw i8, ptr %.0.i.i48, i64 24 ; 3 uses
  %i.el = load ptr, ptr %i.ek, align 8, !tbaa !159 ; 2 uses
  %i.em = ptrtoint ptr %i.ej to i64
  %i.en = ptrtoint ptr %i.el to i64
  %i.eo = sub i64 %i.em, %i.en
  %i.ep = icmp ult i64 %i.eo, 13
...
bb.ah:                                            ; preds = %_ZN4llvh14DomTreeBuilderlsERNS_11raw_ostreamERKNS0_11SemiNCAInfoINS_17DominatorTreeBaseIN6hermes10BasicBlockELb0EEEE16BlockNamePrinterE.exit53
  %i.eq = tail call noundef nonnull align 8 dereferenceable(36) ptr @_ZN4llvh11raw_ostream5writeEPKcm(ptr noundef nonnull align 8 dereferenceable(36) %.0.i.i48, ptr noundef nonnull @.str.45, i64 noundef 13) #13 ; 0 uses
...
bb.ai:                                            ; preds = %_ZN4llvh14DomTreeBuilderlsERNS_11raw_ostreamERKNS0_11SemiNCAInfoINS_17DominatorTreeBaseIN6hermes10BasicBlockELb0EEEE16BlockNamePrinterE.exit53
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(13) %i.el, ptr noundef nonnull align 1 dereferenceable(13) @.str.45, i64 13, i1 false)
  %i.er = load ptr, ptr %i.ek, align 8, !tbaa !159
  %i.es = getelementptr inbounds nuw i8, ptr %i.er, i64 13
  store ptr %i.es, ptr %i.ek, align 8, !tbaa !159
  br label %_ZN4llvh11raw_ostreamlsEPKc.exit56

_ZN4llvh11raw_ostreamlsEPKc.exit56:               ; preds = %bb.ah, %bb.ai
  %i.et = tail call noundef nonnull align 8 dereferenceable(36) ptr @_ZN4llvh4errsEv() #13 ; 3 uses
  %i.eu = getelementptr inbounds nuw i8, ptr %i.et, i64 24
  %i.ev = load ptr, ptr %i.eu, align 8, !tbaa !159
  %i.ew = getelementptr inbounds nuw i8, ptr %i.et, i64 8
  %i.ex = load ptr, ptr %i.ew, align 8, !tbaa !405
  %.not.i57 = icmp eq ptr %i.ev, %i.ex
...
bb.aj:                                            ; preds = %_ZN4llvh11raw_ostreamlsEPKc.exit56
  tail call void @_ZN4llvh11raw_ostream14flush_nonemptyEv(ptr noundef nonnull align 8 dereferenceable(36) %i.et) #13
...
.loopexit91:                                      ; preds = %bb.u, %.lr.ph, %bb.t
  %i.ey = getelementptr inbounds nuw i8, ptr %.sroa.060.0102, i64 8 ; 2 uses
  %.not90 = icmp eq ptr %i.ey, %i.bo
...
._crit_edge:                                      ; preds = %.loopexit91, %_ZN4llvh14DomTreeBuilder11SemiNCAInfoINS_17DominatorTreeBaseIN6hermes10BasicBlockELb0EEEE5clearEv.exit
  %i.ez = getelementptr inbounds nuw i8, ptr %.sroa.064.0103, i64 8 ; 2 uses
  %.not89 = icmp eq ptr %i.ez, %i.aa
  br i1 %.not89, label %.loopexit93, label %.preheader

.loopexit93:                                      ; preds = %._crit_edge, %bb.d, %bb.e
  %i.fa = getelementptr inbounds nuw i8, ptr %.sroa.068.0105, i64 16 ; 3 uses
  %.not5.i3.i = icmp eq ptr %i.fa, %.pn12.i
...
.lr.ph.i4.i:                                      ; preds = %.loopexit93, %.critedge2.i6.i
  %.sroa.068.1 = phi ptr [ %i.fc, %.critedge2.i6.i ], [ %i.fa, %.loopexit93 ] ; 3 uses
  %i.fb = load ptr, ptr %.sroa.068.1, align 8, !tbaa !32
  %magicptr.i5.i = ptrtoint ptr %i.fb to i64
...
.critedge2.i6.i:                                  ; preds = %.lr.ph.i4.i, %.lr.ph.i4.i
  %i.fc = getelementptr inbounds nuw i8, ptr %.sroa.068.1, i64 16 ; 3 uses
  %.not.i7.i = icmp eq ptr %i.fc, %.pn12.i
...
_ZN4llvh16DenseMapIteratorIPN6hermes10BasicBlockESt10unique_ptrINS_15DomTreeNodeBaseIS2_EESt14default_deleteIS6_EENS_12DenseMapInfoIS3_EENS_6detail12DenseMapPairIS3_S9_EELb1EEppEv.exit: ; preds = %.lr.ph.i4.i, %.critedge2.i6.i, %.loopexit93
  %.sroa.068.2 = phi ptr [ %i.fa, %.loopexit93 ], [ %i.fc, %.critedge2.i6.i ], [ %.sroa.068.1, %.lr.ph.i4.i ] ; 2 uses
...
.lr.ph.i.i:                                       ; preds = %bb.c
  %i.t = load ptr, ptr %.03568, align 8, !tbaa !32 ; 4 uses
  %i.u = and i64 %i.q, -32
  %scevgep.i.i = getelementptr i8, ptr %.03158, i64 %i.u ; 2 uses
  br label %bb.d

bb.d:                                             ; preds = %bb.h, %.lr.ph.i.i
  %.047.i.i = phi i64 [ %i.r, %.lr.ph.i.i ], [ %i.ah, %bb.h ] ; 2 uses
  %.02946.i.i = phi ptr [ %.03158, %.lr.ph.i.i ], [ %i.ag, %bb.h ] ; 9 uses
  %i.v = load ptr, ptr %.02946.i.i, align 8, !tbaa !32
  %i.w = icmp eq ptr %i.v, %i.t
  br i1 %i.w, label %_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit, label %bb.e
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.ab = load ptr, ptr %i.aa, align 8, !tbaa !32
  %i.ac = icmp eq ptr %i.ab, %i.t
  br i1 %i.ac, label %_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit.loopexit.split.loop.exit91, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.ad = getelementptr inbounds nuw i8, ptr %.02946.i.i, i64 24
  %i.ae = load ptr, ptr %i.ad, align 8, !tbaa !32
  %i.af = icmp eq ptr %i.ae, %i.t
  br i1 %i.af, label %_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit.loopexit.split.loop.exit93, label %bb.h
...
bb.i:                                             ; preds = %._crit_edge.i.i
  %i.ak = load ptr, ptr %.029.lcssa.i.i, align 8, !tbaa !32
  %i.al = load ptr, ptr %.03568, align 8, !tbaa !32 ; 2 uses
  %i.am = icmp eq ptr %i.ak, %i.al
  br i1 %i.am, label %_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit, label %bb.j
...
_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit: ; preds = %bb.d, %_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit.loopexit.split.loop.exit, %_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit.loopexit.split.loop.exit91, %_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit.loopexit.split.loop.exit93, %bb.i, %bb.k, %bb.m, %bb.n
  %.028.i.i = phi ptr [ %.1.i.i, %bb.k ], [ %.03568, %bb.n ], [ %.2.i.i, %bb.m ], [ %.029.lcssa.i.i, %bb.i ], [ %i.ax, %_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit.loopexit.split.loop.exit93 ], [ %i.av, %_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit.loopexit.split.loop.exit ], [ %i.aw, %_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit.loopexit.split.loop.exit91 ], [ %.02946.i.i, %bb.d ]
  %.not39 = icmp eq ptr %.03568, %.028.i.i
  br i1 %.not39, label %.lr.ph.i, label %.critedge

.lr.ph.i:                                         ; preds = %_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit
  %i.ay = load ptr, ptr %.03568, align 8, !tbaa !32 ; 4 uses
  br i1 %min.iters.check111, label %scalar.ph110.preheader, label %vector.ph112

vector.ph112:                                     ; preds = %.lr.ph.i
  %broadcast.splatinsert114 = insertelement <2 x ptr> poison, ptr %i.ay, i64 0
...
vector.body116:                                   ; preds = %vector.body116, %vector.ph112
  ...
  %vec.phi118 = phi <2 x i64> [ zeroinitializer, %vector.ph112 ], [ %i.bf, %vector.body116 ]
  %vec.phi119 = phi <2 x i64> [ zeroinitializer, %vector.ph112 ], [ %i.bg, %vector.body116 ]
  %i.az = shl i64 %index117, 3
  %next.gep120 = getelementptr i8, ptr %.03257, i64 %i.az ; 2 uses
  %i.ba = getelementptr i8, ptr %next.gep120, i64 16
  %wide.load121 = load <2 x ptr>, ptr %next.gep120, align 8, !tbaa !32
  %wide.load122 = load <2 x ptr>, ptr %i.ba, align 8, !tbaa !32
  %i.bb = icmp eq <2 x ptr> %wide.load121, %broadcast.splat115
  %i.bc = icmp eq <2 x ptr> %wide.load122, %broadcast.splat115
  %i.bd = zext <2 x i1> %i.bb to <2 x i64>
  %i.be = zext <2 x i1> %i.bc to <2 x i64>
  %i.bf = add <2 x i64> %vec.phi118, %i.bd        ; 2 uses
  %i.bg = add <2 x i64> %vec.phi119, %i.be        ; 2 uses
  %index.next123 = add nuw i64 %index117, 4       ; 2 uses
  %i.bh = icmp eq i64 %index.next123, %n.vec113
  br i1 %i.bh, label %middle.block124, label %vector.body116, !llvm.loop !418

middle.block124:                                  ; preds = %vector.body116
  %bin.rdx125 = add <2 x i64> %i.bg, %i.bf
  %i.bi = tail call i64 @llvm.vector.reduce.add.v2i64(<2 x i64> %bin.rdx125) ; 2 uses
...
scalar.ph110.preheader:                           ; preds = %.lr.ph.i, %middle.block124
  %.08.i.ph = phi i64 [ 0, %.lr.ph.i ], [ %i.bi, %middle.block124 ]
  %.057.i.ph = phi ptr [ %.03257, %.lr.ph.i ], [ %i.n, %middle.block124 ]
...
scalar.ph110:                                     ; preds = %scalar.ph110.preheader, %scalar.ph110
  ...
  %.057.i = phi ptr [ %i.bm, %scalar.ph110 ], [ %.057.i.ph, %scalar.ph110.preheader ] ; 2 uses
  %i.bj = load ptr, ptr %.057.i, align 8, !tbaa !32
  %i.bk = icmp eq ptr %i.bj, %i.ay
  %i.bl = zext i1 %i.bk to i64
  %spec.select.i = add nuw nsw i64 %.08.i, %i.bl  ; 2 uses
...
_ZSt10__count_ifIPPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIPKS2_EEENSt15iterator_traitsIT_E15difference_typeESB_SB_T0_.exit: ; preds = %scalar.ph110, %middle.block124
  %spec.select.i.lcssa = phi i64 [ %i.bi, %middle.block124 ], [ %spec.select.i, %scalar.ph110 ] ; 2 uses
  %i.bn = icmp eq i64 %spec.select.i.lcssa, 0
  br i1 %i.bn, label %.critedge42, label %.lr.ph.i44.preheader
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %vec.phi = phi <2 x i64> [ zeroinitializer, %vector.ph ], [ %i.bw, %vector.body ]
  %vec.phi108 = phi <2 x i64> [ zeroinitializer, %vector.ph ], [ %i.bx, %vector.body ]
  %i.bq = shl i64 %index, 3
  %next.gep = getelementptr i8, ptr %.03568, i64 %i.bq ; 2 uses
  %i.br = getelementptr i8, ptr %next.gep, i64 16
  %wide.load = load <2 x ptr>, ptr %next.gep, align 8, !tbaa !32
  %wide.load109 = load <2 x ptr>, ptr %i.br, align 8, !tbaa !32
  %i.bs = icmp eq <2 x ptr> %wide.load, %broadcast.splat
  %i.bt = icmp eq <2 x ptr> %wide.load109, %broadcast.splat
  %i.bu = zext <2 x i1> %i.bs to <2 x i64>
  %i.bv = zext <2 x i1> %i.bt to <2 x i64>
  %i.bw = add <2 x i64> %vec.phi, %i.bu           ; 2 uses
  %i.bx = add <2 x i64> %vec.phi108, %i.bv        ; 2 uses
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.by = icmp eq i64 %index.next, %n.vec
  br i1 %i.by, label %middle.block, label %vector.body, !llvm.loop !420
...
.lr.ph.i44.preheader129:                          ; preds = %.lr.ph.i44.preheader, %middle.block
  %.08.i45.ph = phi i64 [ 0, %.lr.ph.i44.preheader ], [ %i.bz, %middle.block ]
  %.057.i46.ph = phi ptr [ %.03568, %.lr.ph.i44.preheader ], [ %i.bp, %middle.block ]
  br label %.lr.ph.i44
...
.lr.ph.i44:                                       ; preds = %.lr.ph.i44.preheader129, %.lr.ph.i44
  ...
  %.057.i46 = phi ptr [ %i.cd, %.lr.ph.i44 ], [ %.057.i46.ph, %.lr.ph.i44.preheader129 ] ; 2 uses
  %i.ca = load ptr, ptr %.057.i46, align 8, !tbaa !32
  %i.cb = icmp eq ptr %i.ca, %i.ay
  %i.cc = zext i1 %i.cb to i64
  %spec.select.i47 = add nuw nsw i64 %.08.i45, %i.cc ; 2 uses
...
.critedge:                                        ; preds = %_ZSt10__count_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEENSt15iterator_traitsIT_E15difference_typeESA_SA_T0_.exit, %_ZSt9__find_ifIPKPN6hermes10BasicBlockEN9__gnu_cxx5__ops17_Iter_equals_iterIS4_EEET_S9_S9_T0_.exit
  %i.ce = getelementptr inbounds nuw i8, ptr %.03568, i64 8 ; 2 uses
  %.not38 = icmp eq ptr %i.ce, %1
...
bb.a:
  %i.a = tail call noundef nonnull align 8 dereferenceable(36) ptr @_ZN4llvh4errsEv() #13 ; 8 uses
...
bb.b:                                             ; preds = %_ZN4llvh14DomTreeBuilder11SemiNCAInfoINS_17DominatorTreeBaseIN6hermes10BasicBlockELb0EEEE16BlockNamePrinterC2EPNS_15DomTreeNodeBaseIS4_EE.exit.thread
  %i.k = tail call noundef nonnull align 8 dereferenceable(36) ptr @_ZN4llvh11raw_ostream5writeEPKcm(ptr noundef nonnull align 8 dereferenceable(36) %i.a, ptr noundef nonnull @.str.26, i64 noundef 7) #13 ; 0 uses
  br label %_ZN4llvh14DomTreeBuilderlsERNS_11raw_ostreamERKNS0_11SemiNCAInfoINS_17DominatorTreeBaseIN6hermes10BasicBlockELb0EEEE16BlockNamePrinterE.exit
...
bb.d:                                             ; preds = %_ZN4llvh14DomTreeBuilder11SemiNCAInfoINS_17DominatorTreeBaseIN6hermes10BasicBlockELb0EEEE16BlockNamePrinterC2EPNS_15DomTreeNodeBaseIS4_EE.exit
  tail call void @_ZNK6hermes10BasicBlock14printAsOperandERN4llvh11raw_ostreamEb(ptr noundef nonnull align 8 dereferenceable(80) %i.b, ptr noundef nonnull align 8 dereferenceable(36) %i.a, i1 noundef zeroext false) #13
  br label %_ZN4llvh14DomTreeBuilderlsERNS_11raw_ostreamERKNS0_11SemiNCAInfoINS_17DominatorTreeBaseIN6hermes10BasicBlockELb0EEEE16BlockNamePrinterE.exit
...
bb.e:                                             ; preds = %_ZN4llvh14DomTreeBuilderlsERNS_11raw_ostreamERKNS0_11SemiNCAInfoINS_17DominatorTreeBaseIN6hermes10BasicBlockELb0EEEE16BlockNamePrinterE.exit
  %i.v = tail call noundef nonnull align 8 dereferenceable(36) ptr @_ZN4llvh11raw_ostream5writeEPKcm(ptr noundef nonnull align 8 dereferenceable(36) %i.a, ptr noundef nonnull @.str.10, i64 noundef 2) #13
...
_ZN4llvh11raw_ostreamlsEPKc.exit:                 ; preds = %bb.e, %bb.f
  ...
  %i.ab = tail call noundef nonnull align 8 dereferenceable(36) ptr @_ZN4llvh11raw_ostreamlsEm(ptr noundef nonnull align 8 dereferenceable(36) %.0.i.i, i64 noundef %i.aa) #13 ; 4 uses
...
bb.g:                                             ; preds = %_ZN4llvh11raw_ostreamlsEPKc.exit
  %i.ak = tail call noundef nonnull align 8 dereferenceable(36) ptr @_ZN4llvh11raw_ostream5writeEPKcm(ptr noundef nonnull align 8 dereferenceable(36) %i.ab, ptr noundef nonnull @.str.24, i64 noundef 2) #13
...
_ZN4llvh11raw_ostreamlsEPKc.exit6:                ; preds = %bb.g, %bb.h
  ...
  %i.aq = tail call noundef nonnull align 8 dereferenceable(36) ptr @_ZN4llvh11raw_ostreamlsEm(ptr noundef nonnull align 8 dereferenceable(36) %.0.i.i5, i64 noundef %i.ap) #13 ; 3 uses
...
bb.i:                                             ; preds = %_ZN4llvh11raw_ostreamlsEPKc.exit6
  %i.av = tail call noundef nonnull align 8 dereferenceable(36) ptr @_ZN4llvh11raw_ostream5writeEh(ptr noundef nonnull align 8 dereferenceable(36) %i.aq, i8 noundef zeroext 125) #13 ; 0 uses
...
bb.a:
  %i.a = tail call noundef nonnull align 8 dereferenceable(36) ptr @_ZN4llvh4errsEv() #13 ; 3 uses
...
bb.b:                                             ; preds = %bb.a
  %i.j = tail call noundef nonnull align 8 dereferenceable(36) ptr @_ZN4llvh11raw_ostream5writeEPKcm(ptr noundef nonnull align 8 dereferenceable(36) %i.a, ptr noundef nonnull @.str.39, i64 noundef 35) #13 ; 0 uses
  br label %_ZN4llvh11raw_ostreamlsEPKc.exit

bb.c:                                             ; preds = %bb.a
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(35) %i.e, ptr noundef nonnull align 1 dereferenceable(35) @.str.39, i64 35, i1 false)
  %i.k = load ptr, ptr %i.d, align 8, !tbaa !159
  %i.l = getelementptr inbounds nuw i8, ptr %i.k, i64 35
  store ptr %i.l, ptr %i.d, align 8, !tbaa !159
end_hunk_1
