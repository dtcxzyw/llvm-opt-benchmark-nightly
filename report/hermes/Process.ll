...
bb.b:                                             ; preds = %bb.c, %bb.a
  ...
  %i.b = call noundef i32 @fstat(i32 noundef 0, ptr noundef nonnull %0) #18, !inline_history !55 ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  br i1 %i.e, label %bb.b, label %_ZN4llvh3sys16RetryAfterSignalIiDoFiiP4statEJiS3_EEEDTclfp0_spfp1_EERKT_RKT0_DpRKT1_.exit.thread, !llvm.loop !56
...
bb.e:                                             ; preds = %.preheader
  ...
  br i1 %i.k, label %.preheader, label %"_ZN4llvh3sys16RetryAfterSignalIiZNS0_7Process28FixupStandardFileDescriptorsEvE3$_0JEEEDTclfp0_spfp1_EERKT_RKT0_DpRKT1_.exit.thread", !llvm.loop !57
...
bb.h:                                             ; preds = %bb.i, %bb.g
  store i32 0, ptr %i.a, align 4, !tbaa !3
  %i.p = call noundef i32 @fstat(i32 noundef 1, ptr noundef nonnull %0) #18, !inline_history !55 ; 2 uses
...
bb.i:                                             ; preds = %bb.h
  ...
  br i1 %i.t, label %bb.h, label %_ZN4llvh3sys16RetryAfterSignalIiDoFiiP4statEJiS3_EEEDTclfp0_spfp1_EERKT_RKT0_DpRKT1_.exit.thread.1, !llvm.loop !56
...
bb.l:                                             ; preds = %.preheader.1
  ...
  br i1 %i.ad, label %.preheader.1, label %"_ZN4llvh3sys16RetryAfterSignalIiZNS0_7Process28FixupStandardFileDescriptorsEvE3$_0JEEEDTclfp0_spfp1_EERKT_RKT0_DpRKT1_.exit.thread", !llvm.loop !57
...
bb.n:                                             ; preds = %bb.o, %bb.m
  store i32 0, ptr %i.a, align 4, !tbaa !3
  %i.ae = call noundef i32 @fstat(i32 noundef 2, ptr noundef nonnull %0) #18, !inline_history !55 ; 2 uses
...
bb.o:                                             ; preds = %bb.n
  ...
  br i1 %i.ai, label %bb.n, label %_ZN4llvh3sys16RetryAfterSignalIiDoFiiP4statEJiS3_EEEDTclfp0_spfp1_EERKT_RKT0_DpRKT1_.exit.thread.2, !llvm.loop !56
...
end_hunk_7
begin_hunk_8_@_ZN4llvh15optional_detail15OptionalStorageINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEELb0EEaSEOS7_:bb.a
  %i.l = icmp ult i64 %i.k, 16
  tail call void @llvm.assume(i1 %i.l)
  %.not21.i = icmp eq ptr %1, %0
  br i1 %.not21.i, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit, label %bb.d, !prof !58
