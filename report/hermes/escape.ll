...
begin_hunk_0_@_ZN6hermes2vmL6decodeERNS0_7RuntimeENS0_6HandleINS0_15StringPrimitiveEEEPFbDsE:bb.a
  ...
  %i.b = alloca [4 x i8], align 1                 ; 13 uses
...
begin_hunk_1_@_ZN6hermes2vmL6decodeERNS0_7RuntimeENS0_6HandleINS0_15StringPrimitiveEEEPFbDsE:bb.a
  ...
  %.056458.lcssa.sroa.gep = getelementptr inbounds nuw i8, ptr %i.b, i64 3
  %.056458.lcssa.sroa.gep509 = getelementptr inbounds nuw i8, ptr %i.b, i64 4
  %.056458.lcssa.sroa.gep510 = getelementptr inbounds nuw i8, ptr %i.b, i64 2
...
_ZNK6hermes2vm10StringView14const_iteratorgeERKS2_.exit152: ; preds = %.preheader451.2, %.preheader451.3, %.preheader451.4
  %.056458.lcssa.sroa.phi = phi ptr [ %.056458.lcssa.sroa.gep, %.preheader451.3 ], [ %.056458.lcssa.sroa.gep509, %.preheader451.4 ], [ %.056458.lcssa.sroa.gep510, %.preheader451.2 ]
  %exitcond.not.1 = phi i1 [ true, %.preheader451.3 ], [ false, %.preheader451.4 ], [ false, %.preheader451.2 ]
  %11 = phi i64 [ 6, %.preheader451.3 ], [ 9, %.preheader451.4 ], [ 3, %.preheader451.2 ] ; 2 uses
  ...
  %i.fu = getelementptr inbounds nuw i8, ptr %spec.select, i64 %11
  %.sroa.3.0.idx.i145 = select i1 %.not.i144, i64 %11, i64 0
  %.sroa.3.0.i146 = getelementptr inbounds nuw [2 x i8], ptr %spec.select440, i64 %.sroa.3.0.idx.i145
  %i.fv = icmp uge ptr %i.fu, %.sroa.0.0.i76
  %i.fw = icmp uge ptr %.sroa.3.0.i146, %.sroa.3.0.i75
  %.0.i.i151 = select i1 %.not.i144, i1 %i.fw, i1 %i.fv
  br i1 %.0.i.i151, label %_ZN6hermes2vm11TwineChar16C2EPKc.exit154, label %.lr.ph
...
.lr.ph:                                           ; preds = %_ZNK6hermes2vm10StringView14const_iteratorgeERKS2_.exit152
...
_ZNK6hermes2vm10StringView14const_iteratordeEv.exit157: ; preds = %.lr.ph
...
_ZNK6hermes2vm10StringView14const_iteratordeEv.exit157.thread: ; preds = %.lr.ph
...
begin_hunk_4_@_ZN6hermes2vmL6decodeERNS0_7RuntimeENS0_6HandleINS0_15StringPrimitiveEEEPFbDsE:bb.a
  ...
  %i.lu = call noundef i32 @_ZN4llvh18ConvertUTF8toUTF32EPPKhS1_PPjS3_NS_15ConversionFlagsE(ptr noundef nonnull %i.d, ptr noundef nonnull %.056458.lcssa.sroa.phi, ptr noundef nonnull %i.e, ptr noundef nonnull %i.cb, i32 noundef 0) #11
