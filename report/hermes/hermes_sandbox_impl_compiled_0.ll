...
bb.k:                                             ; preds = %bb.h
  ...
  %.not534 = icmp eq i32 %i.an, 0                 ; 3 uses
  %i.ao = select i1 %.not534, i32 16, i32 0
  %5 = select i1 %.not534, i32 24, i32 8
...
bb.s:                                             ; preds = %bb.p
  ...
  %.not526 = icmp eq i32 %i.bv, 0                 ; 3 uses
  %i.bw = select i1 %.not526, i32 16, i32 0
  %7 = select i1 %.not526, i32 24, i32 8
...
begin_hunk_4_@w2c_hermes_d2b:bb.a
  ...
  %i.dr = icmp ult i32 %.0.copyload.i571, 65536   ; 3 uses
  %i.ds = select i1 %i.dr, i32 16, i32 0
  %9 = select i1 %i.dr, i32 24, i32 8
...
begin_hunk_6_@w2c_hermes_dtoa_fixedpoint:bb.a
  ...
  %i.tp = icmp ult i32 %.0.copyload.i3493, 65536  ; 3 uses
  %i.tq = select i1 %i.tp, i32 16, i32 0
  %8 = select i1 %i.tp, i32 24, i32 8
...
begin_hunk_8_@w2c_hermes_g_dtoa:bb.a
  ...
  %i.lw = icmp ult i32 %.0.copyload.i2462, 65536  ; 3 uses
  %i.lx = select i1 %i.lw, i32 16, i32 0
  %6 = select i1 %i.lw, i32 24, i32 8
...
begin_hunk_10_@w2c_hermes_b2d:bb.a
  ...
  %i.k = icmp ult i32 %.0.copyload.i235, 65536    ; 3 uses
  %i.l = select i1 %i.k, i32 16, i32 0
  %3 = select i1 %i.k, i32 24, i32 8
