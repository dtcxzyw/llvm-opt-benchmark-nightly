...
begin_hunk_0_@w2c_hermes_dlfree:bb.a
  ...
  %reass.sub = sub nsw i32 %i.ji, %i.jj
  %2 = add nsw i32 %reass.sub, 62
  br label %bb.bn

bb.bn:                                            ; preds = %bb.bm, %bb.bl
  %.4 = phi i32 [ %2, %bb.bm ], [ 31, %bb.bl ]    ; 5 uses
...
begin_hunk_1_@w2c_hermes_dlmalloc:bb.a
  ...
  %reass.sub = sub nsw i32 %i.fr, %i.fs
  %2 = add nsw i32 %reass.sub, 62
  br label %bb.ah

bb.ah:                                            ; preds = %bb.af, %bb.ag
  %.12996 = phi i32 [ %2, %bb.ag ], [ 31, %bb.af ] ; 4 uses
...
begin_hunk_2_@w2c_hermes_dlmalloc:bb.a
  ...
  %reass.sub3753 = sub nsw i32 %i.zw, %i.zx
  %3 = add nsw i32 %reass.sub3753, 62
  br label %bb.dw

bb.dw:                                            ; preds = %bb.dv, %bb.du
  %.17 = phi i32 [ %3, %bb.dv ], [ 31, %bb.du ]   ; 5 uses
...
begin_hunk_3_@w2c_hermes_dlmalloc:bb.a
  ...
  %reass.sub3754 = sub nsw i32 %i.afl, %i.afm
  %4 = add nsw i32 %reass.sub3754, 62
  br label %bb.ew

bb.ew:                                            ; preds = %bb.ev, %bb.eu
  %.103029 = phi i32 [ %4, %bb.ev ], [ 31, %bb.eu ] ; 5 uses
...
begin_hunk_4_@w2c_hermes_dlmalloc:bb.a
  ...
  %reass.sub3752 = sub nsw i32 %i.akr, %i.aks
  %5 = add nsw i32 %reass.sub3752, 62
  br label %bb.fv

bb.fv:                                            ; preds = %bb.fu, %bb.ft
  %.20 = phi i32 [ %5, %bb.fu ], [ 31, %bb.ft ]   ; 5 uses
...
begin_hunk_5_@w2c_hermes_dispose_chunk:bb.a
  ...
  %reass.sub = sub nsw i32 %i.jc, %i.jd
  %3 = add nsw i32 %reass.sub, 62
  br label %bb.bj

bb.bj:                                            ; preds = %bb.bi, %bb.bh
  %.4 = phi i32 [ %3, %bb.bi ], [ 31, %bb.bh ]    ; 5 uses
