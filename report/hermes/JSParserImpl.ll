...
begin_hunk_0_@_ZN6hermes6parser6detail12JSParserImpl17parseForStatementENS1_5ParamE:bb.a
  ...
  br i1 %i.m, label %bb.b, label %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit.threadthread-pre-split

bb.b:                                             ; preds = %bb.a
  %i.n = load i32, ptr %i.j, align 8, !tbaa !235  ; 2 uses
...
begin_hunk_1_@_ZN6hermes6parser6detail12JSParserImpl17parseForStatementENS1_5ParamE:bb.a
  ...
  br i1 %i.t, label %bb.c, label %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit.threadthread-pre-split
...
begin_hunk_2_@_ZN6hermes6parser6detail12JSParserImpl17parseForStatementENS1_5ParamE:bb.a
  ...
  br label %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit.threadthread-pre-split

_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit.threadthread-pre-split: ; preds = %bb.a, %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit, %bb.c
  %.ph = phi ptr [ %i.j, %bb.a ], [ %i.j, %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit ], [ %i.v, %bb.c ] ; 2 uses
  %.sroa.6138.0.ph = phi ptr [ null, %bb.a ], [ null, %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit ], [ %.sroa.2.0.copyload.i.i81, %bb.c ]
  %.sroa.0137.0.ph = phi ptr [ null, %bb.a ], [ null, %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit ], [ %.sroa.0.0.copyload.i.i79, %bb.c ]
  %.0.ph = phi i1 [ false, %bb.a ], [ false, %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit ], [ true, %bb.c ]
...
_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit.thread: ; preds = %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit.threadthread-pre-split, %bb.b
  %7 = phi i32 [ %.pr, %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit.threadthread-pre-split ], [ %i.n, %bb.b ]
  %8 = phi ptr [ %.ph, %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit.threadthread-pre-split ], [ %i.j, %bb.b ]
  %.sroa.6138.0 = phi ptr [ %.sroa.6138.0.ph, %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit.threadthread-pre-split ], [ null, %bb.b ] ; 2 uses
  %.sroa.0137.0 = phi ptr [ %.sroa.0137.0.ph, %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit.threadthread-pre-split ], [ null, %bb.b ] ; 2 uses
  %.0 = phi i1 [ %.0.ph, %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit.threadthread-pre-split ], [ false, %bb.b ] ; 4 uses
  %i.w = getelementptr inbounds nuw i8, ptr %8, i64 8
  %.sroa.0.0.copyload.i = load ptr, ptr %i.w, align 8, !tbaa !229 ; 3 uses
  %i.x = icmp eq i32 %7, 53
...
begin_hunk_6_@_ZN6hermes6parser6detail12JSParserImpl17parseForStatementENS1_5ParamE:bb.a
  ...
  store i8 %9, ptr %i.fg, align 8, !tbaa !387
  br label %bb.ab
...
bb.bu:                                            ; preds = %.critedge
  ...
  %5 = trunc nuw i8 %.2457.a to i1                ; 2 uses
  br i1 %5, label %bb.bv, label %switch.early.test
