...
_ZN6hermes6parser6detail12JSParserImpl11checkAndEatENS0_9TokenKindENS0_7JSLexer14GrammarContextE.exit: ; preds = %bb.d, %bb.e
  ...
  %.in.then.val = load i8, ptr %i.x, align 1, !tbaa !283, !range !81, !noundef !75
  br i1 %2, label %bb.f, label %_ZN6hermes6parser6detail12JSParserImpl11checkAndEatENS0_9TokenKindENS0_7JSLexer14GrammarContextE.exit.cont.cont

_ZN6hermes6parser6detail12JSParserImpl11checkAndEatENS0_9TokenKindENS0_7JSLexer14GrammarContextE.exit.cont.cont: ; preds = %_ZN6hermes6parser6detail12JSParserImpl11checkAndEatENS0_9TokenKindENS0_7JSLexer14GrammarContextE.exit
  store i8 %i.w, ptr %i.x, align 1, !tbaa !283
  %i.y = getelementptr inbounds nuw i8, ptr %0, i64 1206 ; 3 uses
  %i.z = load i8, ptr %i.y, align 2, !tbaa !283, !range !81, !noundef !75
  store i8 %i.n, ptr %i.y, align 2, !tbaa !283
  %i.aa = tail call { i64, i8 } @_ZN6hermes6parser6detail12JSParserImpl22parseBindingIdentifierENS1_5ParamE(ptr noundef nonnull align 8 dereferenceable(2824) %0, i32 0) ; 2 uses
...
bb.f:                                             ; preds = %_ZN6hermes6parser6detail12JSParserImpl11checkAndEatENS0_9TokenKindENS0_7JSLexer14GrammarContextE.exit
  %i.ac = getelementptr inbounds nuw i8, ptr %0, i64 1206 ; 4 uses
  %.in78.then.val = load i8, ptr %i.ac, align 2, !tbaa !283, !range !81, !noundef !75 ; 3 uses
  %i.ad = tail call { i64, i8 } @_ZN6hermes6parser6detail12JSParserImpl22parseBindingIdentifierENS1_5ParamE(ptr noundef nonnull align 8 dereferenceable(2824) %0, i32 0) ; 3 uses
  %i.ae = extractvalue { i64, i8 } %i.ad, 1       ; 2 uses
  %i.af = and i32 %1, 4
...
bb.i:                                             ; preds = %_ZN6hermes6parser6detail12JSParserImpl11checkAndEatENS0_9TokenKindENS0_7JSLexer14GrammarContextE.exit.cont.cont, %bb.g, %bb.f
  %i.ah = phi i8 [ 1, %bb.g ], [ %i.ae, %bb.f ], [ %i.ab, %_ZN6hermes6parser6detail12JSParserImpl11checkAndEatENS0_9TokenKindENS0_7JSLexer14GrammarContextE.exit.cont.cont ] ; 2 uses
  %.pn = phi { i64, i8 } [ %i.ad, %bb.g ], [ %i.ad, %bb.f ], [ %i.aa, %_ZN6hermes6parser6detail12JSParserImpl11checkAndEatENS0_9TokenKindENS0_7JSLexer14GrammarContextE.exit.cont.cont ]
  %i.ai = phi i8 [ %.in78.then.val, %bb.g ], [ %.in78.then.val, %bb.f ], [ %i.z, %_ZN6hermes6parser6detail12JSParserImpl11checkAndEatENS0_9TokenKindENS0_7JSLexer14GrammarContextE.exit.cont.cont ] ; 4 uses
  %i.aj = phi ptr [ %i.ac, %bb.g ], [ %i.ac, %bb.f ], [ %i.y, %_ZN6hermes6parser6detail12JSParserImpl11checkAndEatENS0_9TokenKindENS0_7JSLexer14GrammarContextE.exit.cont.cont ] ; 7 uses
  %i.ak = extractvalue { i64, i8 } %.pn, 0        ; 2 uses
  %i.al = load ptr, ptr %0, align 8, !tbaa !239, !nonnull !75, !align !76 ; 3 uses
  %i.am = getelementptr inbounds nuw i8, ptr %i.al, i64 188
  %i.an = load i32, ptr %i.am, align 4, !tbaa !284
  %.not200 = icmp eq i32 %i.an, 0
  %.pre203.pre208 = load ptr, ptr %i.d, align 8, !tbaa !85 ; 3 uses
  br i1 %.not200, label %bb.l, label %bb.j

bb.j:                                             ; preds = %bb.i
  %i.ao = load i32, ptr %.pre203.pre208, align 8, !tbaa !235
  %i.ap = icmp eq i32 %i.ao, 74
  br i1 %i.ap, label %bb.k, label %bb.l

bb.k:                                             ; preds = %bb.j
  %i.aq = tail call { i64, i8 } @_ZN6hermes6parser6detail12JSParserImpl19parseTypeParamsFlowEv(ptr noundef nonnull align 8 dereferenceable(2824) %0) #17 ; 2 uses
  %i.ar = extractvalue { i64, i8 } %i.aq, 1
  %i.as = trunc nuw i8 %i.ar to i1
  br i1 %i.as, label %.thread, label %bb.au

.thread:                                          ; preds = %bb.k
  %i.at = extractvalue { i64, i8 } %i.aq, 0
  %i.au = inttoptr i64 %i.at to ptr
  %.pre = load ptr, ptr %0, align 8, !tbaa !239
  %.pre203.pre = load ptr, ptr %i.d, align 8, !tbaa !85
  br label %bb.l

bb.l:                                             ; preds = %.thread, %bb.j, %bb.i
  %.pre203 = phi ptr [ %.pre203.pre, %.thread ], [ %.pre203.pre208, %bb.j ], [ %.pre203.pre208, %bb.i ] ; 2 uses
  %i.av = phi ptr [ %.pre, %.thread ], [ %i.al, %bb.j ], [ %i.al, %bb.i ]
  %.162 = phi ptr [ %i.au, %.thread ], [ null, %bb.j ], [ null, %bb.i ] ; 2 uses
  %i.aw = getelementptr inbounds nuw i8, ptr %i.av, i64 192
  %i.ax = load i8, ptr %i.aw, align 8, !tbaa !285, !range !81, !noundef !75
  %i.ay = trunc nuw i8 %i.ax to i1
  br i1 %i.ay, label %bb.m, label %thread-pre-split

bb.m:                                             ; preds = %bb.l
  %i.az = load i32, ptr %.pre203, align 8, !tbaa !235 ; 2 uses
  %i.ba = icmp eq i32 %i.az, 74
  br i1 %i.ba, label %bb.n, label %bb.o

bb.n:                                             ; preds = %bb.m
  %i.bb = tail call { i64, i8 } @_ZN6hermes6parser6detail12JSParserImpl21parseTSTypeParametersEv(ptr noundef nonnull align 8 dereferenceable(2824) %0) #17 ; 2 uses
  %i.bc = extractvalue { i64, i8 } %i.bb, 1
  %i.bd = trunc nuw i8 %i.bc to i1
  br i1 %i.bd, label %.thread186, label %bb.au

.thread186:                                       ; preds = %bb.n
  %i.be = extractvalue { i64, i8 } %i.bb, 0
  %i.bf = inttoptr i64 %i.be to ptr
  %.pre202 = load ptr, ptr %i.d, align 8, !tbaa !85
  br label %thread-pre-split

thread-pre-split:                                 ; preds = %bb.l, %.thread186
  %.ph = phi ptr [ %.pre203, %bb.l ], [ %.pre202, %.thread186 ]
  %.364.ph = phi ptr [ %.162, %bb.l ], [ %i.bf, %.thread186 ]
  %.pr = load i32, ptr %.ph, align 8, !tbaa !235
  br label %bb.o

bb.o:                                             ; preds = %thread-pre-split, %bb.m
  %i.bg = phi i32 [ %.pr, %thread-pre-split ], [ %i.az, %bb.m ]
  %.364 = phi ptr [ %.364.ph, %thread-pre-split ], [ %.162, %bb.m ] ; 4 uses
  %i.bh = icmp eq i32 %i.bg, 53
  br i1 %i.bh, label %bb.q, label %bb.p

bb.p:                                             ; preds = %bb.o
  %i.bi = select i1 %2, ptr @.str.87, ptr @.str.88
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b)
  store i32 53, ptr %i.b, align 4, !tbaa !264
  call void @_ZN6hermes6parser6detail12JSParserImpl13errorExpectedEN4llvh8ArrayRefINS0_9TokenKindEEEPKcS8_NS3_5SMLocE(ptr noundef nonnull readonly align 8 dereferenceable(2824) %0, ptr nonnull %i.b, i64 1, ptr noundef nonnull @.str.86, ptr noundef nonnull %i.bi, ptr %.sroa.0.0.copyload.i.i)
...
bb.q:                                             ; preds = %bb.o
  ...
  store ptr %4, ptr %i.bj, align 8, !tbaa !234
  %i.bk = load i8, ptr %i.x, align 1, !tbaa !283, !range !81, !noundef !75 ; 2 uses
  store i8 %i.w, ptr %i.x, align 1, !tbaa !283
  %i.bl = load i8, ptr %i.aj, align 1, !tbaa !283, !range !81, !noundef !75 ; 3 uses
  store i8 %i.n, ptr %i.aj, align 1, !tbaa !283
  %i.bm = call noundef zeroext i1 @_ZN6hermes6parser6detail12JSParserImpl21parseFormalParametersENS1_5ParamERN4llvh12simple_ilistINS_6ESTree4NodeEJEEE(ptr noundef nonnull align 8 dereferenceable(2824) %0, i32 %1, ptr noundef nonnull align 8 dereferenceable(16) %4)
  br i1 %i.bm, label %bb.r, label %_ZN6hermes6parser6detail12JSParserImpl31SaveStrictModeAndSeenDirectivesD2Ev.exit

bb.r:                                             ; preds = %bb.q
  %i.bn = load ptr, ptr %0, align 8, !tbaa !239, !nonnull !75, !align !76
  %i.bo = getelementptr inbounds nuw i8, ptr %i.bn, i64 188
  %i.bp = load i32, ptr %i.bo, align 4, !tbaa !284
  %.not201 = icmp eq i32 %i.bp, 0
  %.pre207.pre210 = load ptr, ptr %i.d, align 8, !tbaa !85 ; 4 uses
  br i1 %.not201, label %.thread190, label %bb.s

bb.s:                                             ; preds = %bb.r
  %i.bq = load i32, ptr %.pre207.pre210, align 8, !tbaa !235
  %i.br = icmp eq i32 %i.bq, 92
  br i1 %i.br, label %bb.t, label %.thread190

bb.t:                                             ; preds = %bb.s
  %i.bs = getelementptr inbounds nuw i8, ptr %.pre207.pre210, i64 8
  %.sroa.0.0.copyload.i.i85 = load ptr, ptr %i.bs, align 8, !tbaa !229
  %i.bt = call noundef ptr @_ZN6hermes6parser7JSLexer7advanceENS1_14GrammarContextE(ptr noundef nonnull align 8 dereferenceable(1160) %i.p, i32 noundef 3) #17 ; 3 uses
  store ptr %i.bt, ptr %i.d, align 8, !tbaa !85
  %i.bu = getelementptr inbounds nuw i8, ptr %0, i64 1704 ; 2 uses
  %i.bv = load i32, ptr %i.bt, align 8, !tbaa !235
  %i.bw = icmp eq i32 %i.bv, 1
  br i1 %i.bw, label %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit90, label %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit90.thread

_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit90: ; preds = %bb.t
end_hunk_0
...
_ZN4llvh11SmallVectorIcLj24EED2Ev.exit.i.i.i51:   ; preds = %bb.t, %.lr.ph.i.i.i49
  ...
  br i1 %.not.i.i.i52, label %_ZN4llvh23SmallVectorTemplateBaseINS_11SmallStringILj24EEELb0EE13destroy_rangeEPS2_S4_.exit.loopexit.i.i53, label %.lr.ph.i.i.i49, !llvm.loop !341
...
_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit:    ; preds = %.critedge.i.i.i, %bb.e
  ...
  store ptr %i.j, ptr %i.ap, align 8, !tbaa !346
...
bb.a:
  ...
  store i32 %i.c, ptr %i.a, align 8, !tbaa !349
...
bb.c:                                             ; preds = %_ZN6hermes6parser6detail12JSParserImpl19recursionDepthCheckEv.exit
  %i.i = tail call { i64, i8 } @_ZN6hermes6parser6detail12JSParserImpl24parseArrayBindingPatternENS1_5ParamE(ptr noundef nonnull align 8 dereferenceable(2824) %0, i32 %1), !inline_history !350
...
bb.d:                                             ; preds = %_ZN6hermes6parser6detail12JSParserImpl19recursionDepthCheckEv.exit
  %i.j = tail call { i64, i8 } @_ZN6hermes6parser6detail12JSParserImpl25parseObjectBindingPatternENS1_5ParamE(ptr noundef nonnull align 8 dereferenceable(2824) %0, i32 %1), !inline_history !350
  br label %_ZN6hermes6parser6detail12JSParserImpl19parseBindingPatternENS1_5ParamE.exit
...
bb.h:                                             ; preds = %.thread, %bb.g, %_ZN6hermes6parser6detail12JSParserImpl19parseBindingPatternENS1_5ParamE.exit, %bb.f, %bb.b
  ...
  %i.ad = load i32, ptr %i.a, align 8, !tbaa !349
  %i.ae = add i32 %i.ad, -1
  store i32 %i.ae, ptr %i.a, align 8, !tbaa !349
...
bb.d:                                             ; preds = %_ZN6hermes6parser6detail12JSParserImpl19recursionDepthCheckEv.exit
  %i.m = tail call { i64, i8 } @_ZN6hermes6parser6detail12JSParserImpl23parseLexicalDeclarationENS1_5ParamE(ptr noundef nonnull align 8 dereferenceable(2824) %0, i32 1), !inline_history !351 ; 2 uses
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.bz = load i8, ptr %i.by, align 4, !tbaa !352, !range !81, !noundef !75
...
bb.x:                                             ; preds = %bb.w
  ...
  %i.dl = load i8, ptr %i.dk, align 1, !tbaa !353, !range !81, !noundef !75
...
_ZN6hermes6parser6detail12JSParserImpl19checkMaybeFlowMatchEv.exit: ; preds = %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit.i
  ...
  br i1 %i.dt, label %bb.y, label %_ZN6hermes6parser6detail12JSParserImpl19checkMaybeFlowMatchEv.exit.thread, !prof !354
...
.critedge:                                        ; preds = %_ZN6hermes6parser6detail12JSParserImpl19checkMaybeFlowMatchEv.exit.thread, %bb.v, %bb.u, %bb.t, %bb.s, %bb.r, %bb.q, %bb.m, %bb.l, %bb.k, %bb.j, %bb.i, %bb.h, %bb.d, %bb.c, %bb.y, %bb.z, %bb.g, %bb.b
  ...
  %i.ee = load i32, ptr %i.a, align 8, !tbaa !349
  %i.ef = add i32 %i.ee, -1
  store i32 %i.ef, ptr %i.a, align 8, !tbaa !349
...
_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit:    ; preds = %.critedge.i.i.i, %bb.e
  ...
  store i8 0, ptr %i.ap, align 4, !tbaa !311
  %i.aq = getelementptr inbounds nuw i8, ptr %.0.i.i.i, i64 53
  store i8 0, ptr %i.aq, align 1, !tbaa !313
  %i.ar = getelementptr inbounds nuw i8, ptr %.0.i.i.i, i64 54
  store i8 0, ptr %i.ar, align 2, !tbaa !314
...
bb.g:                                             ; preds = %bb.f
  %i.ab = tail call { i64, i8 } @_ZN6hermes6parser6detail12JSParserImpl24parseArrayBindingPatternENS1_5ParamE(ptr noundef nonnull align 8 dereferenceable(2824) %0, i32 0), !inline_history !350
  br label %_ZN6hermes6parser6detail12JSParserImpl19parseBindingPatternENS1_5ParamE.exit

bb.h:                                             ; preds = %bb.f
  %i.ac = tail call { i64, i8 } @_ZN6hermes6parser6detail12JSParserImpl25parseObjectBindingPatternENS1_5ParamE(ptr noundef nonnull align 8 dereferenceable(2824) %0, i32 0), !inline_history !350
  br label %_ZN6hermes6parser6detail12JSParserImpl19parseBindingPatternENS1_5ParamE.exit
...
bb.f:                                             ; preds = %bb.e, %bb.d
  ...
  store ptr %.sroa.0.0.copyload.i.i, ptr %i.aj, align 8, !tbaa !325
...
_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit:    ; preds = %.critedge.i.i.i, %bb.n
  ...
  store i32 -1, ptr %i.ct, align 8, !tbaa !363
...
_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit43:  ; preds = %.critedge.i.i.i42, %bb.s
  ...
  store ptr %i.el, ptr %i.eo, align 8, !tbaa !337
  %i.ep = getelementptr inbounds nuw i8, ptr %.0.i.i.i41, i64 56
  store ptr null, ptr %i.ep, align 8, !tbaa !340
...
bb.c:                                             ; preds = %bb.b, %.lr.ph
  ...
  %.sroa.2.0.copyload.i = load i64, ptr %.sroa.2.0..sroa_idx.i, align 8, !tbaa !345 ; 5 uses
...
bb.i:                                             ; preds = %bb.h, %bb.f, %_ZNK6hermes6parser6detail12JSParserImpl6checkNINS0_9TokenKindEJPNS_12UniqueStringEEEEbT_DpT0_.exit.thread, %bb.e, %bb.d, %bb.g, %bb.b
  ...
  %i.aw = load i32, ptr %i.a, align 8, !tbaa !349
  %i.ax = add i32 %i.aw, -1
  store i32 %i.ax, ptr %i.a, align 8, !tbaa !349
...
bb.a:
  ...
  %i.k = call { i64, i8 } @_ZN6hermes6parser6detail12JSParserImpl24parseVariableDeclarationENS1_5ParamEN4llvh5SMLocE(ptr noundef nonnull align 8 dereferenceable(2824) %0, i32 %1, ptr %.sroa.0.0.copyload.i.i), !inline_history !374 ; 2 uses
...
_ZN6hermes6parser6detail12JSParserImpl11checkAndEatENS0_9TokenKindENS0_7JSLexer14GrammarContextE.exit.i: ; preds = %.lr.ph.i39
  %i.v = call noundef ptr @_ZN6hermes6parser7JSLexer7advanceENS1_14GrammarContextE(ptr noundef nonnull align 8 dereferenceable(1160) %i.h, i32 noundef 0) #17, !inline_history !374
  store ptr %i.v, ptr %i.a, align 8, !tbaa !85
  %i.w = call { i64, i8 } @_ZN6hermes6parser6detail12JSParserImpl24parseVariableDeclarationENS1_5ParamEN4llvh5SMLocE(ptr noundef nonnull align 8 dereferenceable(2824) %0, i32 %1, ptr %.sroa.0.0.copyload.i.i), !inline_history !374 ; 2 uses
  %i.x = extractvalue { i64, i8 } %i.w, 1
  %i.y = trunc nuw i8 %i.x to i1
  br i1 %i.y, label %.lr.ph.i39, label %_ZN6hermes6parser6detail12JSParserImpl28parseVariableDeclarationListENS1_5ParamERN4llvh12simple_ilistINS_6ESTree4NodeEJEEENS4_5SMLocE.exit.thread, !llvm.loop !375
...
bb.s:                                             ; preds = %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit.thread
  ...
  %i.gc = load i32, ptr %i.gb, align 8, !tbaa !349
  %i.gd = add i32 %i.gc, 1                        ; 2 uses
  store i32 %i.gd, ptr %i.gb, align 8, !tbaa !349
...
bb.b:                                             ; preds = %.lr.ph, %bb.e
  ...
  %i.g = load ptr, ptr %i.f, align 8, !tbaa !286  ; 3 uses
...
_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit:    ; preds = %.critedge.i.i.i, %bb.b
  ...
  store ptr %i.y, ptr %i.ab, align 8, !tbaa !292
  %i.ac = getelementptr inbounds nuw i8, ptr %.0.i.i.i, i64 56
  store ptr null, ptr %i.ac, align 8, !tbaa !294
  %i.ad = getelementptr inbounds nuw i8, ptr %.0.i.i.i, i64 64
  store i8 0, ptr %i.ad, align 8, !tbaa !295
...
bb.b:                                             ; preds = %bb.a
  %i.f = tail call { i64, i8 } @_ZN6hermes6parser6detail12JSParserImpl24parseArrayBindingPatternENS1_5ParamE(ptr noundef nonnull align 8 dereferenceable(2824) %0, i32 %1), !inline_history !350
  br label %_ZN6hermes6parser6detail12JSParserImpl19parseBindingPatternENS1_5ParamE.exit

bb.c:                                             ; preds = %bb.a
  %i.g = tail call { i64, i8 } @_ZN6hermes6parser6detail12JSParserImpl25parseObjectBindingPatternENS1_5ParamE(ptr noundef nonnull align 8 dereferenceable(2824) %0, i32 %1), !inline_history !350
  br label %_ZN6hermes6parser6detail12JSParserImpl19parseBindingPatternENS1_5ParamE.exit
...
_ZN4llvh15SmallVectorImplIZN6hermes6parser6detail12JSParserImpl25parseAssignmentExpressionENS3_5ParamENS4_23AllowTypedArrowFunctionENS4_20CoverTypedParametersEPNS1_6ESTree4NodeEE5StateE12emplace_backIJEEEvDpOT_.exit:
  ...
  %storemerge38 = extractvalue { i64, i8 } %i.h, 1
  %i.i = trunc nuw i8 %storemerge38 to i1
...
.lr.ph.preheader:                                 ; preds = %_ZN4llvh15SmallVectorImplIZN6hermes6parser6detail12JSParserImpl25parseAssignmentExpressionENS3_5ParamENS4_23AllowTypedArrowFunctionENS4_20CoverTypedParametersEPNS1_6ESTree4NodeEE5StateE12emplace_backIJEEEvDpOT_.exit
  %.val1866 = load ptr, ptr %7, align 8, !tbaa !131 ; 2 uses
  %.val1967 = load i32, ptr %i.b, align 8, !tbaa !132 ; 3 uses
  %i.j = zext i32 %.val1967 to i64                ; 2 uses
  %i.k = getelementptr inbounds nuw [48 x i8], ptr %.val1866, i64 %i.j
  %i.l = getelementptr inbounds i8, ptr %i.k, i64 -16
  %i.m = load ptr, ptr %i.l, align 8, !tbaa !458
  %.not68 = icmp eq ptr %i.m, null
  br i1 %.not68, label %.preheader, label %.lr.ph71
...
.lr.ph:                                           ; preds = %_ZN4llvh15SmallVectorImplIZN6hermes6parser6detail12JSParserImpl25parseAssignmentExpressionENS3_5ParamENS4_23AllowTypedArrowFunctionENS4_20CoverTypedParametersEPNS1_6ESTree4NodeEE5StateE12emplace_backIJEEEvDpOT_.exit24
  ...
  br i1 %.not, label %.preheader, label %.lr.ph71, !llvm.loop !459

.preheader:                                       ; preds = %.lr.ph, %.lr.ph.preheader
  %.pn39.lcssa = phi { i64, i8 } [ %i.h, %.lr.ph.preheader ], [ %i.aq, %.lr.ph ]
  %.val19.lcssa = phi i32 [ %.val1967, %.lr.ph.preheader ], [ %.val19, %.lr.ph ]
  %.sroa.0.0.le = extractvalue { i64, i8 } %.pn39.lcssa, 0 ; 2 uses
  %storemerge3040 = add i32 %.val19.lcssa, -1     ; 3 uses
  store i32 %storemerge3040, ptr %i.b, align 8, !tbaa !132
  %.not.i2541 = icmp eq i32 %storemerge3040, 0
  br i1 %.not.i2541, label %.loopexit, label %.lr.ph44
...
.lr.ph71:                                         ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %.val1970 = phi i32 [ %.val19, %.lr.ph ], [ %.val1967, %.lr.ph.preheader ] ; 2 uses
  %.val1869 = phi ptr [ %.val18, %.lr.ph ], [ %.val1866, %.lr.ph.preheader ]
  %i.x = icmp ugt i32 %.val1970, 30000
...
bb.b:                                             ; preds = %.lr.ph71
  ...
  %.not.i22 = icmp ult i32 %.val1970, %i.af
...
_ZN4llvh15SmallVectorImplIZN6hermes6parser6detail12JSParserImpl25parseAssignmentExpressionENS3_5ParamENS4_23AllowTypedArrowFunctionENS4_20CoverTypedParametersEPNS1_6ESTree4NodeEE5StateE12emplace_backIJEEEvDpOT_.exit24: ; preds = %bb.b, %bb.c
  %.pre-phi = phi i64 [ %i.w, %bb.b ], [ %.pre52, %bb.c ]
  %i.ag = phi ptr [ %.val1869, %bb.b ], [ %.pre, %bb.c ]
  %i.ah = getelementptr inbounds nuw [48 x i8], ptr %i.ag, i64 %.pre-phi ; 4 uses
  store ptr null, ptr %i.ah, align 8, !tbaa !323
...
bb.d:                                             ; preds = %.lr.ph44, %_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit
  %storemerge3043 = phi i32 [ %storemerge3040, %.lr.ph44 ], [ %storemerge30, %_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit ]
  %.sroa.0.142 = phi ptr [ %i.v, %.lr.ph44 ], [ %.0.i.i.i, %_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit ]
...
_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit.i: ; preds = %_ZNK6hermes6parser6detail12JSParserImpl6checkNINS0_9TokenKindEJS4_S4_S4_S4_S4_S4_S4_EEEbT_DpT0_.exit.i
  ...
  br i1 %i.az, label %_ZNK6hermes6parser6detail12JSParserImpl28checkEndAssignmentExpressionENS2_16OfEndsAssignmentE.exit.thread, label %_ZNK6hermes6parser6detail12JSParserImpl28checkEndAssignmentExpressionENS2_16OfEndsAssignmentE.exit

_ZNK6hermes6parser6detail12JSParserImpl28checkEndAssignmentExpressionENS2_16OfEndsAssignmentE.exit: ; preds = %_ZNK6hermes6parser6detail12JSParserImpl6checkNINS0_9TokenKindEJS4_S4_S4_S4_S4_S4_S4_EEEbT_DpT0_.exit.i, %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit.i
  %i.ba = load i8, ptr %i.t, align 8, !tbaa !280, !range !81, !noundef !75
  %i.bb = trunc nuw i8 %i.ba to i1
  br i1 %i.bb, label %_ZNK6hermes6parser6detail12JSParserImpl28checkEndAssignmentExpressionENS2_16OfEndsAssignmentE.exit.thread, label %bb.f

bb.f:                                             ; preds = %_ZNK6hermes6parser6detail12JSParserImpl28checkEndAssignmentExpressionENS2_16OfEndsAssignmentE.exit
...
_ZNK6hermes6parser6detail12JSParserImpl28checkEndAssignmentExpressionENS2_16OfEndsAssignmentE.exit.thread: ; preds = %_ZNK6hermes6parser6detail12JSParserImpl6checkNINS0_9TokenKindEJS4_S4_S4_S4_S4_S4_S4_EEEbT_DpT0_.exit.i, %_ZNK6hermes6parser6detail12JSParserImpl6checkNINS0_9TokenKindEJS4_S4_S4_S4_S4_S4_S4_EEEbT_DpT0_.exit.i, %bb.e, %bb.d, %bb.d, %bb.d, %bb.d, %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit.i, %_ZNK6hermes6parser6detail12JSParserImpl28checkEndAssignmentExpressionENS2_16OfEndsAssignmentE.exit
  ...
  %i.bh = zext i32 %storemerge3043 to i64
  ...
  %i.bv = load i64, ptr %i.bu, align 8, !tbaa !250 ; 2 uses
  %i.bw = add i64 %i.bt, 7
end_hunk_5
...
bb.a:
  ...
  %i.a = load ptr, ptr %0, align 8, !tbaa !355    ; 7 uses
...
._crit_edge:                                      ; preds = %bb.c, %bb.d
  ...
  %i.t = load i8, ptr %i.s, align 8, !tbaa !309, !range !81, !noundef !75
  %i.u = trunc nuw i8 %i.t to i1
  br i1 %i.u, label %bb.f, label %bb.e

bb.e:                                             ; preds = %._crit_edge
  %i.v = getelementptr inbounds nuw i8, ptr %i.m, i64 129
  %i.w = load i8, ptr %i.v, align 1, !tbaa !310, !range !81, !noundef !75
...
_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit:    ; preds = %.critedge.i.i.i, %bb.h
  ...
  store i8 0, ptr %i.bb, align 4, !tbaa !311
  %i.bc = getelementptr inbounds nuw i8, ptr %.0.i.i.i, i64 53
  store i8 0, ptr %i.bc, align 1, !tbaa !313
  %i.bd = getelementptr inbounds nuw i8, ptr %.0.i.i.i, i64 54
  store i8 0, ptr %i.bd, align 2, !tbaa !314
...
bb.m:                                             ; preds = %.critedge104
  ...
  store ptr %i.x, ptr %i.as, align 8, !tbaa !294
  ...
  store i8 %i.au, ptr %i.av, align 8, !tbaa !295
...
bb.r:                                             ; preds = %.critedge113
  ...
  store ptr %i.bh, ptr %i.ca, align 8, !tbaa !294
...
_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit: ; preds = %_ZN6hermes6parser6detail12JSParserImpl19recursionDepthCheckEv.exit
  ...
  br i1 %or.cond, label %bb.e, label %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit53
...
bb.e:                                             ; preds = %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit
  ...
  br i1 %i.az, label %._ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit53_crit_edge, label %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit53.thread

._ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit53_crit_edge: ; preds = %bb.e
  %.phi.trans.insert = getelementptr inbounds nuw i8, ptr %.pre250, i64 32
  %.pre291 = load ptr, ptr %.phi.trans.insert, align 8, !tbaa !279
  br label %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit53

_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit53: ; preds = %._ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit53_crit_edge, %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit
  %i.ba = phi ptr [ %.pre291, %._ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit53_crit_edge ], [ %i.ap, %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit ]
  %i.bb = getelementptr inbounds nuw i8, ptr %0, i64 1464
  %i.bc = load ptr, ptr %i.bb, align 8, !tbaa !166
  %i.bd = icmp eq ptr %i.ba, %i.bc
  br i1 %i.bd, label %bb.f, label %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit53.thread

bb.f:                                             ; preds = %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit53
  ...
  br i1 %i.bh, label %bb.g, label %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit53.thread
...
_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit53.thread: ; preds = %bb.e, %bb.f, %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit53
...
bb.h:                                             ; preds = %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit53.thread
  %i.bo = getelementptr inbounds nuw i8, ptr %i.bl, i64 185
  %i.bp = load i8, ptr %i.bo, align 1, !tbaa !353, !range !81, !noundef !75
...
_ZN6hermes6parser6detail12JSParserImpl19checkMaybeFlowMatchEv.exit.thread: ; preds = %_ZN6hermes6parser6detail12JSParserImpl19checkMaybeFlowMatchEv.exit._ZN6hermes6parser6detail12JSParserImpl19checkMaybeFlowMatchEv.exit.thread_crit_edge, %bb.i, %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit.i, %bb.h, %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit53.thread
  %i.cd = phi ptr [ %.pre252, %_ZN6hermes6parser6detail12JSParserImpl19checkMaybeFlowMatchEv.exit._ZN6hermes6parser6detail12JSParserImpl19checkMaybeFlowMatchEv.exit.thread_crit_edge ], [ %i.bl, %bb.i ], [ %i.bl, %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit.i ], [ %i.bl, %bb.h ], [ %i.bl, %_ZNK6hermes6parser6detail12JSParserImpl5checkEPNS_12UniqueStringE.exit53.thread ] ; 3 uses
...
_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit275: ; preds = %.critedge.i.i.i274, %bb.k
  ...
  store ptr %i.da, ptr %i.dd, align 8, !tbaa !292
  %i.de = getelementptr inbounds nuw i8, ptr %.0.i.i.i273, i64 56
  store ptr null, ptr %i.de, align 8, !tbaa !294
  %i.df = getelementptr inbounds nuw i8, ptr %.0.i.i.i273, i64 64
  store i8 0, ptr %i.df, align 8, !tbaa !295
  %i.dg = getelementptr inbounds nuw i8, ptr %i.ce, i64 8 ; 2 uses
  %.sroa.0.0.copyload.i.i.i54 = load ptr, ptr %i.dg, align 8, !tbaa !229
  %i.dh = getelementptr inbounds nuw i8, ptr %.0.i.i.i273, i64 24
  store ptr %.sroa.0.0.copyload.i.i.i54, ptr %i.dh, align 8, !tbaa !229
  %i.di = getelementptr inbounds nuw i8, ptr %i.ce, i64 16
  %.sroa.0.0.copyload.i.i9.i55 = load ptr, ptr %i.di, align 8, !tbaa !229
  %i.dj = getelementptr inbounds nuw i8, ptr %.0.i.i.i273, i64 32
  store ptr %.sroa.0.0.copyload.i.i9.i55, ptr %i.dj, align 8, !tbaa !229
  %.sroa.0.0.copyload.i.i10.i56 = load ptr, ptr %i.dg, align 8, !tbaa !229
  %i.dk = getelementptr inbounds nuw i8, ptr %.0.i.i.i273, i64 40
  store ptr %.sroa.0.0.copyload.i.i10.i56, ptr %i.dk, align 8, !tbaa !229
...
bb.l:                                             ; preds = %_ZN6hermes6parser6detail12JSParserImpl19recursionDepthCheckEv.exit
  ...
  br i1 %i.ee, label %.critedge.i.i.i63, label %bb.m, !prof !251

.critedge.i.i.i63:                                ; preds = %bb.l
  ...
  br label %_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit64
...
_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit64:  ; preds = %.critedge.i.i.i63, %bb.m
  %.0.i.i.i62 = phi ptr [ %i.ef, %.critedge.i.i.i63 ], [ %i.eh, %bb.m ] ; 7 uses
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %.0.i.i.i62, i8 0, i64 16, i1 false)
  %i.ei = getelementptr inbounds nuw i8, ptr %.0.i.i.i62, i64 16
  store i32 34, ptr %i.ei, align 8, !tbaa !252
  %i.ej = getelementptr inbounds nuw i8, ptr %.0.i.i.i62, i64 20
  ...
  %.sroa.0.0.copyload.i.i.i65 = load ptr, ptr %i.ek, align 8, !tbaa !229
  %i.el = getelementptr inbounds nuw i8, ptr %.0.i.i.i62, i64 24
  store ptr %.sroa.0.0.copyload.i.i.i65, ptr %i.el, align 8, !tbaa !229
  %i.em = getelementptr inbounds nuw i8, ptr %i.g, i64 16
  %.sroa.0.0.copyload.i.i9.i66 = load ptr, ptr %i.em, align 8, !tbaa !229
  %i.en = getelementptr inbounds nuw i8, ptr %.0.i.i.i62, i64 32
  store ptr %.sroa.0.0.copyload.i.i9.i66, ptr %i.en, align 8, !tbaa !229
  %.sroa.0.0.copyload.i.i10.i67 = load ptr, ptr %i.ek, align 8, !tbaa !229
  %i.eo = getelementptr inbounds nuw i8, ptr %.0.i.i.i62, i64 40
  store ptr %.sroa.0.0.copyload.i.i10.i67, ptr %i.eo, align 8, !tbaa !229
  ...
  %i.er = ptrtoint ptr %.0.i.i.i62 to i64
  br label %bb.as
...
bb.n:                                             ; preds = %_ZN6hermes6parser6detail12JSParserImpl19recursionDepthCheckEv.exit, %_ZN6hermes6parser6detail12JSParserImpl19recursionDepthCheckEv.exit
  ...
  br i1 %i.fi, label %.critedge.i.i.i74, label %bb.o, !prof !251

.critedge.i.i.i74:                                ; preds = %bb.n
...
_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit75:  ; preds = %.critedge.i.i.i74, %bb.o
  %i.fm = phi i32 [ %.pre249, %.critedge.i.i.i74 ], [ %i.h, %bb.o ]
end_hunk_7
begin_hunk_8_@_ZN6hermes6parser6detail12JSParserImpl22parsePrimaryExpressionEv:bb.a
  store ptr %.sroa.0.0.copyload.i.i9.i88, ptr %i.hd, align 8, !tbaa !229
  %.sroa.0.0.copyload.i.i10.i89 = load ptr, ptr %i.ha, align 8, !tbaa !229
  %i.he = getelementptr inbounds nuw i8, ptr %.0.i.i.i84, i64 40
  store ptr %.sroa.0.0.copyload.i.i10.i89, ptr %i.he, align 8, !tbaa !229
  ...
  %i.hh = ptrtoint ptr %.0.i.i.i84 to i64
  br label %bb.as
...
bb.r:                                             ; preds = %_ZN6hermes6parser6detail12JSParserImpl19recursionDepthCheckEv.exit
  ...
  br i1 %i.hy, label %.critedge.i.i.i96, label %bb.s, !prof !251

.critedge.i.i.i96:                                ; preds = %bb.r
  ...
  br label %_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit97
...
_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit97:  ; preds = %.critedge.i.i.i96, %bb.s
  %i.ic = phi ptr [ %.pre246, %.critedge.i.i.i96 ], [ %i.g, %bb.s ]
  %.0.i.i.i95 = phi ptr [ %i.hz, %.critedge.i.i.i96 ], [ %i.ib, %bb.s ] ; 8 uses
  %i.id = getelementptr inbounds nuw i8, ptr %i.ic, i64 56
  %i.ie = load ptr, ptr %i.id, align 8, !tbaa !499
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(56) %.0.i.i.i95, i8 0, i64 16, i1 false)
  %i.if = getelementptr inbounds nuw i8, ptr %.0.i.i.i95, i64 16
  store i32 39, ptr %i.if, align 8, !tbaa !252
  %i.ig = getelementptr inbounds nuw i8, ptr %.0.i.i.i95, i64 20
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(28) %i.ig, i8 0, i64 28, i1 false)
  %i.ih = getelementptr inbounds nuw i8, ptr %.0.i.i.i95, i64 48
  store ptr %i.ie, ptr %i.ih, align 8, !tbaa !500
  %i.ii = getelementptr inbounds nuw i8, ptr %i.g, i64 8 ; 2 uses
  %.sroa.0.0.copyload.i.i.i98 = load ptr, ptr %i.ii, align 8, !tbaa !229
  %i.ij = getelementptr inbounds nuw i8, ptr %.0.i.i.i95, i64 24
  store ptr %.sroa.0.0.copyload.i.i.i98, ptr %i.ij, align 8, !tbaa !229
  %i.ik = getelementptr inbounds nuw i8, ptr %i.g, i64 16
  %.sroa.0.0.copyload.i.i9.i99 = load ptr, ptr %i.ik, align 8, !tbaa !229
  %i.il = getelementptr inbounds nuw i8, ptr %.0.i.i.i95, i64 32
  store ptr %.sroa.0.0.copyload.i.i9.i99, ptr %i.il, align 8, !tbaa !229
  %.sroa.0.0.copyload.i.i10.i100 = load ptr, ptr %i.ii, align 8, !tbaa !229
  %i.im = getelementptr inbounds nuw i8, ptr %.0.i.i.i95, i64 40
  store ptr %.sroa.0.0.copyload.i.i10.i100, ptr %i.im, align 8, !tbaa !229
  ...
  %i.ip = ptrtoint ptr %.0.i.i.i95 to i64
  br label %bb.as
...
bb.t:                                             ; preds = %_ZN6hermes6parser6detail12JSParserImpl19recursionDepthCheckEv.exit
  ...
  br i1 %i.jg, label %.critedge.i.i.i107, label %bb.u, !prof !251

.critedge.i.i.i107:                               ; preds = %bb.t
...
_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit108: ; preds = %.critedge.i.i.i107, %bb.u
  %i.jk = phi ptr [ %.pre245, %.critedge.i.i.i107 ], [ %i.g, %bb.u ]
  %.0.i.i.i106 = phi ptr [ %i.jh, %.critedge.i.i.i107 ], [ %i.jj, %bb.u ] ; 8 uses
  %i.jl = getelementptr inbounds nuw i8, ptr %i.jk, i64 40
  %i.jm = load ptr, ptr %i.jl, align 8, !tbaa !431
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(56) %.0.i.i.i106, i8 0, i64 16, i1 false)
  %i.jn = getelementptr inbounds nuw i8, ptr %.0.i.i.i106, i64 16
  store i32 36, ptr %i.jn, align 8, !tbaa !252
  %i.jo = getelementptr inbounds nuw i8, ptr %.0.i.i.i106, i64 20
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(28) %i.jo, i8 0, i64 28, i1 false)
  %i.jp = getelementptr inbounds nuw i8, ptr %.0.i.i.i106, i64 48
  store ptr %i.jm, ptr %i.jp, align 8, !tbaa !335
  %i.jq = getelementptr inbounds nuw i8, ptr %i.g, i64 8 ; 2 uses
  %.sroa.0.0.copyload.i.i.i109 = load ptr, ptr %i.jq, align 8, !tbaa !229
  %i.jr = getelementptr inbounds nuw i8, ptr %.0.i.i.i106, i64 24
  store ptr %.sroa.0.0.copyload.i.i.i109, ptr %i.jr, align 8, !tbaa !229
  %i.js = getelementptr inbounds nuw i8, ptr %i.g, i64 16
  %.sroa.0.0.copyload.i.i9.i110 = load ptr, ptr %i.js, align 8, !tbaa !229
  %i.jt = getelementptr inbounds nuw i8, ptr %.0.i.i.i106, i64 32
  store ptr %.sroa.0.0.copyload.i.i9.i110, ptr %i.jt, align 8, !tbaa !229
  %.sroa.0.0.copyload.i.i10.i111 = load ptr, ptr %i.jq, align 8, !tbaa !229
  %i.ju = getelementptr inbounds nuw i8, ptr %.0.i.i.i106, i64 40
  store ptr %.sroa.0.0.copyload.i.i10.i111, ptr %i.ju, align 8, !tbaa !229
  ...
  %i.jx = ptrtoint ptr %.0.i.i.i106 to i64
  br label %bb.as
...
bb.v:                                             ; preds = %_ZN6hermes6parser6detail12JSParserImpl19recursionDepthCheckEv.exit
  ...
  br i1 %i.ko, label %.critedge.i.i.i118, label %bb.w, !prof !251

.critedge.i.i.i118:                               ; preds = %bb.v
...
_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit119: ; preds = %.critedge.i.i.i118, %bb.w
  %i.ks = phi ptr [ %.pre, %.critedge.i.i.i118 ], [ %i.g, %bb.w ]
  %.0.i.i.i117 = phi ptr [ %i.kp, %.critedge.i.i.i118 ], [ %i.kr, %bb.w ] ; 8 uses
  %i.kt = getelementptr inbounds nuw i8, ptr %i.ks, i64 48
  %i.ku = load ptr, ptr %i.kt, align 8, !tbaa !502
  %i.kv = getelementptr inbounds nuw i8, ptr %.0.i.i.i117, i64 16
  %i.kw = getelementptr inbounds nuw i8, ptr %.0.i.i.i117, i64 20
  %i.kx = getelementptr inbounds nuw i8, ptr %.0.i.i.i117, i64 48
  %i.ky = load <2 x ptr>, ptr %i.ku, align 8, !tbaa !214
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(64) %.0.i.i.i117, i8 0, i64 16, i1 false)
  ...
  %.sroa.0.0.copyload.i.i.i120 = load ptr, ptr %i.kz, align 8, !tbaa !229
  %i.la = getelementptr inbounds nuw i8, ptr %.0.i.i.i117, i64 24
  store ptr %.sroa.0.0.copyload.i.i.i120, ptr %i.la, align 8, !tbaa !229
  %i.lb = getelementptr inbounds nuw i8, ptr %i.g, i64 16
  %.sroa.0.0.copyload.i.i9.i121 = load ptr, ptr %i.lb, align 8, !tbaa !229
  %i.lc = getelementptr inbounds nuw i8, ptr %.0.i.i.i117, i64 32
  store ptr %.sroa.0.0.copyload.i.i9.i121, ptr %i.lc, align 8, !tbaa !229
  %.sroa.0.0.copyload.i.i10.i122 = load ptr, ptr %i.kz, align 8, !tbaa !229
  %i.ld = getelementptr inbounds nuw i8, ptr %.0.i.i.i117, i64 40
  store ptr %.sroa.0.0.copyload.i.i10.i122, ptr %i.ld, align 8, !tbaa !229
  ...
  %i.lg = ptrtoint ptr %.0.i.i.i117 to i64
  br label %bb.as
...
bb.z:                                             ; preds = %_ZN6hermes6parser6detail12JSParserImpl19recursionDepthCheckEv.exit
  ...
  %.sroa.0.0.copyload.i.i128 = load ptr, ptr %i.lp, align 8, !tbaa !229 ; 5 uses
...
bb.aa:                                            ; preds = %bb.z
  %.sroa.2.0..sroa_idx.i.i134 = getelementptr inbounds nuw i8, ptr %i.lr, i64 16
  %.sroa.2.0.copyload.i.i135 = load ptr, ptr %.sroa.2.0..sroa_idx.i.i134, align 8, !tbaa !229
  ...
  store ptr %.sroa.0.0.copyload.i.i128, ptr %i.ly, align 8, !tbaa !229
  %i.lz = getelementptr inbounds nuw i8, ptr %i.lv, i64 32
  store ptr %.sroa.2.0.copyload.i.i135, ptr %i.lz, align 8, !tbaa !229
  %i.ma = getelementptr inbounds nuw i8, ptr %i.lv, i64 40
  store ptr %.sroa.0.0.copyload.i.i128, ptr %i.ma, align 8, !tbaa !229
...
.thread:                                          ; preds = %bb.ab
  ...
  %.sroa.0.0.copyload.i.i.i138 = load ptr, ptr %i.mm, align 8, !tbaa !229
  %i.mn = getelementptr inbounds nuw i8, ptr %i.mi, i64 24
  store ptr %.sroa.0.0.copyload.i.i.i138, ptr %i.mn, align 8, !tbaa !229
  %i.mo = getelementptr inbounds nuw i8, ptr %i.mg, i64 32
  %.sroa.0.0.copyload.i.i9.i139 = load ptr, ptr %i.mo, align 8, !tbaa !229
  %i.mp = getelementptr inbounds nuw i8, ptr %i.mi, i64 32
  store ptr %.sroa.0.0.copyload.i.i9.i139, ptr %i.mp, align 8, !tbaa !229
  %.sroa.0.0.copyload.i.i10.i140 = load ptr, ptr %i.mm, align 8, !tbaa !229
  %i.mq = getelementptr inbounds nuw i8, ptr %i.mi, i64 40
  store ptr %.sroa.0.0.copyload.i.i10.i140, ptr %i.mq, align 8, !tbaa !229
  br label %bb.ad
...
bb.ac:                                            ; preds = %bb.z
  ...
  br i1 %i.mt, label %.thread203, label %bb.as

.thread203:                                       ; preds = %bb.ac
  %i.mu = extractvalue { i64, i8 } %i.mr, 0
  %i.mv = inttoptr i64 %i.mu to ptr
  br label %bb.ad

bb.ad:                                            ; preds = %.thread203, %.thread
  %.2 = phi ptr [ %i.mi, %.thread ], [ %i.mv, %.thread203 ] ; 10 uses
...
bb.ah:                                            ; preds = %bb.ag
  ...
  %i.nk = load <2 x ptr>, ptr %i.nj, align 8, !tbaa !286
...
bb.aj:                                            ; preds = %bb.ai
  ...
  %.sroa.0.0.copyload.i.i142 = load ptr, ptr %i.no, align 8, !tbaa !229
  ...
  %i.nq = ptrtoint ptr %.sroa.0.0.copyload.i.i142 to i64
  ...
  br i1 %i.nt, label %.thread205, label %bb.as

.thread205:                                       ; preds = %bb.aj
...
.critedge.sink.split:                             ; preds = %bb.ah, %.thread205
  %.sink272 = phi ptr [ %i.ny, %.thread205 ], [ %i.ni, %bb.ah ] ; 8 uses
  %.sink262 = phi ptr [ %i.nw, %.thread205 ], [ %i.nh, %bb.ah ]
  %i.ob = phi <2 x ptr> [ %i.oa, %.thread205 ], [ %i.nk, %bb.ah ]
  ...
  store <2 x ptr> %i.ob, ptr %i.oe, align 8, !tbaa !286
  %i.of = getelementptr inbounds nuw i8, ptr %.sink272, i64 24
  store ptr %.sroa.0.0.copyload.i.i128, ptr %i.of, align 8, !tbaa !229
  %i.og = getelementptr inbounds nuw i8, ptr %.sink262, i64 16
  %.sroa.0.0.copyload.i.i.i147 = load ptr, ptr %i.og, align 8, !tbaa !229
  %i.oh = getelementptr inbounds nuw i8, ptr %.sink272, i64 32
  store ptr %.sroa.0.0.copyload.i.i.i147, ptr %i.oh, align 8, !tbaa !229
  %i.oi = getelementptr inbounds nuw i8, ptr %.sink272, i64 40
  store ptr %.sroa.0.0.copyload.i.i128, ptr %i.oi, align 8, !tbaa !229
  br label %.critedge
...
bb.ak:                                            ; preds = %.critedge
  ...
  %spec.select.i148 = select i1 %.not.i, i32 1, i32 2
  store i32 %spec.select.i148, ptr %i.ok, align 4, !tbaa !487
...
bb.aq:                                            ; preds = %bb.ao
  ...
  %.sroa.0.0.copyload.i149 = load ptr, ptr %i.pg, align 8, !tbaa !229
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #17
  ...
  call void @_ZN6hermes18SourceErrorManager7messageENS0_8DiagKindEN4llvh5SMLocERKNS2_5TwineENS_9SubsystemE(ptr noundef nonnull align 8 dereferenceable(464) %i.pk, i32 noundef 0, ptr %.sroa.0.0.copyload.i149, ptr noundef nonnull align 8 dereferenceable(18) %2, i32 noundef 2) #17
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #17
  br label %bb.as
...
bb.ar:                                            ; preds = %_ZN6hermes6parser6detail12JSParserImpl19recursionDepthCheckEv.exit
  ...
  %.sroa.0.0.copyload.i150 = load ptr, ptr %i.pl, align 8, !tbaa !229
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #17
  ...
  call void @_ZN6hermes18SourceErrorManager7messageENS0_8DiagKindEN4llvh5SMLocERKNS2_5TwineENS_9SubsystemE(ptr noundef nonnull align 8 dereferenceable(464) %i.pp, i32 noundef 0, ptr %.sroa.0.0.copyload.i150, ptr noundef nonnull align 8 dereferenceable(18) %3, i32 noundef 2) #17
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #17
  br label %bb.as

bb.as:                                            ; preds = %bb.ap, %bb.an, %bb.am, %bb.al, %bb.y, %bb.x, %bb.g, %bb.ak, %bb.ab, %bb.ac, %bb.aj, %.critedge, %bb.aa, %bb.ar, %bb.aq, %_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit119, %_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit108, %_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit97, %_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit86, %_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit75, %_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit64, %_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit275, %bb.j, %_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit, %bb.b
  %.sroa.0200.8 = phi i64 [ undef, %bb.b ], [ undef, %bb.ar ], [ %i.al, %_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit ], [ undef, %bb.aq ], [ %i.cb, %bb.j ], [ %i.dn, %_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit275 ], [ %i.er, %_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit64 ], [ %i.fz, %_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit75 ], [ %i.hh, %_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit86 ], [ %i.ip, %_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit97 ], [ %i.jx, %_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit108 ], [ %i.lg, %_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit119 ], [ undef, %bb.ac ], [ undef, %bb.ab ], [ %i.mb, %bb.aa ], [ %spec.select212, %bb.y ], [ undef, %.critedge ], [ %spec.select214, %bb.al ], [ %spec.select216, %bb.am ], [ %spec.select218, %bb.an ], [ %spec.select220, %bb.ap ], [ %spec.select, %bb.g ], [ %spec.select210, %bb.x ], [ %i.om, %bb.ak ], [ undef, %bb.aj ]
  %.sroa.19.12 = phi i8 [ 0, %bb.b ], [ 0, %bb.ar ], [ 1, %_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit ], [ 0, %bb.aq ], [ %i.cc, %bb.j ], [ 1, %_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit275 ], [ 1, %_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit64 ], [ 1, %_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit75 ], [ 1, %_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit86 ], [ 1, %_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit97 ], [ 1, %_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit108 ], [ 1, %_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit119 ], [ 0, %bb.ac ], [ 0, %bb.ab ], [ 1, %bb.aa ], [ %spec.select213, %bb.y ], [ 0, %.critedge ], [ %spec.select3.i277, %bb.al ], [ %spec.select217, %bb.am ], [ %spec.select219, %bb.an ], [ %spec.select221, %bb.ap ], [ %spec.select3.i, %bb.g ], [ %spec.select211, %bb.x ], [ 1, %bb.ak ], [ 0, %bb.aj ]
  %i.pq = load i32, ptr %i.a, align 8, !tbaa !349
  %i.pr = add i32 %i.pq, -1
  store i32 %i.pr, ptr %i.a, align 8, !tbaa !349
  %.fca.0.insert = insertvalue { i64, i8 } poison, i64 %.sroa.0200.8, 0
...
_ZN6hermes6ESTree4NodenwEmRNS_7ContextEm.exit16:  ; preds = %.critedge.i.i.i15, %bb.j
  ...
  %i.ce = load ptr, ptr %i.ad, align 8, !tbaa !335
  ...
  store ptr %.0.i.i.i, ptr %i.ch, align 8, !tbaa !337
  %i.ci = getelementptr inbounds nuw i8, ptr %.0.i.i.i14, i64 56
  store ptr %i.ce, ptr %i.ci, align 8, !tbaa !340
...
bb.a:
  %i.a = tail call noalias noundef nonnull dereferenceable(2848) ptr @_Znwm(i64 noundef 2848) #19, !noalias !777 ; 13 uses
  %i.b = getelementptr inbounds nuw i8, ptr %i.a, i64 8 ; 8 uses
  store i32 1, ptr %i.b, align 8, !tbaa !782, !noalias !784
  %i.c = getelementptr inbounds nuw i8, ptr %i.a, i64 12 ; 2 uses
  store i32 1, ptr %i.c, align 4, !tbaa !785, !noalias !784
  store ptr getelementptr inbounds nuw inrange(-16, 40) (i8, ptr @_ZTVSt23_Sp_counted_ptr_inplaceIN6hermes6parser6detail12_GLOBAL__N_19PreParserESaIvELN9__gnu_cxx12_Lock_policyE2EE, i64 16), ptr %i.a, align 8, !tbaa !82, !noalias !784
  %i.d = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  store ptr %1, ptr %i.d, align 8, !tbaa !786, !noalias !784
  %i.e = tail call noalias noundef nonnull dereferenceable(40) ptr @_Znwm(i64 noundef 40) #19, !noalias !784 ; 7 uses
  %i.f = getelementptr inbounds nuw i8, ptr %1, i64 24 ; 2 uses
  %i.g = load ptr, ptr %i.f, align 8, !tbaa !240, !noalias !784 ; 3 uses
  %i.h = load i32, ptr %i.g, align 8, !tbaa !241, !noalias !784
  store i32 %i.h, ptr %i.e, align 8, !tbaa !241, !noalias !784
  %i.i = getelementptr inbounds nuw i8, ptr %i.e, i64 8
  %i.j = getelementptr inbounds nuw i8, ptr %i.g, i64 8
  %i.k = load i64, ptr %i.j, align 8, !tbaa !250, !noalias !784
  store i64 %i.k, ptr %i.i, align 8, !tbaa !250, !noalias !784
  %i.l = getelementptr inbounds nuw i8, ptr %i.e, i64 16
  %i.m = getelementptr inbounds nuw i8, ptr %i.e, i64 32 ; 2 uses
  store ptr %i.m, ptr %i.l, align 8, !tbaa !131, !noalias !784
  %i.n = getelementptr inbounds nuw i8, ptr %i.e, i64 24
  store i32 0, ptr %i.n, align 8, !tbaa !132, !noalias !784
  %i.o = getelementptr inbounds nuw i8, ptr %i.e, i64 28
  store i32 0, ptr %i.o, align 4, !tbaa !133, !noalias !784
  store ptr %i.g, ptr %i.m, align 8, !tbaa !288, !noalias !784
  store ptr %i.e, ptr %i.f, align 8, !tbaa !240, !noalias !784
  %i.p = getelementptr inbounds nuw i8, ptr %i.a, i64 24 ; 3 uses
  tail call void @_ZN6hermes6parser6detail12JSParserImplC2ERNS_7ContextEjNS0_10ParserPassE(ptr noundef nonnull align 8 dereferenceable(2824) %i.p, ptr noundef nonnull align 8 dereferenceable(656) %1, i32 noundef %2, i32 noundef 0), !noalias !784
...
bb.b:                                             ; preds = %_ZN6hermes6parser6detail12JSParserImpl5parseEv.exit
  store ptr %i.p, ptr %0, align 8, !tbaa !787
  %i.z = getelementptr inbounds nuw i8, ptr %0, i64 8
  store ptr %i.a, ptr %i.z, align 8, !tbaa !789
...
bb.e:                                             ; preds = %_ZNSt10shared_ptrIN6hermes6parser6detail12JSParserImplEEC2INS2_12_GLOBAL__N_19PreParserEEERKS_IT_EPS3_.exit
  store i32 0, ptr %i.b, align 8, !tbaa !782
  store i32 0, ptr %i.c, align 4, !tbaa !785
  %i.ah = load ptr, ptr %i.a, align 8, !tbaa !82
  %i.ai = getelementptr inbounds nuw i8, ptr %i.ah, i64 16
  %i.aj = load ptr, ptr %i.ai, align 8
  tail call void %i.aj(ptr noundef nonnull align 8 dereferenceable(16) %i.a) #17, !inline_history !790
  %i.ak = load ptr, ptr %i.a, align 8, !tbaa !82
  %i.al = getelementptr inbounds nuw i8, ptr %i.ak, i64 24
  %i.am = load ptr, ptr %i.al, align 8
  tail call void %i.am(ptr noundef nonnull align 8 dereferenceable(16) %i.a) #17, !inline_history !790
...
bb.a:
  ...
  store ptr %4, ptr %i.d, align 8, !tbaa !325
  ...
  store i8 %i.b, ptr %i.h, align 2, !tbaa !373
...
bb.b:                                             ; preds = %.lr.ph
  ...
  %i.d = load i32, ptr %i.c, align 8, !tbaa !791  ; 2 uses
  %i.e = icmp eq i32 %i.d, 0
  %.pre1.i.i.i.i = load ptr, ptr %i.b, align 8, !tbaa !794 ; 3 uses
...
.lr.ph.i.i.i.i.i:                                 ; preds = %_ZN6hermes6parser21PreParsedFunctionInfoD2Ev.exit.i.i.i.i.i, %.lr.ph.preheader.i.i.i.i.i
  ...
  %i.h = load ptr, ptr %.010.i.i.i.i.i, align 8, !tbaa !323
...
_ZN4llvh11SmallVectorIcLj24EED2Ev.exit.i.i.i.i.i.i.i.i: ; preds = %bb.d, %.lr.ph.i.i.i.i.i.i.i.i
  ...
  br i1 %.not.i.i.i.i.i.i.i.i, label %_ZN4llvh23SmallVectorTemplateBaseINS_11SmallStringILj24EEELb0EE13destroy_rangeEPS2_S4_.exit.loopexit.i.i.i.i.i.i.i, label %.lr.ph.i.i.i.i.i.i.i.i, !llvm.loop !341
...
_ZN6hermes6parser21PreParsedFunctionInfoD2Ev.exit.i.i.i.i.i: ; preds = %bb.e, %_ZN4llvh23SmallVectorTemplateBaseINS_11SmallStringILj24EEELb0EE13destroy_rangeEPS2_S4_.exit.i.i.i.i.i.i.i, %.lr.ph.i.i.i.i.i
  ...
  br i1 %.not.i.i.i.i.i, label %_ZN4llvh12DenseMapBaseINS_8DenseMapINS_5SMLocEN6hermes6parser21PreParsedFunctionInfoENS4_9SMLocInfoENS_6detail12DenseMapPairIS2_S5_EEEES2_S5_S6_S9_E10destroyAllEv.exit.loopexit.i.i.i.i, label %.lr.ph.i.i.i.i.i, !llvm.loop !795
...
_ZN4llvh12DenseMapBaseINS_8DenseMapINS_5SMLocEN6hermes6parser21PreParsedFunctionInfoENS4_9SMLocInfoENS_6detail12DenseMapPairIS2_S5_EEEES2_S5_S6_S9_E10destroyAllEv.exit.loopexit.i.i.i.i: ; preds = %_ZN6hermes6parser21PreParsedFunctionInfoD2Ev.exit.i.i.i.i.i
  %.pre.i.i.i.i = load ptr, ptr %i.b, align 8, !tbaa !794
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %next.gep14, align 8, !tbaa !223, !alias.scope !797
  %wide.load15 = load <2 x i64>, ptr %i.ai, align 8, !tbaa !223, !alias.scope !797
  %i.aj = getelementptr i8, ptr %next.gep, i64 16
  store <2 x i64> %wide.load, ptr %next.gep, align 8, !tbaa !223, !alias.scope !800, !noalias !797
  store <2 x i64> %wide.load15, ptr %i.aj, align 8, !tbaa !223, !alias.scope !800, !noalias !797
