...
._crit_edge212:                                   ; preds = %_ZN4llvh11raw_ostreamlsEPKc.exit57, %_ZN4llvh11raw_ostreamlsEPKc.exit57.peel, %_ZN4llvh11raw_ostreamlsEPKc.exit
  %.050.lcssa = phi i32 [ 0, %_ZN4llvh11raw_ostreamlsEPKc.exit ], [ 2, %_ZN4llvh11raw_ostreamlsEPKc.exit57.peel ], [ %i.fb, %_ZN4llvh11raw_ostreamlsEPKc.exit57 ]
...
_ZN4llvh11raw_ostreamlsEPKc.exit57:               ; preds = %bb.aa, %bb.z, %.lr.ph211.peel.next
  %.1 = phi i32 [ %i.eq, %bb.aa ], [ %.050210, %.lr.ph211.peel.next ], [ %i.eq, %bb.z ]
  ...
  %i.fb = add i32 %.1, 2                          ; 2 uses
  %exitcond.not = icmp eq i64 %i.fa, %..i55
  br i1 %exitcond.not, label %._crit_edge212, label %.lr.ph211.peel.next, !llvm.loop !104

bb.ab:                                            ; preds = %._crit_edge212
  %3 = sub i32 %i.ap, %.050.lcssa                 ; 3 uses
  %i.fc = icmp ult i32 %3, 80
  br i1 %i.fc, label %bb.ac, label %.preheader.i.i58

bb.ac:                                            ; preds = %bb.ab
  %i.fd = zext nneg i32 %3 to i64
...
.preheader.i.i58:                                 ; preds = %bb.ab, %_ZN4llvh11raw_ostream5writeEPKcm.exit135
  %.01112.i.i59 = phi i32 [ %i.id, %_ZN4llvh11raw_ostream5writeEPKcm.exit135 ], [ %3, %bb.ab ] ; 2 uses
