...
begin_hunk_0_@_ZN6hermes6parser7JSLexer10scanNumberENS1_14GrammarContextE:bb.a
  ...
  %16 = icmp ne i8 %i.d, 48                       ; 2 uses
  br i1 %16, label %.split.preheader, label %bb.b
...
.split.us:                                        ; preds = %.split.us.preheader, %.critedge.us
  %.sink346 = phi ptr [ %i.p, %.split.us.preheader ], [ %i.y, %.critedge.us ] ; 4 uses
  %.090.us = phi i8 [ 0, %.split.us.preheader ], [ %i.x, %.critedge.us ] ; 2 uses
  store ptr %.sink346, ptr %i.b, align 8, !tbaa !19
  %i.q = load i8, ptr %.sink346, align 1, !tbaa !66 ; 4 uses
...
.split244.us:                                     ; preds = %bb.i, %.critedge, %.split.preheader
  %.087311 = phi ptr [ %.087.ph, %.split.preheader ], [ %.087.ph, %.critedge ], [ %i.p, %bb.i ] ; 4 uses
  ...
  %.us-phi = phi i8 [ 0, %.split.preheader ], [ %i.ab, %.critedge ], [ %.090.us, %bb.i ] ; 4 uses
  %.us-phi245 = phi ptr [ %.promoted.ph, %.split.preheader ], [ %i.ac, %.critedge ], [ %.sink346, %bb.i ] ; 2 uses
  %.us-phi246 = phi i8 [ %i.n, %.split.preheader ], [ %i.ad, %.critedge ], [ %i.q, %bb.i ] ; 2 uses
  %17 = trunc nuw i8 %.0207309 to i1
  %or.cond = select i1 %16, i1 true, i1 %17
  br i1 %or.cond, label %bb.j, label %.loopexit239

bb.j:                                             ; preds = %.split244.us
  %i.af = icmp eq i8 %.us-phi246, 46
  br i1 %i.af, label %bb.k, label %bb.l

bb.k:                                             ; preds = %bb.j
  %i.ag = getelementptr inbounds nuw i8, ptr %.us-phi245, i64 1
  br label %bb.n

bb.l:                                             ; preds = %bb.j
  %i.ah = and i8 %.us-phi246, -33
  %i.ai = icmp eq i8 %i.ah, 69
  br i1 %i.ai, label %bb.m, label %.loopexit239

bb.m:                                             ; preds = %bb.l
  %i.aj = getelementptr inbounds nuw i8, ptr %.us-phi245, i64 1
  br label %bb.p
...
.loopexit239:                                     ; preds = %.critedge6, %._crit_edge, %.split244.us, %bb.l
  ...
  %.5 = phi i8 [ %.us-phi, %.split244.us ], [ %.us-phi, %bb.l ], [ %.292.lcssa, %._crit_edge ], [ %i.bf, %.critedge6 ] ; 3 uses
...
.loopexit239.thread:                              ; preds = %bb.r
  ...
  br i1 %i.bl, label %bb.s, label %..thread224_crit_edge
...
bb.t:                                             ; preds = %bb.s
  %i.bq = trunc nuw i8 %.3210322 to i1
...
_ZNK4llvh9StringRef6equalsES0_.exit136.thread219: ; preds = %_ZNK4llvh9StringRef6equalsES0_.exit136
  ...
  %i.ce = ptrtoint ptr %.3325 to i64
  %i.cf = sub i64 %i.cd, %i.ce                    ; 2 uses
  %.not117 = icmp eq ptr %i.cc, %.3325
  br i1 %.not117, label %.thread224, label %.lr.ph.i

.lr.ph.i:                                         ; preds = %_ZNK4llvh9StringRef6equalsES0_.exit136.thread219
  %i.cg = getelementptr inbounds nuw i8, ptr %.3325, i64 %i.cf
  %i.ch = add nuw nsw i32 %.3214320, 48           ; 2 uses
  %i.ci = add nuw nsw i32 %.3214320, 87           ; 2 uses
  %i.cj = getelementptr inbounds i8, ptr %i.cg, i64 -1
  %i.ck = load i8, ptr %.3325, align 1, !tbaa !66 ; 3 uses
  %i.cl = add i8 %i.ck, -48
...
.peel.next.i:                                     ; preds = %.critedge.peel.i
  %i.cs = getelementptr inbounds nuw i8, ptr %.3325, i64 1
  br label %bb.w
...
.thread224:                                       ; preds = %bb.z, %bb.y, %..thread224_crit_edge, %_ZNK4llvh9StringRef6equalsES0_.exit136, %_ZNK4llvh9StringRef6equalsES0_.exit, %bb.s, %_ZNK4llvh9StringRef6equalsES0_.exit136.thread219, %bb.u, %_ZNK4llvh9StringRef6equalsES0_.exit.thread217, %bb.v
  %18 = phi ptr [ %.pre280, %..thread224_crit_edge ], [ %i.bm, %bb.v ], [ %i.bm, %_ZNK4llvh9StringRef6equalsES0_.exit136 ], [ %i.bm, %_ZNK4llvh9StringRef6equalsES0_.exit ], [ %i.bm, %bb.s ], [ %i.bm, %_ZNK4llvh9StringRef6equalsES0_.exit136.thread219 ], [ %i.bm, %bb.u ], [ %i.bm, %_ZNK4llvh9StringRef6equalsES0_.exit.thread217 ], [ %i.bm, %bb.y ], [ %i.bm, %bb.z ]
...
begin_hunk_11_@_ZN6hermes6parser7JSLexer10scanNumberENS1_14GrammarContextE:bb.a
  ...
  call void @_ZN6hermes18SourceErrorManager7messageENS0_8DiagKindEN4llvh7SMRangeERKNS2_5TwineENS_9SubsystemE(ptr noundef nonnull align 8 dereferenceable(464) %i.eh, i32 noundef 0, ptr %.sroa.0.0.copyload.i, ptr %18, ptr noundef nonnull align 8 dereferenceable(18) %4, i32 noundef 1) #19
...
bb.ag:                                            ; preds = %.loopexit239
  %i.eo = icmp ne i32 %.3214, 10
  %or.cond11.not = or i1 %i.eo, %.0
...
bb.aj:                                            ; preds = %bb.ag
  %i.gl = icmp eq i32 %.3214, 10
  %or.cond13 = or i1 %i.gl, %.0
  br i1 %or.cond13, label %.thread226, label %bb.bo

.thread226:                                       ; preds = %bb.ah, %bb.aj
  %i.gm = trunc nuw i8 %.3210 to i1
...
bb.at:                                            ; preds = %_ZN6hermes6parser7JSLexer10errorRangeEN4llvh5SMLocERKNS2_5TwineE.exit149.thread, %"_ZZN6hermes6parser7JSLexer10scanNumberENS1_14GrammarContextEENK3$_1clEv.exit.thread", %_ZN6hermes6parser7JSLexer10errorRangeEN4llvh5SMLocERKNS2_5TwineE.exit144.thread, %"_ZZN6hermes6parser7JSLexer10scanNumberENS1_14GrammarContextEENK3$_1clEv.exit", %.thread226
  %.4215 = phi i32 [ %.3214, %_ZN6hermes6parser7JSLexer10errorRangeEN4llvh5SMLocERKNS2_5TwineE.exit144.thread ], [ 10, %"_ZZN6hermes6parser7JSLexer10scanNumberENS1_14GrammarContextEENK3$_1clEv.exit" ], [ %.3214, %_ZN6hermes6parser7JSLexer10errorRangeEN4llvh5SMLocERKNS2_5TwineE.exit149.thread ], [ %.3214, %.thread226 ], [ 10, %"_ZZN6hermes6parser7JSLexer10scanNumberENS1_14GrammarContextEENK3$_1clEv.exit.thread" ]
...
"_ZZN6hermes6parser7JSLexer10scanNumberENS1_14GrammarContextEENK3$_1clEv.exit170": ; preds = %.lr.ph.i165, %.lr.ph.i165, %bb.bw, %bb.bv
  %.7 = phi i32 [ 10, %bb.bv ], [ %.3214, %bb.bw ], [ %.3214, %.lr.ph.i165 ], [ %.3214, %.lr.ph.i165 ] ; 2 uses
...
.thread237:                                       ; preds = %.thread236.a, %"_ZZN6hermes6parser7JSLexer10scanNumberENS1_14GrammarContextEENK3$_1clEv.exit170", %bb.bx
  %.5216 = phi i32 [ %.7, %bb.bx ], [ %.7, %"_ZZN6hermes6parser7JSLexer10scanNumberENS1_14GrammarContextEENK3$_1clEv.exit170" ], [ %.3214, %.thread236.a ]
