Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/hermes/original/SourceErrorManager?download=true
...
bb.j:                                             ; preds = %bb.i
  ...
  %4 = getelementptr inbounds nuw i8, ptr %0, i64 160 ; 2 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %4, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.7, i64 16, i1 false), !tbaa.struct !179
  %i.bk = add i32 %i.bi, 1
  %i.bl = call { ptr, i64 } @_ZNK4llvh9SourceMgr10getLineRefEjj(ptr noundef nonnull align 8 dereferenceable(120) %0, i32 noundef %i.bk, i32 noundef %i.bg) #24 ; 2 uses
  %i.bm = extractvalue { ptr, i64 } %i.bl, 0
  %i.bn = extractvalue { ptr, i64 } %i.bl, 1
  %i.bo = getelementptr inbounds nuw i8, ptr %0, i64 176
  store ptr %i.bm, ptr %i.bo, align 8, !tbaa !134
  %.sroa.4.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 184
  store i64 %i.bn, ptr %.sroa.4.0..sroa_idx, align 8, !tbaa !89
  %i.bp = load ptr, ptr %4, align 8, !tbaa !165   ; 4 uses
  %i.bq = load i8, ptr %1, align 1, !tbaa !118    ; 2 uses
  %i.br = icmp eq i8 %i.bq, 13
  %i.bs = icmp slt i8 %i.bq, -64
  %or.cond.i.i28 = or i1 %i.br, %i.bs
...
.critedge.preheader.i.i30:                        ; preds = %bb.j
  ...
  %i.bu = ptrtoaddr ptr %1 to i64
  %i.bv = sub i64 %i.bt, %i.bu
  %scevgep.i.i31 = getelementptr i8, ptr %1, i64 %i.bv ; 2 uses
  %i.bw = icmp eq ptr %1, %i.bp
  br i1 %i.bw, label %_ZN6hermes18SourceErrorManager13FindLineCache10fillCoordsEN4llvh5SMLocERNS0_12SourceCoordsE.exit35, label %.lr.ph53, !prof !199

.critedge.i.i32:                                  ; preds = %.lr.ph53
  %i.bx = icmp eq ptr %i.by, %i.bp
  br i1 %i.bx, label %_ZN6hermes18SourceErrorManager13FindLineCache10fillCoordsEN4llvh5SMLocERNS0_12SourceCoordsE.exit35, label %.lr.ph53, !prof !200, !llvm.loop !201

.lr.ph53:                                         ; preds = %.critedge.preheader.i.i30, %.critedge.i.i32
  %.0.i.i3352 = phi ptr [ %i.by, %.critedge.i.i32 ], [ %1, %.critedge.preheader.i.i30 ]
  %i.by = getelementptr inbounds i8, ptr %.0.i.i3352, i64 -1 ; 4 uses
  %i.bz = load i8, ptr %i.by, align 1, !tbaa !118 ; 2 uses
  %i.ca = icmp eq i8 %i.bz, 13
  %i.cb = icmp slt i8 %i.bz, -64
  %or.cond8.i.i34 = or i1 %i.ca, %i.cb
...
_ZN6hermes18SourceErrorManager13FindLineCache10fillCoordsEN4llvh5SMLocERNS0_12SourceCoordsE.exit35: ; preds = %.critedge.i.i32, %.critedge.preheader.i.i30, %._ZN6hermes18SourceErrorManager13FindLineCache10fillCoordsEN4llvh5SMLocERNS0_12SourceCoordsE.exit35.loopexit_crit_edge, %bb.j
  %.1.i.i29 = phi ptr [ %1, %bb.j ], [ %scevgep.i.i31, %.critedge.preheader.i.i30 ], [ %i.by, %._ZN6hermes18SourceErrorManager13FindLineCache10fillCoordsEN4llvh5SMLocERNS0_12SourceCoordsE.exit35.loopexit_crit_edge ], [ %scevgep.i.i31, %.critedge.i.i32 ]
  %i.cc = load <2 x i32>, ptr %i.a, align 8, !tbaa !3
  store <2 x i32> %i.cc, ptr %2, align 4, !tbaa !3
  %i.cd = ptrtoint ptr %.1.i.i29 to i64
  %i.ce = ptrtoint ptr %i.bp to i64
  %i.cf = sub i64 %i.cd, %i.ce
  %i.cg = trunc i64 %i.cf to i32
  %i.ch = add i32 %i.cg, 1
  %i.ci = getelementptr inbounds nuw i8, ptr %2, i64 8
  store i32 %i.ch, ptr %i.ci, align 4, !tbaa !186
  br label %5

5:                                                ; preds = %_ZN6hermes18SourceErrorManager13FindLineCache10fillCoordsEN4llvh5SMLocERNS0_12SourceCoordsE.exit35, %_ZNK6hermes18SourceErrorManager17findBufferAndLineEN4llvh5SMLocE.exit
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.7)
  br label %bb.k

bb.k:                                             ; preds = %5, %_ZN6hermes18SourceErrorManager13FindLineCache10fillCoordsEN4llvh5SMLocERNS0_12SourceCoordsE.exit26, %_ZN6hermes18SourceErrorManager13FindLineCache10fillCoordsEN4llvh5SMLocERNS0_12SourceCoordsE.exit, %bb.b
  %.1 = phi i1 [ true, %_ZN6hermes18SourceErrorManager13FindLineCache10fillCoordsEN4llvh5SMLocERNS0_12SourceCoordsE.exit ], [ true, %_ZN6hermes18SourceErrorManager13FindLineCache10fillCoordsEN4llvh5SMLocERNS0_12SourceCoordsE.exit26 ], [ %.not.i27, %5 ], [ false, %bb.b ]
  ret i1 %.1
}
