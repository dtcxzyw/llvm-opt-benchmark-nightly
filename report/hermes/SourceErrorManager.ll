...
begin_hunk_1_@_ZN6hermes18SourceErrorManager23buildSourceAndCaretLineB5cxx11ERKN4llvh12SMDiagnosticENS_24SourceErrorOutputOptionsE:bb.a
  ...
  br i1 %i.an, label %bb.j, label %_ZNSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE9_M_createERmm.exit.i

bb.j:                                             ; preds = %bb.i
  %i.ao = shl nuw nsw i64 %i.al, 1                ; 2 uses
  %i.ap = icmp samesign ult i64 %i.ae, %i.ao
  br i1 %i.ap, label %bb.k, label %_ZNSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE9_M_createERmm.exit.i

bb.k:                                             ; preds = %bb.j
  %spec.store.select.i.i = call i64 @llvm.umin.i64(i64 %i.ao, i64 1152921504606846975)
  br label %_ZNSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE9_M_createERmm.exit.i

_ZNSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE9_M_createERmm.exit.i: ; preds = %bb.k, %bb.j, %bb.i
  %.0.i113 = phi i64 [ %spec.store.select.i.i, %bb.k ], [ %i.ae, %bb.j ], [ %i.ae, %bb.i ] ; 2 uses
  %i.aq = shl nuw nsw i64 %.0.i113, 2
  %i.ar = add nuw nsw i64 %i.aq, 4
  %i.as = call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.ar) #23 ; 4 uses
  switch i64 %i.ad, label %bb.m [
    i64 0, label %_ZNSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE7_S_copyEPDiPKDim.exit27.i
    i64 1, label %bb.l
  ]

bb.l:                                             ; preds = %_ZNSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE9_M_createERmm.exit.i
  %i.at = load i32, ptr %i.af, align 4, !tbaa !236
  store i32 %i.at, ptr %i.as, align 4, !tbaa !236
  br label %_ZNSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE7_S_copyEPDiPKDim.exit27.i

bb.m:                                             ; preds = %_ZNSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE9_M_createERmm.exit.i
  %i.au = shl nuw nsw i64 %i.ad, 2
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %i.as, ptr align 4 %i.af, i64 %i.au, i1 false)
  br label %_ZNSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE7_S_copyEPDiPKDim.exit27.i

_ZNSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE7_S_copyEPDiPKDim.exit27.i: ; preds = %_ZNSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE9_M_createERmm.exit.i, %bb.l, %bb.m
  br i1 %i.ag, label %_ZNKSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE11_M_is_localEv.exit.thread.i29.i, label %_ZNKSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE11_M_is_localEv.exit.i28.i

_ZNKSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE11_M_is_localEv.exit.thread.i29.i: ; preds = %_ZNSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE7_S_copyEPDiPKDim.exit27.i
  %i.av = icmp samesign ult i64 %i.ad, 4
  call void @llvm.assume(i1 %i.av)
  br label %_ZNSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE9_M_mutateEmmPKDim.exit

_ZNKSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE11_M_is_localEv.exit.i28.i: ; preds = %_ZNSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE7_S_copyEPDiPKDim.exit27.i
  %i.aw = load i64, ptr %i.e, align 8, !tbaa !118
  %i.ax = shl i64 %i.aw, 2
  %i.ay = add i64 %i.ax, 4
  call void @_ZdlPvm(ptr noundef %i.af, i64 noundef %i.ay) #25
  br label %_ZNSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE9_M_mutateEmmPKDim.exit

_ZNSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE9_M_mutateEmmPKDim.exit: ; preds = %_ZNKSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE11_M_is_localEv.exit.thread.i29.i, %_ZNKSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE11_M_is_localEv.exit.i28.i
  store ptr %i.as, ptr %4, align 8, !tbaa !246
  store i64 %.0.i113, ptr %i.e, align 8, !tbaa !118
...
_ZNSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE9push_backEDi.exit: ; preds = %_ZNKSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE8capacityEv.exit.i.thread, %_ZNKSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE8capacityEv.exit.i, %_ZNSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE9_M_mutateEmmPKDim.exit
  %i.az = phi ptr [ %i.as, %_ZNSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE9_M_mutateEmmPKDim.exit ], [ %i.af, %_ZNKSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE8capacityEv.exit.i ], [ %i.af, %_ZNKSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE8capacityEv.exit.i.thread ] ; 2 uses
  %i.ba = getelementptr inbounds nuw [4 x i8], ptr %i.az, i64 %i.ad
  store i32 %.0.i, ptr %i.ba, align 4, !tbaa !236
  store i64 %i.ae, ptr %i.f, align 8, !tbaa !234
  %i.bb = getelementptr inbounds nuw [4 x i8], ptr %i.az, i64 %i.ae
  store i32 0, ptr %i.bb, align 4, !tbaa !236
  %i.bc = load ptr, ptr %i.b, align 8, !tbaa !134 ; 4 uses
  %i.bd = icmp ult ptr %i.y, %i.bc
  br i1 %i.bd, label %.lr.ph, label %.loopexit190
...
.lr.ph:                                           ; preds = %_ZNSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE9push_backEDi.exit, %_ZNSt6vectorIjSaIjEE9push_backEOj.exit
  %.pre256260 = phi ptr [ %.pre256261, %_ZNSt6vectorIjSaIjEE9push_backEOj.exit ], [ %i.bc, %_ZNSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE9push_backEDi.exit ] ; 2 uses
  %i.be = phi ptr [ %i.bx, %_ZNSt6vectorIjSaIjEE9push_backEOj.exit ], [ %i.bc, %_ZNSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE9push_backEDi.exit ]
  %.0209 = phi ptr [ %i.bf, %_ZNSt6vectorIjSaIjEE9push_backEOj.exit ], [ %i.y, %_ZNSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE9push_backEDi.exit ]
  %.sroa.0.1208 = phi ptr [ %.sroa.0.2, %_ZNSt6vectorIjSaIjEE9push_backEOj.exit ], [ %.sroa.0.0215, %_ZNSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE9push_backEDi.exit ] ; 5 uses
...
.lr.ph.i.i.i.i.i.preheader:                       ; preds = %_ZNKSt6vectorISt4pairIjjESaIS1_EE12_M_check_lenEmPKc.exit.i.i
  ...
  %min.iters.check = icmp ult i64 %i.ea, 24
  %i.ed = sub i64 %i.dm, %i.dy
  %diff.check = icmp ugt i64 %i.ed, -32
  %or.cond = or i1 %min.iters.check, %diff.check
  br i1 %or.cond, label %.lr.ph.i.i.i.i.i.preheader347, label %vector.ph

vector.ph:                                        ; preds = %.lr.ph.i.i.i.i.i.preheader
  %n.vec = and i64 %i.ec, 4611686018427387900     ; 3 uses
  %i.ee = shl i64 %n.vec, 3                       ; 2 uses
  %i.ef = getelementptr i8, ptr %i.dv, i64 %i.ee  ; 2 uses
  %i.eg = getelementptr i8, ptr %.sroa.0159.0223, i64 %i.ee
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.eh = shl i64 %index, 3                       ; 2 uses
  %next.gep = getelementptr i8, ptr %i.dv, i64 %i.eh ; 2 uses
  %next.gep339 = getelementptr i8, ptr %.sroa.0159.0223, i64 %i.eh ; 2 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !253)
  call void @llvm.experimental.noalias.scope.decl(metadata !256)
  %i.ei = getelementptr i8, ptr %next.gep339, i64 16
  %wide.load = load <2 x i64>, ptr %next.gep339, align 4, !alias.scope !256, !noalias !253
  %wide.load340 = load <2 x i64>, ptr %i.ei, align 4, !alias.scope !256, !noalias !253
  %i.ej = getelementptr i8, ptr %next.gep, i64 16
  store <2 x i64> %wide.load, ptr %next.gep, align 4, !alias.scope !253, !noalias !256
  store <2 x i64> %wide.load340, ptr %i.ej, align 4, !alias.scope !253, !noalias !256
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ek = icmp eq i64 %index.next, %n.vec
  br i1 %i.ek, label %middle.block, label %vector.body, !llvm.loop !258
...
.lr.ph.i.i.i.i.i.preheader347:                    ; preds = %.lr.ph.i.i.i.i.i.preheader, %middle.block
  %.012.i.i.i.i.i.ph = phi ptr [ %i.dv, %.lr.ph.i.i.i.i.i.preheader ], [ %i.ef, %middle.block ]
  %.0911.i.i.i.i.i.ph = phi ptr [ %.sroa.0159.0223, %.lr.ph.i.i.i.i.i.preheader ], [ %i.eg, %middle.block ]
  br label %.lr.ph.i.i.i.i.i

.lr.ph.i.i.i.i.i:                                 ; preds = %.lr.ph.i.i.i.i.i.preheader347, %.lr.ph.i.i.i.i.i
  %.012.i.i.i.i.i = phi ptr [ %i.en, %.lr.ph.i.i.i.i.i ], [ %.012.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.preheader347 ] ; 2 uses
  %.0911.i.i.i.i.i = phi ptr [ %i.em, %.lr.ph.i.i.i.i.i ], [ %.0911.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.preheader347 ] ; 2 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !253)
  call void @llvm.experimental.noalias.scope.decl(metadata !256)
  %i.el = load i64, ptr %.0911.i.i.i.i.i, align 4, !alias.scope !256, !noalias !253
  store i64 %i.el, ptr %.012.i.i.i.i.i, align 4, !alias.scope !253, !noalias !256
  %i.em = getelementptr inbounds nuw i8, ptr %.0911.i.i.i.i.i, i64 8 ; 2 uses
  %i.en = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i.i, i64 8 ; 2 uses
  %.not.i.i.i.i.i = icmp eq ptr %i.em, %.sroa.8.0222
...
_ZNSt6vectorISt4pairIjjESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit23.i.i: ; preds = %.lr.ph.i.i.i.i.i, %middle.block, %_ZNKSt6vectorISt4pairIjjESaIS1_EE12_M_check_lenEmPKc.exit.i.i
  %.0.lcssa.i.i.i.i.i = phi ptr [ %i.dv, %_ZNKSt6vectorISt4pairIjjESaIS1_EE12_M_check_lenEmPKc.exit.i.i ], [ %i.ef, %middle.block ], [ %i.en, %.lr.ph.i.i.i.i.i ]
...
_ZNSt6vectorISt4pairIjjESaIS1_EE17_M_realloc_insertIJjjEEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i: ; preds = %bb.aa, %_ZNSt6vectorISt4pairIjjESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit23.i.i
  %i.eo = getelementptr inbounds nuw [8 x i8], ptr %i.dv, i64 %i.dt
  br label %_ZNSt6vectorISt4pairIjjESaIS1_EE12emplace_backIJjjEEERS1_DpOT_.exit
...
_ZNSt6vectorISt4pairIjjESaIS1_EE12emplace_backIJjjEEERS1_DpOT_.exit: ; preds = %bb.x, %_ZNSt6vectorISt4pairIjjESaIS1_EE17_M_realloc_insertIJjjEEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i
  %.sroa.13.1 = phi ptr [ %i.eo, %_ZNSt6vectorISt4pairIjjESaIS1_EE17_M_realloc_insertIJjjEEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i ], [ %.sroa.13.0221, %bb.x ] ; 2 uses
  ...
  %i.ep = getelementptr inbounds nuw i8, ptr %.052224, i64 8 ; 2 uses
  %.not62 = icmp eq ptr %i.ep, %i.cr
...
._crit_edge234:                                   ; preds = %_ZSt4fillIPccEvT_S1_RKT0_.exit, %._crit_edge226
  ...
  %i.eq = load ptr, ptr %6, align 8, !tbaa !90
  %i.er = getelementptr inbounds nuw i8, ptr %i.eq, i64 %.sroa.speculated137
  store i8 94, ptr %i.er, align 1, !tbaa !118
  %i.es = call noundef i64 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE16find_last_not_ofEcm(ptr noundef nonnull align 8 dereferenceable(32) %6, i8 noundef signext 32, i64 noundef -1) #24
  %i.et = add i64 %i.es, 1                        ; 4 uses
  %i.eu = getelementptr inbounds nuw i8, ptr %6, i64 8 ; 8 uses
  %i.ev = load i64, ptr %i.eu, align 8, !tbaa !93 ; 2 uses
  %i.ew = icmp ugt i64 %i.et, %i.ev
  br i1 %i.ew, label %bb.ab, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5eraseEmm.exit

bb.ab:                                            ; preds = %._crit_edge234
  call void (ptr, ...) @_ZSt24__throw_out_of_range_fmtPKcz(ptr noundef nonnull @.str.20, ptr noundef nonnull @.str.19, i64 noundef %i.et, i64 noundef %i.ev) #22
  unreachable

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5eraseEmm.exit: ; preds = %._crit_edge234
  store i64 %i.et, ptr %i.eu, align 8, !tbaa !93
  %i.ex = load ptr, ptr %6, align 8, !tbaa !90
  %i.ey = getelementptr inbounds nuw i8, ptr %i.ex, i64 %i.et
  store i8 0, ptr %i.ey, align 1, !tbaa !118
  %i.ez = load i64, ptr %i.f, align 8, !tbaa !234 ; 4 uses
  %.not187 = icmp eq i64 %i.ez, 0
  br i1 %.not187, label %.preheader, label %bb.ac

bb.ac:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5eraseEmm.exit
  %i.fa = load ptr, ptr %4, align 8, !tbaa !246   ; 3 uses
  br label %.lr.ph.i.i

.lr.ph.i.i:                                       ; preds = %bb.ad, %bb.ac
  %.0915.i.i = phi i64 [ %i.fe, %bb.ad ], [ 0, %bb.ac ] ; 3 uses
  %i.fb = getelementptr inbounds nuw [4 x i8], ptr %i.fa, i64 %.0915.i.i
  %i.fc = load i32, ptr %i.fb, align 4, !tbaa !236
  %i.fd = icmp eq i32 %i.fc, 9
  br i1 %i.fd, label %_ZNKSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE4findEDim.exit.split.loop.exit, label %bb.ad

bb.ad:                                            ; preds = %.lr.ph.i.i
  %i.fe = add nuw i64 %.0915.i.i, 1               ; 2 uses
  %exitcond.not.i.i = icmp eq i64 %i.fe, %i.ez
...
_ZNKSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE4findEDim.exit.split.loop.exit: ; preds = %.lr.ph.i.i
  %i.ff = getelementptr inbounds nuw [4 x i8], ptr %i.fa, i64 %.0915.i.i
...
_ZNKSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE4findEDim.exit: ; preds = %bb.ad, %_ZNKSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE4findEDim.exit.split.loop.exit
  %i.fg = phi ptr [ %i.ff, %_ZNKSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE4findEDim.exit.split.loop.exit ], [ null, %bb.ad ] ; 2 uses
  %.not.i77 = icmp eq ptr %i.fg, null
  %i.fh = ptrtoint ptr %i.fg to i64
  %i.fi = ptrtoint ptr %i.fa to i64
  %i.fj = sub i64 %i.fh, %i.fi
  %i.fk = ashr exact i64 %i.fj, 2
  %.0.i78 = select i1 %.not.i77, i64 -1, i64 %i.fk ; 2 uses
  %i.fl = icmp ult i64 %.0.i78, %i.ez
  br i1 %i.fl, label %.lr.ph240, label %.preheader

bb.ae:                                            ; preds = %.lr.ph233, %_ZSt4fillIPccEvT_S1_RKT0_.exit
  %.sroa.0149.0231 = phi ptr [ %.sroa.0159.0.lcssa, %.lr.ph233 ], [ %i.fv, %_ZSt4fillIPccEvT_S1_RKT0_.exit ] ; 3 uses
  %i.fm = load i32, ptr %.sroa.0149.0231, align 4, !tbaa !250 ; 2 uses
  %i.fn = zext i32 %i.fm to i64                   ; 3 uses
  %i.fo = load i64, ptr %i.cw, align 8, !tbaa !93 ; 2 uses
  %i.fp = icmp ugt i64 %i.fo, %i.fn
  br i1 %i.fp, label %bb.af, label %_ZSt4fillIPccEvT_S1_RKT0_.exit

bb.af:                                            ; preds = %bb.ae
  %i.fq = getelementptr inbounds nuw i8, ptr %.sroa.0149.0231, i64 4
  %i.fr = load i32, ptr %i.fq, align 4, !tbaa !252 ; 2 uses
  %.not.i.i.i80 = icmp eq i32 %i.fr, %i.fm
  br i1 %.not.i.i.i80, label %_ZSt4fillIPccEvT_S1_RKT0_.exit, label %bb.ag

bb.ag:                                            ; preds = %bb.af
  %i.fs = zext i32 %i.fr to i64
  %.sroa.speculated143 = call i64 @llvm.umin.i64(i64 %i.fo, i64 %i.fs)
  %i.ft = load ptr, ptr %6, align 8, !tbaa !90
  %i.fu = getelementptr inbounds nuw i8, ptr %i.ft, i64 %i.fn
  %gepdiff = sub nsw i64 %.sroa.speculated143, %i.fn
  call void @llvm.memset.p0.i64(ptr nonnull align 1 %i.fu, i8 126, i64 %gepdiff, i1 false)
  br label %_ZSt4fillIPccEvT_S1_RKT0_.exit

_ZSt4fillIPccEvT_S1_RKT0_.exit:                   ; preds = %bb.ag, %bb.af, %bb.ae
  %i.fv = getelementptr inbounds nuw i8, ptr %.sroa.0149.0231, i64 8 ; 2 uses
  %.not186 = icmp eq ptr %i.fv, %.sroa.8.0.lcssa
...
.preheader:                                       ; preds = %bb.ah, %_ZNKSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE4findEDim.exit89, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5eraseEmm.exit, %_ZNKSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE4findEDim.exit
  %.lcssa192 = phi i64 [ %i.ez, %_ZNKSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE4findEDim.exit ], [ 0, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5eraseEmm.exit ], [ %i.gg, %_ZNKSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE4findEDim.exit89 ], [ %i.gg, %bb.ah ]
...
.lr.ph240:                                        ; preds = %_ZNKSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE4findEDim.exit, %_ZNKSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE4findEDim.exit89
  ...
  %i.fw = and i64 %.053239, 7
  %i.fx = sub nuw nsw i64 8, %i.fw                ; 3 uses
  %i.fy = call noundef nonnull align 8 dereferenceable(32) ptr @_ZNSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE7replaceEmmmDi(ptr noundef nonnull align 8 dereferenceable(32) %4, i64 noundef %.053239, i64 noundef 1, i64 noundef %i.fx, i32 noundef zeroext 32) ; 0 uses
  %i.fz = load i64, ptr %i.eu, align 8, !tbaa !93
  %i.ga = icmp ult i64 %.053239, %i.fz
  br i1 %i.ga, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7replaceEmmmc.exit, label %bb.ah

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7replaceEmmmc.exit: ; preds = %.lr.ph240
  %i.gb = load ptr, ptr %6, align 8, !tbaa !90
  %i.gc = getelementptr inbounds nuw i8, ptr %i.gb, i64 %.053239
  %i.gd = load i8, ptr %i.gc, align 1, !tbaa !118
  %i.ge = call noundef nonnull align 8 dereferenceable(32) ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE14_M_replace_auxEmmmc(ptr noundef nonnull align 8 dereferenceable(32) %6, i64 noundef %.053239, i64 noundef 1, i64 noundef %i.fx, i8 noundef signext %i.gd) #24 ; 0 uses
  br label %bb.ah

bb.ah:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7replaceEmmmc.exit, %.lr.ph240
  %i.gf = add nsw i64 %i.fx, %.053239             ; 3 uses
  %i.gg = load i64, ptr %i.f, align 8, !tbaa !234 ; 5 uses
  %i.gh = icmp ult i64 %i.gf, %i.gg
  br i1 %i.gh, label %bb.ai, label %.preheader

bb.ai:                                            ; preds = %bb.ah
  %i.gi = load ptr, ptr %4, align 8, !tbaa !246   ; 2 uses
  %i.gj = sub nuw i64 %i.gg, %i.gf
  %i.gk = getelementptr inbounds nuw [4 x i8], ptr %i.gi, i64 %i.gf ; 2 uses
  br label %.lr.ph.i.i82

.lr.ph.i.i82:                                     ; preds = %bb.aj, %bb.ai
  %.0915.i.i83 = phi i64 [ %i.go, %bb.aj ], [ 0, %bb.ai ] ; 3 uses
  %i.gl = getelementptr inbounds nuw [4 x i8], ptr %i.gk, i64 %.0915.i.i83
  %i.gm = load i32, ptr %i.gl, align 4, !tbaa !236
  %i.gn = icmp eq i32 %i.gm, 9
  br i1 %i.gn, label %_ZNKSt7__cxx1112basic_stringIDiSt11char_traitsIDiESaIDiEE4findEDim.exit89.split.loop.exit, label %bb.aj
