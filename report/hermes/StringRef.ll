...
._crit_edge:                                      ; preds = %bb.b
  %.pre = tail call noundef nonnull align 1 ptr @_ZN4llvh11APFloatBase15PPCDoubleDoubleEv() #23, !inline_history !67
  br label %bb.d
...
bb.e:                                             ; preds = %bb.d
  call void @_ZN4llvh6detail9IEEEFloatD1Ev(ptr noundef nonnull align 8 dereferenceable(24) %i.a) #20, !inline_history !70
  br label %_ZN4llvh7APFloatD2Ev.exit

bb.f:                                             ; preds = %bb.d
  call void @_ZN4llvh6detail13DoubleAPFloatD2Ev(ptr noundef nonnull align 8 dereferenceable(24) %i.a) #20, !inline_history !70
  br label %_ZN4llvh7APFloatD2Ev.exit
...
bb.d:                                             ; preds = %bb.c
  tail call void @_ZN4llvh6detail9IEEEFloatD1Ev(ptr noundef nonnull align 8 dereferenceable(24) %i.j) #20, !inline_history !73
  br label %_ZN4llvh7APFloatD2Ev.exit.i

bb.e:                                             ; preds = %bb.c
  tail call void @_ZN4llvh6detail13DoubleAPFloatD2Ev(ptr noundef nonnull align 8 dereferenceable(24) %i.j) #20, !inline_history !73
  br label %_ZN4llvh7APFloatD2Ev.exit.i
...
_ZNKSt14default_deleteIA_N4llvh7APFloatEEclIS1_EENSt9enable_ifIXsr14is_convertibleIPA_T_PS2_EE5valueEvE4typeEPS6_.exit: ; preds = %_ZN4llvh7APFloatD2Ev.exit.i, %bb.b
  ...
  tail call void @_ZdaPvm(ptr noundef nonnull %i.c, i64 noundef %i.m) #22, !inline_history !74
...
bb.a:
  ...
  br i1 %i.b, label %bb.b, label %_ZN4llvh7hashing6detail18get_execution_seedEv.exit, !prof !75
...
begin_hunk_7_@_ZN4llvh7hashing6detail23hash_combine_range_implIKcEENSt9enable_ifIXsr16is_hashable_dataIT_EE5valueENS_9hash_codeEE4typeEPS5_S9_:bb.a
  ...
  %.0.copyload.i.i.i = load i64, ptr %i.al, align 1, !noalias !76 ; 2 uses
  ...
  %.0.copyload.i7.i.i = load i64, ptr %i.aq, align 1, !noalias !76 ; 2 uses
  ...
  %.0.copyload.i8.i.i = load i64, ptr %i.av, align 1, !noalias !76 ; 2 uses
...
begin_hunk_8_@_ZN4llvh7hashing6detail23hash_combine_range_implIKcEENSt9enable_ifIXsr16is_hashable_dataIT_EE5valueENS_9hash_codeEE4typeEPS5_S9_:bb.a
  ...
  %.0.copyload.i15.i.i.i = load i64, ptr %i.be, align 1, !noalias !76 ; 2 uses
  ...
  %.0.copyload.i17.i.i.i = load i64, ptr %i.bi, align 1, !noalias !76 ; 2 uses
...
begin_hunk_9_@_ZN4llvh7hashing6detail23hash_combine_range_implIKcEENSt9enable_ifIXsr16is_hashable_dataIT_EE5valueENS_9hash_codeEE4typeEPS5_S9_:bb.a
  ...
  %.0.copyload.i.i10.i.i = load i64, ptr %i.br, align 1, !noalias !76
  %i.bs = add i64 %i.bp, %.0.copyload.i.i10.i.i   ; 3 uses
  %i.bt = getelementptr inbounds nuw i8, ptr %0, i64 56
  %.0.copyload.i15.i11.i.i = load i64, ptr %i.bt, align 1, !noalias !76 ; 2 uses
...
!71 = !{!72, !72, i64 0}
!72 = !{!"p1 _ZTSN4llvh7APFloatE", !10, i64 0}
!73 = distinct !{null, null, null, null}
!74 = distinct !{null, null}
!75 = !{!"branch_weights", i32 1, i32 1048575}
!76 = !{!77}
!77 = distinct !{!77, !78, !"_ZN4llvh7hashing6detail10hash_state6createEPKcm: argument 0"}
