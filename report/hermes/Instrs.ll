...
begin_hunk_3_@_ZNSt3_V28__rotateIPcEET_S2_S2_S2_St26random_access_iterator_tag:bb.a
  store <16 x i8> %wide.load137, ptr %i.bc, align 1, !tbaa !59, !alias.scope !97
...
vec.epilog.iter.check:                            ; preds = %middle.block
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph109.preheader229, label %vec.epilog.ph, !prof !89
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %5, label %middle.block.a, label %vec.epilog.vector.body, !llvm.loop !100
...
begin_hunk_4_@_ZNSt3_V28__rotateIPcEET_S2_S2_S2_St26random_access_iterator_tag:bb.a
  ...
  br i1 %prol.iter238.cmp.not, label %.lr.ph109.prol.loopexit, label %.lr.ph109.prol, !llvm.loop !101
...
begin_hunk_7_@_ZNSt3_V28__rotateIPcEET_S2_S2_S2_St26random_access_iterator_tag:bb.a
  %i.cj = load i8, ptr %i.ci, align 1, !tbaa !59
  %i.ck = add nsw i64 %.086, -1                   ; 2 uses
  %i.cl = icmp sgt i64 %.086, 2
  br i1 %i.cl, label %bb.k, label %bb.l, !prof !103

bb.k:                                             ; preds = %bb.j
  %i.cm = getelementptr inbounds nuw i8, ptr %.058, i64 1
end_hunk_7
begin_hunk_8_@_ZNSt3_V28__rotateIPcEET_S2_S2_S2_St26random_access_iterator_tag:bb.a
  ...
  %wide.load158 = load <16 x i8>, ptr %i.cw, align 1, !tbaa !59, !alias.scope !104, !noalias !107
  %i.cx = getelementptr inbounds i8, ptr %next.gep155, i64 -16 ; 2 uses
  %wide.load159 = load <16 x i8>, ptr %i.cx, align 1, !tbaa !59, !alias.scope !107
  store <16 x i8> %wide.load159, ptr %i.cw, align 1, !tbaa !59, !alias.scope !104, !noalias !107
  store <16 x i8> %wide.load158, ptr %i.cx, align 1, !tbaa !59, !alias.scope !107
  %index.next163 = add nuw i64 %index154, 16      ; 2 uses
  %i.cy = icmp eq i64 %index.next163, %n.vec152
  br i1 %i.cy, label %middle.block164, label %vector.body153, !llvm.loop !109
...
vec.epilog.iter.check.a:                          ; preds = %middle.block164
  ...
  br i1 %min.epilog.iters.check.not.not, label %.lr.ph.preheader, label %vec.epilog.ph.a, !prof !110
...
begin_hunk_10_@_ZNSt3_V28__rotateIPcEET_S2_S2_S2_St26random_access_iterator_tag:bb.a
  ...
  %wide.load173 = load <8 x i8>, ptr %i.df, align 1, !tbaa !59, !alias.scope !104, !noalias !107
  %i.dg = getelementptr inbounds i8, ptr %next.gep171, i64 -8 ; 2 uses
  %wide.load175 = load <8 x i8>, ptr %i.dg, align 1, !tbaa !59, !alias.scope !107
  store <8 x i8> %wide.load175, ptr %i.df, align 1, !tbaa !59, !alias.scope !104, !noalias !107
  store <8 x i8> %wide.load173, ptr %i.dg, align 1, !tbaa !59, !alias.scope !107
  %index.next179 = add nuw i64 %index170, 8       ; 2 uses
  %i.dh = icmp eq i64 %index.next179, %n.vec169
  br i1 %i.dh, label %vec.epilog.middle.block, label %vec.epilog.vector.body.a, !llvm.loop !111
...
end_hunk_12
begin_hunk_13_@_ZNSt3_V28__rotateIPcEET_S2_S2_S2_St26random_access_iterator_tag:bb.a
  store i8 %i.ee, ptr %i.ed, align 1, !tbaa !59
...
end_hunk_13
begin_hunk_14_@llvm.fshl.i64
!97 = !{!98}
!98 = distinct !{!98, !96}
!99 = distinct !{!99, !22, !87, !88}
!100 = distinct !{!100, !22, !87, !88}
!101 = distinct !{!101, !92}
!102 = distinct !{!102, !22, !87}
...
!110 = !{!"branch_weights", i32 8, i32 8}
!111 = distinct !{!111, !22, !87, !88}
!112 = distinct !{!112, !92}
!113 = distinct !{!113, !22}
!114 = distinct !{!114, !22, !87}
end_hunk_14
