...
begin_hunk_0_@_ZL10getFileAuxIN4llvh20WritableMemoryBufferEENS0_7ErrorOrISt10unique_ptrIT_St14default_deleteIS4_EEEERKNS0_5TwineElmmbb:bb.a
  ...
  call void %i.bb(ptr noundef nonnull align 8 dereferenceable(24) %i.ag) #22, !noalias !60, !inline_history !73
...
bb.q:                                             ; preds = %bb.r, %bb.p
  ...
  %i.br = call noundef i64 @pread(i32 noundef %i.h, ptr noundef %.0101.i, i64 noundef %.066100.i, i64 noundef %i.bq) #22, !noalias !60, !inline_history !74 ; 3 uses
...
begin_hunk_3_@_ZL10getFileAuxIN4llvh20WritableMemoryBufferEENS0_7ErrorOrISt10unique_ptrIT_St14default_deleteIS4_EEEERKNS0_5TwineElmmbb:bb.a
  ...
  call void %i.cf(ptr noundef nonnull align 8 dereferenceable(24) %i.bg) #22, !noalias !60, !inline_history !73
...
begin_hunk_4_@_ZL16getReadWriteFileRKN4llvh5TwineEmmm:bb.a
  ...
  store i64 %i.ay, ptr %0, align 8, !tbaa !77
...
begin_hunk_5_@_ZL16getReadWriteFileRKN4llvh5TwineEmmm:bb.a
  ...
  call void %i.bf(ptr noundef nonnull align 8 dereferenceable(24) %i.ab) #22, !inline_history !79
  br label %_ZNSt10unique_ptrIN4llvh24WriteThroughMemoryBufferESt14default_deleteIS1_EED2Ev.exit
...
begin_hunk_6_@_ZL15getOpenFileImplIN4llvh12MemoryBufferEENS0_7ErrorOrISt10unique_ptrIT_St14default_deleteIS4_EEEEiRKNS0_5TwineEmmlbb:bb.a
  ...
  call void %i.bn(ptr noundef nonnull align 8 dead_on_return(24) dereferenceable(24) %i.as) #22, !inline_history !80
...
bb.v:                                             ; preds = %bb.w, %bb.u
  ...
  %i.cc = call noundef i64 @pread(i32 noundef %1, ptr noundef %.0102, i64 noundef %.066101, i64 noundef %i.cb) #22, !inline_history !74 ; 3 uses
...
bb.w:                                             ; preds = %bb.v
  ...
  br i1 %i.ce, label %bb.v, label %_ZNKSt14default_deleteIN4llvh20WritableMemoryBufferEEclEPS1_.exit.i, !llvm.loop !75
...
begin_hunk_9_@_ZL15getOpenFileImplIN4llvh12MemoryBufferEENS0_7ErrorOrISt10unique_ptrIT_St14default_deleteIS4_EEEEiRKNS0_5TwineEmmlbb:bb.a
  ...
  call void %i.cq(ptr noundef nonnull align 8 dereferenceable(24) %i.bs) #22, !inline_history !81
...
bb.d:                                             ; preds = %bb.e, %_ZN4llvh15SmallVectorImplIcE7reserveEm.exit
  ...
  %i.m = call noundef i64 @read(i32 noundef %1, ptr noundef %i.k, i64 noundef 16384) #22, !inline_history !82 ; 3 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  br i1 %i.p, label %bb.d, label %bb.f, !llvm.loop !83
...
begin_hunk_11_@_ZL24getMemoryBufferForStreamiRKN4llvh5TwineE:bb.a
  ...
  br i1 %.not, label %bb.g, label %bb.b, !llvm.loop !84
...
bb.g:                                             ; preds = %_ZN4llvh3sys16RetryAfterSignalIiFliPvmEJiPclEEEDTclfp0_spfp1_EERKT_RKT0_DpRKT1_.exit
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #22, !noalias !85
  call void @_ZN4llvh20WritableMemoryBuffer21getNewUninitMemBufferEmRKNS_5TwineE(ptr dead_on_unwind nonnull writable sret(%"class.std::unique_ptr.4") align 8 %3, i64 noundef %i.y, ptr noundef nonnull align 8 dereferenceable(18) %2), !noalias !85
  %i.z = load ptr, ptr %3, align 8, !noalias !85  ; 3 uses
...
.thread.i:                                        ; preds = %bb.g
  ...
  %i.ac = load ptr, ptr %i.ab, align 8, !tbaa !7, !noalias !85
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %i.ac, ptr readonly align 1 %i.x, i64 %i.y, i1 false), !noalias !85
  %i.ad = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  %i.ae = load i8, ptr %i.ad, align 8, !alias.scope !85
  %i.af = and i8 %i.ae, -2
  store i8 %i.af, ptr %i.ad, align 8, !alias.scope !85
  store i64 %i.aa, ptr %0, align 8, !tbaa !45, !alias.scope !85
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.ai = load i8, ptr %i.ah, align 8, !alias.scope !85
  %i.aj = or i8 %i.ai, 1
  store i8 %i.aj, ptr %i.ah, align 8, !alias.scope !85
  store i32 12, ptr %0, align 8, !tbaa !3, !alias.scope !85
  %.sroa.21.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %0, i64 8
  store ptr %i.ag, ptr %.sroa.21.0..sroa_idx.i.i, align 8, !tbaa !43, !alias.scope !85
  br label %_ZL20getMemBufferCopyImplN4llvh9StringRefERKNS_5TwineE.exit

_ZL20getMemBufferCopyImplN4llvh9StringRefERKNS_5TwineE.exit: ; preds = %.thread.i, %bb.h
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #22, !noalias !85
  br label %bb.i
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i: ; preds = %bb.a
  ...
  %i.f = add i64 %i.e, 1
  tail call void @_ZdlPvm(ptr noundef %i.b, i64 noundef %i.f) #26, !inline_history !88
...
bb.b:                                             ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.i
  tail call void @free(ptr noundef %i.h) #22, !inline_history !88
...
bb.a:
  ...
  tail call void @_ZN4llvh3sys2fs18mapped_file_regionD1Ev(ptr noundef nonnull align 8 dead_on_return(20) dereferenceable(20) %i.a) #22, !inline_history !89
...
bb.a:
  ...
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 24
  tail call void @_ZN4llvh3sys2fs18mapped_file_regionD1Ev(ptr noundef nonnull align 8 dead_on_return(20) dereferenceable(20) %i.a) #22, !inline_history !90
  tail call void @_ZdlPv(ptr noundef nonnull %0) #22
  ret void
}
end_hunk_15
...
bb.a:
  ...
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 24
  tail call void @_ZN4llvh3sys2fs18mapped_file_regionD1Ev(ptr noundef nonnull align 8 dead_on_return(20) dereferenceable(20) %i.a) #22, !inline_history !91
  tail call void @_ZdlPv(ptr noundef nonnull %0) #22
  ret void
}
end_hunk_16
...
!77 = !{!78, !78, i64 0}
!78 = !{!"p1 _ZTSN4llvh24WriteThroughMemoryBufferE", !10, i64 0}
...
!84 = distinct !{!84, !76}
!85 = !{!86}
!86 = distinct !{!86, !87, !"_ZL20getMemBufferCopyImplN4llvh9StringRefERKNS_5TwineE: argument 0"}
!87 = distinct !{!87, !"_ZL20getMemBufferCopyImplN4llvh9StringRefERKNS_5TwineE"}
!88 = !{ptr @_ZN4llvh23SmallVectorMemoryBufferD2Ev}
!89 = !{ptr @_ZN12_GLOBAL__N_120MemoryBufferMMapFileIN4llvh24WriteThroughMemoryBufferEED2Ev}
!90 = !{ptr @_ZN12_GLOBAL__N_120MemoryBufferMMapFileIN4llvh20WritableMemoryBufferEED2Ev}
!91 = !{ptr @_ZN12_GLOBAL__N_120MemoryBufferMMapFileIN4llvh12MemoryBufferEED2Ev}
end_hunk_17
