...
bb.b:                                             ; preds = %.lr.ph
  %3 = load ptr, ptr %0, align 8, !tbaa !406      ; 2 uses
  %4 = load i32, ptr %i.d, align 8, !tbaa !405    ; 2 uses
  %5 = icmp ne i32 %4, 0
  tail call void @llvm.assume(i1 %5)
  %i.v = trunc i64 %i.u to i32
  %i.w = mul i32 %i.v, 37
  %i.x = add i32 %4, -1                           ; 2 uses
  %.02744.i.i = and i32 %i.x, %i.w                ; 2 uses
  %i.y = zext i32 %.02744.i.i to i64
  %i.z = getelementptr inbounds nuw [40 x i8], ptr %3, i64 %i.y ; 3 uses
...
begin_hunk_1_@_ZN4llvh12DenseMapBaseINS_8DenseMapImNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEENS_12DenseMapInfoImEENS_6detail12DenseMapPairImS7_EEEEmS7_S9_SC_E18moveFromOldBucketsEPSC_SF_:bb.a
  ...
  %i.al = getelementptr inbounds nuw [40 x i8], ptr %3, i64 %i.ak ; 3 uses
...
_ZN4llvh12DenseMapBaseINS_8DenseMapImNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEENS_12DenseMapInfoImEENS_6detail12DenseMapPairImS7_EEEEmS7_S9_SC_E15LookupBucketForImEEbRKT_RPSC_.exit: ; preds = %bb.d, %bb.b, %bb.c
  %.sink.i.i = phi ptr [ %i.af, %bb.c ], [ %i.z, %bb.b ], [ %i.al, %bb.d ] ; 4 uses
...
.lr.ph:                                           ; preds = %_ZNSt10_HashtableINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES5_SaIS5_ENSt8__detail9_IdentityESt8equal_toIS5_ESt4hashIS5_ENS7_18_Mod_range_hashingENS7_20_Default_ranged_hashENS7_20_Prime_rehash_policyENS7_17_Hashtable_traitsILb1ELb1ELb1EEEE19_M_allocate_bucketsEm.exit, %bb.j
  ...
  %i.i = load ptr, ptr %.031, align 8, !tbaa !413 ; 2 uses
...
bb.g:                                             ; preds = %.lr.ph
  ...
  store ptr %i.o, ptr %.031, align 8, !tbaa !413
  store ptr %.031, ptr %i.g, align 8, !tbaa !412
  store ptr %i.g, ptr %i.m, align 8, !tbaa !441
  %i.p = load ptr, ptr %.031, align 8, !tbaa !413
  %.not28 = icmp eq ptr %i.p, null
  br i1 %.not28, label %bb.j, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.q = getelementptr inbounds nuw [8 x i8], ptr %.0.i, i64 %.02530
  store ptr %.031, ptr %i.q, align 8, !tbaa !441
  br label %bb.j

bb.i:                                             ; preds = %.lr.ph
  %i.r = load ptr, ptr %i.n, align 8, !tbaa !413
  store ptr %i.r, ptr %.031, align 8, !tbaa !413
  %i.s = load ptr, ptr %i.m, align 8, !tbaa !441
  store ptr %.031, ptr %i.s, align 8, !tbaa !413
  br label %bb.j
