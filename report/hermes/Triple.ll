...
switch.lookup:                                    ; preds = %bb.a
  ...
  %switch.gep1 = getelementptr inbounds nuw [8 x i8], ptr @switch.table._ZN4llvh6Triple17getArchTypePrefixENS0_8ArchTypeE.3, i64 %i.c
  %switch.load2 = load i64, ptr %switch.gep1, align 8
  br label %bb.b

bb.b:                                             ; preds = %switch.lookup, %bb.a
  %.sroa.0.0 = phi ptr [ null, %bb.a ], [ %switch.load, %switch.lookup ]
  %.sroa.30.0 = phi i64 [ 0, %bb.a ], [ %switch.load2, %switch.lookup ]
...
define hidden noundef range(i32 0, 51) i32 @_ZN4llvh6Triple22getArchTypeForLLVMNameENS_9StringRefE(ptr readonly captures(none) %0, i64 %1) local_unnamed_addr #2 align 2 {
bb.a:
...
end_hunk_0
begin_hunk_1_@_ZL16parseEnvironmentN4llvh9StringRefE:bb.a
  %i.cw = load i64, ptr %0, align 1
  %i.cx = xor i64 %i.cw, 7593739009939174765
  %i.cy = getelementptr i8, ptr %0, i64 8
  %i.cz = load i16, ptr %i.cy, align 1
  %i.da = zext i16 %i.cz to i64
  %i.db = xor i64 %i.da, 26216
  %i.dc = or i64 %i.cx, %i.db
  %i.dd = icmp ne i64 %i.dc, 0
  %i.de = zext i1 %i.dd to i32
  %i.df = icmp eq i32 %i.de, 0
  br i1 %i.df, label %_ZN4llvh12StringSwitchINS_6Triple15EnvironmentTypeES2_E7DefaultES2_.exit, label %_ZNK4llvh9StringRef10startswithES0_.exit41

_ZN4llvh12StringSwitchINS_6Triple15EnvironmentTypeES2_E10StartsWithENS_13StringLiteralES2_.exit9: ; preds = %_ZN4llvh12StringSwitchINS_6Triple15EnvironmentTypeES2_E10StartsWithENS_13StringLiteralES2_.exit10
  %.not.i40 = icmp eq i64 %1, 7
  br i1 %.not.i40, label %_ZNK4llvh9StringRef10startswithES0_.exit43, label %_ZNK4llvh9StringRef10startswithES0_.exit41

_ZNK4llvh9StringRef10startswithES0_.exit41:       ; preds = %_ZNK4llvh9StringRef10startswithES0_.exit39, %_ZN4llvh12StringSwitchINS_6Triple15EnvironmentTypeES2_E10StartsWithENS_13StringLiteralES2_.exit9
  %i.dg = load i64, ptr %0, align 1
  %i.dh = icmp ne i64 %i.dg, 7593739009939174765
  %i.di = zext i1 %i.dh to i32
  %i.dj = icmp eq i32 %i.di, 0
  br i1 %i.dj, label %_ZN4llvh12StringSwitchINS_6Triple15EnvironmentTypeES2_E7DefaultES2_.exit, label %_ZNK4llvh9StringRef10startswithES0_.exit43

_ZNK4llvh9StringRef10startswithES0_.exit43:       ; preds = %_ZN4llvh12StringSwitchINS_6Triple15EnvironmentTypeES2_E10StartsWithENS_13StringLiteralES2_.exit11, %_ZNK4llvh9StringRef10startswithES0_.exit41, %_ZN4llvh12StringSwitchINS_6Triple15EnvironmentTypeES2_E10StartsWithENS_13StringLiteralES2_.exit9
  %i.dk = load i32, ptr %0, align 1
  %i.dl = icmp ne i32 %i.dk, 1819506029
  %i.dm = zext i1 %i.dl to i32
  %i.dn = icmp eq i32 %i.dm, 0
  br i1 %i.dn, label %_ZN4llvh12StringSwitchINS_6Triple15EnvironmentTypeES2_E7DefaultES2_.exit, label %_ZNK4llvh9StringRef10startswithES0_.exit45

_ZNK4llvh9StringRef10startswithES0_.exit45:       ; preds = %_ZNK4llvh9StringRef10startswithES0_.exit43
  %i.do = load i32, ptr %0, align 1
  %i.dp = icmp ne i32 %i.do, 1668707181
  %i.dq = zext i1 %i.dp to i32
  %i.dr = icmp eq i32 %i.dq, 0
  br i1 %i.dr, label %_ZN4llvh12StringSwitchINS_6Triple15EnvironmentTypeES2_E7DefaultES2_.exit, label %_ZN4llvh12StringSwitchINS_6Triple15EnvironmentTypeES2_E10StartsWithENS_13StringLiteralES2_.exit6

_ZN4llvh12StringSwitchINS_6Triple15EnvironmentTypeES2_E10StartsWithENS_13StringLiteralES2_.exit6: ; preds = %_ZNK4llvh9StringRef10startswithES0_.exit45
  br i1 %.not.i36, label %_ZN4llvh12StringSwitchINS_6Triple15EnvironmentTypeES2_E10StartsWithENS_13StringLiteralES2_.exit5, label %_ZNK4llvh9StringRef10startswithES0_.exit47

_ZNK4llvh9StringRef10startswithES0_.exit47:       ; preds = %_ZN4llvh12StringSwitchINS_6Triple15EnvironmentTypeES2_E10StartsWithENS_13StringLiteralES2_.exit6
  %i.ds = load i32, ptr %0, align 1
  %i.dt = xor i32 %i.ds, 1851880553
  %i.du = getelementptr i8, ptr %0, i64 3
  %i.dv = load i32, ptr %i.du, align 1
  %i.dw = xor i32 %i.dv, 1836411246
  %i.dx = or i32 %i.dt, %i.dw
  %i.dy = icmp ne i32 %i.dx, 0
  %i.dz = zext i1 %i.dy to i32
  %i.ea = icmp eq i32 %i.dz, 0
  br i1 %i.ea, label %_ZN4llvh12StringSwitchINS_6Triple15EnvironmentTypeES2_E7DefaultES2_.exit, label %_ZNK4llvh9StringRef10startswithES0_.exit49

_ZN4llvh12StringSwitchINS_6Triple15EnvironmentTypeES2_E10StartsWithENS_13StringLiteralES2_.exit5: ; preds = %_ZN4llvh12StringSwitchINS_6Triple15EnvironmentTypeES2_E10StartsWithENS_13StringLiteralES2_.exit6
  %.not.i48.not = icmp eq i64 %1, 6
  br i1 %.not.i48.not, label %_ZNK4llvh9StringRef10startswithES0_.exit49.thread410, label %_ZNK4llvh9StringRef10startswithES0_.exit53.thread

_ZNK4llvh9StringRef10startswithES0_.exit49:       ; preds = %_ZNK4llvh9StringRef10startswithES0_.exit47
  %i.eb = load i32, ptr %0, align 1
  %i.ec = xor i32 %i.eb, 1852275043
  %i.ed = getelementptr i8, ptr %0, i64 4
  %i.ee = load i16, ptr %i.ed, align 1
  %i.ef = zext i16 %i.ee to i32
  %i.eg = xor i32 %i.ef, 29557
  %i.eh = or i32 %i.ec, %i.eg
  %i.ei = icmp ne i32 %i.eh, 0
  %i.ej = zext i1 %i.ei to i32
  %i.ek = icmp eq i32 %i.ej, 0
  br i1 %i.ek, label %_ZN4llvh12StringSwitchINS_6Triple15EnvironmentTypeES2_E7DefaultES2_.exit, label %_ZNK4llvh9StringRef10startswithES0_.exit51

_ZNK4llvh9StringRef10startswithES0_.exit49.thread410: ; preds = %_ZN4llvh12StringSwitchINS_6Triple15EnvironmentTypeES2_E10StartsWithENS_13StringLiteralES2_.exit5
  %i.el = load i32, ptr %0, align 1
  %i.em = xor i32 %i.el, 1852275043
  %i.en = getelementptr i8, ptr %0, i64 4
  %i.eo = load i16, ptr %i.en, align 1
  %i.ep = zext i16 %i.eo to i32
  %i.eq = xor i32 %i.ep, 29557
  %i.er = or i32 %i.em, %i.eq
  %i.es = icmp ne i32 %i.er, 0
  %i.et = zext i1 %i.es to i32
  %i.eu = icmp eq i32 %i.et, 0
  br i1 %i.eu, label %_ZN4llvh12StringSwitchINS_6Triple15EnvironmentTypeES2_E7DefaultES2_.exit, label %_ZNK4llvh9StringRef10startswithES0_.exit53.thread
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define internal fastcc noundef range(i32 0, 5) i32 @_ZL11parseFormatN4llvh9StringRefE(ptr readonly captures(none) %0, i64 %1) unnamed_addr #2 {
bb.a:
...
end_hunk_1
begin_hunk_2_@_ZN4llvh6Triple9normalizeB5cxx11ENS_9StringRefE:bb.a
...
_ZNK4llvh9StringRef5splitEc.exit:                 ; preds = %bb.a, %bb.b
  ...
  ret { ptr, i64 } %.fca.1.insert
end_hunk_2
begin_hunk_3_@_ZNK4llvh6Triple9getOSNameEv:bb.a
...
switch.lookup:
  ...
  %i.f = zext nneg i32 %i.e to i64
  %switch.gep = getelementptr inbounds nuw [8 x i8], ptr @switch.table._ZN4llvh6Triple5setOSENS0_6OSTypeE, i64 %i.f
  %switch.load = load i64, ptr %switch.gep, align 8 ; 4 uses
  %.not.i = icmp ult i64 %i.c, %switch.load
  br i1 %.not.i, label %_ZNK4llvh9StringRef10startswithES0_.exit.thread, label %_ZNK4llvh9StringRef10startswithES0_.exit
...
; Function Attrs: mustprogress nounwind uwtable
define hidden noundef zeroext i1 @_ZNK4llvh6Triple16getMacOSXVersionERjS1_S1_(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(56) %0, ptr noundef nonnull align 4 dereferenceable(4) %1, ptr noundef nonnull align 4 dereferenceable(4) %2, ptr noundef nonnull align 4 dereferenceable(4) %3) local_unnamed_addr #4 align 2 {
bb.a:
...
; Function Attrs: mustprogress nounwind uwtable
define hidden void @_ZN4llvh6Triple9setTripleERKNS_5TwineE(ptr noundef nonnull align 8 captures(address) dereferenceable(56) %0, ptr noundef nonnull align 8 dereferenceable(18) %1) local_unnamed_addr #4 align 2 {
bb.a:
...
end_hunk_3
begin_hunk_4_@_ZNK4llvh6Triple5mergeB5cxx11ERKS0_:bb.a
...
!130 = !{!131}
!131 = distinct !{!131, !132, !"_ZNK4llvh9StringRef5splitEc: argument 0"}
!132 = distinct !{!132, !"_ZNK4llvh9StringRef5splitEc"}
!133 = !{!134, !131}
!134 = distinct !{!134, !135, !"_ZNK4llvh9StringRef5splitES0_: argument 0"}
!135 = distinct !{!135, !"_ZNK4llvh9StringRef5splitES0_"}
!136 = !{!137}
!137 = distinct !{!137, !138, !"_ZNK4llvh9StringRef5splitEc: argument 0"}
!138 = distinct !{!138, !"_ZNK4llvh9StringRef5splitEc"}
!139 = !{!140, !137}
!140 = distinct !{!140, !141, !"_ZNK4llvh9StringRef5splitES0_: argument 0"}
!141 = distinct !{!141, !"_ZNK4llvh9StringRef5splitES0_"}
!142 = !{!143}
!143 = distinct !{!143, !144, !"_ZNK4llvh9StringRef5splitEc: argument 0"}
!144 = distinct !{!144, !"_ZNK4llvh9StringRef5splitEc"}
!145 = !{!146, !143}
!146 = distinct !{!146, !147, !"_ZNK4llvh9StringRef5splitES0_: argument 0"}
!147 = distinct !{!147, !"_ZNK4llvh9StringRef5splitES0_"}
!148 = !{!149}
!149 = distinct !{!149, !150, !"_ZNK4llvh9StringRef5splitEc: argument 0"}
!150 = distinct !{!150, !"_ZNK4llvh9StringRef5splitEc"}
!151 = !{!152, !149}
!152 = distinct !{!152, !153, !"_ZNK4llvh9StringRef5splitES0_: argument 0"}
!153 = distinct !{!153, !"_ZNK4llvh9StringRef5splitES0_"}
!154 = !{!155}
!155 = distinct !{!155, !156, !"_ZNK4llvh9StringRef5splitEc: argument 0"}
!156 = distinct !{!156, !"_ZNK4llvh9StringRef5splitEc"}
!157 = !{!158, !155}
!158 = distinct !{!158, !159, !"_ZNK4llvh9StringRef5splitES0_: argument 0"}
!159 = distinct !{!159, !"_ZNK4llvh9StringRef5splitES0_"}
!160 = !{!161}
!161 = distinct !{!161, !162, !"_ZNK4llvh9StringRef5splitEc: argument 0"}
!162 = distinct !{!162, !"_ZNK4llvh9StringRef5splitEc"}
!163 = !{!164, !161}
!164 = distinct !{!164, !165, !"_ZNK4llvh9StringRef5splitES0_: argument 0"}
!165 = distinct !{!165, !"_ZNK4llvh9StringRef5splitES0_"}
!166 = !{!167}
!167 = distinct !{!167, !168, !"_ZNK4llvh9StringRef5splitEc: argument 0"}
!168 = distinct !{!168, !"_ZNK4llvh9StringRef5splitEc"}
!169 = !{!170, !167}
!170 = distinct !{!170, !171, !"_ZNK4llvh9StringRef5splitES0_: argument 0"}
!171 = distinct !{!171, !"_ZNK4llvh9StringRef5splitES0_"}
!172 = !{!173}
!173 = distinct !{!173, !174, !"_ZNK4llvh9StringRef5splitEc: argument 0"}
!174 = distinct !{!174, !"_ZNK4llvh9StringRef5splitEc"}
!175 = !{!176, !173}
!176 = distinct !{!176, !177, !"_ZNK4llvh9StringRef5splitES0_: argument 0"}
!177 = distinct !{!177, !"_ZNK4llvh9StringRef5splitES0_"}
!178 = !{!179}
!179 = distinct !{!179, !180, !"_ZNK4llvh9StringRef5splitEc: argument 0"}
!180 = distinct !{!180, !"_ZNK4llvh9StringRef5splitEc"}
!181 = !{!182, !179}
!182 = distinct !{!182, !183, !"_ZNK4llvh9StringRef5splitES0_: argument 0"}
!183 = distinct !{!183, !"_ZNK4llvh9StringRef5splitES0_"}
!184 = !{!185}
!185 = distinct !{!185, !186, !"_ZNK4llvh9StringRef5splitEc: argument 0"}
!186 = distinct !{!186, !"_ZNK4llvh9StringRef5splitEc"}
!187 = !{!188, !185}
!188 = distinct !{!188, !189, !"_ZNK4llvh9StringRef5splitES0_: argument 0"}
!189 = distinct !{!189, !"_ZNK4llvh9StringRef5splitES0_"}
!190 = !{!191}
!191 = distinct !{!191, !192, !"_ZNK4llvh9StringRef5splitEc: argument 0"}
end_hunk_4
