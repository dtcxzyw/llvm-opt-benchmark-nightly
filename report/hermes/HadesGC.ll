...
bb.k:                                             ; preds = %.lr.ph, %_ZNK6hermes8BitArrayILm267ELm8EE18findNextSetBitFromEm.exit97
  %.153145 = phi i64 [ %i.br, %.lr.ph ], [ %.sroa.speculated.i.i92, %_ZNK6hermes8BitArrayILm267ELm8EE18findNextSetBitFromEm.exit97 ] ; 11 uses
...
bb.ad:                                            ; preds = %bb.ac
  ...
  br i1 %.not70, label %9, label %bb.l, !llvm.loop !530

9:                                                ; preds = %bb.ad
  %10 = add nuw nsw i64 %.153145, 1               ; 2 uses
  ...
  %17 = icmp samesign ult i64 %.153145, 255
  %18 = and i1 %17, %.not14.i.i89
  br i1 %18, label %.lr.ph.i.i93, label %_ZNK6hermes8BitArrayILm267ELm8EE18findNextSetBitFromEm.exit97
...
.lr.ph.i.i93:                                     ; preds = %9
  ...
  %21 = icmp ult i64 %.153145, 191
  %22 = and i1 %.not.i.i96, %21
  br i1 %22, label %.lr.ph.i.i93.1, label %_ZNK6hermes8BitArrayILm267ELm8EE18findNextSetBitFromEm.exit97
...
.lr.ph.i.i93.1:                                   ; preds = %.lr.ph.i.i93
  ...
  %25 = icmp ult i64 %.153145, 127
  %26 = and i1 %.not.i.i96.1, %25
  br i1 %26, label %.lr.ph.i.i93.2, label %_ZNK6hermes8BitArrayILm267ELm8EE18findNextSetBitFromEm.exit97
...
_ZNK6hermes8BitArrayILm267ELm8EE18findNextSetBitFromEm.exit97: ; preds = %.lr.ph.i.i93.2, %.lr.ph.i.i93, %.lr.ph.i.i93.1, %9
  ...
  %.sroa.speculated.i.i92 = tail call noundef i64 @llvm.umin.i64(i64 %i.fz, i64 267)
  %i.ga = icmp ult i64 %i.fz, 267
