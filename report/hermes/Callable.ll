...
bb.c:                                             ; preds = %bb.b, %.thread
  %.pn = phi i64 [ 24, %.thread ], [ 640, %bb.b ]
  %.sroa.05.031 = getelementptr inbounds nuw i8, ptr %1, i64 %.pn
  %i.ab = tail call ptr @_ZN6hermes2vm8JSObject6createERNS0_7RuntimeENS0_6HandleIS1_EE(ptr noundef nonnull align 8 dereferenceable(9816) %1, ptr nonnull %.sroa.05.031) #12
