...
bb.h:                                             ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit
  ...
  %.sroa.0.0.copyload.i.i.pre.i.i = load <2 x i64>, ptr %4, align 16, !tbaa !24
...
_ZNSt8functionIFvRN6hermes2vm17GCTripwireContextEEEC2EOS5_.exit.i.i: ; preds = %bb.h, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit
  ...
  store <2 x i64> %.sroa.0.0.copyload.i.i.i.i, ptr %i.ae, align 8, !tbaa !24
...
bb.j:                                             ; preds = %_ZN6hermes2vm16GCTripwireConfigaSEOS1_.exit
  ...
  %.sroa.0.0.copyload.i.i.pre.i = load <2 x i64>, ptr %3, align 16, !tbaa !24
...
_ZNSt8functionIFvRKN6hermes2vm16GCAnalyticsEventEEEC2EOS6_.exit.i: ; preds = %bb.j, %_ZN6hermes2vm16GCTripwireConfigaSEOS1_.exit
  ...
  store <2 x i64> %.sroa.0.0.copyload.i.i.i, ptr %i.ar, align 8, !tbaa !24
...
bb.l:                                             ; preds = %_ZNSt8functionIFvRKN6hermes2vm16GCAnalyticsEventEEEaSEOS6_.exit
  ...
  %.sroa.0.0.copyload.i.i.pre.i8 = load <2 x i64>, ptr %2, align 16, !tbaa !24
...
_ZNSt8functionIFvN6hermes2vm11GCEventKindEPKcEEC2EOS6_.exit.i: ; preds = %bb.l, %_ZNSt8functionIFvRKN6hermes2vm16GCAnalyticsEventEEEaSEOS6_.exit
  ...
  store <2 x i64> %.sroa.0.0.copyload.i.i.i9, ptr %i.bb, align 8, !tbaa !24
...
_ZNSt8functionIFvRN6hermes2vm17GCTripwireContextEEEC2ERKS5_.exit.i.i: ; preds = %bb.b, %bb.a
  ...
  %5 = phi <2 x ptr> [ splat (ptr null), %bb.a ], [ %i.k, %bb.b ]
  ...
  store <2 x i64> %.sroa.0.0.copyload.i.i.i.i, ptr %i.f, align 8, !tbaa !24
  %i.l = getelementptr inbounds nuw i8, ptr %4, i64 16
  %i.m = getelementptr inbounds nuw i8, ptr %0, i64 112 ; 3 uses
  %i.n = load <2 x ptr>, ptr %i.m, align 8, !tbaa !101
  %i.o = load ptr, ptr %i.m, align 8, !tbaa !101  ; 2 uses
  store <2 x ptr> %i.n, ptr %i.l, align 16, !tbaa !101
  store <2 x ptr> %5, ptr %i.m, align 8, !tbaa !101
...
begin_hunk_11_@_ZN6hermes2vm8GCConfigaSERKS1_:bb.a
  ...
  %i.x = call noundef zeroext i1 %i.v(ptr noundef nonnull align 8 dereferenceable(32) %3, ptr noundef nonnull align 8 dereferenceable(32) %i.w, i32 noundef 2) #20, !inline_history !296 ; 0 uses
  %i.y = load <2 x ptr>, ptr %i.u, align 8, !tbaa !101
  %.sroa.0.0.copyload.i.i.pre.i = load <2 x i64>, ptr %3, align 16, !tbaa !24
...
_ZNSt8functionIFvRKN6hermes2vm16GCAnalyticsEventEEEC2ERKS6_.exit.i: ; preds = %bb.d, %_ZN6hermes2vm16GCTripwireConfigaSERKS1_.exit
  ...
  %6 = phi <2 x ptr> [ splat (ptr null), %_ZN6hermes2vm16GCTripwireConfigaSERKS1_.exit ], [ %i.y, %bb.d ]
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %3, ptr noundef nonnull align 8 dereferenceable(32) %i.t, i64 16, i1 false), !tbaa.struct !290
  store <2 x i64> %.sroa.0.0.copyload.i.i.i, ptr %i.t, align 8, !tbaa !24
  %i.z = getelementptr inbounds nuw i8, ptr %3, i64 16
  %i.aa = getelementptr inbounds nuw i8, ptr %0, i64 152 ; 3 uses
  %i.ab = load <2 x ptr>, ptr %i.aa, align 8, !tbaa !101
  %i.ac = load ptr, ptr %i.aa, align 8, !tbaa !101 ; 2 uses
  store <2 x ptr> %i.ab, ptr %i.z, align 16, !tbaa !101
  store <2 x ptr> %6, ptr %i.aa, align 8, !tbaa !101
...
begin_hunk_13_@_ZN6hermes2vm8GCConfigaSERKS1_:bb.a
  ...
  %i.ai = call noundef zeroext i1 %i.ag(ptr noundef nonnull align 8 dereferenceable(32) %2, ptr noundef nonnull align 8 dereferenceable(32) %i.ah, i32 noundef 2) #20, !inline_history !298 ; 0 uses
  %i.aj = load <2 x ptr>, ptr %i.af, align 8, !tbaa !101
  %.sroa.0.0.copyload.i.i.pre.i8 = load <2 x i64>, ptr %2, align 16, !tbaa !24
...
_ZNSt8functionIFvN6hermes2vm11GCEventKindEPKcEEC2ERKS6_.exit.i: ; preds = %bb.f, %_ZNSt8functionIFvRKN6hermes2vm16GCAnalyticsEventEEEaSERKS6_.exit
  ...
  %7 = phi <2 x ptr> [ splat (ptr null), %_ZNSt8functionIFvRKN6hermes2vm16GCAnalyticsEventEEEaSERKS6_.exit ], [ %i.aj, %bb.f ]
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %2, ptr noundef nonnull align 8 dereferenceable(32) %i.ae, i64 16, i1 false), !tbaa.struct !290
  store <2 x i64> %.sroa.0.0.copyload.i.i.i9, ptr %i.ae, align 8, !tbaa !24
  %i.ak = getelementptr inbounds nuw i8, ptr %2, i64 16
  %i.al = getelementptr inbounds nuw i8, ptr %0, i64 184 ; 3 uses
  %i.am = load <2 x ptr>, ptr %i.al, align 8, !tbaa !101
  %i.an = load ptr, ptr %i.al, align 8, !tbaa !101 ; 2 uses
  store <2 x ptr> %i.am, ptr %i.ak, align 16, !tbaa !101
  store <2 x ptr> %7, ptr %i.al, align 8, !tbaa !101
