...
bb.h:                                             ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %4, ptr noundef nonnull align 8 dereferenceable(32) %i.ai, i64 16, i1 false), !tbaa.struct !259
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.af, i8 0, i64 16, i1 false)
  %.sroa.0.0.copyload.i.i.pre.i.i = load <2 x i64>, ptr %4, align 16, !tbaa !22
...
_ZNSt8functionIFvRN6hermes2vm17GCTripwireContextEEEC2EOS5_.exit.i.i: ; preds = %bb.h, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %4, ptr noundef nonnull align 8 dereferenceable(32) %i.ae, i64 16, i1 false), !tbaa.struct !259
  store <2 x i64> %.sroa.0.0.copyload.i.i.i.i, ptr %i.ae, align 8, !tbaa !22
  ...
  store <2 x ptr> %i.al, ptr %i.aj, align 16, !tbaa !98
...
bb.j:                                             ; preds = %_ZN6hermes2vm16GCTripwireConfigaSEOS1_.exit
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %3, ptr noundef nonnull align 8 dereferenceable(32) %i.av, i64 16, i1 false), !tbaa.struct !259
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.as, i8 0, i64 16, i1 false)
  %.sroa.0.0.copyload.i.i.pre.i = load <2 x i64>, ptr %3, align 16, !tbaa !22
...
_ZNSt8functionIFvRKN6hermes2vm16GCAnalyticsEventEEEC2EOS6_.exit.i: ; preds = %bb.j, %_ZN6hermes2vm16GCTripwireConfigaSEOS1_.exit
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %3, ptr noundef nonnull align 8 dereferenceable(32) %i.ar, i64 16, i1 false), !tbaa.struct !259
  store <2 x i64> %.sroa.0.0.copyload.i.i.i, ptr %i.ar, align 8, !tbaa !22
  ...
  store <2 x ptr> %i.ay, ptr %i.aw, align 16, !tbaa !98
...
bb.l:                                             ; preds = %_ZNSt8functionIFvRKN6hermes2vm16GCAnalyticsEventEEEaSEOS6_.exit
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %2, ptr noundef nonnull align 8 dereferenceable(32) %i.bf, i64 16, i1 false), !tbaa.struct !259
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.bc, i8 0, i64 16, i1 false)
  %.sroa.0.0.copyload.i.i.pre.i8 = load <2 x i64>, ptr %2, align 16, !tbaa !22
...
_ZNSt8functionIFvN6hermes2vm11GCEventKindEPKcEEC2EOS6_.exit.i: ; preds = %bb.l, %_ZNSt8functionIFvRKN6hermes2vm16GCAnalyticsEventEEEaSEOS6_.exit
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %2, ptr noundef nonnull align 8 dereferenceable(32) %i.bb, i64 16, i1 false), !tbaa.struct !259
  store <2 x i64> %.sroa.0.0.copyload.i.i.i9, ptr %i.bb, align 8, !tbaa !22
  ...
  store <2 x ptr> %i.bi, ptr %i.bg, align 16, !tbaa !98
...
_ZNSt8functionIFvRN6hermes2vm17GCTripwireContextEEEC2ERKS5_.exit.i.i: ; preds = %bb.b, %bb.a
  %.sroa.0.0.copyload.i.i.i.i = phi <2 x i64> [ zeroinitializer, %bb.a ], [ %.sroa.0.0.copyload.i.i.pre.i.i, %bb.b ]
  %5 = phi <2 x ptr> [ zeroinitializer, %bb.a ], [ %i.k, %bb.b ]
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %4, ptr noundef nonnull align 8 dereferenceable(32) %i.f, i64 16, i1 false), !tbaa.struct !259
  store <2 x i64> %.sroa.0.0.copyload.i.i.i.i, ptr %i.f, align 8, !tbaa !22
  ...
  store <2 x ptr> %i.n, ptr %i.l, align 16, !tbaa !98
...
_ZNSt8functionIFvRKN6hermes2vm16GCAnalyticsEventEEEC2ERKS6_.exit.i: ; preds = %bb.d, %_ZN6hermes2vm16GCTripwireConfigaSERKS1_.exit
  %.sroa.0.0.copyload.i.i.i = phi <2 x i64> [ zeroinitializer, %_ZN6hermes2vm16GCTripwireConfigaSERKS1_.exit ], [ %.sroa.0.0.copyload.i.i.pre.i, %bb.d ]
  %6 = phi <2 x ptr> [ zeroinitializer, %_ZN6hermes2vm16GCTripwireConfigaSERKS1_.exit ], [ %i.y, %bb.d ]
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %3, ptr noundef nonnull align 8 dereferenceable(32) %i.t, i64 16, i1 false), !tbaa.struct !259
  store <2 x i64> %.sroa.0.0.copyload.i.i.i, ptr %i.t, align 8, !tbaa !22
  ...
  store <2 x ptr> %i.ab, ptr %i.z, align 16, !tbaa !98
...
_ZNSt8functionIFvN6hermes2vm11GCEventKindEPKcEEC2ERKS6_.exit.i: ; preds = %bb.f, %_ZNSt8functionIFvRKN6hermes2vm16GCAnalyticsEventEEEaSERKS6_.exit
  %.sroa.0.0.copyload.i.i.i9 = phi <2 x i64> [ zeroinitializer, %_ZNSt8functionIFvRKN6hermes2vm16GCAnalyticsEventEEEaSERKS6_.exit ], [ %.sroa.0.0.copyload.i.i.pre.i8, %bb.f ]
  %7 = phi <2 x ptr> [ zeroinitializer, %_ZNSt8functionIFvRKN6hermes2vm16GCAnalyticsEventEEEaSERKS6_.exit ], [ %i.aj, %bb.f ]
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %2, ptr noundef nonnull align 8 dereferenceable(32) %i.ae, i64 16, i1 false), !tbaa.struct !259
  store <2 x i64> %.sroa.0.0.copyload.i.i.i9, ptr %i.ae, align 8, !tbaa !22
  ...
  store <2 x ptr> %i.am, ptr %i.ak, align 16, !tbaa !98
