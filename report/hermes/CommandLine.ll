...
_ZNSt8functionIFvRN4llvh11raw_ostreamEEEC2ERKS4_.exit.i: ; preds = %bb.b, %bb.a
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %1, ptr noundef nonnull align 16 dereferenceable(32) @_ZL22OverrideVersionPrinter, i64 16, i1 false), !tbaa.struct !356
  store <2 x i64> %.sroa.0.0.copyload.i.i.i, ptr @_ZL22OverrideVersionPrinter, align 16, !tbaa !18
  %i.e = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.f = load <2 x ptr>, ptr getelementptr inbounds nuw (i8, ptr @_ZL22OverrideVersionPrinter, i64 16), align 16, !tbaa !64
  %i.g = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_ZL22OverrideVersionPrinter, i64 16), align 16, !tbaa !64 ; 2 uses
  store <2 x ptr> %i.f, ptr %i.e, align 16, !tbaa !64
  store <2 x ptr> %2, ptr getelementptr inbounds nuw (i8, ptr @_ZL22OverrideVersionPrinter, i64 16), align 16, !tbaa !64
...
bb.c:                                             ; preds = %bb.b
  %i.d = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_ZL22OverrideVersionPrinter, i64 16), align 16, !tbaa !346
