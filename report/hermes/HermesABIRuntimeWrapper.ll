...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %_ZNSt6vectorI14HermesABIValueSaIS0_EE9push_backEOS0_.exit
  %.01075 = phi i64 [ %i.am, %_ZNSt6vectorI14HermesABIValueSaIS0_EE9push_backEOS0_.exit ], [ 0, %.lr.ph.preheader ] ; 2 uses
  %.sroa.041.074 = phi ptr [ %.sroa.041.3, %_ZNSt6vectorI14HermesABIValueSaIS0_EE9push_backEOS0_.exit ], [ %i.c, %.lr.ph.preheader ] ; 7 uses
...
_ZN12_GLOBAL__N_123HermesABIRuntimeWrapper10toABIValueERKN8facebook3jsi5ValueE.exit25: ; preds = %.lr.ph, %bb.j, %bb.k, %bb.m, %bb.n, %bb.o, %bb.p, %.fold.split.i18
  %.pn16.i15 = phi { i32, i64 } [ %.fca.1.insert.i22.i20, %bb.p ], [ { i32 0, i64 undef }, %.lr.ph ], [ %.fca.1.insert.i.i17, %bb.j ], [ %.fca.1.insert.i18.i14, %bb.k ], [ %.fca.1.insert.i19.i23, %bb.m ], [ %.fca.1.insert.i20.i22, %bb.n ], [ %.fca.1.insert.i21.i21, %bb.o ], [ { i32 1, i64 undef }, %.fold.split.i18 ] ; 2 uses
  %i.w = extractvalue { i32, i64 } %.pn16.i15, 0  ; 2 uses
  %i.x = extractvalue { i32, i64 } %.pn16.i15, 1  ; 2 uses
  %.not.i.i = icmp eq ptr %.sroa.12.073, %.sroa.19.072
  br i1 %.not.i.i, label %bb.r, label %bb.q

bb.q:                                             ; preds = %_ZN12_GLOBAL__N_123HermesABIRuntimeWrapper10toABIValueERKN8facebook3jsi5ValueE.exit25
  store i32 %i.w, ptr %.sroa.12.073, align 8, !tbaa !344
  %.sroa.638.0..sroa_idx = getelementptr inbounds nuw i8, ptr %.sroa.12.073, i64 8
  store i64 %i.x, ptr %.sroa.638.0..sroa_idx, align 8, !tbaa !52
  br label %_ZNSt6vectorI14HermesABIValueSaIS0_EE9push_backEOS0_.exit

bb.r:                                             ; preds = %_ZN12_GLOBAL__N_123HermesABIRuntimeWrapper10toABIValueERKN8facebook3jsi5ValueE.exit25
  %i.y = ptrtoint ptr %.sroa.12.073 to i64
  %i.z = ptrtoint ptr %.sroa.041.074 to i64
...
bb.s:                                             ; preds = %bb.r
  invoke void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.13) #28
          to label %.noexc26.a unwind label %.loopexit.split-lp

.noexc26.a:                                       ; preds = %bb.s
  unreachable
...
_ZNKSt6vectorI14HermesABIValueSaIS0_EE12_M_check_lenEmPKc.exit.i.i.i: ; preds = %bb.r
  ...
  %i.ai = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.ah) #24
          to label %.noexc27.a unwind label %.loopexit ; 4 uses

.noexc27.a:                                       ; preds = %_ZNKSt6vectorI14HermesABIValueSaIS0_EE12_M_check_lenEmPKc.exit.i.i.i
  %i.aj = getelementptr inbounds i8, ptr %i.ai, i64 %i.aa ; 3 uses
  store i32 %i.w, ptr %i.aj, align 8, !tbaa !344
  %.sroa.638.0..sroa_idx39 = getelementptr inbounds nuw i8, ptr %i.aj, i64 8
  store i64 %i.x, ptr %.sroa.638.0..sroa_idx39, align 8, !tbaa !52
...
bb.t:                                             ; preds = %.noexc27.a
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.ai, ptr align 8 %.sroa.041.074, i64 %i.aa, i1 false)
  br label %_ZNSt6vectorI14HermesABIValueSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit16.i.i.i

_ZNSt6vectorI14HermesABIValueSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit16.i.i.i: ; preds = %bb.t, %.noexc27.a
  %.not.i17.i.i.i = icmp eq ptr %.sroa.041.074, null
...
bb.u:                                             ; preds = %_ZNSt6vectorI14HermesABIValueSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit16.i.i.i
  tail call void @_ZdlPvm(ptr noundef nonnull %.sroa.041.074, i64 noundef %i.aa) #26
...
_ZNSt6vectorI14HermesABIValueSaIS0_EE9push_backEOS0_.exit: ; preds = %_ZNSt6vectorI14HermesABIValueSaIS0_EE17_M_realloc_insertIJS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i.i, %bb.q
  %.sroa.19.3 = phi ptr [ %i.al, %_ZNSt6vectorI14HermesABIValueSaIS0_EE17_M_realloc_insertIJS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i.i ], [ %.sroa.19.072, %bb.q ] ; 2 uses
  %.pn58 = phi ptr [ %i.aj, %_ZNSt6vectorI14HermesABIValueSaIS0_EE17_M_realloc_insertIJS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i.i ], [ %.sroa.12.073, %bb.q ]
  %.sroa.041.3 = phi ptr [ %i.ai, %_ZNSt6vectorI14HermesABIValueSaIS0_EE17_M_realloc_insertIJS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i.i ], [ %.sroa.041.074, %bb.q ] ; 2 uses
  %.sroa.12.2 = getelementptr inbounds nuw i8, ptr %.pn58, i64 16 ; 2 uses
  %i.am = add nuw i64 %.01075, 1                  ; 2 uses
...
bb.v:                                             ; preds = %.fold.split.i, %bb.i, %bb.h, %bb.g, %bb.f, %bb.d, %bb.c, %._crit_edge
  ...
  %i.ax = ptrtoint ptr %.sroa.041.0.lcssa to i64  ; 2 uses
  %i.ay = sub i64 %.sroa.12.0.lcssa, %i.ax
  %i.az = ashr exact i64 %i.ay, 4
  %i.ba = invoke { i32, i64 } %i.at(ptr noundef %i.av, ptr %.val.val, ptr noundef nonnull %7, ptr noundef %.sroa.041.0.lcssa, i64 noundef %i.az)
...
bb.x:                                             ; preds = %bb.w
  %.sroa.532.8.extract.trunc = trunc i64 %i.bc to i32
  invoke fastcc void @_ZN12_GLOBAL__N_123HermesABIRuntimeWrapper10throwErrorE18HermesABIErrorCode(ptr noundef nonnull align 8 dereferenceable(81) %1, i32 noundef %.sroa.532.8.extract.trunc) #28
          to label %.noexc28 unwind label %bb.ab
...
bb.z:                                             ; preds = %bb.y
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #25
  %.not.i.i.i = icmp eq ptr %.sroa.041.0.lcssa, null
...
bb.aa:                                            ; preds = %bb.z
  ...
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.041.0.lcssa, i64 noundef %i.bg) #26
...
bb.ac:                                            ; preds = %.loopexit, %.loopexit.split-lp, %bb.ab
  %.sroa.19.070 = phi ptr [ %.sroa.19.0.lcssa, %bb.ab ], [ %.sroa.12.073, %.loopexit ], [ %.sroa.12.073, %.loopexit.split-lp ]
  %.sroa.041.062 = phi ptr [ %.sroa.041.0.lcssa, %bb.ab ], [ %.sroa.041.074, %.loopexit ], [ %.sroa.041.074, %.loopexit.split-lp ] ; 3 uses
  %.pn = phi { ptr, i32 } [ %i.bh, %bb.ab ], [ %lpad.loopexit, %.loopexit ], [ %lpad.loopexit.split-lp, %.loopexit.split-lp ]
  %.not.i.i.i30 = icmp eq ptr %.sroa.041.062, null
  br i1 %.not.i.i.i30, label %_ZNSt6vectorI14HermesABIValueSaIS0_EED2Ev.exit31, label %bb.ad

bb.ad:                                            ; preds = %bb.ac
  %i.bi = ptrtoint ptr %.sroa.19.070 to i64
  %i.bj = ptrtoint ptr %.sroa.041.062 to i64
  %i.bk = sub i64 %i.bi, %i.bj
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.041.062, i64 noundef %i.bk) #26
  br label %_ZNSt6vectorI14HermesABIValueSaIS0_EED2Ev.exit31

_ZNSt6vectorI14HermesABIValueSaIS0_EED2Ev.exit31: ; preds = %bb.ac, %bb.ad
  resume { ptr, i32 } %.pn
}
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %_ZNSt6vectorI14HermesABIValueSaIS0_EE9push_backEOS0_.exit
  %.0962 = phi i64 [ %i.ad, %_ZNSt6vectorI14HermesABIValueSaIS0_EE9push_backEOS0_.exit ], [ 0, %.lr.ph.preheader ] ; 2 uses
  %.sroa.028.061 = phi ptr [ %.sroa.028.3, %_ZNSt6vectorI14HermesABIValueSaIS0_EE9push_backEOS0_.exit ], [ %i.c, %.lr.ph.preheader ] ; 7 uses
...
_ZN12_GLOBAL__N_123HermesABIRuntimeWrapper10toABIValueERKN8facebook3jsi5ValueE.exit: ; preds = %.lr.ph, %bb.c, %bb.d, %bb.f, %bb.g, %bb.h, %bb.i, %.fold.split.i
  ...
  %.not.i.i = icmp eq ptr %.sroa.12.060, %.sroa.19.059
  br i1 %.not.i.i, label %bb.k, label %bb.j

bb.j:                                             ; preds = %_ZN12_GLOBAL__N_123HermesABIRuntimeWrapper10toABIValueERKN8facebook3jsi5ValueE.exit
  store i32 %i.n, ptr %.sroa.12.060, align 8, !tbaa !344
  %.sroa.625.0..sroa_idx = getelementptr inbounds nuw i8, ptr %.sroa.12.060, i64 8
...
bb.k:                                             ; preds = %_ZN12_GLOBAL__N_123HermesABIRuntimeWrapper10toABIValueERKN8facebook3jsi5ValueE.exit
  %i.p = ptrtoint ptr %.sroa.12.060 to i64
  %i.q = ptrtoint ptr %.sroa.028.061 to i64
...
bb.m:                                             ; preds = %.noexc14
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.z, ptr align 8 %.sroa.028.061, i64 %i.r, i1 false)
  br label %_ZNSt6vectorI14HermesABIValueSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit16.i.i.i

_ZNSt6vectorI14HermesABIValueSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit16.i.i.i: ; preds = %bb.m, %.noexc14
  %.not.i17.i.i.i = icmp eq ptr %.sroa.028.061, null
...
bb.n:                                             ; preds = %_ZNSt6vectorI14HermesABIValueSaIS0_EE11_S_relocateEPS0_S3_S3_RS1_.exit16.i.i.i
  tail call void @_ZdlPvm(ptr noundef nonnull %.sroa.028.061, i64 noundef %i.r) #26
  br label %_ZNSt6vectorI14HermesABIValueSaIS0_EE17_M_realloc_insertIJS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i.i
...
_ZNSt6vectorI14HermesABIValueSaIS0_EE9push_backEOS0_.exit: ; preds = %_ZNSt6vectorI14HermesABIValueSaIS0_EE17_M_realloc_insertIJS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i.i, %bb.j
  %.sroa.19.3 = phi ptr [ %i.ac, %_ZNSt6vectorI14HermesABIValueSaIS0_EE17_M_realloc_insertIJS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i.i ], [ %.sroa.19.059, %bb.j ] ; 2 uses
  %.pn45 = phi ptr [ %i.aa, %_ZNSt6vectorI14HermesABIValueSaIS0_EE17_M_realloc_insertIJS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i.i ], [ %.sroa.12.060, %bb.j ]
  %.sroa.028.3 = phi ptr [ %i.z, %_ZNSt6vectorI14HermesABIValueSaIS0_EE17_M_realloc_insertIJS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i.i ], [ %.sroa.028.061, %bb.j ] ; 2 uses
  %.sroa.12.2 = getelementptr inbounds nuw i8, ptr %.pn45, i64 16 ; 2 uses
  %i.ad = add nuw i64 %.0962, 1                   ; 2 uses
...
bb.u:                                             ; preds = %.loopexit, %.loopexit.split-lp, %bb.t
  %.sroa.19.057 = phi ptr [ %.sroa.19.0.lcssa, %bb.t ], [ %.sroa.12.060, %.loopexit ], [ %.sroa.12.060, %.loopexit.split-lp ]
  %.sroa.028.049 = phi ptr [ %.sroa.028.0.lcssa, %bb.t ], [ %.sroa.028.061, %.loopexit ], [ %.sroa.028.061, %.loopexit.split-lp ] ; 3 uses
  %.pn = phi { ptr, i32 } [ %i.aw, %bb.t ], [ %lpad.loopexit, %.loopexit ], [ %lpad.loopexit.split-lp, %.loopexit.split-lp ]
  %.not.i.i.i17 = icmp eq ptr %.sroa.028.049, null
  br i1 %.not.i.i.i17, label %_ZNSt6vectorI14HermesABIValueSaIS0_EED2Ev.exit18, label %bb.v

bb.v:                                             ; preds = %bb.u
  %i.ax = ptrtoint ptr %.sroa.19.057 to i64
  %i.ay = ptrtoint ptr %.sroa.028.049 to i64
  %i.az = sub i64 %i.ax, %i.ay
  tail call void @_ZdlPvm(ptr noundef nonnull %.sroa.028.049, i64 noundef %i.az) #26
