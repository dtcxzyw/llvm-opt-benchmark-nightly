...
begin_hunk_0_@_ZN6hermes17parseIntWithRadixILb0EN4llvh9StringRefEEENS_8OptValueIdEET0_i:bb.a
  ...
  br i1 %.not.i, label %bb.f, label %bb.b, !llvm.loop !1045
...
.preheader:                                       ; preds = %bb.f
  ...
  %i.v = load i8, ptr %0, align 1, !tbaa !87      ; 3 uses
  %i.w = or i8 %i.v, 32
  %i.x = add i8 %i.v, -48
...
bb.n:                                             ; preds = %bb.i
  %i.au = load i8, ptr %.139123, align 1, !tbaa !87 ; 3 uses
  %i.av = or i8 %i.au, 32
  %i.aw = add i8 %i.au, -48
  %or.cond.jt3 = icmp ult i8 %i.aw, 10
  %i.ax = zext nneg i8 %i.au to i64
  %i.ay = add nsw i64 %i.ax, -48
...
bb.o:                                             ; preds = %bb.j
  %i.bc = load i8, ptr %.139.jt1, align 1, !tbaa !87 ; 3 uses
  %i.bd = or i8 %i.bc, 32
  %i.be = add i8 %i.bc, -48
  %or.cond.jt2 = icmp ult i8 %i.be, 10
  %i.bf = zext nneg i8 %i.bc to i64
  %i.bg = add nsw i64 %i.bf, -48
...
bb.p:                                             ; preds = %bb.k
  %i.bk = load i8, ptr %.139118217, align 1, !tbaa !87 ; 3 uses
  %i.bl = or i8 %i.bk, 32
  %i.bm = add i8 %i.bk, -48
  %or.cond.jt0 = icmp ult i8 %i.bm, 10
  %i.bn = zext nneg i8 %i.bk to i64
  %i.bo = add nsw i64 %i.bn, -48
...
bb.q:                                             ; preds = %bb.l
  %i.bs = load i8, ptr %.139124, align 1, !tbaa !87 ; 3 uses
  %i.bt = or i8 %i.bs, 32
  %i.bu = add i8 %i.bs, -48
...
.thread139:                                       ; preds = %bb.i
  ...
  %i.cs = uitofp i1 %narrow to double
  %i.ct = fadd double %i.cp, %i.cs
  %i.cu = fmul double %.150.jt3, %i.ct
...
.thread130:                                       ; preds = %bb.h
  %i.cv = uitofp i1 %i.cg to double
  %i.cw = fadd double %i.cp, %i.cv
  %i.cx = fmul double %.150.jt4, %i.cw
  br label %_ZN6hermes23parseIntWithRadixDigitsILb0EN4llvh9StringRefEZNS_17parseIntWithRadixILb0ES2_EENS_8OptValueIdEET0_iEUlhE_EEbS6_iT1_.exit
...
_ZN6hermes23parseIntWithRadixDigitsILb0EN4llvh9StringRefEZNS_17parseIntWithRadixILb0ES2_EENS_8OptValueIdEET0_iEUlhE_EEbS6_iT1_.exit: ; preds = %bb.c, %bb.k, %bb.l, %bb.j, %bb.a, %bb.f, %.thread130, %.thread139
  %.sroa.063.0 = phi double [ 0.000000e+00, %bb.a ], [ %i.p, %bb.f ], [ 0.000000e+00, %bb.k ], [ %i.cx, %.thread130 ], [ %i.cu, %.thread139 ], [ %.166.jt1, %bb.l ], [ %i.cp, %bb.j ], [ 0.000000e+00, %bb.c ]
...
bb.a:
  %i.a = load ptr, ptr %0, align 8, !tbaa !173    ; 6 uses
  %i.b = load i8, ptr %1, align 1, !tbaa !87
  %i.c = getelementptr inbounds nuw i8, ptr %i.a, i64 8 ; 2 uses
  %i.d = load i64, ptr %i.c, align 8, !tbaa !86   ; 4 uses
  %i.e = add i64 %i.d, 1                          ; 3 uses
  %i.f = load ptr, ptr %i.a, align 8, !tbaa !95   ; 2 uses
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9push_backEc.exit: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i, %bb.b
  ...
  store i8 %i.b, ptr %i.n, align 1, !tbaa !87
  store i64 %i.e, ptr %i.c, align 8, !tbaa !86
  %i.o = load ptr, ptr %i.a, align 8, !tbaa !95
...
bb.a:
  ...
  %i.c = load ptr, ptr %0, align 8, !tbaa !128    ; 10 uses
  %i.d = load i8, ptr %i.c, align 1, !tbaa !87    ; 2 uses
  %i.e = sext i8 %i.d to i32                      ; 6 uses
  %i.f = and i32 %i.e, 224
  %i.g = icmp eq i32 %i.f, 192
  br i1 %i.g, label %bb.b, label %bb.c, !prof !171
...
bb.c:                                             ; preds = %bb.a
  ...
  br i1 %i.r, label %bb.d, label %bb.e, !prof !171

bb.d:                                             ; preds = %bb.c
  %i.s = getelementptr inbounds nuw i8, ptr %i.c, i64 1
  %i.t = load i8, ptr %i.s, align 1, !tbaa !87    ; 2 uses
  ...
  store ptr %i.w, ptr %0, align 8, !tbaa !128
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %i.bd, label %bb.g, label %.critedge, !prof !124
...
bb.g:                                             ; preds = %bb.f
  ...
  store i8 1, ptr %i.bf, align 1, !tbaa !148
  store ptr @.str.95, ptr %2, align 8, !tbaa !87
  store i8 3, ptr %i.be, align 8, !tbaa !147
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #16
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #16
  %i.bg = zext nneg i32 %i.bb to i64
  store i64 %i.bg, ptr %i.a, align 8, !tbaa !94
  store ptr %i.a, ptr %3, align 8, !tbaa !87, !alias.scope !1050
  %i.bh = getelementptr inbounds nuw i8, ptr %3, i64 8
  store ptr null, ptr %i.bh, align 8, !tbaa !87, !alias.scope !1050
  %i.bi = getelementptr inbounds nuw i8, ptr %3, i64 16
  store i8 15, ptr %i.bi, align 8, !tbaa !147, !alias.scope !1050
  %i.bj = getelementptr inbounds nuw i8, ptr %3, i64 17
  store i8 1, ptr %i.bj, align 1, !tbaa !148, !alias.scope !1050
...
bb.h:                                             ; preds = %bb.e
  store ptr %i.ai, ptr %0, align 8, !tbaa !128
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #16
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #16
  %i.bk = getelementptr inbounds nuw i8, ptr %5, i64 16
  %i.bl = getelementptr inbounds nuw i8, ptr %5, i64 17
  store i8 1, ptr %i.bl, align 1, !tbaa !148
  store ptr @.str.96, ptr %5, align 8, !tbaa !87
  store i8 3, ptr %i.bk, align 8, !tbaa !147
