...
begin_hunk_0_@w2c_hermes_hermes0x3A0x3Avm0x3A0x3Aunescape0x28void0x2A0x2C0x20hermes0x3A0x3Avm0x3A0x3ARuntime0x260x2C0x20hermes0x3A0x3Avm0x3A0x3ANativeArgs0x29:bb.a
  ...
  %.0.copyload.i2962 = load i32, ptr %i.aw, align 1 ; 24 uses
...
bb.dh:                                            ; preds = %bb.cv, %bb.cr, %bb.dg, %bb.cw, %bb.ct
  ...
  %i.qe = and i32 %i.qd, 2147483646               ; 2 uses
  %5 = shl i32 %i.mk, 1
  %i.qf = add i32 %i.qe, %5
  %i.qg = add i32 %i.qf, %.10
...
bb.gk:                                            ; preds = %bb.gc, %bb.fy, %bb.gj, %bb.gd, %bb.ga
  ...
  %6 = shl nuw i32 %.0.copyload.i2962, 1
  %i.adp = and i32 %6, 2147483646                 ; 2 uses
  %7 = shl i32 %i.aao, 1
  %8 = add i32 %i.adp, %7
  %i.adq = add i32 %8, %.4
