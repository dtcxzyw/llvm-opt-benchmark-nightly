...
bb.a:
  ...
  %.not = icmp eq i64 %1, 0
  br i1 %.not, label %._crit_edge.thread, label %.lr.ph632

.lr.ph632:                                        ; preds = %bb.a, %.critedge10
  %.067630 = phi ptr [ %.7, %.critedge10 ], [ %0, %bb.a ] ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  br i1 %i.p, label %.lr.ph, label %.critedge81

.lr.ph:                                           ; preds = %bb.g, %.critedge2
  %.2608 = phi ptr [ %i.s, %.critedge2 ], [ %i.o, %bb.g ] ; 4 uses
...
.critedge2:                                       ; preds = %.lr.ph, %.lr.ph
  %i.s = getelementptr inbounds nuw i8, ptr %.2608, i64 1 ; 3 uses
...
.critedge6:                                       ; preds = %.lr.ph613, %.lr.ph613
  %.3 = getelementptr inbounds nuw i8, ptr %.3612, i64 1 ; 3 uses
...
.critedge4:                                       ; preds = %.lr.ph616
  %i.y = getelementptr inbounds nuw i8, ptr %.4615, i64 1 ; 4 uses
...
._crit_edge.thread659:                            ; preds = %.lr.ph616, %.lr.ph616, %.lr.ph616, %.lr.ph616, %.critedge4, %.critedge4.preheader
  %.4.lcssa = phi ptr [ %.3612, %.critedge4.preheader ], [ %i.y, %.critedge4 ], [ %.4615, %.lr.ph616 ], [ %.4615, %.lr.ph616 ], [ %.4615, %.lr.ph616 ], [ %.4615, %.lr.ph616 ]
...
.critedge81:                                      ; preds = %.critedge2, %.lr.ph, %.critedge6, %bb.g, %.preheader, %bb.c, %bb.d, %bb.f, %bb.e, %bb.b, %.lr.ph632
  %.5 = phi ptr [ %spec.select, %.lr.ph632 ], [ %i.g, %bb.c ], [ %.3, %.critedge6 ], [ %spec.select, %bb.b ], [ %i.k, %bb.f ], [ %i.k, %bb.e ], [ %i.g, %bb.d ], [ %.3611, %.preheader ], [ %i.o, %bb.g ], [ %i.s, %.critedge2 ], [ %.2608, %.lr.ph ] ; 3 uses
  %i.ad = icmp ult ptr %.5, %i.a
  br i1 %i.ad, label %.lr.ph626, label %.critedge10

.lr.ph626:                                        ; preds = %.critedge81, %bb.h
  %.6625 = phi ptr [ %i.af, %bb.h ], [ %.5, %.critedge81 ] ; 3 uses
  %i.ae = load i8, ptr %.6625, align 1, !tbaa !14
  %.not80 = icmp eq i8 %i.ae, 10
  br i1 %.not80, label %.critedge10, label %bb.h

bb.h:                                             ; preds = %.lr.ph626
  %i.af = getelementptr inbounds nuw i8, ptr %.6625, i64 1 ; 3 uses
  %2 = icmp ult ptr %i.af, %i.a
  br i1 %2, label %.lr.ph626, label %.critedge10, !llvm.loop !27

.critedge10:                                      ; preds = %bb.h, %.lr.ph626, %.critedge81
  %.7 = phi ptr [ %.5, %.critedge81 ], [ %i.af, %bb.h ], [ %.6625, %.lr.ph626 ] ; 2 uses
