...
_ZNKSt6vectorIN6hermes10StringKind5EntryESaIS2_EE12_M_check_lenEmPKc.exit.i.i: ; preds = %bb.f
  %2 = ashr exact i64 %i.r, 2
  %i.t = ashr exact i64 %i.r, 1                   ; 2 uses
  %3 = icmp ult i64 %i.t, %2
  %i.u = tail call i64 @llvm.umin.i64(i64 %i.t, i64 2305843009213693951)
  %4 = select i1 %3, i64 2305843009213693951, i64 %i.u ; 2 uses
  %i.v = shl nuw nsw i64 %4, 2
  %i.w = tail call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.v) #10 ; 7 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep7 = getelementptr i8, ptr %i.b, i64 %i.ai ; 2 uses
  ...
  %wide.load8 = load <4 x i32>, ptr %i.aj, align 4, !tbaa !3, !alias.scope !22, !noalias !19
  %i.ak = getelementptr i8, ptr %next.gep, i64 16
  store <4 x i32> %wide.load, ptr %next.gep, align 4, !tbaa !3, !alias.scope !19, !noalias !22
  store <4 x i32> %wide.load8, ptr %i.ak, align 4, !tbaa !3, !alias.scope !19, !noalias !22
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.al = icmp eq i64 %index.next, %n.vec
  br i1 %i.al, label %middle.block, label %vector.body, !llvm.loop !24

middle.block:                                     ; preds = %vector.body
  %ind.escape = getelementptr i8, ptr %i.ag, i64 -4
...
.lr.ph.i.i.i.i.i.preheader:                       ; preds = %_ZNKSt6vectorIN6hermes10StringKind5EntryESaIS2_EE12_M_check_lenEmPKc.exit.i.i, %middle.block
  %.012.i.i.i.i.i.ph = phi ptr [ %i.w, %_ZNKSt6vectorIN6hermes10StringKind5EntryESaIS2_EE12_M_check_lenEmPKc.exit.i.i ], [ %i.ag, %middle.block ]
  %.0911.i.i.i.i.i.ph = phi ptr [ %i.b, %_ZNKSt6vectorIN6hermes10StringKind5EntryESaIS2_EE12_M_check_lenEmPKc.exit.i.i ], [ %i.ah, %middle.block ]
  br label %.lr.ph.i.i.i.i.i

.lr.ph.i.i.i.i.i:                                 ; preds = %.lr.ph.i.i.i.i.i.preheader, %.lr.ph.i.i.i.i.i
  %.012.i.i.i.i.i = phi ptr [ %i.ao, %.lr.ph.i.i.i.i.i ], [ %.012.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.preheader ] ; 3 uses
  %.0911.i.i.i.i.i = phi ptr [ %i.an, %.lr.ph.i.i.i.i.i ], [ %.0911.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.preheader ] ; 2 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !19)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !22)
  %i.am = load i32, ptr %.0911.i.i.i.i.i, align 4, !tbaa !3, !alias.scope !22, !noalias !19
  store i32 %i.am, ptr %.012.i.i.i.i.i, align 4, !tbaa !3, !alias.scope !19, !noalias !22
  %i.an = getelementptr inbounds nuw i8, ptr %.0911.i.i.i.i.i, i64 4 ; 2 uses
  %i.ao = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i.i, i64 4
  %.not.i.i.i.i.i = icmp eq ptr %i.an, %i.d
...
_ZNSt6vectorIN6hermes10StringKind5EntryESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit22.i.i: ; preds = %.lr.ph.i.i.i.i.i, %middle.block
  ...
  %i.ap = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i.i.lcssa, i64 8
...
_ZNSt6vectorIN6hermes10StringKind5EntryESaIS2_EE17_M_realloc_insertIJRNS1_4KindEEEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i: ; preds = %bb.h, %_ZNSt6vectorIN6hermes10StringKind5EntryESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit22.i.i
  store ptr %i.w, ptr %0, align 8, !tbaa !29
  store ptr %i.ap, ptr %i.c, align 8, !tbaa !18
  %i.aq = getelementptr inbounds nuw [4 x i8], ptr %i.w, i64 %4
  store ptr %i.aq, ptr %i.l, align 8, !tbaa !16
  br label %_ZNSt6vectorIN6hermes10StringKind5EntryESaIS2_EE12emplace_backIJRNS1_4KindEEEERS2_DpOT_.exit

bb.i:                                             ; preds = %bb.c
  %i.ar = add nsw i32 %i.h, 1
  store i32 %i.ar, ptr %i.g, align 4, !tbaa !7
  br label %_ZNSt6vectorIN6hermes10StringKind5EntryESaIS2_EE12emplace_backIJRNS1_4KindEEEERS2_DpOT_.exit
...
_ZNKSt6vectorIN6hermes10StringKind5EntryESaIS2_EE12_M_check_lenEmPKc.exit.i: ; preds = %bb.c
  ...
  %2 = icmp ult i64 %i.n, %i.m
  %i.o = tail call i64 @llvm.umin.i64(i64 %i.n, i64 2305843009213693951)
  %3 = select i1 %2, i64 2305843009213693951, i64 %i.o ; 3 uses
  %.not.i.i = icmp ne i64 %3, 0
  tail call void @llvm.assume(i1 %.not.i.i)
  %i.p = shl nuw nsw i64 %3, 2
  %i.q = tail call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.p) #10 ; 8 uses
  %i.r = getelementptr inbounds nuw i8, ptr %i.q, i64 %i.k
  %i.s = load i32, ptr %1, align 4, !tbaa !9
  %i.t = or i32 %i.s, 1
  store i32 %i.t, ptr %i.r, align 4, !tbaa !7
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep5 = getelementptr i8, ptr %i.h, i64 %i.ad ; 2 uses
  ...
  %wide.load6 = load <4 x i32>, ptr %i.ae, align 4, !tbaa !3, !alias.scope !33, !noalias !30
  %i.af = getelementptr i8, ptr %next.gep, i64 16
  store <4 x i32> %wide.load, ptr %next.gep, align 4, !tbaa !3, !alias.scope !30, !noalias !33
  store <4 x i32> %wide.load6, ptr %i.af, align 4, !tbaa !3, !alias.scope !30, !noalias !33
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.ag = icmp eq i64 %index.next, %n.vec
  br i1 %i.ag, label %middle.block, label %vector.body, !llvm.loop !35
...
.lr.ph.i.i.i.i.preheader8:                        ; preds = %.lr.ph.i.i.i.i.preheader, %middle.block
  %.012.i.i.i.i.ph = phi ptr [ %i.q, %.lr.ph.i.i.i.i.preheader ], [ %i.ab, %middle.block ]
  %.0911.i.i.i.i.ph = phi ptr [ %i.h, %.lr.ph.i.i.i.i.preheader ], [ %i.ac, %middle.block ]
  br label %.lr.ph.i.i.i.i

.lr.ph.i.i.i.i:                                   ; preds = %.lr.ph.i.i.i.i.preheader8, %.lr.ph.i.i.i.i
  %.012.i.i.i.i = phi ptr [ %i.aj, %.lr.ph.i.i.i.i ], [ %.012.i.i.i.i.ph, %.lr.ph.i.i.i.i.preheader8 ] ; 2 uses
  %.0911.i.i.i.i = phi ptr [ %i.ai, %.lr.ph.i.i.i.i ], [ %.0911.i.i.i.i.ph, %.lr.ph.i.i.i.i.preheader8 ] ; 2 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !30)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !33)
  %i.ah = load i32, ptr %.0911.i.i.i.i, align 4, !tbaa !3, !alias.scope !33, !noalias !30
  store i32 %i.ah, ptr %.012.i.i.i.i, align 4, !tbaa !3, !alias.scope !30, !noalias !33
  %i.ai = getelementptr inbounds nuw i8, ptr %.0911.i.i.i.i, i64 4 ; 2 uses
  %i.aj = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i, i64 4 ; 2 uses
  %.not.i.i.i.i = icmp eq ptr %i.ai, %i.b
...
_ZNSt6vectorIN6hermes10StringKind5EntryESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit22.i: ; preds = %.lr.ph.i.i.i.i, %middle.block, %_ZNKSt6vectorIN6hermes10StringKind5EntryESaIS2_EE12_M_check_lenEmPKc.exit.i
  %.0.lcssa.i.i.i.i = phi ptr [ %i.q, %_ZNKSt6vectorIN6hermes10StringKind5EntryESaIS2_EE12_M_check_lenEmPKc.exit.i ], [ %i.ab, %middle.block ], [ %i.aj, %.lr.ph.i.i.i.i ] ; 2 uses
  %i.ak = getelementptr inbounds nuw i8, ptr %.0.lcssa.i.i.i.i, i64 4
...
_ZNSt6vectorIN6hermes10StringKind5EntryESaIS2_EE17_M_realloc_insertIJRNS1_4KindEEEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit: ; preds = %_ZNSt6vectorIN6hermes10StringKind5EntryESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit22.i, %bb.e
  ...
  store ptr %i.ak, ptr %i.a, align 8, !tbaa !18
  %i.al = getelementptr inbounds nuw [4 x i8], ptr %i.q, i64 %3
  store ptr %i.al, ptr %i.c, align 8, !tbaa !16
  br label %bb.f
...
bb.f:                                             ; preds = %_ZNSt6vectorIN6hermes10StringKind5EntryESaIS2_EE17_M_realloc_insertIJRNS1_4KindEEEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit, %bb.b
  %i.am = phi ptr [ %.0.lcssa.i.i.i.i, %_ZNSt6vectorIN6hermes10StringKind5EntryESaIS2_EE17_M_realloc_insertIJRNS1_4KindEEEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit ], [ %i.b, %bb.b ]
  ret ptr %i.am
}
