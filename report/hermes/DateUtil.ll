...
bb.a:
  ...
  %3 = fadd <2 x double> %2, <double -1.901000e+03, double -1.601000e+03>
  %4 = fdiv <2 x double> %3, <double 1.000000e+02, double 4.000000e+02> ; 2 uses
  %5 = extractelement <2 x double> %4, i64 0
  %6 = tail call double @llvm.floor.f64(double %5)
  %7 = fsub double %i.e, %6
  %8 = extractelement <2 x double> %4, i64 1
  %i.f = tail call double @llvm.floor.f64(double %8)
  %i.g = fadd double %i.f, %7
  ret double %i.g
}
...
bb.b:                                             ; preds = %bb.a
  ...
  %1 = insertelement <2 x double> poison, double %i.e, i64 0
  %2 = shufflevector <2 x double> %1, <2 x double> poison, <2 x i32> zeroinitializer
  %3 = fadd <2 x double> %2, <double -1.901000e+03, double -1.601000e+03>
  %4 = fdiv <2 x double> %3, <double 1.000000e+02, double 4.000000e+02> ; 2 uses
  %5 = extractelement <2 x double> %4, i64 0
  ...
  %7 = fsub double %i.j, %6
  %8 = extractelement <2 x double> %4, i64 1
  %i.k = tail call double @llvm.floor.f64(double %8)
  %i.l = fadd double %i.k, %7
...
.lr.ph:                                           ; preds = %bb.b, %.lr.ph
  ...
  %i.n = fadd double %.01519, -1.000000e+00       ; 5 uses
  ...
  %11 = fadd <2 x double> %10, <double -1.901000e+03, double -1.601000e+03>
  %12 = fdiv <2 x double> %11, <double 1.000000e+02, double 4.000000e+02> ; 2 uses
  %13 = extractelement <2 x double> %12, i64 0
  %14 = tail call double @llvm.floor.f64(double %13)
  %15 = fsub double %i.s, %14
  %16 = extractelement <2 x double> %12, i64 1
  %i.t = tail call double @llvm.floor.f64(double %16)
  %i.u = fadd double %i.t, %15
...
bb.d:                                             ; preds = %_ZN6hermes2vm10daysInYearEd.exit
  %i.af = fadd double %.116, 1.000000e+00         ; 4 uses
  ...
  %17 = insertelement <2 x double> poison, double %i.af, i64 0
  %18 = shufflevector <2 x double> %17, <2 x double> poison, <2 x i32> zeroinitializer
  %19 = fadd <2 x double> %18, <double -1.901000e+03, double -1.601000e+03>
  %20 = fdiv <2 x double> %19, <double 1.000000e+02, double 4.000000e+02> ; 2 uses
  %21 = extractelement <2 x double> %20, i64 0
  %22 = tail call double @llvm.floor.f64(double %21)
  %23 = fsub double %i.ak, %22
  %24 = extractelement <2 x double> %20, i64 1
  %i.al = tail call double @llvm.floor.f64(double %24)
  %i.am = fadd double %i.al, %23
...
_ZN6hermes2vm10inLeapYearEd.exit:
  ...
  %1 = insertelement <2 x double> poison, double %0, i64 0
  %2 = insertelement <2 x double> %1, double %i.g, i64 1
  %3 = fdiv <2 x double> %2, <double 8.640000e+07, double 1.000000e+02> ; 2 uses
  %4 = extractelement <2 x double> %3, i64 0
  %5 = tail call noundef double @llvm.floor.f64(double %4)
  %6 = extractelement <2 x double> %3, i64 1
  %i.h = tail call double @llvm.floor.f64(double %6)
...
_ZN6hermes2vm10inLeapYearEd.exit.thread:          ; preds = %bb.a, %_ZN6hermes2vmL10isLeapYearEd.exit.i.i, %bb.c
  ...
  %1 = fadd double %i.a, -1.601000e+03
  %2 = insertelement <2 x double> poison, double %0, i64 0
  %3 = insertelement <2 x double> %2, double %1, i64 1
  %4 = fdiv <2 x double> %3, <double 8.640000e+07, double 4.000000e+02> ; 2 uses
  %5 = extractelement <2 x double> %4, i64 0
  %6 = tail call noundef double @llvm.floor.f64(double %5)
  %7 = extractelement <2 x double> %4, i64 1
  %i.k = tail call double @llvm.floor.f64(double %7)
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.l = fadd double %i.g, %i.k                   ; 6 uses
...
_ZN6hermes2vmL10isLeapYearEd.exit:                ; preds = %bb.b, %bb.c, %bb.d
  ...
  %5 = fadd <2 x double> %4, <double -1.901000e+03, double -1.601000e+03>
  %6 = fdiv <2 x double> %5, <double 1.000000e+02, double 4.000000e+02> ; 2 uses
  %7 = extractelement <2 x double> %6, i64 0
  %8 = tail call double @llvm.floor.f64(double %7)
  %9 = fsub double %i.ab, %8
  %10 = extractelement <2 x double> %6, i64 1
  %i.ac = tail call double @llvm.floor.f64(double %10)
  %i.ad = fadd double %i.ac, %9
...
bb.a:
  ...
  %8 = shufflevector <2 x double> %7, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %9 = fdiv <2 x double> %8, <double 8.640000e+07, double 1.000000e+03> ; 2 uses
  %10 = extractelement <2 x double> %9, i64 0
  %i.i = call noundef double @llvm.floor.f64(double %10)
  ...
  call void @_ZN4llvh11raw_ostream16SetBufferAndModeEPcmNS0_10BufferKindE(ptr noundef nonnull align 8 dereferenceable(48) %3, ptr noundef null, i64 noundef 0, i32 noundef 0) #19
  %i.ae = fdiv <2 x double> %8, <double 3.600000e+06, double 6.000000e+04>
  ...
  %i.as = call double @llvm.floor.f64(double %11)
