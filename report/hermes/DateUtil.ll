...
bb.as:                                            ; preds = %_ZNK6hermes2vm10StringView14const_iteratorgtERKS2_.exit.i
  ...
  %.sroa.3.0.i163.i280 = getelementptr inbounds nuw i8, ptr %i.ig, i64 4
  br label %bb.at

bb.at:                                            ; preds = %bb.ar, %bb.as
  %.sroa.3.0.i163.i289 = phi ptr [ %.sroa.3.0.i163.i280, %bb.as ], [ %.pre257.i, %bb.ar ]
  %.1.i123287 = phi double [ %.1.i.ph, %bb.as ], [ %.1.i.ph115, %bb.ar ] ; 2 uses
  %.sroa.3.0.i155.i125285 = phi ptr [ %.sroa.3.0.i155.i, %bb.as ], [ %.sroa.3.0.i155.i120, %bb.ar ]
  %.sroa.0.0.i156.i128283 = phi ptr [ %.sroa.0.0.i156.i, %bb.as ], [ %.sroa.0.0.i156.i121, %bb.ar ]
  %.127238.i245281 = phi i32 [ %.127238.i.ph, %bb.as ], [ %.127237.i, %bb.ar ]
  %i.ik = phi ptr [ null, %bb.as ], [ %i.ii, %bb.ar ]
  %i.il = call fastcc noundef zeroext i1 @_ZN6hermes2vmL7scanIntINS0_10StringView14const_iteratorEEEbRT_S4_Ri(ptr noundef nonnull align 8 dereferenceable(16) %10, ptr %i.ik, ptr %.sroa.3.0.i163.i289, ptr noundef nonnull align 4 dereferenceable(4) %i.o)
...
bb.au:                                            ; preds = %bb.at
  ...
  %i.io = fmul nnan double %.1.i123287, %i.in
...
"_ZZN6hermes2vmL12parseISODateENS0_10StringViewERNS0_20LocalTimeOffsetCacheEENK3$_0clEDs.exit.thread": ; preds = %_ZNK6hermes2vm10StringView14const_iteratordeEv.exit.thread.i41, %.thread2.i, %_ZNK6hermes2vm10StringView14const_iteratorneERKS2_.exit.thread.i39
  ...
  %i.ja = icmp ugt ptr %i.iz, %.sroa.0.0.i156.i128283
...
_ZNK6hermes2vm10StringView14const_iteratorgtERKS2_.exit175.i: ; preds = %_ZNK6hermes2vm10StringView14const_iteratorneERKS2_.exit.i44, %_ZNK6hermes2vm10StringView14const_iteratordeEv.exit.i45, %bb.av
  ...
  %i.jc = icmp ugt ptr %i.jb, %.sroa.3.0.i155.i125285
...
bb.ax:                                            ; preds = %_ZNK6hermes2vm10StringView14const_iteratorgtERKS2_.exit175.i
  %.sroa.3.0.i178.i295 = getelementptr inbounds nuw i8, ptr %i.jb, i64 4
  br label %bb.ay

bb.ay:                                            ; preds = %bb.aw, %bb.ax
  %.sroa.3.0.i178.i296 = phi ptr [ %.sroa.3.0.i178.i295, %bb.ax ], [ %.pre259.i, %bb.aw ]
  %i.je = phi ptr [ null, %bb.ax ], [ %i.jd, %bb.aw ]
  %i.jf = call fastcc noundef zeroext i1 @_ZN6hermes2vmL7scanIntINS0_10StringView14const_iteratorEEEbRT_S4_Ri(ptr noundef nonnull align 8 dereferenceable(16) %10, ptr %i.je, ptr %.sroa.3.0.i178.i296, ptr noundef nonnull align 4 dereferenceable(4) %i.p)
...
bb.az:                                            ; preds = %bb.ay
  ...
  %i.ji = fmul nnan double %.1.i123287, %i.jh
...
"_ZZN6hermes2vmL12parseISODateENS0_10StringViewERNS0_20LocalTimeOffsetCacheEENK3$_0clEDs.exit119.thread.i": ; preds = %_ZNK6hermes2vm10StringView14const_iteratorneERKS2_.exit.thread.i101.i, %bb.az
  ...
  %.2.i.ph = phi i32 [ 0, %_ZNK6hermes2vm10StringView14const_iteratorneERKS2_.exit.thread.i101.i ], [ %.127238.i245281, %bb.az ] ; 2 uses
  %.not.i.i182.i = icmp eq ptr %.pr138, null
  br i1 %.not.i.i182.i, label %_ZNK6hermes2vm10StringView14const_iteratorneERKS2_.exit184.i, label %"_ZZN6hermes2vmL12parseISODateENS0_10StringViewERNS0_20LocalTimeOffsetCacheEENK3$_0clEDs.exit119.thread.i.thread307"

"_ZZN6hermes2vmL12parseISODateENS0_10StringViewERNS0_20LocalTimeOffsetCacheEENK3$_0clEDs.exit119.thread.i.thread307": ; preds = %_ZNK6hermes2vm10StringView14const_iteratordeEv.exit.thread.i103.i, %"_ZZN6hermes2vmL12parseISODateENS0_10StringViewERNS0_20LocalTimeOffsetCacheEENK3$_0clEDs.exit119.thread.i.thread", %"_ZZN6hermes2vmL12parseISODateENS0_10StringViewERNS0_20LocalTimeOffsetCacheEENK3$_0clEDs.exit119.thread.i"
...
_ZNK6hermes2vm10StringView14const_iteratorneERKS2_.exit184.i: ; preds = %_ZNK6hermes2vm10StringView14const_iteratorneERKS2_.exit.i106.i, %_ZNK6hermes2vm10StringView14const_iteratordeEv.exit.i118.i, %bb.an, %"_ZZN6hermes2vmL12parseISODateENS0_10StringViewERNS0_20LocalTimeOffsetCacheEENK3$_0clEDs.exit119.thread.i"
  %.2.i.ph306 = phi i32 [ %.2.i.ph, %"_ZZN6hermes2vmL12parseISODateENS0_10StringViewERNS0_20LocalTimeOffsetCacheEENK3$_0clEDs.exit119.thread.i" ], [ 0, %_ZNK6hermes2vm10StringView14const_iteratordeEv.exit.i118.i ], [ %.127238.i.ph, %bb.an ], [ 0, %_ZNK6hermes2vm10StringView14const_iteratorneERKS2_.exit.i106.i ]
  %.ph137305 = phi i32 [ %.ph137, %"_ZZN6hermes2vmL12parseISODateENS0_10StringViewERNS0_20LocalTimeOffsetCacheEENK3$_0clEDs.exit119.thread.i" ], [ 0, %_ZNK6hermes2vm10StringView14const_iteratordeEv.exit.i118.i ], [ 0, %bb.an ], [ 0, %_ZNK6hermes2vm10StringView14const_iteratorneERKS2_.exit.i106.i ]
  %.ph136304 = phi i32 [ %.ph136, %"_ZZN6hermes2vmL12parseISODateENS0_10StringViewERNS0_20LocalTimeOffsetCacheEENK3$_0clEDs.exit119.thread.i" ], [ 0, %_ZNK6hermes2vm10StringView14const_iteratordeEv.exit.i118.i ], [ 0, %bb.an ], [ 0, %_ZNK6hermes2vm10StringView14const_iteratorneERKS2_.exit.i106.i ]
...
bb.ba:                                            ; preds = %_ZNK6hermes2vm10StringView14const_iteratorneERKS2_.exit184.i, %"_ZZN6hermes2vmL12parseISODateENS0_10StringViewERNS0_20LocalTimeOffsetCacheEENK3$_0clEDs.exit119.thread.i.thread307"
  %.2.i141 = phi i32 [ %.2.i.ph306, %_ZNK6hermes2vm10StringView14const_iteratorneERKS2_.exit184.i ], [ %.2.i142, %"_ZZN6hermes2vmL12parseISODateENS0_10StringViewERNS0_20LocalTimeOffsetCacheEENK3$_0clEDs.exit119.thread.i.thread307" ]
  %i.jq = phi i32 [ %.ph137305, %_ZNK6hermes2vm10StringView14const_iteratorneERKS2_.exit184.i ], [ %i.jk, %"_ZZN6hermes2vmL12parseISODateENS0_10StringViewERNS0_20LocalTimeOffsetCacheEENK3$_0clEDs.exit119.thread.i.thread307" ]
  %i.jr = phi i32 [ %.ph136304, %_ZNK6hermes2vm10StringView14const_iteratorneERKS2_.exit184.i ], [ %i.jl, %"_ZZN6hermes2vmL12parseISODateENS0_10StringViewERNS0_20LocalTimeOffsetCacheEENK3$_0clEDs.exit119.thread.i.thread307" ]
