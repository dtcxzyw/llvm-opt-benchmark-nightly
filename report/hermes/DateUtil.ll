...
bb.b:                                             ; preds = %bb.a
  ...
  %i.n = fdiv <2 x double> %i.m, <double 1.000000e+02, double 4.000000e+02> ; 2 uses
  %1 = extractelement <2 x double> %i.n, i64 0
  %2 = tail call double @llvm.floor.f64(double %1)
  %i.o = fsub double %i.j, %2
  %i.p = extractelement <2 x double> %i.n, i64 1
  %3 = tail call double @llvm.floor.f64(double %i.p)
  %i.q = fadd double %3, %i.o
