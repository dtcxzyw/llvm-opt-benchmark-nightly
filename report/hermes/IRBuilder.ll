Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/hermes/original/IRBuilder?download=true
...
define hidden noundef nonnull ptr @_ZN6hermes9IRBuilder33createHBCGetConstructedObjectInstEPNS_17HBCCreateThisInstEPNS_16HBCConstructInstE(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(40) %0, ptr noundef %1, ptr noundef %2) local_unnamed_addr #0 align 2 {
bb.a:
  ...
  store i16 7, ptr %i.d, align 4, !tbaa !25
...
; Function Attrs: mustprogress nounwind uwtable
define hidden noundef nonnull ptr @_ZN6hermes9IRBuilder25createHBCProfilePointInstEt(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(40) %0, i16 noundef zeroext %1) local_unnamed_addr #0 align 2 {
bb.a:
...
; Function Attrs: mustprogress nounwind uwtable
define hidden noundef nonnull ptr @_ZN6hermes9IRBuilder21createCallBuiltinInstENS_13BuiltinMethod4EnumEN4llvh8ArrayRefIPNS_5ValueEEE(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(40) %0, i8 noundef zeroext %1, ptr nofree readonly captures(address) %2, i64 %3) local_unnamed_addr #0 align 2 {
bb.a:
  ...
  %i.e = tail call noundef ptr @_ZN6hermes6Module16getLiteralNumberEd(ptr noundef nonnull align 8 dereferenceable(1033) %i.a, double noundef %i.d) #14
  ...
  store i16 7, ptr %i.h, align 4, !tbaa !25
...
; Function Attrs: mustprogress nounwind uwtable
define hidden noundef nonnull ptr @_ZN6hermes9IRBuilder27createGetBuiltinClosureInstENS_13BuiltinMethod4EnumE(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(40) %0, i8 noundef zeroext %1) local_unnamed_addr #0 align 2 {
bb.a:
  %i.a = tail call noalias noundef nonnull dereferenceable(136) ptr @_Znwm(i64 noundef 136) #13 ; 21 uses
  ...
  store i16 7, ptr %i.g, align 4, !tbaa !25
...
; Function Attrs: mustprogress nounwind uwtable
define hidden noundef nonnull ptr @_ZN6hermes9IRBuilder23createHBCCallDirectInstEPNS_13LiteralStringEPNS_8FunctionEPNS_5ValueEN4llvh8ArrayRefIS6_EE(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(40) %0, ptr noundef %1, ptr noundef %2, ptr noundef %3, ptr nofree readonly captures(address) %4, i64 %5) local_unnamed_addr #0 align 2 {
bb.a:
