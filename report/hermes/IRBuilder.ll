...
begin_hunk_0_@_ZN6hermes11StringTable9getStringEN4llvh9StringRefE:bb.a
  %i.v = ptrtoint ptr %i.u to i64                 ; 3 uses
  %i.w = getelementptr inbounds nuw i8, ptr %i.p, i64 8 ; 3 uses
  %i.x = load i64, ptr %i.w, align 8, !tbaa !131  ; 2 uses
  %i.y = add i64 %i.v, 7
  %i.z = add i64 %i.y, %i.x
  %i.aa = and i64 %i.z, 7
  %.neg12 = add i64 %i.x, 7
  %5 = sub i64 %.neg12, %i.aa                     ; 3 uses
  store i64 %5, ptr %i.w, align 8, !tbaa !131
  %i.ab = add i64 %5, 16                          ; 3 uses
  %i.ac = icmp ugt i64 %i.ab, 262144
  br i1 %i.ac, label %.critedge.i.i, label %bb.d, !prof !61
...
bb.d:                                             ; preds = %bb.c
  ...
  store i64 %i.ab, ptr %i.w, align 8, !tbaa !131
  br label %_ZN6hermes28BacktrackingBumpPtrAllocator8AllocateINS_12UniqueStringEEEPT_mm.exit
...
begin_hunk_2_@_ZN6hermes11StringTable9getStringEN4llvh9StringRefE:bb.a
  %.sroa.2.0.copyload = load i64, ptr %i.c, align 8, !tbaa !133 ; 6 uses
  ...
  store i64 %i.ao, ptr %i.ak, align 8, !tbaa !131
  %i.ap = icmp ugt i64 %i.aj, 262144
  br i1 %i.ap, label %.critedge.i.i.i, label %bb.e, !prof !61
...
bb.e:                                             ; preds = %_ZN6hermes28BacktrackingBumpPtrAllocator8AllocateINS_12UniqueStringEEEPT_mm.exit
  ...
  br i1 %i.ar, label %.critedge.i.i.i, label %bb.f, !prof !61
...
bb.f:                                             ; preds = %bb.e
  ...
  store i64 %i.aq, ptr %i.ak, align 8, !tbaa !131
  br label %_ZN6hermes28BacktrackingBumpPtrAllocator8AllocateIcEEPT_mm.exit.i
end_hunk_3
