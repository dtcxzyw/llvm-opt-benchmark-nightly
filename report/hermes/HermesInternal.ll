...
begin_hunk_0_@_ZNSt5dequeIPN6hermes2vm8CallableESaIS3_EE16_M_push_back_auxIJRKS3_EEEvDpOT_:bb.a
  ...
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !410  ; 3 uses
...
_ZNSt5dequeIPN6hermes2vm8CallableESaIS3_EE22_M_reserve_map_at_backEm.exit: ; preds = %bb.c, %bb.d
  ...
  %3 = tail call noalias noundef nonnull dereferenceable(512) ptr @_Znwm(i64 noundef 512) #18 ; 4 uses
  %i.am = getelementptr inbounds nuw i8, ptr %2, i64 8 ; 2 uses
  store ptr %3, ptr %i.am, align 8, !tbaa !417
  ...
  store ptr %3, ptr %i.o, align 8, !tbaa !412
  ...
  store ptr %3, ptr %i.a, align 8, !tbaa !358
  ret void
}
...
bb.a:
  ...
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !418  ; 8 uses
  ...
  %i.l = load i64, ptr %i.k, align 8, !tbaa !414  ; 5 uses
  %i.m = shl i64 %i.j, 1
...
bb.q:                                             ; preds = %bb.p
  %i.bb = load ptr, ptr %i.d, align 8, !tbaa !417
