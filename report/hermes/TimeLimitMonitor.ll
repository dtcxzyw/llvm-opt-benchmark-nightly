...
begin_hunk_0_@_ZN6hermes2vm16TimeLimitMonitor11getOrCreateEv:bb.a
  ...
  br i1 %.not.i.i.i.i, label %_ZNKSt8weak_ptrIN6hermes2vm16TimeLimitMonitorEE4lockEv.exit.thread, label %bb.f
...
_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE23_M_add_ref_lock_nothrowEv.exit.i.i.i.i: ; preds = %bb.g
  ...
  br label %_ZNKSt8weak_ptrIN6hermes2vm16TimeLimitMonitorEE4lockEv.exit.thread

_ZNKSt14__shared_countILN9__gnu_cxx12_Lock_policyE2EE16_M_get_use_countEv.exit.i.i.i.a: ; preds = %bb.h
  %2 = load atomic i32, ptr %i.l monotonic, align 8, !noalias !11
  %.fr.i.i.i = freeze i32 %2
  %.not.i.i.i.a = icmp eq i32 %.fr.i.i.i, 0
  br i1 %.not.i.i.i.a, label %_ZNKSt8weak_ptrIN6hermes2vm16TimeLimitMonitorEE4lockEv.exit.thread, label %_ZNKSt8weak_ptrIN6hermes2vm16TimeLimitMonitorEE4lockEv.exit

_ZNKSt8weak_ptrIN6hermes2vm16TimeLimitMonitorEE4lockEv.exit.thread: ; preds = %_ZNSt10lock_guardISt5mutexEC2ERS0_.exit, %_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE23_M_add_ref_lock_nothrowEv.exit.i.i.i.i, %_ZNKSt14__shared_countILN9__gnu_cxx12_Lock_policyE2EE16_M_get_use_countEv.exit.i.i.i.a
  store ptr null, ptr %0, align 8, !tbaa !21, !alias.scope !11
  br label %bb.i

_ZNKSt8weak_ptrIN6hermes2vm16TimeLimitMonitorEE4lockEv.exit: ; preds = %_ZNKSt14__shared_countILN9__gnu_cxx12_Lock_policyE2EE16_M_get_use_countEv.exit.i.i.i.a
  ...
  br i1 %.not7, label %bb.i, label %.critedge

bb.i:                                             ; preds = %_ZNKSt8weak_ptrIN6hermes2vm16TimeLimitMonitorEE4lockEv.exit.thread, %_ZNKSt8weak_ptrIN6hermes2vm16TimeLimitMonitorEE4lockEv.exit
  %3 = load ptr, ptr %i.i, align 8, !tbaa !17     ; 8 uses
  %.not.i.i3 = icmp eq ptr %3, null
  br i1 %.not.i.i3, label %_ZNSt12__shared_ptrIN6hermes2vm16TimeLimitMonitorELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit, label %bb.j
...
bb.k:                                             ; preds = %bb.j
  ...
  tail call void %i.z(ptr noundef nonnull align 8 dereferenceable(16) %3) #15, !inline_history !29
  %i.aa = load ptr, ptr %3, align 8, !tbaa !27
  %i.ab = getelementptr inbounds nuw i8, ptr %i.aa, i64 24
  %i.ac = load ptr, ptr %i.ab, align 8
  tail call void %i.ac(ptr noundef nonnull align 8 dereferenceable(16) %3) #15, !inline_history !29
...
_ZNSt12__shared_ptrIN6hermes2vm16TimeLimitMonitorELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit: ; preds = %bb.i, %bb.k, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i, %bb.o
