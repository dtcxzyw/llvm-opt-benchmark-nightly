...
bb.g:                                             ; preds = %bb.f
  ...
  %.not5575 = icmp eq i8 %i.y, 0
  br i1 %.not5575, label %.loopexit60, label %.lr.ph79

.lr.ph79:                                         ; preds = %bb.g, %.lr.ph79
  %.277 = phi ptr [ %i.aa, %.lr.ph79 ], [ %i.x, %bb.g ]
  %.14376 = phi ptr [ %i.z, %.lr.ph79 ], [ %i.t, %bb.g ]
  %i.z = getelementptr inbounds nuw i8, ptr %.14376, i64 1 ; 2 uses
  %i.aa = getelementptr inbounds nuw i8, ptr %.277, i64 1 ; 3 uses
  %i.ab = load i8, ptr %i.z, align 1, !tbaa !7    ; 2 uses
  store i8 %i.ab, ptr %i.aa, align 1, !tbaa !7
  %.not55 = icmp eq i8 %i.ab, 0
  br i1 %.not55, label %.loopexit60, label %.lr.ph79, !llvm.loop !13

.loopexit60:                                      ; preds = %.lr.ph79, %bb.g, %bb.f
  %.3 = phi ptr [ %i.v, %bb.f ], [ %i.x, %bb.g ], [ %i.aa, %.lr.ph79 ] ; 5 uses
...
.lr.ph82.prol:                                    ; preds = %.lr.ph82.preheader
  ...
  %i.ap = mul nsw i32 %i.aj, %.041                ; 0 uses
  %i.aq = mul nsw i32 %.recomposed, 10            ; 3 uses
  store i32 %i.aq, ptr %i.a, align 4, !tbaa !3
  %i.ar = sdiv i32 %i.aq, %.041                   ; 2 uses
  %i.as = trunc i32 %i.ar to i8
  %i.at = add i8 %i.as, 48
  %i.au = getelementptr inbounds nuw i8, ptr %.3, i64 4 ; 2 uses
  store i8 %i.at, ptr %i.am, align 1, !tbaa !7
  br label %.lr.ph82.prol.loopexit

.lr.ph82.prol.loopexit:                           ; preds = %.lr.ph82.prol, %.lr.ph82.preheader
  %.lcssa.unr = phi ptr [ poison, %.lr.ph82.preheader ], [ %i.au, %.lr.ph82.prol ]
  %.unr = phi i32 [ %i.ag, %.lr.ph82.preheader ], [ %i.aq, %.lr.ph82.prol ]
  %.unr119 = phi ptr [ %i.am, %.lr.ph82.preheader ], [ %i.au, %.lr.ph82.prol ]
  %.unr120 = phi i32 [ %i.aj, %.lr.ph82.preheader ], [ %i.ar, %.lr.ph82.prol ]
  %.14781.unr = phi i32 [ %.046, %.lr.ph82.preheader ], [ %i.ao, %.lr.ph82.prol ]
  %i.av = icmp eq i32 %.046, 2
  br i1 %i.av, label %.loopexit.sink.split, label %.lr.ph82

.lr.ph82:                                         ; preds = %.lr.ph82.prol.loopexit, %.lr.ph82
  %i.aw = phi i32 [ %i.bi, %.lr.ph82 ], [ %.unr, %.lr.ph82.prol.loopexit ]
  %i.ax = phi ptr [ %i.bm, %.lr.ph82 ], [ %.unr119, %.lr.ph82.prol.loopexit ] ; 3 uses
  %i.ay = phi i32 [ %i.bj, %.lr.ph82 ], [ %.unr120, %.lr.ph82.prol.loopexit ]
  %.14781 = phi i32 [ %i.bg, %.lr.ph82 ], [ %.14781.unr, %.lr.ph82.prol.loopexit ] ; 2 uses
  %i.az = mul nsw i32 %i.ay, %.041
  %i.ba = sub nsw i32 %i.aw, %i.az
  ...
  %i.bn = icmp slt i32 %.14781, 4
  br i1 %i.bn, label %.loopexit.sink.split, label %.lr.ph82
...
.lr.ph:                                           ; preds = %.preheader63, %bb.p
  ...
  %.pre91 = load i8, ptr %i.by, align 1, !tbaa !7 ; 2 uses
  br i1 %i.cc, label %bb.n, label %bb.p

bb.n:                                             ; preds = %.lr.ph
  %.not52 = icmp eq i8 %.pre91, 0
...
bb.p:                                             ; preds = %bb.o, %.lr.ph
  %i.ce = phi i8 [ %.pre, %bb.o ], [ %.pre91, %.lr.ph ] ; 2 uses
...
thread-pre-split:                                 ; preds = %bb.p, %.thread
  %.997 = phi ptr [ %i.bz, %.thread ], [ %.9, %bb.p ] ; 2 uses
...
.lr.ph67.preheader:                               ; preds = %.preheader63, %thread-pre-split
  %.1066.ph = phi ptr [ %.0, %.preheader63 ], [ %.997, %thread-pre-split ]
  br label %.lr.ph67
...
.loopexit.sink.split:                             ; preds = %.lr.ph67, %.lr.ph82.prol.loopexit, %.lr.ph82, %thread-pre-split, %.preheader59
  %.lcssa.sink = phi ptr [ %i.bm, %.lr.ph82 ], [ %i.am, %.preheader59 ], [ %.997, %thread-pre-split ], [ %.lcssa.unr, %.lr.ph82.prol.loopexit ], [ %i.cg, %.lr.ph67 ]
