...
bb.b:                                             ; preds = %bb.a
  ...
  store ptr %i.h, ptr %i.b, align 8, !tbaa !246
  br label %bb.c
...
._crit_edge:                                      ; preds = %_ZN6hermes11Instruction10setOperandEPNS_5ValueEj.exit, %bb.a
  ...
  tail call void @_ZN6hermes5Value7destroyEPS0_(ptr noundef nonnull %i.i), !inline_history !261
  ret void
...
_ZN6hermes11Instruction10setOperandEPNS_5ValueEj.exit: ; preds = %bb.b, %_ZN6hermes5Value9removeUseESt4pairIPS0_jE.exit.i
  ...
  br i1 %i.as, label %bb.b, label %._crit_edge, !llvm.loop !262
}
...
_ZN6hermes11Instruction10setOperandEPNS_5ValueEj.exit.i: ; preds = %_ZN6hermes5Value9removeUseESt4pairIPS0_jE.exit.i.i, %bb.f
  ...
  br i1 %i.cm, label %bb.f, label %_ZN6hermes11Instruction15eraseFromParentEv.exit, !llvm.loop !262
...
._crit_edge:                                      ; preds = %_ZN6hermes11Instruction15eraseFromParentEv.exit, %bb.a
  ...
  tail call void @_ZN6hermes5Value7destroyEPS0_(ptr noundef nonnull %i.cw), !inline_history !265
  ret void
}
