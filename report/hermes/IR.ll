...
.lr.ph109.prol:                                   ; preds = %.lr.ph109.preheader229, %.lr.ph109.prol
  ...
  %4 = load i8, ptr %.159105.prol, align 1, !tbaa !66
  %5 = load i8, ptr %.055106.prol, align 1, !tbaa !66
  store i8 %5, ptr %.159105.prol, align 1, !tbaa !66
  store i8 %4, ptr %.055106.prol, align 1, !tbaa !66
...
.lr.ph109:                                        ; preds = %.lr.ph109.prol.loopexit, %.lr.ph109
  ...
  %12 = load i8, ptr %.159105, align 1, !tbaa !66
  %13 = load i8, ptr %.055106, align 1, !tbaa !66
  store i8 %13, ptr %.159105, align 1, !tbaa !66
  store i8 %12, ptr %.055106, align 1, !tbaa !66
  %14 = getelementptr inbounds nuw i8, ptr %.159105, i64 1 ; 2 uses
  %15 = getelementptr inbounds nuw i8, ptr %.055106, i64 1 ; 2 uses
  %16 = load i8, ptr %14, align 1, !tbaa !66
  %17 = load i8, ptr %15, align 1, !tbaa !66
  store i8 %17, ptr %14, align 1, !tbaa !66
  store i8 %16, ptr %15, align 1, !tbaa !66
  %18 = getelementptr inbounds nuw i8, ptr %.159105, i64 2 ; 2 uses
  %19 = getelementptr inbounds nuw i8, ptr %.055106, i64 2 ; 2 uses
  %20 = load i8, ptr %18, align 1, !tbaa !66
  %21 = load i8, ptr %19, align 1, !tbaa !66
  store i8 %21, ptr %18, align 1, !tbaa !66
  store i8 %20, ptr %19, align 1, !tbaa !66
  %22 = getelementptr inbounds nuw i8, ptr %.159105, i64 3 ; 2 uses
  %23 = getelementptr inbounds nuw i8, ptr %.055106, i64 3 ; 2 uses
  %i.bf = load i8, ptr %22, align 1, !tbaa !66
  %i.bg = load i8, ptr %23, align 1, !tbaa !66
  store i8 %i.bg, ptr %22, align 1, !tbaa !66
  store i8 %i.bf, ptr %23, align 1, !tbaa !66
  ...
  br i1 %exitcond118.not, label %._crit_edge110, label %.lr.ph109, !llvm.loop !520
...
begin_hunk_2_@_ZNSt3_V28__rotateIPcEET_S2_S2_S2_St26random_access_iterator_tag:bb.a
  ...
  %wide.load158 = load <16 x i8>, ptr %i.cb, align 1, !tbaa !66, !alias.scope !521, !noalias !524
  %i.cc = getelementptr inbounds i8, ptr %next.gep155, i64 -16 ; 2 uses
  %wide.load159 = load <16 x i8>, ptr %i.cc, align 1, !tbaa !66, !alias.scope !524
  store <16 x i8> %wide.load159, ptr %i.cb, align 1, !tbaa !66, !alias.scope !521, !noalias !524
  store <16 x i8> %wide.load158, ptr %i.cc, align 1, !tbaa !66, !alias.scope !524
  %index.next163 = add nuw i64 %index154, 16      ; 2 uses
  %i.cd = icmp eq i64 %index.next163, %n.vec152
  br i1 %i.cd, label %middle.block164, label %vector.body153, !llvm.loop !526
...
vec.epilog.iter.check:                            ; preds = %middle.block164
  ...
  br i1 %min.epilog.iters.check.not.not, label %.lr.ph.preheader, label %vec.epilog.ph, !prof !527
...
begin_hunk_4_@_ZNSt3_V28__rotateIPcEET_S2_S2_S2_St26random_access_iterator_tag:bb.a
  ...
  %wide.load173 = load <8 x i8>, ptr %i.ck, align 1, !tbaa !66, !alias.scope !521, !noalias !524
  %i.cl = getelementptr inbounds i8, ptr %next.gep171, i64 -8 ; 2 uses
  %wide.load175 = load <8 x i8>, ptr %i.cl, align 1, !tbaa !66, !alias.scope !524
  store <8 x i8> %wide.load175, ptr %i.ck, align 1, !tbaa !66, !alias.scope !521, !noalias !524
  store <8 x i8> %wide.load173, ptr %i.cl, align 1, !tbaa !66, !alias.scope !524
  %index.next179 = add nuw i64 %index170, 8       ; 2 uses
  %i.cm = icmp eq i64 %index.next179, %n.vec169
  br i1 %i.cm, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !528
