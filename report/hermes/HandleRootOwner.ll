...
begin_hunk_0_@_ZN6hermes2vm15HandleRootOwner12markGCScopesERNS0_12RootAcceptorE:bb.a
  ...
  tail call void %i.p(ptr noundef nonnull align 8 dereferenceable(8) %1, ptr noundef nonnull align 8 dereferenceable(8) %.01318.i) #4, !inline_history !25
...
._crit_edge.i:                                    ; preds = %.lr.ph.i, %bb.b
  ...
  br i1 %.not.i, label %_ZN6hermes2vm7GCScope4markERNS0_12RootAcceptorE.exit, label %bb.b, !llvm.loop !28
...
._crit_edge:                                      ; preds = %.lr.ph, %bb.a
  ...
  br i1 %.not, label %._crit_edge23, label %bb.a, !llvm.loop !28
}
...
bb.a:
  ...
  %i.c = load ptr, ptr %0, align 8, !tbaa !31, !nonnull !32, !align !33
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %.not.i, label %_ZN4llvh23SmallVectorTemplateBaseIPN6hermes2vm17PinnedHermesValueELb1EE9push_backERKS4_.exit, label %bb.c, !prof !39
...
begin_hunk_4_@_ZN6hermes2vm7GCScope15_newChunkAndPHVENS0_11HermesValueE:bb.a
  ...
  %i.r = load i32, ptr %i.e, align 8, !tbaa !36
  %i.s = add i32 %i.r, 1                          ; 2 uses
  store i32 %i.s, ptr %i.e, align 8, !tbaa !36
...
begin_hunk_5_@_ZN6hermes2vm7GCScope15_newChunkAndPHVENS0_11HermesValueE:bb.a
  ...
  store ptr %i.ae, ptr %i.ab, align 8, !tbaa !40
  store i64 %1, ptr %i.aa, align 8, !tbaa !41
  ret ptr %i.aa
}
...
!25 = !{ptr @_ZN6hermes2vm7GCScope4markERNS0_12RootAcceptorE}
!26 = distinct !{!26, !27}
...
!33 = !{i64 8}
!34 = !{!35, !8, i64 8}
!35 = !{!"_ZTSN6hermes2vm15HandleRootOwnerE", !8, i64 8}
!36 = !{!11, !4, i64 8}
!37 = distinct !{!37, !27}
!38 = !{!11, !4, i64 12}
