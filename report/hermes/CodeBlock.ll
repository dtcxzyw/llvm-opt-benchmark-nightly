...
bb.c:                                             ; preds = %bb.b
  ...
  call void %i.q(ptr noundef nonnull align 8 dereferenceable(280) %i.m) #7, !inline_history !97
...
begin_hunk_1_@_ZNK6hermes2vm9CodeBlock19getFunctionSourceIDEv:bb.a
  ...
  %.sroa.0.0.copyload.i = load ptr, ptr %i.d, align 8, !tbaa !98 ; 3 uses
...
begin_hunk_2_@_ZNK6hermes2vm9CodeBlock19getFunctionSourceIDEv:bb.a
  ...
  br i1 %i.n, label %_ZSt9__advanceIPKSt4pairIjjElEvRT_T0_St26random_access_iterator_tag.exit.i.i, label %"_ZSt11lower_boundIPKSt4pairIjjEjZNK6hermes2vm9CodeBlock19getFunctionSourceIDEvE3$_0ET_S8_S8_RKT0_T1_.exit", !llvm.loop !99
...
bb.b:                                             ; preds = %"_ZSt11lower_boundIPKSt4pairIjjEjZNK6hermes2vm9CodeBlock19getFunctionSourceIDEvE3$_0ET_S8_S8_RKT0_T1_.exit"
  %i.p = load i32, ptr %.0.lcssa.i.i, align 4, !tbaa !101
...
.lr.ph:                                           ; preds = %bb.a, %bb.c
  ...
  %i.f = load i32, ptr %.013, align 4, !tbaa !105
...
!101 = !{!102, !4, i64 0}
!102 = !{!"_ZTSSt4pairIjjE", !4, i64 0, !4, i64 4}
!103 = !{!89, !4, i64 4}
!104 = !{!89, !4, i64 8}
!105 = !{!106, !4, i64 0}
!106 = !{!"_ZTSN6hermes2vm12BasedPointerE", !4, i64 0}
end_hunk_7
