...
_ZN4llvh3sys2fs15directory_entryaSEOS2_.exit:     ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_S_copyEPcPKcm.exit.i.i, %bb.j, %bb.k
  %i.bg = phi ptr [ %i.al, %bb.j ], [ %i.ap, %bb.k ], [ %.pre.i.i8, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_S_copyEPcPKcm.exit.i.i ]
...
bb.l:                                             ; preds = %_ZN4llvh3sys2fs15directory_entryD2Ev.exit, %bb.e
  ...
  br i1 %i.bs, label %_ZN4llvh11SmallVectorIcLj128EED2Ev.exit, label %bb.m
...
bb.a:
  ...
  %cond23 = icmp eq ptr %i.e, null
  br i1 %cond23, label %tailrecurse._crit_edge, label %.lr.ph
...
bb.f:                                             ; preds = %tailrecurse._crit_edge
  ...
  br i1 %.not.i, label %_ZN4llvh3sys2fs15directory_entryaSEOS2_.exit.i, label %bb.g
...
_ZN4llvh3sys2fs15directory_entryaSEOS2_.exit.i:   ; preds = %bb.g, %bb.f
  ...
  %i.aq = load ptr, ptr %1, align 8, !tbaa !44    ; 2 uses
  %i.ar = icmp eq ptr %i.aq, %i.ai
  br i1 %i.ar, label %_ZN4llvh3sys2fs6detail27directory_iterator_destructERNS2_12DirIterStateE.exit, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i: ; preds = %_ZN4llvh3sys2fs15directory_entryaSEOS2_.exit.i
  %i.as = load i64, ptr %i.ai, align 8, !tbaa !12
  %i.at = add i64 %i.as, 1
...
_ZN4llvh3sys2fs6detail27directory_iterator_destructERNS2_12DirIterStateE.exit: ; preds = %_ZN4llvh3sys2fs15directory_entryaSEOS2_.exit.i, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i
  ...
  %i.au = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSt3_V215system_categoryEv() #31
  br label %bb.h
...
bb.h:                                             ; preds = %_ZN4llvh3sys2fsL10direntTypeEP6dirent.exit, %_ZN4llvh3sys2fs6detail27directory_iterator_destructERNS2_12DirIterStateE.exit, %bb.b
  ...
  %.pn15 = phi ptr [ %i.au, %_ZN4llvh3sys2fs6detail27directory_iterator_destructERNS2_12DirIterStateE.exit ], [ %i.g, %bb.b ], [ %i.ac, %_ZN4llvh3sys2fsL10direntTypeEP6dirent.exit ]
...
bb.a:
  ...
  br i1 %.not, label %_ZN4llvh3sys2fs15directory_entryaSEOS2_.exit, label %bb.b
...
_ZN4llvh3sys2fs15directory_entryaSEOS2_.exit:     ; preds = %bb.b, %bb.a
  store i64 0, ptr %0, align 8, !tbaa !192
  call void @llvm.lifetime.start.p0(ptr nonnull %1) #30
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %i.l, ptr noundef nonnull align 8 dereferenceable(48) %i.m, i64 48, i1 false)
  %i.n = load ptr, ptr %1, align 8, !tbaa !44     ; 2 uses
  %i.o = icmp eq ptr %i.n, %i.e
  br i1 %i.o, label %_ZN4llvh3sys2fs15directory_entryD2Ev.exit, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i: ; preds = %_ZN4llvh3sys2fs15directory_entryaSEOS2_.exit
  %i.p = load i64, ptr %i.e, align 8, !tbaa !12
  %i.q = add i64 %i.p, 1
...
_ZN4llvh3sys2fs15directory_entryD2Ev.exit:        ; preds = %_ZN4llvh3sys2fs15directory_entryaSEOS2_.exit, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i
  ...
  %.fca.1.insert = insertvalue { i32, ptr } { i32 0, ptr poison }, ptr %i.r, 1
  ret { i32, ptr } %.fca.1.insert
}
