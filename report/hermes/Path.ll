...
@_ZZN4llvh3sys2fsL13hasProcSelfFDEvE6Result = internal global i8 0, align 1
...
define hidden void @_ZN4llvh3sys4path5beginENS_9StringRefENS1_5StyleE(ptr dead_on_unwind noalias nofree writable writeonly sret(%"class.llvh::sys::path::const_iterator") align 8 captures(none) initializes((0, 44)) %0, ptr %1, i64 %2, i32 noundef %3) local_unnamed_addr #0 {
bb.a:
  ...
  %i.b = icmp eq i64 %2, 0
  br i1 %i.b, label %_ZN12_GLOBAL__N_120find_first_componentEN4llvh9StringRefENS0_3sys4path5StyleE.exit, label %bb.b

bb.b:                                             ; preds = %bb.a
  %.not92.i = icmp eq i32 %3, 0                   ; 6 uses
  %.pre97.pre.i = load i8, ptr %1, align 1, !tbaa !12 ; 6 uses
  br i1 %.not92.i, label %bb.c, label %bb.f

bb.c:                                             ; preds = %bb.b
  %.not93.i = icmp eq i64 %2, 1
  br i1 %.not93.i, label %.thread.i, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.c = zext i8 %.pre97.pre.i to i32
  %i.d = tail call i32 @isalpha(i32 noundef %i.c) #29
...
bb.e:                                             ; preds = %bb.d
  ...
  br i1 %i.g, label %_ZN12_GLOBAL__N_120find_first_componentEN4llvh9StringRefENS0_3sys4path5StyleE.exit, label %bb.f

bb.f:                                             ; preds = %bb.e, %bb.d, %bb.b
  %i.h = icmp ugt i64 %2, 2
  br i1 %i.h, label %bb.g, label %.thread.i

bb.g:                                             ; preds = %bb.f
  %i.i = icmp eq i8 %.pre97.pre.i, 47
  %i.j = icmp eq i8 %.pre97.pre.i, 92
  %spec.select.i.i = and i1 %.not92.i, %i.j
  %or.cond.i = or i1 %i.i, %spec.select.i.i
  br i1 %or.cond.i, label %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit.thread.i, label %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit37.thread.sink.split.i

_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit.thread.i: ; preds = %bb.g
  %i.k = getelementptr inbounds nuw i8, ptr %1, i64 1
  %i.l = load i8, ptr %i.k, align 1, !tbaa !12
  %i.m = icmp eq i8 %.pre97.pre.i, %i.l
  br i1 %i.m, label %bb.h, label %.thread.i

bb.h:                                             ; preds = %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit.thread.i
  %i.n = getelementptr inbounds nuw i8, ptr %1, i64 2
  %i.o = load i8, ptr %i.n, align 1, !tbaa !12    ; 2 uses
  %i.p = icmp eq i8 %i.o, 47
  %i.q = icmp eq i8 %i.o, 92
  %spec.select.i28.i = and i1 %.not92.i, %i.q
  %or.cond99.i = or i1 %i.p, %spec.select.i28.i
  br i1 %or.cond99.i, label %.thread.i, label %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit37.thread.sink.split.i

.thread.i:                                        ; preds = %bb.h, %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit.thread.i, %bb.f, %bb.c
  %i.r = icmp eq i8 %.pre97.pre.i, 47
  %i.s = icmp eq i8 %.pre97.pre.i, 92
  %spec.select.i35.i = and i1 %.not92.i, %i.s
  %or.cond100.i = or i1 %i.r, %spec.select.i35.i
  br i1 %or.cond100.i, label %_ZN12_GLOBAL__N_120find_first_componentEN4llvh9StringRefENS0_3sys4path5StyleE.exit, label %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit37.thread.sink.split.i

_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit37.thread.sink.split.i: ; preds = %bb.g, %.thread.i, %bb.h
  %.sink102.i = phi i64 [ 2, %bb.h ], [ 0, %.thread.i ], [ 0, %bb.g ]
  %.str.11..str.1.i41.i = select i1 %.not92.i, ptr @.str.11, ptr @.str.1
  %i.t = select i1 %.not92.i, i64 2, i64 1
  %i.u = call noundef i64 @_ZNK4llvh9StringRef13find_first_ofES0_m(ptr noundef nonnull align 8 dereferenceable(16) %4, ptr nonnull %.str.11..str.1.i41.i, i64 %i.t, i64 noundef %.sink102.i) #30
  %i.v = load i64, ptr %i.a, align 8, !tbaa !10
  %i.w = load ptr, ptr %4, align 8, !tbaa !13
  %.sroa.speculated.i = call i64 @llvm.umin.i64(i64 %i.v, i64 %i.u)
  br label %_ZN12_GLOBAL__N_120find_first_componentEN4llvh9StringRefENS0_3sys4path5StyleE.exit

_ZN12_GLOBAL__N_120find_first_componentEN4llvh9StringRefENS0_3sys4path5StyleE.exit: ; preds = %bb.a, %bb.e, %.thread.i, %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit37.thread.sink.split.i
  %.pn96.i = phi ptr [ %1, %.thread.i ], [ %1, %bb.a ], [ %1, %bb.e ], [ %i.w, %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit37.thread.sink.split.i ]
  %.pn94.i = phi i64 [ 1, %.thread.i ], [ 0, %bb.a ], [ 2, %bb.e ], [ %.sroa.speculated.i, %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit37.thread.sink.split.i ]
  call void @llvm.lifetime.end.p0(ptr nonnull %4)
  %i.x = getelementptr inbounds nuw i8, ptr %0, i64 16
  store ptr %.pn96.i, ptr %i.x, align 8, !tbaa !7
  %.sroa.4.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 24
  store i64 %.pn94.i, ptr %.sroa.4.0..sroa_idx, align 8, !tbaa !10
  %i.y = getelementptr inbounds nuw i8, ptr %0, i64 32
  store i64 0, ptr %i.y, align 8, !tbaa !15
  %i.z = getelementptr inbounds nuw i8, ptr %0, i64 40
  store i32 %3, ptr %i.z, align 8, !tbaa !18
  ret void
}
...
define hidden void @_ZN4llvh3sys4path3endENS_9StringRefE(ptr dead_on_unwind noalias nofree writable writeonly sret(%"class.llvh::sys::path::const_iterator") align 8 captures(none) initializes((0, 40)) %0, ptr %1, i64 %2) local_unnamed_addr #2 {
bb.a:
  ...
  store i64 %2, ptr %i.b, align 8, !tbaa !15
  ret void
}

; Function Attrs: mustprogress nounwind uwtable
define hidden noundef nonnull align 8 dereferenceable(44) ptr @_ZN4llvh3sys4path14const_iteratorppEv(ptr noundef nonnull returned align 8 dereferenceable(44) %0) local_unnamed_addr #0 align 2 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 7 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 24 ; 4 uses
  %i.c = load i64, ptr %i.b, align 8, !tbaa !19   ; 5 uses
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 32 ; 6 uses
  %i.e = load i64, ptr %i.d, align 8, !tbaa !15
  %i.f = add i64 %i.e, %i.c                       ; 8 uses
  store i64 %i.f, ptr %i.d, align 8, !tbaa !15
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
  %i.h = load i64, ptr %i.g, align 8, !tbaa !19   ; 8 uses
...
bb.c:                                             ; preds = %bb.a
  %i.j = icmp ugt i64 %i.c, 2
  br i1 %i.j, label %bb.d, label %._ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit17_crit_edge

._ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit17_crit_edge: ; preds = %bb.c
  %.phi.trans.insert = getelementptr inbounds nuw i8, ptr %0, i64 40
  %.pre = load i32, ptr %.phi.trans.insert, align 8, !tbaa !18
  br label %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit17

bb.d:                                             ; preds = %bb.c
  %i.k = load ptr, ptr %i.a, align 8, !tbaa !13   ; 3 uses
  %i.l = load i8, ptr %i.k, align 1, !tbaa !12    ; 3 uses
  %i.m = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.n = load i32, ptr %i.m, align 8, !tbaa !18   ; 6 uses
  %i.o = icmp eq i8 %i.l, 47
  br i1 %i.o, label %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit.thread, label %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit

_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit: ; preds = %bb.d
  %.not.i12 = icmp eq i32 %i.n, 0
  %i.p = icmp eq i8 %i.l, 92
  %spec.select.i = and i1 %i.p, %.not.i12
  br i1 %spec.select.i, label %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit.thread, label %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit17

_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit.thread: ; preds = %bb.d, %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit
  %i.q = getelementptr inbounds nuw i8, ptr %i.k, i64 1
  %i.r = load i8, ptr %i.q, align 1, !tbaa !12
  %i.s = icmp eq i8 %i.r, %i.l
  br i1 %i.s, label %bb.e, label %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit17

bb.e:                                             ; preds = %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit.thread
  %i.t = getelementptr inbounds nuw i8, ptr %i.k, i64 2
  %i.u = load i8, ptr %i.t, align 1, !tbaa !12    ; 2 uses
  %i.v = icmp eq i8 %i.u, 47
  br i1 %i.v, label %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit17, label %bb.f

bb.f:                                             ; preds = %bb.e
  %.not.i14 = icmp ne i32 %i.n, 0
  %i.w = icmp ne i8 %i.u, 92
  %spec.select.i15.not = or i1 %.not.i14, %i.w
  br label %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit17

_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit17: ; preds = %._ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit17_crit_edge, %bb.f, %bb.e, %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit.thread, %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit
  %i.x = phi i32 [ %i.n, %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit.thread ], [ %i.n, %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit ], [ %.pre, %._ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit17_crit_edge ], [ %i.n, %bb.e ], [ %i.n, %bb.f ]
  %i.y = phi i1 [ false, %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit.thread ], [ false, %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit ], [ false, %._ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit17_crit_edge ], [ false, %bb.e ], [ %spec.select.i15.not, %bb.f ]
  %i.z = load ptr, ptr %0, align 8, !tbaa !13     ; 4 uses
  %i.aa = getelementptr inbounds nuw i8, ptr %i.z, i64 %i.f
  %i.ab = load i8, ptr %i.aa, align 1, !tbaa !12  ; 2 uses
  %.fr = freeze i32 %i.x                          ; 4 uses
  %i.ac = icmp eq i8 %i.ab, 47
  br i1 %i.ac, label %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit21.thread, label %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit21

_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit21: ; preds = %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit17
  %.not.i18 = icmp eq i32 %.fr, 0
  %i.ad = icmp eq i8 %i.ab, 92
  %spec.select.i19 = and i1 %i.ad, %.not.i18
  br i1 %spec.select.i19, label %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit21.thread, label %_ZN4llvh9StringRefC2EPKc.exit

_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit21.thread: ; preds = %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit17, %_ZN4llvh3sys4path12is_separatorEcNS1_5StyleE.exit21
  br i1 %i.y, label %_ZNK4llvh9StringRef8endswithES0_.exit.thread54, label %bb.g
end_hunk_0
begin_hunk_1_@_ZN4llvh3sys2fsL18copy_file_internalEii:bb.a
...
; Function Attrs: mustprogress nounwind uwtable
define hidden void @_ZN4llvh3sys2fs12md5_contentsEi(ptr dead_on_unwind noalias nofree writable sret(%"class.llvh::ErrorOr") align 8 captures(none) %0, i32 noundef %1) local_unnamed_addr #0 {
bb.a:
...
; Function Attrs: mustprogress nounwind uwtable
define hidden void @_ZN4llvh3sys2fs12md5_contentsERKNS_5TwineE(ptr dead_on_unwind noalias nofree writable sret(%"class.llvh::ErrorOr") align 8 captures(none) %0, ptr noundef nonnull align 8 dereferenceable(18) %1) local_unnamed_addr #0 {
bb.a:
  %i.a = alloca i32, align 4                      ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #30
...
define hidden noundef zeroext i1 @_ZN4llvh3sys2fs6existsERKNS1_17basic_file_statusE(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(40) %0) local_unnamed_addr #6 {
bb.a:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define hidden noundef zeroext i1 @_ZN4llvh3sys2fs12status_knownERKNS1_17basic_file_statusE(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(40) %0) local_unnamed_addr #6 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.b = load i32, ptr %i.a, align 8, !tbaa !151
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define hidden noundef zeroext i1 @_ZN4llvh3sys2fs12is_directoryERKNS1_17basic_file_statusE(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(40) %0) local_unnamed_addr #6 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.b = load i32, ptr %i.a, align 8, !tbaa !151
...
; Function Attrs: mustprogress nounwind uwtable
define hidden { i32, ptr } @_ZN4llvh3sys2fs12is_directoryERKNS_5TwineERb(ptr noundef nonnull align 8 dereferenceable(18) %0, ptr nofree noundef nonnull writeonly align 1 captures(none) dereferenceable(1) %1) local_unnamed_addr #0 {
bb.a:
  %2 = alloca %"class.llvh::SmallString.11", align 8 ; 8 uses
  %3 = alloca %struct.stat, align 8               ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #30
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define hidden noundef zeroext i1 @_ZN4llvh3sys2fs15is_regular_fileERKNS1_17basic_file_statusE(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(40) %0) local_unnamed_addr #6 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.b = load i32, ptr %i.a, align 8, !tbaa !151
...
; Function Attrs: mustprogress nounwind uwtable
define hidden { i32, ptr } @_ZN4llvh3sys2fs15is_regular_fileERKNS_5TwineERb(ptr noundef nonnull align 8 dereferenceable(18) %0, ptr nofree noundef nonnull writeonly align 1 captures(none) dereferenceable(1) %1) local_unnamed_addr #0 {
bb.a:
  %2 = alloca %"class.llvh::SmallString.11", align 8 ; 8 uses
  %3 = alloca %struct.stat, align 8               ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #30
...
_ZN4llvh3sys2fsL11typeForModeEj.exit.i:           ; preds = %bb.a
  ...
  %switch.select = zext i1 %switch.selectcmp to i8
end_hunk_1
begin_hunk_2_@_ZN4llvh3sys2fs6accessERKNS_5TwineENS1_10AccessModeE:bb.a
...
_ZN4llvh3sys2fsL11typeForModeEj.exit:             ; preds = %bb.e, %switch.lookup
  ...
  %i.w = load <2 x i64>, ptr %i.n, align 8, !tbaa !10
  store i64 %i.p, ptr %2, align 8
  store i64 %i.r, ptr %.sroa.4.0..sroa_idx, align 8
  store <2 x i32> %i.v, ptr %.sroa.5.0..sroa_idx, align 8
  ...
  store i64 %i.m, ptr %.sroa.10.0..sroa_idx, align 8
  %i.x = shufflevector <2 x i64> %i.w, <2 x i64> poison, <2 x i32> <i32 1, i32 0>
  store <2 x i64> %i.x, ptr %.sroa.11.0..sroa_idx, align 8
  %i.y = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSt3_V215system_categoryEv() #31
  br label %bb.f
...
bb.f:                                             ; preds = %bb.c, %bb.d, %_ZN4llvh3sys2fsL11typeForModeEj.exit
  ...
  %.sroa.427.0 = phi ptr [ %i.y, %_ZN4llvh3sys2fsL11typeForModeEj.exit ], [ %i.c, %bb.c ], [ %i.c, %bb.d ]
...
_ZN4llvh3sys2fs18mapped_file_region4initEimNS2_7mapmodeE.exit.thread: ; preds = %bb.a
  ...
  br label %bb.c
end_hunk_2
begin_hunk_3_@_ZN4llvh3sys2fs6detail28directory_iterator_constructERNS2_12DirIterStateENS_9StringRefEb:bb.a
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_S_copyEPcPKcm.exit.i.i.i: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i.i
  ...
  store i64 0, ptr %i.as, align 8, !tbaa !47
...
_ZN4llvh3sys2fs15directory_entryaSEOS2_.exit.i:   ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_S_copyEPcPKcm.exit.i.i.i, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i.i
  %i.at = phi ptr [ %.pre.i.i.i, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_S_copyEPcPKcm.exit.i.i.i ], [ %i.an, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i.i ]
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %i.au, ptr noundef nonnull align 8 dereferenceable(48) %i.av, i64 48, i1 false)
  %i.aw = load ptr, ptr %1, align 8, !tbaa !44    ; 2 uses
  %i.ax = icmp eq ptr %i.aw, %i.an
  br i1 %i.ax, label %_ZN4llvh3sys2fs6detail27directory_iterator_destructERNS2_12DirIterStateE.exit, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i: ; preds = %_ZN4llvh3sys2fs15directory_entryaSEOS2_.exit.i
  %i.ay = load i64, ptr %i.an, align 8, !tbaa !12
  %i.az = add i64 %i.ay, 1
...
_ZN4llvh3sys2fs6detail27directory_iterator_destructERNS2_12DirIterStateE.exit: ; preds = %_ZN4llvh3sys2fs15directory_entryaSEOS2_.exit.i, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i
  ...
  %i.ba = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSt3_V215system_categoryEv() #31
  br label %bb.h
...
bb.h:                                             ; preds = %_ZN4llvh3sys2fsL10direntTypeEP6dirent.exit, %_ZN4llvh3sys2fs6detail27directory_iterator_destructERNS2_12DirIterStateE.exit, %bb.b
  ...
  %.pn15 = phi ptr [ %i.ba, %_ZN4llvh3sys2fs6detail27directory_iterator_destructERNS2_12DirIterStateE.exit ], [ %i.g, %bb.b ], [ %i.ah, %_ZN4llvh3sys2fsL10direntTypeEP6dirent.exit ]
...
; Function Attrs: mustprogress nounwind uwtable
define hidden void @_ZN4llvh3sys2fs14openNativeFileERKNS_5TwineENS1_19CreationDispositionENS1_10FileAccessENS1_9OpenFlagsEj(ptr dead_on_unwind noalias nofree writable sret(%"class.llvh::Expected") align 8 captures(none) initializes((0, 4)) %0, ptr noundef nonnull align 8 dereferenceable(18) %1, i32 noundef %2, i32 noundef %3, i32 noundef %4, i32 noundef %5) local_unnamed_addr #0 {
bb.a:
  %i.a = alloca i32, align 4                      ; 4 uses
...
bb.c:                                             ; preds = %bb.b, %_ZN4llvh5ErrorD2Ev.exit
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #30
  ret void
}
end_hunk_3
