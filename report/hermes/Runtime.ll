...
begin_hunk_3_@_ZNSt3_V28__rotateIPcEET_S2_S2_S2_St26random_access_iterator_tag:bb.a
  ...
  br i1 %i.bd, label %middle.block.a, label %vector.body, !llvm.loop !1272
...
begin_hunk_6_@_ZNSt3_V28__rotateIPcEET_S2_S2_S2_St26random_access_iterator_tag:bb.a
  ...
  br i1 %exitcond118.not.3, label %._crit_edge110, label %.lr.ph109, !llvm.loop !1274
...
begin_hunk_7_@_ZNSt3_V28__rotateIPcEET_S2_S2_S2_St26random_access_iterator_tag:bb.a
  ...
  %wide.load158 = load <16 x i8>, ptr %i.cw, align 1, !tbaa !19, !alias.scope !1275, !noalias !1278
  %i.cx = getelementptr inbounds i8, ptr %next.gep155, i64 -16 ; 2 uses
  %wide.load159 = load <16 x i8>, ptr %i.cx, align 1, !tbaa !19, !alias.scope !1278
  store <16 x i8> %wide.load159, ptr %i.cw, align 1, !tbaa !19, !alias.scope !1275, !noalias !1278
  store <16 x i8> %wide.load158, ptr %i.cx, align 1, !tbaa !19, !alias.scope !1278
  %index.next163 = add nuw i64 %index154, 16      ; 2 uses
  %i.cy = icmp eq i64 %index.next163, %n.vec152
  br i1 %i.cy, label %middle.block164, label %vector.body153, !llvm.loop !1280
...
vec.epilog.iter.check.a:                          ; preds = %middle.block164
  ...
  br i1 %min.epilog.iters.check.not.not, label %.lr.ph.preheader, label %vec.epilog.ph.a, !prof !1281
...
begin_hunk_9_@_ZNSt3_V28__rotateIPcEET_S2_S2_S2_St26random_access_iterator_tag:bb.a
  ...
  %wide.load173 = load <8 x i8>, ptr %i.df, align 1, !tbaa !19, !alias.scope !1275, !noalias !1278
  %i.dg = getelementptr inbounds i8, ptr %next.gep171, i64 -8 ; 2 uses
  %wide.load175 = load <8 x i8>, ptr %i.dg, align 1, !tbaa !19, !alias.scope !1278
  store <8 x i8> %wide.load175, ptr %i.df, align 1, !tbaa !19, !alias.scope !1275, !noalias !1278
  store <8 x i8> %wide.load173, ptr %i.dg, align 1, !tbaa !19, !alias.scope !1278
  %index.next179 = add nuw i64 %index170, 8       ; 2 uses
  %i.dh = icmp eq i64 %index.next179, %n.vec169
  br i1 %i.dh, label %vec.epilog.middle.block, label %vec.epilog.vector.body.a, !llvm.loop !1282
