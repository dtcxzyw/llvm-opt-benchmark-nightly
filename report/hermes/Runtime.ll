...
bb.c:                                             ; preds = %bb.a
  %i.h = call { i32, i64 } @_ZN6hermes2vm22DynamicStringPrimitiveIDsLb0EE15createLongLivedERNS0_7RuntimeEN4llvh8ArrayRefIDsEE(ptr noundef nonnull align 8 dereferenceable(9816) %0, ptr nonnull %i.a, i64 1) #30 ; 2 uses
...
bb.c:                                             ; preds = %bb.a
  %i.g = call { i32, i64 } @_ZN6hermes2vm15StringPrimitive13createDynamicERNS0_7RuntimeEN4llvh8ArrayRefIDsEE(ptr noundef nonnull align 8 dereferenceable(9816) %0, ptr nonnull %i.a, i64 1) #30 ; 2 uses
