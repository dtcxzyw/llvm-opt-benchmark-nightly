...
.lr.ph109.prol:                                   ; preds = %.lr.ph109.preheader229, %.lr.ph109.prol
  ...
  %4 = load i8, ptr %.159105.prol, align 1, !tbaa !19
  %5 = load i8, ptr %.055106.prol, align 1, !tbaa !19
  store i8 %5, ptr %.159105.prol, align 1, !tbaa !19
  store i8 %4, ptr %.055106.prol, align 1, !tbaa !19
  ...
  br i1 %prol.iter238.cmp.not, label %.lr.ph109.prol.loopexit, label %.lr.ph109.prol, !llvm.loop !1273
...
.lr.ph109:                                        ; preds = %.lr.ph109.prol.loopexit, %.lr.ph109
  ...
  %12 = load i8, ptr %.159105, align 1, !tbaa !19
  %13 = load i8, ptr %.055106, align 1, !tbaa !19
  store i8 %13, ptr %.159105, align 1, !tbaa !19
  store i8 %12, ptr %.055106, align 1, !tbaa !19
  ...
  store i8 %16, ptr %15, align 1, !tbaa !19
  ...
  %i.bf = load i8, ptr %22, align 1, !tbaa !19
  %i.bg = load i8, ptr %23, align 1, !tbaa !19
  store i8 %i.bg, ptr %22, align 1, !tbaa !19
  store i8 %i.bf, ptr %23, align 1, !tbaa !19
  ...
  br i1 %exitcond118.not, label %._crit_edge110, label %.lr.ph109, !llvm.loop !1274
...
begin_hunk_2_@_ZNSt3_V28__rotateIPcEET_S2_S2_S2_St26random_access_iterator_tag:bb.a
  ...
  %wide.load158 = load <16 x i8>, ptr %i.cb, align 1, !tbaa !19, !alias.scope !1275, !noalias !1278
  %i.cc = getelementptr inbounds i8, ptr %next.gep155, i64 -16 ; 2 uses
  %wide.load159 = load <16 x i8>, ptr %i.cc, align 1, !tbaa !19, !alias.scope !1278
  store <16 x i8> %wide.load159, ptr %i.cb, align 1, !tbaa !19, !alias.scope !1275, !noalias !1278
  store <16 x i8> %wide.load158, ptr %i.cc, align 1, !tbaa !19, !alias.scope !1278
  %index.next163 = add nuw i64 %index154, 16      ; 2 uses
  %i.cd = icmp eq i64 %index.next163, %n.vec152
  br i1 %i.cd, label %middle.block164, label %vector.body153, !llvm.loop !1280
...
vec.epilog.iter.check:                            ; preds = %middle.block164
  ...
  br i1 %min.epilog.iters.check.not.not, label %.lr.ph.preheader, label %vec.epilog.ph, !prof !1281
...
begin_hunk_4_@_ZNSt3_V28__rotateIPcEET_S2_S2_S2_St26random_access_iterator_tag:bb.a
  ...
  %wide.load173 = load <8 x i8>, ptr %i.ck, align 1, !tbaa !19, !alias.scope !1275, !noalias !1278
  %i.cl = getelementptr inbounds i8, ptr %next.gep171, i64 -8 ; 2 uses
  %wide.load175 = load <8 x i8>, ptr %i.cl, align 1, !tbaa !19, !alias.scope !1278
  store <8 x i8> %wide.load175, ptr %i.ck, align 1, !tbaa !19, !alias.scope !1275, !noalias !1278
  store <8 x i8> %wide.load173, ptr %i.cl, align 1, !tbaa !19, !alias.scope !1278
  %index.next179 = add nuw i64 %index170, 8       ; 2 uses
  %i.cm = icmp eq i64 %index.next179, %n.vec169
  br i1 %i.cm, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !1282
...
begin_hunk_5_@_ZNSt3_V28__rotateIPcEET_S2_S2_S2_St26random_access_iterator_tag:bb.a
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph.prol.loopexit, label %.lr.ph.prol, !llvm.loop !1283
...
begin_hunk_7_@_ZNSt3_V28__rotateIPcEET_S2_S2_S2_St26random_access_iterator_tag:bb.a
  ...
  br i1 %exitcond.not.3, label %._crit_edge, label %.lr.ph, !llvm.loop !1285
...
!1273 = distinct !{!1273, !1265}
!1274 = distinct !{!1274, !457, !458}
!1275 = !{!1276}
!1276 = distinct !{!1276, !1277}
!1277 = distinct !{!1277, !"LVerDomain"}
!1278 = !{!1279}
!1279 = distinct !{!1279, !1277}
!1280 = distinct !{!1280, !457, !458, !459}
!1281 = !{!"branch_weights", i32 8, i32 8}
!1282 = distinct !{!1282, !457, !458, !459}
!1283 = distinct !{!1283, !1265}
!1284 = distinct !{!1284, !457}
!1285 = distinct !{!1285, !457, !458}
end_hunk_8
