...
_ZN6hermes2vm7Runtime19MarkRootsPhaseTimerD2Ev.exit213: ; preds = %.lr.ph344, %._crit_edge340
  ...
  %i.yp = sub nsw i64 %i.yn, %.sroa.0.0.copyload.i2.i3.i212
  %3 = sub nsw i64 %i.yn, %i.xk
  %4 = sitofp i64 %i.yp to double
  %i.yq = sitofp i64 %3 to double
  %i.yr = insertelement <2 x double> poison, double %i.yq, i64 0
  %i.ys = insertelement <2 x double> %i.yr, double %4, i64 1
