...
bb.b:                                             ; preds = %_ZNSt6vectorIcSaIcEEC2EmRKcRKS0_.exit
  invoke void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.84) #34
          to label %.noexc43 unwind label %8
...
bb.c:                                             ; preds = %_ZNSt6vectorIcSaIcEE17_S_check_init_lenEmRKS0_.exit.i39
  %i.i = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.g) #31
          to label %_ZNSt6vectorIcSaIcEEC2EmRKcRKS0_.exit45.thread unwind label %8 ; 12 uses
...
_ZNSt6vectorIcSaIcEEC2EmRKcRKS0_.exit45.thread:   ; preds = %bb.c
  ...
  br i1 %.not.i.i.i.i, label %.preheader, label %.preheader130.preheader

.preheader130.preheader:                          ; preds = %_ZNSt6vectorIcSaIcEEC2EmRKcRKS0_.exit45.thread
...
iter.check:                                       ; preds = %.preheader130.preheader, %._crit_edge.us
  %.026137 = phi i64 [ %4, %._crit_edge.us ], [ 0, %.preheader130.preheader ] ; 3 uses
...
vec.epilog.scalar.ph.prol.loopexit:               ; preds = %vec.epilog.scalar.ph.prol, %vec.epilog.scalar.ph.preheader
  ...
  br i1 %i.ay, label %._crit_edge.us, label %vec.epilog.scalar.ph

vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph
  %i.az = phi i8 [ %i.bn, %vec.epilog.scalar.ph ], [ %.unr, %vec.epilog.scalar.ph.prol.loopexit ]
  %.025136 = phi i64 [ %i.br, %vec.epilog.scalar.ph ], [ %.025136.unr, %vec.epilog.scalar.ph.prol.loopexit ] ; 4 uses
  %i.ba = getelementptr i8, ptr %i.p, i64 %.025136
  ...
  %i.br = add nuw i64 %.025136, 2                 ; 2 uses
  %exitcond.not.1 = icmp eq i64 %i.br, %i.g
  br i1 %exitcond.not.1, label %._crit_edge.us, label %vec.epilog.scalar.ph, !llvm.loop !233

._crit_edge.us:                                   ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph, %vec.epilog.middle.block, %middle.block
  %4 = add nuw i64 %.026137, 1                    ; 2 uses
  %exitcond156.not = icmp eq i64 %4, %i.a
...
.preheader:                                       ; preds = %._crit_edge.us, %_ZNSt6vectorIcSaIcEE17_S_check_init_lenEmRKS0_.exit.i39, %_ZNSt6vectorIcSaIcEEC2EmRKcRKS0_.exit45.thread
  ...
  %5 = ptrtoint ptr %.sroa.091.0172 to i64        ; 2 uses
  %6 = sub i64 %.sroa.15.0170, %5                 ; 3 uses
  %.not153 = icmp eq i64 %.sroa.15.0170, %5
  br i1 %.not153, label %._crit_edge141, label %.lr.ph

.lr.ph:                                           ; preds = %.preheader
  %7 = getelementptr inbounds nuw i8, ptr %3, i64 8 ; 5 uses
  br label %bb.d
...
bb.e:                                             ; preds = %bb.d
  %i.by = load ptr, ptr %7, align 8, !tbaa !176   ; 4 uses
...
_ZN7testing19MatchResultListenerlsIA10_cEERS0_RKT_.exit: ; preds = %bb.i
  %.pr = load ptr, ptr %7, align 8, !tbaa !176    ; 2 uses
...
_ZN7testing19MatchResultListenerlsImEERS0_RKT_.exit: ; preds = %bb.j
  %.pr114 = load ptr, ptr %7, align 8, !tbaa !176 ; 2 uses
...
bb.l:                                             ; preds = %_ZN7testing19MatchResultListenerlsIA3_cEERS0_RKT_.exit, %bb.e, %bb.d
  ...
  %exitcond157.not = icmp eq i64 %i.cu, %6
  br i1 %exitcond157.not, label %._crit_edge141, label %bb.d, !llvm.loop !242
...
bb.m:                                             ; preds = %._crit_edge149
  tail call void @_ZdlPvm(ptr noundef nonnull %.sroa.091.0172, i64 noundef %6) #30
  br label %_ZNSt6vectorIcSaIcEED2Ev.exit

_ZNSt6vectorIcSaIcEED2Ev.exit:                    ; preds = %._crit_edge149, %bb.m
...
bb.o:                                             ; preds = %.lr.ph148, %_ZN7testing19MatchResultListenerlsINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEERS0_RKT_.exit
  ...
  %storemerge33145 = phi i64 [ 0, %.lr.ph148 ], [ %i.eb, %_ZN7testing19MatchResultListenerlsINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEERS0_RKT_.exit ] ; 4 uses
  ...
  %i.cw = getelementptr inbounds nuw i8, ptr %.sroa.099.0, i64 %storemerge33145
...
bb.s:                                             ; preds = %bb.q
  %i.dg = tail call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %.0107144) #29
  %i.dh = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %i.cy, ptr noundef nonnull %.0107144, i64 noundef %i.dg)
...
bb.v:                                             ; preds = %bb.t
  %i.dq = tail call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %.0109143) #29
  %i.dr = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %i.di, ptr noundef nonnull %.0109143, i64 noundef %i.dq)
...
bb.x:                                             ; preds = %_ZN7testing19MatchResultListenerlsIA10_cEERS0_RKT_.exit68
  %i.dt = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo9_M_insertImEERSoT_(ptr noundef nonnull align 8 dereferenceable(8) %.pr118, i64 noundef %storemerge33145)
...
bb.z:                                             ; preds = %_ZN7testing19MatchResultListenerlsIA3_cEERS0_RKT_.exit74
  ...
  %i.dw = getelementptr inbounds nuw [32 x i8], ptr %i.dv, i64 %storemerge33145 ; 2 uses
...
_ZN7testing19MatchResultListenerlsINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEERS0_RKT_.exit: ; preds = %_ZN7testing19MatchResultListenerlsIPKcEERS0_RKT_.exit65, %_ZN7testing19MatchResultListenerlsIPKcEERS0_RKT_.exit60, %_ZN7testing19MatchResultListenerlsIA10_cEERS0_RKT_.exit68, %_ZN7testing19MatchResultListenerlsImEERS0_RKT_.exit71, %bb.z, %_ZN7testing19MatchResultListenerlsIA3_cEERS0_RKT_.exit74, %bb.p, %bb.o
  %.1110 = phi ptr [ %.0109143, %bb.o ], [ %.0109143, %bb.p ], [ @.str.17, %_ZN7testing19MatchResultListenerlsIA3_cEERS0_RKT_.exit74 ], [ @.str.17, %bb.z ], [ @.str.17, %_ZN7testing19MatchResultListenerlsImEERS0_RKT_.exit71 ], [ @.str.17, %_ZN7testing19MatchResultListenerlsIA10_cEERS0_RKT_.exit68 ], [ @.str.17, %_ZN7testing19MatchResultListenerlsIPKcEERS0_RKT_.exit60 ], [ @.str.17, %_ZN7testing19MatchResultListenerlsIPKcEERS0_RKT_.exit65 ]
  %.1108 = phi ptr [ %.0107144, %bb.o ], [ %.0107144, %bb.p ], [ @.str.2, %_ZN7testing19MatchResultListenerlsIA3_cEERS0_RKT_.exit74 ], [ @.str.2, %bb.z ], [ @.str.2, %_ZN7testing19MatchResultListenerlsImEERS0_RKT_.exit71 ], [ @.str.2, %_ZN7testing19MatchResultListenerlsIA10_cEERS0_RKT_.exit68 ], [ @.str.2, %_ZN7testing19MatchResultListenerlsIPKcEERS0_RKT_.exit60 ], [ @.str.2, %_ZN7testing19MatchResultListenerlsIPKcEERS0_RKT_.exit65 ]
  %.3 = phi i8 [ %.2146, %bb.o ], [ 0, %bb.p ], [ 0, %_ZN7testing19MatchResultListenerlsIA3_cEERS0_RKT_.exit74 ], [ 0, %bb.z ], [ 0, %_ZN7testing19MatchResultListenerlsImEERS0_RKT_.exit71 ], [ 0, %_ZN7testing19MatchResultListenerlsIA10_cEERS0_RKT_.exit68 ], [ 0, %_ZN7testing19MatchResultListenerlsIPKcEERS0_RKT_.exit60 ], [ 0, %_ZN7testing19MatchResultListenerlsIPKcEERS0_RKT_.exit65 ] ; 2 uses
  %i.eb = add nuw i64 %storemerge33145, 1         ; 2 uses
  %exitcond158.not = icmp eq i64 %i.eb, %i.bt
  br i1 %exitcond158.not, label %._crit_edge149, label %bb.o, !llvm.loop !243
...
_ZNSt6vectorIcSaIcEED2Ev.exit78:                  ; preds = %bb.ab, %8
  %.pn.pn = phi { ptr, i32 } [ %9, %8 ], [ %.pn182, %bb.ab ] ; 2 uses
