...
.preheader:                                       ; preds = %._crit_edge.us, %_ZNSt6vectorIcSaIcEE17_S_check_init_lenEmRKS0_.exit.i39, %_ZNSt6vectorIcSaIcEEC2EmRKcRKS0_.exit45.thread
  %.sroa.15.0174 = phi i64 [ %i.k, %_ZNSt6vectorIcSaIcEEC2EmRKcRKS0_.exit45.thread ], [ 0, %_ZNSt6vectorIcSaIcEE17_S_check_init_lenEmRKS0_.exit.i39 ], [ %i.k, %._crit_edge.us ] ; 2 uses
  %.sroa.091.0171 = phi ptr [ %i.i, %_ZNSt6vectorIcSaIcEEC2EmRKcRKS0_.exit45.thread ], [ null, %_ZNSt6vectorIcSaIcEE17_S_check_init_lenEmRKS0_.exit.i39 ], [ %i.i, %._crit_edge.us ] ; 6 uses
  %i.bt = ptrtoint ptr %.sroa.091.0171 to i64     ; 2 uses
  %i.bu = sub i64 %.sroa.15.0174, %i.bt           ; 3 uses
  %.not153 = icmp eq i64 %.sroa.15.0174, %i.bt
...
begin_hunk_4_@_ZNK7testing8internal35UnorderedElementsAreMatcherImplBase38VerifyAllElementsAndMatchersAreMatchedERKSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS8_EERKNS0_11MatchMatrixEPNS_19MatchResultListenerE:bb.a
  ...
  %i.cb = getelementptr inbounds nuw i8, ptr %.sroa.091.0171, i64 %storemerge139
...
bb.n:                                             ; preds = %._crit_edge148
  tail call void @_ZdlPvm(ptr noundef nonnull %.sroa.091.0171, i64 noundef %i.bu) #31
