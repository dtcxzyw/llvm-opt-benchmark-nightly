...
bb.a:
  ...
  %.sroa.15 = alloca [3 x i8], align 1            ; 8 uses
...
begin_hunk_1_@_ZNK6hermes18SourceMapGenerator25mergedWithInputSourceMapsEv:bb.a
  ...
  br i1 %i.de, label %bb.i, label %.thread337
...
begin_hunk_2_@_ZNK6hermes18SourceMapGenerator25mergedWithInputSourceMapsEv:bb.a
  ...
  br i1 %i.do, label %bb.j, label %.thread337
...
bb.j:                                             ; preds = %bb.i
  ...
  br i1 %.not.i24, label %.thread337, label %_ZNK6hermes18SourceMapGenerator25getInputSegmentForSegmentERKNS_9SourceMap7SegmentE.exit

.thread337:                                       ; preds = %bb.j, %bb.i, %.lr.ph
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.15)
  %.sroa.075.0.copyload269 = load i32, ptr %.sroa.0123.0171, align 4 ; 7 uses
  %.sroa.15.0..sroa_idx271 = getelementptr inbounds nuw i8, ptr %.sroa.0123.0171, i64 25 ; 2 uses
  ...
  %5 = load i8, ptr %i.dc, align 4, !tbaa !86, !range !17, !noundef !18
  %6 = trunc nuw i8 %5 to i1
  br i1 %6, label %bb.bb, label %_ZN4llvh8OptionalIN6hermes6parser15JSONSharedValueEED2Ev.exit55
