...
bb.h:                                             ; preds = %_ZN6hermes3hbc18BytecodeSerializer16writeBinaryArrayIhEEvN4llvh8ArrayRefIT_EE.exit
  %i.bl = load i64, ptr %i.j, align 8, !tbaa !110 ; 3 uses
...
..loopexit_crit_edge.split.us.i:                  ; preds = %bb.i
  %4 = and i64 %i.bl, -4
  %5 = add i64 %4, 4
  store i64 %5, ptr %i.j, align 8, !tbaa !110
...
._crit_edge:                                      ; preds = %_ZN6hermes3hbc18BytecodeSerializer11writeBinaryIcEEvRKT_.exit, %.._crit_edge_crit_edge, %._crit_edge.split.us
  %i.dd = phi i64 [ %.pre65, %.._crit_edge_crit_edge ], [ %i.cv, %._crit_edge.split.us ], [ %i.dc, %_ZN6hermes3hbc18BytecodeSerializer11writeBinaryIcEEvRKT_.exit ] ; 3 uses
...
..loopexit_crit_edge.split.us.i30:                ; preds = %bb.o
  %6 = and i64 %i.dd, -4
  %7 = add i64 %6, 4
  store i64 %7, ptr %i.j, align 8, !tbaa !110
