...
begin_hunk_0_@_ZN6hermes3sem12BlockContext26ensureScopedNamesAreUniqueENS1_14IsFunctionBodyEPNS_6ESTree14IdentifierNodeE:bb.a
  ...
  %22 = alloca %"class.llvh::SmallDenseSet.159", align 8 ; 15 uses
...
bb.d:                                             ; preds = %.lr.ph.i.i.i
  ...
  store i32 0, ptr %27, align 4, !tbaa !455
  %.07.i.i.i.i.ptr.i = getelementptr inbounds nuw i8, ptr %22, i64 8 ; 4 uses
  store ptr inttoptr (i64 -8 to ptr), ptr %.07.i.i.i.i.ptr.i, align 8, !tbaa !382
  %.07.i.i.i.i.ptr.1.i = getelementptr inbounds nuw i8, ptr %22, i64 16 ; 2 uses
  store ptr inttoptr (i64 -8 to ptr), ptr %.07.i.i.i.i.ptr.1.i, align 8, !tbaa !382
  %.07.i.i.i.i.ptr.2.i = getelementptr inbounds nuw i8, ptr %22, i64 24
  store ptr inttoptr (i64 -8 to ptr), ptr %.07.i.i.i.i.ptr.2.i, align 8, !tbaa !382
  %.07.i.i.i.i.ptr.3.i = getelementptr inbounds nuw i8, ptr %22, i64 32
  store ptr inttoptr (i64 -8 to ptr), ptr %.07.i.i.i.i.ptr.3.i, align 8, !tbaa !382
  %.07.i.i.i.i.ptr.4.i.a = getelementptr inbounds nuw i8, ptr %22, i64 40
  store ptr inttoptr (i64 -8 to ptr), ptr %.07.i.i.i.i.ptr.4.i.a, align 8, !tbaa !382
  %.07.i.i.i.i.ptr.5.i = getelementptr inbounds nuw i8, ptr %22, i64 48
  store ptr inttoptr (i64 -8 to ptr), ptr %.07.i.i.i.i.ptr.5.i, align 8, !tbaa !382
  %.07.i.i.i.i.ptr.6.i = getelementptr inbounds nuw i8, ptr %22, i64 56
  store ptr inttoptr (i64 -8 to ptr), ptr %.07.i.i.i.i.ptr.6.i, align 8, !tbaa !382
  %.07.i.i.i.i.ptr.7.i = getelementptr inbounds nuw i8, ptr %22, i64 64
  store ptr inttoptr (i64 -8 to ptr), ptr %.07.i.i.i.i.ptr.7.i, align 8, !tbaa !382
...
begin_hunk_2_@_ZN6hermes3sem12BlockContext26ensureScopedNamesAreUniqueENS1_14IsFunctionBodyEPNS_6ESTree14IdentifierNodeE:bb.a
  ...
  %i.ar = load ptr, ptr %.07.i.i.i.i.ptr.i, align 8
  %i.as = select i1 %.not.i.i.i.i.i, ptr %i.ar, ptr %.07.i.i.i.i.ptr.i ; 2 uses
  %i.at = load i32, ptr %.07.i.i.i.i.ptr.1.i, align 8
...
bb.o:                                             ; preds = %.loopexit158
  %i.db = load ptr, ptr %.07.i.i.i.i.ptr.i, align 8, !tbaa !485
