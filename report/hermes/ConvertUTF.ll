...
.thread101.us:                                    ; preds = %bb.e, %bb.f, %bb.c
  ...
  %i.s = icmp samesign ult i32 %.27597105.us, 65536
  %spec.select.us = select i1 %i.s, i16 3, i16 4
  br label %bb.g
...
bb.g:                                             ; preds = %.thread101.us, %bb.c, %bb.b
  ...
  %5 = zext nneg i16 %.080.us to i64              ; 3 uses
  %i.t = getelementptr inbounds nuw i8, ptr %.067114.us, i64 %5 ; 5 uses
...
bb.l:                                             ; preds = %bb.k, %bb.h
  ...
  %i.ak = getelementptr inbounds nuw i8, ptr @_ZN4llvhL13firstByteMarkE, i64 %5
  ...
  %i.ap = getelementptr inbounds nuw i8, ptr %i.ao, i64 %5 ; 2 uses
...
.thread101.us149:                                 ; preds = %bb.q, %bb.n
  ...
  %i.bf = icmp samesign ult i32 %.27597105.us150, 65536
  %spec.select.us152 = select i1 %i.bf, i16 3, i16 4
  br label %bb.r
...
bb.r:                                             ; preds = %.thread101.us149, %bb.n, %bb.m
  ...
  %6 = zext nneg i16 %.080.us155 to i64           ; 3 uses
  %i.bg = getelementptr inbounds nuw i8, ptr %.067114.us146, i64 %6 ; 5 uses
...
bb.w:                                             ; preds = %bb.v, %bb.s
  ...
  %i.bx = getelementptr inbounds nuw i8, ptr @_ZN4llvhL13firstByteMarkE, i64 %6
...
.lr.ph.split.us:                                  ; preds = %.lr.ph, %bb.j
  %.04168.us = phi i32 [ %.1.us.a, %bb.j ], [ 0, %.lr.ph ] ; 4 uses
...
bb.d:                                             ; preds = %bb.c
  %i.j = icmp ult i32 %i.f, 1114112               ; 3 uses
  %..us = select i1 %i.j, i32 %i.f, i32 65533
  %.59.us = select i1 %i.j, i16 4, i16 3
...
bb.e:                                             ; preds = %bb.d, %bb.c, %bb.b, %.lr.ph.split.us
  ...
  %.1.us.a = phi i32 [ %.04168.us, %bb.c ], [ %.04168.us, %.lr.ph.split.us ], [ %.04168.us, %bb.b ], [ %.041..us, %bb.d ] ; 2 uses
  %5 = zext nneg i16 %.045.us to i64              ; 3 uses
  %i.k = getelementptr inbounds nuw i8, ptr %.05066.us, i64 %5 ; 5 uses
...
bb.j:                                             ; preds = %bb.i, %bb.f
  ...
  %i.ab = getelementptr inbounds nuw i8, ptr @_ZN4llvhL13firstByteMarkE, i64 %5
  ...
  %i.ag = getelementptr inbounds nuw i8, ptr %i.af, i64 %5 ; 2 uses
...
.lr.ph.split:                                     ; preds = %.lr.ph, %bb.t
  %.04168 = phi i32 [ %.1.a, %bb.t ], [ 0, %.lr.ph ] ; 4 uses
...
bb.n:                                             ; preds = %bb.m
  %i.ao = icmp ult i32 %i.aj, 1114112             ; 3 uses
  %. = select i1 %i.ao, i32 %i.aj, i32 65533
  %.59 = select i1 %i.ao, i16 4, i16 3
  %.041. = select i1 %i.ao, i32 %.04168, i32 3
  br label %bb.o

bb.o:                                             ; preds = %bb.n, %bb.m, %bb.l, %bb.k
  %.046 = phi i32 [ %i.aj, %bb.m ], [ %i.aj, %bb.k ], [ %i.aj, %bb.l ], [ %., %bb.n ] ; 5 uses
  %.045 = phi i16 [ 3, %bb.m ], [ 1, %bb.k ], [ 2, %bb.l ], [ %.59, %bb.n ] ; 2 uses
  %.1.a = phi i32 [ %.04168, %bb.m ], [ %.04168, %bb.k ], [ %.04168, %bb.l ], [ %.041., %bb.n ] ; 2 uses
  %6 = zext nneg i16 %.045 to i64                 ; 3 uses
  %i.ap = getelementptr inbounds nuw i8, ptr %.05066, i64 %6 ; 5 uses
...
bb.t:                                             ; preds = %bb.p, %bb.s
  ...
  %i.bg = getelementptr inbounds nuw i8, ptr @_ZN4llvhL13firstByteMarkE, i64 %6
  ...
  %i.bl = getelementptr inbounds nuw i8, ptr %i.bk, i64 %6 ; 2 uses
...
.thread:                                          ; preds = %bb.j, %bb.e, %bb.t, %.lr.ph.split, %bb.o, %bb.a
  ...
  %.3 = phi i32 [ 0, %bb.a ], [ 2, %bb.o ], [ 3, %.lr.ph.split ], [ %.1.a, %bb.t ], [ %.1.us.a, %bb.j ], [ 2, %bb.e ]
