...
begin_hunk_0_@_ZN4llvh16itanium_demangle2DbIN12_GLOBAL__N_116DefaultAllocatorEE17parseTemplateArgsEb:bb.a
  ...
  %i.ad = getelementptr inbounds nuw i8, ptr %2, i64 24 ; 10 uses
  ...
  %i.ah = getelementptr inbounds nuw i8, ptr %0, i64 600 ; 8 uses
  %i.ai = getelementptr inbounds nuw i8, ptr %0, i64 584 ; 10 uses
  %i.aj = getelementptr inbounds nuw i8, ptr %0, i64 592 ; 3 uses
  ...
  %3 = insertelement <2 x ptr> poison, ptr %i.ah, i64 0
  %4 = insertelement <2 x ptr> %3, ptr %i.ak, i64 1 ; 2 uses
  %5 = insertelement <2 x ptr> poison, ptr %i.ad, i64 0
  %6 = insertelement <2 x ptr> %5, ptr %i.ag, i64 1 ; 2 uses
  br label %.split.us
...
bb.e:                                             ; preds = %bb.d, %.split.us
  ...
  store <2 x ptr> %6, ptr %i.ae, align 8, !tbaa !84
...
begin_hunk_2_@_ZN4llvh16itanium_demangle2DbIN12_GLOBAL__N_116DefaultAllocatorEE17parseTemplateArgsEb:bb.a
  ...
  store <2 x ptr> %4, ptr %i.ai, align 8, !tbaa !84
