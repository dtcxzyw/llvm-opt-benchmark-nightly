...
begin_hunk_1_@_ZNK4llvh16itanium_demangle16FloatLiteralImplIdE9printLeftER12OutputStream:bb.a
  ...
  %4 = load <4 x i8>, ptr %.0.ptr.1, align 1, !tbaa !7 ; 2 uses
  %5 = shufflevector <4 x i8> %4, <4 x i8> poison, <4 x i32> <i32 poison, i32 1, i32 3, i32 poison>
  %6 = insertelement <4 x i8> %5, i8 %i.aa, i64 0
  %i.ac = insertelement <4 x i8> %6, i8 %2, i64 3 ; 2 uses
  ...
  %7 = shufflevector <4 x i8> %4, <4 x i8> poison, <4 x i32> <i32 poison, i32 0, i32 2, i32 poison>
  %8 = insertelement <4 x i8> %7, i8 %i.ab, i64 0
  %i.ai = insertelement <4 x i8> %8, i8 %3, i64 3 ; 2 uses
