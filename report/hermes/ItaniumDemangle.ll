...
_ZSt7reverseIPcEvT_S1_.exit:                      ; preds = %bb.a
  ...
  %2 = load i8, ptr %.ptr, align 1, !tbaa !7
  %3 = load i8, ptr %i.c, align 1, !tbaa !7
  %4 = load <6 x i8>, ptr %.0.ptr.1, align 1, !tbaa !7 ; 2 uses
  %5 = shufflevector <6 x i8> %4, <6 x i8> poison, <4 x i32> <i32 poison, i32 1, i32 3, i32 5>
  %6 = insertelement <4 x i8> %5, i8 %2, i64 0    ; 2 uses
  %i.aa = sext <4 x i8> %6 to <4 x i32>
  ...
  %i.ae = add <4 x i8> %i.ad, %6
  %7 = shufflevector <6 x i8> %4, <6 x i8> poison, <4 x i32> <i32 poison, i32 0, i32 2, i32 4>
  %8 = insertelement <4 x i8> %7, i8 %3, i64 0    ; 2 uses
  %i.af = sext <4 x i8> %8 to <4 x i32>
