...
.lr.ph.i22:                                       ; preds = %.lr.ph
  ...
  %i.ay = load i8, ptr %.val911.i23.ptr, align 1, !tbaa !18
  %i.az = sext i8 %i.ay to i32
  %isdigittmp2.i24 = add nsw i32 %i.az, -48
  %isdigit3.i25 = icmp ult i32 %isdigittmp2.i24, 10
  br i1 %isdigit3.i25, label %.lr.ph, label %.lr.ph.i22._ZN4llvh16itanium_demangle2DbIN12_GLOBAL__N_116DefaultAllocatorEE11parseNumberEb.exit27_crit_edge, !llvm.loop !2
...
bb.q:                                             ; preds = %_ZN4llvh16itanium_demangle2DbIN12_GLOBAL__N_116DefaultAllocatorEE11parseNumberEb.exit27.thread73
  %i.ba = load i8, ptr %.ptr80141, align 1, !tbaa !18
  %i.bb = icmp eq i8 %i.ba, 112
  br i1 %i.bb, label %bb.r, label %_ZN4llvh16itanium_demangle2DbIN12_GLOBAL__N_116DefaultAllocatorEE9consumeIfEc.exit.thread

bb.r:                                             ; preds = %bb.q
  %i.bc = getelementptr inbounds nuw i8, ptr %.ptr80141, i64 1 ; 5 uses
  store ptr %i.bc, ptr %0, align 16, !tbaa !33
  %.not.i.i31 = icmp eq ptr %i.bc, %i.c
...
bb.s:                                             ; preds = %bb.r
  ...
  %i.be = icmp eq i8 %i.bd, 114
  br i1 %i.be, label %bb.t, label %_ZN4llvh16itanium_demangle2DbIN12_GLOBAL__N_116DefaultAllocatorEE9consumeIfEc.exit.thread.i32

bb.t:                                             ; preds = %bb.s
  %i.bf = getelementptr inbounds nuw i8, ptr %.ptr80141, i64 2 ; 2 uses
  store ptr %i.bf, ptr %0, align 16, !tbaa !33
...
_ZN4llvh16itanium_demangle2DbIN12_GLOBAL__N_116DefaultAllocatorEE9consumeIfEc.exit.thread.i32: ; preds = %bb.t, %bb.s, %bb.r
  %i.bg = phi ptr [ %i.bf, %bb.t ], [ %i.bc, %bb.s ], [ %i.bc, %bb.r ] ; 5 uses
  %.not.i1.i34 = icmp eq ptr %i.bg, %i.c
...
bb.u:                                             ; preds = %_ZN4llvh16itanium_demangle2DbIN12_GLOBAL__N_116DefaultAllocatorEE9consumeIfEc.exit.thread.i32
  ...
  br i1 %i.bi, label %bb.v, label %_ZN4llvh16itanium_demangle2DbIN12_GLOBAL__N_116DefaultAllocatorEE9consumeIfEc.exit3.thread.i35

bb.v:                                             ; preds = %bb.u
  %i.bj = getelementptr inbounds nuw i8, ptr %i.bg, i64 1 ; 2 uses
  store ptr %i.bj, ptr %0, align 16, !tbaa !33
...
_ZN4llvh16itanium_demangle2DbIN12_GLOBAL__N_116DefaultAllocatorEE9consumeIfEc.exit3.thread.i35: ; preds = %bb.v, %bb.u, %_ZN4llvh16itanium_demangle2DbIN12_GLOBAL__N_116DefaultAllocatorEE9consumeIfEc.exit.thread.i32
  %i.bk = phi ptr [ %i.bj, %bb.v ], [ %i.bg, %bb.u ], [ %i.bg, %_ZN4llvh16itanium_demangle2DbIN12_GLOBAL__N_116DefaultAllocatorEE9consumeIfEc.exit.thread.i32 ] ; 5 uses
  %.not.i4.i37 = icmp eq ptr %i.bk, %i.c
...
bb.w:                                             ; preds = %_ZN4llvh16itanium_demangle2DbIN12_GLOBAL__N_116DefaultAllocatorEE9consumeIfEc.exit3.thread.i35
  ...
  %i.bm = icmp eq i8 %i.bl, 75
  br i1 %i.bm, label %bb.x, label %_ZN4llvh16itanium_demangle2DbIN12_GLOBAL__N_116DefaultAllocatorEE17parseCVQualifiersEv.exit39

bb.x:                                             ; preds = %bb.w
  %i.bn = getelementptr inbounds nuw i8, ptr %i.bk, i64 1 ; 2 uses
  store ptr %i.bn, ptr %0, align 16, !tbaa !33
...
_ZN4llvh16itanium_demangle2DbIN12_GLOBAL__N_116DefaultAllocatorEE17parseCVQualifiersEv.exit39: ; preds = %_ZN4llvh16itanium_demangle2DbIN12_GLOBAL__N_116DefaultAllocatorEE9consumeIfEc.exit3.thread.i35, %bb.w, %bb.x
  %i.bo = phi ptr [ %i.bk, %_ZN4llvh16itanium_demangle2DbIN12_GLOBAL__N_116DefaultAllocatorEE9consumeIfEc.exit3.thread.i35 ], [ %i.bk, %bb.w ], [ %i.bn, %bb.x ] ; 7 uses
  %i.bp = icmp eq ptr %i.c, %i.bo
  br i1 %i.bp, label %_ZN4llvh16itanium_demangle2DbIN12_GLOBAL__N_116DefaultAllocatorEE11parseNumberEb.exit52, label %bb.y
...
bb.y:                                             ; preds = %_ZN4llvh16itanium_demangle2DbIN12_GLOBAL__N_116DefaultAllocatorEE17parseCVQualifiersEv.exit39
  ...
  %isdigittmp.i41 = add nsw i32 %i.br, -48
...
.lr.ph.i47:                                       ; preds = %bb.y, %bb.z
  %.val911.i48 = phi ptr [ %i.bu, %bb.z ], [ %i.bo, %bb.y ] ; 4 uses
  %i.bs = load i8, ptr %.val911.i48, align 1, !tbaa !18
  %i.bt = sext i8 %i.bs to i32
  %isdigittmp2.i49 = add nsw i32 %i.bt, -48
...
bb.z:                                             ; preds = %.lr.ph.i47
  %i.bu = getelementptr inbounds nuw i8, ptr %.val911.i48, i64 1 ; 5 uses
  store ptr %i.bu, ptr %0, align 16, !tbaa !33
  %.not.i51 = icmp eq ptr %i.c, %i.bu
...
_ZN4llvh16itanium_demangle2DbIN12_GLOBAL__N_116DefaultAllocatorEE11parseNumberEb.exit52: ; preds = %.lr.ph.i47, %bb.z, %_ZN4llvh16itanium_demangle2DbIN12_GLOBAL__N_116DefaultAllocatorEE17parseCVQualifiersEv.exit39, %bb.y
  %i.bv = phi ptr [ %i.bo, %_ZN4llvh16itanium_demangle2DbIN12_GLOBAL__N_116DefaultAllocatorEE17parseCVQualifiersEv.exit39 ], [ %i.bo, %bb.y ], [ %i.bu, %bb.z ], [ %.val911.i48, %.lr.ph.i47 ] ; 3 uses
  %.sroa.0.0.i43 = phi ptr [ null, %_ZN4llvh16itanium_demangle2DbIN12_GLOBAL__N_116DefaultAllocatorEE17parseCVQualifiersEv.exit39 ], [ null, %bb.y ], [ %i.bo, %bb.z ], [ %i.bo, %.lr.ph.i47 ] ; 2 uses
  %.sroa.3.0.i44 = phi ptr [ null, %_ZN4llvh16itanium_demangle2DbIN12_GLOBAL__N_116DefaultAllocatorEE17parseCVQualifiersEv.exit39 ], [ null, %bb.y ], [ %i.bu, %bb.z ], [ %.val911.i48, %.lr.ph.i47 ] ; 2 uses
  %.not.i53 = icmp eq ptr %i.bv, %i.c
...
bb.aa:                                            ; preds = %_ZN4llvh16itanium_demangle2DbIN12_GLOBAL__N_116DefaultAllocatorEE11parseNumberEb.exit52
  ...
  br i1 %i.bx, label %bb.ab, label %_ZN4llvh16itanium_demangle2DbIN12_GLOBAL__N_116DefaultAllocatorEE9consumeIfEc.exit.thread

bb.ab:                                            ; preds = %bb.aa
  %i.by = getelementptr inbounds nuw i8, ptr %i.bv, i64 1
  store ptr %i.by, ptr %0, align 16, !tbaa !33
  %i.bz = getelementptr inbounds nuw i8, ptr %0, i64 4848 ; 2 uses
  %i.ca = load ptr, ptr %i.bz, align 16, !tbaa !47 ; 3 uses
  %i.cb = getelementptr inbounds nuw i8, ptr %i.ca, i64 8
  %i.cc = load i64, ptr %i.cb, align 8, !tbaa !64 ; 2 uses
  %i.cd = add i64 %i.cc, -4048
  %i.ce = icmp ult i64 %i.cd, -4080
  br i1 %i.ce, label %bb.ac, label %_ZN4llvh16itanium_demangle2DbIN12_GLOBAL__N_116DefaultAllocatorEE9consumeIfEc.exit.thread.sink.split

bb.ac:                                            ; preds = %bb.ab
  %i.cf = tail call noalias dereferenceable_or_null(4096) ptr @malloc(i64 noundef 4096) #21 ; 5 uses
  %i.cg = icmp eq ptr %i.cf, null
  br i1 %i.cg, label %bb.ad, label %_ZN12_GLOBAL__N_120BumpPointerAllocator4growEv.exit.i.i.i57
...
_ZN12_GLOBAL__N_120BumpPointerAllocator4growEv.exit.i.i.i57: ; preds = %bb.ac
  store ptr %i.ca, ptr %i.cf, align 8, !tbaa !63
  %i.ch = getelementptr inbounds nuw i8, ptr %i.cf, i64 8
  store i64 0, ptr %i.ch, align 8, !tbaa !64
  store ptr %i.cf, ptr %i.bz, align 16, !tbaa !47
  br label %_ZN4llvh16itanium_demangle2DbIN12_GLOBAL__N_116DefaultAllocatorEE9consumeIfEc.exit.thread.sink.split
...
_ZN4llvh16itanium_demangle2DbIN12_GLOBAL__N_116DefaultAllocatorEE9consumeIfEc.exit.thread.sink.split: ; preds = %_ZN12_GLOBAL__N_120BumpPointerAllocator4growEv.exit.i.i.i57, %bb.ab, %_ZN12_GLOBAL__N_120BumpPointerAllocator4growEv.exit.i.i.i, %bb.l
  %.sink127 = phi ptr [ %i.ai, %bb.l ], [ %i.an, %_ZN12_GLOBAL__N_120BumpPointerAllocator4growEv.exit.i.i.i ], [ %i.cf, %_ZN12_GLOBAL__N_120BumpPointerAllocator4growEv.exit.i.i.i57 ], [ %i.ca, %bb.ab ] ; 2 uses
  %.sink126 = phi i64 [ %i.ak, %bb.l ], [ 0, %_ZN12_GLOBAL__N_120BumpPointerAllocator4growEv.exit.i.i.i ], [ 0, %_ZN12_GLOBAL__N_120BumpPointerAllocator4growEv.exit.i.i.i57 ], [ %i.cc, %bb.ab ] ; 2 uses
  ...
  %i.ci = getelementptr inbounds nuw i8, ptr %.sink127, i64 8
  %i.cj = add nsw i64 %.sink126, 32
  store i64 %i.cj, ptr %i.ci, align 8, !tbaa !64
  %i.ck = getelementptr inbounds nuw i8, ptr %.sink127, i64 16
  %i.cl = getelementptr inbounds i8, ptr %i.ck, i64 %.sink126 ; 5 uses
  %i.cm = getelementptr inbounds nuw i8, ptr %i.cl, i64 8
  store <4 x i8> <i8 54, i8 1, i8 1, i8 1>, ptr %i.cm, align 8, !tbaa !18
  store ptr getelementptr inbounds nuw inrange(-16, 72) (i8, ptr @_ZTVN4llvh16itanium_demangle13FunctionParamE, i64 16), ptr %i.cl, align 8, !tbaa !57
  %i.cn = getelementptr inbounds nuw i8, ptr %i.cl, i64 16
  store ptr %.sroa.0.0.i43.sink, ptr %i.cn, align 8, !tbaa !69
  %.sroa.2.0..sroa_idx.i.i.i56 = getelementptr inbounds nuw i8, ptr %i.cl, i64 24
