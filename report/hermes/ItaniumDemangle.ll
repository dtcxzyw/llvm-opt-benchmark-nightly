...
_ZSt7reverseIPcEvT_S1_.exit:                      ; preds = %bb.a
  ...
  %i.y = shl i8 %i.x, 4
  %i.z = add i8 %i.u, %i.y
  %.sroa.0.5.insert.ext53 = zext i8 %i.z to i64
  ...
  %3 = shufflevector <8 x i8> %2, <8 x i8> poison, <4 x i32> <i32 5, i32 3, i32 1, i32 7> ; 2 uses
  ...
  %8 = add <4 x i8> %7, %3
  %9 = shufflevector <8 x i8> %2, <8 x i8> poison, <4 x i32> <i32 4, i32 2, i32 0, i32 6> ; 2 uses
  ...
  %16 = add <4 x i8> %8, %15
  %17 = shl nuw nsw i64 %.sroa.0.5.insert.ext53, 16
  %18 = shufflevector <4 x i8> %16, <4 x i8> <i8 0, i8 poison, i8 poison, i8 poison>, <8 x i32> <i32 4, i32 4, i32 4, i32 4, i32 3, i32 0, i32 1, i32 2>
  %19 = bitcast <8 x i8> %18 to i64
  %.sroa.0.4.insert.shift49 = shl nuw nsw i64 %.sroa.0.6.insert.ext, 8
  %op.rdx = or disjoint i64 %17, %19
  %op.rdx69 = or disjoint i64 %.sroa.0.4.insert.shift49, %.sroa.0.4.insert.shift
  %op.rdx70 = or disjoint i64 %op.rdx, %op.rdx69
  %.sroa.0.4.insert.insert51 = or disjoint i64 %op.rdx70, %.sroa.0.7.insert.ext
