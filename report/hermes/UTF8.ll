...
bb.b:                                             ; preds = %.lr.ph, %bb.f
  ...
  %i.d = load i16, ptr %.02074, align 2, !tbaa !17 ; 2 uses
...
bb.f:                                             ; preds = %bb.e, %.thread52
  ...
  br i1 %i.ac, label %bb.b, label %.thread, !llvm.loop !25
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9push_backEc.exit: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i, %bb.d
  ...
  store i64 %i.k, ptr %i.c, align 8, !tbaa !14
...
bb.e:                                             ; preds = %bb.b
  ...
  %i.x = load i64, ptr %i.c, align 8, !tbaa !14
  %i.y = getelementptr inbounds nuw i8, ptr %i.w, i64 %i.x
  %i.z = load ptr, ptr %i.b, align 8, !tbaa !9
...
.lr.ph:                                           ; preds = %.preheader42, %.lr.ph
  %.02248 = phi i32 [ %i.i, %.lr.ph ], [ 0, %.preheader42 ]
  %.02347 = phi i64 [ %i.j, %.lr.ph ], [ %i.c, %.preheader42 ]
  %.02546 = phi ptr [ %i.f, %.lr.ph ], [ %0, %.preheader42 ] ; 2 uses
  %i.f = getelementptr inbounds nuw i8, ptr %.02546, i64 1 ; 3 uses
  %i.g = load i8, ptr %.02546, align 1, !tbaa !10
  %i.h = zext i8 %i.g to i32
  %i.i = or i32 %.02248, %i.h                     ; 2 uses
  %i.j = add i64 %.02347, -1                      ; 2 uses
...
.preheader.preheader:                             ; preds = %.preheader42, %._crit_edge
  ...
  %.025.lcssa67 = phi ptr [ %i.f, %._crit_edge ], [ %0, %.preheader42 ] ; 2 uses
  %i.m = icmp ugt i64 %.023.lcssa68, 3
  br i1 %i.m, label %.lr.ph81, label %.loopexit

.preheader:                                       ; preds = %.lr.ph81
  %i.n = add i64 %.12480, -4                      ; 3 uses
  %i.o = getelementptr inbounds nuw i8, ptr %.12679, i64 4 ; 2 uses
  %i.p = icmp ugt i64 %i.n, 3
  br i1 %i.p, label %.lr.ph81, label %.loopexit, !llvm.loop !27

.lr.ph81:                                         ; preds = %.preheader.preheader, %.preheader
  %.12480 = phi i64 [ %i.n, %.preheader ], [ %.023.lcssa68, %.preheader.preheader ]
  %.12679 = phi ptr [ %i.o, %.preheader ], [ %.025.lcssa67, %.preheader.preheader ] ; 2 uses
  %i.q = load i32, ptr %.12679, align 4, !tbaa !6
  %i.r = and i32 %i.q, -2139062144
  %.not39 = icmp eq i32 %i.r, 0
  br i1 %.not39, label %.preheader, label %.critedge, !llvm.loop !27

.loopexit:                                        ; preds = %.preheader, %.preheader.preheader, %bb.a
  %.429 = phi ptr [ %0, %bb.a ], [ %.025.lcssa67, %.preheader.preheader ], [ %i.o, %.preheader ]
  %.4 = phi i64 [ %i.c, %bb.a ], [ %.023.lcssa68, %.preheader.preheader ], [ %i.n, %.preheader ] ; 2 uses
  %.not4051 = icmp eq i64 %.4, 0
  br i1 %.not4051, label %.critedge, label %.lr.ph56

.lr.ph56:                                         ; preds = %.loopexit, %.lr.ph56
  %.054 = phi i32 [ %i.w, %.lr.ph56 ], [ 0, %.loopexit ]
  %.553 = phi i64 [ %i.s, %.lr.ph56 ], [ %.4, %.loopexit ]
  %.53052 = phi ptr [ %i.t, %.lr.ph56 ], [ %.429, %.loopexit ] ; 2 uses
  %i.s = add i64 %.553, -1                        ; 2 uses
  %i.t = getelementptr inbounds nuw i8, ptr %.53052, i64 1
  %i.u = load i8, ptr %.53052, align 1, !tbaa !10
  %i.v = zext i8 %i.u to i32
  %i.w = or i32 %.054, %i.v                       ; 2 uses
...
bb.b:                                             ; preds = %.lr.ph.i
  ...
  store ptr %i.k, ptr %i.a, align 8, !tbaa !9
...
bb.e:                                             ; preds = %_ZN6hermes10decodeUTF8ILb1EZNS_32convertUTF8WithSurrogatesToUTF16IPDsEET_S3_PKcS5_EUlRKN4llvh5TwineEE_EEjRS5_T0_.exit.i
  ...
  store i16 %i.y, ptr %i.v, align 2, !tbaa !17
  br label %_ZN6hermes11encodeUTF16IPDsEEvRT_j.exit.i
...
_ZN6hermes11encodeUTF16IPDsEEvRT_j.exit.i:        ; preds = %bb.e, %bb.d
  ...
  store i16 %.sink.i, ptr %.03.i, align 2, !tbaa !17
  %i.aa = load ptr, ptr %i.a, align 8, !tbaa !9   ; 2 uses
...
_ZN6hermes32convertUTF8WithSurrogatesToUTF16IPDsEET_S2_PKcS4_.exit.loopexit: ; preds = %_ZN6hermes11encodeUTF16IPDsEEvRT_j.exit.i
  %.pre4 = load ptr, ptr %3, align 8, !tbaa !33
...
bb.d:                                             ; preds = %bb.c
  ...
  store ptr %i.w, ptr %0, align 8, !tbaa !9
