...
bb.c:                                             ; preds = %bb.b
  ...
  %i.i = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %i.h) #24, !inline_history !222
...
bb.d:                                             ; preds = %bb.a
  store ptr @_ZN4llvhL18semPPCDoubleDoubleE, ptr %i.a, align 8, !tbaa !148
  %i.o = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.p = tail call noalias noundef nonnull dereferenceable(72) ptr @_Znam(i64 noundef 72) #24, !inline_history !257 ; 6 uses
...
define hidden noundef range(i32 0, 25) i32 @_ZN4llvh7APFloat7convertERKNS_12fltSemanticsENS_11APFloatBase12roundingModeEPb(ptr noundef nonnull align 8 dereferenceable(32) %0, ptr noundef nonnull align 4 dereferenceable(12) %1, i32 noundef %2, ptr noundef writeonly captures(none) initializes((0, 1)) %3) local_unnamed_addr #2 align 2 {
bb.a:
...
_ZN4llvh7APFloatC2ERKNS_12fltSemanticsERKNS_5APIntE.exit: ; preds = %bb.d
  ...
  call void @_ZN4llvh6detail13DoubleAPFloatC2ERKNS_12fltSemanticsERKNS_5APIntE(ptr noundef nonnull align 8 dereferenceable(24) %i.f, ptr noundef nonnull align 4 dereferenceable(12) @_ZN4llvhL18semPPCDoubleDoubleE, ptr noundef nonnull align 8 dereferenceable(12) %5), !inline_history !253
...
bb.h:                                             ; preds = %bb.g
  call void @_ZdaPv(ptr noundef nonnull %i.n) #25, !inline_history !160
  br label %_ZN4llvh7APFloatD2Ev.exit

bb.i:                                             ; preds = %_ZN4llvh7APFloatC2ERKNS_12fltSemanticsERKNS_5APIntE.exit
  call void @_ZN4llvh6detail13DoubleAPFloatD2Ev(ptr noundef nonnull align 8 dereferenceable(24) %i.f) #26, !inline_history !161
  br label %_ZN4llvh7APFloatD2Ev.exit
...
bb.k:                                             ; preds = %bb.j
  call void @_ZdaPv(ptr noundef nonnull %i.s) #25
...
bb.n:                                             ; preds = %bb.m
  call void @_ZdaPv(ptr noundef nonnull %i.au) #25, !inline_history !160
  br label %_ZN4llvh6detail9IEEEFloatD2Ev.exit

bb.o:                                             ; preds = %_ZN4llvh7APFloatC2ENS_6detail9IEEEFloatERKNS_12fltSemanticsE.exit
  call void @_ZN4llvh6detail13DoubleAPFloatD2Ev(ptr noundef nonnull align 8 dereferenceable(24) %i.ak) #26, !inline_history !161
  br label %_ZN4llvh6detail9IEEEFloatD2Ev.exit
...
; Function Attrs: mustprogress nounwind uwtable
define hidden void @_ZN4llvh7APFloat15getAllOnesValueEjb(ptr dead_on_unwind noalias writable sret(%"class.llvh::APFloat") align 8 captures(none) %0, i32 noundef %1, i1 noundef zeroext %2) local_unnamed_addr #2 align 2 {
bb.a:
...
bb.c:                                             ; preds = %bb.b
  ...
  store i32 %1, ptr %i.c, align 8, !tbaa !20, !alias.scope !258
...
_ZN4llvh5APInt15getAllOnesValueEj.exit.thread:    ; preds = %bb.c
  ...
  store i64 %i.g, ptr %3, align 8, !tbaa !18, !alias.scope !258
  %i.h = inttoptr i64 %i.g to ptr
  br label %bb.d

_ZN4llvh5APInt15getAllOnesValueEj.exit:           ; preds = %bb.c
  call void @_ZN4llvh5APInt12initSlowCaseEmb(ptr noundef nonnull align 8 dereferenceable(12) %3, i64 noundef -1, i1 noundef zeroext true) #26
...
bb.m:                                             ; preds = %_ZN4llvh6detail9IEEEFloat13initFromAPIntEPKNS_12fltSemanticsERKNS_5APIntE.exit
  call void @_ZdaPv(ptr noundef nonnull %i.j) #25
  br label %_ZN4llvh5APIntD2Ev.exit
...
bb.n:                                             ; preds = %bb.b
  ...
  store i32 %1, ptr %i.ar, align 8, !tbaa !20, !alias.scope !261
...
_ZN4llvh5APInt15getAllOnesValueEj.exit9.thread:   ; preds = %bb.n
  ...
  store i64 %i.av, ptr %4, align 8, !tbaa !18, !alias.scope !261
  %i.aw = inttoptr i64 %i.av to ptr
  br label %bb.o

_ZN4llvh5APInt15getAllOnesValueEj.exit9:          ; preds = %bb.n
  call void @_ZN4llvh5APInt12initSlowCaseEmb(ptr noundef nonnull align 8 dereferenceable(12) %4, i64 noundef -1, i1 noundef zeroext true) #26
