...
bb.aa:                                            ; preds = %bb.z, %bb.y
  %.01545 = phi i64 [ %.0.copyload.i1776, %bb.y ], [ %i.hi, %bb.z ] ; 8 uses
...
begin_hunk_1_@w2c_hermes_hermes0x3A0x3Avm0x3A0x3ARuntime0x3A0x3AgcStableHashHermesValue0x28hermes0x3A0x3Avm0x3A0x3AHandle0x3Chermes0x3A0x3Avm0x3A0x3AHermesValue0x3E0x29:bb.a
  ...
  %i.iv = xor i64 %i.iu, %.01545                  ; 4 uses
...
bb.ar:                                            ; preds = %bb.aq, %bb.ap, %bb.ao, %bb.am
  %.4 = phi i32 [ %i.ds, %bb.am ], [ %i.ef, %bb.aq ], [ %i.du, %bb.ao ], [ %i.dv, %bb.ap ]
...
bb.az:                                            ; preds = %bb.ay
  %i.fe = shl i32 %2, 1
  %i.ff = add i32 %.4, %i.fe                      ; 2 uses
  %i.fg = shl nuw i32 %3, 1
  %i.fh = add i32 %i.ff, %i.fg
  br label %bb.ba

bb.ba:                                            ; preds = %bb.bb, %bb.az
  %.2671 = phi i32 [ %.5, %bb.az ], [ %i.fp, %bb.bb ] ; 2 uses
  %.2667 = phi i32 [ %i.ff, %bb.az ], [ %i.fq, %bb.bb ] ; 2 uses
...
bb.bi:                                            ; preds = %bb.bh, %bb.bg, %bb.bf, %bb.bd
  %.6 = phi i32 [ %i.fx, %bb.bd ], [ %i.gk, %bb.bh ], [ %i.fz, %bb.bf ], [ %i.ga, %bb.bg ]
...
bb.bq:                                            ; preds = %bb.bp
  %i.hj = shl i32 %2, 1
  %i.hk = add i32 %.6, %i.hj                      ; 2 uses
  %i.hl = shl nuw i32 %3, 1
  %i.hm = add i32 %i.hk, %i.hl
  br label %bb.br

bb.br:                                            ; preds = %bb.bs, %bb.bq
  %.3672 = phi i32 [ %.7, %bb.bq ], [ %i.hs, %bb.bs ] ; 2 uses
  %.3668 = phi i32 [ %i.hk, %bb.bq ], [ %i.ht, %bb.bs ] ; 2 uses
