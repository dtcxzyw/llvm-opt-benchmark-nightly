...
begin_hunk_0_@_ZN6hermes2vm10parseFloatEPvRNS0_7RuntimeENS0_10NativeArgsE:bb.a
  ...
  %i.ek = and i64 %i.ej, 1073741823               ; 7 uses
...
bb.be:                                            ; preds = %_ZN4llvh11SmallVectorIcLj32EEC2EmRKc.exit
  ...
  br i1 %.not.i.i108, label %4, label %bb.bf
...
4:                                                ; preds = %bb.be
  %5 = getelementptr inbounds nuw i8, ptr %i.s, i64 %i.ek
  br label %_ZNK6hermes2vm10StringView13castToCharPtrEv.exit.i128

bb.br:                                            ; preds = %bb.bg, %bb.bi, %bb.bj, %bb.bk
  %.0.i.sink.i.i112.ph = phi ptr [ %i.fz, %bb.bk ], [ %i.fu, %bb.bj ], [ %i.ft, %bb.bi ], [ %i.fs, %bb.bg ]
  %6 = getelementptr inbounds nuw i8, ptr %.0.i.sink.i.i112.ph, i64 %i.ek ; 4 uses
...
_ZNK6hermes2vm10StringView13castToCharPtrEv.exit.i128: ; preds = %4, %bb.bw, %bb.bv, %bb.bu, %bb.bs
  %i.gy = phi ptr [ %5, %4 ], [ %6, %bb.bs ], [ %6, %bb.bu ], [ %6, %bb.bv ], [ %6, %bb.bw ]
  %.0.i.sink.i.i129 = phi ptr [ %i.s, %4 ], [ %i.gq, %bb.bs ], [ %i.gr, %bb.bu ], [ %i.gs, %bb.bv ], [ %i.gx, %bb.bw ]
...
_ZNK6hermes2vm10StringView3endEv.exit131:         ; preds = %_ZNK6hermes2vm10StringView13castToCharPtrEv.exit.i128, %_ZNK6hermes2vm10StringView15castToChar16PtrEv.exit.i118
  %.sroa.0.0.i104208 = phi ptr [ %i.gy, %_ZNK6hermes2vm10StringView13castToCharPtrEv.exit.i128 ], [ null, %_ZNK6hermes2vm10StringView15castToChar16PtrEv.exit.i118 ]
