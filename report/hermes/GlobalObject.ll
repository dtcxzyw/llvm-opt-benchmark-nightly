...
bb.ce:                                            ; preds = %_ZN6hermes2vm10StringView14const_iteratorppEv.exit138, %_ZNK6hermes2vm10StringView3endEv.exit131
  ...
  %.072 = phi i32 [ 0, %_ZNK6hermes2vm10StringView3endEv.exit131 ], [ %i.ib, %_ZN6hermes2vm10StringView14const_iteratorppEv.exit138 ] ; 5 uses
...
switch.early.test224._crit_edge:                  ; preds = %switch.early.test224
  %.072.lcssa258 = phi i32 [ %.072, %switch.early.test224 ]
  br label %bb.cg

bb.cg:                                            ; preds = %split.a, %switch.early.test224._crit_edge
  %.072.lcssa = phi i32 [ %.072.lcssa258, %switch.early.test224._crit_edge ], [ %.072.lcssa257, %split.a ] ; 2 uses
