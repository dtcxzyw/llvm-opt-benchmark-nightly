...
begin_hunk_0_@w2c_hermes_hermes0x3A0x3Avm0x3A0x3AquickSort0x28hermes0x3A0x3Avm0x3A0x3ASortModel0x2A0x2C0x20unsigned0x20int0x2C0x20unsigned0x20int0x29:bb.a
  ...
  %.tr512 = trunc i64 %i.ae to i32
  %i.af = shl i32 %.tr512, 2
  ...
  %.tr513 = trunc i64 %i.ak to i32
  %i.al = shl i32 %.tr513, 2
  ...
  %.tr514 = trunc i64 %i.aq to i32
  %i.ar = shl i32 %.tr514, 2
  ...
  %.tr515 = trunc i64 %i.aw to i32
  %i.ax = shl i32 %.tr515, 2
  ...
  %.tr516 = trunc i64 %i.bc to i32
  %i.bd = shl i32 %.tr516, 2
  ...
  %.tr517 = trunc i64 %i.bi to i32
  %i.bj = shl i32 %.tr517, 2
...
.preheader485:                                    ; preds = %.loopexit487
  ...
  %i.bq = shl i32 %indvars.iv498.tr, 2
...
.preheader485.1:                                  ; preds = %.preheader485
  ...
  %i.bv = shl i32 %indvars.iv498.tr.1, 2
...
.preheader485.2:                                  ; preds = %.preheader485.1
  ...
  %i.ca = shl i32 %indvars.iv498.tr.2, 2
...
.preheader485.3:                                  ; preds = %.preheader485.2
  ...
  %i.cf = shl i32 %indvars.iv498.tr.3, 2
...
.preheader485.4:                                  ; preds = %.preheader485.3
  ...
  %i.ck = shl i32 %indvars.iv498.tr.4, 2
...
.preheader485.5:                                  ; preds = %.preheader485.4
  ...
  %i.cp = shl i32 %indvars.iv498.tr.5, 2
...
.preheader485.6:                                  ; preds = %.preheader485.5
  ...
  %i.cu = shl i32 %indvars.iv498.tr.6, 2
...
.preheader:                                       ; preds = %.preheader.preheader, %bb.v
  %.3412 = phi i32 [ %i.do, %bb.v ], [ %.0404, %.preheader.preheader ] ; 5 uses
  %.3 = phi i32 [ %.0403, %bb.v ], [ %.2408, %.preheader.preheader ]
  ...
  br i1 %i.du, label %bb.h, label %.critedge, !prof !27
...
bb.h:                                             ; preds = %.preheader
  ...
  br i1 %.not424, label %.critedge, label %bb.i, !prof !31

bb.i:                                             ; preds = %bb.h
  %i.ea = load ptr, ptr %i.dx, align 8, !tbaa !33 ; 4 uses
  %i.eb = icmp eq ptr %i.dk, %i.ea
  br i1 %i.eb, label %func_types_eq.exit.thread, label %bb.j
...
.critedge:                                        ; preds = %bb.j, %bb.h, %.preheader, %func_types_eq.exit
...
func_types_eq.exit.thread:                        ; preds = %bb.i, %func_types_eq.exit
  ...
  br i1 %.not425, label %bb.o, label %bb.k

bb.k:                                             ; preds = %func_types_eq.exit.thread
  ...
  br i1 %.not426, label %bb.m, label %bb.l
...
bb.n:                                             ; preds = %bb.m, %bb.l
  %.0 = phi i1 [ %i.eu, %bb.l ], [ %i.fe, %bb.m ]
  %i.ff = select i1 %.0, i32 1, i32 257
  br label %bb.p

bb.o:                                             ; preds = %func_types_eq.exit.thread
  %i.fg = and i32 %.3, 65280
  br label %bb.p

bb.p:                                             ; preds = %bb.o, %bb.n
  %.0403 = phi i32 [ %i.ff, %bb.n ], [ %i.fg, %bb.o ] ; 4 uses
  %i.fh = and i32 %.0403, 1
  %.not428 = icmp eq i32 %i.fh, 0
  br i1 %.not428, label %.loopexit, label %bb.q

bb.q:                                             ; preds = %bb.p
  %i.fi = and i32 %.0403, 256
  %.not429 = icmp eq i32 %i.fi, 0
  br i1 %.not429, label %.loopexit482, label %bb.r
...
bb.r:                                             ; preds = %bb.q
  ...
  br i1 %i.fn, label %bb.s, label %.critedge436, !prof !27
...
bb.s:                                             ; preds = %bb.r
  ...
  br i1 %.not430, label %.critedge436, label %bb.t, !prof !31

bb.t:                                             ; preds = %bb.s
  %i.ft = load ptr, ptr %i.fq, align 8, !tbaa !33 ; 4 uses
  %i.fu = icmp eq ptr %i.dm, %i.ft
  br i1 %i.fu, label %func_types_eq.exit475.thread, label %bb.u
...
func_types_eq.exit475:                            ; preds = %bb.u
...
.critedge436:                                     ; preds = %bb.u, %bb.s, %bb.r, %func_types_eq.exit475
  tail call void @wasm_rt_trap(i32 noundef 6) #9
  unreachable

func_types_eq.exit475.thread:                     ; preds = %bb.t, %func_types_eq.exit475
  ...
  br i1 %.not431, label %.loopexit, label %bb.v

bb.v:                                             ; preds = %func_types_eq.exit475.thread
...
.loopexit:                                        ; preds = %.loopexit482, %func_types_eq.exit475.thread, %bb.p, %bb.g, %bb.f
  %.1 = phi i32 [ %i.de, %bb.f ], [ 0, %func_types_eq.exit475.thread ], [ 1, %bb.g ], [ 0, %bb.p ], [ 1, %.loopexit482 ] ; 2 uses
  ...
  br i1 %.not434, label %bb.x, label %bb.w
...
bb.x:                                             ; preds = %.loopexit, %bb.a, %bb.w
  %.2 = phi i32 [ 1, %bb.a ], [ %.1, %.loopexit ], [ %.1, %bb.w ]
