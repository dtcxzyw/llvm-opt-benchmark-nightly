...
wasm_trunc.exit:                                  ; preds = %bb.a
  ...
  %i.o = fadd double %i.l, %i.n                   ; 7 uses
...
wasm_floor.exit164:                               ; preds = %bb.c, %wasm_trunc.exit, %bb.b
  ...
  %4 = fadd nnan double %i.o, -1.601000e+03
  %5 = fdiv nnan double %4, 4.000000e+02
  ...
  %7 = fadd nnan double %i.o, -1.901000e+03
  %8 = fdiv nnan double %7, 1.000000e+02
  %i.ad = tail call nnan double @llvm.floor.f64(double %8)
  %i.ae = fsub double %i.ac, %i.ad
  %i.af = fadd double %6, %i.ae
...
bb.cl:                                            ; preds = %.loopexit6502
  ...
  %i.jq = fadd double %i.jo, %i.jp                ; 7 uses
...
bb.co:                                            ; preds = %bb.cm, %bb.cl, %bb.cn
  ...
  %3 = fadd double %i.jq, -1.601000e+03
  ...
  %6 = fadd double %i.jq, -1.901000e+03
  %7 = fdiv double %6, 1.000000e+02
  %i.kt = tail call double @llvm.floor.f64(double %7)
  %i.ku = fsub double %i.ks, %i.kt
  %i.kv = fadd double %5, %i.ku
...
bb.dw:                                            ; preds = %bb.dv
  ...
  %i.pg = fadd double %i.pe, %i.pf                ; 7 uses
...
bb.dz:                                            ; preds = %bb.dx, %bb.dw, %bb.dy
  ...
  %8 = fadd double %i.pg, -1.601000e+03
  %9 = fdiv double %8, 4.000000e+02
  ...
  %11 = fadd double %i.pg, -1.901000e+03
  %12 = fdiv double %11, 1.000000e+02
  %i.pz = tail call double @llvm.floor.f64(double %12)
  %i.qa = fsub double %i.py, %i.pz
  %i.qb = fadd double %10, %i.qa
...
bb.ps:                                            ; preds = %bb.kk, %bb.pr
  ...
  %i.bey = fadd double %i.bev, %i.bex             ; 7 uses
...
bb.pv:                                            ; preds = %bb.pt, %bb.ps, %bb.pu
  ...
  %13 = fadd double %i.bey, -1.601000e+03
  ...
  %16 = fadd double %i.bey, -1.901000e+03
  %17 = fdiv double %16, 1.000000e+02
  %i.bgc = tail call double @llvm.floor.f64(double %17)
  %i.bgd = fsub double %i.bgb, %i.bgc
  %i.bge = fadd double %15, %i.bgd
...
bb.py:                                            ; preds = %bb.js, %.split6516.us, %.split6524.us
  ...
  %i.bhr = fadd double %i.bho, %i.bhq             ; 7 uses
...
bb.qb:                                            ; preds = %bb.pz, %bb.py, %bb.qa
  ...
  %18 = fadd double %i.bhr, -1.601000e+03
  %19 = fdiv double %18, 4.000000e+02
  ...
  %21 = fadd double %i.bhr, -1.901000e+03
  %22 = fdiv double %21, 1.000000e+02
  %i.bit = tail call double @llvm.floor.f64(double %22)
  %i.biu = fsub double %i.bis, %i.bit
  %i.biv = fadd double %20, %i.biu
