...
begin_hunk_0_@_ZN6hermes2vm29regExpPrototypeSymbolMatchAllEPvRNS0_7RuntimeENS0_10NativeArgsE:bb.a
  ...
  %i.v = and i1 %i.t, %i.u
  br i1 %i.v, label %bb.b, label %_ZN6hermes2vm11TwineChar16C2EPKc.exit, !prof !38
...
_ZN6hermes2vm15HandleRootOwner10makeHandleINS0_15StringPrimitiveEEENS0_6HandleIT_EEONS0_12PseudoHandleIS5_EE.exit: ; preds = %bb.d, %bb.e
  ...
  br i1 %i.as, label %bb.ap, label %bb.f, !prof !15
...
_ZN6hermes2vm15HandleRootOwner10makeHandleINS0_11HermesValueEEENS0_6HandleIT_EEONS0_12PseudoHandleIS5_EE.exit: ; preds = %bb.g, %bb.h
  ...
  br i1 %.not110, label %bb.ap, label %bb.i, !prof !15
...
bb.i:                                             ; preds = %_ZN6hermes2vm15HandleRootOwner10makeHandleINS0_11HermesValueEEENS0_6HandleIT_EEONS0_12PseudoHandleIS5_EE.exit
  ...
  %i.be = load ptr, ptr %i.b, align 8, !tbaa !27  ; 3 uses
  ...
  br i1 %i.bj, label %bb.j, label %bb.k, !prof !38

bb.j:                                             ; preds = %bb.i
  %i.bk = getelementptr inbounds nuw i8, ptr %i.bg, i64 8
  store ptr %i.bk, ptr %i.bf, align 8, !tbaa !36
  store i64 %i.bd, ptr %i.bg, align 8, !tbaa !16
...
bb.l:                                             ; preds = %_ZN6hermes2vm15HandleRootOwner10makeHandleINS0_15StringPrimitiveEEENS0_6HandleIT_EEONS0_12PseudoHandleIS5_EE.exit34
  ...
  br i1 %i.bq, label %bb.ap, label %bb.m, !prof !15

bb.m:                                             ; preds = %bb.l
  %i.br = load ptr, ptr %i.b, align 8, !tbaa !27  ; 3 uses
  %i.bs = getelementptr inbounds nuw i8, ptr %i.br, i64 192 ; 2 uses
  %i.bt = load ptr, ptr %i.bs, align 8, !tbaa !36 ; 4 uses
  %i.bu = getelementptr inbounds nuw i8, ptr %i.br, i64 200
  %i.bv = load ptr, ptr %i.bu, align 8, !tbaa !37
  %i.bw = icmp ult ptr %i.bt, %i.bv
  br i1 %i.bw, label %bb.n, label %bb.o, !prof !38

bb.n:                                             ; preds = %bb.m
  %i.bx = getelementptr inbounds nuw i8, ptr %i.bt, i64 8
  store ptr %i.bx, ptr %i.bs, align 8, !tbaa !36
  store i64 %i.bp, ptr %i.bt, align 8, !tbaa !16
...
_ZN6hermes2vm15HandleRootOwner10makeHandleINS0_11HermesValueEEENS0_6HandleIT_EEONS0_12PseudoHandleIS5_EE.exit37: ; preds = %bb.n, %bb.o
  ...
  br i1 %i.cb, label %bb.ap, label %bb.p, !prof !15
...
bb.p:                                             ; preds = %_ZN6hermes2vm15HandleRootOwner10makeHandleINS0_11HermesValueEEENS0_6HandleIT_EEONS0_12PseudoHandleIS5_EE.exit37
  ...
  br i1 %i.cj, label %bb.q, label %bb.r, !prof !38
...
bb.r:                                             ; preds = %bb.p
  ...
  br i1 %.not.i.not.i.i.i.i.i.i.i.i, label %bb.s, label %bb.t, !prof !15
...
vector.body396:                                   ; preds = %vector.body396, %vector.ph394
  ...
  %wide.load403.a = load <16 x i8>, ptr %next.gep402, align 1, !tbaa !23 ; 2 uses
  %wide.load404 = load <16 x i8>, ptr %i.ew, align 1, !tbaa !23 ; 2 uses
  ...
  br i1 %i.ff, label %middle.block406, label %vector.body396, !llvm.loop !98
...
vec.epilog.iter.check415:                         ; preds = %middle.block406
  ...
  br i1 %min.epilog.iters.check416, label %_ZN6hermes2vm10StringView14const_iteratorppEi.exit.us.us.preheader, label %vec.epilog.ph417, !prof !115
...
vec.epilog.vector.body423:                        ; preds = %vec.epilog.vector.body423, %vec.epilog.ph417
  ...
  %wide.load428 = load <4 x i8>, ptr %next.gep427, align 1, !tbaa !23
  ...
  br i1 %i.fp, label %vec.epilog.middle.block430, label %vec.epilog.vector.body423, !llvm.loop !99
...
vector.body351:                                   ; preds = %vector.body351, %vector.ph349
  ...
  %wide.load358.a = load <16 x i8>, ptr %next.gep357, align 1, !tbaa !23 ; 2 uses
...
vector.body302:                                   ; preds = %vector.body302, %vector.ph300
  ...
  %wide.load309.a = load <8 x i16>, ptr %next.gep308, align 2, !tbaa !64 ; 2 uses
  %wide.load310 = load <8 x i16>, ptr %i.iv, align 2, !tbaa !64 ; 2 uses
  ...
  br i1 %i.je, label %middle.block312, label %vector.body302, !llvm.loop !105
...
vec.epilog.vector.body331:                        ; preds = %vec.epilog.vector.body331, %vec.epilog.ph325
  ...
  br i1 %i.js, label %vec.epilog.middle.block338, label %vec.epilog.vector.body331, !llvm.loop !106
...
_ZN6hermes2vm10StringView14const_iteratorppEi.exit.us126: ; preds = %_ZN6hermes2vm10StringView14const_iteratorppEi.exit.us126.preheader, %_ZN6hermes2vm10StringView14const_iteratorppEi.exit.us126
  ...
  %i.jx = load i16, ptr %.sroa.8.0.us115255, align 2, !tbaa !64 ; 2 uses
...
_ZNK6hermes2vm10StringView5beginEv.exit.split.split: ; preds = %bb.ai, %bb.ah, %bb.ag, %bb.ae
  ...
  br i1 %i.kf, label %_ZNK6hermes2vm10StringView5beginEv.exit.split.split.split.us, label %_ZNK6hermes2vm10StringView5beginEv.exit.split.split.split.preheader, !prof !15
...
bb.am:                                            ; preds = %_ZNK6hermes2vm10StringView5beginEv.exit.split.split.split.preheader
  %.sroa.0.0.copyload.i.i.i2.i5.i47.peel = load i64, ptr %i.kg, align 8, !tbaa !16
  ...
  %i.kl = load ptr, ptr %i.kk, align 8, !tbaa !61
  br label %_ZNK6hermes2vm10StringView15castToChar16PtrEv.exit.i41.peel
...
_ZN6hermes2vm10StringView14const_iteratorppEi.exit.peel: ; preds = %_ZNK6hermes2vm10StringView15castToChar16PtrEv.exit.i41.peel
  %i.ko = load i16, ptr %i.kb, align 2, !tbaa !64 ; 2 uses
...
_ZN6hermes2vm10StringView14const_iteratorppEi.exit.us148.peel: ; preds = %_ZNK6hermes2vm10StringView5beginEv.exit.split.split.split.us
  %i.kw = load i16, ptr %i.kb, align 2, !tbaa !64 ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load277 = load <8 x i16>, ptr %i.lj, align 2, !tbaa !64 ; 2 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.mg, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !109
...
_ZN6hermes2vm10StringView14const_iteratorppEi.exit.us148: ; preds = %_ZN6hermes2vm10StringView14const_iteratorppEi.exit.us148.preheader, %_ZN6hermes2vm10StringView14const_iteratorppEi.exit.us148
  ...
  %i.ml = load i16, ptr %.sroa.8.0.us135249, align 2, !tbaa !64 ; 2 uses
...
bb.ao:                                            ; preds = %_ZNK6hermes2vm10StringView5beginEv.exit.split.split.split
  %.sroa.0.0.copyload.i.i.i2.i5.i47 = load i64, ptr %i.kg, align 8, !tbaa !16
  ...
  %i.mr = load ptr, ptr %i.mq, align 8, !tbaa !61
  br label %_ZNK6hermes2vm10StringView15castToChar16PtrEv.exit.i41
...
_ZN6hermes2vm10StringView14const_iteratorppEi.exit: ; preds = %_ZNK6hermes2vm10StringView15castToChar16PtrEv.exit.i41
  %i.mx = load i16, ptr %.sroa.8.0, align 2, !tbaa !64 ; 2 uses
...
_ZSt4moveIPN6hermes8OptValueINS0_2vm16RegExpMatchRangeEEES5_ET0_T_S7_S6_.exit37: ; preds = %bb.o, %bb.n, %bb.l, %bb.k
  ...
  %i.y = load i32, ptr %i.m, align 8, !tbaa !43
...
_ZN4llvh23SmallVectorTemplateBaseIN6hermes8OptValueINS1_2vm16RegExpMatchRangeEEELb1EE18uninitialized_moveIPS5_S8_EEvT_S9_T0_.exit: ; preds = %_ZSt4moveIPN6hermes8OptValueINS0_2vm16RegExpMatchRangeEEES5_ET0_T_S7_S6_.exit37, %bb.p
  store i32 %i.n, ptr %i.p, align 8, !tbaa !43
...
bb.b:                                             ; preds = %bb.a
  ...
  store i64 %i.f, ptr %i.b, align 8, !tbaa !23
...
bb.d:                                             ; preds = %._crit_edge.i.i
  %i.g = load i16, ptr %1, align 2, !tbaa !64
  store i16 %i.g, ptr %.pre7.i.i, align 2, !tbaa !64
...
_ZNSt7__cxx1112basic_stringIDsSt11char_traitsIDsESaIDsEEC2IPKDsvEET_S8_RKS3_.exit: ; preds = %._crit_edge.i.i, %bb.d, %bb.e
  ...
  store i16 0, ptr %i.h, align 2, !tbaa !64
  ret void
}
...
!9 = !{!"_ZTSSt16reverse_iteratorIPKN6hermes2vm17PinnedHermesValueEE", !8, i64 0}
!10 = !{!"_ZTSN6hermes2vm10NativeArgsE", !9, i64 0, !5, i64 8, !8, i64 16}
!11 = !{!10, !5, i64 8}
!12 = !{!"long", !4, i64 0}
!13 = !{!"_ZTSN6hermes2vm11HermesValueE", !12, i64 0}
!14 = !{!13, !12, i64 0}
!15 = !{!"branch_weights", !"expected", i32 1, i32 2000}
!16 = !{!12, !12, i64 0}
!17 = !{!9, !8, i64 0}
!18 = !{!"_ZTSN6hermes2vm11TwineChar168NodeKindE", !4, i64 0}
!19 = !{!"_ZTSN6hermes2vm11TwineChar16E", !4, i64 0, !18, i64 8, !4, i64 16, !18, i64 24, !12, i64 32, !12, i64 40}
!20 = !{!19, !18, i64 24}
!21 = !{!19, !12, i64 32}
!22 = !{!19, !12, i64 40}
!23 = !{!4, !4, i64 0}
!24 = !{!19, !18, i64 8}
!25 = !{!"p1 _ZTSN6hermes2vm7GCScopeE", !7, i64 0}
!26 = !{!"_ZTSN6hermes2vm15HandleRootOwnerE", !25, i64 8}
!27 = !{!26, !25, i64 8}
!28 = !{!"p1 _ZTSN6hermes2vm15HandleRootOwnerE", !7, i64 0}
!29 = !{!"_ZTSN4llvh15SmallVectorBaseE", !7, i64 0, !5, i64 8, !5, i64 12}
!30 = !{!"_ZTSN4llvh25SmallVectorTemplateCommonIPN6hermes2vm17PinnedHermesValueEvEE", !29, i64 0}
!31 = !{!"_ZTSN4llvh23SmallVectorTemplateBaseIPN6hermes2vm17PinnedHermesValueELb1EEE", !30, i64 0}
!32 = !{!"_ZTSN4llvh15SmallVectorImplIPN6hermes2vm17PinnedHermesValueEEE", !31, i64 0}
!33 = !{!"_ZTSN4llvh18SmallVectorStorageIPN6hermes2vm17PinnedHermesValueELj4EEE", !4, i64 0}
!34 = !{!"_ZTSN4llvh11SmallVectorIPN6hermes2vm17PinnedHermesValueELj4EEE", !32, i64 0, !33, i64 16}
!35 = !{!"_ZTSN6hermes2vm7GCScopeE", !28, i64 0, !25, i64 8, !4, i64 16, !34, i64 144, !8, i64 192, !8, i64 200, !5, i64 208}
!36 = !{!35, !8, i64 192}
!37 = !{!35, !8, i64 200}
...
!46 = !{!"p1 _ZTSN6hermes2vm15StorageProviderE", !7, i64 0}
!47 = !{!"_ZTSN6hermes2vm14AlignedStorageE", !45, i64 0, !46, i64 8}
!48 = !{!"_ZTSN6hermes2vm18AlignedHeapSegmentE", !47, i64 0, !45, i64 16, !45, i64 24}
!49 = !{!48, !45, i64 16}
!50 = !{!48, !45, i64 24}
!51 = !{!"_ZTSN6hermes2vm6GCCellE", !4, i64 0}
!52 = !{!"double", !4, i64 0}
!53 = !{!"_ZTSN6hermes2vm11BoxedDoubleE", !51, i64 0, !52, i64 8}
!54 = !{!53, !52, i64 8}
!55 = !{!"_ZTSNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE12_Alloc_hiderE", !45, i64 0}
!56 = !{!"_ZTSNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE", !55, i64 0, !12, i64 8, !4, i64 16}
!57 = !{!56, !45, i64 0}
!58 = !{!"p1 char16_t", !7, i64 0}
!59 = !{!"_ZTSNSt7__cxx1112basic_stringIDsSt11char_traitsIDsESaIDsEE12_Alloc_hiderE", !58, i64 0}
!60 = !{!"_ZTSNSt7__cxx1112basic_stringIDsSt11char_traitsIDsESaIDsEEE", !59, i64 0, !12, i64 8, !4, i64 16}
!61 = !{!60, !58, i64 0}
!62 = !{!"llvm.loop.mustprogress"}
!63 = !{!"char16_t", !4, i64 0}
!64 = !{!63, !63, i64 0}
!65 = !{!"_ZTSN6hermes2vm16RegExpMatchRangeE", !5, i64 0, !5, i64 4}
!66 = !{!"bool", !4, i64 0}
!67 = !{!"_ZTSN6hermes8OptValueINS_2vm16RegExpMatchRangeEEE", !65, i64 0, !66, i64 8}
!68 = !{!67, !66, i64 8}
!69 = !{i8 0, i8 2}
!70 = !{}
!71 = !{!65, !5, i64 0}
!72 = !{!65, !5, i64 4}
!73 = !{!"_ZTSN6hermes2vm23VariableSizeRuntimeCellE", !51, i64 0}
!74 = !{!"_ZTSN6hermes2vm15StringPrimitiveE", !73, i64 0, !5, i64 4}
!75 = !{!74, !5, i64 4}
!76 = !{!8, !8, i64 0}
!77 = !{!"branch_weights", i32 1, i32 127}
!78 = !{!"branch_weights", i32 127, i32 255873}
!79 = !{!"_ZTSN6hermes2vm10HandleBaseE", !8, i64 0}
!80 = !{!79, !8, i64 0}
!81 = !{!47, !45, i64 0}
!82 = !{!"branch_weights", !"expected", i32 -2147483648, i32 0}
!83 = !{!"_ZTSN6hermes2vm12BasedPointerE", !5, i64 0}
!84 = !{!"_ZTSN6hermes2vm17CompressedPointerE", !83, i64 0}
!85 = !{!"_ZTSN4llvh16AlignedCharArrayILm8ELm64EEE", !4, i64 0}
!86 = !{!"_ZTSN4llvh21AlignedCharArrayUnionINS_11SmallVectorIN6hermes8OptValueINS2_2vm16RegExpMatchRangeEEELj4EEEcccccccccEE", !85, i64 0}
!87 = !{!"_ZTSN4llvh15optional_detail15OptionalStorageINS_11SmallVectorIN6hermes8OptValueINS3_2vm16RegExpMatchRangeEEELj4EEELb0EEE", !86, i64 0, !66, i64 64}
!88 = !{!"_ZTSN4llvh8OptionalINS_11SmallVectorIN6hermes8OptValueINS2_2vm16RegExpMatchRangeEEELj4EEEEE", !87, i64 0}
!89 = !{!88, !66, i64 64}
!90 = !{!87, !66, i64 64}
!91 = !{!66, !66, i64 0}
!92 = !{!10, !8, i64 16}
!93 = distinct !{!93, !"_ZNK6hermes2vm10NativeArgs5beginEv"}
!94 = distinct !{!94, !93, !"_ZNK6hermes2vm10NativeArgs5beginEv: argument 0"}
!95 = !{!94}
!96 = distinct !{!96, !"_ZNK6hermes2vm10NativeArgs5beginEv"}
!97 = distinct !{!97, !96, !"_ZNK6hermes2vm10NativeArgs5beginEv: argument 0"}
!98 = distinct !{!98, !62, !113, !114}
!99 = distinct !{!99, !62, !113, !114}
!100 = distinct !{!100, !62, !114, !113}
!101 = distinct !{!101, !62, !113, !114}
!102 = distinct !{!102, !62, !113, !114}
!103 = distinct !{!103, !62, !114, !113}
!104 = distinct !{!104, !62}
!105 = distinct !{!105, !62, !116, !113, !114}
!106 = distinct !{!106, !62, !116, !113, !114}
!107 = distinct !{!107, !62, !116, !114, !113}
!108 = distinct !{!108, !62, !116, !113, !114}
!109 = distinct !{!109, !62, !116, !113, !114}
!110 = distinct !{!110, !62, !116, !114, !113}
!111 = distinct !{!111, !62, !116}
!112 = !{!97}
...
!119 = distinct !{!119, !118, !"_ZNK6hermes2vm10NativeArgs5beginEv: argument 0"}
!120 = !{!119}
!121 = distinct !{!121, !"_ZNK6hermes2vm10NativeArgs5beginEv"}
!122 = distinct !{!122, !121, !"_ZNK6hermes2vm10NativeArgs5beginEv: argument 0"}
!123 = !{!122}
!124 = distinct !{!124, !"_ZNK6hermes2vm10NativeArgs5beginEv"}
!125 = distinct !{!125, !124, !"_ZNK6hermes2vm10NativeArgs5beginEv: argument 0"}
!126 = !{!125}
!127 = !{!"branch_weights", !"expected", i32 2145337238, i32 2146410}
!128 = distinct !{!128, !"_ZNK6hermes2vm10NativeArgs5beginEv"}
!129 = distinct !{!129, !128, !"_ZNK6hermes2vm10NativeArgs5beginEv: argument 0"}
!130 = distinct !{!130, !62}
!131 = !{!129}
!132 = distinct !{!132, !"_ZNK6hermes2vm10NativeArgs5beginEv"}
!133 = distinct !{!133, !132, !"_ZNK6hermes2vm10NativeArgs5beginEv: argument 0"}
!134 = !{!133}
!135 = distinct !{!135, !"_ZNK6hermes2vm10NativeArgs5beginEv"}
!136 = distinct !{!136, !135, !"_ZNK6hermes2vm10NativeArgs5beginEv: argument 0"}
!137 = distinct !{!137, !62}
!138 = distinct !{!138, !62}
!139 = distinct !{null}
!140 = distinct !{!140, !62}
!141 = !{!136}
!142 = !{!"_ZTSN6hermes2vm6GCBase11GCCallbacksE"}
!143 = !{!"_ZTSN6hermes2vm17PinnedHermesValueE", !13, i64 0}
!144 = !{!"p1 _ZTSN6hermes2vm8JSObjectE", !7, i64 0}
!145 = !{!"_ZTSN4llvh25SmallVectorTemplateCommonIN6hermes8OptValueINS1_2vm16RegExpMatchRangeEEEvEE", !29, i64 0}
!146 = !{!"_ZTSN4llvh23SmallVectorTemplateBaseIN6hermes8OptValueINS1_2vm16RegExpMatchRangeEEELb1EEE", !145, i64 0}
!147 = !{!"_ZTSN4llvh15SmallVectorImplIN6hermes8OptValueINS1_2vm16RegExpMatchRangeEEEEE", !146, i64 0}
!148 = !{!"_ZTSN4llvh18SmallVectorStorageIN6hermes8OptValueINS1_2vm16RegExpMatchRangeEEELj4EEE", !4, i64 0}
!149 = !{!"_ZTSN4llvh11SmallVectorIN6hermes8OptValueINS1_2vm16RegExpMatchRangeEEELj4EEE", !147, i64 0, !148, i64 16}
!150 = !{!"_ZTSN6hermes2vm14SynthTraceModeE", !4, i64 0}
!151 = !{!"p1 _ZTSN6hermes2vm16SamplingProfilerE", !7, i64 0}
!152 = !{!"_ZTSSt10_Head_baseILm0EPN6hermes2vm16SamplingProfilerELb0EE", !151, i64 0}
!153 = !{!"_ZTSSt11_Tuple_implILm0EJPN6hermes2vm16SamplingProfilerESt14default_deleteIS2_EEE", !152, i64 0}
!154 = !{!"_ZTSSt5tupleIJPN6hermes2vm16SamplingProfilerESt14default_deleteIS2_EEE", !153, i64 0}
!155 = !{!"_ZTSSt15__uniq_ptr_implIN6hermes2vm16SamplingProfilerESt14default_deleteIS2_EE", !154, i64 0}
!156 = !{!"_ZTSSt15__uniq_ptr_dataIN6hermes2vm16SamplingProfilerESt14default_deleteIS2_ELb1ELb1EE", !155, i64 0}
!157 = !{!"_ZTSSt10unique_ptrIN6hermes2vm16SamplingProfilerESt14default_deleteIS2_EE", !156, i64 0}
!158 = !{!"p1 _ZTSN6hermes2vm16TimeLimitMonitorE", !7, i64 0}
!159 = !{!"p1 _ZTSSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE", !7, i64 0}
!160 = !{!"_ZTSSt14__shared_countILN9__gnu_cxx12_Lock_policyE2EE", !159, i64 0}
!161 = !{!"_ZTSSt12__shared_ptrIN6hermes2vm16TimeLimitMonitorELN9__gnu_cxx12_Lock_policyE2EE", !158, i64 0, !160, i64 8}
!162 = !{!"_ZTSSt10shared_ptrIN6hermes2vm16TimeLimitMonitorEE", !161, i64 0}
!163 = !{!"_ZTSN6hermes2vm11GCExecTraceE"}
!164 = !{!"p1 _ZTSN6hermes2vm6GCBase11GCCallbacksE", !7, i64 0}
!165 = !{!"p1 _ZTSN6hermes2vm11PointerBaseE", !7, i64 0}
!166 = !{!"p1 _ZTSN6hermes2vm12CrashManagerE", !7, i64 0}
!167 = !{!"_ZTSSt12__shared_ptrIN6hermes2vm12CrashManagerELN9__gnu_cxx12_Lock_policyE2EE", !166, i64 0, !160, i64 8}
!168 = !{!"_ZTSSt10shared_ptrIN6hermes2vm12CrashManagerEE", !167, i64 0}
!169 = !{!"_ZTSN6hermes2vm6GCBase8HeapKindE", !4, i64 0}
!170 = !{!"_ZTSSt14_Function_base", !4, i64 0, !7, i64 16}
!171 = !{!"_ZTSSt8functionIFvRKN6hermes2vm16GCAnalyticsEventEEE", !170, i64 0, !7, i64 24}
!172 = !{!"p1 _ZTSN6hermes2vm16GCAnalyticsEventE", !7, i64 0}
!173 = !{!"_ZTSNSt12_Vector_baseIN6hermes2vm16GCAnalyticsEventESaIS2_EE17_Vector_impl_dataE", !172, i64 0, !172, i64 8, !172, i64 16}
!174 = !{!"_ZTSNSt12_Vector_baseIN6hermes2vm16GCAnalyticsEventESaIS2_EE12_Vector_implE", !173, i64 0}
!175 = !{!"_ZTSSt12_Vector_baseIN6hermes2vm16GCAnalyticsEventESaIS2_EE", !174, i64 0}
!176 = !{!"_ZTSSt6vectorIN6hermes2vm16GCAnalyticsEventESaIS2_EE", !175, i64 0}
end_hunk_1
