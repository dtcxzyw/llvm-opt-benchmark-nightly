...
bb.hb:                                            ; preds = %bb.gu
  ...
  %.neg217.i.i = xor i32 %spec.select.i.i, -1
...
bb.hc:                                            ; preds = %bb.hb, %i2b.exit.i.i
  ...
  %.1108.neg218.i.i = phi i32 [ 0, %i2b.exit.i.i ], [ %.neg217.i.i, %bb.hb ]
  %.0102.i.i = phi ptr [ %.1.i.i.i.i, %i2b.exit.i.i ], [ %i.aen, %bb.hb ] ; 3 uses
  %reass.sub182 = sub i32 %i.aet, %i.adl
  %.neg185.i.i = add i32 %reass.sub182, 1
  %i.aeu = add i32 %.neg185.i.i, %.1108.neg218.i.i ; 3 uses
...
.lr.ph.i687.i:                                    ; preds = %bb.hv, %.lr.ph.preheader.i.i
  ...
  %.4206.i.i = phi ptr [ %.3.i.i, %.lr.ph.preheader.i.i ], [ %i.agv, %bb.hv ] ; 5 uses
  %.1113204.i.i = phi i32 [ %.0112.i.i, %.lr.ph.preheader.i.i ], [ %i.agw, %bb.hv ]
...
bb.hv:                                            ; preds = %bb.ht, %bb.hs
  %i.agv = call fastcc ptr @multadd(ptr noundef nonnull %3, ptr noundef nonnull %.4206.i.i, i32 noundef 10, i32 noundef 0) ; 3 uses
...
._crit_edge.i682.i:                               ; preds = %bb.hv, %bb.hr
  ...
  br i1 %i.agx, label %.lr.ph213.preheader.i.i, label %._crit_edge214.i.i

.lr.ph213.preheader.i.i:                          ; preds = %._crit_edge.i682.i
  %i.agy = sext i32 %.sroa.6.2.i to i64
  br label %.lr.ph213.i.i

.lr.ph213.i.i:                                    ; preds = %bb.hz, %.lr.ph213.preheader.i.i
  %indvars.iv242.i.i = phi i64 [ %i.agy, %.lr.ph213.preheader.i.i ], [ %indvars.iv.next243.i.i, %bb.hz ] ; 2 uses
  %.in.i.i = phi i32 [ %.2109.lcssa.i.i, %.lr.ph213.preheader.i.i ], [ %i.agz, %bb.hz ]
  %.5211.i.i = phi ptr [ %.4.lcssa.i.i, %.lr.ph213.preheader.i.i ], [ %i.ahk, %bb.hz ] ; 5 uses
  %.2114209.i.i = phi i32 [ %.1113.lcssa.i.i, %.lr.ph213.preheader.i.i ], [ %i.ahl, %bb.hz ]
  %i.agz = add nuw i32 %.in.i.i, 1                ; 3 uses
  %indvars.iv.next243.i.i = add nsw i64 %indvars.iv242.i.i, 1
  %i.aha = getelementptr inbounds i8, ptr %.2450.i, i64 %indvars.iv242.i.i
  %i.ahb = load i8, ptr %i.aha, align 1, !tbaa !19
  %i.ahc = sext i8 %i.ahb to i32
  %reass.sub220.i.i = sub i32 %i.ahc, %.2114209.i.i
  %i.ahd = add i32 %reass.sub220.i.i, -48         ; 2 uses
  %.not139.i.i = icmp eq i32 %i.ahd, 0
  br i1 %.not139.i.i, label %bb.hw, label %.loopexit.i.i

bb.hw:                                            ; preds = %.lr.ph213.i.i
  %i.ahe = getelementptr inbounds nuw i8, ptr %.5211.i.i, i64 24
  %i.ahf = load i32, ptr %i.ahe, align 8, !tbaa !3
  %.not140.i.i = icmp eq i32 %i.ahf, 0
  br i1 %.not140.i.i, label %bb.hx, label %bb.hz

bb.hx:                                            ; preds = %bb.hw
  %i.ahg = getelementptr inbounds nuw i8, ptr %.5211.i.i, i64 20
...
bb.hz:                                            ; preds = %bb.hx, %bb.hw
  %i.ahk = call fastcc ptr @multadd(ptr noundef nonnull %3, ptr noundef nonnull %.5211.i.i, i32 noundef 10, i32 noundef 0) ; 3 uses
  %i.ahl = call fastcc i32 @quorem(ptr noundef %i.ahk, ptr noundef %.1104.i.i) ; 2 uses
  %exitcond245.not.i.i = icmp eq i32 %i.agz, %i.lh
  br i1 %exitcond245.not.i.i, label %._crit_edge214.i.i, label %.lr.ph213.i.i, !llvm.loop !44

._crit_edge214.i.i:                               ; preds = %bb.hz, %._crit_edge.i682.i
...
.loopexit.i.i:                                    ; preds = %.lr.ph.i687.i, %.lr.ph213.i.i, %._crit_edge214.i.i
  %.2117.i.i = phi i32 [ %i.ahd, %.lr.ph213.i.i ], [ -1, %._crit_edge214.i.i ], [ %i.agn, %.lr.ph.i687.i ] ; 2 uses
  %.6.i.i = phi ptr [ %.5211.i.i, %.lr.ph213.i.i ], [ %.5.lcssa.i.i, %._crit_edge214.i.i ], [ %.4206.i.i, %.lr.ph.i687.i ] ; 2 uses
...
.thread.i.i:                                      ; preds = %.loopexit.i.i, %.thread180.i.i, %bb.ib, %bb.hy, %bb.hu
  %.6178.i.i = phi ptr [ %.6.i.i, %.loopexit.i.i ], [ %.5211.i.i, %bb.hy ], [ %.4206.i.i, %bb.hu ], [ %.5.lcssa.i.i, %bb.ib ], [ %.5.lcssa.i.i, %.thread180.i.i ] ; 4 uses
...
.bigcomp.exit_crit_edge.i:                        ; preds = %bb.ih
  %.pre1072.i = load i32, ptr %i.qz, align 4, !tbaa !19
...
bb.ij:                                            ; preds = %bb.ii
  %.pre1073.i = load i32, ptr %i.qz, align 4, !tbaa !19 ; 2 uses
  br i1 %.0111.i.i, label %._crit_edge250.i.i, label %bigcomp.exit.i

._crit_edge250.i.i:                               ; preds = %bb.iv, %bb.ij
  %.val154.i.i = phi i32 [ %i.ais, %bb.iv ], [ %.pre1073.i, %bb.ij ] ; 2 uses
end_hunk_0
