...
begin_hunk_2_@g_dtoa:bb.a
  ...
  %.not.i.i626 = icmp ult i32 %i.pf, 65536        ; 3 uses
  ...
  %8 = select i1 %.not.i.i626, i32 24, i32 8
...
bb.l:                                             ; preds = %bb.g
  ...
  %.not33.i = icmp eq i32 %i.ah, 0                ; 3 uses
  ...
  %4 = select i1 %.not33.i, i32 24, i32 8
...
bb.t:                                             ; preds = %bb.o
  ...
  %.not33.i43 = icmp eq i32 %i.be, 0              ; 3 uses
  %i.bf = lshr exact i32 %spec.select, 16
  %spec.select.i44 = select i1 %.not33.i43, i32 16, i32 0
  ...
  %6 = select i1 %.not33.i43, i32 24, i32 8
...
begin_hunk_10_@dtoa_fixedpoint:bb.a
  ...
  %.not.i.i595 = icmp ult i32 %i.pd, 65536        ; 3 uses
  %i.pe = shl nuw i32 %i.pd, 16
  %spec.select.i.i = select i1 %.not.i.i595, i32 %i.pe, i32 %i.pd ; 3 uses
  %spec.select26.i.i = select i1 %.not.i.i595, i32 16, i32 0
  %.not21.i.i = icmp ult i32 %spec.select.i.i, 16777216 ; 2 uses
  %8 = select i1 %.not.i.i595, i32 24, i32 8
...
begin_hunk_12_@b2d:bb.a
  ...
  %.not.i = icmp ult i32 %i.g, 65536              ; 3 uses
  ...
  %2 = select i1 %.not.i, i32 24, i32 8
