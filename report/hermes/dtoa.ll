...
.lr.ph904.i.preheader.new:                        ; preds = %.lr.ph904.i.preheader
  %unroll_iter682 = and i32 %.1473.i, 2147483646
  br label %.lr.ph904.i
...
.lr.ph904.i:                                      ; preds = %.lr.ph904.i, %.lr.ph904.i.preheader.new
  ...
  %niter683 = phi i32 [ 0, %.lr.ph904.i.preheader.new ], [ %niter683.next.1, %.lr.ph904.i ]
  ...
  %niter683.next.1 = add nuw nsw i32 %niter683, 2 ; 2 uses
  %niter683.ncmp.1 = icmp eq i32 %niter683.next.1, %unroll_iter682
  br i1 %niter683.ncmp.1, label %._crit_edge905.loopexit.i.unr-lcssa, label %.lr.ph904.i, !llvm.loop !23

._crit_edge905.loopexit.i.unr-lcssa:              ; preds = %.lr.ph904.i
  %lcmp.mod678.not = icmp eq i32 %xtraiter676, 0
  br i1 %lcmp.mod678.not, label %._crit_edge905.loopexit.i, label %.lr.ph904.i.epil.preheader
...
.lr.ph904.i.epil.preheader:                       ; preds = %._crit_edge905.loopexit.i.unr-lcssa, %.lr.ph904.i.preheader
  ...
  %lcmp.mod681 = trunc i32 %.1473.i to i1
