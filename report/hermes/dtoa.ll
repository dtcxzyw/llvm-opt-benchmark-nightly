...
bb.ca:                                            ; preds = %bb.iw, %bb.fd, %sulp.exit653.i, %.loopexit, %bb.bz, %bb.bu, %bb.bo
  ...
  %.2.i = phi ptr [ %.5.i, %bb.iw ], [ %i.ur, %.loopexit ], [ undef, %bb.bz ], [ %i.ur, %bb.fd ], [ undef, %bb.bo ], [ undef, %bb.bu ], [ %i.ur, %sulp.exit653.i ]
...
.loopexit745.i:                                   ; preds = %bb.ce, %bb.cb
  ...
  %i.or = add nsw i32 %.6490.i, 8
  %4 = sdiv i32 %i.or, 9
  %i.os = icmp sgt i32 %.6490.i, 9
  br i1 %i.os, label %.lr.ph.i.i, label %._crit_edge.thread.i.i.thread

.lr.ph.i.i:                                       ; preds = %.loopexit745.i, %.lr.ph.i.i
  %.040.i.i = phi i32 [ %i.ot, %.lr.ph.i.i ], [ 1, %.loopexit745.i ]
  %.02839.i.i = phi i32 [ %i.ou, %.lr.ph.i.i ], [ 0, %.loopexit745.i ] ; 3 uses
  %i.ot = shl i32 %.040.i.i, 1                    ; 2 uses
  %i.ou = add nuw nsw i32 %.02839.i.i, 1          ; 5 uses
  %i.ov = icmp sgt i32 %4, %i.ot
  br i1 %i.ov, label %.lr.ph.i.i, label %._crit_edge.i.i, !llvm.loop !37

._crit_edge.i.i:                                  ; preds = %.lr.ph.i.i
  %i.ow = icmp samesign ult i32 %.02839.i.i, 7
  br i1 %i.ow, label %._crit_edge.thread.i.i, label %bb.cg

._crit_edge.thread.i.i:                           ; preds = %._crit_edge.i.i
  %.phi.trans.insert = getelementptr inbounds nuw i8, ptr %3, i64 16
  %.phi.trans.insert292 = zext nneg i32 %i.ou to i64
...
bb.cf:                                            ; preds = %._crit_edge.thread.i.i
  ...
  %i.oz = getelementptr inbounds nuw [8 x i8], ptr %i.ox, i64 %i.oy
  %i.pa = load ptr, ptr %.pre, align 8, !tbaa !15
  store ptr %i.pa, ptr %i.oz, align 8, !tbaa !13
  br label %Balloc.exit.i.i

bb.cg:                                            ; preds = %._crit_edge.i.i
  %i.pb = shl nuw i32 2, %.02839.i.i              ; 2 uses
  %i.pc = add nsw i32 %i.pb, -1
  %i.pd = zext nneg i32 %i.pc to i64
  %i.pe = shl nuw nsw i64 %i.pd, 2
  %i.pf = add nuw nsw i64 %i.pe, 36
  %i.pg = call noalias ptr @malloc(i64 noundef %i.pf) #19
  %i.ph = getelementptr inbounds nuw i8, ptr %3, i64 4
  store i32 1, ptr %i.ph, align 4, !tbaa !12
  br label %bb.ch

._crit_edge.thread.i.i.thread:                    ; preds = %.lr.ph937.i.prol.loopexit, %.lr.ph937.i, %.preheader.i, %.loopexit745.i, %._crit_edge.thread.i.i
  %.028.lcssa58.i.i380 = phi i32 [ %i.ou, %._crit_edge.thread.i.i ], [ 0, %.loopexit745.i ], [ 0, %.preheader.i ], [ 0, %.lr.ph937.i ], [ 0, %.lr.ph937.i.prol.loopexit ] ; 2 uses
  ...
  %i.pi = shl nuw nsw i32 1, %.028.lcssa58.i.i380 ; 2 uses
  %i.pj = add nsw i32 %i.pi, -1
  %i.pk = zext nneg i32 %i.pj to i64
  %i.pl = shl nuw nsw i64 %i.pk, 2
  %i.pm = add nuw nsw i64 %i.pl, 36
  %i.pn = lshr i64 %i.pm, 3
  %i.po = getelementptr inbounds nuw [8 x i8], ptr %i.g, i64 %i.pn
  store ptr %i.po, ptr %i.h, align 8, !tbaa !11
  br label %bb.ch
...
bb.ch:                                            ; preds = %bb.cg, %._crit_edge.thread.i.i.thread
  ...
  %.028.lcssa56.i.i = phi i32 [ %.028.lcssa58.i.i380, %._crit_edge.thread.i.i.thread ], [ %i.ou, %bb.cg ]
  %i.pp = phi i32 [ %i.pi, %._crit_edge.thread.i.i.thread ], [ %i.pb, %bb.cg ]
  %.0.i.i.i = phi ptr [ %i.g, %._crit_edge.thread.i.i.thread ], [ %i.pg, %bb.cg ] ; 3 uses
  %i.pq = getelementptr inbounds nuw i8, ptr %.0.i.i.i, i64 8
  store i32 %.028.lcssa56.i.i, ptr %i.pq, align 8, !tbaa !29
  %i.pr = getelementptr inbounds nuw i8, ptr %.0.i.i.i, i64 12
  store i32 %i.pp, ptr %i.pr, align 4, !tbaa !38
  br label %Balloc.exit.i.i
...
Balloc.exit.i.i:                                  ; preds = %bb.ch, %bb.cf
  ...
  %i.ps = getelementptr inbounds nuw i8, ptr %.1.i.i.i, i64 20
  %i.pt = getelementptr inbounds nuw i8, ptr %.1.i.i.i, i64 16
  store i32 0, ptr %i.pt, align 8, !tbaa !39
  %i.pu = getelementptr inbounds nuw i8, ptr %.1.i.i.i, i64 24
  store i32 %.111206.i, ptr %i.pu, align 8, !tbaa !3
  store i32 1, ptr %i.ps, align 4, !tbaa !40
  %i.pv = icmp sgt i32 %.24831202.i, 9
  br i1 %i.pv, label %bb.ci, label %bb.cl

bb.ci:                                            ; preds = %Balloc.exit.i.i
  %i.pw = getelementptr inbounds nuw i8, ptr %.2450.i, i64 9
  br label %bb.cj

bb.cj:                                            ; preds = %bb.cj, %bb.ci
  %.032.i.i = phi ptr [ %.1.i.i.i, %bb.ci ], [ %i.qb, %bb.cj ]
  %.029.i.i = phi i32 [ 9, %bb.ci ], [ %i.qc, %bb.cj ]
  %.027.i.i = phi ptr [ %i.pw, %bb.ci ], [ %i.px, %bb.cj ] ; 2 uses
  %i.px = getelementptr inbounds nuw i8, ptr %.027.i.i, i64 1 ; 2 uses
  %i.py = load i8, ptr %.027.i.i, align 1, !tbaa !19
  %i.pz = sext i8 %i.py to i32
  %i.qa = add nsw i32 %i.pz, -48
  %i.qb = call fastcc ptr @multadd(ptr noundef nonnull %3, ptr noundef %.032.i.i, i32 noundef 10, i32 noundef %i.qa) ; 2 uses
  %i.qc = add nuw nsw i32 %.029.i.i, 1            ; 2 uses
  %exitcond.not.i.i = icmp eq i32 %i.qc, %.24831202.i
  br i1 %exitcond.not.i.i, label %bb.ck, label %bb.cj, !llvm.loop !41

bb.ck:                                            ; preds = %bb.cj
  %i.qd = sext i32 %.sroa.12.0.i to i64
  %i.qe = getelementptr inbounds i8, ptr %i.px, i64 %i.qd
  br label %bb.cm

bb.cl:                                            ; preds = %Balloc.exit.i.i
  %i.qf = sext i32 %.sroa.12.0.i to i64
  %i.qg = getelementptr i8, ptr %.2450.i, i64 %i.qf
  %i.qh = getelementptr i8, ptr %i.qg, i64 9
  br label %bb.cm

bb.cm:                                            ; preds = %bb.cl, %bb.ck
  %.133.i.i = phi ptr [ %i.qb, %bb.ck ], [ %.1.i.i.i, %bb.cl ] ; 2 uses
  %.130.i.i = phi i32 [ %.24831202.i, %bb.ck ], [ 9, %bb.cl ] ; 2 uses
  %.1.i.i = phi ptr [ %i.qe, %bb.ck ], [ %i.qh, %bb.cl ]
  %i.qi = icmp slt i32 %.130.i.i, %.64901198.i
  br i1 %i.qi, label %.lr.ph45.i.i, label %s2b.exit.i

.lr.ph45.i.i:                                     ; preds = %bb.cm, %.lr.ph45.i.i
  %.243.i.i = phi ptr [ %i.qj, %.lr.ph45.i.i ], [ %.1.i.i, %bb.cm ] ; 2 uses
  %.23142.i.i = phi i32 [ %i.qo, %.lr.ph45.i.i ], [ %.130.i.i, %bb.cm ]
  %.23441.i.i = phi ptr [ %i.qn, %.lr.ph45.i.i ], [ %.133.i.i, %bb.cm ]
  %i.qj = getelementptr inbounds nuw i8, ptr %.243.i.i, i64 1
  %i.qk = load i8, ptr %.243.i.i, align 1, !tbaa !19
  %i.ql = sext i8 %i.qk to i32
  %i.qm = add nsw i32 %i.ql, -48
  %i.qn = call fastcc ptr @multadd(ptr noundef nonnull %3, ptr noundef %.23441.i.i, i32 noundef 10, i32 noundef %i.qm) ; 2 uses
  %i.qo = add nuw i32 %.23142.i.i, 1              ; 2 uses
  %exitcond52.not.i.i = icmp eq i32 %i.qo, %.64901198.i
  br i1 %exitcond52.not.i.i, label %s2b.exit.i, label %.lr.ph45.i.i, !llvm.loop !42

s2b.exit.i:                                       ; preds = %.lr.ph45.i.i, %bb.cm
  %.234.lcssa.i.i = phi ptr [ %.133.i.i, %bb.cm ], [ %i.qn, %.lr.ph45.i.i ] ; 12 uses
  %i.qp = getelementptr inbounds nuw i8, ptr %.234.lcssa.i.i, i64 8 ; 2 uses
  %i.qq = getelementptr inbounds nuw i8, ptr %.234.lcssa.i.i, i64 16
  %i.qr = getelementptr inbounds nuw i8, ptr %.234.lcssa.i.i, i64 20
  %i.qs = getelementptr inbounds nuw i8, ptr %3, i64 24 ; 6 uses
  %i.qt = icmp sgt i32 %.25111194.i, -1           ; 2 uses
  %i.qu = sub nsw i32 0, %.25111194.i
  %.0519.i = select i1 %i.qt, i32 %.25111194.i, i32 0 ; 3 uses
  %.0437.i = select i1 %i.qt, i32 0, i32 %i.qu    ; 3 uses
  %.1521.i = add i32 %.0519.i, %.sroa.44711.1.i
  %.not571.i = icmp eq i32 %.0437.i, 0
  %i.qv = getelementptr inbounds nuw i8, ptr %3, i64 16 ; 13 uses
  %i.qw = ptrtoint ptr %i.g to i64                ; 4 uses
  %i.qx = getelementptr inbounds nuw i8, ptr %3, i64 4 ; 4 uses
  %i.qy = icmp sgt i32 %.0519.i, 0
  %i.qz = icmp sgt i32 %i.lj, %.64901198.i        ; 4 uses
  %i.ra = getelementptr inbounds nuw i8, ptr %2, i64 4 ; 15 uses
  %i.rb = icmp ne i32 %.sroa.44711.1.i, 0
  %i.rc = icmp eq i32 %i.lj, %.64901198.i
  %i.rd = icmp eq i32 %.sroa.44711.1.i, 0         ; 8 uses
  %or.cond44.not736.i = and i1 %i.rd, %i.rc
  br label %Bfree.exit669.i

Bfree.exit669.i:                                  ; preds = %Bfree.exit669.i.backedge, %s2b.exit.i
  %i.re = load i32, ptr %i.qp, align 8, !tbaa !29 ; 5 uses
  %i.rf = icmp slt i32 %i.re, 8
  br i1 %i.rf, label %bb.cn, label %bb.cp

bb.cn:                                            ; preds = %Bfree.exit669.i
  %i.rg = sext i32 %i.re to i64
  %i.rh = getelementptr inbounds [8 x i8], ptr %i.qv, i64 %i.rg ; 2 uses
  %i.ri = load ptr, ptr %i.rh, align 8, !tbaa !13 ; 3 uses
  %.not.i624.i = icmp eq ptr %i.ri, null
  br i1 %.not.i624.i, label %bb.cq, label %bb.co

bb.co:                                            ; preds = %bb.cn
  %i.rj = load ptr, ptr %i.ri, align 8, !tbaa !15
  store ptr %i.rj, ptr %i.rh, align 8, !tbaa !13
  br label %Balloc.exit.i

bb.cp:                                            ; preds = %Bfree.exit669.i
  %i.rk = shl nuw i32 1, %i.re                    ; 2 uses
  %i.rl = add nsw i32 %i.rk, -1
  %i.rm = zext nneg i32 %i.rl to i64
  %i.rn = shl nuw nsw i64 %i.rm, 2
  %i.ro = add nuw nsw i64 %i.rn, 36
  br label %bb.cs

bb.cq:                                            ; preds = %bb.cn
  %i.rp = shl nuw nsw i32 1, %i.re                ; 3 uses
  %i.rq = add nsw i32 %i.rp, -1
  %i.rr = zext nneg i32 %i.rq to i64
  %i.rs = shl nuw nsw i64 %i.rr, 2
  %i.rt = add nuw nsw i64 %i.rs, 36               ; 2 uses
  %i.ru = lshr i64 %i.rt, 3                       ; 2 uses
  %i.rv = load ptr, ptr %i.h, align 8, !tbaa !11  ; 3 uses
  %i.rw = ptrtoint ptr %i.rv to i64
  %i.rx = sub i64 %i.rw, %i.qw
  %i.ry = ashr exact i64 %i.rx, 3
  %i.rz = add nsw i64 %i.ry, %i.ru
  %i.sa = load i32, ptr %3, align 8, !tbaa !7
  %i.sb = sext i32 %i.sa to i64
  %.not26.i.i = icmp sgt i64 %i.rz, %i.sb
