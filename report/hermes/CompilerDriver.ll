...
bb.fh:                                            ; preds = %_ZNSt6vectorIN12_GLOBAL__N_115ModuleInSegmentESaIS1_EED2Ev.exit.thread.i, %.lr.ph362.i
  %.sroa.17.3 = phi ptr [ null, %.lr.ph362.i ], [ %.sroa.17.5, %_ZNSt6vectorIN12_GLOBAL__N_115ModuleInSegmentESaIS1_EED2Ev.exit.thread.i ] ; 9 uses
  %.sroa.10.2 = phi ptr [ null, %.lr.ph362.i ], [ %.sroa.10.4, %_ZNSt6vectorIN12_GLOBAL__N_115ModuleInSegmentESaIS1_EED2Ev.exit.thread.i ] ; 9 uses
  %.sroa.0241.3 = phi ptr [ null, %.lr.ph362.i ], [ %.sroa.0241.5, %_ZNSt6vectorIN12_GLOBAL__N_115ModuleInSegmentESaIS1_EED2Ev.exit.thread.i ] ; 11 uses
...
begin_hunk_4
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %98) #27
  call void @llvm.lifetime.end.p0(ptr nonnull %97) #27
  br i1 %i.agh, label %bb.gr, label %_ZN4llvh11raw_ostreamlsEPKc.exit161.i
...
._crit_edge.i:                                    ; preds = %bb.gr, %_ZN4llvh16dyn_cast_or_nullIN6hermes6parser9JSONArrayENS2_9JSONValueEEENS_10cast_rettyIT_PT0_E8ret_typeES8_.exit.i
  %.sroa.19.0.lcssa.i = phi ptr [ null, %_ZN4llvh16dyn_cast_or_nullIN6hermes6parser9JSONArrayENS2_9JSONValueEEENS_10cast_rettyIT_PT0_E8ret_typeES8_.exit.i ], [ %.sroa.19.1.i, %bb.gr ] ; 3 uses
  ...
  %.sroa.0197.0.lcssa.i = phi ptr [ null, %_ZN4llvh16dyn_cast_or_nullIN6hermes6parser9JSONArrayENS2_9JSONValueEEENS_10cast_rettyIT_PT0_E8ret_typeES8_.exit.i ], [ %.sroa.0197.1.i, %bb.gr ] ; 6 uses
...
_ZN4llvh11raw_ostreamlsEPKc.exit161.i:            ; preds = %_ZN4llvh11raw_ostreamlsEPKc.exit131.i, %_ZNKSt14default_deleteIN4llvh12MemoryBufferEEclEPS1_.exit.i147.i, %bb.hb, %bb.ha, %_ZN4llvh11raw_ostreamlsEPKc.exit131.thread253.i, %bb.fz, %bb.fy
  %.sroa.15.5.i = phi ptr [ %.sroa.19.0.lcssa.i, %bb.hb ], [ %.sroa.19.0350.i, %bb.fz ], [ %.sroa.19.0.lcssa.i, %bb.ha ], [ %.sroa.19.0350.i, %bb.fy ], [ %.sroa.19.0350.i, %_ZN4llvh11raw_ostreamlsEPKc.exit131.thread253.i ], [ %.sroa.19.1.i, %_ZNKSt14default_deleteIN4llvh12MemoryBufferEEclEPS1_.exit.i147.i ], [ %.sroa.19.1.i, %_ZN4llvh11raw_ostreamlsEPKc.exit131.i ]
  %.sroa.10.5.i = phi ptr [ %.sroa.13.0.lcssa.i, %bb.hb ], [ %.sroa.13.0351.i, %bb.fz ], [ %.sroa.13.0.lcssa.i, %bb.ha ], [ %.sroa.13.0351.i, %bb.fy ], [ %.sroa.13.0351.i, %_ZN4llvh11raw_ostreamlsEPKc.exit131.thread253.i ], [ %.sroa.13.1.i, %_ZNKSt14default_deleteIN4llvh12MemoryBufferEEclEPS1_.exit.i147.i ], [ %.sroa.13.1.i, %_ZN4llvh11raw_ostreamlsEPKc.exit131.i ] ; 2 uses
  %.sroa.0178.5.i = phi ptr [ %.sroa.0197.0.lcssa.i, %bb.hb ], [ %.sroa.0197.0352.i, %bb.fz ], [ %.sroa.0197.0.lcssa.i, %bb.ha ], [ %.sroa.0197.0352.i, %bb.fy ], [ %.sroa.0197.0352.i, %_ZN4llvh11raw_ostreamlsEPKc.exit131.thread253.i ], [ %.sroa.0197.1.i, %_ZNKSt14default_deleteIN4llvh12MemoryBufferEEclEPS1_.exit.i147.i ], [ %.sroa.0197.1.i, %_ZN4llvh11raw_ostreamlsEPKc.exit131.i ] ; 5 uses
  %.not4.i.i.i.i = icmp eq ptr %.sroa.0178.5.i, %.sroa.10.5.i
...
.lr.ph.i.i.i.i:                                   ; preds = %_ZN4llvh11raw_ostreamlsEPKc.exit161.i, %_ZSt8_DestroyIN12_GLOBAL__N_115ModuleInSegmentEEvPT_.exit.i.i.i.i
  %.05.i.i.i.i = phi ptr [ %i.ajs, %_ZSt8_DestroyIN12_GLOBAL__N_115ModuleInSegmentEEvPT_.exit.i.i.i.i ], [ %.sroa.0178.5.i, %_ZN4llvh11raw_ostreamlsEPKc.exit161.i ] ; 3 uses
...
_ZSt8_DestroyIN12_GLOBAL__N_115ModuleInSegmentEEvPT_.exit.i.i.i.i: ; preds = %_ZNKSt14default_deleteIN4llvh12MemoryBufferEEclEPS1_.exit.i2.i.i.i.i.i.i, %_ZNSt10unique_ptrIN4llvh12MemoryBufferESt14default_deleteIS1_EED2Ev.exit.i.i.i.i.i.i
  ...
  %.not.i.i.i165.i = icmp eq ptr %i.ajs, %.sroa.10.5.i
...
_ZSt8_DestroyIPN12_GLOBAL__N_115ModuleInSegmentEEvT_S3_.exit.i.i: ; preds = %_ZSt8_DestroyIN12_GLOBAL__N_115ModuleInSegmentEEvPT_.exit.i.i.i.i, %_ZN4llvh11raw_ostreamlsEPKc.exit161.i
  %.not.i.i2.i.i = icmp eq ptr %.sroa.0178.5.i, null
...
bb.hi:                                            ; preds = %_ZSt8_DestroyIPN12_GLOBAL__N_115ModuleInSegmentEEvT_S3_.exit.i.i
  %i.ajt = ptrtoint ptr %.sroa.15.5.i to i64
  %i.aju = ptrtoint ptr %.sroa.0178.5.i to i64
  %i.ajv = sub i64 %i.ajt, %i.aju
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0178.5.i, i64 noundef %i.ajv) #26
...
.critedge.i.a:                                    ; preds = %_ZNSt6vectorIN12_GLOBAL__N_115ModuleInSegmentESaIS1_EED2Ev.exit.thread.i, %bb.hi, %_ZSt8_DestroyIPN12_GLOBAL__N_115ModuleInSegmentEEvT_S3_.exit.i.i, %bb.fv, %bb.fu, %bb.fq, %bb.fp, %_ZN12_GLOBAL__N_113readModuleIDsEPN6hermes6parser10JSONObjectE.exit.i
  %.sroa.17.4 = phi ptr [ null, %_ZN12_GLOBAL__N_113readModuleIDsEPN6hermes6parser10JSONObjectE.exit.i ], [ %.sroa.17.3, %bb.fq ], [ %.sroa.17.3, %bb.fp ], [ %.sroa.17.3, %bb.fu ], [ %.sroa.17.3, %bb.fv ], [ %.sroa.17.3, %bb.hi ], [ %.sroa.17.3, %_ZSt8_DestroyIPN12_GLOBAL__N_115ModuleInSegmentEEvT_S3_.exit.i.i ], [ %.sroa.17.5, %_ZNSt6vectorIN12_GLOBAL__N_115ModuleInSegmentESaIS1_EED2Ev.exit.thread.i ] ; 2 uses
  %.sroa.10.3 = phi ptr [ null, %_ZN12_GLOBAL__N_113readModuleIDsEPN6hermes6parser10JSONObjectE.exit.i ], [ %.sroa.10.2, %bb.fq ], [ %.sroa.10.2, %bb.fp ], [ %.sroa.10.2, %bb.fu ], [ %.sroa.10.2, %bb.fv ], [ %.sroa.10.2, %bb.hi ], [ %.sroa.10.2, %_ZSt8_DestroyIPN12_GLOBAL__N_115ModuleInSegmentEEvT_S3_.exit.i.i ], [ %.sroa.10.4, %_ZNSt6vectorIN12_GLOBAL__N_115ModuleInSegmentESaIS1_EED2Ev.exit.thread.i ] ; 2 uses
  %.sroa.0239.4 = phi ptr [ null, %_ZN12_GLOBAL__N_113readModuleIDsEPN6hermes6parser10JSONObjectE.exit.i ], [ %.sroa.0241.3, %bb.fq ], [ %.sroa.0241.3, %bb.fp ], [ %.sroa.0241.3, %bb.fu ], [ %.sroa.0241.3, %bb.fv ], [ %.sroa.0241.3, %bb.hi ], [ %.sroa.0241.3, %_ZSt8_DestroyIPN12_GLOBAL__N_115ModuleInSegmentEEvT_S3_.exit.i.i ], [ %.sroa.0241.5, %_ZNSt6vectorIN12_GLOBAL__N_115ModuleInSegmentESaIS1_EED2Ev.exit.thread.i ] ; 2 uses
  %spec.select.i = phi ptr [ %i.sk, %_ZN12_GLOBAL__N_113readModuleIDsEPN6hermes6parser10JSONObjectE.exit.i ], [ null, %bb.fq ], [ null, %bb.fp ], [ null, %bb.fu ], [ null, %bb.fv ], [ null, %bb.hi ], [ null, %_ZSt8_DestroyIPN12_GLOBAL__N_115ModuleInSegmentEEvT_S3_.exit.i.i ], [ %i.sk, %_ZNSt6vectorIN12_GLOBAL__N_115ModuleInSegmentESaIS1_EED2Ev.exit.thread.i ] ; 2 uses
...
_ZNKSt14default_deleteIN4llvh12MemoryBufferEEclEPS1_.exit.i184.i: ; preds = %_ZN4llvh11raw_ostreamlsEPKc.exit.i, %bb.ed, %bb.ec, %bb.dz, %bb.dy, %bb.dv
  ...
  %.sroa.0241.2 = phi ptr [ null, %bb.dv ], [ null, %bb.ec ], [ null, %bb.ed ], [ %.sroa.0239.4, %_ZN4llvh11raw_ostreamlsEPKc.exit.i ], [ null, %bb.dy ], [ null, %bb.dz ]
...
_ZN12_GLOBAL__N_136readInputFilenamesFromDirectoryOrZipEN4llvh9StringRefERSt3mapIjSt6vectorINS_15ModuleInSegmentESaIS4_EESt4lessIjESaISt4pairIKjS6_EEERS3_IjSaIjEERN6hermes28BacktrackingBumpPtrAllocatorEP5zip_t.exit: ; preds = %bb.dt, %bb.du, %_ZN4llvh11raw_ostreamlsEPKc.exit.i, %_ZNKSt14default_deleteIN4llvh12MemoryBufferEEclEPS1_.exit.i184.i
  ...
  %.sroa.0241.6 = phi ptr [ null, %bb.dt ], [ null, %bb.du ], [ %.sroa.0241.2, %_ZNKSt14default_deleteIN4llvh12MemoryBufferEEclEPS1_.exit.i184.i ], [ %.sroa.0239.4, %_ZN4llvh11raw_ostreamlsEPKc.exit.i ] ; 4 uses
...
begin_hunk_11
  ...
  br i1 %.not51, label %_ZNSt10unique_ptrIN6hermes6parser8JSParserESt14default_deleteIS2_EED2Ev.exit, label %bb.e
...
_ZNSt10unique_ptrIN6hermes6parser8JSParserESt14default_deleteIS2_EED2Ev.exit: ; preds = %bb.d
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #27
  br label %bb.t
...
bb.t:                                             ; preds = %bb.g, %bb.r, %bb.s, %bb.o, %bb.k, %bb.n, %bb.m, %_ZNSt10unique_ptrIN6hermes6parser8JSParserESt14default_deleteIS2_EED2Ev.exit
  %.3 = phi ptr [ null, %_ZNSt10unique_ptrIN6hermes6parser8JSParserESt14default_deleteIS2_EED2Ev.exit ], [ null, %bb.g ], [ %.0, %bb.m ], [ %.0, %bb.n ], [ null, %bb.o ], [ null, %bb.k ], [ %.0, %bb.s ], [ %.0, %bb.r ]
  ret ptr %.3
}
