...
begin_hunk_0_@_ZN6hermes2vm13RuntimeModule28importStringIDMapMayAllocateEv:bb.a
  %i.aq = getelementptr inbounds nuw i8, ptr %i.am, i64 9240
  %i.ar = trunc i64 %.sroa.2.0.copyload.i32 to i32
  call void @_ZN6hermes2vm15IdentifierTable7reserveEj(ptr noundef nonnull align 8 dereferenceable(84) %i.aq, i32 noundef %i.ar)
  %.idx = shl nuw nsw i64 %.sroa.2.0.copyload.i, 2
  %i.as = getelementptr inbounds nuw i8, ptr %.sroa.0.0.copyload.i, i64 %.idx
  %.not2761 = icmp eq i64 %.sroa.2.0.copyload.i, 0
  br i1 %.not2761, label %._crit_edge, label %.lr.ph65
...
._crit_edge:                                      ; preds = %.loopexit, %bb.j
  %i.au = load ptr, ptr %i.a, align 8, !tbaa !26, !nonnull !76, !align !77
  %i.av = getelementptr inbounds nuw i8, ptr %i.au, i64 9076
  %i.aw = load i32, ptr %i.av, align 4, !tbaa !149
  %i.ax = and i32 %i.aw, 32
  %.not28 = icmp eq i32 %i.ax, 0
  br i1 %.not28, label %bb.v, label %bb.u

bb.k:                                             ; preds = %.lr.ph65, %.loopexit
  %.064 = phi i32 [ 0, %.lr.ph65 ], [ %.2, %.loopexit ] ; 3 uses
  %.02163 = phi i32 [ 0, %.lr.ph65 ], [ %.223, %.loopexit ] ; 4 uses
  %.02462 = phi ptr [ %.sroa.0.0.copyload.i, %.lr.ph65 ], [ %i.dx, %.loopexit ] ; 2 uses
  %i.ay = load i32, ptr %.02462, align 4, !tbaa !3 ; 3 uses
...
bb.w:                                             ; preds = %bb.v
  %i.ea = load ptr, ptr %i.t, align 8, !tbaa !148 ; 6 uses
...
bb.y:                                             ; preds = %bb.w
  %i.ef = load ptr, ptr %i.r, align 8, !tbaa !96  ; 8 uses
...
.lr.ph.i.i.i.i.i.i.preheader:                     ; preds = %_ZNKSt6vectorIN6hermes2vm12RootSymbolIDESaIS2_EE12_M_check_lenEmPKc.exit.i.i.i
  ...
  %3 = ptrtoaddr ptr %i.ea to i64
  %4 = ptrtoaddr ptr %i.ef to i64
  %i.et = sub i64 %3, %4
...
begin_hunk_1_@_ZN6hermes2vm13RuntimeModule22markLongLivedWeakRootsERNS0_16WeakRootAcceptorE:bb.a
  ...
  tail call void %i.ab(ptr noundef nonnull align 8 dereferenceable(8) %1, ptr noundef nonnull align 4 dereferenceable(4) %i.x) #17
  br label %bb.i

bb.i:                                             ; preds = %bb.h, %.lr.ph27
  %i.ac = getelementptr inbounds nuw i8, ptr %.sroa.013.026, i64 8 ; 3 uses
  %.not4.i3.i = icmp eq ptr %i.ac, %.pn12.i
  br i1 %.not4.i3.i, label %_ZN4llvh16DenseMapIteratorIjN6hermes2vm8WeakRootINS2_11HiddenClassEEENS_12DenseMapInfoIjEENS_6detail12DenseMapPairIjS5_EELb0EEppEv.exit, label %.lr.ph.i4.i

.lr.ph.i4.i:                                      ; preds = %bb.i, %.critedge2.i6.i
  %.sroa.013.1 = phi ptr [ %i.ae, %.critedge2.i6.i ], [ %i.ac, %bb.i ] ; 3 uses
  %i.ad = load i32, ptr %.sroa.013.1, align 4, !tbaa !3
  %switch.i5.i = icmp ugt i32 %i.ad, -3
  br i1 %switch.i5.i, label %.critedge2.i6.i, label %_ZN4llvh16DenseMapIteratorIjN6hermes2vm8WeakRootINS2_11HiddenClassEEENS_12DenseMapInfoIjEENS_6detail12DenseMapPairIjS5_EELb0EEppEv.exit

.critedge2.i6.i:                                  ; preds = %.lr.ph.i4.i
  %i.ae = getelementptr inbounds nuw i8, ptr %.sroa.013.1, i64 8 ; 3 uses
  %.not.i7.i = icmp eq ptr %i.ae, %.pn12.i
  br i1 %.not.i7.i, label %_ZN4llvh16DenseMapIteratorIjN6hermes2vm8WeakRootINS2_11HiddenClassEEENS_12DenseMapInfoIjEENS_6detail12DenseMapPairIjS5_EELb0EEppEv.exit, label %.lr.ph.i4.i, !llvm.loop !433
...
bb.a:
  ...
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !148  ; 6 uses
...
bb.c:                                             ; preds = %bb.a
  %i.h = load ptr, ptr %i.a, align 8, !tbaa !96   ; 8 uses
...
.lr.ph.i.preheader:                               ; preds = %_ZN6hermes14checkedMalloc2Emm.exit.i
  ...
  %2 = ptrtoaddr ptr %i.l to i64                  ; 3 uses
  %i.r = add i64 %.idx.i, %2
  %i.s = add i64 %2, 8
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !148  ; 21 uses
...
bb.i:                                             ; preds = %bb.b
  %i.cj = load ptr, ptr %0, align 8, !tbaa !96    ; 8 uses
...
_ZNKSt6vectorIN6hermes2vm12RootSymbolIDESaIS2_EE12_M_check_lenEmPKc.exit: ; preds = %bb.i
  ...
  %i.ct = ptrtoint ptr %1 to i64                  ; 2 uses
