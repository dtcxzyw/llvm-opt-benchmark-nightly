...
bb.ay:                                            ; preds = %_ZN6hermes2vm7Runtime10makeHandleINS0_11HiddenClassEEENS0_6HandleIT_EERKNS0_9GCPointerIS5_EE.exit145
  ...
  %.phi.trans.insert329 = getelementptr inbounds nuw i8, ptr %.pre12.i168, i64 16
  %.sroa.0.0.copyload.i.i.i.i148.pre = load i32, ptr %.phi.trans.insert329, align 4, !tbaa !3
  br label %bb.az
...
bb.bi:                                            ; preds = %bb.bh
  ...
  %.not111305 = icmp eq i32 %.7, %.096
  br i1 %.not111305, label %._crit_edge310, label %.lr.ph309

.lr.ph309:                                        ; preds = %bb.bi
...
._crit_edge310:                                   ; preds = %_ZNK6hermes2vm9ArrayImpl2atERNS0_7RuntimeEj.exit180, %bb.bi
  %i.mc = load i32, ptr %i.bk, align 8, !tbaa !330 ; 2 uses
  %i.md = add i32 %i.mc, %.096                    ; 2 uses
  %.not112311 = icmp eq i32 %i.md, 0
  br i1 %.not112311, label %.loopexit, label %.lr.ph316
...
bb.bj:                                            ; preds = %.lr.ph309, %_ZNK6hermes2vm9ArrayImpl2atERNS0_7RuntimeEj.exit180
  %.0100307 = phi i32 [ %i.ma, %.lr.ph309 ], [ %i.mg, %_ZNK6hermes2vm9ArrayImpl2atERNS0_7RuntimeEj.exit180 ]
  %.0101306 = phi i32 [ %.7, %.lr.ph309 ], [ %i.mf, %_ZNK6hermes2vm9ArrayImpl2atERNS0_7RuntimeEj.exit180 ]
  %i.mf = add i32 %.0101306, -1                   ; 5 uses
  %i.mg = add i32 %.0100307, -1                   ; 2 uses
...
_ZNK6hermes2vm9ArrayImpl2atERNS0_7RuntimeEj.exit180: ; preds = %bb.bj, %_ZNK6hermes2vm18SegmentedArrayBaseINS0_13HermesValue32EE2atILNS3_6InlineE0EEES2_RNS0_11PointerBaseEj.exit.i176
  ...
  %.not111 = icmp eq i32 %i.mf, %.096
  br i1 %.not111, label %._crit_edge310, label %bb.bj, !llvm.loop !359

bb.bm:                                            ; preds = %.lr.ph316, %bb.bu
  %.197314 = phi i32 [ %i.mc, %.lr.ph316 ], [ %.3, %bb.bu ] ; 4 uses
  %.0102313 = phi i32 [ %i.md, %.lr.ph316 ], [ %i.ph, %bb.bu ]
  %.0105312 = phi i32 [ %.096, %.lr.ph316 ], [ %.2104, %bb.bu ] ; 3 uses
  %.not113 = icmp eq i32 %.0105312, 0
...
_ZNK6hermes2vm9ArrayImpl2atERNS0_7RuntimeEj.exit190.thread: ; preds = %bb.bn, %_ZNK6hermes2vm9ArrayImpl2atERNS0_7RuntimeEj.exit190
  %.sroa.0.0.i184289 = phi i32 [ %.sroa.0.0.i.i189, %_ZNK6hermes2vm9ArrayImpl2atERNS0_7RuntimeEj.exit190 ], [ 7, %bb.bn ]
  %i.oo = and i32 %.sroa.0.0.i184289, -8
...
bb.bu:                                            ; preds = %bb.br, %bb.bs, %bb.bt
  ...
  %.2104 = phi i32 [ 0, %bb.bt ], [ %i.nl, %bb.bs ], [ %.0105312, %bb.br ]
  %.3 = phi i32 [ %i.pb, %bb.bt ], [ %.197314, %bb.bs ], [ %i.ov, %bb.br ]
  %i.pg = uitofp i32 %.sink372 to double
  store double %i.pg, ptr %.0.i.i.i.i.i.i121, align 8, !tbaa !326
  %i.ph = add i32 %.0102313, -1                   ; 3 uses
...
.loopexit:                                        ; preds = %bb.bu, %._crit_edge310, %bb.bh, %bb.n
  %.sroa.0271.2 = phi ptr [ inttoptr (i64 -1 to ptr), %bb.n ], [ %i.ar, %bb.bh ], [ %i.ar, %._crit_edge310 ], [ %i.ar, %bb.bu ]
...
bb.c:                                             ; preds = %bb.d, %.lr.ph.i
  %.0912.i = phi ptr [ %i.d, %.lr.ph.i ], [ %i.l, %bb.d ] ; 3 uses
  %i.j = load i32, ptr %.0912.i, align 4, !tbaa !3
  %i.k = icmp eq i32 %i.j, %i.i
  br i1 %i.k, label %_ZNK4llvh8SmallSetIjLj16ESt4lessIjEE5vfindERKj.exit, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.l = getelementptr inbounds nuw i8, ptr %.0912.i, i64 4 ; 2 uses
...
_ZNK4llvh8SmallSetIjLj16ESt4lessIjEE5vfindERKj.exit: ; preds = %bb.c, %bb.d, %bb.b
  %.1.i = phi ptr [ %i.h, %bb.b ], [ %.0912.i, %bb.c ], [ %i.h, %bb.d ]
...
bb.b:                                             ; preds = %bb.w, %bb.a
  %.sroa.04.0.copyload = phi ptr [ %.sroa.04.0.copyload.pre, %bb.a ], [ %i.dn, %bb.w ] ; 7 uses
  %.sroa.060.0 = phi i32 [ 536870911, %bb.a ], [ %.sroa.060.3170176, %bb.w ] ; 4 uses
...
bb.o:                                             ; preds = %_ZN6hermes2vm20toArrayIndexFastPathENS0_11HermesValueE.exit44.thread, %_ZN6hermes2vm20toArrayIndexFastPathENS0_11HermesValueE.exit44
  ...
  br i1 %.sroa.070.1.off32, label %bb.p, label %_ZN6hermes2vm12_GLOBAL__N_137getOwnComputedPrimitiveDescriptorImplENS0_6HandleINS0_8JSObjectEEERNS0_7RuntimeENS2_INS0_11HermesValueEEENS3_11IgnoreProxyERNS0_8SymbolIDERNS0_13MutableHandleISA_EERNS0_26ComputedPropertyDescriptorE.exit.thread.thread

bb.p:                                             ; preds = %.split, %bb.o
  %.sroa.070.1.off0166 = phi i32 [ %extract.t144, %.split ], [ %.sroa.070.1.off0, %bb.o ] ; 2 uses
  ...
  %i.de = tail call i32 %i.dd(ptr noundef nonnull %i.cw, ptr noundef nonnull align 8 dereferenceable(9816) %1, i32 noundef %.sroa.070.1.off0166) #17, !inline_history !354 ; 3 uses
...
bb.r:                                             ; preds = %_ZN6hermes2vm13MutableHandleINS0_15StringPrimitiveEEC2ERNS0_15HandleRootOwnerEPS2_.exit
  ...
  br i1 %.not156, label %_ZN6hermes2vm12_GLOBAL__N_137getOwnComputedPrimitiveDescriptorImplENS0_6HandleINS0_8JSObjectEEERNS0_7RuntimeENS2_INS0_11HermesValueEEENS3_11IgnoreProxyERNS0_8SymbolIDERNS0_13MutableHandleISA_EERNS0_26ComputedPropertyDescriptorE.exit.thread.thread, label %bb.s
...
_ZN6hermes2vm12_GLOBAL__N_137getOwnComputedPrimitiveDescriptorImplENS0_6HandleINS0_8JSObjectEEERNS0_7RuntimeENS2_INS0_11HermesValueEEENS3_11IgnoreProxyERNS0_8SymbolIDERNS0_13MutableHandleISA_EERNS0_26ComputedPropertyDescriptorE.exit.thread: ; preds = %bb.s
...
_ZN6hermes2vm12_GLOBAL__N_137getOwnComputedPrimitiveDescriptorImplENS0_6HandleINS0_8JSObjectEEERNS0_7RuntimeENS2_INS0_11HermesValueEEENS3_11IgnoreProxyERNS0_8SymbolIDERNS0_13MutableHandleISA_EERNS0_26ComputedPropertyDescriptorE.exit.thread.thread: ; preds = %bb.f, %bb.d, %bb.i, %bb.o, %bb.p, %bb.r, %.split, %_ZN6hermes2vm12_GLOBAL__N_137getOwnComputedPrimitiveDescriptorImplENS0_6HandleINS0_8JSObjectEEERNS0_7RuntimeENS2_INS0_11HermesValueEEENS3_11IgnoreProxyERNS0_8SymbolIDERNS0_13MutableHandleISA_EERNS0_26ComputedPropertyDescriptorE.exit.thread
  ...
  br i1 %.not, label %bb.u, label %bb.t, !prof !42
...
bb.t:                                             ; preds = %_ZN6hermes2vm12_GLOBAL__N_137getOwnComputedPrimitiveDescriptorImplENS0_6HandleINS0_8JSObjectEEERNS0_7RuntimeENS2_INS0_11HermesValueEEENS3_11IgnoreProxyERNS0_8SymbolIDERNS0_13MutableHandleISA_EERNS0_26ComputedPropertyDescriptorE.exit.thread.thread
  ...
  %i.dv = zext i32 %.sroa.060.3170176 to i64
  %i.dw = or disjoint i64 %i.dv, -1266637395197952
  %i.dx = load ptr, ptr %4, align 8, !tbaa !351
  store i64 %i.dw, ptr %i.dx, align 8, !tbaa !326
  br label %.thread126

bb.u:                                             ; preds = %_ZN6hermes2vm12_GLOBAL__N_137getOwnComputedPrimitiveDescriptorImplENS0_6HandleINS0_8JSObjectEEERNS0_7RuntimeENS2_INS0_11HermesValueEEENS3_11IgnoreProxyERNS0_8SymbolIDERNS0_13MutableHandleISA_EERNS0_26ComputedPropertyDescriptorE.exit.thread.thread
  %i.dy = and i32 %i.dr, 128
  %.not26 = icmp eq i32 %i.dy, 0
  br i1 %.not26, label %bb.w, label %bb.v, !prof !42
...
bb.v:                                             ; preds = %bb.u
  ...
  store i32 %.sroa.060.3170176, ptr %i.i, align 4, !tbaa !367
  %i.eb = zext i32 %.sroa.060.3170176 to i64
...
.thread126:                                       ; preds = %bb.h, %bb.g, %_ZN6hermes2vm12_GLOBAL__N_137getOwnComputedPrimitiveDescriptorImplENS0_6HandleINS0_8JSObjectEEERNS0_7RuntimeENS2_INS0_11HermesValueEEENS3_11IgnoreProxyERNS0_8SymbolIDERNS0_13MutableHandleISA_EERNS0_26ComputedPropertyDescriptorE.exit.thread, %bb.s, %bb.w, %bb.q, %bb.e, %bb.v, %bb.t
  %.2 = phi i32 [ 1, %bb.v ], [ 1, %bb.t ], [ 1, %bb.q ], [ 1, %bb.e ], [ 1, %bb.h ], [ 0, %bb.g ], [ 0, %bb.s ], [ 1, %_ZN6hermes2vm12_GLOBAL__N_137getOwnComputedPrimitiveDescriptorImplENS0_6HandleINS0_8JSObjectEEERNS0_7RuntimeENS2_INS0_11HermesValueEEENS3_11IgnoreProxyERNS0_8SymbolIDERNS0_13MutableHandleISA_EERNS0_26ComputedPropertyDescriptorE.exit.thread ], [ 1, %bb.w ]
