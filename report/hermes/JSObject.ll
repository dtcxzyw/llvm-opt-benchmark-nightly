...
bb.t:                                             ; preds = %_ZN6hermes2vmplERKNS0_11TwineChar16ES3_.exit.thread, %_ZN6hermes2vmplERKNS0_11TwineChar16ES3_.exit
  ...
  %spec.select.i.i16 = select i1 %i.bj, i32 %i.bb, i32 2
  %spec.select17.i.i17 = select i1 %i.bj, ptr %.sroa.06.0.copyload.i.i15, ptr %7
  store ptr %spec.select17.i.i17, ptr %6, align 8, !tbaa !41, !alias.scope !491
  %i.bk = getelementptr inbounds nuw i8, ptr %6, i64 8
  store i32 %spec.select.i.i16, ptr %i.bk, align 8, !tbaa !310, !alias.scope !491
