...
bb.d:                                             ; preds = %.lr.ph
  call void @_ZN4llvh14FoldingSetBase15GrowBucketCountEj(ptr noundef nonnull align 8 dereferenceable(24) %0, i32 noundef %i.aj), !inline_history !31
...
begin_hunk_1_@_ZN4llvh14FoldingSetBase15GrowBucketCountEj:bb.a
  ...
  %i.ao = call noundef i32 %i.an(ptr noundef nonnull align 8 dereferenceable(24) %0, ptr noundef nonnull %.01628, ptr noundef nonnull align 8 dereferenceable(144) %2) #23, !inline_history !32
...
.thread:                                          ; preds = %bb.f, %bb.c
  ...
  br i1 %.not, label %._crit_edge, label %bb.c, !llvm.loop !33
}
...
bb.b:                                             ; preds = %bb.a
  tail call void @_ZN4llvh14FoldingSetBase15GrowBucketCountEj(ptr noundef nonnull align 8 dereferenceable(24) %0, i32 noundef %i.f), !inline_history !34
...
begin_hunk_5_@_ZN4llvh14FoldingSetBase15GetOrInsertNodeEPNS0_4NodeE:bb.a
  ...
  %i.ac = call noundef zeroext i1 %i.ab(ptr noundef nonnull align 8 dereferenceable(24) %0, ptr noundef nonnull %.01631.i, ptr noundef nonnull align 8 dereferenceable(144) %4, i32 noundef %i.l, ptr noundef nonnull align 8 dereferenceable(144) %3) #23, !inline_history !36
...
bb.e:                                             ; preds = %bb.d
  call void @_ZN4llvh14FoldingSetBase15GrowBucketCountEj(ptr noundef nonnull align 8 dereferenceable(24) %0, i32 noundef %i.ak), !inline_history !37
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #23
...
begin_hunk_7_@_ZN4llvh14FoldingSetBase15GetOrInsertNodeEPNS0_4NodeE:bb.a
  ...
  %i.as = call noundef i32 %i.ar(ptr noundef nonnull align 8 dereferenceable(24) %0, ptr noundef %1, ptr noundef nonnull align 8 dereferenceable(144) %2) #23, !inline_history !32
...
bb.f:                                             ; preds = %bb.e
  call void @free(ptr noundef %i.az) #23, !inline_history !32
...
bb.a:
  ...
  br i1 %i.b, label %bb.b, label %_ZN4llvh7hashing6detail18get_execution_seedEv.exit, !prof !45
...
bb.c:                                             ; preds = %bb.b
  %i.d = load i64, ptr @_ZN4llvh7hashing6detail19fixed_seed_overrideE, align 8, !tbaa !46 ; 2 uses
  %.not1.i = icmp eq i64 %i.d, 0
  %i.e = select i1 %.not1.i, i64 -49064778989728563, i64 %i.d
  store i64 %i.e, ptr @_ZZN4llvh7hashing6detail18get_execution_seedEvE4seed, align 8, !tbaa !46
...
_ZN4llvh7hashing6detail18get_execution_seedEv.exit: ; preds = %bb.a, %bb.b, %bb.c
  %i.f = load i64, ptr @_ZZN4llvh7hashing6detail18get_execution_seedEvE4seed, align 8, !tbaa !46 ; 10 uses
...
begin_hunk_14_@_ZN4llvh7hashing6detail23hash_combine_range_implIKjEENSt9enable_ifIXsr16is_hashable_dataIT_EE5valueENS_9hash_codeEE4typeEPS5_S9_:bb.a
  ...
  %.0.copyload.i.i.i = load i64, ptr %i.al, align 1, !noalias !47 ; 2 uses
  ...
  %.0.copyload.i7.i.i = load i64, ptr %i.aq, align 1, !noalias !47 ; 2 uses
  ...
  %.0.copyload.i8.i.i = load i64, ptr %i.av, align 1, !noalias !47 ; 2 uses
...
begin_hunk_15_@_ZN4llvh7hashing6detail23hash_combine_range_implIKjEENSt9enable_ifIXsr16is_hashable_dataIT_EE5valueENS_9hash_codeEE4typeEPS5_S9_:bb.a
  ...
  %.0.copyload.i.i.i.i = load i64, ptr %0, align 1, !noalias !47
  %i.bd = add i64 %.0.copyload.i.i.i.i, %i.bb     ; 3 uses
  %i.be = getelementptr inbounds nuw i8, ptr %0, i64 24
  %.0.copyload.i15.i.i.i = load i64, ptr %i.be, align 1, !noalias !47 ; 2 uses
  ...
  %.0.copyload.i17.i.i.i = load i64, ptr %i.bi, align 1, !noalias !47 ; 2 uses
...
begin_hunk_16_@_ZN4llvh7hashing6detail23hash_combine_range_implIKjEENSt9enable_ifIXsr16is_hashable_dataIT_EE5valueENS_9hash_codeEE4typeEPS5_S9_:bb.a
  ...
  %.0.copyload.i.i10.i.i = load i64, ptr %i.br, align 1, !noalias !47
  %i.bs = add i64 %i.bp, %.0.copyload.i.i10.i.i   ; 3 uses
  %i.bt = getelementptr inbounds nuw i8, ptr %0, i64 56
  %.0.copyload.i15.i11.i.i = load i64, ptr %i.bt, align 1, !noalias !47 ; 2 uses
...
bb.a:
  ...
  %i.c = add i64 %i.b, %1
  store i64 %i.c, ptr %i.a, align 8, !tbaa !51
...
bb.b:                                             ; preds = %bb.a
  ...
  store ptr %i.q, ptr %0, align 8, !tbaa !64
  br label %bb.j
...
begin_hunk_21_@_ZN4llvh20BumpPtrAllocatorImplINS_15MallocAllocatorELm4096ELm4096EE8AllocateEmm:bb.a
  ...
  store ptr %i.bd, ptr %i.l, align 8, !tbaa !65
  ...
  store ptr %i.bh, ptr %0, align 8, !tbaa !64
  br label %bb.j
...
!31 = !{ptr @_ZN4llvh14FoldingSetBase13GrowHashTableEv, ptr @_ZN4llvh14FoldingSetBase10InsertNodeEPNS0_4NodeEPv}
!32 = !{ptr @_ZN4llvh14FoldingSetBase10InsertNodeEPNS0_4NodeEPv}
!33 = distinct !{!33, !20}
!34 = !{ptr @_ZN4llvh14FoldingSetBase13GrowHashTableEv}
!35 = distinct !{!35, !20}
!36 = !{ptr @_ZN4llvh14FoldingSetBase19FindNodeOrInsertPosERKNS_16FoldingSetNodeIDERPv}
!37 = !{ptr @_ZN4llvh14FoldingSetBase10InsertNodeEPNS0_4NodeEPv, ptr @_ZN4llvh14FoldingSetBase13GrowHashTableEv}
!38 = distinct !{!38, !20}
!39 = !{!40, !41, i64 0}
!40 = !{!"_ZTSN4llvh22FoldingSetIteratorImplE", !41, i64 0}
!41 = !{!"p1 _ZTSN4llvh14FoldingSetBase4NodeE", !10, i64 0}
!42 = distinct !{!42, !20}
!43 = !{!44, !10, i64 0}
!44 = !{!"_ZTSN4llvh28FoldingSetBucketIteratorImplE", !10, i64 0}
!45 = !{!"branch_weights", i32 1, i32 1048575}
!46 = !{!11, !11, i64 0}
!47 = !{!48}
!48 = distinct !{!48, !49, !"_ZN4llvh7hashing6detail10hash_state6createEPKcm: argument 0"}
!49 = distinct !{!49, !"_ZN4llvh7hashing6detail10hash_state6createEPKcm"}
!50 = distinct !{!50, !20}
!51 = !{!52, !11, i64 80}
!52 = !{!"_ZTSN4llvh20BumpPtrAllocatorImplINS_15MallocAllocatorELm4096ELm4096EEE", !53, i64 0, !53, i64 8, !54, i64 16, !59, i64 64, !11, i64 80, !11, i64 88, !63, i64 96}
!53 = !{!"p1 omnipotent char", !10, i64 0}
!54 = !{!"_ZTSN4llvh11SmallVectorIPvLj4EEE", !55, i64 0, !58, i64 16}
!55 = !{!"_ZTSN4llvh15SmallVectorImplIPvEE", !56, i64 0}
!56 = !{!"_ZTSN4llvh23SmallVectorTemplateBaseIPvLb1EEE", !57, i64 0}
!57 = !{!"_ZTSN4llvh25SmallVectorTemplateCommonIPvvEE", !14, i64 0}
!58 = !{!"_ZTSN4llvh18SmallVectorStorageIPvLj4EEE", !5, i64 0}
!59 = !{!"_ZTSN4llvh11SmallVectorISt4pairIPvmELj0EEE", !60, i64 0}
!60 = !{!"_ZTSN4llvh15SmallVectorImplISt4pairIPvmEEE", !61, i64 0}
!61 = !{!"_ZTSN4llvh23SmallVectorTemplateBaseISt4pairIPvmELb1EEE", !62, i64 0}
!62 = !{!"_ZTSN4llvh25SmallVectorTemplateCommonISt4pairIPvmEvEE", !14, i64 0}
!63 = !{!"_ZTSN4llvh15MallocAllocatorE"}
!64 = !{!52, !53, i64 0}
!65 = !{!52, !53, i64 8}
end_hunk_22
