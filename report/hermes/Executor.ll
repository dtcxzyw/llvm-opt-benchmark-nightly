...
_ZNKSt6vectorIN6hermes5regex13CapturedRangeESaIS2_EE12_M_check_lenEmPKc.exit.i.i.i: ; preds = %bb.i
  ...
  %10 = icmp ult i64 %i.bv, %i.bu
  %i.bw = call i64 @llvm.umin.i64(i64 %i.bv, i64 1152921504606846975)
  %11 = select i1 %10, i64 1152921504606846975, i64 %i.bw ; 3 uses
  %.not.i.i.i.i = icmp ne i64 %11, 0
  call void @llvm.assume(i1 %.not.i.i.i.i)
  %i.bx = shl nuw nsw i64 %11, 3
...
_ZNSt6vectorIN6hermes5regex13CapturedRangeESaIS2_EE17_M_realloc_insertIJS2_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i.i: ; preds = %bb.l, %_ZNSt6vectorIN6hermes5regex13CapturedRangeESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit16.i.i.i
  ...
  %i.cc = getelementptr inbounds nuw [8 x i8], ptr %i.by, i64 %11
...
_ZNKSt6vectorIN6hermes5regex13CapturedRangeESaIS2_EE12_M_check_lenEmPKc.exit.i.i.i.i.i.i.i.i.i.i: ; preds = %bb.o
  ...
  %12 = icmp ult i64 %i.cq, %i.cp
  %i.cr = call i64 @llvm.umin.i64(i64 %i.cq, i64 1152921504606846975)
  %13 = select i1 %12, i64 1152921504606846975, i64 %i.cr ; 3 uses
  %.not.i.i.i.i.i.i.i.i.i.i.i = icmp ne i64 %13, 0
  call void @llvm.assume(i1 %.not.i.i.i.i.i.i.i.i.i.i.i)
  %i.cs = shl nuw nsw i64 %13, 3
...
_ZNSt6vectorIN6hermes5regex13CapturedRangeESaIS2_EE17_M_realloc_insertIJRKS2_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i.i.i.i.i.i.i.i.i: ; preds = %bb.r, %_ZNSt6vectorIN6hermes5regex13CapturedRangeESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit16.i.i.i.i.i.i.i.i.i.i
  ...
  %i.cy = getelementptr inbounds nuw [8 x i8], ptr %i.ct, i64 %13
...
_ZNKSt6vectorIN6hermes5regex13CapturedRangeESaIS2_EE12_M_check_lenEmPKc.exit.i.i.i: ; preds = %bb.i
  ...
  %10 = icmp ult i64 %i.bs, %i.br
  %i.bt = call i64 @llvm.umin.i64(i64 %i.bs, i64 1152921504606846975)
  %11 = select i1 %10, i64 1152921504606846975, i64 %i.bt ; 3 uses
  %.not.i.i.i.i = icmp ne i64 %11, 0
  call void @llvm.assume(i1 %.not.i.i.i.i)
  %i.bu = shl nuw nsw i64 %11, 3
...
_ZNSt6vectorIN6hermes5regex13CapturedRangeESaIS2_EE17_M_realloc_insertIJS2_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i.i: ; preds = %bb.l, %_ZNSt6vectorIN6hermes5regex13CapturedRangeESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit16.i.i.i
  ...
  %i.bz = getelementptr inbounds nuw [8 x i8], ptr %i.bv, i64 %11
...
_ZNKSt6vectorIN6hermes5regex13CapturedRangeESaIS2_EE12_M_check_lenEmPKc.exit.i.i.i.i.i.i.i.i.i.i: ; preds = %bb.o
  ...
  %12 = icmp ult i64 %i.cn, %i.cm
  %i.co = call i64 @llvm.umin.i64(i64 %i.cn, i64 1152921504606846975)
  %13 = select i1 %12, i64 1152921504606846975, i64 %i.co ; 3 uses
  %.not.i.i.i.i.i.i.i.i.i.i.i = icmp ne i64 %13, 0
  call void @llvm.assume(i1 %.not.i.i.i.i.i.i.i.i.i.i.i)
  %i.cp = shl nuw nsw i64 %13, 3
...
_ZNSt6vectorIN6hermes5regex13CapturedRangeESaIS2_EE17_M_realloc_insertIJRKS2_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i.i.i.i.i.i.i.i.i: ; preds = %bb.r, %_ZNSt6vectorIN6hermes5regex13CapturedRangeESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit16.i.i.i.i.i.i.i.i.i.i
  ...
  %i.cv = getelementptr inbounds nuw [8 x i8], ptr %i.cq, i64 %13
...
bb.b:                                             ; preds = %.preheader, %_ZNK6hermes5regex7ContextINS0_16UTF16RegexTraitsEE18advanceStringIndexEPKDsmm.exit
  %.03501026 = phi i64 [ 0, %.preheader ], [ %.1.i594, %_ZNK6hermes5regex7ContextINS0_16UTF16RegexTraitsEE18advanceStringIndexEPKDsmm.exit ] ; 3 uses
  %.sroa.0718.01025 = phi i8 [ undef, %.preheader ], [ %.sroa.0718.49903.ph, %_ZNK6hermes5regex7ContextINS0_16UTF16RegexTraitsEE18advanceStringIndexEPKDsmm.exit ]
  %i.at = getelementptr inbounds nuw [2 x i8], ptr %i.i, i64 %.03501026 ; 3 uses
...
_ZN6hermes5regex17matchesLeftAnchorINS0_16UTF16RegexTraitsEEEbRNS0_7ContextIT_EERNS0_5StateIS4_EE.exit: ; preds = %bb.e, %bb.d
  %i.bb = call i16 @_ZN6hermes5regex7ContextINS0_16UTF16RegexTraitsEE9backtrackERN4llvh11SmallVectorINS3_13BacktrackInsnELj64EEEPNS0_5StateIS2_EE(ptr noundef nonnull align 8 dereferenceable(208) %0, ptr noundef nonnull align 8 dereferenceable(1552) %3, ptr noundef nonnull %1)
  %.fr1001 = freeze i16 %i.bb                     ; 2 uses
  %.sroa.0710.0.extract.trunc = trunc i16 %.fr1001 to i8 ; 2 uses
...
bb.f:                                             ; preds = %_ZN6hermes5regex17matchesLeftAnchorINS0_16UTF16RegexTraitsEEEbRNS0_7ContextIT_EERNS0_5StateIS4_EE.exit
  %i.bd = and i16 %.fr1001, 256
  %.not1002 = icmp eq i16 %i.bd, 0
  br i1 %.not1002, label %.critedge409.thread906, label %.backedge
...
_ZN6hermes5regex18matchesRightAnchorINS0_16UTF16RegexTraitsEEEbRNS0_7ContextIT_EERNS0_5StateIS4_EE.exit.thread: ; preds = %bb.i, %.thread.i, %_ZN6hermes5regex18matchesRightAnchorINS0_16UTF16RegexTraitsEEEbRNS0_7ContextIT_EERNS0_5StateIS4_EE.exit
  %i.bn = call i16 @_ZN6hermes5regex7ContextINS0_16UTF16RegexTraitsEE9backtrackERN4llvh11SmallVectorINS3_13BacktrackInsnELj64EEEPNS0_5StateIS2_EE(ptr noundef nonnull align 8 dereferenceable(208) %0, ptr noundef nonnull align 8 dereferenceable(1552) %3, ptr noundef nonnull %1)
  %.fr999 = freeze i16 %i.bn                      ; 2 uses
  %.sroa.0707.0.extract.trunc = trunc i16 %.fr999 to i8 ; 2 uses
...
bb.j:                                             ; preds = %_ZN6hermes5regex18matchesRightAnchorINS0_16UTF16RegexTraitsEEEbRNS0_7ContextIT_EERNS0_5StateIS4_EE.exit.thread
  %i.bp = and i16 %.fr999, 256
  %.not1000 = icmp eq i16 %i.bp, 0
  br i1 %.not1000, label %.critedge409.thread906, label %.backedge
