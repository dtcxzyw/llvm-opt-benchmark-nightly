...
_ZN4llvh9StringRefC2EPKc.exit29:                  ; preds = %bb.b
  %i.e = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %i.d) #13
...
_ZNK4llvh9StringRef6equalsES0_.exit:              ; preds = %_ZN4llvh9StringRefC2EPKc.exit29
  %bcmp = tail call i32 @bcmp(ptr noundef nonnull dereferenceable(7) %i.d, ptr noundef nonnull dereferenceable(7) @.str, i64 7)
...
begin_hunk_3
  ...
  %i.l = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %i.k) #13
  br label %_ZN4llvh9StringRefC2EPKc.exit27
...
begin_hunk_4
  ...
  call void @_ZN4llvh3sys17findProgramByNameB5cxx11ENS_9StringRefENS_8ArrayRefIS1_EE(ptr dead_on_unwind nonnull writable sret(%"class.llvh::ErrorOr") align 8 %2, ptr %i.m, i64 %i.n, ptr null, i64 0) #12
...
bb.e:                                             ; preds = %_ZN4llvh9StringRefC2EPKc.exit27
  %i.r = call noundef nonnull align 8 dereferenceable(36) ptr @_ZN4llvh4errsEv() #12 ; 4 uses
...
bb.f:                                             ; preds = %bb.e
  %i.aa = call noundef nonnull align 8 dereferenceable(36) ptr @_ZN4llvh11raw_ostream5writeEPKcm(ptr noundef nonnull align 8 dereferenceable(36) %i.r, ptr noundef nonnull @.str.1, i64 noundef 23) #12
...
_ZN4llvh9StringRefC2EPKc.exit.i:                  ; preds = %_ZN4llvh11raw_ostreamlsEPKc.exit
  %i.ae = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %i.ad) #13 ; 5 uses
...
bb.h:                                             ; preds = %_ZN4llvh9StringRefC2EPKc.exit.i
  %i.an = call noundef nonnull align 8 dereferenceable(36) ptr @_ZN4llvh11raw_ostream5writeEPKcm(ptr noundef nonnull align 8 dereferenceable(36) %.0.i.i, ptr noundef nonnull %i.ad, i64 noundef %i.ae) #12
...
bb.k:                                             ; preds = %_ZN4llvh11raw_ostreamlsEPKc.exit32
  %i.ay = call noundef nonnull align 8 dereferenceable(36) ptr @_ZN4llvh11raw_ostream5writeEPKcm(ptr noundef nonnull align 8 dereferenceable(36) %.0.i.i31, ptr noundef nonnull @.str.2, i64 noundef 11) #12
...
bb.n:                                             ; preds = %_ZN4llvh11raw_ostreamlsEPKc.exit36
  %i.bd = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSt3_V215system_categoryEv() #14
  br label %_ZNK4llvh7ErrorOrINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEE8getErrorEv.exit
...
begin_hunk_11
  ...
  call void %i.bg(ptr dead_on_unwind nonnull writable sret(%"class.std::__cxx11::basic_string") align 8 %3, ptr noundef nonnull align 8 dereferenceable(8) %.sroa.31.0.i, i32 noundef %.sroa.0.0.i) #12
  %i.bh = load ptr, ptr %3, align 8, !tbaa !22
  %i.bi = getelementptr inbounds nuw i8, ptr %3, i64 8
  %i.bj = load i64, ptr %i.bi, align 8, !tbaa !26
  %i.bk = call noundef nonnull align 8 dereferenceable(36) ptr @_ZN4llvh11raw_ostream5writeEPKcm(ptr noundef nonnull align 8 dereferenceable(36) %.0.i.i35, ptr noundef %i.bh, i64 noundef %i.bj) #12 ; 3 uses
...
bb.o:                                             ; preds = %_ZNK4llvh7ErrorOrINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEE8getErrorEv.exit
  %i.bq = call noundef nonnull align 8 dereferenceable(36) ptr @_ZN4llvh11raw_ostream5writeEPKcm(ptr noundef nonnull align 8 dereferenceable(36) %i.bk, ptr noundef nonnull @.str.3, i64 noundef 1) #12 ; 0 uses
...
_ZNSt6vectorIN4llvh9StringRefESaIS1_EE7reserveEm.exit: ; preds = %bb.q
  ...
  %i.cb = call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.ca) #17 ; 5 uses
...
bb.s:                                             ; preds = %.lr.ph
  %i.cr = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %i.cq) #13
...
begin_hunk_19
  ...
  %i.dd = call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.dc) #17 ; 5 uses
...
_ZNSt6vectorIN4llvh9StringRefESaIS1_EE17_M_realloc_insertIJS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i: ; preds = %.lr.ph.i.i.i.i.i.i, %_ZNKSt6vectorIN4llvh9StringRefESaIS1_EE12_M_check_lenEmPKc.exit.i.i.i
  ...
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.061.095, i64 noundef %i.cv) #15
...
bb.w:                                             ; preds = %._crit_edge
  %i.di = call noundef nonnull align 8 dereferenceable(36) ptr @_ZN4llvh4errsEv() #12 ; 4 uses
...
bb.x:                                             ; preds = %bb.w
  %i.dr = call noundef nonnull align 8 dereferenceable(36) ptr @_ZN4llvh11raw_ostream5writeEPKcm(ptr noundef nonnull align 8 dereferenceable(36) %i.di, ptr noundef nonnull @.str.4, i64 noundef 7) #12
...
begin_hunk_23
  ...
  %i.dw = call noundef nonnull align 8 dereferenceable(36) ptr @_ZN4llvh11raw_ostream5writeEPKcm(ptr noundef nonnull align 8 dereferenceable(36) %.0.i.i45, ptr noundef %i.du, i64 noundef %i.dv) #12 ; 3 uses
...
bb.z:                                             ; preds = %_ZN4llvh11raw_ostreamlsEPKc.exit46
  %i.ec = call noundef nonnull align 8 dereferenceable(36) ptr @_ZN4llvh11raw_ostream5writeEPKcm(ptr noundef nonnull align 8 dereferenceable(36) %i.dw, ptr noundef nonnull @.str.3, i64 noundef 1) #12 ; 0 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i51: ; preds = %bb.ac
  ...
  %i.ej = add i64 %i.ei, 1
  call void @_ZdlPvm(ptr noundef %i.eg, i64 noundef %i.ej) #15
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i52: ; preds = %bb.ac, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i51
  ...
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.061.0.lcssa, i64 noundef %i.el) #15
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i: ; preds = %bb.ad
  ...
  %i.et = add i64 %i.es, 1
  call void @_ZdlPvm(ptr noundef %i.ep, i64 noundef %i.et) #15
