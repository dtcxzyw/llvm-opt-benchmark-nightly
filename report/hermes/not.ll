begin_hunk_0_@main:bb.a
  ...
  call void %i.bo(ptr dead_on_unwind nonnull writable sret(%"class.std::__cxx11::basic_string") align 8 %3, ptr noundef nonnull align 8 dereferenceable(8) %.sroa.31.0.i, i32 noundef %.sroa.0.0.i) #11
  %i.bp = load ptr, ptr %3, align 8, !tbaa !22
...
_ZN4llvh11raw_ostreamlsEPKc.exit40:               ; preds = %bb.o, %bb.p
  %i.cb = load ptr, ptr %3, align 8, !tbaa !22    ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %_ZN4llvh11raw_ostreamlsEPKc.exit40
  %i.ce = load i64, ptr %i.cc, align 8, !tbaa !27
  %i.cf = add i64 %i.ce, 1
...
begin_hunk_2_@main:bb.a
  ...
  store ptr %i.cl, ptr %4, align 8, !tbaa !28
  %i.cm = getelementptr inbounds nuw i8, ptr %4, i64 8 ; 2 uses
  store i64 0, ptr %i.cm, align 8, !tbaa !26
  store i8 0, ptr %i.cl, align 8, !tbaa !27
  %i.cn = load ptr, ptr %2, align 8, !tbaa !22
...
bb.t:                                             ; preds = %_ZN4llvh9StringRefC2EPKc.exit
  ...
  store i64 %i.da, ptr %.sroa.5.0..sroa_idx, align 8, !tbaa !34
...
begin_hunk_4_@main:bb.a
  ...
  store i64 %i.da, ptr %.sroa.5.0..sroa_idx59, align 8, !tbaa !34
...
.lr.ph.i.i.i.i.i.i:                               ; preds = %_ZNKSt6vectorIN4llvh9StringRefESaIS1_EE12_M_check_lenEmPKc.exit.i.i.i, %.lr.ph.i.i.i.i.i.i
  ...
  br i1 %.not.i.i.i.i.i.i, label %_ZNSt6vectorIN4llvh9StringRefESaIS1_EE17_M_realloc_insertIJS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i, label %.lr.ph.i.i.i.i.i.i, !llvm.loop !40
...
_ZN4llvh11raw_ostreamlsEPKc.exit46:               ; preds = %bb.x, %bb.y
  ...
  %i.ec = load ptr, ptr %4, align 8, !tbaa !22
  %i.ed = load i64, ptr %i.cm, align 8, !tbaa !26
...
bb.ac:                                            ; preds = %bb.ab, %_ZN4llvh11raw_ostreamlsEPKc.exit50
  ...
  %i.eo = load ptr, ptr %4, align 8, !tbaa !22    ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i51: ; preds = %bb.ac
  %i.eq = load i64, ptr %i.cl, align 8, !tbaa !27
  %i.er = add i64 %i.eq, 1
...
bb.ad:                                            ; preds = %_ZNSt6vectorIN4llvh9StringRefESaIS1_EED2Ev.exit
  %i.ex = load ptr, ptr %2, align 8, !tbaa !22    ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i: ; preds = %bb.ad
  %i.fa = load i64, ptr %i.ey, align 8, !tbaa !27
  %i.fb = add i64 %i.fa, 1
...
!28 = !{!24, !9, i64 0}
!29 = !{!30, !33, i64 16}
!30 = !{!"_ZTSN4llvh15optional_detail15OptionalStorageINS_8ArrayRefINS_9StringRefEEELb1EEE", !31, i64 0, !33, i64 16}
!31 = !{!"_ZTSN4llvh21AlignedCharArrayUnionINS_8ArrayRefINS_9StringRefEEEcccccccccEE", !32, i64 0}
!32 = !{!"_ZTSN4llvh16AlignedCharArrayILm8ELm16EEE", !6, i64 0}
!33 = !{!"bool", !6, i64 0}
!34 = !{!25, !25, i64 0}
!35 = !{i64 0, i64 8, !8, i64 8, i64 8, !34}
!36 = !{!37, !39}
!37 = distinct !{!37, !38, !"_ZSt19__relocate_object_aIN4llvh9StringRefES1_SaIS1_EEvPT_PT0_RT1_: argument 0"}
!38 = distinct !{!38, !"_ZSt19__relocate_object_aIN4llvh9StringRefES1_SaIS1_EEvPT_PT0_RT1_"}
!39 = distinct !{!39, !38, !"_ZSt19__relocate_object_aIN4llvh9StringRefES1_SaIS1_EEvPT_PT0_RT1_: argument 1"}
!40 = distinct !{!40, !41}
