...
.preheader3235:                                   ; preds = %bb.ac, %bb.ae
  ...
  %i.fn = shl nsw i32 %indvars3274, 3
...
bb.ag:                                            ; preds = %.preheader3394, %bb.ai
  ...
  %i.gc = shl nsw i32 %indvars3278, 3
...
.preheader3227:                                   ; preds = %bb.df, %.preheader3227
  ...
  %i.vh = shl nsw i32 %.82814, 2                  ; 2 uses
...
bb.eo:                                            ; preds = %bb.eq, %bb.en
  ...
  %i.aam = shl nsw i32 %indvars3330, 3
...
bb.b:                                             ; preds = %bb.d, %bb.a
  ...
  %i.lj = shl nuw nsw i64 %indvars.iv, 2          ; 2 uses
