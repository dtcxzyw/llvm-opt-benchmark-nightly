...
bb.cb:                                            ; preds = %.loopexit3233
  ...
  %i.nn = tail call range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %.0.copyload.i3148.a, i1 false) ; 8 uses
...
bb.db:                                            ; preds = %bb.db, %..thread_crit_edge
  ...
  %i.ue = lshr i32 %.0.copyload.i3167.a, %.pre3345
  %8 = or i32 %i.ue, %.9
  ...
  %10 = add i32 %9, %.1
  %i.uh = shl i32 %.0.copyload.i3167.a, %5
  %11 = add i32 %9, %i.jk
  ...
  %i.uk = lshr i32 %.0.copyload.i3168.a, %.pre3345
  ...
  %i.uo = shl i32 %.0.copyload.i3168.a, %5        ; 2 uses
  %13 = add i32 %.52790, 2                        ; 2 uses
  %.not2892 = icmp eq i32 %13, %6
  br i1 %.not2892, label %14, label %bb.db

14:                                               ; preds = %bb.db
  %15 = and i32 %.12786, 1
  %.not2891 = icmp eq i32 %15, 0
...
.thread:                                          ; preds = %14
  ...
  %i.ut = lshr i32 %.0.copyload.i3169.a, %.pre3345
