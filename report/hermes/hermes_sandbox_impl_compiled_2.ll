...
bb.bl:                                            ; preds = %bb.bk, %bb.bj, %bb.bi
  ...
  %.12786 = phi i32 [ 2, %bb.bi ], [ 0, %bb.bk ], [ 1, %bb.bj ] ; 11 uses
...
bb.bn:                                            ; preds = %bb.bo, %bb.bm
  %indvars.iv3286.a = phi i64 [ %indvars.iv.next3287.a, %bb.bo ], [ %i.lu, %bb.bm ]
  %.22797 = phi i32 [ %i.lz, %bb.bo ], [ %.12796, %bb.bm ] ; 2 uses
  %indvars.iv.next3287.a = add nsw i64 %indvars.iv3286.a, -1 ; 2 uses
  %indvars3288 = trunc i64 %indvars.iv.next3287.a to i32 ; 2 uses
...
bb.ca:                                            ; preds = %bb.bz, %bb.bw, %bb.bu, %bb.bs
  %.32788 = phi i32 [ 0, %bb.bs ], [ %.0.copyload.i3147, %bb.bu ], [ 0, %bb.bw ], [ %i.nf, %bb.bz ] ; 2 uses
...
bb.cb:                                            ; preds = %.loopexit3233
  ...
  %i.ni = add nsw i32 %.12786, -1                 ; 2 uses
  ...
  %i.nn = tail call range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %.0.copyload.i3148, i1 false) ; 8 uses
...
bb.cf:                                            ; preds = %bb.cf, %bb.ce
  ...
  %.0.copyload.i3152 = load i32, ptr %i.ou, align 1 ; 3 uses
  tail call void asm sideeffect "", "r,~{dirflag},~{fpsr},~{flags}"(i32 %.0.copyload.i3152) #7, !srcloc !19
  %i.ov = shl i32 %.0.copyload.i3152, %i.ns
  %i.ow = lshr i32 %.0.copyload.i3151, %i.no
  ...
  %i.oz = lshr i32 %.0.copyload.i3152, %i.no      ; 2 uses
...
bb.cg:                                            ; preds = %.preheader3230, %bb.cg
  %indvars.iv3296.a = phi i64 [ %.4, %.preheader3230 ], [ %indvars.iv.next3297.a, %bb.cg ] ; 2 uses
  %.62813 = phi i32 [ %.52812, %.preheader3230 ], [ %i.pl, %bb.cg ]
  %.22778 = phi i32 [ 0, %.preheader3230 ], [ %i.pm, %bb.cg ]
  %i.pd = trunc nuw i64 %indvars.iv3296.a to i32
  %i.pe = shl i32 %i.pd, 2
  ...
  %.0.copyload.i3153 = load i32, ptr %i.ph, align 1 ; 3 uses
  tail call void asm sideeffect "", "r,~{dirflag},~{fpsr},~{flags}"(i32 %.0.copyload.i3153) #7, !srcloc !19
  %i.pi = shl i32 %.0.copyload.i3153, %i.pc
  ...
  %indvars.iv.next3297.a = add nuw nsw i64 %indvars.iv3296.a, 1
  %i.pl = lshr i32 %.0.copyload.i3153, %i.no      ; 2 uses
...
bb.ci:                                            ; preds = %bb.ch, %bb.ci
  ...
  %.0.copyload.i3154 = load i32, ptr %i.pt, align 1 ; 3 uses
  tail call void asm sideeffect "", "r,~{dirflag},~{fpsr},~{flags}"(i32 %.0.copyload.i3154) #7, !srcloc !19
  %i.pu = shl i32 %.0.copyload.i3154, %i.po
...
bb.cj:                                            ; preds = %bb.cx, %.loopexit3229
  ...
  %.0.copyload.i3155 = load i64, ptr %i.qo, align 1 ; 3 uses
  tail call void asm sideeffect "", "r,~{dirflag},~{fpsr},~{flags}"(i64 %.0.copyload.i3155) #7, !srcloc !22
  %.val3109 = load ptr, ptr %i.d, align 8, !tbaa !18
  %i.qp = getelementptr inbounds nuw i8, ptr %.val3109, i64 %i.nl
  %.0.copyload.i3156 = load i32, ptr %i.qp, align 1 ; 3 uses
  tail call void asm sideeffect "", "r,~{dirflag},~{fpsr},~{flags}"(i32 %.0.copyload.i3156) #7, !srcloc !38
  %i.qq = zext i32 %.0.copyload.i3156 to i64      ; 4 uses
  %i.qr = icmp eq i32 %.0.copyload.i3156, 0
...
bb.cl:                                            ; preds = %bb.cj
  ...
  %.recomposed3420 = urem i64 %.0.copyload.i3155, %i.qq ; 2 uses
...
bb.cm:                                            ; preds = %bb.cl
  ...
  tail call void asm sideeffect "", "r,~{dirflag},~{fpsr},~{flags}"(i32 %.0.copyload.i3157) #7, !srcloc !38
  ...
  tail call void asm sideeffect "", "r,~{dirflag},~{fpsr},~{flags}"(i32 %.0.copyload.i3158) #7, !srcloc !38
...
bb.cp:                                            ; preds = %bb.co
  ...
  tail call void asm sideeffect "", "r,~{dirflag},~{fpsr},~{flags}"(i32 %.0.copyload.i3159) #7, !srcloc !38
  ...
  tail call void asm sideeffect "", "r,~{dirflag},~{fpsr},~{flags}"(i32 %.0.copyload.i3160) #7, !srcloc !38
...
.preheader3223:                                   ; preds = %bb.cr, %.preheader3223
  %indvars.iv3306.a = phi i64 [ %indvars.iv.next3307.a, %.preheader3223 ], [ 0, %bb.cr ] ; 3 uses
  %.02759 = phi i64 [ %i.sn, %.preheader3223 ], [ 0, %bb.cr ]
  %i.rs = trunc nuw nsw i64 %indvars.iv3306.a to i32
  ...
  tail call void asm sideeffect "", "r,~{dirflag},~{fpsr},~{flags}"(i32 %.0.copyload.i3161) #7, !srcloc !38
  %i.ry = zext i32 %.0.copyload.i3161 to i64
  %indvars.iv3306.tr.a = trunc nuw nsw i64 %indvars.iv3306.a to i32
  %i.rz = shl nuw nsw i32 %indvars.iv3306.tr.a, 2
  ...
  tail call void asm sideeffect "", "r,~{dirflag},~{fpsr},~{flags}"(i32 %.0.copyload.i3162) #7, !srcloc !38
  ...
  %indvars.iv.next3307.a = add nuw nsw i64 %indvars.iv3306.a, 1 ; 2 uses
  %.not2884 = icmp eq i64 %indvars.iv.next3307.a, %i.qg
...
bb.cu:                                            ; preds = %bb.cu, %bb.ct
  %indvars.iv3310 = phi i64 [ %indvars.iv.next3311.a, %bb.cu ], [ 0, %bb.ct ] ; 3 uses
  ...
  %i.tl = add i32 %.0.copyload.i3164, %.62782
  ...
  %indvars.iv.next3311.a = add nuw nsw i64 %indvars.iv3310, 1 ; 2 uses
  %.not2887 = icmp eq i64 %indvars.iv.next3311.a, %i.qg
...
bb.cv:                                            ; preds = %bb.cu
  ...
  %i.ts = add i32 %.0.copyload.i3166, %.2
...
bb.cz:                                            ; preds = %bb.cy
  br i1 %.not2874, label %bb.dc, label %bb.da

bb.da:                                            ; preds = %bb.cz
  br i1 %.not2879, label %.loopexit3228, label %..thread_crit_edge

..thread_crit_edge:                               ; preds = %bb.da
  %5 = sub nuw nsw i32 32, %i.nn                  ; 2 uses
  %6 = and i32 %.12786, 2
  %.pre3345 = and i32 %i.nn, 31                   ; 3 uses
  br label %bb.db

bb.db:                                            ; preds = %bb.db, %..thread_crit_edge
  %.02793 = phi i32 [ 1, %..thread_crit_edge ], [ %12, %bb.db ] ; 2 uses
  %.52790 = phi i32 [ 0, %..thread_crit_edge ], [ %13, %bb.db ]
  %.9 = phi i32 [ 0, %..thread_crit_edge ], [ %i.uo, %bb.db ]
  %7 = shl i32 %.02793, 2                         ; 3 uses
  %i.ua = add i32 %7, %.1
  %i.ub = add i32 %7, %i.jk
  %i.uc = zext i32 %i.ub to i64
  %.val2940 = load ptr, ptr %i.d, align 8, !tbaa !18
  %i.ud = getelementptr inbounds nuw i8, ptr %.val2940, i64 %i.uc
  %.0.copyload.i3167 = load i32, ptr %i.ud, align 1 ; 3 uses
  tail call void asm sideeffect "", "r,~{dirflag},~{fpsr},~{flags}"(i32 %.0.copyload.i3167) #7, !srcloc !19
  %i.ue = lshr i32 %.0.copyload.i3167, %.pre3345
  %8 = or i32 %i.ue, %.9
  %i.uf = zext i32 %i.ua to i64
  %.val2986 = load ptr, ptr %i.d, align 8, !tbaa !18
  %i.ug = getelementptr inbounds nuw i8, ptr %.val2986, i64 %i.uf
  store i32 %8, ptr %i.ug, align 1
  %9 = add nsw i32 %7, -4                         ; 2 uses
  %10 = add i32 %9, %.1
  %i.uh = shl i32 %.0.copyload.i3167, %5
  %11 = add i32 %9, %i.jk
  %i.ui = zext i32 %11 to i64
  %.val2939 = load ptr, ptr %i.d, align 8, !tbaa !18
  %i.uj = getelementptr inbounds nuw i8, ptr %.val2939, i64 %i.ui
  %.0.copyload.i3168 = load i32, ptr %i.uj, align 1 ; 3 uses
  tail call void asm sideeffect "", "r,~{dirflag},~{fpsr},~{flags}"(i32 %.0.copyload.i3168) #7, !srcloc !19
  %i.uk = lshr i32 %.0.copyload.i3168, %.pre3345
  %i.ul = or i32 %i.uk, %i.uh
  %i.um = zext i32 %10 to i64
  ...
  %12 = add i32 %.02793, -2                       ; 2 uses
  %i.uo = shl i32 %.0.copyload.i3168, %5          ; 2 uses
  %13 = add i32 %.52790, 2                        ; 2 uses
  %.not2892.a = icmp eq i32 %13, %6
  br i1 %.not2892.a, label %14, label %bb.db

14:                                               ; preds = %bb.db
  %15 = and i32 %.12786, 1
  %.not2892 = icmp eq i32 %15, 0
  br i1 %.not2892, label %.loopexit3228, label %.thread

.thread:                                          ; preds = %14
  %16 = shl i32 %12, 2                            ; 2 uses
  %i.up = add i32 %16, %.1
  %i.uq = add i32 %16, %i.jk
  %i.ur = zext i32 %i.uq to i64
  %.val2938 = load ptr, ptr %i.d, align 8, !tbaa !18
  %i.us = getelementptr inbounds nuw i8, ptr %.val2938, i64 %i.ur
  %.0.copyload.i3169 = load i32, ptr %i.us, align 1 ; 2 uses
  tail call void asm sideeffect "", "r,~{dirflag},~{fpsr},~{flags}"(i32 %.0.copyload.i3169) #7, !srcloc !19
  %i.ut = lshr i32 %.0.copyload.i3169, %.pre3345
  %i.uu = or i32 %i.ut, %i.uo
...
.preheader3227:                                   ; preds = %bb.dc, %.preheader3227
  ...
  %.0.copyload.i3170 = load i32, ptr %i.uz, align 1 ; 2 uses
  ...
  %i.vb = getelementptr inbounds nuw i8, ptr %.val2983, i64 %i.va
  store i32 %.0.copyload.i3170, ptr %i.vb, align 1
...
.loopexit3228:                                    ; preds = %.preheader3227, %.loopexit3228.sink.split, %bb.dc, %14, %bb.da, %bb.cy, %.loopexit3226.a
...
.preheader3225:                                   ; preds = %.loopexit3228, %.preheader3225
  ...
  %i.vi = add i32 %i.vh, %.0.copyload.i3136
  ...
  %.0.copyload.i3171 = load i64, ptr %i.vl, align 1 ; 2 uses
  ...
  store i64 %.0.copyload.i3171, ptr %i.vn, align 1
  %i.vo = or disjoint i32 %i.vh, 8                ; 2 uses
  %i.vp = add i32 %i.vo, %.0.copyload.i3136
  ...
  %.0.copyload.i3172 = load i64, ptr %i.vs, align 1 ; 2 uses
  ...
  store i64 %.0.copyload.i3172, ptr %i.vu, align 1
...
bb.de:                                            ; preds = %bb.dd
  ...
  %i.vw = add i32 %i.vv, %.0.copyload.i3136
  ...
  %.0.copyload.i3173 = load i64, ptr %i.vz, align 1 ; 2 uses
  ...
  store i64 %.0.copyload.i3173, ptr %i.wb, align 1
  br label %bb.df
...
bb.dg:                                            ; preds = %bb.df
  ...
  %.0.copyload.i3174 = load i64, ptr %i.wd, align 1 ; 2 uses
  ...
  store i64 %.0.copyload.i3174, ptr %i.we, align 1
  br label %bb.dh
...
bb.di:                                            ; preds = %bb.dh
  ...
  %.not2899 = icmp eq i32 %.1, 0
  br i1 %.not2899, label %bb.dk, label %bb.dj
...
bb.dk:                                            ; preds = %bb.di, %bb.dh, %bb.dj
  ...
  %.0.copyload.i3175 = load i32, ptr %i.wg, align 1 ; 2 uses
  tail call void asm sideeffect "", "r,~{dirflag},~{fpsr},~{flags}"(i32 %.0.copyload.i3175) #7, !srcloc !19
  %i.wh = add i32 %.0.copyload.i3175, %i.ji
...
bb.dl:                                            ; preds = %bb.ac
  ...
  %.0.copyload.i3176 = load i32, ptr %i.wl, align 1 ; 4 uses
  tail call void asm sideeffect "", "r,~{dirflag},~{fpsr},~{flags}"(i32 %.0.copyload.i3176) #7, !srcloc !19
  %i.wm = icmp ugt i32 %.0.copyload.i3176, 64
...
bb.dm:                                            ; preds = %bb.dl
  ...
  %.0.copyload.i3177 = load i32, ptr %i.wn, align 1 ; 2 uses
  tail call void asm sideeffect "", "r,~{dirflag},~{fpsr},~{flags}"(i32 %.0.copyload.i3177) #7, !srcloc !19
  %i.wo = icmp ugt i32 %.0.copyload.i3177, 64
...
bb.dn:                                            ; preds = %bb.dm
  ...
  %.0.copyload.i3178 = load i64, ptr %i.wp, align 1 ; 4 uses
  ...
  store i32 %.0.copyload.i3179, ptr %i.ws, align 1
  %i.wt = icmp ugt i32 %.0.copyload.i3179, 64
  br i1 %i.wt, label %bb.do, label %bb.dp

bb.do:                                            ; preds = %bb.dn
  %i.wu = zext i32 %.0.copyload.i3179 to i64
  %i.wv = add nuw nsw i64 %i.wu, 63
  %sh.diff = lshr i64 %i.wv, 3
  %i.ww = and i64 %sh.diff, 1073741816
  %i.wx = add i64 %.0.copyload.i3178, 4294967288
  ...
  %.0.copyload.i3180 = load i64, ptr %i.xa, align 1 ; 2 uses
...
bb.dp:                                            ; preds = %bb.do, %bb.dn
  ...
  %.12761 = phi i64 [ %.0.copyload.i3180, %bb.do ], [ %.0.copyload.i3178, %bb.dn ]
  %i.xb = sub i32 0, %.0.copyload.i3179
...
bb.dr:                                            ; preds = %bb.dq
  %i.xp = icmp ult i32 %.0.copyload.i3176, 65
...
bb.ds:                                            ; preds = %bb.dr
  ...
  %.0.copyload.i3182 = load i32, ptr %i.xq, align 1 ; 3 uses
...
bb.du:                                            ; preds = %bb.ds, %bb.dr, %bb.dt
  ...
  store i32 %.0.copyload.i3181, ptr %i.xr, align 1
  %i.xs = icmp ult i32 %.0.copyload.i3181, 65
