...
bb.d:                                             ; preds = %bb.a
  ...
  %.0.copyload.i583 = load i16, ptr %i.o, align 1 ; 3 uses
  tail call void asm sideeffect "", "r,~{dirflag},~{fpsr},~{flags}"(i16 %.0.copyload.i583) #8, !srcloc !23
  %i.p = zext i16 %.0.copyload.i583 to i32        ; 7 uses
...
bb.bi:                                            ; preds = %bb.bh
  %2 = add nuw nsw i32 %i.p, 65408
  %3 = and i32 %2, 65535
  %4 = icmp samesign ugt i32 %3, 65408
  br i1 %4, label %bb.bj, label %bb.bk
...
.loopexit1419:                                    ; preds = %.preheader1418, %bb.z
  ...
  %3 = add nsw i32 %i.ab, -8
  %4 = icmp ult i32 %3, -7
  br i1 %4, label %.preheader1416, label %.loopexit1417
