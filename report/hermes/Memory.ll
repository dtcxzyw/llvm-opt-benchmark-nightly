...
define hidden { ptr, i64 } @_ZN4llvh3sys6Memory20allocateMappedMemoryEmPKNS0_11MemoryBlockEjRSt10error_code(i64 noundef %0, ptr noundef readonly captures(address_is_null) %1, i32 noundef %2, ptr noundef nonnull writeonly align 8 captures(none) dereferenceable(16) initializes((0, 16)) %3) local_unnamed_addr #0 align 2 {
bb.a:
...
bb.h:                                             ; preds = %bb.g, %bb.f, %bb.e
  ...
  %i.w = mul i64 %i.l, %i.i
  %i.x = tail call ptr @mmap(ptr noundef %i.v, i64 noundef %i.w, i32 noundef %switch.load, i32 noundef 34, i32 noundef -1, i64 noundef 0) #9 ; 2 uses
  %i.y = icmp eq ptr %i.x, inttoptr (i64 -1 to ptr)
  br i1 %i.y, label %bb.i, label %bb.j

.thread46:                                        ; preds = %switch.lookup
  %i.z = mul i64 %i.l, %i.i
  %i.aa = tail call ptr @mmap(ptr noundef null, i64 noundef %i.z, i32 noundef %switch.load, i32 noundef 34, i32 noundef -1, i64 noundef 0) #9 ; 2 uses
...
; Function Attrs: mustprogress nounwind uwtable
define hidden { i32, ptr } @_ZN4llvh3sys6Memory19protectMappedMemoryERKNS0_11MemoryBlockEj(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(16) %0, i32 noundef %1) local_unnamed_addr #0 align 2 {
bb.a:
...
switch.lookup:                                    ; preds = %bb.g
  ...
  %switch.gep = getelementptr inbounds nuw [4 x i8], ptr @switch.table._ZN4llvh3sys6Memory19protectMappedMemoryERKNS0_11MemoryBlockEj, i64 %3
  ...
  %i.ac = tail call i32 @mprotect(ptr noundef %i.aa, i64 noundef %i.ab, i32 noundef %switch.load) #9
...
; Function Attrs: mustprogress nounwind uwtable
define hidden { i32, ptr } @_ZN4llvh3sys6Memory19releaseMappedMemoryERNS0_11MemoryBlockE(ptr noundef nonnull align 8 captures(none) dereferenceable(16) %0) local_unnamed_addr #0 align 2 {
bb.a:
