...
bb.i:                                             ; preds = %bb.h
  %i.ae = tail call { ptr, i64 } @_ZN4llvh3sys6Memory20allocateMappedMemoryEmPKNS0_11MemoryBlockEjRSt10error_code(i64 noundef %0, ptr noundef null, i32 noundef %2, ptr noundef nonnull align 8 dereferenceable(16) %3) ; 2 uses
...
.thread48:                                        ; preds = %.thread46
  ...
  %i.aj = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSt3_V216generic_categoryEv() #8
  store i32 %i.ai, ptr %3, align 8, !tbaa !3
  store ptr %i.aj, ptr %.sroa.443.0..sroa_idx, align 8, !tbaa !7
  br label %bb.n

bb.j:                                             ; preds = %.thread46, %bb.h
  %i.ak = phi ptr [ %i.ac, %.thread46 ], [ %i.z, %bb.h ] ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #9
  store ptr %i.ak, ptr %4, align 8, !tbaa !13
  %i.al = load i64, ptr @_ZZN4llvh3sys6Memory20allocateMappedMemoryEmPKNS0_11MemoryBlockEjRSt10error_codeE8PageSize, align 8, !tbaa !11
  %i.am = mul i64 %i.al, %i.l                     ; 2 uses
  %i.an = getelementptr inbounds nuw i8, ptr %4, i64 8
  store i64 %i.am, ptr %i.an, align 8, !tbaa !15
  %i.ao = and i32 %2, 67108864
  %.not36 = icmp eq i32 %i.ao, 0
  br i1 %.not36, label %bb.l, label %bb.k

bb.k:                                             ; preds = %bb.j
  %i.ap = call { i32, ptr } @_ZN4llvh3sys6Memory19protectMappedMemoryERKNS0_11MemoryBlockEj(ptr noundef nonnull align 8 dereferenceable(16) %4, i32 noundef %2) ; 2 uses
  %i.aq = extractvalue { i32, ptr } %i.ap, 0      ; 2 uses
  %i.ar = extractvalue { i32, ptr } %i.ap, 1      ; 2 uses
  store i32 %i.aq, ptr %3, align 8, !tbaa !3
  store ptr %i.ar, ptr %.sroa.443.0..sroa_idx, align 8, !tbaa !7
  %i.as = icmp ne ptr %i.ar, %i.a
...
bb.m:                                             ; preds = %bb.k, %bb.l
  %.sroa.6.0 = phi i64 [ %i.am, %bb.l ], [ 0, %bb.k ]
  %.sroa.044.0 = phi ptr [ %i.ak, %bb.l ], [ null, %bb.k ]
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #9
  br label %bb.n

bb.n:                                             ; preds = %bb.a, %bb.i, %.thread48, %bb.m
  %.sroa.6.1 = phi i64 [ %.sroa.6.0, %bb.m ], [ 0, %.thread48 ], [ %i.ag, %bb.i ], [ 0, %bb.a ]
  %.sroa.044.1 = phi ptr [ %.sroa.044.0, %bb.m ], [ null, %.thread48 ], [ %i.af, %bb.i ], [ null, %bb.a ]
...
bb.k:                                             ; preds = %bb.j
  ...
  tail call void @_ZN4llvh3sys27ValgrindDiscardTranslationsEPKvm(ptr noundef %i.aj, i64 noundef %i.ak) #9
  br label %bb.l

bb.l:                                             ; preds = %bb.k, %bb.j
  %i.al = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSt3_V215system_categoryEv() #8
  br label %bb.m

bb.m:                                             ; preds = %bb.i, %bb.l, %bb.h, %bb.f
  %.sroa.5.0 = phi ptr [ %i.l, %bb.f ], [ %i.m, %bb.h ], [ %i.al, %bb.l ], [ %i.ah, %bb.i ]
  %.sroa.0.0 = phi i32 [ 0, %bb.f ], [ 22, %bb.h ], [ 0, %bb.l ], [ %i.ag, %bb.i ]
