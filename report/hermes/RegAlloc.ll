...
bb.a:
  ...
  %i.b = load i32, ptr %i.a, align 8, !tbaa !31   ; 6 uses
  %i.c = add i32 %i.b, 63
...
bb.d:                                             ; preds = %_ZNK4llvh9BitVector4noneEv.exit
  ...
  %.not37.i.i = sub i32 0, %i.b
  %1 = and i32 %.not37.i.i, 63
...
begin_hunk_2_@_ZN6hermes17RegisterAllocator16allocateFastPassEN4llvh8ArrayRefIPNS_10BasicBlockEEE:bb.a
  ...
  %i.n = load i32, ptr %i.m, align 8, !tbaa !31   ; 6 uses
  %i.o = add i32 %i.n, 63
...
bb.d:                                             ; preds = %_ZNK4llvh9BitVector4noneEv.exit.i
  ...
  %.not37.i.i.i = sub i32 0, %i.n
  %4 = and i32 %.not37.i.i.i, 63
  %i.x = zext nneg i32 %4 to i64
...
bb.i:                                             ; preds = %.lr.ph577
  %i.bj = load i32, ptr %i.c, align 8, !tbaa !31  ; 11 uses
...
bb.w:                                             ; preds = %_ZNK4llvh9BitVector4noneEv.exit.i72
  ...
  %.not37.i.i.i73 = sub i32 0, %i.bj
  %5 = and i32 %.not37.i.i.i73, 63
  %i.es = zext nneg i32 %5 to i64
...
bb.bw:                                            ; preds = %_ZN6hermes17RegisterAllocator11isAllocatedEPNS_5ValueE.exit104
  %i.sd = load i32, ptr %i.m, align 8, !tbaa !31  ; 11 uses
...
bb.ck:                                            ; preds = %_ZNK4llvh9BitVector4noneEv.exit.i110
  ...
  %.not37.i.i.i112 = sub i32 0, %i.sd
  %6 = and i32 %.not37.i.i.i112, 63
  %i.vm = zext nneg i32 %6 to i64
...
bb.di:                                            ; preds = %bb.cx
  %i.abj = load i32, ptr %i.m, align 8, !tbaa !31 ; 11 uses
...
bb.dw:                                            ; preds = %_ZNK4llvh9BitVector4noneEv.exit.i138
  %i.aeq = add i32 %i.abj, -1
  %i.aer = lshr i32 %i.aeq, 6                     ; 3 uses
  %.not37.i.i.i141 = sub i32 0, %i.abj
  %7 = and i32 %.not37.i.i.i141, 63
  %i.aes = zext nneg i32 %7 to i64
...
_ZN6hermes17RegisterAllocator11isAllocatedEPNS_5ValueE.exit: ; preds = %.lr.ph.i.i.i, %.loopexit238
  %i.sf = load i32, ptr %i.hq, align 8, !tbaa !31 ; 6 uses
...
bb.at:                                            ; preds = %_ZNK4llvh9BitVector4noneEv.exit.i
  ...
  %.not37.i.i.i = sub i32 0, %i.sf
  %7 = and i32 %.not37.i.i.i, 63
  %i.sp = zext nneg i32 %7 to i64
