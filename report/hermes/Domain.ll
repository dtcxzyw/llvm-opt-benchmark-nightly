...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep = getelementptr i8, ptr %i.ba, i64 %i.br ; 2 uses
  %next.gep362 = getelementptr i8, ptr %i.bb, i64 %i.br ; 2 uses
  %i.bs = getelementptr i8, ptr %next.gep362, i64 16
  %wide.load = load <2 x ptr>, ptr %next.gep362, align 8, !tbaa !17
  %wide.load363 = load <2 x ptr>, ptr %i.bs, align 8, !tbaa !17
  %i.bt = getelementptr i8, ptr %next.gep, i64 16
  store <2 x ptr> %wide.load, ptr %next.gep, align 8, !tbaa !17
  store <2 x ptr> %wide.load363, ptr %i.bt, align 8, !tbaa !17
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.bu = icmp eq i64 %index.next, %n.vec
  br i1 %i.bu, label %middle.block, label %vector.body, !llvm.loop !81

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %i.bm, %n.vec
  br i1 %cmp.n, label %_ZN6hermes2vm14CopyableVectorIPNS0_13RuntimeModuleEE11setCapacityEm.exit.i, label %.lr.ph.i.i.preheader386

.lr.ph.i.i.preheader386:                          ; preds = %.lr.ph.i.i.preheader, %middle.block
  %.012.i.i.ph = phi ptr [ %i.ba, %.lr.ph.i.i.preheader ], [ %i.bp, %middle.block ]
  %.01011.i.i.ph = phi ptr [ %i.bb, %.lr.ph.i.i.preheader ], [ %i.bq, %middle.block ]
  br label %.lr.ph.i.i

.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader386, %.lr.ph.i.i
  %.012.i.i = phi ptr [ %i.bx, %.lr.ph.i.i ], [ %.012.i.i.ph, %.lr.ph.i.i.preheader386 ] ; 2 uses
  %.01011.i.i = phi ptr [ %i.bw, %.lr.ph.i.i ], [ %.01011.i.i.ph, %.lr.ph.i.i.preheader386 ] ; 2 uses
  %i.bv = load ptr, ptr %.01011.i.i, align 8, !tbaa !17
  store ptr %i.bv, ptr %.012.i.i, align 8, !tbaa !17
  %i.bw = getelementptr inbounds nuw i8, ptr %.01011.i.i, i64 8 ; 2 uses
  %i.bx = getelementptr inbounds nuw i8, ptr %.012.i.i, i64 8
  %i.by = icmp ult ptr %i.bw, %i.be
  br i1 %i.by, label %.lr.ph.i.i, label %_ZN6hermes2vm14CopyableVectorIPNS0_13RuntimeModuleEE11setCapacityEm.exit.i, !llvm.loop !85
...
_ZN6hermes2vm14CopyableVectorIPNS0_13RuntimeModuleEE7reserveEm.exit: ; preds = %bb.j, %_ZN6hermes2vm14CopyableVectorIPNS0_13RuntimeModuleEE11setCapacityEm.exit.i
  ...
  %i.bz = getelementptr inbounds nuw i8, ptr %.pre-phi330, i64 16
  %i.ca = load i64, ptr %i.bz, align 8, !tbaa !13 ; 2 uses
...
._crit_edge:                                      ; preds = %_ZN6hermes2vm14CopyableVectorIPNS0_13RuntimeModuleEE9push_backEOS3_RNS0_7HadesGCE.exit, %_ZN6hermes2vm14CopyableVectorIPNS0_13RuntimeModuleEE7reserveEm.exit
  ...
  %i.ce = tail call ptr @_ZN6hermes2vm14NativeFunction6createERNS0_7RuntimeENS0_6HandleINS0_8JSObjectEEEPvPFNS0_10CallResultINS0_11HermesValueELNS0_6detail20CallResultSpecializeE2EEES7_S3_NS0_10NativeArgsEENS0_8SymbolIDEjS6_j(ptr noundef nonnull align 8 dereferenceable(9816) %1, ptr nonnull %i.cd, ptr noundef nonnull inttoptr (i64 1 to ptr), ptr noundef nonnull @_ZN6hermes2vm14throwTypeErrorEPvRNS0_7RuntimeENS0_10NativeArgsE, i32 14, i32 noundef 0, i64 ptrtoint (ptr @_ZN6hermes2vm15HandleRootOwner12nullPointer_E to i64), i32 noundef 0) #11 ; 2 uses
  %i.cf = getelementptr inbounds nuw i8, ptr %1, i64 9240
  %i.cg = tail call noundef ptr @_ZN6hermes2vm15IdentifierTable13getStringPrimERNS0_7RuntimeENS0_8SymbolIDE(ptr noundef nonnull align 8 dereferenceable(84) %i.cf, ptr noundef nonnull align 8 dereferenceable(9816) %1, i32 14) #11
  %i.ch = ptrtoint ptr %i.cg to i64
  %i.ci = or i64 %i.ch, -844424930131968          ; 2 uses
  %i.cj = load ptr, ptr %i.f, align 8, !tbaa !45  ; 3 uses
  %i.ck = getelementptr inbounds nuw i8, ptr %i.cj, i64 192 ; 2 uses
  %i.cl = load ptr, ptr %i.ck, align 8, !tbaa !48 ; 4 uses
  %i.cm = getelementptr inbounds nuw i8, ptr %i.cj, i64 200
  %i.cn = load ptr, ptr %i.cm, align 8, !tbaa !58
  %i.co = icmp ult ptr %i.cl, %i.cn
  br i1 %i.co, label %bb.m, label %bb.n, !prof !59

bb.m:                                             ; preds = %._crit_edge
  %i.cp = getelementptr inbounds nuw i8, ptr %i.cl, i64 8
  store ptr %i.cp, ptr %i.ck, align 8, !tbaa !48
  store i64 %i.ci, ptr %i.cl, align 8, !tbaa !44
  br label %_ZN6hermes2vm7Runtime25getPredefinedStringHandleENS0_10Predefined3StrE.exit

bb.n:                                             ; preds = %._crit_edge
  %i.cq = tail call noundef ptr @_ZN6hermes2vm7GCScope15_newChunkAndPHVENS0_11HermesValueE(ptr noundef nonnull align 8 dereferenceable(212) %i.cj, i64 %i.ci) #11
  br label %_ZN6hermes2vm7Runtime25getPredefinedStringHandleENS0_10Predefined3StrE.exit

_ZN6hermes2vm7Runtime25getPredefinedStringHandleENS0_10Predefined3StrE.exit: ; preds = %bb.m, %bb.n
  %.0.i.i.i.i.i.i.i = phi ptr [ %i.cl, %bb.m ], [ %i.cq, %bb.n ]
  %i.cr = tail call ptr @_ZN6hermes2vm14RequireContext6createERNS0_7RuntimeENS0_6HandleINS0_6DomainEEENS4_INS0_15StringPrimitiveEEE(ptr noundef nonnull align 8 dereferenceable(9816) %1, ptr nonnull %0, ptr %.0.i.i.i.i.i.i.i)
  %i.cs = tail call noundef i32 @_ZN6hermes2vm8JSObject20defineNewOwnPropertyENS0_6HandleIS1_EERNS0_7RuntimeENS0_8SymbolIDENS0_13PropertyFlagsENS2_INS0_11HermesValueEEE(ptr %i.ce, ptr noundef nonnull align 8 dereferenceable(9816) %1, i32 472, i16 2, ptr %i.cr) #11
  %.not283 = icmp eq i32 %i.cs, 0
...
bb.o:                                             ; preds = %.lr.ph, %_ZN6hermes2vm14CopyableVectorIPNS0_13RuntimeModuleEE9push_backEOS3_RNS0_7HadesGCE.exit
  %.0101285 = phi i64 [ %i.ca, %.lr.ph ], [ %i.df, %_ZN6hermes2vm14CopyableVectorIPNS0_13RuntimeModuleEE9push_backEOS3_RNS0_7HadesGCE.exit ]
  %.sroa.0.0.copyload.i.i137 = load i64, ptr %0, align 8, !tbaa !44
  %i.ct = and i64 %.sroa.0.0.copyload.i.i137, 281474976710655
  ...
  br i1 %i.da, label %bb.p, label %_ZN6hermes2vm14CopyableVectorIPNS0_13RuntimeModuleEE9push_backEOS3_RNS0_7HadesGCE.exit, !prof !71

bb.p:                                             ; preds = %bb.o
  tail call void @_ZN6hermes2vm14CopyableVectorIPNS0_13RuntimeModuleEE4growERNS0_7HadesGCE(ptr noundef nonnull align 8 dereferenceable(24) %i.cv, ptr noundef nonnull align 8 dereferenceable(8112) %i.cc)
  %.pre.i = load i64, ptr %i.cw, align 8, !tbaa !13
...
_ZN6hermes2vm14CopyableVectorIPNS0_13RuntimeModuleEE9push_backEOS3_RNS0_7HadesGCE.exit: ; preds = %bb.o, %bb.p
  %i.db = phi i64 [ %.pre.i, %bb.p ], [ %i.cx, %bb.o ] ; 2 uses
  %i.dc = load ptr, ptr %i.cv, align 8, !tbaa !7
  %i.dd = getelementptr inbounds nuw [8 x i8], ptr %i.dc, i64 %i.db
  store ptr null, ptr %i.dd, align 8, !tbaa !17
  %i.de = add i64 %i.db, 1
  store i64 %i.de, ptr %i.cw, align 8, !tbaa !13
  %i.df = add i64 %.0101285, 1                    ; 2 uses
  %exitcond.not = icmp eq i64 %i.df, %i.t
...
bb.q:                                             ; preds = %_ZN6hermes2vm7Runtime25getPredefinedStringHandleENS0_10Predefined3StrE.exit
  ...
  %i.dg = and i64 %.sroa.0.0.copyload.i.i138, 281474976710655
  %i.dh = inttoptr i64 %i.dg to ptr
  %i.di = getelementptr inbounds nuw i8, ptr %i.dh, i64 80 ; 3 uses
  %.sroa.0.0.copyload.i.i.i = load i64, ptr %i.ce, align 8, !tbaa !44 ; 2 uses
  %i.dj = and i64 %.sroa.0.0.copyload.i.i.i, 281474976710655 ; 2 uses
  %i.dk = getelementptr inbounds nuw i8, ptr %1, i64 1632
  %i.dl = load ptr, ptr %i.dk, align 8, !tbaa !87
  %i.dm = ptrtoint ptr %i.di to i64
  %i.dn = and i64 %i.dm, 562949949227008
  %i.do = inttoptr i64 %i.dn to ptr
  %i.dp = icmp eq ptr %i.dl, %i.do
  br i1 %i.dp, label %bb.s, label %bb.r, !prof !59

bb.r:                                             ; preds = %bb.q
  %i.dq = inttoptr i64 %i.dj to ptr
  %i.dr = getelementptr inbounds nuw i8, ptr %1, i64 856
  tail call void @_ZN6hermes2vm7HadesGC16writeBarrierSlowEPKNS0_13GCPointerBaseEPKNS0_6GCCellE(ptr noundef nonnull align 8 dereferenceable(8112) %i.dr, ptr noundef nonnull align 4 dereferenceable(4) %i.di, ptr noundef %i.dq) #11
  br label %bb.s

bb.s:                                             ; preds = %bb.r, %bb.q
  %.not.i.i.i.i.i = icmp eq i64 %i.dj, 0
  %i.ds = ptrtoint ptr %1 to i64
  %i.dt = sub i64 %.sroa.0.0.copyload.i.i.i, %i.ds
  %i.du = trunc i64 %i.dt to i32
  %.sroa.0.0.i.i.i.i.i = select i1 %.not.i.i.i.i.i, i32 0, i32 %i.du
  store i32 %.sroa.0.0.i.i.i.i.i, ptr %i.di, align 4, !tbaa !3
...
bb.t:                                             ; preds = %_ZN6hermes2vm13MutableHandleINS0_16ArrayStorageBaseINS0_11HermesValueEEEEC2ERNS0_15HandleRootOwnerEPS4_.exit
  ...
  %i.dw = zext i32 %i.r to i64
  %i.dx = add i64 %i.dw, %i.dv
  %i.dy = or i64 %i.dx, -281474976710656          ; 2 uses
  store i64 %i.dy, ptr %.0.i.i.i.i.i.i, align 8, !tbaa !79
  br label %bb.u

bb.u:                                             ; preds = %bb.s, %bb.t
  %.sroa.0.0.copyload.i.i141 = phi i64 [ %.sroa.0.0.copyload.i.i141.pre, %bb.s ], [ %i.dy, %bb.t ]
  %i.dz = and i64 %.sroa.0.0.copyload.i.i141, 281474976710655
  %i.ea = inttoptr i64 %i.dz to ptr
  %i.eb = getelementptr inbounds nuw i8, ptr %i.ea, i64 4
  %i.ec = load atomic i32, ptr %i.eb monotonic, align 4
  %i.ed = udiv i32 %i.ec, 3
  %i.ee = zext nneg i32 %i.ed to i64              ; 2 uses
  %i.ef = load ptr, ptr %i.b, align 8, !tbaa !39  ; 3 uses
  %i.eg = getelementptr inbounds nuw i8, ptr %i.ef, i64 192
  %.sroa.0.0.copyload.i142 = load ptr, ptr %i.eg, align 8, !tbaa !88 ; 2 uses
  %.sroa.2.0..sroa_idx.i143 = getelementptr inbounds nuw i8, ptr %i.ef, i64 200
  ...
  %i.eh = getelementptr inbounds nuw i8, ptr %.sroa.0.0.copyload.i142, i64 %.idx
...
._crit_edge292:                                   ; preds = %._crit_edge292.loopexit, %bb.u
  %i.ej = phi ptr [ %i.ef, %bb.u ], [ %.pre318, %._crit_edge292.loopexit ] ; 2 uses
  %.0102.lcssa = phi i64 [ %i.ee, %bb.u ], [ %spec.select, %._crit_edge292.loopexit ] ; 3 uses
  %i.ek = getelementptr inbounds nuw i8, ptr %i.ej, i64 208
  %.sroa.0.0.copyload.i147 = load ptr, ptr %i.ek, align 8, !tbaa !88 ; 3 uses
  %.sroa.2.0..sroa_idx.i148 = getelementptr inbounds nuw i8, ptr %i.ej, i64 216
  ...
  %i.el = getelementptr inbounds nuw i8, ptr %.sroa.0.0.copyload.i147, i64 %.idx313
...
bb.w:                                             ; preds = %bb.v
  ...
  %i.ez = load ptr, ptr %i.b, align 8, !tbaa !39  ; 2 uses
  %i.fa = getelementptr inbounds nuw i8, ptr %i.ez, i64 304
  %i.fb = load ptr, ptr %i.fa, align 8, !tbaa !97
  %i.fc = getelementptr inbounds nuw [4 x i8], ptr %i.fb, i64 %i.eu
  %i.fd = load i32, ptr %i.fc, align 1            ; 5 uses
  %i.fe = icmp ugt i32 %i.fd, -16777217
  br i1 %i.fe, label %bb.x, label %bb.y, !prof !71

bb.x:                                             ; preds = %bb.w
  %i.ff = getelementptr inbounds nuw i8, ptr %i.ez, i64 312
  %i.fg = lshr i32 %i.fd, 1
  %i.fh = and i32 %i.fg, 8388607
  %i.fi = zext nneg i32 %i.fh to i64
  %i.fj = load ptr, ptr %i.ff, align 8, !tbaa !137
  %i.fk = getelementptr inbounds nuw [8 x i8], ptr %i.fj, i64 %i.fi ; 2 uses
  %.sroa.0.0.copyload.i.i153 = load i32, ptr %i.fk, align 1, !tbaa !3
  %.sroa.4.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.fk, i64 4
...
bb.y:                                             ; preds = %bb.w
  %i.fl = lshr i32 %i.fd, 1
  %i.fm = and i32 %i.fl, 8388607
  %i.fn = lshr i32 %i.fd, 24
  br label %_ZNK6hermes3hbc20BCProviderFromBuffer19getStringTableEntryEj.exit.i

_ZNK6hermes3hbc20BCProviderFromBuffer19getStringTableEntryEj.exit.i: ; preds = %bb.y, %bb.x
  %.sink.i.i152 = phi i32 [ %i.fn, %bb.y ], [ %.sroa.4.0.copyload.i.i, %bb.x ]
  %.sroa.0.0.i.i = phi i32 [ %i.fm, %bb.y ], [ %.sroa.0.0.copyload.i.i153, %bb.x ]
  %i.fo = shl i32 %i.fd, 31
  %spec.select.i7.i.i = or i32 %.sink.i.i152, %i.fo
  ...
  %i.fp = call i32 @_ZN6hermes2vm13RuntimeModule35createSymbolFromStringIDMayAllocateEjRKNS_16StringTableEntryENS_8OptValueIjEE(ptr noundef nonnull align 8 dereferenceable(192) %2, i32 noundef %i.et, ptr noundef nonnull align 4 dereferenceable(8) %4, i64 0) #11
...
_ZN6hermes2vm13RuntimeModule34getSymbolIDFromStringIDMayAllocateEj.exit: ; preds = %bb.v, %_ZNK6hermes3hbc20BCProviderFromBuffer19getStringTableEntryEj.exit.i
  %.sroa.03.0.i = phi i32 [ %i.ex, %bb.v ], [ %i.fp, %_ZNK6hermes3hbc20BCProviderFromBuffer19getStringTableEntryEj.exit.i ] ; 3 uses
  %.sroa.0.0.copyload.i.i154 = load i64, ptr %0, align 8, !tbaa !44
  %i.fq = and i64 %.sroa.0.0.copyload.i.i154, 281474976710655
  %i.fr = inttoptr i64 %i.fq to ptr               ; 2 uses
  %i.fs = getelementptr inbounds nuw i8, ptr %i.fr, i64 32
  %i.ft = load ptr, ptr %i.fs, align 8, !tbaa !14 ; 5 uses
  %i.fu = getelementptr inbounds nuw i8, ptr %i.fr, i64 48
  %i.fv = load i32, ptr %i.fu, align 8, !tbaa !20 ; 4 uses
  %i.fw = icmp eq i32 %i.fv, 0
  br i1 %i.fw, label %_ZN4llvh12DenseMapBaseINS_8DenseMapIN6hermes2vm8SymbolIDEjNS_12DenseMapInfoIS4_EENS_6detail12DenseMapPairIS4_jEEEES4_jS6_S9_E15LookupBucketForIS4_EEbRKT_RPS9_.exit.i, label %bb.z

bb.z:                                             ; preds = %_ZN6hermes2vm13RuntimeModule34getSymbolIDFromStringIDMayAllocateEj.exit
  %i.fx = mul i32 %.sroa.03.0.i, 37
  %i.fy = add i32 %i.fv, -1                       ; 2 uses
  %.03649.i.i.i = and i32 %i.fy, %i.fx            ; 2 uses
  %i.fz = zext i32 %.03649.i.i.i to i64
  %i.ga = getelementptr inbounds nuw [8 x i8], ptr %i.ft, i64 %i.fz ; 2 uses
  %.sroa.05.0.copyload50.i.i.i = load i32, ptr %i.ga, align 4, !tbaa !3 ; 2 uses
  %i.gb = icmp eq i32 %.sroa.03.0.i, %.sroa.05.0.copyload50.i.i.i
  br i1 %i.gb, label %_ZN4llvh12DenseMapBaseINS_8DenseMapIN6hermes2vm8SymbolIDEjNS_12DenseMapInfoIS4_EENS_6detail12DenseMapPairIS4_jEEEES4_jS6_S9_E4findERKS4_.exit, label %.lr.ph.i.i.i, !prof !138
...
.lr.ph.i.i.i:                                     ; preds = %bb.z, %bb.aa
  ...
  %.03851.i.i.i = phi i32 [ %i.gd, %bb.aa ], [ 1, %bb.z ] ; 2 uses
  %i.gc = icmp eq i32 %.sroa.05.0.copyload54.i.i.i, 536870911
  br i1 %i.gc, label %_ZN4llvh12DenseMapBaseINS_8DenseMapIN6hermes2vm8SymbolIDEjNS_12DenseMapInfoIS4_EENS_6detail12DenseMapPairIS4_jEEEES4_jS6_S9_E15LookupBucketForIS4_EEbRKT_RPS9_.exit.i, label %bb.aa, !prof !59

bb.aa:                                            ; preds = %.lr.ph.i.i.i
  %i.gd = add i32 %.03851.i.i.i, 1
  %i.ge = add i32 %.03851.i.i.i, %.03653.i.i.i
  %.036.i.i.i = and i32 %i.ge, %i.fy              ; 2 uses
  %i.gf = zext i32 %.036.i.i.i to i64             ; 2 uses
  %i.gg = getelementptr inbounds nuw [8 x i8], ptr %i.ft, i64 %i.gf
  %.sroa.05.0.copyload.i.i.i = load i32, ptr %i.gg, align 4, !tbaa !3 ; 2 uses
  %i.gh = icmp eq i32 %.sroa.03.0.i, %.sroa.05.0.copyload.i.i.i
  br i1 %i.gh, label %_ZN4llvh12DenseMapBaseINS_8DenseMapIN6hermes2vm8SymbolIDEjNS_12DenseMapInfoIS4_EENS_6detail12DenseMapPairIS4_jEEEES4_jS6_S9_E4findERKS4_.exit.loopexit, label %.lr.ph.i.i.i, !prof !139, !llvm.loop !140
...
_ZN4llvh12DenseMapBaseINS_8DenseMapIN6hermes2vm8SymbolIDEjNS_12DenseMapInfoIS4_EENS_6detail12DenseMapPairIS4_jEEEES4_jS6_S9_E15LookupBucketForIS4_EEbRKT_RPS9_.exit.i: ; preds = %.lr.ph.i.i.i, %_ZN6hermes2vm13RuntimeModule34getSymbolIDFromStringIDMayAllocateEj.exit
  %i.gi = zext i32 %i.fv to i64
  %i.gj = getelementptr inbounds nuw [8 x i8], ptr %i.ft, i64 %i.gi
...
_ZN4llvh12DenseMapBaseINS_8DenseMapIN6hermes2vm8SymbolIDEjNS_12DenseMapInfoIS4_EENS_6detail12DenseMapPairIS4_jEEEES4_jS6_S9_E4findERKS4_.exit.loopexit: ; preds = %bb.aa
  %i.gk = getelementptr inbounds nuw [8 x i8], ptr %i.ft, i64 %i.gf
  br label %_ZN4llvh12DenseMapBaseINS_8DenseMapIN6hermes2vm8SymbolIDEjNS_12DenseMapInfoIS4_EENS_6detail12DenseMapPairIS4_jEEEES4_jS6_S9_E4findERKS4_.exit
...
_ZN4llvh12DenseMapBaseINS_8DenseMapIN6hermes2vm8SymbolIDEjNS_12DenseMapInfoIS4_EENS_6detail12DenseMapPairIS4_jEEEES4_jS6_S9_E4findERKS4_.exit: ; preds = %_ZN4llvh12DenseMapBaseINS_8DenseMapIN6hermes2vm8SymbolIDEjNS_12DenseMapInfoIS4_EENS_6detail12DenseMapPairIS4_jEEEES4_jS6_S9_E4findERKS4_.exit.loopexit, %bb.z, %_ZN4llvh12DenseMapBaseINS_8DenseMapIN6hermes2vm8SymbolIDEjNS_12DenseMapInfoIS4_EENS_6detail12DenseMapPairIS4_jEEEES4_jS6_S9_E15LookupBucketForIS4_EEbRKT_RPS9_.exit.i
  %.sink.i.i.ph.pn.i = phi ptr [ %i.gj, %_ZN4llvh12DenseMapBaseINS_8DenseMapIN6hermes2vm8SymbolIDEjNS_12DenseMapInfoIS4_EENS_6detail12DenseMapPairIS4_jEEEES4_jS6_S9_E15LookupBucketForIS4_EEbRKT_RPS9_.exit.i ], [ %i.ga, %bb.z ], [ %i.gk, %_ZN4llvh12DenseMapBaseINS_8DenseMapIN6hermes2vm8SymbolIDEjNS_12DenseMapInfoIS4_EENS_6detail12DenseMapPairIS4_jEEEES4_jS6_S9_E4findERKS4_.exit.loopexit ]
  %i.gl = zext i32 %i.fv to i64
  %i.gm = getelementptr inbounds nuw [8 x i8], ptr %i.ft, i64 %i.gl
  %i.gn = icmp eq ptr %.sink.i.i.ph.pn.i, %i.gm
  %i.go = zext i1 %i.gn to i64
  %spec.select = add i64 %.0102289, %i.go         ; 2 uses
  %i.gp = getelementptr inbounds nuw i8, ptr %.0107288, i64 8 ; 2 uses
  %.not = icmp eq ptr %i.gp, %i.eh
...
._crit_edge298:                                   ; preds = %.lr.ph297.prol.loopexit, %.lr.ph297, %._crit_edge292
  ...
  %i.gq = add i64 %.2104.lcssa, 1                 ; 5 uses
  %i.gr = mul i64 %i.gq, 3                        ; 3 uses
  %i.gs = icmp ugt i64 %i.gr, 4294967295
  br i1 %i.gs, label %_ZN6hermes2vm11TwineChar16C2EPKc.exit157, label %bb.ab
...
.lr.ph297:                                        ; preds = %.lr.ph297.prol.loopexit, %.lr.ph297
  ...
  %.0108294 = phi ptr [ %i.hq, %.lr.ph297 ], [ %.0108294.unr, %.lr.ph297.prol.loopexit ] ; 9 uses
  %i.gt = load i32, ptr %.0108294, align 4, !tbaa !3
  %i.gu = zext i32 %i.gt to i64
  %spec.select117 = call i64 @llvm.umax.i64(i64 %.2104295, i64 %i.gu)
  %i.gv = getelementptr inbounds nuw i8, ptr %.0108294, i64 8
  %i.gw = load i32, ptr %i.gv, align 4, !tbaa !3
  %i.gx = zext i32 %i.gw to i64
  %spec.select117.1 = call i64 @llvm.umax.i64(i64 %spec.select117, i64 %i.gx)
  %i.gy = getelementptr inbounds nuw i8, ptr %.0108294, i64 16
  %i.gz = load i32, ptr %i.gy, align 4, !tbaa !3
  %i.ha = zext i32 %i.gz to i64
  %spec.select117.2 = call i64 @llvm.umax.i64(i64 %spec.select117.1, i64 %i.ha)
  %i.hb = getelementptr inbounds nuw i8, ptr %.0108294, i64 24
  %i.hc = load i32, ptr %i.hb, align 4, !tbaa !3
  %i.hd = zext i32 %i.hc to i64
  %spec.select117.3 = call i64 @llvm.umax.i64(i64 %spec.select117.2, i64 %i.hd)
  %i.he = getelementptr inbounds nuw i8, ptr %.0108294, i64 32
  %i.hf = load i32, ptr %i.he, align 4, !tbaa !3
  %i.hg = zext i32 %i.hf to i64
  %spec.select117.4 = call i64 @llvm.umax.i64(i64 %spec.select117.3, i64 %i.hg)
  %i.hh = getelementptr inbounds nuw i8, ptr %.0108294, i64 40
  %i.hi = load i32, ptr %i.hh, align 4, !tbaa !3
  %i.hj = zext i32 %i.hi to i64
  %spec.select117.5 = call i64 @llvm.umax.i64(i64 %spec.select117.4, i64 %i.hj)
  %i.hk = getelementptr inbounds nuw i8, ptr %.0108294, i64 48
  %i.hl = load i32, ptr %i.hk, align 4, !tbaa !3
  %i.hm = zext i32 %i.hl to i64
  %spec.select117.6 = call i64 @llvm.umax.i64(i64 %spec.select117.5, i64 %i.hm)
  %i.hn = getelementptr inbounds nuw i8, ptr %.0108294, i64 56
  %i.ho = load i32, ptr %i.hn, align 4, !tbaa !3
  %i.hp = zext i32 %i.ho to i64
  %spec.select117.7 = call i64 @llvm.umax.i64(i64 %spec.select117.6, i64 %i.hp) ; 2 uses
  %i.hq = getelementptr inbounds nuw i8, ptr %.0108294, i64 64 ; 2 uses
  %.not113.7 = icmp eq ptr %i.hq, %i.el
...
_ZN6hermes2vm11TwineChar16C2EPKc.exit157:         ; preds = %._crit_edge298
  ...
  store i32 1, ptr %i.hr, align 8, !tbaa !64
  %i.hs = getelementptr inbounds nuw i8, ptr %7, i64 32
  store i64 34, ptr %i.hs, align 8, !tbaa !67
  %i.ht = getelementptr inbounds nuw i8, ptr %7, i64 40
  store i64 0, ptr %i.ht, align 8, !tbaa !68
  store ptr @.str.2, ptr %7, align 8, !tbaa !69
  %i.hu = getelementptr inbounds nuw i8, ptr %7, i64 8
  store i32 3, ptr %i.hu, align 8, !tbaa !70
  %i.hv = call noundef i32 @_ZN6hermes2vm7Runtime15raiseRangeErrorERKNS0_11TwineChar16E(ptr noundef nonnull align 8 dereferenceable(9816) %1, ptr noundef nonnull align 8 dereferenceable(48) %7) #11
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #11
  br label %.thread

bb.ab:                                            ; preds = %._crit_edge298
  %i.hw = load ptr, ptr %5, align 8, !tbaa !60
  %.sroa.0.0.copyload.i.i158 = load i64, ptr %i.hw, align 8, !tbaa !44
  %i.hx = and i64 %.sroa.0.0.copyload.i.i158, 281474976710655
  %i.hy = inttoptr i64 %i.hx to ptr
  %i.hz = getelementptr inbounds nuw i8, ptr %i.hy, i64 4
  %i.ia = load atomic i32, ptr %i.hz monotonic, align 4
  %i.ib = zext i32 %i.ia to i64
  %i.ic = icmp samesign ugt i64 %i.gr, %i.ib
  br i1 %i.ic, label %bb.ac, label %.loopexit

bb.ac:                                            ; preds = %bb.ab
  %i.id = trunc nuw i64 %i.gr to i32
  %i.ie = call noundef i32 @_ZN6hermes2vm16ArrayStorageBaseINS0_11HermesValueEE5shiftERNS0_13MutableHandleIS3_EERNS0_7RuntimeEjjj(ptr noundef nonnull align 8 dereferenceable(8) %5, ptr noundef nonnull align 8 dereferenceable(9816) %1, i32 noundef 0, i32 noundef 0, i32 noundef %i.id) #11
  %i.if = icmp eq i32 %i.ie, 0
  br i1 %i.if, label %.thread, label %bb.ad, !prof !71

bb.ad:                                            ; preds = %bb.ac
  %.sroa.0.0.copyload.i.i159 = load i64, ptr %0, align 8, !tbaa !44
  %i.ig = and i64 %.sroa.0.0.copyload.i.i159, 281474976710655
  %i.ih = inttoptr i64 %i.ig to ptr               ; 4 uses
  %i.ii = getelementptr inbounds nuw i8, ptr %i.ih, i64 8 ; 2 uses
  %i.ij = getelementptr inbounds nuw i8, ptr %i.ih, i64 24 ; 2 uses
  %i.ik = load i64, ptr %i.ij, align 8, !tbaa !19
  %i.il = icmp ugt i64 %i.gq, %i.ik
  br i1 %i.il, label %bb.ae, label %_ZN6hermes2vm14CopyableVectorIPNS0_13RuntimeModuleEE7reserveEm.exit169

bb.ae:                                            ; preds = %bb.ad
  %mul.ov.i.i.i160 = icmp ugt i64 %i.gq, 2305843009213693951
...
_ZN6hermes14checkedMalloc2Emm.exit.i.i161:        ; preds = %bb.ae
  ...
  %i.iq = getelementptr inbounds nuw i8, ptr %i.in, i64 %.idx.i.i163
  %.not.i.i164 = icmp eq i64 %i.ip, 0
...
vector.ph370:                                     ; preds = %.lr.ph.i.i165.preheader
  %n.vec372 = and i64 %i.iy, 4611686018427387900  ; 3 uses
  %i.ja = shl i64 %n.vec372, 3                    ; 2 uses
  %i.jb = getelementptr i8, ptr %i.im, i64 %i.ja
  %i.jc = getelementptr i8, ptr %i.in, i64 %i.ja
  br label %vector.body373

vector.body373:                                   ; preds = %vector.body373, %vector.ph370
  %index374 = phi i64 [ 0, %vector.ph370 ], [ %index.next379, %vector.body373 ] ; 2 uses
  %i.jd = shl i64 %index374, 3                    ; 2 uses
  %next.gep375 = getelementptr i8, ptr %i.im, i64 %i.jd ; 2 uses
  %next.gep376 = getelementptr i8, ptr %i.in, i64 %i.jd ; 2 uses
  %i.je = getelementptr i8, ptr %next.gep376, i64 16
  %wide.load377 = load <2 x ptr>, ptr %next.gep376, align 8, !tbaa !17
  %wide.load378 = load <2 x ptr>, ptr %i.je, align 8, !tbaa !17
  %i.jf = getelementptr i8, ptr %next.gep375, i64 16
  store <2 x ptr> %wide.load377, ptr %next.gep375, align 8, !tbaa !17
  store <2 x ptr> %wide.load378, ptr %i.jf, align 8, !tbaa !17
  %index.next379 = add nuw i64 %index374, 4       ; 2 uses
  %i.jg = icmp eq i64 %index.next379, %n.vec372
  br i1 %i.jg, label %middle.block380, label %vector.body373, !llvm.loop !141

middle.block380:                                  ; preds = %vector.body373
  %cmp.n381 = icmp eq i64 %i.iy, %n.vec372
  br i1 %cmp.n381, label %_ZN6hermes2vm14CopyableVectorIPNS0_13RuntimeModuleEE11setCapacityEm.exit.i168, label %.lr.ph.i.i165.preheader385

.lr.ph.i.i165.preheader385:                       ; preds = %.lr.ph.i.i165.preheader, %middle.block380
  %.012.i.i166.ph = phi ptr [ %i.im, %.lr.ph.i.i165.preheader ], [ %i.jb, %middle.block380 ]
  %.01011.i.i167.ph = phi ptr [ %i.in, %.lr.ph.i.i165.preheader ], [ %i.jc, %middle.block380 ]
  br label %.lr.ph.i.i165

.lr.ph.i.i165:                                    ; preds = %.lr.ph.i.i165.preheader385, %.lr.ph.i.i165
  %.012.i.i166 = phi ptr [ %i.jj, %.lr.ph.i.i165 ], [ %.012.i.i166.ph, %.lr.ph.i.i165.preheader385 ] ; 2 uses
  %.01011.i.i167 = phi ptr [ %i.ji, %.lr.ph.i.i165 ], [ %.01011.i.i167.ph, %.lr.ph.i.i165.preheader385 ] ; 2 uses
  %i.jh = load ptr, ptr %.01011.i.i167, align 8, !tbaa !17
  store ptr %i.jh, ptr %.012.i.i166, align 8, !tbaa !17
  %i.ji = getelementptr inbounds nuw i8, ptr %.01011.i.i167, i64 8 ; 2 uses
  %i.jj = getelementptr inbounds nuw i8, ptr %.012.i.i166, i64 8
  %i.jk = icmp ult ptr %i.ji, %i.iq
  br i1 %i.jk, label %.lr.ph.i.i165, label %_ZN6hermes2vm14CopyableVectorIPNS0_13RuntimeModuleEE11setCapacityEm.exit.i168, !llvm.loop !142

_ZN6hermes2vm14CopyableVectorIPNS0_13RuntimeModuleEE11setCapacityEm.exit.i168: ; preds = %.lr.ph.i.i165, %middle.block380, %_ZN6hermes14checkedMalloc2Emm.exit.i.i161
  call void @free(ptr noundef %i.in) #11
  store ptr %i.im, ptr %i.ii, align 8, !tbaa !7
  store i64 %i.gq, ptr %i.ij, align 8, !tbaa !19
...
_ZN6hermes2vm14CopyableVectorIPNS0_13RuntimeModuleEE7reserveEm.exit169: ; preds = %bb.ad, %_ZN6hermes2vm14CopyableVectorIPNS0_13RuntimeModuleEE11setCapacityEm.exit.i168
  %.pre-phi334 = phi ptr [ %i.ih, %bb.ad ], [ %.pre333, %_ZN6hermes2vm14CopyableVectorIPNS0_13RuntimeModuleEE11setCapacityEm.exit.i168 ]
  %i.jl = getelementptr inbounds nuw i8, ptr %.pre-phi334, i64 16
  %i.jm = load i64, ptr %i.jl, align 8, !tbaa !13 ; 2 uses
  %.not114300 = icmp ugt i64 %i.jm, %.2104.lcssa
...
.lr.ph302:                                        ; preds = %_ZN6hermes2vm14CopyableVectorIPNS0_13RuntimeModuleEE7reserveEm.exit169
  %i.jn = getelementptr inbounds nuw i8, ptr %1, i64 856
  br label %bb.ag

bb.ag:                                            ; preds = %.lr.ph302, %_ZN6hermes2vm14CopyableVectorIPNS0_13RuntimeModuleEE9push_backEOS3_RNS0_7HadesGCE.exit173
  %.0109301 = phi i64 [ %i.jm, %.lr.ph302 ], [ %i.ka, %_ZN6hermes2vm14CopyableVectorIPNS0_13RuntimeModuleEE9push_backEOS3_RNS0_7HadesGCE.exit173 ]
  %.sroa.0.0.copyload.i.i171 = load i64, ptr %0, align 8, !tbaa !44
  %i.jo = and i64 %.sroa.0.0.copyload.i.i171, 281474976710655
  %i.jp = inttoptr i64 %i.jo to ptr               ; 3 uses
  %i.jq = getelementptr inbounds nuw i8, ptr %i.jp, i64 8 ; 2 uses
  %i.jr = getelementptr inbounds nuw i8, ptr %i.jp, i64 16 ; 3 uses
  %i.js = load i64, ptr %i.jr, align 8, !tbaa !13 ; 2 uses
  %i.jt = getelementptr inbounds nuw i8, ptr %i.jp, i64 24
  %i.ju = load i64, ptr %i.jt, align 8, !tbaa !19
  %i.jv = icmp eq i64 %i.js, %i.ju
  br i1 %i.jv, label %bb.ah, label %_ZN6hermes2vm14CopyableVectorIPNS0_13RuntimeModuleEE9push_backEOS3_RNS0_7HadesGCE.exit173, !prof !71

bb.ah:                                            ; preds = %bb.ag
  call void @_ZN6hermes2vm14CopyableVectorIPNS0_13RuntimeModuleEE4growERNS0_7HadesGCE(ptr noundef nonnull align 8 dereferenceable(24) %i.jq, ptr noundef nonnull align 8 dereferenceable(8112) %i.jn)
  %.pre.i172 = load i64, ptr %i.jr, align 8, !tbaa !13
...
_ZN6hermes2vm14CopyableVectorIPNS0_13RuntimeModuleEE9push_backEOS3_RNS0_7HadesGCE.exit173: ; preds = %bb.ag, %bb.ah
  %i.jw = phi i64 [ %.pre.i172, %bb.ah ], [ %i.js, %bb.ag ] ; 2 uses
  %i.jx = load ptr, ptr %i.jq, align 8, !tbaa !7
  %i.jy = getelementptr inbounds nuw [8 x i8], ptr %i.jx, i64 %i.jw
  store ptr null, ptr %i.jy, align 8, !tbaa !17
  %i.jz = add i64 %i.jw, 1
  store i64 %i.jz, ptr %i.jr, align 8, !tbaa !13
  %i.ka = add i64 %.0109301, 1                    ; 2 uses
  %.not114 = icmp ugt i64 %i.ka, %.2104.lcssa
...
.loopexit:                                        ; preds = %_ZN6hermes2vm14CopyableVectorIPNS0_13RuntimeModuleEE9push_backEOS3_RNS0_7HadesGCE.exit173, %_ZN6hermes2vm14CopyableVectorIPNS0_13RuntimeModuleEE7reserveEm.exit169, %bb.ab
  ...
  %i.kb = and i64 %.sroa.0.0.copyload.i.i174, 281474976710655
  %i.kc = inttoptr i64 %i.kb to ptr               ; 4 uses
  %i.kd = getelementptr inbounds nuw i8, ptr %i.kc, i64 84 ; 2 uses
  %i.ke = getelementptr inbounds nuw i8, ptr %i.kc, i64 8 ; 2 uses
  %i.kf = load ptr, ptr %i.b, align 8, !tbaa !39  ; 3 uses
  %i.kg = getelementptr inbounds nuw i8, ptr %i.kf, i64 192
  %.sroa.0.0.copyload.i176 = load ptr, ptr %i.kg, align 8, !tbaa !88 ; 2 uses
  %.sroa.2.0..sroa_idx.i177 = getelementptr inbounds nuw i8, ptr %i.kf, i64 200
  ...
  %i.kh = getelementptr inbounds nuw i8, ptr %.sroa.0.0.copyload.i176, i64 %.idx314
  %.not115303 = icmp eq i64 %.sroa.2.0.copyload.i178, 0
  br i1 %.not115303, label %._crit_edge307, label %.lr.ph306

.lr.ph306:                                        ; preds = %.loopexit
  %i.ki = getelementptr inbounds nuw i8, ptr %2, i64 24
  %i.kj = getelementptr inbounds nuw i8, ptr %9, i64 16
  %i.kk = getelementptr inbounds nuw i8, ptr %i.kc, i64 88 ; 2 uses
  %i.kl = getelementptr inbounds nuw i8, ptr %1, i64 1632 ; 3 uses
  %i.km = getelementptr inbounds nuw i8, ptr %1, i64 856 ; 3 uses
  br label %bb.ai
...
._crit_edge307:                                   ; preds = %._crit_edge307.loopexit, %.loopexit
  %i.kn = phi ptr [ %.pre320, %._crit_edge307.loopexit ], [ %i.kf, %.loopexit ] ; 2 uses
  %i.ko = getelementptr inbounds nuw i8, ptr %i.kn, i64 208
  %.sroa.0.0.copyload.i181 = load ptr, ptr %i.ko, align 8, !tbaa !88 ; 2 uses
  %.sroa.2.0..sroa_idx.i182 = getelementptr inbounds nuw i8, ptr %i.kn, i64 216
  ...
  %i.kp = getelementptr inbounds nuw i8, ptr %.sroa.0.0.copyload.i181, i64 %.idx315
...
.lr.ph311:                                        ; preds = %._crit_edge307
  %i.kq = getelementptr inbounds nuw i8, ptr %i.kc, i64 88 ; 2 uses
  %i.kr = getelementptr inbounds nuw i8, ptr %1, i64 1632 ; 3 uses
  %i.ks = getelementptr inbounds nuw i8, ptr %1, i64 856 ; 3 uses
  br label %bb.au

bb.ai:                                            ; preds = %.lr.ph306, %bb.as
  %.0110304 = phi ptr [ %.sroa.0.0.copyload.i176, %.lr.ph306 ], [ %i.nv, %bb.as ] ; 3 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %8) #11
  %i.kt = load i32, ptr %.0110304, align 4, !tbaa !92 ; 2 uses
  %i.ku = zext i32 %i.kt to i64                   ; 2 uses
  %i.kv = load ptr, ptr %i.ki, align 8, !tbaa !94
  %i.kw = getelementptr inbounds nuw [4 x i8], ptr %i.kv, i64 %i.ku
  %i.kx = load i32, ptr %i.kw, align 4, !tbaa !3  ; 2 uses
  %i.ky = icmp ult i32 %i.kx, 536870910
  br i1 %i.ky, label %_ZN6hermes2vm13RuntimeModule34getSymbolIDFromStringIDMayAllocateEj.exit198, label %bb.aj, !prof !59

bb.aj:                                            ; preds = %bb.ai
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #11
  %i.kz = load ptr, ptr %i.b, align 8, !tbaa !39  ; 2 uses
  %i.la = getelementptr inbounds nuw i8, ptr %i.kz, i64 304
  %i.lb = load ptr, ptr %i.la, align 8, !tbaa !97
  %i.lc = getelementptr inbounds nuw [4 x i8], ptr %i.lb, i64 %i.ku
  %i.ld = load i32, ptr %i.lc, align 1            ; 5 uses
  %i.le = icmp ugt i32 %i.ld, -16777217
  br i1 %i.le, label %bb.ak, label %bb.al, !prof !71

bb.ak:                                            ; preds = %bb.aj
  %i.lf = getelementptr inbounds nuw i8, ptr %i.kz, i64 312
  %i.lg = lshr i32 %i.ld, 1
  %i.lh = and i32 %i.lg, 8388607
  %i.li = zext nneg i32 %i.lh to i64
  %i.lj = load ptr, ptr %i.lf, align 8, !tbaa !137
  %i.lk = getelementptr inbounds nuw [8 x i8], ptr %i.lj, i64 %i.li ; 2 uses
  %.sroa.0.0.copyload.i.i195 = load i32, ptr %i.lk, align 1, !tbaa !3
  %.sroa.4.0..sroa_idx.i.i196 = getelementptr inbounds nuw i8, ptr %i.lk, i64 4
...
bb.al:                                            ; preds = %bb.aj
  %i.ll = lshr i32 %i.ld, 1
  %i.lm = and i32 %i.ll, 8388607
  %i.ln = lshr i32 %i.ld, 24
  br label %_ZNK6hermes3hbc20BCProviderFromBuffer19getStringTableEntryEj.exit.i186

_ZNK6hermes3hbc20BCProviderFromBuffer19getStringTableEntryEj.exit.i186: ; preds = %bb.al, %bb.ak
  %.sink.i.i187 = phi i32 [ %i.ln, %bb.al ], [ %.sroa.4.0.copyload.i.i197, %bb.ak ]
  %.sroa.0.0.i.i188 = phi i32 [ %i.lm, %bb.al ], [ %.sroa.0.0.copyload.i.i195, %bb.ak ]
  %i.lo = shl i32 %i.ld, 31
  %spec.select.i7.i.i189 = or i32 %.sink.i.i187, %i.lo
  ...
  %i.lp = call i32 @_ZN6hermes2vm13RuntimeModule35createSymbolFromStringIDMayAllocateEjRKNS_16StringTableEntryENS_8OptValueIjEE(ptr noundef nonnull align 8 dereferenceable(192) %2, i32 noundef %i.kt, ptr noundef nonnull align 4 dereferenceable(8) %3, i64 0) #11
...
_ZN6hermes2vm13RuntimeModule34getSymbolIDFromStringIDMayAllocateEj.exit198: ; preds = %bb.ai, %_ZNK6hermes3hbc20BCProviderFromBuffer19getStringTableEntryEj.exit.i186
  %.sroa.03.0.i194 = phi i32 [ %i.kx, %bb.ai ], [ %i.lp, %_ZNK6hermes3hbc20BCProviderFromBuffer19getStringTableEntryEj.exit.i186 ]
  store i32 %.sroa.03.0.i194, ptr %8, align 4
  call void @llvm.lifetime.start.p0(ptr nonnull %9) #11
  %.sroa.0.0.copyload.i.i199 = load i64, ptr %0, align 8, !tbaa !44
  %i.lq = and i64 %.sroa.0.0.copyload.i.i199, 281474976710655
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load7 = load <2 x ptr>, ptr %i.ac, align 8, !tbaa !17
  %i.ad = getelementptr i8, ptr %next.gep, i64 16
  store <2 x ptr> %wide.load, ptr %next.gep, align 8, !tbaa !17
  store <2 x ptr> %wide.load7, ptr %i.ad, align 8, !tbaa !17
  %index.next = add nuw i64 %index, 4             ; 2 uses
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader10, %.lr.ph.i
  ...
  %i.af = load ptr, ptr %.01011.i, align 8, !tbaa !17
  store ptr %i.af, ptr %.012.i, align 8, !tbaa !17
  ...
  br i1 %i.ai, label %.lr.ph.i, label %_ZN6hermes2vm14CopyableVectorIPNS0_13RuntimeModuleEE11setCapacityEm.exit, !llvm.loop !167
