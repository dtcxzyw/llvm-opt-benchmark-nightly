...
_ZNSt12_Vector_baseISt6vectorIN7testing8internal13edit_distance8EditTypeESaIS4_EESaIS6_EEC2EmRKS7_.exit.i: ; preds = %_ZNSt15__new_allocatorISt6vectorIN7testing8internal13edit_distance8EditTypeESaIS4_EEE8allocateEmPKv.exit.i.i.i.i, %_ZNSt6vectorIS_IN7testing8internal13edit_distance8EditTypeESaIS3_EESaIS5_EE17_S_check_init_lenEmRKS6_.exit.i
  %.pre174.a = phi ptr [ null, %_ZNSt6vectorIS_IN7testing8internal13edit_distance8EditTypeESaIS3_EESaIS5_EE17_S_check_init_lenEmRKS6_.exit.i ], [ %i.bn, %_ZNSt15__new_allocatorISt6vectorIN7testing8internal13edit_distance8EditTypeESaIS4_EEE8allocateEmPKv.exit.i.i.i.i ] ; 12 uses
  store ptr %.pre174.a, ptr %5, align 8, !tbaa !311
  %i.bo = getelementptr inbounds nuw i8, ptr %5, i64 8 ; 2 uses
  %i.bp = getelementptr inbounds nuw [24 x i8], ptr %.pre174.a, i64 %i.bk
  %i.bq = getelementptr inbounds nuw i8, ptr %5, i64 16 ; 2 uses
  store ptr %i.bp, ptr %i.bq, align 8, !tbaa !314
  %i.br = invoke noundef ptr @_ZSt18__do_uninit_fill_nIPSt6vectorIN7testing8internal13edit_distance8EditTypeESaIS4_EEmS6_ET_S8_T0_RKT1_(ptr noundef %.pre174.a, i64 noundef %i.bk, ptr noundef nonnull align 8 dereferenceable(24) %6)
...
bb.n:                                             ; preds = %_ZNSt12_Vector_baseISt6vectorIN7testing8internal13edit_distance8EditTypeESaIS4_EESaIS6_EEC2EmRKS7_.exit.i
  %i.bs = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %.not.i.i.i102 = icmp eq ptr %.pre174.a, null
  br i1 %.not.i.i.i102, label %.body105, label %bb.o

bb.o:                                             ; preds = %bb.n
  %.idx202 = mul nuw nsw i64 %i.bk, 24
  call void @_ZdlPvm(ptr noundef nonnull %.pre174.a, i64 noundef %.idx202) #54
  br label %.body105
...
.epil.preheader:                                  ; preds = %.preheader133.loopexit.unr-lcssa, %.lr.ph
  ...
  %lcmp.mod231 = trunc i64 %i.cc to i1
  ...
  %i.ch = getelementptr inbounds nuw [24 x i8], ptr %.pre174.a, i64 %.077141.epil.init
...
.lr.ph143:                                        ; preds = %.preheader133
  %i.cr = load ptr, ptr %.pre174.a, align 8, !tbaa !305 ; 2 uses
...
bb.x:                                             ; preds = %bb.x, %.lr.ph.new
  ...
  %i.ds = getelementptr inbounds nuw [24 x i8], ptr %.pre174.a, i64 %.077141
  ...
  %i.dy = getelementptr inbounds nuw [24 x i8], ptr %.pre174.a, i64 %i.du
...
.preheader132:                                    ; preds = %.preheader.us, %middle.block, %.preheader133
  ...
  %.not156 = icmp eq ptr %i.eb, %i.ec
  %.pre = load ptr, ptr %i.h, align 8, !tbaa !289 ; 4 uses
  %.pre172 = load ptr, ptr %2, align 8, !tbaa !292 ; 5 uses
  %.not157 = icmp eq ptr %.pre, %.pre172
  %or.cond.a = select i1 %.not156, i1 true, i1 %.not157
  br i1 %or.cond.a, label %bb.z, label %.preheader.us.preheader

.preheader.us.preheader:                          ; preds = %.preheader132
  %i.eh = ptrtoint ptr %.pre to i64
  %i.ei = ptrtoint ptr %.pre172 to i64
  %i.ej = sub i64 %i.eh, %i.ei
  %i.ek = ashr exact i64 %i.ej, 3
  br label %bb.y

.preheader.us:                                    ; preds = %scalar.ph.preheader, %.preheader.us
  %.079146.us = phi i64 [ %10, %.preheader.us ], [ %.078142.ph, %scalar.ph.preheader ] ; 4 uses
  %7 = uitofp i64 %.079146.us to double
  %8 = getelementptr inbounds nuw [8 x i8], ptr %i.cl, i64 %.079146.us
  store double %7, ptr %8, align 8, !tbaa !297
  %9 = getelementptr inbounds nuw [4 x i8], ptr %i.cr, i64 %.079146.us
  store i32 1, ptr %9, align 4, !tbaa !308
  %10 = add nuw i64 %.079146.us, 1                ; 2 uses
  %exitcond168.not = icmp eq i64 %10, %i.cp
  br i1 %exitcond168.not, label %.preheader132, label %.preheader.us, !llvm.loop !320

bb.y:                                             ; preds = %.preheader.us.preheader, %bb.ab
  %.080144.us = phi i64 [ %11, %bb.ab ], [ 0, %.preheader.us.preheader ] ; 3 uses
  %i.el = getelementptr inbounds nuw [8 x i8], ptr %i.ec, i64 %.080144.us
  %i.em = load i64, ptr %i.el, align 8, !tbaa !15
  %11 = add nuw i64 %.080144.us, 1                ; 4 uses
  %12 = getelementptr inbounds nuw [24 x i8], ptr %i.ac, i64 %11 ; 2 uses
  %13 = getelementptr inbounds nuw [24 x i8], ptr %i.ac, i64 %.080144.us ; 2 uses
  %14 = getelementptr inbounds nuw [24 x i8], ptr %.pre174.a, i64 %11
  %15 = load ptr, ptr %14, align 8, !tbaa !305
  br label %bb.ac

bb.z:                                             ; preds = %bb.ab, %.preheader132
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %0, i8 0, i64 24, i1 false)
  %16 = icmp ne ptr %i.eb, %i.ec
  %17 = icmp ne ptr %.pre, %.pre172
  %or.cond.us = select i1 %16, i1 true, i1 %17
  br i1 %or.cond.us, label %bb.aa, label %_ZSt7reverseIN9__gnu_cxx17__normal_iteratorIPN7testing8internal13edit_distance8EditTypeESt6vectorIS5_SaIS5_EEEEEvT_SB_.exit

bb.aa:                                            ; preds = %bb.z
  %18 = ptrtoint ptr %.pre172 to i64
...
bb.ab:                                            ; preds = %.lr.ph154
  %exitcond172.not = icmp eq i64 %11, %i.eg
  br i1 %exitcond172.not, label %bb.z, label %bb.y, !llvm.loop !321

bb.ac:                                            ; preds = %bb.y, %.lr.ph154
  %.080144 = phi i64 [ 0, %bb.y ], [ %27, %.lr.ph154 ] ; 5 uses
  %24 = getelementptr inbounds nuw [8 x i8], ptr %.pre172, i64 %.080144
  %25 = load i64, ptr %24, align 8, !tbaa !15
  %26 = icmp eq i64 %i.em, %25
  %27 = add nuw i64 %.080144, 1                   ; 7 uses
  br i1 %26, label %bb.ad, label %bb.ae
...
bb.ad:                                            ; preds = %bb.ac
  ...
  %i.en = getelementptr inbounds nuw [8 x i8], ptr %31, i64 %27
  store double %30, ptr %i.en, align 8, !tbaa !297
  br label %.lr.ph154

bb.ae:                                            ; preds = %bb.ac
  %i.eo = load ptr, ptr %12, align 8, !tbaa !293  ; 3 uses
  %i.ep = getelementptr inbounds nuw [8 x i8], ptr %i.eo, i64 %.080144
  %i.eq = load double, ptr %i.ep, align 8, !tbaa !297 ; 4 uses
  %i.er = load ptr, ptr %13, align 8, !tbaa !293  ; 2 uses
  %32 = getelementptr inbounds nuw [8 x i8], ptr %i.er, i64 %27
  %33 = load double, ptr %32, align 8, !tbaa !297 ; 4 uses
  %i.es = getelementptr inbounds nuw [8 x i8], ptr %i.er, i64 %.080144
  %34 = load double, ptr %i.es, align 8, !tbaa !297 ; 3 uses
  %35 = fcmp olt double %i.eq, %33
  %36 = fcmp olt double %i.eq, %34
  %or.cond = select i1 %35, i1 %36, i1 false
  br i1 %or.cond, label %bb.af, label %._crit_edge.us

bb.af:                                            ; preds = %bb.ae
  %37 = fadd double %i.eq, 1.000000e+00
  %38 = getelementptr inbounds nuw [8 x i8], ptr %i.eo, i64 %27
  store double %37, ptr %38, align 8, !tbaa !297
  br label %.lr.ph154

._crit_edge.us:                                   ; preds = %bb.ae
  %39 = fcmp olt double %33, %i.eq
  %40 = fcmp olt double %33, %34
  %or.cond91 = select i1 %39, i1 %40, i1 false
  %41 = getelementptr inbounds nuw [8 x i8], ptr %i.eo, i64 %27 ; 2 uses
  br i1 %or.cond91, label %scalar.ph, label %._crit_edge147

scalar.ph:                                        ; preds = %._crit_edge.us
...
.lr.ph154:                                        ; preds = %bb.af, %._crit_edge147, %scalar.ph, %bb.ad
  %.sink = phi i32 [ 1, %bb.af ], [ 3, %._crit_edge147 ], [ 2, %scalar.ph ], [ 0, %bb.ad ]
  ...
  br i1 %exitcond170.not, label %bb.ab, label %bb.ac, !llvm.loop !322
...
._crit_edge:                                      ; preds = %_ZNSt6vectorIN7testing8internal13edit_distance8EditTypeESaIS3_EE9push_backERKS3_.exit
  ...
  %i.et = icmp ne ptr %i.gb, %i.fz
  %.sroa.0.08.i.i = getelementptr inbounds i8, ptr %i.fz, i64 -4 ; 2 uses
  %i.eu = icmp ult ptr %i.gb, %.sroa.0.08.i.i
  %or.cond.i.i = select i1 %i.et, i1 %i.eu, i1 false
...
.lr.ph.i.i:                                       ; preds = %._crit_edge, %.lr.ph.i.i
  ...
  %.sroa.05.09.i.i = phi ptr [ %i.ex, %.lr.ph.i.i ], [ %i.gb, %._crit_edge ] ; 3 uses
  %i.ev = load i32, ptr %.sroa.05.09.i.i, align 4, !tbaa !308
  %i.ew = load i32, ptr %.sroa.0.010.i.i, align 4, !tbaa !308
  store i32 %i.ew, ptr %.sroa.05.09.i.i, align 4, !tbaa !308
  store i32 %i.ev, ptr %.sroa.0.010.i.i, align 4, !tbaa !308
  %i.ex = getelementptr inbounds nuw i8, ptr %.sroa.05.09.i.i, i64 4 ; 2 uses
  %.sroa.0.0.i.i = getelementptr inbounds i8, ptr %.sroa.0.010.i.i, i64 -4 ; 2 uses
  %i.ey = icmp ult ptr %i.ex, %.sroa.0.0.i.i
  br i1 %i.ey, label %.lr.ph.i.i, label %_ZSt7reverseIN9__gnu_cxx17__normal_iteratorIPN7testing8internal13edit_distance8EditTypeESt6vectorIS5_SaIS5_EEEEEvT_SB_.exit, !llvm.loop !323

bb.ag:                                            ; preds = %bb.aa, %_ZNSt6vectorIN7testing8internal13edit_distance8EditTypeESaIS3_EE9push_backERKS3_.exit
  %i.ez = phi ptr [ null, %bb.aa ], [ %i.fy, %_ZNSt6vectorIN7testing8internal13edit_distance8EditTypeESaIS3_EE9push_backERKS3_.exit ] ; 3 uses
  %i.fa = phi ptr [ null, %bb.aa ], [ %i.fz, %_ZNSt6vectorIN7testing8internal13edit_distance8EditTypeESaIS3_EE9push_backERKS3_.exit ] ; 3 uses
  %i.fb = phi ptr [ %.pre174.a, %bb.aa ], [ %i.ga, %_ZNSt6vectorIN7testing8internal13edit_distance8EditTypeESaIS3_EE9push_backERKS3_.exit ] ; 3 uses
  %.075153 = phi i64 [ %21, %bb.aa ], [ %i.gf, %_ZNSt6vectorIN7testing8internal13edit_distance8EditTypeESaIS3_EE9push_backERKS3_.exit ] ; 2 uses
  %.076152 = phi i64 [ %i.eg, %bb.aa ], [ %i.gd, %_ZNSt6vectorIN7testing8internal13edit_distance8EditTypeESaIS3_EE9push_backERKS3_.exit ] ; 2 uses
  %i.fc = phi ptr [ null, %bb.aa ], [ %i.gb, %_ZNSt6vectorIN7testing8internal13edit_distance8EditTypeESaIS3_EE9push_backERKS3_.exit ] ; 9 uses
  %i.fd = getelementptr inbounds nuw [24 x i8], ptr %i.fb, i64 %.076152
  %i.fe = load ptr, ptr %i.fd, align 8, !tbaa !305
  %i.ff = getelementptr inbounds nuw [4 x i8], ptr %i.fe, i64 %.075153
  %i.fg = load i32, ptr %i.ff, align 4, !tbaa !308 ; 4 uses
  %.not.i = icmp eq ptr %i.fa, %i.ez
  br i1 %.not.i, label %bb.ai, label %bb.ah

bb.ah:                                            ; preds = %bb.ag
  store i32 %i.fg, ptr %i.fa, align 4, !tbaa !308
  %i.fh = getelementptr inbounds nuw i8, ptr %i.fa, i64 4 ; 2 uses
  store ptr %i.fh, ptr %22, align 8, !tbaa !310
...
bb.ai:                                            ; preds = %bb.ag
  ...
  %i.fk = sub i64 %i.fi, %i.fj                    ; 7 uses
  %i.fl = icmp eq i64 %i.fk, 9223372036854775804
  br i1 %i.fl, label %bb.aj, label %_ZNKSt6vectorIN7testing8internal13edit_distance8EditTypeESaIS3_EE12_M_check_lenEmPKc.exit.i.i

bb.aj:                                            ; preds = %bb.ai
  store ptr %i.fc, ptr %0, align 8
...
_ZNKSt6vectorIN7testing8internal13edit_distance8EditTypeESaIS3_EE12_M_check_lenEmPKc.exit.i.i: ; preds = %bb.ai
  ...
  %.sroa.speculated.i.i.i = call i64 @llvm.umax.i64(i64 %i.fm, i64 1)
  %i.fn = add nsw i64 %.sroa.speculated.i.i.i, %i.fm ; 2 uses
  ...
  %.not.i.i.i112 = icmp ne i64 %i.fq, 0
  call void @llvm.assume(i1 %.not.i.i.i112)
  %i.fr = shl nuw nsw i64 %i.fq, 2
  %i.fs = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.fr) #57
...
.noexc114:                                        ; preds = %_ZNKSt6vectorIN7testing8internal13edit_distance8EditTypeESaIS3_EE12_M_check_lenEmPKc.exit.i.i
  ...
  store i32 %i.fg, ptr %i.ft, align 4, !tbaa !308
  %i.fu = icmp sgt i64 %i.fk, 0
  br i1 %i.fu, label %bb.ak, label %_ZNSt6vectorIN7testing8internal13edit_distance8EditTypeESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit16.i.i

bb.ak:                                            ; preds = %.noexc114
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 4 %i.fs, ptr align 4 %i.fc, i64 %i.fk, i1 false)
...
bb.al:                                            ; preds = %_ZNSt6vectorIN7testing8internal13edit_distance8EditTypeESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit16.i.i
  call void @_ZdlPvm(ptr noundef nonnull %i.fc, i64 noundef %i.fk) #54
...
_ZNSt6vectorIN7testing8internal13edit_distance8EditTypeESaIS3_EE17_M_realloc_insertIJRKS3_EEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i: ; preds = %bb.al, %_ZNSt6vectorIN7testing8internal13edit_distance8EditTypeESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit16.i.i
  %i.fw = phi ptr [ %.pre173, %bb.al ], [ %i.fb, %_ZNSt6vectorIN7testing8internal13edit_distance8EditTypeESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit16.i.i ]
  store ptr %i.fv, ptr %22, align 8, !tbaa !310
  %i.fx = getelementptr inbounds nuw [4 x i8], ptr %i.fs, i64 %i.fq ; 2 uses
  store ptr %i.fx, ptr %23, align 8, !tbaa !307
  br label %_ZNSt6vectorIN7testing8internal13edit_distance8EditTypeESaIS3_EE9push_backERKS3_.exit
...
_ZNSt6vectorIN7testing8internal13edit_distance8EditTypeESaIS3_EE9push_backERKS3_.exit: ; preds = %_ZNSt6vectorIN7testing8internal13edit_distance8EditTypeESaIS3_EE17_M_realloc_insertIJRKS3_EEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i, %bb.ah
  %i.fy = phi ptr [ %i.fx, %_ZNSt6vectorIN7testing8internal13edit_distance8EditTypeESaIS3_EE17_M_realloc_insertIJRKS3_EEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i ], [ %i.ez, %bb.ah ]
  %i.fz = phi ptr [ %i.fv, %_ZNSt6vectorIN7testing8internal13edit_distance8EditTypeESaIS3_EE17_M_realloc_insertIJRKS3_EEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i ], [ %i.fh, %bb.ah ] ; 3 uses
  %i.ga = phi ptr [ %i.fw, %_ZNSt6vectorIN7testing8internal13edit_distance8EditTypeESaIS3_EE17_M_realloc_insertIJRKS3_EEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i ], [ %i.fb, %bb.ah ] ; 3 uses
  %i.gb = phi ptr [ %i.fs, %_ZNSt6vectorIN7testing8internal13edit_distance8EditTypeESaIS3_EE17_M_realloc_insertIJRKS3_EEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i ], [ %i.fc, %bb.ah ] ; 5 uses
  %i.gc = icmp ne i32 %i.fg, 1
  %.neg = sext i1 %i.gc to i64
  %i.gd = add i64 %.076152, %.neg                 ; 2 uses
  %i.ge = icmp ne i32 %i.fg, 2
  %.neg90 = sext i1 %i.ge to i64
  %i.gf = add i64 %.075153, %.neg90               ; 2 uses
  %i.gg = icmp ne i64 %i.gd, 0
  %i.gh = icmp ne i64 %i.gf, 0
  %i.gi = select i1 %i.gg, i1 true, i1 %i.gh
  br i1 %i.gi, label %bb.ag, label %._crit_edge, !llvm.loop !324
...
bb.am:                                            ; preds = %.loopexit.split-lp, %.loopexit
  ...
  %.not.i.i.i125 = icmp eq ptr %i.fc, null
  br i1 %.not.i.i.i125, label %_ZNSt6vectorIN7testing8internal13edit_distance8EditTypeESaIS3_EED2Ev.exit126, label %bb.ar

_ZSt7reverseIN9__gnu_cxx17__normal_iteratorIPN7testing8internal13edit_distance8EditTypeESt6vectorIS5_SaIS5_EEEEEvT_SB_.exit: ; preds = %.lr.ph.i.i, %bb.z, %._crit_edge
  %.pr.i207 = phi ptr [ %.pre174.a, %bb.z ], [ %i.ga, %._crit_edge ], [ %i.ga, %.lr.ph.i.i ] ; 5 uses
  %i.gj = load ptr, ptr %i.bo, align 8, !tbaa !315 ; 2 uses
  %.not4.i.i.i = icmp eq ptr %.pr.i207, %i.gj
...
.lr.ph.i.i.i:                                     ; preds = %_ZSt7reverseIN9__gnu_cxx17__normal_iteratorIPN7testing8internal13edit_distance8EditTypeESt6vectorIS5_SaIS5_EEEEEvT_SB_.exit, %_ZSt8_DestroyISt6vectorIN7testing8internal13edit_distance8EditTypeESaIS4_EEEvPT_.exit.i.i.i
  %.05.i.i.i = phi ptr [ %i.gq, %_ZSt8_DestroyISt6vectorIN7testing8internal13edit_distance8EditTypeESaIS4_EEEvPT_.exit.i.i.i ], [ %.pr.i207, %_ZSt7reverseIN9__gnu_cxx17__normal_iteratorIPN7testing8internal13edit_distance8EditTypeESt6vectorIS5_SaIS5_EEEEEvT_SB_.exit ] ; 3 uses
  %i.gk = load ptr, ptr %.05.i.i.i, align 8, !tbaa !305 ; 3 uses
  %.not.i.i.i.i.i.i.i = icmp eq ptr %i.gk, null
...
_ZSt8_DestroyISt6vectorIN7testing8internal13edit_distance8EditTypeESaIS4_EEEvPT_.exit.i.i.i: ; preds = %bb.an, %.lr.ph.i.i.i
  %i.gq = getelementptr inbounds nuw i8, ptr %.05.i.i.i, i64 24 ; 2 uses
  %.not.i.i.i115 = icmp eq ptr %i.gq, %i.gj
...
bb.ao:                                            ; preds = %_ZSt8_DestroyIPSt6vectorIN7testing8internal13edit_distance8EditTypeESaIS4_EES6_EvT_S8_RSaIT0_E.exit.i
  %i.gr = load ptr, ptr %i.bq, align 8, !tbaa !314
  %i.gs = ptrtoint ptr %i.gr to i64
  %i.gt = ptrtoint ptr %.pr.i207 to i64
  %i.gu = sub i64 %i.gs, %i.gt
  call void @_ZdlPvm(ptr noundef nonnull %.pr.i207, i64 noundef %i.gu) #54
...
_ZNSt6vectorIS_IN7testing8internal13edit_distance8EditTypeESaIS3_EESaIS5_EED2Ev.exit: ; preds = %_ZSt8_DestroyIPSt6vectorIN7testing8internal13edit_distance8EditTypeESaIS4_EES6_EvT_S8_RSaIT0_E.exit.i, %bb.ao
  ...
  %i.gv = load ptr, ptr %3, align 8, !tbaa !300   ; 5 uses
  %i.gw = load ptr, ptr %i.ad, align 8, !tbaa !304 ; 2 uses
  %.not4.i.i.i117 = icmp eq ptr %i.gv, %i.gw
...
.lr.ph.i.i.i118:                                  ; preds = %_ZNSt6vectorIS_IN7testing8internal13edit_distance8EditTypeESaIS3_EESaIS5_EED2Ev.exit, %_ZSt8_DestroyISt6vectorIdSaIdEEEvPT_.exit.i.i.i
  %.05.i.i.i119 = phi ptr [ %i.hd, %_ZSt8_DestroyISt6vectorIdSaIdEEEvPT_.exit.i.i.i ], [ %i.gv, %_ZNSt6vectorIS_IN7testing8internal13edit_distance8EditTypeESaIS3_EESaIS5_EED2Ev.exit ] ; 3 uses
  %i.gx = load ptr, ptr %.05.i.i.i119, align 8, !tbaa !293 ; 3 uses
  %.not.i.i.i.i.i.i.i120 = icmp eq ptr %i.gx, null
  br i1 %.not.i.i.i.i.i.i.i120, label %_ZSt8_DestroyISt6vectorIdSaIdEEEvPT_.exit.i.i.i, label %bb.ap

bb.ap:                                            ; preds = %.lr.ph.i.i.i118
  %i.gy = getelementptr inbounds nuw i8, ptr %.05.i.i.i119, i64 16
  %i.gz = load ptr, ptr %i.gy, align 8, !tbaa !296
  %i.ha = ptrtoint ptr %i.gz to i64
  %i.hb = ptrtoint ptr %i.gx to i64
  %i.hc = sub i64 %i.ha, %i.hb
  call void @_ZdlPvm(ptr noundef nonnull %i.gx, i64 noundef %i.hc) #54
  br label %_ZSt8_DestroyISt6vectorIdSaIdEEEvPT_.exit.i.i.i

_ZSt8_DestroyISt6vectorIdSaIdEEEvPT_.exit.i.i.i:  ; preds = %bb.ap, %.lr.ph.i.i.i118
  %i.hd = getelementptr inbounds nuw i8, ptr %.05.i.i.i119, i64 24 ; 2 uses
  %.not.i.i.i121 = icmp eq ptr %i.hd, %i.gw
...
_ZSt8_DestroyIPSt6vectorIdSaIdEES2_EvT_S4_RSaIT0_E.exit.i: ; preds = %_ZSt8_DestroyISt6vectorIdSaIdEEEvPT_.exit.i.i.i, %_ZNSt6vectorIS_IN7testing8internal13edit_distance8EditTypeESaIS3_EESaIS5_EED2Ev.exit
  %.not.i.i1.i123 = icmp eq ptr %i.gv, null
...
bb.aq:                                            ; preds = %_ZSt8_DestroyIPSt6vectorIdSaIdEES2_EvT_S4_RSaIT0_E.exit.i
  %i.he = load ptr, ptr %i.af, align 8, !tbaa !303
  %i.hf = ptrtoint ptr %i.he to i64
  %i.hg = ptrtoint ptr %i.gv to i64
  %i.hh = sub i64 %i.hf, %i.hg
  call void @_ZdlPvm(ptr noundef nonnull %i.gv, i64 noundef %i.hh) #54
