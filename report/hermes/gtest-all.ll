...
bb.ep:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit521
  %116 = getelementptr inbounds nuw i8, ptr %105, i64 16 ; 2 uses
  %i.afl = getelementptr inbounds nuw i8, ptr %105, i64 8 ; 6 uses
  store ptr null, ptr %i.afk, align 8, !tbaa !392
  %i.afm = getelementptr inbounds nuw i8, ptr %i.afk, i64 8 ; 2 uses
  store ptr %i.afk, ptr %105, align 8, !tbaa !1371
  store ptr %i.afm, ptr %i.afl, align 8, !tbaa !1374
  store ptr %i.afm, ptr %116, align 8, !tbaa !1375
  call void @llvm.lifetime.start.p0(ptr nonnull %106) #55
...
.lr.ph.i:                                         ; preds = %bb.eu, %.noexc531
  ...
  %i.agc = load ptr, ptr %i.afl, align 8, !tbaa !1382
...
_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EED2Ev.exit: ; preds = %_ZSt8_DestroyIPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES5_EvT_S7_RSaIT0_E.exit.i, %bb.ev
  call void @llvm.lifetime.end.p0(ptr nonnull %106) #55
  %i.ago = load ptr, ptr %84, align 8, !tbaa !7
  %i.agp = load ptr, ptr %i.afl, align 8, !tbaa !1382
  %i.agq = getelementptr inbounds i8, ptr %i.agp, i64 -8
  call void @llvm.lifetime.start.p0(ptr nonnull %i.k) #55
  %i.agr = call noalias noundef ptr @strdup(ptr noundef %i.ago) #55
end_hunk_2
...
bb.ew:                                            ; preds = %_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EED2Ev.exit
  ...
  %i.agu = load ptr, ptr %i.afl, align 8, !tbaa !1382
  %i.agv = getelementptr inbounds i8, ptr %i.agu, i64 -8
  call void @llvm.lifetime.start.p0(ptr nonnull %i.j) #55
  %i.agw = call noalias noundef ptr @strdup(ptr noundef %i.agt) #55
end_hunk_3
begin_hunk_4_@_ZN7testing8internal13ExecDeathTest10AssumeRoleEv:bb.a
  ...
  %i.cjx = load ptr, ptr %i.afl, align 8, !tbaa !1382
...
bb.qa:                                            ; preds = %._crit_edge.i
  %i.cjz = load ptr, ptr %116, align 8, !tbaa !1375
...
begin_hunk_6_@_ZN7testing8internal13ExecDeathTest10AssumeRoleEv:bb.a
  ...
  call void @free(ptr noundef %i.ckd) #55
  %i.cke = getelementptr inbounds nuw i8, ptr %.sroa.01.05.i, i64 8 ; 2 uses
  %i.ckf = load ptr, ptr %i.afl, align 8, !tbaa !1382
