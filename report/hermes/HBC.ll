...
begin_hunk_1_@_ZN6hermes11StringTable9getStringEN4llvh9StringRefE:bb.a
  ...
  %i.z = add i64 %i.y, 7
  %i.aa = and i64 %i.z, 7
  %5 = sub i64 %i.x, %i.aa                        ; 2 uses
  %6 = add i64 %5, 7                              ; 2 uses
  store i64 %6, ptr %i.w, align 8, !tbaa !902
  %i.ab = add i64 %5, 23                          ; 3 uses
...
_ZN6hermes28BacktrackingBumpPtrAllocator8AllocateINS_12UniqueStringEEEPT_mm.exit: ; preds = %.critedge.i.i, %bb.d
  ...
  %i.ag = phi i64 [ %.pre21.a, %.critedge.i.i ], [ %i.ab, %bb.d ] ; 2 uses
...
begin_hunk_3_@_ZN6hermes11StringTable9getStringEN4llvh9StringRefE:bb.a
  ...
  %i.al = add i64 %i.ag, %.pre-phi23
  %i.am = add i64 %i.al, 7
  %i.an = and i64 %i.am, 7
  %i.ao = sub i64 %i.ag, %i.an
  %7 = add i64 %i.ao, 7                           ; 3 uses
  store i64 %7, ptr %i.ak, align 8, !tbaa !902
