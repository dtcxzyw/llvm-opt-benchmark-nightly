...
_ZN6hermes2vm11BoxedDouble6createEdRNS0_7RuntimeE.exit.i: ; preds = %bb.h, %bb.g
  ...
  %.pre98 = and i64 %.sroa.0.0.copyload.i.i.i35.pre, 281474976710655
...
bb.k:                                             ; preds = %bb.j
  ...
  br i1 %i.ba, label %.lr.ph117.preheader, label %.loopexit

.lr.ph117.preheader:                              ; preds = %bb.k
  %.sroa.0.0.copyload.i.i.i.i = load i32, ptr %i.ay, align 4, !tbaa !3
  %i.bb = zext i32 %.sroa.0.0.copyload.i.i.i.i to i64
  %i.bc = add i64 %i.bb, %i.az
  %i.bd = inttoptr i64 %i.bc to ptr               ; 2 uses
  %i.be = getelementptr inbounds nuw i8, ptr %i.bd, i64 16392
  br label %.lr.ph117

bb.l:                                             ; preds = %_ZNK6hermes2vm9ArrayImpl8unsafeAtERNS0_7RuntimeEj.exit
  %i.bf = icmp ugt i32 %i.bg, %.sroa.speculated61
  br i1 %i.bf, label %.lr.ph117, label %.loopexit, !llvm.loop !102
...
bb.m:                                             ; preds = %.lr.ph117
  ...
  %i.bp = add i64 %i.bo, %i.az
  %i.bq = inttoptr i64 %i.bp to ptr
  %i.br = and i32 %i.bh, 1023
...
_ZNK6hermes2vm9ArrayImpl8unsafeAtERNS0_7RuntimeEj.exit: ; preds = %.lr.ph117, %bb.m
  %.sink8.i.i = phi ptr [ %i.bq, %bb.m ], [ %i.bd, %.lr.ph117 ]
  %.sink7.i.i = phi i32 [ %i.br, %bb.m ], [ %i.bh, %.lr.ph117 ]
  %i.bs = getelementptr inbounds nuw i8, ptr %.sink8.i.i, i64 8
  %i.bt = zext nneg i32 %.sink7.i.i to i64
  %i.bu = getelementptr inbounds nuw [4 x i8], ptr %i.bs, i64 %i.bt
  %.sroa.0.0.i.i = load i32, ptr %i.bu, align 4, !tbaa !3
  %i.bv = icmp eq i32 %.sroa.0.0.i.i, 7
  br i1 %i.bv, label %bb.l, label %bb.n, !llvm.loop !102
...
.loopexit:                                        ; preds = %bb.l, %bb.k, %..loopexit_crit_edge, %bb.n
  ...
  %.sroa.0.0.copyload.i.i40 = load i32, ptr %i.bx, align 4, !tbaa !3
  %i.by = zext i32 %.sroa.0.0.copyload.i.i40 to i64
  %i.bz = add i64 %.pre-phi103, %i.by
  %i.ca = inttoptr i64 %i.bz to ptr
  %i.cb = getelementptr inbounds nuw i8, ptr %i.ca, i64 10
...
bb.o:                                             ; preds = %.loopexit
  ...
  store ptr %i.ce, ptr %4, align 8, !tbaa !103
  %i.cf = getelementptr inbounds nuw i8, ptr %4, i64 8 ; 2 uses
  store i32 0, ptr %i.cf, align 8, !tbaa !104
  %i.cg = getelementptr inbounds nuw i8, ptr %4, i64 12
  store i32 8, ptr %i.cg, align 4, !tbaa !105
  ...
  store ptr %i.cj, ptr %i.ch, align 8, !tbaa !107
  %i.ck = getelementptr inbounds nuw i8, ptr %5, i64 144 ; 3 uses
  %i.cl = getelementptr inbounds nuw i8, ptr %5, i64 16 ; 2 uses
  %i.cm = getelementptr inbounds nuw i8, ptr %5, i64 160 ; 2 uses
  store ptr %i.cm, ptr %i.ck, align 8, !tbaa !103
  %i.cn = getelementptr inbounds nuw i8, ptr %5, i64 152
  %i.co = getelementptr inbounds nuw i8, ptr %5, i64 156
  store i32 4, ptr %i.co, align 4, !tbaa !105
  store ptr %i.cl, ptr %i.cm, align 8
  store i32 1, ptr %i.cn, align 8, !tbaa !104
  %i.cp = getelementptr inbounds nuw i8, ptr %5, i64 192 ; 3 uses
  store ptr %i.cl, ptr %i.cp, align 8, !tbaa !46
  %i.cq = getelementptr inbounds nuw i8, ptr %5, i64 200 ; 2 uses
  store ptr %i.ck, ptr %i.cq, align 8, !tbaa !56
  %i.cr = getelementptr inbounds nuw i8, ptr %5, i64 208 ; 3 uses
  store i32 0, ptr %i.cr, align 8, !tbaa !108
  store ptr %5, ptr %i.ci, align 8, !tbaa !42
  %i.cs = call ptr @_ZN6hermes2vm7Runtime10makeHandleINS0_11HiddenClassEEENS0_6HandleIT_EERKNS0_9GCPointerIS5_EE(ptr noundef nonnull align 8 dereferenceable(9816) %1, ptr noundef nonnull align 4 dereferenceable(4) %i.bx)
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #13
  store ptr %1, ptr %6, align 8, !tbaa !109
  %i.ct = getelementptr inbounds nuw i8, ptr %6, i64 8
  store ptr %i.a, ptr %i.ct, align 8, !tbaa !111
  %i.cu = getelementptr inbounds nuw i8, ptr %6, i64 16
  store ptr %4, ptr %i.cu, align 8, !tbaa !113
  %i.cv = getelementptr inbounds nuw i8, ptr %6, i64 24
  store ptr %5, ptr %i.cv, align 8, !tbaa !115
  call fastcc void @"_ZN6hermes2vm11HiddenClass15forEachPropertyIZNS0_7JSArray9setLengthENS0_6HandleIS3_EERNS0_7RuntimeEjNS0_11PropOpFlagsEE3$_0EEvNS4_IS1_EES7_RKT_"(ptr %i.cs, ptr noundef nonnull align 8 dereferenceable(9816) %1, ptr noundef nonnull align 8 dereferenceable(32) %6)
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #13
  %i.cw = load ptr, ptr %4, align 8, !tbaa !103, !noalias !116 ; 2 uses
  %i.cx = load i32, ptr %i.cf, align 8, !tbaa !104, !noalias !116 ; 2 uses
  %.not8789 = icmp eq i32 %i.cx, 0
  br i1 %.not8789, label %._crit_edge, label %.lr.ph.preheader

.lr.ph.preheader:                                 ; preds = %bb.o
  %i.cy = zext i32 %i.cx to i64
  %.idx = shl nuw nsw i64 %i.cy, 3
...
._crit_edge:                                      ; preds = %bb.r, %bb.o
  ...
  %i.da = load ptr, ptr %4, align 8, !tbaa !103   ; 2 uses
  %i.db = icmp eq ptr %i.da, %i.ce
  br i1 %i.db, label %_ZN4llvh11SmallVectorISt4pairIjN6hermes2vm8SymbolIDEELj8EED2Ev.exit, label %bb.p

bb.p:                                             ; preds = %._crit_edge
  call void @free(ptr noundef %i.da) #13
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.r
  %.sroa.052.090 = phi ptr [ %i.dc, %bb.r ], [ %i.cz, %.lr.ph.preheader ] ; 2 uses
  %i.dc = getelementptr inbounds i8, ptr %.sroa.052.090, i64 -8 ; 3 uses
  %i.dd = load i32, ptr %i.dc, align 4, !tbaa !119
  %i.de = load i32, ptr %i.a, align 4, !tbaa !3
  %.not34 = icmp ult i32 %i.dd, %i.de
  br i1 %.not34, label %bb.r, label %bb.q

bb.q:                                             ; preds = %.lr.ph
  %i.df = load ptr, ptr %i.cp, align 8, !tbaa !46
  %i.dg = load i32, ptr %i.cr, align 8, !tbaa !108 ; 2 uses
  ...
  %i.dk = load ptr, ptr %i.ck, align 8, !tbaa !103
  ...
  store i32 %i.dg, ptr %i.cr, align 8, !tbaa !108
  store ptr %i.dn, ptr %i.cq, align 8, !tbaa !56
  store ptr %i.df, ptr %i.cp, align 8, !tbaa !46
  br label %bb.r

bb.r:                                             ; preds = %.lr.ph, %bb.q
  %.not87 = icmp eq ptr %i.dc, %i.cw
...
bb.s:                                             ; preds = %_ZN4llvh11SmallVectorISt4pairIjN6hermes2vm8SymbolIDEELj8EED2Ev.exit, %.loopexit
  %.pre-phi97 = phi ptr [ %.pre96, %_ZN4llvh11SmallVectorISt4pairIjN6hermes2vm8SymbolIDEELj8EED2Ev.exit ], [ %i.c, %.loopexit ]
  %i.do = phi i32 [ %.pre, %_ZN4llvh11SmallVectorISt4pairIjN6hermes2vm8SymbolIDEELj8EED2Ev.exit ], [ %i.bw, %.loopexit ] ; 3 uses
