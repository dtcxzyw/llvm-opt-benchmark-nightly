...
bb.sw:                                            ; preds = %bb.sv, %bb.su
  %.012480 = phi i64 [ %.0.copyload.i15563, %bb.su ], [ %i.dkc, %bb.sv ] ; 8 uses
...
.preheader15810:                                  ; preds = %bb.sw, %.preheader15810
  ...
  %.512498 = phi i32 [ %i.dkk, %.preheader15810 ], [ %.0.copyload.i15560, %bb.sw ] ; 2 uses
  %i.dkf = trunc nuw nsw i64 %indvars.iv to i32
  %.2412614 = add i32 %i.djw, %i.dkf
  %i.dkg = zext i32 %.512498 to i64
...
.loopexit15811:                                   ; preds = %.loopexit15811.loopexit, %bb.sw
  %.512585 = phi i32 [ 0, %bb.sw ], [ %i.dkn, %.loopexit15811.loopexit ]
  %.612499 = phi i32 [ %.0.copyload.i15560, %bb.sw ], [ %i.dkk, %.loopexit15811.loopexit ] ; 2 uses
  %i.dko = icmp eq i32 %.612499, %.0.copyload.i15561
  br i1 %i.dko, label %bb.sx, label %bb.sy

bb.sx:                                            ; preds = %.loopexit15811
  %i.dkp = tail call i64 @w2c_hermes_llvh0x3A0x3Ahashing0x3A0x3Adetail0x3A0x3Ahash_short0x28char0x20const0x2A0x2C0x20unsigned0x20long0x2C0x20unsigned0x20long0x20long0x29(ptr noundef nonnull %0, i32 noundef %i.djw, i32 noundef %.512585, i64 noundef %.012480) #7
...
bb.sy:                                            ; preds = %.loopexit15811
  ...
  %i.dku = lshr i64 %.012480, 47
  %i.dkv = xor i64 %i.dku, %.012480               ; 4 uses
  %i.dkw = xor i64 %.012480, -5435081209227447693 ; 3 uses
  ...
  %i.dli = mul i64 %.012480, -5435081209227447693
  ...
  %i.dmg = mul i64 %.012480, -5435081209227447692
  ...
  %i.dmu = mul i64 %.012480, -7894485801551159383
...
bb.sz:                                            ; preds = %.loopexit15807, %bb.sy
  %.712500 = phi i32 [ %.612499, %bb.sy ], [ %i.dnu, %.loopexit15807 ]
  %.012486 = phi i32 [ 64, %bb.sy ], [ %i.dqx, %.loopexit15807 ]
  %.012483 = phi i64 [ %i.dmk, %bb.sy ], [ %i.dpr, %.loopexit15807 ] ; 2 uses
  %.012482 = phi i64 [ %i.dmr, %bb.sy ], [ %i.dqb, %.loopexit15807 ] ; 2 uses
  %.112481 = phi i64 [ %i.dnn, %bb.sy ], [ %i.dqv, %.loopexit15807 ] ; 2 uses
  %.012479 = phi i64 [ %i.dni, %bb.sy ], [ %i.dqq, %.loopexit15807 ]
  %.012478 = phi i64 [ %i.dno, %bb.sy ], [ %i.dqy, %.loopexit15807 ] ; 2 uses
  %.012477 = phi i64 [ %i.dms, %bb.sy ], [ %i.dqw, %.loopexit15807 ] ; 2 uses
  %.012476 = phi i64 [ %i.dlh, %bb.sy ], [ %i.dph, %.loopexit15807 ]
  br label %bb.ta
...
bb.ta:                                            ; preds = %bb.ta, %bb.sz
  ...
  %.812501 = phi i32 [ %i.dnu, %bb.ta ], [ %.712500, %bb.sz ] ; 2 uses
  %i.dnp = trunc nuw nsw i64 %indvars.iv15893 to i32 ; 2 uses
  %.1112524 = add i32 %i.djw, %i.dnp
  %i.dnq = zext i32 %.812501 to i64
...
.preheader15806:                                  ; preds = %.preheader15806.preheader, %.preheader15806
  ...
  %.1512552 = phi i32 [ %i.djw, %.preheader15806.preheader ], [ %i.dok, %.preheader15806 ] ; 2 uses
  %i.doc = zext i32 %.1512552 to i64              ; 2 uses
...
.preheader15809:                                  ; preds = %bb.tc, %bb.te
  %.1812636 = phi i32 [ %.2512615, %bb.te ], [ %i.dnx, %bb.tc ]
  %.2512615 = phi i32 [ %i.dom, %bb.te ], [ %i.dnz, %bb.tc ] ; 4 uses
  %i.dol = icmp eq i32 %.2512615, 0
...
bb.te:                                            ; preds = %.preheader15809
  %i.dom = srem i32 %.1812636, %.2512615          ; 2 uses
  %.not13164 = icmp eq i32 %i.dom, 0
  br i1 %.not13164, label %bb.tf, label %.preheader15809

bb.tf:                                            ; preds = %bb.te
  %i.don = add i32 %.2512615, %i.djw
  %i.doo = add i32 %i.djw, %i.dnx
  br label %bb.tg

bb.tg:                                            ; preds = %bb.ti, %bb.tf
  %.1912637 = phi i32 [ %i.don, %bb.tf ], [ %i.dop, %bb.ti ]
  %i.dop = add i32 %.1912637, -1                  ; 6 uses
...
bb.th:                                            ; preds = %bb.th, %bb.tg
  %.2612616 = phi i32 [ %i.doq, %bb.tg ], [ %i.dpb, %bb.th ] ; 4 uses
  %.1612553 = phi i32 [ %i.dop, %bb.tg ], [ %.2612616, %bb.th ]
  %i.dot = zext i32 %.2612616 to i64              ; 2 uses
  ...
  %i.dox = add i32 %.2612616, %i.dnx
  %i.doy = sub i32 %i.djv, %.2612616              ; 2 uses
...
.loopexit15807:                                   ; preds = %bb.ti, %.preheader15806, %bb.tb
  ...
  %i.dpl = add i64 %.0.copyload.i15581, %.012478
  ...
  %i.dqd = mul i64 %.112481, -5435081209227447693
  ...
  %i.dql = add i64 %.012478, %.012483
  %i.dqm = add i64 %i.dql, %.012476
  ...
  %i.dqq = xor i64 %i.dqp, %.012482               ; 3 uses
  %i.dqr = add i64 %i.dqe, %.012477
  ...
  %i.dqx = add i32 %.012486, %i.dnx               ; 2 uses
