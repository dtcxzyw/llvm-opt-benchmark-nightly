...
bb.aso:                                           ; preds = %bb.aso, %bb.asn
  ...
  %7 = shl i64 %indvars.iv55656, 2                ; 4 uses
  %8 = trunc nuw nsw i64 %7 to i32                ; 2 uses
  %i.klp = add i32 %.0.copyload.i52774, %8
  ...
  %i.kls = add i32 %.0.copyload.i52775, %8
...
begin_hunk_4
  ...
  %i.kmg = or disjoint i32 %10, 8                 ; 2 uses
...
begin_hunk_5
  ...
  %i.kmp = or disjoint i32 %11, 12                ; 2 uses
...
begin_hunk_7
  ...
  %12 = icmp ugt i32 %i.lpx, 127
  br i1 %12, label %bb.aww, label %.loopexit54521
...
bb.awx:                                           ; preds = %bb.awx, %bb.aww
  ...
  %13 = shl i64 %indvars.iv55685, 2               ; 4 uses
  %14 = trunc nuw nsw i64 %13 to i32              ; 2 uses
  %i.lqg = add i32 %.0.copyload.i52907, %14
  ...
  %i.lqj = add i32 %.0.copyload.i52908, %14
...
begin_hunk_9
  ...
  %i.lqo = or disjoint i32 %15, 4                 ; 2 uses
...
begin_hunk_10
  ...
  %i.lqx = or disjoint i32 %16, 8                 ; 2 uses
...
begin_hunk_11
  ...
  %i.lrg = or disjoint i32 %17, 12                ; 2 uses
...
bb.ag:                                            ; preds = %bb.q
  ...
  %.0.copyload.i1250 = load i8, ptr %i.ep, align 1 ; 6 uses
...
bb.ay:                                            ; preds = %bb.ag
  %5 = add i8 %.0.copyload.i1250, -2
  %i.ip = icmp ult i8 %5, 107
...
bb.bi:                                            ; preds = %bb.ba
  %6 = add i8 %.0.copyload.i1250, -127
  %7 = icmp ult i8 %6, 6
  br i1 %7, label %bb.bj, label %bb.bk
