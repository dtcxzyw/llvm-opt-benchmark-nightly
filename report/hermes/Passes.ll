...
begin_hunk_0_@_ZN6hermes3hbc19LowerArgumentsArray13runOnFunctionEPNS_8FunctionE:bb.a
  ...
  %7 = alloca %"class.llvh::SmallSetVector", align 8 ; 20 uses
...
begin_hunk_1_@_ZN6hermes3hbc19LowerArgumentsArray13runOnFunctionEPNS_8FunctionE:bb.a
  ...
  %.07.i.i.i.i.ptr.10.i.i.i = getelementptr inbounds nuw i8, ptr %7, i64 4 ; 3 uses
  store i32 0, ptr %.07.i.i.i.i.ptr.10.i.i.i, align 4, !tbaa !93
  %.07.i.i.i.i.ptr.11.i.i.i = getelementptr inbounds nuw i8, ptr %7, i64 8 ; 4 uses
  %.07.i.i.i.i.ptr.12.i.i.i.a = getelementptr inbounds nuw i8, ptr %7, i64 16
  store <4 x ptr> <ptr inttoptr (i64 -8 to ptr), ptr inttoptr (i64 -8 to ptr), ptr inttoptr (i64 -8 to ptr), ptr inttoptr (i64 -8 to ptr)>, ptr %.07.i.i.i.i.ptr.11.i.i.i, align 8, !tbaa !97
  %.07.i.i.i.i.ptr.13.i.i.i = getelementptr inbounds nuw i8, ptr %7, i64 40
  store <4 x ptr> <ptr inttoptr (i64 -8 to ptr), ptr inttoptr (i64 -8 to ptr), ptr inttoptr (i64 -8 to ptr), ptr inttoptr (i64 -8 to ptr)>, ptr %.07.i.i.i.i.ptr.13.i.i.i, align 8, !tbaa !97
  %.07.i.i.i.i.ptr.14.i.i.i = getelementptr inbounds nuw i8, ptr %7, i64 72
  store <4 x ptr> <ptr inttoptr (i64 -8 to ptr), ptr inttoptr (i64 -8 to ptr), ptr inttoptr (i64 -8 to ptr), ptr inttoptr (i64 -8 to ptr)>, ptr %.07.i.i.i.i.ptr.14.i.i.i, align 8, !tbaa !97
  %.07.i.i.i.i.ptr.15.i.i.i = getelementptr inbounds nuw i8, ptr %7, i64 104
  store <4 x ptr> <ptr inttoptr (i64 -8 to ptr), ptr inttoptr (i64 -8 to ptr), ptr inttoptr (i64 -8 to ptr), ptr inttoptr (i64 -8 to ptr)>, ptr %.07.i.i.i.i.ptr.15.i.i.i, align 8, !tbaa !97
...
begin_hunk_2_@_ZN6hermes3hbc19LowerArgumentsArray13runOnFunctionEPNS_8FunctionE:bb.a
  ...
  %i.bp = load i32, ptr %.07.i.i.i.i.ptr.10.i.i.i, align 4
...
begin_hunk_3_@_ZN6hermes3hbc19LowerArgumentsArray13runOnFunctionEPNS_8FunctionE:bb.a
  ...
  %i.bt = load i32, ptr %.07.i.i.i.i.ptr.12.i.i.i.a, align 8
...
bb.m:                                             ; preds = %bb.k
  %i.bx = load ptr, ptr %.07.i.i.i.i.ptr.11.i.i.i, align 8
  %i.by = select i1 %.not.i.i.i.i.i, ptr %i.bx, ptr %.07.i.i.i.i.ptr.11.i.i.i ; 4 uses
...
bb.x:                                             ; preds = %_ZN4llvh11SmallVectorIPN6hermes11InstructionELj16EED2Ev.exit.i
  %i.eu = load ptr, ptr %.07.i.i.i.i.ptr.11.i.i.i, align 8, !tbaa !117
