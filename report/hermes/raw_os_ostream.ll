...
bb.b:                                             ; preds = %bb.a
  tail call void @_ZN4llvh11raw_ostream14flush_nonemptyEv(ptr noundef nonnull align 8 dereferenceable(48) %0) #4, !inline_history !15
  br label %_ZN4llvh14raw_os_ostreamD2Ev.exit

_ZN4llvh14raw_os_ostreamD2Ev.exit:                ; preds = %bb.a, %bb.b
  tail call void @_ZN4llvh11raw_ostreamD2Ev(ptr noundef nonnull align 8 dead_on_return(36) dereferenceable(48) %0) #4, !inline_history !15
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !16, !nonnull !19, !align !20
...
!14 = !{!10, !11, i64 8}
!15 = !{ptr @_ZN4llvh14raw_os_ostreamD2Ev}
!16 = !{!17, !18, i64 40}
!17 = !{!"_ZTSN4llvh14raw_os_ostreamE", !10, i64 0, !18, i64 40}
