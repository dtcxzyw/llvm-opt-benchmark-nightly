...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep29 = getelementptr i8, ptr %i.ab, i64 %offset.idx ; 4 uses
...
vector.ph40:                                      ; preds = %vector.memcheck32
  %n.vec42 = and i64 %i.cm, 4611686018427387900   ; 3 uses
  %i.cr = shl i64 %n.vec42, 3                     ; 2 uses
...
vector.body43:                                    ; preds = %vector.body43, %vector.ph40
  %index44 = phi i64 [ 0, %vector.ph40 ], [ %index.next51, %vector.body43 ] ; 2 uses
  %offset.idx45 = shl i64 %index44, 3             ; 2 uses
  %next.gep46 = getelementptr i8, ptr %i.cg, i64 %offset.idx45 ; 2 uses
  %next.gep48 = getelementptr i8, ptr %i.bv, i64 %offset.idx45 ; 4 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep28 = getelementptr i8, ptr %i.aa, i64 %offset.idx ; 4 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep31 = getelementptr i8, ptr %i.ah, i64 %offset.idx ; 4 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep34 = getelementptr i8, ptr %i.ak, i64 %offset.idx ; 4 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep21 = getelementptr i8, ptr %i.k, i64 %offset.idx ; 4 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep20 = getelementptr i8, ptr %i.i, i64 %offset.idx ; 4 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep = getelementptr i8, ptr %i.v, i64 %offset.idx ; 2 uses
  %next.gep7 = getelementptr i8, ptr %i.k, i64 %offset.idx ; 2 uses
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec11 = and i64 %i.ab, -4                    ; 3 uses
  %i.aj = shl i64 %n.vec11, 1                     ; 2 uses
  %i.ak = getelementptr i8, ptr %i.v, i64 %i.aj   ; 2 uses
  %i.al = getelementptr i8, ptr %i.k, i64 %i.aj
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index12 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next16, %vec.epilog.vector.body ] ; 2 uses
  %i.am = shl i64 %index12, 1                     ; 2 uses
  %next.gep13.a = getelementptr i8, ptr %i.v, i64 %i.am
  %next.gep14 = getelementptr i8, ptr %i.k, i64 %i.am
  call void @llvm.experimental.noalias.scope.decl(metadata !524)
  call void @llvm.experimental.noalias.scope.decl(metadata !527)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep23 = getelementptr i8, ptr %i.u, i64 %offset.idx ; 4 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep21 = getelementptr i8, ptr %i.l, i64 %offset.idx ; 4 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep21 = getelementptr i8, ptr %i.m, i64 %offset.idx ; 4 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep17 = getelementptr i8, ptr %i.n, i64 %offset.idx ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep23 = getelementptr i8, ptr %i.ae, i64 %offset.idx ; 4 uses
