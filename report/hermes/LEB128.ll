...
bb.g:                                             ; preds = %.lr.ph, %_ZNSt6vectorIhSaIhEE9push_backEOh.exit
  %i.ac = phi ptr [ %.pre, %.lr.ph ], [ %i.ax, %_ZNSt6vectorIhSaIhEE9push_backEOh.exit ] ; 3 uses
...
_ZNKSt6vectorIhSaIhEE12_M_check_lenEmPKc.exit.i.i.i: ; preds = %bb.i
  ...
  %i.as = call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.ar) #14 ; 4 uses
  %i.at = getelementptr inbounds nuw i8, ptr %i.as, i64 %i.am ; 2 uses
  store i8 %i.af, ptr %i.at, align 1, !tbaa !22
  %i.au = icmp sgt i64 %i.am, 0
  br i1 %i.au, label %bb.k, label %_ZNSt6vectorIhSaIhEE11_S_relocateEPhS2_S2_RS0_.exit16.i.i.i
...
_ZNSt6vectorIhSaIhEE17_M_realloc_insertIJhEEEvN9__gnu_cxx17__normal_iteratorIPhS1_EEDpOT_.exit.i.i: ; preds = %bb.l, %_ZNSt6vectorIhSaIhEE11_S_relocateEPhS2_S2_RS0_.exit16.i.i.i
  ...
  store ptr %i.av, ptr %i.y, align 8, !tbaa !25
  %i.aw = getelementptr inbounds nuw i8, ptr %i.as, i64 %i.ar
  store ptr %i.aw, ptr %i.z, align 8, !tbaa !27
  br label %_ZNSt6vectorIhSaIhEE9push_backEOh.exit
...
_ZNSt6vectorIhSaIhEE9push_backEOh.exit:           ; preds = %bb.h, %_ZNSt6vectorIhSaIhEE17_M_realloc_insertIJhEEEvN9__gnu_cxx17__normal_iteratorIPhS1_EEDpOT_.exit.i.i
  %i.ax = phi ptr [ %i.ai, %bb.h ], [ %i.av, %_ZNSt6vectorIhSaIhEE17_M_realloc_insertIJhEEEvN9__gnu_cxx17__normal_iteratorIPhS1_EEDpOT_.exit.i.i ]
