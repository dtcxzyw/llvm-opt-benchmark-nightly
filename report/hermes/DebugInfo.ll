...
bb.b:                                             ; preds = %bb.a
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.0.i.i.i.i.i, ptr noundef nonnull align 8 dereferenceable(104) %4, i64 16, i1 false)
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(104) %1, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.0.i.i.i.i.i, i64 16, i1 false), !tbaa.struct !200
...
begin_hunk_3_@_ZN6hermes3hbc18DebugInfoGenerator17serializeWithMoveEv:bb.a
  ...
  %i.o = load ptr, ptr %i.l, align 8, !tbaa !19   ; 2 uses
...
_ZNSt12_Vector_baseIhSaIhEE13_M_deallocateEPhm.exit.i: ; preds = %bb.e, %_ZNSt6vectorIhSaIhEE11_S_relocateEPhS2_S2_RS0_.exit.i
  ...
  %3 = getelementptr inbounds nuw i8, ptr %i.an, i64 %i.k
  store ptr %3, ptr %i.c, align 8, !tbaa !16
  %i.ap = getelementptr inbounds nuw i8, ptr %i.an, i64 %i.ai
  store ptr %i.ap, ptr %i.f, align 8, !tbaa !219
  %.pre = load ptr, ptr %i.l, align 8, !tbaa !28
  %.pre23 = load ptr, ptr %i.m, align 8, !tbaa !28
...
bb.w:                                             ; preds = %_ZSt34__uninitialized_move_if_noexcept_aIPhS0_SaIhEET0_T_S3_S2_RT1_.exit60
  %4 = load ptr, ptr %i.d, align 8, !tbaa !219
