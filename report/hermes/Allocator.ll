...
bb.e:                                             ; preds = %.lr.ph.i
  ...
  tail call void %i.bn(ptr noundef nonnull %i.bm) #9
...
_ZNSt10unique_ptrIvPDoFvPvEED2Ev.exit.i:          ; preds = %bb.e, %.lr.ph.i
  ...
  br i1 %.not.i, label %_ZN4llvh23SmallVectorTemplateBaseISt10unique_ptrIvPDoFvPvEELb0EE13destroy_rangeEPS5_S7_.exit.loopexit, label %.lr.ph.i, !llvm.loop !54
