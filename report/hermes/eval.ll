...
_ZN6hermes2vm10StringView14const_iteratorppEv.exit.i.i.i.preheader: ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %.0.i10.i.i57.ph = phi ptr [ %i.bc, %iter.check ], [ %i.bk, %vec.epilog.iter.check ], [ %i.bp, %vec.epilog.middle.block ] ; 2 uses
  %.sroa.03.0.i.i.i56.ph = phi ptr [ %i.ap, %iter.check ], [ %i.bl, %vec.epilog.iter.check ], [ %i.bq, %vec.epilog.middle.block ] ; 3 uses
  %9 = add i64 %i.j, %.0.i.sink.i.i2858
  %10 = add i64 %9, %i.aq                         ; 2 uses
  %.sroa.03.0.i.i.i56.ph73 = ptrtoint ptr %.sroa.03.0.i.i.i56.ph to i64 ; 2 uses
  %11 = sub i64 %10, %.sroa.03.0.i.i.i56.ph73
...
_ZN6hermes2vm10StringView14const_iteratorppEv.exit.i.i.i.prol: ; preds = %_ZN6hermes2vm10StringView14const_iteratorppEv.exit.i.i.i.preheader, %_ZN6hermes2vm10StringView14const_iteratorppEv.exit.i.i.i.prol
  %.0.i10.i.i57.prol = phi ptr [ %14, %_ZN6hermes2vm10StringView14const_iteratorppEv.exit.i.i.i.prol ], [ %.0.i10.i.i57.ph, %_ZN6hermes2vm10StringView14const_iteratorppEv.exit.i.i.i.preheader ] ; 2 uses
  %.sroa.03.0.i.i.i56.prol = phi ptr [ %13, %_ZN6hermes2vm10StringView14const_iteratorppEv.exit.i.i.i.prol ], [ %.sroa.03.0.i.i.i56.ph, %_ZN6hermes2vm10StringView14const_iteratorppEv.exit.i.i.i.preheader ] ; 2 uses
  ...
  %12 = load i8, ptr %.sroa.03.0.i.i.i56.prol, align 1, !tbaa !14
  store i8 %12, ptr %.0.i10.i.i57.prol, align 1, !tbaa !14
  %13 = getelementptr inbounds nuw i8, ptr %.sroa.03.0.i.i.i56.prol, i64 1 ; 2 uses
  %14 = getelementptr inbounds nuw i8, ptr %.0.i10.i.i57.prol, i64 1 ; 2 uses
...
_ZN6hermes2vm10StringView14const_iteratorppEv.exit.i.i.i.prol.loopexit: ; preds = %_ZN6hermes2vm10StringView14const_iteratorppEv.exit.i.i.i.prol, %_ZN6hermes2vm10StringView14const_iteratorppEv.exit.i.i.i.preheader
  %.0.i10.i.i57.unr = phi ptr [ %.0.i10.i.i57.ph, %_ZN6hermes2vm10StringView14const_iteratorppEv.exit.i.i.i.preheader ], [ %14, %_ZN6hermes2vm10StringView14const_iteratorppEv.exit.i.i.i.prol ]
  %.sroa.03.0.i.i.i56.unr = phi ptr [ %.sroa.03.0.i.i.i56.ph, %_ZN6hermes2vm10StringView14const_iteratorppEv.exit.i.i.i.preheader ], [ %13, %_ZN6hermes2vm10StringView14const_iteratorppEv.exit.i.i.i.prol ]
  %15 = sub i64 %.sroa.03.0.i.i.i56.ph73, %10
  %16 = icmp ugt i64 %15, -8
  br i1 %16, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2IN6hermes2vm10StringView14const_iteratorEvEET_SA_RKS3_.exit, label %_ZN6hermes2vm10StringView14const_iteratorppEv.exit.i.i.i
...
_ZN6hermes2vm10StringView14const_iteratorppEv.exit.i.i.i: ; preds = %_ZN6hermes2vm10StringView14const_iteratorppEv.exit.i.i.i.prol.loopexit, %_ZN6hermes2vm10StringView14const_iteratorppEv.exit.i.i.i
  %.0.i10.i.i57 = phi ptr [ %i.bu, %_ZN6hermes2vm10StringView14const_iteratorppEv.exit.i.i.i ], [ %.0.i10.i.i57.unr, %_ZN6hermes2vm10StringView14const_iteratorppEv.exit.i.i.i.prol.loopexit ] ; 9 uses
  %.sroa.03.0.i.i.i56 = phi ptr [ %i.bt, %_ZN6hermes2vm10StringView14const_iteratorppEv.exit.i.i.i ], [ %.sroa.03.0.i.i.i56.unr, %_ZN6hermes2vm10StringView14const_iteratorppEv.exit.i.i.i.prol.loopexit ] ; 9 uses
  %17 = load i8, ptr %.sroa.03.0.i.i.i56, align 1, !tbaa !14
  store i8 %17, ptr %.0.i10.i.i57, align 1, !tbaa !14
  %18 = getelementptr inbounds nuw i8, ptr %.sroa.03.0.i.i.i56, i64 1
  %19 = getelementptr inbounds nuw i8, ptr %.0.i10.i.i57, i64 1
  %20 = load i8, ptr %18, align 1, !tbaa !14
  store i8 %20, ptr %19, align 1, !tbaa !14
  %21 = getelementptr inbounds nuw i8, ptr %.sroa.03.0.i.i.i56, i64 2
  %22 = getelementptr inbounds nuw i8, ptr %.0.i10.i.i57, i64 2
  %23 = load i8, ptr %21, align 1, !tbaa !14
  store i8 %23, ptr %22, align 1, !tbaa !14
  %24 = getelementptr inbounds nuw i8, ptr %.sroa.03.0.i.i.i56, i64 3
  %25 = getelementptr inbounds nuw i8, ptr %.0.i10.i.i57, i64 3
  %26 = load i8, ptr %24, align 1, !tbaa !14
  store i8 %26, ptr %25, align 1, !tbaa !14
  %27 = getelementptr inbounds nuw i8, ptr %.sroa.03.0.i.i.i56, i64 4
  %28 = getelementptr inbounds nuw i8, ptr %.0.i10.i.i57, i64 4
  %29 = load i8, ptr %27, align 1, !tbaa !14
  store i8 %29, ptr %28, align 1, !tbaa !14
  %30 = getelementptr inbounds nuw i8, ptr %.sroa.03.0.i.i.i56, i64 5
  %31 = getelementptr inbounds nuw i8, ptr %.0.i10.i.i57, i64 5
  %32 = load i8, ptr %30, align 1, !tbaa !14
  store i8 %32, ptr %31, align 1, !tbaa !14
  %33 = getelementptr inbounds nuw i8, ptr %.sroa.03.0.i.i.i56, i64 6
  %34 = getelementptr inbounds nuw i8, ptr %.0.i10.i.i57, i64 6
  %35 = load i8, ptr %33, align 1, !tbaa !14
  store i8 %35, ptr %34, align 1, !tbaa !14
  %36 = getelementptr inbounds nuw i8, ptr %.sroa.03.0.i.i.i56, i64 7
  %37 = getelementptr inbounds nuw i8, ptr %.0.i10.i.i57, i64 7
  %i.bs = load i8, ptr %36, align 1, !tbaa !14
  store i8 %i.bs, ptr %37, align 1, !tbaa !14
  %i.bt = getelementptr inbounds nuw i8, ptr %.sroa.03.0.i.i.i56, i64 8 ; 2 uses
  %i.bu = getelementptr inbounds nuw i8, ptr %.0.i10.i.i57, i64 8
  %.not.i11.i.i = icmp eq ptr %i.bt, %i.at
  br i1 %.not.i11.i.i, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2IN6hermes2vm10StringView14const_iteratorEvEET_SA_RKS3_.exit, label %_ZN6hermes2vm10StringView14const_iteratorppEv.exit.i.i.i, !llvm.loop !26
...
bb.v:                                             ; preds = %bb.a
  ...
  store i32 0, ptr %i.cr, align 8, !tbaa !29
  %i.cs = getelementptr inbounds nuw i8, ptr %8, i64 12
  store i32 4, ptr %i.cs, align 4, !tbaa !30
  ...
  %i.cx = load ptr, ptr %8, align 8, !tbaa !27    ; 2 uses
