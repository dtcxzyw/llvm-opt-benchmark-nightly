...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(read, inaccessiblemem: none, target_mem: none) uwtable
define hidden noundef zeroext i1 @_ZN6hermes6ESTree15hasSimpleParamsEPNS0_16FunctionLikeNodeE(ptr nofree noundef readonly captures(address) %0) local_unnamed_addr #1 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.b = load i32, ptr %i.a, align 8, !tbaa !7
...
.lr.ph:                                           ; preds = %bb.a, %.critedge
  %.sroa.010.016 = phi ptr [ %.sroa.010.0, %.critedge ], [ %.sroa.010.014, %bb.a ] ; 3 uses
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(read, inaccessiblemem: none, target_mem: none) uwtable
define hidden noundef zeroext i1 @_ZN6hermes6ESTree19hasParamExpressionsEPNS0_16FunctionLikeNodeE(ptr nofree noundef readonly captures(address) %0) local_unnamed_addr #1 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.b = load i32, ptr %i.a, align 8, !tbaa !7
  %switch.tableidx.i = add i32 %i.b, -4
...
.lr.ph:                                           ; preds = %bb.a, %bb.c
  %.sroa.010.021 = phi ptr [ %.sroa.010.0, %bb.c ], [ %.sroa.010.019, %bb.a ] ; 3 uses
