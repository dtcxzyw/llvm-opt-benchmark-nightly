...
bb.b:                                             ; preds = %_ZN6hermes12_GLOBAL__N_113runOnFunctionEPNS_8FunctionE.exit.i, %.lr.ph.i
  %.sroa.05.020.i = phi ptr [ %.sroa.05.017.i, %.lr.ph.i ], [ %.sroa.05.0.i, %_ZN6hermes12_GLOBAL__N_113runOnFunctionEPNS_8FunctionE.exit.i ] ; 3 uses
  %.019.i = phi i1 [ false, %.lr.ph.i ], [ %i.hl, %_ZN6hermes12_GLOBAL__N_113runOnFunctionEPNS_8FunctionE.exit.i ]
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.05.020.i) ]
...
begin_hunk_1_@_ZZN6hermes26createSimpleStackPromotionEvEN8ThisPass11runOnModuleEPNS_6ModuleE:bb.a
  ...
  %i.dh = load ptr, ptr %i.dg, align 8, !tbaa !24, !nonnull !119, !noundef !119
  %i.di = getelementptr inbounds nuw i8, ptr %i.dh, i64 64
  %i.dj = load ptr, ptr %i.di, align 8, !tbaa !24, !nonnull !119, !noundef !119
  ...
  %.sroa.0.0.copyload.i.i.i.i = load ptr, ptr %i.dk, align 8, !tbaa !120
...
begin_hunk_2_@_ZZN6hermes26createSimpleStackPromotionEvEN8ThisPass11runOnModuleEPNS_6ModuleE:bb.a
  ...
  br i1 %i.gt, label %.lr.ph.i.i.i.i.i.i.i.i, label %._crit_edge.loopexit.i.i.i.i.i.i.i.i, !llvm.loop !121
...
begin_hunk_3_@_ZZN6hermes26createSimpleStackPromotionEvEN8ThisPass11runOnModuleEPNS_6ModuleE:bb.a
  ...
  br i1 %.not.i.i.i.i.i.i, label %_ZN6hermes12_GLOBAL__N_113runOnFunctionEPNS_8FunctionE.exit.i, label %.lr.ph.i.i.i.i.i.i, !llvm.loop !123
