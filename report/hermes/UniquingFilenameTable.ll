...
bb.d:                                             ; preds = %bb.c
  ...
  %.pre = load ptr, ptr %i.d, align 8, !tbaa !74
...
_ZNSt5dequeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE22_M_reserve_map_at_backEm.exit: ; preds = %bb.c, %bb.d
  ...
  %4 = tail call noalias noundef nonnull dereferenceable(512) ptr @_Znwm(i64 noundef 512) #12
  %i.an = getelementptr inbounds nuw i8, ptr %3, i64 8
  store ptr %4, ptr %i.an, align 8, !tbaa !45
...
bb.a:
  ...
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !75   ; 8 uses
