...
begin_hunk_0_@_ZN6hermes14StackPromotion11runOnModuleEPNS_6ModuleE:bb.a
  ...
  %i.s = getelementptr inbounds nuw i8, ptr %21, i64 40 ; 3 uses
...
begin_hunk_1_@_ZN6hermes14StackPromotion11runOnModuleEPNS_6ModuleE:bb.a
  ...
  %i.ay = getelementptr inbounds nuw i8, ptr %21, i64 40 ; 3 uses
  br label %bb.hf
...
bb.ag:                                            ; preds = %_ZNSt6vectorIPN6hermes8FunctionESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit16.i.i.i.i.i.i
  %22 = load ptr, ptr %i.s, align 8, !tbaa !100
  %23 = ptrtoint ptr %22 to i64
  %24 = sub i64 %23, %i.jj
  call void @_ZdlPvm(ptr noundef nonnull %i.jh, i64 noundef %24) #15
...
bb.hw:                                            ; preds = %bb.hu
  ...
  %i.bvw = ptrtoint ptr %i.bvu to i64             ; 2 uses
  %i.bvx = sub i64 %i.bvv, %i.bvw                 ; 5 uses
...
bb.hz:                                            ; preds = %_ZNSt6vectorIPN6hermes8FunctionESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit16.i.i.i
  %25 = load ptr, ptr %i.ay, align 8, !tbaa !100
  %26 = ptrtoint ptr %25 to i64
  %27 = sub i64 %26, %i.bvw
  call void @_ZdlPvm(ptr noundef nonnull %i.bvu, i64 noundef %27) #15
