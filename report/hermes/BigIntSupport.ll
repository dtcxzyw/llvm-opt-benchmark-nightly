...
.lr.ph:                                           ; preds = %_ZN6hermes6bigint12_GLOBAL__N_114initWithDigitsENS0_16MutableBigIntRefENS0_18ImmutableBigIntRefE.exit98.thread, %bb.s
  ...
  %.val70.val = load ptr, ptr %i.cm, align 8, !tbaa !92 ; 2 uses
  store i32 1024, ptr %.val70.val, align 4, !tbaa !3
  %.sroa.015.0.copyload = load ptr, ptr %.sroa.0132.0162, align 8, !tbaa !102
  %.val78.val = load ptr, ptr %.sroa.0135.0166, align 8, !tbaa !89 ; 2 uses
  %i.cn = getelementptr i8, ptr %.sroa.0135.0166, i64 8
  %.val78.val79 = load ptr, ptr %i.cn, align 8, !tbaa !92
  ...
  br i1 %.not, label %bb.j, label %_ZN6hermes6bigint12_GLOBAL__N_134initNonCanonicalWithReadOnlyBigIntERNS0_16MutableBigIntRefERKNS0_18ImmutableBigIntRefE.exit.loopexit.split.loop.exit, !prof !103
...
bb.k:                                             ; preds = %bb.j
  ...
  %.val68.val = load ptr, ptr %i.cq, align 8, !tbaa !92
...
bb.t:                                             ; preds = %._crit_edge
  ...
  %.val66.val = load ptr, ptr %i.ee, align 8, !tbaa !92
  ...
  %.val72.val85 = load ptr, ptr %i.ef, align 8, !tbaa !92
...
bb.u:                                             ; preds = %bb.t
  ...
  %i.ei = load ptr, ptr %.sroa.0127.1, align 8, !tbaa !89
  ...
  %i.ek = load ptr, ptr %i.ee, align 8, !tbaa !92, !nonnull !64, !align !93
...
_ZN6hermes6bigint12_GLOBAL__N_124getBigIntRefSignExtValueINS0_18ImmutableBigIntRefEEEmRKT_.exit.i: ; preds = %bb.v, %bb.u
  ...
  %i.ev = load ptr, ptr %.sroa.0127.1, align 8, !tbaa !89
