...
begin_hunk_0_@_ZN6hermesL8orderDFSEPNS_8FunctionE:.lr.ph15
  ...
  %4 = alloca %"class.llvh::SmallDenseSet.154", align 8 ; 7 uses
...
begin_hunk_1_@_ZN6hermesL8orderDFSEPNS_8FunctionE:.lr.ph15
  ...
  %.07.i.i.i.i.ptr.2.i = getelementptr inbounds nuw i8, ptr %4, i64 4
  store i32 0, ptr %.07.i.i.i.i.ptr.2.i, align 4, !tbaa !152
  %.07.i.i.i.i.ptr.3.i = getelementptr inbounds nuw i8, ptr %4, i64 8 ; 2 uses
  store <4 x ptr> <ptr inttoptr (i64 -8 to ptr), ptr inttoptr (i64 -8 to ptr), ptr inttoptr (i64 -8 to ptr), ptr inttoptr (i64 -8 to ptr)>, ptr %.07.i.i.i.i.ptr.3.i, align 8, !tbaa !102
...
bb.e:                                             ; preds = %._crit_edge
  %i.ar = load ptr, ptr %.07.i.i.i.i.ptr.3.i, align 8, !tbaa !163
