begin_hunk_0
  ...
  %.sroa.9.0.copyload.i = load i32, ptr %.sroa.9.0..sroa_idx.i, align 4 ; [#uses=1 type=i32]
  %.sroa.9.0.copyload.fr.i = freeze i32 %.sroa.9.0.copyload.i ; [#uses=3 type=i32]
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #24
  call void @llvm.lifetime.end.p0(ptr nonnull %4)
  %154 = icmp sgt i32 %.sroa.9.0.copyload.fr.i, 1979 ; [#uses=1 type=i1]
  %155 = icmp sgt i32 %.sroa.9.0.copyload.fr.i, 79 ; [#uses=1 type=i1]
  %..i = select i1 %155, i32 -80, i32 20          ; [#uses=1 type=i32]
  %spec.select.i = select i1 %154, i32 -1980, i32 %..i ; [#uses=1 type=i32]
  %156 = add nsw i32 %spec.select.i, %.sroa.9.0.copyload.fr.i ; [#uses=1 type=i32]
  br label %157
...
begin_hunk_1
  ...
  %.sroa.9.0.copyload = load i32, ptr %.sroa.9.0..sroa_idx, align 4 ; [#uses=1 type=i32]
  %.sroa.9.0.copyload.fr = freeze i32 %.sroa.9.0.copyload ; [#uses=3 type=i32]
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #24
  call void @llvm.lifetime.end.p0(ptr nonnull %2)
  %5 = icmp sgt i32 %.sroa.9.0.copyload.fr, 1979  ; [#uses=1 type=i1]
  %6 = icmp sgt i32 %.sroa.9.0.copyload.fr, 79    ; [#uses=1 type=i1]
  %. = select i1 %6, i32 -80, i32 20              ; [#uses=1 type=i32]
  %spec.select = select i1 %5, i32 -1980, i32 %.  ; [#uses=1 type=i32]
  %7 = add nsw i32 %spec.select, %.sroa.9.0.copyload.fr ; [#uses=1 type=i32]
  br label %8
