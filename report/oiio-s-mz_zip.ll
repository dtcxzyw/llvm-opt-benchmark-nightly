begin_hunk_0
  ...
  %154 = icmp sgt i32 %.sroa.9.0.copyload.fr.i, 1979
  %155 = icmp sgt i32 %.sroa.9.0.copyload.fr.i, 79
  %..i = select i1 %155, i32 -80, i32 20
  %spec.select.i = select i1 %154, i32 -1980, i32 %..i
  %156 = add nsw i32 %spec.select.i, %.sroa.9.0.copyload.fr.i
  br label %157
...
begin_hunk_1
  ...
  %5 = icmp sgt i32 %.sroa.9.0.copyload.fr, 1979
  %6 = icmp sgt i32 %.sroa.9.0.copyload.fr, 79
  %. = select i1 %6, i32 -80, i32 20
  %spec.select = select i1 %5, i32 -1980, i32 %.
  %7 = add nsw i32 %spec.select, %.sroa.9.0.copyload.fr
  br label %8
