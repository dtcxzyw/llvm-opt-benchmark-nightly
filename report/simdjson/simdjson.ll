...
.noexc108:                                        ; preds = %bb.az
  ...
  %i.nv = zext i64 %i.no to i128                  ; 2 uses
...
bb.bb:                                            ; preds = %.noexc108
  ...
  %2 = zext i64 %i.oe to i128
  %3 = mul nuw i128 %2, %i.nv
  %4 = lshr i128 %3, 64
  %5 = trunc nuw i128 %4 to i64                   ; 2 uses
  %i.of = add i64 %5, %i.ny                       ; 2 uses
  %6 = icmp ult i64 %i.of, %5
  %i.og = zext i1 %6 to i64
...
bb.ee:                                            ; preds = %bb.ec
  ...
  %i.akz = zext i64 %i.aks to i128                ; 2 uses
...
bb.ef:                                            ; preds = %bb.ee
  ...
  %7 = zext i64 %i.ali to i128
  %8 = mul nuw i128 %7, %i.akz
  %9 = lshr i128 %8, 64
  %10 = trunc nuw i128 %9 to i64                  ; 2 uses
  %i.alj = add i64 %10, %i.alc                    ; 2 uses
  %11 = icmp ult i64 %i.alj, %10
  %i.alk = zext i1 %11 to i64
...
bb.ho:                                            ; preds = %bb.hm
  ...
  %i.bkm = zext i64 %i.bkf to i128                ; 2 uses
...
bb.hp:                                            ; preds = %bb.ho
  ...
  %12 = zext i64 %i.bkv to i128
  %13 = mul nuw i128 %12, %i.bkm
  %14 = lshr i128 %13, 64
  %15 = trunc nuw i128 %14 to i64                 ; 2 uses
  %i.bkw = add i64 %15, %i.bkp                    ; 2 uses
  %16 = icmp ult i64 %i.bkw, %15
  %i.bkx = zext i1 %16 to i64
...
bb.bc:                                            ; preds = %bb.ba
  ...
  %i.no = zext i64 %i.nh to i128                  ; 2 uses
...
bb.bd:                                            ; preds = %bb.bc
  ...
  %2 = zext i64 %i.nx to i128
  %3 = mul nuw i128 %2, %i.no
  %4 = lshr i128 %3, 64
  %5 = trunc nuw i128 %4 to i64                   ; 2 uses
  %i.ny = add i64 %5, %i.nr                       ; 2 uses
  %6 = icmp ult i64 %i.ny, %5
  %i.nz = zext i1 %6 to i64
...
bb.eg:                                            ; preds = %bb.ee
  ...
  %i.aks = zext i64 %i.akl to i128                ; 2 uses
...
bb.eh:                                            ; preds = %bb.eg
  ...
  %7 = zext i64 %i.alb to i128
  %8 = mul nuw i128 %7, %i.aks
  %9 = lshr i128 %8, 64
  %10 = trunc nuw i128 %9 to i64                  ; 2 uses
  %i.alc = add i64 %10, %i.akv                    ; 2 uses
  %11 = icmp ult i64 %i.alc, %10
  %i.ald = zext i1 %11 to i64
...
bb.hq:                                            ; preds = %bb.ho
  ...
  %i.bkf = zext i64 %i.bjy to i128                ; 2 uses
...
bb.hr:                                            ; preds = %bb.hq
  ...
  %12 = zext i64 %i.bko to i128
  %13 = mul nuw i128 %12, %i.bkf
  %14 = lshr i128 %13, 64
  %15 = trunc nuw i128 %14 to i64                 ; 2 uses
  %i.bkp = add i64 %15, %i.bki                    ; 2 uses
  %16 = icmp ult i64 %i.bkp, %15
  %i.bkq = zext i1 %16 to i64
...
bb.bc:                                            ; preds = %bb.bb
  ...
  %2 = zext i64 %i.ob to i128
  %3 = mul nuw i128 %2, %i.ns
  %4 = lshr i128 %3, 64
  %5 = trunc nuw i128 %4 to i64                   ; 2 uses
  %i.oc = add i64 %5, %i.nv                       ; 2 uses
  %6 = icmp ult i64 %i.oc, %5
  %i.od = zext i1 %6 to i64
...
bb.ef:                                            ; preds = %bb.ed
  ...
  %i.akq = zext i64 %i.akj to i128                ; 2 uses
...
bb.eg:                                            ; preds = %bb.ef
  ...
  %7 = zext i64 %i.akz to i128
  %8 = mul nuw i128 %7, %i.akq
  %9 = lshr i128 %8, 64
  %10 = trunc nuw i128 %9 to i64                  ; 2 uses
  %i.ala = add i64 %10, %i.akt                    ; 2 uses
  %11 = icmp ult i64 %i.ala, %10
  %i.alb = zext i1 %11 to i64
...
bb.hp:                                            ; preds = %bb.hn
  ...
  %i.bjy = zext i64 %i.bjr to i128                ; 2 uses
...
bb.hq:                                            ; preds = %bb.hp
  ...
  %12 = zext i64 %i.bkh to i128
  %13 = mul nuw i128 %12, %i.bjy
  %14 = lshr i128 %13, 64
  %15 = trunc nuw i128 %14 to i64                 ; 2 uses
  %i.bki = add i64 %15, %i.bkb                    ; 2 uses
  %16 = icmp ult i64 %i.bki, %15
  %i.bkj = zext i1 %16 to i64
...
bb.bc:                                            ; preds = %bb.ba
  ...
  %i.nl = zext i64 %i.ne to i128                  ; 2 uses
...
bb.bd:                                            ; preds = %bb.bc
  ...
  %2 = zext i64 %i.nu to i128
  %3 = mul nuw i128 %2, %i.nl
  %4 = lshr i128 %3, 64
  %5 = trunc nuw i128 %4 to i64                   ; 2 uses
  %i.nv = add i64 %5, %i.no                       ; 2 uses
  %6 = icmp ult i64 %i.nv, %5
  %i.nw = zext i1 %6 to i64
...
bb.eg:                                            ; preds = %bb.ee
  ...
  %i.akj = zext i64 %i.akc to i128                ; 2 uses
...
bb.eh:                                            ; preds = %bb.eg
  ...
  %7 = zext i64 %i.aks to i128
  %8 = mul nuw i128 %7, %i.akj
  %9 = lshr i128 %8, 64
  %10 = trunc nuw i128 %9 to i64                  ; 2 uses
  %i.akt = add i64 %10, %i.akm                    ; 2 uses
  %11 = icmp ult i64 %i.akt, %10
  %i.aku = zext i1 %11 to i64
...
bb.hq:                                            ; preds = %bb.ho
  ...
  %i.bjr = zext i64 %i.bjk to i128                ; 2 uses
...
bb.hr:                                            ; preds = %bb.hq
  ...
  %12 = zext i64 %i.bka to i128
  %13 = mul nuw i128 %12, %i.bjr
  %14 = lshr i128 %13, 64
  %15 = trunc nuw i128 %14 to i64                 ; 2 uses
  %i.bkb = add i64 %15, %i.bju                    ; 2 uses
  %16 = icmp ult i64 %i.bkb, %15
  %i.bkc = zext i1 %16 to i64
...
bb.bc:                                            ; preds = %bb.ba
  ...
  %i.nu = zext i64 %i.nn to i128                  ; 2 uses
...
bb.bd:                                            ; preds = %bb.bc
  ...
  %2 = zext i64 %i.od to i128
  %3 = mul nuw i128 %2, %i.nu
  %4 = lshr i128 %3, 64
  %5 = trunc nuw i128 %4 to i64                   ; 2 uses
  %i.oe = add i64 %5, %i.nx                       ; 2 uses
  %6 = icmp ult i64 %i.oe, %5
  %i.of = zext i1 %6 to i64
...
bb.ei:                                            ; preds = %bb.eg
  ...
  %i.akw = zext i64 %i.akp to i128                ; 2 uses
...
bb.ej:                                            ; preds = %bb.ei
  ...
  %7 = zext i64 %i.alf to i128
  %8 = mul nuw i128 %7, %i.akw
  %9 = lshr i128 %8, 64
  %10 = trunc nuw i128 %9 to i64                  ; 2 uses
  %i.alg = add i64 %10, %i.akz                    ; 2 uses
  %11 = icmp ult i64 %i.alg, %10
  %i.alh = zext i1 %11 to i64
...
bb.hu:                                            ; preds = %bb.hs
  ...
  %i.bkh = zext i64 %i.bka to i128                ; 2 uses
...
bb.hv:                                            ; preds = %bb.hu
  ...
  %12 = zext i64 %i.bkq to i128
  %13 = mul nuw i128 %12, %i.bkh
  %14 = lshr i128 %13, 64
  %15 = trunc nuw i128 %14 to i64                 ; 2 uses
  %i.bkr = add i64 %15, %i.bkk                    ; 2 uses
  %16 = icmp ult i64 %i.bkr, %15
  %i.bks = zext i1 %16 to i64
...
bb.be:                                            ; preds = %bb.bd
  ...
  %2 = zext i64 %i.nw to i128
  %3 = mul nuw i128 %2, %i.nn
  %4 = lshr i128 %3, 64
  %5 = trunc nuw i128 %4 to i64                   ; 2 uses
  %i.nx = add i64 %5, %i.nq                       ; 2 uses
  %6 = icmp ult i64 %i.nx, %5
  %i.ny = zext i1 %6 to i64
...
bb.ej:                                            ; preds = %bb.eh
  ...
  %i.akp = zext i64 %i.aki to i128                ; 2 uses
...
bb.ek:                                            ; preds = %bb.ej
  ...
  %7 = zext i64 %i.aky to i128
  %8 = mul nuw i128 %7, %i.akp
  %9 = lshr i128 %8, 64
  %10 = trunc nuw i128 %9 to i64                  ; 2 uses
  %i.akz = add i64 %10, %i.aks                    ; 2 uses
  %11 = icmp ult i64 %i.akz, %10
  %i.ala = zext i1 %11 to i64
...
bb.hv:                                            ; preds = %bb.ht
  ...
  %i.bka = zext i64 %i.bjt to i128                ; 2 uses
...
bb.hw:                                            ; preds = %bb.hv
  ...
  %12 = zext i64 %i.bkj to i128
  %13 = mul nuw i128 %12, %i.bka
  %14 = lshr i128 %13, 64
  %15 = trunc nuw i128 %14 to i64                 ; 2 uses
  %i.bkk = add i64 %15, %i.bkd                    ; 2 uses
  %16 = icmp ult i64 %i.bkk, %15
  %i.bkl = zext i1 %16 to i64
...
bb.bc:                                            ; preds = %bb.ba
  ...
  %i.mw = zext i64 %i.mp to i128                  ; 2 uses
...
bb.bd:                                            ; preds = %bb.bc
  ...
  %2 = zext i64 %i.nf to i128
  %3 = mul nuw i128 %2, %i.mw
  %4 = lshr i128 %3, 64
  %5 = trunc nuw i128 %4 to i64                   ; 2 uses
  %i.ng = add i64 %5, %i.mz                       ; 2 uses
  %6 = icmp ult i64 %i.ng, %5
  %i.nh = zext i1 %6 to i64
...
bb.eh:                                            ; preds = %bb.ef
  ...
  %i.aic = zext i64 %i.ahv to i128                ; 2 uses
...
bb.ei:                                            ; preds = %bb.eh
  ...
  %7 = zext i64 %i.ail to i128
  %8 = mul nuw i128 %7, %i.aic
  %9 = lshr i128 %8, 64
  %10 = trunc nuw i128 %9 to i64                  ; 2 uses
  %i.aim = add i64 %10, %i.aif                    ; 2 uses
  %11 = icmp ult i64 %i.aim, %10
  %i.ain = zext i1 %11 to i64
...
bb.hs:                                            ; preds = %bb.hq
  ...
  %i.bfu = zext i64 %i.bfn to i128                ; 2 uses
...
bb.ht:                                            ; preds = %bb.hs
  ...
  %12 = zext i64 %i.bgd to i128
  %13 = mul nuw i128 %12, %i.bfu
  %14 = lshr i128 %13, 64
  %15 = trunc nuw i128 %14 to i64                 ; 2 uses
  %i.bge = add i64 %15, %i.bfx                    ; 2 uses
  %16 = icmp ult i64 %i.bge, %15
  %i.bgf = zext i1 %16 to i64
...
bb.bd:                                            ; preds = %bb.bb
  ...
  %i.mp = zext i64 %i.mi to i128                  ; 2 uses
...
bb.be:                                            ; preds = %bb.bd
  ...
  %2 = zext i64 %i.my to i128
  %3 = mul nuw i128 %2, %i.mp
  %4 = lshr i128 %3, 64
  %5 = trunc nuw i128 %4 to i64                   ; 2 uses
  %i.mz = add i64 %5, %i.ms                       ; 2 uses
  %6 = icmp ult i64 %i.mz, %5
  %i.na = zext i1 %6 to i64
...
bb.ei:                                            ; preds = %bb.eg
  ...
  %i.ahv = zext i64 %i.aho to i128                ; 2 uses
...
bb.ej:                                            ; preds = %bb.ei
  ...
  %7 = zext i64 %i.aie to i128
  %8 = mul nuw i128 %7, %i.ahv
  %9 = lshr i128 %8, 64
  %10 = trunc nuw i128 %9 to i64                  ; 2 uses
  %i.aif = add i64 %10, %i.ahy                    ; 2 uses
  %11 = icmp ult i64 %i.aif, %10
  %i.aig = zext i1 %11 to i64
...
bb.ht:                                            ; preds = %bb.hr
  ...
  %i.bfn = zext i64 %i.bfg to i128                ; 2 uses
...
bb.hu:                                            ; preds = %bb.ht
  ...
  %12 = zext i64 %i.bfw to i128
  %13 = mul nuw i128 %12, %i.bfn
  %14 = lshr i128 %13, 64
  %15 = trunc nuw i128 %14 to i64                 ; 2 uses
  %i.bfx = add i64 %15, %i.bfq                    ; 2 uses
  %16 = icmp ult i64 %i.bfx, %15
  %i.bfy = zext i1 %16 to i64
