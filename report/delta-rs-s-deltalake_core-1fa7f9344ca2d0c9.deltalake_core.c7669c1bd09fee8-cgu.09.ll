...
_RNCNCNvNtNtNtNtCs14kWLkQVSKO_14deltalake_core6kernel8snapshot9iterators8scan_row16parse_partitionss_00Bd_.exit.i.i.i.i.i.i.i: ; preds = %.noexc.i.i3.i.i.i
  %141 = extractvalue { ptr, i64 } %138, 0        ; [#uses=1 type=ptr]
  %bcmp.i.i.i.i.i.i.i.i = call i32 @bcmp(ptr %141, ptr nonnull %133, i64 %132), !noalias !4881 ; [#uses=1 type=i32]
  %bcmp.i.fr.i.i.i.i.i.i.i = freeze i32 %bcmp.i.i.i.i.i.i.i.i ; [#uses=1 type=i32]
  %142 = icmp eq i32 %bcmp.i.fr.i.i.i.i.i.i.i, 0  ; [#uses=1 type=i1]
...
end_hunk_0
begin_hunk_1
  %.promoted.i = load i64, ptr %4, align 8, !alias.scope !23136, !noalias !23141 ; [#uses=2 type=i64]
  %7 = getelementptr inbounds nuw i8, ptr %0, i64 16 ; [#uses=1 type=ptr]
  %8 = load ptr, ptr %7, align 8, !alias.scope !23143 ; [#uses=1 type=ptr]
  %.fr.i = freeze ptr %8                          ; [#uses=1 type=ptr]
  %.not.i.i.i = icmp eq ptr %.fr.i, null          ; [#uses=1 type=i1]
  %9 = getelementptr inbounds nuw i8, ptr %0, i64 48 ; [#uses=1 type=ptr]
  %10 = load i64, ptr %9, align 8, !alias.scope !23143 ; [#uses=1 type=i64]
  %11 = getelementptr inbounds nuw i8, ptr %0, i64 24 ; [#uses=1 type=ptr]
end_hunk_1
begin_hunk_2
  %.promoted.i = load i64, ptr %4, align 8, !alias.scope !23148, !noalias !23153 ; [#uses=2 type=i64]
  %7 = getelementptr inbounds nuw i8, ptr %0, i64 8 ; [#uses=1 type=ptr]
  %8 = load ptr, ptr %7, align 8, !alias.scope !23155 ; [#uses=1 type=ptr]
  %.fr.i = freeze ptr %8                          ; [#uses=1 type=ptr]
  %.not.i.i.i = icmp eq ptr %.fr.i, null          ; [#uses=1 type=i1]
  %9 = getelementptr inbounds nuw i8, ptr %0, i64 40 ; [#uses=1 type=ptr]
  %10 = load i64, ptr %9, align 8, !alias.scope !23155 ; [#uses=1 type=i64]
  %11 = getelementptr inbounds nuw i8, ptr %0, i64 16 ; [#uses=1 type=ptr]
end_hunk_2
