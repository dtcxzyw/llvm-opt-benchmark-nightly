...
.lr.ph.prol:                                      ; preds = %.lr.ph.preheader
  %.09.val.prol = load i32, ptr %1, align 1
  %i.g = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %.09.val.prol, i64 0
...
.lr.ph.prol.loopexit:                             ; preds = %.lr.ph.prol, %.lr.ph.preheader
  %.unr = phi <16 x i8> [ zeroinitializer, %.lr.ph.preheader ], [ %i.h, %.lr.ph.prol ]
  %.0912.unr = phi ptr [ %1, %.lr.ph.preheader ], [ %i.i, %.lr.ph.prol ]
  %.01011.unr = phi i64 [ %i.c, %.lr.ph.preheader ], [ %i.b, %.lr.ph.prol ]
  %i.j = icmp ult i64 %i.e, 4
  br i1 %i.j, label %._crit_edge, label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  %i.k = phi <16 x i8> [ %i.t, %.lr.ph ], [ %.unr, %.lr.ph.prol.loopexit ]
  %.0912 = phi ptr [ %i.w, %.lr.ph ], [ %.0912.unr, %.lr.ph.prol.loopexit ] ; 4 uses
  %.01011 = phi i64 [ %i.x, %.lr.ph ], [ %.01011.unr, %.lr.ph.prol.loopexit ]
  %.09.val = load i32, ptr %.0912, align 1
  %i.l = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %.09.val, i64 0
  ...
  store i32 %i.p, ptr %.0912, align 1
  %i.q = getelementptr inbounds nuw i8, ptr %.0912, i64 4 ; 2 uses
  %.09.val.1 = load i32, ptr %i.q, align 1
  %i.r = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %.09.val.1, i64 0
  ...
  %i.w = getelementptr inbounds nuw i8, ptr %.0912, i64 8
  %i.x = add i64 %.01011, -8                      ; 2 uses
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  %.01821 = phi ptr [ %i.t, %.lr.ph ], [ %2, %bb.a ] ; 2 uses
  %.01920 = phi i64 [ %i.v, %.lr.ph ], [ %i.c, %bb.a ]
  %.018.val = load i32, ptr %.01821, align 1
  %i.e = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %.018.val, i64 0 ; 2 uses
  ...
  %i.t = getelementptr inbounds nuw i8, ptr %.01821, i64 4
  %i.u = getelementptr inbounds nuw i8, ptr %.023, i64 4
  %i.v = add i64 %.01920, -4                      ; 2 uses
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  %.03643 = phi ptr [ %i.ai, %.lr.ph ], [ %1, %bb.a ] ; 3 uses
  %.03742 = phi <2 x i64> [ %i.h, %.lr.ph ], [ zeroinitializer, %bb.a ]
  %.03841 = phi ptr [ %i.ah, %.lr.ph ], [ %2, %bb.a ] ; 2 uses
  %.03940 = phi i64 [ %i.aj, %.lr.ph ], [ %i.c, %bb.a ]
  ...
  %i.i = insertelement <4 x i32> <i32 poison, i32 0, i32 poison, i32 poison>, i32 %.036.val, i64 0
  ...
  %i.m = bitcast <2 x i64> %.03742 to <8 x i16>   ; 3 uses
  ...
  store i32 %i.ag, ptr %.03643, align 1
  %i.ah = getelementptr inbounds nuw i8, ptr %.03841, i64 4
  %i.ai = getelementptr inbounds nuw i8, ptr %.03643, i64 4
  %i.aj = add i64 %.03940, -4                     ; 2 uses
