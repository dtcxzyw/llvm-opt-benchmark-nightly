...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  %indvars.iv57 = phi i64 [ 0, %.lr.ph.preheader.new ], [ %indvars.iv.next58.1, %.lr.ph ] ; 3 uses
  %indvars.iv = phi i64 [ 0, %.lr.ph.preheader.new ], [ %indvars.iv.next.1, %.lr.ph ] ; 5 uses
  %niter = phi i64 [ 0, %.lr.ph.preheader.new ], [ %niter.next.1, %.lr.ph ]
  %i.af = getelementptr inbounds nuw i8, ptr %i.a, i64 %indvars.iv
  %i.ag = load i8, ptr %i.af, align 2, !tbaa !8
  %i.ah = getelementptr inbounds nuw [3 x i8], ptr %3, i64 %indvars.iv57 ; 3 uses
  ...
  store i8 %i.ak, ptr %i.al, align 1, !tbaa !73
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 3 ; 3 uses
  %i.am = getelementptr inbounds nuw i8, ptr %i.a, i64 %indvars.iv
  ...
  store i8 %i.ao, ptr %i.ap, align 2, !tbaa !74
  %i.aq = getelementptr inbounds nuw i8, ptr %i.a, i64 %indvars.iv.next
  %i.ar = load i8, ptr %i.aq, align 1, !tbaa !8
  %i.as = getelementptr inbounds nuw [3 x i8], ptr %3, i64 %indvars.iv57 ; 3 uses
  %i.at = getelementptr inbounds nuw i8, ptr %i.as, i64 3
  store i8 %i.ar, ptr %i.at, align 1, !tbaa !72
  %i.au = getelementptr inbounds nuw i8, ptr %i.a, i64 %indvars.iv.next
  %i.av = getelementptr inbounds nuw i8, ptr %i.au, i64 1
  %i.aw = load i8, ptr %i.av, align 2, !tbaa !8
  %i.ax = getelementptr inbounds nuw i8, ptr %i.as, i64 4
  store i8 %i.aw, ptr %i.ax, align 2, !tbaa !73
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 6 ; 2 uses
  %i.ay = getelementptr inbounds nuw i8, ptr %i.a, i64 %indvars.iv.next
  %i.az = getelementptr inbounds nuw i8, ptr %i.ay, i64 2
  %i.ba = load i8, ptr %i.az, align 1, !tbaa !8
  %i.bb = getelementptr inbounds nuw i8, ptr %i.as, i64 5
  store i8 %i.ba, ptr %i.bb, align 1, !tbaa !74
...
.lr.ph.epil.preheader:                            ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph.preheader
  %indvars.iv57.epil.init = phi i64 [ 0, %.lr.ph.preheader ], [ %indvars.iv.next58.1, %._crit_edge.loopexit.unr-lcssa ]
  %indvars.iv.epil.init = phi i64 [ 0, %.lr.ph.preheader ], [ %indvars.iv.next.1, %._crit_edge.loopexit.unr-lcssa ] ; 3 uses
  %lcmp.mod63 = trunc i32 %i.w to i1
  call void @llvm.assume(i1 %lcmp.mod63)
  %i.bc = getelementptr inbounds nuw i8, ptr %i.a, i64 %indvars.iv.epil.init
  %i.bd = load i8, ptr %i.bc, align 1, !tbaa !8
  %i.be = getelementptr inbounds nuw [3 x i8], ptr %3, i64 %indvars.iv57.epil.init ; 3 uses
  store i8 %i.bd, ptr %i.be, align 1, !tbaa !72
  %i.bf = getelementptr inbounds nuw i8, ptr %i.a, i64 %indvars.iv.epil.init
  ...
  store i8 %i.bh, ptr %i.bi, align 1, !tbaa !73
  %i.bj = getelementptr inbounds nuw i8, ptr %i.a, i64 %indvars.iv.epil.init
...
._crit_edge:                                      ; preds = %.lr.ph.epil.preheader, %._crit_edge.loopexit.unr-lcssa, %png_crc_read.exit
  %i.bn = load i32, ptr %i.b, align 4, !tbaa !26
  %i.bo = or i32 %i.bn, 2
  store i32 %i.bo, ptr %i.b, align 4, !tbaa !26
...
bb.h:                                             ; preds = %bb.f, %bb.d, %bb.c, %bb.b, %bb.a
  ...
  %i.bp = getelementptr inbounds nuw i8, ptr %0, i64 623
  %i.bq = load i8, ptr %i.bp, align 1, !tbaa !68
  %i.br = icmp eq i8 %i.bq, 3
  br i1 %i.br, label %bb.i, label %bb.j

bb.i:                                             ; preds = %bb.h
  %i.bs = tail call i32 @png_crc_finish(ptr noundef nonnull %0, i32 noundef %2) ; 0 uses
  tail call void @png_chunk_error(ptr noundef nonnull %0, ptr noundef nonnull %.044) #12
  unreachable

bb.j:                                             ; preds = %bb.h
  %i.bt = tail call fastcc i32 @png_crc_finish_critical(ptr noundef nonnull %0, i32 noundef %2, i32 noundef 1) ; 0 uses
