...
bb.am:                                            ; preds = %._crit_edge229.i
  ...
  %3 = fadd float %i.gj, %i.io
  %4 = tail call float @llvm.fmuladd.f32(float %i.il, float 0.000000e+00, float %i.im)
  %i.ip = fadd float %i.gk, %4
  ...
  %i.it = insertelement <2 x float> poison, float %3, i64 0
...
bb.aq:                                            ; preds = %bb.ap
  ...
  %5 = fadd float %i.gj, %i.lb
  %6 = tail call float @llvm.fmuladd.f32(float %i.ky, float 0.000000e+00, float %i.kz)
  %i.lc = fadd float %i.gk, %6
  ...
  %i.lg = insertelement <2 x float> poison, float %5, i64 0
