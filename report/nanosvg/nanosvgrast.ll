...
nsvg__viewAlign.exit163.i:                        ; preds = %bb.ae, %bb.ad, %nsvg__viewAlign.exit.i
  ...
  %3 = insertelement <2 x float> %i.eu, float %i.et, i64 1
  %i.ev = insertelement <2 x float> poison, float %i.eb, i64 0
  %4 = shufflevector <2 x float> %i.ev, <2 x float> poison, <2 x i32> zeroinitializer
  br label %bb.ak
...
nsvg__viewAlign.exit167.i:                        ; preds = %bb.aj, %bb.ai, %nsvg__viewAlign.exit165.i
  ...
  %5 = insertelement <2 x float> %i.fs, float %i.fr, i64 1
  %i.ft = insertelement <2 x float> poison, float %i.ez, i64 0
  %6 = shufflevector <2 x float> %i.ft, <2 x float> poison, <2 x i32> zeroinitializer
  br label %bb.ak

bb.ak:                                            ; preds = %nsvg__viewAlign.exit167.i, %nsvg__viewAlign.exit163.i, %nsvg__convertToPixels.exit.i
  %i.fu = phi <2 x float> [ %3, %nsvg__viewAlign.exit163.i ], [ %5, %nsvg__viewAlign.exit167.i ], [ %i.cd, %nsvg__convertToPixels.exit.i ] ; 6 uses
  %i.fv = phi <2 x float> [ %4, %nsvg__viewAlign.exit163.i ], [ %6, %nsvg__viewAlign.exit167.i ], [ %i.ck, %nsvg__convertToPixels.exit.i ]
  ...
  %i.fy = fmul <2 x float> %i.fx, %i.fv           ; 8 uses
...
.lr.ph238.i:                                      ; preds = %bb.ak
  ...
  %i.gk = shufflevector <2 x float> %i.fu, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1> ; 2 uses
  %broadcast.splat58 = shufflevector <2 x float> %i.fu, <2 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splat60 = shufflevector <2 x float> %i.fy, <2 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splat62 = shufflevector <2 x float> %i.fu, <2 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
...
bb.am:                                            ; preds = %._crit_edge229.i
  ...
  %7 = insertelement <2 x float> poison, float %i.ii, i64 0
  %i.ik = insertelement <2 x float> %7, float %i.ij, i64 1
  %8 = fadd <2 x float> %i.fu, %i.ik              ; 2 uses
  %9 = shufflevector <2 x float> %8, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %10 = fmul <2 x float> %i.gi, %9
  %i.il = shufflevector <2 x float> %8, <2 x float> poison, <2 x i32> zeroinitializer
  %i.im = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.il, <2 x float> %i.gf, <2 x float> %10)
...
bb.aq:                                            ; preds = %bb.ap
  ...
  %11 = insertelement <2 x float> poison, float %i.ks, i64 0
  %i.ku = insertelement <2 x float> %11, float %i.kt, i64 1
  %12 = fadd <2 x float> %i.fu, %i.ku             ; 2 uses
  %13 = shufflevector <2 x float> %12, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %14 = fmul <2 x float> %i.gi, %13
  %i.kv = shufflevector <2 x float> %12, <2 x float> poison, <2 x i32> zeroinitializer
  %i.kw = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.kv, <2 x float> %i.gf, <2 x float> %14)
