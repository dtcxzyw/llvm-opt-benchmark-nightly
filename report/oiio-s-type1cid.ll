begin_hunk_0
  ...
  %194 = sub i64 %192, %193                       ; [#uses=2 type=i64]
  %195 = trunc i64 %194 to i32                    ; [#uses=2 type=i32]
...
.preheader154.i.i:                                ; preds = %190
  ...
  %198 = and i64 %194, 4294967295                 ; [#uses=3 type=i64]
...
206:                                              ; preds = %.preheader.us.i.i
  ...
  %exitcond170.not.i.i = icmp eq i64 %indvars.iv.next.i.i, %198 ; [#uses=1 type=i1]
