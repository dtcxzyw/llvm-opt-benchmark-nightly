...
.lr.ph.i.i.i:                                     ; preds = %70
  %72 = load i64, ptr %15, align 8, !tbaa !12     ; [#uses=1 type=i64]
  %.fr9.i.i = freeze i64 %72                      ; [#uses=7 type=i64]
  %73 = load ptr, ptr %7, align 8                 ; [#uses=2 type=ptr]
  %74 = icmp eq i64 %.fr9.i.i, 0                  ; [#uses=2 type=i1]
...
_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i.i: ; preds = %.lr.ph.i.split.i.i
  ...
  %84 = call i32 @memcmp(ptr noundef %83, ptr noundef %73, i64 noundef %.fr9.i.i) #21 ; [#uses=1 type=i32]
...
begin_hunk_2
  ...
  %.not.i3.i.i = icmp eq i64 %.fr9.i.i, %92       ; [#uses=1 type=i1]
  br i1 %.not.i3.i.i, label %94, label %93

93:                                               ; preds = %89
  %.not53 = icmp ugt i64 %.fr9.i.i, %92           ; [#uses=1 type=i1]
...
_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i: ; preds = %94
  ...
  %96 = call i32 @memcmp(ptr noundef %73, ptr noundef %95, i64 noundef %.fr9.i.i) #21 ; [#uses=1 type=i32]
...
.lr.ph:                                           ; preds = %2
  ...
  %6 = load i64, ptr %5, align 8, !tbaa !12       ; [#uses=1 type=i64]
  %.fr40 = freeze i64 %6                          ; [#uses=4 type=i64]
  %7 = icmp eq i64 %.fr40, 0                      ; [#uses=1 type=i1]
...
_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i: ; preds = %.lr.ph.split
  ...
  %16 = tail call i32 @memcmp(ptr noundef %8, ptr noundef %15, i64 noundef %.fr40) #21 ; [#uses=1 type=i32]
