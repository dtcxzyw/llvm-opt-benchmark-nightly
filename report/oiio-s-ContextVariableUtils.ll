...
.lr.ph.i.i.i:                                     ; preds = %70
  %72 = load i64, ptr %15, align 8, !tbaa !12     ; 7 uses
  %73 = load ptr, ptr %7, align 8                 ; 2 uses
  %74 = icmp eq i64 %72, 0                        ; 2 uses
  br i1 %74, label %.lr.ph.i.split.us.i.i, label %.lr.ph.i.split.i.i

.lr.ph.i.split.us.i.i:                            ; preds = %.lr.ph.i.i.i, %.lr.ph.i.split.us.i.i
end_hunk_0
begin_hunk_1
  %.0812.i.i.i = phi ptr [ %.19.i.i.i, %_ZNK16OpenColorIO_v2_59EnvMapKeyINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS6_S9_.exit.thread.i.i.i ], [ %22, %.lr.ph.i.i.i ]
  %78 = getelementptr inbounds nuw i8, ptr %.013.i.i.i, i64 40
  %79 = load i64, ptr %78, align 8, !tbaa !12     ; 2 uses
  %.not.i.i.i.i = icmp eq i64 %79, %72
  br i1 %.not.i.i.i.i, label %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i.i, label %80

80:                                               ; preds = %.lr.ph.i.split.i.i
  %81 = icmp ugt i64 %79, %72
...
_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i.i: ; preds = %.lr.ph.i.split.i.i
  %82 = getelementptr inbounds nuw i8, ptr %.013.i.i.i, i64 32
  %83 = load ptr, ptr %82, align 8, !tbaa !15
  %84 = call i32 @memcmp(ptr noundef %83, ptr noundef %73, i64 noundef %72) #21
...
end_hunk_1
begin_hunk_2
  %90 = getelementptr inbounds nuw i8, ptr %.us-phi.i.i, i64 32
  %91 = getelementptr inbounds nuw i8, ptr %.us-phi.i.i, i64 40
  %92 = load i64, ptr %91, align 8, !tbaa !12     ; 2 uses
  %.not.i3.i.i = icmp eq i64 %72, %92
  br i1 %.not.i3.i.i, label %94, label %93

93:                                               ; preds = %89
  %.not53 = icmp ugt i64 %72, %92
...
_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i: ; preds = %94
  ...
  %96 = call i32 @memcmp(ptr noundef %73, ptr noundef %95, i64 noundef %72) #21
...
.lr.ph:                                           ; preds = %2
  ...
  %6 = load i64, ptr %5, align 8, !tbaa !12       ; 4 uses
  %7 = icmp eq i64 %6, 0
...
_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i: ; preds = %.lr.ph.split
  ...
  %16 = tail call i32 @memcmp(ptr noundef %8, ptr noundef %15, i64 noundef %6) #21
