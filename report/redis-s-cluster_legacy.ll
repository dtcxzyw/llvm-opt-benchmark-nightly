...
.outer:                                           ; preds = %.loopexit.split.us, %284
  %.5.ph = phi ptr [ %.7, %.loopexit.split.us ], [ %.4.fr, %284 ] ; 8 uses
...
begin_hunk_2
  ...
  %301 = getelementptr i8, ptr %.5.ph, i64 %300
...
16:                                               ; preds = %16, %.lr.ph.new
  ...
  %.04181 = phi i32 [ 0, %.lr.ph.new ], [ %.142.1, %16 ]
...
.epil.preheader:                                  ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph
  ...
  %.04181.epil.init = phi i32 [ 0, %.lr.ph ], [ %.142.1, %._crit_edge.loopexit.unr-lcssa ]
  %lcmp.mod107 = trunc i32 %11 to i1
...
begin_hunk_8
  ...
  %.142.epil = add nuw nsw i32 %.04181.epil.init, %35
  br label %._crit_edge

._crit_edge:                                      ; preds = %.epil.preheader, %._crit_edge.loopexit.unr-lcssa, %.preheader80
  %.041.lcssa = phi i32 [ 0, %.preheader80 ], [ %.142.1, %._crit_edge.loopexit.unr-lcssa ], [ %.142.epil, %.epil.preheader ]
...
begin_hunk_9
  ...
  %.not5287 = icmp eq ptr %40, null
  br i1 %.not5287, label %._crit_edge92, label %.lr.ph91

.lr.ph91:                                         ; preds = %37, %.loopexit
  %41 = phi ptr [ %102, %.loopexit ], [ %40, %37 ]
  %.04389 = phi ptr [ %.3, %.loopexit ], [ %3, %37 ] ; 3 uses
  %.04688 = phi ptr [ %.248, %.loopexit ], [ null, %37 ] ; 3 uses
...
begin_hunk_11
  ...
  %xtraiter109 = and i64 %wide.trip.count.i, 1
  %53 = icmp eq i32 %49, 1
  br i1 %53, label %.epil.preheader108, label %.lr.ph.i.new

.lr.ph.i.new:                                     ; preds = %.lr.ph.i
  %unroll_iter113 = and i64 %wide.trip.count.i, 2147483646
  br label %54
...
54:                                               ; preds = %54, %.lr.ph.i.new
  ...
  %niter114 = phi i64 [ 0, %.lr.ph.i.new ], [ %niter114.next.1, %54 ]
  ...
  %.fr78.1 = freeze i32 %66
  %67 = lshr i32 %.fr78.1, 3
  %68 = and i32 %67, 1
  %69 = xor i32 %68, 1
  %spec.select.i.1 = add i32 %69, %spec.select.i  ; 3 uses
...
.epil.preheader108:                               ; preds = %clusterCountNonFailingSlaves.exit.unr-lcssa, %.lr.ph.i
  ...
  %lcmp.mod112 = trunc i32 %49 to i1
  ...
  %.fr78.epil = freeze i32 %73
  %74 = lshr i32 %.fr78.epil, 3
  %75 = and i32 %74, 1
  %76 = xor i32 %75, 1
  %spec.select.i.epil = add i32 %76, %.08.i.epil.init
...
clusterCountNonFailingSlaves.exit:                ; preds = %clusterCountNonFailingSlaves.exit.unr-lcssa, %.epil.preheader108
  %spec.select.i.lcssa = phi i32 [ %spec.select.i.1, %clusterCountNonFailingSlaves.exit.unr-lcssa ], [ %spec.select.i.epil, %.epil.preheader108 ] ; 2 uses
  %.not79 = icmp ne i32 %spec.select.i.lcssa, 0
...
82:                                               ; preds = %78, %77
  %.147 = phi ptr [ %.04688, %77 ], [ %spec.select65, %78 ] ; 2 uses
...
88:                                               ; preds = %82, %85, %.thread
  ...
  %.248 = phi ptr [ %.147, %82 ], [ %.147, %85 ], [ %.04688, %.thread ] ; 2 uses
...
.lr.ph85:                                         ; preds = %.preheader
  ...
  %wide.trip.count99 = zext nneg i32 %91 to i64
  br label %95

95:                                               ; preds = %.lr.ph85, %95
  %indvars.iv96 = phi i64 [ 0, %.lr.ph85 ], [ %indvars.iv.next97, %95 ] ; 2 uses
  %.14483 = phi ptr [ %.04389, %.lr.ph85 ], [ %spec.select66, %95 ] ; 2 uses
  %96 = getelementptr inbounds nuw [8 x i8], ptr %94, i64 %indvars.iv96
  %97 = load ptr, ptr %96, align 8, !tbaa !54     ; 2 uses
  %98 = getelementptr inbounds nuw i8, ptr %97, i64 8
  %99 = getelementptr inbounds nuw i8, ptr %.14483, i64 8
  ...
  %spec.select66 = select i1 %101, ptr %97, ptr %.14483 ; 2 uses
...
.loopexit:                                        ; preds = %95, %.preheader, %88
  %.3 = phi ptr [ %.04389, %88 ], [ %.04389, %.preheader ], [ %spec.select66, %95 ] ; 2 uses
...
122:                                              ; preds = %.lr.ph441
  ...
  %125 = icmp slt i64 %indvars.iv.next482, %124
...
.lr.ph.split.i.preheader.us:                      ; preds = %.lr.ph443, %.loopexit410.us
  ...
  %128 = getelementptr inbounds nuw [8 x i8], ptr %127, i64 %indvars.iv487
...
.loopexit410.us:                                  ; preds = %137
  ...
  %144 = icmp slt i64 %indvars.iv.next488, %143
  br i1 %144, label %.lr.ph.split.i.preheader.us, label %._crit_edge444, !llvm.loop !319

.lr.ph441:                                        ; preds = %111, %122
  %indvars.iv481 = phi i64 [ %indvars.iv.next482, %122 ], [ 2, %111 ] ; 2 uses
  %145 = load ptr, ptr %5, align 8, !tbaa !310
  %146 = getelementptr inbounds nuw [8 x i8], ptr %145, i64 %indvars.iv481
...
.critedge.us.i.preheader:                         ; preds = %.lr.ph443, %.loopexit413
  ...
  %152 = getelementptr inbounds nuw [8 x i8], ptr %151, i64 %indvars.iv484
...
.loopexit413:                                     ; preds = %160
  ...
  %167 = icmp slt i64 %indvars.iv.next485, %166
...
.lr.ph.split.us:                                  ; preds = %.lr.ph, %.loopexit415.us
  ...
  %196 = getelementptr inbounds nuw [8 x i8], ptr %195, i64 %indvars.iv478
...
200:                                              ; preds = %.lr.ph.split.us
  ...
  %202 = getelementptr inbounds nuw [8 x i8], ptr %201, i64 %indvars.iv478
...
.loopexit415.us:                                  ; preds = %221
  ...
  %223 = trunc nuw i64 %indvars.iv.next479 to i32
...
409:                                              ; preds = %406, %398
  ...
  %.pre492 = load ptr, ptr getelementptr inbounds nuw (i8, ptr @server, i64 8224), align 8, !tbaa !65 ; 2 uses
  br i1 %411, label %412, label %417

412:                                              ; preds = %409
  %413 = getelementptr inbounds nuw i8, ptr %.pre492, i64 48
...
417:                                              ; preds = %416, %412, %409
  %418 = getelementptr inbounds nuw i8, ptr %.pre492, i64 262192
  ...
  %.pre494 = load ptr, ptr @myself, align 8, !tbaa !54 ; 4 uses
  br i1 %422, label %425, label %444

425:                                              ; preds = %417
  %.not320 = icmp eq ptr %386, %.pre494
  br i1 %.not320, label %.thread, label %426

.thread:                                          ; preds = %425
  %.pre495521 = load ptr, ptr getelementptr inbounds nuw (i8, ptr @server, i64 8224), align 8, !tbaa !65
  br label %447

426:                                              ; preds = %425
  %427 = getelementptr inbounds nuw i8, ptr %.pre494, i64 2164
...
begin_hunk_29
  ...
  %.pre493 = load ptr, ptr @myself, align 8, !tbaa !54
  br label %444

444:                                              ; preds = %439, %426, %417
  %445 = phi ptr [ %.pre493, %439 ], [ %.pre494, %426 ], [ %.pre494, %417 ]
  %446 = icmp eq ptr %386, %445
  %.pre495 = load ptr, ptr getelementptr inbounds nuw (i8, ptr @server, i64 8224), align 8, !tbaa !65 ; 2 uses
  br i1 %446, label %447, label %465

447:                                              ; preds = %.thread, %444
  %.pre495522 = phi ptr [ %.pre495521, %.thread ], [ %.pre495, %444 ] ; 2 uses
  %448 = getelementptr inbounds nuw i8, ptr %.pre495522, i64 131120
...
465:                                              ; preds = %444, %447, %457, %358, %367, %320
  %466 = phi ptr [ %.pre495, %444 ], [ %.pre495522, %447 ], [ %458, %457 ], [ %359, %358 ], [ %368, %367 ], [ %321, %320 ]
...
752:                                              ; preds = %751
  ...
  %.pre491 = load ptr, ptr getelementptr inbounds nuw (i8, ptr @server, i64 8224), align 8, !tbaa !65
  br label %753

753:                                              ; preds = %751, %752
  %754 = phi ptr [ %742, %751 ], [ %.pre491, %752 ]
...
797:                                              ; preds = %794
  ...
  %.pre490 = load i64, ptr %4, align 8, !tbaa !222
  br label %798

798:                                              ; preds = %794, %797
  %799 = phi i64 [ %775, %794 ], [ %.pre490, %797 ] ; 2 uses
