...
bb.d:                                             ; preds = %bb.c
  ...
  %i.cg = load i8, ptr %i.cf, align 1, !tbaa !17  ; 2 uses
...
bb.h:                                             ; preds = %bb.d
  ...
  %26 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %i.al
...
.lr.ph.i:                                         ; preds = %bb.r, %.lr.ph.preheader.i
  ...
  %i.ei = load i8, ptr %i.eh, align 1, !tbaa !17  ; 2 uses
  ...
  %i.en = load i8, ptr %i.em, align 1, !tbaa !17  ; 2 uses
  ...
  %28 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %i.et
  ...
  %30 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %i.fi
  ...
  %32 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %i.fx
...
bb.q:                                             ; preds = %bb.m
  ...
  %46 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %i.ep
...
bb.b:                                             ; preds = %bb.a
  ...
  %.val.i.i = load i16, ptr %2, align 1, !tbaa !12 ; 3 uses
  ...
  %.val.i.i16 = load i16, ptr %4, align 1, !tbaa !12 ; 3 uses
  ...
  %.val.i.i21 = load i16, ptr %6, align 1, !tbaa !12 ; 3 uses
  ...
  %12 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %11
  ...
  %15 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %14
...
bb.e:                                             ; preds = %bb.d
  ...
  %20 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %19
...
.thread:                                          ; preds = %..thread_crit_edge, %bb.e, %bb.d
  ...
  %23 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %22
...
bb.f:                                             ; preds = %bb.b
  ...
  %25 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %i.ak
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.p
  ...
  %27 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %i.es
  ...
  %29 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %i.fh
  ...
  %31 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %i.fw
...
bb.i:                                             ; preds = %bb.h, %.lr.ph
  ...
  %34 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %33
  ...
  %37 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %36
...
bb.n:                                             ; preds = %bb.m
  ...
  %40 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %39
...
.thread133:                                       ; preds = %..thread133_crit_edge, %bb.n, %bb.m
  ...
  %43 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %42
...
bb.o:                                             ; preds = %bb.k
  ...
  %45 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %i.eo
...
._crit_edge:                                      ; preds = %bb.p, %bb.g
  ...
  %48 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %47
  ...
  %51 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %50
  ...
  %54 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %53
