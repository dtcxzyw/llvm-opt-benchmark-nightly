...
bb.d:                                             ; preds = %bb.c
  ...
  %i.h = zext i16 %.val.i.i.i to i32              ; 3 uses
  ...
  %i.ae = zext i16 %.val.i.i16.i to i32           ; 3 uses
  ...
  %i.ba = zext i16 %.val.i.i21.i to i32           ; 3 uses
  ...
  %.sroa.0.0.copyload.i23.i = load i32, ptr %i.bi, align 4, !tbaa !15
  ...
  %i.bw = load i16, ptr %i.bv, align 4, !tbaa !19
  ...
  %notmask.i.i = shl nsw i32 -1, %i.bz
  %12 = xor i32 %notmask.i.i, -1
  %i.ca = zext i16 %i.bw to i32
  %i.cb = and i32 %12, %i.ca
  %i.cc = zext nneg i32 %i.cb to i64
  %i.cd = getelementptr inbounds nuw i8, ptr %i.bu, i64 6
  %i.ce = load i16, ptr %i.cd, align 2, !tbaa !20
  %i.cf = getelementptr inbounds nuw i8, ptr @ML_bits, i64 %i.o
  %i.cg = load i8, ptr %i.cf, align 1, !tbaa !17
  %i.ch = zext i8 %i.cg to i32                    ; 2 uses
  %notmask.i26.i = shl nsw i32 -1, %i.ch
  %13 = xor i32 %notmask.i26.i, -1
  %14 = zext i16 %i.ce to i32
  %15 = and i32 %13, %14
  %16 = zext nneg i32 %15 to i64
  %i.ci = zext nneg i8 %i.by to i64
  %i.cj = shl i64 %16, %i.ci
...
bb.g:                                             ; preds = %bb.f
  ...
  %notmask.i27.i = shl nsw i32 -1, %i.cn
  %17 = xor i32 %notmask.i27.i, -1
  %i.co = and i32 %.pre158.i, %17
  ...
  store i64 %i.cs, ptr %0, align 1, !tbaa !23
...
.thread.i:                                        ; preds = %bb.g, %bb.f, %..thread_crit_edge.i
  ...
  %notmask.i28.i = shl nsw i32 -1, %i.dd
  %18 = xor i32 %notmask.i28.i, -1
  %i.df = and i32 %i.de, %18
...
bb.h:                                             ; preds = %bb.d
  %i.dl = load i32, ptr %i.bu, align 4, !tbaa !21
  %notmask.i29.i = shl nsw i32 -1, %i.ad
  %19 = xor i32 %notmask.i29.i, -1
  %i.dm = and i32 %i.dl, %19
...
bb.i:                                             ; preds = %bb.h, %.thread.i
  ...
  store i64 %.sroa.058.1.i, ptr %.sroa.112.1.i, align 1, !tbaa !23
...
.lr.ph.i:                                         ; preds = %bb.r, %.lr.ph.preheader.i
  ...
  %i.et = lshr i64 %i.es, 16                      ; 2 uses
  %i.eu = trunc nuw nsw i64 %i.et to i32          ; 2 uses
  %notmask.i.i.i = shl nsw i32 -1, %i.eu
  %20 = xor i32 %notmask.i.i.i, -1
  ...
  %i.fe = load i16, ptr %i.fd, align 2, !tbaa !12
  %i.ff = getelementptr inbounds nuw [8 x i8], ptr %i.n, i64 %i.el ; 2 uses
  %.sroa.0.0.copyload.i30.i = load i32, ptr %i.ff, align 4, !tbaa !15
  ...
  %i.fi = lshr i64 %i.fh, 16                      ; 2 uses
  %i.fj = trunc nuw nsw i64 %i.fi to i32          ; 2 uses
  %notmask.i.i37.i = shl nsw i32 -1, %i.fj
  %21 = xor i32 %notmask.i.i37.i, -1
  %i.fk = zext nneg i32 %21 to i64
  ...
  %i.ft = load i16, ptr %i.fs, align 2, !tbaa !12
  %i.fu = getelementptr inbounds nuw [8 x i8], ptr %i.bg, i64 %i.eg ; 2 uses
  %.sroa.0.0.copyload.i33.i = load i32, ptr %i.fu, align 4, !tbaa !15
  ...
  %i.fx = lshr i64 %i.fw, 16                      ; 2 uses
  %i.fy = trunc nuw nsw i64 %i.fx to i32          ; 2 uses
  %notmask.i.i41.i = shl nsw i32 -1, %i.fy
  %22 = xor i32 %notmask.i.i41.i, -1
  %i.fz = zext nneg i32 %22 to i64
  ...
  %i.gl = load i16, ptr %i.gk, align 2, !tbaa !12
...
bb.j:                                             ; preds = %.lr.ph.i
  ...
  store i64 %i.gf, ptr %.sroa.112.2143.i, align 1, !tbaa !23
...
bb.k:                                             ; preds = %bb.j, %.lr.ph.i
  ...
  %i.gy = load i16, ptr %i.gx, align 4, !tbaa !19
  %notmask.i43.i = shl nsw i32 -1, %i.ej
  %23 = xor i32 %notmask.i43.i, -1
  %i.gz = zext i16 %i.gy to i32
  %i.ha = and i32 %i.gz, %23
  ...
  %i.hh = load i16, ptr %i.hg, align 2, !tbaa !20
  %notmask.i44.i = shl nsw i32 -1, %i.eo
  %24 = xor i32 %notmask.i44.i, -1
  %i.hi = zext i16 %i.hh to i32
  %i.hj = and i32 %i.hi, %24
...
bb.l:                                             ; preds = %bb.k
  ...
  store i64 %i.hn, ptr %.sroa.112.3.i, align 1, !tbaa !23
...
..thread133_crit_edge.i:                          ; preds = %bb.n
  %.pre159.i = load i32, ptr %i.gw, align 4, !tbaa !21
  br label %.thread133.i

bb.o:                                             ; preds = %bb.n
  %.not94.i.i = icmp eq i8 %i.ed, 56
  %.pre160.i = load i32, ptr %i.gw, align 4, !tbaa !21 ; 3 uses
  br i1 %.not94.i.i, label %.thread133.i, label %bb.p

bb.p:                                             ; preds = %bb.o
  %i.hy = add nsw i32 %i.ek, -56                  ; 3 uses
  %notmask.i46.i = shl nsw i32 -1, %i.hy
  %25 = xor i32 %notmask.i46.i, -1
  %i.hz = and i32 %.pre160.i, %25
  ...
  store i64 %i.id, ptr %.sroa.112.4.i, align 1, !tbaa !23
...
.thread133.i:                                     ; preds = %bb.p, %bb.o, %..thread133_crit_edge.i
  ...
  %notmask.i48.i = shl nsw i32 -1, %i.io
  %26 = xor i32 %notmask.i48.i, -1
  %i.iq = and i32 %i.ip, %26
...
bb.q:                                             ; preds = %bb.m
  %i.iw = load i32, ptr %i.gw, align 4, !tbaa !21
  %notmask.i49.i = shl nsw i32 -1, %i.ek
  %27 = xor i32 %notmask.i49.i, -1
  %i.ix = and i32 %i.iw, %27
...
bb.r:                                             ; preds = %bb.q, %.thread133.i
  ...
  store i64 %.sroa.058.6.i, ptr %.sroa.112.6.i, align 1, !tbaa !23
...
._crit_edge.i:                                    ; preds = %bb.r, %bb.i
  ...
  %notmask.i.i51.i = shl nsw i32 -1, %i.h
  %28 = xor i32 %notmask.i.i51.i, -1
  %i.jl = zext nneg i32 %28 to i64
  ...
  store i64 %i.jp, ptr %.sroa.112.2.lcssa.i, align 1, !tbaa !23
  ...
  store i64 %i.la, ptr %spec.store.select.i.i41.i, align 1, !tbaa !23
...
BIT_closeCStream.exit.i:                          ; preds = %._crit_edge.i
  ...
  br i1 %i.ln, label %BIT_closeCStream.exit.thread.i, label %ZSTD_encodeSequences_default.exit
...
ZSTD_encodeSequences_default.exit:                ; preds = %BIT_closeCStream.exit.thread.i, %BIT_closeCStream.exit.i, %bb.c, %bb.b
  %.0 = phi i64 [ %i.a, %bb.b ], [ -70, %bb.c ], [ -70, %BIT_closeCStream.exit.thread.i ], [ %i.lm, %BIT_closeCStream.exit.i ]
  ret i64 %.0
}
...
bb.a:
  ...
  br i1 %i.c, label %bb.b, label %ZSTD_encodeSequences_body.exit
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.g = zext i16 %.val.i.i to i32                ; 3 uses
  ...
  %.sroa.0.0.copyload.i = load i32, ptr %i.o, align 4, !tbaa !15
  ...
  %i.ad = zext i16 %.val.i.i16 to i32             ; 3 uses
  ...
  %.sroa.0.0.copyload.i18 = load i32, ptr %i.al, align 4, !tbaa !15
  ...
  %i.az = zext i16 %.val.i.i21 to i32             ; 3 uses
  ...
  %.sroa.0.0.copyload.i23 = load i32, ptr %i.bh, align 4, !tbaa !15
  ...
  %notmask.i = shl nsw i32 -1, %i.by
  %11 = xor i32 %notmask.i, -1
  %i.bz = zext i16 %i.bv to i32
  %i.ca = and i32 %11, %i.bz
  ...
  %12 = xor i32 %notmask.i26, -1
  %13 = zext i16 %i.cd to i32
  %14 = and i32 %12, %13
  %15 = zext nneg i32 %14 to i64
  %i.ch = zext nneg i8 %i.bx to i64
  %i.ci = shl i64 %15, %i.ch
...
..thread_crit_edge:                               ; preds = %bb.c
  %.pre = load i32, ptr %i.bt, align 4, !tbaa !21
  br label %.thread

bb.d:                                             ; preds = %bb.c
  %.not93.i = icmp eq i8 %i.ab, 56
  %.pre158 = load i32, ptr %i.bt, align 4, !tbaa !21 ; 3 uses
  br i1 %.not93.i, label %.thread, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.cm = add nsw i32 %i.ac, -56                  ; 3 uses
  %notmask.i27 = shl nsw i32 -1, %i.cm
  %16 = xor i32 %notmask.i27, -1
  %i.cn = and i32 %.pre158, %16
  ...
  store i64 %i.cr, ptr %0, align 1, !tbaa !23
...
.thread:                                          ; preds = %..thread_crit_edge, %bb.e, %bb.d
  ...
  %notmask.i28 = shl nsw i32 -1, %i.dc
  %17 = xor i32 %notmask.i28, -1
  %i.de = and i32 %i.dd, %17
...
bb.f:                                             ; preds = %bb.b
  %i.dk = load i32, ptr %i.bt, align 4, !tbaa !21
  %notmask.i29 = shl nsw i32 -1, %i.ac
  %18 = xor i32 %notmask.i29, -1
  %i.dl = and i32 %i.dk, %18
...
bb.g:                                             ; preds = %bb.f, %.thread
  ...
  store i64 %.sroa.058.1, ptr %.sroa.112.1, align 1, !tbaa !23
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.p
  ...
  %i.ej = zext i8 %i.ec to i32                    ; 5 uses
  ...
  %i.en = zext i8 %i.em to i32                    ; 3 uses
  %i.eo = zext i8 %i.ec to i64
  %i.ep = getelementptr inbounds nuw [8 x i8], ptr %i.aj, i64 %i.eo ; 2 uses
  %.sroa.0.0.copyload.i27 = load i32, ptr %i.ep, align 4, !tbaa !15
  %.sroa.4.0..sroa_idx.i28 = getelementptr inbounds nuw i8, ptr %i.ep, i64 4
  %.sroa.4.0.copyload.i29 = load i32, ptr %.sroa.4.0..sroa_idx.i28, align 4, !tbaa !15
  %i.eq = zext i32 %.sroa.4.0.copyload.i29 to i64
  %i.er = add nuw nsw i64 %.sroa.046.0146, %i.eq
  %i.es = lshr i64 %i.er, 16                      ; 2 uses
  %i.et = trunc nuw nsw i64 %i.es to i32          ; 2 uses
  %notmask.i.i = shl nsw i32 -1, %i.et
  %19 = xor i32 %notmask.i.i, -1
  %i.eu = zext nneg i32 %19 to i64
  ...
  %.sroa.0.0.copyload.i30 = load i32, ptr %i.fe, align 4, !tbaa !15
  %.sroa.4.0..sroa_idx.i31 = getelementptr inbounds nuw i8, ptr %i.fe, i64 4
  %.sroa.4.0.copyload.i32 = load i32, ptr %.sroa.4.0..sroa_idx.i31, align 4, !tbaa !15
  %i.ff = zext i32 %.sroa.4.0.copyload.i32 to i64
  %i.fg = add nuw nsw i64 %.sroa.052.0147, %i.ff
  %i.fh = lshr i64 %i.fg, 16                      ; 2 uses
  %i.fi = trunc nuw nsw i64 %i.fh to i32          ; 2 uses
  %notmask.i.i37 = shl nsw i32 -1, %i.fi
  %20 = xor i32 %notmask.i.i37, -1
  %i.fj = zext nneg i32 %20 to i64
  ...
  %.sroa.0.0.copyload.i33 = load i32, ptr %i.ft, align 4, !tbaa !15
  %.sroa.4.0..sroa_idx.i34 = getelementptr inbounds nuw i8, ptr %i.ft, i64 4
  %.sroa.4.0.copyload.i35 = load i32, ptr %.sroa.4.0..sroa_idx.i34, align 4, !tbaa !15
  %i.fu = zext i32 %.sroa.4.0.copyload.i35 to i64
  %i.fv = add nuw nsw i64 %.sroa.0.0145, %i.fu
  %i.fw = lshr i64 %i.fv, 16                      ; 2 uses
  %i.fx = trunc nuw nsw i64 %i.fw to i32          ; 2 uses
  %notmask.i.i41 = shl nsw i32 -1, %i.fx
  %21 = xor i32 %notmask.i.i41, -1
  %i.fy = zext nneg i32 %21 to i64
...
bb.h:                                             ; preds = %.lr.ph
  ...
  store i64 %i.ge, ptr %.sroa.112.2143, align 1, !tbaa !23
...
bb.i:                                             ; preds = %bb.h, %.lr.ph
  ...
  %i.gx = load i16, ptr %i.gw, align 4, !tbaa !19
  %notmask.i43 = shl nsw i32 -1, %i.ei
  %22 = xor i32 %notmask.i43, -1
  %i.gy = zext i16 %i.gx to i32
  %i.gz = and i32 %i.gy, %22
  ...
  %i.hg = load i16, ptr %i.hf, align 2, !tbaa !20
  %notmask.i44 = shl nsw i32 -1, %i.en
  %23 = xor i32 %notmask.i44, -1
  %i.hh = zext i16 %i.hg to i32
  %i.hi = and i32 %i.hh, %23
...
bb.j:                                             ; preds = %bb.i
  ...
  store i64 %i.hm, ptr %.sroa.112.3, align 1, !tbaa !23
...
..thread133_crit_edge:                            ; preds = %bb.l
  %.pre159 = load i32, ptr %i.gv, align 4, !tbaa !21
  br label %.thread133

bb.m:                                             ; preds = %bb.l
  %.not94.i = icmp eq i8 %i.ec, 56
  %.pre160 = load i32, ptr %i.gv, align 4, !tbaa !21 ; 3 uses
  br i1 %.not94.i, label %.thread133, label %bb.n

bb.n:                                             ; preds = %bb.m
  %i.hx = add nsw i32 %i.ej, -56                  ; 3 uses
  %notmask.i46 = shl nsw i32 -1, %i.hx
  %24 = xor i32 %notmask.i46, -1
  %i.hy = and i32 %.pre160, %24
  ...
  store i64 %i.ic, ptr %.sroa.112.4, align 1, !tbaa !23
...
.thread133:                                       ; preds = %..thread133_crit_edge, %bb.n, %bb.m
  ...
  %notmask.i48 = shl nsw i32 -1, %i.in
  %25 = xor i32 %notmask.i48, -1
  %i.ip = and i32 %i.io, %25
...
bb.o:                                             ; preds = %bb.k
  %i.iv = load i32, ptr %i.gv, align 4, !tbaa !21
  %notmask.i49 = shl nsw i32 -1, %i.ej
  %26 = xor i32 %notmask.i49, -1
  %i.iw = and i32 %i.iv, %26
...
bb.p:                                             ; preds = %bb.o, %.thread133
  ...
  store i64 %.sroa.058.6, ptr %.sroa.112.6, align 1, !tbaa !23
...
._crit_edge:                                      ; preds = %bb.p, %bb.g
  ...
  %notmask.i.i51 = shl nsw i32 -1, %i.g
  %27 = xor i32 %notmask.i.i51, -1
  %i.jk = zext nneg i32 %27 to i64
  ...
  store i64 %i.jo, ptr %.sroa.112.2.lcssa, align 1, !tbaa !23
  ...
  %notmask.i.i52 = shl nsw i32 -1, %i.ad
  %28 = xor i32 %notmask.i.i52, -1
  %i.jx = zext nneg i32 %28 to i64
  ...
  store i64 %i.kb, ptr %spec.store.select.i.i, align 1, !tbaa !23
  ...
  store i64 %i.kz, ptr %spec.store.select.i.i41, align 1, !tbaa !23
  ...
  br i1 %.not.i43, label %BIT_closeCStream.exit, label %BIT_closeCStream.exit.thread
...
BIT_closeCStream.exit:                            ; preds = %._crit_edge
  ...
  br i1 %i.lm, label %BIT_closeCStream.exit.thread, label %ZSTD_encodeSequences_body.exit

BIT_closeCStream.exit.thread:                     ; preds = %._crit_edge, %BIT_closeCStream.exit
  br label %ZSTD_encodeSequences_body.exit

ZSTD_encodeSequences_body.exit:                   ; preds = %BIT_closeCStream.exit.thread, %BIT_closeCStream.exit, %bb.a
  %.1.i = phi i64 [ -70, %bb.a ], [ -70, %BIT_closeCStream.exit.thread ], [ %i.ll, %BIT_closeCStream.exit ]
  ret i64 %.1.i
}
...
!17 = !{!7, !7, i64 0}
!18 = !{!"SeqDef_s", !8, i64 0, !11, i64 4, !11, i64 6}
!19 = !{!18, !11, i64 4}
!20 = !{!18, !11, i64 6}
!21 = !{!18, !8, i64 0}
!22 = !{!"long", !7, i64 0}
