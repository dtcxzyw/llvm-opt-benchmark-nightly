...
bb.c:                                             ; preds = %bb.b
  ...
  %.val.i.i52 = load i16, ptr %4, align 1, !tbaa !9 ; 3 uses
  %i.i = zext i16 %.val.i.i52 to i32              ; 3 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.ay = lshr i64 %i.ax, 16                      ; 3 uses
  %i.az = trunc nuw nsw i64 %i.ay to i32          ; 2 uses
  %6 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %i.ay
  %7 = load i32, ptr %6, align 4, !tbaa !17
  %i.ba = zext i32 %7 to i64
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.cn = lshr i64 %i.cm, 16                      ; 3 uses
  %i.co = trunc nuw nsw i64 %i.cn to i32
  %8 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %i.cn
  %9 = load i32, ptr %8, align 4, !tbaa !17
  %i.cp = zext i32 %9 to i64
  ...
  %i.dg = lshr i64 %i.df, 16                      ; 3 uses
  %i.dh = trunc nuw nsw i64 %i.dg to i32
  %10 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %i.dg
...
bb.m:                                             ; preds = %.lr.ph, %bb.m
  ...
  %i.en = lshr i64 %i.em, 16                      ; 3 uses
  %i.eo = trunc nuw nsw i64 %i.en to i32
  %12 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %i.en
  %13 = load i32, ptr %12, align 4, !tbaa !17
  %i.ep = zext i32 %13 to i64
  ...
  %i.fg = lshr i64 %i.ff, 16                      ; 3 uses
  %i.fh = trunc nuw nsw i64 %i.fg to i32
  %14 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %i.fg
  %15 = load i32, ptr %14, align 4, !tbaa !17
  %i.fi = zext i32 %15 to i64
  ...
  %i.fz = lshr i64 %i.fy, 16                      ; 3 uses
  %i.ga = trunc nuw nsw i64 %i.fz to i32
  %16 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %i.fz
  %17 = load i32, ptr %16, align 4, !tbaa !17
  %i.gb = zext i32 %17 to i64
  ...
  %i.gs = lshr i64 %i.gr, 16                      ; 3 uses
  %i.gt = trunc nuw nsw i64 %i.gs to i32
  %18 = getelementptr inbounds nuw [4 x i8], ptr @BIT_mask, i64 %i.gs
  %19 = load i32, ptr %18, align 4, !tbaa !17
  %i.gu = zext i32 %19 to i64
