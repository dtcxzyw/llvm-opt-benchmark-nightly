...
BIT_reloadDStream.exit22.i:                       ; preds = %bb.ae, %bb.ad
  ...
  %.sroa.0.7.i = load i64, ptr %.sroa.9790.7.i, align 1, !tbaa !23 ; 3 uses
...
BIT_reloadDStream.exit22:                         ; preds = %bb.ab, %bb.ac
  ...
  %.sroa.0.7 = load i64, ptr %.sroa.9790.7, align 1, !tbaa !23 ; 3 uses
...
bb.f:                                             ; preds = %bb.e
  %.val.i = load i64, ptr %i.s, align 1, !tbaa !23
  ...
  %i.ab = load ptr, ptr %i.k, align 8, !tbaa !48  ; 8 uses
...
BIT_reloadDStream.exit:                           ; preds = %bb.h, %bb.i
  ...
  %.sroa.0.2 = load i64, ptr %.sroa.6235.2, align 1, !tbaa !23 ; 6 uses
...
BIT_reloadDStream.exit67:                         ; preds = %bb.o, %bb.p
  ...
  %.sroa.0.6 = load i64, ptr %.sroa.6235.6, align 1, !tbaa !23 ; 3 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.z = tail call range(i64 0, 65) i64 @llvm.cttz.i64(i64 %i.y, i1 true) ; 2 uses
  %i.aa = trunc nuw nsw i64 %i.z to i32           ; 5 uses
  %i.ab = load ptr, ptr %i.k, align 8, !tbaa !48  ; 6 uses
...
BIT_reloadDStream.exit43.i:                       ; preds = %bb.i, %bb.h
  ...
  %.sroa.0.2 = load i64, ptr %.sroa.3820.2, align 1, !tbaa !23 ; 6 uses
