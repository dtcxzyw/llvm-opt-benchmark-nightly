...
vector.ph:                                        ; preds = %.lr.ph59
  ...
  %broadcast.splatinsert = insertelement <2 x i8> poison, i8 %i.y, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.z = getelementptr inbounds nuw i8, ptr %i.a, i64 %index ; 2 uses
  %i.aa = getelementptr inbounds nuw i8, ptr %i.z, i64 2
  %wide.load = load <2 x i8>, ptr %i.z, align 4, !tbaa !8 ; 2 uses
  %wide.load95 = load <2 x i8>, ptr %i.aa, align 2, !tbaa !8 ; 2 uses
  %i.ab = getelementptr inbounds nuw [8 x i8], ptr %i.g, i64 %index ; 2 uses
  %i.ac = sub <2 x i8> %broadcast.splat, %wide.load
  %i.ad = sub <2 x i8> %broadcast.splat, %wide.load95
  %i.ae = icmp eq <2 x i8> %wide.load, zeroinitializer
  %i.af = icmp eq <2 x i8> %wide.load95, zeroinitializer
  %i.ag = select <2 x i1> %i.ae, <2 x i8> zeroinitializer, <2 x i8> %i.ac
  %i.ah = select <2 x i1> %i.af, <2 x i8> zeroinitializer, <2 x i8> %i.ad
  %i.ai = zext <2 x i8> %i.ag to <2 x i64>
  %i.aj = zext <2 x i8> %i.ah to <2 x i64>
  %i.ak = getelementptr inbounds nuw i8, ptr %i.ab, i64 16
  store <2 x i64> %i.ai, ptr %i.ab, align 8, !tbaa !16
  store <2 x i64> %i.aj, ptr %i.ak, align 8, !tbaa !16
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.al = icmp eq i64 %index.next, %n.vec
  br i1 %i.al, label %middle.block, label %vector.body, !llvm.loop !31

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %n.vec, %wide.trip.count78
  br i1 %cmp.n, label %.lr.ph62.preheader, label %scalar.ph.preheader

scalar.ph.preheader:                              ; preds = %.lr.ph59, %middle.block
  %indvars.iv75.ph = phi i64 [ 0, %.lr.ph59 ], [ %n.vec, %middle.block ]
  br label %scalar.ph

.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  %indvars.iv = phi i64 [ 1, %.lr.ph.preheader.new ], [ %indvars.iv.next.1, %.lr.ph ] ; 4 uses
  %.04857 = phi i32 [ 0, %.lr.ph.preheader.new ], [ %i.ax, %.lr.ph ] ; 2 uses
  %niter = phi i64 [ 0, %.lr.ph.preheader.new ], [ %niter.next.1, %.lr.ph ]
  %i.am = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %indvars.iv ; 2 uses
  %i.an = load i32, ptr %i.am, align 4, !tbaa !21
  %i.ao = trunc i64 %indvars.iv to i32
  %i.ap = add nsw i32 %i.ao, -1
  %i.aq = shl i32 %i.an, %i.ap
  %i.ar = add i32 %i.aq, %.04857                  ; 2 uses
  store i32 %.04857, ptr %i.am, align 4, !tbaa !21
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.as = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %indvars.iv.next ; 2 uses
  %i.at = load i32, ptr %i.as, align 4, !tbaa !21
  %i.au = trunc i64 %indvars.iv.next to i32
  %i.av = add i32 %i.au, -1
  %i.aw = shl i32 %i.at, %i.av
  %i.ax = add i32 %i.aw, %i.ar                    ; 2 uses
  store i32 %i.ar, ptr %i.as, align 4, !tbaa !21
...
bb.a:
  ...
  %i.c = alloca [14 x i32], align 16              ; 12 uses
...
.epil.preheader:                                  ; preds = %.preheader49.preheader.i.unr-lcssa, %bb.c
  ...
  %lcmp.mod101 = trunc i32 %i.l to i1
...
.preheader48.i.preheader.new:                     ; preds = %.preheader48.i.preheader
  %unroll_iter105 = and i64 %wide.trip.count.i, 510
...
.preheader48.i:                                   ; preds = %.preheader48.i, %.preheader48.i.preheader.new
  ...
  %niter106 = phi i64 [ 0, %.preheader48.i.preheader.new ], [ %niter106.next.1, %.preheader48.i ]
  ...
  br i1 %niter106.ncmp.1, label %.preheader.i.preheader.unr-lcssa, label %.preheader48.i, !llvm.loop !46

.preheader.i.preheader.unr-lcssa:                 ; preds = %.preheader48.i
  %lcmp.mod103.not = icmp eq i64 %xtraiter102, 0
  br i1 %lcmp.mod103.not, label %.preheader.i.preheader, label %.preheader48.i.epil.preheader
...
.preheader48.i.epil.preheader:                    ; preds = %.preheader.i.preheader.unr-lcssa, %.preheader48.i.preheader
  ...
  %lcmp.mod104 = trunc i32 %i.l to i1
...
bb.g:                                             ; preds = %bb.g, %HUF_sort.exit
  %indvars.iv = phi i32 [ %indvars.iv.next, %bb.g ], [ %i.ds, %HUF_sort.exit ] ; 2 uses
  %indvars.iv121.i = phi i32 [ %indvars.iv.next122.i, %bb.g ], [ %i.l, %HUF_sort.exit ] ; 3 uses
  %indvars.iv113.i = phi i32 [ %indvars.iv.next114.i, %bb.g ], [ %i.dr, %HUF_sort.exit ] ; 2 uses
...
.lr.ph.preheader.i:                               ; preds = %bb.h
  %i.eh = tail call i32 @llvm.umax.i32(i32 %indvars.iv, i32 257) ; 2 uses
  %i.ei = zext i32 %i.eh to i64                   ; 3 uses
  %xtraiter120 = and i64 %i.ei, 7                 ; 3 uses
  %6 = add i32 %i.eh, -257
  %7 = icmp ult i32 %6, 7
  br i1 %7, label %.lr.ph.i.epil.preheader, label %.lr.ph.preheader.i.new

.lr.ph.preheader.i.new:                           ; preds = %.lr.ph.preheader.i
  %i.ej = and i64 %i.ei, 4294967288
  %i.ek = add nsw i64 %i.ej, -264
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.lr.ph.i, %.lr.ph.preheader.i.new
  %indvars.iv107.i = phi i64 [ 257, %.lr.ph.preheader.i.new ], [ %indvars.iv.next108.i.7, %.lr.ph.i ] ; 9 uses
  %niter111 = phi i64 [ 0, %.lr.ph.preheader.i.new ], [ %niter111.next.7, %.lr.ph.i ] ; 2 uses
  %i.el = getelementptr inbounds nuw [8 x i8], ptr %i.h, i64 %indvars.iv107.i
  store i32 1073741824, ptr %i.el, align 4, !tbaa !43
  %i.em = getelementptr inbounds nuw [8 x i8], ptr %i.h, i64 %indvars.iv107.i
  ...
  %niter111.next.7 = add i64 %niter111, 8
  %niter111.ncmp.7 = icmp eq i64 %niter111, %i.ek
  br i1 %niter111.ncmp.7, label %.lr.ph96.preheader.i.unr-lcssa, label %.lr.ph.i, !llvm.loop !50

.lr.ph96.preheader.i.unr-lcssa:                   ; preds = %.lr.ph.i
  %lcmp.mod108.not = icmp eq i64 %xtraiter120, 0
  br i1 %lcmp.mod108.not, label %.lr.ph96.preheader.i, label %.lr.ph.i.epil.preheader
...
.lr.ph.i.epil.preheader:                          ; preds = %.lr.ph96.preheader.i.unr-lcssa, %.lr.ph.preheader.i
  ...
  %lcmp.mod109 = icmp ne i64 %xtraiter120, 0
...
.lr.ph.i.epil:                                    ; preds = %.lr.ph.i.epil, %.lr.ph.i.epil.preheader
  ...
  %i.fa = getelementptr inbounds nuw [8 x i8], ptr %i.h, i64 %indvars.iv107.i.epil
  ...
  br i1 %epil.iter.cmp.not, label %.lr.ph96.preheader.i, label %.lr.ph.i.epil, !llvm.loop !51
...
.lr.ph96.i:                                       ; preds = %.lr.ph96.i, %.lr.ph96.preheader.i
  %indvars.iv110.i = phi i64 [ 257, %.lr.ph96.preheader.i ], [ %indvars.iv.next111.i, %.lr.ph96.i ] ; 4 uses
  ...
  %i.fb = sext i32 %.07394.i to i64
  %i.fc = getelementptr inbounds [8 x i8], ptr %i.h, i64 %i.fb
  %i.fd = load i32, ptr %i.fc, align 4, !tbaa !43
  %i.fe = sext i32 %.07493.i to i64
  %i.ff = getelementptr inbounds [8 x i8], ptr %i.h, i64 %i.fe
  %i.fg = load i32, ptr %i.ff, align 4, !tbaa !43
  %i.fh = icmp uge i32 %i.fd, %i.fg               ; 3 uses
  %i.fi = zext i1 %i.fh to i32
  %.175.i = add nsw i32 %.07493.i, %i.fi          ; 3 uses
  %not..i = xor i1 %i.fh, true
  %i.fj = sext i1 %not..i to i32
  %.1.i = add nsw i32 %.07394.i, %i.fj            ; 3 uses
  %i.fk = select i1 %i.fh, i32 %.07493.i, i32 %.07394.i
  %i.fl = sext i32 %.1.i to i64
  ...
  %i.fr = icmp uge i32 %i.fn, %i.fq               ; 3 uses
  %i.fs = zext i1 %i.fr to i32
  %.276.i = add nsw i32 %.175.i, %i.fs
  %not.86.i = xor i1 %i.fr, true
  %i.ft = sext i1 %not.86.i to i32
  %.2.i = add nsw i32 %.1.i, %i.ft
  %i.fu = select i1 %i.fr, i32 %.175.i, i32 %.1.i
  ...
  %i.gc = getelementptr inbounds nuw [8 x i8], ptr %i.h, i64 %indvars.iv110.i
  store i32 %i.gb, ptr %i.gc, align 4, !tbaa !43
  %i.gd = trunc i64 %indvars.iv110.i to i16       ; 2 uses
  ...
  %exitcond63.not = icmp eq i64 %indvars.iv110.i, %i.ei
  br i1 %exitcond63.not, label %.lr.ph100.preheader.i, label %.lr.ph96.i, !llvm.loop !52

.lr.ph100.preheader.i:                            ; preds = %.lr.ph96.i
  %8 = zext nneg i32 %i.dz to i64
  %i.gg = getelementptr inbounds nuw [8 x i8], ptr %i.h, i64 %8
  %i.gh = getelementptr inbounds nuw i8, ptr %i.gg, i64 7
  store i8 0, ptr %i.gh, align 1, !tbaa !53
  %i.gi = zext i32 %indvars.iv113.i to i64
  br label %.lr.ph100.i
...
.lr.ph103.preheader.i:                            ; preds = %.lr.ph100.i, %.preheader.i28
  ...
  %xtraiter112 = and i64 %wide.trip.count.i26, 3  ; 3 uses
  %i.gl = add i32 %indvars.iv121.i, -1
  %i.gm = icmp ult i32 %i.gl, 3
  br i1 %i.gm, label %.lr.ph103.i.epil.preheader, label %.lr.ph103.preheader.i.new

.lr.ph103.preheader.i.new:                        ; preds = %.lr.ph103.preheader.i
  %unroll_iter116 = and i64 %wide.trip.count.i26, 4294967292
  br label %.lr.ph103.i

.lr.ph100.i:                                      ; preds = %.lr.ph100.i, %.lr.ph100.preheader.i
  %indvars.iv115.i = phi i64 [ %i.gi, %.lr.ph100.preheader.i ], [ %indvars.iv.next116.i, %.lr.ph100.i ] ; 3 uses
  %i.gn = getelementptr inbounds nuw [8 x i8], ptr %i.h, i64 %indvars.iv115.i ; 2 uses
  ...
  %i.gw = icmp samesign ugt i64 %indvars.iv115.i, 256
  br i1 %i.gw, label %.lr.ph100.i, label %.lr.ph103.preheader.i, !llvm.loop !54
...
.lr.ph103.i:                                      ; preds = %.lr.ph103.i, %.lr.ph103.preheader.i.new
  ...
  %niter117 = phi i64 [ 0, %.lr.ph103.preheader.i.new ], [ %niter117.next.3, %.lr.ph103.i ]
  %i.gx = getelementptr inbounds nuw [8 x i8], ptr %i.h, i64 %indvars.iv118.i ; 2 uses
  ...
  %i.hg = getelementptr inbounds nuw [8 x i8], ptr %i.h, i64 %indvars.iv118.i ; 2 uses
  ...
  %i.hp = getelementptr inbounds nuw [8 x i8], ptr %i.h, i64 %indvars.iv118.i ; 2 uses
  ...
  %i.hy = getelementptr inbounds nuw [8 x i8], ptr %i.h, i64 %indvars.iv118.i ; 2 uses
  ...
  br i1 %niter117.ncmp.3, label %HUF_buildTree.exit.loopexit.unr-lcssa, label %.lr.ph103.i, !llvm.loop !55

HUF_buildTree.exit.loopexit.unr-lcssa:            ; preds = %.lr.ph103.i
  %lcmp.mod114.not = icmp eq i64 %xtraiter112, 0
  br i1 %lcmp.mod114.not, label %HUF_buildTree.exit, label %.lr.ph103.i.epil.preheader

.lr.ph103.i.epil.preheader:                       ; preds = %HUF_buildTree.exit.loopexit.unr-lcssa, %.lr.ph103.preheader.i
  %indvars.iv118.i.epil.init = phi i64 [ 0, %.lr.ph103.preheader.i ], [ %indvars.iv.next119.i.3, %HUF_buildTree.exit.loopexit.unr-lcssa ]
...
.lr.ph103.i.epil:                                 ; preds = %.lr.ph103.i.epil, %.lr.ph103.i.epil.preheader
  ...
  %epil.iter113 = phi i64 [ 0, %.lr.ph103.i.epil.preheader ], [ %epil.iter113.next, %.lr.ph103.i.epil ]
  %i.ih = getelementptr inbounds nuw [8 x i8], ptr %i.h, i64 %indvars.iv118.i.epil ; 2 uses
  ...
  br i1 %epil.iter113.cmp.not, label %HUF_buildTree.exit, label %.lr.ph103.i.epil, !llvm.loop !56

HUF_buildTree.exit:                               ; preds = %HUF_buildTree.exit.loopexit.unr-lcssa, %.lr.ph103.i.epil, %.preheader.i28
...
bb.i:                                             ; preds = %HUF_buildTree.exit
  ...
  br i1 %i.ja, label %.lr.ph.i35, label %.preheader113.i
...
.preheader113.loopexit.i:                         ; preds = %bb.j
  %i.jc = trunc nsw i64 %indvars.iv.next.i37 to i32
...
.preheader113.i:                                  ; preds = %.preheader113.loopexit.i, %bb.i
  ...
  %.086.lcssa.i = phi i32 [ %i.jh, %.preheader113.loopexit.i ], [ 0, %bb.i ]
  br label %bb.k

bb.j:                                             ; preds = %bb.j, %.lr.ph.i35
  %indvars.iv.i36 = phi i64 [ %indvars.iv.i24, %.lr.ph.i35 ], [ %indvars.iv.next.i37, %bb.j ] ; 2 uses
  %i.jd = phi i32 [ %i.iz, %.lr.ph.i35 ], [ %i.jl, %bb.j ]
  %i.je = phi ptr [ %i.ix, %.lr.ph.i35 ], [ %i.jj, %bb.j ]
  %.086116.i = phi i32 [ 0, %.lr.ph.i35 ], [ %i.jh, %bb.j ]
  %i.jf = sub nsw i32 %i.iu, %i.jd
  %.neg108.i = shl nsw i32 -1, %i.jf
  %i.jg = add i32 %.086116.i, %i.iw
  ...
  %i.ji = getelementptr [8 x i8], ptr %.0.i, i64 %indvars.iv.i36
...
bb.l:                                             ; preds = %bb.k
  %i.js = ashr i32 %.086.lcssa.i, %i.iv           ; 3 uses
...
.lr.ph120.preheader.i:                            ; preds = %bb.l
  ...
  %i.jv = and i64 %i.ju, 1
  %lcmp.mod119.not.not = icmp eq i64 %i.jv, 0
  br i1 %lcmp.mod119.not.not, label %.lr.ph120.i.prol, label %.lr.ph120.i.prol.loopexit
...
.lr.ph120.i.prol.loopexit.unr-lcssa:              ; preds = %bb.m, %.lr.ph120.i.prol
  %.195.i.prol = phi i32 [ %spec.store.select, %.lr.ph120.i.prol ], [ %i.jz, %bb.m ]
...
.preheader112.i:                                  ; preds = %.lr.ph120.i.prol.loopexit, %bb.p, %bb.l
  ...
  br i1 %i.ke, label %.lr.ph134.i.preheader, label %.preheader111.i

.lr.ph134.i.preheader:                            ; preds = %.preheader112.i
  %.phi.trans.insert = getelementptr inbounds nuw i8, ptr %i.c, i64 52
  br label %.lr.ph134.i
...
.lr.ph120.i:                                      ; preds = %.lr.ph120.i.prol.loopexit, %bb.p
  ...
  %.not107.i = icmp ugt i32 %.094118.i, %i.ki
...
.lr.ph120.i.1:                                    ; preds = %bb.n, %.lr.ph120.i
  %.195.i = phi i32 [ %.094118.i, %.lr.ph120.i ], [ %i.ki, %bb.n ] ; 2 uses
  ...
  %.not107.i.1 = icmp ugt i32 %.195.i, %i.kq
...
bb.p:                                             ; preds = %bb.o, %.lr.ph120.i.1
  %.195.i.1 = phi i32 [ %.195.i, %.lr.ph120.i.1 ], [ %i.kq, %bb.o ]
...
.preheader111.i:                                  ; preds = %bb.u, %.preheader112.i
  %.187.lcssa.i = phi i32 [ %i.js, %.preheader112.i ], [ %i.lv, %bb.u ] ; 2 uses
  %i.kx = icmp slt i32 %.187.lcssa.i, 0
...
.lr.ph134.i:                                      ; preds = %.lr.ph134.i.preheader, %bb.u
  %.187133.i = phi i32 [ %i.lv, %bb.u ], [ %i.js, %.lr.ph134.i.preheader ] ; 2 uses
  %i.kz = tail call range(i32 0, 32) i32 @llvm.ctlz.i32(i32 %.187133.i, i1 true) ; 2 uses
...
.lr.ph122.i:                                      ; preds = %select.unfold.i, %.lr.ph122.preheader.i
  ...
  %i.lc = load i32, ptr %i.lb, align 4, !tbaa !21 ; 3 uses
...
select.unfold.i:                                  ; preds = %bb.r, %.lr.ph122.i
  ...
  %9 = and i64 %indvars.iv.next161.i, 4294967294
  %.not185.i = icmp eq i64 %9, 0
  br i1 %.not185.i, label %.lr.ph129.i.preheader, label %.lr.ph122.i, !llvm.loop !60

.thread.i:                                        ; preds = %bb.r, %bb.q
  %i.lo = trunc nuw i64 %indvars.iv160.i to i32
...
.lr.ph129.i:                                      ; preds = %.lr.ph129.i.preheader, %bb.s
  ...
  %i.lr = load i32, ptr %i.lq, align 4, !tbaa !21 ; 2 uses
  %i.ls = icmp eq i32 %i.lr, -252645136
  br i1 %i.ls, label %bb.s, label %.critedge.loopexit.split.loop.exit189.i
...
bb.s:                                             ; preds = %.lr.ph129.i
  ...
  br i1 %exitcond.not.i34, label %.critedge.i.loopexit, label %.lr.ph129.i, !llvm.loop !61

.critedge.loopexit.split.loop.exit189.i:          ; preds = %.lr.ph129.i
  %i.lt = trunc nuw nsw i64 %indvars.iv163.i to i32
  br label %.critedge.i

.critedge.i.loopexit:                             ; preds = %bb.s
  %.pre = load i32, ptr %.phi.trans.insert, align 4, !tbaa !21
  br label %.critedge.i

.critedge.i:                                      ; preds = %.critedge.i.loopexit, %.critedge.loopexit.split.loop.exit189.i, %.thread.i
  %10 = phi i32 [ %i.lc, %.thread.i ], [ %i.lr, %.critedge.loopexit.split.loop.exit189.i ], [ %.pre, %.critedge.i.loopexit ] ; 4 uses
  %.192.lcssa.i = phi i32 [ %i.lo, %.thread.i ], [ %i.lt, %.critedge.loopexit.split.loop.exit189.i ], [ 13, %.critedge.i.loopexit ] ; 3 uses
  %i.lu = add nsw i32 %.192.lcssa.i, -1           ; 2 uses
  %.neg.i = shl nsw i32 -1, %i.lu
  %i.lv = add nsw i32 %.neg.i, %.187133.i         ; 3 uses
  %i.lw = zext nneg i32 %.192.lcssa.i to i64
  %i.lx = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %i.lw
...
bb.t:                                             ; preds = %.critedge.i
  ...
  %i.mo = sub nsw i32 %spec.store.select, %.192.lcssa.i
...
bb.u:                                             ; preds = %bb.t, %.critedge.i
  ...
  store i32 %storemerge.i33, ptr %i.lx, align 4
...
bb.v:                                             ; preds = %bb.w, %.lr.ph137.i
  ...
  %.2136.i = phi i32 [ %.2.ph142.i, %.lr.ph137.i ], [ %i.nn, %bb.w ] ; 4 uses
  %i.mr = icmp eq i32 %i.mq, -252645136
  br i1 %i.mr, label %.preheader.i32, label %bb.w
...
.preheader.i32:                                   ; preds = %bb.v, %.preheader.i32
  ...
  br i1 %i.mw, label %.preheader.i32, label %.outer.i, !llvm.loop !63
...
.outer.i:                                         ; preds = %.preheader.i32
  ...
  %i.ne = add nuw nsw i32 %.2136.i, 1
  %i.nf = icmp slt i32 %.2136.i, -1
...
.lr.ph137.i:                                      ; preds = %.outer.i, %.lr.ph137.lr.ph.i
  ...
  %.2.ph142.i = phi i32 [ %.187.lcssa.i, %.lr.ph137.lr.ph.i ], [ %i.ne, %.outer.i ]
...
HUF_setMaxHeight.exit:                            ; preds = %HUF_buildTree.exit, %.outer._crit_edge.i
  %.0.i31 = phi i32 [ %spec.store.select, %.outer._crit_edge.i ], [ %i.iu, %HUF_buildTree.exit ] ; 6 uses
  %i.no = icmp samesign ugt i32 %.0.i31, 12
...
.lr.ph.preheader.i38:                             ; preds = %bb.x
  ...
  %wide.trip.count.i39 = and i64 %i.nq, 4294967295
  %i.nr = add nsw i64 %wide.trip.count.i39, -1
  %xtraiter120.a = and i64 %i.nq, 3               ; 3 uses
  %i.ns = icmp ult i64 %i.nr, 3
  br i1 %i.ns, label %.lr.ph.i40.epil.preheader, label %.lr.ph.preheader.i38.new

.lr.ph.preheader.i38.new:                         ; preds = %.lr.ph.preheader.i38
  %unroll_iter124 = and i64 %i.nq, 4294967292
  br label %.lr.ph.i40

.preheader37.i.loopexit.unr-lcssa:                ; preds = %.lr.ph.i40
  %lcmp.mod122.not = icmp eq i64 %xtraiter120.a, 0
...
.lr.ph.i40.epil.preheader:                        ; preds = %.preheader37.i.loopexit.unr-lcssa, %.lr.ph.preheader.i38
  ...
  %lcmp.mod123 = icmp ne i64 %xtraiter120.a, 0
...
.lr.ph.i40.epil:                                  ; preds = %.lr.ph.i40.epil, %.lr.ph.i40.epil.preheader
  ...
  %i.nt = getelementptr inbounds nuw [8 x i8], ptr %i.h, i64 %indvars.iv.i41.epil
  ...
  %epil.iter121.cmp.not = icmp eq i64 %epil.iter121.next, %xtraiter120.a
...
.lr.ph42.preheader.i:                             ; preds = %.preheader37.i
  %i.oa = zext nneg i32 %.0.i31 to i64            ; 4 uses
  %xtraiter126 = and i64 %i.oa, 3                 ; 3 uses
  %i.ob = icmp ult i32 %.0.i31, 4
  br i1 %i.ob, label %.lr.ph42.i.epil.preheader, label %.lr.ph42.preheader.i.new

.lr.ph42.preheader.i.new:                         ; preds = %.lr.ph42.preheader.i
  %unroll_iter130 = and i64 %i.oa, 12
  br label %.lr.ph42.i
...
.lr.ph.i40:                                       ; preds = %.lr.ph.i40, %.lr.ph.preheader.i38.new
  ...
  %i.oc = getelementptr inbounds nuw [8 x i8], ptr %i.h, i64 %indvars.iv.i41
  ...
  %i.oj = getelementptr inbounds nuw [8 x i8], ptr %i.h, i64 %indvars.iv.i41
  ...
  %i.oq = getelementptr inbounds nuw [8 x i8], ptr %i.h, i64 %indvars.iv.i41
  ...
  %i.ox = getelementptr inbounds nuw [8 x i8], ptr %i.h, i64 %indvars.iv.i41
...
.lr.ph42.i:                                       ; preds = %.lr.ph42.i, %.lr.ph42.preheader.i.new
  ...
  %i.pu = getelementptr inbounds nuw [2 x i8], ptr %i.a, i64 %indvars.iv.next47.i.2
...
.lr.ph42.i.epil.preheader:                        ; preds = %.preheader36.i.preheader.loopexit.unr-lcssa, %.lr.ph42.preheader.i
  %indvars.iv46.i.epil.init = phi i64 [ %i.oa, %.lr.ph42.preheader.i ], [ %indvars.iv.next47.i.3, %.preheader36.i.preheader.loopexit.unr-lcssa ]
  %.041.i.epil.init = phi i16 [ 0, %.lr.ph42.preheader.i ], [ %i.px, %.preheader36.i.preheader.loopexit.unr-lcssa ]
...
.lr.ph42.i.epil:                                  ; preds = %.lr.ph42.i.epil, %.lr.ph42.i.epil.preheader
  ...
  %.041.i.epil = phi i16 [ %.041.i.epil.init, %.lr.ph42.i.epil.preheader ], [ %i.qc, %.lr.ph42.i.epil ] ; 2 uses
  %epil.iter127 = phi i64 [ 0, %.lr.ph42.i.epil.preheader ], [ %epil.iter127.next, %.lr.ph42.i.epil ]
  %i.py = getelementptr inbounds nuw [2 x i8], ptr %i.b, i64 %indvars.iv46.i.epil
  store i16 %.041.i.epil, ptr %i.py, align 2, !tbaa !34
  %i.pz = getelementptr inbounds nuw [2 x i8], ptr %i.a, i64 %indvars.iv46.i.epil
  %i.qa = load i16, ptr %i.pz, align 2, !tbaa !34
  %i.qb = add i16 %i.qa, %.041.i.epil
...
.preheader36.i.preheader:                         ; preds = %.preheader36.i.preheader.loopexit.unr-lcssa, %.lr.ph42.i.epil, %.preheader37.i
  ...
  %i.qd = icmp ult i32 %2, 3
  br i1 %i.qd, label %.preheader36.i.epil.preheader, label %.preheader36.i.preheader.new
...
.preheader36.i:                                   ; preds = %.preheader36.i, %.preheader36.i.preheader.new
  ...
  %i.qe = getelementptr inbounds nuw [8 x i8], ptr %i.h, i64 %indvars.iv48.i ; 2 uses
  %i.qf = getelementptr inbounds nuw i8, ptr %i.qe, i64 6
  %i.qg = load i8, ptr %i.qf, align 2, !tbaa !45
  %i.qh = zext i8 %i.qg to i64
  %i.qi = getelementptr inbounds nuw [8 x i8], ptr %i.np, i64 %i.qh
  %i.qj = getelementptr inbounds nuw i8, ptr %i.qe, i64 7
  %i.qk = load i8, ptr %i.qj, align 1, !tbaa !53
  %i.ql = zext i8 %i.qk to i64
  store i64 %i.ql, ptr %i.qi, align 8, !tbaa !16
  %i.qm = getelementptr inbounds nuw [8 x i8], ptr %i.h, i64 %indvars.iv48.i ; 2 uses
  %i.qn = getelementptr inbounds nuw i8, ptr %i.qm, i64 14
  %i.qo = load i8, ptr %i.qn, align 2, !tbaa !45
  %i.qp = zext i8 %i.qo to i64
  %i.qq = getelementptr inbounds nuw [8 x i8], ptr %i.np, i64 %i.qp
  %i.qr = getelementptr inbounds nuw i8, ptr %i.qm, i64 15
  %i.qs = load i8, ptr %i.qr, align 1, !tbaa !53
  %i.qt = zext i8 %i.qs to i64
  store i64 %i.qt, ptr %i.qq, align 8, !tbaa !16
  %i.qu = getelementptr inbounds nuw [8 x i8], ptr %i.h, i64 %indvars.iv48.i ; 2 uses
  %i.qv = getelementptr inbounds nuw i8, ptr %i.qu, i64 22
  %i.qw = load i8, ptr %i.qv, align 2, !tbaa !45
  %i.qx = zext i8 %i.qw to i64
  %i.qy = getelementptr inbounds nuw [8 x i8], ptr %i.np, i64 %i.qx
  %i.qz = getelementptr inbounds nuw i8, ptr %i.qu, i64 23
  %i.ra = load i8, ptr %i.qz, align 1, !tbaa !53
  %i.rb = zext i8 %i.ra to i64
  store i64 %i.rb, ptr %i.qy, align 8, !tbaa !16
  %i.rc = getelementptr inbounds nuw [8 x i8], ptr %i.h, i64 %indvars.iv48.i ; 2 uses
  %i.rd = getelementptr inbounds nuw i8, ptr %i.rc, i64 30
  %i.re = load i8, ptr %i.rd, align 2, !tbaa !45
  %i.rf = zext i8 %i.re to i64
  %i.rg = getelementptr inbounds nuw [8 x i8], ptr %i.np, i64 %i.rf
  %i.rh = getelementptr inbounds nuw i8, ptr %i.rc, i64 31
  %i.ri = load i8, ptr %i.rh, align 1, !tbaa !53
  %i.rj = zext i8 %i.ri to i64
  store i64 %i.rj, ptr %i.rg, align 8, !tbaa !16
  ...
  br i1 %niter137.ncmp.3, label %.preheader.i45.preheader.unr-lcssa, label %.preheader36.i, !llvm.loop !69

.preheader.i45.preheader.unr-lcssa:               ; preds = %.preheader36.i
  %lcmp.mod134.not = icmp eq i64 %xtraiter132, 0
  br i1 %lcmp.mod134.not, label %.preheader.i45.preheader, label %.preheader36.i.epil.preheader

.preheader36.i.epil.preheader:                    ; preds = %.preheader.i45.preheader.unr-lcssa, %.preheader36.i.preheader
  %indvars.iv48.i.epil.init = phi i64 [ 0, %.preheader36.i.preheader ], [ %indvars.iv.next49.i.3, %.preheader.i45.preheader.unr-lcssa ]
  %lcmp.mod135 = icmp ne i64 %xtraiter132, 0
  tail call void @llvm.assume(i1 %lcmp.mod135)
  br label %.preheader36.i.epil

.preheader36.i.epil:                              ; preds = %.preheader36.i.epil, %.preheader36.i.epil.preheader
  %indvars.iv48.i.epil = phi i64 [ %indvars.iv.next49.i.epil, %.preheader36.i.epil ], [ %indvars.iv48.i.epil.init, %.preheader36.i.epil.preheader ] ; 2 uses
  %epil.iter133 = phi i64 [ %epil.iter133.next, %.preheader36.i.epil ], [ 0, %.preheader36.i.epil.preheader ]
  %i.rk = getelementptr inbounds nuw [8 x i8], ptr %i.h, i64 %indvars.iv48.i.epil ; 2 uses
  %i.rl = getelementptr inbounds nuw i8, ptr %i.rk, i64 6
  %i.rm = load i8, ptr %i.rl, align 2, !tbaa !45
  %i.rn = zext i8 %i.rm to i64
  %i.ro = getelementptr inbounds nuw [8 x i8], ptr %i.np, i64 %i.rn
  %i.rp = getelementptr inbounds nuw i8, ptr %i.rk, i64 7
  %i.rq = load i8, ptr %i.rp, align 1, !tbaa !53
  %i.rr = zext i8 %i.rq to i64
  store i64 %i.rr, ptr %i.ro, align 8, !tbaa !16
  ...
  br i1 %epil.iter133.cmp.not, label %.preheader.i45.preheader, label %.preheader36.i.epil, !llvm.loop !70

.preheader.i45.preheader:                         ; preds = %.preheader36.i.epil, %.preheader.i45.preheader.unr-lcssa
  br label %.preheader.i45

.preheader.i45:                                   ; preds = %.preheader.i45.preheader, %HUF_setValue.exit.i
  %indvars.iv53.i = phi i64 [ %indvars.iv.next54.i, %HUF_setValue.exit.i ], [ 0, %.preheader.i45.preheader ] ; 2 uses
  %i.rs = getelementptr inbounds nuw [8 x i8], ptr %i.np, i64 %indvars.iv53.i ; 2 uses
  %i.rt = load i64, ptr %i.rs, align 8, !tbaa !16 ; 2 uses
  %i.ru = and i64 %i.rt, 255                      ; 3 uses
  %i.rv = getelementptr inbounds nuw [2 x i8], ptr %i.b, i64 %i.ru ; 2 uses
  %i.rw = load i16, ptr %i.rv, align 2, !tbaa !34 ; 2 uses
  %i.rx = add i16 %i.rw, 1
  store i16 %i.rx, ptr %i.rv, align 2, !tbaa !34
  %.not.i.i = icmp eq i64 %i.ru, 0
  br i1 %.not.i.i, label %HUF_setValue.exit.i, label %bb.y

bb.y:                                             ; preds = %.preheader.i45
  %i.ry = zext i16 %i.rw to i64
  %i.rz = sub nuw nsw i64 64, %i.ru
  %i.sa = shl i64 %i.ry, %i.rz
  %i.sb = or i64 %i.sa, %i.rt
  store i64 %i.sb, ptr %i.rs, align 8, !tbaa !16
  br label %HUF_setValue.exit.i

HUF_setValue.exit.i:                              ; preds = %bb.y, %.preheader.i45
  ...
  br i1 %exitcond57.not.i, label %HUF_buildCTableFromTree.exit, label %.preheader.i45, !llvm.loop !71

HUF_buildCTableFromTree.exit:                     ; preds = %HUF_setValue.exit.i
  %i.sc = trunc nuw nsw i32 %.0.i31 to i8
  %i.sd = trunc nuw i32 %2 to i8
  store i8 %i.sc, ptr %0, align 8
  %.sroa.5.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %0, i64 1
  store i8 %i.sd, ptr %.sroa.5.0..sroa_idx.i.i, align 1
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #14
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #14
  %i.se = zext nneg i32 %.0.i31 to i64
  br label %bb.z

bb.z:                                             ; preds = %HUF_setMaxHeight.exit, %bb.b, %bb.a, %HUF_buildCTableFromTree.exit
  %.0 = phi i64 [ %i.se, %HUF_buildCTableFromTree.exit ], [ -66, %bb.a ], [ -46, %bb.b ], [ -1, %HUF_setMaxHeight.exit ]
  ret i64 %.0
}

; Function Attrs: nofree norecurse nosync nounwind memory(argmem: read) uwtable
define range(i64 0, 2305843009213693952) i64 @HUF_estimateCompressedSize(ptr nofree noundef readonly captures(none) %0, ptr nofree noundef readonly captures(none) %1, i32 noundef %2) local_unnamed_addr #6 {
bb.a:
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %i.c, align 8, !tbaa !16
  %wide.load15 = load <2 x i64>, ptr %i.d, align 8, !tbaa !16
  ...
  %wide.load16 = load <2 x i32>, ptr %i.g, align 4, !tbaa !21
  %wide.load17 = load <2 x i32>, ptr %i.h, align 4, !tbaa !21
...
; Function Attrs: nofree norecurse nosync nounwind memory(argmem: read) uwtable
define range(i32 0, 2) i32 @HUF_validateCTable(ptr nofree noundef readonly captures(none) %0, ptr nofree noundef readonly captures(none) %1, i32 noundef %2) local_unnamed_addr #6 {
bb.a:
  %.sroa.0.0.copyload.i = load i64, ptr %0, align 8
  %i.a = trunc i64 %.sroa.0.0.copyload.i to i32
  %i.b = lshr i32 %i.a, 8
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.g = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %index ; 2 uses
  %i.h = getelementptr inbounds nuw i8, ptr %i.g, i64 8
  %wide.load = load <2 x i32>, ptr %i.g, align 4, !tbaa !21
  %wide.load20 = load <2 x i32>, ptr %i.h, align 4, !tbaa !21
  ...
  %wide.load21 = load <2 x i64>, ptr %i.k, align 8, !tbaa !16
  %wide.load22 = load <2 x i64>, ptr %i.l, align 8, !tbaa !16
...
.loopexit:                                        ; preds = %.preheader, %middle.block
  ...
  %i.ai = zext i1 %.not15 to i32
  br label %bb.b

bb.b:                                             ; preds = %bb.a, %.loopexit
  %.013 = phi i32 [ %i.ai, %.loopexit ], [ 0, %bb.a ]
  ret i32 %.013
}
...
begin_hunk_1_@HUF_compress1X_usingCTable_internal_bmi2:bb.a
  ...
  store i64 %i.bnk, ptr %.sroa.458.6720, align 1, !tbaa !16
  ...
  %i.bql = getelementptr inbounds nuw i8, ptr %.sroa.458.6720, i64 %i.bqj ; 2 uses
