...
.lr.ph.i.epil.preheader:                          ; preds = %.lr.ph96.preheader.i.unr-lcssa, %.lr.ph.preheader.i
  ...
  %lcmp.mod109 = icmp ne i64 %xtraiter107, 0
...
.lr.ph96.i:                                       ; preds = %.lr.ph96.i, %.lr.ph96.preheader.i
  ...
  %exitcond63.not = icmp eq i64 %indvars.iv.next111.i, %i.ei
...
.lr.ph134.i:                                      ; preds = %.preheader112.i, %bb.u
  %.187133.i = phi i32 [ %i.lv, %bb.u ], [ %i.js, %.preheader112.i ] ; 2 uses
...
.critedge.i:                                      ; preds = %bb.s, %.critedge.loopexit.split.loop.exit189.i, %.thread.i
  %.192.lcssa.i = phi i32 [ %i.lo, %.thread.i ], [ %i.lt, %.critedge.loopexit.split.loop.exit189.i ], [ 13, %bb.s ] ; 3 uses
