...
bb.f:                                             ; preds = %.lr.ph, %bb.af
  ...
  %.0116168205 = ptrtoaddr ptr %.0116168 to i64   ; 3 uses
...
.lr.ph.i.preheader:                               ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  ...
  %8 = add i64 %.0116168205, %i.cn
  %.11520.i.ph221 = ptrtoaddr ptr %.11520.i.ph to i64 ; 2 uses
  %i.dy = sub i64 %8, %.11520.i.ph221
...
bb.f:                                             ; preds = %.lr.ph, %bb.aj
  ...
  %.0138235301 = ptrtoaddr ptr %.0138235 to i64   ; 3 uses
...
bb.x:                                             ; preds = %bb.w
  %i.cu = zext i32 %.1128 to i64                  ; 7 uses
...
.lr.ph.i.preheader:                               ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  ...
  %8 = add i64 %.0138235301, %i.cu
  %.11520.i.ph324 = ptrtoaddr ptr %.11520.i.ph to i64 ; 2 uses
  %i.ef = sub i64 %8, %.11520.i.ph324
