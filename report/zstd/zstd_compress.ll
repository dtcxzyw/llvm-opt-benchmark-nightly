...
ZSTD_MLcode.exit.i:                               ; preds = %bb.e, %bb.d
  ...
  store i8 %i.aw, ptr %i.ax, align 1, !tbaa !181
...
ZSTD_seqToCodes.exit:                             ; preds = %bb.g, %bb.h
  ...
  %i.bo = load i32, ptr %i.bn, align 4, !tbaa !199
  %i.bp = getelementptr inbounds nuw i8, ptr %4, i64 3548 ; 2 uses
  store i32 %i.bo, ptr %i.bp, align 4, !tbaa !199
  %i.bq = load i32, ptr %i.a, align 4, !tbaa !64
  ...
  store i32 %i.bs, ptr %0, align 8, !tbaa !287
  %i.bt = ptrtoint ptr %6 to i64                  ; 3 uses
  %i.bu = ptrtoint ptr %5 to i64
  %i.bv = sub i64 %i.bt, %i.bu
  %i.bw = load i32, ptr %i.a, align 4, !tbaa !64
...
bb.j:                                             ; preds = %bb.i
  store i64 %i.bx, ptr %i.l, align 8, !tbaa !285
  br label %bb.l

bb.k:                                             ; preds = %ZSTD_seqToCodes.exit
  %i.ca = getelementptr inbounds nuw i8, ptr %0, i64 16
  store i64 %i.bx, ptr %i.ca, align 8, !tbaa !288
...
bb.l:                                             ; preds = %bb.i, %bb.j
  ...
  %i.cd = load i32, ptr %i.b, align 4, !tbaa !64  ; 2 uses
  ...
  store i32 %i.ch, ptr %i.ci, align 4, !tbaa !200
  ...
  store i32 %i.cj, ptr %i.ck, align 4, !tbaa !289
  %i.cl = ptrtoint ptr %i.cb to i64
  %i.cm = sub i64 %i.bt, %i.cl
  %i.cn = load i32, ptr %i.b, align 4, !tbaa !64
...
bb.n:                                             ; preds = %bb.m
  store i64 %i.co, ptr %i.l, align 8, !tbaa !285
  br label %bb.p

bb.o:                                             ; preds = %bb.l
  %i.cr = getelementptr inbounds nuw i8, ptr %0, i64 16
  store i64 %i.co, ptr %i.cr, align 8, !tbaa !288
...
bb.p:                                             ; preds = %bb.m, %bb.n
  ...
  store i32 52, ptr %i.c, align 4, !tbaa !64
  ...
  %i.cv = load i32, ptr %i.cu, align 4, !tbaa !201
  %i.cw = getelementptr inbounds nuw i8, ptr %4, i64 3544 ; 2 uses
  store i32 %i.cv, ptr %i.cw, align 4, !tbaa !201
  %i.cx = load i32, ptr %i.c, align 4, !tbaa !64
  ...
  store i32 %i.cz, ptr %i.da, align 8, !tbaa !290
  %i.db = ptrtoint ptr %i.cs to i64
  %i.dc = sub i64 %i.bt, %i.db
  %i.dd = load i32, ptr %i.c, align 4, !tbaa !64
...
bb.r:                                             ; preds = %bb.q
  store i64 %i.de, ptr %i.l, align 8, !tbaa !285
  br label %bb.t

bb.s:                                             ; preds = %bb.p
  %i.dh = getelementptr inbounds nuw i8, ptr %0, i64 16
  store i64 %i.de, ptr %i.dh, align 8, !tbaa !288
...
bb.t:                                             ; preds = %bb.q, %bb.r
  ...
  store i64 %i.dj, ptr %i.dk, align 8, !tbaa !288
  br label %bb.u
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.l = load i32, ptr %i.a, align 4, !tbaa !102
  ...
  store ptr %i.aq, ptr %i.ar, align 8, !tbaa !69
  ...
  %i.ax = load i32, ptr %i.m, align 4, !tbaa !106 ; 3 uses
  %i.ay = getelementptr inbounds nuw i8, ptr %2, i64 160
  %i.az = load i32, ptr %i.ay, align 8, !tbaa !92
  %i.ba = getelementptr inbounds nuw i8, ptr %0, i64 140
  %i.bb = load i32, ptr %i.ba, align 4, !tbaa !276
...
.preheader.i.i.preheader:                         ; preds = %bb.d
  %i.bm = insertelement <4 x i32> poison, i32 %i.af, i64 0
  %i.bn = shufflevector <4 x i32> %i.bm, <4 x i32> poison, <4 x i32> zeroinitializer ; 4 uses
  %i.bo = insertelement <4 x i32> poison, i32 %8, i64 0
  %i.bp = shufflevector <4 x i32> %i.bo, <4 x i32> poison, <4 x i32> zeroinitializer ; 4 uses
  br label %.preheader.i.i

.preheader.i.i:                                   ; preds = %.preheader.i.i.preheader, %.preheader.i.i
  %indvars.iv.i.i = phi i64 [ %indvars.iv.next7.i.i, %.preheader.i.i ], [ 0, %.preheader.i.i.preheader ] ; 2 uses
  %.020.i5.i.i = phi i32 [ %i.cs, %.preheader.i.i ], [ 0, %.preheader.i.i.preheader ]
  %i.bq = getelementptr inbounds nuw [4 x i8], ptr %i.bj, i64 %indvars.iv.i.i ; 5 uses
  %i.br = load <4 x i32>, ptr %i.bq, align 4, !tbaa !64 ; 3 uses
  %i.bs = icmp eq <4 x i32> %i.br, splat (i32 1)
  %i.bt = icmp ult <4 x i32> %i.br, %i.bn
  %i.bu = sub <4 x i32> %i.br, %i.bp
  %i.bv = select <4 x i1> %i.bt, <4 x i32> zeroinitializer, <4 x i32> %i.bu
  %i.bw = select <4 x i1> %i.bs, <4 x i32> splat (i32 1), <4 x i32> %i.bv
  store <4 x i32> %i.bw, ptr %i.bq, align 4, !tbaa !64
  %i.bx = getelementptr inbounds nuw i8, ptr %i.bq, i64 16 ; 2 uses
  %i.by = load <4 x i32>, ptr %i.bx, align 4, !tbaa !64 ; 3 uses
  %i.bz = icmp eq <4 x i32> %i.by, splat (i32 1)
  %i.ca = icmp ult <4 x i32> %i.by, %i.bn
  %i.cb = sub <4 x i32> %i.by, %i.bp
  %i.cc = select <4 x i1> %i.ca, <4 x i32> zeroinitializer, <4 x i32> %i.cb
  %i.cd = select <4 x i1> %i.bz, <4 x i32> splat (i32 1), <4 x i32> %i.cc
  store <4 x i32> %i.cd, ptr %i.bx, align 4, !tbaa !64
  %i.ce = getelementptr inbounds nuw i8, ptr %i.bq, i64 32 ; 2 uses
  %i.cf = load <4 x i32>, ptr %i.ce, align 4, !tbaa !64 ; 3 uses
  %i.cg = icmp eq <4 x i32> %i.cf, splat (i32 1)
  %i.ch = icmp ult <4 x i32> %i.cf, %i.bn
  %i.ci = sub <4 x i32> %i.cf, %i.bp
  %i.cj = select <4 x i1> %i.ch, <4 x i32> zeroinitializer, <4 x i32> %i.ci
  %i.ck = select <4 x i1> %i.cg, <4 x i32> splat (i32 1), <4 x i32> %i.cj
  store <4 x i32> %i.ck, ptr %i.ce, align 4, !tbaa !64
  %i.cl = getelementptr inbounds nuw i8, ptr %i.bq, i64 48 ; 2 uses
  %i.cm = load <4 x i32>, ptr %i.cl, align 4, !tbaa !64 ; 3 uses
  %i.cn = icmp eq <4 x i32> %i.cm, splat (i32 1)
  %i.co = icmp ult <4 x i32> %i.cm, %i.bn
  %i.cp = sub <4 x i32> %i.cm, %i.bp
  %i.cq = select <4 x i1> %i.co, <4 x i32> zeroinitializer, <4 x i32> %i.cp
  %i.cr = select <4 x i1> %i.cn, <4 x i32> splat (i32 1), <4 x i32> %i.cq
  store <4 x i32> %i.cr, ptr %i.cl, align 4, !tbaa !64
  %indvars.iv.next7.i.i = add nuw nsw i64 %indvars.iv.i.i, 16
  %i.cs = add nuw nsw i32 %.020.i5.i.i, 1         ; 2 uses
  %exitcond.not.i.i = icmp eq i32 %i.cs, %i.bk
  br i1 %exitcond.not.i.i, label %ZSTD_reduceTable_btlazy2.exit.i, label %.preheader.i.i, !llvm.loop !12
...
ZSTD_reduceTable_btlazy2.exit.i:                  ; preds = %.preheader.i.i, %bb.e, %bb.d, %ZSTD_allocateChainTable.exit.i, %bb.c
  ...
  %i.cu = load i32, ptr %i.ct, align 8, !tbaa !277 ; 2 uses
...
bb.f:                                             ; preds = %ZSTD_reduceTable_btlazy2.exit.i
  ...
  %i.cx = load ptr, ptr %i.cw, align 8, !tbaa !282
  tail call fastcc void @ZSTD_reduceTable(ptr noundef %i.cx, i32 noundef %i.cv, i32 noundef %8)
  br label %ZSTD_reduceIndex.exit

ZSTD_reduceIndex.exit:                            ; preds = %ZSTD_reduceTable_btlazy2.exit.i, %bb.f
  %i.cy = load ptr, ptr %i.ar, align 8, !tbaa !69
  %i.cz = getelementptr inbounds nuw i8, ptr %1, i64 24
  %i.da = load ptr, ptr %i.cz, align 8, !tbaa !68 ; 2 uses
  %i.db = icmp ult ptr %i.cy, %i.da
  br i1 %i.db, label %bb.g, label %ZSTD_cwksp_mark_tables_clean.exit

bb.g:                                             ; preds = %ZSTD_reduceIndex.exit
  store ptr %i.da, ptr %i.ar, align 8, !tbaa !69
...
ZSTD_cwksp_mark_tables_clean.exit:                ; preds = %ZSTD_reduceIndex.exit, %bb.g
  ...
  %i.dd = load i32, ptr %i.dc, align 4, !tbaa !211
  %storemerge = tail call i32 @llvm.usub.sat.i32(i32 %i.dd, i32 %8)
  store i32 %storemerge, ptr %i.dc, align 4, !tbaa !211
  store i32 0, ptr %i.b, align 8, !tbaa !278
  %i.de = getelementptr inbounds nuw i8, ptr %0, i64 248
  store ptr null, ptr %i.de, align 8, !tbaa !279
  br label %bb.h
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.e = load i32, ptr %i.d, align 8, !tbaa !217
...
bb.f:                                             ; preds = %bb.e
  %i.l = load <2 x ptr>, ptr %i.g, align 8, !tbaa !63
  %i.m = shufflevector <2 x ptr> %i.l, <2 x ptr> poison, <2 x i32> <i32 1, i32 0>
  store <2 x ptr> %i.m, ptr %i.g, align 8, !tbaa !63
  br label %.thread
...
bb.g:                                             ; preds = %bb.d
  ...
  %i.t = load i64, ptr %i.s, align 8, !tbaa !73
...
bb.k:                                             ; preds = %ZSTD_entropyCompressSeqStore.exit
  ...
  %i.ar = load i32, ptr %i.aq, align 8, !tbaa !216
...
bb.m:                                             ; preds = %bb.l
  %i.av = load i8, ptr %3, align 1, !tbaa !181
  store i8 %i.av, ptr %1, align 1, !tbaa !181
  br label %.thread68
...
bb.o:                                             ; preds = %bb.n
  %i.ax = load <2 x ptr>, ptr %i.g, align 8, !tbaa !63
  %i.ay = shufflevector <2 x ptr> %i.ax, <2 x ptr> poison, <2 x i32> <i32 1, i32 0>
  store <2 x ptr> %i.ay, ptr %i.g, align 8, !tbaa !63
  br label %.thread68
...
.thread68:                                        ; preds = %bb.c, %bb.m, %bb.o, %bb.n
  ...
  %i.bc = load i32, ptr %i.bb, align 4, !tbaa !155
  %i.bd = icmp eq i32 %i.bc, 2
  br i1 %i.bd, label %bb.p, label %.thread

bb.p:                                             ; preds = %.thread68
  store i32 1, ptr %i.bb, align 4, !tbaa !155
  br label %.thread
