...
bb.kh:                                            ; preds = %bb.kg
  ...
  %i.btw = add nsw i32 %i.btu, -2                 ; 2 uses
  %i.btx = icmp sgt i64 %indvars.iv596113, 1
  br i1 %i.btx, label %.lr.ph452, label %.critedge6

.lr.ph452:                                        ; preds = %bb.kh, %bb.ki
  %.4450 = phi i32 [ %i.bua, %bb.ki ], [ %i.btt, %bb.kh ]
  %.15449 = phi i32 [ %17, %bb.ki ], [ %i.btw, %bb.kh ] ; 4 uses
  %16 = zext nneg i32 %.15449 to i64
  %i.bty = getelementptr inbounds nuw i8, ptr %0, i64 %16
  %i.btz = load i8, ptr %i.bty, align 1, !tbaa !9
  %i.bua = zext i8 %i.btz to i32                  ; 4 uses
  %.not287 = icmp samesign ult i32 %.4450, %i.bua
  br i1 %.not287, label %.critedge6, label %bb.ki

bb.ki:                                            ; preds = %.lr.ph452
  %17 = add nsw i32 %.15449, -1
  %i.bub = icmp sgt i32 %.15449, 0
  br i1 %i.bub, label %.lr.ph452, label %.critedge6, !llvm.loop !106

.critedge6:                                       ; preds = %bb.ki, %.lr.ph452, %bb.kh
  %.15.lcssa = phi i32 [ %i.btw, %bb.kh ], [ -1, %bb.ki ], [ %.15449, %.lr.ph452 ] ; 3 uses
  %.11 = phi i32 [ %i.btt, %bb.kh ], [ %i.bua, %.lr.ph452 ], [ %i.bua, %bb.ki ]
...
._crit_edge474:                                   ; preds = %._crit_edge466
  %i.bwa = shl nuw nsw i32 %indvars613, 8
