...
.lr.ph.i569.i.i:                                  ; preds = %tr_fixdown.exit.i.i.i, %.lr.ph.preheader.i.i.i
  ...
  %i.asg = getelementptr inbounds nuw [4 x i8], ptr %.0462.ph.i.i, i64 %6
...
.lr.ph.i.i.i.i304:                                ; preds = %.lr.ph.i569.i.i, %bb.gk
  %i.asl = phi i32 [ %i.ath, %bb.gk ], [ %8, %.lr.ph.i569.i.i ] ; 2 uses
  %i.asm = phi i32 [ %i.atg, %bb.gk ], [ %7, %.lr.ph.i569.i.i ]
  %.02530.i.i.i.i = phi i32 [ %spec.select.i.i.i.i, %bb.gk ], [ %indvars.i.i.i, %.lr.ph.i569.i.i ] ; 2 uses
  ...
  br i1 %.not.i.i.i.i, label %bb.gk, label %.lr.ph.i.tr_fixdown.exit.loopexit_crit_edge.i.i.i
...
bb.gk:                                            ; preds = %.lr.ph.i.i.i.i304
  ...
  %spec.select.i.i.i.i = select i1 %i.ata, i32 %i.asn, i32 %i.asl ; 3 uses
  %i.atb = zext nneg i32 %spec.select.i.i.i.i to i64 ; 2 uses
...
tr_fixdown.exit.i.i.i:                            ; preds = %bb.gk, %.lr.ph.i.tr_fixdown.exit.loopexit_crit_edge.i.i.i, %.lr.ph.i569.i.i
  %.pre-phi.i.i.i = phi i64 [ %6, %.lr.ph.i569.i.i ], [ %.pre74.i.i.i, %.lr.ph.i.tr_fixdown.exit.loopexit_crit_edge.i.i.i ], [ %i.atb, %bb.gk ]
  %i.atj = getelementptr inbounds nuw [4 x i8], ptr %.0462.ph.i.i, i64 %.pre-phi.i.i.i
