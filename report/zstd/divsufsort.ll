...
.lr.ph452:                                        ; preds = %bb.kh, %bb.ki
  %.4450 = phi i32 [ %i.btz, %bb.ki ], [ %i.bts, %bb.kh ]
  %.15449 = phi i32 [ %17, %bb.ki ], [ %i.btv, %bb.kh ] ; 4 uses
...
.critedge6:                                       ; preds = %bb.ki, %.lr.ph452, %bb.kh
  %.15.lcssa = phi i32 [ %i.btv, %bb.kh ], [ -1, %bb.ki ], [ %.15449, %.lr.ph452 ] ; 3 uses
  %.11 = phi i32 [ %i.bts, %bb.kh ], [ %i.btz, %.lr.ph452 ], [ %i.btz, %bb.ki ]
