...
bb.fa:                                            ; preds = %bb.ez, %bb.ey
  %i.akm = ptrtoint ptr %.0452.ph.i.i to i64
  ...
  %.not89.i.i.i = icmp ugt ptr %.0455.ph.i.i, %i.akv
  br i1 %.not89.i.i.i, label %.preheader.i.i.i, label %.lr.ph.i550.i.i

.preheader.i.i.i:                                 ; preds = %bb.fd, %bb.fa
  %.075.lcssa.i.i.i = phi ptr [ %i.akv, %bb.fa ], [ %.176.i.i.i, %bb.fd ] ; 3 uses
...
.lr.ph.i550.i.i:                                  ; preds = %bb.fa, %bb.fd
  ...
  %.07291.i.i.i = phi ptr [ %i.all, %bb.fd ], [ %.0455.ph.i.i, %bb.fa ] ; 2 uses
  %.07590.i.i.i = phi ptr [ %.176.i.i.i, %bb.fd ], [ %i.akv, %bb.fa ] ; 3 uses
  %i.akw = load i32, ptr %.07291.i.i.i, align 4, !tbaa !8 ; 2 uses
...
bb.fc:                                            ; preds = %bb.fb
  %i.ald = getelementptr inbounds nuw i8, ptr %.07590.i.i.i, i64 4 ; 3 uses
  ...
  %.1.i.i.i308 = select i1 %.not88.i.i.i, i32 %.093.i.i.i, i32 %i.alk ; 2 uses
  store i32 %.1.i.i.i308, ptr %i.ala, align 4, !tbaa !8
  br label %bb.fd

bb.fd:                                            ; preds = %bb.fc, %bb.fb, %.lr.ph.i550.i.i
  %.176.i.i.i = phi ptr [ %i.ald, %bb.fc ], [ %.07590.i.i.i, %bb.fb ], [ %.07590.i.i.i, %.lr.ph.i550.i.i ] ; 3 uses
  ...
  %i.all = getelementptr inbounds nuw i8, ptr %.07291.i.i.i, i64 4 ; 2 uses
  %.not.i551.i.i = icmp ugt ptr %i.all, %.176.i.i.i
...
.lr.ph99.i.i.i:                                   ; preds = %.preheader.i.i.i, %bb.ff
  ...
  %.07496.i.i.i = phi ptr [ %i.alu, %bb.ff ], [ %.075.lcssa.i.i.i, %.preheader.i.i.i ] ; 3 uses
  %i.alm = load i32, ptr %.07496.i.i.i, align 4, !tbaa !8
  ...
  %i.alq = ptrtoint ptr %.07496.i.i.i to i64
...
bb.ff:                                            ; preds = %bb.fe, %.lr.ph99.i.i.i
  %i.alu = getelementptr inbounds i8, ptr %.07496.i.i.i, i64 -4 ; 2 uses
  %.not84.i.i.i = icmp ugt ptr %.0455.ph.i.i, %i.alu
  br i1 %.not84.i.i.i, label %._crit_edge.i552.i.i, label %.lr.ph99.i.i.i, !llvm.loop !78

._crit_edge.i552.i.i:                             ; preds = %bb.ff, %.preheader.i.i.i
  %.3.lcssa.i.i.i = phi i32 [ %.0.lcssa.i.i.i307, %.preheader.i.i.i ], [ %.4.i.i.i, %bb.ff ]
  %i.alv = getelementptr inbounds nuw i8, ptr %.075.lcssa.i.i.i, i64 4 ; 2 uses
...
.lr.ph107.i.i.i:                                  ; preds = %._crit_edge.i552.i.i, %bb.fi
  ...
  %.277102.i.i.i = phi ptr [ %.378.i.i.i, %bb.fi ], [ %i.ais, %._crit_edge.i552.i.i ] ; 3 uses
  %.173105.i.i.i = getelementptr inbounds i8, ptr %.173105.pn.i.i.i, i64 -4 ; 2 uses
  %i.alx = load i32, ptr %.173105.i.i.i, align 4, !tbaa !8 ; 2 uses
...
bb.fh:                                            ; preds = %bb.fg
  %i.ame = getelementptr inbounds i8, ptr %.277102.i.i.i, i64 -4 ; 3 uses
...
bb.fi:                                            ; preds = %bb.fh, %bb.fg, %.lr.ph107.i.i.i
  %.378.i.i.i = phi ptr [ %i.ame, %bb.fh ], [ %.277102.i.i.i, %bb.fg ], [ %.277102.i.i.i, %.lr.ph107.i.i.i ] ; 2 uses
  ...
  %i.amm = icmp ult ptr %i.alv, %.378.i.i.i
...
._crit_edge.thread.i.i299:                        ; preds = %.critedge2.i.i, %bb.bx, %tr_heapsort.exit.i.i, %._crit_edge.i.i305, %.lr.ph646.split.us.i.i
  %i.ana = load i32, ptr %.0455.ph.i.i, align 4, !tbaa !8 ; 2 uses
...
.preheader.i:                                     ; preds = %._crit_edge.thread.i.i299, %bb.fk
  ...
  %i.and = phi ptr [ %i.ank, %bb.fk ], [ %.0455.ph.i.i, %._crit_edge.thread.i.i299 ] ; 2 uses
  ...
  %i.anl = icmp ult ptr %i.ank, %.0463.ph.i.i
...
.critedge.i.i300:                                 ; preds = %bb.fk, %.preheader.i, %._crit_edge.thread.i.i299
  %.1456.i.i = phi ptr [ %.0455.ph.i.i, %._crit_edge.thread.i.i299 ], [ %i.ank, %.preheader.i ], [ %i.ank, %bb.fk ] ; 10 uses
  %i.ano = icmp ult ptr %.1456.i.i, %.0463.ph.i.i
  br i1 %i.ano, label %bb.fl, label %bb.gh

bb.fl:                                            ; preds = %.critedge.i.i300
  %.pre.i.i301 = load i32, ptr %.1456.i.i, align 4, !tbaa !8
  br label %bb.fm

bb.fm:                                            ; preds = %bb.fm, %bb.fl
  %i.anp = phi i32 [ %i.ant, %bb.fm ], [ %.pre.i.i301, %bb.fl ]
  %i.anq = phi ptr [ %i.ans, %bb.fm ], [ %.1456.i.i, %bb.fl ] ; 3 uses
...
bb.fn:                                            ; preds = %bb.fm
  ...
  %i.any = getelementptr inbounds nuw [4 x i8], ptr %.0452.ph.i.i, i64 %i.anv
...
bb.fs:                                            ; preds = %bb.fo
  %.not7.i555.i.i = icmp samesign ult i32 %i.aof, 256
...
tr_ilg.exit556.i.i:                               ; preds = %bb.fu, %bb.ft, %bb.fr, %bb.fq, %bb.fn
  ...
  %i.apa = icmp ult ptr %i.aoz, %.0463.ph.i.i
  %i.apb = ptrtoint ptr %i.aoz to i64             ; 4 uses
  br i1 %i.apa, label %bb.fv, label %tr_ilg.exit556._crit_edge.i.i
...
bb.fy:                                            ; preds = %bb.fx, %tr_ilg.exit556._crit_edge.i.i
  %.pn221.i = phi i32 [ %i.apr, %bb.fx ], [ %.sroa.9.3.i, %tr_ilg.exit556._crit_edge.i.i ]
  %.sroa.0.7.i = phi i32 [ %i.aps, %bb.fx ], [ %.sroa.0.3.i, %tr_ilg.exit556._crit_edge.i.i ] ; 3 uses
  %.sroa.9.7.i = sub i32 %.pn221.i, %i.app        ; 3 uses
  %i.apt = ptrtoint ptr %.0463.ph.i.i to i64
...
bb.fz:                                            ; preds = %bb.fy
  ...
  store ptr %.0452.ph.i.i, ptr %i.apw, align 16, !tbaa !67
  ...
  store ptr %.0463.ph.i.i, ptr %i.apy, align 16, !tbaa !72
  ...
  %i.aqc = getelementptr inbounds [4 x i8], ptr %.0452.ph.i.i, i64 %i.rn
  br label %.outer.i.i.backedge

bb.ga:                                            ; preds = %bb.fy
  %i.aqd = icmp sgt i64 %i.apu, 4
  %i.aqe = getelementptr inbounds [4 x i8], ptr %.0452.ph.i.i, i64 %i.rn ; 2 uses
...
bb.gb:                                            ; preds = %bb.ga
  ...
  store ptr %.1456.i.i, ptr %i.aqh, align 8, !tbaa !71
...
bb.ge:                                            ; preds = %bb.gd, %bb.gc
  %i.aqr = ptrtoint ptr %.0463.ph.i.i to i64
...
bb.gj:                                            ; preds = %.lr.ph650.i.i
  ...
  %i.arw = getelementptr inbounds [4 x i8], ptr %.0452.ph.i.i, i64 %i.arv
  %i.arx = load i32, ptr %i.arw, align 4, !tbaa !8
  %i.ary = load i32, ptr %i.tp, align 4, !tbaa !8 ; 2 uses
  %i.arz = sext i32 %i.ary to i64
  %i.asa = getelementptr inbounds [4 x i8], ptr %.0452.ph.i.i, i64 %i.arz
...
._crit_edge72.i.i.i:                              ; preds = %bb.gk, %bb.gj, %.lr.ph650.i.i
  %.0.i565.i.i = phi i32 [ %i.tk, %bb.gk ], [ %i.tk, %bb.gj ], [ %i.th, %.lr.ph650.i.i ] ; 8 uses
  %i.asd = icmp sgt i32 %.0.i565.i.i, 1           ; 3 uses
  br i1 %i.asd, label %.lr.ph.preheader.i.i.i, label %._crit_edge.i566.i.i

.lr.ph.preheader.i.i.i:                           ; preds = %._crit_edge72.i.i.i
  %i.ase = lshr i32 %.0.i565.i.i, 1
  %i.asf = zext nneg i32 %i.ase to i64
  %i.asg = zext nneg i32 %.0.i565.i.i to i64
...
.lr.ph.i568.i.i:                                  ; preds = %tr_fixdown.exit.i.i.i, %.lr.ph.preheader.i.i.i
  ...
  %i.ash = getelementptr inbounds nuw [4 x i8], ptr %.0455.ph.i.i, i64 %indvars.iv.next.i.i.i
  %i.asi = load i32, ptr %i.ash, align 4, !tbaa !8 ; 2 uses
  %i.asj = sext i32 %i.asi to i64
  %i.ask = getelementptr inbounds [4 x i8], ptr %.0452.ph.i.i, i64 %i.asj
...
.lr.ph.i.i.i.i304:                                ; preds = %bb.gl, %.lr.ph.i.preheader.i.i.i
  ...
  %.030.i.i.i.i = phi i32 [ %spec.select.i.i.i.i, %bb.gl ], [ %i.asp, %.lr.ph.i.preheader.i.i.i ] ; 2 uses
  %i.asu = add nuw nsw i32 %i.ast, 2              ; 2 uses
  %i.asv = zext nneg i32 %i.ass to i64
  %i.asw = getelementptr inbounds nuw [4 x i8], ptr %.0455.ph.i.i, i64 %i.asv
  %i.asx = load i32, ptr %i.asw, align 4, !tbaa !8
  %i.asy = sext i32 %i.asx to i64
  %i.asz = getelementptr inbounds [4 x i8], ptr %.0452.ph.i.i, i64 %i.asy
  %i.ata = load i32, ptr %i.asz, align 4, !tbaa !8 ; 2 uses
  %i.atb = zext nneg i32 %i.asu to i64
  %i.atc = getelementptr inbounds nuw [4 x i8], ptr %.0455.ph.i.i, i64 %i.atb
  %i.atd = load i32, ptr %i.atc, align 4, !tbaa !8
  %i.ate = sext i32 %i.atd to i64
  %i.atf = getelementptr inbounds [4 x i8], ptr %.0452.ph.i.i, i64 %i.ate
...
bb.gl:                                            ; preds = %.lr.ph.i.i.i.i304
  ...
  %i.atj = getelementptr inbounds nuw [4 x i8], ptr %.0455.ph.i.i, i64 %i.ati
  %i.atk = load i32, ptr %i.atj, align 4, !tbaa !8
  %i.atl = zext nneg i32 %.030.i.i.i.i to i64
  %i.atm = getelementptr inbounds nuw [4 x i8], ptr %.0455.ph.i.i, i64 %i.atl
  ...
  %i.atp = icmp slt i32 %i.ato, %.0.i565.i.i
end_hunk_0
