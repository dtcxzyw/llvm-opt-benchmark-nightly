...
bb.jj:                                            ; preds = %bb.jh
  ...
  br i1 %i.bqw, label %.outer.i.i.backedge, label %bb.jk

bb.jk:                                            ; preds = %bb.jj
  %i.bqx = icmp eq i32 %.0445.ph.i.i, 0
  br i1 %i.bqx, label %tr_introsort.exit.i, label %bb.jl
...
bb.jm:                                            ; preds = %tr_partition.exit.thread.i
  ...
  br i1 %i.brk, label %bb.jv, label %bb.jn
...
bb.jo:                                            ; preds = %bb.jn, %tr_partition.exit.thread.i
  %.pn209.i = phi i32 [ %i.brl, %bb.jn ], [ %.sroa.9.3.i, %tr_partition.exit.thread.i ]
  %.sroa.0.6.i = phi i32 [ %i.brm, %bb.jn ], [ %.sroa.0.3.i, %tr_partition.exit.thread.i ]
  %.sroa.9.6.i = sub i32 %.pn209.i, %i.sx
...
tr_ilg.exit585.i.i:                               ; preds = %bb.ju, %bb.jt, %bb.jr, %bb.jq
  %i.bsf = phi i32 [ %i.brw, %bb.jr ], [ %i.brr, %bb.jq ], [ %i.bsb, %bb.jt ], [ %i.bse, %bb.ju ]
...
bb.jv:                                            ; preds = %bb.jm
  ...
  br i1 %i.bsi, label %bb.jw, label %bb.jx
...
bb.jx:                                            ; preds = %bb.jw, %bb.jv
  ...
  br i1 %i.bsm, label %tr_introsort.exit.i, label %bb.jy
...
.outer.i.i.backedge:                              ; preds = %bb.jy, %tr_ilg.exit585.i.i, %bb.jl, %bb.jj, %bb.ji, %bb.jg, %bb.je, %bb.jd, %bb.iy, %bb.ix, %bb.iw, %bb.it, %bb.is, %bb.ir, %bb.io, %bb.in, %bb.im, %bb.ij, %bb.ii, %bb.ih, %bb.gh, %bb.gf, %bb.gd, %bb.ga, %bb.fz, %bb.fy, %bb.fj, %bb.ep, %bb.en, %bb.em, %bb.ek, %bb.ej, %bb.ef, %bb.ee, %bb.ec, %bb.eb, %bb.dr, %bb.dp, %bb.do, %bb.dm, %bb.dl, %bb.dh, %bb.dg, %bb.de, %bb.dd
  %.sroa.23.0.i.be = phi i32 [ %.sroa.23.0.i, %bb.in ], [ %.sroa.23.0.i, %bb.ih ], [ %.sroa.23.0.i, %bb.ij ], [ %.sroa.23.0.i, %bb.ii ], [ %i.aqb, %bb.gd ], [ %i.aqb, %bb.gf ], [ %.sroa.23.0.i, %bb.ga ], [ %.sroa.23.0.i, %bb.fz ], [ %.sroa.23.0.i, %bb.fy ], [ %.sroa.23.0.i, %bb.gh ], [ %.sroa.23.0.i, %bb.ef ], [ %.sroa.23.0.i, %bb.ee ], [ %.sroa.23.0.i, %bb.ec ], [ %.sroa.23.0.i, %bb.eb ], [ %.sroa.23.0.i, %bb.en ], [ %.sroa.23.0.i, %bb.em ], [ %.sroa.23.0.i, %bb.ek ], [ %.sroa.23.0.i, %bb.ej ], [ %.sroa.23.0.i, %bb.ep ], [ %.sroa.23.0.i, %bb.dh ], [ %.sroa.23.0.i, %bb.dg ], [ %.sroa.23.0.i, %bb.de ], [ %.sroa.23.0.i, %bb.dd ], [ %.sroa.23.0.i, %bb.dp ], [ %.sroa.23.0.i, %bb.do ], [ %.sroa.23.0.i, %bb.dm ], [ %.sroa.23.0.i, %bb.dl ], [ %.sroa.23.0.i, %bb.dr ], [ %.sroa.23.0.i, %bb.fj ], [ %i.bsh, %bb.jy ], [ %.sroa.23.0.i, %tr_ilg.exit585.i.i ], [ %.sroa.23.1.i, %bb.ji ], [ %.sroa.23.1.i, %bb.jj ], [ %.sroa.23.1.i, %bb.jl ], [ %.sroa.23.1.i, %bb.jd ], [ %.sroa.23.1.i, %bb.je ], [ %.sroa.23.1.i, %bb.jg ], [ %.sroa.23.0.i, %bb.iy ], [ %.sroa.23.0.i, %bb.iw ], [ %.sroa.23.0.i, %bb.ix ], [ %.sroa.23.0.i, %bb.ir ], [ %.sroa.23.0.i, %bb.it ], [ %.sroa.23.0.i, %bb.is ], [ %.sroa.23.0.i, %bb.io ], [ %.sroa.23.0.i, %bb.im ]
  ...
  %.0462.ph.i.i.be = phi ptr [ %i.bjg, %bb.in ], [ %.0462.ph.i.i, %bb.ih ], [ %i.bjh, %bb.ij ], [ %i.bjg, %bb.ii ], [ %i.aoo, %bb.gd ], [ %i.aqp, %bb.gf ], [ %i.aoo, %bb.ga ], [ %.1463.i.i, %bb.fz ], [ %.1463.i.i, %bb.fy ], [ %i.arc, %bb.gh ], [ %.0166.i78.i, %bb.ef ], [ %.0166.i78.i, %bb.ee ], [ %.0166.i78.i, %bb.ec ], [ %.0166.i78.i, %bb.eb ], [ %.0462.ph.i.i, %bb.en ], [ %.0462.ph.i.i, %bb.em ], [ %.0462.ph.i.i, %bb.ek ], [ %.0462.ph.i.i, %bb.ej ], [ %i.ahu, %bb.ep ], [ %.0462.ph.i.i, %bb.dh ], [ %.0462.ph.i.i, %bb.dg ], [ %.0462.ph.i.i, %bb.de ], [ %.0462.ph.i.i, %bb.dd ], [ %.0166.i78.i, %bb.dp ], [ %.0166.i78.i, %bb.do ], [ %.0166.i78.i, %bb.dm ], [ %.0166.i78.i, %bb.dl ], [ %i.aeq, %bb.dr ], [ %i.ami, %bb.fj ], [ %i.bss, %bb.jy ], [ %.0462.ph.i.i, %tr_ilg.exit585.i.i ], [ %i.bjh, %bb.ji ], [ %.0462.ph.i.i, %bb.jj ], [ %i.brd, %bb.jl ], [ %.0462.ph.i.i, %bb.jd ], [ %i.bjh, %bb.je ], [ %i.bqh, %bb.jg ], [ %i.bjg, %bb.iy ], [ %i.bjh, %bb.iw ], [ %i.bjg, %bb.ix ], [ %i.bjh, %bb.ir ], [ %.0462.ph.i.i, %bb.it ], [ %i.bjg, %bb.is ], [ %i.bjg, %bb.io ], [ %.0462.ph.i.i, %bb.im ]
  %.0459.ph.i.i.be = phi ptr [ %i.bjh, %bb.in ], [ %i.bjg, %bb.ih ], [ %.0459.ph.i.i, %bb.ij ], [ %i.bjh, %bb.ii ], [ %.0459.ph.i.i, %bb.gd ], [ %i.aqr, %bb.gf ], [ %.0459.ph.i.i, %bb.ga ], [ %i.aoo, %bb.fz ], [ %i.aoo, %bb.fy ], [ %i.are, %bb.gh ], [ %.0459.ph.i.i, %bb.ef ], [ %.0459.ph.i.i, %bb.ee ], [ %.0459.ph.i.i, %bb.ec ], [ %.0459.ph.i.i, %bb.eb ], [ %.0165.i79.i, %bb.en ], [ %.0165.i79.i, %bb.em ], [ %.0165.i79.i, %bb.ek ], [ %.0165.i79.i, %bb.ej ], [ %i.ahw, %bb.ep ], [ %.0165.i79.i, %bb.dh ], [ %.0165.i79.i, %bb.dg ], [ %.0165.i79.i, %bb.de ], [ %.0165.i79.i, %bb.dd ], [ %.0459.ph.i.i, %bb.dp ], [ %.0459.ph.i.i, %bb.do ], [ %.0459.ph.i.i, %bb.dm ], [ %.0459.ph.i.i, %bb.dl ], [ %i.aes, %bb.dr ], [ %i.amk, %bb.fj ], [ %i.bsu, %bb.jy ], [ %.0459.ph.i.i, %tr_ilg.exit585.i.i ], [ %.0459.ph.i.i, %bb.ji ], [ %i.bjg, %bb.jj ], [ %i.brf, %bb.jl ], [ %i.bjg, %bb.jd ], [ %.0459.ph.i.i, %bb.je ], [ %i.bqj, %bb.jg ], [ %i.bjh, %bb.iy ], [ %.0459.ph.i.i, %bb.iw ], [ %i.bjh, %bb.ix ], [ %.0459.ph.i.i, %bb.ir ], [ %i.bjg, %bb.it ], [ %i.bjh, %bb.is ], [ %i.bjh, %bb.io ], [ %i.bjg, %bb.im ]
  %.0456.ph.i.i.be = phi ptr [ %i.bmw, %bb.in ], [ %.0456.ph.i.i, %bb.ih ], [ %.0456.ph.i.i, %bb.ij ], [ %i.bly, %bb.ii ], [ %.0456.ph.i.i, %bb.gd ], [ %i.aqn, %bb.gf ], [ %.0456.ph.i.i, %bb.ga ], [ %i.apt, %bb.fz ], [ %i.apr, %bb.fy ], [ %i.ara, %bb.gh ], [ %.0456.ph.i.i, %bb.ef ], [ %.0456.ph.i.i, %bb.ee ], [ %.0456.ph.i.i, %bb.ec ], [ %.0456.ph.i.i, %bb.eb ], [ %.0456.ph.i.i, %bb.en ], [ %.0456.ph.i.i, %bb.em ], [ %.0456.ph.i.i, %bb.ek ], [ %.0456.ph.i.i, %bb.ej ], [ %i.ahs, %bb.ep ], [ %.0456.ph.i.i, %bb.dh ], [ %.0456.ph.i.i, %bb.dg ], [ %.0456.ph.i.i, %bb.de ], [ %.0456.ph.i.i, %bb.dd ], [ %.0456.ph.i.i, %bb.dp ], [ %.0456.ph.i.i, %bb.do ], [ %.0456.ph.i.i, %bb.dm ], [ %.0456.ph.i.i, %bb.dl ], [ %i.aeo, %bb.dr ], [ %i.amg, %bb.fj ], [ %i.bsq, %bb.jy ], [ %i.bsg, %tr_ilg.exit585.i.i ], [ %.0456.ph.i.i, %bb.ji ], [ %.0456.ph.i.i, %bb.jj ], [ %i.brb, %bb.jl ], [ %.0456.ph.i.i, %bb.jd ], [ %.0456.ph.i.i, %bb.je ], [ %i.bqf, %bb.jg ], [ %i.bpk, %bb.iy ], [ %.0456.ph.i.i, %bb.iw ], [ %i.box, %bb.ix ], [ %.0456.ph.i.i, %bb.ir ], [ %.0456.ph.i.i, %bb.it ], [ %i.bnz, %bb.is ], [ %i.bnj, %bb.io ], [ %.0456.ph.i.i, %bb.im ]
  %.0449.ph.i.i.be = phi i32 [ %i.bkf, %bb.in ], [ %i.awm, %bb.ih ], [ %i.awm, %bb.ij ], [ %i.bkf, %bb.ii ], [ -3, %bb.gd ], [ %i.aqt, %bb.gf ], [ -3, %bb.ga ], [ %i.aon, %bb.fz ], [ %i.aon, %bb.fy ], [ %i.arg, %bb.gh ], [ %i.agt, %bb.ef ], [ %i.agq, %bb.ee ], [ %i.agl, %bb.ec ], [ %i.agg, %bb.eb ], [ %i.ahn, %bb.en ], [ %i.ahk, %bb.em ], [ %i.ahf, %bb.ek ], [ %i.aha, %bb.ej ], [ %i.ahy, %bb.ep ], [ %i.adp, %bb.dh ], [ %i.adm, %bb.dg ], [ %i.adh, %bb.de ], [ %i.adc, %bb.dd ], [ %i.aej, %bb.dp ], [ %i.aeg, %bb.do ], [ %i.aeb, %bb.dm ], [ %i.adw, %bb.dl ], [ %i.aeu, %bb.dr ], [ %i.amm, %bb.fj ], [ %i.bsw, %bb.jy ], [ %i.bsf, %tr_ilg.exit585.i.i ], [ %i.awm, %bb.ji ], [ %i.awm, %bb.jj ], [ %i.brh, %bb.jl ], [ %i.awm, %bb.jd ], [ %i.awm, %bb.je ], [ %i.bql, %bb.jg ], [ %i.bkf, %bb.iy ], [ %i.awm, %bb.iw ], [ %i.bkf, %bb.ix ], [ %i.awm, %bb.ir ], [ %i.awm, %bb.it ], [ %i.bkf, %bb.is ], [ %i.bkf, %bb.io ], [ %i.awm, %bb.im ]
  %.0445.ph.i.i.be = phi i32 [ %i.bmu, %bb.in ], [ %i.blv, %bb.ih ], [ %i.bme, %bb.ij ], [ %.0445.ph.i.i, %bb.ii ], [ %.0445.ph.i.i, %bb.gd ], [ %i.aqk, %bb.gf ], [ %i.apz, %bb.ga ], [ %.0445.ph.i.i, %bb.fz ], [ %i.app, %bb.fy ], [ %i.aqx, %bb.gh ], [ %i.afy, %bb.ef ], [ %i.afy, %bb.ee ], [ %i.afy, %bb.ec ], [ %i.afy, %bb.eb ], [ %.1446.i.i, %bb.en ], [ %.1446.i.i, %bb.em ], [ %.1446.i.i, %bb.ek ], [ %.1446.i.i, %bb.ej ], [ %i.ahp, %bb.ep ], [ %i.acu, %bb.dh ], [ %i.acu, %bb.dg ], [ %i.acu, %bb.de ], [ %i.acu, %bb.dd ], [ %.1446.i.i, %bb.dp ], [ %.1446.i.i, %bb.do ], [ %.1446.i.i, %bb.dm ], [ %.1446.i.i, %bb.dl ], [ %i.ael, %bb.dr ], [ %i.amd, %bb.fj ], [ %i.bsn, %bb.jy ], [ %.0445.ph.i.i, %tr_ilg.exit585.i.i ], [ %i.bqu, %bb.ji ], [ %.0445.ph.i.i, %bb.jj ], [ %i.bqy, %bb.jl ], [ %i.bpy, %bb.jd ], [ %.0445.ph.i.i, %bb.je ], [ %i.bqc, %bb.jg ], [ %i.bpi, %bb.iy ], [ %i.bot, %bb.iw ], [ %i.bov, %bb.ix ], [ %i.bnw, %bb.ir ], [ %i.bof, %bb.it ], [ %.0445.ph.i.i, %bb.is ], [ %i.bnh, %bb.io ], [ %i.bms, %bb.im ]
  %.0.ph.i.i.be = phi i32 [ %.0.ph.i.i, %bb.in ], [ %.0.ph.i.i, %bb.ih ], [ %.0.ph.i.i, %bb.ij ], [ %.0.ph.i.i, %bb.ii ], [ %.0.ph.i.i, %bb.gd ], [ %i.aqv, %bb.gf ], [ %.0.ph.i.i, %bb.ga ], [ %.0.ph.i.i, %bb.fz ], [ %.0.ph.i.i, %bb.fy ], [ %i.ari, %bb.gh ], [ %.1.i.i311, %bb.ef ], [ %.1.i.i311, %bb.ee ], [ %.1.i.i311, %bb.ec ], [ %.1.i.i311, %bb.eb ], [ %.1.i.i311, %bb.en ], [ %.1.i.i311, %bb.em ], [ %.1.i.i311, %bb.ek ], [ %.1.i.i311, %bb.ej ], [ %i.aia, %bb.ep ], [ %.1.i.i311, %bb.dh ], [ %.1.i.i311, %bb.dg ], [ %.1.i.i311, %bb.de ], [ %.1.i.i311, %bb.dd ], [ %.1.i.i311, %bb.dp ], [ %.1.i.i311, %bb.do ], [ %.1.i.i311, %bb.dm ], [ %.1.i.i311, %bb.dl ], [ %i.aew, %bb.dr ], [ %i.amo, %bb.fj ], [ %i.bsy, %bb.jy ], [ %.0.ph.i.i, %tr_ilg.exit585.i.i ], [ %.0.ph.i.i, %bb.ji ], [ %.0.ph.i.i, %bb.jj ], [ %i.brj, %bb.jl ], [ %.0.ph.i.i, %bb.jd ], [ %.0.ph.i.i, %bb.je ], [ %i.bqn, %bb.jg ], [ %.0.ph.i.i, %bb.iy ], [ %.0.ph.i.i, %bb.iw ], [ %.0.ph.i.i, %bb.ix ], [ %.0.ph.i.i, %bb.ir ], [ %.0.ph.i.i, %bb.it ], [ %.0.ph.i.i, %bb.is ], [ %.0.ph.i.i, %bb.io ], [ %.0.ph.i.i, %bb.im ]
  br label %.outer.i.i
...
tr_introsort.exit.i:                              ; preds = %bb.jx, %bb.jk, %bb.jf, %bb.gg, %bb.ge, %tr_copy.exit.i.i, %bb.eo, %bb.dq
  ...
  %.sroa.23.3.i = phi i32 [ %.sroa.23.0.i, %bb.dq ], [ %.sroa.23.0.i, %bb.eo ], [ %.sroa.23.0.i, %tr_copy.exit.i.i ], [ %i.aqb, %bb.ge ], [ %.sroa.23.0.i, %bb.gg ], [ %.sroa.23.1.i, %bb.jf ], [ %.sroa.23.1.i, %bb.jk ], [ %i.bsh, %bb.jx ] ; 2 uses
...
bb.kb:                                            ; preds = %bb.ka, %bb.jz, %bb.bj
  ...
  %.3.i = phi i32 [ %i.rk, %bb.bj ], [ %i.btb, %bb.jz ], [ %spec.select.i294, %bb.ka ] ; 4 uses
  %i.btd = icmp ult ptr %.146.i, %i.br
  br i1 %i.btd, label %thread-pre-split.i, label %bb.kc, !llvm.loop !103

.thread.i:                                        ; preds = %tr_introsort.exit.i
  %i.bte = add nsw i32 %.sroa.23.3.i, %.0.i       ; 2 uses
  %i.btf = icmp slt i64 %i.rr, %.idx159.i
  br i1 %i.btf, label %thread-pre-split.i, label %.thread149.i, !llvm.loop !103
...
.thread149.i:                                     ; preds = %.thread.i, %bb.kd, %bb.kc
  ...
  %.2147156.i = phi i32 [ %.0.i, %bb.kc ], [ %.0.i, %bb.kd ], [ %i.bte, %.thread.i ]
  %i.bti = icmp eq i32 %.2147156.i, 0
  br i1 %i.bti, label %trsort.exit, label %bb.ke

bb.ke:                                            ; preds = %.thread149.i
  %i.btj = getelementptr inbounds i8, ptr %.047208.i, i64 %i.rc
  %i.btk = load i32, ptr %1, align 4, !tbaa !8    ; 2 uses
  %i.btl = icmp sgt i32 %i.btk, %i.qs
  br i1 %i.btl, label %.preheader169.i, label %trsort.exit, !llvm.loop !104
...
bb.kg:                                            ; preds = %.lr.ph115, %bb.kf
  %.3114 = phi i32 [ %.7460, %.lr.ph115 ], [ %i.bts, %bb.kf ]
  %indvars.iv596113 = phi i64 [ %i.bto, %.lr.ph115 ], [ %i.btp, %bb.kf ] ; 3 uses
...
bb.kh:                                            ; preds = %bb.kg
  ...
  %i.btv = add nuw nsw i32 %i.btt, -2
  %i.btw = icmp sgt i64 %indvars.iv596113, 1
  br i1 %i.btw, label %.lr.ph452.preheader, label %.critedge6
...
.lr.ph452:                                        ; preds = %.lr.ph452.preheader, %bb.ki
  ...
  %.15449 = phi i32 [ %i.bts, %.lr.ph452.preheader ], [ %i.btz, %bb.ki ]
  %i.btx = getelementptr inbounds nuw i8, ptr %0, i64 %indvars.iv609
  %i.bty = load i8, ptr %i.btx, align 1, !tbaa !9
  %i.btz = zext i8 %i.bty to i32                  ; 4 uses
  %.not287 = icmp samesign ult i32 %.15449, %i.btz
...
bb.ki:                                            ; preds = %.lr.ph452
  ...
  %i.bua = icmp sgt i64 %indvars.iv609, 0
...
.critedge6:                                       ; preds = %bb.ki, %.critedge6.loopexit.split.loop.exit, %bb.kh
  %.15.lcssa = phi i32 [ %i.btv, %bb.kh ], [ %14, %.critedge6.loopexit.split.loop.exit ], [ -1, %bb.ki ] ; 3 uses
  %.11 = phi i32 [ %i.bts, %bb.kh ], [ %i.btz, %.critedge6.loopexit.split.loop.exit ], [ %i.btz, %bb.ki ]
...
._crit_edge466:                                   ; preds = %._crit_edge466.loopexit, %bb.kj
  %.18.lcssa = phi i32 [ %i.buw, %bb.kj ], [ %i.bvw, %._crit_edge466.loopexit ] ; 3 uses
  %.2250.lcssa = phi i32 [ %.1249470, %bb.kj ], [ %i.bvx, %._crit_edge466.loopexit ] ; 2 uses
  %indvars.iv.next609 = add nsw i64 %indvars.iv608, -1 ; 2 uses
  %i.bvy = icmp samesign ult i64 %indvars.iv611, %indvars.iv.next609
  br i1 %i.bvy, label %bb.kj, label %._crit_edge474, !llvm.loop !110
