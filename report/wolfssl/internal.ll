...
bb.bd:                                            ; preds = %bb.bc
  ...
  %i.hh = xor i8 %.0..0..0..0., -1                ; 8 uses
  %.sroa.0.0.extract.trunc291 = trunc i64 %.sroa.0.3433 to i8
  %i.hi = ptrtoint ptr %i.hg to i64               ; 2 uses
  %i.hj = xor i64 %.sroa.0.3433, %i.hi            ; 5 uses
  %4 = trunc i64 %i.hj to i8
  %5 = and i8 %i.hh, %4
  %6 = xor i8 %5, %.sroa.0.0.extract.trunc291
  %.sroa.0.0.insert.ext293 = zext i8 %6 to i64
  %.sroa.0.1.extract.shift297 = lshr i64 %.sroa.0.3433, 8
  %.sroa.0.1.extract.trunc298 = trunc i64 %.sroa.0.1.extract.shift297 to i8
  %7 = lshr i64 %i.hj, 8
  %8 = trunc i64 %7 to i8
  %9 = and i8 %i.hh, %8
  %10 = xor i8 %9, %.sroa.0.1.extract.trunc298
  %.sroa.0.1.insert.ext300 = zext i8 %10 to i64
  %.sroa.0.1.insert.shift301 = shl nuw nsw i64 %.sroa.0.1.insert.ext300, 8
  %11 = or disjoint i64 %.sroa.0.1.insert.shift301, %.sroa.0.0.insert.ext293
  %.sroa.0.2.extract.shift305 = lshr i64 %.sroa.0.3433, 16
  %.sroa.0.2.extract.trunc306 = trunc i64 %.sroa.0.2.extract.shift305 to i8
  %12 = lshr i64 %i.hj, 16
  %13 = trunc i64 %12 to i8
  %14 = and i8 %i.hh, %13
  %15 = xor i8 %14, %.sroa.0.2.extract.trunc306
  %.sroa.0.2.insert.ext308 = zext i8 %15 to i64
  %.sroa.0.2.insert.shift309 = shl nuw nsw i64 %.sroa.0.2.insert.ext308, 16
  %16 = or disjoint i64 %11, %.sroa.0.2.insert.shift309
  %.sroa.0.3.extract.shift313 = lshr i64 %.sroa.0.3433, 24
  %.sroa.0.3.extract.trunc314 = trunc i64 %.sroa.0.3.extract.shift313 to i8
  %17 = lshr i64 %i.hj, 24
  %18 = trunc i64 %17 to i8
  %19 = and i8 %i.hh, %18
  %20 = xor i8 %19, %.sroa.0.3.extract.trunc314
  %.sroa.0.3.insert.ext316 = zext i8 %20 to i64
  %.sroa.0.3.insert.shift317 = shl nuw nsw i64 %.sroa.0.3.insert.ext316, 24
  %21 = or disjoint i64 %16, %.sroa.0.3.insert.shift317 ; 2 uses
  ...
  %.sroa.0.4.insert.mask326 = or i64 %21, %.sroa.0.3433 ; 4 uses
  %.sroa.0.5.extract.shift329 = lshr i64 %.sroa.0.4.insert.mask326, 40
  ...
  %.sroa.0.6.extract.shift337 = lshr i64 %.sroa.0.4.insert.mask326, 48
  ...
  %.sroa.0.4.insert.mask326.masked454 = and i64 %.sroa.0.4.insert.mask326, -72057594037927936
  ...
  %.sroa.0.7.insert.insert351 = or disjoint i64 %i.ib, %21 ; 2 uses
