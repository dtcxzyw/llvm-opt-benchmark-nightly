...
bb.h:                                             ; preds = %bb.a
  ...
  %i.dy = load <2 x float>, ptr %i.f, align 8, !tbaa !70 ; 7 uses
  %i.dz = load float, ptr %i.g, align 4, !tbaa !70 ; 15 uses
  %i.ea = load <2 x float>, ptr %i.n, align 8, !tbaa !70 ; 8 uses
  %i.eb = load float, ptr %i.o, align 4, !tbaa !70 ; 5 uses
...
bb.i:                                             ; preds = %bb.h
  ...
  %5 = fsub <2 x float> %i.dx, %i.ei              ; 2 uses
  %6 = shufflevector <2 x float> %i.dy, <2 x float> %i.ea, <2 x i32> <i32 1, i32 3>
  %7 = shufflevector <2 x float> %i.dy, <2 x float> %i.ea, <2 x i32> <i32 0, i32 2>
  %i.ej = fsub <2 x float> %6, %7                 ; 4 uses
  %8 = extractelement <2 x float> %i.ej, i64 0    ; 2 uses
  %i.ek = fdiv float %i.eh, %8                    ; 2 uses
  %i.el = fmul float %8, %i.ek
  %i.em = fmul float %i.ek, 5.000000e-01
  %i.en = extractelement <2 x float> %i.ej, i64 1
  %9 = fmul float %i.em, %i.en
  %10 = extractelement <2 x float> %i.ea, i64 0   ; 2 uses
  %i.eo = fadd float %10, %9
  %i.ep = fmul float %i.el, %i.eo
  %i.eq = fmul float %i.eh, %10
  ...
  %i.ez = shufflevector <2 x float> %i.ej, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.fa = fdiv <2 x float> %5, %i.ez              ; 2 uses
  %i.fb = fmul <2 x float> %i.ez, %i.fa
  %i.fc = fmul <2 x float> %i.fa, splat (float 5.000000e-01)
  %11 = shufflevector <2 x float> %i.ej, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.fd = fmul <2 x float> %i.fc, %11
