...
bb.e:                                             ; preds = %bb.a
  ...
  %4 = fsub double %i.by, %1
  %i.bz = fsub double %4, %i.bs
  ...
  %i.cj = insertelement <2 x double> %i.ci, double %i.ce, i64 1
  %i.ck = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cg, <2 x double> %i.ch, <2 x double> %i.cj) ; 2 uses
  %i.cl = insertelement <2 x double> %i.ck, double %i.bz, i64 0
