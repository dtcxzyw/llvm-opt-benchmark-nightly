...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %8 = shufflevector <4 x float> %i.cg, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %i.ch = fsub <4 x float> %i.cf, %i.cg           ; 2 uses
  %9 = shufflevector <4 x float> %i.ch, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  ...
  %i.cv = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %7, <8 x float> %9, <8 x float> %8)
