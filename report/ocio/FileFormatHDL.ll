...
_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EEC2ERKS7_.exit: ; preds = %bb.u
  store ptr %i.ck, ptr %i.ch, align 8, !tbaa !74
  ret void
...
define linkonce_odr hidden void @_ZNSt12__shared_ptrIN16OpenColorIO_v2_511Lut3DOpDataELN9__gnu_cxx12_Lock_policyE2EED2Ev(ptr noundef nonnull align 8 dead_on_return(16) dereferenceable(16) %0) unnamed_addr #0 comdat align 2 personality ptr @__gxx_personality_v0 {
bb.a:
...
bb.c:                                             ; preds = %bb.b
  ...
  tail call void %i.j(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #26, !inline_history !190
  %i.k = load ptr, ptr %i.b, align 8, !tbaa !12
  %i.l = getelementptr inbounds nuw i8, ptr %i.k, i64 24
  %i.m = load ptr, ptr %i.l, align 8
  tail call void %i.m(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #26, !inline_history !190
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  %i.br = load float, ptr %i.bq, align 4, !tbaa !40 ; 2 uses
  %.idx.1 = mul i64 %i.bp, 12
  %i.bs = getelementptr i8, ptr %i.ak, i64 %.idx.1 ; 3 uses
  store float %i.br, ptr %i.bs, align 4, !tbaa !40
  %i.bt = getelementptr i8, ptr %i.bs, i64 4
  store float %i.br, ptr %i.bt, align 4, !tbaa !40
  %i.bu = load float, ptr %i.bq, align 4, !tbaa !40
  %i.bv = getelementptr i8, ptr %i.bs, i64 8
  store float %i.bu, ptr %i.bv, align 4, !tbaa !40
