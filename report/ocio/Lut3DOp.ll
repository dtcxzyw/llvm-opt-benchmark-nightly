Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/ocio/original/Lut3DOp?download=true
...
$_ZNSt12__shared_ptrIN16OpenColorIO_v2_52OpELN9__gnu_cxx12_Lock_policyE2EED2Ev = comdat any

$_ZNSt12__shared_ptrIKN16OpenColorIO_v2_56OpDataELN9__gnu_cxx12_Lock_policyE2EED2Ev = comdat any

$_ZNSt12__shared_ptrIN16OpenColorIO_v2_514Lut3DTransformELN9__gnu_cxx12_Lock_policyE2EED2Ev = comdat any

$_ZNSt12__shared_ptrIKN16OpenColorIO_v2_511Lut3DOpDataELN9__gnu_cxx12_Lock_policyE2EED2Ev = comdat any
...
$_ZN16OpenColorIO_v2_52OpD2Ev = comdat any

$_ZNK16OpenColorIO_v2_52Op10isNoOpTypeEv = comdat any

$_ZNK16OpenColorIO_v2_52Op6isNoOpEv = comdat any

$_ZNK16OpenColorIO_v2_52Op10isIdentityEv = comdat any

$_ZNK16OpenColorIO_v2_52Op12dumpMetadataERSt10shared_ptrINS_17ProcessorMetadataEE = comdat any

$_ZN16OpenColorIO_v2_52Op8finalizeEv = comdat any

$_ZNK16OpenColorIO_v2_52Op5applyEPvl = comdat any

$_ZNK16OpenColorIO_v2_52Op5applyEPKvPvl = comdat any

$_ZN16OpenColorIO_v2_52Op22replaceDynamicPropertyENS_19DynamicPropertyTypeERSt10shared_ptrINS_25DynamicPropertyDoubleImplEE = comdat any

$_ZN16OpenColorIO_v2_52Op22replaceDynamicPropertyENS_19DynamicPropertyTypeERSt10shared_ptrINS_33DynamicPropertyGradingPrimaryImplEE = comdat any

$_ZN16OpenColorIO_v2_52Op22replaceDynamicPropertyENS_19DynamicPropertyTypeERSt10shared_ptrINS_34DynamicPropertyGradingRGBCurveImplEE = comdat any

$_ZN16OpenColorIO_v2_52Op22replaceDynamicPropertyENS_19DynamicPropertyTypeERSt10shared_ptrINS_34DynamicPropertyGradingHueCurveImplEE = comdat any

$_ZN16OpenColorIO_v2_52Op22replaceDynamicPropertyENS_19DynamicPropertyTypeERSt10shared_ptrINS_30DynamicPropertyGradingToneImplEE = comdat any

$_ZN16OpenColorIO_v2_52Op23removeDynamicPropertiesEv = comdat any

$_ZNSt12__shared_ptrIKN16OpenColorIO_v2_55OpCPUELN9__gnu_cxx12_Lock_policyE2EED2Ev = comdat any

$_ZNSt12__shared_ptrIN16OpenColorIO_v2_511Lut3DOpDataELN9__gnu_cxx12_Lock_policyE2EED2Ev = comdat any

$_ZTIN16OpenColorIO_v2_514Lut3DTransformE = comdat any

$_ZTSN16OpenColorIO_v2_514Lut3DTransformE = comdat any
...
@_ZTIN16OpenColorIO_v2_514Lut3DTransformE = linkonce_odr constant { ptr, ptr, ptr } { ptr getelementptr inbounds (ptr, ptr @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2), ptr @_ZTSN16OpenColorIO_v2_514Lut3DTransformE, ptr @_ZTIN16OpenColorIO_v2_59TransformE }, comdat, align 8
@_ZTVN10__cxxabiv120__si_class_type_infoE = external global [0 x ptr]
@_ZTSN16OpenColorIO_v2_514Lut3DTransformE = linkonce_odr constant [37 x i8] c"N16OpenColorIO_v2_514Lut3DTransformE\00", comdat, align 1
...
@_ZTVN16OpenColorIO_v2_52OpE = external constant { [31 x ptr] }, align 8
...
.lr.ph.preheader:                                 ; preds = %.preheader65
  ...
  %i.m = insertelement <2 x i32> poison, i32 %1, i64 0
  %i.n = shufflevector <2 x i32> %i.m, <2 x i32> poison, <2 x i32> zeroinitializer
  br label %.lr.ph

.preheader:                                       ; preds = %bb.f
  %i.o = mul nsw i32 %1, %1
  %i.p = mul nsw i32 %i.o, %1                     ; 2 uses
  %i.q = icmp sgt i32 %i.p, 0
  br i1 %i.q, label %.lr.ph69.preheader, label %.loopexit

.lr.ph69.preheader:                               ; preds = %.preheader
  %i.r = zext nneg i32 %2 to i64
  %wide.trip.count75 = zext nneg i32 %i.p to i64
  %i.s = insertelement <2 x float> poison, float %i.f, i64 0
...
.lr.ph69:                                         ; preds = %.lr.ph69.preheader, %.lr.ph69
  ...
  %i.u = trunc nuw nsw i64 %indvars.iv72 to i32   ; 2 uses
  %i.v = mul nuw nsw i64 %indvars.iv72, %i.r
  %i.w = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %i.v ; 2 uses
  %i.x = sdiv i32 %i.u, %1                        ; 2 uses
  %i.y = srem i32 %i.x, %1
  %4 = srem i32 %i.u, %1
  %5 = sitofp i32 %i.y to float
  %6 = uitofp nneg i32 %4 to float
  %i.z = insertelement <2 x float> poison, float %6, i64 0
  %i.aa = insertelement <2 x float> %i.z, float %5, i64 1
  %i.ab = fmul <2 x float> %i.t, %i.aa
  store <2 x float> %i.ab, ptr %i.w, align 4, !tbaa !23
  %i.ac = sdiv i32 %i.x, %1
  %i.ad = srem i32 %i.ac, %1
  %i.ae = sitofp i32 %i.ad to float
  %i.af = fmul float %i.f, %i.ae
  %i.ag = getelementptr inbounds nuw i8, ptr %i.w, i64 8
  store float %i.af, ptr %i.ag, align 4, !tbaa !23
  %indvars.iv.next73 = add nuw nsw i64 %indvars.iv72, 1 ; 2 uses
  %exitcond76.not = icmp eq i64 %indvars.iv.next73, %wide.trip.count75
  br i1 %exitcond76.not, label %.loopexit, label %.lr.ph69, !llvm.loop !89

.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  %indvars.iv = phi i64 [ 0, %.lr.ph.preheader ], [ %indvars.iv.next, %.lr.ph ] ; 3 uses
  %i.ah = trunc nuw nsw i64 %indvars.iv to i32    ; 2 uses
  %i.ai = sdiv i32 %i.ah, %1                      ; 2 uses
  %i.aj = sdiv i32 %i.ai, %1
  %i.ak = mul nuw nsw i64 %indvars.iv, %i.j
  %i.al = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %i.ak ; 2 uses
  %i.am = insertelement <2 x i32> poison, i32 %i.aj, i64 0
  %i.an = insertelement <2 x i32> %i.am, i32 %i.ai, i64 1
  %i.ao = srem <2 x i32> %i.an, %i.n
  %i.ap = sitofp <2 x i32> %i.ao to <2 x float>
  %i.aq = fmul <2 x float> %i.l, %i.ap
  store <2 x float> %i.aq, ptr %i.al, align 4, !tbaa !23
  %i.ar = srem i32 %i.ah, %1
  %i.as = uitofp nneg i32 %i.ar to float
  %i.at = fmul float %i.f, %i.as
  %i.au = getelementptr inbounds nuw i8, ptr %i.al, i64 8
  store float %i.at, ptr %i.au, align 4, !tbaa !23
...
bb.g:                                             ; preds = %bb.f
  ...
  invoke void @_ZN16OpenColorIO_v2_59ExceptionC1EPKc(ptr noundef nonnull align 8 dereferenceable(16) %i.av, ptr noundef nonnull @.str.1)
          to label %bb.h unwind label %bb.i

bb.h:                                             ; preds = %bb.g
  tail call void @__cxa_throw(ptr nonnull %i.av, ptr nonnull @_ZTIN16OpenColorIO_v2_59ExceptionE, ptr nonnull @_ZN16OpenColorIO_v2_59ExceptionD1Ev) #21
  unreachable
...
bb.j:                                             ; preds = %bb.i, %bb.e
  %.sink = phi ptr [ %i.av, %bb.i ], [ %i.b, %bb.e ]
  %.pn = phi { ptr, i32 } [ %i.aw, %bb.i ], [ %i.c, %bb.e ]
...
bb.a:
  ...
  %i.b = tail call float @powf(float noundef %i.a, float noundef f0x3EAAAAAB) #20
