...
.preheader:                                       ; preds = %bb.f
  %i.m = mul nsw i32 %1, %1
  %i.n = mul nsw i32 %i.m, %1                     ; 2 uses
  %i.o = icmp sgt i32 %i.n, 0
  br i1 %i.o, label %.lr.ph69.preheader, label %.loopexit

.lr.ph69.preheader:                               ; preds = %.preheader
  %i.p = zext nneg i32 %2 to i64
  %wide.trip.count75 = zext nneg i32 %i.n to i64
...
.lr.ph69:                                         ; preds = %.lr.ph69.preheader, %.lr.ph69
  ...
  %i.s = trunc nuw nsw i64 %indvars.iv72 to i32   ; 2 uses
  %i.t = mul nuw nsw i64 %indvars.iv72, %i.p
  %i.u = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %i.t ; 2 uses
  %i.v = sdiv i32 %i.s, %1                        ; 2 uses
  %i.w = srem i32 %i.v, %1
  %i.x = srem i32 %i.s, %1
  ...
  %i.ac = fmul <2 x float> %i.r, %i.ab
  store <2 x float> %i.ac, ptr %i.u, align 4, !tbaa !23
  %i.ad = sdiv i32 %i.v, %1
  %i.ae = srem i32 %i.ad, %1
  %i.af = sitofp i32 %i.ae to float
  %i.ag = fmul float %i.f, %i.af
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %i.as = fmul float %i.f, %i.ar
  %i.at = getelementptr inbounds nuw i8, ptr %i.am, i64 8
  store float %i.as, ptr %i.at, align 4, !tbaa !23
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %.loopexit, label %.lr.ph, !llvm.loop !90

bb.g:                                             ; preds = %bb.f
  %i.au = tail call ptr @__cxa_allocate_exception(i64 16) #20 ; 3 uses
  invoke void @_ZN16OpenColorIO_v2_59ExceptionC1EPKc(ptr noundef nonnull align 8 dereferenceable(16) %i.au, ptr noundef nonnull @.str.1)
          to label %bb.h unwind label %bb.i

bb.h:                                             ; preds = %bb.g
  tail call void @__cxa_throw(ptr nonnull %i.au, ptr nonnull @_ZTIN16OpenColorIO_v2_59ExceptionE, ptr nonnull @_ZN16OpenColorIO_v2_59ExceptionD1Ev) #21
  unreachable
...
bb.j:                                             ; preds = %bb.i, %bb.e
  %.sink = phi ptr [ %i.au, %bb.i ], [ %i.b, %bb.e ]
  %.pn = phi { ptr, i32 } [ %i.av, %bb.i ], [ %i.c, %bb.e ]
...
bb.a:
  ...
  %i.d = load <2 x ptr>, ptr %1, align 8, !tbaa !34
  store <2 x ptr> %i.d, ptr %3, align 16, !tbaa !34
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.f = load i8, ptr @__libc_single_threaded, align 1, !tbaa !30
  %.not.i.i.i.i = icmp eq i8 %i.f, 0
  br i1 %.not.i.i.i.i, label %bb.d, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.g = load i32, ptr %i.e, align 4, !tbaa !35
