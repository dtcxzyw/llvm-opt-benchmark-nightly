...
begin_hunk_0_@_ZN16OpenColorIO_v2_512_GLOBAL__N_117BaseLut1DRendererILNS_8BitDepthE8ELS2_2EEC2ERSt10shared_ptrIKNS_11Lut1DOpDataEES2_:bb.a
  ...
  store i32 8, ptr %i.i, align 4, !tbaa !1141
  %i.j = getelementptr inbounds nuw i8, ptr %0, i64 48
  store <2 x float> <float 1.000000e+00, float 0.000000e+00>, ptr %i.j, align 8, !tbaa !72
  %i.k = getelementptr inbounds nuw i8, ptr %0, i64 56 ; 4 uses
  store ptr null, ptr %i.k, align 8, !tbaa !1142
...
bb.a:
  ...
  tail call void %i.c(ptr noundef nonnull align 8 dead_on_return(64) dereferenceable(64) %i.a) #21, !inline_history !8277
  ret void
}
...
bb.a:
  store ptr getelementptr inbounds nuw inrange(-16, 56) (i8, ptr @_ZTVN16OpenColorIO_v2_512_GLOBAL__N_117BaseLut1DRendererILNS_8BitDepthE8ELS2_2EEE, i64 16), ptr %0, align 8, !tbaa !58
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !1143 ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  tail call void @_ZdaPv(ptr noundef nonnull %i.b) #24, !inline_history !1144
  %.pre.i.i = load ptr, ptr %i.c, align 8, !tbaa !1145
  br label %bb.d

bb.d:                                             ; preds = %bb.c, %bb.b
  %i.g = phi ptr [ %.pre.i.i, %bb.c ], [ %i.d, %bb.b ] ; 2 uses
  store ptr null, ptr %i.a, align 8, !tbaa !1143
  %i.h = icmp eq ptr %i.g, null
  br i1 %i.h, label %bb.f, label %bb.e

bb.e:                                             ; preds = %bb.d
  tail call void @_ZdaPv(ptr noundef nonnull %i.g) #24, !inline_history !1144
  br label %bb.f

bb.f:                                             ; preds = %bb.e, %bb.d
  store ptr null, ptr %i.c, align 8, !tbaa !1145
  %i.i = load ptr, ptr %i.e, align 8, !tbaa !1146 ; 2 uses
  %i.j = icmp eq ptr %i.i, null
  br i1 %i.j, label %_ZN16OpenColorIO_v2_512_GLOBAL__N_117BaseLut1DRendererILNS_8BitDepthE8ELS2_2EED2Ev.exit, label %bb.g

bb.g:                                             ; preds = %bb.f
  tail call void @_ZdaPv(ptr noundef nonnull %i.i) #24, !inline_history !1144
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !1142 ; 2 uses
  %i.c = icmp ne ptr %i.b, null
  %i.d = icmp sgt i64 %3, 1
  %or.cond = and i1 %i.d, %i.c
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !1143 ; 3 uses
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !1145 ; 3 uses
  %i.i = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.j = load ptr, ptr %i.i, align 8, !tbaa !1146 ; 3 uses
  br i1 %or.cond, label %bb.b, label %bb.c

bb.b:                                             ; preds = %bb.a
  %i.k = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.l = load i64, ptr %i.k, align 8, !tbaa !1140
...
.lr.ph:                                           ; preds = %bb.c
  ...
  %4 = load <2 x float>, ptr %i.o, align 8, !tbaa !72 ; 4 uses
  %i.q = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.r = load float, ptr %i.q, align 8, !tbaa !1147
  %5 = shufflevector <2 x float> %4, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.s = shufflevector <2 x float> %4, <2 x float> poison, <2 x i32> zeroinitializer
  %6 = extractelement <2 x float> %4, i64 0
  %7 = extractelement <2 x float> %4, i64 1       ; 2 uses
  br label %bb.d
...
bb.d:                                             ; preds = %.lr.ph, %_ZN16OpenColorIO_v2_59ConverterILNS_8BitDepthE2EE9CastValueEf.exit47
  ...
  %i.bi = load float, ptr %i.bh, align 4, !tbaa !72
...
_ZN16OpenColorIO_v2_59ConverterILNS_8BitDepthE2EE9CastValueEf.exit: ; preds = %bb.d, %bb.e
  ...
  store i16 %i.bq, ptr %.03663, align 2, !tbaa !88
...
_ZN16OpenColorIO_v2_59ConverterILNS_8BitDepthE2EE9CastValueEf.exit45: ; preds = %_ZN16OpenColorIO_v2_59ConverterILNS_8BitDepthE2EE9CastValueEf.exit, %bb.f
  ...
  store i16 %i.ce, ptr %i.cf, align 2, !tbaa !88
  %i.cg = zext i32 %i.aw to i64
  %i.ch = getelementptr inbounds nuw [4 x i8], ptr %i.j, i64 %i.cg
  %i.ci = load float, ptr %i.ch, align 4, !tbaa !72 ; 2 uses
...
_ZN16OpenColorIO_v2_59ConverterILNS_8BitDepthE2EE9CastValueEf.exit46: ; preds = %_ZN16OpenColorIO_v2_59ConverterILNS_8BitDepthE2EE9CastValueEf.exit45, %bb.g
  ...
  store i16 %i.ct, ptr %i.cu, align 2, !tbaa !88
  %i.cv = getelementptr inbounds nuw i8, ptr %.064, i64 12
  %i.cw = load float, ptr %i.cv, align 4, !tbaa !72
...
_ZN16OpenColorIO_v2_59ConverterILNS_8BitDepthE2EE9CastValueEf.exit47: ; preds = %_ZN16OpenColorIO_v2_59ConverterILNS_8BitDepthE2EE9CastValueEf.exit46, %bb.h
  ...
  store i16 %i.dd, ptr %i.de, align 2, !tbaa !88
  ...
  br i1 %exitcond.not, label %.loopexit, label %bb.d, !llvm.loop !8278
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !58
  %i.c = load ptr, ptr %i.b, align 8
  tail call void %i.c(ptr noundef nonnull align 8 dead_on_return(64) dereferenceable(64) %i.a) #21, !inline_history !8279
  ret void
}
...
bb.c:                                             ; preds = %bb.b
  ...
  %.pre.i = load ptr, ptr %i.c, align 8, !tbaa !1145
  br label %bb.d
...
begin_hunk_1_@_ZN16OpenColorIO_v2_512_GLOBAL__N_117BaseLut1DRendererILNS_8BitDepthE8ELS2_3EEC2ERSt10shared_ptrIKNS_11Lut1DOpDataEES2_:bb.a
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(28) %i.h, i8 0, i64 28, i1 false)
  store i32 8, ptr %i.i, align 4, !tbaa !1173
  %i.j = getelementptr inbounds nuw i8, ptr %0, i64 48
  store <2 x float> <float 1.000000e+00, float 0.000000e+00>, ptr %i.j, align 8, !tbaa !72
  %i.k = getelementptr inbounds nuw i8, ptr %0, i64 56 ; 4 uses
  store ptr null, ptr %i.k, align 8, !tbaa !1174
  %i.l = load ptr, ptr %0, align 8, !tbaa !58
  %i.m = getelementptr inbounds nuw i8, ptr %i.l, i64 48
  %i.n = load ptr, ptr %i.m, align 8
  tail call void %i.n(ptr noundef nonnull align 8 dereferenceable(64) %0, ptr noundef nonnull align 8 dereferenceable(16) %1)
...
bb.b:                                             ; preds = %bb.a
  %i.r = load i32, ptr %i.i, align 4, !tbaa !1173
  %i.s = tail call noundef ptr @_ZN16OpenColorIO_v2_521SSE2GetLut1DApplyFuncENS_8BitDepthES0_(i32 noundef 8, i32 noundef %i.r)
  store ptr %i.s, ptr %i.k, align 8, !tbaa !1174
  br label %bb.c
...
bb.e:                                             ; preds = %bb.d
  %i.z = load i32, ptr %i.i, align 4, !tbaa !1173
  %i.aa = tail call noundef ptr @_ZN16OpenColorIO_v2_520AVXGetLut1DApplyFuncENS_8BitDepthES0_(i32 noundef 8, i32 noundef %i.z)
  store ptr %i.aa, ptr %i.k, align 8, !tbaa !1174
  br label %bb.f
...
bb.h:                                             ; preds = %bb.g
  %i.ah = load i32, ptr %i.i, align 4, !tbaa !1173
  %i.ai = tail call noundef ptr @_ZN16OpenColorIO_v2_521AVX2GetLut1DApplyFuncENS_8BitDepthES0_(i32 noundef 8, i32 noundef %i.ah)
  store ptr %i.ai, ptr %i.k, align 8, !tbaa !1174
  br label %bb.i
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !58
  %i.c = load ptr, ptr %i.b, align 8
  tail call void %i.c(ptr noundef nonnull align 8 dead_on_return(64) dereferenceable(64) %i.a) #21, !inline_history !8447
  ret void
}
...
bb.a:
  store ptr getelementptr inbounds nuw inrange(-16, 56) (i8, ptr @_ZTVN16OpenColorIO_v2_512_GLOBAL__N_117BaseLut1DRendererILNS_8BitDepthE8ELS2_3EEE, i64 16), ptr %0, align 8, !tbaa !58
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !1175 ; 2 uses
  %.not.i.i = icmp eq ptr %i.b, null              ; 2 uses
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 24 ; 3 uses
  %i.d = load ptr, ptr %i.c, align 8              ; 2 uses
  %.not1.i.i = icmp eq ptr %i.d, null
...
bb.c:                                             ; preds = %bb.b
  tail call void @_ZdaPv(ptr noundef nonnull %i.b) #24, !inline_history !1176
  %.pre.i.i = load ptr, ptr %i.c, align 8, !tbaa !1177
  br label %bb.d

bb.d:                                             ; preds = %bb.c, %bb.b
  %i.g = phi ptr [ %.pre.i.i, %bb.c ], [ %i.d, %bb.b ] ; 2 uses
  store ptr null, ptr %i.a, align 8, !tbaa !1175
  %i.h = icmp eq ptr %i.g, null
  br i1 %i.h, label %bb.f, label %bb.e

bb.e:                                             ; preds = %bb.d
  tail call void @_ZdaPv(ptr noundef nonnull %i.g) #24, !inline_history !1176
  br label %bb.f

bb.f:                                             ; preds = %bb.e, %bb.d
  store ptr null, ptr %i.c, align 8, !tbaa !1177
  %i.i = load ptr, ptr %i.e, align 8, !tbaa !1178 ; 2 uses
  %i.j = icmp eq ptr %i.i, null
  br i1 %i.j, label %_ZN16OpenColorIO_v2_512_GLOBAL__N_117BaseLut1DRendererILNS_8BitDepthE8ELS2_3EED2Ev.exit, label %bb.g

bb.g:                                             ; preds = %bb.f
  tail call void @_ZdaPv(ptr noundef nonnull %i.i) #24, !inline_history !1176
...
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 56
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !1174 ; 2 uses
  %i.c = icmp ne ptr %i.b, null
  %i.d = icmp sgt i64 %3, 1
  %or.cond = and i1 %i.d, %i.c
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !1175 ; 3 uses
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !1177 ; 3 uses
  %i.i = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.j = load ptr, ptr %i.i, align 8, !tbaa !1178 ; 3 uses
  br i1 %or.cond, label %bb.b, label %bb.c

bb.b:                                             ; preds = %bb.a
  %i.k = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.l = load i64, ptr %i.k, align 8, !tbaa !1172
  %i.m = trunc i64 %i.l to i32
  tail call void %i.b(ptr noundef %i.f, ptr noundef %i.h, ptr noundef %i.j, i32 noundef %i.m, ptr noundef %1, ptr noundef %2, i64 noundef %3)
  br label %.loopexit
...
.lr.ph:                                           ; preds = %bb.c
  ...
  %4 = load <2 x float>, ptr %i.o, align 8, !tbaa !72 ; 4 uses
  %i.q = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.r = load float, ptr %i.q, align 8, !tbaa !1179
  %5 = shufflevector <2 x float> %4, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.s = shufflevector <2 x float> %4, <2 x float> poison, <2 x i32> zeroinitializer
  %6 = extractelement <2 x float> %4, i64 0
  %7 = extractelement <2 x float> %4, i64 1       ; 2 uses
...
_ZN16OpenColorIO_v2_59ConverterILNS_8BitDepthE3EE9CastValueEf.exit47: ; preds = %_ZN16OpenColorIO_v2_59ConverterILNS_8BitDepthE3EE9CastValueEf.exit46, %bb.h
  ...
  %i.dh = add nuw nsw i64 %.03762, 1              ; 2 uses
  %exitcond.not = icmp eq i64 %i.dh, %3
  br i1 %exitcond.not, label %.loopexit, label %bb.d, !llvm.loop !8448
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !58
  %i.c = load ptr, ptr %i.b, align 8
  tail call void %i.c(ptr noundef nonnull align 8 dead_on_return(64) dereferenceable(64) %i.a) #21, !inline_history !8449
  ret void
}
...
bb.c:                                             ; preds = %bb.b
  tail call void @_ZdaPv(ptr noundef nonnull %i.b) #24
  %.pre.i = load ptr, ptr %i.c, align 8, !tbaa !1177
  br label %bb.d
...
begin_hunk_2_@_ZN16OpenColorIO_v2_512_GLOBAL__N_117BaseLut1DRendererILNS_8BitDepthE8ELS2_5EEC2ERSt10shared_ptrIKNS_11Lut1DOpDataEES2_:bb.a
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(28) %i.h, i8 0, i64 28, i1 false)
  store i32 8, ptr %i.i, align 4, !tbaa !1205
  %i.j = getelementptr inbounds nuw i8, ptr %0, i64 48
  store <2 x float> <float 1.000000e+00, float 0.000000e+00>, ptr %i.j, align 8, !tbaa !72
  %i.k = getelementptr inbounds nuw i8, ptr %0, i64 56 ; 4 uses
  store ptr null, ptr %i.k, align 8, !tbaa !1206
  %i.l = load ptr, ptr %0, align 8, !tbaa !58
  %i.m = getelementptr inbounds nuw i8, ptr %i.l, i64 48
  %i.n = load ptr, ptr %i.m, align 8
  tail call void %i.n(ptr noundef nonnull align 8 dereferenceable(64) %0, ptr noundef nonnull align 8 dereferenceable(16) %1)
...
bb.b:                                             ; preds = %bb.a
  %i.r = load i32, ptr %i.i, align 4, !tbaa !1205
  %i.s = tail call noundef ptr @_ZN16OpenColorIO_v2_521SSE2GetLut1DApplyFuncENS_8BitDepthES0_(i32 noundef 8, i32 noundef %i.r)
  store ptr %i.s, ptr %i.k, align 8, !tbaa !1206
  br label %bb.c
...
bb.e:                                             ; preds = %bb.d
  %i.z = load i32, ptr %i.i, align 4, !tbaa !1205
  %i.aa = tail call noundef ptr @_ZN16OpenColorIO_v2_520AVXGetLut1DApplyFuncENS_8BitDepthES0_(i32 noundef 8, i32 noundef %i.z)
  store ptr %i.aa, ptr %i.k, align 8, !tbaa !1206
  br label %bb.f
...
bb.h:                                             ; preds = %bb.g
  %i.ah = load i32, ptr %i.i, align 4, !tbaa !1205
  %i.ai = tail call noundef ptr @_ZN16OpenColorIO_v2_521AVX2GetLut1DApplyFuncENS_8BitDepthES0_(i32 noundef 8, i32 noundef %i.ah)
  store ptr %i.ai, ptr %i.k, align 8, !tbaa !1206
  br label %bb.i
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !58
  %i.c = load ptr, ptr %i.b, align 8
  tail call void %i.c(ptr noundef nonnull align 8 dead_on_return(64) dereferenceable(64) %i.a) #21, !inline_history !8617
  ret void
}
...
bb.a:
  store ptr getelementptr inbounds nuw inrange(-16, 56) (i8, ptr @_ZTVN16OpenColorIO_v2_512_GLOBAL__N_117BaseLut1DRendererILNS_8BitDepthE8ELS2_5EEE, i64 16), ptr %0, align 8, !tbaa !58
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  tail call void @_ZdaPv(ptr noundef nonnull %i.b) #24, !inline_history !1208
  %.pre.i.i = load ptr, ptr %i.c, align 8, !tbaa !1209
  br label %bb.d

bb.d:                                             ; preds = %bb.c, %bb.b
  %i.g = phi ptr [ %.pre.i.i, %bb.c ], [ %i.d, %bb.b ] ; 2 uses
  store ptr null, ptr %i.a, align 8, !tbaa !1207
  %i.h = icmp eq ptr %i.g, null
  br i1 %i.h, label %bb.f, label %bb.e

bb.e:                                             ; preds = %bb.d
  tail call void @_ZdaPv(ptr noundef nonnull %i.g) #24, !inline_history !1208
  br label %bb.f

bb.f:                                             ; preds = %bb.e, %bb.d
  store ptr null, ptr %i.c, align 8, !tbaa !1209
  %i.i = load ptr, ptr %i.e, align 8, !tbaa !1210 ; 2 uses
  %i.j = icmp eq ptr %i.i, null
  br i1 %i.j, label %_ZN16OpenColorIO_v2_512_GLOBAL__N_117BaseLut1DRendererILNS_8BitDepthE8ELS2_5EED2Ev.exit, label %bb.g

bb.g:                                             ; preds = %bb.f
  tail call void @_ZdaPv(ptr noundef nonnull %i.i) #24, !inline_history !1208
...
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 56
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !1206 ; 2 uses
  %i.c = icmp ne ptr %i.b, null
  %i.d = icmp sgt i64 %3, 1
  %or.cond = and i1 %i.d, %i.c
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 16
  ...
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !1209 ; 3 uses
  %i.i = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.j = load ptr, ptr %i.i, align 8, !tbaa !1210 ; 3 uses
  br i1 %or.cond, label %bb.b, label %bb.c

bb.b:                                             ; preds = %bb.a
  %i.k = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.l = load i64, ptr %i.k, align 8, !tbaa !1204
  %i.m = trunc i64 %i.l to i32
  tail call void %i.b(ptr noundef %i.f, ptr noundef %i.h, ptr noundef %i.j, i32 noundef %i.m, ptr noundef %1, ptr noundef %2, i64 noundef %3)
  br label %.loopexit
...
.lr.ph:                                           ; preds = %bb.c
  ...
  %4 = load <2 x float>, ptr %i.o, align 8, !tbaa !72 ; 4 uses
  %i.q = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.r = load float, ptr %i.q, align 8, !tbaa !1211
  %5 = shufflevector <2 x float> %4, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.s = shufflevector <2 x float> %4, <2 x float> poison, <2 x i32> zeroinitializer
  %6 = extractelement <2 x float> %4, i64 0
  %7 = extractelement <2 x float> %4, i64 1       ; 2 uses
...
_ZN16OpenColorIO_v2_59ConverterILNS_8BitDepthE5EE9CastValueEf.exit47: ; preds = %_ZN16OpenColorIO_v2_59ConverterILNS_8BitDepthE5EE9CastValueEf.exit46, %bb.h
  ...
  %i.dh = add nuw nsw i64 %.03762, 1              ; 2 uses
  %exitcond.not = icmp eq i64 %i.dh, %3
  br i1 %exitcond.not, label %.loopexit, label %bb.d, !llvm.loop !8618
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !58
  %i.c = load ptr, ptr %i.b, align 8
  tail call void %i.c(ptr noundef nonnull align 8 dead_on_return(64) dereferenceable(64) %i.a) #21, !inline_history !8619
  ret void
}
...
bb.c:                                             ; preds = %bb.b
  tail call void @_ZdaPv(ptr noundef nonnull %i.b) #24
  %.pre.i = load ptr, ptr %i.c, align 8, !tbaa !1209
  br label %bb.d
...
begin_hunk_3_@_ZN16OpenColorIO_v2_512_GLOBAL__N_117BaseLut1DRendererILNS_8BitDepthE8ELS2_7EEC2ERSt10shared_ptrIKNS_11Lut1DOpDataEES2_:bb.a
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(28) %i.h, i8 0, i64 28, i1 false)
  store i32 8, ptr %i.i, align 4, !tbaa !1237
  %i.j = getelementptr inbounds nuw i8, ptr %0, i64 48
  store <2 x float> <float 1.000000e+00, float 0.000000e+00>, ptr %i.j, align 8, !tbaa !72
  %i.k = getelementptr inbounds nuw i8, ptr %0, i64 56 ; 4 uses
  store ptr null, ptr %i.k, align 8, !tbaa !1238
  %i.l = load ptr, ptr %0, align 8, !tbaa !58
  %i.m = getelementptr inbounds nuw i8, ptr %i.l, i64 48
  %i.n = load ptr, ptr %i.m, align 8
  tail call void %i.n(ptr noundef nonnull align 8 dereferenceable(64) %0, ptr noundef nonnull align 8 dereferenceable(16) %1)
...
bb.b:                                             ; preds = %bb.a
  %i.r = load i32, ptr %i.i, align 4, !tbaa !1237
  %i.s = tail call noundef ptr @_ZN16OpenColorIO_v2_521SSE2GetLut1DApplyFuncENS_8BitDepthES0_(i32 noundef 8, i32 noundef %i.r)
  store ptr %i.s, ptr %i.k, align 8, !tbaa !1238
  br label %bb.c
...
bb.e:                                             ; preds = %bb.d
  %i.z = load i32, ptr %i.i, align 4, !tbaa !1237
  %i.aa = tail call noundef ptr @_ZN16OpenColorIO_v2_520AVXGetLut1DApplyFuncENS_8BitDepthES0_(i32 noundef 8, i32 noundef %i.z)
  store ptr %i.aa, ptr %i.k, align 8, !tbaa !1238
  br label %bb.f
...
bb.h:                                             ; preds = %bb.g
  %i.ah = load i32, ptr %i.i, align 4, !tbaa !1237
  %i.ai = tail call noundef ptr @_ZN16OpenColorIO_v2_521AVX2GetLut1DApplyFuncENS_8BitDepthES0_(i32 noundef 8, i32 noundef %i.ah)
  store ptr %i.ai, ptr %i.k, align 8, !tbaa !1238
  br label %bb.i
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !58
  %i.c = load ptr, ptr %i.b, align 8
  tail call void %i.c(ptr noundef nonnull align 8 dead_on_return(64) dereferenceable(64) %i.a) #21, !inline_history !8787
  ret void
}
...
bb.a:
  store ptr getelementptr inbounds nuw inrange(-16, 56) (i8, ptr @_ZTVN16OpenColorIO_v2_512_GLOBAL__N_117BaseLut1DRendererILNS_8BitDepthE8ELS2_7EEE, i64 16), ptr %0, align 8, !tbaa !58
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  tail call void @_ZdaPv(ptr noundef nonnull %i.b) #24, !inline_history !1240
  %.pre.i.i = load ptr, ptr %i.c, align 8, !tbaa !1241
  br label %bb.d

bb.d:                                             ; preds = %bb.c, %bb.b
  %i.g = phi ptr [ %.pre.i.i, %bb.c ], [ %i.d, %bb.b ] ; 2 uses
  store ptr null, ptr %i.a, align 8, !tbaa !1239
  %i.h = icmp eq ptr %i.g, null
  br i1 %i.h, label %bb.f, label %bb.e

bb.e:                                             ; preds = %bb.d
  tail call void @_ZdaPv(ptr noundef nonnull %i.g) #24, !inline_history !1240
  br label %bb.f

bb.f:                                             ; preds = %bb.e, %bb.d
  store ptr null, ptr %i.c, align 8, !tbaa !1241
  %i.i = load ptr, ptr %i.e, align 8, !tbaa !1242 ; 2 uses
  %i.j = icmp eq ptr %i.i, null
  br i1 %i.j, label %_ZN16OpenColorIO_v2_512_GLOBAL__N_117BaseLut1DRendererILNS_8BitDepthE8ELS2_7EED2Ev.exit, label %bb.g

bb.g:                                             ; preds = %bb.f
  tail call void @_ZdaPv(ptr noundef nonnull %i.i) #24, !inline_history !1240
...
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 56
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !1238 ; 2 uses
  %i.c = icmp ne ptr %i.b, null
  %i.d = icmp sgt i64 %3, 1
  %or.cond = and i1 %i.d, %i.c
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !1239 ; 3 uses
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !1241 ; 3 uses
  %i.i = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.j = load ptr, ptr %i.i, align 8, !tbaa !1242 ; 3 uses
  br i1 %or.cond, label %bb.b, label %bb.c

bb.b:                                             ; preds = %bb.a
  %i.k = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.l = load i64, ptr %i.k, align 8, !tbaa !1236
  %i.m = trunc i64 %i.l to i32
  tail call void %i.b(ptr noundef %i.f, ptr noundef %i.h, ptr noundef %i.j, i32 noundef %i.m, ptr noundef %1, ptr noundef %2, i64 noundef %3)
  br label %.loopexit
...
.lr.ph:                                           ; preds = %bb.c
  ...
  %4 = load <2 x float>, ptr %i.o, align 8, !tbaa !72 ; 4 uses
  %i.q = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.r = load float, ptr %i.q, align 8, !tbaa !1243
  %5 = shufflevector <2 x float> %4, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.s = shufflevector <2 x float> %4, <2 x float> poison, <2 x i32> zeroinitializer
  %6 = extractelement <2 x float> %4, i64 0
  %7 = extractelement <2 x float> %4, i64 1       ; 2 uses
...
bb.d:                                             ; preds = %.lr.ph, %_ZN16OpenColorIO_v2_59ConverterILNS_8BitDepthE7EE9CastValueEf.exit60
  ...
  %i.u = load float, ptr %i.t, align 4, !tbaa !72
  %i.v = fmul float %6, %i.u                      ; 2 uses
  %i.w = load <2 x float>, ptr %.077, align 4, !tbaa !72
  %i.x = fmul <2 x float> %i.s, %i.w              ; 2 uses
  %i.y = fcmp ogt <2 x float> %i.x, zeroinitializer
  %i.z = select <2 x i1> %i.y, <2 x float> %i.x, <2 x float> zeroinitializer ; 3 uses
  %i.aa = fcmp olt <2 x float> %5, %i.z           ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  br i1 %i.bs, label %bb.f, label %bb.h, !prof !83
...
bb.h:                                             ; preds = %bb.e
  ...
  br i1 %i.cc, label %bb.i, label %bb.j, !prof !83
...
_ZN16OpenColorIO_v2_59ConverterILNS_8BitDepthE7EE9CastValueEf.exit: ; preds = %bb.f, %bb.g, %bb.i, %bb.j, %bb.k, %bb.m, %bb.n
  ...
  store i16 %.033.i.i.i, ptr %.04076, align 2, !tbaa !88
  %i.db = zext i32 %i.au to i64
  %i.dc = getelementptr inbounds nuw [4 x i8], ptr %i.h, i64 %i.db
  %i.dd = load float, ptr %i.dc, align 4, !tbaa !72 ; 2 uses
...
bb.o:                                             ; preds = %_ZN16OpenColorIO_v2_59ConverterILNS_8BitDepthE7EE9CastValueEf.exit
  ...
  br i1 %i.dq, label %bb.p, label %bb.r, !prof !83
...
bb.r:                                             ; preds = %bb.o
  ...
  br i1 %i.ea, label %bb.s, label %bb.t, !prof !83
