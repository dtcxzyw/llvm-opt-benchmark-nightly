...
_ZNKSt6vectorIfSaIfEE12_M_check_lenEmPKc.exit.i:  ; preds = %bb.u
  ...
  %i.bk = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.bj) #22
          to label %.noexc257.a unwind label %bb.ag ; 4 uses

.noexc257.a:                                      ; preds = %_ZNKSt6vectorIfSaIfEE12_M_check_lenEmPKc.exit.i
...
_ZNSt6vectorIfSaIfEE6resizeEm.exit:               ; preds = %.noexc257.a, %bb.t
  %.sroa.0318.3 = phi ptr [ %i.bk, %.noexc257.a ], [ null, %bb.t ] ; 5 uses
  %.sroa.19329.3 = phi ptr [ %14, %.noexc257.a ], [ null, %bb.t ] ; 3 uses
...
_ZNKSt6vectorIfSaIfEE12_M_check_lenEmPKc.exit.i281: ; preds = %bb.bk
  ...
  %i.ev = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.eu) #22
          to label %.noexc290.a unwind label %bb.bo ; 4 uses

.noexc290.a:                                      ; preds = %_ZNKSt6vectorIfSaIfEE12_M_check_lenEmPKc.exit.i281
...
_ZNSt6vectorIfSaIfEE6resizeEm.exit155:            ; preds = %.noexc290.a, %bb.bj
  %.sroa.0.4 = phi ptr [ %i.ev, %.noexc290.a ], [ null, %bb.bj ] ; 8 uses
  %.sroa.22.4 = phi ptr [ %15, %.noexc290.a ], [ null, %bb.bj ] ; 5 uses
