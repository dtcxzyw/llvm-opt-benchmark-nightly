...
bb.bp:                                            ; preds = %bb.bo
  %i.kd = load ptr, ptr %0, align 8, !tbaa !33    ; 2 uses
...
bb.bq:                                            ; preds = %bb.ck, %.lr.ph.i158
  ...
  %i.kj = load ptr, ptr %0, align 8, !tbaa !33
  %i.kk = getelementptr inbounds nuw [16 x i8], ptr %i.kj, i64 %.012.i ; 2 uses
  %i.kl = load ptr, ptr %i.kk, align 8, !tbaa !17 ; 2 uses
  %i.km = load ptr, ptr %i.kl, align 8, !tbaa !22
  %i.kn = getelementptr inbounds nuw i8, ptr %i.km, i64 152
  %i.ko = load ptr, ptr %i.kn, align 8
  %i.kp = call noundef zeroext i1 %i.ko(ptr noundef nonnull align 8 dereferenceable(24) %i.kl), !inline_history !89
  br i1 %i.kp, label %bb.br, label %bb.ck

bb.br:                                            ; preds = %bb.bq
  call void @llvm.lifetime.start.p0(ptr nonnull %31) #14
  %i.kq = load ptr, ptr %i.kk, align 8, !tbaa !17 ; 2 uses
  %i.kr = load ptr, ptr %i.kq, align 8, !tbaa !22
  %i.ks = getelementptr inbounds nuw i8, ptr %i.kr, i64 16
  %i.kt = load ptr, ptr %i.ks, align 8
  call void %i.kt(ptr dead_on_unwind nonnull writable sret(%"class.std::shared_ptr") align 8 %31, ptr noundef nonnull align 8 dereferenceable(24) %i.kq), !inline_history !89
  %i.ku = load ptr, ptr %31, align 8, !tbaa !17   ; 2 uses
...
bb.bs:                                            ; preds = %bb.br
  %i.ky = load ptr, ptr %0, align 8, !tbaa !33
  %i.kz = getelementptr inbounds nuw [16 x i8], ptr %i.ky, i64 %.012.i ; 2 uses
  %i.la = load ptr, ptr %31, align 8, !tbaa !17
  store ptr %i.la, ptr %i.kz, align 8, !tbaa !17
  %i.lb = getelementptr inbounds nuw i8, ptr %i.kz, i64 8 ; 3 uses
  %i.lc = load ptr, ptr %i.ki, align 8, !tbaa !18 ; 5 uses
  %i.ld = load ptr, ptr %i.lb, align 8, !tbaa !18 ; 3 uses
...
bb.by:                                            ; preds = %bb.bx
  store i32 0, ptr %i.lk, align 8, !tbaa !24
  %i.lo = getelementptr inbounds nuw i8, ptr %i.lj, i64 12
  store i32 0, ptr %i.lo, align 4, !tbaa !25
  %i.lp = load ptr, ptr %i.lj, align 8, !tbaa !22
  %i.lq = getelementptr inbounds nuw i8, ptr %i.lp, i64 16
  %i.lr = load ptr, ptr %i.lq, align 8
  call void %i.lr(ptr noundef nonnull align 8 dereferenceable(16) %i.lj) #14, !inline_history !90
  %i.ls = load ptr, ptr %i.lj, align 8, !tbaa !22
  %i.lt = getelementptr inbounds nuw i8, ptr %i.ls, i64 24
  %i.lu = load ptr, ptr %i.lt, align 8
  call void %i.lu(ptr noundef nonnull align 8 dereferenceable(16) %i.lj) #14, !inline_history !90
  br label %_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE10_M_releaseEv.exit.i.i.i.i

bb.bz:                                            ; preds = %bb.bx
  %i.lv = load i8, ptr @__libc_single_threaded, align 1, !tbaa !19
  %.not.i9.i.i.i.i = icmp eq i8 %i.lv, 0
  br i1 %.not.i9.i.i.i.i, label %bb.cb, label %bb.ca

bb.ca:                                            ; preds = %bb.bz
  %i.lw = add nsw i32 %i.ln, -1
  store i32 %i.lw, ptr %i.lk, align 8, !tbaa !20
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i: ; preds = %bb.cb, %bb.ca
  ...
  br i1 %i.ly, label %bb.cc, label %_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE10_M_releaseEv.exit.i.i.i.i, !prof !26
...
_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE10_M_releaseEv.exit.i.i.i.i: ; preds = %bb.cc, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i, %bb.by, %_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE15_M_add_ref_copyEv.exit.i.i.i.i
  store ptr %i.lc, ptr %i.lb, align 8, !tbaa !18
  %.pr.i = load ptr, ptr %i.ki, align 8, !tbaa !18
...
bb.ce:                                            ; preds = %bb.cd
  store i32 0, ptr %i.ma, align 8, !tbaa !24
  %i.me = getelementptr inbounds nuw i8, ptr %i.lz, i64 12
  store i32 0, ptr %i.me, align 4, !tbaa !25
  %i.mf = load ptr, ptr %i.lz, align 8, !tbaa !22
  %i.mg = getelementptr inbounds nuw i8, ptr %i.mf, i64 16
  %i.mh = load ptr, ptr %i.mg, align 8
  call void %i.mh(ptr noundef nonnull align 8 dereferenceable(16) %i.lz) #14, !inline_history !91
  %i.mi = load ptr, ptr %i.lz, align 8, !tbaa !22
  %i.mj = getelementptr inbounds nuw i8, ptr %i.mi, i64 24
  %i.mk = load ptr, ptr %i.mj, align 8
  call void %i.mk(ptr noundef nonnull align 8 dereferenceable(16) %i.lz) #14, !inline_history !91
  br label %_ZNSt12__shared_ptrIN16OpenColorIO_v2_52OpELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i

bb.cf:                                            ; preds = %bb.cd
  %i.ml = load i8, ptr @__libc_single_threaded, align 1, !tbaa !19
  %.not.i.i.i11.i162 = icmp eq i8 %i.ml, 0
  br i1 %.not.i.i.i11.i162, label %bb.ch, label %bb.cg

bb.cg:                                            ; preds = %bb.cf
  %i.mm = add nsw i32 %i.md, -1
  store i32 %i.mm, ptr %i.ma, align 8, !tbaa !20
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i163: ; preds = %bb.ch, %bb.cg
  ...
  br i1 %i.mo, label %bb.ci, label %_ZNSt12__shared_ptrIN16OpenColorIO_v2_52OpELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i, !prof !26
...
bb.ck:                                            ; preds = %_ZNSt12__shared_ptrIN16OpenColorIO_v2_52OpELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i, %bb.bq
  ...
  br i1 %exitcond.not.i, label %_ZN16OpenColorIO_v2_512_GLOBAL__N_123RemoveDynamicPropertiesERNS_10OpRcPtrVecE.exit, label %bb.bq, !llvm.loop !92
...
bb.cm:                                            ; preds = %bb.cl
  %i.ol = load ptr, ptr %0, align 8, !tbaa !12    ; 2 uses
  %i.om = load ptr, ptr %i.b, align 8, !tbaa !12
...
.lr.ph.i165:                                      ; preds = %bb.cm, %bb.cp
  ...
  %i.on = load ptr, ptr %.sroa.07.011.i, align 8, !tbaa !17 ; 2 uses
  %i.oo = load ptr, ptr %i.on, align 8, !tbaa !22
  %i.op = getelementptr inbounds nuw i8, ptr %i.oo, i64 40
  %i.oq = load ptr, ptr %i.op, align 8
  %i.or = call noundef zeroext i1 %i.oq(ptr noundef nonnull align 8 dereferenceable(24) %i.on), !inline_history !93
...
bb.cp:                                            ; preds = %bb.co, %bb.cn
  ...
  %i.ov = load ptr, ptr %i.b, align 8, !tbaa !12
  %.not.i168 = icmp eq ptr %.sroa.07.1.i, %i.ov
  br i1 %.not.i168, label %_ZN16OpenColorIO_v2_512_GLOBAL__N_111RemoveNoOpsERNS_10OpRcPtrVecE.exit, label %.lr.ph.i165, !llvm.loop !94
...
_ZN16OpenColorIO_v2_512_GLOBAL__N_111RemoveNoOpsERNS_10OpRcPtrVecE.exit: ; preds = %bb.cp, %bb.cm, %bb.cl
  ...
  br i1 %.not457, label %bb.dq, label %bb.cq
...
bb.cq:                                            ; preds = %_ZN16OpenColorIO_v2_512_GLOBAL__N_111RemoveNoOpsERNS_10OpRcPtrVecE.exit
  ...
  %i.ox = load ptr, ptr %i.b, align 8, !tbaa !32
  %i.oy = load ptr, ptr %0, align 8, !tbaa !33    ; 2 uses
...
.lr.ph.i171:                                      ; preds = %bb.cq, %_ZNSt12__shared_ptrIKN16OpenColorIO_v2_52OpELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i182
  ...
  %i.pg = load ptr, ptr %29, align 8, !tbaa !33   ; 3 uses
  %i.ph = load ptr, ptr %i.mt, align 8, !tbaa !32 ; 2 uses
...
.lr.ph.i.i.i.i.i.i:                               ; preds = %.lr.ph.i171, %_ZSt8_DestroyISt10shared_ptrIN16OpenColorIO_v2_52OpEEEvPT_.exit.i.i.i.i.i.i
  ...
  %i.pj = load ptr, ptr %i.pi, align 8, !tbaa !18 ; 8 uses
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i.i.i.i.i: ; preds = %bb.cv, %bb.cu
  ...
  br i1 %i.py, label %bb.cw, label %_ZSt8_DestroyISt10shared_ptrIN16OpenColorIO_v2_52OpEEEvPT_.exit.i.i.i.i.i.i, !prof !26
...
_ZSt8_DestroyIPSt10shared_ptrIN16OpenColorIO_v2_52OpEES3_EvT_S5_RSaIT0_E.exit.i.i.i.i: ; preds = %_ZSt8_DestroyISt10shared_ptrIN16OpenColorIO_v2_52OpEEEvPT_.exit.i.i.i.i.i.i
  store ptr %i.pg, ptr %i.mt, align 8, !tbaa !32
...
_ZN16OpenColorIO_v2_510OpRcPtrVec5clearEv.exit.i: ; preds = %_ZSt8_DestroyIPSt10shared_ptrIN16OpenColorIO_v2_52OpEES3_EvT_S5_RSaIT0_E.exit.i.i.i.i, %.lr.ph.i171
  ...
  %i.qc = load ptr, ptr %i.qb, align 8, !tbaa !17 ; 3 uses
  store ptr %i.qc, ptr %30, align 8, !tbaa !35
  %i.qd = getelementptr inbounds nuw i8, ptr %i.qb, i64 8
  %i.qe = load ptr, ptr %i.qd, align 8, !tbaa !18 ; 3 uses
  store ptr %i.qe, ptr %i.mu, align 8, !tbaa !18
...
bb.cx:                                            ; preds = %_ZN16OpenColorIO_v2_510OpRcPtrVec5clearEv.exit.i
  ...
  %i.qg = load i8, ptr @__libc_single_threaded, align 1, !tbaa !19
  %.not.i.i.i.i.i175 = icmp eq i8 %i.qg, 0
  br i1 %.not.i.i.i.i.i175, label %bb.cz, label %bb.cy

bb.cy:                                            ; preds = %bb.cx
  %i.qh = load i32, ptr %i.qf, align 4, !tbaa !20
  %i.qi = add nsw i32 %i.qh, 1
  store i32 %i.qi, ptr %i.qf, align 4, !tbaa !20
...
bb.da:                                            ; preds = %_ZNSt10shared_ptrIKN16OpenColorIO_v2_52OpEEC2IS1_vEERKS_IT_E.exit.i176
  %i.ql = load ptr, ptr %29, align 8, !tbaa !12   ; 2 uses
  %i.qm = load ptr, ptr %i.mt, align 8, !tbaa !12 ; 2 uses
...
bb.dc:                                            ; preds = %bb.db
  %i.qo = load ptr, ptr %0, align 8, !tbaa !12
...
bb.dd:                                            ; preds = %bb.dc
  %i.qs = load ptr, ptr %0, align 8, !tbaa !12
  %i.qt = getelementptr inbounds nuw [16 x i8], ptr %i.qs, i64 %indvars.iv.i
  %i.qu = load ptr, ptr %29, align 8, !tbaa !12
  %i.qv = load ptr, ptr %i.mt, align 8, !tbaa !12
...
begin_hunk_1_@_ZN16OpenColorIO_v2_510OpRcPtrVec8optimizeENS_17OptimizationFlagsE:bb.a
  ...
  call void %i.ri(ptr noundef nonnull align 8 dereferenceable(16) %i.ra) #14, !inline_history !96
  %i.rj = load ptr, ptr %i.ra, align 8, !tbaa !22
  %i.rk = getelementptr inbounds nuw i8, ptr %i.rj, i64 24
  %i.rl = load ptr, ptr %i.rk, align 8
  call void %i.rl(ptr noundef nonnull align 8 dereferenceable(16) %i.ra) #14, !inline_history !96
  br label %_ZNSt12__shared_ptrIKN16OpenColorIO_v2_52OpELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i182

bb.dl:                                            ; preds = %bb.dj
  %i.rm = load i8, ptr @__libc_single_threaded, align 1, !tbaa !19
  %.not.i.i.i22.i = icmp eq i8 %i.rm, 0
  br i1 %.not.i.i.i22.i, label %bb.dn, label %bb.dm

bb.dm:                                            ; preds = %bb.dl
  %i.rn = add nsw i32 %i.re, -1
  store i32 %i.rn, ptr %i.rb, align 8, !tbaa !20
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i180: ; preds = %bb.dn, %bb.dm
  ...
  br i1 %i.rp, label %bb.do, label %_ZNSt12__shared_ptrIKN16OpenColorIO_v2_52OpELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i182, !prof !26
...
_ZNSt12__shared_ptrIKN16OpenColorIO_v2_52OpELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i182: ; preds = %bb.do, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i180, %bb.dk, %bb.di
  ...
  %i.rq = load ptr, ptr %i.b, align 8, !tbaa !32
  %i.rr = load ptr, ptr %0, align 8, !tbaa !33    ; 2 uses
  ...
  br i1 %i.rw, label %.lr.ph.i171, label %_ZN16OpenColorIO_v2_512_GLOBAL__N_110ReplaceOpsERNS_10OpRcPtrVecE.exit, !llvm.loop !97
...
.lr.ph.i183:                                      ; preds = %bb.dq
  %i.ry = ptrtoint ptr %.pre893 to i64
  %i.rz = ptrtoint ptr %.pre895 to i64
...
bb.dr:                                            ; preds = %_ZNSt12__shared_ptrIKN16OpenColorIO_v2_52OpELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i195, %.lr.ph.i183
  ...
  %i.sc = load ptr, ptr %0, align 8, !tbaa !33
  %i.sd = getelementptr inbounds nuw [16 x i8], ptr %i.sc, i64 %.02750.i ; 2 uses
  %i.se = load ptr, ptr %i.sd, align 8, !tbaa !17 ; 3 uses
  store ptr %i.se, ptr %26, align 8, !tbaa !35
  %i.sf = getelementptr inbounds nuw i8, ptr %i.sd, i64 8
  %i.sg = load ptr, ptr %i.sf, align 8, !tbaa !18 ; 3 uses
  store ptr %i.sg, ptr %i.my, align 8, !tbaa !18
...
bb.ds:                                            ; preds = %bb.dr
  ...
  %i.si = load i8, ptr @__libc_single_threaded, align 1, !tbaa !19
  %.not.i.i.i.i.i185 = icmp eq i8 %i.si, 0
  br i1 %.not.i.i.i.i.i185, label %bb.du, label %bb.dt

bb.dt:                                            ; preds = %bb.ds
  %i.sj = load i32, ptr %i.sh, align 4, !tbaa !20
  %i.sk = add nsw i32 %i.sj, 1
  store i32 %i.sk, ptr %i.sh, align 4, !tbaa !20
...
_ZNSt10shared_ptrIKN16OpenColorIO_v2_52OpEEC2IS1_vEERKS_IT_E.exit.i186: ; preds = %bb.du, %bb.dt, %bb.dr
  ...
  %i.so = load ptr, ptr %i.sn, align 8, !tbaa !38, !noalias !210 ; 3 uses
  store ptr %i.so, ptr %27, align 8, !tbaa !40, !alias.scope !210
  %i.sp = getelementptr inbounds nuw i8, ptr %i.sm, i64 16
  %i.sq = load ptr, ptr %i.sp, align 8, !tbaa !18, !noalias !210 ; 3 uses
  store ptr %i.sq, ptr %i.mz, align 8, !tbaa !18, !alias.scope !210
...
bb.dv:                                            ; preds = %_ZNSt10shared_ptrIKN16OpenColorIO_v2_52OpEEC2IS1_vEERKS_IT_E.exit.i186
  ...
  %i.ss = load i8, ptr @__libc_single_threaded, align 1, !tbaa !19, !noalias !210
  %.not.i.i.i.i.i.i.i188 = icmp eq i8 %i.ss, 0
  br i1 %.not.i.i.i.i.i.i.i188, label %bb.dx, label %bb.dw

bb.dw:                                            ; preds = %bb.dv
  %i.st = load i32, ptr %i.sr, align 4, !tbaa !20, !noalias !210
  %i.su = add nsw i32 %i.st, 1
  store i32 %i.su, ptr %i.sr, align 4, !tbaa !20, !noalias !210
  br label %_ZNK16OpenColorIO_v2_52Op4dataEv.exit.i189

bb.dx:                                            ; preds = %bb.dv
  %i.sv = atomicrmw volatile add ptr %i.sr, i32 1 acq_rel, align 4, !noalias !210 ; 0 uses
...
_ZNK16OpenColorIO_v2_52Op4dataEv.exit.i189:       ; preds = %bb.dx, %bb.dw, %_ZNSt10shared_ptrIKN16OpenColorIO_v2_52OpEEC2IS1_vEERKS_IT_E.exit.i186
  ...
  %i.sx = load ptr, ptr %i.sw, align 8, !tbaa !22
...
bb.dy:                                            ; preds = %_ZNK16OpenColorIO_v2_52Op4dataEv.exit.i189
  %i.tb = load ptr, ptr %i.mz, align 8, !tbaa !18 ; 8 uses
...
bb.ea:                                            ; preds = %bb.dz
  store i32 0, ptr %i.tc, align 8, !tbaa !24
  %i.tg = getelementptr inbounds nuw i8, ptr %i.tb, i64 12
  store i32 0, ptr %i.tg, align 4, !tbaa !25
  %i.th = load ptr, ptr %i.tb, align 8, !tbaa !22
  %i.ti = getelementptr inbounds nuw i8, ptr %i.th, i64 16
  %i.tj = load ptr, ptr %i.ti, align 8
  call void %i.tj(ptr noundef nonnull align 8 dereferenceable(16) %i.tb) #14, !inline_history !102
  %i.tk = load ptr, ptr %i.tb, align 8, !tbaa !22
  %i.tl = getelementptr inbounds nuw i8, ptr %i.tk, i64 24
  %i.tm = load ptr, ptr %i.tl, align 8
  call void %i.tm(ptr noundef nonnull align 8 dereferenceable(16) %i.tb) #14, !inline_history !102
  br label %_ZNSt12__shared_ptrIKN16OpenColorIO_v2_56OpDataELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i193

bb.eb:                                            ; preds = %bb.dz
  %i.tn = load i8, ptr @__libc_single_threaded, align 1, !tbaa !19
  %.not.i.i.i34.i = icmp eq i8 %i.tn, 0
  br i1 %.not.i.i.i34.i, label %bb.ed, label %bb.ec

bb.ec:                                            ; preds = %bb.eb
  %i.to = add nsw i32 %i.tf, -1
  store i32 %i.to, ptr %i.tc, align 8, !tbaa !20
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i191: ; preds = %bb.ed, %bb.ec
  ...
  br i1 %i.tq, label %bb.ee, label %_ZNSt12__shared_ptrIKN16OpenColorIO_v2_56OpDataELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i193, !prof !26
...
bb.ek:                                            ; preds = %bb.ej
  ...
  %i.ug = load ptr, ptr %i.na, align 8, !tbaa !18 ; 5 uses
...
_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE10_M_releaseEv.exit.i.i.i.i204: ; preds = %bb.eu, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i202, %bb.eq, %_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE15_M_add_ref_copyEv.exit.i.i.i.i199
  ...
  %.pr.i205 = load ptr, ptr %i.na, align 8, !tbaa !18
...
bb.fg:                                            ; preds = %_ZNSt12__shared_ptrIN16OpenColorIO_v2_52OpELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i207, %bb.eh, %bb.ef, %_ZNSt12__shared_ptrIKN16OpenColorIO_v2_56OpDataELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i193
  ...
  %i.vy = load ptr, ptr %i.my, align 8, !tbaa !18 ; 8 uses
