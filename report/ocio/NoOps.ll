...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ao = load float, ptr %i.am, align 4, !tbaa !40, !alias.scope !98
  %i.ap = load float, ptr %i.an, align 4, !tbaa !40, !alias.scope !98
  ...
  %i.bb = load float, ptr %i.az, align 4, !tbaa !40, !alias.scope !98
  %i.bc = load float, ptr %i.ba, align 4, !tbaa !40, !alias.scope !98
  ...
  %i.bl = load float, ptr %i.bj, align 4, !tbaa !40, !alias.scope !98
  %i.bm = load float, ptr %i.bk, align 4, !tbaa !40, !alias.scope !98
  ...
  store <6 x float> %interleaved.vec, ptr %i.au, align 4, !tbaa !40, !alias.scope !99, !noalias !98
  %index.next = add nuw i64 %index, 2             ; 2 uses
  %i.bq = icmp eq i64 %index.next, %n.vec
  br i1 %i.bq, label %scalar.ph.preheader, label %vector.body, !llvm.loop !89
...
bb.g:                                             ; preds = %.lr.ph, %bb.h
  ...
  %i.bt = load ptr, ptr %.sroa.033.049, align 8, !tbaa !48 ; 2 uses
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  store float %i.ce, ptr %i.ch, align 4, !tbaa !40
  ...
  store float %i.cl, ptr %i.co, align 4, !tbaa !40
  ...
  store float %i.cs, ptr %i.cv, align 4, !tbaa !40
...
_ZNSt6vectorIfSaIfEED2Ev.exit:                    ; preds = %bb.k
  ...
  %i.cx = load ptr, ptr %i.m, align 8, !tbaa !18  ; 8 uses
...
bb.n:                                             ; preds = %bb.m
  ...
  store i32 0, ptr %i.dc, align 4, !tbaa !21
  %i.dd = load ptr, ptr %i.cx, align 8, !tbaa !23
  %i.de = getelementptr inbounds nuw i8, ptr %i.dd, i64 16
  %i.df = load ptr, ptr %i.de, align 8
  call void %i.df(ptr noundef nonnull align 8 dereferenceable(16) %i.cx) #23, !inline_history !91
  %i.dg = load ptr, ptr %i.cx, align 8, !tbaa !23
  %i.dh = getelementptr inbounds nuw i8, ptr %i.dg, i64 24
  %i.di = load ptr, ptr %i.dh, align 8
  call void %i.di(ptr noundef nonnull align 8 dereferenceable(16) %i.cx) #23, !inline_history !91
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i: ; preds = %bb.q, %bb.p
  ...
  br i1 %i.dm, label %bb.r, label %_ZNSt12__shared_ptrIN16OpenColorIO_v2_511Lut3DOpDataELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit, !prof !26
