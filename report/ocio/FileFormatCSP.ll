...
bb.li:                                            ; preds = %bb.lg
  ...
  %i.aot = load ptr, ptr %i.aos, align 8, !tbaa !137 ; 11 uses
...
bb.lk:                                            ; preds = %bb.ln, %.peel.next.i
  ...
  %60 = load float, ptr %i.aqz, align 4, !tbaa !61 ; 7 uses
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 5 uses
  %61 = getelementptr inbounds nuw [4 x i8], ptr %i.aot, i64 %indvars.iv.next.i
  %62 = load float, ptr %61, align 4, !tbaa !61   ; 5 uses
...
bb.ll:                                            ; preds = %bb.lk
  ...
  %i.arn = fsub float %62, %i.arm
  %i.aro = fadd float %i.arl, 1.000000e+00
  %i.arp = fdiv float %i.arn, %i.aro              ; 3 uses
  %i.arq = fmul float %62, 0.000000e+00           ; 2 uses
  %63 = fadd float %60, %i.arq
  %64 = insertelement <2 x float> poison, float %60, i64 0
  %65 = insertelement <2 x float> %64, float %i.arp, i64 1
  %66 = insertelement <2 x float> poison, float %i.arq, i64 0
  %67 = insertelement <2 x float> %66, float %63, i64 1
  %68 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %65, <2 x float> zeroinitializer, <2 x float> %67) ; 2 uses
  %69 = extractelement <2 x float> %68, i64 0
  %i.arr = fadd float %69, %i.arp
  %i.ars = fsub float %62, %60
  %i.art = fsub float %i.ars, %i.arp
  %70 = shufflevector <2 x float> %68, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %i.aru = insertelement <2 x float> %70, float %i.arr, i64 1
...
bb.lm:                                            ; preds = %bb.lk
  ...
  %i.arx = load float, ptr %i.arw, align 4, !tbaa !61 ; 2 uses
  %71 = fsub float %i.arg, %i.arx                 ; 2 uses
  %i.ary = add nsw i64 %indvars.iv.i, -1          ; 2 uses
  %i.arz = getelementptr inbounds nuw [4 x i8], ptr %i.aot, i64 %i.ary
  %i.asa = load float, ptr %i.arz, align 4, !tbaa !61
  %i.asb = getelementptr inbounds nuw [4 x i8], ptr %i.aol, i64 %i.ary
  %i.asc = load float, ptr %i.asb, align 4, !tbaa !61
  %72 = fsub float %i.arx, %i.asc
  %73 = fdiv float %72, %71
  %74 = add nuw i64 %indvars.iv.i, 2
  %75 = and i64 %74, 4294967295                   ; 2 uses
  %76 = getelementptr inbounds nuw [4 x i8], ptr %i.aot, i64 %75
  %77 = load float, ptr %76, align 4, !tbaa !61
  %78 = getelementptr inbounds nuw [4 x i8], ptr %i.aol, i64 %75
  %79 = load float, ptr %78, align 4, !tbaa !61
  %80 = fsub float %79, %i.arg
  %81 = fdiv float %80, %71
  %i.asd = fsub float %62, %i.asa
  %82 = fadd float %73, 1.000000e+00
  %i.ase = fsub float %77, %60
  %83 = fadd float %81, 1.000000e+00
  %84 = fdiv float %i.ase, %83
  %i.asf = insertelement <2 x float> poison, float %62, i64 0
  %85 = shufflevector <2 x float> %i.asf, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %86 = insertelement <2 x float> poison, float %84, i64 0
  %i.asg = shufflevector <2 x float> %86, <2 x float> poison, <2 x i32> zeroinitializer ; 3 uses
  %87 = fdiv float %i.asd, %82                    ; 3 uses
  %i.ash = fmul float %87, 0.000000e+00
  %i.asi = fadd float %60, %i.ash
  %i.asj = call float @llvm.fmuladd.f32(float %60, float 0.000000e+00, float %87)
  %i.ask = insertelement <2 x float> poison, float %i.asi, i64 0
  %i.asl = insertelement <2 x float> %i.ask, float %i.asj, i64 1
  %i.asm = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %85, <2 x float> zeroinitializer, <2 x float> %i.asl)
  ...
  %i.aso = fmul <2 x float> %89, <float -2.000000e+00, float 1.000000e+00>
  %90 = insertelement <2 x float> poison, float %60, i64 0
  %91 = shufflevector <2 x float> %90, <2 x float> poison, <2 x i32> zeroinitializer
  %92 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %91, <2 x float> <float -3.000000e+00, float 2.000000e+00>, <2 x float> %i.aso)
  %i.asp = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %85, <2 x float> <float 3.000000e+00, float -2.000000e+00>, <2 x float> %92) ; 2 uses
