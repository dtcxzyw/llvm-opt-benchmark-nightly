...
bb.li:                                            ; preds = %bb.lg
  ...
  %i.aot = load ptr, ptr %i.aos, align 8, !tbaa !158 ; 11 uses
...
bb.lk:                                            ; preds = %bb.ln, %.peel.next.i
  ...
  %60 = getelementptr inbounds nuw [4 x i8], ptr %i.aot, i64 %indvars.iv.next.i
  %61 = load float, ptr %i.aqz, align 4, !tbaa !47 ; 7 uses
  %62 = load float, ptr %60, align 4, !tbaa !47   ; 5 uses
...
bb.lm:                                            ; preds = %bb.lk
  ...
  %i.asr = fsub float %62, %i.arz
  %i.ass = fsub float %i.ase, %61
  ...
  %72 = shufflevector <2 x float> %71, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  ...
  %i.ata = fadd float %61, %i.asz
  %i.atb = call float @llvm.fmuladd.f32(float %61, float 0.000000e+00, float %i.asy)
  %i.atc = insertelement <2 x float> poison, float %i.ata, i64 0
  %i.atd = insertelement <2 x float> %i.atc, float %i.atb, i64 1
  %i.ate = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %72, <2 x float> zeroinitializer, <2 x float> %i.atd)
  ...
  %75 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %74, <2 x float> <float -3.000000e+00, float 2.000000e+00>, <2 x float> %i.ath)
  %i.ati = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %72, <2 x float> <float 3.000000e+00, float -2.000000e+00>, <2 x float> %75) ; 2 uses
