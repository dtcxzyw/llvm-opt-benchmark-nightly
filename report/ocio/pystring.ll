...
.preheader.i:                                     ; preds = %.critedge4.i, %.preheader.lr.ph.i
  %.04184.i = phi i32 [ %spec.store.select, %.preheader.lr.ph.i ], [ %.1.i, %.critedge4.i ] ; 4 uses
  %.04483.i = phi i64 [ 0, %.preheader.lr.ph.i ], [ %.4.i, %.critedge4.i ]
  %i.w = load ptr, ptr %0, align 8, !tbaa !13     ; 3 uses
  br label %bb.c

bb.c:                                             ; preds = %bb.d, %.preheader.i
  %.14574.i = phi i64 [ %.04483.i, %.preheader.i ], [ %i.ab, %bb.d ] ; 13 uses
  %i.x = getelementptr inbounds nuw i8, ptr %i.w, i64 %.14574.i
...
bb.d:                                             ; preds = %bb.c
  %i.ab = add nuw i64 %.14574.i, 1                ; 2 uses
...
.critedge.i:                                      ; preds = %bb.c
  %i.ad = getelementptr inbounds nuw i8, ptr %i.w, i64 %.14574.i ; 2 uses
  %i.ae = icmp ult i64 %.14574.i, %i.s
  br i1 %i.ae, label %.lr.ph.i, label %.critedge4.i

.lr.ph.i:                                         ; preds = %.critedge.i, %bb.e
  %.24675.i = phi i64 [ %i.aj, %bb.e ], [ %.14574.i, %.critedge.i ] ; 3 uses
  %i.af = getelementptr inbounds nuw i8, ptr %i.w, i64 %.24675.i
...
.critedge2.i:                                     ; preds = %bb.e, %.lr.ph.i
  %.246.lcssa.i = phi i64 [ %.24675.i, %.lr.ph.i ], [ %i.s, %bb.e ] ; 7 uses
  %i.ak = icmp ult i64 %.14574.i, %.246.lcssa.i
  br i1 %i.ak, label %bb.f, label %.critedge4.i

bb.f:                                             ; preds = %.critedge2.i
  %i.al = add nsw i32 %.04184.i, -1               ; 2 uses
  %i.am = icmp slt i32 %.04184.i, 1
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.ao = icmp ugt i64 %.14574.i, %i.an
  br i1 %i.ao, label %bb.h, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8_M_checkEmPKc.exit.i.i.i

bb.h:                                             ; preds = %bb.g
  call void (ptr, ...) @_ZSt24__throw_out_of_range_fmtPKcz(ptr noundef nonnull @.str.16, ptr noundef nonnull @.str.18, i64 noundef %.14574.i, i64 noundef %i.an) #25, !noalias !24
  unreachable
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8_M_checkEmPKc.exit.i.i.i: ; preds = %bb.g
  ...
  %9 = call i64 @llvm.umin.i64(i64 %.246.lcssa.i, i64 %i.an)
  %spec.select.i.i.i.i = sub nuw i64 %9, %.14574.i ; 4 uses
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.i: ; preds = %_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE9push_backEOS5_.exit.thread.i, %_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE9push_backEOS5_.exit.i, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i
  ...
  %i.bn = icmp ult i64 %.246.lcssa.i, %i.s
...
bb.n:                                             ; preds = %bb.o, %.lr.ph79.i
  %.378.i = phi i64 [ %.246.lcssa.i, %.lr.ph79.i ], [ %i.bt, %bb.o ] ; 4 uses
...
.critedge4.i:                                     ; preds = %bb.n, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.i, %.critedge2.i, %.critedge.i
  %.4.i = phi i64 [ %.246.lcssa.i, %.critedge2.i ], [ %.246.lcssa.i, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.i ], [ %.14574.i, %.critedge.i ], [ %.378.i, %bb.n ] ; 2 uses
  %.143.i = phi i64 [ %.14574.i, %.critedge2.i ], [ %.246.lcssa.i, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.i ], [ %.14574.i, %.critedge.i ], [ %.378.i, %bb.n ]
  %.1.i = phi i32 [ %.04184.i, %.critedge2.i ], [ %i.al, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.i ], [ %.04184.i, %.critedge.i ], [ %i.al, %bb.n ]
...
._crit_edge.i:                                    ; preds = %.critedge4.i, %bb.f, %bb.b
  %.2.i = phi i64 [ 0, %bb.b ], [ %.143.i, %.critedge4.i ], [ %.14574.i, %bb.f ] ; 5 uses
...
bb.y:                                             ; preds = %.lr.ph, %.critedge.thread
  %.043115 = phi i32 [ %3, %.lr.ph ], [ %.1, %.critedge.thread ] ; 4 uses
  %.044114 = phi i32 [ %i.ea, %.lr.ph ], [ %.145, %.critedge.thread ] ; 4 uses
  %.046113 = phi i32 [ %i.ea, %.lr.ph ], [ %.147, %.critedge.thread ] ; 4 uses
...
bb.ag:                                            ; preds = %.critedge
  %i.fr = add nsw i32 %.043115, -1
  %i.fs = icmp slt i32 %.043115, 1
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8_M_checkEmPKc.exit.i.i54: ; preds = %bb.ah
  %i.fv = sub nsw i32 %.046113, %.044114
...
bb.d:                                             ; preds = %bb.c, %bb.b, %bb.a
  %.020.i = phi i32 [ %3, %bb.b ], [ %spec.store.select.i, %bb.c ], [ %i.c, %bb.a ]
  %i.g = icmp slt i32 %2, 0
  %i.h = add nsw i32 %2, %i.c
  %spec.store.select1.i = tail call i32 @llvm.smax.i32(i32 %i.h, i32 0)
  %.021.i = select i1 %i.g, i32 %spec.store.select1.i, i32 %2
  %i.i = zext nneg i32 %.021.i to i64
...
_ZN8pystring4findERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES7_ii.exit: ; preds = %bb.d, %bb.e
  %.0.i = phi i32 [ -1, %bb.d ], [ %spec.select.i, %bb.e ]
  ret i32 %.0.i
}
...
bb.d:                                             ; preds = %bb.c, %bb.b, %bb.a
  %.022.i = phi i32 [ %3, %bb.b ], [ %spec.store.select.i, %bb.c ], [ %i.c, %bb.a ]
  %i.g = icmp slt i32 %2, 0
  %i.h = add nsw i32 %2, %i.c
  %spec.store.select1.i = tail call i32 @llvm.smax.i32(i32 %i.h, i32 0)
  %.023.i = select i1 %i.g, i32 %spec.store.select1.i, i32 %2
  %i.i = sext i32 %.022.i to i64                  ; 2 uses
  %i.j = load ptr, ptr %1, align 8, !tbaa !13
  %i.k = getelementptr inbounds nuw i8, ptr %1, i64 8 ; 2 uses
  %i.l = load i64, ptr %i.k, align 8, !tbaa !21
  ...
  %i.n = icmp eq i64 %i.m, -1
  %i.o = zext nneg i32 %.023.i to i64
...
bb.a:
  ...
  %.021.i.us26 = select i1 %i.f, i32 %spec.store.select1.i.us25, i32 %2
  %i.h = zext nneg i32 %.021.i.us26 to i64
...
.lr.ph28:                                         ; preds = %.split.us.preheader, %.split.us
  ...
  %.020.i.us = select i1 %i.n, i32 %i.m, i32 %spec.store.select.i.us
  %i.p = load i64, ptr %i.b, align 8, !tbaa !21   ; 3 uses
  %i.q = add i64 %i.p, %i.l
  %i.r = sext i32 %.020.i.us to i64
