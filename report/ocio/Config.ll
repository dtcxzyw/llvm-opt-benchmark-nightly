...
bb.f:                                             ; preds = %bb.e
  ...
  %6 = load float, ptr %i.w, align 4, !tbaa !648
  ...
  %7 = load <2 x float>, ptr %i.x, align 4, !tbaa !648
  %8 = load <2 x float>, ptr %i.aa, align 4, !tbaa !648
...
_ZNSt6vectorIfSaIfEED2Ev.exit62:                  ; preds = %_ZNSt12__shared_ptrIKN16OpenColorIO_v2_512CPUProcessorELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit, %bb.n, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i56, %bb.r
  ...
  %9 = shufflevector <2 x float> %7, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 2 uses
  %10 = insertelement <4 x float> %9, float %6, i64 0
  %11 = shufflevector <2 x float> %8, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.ci = shufflevector <4 x float> %10, <4 x float> %11, <4 x i32> <i32 0, i32 1, i32 4, i32 5>
  %i.cj = fmul <4 x float> %i.ci, splat (float 6.400000e+01) ; 3 uses
  %i.ck = insertelement <4 x float> %9, float %i.z, i64 1
