Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/ocio/original/ImageDesc?download=true
...
bb.f:                                             ; preds = %bb.a
  %i.ae = load ptr, ptr %0, align 8, !tbaa !13    ; 4 uses
...
bb.j:                                             ; preds = %bb.d, %bb.b, %bb.f, %bb.e, %bb.c
  ...
  store ptr %.sink, ptr %i.ar, align 8, !tbaa !63
  ret void
}

; Function Attrs: mustprogress uwtable
define linkonce_odr hidden noundef zeroext i1 @_ZNK16OpenColorIO_v2_515PackedImageDesc4Impl12isRGBAPackedEv(ptr noundef nonnull align 8 dereferenceable(98) %0) local_unnamed_addr #0 comdat align 2 personality ptr @__gxx_personality_v0 {
bb.a:
...
bb.i:                                             ; preds = %bb.b, %bb.b, %bb.b
  ...
  %i.r = load i32, ptr %i.d, align 4, !tbaa !54
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.w = load ptr, ptr %1, align 8, !tbaa !64
...
bb.p:                                             ; preds = %bb.o, %bb.n
  ...
  %i.z = load ptr, ptr %1, align 8, !tbaa !64     ; 2 uses
...
bb.q:                                             ; preds = %._crit_edge, %bb.h, %bb.g, %bb.f, %bb.e, %bb.d, %bb.c
  %i.ae = phi i64 [ %.pre, %._crit_edge ], [ 4, %bb.h ], [ 2, %bb.g ], [ 2, %bb.f ], [ 2, %bb.e ], [ 2, %bb.d ], [ 1, %bb.c ] ; 5 uses
  ...
  br i1 %.not19, label %bb.r, label %bb.u
...
bb.r:                                             ; preds = %bb.q
  ...
  br i1 %.not20, label %bb.s, label %bb.u

bb.s:                                             ; preds = %bb.r
  %i.aq = ptrtoint ptr %i.b to i64
  %i.ar = sub i64 %i.aq, %i.ao
  %.not21 = icmp ne i64 %i.ar, %i.ae
  %i.as = icmp eq i64 %i.ae, 0
  %or.cond = or i1 %i.as, %.not21
...
; Function Attrs: mustprogress uwtable
define linkonce_odr hidden void @_ZNK16OpenColorIO_v2_515PackedImageDesc4Impl8validateEv(ptr noundef nonnull align 8 dereferenceable(98) %0) local_unnamed_addr #0 comdat align 2 personality ptr @__gxx_personality_v0 {
bb.a:
...
bb.j:                                             ; preds = %bb.i
  %i.u = load i64, ptr %i.m, align 8, !tbaa !23   ; 2 uses
...
bb.z:                                             ; preds = %bb.v
  ...
  %i.ap = load i64, ptr %i.ao, align 8, !tbaa !56 ; 2 uses
...
bb.ad:                                            ; preds = %bb.z
  %i.at = load i64, ptr %i.e, align 8, !tbaa !52
...
bb.ah:                                            ; preds = %bb.ad
  %i.az = load i32, ptr %i.p, align 4, !tbaa !54
