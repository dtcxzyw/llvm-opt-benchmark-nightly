...
bb.a:
  %i.a = load ptr, ptr @imath_half_to_float_table, align 8, !tbaa !21
...
bb.a:
  ...
  %i.aa = load <2 x float>, ptr %i.z, align 4, !tbaa !10
  ...
  %i.ag = load <2 x float>, ptr %i.c, align 4, !tbaa !10 ; 2 uses
  %i.ah = load <2 x float>, ptr %i.h, align 4, !tbaa !10 ; 2 uses
  ...
  %i.al = fpext <2 x float> %i.ak to <2 x double> ; 9 uses
  ...
  %2 = fpext float %i.o to double                 ; 4 uses
  %i.ar = fpext float %i.s to double              ; 4 uses
  %3 = fneg double %2
  %i.as = shufflevector <2 x double> %i.ap, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %4 = fneg <2 x double> %i.ae
  %5 = shufflevector <2 x double> %4, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %i.at = insertelement <2 x double> %5, double %i.aq, i64 1
  %i.au = fmul <2 x double> %i.as, %i.at
  %i.av = shufflevector <2 x double> %i.al, <2 x double> %i.ap, <2 x i32> <i32 0, i32 2>
  %i.aw = insertelement <2 x double> poison, double %3, i64 0
  %6 = shufflevector <2 x double> %i.aw, <2 x double> poison, <2 x i32> zeroinitializer
  %7 = fmul <2 x double> %i.av, %6
  %i.ax = shufflevector <2 x double> %i.aj, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %8 = shufflevector <2 x double> %i.ae, <2 x double> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  %9 = insertelement <2 x double> %8, double %i.ar, i64 1
  %10 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ax, <2 x double> %9, <2 x double> %7) ; 6 uses
  %11 = shufflevector <2 x double> %i.al, <2 x double> %i.ae, <2 x i32> <i32 0, i32 2>
  %i.ay = insertelement <2 x double> poison, double %i.ar, i64 0 ; 2 uses
  %12 = shufflevector <2 x double> %i.ay, <2 x double> poison, <2 x i32> zeroinitializer
  %13 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %11, <2 x double> %12, <2 x double> %i.au) ; 5 uses
  %14 = extractelement <2 x double> %10, i64 0    ; 2 uses
  %15 = shufflevector <2 x double> %10, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
  %16 = shufflevector <2 x double> %i.ab, <2 x double> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %17 = insertelement <2 x double> %16, double %i.y, i64 0 ; 2 uses
  %i.az = insertelement <2 x double> poison, double %i.af, i64 0 ; 3 uses
  %18 = insertelement <2 x double> %i.az, double %i.v, i64 1
  %19 = shufflevector <2 x double> %13, <2 x double> %10, <2 x i32> <i32 0, i32 3>
  %20 = shufflevector <2 x double> %i.aj, <2 x double> %i.al, <2 x i32> <i32 0, i32 2>
  %21 = insertelement <2 x double> poison, double %i.aq, i64 0
  %i.ba = shufflevector <2 x double> %21, <2 x double> poison, <2 x i32> zeroinitializer
  %22 = fmul <2 x double> %20, %i.ba
  %23 = shufflevector <2 x double> %i.ae, <2 x double> poison, <2 x i32> zeroinitializer
  %24 = insertelement <2 x double> %i.ae, double %2, i64 0
  %25 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %23, <2 x double> %24, <2 x double> %22) ; 5 uses
  %26 = shufflevector <2 x double> %10, <2 x double> %25, <2 x i32> <i32 1, i32 3>
  %i.bb = fneg <2 x double> %26                   ; 2 uses
  %i.bc = fmul <2 x double> %i.ab, %i.bb
  %i.bd = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %17, <2 x double> %13, <2 x double> %i.bc) ; 2 uses
  %i.be = extractelement <2 x double> %i.bd, i64 0
  %i.bf = tail call double @llvm.fmuladd.f64(double %i.am, double %14, double %i.be) ; 2 uses
  %i.bg = shufflevector <2 x double> %13, <2 x double> %25, <2 x i32> <i32 1, i32 2>
  %i.bh = fneg <2 x double> %i.bg                 ; 2 uses
  %i.bi = fmul <2 x double> %17, %i.bh            ; 2 uses
  %i.bj = shufflevector <2 x double> %i.bd, <2 x double> %i.bi, <2 x i32> <i32 1, i32 2>
  %i.bk = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %18, <2 x double> %19, <2 x double> %i.bj) ; 3 uses
  %i.bl = insertelement <2 x double> %16, double %i.y, i64 1
  %i.bm = shufflevector <2 x double> %i.bk, <2 x double> %i.bi, <2 x i32> <i32 1, i32 3>
  %i.bn = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bl, <2 x double> %25, <2 x double> %i.bm) ; 3 uses
  %i.bo = extractelement <2 x double> %i.bn, i64 1
  %i.bp = tail call double @llvm.fmuladd.f64(double %i.af, double %14, double %i.bo) ; 2 uses
  %i.bq = extractelement <2 x double> %i.aj, i64 1 ; 2 uses
...
_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIfEEbT_.exit.thread: ; preds = %bb.a, %_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIfEEbT_.exit
  ...
  %i.dd = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.dc, <2 x double> %13, <2 x double> %i.db) ; 2 uses
  %i.de = extractelement <2 x double> %i.dd, i64 0
  %27 = extractelement <2 x double> %25, i64 1
  %28 = tail call double @llvm.fmuladd.f64(double %i.bx, double %27, double %i.de)
  %29 = extractelement <2 x double> %i.dd, i64 1
  %30 = extractelement <2 x double> %10, i64 1
  %31 = tail call double @llvm.fmuladd.f64(double %i.cu, double %30, double %29)
  %32 = getelementptr inbounds nuw i8, ptr %0, i64 48
  %i.df = fneg <2 x double> %i.ab
  %i.dg = shufflevector <2 x double> %i.az, <2 x double> %i.df, <2 x i32> <i32 0, i32 2> ; 2 uses
  ...
  %i.dl = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.dk, <2 x double> %i.ab, <2 x double> %i.dh) ; 4 uses
  ...
  %i.dt = insertelement <2 x double> %i.az, double %i.cq, i64 1
  ...
  %34 = shufflevector <2 x double> %10, <2 x double> %i.dw, <2 x i32> <i32 3, i32 1>
  %i.dx = shufflevector <2 x double> %i.dn, <2 x double> %i.dw, <2 x i32> <i32 0, i32 2>
  %i.dy = fneg <2 x double> %i.dx                 ; 2 uses
  %35 = insertelement <2 x double> %i.as, double %2, i64 0
  %36 = fmul <2 x double> %35, %i.dy
  %37 = insertelement <2 x double> %i.dy, double %33, i64 1
  %38 = fmul <2 x double> %i.dq, %37
  %i.dz = insertelement <2 x double> %i.ax, double %i.m, i64 0
  %39 = shufflevector <2 x double> %i.dw, <2 x double> %i.dn, <2 x i32> <i32 1, i32 2>
  %40 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.dz, <2 x double> %39, <2 x double> %36)
  %41 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ae, <2 x double> %i.do, <2 x double> %38)
  %42 = fneg <2 x double> %i.dw
  %43 = fmul <2 x double> %8, %42
  %i.ea = insertelement <2 x double> poison, double %2, i64 0
  %44 = shufflevector <2 x double> %i.ea, <2 x double> poison, <2 x i32> zeroinitializer
  %45 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %44, <2 x double> %i.dl, <2 x double> %43) ; 2 uses
  %i.eb = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.dr, <2 x double> %i.dl, <2 x double> %41)
  %i.ec = fneg <2 x double> %i.ae
  %i.ed = shufflevector <2 x double> %i.ay, <2 x double> %i.ec, <2 x i32> <i32 0, i32 2>
  %i.ee = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ed, <2 x double> %i.dw, <2 x double> %40)
  %i.ef = tail call double @llvm.fmuladd.f64(double %i.bq, double %i.cs, double %i.cr) ; 3 uses
  %i.eg = insertelement <2 x double> %15, double %i.ef, i64 0 ; 2 uses
  %i.eh = fneg <2 x double> %i.eg
  %i.ei = fmul <2 x double> %i.ap, %i.eh
  %i.ej = insertelement <2 x double> %i.bb, double %33, i64 0
  %i.ek = fmul <2 x double> %i.ej, %i.aj
  %i.el = insertelement <2 x double> %i.ae, double %i.b, i64 1
  %i.em = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.el, <2 x double> %i.eg, <2 x double> %i.ek)
  %i.en = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.al, <2 x double> %34, <2 x double> %i.ei)
  %46 = shufflevector <2 x double> %i.dw, <2 x double> %25, <2 x i32> <i32 0, i32 2>
  %47 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.al, <2 x double> %46, <2 x double> %i.em)
  %48 = extractelement <2 x double> %45, i64 0
  %49 = tail call double @llvm.fmuladd.f64(double %i.aq, double %i.ef, double %48)
  %i.eo = shufflevector <2 x double> %i.dl, <2 x double> %13, <2 x i32> <i32 1, i32 2>
  %i.ep = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ct, <2 x double> %i.eo, <2 x double> %i.en)
  %i.eq = extractelement <2 x double> %45, i64 1
  ...
  store <4 x float> %i.ew, ptr %0, align 4, !tbaa !10
  %i.ex = shufflevector <2 x double> %i.bk, <2 x double> %i.eb, <4 x i32> <i32 0, i32 3, i32 2, i32 poison>
  ...
  store <4 x float> %i.fa, ptr %i.cy, align 4, !tbaa !10
  %i.fb = shufflevector <2 x double> %i.bn, <2 x double> %i.ee, <4 x i32> <i32 0, i32 2, i32 3, i32 poison>
  %50 = insertelement <4 x double> %i.fb, double %31, i64 3
  %i.fc = fmul <4 x double> %i.cw, %50
  %i.fd = fptrunc <4 x double> %i.fc to <4 x float>
  store <4 x float> %i.fd, ptr %i.cz, align 4, !tbaa !10
  %i.fe = insertelement <4 x double> poison, double %i.bp, i64 0
  %51 = insertelement <4 x double> %i.fe, double %49, i64 1
  %52 = shufflevector <2 x double> %47, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %53 = shufflevector <4 x double> %51, <4 x double> %52, <4 x i32> <i32 0, i32 1, i32 4, i32 5>
  %i.ff = fmul <4 x double> %i.cw, %53
  %i.fg = fptrunc <4 x double> %i.ff to <4 x float>
  store <4 x float> %i.fg, ptr %32, align 4, !tbaa !10
  br label %bb.b
...
bb.a:
  ...
  store <4 x float> %i.p, ptr %0, align 4, !tbaa !10
  ...
  store <4 x float> %i.ac, ptr %i.q, align 4, !tbaa !10
  ...
  store <4 x float> %i.ap, ptr %i.ad, align 4, !tbaa !10
  ...
  store <4 x float> %i.bc, ptr %i.aq, align 4, !tbaa !10
  ret void
}
...
bb.a:
  ...
  store <4 x float> %i.u, ptr %0, align 4, !tbaa !10
  ...
  store <4 x float> %i.ac, ptr %i.e, align 4, !tbaa !10
  ...
  store <4 x float> %i.ak, ptr %i.f, align 4, !tbaa !10
  ...
  store <4 x float> %i.as, ptr %i.g, align 4, !tbaa !10
  ...
  store <4 x float> %i.bf, ptr %1, align 4, !tbaa !10
  ret void
}
