...
bb.a:
  ...
  %9 = load <4 x float>, ptr %3, align 4          ; 4 uses
  %10 = load <4 x float>, ptr %5, align 4
  %11 = load <16 x float>, ptr %4, align 4        ; 20 uses
  %12 = shufflevector <16 x float> %11, <16 x float> poison, <4 x i32> <i32 1, i32 5, i32 9, i32 13>
  %i.e = shufflevector <16 x float> %11, <16 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %i.f = fmul <4 x float> %i.b, %i.e
  %13 = shufflevector <16 x float> %11, <16 x float> poison, <4 x i32> <i32 0, i32 4, i32 8, i32 12>
  %14 = shufflevector <16 x float> %11, <16 x float> poison, <4 x i32> zeroinitializer
  %15 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %14, <4 x float> %i.a, <4 x float> %i.f)
  %16 = shufflevector <16 x float> %11, <16 x float> poison, <4 x i32> <i32 2, i32 6, i32 10, i32 14>
  %17 = shufflevector <16 x float> %11, <16 x float> poison, <4 x i32> <i32 2, i32 2, i32 2, i32 2>
  %i.g = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %17, <4 x float> %i.c, <4 x float> %15)
  %18 = shufflevector <16 x float> %11, <16 x float> poison, <4 x i32> <i32 3, i32 7, i32 11, i32 15>
  %19 = shufflevector <16 x float> %11, <16 x float> poison, <4 x i32> <i32 3, i32 3, i32 3, i32 3>
  %20 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %19, <4 x float> %i.d, <4 x float> %i.g)
  %21 = shufflevector <16 x float> %11, <16 x float> poison, <4 x i32> <i32 5, i32 5, i32 5, i32 5>
  %i.h = fmul <4 x float> %i.b, %21
  %22 = shufflevector <16 x float> %11, <16 x float> poison, <4 x i32> <i32 4, i32 4, i32 4, i32 4>
  %i.i = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %22, <4 x float> %i.a, <4 x float> %i.h)
  %23 = shufflevector <16 x float> %11, <16 x float> poison, <4 x i32> <i32 6, i32 6, i32 6, i32 6>
  %i.j = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %23, <4 x float> %i.c, <4 x float> %i.i)
  %24 = shufflevector <16 x float> %11, <16 x float> poison, <4 x i32> <i32 7, i32 7, i32 7, i32 7>
  %i.k = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %24, <4 x float> %i.d, <4 x float> %i.j)
  %25 = shufflevector <16 x float> %11, <16 x float> poison, <4 x i32> <i32 9, i32 9, i32 9, i32 9>
  %i.l = fmul <4 x float> %i.b, %25
  %26 = shufflevector <16 x float> %11, <16 x float> poison, <4 x i32> <i32 8, i32 8, i32 8, i32 8>
  %i.m = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %26, <4 x float> %i.a, <4 x float> %i.l)
  %27 = shufflevector <16 x float> %11, <16 x float> poison, <4 x i32> <i32 10, i32 10, i32 10, i32 10>
  %i.n = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %27, <4 x float> %i.c, <4 x float> %i.m)
  %28 = shufflevector <16 x float> %11, <16 x float> poison, <4 x i32> <i32 11, i32 11, i32 11, i32 11>
  %i.o = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %28, <4 x float> %i.d, <4 x float> %i.n)
  store <4 x float> %20, ptr %0, align 4, !tbaa !10
  store <4 x float> %i.k, ptr %6, align 4, !tbaa !10
  store <4 x float> %i.o, ptr %7, align 4, !tbaa !10
  %29 = shufflevector <16 x float> %11, <16 x float> poison, <4 x i32> <i32 13, i32 13, i32 13, i32 13>
  %30 = fmul <4 x float> %i.b, %29
  %31 = shufflevector <16 x float> %11, <16 x float> poison, <4 x i32> <i32 12, i32 12, i32 12, i32 12>
  %32 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %31, <4 x float> %i.a, <4 x float> %30)
  %33 = shufflevector <16 x float> %11, <16 x float> poison, <4 x i32> <i32 14, i32 14, i32 14, i32 14>
  %34 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %33, <4 x float> %i.c, <4 x float> %32)
  %35 = shufflevector <16 x float> %11, <16 x float> poison, <4 x i32> <i32 15, i32 15, i32 15, i32 15>
  %i.p = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %35, <4 x float> %i.d, <4 x float> %34)
  store <4 x float> %i.p, ptr %8, align 4, !tbaa !10
  %36 = shufflevector <4 x float> %9, <4 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %37 = fmul <4 x float> %36, %12
  %38 = shufflevector <4 x float> %9, <4 x float> poison, <4 x i32> zeroinitializer
  %i.q = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %13, <4 x float> %38, <4 x float> %37)
  %39 = shufflevector <4 x float> %9, <4 x float> poison, <4 x i32> <i32 2, i32 2, i32 2, i32 2>
  %40 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %16, <4 x float> %39, <4 x float> %i.q)
  %i.r = shufflevector <4 x float> %9, <4 x float> poison, <4 x i32> <i32 3, i32 3, i32 3, i32 3>
  %i.s = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %18, <4 x float> %i.r, <4 x float> %40)
  %i.t = fadd <4 x float> %i.s, %10
