...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %4 = load float, ptr %i.i, align 4, !tbaa !13, !alias.scope !87
  %broadcast.splatinsert41 = insertelement <4 x float> poison, float %4, i64 0
  %i.u = shufflevector <4 x float> %i.n, <4 x float> %i.p, <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 4, i32 4, i32 4, i32 4>
  %5 = shufflevector <4 x float> %i.o, <4 x float> %broadcast.splatinsert33, <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 4, i32 4, i32 4, i32 4>
  %6 = shufflevector <4 x float> %i.r, <4 x float> %i.t, <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 4, i32 4, i32 4, i32 4>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.bs = shufflevector <4 x float> %i.ah, <4 x float> %i.at, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.bt = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.bs, <8 x float> %i.u, <8 x float> %5)
  %7 = shufflevector <4 x float> %i.bf, <4 x float> %i.br, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.bu = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %7, <8 x float> %6, <8 x float> %i.v)
