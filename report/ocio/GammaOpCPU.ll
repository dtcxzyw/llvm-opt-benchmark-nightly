...
bb.a:
  ...
  %4 = shufflevector <4 x float> %i.z, <4 x float> %i.k, <4 x i32> <i32 2, i32 7, i32 poison, i32 poison>
  %i.ah = insertelement <4 x float> %4, float %i.ag, i64 2
  ...
  %5 = shufflevector <4 x float> %i.z, <4 x float> poison, <4 x i32> <i32 3, i32 poison, i32 poison, i32 poison>
  %i.ap = insertelement <4 x float> %5, float %i.ao, i64 1
