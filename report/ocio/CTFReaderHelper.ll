...
_ZN16OpenColorIO_v2_512_GLOBAL__N_114FindIndexDelimEPKcmm.exit.i: ; preds = %bb.f, %bb.f, %bb.f, %bb.f, %bb.f, %bb.f, %bb.f
  %10 = icmp eq i64 %.010.i.i, %2
  br i1 %10, label %_ZN16OpenColorIO_v2_512_GLOBAL__N_114FindIndexDelimEPKcmm.exit.thread.i, label %.preheader.preheader.i.i
...
.preheader.i.i:                                   ; preds = %.critedge.i.i, %.noexc20
  %.013.i.i = phi i64 [ %i.bj, %.critedge.i.i ], [ %.010.i.i, %.noexc20 ] ; 8 uses
  %.0.i60.i = phi ptr [ %i.bi, %.critedge.i.i ], [ %i.bg, %.noexc20 ] ; 2 uses
  %i.bh = load i8, ptr %.0.i60.i, align 1, !tbaa !62
  switch i8 %i.bh, label %_ZN16OpenColorIO_v2_512_GLOBAL__N_127FindNextTokenStart_IndexMapEPKcmm.exit.i [
...
bb.r:                                             ; preds = %bb.s, %bb.q
  %.012.i65.i = phi i64 [ %.013.i.i, %bb.q ], [ %i.bn, %bb.s ] ; 5 uses
