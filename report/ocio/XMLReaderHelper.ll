...
_ZNSt10shared_ptrIN16OpenColorIO_v2_59CDLOpDataEEC2ERKS2_.exit: ; preds = %bb.s, %bb.u, %bb.v
  ...
  %i.by = load ptr, ptr %i.bx, align 8, !tbaa !24 ; 3 uses
...
bb.w:                                             ; preds = %_ZNSt10shared_ptrIN16OpenColorIO_v2_59CDLOpDataEEC2ERKS2_.exit
  %i.cb = load ptr, ptr %6, align 16, !tbaa !80
  call void @llvm.lifetime.start.p0(ptr nonnull %7) #29
  %i.cc = getelementptr inbounds nuw i8, ptr %i.f, i64 16
  %i.cd = load double, ptr %i.cc, align 8, !tbaa !82
  %i.ce = load <2 x double>, ptr %i.f, align 8, !tbaa !82
  store <2 x double> %i.ce, ptr %7, align 16, !tbaa !82
  %i.cf = getelementptr inbounds nuw i8, ptr %7, i64 16
  store double %i.cd, ptr %i.cf, align 16, !tbaa !82
...
bb.x:                                             ; preds = %bb.w
  ...
  store i8 1, ptr %i.cg, align 8, !tbaa !124
  br label %bb.ai
...
bb.ab:                                            ; preds = %bb.aa
  %i.cl = load ptr, ptr %6, align 16, !tbaa !80
  call void @llvm.lifetime.start.p0(ptr nonnull %8) #29
  %i.cm = getelementptr inbounds nuw i8, ptr %i.f, i64 16
  %i.cn = load double, ptr %i.cm, align 8, !tbaa !82
  %i.co = load <2 x double>, ptr %i.f, align 8, !tbaa !82
  store <2 x double> %i.co, ptr %8, align 16, !tbaa !82
  %i.cp = getelementptr inbounds nuw i8, ptr %8, i64 16
  store double %i.cn, ptr %i.cp, align 16, !tbaa !82
...
bb.ac:                                            ; preds = %bb.ab
  ...
  store i8 1, ptr %i.cq, align 1, !tbaa !125
  br label %bb.ai
...
bb.af:                                            ; preds = %bb.ae
  %i.cu = load ptr, ptr %6, align 16, !tbaa !80
  call void @llvm.lifetime.start.p0(ptr nonnull %9) #29
  %i.cv = getelementptr inbounds nuw i8, ptr %i.f, i64 16
  %i.cw = load double, ptr %i.cv, align 8, !tbaa !82
  %i.cx = load <2 x double>, ptr %i.f, align 8, !tbaa !82
  store <2 x double> %i.cx, ptr %9, align 16, !tbaa !82
  %i.cy = getelementptr inbounds nuw i8, ptr %9, i64 16
  store double %i.cw, ptr %i.cy, align 16, !tbaa !82
...
bb.ag:                                            ; preds = %bb.af
  ...
  store i8 1, ptr %i.cz, align 2, !tbaa !126
  br label %bb.ai
...
bb.ai:                                            ; preds = %bb.ac, %bb.ag, %bb.ae, %bb.x
  %i.db = load ptr, ptr %i.bo, align 8, !tbaa !51 ; 8 uses
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i: ; preds = %bb.an, %bb.am
  ...
  br i1 %i.dq, label %bb.ao, label %_ZNSt12__shared_ptrIN16OpenColorIO_v2_59CDLOpDataELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit, !prof !53
...
bb.a:
  ...
  br i1 %.not.i.not, label %._crit_edge, label %.preheader

.preheader:                                       ; preds = %bb.a, %_ZN16OpenColorIO_v2_517IsNumberDelimiterEc.exit.thread.i
  %.012.i = phi i64 [ %i.d, %_ZN16OpenColorIO_v2_517IsNumberDelimiterEc.exit.thread.i ], [ 0, %bb.a ] ; 3 uses
  %.0.i = phi ptr [ %i.c, %_ZN16OpenColorIO_v2_517IsNumberDelimiterEc.exit.thread.i ], [ %1, %bb.a ] ; 2 uses
  %i.b = load i8, ptr %.0.i, align 1, !tbaa !27
...
_ZN16OpenColorIO_v2_517IsNumberDelimiterEc.exit.thread.i: ; preds = %.preheader, %.preheader, %.preheader, %.preheader, %.preheader, %.preheader, %.preheader
  ...
  br i1 %exitcond.not.i, label %._crit_edge, label %.preheader, !llvm.loop !127

_ZN16OpenColorIO_v2_518FindNextTokenStartEPKcmm.exit: ; preds = %.preheader
  %.not21 = icmp eq i64 %.012.i, %2
...
_ZN16OpenColorIO_v2_517IsNumberDelimiterEc.exit.thread.i.i: ; preds = %bb.d, %bb.d, %bb.d, %bb.d, %bb.d, %bb.d, %bb.d
  ...
  br i1 %exitcond.not.i.i, label %_ZN16OpenColorIO_v2_513GetNextNumberIdEEvPKcmRmRT_.exit, label %bb.d, !llvm.loop !127

_ZN16OpenColorIO_v2_518FindNextTokenStartEPKcmm.exit.i: ; preds = %bb.d
  %i.n = getelementptr inbounds nuw i8, ptr %1, i64 %.012.i.i
  br label %bb.e

bb.e:                                             ; preds = %bb.f, %_ZN16OpenColorIO_v2_518FindNextTokenStartEPKcmm.exit.i
  %.012.i26.i = phi i64 [ %.012.i.i, %_ZN16OpenColorIO_v2_518FindNextTokenStartEPKcmm.exit.i ], [ %i.q, %bb.f ] ; 4 uses
  %.0.i27.i = phi ptr [ %i.n, %_ZN16OpenColorIO_v2_518FindNextTokenStartEPKcmm.exit.i ], [ %i.p, %bb.f ] ; 2 uses
  %i.o = load i8, ptr %.0.i27.i, align 1, !tbaa !27
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %exitcond.not.i28.i, label %_ZN16OpenColorIO_v2_59FindDelimEPKcmm.exit.thread.i, label %bb.e, !llvm.loop !128

_ZN16OpenColorIO_v2_59FindDelimEPKcmm.exit.thread.i: ; preds = %bb.f
...
_ZN16OpenColorIO_v2_59FindDelimEPKcmm.exit.i:     ; preds = %bb.e, %bb.e, %bb.e, %bb.e, %bb.e, %bb.e, %bb.e
...
.noexc10:                                         ; preds = %_ZN16OpenColorIO_v2_59FindDelimEPKcmm.exit.i
  %i.r = getelementptr inbounds nuw i8, ptr %1, i64 %.012.i26.i
  br label %bb.g

bb.g:                                             ; preds = %_ZN16OpenColorIO_v2_517IsNumberDelimiterEc.exit.thread.i33.i, %.noexc10
  %.012.i31.i = phi i64 [ %.012.i26.i, %.noexc10 ], [ %i.u, %_ZN16OpenColorIO_v2_517IsNumberDelimiterEc.exit.thread.i33.i ] ; 2 uses
  %.0.i32.i = phi ptr [ %i.r, %.noexc10 ], [ %i.t, %_ZN16OpenColorIO_v2_517IsNumberDelimiterEc.exit.thread.i33.i ] ; 2 uses
  %i.s = load i8, ptr %.0.i32.i, align 1, !tbaa !27
...
_ZN16OpenColorIO_v2_517IsNumberDelimiterEc.exit.thread.i33.i: ; preds = %bb.g, %bb.g, %bb.g, %bb.g, %bb.g, %bb.g, %bb.g
  %i.t = getelementptr inbounds nuw i8, ptr %.0.i32.i, i64 1
  %i.u = add i64 %.012.i31.i, 1                   ; 2 uses
  %exitcond.not.i34.i = icmp eq i64 %i.u, %2
  br i1 %exitcond.not.i34.i, label %_ZN16OpenColorIO_v2_513GetNextNumberIdEEvPKcmRmRT_.exit, label %bb.g, !llvm.loop !127

_ZN16OpenColorIO_v2_513GetNextNumberIdEEvPKcmRmRT_.exit: ; preds = %_ZN16OpenColorIO_v2_517IsNumberDelimiterEc.exit.thread.i.i, %_ZN16OpenColorIO_v2_517IsNumberDelimiterEc.exit.thread.i33.i, %bb.g, %bb.b, %_ZN16OpenColorIO_v2_59FindDelimEPKcmm.exit.thread.i
  %.sink.i = phi i64 [ %2, %_ZN16OpenColorIO_v2_59FindDelimEPKcmm.exit.thread.i ], [ %2, %bb.b ], [ %.012.i31.i, %bb.g ], [ %2, %_ZN16OpenColorIO_v2_517IsNumberDelimiterEc.exit.thread.i33.i ], [ %2, %_ZN16OpenColorIO_v2_517IsNumberDelimiterEc.exit.thread.i.i ] ; 2 uses
  %.not.i11 = icmp eq ptr %i.h, %i.g
  br i1 %.not.i11, label %bb.i, label %bb.h

bb.h:                                             ; preds = %_ZN16OpenColorIO_v2_513GetNextNumberIdEEvPKcmRmRT_.exit
  %i.v = load double, ptr %i.a, align 8, !tbaa !82
  store double %i.v, ptr %i.h, align 8, !tbaa !82
  %i.w = getelementptr inbounds nuw i8, ptr %i.h, i64 8 ; 2 uses
  store ptr %i.w, ptr %i.e, align 8, !tbaa !76
  br label %_ZNSt6vectorIdSaIdEE9push_backERKd.exit

bb.i:                                             ; preds = %_ZN16OpenColorIO_v2_513GetNextNumberIdEEvPKcmRmRT_.exit
  %i.x = ptrtoint ptr %i.g to i64
  %i.y = ptrtoint ptr %i.i to i64
  %i.z = sub i64 %i.x, %i.y                       ; 6 uses
  %i.aa = icmp eq i64 %i.z, 9223372036854775800
  br i1 %i.aa, label %bb.j, label %_ZNKSt6vectorIdSaIdEE12_M_check_lenEmPKc.exit.i.i
...
_ZNKSt6vectorIdSaIdEE12_M_check_lenEmPKc.exit.i.i: ; preds = %bb.i
...
.noexc13:                                         ; preds = %_ZNKSt6vectorIdSaIdEE12_M_check_lenEmPKc.exit.i.i
  ...
  %i.aj = load double, ptr %i.a, align 8, !tbaa !82
  store double %i.aj, ptr %i.ai, align 8, !tbaa !82
  %i.ak = icmp sgt i64 %i.z, 0
  br i1 %i.ak, label %bb.k, label %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit16.i.i

bb.k:                                             ; preds = %.noexc13
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.ah, ptr align 8 %i.i, i64 %i.z, i1 false)
  br label %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit16.i.i

_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit16.i.i: ; preds = %bb.k, %.noexc13
  %i.al = getelementptr inbounds nuw i8, ptr %i.ai, i64 8 ; 2 uses
  %.not.i17.i.i = icmp eq ptr %i.i, null
  br i1 %.not.i17.i.i, label %_ZNSt6vectorIdSaIdEE17_M_realloc_insertIJRKdEEEvN9__gnu_cxx17__normal_iteratorIPdS1_EEDpOT_.exit.i, label %bb.l

bb.l:                                             ; preds = %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit16.i.i
  call void @_ZdlPvm(ptr noundef nonnull %i.i, i64 noundef %i.z) #30
  br label %_ZNSt6vectorIdSaIdEE17_M_realloc_insertIJRKdEEEvN9__gnu_cxx17__normal_iteratorIPdS1_EEDpOT_.exit.i

_ZNSt6vectorIdSaIdEE17_M_realloc_insertIJRKdEEEvN9__gnu_cxx17__normal_iteratorIPdS1_EEDpOT_.exit.i: ; preds = %bb.l, %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit16.i.i
  store ptr %i.al, ptr %i.e, align 8, !tbaa !76
  %i.am = getelementptr inbounds nuw [8 x i8], ptr %i.ah, i64 %i.af ; 2 uses
  store ptr %i.am, ptr %i.f, align 8, !tbaa !77
  br label %_ZNSt6vectorIdSaIdEE9push_backERKd.exit

_ZNSt6vectorIdSaIdEE9push_backERKd.exit:          ; preds = %_ZNSt6vectorIdSaIdEE17_M_realloc_insertIJRKdEEEvN9__gnu_cxx17__normal_iteratorIPdS1_EEDpOT_.exit.i, %bb.h
  %i.an = phi ptr [ %i.am, %_ZNSt6vectorIdSaIdEE17_M_realloc_insertIJRKdEEEvN9__gnu_cxx17__normal_iteratorIPdS1_EEDpOT_.exit.i ], [ %i.g, %bb.h ]
  %i.ao = phi ptr [ %i.al, %_ZNSt6vectorIdSaIdEE17_M_realloc_insertIJRKdEEEvN9__gnu_cxx17__normal_iteratorIPdS1_EEDpOT_.exit.i ], [ %i.w, %bb.h ]
  %i.ap = phi ptr [ %i.ah, %_ZNSt6vectorIdSaIdEE17_M_realloc_insertIJRKdEEEvN9__gnu_cxx17__normal_iteratorIPdS1_EEDpOT_.exit.i ], [ %i.i, %bb.h ] ; 2 uses
...
bb.m:                                             ; preds = %.loopexit.split-lp, %.loopexit
  ...
  br i1 %.not.i.i.i14, label %_ZNSt6vectorIdSaIdEED2Ev.exit, label %bb.n

._crit_edge:                                      ; preds = %_ZN16OpenColorIO_v2_517IsNumberDelimiterEc.exit.thread.i, %_ZNSt6vectorIdSaIdEE9push_backERKd.exit, %bb.a, %_ZN16OpenColorIO_v2_518FindNextTokenStartEPKcmm.exit
  %.lcssa = phi ptr [ null, %_ZN16OpenColorIO_v2_518FindNextTokenStartEPKcmm.exit ], [ %i.ap, %_ZNSt6vectorIdSaIdEE9push_backERKd.exit ], [ null, %bb.a ], [ null, %_ZN16OpenColorIO_v2_517IsNumberDelimiterEc.exit.thread.i ]
...
_ZNSt6vectorIdSaIdEED2Ev.exit:                    ; preds = %bb.m, %bb.n
...
bb.a:
  ...
  store ptr %i.c, ptr %0, align 8, !tbaa !21, !alias.scope !132
...
bb.b:                                             ; preds = %bb.a
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #29, !noalias !132
  store i64 %i.b, ptr %i.a, align 8, !tbaa !26, !noalias !132
...
.noexc.i.i:                                       ; preds = %bb.b
  ...
  store ptr %i.g, ptr %0, align 8, !tbaa !24, !alias.scope !132
  %i.h = load i64, ptr %i.a, align 8, !tbaa !26, !noalias !132
  store i64 %i.h, ptr %i.c, align 8, !tbaa !27, !alias.scope !132
...
bb.c:                                             ; preds = %._crit_edge.i.i.i
  %i.j = load i8, ptr %1, align 1, !tbaa !27, !noalias !132
...
_ZN16OpenColorIO_v2_514TruncateStringB5cxx11EPKcmm.exit: ; preds = %._crit_edge.i.i.i, %bb.c, %bb.d
  %i.k = load i64, ptr %i.a, align 8, !tbaa !26, !noalias !132 ; 2 uses
  %i.l = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i64 %i.k, ptr %i.l, align 8, !tbaa !25, !alias.scope !132
  %i.m = load ptr, ptr %0, align 8, !tbaa !24, !alias.scope !132
  %i.n = getelementptr inbounds nuw i8, ptr %i.m, i64 %i.k
  store i8 0, ptr %i.n, align 1, !tbaa !27
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #29, !noalias !132
  ret void
}
...
bb.c:                                             ; preds = %bb.b
  ...
  tail call void %i.j(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #29, !inline_history !1
  %i.k = load ptr, ptr %i.b, align 8, !tbaa !18
  %i.l = getelementptr inbounds nuw i8, ptr %i.k, i64 24
  %i.m = load ptr, ptr %i.l, align 8
  tail call void %i.m(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #29, !inline_history !1
...
.noexc.i:                                         ; preds = %bb.b
  ...
  store ptr %i.f, ptr %5, align 8, !tbaa !24
