...
bb.a:
  ...
  %i.j = load i32, ptr %i.i, align 8, !tbaa !89   ; 6 uses
  %1 = lshr i32 %i.j, 3
  %2 = lshr i32 %i.j, 2
  %3 = lshr i32 %i.j, 1
  ...
  %4 = trunc i32 %2 to i8
  %5 = trunc i32 %3 to i8
  %6 = trunc i32 %i.j to i8
  %i.l = insertelement <4 x i8> poison, i8 %6, i64 0
  %i.m = insertelement <4 x i8> %i.l, i8 %5, i64 1
  %i.n = insertelement <4 x i8> %i.m, i8 %4, i64 2
  %i.o = insertelement <4 x i8> %i.n, i8 %i.k, i64 3
