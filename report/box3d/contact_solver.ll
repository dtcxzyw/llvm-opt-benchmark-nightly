...
b3Perp.exit:                                      ; preds = %bb.l, %bb.m
  ...
  %i.gp = fsub float %i.gn, %i.go                 ; 7 uses
  ...
  %i.gv = fsub float %i.gr, %i.gt                 ; 6 uses
...
._crit_edge:                                      ; preds = %bb.n, %b3Perp.exit
  ...
  %i.jk = extractelement <4 x float> %i.ix, i64 1 ; 2 uses
...
._crit_edge1170:                                  ; preds = %.lr.ph1169, %._crit_edge
  ...
  %i.pz = fmul float %i.gp, %i.je
  %i.qa = fmul float %i.gu, %i.jg
  %i.qb = fmul float %i.gp, %i.jk
  %2 = fmul float %i.gp, %i.jc
  %3 = fmul float %i.gv, %i.ir
  %4 = fmul float %i.gp, %i.ji
  %5 = fmul float %i.gv, %i.jg
  %6 = fsub float %i.pz, %3                       ; 2 uses
  %7 = fsub float %i.qb, %5
  %i.qc = insertelement <2 x float> poison, float %i.gv, i64 0
  %8 = shufflevector <2 x float> %i.qc, <2 x float> poison, <2 x i32> zeroinitializer
  %i.qd = shufflevector <4 x float> %i.ix, <4 x float> poison, <2 x i32> <i32 0, i32 3>
  %i.qe = fmul <2 x float> %8, %i.qd
  ...
  %i.qj = fsub <2 x float> %i.qe, %i.qi
  %i.qk = fsub float %i.py, %2                    ; 2 uses
  %i.ql = fsub float %i.qa, %4                    ; 2 uses
  %i.qm = shufflevector <2 x float> %i.qj, <2 x float> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison> ; 2 uses
  ...
  %9 = insertelement <8 x float> <float poison, float poison, float 1.000000e+00, float -0.000000e+00, float poison, float poison, float poison, float poison>, float %7, i64 0 ; 2 uses
  %10 = insertelement <8 x float> %9, float %6, i64 1
  %11 = shufflevector <8 x float> %10, <8 x float> poison, <8 x i32> <i32 0, i32 0, i32 0, i32 1, i32 1, i32 1, i32 2, i32 3>
  %i.qp = fmul <8 x float> %i.pt, %11
  ...
  %12 = shufflevector <8 x float> %i.qm, <8 x float> %9, <8 x i32> <i32 0, i32 8, i32 poison, i32 1, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.qw = insertelement <8 x float> %12, float %i.ql, i64 2
  %i.qx = insertelement <8 x float> %i.qw, float %6, i64 4
  %i.qy = insertelement <8 x float> %i.qx, float %i.qk, i64 5
  %13 = insertelement <8 x float> %i.qy, float %.0695, i64 6
  %i.qz = insertelement <8 x float> %13, float %.0694, i64 7
