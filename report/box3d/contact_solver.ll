...
.cont655:                                         ; preds = %.cont660.cont.thread, %.else656
  ...
  %i.aj = load <2 x float>, ptr %.sroa.27.0..sroa_idx, align 4, !tbaa !103 ; 5 uses
...
.lr.ph767:                                        ; preds = %.cont655
  ...
  %2 = insertelement <2 x float> %i.aj, float %.sroa.35.0.copyload, i64 1
  %3 = extractelement <2 x float> %i.aj, i64 0
...
._crit_edge:                                      ; preds = %bb.c, %bb.b
  ...
  %.sroa.06.0.vec.extract.i415 = extractelement <2 x float> %.sroa.0186.0.copyload, i64 0
  ...
  %i.cq = fmul float %.sroa.06.0.vec.extract.i415, %i.cn
  ...
  %4 = fmul <4 x float> %i.dt, %i.bd
  %5 = shufflevector <4 x float> %i.dt, <4 x float> poison, <2 x i32> <i32 0, i32 1>
  %6 = fmul <2 x float> %i.ar, %5                 ; 2 uses
  %7 = insertelement <2 x float> %6, float %i.dv, i64 0
  %8 = shufflevector <2 x float> %6, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %9 = insertelement <2 x float> %8, float %i.dx, i64 0
  %foldExtExtBinop819 = fadd <2 x float> %7, %9
  %10 = shufflevector <4 x float> %i.dt, <4 x float> poison, <2 x i32> <i32 2, i32 2>
  %11 = fmul <2 x float> %2, %10
  %12 = fadd <2 x float> %11, %foldExtExtBinop819
  %13 = insertelement <2 x float> %.sroa.0305.1.lcssa, float %.sroa.12.1.lcssa, i64 1
  %14 = fadd <2 x float> %13, %12                 ; 2 uses
  ...
  %i.er = tail call float @llvm.vector.reduce.fadd.v4f32(float -0.000000e+00, <4 x float> %4)
  ...
  %i.gu = insertelement <2 x float> %14, float %i.er, i64 1
