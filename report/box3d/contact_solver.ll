...
.lr.ph:                                           ; preds = %bb.c
  ...
  %3 = shufflevector <2 x float> %.sroa.0578.0.copyload, <2 x float> poison, <3 x i32> <i32 1, i32 0, i32 poison>
  %4 = insertelement <3 x float> %3, float %.sroa.6581.0.copyload, i64 2
...
._crit_edge:                                      ; preds = %bb.h, %bb.c
  ...
  %.sroa.0673.1.lcssa = phi <2 x float> [ %.sroa.0673.01446, %bb.c ], [ %11, %bb.h ] ; 3 uses
  %.sroa.10678.1.lcssa = phi float [ %.sroa.10678.01447, %bb.c ], [ %14, %bb.h ] ; 3 uses
...
bb.d:                                             ; preds = %.lr.ph, %bb.h
  ...
  %.sroa.10678.11429 = phi float [ %.sroa.10678.01447, %.lr.ph ], [ %14, %bb.h ] ; 2 uses
  %.sroa.0673.11428 = phi <2 x float> [ %.sroa.0673.01446, %.lr.ph ], [ %11, %bb.h ] ; 3 uses
...
bb.h:                                             ; preds = %bb.f, %bb.g, %bb.e
  ...
  %5 = insertelement <3 x float> poison, float %i.hh, i64 0
  %6 = shufflevector <3 x float> %5, <3 x float> poison, <3 x i32> zeroinitializer
  %7 = fmul <3 x float> %4, %6                    ; 5 uses
  %8 = shufflevector <3 x float> %7, <3 x float> poison, <2 x i32> <i32 0, i32 1> ; 2 uses
  %9 = fmul <2 x float> %i.bn, %8
  %10 = shufflevector <2 x float> %9, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %11 = fsub <2 x float> %.sroa.0673.11428, %10   ; 2 uses
  %12 = extractelement <3 x float> %7, i64 2      ; 2 uses
  %13 = fmul float %i.y, %12
  %14 = fsub float %.sroa.10678.11429, %13        ; 2 uses
  %15 = shufflevector <2 x float> %.sroa.0553.0.copyload, <2 x float> %.sroa.0556.0.copyload, <2 x i32> <i32 1, i32 3> ; 2 uses
  %16 = shufflevector <3 x float> %7, <3 x float> poison, <2 x i32> <i32 2, i32 2> ; 2 uses
  %17 = fmul <2 x float> %15, %16
  %18 = shufflevector <3 x float> %7, <3 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.hr = fmul <2 x float> %i.fv, %18
  %i.hs = fsub <2 x float> %17, %i.hr             ; 3 uses
  %19 = shufflevector <3 x float> %7, <3 x float> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  %20 = fmul <2 x float> %i.fv, %19
  %i.ht = fmul <2 x float> %i.fs, %16
  %i.hu = fsub <2 x float> %20, %i.ht             ; 3 uses
  %i.hv = fmul <2 x float> %i.fs, %18
  %i.hw = fmul <2 x float> %15, %19
  ...
  %i.im = fmul <2 x float> %i.bk, %8
  %21 = shufflevector <2 x float> %i.im, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %i.in = fadd <2 x float> %.sroa.0645.11424, %21 ; 2 uses
  %i.io = fmul float %i.ad, %12
