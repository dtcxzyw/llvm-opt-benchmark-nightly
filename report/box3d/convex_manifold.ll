...
bb.a:
  ...
  %i.q = load <2 x float>, ptr %i.p, align 4      ; 8 uses
  %i.r = getelementptr inbounds nuw i8, ptr %3, i64 20
  %i.s = load <2 x float>, ptr %i.r, align 4      ; 8 uses
  %.sroa.9.8.vec.extract = extractelement <2 x float> %.sroa.9.0.copyload, i64 0 ; 4 uses
  %8 = shufflevector <2 x float> %i.q, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1> ; 2 uses
  ...
  %i.at = fmul <2 x float> %i.q, %i.q
  %i.au = shufflevector <2 x float> %i.at, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %foldExtExtBinop = fmul <2 x float> %i.s, %i.s
  %9 = shufflevector <2 x float> %foldExtExtBinop, <2 x float> poison, <2 x i32> zeroinitializer
  %i.av = fadd <2 x float> %i.au, %9
  %i.aw = fmul <2 x float> %i.av, splat (float 2.000000e+00)
  %i.ax = fsub <2 x float> splat (float 1.000000e+00), %i.aw
  %10 = shufflevector <2 x float> %i.q, <2 x float> %i.s, <4 x i32> <i32 1, i32 2, i32 1, i32 0>
  %11 = shufflevector <2 x float> %i.ai, <2 x float> %i.s, <4 x i32> <i32 1, i32 3, i32 3, i32 3>
  %i.ay = fmul <4 x float> %10, %11               ; 2 uses
  %12 = shufflevector <2 x float> %i.aj, <2 x float> %i.s, <4 x i32> <i32 0, i32 poison, i32 2, i32 2>
  %13 = shufflevector <4 x float> %12, <4 x float> %8, <4 x i32> <i32 0, i32 4, i32 2, i32 3>
  %i.az = fmul <4 x float> %8, %13                ; 2 uses
  %i.ba = fsub <4 x float> %i.az, %i.ay           ; 4 uses
  ...
  %14 = shufflevector <2 x float> %i.au, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 2 uses
  %15 = shufflevector <4 x float> %i.az, <4 x float> %14, <4 x i32> <i32 1, i32 3, i32 2, i32 5>
  %16 = shufflevector <4 x float> %i.ay, <4 x float> %14, <4 x i32> <i32 1, i32 3, i32 2, i32 4>
  %foldExtExtBinop5.a = fadd <4 x float> %15, %16 ; 4 uses
  %17 = shufflevector <4 x float> %i.ba, <4 x float> %foldExtExtBinop5.a, <2 x i32> <i32 1, i32 4>
  %18 = fmul <2 x float> %17, splat (float 2.000000e+00)
  %19 = extractelement <4 x float> %foldExtExtBinop5.a, i64 1
  %20 = fmul float %19, 2.000000e+00
  %21 = shufflevector <4 x float> %foldExtExtBinop5.a, <4 x float> %i.ba, <2 x i32> <i32 2, i32 7>
  %i.bz = fmul <2 x float> %21, splat (float 2.000000e+00)
  %i.ca = extractelement <4 x float> %foldExtExtBinop5.a, i64 3
...
bb.c:                                             ; preds = %bb.a
  ...
  %7 = fmul float %.sroa.011.0.vec.extract.i.i.i, %.sroa.011.4.vec.extract.i.i.i ; 2 uses
  ...
  %i.ao = fmul float %.sroa.3.8.vec.extract.i.i, %.sroa.3.12.vec.extract.i.i ; 2 uses
  %8 = fsub float %i.ak, %i.an
  %i.ap = fmul float %8, 2.000000e+00             ; 2 uses
  %9 = fadd float %i.am, %i.al
  %10 = fmul float %9, 2.000000e+00               ; 2 uses
  %i.aq = fadd float %7, %i.ao
  %i.ar = fsub float %7, %i.ao
  ...
  %11 = shufflevector <2 x float> %foldExtExtBinop8, <2 x float> poison, <2 x i32> zeroinitializer
  %i.av = fadd <2 x float> %i.aj, %11
  %i.aw = fmul <2 x float> %i.av, splat (float 2.000000e+00)
  ...
  %i.bh = fmul float %i.ap, %.sroa.03.0.vec.extract.i62
...
bb.d:                                             ; preds = %.lr.ph, %bb.d
  ...
  %i.ci = fmul float %i.ap, %.sroa.03.0.vec.extract.i72
  %i.cj = extractelement <2 x float> %.sroa.010.0.copyload, i64 1
  %i.ck = fmul float %10, %i.cj
