...
bb.a:
  ...
  %.sroa.10443.0.copyload = load <2 x float>, ptr %.sroa.10443.0..sroa_idx, align 4 ; 6 uses
  ...
  %foldExtExtBinop = fmul <2 x float> %.sroa.10443.0.copyload, %.sroa.10443.0.copyload
  %shift = shufflevector <2 x float> %.sroa.10443.0.copyload, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop1028 = fmul <2 x float> %.sroa.10443.0.copyload, %shift ; 2 uses
  %shift1030 = shufflevector <2 x float> %.sroa.9442.0.copyload, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %i.j = fmul <2 x float> %.sroa.9442.0.copyload, %shift1030 ; 2 uses
  %11 = shufflevector <2 x float> %foldExtExtBinop, <2 x float> poison, <2 x i32> zeroinitializer
  %12 = fadd <2 x float> %i.e, %11
  %13 = fmul <2 x float> %12, splat (float 2.000000e+00)
  %foldExtExtBinop1033 = fadd <2 x float> %i.j, %foldExtExtBinop1028
  %foldExtExtBinop1035 = fsub <2 x float> %i.j, %foldExtExtBinop1028
  %14 = shufflevector <2 x float> %foldExtExtBinop1035, <2 x float> %foldExtExtBinop1033, <2 x i32> <i32 0, i32 2>
  %i.k = fmul <2 x float> %14, splat (float 2.000000e+00) ; 5 uses
  %i.l = fsub <2 x float> splat (float 1.000000e+00), %13 ; 5 uses
