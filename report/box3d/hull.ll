...
bb.a:
  ...
  %i.a = tail call <2 x float> @b3ComputeCosSin(float noundef f0x407886B6) #24 ; 13 uses
  %i.b = shufflevector <2 x float> %i.a, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 6 uses
  %.sroa.012.0.vec.extract = extractelement <2 x float> %i.a, i64 0 ; 2 uses
  %i.c = fmul float %0, f0x3EDF2CF8               ; 3 uses
  store float %i.c, ptr %1, align 16, !tbaa !87
  %i.d = getelementptr inbounds nuw i8, ptr %1, i64 4
  %2 = extractelement <2 x float> %i.a, i64 1     ; 4 uses
  %3 = fmul float %2, 0.000000e+00
  %4 = fsub float %.sroa.012.0.vec.extract, %3    ; 2 uses
  %5 = fmul float %.sroa.012.0.vec.extract, 0.000000e+00
  %6 = fadd float %2, %5                          ; 2 uses
  %7 = fmul float %0, f0x3F36D211
  %8 = insertelement <4 x float> poison, float %0, i64 1 ; 2 uses
  %9 = insertelement <4 x float> %8, float %i.c, i64 0
  %10 = insertelement <4 x float> %9, float %4, i64 2
  %11 = insertelement <4 x float> %10, float %6, i64 3
  %12 = insertelement <4 x float> <float 0.000000e+00, float f0x3F666666, float poison, float poison>, float %7, i64 2
  %13 = shufflevector <4 x float> %12, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 2>
  %i.e = fmul <4 x float> %11, %13
  store <4 x float> %i.e, ptr %i.d, align 4, !tbaa !23
  %14 = getelementptr inbounds nuw i8, ptr %1, i64 20
  %15 = insertelement <4 x float> poison, float %0, i64 0 ; 2 uses
  %16 = getelementptr inbounds nuw i8, ptr %1, i64 36
  %17 = insertelement <2 x float> poison, float %4, i64 0
  %18 = shufflevector <2 x float> %17, <2 x float> poison, <2 x i32> zeroinitializer
  %i.f = fmul <2 x float> %i.a, %18               ; 2 uses
  %19 = insertelement <2 x float> poison, float %6, i64 0
  %20 = shufflevector <2 x float> %19, <2 x float> poison, <2 x i32> zeroinitializer
  %21 = fmul <2 x float> %i.b, %20                ; 2 uses
  %22 = fsub <2 x float> %i.f, %21                ; 2 uses
  %23 = fadd <2 x float> %i.f, %21                ; 2 uses
  %24 = shufflevector <2 x float> %22, <2 x float> %23, <4 x i32> <i32 0, i32 3, i32 poison, i32 poison>
  %25 = shufflevector <4 x float> %15, <4 x float> %24, <4 x i32> <i32 0, i32 4, i32 5, i32 0>
  %26 = shufflevector <2 x float> %22, <2 x float> poison, <2 x i32> zeroinitializer
  %i.g = fmul <2 x float> %i.a, %26               ; 2 uses
  %27 = shufflevector <2 x float> %23, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %28 = fmul <2 x float> %i.b, %27                ; 2 uses
  %29 = fsub <2 x float> %i.g, %28
  %30 = fadd <2 x float> %i.g, %28
  %31 = shufflevector <2 x float> %29, <2 x float> %30, <2 x i32> <i32 0, i32 3> ; 3 uses
  %32 = fmul <2 x float> %i.a, %31                ; 2 uses
  %shift = shufflevector <2 x float> %32, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop = fsub <2 x float> %32, %shift ; 3 uses
  %33 = shufflevector <2 x float> %foldExtExtBinop, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %34 = extractelement <2 x float> %foldExtExtBinop, i64 0
  %35 = fmul <2 x float> %i.b, %31                ; 2 uses
  %shift32 = shufflevector <2 x float> %35, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop33 = fadd <2 x float> %35, %shift32 ; 2 uses
  %36 = extractelement <2 x float> %foldExtExtBinop33, i64 0 ; 2 uses
  ...
  %i.k = insertelement <4 x float> %37, float %0, i64 2
  %38 = shufflevector <4 x float> %i.k, <4 x float> %33, <4 x i32> <i32 0, i32 1, i32 2, i32 4>
  %i.l = fmul <4 x float> %38, %i.j
  store <4 x float> %i.l, ptr %16, align 4, !tbaa !23
  %i.m = getelementptr inbounds nuw i8, ptr %1, i64 52
  %foldExtExtBinop35 = fmul <2 x float> %i.a, %foldExtExtBinop
  %39 = extractelement <2 x float> %foldExtExtBinop35, i64 0
  %i.n = fmul float %2, %36
  %i.o = fsub float %39, %i.n                     ; 2 uses
  %i.p = fmul float %2, %34
  %foldExtExtBinop37 = fmul <2 x float> %i.a, %foldExtExtBinop33
  %40 = extractelement <2 x float> %foldExtExtBinop37, i64 0
  %i.q = fadd float %i.p, %40                     ; 2 uses
  %i.r = insertelement <4 x float> %8, float %36, i64 0
  ...
  %42 = shufflevector <4 x float> %i.j, <4 x float> <float f0xBDCCCCD0, float poison, float poison, float f0xBE999998>, <4 x i32> <i32 4, i32 0, i32 0, i32 7>
  %i.w = getelementptr inbounds nuw i8, ptr %1, i64 84
  %43 = insertelement <2 x float> poison, float %i.o, i64 0
  %44 = shufflevector <2 x float> %43, <2 x float> poison, <2 x i32> zeroinitializer
  %45 = fmul <2 x float> %i.a, %44                ; 2 uses
  %46 = insertelement <2 x float> poison, float %i.q, i64 0
  %47 = shufflevector <2 x float> %46, <2 x float> poison, <2 x i32> zeroinitializer
  %48 = fmul <2 x float> %i.b, %47                ; 2 uses
  %49 = fsub <2 x float> %45, %48                 ; 2 uses
  %50 = fadd <2 x float> %45, %48                 ; 2 uses
  %51 = shufflevector <2 x float> %49, <2 x float> %50, <4 x i32> <i32 0, i32 3, i32 poison, i32 poison>
  %52 = shufflevector <4 x float> %15, <4 x float> %51, <4 x i32> <i32 0, i32 4, i32 5, i32 0>
  %i.x = fmul <4 x float> %52, %42
  store <4 x float> %i.x, ptr %41, align 4, !tbaa !23
  %53 = shufflevector <2 x float> %49, <2 x float> poison, <2 x i32> zeroinitializer
  %54 = fmul <2 x float> %i.a, %53                ; 2 uses
  %55 = shufflevector <2 x float> %50, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %56 = fmul <2 x float> %i.b, %55                ; 2 uses
  %57 = fsub <2 x float> %54, %56
  %58 = fadd <2 x float> %54, %56
  %59 = shufflevector <2 x float> %57, <2 x float> %58, <2 x i32> <i32 0, i32 3> ; 3 uses
  %60 = fmul <2 x float> %i.a, %59                ; 2 uses
  %61 = fmul <2 x float> %i.b, %59                ; 2 uses
  ...
  %i.aa = fmul <4 x float> %25, %i.z
  store <4 x float> %i.aa, ptr %14, align 4, !tbaa !23
  %62 = shufflevector <2 x float> %59, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.ab = insertelement <4 x float> %62, float %0, i64 2
  %i.ac = getelementptr inbounds nuw i8, ptr %1, i64 100
  %shift39 = shufflevector <2 x float> %61, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop40 = fadd <2 x float> %61, %shift39 ; 2 uses
  %63 = shufflevector <2 x float> %foldExtExtBinop40, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %shift42 = shufflevector <2 x float> %60, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop43 = fsub <2 x float> %60, %shift42 ; 2 uses
  %64 = shufflevector <2 x float> %foldExtExtBinop43, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %65 = shufflevector <4 x float> %i.ab, <4 x float> %64, <4 x i32> <i32 0, i32 1, i32 2, i32 4>
  %i.ad = fmul <4 x float> %65, %i.y
  store <4 x float> %i.ad, ptr %i.w, align 4, !tbaa !23
  %i.ae = shufflevector <2 x float> %foldExtExtBinop43, <2 x float> poison, <2 x i32> zeroinitializer
  %i.af = fmul <2 x float> %i.a, %i.ae            ; 2 uses
  %66 = shufflevector <2 x float> %i.a, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %i.ag = shufflevector <2 x float> %foldExtExtBinop40, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ah = fmul <2 x float> %66, %i.ag             ; 2 uses
  %i.ai = fsub <2 x float> %i.af, %i.ah
  %i.aj = fadd <2 x float> %i.af, %i.ah
  %i.ak = insertelement <4 x float> %63, float %0, i64 1
