...
bb.f:                                             ; preds = %bb.e
  ...
  %12 = sext i32 %i.bw to i64
  %i.cf = getelementptr inbounds [2 x i8], ptr %i.ce, i64 %12
  %13 = sext i32 %i.by to i64
  %i.cg = getelementptr inbounds [2 x i8], ptr %i.ce, i64 %13
...
bb.f:                                             ; preds = %bb.e
  ...
  %4 = sext i32 %i.bh to i64
  %i.bq = getelementptr inbounds [2 x i8], ptr %i.bp, i64 %4
  %5 = sext i32 %i.bj to i64
  %i.br = getelementptr inbounds [2 x i8], ptr %i.bp, i64 %5
...
bb.f:                                             ; preds = %bb.e
  ...
  %10 = sext i32 %i.co to i64
  %i.cx = getelementptr inbounds [2 x i8], ptr %i.cw, i64 %10
  %11 = sext i32 %i.cq to i64
  %i.cy = getelementptr inbounds [2 x i8], ptr %i.cw, i64 %11
