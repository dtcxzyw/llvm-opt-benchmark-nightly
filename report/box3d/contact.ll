...
bb.a:
  ...
  %.sroa.7.0.copyload = load <2 x float>, ptr %.sroa.7.0..sroa_idx, align 4 ; 18 uses
...
b3Bump.exit.i:                                    ; preds = %bb.e, %bb.b
  ...
  %.sroa.443.8.vec.extract.i.i = extractelement <2 x float> %.sroa.8.0.copyload, i64 0 ; 2 uses
  %.sroa.03.4.vec.extract.i.i.i = extractelement <2 x float> %.sroa.7.0.copyload, i64 1 ; 4 uses
  %.sroa.03.0.vec.extract.i.i.i = extractelement <2 x float> %.sroa.7.0.copyload, i64 0 ; 3 uses
...
bb.v:                                             ; preds = %bb.u, %b3AllocateManifolds.exit.i
  ...
  %foldExtExtBinop220 = fmul <2 x float> %.sroa.8.0.copyload, %.sroa.8.0.copyload
  %15 = fmul float %.sroa.03.0.vec.extract.i.i.i, %.sroa.03.4.vec.extract.i.i.i ; 2 uses
  ...
  %16 = fmul float %.sroa.03.0.vec.extract.i.i.i, %14 ; 2 uses
  %i.ev = fmul float %.sroa.03.4.vec.extract.i.i.i, %.sroa.443.8.vec.extract.i.i ; 2 uses
  %i.ew = fmul float %.sroa.03.4.vec.extract.i.i.i, %14 ; 2 uses
  %i.ex = fmul float %.sroa.443.8.vec.extract.i.i, %14 ; 2 uses
  %i.ey = fsub float %i.eu, %i.ew
  %i.ez = fmul float %i.ey, 2.000000e+00          ; 2 uses
  %i.fa = fadd float %i.ev, %16
  %i.fb = fmul float %i.fa, 2.000000e+00          ; 2 uses
  %i.fc = fadd float %15, %i.ex
  %i.fd = fsub float %15, %i.ex
  ...
  %17 = shufflevector <2 x float> %foldExtExtBinop220, <2 x float> poison, <2 x i32> zeroinitializer
  %i.fh = fadd <2 x float> %i.et, %17
  %i.fi = fmul <2 x float> %i.fh, splat (float 2.000000e+00)
  %i.fj = fsub <2 x float> splat (float 1.000000e+00), %i.fi ; 2 uses
  %i.fk = fsub float %i.ev, %16
  %i.fl = fadd float %i.eu, %i.ew
