...
bb.o:                                             ; preds = %bb.m, %bb.l, %bb.k, %bb.n
  ...
  %i.kz = load <2 x float>, ptr %i.aw, align 4    ; 4 uses
  ...
  %6 = shufflevector <2 x float> %i.ky, <2 x float> %i.kz, <3 x i32> <i32 0, i32 3, i32 2>
  %7 = shufflevector <2 x float> %i.ky, <2 x float> %i.kz, <3 x i32> <i32 1, i32 2, i32 2>
  %8 = fmul <3 x float> %6, %7                    ; 3 uses
  %9 = extractelement <3 x float> %8, i64 0       ; 2 uses
  %10 = extractelement <3 x float> %8, i64 1      ; 2 uses
  %11 = fadd float %9, %10
  %12 = fsub float %9, %10
  %13 = insertelement <2 x float> poison, float %11, i64 0
  %14 = insertelement <2 x float> %13, float %12, i64 1
  %i.li = fmul <2 x float> %14, splat (float 2.000000e+00) ; 8 uses
  %15 = shufflevector <3 x float> %8, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %i.lj = fadd <2 x float> %i.lc, %15
  %i.lk = fmul <2 x float> %i.lj, splat (float 2.000000e+00)
  %i.ll = fsub <2 x float> splat (float 1.000000e+00), %i.lk ; 8 uses
  ...
  %i.lp = fmul <2 x float> %i.lo, splat (float 2.000000e+00) ; 8 uses
  ...
  %i.ms = extractelement <2 x float> %i.lr, i64 1
  ...
  %16 = extractelement <2 x float> %i.lr, i64 0
  ...
  %17 = fmul <2 x float> %i.lp, %i.ma
  %18 = shufflevector <2 x float> %i.lp, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %19 = fmul <2 x float> %18, %i.mj
  %20 = fadd <2 x float> %17, %19
  %shift556 = shufflevector <2 x float> %i.lc, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop557 = fadd <2 x float> %i.lc, %shift556
  %21 = extractelement <2 x float> %foldExtExtBinop557, i64 0
  %22 = fmul float %21, 2.000000e+00
  %23 = fsub float 1.000000e+00, %22              ; 4 uses
  %foldExtExtBinop559 = fmul <2 x float> %i.lp, %.sroa.5458.0.copyload
  %24 = shufflevector <2 x float> %foldExtExtBinop559, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %foldExtExtBinop561 = fmul <2 x float> %.sroa.0456.0.copyload, %i.lp
  %25 = shufflevector <2 x float> %foldExtExtBinop561, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %26 = shufflevector <2 x float> %.sroa.0456.0.copyload, <2 x float> %i.lp, <4 x i32> <i32 poison, i32 1, i32 3, i32 1>
  %i.nl = insertelement <4 x float> %26, float -0.000000e+00, i64 0
  %27 = shufflevector <2 x float> %i.lp, <2 x float> %.sroa.5458.0.copyload, <4 x i32> <i32 poison, i32 1, i32 3, i32 1>
  %28 = insertelement <4 x float> %27, float 1.000000e+00, i64 0
  %i.nm = fmul <4 x float> %i.nl, %28
  %29 = shufflevector <4 x float> <float -0.000000e+00, float poison, float poison, float poison>, <4 x float> %25, <4 x i32> <i32 0, i32 4, i32 poison, i32 poison>
  %30 = shufflevector <4 x float> %29, <4 x float> %24, <4 x i32> <i32 0, i32 1, i32 4, i32 poison>
  %31 = shufflevector <4 x float> %30, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 1>
  %32 = fadd <4 x float> %31, %i.nm
  %33 = shufflevector <2 x float> %.sroa.7460.0.copyload, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %34 = insertelement <4 x float> %33, float %.sroa.4457.0.copyload, i64 1
  %35 = insertelement <4 x float> %34, float %.sroa.6459.0.copyload, i64 2
  %36 = shufflevector <4 x float> %35, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 1>
  %37 = insertelement <4 x float> <float 1.000000e+00, float poison, float poison, float poison>, float %23, i64 1
  %38 = shufflevector <4 x float> %37, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 1>
  %39 = fmul <4 x float> %36, %38
  %i.nn = fadd <4 x float> %39, %32               ; 2 uses
  %40 = fmul float %23, %.sroa.8461.0.copyload
  %41 = shufflevector <2 x float> %i.lp, <2 x float> %i.ll, <4 x i32> <i32 0, i32 3, i32 2, i32 0>
  %42 = fmul <4 x float> %41, %i.nn
  %43 = shufflevector <2 x float> %i.lp, <2 x float> %i.li, <4 x i32> <i32 1, i32 3, i32 2, i32 1>
  %44 = shufflevector <2 x float> %.sroa.7460.0.copyload, <2 x float> poison, <4 x i32> <i32 1, i32 poison, i32 poison, i32 poison>
  %45 = shufflevector <4 x float> %44, <4 x float> %i.nn, <4 x i32> <i32 0, i32 6, i32 5, i32 6>
  %46 = fmul <4 x float> %43, %45
  %47 = fadd <4 x float> %42, %46                 ; 4 uses
  %48 = extractelement <4 x float> %47, i64 0
  %49 = fadd float %40, %48                       ; 3 uses
  %50 = fmul float %i.ms, %49
  %51 = extractelement <4 x float> %47, i64 1
  %52 = fadd float %51, %50
  %53 = fmul float %16, %49
  %54 = extractelement <4 x float> %47, i64 2
  %55 = fadd float %54, %53
  %56 = insertelement <2 x float> poison, float %23, i64 0
  %57 = shufflevector <2 x float> %56, <2 x float> poison, <2 x i32> zeroinitializer
  %58 = fmul <2 x float> %57, %i.mr
  %59 = fadd <2 x float> %58, %20
  %60 = shufflevector <2 x float> %59, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %61 = fmul float %23, %49
  %i.no = extractelement <4 x float> %47, i64 3
  %62 = fadd float %i.no, %61
  store <2 x float> %i.nb, ptr %i.la, align 4
  %.sroa.4416.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.as, i64 152
  store float %52, ptr %.sroa.4416.0..sroa_idx, align 4, !tbaa !148
  ...
  store float %55, ptr %.sroa.6418.0..sroa_idx, align 4, !tbaa !148
  %.sroa.7419.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.as, i64 168
  store <2 x float> %60, ptr %.sroa.7419.0..sroa_idx, align 4
  %.sroa.8420.0..sroa_idx = getelementptr inbounds nuw i8, ptr %i.as, i64 176
  store float %62, ptr %.sroa.8420.0..sroa_idx, align 4, !tbaa !148
