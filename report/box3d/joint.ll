...
bb.g:                                             ; preds = %bb.a
  ...
  %i.dy = fadd <2 x float> %i.dv, %i.ds           ; 3 uses
  %i.dz = fadd <2 x float> %i.dx, %i.dt           ; 2 uses
  %i.ea = extractelement <2 x float> %i.dz, i64 1 ; 2 uses
  %i.eb = extractelement <2 x float> %i.dy, i64 0 ; 3 uses
  %7 = fmul float %i.eb, 0.000000e+00
  %8 = extractelement <2 x float> %i.dy, i64 1    ; 2 uses
  %i.ec = fmul float %8, 0.000000e+00
  %i.ed = fsub float %7, %i.ec
  %foldExtExtBinop283 = fmul <2 x float> %i.cn, %i.co
  %foldExtExtBinop285 = fmul <2 x float> %i.cl, %i.cq
  %9 = shufflevector <2 x float> %i.co, <2 x float> %i.cq, <2 x i32> <i32 1, i32 2>
  %10 = fmul <2 x float> %i.cl, %9
  %i.ee = shufflevector <2 x float> %i.cl, <2 x float> %i.cn, <2 x i32> <i32 1, i32 2>
  %i.ef = fmul <2 x float> %i.ee, %i.co
  %foldExtExtBinop287 = fsub <2 x float> %foldExtExtBinop283, %foldExtExtBinop285
  %11 = extractelement <2 x float> %foldExtExtBinop287, i64 0
  %i.eg = fsub <2 x float> %10, %i.ef
  ...
  %12 = fadd float %i.eh, %11
  %i.eq = fadd <2 x float> %i.ep, %i.el           ; 5 uses
  %13 = fadd float %i.em, %12                     ; 4 uses
  %shift289 = shufflevector <2 x float> %i.dd, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop290 = fadd <2 x float> %i.dd, %shift289
  %14 = fmul float %.sroa.443.12.vec.extract.i, %.sroa.433.12.vec.extract.i
  %i.er = extractelement <2 x float> %i.eq, i64 0
  %i.es = fmul float %i.er, 0.000000e+00          ; 2 uses
  %15 = fmul <2 x float> %i.cz, %i.dc             ; 2 uses
  %16 = fadd float %i.cu, %i.ct
  %foldExtExtBinop292 = fadd <2 x float> %15, %foldExtExtBinop290
  %i.et = insertelement <2 x float> poison, float %13, i64 0
  ...
  %17 = fmul float %i.ex, 0.000000e+00
  %i.ey = fmul float %13, 0.000000e+00
  %i.ez = fmul float %i.ea, 0.000000e+00          ; 2 uses
  %i.fa = fsub float %14, %16                     ; 2 uses
  %i.fb = fmul float %i.fa, 0.000000e+00
  %shift294 = shufflevector <2 x float> %15, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop295 = fsub <2 x float> %shift294, %foldExtExtBinop292
  %18 = extractelement <2 x float> %foldExtExtBinop295, i64 0 ; 2 uses
  %19 = fsub float %17, %i.ey
  ...
  %20 = fsub float %8, %i.ez
  %i.ff = fmul float %18, 0.000000e+00            ; 2 uses
  %21 = fadd float %18, %i.ed                     ; 2 uses
  %i.fg = fmul <2 x float> %i.eq, %i.fe
  %22 = fadd float %i.fa, %19                     ; 2 uses
  %23 = fadd float %i.ff, %20                     ; 2 uses
  %24 = extractelement <2 x float> %i.fe, i64 0
  %25 = fmul float %13, %24
  %i.fh = fmul float %i.ex, %22
  %i.fi = insertelement <2 x float> poison, float %i.fh, i64 0
  %i.fj = insertelement <2 x float> %i.fi, float %25, i64 1
  %i.fk = fsub <2 x float> %i.fg, %i.fj
  %i.fl = fmul <2 x float> %i.fk, splat (float 2.000000e+00)
  %i.fm = fadd <2 x float> %i.fl, <float 0.000000e+00, float 1.000000e+00> ; 3 uses
  %26 = fsub float %i.ez, %i.eb
  %27 = fadd float %i.ff, %26                     ; 2 uses
  %i.fn = fmul float %13, %22
  %i.fo = fmul float %i.ea, %23
  %shift297 = shufflevector <2 x float> %i.fe, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop298 = fmul <2 x float> %i.eq, %shift297
  %28 = extractelement <2 x float> %foldExtExtBinop298, i64 0
  %i.fp = fmul float %i.eb, %21
  %29 = fsub float %i.fn, %28
  %i.fq = fsub float %i.fo, %i.fp
  %i.fr = insertelement <2 x float> poison, float %27, i64 0
  %i.fs = insertelement <2 x float> %i.fr, float %21, i64 1
  %i.ft = fmul <2 x float> %i.dy, %i.fs
  %i.fu = insertelement <2 x float> poison, float %23, i64 0
  %i.fv = insertelement <2 x float> %i.fu, float %27, i64 1
  %i.fw = fmul <2 x float> %i.dz, %i.fv
  %i.fx = fsub <2 x float> %i.ft, %i.fw
  %i.fy = insertelement <2 x float> poison, float %i.fq, i64 0
  %i.fz = insertelement <2 x float> %i.fy, float %29, i64 1
  ...
  %i.ge = fmul <2 x float> %i.fm, %i.gd
  %i.gf = shufflevector <2 x float> %i.fm, <2 x float> %i.gd, <2 x i32> <i32 1, i32 2>
  ...
  %foldExtExtBinop304 = fmul <2 x float> %i.fm, %shift303
...
b3GetJointSim.exit:                               ; preds = %bb.d, %bb.e
  ...
  %i.ak = load <2 x float>, ptr %i.aj, align 4    ; 5 uses
  %i.al = getelementptr inbounds nuw i8, ptr %3, i64 20
  %i.am = load <2 x float>, ptr %i.al, align 4    ; 5 uses
  %.sroa.03.4.vec.extract.i.i.i.a = extractelement <2 x float> %.sroa.0109.0.copyload, i64 1 ; 2 uses
  %.sroa.011.0.vec.extract.i.i.i.a = extractelement <2 x float> %i.ak, i64 0
  %5 = fmul float %.sroa.03.4.vec.extract.i.i.i.a, %.sroa.011.0.vec.extract.i.i.i.a
  %shift = shufflevector <2 x float> %i.ak, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop = fmul <2 x float> %.sroa.0109.0.copyload, %shift
  ...
  %foldExtExtBinop234 = fmul <2 x float> %.sroa.096.0.copyload, %i.aw
  %foldExtExtBinop236 = fmul <2 x float> %.sroa.0109.0.copyload, %i.am
  ...
  %i.bf = shufflevector <2 x float> %foldExtExtBinop236, <2 x float> %foldExtExtBinop234, <2 x i32> <i32 0, i32 2>
  %i.bg = fsub <2 x float> %i.bf, %i.be
  %foldExtExtBinop238 = fmul <2 x float> %.sroa.096.0.copyload, %i.aw
  %7 = fmul float %.sroa.03.4.vec.extract.i.i.i.a, %.sroa.3.12.vec.extract.i.i
  ...
  %8 = load <2 x float>, ptr %3, align 8, !tbaa !9
  %9 = fadd float %i.ba, %i.az                    ; 2 uses
  %10 = shufflevector <2 x float> %i.ak, <2 x float> %i.am, <4 x i32> <i32 0, i32 2, i32 2, i32 1>
  %11 = shufflevector <2 x float> %i.bi, <2 x float> %i.bs, <4 x i32> <i32 poison, i32 0, i32 2, i32 poison>
  %12 = insertelement <4 x float> poison, float %i.ap, i64 0
  %13 = shufflevector <4 x float> %12, <4 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 0>
  %14 = shufflevector <4 x float> %13, <4 x float> %11, <4 x i32> <i32 0, i32 5, i32 6, i32 3>
  %15 = fmul <4 x float> %10, %14                 ; 2 uses
  %16 = shufflevector <4 x float> %15, <4 x float> poison, <2 x i32> <i32 3, i32 2>
  %17 = shufflevector <4 x float> %15, <4 x float> poison, <2 x i32> <i32 1, i32 0>
  %i.by = fsub <2 x float> %16, %17
  %i.bz = fmul <2 x float> %i.by, splat (float 2.000000e+00)
  %i.ca = fadd <2 x float> %.sroa.0109.0.copyload, %i.bz
  %i.cb = fadd <2 x float> %8, %i.ca              ; 7 uses
  %i.cc = shufflevector <2 x float> %i.au, <2 x float> %i.aw, <2 x i32> <i32 1, i32 2>
  %i.cd = insertelement <2 x float> %i.bs, float %9, i64 0
  ...
  %i.ch = insertelement <2 x float> %i.cf, float %9, i64 1
