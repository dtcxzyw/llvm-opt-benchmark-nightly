...
"_ZSt8count_ifIN9__gnu_cxx17__normal_iteratorIPKN9benchmark17BenchmarkReporter3RunESt6vectorIS4_SaIS4_EEEEZNS2_12ComputeStatsERKS9_E3$_0ENSt15iterator_traitsIT_E15difference_typeESF_SF_T0_.exit": ; preds = %.lr.ph.i.i, %bb.a
  ...
  %i.l = sdiv exact i64 %i.k, 592                 ; 3 uses
...
bb.b:                                             ; preds = %"_ZSt8count_ifIN9__gnu_cxx17__normal_iteratorIPKN9benchmark17BenchmarkReporter3RunESt6vectorIS4_SaIS4_EEEEZNS2_12ComputeStatsERKS9_E3$_0ENSt15iterator_traitsIT_E15difference_typeESF_SF_T0_.exit"
  ...
  %10 = icmp slt i64 %i.k, 0
  br i1 %10, label %.invoke, label %bb.c
...
.noexc106:                                        ; preds = %_ZNSt12_Vector_baseIdSaIdEE11_M_allocateEm.exit.i
  %i.t = load ptr, ptr %5, align 8, !tbaa !22     ; 4 uses
  %i.u = load ptr, ptr %i.q, align 8, !tbaa !21
  %i.v = ptrtoint ptr %i.u to i64
  %i.w = ptrtoint ptr %i.t to i64                 ; 2 uses
  %i.x = sub i64 %i.v, %i.w                       ; 2 uses
  %i.y = icmp sgt i64 %i.x, 0
  br i1 %i.y, label %bb.d, label %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i
...
bb.e:                                             ; preds = %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i
  %i.z = load ptr, ptr %i.o, align 8, !tbaa !94
  %i.aa = ptrtoint ptr %i.z to i64
  %i.ab = sub i64 %i.aa, %i.w
  tail call void @_ZdlPvm(ptr noundef nonnull %i.t, i64 noundef %i.ab) #27
...
_ZNSt6vectorIdSaIdEE7reserveEm.exit:              ; preds = %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i, %bb.e
  store ptr %i.s, ptr %5, align 8, !tbaa !22
  store ptr %i.s, ptr %i.q, align 8, !tbaa !21
  %i.ac = getelementptr inbounds nuw [8 x i8], ptr %i.s, i64 %i.l
  store ptr %i.ac, ptr %i.o, align 8, !tbaa !94
  ...
  %.pre376 = sub i64 %.pre373, %.pre374           ; 2 uses
  %.pre378472 = udiv exact i64 %.pre376, 592      ; 3 uses
  %11 = icmp slt i64 %.pre376, 0
  br i1 %11, label %.invoke, label %bb.f
...
bb.f:                                             ; preds = %_ZNSt6vectorIdSaIdEE7reserveEm.exit
  ...
  %i.af = load ptr, ptr %6, align 8, !tbaa !22
  %i.ag = ptrtoint ptr %i.ae to i64
  %i.ah = ptrtoint ptr %i.af to i64               ; 2 uses
  %i.ai = sub i64 %i.ag, %i.ah
  %i.aj = ashr exact i64 %i.ai, 3
  %i.ak = icmp ult i64 %i.aj, %.pre378472
  br i1 %i.ak, label %_ZNSt12_Vector_baseIdSaIdEE11_M_allocateEm.exit.i107, label %_ZNSt6vectorIdSaIdEE7reserveEm.exit113
...
_ZNSt12_Vector_baseIdSaIdEE11_M_allocateEm.exit.i107: ; preds = %bb.f
  ...
  %i.ap = shl nuw nsw i64 %.pre378472, 3
  %i.aq = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.ap) #26
          to label %.noexc112 unwind label %bb.i  ; 4 uses

.noexc112:                                        ; preds = %_ZNSt12_Vector_baseIdSaIdEE11_M_allocateEm.exit.i107
  %i.ar = load ptr, ptr %6, align 8, !tbaa !22    ; 4 uses
  %i.as = load ptr, ptr %i.al, align 8, !tbaa !21
  %i.at = ptrtoint ptr %i.as to i64
  %i.au = ptrtoint ptr %i.ar to i64               ; 2 uses
  %i.av = sub i64 %i.at, %i.au                    ; 2 uses
  %i.aw = icmp sgt i64 %i.av, 0
  br i1 %i.aw, label %bb.g, label %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i108

bb.g:                                             ; preds = %.noexc112
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.aq, ptr align 8 %i.ar, i64 %i.av, i1 false)
...
_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i108: ; preds = %bb.g, %.noexc112
  %.not.i8.i109 = icmp eq ptr %i.ar, null
...
bb.h:                                             ; preds = %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i108
  %i.ax = load ptr, ptr %i.ad, align 8, !tbaa !94
  %i.ay = ptrtoint ptr %i.ax to i64
  %i.az = sub i64 %i.ay, %i.au
  tail call void @_ZdlPvm(ptr noundef nonnull %i.ar, i64 noundef %i.az) #27
...
_ZNSt12_Vector_baseIdSaIdEE13_M_deallocateEPdm.exit.i110: ; preds = %bb.h, %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i108
  store ptr %i.aq, ptr %6, align 8, !tbaa !22
  %i.ba = getelementptr inbounds nuw i8, ptr %i.aq, i64 %i.ao
  store ptr %i.ba, ptr %i.al, align 8, !tbaa !21
  %i.bb = getelementptr inbounds nuw [8 x i8], ptr %i.aq, i64 %.pre378472
  store ptr %i.bb, ptr %i.ad, align 8, !tbaa !94
...
_ZNSt6vectorIdSaIdEE7reserveEm.exit113:           ; preds = %.thread, %_ZNSt12_Vector_baseIdSaIdEE13_M_deallocateEPdm.exit.i110, %bb.f
  %i.bc = phi ptr [ %i.ad, %_ZNSt12_Vector_baseIdSaIdEE13_M_deallocateEPdm.exit.i110 ], [ %i.ad, %bb.f ], [ %i.p, %.thread ] ; 4 uses
  %i.bd = phi ptr [ %.pre367, %_ZNSt12_Vector_baseIdSaIdEE13_M_deallocateEPdm.exit.i110 ], [ %.pre, %bb.f ], [ %i.e, %.thread ] ; 3 uses
  %i.be = phi ptr [ %.pre366, %_ZNSt12_Vector_baseIdSaIdEE13_M_deallocateEPdm.exit.i110 ], [ %.pre365, %bb.f ], [ %i.c, %.thread ] ; 4 uses
  %i.bf = getelementptr inbounds nuw i8, ptr %i.be, i64 392
  %i.bg = load i64, ptr %i.bf, align 8, !tbaa !52
  call void @llvm.lifetime.start.p0(ptr nonnull %7) #28
  %i.bh = getelementptr inbounds nuw i8, ptr %7, i64 8 ; 17 uses
  store i32 0, ptr %i.bh, align 8, !tbaa !53
  %i.bi = getelementptr inbounds nuw i8, ptr %7, i64 16 ; 5 uses
  store ptr null, ptr %i.bi, align 8, !tbaa !54
  %i.bj = getelementptr inbounds nuw i8, ptr %7, i64 24 ; 2 uses
  store ptr %i.bh, ptr %i.bj, align 8, !tbaa !55
  %i.bk = getelementptr inbounds nuw i8, ptr %7, i64 32
  store ptr %i.bh, ptr %i.bk, align 8, !tbaa !56
  %i.bl = getelementptr inbounds nuw i8, ptr %7, i64 40 ; 3 uses
  store i64 0, ptr %i.bl, align 8, !tbaa !57
  %.not294327 = icmp eq ptr %i.be, %i.bd
...
._crit_edge330:                                   ; preds = %._crit_edge330.loopexit, %_ZNSt6vectorIdSaIdEE7reserveEm.exit113
  %i.bm = phi ptr [ %.pre369, %._crit_edge330.loopexit ], [ %i.bd, %_ZNSt6vectorIdSaIdEE7reserveEm.exit113 ] ; 2 uses
  %i.bn = phi ptr [ %.pre368, %._crit_edge330.loopexit ], [ %i.be, %_ZNSt6vectorIdSaIdEE7reserveEm.exit113 ] ; 3 uses
  %.not295335 = icmp eq ptr %i.bn, %i.bm
...
.lr.ph329:                                        ; preds = %_ZNSt6vectorIdSaIdEE7reserveEm.exit113, %._crit_edge
  %.sroa.0280.0328 = phi ptr [ %i.bu, %._crit_edge ], [ %i.be, %_ZNSt6vectorIdSaIdEE7reserveEm.exit113 ] ; 3 uses
...
._crit_edge:                                      ; preds = %_ZNSt6vectorIdSaIdEE7reserveEm.exit126, %.lr.ph329
  ...
  %.not294 = icmp eq ptr %i.bu, %i.bd
  br i1 %.not294, label %._crit_edge330.loopexit, label %.lr.ph329

.lr.ph:                                           ; preds = %.lr.ph329, %_ZNSt6vectorIdSaIdEE7reserveEm.exit126
  %.sroa.0276.0324 = phi ptr [ %i.gc, %_ZNSt6vectorIdSaIdEE7reserveEm.exit126 ], [ %i.bs, %.lr.ph329 ] ; 5 uses
  ...
  %.val.i.i = load ptr, ptr %i.bi, align 8, !tbaa !54 ; 3 uses
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph, %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i
  ...
  %.083.i.i.i = phi ptr [ %.19.i.i.i, %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i ], [ %i.bh, %.lr.ph ] ; 3 uses
...
_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_ZN9benchmark12ComputeStatsERKSt6vectorINS8_17BenchmarkReporter3RunESaISB_EEE11CounterStatESt10_Select1stISH_ESt4lessIS5_ESaISH_EE14_M_lower_boundEPSt13_Rb_tree_nodeISH_EPSt18_Rb_tree_node_baseRS7_.exit.i.i: ; preds = %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i
  %i.cg = icmp eq ptr %.19.i.i.i, %i.bh
...
.lr.ph.i.i.i.i:                                   ; preds = %_ZNSt3mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEZN9benchmark12ComputeStatsERKSt6vectorINS6_17BenchmarkReporter3RunESaIS9_EEE11CounterStatSt4lessIS5_ESaISt4pairIKS5_SE_EEE4findERSI_.exit.thread, %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i.i
  ...
  %.083.i.i.i.i = phi ptr [ %.19.i.i.i.i, %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i.i ], [ %i.bh, %_ZNSt3mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEZN9benchmark12ComputeStatsERKSt6vectorINS6_17BenchmarkReporter3RunESaIS9_EEE11CounterStatSt4lessIS5_ESaISt4pairIKS5_SE_EEE4findERSI_.exit.thread ] ; 3 uses
...
_ZNSt3mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEZN9benchmark12ComputeStatsERKSt6vectorINS6_17BenchmarkReporter3RunESaIS9_EEE11CounterStatSt4lessIS5_ESaISt4pairIKS5_SE_EEE11lower_boundERSI_.exit.i: ; preds = %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i.i
  %i.cw = icmp eq ptr %.19.i.i.i.i, %i.bh
...
.thread.i.i.i:                                    ; preds = %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i.i.i, %bb.s
  ...
  call void @_ZSt29_Rb_tree_insert_and_rebalancebPSt18_Rb_tree_node_baseS0_RS_(i1 noundef zeroext %i.el, ptr noundef nonnull %i.dd, ptr noundef nonnull %i.eb, ptr noundef nonnull align 8 dereferenceable(32) %i.bh) #28
  %i.em = load i64, ptr %i.bl, align 8, !tbaa !57
  %i.en = add i64 %i.em, 1
  store i64 %i.en, ptr %i.bl, align 8, !tbaa !57
...
_ZZN9benchmark12ComputeStatsERKSt6vectorINS_17BenchmarkReporter3RunESaIS2_EEEN11CounterStatD2Ev.exit: ; preds = %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i, %.thread.i.i.i, %_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_ZN9benchmark12ComputeStatsERKSt6vectorINS8_17BenchmarkReporter3RunESaISB_EEE11CounterStatESt10_Select1stISH_ESt4lessIS5_ESaISH_EE12_M_drop_nodeEPSt13_Rb_tree_nodeISH_E.exit.i.i.i.i
  ...
  %i.ey = sdiv exact i64 %i.ex, 592               ; 3 uses
  %12 = icmp slt i64 %i.ex, 0
...
bb.v:                                             ; preds = %_ZZN9benchmark12ComputeStatsERKSt6vectorINS_17BenchmarkReporter3RunESaIS2_EEEN11CounterStatD2Ev.exit
  %i.ez = getelementptr inbounds nuw i8, ptr %.sroa.027.0.i, i64 96 ; 3 uses
  %i.fa = load ptr, ptr %i.ez, align 8, !tbaa !94
  %i.fb = load ptr, ptr %i.es, align 8, !tbaa !22
  %i.fc = ptrtoint ptr %i.fa to i64
  %i.fd = ptrtoint ptr %i.fb to i64               ; 2 uses
  %i.fe = sub i64 %i.fc, %i.fd
  %i.ff = ashr exact i64 %i.fe, 3
  %i.fg = icmp ult i64 %i.ff, %i.ey
  br i1 %i.fg, label %_ZNSt12_Vector_baseIdSaIdEE11_M_allocateEm.exit.i120, label %_ZNSt6vectorIdSaIdEE7reserveEm.exit126

_ZNSt12_Vector_baseIdSaIdEE11_M_allocateEm.exit.i120: ; preds = %bb.v
  %i.fh = getelementptr inbounds nuw i8, ptr %.sroa.027.0.i, i64 88 ; 3 uses
  %i.fi = load ptr, ptr %i.fh, align 8, !tbaa !21
  %i.fj = ptrtoint ptr %i.fi to i64
  %i.fk = sub i64 %i.fj, %i.fd
  %i.fl = shl nuw nsw i64 %i.ey, 3
...
.noexc125:                                        ; preds = %_ZNSt12_Vector_baseIdSaIdEE11_M_allocateEm.exit.i120
  %i.fn = load ptr, ptr %i.es, align 8, !tbaa !22 ; 4 uses
  %i.fo = load ptr, ptr %i.fh, align 8, !tbaa !21
  %i.fp = ptrtoint ptr %i.fo to i64
  %i.fq = ptrtoint ptr %i.fn to i64               ; 2 uses
  %i.fr = sub i64 %i.fp, %i.fq                    ; 2 uses
  %i.fs = icmp sgt i64 %i.fr, 0
  br i1 %i.fs, label %bb.w, label %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i121

bb.w:                                             ; preds = %.noexc125
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.fm, ptr align 8 %i.fn, i64 %i.fr, i1 false)
...
_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i121: ; preds = %bb.w, %.noexc125
  %.not.i8.i122 = icmp eq ptr %i.fn, null
...
bb.x:                                             ; preds = %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i121
  %i.ft = load ptr, ptr %i.ez, align 8, !tbaa !94
  %i.fu = ptrtoint ptr %i.ft to i64
  %i.fv = sub i64 %i.fu, %i.fq
  call void @_ZdlPvm(ptr noundef nonnull %i.fn, i64 noundef %i.fv) #27
...
_ZNSt12_Vector_baseIdSaIdEE13_M_deallocateEPdm.exit.i123: ; preds = %bb.x, %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i121
  store ptr %i.fm, ptr %i.es, align 8, !tbaa !22
  %i.fw = getelementptr inbounds nuw i8, ptr %i.fm, i64 %i.fk
  store ptr %i.fw, ptr %i.fh, align 8, !tbaa !21
  %i.fx = getelementptr inbounds nuw [8 x i8], ptr %i.fm, i64 %i.ey
  store ptr %i.fx, ptr %i.ez, align 8, !tbaa !94
...
_ZZN9benchmark12ComputeStatsERKSt6vectorINS_17BenchmarkReporter3RunESaIS2_EEEN11CounterStatD2Ev.exit128: ; preds = %bb.y, %bb.o
  %eh.lpad-body = phi { ptr, i32 } [ %i.fy, %bb.y ], [ %i.dq, %bb.o ]
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.0271)
  br label %bb.cg
...
bb.z:                                             ; preds = %_ZNSt3mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEZN9benchmark12ComputeStatsERKSt6vectorINS6_17BenchmarkReporter3RunESaIS9_EEE11CounterStatSt4lessIS5_ESaISt4pairIKS5_SE_EEE4findERSI_.exit
  %i.fz = load atomic i8, ptr @_ZGVZN9benchmark8internal18GetNullLogInstanceEvE8null_log acquire, align 8
  %i.ga = icmp eq i8 %i.fz, 0
  br i1 %i.ga, label %bb.aa, label %_ZNSt6vectorIdSaIdEE7reserveEm.exit126, !prof !95

bb.aa:                                            ; preds = %bb.z
  %i.gb = call i32 @__cxa_guard_acquire(ptr nonnull @_ZGVZN9benchmark8internal18GetNullLogInstanceEvE8null_log) #28
...
_ZNSt6vectorIdSaIdEE7reserveEm.exit126:           ; preds = %bb.ab, %bb.aa, %bb.z, %_ZNSt12_Vector_baseIdSaIdEE13_M_deallocateEPdm.exit.i123, %bb.v
  %i.gc = call noundef ptr @_ZSt18_Rb_tree_incrementPKSt18_Rb_tree_node_base(ptr noundef %.sroa.0276.0324) #30 ; 2 uses
  %.not300 = icmp eq ptr %i.gc, %i.bt
...
._crit_edge339:                                   ; preds = %._crit_edge339.loopexit, %._crit_edge330
  %i.gd = phi ptr [ %.pre370, %._crit_edge339.loopexit ], [ %i.bn, %._crit_edge330 ] ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %8) #28
  %i.ge = getelementptr inbounds nuw i8, ptr %i.gd, i64 320
  ...
  %i.gh = getelementptr inbounds nuw i8, ptr %i.gd, i64 328
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2ERKS4_.exit: ; preds = %._crit_edge.i.i, %bb.ac, %bb.ad
  ...
  %i.gx = sdiv exact i64 %i.gw, 592               ; 3 uses
  %i.gy = icmp ugt i64 %i.gw, 592
...
.lr.ph341:                                        ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2ERKS4_.exit
  ...
  %umax = call i64 @llvm.umax.i64(i64 %i.gx, i64 2)
  %i.hb = icmp eq i64 %i.gz, 0
  br label %bb.bb

bb.ae:                                            ; preds = %.lr.ph338, %.loopexit
  %.sroa.0268.0336 = phi ptr [ %i.bn, %.lr.ph338 ], [ %i.li, %.loopexit ] ; 6 uses
...
bb.aj:                                            ; preds = %_ZN9benchmark8internal18GetNullLogInstanceEv.exit133
  ...
  %i.hm = load ptr, ptr %i.o, align 8, !tbaa !94
...
bb.an:                                            ; preds = %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit16.i.i
  %i.if = load ptr, ptr %i.o, align 8, !tbaa !94
...
_ZNSt6vectorIdSaIdEE17_M_realloc_insertIJRKdEEEvN9__gnu_cxx17__normal_iteratorIPdS1_EEDpOT_.exit.i: ; preds = %bb.an, %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit16.i.i
  ...
  store ptr %i.ii, ptr %i.o, align 8, !tbaa !94
  br label %_ZNSt6vectorIdSaIdEE12emplace_backIJRKdEEERdDpOT_.exit
...
_ZNSt6vectorIdSaIdEE12emplace_backIJRKdEEERdDpOT_.exit: ; preds = %_ZNSt6vectorIdSaIdEE17_M_realloc_insertIJRKdEEEvN9__gnu_cxx17__normal_iteratorIPdS1_EEDpOT_.exit.i, %bb.ak
  ...
  %i.il = load ptr, ptr %i.bc, align 8, !tbaa !94
...
bb.ar:                                            ; preds = %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit16.i.i142
  %i.je = load ptr, ptr %i.bc, align 8, !tbaa !94
...
_ZNSt6vectorIdSaIdEE17_M_realloc_insertIJRKdEEEvN9__gnu_cxx17__normal_iteratorIPdS1_EEDpOT_.exit.i144: ; preds = %bb.ar, %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit16.i.i142
  ...
  store ptr %i.jh, ptr %i.bc, align 8, !tbaa !94
  br label %_ZNSt6vectorIdSaIdEE12emplace_backIJRKdEEERdDpOT_.exit147
...
_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_ZN9benchmark12ComputeStatsERKSt6vectorINS8_17BenchmarkReporter3RunESaISB_EEE11CounterStatESt10_Select1stISH_ESt4lessIS5_ESaISH_EE14_M_lower_boundEPSt13_Rb_tree_nodeISH_EPSt18_Rb_tree_node_baseRS7_.exit.i.i163: ; preds = %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i156
  %i.jv = icmp eq ptr %.19.i.i.i158, %i.bh
...
_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i167: ; preds = %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.thread.i.i.i.i.i171, %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i165
  ...
  %spec.select.i.i169 = select i1 %i.kb, ptr %i.bh, ptr %.19.i.i.i158
...
_ZNSt3mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEZN9benchmark12ComputeStatsERKSt6vectorINS6_17BenchmarkReporter3RunESaIS9_EEE11CounterStatSt4lessIS5_ESaISt4pairIKS5_SE_EEE4findERSI_.exit179: ; preds = %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i167, %_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_ZN9benchmark12ComputeStatsERKSt6vectorINS8_17BenchmarkReporter3RunESaISB_EEE11CounterStatESt10_Select1stISH_ESt4lessIS5_ESaISH_EE14_M_lower_boundEPSt13_Rb_tree_nodeISH_EPSt18_Rb_tree_node_baseRS7_.exit.i.i163, %.lr.ph334
  %.sroa.0.0.i.i170 = phi ptr [ %i.bh, %.lr.ph334 ], [ %i.bh, %_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_ZN9benchmark12ComputeStatsERKSt6vectorINS8_17BenchmarkReporter3RunESaISB_EEE11CounterStatESt10_Select1stISH_ESt4lessIS5_ESaISH_EE14_M_lower_boundEPSt13_Rb_tree_nodeISH_EPSt18_Rb_tree_node_baseRS7_.exit.i.i163 ], [ %spec.select.i.i169, %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i167 ] ; 3 uses
...
_ZStneIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EESA_.exit.thread293: ; preds = %bb.bc, %_ZStneIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EESA_.exit
  ...
  %exitcond.not = icmp eq i64 %i.ls, %umax
...
.lr.ph351:                                        ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEPKc.exit
  ...
  %i.ma = sitofp i64 %i.bg to double
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %._crit_edge352, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i
  ...
  %.val102 = load ptr, ptr %i.bi, align 8, !tbaa !54
...
bb.be:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  %i.nn = load ptr, ptr %i.bc, align 8, !tbaa !94
...
bb.bf:                                            ; preds = %_ZNSt6vectorIdSaIdEED2Ev.exit
  %i.ns = load ptr, ptr %i.o, align 8, !tbaa !94
...
_ZN9benchmark13BenchmarkNameaSERKS0_.exit:        ; preds = %.noexc198
  ...
  store i64 %i.ok, ptr %i.mm, align 8, !tbaa !102
  store i64 -1, ptr %i.mn, align 8, !tbaa !103
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_assignERKS4_(ptr noundef nonnull align 8 dereferenceable(32) %i.mo, ptr noundef nonnull align 8 dereferenceable(32) %.sroa.0259.0350)
          to label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSERKS4_.exit unwind label %bb.bm

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSERKS4_.exit: ; preds = %_ZN9benchmark13BenchmarkNameaSERKS0_.exit
  %i.ol = getelementptr inbounds nuw i8, ptr %.sroa.0259.0350, i64 40
  %i.om = load i32, ptr %i.ol, align 8, !tbaa !105
  store i32 %i.om, ptr %i.mp, align 8, !tbaa !71
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_assignERKS4_(ptr noundef nonnull align 8 dereferenceable(32) %i.mq, ptr noundef nonnull align 8 dereferenceable(32) %8)
          to label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSERKS4_.exit202 unwind label %bb.bm
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSERKS4_.exit202: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSERKS4_.exit
  %i.on = load ptr, ptr %i.d, align 8, !tbaa !50
  %i.oo = load ptr, ptr %1, align 8, !tbaa !51
  %i.op = ptrtoint ptr %i.on to i64
  %i.oq = ptrtoint ptr %i.oo to i64
  %i.or = sub i64 %i.op, %i.oq
  %i.os = sdiv exact i64 %i.or, 592
  store i64 %i.os, ptr %i.mr, align 8, !tbaa !52
  %i.ot = getelementptr inbounds nuw i8, ptr %.sroa.0259.0350, i64 32 ; 3 uses
  %i.ou = load ptr, ptr %i.ot, align 8, !tbaa !106
  %i.ov = invoke noundef double %i.ou(ptr noundef nonnull align 8 dereferenceable(24) %5)
          to label %bb.bi unwind label %bb.bm

bb.bi:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSERKS4_.exit202
  store double %i.ov, ptr %i.ms, align 8, !tbaa !107
  %i.ow = load ptr, ptr %i.ot, align 8, !tbaa !106
  %i.ox = invoke noundef double %i.ow(ptr noundef nonnull align 8 dereferenceable(24) %6)
          to label %bb.bj unwind label %bb.bm     ; 2 uses

bb.bj:                                            ; preds = %bb.bi
  store double %i.ox, ptr %i.mt, align 8, !tbaa !108
  %i.oy = load i32, ptr %i.mp, align 8, !tbaa !71
  %i.oz = icmp eq i32 %i.oy, 0
  br i1 %i.oz, label %bb.bk, label %bb.bn

bb.bk:                                            ; preds = %bb.bj
  %i.pa = load <2 x double>, ptr %i.ms, align 8
  %i.pb = insertelement <2 x double> %i.pa, double %i.ox, i64 1
  %i.pc = fmul <2 x double> %i.nh, %i.pb
  store <2 x double> %i.pc, ptr %i.ms, align 8, !tbaa !18
  br label %bb.bn
