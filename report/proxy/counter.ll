...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %.val7 = load i32, ptr %i.f, align 8, !tbaa !23 ; 5 uses
  %4 = trunc i32 %.val7 to i1
  %5 = fdiv double %.val, %2
  %.0.i = select i1 %4, double %5, double %.val   ; 2 uses
  %6 = and i32 %.val7, 2
  %.not.i = icmp eq i32 %6, 0
  %7 = fdiv double %.0.i, %3
  %.0.i.a = select i1 %.not.i, double %.0.i, double %7 ; 2 uses
  %8 = and i32 %.val7, 4
  %.not15.i = icmp eq i32 %8, 0
  %i.g = fmul double %.0.i.a, %i.d
  %.2.i = select i1 %.not15.i, double %.0.i.a, double %i.g ; 2 uses
  %9 = and i32 %.val7, 8
  %.not16.i = icmp eq i32 %9, 0
  %10 = fdiv double %.2.i, %i.d
  %.3.i = select i1 %.not16.i, double %.2.i, double %10 ; 2 uses
