...
SinCosSeries.exit:                                ; preds = %bb.cf
  ...
  %14 = load <4 x double>, ptr %.19.i.3.1.i, align 8, !tbaa !10 ; 2 uses
  %i.aee = load double, ptr %i.acu, align 8, !tbaa !10
  %i.aef = load double, ptr %i.act, align 8, !tbaa !10
  ...
  %15 = shufflevector <4 x double> %14, <4 x double> poison, <2 x i32> <i32 poison, i32 0>
  %i.aes = insertelement <2 x double> %15, double %i.adu, i64 0
  %i.aet = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.aer, <2 x double> %i.aep, <2 x double> %i.aes)
  %16 = extractelement <4 x double> %14, i64 2
  %i.aeu = call double @llvm.fmuladd.f64(double %i.aef, double %i.ade, double %16)
