...
.preheader:                                       ; preds = %bb.bh
  ...
  %.19.i.119.i.i.a = getelementptr inbounds nuw i8, ptr %0, i64 136
  %.19.i.221.i.i = getelementptr inbounds nuw i8, ptr %0, i64 144
  %14 = load double, ptr %.19.i.i.i296, align 8, !tbaa !8
  %i.pq = load double, ptr %i.pp, align 8, !tbaa !8
  %15 = load double, ptr %.19.i.221.i.i, align 8, !tbaa !8
  %i.pr = load double, ptr %.19.i.119.i.i.a, align 8, !tbaa !8
...
SinCosSeries.exit.i:                              ; preds = %bb.bl, %._crit_edge.i
  ...
  %16 = call double @llvm.fmuladd.f64(double %i.pq, double %i.um, double %14)
  %17 = call double @llvm.fmuladd.f64(double %16, double %i.um, double %i.pr)
  %18 = call double @llvm.fmuladd.f64(double %17, double %i.um, double %15)
