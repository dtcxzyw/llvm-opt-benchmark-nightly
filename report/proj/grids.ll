...
_ZNSt6vectorIfSaIfEE6resizeEm.exit:               ; preds = %._ZNSt6vectorIfSaIfEE6resizeEm.exit_crit_edge, %_ZSt8_DestroyIPffEvT_S1_RSaIT0_E.exit.i.i, %bb.l, %bb.k
  ...
  %i.bt = load ptr, ptr %i.bs, align 8, !tbaa !391 ; 2 uses
  %i.bu = getelementptr inbounds nuw i8, ptr %0, i64 176
  %i.bv = load i64, ptr %i.bu, align 8, !tbaa !392
  %i.bw = sext i32 %2 to i64
  %i.bx = mul i64 %i.br, %i.bw
  %i.by = add i64 %i.bx, %i.bv
  %i.bz = load ptr, ptr %i.bt, align 8, !tbaa !20
  ...
  %i.cd = load ptr, ptr %i.bs, align 8, !tbaa !391 ; 2 uses
  %i.ce = load ptr, ptr %i.am, align 8, !tbaa !72
  %i.cf = load ptr, ptr %i.cd, align 8, !tbaa !20
...
.preheader:                                       ; preds = %_ZNSt6vectorIfSaIfEE6resizeEm.exit
  %i.cj = load i32, ptr %i.an, align 8, !tbaa !32 ; 7 uses
  %i.ck = icmp sgt i32 %i.cj, 1
  %.pre79 = load ptr, ptr %i.am, align 8, !tbaa !72 ; 12 uses
...
bb.q:                                             ; preds = %bb.q, %.epil.preheader
  ...
  %i.cs = load <2 x float>, ptr %i.cq, align 4, !tbaa !37
  store <2 x float> %i.cs, ptr %i.cr, align 4, !tbaa !37
  %indvars.iv.next.epil = add nuw nsw i64 %indvars.iv.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %._crit_edge, label %bb.q, !llvm.loop !393

._crit_edge:                                      ; preds = %._crit_edge.loopexit.unr-lcssa, %bb.q, %.preheader
  %i.ct = shl nsw i32 %i.cj, 1
  %i.cu = sext i32 %i.ct to i64                   ; 4 uses
  %i.cv = load ptr, ptr %i.ar, align 8, !tbaa !121 ; 2 uses
...
bb.r:                                             ; preds = %._crit_edge
  ...
  %.pre81.pre = load i32, ptr %i.an, align 8, !tbaa !32
...
_ZSt8_DestroyIPffEvT_S1_RSaIT0_E.exit.i.i50:      ; preds = %bb.t
  store ptr %i.dd, ptr %i.ar, align 8, !tbaa !121
  br label %_ZNSt6vectorIfSaIfEE6resizeEm.exit51
...
_ZNSt6vectorIfSaIfEE6resizeEm.exit51:             ; preds = %bb.r, %bb.s, %bb.t, %_ZSt8_DestroyIPffEvT_S1_RSaIT0_E.exit.i.i50
  ...
  %i.df = load i8, ptr %i.de, align 8, !tbaa !394, !range !13, !noundef !14
...
bb.u:                                             ; preds = %bb.u, %.lr.ph.new
  ...
  %i.dj = load <2 x float>, ptr %i.dh, align 4, !tbaa !37
  store <2 x float> %i.dj, ptr %i.di, align 4, !tbaa !37
  ...
  %i.dm = load <2 x float>, ptr %i.dk, align 4, !tbaa !37
  store <2 x float> %i.dm, ptr %i.dl, align 4, !tbaa !37
  ...
  %i.dp = load <2 x float>, ptr %i.dn, align 4, !tbaa !37
  store <2 x float> %i.dp, ptr %i.do, align 4, !tbaa !37
  ...
  %i.ds = load <2 x float>, ptr %i.dq, align 4, !tbaa !37
  store <2 x float> %i.ds, ptr %i.dr, align 4, !tbaa !37
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4 ; 2 uses
  %niter.next.3 = add nuw i64 %niter, 4           ; 2 uses
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %._crit_edge.loopexit.unr-lcssa, label %bb.u, !llvm.loop !395
...
.preheader.i.preheader:                           ; preds = %bb.v
  %i.dv = load ptr, ptr %i.am, align 8, !tbaa !72 ; 2 uses
...
.preheader.i.epil:                                ; preds = %.preheader.i.epil, %.preheader.i.epil.preheader
  ...
  %i.el = load <4 x i8>, ptr %.023.i.epil, align 1, !tbaa !31
  %i.em = shufflevector <4 x i8> %i.el, <4 x i8> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  store <4 x i8> %i.em, ptr %.023.i.epil, align 1, !tbaa !31
  %epil.iter120.next = add i64 %epil.iter120, 1   ; 2 uses
  %epil.iter120.cmp.not = icmp eq i64 %epil.iter120.next, 2
  br i1 %epil.iter120.cmp.not, label %_ZN5osgeo4projL10swap_wordsEPvmm.exit.loopexit, label %.preheader.i.epil, !llvm.loop !396
...
_ZN5osgeo4projL10swap_wordsEPvmm.exit.loopexit:   ; preds = %.preheader.i.epil, %_ZN5osgeo4projL10swap_wordsEPvmm.exit.loopexit.unr-lcssa
  %.pre80 = load i32, ptr %i.an, align 8, !tbaa !32
...
.lr.ph66:                                         ; preds = %_ZN5osgeo4projL10swap_wordsEPvmm.exit
  ...
  %i.eq = load ptr, ptr %i.am, align 8, !tbaa !72 ; 6 uses
...
.lr.ph66.new:                                     ; preds = %.lr.ph66
  %6 = and i32 %i.ep, 1073741822
  %unroll_iter130 = zext nneg i32 %6 to i64
  br label %bb.w

._crit_edge67.loopexit.unr-lcssa:                 ; preds = %bb.w
  %lcmp.mod128.not = trunc i32 %i.ep to i1
  br i1 %lcmp.mod128.not, label %.epil.preheader125, label %._crit_edge67
...
.epil.preheader125:                               ; preds = %._crit_edge67.loopexit.unr-lcssa, %.lr.ph66
  ...
  %i.ex = load <2 x float>, ptr %i.et, align 4, !tbaa !37
  %i.ey = load <2 x float>, ptr %i.ew, align 4, !tbaa !37
  store <2 x float> %i.ey, ptr %i.et, align 4, !tbaa !37
  store <2 x float> %i.ex, ptr %i.ew, align 4, !tbaa !37
  br label %._crit_edge67

._crit_edge67:                                    ; preds = %.epil.preheader125, %._crit_edge67.loopexit.unr-lcssa, %bb.v, %_ZN5osgeo4projL10swap_wordsEPvmm.exit
  %i.ez = load ptr, ptr %i.b, align 8, !tbaa !386
  %i.fa = load i32, ptr %i.d, align 8, !tbaa !389
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #31
  %i.fb = zext i32 %i.fa to i64
  %i.fc = shl nuw i64 %i.fb, 32
  %i.fd = or disjoint i64 %i.fc, %i.h
  store i64 %i.fd, ptr %i.a, align 8, !tbaa !30
...
bb.w:                                             ; preds = %bb.w, %.lr.ph66.new
  ...
  %i.fi = load <2 x float>, ptr %i.fe, align 4, !tbaa !37
  %i.fj = load <2 x float>, ptr %i.fh, align 4, !tbaa !37
  store <2 x float> %i.fj, ptr %i.fe, align 4, !tbaa !37
  store <2 x float> %i.fi, ptr %i.fh, align 4, !tbaa !37
  ...
  %i.fp = load <2 x float>, ptr %i.fl, align 4, !tbaa !37
  %i.fq = load <2 x float>, ptr %i.fo, align 4, !tbaa !37
  store <2 x float> %i.fq, ptr %i.fl, align 4, !tbaa !37
  store <2 x float> %i.fp, ptr %i.fo, align 4, !tbaa !37
  ...
  br i1 %niter131.ncmp.1, label %._crit_edge67.loopexit.unr-lcssa, label %bb.w, !llvm.loop !397
...
bb.y:                                             ; preds = %bb.x
  ...
  %i.fy = load ptr, ptr %i.fx, align 8, !tbaa !390
  %i.fz = load ptr, ptr %i.fw, align 8, !tbaa !20
...
bb.ac:                                            ; preds = %_ZN5osgeo4proj14FloatLineCache6insertEjjRKSt6vectorIfSaIfEE.exit, %bb.z, %bb.ab
  ...
  store float %i.gv, ptr %4, align 4, !tbaa !37
  br label %bb.ad
...
bb.a:
  store ptr getelementptr inbounds nuw inrange(-16, 32) (i8, ptr @_ZTVN5osgeo4proj11NTv2GridSetE, i64 16), ptr %0, align 8, !tbaa !20
...
_ZNKSt14default_deleteIN5osgeo4proj4FileEEclEPS2_.exit.i: ; preds = %_ZNSt10unique_ptrIN5osgeo4proj14FloatLineCacheESt14default_deleteIS2_EED2Ev.exit
  ...
  tail call void %i.g(ptr noundef nonnull align 8 dereferenceable(73) %i.d) #31, !inline_history !81
...
_ZNSt10unique_ptrIN5osgeo4proj4FileESt14default_deleteIS2_EED2Ev.exit: ; preds = %_ZNSt10unique_ptrIN5osgeo4proj14FloatLineCacheESt14default_deleteIS2_EED2Ev.exit, %_ZNKSt14default_deleteIN5osgeo4proj4FileEEclEPS2_.exit.i
  store ptr getelementptr inbounds nuw inrange(-16, 32) (i8, ptr @_ZTVN5osgeo4proj22HorizontalShiftGridSetE, i64 16), ptr %0, align 8, !tbaa !20
  %i.h = getelementptr inbounds nuw i8, ptr %0, i64 72 ; 2 uses
  %i.i = load ptr, ptr %i.h, align 8, !tbaa !358  ; 3 uses
...
.lr.ph.i.i.i.i:                                   ; preds = %_ZNSt10unique_ptrIN5osgeo4proj4FileESt14default_deleteIS2_EED2Ev.exit, %_ZSt8_DestroyISt10unique_ptrIN5osgeo4proj19HorizontalShiftGridESt14default_deleteIS3_EEEvPT_.exit.i.i.i.i
  ...
  %i.l = load ptr, ptr %.05.i.i.i.i, align 8, !tbaa !362 ; 3 uses
...
_ZNKSt14default_deleteIN5osgeo4proj19HorizontalShiftGridEEclEPS2_.exit.i.i.i.i.i.i: ; preds = %.lr.ph.i.i.i.i
  ...
  tail call void %i.o(ptr noundef nonnull align 8 dereferenceable(144) %i.l) #31, !inline_history !398
...
_ZSt8_DestroyISt10unique_ptrIN5osgeo4proj19HorizontalShiftGridESt14default_deleteIS3_EEEvPT_.exit.i.i.i.i: ; preds = %_ZNKSt14default_deleteIN5osgeo4proj19HorizontalShiftGridEEclEPS2_.exit.i.i.i.i.i.i, %.lr.ph.i.i.i.i
  ...
  br i1 %.not.i.i.i.i, label %_ZSt8_DestroyIPSt10unique_ptrIN5osgeo4proj19HorizontalShiftGridESt14default_deleteIS3_EES6_EvT_S8_RSaIT0_E.exitthread-pre-split.i.i, label %.lr.ph.i.i.i.i, !llvm.loop !365
...
_ZSt8_DestroyIPSt10unique_ptrIN5osgeo4proj19HorizontalShiftGridESt14default_deleteIS3_EES6_EvT_S8_RSaIT0_E.exitthread-pre-split.i.i: ; preds = %_ZSt8_DestroyISt10unique_ptrIN5osgeo4proj19HorizontalShiftGridESt14default_deleteIS3_EEEvPT_.exit.i.i.i.i
  %.pr.i.i = load ptr, ptr %i.h, align 8, !tbaa !358
