...
bb.j:                                             ; preds = %bb.f, %bb.g, %bb.i
  %.sroa.046.0 = phi double [ %i.z, %bb.g ], [ 1.000000e+00, %bb.i ], [ 0.000000e+00, %bb.f ] ; 2 uses
...
bb.o:                                             ; preds = %bb.k, %bb.l, %bb.n
  %.sroa.9.0 = phi double [ %i.ab, %bb.l ], [ 1.000000e+00, %bb.n ], [ 0.000000e+00, %bb.k ] ; 2 uses
...
bb.s:                                             ; preds = %bb.r
  %i.bm = fsub double 1.000000e+00, %.sroa.046.0
  %i.bn = fsub double 1.000000e+00, %.sroa.9.0
  ...
  %4 = insertelement <4 x double> poison, double %.sroa.046.0, i64 0
  %5 = insertelement <4 x double> %4, double %i.bm, i64 1
  %6 = shufflevector <4 x double> %5, <4 x double> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 0>
  %7 = insertelement <4 x double> poison, double %.sroa.9.0, i64 0
  %8 = insertelement <4 x double> %7, double %i.bn, i64 2
  %9 = shufflevector <4 x double> %8, <4 x double> poison, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %10 = fmul <4 x double> %6, %9                  ; 4 uses
  %i.bw = insertelement <2 x float> poison, float %i.bo, i64 0
  %i.bx = insertelement <2 x float> %i.bw, float %i.bs, i64 1
  %i.by = fpext <2 x float> %i.bx to <2 x double>
  %11 = insertelement <2 x float> poison, float %i.bp, i64 0
  %12 = insertelement <2 x float> %11, float %i.bt, i64 1
  %13 = fpext <2 x float> %12 to <2 x double>
  %14 = shufflevector <4 x double> %10, <4 x double> poison, <2 x i32> <i32 3, i32 3>
  %15 = fmul <2 x double> %14, %13
  %16 = shufflevector <4 x double> %10, <4 x double> poison, <2 x i32> <i32 2, i32 2>
  %i.bz = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %16, <2 x double> %i.by, <2 x double> %15)
  ...
  %17 = shufflevector <4 x double> %10, <4 x double> poison, <2 x i32> <i32 1, i32 1>
  ...
  %i.ch = shufflevector <4 x double> %10, <4 x double> poison, <2 x i32> zeroinitializer
...
bb.x:                                             ; preds = %bb.w
  ...
  %i.cz = fsub double %.0114, %i.cy               ; 2 uses
  %i.da = sitofp i32 %i.an to double
  %i.db = fsub double %i.al, %i.da                ; 2 uses
  %i.dc = fsub double 1.000000e+00, %i.cz
  %i.dd = fsub double 1.000000e+00, %i.db
  ...
  %10 = insertelement <4 x double> poison, double %i.cz, i64 0
  %11 = insertelement <4 x double> %10, double %i.dc, i64 1
  %12 = shufflevector <4 x double> %11, <4 x double> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 0>
  %13 = insertelement <4 x double> poison, double %i.db, i64 0
  %14 = insertelement <4 x double> %13, double %i.dd, i64 1
  %15 = shufflevector <4 x double> %14, <4 x double> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 1>
  %16 = fmul <4 x double> %12, %15                ; 8 uses
  %17 = extractelement <4 x double> %16, i64 3
  %i.du = fmul double %17, %i.dh
  %18 = extractelement <4 x double> %16, i64 2
  %i.dv = call double @llvm.fmuladd.f64(double %18, double %i.df, double %i.du)
  %19 = extractelement <4 x double> %16, i64 1
  %i.dw = call double @llvm.fmuladd.f64(double %19, double %i.dj, double %i.dv)
  %20 = extractelement <4 x double> %16, i64 0
  %i.dx = call double @llvm.fmuladd.f64(double %20, double %i.dl, double %i.dw)
  ...
  %21 = shufflevector <4 x double> %16, <4 x double> poison, <2 x i32> <i32 3, i32 3>
  %i.ee = fmul <2 x double> %21, %i.ed
  %22 = shufflevector <4 x double> %16, <4 x double> poison, <2 x i32> <i32 2, i32 2>
  %i.ef = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %22, <2 x double> %i.ea, <2 x double> %i.ee)
  ...
  %23 = shufflevector <4 x double> %16, <4 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.ej = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %23, <2 x double> %i.ei, <2 x double> %i.ef)
  ...
  %i.en = shufflevector <4 x double> %16, <4 x double> poison, <2 x i32> zeroinitializer
