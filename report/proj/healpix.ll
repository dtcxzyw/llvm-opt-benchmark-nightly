...
_ZL16get_rotate_indexi.exit.i:                    ; preds = %bb.w, %bb.v, %bb.u, %bb.t, %bb.s, %bb.r, %bb.q, %bb.p, %bb.o, %bb.n, %bb.m, %bb.l, %bb.k, %bb.j
  ...
  %3 = fsub double %.sroa.014.0.i, %.sroa.2136.0.ph.i
  %4 = fsub double %.sroa.3.0.i, %.0.i.i
  ...
  %5 = insertelement <2 x double> poison, double %i.bb, i64 0
  %i.be = insertelement <2 x double> %5, double %i.bd, i64 1
  %i.bf = insertelement <2 x double> poison, double %3, i64 0
  %6 = shufflevector <2 x double> %i.bf, <2 x double> poison, <2 x i32> zeroinitializer
  %i.bg = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.be, <2 x double> %6, <2 x double> zeroinitializer)
  %7 = insertelement <2 x double> poison, double %i.ba, i64 0
  %i.bh = insertelement <2 x double> %7, double %i.bc, i64 1
  %i.bi = insertelement <2 x double> poison, double %4, i64 0
  %i.bj = shufflevector <2 x double> %i.bi, <2 x double> poison, <2 x i32> zeroinitializer
  %i.bk = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bh, <2 x double> %i.bj, <2 x double> %i.bg)
...
_ZL16get_rotate_indexi.exit.i:                    ; preds = %bb.w, %bb.v, %bb.u, %bb.t, %bb.s, %bb.r, %bb.q, %bb.p, %bb.o, %bb.n, %bb.m, %bb.l, %bb.k, %bb.j
  ...
  %5 = insertelement <2 x double> poison, double %i.au, i64 0
  %i.ax = insertelement <2 x double> %5, double %i.aw, i64 1
  %i.ay = insertelement <2 x double> poison, double %3, i64 0
  %6 = shufflevector <2 x double> %i.ay, <2 x double> poison, <2 x i32> zeroinitializer
  %i.az = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ax, <2 x double> %6, <2 x double> zeroinitializer)
  %7 = insertelement <2 x double> poison, double %i.at, i64 0
  %i.ba = insertelement <2 x double> %7, double %i.av, i64 1
  %i.bb = insertelement <2 x double> poison, double %4, i64 0
  %i.bc = shufflevector <2 x double> %i.bb, <2 x double> poison, <2 x i32> zeroinitializer
  %i.bd = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ba, <2 x double> %i.bc, <2 x double> %i.az)
...
_ZL16get_rotate_indexi.exit:                      ; preds = %bb.bd, %bb.bc, %bb.bb, %bb.ba, %bb.az, %bb.ay, %bb.ax, %bb.aw, %bb.av, %bb.au, %bb.at, %bb.as, %bb.ar, %bb.aq, %bb.ap, %bb.ao, %bb.an, %bb.am, %bb.al, %bb.ak, %bb.aj, %bb.ai, %bb.ah, %bb.ag, %bb.af, %bb.ae, %bb.ad, %bb.ac
  ...
  %i.bw = getelementptr inbounds nuw [32 x i8], ptr @_ZL3rot, i64 %.0.i23.sink
  %5 = fsub double %0, %.sroa.2136.0.ph64
  %6 = fsub double %1, %.sroa.30.0.ph62
  %i.bx = sitofp i32 %i.bv to double
  %7 = load <4 x double>, ptr %i.bw, align 16, !tbaa !59 ; 2 uses
  %8 = shufflevector <4 x double> %7, <4 x double> poison, <2 x i32> <i32 0, i32 2>
  %i.by = insertelement <2 x double> poison, double %5, i64 0
  %9 = shufflevector <2 x double> %i.by, <2 x double> poison, <2 x i32> zeroinitializer
  %i.bz = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %8, <2 x double> %9, <2 x double> zeroinitializer)
  %10 = shufflevector <4 x double> %7, <4 x double> poison, <2 x i32> <i32 1, i32 3>
  %i.ca = insertelement <2 x double> poison, double %6, i64 0
  %i.cb = shufflevector <2 x double> %i.ca, <2 x double> poison, <2 x i32> zeroinitializer
  %i.cc = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %10, <2 x double> %i.cb, <2 x double> %i.bz)
  %11 = insertelement <2 x double> <double poison, double -0.000000e+00>, double %i.bx, i64 0
  %i.cd = insertelement <2 x double> <double f0xC002D97C7F3321D2, double poison>, double %spec.select, i64 1
  %12 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %11, <2 x double> <double f0x3FF921FB54442D18, double 0.000000e+00>, <2 x double> %i.cd)
  %i.ce = fadd <2 x double> %12, %i.cc
