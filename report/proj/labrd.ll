...
bb.c:                                             ; preds = %bb.b
  ...
  %4 = fmul double %i.at, %i.cu
  %5 = fdiv double %i.co, %i.cq
  %i.cv = insertelement <2 x double> poison, double %5, i64 0
  %i.cw = insertelement <2 x double> %i.cv, double %4, i64 1
...
bb.a:
  ...
  %5 = load double, ptr %i.c, align 8, !tbaa !43  ; 8 uses
  %6 = fmul double %5, %i.f
  %i.r = fmul double %5, %i.k
  %7 = fmul double %i.r, %i.o
  %8 = fsub double %6, %7
  %9 = fadd double %i.q, %8
  %10 = tail call double @exp(double noundef %9) #8
  %i.s = tail call double @atan(double noundef %10) #8
  %11 = fadd double %i.s, f0xBFE921FB54442D18
  %i.t = fmul double %11, 2.000000e+00            ; 3 uses
  %12 = load double, ptr %3, align 8, !tbaa !42
  %13 = tail call double @cos(double noundef %i.t) #8 ; 3 uses
  %i.u = fmul double %13, %13                     ; 4 uses
  %14 = tail call double @sin(double noundef %i.t) #8 ; 3 uses
  %i.v = fmul double %14, %14                     ; 4 uses
  %15 = fsub double %i.t, %12
  %16 = fmul double %5, %13                       ; 3 uses
  %17 = fmul double %5, 5.000000e-01
  %18 = fmul double %17, %16
  %19 = fmul double %14, %18                      ; 2 uses
  %20 = fmul double %5, %19
  %21 = fneg double %i.v
  %22 = fmul double %5, %16
  %23 = fmul double %5, %22                       ; 2 uses
  %24 = fsub double %i.u, %i.v
  %i.w = fmul double %23, %24
  %i.x = fdiv double %i.w, 6.000000e+00
  %i.y = fmul double %i.u, 5.000000e+00
  %25 = tail call double @llvm.fmuladd.f64(double %i.u, double -1.800000e+01, double %i.v)
  %i.z = fmul double %i.v, %25
  %i.aa = insertelement <2 x double> poison, double %5, i64 0
  %i.ab = shufflevector <2 x double> %i.aa, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.ac = insertelement <2 x double> %i.ab, double %20, i64 1
  %26 = fmul <2 x double> %i.ab, %i.ac
  %i.ad = insertelement <2 x double> poison, double %i.u, i64 0
  %27 = shufflevector <2 x double> %i.ad, <2 x double> poison, <2 x i32> zeroinitializer
  %28 = insertelement <2 x double> <double poison, double 5.000000e+00>, double %i.y, i64 0
  %29 = insertelement <2 x double> poison, double %i.z, i64 0
  %i.ae = insertelement <2 x double> %29, double %21, i64 1
  %30 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %27, <2 x double> %28, <2 x double> %i.ae)
  %i.af = fmul <2 x double> %26, %30
  %i.ag = fdiv <2 x double> %i.af, <double 1.200000e+02, double 1.200000e+01> ; 2 uses
  %i.ah = extractelement <2 x double> %i.ag, i64 0
  %i.ai = fmul double %23, %i.ah
  %i.aj = fmul double %0, %0
  %31 = load double, ptr %i.b, align 8, !tbaa !45 ; 2 uses
  %i.ak = fmul double %0, %31
  ...
  %i.an = insertelement <2 x double> %i.ag, double %i.ai, i64 0
  %32 = insertelement <2 x double> poison, double %i.x, i64 0
  %i.ao = insertelement <2 x double> %32, double %19, i64 1
  %i.ap = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.am, <2 x double> %i.an, <2 x double> %i.ao)
  %i.aq = insertelement <2 x double> poison, double %16, i64 0
  %i.ar = insertelement <2 x double> %i.aq, double %15, i64 1
  ...
  %i.au = insertelement <2 x double> %i.at, double %31, i64 1
  %i.av = fmul <2 x double> %i.au, %i.as          ; 7 uses
  %foldExtExtBinop = fmul <2 x double> %i.av, %i.av
  %33 = fmul <2 x double> %i.av, <double 3.000000e+00, double 1.000000e+00>
  ...
  %i.ba = shufflevector <2 x double> %i.av, <2 x double> %i.ay, <2 x i32> <i32 0, i32 2>
  %i.bb = fmul <2 x double> %i.ba, %i.az
  %34 = load <2 x double>, ptr %4, align 8, !tbaa !63 ; 2 uses
  %i.bc = shufflevector <2 x double> %i.ay, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.bd = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %33, <2 x double> %i.bc, <2 x double> %i.bb) ; 3 uses
  %i.be = shufflevector <2 x double> %34, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  ...
  %i.bi = shufflevector <2 x double> %34, <2 x double> poison, <2 x i32> zeroinitializer
