...
bb.l:                                             ; preds = %bb.d, %bb.d
  ...
  %1 = load <2 x double>, ptr %i.cd, align 8, !tbaa !47
  %2 = tail call reassoc double @llvm.vector.reduce.fadd.v2f64(double -0.000000e+00, <2 x double> %1)
  %i.ce = fmul double %2, 5.000000e-01            ; 2 uses
