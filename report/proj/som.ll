...
.preheader:
  ...
  %i.be = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bd, <2 x double> zeroinitializer, <2 x double> splat (double 1.000000e+00)) ; 4 uses
  %i.bf = extractelement <2 x double> %i.be, i64 1 ; 3 uses
  %1 = extractelement <2 x double> %i.be, i64 0   ; 2 uses
  %2 = fmul double %1, %i.bf
  %3 = extractelement <2 x double> %i.ba, i64 1
  %4 = fdiv double %3, %2
  %5 = tail call double @sqrt(double noundef %4) #8
  %6 = fdiv double %1, %i.bf
  %7 = tail call double @sqrt(double noundef %6) #8
  %8 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bd, <2 x double> splat (double f0x3F990F1ECBBAB00A), <2 x double> splat (double 1.000000e+00)) ; 4 uses
  %i.bg = extractelement <2 x double> %8, i64 1   ; 2 uses
  %9 = extractelement <2 x double> %8, i64 0      ; 2 uses
  %10 = fmul double %i.bg, %9
  %11 = fdiv double %9, %i.bg
  ...
  %12 = fdiv double %i.bj, %10
  %i.bk = tail call double @sqrt(double noundef %12) #8
  %13 = tail call double @sqrt(double noundef %11) #8
  %i.bl = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bd, <2 x double> splat (double f0x3FCA61B9F7154B43), <2 x double> splat (double 1.000000e+00)) ; 4 uses
  %14 = extractelement <2 x double> %i.bl, i64 1  ; 2 uses
  %15 = extractelement <2 x double> %i.bl, i64 0  ; 2 uses
  %16 = fmul double %14, %15
  %17 = extractelement <2 x double> %i.bi, i64 1
  %18 = fdiv double %17, %16
  %i.bm = tail call double @sqrt(double noundef %18) #8
  %19 = fdiv double %15, %14
  %i.bn = tail call double @sqrt(double noundef %19) #8
  %i.bo = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bd, <2 x double> splat (double f0x3FDFFFFFFFFFFFFE), <2 x double> splat (double 1.000000e+00)) ; 4 uses
  %20 = extractelement <2 x double> %i.bo, i64 1  ; 2 uses
  %21 = extractelement <2 x double> %i.bo, i64 0  ; 2 uses
  %22 = fmul double %20, %21
  %23 = fdiv double %21, %20
  %24 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bh, <2 x double> <double f0x3FDFFFFFFFFFFFFE, double f0x3FE96791823AAD2E>, <2 x double> splat (double 1.000000e+00)) ; 2 uses
  %i.bp = extractelement <2 x double> %24, i64 0
  %25 = fdiv double %i.bp, %22
  %26 = tail call double @sqrt(double noundef %25) #8
  %27 = tail call double @sqrt(double noundef %23) #8
  %28 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bd, <2 x double> splat (double f0x3FE96791823AAD2E), <2 x double> splat (double 1.000000e+00)) ; 4 uses
  %29 = extractelement <2 x double> %28, i64 1    ; 2 uses
  %30 = extractelement <2 x double> %28, i64 0    ; 2 uses
  %31 = fmul double %29, %30
  %32 = extractelement <2 x double> %24, i64 1
  %33 = fdiv double %32, %31
  %i.bq = tail call double @sqrt(double noundef %33) #8
  %34 = fdiv double %30, %29
  %i.br = tail call double @sqrt(double noundef %34) #8
  %i.bs = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bd, <2 x double> splat (double f0x3FEF378709A22A80), <2 x double> splat (double 1.000000e+00)) ; 4 uses
  %35 = extractelement <2 x double> %i.bs, i64 1  ; 2 uses
  %36 = extractelement <2 x double> %i.bs, i64 0  ; 2 uses
  %37 = fmul double %35, %36
  %38 = fdiv double %36, %35
  %39 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bh, <2 x double> <double f0x3FEF378709A22A80, double f0x3FB8722191A02D60>, <2 x double> splat (double 1.000000e+00)) ; 2 uses
  %i.bt = extractelement <2 x double> %39, i64 0
  %40 = fdiv double %i.bt, %37
  %41 = tail call double @sqrt(double noundef %40) #8
  %42 = tail call double @sqrt(double noundef %38) #8
  %43 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bd, <2 x double> splat (double f0x3FB8722191A02D60), <2 x double> splat (double 1.000000e+00)) ; 4 uses
  %44 = extractelement <2 x double> %43, i64 1    ; 2 uses
  %45 = extractelement <2 x double> %43, i64 0    ; 2 uses
  %46 = fmul double %44, %45
  %47 = extractelement <2 x double> %39, i64 1
  %48 = fdiv double %47, %46
  %i.bu = tail call double @sqrt(double noundef %48) #8
  %49 = fdiv double %45, %44
  %i.bv = tail call double @sqrt(double noundef %49) #8
  %50 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bd, <2 x double> splat (double f0x3FD61C8864680B58), <2 x double> splat (double 1.000000e+00)) ; 4 uses
  %51 = extractelement <2 x double> %50, i64 1    ; 2 uses
  %52 = extractelement <2 x double> %50, i64 0    ; 2 uses
  %53 = fmul double %51, %52
  %54 = fdiv double %52, %51
  %55 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bh, <2 x double> <double f0x3FD61C8864680B58, double f0x3FE4F1BBCDCBFA54>, <2 x double> splat (double 1.000000e+00)) ; 2 uses
  %56 = extractelement <2 x double> %55, i64 0
  %57 = fdiv double %56, %53
  %i.bw = tail call double @sqrt(double noundef %57) #8
  %58 = tail call double @sqrt(double noundef %54) #8
  %i.bx = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bd, <2 x double> splat (double f0x3FE4F1BBCDCBFA54), <2 x double> splat (double 1.000000e+00)) ; 4 uses
  %59 = extractelement <2 x double> %i.bx, i64 1  ; 2 uses
  %60 = extractelement <2 x double> %i.bx, i64 0  ; 2 uses
  %61 = fmul double %59, %60
  %62 = extractelement <2 x double> %55, i64 1
  %63 = fdiv double %62, %61
  %64 = tail call double @sqrt(double noundef %63) #8
  %65 = fdiv double %60, %59
  %i.by = tail call double @sqrt(double noundef %65) #8
  %66 = tail call double @llvm.fmuladd.f64(double %i.aw, double f0x3FECF1BBCDCBFA53, double 1.000000e+00)
  %67 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bd, <2 x double> splat (double f0x3FECF1BBCDCBFA53), <2 x double> splat (double 1.000000e+00)) ; 4 uses
  %68 = extractelement <2 x double> %67, i64 1    ; 2 uses
  %69 = extractelement <2 x double> %67, i64 0    ; 2 uses
  %70 = fmul double %68, %69
  %71 = fdiv double %66, %70
  %i.bz = tail call double @sqrt(double noundef %71) #8
  %72 = fdiv double %69, %68
  %i.ca = tail call double @sqrt(double noundef %72) #8
  ...
  %i.cl = fmul double %i.an, %i.bw                ; 2 uses
  %foldExtExtBinop = fmul <2 x double> %i.be, %i.be
  %i.cm = extractelement <2 x double> %foldExtExtBinop, i64 0
  %i.cn = shufflevector <2 x double> %i.cb, <2 x double> %50, <2 x i32> <i32 0, i32 2> ; 2 uses
  %i.co = fmul <2 x double> %i.cn, %i.cn
  %i.cp = insertelement <2 x double> %50, double %i.bc, i64 0
  ...
  %i.cz = insertelement <2 x double> poison, double %64, i64 0
  %i.da = insertelement <2 x double> %i.cz, double %i.bz, i64 1
  %i.db = fmul <2 x double> %i.cy, %i.da          ; 4 uses
  %73 = shufflevector <2 x double> %i.bx, <2 x double> %67, <2 x i32> <i32 0, i32 2> ; 2 uses
  %i.dc = fmul <2 x double> %73, %73
  %74 = shufflevector <2 x double> %i.bx, <2 x double> %67, <2 x i32> <i32 1, i32 3>
  %i.dd = fdiv <2 x double> %74, %i.dc
  ...
  %i.ds = insertelement <4 x double> <double poison, double poison, double poison, double 0.000000e+00>, double %i.by, i64 0
  ...
  %i.ec = insertelement <2 x double> <double 2.000000e+00, double poison>, double %5, i64 1
  ...
  %i.ei = insertelement <2 x double> poison, double %41, i64 0
  %i.ej = insertelement <2 x double> %i.ei, double %i.bu, i64 1
  %i.ek = fmul <2 x double> %i.eh, %i.ej          ; 4 uses
  %i.el = shufflevector <2 x double> %i.bs, <2 x double> %43, <2 x i32> <i32 0, i32 2> ; 2 uses
  %i.em = fmul <2 x double> %i.el, %i.el
  %i.en = shufflevector <2 x double> %i.bs, <2 x double> %43, <2 x i32> <i32 1, i32 3>
  ...
  %i.eu = insertelement <2 x double> poison, double %42, i64 0
  ...
  %i.fe = insertelement <4 x double> poison, double %i.bk, i64 0
  %i.ff = insertelement <4 x double> %i.fe, double %i.bm, i64 1
  %i.fg = insertelement <4 x double> %i.ff, double %26, i64 2
  %i.fh = insertelement <4 x double> %i.fg, double %i.bq, i64 3
  %i.fi = fmul <4 x double> %i.fd, %i.fh          ; 5 uses
  %i.fj = shufflevector <2 x double> %8, <2 x double> %i.bl, <2 x i32> <i32 0, i32 2>
  %i.fk = shufflevector <2 x double> %i.bo, <2 x double> %28, <2 x i32> <i32 0, i32 2>
  %i.fl = shufflevector <2 x double> %i.fj, <2 x double> %i.fk, <4 x i32> <i32 0, i32 1, i32 2, i32 3> ; 2 uses
  %i.fm = fmul <4 x double> %i.fl, %i.fl
  %i.fn = shufflevector <2 x double> %8, <2 x double> %i.bl, <2 x i32> <i32 1, i32 3>
  %i.fo = shufflevector <2 x double> %i.bo, <2 x double> %28, <2 x i32> <i32 1, i32 3>
  ...
  %i.fw = insertelement <4 x double> poison, double %13, i64 0
  %i.fx = insertelement <4 x double> %i.fw, double %i.bn, i64 1
  %i.fy = insertelement <4 x double> %i.fx, double %27, i64 2
  ...
  %75 = shufflevector <2 x double> %i.cq, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %76 = insertelement <2 x double> %75, double %i.ct, i64 1
  %77 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.eq, <2 x double> %i.es, <2 x double> %76)
  %78 = insertelement <2 x double> %i.ed, double %i.cl, i64 0 ; 2 uses
  %79 = fmul <2 x double> %78, %78                ; 3 uses
  %80 = fneg <2 x double> %79
  %i.gz = insertelement <2 x double> poison, double %58, i64 0
  %i.ha = insertelement <2 x double> %i.gz, double %7, i64 1
  %i.hb = fmul <2 x double> %77, %i.ha            ; 3 uses
  %i.hc = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.hb, <2 x double> %i.dw, <2 x double> %80) ; 2 uses
  %i.hd = extractelement <2 x double> %i.hc, i64 0
  %i.he = fmul double %i.hd, 2.000000e+00
  %i.hf = shufflevector <2 x double> %i.ex, <2 x double> %79, <2 x i32> <i32 1, i32 2>
  ...
  %i.hm = shufflevector <2 x double> %i.ge, <2 x double> %79, <2 x i32> <i32 3, i32 1>
