...
begin_hunk_0_@_ZL9som_setupP8PJconsts:.preheader
  ...
  %1 = insertelement <2 x double> poison, double %i.aa, i64 0
  %2 = insertelement <2 x double> %1, double %i.e, i64 1
  %3 = insertelement <2 x double> poison, double %i.ab, i64 0
  %i.gh = insertelement <2 x double> %3, double %i.ak, i64 1
  %4 = fmul <2 x double> %2, %i.gh                ; 5 uses
  %5 = shufflevector <2 x double> %4, <2 x double> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  %i.gi = fmul <2 x double> %5, <double f0x3FEC83201D3D2C6D, double f0x3FE6A09E667F3BCD>
  ...
  %6 = shufflevector <2 x double> %4, <2 x double> poison, <7 x i32> <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>
  ...
  %8 = extractelement <2 x double> %4, i64 0      ; 4 uses
  %i.ha = fadd double %8, %i.bz
  %9 = fmul <2 x double> %5, <double 1.000000e+00, double f0x3FEF9B24942FE45C>
  %i.hb = insertelement <2 x double> poison, double %i.bp, i64 0
  %i.hc = insertelement <2 x double> %i.hb, double %i.cb, i64 1
  %i.hd = fmul <2 x double> %9, %i.hc             ; 4 uses
  ...
  %i.hi = shufflevector <2 x double> %4, <2 x double> poison, <2 x i32> zeroinitializer ; 10 uses
  ...
  store double %8, ptr %i.ac, align 8, !tbaa !60
  %i.if = extractelement <2 x double> %i.hf, i64 1
  %i.ig = tail call double @llvm.fmuladd.f64(double %i.ci, double %8, double %i.if)
  %i.ih = fmul double %i.ig, 4.000000e+00
  %i.ii = extractelement <2 x double> %i.hf, i64 0
  %i.ij = tail call double @llvm.fmuladd.f64(double %i.bz, double %8, double %i.ii)
  ...
  %i.jn = shufflevector <2 x double> %4, <2 x double> poison, <7 x i32> zeroinitializer ; 3 uses
