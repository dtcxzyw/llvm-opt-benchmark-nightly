...
_ZNSt11_Deque_baseIdSaIdEE15_M_allocate_mapEm.exit:
  ...
  %2 = load i64, ptr %i.d, align 8, !tbaa !132
  %i.g = sub i64 %2, %i.b
  %i.h = lshr i64 %i.g, 1
...
bb.a:
  ...
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !128  ; 6 uses
  ...
  %i.l = load i64, ptr %i.k, align 8, !tbaa !132  ; 4 uses
  %i.m = shl i64 %i.j, 1
...
_ZNSt11_Deque_baseIdSaIdEE15_M_allocate_mapEm.exit: ; preds = %bb.k
  ...
  %3 = load ptr, ptr %i.c, align 8, !tbaa !128    ; 3 uses
  %4 = load ptr, ptr %i.a, align 8, !tbaa !129
...
bb.o:                                             ; preds = %bb.n
  %i.bb = load ptr, ptr %3, align 8, !tbaa !130
...
_ZSt4copyIPPdS1_ET0_T_S3_S2_.exit24:              ; preds = %bb.m, %bb.n, %bb.o
  ...
  %6 = load i64, ptr %i.k, align 8, !tbaa !132
  %i.bd = shl i64 %6, 3
