...
bb.h:                                             ; preds = %bb.g, %bb.f
  %i.v = sext i8 %i.l to i64
  %i.w = getelementptr inbounds [2 x i8], ptr %i.c, i64 %i.v
  %i.x = load i16, ptr %i.w, align 2, !tbaa !14
  %i.y = and i16 %i.x, 8192
  %.not45 = icmp eq i16 %i.y, 0
...
._crit_edge:                                      ; preds = %bb.i, %bb.h, %bb.c
  %.034.lcssa = phi i64 [ 0, %bb.c ], [ %.03453, %bb.h ], [ %i.z, %bb.i ] ; 2 uses
  %.lcssa = phi ptr [ %spec.select, %bb.c ], [ %i.m, %bb.h ], [ %i.aa, %bb.i ]
...
bb.k:                                             ; preds = %bb.j, %._crit_edge
  %i.ac = add i64 %.034.lcssa, 17
  %i.ad = tail call noalias ptr @calloc(i64 noundef 1, i64 noundef %i.ac) #19 ; 3 uses
  %i.ae = icmp eq ptr %i.ad, null
  br i1 %i.ae, label %bb.m, label %bb.l

bb.l:                                             ; preds = %bb.k
  %i.af = getelementptr inbounds nuw i8, ptr %i.ad, i64 9
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.af, ptr nonnull align 1 %spec.select, i64 %.034.lcssa, i1 false)
  br label %bb.m

bb.m:                                             ; preds = %bb.l, %bb.k, %bb.a
  %.137 = phi ptr [ null, %bb.a ], [ %i.ad, %bb.l ], [ null, %bb.k ]
  ret ptr %.137
}
...
.preheader:                                       ; preds = %bb.a, %bb.e
  %.02127 = phi ptr [ %i.o, %bb.e ], [ %0, %bb.a ] ; 4 uses
  %i.g = getelementptr inbounds nuw i8, ptr %.02127, i64 9 ; 2 uses
...
bb.c:                                             ; preds = %bb.b, %bb.b
  %i.l = getelementptr inbounds nuw i8, ptr %.02127, i64 8
...
bb.c:                                             ; preds = %bb.b, %bb.a
  %.047 = phi ptr [ %i.b, %bb.b ], [ %0, %bb.a ]  ; 3 uses
...
.preheader.i:                                     ; preds = %bb.e, %bb.i
  %.02127.i = phi ptr [ %i.w, %bb.i ], [ %1, %bb.e ] ; 4 uses
  %i.o = getelementptr inbounds nuw i8, ptr %.02127.i, i64 9 ; 2 uses
...
bb.g:                                             ; preds = %bb.f, %bb.f
  %i.t = getelementptr inbounds nuw i8, ptr %.02127.i, i64 8
...
bb.i:                                             ; preds = %bb.h
  %i.w = load ptr, ptr %.02127.i, align 8, !tbaa !9 ; 2 uses
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.ae = getelementptr inbounds nuw i8, ptr %.020.i, i64 9
