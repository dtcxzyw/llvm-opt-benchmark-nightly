...
bb.b:                                             ; preds = %.lr.ph, %bb.d
  ...
  %9 = fsub double %i.at, %i.bc
  %10 = fsub double %i.ay, %i.ap
  ...
  %i.bi = insertelement <2 x double> poison, double %10, i64 0
...
.lr.ph352:                                        ; preds = %.preheader
  ...
  %i.cr = insertelement <2 x double> %i.cq, double %4, i64 1 ; 4 uses
  br label %bb.e
...
bb.ab:                                            ; preds = %._crit_edge353
  ...
  %i.kg = load double, ptr %i.kf, align 8, !tbaa !150 ; 3 uses
  ...
  %i.km = insertelement <2 x double> poison, double %i.kg, i64 0
...
bb.ac:                                            ; preds = %bb.ab
  %16 = fsub double %3, %i.kg
  %17 = fsub double %4, %i.kk
  %i.ky = fsub double %i.kk, %i.js
  %18 = insertelement <2 x double> poison, double %17, i64 0
  %19 = shufflevector <2 x double> %18, <2 x double> poison, <2 x i32> zeroinitializer
  %i.kz = fmul <2 x double> %i.kq, %19
  %i.la = insertelement <2 x double> poison, double %i.kl, i64 0
  %20 = insertelement <2 x double> %i.la, double %i.ky, i64 1
  %i.lb = insertelement <2 x double> poison, double %16, i64 0
  %i.lc = shufflevector <2 x double> %i.lb, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ld = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %20, <2 x double> %i.lc, <2 x double> %i.kz)
