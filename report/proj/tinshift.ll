...
bb.b:                                             ; preds = %.lr.ph, %bb.d
  ...
  %i.ay = load double, ptr %i.ax, align 8, !tbaa !92
...
.lr.ph352:                                        ; preds = %.preheader
  ...
  %i.cr = insertelement <2 x double> %i.cq, double %4, i64 1 ; 8 uses
  br label %bb.e
...
bb.ab:                                            ; preds = %._crit_edge353
  ...
  %i.ka = load double, ptr %i.jz, align 8, !tbaa !92 ; 2 uses
  ...
  %i.kg = insertelement <2 x double> poison, double %i.ka, i64 0 ; 2 uses
...
bb.ac:                                            ; preds = %bb.ab
  %15 = insertelement <2 x double> %i.kg, double %i.ke, i64 1
  ...
  %i.kt = fmul <2 x double> %i.kk, %17
  %i.ku = insertelement <2 x double> poison, double %i.kf, i64 0
  %i.kv = insertelement <2 x double> %i.ku, double %i.ks, i64 1
  %i.kw = shufflevector <2 x double> %16, <2 x double> poison, <2 x i32> zeroinitializer
  %i.kx = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.kv, <2 x double> %i.kw, <2 x double> %i.kt)
