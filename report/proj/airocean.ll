...
_Z18get_ico_face_indexPKN12_GLOBAL__N_116pj_airocean_dataEPK6PJ_XYZ.exit: ; preds = %_Z16is_point_in_facePK6PJ_XYZPKN12_GLOBAL__N_17pj_faceE.exit.i
  ...
  %i.cm = getelementptr inbounds nuw [24 x i8], ptr %i.cl, i64 %indvars.iv.i ; 3 uses
  ...
  %i.cr = fmul <2 x double> %i.cq, %9
  %i.cs = shufflevector <2 x double> %i.cp, <2 x double> %i.y, <2 x i32> <i32 0, i32 2>
  %10 = insertelement <2 x double> poison, double %6, i64 0
  %i.ct = shufflevector <2 x double> %10, <2 x double> poison, <2 x i32> zeroinitializer
  %i.cu = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cs, <2 x double> %i.ct, <2 x double> %i.cr)
  %11 = insertelement <2 x double> %i.ab, double %i.co, i64 0
  %i.cv = insertelement <2 x double> poison, double %7, i64 0
  %12 = shufflevector <2 x double> %i.cv, <2 x double> poison, <2 x i32> zeroinitializer
  %i.cw = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %11, <2 x double> %12, <2 x double> %i.cu) ; 2 uses
