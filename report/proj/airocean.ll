...
_Z18get_ico_face_indexPKN12_GLOBAL__N_116pj_airocean_dataEPK6PJ_XYZ.exit: ; preds = %_Z16is_point_in_facePK6PJ_XYZPKN12_GLOBAL__N_17pj_faceE.exit.i
  ...
  %i.cn = getelementptr inbounds nuw [24 x i8], ptr %i.cm, i64 %indvars.iv.i
  ...
  %3 = load <3 x double>, ptr %i.cn, align 8, !tbaa !40, !noalias !73 ; 3 uses
  ...
  %i.cs = fmul <2 x double> %i.cr, %4
  %i.ct = shufflevector <2 x double> %i.cq, <2 x double> %i.y, <2 x i32> <i32 0, i32 3>
  %i.cu = shufflevector <3 x double> %3, <3 x double> poison, <2 x i32> zeroinitializer
  %i.cv = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ct, <2 x double> %i.cu, <2 x double> %i.cs)
  %i.cw = insertelement <2 x double> poison, double %i.cp, i64 0
  %i.cx = insertelement <2 x double> %i.cw, double %i.q, i64 1
  %5 = shufflevector <3 x double> %3, <3 x double> poison, <2 x i32> <i32 2, i32 2>
  %i.cy = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cx, <2 x double> %5, <2 x double> %i.cv) ; 2 uses
