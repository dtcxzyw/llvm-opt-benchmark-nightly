...
bb.d:                                             ; preds = %_Z16is_point_in_facePK6PJ_XYZPKN12_GLOBAL__N_17pj_faceE.exit.thread.i, %bb.c
  ...
  %3 = load double, ptr %i.ae, align 8, !tbaa !57 ; 2 uses
  %i.an = fmul double %i.q, %i.am
  %4 = load double, ptr %i.af, align 8, !tbaa !57 ; 2 uses
  %5 = extractelement <2 x double> %i.aj, i64 1
  %6 = fmul double %5, %i.am
  %7 = extractelement <2 x double> %i.aj, i64 0
  %i.ao = tail call double @llvm.fmuladd.f64(double %7, double %i.ai, double %6)
  %8 = tail call double @llvm.fmuladd.f64(double %i.z, double %i.ai, double %i.an) ; 2 uses
  %i.ap = shufflevector <2 x double> %i.aj, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
  %i.aq = insertelement <2 x double> %i.ap, double %8, i64 0
  %i.ar = fneg <2 x double> %i.aq                 ; 2 uses
  %i.as = insertelement <2 x double> %i.ac, double %3, i64 0
  %i.at = fmul <2 x double> %i.as, %i.ar
  %i.au = insertelement <2 x double> %i.aj, double %i.ao, i64 0
  ...
  %i.ay = tail call noundef double @llvm.fmuladd.f64(double %4, double %i.ax, double %i.aw)
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.bk = tail call double @llvm.fmuladd.f64(double %i.ba, double %8, double %i.bj)
  %i.bl = fmul double %i.be, %i.ab
  %i.bm = tail call double @llvm.fmuladd.f64(double %i.bg, double %i.q, double %i.bl) ; 2 uses
  %i.bn = tail call noundef double @llvm.fmuladd.f64(double %4, double %i.bm, double %i.bk)
