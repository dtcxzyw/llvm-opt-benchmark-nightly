Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/proj/original/rtodms?download=true
...
bb.f:                                             ; preds = %bb.a, %bb.b, %bb.e
  ...
  %.not81.a = icmp eq i32 %i.t, 0
  br i1 %.not81.a, label %bb.h, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.u = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef %.066, i64 noundef %.065, ptr noundef nonnull @_ZL6format, i32 noundef %i.s, i32 noundef %i.p, double noundef %i.k, i32 noundef %.067.a) #6 ; 0 uses
  br label %.critedge
...
bb.i:                                             ; preds = %bb.h
  %.not83 = icmp eq i32 %.067.a, 0                ; 2 uses
  %.neg = select i1 %.not83, i64 -2, i64 -3
  %i.w = select i1 %.not83, i64 2, i64 3          ; 2 uses
  %i.x = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef %.066, i64 noundef %.065, ptr noundef nonnull @_ZL6format, i32 noundef %i.s, i32 noundef %i.p, double noundef %i.k, i32 noundef %.067.a) #6 ; 0 uses
  br label %bb.j
...
bb.s:                                             ; preds = %bb.r
  %i.af = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef %.066, i64 noundef %.065, ptr noundef nonnull @.str.2, i32 noundef %i.s, i32 noundef %i.p, i32 noundef %.067.a) #6 ; 0 uses
  br label %.critedge

bb.t:                                             ; preds = %bb.r
  %i.ag = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef %.066, i64 noundef %.065, ptr noundef nonnull @.str.3, i32 noundef %i.s, i32 noundef %.067.a) #6 ; 0 uses
  br label %.critedge
