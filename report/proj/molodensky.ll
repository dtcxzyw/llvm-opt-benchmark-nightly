...
bb.a:
  ...
  %i.d = tail call double @sin(double noundef %i.c) #8 ; 2 uses
  %i.e = tail call double @cos(double noundef %i.c) #8 ; 2 uses
  ...
  %i.m = load double, ptr %i.k, align 8, !tbaa !42 ; 3 uses
  %i.n = load double, ptr %i.l, align 8, !tbaa !43 ; 2 uses
...
bb.i:                                             ; preds = %_ZL2RNddd.exit
  %3 = fneg double %i.j                           ; 2 uses
  %4 = fmul double %i.h, %3
  %i.az = fmul double %i.h, %i.m
  %5 = fneg double %i.d
  %i.ba = fmul double %i.i, %i.j
  %6 = fmul double %i.i, %i.m
  %7 = insertelement <2 x double> poison, double %i.e, i64 0
  %i.bb = insertelement <2 x double> %7, double %i.d, i64 1 ; 2 uses
  %i.bc = insertelement <2 x double> poison, double %i.m, i64 0
  %i.bd = insertelement <2 x double> %i.bc, double %6, i64 1
  %i.be = fmul <2 x double> %i.bb, %i.bd
  %i.bf = insertelement <2 x double> poison, double %3, i64 0
  %i.bg = insertelement <2 x double> %i.bf, double %i.ba, i64 1
  %8 = shufflevector <2 x double> %i.bb, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  ...
  %i.bj = tail call double @llvm.fmuladd.f64(double %i.n, double %i.h, double %i.bi)
  %i.bk = extractelement <2 x double> %i.p, i64 0
  %i.bl = fsub double %i.bj, %i.bk
  %9 = insertelement <2 x double> %i.p, double %i.az, i64 1
  %10 = insertelement <2 x double> poison, double %i.t, i64 0
  %i.bm = insertelement <2 x double> %10, double %5, i64 1
  %11 = fmul <2 x double> %9, %i.bm
  %i.bn = insertelement <2 x double> poison, double %i.r, i64 0
  %i.bo = insertelement <2 x double> %i.bn, double %4, i64 1
  %12 = shufflevector <2 x double> %i.p, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %i.bp = insertelement <2 x double> %12, double %i.e, i64 1
  %i.bq = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bo, <2 x double> %i.bp, <2 x double> %11) ; 2 uses
  %i.br = extractelement <2 x double> %i.bq, i64 1
  %i.bs = tail call double @llvm.fmuladd.f64(double %i.n, double %i.i, double %i.br)
  %13 = extractelement <2 x double> %i.bq, i64 0  ; 2 uses
  %14 = tail call double @llvm.fmuladd.f64(double %13, double %i.v, double %i.bs)
  %i.bt = insertelement <2 x double> %i.bh, double %14, i64 1
...
bb.a:
  ...
  %i.s = load double, ptr %i.o, align 8, !tbaa !42 ; 3 uses
  %i.t = load double, ptr %i.p, align 8, !tbaa !43 ; 2 uses
  %i.u = load double, ptr %i.q, align 8, !tbaa !44 ; 2 uses
  %i.v = load double, ptr %i.r, align 8, !tbaa !45 ; 2 uses
  %i.w = getelementptr inbounds nuw i8, ptr %2, i64 216
...
bb.k:                                             ; preds = %bb.i
  ...
  %i.bo = fmul double %i.u, %i.bn
  %i.bp = fdiv double %i.bo, %i.m
  %i.bq = fmul double %i.i, %i.n
  %i.br = fmul double %i.i, %i.s
  %i.bs = fmul double %i.d, %i.br
  %i.bt = fneg double %i.m
  %i.bu = fmul double %i.ay, %.0.i65
  %i.bv = fmul double %i.h, %i.bu
  %i.bw = fmul double %i.h, %i.s
  %3 = fmul double %i.bw, %i.bk
  %4 = tail call double @llvm.fmuladd.f64(double %i.bq, double %i.e, double %i.bs)
  %i.bx = tail call double @llvm.fmuladd.f64(double %i.t, double %i.h, double %4)
  %5 = fdiv double %i.bt, %.0.i65
  %i.by = tail call double @llvm.fmuladd.f64(double %5, double %i.u, double %i.bx)
  ...
  %i.ck = tail call double @llvm.fmuladd.f64(double %i.t, double %i.i, double %i.cj)
  %i.cl = fadd double %i.ck, %i.bp
  %i.cm = fmul double %i.e, %i.s
  ...
  %i.cq = insertelement <2 x double> %i.cp, double %i.v, i64 1
