...
begin_hunk_0_@_ZL15yyyymmdd_to_mjdd:bb.a
...
.lr.ph:                                           ; preds = %bb.a, %_ZL12days_in_yearl.exit
  %.054 = phi i32 [ %i.h, %_ZL12days_in_yearl.exit ], [ 45, %bb.a ]
  %.02253 = phi i32 [ %i.i, %_ZL12days_in_yearl.exit ], [ 1859, %bb.a ] ; 5 uses
  %i.c = and i32 %.02253, 3
  %i.d = icmp ne i32 %i.c, 0
  %i.e = urem i32 %.02253, 100
  %.not.i.i = icmp eq i32 %i.e, 0
  %or.cond.i.i = or i1 %i.d, %.not.i.i
  br i1 %or.cond.i.i, label %_ZL12is_leap_yearl.exit.i, label %_ZL12days_in_yearl.exit

_ZL12is_leap_yearl.exit.i:                        ; preds = %.lr.ph
  %i.f = urem i32 %.02253, 400
...
_ZL12days_in_yearl.exit:                          ; preds = %.lr.ph, %_ZL12is_leap_yearl.exit.i
  ...
  %i.h = add i32 %i.g, %.054                      ; 3 uses
  %i.i = add i32 %.02253, 1
  %.not = icmp ugt i32 %i.h, %i.b
  br i1 %.not, label %._crit_edge, label %.lr.ph, !llvm.loop !82

._crit_edge:                                      ; preds = %_ZL12days_in_yearl.exit, %bb.a
  %.022.lcssa = phi i32 [ 1858, %bb.a ], [ %.02253, %_ZL12days_in_yearl.exit ] ; 4 uses
  %.0.lcssa = phi i32 [ 45, %bb.a ], [ %i.h, %_ZL12days_in_yearl.exit ] ; 3 uses
  %i.j = and i32 %.022.lcssa, 3
  %i.k = icmp ne i32 %i.j, 0
  %i.l = urem i32 %.022.lcssa, 100
...
_ZL12days_in_yearl.exit30.split.us:               ; preds = %._crit_edge
  %1 = insertelement <2 x i32> poison, i32 %.022.lcssa, i64 0
  %2 = urem <2 x i32> %1, <i32 400, i32 1>
  %3 = icmp eq <2 x i32> %2, zeroinitializer      ; 2 uses
  %4 = extractelement <2 x i1> %3, i64 0
  %spec.select.i29.neg = select i1 %4, i32 -366, i32 -365
  %5 = add i32 %spec.select.i29.neg, %.0.lcssa    ; 3 uses
  %spec.select.i34.us63 = add i32 %5, 31
...
_ZL13days_in_monthmm.exit42.us.preheader:         ; preds = %_ZL12days_in_yearl.exit30.split.us
  %6 = extractelement <2 x i1> %3, i64 0          ; 2 uses
...
_ZL13days_in_monthmm.exit42.us:                   ; preds = %_ZL13days_in_monthmm.exit42.us.preheader, %_ZL13days_in_monthmm.exit42.us
  %i.m = phi i1 [ %i.x, %_ZL13days_in_monthmm.exit42.us ], [ false, %_ZL13days_in_monthmm.exit42.us.preheader ]
  %i.n = phi i32 [ %i.w, %_ZL13days_in_monthmm.exit42.us ], [ 31, %_ZL13days_in_monthmm.exit42.us.preheader ]
  %.1.us66 = phi i32 [ %i.q, %_ZL13days_in_monthmm.exit42.us ], [ %5, %_ZL13days_in_monthmm.exit42.us.preheader ]
  %.021.us65 = phi i32 [ %i.r, %_ZL13days_in_monthmm.exit42.us ], [ 1, %_ZL13days_in_monthmm.exit42.us.preheader ]
  %i.o = and i1 %6, %i.m
  %i.p = zext i1 %i.o to i32
  %spec.select.i41.us = add i32 %i.n, %.1.us66
  %i.q = add i32 %spec.select.i41.us, %i.p        ; 3 uses
  %i.r = add i32 %.021.us65, 1                    ; 4 uses
  %i.s = tail call i32 @llvm.umin.i32(i32 %i.r, i32 12)
  %i.t = icmp eq i32 %i.r, 0
  %narrow.us = select i1 %i.t, i32 1, i32 %i.s    ; 2 uses
  %spec.store.select2.i.us = zext nneg i32 %narrow.us to i64
  %i.u = getelementptr [4 x i8], ptr @__const._ZL13days_in_monthmm.month_table, i64 %spec.store.select2.i.us
  %i.v = getelementptr i8, ptr %i.u, i64 -4
  %i.w = load i32, ptr %i.v, align 4, !tbaa !79   ; 2 uses
  %i.x = icmp eq i32 %narrow.us, 2                ; 2 uses
  %or.cond.i.us = and i1 %6, %i.x
  %i.y = zext i1 %or.cond.i.us to i32
  %spec.select.i34.us = add i32 %i.w, %i.q
  %i.z = add i32 %spec.select.i34.us, %i.y
  %.not24.us = icmp ugt i32 %i.z, %i.b
...
_ZL12days_in_yearl.exit30.split:                  ; preds = %._crit_edge
  %i.aa = add i32 %.0.lcssa, -366                 ; 2 uses
...
_ZL13days_in_monthmm.exit42:                      ; preds = %_ZL12days_in_yearl.exit30.split, %_ZL13days_in_monthmm.exit42
  %i.ab = phi i1 [ %i.al, %_ZL13days_in_monthmm.exit42 ], [ false, %_ZL12days_in_yearl.exit30.split ]
  %i.ac = phi i32 [ %i.ak, %_ZL13days_in_monthmm.exit42 ], [ 31, %_ZL12days_in_yearl.exit30.split ]
  %.160 = phi i32 [ %i.ae, %_ZL13days_in_monthmm.exit42 ], [ %i.aa, %_ZL12days_in_yearl.exit30.split ]
  %.02159 = phi i32 [ %i.af, %_ZL13days_in_monthmm.exit42 ], [ 1, %_ZL12days_in_yearl.exit30.split ]
  %i.ad = zext i1 %i.ab to i32
  %spec.select.i41 = add i32 %i.ac, %.160
  %i.ae = add i32 %spec.select.i41, %i.ad         ; 3 uses
  %i.af = add i32 %.02159, 1                      ; 4 uses
  %i.ag = tail call i32 @llvm.umin.i32(i32 %i.af, i32 12)
  %i.ah = icmp eq i32 %i.af, 0
  %narrow = select i1 %i.ah, i32 1, i32 %i.ag     ; 2 uses
  %spec.store.select2.i = zext nneg i32 %narrow to i64
  %i.ai = getelementptr [4 x i8], ptr @__const._ZL13days_in_monthmm.month_table, i64 %spec.store.select2.i
  %i.aj = getelementptr i8, ptr %i.ai, i64 -4
  %i.ak = load i32, ptr %i.aj, align 4, !tbaa !79 ; 2 uses
  %i.al = icmp eq i32 %narrow, 2                  ; 2 uses
  %i.am = zext i1 %i.al to i32
  %spec.select.i3444 = add i32 %i.ak, %i.ae
  %i.an = add i32 %spec.select.i3444, %i.am
  %.not2445 = icmp ugt i32 %i.an, %i.b
...
.split.us:                                        ; preds = %_ZL13days_in_monthmm.exit42, %_ZL13days_in_monthmm.exit42.us, %_ZL12days_in_yearl.exit30.split, %_ZL12days_in_yearl.exit30.split.us
  %.us-phi = phi i32 [ %i.r, %_ZL13days_in_monthmm.exit42.us ], [ 1, %_ZL12days_in_yearl.exit30.split.us ], [ 1, %_ZL12days_in_yearl.exit30.split ], [ %i.af, %_ZL13days_in_monthmm.exit42 ]
  %.us-phi56 = phi i32 [ %i.q, %_ZL13days_in_monthmm.exit42.us ], [ %5, %_ZL12days_in_yearl.exit30.split.us ], [ %i.aa, %_ZL12days_in_yearl.exit30.split ], [ %i.ae, %_ZL13days_in_monthmm.exit42 ]
  %i.ao = add nuw i32 %i.b, 1
  %i.ap = sub i32 %i.ao, %.us-phi56
  %i.aq = uitofp i32 %.022.lcssa to double
  %i.ar = uitofp i32 %.us-phi to double
  %i.as = fmul nnan double %i.ar, 1.000000e+02
  %i.at = tail call double @llvm.fmuladd.f64(double %i.aq, double 1.000000e+04, double %i.as)
  %i.au = uitofp i32 %i.ap to double
