...
bb.g:                                             ; preds = %.thread, %bb.f
  ...
  %i.aj = phi <2 x double> [ %i.af, %bb.f ], [ %i.s, %.thread ] ; 3 uses
  ...
  %5 = fneg double %i.ak
  %6 = extractelement <2 x double> %i.aj, i64 1   ; 2 uses
  %i.ao = fneg double %6
  ...
  %i.av = insertelement <2 x double> poison, double %5, i64 0
  %i.aw = shufflevector <2 x double> %i.av, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ax = fmul <2 x double> %i.au, %i.aw
  %7 = fmul double %6, %i.an
  %8 = fmul double %i.am, %i.ao
  %9 = shufflevector <2 x double> %i.aj, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ay = insertelement <2 x double> poison, double %8, i64 0
  %10 = insertelement <2 x double> %i.ay, double %7, i64 1
  %i.az = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ax, <2 x double> %9, <2 x double> %10)
