...
bb.f:                                             ; preds = %bb.e
  ...
  %i.ad = fdiv <2 x double> %i.ab, %i.ac          ; 3 uses
  ...
  %i.av = fdiv <2 x double> %i.aq, %i.au          ; 3 uses
  %3 = extractelement <2 x double> %i.av, i64 0   ; 2 uses
  ...
  %4 = extractelement <2 x double> %i.ba, i64 0
  %5 = tail call double @llvm.fmuladd.f64(double %3, double %3, double %4)
  %sqrt = tail call double @llvm.sqrt.f64(double %5) ; 2 uses
  %i.bb = fneg double %sqrt
  %i.bc = extractelement <2 x double> %i.ba, i64 1
  %6 = tail call double @llvm.fmuladd.f64(double %i.ae, double %i.t, double %i.bc)
  %i.bd = fadd double %6, -1.000000e+00
