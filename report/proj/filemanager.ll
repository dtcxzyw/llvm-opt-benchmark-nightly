...
bb.an:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEpLEc.exit, %bb.cd
  %.074250 = phi i64 [ 0, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEpLEc.exit ], [ %i.kn, %bb.cd ] ; 7 uses
  %i.dc = call noundef i64 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE13find_first_ofEPKcmm(ptr noundef nonnull align 8 dereferenceable(32) %1, ptr noundef nonnull @.str, i64 noundef %.074250, i64 noundef 2) #29 ; 4 uses
  %i.dd = icmp eq i64 %i.dc, -1
  br i1 %i.dd, label %.critedge, label %bb.ao

bb.ao:                                            ; preds = %bb.an
  %i.de = call noundef i64 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4findEcm(ptr noundef nonnull align 8 dereferenceable(32) %1, i8 noundef signext 61, i64 noundef %.074250) #29 ; 4 uses
...
bb.ap:                                            ; preds = %bb.ao
  ...
  %i.dh = icmp ugt i64 %.074250, %i.dg
  br i1 %i.dh, label %bb.aq, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8_M_checkEmPKc.exit.i.i

bb.aq:                                            ; preds = %bb.ap
  invoke void (ptr, ...) @_ZSt24__throw_out_of_range_fmtPKcz(ptr noundef nonnull @.str.65, ptr noundef nonnull @.str.64, i64 noundef %.074250, i64 noundef %i.dg) #32
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8_M_checkEmPKc.exit.i.i: ; preds = %bb.ap
  %i.di = sub i64 %i.de, %.074250
  store ptr %i.ci, ptr %3, align 8, !tbaa !10, !alias.scope !124
  %i.dj = load ptr, ptr %1, align 8, !tbaa !14, !noalias !124
  %i.dk = getelementptr inbounds nuw i8, ptr %i.dj, i64 %.074250 ; 2 uses
  %i.dl = sub nuw i64 %i.dg, %.074250
