...
.lr.ph.i.i.i:                                     ; preds = %_ZL12snyder_ctranRKN12_GLOBAL__N_18GeoPointES2_.exit.i.i.i, %.lr.ph.i.i.i
  ...
  br i1 %i.aw, label %.lr.ph.i.i.i, label %.preheader.i.i.i, !llvm.loop !82
...
.lr.ph8.i.i.i:                                    ; preds = %.preheader.i.i.i, %.lr.ph8.i.i.i
  ...
  br i1 %i.ay, label %.lr.ph8.i.i.i, label %_ZL10isea_ctranPKN12_GLOBAL__N_18GeoPointES2_d.exit.i.i, !llvm.loop !83
...
bb.e:                                             ; preds = %_ZL10safeArcCosd.exit.thread.i.i.i, %_ZL10isea_ctranPKN12_GLOBAL__N_18GeoPointES2_d.exit.i.i
  ...
  %i.bj = load double, ptr %i.bd, align 8, !tbaa !59 ; 2 uses
...
switch.lookup:                                    ; preds = %7
  ...
  %i.fb = fadd nnan double %i.fa, f0x3FE52BB3566A484C
  %.sroa.0.0.i.i.i = select i1 %i.ex, double %i.fb, double %i.fa
...
bb.i:                                             ; preds = %_ZL14isea_transformPN12_GLOBAL__N_112pj_isea_dataEPNS_8GeoPointEPNS_7isea_ptE.exit.i
  %i.ff = fmul double %i.ej, f0x3FEA90A6031F46A3
  %i.fg = fmul double %i.el, f0x3FEA90A6031F46A3
  %i.fh = fadd double %i.ff, 5.000000e-01         ; 3 uses
  store double %i.fh, ptr %5, align 16, !tbaa !62
  %i.fi = fadd double %i.fg, f0x3FD279A74590331C  ; 2 uses
  store double %i.fi, ptr %i.em, align 8, !tbaa !63
...
_ZL9isea_ptddiPN12_GLOBAL__N_17isea_ptE.exit.i:   ; preds = %bb.i
  %i.fj = sdiv i32 %i.cf, 5
  %i.fk = srem i32 %i.cf, 5
  %i.fl = and i32 %i.fj, -2147483647
  %i.fm = icmp eq i32 %i.fl, 1                    ; 2 uses
  %i.fn = select i1 %i.fm, double f0xC010C152382D7365, double f0xBFF0C152382D7365 ; 3 uses
  %i.fo = tail call double @cos(double noundef %i.fn) #17
  %i.fp = tail call double @sin(double noundef %i.fn) #17 ; 2 uses
  %i.fq = fneg double %i.fh
  %i.fr = tail call double @cos(double noundef %i.fn) #17
  %i.fs = insertelement <2 x double> poison, double %i.fi, i64 0
  %i.ft = shufflevector <2 x double> %i.fs, <2 x double> poison, <2 x i32> zeroinitializer
  %i.fu = insertelement <2 x double> poison, double %i.fp, i64 0
  %i.fv = insertelement <2 x double> %i.fu, double %i.fr, i64 1
  %i.fw = fmul <2 x double> %i.ft, %i.fv
  %i.fx = insertelement <2 x double> poison, double %i.fh, i64 0
  %i.fy = insertelement <2 x double> %i.fx, double %i.fq, i64 1
  %i.fz = insertelement <2 x double> poison, double %i.fo, i64 0
  %i.ga = insertelement <2 x double> %i.fz, double %i.fp, i64 1
  %i.gb = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.fy, <2 x double> %i.ga, <2 x double> %i.fw) ; 2 uses
  %i.gc = fadd <2 x double> %i.gb, <double 5.000000e-01, double f0x3FEBB67AE8584CAA>
  %storemerge = select i1 %i.fm, <2 x double> %i.gc, <2 x double> %i.gb
...
bb.j:                                             ; preds = %bb.i
  %i.gi = invoke fastcc noundef i32 @_ZL9isea_ptdiPN12_GLOBAL__N_112pj_isea_dataEiPNS_7isea_ptES3_(ptr noundef nonnull %i.b, i32 noundef %i.cf, ptr noundef %5, ptr noundef %4)
          to label %.noexc unwind label %bb.n

.noexc:                                           ; preds = %bb.j
  %i.gj = getelementptr inbounds nuw i8, ptr %i.b, i64 40
  store i32 %i.gi, ptr %i.gj, align 8, !tbaa !64
  br label %_ZL12isea_forwardPN12_GLOBAL__N_112pj_isea_dataEPNS_8GeoPointE.exit

bb.k:                                             ; preds = %bb.i
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #17
  %i.gk = invoke fastcc noundef i32 @_ZL9isea_ptdiPN12_GLOBAL__N_112pj_isea_dataEiPNS_7isea_ptES3_(ptr noundef nonnull %i.b, i32 noundef %i.cf, ptr noundef nonnull readonly %5, ptr noundef %3)
          to label %.noexc16 unwind label %bb.n

.noexc16:                                         ; preds = %bb.k
  %i.gl = load double, ptr %3, align 8, !tbaa !62 ; 3 uses
  %i.gm = fcmp olt double %i.gl, f0xC1A0000000000000
  %i.gn = fcmp ogt double %i.gl, f0x419FFFFFFC000000
  %or.cond.i.i = or i1 %i.gm, %i.gn
  br i1 %or.cond.i.i, label %bb.l, label %_ZL8isea_hexPN12_GLOBAL__N_112pj_isea_dataEiPNS_7isea_ptES3_.exit.i

bb.l:                                             ; preds = %.noexc16
  %i.go = tail call ptr @__cxa_allocate_exception(i64 8) #17 ; 2 uses
  store ptr @.str.24, ptr %i.go, align 16, !tbaa !65
  invoke void @__cxa_throw(ptr nonnull %i.go, ptr nonnull @_ZTIPKc, ptr null) #20
...
_ZL8isea_hexPN12_GLOBAL__N_112pj_isea_dataEiPNS_7isea_ptES3_.exit.i: ; preds = %.noexc16
  %i.gp = fptosi double %i.gl to i32
  %i.gq = shl nsw i32 %i.gp, 4
  %i.gr = add nsw i32 %i.gq, %i.gk
  %i.gs = sitofp i32 %i.gr to double
  store double %i.gs, ptr %4, align 16, !tbaa !62
  %i.gt = getelementptr inbounds nuw i8, ptr %3, i64 8
  %i.gu = load double, ptr %i.gt, align 8, !tbaa !63
  %i.gv = getelementptr inbounds nuw i8, ptr %4, i64 8
  store double %i.gu, ptr %i.gv, align 8, !tbaa !63
...
_ZL12isea_forwardPN12_GLOBAL__N_112pj_isea_dataEPNS_8GeoPointE.exit: ; preds = %.noexc, %_ZL8isea_hexPN12_GLOBAL__N_112pj_isea_dataEiPNS_7isea_ptES3_.exit.i, %bb.m
  ...
  %i.gw = load <2 x double>, ptr %4, align 16
...
bb.n:                                             ; preds = %bb.l, %bb.k, %bb.j
  ...
  %i.gy = extractvalue { ptr, i32 } %i.gx, 1
  %i.gz = tail call i32 @llvm.eh.typeid.for.p0(ptr nonnull @_ZTIPKc) #17
  %i.ha = icmp eq i32 %i.gy, %i.gz
  br i1 %i.ha, label %bb.o, label %bb.v

bb.o:                                             ; preds = %bb.n
  %i.hb = extractvalue { ptr, i32 } %i.gx, 0
  %i.hc = tail call ptr @__cxa_begin_catch(ptr %i.hb) #17 ; 0 uses
  %i.hd = invoke i32 @proj_errno_set(ptr noundef %2, i32 noundef 2050)
...
bb.q:                                             ; preds = %bb.p
  %i.he = load <2 x double>, ptr %6, align 16, !tbaa !38
...
bb.t:                                             ; preds = %bb.s, %bb.r
  %.pn = phi { ptr, i32 } [ %i.hg, %bb.s ], [ %i.hf, %bb.r ]
  call void @__cxa_end_catch() #17
  br label %bb.v

bb.u:                                             ; preds = %_ZL12isea_forwardPN12_GLOBAL__N_112pj_isea_dataEPNS_8GeoPointE.exit, %bb.q
  %i.hh = phi <2 x double> [ %i.he, %bb.q ], [ %i.gw, %_ZL12isea_forwardPN12_GLOBAL__N_112pj_isea_dataEPNS_8GeoPointE.exit ] ; 2 uses
  %i.hi = extractelement <2 x double> %i.hh, i64 0
  %.pn18 = insertvalue { double, double } poison, double %i.hi, 0
  %i.hj = extractelement <2 x double> %i.hh, i64 1
  %.fca.1.insert.merged = insertvalue { double, double } %.pn18, double %i.hj, 1
  ret { double, double } %.fca.1.insert.merged

bb.v:                                             ; preds = %bb.t, %bb.n
  %.merged = phi { ptr, i32 } [ %.pn, %bb.t ], [ %i.gx, %bb.n ]
