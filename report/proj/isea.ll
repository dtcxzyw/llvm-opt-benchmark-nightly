...
.lr.ph.i14.i.i:                                   ; preds = %_ZL10safeArcCosd.exit.thread1.i.i.i, %.lr.ph.i14.i.i
  ...
  br i1 %i.cp, label %.lr.ph.i14.i.i, label %.preheader.i13.i.i, !llvm.loop !84
...
.lr.ph14.i.i.i:                                   ; preds = %.preheader.i13.i.i, %.lr.ph14.i.i.i
  ...
  br i1 %i.cs, label %.lr.ph14.i.i.i, label %._crit_edge.i.i.i, !llvm.loop !85
...
_ZL10safeArcCosd.exit.thread.i.i.i:               ; preds = %._crit_edge.i.i.i, %_ZL10safeArcCosd.exit.i.i.i, %bb.f, %bb.e
  ...
  br i1 %exitcond.not.i.i.i, label %bb.h, label %bb.e, !llvm.loop !86

bb.h:                                             ; preds = %_ZL10safeArcCosd.exit.thread.i.i.i
  %i.cz = load ptr, ptr @stderr, align 8, !tbaa !88
...
_ZL14isea_transformPN12_GLOBAL__N_112pj_isea_dataEPNS_8GeoPointEPNS_7isea_ptE.exit.i: ; preds = %._crit_edge.i.i.i
  ...
  store i32 %i.cf, ptr %i.en, align 4, !tbaa !89
...
switch.lookup:                                    ; preds = %_ZL14isea_transformPN12_GLOBAL__N_112pj_isea_dataEPNS_8GeoPointEPNS_7isea_ptE.exit.i
  ...
  %i.ev = fneg double %i.el
  %i.ew = select i1 %i.et, double %i.ev, double %i.el
  %i.ex = select i1 %i.et, double %i.eu, double %i.ej
  %i.ey = srem i32 %i.cf, 20                      ; 2 uses
  %.lhs.trunc5.i.i.i = trunc nuw nsw i32 %i.ey to i8 ; 2 uses
  %i.ez = udiv i8 %.lhs.trunc5.i.i.i, 5
  %i.fa = zext nneg i8 %i.ez to i64
  %switch.gep = getelementptr inbounds nuw [8 x i8], ptr @switch.table._ZL14isea_s_forward5PJ_LPP8PJconsts, i64 %i.fa
  %switch.load = load double, ptr %switch.gep, align 8
  %i.fb = icmp sgt i32 %i.ey, 9
  %i.fc = urem i8 %.lhs.trunc5.i.i.i, 5
  %narrow.i.i.i = add nsw i8 %i.fc, -2
  %i.fd = sitofp i8 %narrow.i.i.i to double
  %i.fe = fmul nnan double %i.fd, f0x3FE52BB3566A484C
  %i.ff = fmul nnan double %i.fe, 2.000000e+00    ; 2 uses
  %i.fg = fadd nnan double %i.ff, f0x3FE52BB3566A484C
  %.sroa.0.0.i.i.i = select i1 %i.fb, double %i.fg, double %i.ff
  %i.fh = fmul nnan double %.sroa.0.0.i.i.i, f0x3FED21DC1E9D1240
  %i.fi = fadd double %i.fh, %i.ex
  store double %i.fi, ptr %5, align 16, !tbaa !62
  %i.fj = fadd double %i.ew, %switch.load
  store double %i.fj, ptr %i.em, align 8, !tbaa !63
  br label %bb.m

bb.i:                                             ; preds = %_ZL14isea_transformPN12_GLOBAL__N_112pj_isea_dataEPNS_8GeoPointEPNS_7isea_ptE.exit.i
  %i.fk = fmul double %i.ej, f0x3FEA90A6031F46A3
  %i.fl = fmul double %i.el, f0x3FEA90A6031F46A3
  %i.fm = fadd double %i.fk, 5.000000e-01         ; 3 uses
  store double %i.fm, ptr %5, align 16, !tbaa !62
  %i.fn = fadd double %i.fl, f0x3FD279A74590331C  ; 2 uses
  store double %i.fn, ptr %i.em, align 8, !tbaa !63
  switch i32 %i.ep, label %bb.m [
    i32 3, label %bb.k
    i32 2, label %_ZL9isea_ptddiPN12_GLOBAL__N_17isea_ptE.exit.i
    i32 1, label %bb.j
  ]

_ZL9isea_ptddiPN12_GLOBAL__N_17isea_ptE.exit.i:   ; preds = %bb.i
  %i.fo = sdiv i32 %i.cf, 5
  %i.fp = srem i32 %i.cf, 5
  %i.fq = and i32 %i.fo, -2147483647
  %i.fr = icmp eq i32 %i.fq, 1                    ; 2 uses
  %i.fs = select i1 %i.fr, double f0xC010C152382D7365, double f0xBFF0C152382D7365 ; 3 uses
  %i.ft = tail call double @cos(double noundef %i.fs) #17
  %i.fu = tail call double @sin(double noundef %i.fs) #17 ; 2 uses
  %i.fv = fneg double %i.fm
  %i.fw = tail call double @cos(double noundef %i.fs) #17
  %i.fx = insertelement <2 x double> poison, double %i.fn, i64 0
  ...
  %i.gc = insertelement <2 x double> poison, double %i.fm, i64 0
  %i.gd = insertelement <2 x double> %i.gc, double %i.fv, i64 1
  %i.ge = insertelement <2 x double> poison, double %i.ft, i64 0
  %i.gf = insertelement <2 x double> %i.ge, double %i.fu, i64 1
  %i.gg = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.gd, <2 x double> %i.gf, <2 x double> %i.gb) ; 2 uses
  %i.gh = fadd <2 x double> %i.gg, <double 5.000000e-01, double f0x3FEBB67AE8584CAA>
  %storemerge = select i1 %i.fr, <2 x double> %i.gh, <2 x double> %i.gg
  store <2 x double> %storemerge, ptr %5, align 16, !tbaa !38
  %i.gi = sdiv i32 %i.cf, 10
  %i.gj = mul nuw nsw i32 %i.gi, 5
  %i.gk = add nuw nsw i32 %i.fp, 1
  %i.gl = add nuw nsw i32 %i.gk, %i.gj
  %i.gm = getelementptr inbounds nuw i8, ptr %i.b, i64 40
  store i32 %i.gl, ptr %i.gm, align 8, !tbaa !64
  br label %bb.m

bb.j:                                             ; preds = %bb.i
  %i.gn = invoke fastcc noundef i32 @_ZL9isea_ptdiPN12_GLOBAL__N_112pj_isea_dataEiPNS_7isea_ptES3_(ptr noundef nonnull %i.b, i32 noundef %i.cf, ptr noundef %5, ptr noundef %4)
          to label %.noexc unwind label %bb.n

.noexc:                                           ; preds = %bb.j
  %i.go = getelementptr inbounds nuw i8, ptr %i.b, i64 40
  store i32 %i.gn, ptr %i.go, align 8, !tbaa !64
  br label %_ZL12isea_forwardPN12_GLOBAL__N_112pj_isea_dataEPNS_8GeoPointE.exit

bb.k:                                             ; preds = %bb.i
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #17
  %i.gp = invoke fastcc noundef i32 @_ZL9isea_ptdiPN12_GLOBAL__N_112pj_isea_dataEiPNS_7isea_ptES3_(ptr noundef nonnull %i.b, i32 noundef %i.cf, ptr noundef nonnull readonly %5, ptr noundef %3)
          to label %.noexc16 unwind label %bb.n

.noexc16:                                         ; preds = %bb.k
  %i.gq = load double, ptr %3, align 8, !tbaa !62 ; 3 uses
  %i.gr = fcmp olt double %i.gq, f0xC1A0000000000000
  %i.gs = fcmp ogt double %i.gq, f0x419FFFFFFC000000
  %or.cond.i.i = or i1 %i.gr, %i.gs
  br i1 %or.cond.i.i, label %bb.l, label %_ZL8isea_hexPN12_GLOBAL__N_112pj_isea_dataEiPNS_7isea_ptES3_.exit.i

bb.l:                                             ; preds = %.noexc16
  %i.gt = tail call ptr @__cxa_allocate_exception(i64 8) #17 ; 2 uses
  store ptr @.str.24, ptr %i.gt, align 16, !tbaa !65
  invoke void @__cxa_throw(ptr nonnull %i.gt, ptr nonnull @_ZTIPKc, ptr null) #20
...
_ZL8isea_hexPN12_GLOBAL__N_112pj_isea_dataEiPNS_7isea_ptES3_.exit.i: ; preds = %.noexc16
  %i.gu = fptosi double %i.gq to i32
  %i.gv = shl nsw i32 %i.gu, 4
  %i.gw = add nsw i32 %i.gv, %i.gp
  %i.gx = sitofp i32 %i.gw to double
  store double %i.gx, ptr %4, align 16, !tbaa !62
  %i.gy = getelementptr inbounds nuw i8, ptr %3, i64 8
  %i.gz = load double, ptr %i.gy, align 8, !tbaa !63
  %i.ha = getelementptr inbounds nuw i8, ptr %4, i64 8
  store double %i.gz, ptr %i.ha, align 8, !tbaa !63
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #17
  br label %_ZL12isea_forwardPN12_GLOBAL__N_112pj_isea_dataEPNS_8GeoPointE.exit

bb.m:                                             ; preds = %_ZL9isea_ptddiPN12_GLOBAL__N_17isea_ptE.exit.i, %bb.i, %switch.lookup
...
_ZL12isea_forwardPN12_GLOBAL__N_112pj_isea_dataEPNS_8GeoPointE.exit: ; preds = %.noexc, %_ZL8isea_hexPN12_GLOBAL__N_112pj_isea_dataEiPNS_7isea_ptES3_.exit.i, %bb.m
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #17
  %i.hb = load <2 x double>, ptr %4, align 16
...
bb.n:                                             ; preds = %bb.l, %bb.k, %bb.j
  ...
  %i.hd = extractvalue { ptr, i32 } %i.hc, 1
  %i.he = tail call i32 @llvm.eh.typeid.for.p0(ptr nonnull @_ZTIPKc) #17
  %i.hf = icmp eq i32 %i.hd, %i.he
  br i1 %i.hf, label %bb.o, label %bb.v

bb.o:                                             ; preds = %bb.n
  %i.hg = extractvalue { ptr, i32 } %i.hc, 0
  %i.hh = tail call ptr @__cxa_begin_catch(ptr %i.hg) #17 ; 0 uses
  %i.hi = invoke i32 @proj_errno_set(ptr noundef %2, i32 noundef 2050)
...
bb.q:                                             ; preds = %bb.p
  %i.hj = load <2 x double>, ptr %6, align 16, !tbaa !38
...
bb.t:                                             ; preds = %bb.s, %bb.r
  %.pn = phi { ptr, i32 } [ %i.hl, %bb.s ], [ %i.hk, %bb.r ]
  call void @__cxa_end_catch() #17
  br label %bb.v

bb.u:                                             ; preds = %_ZL12isea_forwardPN12_GLOBAL__N_112pj_isea_dataEPNS_8GeoPointE.exit, %bb.q
  %i.hm = phi <2 x double> [ %i.hj, %bb.q ], [ %i.hb, %_ZL12isea_forwardPN12_GLOBAL__N_112pj_isea_dataEPNS_8GeoPointE.exit ] ; 2 uses
  %i.hn = extractelement <2 x double> %i.hm, i64 0
  %.pn18 = insertvalue { double, double } poison, double %i.hn, 0
  %i.ho = extractelement <2 x double> %i.hm, i64 1
  %.fca.1.insert.merged = insertvalue { double, double } %.pn18, double %i.ho, 1
  ret { double, double } %.fca.1.insert.merged

bb.v:                                             ; preds = %bb.t, %bb.n
  %.merged = phi { ptr, i32 } [ %.pn, %bb.t ], [ %i.hc, %bb.n ]
