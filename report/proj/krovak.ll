...
begin_hunk_0_@_ZL12krovak_setupP8PJconstsb:bb.a
  ...
  store i8 %i.a, ptr %i.ac, align 1, !tbaa !48
  %i.ad = getelementptr inbounds nuw i8, ptr %i.b, i64 40 ; 2 uses
  store i8 1, ptr %i.ad, align 8, !tbaa !49
  %i.ae = load ptr, ptr %0, align 8, !tbaa !45
  %i.af = load ptr, ptr %i.j, align 8, !tbaa !58
...
bb.j:                                             ; preds = %.critedge
  store i8 0, ptr %i.ad, align 8, !tbaa !49
  br label %bb.k

bb.k:                                             ; preds = %bb.j, %.critedge
  %i.ai = load double, ptr %i.g, align 8, !tbaa !61 ; 3 uses
  %i.aj = getelementptr inbounds nuw i8, ptr %0, i64 448
  %i.ak = load double, ptr %i.aj, align 8, !tbaa !59 ; 5 uses
  ...
  store double %i.ar, ptr %i.b, align 8, !tbaa !50
  ...
  %i.av = load double, ptr %i.h, align 8, !tbaa !51 ; 3 uses
...
bb.m:                                             ; preds = %bb.k
  ...
  %i.ce = load double, ptr %i.cd, align 8, !tbaa !60
  ...
  store ptr @_ZL16krovak_e_inverse5PJ_XYP8PJconsts, ptr %i.cm, align 8, !tbaa !62
  %i.cn = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr @_ZL16krovak_e_forward5PJ_LPP8PJconsts, ptr %i.cn, align 8, !tbaa !63
  br label %bb.n
...
bb.d:                                             ; preds = %bb.c
  ...
  store ptr @.str.1, ptr %i.d, align 8, !tbaa !37
...
bb.a:
  ...
  %i.d = load i8, ptr %i.c, align 8, !tbaa !49, !range !52, !noundef !53
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %i.u = load i8, ptr %i.t, align 1, !tbaa !48, !range !52, !noundef !53
...
bb.d:                                             ; preds = %bb.c
  ...
  %7 = fmul double %i.ac, -6.000000e+00
  %8 = fneg <2 x double> %3
  %9 = shufflevector <2 x double> %3, <2 x double> %8, <2 x i32> <i32 1, i32 2>
  %10 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %3, <2 x double> <double -3.000000e+00, double 3.000000e+00>, <2 x double> %9) ; 2 uses
  %11 = tail call double @llvm.fmuladd.f64(double %7, double %i.ab, double %6)
  ...
  %15 = shufflevector <2 x double> %10, <2 x double> poison, <2 x i32> <i32 1, i32 1>
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.bd = load double, ptr %i.bc, align 8, !tbaa !54
  %i.be = fdiv double %i.bd, %sqrt
  %i.bf = getelementptr inbounds nuw i8, ptr %i.b, i64 16
  %i.bg = load double, ptr %i.bf, align 8, !tbaa !55
...
bb.g:                                             ; preds = %bb.e, %bb.f
  ...
  %i.bo = load double, ptr %i.bn, align 8, !tbaa !56 ; 2 uses
  ...
  %i.cg = load double, ptr %i.cf, align 8, !tbaa !46 ; 2 uses
  %i.ch = load double, ptr %i.b, align 8, !tbaa !50 ; 3 uses
  %i.ci = getelementptr inbounds nuw i8, ptr %i.b, i64 8
  %i.cj = load double, ptr %i.ci, align 8, !tbaa !57
  ...
  %i.cp = load double, ptr %i.co, align 8, !tbaa !51 ; 3 uses
...
bb.j:                                             ; preds = %bb.h
  ...
  %.pre = load double, ptr %i.cf, align 8, !tbaa !46
  br label %.loopexit
...
bb.a:
  ...
  %i.d = load double, ptr %i.c, align 8, !tbaa !51 ; 3 uses
  ...
  %i.o = load double, ptr %i.b, align 8, !tbaa !50 ; 3 uses
  ...
  %i.ag = load double, ptr %i.af, align 8, !tbaa !56 ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.ay = load double, ptr %i.ax, align 8, !tbaa !55 ; 3 uses
  %i.az = fmul double %i.aw, %i.ay                ; 2 uses
  %i.ba = getelementptr inbounds nuw i8, ptr %i.b, i64 24
  %i.bb = load double, ptr %i.ba, align 8, !tbaa !54
  ...
  %i.br = load i8, ptr %i.bq, align 1, !tbaa !48, !range !52, !noundef !53
...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  %i.dn = load i8, ptr %i.dm, align 8, !tbaa !49, !range !52, !noundef !53
...
!45 = !{!36, !9, i64 0}
!46 = !{!36, !14, i64 440}
!47 = !{!"_ZTSN12_GLOBAL__N_114pj_krovak_dataE", !14, i64 0, !14, i64 8, !14, i64 16, !14, i64 24, !14, i64 32, !21, i64 40, !21, i64 41}
!48 = !{!47, !21, i64 41}
!49 = !{!47, !21, i64 40}
!50 = !{!47, !14, i64 0}
!51 = !{!36, !14, i64 208}
