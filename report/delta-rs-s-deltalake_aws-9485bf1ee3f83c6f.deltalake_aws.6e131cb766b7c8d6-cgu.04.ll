...
common.resume:                                    ; preds = %.body, %144, %85, %94
  %common.resume.op = phi { ptr, i32 } [ %145, %144 ], [ %95, %94 ], [ %86, %85 ], [ %.pn, %.body ]
  resume { ptr, i32 } %common.resume.op

_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.i: ; preds = %87
  %92 = getelementptr inbounds nuw i8, ptr %7, i64 8
  %.sroa.643.24.copyload.i = load i64, ptr %92, align 8, !noalias !1971
...
99:                                               ; preds = %_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.i, %_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.thread.i
  %.sroa.5.sroa.0.0.ph.i = phi i64 [ %.sroa.7.sroa.0.0.copyload14.i, %_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.thread.i ], [ %84, %_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.i ] ; 2 uses
...
begin_hunk_4
  ...
  %100 = icmp eq i64 %.sroa.5.sroa.0.0.ph.i, -9223372036854775808 ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %12)
  %spec.select83 = select i1 %100, ptr null, ptr %13
  br label %101

101:                                              ; preds = %99, %.thread72
  %.not1075 = phi i1 [ %100, %99 ], [ true, %.thread72 ] ; 2 uses
  %102 = phi ptr [ %spec.select83, %99 ], [ null, %.thread72 ]
  %.not11 = icmp eq ptr %spec.store.select, null  ; 3 uses
  %103 = select i1 %.not11, ptr %102, ptr %spec.store.select
...
.body:                                            ; preds = %135, %114, %123, %104, %139
  %.pn = phi { ptr, i32 } [ %140, %139 ], [ %124, %123 ], [ %105, %104 ], [ %115, %114 ], [ %136, %135 ]
...
106:                                              ; preds = %101
  %107 = load i64, ptr %10, align 8, !range !139, !noundef !3
  %.not12 = icmp eq i64 %107, -9223372036854775808
...
108:                                              ; preds = %106
  ...
  %110 = load ptr, ptr %109, align 8, !alias.scope !1989, !noalias !1995, !nonnull !3, !noundef !3 ; 2 uses
  %111 = getelementptr inbounds nuw i8, ptr %5, i64 16
  %112 = load i64, ptr %111, align 8, !alias.scope !1989, !noalias !1995, !noundef !3 ; 4 uses
  %113 = ptrtoint ptr %110 to i64                 ; 3 uses
...
116:                                              ; preds = %108
  %117 = load i64, ptr %4, align 8, !range !62, !noalias !1991, !noundef !3
...
_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.i42: ; preds = %116
  ...
  %.sroa.643.24.copyload.i43 = load i64, ptr %121, align 8, !noalias !1991
...
128:                                              ; preds = %_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.i42, %_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.thread.i35
  %.sroa.5.sroa.0.0.ph.i37 = phi i64 [ %.sroa.7.sroa.0.0.copyload14.i36, %_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.thread.i35 ], [ %113, %_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.i42 ] ; 2 uses
  %.sroa.5.sroa.6.0.ph.i38 = phi i64 [ %113, %_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.thread.i35 ], [ %112, %_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.i42 ]
  %.sroa.5.sroa.7.0.ph.i39 = phi i64 [ %112, %_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.thread.i35 ], [ %.sroa.643.24.copyload.i43, %_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.i42 ]
...
131:                                              ; preds = %129, %130
  %.sroa.02.2 = phi ptr [ %spec.select, %129 ], [ %103, %130 ]
...
132:                                              ; preds = %131
  ...
  %133 = icmp eq i64 %.pre, -9223372036854775808
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionNtNtCs6Po7BT7Nknu_5alloc6string6StringEECs9rVkZwOUgsI_13deltalake_aws.exit: ; preds = %.thread77, %132, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6Po7BT7Nknu_5alloc6string6StringECs9rVkZwOUgsI_13deltalake_aws.exit.i
  ...
  %141 = load i64, ptr %13, align 8, !range !139, !alias.scope !2009, !noundef !3
