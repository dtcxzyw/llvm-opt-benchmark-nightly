...
87:                                               ; preds = %79
  %88 = load i64, ptr %7, align 8, !range !62, !noalias !1971, !noundef !3
end_hunk_0
begin_hunk_1
_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.thread.i: ; preds = %87
  %.sroa.7.sroa.0.0.copyload14.i = load i64, ptr %8, align 8, !alias.scope !1976, !noalias !1977
  call void @llvm.lifetime.end.p0(ptr nonnull %7), !noalias !1971
  %90 = freeze i64 %.sroa.7.sroa.0.0.copyload14.i
  br label %100
...
common.resume:                                    ; preds = %.body, %145, %85, %95
  %common.resume.op = phi { ptr, i32 } [ %146, %145 ], [ %96, %95 ], [ %86, %85 ], [ %.pn, %.body ]
  resume { ptr, i32 } %common.resume.op

_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.i: ; preds = %87
  %93 = getelementptr inbounds nuw i8, ptr %7, i64 8
  %.sroa.643.24.copyload.i = load i64, ptr %93, align 8, !noalias !1971
  %.sroa.040.0.copyload.i = load i64, ptr %8, align 8, !noalias !1975 ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %7), !noalias !1971
...
94:                                               ; preds = %_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.i
  ...
  %.sroa.5.sroa.6.0..sroa_idx30.i = getelementptr inbounds nuw i8, ptr %6, i64 8
end_hunk_1
begin_hunk_2
  %.sroa.5.sroa.7.0..sroa_idx34.i = getelementptr inbounds nuw i8, ptr %6, i64 16
...
100:                                              ; preds = %_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.i, %_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.thread.i
  %.sroa.5.sroa.0.0.ph.i = phi i64 [ %90, %_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.thread.i ], [ %84, %_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.i ] ; 2 uses
  %.sroa.5.sroa.6.0.ph.i = phi i64 [ %84, %_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.thread.i ], [ %83, %_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.i ]
  %.sroa.5.sroa.7.0.ph.i = phi i64 [ %83, %_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.thread.i ], [ %.sroa.643.24.copyload.i, %_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.i ]
...
begin_hunk_4
  ...
  %101 = icmp eq i64 %.sroa.5.sroa.0.0.ph.i, -9223372036854775808 ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %12)
  %spec.select83 = select i1 %101, ptr null, ptr %13
  br label %102

102:                                              ; preds = %100, %.thread72
  %.not1075 = phi i1 [ %101, %100 ], [ true, %.thread72 ] ; 2 uses
  %103 = phi ptr [ %spec.select83, %100 ], [ null, %.thread72 ]
  %.not11 = icmp eq ptr %spec.store.select, null  ; 3 uses
  %104 = select i1 %.not11, ptr %103, ptr %spec.store.select
...
.body:                                            ; preds = %136, %115, %124, %105, %140
  %.pn = phi { ptr, i32 } [ %141, %140 ], [ %125, %124 ], [ %106, %105 ], [ %116, %115 ], [ %137, %136 ]
...
107:                                              ; preds = %102
  %108 = load i64, ptr %10, align 8, !range !139, !noundef !3
  %.not12 = icmp eq i64 %108, -9223372036854775808
...
109:                                              ; preds = %107
  ...
  %111 = load ptr, ptr %110, align 8, !alias.scope !1989, !noalias !1995, !nonnull !3, !noundef !3 ; 2 uses
  %112 = getelementptr inbounds nuw i8, ptr %5, i64 16
  %113 = load i64, ptr %112, align 8, !alias.scope !1989, !noalias !1995, !noundef !3 ; 4 uses
  %114 = ptrtoint ptr %111 to i64                 ; 3 uses
...
117:                                              ; preds = %109
  %118 = load i64, ptr %4, align 8, !range !62, !noalias !1991, !noundef !3
...
_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.thread.i35: ; preds = %117
  %.sroa.7.sroa.0.0.copyload14.i36 = load i64, ptr %5, align 8, !alias.scope !1996, !noalias !1997
...
_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.i42: ; preds = %117
  ...
  %.sroa.643.24.copyload.i43 = load i64, ptr %122, align 8, !noalias !1991
  %.sroa.040.0.copyload.i44 = load i64, ptr %5, align 8, !noalias !1995 ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %4), !noalias !1991
...
123:                                              ; preds = %_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.i42
  ...
  %.sroa.5.sroa.6.0..sroa_idx30.i46 = getelementptr inbounds nuw i8, ptr %3, i64 8
  store i64 %114, ptr %.sroa.5.sroa.6.0..sroa_idx30.i46, align 8, !noalias !2004
  %.sroa.5.sroa.7.0..sroa_idx34.i47 = getelementptr inbounds nuw i8, ptr %3, i64 16
...
129:                                              ; preds = %_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.i42, %_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.thread.i35
  %.sroa.5.sroa.0.0.ph.i37 = phi i64 [ %.sroa.7.sroa.0.0.copyload14.i36, %_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.thread.i35 ], [ %114, %_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.i42 ] ; 2 uses
  %.sroa.5.sroa.6.0.ph.i38 = phi i64 [ %114, %_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.thread.i35 ], [ %113, %_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.i42 ]
  %.sroa.5.sroa.7.0.ph.i39 = phi i64 [ %113, %_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.thread.i35 ], [ %.sroa.643.24.copyload.i43, %_RNvMNtCs6Po7BT7Nknu_5alloc6stringNtB2_6String9from_utf8.exit.i42 ]
...
begin_hunk_5
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %10)
  %.not13 = icmp eq i64 %.sroa.5.sroa.0.0.ph.i37, -9223372036854775808
  br i1 %.not13, label %131, label %130

130:                                              ; preds = %129
  %.sroa.02.1 = select i1 %.not1075, ptr %11, ptr %13
...
132:                                              ; preds = %130, %131
  %.sroa.02.2 = phi ptr [ %spec.select, %130 ], [ %104, %131 ]
...
133:                                              ; preds = %132
  ...
  %.pre = load i64, ptr %11, align 8, !range !139, !alias.scope !2006
  %134 = icmp eq i64 %.pre, -9223372036854775808
...
_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeINtNtB4_6option6OptionNtNtCs6Po7BT7Nknu_5alloc6string6StringEECs9rVkZwOUgsI_13deltalake_aws.exit: ; preds = %.thread77, %133, %_RINvNtCsbvkFyIu7lgC_4core3ptr13drop_in_placeNtNtCs6Po7BT7Nknu_5alloc6string6StringECs9rVkZwOUgsI_13deltalake_aws.exit.i
  ...
  %142 = load i64, ptr %13, align 8, !range !139, !alias.scope !2009, !noundef !3
