begin_hunk_0
  ...
  %.pre = load i32, ptr %3, align 8, !tbaa !93    ; [#uses=1 type=i32]
  %.fr84 = freeze i32 %.pre                       ; [#uses=7 type=i32]
...
39:                                               ; preds = %37, %36
  %40 = and i32 %.fr84, 12                        ; [#uses=1 type=i32]
...
getExpireMillisecondsOrReply.exit.thread:         ; preds = %39, %thread-pre-split.i, %23
  %45 = and i32 %.fr84, 3                         ; [#uses=1 type=i32]
...
.lr.ph:                                           ; preds = %getExpireMillisecondsOrReply.exit.thread
  ...
  %48 = trunc i32 %.fr84 to i1                    ; [#uses=1 type=i1]
  %49 = and i32 %.fr84, 2                         ; [#uses=1 type=i32]
...
.lr.ph.split.us.split.us:                         ; preds = %.lr.ph.split.us, %.lr.ph.split.us.split.us
  %indvars.iv92 = phi i64 [ %indvars.iv.next93, %.lr.ph.split.us.split.us ], [ 0, %.lr.ph.split.us ] ; [#uses=2 type=i64]
  %51 = load ptr, ptr %47, align 8, !tbaa !44     ; [#uses=1 type=ptr]
  %52 = load ptr, ptr %5, align 8, !tbaa !15      ; [#uses=1 type=ptr]
  %.idx109 = shl nuw nsw i64 %indvars.iv92, 4     ; [#uses=1 type=i64]
  %53 = getelementptr inbounds nuw i8, ptr %52, i64 %.idx109 ; [#uses=1 type=ptr]
  ...
  %indvars.iv.next93 = add nuw nsw i64 %indvars.iv92, 1 ; [#uses=2 type=i64]
  %57 = load i64, ptr %2, align 8, !tbaa !90      ; [#uses=2 type=i64]
  %.not64.us.us = icmp sgt i64 %57, %indvars.iv.next93 ; [#uses=1 type=i1]
...
begin_hunk_5
  ...
  %.not85 = icmp eq ptr %63, null                 ; [#uses=1 type=i1]
...
.lr.ph.split.split.us:                            ; preds = %.lr.ph.split, %72
  %indvars.iv95 = phi i64 [ %indvars.iv.next96, %72 ], [ 0, %.lr.ph.split ] ; [#uses=2 type=i64]
  %66 = load ptr, ptr %47, align 8, !tbaa !44     ; [#uses=1 type=ptr]
  %67 = load ptr, ptr %5, align 8, !tbaa !15      ; [#uses=1 type=ptr]
  %.idx110 = shl nuw nsw i64 %indvars.iv95, 4     ; [#uses=1 type=i64]
  %68 = getelementptr inbounds nuw i8, ptr %67, i64 %.idx110 ; [#uses=1 type=ptr]
  ...
  %.not87 = icmp eq ptr %71, null                 ; [#uses=1 type=i1]
  br i1 %.not87, label %72, label %.critedge

72:                                               ; preds = %.lr.ph.split.split.us
  %indvars.iv.next96 = add nuw nsw i64 %indvars.iv95, 1 ; [#uses=2 type=i64]
  %73 = load i64, ptr %2, align 8, !tbaa !90      ; [#uses=2 type=i64]
  %.not64.us78 = icmp sgt i64 %73, %indvars.iv.next96 ; [#uses=1 type=i1]
...
.lr.ph83:                                         ; preds = %.critedge71
  %82 = and i32 %.fr84, 16                        ; [#uses=2 type=i32]
...
._crit_edge:                                      ; preds = %115, %.critedge71
  ...
  %85 = and i32 %.fr84, 128                       ; [#uses=1 type=i32]
...
86:                                               ; preds = %.lr.ph83, %115
  %indvars.iv98 = phi i64 [ 0, %.lr.ph83 ], [ %indvars.iv.next99, %115 ] ; [#uses=2 type=i64]
  %87 = shl nuw nsw i64 %indvars.iv98, 1          ; [#uses=2 type=i64]
...
begin_hunk_9
  ...
  %indvars.iv.next99 = add nuw nsw i64 %indvars.iv98, 1 ; [#uses=2 type=i64]
  %122 = load i64, ptr %2, align 8, !tbaa !90     ; [#uses=2 type=i64]
  %123 = icmp sgt i64 %122, %indvars.iv.next99    ; [#uses=1 type=i1]
  br i1 %123, label %86, label %._crit_edge, !llvm.loop !114

124:                                              ; preds = %._crit_edge
  %125 = and i32 %.fr84, 64                       ; [#uses=1 type=i32]
...
begin_hunk_10
  ...
  %.pre101 = load i64, ptr %2, align 8, !tbaa !90 ; [#uses=1 type=i64]
  br label %135

135:                                              ; preds = %130, %124, %._crit_edge
  %136 = phi i64 [ %.pre101, %130 ], [ %84, %124 ], [ %84, %._crit_edge ] ; [#uses=1 type=i64]
