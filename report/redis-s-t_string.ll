...
.lr.ph.split.us.split.us:                         ; preds = %.lr.ph.split.us, %.lr.ph.split.us.split.us
  %indvars.iv92 = phi i64 [ %indvars.iv.next93, %.lr.ph.split.us.split.us ], [ 0, %.lr.ph.split.us ] ; 2 uses
  %51 = load ptr, ptr %47, align 8, !tbaa !44
  %52 = load ptr, ptr %5, align 8, !tbaa !15
  %.idx109 = shl nuw nsw i64 %indvars.iv92, 4
  %53 = getelementptr inbounds nuw i8, ptr %52, i64 %.idx109
  ...
  %.not64.us.us = icmp sgt i64 %57, %indvars.iv.next93
...
.lr.ph.split.split.us:                            ; preds = %.lr.ph.split, %72
  %indvars.iv95 = phi i64 [ %indvars.iv.next96, %72 ], [ 0, %.lr.ph.split ] ; 2 uses
  %66 = load ptr, ptr %47, align 8, !tbaa !44
  %67 = load ptr, ptr %5, align 8, !tbaa !15
  %.idx110 = shl nuw nsw i64 %indvars.iv95, 4
  %68 = getelementptr inbounds nuw i8, ptr %67, i64 %.idx110
...
72:                                               ; preds = %.lr.ph.split.split.us
  ...
  %.not64.us78 = icmp sgt i64 %73, %indvars.iv.next96
...
86:                                               ; preds = %.lr.ph83, %115
  %indvars.iv98 = phi i64 [ 0, %.lr.ph83 ], [ %indvars.iv.next99, %115 ] ; 2 uses
  %87 = shl nuw nsw i64 %indvars.iv98, 1          ; 2 uses
...
begin_hunk_9
  ...
  %123 = icmp sgt i64 %122, %indvars.iv.next99
...
begin_hunk_10
  ...
  %.pre101 = load i64, ptr %2, align 8, !tbaa !90
  br label %135

135:                                              ; preds = %130, %124, %._crit_edge
  %136 = phi i64 [ %.pre101, %130 ], [ %84, %124 ], [ %84, %._crit_edge ]
