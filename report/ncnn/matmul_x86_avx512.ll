...
.noexc1236:                                       ; preds = %bb.rk
  ...
  %i.bfj = load i32, ptr %i.bdy, align 4, !tbaa !72, !noalias !85 ; 2 uses
  %i.bfk = load i32, ptr %i.bcv, align 16, !tbaa !79, !noalias !85 ; 2 uses
  %i.bfl = load i32, ptr %i.bdz, align 4, !tbaa !80, !noalias !85
  %i.bfm = load ptr, ptr %28, align 16, !tbaa !43, !noalias !85
  %i.bfn = load i64, ptr %i.bea, align 16, !tbaa !39, !noalias !85
  %i.bfo = and i64 %indvars.iv1786, 4294967295
  %i.bfp = select i1 %i.bfi, i64 0, i64 %i.bfo
  %i.bfq = mul i64 %i.bfn, %i.bfp
  %i.bfr = load i64, ptr %i.beb, align 16, !tbaa !71, !noalias !85 ; 4 uses
  %i.bfs = mul i64 %i.bfq, %i.bfr
  %i.bft = getelementptr inbounds nuw i8, ptr %i.bfm, i64 %i.bfs
  %i.bfu = load i32, ptr %i.bec, align 8, !tbaa !74, !noalias !85
  %i.bfv = load ptr, ptr %i.bed, align 16, !tbaa !42, !noalias !85
  %i.bfw = sext i32 %i.bfj to i64
  %i.bfx = sext i32 %i.bfk to i64
  %i.bfy = mul nsw i64 %i.bfx, %i.bfw             ; 2 uses
  %i.bfz = mul i64 %i.bfr, %i.bfy
  %i.bga = add i64 %i.bfz, 15
  %i.bgb = and i64 %i.bga, -16
  %i.bgc = udiv i64 %i.bgb, %i.bfr
  %i.bgd = load i32, ptr %i.bee, align 8, !tbaa !70, !noalias !85 ; 2 uses
  %i.bge = add nsw i32 %i.bgd, -1
  %i.bgf = icmp eq i32 %i.bgd, 4
  %spec.select2313 = select i1 %i.bgf, i64 %i.bfy, i64 %i.bgc
  %i.bgg = getelementptr inbounds nuw i8, ptr %i.bez, i64 8
  %.pre1897 = load i32, ptr %i.bda, align 4, !tbaa !72, !noalias !86 ; 2 uses
  %.pre1898 = load i32, ptr %i.bdc, align 16, !tbaa !79, !noalias !86 ; 2 uses
  ...
  %i.bgh = getelementptr inbounds nuw i8, ptr %i.bez, i64 16
  %i.bgi = getelementptr inbounds nuw i8, ptr %i.bez, i64 24
end_hunk_1
...
bb.se:                                            ; preds = %bb.sd, %bb.sa
  %.pn280.pn.pn.pn = phi { ptr, i32 } [ %.pn280.pn, %bb.sd ], [ %i.bko, %bb.sa ]
...
._crit_edge1766:                                  ; preds = %_ZNSt6vectorIN4ncnn3MatESaIS1_EED2Ev.exit1269, %.preheader1406
  %i.bkr = getelementptr inbounds nuw i8, ptr %29, i64 8
  %i.bks = load ptr, ptr %i.bkr, align 8, !tbaa !41 ; 2 uses
  %.not.i707 = icmp eq ptr %i.bks, null
  br i1 %.not.i707, label %_ZN4ncnn3MatD2Ev.exit446, label %bb.sf

bb.sf:                                            ; preds = %._crit_edge1766
  %i.bkt = atomicrmw add ptr %i.bks, i32 -1 acq_rel, align 4
  %i.bku = icmp eq i32 %i.bkt, 1
  br i1 %i.bku, label %bb.sg, label %_ZN4ncnn3MatD2Ev.exit446

bb.sg:                                            ; preds = %bb.sf
  %i.bkv = getelementptr inbounds nuw i8, ptr %29, i64 32
  %i.bkw = load ptr, ptr %i.bkv, align 16, !tbaa !42 ; 3 uses
  %.not3.i708 = icmp eq ptr %i.bkw, null
  %i.bkx = load ptr, ptr %29, align 16, !tbaa !43 ; 3 uses
  br i1 %.not3.i708, label %bb.si, label %bb.sh

bb.sh:                                            ; preds = %bb.sg
  %i.bky = load ptr, ptr %i.bkw, align 8, !tbaa !34
  %i.bkz = getelementptr inbounds nuw i8, ptr %i.bky, i64 24
  %i.bla = load ptr, ptr %i.bkz, align 8
  invoke void %i.bla(ptr noundef nonnull align 8 dereferenceable(8) %i.bkw, ptr noundef %i.bkx)
          to label %_ZN4ncnn3MatD2Ev.exit446 unwind label %bb.sk, !inline_history !0

bb.si:                                            ; preds = %bb.sg
  %.not.i1010 = icmp eq ptr %i.bkx, null
  br i1 %.not.i1010, label %_ZN4ncnn3MatD2Ev.exit446, label %bb.sj

bb.sj:                                            ; preds = %bb.si
  call void @free(ptr noundef nonnull %i.bkx) #15
...
bb.sk:                                            ; preds = %bb.sh
  ...
  call void @__clang_call_terminate(ptr %i.blc) #18
  unreachable

_ZN4ncnn3MatD2Ev.exit446:                         ; preds = %bb.sf, %._crit_edge1766, %bb.sh, %bb.si, %bb.sj
  call void @llvm.lifetime.end.p0(ptr nonnull %29) #15
  %i.bld = getelementptr inbounds nuw i8, ptr %28, i64 8
  %i.ble = load ptr, ptr %i.bld, align 8, !tbaa !41 ; 2 uses
  %.not.i711 = icmp eq ptr %i.ble, null
  br i1 %.not.i711, label %_ZN4ncnn3MatD2Ev.exit445, label %bb.sl

bb.sl:                                            ; preds = %_ZN4ncnn3MatD2Ev.exit446
  %i.blf = atomicrmw add ptr %i.ble, i32 -1 acq_rel, align 4
  %i.blg = icmp eq i32 %i.blf, 1
  br i1 %i.blg, label %bb.sm, label %_ZN4ncnn3MatD2Ev.exit445

bb.sm:                                            ; preds = %bb.sl
  %i.blh = getelementptr inbounds nuw i8, ptr %28, i64 32
  %i.bli = load ptr, ptr %i.blh, align 16, !tbaa !42 ; 3 uses
  %.not3.i712 = icmp eq ptr %i.bli, null
  %i.blj = load ptr, ptr %28, align 16, !tbaa !43 ; 3 uses
  br i1 %.not3.i712, label %bb.so, label %bb.sn

bb.sn:                                            ; preds = %bb.sm
  %i.blk = load ptr, ptr %i.bli, align 8, !tbaa !34
  %i.bll = getelementptr inbounds nuw i8, ptr %i.blk, i64 24
  %i.blm = load ptr, ptr %i.bll, align 8
  invoke void %i.blm(ptr noundef nonnull align 8 dereferenceable(8) %i.bli, ptr noundef %i.blj)
          to label %_ZN4ncnn3MatD2Ev.exit445 unwind label %bb.sq, !inline_history !0

bb.so:                                            ; preds = %bb.sm
  %.not.i1008 = icmp eq ptr %i.blj, null
  br i1 %.not.i1008, label %_ZN4ncnn3MatD2Ev.exit445, label %bb.sp

bb.sp:                                            ; preds = %bb.so
  call void @free(ptr noundef nonnull %i.blj) #15
  br label %_ZN4ncnn3MatD2Ev.exit445

bb.sq:                                            ; preds = %bb.sn
  %i.bln = landingpad { ptr, i32 }
          catch ptr null
  %i.blo = extractvalue { ptr, i32 } %i.bln, 0
  call void @__clang_call_terminate(ptr %i.blo) #18
  unreachable
...
bb.sr:                                            ; preds = %bb.se, %bb.rj
  ...
  %i.blp = getelementptr inbounds nuw i8, ptr %29, i64 8
  %i.blq = load ptr, ptr %i.blp, align 8, !tbaa !41 ; 2 uses
  %.not.i715 = icmp eq ptr %i.blq, null
  br i1 %.not.i715, label %_ZN4ncnn3MatD2Ev.exit444, label %bb.ss

bb.ss:                                            ; preds = %bb.sr
  %i.blr = atomicrmw add ptr %i.blq, i32 -1 acq_rel, align 4
  %i.bls = icmp eq i32 %i.blr, 1
  br i1 %i.bls, label %bb.st, label %_ZN4ncnn3MatD2Ev.exit444

bb.st:                                            ; preds = %bb.ss
  %i.blt = getelementptr inbounds nuw i8, ptr %29, i64 32
  %i.blu = load ptr, ptr %i.blt, align 16, !tbaa !42 ; 3 uses
  %.not3.i716 = icmp eq ptr %i.blu, null
  %i.blv = load ptr, ptr %29, align 16, !tbaa !43 ; 3 uses
  br i1 %.not3.i716, label %bb.sv, label %bb.su

bb.su:                                            ; preds = %bb.st
  %i.blw = load ptr, ptr %i.blu, align 8, !tbaa !34
  %i.blx = getelementptr inbounds nuw i8, ptr %i.blw, i64 24
  %i.bly = load ptr, ptr %i.blx, align 8
  invoke void %i.bly(ptr noundef nonnull align 8 dereferenceable(8) %i.blu, ptr noundef %i.blv)
          to label %_ZN4ncnn3MatD2Ev.exit444 unwind label %bb.sx, !inline_history !0

bb.sv:                                            ; preds = %bb.st
  %.not.i1006 = icmp eq ptr %i.blv, null
  br i1 %.not.i1006, label %_ZN4ncnn3MatD2Ev.exit444, label %bb.sw

bb.sw:                                            ; preds = %bb.sv
  call void @free(ptr noundef nonnull %i.blv) #15
  br label %_ZN4ncnn3MatD2Ev.exit444

bb.sx:                                            ; preds = %bb.su
  %i.blz = landingpad { ptr, i32 }
          catch ptr null
  %i.bma = extractvalue { ptr, i32 } %i.blz, 0
  call void @__clang_call_terminate(ptr %i.bma) #18
  unreachable
...
_ZN4ncnn3MatD2Ev.exit444:                         ; preds = %bb.sw, %bb.sv, %bb.su, %bb.sr, %bb.ss, %bb.ri
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %29) #15
  %i.bmb = getelementptr inbounds nuw i8, ptr %28, i64 8
  %i.bmc = load ptr, ptr %i.bmb, align 8, !tbaa !41 ; 2 uses
  %.not.i719 = icmp eq ptr %i.bmc, null
  br i1 %.not.i719, label %_ZN4ncnn3MatD2Ev.exit443, label %bb.sy

bb.sy:                                            ; preds = %_ZN4ncnn3MatD2Ev.exit444
  %i.bmd = atomicrmw add ptr %i.bmc, i32 -1 acq_rel, align 4
  %i.bme = icmp eq i32 %i.bmd, 1
  br i1 %i.bme, label %bb.sz, label %_ZN4ncnn3MatD2Ev.exit443

bb.sz:                                            ; preds = %bb.sy
  %i.bmf = getelementptr inbounds nuw i8, ptr %28, i64 32
  %i.bmg = load ptr, ptr %i.bmf, align 16, !tbaa !42 ; 3 uses
  %.not3.i720 = icmp eq ptr %i.bmg, null
  %i.bmh = load ptr, ptr %28, align 16, !tbaa !43 ; 3 uses
  br i1 %.not3.i720, label %bb.tb, label %bb.ta

bb.ta:                                            ; preds = %bb.sz
  %i.bmi = load ptr, ptr %i.bmg, align 8, !tbaa !34
...
bb.tb:                                            ; preds = %bb.sz
  %.not.i1004 = icmp eq ptr %i.bmh, null
  br i1 %.not.i1004, label %_ZN4ncnn3MatD2Ev.exit443, label %bb.tc

bb.tc:                                            ; preds = %bb.tb
  call void @free(ptr noundef nonnull %i.bmh) #15
...
bb.td:                                            ; preds = %bb.ta
  ...
  call void @__clang_call_terminate(ptr %i.bmm) #18
  unreachable
...
bb.te:                                            ; preds = %bb.qz
  ...
  %i.bmn = icmp eq i32 %i.e, 3
  br i1 %i.bmn, label %bb.tf, label %bb.tg

bb.tf:                                            ; preds = %bb.te
  %i.bmo = getelementptr inbounds nuw i8, ptr %i.a, i64 44
  %i.bmp = load i32, ptr %i.bmo, align 4, !tbaa !72
  %i.bmq = getelementptr inbounds nuw i8, ptr %i.a, i64 48
  %i.bmr = load i32, ptr %i.bmq, align 8, !tbaa !79
  %i.bms = getelementptr inbounds nuw i8, ptr %i.a, i64 56
  %i.bmt = load i32, ptr %i.bms, align 8, !tbaa !76
  call void @_ZNK4ncnn3Mat7reshapeEiiiiPNS_9AllocatorE(ptr dead_on_unwind nonnull writable sret(%"class.ncnn::Mat") align 8 %32, ptr noundef nonnull align 8 dereferenceable(72) %i.a, i32 noundef %i.bmp, i32 noundef %i.bmr, i32 noundef %i.bmt, i32 noundef 1, ptr noundef null)
  br label %_ZN4ncnn3Mat6addrefEv.exit1112

bb.tg:                                            ; preds = %bb.te
  %i.bmu = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  %i.bmv = load ptr, ptr %i.bmu, align 8, !tbaa !41 ; 2 uses
  ...
  store i32 %i.bna, ptr %i.bmy, align 8, !tbaa !74
  %i.bnb = getelementptr inbounds nuw i8, ptr %32, i64 32
  %i.bnc = getelementptr inbounds nuw i8, ptr %i.a, i64 32
  ...
  store i64 %i.bnj, ptr %i.bnh, align 16, !tbaa !39
  %.not.i1111 = icmp eq ptr %i.bmv, null
  br i1 %.not.i1111, label %_ZN4ncnn3Mat6addrefEv.exit1112, label %bb.th

bb.th:                                            ; preds = %bb.tg
  %i.bnk = atomicrmw add ptr %i.bmv, i32 1 acq_rel, align 4 ; 0 uses
  br label %_ZN4ncnn3Mat6addrefEv.exit1112

_ZN4ncnn3Mat6addrefEv.exit1112:                   ; preds = %bb.th, %bb.tg, %bb.tf
  call void @llvm.lifetime.start.p0(ptr nonnull %33) #15
  %i.bnl = icmp eq i32 %i.g, 3
  br i1 %i.bnl, label %bb.ti, label %bb.tj

bb.ti:                                            ; preds = %_ZN4ncnn3Mat6addrefEv.exit1112
  %i.bnm = getelementptr inbounds nuw i8, ptr %i.a, i64 116
  %i.bnn = load i32, ptr %i.bnm, align 4, !tbaa !72
  %i.bno = getelementptr inbounds nuw i8, ptr %i.a, i64 120
  %i.bnp = load i32, ptr %i.bno, align 8, !tbaa !79
  %i.bnq = getelementptr inbounds nuw i8, ptr %i.a, i64 128
  %i.bnr = load i32, ptr %i.bnq, align 8, !tbaa !76
  invoke void @_ZNK4ncnn3Mat7reshapeEiiiiPNS_9AllocatorE(ptr dead_on_unwind nonnull writable sret(%"class.ncnn::Mat") align 8 %33, ptr noundef nonnull align 8 dereferenceable(72) %i.b, i32 noundef %i.bnn, i32 noundef %i.bnp, i32 noundef %i.bnr, i32 noundef 1, ptr noundef null)
          to label %_ZN4ncnn3Mat6addrefEv.exit1114 unwind label %bb.tm

bb.tj:                                            ; preds = %_ZN4ncnn3Mat6addrefEv.exit1112
  %i.bns = getelementptr inbounds nuw i8, ptr %i.a, i64 80
  %i.bnt = load ptr, ptr %i.bns, align 8, !tbaa !41 ; 2 uses
  %i.bnu = load <2 x ptr>, ptr %i.b, align 8, !tbaa !73
  store <2 x ptr> %i.bnu, ptr %33, align 16, !tbaa !73
  %i.bnv = getelementptr inbounds nuw i8, ptr %33, i64 16
  %i.bnw = getelementptr inbounds nuw i8, ptr %i.a, i64 88
  %i.bnx = load i64, ptr %i.bnw, align 8, !tbaa !71
  store i64 %i.bnx, ptr %i.bnv, align 16, !tbaa !71
  %i.bny = getelementptr inbounds nuw i8, ptr %33, i64 24
  %i.bnz = getelementptr inbounds nuw i8, ptr %i.a, i64 96
  %i.boa = load i32, ptr %i.bnz, align 8, !tbaa !74
  store i32 %i.boa, ptr %i.bny, align 8, !tbaa !74
  %i.bob = getelementptr inbounds nuw i8, ptr %33, i64 32
  %i.boc = getelementptr inbounds nuw i8, ptr %i.a, i64 104
  %i.bod = load ptr, ptr %i.boc, align 8, !tbaa !42
  store ptr %i.bod, ptr %i.bob, align 16, !tbaa !42
  %i.boe = getelementptr inbounds nuw i8, ptr %33, i64 40
  %i.bof = load <4 x i32>, ptr %i.f, align 8, !tbaa !75
  store <4 x i32> %i.bof, ptr %i.boe, align 8, !tbaa !75
  %i.bog = getelementptr inbounds nuw i8, ptr %33, i64 56
  %i.boh = getelementptr inbounds nuw i8, ptr %i.a, i64 128
  %i.boi = load i32, ptr %i.boh, align 8, !tbaa !76
  store i32 %i.boi, ptr %i.bog, align 8, !tbaa !76
  %i.boj = getelementptr inbounds nuw i8, ptr %33, i64 64
  %i.bok = getelementptr inbounds nuw i8, ptr %i.a, i64 136
  %i.bol = load i64, ptr %i.bok, align 8, !tbaa !39
  store i64 %i.bol, ptr %i.boj, align 16, !tbaa !39
  %.not.i1113 = icmp eq ptr %i.bnt, null
  br i1 %.not.i1113, label %_ZN4ncnn3Mat6addrefEv.exit1114, label %bb.tk

bb.tk:                                            ; preds = %bb.tj
  %i.bom = atomicrmw add ptr %i.bnt, i32 1 acq_rel, align 4 ; 0 uses
  br label %_ZN4ncnn3Mat6addrefEv.exit1114

_ZN4ncnn3Mat6addrefEv.exit1114:                   ; preds = %bb.tk, %bb.tj, %bb.ti
  %i.bon = getelementptr inbounds nuw i8, ptr %32, i64 48 ; 2 uses
  %i.boo = load i32, ptr %i.bon, align 16, !tbaa !79
  %i.bop = getelementptr inbounds nuw i8, ptr %0, i64 208
  %i.boq = load i32, ptr %i.bop, align 8, !tbaa !32
  %i.bor = icmp eq i32 %i.boq, 0
  %i.bos = getelementptr inbounds nuw i8, ptr %33, i64 44 ; 3 uses
  %i.bot = load i32, ptr %i.bos, align 4
  %i.bou = getelementptr inbounds nuw i8, ptr %33, i64 48 ; 2 uses
  %i.bov = load i32, ptr %i.bou, align 16
  %i.bow = select i1 %i.bor, i32 %i.bot, i32 %i.bov
  %i.box = getelementptr inbounds nuw i8, ptr %32, i64 52 ; 2 uses
  %i.boy = getelementptr inbounds nuw i8, ptr %33, i64 52 ; 2 uses
  %i.boz = load i32, ptr %i.box, align 4, !tbaa !75
  %i.bpa = load i32, ptr %i.boy, align 4, !tbaa !75
  %i.bpb = call i32 @llvm.smax.i32(i32 %i.boz, i32 %i.bpa) ; 3 uses
  %i.bpc = getelementptr inbounds nuw i8, ptr %32, i64 56 ; 2 uses
  %i.bpd = getelementptr inbounds nuw i8, ptr %33, i64 56 ; 2 uses
  %i.bpe = load i32, ptr %i.bpc, align 8, !tbaa !75
  %i.bpf = load i32, ptr %i.bpd, align 8, !tbaa !75
  %i.bpg = call i32 @llvm.smax.i32(i32 %i.bpe, i32 %i.bpf) ; 3 uses
  %i.bph = getelementptr inbounds nuw i8, ptr %3, i64 8
  %i.bpi = load ptr, ptr %i.bph, align 8, !tbaa !78
  invoke void @_ZN4ncnn3Mat6createEiiiimPNS_9AllocatorE(ptr noundef nonnull align 8 dereferenceable(72) %i.c, i32 noundef %i.bow, i32 noundef %i.boo, i32 noundef %i.bpb, i32 noundef %i.bpg, i64 noundef %i.i, ptr noundef %i.bpi)
          to label %bb.tl unwind label %bb.tn

bb.tl:                                            ; preds = %_ZN4ncnn3Mat6addrefEv.exit1114
  %i.bpj = load ptr, ptr %i.c, align 8, !tbaa !43
  %i.bpk = icmp eq ptr %i.bpj, null
  br i1 %i.bpk, label %.critedge349, label %_ZNK4ncnn3Mat5emptyEv.exit

_ZNK4ncnn3Mat5emptyEv.exit:                       ; preds = %bb.tl
  %i.bpl = getelementptr inbounds nuw i8, ptr %i.c, i64 64 ; 2 uses
  %i.bpm = load i64, ptr %i.bpl, align 8, !tbaa !39
  %i.bpn = getelementptr inbounds nuw i8, ptr %i.c, i64 56
  %i.bpo = load i32, ptr %i.bpn, align 8, !tbaa !76
  %i.bpp = sext i32 %i.bpo to i64
  %i.bpq = mul i64 %i.bpm, %i.bpp
  %i.bpr = icmp eq i64 %i.bpq, 0
  br i1 %i.bpr, label %.critedge349, label %.preheader1407

.preheader1407:                                   ; preds = %_ZNK4ncnn3Mat5emptyEv.exit
  %i.bps = icmp sgt i32 %i.bpg, 0
  br i1 %i.bps, label %.lr.ph1762, label %._crit_edge1763.split

.lr.ph1762:                                       ; preds = %.preheader1407
  %i.bpt = icmp sgt i32 %i.bpb, 0
  %i.bpu = getelementptr inbounds nuw i8, ptr %34, i64 16 ; 2 uses
  %i.bpv = getelementptr inbounds nuw i8, ptr %34, i64 8 ; 2 uses
  %i.bpw = getelementptr inbounds nuw i8, ptr %32, i64 44 ; 2 uses
  %i.bpx = getelementptr inbounds nuw i8, ptr %32, i64 64
  %i.bpy = getelementptr inbounds nuw i8, ptr %32, i64 16
  %i.bpz = getelementptr inbounds nuw i8, ptr %32, i64 24
  %i.bqa = getelementptr inbounds nuw i8, ptr %32, i64 32
  %i.bqb = getelementptr inbounds nuw i8, ptr %33, i64 64
  %i.bqc = getelementptr inbounds nuw i8, ptr %33, i64 16
  %i.bqd = getelementptr inbounds nuw i8, ptr %33, i64 24
  %i.bqe = getelementptr inbounds nuw i8, ptr %33, i64 32
  %i.bqf = getelementptr inbounds nuw i8, ptr %35, i64 16 ; 2 uses
  %i.bqg = getelementptr inbounds nuw i8, ptr %35, i64 8 ; 2 uses
  %i.bqh = getelementptr inbounds nuw i8, ptr %i.c, i64 44 ; 2 uses
  %i.bqi = getelementptr inbounds nuw i8, ptr %i.c, i64 48
  %i.bqj = getelementptr inbounds nuw i8, ptr %i.c, i64 16
  %i.bqk = getelementptr inbounds nuw i8, ptr %i.c, i64 24
  %i.bql = getelementptr inbounds nuw i8, ptr %i.c, i64 32
  %i.bqm = getelementptr inbounds nuw i8, ptr %0, i64 216
  br i1 %i.bpt, label %.lr.ph.preheader, label %._crit_edge1763.split

.lr.ph.preheader:                                 ; preds = %.lr.ph1762
  %wide.trip.count1784 = zext nneg i32 %i.bpg to i64
  %wide.trip.count = zext nneg i32 %i.bpb to i64
  br label %.lr.ph
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %._crit_edge
  ...
  %i.bqp = load i32, ptr %i.bpc, align 8, !tbaa !76
  %i.bqq = icmp eq i32 %i.bqp, 1
  %i.bqr = load i32, ptr %i.bpd, align 8, !tbaa !76
  %i.bqs = icmp eq i32 %i.bqr, 1
  %i.bqt = and i64 %indvars.iv1781, 4294967295
  %i.bqu = select i1 %i.bqq, i64 0, i64 %i.bqt
  %i.bqv = and i64 %indvars.iv1781, 4294967295
  %i.bqw = select i1 %i.bqs, i64 0, i64 %i.bqv
  br label %bb.to
...
bb.to:                                            ; preds = %.lr.ph, %_ZNSt6vectorIN4ncnn3MatESaIS1_EED2Ev.exit1309
  ...
  %i.bqx = load i32, ptr %i.box, align 4, !tbaa !80
  %i.bqy = load i32, ptr %i.boy, align 4, !tbaa !80
  call void @llvm.lifetime.start.p0(ptr nonnull %34) #15
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %34, i8 0, i64 24, i1 false)
  %i.bqz = invoke noalias noundef nonnull dereferenceable(144) ptr @_Znwm(i64 noundef 144) #17
          to label %.noexc351 unwind label %bb.ue ; 19 uses

.noexc351:                                        ; preds = %bb.to
  %i.bra = icmp eq i32 %i.bqy, 1
  %i.brb = icmp eq i32 %i.bqx, 1
  store ptr %i.bqz, ptr %34, align 8, !tbaa !35
  %i.brc = getelementptr inbounds nuw i8, ptr %i.bqz, i64 144
  store ptr %i.brc, ptr %i.bpu, align 8, !tbaa !38
  %i.brd = getelementptr inbounds nuw i8, ptr %i.bqz, i64 32
  %i.bre = getelementptr inbounds nuw i8, ptr %i.bqz, i64 64
  %i.brf = getelementptr inbounds nuw i8, ptr %i.bqz, i64 72
  %i.brg = getelementptr inbounds nuw i8, ptr %i.bqz, i64 144
  store ptr %i.brg, ptr %i.bpv, align 8, !tbaa !40
  %i.brh = load ptr, ptr %32, align 16, !tbaa !43, !noalias !88
  %i.bri = load i64, ptr %i.bpx, align 16, !tbaa !39, !noalias !88
  %i.brj = mul i64 %i.bri, %i.bqu
  %i.brk = load i64, ptr %i.bpy, align 16, !tbaa !71, !noalias !88 ; 3 uses
  %i.brl = mul i64 %i.brj, %i.brk
  %i.brm = getelementptr inbounds nuw i8, ptr %i.brh, i64 %i.brl
  %i.brn = load i32, ptr %i.bpz, align 8, !tbaa !74, !noalias !88
  %i.bro = load ptr, ptr %i.bqa, align 16, !tbaa !42, !noalias !88
  %i.brp = and i64 %indvars.iv, 4294967295
  %i.brq = select i1 %i.brb, i64 0, i64 %i.brp
  %i.brr = getelementptr inbounds nuw i8, ptr %i.bqz, i64 8
  %.pre1886 = load i64, ptr %i.bqc, align 16, !tbaa !71, !noalias !89 ; 3 uses
  %.pre1887 = load i32, ptr %i.bqd, align 8, !tbaa !74, !noalias !89
  %.pre1888 = load ptr, ptr %i.bqe, align 16, !tbaa !42, !noalias !89
  %.pre1885 = load i64, ptr %i.bqb, align 16, !tbaa !39, !noalias !89
  %.pre1884 = load ptr, ptr %33, align 16, !tbaa !43, !noalias !89
  %i.brs = getelementptr inbounds nuw i8, ptr %i.bqz, i64 16
  %i.brt = getelementptr inbounds nuw i8, ptr %i.bqz, i64 24
  %i.bru = getelementptr inbounds nuw i8, ptr %i.bqz, i64 40
end_hunk_2
