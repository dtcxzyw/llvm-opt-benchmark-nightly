...
.sink.split.i:                                    ; preds = %_ZN4ncnn3MatD2Ev.exit976.us.us.i, %_ZN4ncnn3MatD2Ev.exit975.us.us.i, %_ZN4ncnn3MatD2Ev.exit973.us.us.i
  ...
  %i.ur = fadd fast <4 x float> %i.uq, %.323152517.us.us.i
  ...
  %i.uv = fadd fast <4 x float> %i.uu, %.223262516.us.us.i
  ...
  %i.uz = fadd fast <4 x float> %i.uy, %.223412515.us.us.i
  ...
  %i.vd = fadd fast <4 x float> %i.vc, %.223562514.us.us.i
  ...
  %i.vh = fadd fast <4 x float> %i.ur, %i.vg
  ...
  %i.vl = fadd fast <4 x float> %i.uv, %i.vk
  ...
  %i.vp = fadd fast <4 x float> %i.uz, %i.vo
  ...
  %i.vt = fadd fast <4 x float> %i.vd, %i.vs
  br label %bb.be
...
bb.by:                                            ; preds = %._crit_edge2717.i
  ...
  %i.ajc = fadd fast <4 x float> %i.aip, splat (float 1.000000e+00)
  %i.ajd = fadd fast <4 x float> %i.ajc, %i.ajb
...
bb.bz:                                            ; preds = %._crit_edge2717.i
  ...
  %i.aki = fadd fast <4 x float> %i.ajv, splat (float 1.000000e+00)
  %i.akj = fadd fast <4 x float> %i.aki, %i.akh
  ...
  %i.alw = fmul fast <4 x float> %i.alv, %i.ale
  %reass.mul.i.a = fmul fast <4 x float> %i.ald, splat (float f0x3F317218)
  %reass.add2451.i = fadd fast <4 x float> %i.alw, splat (float -5.000000e-01)
  %reass.mul2452.i = fmul fast <4 x float> %i.alf, %reass.add2451.i
  %i.alx = fadd fast <4 x float> %reass.mul.i.a, %i.ale
  ...
  %i.amx = fadd fast <4 x float> %i.amk, splat (float 1.000000e+00)
  %i.amy = fadd fast <4 x float> %i.amx, %i.amw
...
_ZN4ncnn3MatD2Ev.exit948.us.us.us.i:              ; preds = %bb.cu
  ...
  %i.bbl = fadd fast <2 x float> %i.bbk, %i.bap
  ...
  %i.bbq = fadd fast <2 x float> %i.bbl, %i.bbp
...
_ZN4ncnn3MatD2Ev.exit938.us.us.us.i:              ; preds = %bb.dw
  ...
  %i.brb = fadd fast float %i.bra, %.37953081.us.us.us.i
  ...
  %i.brg = fadd fast float %i.brb, %i.brf
...
.sink.split.i:                                    ; preds = %_ZN4ncnn3MatD2Ev.exit976.us.us.i, %_ZN4ncnn3MatD2Ev.exit975.us.us.i, %_ZN4ncnn3MatD2Ev.exit973.us.us.i
  ...
  %i.sm = fadd fast <4 x float> %i.sl, %.323852587.us.us.i
  ...
  %i.su = fadd fast <4 x float> %i.st, %.223962586.us.us.i
  ...
  %i.tc = fadd fast <4 x float> %i.tb, %.224112585.us.us.i
  ...
  %i.tk = fadd fast <4 x float> %i.tj, %.224212584.us.us.i
  ...
  %i.ts = fadd fast <4 x float> %i.sm, %i.tr
  ...
  %i.ua = fadd fast <4 x float> %i.su, %i.tz
  ...
  %i.ui = fadd fast <4 x float> %i.tc, %i.uh
  ...
  %i.uq = fadd fast <4 x float> %i.tk, %i.up
  br label %bb.ad
...
bb.ax:                                            ; preds = %._crit_edge2787.i
  ...
  %i.akw = fadd fast <4 x float> %i.akj, splat (float 1.000000e+00)
  %i.akx = fadd fast <4 x float> %i.akw, %i.akv
...
bb.ay:                                            ; preds = %._crit_edge2787.i
  ...
  %i.amc = fadd fast <4 x float> %i.alp, splat (float 1.000000e+00)
  %i.amd = fadd fast <4 x float> %i.amc, %i.amb
  ...
  %i.anq = fmul fast <4 x float> %i.anp, %i.amy
  %reass.mul.i.a = fmul fast <4 x float> %i.amx, splat (float f0x3F317218)
  %reass.add2521.i = fadd fast <4 x float> %i.anq, splat (float -5.000000e-01)
  %reass.mul2522.i = fmul fast <4 x float> %i.amz, %reass.add2521.i
  %i.anr = fadd fast <4 x float> %reass.mul.i.a, %i.amy
  ...
  %i.aor = fadd fast <4 x float> %i.aoe, splat (float 1.000000e+00)
  %i.aos = fadd fast <4 x float> %i.aor, %i.aoq
...
_ZN4ncnn3MatD2Ev.exit948.us.us.us.i:              ; preds = %bb.bt
  ...
  %i.bhl = fadd fast <2 x float> %i.bhk, %i.bgg
  ...
  %i.bhr = fadd fast <2 x float> %i.bhl, %i.bhq
...
_ZN4ncnn3MatD2Ev.exit938.us.us.us.i:              ; preds = %bb.cv
  ...
  %i.bzr = zext i16 %i.bzo to i32
  %i.bzs = insertelement <2 x i32> poison, i32 %i.bzr, i64 0
  %i.bzt = insertelement <2 x i32> %i.bzs, i32 %i.bzq, i64 1
  ...
  %i.cac = fadd fast float %i.cab, %.37953151.us.us.us.i
  %i.cad = extractelement <2 x float> %i.caa, i64 1
  %i.cae = fadd fast float %i.cac, %i.cad
  br label %.loopexit.us.us.us.i
...
.sink.split:                                      ; preds = %_ZN4ncnn3MatD2Ev.exit400.us, %_ZN4ncnn3MatD2Ev.exit402.us, %bb.j
  ...
  %i.jg = fadd fast <8 x float> %i.jf, %.311801265.us
  ...
  %i.jk = fadd fast <8 x float> %i.jj, %.211841264.us
  ...
  %i.jo = fadd fast <8 x float> %i.jn, %.212021263.us
  ...
  %i.js = fadd fast <8 x float> %i.jr, %.212151262.us
  ...
  %i.jw = fadd fast <8 x float> %i.jg, %i.jv
  ...
  %i.ka = fadd fast <8 x float> %i.jk, %i.jz
  ...
  %i.ke = fadd fast <8 x float> %i.jo, %i.kd
  ...
  %i.ki = fadd fast <8 x float> %i.js, %i.kh
  br label %bb.k
...
.noexc550:                                        ; preds = %._crit_edge1414
  ...
  %i.xz = fadd fast <8 x float> %i.xm, splat (float 1.000000e+00)
  %i.ya = fadd fast <8 x float> %i.xz, %i.xy
...
.noexc551:                                        ; preds = %._crit_edge1414
  ...
  %i.ze = fadd fast <8 x float> %i.yr, splat (float 1.000000e+00)
  %i.zf = fadd fast <8 x float> %i.ze, %i.zd
  ...
  %i.aac = fmul fast <8 x float> %i.aab, %i.aab
  ...
  %i.aat = fmul fast <8 x float> %i.aas, %i.aab
  %reass.mul.a = fmul fast <8 x float> %i.aaa, splat (float f0x3F317218)
  %reass.add1230 = fadd fast <8 x float> %i.aat, splat (float -5.000000e-01)
  %reass.mul1231 = fmul fast <8 x float> %i.aac, %reass.add1230
  %i.aau = fadd fast <8 x float> %reass.mul.a, %i.aab
  ...
  %i.abt = fadd fast <8 x float> %i.abg, splat (float 1.000000e+00)
  %i.abu = fadd fast <8 x float> %i.abt, %i.abs
...
.sink.split:                                      ; preds = %_ZN4ncnn3MatD2Ev.exit400.us, %_ZN4ncnn3MatD2Ev.exit402.us, %bb.j
  ...
  %i.li = fadd fast <8 x float> %i.lh, %.312531338.us
  ...
  %i.lq = fadd fast <8 x float> %i.lp, %.212571337.us
  ...
  %i.ly = fadd fast <8 x float> %i.lx, %.212751336.us
  ...
  %i.mg = fadd fast <8 x float> %i.mf, %.212881335.us
  ...
  %i.mo = fadd fast <8 x float> %i.li, %i.mn
  ...
  %i.mw = fadd fast <8 x float> %i.lq, %i.mv
  ...
  %i.ne = fadd fast <8 x float> %i.ly, %i.nd
  ...
  %i.nm = fadd fast <8 x float> %i.mg, %i.nl
  br label %bb.k
...
.noexc550:                                        ; preds = %._crit_edge1487
  ...
  %i.adv = fadd fast <8 x float> %i.adi, splat (float 1.000000e+00)
  %i.adw = fadd fast <8 x float> %i.adv, %i.adu
...
.noexc551:                                        ; preds = %._crit_edge1487
  ...
  %i.afa = fadd fast <8 x float> %i.aen, splat (float 1.000000e+00)
  %i.afb = fadd fast <8 x float> %i.afa, %i.aez
  ...
  %i.afy = fmul fast <8 x float> %i.afx, %i.afx
  ...
  %i.agp = fmul fast <8 x float> %i.ago, %i.afx
  %reass.mul.a = fmul fast <8 x float> %i.afw, splat (float f0x3F317218)
  %reass.add1303 = fadd fast <8 x float> %i.agp, splat (float -5.000000e-01)
  %reass.mul1304 = fmul fast <8 x float> %i.afy, %reass.add1303
  %i.agq = fadd fast <8 x float> %reass.mul.a, %i.afx
  ...
  %i.ahp = fadd fast <8 x float> %i.ahc, splat (float 1.000000e+00)
