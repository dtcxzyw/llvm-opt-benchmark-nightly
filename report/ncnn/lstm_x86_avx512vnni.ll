...
begin_hunk_0_@_ZN4ncnnL26lstm_transform_weight_int8ERKNS_3MatES2_S2_S2_S2_RS0_S3_S3_iiiiRKNS_6OptionE.omp_outlined:bb.a
  store i8 %i.atg, ptr %i.ath, align 1, !tbaa !25
  %i.ati = getelementptr inbounds nuw i8, ptr %i.hn, i64 %i.apt
  %i.atj = load i8, ptr %i.ati, align 1, !tbaa !25
  %i.atk = getelementptr inbounds nuw i8, ptr %.821132703, i64 31
  store i8 %i.atj, ptr %i.atk, align 1, !tbaa !25
  ...
  %i.atn = load i32, ptr %13, align 4, !tbaa !12  ; 2 uses
  %i.ato = trunc nuw i64 %i.atm to i32
  %i.atp = icmp sgt i32 %i.atn, %i.ato
  br i1 %i.atp, label %.lr.ph2706, label %.preheader2600.loopexit, !llvm.loop !56
...
._crit_edge2712:                                  ; preds = %.lr.ph2711, %.preheader2600
  ...
  %i.avv = load <4 x float>, ptr %i.avu, align 1, !tbaa !25
  ...
  %i.awa = load <4 x float>, ptr %i.avz, align 1, !tbaa !25
  ...
  %i.awf = load <4 x float>, ptr %i.awe, align 1, !tbaa !25
  %i.awg = getelementptr inbounds nuw [4 x i8], ptr %i.bt, i64 %indvars.iv3008
  %i.awh = load <4 x float>, ptr %i.awg, align 1, !tbaa !25
  ...
  %i.awk = load <4 x float>, ptr %i.awj, align 1, !tbaa !25
  ...
  %i.awn = load <4 x float>, ptr %i.awm, align 1, !tbaa !25
  ...
  %i.awq = load <4 x float>, ptr %i.awp, align 1, !tbaa !25
...
bb.d:                                             ; preds = %.lr.ph2797, %._crit_edge2794
  ...
  %i.bat = load i32, ptr %12, align 4, !tbaa !12  ; 2 uses
...
.lr.ph2721:                                       ; preds = %bb.d, %.lr.ph2721
  ...
  %i.bba = load <2 x i64>, ptr %i.baz, align 1, !tbaa !25
  store <2 x i64> %i.bba, ptr %.020652718, align 1, !tbaa !25
  %i.bbb = getelementptr inbounds nuw i8, ptr %.020652718, i64 16
  %i.bbc = getelementptr inbounds nuw i8, ptr %i.azh, i64 %indvars.iv3011
  %i.bbd = load <2 x i64>, ptr %i.bbc, align 1, !tbaa !25
  store <2 x i64> %i.bbd, ptr %i.bbb, align 1, !tbaa !25
  ...
  %i.bbg = load <2 x i64>, ptr %i.bbf, align 1, !tbaa !25
  store <2 x i64> %i.bbg, ptr %i.bbe, align 1, !tbaa !25
  %i.bbh = getelementptr inbounds nuw i8, ptr %.020652718, i64 48
  %i.bbi = getelementptr inbounds nuw i8, ptr %i.azl, i64 %indvars.iv3011
  %i.bbj = load <2 x i64>, ptr %i.bbi, align 1, !tbaa !25
  store <2 x i64> %i.bbj, ptr %i.bbh, align 1, !tbaa !25
  ...
  %i.bbm = load <2 x i64>, ptr %i.bbl, align 1, !tbaa !25
  store <2 x i64> %i.bbm, ptr %i.bbk, align 1, !tbaa !25
  %i.bbn = getelementptr inbounds nuw i8, ptr %.020652718, i64 80
  %i.bbo = getelementptr inbounds nuw i8, ptr %i.azp, i64 %indvars.iv3011
  %i.bbp = load <2 x i64>, ptr %i.bbo, align 1, !tbaa !25
  store <2 x i64> %i.bbp, ptr %i.bbn, align 1, !tbaa !25
  ...
  %i.bbs = load <2 x i64>, ptr %i.bbr, align 1, !tbaa !25
  store <2 x i64> %i.bbs, ptr %i.bbq, align 1, !tbaa !25
  ...
  %i.bbv = load <2 x i64>, ptr %i.bbu, align 1, !tbaa !25
  store <2 x i64> %i.bbv, ptr %i.bbt, align 1, !tbaa !25
  %i.bbw = load <32 x i8>, ptr %.020652718, align 1, !tbaa !25
  %i.bbx = load <32 x i8>, ptr %i.bbe, align 1, !tbaa !25
  %i.bby = load <32 x i8>, ptr %i.bbk, align 1, !tbaa !25
  %i.bbz = load <32 x i8>, ptr %i.bbq, align 1, !tbaa !25
  ...
  %i.bcg = load i32, ptr %12, align 4, !tbaa !12  ; 2 uses
  %i.bch = sext i32 %i.bcg to i64
  %i.bci = icmp slt i64 %i.bcf, %i.bch
  br i1 %i.bci, label %.lr.ph2721, label %._crit_edge2722.loopexit, !llvm.loop !59
...
.lr.ph2732:                                       ; preds = %.lr.ph2732.preheader, %.lr.ph2732
  ...
  %i.bdg = load i64, ptr %i.bdf, align 1, !tbaa !25
  store i64 %i.bdg, ptr %i.bde, align 1, !tbaa !25
  %i.bdh = getelementptr inbounds nuw i8, ptr %.120662729, i64 40
  %i.bdi = getelementptr inbounds nuw i8, ptr %i.azf, i64 %indvars.iv3014
  %i.bdj = load i64, ptr %i.bdi, align 1, !tbaa !25
  store i64 %i.bdj, ptr %i.bdh, align 1, !tbaa !25
  %i.bdk = getelementptr inbounds nuw i8, ptr %.120662729, i64 48
  %i.bdl = getelementptr inbounds nuw i8, ptr %i.azp, i64 %indvars.iv3014
  %i.bdm = load i64, ptr %i.bdl, align 1, !tbaa !25
  store i64 %i.bdm, ptr %i.bdk, align 1, !tbaa !25
  %i.bdn = getelementptr inbounds nuw i8, ptr %.120662729, i64 56
  %i.bdo = getelementptr inbounds nuw i8, ptr %i.azt, i64 %indvars.iv3014
  %i.bdp = load i64, ptr %i.bdo, align 1, !tbaa !25
  store i64 %i.bdp, ptr %i.bdn, align 1, !tbaa !25
  %i.bdq = load <32 x i8>, ptr %.120662729, align 1, !tbaa !25
  %i.bdr = load <32 x i8>, ptr %i.bde, align 1, !tbaa !25
  ...
  %i.bdv = load i32, ptr %12, align 4, !tbaa !12  ; 2 uses
  %i.bdw = trunc i64 %indvars.iv.next3015 to i32
  %i.bdx = or i32 %i.bdw, 7
  %i.bdy = icmp slt i32 %i.bdx, %i.bdv
  br i1 %i.bdy, label %.lr.ph2732, label %._crit_edge2733.loopexit, !llvm.loop !60
...
.lr.ph2742:                                       ; preds = %.lr.ph2742.preheader, %.lr.ph2742
  ...
  %i.bej = load i8, ptr %i.bei, align 1, !tbaa !25
end_hunk_0
