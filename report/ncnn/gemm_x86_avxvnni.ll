...
.lr.ph2288.i:                                     ; preds = %._crit_edge2279.i, %.lr.ph2288.i
  ...
  %i.akn = load i16, ptr %.1411932286.i, align 2, !tbaa !408
  ...
  br i1 %i.aky, label %.lr.ph2288.i, label %.preheader1876.i, !llvm.loop !346
...
.lr.ph2296.i:                                     ; preds = %.lr.ph2296.i.prol.loopexit, %.lr.ph2296.i
  ...
  br i1 %exitcond2958.not.i.1, label %._crit_edge2297.i, label %.lr.ph2296.i, !llvm.loop !347
...
._crit_edge2297.i:                                ; preds = %.lr.ph2296.i.prol.loopexit, %.lr.ph2296.i, %.preheader1876.i
  ...
  br i1 %exitcond2959.not.i, label %._crit_edge2304.i, label %.lr.ph2303.i, !llvm.loop !348
...
._crit_edge2304.i:                                ; preds = %._crit_edge2297.i, %.preheader1880.i
  ...
  br i1 %i.amg, label %.preheader1883.i, label %.preheader1875.i, !llvm.loop !349
...
.lr.ph2316.i:                                     ; preds = %.lr.ph2316.i.preheader, %.lr.ph2316.i
  ...
  br i1 %niter2027.ncmp.1.not, label %.unr-lcssa2012, label %.lr.ph2316.i, !llvm.loop !350
...
.lr.ph2336.i.prol:                                ; preds = %.lr.ph2336.i.preheader
  %i.aqb = load i16, ptr %.21321.lcssa.i, align 2, !tbaa !408
...
.lr.ph2327.i:                                     ; preds = %._crit_edge2317.i, %.lr.ph2327.i
  ...
  br i1 %i.arj, label %.lr.ph2327.i, label %.preheader1870.i, !llvm.loop !351
...
.lr.ph2336.i:                                     ; preds = %.lr.ph2336.i.prol.loopexit, %.lr.ph2336.i
  ...
  %i.arm = load i16, ptr %.313222334.i, align 2, !tbaa !408
...
begin_hunk_1_@_ZN4ncnn36gemm_transB_packed_tile_int8_avxvnniERKNS_3MatES2_RS0_iiiiii:bb.a
  ...
  br i1 %i.efj, label %.lr.ph2557.i, label %.loopexit1636, !llvm.loop !388
...
.loopexit1636:                                    ; preds = %.lr.ph2557.i, %vec.epilog.middle.block1629, %middle.block1598
  ...
  %i.efl = load i32, ptr %indvars.iv512, align 4, !tbaa !23 ; 2 uses
...
vector.body1492:                                  ; preds = %vector.body1492, %vector.ph1490
  ...
  br i1 %i.ehj, label %middle.block1519, label %vector.body1492, !llvm.loop !389
...
vec.epilog.iter.check1531:                        ; preds = %middle.block1519
  ...
  br i1 %min.epilog.iters.check1532, label %.lr.ph2570.i.preheader, label %vec.epilog.ph1533, !prof !22
...
vec.epilog.vector.body1535:                       ; preds = %vec.epilog.vector.body1535, %vec.epilog.ph1533
  ...
  br i1 %i.eil, label %vec.epilog.middle.block1550, label %vec.epilog.vector.body1535, !llvm.loop !390
...
.preheader.i:                                     ; preds = %.lr.ph2570.i, %middle.block1519, %vec.epilog.middle.block1550, %._crit_edge2558.i
  ...
  %.11094.lcssa.i = phi i32 [ %.01093.lcssa3203.i, %._crit_edge2558.i ], [ %i.eho, %vec.epilog.middle.block1550 ], [ %i.efw, %middle.block1519 ], [ %i.ete, %.lr.ph2570.i ] ; 5 uses
...
.lr.ph2587.i.preheader:                           ; preds = %.preheader.i
  %i.eiq = sub i32 %9, %.11094.lcssa.i            ; 2 uses
...
begin_hunk_2_@_ZN4ncnn36gemm_transB_packed_tile_int8_avxvnniERKNS_3MatES2_RS0_iiiiii:bb.a
  ...
  br i1 %i.evo, label %middle.block1410, label %vector.body1392, !llvm.loop !394
...
vec.epilog.iter.check1422:                        ; preds = %middle.block1410
  ...
  br i1 %min.epilog.iters.check1423, label %.lr.ph2606.i.preheader, label %vec.epilog.ph1424, !prof !22
...
vec.epilog.vector.body1426:                       ; preds = %vec.epilog.vector.body1426, %vec.epilog.ph1424
  ...
  br i1 %i.ewg, label %vec.epilog.middle.block1437, label %vec.epilog.vector.body1426, !llvm.loop !395
...
.lr.ph2606.i:                                     ; preds = %.lr.ph2606.i.preheader, %.lr.ph2606.i
  ...
  br i1 %exitcond2975.not.i, label %._crit_edge2607.i, label %.lr.ph2606.i, !llvm.loop !396
...
._crit_edge2607.i:                                ; preds = %.lr.ph2606.i, %middle.block1410, %vec.epilog.middle.block1437, %._crit_edge2588.i
  ...
  store i32 %.41111.lcssa.i, ptr %.182613.i, align 4, !tbaa !23
  %i.ewx = getelementptr inbounds nuw i8, ptr %.182613.i, i64 4
  store i32 %.41106.lcssa.i, ptr %i.ewx, align 4, !tbaa !23
  ...
  br i1 %i.exb, label %.lr.ph2614.i, label %.preheader1862.i, !llvm.loop !397
...
bb.ap:                                            ; preds = %.lr.ph2658.i
  %i.exc = load i32, ptr %.192657.i, align 4, !tbaa !23
  br label %bb.aq
...
vector.body1364:                                  ; preds = %vector.body1364, %vector.ph1362
  ...
  br i1 %i.exw, label %middle.block1380, label %vector.body1364, !llvm.loop !398
...
.lr.ph2623.i:                                     ; preds = %.lr.ph2623.i.preheader1649, %.lr.ph2623.i
  ...
  br i1 %i.eyi, label %.lr.ph2623.i, label %.loopexit, !llvm.loop !399
...
.loopexit:                                        ; preds = %.lr.ph2623.i, %middle.block1380
  ...
  %i.eyk = load i32, ptr %indvars.iv512, align 4, !tbaa !23
  %i.eyl = sub nsw i32 %.lcssa812, %i.eyk
  br label %._crit_edge2624.i

._crit_edge2624.i:                                ; preds = %.loopexit, %bb.aq
  %.01074.lcssa3213.i = phi i32 [ %i.amq, %.loopexit ], [ 0, %bb.aq ] ; 5 uses
...
.lr.ph2637.i.preheader:                           ; preds = %._crit_edge2624.i
  %i.eyo = sub i32 %10, %.01074.lcssa3213.i       ; 2 uses
...
vector.body1332:                                  ; preds = %vector.body1332, %vector.ph1330
  ...
  br i1 %i.ezo, label %middle.block1351, label %vector.body1332, !llvm.loop !400
...
.lr.ph2637.i:                                     ; preds = %.lr.ph2637.i.preheader1648, %.lr.ph2637.i
  ...
  br i1 %i.fai, label %.lr.ph2637.i, label %._crit_edge2638.i, !llvm.loop !401
...
vector.body1281:                                  ; preds = %vector.body1281, %vector.ph1279
  ...
  br i1 %i.fbs, label %middle.block1298, label %vector.body1281, !llvm.loop !402
...
vec.epilog.iter.check1310:                        ; preds = %middle.block1298
  ...
  br i1 %min.epilog.iters.check1311, label %.lr.ph2651.i.preheader, label %vec.epilog.ph1312, !prof !26
