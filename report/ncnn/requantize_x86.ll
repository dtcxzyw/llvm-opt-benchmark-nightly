...
_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit142.thread699: ; preds = %.lr.ph769
  ...
  %i.ge = fmul fast <4 x float> %i.fk, splat (float f0x3F317218)
  %reass.add753 = fadd fast <4 x float> %i.gd, splat (float -5.000000e-01)
  %reass.mul741.a = fmul fast <4 x float> %i.fm, %reass.add753
  %i.gf = fadd fast <4 x float> %i.ge, %i.fl
  ...
  %i.jk = fmul fast <4 x float> %i.jj, %i.jj
  ...
  %i.kb = fmul fast <4 x float> %i.ka, %i.jj
  %i.kc = fmul fast <4 x float> %i.ji, splat (float f0x3F317218)
  %reass.add755 = fadd fast <4 x float> %i.kb, splat (float -5.000000e-01)
  %reass.mul744 = fmul fast <4 x float> %i.jk, %reass.add755
  %i.kd = fadd fast <4 x float> %i.kc, %i.jj
...
bb.j:                                             ; preds = %.lr.ph776
  ...
  %i.qv = fmul fast <4 x float> %i.qu, %i.qu
  ...
  %i.rm = fmul fast <4 x float> %i.rl, %i.qu
  %i.rn = fmul fast <4 x float> %i.qt, splat (float f0x3F317218)
  %reass.add746 = fadd fast <4 x float> %i.rm, splat (float -5.000000e-01)
  %reass.mul739.a = fmul fast <4 x float> %i.qv, %reass.add746
  %i.ro = fadd fast <4 x float> %i.rn, %i.qu
...
_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit136.thread717: ; preds = %.lr.ph
  ...
  %i.abu = fmul fast <4 x float> %i.abt, %i.abt
  ...
  %i.acl = fmul fast <4 x float> %i.ack, %i.abt
  %i.acm = fmul fast <4 x float> %i.abs, splat (float f0x3F317218)
  %reass.add740 = fadd fast <4 x float> %i.acl, splat (float -5.000000e-01)
  %reass.mul734.a = fmul fast <4 x float> %i.abu, %reass.add740
  %i.acn = fadd fast <4 x float> %i.acm, %i.abt
  ...
  %i.afs = fmul fast <4 x float> %i.afr, %i.afr
  ...
  %i.agj = fmul fast <4 x float> %i.agi, %i.afr
  %i.agk = fmul fast <4 x float> %i.afq, splat (float f0x3F317218)
  %reass.add742 = fadd fast <4 x float> %i.agj, splat (float -5.000000e-01)
  %reass.mul737 = fmul fast <4 x float> %i.afs, %reass.add742
  %i.agl = fadd fast <4 x float> %i.agk, %i.afr
...
bb.ab:                                            ; preds = %.lr.ph758
  ...
  %i.ane = fmul fast <4 x float> %i.and, %i.and
  ...
  %i.anv = fmul fast <4 x float> %i.anu, %i.and
  %i.anw = fmul fast <4 x float> %i.anc, splat (float f0x3F317218)
  %reass.add733 = fadd fast <4 x float> %i.anv, splat (float -5.000000e-01)
  %reass.mul = fmul fast <4 x float> %i.ane, %reass.add733
  %i.anx = fadd fast <4 x float> %i.anw, %i.and
