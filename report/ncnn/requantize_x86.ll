...
bb.e:                                             ; preds = %bb.d, %bb.c
  %.0128 = phi nsz <4 x float> [ %i.p, %bb.d ], [ %i.l, %bb.c ] ; 2 uses
  %.0127 = phi nsz <4 x float> [ %i.n, %bb.d ], [ %i.l, %bb.c ] ; 4 uses
...
.preheader757:                                    ; preds = %.preheader757.loopexit, %.preheader758
  %.0129.lcssa = phi i32 [ 0, %.preheader758 ], [ %i.x, %.preheader757.loopexit ] ; 3 uses
  ...
  %i.y = or disjoint i32 %.0129.lcssa, 3
...
.lr.ph781:                                        ; preds = %.lr.ph781.preheader, %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit140
  ...
  %.0129778 = phi i32 [ %i.ms, %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit140 ], [ 0, %.lr.ph781.preheader ]
...
_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit142.thread696: ; preds = %.lr.ph781
  ...
  %i.cc = fadd fast <4 x float> %i.bp, splat (float 1.000000e+00)
  %i.cd = fadd fast <4 x float> %i.cc, %i.cb
  ...
  %i.dj = fadd fast <4 x float> %i.cw, splat (float 1.000000e+00)
...
_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit142.thread699: ; preds = %.lr.ph781
  ...
  %i.ep = fadd fast <4 x float> %i.ec, splat (float 1.000000e+00)
  ...
  %i.gd = fmul fast <4 x float> %i.gc, %i.fl
  %reass.mul749 = fmul fast <4 x float> %i.fk, splat (float f0x3F317218)
  %reass.add753 = fadd fast <4 x float> %i.gd, splat (float -5.000000e-01)
  %reass.mul754 = fmul fast <4 x float> %i.fm, %reass.add753
  %i.ge = fadd fast <4 x float> %reass.mul749, %i.fl
  ...
  %i.he = fadd fast <4 x float> %i.gr, splat (float 1.000000e+00)
  %i.hf = fadd fast <4 x float> %i.he, %i.hd
  ...
  %i.im = fadd fast <4 x float> %i.hz, splat (float 1.000000e+00)
  ...
  %i.jj = fmul fast <4 x float> %i.ji, %i.ji
  ...
  %i.ka = fmul fast <4 x float> %i.jz, %i.ji
  %reass.mul752 = fmul fast <4 x float> %i.jh, splat (float f0x3F317218)
  %reass.add755 = fadd fast <4 x float> %i.ka, splat (float -5.000000e-01)
  %reass.mul756 = fmul fast <4 x float> %i.jj, %reass.add755
  %i.kb = fadd fast <4 x float> %reass.mul752, %i.ji
  ...
  %i.lb = fadd fast <4 x float> %i.ko, splat (float 1.000000e+00)
...
_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit140:   ; preds = %.lr.ph781, %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit142.thread, %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit142.thread690, %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit142.thread693, %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit142.thread696, %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit142.thread699, %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit142.thread702
  ...
  %i.mc = fmul fast <4 x float> %.0.i141689, %.0127 ; 2 uses
  %i.md = fmul fast <4 x float> %.0.i139, %.0128  ; 2 uses
  ...
  %i.ms = add nuw nsw i32 %.0129778, 8            ; 2 uses
...
.preheader:                                       ; preds = %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit138, %.preheader757
  %.1130.lcssa = phi i32 [ %.0129.lcssa, %.preheader757 ], [ %i.tu, %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit138 ] ; 2 uses
  ...
  %i.mv = icmp slt i32 %.1130.lcssa, %i.a
...
.lr.ph788:                                        ; preds = %.preheader757, %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit138
  ...
  %.1130785 = phi i32 [ %i.tu, %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit138 ], [ %.0129.lcssa, %.preheader757 ]
...
bb.i:                                             ; preds = %.lr.ph788
  ...
  %i.oq = fadd fast <4 x float> %i.od, splat (float 1.000000e+00)
  %i.or = fadd fast <4 x float> %i.oq, %i.op
...
bb.j:                                             ; preds = %.lr.ph788
  ...
  %i.pw = fadd fast <4 x float> %i.pj, splat (float 1.000000e+00)
  %i.px = fadd fast <4 x float> %i.pw, %i.pv
  ...
  %i.rk = fmul fast <4 x float> %i.rj, %i.qs
  %reass.mul745 = fmul fast <4 x float> %i.qr, splat (float f0x3F317218)
  %reass.add746 = fadd fast <4 x float> %i.rk, splat (float -5.000000e-01)
  %reass.mul747 = fmul fast <4 x float> %i.qt, %reass.add746
  %i.rl = fadd fast <4 x float> %reass.mul745, %i.qs
  ...
  %i.sl = fadd fast <4 x float> %i.ry, splat (float 1.000000e+00)
  %i.sm = fadd fast <4 x float> %i.sl, %i.sk
...
_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit138:   ; preds = %.lr.ph788, %bb.f, %bb.g, %bb.h, %bb.i, %bb.j, %bb.k
  ...
  %i.tj = fmul fast <4 x float> %.0.i137, %.0127  ; 2 uses
  ...
  %i.tu = add nuw nsw i32 %.1130785, 4            ; 3 uses
...
.lr.ph795:                                        ; preds = %.preheader, %_ZL13activation_ssfiRKN4ncnn3MatE.exit143
  ...
  %.2131792 = phi i32 [ %i.vm, %_ZL13activation_ssfiRKN4ncnn3MatE.exit143 ], [ %.1130.lcssa, %.preheader ]
...
_ZL13activation_ssfiRKN4ncnn3MatE.exit143:        ; preds = %bb.r, %.lr.ph795, %bb.l, %bb.m, %bb.n, %bb.o, %bb.p, %bb.q, %bb.s, %bb.t
  ...
  %i.vm = add nuw nsw i32 %.2131792, 1            ; 2 uses
...
_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit136.thread714: ; preds = %.lr.ph
  ...
  %i.yh = fadd fast <4 x float> %i.xu, splat (float 1.000000e+00)
  ...
  %i.zo = fadd fast <4 x float> %i.zb, splat (float 1.000000e+00)
  %i.zp = fadd fast <4 x float> %i.zo, %i.zn
...
_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit136.thread717: ; preds = %.lr.ph
  ...
  %i.aau = fadd fast <4 x float> %i.aah, splat (float 1.000000e+00)
  ...
  %i.abr = fmul fast <4 x float> %i.abq, %i.abq
  ...
  %i.aci = fmul fast <4 x float> %i.ach, %i.abq
  %reass.mul736 = fmul fast <4 x float> %i.abp, splat (float f0x3F317218)
  %reass.add740 = fadd fast <4 x float> %i.aci, splat (float -5.000000e-01)
  %reass.mul741 = fmul fast <4 x float> %i.abr, %reass.add740
  %i.acj = fadd fast <4 x float> %reass.mul736, %i.abq
  ...
  %i.adj = fadd fast <4 x float> %i.acw, splat (float 1.000000e+00)
  %i.adk = fadd fast <4 x float> %i.adj, %i.adi
  ...
  %i.aer = fadd fast <4 x float> %i.aee, splat (float 1.000000e+00)
  %i.aes = fadd fast <4 x float> %i.aer, %i.aeq
  ...
  %i.afo = fmul fast <4 x float> %i.afn, %i.afn
  ...
  %i.agf = fmul fast <4 x float> %i.age, %i.afn
  %reass.mul739 = fmul fast <4 x float> %i.afm, splat (float f0x3F317218)
  %reass.add742 = fadd fast <4 x float> %i.agf, splat (float -5.000000e-01)
  %reass.mul743 = fmul fast <4 x float> %i.afo, %reass.add742
  %i.agg = fadd fast <4 x float> %reass.mul739, %i.afn
  ...
  %i.ahg = fadd fast <4 x float> %i.agt, splat (float 1.000000e+00)
  %i.ahh = fadd fast <4 x float> %i.ahg, %i.ahf
...
_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit134:   ; preds = %.lr.ph, %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit136.thread, %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit136.thread708, %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit136.thread711, %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit136.thread714, %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit136.thread717, %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit136.thread720
  ...
  %i.aih = fmul fast <4 x float> %.0.i135707, %.0127 ; 2 uses
  %i.aii = fmul fast <4 x float> %.0.i133, %.0128 ; 2 uses
...
bb.ab:                                            ; preds = %.lr.ph770
  ...
  %reass.mul.a = fmul fast <4 x float> %i.amx, splat (float f0x3F317218)
  %reass.add733 = fadd fast <4 x float> %i.anq, splat (float -5.000000e-01)
  %reass.mul734 = fmul fast <4 x float> %i.amz, %reass.add733
  %i.anr = fadd fast <4 x float> %reass.mul.a, %i.amy
...
_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit:      ; preds = %.lr.ph770, %bb.x, %bb.y, %bb.z, %bb.aa, %bb.ab, %bb.ac
  ...
  %i.app = fmul fast <4 x float> %.0.i, %.0127    ; 2 uses
