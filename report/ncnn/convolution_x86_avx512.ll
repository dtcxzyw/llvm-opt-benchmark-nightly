...
begin_hunk_0_@_ZN4ncnnL39convolution_transform_kernel_packed_sseERKNS_3MatERS0_iiiiii:bb.a
  %.3103 = phi ptr [ %i.bp, %_ZN4ncnn3MatD2Ev.exit59 ], [ %.2108, %.preheader ] ; 5 uses
  ...
  %i.bf = load float, ptr %gep102, align 4, !tbaa !41
  store float %i.bf, ptr %.3103, align 4, !tbaa !41
  ...
  %i.bi = load float, ptr %gep102.1, align 4, !tbaa !41
  store float %i.bi, ptr %i.bg, align 4, !tbaa !41
  ...
  %i.bl = load float, ptr %gep102.2, align 4, !tbaa !41
  store float %i.bl, ptr %i.bj, align 4, !tbaa !41
  ...
  %i.bo = load float, ptr %gep102.3, align 4, !tbaa !41
  store float %i.bo, ptr %i.bm, align 4, !tbaa !41
  %i.bp = getelementptr inbounds nuw i8, ptr %.3103, i64 16 ; 3 uses
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4 ; 2 uses
  %niter.next.3 = add i64 %niter, 4               ; 2 uses
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %.unr-lcssa, label %_ZN4ncnn3MatD2Ev.exit59, !llvm.loop !642
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.bt = load ptr, ptr %i.bs, align 8, !tbaa !21 ; 3 uses
  %.not3.i70 = icmp eq ptr %i.bt, null
  %i.bu = load ptr, ptr %8, align 8, !tbaa !22    ; 3 uses
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %i.j = and i32 %i.i, 2147483632
  %.sroa.speculated86 = tail call i32 @llvm.umax.i32(i32 %i.j, i32 16)
  store i32 %.sroa.speculated86, ptr %3, align 4, !tbaa !66
  %i.k = tail call noundef i32 @_ZN4ncnn22get_physical_cpu_countEv()
  %.sroa.speculated82 = tail call i32 @llvm.smin.i32(i32 %i.k, i32 %.0)
  %i.l = load i32, ptr %3, align 4, !tbaa !66
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.x = add nuw nsw i32 %.sroa.speculated68, 15
  %i.y = and i32 %i.x, 2147483632
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  %i.ae = shl nsw i32 %i.ad, 4
  %.sroa.speculated62 = tail call i32 @llvm.smax.i32(i32 %i.ae, i32 16) ; 3 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.k = load i32, ptr %i.a, align 4, !tbaa !66   ; 3 uses
...
bb.c:                                             ; preds = %.lr.ph101, %_ZN4ncnn3MatD2Ev.exit
  ...
  %i.aa = mul i32 %12, 9
  %i.ab = load i32, ptr %3, align 4, !tbaa !66    ; 2 uses
...
_ZN4ncnn3MatD2Ev.exit:                            ; preds = %_ZN4ncnnL42conv3x3s1_winograd63_transform_kernel_tileERKNS_3MatERS0_iiiii.exit, %_ZN4ncnn3Mat7channelEi.exit49
  ...
  %i.ap = load i32, ptr %i.b, align 4, !tbaa !66
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %_ZN4ncnnL42conv3x3s1_winograd63_transform_kernel_tileERKNS_3MatERS0_iiiii.exit
  %i.aq = phi i32 [ %i.aeh, %_ZN4ncnnL42conv3x3s1_winograd63_transform_kernel_tileERKNS_3MatERS0_iiiii.exit ], [ %.pre, %.lr.ph.preheader ] ; 2 uses
  %i.ar = phi i32 [ %i.aej, %_ZN4ncnnL42conv3x3s1_winograd63_transform_kernel_tileERKNS_3MatERS0_iiiii.exit ], [ %i.al, %.lr.ph.preheader ]
  %.098 = phi i32 [ %i.aei, %_ZN4ncnnL42conv3x3s1_winograd63_transform_kernel_tileERKNS_3MatERS0_iiiii.exit ], [ 0, %.lr.ph.preheader ] ; 4 uses
  %i.as = load i32, ptr %7, align 4, !tbaa !66
  %i.at = sub nsw i32 %i.as, %i.ac
  %i.au = load i32, ptr %3, align 4, !tbaa !66    ; 2 uses
...
.preheader12.lr.ph.i:                             ; preds = %.lr.ph
  %i.ax = load i32, ptr %9, align 4, !tbaa !66    ; 3 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.masked.gather = call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> align 4 %wide.gep, <16 x i1> splat (i1 true), <16 x float> poison), !tbaa !41, !alias.scope !659 ; 4 uses
  %wide.gep111 = getelementptr inbounds nuw i8, <16 x ptr> %wide.gep, i64 4
  %wide.masked.gather112 = call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> align 4 %wide.gep111, <16 x i1> splat (i1 true), <16 x float> poison), !tbaa !41, !alias.scope !659 ; 3 uses
  %wide.gep113 = getelementptr inbounds nuw i8, <16 x ptr> %wide.gep, i64 8
  %wide.masked.gather114 = call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> align 4 %wide.gep113, <16 x i1> splat (i1 true), <16 x float> poison), !tbaa !41, !alias.scope !659 ; 6 uses
  ...
  %wide.masked.gather116 = call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> align 4 %wide.gep115, <16 x i1> splat (i1 true), <16 x float> poison), !tbaa !41, !alias.scope !659 ; 4 uses
  %wide.gep117 = getelementptr inbounds nuw i8, <16 x ptr> %wide.gep, i64 16
  %wide.masked.gather118 = call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> align 4 %wide.gep117, <16 x i1> splat (i1 true), <16 x float> poison), !tbaa !41, !alias.scope !659 ; 3 uses
  %wide.gep119 = getelementptr inbounds nuw i8, <16 x ptr> %wide.gep, i64 20
  %wide.masked.gather120 = call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> align 4 %wide.gep119, <16 x i1> splat (i1 true), <16 x float> poison), !tbaa !41, !alias.scope !659 ; 6 uses
  ...
  %wide.masked.gather122 = call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> align 4 %wide.gep121, <16 x i1> splat (i1 true), <16 x float> poison), !tbaa !41, !alias.scope !659 ; 6 uses
  %wide.gep123 = getelementptr inbounds nuw i8, <16 x ptr> %wide.gep, i64 28
  %wide.masked.gather124 = call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> align 4 %wide.gep123, <16 x i1> splat (i1 true), <16 x float> poison), !tbaa !41, !alias.scope !659 ; 3 uses
  %wide.gep125 = getelementptr inbounds nuw i8, <16 x ptr> %wide.gep, i64 32
  %wide.masked.gather126 = call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> align 4 %wide.gep125, <16 x i1> splat (i1 true), <16 x float> poison), !tbaa !41, !alias.scope !659 ; 4 uses
  ...
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %wide.masked.gather, <16 x ptr> align 4 %vector.gep, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !660, !noalias !659
  %wide.gep127 = getelementptr inbounds nuw i8, <16 x ptr> %vector.gep, i64 4
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %i.ek, <16 x ptr> align 4 %wide.gep127, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !660, !noalias !659
  %wide.gep128 = getelementptr inbounds nuw i8, <16 x ptr> %vector.gep, i64 8
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %i.em, <16 x ptr> align 4 %wide.gep128, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !660, !noalias !659
  %wide.gep129 = getelementptr inbounds nuw i8, <16 x ptr> %vector.gep, i64 12
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %i.ep, <16 x ptr> align 4 %wide.gep129, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !660, !noalias !659
  %wide.gep130 = getelementptr inbounds nuw i8, <16 x ptr> %vector.gep, i64 16
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %i.er, <16 x ptr> align 4 %wide.gep130, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !660, !noalias !659
  %wide.gep131 = getelementptr inbounds nuw i8, <16 x ptr> %vector.gep, i64 20
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %i.eu, <16 x ptr> align 4 %wide.gep131, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !660, !noalias !659
  %wide.gep132 = getelementptr inbounds nuw i8, <16 x ptr> %vector.gep, i64 24
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %i.ew, <16 x ptr> align 4 %wide.gep132, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !660, !noalias !659
  %wide.gep133 = getelementptr inbounds nuw i8, <16 x ptr> %vector.gep, i64 28
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %wide.masked.gather122, <16 x ptr> align 4 %wide.gep133, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !660, !noalias !659
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  %.016145 = phi ptr [ %i.hd, %.lr.ph ], [ %gep, %.lr.ph.preheader ] ; 3 uses
  %.744 = phi ptr [ %i.he, %.lr.ph ], [ %.647, %.lr.ph.preheader ] ; 9 uses
  %niter135 = phi i32 [ %niter135.next.3, %.lr.ph ], [ 0, %.lr.ph.preheader ]
  %i.gh = load float, ptr %.016145, align 4, !tbaa !41
  store float %i.gh, ptr %.744, align 4, !tbaa !41
  %i.gi = getelementptr inbounds nuw [4 x i8], ptr %.016145, i64 %i.j
  %i.gj = load float, ptr %i.gi, align 4, !tbaa !41
  %i.gk = getelementptr inbounds nuw i8, ptr %.744, i64 4
  store float %i.gj, ptr %i.gk, align 4, !tbaa !41
  %i.gl = getelementptr inbounds nuw [4 x i8], ptr %.016145, i64 %i.am ; 3 uses
  %i.gm = getelementptr inbounds nuw i8, ptr %.744, i64 8
  %i.gn = load float, ptr %i.gl, align 4, !tbaa !41
  store float %i.gn, ptr %i.gm, align 4, !tbaa !41
  %i.go = getelementptr inbounds nuw [4 x i8], ptr %i.gl, i64 %i.j
  %i.gp = load float, ptr %i.go, align 4, !tbaa !41
  %i.gq = getelementptr inbounds nuw i8, ptr %.744, i64 12
  store float %i.gp, ptr %i.gq, align 4, !tbaa !41
  %i.gr = getelementptr inbounds nuw [4 x i8], ptr %i.gl, i64 %i.am ; 3 uses
  %i.gs = getelementptr inbounds nuw i8, ptr %.744, i64 16
  %i.gt = load float, ptr %i.gr, align 4, !tbaa !41
  store float %i.gt, ptr %i.gs, align 4, !tbaa !41
  %i.gu = getelementptr inbounds nuw [4 x i8], ptr %i.gr, i64 %i.j
  %i.gv = load float, ptr %i.gu, align 4, !tbaa !41
  %i.gw = getelementptr inbounds nuw i8, ptr %.744, i64 20
  store float %i.gv, ptr %i.gw, align 4, !tbaa !41
  %i.gx = getelementptr inbounds nuw [4 x i8], ptr %i.gr, i64 %i.am ; 3 uses
  %i.gy = getelementptr inbounds nuw i8, ptr %.744, i64 24
  %i.gz = load float, ptr %i.gx, align 4, !tbaa !41
  store float %i.gz, ptr %i.gy, align 4, !tbaa !41
  %i.ha = getelementptr inbounds nuw [4 x i8], ptr %i.gx, i64 %i.j
  %i.hb = load float, ptr %i.ha, align 4, !tbaa !41
  %i.hc = getelementptr inbounds nuw i8, ptr %.744, i64 28
  store float %i.hb, ptr %i.hc, align 4, !tbaa !41
  %i.hd = getelementptr inbounds nuw [4 x i8], ptr %i.gx, i64 %i.am ; 2 uses
  %i.he = getelementptr inbounds nuw i8, ptr %.744, i64 32 ; 3 uses
  %niter135.next.3 = add nuw nsw i32 %niter135, 4 ; 2 uses
  %niter135.ncmp.3 = icmp eq i32 %niter135.next.3, %unroll_iter134
  br i1 %niter135.ncmp.3, label %._crit_edge.loopexit.unr-lcssa, label %.lr.ph, !llvm.loop !669

._crit_edge.loopexit.unr-lcssa:                   ; preds = %.lr.ph
  br i1 %lcmp.mod131.not, label %._crit_edge, label %.lr.ph.epil.preheader

.lr.ph.epil.preheader:                            ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph.preheader
  %.016145.epil.init = phi ptr [ %gep, %.lr.ph.preheader ], [ %i.hd, %._crit_edge.loopexit.unr-lcssa ]
  %.744.epil.init = phi ptr [ %.647, %.lr.ph.preheader ], [ %i.he, %._crit_edge.loopexit.unr-lcssa ]
  tail call void @llvm.assume(i1 %lcmp.mod133)
  br label %.lr.ph.epil

.lr.ph.epil:                                      ; preds = %.lr.ph.epil, %.lr.ph.epil.preheader
  %.016145.epil = phi ptr [ %i.hj, %.lr.ph.epil ], [ %.016145.epil.init, %.lr.ph.epil.preheader ] ; 3 uses
  %.744.epil = phi ptr [ %i.hk, %.lr.ph.epil ], [ %.744.epil.init, %.lr.ph.epil.preheader ] ; 3 uses
  %epil.iter = phi i32 [ %epil.iter.next, %.lr.ph.epil ], [ 0, %.lr.ph.epil.preheader ]
  %i.hf = load float, ptr %.016145.epil, align 4, !tbaa !41
  store float %i.hf, ptr %.744.epil, align 4, !tbaa !41
  %i.hg = getelementptr inbounds nuw [4 x i8], ptr %.016145.epil, i64 %i.j
  %i.hh = load float, ptr %i.hg, align 4, !tbaa !41
  %i.hi = getelementptr inbounds nuw i8, ptr %.744.epil, i64 4
  store float %i.hh, ptr %i.hi, align 4, !tbaa !41
  %i.hj = getelementptr inbounds nuw [4 x i8], ptr %.016145.epil, i64 %i.am
  %i.hk = getelementptr inbounds nuw i8, ptr %.744.epil, i64 8 ; 2 uses
  %epil.iter.next = add i32 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.next, %xtraiter130
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph.epil, %bb.f
  %.7.lcssa = phi ptr [ %.647, %bb.f ], [ %i.he, %._crit_edge.loopexit.unr-lcssa ], [ %i.hk, %.lr.ph.epil ] ; 2 uses
  %indvars.iv.next92 = add nuw nsw i64 %indvars.iv91, 2 ; 3 uses
  %i.hl = icmp slt i64 %indvars.iv.next92, %invariant.op119
  br i1 %i.hl, label %bb.f, label %.preheader.loopexit, !llvm.loop !671

.lr.ph57:                                         ; preds = %.lr.ph57.preheader, %._crit_edge58
  %indvars.iv95 = phi i64 [ %i.gf, %.lr.ph57.preheader ], [ %indvars.iv.next96, %._crit_edge58 ] ; 2 uses
  %.860 = phi ptr [ %.6.lcssa, %.lr.ph57.preheader ], [ %.lcssa127, %._crit_edge58 ] ; 2 uses
  %i.hm = mul nsw i64 %indvars.iv95, %i.j
  %gep65 = getelementptr [4 x i8], ptr %invariant.gep64, i64 %i.hm ; 2 uses
  br i1 %i.aw, label %.epil.preheader136, label %.lr.ph57.new

.lr.ph57.new:                                     ; preds = %.lr.ph57, %.lr.ph57.new
  %.015954 = phi ptr [ %i.ij, %.lr.ph57.new ], [ %gep65, %.lr.ph57 ] ; 2 uses
  %.953 = phi ptr [ %i.ik, %.lr.ph57.new ], [ %.860, %.lr.ph57 ] ; 9 uses
  %niter143 = phi i32 [ %niter143.next.7, %.lr.ph57.new ], [ 0, %.lr.ph57 ]
  %i.hn = load float, ptr %.015954, align 4, !tbaa !41
  store float %i.hn, ptr %.953, align 4, !tbaa !41
  %i.ho = getelementptr inbounds nuw [4 x i8], ptr %.015954, i64 %i.am ; 2 uses
  %i.hp = getelementptr inbounds nuw i8, ptr %.953, i64 4
  %i.hq = load float, ptr %i.ho, align 4, !tbaa !41
  store float %i.hq, ptr %i.hp, align 4, !tbaa !41
  %i.hr = getelementptr inbounds nuw [4 x i8], ptr %i.ho, i64 %i.am ; 2 uses
  %i.hs = getelementptr inbounds nuw i8, ptr %.953, i64 8
  %i.ht = load float, ptr %i.hr, align 4, !tbaa !41
  store float %i.ht, ptr %i.hs, align 4, !tbaa !41
  %i.hu = getelementptr inbounds nuw [4 x i8], ptr %i.hr, i64 %i.am ; 2 uses
  %i.hv = getelementptr inbounds nuw i8, ptr %.953, i64 12
  %i.hw = load float, ptr %i.hu, align 4, !tbaa !41
  store float %i.hw, ptr %i.hv, align 4, !tbaa !41
  %i.hx = getelementptr inbounds nuw [4 x i8], ptr %i.hu, i64 %i.am ; 2 uses
  %i.hy = getelementptr inbounds nuw i8, ptr %.953, i64 16
  %i.hz = load float, ptr %i.hx, align 4, !tbaa !41
  store float %i.hz, ptr %i.hy, align 4, !tbaa !41
  %i.ia = getelementptr inbounds nuw [4 x i8], ptr %i.hx, i64 %i.am ; 2 uses
  %i.ib = getelementptr inbounds nuw i8, ptr %.953, i64 20
  %i.ic = load float, ptr %i.ia, align 4, !tbaa !41
  store float %i.ic, ptr %i.ib, align 4, !tbaa !41
  %i.id = getelementptr inbounds nuw [4 x i8], ptr %i.ia, i64 %i.am ; 2 uses
  %i.ie = getelementptr inbounds nuw i8, ptr %.953, i64 24
  %i.if = load float, ptr %i.id, align 4, !tbaa !41
  store float %i.if, ptr %i.ie, align 4, !tbaa !41
  %i.ig = getelementptr inbounds nuw [4 x i8], ptr %i.id, i64 %i.am ; 2 uses
  %i.ih = getelementptr inbounds nuw i8, ptr %.953, i64 28
  %i.ii = load float, ptr %i.ig, align 4, !tbaa !41
  store float %i.ii, ptr %i.ih, align 4, !tbaa !41
  %i.ij = getelementptr inbounds nuw [4 x i8], ptr %i.ig, i64 %i.am ; 2 uses
  %i.ik = getelementptr inbounds nuw i8, ptr %.953, i64 32 ; 3 uses
  %niter143.next.7 = add nuw nsw i32 %niter143, 8 ; 2 uses
  %niter143.ncmp.7 = icmp eq i32 %niter143.next.7, %unroll_iter142
  br i1 %niter143.ncmp.7, label %._crit_edge58.unr-lcssa, label %.lr.ph57.new, !llvm.loop !672

._crit_edge58.unr-lcssa:                          ; preds = %.lr.ph57.new
  br i1 %lcmp.mod139.not, label %._crit_edge58, label %.epil.preheader136

.epil.preheader136:                               ; preds = %._crit_edge58.unr-lcssa, %.lr.ph57
  %.015954.epil.init = phi ptr [ %gep65, %.lr.ph57 ], [ %i.ij, %._crit_edge58.unr-lcssa ]
  %.953.epil.init = phi ptr [ %.860, %.lr.ph57 ], [ %i.ik, %._crit_edge58.unr-lcssa ]
  tail call void @llvm.assume(i1 %lcmp.mod141)
  br label %bb.g

bb.g:                                             ; preds = %bb.g, %.epil.preheader136
  %.015954.epil = phi ptr [ %.015954.epil.init, %.epil.preheader136 ], [ %i.im, %bb.g ] ; 2 uses
  %.953.epil = phi ptr [ %.953.epil.init, %.epil.preheader136 ], [ %i.in, %bb.g ] ; 2 uses
  %epil.iter138 = phi i32 [ 0, %.epil.preheader136 ], [ %epil.iter138.next, %bb.g ]
  %i.il = load float, ptr %.015954.epil, align 4, !tbaa !41
  store float %i.il, ptr %.953.epil, align 4, !tbaa !41
  %i.im = getelementptr inbounds nuw [4 x i8], ptr %.015954.epil, i64 %i.am
  %i.in = getelementptr inbounds nuw i8, ptr %.953.epil, i64 4 ; 2 uses
  %epil.iter138.next = add i32 %epil.iter138, 1   ; 2 uses
  %epil.iter138.cmp.not = icmp eq i32 %epil.iter138.next, %xtraiter137
  br i1 %epil.iter138.cmp.not, label %._crit_edge58, label %bb.g, !llvm.loop !673

._crit_edge58:                                    ; preds = %bb.g, %._crit_edge58.unr-lcssa
  %.lcssa127 = phi ptr [ %i.ik, %._crit_edge58.unr-lcssa ], [ %i.in, %bb.g ]
  %indvars.iv.next96 = add nuw nsw i64 %indvars.iv95, 1 ; 2 uses
  %exitcond98.not = icmp eq i64 %indvars.iv.next96, %i.ap
  br i1 %exitcond98.not, label %._crit_edge63.split, label %.lr.ph57, !llvm.loop !674

._crit_edge63.split:                              ; preds = %._crit_edge58, %.lr.ph62, %.preheader
  %indvars.iv.next100 = add nuw nsw i64 %indvars.iv99, 1 ; 2 uses
  %exitcond103.not = icmp eq i64 %indvars.iv.next100, %i.am
  br i1 %exitcond103.not, label %bb.b, label %bb.c, !llvm.loop !675
}
...
_ZN4ncnn3Mat7channelEi.exit49:                    ; preds = %bb.c
  %i.ae = load ptr, ptr %4, align 8, !tbaa !22, !noalias !690
  %i.af = load i64, ptr %i.l, align 8, !tbaa !23, !noalias !690
  %i.ag = sext i32 %i.ad to i64
  %i.ah = mul i64 %i.af, %i.ag
  %i.ai = load i64, ptr %i.m, align 8, !tbaa !64, !noalias !690
  %i.aj = mul i64 %i.ah, %i.ai
  %i.ak = getelementptr inbounds nuw i8, ptr %i.ae, i64 %i.aj ; 2 uses
  %i.al = load i32, ptr %5, align 4, !tbaa !66    ; 2 uses
  %i.am = icmp sgt i32 %i.al, 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.bw = mul nsw <16 x i64> %i.bv, splat (i64 36)
  %wide.gep = getelementptr inbounds i8, ptr %i.bo, <16 x i64> %i.bw ; 9 uses
  %wide.masked.gather = call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> align 4 %wide.gep, <16 x i1> splat (i1 true), <16 x float> poison), !tbaa !41, !alias.scope !691 ; 3 uses
  %wide.gep119 = getelementptr inbounds nuw i8, <16 x ptr> %wide.gep, i64 4
  %wide.masked.gather120 = call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> align 4 %wide.gep119, <16 x i1> splat (i1 true), <16 x float> poison), !tbaa !41, !alias.scope !691 ; 2 uses
  %wide.gep121 = getelementptr inbounds nuw i8, <16 x ptr> %wide.gep, i64 8
  %wide.masked.gather122 = call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> align 4 %wide.gep121, <16 x i1> splat (i1 true), <16 x float> poison), !tbaa !41, !alias.scope !691 ; 4 uses
  ...
  %wide.masked.gather124 = call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> align 4 %wide.gep123, <16 x i1> splat (i1 true), <16 x float> poison), !tbaa !41, !alias.scope !691 ; 4 uses
  %wide.gep125 = getelementptr inbounds nuw i8, <16 x ptr> %wide.gep, i64 16
  %wide.masked.gather126 = call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> align 4 %wide.gep125, <16 x i1> splat (i1 true), <16 x float> poison), !tbaa !41, !alias.scope !691 ; 2 uses
  %wide.gep127 = getelementptr inbounds nuw i8, <16 x ptr> %wide.gep, i64 20
  %wide.masked.gather128 = call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> align 4 %wide.gep127, <16 x i1> splat (i1 true), <16 x float> poison), !tbaa !41, !alias.scope !691 ; 3 uses
  ...
  %wide.masked.gather130 = call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> align 4 %wide.gep129, <16 x i1> splat (i1 true), <16 x float> poison), !tbaa !41, !alias.scope !691 ; 4 uses
  %wide.gep131 = getelementptr inbounds nuw i8, <16 x ptr> %wide.gep, i64 28
  %wide.masked.gather132 = call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> align 4 %wide.gep131, <16 x i1> splat (i1 true), <16 x float> poison), !tbaa !41, !alias.scope !691 ; 2 uses
  %wide.gep133 = getelementptr inbounds nuw i8, <16 x ptr> %wide.gep, i64 32
  %wide.masked.gather134 = call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> align 4 %wide.gep133, <16 x i1> splat (i1 true), <16 x float> poison), !tbaa !41, !alias.scope !691 ; 2 uses
  ...
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %wide.masked.gather, <16 x ptr> align 4 %vector.gep, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !692, !noalias !691
  %wide.gep135 = getelementptr inbounds nuw i8, <16 x ptr> %vector.gep, i64 4
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %i.dn, <16 x ptr> align 4 %wide.gep135, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !692, !noalias !691
  %wide.gep136 = getelementptr inbounds nuw i8, <16 x ptr> %vector.gep, i64 8
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %i.dp, <16 x ptr> align 4 %wide.gep136, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !692, !noalias !691
  %wide.gep137 = getelementptr inbounds nuw i8, <16 x ptr> %vector.gep, i64 12
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %i.ds, <16 x ptr> align 4 %wide.gep137, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !692, !noalias !691
  %wide.gep138 = getelementptr inbounds nuw i8, <16 x ptr> %vector.gep, i64 16
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %i.du, <16 x ptr> align 4 %wide.gep138, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !692, !noalias !691
  %wide.gep139 = getelementptr inbounds nuw i8, <16 x ptr> %vector.gep, i64 20
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %wide.masked.gather130, <16 x ptr> align 4 %wide.gep139, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !692, !noalias !691
  ...
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %i.cb, <16 x ptr> align 4 %wide.gep140, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !692, !noalias !691
  %wide.gep141 = getelementptr inbounds nuw i8, <16 x ptr> %vector.gep, i64 28
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %i.dz, <16 x ptr> align 4 %wide.gep141, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !692, !noalias !691
  %wide.gep142 = getelementptr inbounds nuw i8, <16 x ptr> %vector.gep, i64 32
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %i.eb, <16 x ptr> align 4 %wide.gep142, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !692, !noalias !691
  %wide.gep143 = getelementptr inbounds nuw i8, <16 x ptr> %vector.gep, i64 36
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %i.ef, <16 x ptr> align 4 %wide.gep143, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !692, !noalias !691
  %wide.gep144 = getelementptr inbounds nuw i8, <16 x ptr> %vector.gep, i64 40
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %i.eh, <16 x ptr> align 4 %wide.gep144, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !692, !noalias !691
  %wide.gep145 = getelementptr inbounds nuw i8, <16 x ptr> %vector.gep, i64 44
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %i.db, <16 x ptr> align 4 %wide.gep145, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !692, !noalias !691
...
begin_hunk_2_@_ZN4ncnnL37conv3x3s1_winograd43_transform_kernelERKNS_3MatERS0_iiRKNS_6OptionE.omp_outlined:bb.a
  store float %i.of, ptr %i.oj, align 4, !tbaa !41
  %i.ok = getelementptr inbounds nuw i8, ptr %.116.i, i64 44
  store float %i.mt, ptr %i.ok, align 4, !tbaa !41
...
._crit_edge.i:                                    ; preds = %.preheader.preheader.i, %vec.epilog.middle.block, %middle.block
  ...
  br i1 %exitcond27.not.i, label %_ZN4ncnnL42conv3x3s1_winograd43_transform_kernel_tileERKNS_3MatERS0_iiiii.exit, label %iter.check, !llvm.loop !684
...
_ZN4ncnnL42conv3x3s1_winograd43_transform_kernel_tileERKNS_3MatERS0_iiiii.exit: ; preds = %._crit_edge.i, %.lr.ph, %.preheader10.lr.ph.i
  ...
  %i.rk = load ptr, ptr %10, align 8, !tbaa !22, !noalias !693
  %i.rl = load i64, ptr %i.p, align 8, !tbaa !23, !noalias !693
  %i.rm = sext i32 %i.rj to i64
  %i.rn = mul i64 %i.rl, %i.rm
  %i.ro = load i64, ptr %i.q, align 8, !tbaa !64, !noalias !693 ; 3 uses
  %i.rp = mul i64 %i.rn, %i.ro
  %i.rq = getelementptr inbounds nuw i8, ptr %i.rk, i64 %i.rp
  %i.rr = load i32, ptr %i.r, align 8, !tbaa !65, !noalias !693
  %i.rs = load ptr, ptr %i.s, align 8, !tbaa !21, !noalias !693
  %i.rt = sdiv i32 %.0106, %i.aq
  %i.ru = sext i32 %i.rt to i64
  store ptr null, ptr %i.t, align 8, !tbaa !20
  store i64 %i.ro, ptr %i.u, align 8, !tbaa !64
  store i32 %i.rr, ptr %i.v, align 8, !tbaa !65
  store ptr %i.rs, ptr %i.w, align 8, !tbaa !21
  %i.rv = load <2 x i32>, ptr %i.n, align 4, !tbaa !66, !noalias !693
  %i.rw = load i32, ptr %i.o, align 8, !tbaa !75, !noalias !693
  %i.rx = load i32, ptr %i.n, align 4, !tbaa !74, !noalias !693
  ...
  store ptr %i.sd, ptr %11, align 8, !tbaa !22
  ...
  store <4 x i32> %i.sf, ptr %i.x, align 8, !tbaa !66
  store i32 1, ptr %i.y, align 8, !tbaa !67
  store i64 %i.sa, ptr %i.z, align 8, !tbaa !23, !alias.scope !694
  ...
  %i.sg = load i32, ptr %6, align 4, !tbaa !66    ; 2 uses
  %i.sh = add nsw i32 %i.sg, %.0106               ; 2 uses
  %i.si = load i32, ptr %5, align 4, !tbaa !66    ; 2 uses
  %i.sj = icmp slt i32 %i.sh, %i.si
  br i1 %i.sj, label %.lr.ph, label %_ZN4ncnn3MatD2Ev.exit, !llvm.loop !689
...
_ZN4ncnn3Mat7channelEi.exit49:                    ; preds = %bb.c
  %i.ae = load ptr, ptr %4, align 8, !tbaa !22, !noalias !709
  %i.af = load i64, ptr %i.l, align 8, !tbaa !23, !noalias !709
  %i.ag = sext i32 %i.ad to i64
  %i.ah = mul i64 %i.af, %i.ag
  %i.ai = load i64, ptr %i.m, align 8, !tbaa !64, !noalias !709
  %i.aj = mul i64 %i.ah, %i.ai
  %i.ak = getelementptr inbounds nuw i8, ptr %i.ae, i64 %i.aj ; 2 uses
  %i.al = load i32, ptr %5, align 4, !tbaa !66    ; 2 uses
  %i.am = icmp sgt i32 %i.al, 0
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %_ZN4ncnnL42conv3x3s1_winograd23_transform_kernel_tileERKNS_3MatERS0_iiiii.exit
  %i.aq = phi i32 [ %i.jb, %_ZN4ncnnL42conv3x3s1_winograd23_transform_kernel_tileERKNS_3MatERS0_iiiii.exit ], [ %.pre, %.lr.ph.preheader ] ; 2 uses
  %i.ar = phi i32 [ %i.jd, %_ZN4ncnnL42conv3x3s1_winograd23_transform_kernel_tileERKNS_3MatERS0_iiiii.exit ], [ %i.al, %.lr.ph.preheader ]
  %.079 = phi i32 [ %i.jc, %_ZN4ncnnL42conv3x3s1_winograd23_transform_kernel_tileERKNS_3MatERS0_iiiii.exit ], [ 0, %.lr.ph.preheader ] ; 4 uses
  %i.as = load i32, ptr %7, align 4, !tbaa !66
  %i.at = sub nsw i32 %i.as, %i.ac
  %i.au = load i32, ptr %3, align 4, !tbaa !66    ; 2 uses
  %.sroa.speculated66 = call i32 @llvm.smin.i32(i32 %i.au, i32 %i.at) ; 3 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.bw = mul nsw <16 x i64> %i.bv, splat (i64 36)
  %wide.gep = getelementptr inbounds i8, ptr %i.bo, <16 x i64> %i.bw ; 9 uses
  %wide.masked.gather = call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> align 4 %wide.gep, <16 x i1> splat (i1 true), <16 x float> poison), !tbaa !41, !alias.scope !710 ; 2 uses
  %wide.gep92 = getelementptr inbounds nuw i8, <16 x ptr> %wide.gep, i64 4
  %wide.masked.gather93 = call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> align 4 %wide.gep92, <16 x i1> splat (i1 true), <16 x float> poison), !tbaa !41, !alias.scope !710
  %wide.gep94 = getelementptr inbounds nuw i8, <16 x ptr> %wide.gep, i64 8
  %wide.masked.gather95 = call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> align 4 %wide.gep94, <16 x i1> splat (i1 true), <16 x float> poison), !tbaa !41, !alias.scope !710 ; 2 uses
  ...
  %wide.masked.gather97 = call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> align 4 %wide.gep96, <16 x i1> splat (i1 true), <16 x float> poison), !tbaa !41, !alias.scope !710
  %wide.gep98 = getelementptr inbounds nuw i8, <16 x ptr> %wide.gep, i64 16
  %wide.masked.gather99 = call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> align 4 %wide.gep98, <16 x i1> splat (i1 true), <16 x float> poison), !tbaa !41, !alias.scope !710
  %wide.gep100 = getelementptr inbounds nuw i8, <16 x ptr> %wide.gep, i64 20
  %wide.masked.gather101 = call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> align 4 %wide.gep100, <16 x i1> splat (i1 true), <16 x float> poison), !tbaa !41, !alias.scope !710
  ...
  %wide.masked.gather103 = call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> align 4 %wide.gep102, <16 x i1> splat (i1 true), <16 x float> poison), !tbaa !41, !alias.scope !710 ; 2 uses
  %wide.gep104 = getelementptr inbounds nuw i8, <16 x ptr> %wide.gep, i64 28
  %wide.masked.gather105 = call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> align 4 %wide.gep104, <16 x i1> splat (i1 true), <16 x float> poison), !tbaa !41, !alias.scope !710
  %wide.gep106 = getelementptr inbounds nuw i8, <16 x ptr> %wide.gep, i64 32
  %wide.masked.gather107 = call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> align 4 %wide.gep106, <16 x i1> splat (i1 true), <16 x float> poison), !tbaa !41, !alias.scope !710 ; 2 uses
  ...
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %wide.masked.gather, <16 x ptr> align 4 %vector.gep, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !711, !noalias !710
  %wide.gep108 = getelementptr inbounds nuw i8, <16 x ptr> %vector.gep, i64 4
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %i.ct, <16 x ptr> align 4 %wide.gep108, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !711, !noalias !710
  %wide.gep109 = getelementptr inbounds nuw i8, <16 x ptr> %vector.gep, i64 8
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %i.cv, <16 x ptr> align 4 %wide.gep109, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !711, !noalias !710
  %wide.gep110 = getelementptr inbounds nuw i8, <16 x ptr> %vector.gep, i64 12
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %wide.masked.gather103, <16 x ptr> align 4 %wide.gep110, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !711, !noalias !710
  ...
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %i.cb, <16 x ptr> align 4 %wide.gep111, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !711, !noalias !710
  %wide.gep112 = getelementptr inbounds nuw i8, <16 x ptr> %vector.gep, i64 20
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %i.da, <16 x ptr> align 4 %wide.gep112, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !711, !noalias !710
  %wide.gep113 = getelementptr inbounds nuw i8, <16 x ptr> %vector.gep, i64 24
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %i.dc, <16 x ptr> align 4 %wide.gep113, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !711, !noalias !710
  %wide.gep114 = getelementptr inbounds nuw i8, <16 x ptr> %vector.gep, i64 28
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %i.cp, <16 x ptr> align 4 %wide.gep114, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !711, !noalias !710
  ...
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %i.cd, <16 x ptr> align 4 %wide.gep115, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !711, !noalias !710
  %wide.gep116 = getelementptr inbounds nuw i8, <16 x ptr> %vector.gep, i64 36
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %i.dh, <16 x ptr> align 4 %wide.gep116, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !711, !noalias !710
  %wide.gep117 = getelementptr inbounds nuw i8, <16 x ptr> %vector.gep, i64 40
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %i.dj, <16 x ptr> align 4 %wide.gep117, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !711, !noalias !710
  %wide.gep118 = getelementptr inbounds nuw i8, <16 x ptr> %vector.gep, i64 44
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %i.cr, <16 x ptr> align 4 %wide.gep118, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !711, !noalias !710
  ...
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %wide.masked.gather95, <16 x ptr> align 4 %wide.gep119, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !711, !noalias !710
  %wide.gep120 = getelementptr inbounds nuw i8, <16 x ptr> %vector.gep, i64 52
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %i.dl, <16 x ptr> align 4 %wide.gep120, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !711, !noalias !710
  %wide.gep121 = getelementptr inbounds nuw i8, <16 x ptr> %vector.gep, i64 56
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %i.dn, <16 x ptr> align 4 %wide.gep121, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !711, !noalias !710
  %wide.gep122 = getelementptr inbounds nuw i8, <16 x ptr> %vector.gep, i64 60
  call void @llvm.masked.scatter.v16f32.v16p0(<16 x float> %wide.masked.gather107, <16 x ptr> align 4 %wide.gep122, <16 x i1> splat (i1 true)), !tbaa !41, !alias.scope !711, !noalias !710
  ...
  br i1 %i.do, label %middle.block, label %vector.body, !llvm.loop !700

middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %._crit_edge.i, label %vec.epilog.iter.check

vec.epilog.iter.check:                            ; preds = %middle.block
  br i1 %min.epilog.iters.check.not.not, label %.preheader.preheader.i.preheader, label %vec.epilog.ph, !prof !105
...
begin_hunk_3_@_ZN4ncnnL42conv3x3s1_winograd23_transform_kernel_int8ERKNS_3MatERS0_iiRKNS_6OptionE:bb.a
          to label %_ZN4ncnn3MatD2Ev.exit8 unwind label %bb.k, !inline_history !0

bb.i:                                             ; preds = %bb.g
  %.not.i14 = icmp eq ptr %i.bn, null
  br i1 %.not.i14, label %_ZN4ncnn3MatD2Ev.exit8, label %bb.j

bb.j:                                             ; preds = %bb.i
  call void @free(ptr noundef nonnull %i.bn) #12
...
_ZN4ncnn3MatD2Ev.exit8:                           ; preds = %bb.f, %bb.e, %bb.h, %bb.i, %bb.j
...
bb.l:                                             ; preds = %_ZN4ncnnL25get_optimal_tile_mnk_int8EiiiRiS0_S0_i.exit
  %i.bt = landingpad { ptr, i32 }
          cleanup
  %i.bu = load ptr, ptr %i.bb, align 8, !tbaa !20 ; 2 uses
  %.not.i9 = icmp eq ptr %i.bu, null
  br i1 %.not.i9, label %_ZN4ncnn3MatD2Ev.exit, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.bv = atomicrmw add ptr %i.bu, i32 -1 acq_rel, align 4
  %i.bw = icmp eq i32 %i.bv, 1
  br i1 %i.bw, label %bb.n, label %_ZN4ncnn3MatD2Ev.exit

bb.n:                                             ; preds = %bb.m
  %i.bx = load ptr, ptr %i.bc, align 8, !tbaa !21 ; 3 uses
  %.not3.i10 = icmp eq ptr %i.bx, null
  %i.by = load ptr, ptr %5, align 8, !tbaa !22    ; 3 uses
  br i1 %.not3.i10, label %bb.p, label %bb.o

bb.o:                                             ; preds = %bb.n
  %i.bz = load ptr, ptr %i.bx, align 8, !tbaa !14
  %i.ca = getelementptr inbounds nuw i8, ptr %i.bz, i64 24
  %i.cb = load ptr, ptr %i.ca, align 8
  invoke void %i.cb(ptr noundef nonnull align 8 dereferenceable(8) %i.bx, ptr noundef %i.by)
          to label %_ZN4ncnn3MatD2Ev.exit unwind label %bb.r, !inline_history !0

bb.p:                                             ; preds = %bb.n
  %.not.i13 = icmp eq ptr %i.by, null
  br i1 %.not.i13, label %_ZN4ncnn3MatD2Ev.exit, label %bb.q

bb.q:                                             ; preds = %bb.p
  call void @free(ptr noundef nonnull %i.by) #12
  br label %_ZN4ncnn3MatD2Ev.exit
...
_ZN4ncnn3Mat7channelEi.exit49:                    ; preds = %bb.c
  %i.ae = load ptr, ptr %4, align 8, !tbaa !22, !noalias !1629
  %i.af = load i64, ptr %i.l, align 8, !tbaa !23, !noalias !1629
  %i.ag = sext i32 %i.ad to i64
  %i.ah = mul i64 %i.af, %i.ag
  %i.ai = load i64, ptr %i.m, align 8, !tbaa !64, !noalias !1629
  %i.aj = mul i64 %i.ah, %i.ai
  %i.ak = getelementptr inbounds nuw i8, ptr %i.ae, i64 %i.aj ; 2 uses
  %i.al = load i32, ptr %5, align 4, !tbaa !66    ; 2 uses
  %i.am = icmp sgt i32 %i.al, 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ds = load i8, ptr %i.cn, align 1, !tbaa !85, !alias.scope !1630
  %i.dt = load i8, ptr %i.cp, align 1, !tbaa !85, !alias.scope !1630
  %i.du = load i8, ptr %i.cr, align 1, !tbaa !85, !alias.scope !1630
  %i.dv = load i8, ptr %i.ct, align 1, !tbaa !85, !alias.scope !1630
  %i.dw = load i8, ptr %i.cv, align 1, !tbaa !85, !alias.scope !1630
  %i.dx = load i8, ptr %i.cx, align 1, !tbaa !85, !alias.scope !1630
  %i.dy = load i8, ptr %i.cz, align 1, !tbaa !85, !alias.scope !1630
  %i.dz = load i8, ptr %i.db, align 1, !tbaa !85, !alias.scope !1630
  %i.ea = load i8, ptr %i.dd, align 1, !tbaa !85, !alias.scope !1630
  %i.eb = load i8, ptr %i.df, align 1, !tbaa !85, !alias.scope !1630
  %i.ec = load i8, ptr %i.dh, align 1, !tbaa !85, !alias.scope !1630
  %i.ed = load i8, ptr %i.dj, align 1, !tbaa !85, !alias.scope !1630
  %i.ee = load i8, ptr %i.dl, align 1, !tbaa !85, !alias.scope !1630
  %i.ef = load i8, ptr %i.dn, align 1, !tbaa !85, !alias.scope !1630
  %i.eg = load i8, ptr %i.dp, align 1, !tbaa !85, !alias.scope !1630
  %i.eh = load i8, ptr %i.dr, align 1, !tbaa !85, !alias.scope !1630
  ...
  %i.fo = load i8, ptr %i.ey, align 1, !tbaa !85, !alias.scope !1630
  %i.fp = load i8, ptr %i.ez, align 1, !tbaa !85, !alias.scope !1630
  %i.fq = load i8, ptr %i.fa, align 1, !tbaa !85, !alias.scope !1630
end_hunk_3
