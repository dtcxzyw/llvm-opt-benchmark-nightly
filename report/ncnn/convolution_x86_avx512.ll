...
bb.ki:                                            ; preds = %bb.kh
  ...
  %op.rdx969 = add nuw nsw i32 %i.alr, %i.alm
  %i.als = and i32 %i.rk, 1
  %i.alt = add nuw nsw i32 %i.als, 1
  call void @_ZN4ncnn3Mat6createEiiimPNS_9AllocatorE(ptr noundef nonnull align 8 dereferenceable(72) %i.aez, i32 noundef %i.all, i32 noundef %op.rdx969, i32 noundef %i.alt, i64 noundef 4, ptr noundef null)
  br label %.preheader1584.i
...
bb.kr:                                            ; preds = %bb.kq
  ...
  %op.rdx970 = add nuw nsw i32 %i.anb, %i.amw
  call void @_ZN4ncnn3Mat6createEiiimPNS_9AllocatorE(ptr noundef nonnull align 8 dereferenceable(72) %i.aez, i32 noundef %i.amv, i32 noundef %op.rdx970, i32 noundef %i.rk, i64 noundef 4, ptr noundef null)
  br label %.preheader1584.i
...
_ZN4ncnn3MatD2Ev.exit1330.lr.ph.i:                ; preds = %bb.jl, %bb.jk, %bb.ji, %bb.jg, %bb.je
  ...
  %i.aov = add nuw i32 %i.aou, 16                 ; 4 uses
  ...
  %lcmp.mod1052 = trunc i32 %i.afa to i1
  %xtraiter1054 = and i64 %wide.trip.count.i, 3   ; 3 uses
  %i.apc = icmp ult i64 %i.apa, 3
  %unroll_iter1058 = and i64 %wide.trip.count.i, 2147483644
  %lcmp.mod1055.not = icmp eq i64 %xtraiter1054, 0
  %lcmp.mod1057 = icmp ne i64 %xtraiter1054, 0
  %xtraiter1061 = and i64 %wide.trip.count.i, 7   ; 3 uses
  %i.apd = icmp ult i64 %i.apa, 7
  %unroll_iter1066 = and i64 %wide.trip.count.i, 2147483640
  %lcmp.mod1063.not = icmp eq i64 %xtraiter1061, 0
  %lcmp.mod1065 = icmp ne i64 %xtraiter1061, 0
...
.preheader1584.i:                                 ; preds = %.preheader1584.loopexit.i, %bb.ky, %bb.kx, %bb.kv, %bb.kt, %bb.kr, %bb.kp, %bb.ko, %bb.km, %bb.kk, %bb.ki, %bb.kf, %bb.ke, %bb.kc, %bb.ka, %bb.jy, %bb.jv, %bb.ju, %bb.js, %bb.jq, %bb.jo
  %.01122.lcssa.i = phi i32 [ %i.ape, %.preheader1584.loopexit.i ], [ 0, %bb.jq ], [ 0, %bb.ju ], [ 0, %bb.jv ], [ 0, %bb.js ], [ 0, %bb.jo ], [ 0, %bb.kk ], [ 0, %bb.ko ], [ 0, %bb.kp ], [ 0, %bb.km ], [ 0, %bb.ki ], [ 0, %bb.kt ], [ 0, %bb.kx ], [ 0, %bb.ky ], [ 0, %bb.kv ], [ 0, %bb.kr ], [ 0, %bb.jy ], [ 0, %bb.kc ], [ 0, %bb.kf ], [ 0, %bb.ke ], [ 0, %bb.ka ] ; 5 uses
  %i.apf = or disjoint i32 %.01122.lcssa.i, 7
...
_ZN4ncnn3MatD2Ev.exit1329.lr.ph.i:                ; preds = %.preheader1584.i
  ...
  %i.aqk = mul i32 %i.aph, %.01122.lcssa.i
  %i.aql = shl i32 %i.aph, 3
  %i.aqm = and i32 %i.aqf, -16
  %i.aqn = add nuw i32 %i.aqm, 16                 ; 4 uses
  %i.aqo = add i32 %i.cj, -8
  %i.aqp = zext nneg i32 %.01122.lcssa.i to i64
  %i.aqq = add i32 %.01122.lcssa.i, 7
  ...
  %xtraiter1069 = and i64 %wide.trip.count2235.i, 1
  %i.aqv = icmp eq i64 %i.aqu, 0
  %unroll_iter1074 = and i64 %wide.trip.count2235.i, 2147483646
  %lcmp.mod1071.not = icmp eq i64 %xtraiter1069, 0
  %lcmp.mod1073 = trunc i32 %i.afa to i1
  %xtraiter1077 = and i64 %wide.trip.count2235.i, 3 ; 3 uses
  %i.aqw = icmp ult i64 %i.aqu, 3
  %unroll_iter1082 = and i64 %wide.trip.count2235.i, 2147483644
  %lcmp.mod1079.not = icmp eq i64 %xtraiter1077, 0
  %lcmp.mod1081 = icmp ne i64 %xtraiter1077, 0
  %xtraiter1085 = and i64 %wide.trip.count2235.i, 7 ; 3 uses
  %i.aqx = icmp ult i64 %i.aqu, 7
  %unroll_iter1090 = and i64 %wide.trip.count2235.i, 2147483640
  %lcmp.mod1087.not = icmp eq i64 %xtraiter1085, 0
  %lcmp.mod1089 = icmp ne i64 %xtraiter1085, 0
...
_ZN4ncnn3MatD2Ev.exit1330.i:                      ; preds = %._crit_edge1671.split.i, %_ZN4ncnn3MatD2Ev.exit1330.lr.ph.i
  ...
  %indvars.iv.i228 = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit1330.lr.ph.i ], [ %indvars.iv.next.i229, %._crit_edge1671.split.i ] ; 2 uses
  %i.aqy = sext i32 %indvars.iv.i228 to i64
...
.preheader1589.us.i:                              ; preds = %._crit_edge.us.i, %.preheader1589.us.preheader.i
  ...
  %.011281611.us.i = phi ptr [ %i.ayd, %._crit_edge.us.i ], [ %i.arp, %.preheader1589.us.preheader.i ] ; 2 uses
  %.011291610.us.i = phi ptr [ %i.aye, %._crit_edge.us.i ], [ %i.art, %.preheader1589.us.preheader.i ] ; 2 uses
  %.011311609.us.i = phi ptr [ %i.ayf, %._crit_edge.us.i ], [ %i.arx, %.preheader1589.us.preheader.i ] ; 2 uses
  %.011321608.us.i = phi ptr [ %i.ayg, %._crit_edge.us.i ], [ %i.asb, %.preheader1589.us.preheader.i ] ; 2 uses
  %.011481607.us.i = phi ptr [ %i.ayh, %._crit_edge.us.i ], [ %i.asf, %.preheader1589.us.preheader.i ] ; 2 uses
  %.011491606.us.i = phi ptr [ %i.ayi, %._crit_edge.us.i ], [ %i.asj, %.preheader1589.us.preheader.i ] ; 2 uses
  %.011551605.us.i = phi ptr [ %i.ayj, %._crit_edge.us.i ], [ %i.asn, %.preheader1589.us.preheader.i ] ; 2 uses
  ...
  %.011601601.us.i = phi ptr [ %i.ayn, %._crit_edge.us.i ], [ %i.atd, %.preheader1589.us.preheader.i ] ; 2 uses
  ...
  %.011651597.us.i = phi ptr [ %i.ayr, %._crit_edge.us.i ], [ %i.att, %.preheader1589.us.preheader.i ] ; 2 uses
...
bb.kz:                                            ; preds = %bb.kz, %.preheader1589.us.i
  ...
  %i.atv = getelementptr inbounds nuw [4 x i8], ptr %.011281611.us.i, i64 %indvars.iv2173.i
  %i.atw = getelementptr inbounds nuw [4 x i8], ptr %.011291610.us.i, i64 %indvars.iv2173.i
  %i.atx = getelementptr inbounds nuw [4 x i8], ptr %.011311609.us.i, i64 %indvars.iv2173.i
  %i.aty = getelementptr inbounds nuw [4 x i8], ptr %.011321608.us.i, i64 %indvars.iv2173.i
  %i.atz = getelementptr inbounds nuw [4 x i8], ptr %.011481607.us.i, i64 %indvars.iv2173.i
  %i.aua = getelementptr inbounds nuw [4 x i8], ptr %.011491606.us.i, i64 %indvars.iv2173.i
  %i.aub = getelementptr inbounds nuw [4 x i8], ptr %.011551605.us.i, i64 %indvars.iv2173.i
  ...
  %i.auf = getelementptr inbounds nuw [4 x i8], ptr %.011601601.us.i, i64 %indvars.iv2173.i
  ...
  %i.auj = getelementptr inbounds nuw [4 x i8], ptr %.011651597.us.i, i64 %indvars.iv2173.i
...
begin_hunk_1_@_ZN4ncnn22Convolution_x86_avx51215create_pipelineERKNS_6OptionE:bb.a
  ...
  %niter1059.next.3 = add i64 %niter1059, 4       ; 2 uses
  %niter1059.ncmp.3 = icmp eq i64 %niter1059.next.3, %unroll_iter1058
  br i1 %niter1059.ncmp.3, label %._crit_edge.us1662.i.unr-lcssa, label %.preheader1586.us.i.new, !llvm.loop !107

._crit_edge.us1662.i.unr-lcssa:                   ; preds = %.preheader1586.us.i.new
  br i1 %lcmp.mod1055.not, label %._crit_edge.us1662.i, label %.epil.preheader1053

.epil.preheader1053:                              ; preds = %._crit_edge.us1662.i.unr-lcssa, %.preheader1586.us.i
  ...
  call void @llvm.assume(i1 %lcmp.mod1057)
  br label %bb.lb

bb.lb:                                            ; preds = %bb.lb, %.epil.preheader1053
  %indvars.iv2192.i.epil = phi i64 [ %indvars.iv2192.i.epil.init, %.epil.preheader1053 ], [ %indvars.iv.next2193.i.epil, %bb.lb ] ; 2 uses
  %.911751655.us.i.epil = phi ptr [ %.911751655.us.i.epil.init, %.epil.preheader1053 ], [ %i.bdg, %bb.lb ] ; 3 uses
  %epil.iter = phi i64 [ 0, %.epil.preheader1053 ], [ %epil.iter.next, %bb.lb ]
  ...
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter1054
...
._crit_edge.us1662.i:                             ; preds = %bb.lb, %._crit_edge.us1662.i.unr-lcssa
  %.lcssa1047 = phi ptr [ %i.bda, %._crit_edge.us1662.i.unr-lcssa ], [ %i.bdg, %bb.lb ] ; 2 uses
...
.preheader1590.i:                                 ; preds = %._crit_edge.us1662.i, %.preheader1591.i
  ...
  %.81174.lcssa.i = phi ptr [ %.51171.lcssa.i, %.preheader1591.i ], [ %.lcssa1047, %._crit_edge.us1662.i ]
...
.preheader1585.i:                                 ; preds = %.preheader1590.i, %._crit_edge.i
  %.111670.i = phi ptr [ %.lcssa1050, %._crit_edge.i ], [ %.81174.lcssa.i, %.preheader1590.i ] ; 2 uses
  %.411811669.i = phi i32 [ %i.bdp, %._crit_edge.i ], [ %.31180.lcssa.i, %.preheader1590.i ]
  br i1 %i.apd, label %.epil.preheader1060, label %.preheader1585.i.new

._crit_edge.i.unr-lcssa:                          ; preds = %.preheader1585.i.new
  br i1 %lcmp.mod1063.not, label %._crit_edge.i, label %.epil.preheader1060

.epil.preheader1060:                              ; preds = %._crit_edge.i.unr-lcssa, %.preheader1585.i
...
bb.lc:                                            ; preds = %bb.lc, %.epil.preheader1060
  %indvars.iv2197.i.epil = phi i64 [ %indvars.iv2197.i.epil.init, %.epil.preheader1060 ], [ %indvars.iv.next2198.i.epil, %bb.lc ] ; 2 uses
  %.121668.i.epil = phi ptr [ %.121668.i.epil.init, %.epil.preheader1060 ], [ %i.bdo, %bb.lc ] ; 2 uses
  %epil.iter1062 = phi i64 [ 0, %.epil.preheader1060 ], [ %epil.iter1062.next, %bb.lc ]
  ...
  %epil.iter1062.next = add i64 %epil.iter1062, 1 ; 2 uses
  %epil.iter1062.cmp.not = icmp eq i64 %epil.iter1062.next, %xtraiter1061
  br i1 %epil.iter1062.cmp.not, label %._crit_edge.i, label %bb.lc, !llvm.loop !110

._crit_edge.i:                                    ; preds = %bb.lc, %._crit_edge.i.unr-lcssa
  %.lcssa1050 = phi ptr [ %i.beu, %._crit_edge.i.unr-lcssa ], [ %i.bdo, %bb.lc ]
...
.preheader1585.i.new:                             ; preds = %.preheader1585.i, %.preheader1585.i.new
  ...
  %niter1067 = phi i64 [ %niter1067.next.7, %.preheader1585.i.new ], [ 0, %.preheader1585.i ]
  ...
  %niter1067.next.7 = add i64 %niter1067, 8       ; 2 uses
  %niter1067.ncmp.7 = icmp eq i64 %niter1067.next.7, %unroll_iter1066
  br i1 %niter1067.ncmp.7, label %._crit_edge.i.unr-lcssa, label %.preheader1585.i.new, !llvm.loop !112
...
._crit_edge1671.split.i:                          ; preds = %._crit_edge.i, %.preheader1590.i, %.preheader1586.lr.ph.i, %.preheader1587.lr.ph.i
  ...
  %indvars.iv.next.i229 = add i32 %indvars.iv.i228, %i.aot
...
.preheader1575.i:                                 ; preds = %.preheader1575.loopexit.i, %.preheader1584.i
  %.1.lcssa.i = phi i32 [ %.01122.lcssa.i, %.preheader1584.i ], [ %i.bex, %.preheader1575.loopexit.i ] ; 4 uses
...
_ZN4ncnn3MatD2Ev.exit1328.lr.ph.i:                ; preds = %.preheader1575.i
  ...
  %i.bgp = add nuw i32 %i.bgo, 16                 ; 4 uses
  ...
  %xtraiter1093 = and i64 %wide.trip.count2287.i, 3 ; 3 uses
  %i.bgy = icmp ult i64 %i.bgx, 3
  %unroll_iter1098 = and i64 %wide.trip.count2287.i, 2147483644
  %lcmp.mod1095.not = icmp eq i64 %xtraiter1093, 0
  %lcmp.mod1097 = icmp ne i64 %xtraiter1093, 0
  %xtraiter1101 = and i64 %wide.trip.count2287.i, 7 ; 3 uses
  %i.bgz = icmp ult i64 %i.bgx, 7
  %unroll_iter1106 = and i64 %wide.trip.count2287.i, 2147483640
  %lcmp.mod1103.not = icmp eq i64 %xtraiter1101, 0
  %lcmp.mod1105 = icmp ne i64 %xtraiter1101, 0
...
.preheader1580.us.i:                              ; preds = %.preheader1580.lr.ph.i, %._crit_edge1676.us.i
  ...
  %.012311684.us.i = phi ptr [ %i.bla, %._crit_edge1676.us.i ], [ %i.bhs, %.preheader1580.lr.ph.i ] ; 2 uses
  ...
  %.012401680.us.i = phi ptr [ %i.ble, %._crit_edge1676.us.i ], [ %i.bih, %.preheader1580.lr.ph.i ] ; 2 uses
  %.012421679.us.i = phi ptr [ %i.bkw, %._crit_edge1676.us.i ], [ %i.bis, %.preheader1580.lr.ph.i ]
  %.012841678.us.i = phi i32 [ %i.blf, %._crit_edge1676.us.i ], [ 0, %.preheader1580.lr.ph.i ]
  br label %bb.ld
...
bb.ld:                                            ; preds = %bb.ld, %.preheader1580.us.i
  ...
  %i.biw = getelementptr inbounds nuw [4 x i8], ptr %.012311684.us.i, i64 %indvars.iv2232.i
  ...
  %i.bja = getelementptr inbounds nuw [4 x i8], ptr %.012401680.us.i, i64 %indvars.iv2232.i
...
._crit_edge1676.us.i:                             ; preds = %bb.ld
  ...
  %i.bla = getelementptr inbounds nuw [4 x i8], ptr %.012311684.us.i, i64 %i.apt ; 2 uses
  ...
  %i.ble = getelementptr inbounds nuw [4 x i8], ptr %.012401680.us.i, i64 %i.apt ; 2 uses
  %i.blf = add nuw nsw i32 %.012841678.us.i, 16   ; 2 uses
...
.preheader1583.i:                                 ; preds = %._crit_edge1676.us.i, %_ZN4ncnn3MatD2Ev.exit1329.i
  %.01284.lcssa.i = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit1329.i ], [ %i.aqn, %._crit_edge1676.us.i ] ; 4 uses
  %.01242.lcssa.i = phi ptr [ %i.bis, %_ZN4ncnn3MatD2Ev.exit1329.i ], [ %i.bkw, %._crit_edge1676.us.i ] ; 3 uses
  %.01240.lcssa.i = phi ptr [ %i.bih, %_ZN4ncnn3MatD2Ev.exit1329.i ], [ %i.ble, %._crit_edge1676.us.i ]
  ...
  %.01231.lcssa.i = phi ptr [ %i.bhs, %_ZN4ncnn3MatD2Ev.exit1329.i ], [ %i.bla, %._crit_edge1676.us.i ]
  ...
  %i.bli = or disjoint i32 %.01284.lcssa.i, 7
...
.preheader1579.preheader.i:                       ; preds = %.preheader1579.lr.ph.i, %.preheader1583.thread.i
  %.01284.lcssa24862508.i = phi i32 [ %.01284.lcssa.i, %.preheader1579.lr.ph.i ], [ %i.aqn, %.preheader1583.thread.i ] ; 2 uses
...
begin_hunk_2_@_ZN4ncnn22Convolution_x86_avx51215create_pipelineERKNS_6OptionE:bb.a
  ...
  %niter1083.next.3 = add i64 %niter1083, 4       ; 2 uses
  %niter1083.ncmp.3 = icmp eq i64 %niter1083.next.3, %unroll_iter1082
  br i1 %niter1083.ncmp.3, label %._crit_edge1750.us.i.unr-lcssa, label %.preheader1577.us.i.new, !llvm.loop !123

._crit_edge1750.us.i.unr-lcssa:                   ; preds = %.preheader1577.us.i.new
  br i1 %lcmp.mod1079.not, label %._crit_edge1750.us.i, label %.epil.preheader1076

.epil.preheader1076:                              ; preds = %._crit_edge1750.us.i.unr-lcssa, %.preheader1577.us.i
  ...
  call void @llvm.assume(i1 %lcmp.mod1081)
  br label %bb.lf

bb.lf:                                            ; preds = %bb.lf, %.epil.preheader1076
  %indvars.iv2253.i.epil = phi i64 [ %indvars.iv2253.i.epil.init, %.epil.preheader1076 ], [ %indvars.iv.next2254.i.epil, %bb.lf ] ; 2 uses
  %.812501749.us.i.epil = phi ptr [ %.812501749.us.i.epil.init, %.epil.preheader1076 ], [ %i.bqy, %bb.lf ] ; 3 uses
  %epil.iter1078 = phi i64 [ 0, %.epil.preheader1076 ], [ %epil.iter1078.next, %bb.lf ]
  ...
  %epil.iter1078.next = add i64 %epil.iter1078, 1 ; 2 uses
  %epil.iter1078.cmp.not = icmp eq i64 %epil.iter1078.next, %xtraiter1077
  br i1 %epil.iter1078.cmp.not, label %._crit_edge1750.us.i, label %bb.lf, !llvm.loop !124

._crit_edge1750.us.i:                             ; preds = %bb.lf, %._crit_edge1750.us.i.unr-lcssa
  %.lcssa1035 = phi ptr [ %i.bqs, %._crit_edge1750.us.i.unr-lcssa ], [ %i.bqy, %bb.lf ] ; 2 uses
  %i.bqz = getelementptr inbounds nuw [4 x i8], ptr %.312251754.us.i, i64 %i.aqd ; 2 uses
  %i.bra = add nuw nsw i32 %.312871752.us.i, 2    ; 3 uses
...
.preheader1581.i:                                 ; preds = %._crit_edge1750.us.i, %.preheader1582.i
  %.31287.lcssa.i = phi i32 [ %.21286.lcssa.i, %.preheader1582.i ], [ %i.bra, %._crit_edge1750.us.i ] ; 2 uses
  %.71249.lcssa.i = phi ptr [ %.41246.lcssa.i, %.preheader1582.i ], [ %.lcssa1035, %._crit_edge1750.us.i ]
  %.31225.lcssa.i = phi ptr [ %.21224.lcssa.i, %.preheader1582.i ], [ %i.bqz, %._crit_edge1750.us.i ] ; 9 uses
  %i.brd = icmp sge i32 %.31287.lcssa.i, %i.cj
...
.preheader1576.i:                                 ; preds = %.preheader1581.i, %._crit_edge1763.i
  %.1012521766.i = phi ptr [ %.lcssa1038, %._crit_edge1763.i ], [ %.71249.lcssa.i, %.preheader1581.i ] ; 2 uses
  %.412881765.i = phi i32 [ %i.brh, %._crit_edge1763.i ], [ %.31287.lcssa.i, %.preheader1581.i ]
  br i1 %i.aqx, label %.epil.preheader1084, label %.preheader1576.i.new

._crit_edge1763.i.unr-lcssa:                      ; preds = %.preheader1576.i.new
  br i1 %lcmp.mod1087.not, label %._crit_edge1763.i, label %.epil.preheader1084

.epil.preheader1084:                              ; preds = %._crit_edge1763.i.unr-lcssa, %.preheader1576.i
  ...
  call void @llvm.assume(i1 %lcmp.mod1089)
  br label %bb.lg

bb.lg:                                            ; preds = %bb.lg, %.epil.preheader1084
  %indvars.iv2258.i.epil = phi i64 [ %indvars.iv2258.i.epil.init, %.epil.preheader1084 ], [ %indvars.iv.next2259.i.epil, %bb.lg ] ; 2 uses
  %.1112531762.i.epil = phi ptr [ %.1112531762.i.epil.init, %.epil.preheader1084 ], [ %i.brg, %bb.lg ] ; 2 uses
  %epil.iter1086 = phi i64 [ 0, %.epil.preheader1084 ], [ %epil.iter1086.next, %bb.lg ]
  ...
  %epil.iter1086.next = add i64 %epil.iter1086, 1 ; 2 uses
  %epil.iter1086.cmp.not = icmp eq i64 %epil.iter1086.next, %xtraiter1085
  br i1 %epil.iter1086.cmp.not, label %._crit_edge1763.i, label %bb.lg, !llvm.loop !126

._crit_edge1763.i:                                ; preds = %bb.lg, %._crit_edge1763.i.unr-lcssa
  %.lcssa1038 = phi ptr [ %i.bsm, %._crit_edge1763.i.unr-lcssa ], [ %i.brg, %bb.lg ]
  %i.brh = add nuw nsw i32 %.412881765.i, 1       ; 2 uses
...
.preheader1576.i.new:                             ; preds = %.preheader1576.i, %.preheader1576.i.new
  ...
  %niter1091 = phi i64 [ %niter1091.next.7, %.preheader1576.i.new ], [ 0, %.preheader1576.i ]
  ...
  %niter1091.next.7 = add i64 %niter1091, 8       ; 2 uses
  %niter1091.ncmp.7 = icmp eq i64 %niter1091.next.7, %unroll_iter1090
  br i1 %niter1091.ncmp.7, label %._crit_edge1763.i.unr-lcssa, label %.preheader1576.i.new, !llvm.loop !128
...
_ZN4ncnn3MatD2Ev.exit1327.lr.ph.i:                ; preds = %.preheader1566.i
  ...
  %i.bty = add nuw i32 %i.btx, 16                 ; 4 uses
  ...
  %xtraiter1109 = and i64 %wide.trip.count2331.i, 3 ; 3 uses
  %i.bul = icmp ult i64 %i.buk, 3
  %unroll_iter1114 = and i64 %wide.trip.count2331.i, 2147483644
  %lcmp.mod1111.not = icmp eq i64 %xtraiter1109, 0
  %lcmp.mod1113 = icmp ne i64 %xtraiter1109, 0
  %xtraiter1117 = and i64 %wide.trip.count2331.i, 3 ; 3 uses
  %i.bum = icmp ult i64 %i.buk, 3
  %unroll_iter1122 = and i64 %wide.trip.count2331.i, 2147483644
  %lcmp.mod1119.not = icmp eq i64 %xtraiter1117, 0
  %lcmp.mod1121 = icmp ne i64 %xtraiter1117, 0
  %xtraiter1125 = and i64 %wide.trip.count2331.i, 3 ; 3 uses
  %i.bun = icmp ult i64 %i.buk, 3
  %unroll_iter1130 = and i64 %wide.trip.count2331.i, 2147483644
  %lcmp.mod1127.not = icmp eq i64 %xtraiter1125, 0
  %lcmp.mod1129 = icmp ne i64 %xtraiter1125, 0
  %min.iters.check790 = icmp ult i32 %i.afa, 4
  %stride.check778 = icmp slt i32 %i.btm, 0
  %min.iters.check792 = icmp ult i32 %i.afa, 16
  %i.buo = and i64 %wide.trip.count2331.i, 12
  %n.vec794 = and i64 %wide.trip.count2331.i, 2147483632 ; 5 uses
  %i.bup = shl nuw nsw i64 %n.vec794, 4
  %cmp.n805 = icmp eq i64 %n.vec794, %wide.trip.count2331.i
  %min.epilog.iters.check810 = icmp eq i64 %i.buo, 0
  %n.vec812 = and i64 %wide.trip.count2331.i, 2147483644 ; 4 uses
  %i.buq = shl nuw nsw i64 %n.vec812, 4
  %cmp.n823 = icmp eq i64 %n.vec812, %wide.trip.count2331.i
  %xtraiter1132 = and i64 %wide.trip.count2331.i, 1
  %lcmp.mod1133.not = icmp eq i64 %xtraiter1132, 0
  %i.bur = add nsw i64 %wide.trip.count2331.i, -1
  %min.iters.check = icmp ult i32 %i.afa, 4
  %min.iters.check748 = icmp ult i32 %i.afa, 16
  ...
  %n.vec750 = and i64 %wide.trip.count2331.i, 2147483644 ; 4 uses
  %i.buu = shl nuw nsw i64 %n.vec750, 3
  %cmp.n757 = icmp eq i64 %n.vec750, %wide.trip.count2331.i
  %xtraiter1134 = and i64 %wide.trip.count2331.i, 3 ; 2 uses
...
.preheader1571.us.i:                              ; preds = %.preheader1571.lr.ph.i, %._crit_edge1772.us.i
  %.012551779.us.i = phi i32 [ %i.bxf, %._crit_edge1772.us.i ], [ 0, %.preheader1571.lr.ph.i ]
  %.012601778.us.i = phi ptr [ %i.bxa, %._crit_edge1772.us.i ], [ %i.bwc, %.preheader1571.lr.ph.i ]
  %.012711777.us.i = phi ptr [ %i.bxe, %._crit_edge1772.us.i ], [ %i.bvo, %.preheader1571.lr.ph.i ] ; 2 uses
  %.012741776.us.i = phi ptr [ %i.bxd, %._crit_edge1772.us.i ], [ %i.bvl, %.preheader1571.lr.ph.i ] ; 2 uses
  %.012771775.us.i = phi ptr [ %i.bxc, %._crit_edge1772.us.i ], [ %i.bvh, %.preheader1571.lr.ph.i ] ; 2 uses
  %.012801774.us.i = phi ptr [ %i.bxb, %._crit_edge1772.us.i ], [ %i.bvd, %.preheader1571.lr.ph.i ] ; 2 uses
  br label %bb.lh

bb.lh:                                            ; preds = %bb.lh, %.preheader1571.us.i
  %indvars.iv2284.i = phi i64 [ 0, %.preheader1571.us.i ], [ %indvars.iv.next2285.i, %bb.lh ] ; 5 uses
  %.112611770.us.i = phi ptr [ %.012601778.us.i, %.preheader1571.us.i ], [ %i.bxa, %bb.lh ] ; 5 uses
  %i.bwd = getelementptr inbounds nuw [4 x i8], ptr %.012801774.us.i, i64 %indvars.iv2284.i
  %i.bwe = getelementptr inbounds nuw [4 x i8], ptr %.012771775.us.i, i64 %indvars.iv2284.i
  %i.bwf = getelementptr inbounds nuw [4 x i8], ptr %.012741776.us.i, i64 %indvars.iv2284.i
  %i.bwg = getelementptr inbounds nuw [4 x i8], ptr %.012711777.us.i, i64 %indvars.iv2284.i
  ...
  store <16 x float> %i.bwt, ptr %.112611770.us.i, align 1, !tbaa !100
  %i.bwx = getelementptr inbounds nuw i8, ptr %.112611770.us.i, i64 64
  store <16 x float> %i.bwu, ptr %i.bwx, align 1, !tbaa !100
  %i.bwy = getelementptr inbounds nuw i8, ptr %.112611770.us.i, i64 128
  store <16 x float> %i.bwv, ptr %i.bwy, align 1, !tbaa !100
  %i.bwz = getelementptr inbounds nuw i8, ptr %.112611770.us.i, i64 192
  store <16 x float> %i.bww, ptr %i.bwz, align 1, !tbaa !100
  %i.bxa = getelementptr inbounds nuw i8, ptr %.112611770.us.i, i64 256 ; 3 uses
...
._crit_edge1772.us.i:                             ; preds = %bb.lh
  %i.bxb = getelementptr inbounds nuw [4 x i8], ptr %.012801774.us.i, i64 %i.bfs ; 2 uses
  %i.bxc = getelementptr inbounds nuw [4 x i8], ptr %.012771775.us.i, i64 %i.bfs ; 2 uses
  %i.bxd = getelementptr inbounds nuw [4 x i8], ptr %.012741776.us.i, i64 %i.bfs ; 2 uses
  %i.bxe = getelementptr inbounds nuw [4 x i8], ptr %.012711777.us.i, i64 %i.bfs ; 2 uses
  %i.bxf = add nuw nsw i32 %.012551779.us.i, 16   ; 2 uses
...
.preheader1574.i:                                 ; preds = %._crit_edge1772.us.i, %_ZN4ncnn3MatD2Ev.exit1328.i
  %.01280.lcssa.i = phi ptr [ %i.bvd, %_ZN4ncnn3MatD2Ev.exit1328.i ], [ %i.bxb, %._crit_edge1772.us.i ] ; 3 uses
  %.01277.lcssa.i = phi ptr [ %i.bvh, %_ZN4ncnn3MatD2Ev.exit1328.i ], [ %i.bxc, %._crit_edge1772.us.i ] ; 3 uses
  %.01274.lcssa.i = phi ptr [ %i.bvl, %_ZN4ncnn3MatD2Ev.exit1328.i ], [ %i.bxd, %._crit_edge1772.us.i ] ; 3 uses
  %.01271.lcssa.i = phi ptr [ %i.bvo, %_ZN4ncnn3MatD2Ev.exit1328.i ], [ %i.bxe, %._crit_edge1772.us.i ] ; 3 uses
  %.01260.lcssa.i = phi ptr [ %i.bwc, %_ZN4ncnn3MatD2Ev.exit1328.i ], [ %i.bxa, %._crit_edge1772.us.i ] ; 3 uses
  %.01255.lcssa.i = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit1328.i ], [ %i.bgp, %._crit_edge1772.us.i ] ; 4 uses
  %i.bxi = or disjoint i32 %.01255.lcssa.i, 7
...
.preheader1570.preheader.i:                       ; preds = %.preheader1570.lr.ph.i, %.preheader1574.thread.i
  %.01280.lcssa25312548.i = phi ptr [ %.01280.lcssa.i, %.preheader1570.lr.ph.i ], [ %scevgep2274.i, %.preheader1574.thread.i ]
  %.01277.lcssa25322547.i = phi ptr [ %.01277.lcssa.i, %.preheader1570.lr.ph.i ], [ %scevgep2277.i, %.preheader1574.thread.i ]
  %.01274.lcssa25332546.i = phi ptr [ %.01274.lcssa.i, %.preheader1570.lr.ph.i ], [ %scevgep2280.i, %.preheader1574.thread.i ]
  %.01271.lcssa25342545.i = phi ptr [ %.01271.lcssa.i, %.preheader1570.lr.ph.i ], [ %scevgep2283.i, %.preheader1574.thread.i ]
  %.01260.lcssa25352544.i = phi ptr [ %.01260.lcssa.i, %.preheader1570.lr.ph.i ], [ %i.bwc, %.preheader1574.thread.i ]
  %.01255.lcssa25362543.i = phi i32 [ %.01255.lcssa.i, %.preheader1570.lr.ph.i ], [ %i.bgp, %.preheader1574.thread.i ] ; 2 uses
  %i.bxo = sub i32 %i.bgq, %.01255.lcssa25362543.i ; 2 uses
  ...
  %scevgep2289.i = getelementptr i8, ptr %.01280.lcssa25312548.i, i64 %i.bxs
  %scevgep2290.i = getelementptr i8, ptr %.01277.lcssa25322547.i, i64 %i.bxs
  %scevgep2291.i = getelementptr i8, ptr %.01274.lcssa25332546.i, i64 %i.bxs
  %scevgep2292.i = getelementptr i8, ptr %.01271.lcssa25342545.i, i64 %i.bxs
  %i.bxt = add i32 %.01255.lcssa25362543.i, 8
...
begin_hunk_3_@_ZN4ncnn22Convolution_x86_avx51215create_pipelineERKNS_6OptionE:bb.a
  %i.cam = getelementptr inbounds nuw i8, ptr %.712671834.us.i, i64 48
  ...
  %i.cao = getelementptr inbounds nuw i8, ptr %.712671834.us.i, i64 64
  %i.cap = getelementptr inbounds nuw [4 x i8], ptr %.312831838.us.i, i64 %indvars.iv2307.i
  ...
  %i.cat = getelementptr inbounds nuw i8, ptr %.712671834.us.i, i64 80
  ...
  %i.cav = getelementptr inbounds nuw i8, ptr %.712671834.us.i, i64 96
  %i.caw = getelementptr inbounds nuw [4 x i8], ptr %.312831838.us.i, i64 %indvars.iv2307.i
  ...
  %i.cba = getelementptr inbounds nuw i8, ptr %.712671834.us.i, i64 112
  ...
  %i.cbc = getelementptr inbounds nuw i8, ptr %.712671834.us.i, i64 128 ; 3 uses
  ...
  br i1 %niter1099.ncmp.3, label %._crit_edge1836.us.i.unr-lcssa, label %.preheader1568.us.i.new, !llvm.loop !139

._crit_edge1836.us.i.unr-lcssa:                   ; preds = %.preheader1568.us.i.new
  br i1 %lcmp.mod1095.not, label %._crit_edge1836.us.i, label %.epil.preheader1092

.epil.preheader1092:                              ; preds = %._crit_edge1836.us.i.unr-lcssa, %.preheader1568.us.i
  %indvars.iv2307.i.epil.init = phi i64 [ 0, %.preheader1568.us.i ], [ %indvars.iv.next2308.i.3, %._crit_edge1836.us.i.unr-lcssa ]
  %.712671834.us.i.epil.init = phi ptr [ %.612661839.us.i, %.preheader1568.us.i ], [ %i.cbc, %._crit_edge1836.us.i.unr-lcssa ]
  call void @llvm.assume(i1 %lcmp.mod1097)
  br label %bb.lk

bb.lk:                                            ; preds = %bb.lk, %.epil.preheader1092
  %indvars.iv2307.i.epil = phi i64 [ %indvars.iv2307.i.epil.init, %.epil.preheader1092 ], [ %indvars.iv.next2308.i.epil, %bb.lk ] ; 2 uses
  %.712671834.us.i.epil = phi ptr [ %.712671834.us.i.epil.init, %.epil.preheader1092 ], [ %i.cbi, %bb.lk ] ; 3 uses
  %epil.iter1094 = phi i64 [ 0, %.epil.preheader1092 ], [ %epil.iter1094.next, %bb.lk ]
  %i.cbd = getelementptr inbounds nuw [4 x i8], ptr %.312831838.us.i, i64 %indvars.iv2307.i.epil ; 2 uses
  ...
  store <4 x float> %i.cbe, ptr %.712671834.us.i.epil, align 16, !tbaa !100
  %i.cbf = getelementptr inbounds nuw [4 x i8], ptr %i.cbd, i64 %i.bga
  %i.cbg = getelementptr inbounds nuw i8, ptr %.712671834.us.i.epil, i64 16
  ...
  %i.cbi = getelementptr inbounds nuw i8, ptr %.712671834.us.i.epil, i64 32 ; 2 uses
  ...
  br i1 %epil.iter1094.cmp.not, label %._crit_edge1836.us.i, label %bb.lk, !llvm.loop !140

._crit_edge1836.us.i:                             ; preds = %bb.lk, %._crit_edge1836.us.i.unr-lcssa
  %.lcssa1016 = phi ptr [ %i.cbc, %._crit_edge1836.us.i.unr-lcssa ], [ %i.cbi, %bb.lk ] ; 2 uses
  %i.cbj = getelementptr inbounds nuw [4 x i8], ptr %.312831838.us.i, i64 %i.bgc ; 2 uses
  %i.cbk = add nuw nsw i32 %.312581840.us.i, 2    ; 3 uses
...
.preheader1572.i:                                 ; preds = %._crit_edge1836.us.i, %._crit_edge1824.i
  %.31283.lcssa.i = phi ptr [ %.21282.lcssa.i, %._crit_edge1824.i ], [ %i.cbj, %._crit_edge1836.us.i ] ; 9 uses
  %.61266.lcssa.i = phi ptr [ %.41264.lcssa.i, %._crit_edge1824.i ], [ %.lcssa1016, %._crit_edge1836.us.i ]
  %.31258.lcssa.i = phi i32 [ %.21257.lcssa.i, %._crit_edge1824.i ], [ %i.cbk, %._crit_edge1836.us.i ] ; 2 uses
  %i.cbn = icmp sge i32 %.31258.lcssa.i, %i.cj
...
.preheader1567.i:                                 ; preds = %.preheader1572.i, %._crit_edge1849.i
  %.412591852.i = phi i32 [ %i.cbr, %._crit_edge1849.i ], [ %.31258.lcssa.i, %.preheader1572.i ]
  %.912691851.i = phi ptr [ %.lcssa1019, %._crit_edge1849.i ], [ %.61266.lcssa.i, %.preheader1572.i ] ; 2 uses
  br i1 %i.bgz, label %.epil.preheader1100, label %.preheader1567.i.new

._crit_edge1849.i.unr-lcssa:                      ; preds = %.preheader1567.i.new
  br i1 %lcmp.mod1103.not, label %._crit_edge1849.i, label %.epil.preheader1100

.epil.preheader1100:                              ; preds = %._crit_edge1849.i.unr-lcssa, %.preheader1567.i
  %indvars.iv2312.i.epil.init = phi i64 [ 0, %.preheader1567.i ], [ %indvars.iv.next2313.i.7, %._crit_edge1849.i.unr-lcssa ]
  %.1012701847.i.epil.init = phi ptr [ %.912691851.i, %.preheader1567.i ], [ %i.ccw, %._crit_edge1849.i.unr-lcssa ]
  call void @llvm.assume(i1 %lcmp.mod1105)
  br label %bb.ll

bb.ll:                                            ; preds = %bb.ll, %.epil.preheader1100
  %indvars.iv2312.i.epil = phi i64 [ %indvars.iv2312.i.epil.init, %.epil.preheader1100 ], [ %indvars.iv.next2313.i.epil, %bb.ll ] ; 2 uses
  %.1012701847.i.epil = phi ptr [ %.1012701847.i.epil.init, %.epil.preheader1100 ], [ %i.cbq, %bb.ll ] ; 2 uses
  %epil.iter1102 = phi i64 [ 0, %.epil.preheader1100 ], [ %epil.iter1102.next, %bb.ll ]
  %i.cbo = getelementptr inbounds nuw [4 x i8], ptr %.31283.lcssa.i, i64 %indvars.iv2312.i.epil
  ...
  store <4 x float> %i.cbp, ptr %.1012701847.i.epil, align 16, !tbaa !100
  %i.cbq = getelementptr inbounds nuw i8, ptr %.1012701847.i.epil, i64 16 ; 2 uses
  %indvars.iv.next2313.i.epil = add nuw nsw i64 %indvars.iv2312.i.epil, 1
  %epil.iter1102.next = add i64 %epil.iter1102, 1 ; 2 uses
  %epil.iter1102.cmp.not = icmp eq i64 %epil.iter1102.next, %xtraiter1101
  br i1 %epil.iter1102.cmp.not, label %._crit_edge1849.i, label %bb.ll, !llvm.loop !142

._crit_edge1849.i:                                ; preds = %bb.ll, %._crit_edge1849.i.unr-lcssa
  %.lcssa1019 = phi ptr [ %i.ccw, %._crit_edge1849.i.unr-lcssa ], [ %i.cbq, %bb.ll ]
  %i.cbr = add nuw nsw i32 %.412591852.i, 1       ; 2 uses
...
.preheader1567.i.new:                             ; preds = %.preheader1567.i, %.preheader1567.i.new
  ...
  %.1012701847.i = phi ptr [ %i.ccw, %.preheader1567.i.new ], [ %.912691851.i, %.preheader1567.i ] ; 9 uses
  %niter1107 = phi i64 [ %niter1107.next.7, %.preheader1567.i.new ], [ 0, %.preheader1567.i ]
  %i.cbs = getelementptr inbounds nuw [4 x i8], ptr %.31283.lcssa.i, i64 %indvars.iv2312.i
  ...
  store <4 x float> %i.cbt, ptr %.1012701847.i, align 16, !tbaa !100
  %i.cbu = getelementptr inbounds nuw i8, ptr %.1012701847.i, i64 16
  %i.cbv = getelementptr inbounds nuw [4 x i8], ptr %.31283.lcssa.i, i64 %indvars.iv2312.i
  ...
  %i.cby = getelementptr inbounds nuw i8, ptr %.1012701847.i, i64 32
  %i.cbz = getelementptr inbounds nuw [4 x i8], ptr %.31283.lcssa.i, i64 %indvars.iv2312.i
  ...
  %i.ccc = getelementptr inbounds nuw i8, ptr %.1012701847.i, i64 48
  %i.ccd = getelementptr inbounds nuw [4 x i8], ptr %.31283.lcssa.i, i64 %indvars.iv2312.i
  ...
  %i.ccg = getelementptr inbounds nuw i8, ptr %.1012701847.i, i64 64
  %i.cch = getelementptr inbounds nuw [4 x i8], ptr %.31283.lcssa.i, i64 %indvars.iv2312.i
  ...
  %i.cck = getelementptr inbounds nuw i8, ptr %.1012701847.i, i64 80
  %i.ccl = getelementptr inbounds nuw [4 x i8], ptr %.31283.lcssa.i, i64 %indvars.iv2312.i
  ...
  %i.cco = getelementptr inbounds nuw i8, ptr %.1012701847.i, i64 96
  %i.ccp = getelementptr inbounds nuw [4 x i8], ptr %.31283.lcssa.i, i64 %indvars.iv2312.i
  ...
  %i.ccs = getelementptr inbounds nuw i8, ptr %.1012701847.i, i64 112
  %i.cct = getelementptr inbounds nuw [4 x i8], ptr %.31283.lcssa.i, i64 %indvars.iv2312.i
  ...
  %i.ccw = getelementptr inbounds nuw i8, ptr %.1012701847.i, i64 128 ; 3 uses
  %indvars.iv.next2313.i.7 = add nuw nsw i64 %indvars.iv2312.i, 8 ; 2 uses
  %niter1107.next.7 = add i64 %niter1107, 8       ; 2 uses
  %niter1107.ncmp.7 = icmp eq i64 %niter1107.next.7, %unroll_iter1106
  br i1 %niter1107.ncmp.7, label %._crit_edge1849.i.unr-lcssa, label %.preheader1567.i.new, !llvm.loop !144
...
_ZN4ncnn3MatD2Ev.exit.lr.ph.i:                    ; preds = %.preheader1556.i
  ...
  %i.cei = add nuw i32 %i.ceh, 16                 ; 4 uses
  ...
  %xtraiter1137 = and i64 %wide.trip.count2372.i, 7 ; 3 uses
  %i.ces = icmp ult i64 %i.cer, 7
  %unroll_iter1142 = and i64 %wide.trip.count2372.i, 2147483640
  %lcmp.mod1139.not = icmp eq i64 %xtraiter1137, 0
  %lcmp.mod1141 = icmp ne i64 %xtraiter1137, 0
  %xtraiter1145 = and i64 %wide.trip.count2372.i, 7 ; 3 uses
  %i.cet = icmp ult i64 %i.cer, 7
  %unroll_iter1150 = and i64 %wide.trip.count2372.i, 2147483640
  %lcmp.mod1147.not = icmp eq i64 %xtraiter1145, 0
  %lcmp.mod1149 = icmp ne i64 %xtraiter1145, 0
  %xtraiter1153 = and i64 %wide.trip.count2372.i, 7 ; 3 uses
  %i.ceu = icmp ult i64 %i.cer, 7
  %unroll_iter1158 = and i64 %wide.trip.count2372.i, 2147483640
  %lcmp.mod1155.not = icmp eq i64 %xtraiter1153, 0
  %lcmp.mod1157 = icmp ne i64 %xtraiter1153, 0
  %min.iters.check877 = icmp ult i32 %i.afa, 8
  %stride.check875 = icmp slt i32 %i.cdy, 0
  %min.iters.check879 = icmp ult i32 %i.afa, 32
  %i.cev = and i64 %wide.trip.count2372.i, 24
  %n.vec881 = and i64 %wide.trip.count2372.i, 2147483616 ; 5 uses
  %i.cew = shl nuw nsw i64 %n.vec881, 3
  %cmp.n894 = icmp eq i64 %n.vec881, %wide.trip.count2372.i
  %min.epilog.iters.check899 = icmp eq i64 %i.cev, 0
  %n.vec901 = and i64 %wide.trip.count2372.i, 2147483640 ; 4 uses
  %i.cex = shl nuw nsw i64 %n.vec901, 3
  %cmp.n910 = icmp eq i64 %n.vec901, %wide.trip.count2372.i
  %xtraiter1160 = and i64 %wide.trip.count2372.i, 3 ; 2 uses
  %lcmp.mod1161.not = icmp eq i64 %xtraiter1160, 0
  %min.iters.check829 = icmp ult i32 %i.afa, 8
  %min.iters.check831 = icmp ult i32 %i.afa, 64
  %i.cey = and i64 %wide.trip.count2372.i, 56
  %n.vec833 = and i64 %wide.trip.count2372.i, 2147483584 ; 5 uses
  %i.cez = shl nuw nsw i64 %n.vec833, 2
  %cmp.n843 = icmp eq i64 %n.vec833, %wide.trip.count2372.i
  %min.epilog.iters.check848 = icmp eq i64 %i.cey, 0
  %n.vec850 = and i64 %wide.trip.count2372.i, 2147483640 ; 4 uses
  %i.cfa = shl nuw nsw i64 %n.vec850, 2
  %cmp.n857 = icmp eq i64 %n.vec850, %wide.trip.count2372.i
  %xtraiter1163 = and i64 %wide.trip.count2372.i, 7 ; 2 uses
...
.preheader1561.us.i:                              ; preds = %.preheader1561.lr.ph.i, %._crit_edge1858.us.i
  %.011831863.us.i = phi i32 [ %i.chg, %._crit_edge1858.us.i ], [ 0, %.preheader1561.lr.ph.i ]
  %.011881862.us.i = phi ptr [ %.lcssa986, %._crit_edge1858.us.i ], [ %i.cfz, %.preheader1561.lr.ph.i ] ; 2 uses
  %.011991861.us.i = phi ptr [ %i.chf, %._crit_edge1858.us.i ], [ %i.cfn, %.preheader1561.lr.ph.i ] ; 6 uses
  %.012031860.us.i = phi ptr [ %i.che, %._crit_edge1858.us.i ], [ %i.cfk, %.preheader1561.lr.ph.i ] ; 6 uses
  br i1 %i.bul, label %.epil.preheader1108, label %.preheader1561.us.i.new
...
.preheader1561.us.i.new:                          ; preds = %.preheader1561.us.i, %.preheader1561.us.i.new
  ...
  %.111891856.us.i = phi ptr [ %i.cgx, %.preheader1561.us.i.new ], [ %.011881862.us.i, %.preheader1561.us.i ] ; 9 uses
  %niter1115 = phi i64 [ %niter1115.next.3, %.preheader1561.us.i.new ], [ 0, %.preheader1561.us.i ]
  %i.cga = getelementptr inbounds nuw [4 x i8], ptr %.012031860.us.i, i64 %indvars.iv2328.i
  %i.cgb = getelementptr inbounds nuw [4 x i8], ptr %.011991861.us.i, i64 %indvars.iv2328.i
  ...
  store <16 x float> %i.cgc, ptr %.111891856.us.i, align 1, !tbaa !100
  %i.cge = getelementptr inbounds nuw i8, ptr %.111891856.us.i, i64 64
  store <16 x float> %i.cgd, ptr %i.cge, align 1, !tbaa !100
  %i.cgf = getelementptr inbounds nuw i8, ptr %.111891856.us.i, i64 128
  %indvars.iv.next2329.i = or disjoint i64 %indvars.iv2328.i, 1 ; 2 uses
  %i.cgg = getelementptr inbounds nuw [4 x i8], ptr %.012031860.us.i, i64 %indvars.iv.next2329.i
  %i.cgh = getelementptr inbounds nuw [4 x i8], ptr %.011991861.us.i, i64 %indvars.iv.next2329.i
  ...
  %i.cgk = getelementptr inbounds nuw i8, ptr %.111891856.us.i, i64 192
  store <16 x float> %i.cgj, ptr %i.cgk, align 1, !tbaa !100
  %i.cgl = getelementptr inbounds nuw i8, ptr %.111891856.us.i, i64 256
  %indvars.iv.next2329.i.1 = or disjoint i64 %indvars.iv2328.i, 2 ; 2 uses
  %i.cgm = getelementptr inbounds nuw [4 x i8], ptr %.012031860.us.i, i64 %indvars.iv.next2329.i.1
  %i.cgn = getelementptr inbounds nuw [4 x i8], ptr %.011991861.us.i, i64 %indvars.iv.next2329.i.1
  ...
  %i.cgq = getelementptr inbounds nuw i8, ptr %.111891856.us.i, i64 320
  store <16 x float> %i.cgp, ptr %i.cgq, align 1, !tbaa !100
  %i.cgr = getelementptr inbounds nuw i8, ptr %.111891856.us.i, i64 384
  %indvars.iv.next2329.i.2 = or disjoint i64 %indvars.iv2328.i, 3 ; 2 uses
  %i.cgs = getelementptr inbounds nuw [4 x i8], ptr %.012031860.us.i, i64 %indvars.iv.next2329.i.2
  %i.cgt = getelementptr inbounds nuw [4 x i8], ptr %.011991861.us.i, i64 %indvars.iv.next2329.i.2
  ...
  %i.cgw = getelementptr inbounds nuw i8, ptr %.111891856.us.i, i64 448
  store <16 x float> %i.cgv, ptr %i.cgw, align 1, !tbaa !100
  %i.cgx = getelementptr inbounds nuw i8, ptr %.111891856.us.i, i64 512 ; 3 uses
  %indvars.iv.next2329.i.3 = add nuw nsw i64 %indvars.iv2328.i, 4 ; 2 uses
  %niter1115.next.3 = add i64 %niter1115, 4       ; 2 uses
  %niter1115.ncmp.3 = icmp eq i64 %niter1115.next.3, %unroll_iter1114
  br i1 %niter1115.ncmp.3, label %._crit_edge1858.us.i.unr-lcssa, label %.preheader1561.us.i.new, !llvm.loop !149

._crit_edge1858.us.i.unr-lcssa:                   ; preds = %.preheader1561.us.i.new
  br i1 %lcmp.mod1111.not, label %._crit_edge1858.us.i, label %.epil.preheader1108

.epil.preheader1108:                              ; preds = %._crit_edge1858.us.i.unr-lcssa, %.preheader1561.us.i
  %indvars.iv2328.i.epil.init = phi i64 [ 0, %.preheader1561.us.i ], [ %indvars.iv.next2329.i.3, %._crit_edge1858.us.i.unr-lcssa ]
  %.111891856.us.i.epil.init = phi ptr [ %.011881862.us.i, %.preheader1561.us.i ], [ %i.cgx, %._crit_edge1858.us.i.unr-lcssa ]
  call void @llvm.assume(i1 %lcmp.mod1113)
  br label %bb.lm

bb.lm:                                            ; preds = %bb.lm, %.epil.preheader1108
  %indvars.iv2328.i.epil = phi i64 [ %indvars.iv2328.i.epil.init, %.epil.preheader1108 ], [ %indvars.iv.next2329.i.epil, %bb.lm ] ; 3 uses
  %.111891856.us.i.epil = phi ptr [ %.111891856.us.i.epil.init, %.epil.preheader1108 ], [ %i.chd, %bb.lm ] ; 3 uses
  %epil.iter1110 = phi i64 [ 0, %.epil.preheader1108 ], [ %epil.iter1110.next, %bb.lm ]
  %i.cgy = getelementptr inbounds nuw [4 x i8], ptr %.012031860.us.i, i64 %indvars.iv2328.i.epil
  %i.cgz = getelementptr inbounds nuw [4 x i8], ptr %.011991861.us.i, i64 %indvars.iv2328.i.epil
  ...
  store <16 x float> %i.cha, ptr %.111891856.us.i.epil, align 1, !tbaa !100
  %i.chc = getelementptr inbounds nuw i8, ptr %.111891856.us.i.epil, i64 64
  store <16 x float> %i.chb, ptr %i.chc, align 1, !tbaa !100
  %i.chd = getelementptr inbounds nuw i8, ptr %.111891856.us.i.epil, i64 128 ; 2 uses
  %indvars.iv.next2329.i.epil = add nuw nsw i64 %indvars.iv2328.i.epil, 1
  %epil.iter1110.next = add i64 %epil.iter1110, 1 ; 2 uses
  %epil.iter1110.cmp.not = icmp eq i64 %epil.iter1110.next, %xtraiter1109
  br i1 %epil.iter1110.cmp.not, label %._crit_edge1858.us.i, label %bb.lm, !llvm.loop !150

._crit_edge1858.us.i:                             ; preds = %bb.lm, %._crit_edge1858.us.i.unr-lcssa
  %.lcssa986 = phi ptr [ %i.cgx, %._crit_edge1858.us.i.unr-lcssa ], [ %i.chd, %bb.lm ] ; 2 uses
  %i.che = getelementptr inbounds nuw [4 x i8], ptr %.012031860.us.i, i64 %i.btg ; 2 uses
  %i.chf = getelementptr inbounds nuw [4 x i8], ptr %.011991861.us.i, i64 %i.btg ; 2 uses
  %i.chg = add nuw nsw i32 %.011831863.us.i, 16   ; 2 uses
...
.preheader1565.i:                                 ; preds = %._crit_edge1858.us.i, %_ZN4ncnn3MatD2Ev.exit1327.i
  %.01203.lcssa.i = phi ptr [ %i.cfk, %_ZN4ncnn3MatD2Ev.exit1327.i ], [ %i.che, %._crit_edge1858.us.i ] ; 3 uses
  %.01199.lcssa.i = phi ptr [ %i.cfn, %_ZN4ncnn3MatD2Ev.exit1327.i ], [ %i.chf, %._crit_edge1858.us.i ] ; 3 uses
  %.01188.lcssa.i = phi ptr [ %i.cfz, %_ZN4ncnn3MatD2Ev.exit1327.i ], [ %.lcssa986, %._crit_edge1858.us.i ] ; 3 uses
  %.01183.lcssa.i = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit1327.i ], [ %i.bty, %._crit_edge1858.us.i ] ; 4 uses
  %i.chj = or disjoint i32 %.01183.lcssa.i, 7
...
.preheader1560.preheader.i:                       ; preds = %.preheader1560.lr.ph.i, %.preheader1565.thread.i
  %.01203.lcssa25692580.i = phi ptr [ %.01203.lcssa.i, %.preheader1560.lr.ph.i ], [ %scevgep2324.i, %.preheader1565.thread.i ]
  %.01199.lcssa25702579.i = phi ptr [ %.01199.lcssa.i, %.preheader1560.lr.ph.i ], [ %scevgep2327.i, %.preheader1565.thread.i ]
  %.01188.lcssa25712578.i = phi ptr [ %.01188.lcssa.i, %.preheader1560.lr.ph.i ], [ %i.cfz, %.preheader1565.thread.i ]
  %.01183.lcssa25722577.i = phi i32 [ %.01183.lcssa.i, %.preheader1560.lr.ph.i ], [ %i.bty, %.preheader1565.thread.i ] ; 2 uses
  %i.chl = sub i32 %i.btz, %.01183.lcssa25722577.i ; 2 uses
...
_ZN4ncnn3MatD2Ev.exit1286.lr.ph.i:                ; preds = %bb.ck, %bb.cj, %bb.ch, %bb.cf
  ...
  %i.su = add nuw i32 %i.st, 16                   ; 4 uses
  %i.sv = add i32 %i.p, -8
...
.preheader1506.i:                                 ; preds = %.preheader1506.loopexit.i, %bb.dp, %bb.do, %bb.dm, %bb.dk, %bb.di, %bb.dh, %bb.df, %bb.dd, %bb.da, %bb.cz, %bb.cx, %bb.cv, %bb.cs, %bb.cr, %bb.cp, %bb.cn
  %.01085.lcssa.i = phi i32 [ %i.tc, %.preheader1506.loopexit.i ], [ 0, %bb.cp ], [ 0, %bb.cs ], [ 0, %bb.cr ], [ 0, %bb.cn ], [ 0, %bb.df ], [ 0, %bb.di ], [ 0, %bb.dh ], [ 0, %bb.dd ], [ 0, %bb.dm ], [ 0, %bb.dp ], [ 0, %bb.do ], [ 0, %bb.dk ], [ 0, %bb.cv ], [ 0, %bb.cz ], [ 0, %bb.da ], [ 0, %bb.cx ] ; 5 uses
  %i.td = or disjoint i32 %.01085.lcssa.i, 7
...
_ZN4ncnn3MatD2Ev.exit1285.lr.ph.i:                ; preds = %.preheader1506.i
  ...
  %i.uu = mul i32 %i.tf, %.01085.lcssa.i
  %i.uv = shl i32 %i.tf, 3
  %i.uw = and i32 %i.uq, -16
  %i.ux = add nuw i32 %i.uw, 16                   ; 4 uses
  %i.uy = add i32 %i.p, -8
  %i.uz = zext nneg i32 %.01085.lcssa.i to i64
  %i.va = add i32 %.01085.lcssa.i, 7
...
.lr.ph.us.i:                                      ; preds = %.lr.ph1530.i, %._crit_edge.us.i
  %.010871529.us.i = phi ptr [ %i.adr, %._crit_edge.us.i ], [ %i.vn, %.lr.ph1530.i ] ; 2 uses
  %.010911528.us.i = phi ptr [ %i.ads, %._crit_edge.us.i ], [ %i.vr, %.lr.ph1530.i ] ; 2 uses
  %.011061527.us.i = phi ptr [ %i.adt, %._crit_edge.us.i ], [ %i.vv, %.lr.ph1530.i ] ; 2 uses
  %.011081526.us.i = phi ptr [ %i.adu, %._crit_edge.us.i ], [ %i.vz, %.lr.ph1530.i ] ; 2 uses
  %.011111525.us.i = phi ptr [ %i.adv, %._crit_edge.us.i ], [ %i.wd, %.lr.ph1530.i ] ; 2 uses
  %.011141524.us.i = phi ptr [ %i.adw, %._crit_edge.us.i ], [ %i.wh, %.lr.ph1530.i ] ; 2 uses
  %.011171523.us.i = phi ptr [ %i.adx, %._crit_edge.us.i ], [ %i.wl, %.lr.ph1530.i ] ; 2 uses
  %.011191522.us.i = phi ptr [ %i.ady, %._crit_edge.us.i ], [ %i.wp, %.lr.ph1530.i ] ; 2 uses
  %.011401521.us.i = phi ptr [ %i.adz, %._crit_edge.us.i ], [ %i.wt, %.lr.ph1530.i ] ; 2 uses
  %.011441520.us.i = phi ptr [ %i.aea, %._crit_edge.us.i ], [ %i.wx, %.lr.ph1530.i ] ; 2 uses
  %.011831519.us.i = phi ptr [ %i.aeb, %._crit_edge.us.i ], [ %i.xb, %.lr.ph1530.i ] ; 2 uses
  %.011851518.us.i = phi ptr [ %i.aec, %._crit_edge.us.i ], [ %i.xf, %.lr.ph1530.i ] ; 2 uses
  %.011881517.us.i = phi ptr [ %i.aed, %._crit_edge.us.i ], [ %i.xj, %.lr.ph1530.i ] ; 2 uses
  %.012331516.us.i = phi ptr [ %i.aee, %._crit_edge.us.i ], [ %i.xn, %.lr.ph1530.i ] ; 2 uses
  %.012361515.us.i = phi ptr [ %i.aef, %._crit_edge.us.i ], [ %i.xr, %.lr.ph1530.i ] ; 2 uses
  %.012381514.us.i = phi ptr [ %i.aeg, %._crit_edge.us.i ], [ %i.xv, %.lr.ph1530.i ] ; 2 uses
  %.012411513.us.i = phi ptr [ %i.adq, %._crit_edge.us.i ], [ %i.yc, %.lr.ph1530.i ]
  %.012491512.us.i = phi i32 [ %i.aeh, %._crit_edge.us.i ], [ 0, %.lr.ph1530.i ]
  br label %bb.dq

bb.dq:                                            ; preds = %bb.dq, %.lr.ph.us.i
  %indvars.iv2138.i = phi i64 [ 0, %.lr.ph.us.i ], [ %indvars.iv.next2139.i, %bb.dq ] ; 17 uses
  %.112421511.us.i = phi ptr [ %.012411513.us.i, %.lr.ph.us.i ], [ %i.adq, %bb.dq ] ; 17 uses
  %i.yd = getelementptr inbounds nuw i8, ptr %.010871529.us.i, i64 %indvars.iv2138.i
  ...
  %i.yg = getelementptr inbounds nuw i8, ptr %.010911528.us.i, i64 %indvars.iv2138.i
  ...
  %i.yj = getelementptr inbounds nuw i8, ptr %.011061527.us.i, i64 %indvars.iv2138.i
  ...
  %i.yp = getelementptr inbounds nuw i8, ptr %.011111525.us.i, i64 %indvars.iv2138.i
  ...
  %i.ys = getelementptr inbounds nuw i8, ptr %.011141524.us.i, i64 %indvars.iv2138.i
  ...
  %i.yv = getelementptr inbounds nuw i8, ptr %.011171523.us.i, i64 %indvars.iv2138.i
  ...
  %i.yy = getelementptr inbounds nuw i8, ptr %.011191522.us.i, i64 %indvars.iv2138.i
  ...
  %i.zb = getelementptr inbounds nuw i8, ptr %.011401521.us.i, i64 %indvars.iv2138.i
  ...
  %i.ze = getelementptr inbounds nuw i8, ptr %.011441520.us.i, i64 %indvars.iv2138.i
  ...
  %i.zh = getelementptr inbounds nuw i8, ptr %.011831519.us.i, i64 %indvars.iv2138.i
  ...
  %i.zk = getelementptr inbounds nuw i8, ptr %.011851518.us.i, i64 %indvars.iv2138.i
  ...
  %i.zn = getelementptr inbounds nuw i8, ptr %.011881517.us.i, i64 %indvars.iv2138.i
  ...
  %i.zq = getelementptr inbounds nuw i8, ptr %.012331516.us.i, i64 %indvars.iv2138.i
  ...
  %i.zt = getelementptr inbounds nuw i8, ptr %.012361515.us.i, i64 %indvars.iv2138.i
  ...
  %i.zw = getelementptr inbounds nuw i8, ptr %.012381514.us.i, i64 %indvars.iv2138.i
...
begin_hunk_5_@_ZN4ncnn22Convolution_x86_avx51224create_pipeline_int8_x86ERKNS_6OptionE:bb.a
  %.11141.lcssa.i = phi ptr [ %.01140.lcssa.i, %.preheader1509.i ], [ %scevgep2115.i, %.preheader1509.thread.i ], [ %scevgep2142.i, %.lr.ph1586.split.preheader.i ], [ %i.akh, %._crit_edge.us1592.i ]
  %.11088.lcssa.i = phi ptr [ %.01087.lcssa.i, %.preheader1509.i ], [ %scevgep2090.i, %.preheader1509.thread.i ], [ %scevgep2141.i, %.lr.ph1586.split.preheader.i ], [ %i.ajz, %._crit_edge.us1592.i ] ; 2 uses
  %i.aks = or disjoint i32 %.11250.lcssa.i, 1
...
.lr.ph.us1608.i:                                  ; preds = %.lr.ph1604.i, %._crit_edge.us1609.i
  %.210891603.us.i = phi ptr [ %i.als, %._crit_edge.us1609.i ], [ %.11088.lcssa.i, %.lr.ph1604.i ] ; 4 uses
  %.211421602.us.i = phi ptr [ %i.alt, %._crit_edge.us1609.i ], [ %.11141.lcssa.i, %.lr.ph1604.i ] ; 4 uses
  %.412451601.us.i = phi ptr [ %.lcssa554, %._crit_edge.us1609.i ], [ %.21243.lcssa.i, %.lr.ph1604.i ] ; 2 uses
  %.212511600.us.i = phi i32 [ %i.alu, %._crit_edge.us1609.i ], [ %.11250.lcssa.i, %.lr.ph1604.i ]
...
.lr.ph.us1608.i.new:                              ; preds = %.lr.ph.us1608.i, %.lr.ph.us1608.i.new
  ...
  %.512461598.us.i = phi ptr [ %i.alj, %.lr.ph.us1608.i.new ], [ %.412451601.us.i, %.lr.ph.us1608.i ] ; 5 uses
  %niter = phi i64 [ %niter.next.1, %.lr.ph.us1608.i.new ], [ 0, %.lr.ph.us1608.i ]
  %i.aku = getelementptr inbounds nuw i8, ptr %.210891603.us.i, i64 %indvars.iv2149.i
  ...
  %i.akx = getelementptr inbounds nuw i8, ptr %.211421602.us.i, i64 %indvars.iv2149.i
  ...
  store <16 x i8> %i.akw, ptr %.512461598.us.i, align 1, !tbaa !100
  %i.ala = getelementptr inbounds nuw i8, ptr %.512461598.us.i, i64 16
  store <16 x i8> %i.akz, ptr %i.ala, align 1, !tbaa !100
  %i.alb = getelementptr inbounds nuw i8, ptr %.512461598.us.i, i64 32
  %indvars.iv.next2150.i = or disjoint i64 %indvars.iv2149.i, 1 ; 2 uses
  %i.alc = getelementptr inbounds nuw i8, ptr %.210891603.us.i, i64 %indvars.iv.next2150.i
  ...
  %i.alf = getelementptr inbounds nuw i8, ptr %.211421602.us.i, i64 %indvars.iv.next2150.i
  ...
  %i.ali = getelementptr inbounds nuw i8, ptr %.512461598.us.i, i64 48
  store <16 x i8> %i.alh, ptr %i.ali, align 1, !tbaa !100
  %i.alj = getelementptr inbounds nuw i8, ptr %.512461598.us.i, i64 64 ; 3 uses
...
.epil.preheader:                                  ; preds = %._crit_edge.us1609.i.unr-lcssa, %.lr.ph.us1608.i
  ...
  %.512461598.us.i.epil.init = phi ptr [ %.412451601.us.i, %.lr.ph.us1608.i ], [ %i.alj, %._crit_edge.us1609.i.unr-lcssa ] ; 3 uses
  tail call void @llvm.assume(i1 %lcmp.mod559)
  %i.alk = getelementptr inbounds nuw i8, ptr %.210891603.us.i, i64 %indvars.iv2149.i.epil.init
  ...
  %i.aln = getelementptr inbounds nuw i8, ptr %.211421602.us.i, i64 %indvars.iv2149.i.epil.init
  ...
  store <16 x i8> %i.alm, ptr %.512461598.us.i.epil.init, align 1, !tbaa !100
  %i.alq = getelementptr inbounds nuw i8, ptr %.512461598.us.i.epil.init, i64 16
  store <16 x i8> %i.alp, ptr %i.alq, align 1, !tbaa !100
  %i.alr = getelementptr inbounds nuw i8, ptr %.512461598.us.i.epil.init, i64 32
...
._crit_edge.us1609.i:                             ; preds = %._crit_edge.us1609.i.unr-lcssa, %.epil.preheader
  ...
  %i.als = getelementptr inbounds nuw i8, ptr %.210891603.us.i, i64 %i.si ; 2 uses
  %i.alt = getelementptr inbounds nuw i8, ptr %.211421602.us.i, i64 %i.si
  %i.alu = add nuw nsw i32 %.212511600.us.i, 2    ; 3 uses
...
.preheader1507.i:                                 ; preds = %._crit_edge.us1609.i, %.preheader1508.i
  %.21251.lcssa.i = phi i32 [ %.11250.lcssa.i, %.preheader1508.i ], [ %i.alu, %._crit_edge.us1609.i ] ; 2 uses
  %.41245.lcssa.i = phi ptr [ %.21243.lcssa.i, %.preheader1508.i ], [ %.lcssa554, %._crit_edge.us1609.i ]
  %.21089.lcssa.i = phi ptr [ %.11088.lcssa.i, %.preheader1508.i ], [ %i.als, %._crit_edge.us1609.i ] ; 5 uses
  %i.alx = icmp sge i32 %.21251.lcssa.i, %i.p
...
.lr.ph.i31:                                       ; preds = %.preheader1507.i, %._crit_edge.i
  %.612471617.i = phi ptr [ %.lcssa557, %._crit_edge.i ], [ %.41245.lcssa.i, %.preheader1507.i ] ; 2 uses
  %.312521616.i = phi i32 [ %i.amc, %._crit_edge.i ], [ %.21251.lcssa.i, %.preheader1507.i ]
...
.epil.preheader560:                               ; preds = %._crit_edge.i.unr-lcssa, %.lr.ph.i31
  ...
  %.712481614.i.epil.init = phi ptr [ %.612471617.i, %.lr.ph.i31 ], [ %i.amv, %._crit_edge.i.unr-lcssa ]
...
bb.ds:                                            ; preds = %bb.ds, %.epil.preheader560
  ...
  %.712481614.i.epil = phi ptr [ %.712481614.i.epil.init, %.epil.preheader560 ], [ %i.amb, %bb.ds ] ; 2 uses
  %epil.iter = phi i64 [ 0, %.epil.preheader560 ], [ %epil.iter.next, %bb.ds ]
  %i.aly = getelementptr inbounds nuw i8, ptr %.21089.lcssa.i, i64 %indvars.iv2154.i.epil
  ...
  store <16 x i8> %i.ama, ptr %.712481614.i.epil, align 1, !tbaa !100
  %i.amb = getelementptr inbounds nuw i8, ptr %.712481614.i.epil, i64 16 ; 2 uses
...
._crit_edge.i:                                    ; preds = %bb.ds, %._crit_edge.i.unr-lcssa
  ...
  %i.amc = add nuw nsw i32 %.312521616.i, 1       ; 2 uses
...
.lr.ph.i31.new:                                   ; preds = %.lr.ph.i31, %.lr.ph.i31.new
  ...
  %.712481614.i = phi ptr [ %i.amv, %.lr.ph.i31.new ], [ %.612471617.i, %.lr.ph.i31 ] ; 5 uses
  %niter566 = phi i64 [ %niter566.next.3, %.lr.ph.i31.new ], [ 0, %.lr.ph.i31 ]
  %i.amd = getelementptr inbounds nuw i8, ptr %.21089.lcssa.i, i64 %indvars.iv2154.i
  ...
  store <16 x i8> %i.amf, ptr %.712481614.i, align 1, !tbaa !100
  %i.amg = getelementptr inbounds nuw i8, ptr %.712481614.i, i64 16
  %i.amh = getelementptr inbounds nuw i8, ptr %.21089.lcssa.i, i64 %indvars.iv2154.i
  ...
  %i.aml = getelementptr inbounds nuw i8, ptr %.712481614.i, i64 32
  %i.amm = getelementptr inbounds nuw i8, ptr %.21089.lcssa.i, i64 %indvars.iv2154.i
  ...
  %i.amq = getelementptr inbounds nuw i8, ptr %.712481614.i, i64 48
  %i.amr = getelementptr inbounds nuw i8, ptr %.21089.lcssa.i, i64 %indvars.iv2154.i
  ...
  %i.amv = getelementptr inbounds nuw i8, ptr %.712481614.i, i64 64 ; 3 uses
...
.preheader1501.i:                                 ; preds = %.preheader1501.loopexit.i, %.preheader1506.i
  %.1.lcssa.i = phi i32 [ %.01085.lcssa.i, %.preheader1506.i ], [ %i.amy, %.preheader1501.loopexit.i ] ; 4 uses
...
_ZN4ncnn3MatD2Ev.exit1284.lr.ph.i:                ; preds = %.preheader1501.i
  ...
  %i.aoh = add nuw i32 %i.aog, 16                 ; 4 uses
  %i.aoi = add i32 %i.p, -8
...
.lr.ph1625.us.i:                                  ; preds = %.lr.ph1638.i, %._crit_edge1626.us.i
  %.012021637.us.i = phi i32 [ %i.atk, %._crit_edge1626.us.i ], [ 0, %.lr.ph1638.i ]
  %.012061636.us.i = phi ptr [ %i.atb, %._crit_edge1626.us.i ], [ %i.aqh, %.lr.ph1638.i ]
  %.012151635.us.i = phi ptr [ %i.atj, %._crit_edge1626.us.i ], [ %i.apw, %.lr.ph1638.i ] ; 2 uses
  %.012171634.us.i = phi ptr [ %i.ati, %._crit_edge1626.us.i ], [ %i.apt, %.lr.ph1638.i ] ; 2 uses
  %.012191633.us.i = phi ptr [ %i.ath, %._crit_edge1626.us.i ], [ %i.app, %.lr.ph1638.i ] ; 2 uses
  %.012211632.us.i = phi ptr [ %i.atg, %._crit_edge1626.us.i ], [ %i.apl, %.lr.ph1638.i ] ; 2 uses
  %.012241631.us.i = phi ptr [ %i.atf, %._crit_edge1626.us.i ], [ %i.aph, %.lr.ph1638.i ] ; 2 uses
  %.012261630.us.i = phi ptr [ %i.ate, %._crit_edge1626.us.i ], [ %i.apd, %.lr.ph1638.i ] ; 2 uses
  %.012281629.us.i = phi ptr [ %i.atd, %._crit_edge1626.us.i ], [ %i.aoz, %.lr.ph1638.i ] ; 2 uses
  %.012301628.us.i = phi ptr [ %i.atc, %._crit_edge1626.us.i ], [ %i.aov, %.lr.ph1638.i ] ; 2 uses
  br label %bb.dt

bb.dt:                                            ; preds = %bb.dt, %.lr.ph1625.us.i
  %indvars.iv2189.i = phi i64 [ 0, %.lr.ph1625.us.i ], [ %indvars.iv.next2190.i, %bb.dt ] ; 9 uses
  %.112071622.us.i = phi ptr [ %.012061636.us.i, %.lr.ph1625.us.i ], [ %i.atb, %bb.dt ] ; 9 uses
  %i.aqi = getelementptr inbounds nuw i8, ptr %.012301628.us.i, i64 %indvars.iv2189.i
  ...
  %i.aql = getelementptr inbounds nuw i8, ptr %.012281629.us.i, i64 %indvars.iv2189.i
  ...
  %i.aqo = getelementptr inbounds nuw i8, ptr %.012261630.us.i, i64 %indvars.iv2189.i
  ...
  %i.aqr = getelementptr inbounds nuw i8, ptr %.012241631.us.i, i64 %indvars.iv2189.i
  ...
  %i.aqu = getelementptr inbounds nuw i8, ptr %.012211632.us.i, i64 %indvars.iv2189.i
  ...
  %i.aqx = getelementptr inbounds nuw i8, ptr %.012191633.us.i, i64 %indvars.iv2189.i
  ...
  %i.ara = getelementptr inbounds nuw i8, ptr %.012171634.us.i, i64 %indvars.iv2189.i
  ...
  %i.ard = getelementptr inbounds nuw i8, ptr %.012151635.us.i, i64 %indvars.iv2189.i
  ...
  store <4 x i32> %i.asm, ptr %.112071622.us.i, align 1, !tbaa !100
  %i.asu = getelementptr inbounds nuw i8, ptr %.112071622.us.i, i64 16
  store <4 x i32> %i.asn, ptr %i.asu, align 1, !tbaa !100
  %i.asv = getelementptr inbounds nuw i8, ptr %.112071622.us.i, i64 32
  store <4 x i32> %i.aso, ptr %i.asv, align 1, !tbaa !100
  %i.asw = getelementptr inbounds nuw i8, ptr %.112071622.us.i, i64 48
  store <4 x i32> %i.asp, ptr %i.asw, align 1, !tbaa !100
  %i.asx = getelementptr inbounds nuw i8, ptr %.112071622.us.i, i64 64
  store <4 x i32> %i.asq, ptr %i.asx, align 1, !tbaa !100
  %i.asy = getelementptr inbounds nuw i8, ptr %.112071622.us.i, i64 80
  store <4 x i32> %i.asr, ptr %i.asy, align 1, !tbaa !100
  %i.asz = getelementptr inbounds nuw i8, ptr %.112071622.us.i, i64 96
  store <4 x i32> %i.ass, ptr %i.asz, align 1, !tbaa !100
  %i.ata = getelementptr inbounds nuw i8, ptr %.112071622.us.i, i64 112
  store <4 x i32> %i.ast, ptr %i.ata, align 1, !tbaa !100
  %i.atb = getelementptr inbounds nuw i8, ptr %.112071622.us.i, i64 128 ; 3 uses
...
._crit_edge1626.us.i:                             ; preds = %bb.dt
  %i.atc = getelementptr inbounds nuw i8, ptr %.012301628.us.i, i64 %i.to ; 2 uses
  %i.atd = getelementptr inbounds nuw i8, ptr %.012281629.us.i, i64 %i.to ; 2 uses
  %i.ate = getelementptr inbounds nuw i8, ptr %.012261630.us.i, i64 %i.to ; 2 uses
  %i.atf = getelementptr inbounds nuw i8, ptr %.012241631.us.i, i64 %i.to ; 2 uses
  %i.atg = getelementptr inbounds nuw i8, ptr %.012211632.us.i, i64 %i.to ; 2 uses
  %i.ath = getelementptr inbounds nuw i8, ptr %.012191633.us.i, i64 %i.to ; 2 uses
  %i.ati = getelementptr inbounds nuw i8, ptr %.012171634.us.i, i64 %i.to ; 2 uses
  %i.atj = getelementptr inbounds nuw i8, ptr %.012151635.us.i, i64 %i.to ; 2 uses
  %i.atk = add nuw nsw i32 %.012021637.us.i, 16   ; 2 uses
...
.preheader1505.i:                                 ; preds = %._crit_edge1626.us.i, %_ZN4ncnn3MatD2Ev.exit1285.i
  %.01230.lcssa.i = phi ptr [ %i.aov, %_ZN4ncnn3MatD2Ev.exit1285.i ], [ %i.atc, %._crit_edge1626.us.i ] ; 3 uses
  %.01228.lcssa.i = phi ptr [ %i.aoz, %_ZN4ncnn3MatD2Ev.exit1285.i ], [ %i.atd, %._crit_edge1626.us.i ]
  %.01226.lcssa.i = phi ptr [ %i.apd, %_ZN4ncnn3MatD2Ev.exit1285.i ], [ %i.ate, %._crit_edge1626.us.i ]
  %.01224.lcssa.i = phi ptr [ %i.aph, %_ZN4ncnn3MatD2Ev.exit1285.i ], [ %i.atf, %._crit_edge1626.us.i ]
  %.01221.lcssa.i = phi ptr [ %i.apl, %_ZN4ncnn3MatD2Ev.exit1285.i ], [ %i.atg, %._crit_edge1626.us.i ]
  %.01219.lcssa.i = phi ptr [ %i.app, %_ZN4ncnn3MatD2Ev.exit1285.i ], [ %i.ath, %._crit_edge1626.us.i ]
  %.01217.lcssa.i = phi ptr [ %i.apt, %_ZN4ncnn3MatD2Ev.exit1285.i ], [ %i.ati, %._crit_edge1626.us.i ]
  %.01215.lcssa.i = phi ptr [ %i.apw, %_ZN4ncnn3MatD2Ev.exit1285.i ], [ %i.atj, %._crit_edge1626.us.i ]
  %.01206.lcssa.i = phi ptr [ %i.aqh, %_ZN4ncnn3MatD2Ev.exit1285.i ], [ %i.atb, %._crit_edge1626.us.i ] ; 3 uses
  %.01202.lcssa.i = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit1285.i ], [ %i.ux, %._crit_edge1626.us.i ] ; 4 uses
  %i.atn = or disjoint i32 %.01202.lcssa.i, 7
...
begin_hunk_6_@_ZN4ncnn22Convolution_x86_avx51224create_pipeline_int8_x86ERKNS_6OptionE:bb.a
  ...
  store <16 x i8> %i.bbv, ptr %.612121690.us.i, align 1, !tbaa !100
  %i.bbw = getelementptr inbounds nuw i8, ptr %.612121690.us.i, i64 16
  %i.bbx = getelementptr inbounds nuw i8, ptr %.212321696.us.i, i64 %indvars.iv2203.i
  ...
  %i.bcb = getelementptr inbounds nuw i8, ptr %.612121690.us.i, i64 32
  %i.bcc = getelementptr inbounds nuw i8, ptr %.212321696.us.i, i64 %indvars.iv2203.i
  ...
  %i.bcg = getelementptr inbounds nuw i8, ptr %.612121690.us.i, i64 48
  %i.bch = getelementptr inbounds nuw i8, ptr %.212321696.us.i, i64 %indvars.iv2203.i
  ...
  %i.bcl = getelementptr inbounds nuw i8, ptr %.612121690.us.i, i64 64 ; 3 uses
...
.epil.preheader567:                               ; preds = %._crit_edge1694.us.i.unr-lcssa, %.lr.ph1693.us.i
  ...
  %.612121690.us.i.epil.init = phi ptr [ %.512111697.us.i, %.lr.ph1693.us.i ], [ %i.bcl, %._crit_edge1694.us.i.unr-lcssa ]
...
bb.dv:                                            ; preds = %bb.dv, %.epil.preheader567
  ...
  %.612121690.us.i.epil = phi ptr [ %.612121690.us.i.epil.init, %.epil.preheader567 ], [ %i.bcp, %bb.dv ] ; 2 uses
  %epil.iter569 = phi i64 [ 0, %.epil.preheader567 ], [ %epil.iter569.next, %bb.dv ]
  %i.bcm = getelementptr inbounds nuw i8, ptr %.212321696.us.i, i64 %indvars.iv2203.i.epil
  ...
  store <16 x i8> %i.bco, ptr %.612121690.us.i.epil, align 1, !tbaa !100
  %i.bcp = getelementptr inbounds nuw i8, ptr %.612121690.us.i.epil, i64 16 ; 2 uses
...
._crit_edge1694.us.i:                             ; preds = %bb.dv, %._crit_edge1694.us.i.unr-lcssa
  ...
  %i.bcq = getelementptr inbounds nuw i8, ptr %.212321696.us.i, i64 %i.tr ; 2 uses
  %i.bcr = add nuw nsw i32 %.212041698.us.i, 2    ; 3 uses
...
.preheader1503.i:                                 ; preds = %._crit_edge1694.us.i, %.preheader1504.i
  %.21232.lcssa.i = phi ptr [ %.11231.lcssa.i, %.preheader1504.i ], [ %i.bcq, %._crit_edge1694.us.i ] ; 5 uses
  %.51211.lcssa.i = phi ptr [ %.21208.lcssa.i, %.preheader1504.i ], [ %.lcssa529, %._crit_edge1694.us.i ]
  %.21204.lcssa.i = phi i32 [ %.11203.lcssa.i, %.preheader1504.i ], [ %i.bcr, %._crit_edge1694.us.i ] ; 2 uses
  %i.bcu = icmp sge i32 %.21204.lcssa.i, %i.p
...
.lr.ph1709.i:                                     ; preds = %.preheader1503.i, %._crit_edge1710.i
  %.312051713.i = phi i32 [ %i.bdc, %._crit_edge1710.i ], [ %.21204.lcssa.i, %.preheader1503.i ]
...
.epil.preheader575:                               ; preds = %._crit_edge1710.i.unr-lcssa, %.lr.ph1709.i
  ...
  %.812141706.i.epil.init = phi ptr [ %.712131712.i, %.lr.ph1709.i ], [ %i.beh, %._crit_edge1710.i.unr-lcssa ]
...
bb.dw:                                            ; preds = %bb.dw, %.epil.preheader575
  ...
  %.812141706.i.epil = phi ptr [ %.812141706.i.epil.init, %.epil.preheader575 ], [ %i.bdb, %bb.dw ] ; 2 uses
  %epil.iter577 = phi i64 [ 0, %.epil.preheader575 ], [ %epil.iter577.next, %bb.dw ]
  %i.bcv = getelementptr inbounds nuw i8, ptr %.21232.lcssa.i, i64 %indvars.iv2208.i.epil
  ...
  store i64 %i.bda, ptr %.812141706.i.epil, align 1, !tbaa !100
  %i.bdb = getelementptr inbounds nuw i8, ptr %.812141706.i.epil, i64 8 ; 2 uses
...
._crit_edge1710.i:                                ; preds = %bb.dw, %._crit_edge1710.i.unr-lcssa
  ...
  %i.bdc = add nuw nsw i32 %.312051713.i, 1       ; 2 uses
...
.lr.ph1709.i.new:                                 ; preds = %.lr.ph1709.i, %.lr.ph1709.i.new
  ...
  %.812141706.i = phi ptr [ %i.beh, %.lr.ph1709.i.new ], [ %.712131712.i, %.lr.ph1709.i ] ; 5 uses
  %niter582 = phi i64 [ %niter582.next.3, %.lr.ph1709.i.new ], [ 0, %.lr.ph1709.i ]
  %i.bdd = getelementptr inbounds nuw i8, ptr %.21232.lcssa.i, i64 %indvars.iv2208.i
  ...
  store i64 %i.bdi, ptr %.812141706.i, align 1, !tbaa !100
  %i.bdj = getelementptr inbounds nuw i8, ptr %.812141706.i, i64 8
  %i.bdk = getelementptr inbounds nuw i8, ptr %.21232.lcssa.i, i64 %indvars.iv2208.i
  ...
  %i.bdr = getelementptr inbounds nuw i8, ptr %.812141706.i, i64 16
  %i.bds = getelementptr inbounds nuw i8, ptr %.21232.lcssa.i, i64 %indvars.iv2208.i
  ...
  %i.bdz = getelementptr inbounds nuw i8, ptr %.812141706.i, i64 24
  %i.bea = getelementptr inbounds nuw i8, ptr %.21232.lcssa.i, i64 %indvars.iv2208.i
  ...
  %i.beh = getelementptr inbounds nuw i8, ptr %.812141706.i, i64 32 ; 3 uses
...
_ZN4ncnn3MatD2Ev.exit1283.lr.ph.i:                ; preds = %.preheader1495.i
  ...
  %i.bfu = add nuw i32 %i.bft, 16                 ; 4 uses
  %i.bfv = add i32 %i.p, -8
...
.preheader1497.us.i:                              ; preds = %.preheader1497.lr.ph.i, %._crit_edge1727.us.i
  %.011591734.us.i = phi i32 [ %i.bpc, %._crit_edge1727.us.i ], [ 0, %.preheader1497.lr.ph.i ]
  %.011631733.us.i = phi ptr [ %i.box, %._crit_edge1727.us.i ], [ %i.bhn, %.preheader1497.lr.ph.i ]
  %.011711732.us.i = phi ptr [ %i.bpb, %._crit_edge1727.us.i ], [ %i.bgz, %.preheader1497.lr.ph.i ] ; 2 uses
  %.011741731.us.i = phi ptr [ %i.bpa, %._crit_edge1727.us.i ], [ %i.bgw, %.preheader1497.lr.ph.i ] ; 2 uses
  %.011771730.us.i = phi ptr [ %i.boz, %._crit_edge1727.us.i ], [ %i.bgs, %.preheader1497.lr.ph.i ] ; 2 uses
  %.011801729.us.i = phi ptr [ %i.boy, %._crit_edge1727.us.i ], [ %i.bgo, %.preheader1497.lr.ph.i ] ; 2 uses
  br label %bb.dx

bb.dx:                                            ; preds = %bb.dx, %.preheader1497.us.i
  %indvars.iv2235.i = phi i64 [ 0, %.preheader1497.us.i ], [ %indvars.iv.next2236.i, %bb.dx ] ; 5 uses
  %.111641724.us.i = phi ptr [ %.011631733.us.i, %.preheader1497.us.i ], [ %i.box, %bb.dx ] ; 65 uses
  %i.bho = getelementptr inbounds nuw i8, ptr %.011801729.us.i, i64 %indvars.iv2235.i ; 3 uses
  %i.bhp = getelementptr inbounds nuw i8, ptr %.011771730.us.i, i64 %indvars.iv2235.i ; 3 uses
  %i.bhq = getelementptr inbounds nuw i8, ptr %.011741731.us.i, i64 %indvars.iv2235.i ; 3 uses
  %i.bhr = getelementptr inbounds nuw i8, ptr %.011711732.us.i, i64 %indvars.iv2235.i ; 3 uses
  %i.bhs = load i8, ptr %i.bho, align 1, !tbaa !100
  store i8 %i.bhs, ptr %.111641724.us.i, align 1, !tbaa !100
  %i.bht = getelementptr inbounds nuw i8, ptr %i.bho, i64 %i.ang
  %i.bhu = load i8, ptr %i.bht, align 1, !tbaa !100
  %i.bhv = getelementptr inbounds nuw i8, ptr %.111641724.us.i, i64 1
  store i8 %i.bhu, ptr %i.bhv, align 1, !tbaa !100
  %i.bhw = load i8, ptr %i.bhp, align 1, !tbaa !100
  %i.bhx = getelementptr inbounds nuw i8, ptr %.111641724.us.i, i64 2
  ...
  %i.bia = getelementptr inbounds nuw i8, ptr %.111641724.us.i, i64 3
  store i8 %i.bhz, ptr %i.bia, align 1, !tbaa !100
  %i.bib = load i8, ptr %i.bhq, align 1, !tbaa !100
  %i.bic = getelementptr inbounds nuw i8, ptr %.111641724.us.i, i64 4
  ...
  %i.bif = getelementptr inbounds nuw i8, ptr %.111641724.us.i, i64 5
  store i8 %i.bie, ptr %i.bif, align 1, !tbaa !100
  %i.big = load i8, ptr %i.bhr, align 1, !tbaa !100
  %i.bih = getelementptr inbounds nuw i8, ptr %.111641724.us.i, i64 6
  ...
  %i.bik = getelementptr inbounds nuw i8, ptr %.111641724.us.i, i64 7
  store i8 %i.bij, ptr %i.bik, align 1, !tbaa !100
  %i.bil = getelementptr inbounds nuw i8, ptr %.111641724.us.i, i64 8
  ...
  %i.bit = getelementptr inbounds nuw i8, ptr %.111641724.us.i, i64 9
  store i8 %i.bis, ptr %i.bit, align 1, !tbaa !100
  %i.biu = load i8, ptr %i.bin, align 1, !tbaa !100
  %i.biv = getelementptr inbounds nuw i8, ptr %.111641724.us.i, i64 10
  ...
  %i.biy = getelementptr inbounds nuw i8, ptr %.111641724.us.i, i64 11
  store i8 %i.bix, ptr %i.biy, align 1, !tbaa !100
  %i.biz = load i8, ptr %i.bio, align 1, !tbaa !100
  %i.bja = getelementptr inbounds nuw i8, ptr %.111641724.us.i, i64 12
  ...
  %i.bjd = getelementptr inbounds nuw i8, ptr %.111641724.us.i, i64 13
  store i8 %i.bjc, ptr %i.bjd, align 1, !tbaa !100
  %i.bje = load i8, ptr %i.bip, align 1, !tbaa !100
  %i.bjf = getelementptr inbounds nuw i8, ptr %.111641724.us.i, i64 14
  ...
  %i.bji = getelementptr inbounds nuw i8, ptr %.111641724.us.i, i64 15
  store i8 %i.bjh, ptr %i.bji, align 1, !tbaa !100
  %i.bjj = getelementptr inbounds nuw i8, ptr %.111641724.us.i, i64 16
  ...
  %i.bjr = getelementptr inbounds nuw i8, ptr %.111641724.us.i, i64 17
  store i8 %i.bjq, ptr %i.bjr, align 1, !tbaa !100
  %i.bjs = load i8, ptr %i.bjl, align 1, !tbaa !100
  %i.bjt = getelementptr inbounds nuw i8, ptr %.111641724.us.i, i64 18
  ...
  %i.bjw = getelementptr inbounds nuw i8, ptr %.111641724.us.i, i64 19
  store i8 %i.bjv, ptr %i.bjw, align 1, !tbaa !100
  %i.bjx = load i8, ptr %i.bjm, align 1, !tbaa !100
  %i.bjy = getelementptr inbounds nuw i8, ptr %.111641724.us.i, i64 20
  ...
  %i.bkb = getelementptr inbounds nuw i8, ptr %.111641724.us.i, i64 21
  store i8 %i.bka, ptr %i.bkb, align 1, !tbaa !100
  %i.bkc = load i8, ptr %i.bjn, align 1, !tbaa !100
  %i.bkd = getelementptr inbounds nuw i8, ptr %.111641724.us.i, i64 22
  ...
  %i.bkg = getelementptr inbounds nuw i8, ptr %.111641724.us.i, i64 23
  store i8 %i.bkf, ptr %i.bkg, align 1, !tbaa !100
  %i.bkh = getelementptr inbounds nuw i8, ptr %.111641724.us.i, i64 24
  ...
  %i.bkp = getelementptr inbounds nuw i8, ptr %.111641724.us.i, i64 25
  store i8 %i.bko, ptr %i.bkp, align 1, !tbaa !100
  %i.bkq = load i8, ptr %i.bkj, align 1, !tbaa !100
  %i.bkr = getelementptr inbounds nuw i8, ptr %.111641724.us.i, i64 26
...
begin_hunk_7_@_ZN4ncnn22Convolution_x86_avx51224create_pipeline_int8_x86ERKNS_6OptionE:bb.a
  %i.btv = getelementptr inbounds nuw i8, ptr %.711701770.us.i, i64 8
  %i.btw = getelementptr inbounds nuw i8, ptr %.211821776.us.i, i64 %indvars.iv2249.i
  ...
  %i.bud = getelementptr inbounds nuw i8, ptr %.711701770.us.i, i64 16
  %i.bue = getelementptr inbounds nuw i8, ptr %.211821776.us.i, i64 %indvars.iv2249.i
  ...
  %i.bul = getelementptr inbounds nuw i8, ptr %.711701770.us.i, i64 24
  %i.bum = getelementptr inbounds nuw i8, ptr %.211821776.us.i, i64 %indvars.iv2249.i
  ...
  %i.but = getelementptr inbounds nuw i8, ptr %.711701770.us.i, i64 32 ; 3 uses
...
.epil.preheader583:                               ; preds = %._crit_edge1774.us.i.unr-lcssa, %.lr.ph1773.us.i
  ...
  %.711701770.us.i.epil.init = phi ptr [ %.611691777.us.i, %.lr.ph1773.us.i ], [ %i.but, %._crit_edge1774.us.i.unr-lcssa ]
...
bb.dz:                                            ; preds = %bb.dz, %.epil.preheader583
  ...
  %.711701770.us.i.epil = phi ptr [ %.711701770.us.i.epil.init, %.epil.preheader583 ], [ %i.bva, %bb.dz ] ; 2 uses
  %epil.iter585 = phi i64 [ 0, %.epil.preheader583 ], [ %epil.iter585.next, %bb.dz ]
  %i.buu = getelementptr inbounds nuw i8, ptr %.211821776.us.i, i64 %indvars.iv2249.i.epil
  ...
  store i64 %i.buz, ptr %.711701770.us.i.epil, align 1, !tbaa !100
  %i.bva = getelementptr inbounds nuw i8, ptr %.711701770.us.i.epil, i64 8 ; 2 uses
...
._crit_edge1774.us.i:                             ; preds = %bb.dz, %._crit_edge1774.us.i.unr-lcssa
  ...
  %i.bvb = getelementptr inbounds nuw i8, ptr %.211821776.us.i, i64 %i.ani ; 2 uses
  %i.bvc = add nuw nsw i32 %.211611778.us.i, 2    ; 3 uses
...
.preheader1498.i:                                 ; preds = %._crit_edge1774.us.i, %.preheader1499.i
  %.21182.lcssa.i = phi ptr [ %.11181.lcssa.i, %.preheader1499.i ], [ %i.bvb, %._crit_edge1774.us.i ] ; 5 uses
  %.61169.lcssa.i = phi ptr [ %.31166.lcssa.i, %.preheader1499.i ], [ %.lcssa513, %._crit_edge1774.us.i ]
  %.21161.lcssa.i = phi i32 [ %.11160.lcssa.i, %.preheader1499.i ], [ %i.bvc, %._crit_edge1774.us.i ] ; 2 uses
  %i.bvf = icmp sge i32 %.21161.lcssa.i, %i.p
...
.lr.ph1789.i:                                     ; preds = %.preheader1498.i, %._crit_edge1790.i
  %.311621793.i = phi i32 [ %i.bvn, %._crit_edge1790.i ], [ %.21161.lcssa.i, %.preheader1498.i ]
...
bb.ea:                                            ; preds = %bb.ea, %.epil.preheader591
  ...
  %i.bvg = getelementptr inbounds nuw i8, ptr %.21182.lcssa.i, i64 %indvars.iv2254.i.epil
...
._crit_edge1790.i:                                ; preds = %bb.ea, %._crit_edge1790.i.unr-lcssa
  ...
  %i.bvn = add nuw nsw i32 %.311621793.i, 1       ; 2 uses
...
.lr.ph1789.i.new:                                 ; preds = %.lr.ph1789.i, %.lr.ph1789.i.new
  ...
  %i.bvo = getelementptr inbounds nuw i8, ptr %.21182.lcssa.i, i64 %indvars.iv2254.i
  ...
  %i.bvv = getelementptr inbounds nuw i8, ptr %.21182.lcssa.i, i64 %indvars.iv2254.i
  ...
  %i.bwd = getelementptr inbounds nuw i8, ptr %.21182.lcssa.i, i64 %indvars.iv2254.i
  ...
  %i.bwl = getelementptr inbounds nuw i8, ptr %.21182.lcssa.i, i64 %indvars.iv2254.i
...
_ZN4ncnn3MatD2Ev.exit.lr.ph.i:                    ; preds = %.preheader1490.i
  ...
  %i.bxx = add nuw i32 %i.bxw, 16                 ; 4 uses
  %i.bxy = add i32 %i.p, -8
...
.lr.ph1801.us.i:                                  ; preds = %.lr.ph1808.i, %._crit_edge1802.us.i
  %.011221807.us.i = phi i32 [ %i.cag, %._crit_edge1802.us.i ], [ 0, %.lr.ph1808.i ]
  %.011261806.us.i = phi ptr [ %.lcssa493, %._crit_edge1802.us.i ], [ %i.bzf, %.lr.ph1808.i ] ; 2 uses
  %.011341805.us.i = phi ptr [ %i.caf, %._crit_edge1802.us.i ], [ %i.byt, %.lr.ph1808.i ] ; 4 uses
  %.011371804.us.i = phi ptr [ %i.cae, %._crit_edge1802.us.i ], [ %i.byq, %.lr.ph1808.i ] ; 4 uses
...
.lr.ph1801.us.i.new:                              ; preds = %.lr.ph1801.us.i, %.lr.ph1801.us.i.new
  ...
  %.111271798.us.i = phi ptr [ %i.bzv, %.lr.ph1801.us.i.new ], [ %.011261806.us.i, %.lr.ph1801.us.i ] ; 5 uses
  %niter606 = phi i64 [ %niter606.next.1, %.lr.ph1801.us.i.new ], [ 0, %.lr.ph1801.us.i ]
  %i.bzg = getelementptr inbounds nuw i8, ptr %.011371804.us.i, i64 %indvars.iv2270.i
  ...
  %i.bzj = getelementptr inbounds nuw i8, ptr %.011341805.us.i, i64 %indvars.iv2270.i
  ...
  store <16 x i8> %i.bzi, ptr %.111271798.us.i, align 1, !tbaa !100
  %i.bzm = getelementptr inbounds nuw i8, ptr %.111271798.us.i, i64 16
  store <16 x i8> %i.bzl, ptr %i.bzm, align 1, !tbaa !100
  %i.bzn = getelementptr inbounds nuw i8, ptr %.111271798.us.i, i64 32
  %indvars.iv.next2271.i = or disjoint i64 %indvars.iv2270.i, 1 ; 2 uses
  %i.bzo = getelementptr inbounds nuw i8, ptr %.011371804.us.i, i64 %indvars.iv.next2271.i
  ...
  %i.bzr = getelementptr inbounds nuw i8, ptr %.011341805.us.i, i64 %indvars.iv.next2271.i
  ...
  %i.bzu = getelementptr inbounds nuw i8, ptr %.111271798.us.i, i64 48
  store <16 x i8> %i.bzt, ptr %i.bzu, align 1, !tbaa !100
  %i.bzv = getelementptr inbounds nuw i8, ptr %.111271798.us.i, i64 64 ; 3 uses
...
.epil.preheader599:                               ; preds = %._crit_edge1802.us.i.unr-lcssa, %.lr.ph1801.us.i
  ...
  %.111271798.us.i.epil.init = phi ptr [ %.011261806.us.i, %.lr.ph1801.us.i ], [ %i.bzv, %._crit_edge1802.us.i.unr-lcssa ] ; 3 uses
  tail call void @llvm.assume(i1 %lcmp.mod604)
  %i.bzw = getelementptr inbounds nuw i8, ptr %.011371804.us.i, i64 %indvars.iv2270.i.epil.init
  ...
  %i.bzz = getelementptr inbounds nuw i8, ptr %.011341805.us.i, i64 %indvars.iv2270.i.epil.init
  ...
  store <16 x i8> %i.bzy, ptr %.111271798.us.i.epil.init, align 1, !tbaa !100
  %i.cac = getelementptr inbounds nuw i8, ptr %.111271798.us.i.epil.init, i64 16
  store <16 x i8> %i.cab, ptr %i.cac, align 1, !tbaa !100
  %i.cad = getelementptr inbounds nuw i8, ptr %.111271798.us.i.epil.init, i64 32
...
._crit_edge1802.us.i:                             ; preds = %._crit_edge1802.us.i.unr-lcssa, %.epil.preheader599
  ...
  %i.cae = getelementptr inbounds nuw i8, ptr %.011371804.us.i, i64 %i.bev ; 2 uses
  %i.caf = getelementptr inbounds nuw i8, ptr %.011341805.us.i, i64 %i.bev ; 2 uses
  %i.cag = add nuw nsw i32 %.011221807.us.i, 16   ; 2 uses
...
.preheader1494.i:                                 ; preds = %._crit_edge1802.us.i, %_ZN4ncnn3MatD2Ev.exit1283.i
  %.01137.lcssa.i = phi ptr [ %i.byq, %_ZN4ncnn3MatD2Ev.exit1283.i ], [ %i.cae, %._crit_edge1802.us.i ] ; 3 uses
  %.01134.lcssa.i = phi ptr [ %i.byt, %_ZN4ncnn3MatD2Ev.exit1283.i ], [ %i.caf, %._crit_edge1802.us.i ] ; 3 uses
  %.01126.lcssa.i = phi ptr [ %i.bzf, %_ZN4ncnn3MatD2Ev.exit1283.i ], [ %.lcssa493, %._crit_edge1802.us.i ] ; 3 uses
  %.01122.lcssa.i = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit1283.i ], [ %i.bfu, %._crit_edge1802.us.i ] ; 4 uses
  %i.caj = or disjoint i32 %.01122.lcssa.i, 7
...
.lr.ph1827.split.preheader.i:                     ; preds = %.lr.ph1827.i, %.preheader1494.thread.i
  %.01137.lcssa25052516.i = phi ptr [ %.01137.lcssa.i, %.lr.ph1827.i ], [ %scevgep2266.i, %.preheader1494.thread.i ]
  %.01134.lcssa25062515.i = phi ptr [ %.01134.lcssa.i, %.lr.ph1827.i ], [ %scevgep2269.i, %.preheader1494.thread.i ]
  %.01126.lcssa25072514.i = phi ptr [ %.01126.lcssa.i, %.lr.ph1827.i ], [ %i.bzf, %.preheader1494.thread.i ]
  %.01122.lcssa25082513.i = phi i32 [ %.01122.lcssa.i, %.lr.ph1827.i ], [ %i.bfu, %.preheader1494.thread.i ] ; 2 uses
  %i.cal = sub i32 %i.bfv, %.01122.lcssa25082513.i ; 2 uses
  ...
  %scevgep2275.i = getelementptr i8, ptr %.01137.lcssa25052516.i, i64 %i.cao
  %scevgep2276.i = getelementptr i8, ptr %.01134.lcssa25062515.i, i64 %i.cao
  %i.cap = add i32 %.01122.lcssa25082513.i, 8
...
.lr.ph1820.us.i:                                  ; preds = %.lr.ph1827.i, %._crit_edge1821.us.i
  %.111231826.us.i = phi i32 [ %i.cbr, %._crit_edge1821.us.i ], [ %.01122.lcssa.i, %.lr.ph1827.i ]
  %.211281825.us.i = phi ptr [ %.lcssa496, %._crit_edge1821.us.i ], [ %.01126.lcssa.i, %.lr.ph1827.i ] ; 2 uses
  %.111351824.us.i = phi ptr [ %i.cbq, %._crit_edge1821.us.i ], [ %.01134.lcssa.i, %.lr.ph1827.i ]
  %.111381823.us.i = phi ptr [ %i.cbp, %._crit_edge1821.us.i ], [ %.01137.lcssa.i, %.lr.ph1827.i ] ; 6 uses
...
.lr.ph1820.us.i.new:                              ; preds = %.lr.ph1820.us.i, %.lr.ph1820.us.i.new
  ...
  %.311291817.us.i = phi ptr [ %i.cbk, %.lr.ph1820.us.i.new ], [ %.211281825.us.i, %.lr.ph1820.us.i ] ; 5 uses
  %niter614 = phi i64 [ %niter614.next.3, %.lr.ph1820.us.i.new ], [ 0, %.lr.ph1820.us.i ]
  %i.cas = getelementptr inbounds nuw i8, ptr %.111381823.us.i, i64 %indvars.iv2277.i
  ...
  store <16 x i8> %i.cau, ptr %.311291817.us.i, align 1, !tbaa !100
  %i.cav = getelementptr inbounds nuw i8, ptr %.311291817.us.i, i64 16
  %i.caw = getelementptr inbounds nuw i8, ptr %.111381823.us.i, i64 %indvars.iv2277.i
  ...
  %i.cba = getelementptr inbounds nuw i8, ptr %.311291817.us.i, i64 32
  %i.cbb = getelementptr inbounds nuw i8, ptr %.111381823.us.i, i64 %indvars.iv2277.i
...
bb.er:                                            ; preds = %bb.eq
  ...
  %op.rdx676 = add nuw nsw i32 %i.wc, %i.vx
  %i.wd = and i32 %i.eg, 1
  %i.we = add nuw nsw i32 %i.wd, 1
  tail call void @_ZN4ncnn3Mat6createEiiimiPNS_9AllocatorE(ptr noundef nonnull align 8 dereferenceable(72) %i.pj, i32 noundef %i.vw, i32 noundef %op.rdx676, i32 noundef %i.we, i64 noundef 2, i32 noundef 1, ptr noundef null)
  br label %.preheader1590.i
...
bb.fa:                                            ; preds = %bb.ez
  ...
  %op.rdx677 = add nuw nsw i32 %i.xm, %i.xh
  tail call void @_ZN4ncnn3Mat6createEiiimiPNS_9AllocatorE(ptr noundef nonnull align 8 dereferenceable(72) %i.pj, i32 noundef %i.xg, i32 noundef %op.rdx677, i32 noundef %i.eg, i64 noundef 2, i32 noundef 1, ptr noundef null)
  br label %.preheader1590.i
...
_ZN4ncnn3MatD2Ev.exit1306.lr.ph.i:                ; preds = %bb.du, %bb.dt, %bb.dr, %bb.dp, %bb.dn
  ...
  %i.zg = add nuw i32 %i.zf, 16                   ; 4 uses
  %i.zh = add i32 %i.p, -8
  ...
  %unroll_iter = and i64 %wide.trip.count.i, 2147483646
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  %lcmp.mod763 = trunc i32 %i.pl to i1
  %xtraiter765 = and i64 %wide.trip.count.i, 1
  %i.zn = icmp eq i64 %i.zl, 0
  %unroll_iter769 = and i64 %wide.trip.count.i, 2147483646
  %lcmp.mod766.not = icmp eq i64 %xtraiter765, 0
  %lcmp.mod768 = trunc i32 %i.pl to i1
...
.preheader1590.i:                                 ; preds = %.preheader1590.loopexit.i, %bb.fh, %bb.fg, %bb.fe, %bb.fc, %bb.fa, %bb.ey, %bb.ex, %bb.ev, %bb.et, %bb.er, %bb.eo, %bb.en, %bb.el, %bb.ej, %bb.eh, %bb.ee, %bb.ed, %bb.eb, %bb.dz, %bb.dx
  %.01098.lcssa.i = phi i32 [ %i.zo, %.preheader1590.loopexit.i ], [ 0, %bb.dz ], [ 0, %bb.ed ], [ 0, %bb.ee ], [ 0, %bb.eb ], [ 0, %bb.dx ], [ 0, %bb.et ], [ 0, %bb.ex ], [ 0, %bb.ey ], [ 0, %bb.ev ], [ 0, %bb.er ], [ 0, %bb.fc ], [ 0, %bb.fg ], [ 0, %bb.fh ], [ 0, %bb.fe ], [ 0, %bb.fa ], [ 0, %bb.eh ], [ 0, %bb.el ], [ 0, %bb.eo ], [ 0, %bb.en ], [ 0, %bb.ej ] ; 5 uses
  %i.zp = or disjoint i32 %.01098.lcssa.i, 7
...
_ZN4ncnn3MatD2Ev.exit1305.lr.ph.i:                ; preds = %.preheader1590.i
  ...
  %i.aau = mul i32 %i.zr, %.01098.lcssa.i
  %i.aav = shl i32 %i.zr, 3
  %i.aaw = and i32 %i.aap, -16
  %i.aax = add nuw i32 %i.aaw, 16                 ; 4 uses
  %i.aay = add i32 %i.p, -8
  %i.aaz = zext nneg i32 %.01098.lcssa.i to i64
  %i.aba = add i32 %.01098.lcssa.i, 7
  ...
  %xtraiter772 = and i64 %wide.trip.count2241.i, 1
  %i.abf = icmp eq i64 %i.abe, 0
  %unroll_iter776 = and i64 %wide.trip.count2241.i, 2147483646
  %lcmp.mod773.not = icmp eq i64 %xtraiter772, 0
  %lcmp.mod775 = trunc i32 %i.pl to i1
  %xtraiter779 = and i64 %wide.trip.count2241.i, 3 ; 3 uses
  %i.abg = icmp ult i64 %i.abe, 3
  %unroll_iter783 = and i64 %wide.trip.count2241.i, 2147483644
  %lcmp.mod780.not = icmp eq i64 %xtraiter779, 0
  %lcmp.mod782 = icmp ne i64 %xtraiter779, 0
...
_ZN4ncnn3MatD2Ev.exit1306.i:                      ; preds = %._crit_edge1677.split.i, %_ZN4ncnn3MatD2Ev.exit1306.lr.ph.i
  ...
  %indvars.iv.i104 = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit1306.lr.ph.i ], [ %indvars.iv.next.i105, %._crit_edge1677.split.i ] ; 2 uses
  %i.abh = sext i32 %indvars.iv.i104 to i64
...
.preheader1595.us.i:                              ; preds = %._crit_edge.us.i, %.preheader1595.us.preheader.i
  %.011001618.us.i = phi ptr [ %i.amt, %._crit_edge.us.i ], [ %i.abn, %.preheader1595.us.preheader.i ] ; 2 uses
  %.011051617.us.i = phi ptr [ %i.amu, %._crit_edge.us.i ], [ %i.aby, %.preheader1595.us.preheader.i ] ; 2 uses
  %.011211616.us.i = phi ptr [ %i.amv, %._crit_edge.us.i ], [ %i.acc, %.preheader1595.us.preheader.i ] ; 2 uses
  %.011221615.us.i = phi ptr [ %i.amw, %._crit_edge.us.i ], [ %i.acg, %.preheader1595.us.preheader.i ] ; 2 uses
  %.011281614.us.i = phi ptr [ %i.amx, %._crit_edge.us.i ], [ %i.ack, %.preheader1595.us.preheader.i ] ; 2 uses
  %.011291613.us.i = phi ptr [ %i.amy, %._crit_edge.us.i ], [ %i.aco, %.preheader1595.us.preheader.i ] ; 2 uses
  %.011311612.us.i = phi ptr [ %i.amz, %._crit_edge.us.i ], [ %i.acs, %.preheader1595.us.preheader.i ] ; 2 uses
  %.011321611.us.i = phi ptr [ %i.ana, %._crit_edge.us.i ], [ %i.acw, %.preheader1595.us.preheader.i ] ; 2 uses
  %.011341610.us.i = phi ptr [ %i.anb, %._crit_edge.us.i ], [ %i.ada, %.preheader1595.us.preheader.i ] ; 2 uses
  %.011351609.us.i = phi ptr [ %i.anc, %._crit_edge.us.i ], [ %i.ade, %.preheader1595.us.preheader.i ] ; 2 uses
  %.011611608.us.i = phi ptr [ %i.and, %._crit_edge.us.i ], [ %i.adi, %.preheader1595.us.preheader.i ] ; 2 uses
  %.011661607.us.i = phi ptr [ %i.ane, %._crit_edge.us.i ], [ %i.adm, %.preheader1595.us.preheader.i ] ; 2 uses
...
bb.fi:                                            ; preds = %bb.fi, %.preheader1595.us.i
  ...
  %i.aed = getelementptr inbounds nuw [4 x i8], ptr %.011001618.us.i, i64 %indvars.iv2179.i
  %i.aee = getelementptr inbounds nuw [4 x i8], ptr %.011051617.us.i, i64 %indvars.iv2179.i
  %i.aef = getelementptr inbounds nuw [4 x i8], ptr %.011211616.us.i, i64 %indvars.iv2179.i
  %i.aeg = getelementptr inbounds nuw [4 x i8], ptr %.011221615.us.i, i64 %indvars.iv2179.i
  %i.aeh = getelementptr inbounds nuw [4 x i8], ptr %.011281614.us.i, i64 %indvars.iv2179.i
  %i.aei = getelementptr inbounds nuw [4 x i8], ptr %.011291613.us.i, i64 %indvars.iv2179.i
  %i.aej = getelementptr inbounds nuw [4 x i8], ptr %.011311612.us.i, i64 %indvars.iv2179.i
  %i.aek = getelementptr inbounds nuw [4 x i8], ptr %.011321611.us.i, i64 %indvars.iv2179.i
  %i.ael = getelementptr inbounds nuw [4 x i8], ptr %.011341610.us.i, i64 %indvars.iv2179.i
  %i.aem = getelementptr inbounds nuw [4 x i8], ptr %.011351609.us.i, i64 %indvars.iv2179.i
  %i.aen = getelementptr inbounds nuw [4 x i8], ptr %.011611608.us.i, i64 %indvars.iv2179.i
  %i.aeo = getelementptr inbounds nuw [4 x i8], ptr %.011661607.us.i, i64 %indvars.iv2179.i
...
begin_hunk_9_@_ZN4ncnn22Convolution_x86_avx51221create_pipeline_bf16sERKNS_6OptionE:bb.a
  ...
  %i.ats = getelementptr inbounds nuw [4 x i8], ptr %.311031664.us.i, i64 %indvars.iv2198.i
...
.epil.preheader:                                  ; preds = %._crit_edge.us1668.i.unr-lcssa, %.preheader1592.us.i
  ...
  %i.aun = getelementptr inbounds nuw [4 x i8], ptr %.311031664.us.i, i64 %indvars.iv2198.i.epil.init ; 2 uses
...
._crit_edge.us1668.i:                             ; preds = %._crit_edge.us1668.i.unr-lcssa, %.epil.preheader
  %.lcssa758 = phi ptr [ %i.aum, %._crit_edge.us1668.i.unr-lcssa ], [ %i.avg, %.epil.preheader ] ; 2 uses
  %i.avh = getelementptr inbounds nuw [4 x i8], ptr %.311031664.us.i, i64 %i.yx ; 2 uses
...
.preheader1596.i:                                 ; preds = %._crit_edge.us1668.i, %.preheader1597.i
  ...
  %.81179.lcssa.i = phi ptr [ %.51176.lcssa.i, %.preheader1597.i ], [ %.lcssa758, %._crit_edge.us1668.i ]
  %.31103.lcssa.i = phi ptr [ %.21102.lcssa.i, %.preheader1597.i ], [ %i.avh, %._crit_edge.us1668.i ] ; 3 uses
...
.preheader1591.i:                                 ; preds = %.preheader1596.i, %._crit_edge.i
  %.111676.i = phi ptr [ %.lcssa761, %._crit_edge.i ], [ %.81179.lcssa.i, %.preheader1596.i ] ; 2 uses
  %.411861675.i = phi i32 [ %i.avw, %._crit_edge.i ], [ %.31185.lcssa.i, %.preheader1596.i ]
  br i1 %i.zn, label %.epil.preheader764, label %.preheader1591.i.new

._crit_edge.i.unr-lcssa:                          ; preds = %.preheader1591.i.new
  br i1 %lcmp.mod766.not, label %._crit_edge.i, label %.epil.preheader764

.epil.preheader764:                               ; preds = %._crit_edge.i.unr-lcssa, %.preheader1591.i
  ...
  tail call void @llvm.assume(i1 %lcmp.mod768)
  %i.avm = getelementptr inbounds nuw [4 x i8], ptr %.31103.lcssa.i, i64 %indvars.iv2203.i.epil.init
...
._crit_edge.i:                                    ; preds = %._crit_edge.i.unr-lcssa, %.epil.preheader764
  %.lcssa761 = phi ptr [ %i.awr, %._crit_edge.i.unr-lcssa ], [ %i.avv, %.epil.preheader764 ]
...
.preheader1591.i.new:                             ; preds = %.preheader1591.i, %.preheader1591.i.new
  ...
  %niter770 = phi i64 [ %niter770.next.1, %.preheader1591.i.new ], [ 0, %.preheader1591.i ]
  %i.avx = getelementptr inbounds nuw [4 x i8], ptr %.31103.lcssa.i, i64 %indvars.iv2203.i
  ...
  %i.awh = getelementptr inbounds nuw [4 x i8], ptr %.31103.lcssa.i, i64 %indvars.iv2203.i
  ...
  %niter770.next.1 = add i64 %niter770, 2         ; 2 uses
  %niter770.ncmp.1 = icmp eq i64 %niter770.next.1, %unroll_iter769
  br i1 %niter770.ncmp.1, label %._crit_edge.i.unr-lcssa, label %.preheader1591.i.new, !llvm.loop !554
...
._crit_edge1677.split.i:                          ; preds = %._crit_edge.i, %.preheader1596.i, %.preheader1592.lr.ph.i, %.preheader1593.lr.ph.i
  ...
  %indvars.iv.next.i105 = add i32 %indvars.iv.i104, %i.ze
...
.preheader1581.i:                                 ; preds = %.preheader1581.loopexit.i, %.preheader1590.i
  %.1.lcssa.i = phi i32 [ %.01098.lcssa.i, %.preheader1590.i ], [ %i.awu, %.preheader1581.loopexit.i ] ; 4 uses
...
_ZN4ncnn3MatD2Ev.exit1304.lr.ph.i:                ; preds = %.preheader1581.i
  ...
  %i.aym = add nuw i32 %i.ayl, 16                 ; 4 uses
  %i.ayn = add i32 %i.p, -8
  ...
  %xtraiter786 = and i64 %wide.trip.count2293.i, 1
  %i.ayv = icmp eq i64 %i.ayu, 0
  %unroll_iter791 = and i64 %wide.trip.count2293.i, 2147483646
  %lcmp.mod788.not = icmp eq i64 %xtraiter786, 0
  %lcmp.mod790 = trunc i32 %i.pl to i1
  %xtraiter794 = and i64 %wide.trip.count2293.i, 3 ; 3 uses
  %i.ayw = icmp ult i64 %i.ayu, 3
  %unroll_iter799 = and i64 %wide.trip.count2293.i, 2147483644
  %lcmp.mod796.not = icmp eq i64 %xtraiter794, 0
  %lcmp.mod798 = icmp ne i64 %xtraiter794, 0
...
.preheader1586.us.i:                              ; preds = %.preheader1586.lr.ph.i, %._crit_edge1682.us.i
  ...
  %.012501688.us.i = phi ptr [ %i.bfd, %._crit_edge1682.us.i ], [ %i.azx, %.preheader1586.lr.ph.i ] ; 2 uses
...
bb.fl:                                            ; preds = %bb.fl, %.preheader1586.us.i
  ...
  %i.bav = getelementptr inbounds nuw [4 x i8], ptr %.012501688.us.i, i64 %indvars.iv2238.i
...
begin_hunk_10_@_ZN4ncnn22Convolution_x86_avx51221create_pipeline_bf16sERKNS_6OptionE:bb.a
  ...
  br i1 %niter777.ncmp.1, label %._crit_edge1756.us.i.unr-lcssa, label %.preheader1583.us.i.new, !llvm.loop !565
...
._crit_edge1756.us.i:                             ; preds = %._crit_edge1756.us.i.unr-lcssa, %.epil.preheader771
  %.lcssa746 = phi ptr [ %i.bmi, %._crit_edge1756.us.i.unr-lcssa ], [ %i.bmy, %.epil.preheader771 ] ; 2 uses
...
.preheader1582.i:                                 ; preds = %.preheader1587.i, %._crit_edge1769.i
  ...
  br i1 %i.abg, label %.epil.preheader778, label %.preheader1582.i.new
...
bb.fo:                                            ; preds = %bb.fo, %.epil.preheader778
  %indvars.iv2264.i.epil = phi i64 [ %indvars.iv2264.i.epil.init, %.epil.preheader778 ], [ %indvars.iv.next2265.i.epil, %bb.fo ] ; 2 uses
  %.1112671767.i.epil = phi ptr [ %.1112671767.i.epil.init, %.epil.preheader778 ], [ %i.bnl, %bb.fo ] ; 2 uses
...
._crit_edge1769.i:                                ; preds = %bb.fo, %._crit_edge1769.i.unr-lcssa
  %.lcssa749 = phi ptr [ %i.bov, %._crit_edge1769.i.unr-lcssa ], [ %i.bnl, %bb.fo ]
...
.preheader1582.i.new:                             ; preds = %.preheader1582.i, %.preheader1582.i.new
  ...
  br i1 %niter784.ncmp.3, label %._crit_edge1769.i.unr-lcssa, label %.preheader1582.i.new, !llvm.loop !569
...
_ZN4ncnn3MatD2Ev.exit1303.lr.ph.i:                ; preds = %.preheader1572.i
  ...
  %i.bqh = add nuw i32 %i.bqg, 16                 ; 4 uses
  %i.bqi = add i32 %i.p, -8
  ...
  %xtraiter802 = and i64 %wide.trip.count2337.i, 1
  %i.bqo = icmp eq i64 %i.bqn, 0
  %unroll_iter807 = and i64 %wide.trip.count2337.i, 2147483646
  %lcmp.mod804.not = icmp eq i64 %xtraiter802, 0
  %lcmp.mod806 = trunc i32 %i.pl to i1
  %xtraiter810 = and i64 %wide.trip.count2337.i, 1
  %i.bqp = icmp eq i64 %i.bqn, 0
  %unroll_iter815 = and i64 %wide.trip.count2337.i, 2147483646
  %lcmp.mod812.not = icmp eq i64 %xtraiter810, 0
  %lcmp.mod814 = trunc i32 %i.pl to i1
  %xtraiter818 = and i64 %wide.trip.count2337.i, 1
  %i.bqq = icmp eq i64 %i.bqn, 0
  %unroll_iter823 = and i64 %wide.trip.count2337.i, 2147483646
  %lcmp.mod820.not = icmp eq i64 %xtraiter818, 0
  %lcmp.mod822 = trunc i32 %i.pl to i1
  %min.iters.check523 = icmp ult i32 %i.pl, 4
  %min.iters.check525 = icmp ult i32 %i.pl, 16
  %i.bqr = and i64 %wide.trip.count2337.i, 12
  %n.vec527 = and i64 %wide.trip.count2337.i, 2147483632 ; 5 uses
  %i.bqs = shl nuw nsw i64 %n.vec527, 3
  %cmp.n538 = icmp eq i64 %n.vec527, %wide.trip.count2337.i
  %min.epilog.iters.check543 = icmp eq i64 %i.bqr, 0
  %n.vec545 = and i64 %wide.trip.count2337.i, 2147483644 ; 4 uses
  %i.bqt = shl nuw nsw i64 %n.vec545, 3
  %cmp.n556 = icmp eq i64 %n.vec545, %wide.trip.count2337.i
  %min.iters.check = icmp ult i32 %i.pl, 4
  %min.iters.check511 = icmp ult i32 %i.pl, 16
  ...
  %n.vec513 = and i64 %wide.trip.count2337.i, 2147483644 ; 4 uses
  %i.bqw = shl nuw nsw i64 %n.vec513, 2
  %cmp.n520 = icmp eq i64 %n.vec513, %wide.trip.count2337.i
...
.preheader1577.us.i:                              ; preds = %.preheader1577.lr.ph.i, %._crit_edge1778.us.i
  %.011971785.us.i = phi i32 [ %i.buj, %._crit_edge1778.us.i ], [ 0, %.preheader1577.lr.ph.i ]
  %.012021784.us.i = phi ptr [ %i.bue, %._crit_edge1778.us.i ], [ %i.bse, %.preheader1577.lr.ph.i ]
  %.012131783.us.i = phi ptr [ %i.bui, %._crit_edge1778.us.i ], [ %i.brq, %.preheader1577.lr.ph.i ] ; 2 uses
  %.012161782.us.i = phi ptr [ %i.buh, %._crit_edge1778.us.i ], [ %i.brn, %.preheader1577.lr.ph.i ] ; 2 uses
  %.012191781.us.i = phi ptr [ %i.bug, %._crit_edge1778.us.i ], [ %i.brj, %.preheader1577.lr.ph.i ] ; 2 uses
  %.012221780.us.i = phi ptr [ %i.buf, %._crit_edge1778.us.i ], [ %i.brf, %.preheader1577.lr.ph.i ] ; 2 uses
  br label %bb.fp

bb.fp:                                            ; preds = %bb.fp, %.preheader1577.us.i
  %indvars.iv2290.i = phi i64 [ 0, %.preheader1577.us.i ], [ %indvars.iv.next2291.i, %bb.fp ] ; 5 uses
  %.112031776.us.i = phi ptr [ %.012021784.us.i, %.preheader1577.us.i ], [ %i.bue, %bb.fp ] ; 5 uses
  %i.bsf = getelementptr inbounds nuw [4 x i8], ptr %.012221780.us.i, i64 %indvars.iv2290.i
  %i.bsg = getelementptr inbounds nuw [4 x i8], ptr %.012191781.us.i, i64 %indvars.iv2290.i
  %i.bsh = getelementptr inbounds nuw [4 x i8], ptr %.012161782.us.i, i64 %indvars.iv2290.i
  %i.bsi = getelementptr inbounds nuw [4 x i8], ptr %.012131783.us.i, i64 %indvars.iv2290.i
  ...
  store <4 x i64> %i.btf, ptr %.112031776.us.i, align 1, !tbaa !100
  %i.btg = getelementptr inbounds nuw i8, ptr %.112031776.us.i, i64 32
  ...
  %i.bto = getelementptr inbounds nuw i8, ptr %.112031776.us.i, i64 64
  ...
  %i.btw = getelementptr inbounds nuw i8, ptr %.112031776.us.i, i64 96
  ...
  %i.bue = getelementptr inbounds nuw i8, ptr %.112031776.us.i, i64 128 ; 3 uses
...
._crit_edge1778.us.i:                             ; preds = %bb.fp
  %i.buf = getelementptr inbounds nuw [4 x i8], ptr %.012221780.us.i, i64 %i.axp ; 2 uses
  %i.bug = getelementptr inbounds nuw [4 x i8], ptr %.012191781.us.i, i64 %i.axp ; 2 uses
  %i.buh = getelementptr inbounds nuw [4 x i8], ptr %.012161782.us.i, i64 %i.axp ; 2 uses
  %i.bui = getelementptr inbounds nuw [4 x i8], ptr %.012131783.us.i, i64 %i.axp ; 2 uses
  %i.buj = add nuw nsw i32 %.011971785.us.i, 16   ; 2 uses
...
.preheader1580.i:                                 ; preds = %._crit_edge1778.us.i, %_ZN4ncnn3MatD2Ev.exit1304.i
  %.01222.lcssa.i = phi ptr [ %i.brf, %_ZN4ncnn3MatD2Ev.exit1304.i ], [ %i.buf, %._crit_edge1778.us.i ] ; 3 uses
  %.01219.lcssa.i = phi ptr [ %i.brj, %_ZN4ncnn3MatD2Ev.exit1304.i ], [ %i.bug, %._crit_edge1778.us.i ] ; 3 uses
  %.01216.lcssa.i = phi ptr [ %i.brn, %_ZN4ncnn3MatD2Ev.exit1304.i ], [ %i.buh, %._crit_edge1778.us.i ] ; 3 uses
  %.01213.lcssa.i = phi ptr [ %i.brq, %_ZN4ncnn3MatD2Ev.exit1304.i ], [ %i.bui, %._crit_edge1778.us.i ] ; 3 uses
  %.01202.lcssa.i = phi ptr [ %i.bse, %_ZN4ncnn3MatD2Ev.exit1304.i ], [ %i.bue, %._crit_edge1778.us.i ] ; 3 uses
  %.01197.lcssa.i = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit1304.i ], [ %i.aym, %._crit_edge1778.us.i ] ; 4 uses
  %i.bum = or disjoint i32 %.01197.lcssa.i, 7
...
.preheader1576.preheader.i:                       ; preds = %.preheader1576.lr.ph.i, %.preheader1580.thread.i
  %.01222.lcssa25372554.i = phi ptr [ %.01222.lcssa.i, %.preheader1576.lr.ph.i ], [ %scevgep2280.i, %.preheader1580.thread.i ]
  %.01219.lcssa25382553.i = phi ptr [ %.01219.lcssa.i, %.preheader1576.lr.ph.i ], [ %scevgep2283.i, %.preheader1580.thread.i ]
  %.01216.lcssa25392552.i = phi ptr [ %.01216.lcssa.i, %.preheader1576.lr.ph.i ], [ %scevgep2286.i, %.preheader1580.thread.i ]
  %.01213.lcssa25402551.i = phi ptr [ %.01213.lcssa.i, %.preheader1576.lr.ph.i ], [ %scevgep2289.i, %.preheader1580.thread.i ]
  %.01202.lcssa25412550.i = phi ptr [ %.01202.lcssa.i, %.preheader1576.lr.ph.i ], [ %i.bse, %.preheader1580.thread.i ]
  %.01197.lcssa25422549.i = phi i32 [ %.01197.lcssa.i, %.preheader1576.lr.ph.i ], [ %i.aym, %.preheader1580.thread.i ] ; 2 uses
end_hunk_10
begin_hunk_11_@_ZN4ncnn22Convolution_x86_avx51221create_pipeline_bf16sERKNS_6OptionE:bb.a
  ...
  %i.bzp = getelementptr inbounds nuw i8, ptr %.712091840.us.i, i64 24
  ...
  %i.bzw = getelementptr inbounds nuw i8, ptr %.712091840.us.i, i64 32 ; 3 uses
  ...
  br i1 %niter792.ncmp.1, label %._crit_edge1842.us.i.unr-lcssa, label %.preheader1574.us.i.new, !llvm.loop !580
...
.epil.preheader785:                               ; preds = %._crit_edge1842.us.i.unr-lcssa, %.preheader1574.us.i
  ...
  %.712091840.us.i.epil.init = phi ptr [ %.612081845.us.i, %.preheader1574.us.i ], [ %i.bzw, %._crit_edge1842.us.i.unr-lcssa ] ; 3 uses
  tail call void @llvm.assume(i1 %lcmp.mod790)
  %i.bzx = getelementptr inbounds nuw [4 x i8], ptr %.312251844.us.i, i64 %indvars.iv2313.i.epil.init ; 2 uses
  ...
  store i64 %i.cad, ptr %.712091840.us.i.epil.init, align 1, !tbaa !100
  %i.cae = getelementptr inbounds nuw [4 x i8], ptr %i.bzx, i64 %i.axx
  %i.caf = getelementptr inbounds nuw i8, ptr %.712091840.us.i.epil.init, i64 8
  ...
  %i.cam = getelementptr inbounds nuw i8, ptr %.712091840.us.i.epil.init, i64 16
  br label %._crit_edge1842.us.i

._crit_edge1842.us.i:                             ; preds = %._crit_edge1842.us.i.unr-lcssa, %.epil.preheader785
  %.lcssa727 = phi ptr [ %i.bzw, %._crit_edge1842.us.i.unr-lcssa ], [ %i.cam, %.epil.preheader785 ] ; 2 uses
  %i.can = getelementptr inbounds nuw [4 x i8], ptr %.312251844.us.i, i64 %i.axz ; 2 uses
  %i.cao = add nuw nsw i32 %.312001846.us.i, 2    ; 3 uses
...
.preheader1578.i:                                 ; preds = %._crit_edge1842.us.i, %._crit_edge1830.i
  %.31225.lcssa.i = phi ptr [ %.21224.lcssa.i, %._crit_edge1830.i ], [ %i.can, %._crit_edge1842.us.i ] ; 5 uses
  %.61208.lcssa.i = phi ptr [ %.41206.lcssa.i, %._crit_edge1830.i ], [ %.lcssa727, %._crit_edge1842.us.i ]
  %.31200.lcssa.i = phi i32 [ %.21199.lcssa.i, %._crit_edge1830.i ], [ %i.cao, %._crit_edge1842.us.i ] ; 2 uses
  %i.car = icmp sge i32 %.31200.lcssa.i, %i.p
...
.preheader1573.i:                                 ; preds = %.preheader1578.i, %._crit_edge1855.i
  %.412011858.i = phi i32 [ %i.cba, %._crit_edge1855.i ], [ %.31200.lcssa.i, %.preheader1578.i ]
  %.912111857.i = phi ptr [ %.lcssa730, %._crit_edge1855.i ], [ %.61208.lcssa.i, %.preheader1578.i ] ; 2 uses
  br i1 %i.ayw, label %.epil.preheader793, label %.preheader1573.i.new
...
.epil.preheader793:                               ; preds = %._crit_edge1855.i.unr-lcssa, %.preheader1573.i
  ...
  %.1012121853.i.epil.init = phi ptr [ %.912111857.i, %.preheader1573.i ], [ %i.ccj, %._crit_edge1855.i.unr-lcssa ]
  tail call void @llvm.assume(i1 %lcmp.mod798)
  br label %bb.fs

bb.fs:                                            ; preds = %bb.fs, %.epil.preheader793
  %indvars.iv2318.i.epil = phi i64 [ %indvars.iv2318.i.epil.init, %.epil.preheader793 ], [ %indvars.iv.next2319.i.epil, %bb.fs ] ; 2 uses
  %.1012121853.i.epil = phi ptr [ %.1012121853.i.epil.init, %.epil.preheader793 ], [ %i.caz, %bb.fs ] ; 2 uses
  %epil.iter795 = phi i64 [ 0, %.epil.preheader793 ], [ %epil.iter795.next, %bb.fs ]
  %i.cas = getelementptr inbounds nuw [4 x i8], ptr %.31225.lcssa.i, i64 %indvars.iv2318.i.epil
  ...
  store i64 %i.cay, ptr %.1012121853.i.epil, align 1, !tbaa !100
  %i.caz = getelementptr inbounds nuw i8, ptr %.1012121853.i.epil, i64 8 ; 2 uses
  ...
  br i1 %epil.iter795.cmp.not, label %._crit_edge1855.i, label %bb.fs, !llvm.loop !582

._crit_edge1855.i:                                ; preds = %bb.fs, %._crit_edge1855.i.unr-lcssa
  %.lcssa730 = phi ptr [ %i.ccj, %._crit_edge1855.i.unr-lcssa ], [ %i.caz, %bb.fs ]
  %i.cba = add nuw nsw i32 %.412011858.i, 1       ; 2 uses
...
.preheader1573.i.new:                             ; preds = %.preheader1573.i, %.preheader1573.i.new
  ...
  %.1012121853.i = phi ptr [ %i.ccj, %.preheader1573.i.new ], [ %.912111857.i, %.preheader1573.i ] ; 5 uses
  %niter800 = phi i64 [ %niter800.next.3, %.preheader1573.i.new ], [ 0, %.preheader1573.i ]
  %i.cbb = getelementptr inbounds nuw [4 x i8], ptr %.31225.lcssa.i, i64 %indvars.iv2318.i
  ...
  store i64 %i.cbh, ptr %.1012121853.i, align 1, !tbaa !100
  %i.cbi = getelementptr inbounds nuw i8, ptr %.1012121853.i, i64 8
  %i.cbj = getelementptr inbounds nuw [4 x i8], ptr %.31225.lcssa.i, i64 %indvars.iv2318.i
  ...
  %i.cbr = getelementptr inbounds nuw i8, ptr %.1012121853.i, i64 16
  %i.cbs = getelementptr inbounds nuw [4 x i8], ptr %.31225.lcssa.i, i64 %indvars.iv2318.i
  ...
  %i.cca = getelementptr inbounds nuw i8, ptr %.1012121853.i, i64 24
  %i.ccb = getelementptr inbounds nuw [4 x i8], ptr %.31225.lcssa.i, i64 %indvars.iv2318.i
  ...
  %i.ccj = getelementptr inbounds nuw i8, ptr %.1012121853.i, i64 32 ; 3 uses
  ...
  br i1 %niter800.ncmp.3, label %._crit_edge1855.i.unr-lcssa, label %.preheader1573.i.new, !llvm.loop !584
...
_ZN4ncnn3MatD2Ev.exit.lr.ph.i:                    ; preds = %.preheader1562.i
  ...
  %i.cdv = add nuw i32 %i.cdu, 16                 ; 4 uses
  %i.cdw = add i32 %i.p, -8
  ...
  %xtraiter826 = and i64 %wide.trip.count2378.i, 1
  %i.ceb = icmp eq i64 %i.cea, 0
  %unroll_iter831 = and i64 %wide.trip.count2378.i, 2147483646
  %lcmp.mod828.not = icmp eq i64 %xtraiter826, 0
  %lcmp.mod830 = trunc i32 %i.pl to i1
  %xtraiter834 = and i64 %wide.trip.count2378.i, 3 ; 3 uses
  %i.cec = icmp ult i64 %i.cea, 3
  %unroll_iter839 = and i64 %wide.trip.count2378.i, 2147483644
  %lcmp.mod836.not = icmp eq i64 %xtraiter834, 0
  %lcmp.mod838 = icmp ne i64 %xtraiter834, 0
  %xtraiter842 = and i64 %wide.trip.count2378.i, 3 ; 3 uses
  %i.ced = icmp ult i64 %i.cea, 3
  %unroll_iter847 = and i64 %wide.trip.count2378.i, 2147483644
  %lcmp.mod844.not = icmp eq i64 %xtraiter842, 0
  %lcmp.mod846 = icmp ne i64 %xtraiter842, 0
  %min.iters.check590 = icmp ult i32 %i.pl, 8
  %min.iters.check592 = icmp ult i32 %i.pl, 32
  %i.cee = and i64 %wide.trip.count2378.i, 24
  %n.vec594 = and i64 %wide.trip.count2378.i, 2147483616 ; 5 uses
  %i.cef = shl nuw nsw i64 %n.vec594, 2
  %cmp.n607 = icmp eq i64 %n.vec594, %wide.trip.count2378.i
  %min.epilog.iters.check612 = icmp eq i64 %i.cee, 0
  %n.vec614 = and i64 %wide.trip.count2378.i, 2147483640 ; 4 uses
  %i.ceg = shl nuw nsw i64 %n.vec614, 2
  %cmp.n623 = icmp eq i64 %n.vec614, %wide.trip.count2378.i
  %min.iters.check559 = icmp ult i32 %i.pl, 8
  %min.iters.check561 = icmp ult i32 %i.pl, 64
  %i.ceh = and i64 %wide.trip.count2378.i, 56
  %n.vec563 = and i64 %wide.trip.count2378.i, 2147483584 ; 5 uses
  %i.cei = shl nuw nsw i64 %n.vec563, 1
  %cmp.n573 = icmp eq i64 %n.vec563, %wide.trip.count2378.i
  %min.epilog.iters.check578 = icmp eq i64 %i.ceh, 0
  %n.vec580 = and i64 %wide.trip.count2378.i, 2147483640 ; 4 uses
  %i.cej = shl nuw nsw i64 %n.vec580, 1
  %cmp.n587 = icmp eq i64 %n.vec580, %wide.trip.count2378.i
...
.preheader1567.us.i:                              ; preds = %.preheader1567.lr.ph.i, %._crit_edge1864.us.i
  %.011371869.us.i = phi i32 [ %i.cht, %._crit_edge1864.us.i ], [ 0, %.preheader1567.lr.ph.i ]
  %.011421868.us.i = phi ptr [ %.lcssa697, %._crit_edge1864.us.i ], [ %i.cfi, %.preheader1567.lr.ph.i ] ; 2 uses
  %.011531867.us.i = phi ptr [ %i.chs, %._crit_edge1864.us.i ], [ %i.cew, %.preheader1567.lr.ph.i ] ; 4 uses
  %.011571866.us.i = phi ptr [ %i.chr, %._crit_edge1864.us.i ], [ %i.cet, %.preheader1567.lr.ph.i ] ; 4 uses
  br i1 %i.bqo, label %.epil.preheader801, label %.preheader1567.us.i.new
...
.preheader1567.us.i.new:                          ; preds = %.preheader1567.us.i, %.preheader1567.us.i.new
  ...
  %.111431862.us.i = phi ptr [ %i.cgw, %.preheader1567.us.i.new ], [ %.011421868.us.i, %.preheader1567.us.i ] ; 5 uses
  %niter808 = phi i64 [ %niter808.next.1, %.preheader1567.us.i.new ], [ 0, %.preheader1567.us.i ]
  %i.cfj = getelementptr inbounds nuw [4 x i8], ptr %.011571866.us.i, i64 %indvars.iv2334.i
  %i.cfk = getelementptr inbounds nuw [4 x i8], ptr %.011531867.us.i, i64 %indvars.iv2334.i
  ...
  store <4 x i64> %i.cft, ptr %.111431862.us.i, align 1, !tbaa !100
  %i.cfu = getelementptr inbounds nuw i8, ptr %.111431862.us.i, i64 32
  ...
  %i.cgc = getelementptr inbounds nuw i8, ptr %.111431862.us.i, i64 64
  %indvars.iv.next2335.i = or disjoint i64 %indvars.iv2334.i, 1 ; 2 uses
  %i.cgd = getelementptr inbounds nuw [4 x i8], ptr %.011571866.us.i, i64 %indvars.iv.next2335.i
  %i.cge = getelementptr inbounds nuw [4 x i8], ptr %.011531867.us.i, i64 %indvars.iv.next2335.i
  ...
  %i.cgo = getelementptr inbounds nuw i8, ptr %.111431862.us.i, i64 96
  ...
  %i.cgw = getelementptr inbounds nuw i8, ptr %.111431862.us.i, i64 128 ; 3 uses
  ...
  br i1 %niter808.ncmp.1, label %._crit_edge1864.us.i.unr-lcssa, label %.preheader1567.us.i.new, !llvm.loop !589
...
.epil.preheader801:                               ; preds = %._crit_edge1864.us.i.unr-lcssa, %.preheader1567.us.i
  ...
  %.111431862.us.i.epil.init = phi ptr [ %.011421868.us.i, %.preheader1567.us.i ], [ %i.cgw, %._crit_edge1864.us.i.unr-lcssa ] ; 3 uses
  tail call void @llvm.assume(i1 %lcmp.mod806)
  %i.cgx = getelementptr inbounds nuw [4 x i8], ptr %.011571866.us.i, i64 %indvars.iv2334.i.epil.init
  %i.cgy = getelementptr inbounds nuw [4 x i8], ptr %.011531867.us.i, i64 %indvars.iv2334.i.epil.init
  ...
  store <4 x i64> %i.chh, ptr %.111431862.us.i.epil.init, align 1, !tbaa !100
  %i.chi = getelementptr inbounds nuw i8, ptr %.111431862.us.i.epil.init, i64 32
  ...
  %i.chq = getelementptr inbounds nuw i8, ptr %.111431862.us.i.epil.init, i64 64
  br label %._crit_edge1864.us.i

._crit_edge1864.us.i:                             ; preds = %._crit_edge1864.us.i.unr-lcssa, %.epil.preheader801
  %.lcssa697 = phi ptr [ %i.cgw, %._crit_edge1864.us.i.unr-lcssa ], [ %i.chq, %.epil.preheader801 ] ; 2 uses
  %i.chr = getelementptr inbounds nuw [4 x i8], ptr %.011571866.us.i, i64 %i.bpp ; 2 uses
  %i.chs = getelementptr inbounds nuw [4 x i8], ptr %.011531867.us.i, i64 %i.bpp ; 2 uses
  %i.cht = add nuw nsw i32 %.011371869.us.i, 16   ; 2 uses
...
.preheader1571.i:                                 ; preds = %._crit_edge1864.us.i, %_ZN4ncnn3MatD2Ev.exit1303.i
  %.01157.lcssa.i = phi ptr [ %i.cet, %_ZN4ncnn3MatD2Ev.exit1303.i ], [ %i.chr, %._crit_edge1864.us.i ] ; 3 uses
  %.01153.lcssa.i = phi ptr [ %i.cew, %_ZN4ncnn3MatD2Ev.exit1303.i ], [ %i.chs, %._crit_edge1864.us.i ] ; 3 uses
  %.01142.lcssa.i = phi ptr [ %i.cfi, %_ZN4ncnn3MatD2Ev.exit1303.i ], [ %.lcssa697, %._crit_edge1864.us.i ] ; 3 uses
  %.01137.lcssa.i = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit1303.i ], [ %i.bqh, %._crit_edge1864.us.i ] ; 4 uses
  %i.chw = or disjoint i32 %.01137.lcssa.i, 7
...
.preheader1566.preheader.i:                       ; preds = %.preheader1566.lr.ph.i, %.preheader1571.thread.i
  %.01157.lcssa25752586.i = phi ptr [ %.01157.lcssa.i, %.preheader1566.lr.ph.i ], [ %scevgep2330.i, %.preheader1571.thread.i ]
  %.01153.lcssa25762585.i = phi ptr [ %.01153.lcssa.i, %.preheader1566.lr.ph.i ], [ %scevgep2333.i, %.preheader1571.thread.i ]
end_hunk_11
