...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %i.m = load i32, ptr %3, align 4, !tbaa !66
...
bb.f:                                             ; preds = %bb.e
  %i.ap = load i32, ptr %3, align 4, !tbaa !66    ; 2 uses
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %i.gj = load float, ptr %.016145, align 4, !tbaa !41
  store float %i.gj, ptr %.744, align 4, !tbaa !41
  %i.gk = getelementptr inbounds nuw [4 x i8], ptr %.016145, i64 %i.j
  %i.gl = load float, ptr %i.gk, align 4, !tbaa !41
  %i.gm = getelementptr inbounds nuw i8, ptr %.744, i64 4
  store float %i.gl, ptr %i.gm, align 4, !tbaa !41
  %i.gn = getelementptr inbounds nuw [4 x i8], ptr %.016145, i64 %i.am ; 3 uses
  %i.go = getelementptr inbounds nuw i8, ptr %.744, i64 8
  %i.gp = load float, ptr %i.gn, align 4, !tbaa !41
  store float %i.gp, ptr %i.go, align 4, !tbaa !41
  ...
  br i1 %niter138.ncmp.3, label %._crit_edge.loopexit.unr-lcssa, label %.lr.ph, !llvm.loop !669
...
.lr.ph.epil:                                      ; preds = %.lr.ph.epil, %.lr.ph.epil.preheader
  ...
  %i.hh = load float, ptr %.016145.epil, align 4, !tbaa !41
  store float %i.hh, ptr %.744.epil, align 4, !tbaa !41
  %i.hi = getelementptr inbounds nuw [4 x i8], ptr %.016145.epil, i64 %i.j
  %i.hj = load float, ptr %i.hi, align 4, !tbaa !41
  %i.hk = getelementptr inbounds nuw i8, ptr %.744.epil, i64 4
  store float %i.hj, ptr %i.hk, align 4, !tbaa !41
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph.epil, %bb.f
  ...
  br i1 %i.hn, label %bb.f, label %.preheader.loopexit, !llvm.loop !671
...
.lr.ph57.new:                                     ; preds = %.lr.ph57, %.lr.ph57.new
  ...
  br i1 %niter146.ncmp.7, label %._crit_edge58.unr-lcssa, label %.lr.ph57.new, !llvm.loop !672
...
bb.g:                                             ; preds = %bb.g, %.epil.preheader139
  ...
  %i.in = load float, ptr %.015954.epil, align 4, !tbaa !41
  store float %i.in, ptr %.953.epil, align 4, !tbaa !41
  ...
  br i1 %epil.iter141.cmp.not, label %._crit_edge58, label %bb.g, !llvm.loop !673
...
._crit_edge58:                                    ; preds = %bb.g, %._crit_edge58.unr-lcssa
  ...
  br i1 %exitcond99.not, label %._crit_edge63.split, label %.lr.ph57, !llvm.loop !674
...
._crit_edge63.split:                              ; preds = %._crit_edge58, %.lr.ph62, %.preheader
  ...
  br i1 %exitcond104.not, label %bb.b, label %bb.c, !llvm.loop !675
}
...
bb.i:                                             ; preds = %bb.a
  %i.an = landingpad { ptr, i32 }
          cleanup
  %i.ao = load ptr, ptr %i.s, align 8, !tbaa !20  ; 2 uses
...
bb.k:                                             ; preds = %bb.j
  %i.ar = load ptr, ptr %i.t, align 8, !tbaa !21  ; 3 uses
  %.not3.i10 = icmp eq ptr %i.ar, null
  %i.as = load ptr, ptr %5, align 8, !tbaa !22    ; 3 uses
  br i1 %.not3.i10, label %bb.m, label %bb.l

bb.l:                                             ; preds = %bb.k
  %i.at = load ptr, ptr %i.ar, align 8, !tbaa !14
