...
.preheader.preheader.i:                           ; preds = %.preheader.preheader.i.preheader, %.preheader.preheader.i
  ...
  %12 = getelementptr inbounds i8, ptr %i.bp, i64 %.idx.i ; 9 uses
  %i.te = getelementptr inbounds nuw i8, ptr %12, i64 4
  %i.tf = getelementptr inbounds nuw i8, ptr %12, i64 8
  %i.tg = getelementptr inbounds nuw i8, ptr %12, i64 12
  %i.th = getelementptr inbounds nuw i8, ptr %12, i64 16
  %i.ti = getelementptr inbounds nuw i8, ptr %12, i64 20
  %i.tj = getelementptr inbounds nuw i8, ptr %12, i64 24
  %i.tk = getelementptr inbounds nuw i8, ptr %12, i64 28
  %i.tl = load float, ptr %i.tk, align 4, !tbaa !39 ; 3 uses
  %i.tm = getelementptr inbounds nuw i8, ptr %12, i64 32
  ...
  %13 = load float, ptr %i.tj, align 4, !tbaa !39 ; 6 uses
  %14 = fmul fast float %13, f0xBE638E39          ; 3 uses
  %.neg9.2.i = fsub fast float %14, %i.to
  %15 = fadd fast float %i.to, %14
  %16 = fmul fast float %13, f0x3C360B61          ; 2 uses
  %17 = fadd fast float %i.tp, %16
  %18 = fsub fast float %16, %i.tp
  %19 = fmul fast float %13, f0x3CB60B61          ; 2 uses
  %20 = fadd fast float %i.tq, %19
  %21 = fsub fast float %19, %i.tq
  %i.tt = fmul fast float %13, f0x3D360B61
  %22 = insertelement <4 x float> poison, float %14, i64 0
  %23 = insertelement <4 x float> %22, float %i.tt, i64 2
  %i.tu = fmul fast float %13, f0x3BB60B61
  %24 = insertelement <2 x float> poison, float %i.tu, i64 0
  %25 = insertelement <16 x float> poison, float %13, i64 6
  %26 = getelementptr inbounds nuw i8, ptr %.118.i, i64 68
  %i.tv = getelementptr inbounds nuw i8, ptr %.118.i, i64 84
  ...
  %i.uk = load <4 x float>, ptr %12, align 4, !tbaa !39 ; 6 uses
  %27 = load <2 x float>, ptr %i.th, align 4, !tbaa !39 ; 2 uses
  %28 = load float, ptr %i.ti, align 4, !tbaa !39 ; 4 uses
  %29 = shufflevector <2 x float> %27, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 3 uses
  %30 = shufflevector <4 x float> %i.uk, <4 x float> %29, <2 x i32> <i32 1, i32 4>
  %31 = fmul fast <2 x float> %30, splat (float f0x3C360B61) ; 2 uses
  %32 = shufflevector <4 x float> %i.uk, <4 x float> %29, <2 x i32> <i32 2, i32 5>
  %i.ul = fmul fast <2 x float> %32, splat (float f0x3BB60B61) ; 2 uses
  %i.um = extractelement <4 x float> %i.uk, i64 0 ; 2 uses
  %33 = fmul fast float %i.um, f0x3CB60B61        ; 3 uses
  %i.un = fadd fast float %20, %i.tr              ; 3 uses
  %i.uo = fadd fast float %21, %i.tr              ; 3 uses
  %i.up = load <2 x float>, ptr %i.te, align 4, !tbaa !39 ; 3 uses
  %34 = shufflevector <2 x float> %i.up, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %i.uq = insertelement <2 x float> %34, float %28, i64 1
  %i.ur = fmul fast <2 x float> %i.uq, splat (float f0xBE638E39) ; 4 uses
  %35 = shufflevector <4 x float> %i.uk, <4 x float> %29, <2 x i32> <i32 0, i32 4>
  %i.us = fmul fast <2 x float> %35, <float f0xBE638E39, float f0x3E638E39> ; 5 uses
  %36 = load <2 x float>, ptr %i.tf, align 4, !tbaa !39 ; 5 uses
  %37 = load float, ptr %i.tg, align 4, !tbaa !39 ; 2 uses
  %38 = shufflevector <4 x float> %i.uk, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %39 = shufflevector <2 x float> %38, <2 x float> %36, <2 x i32> <i32 0, i32 3>
  %i.ut = fmul fast <2 x float> %39, splat (float f0x3C360B61) ; 5 uses
  %40 = shufflevector <2 x float> %i.up, <2 x float> %27, <2 x i32> <i32 0, i32 2>
  %41 = fmul fast <2 x float> %40, splat (float f0x3CB60B61) ; 2 uses
  %42 = extractelement <2 x float> %i.ut, i64 1   ; 2 uses
  %43 = insertelement <2 x float> %36, float %28, i64 1
  %i.uu = fmul fast <2 x float> %43, splat (float f0x3D360B61) ; 2 uses
  %44 = fsub fast float %33, %42
  %45 = fadd fast float %42, %33
  %46 = insertelement <16 x float> poison, float %45, i64 0
  %47 = insertelement <16 x float> %46, float %44, i64 1
  %48 = shufflevector <2 x float> %24, <2 x float> poison, <16 x i32> <i32 0, i32 0, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %49 = fadd fast <16 x float> %47, %48
  %50 = shufflevector <2 x float> %i.up, <2 x float> %36, <2 x i32> <i32 0, i32 3>
  %51 = fmul fast <2 x float> %50, <float f0x3E638E39, float f0xBE638E39> ; 3 uses
  %52 = fadd fast <2 x float> %i.us, %51
  %53 = fadd fast <2 x float> %52, %i.ur          ; 4 uses
  %54 = shufflevector <2 x float> %53, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 0>
  %55 = extractelement <2 x float> %53, i64 1
  %56 = fmul fast float %55, f0x3C360B61          ; 2 uses
  %57 = fadd fast <2 x float> %41, %i.ut
  %58 = fadd fast <2 x float> %57, %i.uu          ; 3 uses
  %59 = shufflevector <2 x float> %58, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 0>
  %60 = insertelement <2 x float> poison, float %37, i64 0 ; 2 uses
  %61 = shufflevector <2 x float> %60, <2 x float> poison, <2 x i32> zeroinitializer
  %i.uv = fmul fast <2 x float> %61, <float f0x3E638E39, float f0x3CB60B61> ; 2 uses
  %62 = insertelement <2 x float> %i.uv, float %33, i64 0 ; 2 uses
  %i.uw = fadd fast <2 x float> %31, %62
  %i.ux = fadd fast <2 x float> %i.uw, %i.ul      ; 3 uses
  %63 = shufflevector <2 x float> %i.ux, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 0>
  %i.uy = fsub fast <2 x float> %62, %31
  %i.uz = fadd fast <2 x float> %i.uy, %i.ul      ; 3 uses
  %i.va = shufflevector <2 x float> %i.uz, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 0>
  %shift.scalar = fmul fast float %37, f0x3CB60B61
  %64 = extractelement <2 x float> %i.ut, i64 0
  %i.vb = fsub fast float %64, %shift.scalar
  %foldExtExtBinop287 = fsub fast <2 x float> %i.us, %i.uv
  %65 = shufflevector <2 x float> %foldExtExtBinop287, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %66 = shufflevector <2 x float> %60, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 poison, i32 poison>
  %67 = fmul fast <4 x float> %66, <float f0x3E638E39, float f0x3CB60B61, float poison, float poison>
  %68 = shufflevector <2 x float> %i.us, <2 x float> %i.ut, <4 x i32> <i32 0, i32 2, i32 poison, i32 poison>
  %69 = fadd fast <4 x float> %67, %68
  %70 = shufflevector <4 x float> %65, <4 x float> %69, <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
  %71 = insertelement <4 x float> %70, float %i.vb, i64 3
  store float %i.um, ptr %.118.i, align 4, !tbaa !39
  %72 = fmul fast <4 x float> %54, <float f0xBE638E39, float f0x3E638E39, float f0x3CB60B61, float f0x3C360B61> ; 3 uses
  %73 = shufflevector <4 x float> %72, <4 x float> poison, <4 x i32> <i32 1, i32 0, i32 3, i32 2> ; 2 uses
  %74 = fsub fast <4 x float> %72, %73
  %75 = fadd fast <4 x float> %72, %73
  %76 = shufflevector <4 x float> %74, <4 x float> %75, <4 x i32> <i32 0, i32 5, i32 6, i32 3>
  %77 = extractelement <2 x float> %53, i64 0
  %78 = fmul fast float %77, f0x3CB60B61          ; 2 uses
  %79 = fadd fast float %56, %78
  %80 = fsub fast float %78, %56
  %81 = shufflevector <2 x float> %53, <2 x float> poison, <16 x i32> <i32 0, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %82 = shufflevector <4 x float> %71, <4 x float> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %83 = shufflevector <4 x float> %23, <4 x float> poison, <16 x i32> <i32 0, i32 0, i32 2, i32 2, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.vc = fadd fast <16 x float> %82, %83
  %i.vd = fmul fast <4 x float> %59, <float f0xBE638E39, float f0x3E638E39, float f0x3CB60B61, float f0x3C360B61> ; 3 uses
  ...
  %i.vi = extractelement <2 x float> %58, i64 0   ; 2 uses
  %i.vj = fmul fast float %i.vi, f0x3CB60B61      ; 2 uses
  %i.vk = extractelement <2 x float> %58, i64 1
  ...
  %i.vo = fsub fast <2 x float> %i.ut, %41
  %i.vp = fadd fast <2 x float> %i.vo, %i.uu      ; 3 uses
  ...
  %i.wc = fmul fast <4 x float> %63, <float f0xBE638E39, float f0x3E638E39, float f0x3CB60B61, float f0x3C360B61> ; 3 uses
  ...
  %i.wh = extractelement <2 x float> %i.ux, i64 0
  %i.wi = fmul fast <2 x float> %i.ux, <float f0x3CB60B61, float f0x3C360B61> ; 2 uses
  ...
  %i.xf = fmul fast float %84, f0x3CB60B61        ; 2 uses
  %i.xg = fmul fast float %28, f0x3C360B61        ; 2 uses
  ...
  %85 = shufflevector <4 x float> %i.uk, <4 x float> poison, <16 x i32> <i32 poison, i32 poison, i32 2, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %86 = shufflevector <16 x float> %i.xn, <16 x float> %85, <16 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 6, i32 7, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 18>
  %i.xo = insertelement <16 x float> %86, float %i.uo, i64 14
  ...
  %i.yk = fadd fast float %.neg9.2.i, %i.yj       ; 3 uses
  %i.yl = fadd fast float %15, %i.yj              ; 3 uses
  %i.ym = extractelement <4 x float> %i.yi, i64 2 ; 2 uses
  %i.yn = fadd fast float %17, %i.ym              ; 3 uses
  %i.yo = fadd fast float %18, %i.ym              ; 3 uses
  %i.yp = insertelement <4 x float> poison, float %i.yk, i64 0
  %87 = fmul fast float %i.yk, f0x3BB60B61
  %88 = insertelement <2 x float> poison, float %87, i64 0
  %89 = fmul fast float %i.yl, f0x3BB60B61        ; 2 uses
  %i.yq = fmul fast float %i.yn, f0x3BB60B61      ; 2 uses
  %i.yr = fmul fast float %i.yo, f0x3BB60B61      ; 2 uses
  %90 = insertelement <4 x float> poison, float %i.yl, i64 0
  %91 = shufflevector <4 x float> %90, <4 x float> poison, <4 x i32> zeroinitializer
  %92 = fmul fast <4 x float> %91, <float f0xBE638E39, float f0xBE638E39, float f0x3D360B61, float f0x3D360B61>
  %93 = insertelement <4 x float> poison, float %i.yn, i64 0
  %94 = shufflevector <4 x float> %93, <4 x float> poison, <4 x i32> zeroinitializer
  %95 = fmul fast <4 x float> %94, <float f0xBE638E39, float f0xBE638E39, float f0x3D360B61, float f0x3D360B61>
  %96 = shufflevector <2 x float> %i.us, <2 x float> %51, <2 x i32> <i32 0, i32 3>
  %97 = shufflevector <2 x float> %51, <2 x float> %i.us, <2 x i32> <i32 0, i32 3>
  %98 = fsub fast <2 x float> %96, %97
  %99 = fadd fast <2 x float> %98, %i.ur          ; 3 uses
  %100 = shufflevector <2 x float> %99, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 0>
  %i.ys = fmul fast <4 x float> %100, <float f0xBE638E39, float f0x3E638E39, float f0x3CB60B61, float f0x3C360B61> ; 3 uses
  %101 = shufflevector <4 x float> %i.ys, <4 x float> poison, <4 x i32> <i32 1, i32 0, i32 3, i32 2> ; 2 uses
  %102 = fsub fast <4 x float> %i.ys, %101
  %i.yt = fadd fast <4 x float> %i.ys, %101
  %103 = fmul fast <2 x float> %99, <float f0x3CB60B61, float f0x3C360B61> ; 2 uses
  %104 = shufflevector <2 x float> %103, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %105 = shufflevector <2 x float> %103, <2 x float> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  %106 = fadd fast <2 x float> %104, %105
  %107 = fsub fast <2 x float> %104, %105
  %i.yu = fadd fast <4 x float> %76, %92
  %108 = fadd fast float %79, %89
  %109 = fadd fast float %80, %89
  %110 = shufflevector <2 x float> %99, <2 x float> poison, <16 x i32> <i32 0, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %111 = shufflevector <16 x float> %25, <16 x float> %110, <16 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 6, i32 16, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %112 = insertelement <16 x float> %111, float %i.yk, i64 14
  %113 = shufflevector <16 x float> %112, <16 x float> %81, <16 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 6, i32 7, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 14, i32 16>
  %114 = shufflevector <16 x float> %i.vc, <16 x float> %113, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 22, i32 23, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 30, i32 31>
  %115 = shufflevector <4 x float> %102, <4 x float> %i.yt, <16 x i32> <i32 0, i32 5, i32 6, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %116 = shufflevector <4 x float> %i.yp, <4 x float> poison, <16 x i32> <i32 0, i32 0, i32 0, i32 0, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.yv = fmul fast <16 x float> %116, <float f0xBE638E39, float f0xBE638E39, float f0x3D360B61, float f0x3D360B61, float poison, float poison, float poison, float poison, float poison, float poison, float poison, float poison, float poison, float poison, float poison, float poison>
  %i.yw = fadd fast <16 x float> %115, %i.yv
  %117 = shufflevector <16 x float> %114, <16 x float> %i.yw, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 6, i32 7, i32 16, i32 17, i32 18, i32 19, i32 poison, i32 poison, i32 14, i32 15>
  %118 = shufflevector <16 x float> %117, <16 x float> %49, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 16, i32 17, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 poison, i32 poison, i32 14, i32 15>
  %119 = shufflevector <2 x float> %106, <2 x float> %107, <16 x i32> <i32 0, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %120 = shufflevector <2 x float> %88, <2 x float> poison, <16 x i32> <i32 0, i32 0, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %121 = fadd fast <16 x float> %119, %120
  %122 = shufflevector <16 x float> %118, <16 x float> %121, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 16, i32 17, i32 14, i32 15>
  store <16 x float> %122, ptr %i.ts, align 4, !tbaa !39
  store <4 x float> %i.yu, ptr %26, align 4, !tbaa !39
  store float %108, ptr %i.tv, align 4, !tbaa !39
  store float %109, ptr %i.tw, align 4, !tbaa !39
  store float %i.yl, ptr %i.tx, align 4, !tbaa !39
  %i.yx = fadd fast <4 x float> %i.vh, %95
  ...
  %123 = shufflevector <2 x float> %i.ur, <2 x float> %36, <4 x i32> <i32 0, i32 poison, i32 poison, i32 2>
  %i.zg = insertelement <4 x float> poison, float %28, i64 0
  %i.zh = shufflevector <4 x float> %i.zg, <4 x float> poison, <4 x i32> <i32 poison, i32 0, i32 0, i32 poison>
  %i.zi = shufflevector <4 x float> %123, <4 x float> %i.zh, <4 x i32> <i32 0, i32 5, i32 6, i32 3>
  ...
  %i.zk = shufflevector <2 x float> %i.ur, <2 x float> poison, <4 x i32> <i32 poison, i32 0, i32 poison, i32 poison>
