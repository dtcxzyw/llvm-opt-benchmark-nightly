...
._crit_edge1918.split.i:                          ; preds = %._crit_edge1914.i, %.preheader1487.i, %.preheader1486.lr.ph.i
  %indvars.iv.next2328.i = add nuw nsw i64 %indvars.iv2327.i, 1 ; 2 uses
...
._crit_edge2000.split.i:                          ; preds = %._crit_edge1996.i, %.preheader1558.i, %.preheader1554.lr.ph.i, %.preheader1555.lr.ph.i
  %indvars.iv.next2407.i = add nuw nsw i64 %indvars.iv2406.i, 1 ; 2 uses
...
.loopexit.i.i:                                    ; preds = %.loopexit.i.i.loopexit224.unr-lcssa, %bb.e, %.loopexit.i.i.loopexit223.unr-lcssa, %.lr.ph622.i.i.epil, %.loopexit.i.i.loopexit222.unr-lcssa, %.lr.ph617.i.i.epil, %.loopexit.i.i.loopexit.unr-lcssa, %.lr.ph612.i.i.epil, %_ZN4ncnn3MatD2Ev.exit.i.i, %_ZN4ncnn3MatD2Ev.exit662.i.i, %_ZN4ncnn3MatD2Ev.exit663.i.i, %_ZN4ncnn3MatD2Ev.exit664.i.i, %.split764.i.i
  ...
  %indvars.iv.next685.i.i = add nuw nsw i64 %indvars.iv684.i.i, 1 ; 2 uses
...
._crit_edge1468.i:                                ; preds = %bb.id, %.preheader.i
  ...
  %indvars.iv.next1711.i = add nuw nsw i64 %indvars.iv1710.i, 1 ; 2 uses
...
bb.a:
  ...
  %i.c = alloca i32, align 4                      ; 4 uses
  %i.d = alloca i32, align 4                      ; 4 uses
  %i.e = load i32, ptr %3, align 4, !tbaa !67     ; 15 uses
  %i.f = load i32, ptr %2, align 4, !tbaa !67     ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.l = call i32 @llvm.umin.i32(i32 %i.k, i32 %i.i) ; 11 uses
  store i32 %i.l, ptr %i.b, align 4, !tbaa !67
  %i.m = load i32, ptr %i.a, align 4, !tbaa !67   ; 12 uses
  %i.n = add i32 %i.l, 1
...
_ZN4ncnn3Mat7channelEi.exit.lr.ph.split.us.split.us: ; preds = %_ZN4ncnn3Mat7channelEi.exit.lr.ph.split.us
  ...
  %wide.trip.count207 = zext nneg i32 %i.at to i64
  %wide.trip.count = zext nneg i32 %i.bd to i64
  %i.bi = zext i32 %i.am to i64                   ; 5 uses
  %min.iters.check273 = icmp ult i32 %i.am, 8
  %min.iters.check275 = icmp ult i32 %i.am, 64
  %i.bj = and i64 %i.bi, 56
  %n.vec277 = and i64 %i.bi, 2147483584           ; 5 uses
  %i.bk = trunc nuw nsw i64 %n.vec277 to i32
  %i.bl = shl nuw nsw i64 %n.vec277, 2
  %cmp.n285 = icmp eq i64 %n.vec277, %i.bi
  %min.epilog.iters.check291 = icmp eq i64 %i.bj, 0
  %n.vec293 = and i64 %i.bi, 2147483640           ; 4 uses
  %i.bm = trunc nuw nsw i64 %n.vec293 to i32
  %i.bn = shl nuw nsw i64 %n.vec293, 2
  %cmp.n301 = icmp eq i64 %n.vec293, %i.bi
...
bb.d:                                             ; preds = %bb.c, %_ZN4ncnn3Mat7channelEi.exit.us.us
  ...
  br i1 %i.an, label %iter.check288, label %.noexc100.us.us

iter.check288:                                    ; preds = %bb.d
  br i1 %min.iters.check273, label %.lr.ph.us.us.preheader, label %vector.main.loop.iter.check274

vector.main.loop.iter.check274:                   ; preds = %iter.check288
...
vector.ph276:                                     ; preds = %vector.main.loop.iter.check274
  ...
  %broadcast.splatinsert278 = insertelement <16 x float> poison, float %i.bt, i64 0
  %broadcast.splat279 = shufflevector <16 x float> %broadcast.splatinsert278, <16 x float> poison, <16 x i32> zeroinitializer ; 4 uses
...
vector.body280:                                   ; preds = %vector.body280, %vector.ph276
  ...
  %i.bv = shl i64 %index281, 2
  %next.gep282 = getelementptr i8, ptr %i.bq, i64 %i.bv ; 4 uses
  %i.bw = getelementptr i8, ptr %next.gep282, i64 64
  %i.bx = getelementptr i8, ptr %next.gep282, i64 128
  %i.by = getelementptr i8, ptr %next.gep282, i64 192
  store <16 x float> %broadcast.splat279, ptr %next.gep282, align 4, !tbaa !39
  store <16 x float> %broadcast.splat279, ptr %i.bw, align 4, !tbaa !39
  store <16 x float> %broadcast.splat279, ptr %i.bx, align 4, !tbaa !39
  store <16 x float> %broadcast.splat279, ptr %i.by, align 4, !tbaa !39
  %index.next283 = add nuw i64 %index281, 64      ; 2 uses
  %i.bz = icmp eq i64 %index.next283, %n.vec277
  br i1 %i.bz, label %middle.block284, label %vector.body280, !llvm.loop !1379

middle.block284:                                  ; preds = %vector.body280
  br i1 %cmp.n285, label %.noexc100.us.us, label %vec.epilog.iter.check290

vec.epilog.iter.check290:                         ; preds = %middle.block284
  br i1 %min.epilog.iters.check291, label %.lr.ph.us.us.preheader, label %vec.epilog.ph292, !prof !216

vec.epilog.ph292:                                 ; preds = %vector.main.loop.iter.check274, %vec.epilog.iter.check290
  %vec.epilog.resume.val286 = phi i64 [ %n.vec277, %vec.epilog.iter.check290 ], [ 0, %vector.main.loop.iter.check274 ]
  %i.ca = getelementptr i8, ptr %i.bq, i64 %i.bn
  %broadcast.splatinsert294 = insertelement <8 x float> poison, float %i.bt, i64 0
  %broadcast.splat295 = shufflevector <8 x float> %broadcast.splatinsert294, <8 x float> poison, <8 x i32> zeroinitializer
  br label %vec.epilog.vector.body296

vec.epilog.vector.body296:                        ; preds = %vec.epilog.vector.body296, %vec.epilog.ph292
  %index297 = phi i64 [ %vec.epilog.resume.val286, %vec.epilog.ph292 ], [ %index.next299, %vec.epilog.vector.body296 ] ; 2 uses
  %i.cb = shl i64 %index297, 2
  %next.gep298 = getelementptr i8, ptr %i.bq, i64 %i.cb
  store <8 x float> %broadcast.splat295, ptr %next.gep298, align 4, !tbaa !39
  %index.next299 = add nuw i64 %index297, 8       ; 2 uses
  %i.cc = icmp eq i64 %index.next299, %n.vec293
end_hunk_10
...
bb.bp:                                            ; preds = %._crit_edge1883
  %indvars.iv.next2299 = add nuw nsw i64 %indvars.iv2298, 1 ; 2 uses
...
.loopexit150.us.i.loopexit.i:                     ; preds = %.lr.ph255.us.i.i.epil, %.loopexit150.us.i.loopexit.i.unr-lcssa
  ...
  %indvars.iv.next319.i.i = add nuw nsw i64 %indvars.iv318.i.i, 1 ; 2 uses
...
._crit_edge1026.i:                                ; preds = %.lr.ph1025.i.prol.loopexit, %.lr.ph1025.i, %middle.block, %vec.epilog.middle.block, %.preheader.i
  ...
  %indvars.iv.next1106.i = add nuw nsw i64 %indvars.iv1105.i, 1 ; 2 uses
...
._crit_edge1750.i:                                ; preds = %bb.cz, %bb.cg
  %indvars.iv.next1841.i = add nuw nsw i64 %indvars.iv1840.i, 1 ; 2 uses
...
._crit_edge3510:                                  ; preds = %bb.fz, %bb.dg
  ...
  %indvars.iv.next3606 = add nuw nsw i64 %indvars.iv3605, 1 ; 2 uses
...
._crit_edge5720:                                  ; preds = %bb.fh, %bb.fe
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e) #12
  %indvars.iv.next5816 = add nuw nsw i64 %indvars.iv5815, 1 ; 2 uses
...
.loopexit.i.i:                                    ; preds = %.loopexit.i.i.loopexit196.unr-lcssa, %bb.d, %.loopexit.i.i.loopexit195.unr-lcssa, %.lr.ph740.i.i.epil, %.loopexit.i.i.loopexit194.unr-lcssa, %.lr.ph735.i.i.epil, %.loopexit.i.i.loopexit.unr-lcssa, %.lr.ph730.i.i.epil, %_ZN4ncnn3MatD2Ev.exit.i.i, %_ZN4ncnn3MatD2Ev.exit491.i.i, %_ZN4ncnn3MatD2Ev.exit492.i.i, %_ZN4ncnn3MatD2Ev.exit493.i.i, %.split853.i.i
  ...
  %indvars.iv.next791.i.i = add nuw nsw i64 %indvars.iv790.i.i, 1 ; 2 uses
...
._crit_edge9263:                                  ; preds = %bb.hv, %.preheader
  ...
  %indvars.iv.next9462 = add nuw nsw i64 %indvars.iv9461, 1 ; 2 uses
