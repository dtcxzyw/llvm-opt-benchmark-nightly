...
_ZN4ncnn3MatD2Ev.exit36:                          ; preds = %_ZN4ncnn3MatD2Ev.exit36.lr.ph, %_ZN4ncnn3MatD2Ev.exit
  ...
  %i.aq = load i32, ptr %10, align 4, !tbaa !78   ; 58 uses
...
bb.g:                                             ; preds = %_ZN4ncnn3MatD2Ev.exit36
  ...
  %i.sz = mul nsw i32 %i.ar, %i.aq                ; 53 uses
...
bb.k:                                             ; preds = %bb.k, %.lr.ph168.i.i
  ...
  %16 = srem i32 %i.abm, %i.sz                    ; 2 uses
  %17 = srem i32 %i.abo, %i.sz                    ; 2 uses
  %i.abq = sdiv i32 %16, %i.aq
  %18 = sdiv i32 %17, %i.aq
  %19 = srem i32 %16, %i.aq
  %20 = srem i32 %17, %i.aq
...
.lr.ph.i42.i:                                     ; preds = %.preheader154.i.i, %.lr.ph.i42.i
  ...
  %21 = srem i32 %i.afd, %i.sz                    ; 2 uses
  %22 = srem i32 %i.aff, %i.sz                    ; 2 uses
  %i.afh = sdiv i32 %21, %i.aq
  %i.afi = sdiv i32 %22, %i.aq
  %23 = srem i32 %21, %i.aq
  %24 = srem i32 %22, %i.aq
  %i.afj = mul i32 %i.afh, %i.uo
  %i.afk = mul nsw i32 %23, %i.as
  %25 = mul i32 %i.afi, %i.uo
  %i.afl = mul nsw i32 %24, %i.as
  %i.afm = mul i32 %i.afe, %i.up
  %i.afn = add i32 %i.afj, %i.afm
...
.lr.ph244.i.i:                                    ; preds = %.preheader133.i.i
  ...
  %i.apw = mul i32 %i.ss, %i.at                   ; 7 uses
  %i.apx = trunc i64 %i.bd to i32
  ...
  %i.aqi = insertelement <2 x i32> poison, i32 %i.apw, i64 0
  %i.aqj = shufflevector <2 x i32> %i.aqi, <2 x i32> poison, <2 x i32> zeroinitializer
  %i.aqk = insertelement <2 x i32> poison, i32 %i.apx, i64 0
...
bb.q:                                             ; preds = %bb.q, %.lr.ph199.i.i
  ...
  %26 = srem i32 %i.atl, %i.sz                    ; 2 uses
  %27 = srem i32 %i.atn, %i.sz                    ; 2 uses
  %i.atp = sdiv i32 %26, %i.aq
  %28 = sdiv i32 %27, %i.aq
  %29 = srem i32 %26, %i.aq
  %30 = srem i32 %27, %i.aq
...
.lr.ph186.i.i:                                    ; preds = %.preheader143.i.i, %.lr.ph186.i.i
  ...
  %31 = srem i32 %i.axd, %i.sz                    ; 2 uses
  %32 = srem i32 %i.axf, %i.sz                    ; 2 uses
  %i.axh = sdiv i32 %31, %i.aq
  %i.axi = sdiv i32 %32, %i.aq
  %33 = srem i32 %31, %i.aq
  %34 = srem i32 %32, %i.aq
  %i.axj = mul i32 %i.axh, %i.vr
  %i.axk = mul nsw i32 %33, %i.as
  %35 = mul i32 %i.axi, %i.vr
  %i.axl = mul nsw i32 %34, %i.as
  %i.axm = mul i32 %i.axe, %i.vs
  %i.axn = add i32 %i.axj, %i.axm
  %i.axo = add i32 %i.axn, %i.axk
...
bb.w:                                             ; preds = %bb.w, %.lr.ph231.i.i
  ...
  %36 = srem i32 %i.bef, %i.sz                    ; 2 uses
  %37 = srem i32 %i.beh, %i.sz                    ; 2 uses
  %i.bej = sdiv i32 %36, %i.aq
  %38 = sdiv i32 %37, %i.aq
  %39 = srem i32 %36, %i.aq
  %40 = srem i32 %37, %i.aq
...
.lr.ph217.i.i:                                    ; preds = %.preheader132.i.i, %.lr.ph217.i.i
  ...
  %i.bhl = add nsw i32 %.01117215.i.i, %i.y       ; 2 uses
  %i.bhm = add nsw i32 %i.bhl, 1
  %41 = insertelement <2 x i32> poison, i32 %i.bhl, i64 0
  %i.bhn = insertelement <2 x i32> %41, i32 %i.bhm, i64 1
  %.frozen = freeze <2 x i32> %i.bhn              ; 2 uses
  %.frozen492 = freeze <2 x i32> %i.aqf           ; 2 uses
  %42 = sdiv <2 x i32> %.frozen, %.frozen492      ; 2 uses
  %43 = mul <2 x i32> %42, %.frozen492
  %.decomposed = sub <2 x i32> %.frozen, %43      ; 3 uses
  %44 = sdiv <2 x i32> %.decomposed, %i.aqh
  %45 = extractelement <2 x i32> %.decomposed, i64 0
  %46 = srem i32 %45, %i.aq
  %i.bho = extractelement <2 x i32> %.decomposed, i64 1
  %47 = srem i32 %i.bho, %i.aq
  %i.bhp = mul nsw i32 %46, %i.as
  %48 = mul <2 x i32> %44, %i.aqj
  %i.bhq = mul nsw i32 %47, %i.as
  %49 = mul <2 x i32> %42, %i.aql
  %50 = add <2 x i32> %48, %49                    ; 2 uses
  %51 = extractelement <2 x i32> %50, i64 0
  %i.bhr = add i32 %51, %i.bhp                    ; 2 uses
  %i.bhs = add i32 %i.bhr, %i.bdz
  %52 = add i32 %i.bhr, %i.bea
  %53 = extractelement <2 x i32> %50, i64 1
  %i.bht = add i32 %53, %i.bhq                    ; 2 uses
  %i.bhu = add i32 %i.bht, %i.bdz
  %i.bhv = add i32 %i.bht, %i.bea
  %i.bhw = load ptr, ptr %9, align 8, !tbaa !34   ; 4 uses
  %i.bhx = sext i32 %i.bhs to i64
  %i.bhy = getelementptr inbounds i8, ptr %i.bhw, i64 %i.bhx
  %i.bhz = sext i32 %52 to i64
...
bb.ad:                                            ; preds = %bb.ad, %.lr.ph249.i.i
  ...
  %54 = srem i32 %i.blc, %i.sz                    ; 2 uses
  %55 = srem i32 %i.ble, %i.sz                    ; 2 uses
  %i.blg = sdiv i32 %54, %i.aq
  %56 = sdiv i32 %55, %i.aq
  %57 = srem i32 %54, %i.aq
  %58 = srem i32 %55, %i.aq
