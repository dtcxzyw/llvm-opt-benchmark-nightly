...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  store i32 %storemerge, ptr %3, align 4, !tbaa !78
  ...
  store i32 %.sroa.speculated58, ptr %5, align 4, !tbaa !78
  %i.ao = icmp sgt i32 %1, 0
  br i1 %i.ao, label %bb.f, label %bb.g

bb.f:                                             ; preds = %bb.e
  %i.ap = load i32, ptr %3, align 4, !tbaa !78    ; 2 uses
  ...
  store i32 %.sroa.speculated, ptr %4, align 4, !tbaa !78
  br label %bb.g
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.k = load i32, ptr %i.a, align 4, !tbaa !78   ; 3 uses
...
bb.c:                                             ; preds = %.lr.ph126, %_ZN4ncnn3MatD2Ev.exit
  ...
  %i.s = mul i32 %i.r, 9
  %i.t = load i32, ptr %3, align 4, !tbaa !78     ; 2 uses
...
_ZN4ncnn3Mat7channelEi.exit49:                    ; preds = %bb.c
  %i.w = load ptr, ptr %4, align 8, !tbaa !34, !noalias !467 ; 2 uses
  %i.x = load i64, ptr %i.l, align 8, !tbaa !35, !noalias !467
  %i.y = sext i32 %i.v to i64
  %i.z = mul i64 %i.x, %i.y
  %i.aa = load i64, ptr %i.m, align 8, !tbaa !76, !noalias !467
  %i.ab = mul i64 %i.z, %i.aa                     ; 2 uses
  %i.ac = getelementptr i8, ptr %i.w, i64 %i.ab   ; 4 uses
  %i.ad = load i32, ptr %5, align 4, !tbaa !78    ; 6 uses
  %i.ae = icmp sgt i32 %i.ad, 0
  br i1 %i.ae, label %.lr.ph, label %_ZN4ncnn3MatD2Ev.exit

.lr.ph:                                           ; preds = %_ZN4ncnn3Mat7channelEi.exit49
  %i.af = load i32, ptr %7, align 4, !tbaa !78
  %i.ag = sub i32 %i.af, %i.u
  %i.ah = load i32, ptr %3, align 4, !tbaa !78    ; 2 uses
  %.sroa.speculated82 = call i32 @llvm.smin.i32(i32 %i.ah, i32 %i.ag) ; 9 uses
  %i.ai = load i32, ptr %6, align 4, !tbaa !78    ; 9 uses
  %i.aj = icmp sgt i32 %.sroa.speculated82, 0
  %wide.trip.count28.i = zext nneg i32 %.sroa.speculated82 to i64
  %i.ak = sdiv i32 %i.u, %i.ah
  %i.al = load i32, ptr %i.n, align 4, !tbaa !86, !noalias !468
  %i.am = load i32, ptr %i.o, align 8, !tbaa !87, !noalias !468
  %i.an = load ptr, ptr %10, align 8, !tbaa !34, !noalias !468
  %i.ao = load i64, ptr %i.p, align 8, !tbaa !35, !noalias !468
  %i.ap = sext i32 %i.ak to i64
  %i.aq = mul i64 %i.ao, %i.ap
  %i.ar = load i64, ptr %i.q, align 8, !tbaa !76, !noalias !468 ; 2 uses
...
_ZN4ncnn3MatD2Ev.exit:                            ; preds = %_ZN4ncnn3MatD2Ev.exit34, %_ZN4ncnn3Mat7channelEi.exit49
  ...
  %i.bm = load i32, ptr %i.b, align 4, !tbaa !78
...
.preheader12.lr.ph.i:                             ; preds = %bb.d
  %i.ci = load i32, ptr %9, align 4, !tbaa !78    ; 3 uses
...
vector.body170:                                   ; preds = %vector.body170, %vector.ph168
  ...
  %i.dt = load float, ptr %i.dp, align 4, !tbaa !53, !alias.scope !469 ; 2 uses
  %i.du = load float, ptr %i.dq, align 4, !tbaa !53, !alias.scope !469 ; 2 uses
  %i.dv = load float, ptr %i.dr, align 4, !tbaa !53, !alias.scope !469 ; 2 uses
  %i.dw = load float, ptr %i.ds, align 4, !tbaa !53, !alias.scope !469 ; 2 uses
  ...
  %i.ef = load float, ptr %i.eb, align 4, !tbaa !53, !alias.scope !469
  %i.eg = load float, ptr %i.ec, align 4, !tbaa !53, !alias.scope !469
  %i.eh = load float, ptr %i.ed, align 4, !tbaa !53, !alias.scope !469
  %i.ei = load float, ptr %i.ee, align 4, !tbaa !53, !alias.scope !469
  ...
  %i.er = load float, ptr %i.en, align 4, !tbaa !53, !alias.scope !469 ; 2 uses
  %i.es = load float, ptr %i.eo, align 4, !tbaa !53, !alias.scope !469 ; 2 uses
  %i.et = load float, ptr %i.ep, align 4, !tbaa !53, !alias.scope !469 ; 2 uses
  %i.eu = load float, ptr %i.eq, align 4, !tbaa !53, !alias.scope !469 ; 2 uses
  ...
  %i.fy = load float, ptr %i.fu, align 4, !tbaa !53, !alias.scope !469
  %i.fz = load float, ptr %i.fv, align 4, !tbaa !53, !alias.scope !469
  %i.ga = load float, ptr %i.fw, align 4, !tbaa !53, !alias.scope !469
  %i.gb = load float, ptr %i.fx, align 4, !tbaa !53, !alias.scope !469
  ...
  %i.gk = load float, ptr %i.gg, align 4, !tbaa !53, !alias.scope !469
  %i.gl = load float, ptr %i.gh, align 4, !tbaa !53, !alias.scope !469
  %i.gm = load float, ptr %i.gi, align 4, !tbaa !53, !alias.scope !469
  %i.gn = load float, ptr %i.gj, align 4, !tbaa !53, !alias.scope !469
...
begin_hunk_1_@_ZN4ncnnL37conv3x3s1_winograd63_transform_kernelERKNS_3MatERS0_iiRKNS_6OptionE.omp_outlined:bb.a
  %i.ale = insertelement <4 x float> %i.ald, float %.neg4.7.i, i64 2
  %i.alf = insertelement <4 x float> %i.ale, float %i.aia, i64 3
  %i.alg = fadd reassoc nsz arcp contract afn <4 x float> %i.alf, %i.aid ; 3 uses
  %i.alh = fadd fast <2 x float> %i.ahw, %i.aki   ; 2 uses
  %i.ali = shufflevector <2 x float> %i.alh, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 0> ; 2 uses
  %i.alj = fmul fast <4 x float> %i.ali, <float f0xBE638E39, float f0x3E638E39, float f0x3CB60B61, float f0x3C360B61> ; 3 uses
  %i.alk = shufflevector <4 x float> %i.alg, <4 x float> poison, <4 x i32> zeroinitializer
  %i.all = fmul fast <4 x float> %i.alk, <float f0xBE638E39, float f0xBE638E39, float f0x3D360B61, float f0x3D360B61>
  %i.alm = shufflevector <4 x float> %i.alj, <4 x float> poison, <4 x i32> <i32 1, i32 0, i32 3, i32 2> ; 2 uses
  %i.aln = fsub fast <4 x float> %i.alj, %i.alm
  %i.alo = fadd fast <4 x float> %i.alj, %i.alm
  %i.alp = shufflevector <4 x float> %i.aln, <4 x float> %i.alo, <4 x i32> <i32 0, i32 5, i32 6, i32 3>
  %i.alq = fadd fast <4 x float> %i.alp, %i.all
  %i.alr = extractelement <2 x float> %i.alh, i64 0
  store float %i.alr, ptr %i.ahu, align 4, !tbaa !53
  store <4 x float> %i.alq, ptr %i.ahv, align 4, !tbaa !53
  %i.als = shufflevector <4 x float> %i.ali, <4 x float> %i.alg, <3 x i32> <i32 0, i32 1, i32 4>
  %i.alt = fmul fast <3 x float> %i.als, <float f0x3CB60B61, float f0x3C360B61, float f0x3BB60B61> ; 3 uses
  %i.alu = extractelement <3 x float> %i.alt, i64 0 ; 2 uses
  %i.alv = extractelement <3 x float> %i.alt, i64 1 ; 2 uses
  %i.alw = fsub fast float %i.alu, %i.alv
  %i.alx = fadd fast float %i.alv, %i.alu
  %i.aly = insertelement <2 x float> poison, float %i.alx, i64 0
  %i.alz = insertelement <2 x float> %i.aly, float %i.alw, i64 1
  %i.ama = shufflevector <3 x float> %i.alt, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %i.amb = fadd fast <2 x float> %i.alz, %i.ama
  store <2 x float> %i.amb, ptr %i.ahx, align 4, !tbaa !53
  store <4 x float> %i.alg, ptr %i.ahy, align 4, !tbaa !53
  %i.amc = getelementptr inbounds nuw i8, ptr %.118.i, i64 236
  %i.amd = insertelement <4 x float> poison, float %i.aey, i64 0
  %i.ame = insertelement <4 x float> %i.amd, float %i.aik, i64 1
  ...
  %i.amm = shufflevector <4 x float> %i.aml, <4 x float> %i.aid, <4 x i32> <i32 0, i32 0, i32 4, i32 4>
  %i.amn = fadd fast <4 x float> %i.amk, %i.amm
  store <4 x float> %i.amn, ptr %i.amc, align 4, !tbaa !53
  %i.amo = getelementptr inbounds nuw i8, ptr %.118.i, i64 252
  store float %i.act, ptr %i.amo, align 4, !tbaa !53
...
.lr.ph.us.i.new:                                  ; preds = %.lr.ph.us.i, %.lr.ph.us.i.new
  ...
  %i.aoj = load float, ptr %i.aoi, align 4, !tbaa !53
  %i.aok = getelementptr inbounds nuw i8, ptr %.1702.us.i, i64 28
  store float %i.aoj, ptr %i.aok, align 4, !tbaa !53
...
.epil.preheader:                                  ; preds = %._crit_edge.us.i.unr-lcssa, %.lr.ph.us.i
  ...
  %i.aon = load float, ptr %.0673.us.i.epil.init, align 4, !tbaa !53
  store float %i.aon, ptr %.1702.us.i.epil.init, align 4, !tbaa !53
  ...
  store float %i.aop, ptr %i.aoq, align 4, !tbaa !53
  ...
  %i.aov = load float, ptr %i.aou, align 4, !tbaa !53
  %i.aow = getelementptr inbounds nuw i8, ptr %.1702.us.i.epil.init, i64 12
  store float %i.aov, ptr %i.aow, align 4, !tbaa !53
...
._crit_edge.us.i:                                 ; preds = %._crit_edge.us.i.unr-lcssa, %.epil.preheader
  ...
  br i1 %i.aoy, label %.lr.ph.us.i, label %.preheader1.loopexit.i, !llvm.loop !3
...
.lr.ph17.split.preheader.i:                       ; preds = %.lr.ph17.i, %.preheader1.thread.i
  ...
  %.068.lcssa6367.i = phi i32 [ %.068.lcssa.i, %.lr.ph17.i ], [ %i.az, %.preheader1.thread.i ] ; 3 uses
  %i.apc = add i32 %.068.lcssa6367.i, 3
  %smax.i = call i32 @llvm.smax.i32(i32 %.sroa.speculated82, i32 %i.apc)
  %reass.sub = sub i32 %smax.i, %.068.lcssa6367.i
  %i.apd = and i32 %reass.sub, -2
  %i.ape = add i32 %.068.lcssa6367.i, %i.apd
...
.lr.ph.us22.i.new:                                ; preds = %.lr.ph.us22.i, %.lr.ph.us22.i.new
  ...
  %i.aph = load float, ptr %.06513.us.i, align 4, !tbaa !53
  store float %i.aph, ptr %.312.us.i, align 4, !tbaa !53
  %i.api = getelementptr inbounds nuw [4 x i8], ptr %.06513.us.i, i64 %i.amx
  %i.apj = load float, ptr %i.api, align 4, !tbaa !53
  %i.apk = getelementptr inbounds nuw i8, ptr %.312.us.i, i64 4
  store float %i.apj, ptr %i.apk, align 4, !tbaa !53
  %i.apl = getelementptr inbounds nuw i8, ptr %.06513.us.i, i64 256 ; 2 uses
  %i.apm = getelementptr inbounds nuw i8, ptr %.312.us.i, i64 8
  %i.apn = load float, ptr %i.apl, align 4, !tbaa !53
  store float %i.apn, ptr %i.apm, align 4, !tbaa !53
  %i.apo = getelementptr inbounds nuw [4 x i8], ptr %i.apl, i64 %i.amx
  %i.app = load float, ptr %i.apo, align 4, !tbaa !53
  ...
  %i.apt = load float, ptr %i.apr, align 4, !tbaa !53
  store float %i.apt, ptr %i.aps, align 4, !tbaa !53
  %i.apu = getelementptr inbounds nuw [4 x i8], ptr %i.apr, i64 %i.amx
  %i.apv = load float, ptr %i.apu, align 4, !tbaa !53
  ...
  %i.apz = load float, ptr %i.apx, align 4, !tbaa !53
  store float %i.apz, ptr %i.apy, align 4, !tbaa !53
  %i.aqa = getelementptr inbounds nuw [4 x i8], ptr %i.apx, i64 %i.amx
  %i.aqb = load float, ptr %i.aqa, align 4, !tbaa !53
  %i.aqc = getelementptr inbounds nuw i8, ptr %.312.us.i, i64 28
  store float %i.aqb, ptr %i.aqc, align 4, !tbaa !53
  ...
  br i1 %niter197.ncmp.3, label %._crit_edge.us23.i.unr-lcssa, label %.lr.ph.us22.i.new, !llvm.loop !4
...
bb.f:                                             ; preds = %bb.f, %.epil.preheader191
  ...
  %i.aqf = load float, ptr %.06513.us.i.epil, align 4, !tbaa !53
  store float %i.aqf, ptr %.312.us.i.epil, align 4, !tbaa !53
  %i.aqg = getelementptr inbounds nuw [4 x i8], ptr %.06513.us.i.epil, i64 %i.amx
  %i.aqh = load float, ptr %i.aqg, align 4, !tbaa !53
  ...
  br i1 %epil.iter.cmp.not, label %._crit_edge.us23.i, label %bb.f, !llvm.loop !459
...
._crit_edge.us23.i:                               ; preds = %bb.f, %._crit_edge.us23.i.unr-lcssa
  ...
  br i1 %i.aql, label %.lr.ph.us22.i, label %.preheader.loopexit.i, !llvm.loop !5
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ard = load float, ptr %next.gep, align 4, !tbaa !53, !alias.scope !471
  %i.are = load float, ptr %next.gep142, align 4, !tbaa !53, !alias.scope !471
  %i.arf = load float, ptr %next.gep143, align 4, !tbaa !53, !alias.scope !471
  %i.arg = load float, ptr %next.gep144, align 4, !tbaa !53, !alias.scope !471
  ...
  %i.arl = load float, ptr %next.gep145, align 4, !tbaa !53, !alias.scope !471
  %i.arm = load float, ptr %next.gep146, align 4, !tbaa !53, !alias.scope !471
  %i.arn = load float, ptr %next.gep147, align 4, !tbaa !53, !alias.scope !471
  %i.aro = load float, ptr %next.gep148, align 4, !tbaa !53, !alias.scope !471
  ...
  store <4 x float> %i.ark, ptr %next.gep149, align 4, !tbaa !53, !alias.scope !472, !noalias !471
  store <4 x float> %i.ars, ptr %i.art, align 4, !tbaa !53, !alias.scope !472, !noalias !471
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.aru = icmp eq i64 %index.next, %n.vec
  br i1 %i.aru, label %middle.block, label %vector.body, !llvm.loop !463
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  ...
  %i.arw = load float, ptr %.06328.i.prol, align 4, !tbaa !53
  store float %i.arw, ptr %.527.i.prol, align 4, !tbaa !53
  ...
  br i1 %prol.iter.cmp.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol, !llvm.loop !464
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  br i1 %exitcond49.not.i.7, label %._crit_edge.i53, label %scalar.ph, !llvm.loop !465
...
._crit_edge.i53:                                  ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  ...
  br i1 %exitcond53.not.i, label %._crit_edge33.split.i, label %.lr.ph.i, !llvm.loop !6
...
._crit_edge33.split.i:                            ; preds = %._crit_edge.i53, %.lr.ph32.i, %.preheader.i
  ...
  br i1 %exitcond58.not.i, label %_ZN4ncnn3MatD2Ev.exit34, label %bb.e, !llvm.loop !7
...
_ZN4ncnn3MatD2Ev.exit34:                          ; preds = %._crit_edge33.split.i
  ...
  br i1 %i.atb, label %bb.d, label %_ZN4ncnn3MatD2Ev.exit, !llvm.loop !466
...
; Function Attrs: nounwind
declare !callback !112 void @__kmpc_fork_call(ptr, i32, ptr, ...) local_unnamed_addr #12
...
_ZN4ncnn3Mat7channelEi.exit49:                    ; preds = %bb.c
  %i.w = load ptr, ptr %4, align 8, !tbaa !34, !noalias !491 ; 2 uses
  %i.x = load i64, ptr %i.l, align 8, !tbaa !35, !noalias !491
  %i.y = sext i32 %i.v to i64
  %i.z = mul i64 %i.x, %i.y
  %i.aa = load i64, ptr %i.m, align 8, !tbaa !76, !noalias !491
  %i.ab = mul i64 %i.z, %i.aa                     ; 2 uses
  %i.ac = getelementptr i8, ptr %i.w, i64 %i.ab   ; 4 uses
  %i.ad = load i32, ptr %5, align 4, !tbaa !78    ; 6 uses
  %i.ae = icmp sgt i32 %i.ad, 0
...
.lr.ph:                                           ; preds = %_ZN4ncnn3Mat7channelEi.exit49
  ...
  %i.ak = sdiv i32 %i.u, %i.ah
  %i.al = load i32, ptr %i.n, align 4, !tbaa !86, !noalias !492
  %i.am = load i32, ptr %i.o, align 8, !tbaa !87, !noalias !492
  %i.an = load ptr, ptr %10, align 8, !tbaa !34, !noalias !492
  %i.ao = load i64, ptr %i.p, align 8, !tbaa !35, !noalias !492
  %i.ap = sext i32 %i.ak to i64
  %i.aq = mul i64 %i.ao, %i.ap
  %i.ar = load i64, ptr %i.q, align 8, !tbaa !76, !noalias !492 ; 2 uses
  %i.as = mul i64 %i.aq, %i.ar
  %i.at = getelementptr inbounds nuw i8, ptr %i.an, i64 %i.as
  %i.au = sext i32 %i.al to i64
  %i.av = sext i32 %i.am to i64
...
vector.body178:                                   ; preds = %vector.body178, %vector.ph176
  ...
  %i.dr = getelementptr inbounds i8, ptr %i.ct, i64 %i.dn ; 9 uses
  %i.ds = getelementptr inbounds i8, ptr %i.ct, i64 %i.do ; 9 uses
  %i.dt = load float, ptr %i.dp, align 4, !tbaa !53, !alias.scope !493 ; 2 uses
  %i.du = load float, ptr %i.dr, align 4, !tbaa !53, !alias.scope !493 ; 2 uses
  %i.dv = load float, ptr %i.ds, align 4, !tbaa !53, !alias.scope !493 ; 2 uses
  ...
  %i.ea = load float, ptr %i.dw, align 4, !tbaa !53, !alias.scope !493
  %i.eb = load float, ptr %i.dx, align 4, !tbaa !53, !alias.scope !493
  %i.ec = load float, ptr %i.dy, align 4, !tbaa !53, !alias.scope !493
  %i.ed = load float, ptr %i.dz, align 4, !tbaa !53, !alias.scope !493
  ...
  %i.em = load float, ptr %i.ei, align 4, !tbaa !53, !alias.scope !493 ; 2 uses
  %i.en = load float, ptr %i.ej, align 4, !tbaa !53, !alias.scope !493 ; 2 uses
  %i.eo = load float, ptr %i.ek, align 4, !tbaa !53, !alias.scope !493 ; 2 uses
  %i.ep = load float, ptr %i.el, align 4, !tbaa !53, !alias.scope !493 ; 2 uses
  ...
  %i.fc = load float, ptr %i.ey, align 4, !tbaa !53, !alias.scope !493
  %i.fd = load float, ptr %i.ez, align 4, !tbaa !53, !alias.scope !493
  %i.fe = load float, ptr %i.fa, align 4, !tbaa !53, !alias.scope !493
  %i.ff = load float, ptr %i.fb, align 4, !tbaa !53, !alias.scope !493
  ...
  %i.fo = load float, ptr %i.fk, align 4, !tbaa !53, !alias.scope !493
  %i.fp = load float, ptr %i.fl, align 4, !tbaa !53, !alias.scope !493
  %i.fq = load float, ptr %i.fm, align 4, !tbaa !53, !alias.scope !493
  %i.fr = load float, ptr %i.fn, align 4, !tbaa !53, !alias.scope !493
  ...
  %i.ga = load float, ptr %i.fw, align 4, !tbaa !53, !alias.scope !493
  %i.gb = load float, ptr %i.fx, align 4, !tbaa !53, !alias.scope !493
  %i.gc = load float, ptr %i.fy, align 4, !tbaa !53, !alias.scope !493
  %i.gd = load float, ptr %i.fz, align 4, !tbaa !53, !alias.scope !493
...
begin_hunk_2_@_ZN4ncnnL37conv3x3s1_winograd43_transform_kernelERKNS_3MatERS0_iiRKNS_6OptionE.omp_outlined:bb.a
  ...
  store float %i.yr, ptr %i.xq, align 4, !tbaa !53
  %i.ys = extractelement <2 x float> %i.yp, i64 1
  %i.yt = fadd fast float %i.ys, %i.xt
  %i.yu = extractelement <2 x float> %i.xz, i64 0
  store float %i.yu, ptr %i.xs, align 4, !tbaa !53
  store float %i.yg, ptr %i.xu, align 4, !tbaa !53
  store <2 x float> %i.ym, ptr %i.xv, align 4, !tbaa !53
  %i.yv = getelementptr inbounds nuw i8, ptr %.116.i, i64 112
  store float %i.yt, ptr %i.yv, align 4, !tbaa !53
  %i.yw = getelementptr inbounds nuw i8, ptr %.116.i, i64 116
  store float %i.to, ptr %i.yw, align 4, !tbaa !53
  ...
  store float %i.ub, ptr %i.yx, align 4, !tbaa !53
  %i.zk = getelementptr inbounds nuw i8, ptr %.116.i, i64 124
  store float %i.zb, ptr %i.zk, align 4, !tbaa !53
  %i.zl = getelementptr inbounds nuw i8, ptr %.116.i, i64 128
  store float %i.zd, ptr %i.zl, align 4, !tbaa !53
  %i.zm = getelementptr inbounds nuw i8, ptr %.116.i, i64 132
  store float %i.zh, ptr %i.zm, align 4, !tbaa !53
  %i.zn = getelementptr inbounds nuw i8, ptr %.116.i, i64 136
  store float %i.zj, ptr %i.zn, align 4, !tbaa !53
  %i.zo = getelementptr inbounds nuw i8, ptr %.116.i, i64 140
  store float %i.ta, ptr %i.zo, align 4, !tbaa !53
  %i.zp = getelementptr inbounds nuw i8, ptr %.116.i, i64 144 ; 2 uses
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %wide.trip.count.i
  br i1 %exitcond.not.i, label %._crit_edge.i, label %.preheader.preheader.i, !llvm.loop !481
...
._crit_edge.i:                                    ; preds = %.preheader.preheader.i, %middle.block185
  ...
  br i1 %exitcond27.not.i, label %_ZN4ncnnL42conv3x3s1_winograd43_transform_kernel_tileERKNS_3MatERS0_iiiii.exit, label %.preheader10.i, !llvm.loop !482
...
.lr.ph.us.i.new:                                  ; preds = %.lr.ph.us.i, %.lr.ph.us.i.new
  ...
  %niter = phi i32 [ %niter.next.1, %.lr.ph.us.i.new ], [ 0, %.lr.ph.us.i ]
  %i.aap = load float, ptr %.0673.us.i, align 4, !tbaa !53
  store float %i.aap, ptr %.1702.us.i, align 4, !tbaa !53
...
.epil.preheader:                                  ; preds = %._crit_edge.us.i.unr-lcssa, %.lr.ph.us.i
  ...
  %i.abn = load float, ptr %.0673.us.i.epil.init, align 4, !tbaa !53
  store float %i.abn, ptr %.1702.us.i.epil.init, align 4, !tbaa !53
  %i.abo = getelementptr inbounds nuw [4 x i8], ptr %.0673.us.i.epil.init, i64 %i.zx
  %i.abp = load float, ptr %i.abo, align 4, !tbaa !53
...
._crit_edge.us.i:                                 ; preds = %._crit_edge.us.i.unr-lcssa, %.epil.preheader
  ...
  br i1 %i.aby, label %.lr.ph.us.i, label %.preheader1.loopexit.i, !llvm.loop !3
...
.lr.ph17.split.preheader.i:                       ; preds = %.lr.ph17.i, %.preheader1.thread.i
  ...
  %.068.lcssa6367.i = phi i32 [ %.068.lcssa.i, %.lr.ph17.i ], [ %i.az, %.preheader1.thread.i ] ; 3 uses
  %i.acc = add i32 %.068.lcssa6367.i, 3
  %smax.i = call i32 @llvm.smax.i32(i32 %.sroa.speculated82, i32 %i.acc)
  %reass.sub = sub i32 %smax.i, %.068.lcssa6367.i
  %i.acd = and i32 %reass.sub, -2
  %i.ace = add i32 %.068.lcssa6367.i, %i.acd
  br label %.preheader.i
...
.lr.ph.us22.i.new:                                ; preds = %.lr.ph.us22.i, %.lr.ph.us22.i.new
  ...
  br i1 %niter207.ncmp.3, label %._crit_edge.us23.i.unr-lcssa, label %.lr.ph.us22.i.new, !llvm.loop !4
...
bb.f:                                             ; preds = %bb.f, %.epil.preheader201
  ...
  %i.adf = load float, ptr %.06513.us.i.epil, align 4, !tbaa !53
  store float %i.adf, ptr %.312.us.i.epil, align 4, !tbaa !53
  %i.adg = getelementptr inbounds nuw [4 x i8], ptr %.06513.us.i.epil, i64 %i.zx
  %i.adh = load float, ptr %i.adg, align 4, !tbaa !53
  %i.adi = getelementptr inbounds nuw i8, ptr %.312.us.i.epil, i64 4
  store float %i.adh, ptr %i.adi, align 4, !tbaa !53
  ...
  br i1 %epil.iter.cmp.not, label %._crit_edge.us23.i, label %bb.f, !llvm.loop !483
...
._crit_edge.us23.i:                               ; preds = %bb.f, %._crit_edge.us23.i.unr-lcssa
  ...
  br i1 %i.adl, label %.lr.ph.us22.i, label %.preheader.loopexit.i, !llvm.loop !5
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.aed = load float, ptr %next.gep, align 4, !tbaa !53, !alias.scope !495
  %i.aee = load float, ptr %next.gep150, align 4, !tbaa !53, !alias.scope !495
  %i.aef = load float, ptr %next.gep151, align 4, !tbaa !53, !alias.scope !495
  %i.aeg = load float, ptr %next.gep152, align 4, !tbaa !53, !alias.scope !495
  ...
  %i.ael = load float, ptr %next.gep153, align 4, !tbaa !53, !alias.scope !495
  %i.aem = load float, ptr %next.gep154, align 4, !tbaa !53, !alias.scope !495
  %i.aen = load float, ptr %next.gep155, align 4, !tbaa !53, !alias.scope !495
  %i.aeo = load float, ptr %next.gep156, align 4, !tbaa !53, !alias.scope !495
  ...
  store <4 x float> %i.aek, ptr %next.gep157, align 4, !tbaa !53, !alias.scope !496, !noalias !495
  store <4 x float> %i.aes, ptr %i.aet, align 4, !tbaa !53, !alias.scope !496, !noalias !495
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.aeu = icmp eq i64 %index.next, %n.vec
  br i1 %i.aeu, label %middle.block, label %vector.body, !llvm.loop !487
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  ...
  %prol.iter = phi i32 [ %prol.iter.next, %scalar.ph.prol ], [ 0, %scalar.ph.preheader ]
  %i.aew = load float, ptr %.06328.i.prol, align 4, !tbaa !53
  store float %i.aew, ptr %.527.i.prol, align 4, !tbaa !53
  ...
  br i1 %prol.iter.cmp.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol, !llvm.loop !488
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  %i.afc = load float, ptr %.06328.i, align 4, !tbaa !53
  store float %i.afc, ptr %.527.i, align 4, !tbaa !53
  ...
  store float %i.aff, ptr %i.afe, align 4, !tbaa !53
  %i.afg = getelementptr inbounds nuw i8, ptr %.06328.i, i64 288
  %i.afh = getelementptr inbounds nuw i8, ptr %.527.i, i64 8
  %i.afi = load float, ptr %i.afg, align 4, !tbaa !53
  store float %i.afi, ptr %i.afh, align 4, !tbaa !53
  ...
  br i1 %exitcond49.not.i.7, label %._crit_edge.i53, label %scalar.ph, !llvm.loop !489
...
_ZN4ncnn3MatD2Ev.exit34:                          ; preds = %._crit_edge33.split.i
  ...
  br i1 %i.agb, label %bb.d, label %_ZN4ncnn3MatD2Ev.exit, !llvm.loop !490
...
_ZN4ncnn3Mat7channelEi.exit49:                    ; preds = %bb.c
  %i.w = load ptr, ptr %4, align 8, !tbaa !34, !noalias !515 ; 2 uses
  %i.x = load i64, ptr %i.l, align 8, !tbaa !35, !noalias !515
  %i.y = sext i32 %i.v to i64
  %i.z = mul i64 %i.x, %i.y
  %i.aa = load i64, ptr %i.m, align 8, !tbaa !76, !noalias !515
  %i.ab = mul i64 %i.z, %i.aa                     ; 2 uses
  %i.ac = getelementptr i8, ptr %i.w, i64 %i.ab   ; 4 uses
  %i.ad = load i32, ptr %5, align 4, !tbaa !78    ; 6 uses
  %i.ae = icmp sgt i32 %i.ad, 0
...
.lr.ph:                                           ; preds = %_ZN4ncnn3Mat7channelEi.exit49
  ...
  %i.ak = sdiv i32 %i.u, %i.ah
  %i.al = load i32, ptr %i.n, align 4, !tbaa !86, !noalias !516
  %i.am = load i32, ptr %i.o, align 8, !tbaa !87, !noalias !516
  %i.an = load ptr, ptr %10, align 8, !tbaa !34, !noalias !516
  %i.ao = load i64, ptr %i.p, align 8, !tbaa !35, !noalias !516
  %i.ap = sext i32 %i.ak to i64
  %i.aq = mul i64 %i.ao, %i.ap
  %i.ar = load i64, ptr %i.q, align 8, !tbaa !76, !noalias !516 ; 2 uses
  %i.as = mul i64 %i.aq, %i.ar
  %i.at = getelementptr inbounds nuw i8, ptr %i.an, i64 %i.as
  %i.au = sext i32 %i.al to i64
  %i.av = sext i32 %i.am to i64
...
bb.d:                                             ; preds = %.lr.ph, %_ZN4ncnn3MatD2Ev.exit34
  ...
  %i.bo = mul i32 %i.ai, %i.bn
  %i.bp = sub i32 %i.ad, %i.bo
  %smin166 = call i32 @llvm.smin.i32(i32 %i.ai, i32 %i.bp)
  %i.bq = add i32 %smin166, -1                    ; 2 uses
  %i.br = mul i32 %i.ai, %indvar
  %i.bs = sub i32 %i.ad, %i.br
...
vector.body151:                                   ; preds = %vector.body151, %vector.ph149
  ...
  %i.dr = getelementptr inbounds i8, ptr %i.ct, i64 %i.dn ; 9 uses
  %i.ds = getelementptr inbounds i8, ptr %i.ct, i64 %i.do ; 9 uses
  %i.dt = load float, ptr %i.dp, align 4, !tbaa !53, !alias.scope !517 ; 2 uses
  %i.du = load float, ptr %i.dr, align 4, !tbaa !53, !alias.scope !517 ; 2 uses
  %i.dv = load float, ptr %i.ds, align 4, !tbaa !53, !alias.scope !517 ; 2 uses
  %i.dw = getelementptr inbounds nuw i8, ptr %i.dp, i64 4
  %i.dx = getelementptr inbounds nuw i8, ptr %i.dq, i64 4
  %i.dy = getelementptr inbounds nuw i8, ptr %i.dr, i64 4
  %i.dz = getelementptr inbounds nuw i8, ptr %i.ds, i64 4
  %i.ea = load float, ptr %i.dw, align 4, !tbaa !53, !alias.scope !517
  %i.eb = load float, ptr %i.dx, align 4, !tbaa !53, !alias.scope !517
  %i.ec = load float, ptr %i.dy, align 4, !tbaa !53, !alias.scope !517
  %i.ed = load float, ptr %i.dz, align 4, !tbaa !53, !alias.scope !517
  %i.ee = insertelement <4 x float> poison, float %i.ea, i64 0
  %i.ef = insertelement <4 x float> %i.ee, float %i.eb, i64 1
  %i.eg = insertelement <4 x float> %i.ef, float %i.ec, i64 2
  ...
  %i.ek = getelementptr inbounds nuw i8, ptr %i.dr, i64 8
  %i.el = getelementptr inbounds nuw i8, ptr %i.ds, i64 8
  %i.em = load float, ptr %i.ei, align 4, !tbaa !53, !alias.scope !517 ; 2 uses
  %i.en = load float, ptr %i.ej, align 4, !tbaa !53, !alias.scope !517 ; 2 uses
  %i.eo = load float, ptr %i.ek, align 4, !tbaa !53, !alias.scope !517 ; 2 uses
  %i.ep = load float, ptr %i.el, align 4, !tbaa !53, !alias.scope !517 ; 2 uses
  %i.eq = insertelement <4 x float> poison, float %i.em, i64 0
  %i.er = insertelement <4 x float> %i.eq, float %i.en, i64 1
  %i.es = insertelement <4 x float> %i.er, float %i.eo, i64 2
  ...
  %i.fa = load float, ptr %i.ew, align 4, !tbaa !53, !alias.scope !517
  %i.fb = load float, ptr %i.ex, align 4, !tbaa !53, !alias.scope !517
  %i.fc = load float, ptr %i.ey, align 4, !tbaa !53, !alias.scope !517
  %i.fd = load float, ptr %i.ez, align 4, !tbaa !53, !alias.scope !517
  ...
  %i.fm = load float, ptr %i.fi, align 4, !tbaa !53, !alias.scope !517
  %i.fn = load float, ptr %i.fj, align 4, !tbaa !53, !alias.scope !517
  %i.fo = load float, ptr %i.fk, align 4, !tbaa !53, !alias.scope !517
  %i.fp = load float, ptr %i.fl, align 4, !tbaa !53, !alias.scope !517
  ...
  %i.fy = load float, ptr %i.fu, align 4, !tbaa !53, !alias.scope !517
  %i.fz = load float, ptr %i.fv, align 4, !tbaa !53, !alias.scope !517
  %i.ga = load float, ptr %i.fw, align 4, !tbaa !53, !alias.scope !517
  %i.gb = load float, ptr %i.fx, align 4, !tbaa !53, !alias.scope !517
  %i.gc = insertelement <4 x float> poison, float %i.fy, i64 0
  %i.gd = insertelement <4 x float> %i.gc, float %i.fz, i64 1
  %i.ge = insertelement <4 x float> %i.gd, float %i.ga, i64 2
...
begin_hunk_3_@_ZN4ncnnL37conv3x3s1_winograd23_transform_kernelERKNS_3MatERS0_iiRKNS_6OptionE.omp_outlined:bb.a
  store float %i.nv, ptr %i.mn, align 4, !tbaa !53
  %i.oc = extractelement <2 x float> %i.nf, i64 0
  store float %i.oc, ptr %i.mo, align 4, !tbaa !53
  %i.od = fmul fast <3 x float> %i.oa, splat (float 5.000000e-01) ; 3 uses
  %i.oe = extractelement <3 x float> %i.od, i64 0 ; 2 uses
  %i.of = extractelement <3 x float> %i.od, i64 1 ; 2 uses
  %i.og = fsub fast float %i.oe, %i.of
  %i.oh = fadd fast float %i.of, %i.oe
  %i.oi = insertelement <2 x float> poison, float %i.oh, i64 0
  %i.oj = insertelement <2 x float> %i.oi, float %i.og, i64 1
  %i.ok = shufflevector <3 x float> %i.od, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %i.ol = fadd fast <2 x float> %i.oj, %i.ok
  %i.om = extractelement <3 x float> %i.oa, i64 0
  store float %i.om, ptr %i.mp, align 4, !tbaa !53
  store <2 x float> %i.ol, ptr %i.mq, align 4, !tbaa !53
  %i.on = extractelement <3 x float> %i.oa, i64 2
  store float %i.on, ptr %i.mr, align 4, !tbaa !53
  %i.oo = fadd fast float %i.np, %i.nw
  %i.op = shufflevector <3 x float> %i.nj, <3 x float> %i.ny, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.oq = shufflevector <3 x float> %i.nm, <3 x float> %i.ny, <4 x i32> <i32 0, i32 1, i32 2, i32 4>
  %i.or = fsub fast <4 x float> %i.op, %i.oq      ; 3 uses
  %i.os = extractelement <4 x float> %i.or, i64 1
  %i.ot = fadd fast float %i.os, %i.np
  %i.ou = fmul fast float %i.ot, 5.000000e-01     ; 2 uses
  %i.ov = extractelement <4 x float> %i.or, i64 0
  %i.ow = fadd fast float %i.ov, %i.nw            ; 2 uses
  %i.ox = fmul fast float %i.ow, 5.000000e-01     ; 2 uses
  %i.oy = fadd fast float %i.ou, %i.ox
  %i.oz = shufflevector <4 x float> %i.or, <4 x float> poison, <4 x i32> <i32 2, i32 poison, i32 poison, i32 3>
  %i.pa = insertelement <4 x float> %i.oz, float %i.mw, i64 1
  %i.pb = insertelement <4 x float> %i.pa, float %i.oo, i64 2
  %i.pc = fadd reassoc nsz arcp contract afn <4 x float> %i.pb, %i.nc ; 2 uses
  %i.pd = extractelement <4 x float> %i.pc, i64 0
  %i.pe = fmul fast float %i.pd, 5.000000e-01     ; 2 uses
  %i.pf = fadd fast float %i.oy, %i.pe
  %i.pg = fsub fast float %i.ox, %i.ou
  %i.ph = fadd fast float %i.pg, %i.pe
  store float %i.ow, ptr %i.ms, align 4, !tbaa !53
  store float %i.pf, ptr %i.mt, align 4, !tbaa !53
  store float %i.ph, ptr %i.mu, align 4, !tbaa !53
  store <4 x float> %i.pc, ptr %i.mv, align 4, !tbaa !53
  %i.pi = getelementptr inbounds nuw i8, ptr %.110.i, i64 60
  store float %i.ml, ptr %i.pi, align 4, !tbaa !53
  %i.pj = getelementptr inbounds nuw i8, ptr %.110.i, i64 64 ; 2 uses
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %wide.trip.count.i
  br i1 %exitcond.not.i, label %._crit_edge.i, label %.preheader.preheader.i, !llvm.loop !505

._crit_edge.i:                                    ; preds = %.preheader.preheader.i, %middle.block158
  %.lcssa = phi ptr [ %i.cz, %middle.block158 ], [ %i.pj, %.preheader.preheader.i ]
  ...
  br i1 %exitcond21.not.i, label %_ZN4ncnnL42conv3x3s1_winograd23_transform_kernel_tileERKNS_3MatERS0_iiiii.exit, label %.preheader4.i, !llvm.loop !506
...
_ZN4ncnnL42conv3x3s1_winograd23_transform_kernel_tileERKNS_3MatERS0_iiiii.exit: ; preds = %._crit_edge.i, %bb.d, %.preheader4.lr.ph.i
  %i.pk = trunc nsw i64 %indvars.iv to i32
  %i.pl = sdiv i32 %i.pk, %i.ai
  %i.pm = sext i32 %i.pl to i64
  %i.pn = mul i64 %i.ax, %i.pm
  %i.po = getelementptr inbounds nuw i8, ptr %i.at, i64 %i.pn
  %i.pp = shl i32 %.sroa.speculated, 4            ; 2 uses
  %i.pq = icmp sgt i32 %.sroa.speculated, 0       ; 3 uses
  %i.pr = sext i32 %i.pp to i64                   ; 11 uses
  %i.ps = shl nsw i32 %.sroa.speculated, 5
  %i.pt = sext i32 %i.ps to i64                   ; 3 uses
  %i.pu = mul nsw i32 %.sroa.speculated, 48
  %i.pv = sext i32 %i.pu to i64                   ; 3 uses
  %i.pw = zext i32 %i.pp to i64
  %i.px = shl nsw i64 %i.pr, 2
  %i.py = getelementptr i8, ptr %i.bk, i64 %i.ce
  %i.pz = getelementptr i8, ptr %i.py, i64 %i.cf
  %xtraiter = and i32 %.sroa.speculated, 1
  %i.qa = icmp eq i32 %i.bq, 0
  %unroll_iter = and i32 %.sroa.speculated, 2147483646
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  %lcmp.mod168 = trunc i32 %.sroa.speculated to i1
  %xtraiter170 = and i32 %.sroa.speculated, 3     ; 3 uses
  %i.qb = icmp ult i32 %i.bq, 3
  %unroll_iter174 = and i32 %.sroa.speculated, 2147483644
  %lcmp.mod171.not = icmp eq i32 %xtraiter170, 0
  %lcmp.mod173 = icmp ne i32 %xtraiter170, 0
  %i.qc = zext nneg i32 %.sroa.speculated to i64  ; 2 uses
  %min.iters.check = icmp ult i32 %.sroa.speculated, 8
  %stride.check = icmp slt i32 %i.cc, 0
  %n.vec = and i64 %i.qc, 2147483640              ; 5 uses
  %i.qd = trunc nuw nsw i64 %n.vec to i32
  %i.qe = shl nuw nsw i64 %n.vec, 6
  %i.qf = shl nuw nsw i64 %n.vec, 2
  %cmp.n = icmp eq i64 %n.vec, %i.qc
  br label %bb.e
...
bb.e:                                             ; preds = %._crit_edge33.split.i, %_ZN4ncnnL42conv3x3s1_winograd23_transform_kernel_tileERKNS_3MatERS0_iiiii.exit
  ...
  %i.qg = shl nuw nsw i64 %indvars.iv54.i, 2
  %scevgep122 = getelementptr i8, ptr %i.pz, i64 %i.qg
  %.reass.i = mul i64 %i.aw, %indvars.iv54.i
  %i.qh = getelementptr inbounds nuw i8, ptr %i.po, i64 %.reass.i ; 4 uses
  br i1 %i.ay, label %.lr.ph8.i, label %.preheader1.i

.lr.ph8.i:                                        ; preds = %bb.e
  %invariant.gep.i = getelementptr [4 x i8], ptr %i.ac, i64 %indvars.iv54.i
  br i1 %i.pq, label %.lr.ph.us.i, label %.preheader1.thread.i

.lr.ph.us.i:                                      ; preds = %.lr.ph8.i, %._crit_edge.us.i
  %indvars.iv.i54 = phi i64 [ %indvars.iv.next.i56, %._crit_edge.us.i ], [ 0, %.lr.ph8.i ] ; 2 uses
  %.0695.us.i = phi ptr [ %.lcssa163, %._crit_edge.us.i ], [ %i.qh, %.lr.ph8.i ] ; 2 uses
  %i.qi = mul nuw nsw i64 %indvars.iv.i54, %i.pw
  %gep.us.i = getelementptr [4 x i8], ptr %invariant.gep.i, i64 %i.qi ; 2 uses
  br i1 %i.qa, label %.epil.preheader, label %.lr.ph.us.i.new

.lr.ph.us.i.new:                                  ; preds = %.lr.ph.us.i, %.lr.ph.us.i.new
  %.0673.us.i = phi ptr [ %i.rf, %.lr.ph.us.i.new ], [ %gep.us.i, %.lr.ph.us.i ] ; 6 uses
  %.1702.us.i = phi ptr [ %i.rg, %.lr.ph.us.i.new ], [ %.0695.us.i, %.lr.ph.us.i ] ; 9 uses
  %niter = phi i32 [ %niter.next.1, %.lr.ph.us.i.new ], [ 0, %.lr.ph.us.i ]
  %i.qj = load float, ptr %.0673.us.i, align 4, !tbaa !53
  store float %i.qj, ptr %.1702.us.i, align 4, !tbaa !53
  %i.qk = getelementptr inbounds nuw [4 x i8], ptr %.0673.us.i, i64 %i.pr
  %i.ql = load float, ptr %i.qk, align 4, !tbaa !53
  %i.qm = getelementptr inbounds nuw i8, ptr %.1702.us.i, i64 4
  store float %i.ql, ptr %i.qm, align 4, !tbaa !53
  %i.qn = getelementptr inbounds nuw [4 x i8], ptr %.0673.us.i, i64 %i.pt
  %i.qo = load float, ptr %i.qn, align 4, !tbaa !53
  %i.qp = getelementptr inbounds nuw i8, ptr %.1702.us.i, i64 8
  store float %i.qo, ptr %i.qp, align 4, !tbaa !53
  %i.qq = getelementptr inbounds nuw [4 x i8], ptr %.0673.us.i, i64 %i.pv
  %i.qr = load float, ptr %i.qq, align 4, !tbaa !53
  %i.qs = getelementptr inbounds nuw i8, ptr %.1702.us.i, i64 12
  store float %i.qr, ptr %i.qs, align 4, !tbaa !53
  %i.qt = getelementptr inbounds nuw i8, ptr %.0673.us.i, i64 64 ; 4 uses
  %i.qu = getelementptr inbounds nuw i8, ptr %.1702.us.i, i64 16
  %i.qv = load float, ptr %i.qt, align 4, !tbaa !53
  store float %i.qv, ptr %i.qu, align 4, !tbaa !53
  %i.qw = getelementptr inbounds nuw [4 x i8], ptr %i.qt, i64 %i.pr
  %i.qx = load float, ptr %i.qw, align 4, !tbaa !53
  %i.qy = getelementptr inbounds nuw i8, ptr %.1702.us.i, i64 20
  store float %i.qx, ptr %i.qy, align 4, !tbaa !53
  %i.qz = getelementptr inbounds nuw [4 x i8], ptr %i.qt, i64 %i.pt
  %i.ra = load float, ptr %i.qz, align 4, !tbaa !53
  %i.rb = getelementptr inbounds nuw i8, ptr %.1702.us.i, i64 24
  store float %i.ra, ptr %i.rb, align 4, !tbaa !53
  %i.rc = getelementptr inbounds nuw [4 x i8], ptr %i.qt, i64 %i.pv
  %i.rd = load float, ptr %i.rc, align 4, !tbaa !53
  %i.re = getelementptr inbounds nuw i8, ptr %.1702.us.i, i64 28
  store float %i.rd, ptr %i.re, align 4, !tbaa !53
  %i.rf = getelementptr inbounds nuw i8, ptr %.0673.us.i, i64 128 ; 2 uses
  %i.rg = getelementptr inbounds nuw i8, ptr %.1702.us.i, i64 32 ; 3 uses
  %niter.next.1 = add i32 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i32 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge.us.i.unr-lcssa, label %.lr.ph.us.i.new, !llvm.loop !2
...
.epil.preheader:                                  ; preds = %._crit_edge.us.i.unr-lcssa, %.lr.ph.us.i
  %.0673.us.i.epil.init = phi ptr [ %gep.us.i, %.lr.ph.us.i ], [ %i.rf, %._crit_edge.us.i.unr-lcssa ] ; 4 uses
  %.1702.us.i.epil.init = phi ptr [ %.0695.us.i, %.lr.ph.us.i ], [ %i.rg, %._crit_edge.us.i.unr-lcssa ] ; 5 uses
  call void @llvm.assume(i1 %lcmp.mod168)
  %i.rh = load float, ptr %.0673.us.i.epil.init, align 4, !tbaa !53
  store float %i.rh, ptr %.1702.us.i.epil.init, align 4, !tbaa !53
  %i.ri = getelementptr inbounds nuw [4 x i8], ptr %.0673.us.i.epil.init, i64 %i.pr
  %i.rj = load float, ptr %i.ri, align 4, !tbaa !53
  %i.rk = getelementptr inbounds nuw i8, ptr %.1702.us.i.epil.init, i64 4
  store float %i.rj, ptr %i.rk, align 4, !tbaa !53
  %i.rl = getelementptr inbounds nuw [4 x i8], ptr %.0673.us.i.epil.init, i64 %i.pt
  %i.rm = load float, ptr %i.rl, align 4, !tbaa !53
  %i.rn = getelementptr inbounds nuw i8, ptr %.1702.us.i.epil.init, i64 8
  store float %i.rm, ptr %i.rn, align 4, !tbaa !53
  %i.ro = getelementptr inbounds nuw [4 x i8], ptr %.0673.us.i.epil.init, i64 %i.pv
  %i.rp = load float, ptr %i.ro, align 4, !tbaa !53
  %i.rq = getelementptr inbounds nuw i8, ptr %.1702.us.i.epil.init, i64 12
  store float %i.rp, ptr %i.rq, align 4, !tbaa !53
  %i.rr = getelementptr inbounds nuw i8, ptr %.1702.us.i.epil.init, i64 16
  br label %._crit_edge.us.i

._crit_edge.us.i:                                 ; preds = %._crit_edge.us.i.unr-lcssa, %.epil.preheader
  %.lcssa163 = phi ptr [ %i.rg, %._crit_edge.us.i.unr-lcssa ], [ %i.rr, %.epil.preheader ] ; 2 uses
  %indvars.iv.next.i56 = add nuw nsw i64 %indvars.iv.i54, 4 ; 3 uses
  %i.rs = icmp slt i64 %indvars.iv.next.i56, %invariant.op.i
  br i1 %i.rs, label %.lr.ph.us.i, label %.preheader1.loopexit.i, !llvm.loop !3

.preheader1.loopexit.i:                           ; preds = %._crit_edge.us.i
  %i.rt = trunc nuw nsw i64 %indvars.iv.next.i56 to i32
  br label %.preheader1.i

.preheader1.i:                                    ; preds = %.preheader1.loopexit.i, %bb.e
  %.069.lcssa.i = phi ptr [ %i.qh, %bb.e ], [ %.lcssa163, %.preheader1.loopexit.i ] ; 3 uses
  %.068.lcssa.i = phi i32 [ 0, %bb.e ], [ %i.rt, %.preheader1.loopexit.i ] ; 4 uses
  %i.ru = or disjoint i32 %.068.lcssa.i, 1
  %i.rv = icmp slt i32 %i.ru, %.sroa.speculated82
  br i1 %i.rv, label %.lr.ph17.i, label %.preheader.i
...
.lr.ph17.i:                                       ; preds = %.preheader1.i
  %invariant.gep20.i = getelementptr [4 x i8], ptr %i.ac, i64 %indvars.iv54.i
  br i1 %i.pq, label %.lr.ph.us22.preheader.i, label %.lr.ph17.split.preheader.i

.lr.ph17.split.preheader.i:                       ; preds = %.lr.ph17.i, %.preheader1.thread.i
  %.069.lcssa6268.i = phi ptr [ %.069.lcssa.i, %.lr.ph17.i ], [ %i.qh, %.preheader1.thread.i ]
  %.068.lcssa6367.i = phi i32 [ %.068.lcssa.i, %.lr.ph17.i ], [ %i.az, %.preheader1.thread.i ] ; 3 uses
  %i.rw = add i32 %.068.lcssa6367.i, 3
  %smax.i = call i32 @llvm.smax.i32(i32 %.sroa.speculated82, i32 %i.rw)
  %reass.sub = sub i32 %smax.i, %.068.lcssa6367.i
  %i.rx = and i32 %reass.sub, -2
  %i.ry = add i32 %.068.lcssa6367.i, %i.rx
  br label %.preheader.i

.lr.ph.us22.preheader.i:                          ; preds = %.lr.ph17.i
  %i.rz = sext i32 %.068.lcssa.i to i64
  br label %.lr.ph.us22.i

.lr.ph.us22.i:                                    ; preds = %._crit_edge.us23.i, %.lr.ph.us22.preheader.i
  %indvars.iv46.i = phi i64 [ %i.rz, %.lr.ph.us22.preheader.i ], [ %indvars.iv.next47.i, %._crit_edge.us23.i ] ; 2 uses
  %.27115.us.i = phi ptr [ %.069.lcssa.i, %.lr.ph.us22.preheader.i ], [ %.lcssa164, %._crit_edge.us23.i ] ; 2 uses
  %i.sa = mul nsw i64 %indvars.iv46.i, %i.pr
  %gep.us21.i = getelementptr [4 x i8], ptr %invariant.gep20.i, i64 %i.sa ; 2 uses
  br i1 %i.qb, label %.epil.preheader169, label %.lr.ph.us22.i.new

.lr.ph.us22.i.new:                                ; preds = %.lr.ph.us22.i, %.lr.ph.us22.i.new
  %.06513.us.i = phi ptr [ %i.sx, %.lr.ph.us22.i.new ], [ %gep.us21.i, %.lr.ph.us22.i ] ; 6 uses
  %.312.us.i = phi ptr [ %i.sy, %.lr.ph.us22.i.new ], [ %.27115.us.i, %.lr.ph.us22.i ] ; 9 uses
  %niter175 = phi i32 [ %niter175.next.3, %.lr.ph.us22.i.new ], [ 0, %.lr.ph.us22.i ]
  %i.sb = load float, ptr %.06513.us.i, align 4, !tbaa !53
  store float %i.sb, ptr %.312.us.i, align 4, !tbaa !53
  %i.sc = getelementptr inbounds nuw [4 x i8], ptr %.06513.us.i, i64 %i.pr
  %i.sd = load float, ptr %i.sc, align 4, !tbaa !53
  %i.se = getelementptr inbounds nuw i8, ptr %.312.us.i, i64 4
  store float %i.sd, ptr %i.se, align 4, !tbaa !53
  %i.sf = getelementptr inbounds nuw i8, ptr %.06513.us.i, i64 64 ; 2 uses
  %i.sg = getelementptr inbounds nuw i8, ptr %.312.us.i, i64 8
  %i.sh = load float, ptr %i.sf, align 4, !tbaa !53
  store float %i.sh, ptr %i.sg, align 4, !tbaa !53
  %i.si = getelementptr inbounds nuw [4 x i8], ptr %i.sf, i64 %i.pr
  %i.sj = load float, ptr %i.si, align 4, !tbaa !53
  %i.sk = getelementptr inbounds nuw i8, ptr %.312.us.i, i64 12
  store float %i.sj, ptr %i.sk, align 4, !tbaa !53
  %i.sl = getelementptr inbounds nuw i8, ptr %.06513.us.i, i64 128 ; 2 uses
  %i.sm = getelementptr inbounds nuw i8, ptr %.312.us.i, i64 16
  %i.sn = load float, ptr %i.sl, align 4, !tbaa !53
  store float %i.sn, ptr %i.sm, align 4, !tbaa !53
  %i.so = getelementptr inbounds nuw [4 x i8], ptr %i.sl, i64 %i.pr
  %i.sp = load float, ptr %i.so, align 4, !tbaa !53
  %i.sq = getelementptr inbounds nuw i8, ptr %.312.us.i, i64 20
  store float %i.sp, ptr %i.sq, align 4, !tbaa !53
  %i.sr = getelementptr inbounds nuw i8, ptr %.06513.us.i, i64 192 ; 2 uses
  %i.ss = getelementptr inbounds nuw i8, ptr %.312.us.i, i64 24
  %i.st = load float, ptr %i.sr, align 4, !tbaa !53
  store float %i.st, ptr %i.ss, align 4, !tbaa !53
  %i.su = getelementptr inbounds nuw [4 x i8], ptr %i.sr, i64 %i.pr
  %i.sv = load float, ptr %i.su, align 4, !tbaa !53
  %i.sw = getelementptr inbounds nuw i8, ptr %.312.us.i, i64 28
  store float %i.sv, ptr %i.sw, align 4, !tbaa !53
  %i.sx = getelementptr inbounds nuw i8, ptr %.06513.us.i, i64 256 ; 2 uses
  %i.sy = getelementptr inbounds nuw i8, ptr %.312.us.i, i64 32 ; 3 uses
  %niter175.next.3 = add i32 %niter175, 4         ; 2 uses
  %niter175.ncmp.3 = icmp eq i32 %niter175.next.3, %unroll_iter174
  br i1 %niter175.ncmp.3, label %._crit_edge.us23.i.unr-lcssa, label %.lr.ph.us22.i.new, !llvm.loop !4

._crit_edge.us23.i.unr-lcssa:                     ; preds = %.lr.ph.us22.i.new
  br i1 %lcmp.mod171.not, label %._crit_edge.us23.i, label %.epil.preheader169

.epil.preheader169:                               ; preds = %._crit_edge.us23.i.unr-lcssa, %.lr.ph.us22.i
  %.06513.us.i.epil.init = phi ptr [ %gep.us21.i, %.lr.ph.us22.i ], [ %i.sx, %._crit_edge.us23.i.unr-lcssa ]
  %.312.us.i.epil.init = phi ptr [ %.27115.us.i, %.lr.ph.us22.i ], [ %i.sy, %._crit_edge.us23.i.unr-lcssa ]
  call void @llvm.assume(i1 %lcmp.mod173)
  br label %bb.f

bb.f:                                             ; preds = %bb.f, %.epil.preheader169
  %.06513.us.i.epil = phi ptr [ %.06513.us.i.epil.init, %.epil.preheader169 ], [ %i.td, %bb.f ] ; 3 uses
  %.312.us.i.epil = phi ptr [ %.312.us.i.epil.init, %.epil.preheader169 ], [ %i.te, %bb.f ] ; 3 uses
  %epil.iter = phi i32 [ 0, %.epil.preheader169 ], [ %epil.iter.next, %bb.f ]
  %i.sz = load float, ptr %.06513.us.i.epil, align 4, !tbaa !53
  store float %i.sz, ptr %.312.us.i.epil, align 4, !tbaa !53
  %i.ta = getelementptr inbounds nuw [4 x i8], ptr %.06513.us.i.epil, i64 %i.pr
  %i.tb = load float, ptr %i.ta, align 4, !tbaa !53
  %i.tc = getelementptr inbounds nuw i8, ptr %.312.us.i.epil, i64 4
  store float %i.tb, ptr %i.tc, align 4, !tbaa !53
  %i.td = getelementptr inbounds nuw i8, ptr %.06513.us.i.epil, i64 64
  %i.te = getelementptr inbounds nuw i8, ptr %.312.us.i.epil, i64 8 ; 2 uses
  %epil.iter.next = add i32 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.next, %xtraiter170
  br i1 %epil.iter.cmp.not, label %._crit_edge.us23.i, label %bb.f, !llvm.loop !507

._crit_edge.us23.i:                               ; preds = %bb.f, %._crit_edge.us23.i.unr-lcssa
  %.lcssa164 = phi ptr [ %i.sy, %._crit_edge.us23.i.unr-lcssa ], [ %i.te, %bb.f ] ; 2 uses
  %indvars.iv.next47.i = add nuw nsw i64 %indvars.iv46.i, 2 ; 3 uses
  %i.tf = icmp slt i64 %indvars.iv.next47.i, %invariant.op71.i
  br i1 %i.tf, label %.lr.ph.us22.i, label %.preheader.loopexit.i, !llvm.loop !5

.preheader.loopexit.i:                            ; preds = %._crit_edge.us23.i
  %i.tg = trunc nsw i64 %indvars.iv.next47.i to i32
  br label %.preheader.i

.preheader.i:                                     ; preds = %.preheader.loopexit.i, %.lr.ph17.split.preheader.i, %.preheader1.thread.i, %.preheader1.i
  %.271.lcssa.i = phi ptr [ %.069.lcssa.i, %.preheader1.i ], [ %.lcssa164, %.preheader.loopexit.i ], [ %.069.lcssa6268.i, %.lr.ph17.split.preheader.i ], [ %i.qh, %.preheader1.thread.i ]
  %.1.lcssa.i = phi i32 [ %.068.lcssa.i, %.preheader1.i ], [ %i.tg, %.preheader.loopexit.i ], [ %i.ry, %.lr.ph17.split.preheader.i ], [ %i.az, %.preheader1.thread.i ] ; 2 uses
  %i.th = icmp slt i32 %.1.lcssa.i, %.sroa.speculated82
  br i1 %i.th, label %.lr.ph32.i, label %._crit_edge33.split.i

.lr.ph32.i:                                       ; preds = %.preheader.i
  %invariant.gep34.i = getelementptr [4 x i8], ptr %i.ac, i64 %indvars.iv54.i ; 2 uses
  br i1 %i.pq, label %.lr.ph.preheader.i, label %._crit_edge33.split.i

.lr.ph.preheader.i:                               ; preds = %.lr.ph32.i
  %i.ti = sext i32 %.1.lcssa.i to i64             ; 2 uses
  %i.tj = mul i64 %i.px, %i.ti
  %scevgep121 = getelementptr i8, ptr %invariant.gep34.i, i64 %i.tj
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %._crit_edge.i53, %.lr.ph.preheader.i
  %indvars.iv50.i = phi i64 [ %i.ti, %.lr.ph.preheader.i ], [ %indvars.iv.next51.i, %._crit_edge.i53 ] ; 2 uses
  %.430.i = phi ptr [ %.271.lcssa.i, %.lr.ph.preheader.i ], [ %.lcssa119, %._crit_edge.i53 ] ; 6 uses
  %i.tk = mul nsw i64 %indvars.iv50.i, %i.pr
  %gep.i = getelementptr [4 x i8], ptr %invariant.gep34.i, i64 %i.tk ; 11 uses
  br i1 %min.iters.check, label %scalar.ph.preheader, label %vector.memcheck
...
vector.memcheck:                                  ; preds = %.lr.ph.i
  ...
  %found.conflict = and i1 %bound0, %bound1
  %i.tl = or i1 %found.conflict, %stride.check
  br i1 %i.tl, label %scalar.ph.preheader, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %i.tm = getelementptr i8, ptr %gep.i, i64 %i.qe
  %i.tn = getelementptr i8, ptr %.430.i, i64 %i.qf ; 2 uses
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 3 uses
  %i.to = shl i64 %index, 6                       ; 8 uses
  %next.gep = getelementptr i8, ptr %gep.i, i64 %i.to
  %i.tp = getelementptr i8, ptr %gep.i, i64 %i.to
  %next.gep123 = getelementptr i8, ptr %i.tp, i64 64
  %i.tq = getelementptr i8, ptr %gep.i, i64 %i.to
  %next.gep124 = getelementptr i8, ptr %i.tq, i64 128
  %i.tr = getelementptr i8, ptr %gep.i, i64 %i.to
  %next.gep125 = getelementptr i8, ptr %i.tr, i64 192
  %i.ts = getelementptr i8, ptr %gep.i, i64 %i.to
  %next.gep126 = getelementptr i8, ptr %i.ts, i64 256
  %i.tt = getelementptr i8, ptr %gep.i, i64 %i.to
  %next.gep127 = getelementptr i8, ptr %i.tt, i64 320
  %i.tu = getelementptr i8, ptr %gep.i, i64 %i.to
  %next.gep128 = getelementptr i8, ptr %i.tu, i64 384
  %i.tv = getelementptr i8, ptr %gep.i, i64 %i.to
  %next.gep129 = getelementptr i8, ptr %i.tv, i64 448
  %i.tw = shl i64 %index, 2
  %next.gep130 = getelementptr i8, ptr %.430.i, i64 %i.tw ; 2 uses
  %i.tx = load float, ptr %next.gep, align 4, !tbaa !53, !alias.scope !519
  %i.ty = load float, ptr %next.gep123, align 4, !tbaa !53, !alias.scope !519
  %i.tz = load float, ptr %next.gep124, align 4, !tbaa !53, !alias.scope !519
  %i.ua = load float, ptr %next.gep125, align 4, !tbaa !53, !alias.scope !519
  %i.ub = insertelement <4 x float> poison, float %i.tx, i64 0
  %i.uc = insertelement <4 x float> %i.ub, float %i.ty, i64 1
  %i.ud = insertelement <4 x float> %i.uc, float %i.tz, i64 2
  %i.ue = insertelement <4 x float> %i.ud, float %i.ua, i64 3
  %i.uf = load float, ptr %next.gep126, align 4, !tbaa !53, !alias.scope !519
  %i.ug = load float, ptr %next.gep127, align 4, !tbaa !53, !alias.scope !519
  %i.uh = load float, ptr %next.gep128, align 4, !tbaa !53, !alias.scope !519
  %i.ui = load float, ptr %next.gep129, align 4, !tbaa !53, !alias.scope !519
  ...
  %i.un = getelementptr i8, ptr %next.gep130, i64 16
  store <4 x float> %i.ue, ptr %next.gep130, align 4, !tbaa !53, !alias.scope !520, !noalias !519
  store <4 x float> %i.um, ptr %i.un, align 4, !tbaa !53, !alias.scope !520, !noalias !519
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.uo = icmp eq i64 %index.next, %n.vec
  br i1 %i.uo, label %middle.block, label %vector.body, !llvm.loop !511

middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %._crit_edge.i53, label %scalar.ph.preheader

scalar.ph.preheader:                              ; preds = %vector.memcheck, %.lr.ph.i, %middle.block
  %.029.i.ph = phi i32 [ 0, %vector.memcheck ], [ 0, %.lr.ph.i ], [ %i.qd, %middle.block ] ; 4 uses
  %.06328.i.ph = phi ptr [ %gep.i, %vector.memcheck ], [ %gep.i, %.lr.ph.i ], [ %i.tm, %middle.block ] ; 2 uses
  %.527.i.ph = phi ptr [ %.430.i, %vector.memcheck ], [ %.430.i, %.lr.ph.i ], [ %i.tn, %middle.block ] ; 2 uses
  %i.up = sub i32 %.sroa.speculated, %.029.i.ph
  %xtraiter176 = and i32 %i.up, 7                 ; 2 uses
  %lcmp.mod177.not = icmp eq i32 %xtraiter176, 0
  br i1 %lcmp.mod177.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol

scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  %.029.i.prol = phi i32 [ %i.ut, %scalar.ph.prol ], [ %.029.i.ph, %scalar.ph.preheader ]
  %.06328.i.prol = phi ptr [ %i.ur, %scalar.ph.prol ], [ %.06328.i.ph, %scalar.ph.preheader ] ; 2 uses
  %.527.i.prol = phi ptr [ %i.us, %scalar.ph.prol ], [ %.527.i.ph, %scalar.ph.preheader ] ; 2 uses
  %prol.iter = phi i32 [ %prol.iter.next, %scalar.ph.prol ], [ 0, %scalar.ph.preheader ]
  %i.uq = load float, ptr %.06328.i.prol, align 4, !tbaa !53
  store float %i.uq, ptr %.527.i.prol, align 4, !tbaa !53
  %i.ur = getelementptr inbounds nuw i8, ptr %.06328.i.prol, i64 64 ; 2 uses
  %i.us = getelementptr inbounds nuw i8, ptr %.527.i.prol, i64 4 ; 3 uses
  %i.ut = add nuw nsw i32 %.029.i.prol, 1         ; 2 uses
  %prol.iter.next = add i32 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter176
  br i1 %prol.iter.cmp.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol, !llvm.loop !512

scalar.ph.prol.loopexit:                          ; preds = %scalar.ph.prol, %scalar.ph.preheader
  %.lcssa165.unr = phi ptr [ poison, %scalar.ph.preheader ], [ %i.us, %scalar.ph.prol ]
  %.029.i.unr = phi i32 [ %.029.i.ph, %scalar.ph.preheader ], [ %i.ut, %scalar.ph.prol ]
  %.06328.i.unr = phi ptr [ %.06328.i.ph, %scalar.ph.preheader ], [ %i.ur, %scalar.ph.prol ]
  %.527.i.unr = phi ptr [ %.527.i.ph, %scalar.ph.preheader ], [ %i.us, %scalar.ph.prol ]
  %i.uu = sub i32 %.029.i.ph, %.sroa.speculated
end_hunk_3
begin_hunk_4_@_ZN4ncnnL37conv3x3s1_winograd23_transform_kernelERKNS_3MatERS0_iiRKNS_6OptionE.omp_outlined:bb.a
  %i.vr = load float, ptr %i.vp, align 4, !tbaa !53
  store float %i.vr, ptr %i.vq, align 4, !tbaa !53
  %i.vs = getelementptr inbounds nuw i8, ptr %.06328.i, i64 512
  %i.vt = getelementptr inbounds nuw i8, ptr %.527.i, i64 32 ; 2 uses
  %i.vu = add nuw nsw i32 %.029.i, 8              ; 2 uses
  %exitcond49.not.i.7 = icmp eq i32 %i.vu, %.sroa.speculated
  br i1 %exitcond49.not.i.7, label %._crit_edge.i53, label %scalar.ph, !llvm.loop !513

._crit_edge.i53:                                  ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  %.lcssa119 = phi ptr [ %i.tn, %middle.block ], [ %.lcssa165.unr, %scalar.ph.prol.loopexit ], [ %i.vt, %scalar.ph ]
  %indvars.iv.next51.i = add nuw nsw i64 %indvars.iv50.i, 1 ; 2 uses
  %exitcond53.not.i = icmp eq i64 %indvars.iv.next51.i, %i.ba
  br i1 %exitcond53.not.i, label %._crit_edge33.split.i, label %.lr.ph.i, !llvm.loop !6
...
_ZN4ncnn3MatD2Ev.exit34:                          ; preds = %._crit_edge33.split.i
  %indvars.iv.next = add nsw i64 %indvars.iv, %i.bd ; 2 uses
  %i.vv = icmp slt i64 %indvars.iv.next, %i.be
  %indvar.next = add i32 %indvar, 1
  %indvar.next137 = add i64 %indvar136, 1
  br i1 %i.vv, label %bb.d, label %_ZN4ncnn3MatD2Ev.exit, !llvm.loop !514
...
bb.h:                                             ; preds = %bb.c
  ...
  call void @__clang_call_terminate(ptr %i.vx) #27
  unreachable
}
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  store i32 %.sroa.speculated105, ptr %5, align 4, !tbaa !78
  ...
  store i32 %.sroa.speculated98, ptr %3, align 4, !tbaa !78
  ...
  %i.y = load i32, ptr %3, align 4, !tbaa !78
...
bb.f:                                             ; preds = %bb.e
  %i.an = load i32, ptr %5, align 4, !tbaa !78    ; 3 uses
...
.lr.ph:                                           ; preds = %bb.b
  ...
  %i.p = load i32, ptr %5, align 4, !tbaa !78     ; 2 uses
...
.lr.ph.split:                                     ; preds = %.lr.ph, %._crit_edge
  ...
  %i.u = load i32, ptr %4, align 4, !tbaa !78
...
._crit_edge:                                      ; preds = %_ZN4ncnn3MatD2Ev.exit, %.lr.ph.split
  ...
  br i1 %exitcond.not, label %._crit_edge80, label %.lr.ph.split, !llvm.loop !521
...
_ZN4ncnn3MatD2Ev.exit29:                          ; preds = %_ZN4ncnn3MatD2Ev.exit29.lr.ph, %_ZN4ncnn3MatD2Ev.exit
  ...
  %i.ap = load i32, ptr %3, align 4, !tbaa !78
  %i.aq = sdiv i32 %i.t, %i.ap
  %i.ar = load i32, ptr %i.l, align 4, !tbaa !86, !noalias !549
  %i.as = load ptr, ptr %7, align 8, !tbaa !34, !noalias !549
  %i.at = load i64, ptr %i.m, align 8, !tbaa !35, !noalias !549
  %i.au = sext i32 %i.aq to i64
  %i.av = mul i64 %i.at, %i.au
  %i.aw = load i64, ptr %i.n, align 8, !tbaa !76, !noalias !549 ; 2 uses
  ...
  %i.bf = load i32, ptr %i.o, align 4, !tbaa !86  ; 5 uses
...
.lr.ph.us.i:                                      ; preds = %._crit_edge.us.i, %.lr.ph.us.preheader.i
  ...
  %i.ch = load ptr, ptr %8, align 8, !tbaa !34    ; 8 uses
...
bb.c:                                             ; preds = %bb.c, %.lr.ph.us.i
  ...
  %i.cy = load <4 x float>, ptr %.01449.us.i, align 1, !tbaa !108 ; 2 uses
  %i.cz = load <4 x float>, ptr %.01528.us.i, align 1, !tbaa !108 ; 2 uses
  %i.da = load <4 x float>, ptr %.01547.us.i, align 1, !tbaa !108 ; 2 uses
  %i.db = load <4 x float>, ptr %.01566.us.i, align 1, !tbaa !108 ; 2 uses
  ...
  store <4 x float> %i.dg, ptr %.114010.us.i, align 16, !tbaa !108
  %i.dk = getelementptr inbounds nuw i8, ptr %.114010.us.i, i64 16
  store <4 x float> %i.dh, ptr %i.dk, align 16, !tbaa !108
  %i.dl = getelementptr inbounds nuw i8, ptr %.114010.us.i, i64 32
  store <4 x float> %i.di, ptr %i.dl, align 16, !tbaa !108
  %i.dm = getelementptr inbounds nuw i8, ptr %.114010.us.i, i64 48
  store <4 x float> %i.dj, ptr %i.dm, align 16, !tbaa !108
  ...
  br i1 %i.du, label %bb.c, label %..preheader4_crit_edge.us.i, !llvm.loop !524
...
.lr.ph22.us.i:                                    ; preds = %.lr.ph22.us.i.preheader229, %.lr.ph22.us.i
  ...
  %i.dv = load float, ptr %.114520.us.i, align 4, !tbaa !53
  store float %i.dv, ptr %.221.us.i, align 4, !tbaa !53
  %i.dw = load float, ptr %.115319.us.i, align 4, !tbaa !53
  %i.dx = getelementptr inbounds nuw i8, ptr %.221.us.i, i64 4
  store float %i.dw, ptr %i.dx, align 4, !tbaa !53
  %i.dy = load float, ptr %.115518.us.i, align 4, !tbaa !53
  %i.dz = getelementptr inbounds nuw i8, ptr %.221.us.i, i64 8
  store float %i.dy, ptr %i.dz, align 4, !tbaa !53
  %i.ea = load float, ptr %.115717.us.i, align 4, !tbaa !53
  %i.eb = getelementptr inbounds nuw i8, ptr %.221.us.i, i64 12
  store float %i.ea, ptr %i.eb, align 4, !tbaa !53
  ...
  br i1 %i.ei, label %.lr.ph22.us.i, label %._crit_edge.us.i, !llvm.loop !525
...
._crit_edge.us.i:                                 ; preds = %.lr.ph22.us.i, %middle.block217, %..preheader4_crit_edge.us.i
  ...
  br i1 %i.ek, label %.lr.ph.us.i, label %.preheader3.loopexit.i, !llvm.loop !526
...
vector.body204:                                   ; preds = %vector.body204, %vector.ph202
  ...
  %wide.load211 = load <4 x float>, ptr %next.gep207, align 4, !tbaa !53, !alias.scope !550
  %wide.load212 = load <4 x float>, ptr %next.gep208, align 4, !tbaa !53, !alias.scope !551
  %wide.load213 = load <4 x float>, ptr %next.gep209, align 4, !tbaa !53, !alias.scope !552
  %wide.load214 = load <4 x float>, ptr %next.gep210, align 4, !tbaa !53, !alias.scope !553
  ...
  store <16 x float> %interleaved.vec215, ptr %next.gep206, align 4, !tbaa !53, !alias.scope !554, !noalias !555
  %index.next216 = add nuw i64 %index205, 4       ; 2 uses
  %i.fs = icmp eq i64 %index.next216, %n.vec203
  br i1 %i.fs, label %middle.block217, label %vector.body204, !llvm.loop !533
...
.lr.ph27.split.split.us.i:                        ; preds = %.lr.ph27.split.i
  %i.fu = load ptr, ptr %8, align 8, !tbaa !34
...
.preheader4.us31.i:                               ; preds = %._crit_edge.us41.i, %.lr.ph27.split.split.us.i
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %._crit_edge.us41.i ], [ 0, %.lr.ph27.split.split.us.i ] ; 2 uses
  %.013925.us32.i = phi ptr [ %.lcssa, %._crit_edge.us41.i ], [ %i.be, %.lr.ph27.split.split.us.i ] ; 13 uses
  ...
  %i.ge = load float, ptr %gep.i, align 4, !tbaa !53
  store float %i.ge, ptr %.013925.us32.i, align 4, !tbaa !53
  %i.gf = load float, ptr %gep49.i, align 4, !tbaa !53
  %i.gg = getelementptr inbounds nuw i8, ptr %.013925.us32.i, i64 4
  store float %i.gf, ptr %i.gg, align 4, !tbaa !53
  %i.gh = load float, ptr %gep51.i, align 4, !tbaa !53
  %i.gi = getelementptr inbounds nuw i8, ptr %.013925.us32.i, i64 8
  store float %i.gh, ptr %i.gi, align 4, !tbaa !53
  %i.gj = load float, ptr %gep53.i, align 4, !tbaa !53
  ...
  br i1 %exitcond.not.i, label %._crit_edge.us41.i, label %bb.d
...
bb.d:                                             ; preds = %.preheader4.us31.i
  ...
  %i.gq = load float, ptr %i.gp, align 4, !tbaa !53
  store float %i.gq, ptr %i.gl, align 4, !tbaa !53
  %i.gr = load float, ptr %i.go, align 4, !tbaa !53
  %i.gs = getelementptr inbounds nuw i8, ptr %.013925.us32.i, i64 20
  store float %i.gr, ptr %i.gs, align 4, !tbaa !53
  %i.gt = load float, ptr %i.gn, align 4, !tbaa !53
  %i.gu = getelementptr inbounds nuw i8, ptr %.013925.us32.i, i64 24
  store float %i.gt, ptr %i.gu, align 4, !tbaa !53
  %i.gv = load float, ptr %i.gm, align 4, !tbaa !53
  ...
  br i1 %exitcond.not.i.1, label %._crit_edge.us41.i, label %bb.e
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.hc = load float, ptr %i.hb, align 4, !tbaa !53
  store float %i.hc, ptr %i.gx, align 4, !tbaa !53
  %i.hd = load float, ptr %i.ha, align 4, !tbaa !53
  %i.he = getelementptr inbounds nuw i8, ptr %.013925.us32.i, i64 36
  store float %i.hd, ptr %i.he, align 4, !tbaa !53
  %i.hf = load float, ptr %i.gz, align 4, !tbaa !53
  %i.hg = getelementptr inbounds nuw i8, ptr %.013925.us32.i, i64 40
  store float %i.hf, ptr %i.hg, align 4, !tbaa !53
  %i.hh = load float, ptr %i.gy, align 4, !tbaa !53
  ...
  br label %._crit_edge.us41.i

._crit_edge.us41.i:                               ; preds = %bb.e, %bb.d, %.preheader4.us31.i
  ...
  br i1 %i.hl, label %.preheader4.us31.i, label %.preheader3.loopexit112.i, !llvm.loop !526

.preheader3.loopexit.i:                           ; preds = %._crit_edge.us.i
  %i.hm = trunc nuw nsw i64 %indvars.iv.next139.i to i32
  br label %.preheader3.i

.preheader3.loopexit112.i:                        ; preds = %._crit_edge.us41.i
...
.preheader3.i:                                    ; preds = %.lr.ph27.split.i, %.preheader3.loopexit112.i, %.preheader3.loopexit.i, %_ZN4ncnn3MatD2Ev.exit29
  %.0141.lcssa.i = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit29 ], [ %i.hn, %.preheader3.loopexit112.i ], [ %i.hm, %.preheader3.loopexit.i ], [ %i.y, %.lr.ph27.split.i ] ; 7 uses
...
.lr.ph.us72.i:                                    ; preds = %._crit_edge.us74.i, %.lr.ph.us72.preheader.i
  ...
  %i.iz = load ptr, ptr %8, align 8, !tbaa !34    ; 4 uses
...
.lr.ph.us72.i.new:                                ; preds = %.lr.ph.us72.i, %.lr.ph.us72.i.new
  ...
  %i.ji = load <4 x float>, ptr %.015054.us.i, align 1, !tbaa !108 ; 2 uses
  %i.jj = load <4 x float>, ptr %.014855.us.i, align 1, !tbaa !108 ; 2 uses
  ...
  store <4 x float> %i.jk, ptr %.457.us.i, align 16, !tbaa !108
  %i.jm = getelementptr inbounds nuw i8, ptr %.457.us.i, i64 16
  store <4 x float> %i.jl, ptr %i.jm, align 16, !tbaa !108
  ...
  %i.jq = load <4 x float>, ptr %i.jo, align 1, !tbaa !108 ; 2 uses
  ...
  store <4 x float> %i.js, ptr %i.jn, align 16, !tbaa !108
  %i.ju = getelementptr i8, ptr %.457.us.i, i64 48
  store <4 x float> %i.jt, ptr %i.ju, align 16, !tbaa !108
...
.lr.ph65.us.i:                                    ; preds = %.lr.ph65.us.i.preheader228, %.lr.ph65.us.i
  ...
  %i.jy = load float, ptr %.115161.us.i, align 4, !tbaa !53
  store float %i.jy, ptr %.564.us.i, align 4, !tbaa !53
  %i.jz = load float, ptr %.114962.us.i, align 4, !tbaa !53
  %i.ka = getelementptr inbounds nuw i8, ptr %.564.us.i, i64 4
  store float %i.jz, ptr %i.ka, align 4, !tbaa !53
  ...
  br i1 %i.kf, label %.lr.ph65.us.i, label %._crit_edge.us74.i, !llvm.loop !535
...
._crit_edge.us74.i:                               ; preds = %.lr.ph65.us.i, %middle.block167, %..preheader2_crit_edge.us.i
  ...
  br i1 %i.kg, label %.lr.ph.us72.i, label %.preheader1.loopexit.i, !llvm.loop !536
...
.epil.preheader:                                  ; preds = %..preheader2_crit_edge.us.i.unr-lcssa, %.lr.ph.us72.i
  ...
  %i.kh = load <4 x float>, ptr %.015054.us.i.epil.init, align 1, !tbaa !108 ; 2 uses
  %i.ki = load <4 x float>, ptr %.014855.us.i.epil.init, align 1, !tbaa !108 ; 2 uses
  ...
  store <4 x float> %i.kj, ptr %.457.us.i.epil.init, align 16, !tbaa !108
  %i.kl = getelementptr inbounds nuw i8, ptr %.457.us.i.epil.init, i64 16
  store <4 x float> %i.kk, ptr %i.kl, align 16, !tbaa !108
...
vector.body155:                                   ; preds = %vector.body155, %vector.ph153
  ...
  %wide.load162 = load <2 x float>, ptr %i.lj, align 4, !tbaa !53, !alias.scope !556
  %i.lk = getelementptr i8, ptr %next.gep159, i64 8
  %wide.load163 = load <2 x float>, ptr %next.gep159, align 4, !tbaa !53, !alias.scope !557
  %wide.load164 = load <2 x float>, ptr %i.lk, align 4, !tbaa !53, !alias.scope !557
...
.preheader2.preheader.i:                          ; preds = %.lr.ph69.split.i
  %9 = add i32 %.0141.lcssa.i, 3
  %smax.i = call i32 @llvm.smax.i32(i32 %.sroa.speculated57, i32 %9)
  %reass.sub = sub i32 %smax.i, %.0141.lcssa.i
  %10 = and i32 %reass.sub, -2
  %i.ln = add i32 %.0141.lcssa.i, %10
  br label %.preheader1.i

.lr.ph69.split.split.us.i:                        ; preds = %.lr.ph69.split.i
  %i.lo = load ptr, ptr %8, align 8, !tbaa !34
...
.preheader2.us77.i:                               ; preds = %._crit_edge.us85.i, %.lr.ph69.split.split.us.i
  %indvars.iv142.i = phi i64 [ %indvars.iv.next143.i, %._crit_edge.us85.i ], [ %i.lp, %.lr.ph69.split.split.us.i ] ; 2 uses
  %.368.us78.i = phi ptr [ %.lcssa236, %._crit_edge.us85.i ], [ %.0139.lcssa.i, %.lr.ph69.split.split.us.i ] ; 7 uses
  ...
  %i.lv = load float, ptr %gep93.i, align 4, !tbaa !53
  store float %i.lv, ptr %.368.us78.i, align 4, !tbaa !53
  %i.lw = load float, ptr %gep95.i, align 4, !tbaa !53
  %i.lx = getelementptr inbounds nuw i8, ptr %.368.us78.i, i64 4
  store float %i.lw, ptr %i.lx, align 4, !tbaa !53
...
bb.f:                                             ; preds = %.preheader2.us77.i
  ...
  %i.mb = load float, ptr %i.ma, align 4, !tbaa !53
  store float %i.mb, ptr %i.ly, align 4, !tbaa !53
  %i.mc = load float, ptr %i.lz, align 4, !tbaa !53
  %i.md = getelementptr inbounds nuw i8, ptr %.368.us78.i, i64 12
  store float %i.mc, ptr %i.md, align 4, !tbaa !53
...
bb.g:                                             ; preds = %bb.f
  ...
  store float %i.mh, ptr %i.me, align 4, !tbaa !53
  %i.mi = load float, ptr %i.mf, align 4, !tbaa !53
...
._crit_edge.us85.i:                               ; preds = %bb.g, %bb.f, %.preheader2.us77.i
  ...
  br i1 %i.ml, label %.preheader2.us77.i, label %.preheader1.loopexit110.i, !llvm.loop !536
...
bb.h:                                             ; preds = %._crit_edge.i, %.lr.ph108.i
  ...
  %i.my = load ptr, ptr %8, align 8, !tbaa !34
...
.lr.ph.i.epil:                                    ; preds = %.lr.ph.i.epil, %.lr.ph.i.epil.preheader
  ...
  %i.nd = load <4 x float>, ptr %.013797.i.epil, align 1, !tbaa !108
  store <4 x float> %i.nd, ptr %.796.i.epil, align 1, !tbaa !108
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load139 = load <4 x float>, ptr %i.ns, align 4, !tbaa !53
  %i.nt = getelementptr i8, ptr %next.gep138, i64 16
  store <4 x float> %wide.load, ptr %next.gep138, align 4, !tbaa !53
  store <4 x float> %wide.load139, ptr %i.nt, align 4, !tbaa !53
  %index.next = add nuw i64 %index, 8             ; 2 uses
...
.lr.ph104.i.prol:                                 ; preds = %.lr.ph104.i.preheader227, %.lr.ph104.i.prol
  ...
  %i.nw = load float, ptr %.1138102.i.prol, align 4, !tbaa !53
  store float %i.nw, ptr %.8101.i.prol, align 4, !tbaa !53
...
bb.ce:                                            ; preds = %bb.ce, %.noexc1310.us.i
  ...
  %i.aqx = load i32, ptr %i.aqw, align 4, !tbaa !78
  ...
  %i.arb = load i8, ptr %i.aqz, align 1, !tbaa !108
  %i.arc = sext i8 %i.arb to i32                  ; 2 uses
  %i.ard = load i8, ptr %.511413118.us.i, align 1, !tbaa !108
  ...
  br i1 %exitcond3696.not.i, label %._crit_edge3121.us.i, label %bb.ce, !llvm.loop !594
...
._crit_edge3121.us.i:                             ; preds = %bb.ce
  ...
  br i1 %i.aru, label %.noexc1310.us.i, label %._crit_edge3133.i, !llvm.loop !595
...
._crit_edge3133.i:                                ; preds = %._crit_edge3121.us.i, %.noexc1310.lr.ph.i, %.preheader2859.i
  ...
  store i32 %.21156.lcssa.i, ptr %.111263154.i, align 4, !tbaa !78
  %i.arv = getelementptr inbounds nuw i8, ptr %.111263154.i, i64 4
  store i32 %.21152.lcssa.i, ptr %i.arv, align 4, !tbaa !78
  store i32 %.21148.lcssa.i, ptr %.111293153.i, align 4, !tbaa !78
  %i.arw = getelementptr inbounds nuw i8, ptr %.111293153.i, i64 4
  store i32 %.21144.lcssa.i, ptr %i.arw, align 4, !tbaa !78
  ...
  br i1 %i.asb, label %.noexc1320.i, label %.preheader2861.i, !llvm.loop !596
...
.noexc1306.i:                                     ; preds = %._crit_edge3224.i, %.noexc1306.lr.ph.i
  ...
  %i.ase = load i32, ptr %i.d, align 4, !tbaa !78 ; 9 uses
  %i.asf = icmp sgt i32 %i.ase, 7
  br i1 %i.asf, label %.noexc1304.lr.ph.i, label %._crit_edge3171.i

.noexc1304.lr.ph.i:                               ; preds = %.noexc1306.i
  %i.asg = load i32, ptr %i.c, align 4, !tbaa !78 ; 3 uses
  %i.ash = load i32, ptr %i.bm, align 4, !tbaa !86, !noalias !670
  %i.asi = sext i32 %i.ash to i64
  %i.asj = load i32, ptr %i.b, align 4, !tbaa !78
  ...
  %i.aso = load i32, ptr %i.a, align 4, !tbaa !78
  ...
  %i.ass = load i32, ptr %i.f, align 4, !tbaa !78 ; 3 uses
...
bb.cf:                                            ; preds = %bb.ci, %.noexc1304.us.i
  ...
  %i.atf = load i32, ptr %i.ate, align 4, !tbaa !78
...
bb.ch:                                            ; preds = %bb.cf
  %i.auf = load i64, ptr %i.ath, align 1, !tbaa !108
...
bb.ci:                                            ; preds = %bb.ch, %bb.cg
  ...
  %i.auj = load <16 x i8>, ptr %.111113160.us.i, align 16, !tbaa !108 ; 3 uses
  ...
  br i1 %exitcond3706.not.i, label %._crit_edge3163.us.i, label %bb.cf, !llvm.loop !599
...
._crit_edge3163.us.i:                             ; preds = %bb.ci
  ...
  br i1 %i.auw, label %.noexc1304.us.i, label %._crit_edge3171.loopexit.i, !llvm.loop !600
...
._crit_edge3171.i:                                ; preds = %._crit_edge3171.loopexit.i, %.noexc1304.preheader.i, %.noexc1306.i
  ...
  %.01107.lcssa.i = phi i32 [ 0, %.noexc1306.i ], [ %i.aux, %._crit_edge3171.loopexit.i ], [ %i.asw, %.noexc1304.preheader.i ] ; 6 uses
...
.noexc1302.lr.ph.i:                               ; preds = %._crit_edge3171.i
  %i.ave = load i32, ptr %i.bm, align 4, !tbaa !86, !noalias !671
  %i.avf = sext i32 %i.ave to i64
  %i.avg = load i32, ptr %i.b, align 4, !tbaa !78
  ...
  %i.avl = load i32, ptr %i.a, align 4, !tbaa !78
  ...
  %i.avo = load i32, ptr %i.f, align 4, !tbaa !78 ; 3 uses
...
.noexc1302.preheader.i:                           ; preds = %.noexc1302.lr.ph.i
  ...
  %12 = or disjoint i32 %.01107.lcssa.i, 3
  %13 = call i32 @llvm.umax.i32(i32 %i.ase, i32 %12)
  %reass.sub = sub nsw i32 %13, %.01107.lcssa.i
  %i.avs = and i32 %reass.sub, -2
  %14 = add i32 %i.avs, -2
  %i.avt = add i32 %i.avr, %14
...
bb.cj:                                            ; preds = %bb.cj, %.noexc1302.us.i
  ...
  %i.avz = load i32, ptr %i.avy, align 4, !tbaa !78
  %i.awa = sext i32 %i.avz to i64
  %i.awb = getelementptr inbounds i8, ptr %gep3206.us.i, i64 %i.awa ; 2 uses
  %i.awc = load i8, ptr %i.awb, align 1, !tbaa !108
  %i.awd = sext i8 %i.awc to i32                  ; 2 uses
  %i.awe = load i8, ptr %.311133187.us.i, align 1, !tbaa !108
  ...
  %i.awj = load i8, ptr %i.awi, align 1, !tbaa !108
  ...
  %i.aww = load i8, ptr %i.awv, align 1, !tbaa !108
  ...
  br i1 %exitcond3713.not.i, label %._crit_edge3190.us.i, label %bb.cj, !llvm.loop !603
...
._crit_edge3190.us.i:                             ; preds = %bb.cj
  ...
  br i1 %i.axd, label %.noexc1302.us.i, label %.preheader2858.i, !llvm.loop !604
...
.noexc1300.lr.ph.i:                               ; preds = %.preheader2858.i
  %i.axf = load i32, ptr %i.bm, align 4, !tbaa !86, !noalias !672
  %i.axg = sext i32 %i.axf to i64
  %i.axh = load i32, ptr %i.b, align 4, !tbaa !78
  ...
  %i.axm = load i32, ptr %i.a, align 4, !tbaa !78
  ...
  %i.axp = load i32, ptr %i.f, align 4, !tbaa !78 ; 5 uses
...
.noexc1300.us.i.new:                              ; preds = %.noexc1300.us.i, %.noexc1300.us.i.new
  ...
  %i.axy = load i32, ptr %i.axx, align 4, !tbaa !78
  ...
  %i.ayd = load i8, ptr %.511153213.us.i, align 1, !tbaa !108
  ...
  %i.ayi = load i8, ptr %i.ayh, align 1, !tbaa !108
  ...
  %i.ayp = load i32, ptr %i.ayo, align 4, !tbaa !78
  %i.ayq = sext i32 %i.ayp to i64
  %i.ayr = getelementptr inbounds i8, ptr %gep3231.us.i, i64 %i.ayq
  %i.ays = load i8, ptr %i.ayr, align 1, !tbaa !108
  %i.ayt = sext i8 %i.ays to i32                  ; 2 uses
  %i.ayu = load i8, ptr %i.aym, align 1, !tbaa !108
  ...
  br i1 %niter.ncmp.1, label %._crit_edge3216.us.i.unr-lcssa, label %.noexc1300.us.i.new, !llvm.loop !607
...
.epil.preheader:                                  ; preds = %._crit_edge3216.us.i.unr-lcssa, %.noexc1300.us.i
  ...
  %i.azf = load i32, ptr %i.aze, align 4, !tbaa !78
  %i.azg = sext i32 %i.azf to i64
  %i.azh = getelementptr inbounds i8, ptr %gep3231.us.i, i64 %i.azg
  %i.azi = load i8, ptr %i.azh, align 1, !tbaa !108
  %i.azj = sext i8 %i.azi to i32                  ; 2 uses
  %i.azk = load i8, ptr %.511153213.us.i.epil.init, align 1, !tbaa !108
  ...
  %i.azp = load i8, ptr %i.azo, align 1, !tbaa !108
...
._crit_edge3216.us.i:                             ; preds = %._crit_edge3216.us.i.unr-lcssa, %.epil.preheader
  ...
  br i1 %i.azu, label %.noexc1300.us.i, label %._crit_edge3224.i, !llvm.loop !608
...
._crit_edge3224.i:                                ; preds = %._crit_edge3216.us.i, %.noexc1300.lr.ph.i, %.preheader2858.i
  ...
  store i32 %.21122.lcssa.i, ptr %.211273236.i, align 4, !tbaa !78
  store i32 %.21118.lcssa.i, ptr %.211303235.i, align 4, !tbaa !78
...
begin_hunk_6_@_ZNK4ncnn15Convolution_x8616forward_int8_x86ERKNS_3MatERS1_RKNS_6OptionE:bb.a
  ...
  %i.bzf = load i8, ptr %i.bzd, align 1, !tbaa !108
  %i.bzg = sext i8 %i.bzf to i32
  %i.bzh = load i8, ptr %.510113418.us.i.epil.init, align 1, !tbaa !108
  %i.bzi = sext i8 %i.bzh to i32                  ; 2 uses
  %i.bzj = mul nsw i32 %i.bzi, %i.bzg
  %i.bzk = add nsw i32 %i.bzj, %.310193416.us.i.epil.init
  %i.bzl = load i8, ptr %i.bze, align 1, !tbaa !108
...
._crit_edge3421.us.i:                             ; preds = %._crit_edge3421.us.i.unr-lcssa, %.epil.preheader664
  ...
  br i1 %i.bzr, label %.noexc1262.us.i, label %._crit_edge3429.i, !llvm.loop !643
...
._crit_edge3429.i:                                ; preds = %._crit_edge3421.us.i, %.noexc1262.lr.ph.i, %.preheader2854.i
  ...
  store i32 %.21018.lcssa.i, ptr %.111013444.i, align 4, !tbaa !78
  %i.bzs = getelementptr inbounds nuw i8, ptr %.111013444.i, i64 4
  store i32 %.21014.lcssa.i, ptr %i.bzs, align 4, !tbaa !78
  ...
  br i1 %i.bzw, label %.noexc1272.i, label %.preheader2856.i, !llvm.loop !644
...
.noexc1258.i:                                     ; preds = %._crit_edge3515.i, %.noexc1258.lr.ph.i
  ...
  %i.bzz = load i32, ptr %i.d, align 4, !tbaa !78 ; 11 uses
  %i.caa = icmp sgt i32 %i.bzz, 7
  br i1 %i.caa, label %.noexc1256.lr.ph.i, label %._crit_edge3460.i

.noexc1256.lr.ph.i:                               ; preds = %.noexc1258.i
  %i.cab = load i32, ptr %i.c, align 4, !tbaa !78 ; 3 uses
  %i.cac = load i32, ptr %i.bm, align 4, !tbaa !86, !noalias !683
  %i.cad = sext i32 %i.cac to i64
  %i.cae = load i32, ptr %i.b, align 4, !tbaa !78
  ...
  %i.caj = load i32, ptr %i.a, align 4, !tbaa !78
  ...
  %i.can = load i32, ptr %i.f, align 4, !tbaa !78 ; 3 uses
...
bb.cu:                                            ; preds = %bb.cu, %.noexc1256.us.us.i
  ...
  %i.cbg = load i64, ptr %.19883449.us.us.us.i, align 1, !tbaa !108
  ...
  br i1 %exitcond3795.not.i, label %._crit_edge3452.split.us.us.us.i, label %bb.cu, !llvm.loop !647
...
._crit_edge3452.split.us.us.us.i:                 ; preds = %bb.cu
  ...
  br i1 %i.cbq, label %.noexc1256.us.us.i, label %._crit_edge3460.loopexit.i, !llvm.loop !648

.noexc1256.us.i:                                  ; preds = %.noexc1256.lr.ph.split.us.i, %._crit_edge3452.split.us3475.i
  %.09863459.us.i = phi i32 [ %i.cdf, %._crit_edge3452.split.us3475.i ], [ 0, %.noexc1256.lr.ph.split.us.i ] ; 2 uses
  %.09873458.us.i = phi ptr [ %scevgep3785.i, %._crit_edge3452.split.us3475.i ], [ %i.bpy, %.noexc1256.lr.ph.split.us.i ] ; 2 uses
  %i.cbr = phi <4 x i32> [ %i.cdd, %._crit_edge3452.split.us3475.i ], [ zeroinitializer, %.noexc1256.lr.ph.split.us.i ]
...
bb.cv:                                            ; preds = %bb.cv, %.noexc1256.us.i
  %indvars.iv3782.i = phi i64 [ %indvars.iv.next3783.i, %bb.cv ], [ 0, %.noexc1256.us.i ] ; 2 uses
  %.19883449.us3471.i = phi ptr [ %i.cde, %bb.cv ], [ %.09873458.us.i, %.noexc1256.us.i ] ; 2 uses
  %.127833448.us3472.i = phi <4 x i32> [ %i.cdd, %bb.cv ], [ %i.cbr, %.noexc1256.us.i ]
  %i.cbu = getelementptr inbounds nuw [4 x i8], ptr %i.cap, i64 %indvars.iv3782.i
  %i.cbv = load i32, ptr %i.cbu, align 4, !tbaa !78
  %i.cbw = sext i32 %i.cbv to i64
  %i.cbx = getelementptr inbounds i8, ptr %gep3468.us.i, i64 %i.cbw ; 8 uses
  %i.cby = load i8, ptr %i.cbx, align 1, !tbaa !108
  %i.cbz = getelementptr inbounds nuw i8, ptr %i.cbx, i64 %i.lx
  %i.cca = load i8, ptr %i.cbz, align 1, !tbaa !108
  %i.ccb = getelementptr inbounds nuw i8, ptr %i.cbx, i64 %i.od
  %i.ccc = load i8, ptr %i.ccb, align 1, !tbaa !108
  %i.ccd = getelementptr inbounds nuw i8, ptr %i.cbx, i64 %i.oe
  %i.cce = load i8, ptr %i.ccd, align 1, !tbaa !108
  %i.ccf = getelementptr inbounds nuw i8, ptr %i.cbx, i64 %i.of
  %i.ccg = load i8, ptr %i.ccf, align 1, !tbaa !108
  %i.cch = getelementptr inbounds nuw i8, ptr %i.cbx, i64 %i.og
  %i.cci = load i8, ptr %i.cch, align 1, !tbaa !108
  %i.ccj = getelementptr inbounds nuw i8, ptr %i.cbx, i64 %i.oh
  %i.cck = load i8, ptr %i.ccj, align 1, !tbaa !108
  %i.ccl = getelementptr inbounds nuw i8, ptr %i.cbx, i64 %i.oi
  %i.ccm = load i8, ptr %i.ccl, align 1, !tbaa !108
  ...
  %.lobit.i1702.us3473.i = ashr <16 x i8> %i.ccu, splat (i8 7)
  %i.ccv = shufflevector <16 x i8> %i.ccu, <16 x i8> %.lobit.i1702.us3473.i, <16 x i32> <i32 0, i32 16, i32 1, i32 17, i32 2, i32 18, i32 3, i32 19, i32 4, i32 20, i32 5, i32 21, i32 6, i32 22, i32 7, i32 23>
  %i.ccw = load i64, ptr %.19883449.us3471.i, align 1, !tbaa !108
  %i.ccx = insertelement <2 x i64> <i64 poison, i64 0>, i64 %i.ccw, i64 0
  %i.ccy = bitcast <2 x i64> %i.ccx to <16 x i8>  ; 2 uses
  %.lobit.i.us3474.i = ashr <16 x i8> %i.ccy, splat (i8 7)
  %i.ccz = shufflevector <16 x i8> %i.ccy, <16 x i8> %.lobit.i.us3474.i, <16 x i32> <i32 0, i32 16, i32 1, i32 17, i32 2, i32 18, i32 3, i32 19, i32 4, i32 20, i32 5, i32 21, i32 6, i32 22, i32 7, i32 23>
  ...
  %i.cdd = add <4 x i32> %i.cdc, %.127833448.us3472.i ; 3 uses
  %i.cde = getelementptr inbounds nuw i8, ptr %.19883449.us3471.i, i64 8
  ...
  br i1 %exitcond3788.not.i, label %._crit_edge3452.split.us3475.i, label %bb.cv, !llvm.loop !647

._crit_edge3452.split.us3475.i:                   ; preds = %bb.cv
  ...
  br i1 %i.cdh, label %.noexc1256.us.i, label %._crit_edge3460.loopexit3530.i, !llvm.loop !648

._crit_edge3460.loopexit.i:                       ; preds = %._crit_edge3452.split.us.us.us.i
  %i.cdi = and i32 %i.bzz, 2147483640
  br label %._crit_edge3460.i

._crit_edge3460.loopexit3530.i:                   ; preds = %._crit_edge3452.split.us3475.i
...
._crit_edge3460.i:                                ; preds = %._crit_edge3460.loopexit3530.i, %._crit_edge3460.loopexit.i, %.noexc1256.preheader.i, %.noexc1258.i
  ...
  %.0986.lcssa.i = phi i32 [ 0, %.noexc1258.i ], [ %i.cdi, %._crit_edge3460.loopexit.i ], [ %i.cdj, %._crit_edge3460.loopexit3530.i ], [ %i.caq, %.noexc1256.preheader.i ] ; 6 uses
...
.noexc1254.lr.ph.i:                               ; preds = %._crit_edge3460.i
  %i.cdo = load i32, ptr %i.bm, align 4, !tbaa !86, !noalias !684
  %i.cdp = sext i32 %i.cdo to i64
  %i.cdq = load i32, ptr %i.b, align 4, !tbaa !78
  ...
  %i.cdv = load i32, ptr %i.a, align 4, !tbaa !78
  ...
  %i.cdy = load i32, ptr %i.f, align 4, !tbaa !78 ; 5 uses
...
.noexc1254.preheader.i:                           ; preds = %.noexc1254.lr.ph.i
  ...
  %15 = or disjoint i32 %.0986.lcssa.i, 3
  %16 = call i32 @llvm.umax.i32(i32 %i.bzz, i32 %15)
  %reass.sub285 = sub nsw i32 %16, %.0986.lcssa.i
  %i.cec = and i32 %reass.sub285, -2
  %17 = add i32 %i.cec, -2
  %i.ced = add i32 %i.ceb, %17
  br label %.preheader.i
...
.noexc1254.us.i.new:                              ; preds = %.noexc1254.us.i, %.noexc1254.us.i.new
  ...
  %i.cek = load i32, ptr %i.cej, align 4, !tbaa !78
  %i.cel = sext i32 %i.cek to i64
  %i.cem = getelementptr inbounds i8, ptr %gep3501.us.i, i64 %i.cel ; 2 uses
  %i.cen = load i8, ptr %i.cem, align 1, !tbaa !108
  %i.ceo = sext i8 %i.cen to i32
  %i.cep = load i8, ptr %.33485.us.i, align 1, !tbaa !108
  ...
  %i.cfe = load i32, ptr %i.cfd, align 4, !tbaa !78
  %i.cff = sext i32 %i.cfe to i64
  %i.cfg = getelementptr inbounds i8, ptr %gep3501.us.i, i64 %i.cff ; 2 uses
  %i.cfh = load i8, ptr %i.cfg, align 1, !tbaa !108
  %i.cfi = sext i8 %i.cfh to i32
  %i.cfj = load i8, ptr %i.cfb, align 1, !tbaa !108
  ...
  br i1 %niter678.ncmp.1, label %._crit_edge3488.us.i.unr-lcssa, label %.noexc1254.us.i.new, !llvm.loop !651
...
.epil.preheader672:                               ; preds = %._crit_edge3488.us.i.unr-lcssa, %.noexc1254.us.i
  ...
  %i.cfx = load i32, ptr %i.cfw, align 4, !tbaa !78
  %i.cfy = sext i32 %i.cfx to i64
  %i.cfz = getelementptr inbounds i8, ptr %gep3501.us.i, i64 %i.cfy ; 2 uses
  %i.cga = load i8, ptr %i.cfz, align 1, !tbaa !108
  %i.cgb = sext i8 %i.cga to i32
  %i.cgc = load i8, ptr %.33485.us.i.epil.init, align 1, !tbaa !108
...
._crit_edge3488.us.i:                             ; preds = %._crit_edge3488.us.i.unr-lcssa, %.epil.preheader672
  ...
  br i1 %i.cgq, label %.noexc1254.us.i, label %.preheader.i, !llvm.loop !652
...
.noexc.lr.ph.i:                                   ; preds = %.preheader.i
  %i.cgs = load i32, ptr %i.bm, align 4, !tbaa !86, !noalias !685
  %i.cgt = sext i32 %i.cgs to i64
  %i.cgu = load i32, ptr %i.b, align 4, !tbaa !78
  ...
  %i.cgz = load i32, ptr %i.a, align 4, !tbaa !78
  ...
  %i.chc = load i32, ptr %i.f, align 4, !tbaa !78 ; 3 uses
...
.noexc.us.i.new:                                  ; preds = %.noexc.us.i, %.noexc.us.i.new
  ...
  %i.chj = load i32, ptr %i.chi, align 4, !tbaa !78
  %i.chk = sext i32 %i.chj to i64
  %i.chl = getelementptr inbounds i8, ptr %gep3521.us.i, i64 %i.chk
  %i.chm = load i8, ptr %i.chl, align 1, !tbaa !108
  %i.chn = sext i8 %i.chm to i32
  %i.cho = load i8, ptr %.53506.us.i, align 1, !tbaa !108
  ...
  %i.chv = load i32, ptr %i.chu, align 4, !tbaa !78
  %i.chw = sext i32 %i.chv to i64
  %i.chx = getelementptr inbounds i8, ptr %gep3521.us.i, i64 %i.chw
  %i.chy = load i8, ptr %i.chx, align 1, !tbaa !108
  %i.chz = sext i8 %i.chy to i32
  %i.cia = load i8, ptr %i.chs, align 1, !tbaa !108
  ...
  %i.cih = load i32, ptr %i.cig, align 4, !tbaa !78
  %i.cii = sext i32 %i.cih to i64
  %i.cij = getelementptr inbounds i8, ptr %gep3521.us.i, i64 %i.cii
  %i.cik = load i8, ptr %i.cij, align 1, !tbaa !108
  %i.cil = sext i8 %i.cik to i32
  %i.cim = load i8, ptr %i.cie, align 1, !tbaa !108
...
bb.g:                                             ; preds = %bb.f
  %i.de = load ptr, ptr %i.ap, align 8, !tbaa !33 ; 3 uses
  %.not3.i36 = icmp eq ptr %i.de, null
  %i.df = load ptr, ptr %12, align 8, !tbaa !34   ; 3 uses
  br i1 %.not3.i36, label %bb.i, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.dg = load ptr, ptr %i.de, align 8, !tbaa !26
  ...
  invoke void %i.di(ptr noundef nonnull align 8 dereferenceable(8) %i.de, ptr noundef %i.df)
          to label %_ZN4ncnn3MatD2Ev.exit33 unwind label %bb.k, !inline_history !0
...
_ZN4ncnn3MatD2Ev.exit33:                          ; preds = %bb.f, %_ZN4ncnn3Mat7channelEi.exit48, %bb.h, %bb.i, %bb.j
  ...
  %i.dl = load ptr, ptr %i.v, align 8, !tbaa !32  ; 2 uses
...
bb.m:                                             ; preds = %bb.l
  %i.do = load ptr, ptr %i.y, align 8, !tbaa !33  ; 3 uses
  %.not3.i40 = icmp eq ptr %i.do, null
  %i.dp = load ptr, ptr %11, align 8, !tbaa !34   ; 3 uses
  br i1 %.not3.i40, label %bb.o, label %bb.n

bb.n:                                             ; preds = %bb.m
  %i.dq = load ptr, ptr %i.do, align 8, !tbaa !26
  ...
  invoke void %i.ds(ptr noundef nonnull align 8 dereferenceable(8) %i.do, ptr noundef %i.dp)
          to label %_ZN4ncnn3MatD2Ev.exit unwind label %bb.q, !inline_history !0
...
_ZN4ncnn3MatD2Ev.exit:                            ; preds = %bb.l, %_ZN4ncnn3MatD2Ev.exit33, %bb.n, %bb.o, %bb.p
  ...
  %i.dw = load i32, ptr %i.e, align 4, !tbaa !78
...
bb.c:                                             ; preds = %.lr.ph151, %_ZN4ncnn3MatD2Ev.exit
  ...
  %i.as = load i32, ptr %3, align 4, !tbaa !78
...
_ZN4ncnn3Mat7channelEi.exit76:                    ; preds = %bb.c
  %i.av = load ptr, ptr %4, align 8, !tbaa !34, !noalias !788
  %i.aw = load i64, ptr %i.l, align 8, !tbaa !35, !noalias !788
  %i.ax = sext i32 %i.au to i64
  %i.ay = mul i64 %i.aw, %i.ax
  %i.az = load i64, ptr %i.m, align 8, !tbaa !76, !noalias !788
  %i.ba = mul i64 %i.ay, %i.az
  %i.bb = getelementptr inbounds nuw i8, ptr %i.av, i64 %i.ba ; 4 uses
  %i.bc = load i32, ptr %5, align 4, !tbaa !78
  %i.bd = sub nsw i32 %i.bc, %i.at
  %i.be = load i32, ptr %3, align 4, !tbaa !78
  %.sroa.speculated121 = call i32 @llvm.smin.i32(i32 %i.be, i32 %i.bd) ; 8 uses
  %i.bf = load i32, ptr %6, align 4, !tbaa !78    ; 2 uses
...
_ZN4ncnn3MatD2Ev.exit:                            ; preds = %_ZN4ncnnL42conv3x3s1_winograd23_transform_output_tileERKNS_3MatERS0_S2_iiii.exit, %_ZN4ncnn3Mat7channelEi.exit76
  ...
  %i.bn = load i32, ptr %i.b, align 4, !tbaa !78
...
bb.d:                                             ; preds = %.lr.ph, %_ZN4ncnnL42conv3x3s1_winograd23_transform_output_tileERKNS_3MatERS0_S2_iiii.exit
  ...
  %i.br = load i32, ptr %8, align 4, !tbaa !78    ; 2 uses
  %i.bs = icmp sgt i32 %i.br, 0
  br i1 %i.bs, label %.noexc.preheader, label %._crit_edge

.noexc.preheader:                                 ; preds = %bb.d
  %.pre153 = load i32, ptr %9, align 4, !tbaa !78
  br label %.noexc

._crit_edge:                                      ; preds = %.noexc, %bb.d
  %.val78 = load ptr, ptr %13, align 8, !tbaa !34 ; 6 uses
  %i.bt = load i32, ptr %i.an, align 4, !tbaa !86 ; 7 uses
  %i.bu = load i32, ptr %i.ao, align 8, !tbaa !87 ; 7 uses
  %i.bv = load i32, ptr %i.ap, align 8, !tbaa !77 ; 6 uses
  %i.bw = load i64, ptr %i.aq, align 8, !tbaa !35
...
.lr.ph67.i:                                       ; preds = %._crit_edge
  ...
  %i.cd = shl nuw nsw i32 %.sroa.speculated117, 2
  %i.ce = zext nneg i32 %i.cd to i64
  %i.cf = shl nuw nsw i32 %.sroa.speculated117, 3
  %i.cg = zext nneg i32 %i.cf to i64
  %i.ch = mul nuw nsw i32 %.sroa.speculated117, 12
  %i.ci = zext nneg i32 %i.ch to i64
  %i.cj = zext nneg i32 %factor.op.mul64.i to i64 ; 12 uses
...
bb.e:                                             ; preds = %.lr.ph67.split.us.i
  ...
  %i.cn = load <4 x float>, ptr %i.cm, align 1, !tbaa !108
  br label %.lr.ph.us.i
...
_ZN4ncnn3MatD2Ev.exit337.us.i:                    ; preds = %bb.r, %.lr.ph.us.i
  ...
  %i.cz = load <4 x float>, ptr %i.cw, align 16, !tbaa !108 ; 2 uses
  %i.da = load <4 x float>, ptr %i.cx, align 16, !tbaa !108 ; 2 uses
  %i.db = load <4 x float>, ptr %i.cy, align 16, !tbaa !108
  ...
  %i.df = load <4 x float>, ptr %i.dc, align 16, !tbaa !108 ; 2 uses
  %i.dg = load <4 x float>, ptr %i.dd, align 16, !tbaa !108 ; 2 uses
  %i.dh = load <4 x float>, ptr %i.de, align 16, !tbaa !108
  ...
  %i.dn = load <4 x float>, ptr %i.dk, align 16, !tbaa !108 ; 2 uses
  %i.do = load <4 x float>, ptr %i.dl, align 16, !tbaa !108 ; 2 uses
  %i.dp = load <4 x float>, ptr %i.dm, align 16, !tbaa !108
  ...
  %i.dv = load <4 x float>, ptr %i.ds, align 16, !tbaa !108 ; 2 uses
  %i.dw = load <4 x float>, ptr %i.dt, align 16, !tbaa !108 ; 2 uses
  %i.dx = load <4 x float>, ptr %i.du, align 16, !tbaa !108
  %i.dy = trunc i64 %indvars.iv.i to i32
  %i.dz = add i32 %.044147, %i.dy                 ; 2 uses
  %i.ea = sdiv i32 %i.dz, %i.ca
  %i.eb = srem i32 %i.dz, %i.ca
  %i.ec = load i32, ptr %i.an, align 4, !tbaa !86, !noalias !789
  %i.ed = load ptr, ptr %12, align 8, !tbaa !34, !noalias !789
  %i.ee = load i64, ptr %i.aq, align 8, !tbaa !35, !noalias !789
  %i.ef = mul i64 %i.ee, %i.cu
  %i.eg = load i64, ptr %i.ar, align 8, !tbaa !76, !noalias !789 ; 2 uses
...
bb.f:                                             ; preds = %_ZN4ncnn3MatD2Ev.exit337.us.i
  ...
  %i.ey = load <4 x float>, ptr %i.ex, align 16, !tbaa !108
  %i.ez = load <4 x float>, ptr %i.ew, align 16, !tbaa !108
  %i.fa = fadd fast <4 x float> %i.do, %i.dn
  %i.fb = fadd fast <4 x float> %i.fa, %i.ez      ; 2 uses
  %i.fc = load <4 x float>, ptr %i.ev, align 16, !tbaa !108
  %i.fd = fadd fast <4 x float> %i.dg, %i.df
  %i.fe = fadd fast <4 x float> %i.fd, %i.fc      ; 2 uses
  %i.ff = load <4 x float>, ptr %i.cv, align 16, !tbaa !108
...
bb.g:                                             ; preds = %bb.f
  ...
  store float %.sroa.028.0.vec.extract.us.i, ptr %i.es, align 4, !tbaa !53
  %.sroa.028.4.vec.extract.us.i = extractelement <4 x float> %i.fk, i64 1
  store float %.sroa.028.4.vec.extract.us.i, ptr %i.fq, align 4, !tbaa !53
  %.sroa.028.8.vec.extract.us.i = extractelement <4 x float> %i.fk, i64 2
  store float %.sroa.028.8.vec.extract.us.i, ptr %i.fr, align 4, !tbaa !53
  %.sroa.028.12.vec.extract.us.i = extractelement <4 x float> %i.fk, i64 3
  store float %.sroa.028.12.vec.extract.us.i, ptr %i.fs, align 4, !tbaa !53
...
bb.n:                                             ; preds = %bb.m
  ...
  store float %.sroa.028.0.vec.extract.us.1.i, ptr %.1315.us.i, align 4, !tbaa !53
  %.sroa.028.4.vec.extract.us.1.i = extractelement <4 x float> %i.ge, i64 1
  store float %.sroa.028.4.vec.extract.us.1.i, ptr %i.gj, align 4, !tbaa !53
  %.sroa.028.8.vec.extract.us.1.i = extractelement <4 x float> %i.ge, i64 2
  store float %.sroa.028.8.vec.extract.us.1.i, ptr %i.gk, align 4, !tbaa !53
  %.sroa.028.12.vec.extract.us.1.i = extractelement <4 x float> %i.ge, i64 3
  store float %.sroa.028.12.vec.extract.us.1.i, ptr %i.gl, align 4, !tbaa !53
...
._crit_edge.us.i:                                 ; preds = %bb.r
  ...
  br i1 %i.gs, label %.lr.ph67.split.us.i, label %.preheader55.loopexit.i, !llvm.loop !769
...
.preheader55.i:                                   ; preds = %.lr.ph67.i, %.preheader55.loopexit.i, %._crit_edge
  %.0322.lcssa.i = phi i32 [ 0, %._crit_edge ], [ %i.gt, %.preheader55.loopexit.i ], [ %i.bj, %.lr.ph67.i ] ; 6 uses
...
.lr.ph83.i:                                       ; preds = %.preheader55.i
  ...
  %i.gx = shl nuw nsw i32 %.sroa.speculated117, 1
  %i.gy = zext nneg i32 %i.gx to i64
  %i.gz = shl nuw nsw i32 %.sroa.speculated117, 2
  %i.ha = zext nneg i32 %i.gz to i64
  %i.hb = mul nuw nsw i32 %.sroa.speculated117, 6
  %i.hc = zext nneg i32 %i.hb to i64
  %i.hd = shl nuw nsw i32 %.sroa.speculated117, 3
  %i.he = zext nneg i32 %i.hd to i64              ; 12 uses
  %i.hf = sext i32 %i.bt to i64
  br i1 %i.gw, label %.lr.ph83.split.us.i, label %.lr.ph83.split.i

.lr.ph83.split.us.i:                              ; preds = %.lr.ph83.i
  %i.hg = load i32, ptr %i.an, align 4, !tbaa !86, !noalias !790
  %i.hh = load ptr, ptr %12, align 8, !tbaa !34, !noalias !790
  %i.hi = load i64, ptr %i.aq, align 8, !tbaa !35, !noalias !790
  %i.hj = load i64, ptr %i.ar, align 8, !tbaa !76, !noalias !790 ; 2 uses
...
bb.t:                                             ; preds = %bb.s
  ...
  %i.hn = load <2 x float>, ptr %i.hm, align 4, !tbaa !53
...
_ZN4ncnn3MatD2Ev.exit336.us.i:                    ; preds = %bb.aa, %.thread.us.i
  ...
  %i.hx = load <2 x float>, ptr %i.hu, align 4, !tbaa !53 ; 2 uses
  %i.hy = load <2 x float>, ptr %i.hv, align 4, !tbaa !53 ; 2 uses
  %i.hz = fsub fast <2 x float> %i.hx, %i.hy
  %i.ia = load <2 x float>, ptr %i.hw, align 4, !tbaa !53
  ...
  %i.io = load <2 x float>, ptr %i.id, align 4, !tbaa !53 ; 2 uses
  %i.ip = load <2 x float>, ptr %i.ie, align 4, !tbaa !53 ; 2 uses
  %i.iq = load <2 x float>, ptr %i.if, align 4, !tbaa !53
  %i.ir = load <2 x float>, ptr %i.ih, align 4, !tbaa !53 ; 2 uses
  %i.is = load <2 x float>, ptr %i.ii, align 4, !tbaa !53 ; 2 uses
  %i.it = load <2 x float>, ptr %i.ig, align 4, !tbaa !53
  %i.iu = load <2 x float>, ptr %i.ik, align 4, !tbaa !53
  %i.iv = fadd fast <2 x float> %i.ir, %i.it
  %i.iw = fadd fast <2 x float> %i.iv, %i.is      ; 2 uses
  %i.ix = fsub fast <2 x float> %i.ir, %i.is
  %i.iy = load <2 x float>, ptr %i.ij, align 4, !tbaa !53
  %i.iz = fadd fast <2 x float> %i.iy, %i.ix      ; 2 uses
  %i.ja = load <2 x float>, ptr %i.il, align 4, !tbaa !53 ; 2 uses
  %i.jb = load <2 x float>, ptr %i.im, align 4, !tbaa !53 ; 2 uses
  %i.jc = load <2 x float>, ptr %i.in, align 4, !tbaa !53
...
bb.u:                                             ; preds = %_ZN4ncnn3MatD2Ev.exit336.us.i
  ...
  store float %i.jz, ptr %i.jm, align 4, !tbaa !53
  %i.ka = extractelement <2 x float> %i.jx, i64 1
  store float %i.ka, ptr %i.jy, align 4, !tbaa !53
...
bb.y:                                             ; preds = %bb.x
  ...
  store float %i.kr, ptr %.1306.us.i, align 4, !tbaa !53
  %i.ks = extractelement <2 x float> %i.kp, i64 1
  store float %i.ks, ptr %i.kq, align 4, !tbaa !53
...
bb.aa:                                            ; preds = %bb.z, %bb.y, %bb.x
  ...
  br i1 %exitcond150.not.i, label %._crit_edge.us87.i, label %_ZN4ncnn3MatD2Ev.exit336.us.i, !llvm.loop !772
...
._crit_edge.us87.i:                               ; preds = %bb.aa
  ...
  br i1 %i.lb, label %bb.s, label %.preheader.loopexit.i, !llvm.loop !773

.lr.ph83.split.i:                                 ; preds = %.lr.ph83.i
  %16 = add i32 %.0322.lcssa.i, 3
  %smax138.i = call i32 @llvm.smax.i32(i32 %.sroa.speculated121, i32 %16)
  %reass.sub = sub i32 %smax138.i, %.0322.lcssa.i
  %17 = and i32 %reass.sub, -2
  %i.lc = add i32 %.0322.lcssa.i, %17
  br label %.preheader.i
...
.lr.ph107.i:                                      ; preds = %.preheader.i
  ...
  %i.lh = shl nuw nsw i32 %.sroa.speculated117, 1
  %i.li = zext nneg i32 %i.lh to i64
  %i.lj = mul nuw nsw i32 %.sroa.speculated117, 3
  %i.lk = zext nneg i32 %i.lj to i64
  %i.ll = shl nuw nsw i32 %.sroa.speculated117, 2
  %i.lm = zext nneg i32 %i.ll to i64              ; 12 uses
...
.lr.ph107.split.us.i:                             ; preds = %.lr.ph107.i
  %i.lo = load i32, ptr %i.an, align 4, !tbaa !86, !noalias !791
  %i.lp = load ptr, ptr %12, align 8, !tbaa !34, !noalias !791
  %i.lq = load i64, ptr %i.aq, align 8, !tbaa !35, !noalias !791
  %i.lr = load i64, ptr %i.ar, align 8, !tbaa !76, !noalias !791 ; 2 uses
...
bb.ac:                                            ; preds = %bb.ab
  ...
  %i.lv = load float, ptr %i.lu, align 4, !tbaa !53
...
_ZN4ncnn3MatD2Ev.exit.us.i:                       ; preds = %.split.us114.i, %.lr.ph.us115.i
  %indvars.iv164.i = phi i64 [ 0, %.lr.ph.us115.i ], [ %indvars.iv.next165.i, %.split.us114.i ] ; 3 uses
  ...
  %i.mf = load float, ptr %i.mb, align 4, !tbaa !53
  %i.mg = load float, ptr %i.mc, align 4, !tbaa !53 ; 2 uses
  %i.mh = fadd fast float %i.mg, %i.mf
  %i.mi = load float, ptr %i.md, align 4, !tbaa !53 ; 2 uses
  %i.mj = fadd fast float %i.mh, %i.mi            ; 2 uses
  %i.mk = fsub fast float %i.mg, %i.mi
  %i.ml = load float, ptr %i.me, align 4, !tbaa !53
  ...
  %i.mr = load float, ptr %i.mn, align 4, !tbaa !53
  %i.ms = load float, ptr %i.mo, align 4, !tbaa !53 ; 2 uses
  %i.mt = fadd fast float %i.ms, %i.mr
  %i.mu = load float, ptr %i.mp, align 4, !tbaa !53 ; 2 uses
  %i.mv = fadd fast float %i.mt, %i.mu            ; 2 uses
  %i.mw = fsub fast float %i.ms, %i.mu
  %i.mx = load float, ptr %i.mq, align 4, !tbaa !53
  ...
  %i.nd = load float, ptr %i.mz, align 4, !tbaa !53
  %i.ne = load float, ptr %i.na, align 4, !tbaa !53 ; 2 uses
  %i.nf = fadd fast float %i.ne, %i.nd
  %i.ng = load float, ptr %i.nb, align 4, !tbaa !53 ; 2 uses
  %i.nh = fadd fast float %i.nf, %i.ng            ; 3 uses
  %i.ni = fsub fast float %i.ne, %i.ng
  %i.nj = load float, ptr %i.nc, align 4, !tbaa !53
  ...
  %i.np = load float, ptr %i.nl, align 4, !tbaa !53
  %i.nq = load float, ptr %i.nm, align 4, !tbaa !53 ; 2 uses
  %i.nr = load float, ptr %i.nn, align 4, !tbaa !53 ; 2 uses
  %i.ns = load float, ptr %i.no, align 4, !tbaa !53
...
bb.ad:                                            ; preds = %_ZN4ncnn3MatD2Ev.exit.split.us109.preheader.i
  ...
  store float %i.oh, ptr %i.oc, align 4, !tbaa !53
...
_ZN4ncnn3MatD2Ev.exit.split.us109.1.i:            ; preds = %bb.ad, %_ZN4ncnn3MatD2Ev.exit.split.us109.preheader.i
  %.1.us113.i = phi ptr [ %i.oc, %_ZN4ncnn3MatD2Ev.exit.split.us109.preheader.i ], [ %i.oi, %bb.ad ]
  %i.oj = or disjoint i32 %i.nx, 1
  %.not330.us112.1.i = icmp slt i32 %i.oj, %i.bu
...
bb.ae:                                            ; preds = %_ZN4ncnn3MatD2Ev.exit.split.us109.1.i
  ...
  store float %i.om, ptr %.1.us113.i, align 4, !tbaa !53
...
bb.af:                                            ; preds = %_ZN4ncnn3MatD2Ev.exit.split.us.us.preheader.i
  ...
  store float %i.op, ptr %i.oc, align 4, !tbaa !53
  ...
  store float %i.ot, ptr %i.ou, align 4, !tbaa !53
...
bb.ag:                                            ; preds = %_ZN4ncnn3MatD2Ev.exit.split.us.us.1.i
  ...
  store float %i.oz, ptr %.1.us.us.i, align 4, !tbaa !53
  ...
  store float %i.pd, ptr %i.pe, align 4, !tbaa !53
  br label %.split.us114.i
...
.split.us114.i:                                   ; preds = %bb.ag, %_ZN4ncnn3MatD2Ev.exit.split.us.us.1.i, %bb.ae, %_ZN4ncnn3MatD2Ev.exit.split.us109.1.i
  ...
  br i1 %exitcond168.not.i, label %._crit_edge.us116.i, label %_ZN4ncnn3MatD2Ev.exit.us.i, !llvm.loop !776
...
._crit_edge.us116.i:                              ; preds = %.split.us114.i
  ...
  br i1 %exitcond173.not.i, label %_ZN4ncnnL42conv3x3s1_winograd23_transform_output_tileERKNS_3MatERS0_S2_iiii.exit, label %bb.ab, !llvm.loop !777
...
.noexc:                                           ; preds = %.noexc.preheader, %.noexc
  ...
  %i.pi = load i32, ptr %3, align 4, !tbaa !78
  %i.pj = sdiv i32 %i.at, %i.pi
  %i.pk = load ptr, ptr %10, align 8, !tbaa !34, !noalias !792
  %i.pl = load i64, ptr %i.p, align 8, !tbaa !35, !noalias !792
end_hunk_7
begin_hunk_8_@_ZN4ncnnL23gemm_transB_packed_tileERKNS_3MatES2_RS0_iiiii:bb.a
  ...
  br i1 %niter1182.ncmp.3, label %._crit_edge398.us.unr-lcssa, label %.lr.ph397.us, !llvm.loop !803
...
.lr.ph397.us.epil:                                ; preds = %.lr.ph397.us.epil, %.lr.ph397.us.epil.preheader
  ...
  %i.mh = load <4 x float>, ptr %.0513394.us.epil, align 16, !tbaa !108
  %i.mi = load float, ptr %.9497395.us.epil, align 4, !tbaa !53
  ...
  br i1 %epil.iter.cmp.not, label %._crit_edge398.us, label %.lr.ph397.us.epil, !llvm.loop !804
...
._crit_edge398.us:                                ; preds = %.lr.ph397.us.epil, %._crit_edge398.us.unr-lcssa
  ...
  store <4 x float> %.lcssa1172, ptr %.6478403.us, align 16, !tbaa !108
  ...
  br i1 %exitcond753.not, label %._crit_edge405, label %.lr.ph404.split.us, !llvm.loop !805
...
.lr.ph404.split.split.us.preheader:               ; preds = %.lr.ph404.split
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(1) %.5477.lcssa, i8 0, i64 %i.my, i1 false), !tbaa !108
...
bb.k:                                             ; preds = %.lr.ph388
  %i.mz = load <4 x float>, ptr %.5477387, align 16, !tbaa !108
  %i.na = getelementptr inbounds nuw i8, ptr %.5477387, i64 16
  %i.nb = load <4 x float>, ptr %i.na, align 16, !tbaa !108
  br label %bb.l
...
.lr.ph380:                                        ; preds = %.lr.ph380.preheader, %.lr.ph380
  ...
  %i.nc = load <4 x float>, ptr %.0511377, align 16, !tbaa !108 ; 2 uses
  %i.nd = load float, ptr %.7495378, align 4, !tbaa !53
  ...
  %i.nj = load float, ptr %i.ni, align 4, !tbaa !53
  ...
  %i.nq = load <4 x float>, ptr %i.no, align 16, !tbaa !108 ; 2 uses
  %i.nr = load float, ptr %i.np, align 4, !tbaa !53
  ...
  %niter.ncmp.1 = icmp eq i32 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge381.loopexit.unr-lcssa, label %.lr.ph380, !llvm.loop !806
...
.lr.ph380.epil.preheader:                         ; preds = %._crit_edge381.loopexit.unr-lcssa, %.lr.ph380.preheader
  ...
  %i.oe = load <4 x float>, ptr %.0511377.epil.init, align 16, !tbaa !108 ; 2 uses
  %i.of = load float, ptr %.7495378.epil.init, align 4, !tbaa !53
  ...
  %i.ol = load float, ptr %i.ok, align 4, !tbaa !53
...
._crit_edge381:                                   ; preds = %._crit_edge381.loopexit, %bb.l
  ...
  store <4 x float> %.1269.lcssa, ptr %.5477387, align 16, !tbaa !108
  %i.or = getelementptr inbounds nuw i8, ptr %.5477387, i64 16
  store <4 x float> %.0270.lcssa, ptr %i.or, align 16, !tbaa !108
  ...
  br i1 %i.ov, label %.lr.ph388, label %.preheader282, !llvm.loop !807
...
._crit_edge405:                                   ; preds = %._crit_edge398.us, %.lr.ph404.split.split.preheader, %.lr.ph404.split.split.us.preheader, %.preheader282
  ...
  br i1 %exitcond755.not, label %bb.b, label %bb.c, !llvm.loop !808
...
bb.m:                                             ; preds = %._crit_edge522
  ...
  br i1 %i.qd, label %.preheader280, label %.preheader275.loopexit, !llvm.loop !809
...
bb.n:                                             ; preds = %.preheader280, %._crit_edge522
  ...
  %i.qe = load ptr, ptr %0, align 8, !tbaa !34
  %i.qf = load i32, ptr %i.ab, align 4, !tbaa !86
  %i.qg = sext i32 %i.qf to i64
  %i.qh = mul nsw i64 %indvars.iv769, %i.qg
  %i.qi = load i64, ptr %i.ac, align 8, !tbaa !76
  ...
  %i.qm = load ptr, ptr %1, align 8, !tbaa !34
  %i.qn = load i32, ptr %i.ad, align 4, !tbaa !86
  %i.qo = sext i32 %i.qn to i64
  %i.qp = mul nsw i64 %indvars.iv769, %i.qo
  %i.qq = load i64, ptr %i.ae, align 8, !tbaa !76
...
bb.o:                                             ; preds = %.lr.ph441
  %i.qv = load <4 x float>, ptr %.9481439, align 1, !tbaa !108 ; 2 uses
  %i.qw = getelementptr inbounds nuw i8, ptr %.9481439, i64 16
  %i.qx = load <4 x float>, ptr %i.qw, align 1, !tbaa !108 ; 2 uses
  %i.qy = getelementptr inbounds nuw i8, ptr %.9481439, i64 32
  %i.qz = load <4 x float>, ptr %i.qy, align 1, !tbaa !108 ; 2 uses
  %i.ra = getelementptr inbounds nuw i8, ptr %.9481439, i64 48
  %i.rb = load <4 x float>, ptr %i.ra, align 1, !tbaa !108 ; 2 uses
  %i.rc = getelementptr inbounds nuw i8, ptr %.9481439, i64 64
  %i.rd = load <4 x float>, ptr %i.rc, align 1, !tbaa !108 ; 2 uses
  %i.re = getelementptr inbounds nuw i8, ptr %.9481439, i64 80
  %i.rf = load <4 x float>, ptr %i.re, align 1, !tbaa !108 ; 2 uses
...
.lr.ph428:                                        ; preds = %bb.p, %.lr.ph428
  ...
  %i.rm = load float, ptr %.0532424, align 4, !tbaa !53
  ...
  %i.rq = load float, ptr %i.rp, align 4, !tbaa !53
  ...
  %i.rt = load <4 x float>, ptr %.1518425, align 16, !tbaa !108 ; 2 uses
  %i.ru = getelementptr inbounds nuw i8, ptr %.1518425, i64 16
  %i.rv = load <4 x float>, ptr %i.ru, align 16, !tbaa !108 ; 2 uses
  %i.rw = getelementptr inbounds nuw i8, ptr %.1518425, i64 32
  %i.rx = load <4 x float>, ptr %i.rw, align 16, !tbaa !108 ; 2 uses
  ...
  br i1 %exitcond759.not, label %._crit_edge429, label %.lr.ph428, !llvm.loop !810
...
._crit_edge429:                                   ; preds = %.lr.ph428, %bb.p
  ...
  store <4 x float> %i.sn, ptr %.9481439, align 1, !tbaa !108
  %i.st = getelementptr inbounds nuw i8, ptr %.9481439, i64 16
  store <4 x float> %i.so, ptr %i.st, align 1, !tbaa !108
  %i.su = getelementptr inbounds nuw i8, ptr %.9481439, i64 32
  store <4 x float> %i.sp, ptr %i.su, align 1, !tbaa !108
  %i.sv = getelementptr inbounds nuw i8, ptr %.9481439, i64 48
  store <4 x float> %i.sq, ptr %i.sv, align 1, !tbaa !108
  %i.sw = getelementptr inbounds nuw i8, ptr %.9481439, i64 64
  store <4 x float> %i.sr, ptr %i.sw, align 1, !tbaa !108
  %i.sx = getelementptr inbounds nuw i8, ptr %.9481439, i64 80
  store <4 x float> %i.ss, ptr %i.sx, align 1, !tbaa !108
  ...
  br i1 %i.tb, label %.lr.ph441, label %.preheader279, !llvm.loop !811
...
bb.q:                                             ; preds = %.lr.ph463
  %i.te = load <4 x float>, ptr %.10462, align 1, !tbaa !108 ; 2 uses
  %i.tf = getelementptr inbounds nuw i8, ptr %.10462, i64 16
  %i.tg = load <4 x float>, ptr %i.tf, align 1, !tbaa !108 ; 2 uses
  %i.th = getelementptr inbounds nuw i8, ptr %.10462, i64 32
  %i.ti = load <4 x float>, ptr %i.th, align 1, !tbaa !108 ; 2 uses
  %i.tj = getelementptr inbounds nuw i8, ptr %.10462, i64 48
  %i.tk = load <4 x float>, ptr %i.tj, align 1, !tbaa !108 ; 2 uses
...
.lr.ph513:                                        ; preds = %.lr.ph513.preheader1103, %.lr.ph513
  ...
  %i.zq = load float, ptr %.9526507, align 4, !tbaa !53
  %i.zr = load <2 x float>, ptr %.0461508, align 4, !tbaa !53
  ...
  br i1 %exitcond767.not, label %._crit_edge514.loopexit, label %.lr.ph513, !llvm.loop !820
...
._crit_edge514:                                   ; preds = %._crit_edge514.loopexit, %bb.x
  ...
  store <2 x float> %i.aab, ptr %.13520, align 4, !tbaa !53
  ...
  br i1 %exitcond768.not, label %._crit_edge522, label %.lr.ph521, !llvm.loop !821
...
._crit_edge522:                                   ; preds = %._crit_edge514, %.preheader276
  ...
  br i1 %exitcond773.not, label %bb.m, label %bb.n, !llvm.loop !822
...
bb.y:                                             ; preds = %._crit_edge628
  ...
  br i1 %exitcond802.not, label %._crit_edge634, label %.preheader274, !llvm.loop !823
...
bb.z:                                             ; preds = %.preheader274, %._crit_edge628
  ...
  %i.aaf = load ptr, ptr %0, align 8, !tbaa !34
  %i.aag = load i32, ptr %i.oz, align 4, !tbaa !86
  %i.aah = sext i32 %i.aag to i64
  %i.aai = mul nsw i64 %indvars.iv793, %i.aah
  %i.aaj = load i64, ptr %i.pa, align 8, !tbaa !76
  ...
  %i.aan = load ptr, ptr %1, align 8, !tbaa !34
  %i.aao = load i32, ptr %i.pb, align 4, !tbaa !86
  %i.aap = sext i32 %i.aao to i64
  %i.aaq = mul nsw i64 %indvars.iv793, %i.aap
  %i.aar = load i64, ptr %i.pc, align 8, !tbaa !76
...
bb.aa:                                            ; preds = %.lr.ph547
  %i.aaw = load <4 x float>, ptr %.16543, align 1, !tbaa !108
  %i.aax = getelementptr inbounds nuw i8, ptr %.16543, i64 16
  %i.aay = load <4 x float>, ptr %i.aax, align 1, !tbaa !108
  %i.aaz = getelementptr inbounds nuw i8, ptr %.16543, i64 32
  %i.aba = load <4 x float>, ptr %i.aaz, align 1, !tbaa !108
  br label %bb.ab
...
.lr.ph537:                                        ; preds = %.lr.ph537.preheader, %.lr.ph537
  ...
  %i.abb = load float, ptr %.0447534, align 4, !tbaa !53
  ...
  %i.abe = load <4 x float>, ptr %.1451533, align 16, !tbaa !108
  %i.abf = getelementptr inbounds nuw i8, ptr %.1451533, i64 16
  %i.abg = load <4 x float>, ptr %i.abf, align 16, !tbaa !108
  %i.abh = getelementptr inbounds nuw i8, ptr %.1451533, i64 32
  %i.abi = load <4 x float>, ptr %i.abh, align 16, !tbaa !108
  ...
  %i.abr = load float, ptr %i.abp, align 4, !tbaa !53
  ...
  %i.abu = load <4 x float>, ptr %i.abq, align 16, !tbaa !108
  %i.abv = getelementptr inbounds nuw i8, ptr %.1451533, i64 64
  %i.abw = load <4 x float>, ptr %i.abv, align 16, !tbaa !108
  %i.abx = getelementptr inbounds nuw i8, ptr %.1451533, i64 80
  %i.aby = load <4 x float>, ptr %i.abx, align 16, !tbaa !108
  ...
  br i1 %niter1200.ncmp.1, label %._crit_edge538.loopexit.unr-lcssa, label %.lr.ph537, !llvm.loop !824
...
.lr.ph537.epil.preheader:                         ; preds = %._crit_edge538.loopexit.unr-lcssa, %.lr.ph537.preheader
  ...
  %i.ach = load float, ptr %.0447534.epil.init, align 4, !tbaa !53
  ...
  %i.ack = load <4 x float>, ptr %.1451533.epil.init, align 16, !tbaa !108
  %i.acl = getelementptr inbounds nuw i8, ptr %.1451533.epil.init, i64 16
  %i.acm = load <4 x float>, ptr %i.acl, align 16, !tbaa !108
  %i.acn = getelementptr inbounds nuw i8, ptr %.1451533.epil.init, i64 32
  %i.aco = load <4 x float>, ptr %i.acn, align 16, !tbaa !108
...
._crit_edge538:                                   ; preds = %.lr.ph537.epil.preheader, %._crit_edge538.loopexit.unr-lcssa, %bb.ab
  ...
  store <4 x float> %.1218.lcssa, ptr %.16543, align 1, !tbaa !108
  %i.acw = getelementptr inbounds nuw i8, ptr %.16543, i64 16
  store <4 x float> %.1216.lcssa, ptr %i.acw, align 1, !tbaa !108
  %i.acx = getelementptr inbounds nuw i8, ptr %.16543, i64 32
  store <4 x float> %.0214.lcssa, ptr %i.acx, align 1, !tbaa !108
  ...
  br i1 %i.adb, label %.lr.ph547, label %.preheader273, !llvm.loop !825
...
.preheader272:                                    ; preds = %._crit_edge558, %.preheader273
  ...
  %.1449.lcssa = phi i32 [ %.0448.lcssa, %.preheader273 ], [ %i.ahb, %._crit_edge558 ] ; 9 uses
...
bb.ac:                                            ; preds = %.lr.ph581.split.us
  %i.ade = load <4 x float>, ptr %.18578.us, align 1, !tbaa !108
...
.lr.ph574.us:                                     ; preds = %.lr.ph574.us.preheader, %.lr.ph574.us
  ...
  %i.adf = load float, ptr %.0443571.us, align 4, !tbaa !53
  ...
  %i.adi = load <4 x float>, ptr %.5570.us, align 16, !tbaa !108
  ...
  %i.adn = load float, ptr %i.adl, align 4, !tbaa !53
  ...
  %i.adq = load <4 x float>, ptr %i.adm, align 16, !tbaa !108
  ...
  %i.adv = load float, ptr %i.adt, align 4, !tbaa !53
  ...
  %i.ady = load <4 x float>, ptr %i.adu, align 16, !tbaa !108
  ...
  %i.aed = load float, ptr %i.aeb, align 4, !tbaa !53
  ...
  %i.aeg = load <4 x float>, ptr %i.aec, align 16, !tbaa !108
  ...
  br i1 %niter1215.ncmp.3, label %._crit_edge575.us.unr-lcssa, label %.lr.ph574.us, !llvm.loop !826
...
.lr.ph574.us.epil:                                ; preds = %.lr.ph574.us.epil, %.lr.ph574.us.epil.preheader
  ...
  %i.ael = load float, ptr %.0443571.us.epil, align 4, !tbaa !53
  ...
  %i.aeo = load <4 x float>, ptr %.5570.us.epil, align 16, !tbaa !108
  ...
  br i1 %epil.iter1210.cmp.not, label %._crit_edge575.us, label %.lr.ph574.us.epil, !llvm.loop !827
...
._crit_edge575.us:                                ; preds = %.lr.ph574.us.epil, %._crit_edge575.us.unr-lcssa
  ...
  store <4 x float> %.lcssa1089, ptr %.18578.us, align 1, !tbaa !108
  ...
  br i1 %i.aex, label %.lr.ph581.split.us, label %.preheader271, !llvm.loop !828
...
.lr.ph581.split.split.preheader:                  ; preds = %.lr.ph581.split
  ...
  %7 = add i32 %.1449.lcssa, 7
  %smax = tail call i32 @llvm.smax.i32(i32 %4, i32 %7)
  %8 = add i32 %smax, -4
  %i.aey = sub i32 %8, %.1449.lcssa               ; 2 uses
...
.lr.ph581.split.split.us.preheader:               ; preds = %.lr.ph581.split
  %9 = add i32 %.1449.lcssa, 7
  %smax782 = tail call i32 @llvm.smax.i32(i32 %4, i32 %9)
  %10 = add i32 %smax782, -4
  %i.aff = sub i32 %10, %.1449.lcssa              ; 2 uses
  %i.afg = lshr i32 %i.aff, 2
  %i.afh = zext nneg i32 %i.afg to i64
  %i.afi = shl nuw nsw i64 %i.afh, 4              ; 2 uses
  %i.afj = add nuw nsw i64 %i.afi, 16
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %.17.lcssa, i8 0, i64 %i.afj, i1 false), !tbaa !108
...
bb.ad:                                            ; preds = %.lr.ph565
  %i.afn = load <4 x float>, ptr %.17562, align 1, !tbaa !108
  %i.afo = getelementptr inbounds nuw i8, ptr %.17562, i64 16
  %i.afp = load <4 x float>, ptr %i.afo, align 1, !tbaa !108
  br label %bb.ae
...
.lr.ph557:                                        ; preds = %.lr.ph557.preheader, %.lr.ph557
  ...
  %i.afq = load float, ptr %.0445554, align 4, !tbaa !53
  ...
  %i.aft = load <4 x float>, ptr %.3453553, align 16, !tbaa !108
  %i.afu = getelementptr inbounds nuw i8, ptr %.3453553, i64 16
  %i.afv = load <4 x float>, ptr %i.afu, align 16, !tbaa !108
  ...
  %i.agc = load float, ptr %i.aga, align 4, !tbaa !53
  ...
  %i.agf = load <4 x float>, ptr %i.agb, align 16, !tbaa !108
  %i.agg = getelementptr inbounds nuw i8, ptr %.3453553, i64 48
  %i.agh = load <4 x float>, ptr %i.agg, align 16, !tbaa !108
  ...
  br i1 %niter1208.ncmp.1, label %._crit_edge558.loopexit.unr-lcssa, label %.lr.ph557, !llvm.loop !829
...
.lr.ph557.epil.preheader:                         ; preds = %._crit_edge558.loopexit.unr-lcssa, %.lr.ph557.preheader
  ...
  %i.ago = load float, ptr %.0445554.epil.init, align 4, !tbaa !53
  ...
  %i.agr = load <4 x float>, ptr %.3453553.epil.init, align 16, !tbaa !108
  %i.ags = getelementptr inbounds nuw i8, ptr %.3453553.epil.init, i64 16
  %i.agt = load <4 x float>, ptr %i.ags, align 16, !tbaa !108
...
._crit_edge558:                                   ; preds = %._crit_edge558.loopexit, %bb.ae
  ...
  store <4 x float> %.1205.lcssa, ptr %.17562, align 1, !tbaa !108
  %i.agz = getelementptr inbounds nuw i8, ptr %.17562, i64 16
  store <4 x float> %.0203.lcssa, ptr %i.agz, align 1, !tbaa !108
  ...
  br i1 %i.ahd, label %.lr.ph565, label %.preheader272, !llvm.loop !830
...
bb.af:                                            ; preds = %.lr.ph611
  %i.ahj = load <2 x float>, ptr %.19608, align 4, !tbaa !53
  br label %bb.ag
...
vector.body1052:                                  ; preds = %vector.body1052, %vector.ph1050
  ...
  %wide.load1061 = load <4 x float>, ptr %next.gep1058.a, align 4, !tbaa !53 ; 2 uses
  %wide.load1062 = load <4 x float>, ptr %i.ahs, align 4, !tbaa !53 ; 2 uses
  %wide.vec1063 = load <8 x float>, ptr %next.gep1059, align 4, !tbaa !53 ; 2 uses
  ...
  %wide.vec1066 = load <8 x float>, ptr %next.gep1060, align 4, !tbaa !53 ; 2 uses
  ...
  br i1 %i.aib, label %middle.block1070, label %vector.body1052, !llvm.loop !831
...
_ZN4ncnn3Mat7channelEi.exit76:                    ; preds = %bb.c
  %i.av = load ptr, ptr %4, align 8, !tbaa !34, !noalias !908
  %i.aw = load i64, ptr %i.l, align 8, !tbaa !35, !noalias !908
  %i.ax = sext i32 %i.au to i64
  %i.ay = mul i64 %i.aw, %i.ax
  %i.az = load i64, ptr %i.m, align 8, !tbaa !76, !noalias !908
  %i.ba = mul i64 %i.ay, %i.az
  %i.bb = getelementptr inbounds nuw i8, ptr %i.av, i64 %i.ba ; 4 uses
  %i.bc = load i32, ptr %5, align 4, !tbaa !78
  %i.bd = sub nsw i32 %i.bc, %i.at
...
.noexc.preheader:                                 ; preds = %bb.d
  %.pre143 = load i32, ptr %9, align 4, !tbaa !78
  br label %.noexc

._crit_edge:                                      ; preds = %.noexc, %bb.d
  %.val78 = load ptr, ptr %13, align 8, !tbaa !34 ; 6 uses
  %i.bt = load i32, ptr %i.an, align 4, !tbaa !86 ; 13 uses
  %i.bu = load i32, ptr %i.ao, align 8, !tbaa !87 ; 12 uses
  %i.bv = load i32, ptr %i.ap, align 8, !tbaa !77 ; 8 uses
  %i.bw = load i64, ptr %i.aq, align 8, !tbaa !35
  %i.bx = sext i32 %i.bv to i64
...
.lr.ph100.i:                                      ; preds = %._crit_edge
  ...
  %i.ch = mul nuw nsw i32 %.sroa.speculated117, 12
  %i.ci = zext nneg i32 %i.ch to i64
  %i.cj = shl nuw nsw i32 %.sroa.speculated117, 4
  %i.ck = zext nneg i32 %i.cj to i64
  %i.cl = mul nuw nsw i32 %.sroa.speculated117, 20
  %i.cm = zext nneg i32 %i.cl to i64
  %i.cn = mul nuw nsw i32 %.sroa.speculated117, 24
  %i.co = zext nneg i32 %i.cn to i64              ; 30 uses
...
bb.e:                                             ; preds = %.lr.ph100.split.us.i
  ...
  %i.cs = load <4 x float>, ptr %i.cr, align 1, !tbaa !108
  br label %.lr.ph.us.i
...
_ZN4ncnn3MatD2Ev.exit524.us.i:                    ; preds = %bb.bl, %.lr.ph.us.i
  ...
  %i.dg = load <4 x float>, ptr %i.db, align 16, !tbaa !108 ; 2 uses
  %i.dh = load <4 x float>, ptr %i.dc, align 16, !tbaa !108 ; 2 uses
  %i.di = load <4 x float>, ptr %i.dd, align 16, !tbaa !108 ; 2 uses
  %i.dj = load <4 x float>, ptr %i.de, align 16, !tbaa !108 ; 2 uses
  %i.dk = load <4 x float>, ptr %i.df, align 16, !tbaa !108
  ...
  %i.eb = load <4 x float>, ptr %i.dw, align 16, !tbaa !108 ; 2 uses
  %i.ec = load <4 x float>, ptr %i.dx, align 16, !tbaa !108 ; 2 uses
  %i.ed = load <4 x float>, ptr %i.dy, align 16, !tbaa !108 ; 2 uses
  %i.ee = load <4 x float>, ptr %i.dz, align 16, !tbaa !108 ; 2 uses
  %i.ef = load <4 x float>, ptr %i.ea, align 16, !tbaa !108
  ...
  %i.ez = load <4 x float>, ptr %i.eu, align 16, !tbaa !108 ; 2 uses
  %i.fa = load <4 x float>, ptr %i.ev, align 16, !tbaa !108 ; 2 uses
  %i.fb = load <4 x float>, ptr %i.ew, align 16, !tbaa !108 ; 2 uses
  %i.fc = load <4 x float>, ptr %i.ex, align 16, !tbaa !108 ; 2 uses
  %i.fd = load <4 x float>, ptr %i.ey, align 16, !tbaa !108
  ...
  %i.fx = load <4 x float>, ptr %i.fs, align 16, !tbaa !108 ; 2 uses
  %i.fy = load <4 x float>, ptr %i.ft, align 16, !tbaa !108 ; 2 uses
  %i.fz = load <4 x float>, ptr %i.fu, align 16, !tbaa !108 ; 2 uses
  %i.ga = load <4 x float>, ptr %i.fv, align 16, !tbaa !108 ; 2 uses
  %i.gb = load <4 x float>, ptr %i.fw, align 16, !tbaa !108
  ...
  %i.gv = load <4 x float>, ptr %i.gq, align 16, !tbaa !108 ; 2 uses
  %i.gw = load <4 x float>, ptr %i.gr, align 16, !tbaa !108 ; 2 uses
  %i.gx = load <4 x float>, ptr %i.gs, align 16, !tbaa !108 ; 2 uses
  %i.gy = load <4 x float>, ptr %i.gt, align 16, !tbaa !108 ; 2 uses
  %i.gz = load <4 x float>, ptr %i.gu, align 16, !tbaa !108
...
bb.at:                                            ; preds = %bb.as
  ...
  store <4 x float> %i.nx, ptr %i.ou, align 16, !tbaa !108
  br label %bb.au
...
bb.av:                                            ; preds = %bb.au
  ...
  store <4 x float> %i.od, ptr %i.ov, align 16, !tbaa !108
  br label %bb.aw
...
bb.az:                                            ; preds = %bb.ay
  ...
  store float %.sroa.028.0.vec.extract.us.3.i, ptr %.1503.us.2.i, align 4, !tbaa !53
  %.sroa.028.4.vec.extract.us.3.i = extractelement <4 x float> %i.pf, i64 1
  store float %.sroa.028.4.vec.extract.us.3.i, ptr %i.pr, align 4, !tbaa !53
  %.sroa.028.8.vec.extract.us.3.i = extractelement <4 x float> %i.pf, i64 2
  store float %.sroa.028.8.vec.extract.us.3.i, ptr %i.ps, align 4, !tbaa !53
  %.sroa.028.12.vec.extract.us.3.i = extractelement <4 x float> %i.pf, i64 3
  store float %.sroa.028.12.vec.extract.us.3.i, ptr %i.pt, align 4, !tbaa !53
...
bb.bi:                                            ; preds = %bb.bh
  ...
  store <4 x float> %i.pn, ptr %i.qh, align 16, !tbaa !108
  br label %bb.bj
...
bb.bk:                                            ; preds = %bb.bj
  ...
  store <4 x float> %i.pq, ptr %i.qi, align 16, !tbaa !108
  br label %bb.bl

bb.bl:                                            ; preds = %bb.bk, %bb.bj, %bb.be, %bb.bd, %bb.ay, %bb.ax
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %wide.trip.count.i
  br i1 %exitcond.not.i, label %._crit_edge.us.i, label %_ZN4ncnn3MatD2Ev.exit524.us.i, !llvm.loop !888
...
._crit_edge.us.i:                                 ; preds = %bb.bl
  ...
  br i1 %i.qk, label %.lr.ph100.split.us.i, label %.preheader86.loopexit.i, !llvm.loop !889
...
.preheader86.i:                                   ; preds = %.lr.ph100.i, %.preheader86.loopexit.i, %._crit_edge
  %.0490.lcssa.i = phi i32 [ 0, %._crit_edge ], [ %i.ql, %.preheader86.loopexit.i ], [ %i.bj, %.lr.ph100.i ] ; 6 uses
...
.lr.ph118.i:                                      ; preds = %.preheader86.i
  ...
  %i.qp = shl nuw nsw i32 %.sroa.speculated117, 1
  %i.qq = zext nneg i32 %i.qp to i64
  %i.qr = shl nuw nsw i32 %.sroa.speculated117, 2
  %i.qs = zext nneg i32 %i.qr to i64
  %i.qt = mul nuw nsw i32 %.sroa.speculated117, 6
  %i.qu = zext nneg i32 %i.qt to i64
  %i.qv = shl nuw nsw i32 %.sroa.speculated117, 3
  %i.qw = zext nneg i32 %i.qv to i64
  %i.qx = mul nuw nsw i32 %.sroa.speculated117, 10
  %i.qy = zext nneg i32 %i.qx to i64
  %i.qz = mul nuw nsw i32 %.sroa.speculated117, 12
  %i.ra = zext nneg i32 %i.qz to i64              ; 30 uses
...
.lr.ph118.split.us.i:                             ; preds = %.lr.ph118.i
  %i.rc = load i32, ptr %i.an, align 4, !tbaa !86, !noalias !910
  %i.rd = load ptr, ptr %12, align 8, !tbaa !34, !noalias !910
  %i.re = load i64, ptr %i.aq, align 8, !tbaa !35, !noalias !910
  %i.rf = load i64, ptr %i.ar, align 8, !tbaa !76, !noalias !910 ; 2 uses
...
bb.bn:                                            ; preds = %bb.bm
  ...
  %i.rj = load <2 x float>, ptr %i.ri, align 4, !tbaa !53
  br label %.thread.us.i
...
_ZN4ncnn3MatD2Ev.exit523.us.i:                    ; preds = %bb.cs, %.thread.us.i
  ...
  %i.rx = load <2 x float>, ptr %i.rw, align 4, !tbaa !53 ; 2 uses
  %i.ry = load <2 x float>, ptr %i.rv, align 4, !tbaa !53 ; 2 uses
  %i.rz = fadd fast <2 x float> %i.ry, %i.rx      ; 2 uses
  %i.sa = load <2 x float>, ptr %i.ru, align 4, !tbaa !53 ; 2 uses
  %i.sb = load <2 x float>, ptr %i.rt, align 4, !tbaa !53 ; 2 uses
  ...
  %i.sl = load <2 x float>, ptr %i.rs, align 4, !tbaa !53
  ...
  %i.sv = load <2 x float>, ptr %i.sq, align 4, !tbaa !53 ; 2 uses
  %i.sw = load <2 x float>, ptr %i.sr, align 4, !tbaa !53 ; 2 uses
  %i.sx = fadd fast <2 x float> %i.sw, %i.sv      ; 2 uses
  %i.sy = load <2 x float>, ptr %i.ss, align 4, !tbaa !53 ; 2 uses
  %i.sz = load <2 x float>, ptr %i.st, align 4, !tbaa !53 ; 2 uses
  ...
  %i.tj = load <2 x float>, ptr %i.su, align 4, !tbaa !53
  ...
  %i.tt = load <2 x float>, ptr %i.to, align 4, !tbaa !53 ; 2 uses
  %i.tu = load <2 x float>, ptr %i.tp, align 4, !tbaa !53 ; 2 uses
  %i.tv = fadd fast <2 x float> %i.tu, %i.tt      ; 2 uses
  %i.tw = load <2 x float>, ptr %i.tq, align 4, !tbaa !53 ; 2 uses
  %i.tx = load <2 x float>, ptr %i.tr, align 4, !tbaa !53 ; 2 uses
  ...
  %i.uh = load <2 x float>, ptr %i.ts, align 4, !tbaa !53
  ...
  %i.ur = load <2 x float>, ptr %i.um, align 4, !tbaa !53 ; 2 uses
  %i.us = load <2 x float>, ptr %i.un, align 4, !tbaa !53 ; 2 uses
  %i.ut = fadd fast <2 x float> %i.us, %i.ur      ; 2 uses
  %i.uu = load <2 x float>, ptr %i.uo, align 4, !tbaa !53 ; 2 uses
  %i.uv = load <2 x float>, ptr %i.up, align 4, !tbaa !53 ; 2 uses
  ...
  %i.vf = load <2 x float>, ptr %i.uq, align 4, !tbaa !53
  ...
  %i.vp = load <2 x float>, ptr %i.vk, align 4, !tbaa !53 ; 2 uses
  %i.vq = load <2 x float>, ptr %i.vl, align 4, !tbaa !53 ; 2 uses
  %i.vr = fadd fast <2 x float> %i.vq, %i.vp      ; 2 uses
  %i.vs = load <2 x float>, ptr %i.vm, align 4, !tbaa !53 ; 2 uses
  %i.vt = load <2 x float>, ptr %i.vn, align 4, !tbaa !53 ; 2 uses
  ...
  %i.wd = load <2 x float>, ptr %i.vo, align 4, !tbaa !53
  ...
  %i.wn = load <2 x float>, ptr %i.wi, align 4, !tbaa !53 ; 2 uses
  %i.wo = load <2 x float>, ptr %i.wj, align 4, !tbaa !53 ; 2 uses
  %i.wp = fadd fast <2 x float> %i.wo, %i.wn      ; 2 uses
  %i.wq = load <2 x float>, ptr %i.wk, align 4, !tbaa !53 ; 2 uses
  %i.wr = load <2 x float>, ptr %i.wl, align 4, !tbaa !53 ; 2 uses
  ...
  %i.xb = load <2 x float>, ptr %i.wm, align 4, !tbaa !53
end_hunk_11
begin_hunk_12_@_ZN4ncnnL20conv3x3s1_winograd43ERKNS_3MatERS0_S2_S2_iRKNS_6OptionE.omp_outlined.4:bb.a
  ...
  store float %i.abp, ptr %i.abo, align 4, !tbaa !53
  br label %bb.by
...
bb.bz:                                            ; preds = %bb.by
  ...
  store float %i.aax, ptr %i.abq, align 4, !tbaa !53
...
bb.cb:                                            ; preds = %bb.ca
  ...
  store float %i.abe, ptr %i.abt, align 4, !tbaa !53
  br label %bb.cc
...
bb.ce:                                            ; preds = %bb.cd
  ...
  store float %i.acu, ptr %.1489.us.1.i, align 4, !tbaa !53
  %i.acv = extractelement <2 x float> %i.acc, i64 1
  store float %i.acv, ptr %i.act, align 4, !tbaa !53
...
bb.cf:                                            ; preds = %bb.ce
  ...
  store float %i.adb, ptr %i.ada, align 4, !tbaa !53
...
bb.ch:                                            ; preds = %bb.cg
  ...
  store float %i.acl, ptr %i.ade, align 4, !tbaa !53
...
bb.cj:                                            ; preds = %bb.ci
  ...
  store float %i.acs, ptr %i.adh, align 4, !tbaa !53
  br label %bb.ck
...
bb.cm:                                            ; preds = %bb.cl
  ...
  store float %i.aei, ptr %.1489.us.2.i, align 4, !tbaa !53
  %i.aej = extractelement <2 x float> %i.adq, i64 1
  store float %i.aej, ptr %i.aeh, align 4, !tbaa !53
...
bb.cp:                                            ; preds = %bb.co
  ...
  store float %i.adz, ptr %i.aes, align 4, !tbaa !53
...
bb.cr:                                            ; preds = %bb.cq
  ...
  store float %i.aeg, ptr %i.aev, align 4, !tbaa !53
  br label %bb.cs
...
bb.cs:                                            ; preds = %bb.cr, %bb.cq, %bb.cl
  ...
  br i1 %exitcond181.not.i, label %._crit_edge.us122.i, label %_ZN4ncnn3MatD2Ev.exit523.us.i, !llvm.loop !892
...
._crit_edge.us122.i:                              ; preds = %bb.cs
  ...
  br i1 %i.aew, label %bb.bm, label %.preheader.loopexit.i, !llvm.loop !893

.lr.ph118.split.i:                                ; preds = %.lr.ph118.i
  %16 = add i32 %.0490.lcssa.i, 3
  %smax168.i = call i32 @llvm.smax.i32(i32 %.sroa.speculated121, i32 %16)
  %reass.sub = sub i32 %smax168.i, %.0490.lcssa.i
  %17 = and i32 %reass.sub, -2
  %i.aex = add i32 %.0490.lcssa.i, %17
  br label %.preheader.i
...
.lr.ph144.i:                                      ; preds = %.preheader.i
  ...
  %i.afc = shl nuw nsw i32 %.sroa.speculated117, 1
  %i.afd = zext nneg i32 %i.afc to i64
  %i.afe = mul nuw nsw i32 %.sroa.speculated117, 3
  %i.aff = zext nneg i32 %i.afe to i64
  %i.afg = shl nuw nsw i32 %.sroa.speculated117, 2
  %i.afh = zext nneg i32 %i.afg to i64
  %i.afi = mul nuw nsw i32 %.sroa.speculated117, 5
  %i.afj = zext nneg i32 %i.afi to i64
  %i.afk = mul nuw nsw i32 %.sroa.speculated117, 6
  %i.afl = zext nneg i32 %i.afk to i64            ; 30 uses
...
.lr.ph144.split.us.i:                             ; preds = %.lr.ph144.i
  %i.afn = load i32, ptr %i.an, align 4, !tbaa !86, !noalias !911
  %i.afo = load ptr, ptr %12, align 8, !tbaa !34, !noalias !911
  %i.afp = load i64, ptr %i.aq, align 8, !tbaa !35, !noalias !911
  %i.afq = load i64, ptr %i.ar, align 8, !tbaa !76, !noalias !911 ; 2 uses
...
bb.cu:                                            ; preds = %bb.ct
  ...
  %i.afu = load float, ptr %i.aft, align 4, !tbaa !53
...
_ZN4ncnn3MatD2Ev.exit.us.i:                       ; preds = %bb.dz, %.lr.ph.us146.i
  ...
  %i.agh = load float, ptr %i.agc, align 4, !tbaa !53 ; 2 uses
  %i.agi = load float, ptr %i.agd, align 4, !tbaa !53 ; 2 uses
  %i.agj = fadd fast float %i.agi, %i.agh         ; 2 uses
  %i.agk = load float, ptr %i.age, align 4, !tbaa !53 ; 2 uses
  %i.agl = load float, ptr %i.agf, align 4, !tbaa !53 ; 2 uses
  ...
  %i.agt = load float, ptr %i.agg, align 4, !tbaa !53
  ...
  %i.ahd = load float, ptr %i.agy, align 4, !tbaa !53 ; 2 uses
  %i.ahe = load float, ptr %i.agz, align 4, !tbaa !53 ; 2 uses
  %i.ahf = load float, ptr %i.aha, align 4, !tbaa !53 ; 2 uses
  %i.ahg = load float, ptr %i.ahb, align 4, !tbaa !53 ; 2 uses
  ...
  %i.ahn = load float, ptr %i.ahi, align 4, !tbaa !53 ; 2 uses
  %i.aho = load float, ptr %i.ahj, align 4, !tbaa !53 ; 2 uses
  %i.ahp = load float, ptr %i.ahk, align 4, !tbaa !53 ; 2 uses
  %i.ahq = load float, ptr %i.ahl, align 4, !tbaa !53 ; 2 uses
  %i.ahr = load float, ptr %i.ahm, align 4, !tbaa !53
  ...
  %i.ahx = load float, ptr %i.ahs, align 4, !tbaa !53 ; 2 uses
  %i.ahy = load float, ptr %i.aht, align 4, !tbaa !53 ; 2 uses
  %i.ahz = load float, ptr %i.ahu, align 4, !tbaa !53 ; 2 uses
  %i.aia = load float, ptr %i.ahv, align 4, !tbaa !53 ; 2 uses
  %i.aib = load float, ptr %i.ahw, align 4, !tbaa !53
  ...
  %i.aih = load float, ptr %i.aic, align 4, !tbaa !53 ; 2 uses
  %i.aii = load float, ptr %i.aid, align 4, !tbaa !53 ; 2 uses
  %i.aij = load float, ptr %i.aie, align 4, !tbaa !53 ; 2 uses
  %i.aik = load float, ptr %i.aif, align 4, !tbaa !53 ; 2 uses
  ...
  %i.ajg = load float, ptr %i.aig, align 4, !tbaa !53
  ...
  %i.akw = load float, ptr %i.akr, align 4, !tbaa !53 ; 2 uses
  %i.akx = load float, ptr %i.aks, align 4, !tbaa !53 ; 2 uses
  %i.aky = fadd fast float %i.akx, %i.akw         ; 2 uses
  %i.akz = load float, ptr %i.akt, align 4, !tbaa !53 ; 2 uses
  %i.ala = load float, ptr %i.aku, align 4, !tbaa !53 ; 2 uses
...
bb.c:                                             ; preds = %.lr.ph135, %_ZN4ncnn3MatD2Ev.exit
  ...
  %i.bk = load i32, ptr %3, align 4, !tbaa !78
...
_ZN4ncnn3Mat7channelEi.exit76:                    ; preds = %bb.c
  %i.bn = load ptr, ptr %4, align 8, !tbaa !34, !noalias !974
  %i.bo = load i64, ptr %i.o, align 8, !tbaa !35, !noalias !974
  %i.bp = sext i32 %i.bm to i64
  %i.bq = mul i64 %i.bo, %i.bp
  %i.br = load i64, ptr %i.p, align 8, !tbaa !76, !noalias !974
  %i.bs = mul i64 %i.bq, %i.br
  %i.bt = getelementptr inbounds nuw i8, ptr %i.bn, i64 %i.bs ; 4 uses
  %i.bu = load i32, ptr %5, align 4, !tbaa !78
  %i.bv = sub nsw i32 %i.bu, %i.bl
  %i.bw = load i32, ptr %3, align 4, !tbaa !78
  %.sroa.speculated121 = call i32 @llvm.smin.i32(i32 %i.bw, i32 %i.bv) ; 8 uses
  %i.bx = load i32, ptr %6, align 4, !tbaa !78    ; 2 uses
...
_ZN4ncnn3MatD2Ev.exit:                            ; preds = %_ZN4ncnnL42conv3x3s1_winograd63_transform_output_tileERKNS_3MatERS0_S2_iiii.exit, %_ZN4ncnn3Mat7channelEi.exit76
  ...
  %i.cf = load i32, ptr %i.e, align 4, !tbaa !78
...
bb.d:                                             ; preds = %.lr.ph, %_ZN4ncnnL42conv3x3s1_winograd63_transform_output_tileERKNS_3MatERS0_S2_iiii.exit
  ...
  %i.cj = load i32, ptr %8, align 4, !tbaa !78    ; 2 uses
  %i.ck = icmp sgt i32 %i.cj, 0
  br i1 %i.ck, label %.noexc.preheader, label %._crit_edge

.noexc.preheader:                                 ; preds = %bb.d
  %.pre137 = load i32, ptr %9, align 4, !tbaa !78
  br label %.noexc

._crit_edge:                                      ; preds = %.noexc, %bb.d
  %.val78 = load ptr, ptr %13, align 8, !tbaa !34 ; 6 uses
  %i.cl = load i32, ptr %i.aq, align 4, !tbaa !86 ; 19 uses
  %i.cm = load i32, ptr %i.ar, align 8, !tbaa !87 ; 3 uses
  %i.cn = load i32, ptr %i.as, align 8, !tbaa !77 ; 5 uses
  %i.co = load i64, ptr %i.at, align 8, !tbaa !35
...
.lr.ph140.i:                                      ; preds = %._crit_edge
  ...
  %i.cv = shl nuw nsw i32 %.sroa.speculated117, 2
  %i.cw = zext nneg i32 %i.cv to i64
  %i.cx = shl nuw nsw i32 %.sroa.speculated117, 3
  %i.cy = zext nneg i32 %i.cx to i64
  %i.cz = mul nuw nsw i32 %.sroa.speculated117, 12
  %i.da = zext nneg i32 %i.cz to i64
  %i.db = shl nuw nsw i32 %.sroa.speculated117, 4
  %i.dc = zext nneg i32 %i.db to i64
  %i.dd = mul nuw nsw i32 %.sroa.speculated117, 20
  %i.de = zext nneg i32 %i.dd to i64
  %i.df = mul nuw nsw i32 %.sroa.speculated117, 24
  %i.dg = zext nneg i32 %i.df to i64
  %i.dh = mul nuw nsw i32 %.sroa.speculated117, 28
  %i.di = zext nneg i32 %i.dh to i64
  %i.dj = shl nuw nsw i32 %.sroa.speculated117, 5
  %i.dk = zext nneg i32 %i.dj to i64              ; 8 uses
...
bb.e:                                             ; preds = %.lr.ph140.split.us.i
  ...
  %i.dp = load <4 x float>, ptr %i.do, align 1, !tbaa !108
  br label %.lr.ph.us.i
...
bb.g:                                             ; preds = %bb.g, %bb.f
  ...
  %i.ef = load <4 x float>, ptr %.0706133.us.i, align 16, !tbaa !108
  %i.eg = load <4 x float>, ptr %.0707132.us.i, align 16, !tbaa !108 ; 2 uses
  %i.eh = load <4 x float>, ptr %.0708131.us.i, align 16, !tbaa !108 ; 2 uses
  %i.ei = load <4 x float>, ptr %.0709130.us.i, align 16, !tbaa !108 ; 2 uses
  %i.ej = load <4 x float>, ptr %.0710129.us.i, align 16, !tbaa !108 ; 2 uses
  %i.ek = load <4 x float>, ptr %.0711128.us.i, align 16, !tbaa !108 ; 2 uses
  %i.el = load <4 x float>, ptr %.0712127.us.i, align 16, !tbaa !108 ; 2 uses
  %i.em = load <4 x float>, ptr %.0726126.us.i, align 16, !tbaa !108
  ...
  br i1 %exitcond.not.i, label %_ZN4ncnn3MatD2Ev.exit741.us.i, label %bb.g, !llvm.loop !946
...
_ZN4ncnn3MatD2Ev.exit741.us.i:                    ; preds = %bb.g
  ...
  %i.gj = load i32, ptr %i.aq, align 4, !tbaa !86, !noalias !975
  %i.gk = load ptr, ptr %12, align 8, !tbaa !34, !noalias !975
  %i.gl = load i64, ptr %i.at, align 8, !tbaa !35, !noalias !975
  %i.gm = mul i64 %i.gl, %i.dw
  %i.gn = load i64, ptr %i.az, align 8, !tbaa !76, !noalias !975 ; 2 uses
...
bb.j:                                             ; preds = %bb.i
  ...
  store float %.sroa.028.0.vec.extract.us.i, ptr %.0724134.us.i, align 4, !tbaa !53
  %.sroa.028.4.vec.extract.us.i = extractelement <4 x float> %i.ik, i64 1
  store float %.sroa.028.4.vec.extract.us.i, ptr %i.jk, align 4, !tbaa !53
  %.sroa.028.8.vec.extract.us.i = extractelement <4 x float> %i.ik, i64 2
  store float %.sroa.028.8.vec.extract.us.i, ptr %i.jl, align 4, !tbaa !53
  %.sroa.028.12.vec.extract.us.i = extractelement <4 x float> %i.ik, i64 3
  store float %.sroa.028.12.vec.extract.us.i, ptr %i.jm, align 4, !tbaa !53
...
bb.w:                                             ; preds = %bb.v
  ...
  store <4 x float> %i.iu, ptr %i.ki, align 16, !tbaa !108
  br label %bb.x
...
bb.y:                                             ; preds = %bb.x
  ...
  store <4 x float> %i.iz, ptr %i.kj, align 16, !tbaa !108
  br label %bb.z
...
bb.aa:                                            ; preds = %bb.z
  ...
  store <4 x float> %i.je, ptr %i.kk, align 16, !tbaa !108
  br label %bb.ab
...
bb.ac:                                            ; preds = %bb.ab
  ...
  store <4 x float> %i.jj, ptr %i.kl, align 16, !tbaa !108
  br label %bb.ad
...
bb.ae:                                            ; preds = %bb.ad, %bb.h
  ...
  br i1 %exitcond210.not.i, label %bb.af, label %bb.h, !llvm.loop !949
...
bb.af:                                            ; preds = %bb.ae
  ...
  br i1 %exitcond214.not.i, label %._crit_edge.us.i, label %bb.f, !llvm.loop !950
...
._crit_edge.us.i:                                 ; preds = %bb.af
  ...
  br i1 %i.ko, label %.lr.ph140.split.us.i, label %.preheader124.loopexit.i, !llvm.loop !951
...
.preheader124.i:                                  ; preds = %.lr.ph140.i, %.preheader124.loopexit.i, %._crit_edge
  %.0703.lcssa.i = phi i32 [ 0, %._crit_edge ], [ %i.kp, %.preheader124.loopexit.i ], [ %i.cb, %.lr.ph140.i ] ; 6 uses
...
.lr.ph160.i:                                      ; preds = %.preheader124.i
  ...
  %i.kt = shl nuw nsw i32 %.sroa.speculated117, 1
  %i.ku = zext nneg i32 %i.kt to i64
  %i.kv = shl nuw nsw i32 %.sroa.speculated117, 2
  %i.kw = zext nneg i32 %i.kv to i64
  %i.kx = mul nuw nsw i32 %.sroa.speculated117, 6
  %i.ky = zext nneg i32 %i.kx to i64
  %i.kz = shl nuw nsw i32 %.sroa.speculated117, 3
  %i.la = zext nneg i32 %i.kz to i64
  %i.lb = mul nuw nsw i32 %.sroa.speculated117, 10
  %i.lc = zext nneg i32 %i.lb to i64
  %i.ld = mul nuw nsw i32 %.sroa.speculated117, 12
  %i.le = zext nneg i32 %i.ld to i64
  %i.lf = mul nuw nsw i32 %.sroa.speculated117, 14
  %i.lg = zext nneg i32 %i.lf to i64
  %i.lh = shl nuw nsw i32 %.sroa.speculated117, 4
  %i.li = zext nneg i32 %i.lh to i64              ; 8 uses
  %i.lj = sext i32 %i.cl to i64
  br i1 %i.ks, label %.lr.ph160.split.us.i, label %.lr.ph160.split.i

.lr.ph160.split.us.i:                             ; preds = %.lr.ph160.i
  %i.lk = load i32, ptr %i.aq, align 4, !tbaa !86, !noalias !976
  %i.ll = load ptr, ptr %12, align 8, !tbaa !34, !noalias !976
  %i.lm = load i64, ptr %i.at, align 8, !tbaa !35, !noalias !976
  %i.ln = load i64, ptr %i.az, align 8, !tbaa !76, !noalias !976 ; 2 uses
...
bb.ah:                                            ; preds = %bb.ag
  ...
  %i.ls = load <2 x float>, ptr %i.lr, align 4, !tbaa !53
  br label %.thread.us.i
...
bb.aj:                                            ; preds = %bb.aj, %bb.ai
  ...
  %i.mh = load <2 x float>, ptr %.0720145.us.i, align 4, !tbaa !53 ; 2 uses
  %i.mi = load <2 x float>, ptr %.0719146.us.i, align 4, !tbaa !53 ; 2 uses
  %i.mj = fadd fast <2 x float> %i.mi, %i.mh      ; 3 uses
  %i.mk = load <2 x float>, ptr %.0718147.us.i, align 4, !tbaa !53 ; 2 uses
  %i.ml = load <2 x float>, ptr %.0717148.us.i, align 4, !tbaa !53 ; 2 uses
  %i.mm = fadd fast <2 x float> %i.ml, %i.mk      ; 3 uses
  %i.mn = load <2 x float>, ptr %.0716149.us.i, align 4, !tbaa !53 ; 2 uses
  %i.mo = load <2 x float>, ptr %.0715150.us.i, align 4, !tbaa !53 ; 2 uses
  %i.mp = fadd fast <2 x float> %i.mo, %i.mn      ; 3 uses
  %i.mq = load <2 x float>, ptr %.0721144.us.i, align 4, !tbaa !53
  ...
  store <2 x float> %i.mu, ptr %i.mg, align 8, !tbaa !53
  ...
  store <2 x float> %i.nc, ptr %i.mv, align 8, !tbaa !53
  ...
  store <2 x float> %i.nh, ptr %i.nd, align 8, !tbaa !53
  ...
  store <2 x float> %i.nm, ptr %i.ni, align 8, !tbaa !53
  ...
  store <2 x float> %i.nr, ptr %i.nn, align 8, !tbaa !53
  %i.ns = getelementptr inbounds nuw [8 x i8], ptr %i.be, i64 %indvars.iv219.i
  %i.nt = load <2 x float>, ptr %.0714151.us.i, align 4, !tbaa !53
  ...
  store <2 x float> %i.nx, ptr %i.ns, align 8, !tbaa !53
  ...
  br i1 %exitcond222.not.i, label %_ZN4ncnn3MatD2Ev.exit740.us.i, label %bb.aj, !llvm.loop !954
...
bb.al:                                            ; preds = %bb.ak
  ...
  %i.pi = load float, ptr %i.ph, align 8, !tbaa !53
  %i.pj = getelementptr inbounds nuw i8, ptr %i.pa, i64 60
  %i.pk = load float, ptr %i.pj, align 4, !tbaa !53
  %i.pl = load <2 x float>, ptr %i.pb, align 8, !tbaa !53 ; 2 uses
  %i.pm = load <2 x float>, ptr %i.pc, align 16, !tbaa !53 ; 2 uses
  %i.pn = load <2 x float>, ptr %i.pd, align 8, !tbaa !53 ; 2 uses
  %i.po = load <2 x float>, ptr %i.pe, align 16, !tbaa !53 ; 2 uses
  %i.pp = load <2 x float>, ptr %i.pf, align 8, !tbaa !53 ; 2 uses
  %i.pq = load <2 x float>, ptr %i.pg, align 16, !tbaa !53 ; 2 uses
  %i.pr = fsub fast <2 x float> %i.pl, %i.pm
  %i.ps = fsub fast <2 x float> %i.pn, %i.po      ; 3 uses
  %i.pt = fsub fast <2 x float> %i.pp, %i.pq      ; 4 uses
  %i.pu = load <2 x float>, ptr %i.pa, align 16, !tbaa !53
  ...
  store float %i.ra, ptr %.0701153.us.i, align 4, !tbaa !53
  %i.rb = extractelement <2 x float> %i.qc, i64 1
  store float %i.rb, ptr %i.qz, align 4, !tbaa !53
...
bb.ao:                                            ; preds = %bb.an
  ...
  store float %i.ql, ptr %i.rk, align 4, !tbaa !53
...
bb.as:                                            ; preds = %bb.ar
  ...
  store float %i.qs, ptr %i.rq, align 4, !tbaa !53
...
bb.au:                                            ; preds = %bb.at
  ...
  store float %i.qw, ptr %i.rs, align 4, !tbaa !53
  %i.rt = getelementptr inbounds nuw i8, ptr %i.qz, i64 20
  store float %i.qy, ptr %i.rt, align 4, !tbaa !53
  br label %bb.av
...
bb.aw:                                            ; preds = %bb.av, %bb.ak
  ...
  br i1 %exitcond226.not.i, label %bb.ax, label %bb.ak, !llvm.loop !955
...
bb.ax:                                            ; preds = %bb.aw
  ...
  br i1 %exitcond231.not.i, label %._crit_edge.us164.i, label %bb.ai, !llvm.loop !956
...
._crit_edge.us164.i:                              ; preds = %bb.ax
  ...
  br i1 %i.rv, label %bb.ag, label %.preheader.loopexit.i, !llvm.loop !957

.lr.ph160.split.i:                                ; preds = %.lr.ph160.i
  %16 = add i32 %.0703.lcssa.i, 3
  %smax218.i = call i32 @llvm.smax.i32(i32 %.sroa.speculated121, i32 %16)
  %reass.sub = sub i32 %smax218.i, %.0703.lcssa.i
  %17 = and i32 %reass.sub, -2
  %i.rw = add i32 %.0703.lcssa.i, %17
  br label %.preheader.i
...
.lr.ph188.i:                                      ; preds = %.preheader.i
  ...
  %i.sb = shl nuw nsw i32 %.sroa.speculated117, 1
  %i.sc = zext nneg i32 %i.sb to i64
  %i.sd = mul nuw nsw i32 %.sroa.speculated117, 3
  %i.se = zext nneg i32 %i.sd to i64
  %i.sf = shl nuw nsw i32 %.sroa.speculated117, 2
  %i.sg = zext nneg i32 %i.sf to i64
  %i.sh = mul nuw nsw i32 %.sroa.speculated117, 5
  %i.si = zext nneg i32 %i.sh to i64
  %i.sj = mul nuw nsw i32 %.sroa.speculated117, 6
  %i.sk = zext nneg i32 %i.sj to i64
  %i.sl = mul nuw nsw i32 %.sroa.speculated117, 7
  %i.sm = zext nneg i32 %i.sl to i64
  %i.sn = shl nuw nsw i32 %.sroa.speculated117, 3
  %i.so = zext nneg i32 %i.sn to i64              ; 8 uses
...
.lr.ph188.split.us.i:                             ; preds = %.lr.ph188.i
  %i.sq = load i32, ptr %i.aq, align 4, !tbaa !86, !noalias !977
  %i.sr = load ptr, ptr %12, align 8, !tbaa !34, !noalias !977
  %i.ss = load i64, ptr %i.at, align 8, !tbaa !35, !noalias !977
  %i.st = load i64, ptr %i.az, align 8, !tbaa !76, !noalias !977 ; 2 uses
...
bb.az:                                            ; preds = %bb.ay
  ...
  %i.sy = load float, ptr %i.sx, align 4, !tbaa !53
...
bb.bb:                                            ; preds = %bb.bb, %bb.ba
  ...
  %i.tm = load float, ptr %.0697171.us.i, align 4, !tbaa !53 ; 2 uses
  %i.tn = load float, ptr %.0696172.us.i, align 4, !tbaa !53 ; 2 uses
  %i.to = load float, ptr %.0695173.us.i, align 4, !tbaa !53 ; 2 uses
  %i.tp = load float, ptr %.0694174.us.i, align 4, !tbaa !53 ; 2 uses
  %i.tq = load float, ptr %.0693175.us.i, align 4, !tbaa !53 ; 2 uses
  %i.tr = load float, ptr %.0692176.us.i, align 4, !tbaa !53 ; 2 uses
  %i.ts = fadd fast float %i.tr, %i.tq            ; 3 uses
  %i.tt = fsub fast float %i.tq, %i.tr            ; 3 uses
  %i.tu = load float, ptr %.0698170.us.i, align 4, !tbaa !53
  ...
  store float %i.uk, ptr %i.tw, align 4, !tbaa !53
  ...
  store float %i.uu, ptr %i.ty, align 4, !tbaa !53
  %i.uv = extractelement <4 x float> %i.ut, i64 1
  %i.uw = fadd fast float %i.tz, %i.uv
  store float %i.uw, ptr %i.ua, align 4, !tbaa !53
  ...
  store float %i.va, ptr %i.vb, align 4, !tbaa !53
  %i.vc = load float, ptr %.0691177.us.i, align 4, !tbaa !53
  ...
  store float %i.vg, ptr %i.vh, align 4, !tbaa !53
  ...
  br i1 %exitcond238.not.i, label %_ZN4ncnn3MatD2Ev.exit.us.i, label %bb.bb, !llvm.loop !960
...
bb.bd:                                            ; preds = %bb.bc
  ...
  %i.wl = load float, ptr %i.wk, align 16, !tbaa !53
  %i.wm = getelementptr inbounds nuw i8, ptr %i.wk, i64 4
  %i.wn = load float, ptr %i.wm, align 4, !tbaa !53 ; 2 uses
  %i.wo = getelementptr inbounds nuw i8, ptr %i.wk, i64 8
  %i.wp = load float, ptr %i.wo, align 8, !tbaa !53 ; 2 uses
  ...
  %i.wu = load float, ptr %i.wt, align 8, !tbaa !53 ; 2 uses
  %i.wv = getelementptr inbounds nuw i8, ptr %i.wk, i64 28
  %i.ww = load float, ptr %i.wv, align 4, !tbaa !53
end_hunk_14
...
bb.a:
  ...
  %14 = alloca %"class.ncnn::Mat", align 8        ; 11 uses
  %i.g = load i32, ptr %2, align 4, !tbaa !78     ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d) #12
  store i32 %i.i, ptr %i.d, align 4, !tbaa !78
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e) #12
  store i32 1, ptr %i.e, align 4, !tbaa !78
  call void @llvm.lifetime.start.p0(ptr nonnull %i.f) #12
  store i32 0, ptr %i.f, align 4, !tbaa !78
  %i.j = load i32, ptr %0, align 4, !tbaa !78     ; 2 uses
  ...
  %i.k = load i32, ptr %i.d, align 4, !tbaa !78
  %i.l = call i32 @llvm.smin.i32(i32 %i.k, i32 %i.i) ; 2 uses
  store i32 %i.l, ptr %i.d, align 4, !tbaa !78
  %i.m = load i32, ptr %i.c, align 4, !tbaa !78   ; 2 uses
...
bb.c:                                             ; preds = %.lr.ph138, %_ZN4ncnn3MatD2Ev.exit
  ...
  %i.dm = load i32, ptr %3, align 4, !tbaa !78
...
_ZN4ncnn3Mat7channelEi.exit76:                    ; preds = %bb.c
  %i.dp = load ptr, ptr %4, align 8, !tbaa !34, !noalias !1295
  %i.dq = load i64, ptr %i.n, align 8, !tbaa !35, !noalias !1295
  %i.dr = sext i32 %i.do to i64
  %i.ds = mul i64 %i.dq, %i.dr
  %i.dt = load i64, ptr %i.o, align 8, !tbaa !76, !noalias !1295
  %i.du = mul i64 %i.ds, %i.dt
  %i.dv = getelementptr inbounds nuw i8, ptr %i.dp, i64 %i.du ; 4 uses
  %i.dw = load i32, ptr %5, align 4, !tbaa !78
  %i.dx = sub nsw i32 %i.dw, %i.dn
  %i.dy = load i32, ptr %3, align 4, !tbaa !78
  %.sroa.speculated118 = call i32 @llvm.smin.i32(i32 %i.dy, i32 %i.dx) ; 8 uses
  %i.dz = load i32, ptr %6, align 4, !tbaa !78    ; 2 uses
...
_ZN4ncnn3MatD2Ev.exit:                            ; preds = %_ZN4ncnnL47conv3x3s1_winograd43_transform_output_tile_int8ERKNS_3MatERS0_iiii.exit, %_ZN4ncnn3Mat7channelEi.exit76
  ...
  %i.eh = load i32, ptr %i.d, align 4, !tbaa !78
...
bb.d:                                             ; preds = %.lr.ph, %_ZN4ncnnL47conv3x3s1_winograd43_transform_output_tile_int8ERKNS_3MatERS0_iiii.exit
  ...
  %i.el = load i32, ptr %8, align 4, !tbaa !78    ; 2 uses
  %i.em = icmp sgt i32 %i.el, 0
  br i1 %i.em, label %.noexc.preheader, label %._crit_edge

.noexc.preheader:                                 ; preds = %bb.d
  %.pre140 = load i32, ptr %9, align 4, !tbaa !78
  br label %.noexc

._crit_edge:                                      ; preds = %.noexc, %bb.d
  %i.en = load i32, ptr %i.ap, align 4, !tbaa !86 ; 13 uses
  %i.eo = load i32, ptr %i.aq, align 8, !tbaa !87 ; 6 uses
  %i.ep = load i32, ptr %i.ar, align 8, !tbaa !77 ; 5 uses
  %i.eq = load i64, ptr %i.as, align 8, !tbaa !35
...
.lr.ph799.i:                                      ; preds = %._crit_edge
  ...
  %i.ew = shl nuw nsw i32 %.sroa.speculated114, 2
  %i.ex = zext nneg i32 %i.ew to i64
  %i.ey = shl nuw nsw i32 %.sroa.speculated114, 3
  %i.ez = zext nneg i32 %i.ey to i64
  %i.fa = mul nuw nsw i32 %.sroa.speculated114, 12
  %i.fb = zext nneg i32 %i.fa to i64
  %i.fc = shl nuw nsw i32 %.sroa.speculated114, 4
  %i.fd = zext nneg i32 %i.fc to i64
  %i.fe = mul nuw nsw i32 %.sroa.speculated114, 20
  %i.ff = zext nneg i32 %i.fe to i64
  %i.fg = mul nuw nsw i32 %.sroa.speculated114, 24
  %i.fh = zext nneg i32 %i.fg to i64              ; 30 uses
...
.preheader776.us.i:                               ; preds = %bb.u, %.lr.ph.us.i
  ...
  %i.fw = load <4 x i32>, ptr %i.fq, align 16, !tbaa !108
  %i.fx = load <4 x i32>, ptr %i.fr, align 16, !tbaa !108 ; 2 uses
  %i.fy = load <4 x i32>, ptr %i.fs, align 16, !tbaa !108 ; 2 uses
  %i.fz = load <4 x i32>, ptr %i.ft, align 16, !tbaa !108 ; 2 uses
  %i.ga = load <4 x i32>, ptr %i.fu, align 16, !tbaa !108 ; 2 uses
  %i.gb = load <4 x i32>, ptr %i.fv, align 16, !tbaa !108
  ...
  store <4 x i32> %i.gh, ptr %i.a, align 16, !tbaa !108
  store <4 x i32> %i.gj, ptr %i.at, align 16, !tbaa !108
  store <4 x i32> %i.gl, ptr %i.au, align 16, !tbaa !108
  store <4 x i32> %i.gp, ptr %i.av, align 16, !tbaa !108
  ...
  %i.gw = load <4 x i32>, ptr %i.gq, align 16, !tbaa !108
  %i.gx = load <4 x i32>, ptr %i.gr, align 16, !tbaa !108 ; 2 uses
  %i.gy = load <4 x i32>, ptr %i.gs, align 16, !tbaa !108 ; 2 uses
  %i.gz = load <4 x i32>, ptr %i.gt, align 16, !tbaa !108 ; 2 uses
  %i.ha = load <4 x i32>, ptr %i.gu, align 16, !tbaa !108 ; 2 uses
  %i.hb = load <4 x i32>, ptr %i.gv, align 16, !tbaa !108
  ...
  store <4 x i32> %i.hh, ptr %i.bb, align 16, !tbaa !108
  store <4 x i32> %i.hj, ptr %i.bc, align 16, !tbaa !108
  store <4 x i32> %i.hl, ptr %i.bd, align 16, !tbaa !108
  store <4 x i32> %i.hp, ptr %i.be, align 16, !tbaa !108
  ...
  %i.hw = load <4 x i32>, ptr %i.hq, align 16, !tbaa !108
  %i.hx = load <4 x i32>, ptr %i.hr, align 16, !tbaa !108 ; 2 uses
  %i.hy = load <4 x i32>, ptr %i.hs, align 16, !tbaa !108 ; 2 uses
  %i.hz = load <4 x i32>, ptr %i.ht, align 16, !tbaa !108 ; 2 uses
  %i.ia = load <4 x i32>, ptr %i.hu, align 16, !tbaa !108 ; 2 uses
  %i.ib = load <4 x i32>, ptr %i.hv, align 16, !tbaa !108
  ...
  store <4 x i32> %i.ih, ptr %i.bf, align 16, !tbaa !108
  store <4 x i32> %i.ij, ptr %i.bg, align 16, !tbaa !108
  store <4 x i32> %i.il, ptr %i.bh, align 16, !tbaa !108
  store <4 x i32> %i.ip, ptr %i.bi, align 16, !tbaa !108
  ...
  %i.iw = load <4 x i32>, ptr %i.iq, align 16, !tbaa !108
  %i.ix = load <4 x i32>, ptr %i.ir, align 16, !tbaa !108 ; 2 uses
  %i.iy = load <4 x i32>, ptr %i.is, align 16, !tbaa !108 ; 2 uses
  %i.iz = load <4 x i32>, ptr %i.it, align 16, !tbaa !108 ; 2 uses
  %i.ja = load <4 x i32>, ptr %i.iu, align 16, !tbaa !108 ; 2 uses
  %i.jb = load <4 x i32>, ptr %i.iv, align 16, !tbaa !108
  ...
  store <4 x i32> %i.jh, ptr %i.bj, align 16, !tbaa !108
  store <4 x i32> %i.jj, ptr %i.bk, align 16, !tbaa !108
  store <4 x i32> %i.jl, ptr %i.bl, align 16, !tbaa !108
  store <4 x i32> %i.jp, ptr %i.bm, align 16, !tbaa !108
...
begin_hunk_16_@_ZN4ncnnL25conv3x3s1_winograd43_int8ERKNS_3MatERS0_S2_iRKNS_6OptionE.omp_outlined.10:bb.a
  ...
  store <4 x i32> %i.lm, ptr %i.aw, align 16, !tbaa !108
  store <4 x i32> %i.lp, ptr %i.ax, align 16, !tbaa !108
  store <4 x i32> %i.ls, ptr %i.ay, align 16, !tbaa !108
  store <4 x i32> %i.lw, ptr %i.az, align 16, !tbaa !108
  %i.lx = load i32, ptr %i.ap, align 4, !tbaa !86, !noalias !1296
  %i.ly = load ptr, ptr %12, align 8, !tbaa !34, !noalias !1296
  %i.lz = load i64, ptr %i.as, align 8, !tbaa !35, !noalias !1296
  %i.ma = mul i64 %i.lz, %i.fo
  %i.mb = load i64, ptr %i.ba, align 8, !tbaa !76, !noalias !1296 ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.mx = load <4 x i32>, ptr %i.mw, align 16, !tbaa !108
  %i.my = getelementptr inbounds nuw i8, ptr %i.mw, i64 16
  %i.mz = load <4 x i32>, ptr %i.my, align 16, !tbaa !108 ; 2 uses
  %i.na = getelementptr inbounds nuw i8, ptr %i.mw, i64 32
  %i.nb = load <4 x i32>, ptr %i.na, align 16, !tbaa !108 ; 2 uses
  %i.nc = getelementptr inbounds nuw i8, ptr %i.mw, i64 48
  %i.nd = load <4 x i32>, ptr %i.nc, align 16, !tbaa !108 ; 2 uses
  %i.ne = getelementptr inbounds nuw i8, ptr %i.mw, i64 64
  %i.nf = load <4 x i32>, ptr %i.ne, align 16, !tbaa !108 ; 2 uses
  %i.ng = getelementptr inbounds nuw i8, ptr %i.mw, i64 80
  %i.nh = load <4 x i32>, ptr %i.ng, align 16, !tbaa !108
...
bb.g:                                             ; preds = %bb.f
  ...
  store i32 %.sroa.0748.4.vec.extract.us.i, ptr %i.oh, align 4, !tbaa !78
  %.sroa.0748.8.vec.extract.us.i = extractelement <4 x i32> %i.nx, i64 2
  store i32 %.sroa.0748.8.vec.extract.us.i, ptr %i.oi, align 4, !tbaa !78
  %.sroa.0748.12.vec.extract.us.i = extractelement <4 x i32> %i.nx, i64 3
  store i32 %.sroa.0748.12.vec.extract.us.i, ptr %i.oj, align 4, !tbaa !78
...
bb.p:                                             ; preds = %bb.o
  ...
  store <4 x i32> %i.od, ptr %i.ox, align 16, !tbaa !108
  br label %bb.q
...
bb.r:                                             ; preds = %bb.q
  ...
  store <4 x i32> %i.og, ptr %i.oy, align 16, !tbaa !108
  br label %bb.s
...
._crit_edge.us.i:                                 ; preds = %bb.u
  ...
  br i1 %i.pb, label %.lr.ph.us.i, label %.preheader775.loopexit.i, !llvm.loop !1275
...
.preheader775.i:                                  ; preds = %.lr.ph799.i, %.preheader775.loopexit.i, %._crit_edge
  %.0647.lcssa.i = phi i32 [ 0, %._crit_edge ], [ %i.pc, %.preheader775.loopexit.i ], [ %i.ec, %.lr.ph799.i ] ; 6 uses
...
.lr.ph850.split.preheader.i:                      ; preds = %.lr.ph850.i
  ...
  %smax.i = call i32 @llvm.smax.i32(i32 %.sroa.speculated118, i32 %15)
  %reass.sub = sub i32 %smax.i, %.0647.lcssa.i
  %16 = and i32 %reass.sub, -2
  %i.pt = add i32 %.0647.lcssa.i, %16
  br label %.preheader773.i

.lr.ph850.split.us.i:                             ; preds = %.lr.ph850.i
  %i.pu = load ptr, ptr %12, align 8, !tbaa !34, !noalias !1297
  %i.pv = load i64, ptr %i.as, align 8, !tbaa !35, !noalias !1297
  %i.pw = load i64, ptr %i.ba, align 8, !tbaa !76, !noalias !1297 ; 2 uses
...
.preheader774.us.i:                               ; preds = %bb.ae, %.lr.ph.us853.i
  ...
  %i.qj = load i32, ptr %i.qe, align 4, !tbaa !78 ; 2 uses
  %i.qk = load i32, ptr %i.qf, align 4, !tbaa !78 ; 2 uses
  %i.ql = add nsw i32 %i.qk, %i.qj                ; 2 uses
  %i.qm = getelementptr inbounds nuw i8, ptr %i.qe, i64 4
  %i.qn = load i32, ptr %i.qm, align 4, !tbaa !78 ; 2 uses
  %i.qo = getelementptr inbounds nuw i8, ptr %i.qf, i64 4
  %i.qp = load i32, ptr %i.qo, align 4, !tbaa !78 ; 2 uses
  %i.qq = add nsw i32 %i.qp, %i.qn                ; 2 uses
  %i.qr = load i32, ptr %i.qg, align 4, !tbaa !78 ; 2 uses
  %i.qs = load i32, ptr %i.qh, align 4, !tbaa !78 ; 2 uses
  %i.qt = add nsw i32 %i.qs, %i.qr                ; 2 uses
  %i.qu = getelementptr inbounds nuw i8, ptr %i.qg, i64 4
  %i.qv = load i32, ptr %i.qu, align 4, !tbaa !78 ; 2 uses
  %i.qw = getelementptr inbounds nuw i8, ptr %i.qh, i64 4
  %i.qx = load i32, ptr %i.qw, align 4, !tbaa !78 ; 2 uses
  ...
  %i.ru = load i32, ptr %i.qi, align 4, !tbaa !78
  ...
  %i.sa = load i32, ptr %i.rz, align 4, !tbaa !78
  %i.sb = shl nsw i32 %i.sa, 2
  %i.sc = add nsw i32 %i.ry, %i.sb
  store i32 %i.rf, ptr %i.b, align 16, !tbaa !78
  store i32 %i.rj, ptr %i.cc, align 4, !tbaa !78
  store i32 %i.rl, ptr %i.br, align 16, !tbaa !78
  store i32 %i.rn, ptr %i.cd, align 4, !tbaa !78
  store i32 %i.rp, ptr %i.bs, align 16, !tbaa !78
  store i32 %i.rr, ptr %i.ce, align 4, !tbaa !78
  store i32 %i.rw, ptr %i.bt, align 16, !tbaa !78
  store i32 %i.sc, ptr %i.cf, align 4, !tbaa !78
  ...
  %i.sj = load i32, ptr %i.se, align 4, !tbaa !78 ; 2 uses
  %i.sk = load i32, ptr %i.sf, align 4, !tbaa !78 ; 2 uses
  %i.sl = add nsw i32 %i.sk, %i.sj                ; 2 uses
  %i.sm = getelementptr inbounds nuw i8, ptr %i.se, i64 4
  %i.sn = load i32, ptr %i.sm, align 4, !tbaa !78 ; 2 uses
  %i.so = getelementptr inbounds nuw i8, ptr %i.sf, i64 4
  %i.sp = load i32, ptr %i.so, align 4, !tbaa !78 ; 2 uses
  %i.sq = add nsw i32 %i.sp, %i.sn                ; 2 uses
  %i.sr = load i32, ptr %i.sg, align 4, !tbaa !78 ; 2 uses
  %i.ss = load i32, ptr %i.sh, align 4, !tbaa !78 ; 2 uses
  %i.st = add nsw i32 %i.ss, %i.sr                ; 2 uses
  %i.su = getelementptr inbounds nuw i8, ptr %i.sg, i64 4
  %i.sv = load i32, ptr %i.su, align 4, !tbaa !78 ; 2 uses
  %i.sw = getelementptr inbounds nuw i8, ptr %i.sh, i64 4
  %i.sx = load i32, ptr %i.sw, align 4, !tbaa !78 ; 2 uses
  ...
  %i.tu = load i32, ptr %i.si, align 4, !tbaa !78
  ...
  %i.ua = load i32, ptr %i.tz, align 4, !tbaa !78
  %i.ub = shl nsw i32 %i.ua, 2
  %i.uc = add nsw i32 %i.ty, %i.ub
  store i32 %i.tf, ptr %i.cg, align 8, !tbaa !78
  store i32 %i.tj, ptr %i.ch, align 4, !tbaa !78
  store i32 %i.tl, ptr %i.ci, align 8, !tbaa !78
  store i32 %i.tn, ptr %i.cj, align 4, !tbaa !78
  store i32 %i.tp, ptr %i.ck, align 8, !tbaa !78
  store i32 %i.tr, ptr %i.cl, align 4, !tbaa !78
  store i32 %i.tw, ptr %i.cm, align 8, !tbaa !78
  store i32 %i.uc, ptr %i.cn, align 4, !tbaa !78
  ...
  %i.uj = load i32, ptr %i.ue, align 4, !tbaa !78 ; 2 uses
  %i.uk = load i32, ptr %i.uf, align 4, !tbaa !78 ; 2 uses
  %i.ul = add nsw i32 %i.uk, %i.uj                ; 2 uses
  %i.um = getelementptr inbounds nuw i8, ptr %i.ue, i64 4
  %i.un = load i32, ptr %i.um, align 4, !tbaa !78 ; 2 uses
  %i.uo = getelementptr inbounds nuw i8, ptr %i.uf, i64 4
  %i.up = load i32, ptr %i.uo, align 4, !tbaa !78 ; 2 uses
  %i.uq = add nsw i32 %i.up, %i.un                ; 2 uses
  %i.ur = load i32, ptr %i.ug, align 4, !tbaa !78 ; 2 uses
  %i.us = load i32, ptr %i.uh, align 4, !tbaa !78 ; 2 uses
  %i.ut = add nsw i32 %i.us, %i.ur                ; 2 uses
  %i.uu = getelementptr inbounds nuw i8, ptr %i.ug, i64 4
  %i.uv = load i32, ptr %i.uu, align 4, !tbaa !78 ; 2 uses
  %i.uw = getelementptr inbounds nuw i8, ptr %i.uh, i64 4
  %i.ux = load i32, ptr %i.uw, align 4, !tbaa !78 ; 2 uses
  ...
  %i.vu = load i32, ptr %i.ui, align 4, !tbaa !78
  ...
  %i.wa = load i32, ptr %i.vz, align 4, !tbaa !78
  %i.wb = shl nsw i32 %i.wa, 2
  %i.wc = add nsw i32 %i.vy, %i.wb
  store i32 %i.vf, ptr %i.co, align 16, !tbaa !78
  store i32 %i.vj, ptr %i.cp, align 4, !tbaa !78
end_hunk_16
...
_ZN4ncnn3Mat7channelEi.exit76:                    ; preds = %bb.c
  %i.av = load ptr, ptr %4, align 8, !tbaa !34, !noalias !1417
  %i.aw = load i64, ptr %i.l, align 8, !tbaa !35, !noalias !1417
  %i.ax = sext i32 %i.au to i64
  %i.ay = mul i64 %i.aw, %i.ax
  %i.az = load i64, ptr %i.m, align 8, !tbaa !76, !noalias !1417
  %i.ba = mul i64 %i.ay, %i.az
  %i.bb = getelementptr inbounds nuw i8, ptr %i.av, i64 %i.ba ; 4 uses
  %i.bc = load i32, ptr %5, align 4, !tbaa !78
  %i.bd = sub nsw i32 %i.bc, %i.at
...
.noexc.preheader:                                 ; preds = %bb.d
  %.pre149 = load i32, ptr %9, align 4, !tbaa !78
  br label %.noexc
...
.lr.ph67.i:                                       ; preds = %._crit_edge
  ...
  %i.cc = shl nuw nsw i32 %.sroa.speculated115, 2
  %i.cd = zext nneg i32 %i.cc to i64
  %i.ce = shl nuw nsw i32 %.sroa.speculated115, 3
  %i.cf = zext nneg i32 %i.ce to i64
  %i.cg = mul nuw nsw i32 %.sroa.speculated115, 12
  %i.ch = zext nneg i32 %i.cg to i64
  %i.ci = zext nneg i32 %factor.op.mul64.i to i64 ; 12 uses
  %.idx.i = shl i64 %i.by, 3                      ; 2 uses
...
_ZN4ncnn3MatD2Ev.exit302.us.i:                    ; preds = %bb.q, %.lr.ph.us.i
  ...
  %i.cv = load <4 x i32>, ptr %i.cs, align 16, !tbaa !108 ; 2 uses
  %i.cw = load <4 x i32>, ptr %i.ct, align 16, !tbaa !108 ; 2 uses
  %i.cx = load <4 x i32>, ptr %i.cu, align 16, !tbaa !108
  ...
  %i.dd = load <4 x i32>, ptr %i.da, align 16, !tbaa !108 ; 2 uses
  %i.de = load <4 x i32>, ptr %i.db, align 16, !tbaa !108 ; 2 uses
  %i.df = load <4 x i32>, ptr %i.dc, align 16, !tbaa !108
  ...
  %i.dl = load <4 x i32>, ptr %i.di, align 16, !tbaa !108 ; 2 uses
  %i.dm = load <4 x i32>, ptr %i.dj, align 16, !tbaa !108 ; 2 uses
  %i.dn = load <4 x i32>, ptr %i.dk, align 16, !tbaa !108
  ...
  %i.dt = load <4 x i32>, ptr %i.dq, align 16, !tbaa !108 ; 2 uses
  %i.du = load <4 x i32>, ptr %i.dr, align 16, !tbaa !108 ; 2 uses
  %i.dv = load <4 x i32>, ptr %i.ds, align 16, !tbaa !108
  %i.dw = trunc i64 %indvars.iv.i to i32
  %i.dx = add i32 %.044143, %i.dw                 ; 2 uses
  %i.dy = sdiv i32 %i.dx, %i.ca
  %i.dz = srem i32 %i.dx, %i.ca
  %i.ea = load i32, ptr %i.an, align 4, !tbaa !86, !noalias !1418
  %i.eb = load ptr, ptr %12, align 8, !tbaa !34, !noalias !1418
  %i.ec = load i64, ptr %i.aq, align 8, !tbaa !35, !noalias !1418
  %i.ed = mul i64 %i.ec, %i.cq
  %i.ee = load i64, ptr %i.ar, align 8, !tbaa !76, !noalias !1418 ; 2 uses
...
bb.e:                                             ; preds = %_ZN4ncnn3MatD2Ev.exit302.us.i
  ...
  %i.ew = load <4 x i32>, ptr %i.ev, align 16, !tbaa !108
  %i.ex = load <4 x i32>, ptr %i.eu, align 16, !tbaa !108
  %i.ey = add <4 x i32> %i.dm, %i.dl
  %i.ez = add <4 x i32> %i.ey, %i.ex              ; 2 uses
  %i.fa = load <4 x i32>, ptr %i.et, align 16, !tbaa !108
  %i.fb = add <4 x i32> %i.de, %i.dd
  %i.fc = add <4 x i32> %i.fb, %i.fa              ; 2 uses
  %i.fd = load <4 x i32>, ptr %i.cr, align 16, !tbaa !108
...
bb.f:                                             ; preds = %bb.e
  ...
  store i32 %.sroa.026.0.vec.extract.us.i, ptr %i.eq, align 4, !tbaa !78
  %.sroa.026.4.vec.extract.us.i = extractelement <4 x i32> %i.fm, i64 1
  store i32 %.sroa.026.4.vec.extract.us.i, ptr %i.fo, align 4, !tbaa !78
  %.sroa.026.8.vec.extract.us.i = extractelement <4 x i32> %i.fm, i64 2
  store i32 %.sroa.026.8.vec.extract.us.i, ptr %i.fp, align 4, !tbaa !78
  %.sroa.026.12.vec.extract.us.i = extractelement <4 x i32> %i.fm, i64 3
  store i32 %.sroa.026.12.vec.extract.us.i, ptr %i.fq, align 4, !tbaa !78
...
bb.m:                                             ; preds = %bb.l
  ...
  store i32 %.sroa.026.4.vec.extract.us.1.i, ptr %i.gg, align 4, !tbaa !78
  %.sroa.026.8.vec.extract.us.1.i = extractelement <4 x i32> %i.ge, i64 2
  store i32 %.sroa.026.8.vec.extract.us.1.i, ptr %i.gh, align 4, !tbaa !78
  %.sroa.026.12.vec.extract.us.1.i = extractelement <4 x i32> %i.ge, i64 3
  store i32 %.sroa.026.12.vec.extract.us.1.i, ptr %i.gi, align 4, !tbaa !78
...
._crit_edge.us.i:                                 ; preds = %bb.q
  ...
  br i1 %i.gp, label %.lr.ph.us.i, label %.preheader55.loopexit.i, !llvm.loop !1398
...
.preheader55.i:                                   ; preds = %.lr.ph67.i, %.preheader55.loopexit.i, %._crit_edge
  %.0287.lcssa.i = phi i32 [ 0, %._crit_edge ], [ %i.gq, %.preheader55.loopexit.i ], [ %i.bi, %.lr.ph67.i ] ; 6 uses
...
.lr.ph78.i:                                       ; preds = %.preheader55.i
  ...
  %i.gu = shl nuw nsw i32 %.sroa.speculated115, 1
  %i.gv = zext nneg i32 %i.gu to i64
  %i.gw = shl nuw nsw i32 %.sroa.speculated115, 2
  %i.gx = zext nneg i32 %i.gw to i64
  %i.gy = mul nuw nsw i32 %.sroa.speculated115, 6
  %i.gz = zext nneg i32 %i.gy to i64
  %i.ha = shl nuw nsw i32 %.sroa.speculated115, 3
...
.lr.ph78.split.us.i:                              ; preds = %.lr.ph78.i
  %i.he = load ptr, ptr %12, align 8, !tbaa !34, !noalias !1419
  %i.hf = load i64, ptr %i.aq, align 8, !tbaa !35, !noalias !1419
  %i.hg = load i64, ptr %i.ar, align 8, !tbaa !76, !noalias !1419 ; 2 uses
...
_ZN4ncnn3MatD2Ev.exit301.us.i:                    ; preds = %bb.x, %.lr.ph.us81.i
  ...
  %i.hr = load i32, ptr %i.ho, align 4, !tbaa !78 ; 2 uses
  %i.hs = load i32, ptr %i.hp, align 4, !tbaa !78 ; 2 uses
  %i.ht = getelementptr inbounds nuw i8, ptr %i.ho, i64 4
  %i.hu = load i32, ptr %i.ht, align 4, !tbaa !78 ; 2 uses
  %i.hv = getelementptr inbounds nuw i8, ptr %i.hp, i64 4
  %i.hw = load i32, ptr %i.hv, align 4, !tbaa !78 ; 2 uses
  %i.hx = sub i32 %i.hr, %i.hs
  %i.hy = load i32, ptr %i.hq, align 4, !tbaa !78
  %i.hz = add nsw i32 %i.hx, %i.hy
  %i.ia = sub i32 %i.hu, %i.hw
  %i.ib = getelementptr inbounds nuw i8, ptr %i.hq, i64 4
  %i.ic = load i32, ptr %i.ib, align 4, !tbaa !78
  ...
  %i.jg = load i32, ptr %i.jc, align 4, !tbaa !78
  %i.jh = load i32, ptr %i.jd, align 4, !tbaa !78 ; 2 uses
  %i.ji = add nsw i32 %i.jh, %i.jg
  %i.jj = load i32, ptr %i.je, align 4, !tbaa !78 ; 2 uses
  %i.jk = add nsw i32 %i.ji, %i.jj                ; 2 uses
  %i.jl = getelementptr inbounds nuw i8, ptr %i.jc, i64 4
  %i.jm = load i32, ptr %i.jl, align 4, !tbaa !78
  %i.jn = getelementptr inbounds nuw i8, ptr %i.jd, i64 4
  %i.jo = load i32, ptr %i.jn, align 4, !tbaa !78 ; 2 uses
  %i.jp = add nsw i32 %i.jo, %i.jm
  %i.jq = getelementptr inbounds nuw i8, ptr %i.je, i64 4
  %i.jr = load i32, ptr %i.jq, align 4, !tbaa !78 ; 2 uses
  %i.js = add nsw i32 %i.jp, %i.jr                ; 2 uses
  %i.jt = sub i32 %i.jh, %i.jj
  %i.ju = load i32, ptr %i.jf, align 4, !tbaa !78
  ...
  %i.ke = load i32, ptr %i.ka, align 4, !tbaa !78
  %i.kf = load i32, ptr %i.kb, align 4, !tbaa !78 ; 2 uses
  %i.kg = load i32, ptr %i.kc, align 4, !tbaa !78 ; 2 uses
  %i.kh = getelementptr inbounds nuw i8, ptr %i.ka, i64 4
  %i.ki = load i32, ptr %i.kh, align 4, !tbaa !78
  %i.kj = getelementptr inbounds nuw i8, ptr %i.kb, i64 4
  %i.kk = load i32, ptr %i.kj, align 4, !tbaa !78 ; 2 uses
  %i.kl = getelementptr inbounds nuw i8, ptr %i.kc, i64 4
  %i.km = load i32, ptr %i.kl, align 4, !tbaa !78 ; 2 uses
  %i.kn = load i32, ptr %i.kd, align 4, !tbaa !78
  %i.ko = getelementptr inbounds nuw i8, ptr %i.kd, i64 4
  %i.kp = load i32, ptr %i.ko, align 4, !tbaa !78
  %i.kq = trunc i64 %indvars.iv128.i to i32
  %i.kr = add i32 %.044143, %i.kq                 ; 2 uses
  %i.ks = sdiv i32 %i.kr, %i.ca
  %i.kt = srem i32 %i.kr, %i.ca
  %i.ku = load i32, ptr %i.an, align 4, !tbaa !86, !noalias !1419
...
bb.r:                                             ; preds = %_ZN4ncnn3MatD2Ev.exit301.us.i
  ...
  %i.lh = load i32, ptr %i.lg, align 4, !tbaa !78
  %i.li = load i32, ptr %i.hn, align 4, !tbaa !78
  ...
  store i32 %i.lr, ptr %i.ld, align 4, !tbaa !78
  store i32 %i.ls, ptr %i.lt, align 4, !tbaa !78
...
bb.s:                                             ; preds = %bb.r
  ...
  store i32 %i.md, ptr %i.me, align 4, !tbaa !78
  %i.mf = getelementptr inbounds nuw i8, ptr %i.lt, i64 4
  store i32 %i.ly, ptr %i.mf, align 4, !tbaa !78
  br label %bb.t
...
bb.v:                                             ; preds = %bb.u
  ...
  store i32 %i.mm, ptr %.1277.us.i, align 4, !tbaa !78
  store i32 %i.mn, ptr %i.mo, align 4, !tbaa !78
...
bb.w:                                             ; preds = %bb.v
  ...
  store i32 %i.my, ptr %i.mz, align 4, !tbaa !78
  %i.na = getelementptr inbounds nuw i8, ptr %i.mo, i64 4
  store i32 %i.mt, ptr %i.na, align 4, !tbaa !78
  br label %bb.x
...
begin_hunk_18_@_ZN4ncnnL23convolution_packed_int8ERKNS_3MatERS0_S2_iiiiiiRKNS_6OptionE.omp_outlined:bb.a
  ...
  store <4 x i32> %i.ahf, ptr %i.ahi, align 16, !tbaa !108
  %i.ahj = getelementptr inbounds nuw i8, ptr %.36901879, i64 32
  %.pr1618 = load i32, ptr %7, align 4, !tbaa !78
  br label %bb.t
...
bb.u:                                             ; preds = %bb.t
  ...
  store <2 x i32> %i.ahm, ptr %.4691, align 4, !tbaa !78
  ...
  store <2 x i32> %i.aho, ptr %i.ahn, align 4, !tbaa !78
  ...
  store <2 x i32> %i.ahq, ptr %i.ahp, align 4, !tbaa !78
  ...
  store <2 x i32> %i.ahs, ptr %i.ahr, align 4, !tbaa !78
...
bb.v:                                             ; preds = %bb.u, %bb.t
  ...
  br i1 %i.ahw, label %.noexc747, label %.preheader1628, !llvm.loop !1594
...
.noexc733:                                        ; preds = %.noexc733.lr.ph, %bb.af
  ...
  %i.ahz = load ptr, ptr %8, align 8, !tbaa !34, !noalias !1619
  %i.aia = load i64, ptr %i.q, align 8, !tbaa !35, !noalias !1619
  %i.aib = mul i64 %i.aia, %i.vh
  %i.aic = load i64, ptr %i.r, align 8, !tbaa !76, !noalias !1619
  %i.aid = mul i64 %i.aib, %i.aic
  %i.aie = getelementptr inbounds nuw i8, ptr %i.ahz, i64 %i.aid ; 3 uses
  %i.aif = load i32, ptr %9, align 4, !tbaa !78   ; 9 uses
  %i.aig = icmp sgt i32 %i.aif, 7
  br i1 %i.aig, label %.noexc731.lr.ph, label %._crit_edge1893

.noexc731.lr.ph:                                  ; preds = %.noexc733
  %i.aih = load i32, ptr %6, align 4, !tbaa !78   ; 3 uses
  %i.aii = load i32, ptr %i.s, align 4, !tbaa !86, !noalias !1620
  %i.aij = load ptr, ptr %5, align 8, !tbaa !34, !noalias !1620
  %i.aik = load i64, ptr %i.n, align 8, !tbaa !35, !noalias !1620
  %i.ail = load i64, ptr %i.t, align 8, !tbaa !76, !noalias !1620 ; 2 uses
  %factor.op.mul1900 = mul i64 %i.aik, %i.ail
  %i.aim = sext i32 %i.aii to i64
  %i.ain = load i32, ptr %10, align 4, !tbaa !78
  ...
  %i.ais = load i32, ptr %11, align 4, !tbaa !78
  ...
  %i.aiw = load i32, ptr %12, align 4, !tbaa !78  ; 3 uses
...
.noexc731.lr.ph.split.us:                         ; preds = %.noexc731.lr.ph
  %i.aiz = load ptr, ptr %13, align 8, !tbaa !105
...
bb.w:                                             ; preds = %.noexc731.us, %bb.z
  ...
  %i.ajp = load i32, ptr %i.ajo, align 4, !tbaa !78
...
bb.x:                                             ; preds = %bb.w
  %i.ajs = load i8, ptr %i.ajr, align 1, !tbaa !108
  %i.ajt = getelementptr inbounds nuw i8, ptr %i.ajr, i64 %i.ac
  %i.aju = load i8, ptr %i.ajt, align 1, !tbaa !108
  ...
  %i.ajy = load i8, ptr %i.ajx, align 1, !tbaa !108
  ...
  %i.akc = load i8, ptr %i.akb, align 1, !tbaa !108
  %i.akd = getelementptr inbounds nuw i8, ptr %i.ajr, i64 %i.vm
  %i.ake = load i8, ptr %i.akd, align 1, !tbaa !108
  %i.akf = getelementptr inbounds nuw i8, ptr %i.ajr, i64 %i.vn
  %i.akg = load i8, ptr %i.akf, align 1, !tbaa !108
...
bb.y:                                             ; preds = %bb.w
  %i.akp = load i64, ptr %i.ajr, align 1, !tbaa !108
...
bb.z:                                             ; preds = %bb.y, %bb.x
  ...
  %i.akt = load <16 x i8>, ptr %.16851882.us, align 16, !tbaa !108 ; 3 uses
  %i.aku = getelementptr inbounds nuw i8, ptr %.16851882.us, i64 16
  %i.akv = load <16 x i8>, ptr %i.aku, align 16, !tbaa !108 ; 3 uses
  ...
  br i1 %exitcond2061.not, label %._crit_edge1885.us, label %bb.w, !llvm.loop !1599
...
._crit_edge1885.us:                               ; preds = %bb.z
  ...
  br i1 %i.aly, label %.noexc731.us, label %._crit_edge1893.loopexit, !llvm.loop !1600
...
._crit_edge1893:                                  ; preds = %.noexc731.preheader, %._crit_edge1893.loopexit, %.noexc733
  ...
  %.0683.lcssa = phi i32 [ 0, %.noexc733 ], [ %i.alz, %._crit_edge1893.loopexit ], [ %i.aiy, %.noexc731.preheader ] ; 6 uses
...
.noexc729.lr.ph:                                  ; preds = %._crit_edge1893
  %i.amf = load i32, ptr %i.s, align 4, !tbaa !86, !noalias !1621
  %i.amg = load ptr, ptr %5, align 8, !tbaa !34, !noalias !1621
  %i.amh = load i64, ptr %i.n, align 8, !tbaa !35, !noalias !1621
  %i.ami = load i64, ptr %i.t, align 8, !tbaa !76, !noalias !1621 ; 2 uses
  %factor.op.mul1922 = mul i64 %i.amh, %i.ami
  %i.amj = sext i32 %i.amf to i64
  %i.amk = load i32, ptr %10, align 4, !tbaa !78
  ...
  %i.amp = load i32, ptr %11, align 4, !tbaa !78
  ...
  %i.ams = load i32, ptr %12, align 4, !tbaa !78  ; 3 uses
...
.noexc729.preheader:                              ; preds = %.noexc729.lr.ph
  ...
  %14 = or disjoint i32 %.0683.lcssa, 3
  %15 = call i32 @llvm.umax.i32(i32 %i.aif, i32 %14)
  %i.amv = add nsw i32 %15, -2
...
.noexc729.lr.ph.split.us:                         ; preds = %.noexc729.lr.ph
  %i.amz = load ptr, ptr %13, align 8, !tbaa !105
...
bb.aa:                                            ; preds = %.noexc729.us, %bb.aa
  ...
  %i.anx = load i64, ptr %.31911.us, align 1, !tbaa !108
  ...
  br i1 %exitcond2068.not, label %._crit_edge1914.us, label %bb.aa, !llvm.loop !1603
...
._crit_edge1914.us:                               ; preds = %bb.aa
  ...
  br i1 %i.aoh, label %.noexc729.us, label %.preheader.loopexit, !llvm.loop !1604
...
.noexc.lr.ph:                                     ; preds = %.preheader
  %i.aok = load i32, ptr %i.s, align 4, !tbaa !86, !noalias !1622
  %i.aol = load ptr, ptr %5, align 8, !tbaa !34, !noalias !1622
  %i.aom = load i64, ptr %i.n, align 8, !tbaa !35, !noalias !1622
  %i.aon = load i64, ptr %i.t, align 8, !tbaa !76, !noalias !1622 ; 2 uses
  %factor.op.mul1940 = mul i64 %i.aom, %i.aon
  %i.aoo = sext i32 %i.aok to i64
  %i.aop = load i32, ptr %10, align 4, !tbaa !78
  ...
  %i.aou = load i32, ptr %11, align 4, !tbaa !78
  ...
  %i.aox = load i32, ptr %12, align 4, !tbaa !78  ; 3 uses
...
.noexc.lr.ph.split.us:                            ; preds = %.noexc.lr.ph
  %i.aoz = load ptr, ptr %13, align 8, !tbaa !105
...
bb.ab:                                            ; preds = %.noexc.us, %bb.ab
  ...
  %i.apo = load i64, ptr %.51930.us, align 1, !tbaa !108
  ...
  br i1 %exitcond2078.not, label %._crit_edge1933.us, label %bb.ab, !llvm.loop !1607
...
._crit_edge1933.us:                               ; preds = %bb.ab
  ...
  br i1 %i.aqa, label %.noexc.us, label %._crit_edge1938, !llvm.loop !1608
...
bb.af:                                            ; preds = %bb.ae, %bb.ad
  ...
  br i1 %exitcond2082.not, label %._crit_edge1948, label %.noexc733, !llvm.loop !1609

._crit_edge1948:                                  ; preds = %bb.af, %.preheader1628
  %i.aql = add nsw i32 %.01950, 1
  %i.aqm = load i32, ptr %i.b, align 4, !tbaa !78
...
bb.a:
  ...
  %i.f = load i32, ptr %2, align 4, !tbaa !78     ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c) #12
  store i32 %i.h, ptr %i.c, align 4, !tbaa !78
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d) #12
  store i32 1, ptr %i.d, align 4, !tbaa !78
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e) #12
  store i32 0, ptr %i.e, align 4, !tbaa !78
  %i.i = load i32, ptr %0, align 4, !tbaa !78     ; 2 uses
  ...
  %i.j = load i32, ptr %i.c, align 4, !tbaa !78
  %i.k = call i32 @llvm.smin.i32(i32 %i.j, i32 %i.h) ; 2 uses
  store i32 %i.k, ptr %i.c, align 4, !tbaa !78
  %i.l = load i32, ptr %i.b, align 4, !tbaa !78   ; 2 uses
...
bb.c:                                             ; preds = %.lr.ph157, %_ZN4ncnn3MatD2Ev.exit
  ...
  %i.az = load i32, ptr %3, align 4, !tbaa !78
...
_ZN4ncnn3Mat7channelEi.exit79:                    ; preds = %bb.c
  %i.bc = load ptr, ptr %4, align 8, !tbaa !34, !noalias !1729
  %i.bd = load i64, ptr %i.m, align 8, !tbaa !35, !noalias !1729
  %i.be = sext i32 %i.bb to i64
  %i.bf = mul i64 %i.bd, %i.be
  %i.bg = load i64, ptr %i.n, align 8, !tbaa !76, !noalias !1729
  %i.bh = mul i64 %i.bf, %i.bg
  %i.bi = getelementptr inbounds nuw i8, ptr %i.bc, i64 %i.bh ; 4 uses
  %i.bj = load i32, ptr %5, align 4, !tbaa !78
  %i.bk = sub nsw i32 %i.bj, %i.ba
  %i.bl = load i32, ptr %3, align 4, !tbaa !78
  %.sroa.speculated123 = call i32 @llvm.smin.i32(i32 %i.bl, i32 %i.bk) ; 8 uses
  %i.bm = load i32, ptr %6, align 4, !tbaa !78    ; 2 uses
...
_ZN4ncnn3MatD2Ev.exit:                            ; preds = %_ZN4ncnnL48conv3x3s1_winograd23_transform_output_tile_bf16sERKNS_3MatERS0_S2_iiiiiS2_.exit, %_ZN4ncnn3Mat7channelEi.exit79
  ...
  %i.bu = load i32, ptr %i.c, align 4, !tbaa !78
...
bb.d:                                             ; preds = %.lr.ph, %_ZN4ncnnL48conv3x3s1_winograd23_transform_output_tile_bf16sERKNS_3MatERS0_S2_iiiiiS2_.exit
  %i.bv = phi i32 [ %.pre, %.lr.ph ], [ %i.arv, %_ZN4ncnnL48conv3x3s1_winograd23_transform_output_tile_bf16sERKNS_3MatERS0_S2_iiiiiS2_.exit ]
  %i.bw = phi i32 [ %i.bm, %.lr.ph ], [ %i.arx, %_ZN4ncnnL48conv3x3s1_winograd23_transform_output_tile_bf16sERKNS_3MatERS0_S2_iiiiiS2_.exit ]
  %.047153 = phi i32 [ 0, %.lr.ph ], [ %i.arw, %_ZN4ncnnL48conv3x3s1_winograd23_transform_output_tile_bf16sERKNS_3MatERS0_S2_iiiiiS2_.exit ] ; 6 uses
  %i.bx = sub nsw i32 %i.bw, %.047153
  %.sroa.speculated119 = call i32 @llvm.smin.i32(i32 %i.bv, i32 %i.bx) ; 19 uses
  %i.by = load i32, ptr %8, align 4, !tbaa !78    ; 2 uses
  %i.bz = icmp sgt i32 %i.by, 0
  br i1 %i.bz, label %.noexc.preheader, label %._crit_edge

.noexc.preheader:                                 ; preds = %bb.d
  %.pre159 = load i32, ptr %9, align 4, !tbaa !78
  br label %.noexc

._crit_edge:                                      ; preds = %.noexc, %bb.d
  %i.ca = load i32, ptr %14, align 4, !tbaa !78   ; 5 uses
  %.val = load ptr, ptr %13, align 8, !tbaa !34   ; 6 uses
  %i.cb = load i32, ptr %i.ao, align 4, !tbaa !86 ; 7 uses
  %i.cc = load i32, ptr %i.ap, align 8, !tbaa !87 ; 5 uses
  %i.cd = load i32, ptr %i.aq, align 8, !tbaa !77 ; 5 uses
  %i.ce = load i64, ptr %i.ar, align 8, !tbaa !35
...
.lr.ph520.i:                                      ; preds = %._crit_edge
  ...
  %i.cl = shl nuw nsw i32 %.sroa.speculated119, 2
  %i.cm = zext nneg i32 %i.cl to i64
  %i.cn = shl nuw nsw i32 %.sroa.speculated119, 3
  %i.co = zext nneg i32 %i.cn to i64
  %i.cp = mul nuw nsw i32 %.sroa.speculated119, 12
  %i.cq = zext nneg i32 %i.cp to i64
  %i.cr = zext nneg i32 %factor.op.mul517.i to i64 ; 12 uses
...
bb.e:                                             ; preds = %.lr.ph520.split.us.i
  ...
  %i.cv = load <4 x float>, ptr %i.cu, align 1, !tbaa !108
  br label %.lr.ph.us.i
...
_ZN4ncnn3MatD2Ev.exit355.us.i:                    ; preds = %bb.n, %.lr.ph.us.i
  ...
  %i.dh = load <4 x float>, ptr %i.dd, align 16, !tbaa !108
  %i.di = load <4 x float>, ptr %i.de, align 16, !tbaa !108 ; 2 uses
  %i.dj = load <4 x float>, ptr %i.df, align 16, !tbaa !108 ; 2 uses
  %i.dk = load <4 x float>, ptr %i.dg, align 16, !tbaa !108
  ...
  store <4 x float> %i.dm, ptr %i.a, align 16, !tbaa !108
  store <4 x float> %i.do, ptr %indvars.iv.i.sroa.gep, align 16, !tbaa !108
  ...
  %i.dt = load <4 x float>, ptr %i.dp, align 16, !tbaa !108
  %i.du = load <4 x float>, ptr %i.dq, align 16, !tbaa !108 ; 2 uses
  %i.dv = load <4 x float>, ptr %i.dr, align 16, !tbaa !108 ; 2 uses
  %i.dw = load <4 x float>, ptr %i.ds, align 16, !tbaa !108
  ...
  store <4 x float> %i.dy, ptr %i.at, align 16, !tbaa !108
  store <4 x float> %i.ea, ptr %i.au, align 16, !tbaa !108
  ...
  %i.ef = load <4 x float>, ptr %i.eb, align 16, !tbaa !108
  %i.eg = load <4 x float>, ptr %i.ec, align 16, !tbaa !108 ; 2 uses
  %i.eh = load <4 x float>, ptr %i.ed, align 16, !tbaa !108 ; 2 uses
  %i.ei = load <4 x float>, ptr %i.ee, align 16, !tbaa !108
  ...
  store <4 x float> %i.ek, ptr %i.av, align 16, !tbaa !108
  store <4 x float> %i.em, ptr %i.aw, align 16, !tbaa !108
  ...
  %i.er = load <4 x float>, ptr %i.en, align 16, !tbaa !108
  %i.es = load <4 x float>, ptr %i.eo, align 16, !tbaa !108 ; 2 uses
  %i.et = load <4 x float>, ptr %i.ep, align 16, !tbaa !108 ; 2 uses
  %i.eu = load <4 x float>, ptr %i.eq, align 16, !tbaa !108
  ...
  store <4 x float> %i.ew, ptr %i.ax, align 16, !tbaa !108
  store <4 x float> %i.ey, ptr %i.ay, align 16, !tbaa !108
  %i.ez = trunc i64 %indvars.iv580.i to i32
  %i.fa = add i32 %.047153, %i.ez                 ; 2 uses
  %i.fb = sdiv i32 %i.fa, %i.ci
  %i.fc = srem i32 %i.fa, %i.ci
  %i.fd = load i32, ptr %i.ao, align 4, !tbaa !86, !noalias !1730
  %i.fe = load ptr, ptr %12, align 8, !tbaa !34, !noalias !1730
  %i.ff = load i64, ptr %i.ar, align 8, !tbaa !35, !noalias !1730
  %i.fg = mul i64 %i.ff, %i.db
  %i.fh = load i64, ptr %i.as, align 8, !tbaa !76, !noalias !1730 ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  %i.fy = load <4 x float>, ptr %indvars.iv.i.sroa.phi, align 1, !tbaa !108
  %i.fz = getelementptr inbounds nuw i8, ptr %indvars.iv.i.sroa.phi, i64 16
  %i.ga = load <4 x float>, ptr %i.fz, align 1, !tbaa !108
  %i.gb = getelementptr inbounds nuw i8, ptr %indvars.iv.i.sroa.phi, i64 32
  %i.gc = load <4 x float>, ptr %i.gb, align 1, !tbaa !108 ; 2 uses
  %i.gd = getelementptr inbounds nuw i8, ptr %indvars.iv.i.sroa.phi, i64 48
  %i.ge = load <4 x float>, ptr %i.gd, align 1, !tbaa !108
...
_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit372.thread369.us.i: ; preds = %bb.g
  %i.gk = load ptr, ptr %15, align 8, !tbaa !34   ; 2 uses
  %i.gl = load float, ptr %i.gk, align 4, !tbaa !53
...
_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit372.thread360.us.i: ; preds = %bb.g
  %i.rk = load ptr, ptr %15, align 8, !tbaa !34   ; 2 uses
  %i.rl = load float, ptr %i.rk, align 4, !tbaa !53
...
_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit372.thread357.us.i: ; preds = %bb.g
  %i.rw = load ptr, ptr %15, align 8, !tbaa !34
  %i.rx = load float, ptr %i.rw, align 4, !tbaa !53
...
bb.h:                                             ; preds = %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit.us.i
  ...
  store i16 %i.so, ptr %.0332514.us.i, align 2, !tbaa !110
  %i.sp = extractelement <8 x i16> %i.sn, i64 3
  store i16 %i.sp, ptr %i.sk, align 2, !tbaa !110
  %i.sq = extractelement <8 x i16> %i.sn, i64 5
  store i16 %i.sq, ptr %i.sl, align 2, !tbaa !110
  %i.sr = extractelement <8 x i16> %i.sn, i64 7
  store i16 %i.sr, ptr %i.sm, align 2, !tbaa !110
...
bb.j:                                             ; preds = %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit.us.i
  ...
  store i64 %i.tg, ptr %.0332514.us.i, align 1, !tbaa !108
...
bb.k:                                             ; preds = %bb.j
  ...
  store i64 %i.tn, ptr %i.th, align 1, !tbaa !108
  br label %bb.l
...
bb.m:                                             ; preds = %bb.l, %bb.f
  ...
  br i1 %i.fw, label %bb.f, label %bb.n, !llvm.loop !1708
...
bb.n:                                             ; preds = %bb.m
  ...
  br i1 %exitcond.not.i, label %._crit_edge.us.i, label %_ZN4ncnn3MatD2Ev.exit355.us.i, !llvm.loop !1709
...
._crit_edge.us.i:                                 ; preds = %bb.n
  ...
  br i1 %i.tq, label %.lr.ph520.split.us.i, label %.preheader508.loopexit.i, !llvm.loop !1710
...
.preheader508.i:                                  ; preds = %.lr.ph520.i, %.preheader508.loopexit.i, %._crit_edge
  %.0340.lcssa.i = phi i32 [ 0, %._crit_edge ], [ %i.tr, %.preheader508.loopexit.i ], [ %i.bq, %.lr.ph520.i ] ; 6 uses
...
.lr.ph536.i:                                      ; preds = %.preheader508.i
  ...
  %i.tv = shl nuw nsw i32 %.sroa.speculated119, 1
  %i.tw = zext nneg i32 %i.tv to i64
  %i.tx = shl nuw nsw i32 %.sroa.speculated119, 2
  %i.ty = zext nneg i32 %i.tx to i64
  %i.tz = mul nuw nsw i32 %.sroa.speculated119, 6
  %i.ua = zext nneg i32 %i.tz to i64
  %i.ub = shl nuw nsw i32 %.sroa.speculated119, 3
  %i.uc = zext nneg i32 %i.ub to i64              ; 12 uses
  %i.ud = sext i32 %i.cb to i64
  br i1 %i.tu, label %.lr.ph536.split.us.i, label %.lr.ph536.split.i

.lr.ph536.split.us.i:                             ; preds = %.lr.ph536.i
  %i.ue = load i32, ptr %i.ao, align 4, !tbaa !86, !noalias !1731
  %i.uf = load ptr, ptr %12, align 8, !tbaa !34, !noalias !1731
  %i.ug = load i64, ptr %i.ar, align 8, !tbaa !35, !noalias !1731
  %i.uh = load i64, ptr %i.as, align 8, !tbaa !76, !noalias !1731 ; 2 uses
...
bb.p:                                             ; preds = %bb.o
  ...
  %i.ul = load <2 x float>, ptr %i.uk, align 4, !tbaa !53
  br label %.thread.us.i
...
_ZN4ncnn3MatD2Ev.exit354.us.i:                    ; preds = %bb.aq, %.thread.us.i
  ...
  %i.uv = load <2 x float>, ptr %i.us, align 4, !tbaa !53 ; 2 uses
  %i.uw = load <2 x float>, ptr %i.ut, align 4, !tbaa !53 ; 2 uses
  %i.ux = fsub fast <2 x float> %i.uv, %i.uw
  %i.uy = load <2 x float>, ptr %i.uu, align 4, !tbaa !53
  ...
  %i.vj = load <2 x float>, ptr %i.va, align 4, !tbaa !53 ; 2 uses
  %i.vk = load <2 x float>, ptr %i.vb, align 4, !tbaa !53 ; 2 uses
  %i.vl = load <2 x float>, ptr %i.vc, align 4, !tbaa !53
  %i.vm = load <2 x float>, ptr %i.vd, align 4, !tbaa !53 ; 2 uses
  %i.vn = load <2 x float>, ptr %i.ve, align 4, !tbaa !53 ; 2 uses
  %i.vo = fsub fast <2 x float> %i.vm, %i.vn
  %i.vp = load <2 x float>, ptr %i.vf, align 4, !tbaa !53
  %i.vq = fadd fast <2 x float> %i.vp, %i.vo      ; 2 uses
  %i.vr = load <2 x float>, ptr %i.vg, align 4, !tbaa !53 ; 2 uses
  %i.vs = load <2 x float>, ptr %i.vh, align 4, !tbaa !53 ; 2 uses
  %i.vt = load <2 x float>, ptr %i.vi, align 4, !tbaa !53
...
bb.r:                                             ; preds = %bb.q
  %i.xa = load ptr, ptr %15, align 8, !tbaa !34   ; 2 uses
  %i.xb = load float, ptr %i.xa, align 4, !tbaa !53 ; 9 uses
  %i.xc = getelementptr inbounds nuw i8, ptr %i.xa, i64 4
  %i.xd = load float, ptr %i.xc, align 4, !tbaa !53 ; 5 uses
...
bb.af:                                            ; preds = %bb.ae
  %i.abx = load ptr, ptr %15, align 8, !tbaa !34  ; 2 uses
  %i.aby = load float, ptr %i.abx, align 4, !tbaa !53 ; 9 uses
  %i.abz = getelementptr inbounds nuw i8, ptr %i.abx, i64 4
  %i.aca = load float, ptr %i.abz, align 4, !tbaa !53 ; 5 uses
  %i.acb = fneg fast float %i.aca
  %i.acc = fdiv fast float %i.acb, %i.aby         ; 8 uses
  %i.acd = extractelement <2 x float> %i.abt, i64 0 ; 5 uses
  %i.ace = fcmp fast olt float %i.acd, %i.acc
  br i1 %i.ace, label %_ZL13activation_ssfiRKN4ncnn3MatE.exit377.thread.us.1.i, label %bb.ag

bb.ag:                                            ; preds = %bb.af
  %i.acf = fdiv fast float 1.000000e+00, %i.aby
  %i.acg = fadd fast float %i.acc, %i.acf
  %i.ach = fcmp fast ogt float %i.acd, %i.acg
  br i1 %i.ach, label %_ZL13activation_ssfiRKN4ncnn3MatE.exit377.thread.us.1.i, label %bb.ah

bb.ah:                                            ; preds = %bb.ag
  %i.aci = fmul fast float %i.aby, %i.acd
  %i.acj = fadd fast float %i.aci, %i.aca
  %i.ack = fmul fast float %i.acj, %i.acd
...
_ZL13activation_ssfiRKN4ncnn3MatE.exit377.thread.us.1.i: ; preds = %bb.ah, %bb.ag, %bb.af
  %.1343373.us.1.i = phi float [ %i.ack, %bb.ah ], [ 0.000000e+00, %bb.af ], [ %i.acd, %bb.ag ]
  %i.acl = extractelement <2 x float> %i.abt, i64 1 ; 5 uses
  %i.acm = fcmp fast olt float %i.acl, %i.acc
  br i1 %i.acm, label %_ZL13activation_ssfiRKN4ncnn3MatE.exit376.thread.us.1.i, label %bb.ai

bb.ai:                                            ; preds = %_ZL13activation_ssfiRKN4ncnn3MatE.exit377.thread.us.1.i
  %i.acn = fdiv fast float 1.000000e+00, %i.aby
  %i.aco = fadd fast float %i.acc, %i.acn
  %i.acp = fcmp fast ogt float %i.acl, %i.aco
  br i1 %i.acp, label %_ZL13activation_ssfiRKN4ncnn3MatE.exit376.thread.us.1.i, label %bb.aj

bb.aj:                                            ; preds = %bb.ai
  %i.acq = fmul fast float %i.aby, %i.acl
  %i.acr = fadd fast float %i.acq, %i.aca
  %i.acs = fmul fast float %i.acr, %i.acl
...
_ZL13activation_ssfiRKN4ncnn3MatE.exit376.thread.us.1.i: ; preds = %bb.aj, %bb.ai, %_ZL13activation_ssfiRKN4ncnn3MatE.exit377.thread.us.1.i
  %.1345396.us.1.i = phi float [ %i.acs, %bb.aj ], [ 0.000000e+00, %_ZL13activation_ssfiRKN4ncnn3MatE.exit377.thread.us.1.i ], [ %i.acl, %bb.ai ]
  %i.act = extractelement <2 x float> %i.abw, i64 0 ; 5 uses
  %i.acu = fcmp fast olt float %i.act, %i.acc
  br i1 %i.acu, label %_ZL13activation_ssfiRKN4ncnn3MatE.exit375.thread.us.1.i, label %bb.ak

bb.ak:                                            ; preds = %_ZL13activation_ssfiRKN4ncnn3MatE.exit376.thread.us.1.i
  %i.acv = fdiv fast float 1.000000e+00, %i.aby
  %i.acw = fadd fast float %i.acc, %i.acv
  %i.acx = fcmp fast ogt float %i.act, %i.acw
  br i1 %i.acx, label %_ZL13activation_ssfiRKN4ncnn3MatE.exit375.thread.us.1.i, label %bb.al

bb.al:                                            ; preds = %bb.ak
  %i.acy = fmul fast float %i.aby, %i.act
  %i.acz = fadd fast float %i.acy, %i.aca
  %i.ada = fmul fast float %i.acz, %i.act
...
_ZL13activation_ssfiRKN4ncnn3MatE.exit375.thread.us.1.i: ; preds = %bb.al, %bb.ak, %_ZL13activation_ssfiRKN4ncnn3MatE.exit376.thread.us.1.i
  %.1347432.us.1.i = phi float [ %i.ada, %bb.al ], [ 0.000000e+00, %_ZL13activation_ssfiRKN4ncnn3MatE.exit376.thread.us.1.i ], [ %i.act, %bb.ak ] ; 2 uses
  %i.adb = extractelement <2 x float> %i.abw, i64 1 ; 4 uses
  %i.adc = fcmp fast olt float %i.adb, %i.acc
  %i.add = insertelement <2 x float> <float poison, float 0.000000e+00>, float %.1347432.us.1.i, i64 0 ; 2 uses
  %i.ade = insertelement <2 x float> poison, float %.1343373.us.1.i, i64 0
  %i.adf = insertelement <2 x float> %i.ade, float %.1345396.us.1.i, i64 1 ; 3 uses
  br i1 %i.adc, label %_ZL13activation_ssfiRKN4ncnn3MatE.exit374.us.1.i, label %bb.am

bb.am:                                            ; preds = %_ZL13activation_ssfiRKN4ncnn3MatE.exit375.thread.us.1.i
  %i.adg = fdiv fast float 1.000000e+00, %i.aby
  %i.adh = fadd fast float %i.acc, %i.adg
  %i.adi = fcmp fast ogt float %i.adb, %i.adh
  %i.adj = insertelement <2 x float> %i.abw, float %.1347432.us.1.i, i64 0
  br i1 %i.adi, label %_ZL13activation_ssfiRKN4ncnn3MatE.exit374.us.1.i, label %bb.an

bb.an:                                            ; preds = %bb.am
  %i.adk = fmul fast float %i.aby, %i.adb
  %i.adl = fadd fast float %i.adk, %i.aca
  %i.adm = fmul fast float %i.adl, %i.adb
  %i.adn = insertelement <2 x float> %i.add, float %i.adm, i64 1
...
_ZL13activation_ssfiRKN4ncnn3MatE.exit377.thread389.us.1.i: ; preds = %bb.ae
  %i.ado = call fast <2 x float> @llvm.exp.v2f32(<2 x float> %i.abt)
  %i.adp = fadd fast <2 x float> %i.ado, splat (float 1.000000e+00)
  %i.adq = call fast <2 x float> @llvm.log.v2f32(<2 x float> %i.adp)
  %i.adr = call fast <2 x float> @llvm.tanh.v2f32(<2 x float> %i.adq)
  %i.ads = fmul fast <2 x float> %i.adr, %i.abt
  %i.adt = extractelement <2 x float> %i.abw, i64 0
  %i.adu = call fast float @llvm.exp.f32(float nofpclass(nan inf) %i.adt)
  %i.adv = extractelement <2 x float> %i.abw, i64 1
  %i.adw = call fast float @llvm.exp.f32(float nofpclass(nan inf) %i.adv)
  %i.adx = fadd fast float %i.adw, 1.000000e+00
  %i.ady = fadd fast float %i.adu, 1.000000e+00
  %i.adz = call fast float @llvm.log.f32(float %i.adx)
  %i.aea = call fast float @llvm.log.f32(float %i.ady)
  %i.aeb = call fast float @llvm.tanh.f32(float %i.adz)
  %i.aec = call fast float @llvm.tanh.f32(float %i.aea)
  %i.aed = insertelement <2 x float> poison, float %i.aec, i64 0
  %i.aee = insertelement <2 x float> %i.aed, float %i.aeb, i64 1
  %i.aef = fmul fast <2 x float> %i.aee, %i.abw
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit374.us.1.i

_ZL13activation_ssfiRKN4ncnn3MatE.exit377.thread386.us.1.i: ; preds = %bb.ae
  %i.aeg = call nnan ninf nsz <2 x float> @llvm.minnum.v2f32(<2 x float> %i.abt, <2 x float> splat (float f0x42B0C0A5))
  %i.aeh = call nnan ninf nsz <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.aeg, <2 x float> splat (float f0xC2B0C0A5))
  %i.aei = fneg fast <2 x float> %i.aeh
  %i.aej = call fast <2 x float> @llvm.exp.v2f32(<2 x float> %i.aei)
  %i.aek = fadd fast <2 x float> %i.aej, splat (float 1.000000e+00)
  %i.ael = fdiv fast <2 x float> splat (float 1.000000e+00), %i.aek
  %i.aem = call nnan ninf nsz <2 x float> @llvm.minnum.v2f32(<2 x float> %i.abw, <2 x float> splat (float f0x42B0C0A5))
...
_ZL13activation_ssfiRKN4ncnn3MatE.exit377.thread377.us.1.i: ; preds = %bb.ae
  %i.aes = load ptr, ptr %15, align 8, !tbaa !34
  %i.aet = load <2 x float>, ptr %i.aes, align 4, !tbaa !53 ; 5 uses
  %i.aeu = shufflevector <2 x float> %i.aet, <2 x float> poison, <2 x i32> zeroinitializer
  %i.aev = call nnan ninf nsz <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.abt, <2 x float> %i.aeu) ; 2 uses
  %i.aew = shufflevector <2 x float> %i.aet, <2 x float> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  %i.aex = fcmp fast ogt <2 x float> %i.aev, %i.aew
  %i.aey = select <2 x i1> %i.aex, <2 x float> %i.aew, <2 x float> %i.aev ; 2 uses
  %i.aez = extractelement <2 x float> %i.abw, i64 0
  %i.afa = extractelement <2 x float> %i.aet, i64 0 ; 2 uses
  %.0346.us.1.i = call nnan ninf nsz float @llvm.maxnum.f32(float %i.aez, float %i.afa) ; 2 uses
  %i.afb = extractelement <2 x float> %i.aet, i64 1 ; 3 uses
  %i.afc = fcmp fast ogt float %.0346.us.1.i, %i.afb
  %.1347442.us.1.i = select i1 %i.afc, float %i.afb, float %.0346.us.1.i ; 2 uses
  %i.afd = extractelement <2 x float> %i.abw, i64 1
  %.0348.us.1.i = call nnan ninf nsz float @llvm.maxnum.f32(float %i.afd, float %i.afa) ; 2 uses
  %i.afe = fcmp fast ogt float %.0348.us.1.i, %i.afb
  %i.aff = insertelement <2 x float> poison, float %.1347442.us.1.i, i64 0
  %i.afg = insertelement <2 x float> %i.aff, float %.0348.us.1.i, i64 1
  br i1 %i.afe, label %bb.ao, label %_ZL13activation_ssfiRKN4ncnn3MatE.exit374.us.1.i

bb.ao:                                            ; preds = %_ZL13activation_ssfiRKN4ncnn3MatE.exit377.thread377.us.1.i
  %i.afh = insertelement <2 x float> %i.aet, float %.1347442.us.1.i, i64 0
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit374.us.1.i

_ZL13activation_ssfiRKN4ncnn3MatE.exit377.thread383.us.1.i: ; preds = %bb.ae
  %i.afi = load ptr, ptr %15, align 8, !tbaa !34
  %i.afj = load float, ptr %i.afi, align 4, !tbaa !53
  %i.afk = fcmp fast ogt <2 x float> %i.abt, zeroinitializer
  %i.afl = insertelement <2 x float> poison, float %i.afj, i64 0
  %i.afm = shufflevector <2 x float> %i.afl, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.afn = select <2 x i1> %i.afk, <2 x float> splat (float 1.000000e+00), <2 x float> %i.afm
  %i.afo = fmul fast <2 x float> %i.afn, %i.abt
  %i.afp = fcmp fast ogt <2 x float> %i.abw, zeroinitializer
  %i.afq = select <2 x i1> %i.afp, <2 x float> splat (float 1.000000e+00), <2 x float> %i.afm
  %i.afr = fmul fast <2 x float> %i.afq, %i.abw
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit374.us.1.i

_ZL13activation_ssfiRKN4ncnn3MatE.exit377.thread380.us.1.i: ; preds = %bb.ae
  %i.afs = call fast <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.abt, <2 x float> zeroinitializer)
  %i.aft = call fast <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.abw, <2 x float> zeroinitializer)
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit374.us.1.i
...
_ZL13activation_ssfiRKN4ncnn3MatE.exit374.us.1.i: ; preds = %_ZL13activation_ssfiRKN4ncnn3MatE.exit377.thread380.us.1.i, %_ZL13activation_ssfiRKN4ncnn3MatE.exit377.thread383.us.1.i, %bb.ao, %_ZL13activation_ssfiRKN4ncnn3MatE.exit377.thread377.us.1.i, %_ZL13activation_ssfiRKN4ncnn3MatE.exit377.thread386.us.1.i, %_ZL13activation_ssfiRKN4ncnn3MatE.exit377.thread389.us.1.i, %bb.an, %bb.am, %_ZL13activation_ssfiRKN4ncnn3MatE.exit375.thread.us.1.i, %bb.ae
  %i.afu = phi <2 x float> [ %i.add, %_ZL13activation_ssfiRKN4ncnn3MatE.exit375.thread.us.1.i ], [ %i.aft, %_ZL13activation_ssfiRKN4ncnn3MatE.exit377.thread380.us.1.i ], [ %i.afr, %_ZL13activation_ssfiRKN4ncnn3MatE.exit377.thread383.us.1.i ], [ %i.afh, %bb.ao ], [ %i.afg, %_ZL13activation_ssfiRKN4ncnn3MatE.exit377.thread377.us.1.i ], [ %i.aer, %_ZL13activation_ssfiRKN4ncnn3MatE.exit377.thread386.us.1.i ], [ %i.aef, %_ZL13activation_ssfiRKN4ncnn3MatE.exit377.thread389.us.1.i ], [ %i.adn, %bb.an ], [ %i.adj, %bb.am ], [ %i.abw, %bb.ae ]
  %i.afv = phi <2 x float> [ %i.adf, %_ZL13activation_ssfiRKN4ncnn3MatE.exit375.thread.us.1.i ], [ %i.afs, %_ZL13activation_ssfiRKN4ncnn3MatE.exit377.thread380.us.1.i ], [ %i.afo, %_ZL13activation_ssfiRKN4ncnn3MatE.exit377.thread383.us.1.i ], [ %i.aey, %bb.ao ], [ %i.aey, %_ZL13activation_ssfiRKN4ncnn3MatE.exit377.thread377.us.1.i ], [ %i.ael, %_ZL13activation_ssfiRKN4ncnn3MatE.exit377.thread386.us.1.i ], [ %i.ads, %_ZL13activation_ssfiRKN4ncnn3MatE.exit377.thread389.us.1.i ], [ %i.adf, %bb.an ], [ %i.adf, %bb.am ], [ %i.abt, %bb.ae ]
  %i.afw = getelementptr inbounds nuw [2 x i8], ptr %.1324.us.i, i64 %i.cg ; 2 uses
  %i.afx = bitcast <2 x float> %i.afv to <2 x i32>
  %i.afy = lshr <2 x i32> %i.afx, splat (i32 16)
  %i.afz = trunc nuw <2 x i32> %i.afy to <2 x i16> ; 2 uses
  %i.aga = extractelement <2 x i16> %i.afz, i64 0
  store i16 %i.aga, ptr %.1324.us.i, align 2, !tbaa !110
  %i.agb = extractelement <2 x i16> %i.afz, i64 1
  store i16 %i.agb, ptr %i.afw, align 2, !tbaa !110
  br i1 %i.wf, label %bb.ap, label %bb.aq

bb.ap:                                            ; preds = %_ZL13activation_ssfiRKN4ncnn3MatE.exit374.us.1.i
  %i.agc = bitcast <2 x float> %i.afu to <2 x i32>
  %i.agd = getelementptr inbounds nuw i8, ptr %.1324.us.i, i64 2
  %i.age = lshr <2 x i32> %i.agc, splat (i32 16)
  %i.agf = trunc nuw <2 x i32> %i.age to <2 x i16> ; 2 uses
  %i.agg = extractelement <2 x i16> %i.agf, i64 0
  store i16 %i.agg, ptr %i.agd, align 2, !tbaa !110
  %i.agh = getelementptr inbounds nuw i8, ptr %i.afw, i64 2
  %i.agi = extractelement <2 x i16> %i.agf, i64 1
  store i16 %i.agi, ptr %i.agh, align 2, !tbaa !110
  br label %bb.aq
...
bb.aq:                                            ; preds = %bb.ap, %_ZL13activation_ssfiRKN4ncnn3MatE.exit374.us.1.i, %bb.ad
  ...
  br i1 %exitcond598.not.i, label %._crit_edge.us540.i, label %_ZN4ncnn3MatD2Ev.exit354.us.i, !llvm.loop !1713

._crit_edge.us540.i:                              ; preds = %bb.aq
  %indvars.iv.next600.i = add nuw nsw i64 %indvars.iv599.i, 2 ; 3 uses
  %i.agj = icmp slt i64 %indvars.iv.next600.i, %invariant.op.i
  br i1 %i.agj, label %bb.o, label %.preheader.loopexit.i, !llvm.loop !1714

.lr.ph536.split.i:                                ; preds = %.lr.ph536.i
  %18 = add i32 %.0340.lcssa.i, 3
  %smax586.i = call i32 @llvm.smax.i32(i32 %.sroa.speculated123, i32 %18)
  %reass.sub = sub i32 %smax586.i, %.0340.lcssa.i
  %19 = and i32 %reass.sub, -2
  %i.agk = add i32 %.0340.lcssa.i, %19
  br label %.preheader.i

.preheader.loopexit.i:                            ; preds = %._crit_edge.us540.i
  %i.agl = trunc nsw i64 %indvars.iv.next600.i to i32
  br label %.preheader.i

.preheader.i:                                     ; preds = %.preheader.loopexit.i, %.lr.ph536.split.i, %.preheader508.i
  %.1341.lcssa.i = phi i32 [ %.0340.lcssa.i, %.preheader508.i ], [ %i.agk, %.lr.ph536.split.i ], [ %i.agl, %.preheader.loopexit.i ] ; 2 uses
  %i.agm = icmp slt i32 %.1341.lcssa.i, %.sroa.speculated123
  br i1 %i.agm, label %.lr.ph560.i, label %_ZN4ncnnL48conv3x3s1_winograd23_transform_output_tile_bf16sERKNS_3MatERS0_S2_iiiiiS2_.exit

.lr.ph560.i:                                      ; preds = %.preheader.i
  %.not.i82 = icmp eq ptr %.val, null
  %i.agn = icmp sgt i32 %.sroa.speculated119, 0
  %i.ago = sext i32 %.sroa.speculated119 to i64
  %i.agp = shl nuw nsw i32 %.sroa.speculated119, 1
  %i.agq = zext nneg i32 %i.agp to i64
  %i.agr = mul nuw nsw i32 %.sroa.speculated119, 3
  %i.ags = zext nneg i32 %i.agr to i64
  %i.agt = shl nuw nsw i32 %.sroa.speculated119, 2
  %i.agu = zext nneg i32 %i.agt to i64            ; 12 uses
  %i.agv = sext i32 %i.cb to i64
  br i1 %i.agn, label %.lr.ph560.split.us.i, label %_ZN4ncnnL48conv3x3s1_winograd23_transform_output_tile_bf16sERKNS_3MatERS0_S2_iiiiiS2_.exit

.lr.ph560.split.us.i:                             ; preds = %.lr.ph560.i
  %i.agw = load i32, ptr %i.ao, align 4, !tbaa !86, !noalias !1732
  %i.agx = load ptr, ptr %12, align 8, !tbaa !34, !noalias !1732
  %i.agy = load i64, ptr %i.ar, align 8, !tbaa !35, !noalias !1732
  %i.agz = load i64, ptr %i.as, align 8, !tbaa !76, !noalias !1732 ; 2 uses
  %factor.op.mul565.i = mul i64 %i.agz, %i.agy
  %i.aha = sext i32 %i.agw to i64
  %factor.op.mul556.us.i = mul i64 %i.agz, %i.aha
  %i.ahb = sext i32 %.1341.lcssa.i to i64
  %wide.trip.count612.i = zext nneg i32 %.sroa.speculated119 to i64
  br label %bb.ar

bb.ar:                                            ; preds = %._crit_edge.us563.i, %.lr.ph560.split.us.i
  %indvars.iv614.i = phi i64 [ %indvars.iv.next615.i, %._crit_edge.us563.i ], [ %i.ahb, %.lr.ph560.split.us.i ] ; 3 uses
  %.pre627.i = add nsw i64 %indvars.iv614.i, %i.bp ; 2 uses
  br i1 %.not.i82, label %.lr.ph.us562.i, label %bb.as

bb.as:                                            ; preds = %bb.ar
  %i.ahc = getelementptr inbounds [4 x i8], ptr %.val, i64 %.pre627.i
  %i.ahd = load float, ptr %i.ahc, align 4, !tbaa !53
  br label %.lr.ph.us562.i

.lr.ph.us562.i:                                   ; preds = %bb.as, %bb.ar
  %i.ahe = phi fast float [ %i.ahd, %bb.as ], [ 0.000000e+00, %bb.ar ] ; 2 uses
  %i.ahf = trunc nsw i64 %indvars.iv614.i to i32
  %factor.op.mul553.reass.us.i = mul i32 %factor.op.mul517.i, %i.ahf
  %i.ahg = sext i32 %factor.op.mul553.reass.us.i to i64
  %i.ahh = getelementptr inbounds [4 x i8], ptr %i.bi, i64 %i.ahg
  %.reass566.i = mul i64 %factor.op.mul565.i, %.pre627.i
  %i.ahi = getelementptr inbounds nuw i8, ptr %i.agx, i64 %.reass566.i
  br label %_ZN4ncnn3MatD2Ev.exit.us.i
...
_ZN4ncnn3MatD2Ev.exit.us.i:                       ; preds = %bb.bl, %.lr.ph.us562.i
  ...
  %i.ahj = getelementptr inbounds nuw [4 x i8], ptr %i.ahh, i64 %indvars.iv609.i ; 5 uses
  %i.ahk = getelementptr inbounds nuw [4 x i8], ptr %i.ahj, i64 %i.ago ; 2 uses
  %i.ahl = getelementptr inbounds nuw [4 x i8], ptr %i.ahj, i64 %i.agq ; 2 uses
  %i.ahm = getelementptr inbounds nuw [4 x i8], ptr %i.ahj, i64 %i.ags ; 2 uses
  %i.ahn = load float, ptr %i.ahk, align 4, !tbaa !53 ; 2 uses
  %i.aho = load float, ptr %i.ahl, align 4, !tbaa !53 ; 2 uses
  %i.ahp = fsub fast float %i.ahn, %i.aho
  %i.ahq = load float, ptr %i.ahm, align 4, !tbaa !53
  %i.ahr = fadd fast float %i.ahp, %i.ahq
  %i.ahs = getelementptr inbounds nuw [4 x i8], ptr %i.ahk, i64 %i.agu ; 2 uses
  %i.aht = getelementptr inbounds nuw [4 x i8], ptr %i.ahl, i64 %i.agu ; 2 uses
  %i.ahu = getelementptr inbounds nuw [4 x i8], ptr %i.ahm, i64 %i.agu ; 2 uses
  %i.ahv = load float, ptr %i.ahs, align 4, !tbaa !53 ; 2 uses
  %i.ahw = load float, ptr %i.aht, align 4, !tbaa !53 ; 2 uses
  %i.ahx = load float, ptr %i.ahu, align 4, !tbaa !53
  %i.ahy = getelementptr inbounds nuw [4 x i8], ptr %i.ahs, i64 %i.agu ; 2 uses
  %i.ahz = getelementptr inbounds nuw [4 x i8], ptr %i.aht, i64 %i.agu ; 2 uses
  %i.aia = getelementptr inbounds nuw [4 x i8], ptr %i.ahu, i64 %i.agu ; 2 uses
  %i.aib = load float, ptr %i.ahy, align 4, !tbaa !53 ; 2 uses
  %i.aic = load float, ptr %i.ahz, align 4, !tbaa !53 ; 2 uses
  %i.aid = fsub fast float %i.aib, %i.aic
  %i.aie = load float, ptr %i.aia, align 4, !tbaa !53
  %i.aif = fadd fast float %i.aid, %i.aie         ; 2 uses
  %i.aig = getelementptr inbounds nuw [4 x i8], ptr %i.ahy, i64 %i.agu
  %i.aih = getelementptr inbounds nuw [4 x i8], ptr %i.ahz, i64 %i.agu
  %i.aii = getelementptr inbounds nuw [4 x i8], ptr %i.aia, i64 %i.agu
  %i.aij = load float, ptr %i.aig, align 4, !tbaa !53 ; 2 uses
  %i.aik = load float, ptr %i.aih, align 4, !tbaa !53 ; 2 uses
  %i.ail = fsub fast float %i.aij, %i.aik
  %i.aim = load float, ptr %i.aii, align 4, !tbaa !53
  %i.ain = trunc i64 %indvars.iv609.i to i32
  %i.aio = add i32 %.047153, %i.ain               ; 2 uses
  %i.aip = sdiv i32 %i.aio, %i.ci
  %i.aiq = srem i32 %i.aio, %i.ci
  %i.air = shl nsw i32 %i.aip, 1                  ; 3 uses
  %i.ais = sext i32 %i.air to i64
  %.reass557.us.i = mul i64 %factor.op.mul556.us.i, %i.ais
  %i.ait = getelementptr inbounds nuw i8, ptr %i.ahi, i64 %.reass557.us.i
  %i.aiu = shl nsw i32 %i.aiq, 1                  ; 2 uses
  %i.aiv = sext i32 %i.aiu to i64
  %i.aiw = getelementptr inbounds [2 x i8], ptr %i.ait, i64 %i.aiv ; 4 uses
  %i.aix = or disjoint i32 %i.aiu, 1
  %i.aiy = icmp slt i32 %i.aix, %i.cb             ; 2 uses
  %.not348.us.i = icmp slt i32 %i.air, %i.cc
  br i1 %.not348.us.i, label %bb.at, label %bb.bc

bb.at:                                            ; preds = %_ZN4ncnn3MatD2Ev.exit.us.i
  %i.aiz = getelementptr inbounds nuw [4 x i8], ptr %i.ahj, i64 %i.agu ; 2 uses
  %i.aja = getelementptr inbounds nuw [4 x i8], ptr %i.aiz, i64 %i.agu ; 2 uses
  %i.ajb = getelementptr inbounds nuw [4 x i8], ptr %i.aja, i64 %i.agu
  %i.ajc = load float, ptr %i.ajb, align 4, !tbaa !53
  %i.ajd = load float, ptr %i.aja, align 4, !tbaa !53
  %i.aje = fadd fast float %i.aic, %i.aib
  %i.ajf = fadd fast float %i.aje, %i.ajd         ; 2 uses
  %i.ajg = load float, ptr %i.aiz, align 4, !tbaa !53
  %i.ajh = load float, ptr %i.ahj, align 4, !tbaa !53
  %i.aji = fadd fast float %i.ahv, %i.ahe
  %i.ajj = fadd fast float %i.aji, %i.ahw
  %i.ajk = fadd fast float %i.ajj, %i.ajg         ; 2 uses
  %i.ajl = fadd fast float %i.aho, %i.ahn
  %i.ajm = fsub fast float %i.ajk, %i.ajf
  %i.ajn = insertelement <2 x float> poison, float %i.ajl, i64 0
  %i.ajo = insertelement <2 x float> %i.ajn, float %i.aik, i64 1
  %i.ajp = insertelement <2 x float> poison, float %i.ajh, i64 0
  %i.ajq = insertelement <2 x float> %i.ajp, float %i.aij, i64 1
  %i.ajr = fadd fast <2 x float> %i.ajo, %i.ajq
  %i.ajs = insertelement <2 x float> poison, float %i.ajf, i64 0
  %i.ajt = insertelement <2 x float> %i.ajs, float %i.ajc, i64 1
  %i.aju = fadd fast <2 x float> %i.ajr, %i.ajt
  %i.ajv = insertelement <2 x float> poison, float %i.ajk, i64 0
  %i.ajw = insertelement <2 x float> %i.ajv, float %i.ajm, i64 1
  %i.ajx = fadd fast <2 x float> %i.aju, %i.ajw   ; 13 uses
...
bb.au:                                            ; preds = %bb.at
  %i.ajy = load ptr, ptr %15, align 8, !tbaa !34  ; 2 uses
  %i.ajz = load float, ptr %i.ajy, align 4, !tbaa !53 ; 5 uses
  %i.aka = getelementptr inbounds nuw i8, ptr %i.ajy, i64 4
  %i.akb = load float, ptr %i.aka, align 4, !tbaa !53 ; 3 uses
  %i.akc = fneg fast float %i.akb
  %i.akd = fdiv fast float %i.akc, %i.ajz         ; 4 uses
  %i.ake = extractelement <2 x float> %i.ajx, i64 0 ; 5 uses
  %i.akf = fcmp fast olt float %i.ake, %i.akd
  br i1 %i.akf, label %_ZL13activation_ssfiRKN4ncnn3MatE.exit373.thread.us.i, label %bb.av

bb.av:                                            ; preds = %bb.au
  %i.akg = fdiv fast float 1.000000e+00, %i.ajz
  %i.akh = fadd fast float %i.akd, %i.akg
  %i.aki = fcmp fast ogt float %i.ake, %i.akh
  br i1 %i.aki, label %_ZL13activation_ssfiRKN4ncnn3MatE.exit373.thread.us.i, label %bb.aw

bb.aw:                                            ; preds = %bb.av
  %i.akj = fmul fast float %i.ajz, %i.ake
  %i.akk = fadd fast float %i.akj, %i.akb
  %i.akl = fmul fast float %i.akk, %i.ake
...
_ZL13activation_ssfiRKN4ncnn3MatE.exit373.thread.us.i: ; preds = %bb.aw, %bb.av, %bb.au
  %.1351472.us.i = phi float [ %i.akl, %bb.aw ], [ 0.000000e+00, %bb.au ], [ %i.ake, %bb.av ] ; 2 uses
  %i.akm = extractelement <2 x float> %i.ajx, i64 1 ; 4 uses
  %i.akn = fcmp fast olt float %i.akm, %i.akd
  %i.ako = insertelement <2 x float> <float poison, float 0.000000e+00>, float %.1351472.us.i, i64 0 ; 2 uses
  br i1 %i.akn, label %_ZL13activation_ssfiRKN4ncnn3MatE.exit.us.i, label %bb.ax

bb.ax:                                            ; preds = %_ZL13activation_ssfiRKN4ncnn3MatE.exit373.thread.us.i
  %i.akp = fdiv fast float 1.000000e+00, %i.ajz
  %i.akq = fadd fast float %i.akd, %i.akp
  %i.akr = fcmp fast ogt float %i.akm, %i.akq
  %i.aks = insertelement <2 x float> %i.ajx, float %.1351472.us.i, i64 0
  br i1 %i.akr, label %_ZL13activation_ssfiRKN4ncnn3MatE.exit.us.i, label %bb.ay

bb.ay:                                            ; preds = %bb.ax
  %i.akt = fmul fast float %i.ajz, %i.akm
  %i.aku = fadd fast float %i.akt, %i.akb
  %i.akv = fmul fast float %i.aku, %i.akm
  %i.akw = insertelement <2 x float> %i.ako, float %i.akv, i64 1
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit.us.i

_ZL13activation_ssfiRKN4ncnn3MatE.exit373.thread488.us.i: ; preds = %bb.at
  %i.akx = extractelement <2 x float> %i.ajx, i64 0
  %i.aky = call fast float @llvm.exp.f32(float nofpclass(nan inf) %i.akx)
  %i.akz = extractelement <2 x float> %i.ajx, i64 1
  %i.ala = call fast float @llvm.exp.f32(float nofpclass(nan inf) %i.akz)
  %i.alb = fadd fast float %i.ala, 1.000000e+00
  %i.alc = fadd fast float %i.aky, 1.000000e+00
  %i.ald = call fast float @llvm.log.f32(float %i.alb)
  %i.ale = call fast float @llvm.log.f32(float %i.alc)
  %i.alf = call fast float @llvm.tanh.f32(float %i.ald)
  %i.alg = call fast float @llvm.tanh.f32(float %i.ale)
  %i.alh = insertelement <2 x float> poison, float %i.alg, i64 0
  %i.ali = insertelement <2 x float> %i.alh, float %i.alf, i64 1
  %i.alj = fmul fast <2 x float> %i.ali, %i.ajx
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit.us.i
...
bb.c:                                             ; preds = %.lr.ph138, %_ZN4ncnn3MatD2Ev.exit
  ...
  %i.co = load i32, ptr %3, align 4, !tbaa !78
...
_ZN4ncnn3Mat7channelEi.exit79:                    ; preds = %bb.c
  %i.cr = load ptr, ptr %4, align 8, !tbaa !34, !noalias !1787
  %i.cs = load i64, ptr %i.n, align 8, !tbaa !35, !noalias !1787
  %i.ct = sext i32 %i.cq to i64
  %i.cu = mul i64 %i.cs, %i.ct
  %i.cv = load i64, ptr %i.o, align 8, !tbaa !76, !noalias !1787
  %i.cw = mul i64 %i.cu, %i.cv
  %i.cx = getelementptr inbounds nuw i8, ptr %i.cr, i64 %i.cw ; 4 uses
  %i.cy = load i32, ptr %5, align 4, !tbaa !78
  %i.cz = sub nsw i32 %i.cy, %i.cp
  %i.da = load i32, ptr %3, align 4, !tbaa !78
  %.sroa.speculated124 = call i32 @llvm.smin.i32(i32 %i.da, i32 %i.cz) ; 8 uses
  %i.db = load i32, ptr %6, align 4, !tbaa !78    ; 2 uses
...
_ZN4ncnn3MatD2Ev.exit:                            ; preds = %_ZN4ncnnL48conv3x3s1_winograd43_transform_output_tile_bf16sERKNS_3MatERS0_S2_iiiiiS2_.exit, %_ZN4ncnn3Mat7channelEi.exit79
  ...
  %i.dj = load i32, ptr %i.d, align 4, !tbaa !78
...
bb.d:                                             ; preds = %.lr.ph, %_ZN4ncnnL48conv3x3s1_winograd43_transform_output_tile_bf16sERKNS_3MatERS0_S2_iiiiiS2_.exit
  %i.dk = phi i32 [ %.pre, %.lr.ph ], [ %i.ckk, %_ZN4ncnnL48conv3x3s1_winograd43_transform_output_tile_bf16sERKNS_3MatERS0_S2_iiiiiS2_.exit ]
  %i.dl = phi i32 [ %i.db, %.lr.ph ], [ %i.ckm, %_ZN4ncnnL48conv3x3s1_winograd43_transform_output_tile_bf16sERKNS_3MatERS0_S2_iiiiiS2_.exit ]
  %.047134 = phi i32 [ 0, %.lr.ph ], [ %i.ckl, %_ZN4ncnnL48conv3x3s1_winograd43_transform_output_tile_bf16sERKNS_3MatERS0_S2_iiiiiS2_.exit ] ; 6 uses
  %i.dm = sub nsw i32 %i.dl, %.047134
  %.sroa.speculated120 = call i32 @llvm.smin.i32(i32 %i.dk, i32 %i.dm) ; 26 uses
  %i.dn = load i32, ptr %8, align 4, !tbaa !78    ; 2 uses
...
._crit_edge:                                      ; preds = %.noexc, %bb.d
  %i.dp = load i32, ptr %14, align 4, !tbaa !78   ; 6 uses
  %.val81 = load ptr, ptr %13, align 8, !tbaa !34 ; 6 uses
  %i.dq = load i32, ptr %i.ap, align 4, !tbaa !86 ; 13 uses
  %i.dr = load i32, ptr %i.aq, align 8, !tbaa !87 ; 6 uses
  %i.ds = load i32, ptr %i.ar, align 8, !tbaa !77 ; 5 uses
  %i.dt = load i64, ptr %i.as, align 8, !tbaa !35
...
.lr.ph1351.i:                                     ; preds = %._crit_edge
  ...
  %i.ea = shl nuw nsw i32 %.sroa.speculated120, 2
  %i.eb = zext nneg i32 %i.ea to i64
  %i.ec = shl nuw nsw i32 %.sroa.speculated120, 3
  %i.ed = zext nneg i32 %i.ec to i64
  %i.ee = mul nuw nsw i32 %.sroa.speculated120, 12
  %i.ef = zext nneg i32 %i.ee to i64
  %i.eg = shl nuw nsw i32 %.sroa.speculated120, 4
  %i.eh = zext nneg i32 %i.eg to i64
  %i.ei = mul nuw nsw i32 %.sroa.speculated120, 20
  %i.ej = zext nneg i32 %i.ei to i64
  %i.ek = mul nuw nsw i32 %.sroa.speculated120, 24
  %i.el = zext nneg i32 %i.ek to i64              ; 30 uses
...
bb.e:                                             ; preds = %.lr.ph1351.split.us.i
  ...
  %i.ep = load <4 x float>, ptr %i.eo, align 1, !tbaa !108
  br label %.lr.ph.us.i
...
_ZN4ncnn3MatD2Ev.exit560.us.i:                    ; preds = %bb.v, %.lr.ph.us.i
  ...
  %i.fd = load <4 x float>, ptr %i.ex, align 16, !tbaa !108
  %i.fe = load <4 x float>, ptr %i.ey, align 16, !tbaa !108 ; 2 uses
  %i.ff = load <4 x float>, ptr %i.ez, align 16, !tbaa !108 ; 2 uses
  %i.fg = load <4 x float>, ptr %i.fa, align 16, !tbaa !108 ; 2 uses
  %i.fh = load <4 x float>, ptr %i.fb, align 16, !tbaa !108 ; 2 uses
  %i.fi = load <4 x float>, ptr %i.fc, align 16, !tbaa !108
  ...
  store <4 x float> %i.fo, ptr %i.a, align 16, !tbaa !108
  store <4 x float> %i.fr, ptr %i.at, align 16, !tbaa !108
  store <4 x float> %i.fu, ptr %i.au, align 16, !tbaa !108
  store <4 x float> %i.fy, ptr %i.av, align 16, !tbaa !108
  ...
  %i.gf = load <4 x float>, ptr %i.fz, align 16, !tbaa !108
  %i.gg = load <4 x float>, ptr %i.ga, align 16, !tbaa !108 ; 2 uses
  %i.gh = load <4 x float>, ptr %i.gb, align 16, !tbaa !108 ; 2 uses
  %i.gi = load <4 x float>, ptr %i.gc, align 16, !tbaa !108 ; 2 uses
  %i.gj = load <4 x float>, ptr %i.gd, align 16, !tbaa !108 ; 2 uses
  %i.gk = load <4 x float>, ptr %i.ge, align 16, !tbaa !108
  ...
  store <4 x float> %i.gq, ptr %i.ax, align 16, !tbaa !108
  store <4 x float> %i.gt, ptr %i.ay, align 16, !tbaa !108
  store <4 x float> %i.gw, ptr %i.az, align 16, !tbaa !108
  store <4 x float> %i.ha, ptr %i.ba, align 16, !tbaa !108
  ...
  %i.hh = load <4 x float>, ptr %i.hb, align 16, !tbaa !108
  %i.hi = load <4 x float>, ptr %i.hc, align 16, !tbaa !108 ; 2 uses
  %i.hj = load <4 x float>, ptr %i.hd, align 16, !tbaa !108 ; 2 uses
  %i.hk = load <4 x float>, ptr %i.he, align 16, !tbaa !108 ; 2 uses
  %i.hl = load <4 x float>, ptr %i.hf, align 16, !tbaa !108 ; 2 uses
  %i.hm = load <4 x float>, ptr %i.hg, align 16, !tbaa !108
  ...
  store <4 x float> %i.hs, ptr %i.bb, align 16, !tbaa !108
  store <4 x float> %i.hv, ptr %i.bc, align 16, !tbaa !108
  store <4 x float> %i.hy, ptr %i.bd, align 16, !tbaa !108
  store <4 x float> %i.ic, ptr %i.be, align 16, !tbaa !108
  ...
  %i.ij = load <4 x float>, ptr %i.id, align 16, !tbaa !108
  %i.ik = load <4 x float>, ptr %i.ie, align 16, !tbaa !108 ; 2 uses
  %i.il = load <4 x float>, ptr %i.if, align 16, !tbaa !108 ; 2 uses
  %i.im = load <4 x float>, ptr %i.ig, align 16, !tbaa !108 ; 2 uses
  %i.in = load <4 x float>, ptr %i.ih, align 16, !tbaa !108 ; 2 uses
  %i.io = load <4 x float>, ptr %i.ii, align 16, !tbaa !108
...
begin_hunk_23_@_ZN4ncnnL26conv3x3s1_winograd43_bf16sERKNS_3MatERS0_S2_S2_iiS2_RKNS_6OptionE.omp_outlined.15:bb.a
  ...
  %i.ajp = load float, ptr %i.ajo, align 4, !tbaa !53
...
_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit581.thread712.us.i: ; preds = %bb.g
  %i.aka = load ptr, ptr %15, align 8, !tbaa !34
  %i.akb = load float, ptr %i.aka, align 4, !tbaa !53
...
bb.h:                                             ; preds = %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit.us.i
  ...
  store i16 %i.alc, ptr %.05381345.us.i, align 2, !tbaa !110
  %i.ald = extractelement <8 x i16> %i.alb, i64 3
  store i16 %i.ald, ptr %i.aky, align 2, !tbaa !110
  %i.ale = extractelement <8 x i16> %i.alb, i64 5
  store i16 %i.ale, ptr %i.akz, align 2, !tbaa !110
  %i.alf = extractelement <8 x i16> %i.alb, i64 7
  store i16 %i.alf, ptr %i.ala, align 2, !tbaa !110
...
bb.n:                                             ; preds = %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit.us.i
  ...
  store i64 %i.amm, ptr %.05381345.us.i, align 1, !tbaa !108
...
bb.o:                                             ; preds = %bb.n
  ...
  store i64 %i.amt, ptr %i.amn, align 1, !tbaa !108
  br label %bb.p
...
bb.q:                                             ; preds = %bb.p
  ...
  store i64 %i.ana, ptr %i.amu, align 1, !tbaa !108
  br label %bb.r
...
bb.s:                                             ; preds = %bb.r
  ...
  store i64 %i.anh, ptr %i.anb, align 1, !tbaa !108
  br label %bb.t
...
bb.u:                                             ; preds = %bb.t, %bb.f
  ...
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, 4
  br i1 %exitcond.not.i, label %bb.v, label %bb.f, !llvm.loop !1765
...
bb.v:                                             ; preds = %bb.u
  ...
  br i1 %exitcond1418.not.i, label %._crit_edge.us.i, label %_ZN4ncnn3MatD2Ev.exit560.us.i, !llvm.loop !1766
...
._crit_edge.us.i:                                 ; preds = %bb.v
  ...
  br i1 %i.ank, label %.lr.ph1351.split.us.i, label %.preheader1337.loopexit.i, !llvm.loop !1767
...
.preheader1337.i:                                 ; preds = %.lr.ph1351.i, %.preheader1337.loopexit.i, %._crit_edge
  %.0526.lcssa.i = phi i32 [ 0, %._crit_edge ], [ %i.anl, %.preheader1337.loopexit.i ], [ %i.df, %.lr.ph1351.i ] ; 6 uses
...
.lr.ph1369.i:                                     ; preds = %.preheader1337.i
  ...
  %i.anp = shl nuw nsw i32 %.sroa.speculated120, 1
  %i.anq = zext nneg i32 %i.anp to i64
  %i.anr = shl nuw nsw i32 %.sroa.speculated120, 2
  %i.ans = zext nneg i32 %i.anr to i64
  %i.ant = mul nuw nsw i32 %.sroa.speculated120, 6
  %i.anu = zext nneg i32 %i.ant to i64
  %i.anv = shl nuw nsw i32 %.sroa.speculated120, 3
  %i.anw = zext nneg i32 %i.anv to i64
  %i.anx = mul nuw nsw i32 %.sroa.speculated120, 10
  %i.any = zext nneg i32 %i.anx to i64
  %i.anz = mul nuw nsw i32 %.sroa.speculated120, 12
  %i.aoa = zext nneg i32 %i.anz to i64            ; 30 uses
...
.lr.ph1369.split.us.i:                            ; preds = %.lr.ph1369.i
  %i.aoc = load i32, ptr %i.ap, align 4, !tbaa !86, !noalias !1789
  %i.aod = load ptr, ptr %12, align 8, !tbaa !34, !noalias !1789
  %i.aoe = load i64, ptr %i.as, align 8, !tbaa !35, !noalias !1789
  %i.aof = load i64, ptr %i.aw, align 8, !tbaa !76, !noalias !1789 ; 2 uses
...
bb.x:                                             ; preds = %bb.w
  ...
  %i.aoj = load <2 x float>, ptr %i.aoi, align 4, !tbaa !53
  br label %.thread.us.i
...
_ZN4ncnn3MatD2Ev.exit559.us.i:                    ; preds = %bb.az, %.thread.us.i
  ...
  %i.aov = load <2 x float>, ptr %i.aou, align 4, !tbaa !53 ; 2 uses
  %i.aow = load <2 x float>, ptr %i.aot, align 4, !tbaa !53 ; 2 uses
  %i.aox = fadd fast <2 x float> %i.aow, %i.aov   ; 2 uses
  %i.aoy = load <2 x float>, ptr %i.aos, align 4, !tbaa !53 ; 2 uses
  %i.aoz = load <2 x float>, ptr %i.aor, align 4, !tbaa !53 ; 2 uses
  %i.apa = fadd fast <2 x float> %i.aoz, %i.aoy   ; 2 uses
  %i.apb = load <2 x float>, ptr %i.aop, align 4, !tbaa !53
  %i.apc = fadd fast <2 x float> %i.apa, %i.aox
  %i.apd = fadd fast <2 x float> %i.apc, %i.apb
  store <2 x float> %i.apd, ptr %i.b, align 16, !tbaa !53
  ...
  store <2 x float> %i.api, ptr %i.br, align 16, !tbaa !53
  ...
  store <2 x float> %i.apl, ptr %i.bs, align 16, !tbaa !53
  %i.apm = load <2 x float>, ptr %i.aoq, align 4, !tbaa !53
  ...
  store <2 x float> %i.apq, ptr %i.bt, align 16, !tbaa !53
  ...
  %i.apx = load <2 x float>, ptr %i.aps, align 4, !tbaa !53 ; 2 uses
  %i.apy = load <2 x float>, ptr %i.apt, align 4, !tbaa !53 ; 2 uses
  %i.apz = fadd fast <2 x float> %i.apy, %i.apx   ; 2 uses
  %i.aqa = load <2 x float>, ptr %i.apu, align 4, !tbaa !53 ; 2 uses
  %i.aqb = load <2 x float>, ptr %i.apv, align 4, !tbaa !53 ; 2 uses
  %i.aqc = fadd fast <2 x float> %i.aqb, %i.aqa   ; 2 uses
  %i.aqd = load <2 x float>, ptr %i.apr, align 4, !tbaa !53
  %i.aqe = fadd fast <2 x float> %i.aqc, %i.apz
  %i.aqf = fadd fast <2 x float> %i.aqe, %i.aqd
  store <2 x float> %i.aqf, ptr %i.bu, align 8, !tbaa !53
  ...
  store <2 x float> %i.aqk, ptr %i.bv, align 8, !tbaa !53
  ...
  store <2 x float> %i.aqn, ptr %i.bw, align 8, !tbaa !53
  %i.aqo = load <2 x float>, ptr %i.apw, align 4, !tbaa !53
  ...
  store <2 x float> %i.aqs, ptr %i.bx, align 8, !tbaa !53
  ...
  %i.aqz = load <2 x float>, ptr %i.aqu, align 4, !tbaa !53 ; 2 uses
  %i.ara = load <2 x float>, ptr %i.aqv, align 4, !tbaa !53 ; 2 uses
  %i.arb = fadd fast <2 x float> %i.ara, %i.aqz   ; 2 uses
  %i.arc = load <2 x float>, ptr %i.aqw, align 4, !tbaa !53 ; 2 uses
  %i.ard = load <2 x float>, ptr %i.aqx, align 4, !tbaa !53 ; 2 uses
  %i.are = fadd fast <2 x float> %i.ard, %i.arc   ; 2 uses
  %i.arf = load <2 x float>, ptr %i.aqt, align 4, !tbaa !53
  %i.arg = fadd fast <2 x float> %i.are, %i.arb
  %i.arh = fadd fast <2 x float> %i.arg, %i.arf
  store <2 x float> %i.arh, ptr %i.by, align 16, !tbaa !53
  ...
  store <2 x float> %i.arm, ptr %i.bz, align 16, !tbaa !53
  ...
  store <2 x float> %i.arp, ptr %i.ca, align 16, !tbaa !53
  %i.arq = load <2 x float>, ptr %i.aqy, align 4, !tbaa !53
  ...
  store <2 x float> %i.aru, ptr %i.cb, align 16, !tbaa !53
  ...
  %i.asb = load <2 x float>, ptr %i.arw, align 4, !tbaa !53 ; 2 uses
  %i.asc = load <2 x float>, ptr %i.arx, align 4, !tbaa !53 ; 2 uses
  %i.asd = fadd fast <2 x float> %i.asc, %i.asb   ; 2 uses
  %i.ase = load <2 x float>, ptr %i.ary, align 4, !tbaa !53 ; 2 uses
  %i.asf = load <2 x float>, ptr %i.arz, align 4, !tbaa !53 ; 2 uses
  %i.asg = fadd fast <2 x float> %i.asf, %i.ase   ; 2 uses
  %i.ash = load <2 x float>, ptr %i.arv, align 4, !tbaa !53
  %i.asi = fadd fast <2 x float> %i.asg, %i.asd
  %i.asj = fadd fast <2 x float> %i.asi, %i.ash
  store <2 x float> %i.asj, ptr %i.cc, align 8, !tbaa !53
  ...
  store <2 x float> %i.aso, ptr %i.cd, align 8, !tbaa !53
  ...
  store <2 x float> %i.asr, ptr %i.ce, align 8, !tbaa !53
  %i.ass = load <2 x float>, ptr %i.asa, align 4, !tbaa !53
  ...
  store <2 x float> %i.asw, ptr %i.cf, align 8, !tbaa !53
  ...
  %i.atd = load <2 x float>, ptr %i.asy, align 4, !tbaa !53 ; 2 uses
  %i.ate = load <2 x float>, ptr %i.asz, align 4, !tbaa !53 ; 2 uses
  %i.atf = fadd fast <2 x float> %i.ate, %i.atd   ; 2 uses
  %i.atg = load <2 x float>, ptr %i.ata, align 4, !tbaa !53 ; 2 uses
  %i.ath = load <2 x float>, ptr %i.atb, align 4, !tbaa !53 ; 2 uses
  %i.ati = fadd fast <2 x float> %i.ath, %i.atg   ; 2 uses
  %i.atj = load <2 x float>, ptr %i.asx, align 4, !tbaa !53
...
begin_hunk_24_@_ZN4ncnnL26conv3x3s1_winograd43_bf16sERKNS_3MatERS0_S2_S2_iiS2_RKNS_6OptionE.omp_outlined.15:bb.a
  %i.azw = fmul fast float %i.axa, %i.azj
  %i.azx = fadd fast float %i.azw, %i.axc
...
_ZL13activation_ssfiRKN4ncnn3MatE.exit592.thread809.us.i: ; preds = %bb.z
  %i.bca = load ptr, ptr %15, align 8, !tbaa !34
  %i.bcb = load <2 x float>, ptr %i.bca, align 4, !tbaa !53 ; 5 uses
  %i.bcc = extractelement <2 x float> %i.bcb, i64 0 ; 2 uses
  %i.bcd = extractelement <2 x float> %i.bcb, i64 1 ; 3 uses
  %i.bce = shufflevector <2 x float> %i.bcb, <2 x float> poison, <2 x i32> zeroinitializer ; 3 uses
  %i.bcf = call nnan ninf nsz <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.awp, <2 x float> %i.bce) ; 2 uses
  %i.bcg = shufflevector <2 x float> %i.bcb, <2 x float> poison, <2 x i32> <i32 1, i32 1> ; 6 uses
  %i.bch = fcmp fast ogt <2 x float> %i.bcf, %i.bcg
  %i.bci = select <2 x i1> %i.bch, <2 x float> %i.bcg, <2 x float> %i.bcf ; 2 uses
  %i.bcj = call nnan ninf nsz <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.awj, <2 x float> %i.bce) ; 2 uses
  %i.bck = fcmp fast ogt <2 x float> %i.bcj, %i.bcg
  %i.bcl = select <2 x i1> %i.bck, <2 x float> %i.bcg, <2 x float> %i.bcj ; 2 uses
  %i.bcm = call nnan ninf nsz <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.awt, <2 x float> %i.bce) ; 2 uses
  %i.bcn = fcmp fast ogt <2 x float> %i.bcm, %i.bcg
  %i.bco = select <2 x i1> %i.bcn, <2 x float> %i.bcg, <2 x float> %i.bcm ; 2 uses
  %i.bcp = extractelement <2 x float> %i.awy, i64 0
  %.0697.us.i = call nnan ninf nsz float @llvm.maxnum.f32(float %i.bcp, float %i.bcc) ; 2 uses
  %i.bcq = fcmp fast ogt float %.0697.us.i, %i.bcd
  %.16981156.us.i = select i1 %i.bcq, float %i.bcd, float %.0697.us.i ; 2 uses
  %i.bcr = extractelement <2 x float> %i.awy, i64 1
  %.0699.us.i = call nnan ninf nsz float @llvm.maxnum.f32(float %i.bcr, float %i.bcc) ; 2 uses
  %i.bcs = fcmp fast ogt float %.0699.us.i, %i.bcd
  %i.bct = insertelement <2 x float> poison, float %.16981156.us.i, i64 0
  %i.bcu = insertelement <2 x float> %i.bct, float %.0699.us.i, i64 1
  br i1 %i.bcs, label %bb.ar, label %_ZL13activation_ssfiRKN4ncnn3MatE.exit585.us.i

bb.ar:                                            ; preds = %_ZL13activation_ssfiRKN4ncnn3MatE.exit592.thread809.us.i
  %i.bcv = insertelement <2 x float> %i.bcb, float %.16981156.us.i, i64 0
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit585.us.i

_ZL13activation_ssfiRKN4ncnn3MatE.exit592.thread815.us.i: ; preds = %bb.z
  %i.bcw = load ptr, ptr %15, align 8, !tbaa !34
  %i.bcx = load float, ptr %i.bcw, align 4, !tbaa !53
  %i.bcy = fcmp fast ogt <2 x float> %i.awp, zeroinitializer
  %i.bcz = insertelement <2 x float> poison, float %i.bcx, i64 0
  %i.bda = shufflevector <2 x float> %i.bcz, <2 x float> poison, <2 x i32> zeroinitializer ; 4 uses
  %i.bdb = select <2 x i1> %i.bcy, <2 x float> splat (float 1.000000e+00), <2 x float> %i.bda
  %i.bdc = fmul fast <2 x float> %i.bdb, %i.awp
  %i.bdd = fcmp fast ogt <2 x float> %i.awj, zeroinitializer
  %i.bde = select <2 x i1> %i.bdd, <2 x float> splat (float 1.000000e+00), <2 x float> %i.bda
  %i.bdf = fmul fast <2 x float> %i.bde, %i.awj
  %i.bdg = fcmp fast ogt <2 x float> %i.awt, zeroinitializer
  %i.bdh = select <2 x i1> %i.bdg, <2 x float> splat (float 1.000000e+00), <2 x float> %i.bda
  %i.bdi = fmul fast <2 x float> %i.bdh, %i.awt
  %i.bdj = fcmp fast ogt <2 x float> %i.awy, zeroinitializer
  %i.bdk = select <2 x i1> %i.bdj, <2 x float> splat (float 1.000000e+00), <2 x float> %i.bda
  %i.bdl = fmul fast <2 x float> %i.bdk, %i.awy
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit585.us.i

_ZL13activation_ssfiRKN4ncnn3MatE.exit592.thread812.us.i: ; preds = %bb.z
  %i.bdm = call fast <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.awp, <2 x float> zeroinitializer)
  %i.bdn = call fast <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.awj, <2 x float> zeroinitializer)
  %i.bdo = call fast <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.awt, <2 x float> zeroinitializer)
  %i.bdp = call fast <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.awy, <2 x float> zeroinitializer)
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit585.us.i
...
_ZL13activation_ssfiRKN4ncnn3MatE.exit585.us.i:   ; preds = %_ZL13activation_ssfiRKN4ncnn3MatE.exit592.thread812.us.i, %_ZL13activation_ssfiRKN4ncnn3MatE.exit592.thread815.us.i, %bb.ar, %_ZL13activation_ssfiRKN4ncnn3MatE.exit592.thread809.us.i, %_ZL13activation_ssfiRKN4ncnn3MatE.exit592.thread818.us.i, %_ZL13activation_ssfiRKN4ncnn3MatE.exit592.thread821.us.i, %bb.aq, %bb.ap, %_ZL13activation_ssfiRKN4ncnn3MatE.exit586.thread.us.i, %bb.z
  %i.bdq = phi <2 x float> [ %i.azl, %_ZL13activation_ssfiRKN4ncnn3MatE.exit586.thread.us.i ], [ %i.bdp, %_ZL13activation_ssfiRKN4ncnn3MatE.exit592.thread812.us.i ], [ %i.bdl, %_ZL13activation_ssfiRKN4ncnn3MatE.exit592.thread815.us.i ], [ %i.bcv, %bb.ar ], [ %i.bcu, %_ZL13activation_ssfiRKN4ncnn3MatE.exit592.thread809.us.i ], [ %i.bbz, %_ZL13activation_ssfiRKN4ncnn3MatE.exit592.thread818.us.i ], [ %i.bbb, %_ZL13activation_ssfiRKN4ncnn3MatE.exit592.thread821.us.i ], [ %i.azz, %bb.aq ], [ %i.azv, %bb.ap ], [ %i.awy, %bb.z ]
  %i.bdr = phi <2 x float> [ %i.azn, %_ZL13activation_ssfiRKN4ncnn3MatE.exit586.thread.us.i ], [ %i.bdo, %_ZL13activation_ssfiRKN4ncnn3MatE.exit592.thread812.us.i ], [ %i.bdi, %_ZL13activation_ssfiRKN4ncnn3MatE.exit592.thread815.us.i ], [ %i.bco, %bb.ar ], [ %i.bco, %_ZL13activation_ssfiRKN4ncnn3MatE.exit592.thread809.us.i ], [ %i.bbt, %_ZL13activation_ssfiRKN4ncnn3MatE.exit592.thread818.us.i ], [ %i.bao, %_ZL13activation_ssfiRKN4ncnn3MatE.exit592.thread821.us.i ], [ %i.azn, %bb.aq ], [ %i.azn, %bb.ap ], [ %i.awt, %bb.z ]
  %i.bds = phi <2 x float> [ %i.azp, %_ZL13activation_ssfiRKN4ncnn3MatE.exit586.thread.us.i ], [ %i.bdn, %_ZL13activation_ssfiRKN4ncnn3MatE.exit592.thread812.us.i ], [ %i.bdf, %_ZL13activation_ssfiRKN4ncnn3MatE.exit592.thread815.us.i ], [ %i.bcl, %bb.ar ], [ %i.bcl, %_ZL13activation_ssfiRKN4ncnn3MatE.exit592.thread809.us.i ], [ %i.bbn, %_ZL13activation_ssfiRKN4ncnn3MatE.exit592.thread818.us.i ], [ %i.baj, %_ZL13activation_ssfiRKN4ncnn3MatE.exit592.thread821.us.i ], [ %i.azp, %bb.aq ], [ %i.azp, %bb.ap ], [ %i.awj, %bb.z ]
  %i.bdt = phi <2 x float> [ %i.azr, %_ZL13activation_ssfiRKN4ncnn3MatE.exit586.thread.us.i ], [ %i.bdm, %_ZL13activation_ssfiRKN4ncnn3MatE.exit592.thread812.us.i ], [ %i.bdc, %_ZL13activation_ssfiRKN4ncnn3MatE.exit592.thread815.us.i ], [ %i.bci, %bb.ar ], [ %i.bci, %_ZL13activation_ssfiRKN4ncnn3MatE.exit592.thread809.us.i ], [ %i.bbh, %_ZL13activation_ssfiRKN4ncnn3MatE.exit592.thread818.us.i ], [ %i.bae, %_ZL13activation_ssfiRKN4ncnn3MatE.exit592.thread821.us.i ], [ %i.azr, %bb.aq ], [ %i.azr, %bb.ap ], [ %i.awp, %bb.z ]
  %i.bdu = getelementptr inbounds nuw [2 x i8], ptr %.05241362.us.i, i64 %i.dv ; 4 uses
  %i.bdv = bitcast <2 x float> %i.bdt to <2 x i32>
  %i.bdw = lshr <2 x i32> %i.bdv, splat (i32 16)
  %i.bdx = trunc nuw <2 x i32> %i.bdw to <2 x i16> ; 2 uses
  %i.bdy = extractelement <2 x i16> %i.bdx, i64 0
  store i16 %i.bdy, ptr %.05241362.us.i, align 2, !tbaa !110
  %i.bdz = extractelement <2 x i16> %i.bdx, i64 1
  store i16 %i.bdz, ptr %i.bdu, align 2, !tbaa !110
  br i1 %i.avm, label %bb.as, label %bb.at

bb.as:                                            ; preds = %_ZL13activation_ssfiRKN4ncnn3MatE.exit585.us.i
  %i.bea = bitcast <2 x float> %i.bds to <2 x i32>
  %i.beb = getelementptr inbounds nuw i8, ptr %.05241362.us.i, i64 2
  %i.bec = lshr <2 x i32> %i.bea, splat (i32 16)
  %i.bed = trunc nuw <2 x i32> %i.bec to <2 x i16> ; 2 uses
  %i.bee = extractelement <2 x i16> %i.bed, i64 0
  store i16 %i.bee, ptr %i.beb, align 2, !tbaa !110
  %i.bef = getelementptr inbounds nuw i8, ptr %i.bdu, i64 2
  %i.beg = extractelement <2 x i16> %i.bed, i64 1
  store i16 %i.beg, ptr %i.bef, align 2, !tbaa !110
  br label %bb.at
...
bb.au:                                            ; preds = %bb.at
  %i.beh = bitcast <2 x float> %i.bdr to <2 x i32>
  %i.bei = getelementptr inbounds nuw i8, ptr %.05241362.us.i, i64 4
  %i.bej = lshr <2 x i32> %i.beh, splat (i32 16)
  %i.bek = trunc nuw <2 x i32> %i.bej to <2 x i16> ; 2 uses
  %i.bel = extractelement <2 x i16> %i.bek, i64 0
  store i16 %i.bel, ptr %i.bei, align 2, !tbaa !110
  %i.bem = getelementptr inbounds nuw i8, ptr %i.bdu, i64 4
  %i.ben = extractelement <2 x i16> %i.bek, i64 1
  store i16 %i.ben, ptr %i.bem, align 2, !tbaa !110
  br label %bb.av
...
bb.aw:                                            ; preds = %bb.av
  %i.beo = bitcast <2 x float> %i.bdq to <2 x i32>
  %i.bep = getelementptr inbounds nuw i8, ptr %.05241362.us.i, i64 6
  %i.beq = lshr <2 x i32> %i.beo, splat (i32 16)
  %i.ber = trunc nuw <2 x i32> %i.beq to <2 x i16> ; 2 uses
  %i.bes = extractelement <2 x i16> %i.ber, i64 0
  store i16 %i.bes, ptr %i.bep, align 2, !tbaa !110
  %i.bet = getelementptr inbounds nuw i8, ptr %i.bdu, i64 6
  %i.beu = extractelement <2 x i16> %i.ber, i64 1
  store i16 %i.beu, ptr %i.bet, align 2, !tbaa !110
  br label %bb.ax

bb.ax:                                            ; preds = %bb.aw, %bb.av
  %i.bev = getelementptr inbounds [2 x i8], ptr %.05241362.us.i, i64 %i.aob
  br label %bb.ay

bb.ay:                                            ; preds = %bb.ax, %bb.y
  %.1525.us.i = phi ptr [ %.05241362.us.i, %bb.y ], [ %i.bev, %bb.ax ]
  %indvars.iv.next1428.i = add nuw nsw i64 %indvars.iv1427.i, 1 ; 2 uses
  %exitcond1430.not.i = icmp eq i64 %indvars.iv.next1428.i, 4
  br i1 %exitcond1430.not.i, label %bb.az, label %bb.y, !llvm.loop !1770
...
bb.az:                                            ; preds = %bb.ay
  ...
  br i1 %exitcond1435.not.i, label %._crit_edge.us1373.i, label %_ZN4ncnn3MatD2Ev.exit559.us.i, !llvm.loop !1771

._crit_edge.us1373.i:                             ; preds = %bb.az
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #12
  %indvars.iv.next1437.i = add nuw nsw i64 %indvars.iv1436.i, 2 ; 3 uses
  %i.bew = icmp slt i64 %indvars.iv.next1437.i, %invariant.op.i
  br i1 %i.bew, label %bb.w, label %.preheader.loopexit.i, !llvm.loop !1772

.lr.ph1369.split.i:                               ; preds = %.lr.ph1369.i
  %18 = add i32 %.0526.lcssa.i, 3
  %smax1422.i = call i32 @llvm.smax.i32(i32 %.sroa.speculated124, i32 %18)
  %reass.sub = sub i32 %smax1422.i, %.0526.lcssa.i
  %19 = and i32 %reass.sub, -2
  %i.bex = add i32 %.0526.lcssa.i, %19
  br label %.preheader.i

.preheader.loopexit.i:                            ; preds = %._crit_edge.us1373.i
  %i.bey = trunc nsw i64 %indvars.iv.next1437.i to i32
  br label %.preheader.i

.preheader.i:                                     ; preds = %.preheader.loopexit.i, %.lr.ph1369.split.i, %.preheader1337.i
  %.1527.lcssa.i = phi i32 [ %.0526.lcssa.i, %.preheader1337.i ], [ %i.bex, %.lr.ph1369.split.i ], [ %i.bey, %.preheader.loopexit.i ] ; 2 uses
  %i.bez = icmp slt i32 %.1527.lcssa.i, %.sroa.speculated124
  br i1 %i.bez, label %.lr.ph1395.i, label %_ZN4ncnnL48conv3x3s1_winograd43_transform_output_tile_bf16sERKNS_3MatERS0_S2_iiiiiS2_.exit

.lr.ph1395.i:                                     ; preds = %.preheader.i
  %.not.i83 = icmp eq ptr %.val81, null
  %i.bfa = icmp sgt i32 %.sroa.speculated120, 0
  %i.bfb = sext i32 %.sroa.speculated120 to i64
  %i.bfc = shl nuw nsw i32 %.sroa.speculated120, 1
  %i.bfd = zext nneg i32 %i.bfc to i64
  %i.bfe = mul nuw nsw i32 %.sroa.speculated120, 3
  %i.bff = zext nneg i32 %i.bfe to i64
  %i.bfg = shl nuw nsw i32 %.sroa.speculated120, 2
  %i.bfh = zext nneg i32 %i.bfg to i64
  %i.bfi = mul nuw nsw i32 %.sroa.speculated120, 5
  %i.bfj = zext nneg i32 %i.bfi to i64
  %i.bfk = mul nuw nsw i32 %.sroa.speculated120, 6
  %i.bfl = zext nneg i32 %i.bfk to i64            ; 30 uses
  %i.bfm = sext i32 %i.dq to i64                  ; 3 uses
  br i1 %i.bfa, label %.lr.ph1395.split.us.i, label %_ZN4ncnnL48conv3x3s1_winograd43_transform_output_tile_bf16sERKNS_3MatERS0_S2_iiiiiS2_.exit

.lr.ph1395.split.us.i:                            ; preds = %.lr.ph1395.i
  %i.bfn = load i32, ptr %i.ap, align 4, !tbaa !86, !noalias !1790
  %i.bfo = load ptr, ptr %12, align 8, !tbaa !34, !noalias !1790
  %i.bfp = load i64, ptr %i.as, align 8, !tbaa !35, !noalias !1790
  %i.bfq = load i64, ptr %i.aw, align 8, !tbaa !76, !noalias !1790 ; 2 uses
  %factor.op.mul1400.i = mul i64 %i.bfq, %i.bfp
  %i.bfr = sext i32 %i.bfn to i64
  %factor.op.mul1391.us.i = mul i64 %i.bfq, %i.bfr
  %i.bfs = sext i32 %.1527.lcssa.i to i64
  %wide.trip.count1450.i = zext nneg i32 %.sroa.speculated120 to i64
  br label %bb.ba

bb.ba:                                            ; preds = %._crit_edge.us1398.i, %.lr.ph1395.split.us.i
  %indvars.iv1452.i = phi i64 [ %indvars.iv.next1453.i, %._crit_edge.us1398.i ], [ %i.bfs, %.lr.ph1395.split.us.i ] ; 3 uses
  %.pre1457.i = add nsw i64 %indvars.iv1452.i, %i.de ; 2 uses
  br i1 %.not.i83, label %.lr.ph.us1397.i, label %bb.bb

bb.bb:                                            ; preds = %bb.ba
  %i.bft = getelementptr inbounds [4 x i8], ptr %.val81, i64 %.pre1457.i
  %i.bfu = load float, ptr %i.bft, align 4, !tbaa !53
  br label %.lr.ph.us1397.i

.lr.ph.us1397.i:                                  ; preds = %bb.bb, %bb.ba
  %i.bfv = phi fast float [ %i.bfu, %bb.bb ], [ 0.000000e+00, %bb.ba ] ; 2 uses
  %i.bfw = trunc nsw i64 %indvars.iv1452.i to i32
  %factor.op.mul1388.reass.us.i = mul i32 %factor.op.mul1348.i, %i.bfw
  %i.bfx = sext i32 %factor.op.mul1388.reass.us.i to i64
  %i.bfy = getelementptr inbounds [4 x i8], ptr %i.cx, i64 %i.bfx
  %.reass1401.i = mul i64 %factor.op.mul1400.i, %.pre1457.i
  %i.bfz = getelementptr inbounds nuw i8, ptr %i.bfo, i64 %.reass1401.i
  %i.bga = insertelement <4 x float> poison, float %i.bfv, i64 0 ; 4 uses
  %i.bgb = insertelement <2 x float> poison, float %i.bfv, i64 0 ; 4 uses
  %i.bgc = shufflevector <2 x float> %i.bgb, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 poison, i32 poison>
  %i.bgd = shufflevector <2 x float> %i.bgb, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 poison, i32 poison>
  %i.bge = shufflevector <2 x float> %i.bgb, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 poison, i32 poison>
  %i.bgf = shufflevector <2 x float> %i.bgb, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 poison, i32 poison>
  br label %_ZN4ncnn3MatD2Ev.exit.us.i
...
_ZN4ncnn3MatD2Ev.exit.us.i:                       ; preds = %bb.du, %.lr.ph.us1397.i
  ...
  %i.bgg = getelementptr inbounds nuw [4 x i8], ptr %i.bfy, i64 %indvars.iv1447.i ; 7 uses
  %i.bgh = getelementptr inbounds nuw [4 x i8], ptr %i.bgg, i64 %i.bfb ; 2 uses
  %i.bgi = getelementptr inbounds nuw [4 x i8], ptr %i.bgg, i64 %i.bfd ; 2 uses
  %i.bgj = getelementptr inbounds nuw [4 x i8], ptr %i.bgg, i64 %i.bff ; 2 uses
  %i.bgk = getelementptr inbounds nuw [4 x i8], ptr %i.bgg, i64 %i.bfh ; 2 uses
  %i.bgl = getelementptr inbounds nuw [4 x i8], ptr %i.bgg, i64 %i.bfj ; 2 uses
  %i.bgm = load float, ptr %i.bgh, align 4, !tbaa !53 ; 2 uses
  %i.bgn = load float, ptr %i.bgi, align 4, !tbaa !53 ; 2 uses
  %i.bgo = load float, ptr %i.bgj, align 4, !tbaa !53 ; 2 uses
  %i.bgp = load float, ptr %i.bgg, align 4, !tbaa !53
  %i.bgq = load float, ptr %i.bgl, align 4, !tbaa !53
  %i.bgr = getelementptr inbounds nuw [4 x i8], ptr %i.bgg, i64 %i.bfl ; 2 uses
  %i.bgs = getelementptr inbounds nuw [4 x i8], ptr %i.bgh, i64 %i.bfl ; 2 uses
  %i.bgt = getelementptr inbounds nuw [4 x i8], ptr %i.bgi, i64 %i.bfl ; 2 uses
  %i.bgu = getelementptr inbounds nuw [4 x i8], ptr %i.bgj, i64 %i.bfl ; 2 uses
  %i.bgv = getelementptr inbounds nuw [4 x i8], ptr %i.bgk, i64 %i.bfl ; 2 uses
  %i.bgw = getelementptr inbounds nuw [4 x i8], ptr %i.bgl, i64 %i.bfl ; 2 uses
  %i.bgx = load float, ptr %i.bgs, align 4, !tbaa !53 ; 2 uses
  %i.bgy = load float, ptr %i.bgt, align 4, !tbaa !53 ; 2 uses
  %i.bgz = load float, ptr %i.bgu, align 4, !tbaa !53 ; 2 uses
  %i.bha = load float, ptr %i.bgr, align 4, !tbaa !53
  %i.bhb = load float, ptr %i.bgw, align 4, !tbaa !53
  %i.bhc = getelementptr inbounds nuw [4 x i8], ptr %i.bgr, i64 %i.bfl ; 2 uses
  %i.bhd = getelementptr inbounds nuw [4 x i8], ptr %i.bgs, i64 %i.bfl ; 2 uses
  %i.bhe = getelementptr inbounds nuw [4 x i8], ptr %i.bgt, i64 %i.bfl ; 2 uses
  %i.bhf = getelementptr inbounds nuw [4 x i8], ptr %i.bgu, i64 %i.bfl ; 2 uses
  %i.bhg = getelementptr inbounds nuw [4 x i8], ptr %i.bgv, i64 %i.bfl ; 2 uses
  %i.bhh = getelementptr inbounds nuw [4 x i8], ptr %i.bgw, i64 %i.bfl ; 2 uses
  %i.bhi = load float, ptr %i.bhd, align 4, !tbaa !53 ; 2 uses
  %i.bhj = load float, ptr %i.bhe, align 4, !tbaa !53 ; 2 uses
  %i.bhk = load float, ptr %i.bhf, align 4, !tbaa !53 ; 2 uses
  %i.bhl = load float, ptr %i.bhc, align 4, !tbaa !53
  %i.bhm = load float, ptr %i.bhh, align 4, !tbaa !53
  %i.bhn = getelementptr inbounds nuw [4 x i8], ptr %i.bhc, i64 %i.bfl ; 2 uses
  %i.bho = getelementptr inbounds nuw [4 x i8], ptr %i.bhd, i64 %i.bfl ; 2 uses
  %i.bhp = getelementptr inbounds nuw [4 x i8], ptr %i.bhe, i64 %i.bfl ; 2 uses
  %i.bhq = getelementptr inbounds nuw [4 x i8], ptr %i.bhf, i64 %i.bfl ; 2 uses
  %i.bhr = getelementptr inbounds nuw [4 x i8], ptr %i.bhg, i64 %i.bfl ; 2 uses
  %i.bhs = getelementptr inbounds nuw [4 x i8], ptr %i.bhh, i64 %i.bfl ; 2 uses
  %i.bht = load float, ptr %i.bho, align 4, !tbaa !53 ; 2 uses
  %i.bhu = load float, ptr %i.bhp, align 4, !tbaa !53 ; 2 uses
  %i.bhv = load float, ptr %i.bhq, align 4, !tbaa !53 ; 2 uses
  %i.bhw = load float, ptr %i.bhr, align 4, !tbaa !53 ; 2 uses
  %i.bhx = load float, ptr %i.bhn, align 4, !tbaa !53
  %i.bhy = insertelement <4 x float> poison, float %i.bgn, i64 0
  %i.bhz = insertelement <4 x float> %i.bhy, float %i.bgy, i64 1
  %i.bia = insertelement <4 x float> %i.bhz, float %i.bhj, i64 2
  %i.bib = insertelement <4 x float> %i.bia, float %i.bhu, i64 3
  %i.bic = insertelement <4 x float> poison, float %i.bgm, i64 0
  %i.bid = insertelement <4 x float> %i.bic, float %i.bgx, i64 1
  %i.bie = insertelement <4 x float> %i.bid, float %i.bhi, i64 2
  %i.bif = insertelement <4 x float> %i.bie, float %i.bht, i64 3
  %i.big = fadd fast <4 x float> %i.bib, %i.bif   ; 3 uses
  %i.bih = insertelement <4 x float> poison, float %i.bgo, i64 0
  %i.bii = insertelement <4 x float> %i.bih, float %i.bgz, i64 1
  %i.bij = insertelement <4 x float> %i.bii, float %i.bhk, i64 2
  %i.bik = insertelement <4 x float> %i.bij, float %i.bhv, i64 3
  %i.bil = insertelement <4 x float> poison, float %i.bgp, i64 0
  %i.bim = insertelement <4 x float> %i.bil, float %i.bha, i64 1
  %i.bin = insertelement <4 x float> %i.bim, float %i.bhl, i64 2
  %i.bio = insertelement <4 x float> %i.bin, float %i.bhx, i64 3
  %i.bip = fadd fast <4 x float> %i.bio, %i.big
  %i.biq = load float, ptr %i.bhs, align 4, !tbaa !53
  %i.bir = getelementptr inbounds nuw [4 x i8], ptr %i.bhn, i64 %i.bfl ; 2 uses
  %i.bis = getelementptr inbounds nuw [4 x i8], ptr %i.bho, i64 %i.bfl ; 2 uses
  %i.bit = getelementptr inbounds nuw [4 x i8], ptr %i.bhp, i64 %i.bfl ; 2 uses
  %i.biu = getelementptr inbounds nuw [4 x i8], ptr %i.bhq, i64 %i.bfl ; 2 uses
  %i.biv = getelementptr inbounds nuw [4 x i8], ptr %i.bhr, i64 %i.bfl ; 2 uses
  %i.biw = getelementptr inbounds nuw [4 x i8], ptr %i.bhs, i64 %i.bfl ; 2 uses
  %i.bix = load float, ptr %i.bis, align 4, !tbaa !53 ; 2 uses
  %i.biy = load float, ptr %i.bit, align 4, !tbaa !53 ; 2 uses
  %i.biz = load float, ptr %i.biu, align 4, !tbaa !53 ; 2 uses
  %i.bja = load float, ptr %i.biv, align 4, !tbaa !53 ; 2 uses
  %i.bjb = load float, ptr %i.bir, align 4, !tbaa !53
  %i.bjc = load float, ptr %i.biw, align 4, !tbaa !53
  %i.bjd = getelementptr inbounds nuw [4 x i8], ptr %i.bir, i64 %i.bfl
  %i.bje = getelementptr inbounds nuw [4 x i8], ptr %i.bis, i64 %i.bfl
  %i.bjf = getelementptr inbounds nuw [4 x i8], ptr %i.bit, i64 %i.bfl
  %i.bjg = getelementptr inbounds nuw [4 x i8], ptr %i.biu, i64 %i.bfl
  %i.bjh = getelementptr inbounds nuw [4 x i8], ptr %i.biv, i64 %i.bfl
  %i.bji = getelementptr inbounds nuw [4 x i8], ptr %i.biw, i64 %i.bfl
  %i.bjj = load float, ptr %i.bje, align 4, !tbaa !53 ; 2 uses
  %i.bjk = load float, ptr %i.bjf, align 4, !tbaa !53 ; 2 uses
  %i.bjl = load float, ptr %i.bjg, align 4, !tbaa !53 ; 2 uses
  %i.bjm = load float, ptr %i.bjh, align 4, !tbaa !53 ; 2 uses
  %i.bjn = load float, ptr %i.bjd, align 4, !tbaa !53
  %i.bjo = load float, ptr %i.bgk, align 4, !tbaa !53 ; 2 uses
  %i.bjp = load float, ptr %i.bgv, align 4, !tbaa !53 ; 2 uses
  %i.bjq = load float, ptr %i.bhg, align 4, !tbaa !53 ; 2 uses
  %i.bjr = insertelement <4 x float> poison, float %i.bjo, i64 0
  %i.bjs = insertelement <4 x float> %i.bjr, float %i.bjp, i64 1
  %i.bjt = insertelement <4 x float> %i.bjs, float %i.bjq, i64 2
  %i.bju = insertelement <4 x float> %i.bjt, float %i.bhw, i64 3
  %i.bjv = fadd fast <4 x float> %i.bju, %i.bik   ; 3 uses
  %i.bjw = fadd fast <4 x float> %i.bip, %i.bjv   ; 4 uses
  %i.bjx = fadd fast float %i.biy, %i.bix         ; 2 uses
  %i.bjy = fadd fast float %i.bja, %i.biz         ; 2 uses
  %i.bjz = fadd fast float %i.bjb, %i.bjx
  %i.bka = fadd fast float %i.bjz, %i.bjy         ; 2 uses
  %i.bkb = insertelement <4 x float> %i.big, float %i.bjx, i64 0
  %i.bkc = fmul fast <4 x float> %i.bkb, splat (float 5.000000e-01)
  %i.bkd = insertelement <4 x float> %i.bjv, float %i.bjy, i64 0
  %i.bke = fmul fast <4 x float> %i.bkd, splat (float 2.000000e+00)
  %i.bkf = fadd fast <4 x float> %i.bke, %i.bkc   ; 4 uses
  %i.bkg = fsub fast float %i.bjj, %i.bjk         ; 2 uses
  %i.bkh = fsub fast float %i.bix, %i.biy         ; 2 uses
  %i.bki = fsub fast float %i.bht, %i.bhu         ; 2 uses
  %i.bkj = fmul fast float %i.bki, f0x3EB504F3
  %i.bkk = fadd fast float %i.bkj, %i.biq
  %i.bkl = fsub fast float %i.bjl, %i.bjm         ; 2 uses
  %i.bkm = fsub fast float %i.biz, %i.bja         ; 2 uses
  %i.bkn = fsub fast float %i.bhv, %i.bhw         ; 2 uses
  %i.bko = fmul fast float %i.bkn, f0x403504F3
  %i.bkp = fadd fast float %i.bkk, %i.bko         ; 2 uses
  %i.bkq = fmul fast float %i.bkh, f0x3EB504F3
  %i.bkr = fadd fast float %i.bkq, %i.bjc
  %i.bks = fmul fast float %i.bkm, f0x403504F3
  %i.bkt = fadd fast float %i.bkr, %i.bks         ; 2 uses
  %i.bku = shufflevector <4 x float> %i.big, <4 x float> poison, <4 x i32> <i32 poison, i32 poison, i32 poison, i32 0>
  %i.bkv = insertelement <4 x float> %i.bku, float %i.bki, i64 0
  %i.bkw = insertelement <4 x float> %i.bkv, float %i.bkh, i64 1
  %i.bkx = insertelement <4 x float> %i.bkw, float %i.bkg, i64 2
  %i.bky = fmul fast <4 x float> %i.bkx, <float f0x3F3504F3, float f0x3F3504F3, float f0x3F3504F3, float 5.000000e-01>
  %i.bkz = shufflevector <4 x float> %i.bjv, <4 x float> poison, <4 x i32> <i32 poison, i32 poison, i32 poison, i32 0>
  %i.bla = insertelement <4 x float> %i.bkz, float %i.bkn, i64 0
  %i.blb = insertelement <4 x float> %i.bla, float %i.bkm, i64 1
  %i.blc = insertelement <4 x float> %i.blb, float %i.bkl, i64 2
  ...
  %i.blf = insertelement <4 x float> poison, float %i.bjk, i64 0
  %i.blg = insertelement <4 x float> %i.blf, float %i.bgm, i64 1
  %i.blh = insertelement <4 x float> %i.blg, float %i.bgx, i64 2
end_hunk_24
...
_ZN4ncnn3Mat7channelEi.exit79:                    ; preds = %bb.c
  %i.bn = load ptr, ptr %4, align 8, !tbaa !34, !noalias !1853
  %i.bo = load i64, ptr %i.o, align 8, !tbaa !35, !noalias !1853
  %i.bp = sext i32 %i.bm to i64
  %i.bq = mul i64 %i.bo, %i.bp
  %i.br = load i64, ptr %i.p, align 8, !tbaa !76, !noalias !1853
  %i.bs = mul i64 %i.bq, %i.br
  %i.bt = getelementptr inbounds nuw i8, ptr %i.bn, i64 %i.bs ; 4 uses
  %i.bu = load i32, ptr %5, align 4, !tbaa !78
  %i.bv = sub nsw i32 %i.bu, %i.bl
...
bb.d:                                             ; preds = %.lr.ph, %_ZN4ncnnL48conv3x3s1_winograd63_transform_output_tile_bf16sERKNS_3MatERS0_S2_iiiiiS2_.exit
  %i.cg = phi i32 [ %.pre, %.lr.ph ], [ %i.cbz, %_ZN4ncnnL48conv3x3s1_winograd63_transform_output_tile_bf16sERKNS_3MatERS0_S2_iiiiiS2_.exit ]
  %i.ch = phi i32 [ %i.bx, %.lr.ph ], [ %i.ccb, %_ZN4ncnnL48conv3x3s1_winograd63_transform_output_tile_bf16sERKNS_3MatERS0_S2_iiiiiS2_.exit ]
  %.047134 = phi i32 [ 0, %.lr.ph ], [ %i.cca, %_ZN4ncnnL48conv3x3s1_winograd63_transform_output_tile_bf16sERKNS_3MatERS0_S2_iiiiiS2_.exit ] ; 6 uses
...
._crit_edge:                                      ; preds = %.noexc, %bb.d
  %i.cl = load i32, ptr %14, align 4, !tbaa !78   ; 3 uses
  %.val81 = load ptr, ptr %13, align 8, !tbaa !34 ; 6 uses
  %i.cm = load i32, ptr %i.aq, align 4, !tbaa !86 ; 19 uses
  %i.cn = load i32, ptr %i.ar, align 8, !tbaa !87 ; 3 uses
  %i.co = load i32, ptr %i.as, align 8, !tbaa !77 ; 5 uses
  %i.cp = load i64, ptr %i.at, align 8, !tbaa !35
...
.lr.ph2499.i:                                     ; preds = %._crit_edge
  ...
  %i.cw = shl nuw nsw i32 %.sroa.speculated120, 2
  %i.cx = zext nneg i32 %i.cw to i64
  %i.cy = shl nuw nsw i32 %.sroa.speculated120, 3
  %i.cz = zext nneg i32 %i.cy to i64
  %i.da = mul nuw nsw i32 %.sroa.speculated120, 12
  %i.db = zext nneg i32 %i.da to i64
  %i.dc = shl nuw nsw i32 %.sroa.speculated120, 4
  %i.dd = zext nneg i32 %i.dc to i64
  %i.de = mul nuw nsw i32 %.sroa.speculated120, 20
  %i.df = zext nneg i32 %i.de to i64
  %i.dg = mul nuw nsw i32 %.sroa.speculated120, 24
  %i.dh = zext nneg i32 %i.dg to i64
  %i.di = mul nuw nsw i32 %.sroa.speculated120, 28
  %i.dj = zext nneg i32 %i.di to i64
  %i.dk = shl nuw nsw i32 %.sroa.speculated120, 5
  %i.dl = zext nneg i32 %i.dk to i64              ; 8 uses
...
bb.e:                                             ; preds = %.lr.ph2499.split.us.i
  ...
  %i.dq = load <4 x float>, ptr %i.dp, align 1, !tbaa !108
  br label %.lr.ph.us.i
...
bb.g:                                             ; preds = %bb.g, %bb.f
  ...
  %i.eg = load <4 x float>, ptr %.07602492.us.i, align 16, !tbaa !108
  %i.eh = load <4 x float>, ptr %.07612491.us.i, align 16, !tbaa !108 ; 2 uses
  %i.ei = load <4 x float>, ptr %.07622490.us.i, align 16, !tbaa !108 ; 2 uses
  %i.ej = load <4 x float>, ptr %.07632489.us.i, align 16, !tbaa !108 ; 2 uses
  %i.ek = load <4 x float>, ptr %.07642488.us.i, align 16, !tbaa !108 ; 2 uses
  %i.el = load <4 x float>, ptr %.07652487.us.i, align 16, !tbaa !108 ; 2 uses
  %i.em = load <4 x float>, ptr %.07662486.us.i, align 16, !tbaa !108 ; 2 uses
  %i.en = load <4 x float>, ptr %.07802485.us.i, align 16, !tbaa !108
  ...
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, 8
  br i1 %exitcond.not.i, label %_ZN4ncnn3MatD2Ev.exit795.us.i, label %bb.g, !llvm.loop !1825
...
_ZN4ncnn3MatD2Ev.exit795.us.i:                    ; preds = %bb.g
  ...
  %i.gk = load i32, ptr %i.aq, align 4, !tbaa !86, !noalias !1854
  %i.gl = load ptr, ptr %12, align 8, !tbaa !34, !noalias !1854
  %i.gm = load i64, ptr %i.at, align 8, !tbaa !35, !noalias !1854
  %i.gn = mul i64 %i.gm, %i.dx
  %i.go = load i64, ptr %i.az, align 8, !tbaa !76, !noalias !1854 ; 2 uses
...
begin_hunk_26_@_ZN4ncnnL26conv3x3s1_winograd63_bf16sERKNS_3MatERS0_S2_S2_iiS2_RKNS_6OptionE.omp_outlined.16:bb.a
  ...
  store i16 %i.ase, ptr %i.arz, align 2, !tbaa !110
...
bb.t:                                             ; preds = %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit.us.i
  ...
  store i64 %i.aud, ptr %.07782493.us.i, align 1, !tbaa !108
...
bb.u:                                             ; preds = %bb.t
  ...
  store i64 %i.auk, ptr %i.aue, align 1, !tbaa !108
  br label %bb.v
...
bb.w:                                             ; preds = %bb.v
  ...
  store i64 %i.aur, ptr %i.aul, align 1, !tbaa !108
  br label %bb.x
...
bb.y:                                             ; preds = %bb.x
  ...
  store i64 %i.auy, ptr %i.aus, align 1, !tbaa !108
  br label %bb.z
...
bb.aa:                                            ; preds = %bb.z
  ...
  store i64 %i.avf, ptr %i.auz, align 1, !tbaa !108
  br label %bb.ab
...
bb.ac:                                            ; preds = %bb.ab
  ...
  store i64 %i.avm, ptr %i.avg, align 1, !tbaa !108
  br label %bb.ad
...
bb.ae:                                            ; preds = %bb.ad, %bb.h
  ...
  br i1 %exitcond2569.not.i, label %bb.af, label %bb.h, !llvm.loop !1828
...
bb.af:                                            ; preds = %bb.ae
  ...
  br i1 %exitcond2573.not.i, label %._crit_edge.us.i, label %bb.f, !llvm.loop !1829
...
._crit_edge.us.i:                                 ; preds = %bb.af
  ...
  br i1 %i.avp, label %.lr.ph2499.split.us.i, label %.preheader2483.loopexit.i, !llvm.loop !1830
...
.preheader2483.i:                                 ; preds = %.lr.ph2499.i, %.preheader2483.loopexit.i, %._crit_edge
  %.0757.lcssa.i = phi i32 [ 0, %._crit_edge ], [ %i.avq, %.preheader2483.loopexit.i ], [ %i.cb, %.lr.ph2499.i ] ; 6 uses
...
.lr.ph2519.i:                                     ; preds = %.preheader2483.i
  ...
  %i.avu = shl nuw nsw i32 %.sroa.speculated120, 1
  %i.avv = zext nneg i32 %i.avu to i64
  %i.avw = shl nuw nsw i32 %.sroa.speculated120, 2
  %i.avx = zext nneg i32 %i.avw to i64
  %i.avy = mul nuw nsw i32 %.sroa.speculated120, 6
  %i.avz = zext nneg i32 %i.avy to i64
  %i.awa = shl nuw nsw i32 %.sroa.speculated120, 3
  %i.awb = zext nneg i32 %i.awa to i64
  %i.awc = mul nuw nsw i32 %.sroa.speculated120, 10
  %i.awd = zext nneg i32 %i.awc to i64
  %i.awe = mul nuw nsw i32 %.sroa.speculated120, 12
  %i.awf = zext nneg i32 %i.awe to i64
  %i.awg = mul nuw nsw i32 %.sroa.speculated120, 14
  %i.awh = zext nneg i32 %i.awg to i64
  %i.awi = shl nuw nsw i32 %.sroa.speculated120, 4
  %i.awj = zext nneg i32 %i.awi to i64            ; 8 uses
...
.lr.ph2519.split.us.i:                            ; preds = %.lr.ph2519.i
  %i.awl = load i32, ptr %i.aq, align 4, !tbaa !86, !noalias !1855
  %i.awm = load ptr, ptr %12, align 8, !tbaa !34, !noalias !1855
  %i.awn = load i64, ptr %i.at, align 8, !tbaa !35, !noalias !1855
  %i.awo = load i64, ptr %i.az, align 8, !tbaa !76, !noalias !1855 ; 2 uses
...
bb.ah:                                            ; preds = %bb.ag
  ...
  %i.awt = load <2 x float>, ptr %i.aws, align 4, !tbaa !53
  br label %.thread.us.i
...
bb.aj:                                            ; preds = %bb.aj, %bb.ai
  ...
  %i.axi = load <2 x float>, ptr %.07742504.us.i, align 4, !tbaa !53 ; 2 uses
  %i.axj = load <2 x float>, ptr %.07732505.us.i, align 4, !tbaa !53 ; 2 uses
  %i.axk = fadd fast <2 x float> %i.axj, %i.axi   ; 3 uses
  %i.axl = load <2 x float>, ptr %.07722506.us.i, align 4, !tbaa !53 ; 2 uses
  %i.axm = load <2 x float>, ptr %.07712507.us.i, align 4, !tbaa !53 ; 2 uses
  %i.axn = fadd fast <2 x float> %i.axm, %i.axl   ; 3 uses
  %i.axo = load <2 x float>, ptr %.07702508.us.i, align 4, !tbaa !53 ; 2 uses
  %i.axp = load <2 x float>, ptr %.07692509.us.i, align 4, !tbaa !53 ; 2 uses
  %i.axq = fadd fast <2 x float> %i.axp, %i.axo   ; 3 uses
  %i.axr = load <2 x float>, ptr %.07752503.us.i, align 4, !tbaa !53
  ...
  store <2 x float> %i.axv, ptr %i.axh, align 8, !tbaa !53
  ...
  store <2 x float> %i.ayd, ptr %i.axw, align 8, !tbaa !53
  ...
  store <2 x float> %i.ayi, ptr %i.aye, align 8, !tbaa !53
  ...
  store <2 x float> %i.ayn, ptr %i.ayj, align 8, !tbaa !53
  ...
  store <2 x float> %i.ays, ptr %i.ayo, align 8, !tbaa !53
  %i.ayt = getelementptr inbounds nuw [8 x i8], ptr %i.be, i64 %indvars.iv2578.i
  %i.ayu = load <2 x float>, ptr %.07682510.us.i, align 4, !tbaa !53
  ...
  store <2 x float> %i.ayy, ptr %i.ayt, align 8, !tbaa !53
  ...
  br i1 %exitcond2581.not.i, label %_ZN4ncnn3MatD2Ev.exit794.us.i, label %bb.aj, !llvm.loop !1833
...
bb.al:                                            ; preds = %bb.ak
  ...
  %i.baj = load <2 x float>, ptr %i.bac, align 8, !tbaa !53 ; 2 uses
  %i.bak = load <2 x float>, ptr %i.bad, align 16, !tbaa !53 ; 2 uses
  %i.bal = load <2 x float>, ptr %i.bae, align 8, !tbaa !53 ; 2 uses
  %i.bam = load <2 x float>, ptr %i.baf, align 16, !tbaa !53 ; 2 uses
  %i.ban = load <2 x float>, ptr %i.bag, align 8, !tbaa !53 ; 2 uses
  %i.bao = load <2 x float>, ptr %i.bah, align 16, !tbaa !53 ; 2 uses
  %i.bap = load <2 x float>, ptr %i.bai, align 8, !tbaa !53
...
begin_hunk_27_@_ZN4ncnnL26conv3x3s1_winograd63_bf16sERKNS_3MatERS0_S2_S2_iiS2_RKNS_6OptionE.omp_outlined.16:bb.a
  %i.bio = fneg fast <2 x float> %i.bin
  %i.bip = call fast <2 x float> @llvm.exp.v2f32(<2 x float> %i.bio)
...
_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1279.us.i: ; preds = %bb.al
  %i.bje = load ptr, ptr %15, align 8, !tbaa !34
  %i.bjf = load <2 x float>, ptr %i.bje, align 4, !tbaa !53 ; 5 uses
  %i.bjg = extractelement <2 x float> %i.bjf, i64 0 ; 2 uses
  %i.bjh = extractelement <2 x float> %i.bjf, i64 1 ; 3 uses
  %i.bji = shufflevector <2 x float> %i.bjf, <2 x float> poison, <2 x i32> zeroinitializer ; 5 uses
  %i.bjj = call nnan ninf nsz <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.bbk, <2 x float> %i.bji) ; 2 uses
  %i.bjk = shufflevector <2 x float> %i.bjf, <2 x float> poison, <2 x i32> <i32 1, i32 1> ; 10 uses
  %i.bjl = fcmp fast ogt <2 x float> %i.bjj, %i.bjk
  %i.bjm = select <2 x i1> %i.bjl, <2 x float> %i.bjk, <2 x float> %i.bjj ; 2 uses
  %i.bjn = call nnan ninf nsz <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.bax, <2 x float> %i.bji) ; 2 uses
  %i.bjo = fcmp fast ogt <2 x float> %i.bjn, %i.bjk
  %i.bjp = select <2 x i1> %i.bjo, <2 x float> %i.bjk, <2 x float> %i.bjn ; 2 uses
  %i.bjq = call nnan ninf nsz <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.bbo, <2 x float> %i.bji) ; 2 uses
  %i.bjr = fcmp fast ogt <2 x float> %i.bjq, %i.bjk
  %i.bjs = select <2 x i1> %i.bjr, <2 x float> %i.bjk, <2 x float> %i.bjq ; 2 uses
  %i.bjt = call nnan ninf nsz <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.bbb, <2 x float> %i.bji) ; 2 uses
  %i.bju = fcmp fast ogt <2 x float> %i.bjt, %i.bjk
  %i.bjv = select <2 x i1> %i.bju, <2 x float> %i.bjk, <2 x float> %i.bjt ; 2 uses
  %i.bjw = call nnan ninf nsz <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.bbs, <2 x float> %i.bji) ; 2 uses
  %i.bjx = fcmp fast ogt <2 x float> %i.bjw, %i.bjk
  %i.bjy = select <2 x i1> %i.bjx, <2 x float> %i.bjk, <2 x float> %i.bjw ; 2 uses
  %i.bjz = extractelement <2 x float> %i.bbw, i64 0
  %.01034.us.i = call nnan ninf nsz float @llvm.maxnum.f32(float %i.bjz, float %i.bjg) ; 2 uses
  %i.bka = fcmp fast ogt float %.01034.us.i, %i.bjh
  %.110352116.us.i = select i1 %i.bka, float %i.bjh, float %.01034.us.i ; 2 uses
  %i.bkb = extractelement <2 x float> %i.bbw, i64 1
  %.01036.us.i = call nnan ninf nsz float @llvm.maxnum.f32(float %i.bkb, float %i.bjg) ; 2 uses
  %i.bkc = fcmp fast ogt float %.01036.us.i, %i.bjh
  %i.bkd = insertelement <2 x float> poison, float %.110352116.us.i, i64 0
  %i.bke = insertelement <2 x float> %i.bkd, float %.01036.us.i, i64 1
  br i1 %i.bkc, label %bb.bl, label %_ZL13activation_ssfiRKN4ncnn3MatE.exit826.us.i

bb.bl:                                            ; preds = %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1279.us.i
  %i.bkf = insertelement <2 x float> %i.bjf, float %.110352116.us.i, i64 0
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit826.us.i

_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1285.us.i: ; preds = %bb.al
  %i.bkg = load ptr, ptr %15, align 8, !tbaa !34
  %i.bkh = load float, ptr %i.bkg, align 4, !tbaa !53
  %i.bki = fcmp fast ogt <2 x float> %i.bbk, zeroinitializer
  %i.bkj = insertelement <2 x float> poison, float %i.bkh, i64 0
  %i.bkk = shufflevector <2 x float> %i.bkj, <2 x float> poison, <2 x i32> zeroinitializer ; 6 uses
  %i.bkl = select <2 x i1> %i.bki, <2 x float> splat (float 1.000000e+00), <2 x float> %i.bkk
  %i.bkm = fmul fast <2 x float> %i.bkl, %i.bbk
  %i.bkn = fcmp fast ogt <2 x float> %i.bax, zeroinitializer
  %i.bko = select <2 x i1> %i.bkn, <2 x float> splat (float 1.000000e+00), <2 x float> %i.bkk
  %i.bkp = fmul fast <2 x float> %i.bko, %i.bax
  %i.bkq = fcmp fast ogt <2 x float> %i.bbo, zeroinitializer
  %i.bkr = select <2 x i1> %i.bkq, <2 x float> splat (float 1.000000e+00), <2 x float> %i.bkk
  %i.bks = fmul fast <2 x float> %i.bkr, %i.bbo
  %i.bkt = fcmp fast ogt <2 x float> %i.bbb, zeroinitializer
  %i.bku = select <2 x i1> %i.bkt, <2 x float> splat (float 1.000000e+00), <2 x float> %i.bkk
  %i.bkv = fmul fast <2 x float> %i.bku, %i.bbb
  %i.bkw = fcmp fast ogt <2 x float> %i.bbs, zeroinitializer
  %i.bkx = select <2 x i1> %i.bkw, <2 x float> splat (float 1.000000e+00), <2 x float> %i.bkk
  %i.bky = fmul fast <2 x float> %i.bkx, %i.bbs
  %i.bkz = fcmp fast ogt <2 x float> %i.bbw, zeroinitializer
  %i.bla = select <2 x i1> %i.bkz, <2 x float> splat (float 1.000000e+00), <2 x float> %i.bkk
  %i.blb = fmul fast <2 x float> %i.bla, %i.bbw
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit826.us.i

_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1282.us.i: ; preds = %bb.al
  %i.blc = call fast <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.bbk, <2 x float> zeroinitializer)
  %i.bld = call fast <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.bax, <2 x float> zeroinitializer)
  %i.ble = call fast <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.bbo, <2 x float> zeroinitializer)
  %i.blf = call fast <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.bbb, <2 x float> zeroinitializer)
  %i.blg = call fast <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.bbs, <2 x float> zeroinitializer)
  %i.blh = call fast <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.bbw, <2 x float> zeroinitializer)
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit826.us.i
...
_ZL13activation_ssfiRKN4ncnn3MatE.exit826.us.i:   ; preds = %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1282.us.i, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1285.us.i, %bb.bl, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1279.us.i, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1288.us.i, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1291.us.i, %bb.bk, %bb.bj, %_ZL13activation_ssfiRKN4ncnn3MatE.exit827.thread.us.i, %bb.al
  %i.bli = phi <2 x float> [ %i.bfp, %_ZL13activation_ssfiRKN4ncnn3MatE.exit827.thread.us.i ], [ %i.blh, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1282.us.i ], [ %i.blb, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1285.us.i ], [ %i.bkf, %bb.bl ], [ %i.bke, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1279.us.i ], [ %i.bjd, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1288.us.i ], [ %i.bht, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1291.us.i ], [ %i.bgh, %bb.bk ], [ %i.bgd, %bb.bj ], [ %i.bbw, %bb.al ]
  %i.blj = phi <2 x float> [ %i.bfr, %_ZL13activation_ssfiRKN4ncnn3MatE.exit827.thread.us.i ], [ %i.blg, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1282.us.i ], [ %i.bky, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1285.us.i ], [ %i.bjy, %bb.bl ], [ %i.bjy, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1279.us.i ], [ %i.bix, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1288.us.i ], [ %i.bhg, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1291.us.i ], [ %i.bfr, %bb.bk ], [ %i.bfr, %bb.bj ], [ %i.bbs, %bb.al ]
  %i.blk = phi <2 x float> [ %i.bft, %_ZL13activation_ssfiRKN4ncnn3MatE.exit827.thread.us.i ], [ %i.blf, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1282.us.i ], [ %i.bkv, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1285.us.i ], [ %i.bjv, %bb.bl ], [ %i.bjv, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1279.us.i ], [ %i.bir, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1288.us.i ], [ %i.bhb, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1291.us.i ], [ %i.bft, %bb.bk ], [ %i.bft, %bb.bj ], [ %i.bbb, %bb.al ]
  %i.bll = phi <2 x float> [ %i.bfv, %_ZL13activation_ssfiRKN4ncnn3MatE.exit827.thread.us.i ], [ %i.ble, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1282.us.i ], [ %i.bks, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1285.us.i ], [ %i.bjs, %bb.bl ], [ %i.bjs, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1279.us.i ], [ %i.bil, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1288.us.i ], [ %i.bgw, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1291.us.i ], [ %i.bfv, %bb.bk ], [ %i.bfv, %bb.bj ], [ %i.bbo, %bb.al ]
  %i.blm = phi <2 x float> [ %i.bfx, %_ZL13activation_ssfiRKN4ncnn3MatE.exit827.thread.us.i ], [ %i.bld, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1282.us.i ], [ %i.bkp, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1285.us.i ], [ %i.bjp, %bb.bl ], [ %i.bjp, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1279.us.i ], [ %i.bif, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1288.us.i ], [ %i.bgr, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1291.us.i ], [ %i.bfx, %bb.bk ], [ %i.bfx, %bb.bj ], [ %i.bax, %bb.al ]
  %i.bln = phi <2 x float> [ %i.bfz, %_ZL13activation_ssfiRKN4ncnn3MatE.exit827.thread.us.i ], [ %i.blc, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1282.us.i ], [ %i.bkm, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1285.us.i ], [ %i.bjm, %bb.bl ], [ %i.bjm, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1279.us.i ], [ %i.bhz, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1288.us.i ], [ %i.bgm, %_ZL13activation_ssfiRKN4ncnn3MatE.exit837.thread1291.us.i ], [ %i.bfz, %bb.bk ], [ %i.bfz, %bb.bj ], [ %i.bbk, %bb.al ]
  %i.blo = getelementptr inbounds nuw [2 x i8], ptr %.07552512.us.i, i64 %i.cr ; 6 uses
  %i.blp = bitcast <2 x float> %i.bln to <2 x i32>
  %i.blq = lshr <2 x i32> %i.blp, splat (i32 16)
  %i.blr = trunc nuw <2 x i32> %i.blq to <2 x i16> ; 2 uses
  %i.bls = extractelement <2 x i16> %i.blr, i64 0
  store i16 %i.bls, ptr %.07552512.us.i, align 2, !tbaa !110
  %i.blt = extractelement <2 x i16> %i.blr, i64 1
  store i16 %i.blt, ptr %i.blo, align 2, !tbaa !110
  br i1 %i.azs, label %bb.bm, label %bb.bn

bb.bm:                                            ; preds = %_ZL13activation_ssfiRKN4ncnn3MatE.exit826.us.i
  %i.blu = bitcast <2 x float> %i.blm to <2 x i32>
  %i.blv = getelementptr inbounds nuw i8, ptr %.07552512.us.i, i64 2
  %i.blw = lshr <2 x i32> %i.blu, splat (i32 16)
  %i.blx = trunc nuw <2 x i32> %i.blw to <2 x i16> ; 2 uses
  %i.bly = extractelement <2 x i16> %i.blx, i64 0
  store i16 %i.bly, ptr %i.blv, align 2, !tbaa !110
  %i.blz = getelementptr inbounds nuw i8, ptr %i.blo, i64 2
  %i.bma = extractelement <2 x i16> %i.blx, i64 1
  store i16 %i.bma, ptr %i.blz, align 2, !tbaa !110
  br label %bb.bn
...
bb.bo:                                            ; preds = %bb.bn
  %i.bmb = bitcast <2 x float> %i.bll to <2 x i32>
  %i.bmc = getelementptr inbounds nuw i8, ptr %.07552512.us.i, i64 4
  %i.bmd = lshr <2 x i32> %i.bmb, splat (i32 16)
  %i.bme = trunc nuw <2 x i32> %i.bmd to <2 x i16> ; 2 uses
  %i.bmf = extractelement <2 x i16> %i.bme, i64 0
  store i16 %i.bmf, ptr %i.bmc, align 2, !tbaa !110
  %i.bmg = getelementptr inbounds nuw i8, ptr %i.blo, i64 4
  %i.bmh = extractelement <2 x i16> %i.bme, i64 1
  store i16 %i.bmh, ptr %i.bmg, align 2, !tbaa !110
  br label %bb.bp
...
bb.bq:                                            ; preds = %bb.bp
  %i.bmi = bitcast <2 x float> %i.blk to <2 x i32>
  %i.bmj = getelementptr inbounds nuw i8, ptr %.07552512.us.i, i64 6
  %i.bmk = lshr <2 x i32> %i.bmi, splat (i32 16)
  %i.bml = trunc nuw <2 x i32> %i.bmk to <2 x i16> ; 2 uses
  %i.bmm = extractelement <2 x i16> %i.bml, i64 0
  store i16 %i.bmm, ptr %i.bmj, align 2, !tbaa !110
  %i.bmn = getelementptr inbounds nuw i8, ptr %i.blo, i64 6
  %i.bmo = extractelement <2 x i16> %i.bml, i64 1
  store i16 %i.bmo, ptr %i.bmn, align 2, !tbaa !110
  br label %bb.br
...
bb.bs:                                            ; preds = %bb.br
  %i.bmp = bitcast <2 x float> %i.blj to <2 x i32>
  %i.bmq = getelementptr inbounds nuw i8, ptr %.07552512.us.i, i64 8
  %i.bmr = lshr <2 x i32> %i.bmp, splat (i32 16)
  %i.bms = trunc nuw <2 x i32> %i.bmr to <2 x i16> ; 2 uses
  %i.bmt = extractelement <2 x i16> %i.bms, i64 0
  store i16 %i.bmt, ptr %i.bmq, align 2, !tbaa !110
  %i.bmu = getelementptr inbounds nuw i8, ptr %i.blo, i64 8
  %i.bmv = extractelement <2 x i16> %i.bms, i64 1
  store i16 %i.bmv, ptr %i.bmu, align 2, !tbaa !110
  br label %bb.bt
...
bb.bu:                                            ; preds = %bb.bt
  %i.bmw = bitcast <2 x float> %i.bli to <2 x i32>
  %i.bmx = getelementptr inbounds nuw i8, ptr %.07552512.us.i, i64 10
  %i.bmy = lshr <2 x i32> %i.bmw, splat (i32 16)
  %i.bmz = trunc nuw <2 x i32> %i.bmy to <2 x i16> ; 2 uses
  %i.bna = extractelement <2 x i16> %i.bmz, i64 0
  store i16 %i.bna, ptr %i.bmx, align 2, !tbaa !110
  %i.bnb = getelementptr inbounds nuw i8, ptr %i.blo, i64 10
  %i.bnc = extractelement <2 x i16> %i.bmz, i64 1
  store i16 %i.bnc, ptr %i.bnb, align 2, !tbaa !110
  br label %bb.bv

bb.bv:                                            ; preds = %bb.bu, %bb.bt
  %i.bnd = getelementptr inbounds [2 x i8], ptr %.07552512.us.i, i64 %i.awk
  br label %bb.bw

bb.bw:                                            ; preds = %bb.bv, %bb.ak
  %.1756.us.i = phi ptr [ %.07552512.us.i, %bb.ak ], [ %i.bnd, %bb.bv ]
  %indvars.iv.next2583.i = add nuw nsw i64 %indvars.iv2582.i, 1 ; 2 uses
  %exitcond2585.not.i = icmp eq i64 %indvars.iv.next2583.i, 6
  br i1 %exitcond2585.not.i, label %bb.bx, label %bb.ak, !llvm.loop !1834
...
bb.bx:                                            ; preds = %bb.bw
  ...
  br i1 %exitcond2590.not.i, label %._crit_edge.us2523.i, label %bb.ai, !llvm.loop !1835

._crit_edge.us2523.i:                             ; preds = %bb.bx
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #12
  %indvars.iv.next2592.i = add nuw nsw i64 %indvars.iv2591.i, 2 ; 3 uses
  %i.bne = icmp slt i64 %indvars.iv.next2592.i, %invariant.op2649.i.a
  br i1 %i.bne, label %bb.ag, label %.preheader.loopexit.i, !llvm.loop !1836

.lr.ph2519.split.i:                               ; preds = %.lr.ph2519.i
  %18 = add i32 %.0757.lcssa.i, 3
  %smax2577.i = call i32 @llvm.smax.i32(i32 %.sroa.speculated124, i32 %18)
  %reass.sub = sub i32 %smax2577.i, %.0757.lcssa.i
  %19 = and i32 %reass.sub, -2
  %i.bnf = add i32 %.0757.lcssa.i, %19
  br label %.preheader.i

.preheader.loopexit.i:                            ; preds = %._crit_edge.us2523.i
  %i.bng = trunc nsw i64 %indvars.iv.next2592.i to i32
  br label %.preheader.i

.preheader.i:                                     ; preds = %.preheader.loopexit.i, %.lr.ph2519.split.i, %.preheader2483.i
  %.1758.lcssa.i = phi i32 [ %.0757.lcssa.i, %.preheader2483.i ], [ %i.bnf, %.lr.ph2519.split.i ], [ %i.bng, %.preheader.loopexit.i ] ; 2 uses
  %i.bnh = icmp slt i32 %.1758.lcssa.i, %.sroa.speculated124
  br i1 %i.bnh, label %.lr.ph2547.i, label %_ZN4ncnnL48conv3x3s1_winograd63_transform_output_tile_bf16sERKNS_3MatERS0_S2_iiiiiS2_.exit

.lr.ph2547.i:                                     ; preds = %.preheader.i
  %.not.i83 = icmp eq ptr %.val81, null
  %i.bni = icmp sgt i32 %.sroa.speculated120, 0
  %i.bnj = sext i32 %.sroa.speculated120 to i64
  %i.bnk = shl nuw nsw i32 %.sroa.speculated120, 1
  %i.bnl = zext nneg i32 %i.bnk to i64
  %i.bnm = mul nuw nsw i32 %.sroa.speculated120, 3
  %i.bnn = zext nneg i32 %i.bnm to i64
  %i.bno = shl nuw nsw i32 %.sroa.speculated120, 2
  %i.bnp = zext nneg i32 %i.bno to i64
  %i.bnq = mul nuw nsw i32 %.sroa.speculated120, 5
  %i.bnr = zext nneg i32 %i.bnq to i64
  %i.bns = mul nuw nsw i32 %.sroa.speculated120, 6
  %i.bnt = zext nneg i32 %i.bns to i64
  %i.bnu = mul nuw nsw i32 %.sroa.speculated120, 7
  %i.bnv = zext nneg i32 %i.bnu to i64
  %i.bnw = shl nuw nsw i32 %.sroa.speculated120, 3
  %i.bnx = zext nneg i32 %i.bnw to i64            ; 8 uses
  %i.bny = sext i32 %i.cm to i64
  br i1 %i.bni, label %.lr.ph2547.split.us.i, label %_ZN4ncnnL48conv3x3s1_winograd63_transform_output_tile_bf16sERKNS_3MatERS0_S2_iiiiiS2_.exit

.lr.ph2547.split.us.i:                            ; preds = %.lr.ph2547.i
  %i.bnz = load i32, ptr %i.aq, align 4, !tbaa !86, !noalias !1856
  %i.boa = load ptr, ptr %12, align 8, !tbaa !34, !noalias !1856
  %i.bob = load i64, ptr %i.at, align 8, !tbaa !35, !noalias !1856
  %i.boc = load i64, ptr %i.az, align 8, !tbaa !76, !noalias !1856 ; 2 uses
  %factor.op.mul2552.i = mul i64 %i.boc, %i.bob
  %i.bod = sext i32 %i.bnz to i64
  %factor.op.mul2543.us.i = mul i64 %i.boc, %i.bod
  %i.boe = sext i32 %i.cn to i64
  %i.bof = sext i32 %.1758.lcssa.i to i64
  %wide.trip.count2605.i = zext nneg i32 %.sroa.speculated120 to i64
  br label %bb.by

bb.by:                                            ; preds = %._crit_edge.us2550.i, %.lr.ph2547.split.us.i
  %indvars.iv2607.i = phi i64 [ %indvars.iv.next2608.i, %._crit_edge.us2550.i ], [ %i.bof, %.lr.ph2547.split.us.i ] ; 3 uses
  %.pre2612.i = add nsw i64 %indvars.iv2607.i, %i.ca ; 2 uses
  br i1 %.not.i83, label %.lr.ph.us2549.i, label %bb.bz

bb.bz:                                            ; preds = %bb.by
  %i.bog = getelementptr inbounds [4 x i8], ptr %.val81, i64 %.pre2612.i
  %i.boh = load float, ptr %i.bog, align 4, !tbaa !53
  br label %.lr.ph.us2549.i

.lr.ph.us2549.i:                                  ; preds = %bb.bz, %bb.by
  %i.boi = phi fast float [ %i.boh, %bb.bz ], [ 0.000000e+00, %bb.by ] ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c) #12
  %i.boj = trunc nsw i64 %indvars.iv2607.i to i32
  %factor.op.mul2540.reass.us.i = mul i32 %factor.op.mul2496.i, %i.boj
  %i.bok = sext i32 %factor.op.mul2540.reass.us.i to i64
  %i.bol = getelementptr inbounds [4 x i8], ptr %i.bt, i64 %i.bok
  %.reass2553.i = mul i64 %factor.op.mul2552.i, %.pre2612.i
  %i.bom = getelementptr inbounds nuw i8, ptr %i.boa, i64 %.reass2553.i
  %i.bon = insertelement <2 x float> poison, float %i.boi, i64 0
  br label %bb.ca

bb.ca:                                            ; preds = %bb.dd, %.lr.ph.us2549.i
  %indvars.iv2602.i = phi i64 [ 0, %.lr.ph.us2549.i ], [ %indvars.iv.next2603.i, %bb.dd ] ; 3 uses
  %i.boo = getelementptr inbounds nuw [4 x i8], ptr %i.bol, i64 %indvars.iv2602.i ; 8 uses
  %i.bop = getelementptr inbounds nuw [4 x i8], ptr %i.boo, i64 %i.bnj
  %i.boq = getelementptr inbounds nuw [4 x i8], ptr %i.boo, i64 %i.bnl
  %i.bor = getelementptr inbounds nuw [4 x i8], ptr %i.boo, i64 %i.bnn
  %i.bos = getelementptr inbounds nuw [4 x i8], ptr %i.boo, i64 %i.bnp
  %i.bot = getelementptr inbounds nuw [4 x i8], ptr %i.boo, i64 %i.bnr
  %i.bou = getelementptr inbounds nuw [4 x i8], ptr %i.boo, i64 %i.bnt
  %i.bov = getelementptr inbounds nuw [4 x i8], ptr %i.boo, i64 %i.bnv
  br label %bb.cb

bb.cb:                                            ; preds = %bb.cb, %bb.ca
  %indvars.iv2594.i = phi i64 [ %indvars.iv.next2595.i, %bb.cb ], [ 0, %bb.ca ] ; 7 uses
  %.07452536.us.i = phi ptr [ %i.bqz, %bb.cb ], [ %i.bov, %bb.ca ] ; 2 uses
  %.07462535.us.i = phi ptr [ %i.bqy, %bb.cb ], [ %i.bou, %bb.ca ] ; 2 uses
  %.07472534.us.i = phi ptr [ %i.bqx, %bb.cb ], [ %i.bot, %bb.ca ] ; 2 uses
  %.07482533.us.i = phi ptr [ %i.bqw, %bb.cb ], [ %i.bos, %bb.ca ] ; 2 uses
  %.07492532.us.i = phi ptr [ %i.bqv, %bb.cb ], [ %i.bor, %bb.ca ] ; 2 uses
  %.07502531.us.i = phi ptr [ %i.bqu, %bb.cb ], [ %i.boq, %bb.ca ] ; 2 uses
  %.07512530.us.i = phi ptr [ %i.bqt, %bb.cb ], [ %i.bop, %bb.ca ] ; 2 uses
  %.07522529.us.i = phi ptr [ %i.bqs, %bb.cb ], [ %i.boo, %bb.ca ] ; 2 uses
  %i.bow = load float, ptr %.07512530.us.i, align 4, !tbaa !53 ; 2 uses
  %i.box = load float, ptr %.07502531.us.i, align 4, !tbaa !53 ; 2 uses
  %i.boy = load float, ptr %.07492532.us.i, align 4, !tbaa !53 ; 2 uses
  %i.boz = load float, ptr %.07482533.us.i, align 4, !tbaa !53 ; 2 uses
  %i.bpa = load float, ptr %.07472534.us.i, align 4, !tbaa !53 ; 2 uses
  %i.bpb = load float, ptr %.07462535.us.i, align 4, !tbaa !53 ; 2 uses
  %i.bpc = fadd fast float %i.bpb, %i.bpa         ; 3 uses
  %i.bpd = fsub fast float %i.bpa, %i.bpb         ; 3 uses
  %i.bpe = load float, ptr %.07522529.us.i, align 4, !tbaa !53
  %i.bpf = fmul fast float %i.bpc, 3.200000e+01
  %i.bpg = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %indvars.iv2594.i
  %i.bph = fmul fast float %i.bpd, 1.600000e+01
  %i.bpi = getelementptr inbounds nuw [4 x i8], ptr %i.bf, i64 %indvars.iv2594.i
  %i.bpj = fmul fast float %i.bpc, 8.000000e+00
  %i.bpk = getelementptr inbounds nuw [4 x i8], ptr %i.bg, i64 %indvars.iv2594.i
  %i.bpl = fmul fast float %i.bpd, 4.000000e+00
  %i.bpm = getelementptr inbounds nuw [4 x i8], ptr %i.bh, i64 %indvars.iv2594.i
  %i.bpn = fsub fast float %i.bow, %i.box         ; 3 uses
  %i.bpo = fadd fast float %i.boz, %i.boy         ; 2 uses
  %i.bpp = fsub fast float %i.boy, %i.boz         ; 2 uses
  %i.bpq = fadd fast float %i.box, %i.bow         ; 2 uses
  %i.bpr = fadd fast float %i.bpn, %i.bph
  %i.bps = fadd fast float %i.bpo, %i.bpq
  %i.bpt = fadd fast float %i.bps, %i.bpe
  %i.bpu = fadd fast float %i.bpt, %i.bpf
  store float %i.bpu, ptr %i.bpg, align 4, !tbaa !53
  %i.bpv = insertelement <4 x float> poison, float %i.bpp, i64 0
  %i.bpw = insertelement <4 x float> %i.bpv, float %i.bpo, i64 1
  %i.bpx = shufflevector <4 x float> %i.bpw, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %i.bpy = fmul fast <4 x float> %i.bpx, <float 2.000000e+00, float 4.000000e+00, float 8.000000e+00, float 1.600000e+01>
  %i.bpz = insertelement <4 x float> poison, float %i.bpr, i64 0
  %i.bqa = insertelement <4 x float> %i.bpz, float %i.bpq, i64 1
  %i.bqb = insertelement <4 x float> %i.bqa, float %i.bpn, i64 2
  %i.bqc = shufflevector <4 x float> %i.bqb, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 1>
  %i.bqd = fadd fast <4 x float> %i.bqc, %i.bpy   ; 4 uses
  %i.bqe = extractelement <4 x float> %i.bqd, i64 0
  store float %i.bqe, ptr %i.bpi, align 4, !tbaa !53
  %i.bqf = extractelement <4 x float> %i.bqd, i64 1
  %i.bqg = fadd fast float %i.bpj, %i.bqf
  store float %i.bqg, ptr %i.bpk, align 4, !tbaa !53
  %i.bqh = extractelement <4 x float> %i.bqd, i64 2
  %i.bqi = fadd fast float %i.bpl, %i.bqh
  store float %i.bqi, ptr %i.bpm, align 4, !tbaa !53
  %factor2446.us.i = fmul fast float %i.bpc, 2.000000e+00
  %i.bqj = extractelement <4 x float> %i.bqd, i64 3
  %i.bqk = fadd fast float %factor2446.us.i, %i.bqj
  %i.bql = getelementptr inbounds nuw [4 x i8], ptr %i.bi, i64 %indvars.iv2594.i
  store float %i.bqk, ptr %i.bql, align 4, !tbaa !53
  %i.bqm = load float, ptr %.07452536.us.i, align 4, !tbaa !53
  %i.bqn = fmul fast float %i.bpp, 3.200000e+01
  %i.bqo = fadd fast float %i.bpn, %i.bqn
  %i.bqp = fadd fast float %i.bqo, %i.bpd
  %i.bqq = fadd fast float %i.bqp, %i.bqm
  %i.bqr = getelementptr inbounds nuw [4 x i8], ptr %i.bj, i64 %indvars.iv2594.i
  store float %i.bqq, ptr %i.bqr, align 4, !tbaa !53
  %i.bqs = getelementptr inbounds nuw [4 x i8], ptr %.07522529.us.i, i64 %i.bnx
  %i.bqt = getelementptr inbounds nuw [4 x i8], ptr %.07512530.us.i, i64 %i.bnx
  %i.bqu = getelementptr inbounds nuw [4 x i8], ptr %.07502531.us.i, i64 %i.bnx
  %i.bqv = getelementptr inbounds nuw [4 x i8], ptr %.07492532.us.i, i64 %i.bnx
  %i.bqw = getelementptr inbounds nuw [4 x i8], ptr %.07482533.us.i, i64 %i.bnx
  %i.bqx = getelementptr inbounds nuw [4 x i8], ptr %.07472534.us.i, i64 %i.bnx
  %i.bqy = getelementptr inbounds nuw [4 x i8], ptr %.07462535.us.i, i64 %i.bnx
  %i.bqz = getelementptr inbounds nuw [4 x i8], ptr %.07452536.us.i, i64 %i.bnx
  %indvars.iv.next2595.i = add nuw nsw i64 %indvars.iv2594.i, 1 ; 2 uses
  %exitcond2597.not.i = icmp eq i64 %indvars.iv.next2595.i, 8
  br i1 %exitcond2597.not.i, label %_ZN4ncnn3MatD2Ev.exit.us.i, label %bb.cb, !llvm.loop !1839

_ZN4ncnn3MatD2Ev.exit.us.i:                       ; preds = %bb.cb
  %i.bra = trunc i64 %indvars.iv2602.i to i32
  %i.brb = add i32 %.047134, %i.bra               ; 2 uses
  %i.brc = sdiv i32 %i.brb, %i.ct
  %i.brd = srem i32 %i.brb, %i.ct
  %i.bre = mul nsw i32 %i.brc, 6
  %i.brf = sext i32 %i.bre to i64                 ; 2 uses
  %.reass2544.us.i = mul i64 %factor.op.mul2543.us.i, %i.brf
  %i.brg = getelementptr inbounds nuw i8, ptr %i.bom, i64 %.reass2544.us.i
  %i.brh = mul nsw i32 %i.brd, 6                  ; 6 uses
  %i.bri = sext i32 %i.brh to i64
  %i.brj = getelementptr inbounds [2 x i8], ptr %i.brg, i64 %i.bri
  %i.brk = or disjoint i32 %i.brh, 1
  %i.brl = icmp slt i32 %i.brk, %i.cm
  %i.brm = add nsw i32 %i.brh, 2
  %i.brn = icmp slt i32 %i.brm, %i.cm
  %i.bro = add nsw i32 %i.brh, 3
  %i.brp = icmp slt i32 %i.bro, %i.cm
  %i.brq = add nsw i32 %i.brh, 4
  %i.brr = icmp slt i32 %i.brq, %i.cm
  %i.brs = add nsw i32 %i.brh, 5
  %i.brt = icmp slt i32 %i.brs, %i.cm
  %invariant.op2650.i = sub nsw i64 %i.boe, %i.brf
  br label %bb.cc
...
bb.cc:                                            ; preds = %bb.dc, %_ZN4ncnn3MatD2Ev.exit.us.i
  ...
  %.07432538.us.i = phi ptr [ %.1.us.i, %bb.dc ], [ %i.brj, %_ZN4ncnn3MatD2Ev.exit.us.i ] ; 8 uses
  %.not788.us.i = icmp slt i64 %indvars.iv2598.i, %invariant.op2650.i
  br i1 %.not788.us.i, label %bb.cd, label %bb.dc

bb.cd:                                            ; preds = %bb.cc
  %i.bru = getelementptr inbounds nuw [32 x i8], ptr %i.c, i64 %indvars.iv2598.i ; 8 uses
  %i.brv = load float, ptr %i.bru, align 16, !tbaa !53
  %i.brw = getelementptr inbounds nuw i8, ptr %i.bru, i64 4
  %i.brx = load float, ptr %i.brw, align 4, !tbaa !53 ; 2 uses
  %i.bry = getelementptr inbounds nuw i8, ptr %i.bru, i64 8
  %i.brz = load float, ptr %i.bry, align 8, !tbaa !53 ; 2 uses
  %i.bsa = getelementptr inbounds nuw i8, ptr %i.bru, i64 12
  %i.bsb = getelementptr inbounds nuw i8, ptr %i.bru, i64 16
  %i.bsc = getelementptr inbounds nuw i8, ptr %i.bru, i64 20
  %i.bsd = getelementptr inbounds nuw i8, ptr %i.bru, i64 24
  %i.bse = getelementptr inbounds nuw i8, ptr %i.bru, i64 28
  %i.bsf = load float, ptr %i.bse, align 4, !tbaa !53
end_hunk_27
...
bb.k:                                             ; preds = %._crit_edge510
  %i.rb = load ptr, ptr %14, align 8, !tbaa !34   ; 2 uses
  %i.rc = load float, ptr %i.rb, align 4, !tbaa !53
  ...
  %i.rg = load float, ptr %i.rf, align 4, !tbaa !53
...
.thread:                                          ; preds = %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit
  ...
  store i64 %i.rt, ptr %.1132519, align 1, !tbaa !108
...
bb.m:                                             ; preds = %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit, %.thread, %bb.l
  ...
  br i1 %exitcond578.not, label %._crit_edge, label %bb.c, !llvm.loop !1980
...
!19 = !{!"Ubuntu clang version 24.0.0 (++20260807082003+f3bd40ce6ba5-1~exp1~20260807082012.1771)"}
!20 = !{!"Simple C++ TBAA"}
...
!28 = !{!"p1 int", !27, i64 0}
!29 = !{!"long", !21, i64 0}
!30 = !{!"p1 _ZTSN4ncnn9AllocatorE", !27, i64 0}
!31 = !{!"_ZTSN4ncnn3MatE", !27, i64 0, !28, i64 8, !29, i64 16, !22, i64 24, !30, i64 32, !22, i64 40, !22, i64 44, !22, i64 48, !22, i64 52, !22, i64 56, !29, i64 64}
!32 = !{!31, !28, i64 8}
!33 = !{!31, !30, i64 32}
!34 = !{!31, !27, i64 0}
!35 = !{!31, !29, i64 64}
!36 = !{!"bool", !21, i64 0}
!37 = !{!"p1 omnipotent char", !27, i64 0}
!38 = !{!"_ZTSNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE12_Alloc_hiderE", !37, i64 0}
!39 = !{!"_ZTSNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE", !38, i64 0, !29, i64 8, !21, i64 16}
!40 = !{!"_ZTSNSt12_Vector_baseIiSaIiEE17_Vector_impl_dataE", !28, i64 0, !28, i64 8, !28, i64 16}
...
!44 = !{!"p1 _ZTSN4ncnn3MatE", !27, i64 0}
!45 = !{!"_ZTSNSt12_Vector_baseIN4ncnn3MatESaIS1_EE17_Vector_impl_dataE", !44, i64 0, !44, i64 8, !44, i64 16}
!46 = !{!"_ZTSNSt12_Vector_baseIN4ncnn3MatESaIS1_EE12_Vector_implE", !45, i64 0}
!47 = !{!"_ZTSSt12_Vector_baseIN4ncnn3MatESaIS1_EE", !46, i64 0}
!48 = !{!"_ZTSSt6vectorIN4ncnn3MatESaIS1_EE", !47, i64 0}
!49 = !{!"_ZTSN4ncnn5LayerE", !36, i64 8, !36, i64 9, !36, i64 10, !36, i64 11, !36, i64 12, !36, i64 13, !36, i64 14, !36, i64 15, !36, i64 16, !36, i64 17, !36, i64 18, !36, i64 19, !36, i64 20, !36, i64 21, !36, i64 22, !36, i64 23, !36, i64 24, !36, i64 25, !36, i64 26, !36, i64 27, !22, i64 28, !27, i64 32, !22, i64 40, !39, i64 48, !39, i64 80, !43, i64 112, !43, i64 136, !48, i64 160, !48, i64 184}
!50 = !{!"float", !21, i64 0}
!51 = !{!"_ZTSN4ncnn11ConvolutionE", !49, i64 0, !22, i64 208, !22, i64 212, !22, i64 216, !22, i64 220, !22, i64 224, !22, i64 228, !22, i64 232, !22, i64 236, !22, i64 240, !22, i64 244, !22, i64 248, !50, i64 252, !22, i64 256, !22, i64 260, !22, i64 264, !22, i64 268, !31, i64 272, !22, i64 344, !31, i64 352, !31, i64 424, !31, i64 496, !31, i64 568, !31, i64 640}
!52 = !{!51, !22, i64 268}
!53 = !{!50, !50, i64 0}
!54 = !{!"p1 _ZTSN4ncnn5LayerE", !27, i64 0}
!55 = !{!"_ZTSN4ncnn15Convolution_x86E", !51, i64 0, !54, i64 712, !22, i64 720, !31, i64 728, !31, i64 800, !31, i64 872, !31, i64 944, !31, i64 1016, !54, i64 1088, !31, i64 1096}
!56 = !{!55, !54, i64 712}
!57 = !{!"_ZTSN4ncnn6OptionE", !36, i64 0, !36, i64 1, !36, i64 2, !36, i64 3, !22, i64 4, !30, i64 8, !30, i64 16, !22, i64 24, !36, i64 28, !36, i64 29, !36, i64 30, !36, i64 31, !36, i64 32, !36, i64 33, !36, i64 34, !36, i64 35, !36, i64 36, !36, i64 37, !36, i64 38, !36, i64 39, !22, i64 40, !36, i64 44, !36, i64 45, !36, i64 46, !36, i64 47, !21, i64 48, !36, i64 49, !36, i64 50, !36, i64 51, !36, i64 52, !36, i64 53, !36, i64 54, !36, i64 55, !36, i64 56, !36, i64 57, !36, i64 58, !36, i64 59, !36, i64 60, !36, i64 61, !36, i64 62, !36, i64 63}
!58 = !{!57, !22, i64 4}
!59 = !{!55, !22, i64 720}
!60 = !{!57, !36, i64 30}
!61 = !{i8 0, i8 2}
...
!100 = !{!57, !30, i64 16}
!101 = !{!57, !30, i64 8}
!102 = !{!"p1 _ZTS8_IO_FILE", !27, i64 0}
!103 = !{!102, !102, i64 0}
!104 = !{!29, !29, i64 0}
!105 = !{!28, !28, i64 0}
!106 = !{!"p1 float", !27, i64 0}
!107 = !{!106, !106, i64 0}
!108 = !{!21, !21, i64 0}
!109 = !{!"short", !21, i64 0}
!110 = !{!109, !109, i64 0}
