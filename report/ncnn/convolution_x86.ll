...
scalar.ph.prol.loopexit:                          ; preds = %scalar.ph.prol, %scalar.ph.preheader
  ...
  %i.um = icmp ugt i32 %i.ul, -8
  br i1 %i.um, label %._crit_edge.i53, label %scalar.ph

scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  %.029.i = phi i32 [ %i.vl, %scalar.ph ], [ %.029.i.unr, %scalar.ph.prol.loopexit ]
  %.06328.i = phi ptr [ %i.vj, %scalar.ph ], [ %.06328.i.unr, %scalar.ph.prol.loopexit ] ; 9 uses
  %.527.i = phi ptr [ %i.vk, %scalar.ph ], [ %.527.i.unr, %scalar.ph.prol.loopexit ] ; 9 uses
  %i.un = load float, ptr %.06328.i, align 4, !tbaa !39
  store float %i.un, ptr %.527.i, align 4, !tbaa !39
  %i.uo = getelementptr inbounds nuw i8, ptr %.06328.i, i64 64
  %i.up = getelementptr inbounds nuw i8, ptr %.527.i, i64 4
  %i.uq = load float, ptr %i.uo, align 4, !tbaa !39
  store float %i.uq, ptr %i.up, align 4, !tbaa !39
  %i.ur = getelementptr inbounds nuw i8, ptr %.06328.i, i64 128
  %i.us = getelementptr inbounds nuw i8, ptr %.527.i, i64 8
  %i.ut = load float, ptr %i.ur, align 4, !tbaa !39
  store float %i.ut, ptr %i.us, align 4, !tbaa !39
  %i.uu = getelementptr inbounds nuw i8, ptr %.06328.i, i64 192
  %i.uv = getelementptr inbounds nuw i8, ptr %.527.i, i64 12
  %i.uw = load float, ptr %i.uu, align 4, !tbaa !39
  store float %i.uw, ptr %i.uv, align 4, !tbaa !39
  %i.ux = getelementptr inbounds nuw i8, ptr %.06328.i, i64 256
  %i.uy = getelementptr inbounds nuw i8, ptr %.527.i, i64 16
  %i.uz = load float, ptr %i.ux, align 4, !tbaa !39
  store float %i.uz, ptr %i.uy, align 4, !tbaa !39
  %i.va = getelementptr inbounds nuw i8, ptr %.06328.i, i64 320
  %i.vb = getelementptr inbounds nuw i8, ptr %.527.i, i64 20
  %i.vc = load float, ptr %i.va, align 4, !tbaa !39
  store float %i.vc, ptr %i.vb, align 4, !tbaa !39
  %i.vd = getelementptr inbounds nuw i8, ptr %.06328.i, i64 384
  %i.ve = getelementptr inbounds nuw i8, ptr %.527.i, i64 24
  %i.vf = load float, ptr %i.vd, align 4, !tbaa !39
  store float %i.vf, ptr %i.ve, align 4, !tbaa !39
  %i.vg = getelementptr inbounds nuw i8, ptr %.06328.i, i64 448
  %i.vh = getelementptr inbounds nuw i8, ptr %.527.i, i64 28
...
._crit_edge.i:                                    ; preds = %.lr.ph104.i.prol.loopexit, %.lr.ph104.i, %middle.block, %.preheader.i
  ...
  %indvars.iv.next150.i = add nsw i64 %indvars.iv149.i, 1 ; 2 uses
...
._crit_edge.us147.i:                              ; preds = %bb.dz
  %indvars.iv.next199.i = add nsw i64 %indvars.iv198.i, 1 ; 2 uses
...
._crit_edge.us191.i:                              ; preds = %bb.bp
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #12
  %indvars.iv.next249.i = add nsw i64 %indvars.iv248.i, 1 ; 2 uses
...
._crit_edge.us563.i:                              ; preds = %bb.bl
  %indvars.iv.next615.i = add nsw i64 %indvars.iv614.i, 1 ; 2 uses
...
._crit_edge.us1398.i:                             ; preds = %bb.du
  %indvars.iv.next1453.i = add nsw i64 %indvars.iv1452.i, 1 ; 2 uses
...
._crit_edge.us2550.i:                             ; preds = %bb.dd
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #12
  %indvars.iv.next2608.i = add nsw i64 %indvars.iv2607.i, 1 ; 2 uses
