...
.lr.ph217.i.i:                                    ; preds = %.preheader153.i.i
  ...
  %19 = lshr i32 %.sroa.speculated, 2             ; 3 uses
  ...
  %20 = icmp eq i32 %19, 1
  %i.md = and i32 %19, 536870910
  %unroll_iter196 = and i32 %.sroa.speculated, 4
  %lcmp.mod193.not = icmp eq i32 %unroll_iter196, 0
...
.lr.ph232.i.i:                                    ; preds = %.preheader.i.i
  ...
  %21 = lshr i32 %.sroa.speculated, 2             ; 3 uses
...
.lr.ph208.i.i:                                    ; preds = %.lr.ph208.preheader.i.i, %.lr.ph208.i.i
  ...
  %niter197.ncmp.1 = icmp eq i32 %niter197.next.1, %i.md
...
.lr.ph191.i.i:                                    ; preds = %.preheader122.i.i
  ...
  %19 = icmp eq i32 %18, 1
  %i.ko = and i32 %18, 268435454
  %unroll_iter421 = and i32 %.sroa.speculated, 8
  %lcmp.mod418.not = icmp eq i32 %unroll_iter421, 0
...
.lr.ph175.i.i:                                    ; preds = %.lr.ph175.preheader.i.i, %.lr.ph175.i.i
  ...
  %niter422.ncmp.1 = icmp eq i32 %niter422.next.1, %i.ko
...
.lr.ph196.i.i:                                    ; preds = %.preheader.i.i
  ...
  %18 = lshr i32 %.sroa.speculated, 2             ; 3 uses
