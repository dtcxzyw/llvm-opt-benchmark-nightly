...
bb.bc:                                            ; preds = %_ZN4ncnn3MatD2Ev.exit.us.i
  ...
  %18 = fsub fast float %.sroa.0.12.vec.extract, %i.bjj
  %19 = fadd fast float %i.bjj, %.sroa.0.12.vec.extract
  %20 = insertelement <2 x float> poison, float %19, i64 0
  %21 = insertelement <2 x float> %20, float %18, i64 1
  %22 = shufflevector <2 x float> %21, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %23 = fmul fast <4 x float> %22, <float 2.000000e+00, float f0x3FB504F3, float 1.000000e+00, float f0x403504F3>
  %i.bng = fadd fast <4 x float> %i.bnf, %23      ; 18 uses
...
bb.bu:                                            ; preds = %bb.bt
  ...
  %24 = fsub fast float %.sroa.14.36.vec.extract, %.sroa.14.40.vec.extract
  %25 = fadd fast float %.sroa.14.40.vec.extract, %.sroa.14.36.vec.extract
  ...
  %29 = fmul fast <4 x float> %28, <float 2.000000e+00, float f0x3FB504F3, float 1.000000e+00, float f0x403504F3>
  %i.bsi = fadd fast <4 x float> %i.bsh, %29      ; 18 uses
...
bb.cm:                                            ; preds = %bb.cl
  ...
  %30 = fsub fast float %.sroa.19.60.vec.extract, %.sroa.19.64.vec.extract
  %31 = fadd fast float %.sroa.19.64.vec.extract, %.sroa.19.60.vec.extract
  ...
  %35 = fmul fast <4 x float> %34, <float 2.000000e+00, float f0x3FB504F3, float 1.000000e+00, float f0x403504F3>
  %i.bxk = fadd fast <4 x float> %i.bxj, %35      ; 18 uses
...
bb.de:                                            ; preds = %bb.dd
  ...
  %36 = fsub fast float %.sroa.26.84.vec.extract, %i.bll
  %37 = fadd fast float %i.bll, %.sroa.26.84.vec.extract
  ...
  %41 = fmul fast <4 x float> %40, <float 2.000000e+00, float f0x3FB504F3, float 1.000000e+00, float f0x403504F3>
  %i.ccl = fadd fast <4 x float> %i.cck, %41      ; 18 uses
