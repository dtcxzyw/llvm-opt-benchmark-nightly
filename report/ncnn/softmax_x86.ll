...
.lr.ph.i43:                                       ; preds = %bb.l, %.lr.ph.i43
  ...
  %i.xi = fadd fast <4 x float> %i.wv, %i.xh
  %i.xj = fadd fast <4 x float> %i.xi, splat (float 1.000000e+00)
...
.lr.ph.i43:                                       ; preds = %bb.j, %.lr.ph.i43
  ...
  %i.mb = fadd fast <4 x float> %i.lo, %i.ma
...
.lr.ph.i43.i:                                     ; preds = %bb.f, %.lr.ph.i43.i
  ...
  %i.iu = fadd fast <4 x float> %i.ih, %i.it
  %i.iv = fadd fast <4 x float> %i.iu, splat (float 1.000000e+00)
