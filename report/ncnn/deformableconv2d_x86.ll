...
begin_hunk_1_@_ZN4ncnnL23deformableconv2d_packedERKSt6vectorINS_3MatESaIS1_EERS1_RKS1_S8_iiiiiiiiiS8_RKNS_6OptionE.omp_outlined:bb.a
  %.5254638.us.us = phi ptr [ %.4253.us, %.lr.ph641.split.us.us.preheader ], [ %i.me, %bb.ac ] ; 2 uses
  br i1 %.0236.us, label %bb.v, label %bb.w

bb.v:                                             ; preds = %.lr.ph641.split.us.us
  %i.li = getelementptr inbounds nuw [4 x i8], ptr %i.kv, i64 %indvars.iv704
  %i.lj = load float, ptr %i.li, align 4, !tbaa !38
  %i.lk = fmul fast float %i.lj, %.0240.us
  br label %bb.w

bb.w:                                             ; preds = %bb.v, %.lr.ph641.split.us.us
  %i.ll = phi float [ %i.lk, %bb.v ], [ 0.000000e+00, %.lr.ph641.split.us.us ] ; 2 uses
  br i1 %.0235.us, label %bb.x, label %bb.y

bb.x:                                             ; preds = %bb.w
  %i.lm = getelementptr inbounds nuw [4 x i8], ptr %i.ky, i64 %indvars.iv704
  %i.ln = load float, ptr %i.lm, align 4, !tbaa !38
  %i.lo = fmul fast float %i.ln, %.0239.us
  %i.lp = fadd fast float %i.lo, %i.ll
  br label %bb.y

bb.y:                                             ; preds = %bb.x, %bb.w
  %i.lq = phi float [ %i.lp, %bb.x ], [ %i.ll, %bb.w ] ; 2 uses
  br i1 %.0234.us, label %bb.z, label %bb.aa

bb.z:                                             ; preds = %bb.y
  %i.lr = getelementptr inbounds nuw [4 x i8], ptr %i.lb, i64 %indvars.iv704
  %i.ls = load float, ptr %i.lr, align 4, !tbaa !38
  %i.lt = fmul fast float %i.ls, %.0238.us
  %i.lu = fadd fast float %i.lt, %i.lq
  br label %bb.aa

bb.aa:                                            ; preds = %bb.z, %bb.y
  %i.lv = phi float [ %i.lu, %bb.z ], [ %i.lq, %bb.y ] ; 2 uses
  br i1 %.0233.us, label %bb.ab, label %bb.ac

bb.ab:                                            ; preds = %bb.aa
  %i.lw = getelementptr inbounds nuw [4 x i8], ptr %i.le, i64 %indvars.iv704
  %i.lx = load float, ptr %i.lw, align 4, !tbaa !38
  %i.ly = fmul fast float %i.lx, %.0237.us
  %i.lz = fadd fast float %i.ly, %i.lv
  br label %bb.ac

bb.ac:                                            ; preds = %bb.ab, %bb.aa
  %.0.us.us = phi nsz float [ %i.lv, %bb.aa ], [ %i.lz, %bb.ab ] ; 2 uses
  %i.ma = fmul fast float %.0.us.us, %.1242.us
  %.1.us.us = select nsz i1 %i.bw, float %i.ma, float %.0.us.us
  %i.mb = load float, ptr %.5254638.us.us, align 4, !tbaa !38
  %i.mc = fmul fast float %.1.us.us, %i.mb
  %i.md = fadd fast float %i.mc, %.4639.us.us     ; 2 uses
  %i.me = getelementptr inbounds nuw i8, ptr %.5254638.us.us, i64 4
  %indvars.iv.next705 = add nuw nsw i64 %indvars.iv704, 1 ; 2 uses
  %exitcond710.not = icmp eq i64 %indvars.iv.next705, %wide.trip.count709
  br i1 %exitcond710.not, label %.loopexit.us.loopexit, label %.lr.ph641.split.us.us, !llvm.loop !151
...
_ZN4ncnn3MatD2Ev.exit.lr.ph.us:                   ; preds = %.thread626.us
  ...
  %i.mk = insertelement <4 x float> poison, float %.1242.us, i64 0
...
._crit_edge657.us:                                ; preds = %._crit_edge.us
  ...
  br i1 %exitcond725.not, label %._crit_edge665, label %.preheader631.us, !llvm.loop !155

._crit_edge665:                                   ; preds = %._crit_edge657.us, %.preheader631.lr.ph, %bb.e
  %.2620.lcssa = phi <4 x float> [ %.1619, %bb.e ], [ %.1619, %.preheader631.lr.ph ], [ %.4622.lcssa.us, %._crit_edge657.us ] ; 10 uses
  %.1248.lcssa = phi float [ %.0247, %bb.e ], [ %.0247, %.preheader631.lr.ph ], [ %.3.lcssa.us, %._crit_edge657.us ] ; 13 uses
  %i.mn = load i32, ptr %12, align 4, !tbaa !67   ; 2 uses
  %i.mo = icmp eq i32 %i.mn, 4
  br i1 %i.mo, label %bb.ad, label %bb.ah

bb.ad:                                            ; preds = %._crit_edge665
...
.noexc336:                                        ; preds = %bb.ad
  ...
  %i.qk = fmul fast <4 x float> %i.qj, %i.qj
  ...
  %i.rb = fmul fast <4 x float> %i.ra, %i.qj
  %i.rc = fmul fast <4 x float> %i.qi, splat (float f0x3F317218)
  %reass.add630 = fadd fast <4 x float> %i.rb, splat (float -5.000000e-01)
  %reass.mul = fmul fast <4 x float> %i.qk, %reass.add630
  %i.rd = fadd fast <4 x float> %i.rc, %i.qj
  %i.re = fadd fast <4 x float> %i.rd, %reass.mul
  %.neg = fmul fast <4 x float> %i.re, splat (float -2.000000e+00)
  %i.rf = select fast <4 x i1> %i.pv, <4 x float> splat (float +nan(0x3FFFFF)), <4 x float> %.neg
  %i.rg = call fast noundef nofpclass(nan inf) <4 x float> @llvm.x86.sse.min.ps(<4 x float> nofpclass(nan inf) %i.rf, <4 x float> splat (float f0x42B0C0A5))
  %i.rh = call fast noundef nofpclass(nan inf) <4 x float> @llvm.x86.sse.max.ps(<4 x float> nofpclass(nan inf) %i.rg, <4 x float> splat (float f0xC2B0C0A5)) ; 2 uses
  %i.ri = fmul fast <4 x float> %i.rh, splat (float f0x3FB8AA3B)
  %i.rj = fadd fast <4 x float> %i.ri, splat (float 5.000000e-01) ; 2 uses
  %i.rk = call <4 x i32> @llvm.x86.sse2.cvttps2dq(<4 x float> nofpclass(nan inf) %i.rj)
  %i.rl = sitofp fast <4 x i32> %i.rk to <4 x float> ; 2 uses
  %i.rm = fcmp fast olt <4 x float> %i.rj, %i.rl
  %i.rn = select <4 x i1> %i.rm, <4 x float> splat (float 1.000000e+00), <4 x float> zeroinitializer
  %i.ro = fsub fast <4 x float> %i.rl, %i.rn      ; 2 uses
  %i.rp = fmul fast <4 x float> %i.ro, splat (float f0x3F317218)
  %i.rq = fsub fast <4 x float> %i.rh, %i.rp      ; 8 uses
  %i.rr = fmul fast <4 x float> %i.rq, %i.rq
  %i.rs = fmul fast <4 x float> %i.rq, splat (float f0x39506967)
  %i.rt = fadd fast <4 x float> %i.rs, splat (float f0x3AB743CE)
  %i.ru = fmul fast <4 x float> %i.rt, %i.rq
  %i.rv = fadd fast <4 x float> %i.ru, splat (float f0x3C088908)
  %i.rw = fmul fast <4 x float> %i.rv, %i.rq
  %i.rx = fadd fast <4 x float> %i.rw, splat (float f0x3D2AA9C1)
  %i.ry = fmul fast <4 x float> %i.rx, %i.rq
  %i.rz = fadd fast <4 x float> %i.ry, splat (float f0x3E2AAAAA)
  %i.sa = fmul fast <4 x float> %i.rz, %i.rq
  %i.sb = fadd fast <4 x float> %i.sa, splat (float 5.000000e-01)
  %i.sc = fmul fast <4 x float> %i.rr, %i.sb
  %i.sd = fadd fast <4 x float> %i.rq, %i.sc
  %i.se = fadd fast <4 x float> %i.sd, splat (float 1.000000e+00)
  %i.sf = call <4 x i32> @llvm.x86.sse2.cvttps2dq(<4 x float> nofpclass(nan inf) %i.ro)
  %i.sg = shl <4 x i32> %i.sf, splat (i32 23)
  %i.sh = add <4 x i32> %i.sg, splat (i32 1065353216)
  %i.si = bitcast <4 x i32> %i.sh to <4 x float>
  %i.sj = fmul fast <4 x float> %i.se, %i.si
  %i.sk = fadd fast <4 x float> %i.sj, splat (float 1.000000e+00)
  %i.sl = fdiv fast <4 x float> splat (float 2.000000e+00), %i.sk
  %i.sm = fadd fast <4 x float> %i.sl, splat (float -1.000000e+00)
  %i.sn = fmul fast <4 x float> %i.sm, %.2620.lcssa
  br label %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit

bb.ag:                                            ; preds = %bb.ad
  %i.so = load ptr, ptr %28, align 8, !tbaa !18   ; 2 uses
  %i.sp = load float, ptr %i.so, align 4, !tbaa !38
  ...
  %i.ss = getelementptr inbounds nuw i8, ptr %i.so, i64 4
  %i.st = load float, ptr %i.ss, align 4, !tbaa !38
  ...
  %i.sw = fmul fast <4 x float> %i.sr, %.2620.lcssa
  %i.sx = fadd fast <4 x float> %i.sw, %i.sv
  %i.sy = call fast noundef nofpclass(nan inf) <4 x float> @llvm.x86.sse.max.ps(<4 x float> nofpclass(nan inf) %i.sx, <4 x float> zeroinitializer)
  %i.sz = call fast noundef nofpclass(nan inf) <4 x float> @llvm.x86.sse.min.ps(<4 x float> nofpclass(nan inf) %i.sy, <4 x float> splat (float 1.000000e+00))
  %i.ta = fmul fast <4 x float> %i.sz, %.2620.lcssa
  br label %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit

_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit:      ; preds = %bb.ag, %.noexc336, %.noexc335, %bb.af, %.noexc334, %bb.ae, %bb.ad
  %.0.i = phi nsz <4 x float> [ %i.ta, %bb.ag ], [ %i.mq, %bb.ae ], [ %i.my, %.noexc334 ], [ %i.ni, %bb.af ], [ %i.op, %.noexc335 ], [ %i.sn, %.noexc336 ], [ %.2620.lcssa, %bb.ad ]
  %i.tb = load i32, ptr %3, align 4, !tbaa !67
  %i.tc = mul nsw i32 %i.tb, %i.ae
  %i.td = add nsw i32 %i.tc, %i.aj
  %i.te = shl nsw i32 %i.td, 2
  %i.tf = sext i32 %i.te to i64
  %i.tg = getelementptr inbounds [4 x i8], ptr %i.bi, i64 %i.tf
  store <4 x float> %.0.i, ptr %i.tg, align 16, !tbaa !91
  %.pr = load i32, ptr %12, align 4, !tbaa !67
  br label %bb.ah

bb.ah:                                            ; preds = %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit, %._crit_edge665
  %i.th = phi i32 [ %.pr, %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit ], [ %i.mn, %._crit_edge665 ]
  %i.ti = icmp eq i32 %i.th, 1
  br i1 %i.ti, label %bb.ai, label %bb.as

bb.ai:                                            ; preds = %bb.ah
  %i.tj = load i32, ptr %27, align 4, !tbaa !67
  switch i32 %i.tj, label %_ZL13activation_ssfiRKN4ncnn3MatE.exit [
    i32 1, label %bb.aj
    i32 2, label %bb.ak
    i32 3, label %bb.al
    i32 4, label %bb.an
...
bb.aj:                                            ; preds = %bb.ai
  %i.tk = call fast float @llvm.maxnum.f32(float nofpclass(nan inf) %.1248.lcssa, float 0.000000e+00)
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit

bb.ak:                                            ; preds = %bb.ai
  %i.tl = load ptr, ptr %28, align 8, !tbaa !18
  %i.tm = load float, ptr %i.tl, align 4, !tbaa !38
  %i.tn = fcmp fast ogt float %.1248.lcssa, 0.000000e+00
  %i.to = select fast i1 %i.tn, float 1.000000e+00, float %i.tm
  %i.tp = fmul fast float %i.to, %.1248.lcssa
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit

bb.al:                                            ; preds = %bb.ai
  %i.tq = load ptr, ptr %28, align 8, !tbaa !18   ; 2 uses
  %i.tr = load float, ptr %i.tq, align 4, !tbaa !38
  %i.ts = getelementptr inbounds nuw i8, ptr %i.tq, i64 4
  %i.tt = load float, ptr %i.ts, align 4, !tbaa !38 ; 2 uses
  %.0616 = call nnan ninf nsz float @llvm.maxnum.f32(float %.1248.lcssa, float %i.tr) ; 2 uses
  %i.tu = fcmp fast ogt float %.0616, %i.tt
  br i1 %i.tu, label %bb.am, label %_ZL13activation_ssfiRKN4ncnn3MatE.exit

bb.am:                                            ; preds = %bb.al
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit

bb.an:                                            ; preds = %bb.ai
  %.sroa.speculated503 = call nnan ninf nsz float @llvm.minnum.f32(float %.1248.lcssa, float f0x42B0C0A5)
  %.sroa.speculated = call nnan ninf nsz float @llvm.maxnum.f32(float %.sroa.speculated503, float f0xC2B0C0A5)
  %i.tv = fneg fast float %.sroa.speculated
  %i.tw = call fast float @llvm.exp.f32(float %i.tv)
  %i.tx = fadd fast float %i.tw, 1.000000e+00
  %i.ty = fdiv fast float 1.000000e+00, %i.tx
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit

bb.ao:                                            ; preds = %bb.ai
  %i.tz = call fast float @llvm.exp.f32(float nofpclass(nan inf) %.1248.lcssa)
  %i.ua = fadd fast float %i.tz, 1.000000e+00
  %i.ub = call fast float @llvm.log.f32(float %i.ua)
  %i.uc = call fast float @llvm.tanh.f32(float %i.ub)
  %i.ud = fmul fast float %i.uc, %.1248.lcssa
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit

bb.ap:                                            ; preds = %bb.ai
  %i.ue = load ptr, ptr %28, align 8, !tbaa !18   ; 2 uses
  %i.uf = load float, ptr %i.ue, align 4, !tbaa !38 ; 3 uses
  %i.ug = getelementptr inbounds nuw i8, ptr %i.ue, i64 4
  %i.uh = load float, ptr %i.ug, align 4, !tbaa !38 ; 2 uses
  %i.ui = fneg fast float %i.uh
  %i.uj = fdiv fast float %i.ui, %i.uf            ; 2 uses
  %i.uk = fcmp fast olt float %.1248.lcssa, %i.uj
  br i1 %i.uk, label %_ZL13activation_ssfiRKN4ncnn3MatE.exit, label %bb.aq

bb.aq:                                            ; preds = %bb.ap
  %i.ul = fdiv fast float 1.000000e+00, %i.uf
  %i.um = fadd fast float %i.uj, %i.ul
  %i.un = fcmp fast ogt float %.1248.lcssa, %i.um
  br i1 %i.un, label %_ZL13activation_ssfiRKN4ncnn3MatE.exit, label %bb.ar

bb.ar:                                            ; preds = %bb.aq
  %i.uo = fmul fast float %i.uf, %.1248.lcssa
  %i.up = fadd fast float %i.uo, %i.uh
  %i.uq = fmul fast float %i.up, %.1248.lcssa
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit

_ZL13activation_ssfiRKN4ncnn3MatE.exit:           ; preds = %bb.ar, %bb.aq, %bb.ao, %bb.an, %bb.am, %bb.al, %bb.ak, %bb.aj, %bb.ai, %bb.ap
  %.1617 = phi nsz float [ %.1248.lcssa, %bb.ai ], [ %i.tk, %bb.aj ], [ %i.tp, %bb.ak ], [ %i.tt, %bb.am ], [ %.0616, %bb.al ], [ %i.ty, %bb.an ], [ %i.ud, %bb.ao ], [ %i.uq, %bb.ar ], [ %.1248.lcssa, %bb.aq ], [ 0.000000e+00, %bb.ap ]
  %i.ur = load i32, ptr %3, align 4, !tbaa !67
  %i.us = sext i32 %i.ur to i64
  %i.ut = mul nsw i64 %indvars.iv732, %i.us
  %i.uu = getelementptr inbounds [4 x i8], ptr %i.bi, i64 %i.ut
  %i.uv = getelementptr inbounds nuw [4 x i8], ptr %i.uu, i64 %indvars.iv729
  store float %.1617, ptr %i.uv, align 4, !tbaa !38
  br label %bb.as

bb.as:                                            ; preds = %_ZL13activation_ssfiRKN4ncnn3MatE.exit, %bb.ah
  %indvars.iv.next727 = add nuw nsw i64 %indvars.iv726, 1 ; 2 uses
  %i.uw = load i32, ptr %8, align 4, !tbaa !67    ; 2 uses
  %i.ux = sext i32 %i.uw to i64
  %i.uy = icmp slt i64 %indvars.iv.next727, %i.ux
  br i1 %i.uy, label %.noexc326, label %._crit_edge.loopexit, !llvm.loop !156

._crit_edge687:                                   ; preds = %._crit_edge683, %.preheader632.lr.ph, %bb.b
  call void @__kmpc_for_static_fini(ptr nonnull @1, i32 %i.h)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d) #9
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #9
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #9
...
bb.at:                                            ; preds = %._crit_edge687, %bb.a
  ret void
}
