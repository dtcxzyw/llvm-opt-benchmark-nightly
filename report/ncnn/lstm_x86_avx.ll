...
bb.c:                                             ; preds = %.lr.ph, %bb.e
  ...
  %i.bk = fadd fast <4 x float> %i.ax, %i.bj
  ...
  %i.cq = fadd fast <4 x float> %i.cd, %i.cp
  ...
  %i.dw = fadd fast <4 x float> %i.dj, %i.dv
  ...
  %i.fc = fadd fast <4 x float> %i.ep, %i.fb
  ...
  %i.gq = fadd fast <4 x float> %i.gd, %i.gp
...
._crit_edge326:                                   ; preds = %.lr.ph325.prol.loopexit, %.lr.ph325, %.preheader
  ...
  %i.nf = fadd fast <4 x float> %i.ne, %i.mz
