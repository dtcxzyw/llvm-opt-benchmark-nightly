...
bb.a:
  ...
  %i.x = mul nsw i32 %i.w, %i.u                   ; 6 uses
...
._crit_edge3510:                                  ; preds = %.loopexit2846, %._crit_edge3476
  ...
  %.21362.lcssa = phi i32 [ %.11361.lcssa, %._crit_edge3476 ], [ %i.dxs, %.loopexit2846 ] ; 6 uses
...
._crit_edge3755:                                  ; preds = %_ZL13activation_ssfiRKN4ncnn3MatE.exit
  ...
  %16 = icmp slt i64 %indvars.iv.next4194, %i.ddh
  br i1 %16, label %.lr.ph3754, label %._crit_edge3765.split, !llvm.loop !99
...
._crit_edge3699:                                  ; preds = %.loopexit, %._crit_edge3671
  ...
  %.21263.lcssa = phi i32 [ %.11262.lcssa, %._crit_edge3671 ], [ %i.eym, %.loopexit ] ; 6 uses
...
.lr.ph3720.split.preheader:                       ; preds = %.lr.ph3720
  ...
  %17 = add i32 %.21263.lcssa, 3
  %smax4175 = call i32 @llvm.smax.i32(i32 %i.n, i32 %17)
  %18 = add i32 %smax4175, -2
  %i.eze = sub i32 %18, %.21263.lcssa
