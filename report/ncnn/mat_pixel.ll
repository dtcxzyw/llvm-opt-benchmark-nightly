...
vector.body360:                                   ; preds = %vector.body360, %vector.ph358
  ...
  %4 = fptosi <4 x float> %wide.load368 to <4 x i32>
  %5 = tail call <4 x i32> @llvm.smax.v4i32(<4 x i32> %4, <4 x i32> zeroinitializer)
  %6 = tail call <4 x i32> @llvm.umin.v4i32(<4 x i32> %5, <4 x i32> splat (i32 255))
  %7 = trunc nuw <4 x i32> %6 to <4 x i8>
  %8 = shufflevector <4 x float> %wide.load366, <4 x float> %wide.load367, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %9 = fptosi <8 x float> %8 to <8 x i32>
  %10 = tail call <8 x i32> @llvm.smax.v8i32(<8 x i32> %9, <8 x i32> zeroinitializer)
  %i.cx = tail call <8 x i32> @llvm.umin.v8i32(<8 x i32> %10, <8 x i32> splat (i32 255))
  %i.cy = trunc nuw <8 x i32> %i.cx to <8 x i8>
  %i.cz = shufflevector <4 x i8> %7, <4 x i8> splat (i8 -1), <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
...
vector.body322:                                   ; preds = %vector.body322, %vector.ph320
  ...
  %11 = fptosi <4 x float> %wide.load330 to <4 x i32>
  %12 = tail call <4 x i32> @llvm.smax.v4i32(<4 x i32> %11, <4 x i32> zeroinitializer)
  %13 = tail call <4 x i32> @llvm.umin.v4i32(<4 x i32> %12, <4 x i32> splat (i32 255))
  %14 = trunc nuw <4 x i32> %13 to <4 x i8>
  %15 = shufflevector <4 x float> %wide.load328, <4 x float> %wide.load329, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %16 = fptosi <8 x float> %15 to <8 x i32>
  %17 = tail call <8 x i32> @llvm.smax.v8i32(<8 x i32> %16, <8 x i32> zeroinitializer)
  %i.fd = tail call <8 x i32> @llvm.umin.v8i32(<8 x i32> %17, <8 x i32> splat (i32 255))
  %i.fe = trunc nuw <8 x i32> %i.fd to <8 x i8>
  %i.ff = shufflevector <4 x i8> %14, <4 x i8> splat (i8 -1), <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x float>, ptr %next.gep290, align 4, !tbaa !23, !alias.scope !385
  %wide.load294 = load <4 x float>, ptr %next.gep291, align 4, !tbaa !23, !alias.scope !386
  %wide.load295.a = load <4 x float>, ptr %next.gep292, align 4, !tbaa !23, !alias.scope !387
  %wide.load296.a = load <4 x float>, ptr %next.gep, align 4, !tbaa !23, !alias.scope !388
  %i.jb = shufflevector <4 x float> %wide.load, <4 x float> %wide.load294, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.jc = fptosi <8 x float> %i.jb to <8 x i32>
  %i.jd = tail call <8 x i32> @llvm.smax.v8i32(<8 x i32> %i.jc, <8 x i32> zeroinitializer)
  %18 = tail call <8 x i32> @llvm.umin.v8i32(<8 x i32> %i.jd, <8 x i32> splat (i32 255))
  %19 = trunc nuw <8 x i32> %18 to <8 x i8>
  %i.je = shufflevector <4 x float> %wide.load295.a, <4 x float> %wide.load296.a, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.jf = fptosi <8 x float> %i.je to <8 x i32>
  %i.jg = tail call <8 x i32> @llvm.smax.v8i32(<8 x i32> %i.jf, <8 x i32> zeroinitializer)
  %i.jh = tail call <8 x i32> @llvm.umin.v8i32(<8 x i32> %i.jg, <8 x i32> splat (i32 255))
...
vector.body436:                                   ; preds = %vector.body436, %vector.ph434
  ...
  %20 = fptosi <4 x float> %wide.load444 to <4 x i32>
  %21 = tail call <4 x i32> @llvm.smax.v4i32(<4 x i32> %20, <4 x i32> zeroinitializer)
  %22 = tail call <4 x i32> @llvm.umin.v4i32(<4 x i32> %21, <4 x i32> splat (i32 255))
  %23 = trunc nuw <4 x i32> %22 to <4 x i8>
  %24 = shufflevector <4 x float> %wide.load442, <4 x float> %wide.load443, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %25 = fptosi <8 x float> %24 to <8 x i32>
  %26 = tail call <8 x i32> @llvm.smax.v8i32(<8 x i32> %25, <8 x i32> zeroinitializer)
  %i.lx = tail call <8 x i32> @llvm.umin.v8i32(<8 x i32> %26, <8 x i32> splat (i32 255))
  %i.ly = trunc nuw <8 x i32> %i.lx to <8 x i8>
  %i.lz = shufflevector <4 x i8> %23, <4 x i8> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
...
vector.body501:                                   ; preds = %vector.body501, %vector.ph499
  ...
  %wide.load508 = load <4 x float>, ptr %next.gep506, align 4, !tbaa !23, !alias.scope !402
  %wide.load509 = load <4 x float>, ptr %next.gep505, align 4, !tbaa !23, !alias.scope !403
  %wide.load510.a = load <4 x float>, ptr %next.gep504, align 4, !tbaa !23, !alias.scope !404
  %wide.load511.a = load <4 x float>, ptr %next.gep503, align 4, !tbaa !23, !alias.scope !405
  %i.px = shufflevector <4 x float> %wide.load508, <4 x float> %wide.load509, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.py = fptosi <8 x float> %i.px to <8 x i32>
  %i.pz = tail call <8 x i32> @llvm.smax.v8i32(<8 x i32> %i.py, <8 x i32> zeroinitializer)
  %27 = tail call <8 x i32> @llvm.umin.v8i32(<8 x i32> %i.pz, <8 x i32> splat (i32 255))
  %28 = trunc nuw <8 x i32> %27 to <8 x i8>
  %i.qa = shufflevector <4 x float> %wide.load510.a, <4 x float> %wide.load511.a, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.qb = fptosi <8 x float> %i.qa to <8 x i32>
  %i.qc = tail call <8 x i32> @llvm.smax.v8i32(<8 x i32> %i.qb, <8 x i32> zeroinitializer)
  %i.qd = tail call <8 x i32> @llvm.umin.v8i32(<8 x i32> %i.qc, <8 x i32> splat (i32 255))
