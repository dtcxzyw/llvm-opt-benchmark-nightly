...
bb.ah:                                            ; preds = %bb.af, %bb.ag
  ...
  %i.yh = getelementptr inbounds nuw i8, ptr %.1510860, i64 4
  %i.yi = getelementptr inbounds nuw i8, ptr %.1508861, i64 4
  %i.yj = getelementptr inbounds nuw i8, ptr %.1506862, i64 4
  %i.yk = getelementptr inbounds nuw i8, ptr %.4864, i64 44
  %i.yl = add nuw nsw i32 %.1504863, 1            ; 2 uses
...
bb.ah:                                            ; preds = %bb.af, %bb.ag
  ...
  %i.yn = getelementptr inbounds nuw i8, ptr %.1510860, i64 4
  %i.yo = getelementptr inbounds nuw i8, ptr %.1508861, i64 4
  %i.yp = getelementptr inbounds nuw i8, ptr %.1506862, i64 4
  %i.yq = getelementptr inbounds nuw i8, ptr %.4864, i64 44
  %i.yr = add nuw nsw i32 %.1504863, 1            ; 2 uses
...
bb.ah:                                            ; preds = %bb.af, %bb.ag
  ...
  %i.zh = getelementptr inbounds nuw i8, ptr %.1510870, i64 4
  %i.zi = getelementptr inbounds nuw i8, ptr %.1508871, i64 4
  %i.zj = getelementptr inbounds nuw i8, ptr %.1506872, i64 4
  %i.zk = getelementptr inbounds nuw i8, ptr %.4874, i64 44
  %i.zl = add nuw nsw i32 %.1504873, 1            ; 2 uses
...
bb.ah:                                            ; preds = %bb.af, %bb.ag
  ...
  %i.zl = getelementptr inbounds nuw i8, ptr %.1510870, i64 4
  %i.zm = getelementptr inbounds nuw i8, ptr %.1508871, i64 4
  %i.zn = getelementptr inbounds nuw i8, ptr %.1506872, i64 4
  %i.zo = getelementptr inbounds nuw i8, ptr %.4874, i64 44
  %i.zp = add nuw nsw i32 %.1504873, 1            ; 2 uses
...
bb.ah:                                            ; preds = %bb.af, %bb.ag
  ...
  %i.abh = getelementptr inbounds nuw i8, ptr %.1510881, i64 4
  %i.abi = getelementptr inbounds nuw i8, ptr %.1508882, i64 4
  %i.abj = getelementptr inbounds nuw i8, ptr %.1506883, i64 4
  %i.abk = getelementptr inbounds nuw i8, ptr %.4885, i64 44
  %i.abl = add nuw nsw i32 %.1504884, 1           ; 2 uses
...
bb.ah:                                            ; preds = %bb.af, %bb.ag
  ...
  %i.aan = getelementptr inbounds nuw i8, ptr %.1510870, i64 4
  %i.aao = getelementptr inbounds nuw i8, ptr %.1508871, i64 4
  %i.aap = getelementptr inbounds nuw i8, ptr %.1506872, i64 4
  %i.aaq = getelementptr inbounds nuw i8, ptr %.4874, i64 44
  %i.aar = add nuw nsw i32 %.1504873, 1           ; 2 uses
...
.preheader:                                       ; preds = %.lr.ph335, %_ZN4ncnn3MatD2Ev.exit167
  %.0163.lcssa = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit167 ], [ %i.x, %.lr.ph335 ] ; 2 uses
  %.0161.lcssa = phi ptr [ %i.ad, %_ZN4ncnn3MatD2Ev.exit167 ], [ %i.cp, %.lr.ph335 ]
  %.1.lcssa = phi ptr [ %.0345, %_ZN4ncnn3MatD2Ev.exit167 ], [ %i.cq, %.lr.ph335 ] ; 2 uses
  %i.ae = icmp slt i32 %.0163.lcssa, %.fr368
...
.lr.ph335:                                        ; preds = %_ZN4ncnn3MatD2Ev.exit167, %.lr.ph335
  ...
  %.0161333 = phi ptr [ %i.cp, %.lr.ph335 ], [ %i.ad, %_ZN4ncnn3MatD2Ev.exit167 ] ; 4 uses
  %.0163332 = phi i32 [ %i.cr, %.lr.ph335 ], [ 0, %_ZN4ncnn3MatD2Ev.exit167 ] ; 2 uses
  %i.af = load <8 x float>, ptr %.0161333, align 1, !tbaa !63 ; 2 uses
  %i.ag = getelementptr inbounds nuw i8, ptr %.0161333, i64 32
  %i.ah = load <8 x float>, ptr %i.ag, align 1, !tbaa !63 ; 2 uses
  %i.ai = getelementptr inbounds nuw i8, ptr %.0161333, i64 64
  %i.aj = load <8 x float>, ptr %i.ai, align 1, !tbaa !63 ; 2 uses
  %i.ak = shufflevector <8 x float> %i.af, <8 x float> %i.ah, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 12, i32 13, i32 14, i32 15> ; 2 uses
  %i.al = shufflevector <8 x float> %i.af, <8 x float> %i.aj, <8 x i32> <i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11> ; 2 uses
  %i.am = shufflevector <8 x float> %i.ah, <8 x float> %i.aj, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 12, i32 13, i32 14, i32 15> ; 2 uses
  ...
  %i.cp = getelementptr inbounds nuw i8, ptr %.0161333, i64 96 ; 2 uses
  %i.cq = getelementptr inbounds nuw i8, ptr %.1334, i64 32 ; 2 uses
  %i.cr = add nuw nsw i32 %.0163332, 24
  %i.cs = add nuw nsw i32 %.0163332, 47
...
.lr.ph342:                                        ; preds = %.preheader, %bb.b
  ...
  %.1162340 = phi ptr [ %i.ef, %bb.b ], [ %.0161.lcssa, %.preheader ] ; 3 uses
  %.1164339 = phi i32 [ %i.eh, %bb.b ], [ %.0163.lcssa, %.preheader ]
  %i.cu = getelementptr inbounds nuw i8, ptr %.1162340, i64 8
  ...
  %i.db = load <2 x float>, ptr %.1162340, align 4, !tbaa !66
...
bb.b:                                             ; preds = %.lr.ph342, %bb.a
  ...
  %i.ef = getelementptr inbounds nuw i8, ptr %.1162340, i64 12
  %i.eg = getelementptr inbounds nuw i8, ptr %.2341, i64 4 ; 2 uses
  %i.eh = add nuw nsw i32 %.1164339, 3            ; 2 uses
...
.preheader315:                                    ; preds = %.preheader315.loopexit, %_ZN4ncnn3MatD2Ev.exit166
  %.0158.lcssa = phi ptr [ %i.em, %_ZN4ncnn3MatD2Ev.exit166 ], [ %i.hg, %.preheader315.loopexit ]
  %.0156.lcssa = phi ptr [ %i.es, %_ZN4ncnn3MatD2Ev.exit166 ], [ %i.hh, %.preheader315.loopexit ]
  %.0154.lcssa = phi ptr [ %i.ev, %_ZN4ncnn3MatD2Ev.exit166 ], [ %i.hi, %.preheader315.loopexit ]
  %.0152.lcssa = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit166 ], [ %i.fb, %.preheader315.loopexit ] ; 2 uses
  %.3.lcssa = phi ptr [ %i.i, %_ZN4ncnn3MatD2Ev.exit166 ], [ %i.hj, %.preheader315.loopexit ]
  %i.fc = icmp slt i32 %.0152.lcssa, %.fr368
...
bb.c:                                             ; preds = %.lr.ph, %bb.c
  ...
  %.0152320 = phi i32 [ 0, %.lr.ph ], [ %i.hk, %bb.c ]
  %.0154319 = phi ptr [ %i.ev, %.lr.ph ], [ %i.hi, %bb.c ] ; 2 uses
  %.0156318 = phi ptr [ %i.es, %.lr.ph ], [ %i.hh, %bb.c ] ; 2 uses
  %.0158317 = phi ptr [ %i.em, %.lr.ph ], [ %i.hg, %bb.c ] ; 2 uses
  %i.fg = load <8 x float>, ptr %.0158317, align 1, !tbaa !63
  %i.fh = load <8 x float>, ptr %.0156318, align 1, !tbaa !63
  %i.fi = load <8 x float>, ptr %.0154319, align 1, !tbaa !63
  ...
  %i.hg = getelementptr inbounds nuw i8, ptr %.0158317, i64 32 ; 2 uses
  %i.hh = getelementptr inbounds nuw i8, ptr %.0156318, i64 32 ; 2 uses
  %i.hi = getelementptr inbounds nuw i8, ptr %.0154319, i64 32 ; 2 uses
  %i.hj = getelementptr inbounds nuw i8, ptr %.3321, i64 32 ; 2 uses
  %i.hk = add nuw nsw i32 %.0152320, 8            ; 2 uses
...
bb.d:                                             ; preds = %.lr.ph331, %bb.f
  ...
  %.1153329 = phi i32 [ %.0152.lcssa, %.lr.ph331 ], [ %i.je, %bb.f ]
  %.1155328 = phi ptr [ %.0154.lcssa, %.lr.ph331 ], [ %i.jc, %bb.f ] ; 2 uses
  %.1157327 = phi ptr [ %.0156.lcssa, %.lr.ph331 ], [ %i.jb, %bb.f ] ; 2 uses
  %.1159326 = phi ptr [ %.0158.lcssa, %.lr.ph331 ], [ %i.ja, %bb.f ] ; 2 uses
  %i.hn = load float, ptr %.1159326, align 4, !tbaa !66
  %i.ho = load float, ptr %.1157327, align 4, !tbaa !66
  %i.hp = load float, ptr %.1155328, align 4, !tbaa !66
...
bb.f:                                             ; preds = %bb.d, %bb.e
  ...
  %i.ja = getelementptr inbounds nuw i8, ptr %.1159326, i64 4
  %i.jb = getelementptr inbounds nuw i8, ptr %.1157327, i64 4
  %i.jc = getelementptr inbounds nuw i8, ptr %.1155328, i64 4
  %i.jd = getelementptr inbounds nuw i8, ptr %.4330, i64 4
  %i.je = add nuw nsw i32 %.1153329, 1            ; 2 uses
...
.preheader:                                       ; preds = %.lr.ph335, %_ZN4ncnn3MatD2Ev.exit167
  %.0163.lcssa = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit167 ], [ %i.x, %.lr.ph335 ] ; 2 uses
  %.0161.lcssa = phi ptr [ %i.ad, %_ZN4ncnn3MatD2Ev.exit167 ], [ %i.cs, %.lr.ph335 ]
...
.lr.ph335:                                        ; preds = %_ZN4ncnn3MatD2Ev.exit167, %.lr.ph335
  ...
  %.0161333 = phi ptr [ %i.cs, %.lr.ph335 ], [ %i.ad, %_ZN4ncnn3MatD2Ev.exit167 ] ; 4 uses
  %.0163332 = phi i32 [ %i.cu, %.lr.ph335 ], [ 0, %_ZN4ncnn3MatD2Ev.exit167 ] ; 2 uses
  %i.af = load <8 x float>, ptr %.0161333, align 1, !tbaa !63 ; 2 uses
  %i.ag = getelementptr inbounds nuw i8, ptr %.0161333, i64 32
  %i.ah = load <8 x float>, ptr %i.ag, align 1, !tbaa !63 ; 2 uses
  %i.ai = getelementptr inbounds nuw i8, ptr %.0161333, i64 64
  ...
  %i.cs = getelementptr inbounds nuw i8, ptr %.0161333, i64 96 ; 2 uses
  %i.ct = getelementptr inbounds nuw i8, ptr %.1334, i64 32 ; 2 uses
  %i.cu = add nuw nsw i32 %.0163332, 24
  %i.cv = add nuw nsw i32 %.0163332, 47
...
.lr.ph342:                                        ; preds = %.preheader, %bb.b
  ...
  %.1162340 = phi ptr [ %i.em, %bb.b ], [ %.0161.lcssa, %.preheader ] ; 3 uses
  %.1164339 = phi i32 [ %i.eo, %bb.b ], [ %.0163.lcssa, %.preheader ]
  %i.cx = getelementptr inbounds nuw i8, ptr %.1162340, i64 8
  ...
  %i.df = load <2 x float>, ptr %.1162340, align 4, !tbaa !66
...
bb.b:                                             ; preds = %.lr.ph342, %bb.a
  ...
  %i.em = getelementptr inbounds nuw i8, ptr %.1162340, i64 12
  %i.en = getelementptr inbounds nuw i8, ptr %.2341, i64 4 ; 2 uses
  %i.eo = add nuw nsw i32 %.1164339, 3            ; 2 uses
...
.preheader315:                                    ; preds = %.preheader315.loopexit, %_ZN4ncnn3MatD2Ev.exit166
  %.0158.lcssa = phi ptr [ %i.et, %_ZN4ncnn3MatD2Ev.exit166 ], [ %i.hq, %.preheader315.loopexit ]
  %.0156.lcssa = phi ptr [ %i.ez, %_ZN4ncnn3MatD2Ev.exit166 ], [ %i.hr, %.preheader315.loopexit ]
  %.0154.lcssa = phi ptr [ %i.fc, %_ZN4ncnn3MatD2Ev.exit166 ], [ %i.hs, %.preheader315.loopexit ]
  %.0152.lcssa = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit166 ], [ %i.fi, %.preheader315.loopexit ] ; 2 uses
  %.3.lcssa = phi ptr [ %i.i, %_ZN4ncnn3MatD2Ev.exit166 ], [ %i.ht, %.preheader315.loopexit ]
  %i.fj = icmp slt i32 %.0152.lcssa, %.fr368
...
bb.c:                                             ; preds = %.lr.ph, %bb.c
  ...
  %.0152320 = phi i32 [ 0, %.lr.ph ], [ %i.hu, %bb.c ]
  %.0154319 = phi ptr [ %i.fc, %.lr.ph ], [ %i.hs, %bb.c ] ; 2 uses
  %.0156318 = phi ptr [ %i.ez, %.lr.ph ], [ %i.hr, %bb.c ] ; 2 uses
  %.0158317 = phi ptr [ %i.et, %.lr.ph ], [ %i.hq, %bb.c ] ; 2 uses
  %i.fn = load <8 x float>, ptr %.0158317, align 1, !tbaa !63
  %i.fo = load <8 x float>, ptr %.0156318, align 1, !tbaa !63
  %i.fp = load <8 x float>, ptr %.0154319, align 1, !tbaa !63
  ...
  %i.hq = getelementptr inbounds nuw i8, ptr %.0158317, i64 32 ; 2 uses
  %i.hr = getelementptr inbounds nuw i8, ptr %.0156318, i64 32 ; 2 uses
  %i.hs = getelementptr inbounds nuw i8, ptr %.0154319, i64 32 ; 2 uses
  %i.ht = getelementptr inbounds nuw i8, ptr %.3321, i64 32 ; 2 uses
  %i.hu = add nuw nsw i32 %.0152320, 8            ; 2 uses
...
bb.d:                                             ; preds = %.lr.ph331, %bb.f
  ...
  %.1153329 = phi i32 [ %.0152.lcssa, %.lr.ph331 ], [ %i.js, %bb.f ]
  %.1155328 = phi ptr [ %.0154.lcssa, %.lr.ph331 ], [ %i.jq, %bb.f ] ; 2 uses
  %.1157327 = phi ptr [ %.0156.lcssa, %.lr.ph331 ], [ %i.jp, %bb.f ] ; 2 uses
  %.1159326 = phi ptr [ %.0158.lcssa, %.lr.ph331 ], [ %i.jo, %bb.f ] ; 2 uses
  %i.hx = load float, ptr %.1159326, align 4, !tbaa !66
  %i.hy = load float, ptr %.1157327, align 4, !tbaa !66
  %i.hz = load float, ptr %.1155328, align 4, !tbaa !66
...
bb.f:                                             ; preds = %bb.d, %bb.e
  ...
  %i.jo = getelementptr inbounds nuw i8, ptr %.1159326, i64 4
  %i.jp = getelementptr inbounds nuw i8, ptr %.1157327, i64 4
  %i.jq = getelementptr inbounds nuw i8, ptr %.1155328, i64 4
  %i.jr = getelementptr inbounds nuw i8, ptr %.4330, i64 4
  %i.js = add nuw nsw i32 %.1153329, 1            ; 2 uses
...
.preheader:                                       ; preds = %.lr.ph345, %_ZN4ncnn3MatD2Ev.exit167
  %.0163.lcssa = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit167 ], [ %i.x, %.lr.ph345 ] ; 2 uses
  %.0161.lcssa = phi ptr [ %i.ad, %_ZN4ncnn3MatD2Ev.exit167 ], [ %i.cy, %.lr.ph345 ]
  %.1.lcssa = phi ptr [ %.0355, %_ZN4ncnn3MatD2Ev.exit167 ], [ %i.cz, %.lr.ph345 ] ; 2 uses
  %i.ae = icmp slt i32 %.0163.lcssa, %.fr378
...
.lr.ph345:                                        ; preds = %_ZN4ncnn3MatD2Ev.exit167, %.lr.ph345
  ...
  %.0161343 = phi ptr [ %i.cy, %.lr.ph345 ], [ %i.ad, %_ZN4ncnn3MatD2Ev.exit167 ] ; 4 uses
  %.0163342 = phi i32 [ %i.da, %.lr.ph345 ], [ 0, %_ZN4ncnn3MatD2Ev.exit167 ] ; 2 uses
  %i.af = load <8 x float>, ptr %.0161343, align 1, !tbaa !63 ; 2 uses
  %i.ag = getelementptr inbounds nuw i8, ptr %.0161343, i64 32
  %i.ah = load <8 x float>, ptr %i.ag, align 1, !tbaa !63 ; 2 uses
  %i.ai = getelementptr inbounds nuw i8, ptr %.0161343, i64 64
  %i.aj = load <8 x float>, ptr %i.ai, align 1, !tbaa !63 ; 2 uses
  %i.ak = shufflevector <8 x float> %i.af, <8 x float> %i.ah, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 12, i32 13, i32 14, i32 15> ; 2 uses
  %i.al = shufflevector <8 x float> %i.af, <8 x float> %i.aj, <8 x i32> <i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11> ; 2 uses
  %i.am = shufflevector <8 x float> %i.ah, <8 x float> %i.aj, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 12, i32 13, i32 14, i32 15> ; 2 uses
  ...
  %i.cy = getelementptr inbounds nuw i8, ptr %.0161343, i64 96 ; 2 uses
  %i.cz = getelementptr inbounds nuw i8, ptr %.1344, i64 32 ; 2 uses
  %i.da = add nuw nsw i32 %.0163342, 24
  %i.db = add nuw nsw i32 %.0163342, 47
...
.lr.ph352:                                        ; preds = %.preheader, %bb.b
  ...
  %.1162350 = phi ptr [ %i.ew, %bb.b ], [ %.0161.lcssa, %.preheader ] ; 3 uses
  %.1164349 = phi i32 [ %i.ey, %bb.b ], [ %.0163.lcssa, %.preheader ]
  %i.dd = getelementptr inbounds nuw i8, ptr %.1162350, i64 8
  ...
  %i.dm = load <2 x float>, ptr %.1162350, align 4, !tbaa !66
...
bb.b:                                             ; preds = %.lr.ph352, %bb.a
  ...
  %i.ew = getelementptr inbounds nuw i8, ptr %.1162350, i64 12
  %i.ex = getelementptr inbounds nuw i8, ptr %.2351, i64 4 ; 2 uses
  %i.ey = add nuw nsw i32 %.1164349, 3            ; 2 uses
...
begin_hunk_7_@_ZN4ncnn34gridsample_3d_nearest_compute_blobILNS_10GridSample11PaddingModeE2ELb0EEEvRKNS_3MatES5_RS3_i:_ZN4ncnn3MatD2Ev.exit168
  %.0158.lcssa = phi ptr [ %i.fd, %_ZN4ncnn3MatD2Ev.exit166 ], [ %i.ig, %.preheader325.loopexit ]
  %.0156.lcssa = phi ptr [ %i.fj, %_ZN4ncnn3MatD2Ev.exit166 ], [ %i.ih, %.preheader325.loopexit ]
  %.0154.lcssa = phi ptr [ %i.fm, %_ZN4ncnn3MatD2Ev.exit166 ], [ %i.ii, %.preheader325.loopexit ]
  %.0152.lcssa = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit166 ], [ %i.fs, %.preheader325.loopexit ] ; 2 uses
  %.3.lcssa = phi ptr [ %i.i, %_ZN4ncnn3MatD2Ev.exit166 ], [ %i.ij, %.preheader325.loopexit ]
  %i.ft = icmp slt i32 %.0152.lcssa, %.fr378
...
bb.c:                                             ; preds = %.lr.ph, %bb.c
  ...
  %.0152330 = phi i32 [ 0, %.lr.ph ], [ %i.ik, %bb.c ]
  %.0154329 = phi ptr [ %i.fm, %.lr.ph ], [ %i.ii, %bb.c ] ; 2 uses
  %.0156328 = phi ptr [ %i.fj, %.lr.ph ], [ %i.ih, %bb.c ] ; 2 uses
  %.0158327 = phi ptr [ %i.fd, %.lr.ph ], [ %i.ig, %bb.c ] ; 2 uses
  %i.fx = load <8 x float>, ptr %.0158327, align 1, !tbaa !63
  %i.fy = load <8 x float>, ptr %.0156328, align 1, !tbaa !63
  %i.fz = load <8 x float>, ptr %.0154329, align 1, !tbaa !63
  ...
  %i.ig = getelementptr inbounds nuw i8, ptr %.0158327, i64 32 ; 2 uses
  %i.ih = getelementptr inbounds nuw i8, ptr %.0156328, i64 32 ; 2 uses
  %i.ii = getelementptr inbounds nuw i8, ptr %.0154329, i64 32 ; 2 uses
  %i.ij = getelementptr inbounds nuw i8, ptr %.3331, i64 32 ; 2 uses
  %i.ik = add nuw nsw i32 %.0152330, 8            ; 2 uses
...
bb.d:                                             ; preds = %.lr.ph341, %bb.f
  ...
  %.1153339 = phi i32 [ %.0152.lcssa, %.lr.ph341 ], [ %i.km, %bb.f ]
  %.1155338 = phi ptr [ %.0154.lcssa, %.lr.ph341 ], [ %i.kk, %bb.f ] ; 2 uses
  %.1157337 = phi ptr [ %.0156.lcssa, %.lr.ph341 ], [ %i.kj, %bb.f ] ; 2 uses
  %.1159336 = phi ptr [ %.0158.lcssa, %.lr.ph341 ], [ %i.ki, %bb.f ] ; 2 uses
  %i.in = load float, ptr %.1159336, align 4, !tbaa !66
  %i.io = load float, ptr %.1157337, align 4, !tbaa !66
  %i.ip = load float, ptr %.1155338, align 4, !tbaa !66
...
bb.f:                                             ; preds = %bb.d, %bb.e
  ...
  %i.ki = getelementptr inbounds nuw i8, ptr %.1159336, i64 4
  %i.kj = getelementptr inbounds nuw i8, ptr %.1157337, i64 4
  %i.kk = getelementptr inbounds nuw i8, ptr %.1155338, i64 4
  %i.kl = getelementptr inbounds nuw i8, ptr %.4340, i64 4
  %i.km = add nuw nsw i32 %.1153339, 1            ; 2 uses
...
.lr.ph352:                                        ; preds = %.preheader, %bb.b
  ...
  %.1162350 = phi ptr [ %i.ey, %bb.b ], [ %.0161.lcssa, %.preheader ] ; 3 uses
  %.1164349 = phi i32 [ %i.fa, %bb.b ], [ %.0163.lcssa, %.preheader ]
  %i.dd = getelementptr inbounds nuw i8, ptr %.1162350, i64 8
  %i.de = load float, ptr %i.dd, align 4, !tbaa !66
  ...
  %i.dn = load <2 x float>, ptr %.1162350, align 4, !tbaa !66
...
bb.b:                                             ; preds = %.lr.ph352, %bb.a
  ...
  %i.ey = getelementptr inbounds nuw i8, ptr %.1162350, i64 12
  %i.ez = getelementptr inbounds nuw i8, ptr %.2351, i64 4 ; 2 uses
  %i.fa = add nuw nsw i32 %.1164349, 3            ; 2 uses
...
begin_hunk_8_@_ZN4ncnn34gridsample_3d_nearest_compute_blobILNS_10GridSample11PaddingModeE2ELb1EEEvRKNS_3MatES5_RS3_i:_ZN4ncnn3MatD2Ev.exit168
  %.0154.lcssa = phi ptr [ %i.fo, %_ZN4ncnn3MatD2Ev.exit166 ], [ %i.ik, %.preheader325.loopexit ]
  %.0152.lcssa = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit166 ], [ %i.fu, %.preheader325.loopexit ] ; 2 uses
  %.3.lcssa = phi ptr [ %i.i, %_ZN4ncnn3MatD2Ev.exit166 ], [ %i.il, %.preheader325.loopexit ]
  %i.fv = icmp slt i32 %.0152.lcssa, %.fr378
...
bb.c:                                             ; preds = %.lr.ph, %bb.c
  ...
  %.0152330 = phi i32 [ 0, %.lr.ph ], [ %i.im, %bb.c ]
  %.0154329 = phi ptr [ %i.fo, %.lr.ph ], [ %i.ik, %bb.c ] ; 2 uses
  %.0156328 = phi ptr [ %i.fl, %.lr.ph ], [ %i.ij, %bb.c ] ; 2 uses
  %.0158327 = phi ptr [ %i.ff, %.lr.ph ], [ %i.ii, %bb.c ] ; 2 uses
  %i.fz = load <8 x float>, ptr %.0158327, align 1, !tbaa !63
  %i.ga = load <8 x float>, ptr %.0156328, align 1, !tbaa !63
  %i.gb = load <8 x float>, ptr %.0154329, align 1, !tbaa !63
  ...
  %i.ii = getelementptr inbounds nuw i8, ptr %.0158327, i64 32 ; 2 uses
  %i.ij = getelementptr inbounds nuw i8, ptr %.0156328, i64 32 ; 2 uses
  %i.ik = getelementptr inbounds nuw i8, ptr %.0154329, i64 32 ; 2 uses
  %i.il = getelementptr inbounds nuw i8, ptr %.3331, i64 32 ; 2 uses
  %i.im = add nuw nsw i32 %.0152330, 8            ; 2 uses
...
bb.d:                                             ; preds = %.lr.ph341, %bb.f
  ...
  %.1153339 = phi i32 [ %.0152.lcssa, %.lr.ph341 ], [ %i.kq, %bb.f ]
  %.1155338 = phi ptr [ %.0154.lcssa, %.lr.ph341 ], [ %i.ko, %bb.f ] ; 2 uses
  %.1157337 = phi ptr [ %.0156.lcssa, %.lr.ph341 ], [ %i.kn, %bb.f ] ; 2 uses
  %.1159336 = phi ptr [ %.0158.lcssa, %.lr.ph341 ], [ %i.km, %bb.f ] ; 2 uses
  %i.ip = load float, ptr %.1159336, align 4, !tbaa !66
  %i.iq = load float, ptr %.1157337, align 4, !tbaa !66
  %i.ir = load float, ptr %.1155338, align 4, !tbaa !66
...
bb.f:                                             ; preds = %bb.d, %bb.e
  ...
  %i.km = getelementptr inbounds nuw i8, ptr %.1159336, i64 4
  %i.kn = getelementptr inbounds nuw i8, ptr %.1157337, i64 4
  %i.ko = getelementptr inbounds nuw i8, ptr %.1155338, i64 4
  %i.kp = getelementptr inbounds nuw i8, ptr %.4340, i64 4
  %i.kq = add nuw nsw i32 %.1153339, 1            ; 2 uses
...
.preheader:                                       ; preds = %.lr.ph356, %_ZN4ncnn3MatD2Ev.exit167
  %.0163.lcssa = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit167 ], [ %i.x, %.lr.ph356 ] ; 2 uses
  %.0161.lcssa = phi ptr [ %i.ad, %_ZN4ncnn3MatD2Ev.exit167 ], [ %i.dq, %.lr.ph356 ]
  %.1.lcssa = phi ptr [ %.0366, %_ZN4ncnn3MatD2Ev.exit167 ], [ %i.dr, %.lr.ph356 ] ; 2 uses
  %i.ae = icmp slt i32 %.0163.lcssa, %.fr389
...
.lr.ph356:                                        ; preds = %_ZN4ncnn3MatD2Ev.exit167, %.lr.ph356
  ...
  %.0161354 = phi ptr [ %i.dq, %.lr.ph356 ], [ %i.ad, %_ZN4ncnn3MatD2Ev.exit167 ] ; 4 uses
  %.0163353 = phi i32 [ %i.ds, %.lr.ph356 ], [ 0, %_ZN4ncnn3MatD2Ev.exit167 ] ; 2 uses
  %i.af = load <8 x float>, ptr %.0161354, align 1, !tbaa !63 ; 2 uses
  %i.ag = getelementptr inbounds nuw i8, ptr %.0161354, i64 32
  %i.ah = load <8 x float>, ptr %i.ag, align 1, !tbaa !63 ; 2 uses
  %i.ai = getelementptr inbounds nuw i8, ptr %.0161354, i64 64
  %i.aj = load <8 x float>, ptr %i.ai, align 1, !tbaa !63 ; 2 uses
  %i.ak = shufflevector <8 x float> %i.af, <8 x float> %i.ah, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 12, i32 13, i32 14, i32 15> ; 2 uses
  %i.al = shufflevector <8 x float> %i.af, <8 x float> %i.aj, <8 x i32> <i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11> ; 2 uses
  %i.am = shufflevector <8 x float> %i.ah, <8 x float> %i.aj, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 12, i32 13, i32 14, i32 15> ; 2 uses
  ...
  %i.dq = getelementptr inbounds nuw i8, ptr %.0161354, i64 96 ; 2 uses
  %i.dr = getelementptr inbounds nuw i8, ptr %.1355, i64 32 ; 2 uses
  %i.ds = add nuw nsw i32 %.0163353, 24
  %i.dt = add nuw nsw i32 %.0163353, 47
...
.lr.ph363:                                        ; preds = %.preheader, %bb.b
  ...
  %.1162361 = phi ptr [ %i.fw, %bb.b ], [ %.0161.lcssa, %.preheader ] ; 3 uses
  %.1164360 = phi i32 [ %i.fy, %bb.b ], [ %.0163.lcssa, %.preheader ]
  %i.dv = getelementptr inbounds nuw i8, ptr %.1162361, i64 8
  ...
  %i.ei = load <2 x float>, ptr %.1162361, align 4, !tbaa !66
...
bb.b:                                             ; preds = %.lr.ph363, %bb.a
  ...
  %i.fw = getelementptr inbounds nuw i8, ptr %.1162361, i64 12
  %i.fx = getelementptr inbounds nuw i8, ptr %.2362, i64 4 ; 2 uses
  %i.fy = add nuw nsw i32 %.1164360, 3            ; 2 uses
...
begin_hunk_9_@_ZN4ncnn34gridsample_3d_nearest_compute_blobILNS_10GridSample11PaddingModeE3ELb0EEEvRKNS_3MatES5_RS3_i:_ZN4ncnn3MatD2Ev.exit168
  ...
  %i.jy = getelementptr inbounds nuw i8, ptr %.0158338, i64 32 ; 2 uses
  %i.jz = getelementptr inbounds nuw i8, ptr %.0156339, i64 32 ; 2 uses
  %i.ka = getelementptr inbounds nuw i8, ptr %.0154340, i64 32 ; 2 uses
  %i.kb = getelementptr inbounds nuw i8, ptr %.3342, i64 32 ; 2 uses
  %i.kc = add nuw nsw i32 %.0152341, 8            ; 2 uses
...
bb.d:                                             ; preds = %.lr.ph352, %bb.f
  ...
  %.1153350 = phi i32 [ %.0152.lcssa, %.lr.ph352 ], [ %i.mm, %bb.f ]
  %.1155349 = phi ptr [ %.0154.lcssa, %.lr.ph352 ], [ %i.mk, %bb.f ] ; 2 uses
  %.1157348 = phi ptr [ %.0156.lcssa, %.lr.ph352 ], [ %i.mj, %bb.f ] ; 2 uses
  %.1159347 = phi ptr [ %.0158.lcssa, %.lr.ph352 ], [ %i.mi, %bb.f ] ; 2 uses
  %i.kf = load float, ptr %.1159347, align 4, !tbaa !66
  %i.kg = load float, ptr %.1157348, align 4, !tbaa !66
  %i.kh = load float, ptr %.1155349, align 4, !tbaa !66
...
bb.f:                                             ; preds = %bb.d, %bb.e
  ...
  %i.mi = getelementptr inbounds nuw i8, ptr %.1159347, i64 4
  %i.mj = getelementptr inbounds nuw i8, ptr %.1157348, i64 4
  %i.mk = getelementptr inbounds nuw i8, ptr %.1155349, i64 4
  %i.ml = getelementptr inbounds nuw i8, ptr %.4351, i64 4
  %i.mm = add nuw nsw i32 %.1153350, 1            ; 2 uses
...
.preheader:                                       ; preds = %.lr.ph350, %_ZN4ncnn3MatD2Ev.exit167
  %.0163.lcssa = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit167 ], [ %i.x, %.lr.ph350 ] ; 2 uses
  %.0161.lcssa = phi ptr [ %i.ad, %_ZN4ncnn3MatD2Ev.exit167 ], [ %i.de, %.lr.ph350 ]
  %.1.lcssa = phi ptr [ %.0360, %_ZN4ncnn3MatD2Ev.exit167 ], [ %i.df, %.lr.ph350 ] ; 2 uses
  %i.ae = icmp slt i32 %.0163.lcssa, %.fr383
...
.lr.ph350:                                        ; preds = %_ZN4ncnn3MatD2Ev.exit167, %.lr.ph350
  ...
  %.0161348 = phi ptr [ %i.de, %.lr.ph350 ], [ %i.ad, %_ZN4ncnn3MatD2Ev.exit167 ] ; 4 uses
  %.0163347 = phi i32 [ %i.dg, %.lr.ph350 ], [ 0, %_ZN4ncnn3MatD2Ev.exit167 ] ; 2 uses
  %i.af = load <8 x float>, ptr %.0161348, align 1, !tbaa !63 ; 2 uses
  %i.ag = getelementptr inbounds nuw i8, ptr %.0161348, i64 32
  %i.ah = load <8 x float>, ptr %i.ag, align 1, !tbaa !63 ; 2 uses
  %i.ai = getelementptr inbounds nuw i8, ptr %.0161348, i64 64
  %i.aj = load <8 x float>, ptr %i.ai, align 1, !tbaa !63 ; 2 uses
  %i.ak = shufflevector <8 x float> %i.af, <8 x float> %i.ah, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 12, i32 13, i32 14, i32 15> ; 2 uses
  %i.al = shufflevector <8 x float> %i.af, <8 x float> %i.aj, <8 x i32> <i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11> ; 2 uses
  %i.am = shufflevector <8 x float> %i.ah, <8 x float> %i.aj, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 12, i32 13, i32 14, i32 15> ; 2 uses
  ...
  %i.de = getelementptr inbounds nuw i8, ptr %.0161348, i64 96 ; 2 uses
  %i.df = getelementptr inbounds nuw i8, ptr %.1349, i64 32 ; 2 uses
  %i.dg = add nuw nsw i32 %.0163347, 24
  %i.dh = add nuw nsw i32 %.0163347, 47
...
.lr.ph357:                                        ; preds = %.preheader, %bb.b
  ...
  %.1162355 = phi ptr [ %i.fm, %bb.b ], [ %.0161.lcssa, %.preheader ] ; 3 uses
  %.1164354 = phi i32 [ %i.fo, %bb.b ], [ %.0163.lcssa, %.preheader ]
  %i.dj = getelementptr inbounds nuw i8, ptr %.1162355, i64 8
  ...
  %i.dx = load <2 x float>, ptr %.1162355, align 4, !tbaa !66
...
bb.b:                                             ; preds = %.lr.ph357, %bb.a
  ...
  %i.fm = getelementptr inbounds nuw i8, ptr %.1162355, i64 12
  %i.fn = getelementptr inbounds nuw i8, ptr %.2356, i64 4 ; 2 uses
  %i.fo = add nuw nsw i32 %.1164354, 3            ; 2 uses
