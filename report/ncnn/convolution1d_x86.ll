...
bb.i:                                             ; preds = %bb.i, %.lr.ph438.us.i
  ...
  %i.jq = bitcast <2 x i32> %9 to <2 x float>
  %10 = shufflevector <2 x float> %i.jq, <2 x float> poison, <2 x i32> zeroinitializer
  %i.jr = fmul fast <2 x float> %10, %i.jp
  ...
  %11 = bitcast <2 x i32> %i.jv to <2 x float>
  %12 = insertelement <2 x i32> poison, i32 %8, i64 0
  %i.jw = bitcast <2 x i32> %12 to <2 x float>
  %i.jx = shufflevector <2 x float> %i.jw, <2 x float> poison, <2 x i32> zeroinitializer
  %i.jy = fmul fast <2 x float> %i.jx, %11
