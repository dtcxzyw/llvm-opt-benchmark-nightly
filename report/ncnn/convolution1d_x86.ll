...
_ZN4ncnn3MatD2Ev.exit419.lr.ph.i:                 ; preds = %.preheader483.i
  ...
  %2 = zext i32 %i.do to i64                      ; 5 uses
  %i.dp = mul i32 %i.j, 3
  %3 = zext i32 %i.dp to i64                      ; 5 uses
  %i.dq = shl i32 %i.j, 2                         ; 2 uses
  %4 = sext i32 %i.dq to i64                      ; 3 uses
  %i.dr = sext i32 %i.do to i64                   ; 3 uses
  ...
  %i.en = mul nsw i64 %i.em, %4
  %i.eo = shl i64 %i.en, 2                        ; 3 uses
  %5 = shl nuw nsw i64 %wide.trip.count747.i, 2   ; 3 uses
  %6 = add i64 %i.eo, %5                          ; 2 uses
  %i.ep = add i64 %6, %i.ef                       ; 2 uses
...
_ZN4ncnn3MatD2Ev.exit.i.us.preheader:             ; preds = %_ZN4ncnn3MatD2Ev.exit.lr.ph.i.split.us
  ...
  %min.iters.check486 = icmp ult i32 %i.j, 10
  %stride.check485 = icmp slt i32 %i.oh, 0
...
vector.memcheck469:                               ; preds = %.preheader473.us.i.us
  ...
  %7 = or i1 %found.conflict483, %stride.check485
  %conflict.rdx484 = or i1 %found.conflict480, %7
...
._crit_edge551.us.i:                              ; preds = %scalar.ph375, %middle.block392
  ...
  %i.aat = getelementptr inbounds nuw [4 x i8], ptr %.0375553.us.i, i64 %4 ; 2 uses
  %i.aau = getelementptr inbounds nuw [4 x i8], ptr %.0373554.us.i, i64 %4 ; 2 uses
...
._crit_edge571.us.i:                              ; preds = %scalar.ph289.prol.loopexit, %scalar.ph289, %middle.block302
  ...
  %i.adp = getelementptr inbounds nuw [4 x i8], ptr %.1376573.us.i, i64 %i.dr ; 2 uses
  %i.adq = getelementptr inbounds nuw [4 x i8], ptr %.1374574.us.i, i64 %i.dr ; 2 uses
...
_ZN4ncnn3MatD2Ev.exit419.lr.ph.i:                 ; preds = %.preheader483.i
  ...
  %2 = zext nneg i32 %i.cz to i64                 ; 2 uses
  %i.da = mul nuw nsw i32 %i.d, 3
  %3 = zext nneg i32 %i.da to i64                 ; 2 uses
  %i.db = shl i32 %i.d, 2
  %4 = sext i32 %i.db to i64                      ; 2 uses
...
._crit_edge551.us.i:                              ; preds = %bb.t
  %i.ti = getelementptr inbounds nuw [4 x i8], ptr %.0375553.us.i, i64 %4 ; 2 uses
  %i.tj = getelementptr inbounds nuw [4 x i8], ptr %.0373554.us.i, i64 %4 ; 2 uses
...
._crit_edge571.us.i:                              ; preds = %._crit_edge571.us.i.unr-lcssa, %.epil.preheader216
  ...
  %i.vx = getelementptr inbounds nuw [4 x i8], ptr %.1376573.us.i, i64 %i.dc ; 2 uses
  %i.vy = getelementptr inbounds nuw [4 x i8], ptr %.1374574.us.i, i64 %i.dc ; 2 uses
