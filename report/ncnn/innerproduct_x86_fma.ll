...
bb.m:                                             ; preds = %bb.l
  %10 = insertelement <4 x float> poison, float %i.cu, i64 0
  %11 = insertelement <4 x float> %10, float %i.cx, i64 1
  %12 = insertelement <4 x float> %11, float %i.da, i64 2
  %13 = insertelement <4 x float> %12, float %i.dd, i64 3
  %14 = insertelement <4 x float> poison, float %i.cs, i64 0
  %15 = insertelement <4 x float> %14, float %i.cv, i64 1
  %16 = insertelement <4 x float> %15, float %i.cy, i64 2
  %17 = insertelement <4 x float> %16, float %i.db, i64 3
  %18 = fmul fast <4 x float> %13, %17
  %19 = insertelement <4 x float> poison, float %i.dg, i64 0
  %20 = insertelement <4 x float> %19, float %i.dj, i64 1
  %21 = insertelement <4 x float> %20, float %i.dm, i64 2
  %22 = insertelement <4 x float> %21, float %i.dp, i64 3
  %23 = insertelement <4 x float> poison, float %i.de, i64 0
  %24 = insertelement <4 x float> %23, float %i.dh, i64 1
  %25 = insertelement <4 x float> %24, float %i.dk, i64 2
  %26 = insertelement <4 x float> %25, float %i.dn, i64 3
  %27 = fmul fast <4 x float> %22, %26
  %28 = shufflevector <4 x float> %18, <4 x float> %27, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.dq = fadd fast <8 x float> %28, %.sroa.0.1377 ; 2 uses
...
bb.h:                                             ; preds = %bb.g
  %11 = fmul fast float %i.cp, %i.cn
  %12 = fmul fast float %i.cs, %i.cq
  %13 = fmul fast float %i.cv, %i.ct
  %14 = fmul fast float %i.cy, %i.cw
  %i.cz = insertelement <4 x float> poison, float %11, i64 0
  %i.da = insertelement <4 x float> %i.cz, float %12, i64 1
  %i.db = insertelement <4 x float> %i.da, float %13, i64 2
  %i.dc = insertelement <4 x float> %i.db, float %14, i64 3
  %i.dd = fadd fast <4 x float> %i.dc, %.sroa.0.1325 ; 2 uses
