...
middle.block195:                                  ; preds = %vector.body174
  %cmp.n196 = icmp eq i64 %i.dc, %n.vec173
  br i1 %cmp.n196, label %._crit_edge84.i, label %.lr.ph83.i.preheader207

.lr.ph83.i.preheader207:                          ; preds = %vector.memcheck120, %.lr.ph83.i.preheader, %middle.block195
  %.114482.i.ph = phi ptr [ %.0143.lcssa.i, %vector.memcheck120 ], [ %.0143.lcssa.i, %.lr.ph83.i.preheader ], [ %i.dj, %middle.block195 ]
  %.114681.i.ph = phi ptr [ %.0145.lcssa.i, %vector.memcheck120 ], [ %.0145.lcssa.i, %.lr.ph83.i.preheader ], [ %i.dl, %middle.block195 ]
  %.114880.i.ph = phi ptr [ %.0147.lcssa.i, %vector.memcheck120 ], [ %.0147.lcssa.i, %.lr.ph83.i.preheader ], [ %i.dm, %middle.block195 ]
...
.preheader.i:                                     ; preds = %.lr.ph313.i, %bb.k
  %.0175.lcssa.i = phi ptr [ %i.at, %bb.k ], [ %i.fv, %.lr.ph313.i ]
  %.0173.lcssa.i = phi ptr [ %i.ba, %bb.k ], [ %i.fn, %.lr.ph313.i ]
  %.0171.lcssa.i = phi ptr [ %i.bd, %bb.k ], [ %i.fo, %.lr.ph313.i ]
  %.0169.lcssa.i = phi ptr [ %i.bg, %bb.k ], [ %i.fp, %.lr.ph313.i ]
  %.0167.lcssa.i = phi ptr [ %i.bj, %bb.k ], [ %i.fq, %.lr.ph313.i ]
  %.0165.lcssa.i = phi ptr [ %i.bm, %bb.k ], [ %i.fr, %.lr.ph313.i ]
  %.0163.lcssa.i = phi ptr [ %i.bp, %bb.k ], [ %i.fs, %.lr.ph313.i ]
  %.0161.lcssa.i = phi ptr [ %i.bs, %bb.k ], [ %i.ft, %.lr.ph313.i ]
  %.0159.lcssa.i = phi ptr [ %i.bu, %bb.k ], [ %i.fu, %.lr.ph313.i ]
  %.0157.lcssa.i = phi i32 [ 0, %bb.k ], [ %i.u, %.lr.ph313.i ] ; 2 uses
  %i.bv = icmp slt i32 %.0157.lcssa.i, %i.e
  br i1 %i.bv, label %.lr.ph334.i, label %._crit_edge335.i

.lr.ph313.i:                                      ; preds = %bb.k, %.lr.ph313.i
  %.0157311.i = phi i32 [ %i.fw, %.lr.ph313.i ], [ 0, %bb.k ]
  %.0159310.i = phi ptr [ %i.fu, %.lr.ph313.i ], [ %i.bu, %bb.k ] ; 2 uses
  %.0161309.i = phi ptr [ %i.ft, %.lr.ph313.i ], [ %i.bs, %bb.k ] ; 2 uses
  %.0163308.i = phi ptr [ %i.fs, %.lr.ph313.i ], [ %i.bp, %bb.k ] ; 2 uses
  %.0165307.i = phi ptr [ %i.fr, %.lr.ph313.i ], [ %i.bm, %bb.k ] ; 2 uses
  %.0167306.i = phi ptr [ %i.fq, %.lr.ph313.i ], [ %i.bj, %bb.k ] ; 2 uses
  %.0169305.i = phi ptr [ %i.fp, %.lr.ph313.i ], [ %i.bg, %bb.k ] ; 2 uses
  %.0171304.i = phi ptr [ %i.fo, %.lr.ph313.i ], [ %i.bd, %bb.k ] ; 2 uses
  %.0173303.i = phi ptr [ %i.fn, %.lr.ph313.i ], [ %i.ba, %bb.k ] ; 2 uses
  %.0175302.i = phi ptr [ %i.fv, %.lr.ph313.i ], [ %i.at, %bb.k ] ; 9 uses
  %i.bw = load <8 x i32>, ptr %.0173303.i, align 1, !tbaa !77 ; 2 uses
  ...
  %i.cc = load <8 x i32>, ptr %.0171304.i, align 1, !tbaa !77 ; 2 uses
  ...
  %i.ci = load <8 x i32>, ptr %.0169305.i, align 1, !tbaa !77 ; 2 uses
  ...
  %i.co = load <8 x i32>, ptr %.0167306.i, align 1, !tbaa !77 ; 2 uses
  ...
  %i.cu = load <8 x i32>, ptr %.0165307.i, align 1, !tbaa !77 ; 2 uses
  ...
  %i.da = load <8 x i32>, ptr %.0163308.i, align 1, !tbaa !77 ; 2 uses
  ...
  %i.dg = load <8 x i32>, ptr %.0161309.i, align 1, !tbaa !77 ; 2 uses
  ...
  %i.dm = load <8 x i32>, ptr %.0159310.i, align 1, !tbaa !77 ; 2 uses
  ...
  %i.dp = lshr <4 x i32> %i.dn, splat (i32 16)
  %i.dq = lshr <4 x i32> %i.do, splat (i32 16)
  ...
  store <2 x i64> %i.ey, ptr %.0175302.i, align 1, !tbaa !77
  %i.fg = getelementptr inbounds nuw i8, ptr %.0175302.i, i64 16
  store <2 x i64> %i.ez, ptr %i.fg, align 1, !tbaa !77
  %i.fh = getelementptr inbounds nuw i8, ptr %.0175302.i, i64 32
  store <2 x i64> %i.fa, ptr %i.fh, align 1, !tbaa !77
  %i.fi = getelementptr inbounds nuw i8, ptr %.0175302.i, i64 48
  store <2 x i64> %i.fb, ptr %i.fi, align 1, !tbaa !77
  %i.fj = getelementptr inbounds nuw i8, ptr %.0175302.i, i64 64
  store <2 x i64> %i.fc, ptr %i.fj, align 1, !tbaa !77
  %i.fk = getelementptr inbounds nuw i8, ptr %.0175302.i, i64 80
  store <2 x i64> %i.fd, ptr %i.fk, align 1, !tbaa !77
  %i.fl = getelementptr inbounds nuw i8, ptr %.0175302.i, i64 96
  store <2 x i64> %i.fe, ptr %i.fl, align 1, !tbaa !77
  %i.fm = getelementptr inbounds nuw i8, ptr %.0175302.i, i64 112
  store <2 x i64> %i.ff, ptr %i.fm, align 1, !tbaa !77
  %i.fn = getelementptr inbounds nuw i8, ptr %.0173303.i, i64 32 ; 2 uses
  %i.fo = getelementptr inbounds nuw i8, ptr %.0171304.i, i64 32 ; 2 uses
  %i.fp = getelementptr inbounds nuw i8, ptr %.0169305.i, i64 32 ; 2 uses
  %i.fq = getelementptr inbounds nuw i8, ptr %.0167306.i, i64 32 ; 2 uses
  %i.fr = getelementptr inbounds nuw i8, ptr %.0165307.i, i64 32 ; 2 uses
  %i.fs = getelementptr inbounds nuw i8, ptr %.0163308.i, i64 32 ; 2 uses
  %i.ft = getelementptr inbounds nuw i8, ptr %.0161309.i, i64 32 ; 2 uses
  %i.fu = getelementptr inbounds nuw i8, ptr %.0159310.i, i64 32 ; 2 uses
  %i.fv = getelementptr inbounds nuw i8, ptr %.0175302.i, i64 128 ; 2 uses
  %i.fw = add nuw nsw i32 %.0157311.i, 8          ; 2 uses
...
.lr.ph334.i:                                      ; preds = %.preheader.i, %.lr.ph334.i
  %.1158333.i = phi i32 [ %i.hn, %.lr.ph334.i ], [ %.0157.lcssa.i, %.preheader.i ]
  %.1160332.i = phi ptr [ %i.hh, %.lr.ph334.i ], [ %.0159.lcssa.i, %.preheader.i ] ; 2 uses
  %.1162331.i = phi ptr [ %i.hc, %.lr.ph334.i ], [ %.0161.lcssa.i, %.preheader.i ] ; 2 uses
  %.1164330.i = phi ptr [ %i.gx, %.lr.ph334.i ], [ %.0163.lcssa.i, %.preheader.i ] ; 2 uses
  %.1166329.i = phi ptr [ %i.gs, %.lr.ph334.i ], [ %.0165.lcssa.i, %.preheader.i ] ; 2 uses
  %.1168328.i = phi ptr [ %i.gn, %.lr.ph334.i ], [ %.0167.lcssa.i, %.preheader.i ] ; 2 uses
  %.1170327.i = phi ptr [ %i.gi, %.lr.ph334.i ], [ %.0169.lcssa.i, %.preheader.i ] ; 2 uses
  %.1172326.i = phi ptr [ %i.gd, %.lr.ph334.i ], [ %.0171.lcssa.i, %.preheader.i ] ; 2 uses
  %.1174325.i = phi ptr [ %i.fz, %.lr.ph334.i ], [ %.0173.lcssa.i, %.preheader.i ] ; 2 uses
  %.1176324.i = phi ptr [ %i.hm, %.lr.ph334.i ], [ %.0175.lcssa.i, %.preheader.i ] ; 9 uses
  %i.fz = getelementptr inbounds nuw i8, ptr %.1174325.i, i64 4
  %i.ga = load i32, ptr %.1174325.i, align 4, !tbaa !51
  %i.gb = lshr i32 %i.ga, 16
  %i.gc = trunc nuw i32 %i.gb to i16
  store i16 %i.gc, ptr %.1176324.i, align 2, !tbaa !121
  %i.gd = getelementptr inbounds nuw i8, ptr %.1172326.i, i64 4
  %i.ge = load i32, ptr %.1172326.i, align 4, !tbaa !51
  %i.gf = lshr i32 %i.ge, 16
  %i.gg = trunc nuw i32 %i.gf to i16
  %i.gh = getelementptr inbounds nuw i8, ptr %.1176324.i, i64 2
  store i16 %i.gg, ptr %i.gh, align 2, !tbaa !121
  %i.gi = getelementptr inbounds nuw i8, ptr %.1170327.i, i64 4
  %i.gj = load i32, ptr %.1170327.i, align 4, !tbaa !51
  %i.gk = lshr i32 %i.gj, 16
  %i.gl = trunc nuw i32 %i.gk to i16
  %i.gm = getelementptr inbounds nuw i8, ptr %.1176324.i, i64 4
  store i16 %i.gl, ptr %i.gm, align 2, !tbaa !121
  %i.gn = getelementptr inbounds nuw i8, ptr %.1168328.i, i64 4
  %i.go = load i32, ptr %.1168328.i, align 4, !tbaa !51
  %i.gp = lshr i32 %i.go, 16
  %i.gq = trunc nuw i32 %i.gp to i16
  %i.gr = getelementptr inbounds nuw i8, ptr %.1176324.i, i64 6
  store i16 %i.gq, ptr %i.gr, align 2, !tbaa !121
  %i.gs = getelementptr inbounds nuw i8, ptr %.1166329.i, i64 4
  %i.gt = load i32, ptr %.1166329.i, align 4, !tbaa !51
  %i.gu = lshr i32 %i.gt, 16
  %i.gv = trunc nuw i32 %i.gu to i16
  %i.gw = getelementptr inbounds nuw i8, ptr %.1176324.i, i64 8
  store i16 %i.gv, ptr %i.gw, align 2, !tbaa !121
  %i.gx = getelementptr inbounds nuw i8, ptr %.1164330.i, i64 4
  %i.gy = load i32, ptr %.1164330.i, align 4, !tbaa !51
  %i.gz = lshr i32 %i.gy, 16
  %i.ha = trunc nuw i32 %i.gz to i16
  %i.hb = getelementptr inbounds nuw i8, ptr %.1176324.i, i64 10
  store i16 %i.ha, ptr %i.hb, align 2, !tbaa !121
  %i.hc = getelementptr inbounds nuw i8, ptr %.1162331.i, i64 4
  %i.hd = load i32, ptr %.1162331.i, align 4, !tbaa !51
  %i.he = lshr i32 %i.hd, 16
  %i.hf = trunc nuw i32 %i.he to i16
  %i.hg = getelementptr inbounds nuw i8, ptr %.1176324.i, i64 12
  store i16 %i.hf, ptr %i.hg, align 2, !tbaa !121
  %i.hh = getelementptr inbounds nuw i8, ptr %.1160332.i, i64 4
  %i.hi = load i32, ptr %.1160332.i, align 4, !tbaa !51
  %i.hj = lshr i32 %i.hi, 16
  %i.hk = trunc nuw i32 %i.hj to i16
  %i.hl = getelementptr inbounds nuw i8, ptr %.1176324.i, i64 14
  store i16 %i.hk, ptr %i.hl, align 2, !tbaa !121
  %i.hm = getelementptr inbounds nuw i8, ptr %.1176324.i, i64 16
  %i.hn = add nuw nsw i32 %.1158333.i, 1          ; 2 uses
...
.lr.ph.i.us:                                      ; preds = %.lr.ph.i.preheader.us, %.lr.ph.i.us
  %.0144286.i.us = phi i32 [ %i.kr, %.lr.ph.i.us ], [ 0, %.lr.ph.i.preheader.us ]
  %.0146285.i.us = phi ptr [ %i.kp, %.lr.ph.i.us ], [ %i.jo, %.lr.ph.i.preheader.us ] ; 2 uses
  %.0148284.i.us = phi ptr [ %i.ko, %.lr.ph.i.us ], [ %i.jm, %.lr.ph.i.preheader.us ] ; 2 uses
  %.0150283.i.us = phi ptr [ %i.kn, %.lr.ph.i.us ], [ %i.jj, %.lr.ph.i.preheader.us ] ; 2 uses
  %.0152282.i.us = phi ptr [ %i.km, %.lr.ph.i.us ], [ %i.jg, %.lr.ph.i.preheader.us ] ; 2 uses
  %.0154281.i.us = phi ptr [ %i.kq, %.lr.ph.i.us ], [ %i.iz, %.lr.ph.i.preheader.us ] ; 3 uses
  %i.jp = load <4 x float>, ptr %.0152282.i.us, align 1, !tbaa !77 ; 2 uses
  %i.jq = load <4 x float>, ptr %.0150283.i.us, align 1, !tbaa !77 ; 2 uses
  %i.jr = load <4 x float>, ptr %.0148284.i.us, align 1, !tbaa !77 ; 2 uses
  %i.js = load <4 x float>, ptr %.0146285.i.us, align 1, !tbaa !77 ; 2 uses
  ...
  store <8 x i16> %i.kd, ptr %.0154281.i.us, align 1, !tbaa !77
  %i.kl = getelementptr inbounds nuw i8, ptr %.0154281.i.us, i64 16
  store <8 x i16> %i.kk, ptr %i.kl, align 1, !tbaa !77
  %i.km = getelementptr inbounds nuw i8, ptr %.0152282.i.us, i64 16 ; 4 uses
  %i.kn = getelementptr inbounds nuw i8, ptr %.0150283.i.us, i64 16 ; 4 uses
  %i.ko = getelementptr inbounds nuw i8, ptr %.0148284.i.us, i64 16 ; 4 uses
  %i.kp = getelementptr inbounds nuw i8, ptr %.0146285.i.us, i64 16 ; 4 uses
  %i.kq = getelementptr inbounds nuw i8, ptr %.0154281.i.us, i64 32 ; 4 uses
  %i.kr = add nuw nsw i32 %.0144286.i.us, 4       ; 2 uses
...
.lr.ph298.i.us:                                   ; preds = %.lr.ph298.i.us.preheader109, %.lr.ph298.i.us
  %.1145297.i.us = phi i32 [ %i.lo, %.lr.ph298.i.us ], [ %.1145297.i.us.ph, %.lr.ph298.i.us.preheader109 ]
  %.1147296.i.us = phi ptr [ %i.li, %.lr.ph298.i.us ], [ %.1147296.i.us.ph, %.lr.ph298.i.us.preheader109 ] ; 2 uses
  %.1149295.i.us = phi ptr [ %i.ld, %.lr.ph298.i.us ], [ %.1149295.i.us.ph, %.lr.ph298.i.us.preheader109 ] ; 2 uses
  %.1151294.i.us = phi ptr [ %i.ky, %.lr.ph298.i.us ], [ %.1151294.i.us.ph, %.lr.ph298.i.us.preheader109 ] ; 2 uses
  %.1153293.i.us = phi ptr [ %i.ku, %.lr.ph298.i.us ], [ %.1153293.i.us.ph, %.lr.ph298.i.us.preheader109 ] ; 2 uses
  %.1155292.i.us = phi ptr [ %i.ln, %.lr.ph298.i.us ], [ %.1155292.i.us.ph, %.lr.ph298.i.us.preheader109 ] ; 5 uses
  %i.ku = getelementptr inbounds nuw i8, ptr %.1153293.i.us, i64 4
  %i.kv = load i32, ptr %.1153293.i.us, align 4, !tbaa !51
  %i.kw = lshr i32 %i.kv, 16
  %i.kx = trunc nuw i32 %i.kw to i16
  store i16 %i.kx, ptr %.1155292.i.us, align 2, !tbaa !121
  %i.ky = getelementptr inbounds nuw i8, ptr %.1151294.i.us, i64 4
  %i.kz = load i32, ptr %.1151294.i.us, align 4, !tbaa !51
  %i.la = lshr i32 %i.kz, 16
  %i.lb = trunc nuw i32 %i.la to i16
  %i.lc = getelementptr inbounds nuw i8, ptr %.1155292.i.us, i64 2
  store i16 %i.lb, ptr %i.lc, align 2, !tbaa !121
  %i.ld = getelementptr inbounds nuw i8, ptr %.1149295.i.us, i64 4
  %i.le = load i32, ptr %.1149295.i.us, align 4, !tbaa !51
  %i.lf = lshr i32 %i.le, 16
  %i.lg = trunc nuw i32 %i.lf to i16
  %i.lh = getelementptr inbounds nuw i8, ptr %.1155292.i.us, i64 4
  store i16 %i.lg, ptr %i.lh, align 2, !tbaa !121
  %i.li = getelementptr inbounds nuw i8, ptr %.1147296.i.us, i64 4
  %i.lj = load i32, ptr %.1147296.i.us, align 4, !tbaa !51
  %i.lk = lshr i32 %i.lj, 16
  %i.ll = trunc nuw i32 %i.lk to i16
  %i.lm = getelementptr inbounds nuw i8, ptr %.1155292.i.us, i64 6
  store i16 %i.ll, ptr %i.lm, align 2, !tbaa !121
  %i.ln = getelementptr inbounds nuw i8, ptr %.1155292.i.us, i64 8
  %i.lo = add nuw nsw i32 %.1145297.i.us, 1       ; 2 uses
...
.lr.ph298.i.us.preheader109:                      ; preds = %.lr.ph298.i.us.preheader, %middle.block
  %.1145297.i.us.ph = phi i32 [ %i.ih, %.lr.ph298.i.us.preheader ], [ %i.io, %middle.block ]
  %.1147296.i.us.ph = phi ptr [ %i.kp, %.lr.ph298.i.us.preheader ], [ %i.lr, %middle.block ]
  %.1149295.i.us.ph = phi ptr [ %i.ko, %.lr.ph298.i.us.preheader ], [ %i.ls, %middle.block ]
  %.1151294.i.us.ph = phi ptr [ %i.kn, %.lr.ph298.i.us.preheader ], [ %i.lt, %middle.block ]
  %.1153293.i.us.ph = phi ptr [ %i.km, %.lr.ph298.i.us.preheader ], [ %i.lu, %middle.block ]
  %.1155292.i.us.ph = phi ptr [ %i.kq, %.lr.ph298.i.us.preheader ], [ %i.lv, %middle.block ]
