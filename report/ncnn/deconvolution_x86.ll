...
.noexc310:                                        ; preds = %._crit_edge777
  ...
  %i.rf = fmul fast <4 x float> %i.ql, splat (float f0x3F317218)
  %reass.add649 = fadd fast <4 x float> %i.re, splat (float -5.000000e-01)
  %reass.mul = fmul fast <4 x float> %i.qn, %reass.add649
  %i.rg = fadd fast <4 x float> %i.rf, %i.qm
...
.noexc310:                                        ; preds = %._crit_edge789
  ...
  %i.ty = fmul fast <4 x float> %i.te, splat (float f0x3F317218)
  %reass.add661 = fadd fast <4 x float> %i.tx, splat (float -5.000000e-01)
  %reass.mul = fmul fast <4 x float> %i.tg, %reass.add661
  %i.tz = fadd fast <4 x float> %i.ty, %i.tf
