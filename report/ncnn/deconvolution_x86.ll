...
_ZN4ncnn3MatD2Ev.exit452.us.us.us.i:              ; preds = %bb.bj
  ...
  %i.sm = getelementptr inbounds nuw [4 x i8], ptr %.1346993.us.us.i, i64 %i.sl
  ...
  %i.sz = fadd fast <2 x float> %i.sy, %i.sd
  ...
  %i.te = fadd fast <2 x float> %i.sz, %i.td
...
_ZN4ncnn3MatD2Ev.exit451.us.us.us.i:              ; preds = %bb.bn
  ...
  %i.uo = getelementptr inbounds nuw i8, ptr %.23471037.us.us.i, i64 %.idx.i
...
_ZN4ncnn3MatD2Ev.exit447.us.us.us.us.i.us:        ; preds = %bb.cb
  ...
  %i.abr = getelementptr inbounds nuw [4 x i8], ptr %.03231110.us.us.i, i64 %i.abq
...
._crit_edge1096.split.us.us.us.i:                 ; preds = %..loopexit886_crit_edge.us.us.us.i.us162, %..loopexit886_crit_edge.us.us.us.i.us, %.preheader889.us.us.i
  ...
  %i.abv = getelementptr inbounds [4 x i8], ptr %.03231110.us.us.i, i64 %i.ys ; 2 uses
...
._crit_edge1114.i:                                ; preds = %._crit_edge1096.split.us.us.us.i, %.preheader889.lr.ph.i, %_ZN4ncnn3MatD2Ev.exit449.i
  ...
  %.0323.lcssa.i = phi ptr [ %i.yn, %_ZN4ncnn3MatD2Ev.exit449.i ], [ %scevgep1332.i, %.preheader889.lr.ph.i ], [ %i.abv, %._crit_edge1096.split.us.us.us.i ] ; 4 uses
  ...
  %i.acb = fadd fast float %i.abz, %.0326.i
  %i.acc = fadd fast float %i.acb, %i.aca         ; 4 uses
  %i.acd = or disjoint i32 %.0322.lcssa.i, 1
...
.preheader888.preheader.i:                        ; preds = %.preheader888.lr.ph.i
  ...
  %scevgep1358.i = getelementptr i8, ptr %.0323.lcssa.i, i64 %i.acs
...
.preheader888.us.preheader.i:                     ; preds = %.preheader888.lr.ph.split.us.i
  ...
  %scevgep1360.i = getelementptr i8, ptr %.0323.lcssa.i, i64 %i.add
  %i.ade = or disjoint i32 %.0322.lcssa.i, 2
...
.preheader888.us.us.preheader.i:                  ; preds = %.preheader888.lr.ph.split.us.i
  ...
  %i.adi = zext i32 %.0322.lcssa.i to i64
...
.preheader888.us.us.i:                            ; preds = %._crit_edge1147.split.us.us.us.i, %.preheader888.us.us.preheader.i
  ...
  %.13241154.us.us.i = phi ptr [ %.0323.lcssa.i, %.preheader888.us.us.preheader.i ], [ %i.aen, %._crit_edge1147.split.us.us.us.i ] ; 2 uses
  %.13271153.us.us.i = phi float [ %i.acc, %.preheader888.us.us.preheader.i ], [ %.8.us.us.us.i, %._crit_edge1147.split.us.us.us.i ]
...
_ZN4ncnn3MatD2Ev.exit446.us.us.us.i:              ; preds = %bb.cg
  ...
  %i.aee = fadd fast float %i.aed, %.31139.us.us.us.i
  ...
  %i.aej = fadd fast float %i.aee, %i.aei
...
._crit_edge1147.split.us.us.us.i:                 ; preds = %..loopexit884_crit_edge.us.us.us.i
  %i.aen = getelementptr inbounds [4 x i8], ptr %.13241154.us.us.i, i64 %i.yu ; 2 uses
...
.preheader890.i:                                  ; preds = %._crit_edge1147.split.us.us.us.i, %.preheader888.us.preheader.i, %.preheader888.preheader.i, %._crit_edge1114.i
  %.1327.lcssa.i = phi float [ %i.acc, %._crit_edge1114.i ], [ %i.acc, %.preheader888.preheader.i ], [ %i.acc, %.preheader888.us.preheader.i ], [ %.8.us.us.us.i, %._crit_edge1147.split.us.us.us.i ] ; 3 uses
  %.1324.lcssa.i = phi ptr [ %.0323.lcssa.i, %._crit_edge1114.i ], [ %scevgep1358.i, %.preheader888.preheader.i ], [ %scevgep1360.i, %.preheader888.us.preheader.i ], [ %i.aen, %._crit_edge1147.split.us.us.us.i ]
  %.1.lcssa.i = phi i32 [ %.0322.lcssa.i, %._crit_edge1114.i ], [ %i.acv, %.preheader888.preheader.i ], [ %i.adg, %.preheader888.us.preheader.i ], [ %i.aeo, %._crit_edge1147.split.us.us.us.i ] ; 2 uses
  %i.aer = icmp slt i32 %.1.lcssa.i, %i.ky
...
.preheader887.us.us.preheader.i:                  ; preds = %.preheader887.lr.ph.i
  ...
  %i.afb = zext i32 %.1.lcssa.i to i64
...
.preheader887.us.us.i:                            ; preds = %._crit_edge1183.split.us.us.us.i, %.preheader887.us.us.preheader.i
  ...
  %.23251190.us.us.i = phi ptr [ %.1324.lcssa.i, %.preheader887.us.us.preheader.i ], [ %i.agf, %._crit_edge1183.split.us.us.us.i ] ; 2 uses
...
_ZN4ncnn3MatD2Ev.exit.us.us.us.i:                 ; preds = %bb.ck
  ...
  %i.aga = fadd fast float %i.afz, %.111175.us.us.us.i
  br label %bb.cl

bb.cl:                                            ; preds = %_ZN4ncnn3MatD2Ev.exit.us.us.us.i, %bb.ck, %bb.cj
  %.13.us.us.us.i = phi nsz float [ %.111175.us.us.us.i, %bb.cj ], [ %.111175.us.us.us.i, %bb.ck ], [ %i.aga, %_ZN4ncnn3MatD2Ev.exit.us.us.us.i ] ; 2 uses
...
.preheader.us.us.us.i:                            ; preds = %bb.ci
  ...
  %i.agd = getelementptr inbounds nuw [4 x i8], ptr %.23251190.us.us.i, i64 %i.agb
  %i.age = mul nsw i64 %i.agc, %i.ly
  br label %bb.cj

._crit_edge1183.split.us.us.us.i:                 ; preds = %..loopexit882_crit_edge.us.us.us.i
  %i.agf = getelementptr inbounds [4 x i8], ptr %.23251190.us.us.i, i64 %i.yv
...
bb.cm:                                            ; preds = %._crit_edge1193.i
  %i.agi = call fast float @llvm.maxnum.f32(float nofpclass(nan inf) %.9.lcssa.i, float 0.000000e+00)
...
bb.cn:                                            ; preds = %._crit_edge1193.i
  ...
  %i.agl = fcmp fast ogt float %.9.lcssa.i, 0.000000e+00
  %i.agm = select fast i1 %i.agl, float 1.000000e+00, float %i.agk
  %i.agn = fmul fast float %i.agm, %.9.lcssa.i
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit.i
...
bb.co:                                            ; preds = %._crit_edge1193.i
  ...
  %.0820.i = call nnan ninf nsz float @llvm.maxnum.f32(float %.9.lcssa.i, float %i.agp) ; 2 uses
...
bb.cr:                                            ; preds = %._crit_edge1193.i
  %i.agx = call fast float @llvm.exp.f32(float nofpclass(nan inf) %.9.lcssa.i)
  ...
  %i.ahb = fmul fast float %i.aha, %.9.lcssa.i
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit.i
...
bb.cs:                                            ; preds = %._crit_edge1193.i
  ...
  %i.ahi = fcmp fast olt float %.9.lcssa.i, %i.ahh
end_hunk_1
...
.preheader908.us.us.i:                            ; preds = %._crit_edge.split.us.us.us1020.i, %.preheader908.us.us.preheader.i
  ...
  %.13461001.us.us.i = phi ptr [ %.0345.lcssa.i, %.preheader908.us.us.preheader.i ], [ %i.qp, %._crit_edge.split.us.us.us1020.i ] ; 2 uses
...
_ZN4ncnn3MatD2Ev.exit452.us.us.us.i:              ; preds = %bb.ag
  ...
  %i.ph = getelementptr inbounds nuw [2 x i8], ptr %.13461001.us.us.i, i64 %i.pg
  ...
  %i.qd = fadd fast <2 x float> %i.qc, %i.oy
  ...
  %i.qj = fadd fast <2 x float> %i.qd, %i.qi
...
._crit_edge.split.us.us.us1020.i:                 ; preds = %..loopexit904_crit_edge.us.us.us.i
  %i.qp = getelementptr inbounds [2 x i8], ptr %.13461001.us.us.i, i64 %i.iw ; 2 uses
...
.preheader910.i:                                  ; preds = %._crit_edge.split.us.us.us1020.i, %.preheader908.us.preheader.i, %.preheader908.preheader.i, %._crit_edge958.i
  %.1346.lcssa.i = phi ptr [ %.0345.lcssa.i, %._crit_edge958.i ], [ %scevgep1300.i, %.preheader908.preheader.i ], [ %scevgep1302.i, %.preheader908.us.preheader.i ], [ %i.qp, %._crit_edge.split.us.us.us1020.i ]
  %.1343.lcssa.i = phi i32 [ %.0342.lcssa.i, %._crit_edge958.i ], [ %i.of, %.preheader908.preheader.i ], [ %i.on, %.preheader908.us.preheader.i ], [ %i.qq, %._crit_edge.split.us.us.us1020.i ] ; 2 uses
  ...
  %i.qu = icmp slt i32 %.1343.lcssa.i, %i.fn
...
.preheader907.us.us.preheader.i:                  ; preds = %.preheader907.lr.ph.i
  ...
  %i.re = zext i32 %.1343.lcssa.i to i64
...
.preheader907.us.us.i:                            ; preds = %._crit_edge.split.us.us.us1060.i, %.preheader907.us.us.preheader.i
  ...
  %.23471045.us.us.i = phi ptr [ %.1346.lcssa.i, %.preheader907.us.us.preheader.i ], [ %i.sv, %._crit_edge.split.us.us.us1060.i ] ; 2 uses
...
._crit_edge.split.us.us.us1060.i:                 ; preds = %..loopexit902_crit_edge.us.us.us.i
  %i.sv = getelementptr inbounds [2 x i8], ptr %.23471045.us.us.i, i64 %i.iy
...
_ZN4ncnn3MatD2Ev.exit447.us.us.us.us.i.us:        ; preds = %bb.ay
  ...
  %i.zt = getelementptr inbounds nuw [2 x i8], ptr %.03231118.us.us.i, i64 %i.zs
...
._crit_edge1104.split.us.us.us.i:                 ; preds = %..loopexit894_crit_edge.us.us.us.i.us86, %..loopexit894_crit_edge.us.us.us.i.us, %.preheader897.us.us.i
  ...
  %i.aab = getelementptr inbounds [2 x i8], ptr %.03231118.us.us.i, i64 %i.wg ; 2 uses
...
._crit_edge1122.i:                                ; preds = %._crit_edge1104.split.us.us.us.i, %.preheader897.lr.ph.i, %_ZN4ncnn3MatD2Ev.exit449.i
  ...
  %.0323.lcssa.i = phi ptr [ %i.wb, %_ZN4ncnn3MatD2Ev.exit449.i ], [ %scevgep1340.i, %.preheader897.lr.ph.i ], [ %i.aab, %._crit_edge1104.split.us.us.us.i ] ; 4 uses
  ...
  %i.aah = fadd fast float %i.aaf, %.0326.i
  %i.aai = fadd fast float %i.aah, %i.aag         ; 4 uses
  %i.aaj = or disjoint i32 %.0322.lcssa.i, 1
...
.preheader896.preheader.i:                        ; preds = %.preheader896.lr.ph.i
  ...
  %scevgep1366.i = getelementptr i8, ptr %.0323.lcssa.i, i64 %i.aax
  %i.aay = add i32 %.0322.lcssa.i, %i.aat
...
.preheader896.us.preheader.i:                     ; preds = %.preheader896.lr.ph.split.us.i
  ...
  %scevgep1368.i = getelementptr i8, ptr %.0323.lcssa.i, i64 %i.abf
  %i.abg = add i32 %.0322.lcssa.i, %i.abb
  br label %.preheader898.i

.preheader896.us.us.preheader.i:                  ; preds = %.preheader896.lr.ph.split.us.i
  %i.abh = zext nneg i32 %.fr1235.i to i64        ; 2 uses
  %i.abi = zext i32 %.0322.lcssa.i to i64
...
.preheader896.us.us.i:                            ; preds = %._crit_edge1155.split.us.us.us.i, %.preheader896.us.us.preheader.i
  ...
  %.13241162.us.us.i = phi ptr [ %.0323.lcssa.i, %.preheader896.us.us.preheader.i ], [ %i.acu, %._crit_edge1155.split.us.us.us.i ] ; 2 uses
  %.13271161.us.us.i = phi float [ %i.aai, %.preheader896.us.us.preheader.i ], [ %.8.us.us.us.i, %._crit_edge1155.split.us.us.us.i ]
...
_ZN4ncnn3MatD2Ev.exit446.us.us.us.i:              ; preds = %bb.bd
  ...
  %i.abv = getelementptr inbounds nuw i8, ptr %.13241162.us.us.i, i64 %.idx1440.i
  ...
  %i.aco = fadd fast float %i.acn, %.31147.us.us.us.i
...
.loopexit.us.us.us.i:                             ; preds = %_ZN4ncnn3MatD2Ev.exit446.us.us.us.i, %bb.bd, %bb.bc
  %.6.us.us.us.i = phi nsz float [ %.31147.us.us.us.i, %bb.bc ], [ %.31147.us.us.us.i, %bb.bd ], [ %i.acq, %_ZN4ncnn3MatD2Ev.exit446.us.us.us.i ] ; 2 uses
...
._crit_edge1155.split.us.us.us.i:                 ; preds = %..loopexit892_crit_edge.us.us.us.i
  %i.acu = getelementptr inbounds [2 x i8], ptr %.13241162.us.us.i, i64 %i.wi ; 2 uses
...
.preheader898.i:                                  ; preds = %._crit_edge1155.split.us.us.us.i, %.preheader896.us.preheader.i, %.preheader896.preheader.i, %._crit_edge1122.i
  %.1327.lcssa.i = phi float [ %i.aai, %._crit_edge1122.i ], [ %i.aai, %.preheader896.preheader.i ], [ %i.aai, %.preheader896.us.preheader.i ], [ %.8.us.us.us.i, %._crit_edge1155.split.us.us.us.i ] ; 3 uses
  %.1324.lcssa.i = phi ptr [ %.0323.lcssa.i, %._crit_edge1122.i ], [ %scevgep1366.i, %.preheader896.preheader.i ], [ %scevgep1368.i, %.preheader896.us.preheader.i ], [ %i.acu, %._crit_edge1155.split.us.us.us.i ]
  %.1.lcssa.i = phi i32 [ %.0322.lcssa.i, %._crit_edge1122.i ], [ %i.aay, %.preheader896.preheader.i ], [ %i.abg, %.preheader896.us.preheader.i ], [ %i.acv, %._crit_edge1155.split.us.us.us.i ] ; 2 uses
  %i.acy = icmp slt i32 %.1.lcssa.i, %i.gw
...
.preheader895.us.us.preheader.i:                  ; preds = %.preheader895.lr.ph.i
  ...
  %i.adi = zext i32 %.1.lcssa.i to i64
...
.preheader895.us.us.i:                            ; preds = %._crit_edge1191.split.us.us.us.i, %.preheader895.us.us.preheader.i
  ...
  %.23251198.us.us.i = phi ptr [ %.1324.lcssa.i, %.preheader895.us.us.preheader.i ], [ %i.aes, %._crit_edge1191.split.us.us.us.i ] ; 2 uses
...
_ZN4ncnn3MatD2Ev.exit.us.us.us.i:                 ; preds = %bb.bh
  ...
  %i.aen = fadd fast float %i.aem, %.111183.us.us.us.i
  br label %bb.bi

bb.bi:                                            ; preds = %_ZN4ncnn3MatD2Ev.exit.us.us.us.i, %bb.bh, %bb.bg
  %.13.us.us.us.i = phi nsz float [ %.111183.us.us.us.i, %bb.bg ], [ %.111183.us.us.us.i, %bb.bh ], [ %i.aen, %_ZN4ncnn3MatD2Ev.exit.us.us.us.i ] ; 2 uses
...
.preheader.us.us.us.i:                            ; preds = %bb.bf
  ...
  %i.aeq = getelementptr inbounds nuw [2 x i8], ptr %.23251198.us.us.i, i64 %i.aeo
  %i.aer = mul nsw i64 %i.aep, %i.hz
  br label %bb.bg

._crit_edge1191.split.us.us.us.i:                 ; preds = %..loopexit890_crit_edge.us.us.us.i
  %i.aes = getelementptr inbounds [2 x i8], ptr %.23251198.us.us.i, i64 %i.wj
...
bb.bj:                                            ; preds = %._crit_edge1201.i
  %i.aev = call fast float @llvm.maxnum.f32(float nofpclass(nan inf) %.9.lcssa.i, float 0.000000e+00)
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit.i

bb.bk:                                            ; preds = %._crit_edge1201.i
  %i.aew = load ptr, ptr %i.ej, align 8, !tbaa !18
  %i.aex = load float, ptr %i.aew, align 4, !tbaa !39
  %i.aey = fcmp fast ogt float %.9.lcssa.i, 0.000000e+00
  %i.aez = select fast i1 %i.aey, float 1.000000e+00, float %i.aex
  %i.afa = fmul fast float %i.aez, %.9.lcssa.i
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit.i
...
bb.bl:                                            ; preds = %._crit_edge1201.i
  ...
  %.0828.i = call nnan ninf nsz float @llvm.maxnum.f32(float %.9.lcssa.i, float %i.afc) ; 2 uses
...
bb.bo:                                            ; preds = %._crit_edge1201.i
  %i.afk = call fast float @llvm.exp.f32(float nofpclass(nan inf) %.9.lcssa.i)
  ...
  %i.afo = fmul fast float %i.afn, %.9.lcssa.i
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit.i
...
bb.u:                                             ; preds = %bb.t
  ...
  %i.lu = getelementptr inbounds nuw [4 x i8], ptr %.2196777.us, i64 %i.lt
...
.loopexit.us:                                     ; preds = %bb.v, %.preheader.us, %bb.r, %bb.q
  ...
  %i.mg = add nuw nsw i32 %.0188771.us, 1         ; 2 uses
...
.lr.ph.us782:                                     ; preds = %.preheader.us
  ...
  %i.ml = mul nuw nsw i32 %i.mh, %.0188771.us
...
.noexc309:                                        ; preds = %._crit_edge779
  ...
  %i.ok = fadd fast <4 x float> %i.nx, splat (float 1.000000e+00)
  %i.ol = fadd fast <4 x float> %i.ok, %i.oj
...
.noexc310:                                        ; preds = %._crit_edge779
  ...
  %i.pq = fadd fast <4 x float> %i.pd, splat (float 1.000000e+00)
  %i.pr = fadd fast <4 x float> %i.pq, %i.pp
  ...
  %i.re = fmul fast <4 x float> %i.rd, %i.qm
  %reass.mul.a = fmul fast <4 x float> %i.ql, splat (float f0x3F317218)
  %reass.add649 = fadd fast <4 x float> %i.re, splat (float -5.000000e-01)
  %reass.mul650 = fmul fast <4 x float> %i.qn, %reass.add649
  %i.rf = fadd fast <4 x float> %reass.mul.a, %i.qm
...
.thread:                                          ; preds = %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit
  ...
  %i.td = getelementptr inbounds nuw i8, ptr %.1200787, i64 16
  br label %bb.aa
...
bb.z:                                             ; preds = %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit
  ...
  %i.tf = getelementptr inbounds nuw [4 x i8], ptr %.1200787, i64 %i.te
  store float %.sroa.0.4.vec.extract, ptr %i.tf, align 4, !tbaa !39
  %.sroa.0.8.vec.extract = extractelement <4 x float> %.0.i, i64 2
  %.idx = shl i64 %i.te, 3
  %i.tg = getelementptr inbounds nuw i8, ptr %.1200787, i64 %.idx
  ...
  %i.th = getelementptr inbounds nuw i8, ptr %.1200787, i64 %.idx222
  store float %.sroa.0.12.vec.extract, ptr %i.th, align 4, !tbaa !39
  %i.ti = getelementptr inbounds nuw i8, ptr %.1200787, i64 4
  br label %bb.aa

bb.aa:                                            ; preds = %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit, %.thread, %bb.z
  %.3 = phi ptr [ %i.ti, %bb.z ], [ %.1200787, %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit ], [ %i.td, %.thread ] ; 2 uses
  %i.tj = add nuw nsw i32 %.0197788, 1            ; 2 uses
...
.preheader684:                                    ; preds = %.preheader684.preheader, %._crit_edge
  %.0198802 = phi i32 [ %.neg672.a, %._crit_edge ], [ 0, %.preheader684.preheader ]
...
bb.u:                                             ; preds = %bb.t
  ...
  %i.og = getelementptr inbounds nuw [2 x i8], ptr %.2196789.us, i64 %i.of
...
.loopexit.us:                                     ; preds = %bb.v, %.preheader.us, %bb.r, %bb.q
  ...
  %i.oz = add nuw nsw i32 %.0188783.us, 1         ; 2 uses
...
.lr.ph.us794:                                     ; preds = %.preheader.us
  ...
  %i.pe = mul nuw nsw i32 %i.pa, %.0188783.us
...
.noexc309:                                        ; preds = %._crit_edge791
  ...
  %i.rd = fadd fast <4 x float> %i.qq, splat (float 1.000000e+00)
...
.noexc310:                                        ; preds = %._crit_edge791
  ...
  %i.sj = fadd fast <4 x float> %i.rw, splat (float 1.000000e+00)
  %i.sk = fadd fast <4 x float> %i.sj, %i.si
  ...
  %i.tx = fmul fast <4 x float> %i.tw, %i.tf
  %reass.mul.a = fmul fast <4 x float> %i.te, splat (float f0x3F317218)
  %reass.add661 = fadd fast <4 x float> %i.tx, splat (float -5.000000e-01)
  %reass.mul662 = fmul fast <4 x float> %i.tg, %reass.add661
  %i.ty = fadd fast <4 x float> %reass.mul.a, %i.tf
  ...
  %i.uy = fadd fast <4 x float> %i.ul, splat (float 1.000000e+00)
  %i.uz = fadd fast <4 x float> %i.uy, %i.ux
...
.thread:                                          ; preds = %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit
  ...
  store i64 %i.wb, ptr %.1200799, align 1, !tbaa !245
  %i.wc = getelementptr inbounds nuw i8, ptr %.1200799, i64 8
  br label %bb.aa

bb.z:                                             ; preds = %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit
  %i.wd = bitcast <4 x float> %.0.i to <8 x i16>  ; 4 uses
  %i.we = extractelement <8 x i16> %i.wd, i64 1
  store i16 %i.we, ptr %.1200799, align 2, !tbaa !328
  %i.wf = extractelement <8 x i16> %i.wd, i64 3
  %i.wg = load i64, ptr %19, align 8, !tbaa !248  ; 3 uses
  %i.wh = getelementptr inbounds nuw [2 x i8], ptr %.1200799, i64 %i.wg
  store i16 %i.wf, ptr %i.wh, align 2, !tbaa !328
  %i.wi = extractelement <8 x i16> %i.wd, i64 5
  %.idx = shl i64 %i.wg, 2
  %i.wj = getelementptr inbounds nuw i8, ptr %.1200799, i64 %.idx
  store i16 %i.wi, ptr %i.wj, align 2, !tbaa !328
  %i.wk = extractelement <8 x i16> %i.wd, i64 7
  %.idx222 = mul i64 %i.wg, 6
  %i.wl = getelementptr inbounds nuw i8, ptr %.1200799, i64 %.idx222
  store i16 %i.wk, ptr %i.wl, align 2, !tbaa !328
  %i.wm = getelementptr inbounds nuw i8, ptr %.1200799, i64 2
  br label %bb.aa

bb.aa:                                            ; preds = %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit, %.thread, %bb.z
  %.3 = phi ptr [ %i.wm, %bb.z ], [ %.1200799, %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit ], [ %i.wc, %.thread ] ; 2 uses
  %i.wn = add nuw nsw i32 %.0197800, 1            ; 2 uses
