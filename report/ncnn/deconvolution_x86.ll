...
.preheader911.i:                                  ; preds = %._crit_edge.i, %_ZN4ncnn3MatD2Ev.exit457.i
  ...
  %.03821068.i = phi ptr [ %i.if, %_ZN4ncnn3MatD2Ev.exit457.i ], [ %i.vn, %._crit_edge.i ]
  %.03841067.i = phi ptr [ %i.id, %_ZN4ncnn3MatD2Ev.exit457.i ], [ %i.vm, %._crit_edge.i ]
...
bb.v:                                             ; preds = %_ZL13activation_ssfiRKN4ncnn3MatE.exit542.i, %.preheader911.i
  %.03801065.i = phi i32 [ 0, %.preheader911.i ], [ %i.vo, %_ZL13activation_ssfiRKN4ncnn3MatE.exit542.i ] ; 4 uses
  %.13831064.i = phi ptr [ %.03821068.i, %.preheader911.i ], [ %i.vn, %_ZL13activation_ssfiRKN4ncnn3MatE.exit542.i ] ; 2 uses
  %.13851063.i = phi ptr [ %.03841067.i, %.preheader911.i ], [ %i.vm, %_ZL13activation_ssfiRKN4ncnn3MatE.exit542.i ] ; 2 uses
