...
._crit_edge.i:                                    ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  ...
  br i1 %exitcond897.not.i, label %._crit_edge698.split.i, label %.preheader693.i, !llvm.loop !103
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  br i1 %exitcond.not.i.3, label %._crit_edge.i, label %scalar.ph, !llvm.loop !104
...
bb.cx:                                            ; preds = %.invoke.i, %.invoke1069.i
  ...
  %i.lh = load ptr, ptr %i.lg, align 8, !tbaa !18 ; 2 uses
...
.noexc470.lr.ph.i:                                ; preds = %.invoke1069.i
  %i.nd = load ptr, ptr %i.iq, align 8, !tbaa !20, !noalias !192
  %i.ne = getelementptr inbounds nuw i8, ptr %0, i64 584
  %i.nf = load i64, ptr %i.ne, align 8, !tbaa !21, !noalias !192
  %i.ng = getelementptr inbounds nuw i8, ptr %0, i64 536
  %i.nh = load i64, ptr %i.ng, align 8, !tbaa !55, !noalias !192
...
.noexc462.lr.ph.i:                                ; preds = %.preheader682.i
  %i.oa = load ptr, ptr %i.iq, align 8, !tbaa !20, !noalias !193
  %i.ob = getelementptr inbounds nuw i8, ptr %0, i64 584
  %i.oc = load i64, ptr %i.ob, align 8, !tbaa !21, !noalias !193
  %i.od = getelementptr inbounds nuw i8, ptr %0, i64 536
  %i.oe = load i64, ptr %i.od, align 8, !tbaa !55, !noalias !193
...
.preheader687.us.i:                               ; preds = %.preheader687.us.i, %.preheader690.us.i
  ...
  br i1 %exitcond913.not.i, label %._crit_edge710.us.i, label %.preheader687.us.i, !llvm.loop !109
...
._crit_edge710.us.i:                              ; preds = %.preheader687.us.i
  ...
  br i1 %i.rb, label %.preheader690.us.i, label %.preheader692.loopexit.i, !llvm.loop !110
...
.preheader689.preheader.i:                        ; preds = %.preheader692.i.thread, %.preheader689.lr.ph.i
  ...
  %.0283.lcssa.i125129 = phi i32 [ %.0283.lcssa.i, %.preheader689.lr.ph.i ], [ %i.nm, %.preheader692.i.thread ] ; 2 uses
  %i.rj = add i32 %.0283.lcssa.i125129, 2
  %reass.sub = sub i32 %15, %.0283.lcssa.i125129
  %i.rk = and i32 %reass.sub, -2
  %i.rl = add i32 %i.rj, %i.rk
...
.preheader689.us.preheader.i:                     ; preds = %.preheader689.lr.ph.i
  ...
  %.reass.us734.i = mul i64 %factor.op.mul716.i, %indvars.iv945.i ; 4 uses
  %i.ro = or disjoint i64 %indvars.iv945.i, 1
  %.reass.us734.1.i = mul i64 %factor.op.mul716.i, %i.ro ; 4 uses
  %i.rp = or disjoint i64 %indvars.iv945.i, 2
  %.reass.us734.2.i = mul i64 %factor.op.mul716.i, %i.rp ; 4 uses
  %i.rq = or disjoint i64 %indvars.iv945.i, 3     ; 2 uses
  %.reass.us734.3.i = mul i64 %factor.op.mul716.i, %i.rq ; 4 uses
...
vector.body372:                                   ; preds = %vector.body372, %vector.ph370
  ...
  %i.us = getelementptr i8, ptr %i.ur, i64 %.reass.us734.i
  %wide.load375.a = load <4 x float>, ptr %i.us, align 4, !tbaa !39, !alias.scope !194
  %i.ut = getelementptr i8, ptr %i.ur, i64 %.reass.us734.1.i
  %wide.load376.a = load <4 x float>, ptr %i.ut, align 4, !tbaa !39, !alias.scope !195
  %i.uu = getelementptr i8, ptr %i.ur, i64 %.reass.us734.2.i
  %wide.load377.a = load <4 x float>, ptr %i.uu, align 4, !tbaa !39, !alias.scope !196
  %i.uv = getelementptr i8, ptr %i.ur, i64 %.reass.us734.3.i
  %wide.load378.a = load <4 x float>, ptr %i.uv, align 4, !tbaa !39, !alias.scope !197
  %i.uw = getelementptr i8, ptr %i.uq, i64 %.reass722.us.1.i ; 4 uses
  %i.ux = getelementptr i8, ptr %i.uw, i64 %.reass.us734.i
  %wide.load379.a = load <4 x float>, ptr %i.ux, align 4, !tbaa !39, !alias.scope !198
  %i.uy = getelementptr i8, ptr %i.uw, i64 %.reass.us734.1.i
  %wide.load380.a = load <4 x float>, ptr %i.uy, align 4, !tbaa !39, !alias.scope !199
  %i.uz = getelementptr i8, ptr %i.uw, i64 %.reass.us734.2.i
  %wide.load381 = load <4 x float>, ptr %i.uz, align 4, !tbaa !39, !alias.scope !200
  %i.va = getelementptr i8, ptr %i.uw, i64 %.reass.us734.3.i
  %wide.load382 = load <4 x float>, ptr %i.va, align 4, !tbaa !39, !alias.scope !201
  ...
  store <32 x float> %interleaved.vec383, ptr %next.gep374, align 4, !tbaa !39, !alias.scope !202, !noalias !203
  %index.next384 = add nuw i64 %index373, 4       ; 2 uses
  %i.vh = icmp eq i64 %index.next384, %n.vec371
  br i1 %i.vh, label %middle.block385, label %vector.body372, !llvm.loop !121
...
.preheader686.us.i:                               ; preds = %.preheader686.us.i.preheader, %.preheader686.us.i
  ...
  %gep.us733.i = getelementptr i8, ptr %invariant.gep723.us.i, i64 %.reass722.us.i ; 4 uses
  %gep718.us.i = getelementptr i8, ptr %gep.us733.i, i64 %.reass.us734.i
  ...
  %gep718.us.1.i = getelementptr i8, ptr %gep.us733.i, i64 %.reass.us734.1.i
  ...
  %gep718.us.2.i = getelementptr i8, ptr %gep.us733.i, i64 %.reass.us734.2.i
  ...
  %gep718.us.3.i = getelementptr i8, ptr %gep.us733.i, i64 %.reass.us734.3.i
  ...
  %gep.us733.1.i = getelementptr i8, ptr %invariant.gep723.us.i, i64 %.reass722.us.1.i ; 4 uses
  %gep718.us.1924.i = getelementptr i8, ptr %gep.us733.1.i, i64 %.reass.us734.i
  ...
  %gep718.us.1.1.i = getelementptr i8, ptr %gep.us733.1.i, i64 %.reass.us734.1.i
  ...
  %gep718.us.2.1.i = getelementptr i8, ptr %gep.us733.1.i, i64 %.reass.us734.2.i
...
vector.body308:                                   ; preds = %vector.body308, %vector.ph306
  ...
  %wide.load310.a = load <4 x float>, ptr %i.yg, align 4, !tbaa !39, !alias.scope !204
  %i.yh = getelementptr i8, ptr %i.yf, i64 %.reass.1.i
  %wide.load311.a = load <4 x float>, ptr %i.yh, align 4, !tbaa !39, !alias.scope !205
  %i.yi = getelementptr i8, ptr %i.yf, i64 %.reass.2.i
  %wide.load312 = load <4 x float>, ptr %i.yi, align 4, !tbaa !39, !alias.scope !206
  %i.yj = getelementptr i8, ptr %i.yf, i64 %.reass.3.i
  %wide.load313 = load <4 x float>, ptr %i.yj, align 4, !tbaa !39, !alias.scope !207
  ...
  store <16 x float> %interleaved.vec, ptr %next.gep, align 4, !tbaa !39, !alias.scope !208, !noalias !209
  %index.next314 = add nuw i64 %index309, 4       ; 2 uses
  %i.ym = icmp eq i64 %index.next314, %n.vec307
  br i1 %i.ym, label %middle.block315, label %vector.body308, !llvm.loop !130
...
.preheader685.i:                                  ; preds = %.preheader685.i.prol.loopexit, %.preheader685.i
  ...
  br i1 %exitcond941.not.i.1, label %._crit_edge745.i, label %.preheader685.i, !llvm.loop !131
...
._crit_edge745.i:                                 ; preds = %.preheader685.i.prol.loopexit, %.preheader685.i, %middle.block315
  ...
  br i1 %i.zo, label %.preheader688.i, label %._crit_edge748.split.i, !llvm.loop !132
...
._crit_edge748.split.i:                           ; preds = %._crit_edge745.i, %.preheader688.lr.ph.i, %.preheader691.i
  ...
  br i1 %i.zq, label %.noexc470.i, label %.preheader682.loopexit.i, !llvm.loop !133
...
.noexc454.lr.ph.i:                                ; preds = %.preheader671.i
  %i.zt = load ptr, ptr %i.iq, align 8, !tbaa !20, !noalias !210
  %i.zu = getelementptr inbounds nuw i8, ptr %0, i64 584
  %i.zv = load i64, ptr %i.zu, align 8, !tbaa !21, !noalias !210
  %i.zw = getelementptr inbounds nuw i8, ptr %0, i64 536
  %i.zx = load i64, ptr %i.zw, align 8, !tbaa !55, !noalias !210
...
vector.body536:                                   ; preds = %vector.body536, %vector.ph534
  ...
  %wide.load539.a = load <4 x float>, ptr %i.ady, align 4, !tbaa !39, !alias.scope !211
  %i.adz = getelementptr i8, ptr %i.adx, i64 %.reass758.us.1.i
  %wide.load540.a = load <4 x float>, ptr %i.adz, align 4, !tbaa !39, !alias.scope !212
  %i.aea = getelementptr i8, ptr %i.adx, i64 %.reass758.us.2.i
  %wide.load541.a = load <4 x float>, ptr %i.aea, align 4, !tbaa !39, !alias.scope !213
  %i.aeb = getelementptr i8, ptr %i.adx, i64 %.reass758.us.3.i
  %wide.load542.a = load <4 x float>, ptr %i.aeb, align 4, !tbaa !39, !alias.scope !214
  %i.aec = getelementptr i8, ptr %i.adw, i64 %.reass763.us.1.i ; 4 uses
  %i.aed = getelementptr i8, ptr %i.aec, i64 %.reass758.us.i
  %wide.load543.a = load <4 x float>, ptr %i.aed, align 4, !tbaa !39, !alias.scope !215
  %i.aee = getelementptr i8, ptr %i.aec, i64 %.reass758.us.1.i
  %wide.load544.a = load <4 x float>, ptr %i.aee, align 4, !tbaa !39, !alias.scope !216
  %i.aef = getelementptr i8, ptr %i.aec, i64 %.reass758.us.2.i
  %wide.load545 = load <4 x float>, ptr %i.aef, align 4, !tbaa !39, !alias.scope !217
  %i.aeg = getelementptr i8, ptr %i.aec, i64 %.reass758.us.3.i
  %wide.load546 = load <4 x float>, ptr %i.aeg, align 4, !tbaa !39, !alias.scope !218
  ...
  store <32 x float> %interleaved.vec547, ptr %next.gep538, align 4, !tbaa !39, !alias.scope !219, !noalias !220
  %index.next548 = add nuw i64 %index537, 4       ; 2 uses
  %i.aen = icmp eq i64 %index.next548, %n.vec535
  br i1 %i.aen, label %middle.block549, label %vector.body536, !llvm.loop !146
...
.preheader676.us.i:                               ; preds = %.preheader676.us.i.preheader, %.preheader676.us.i
  ...
  br i1 %exitcond960.not.i, label %._crit_edge770.us.i, label %.preheader676.us.i, !llvm.loop !147
...
._crit_edge770.us.i:                              ; preds = %.preheader676.us.i, %middle.block549
  ...
  br i1 %i.afe, label %.preheader679.us.i, label %.preheader681.loopexit.i, !llvm.loop !148
...
.preheader678.preheader.i:                        ; preds = %.preheader681.i.thread, %.preheader678.lr.ph.i
  ...
  %.0264.lcssa.i134138 = phi i32 [ %.0264.lcssa.i, %.preheader678.lr.ph.i ], [ %i.ok, %.preheader681.i.thread ] ; 2 uses
  %i.afm = add i32 %.0264.lcssa.i134138, 2
  %reass.sub165 = sub i32 %16, %.0264.lcssa.i134138
  %i.afn = and i32 %reass.sub165, -2
  %i.afo = add i32 %i.afm, %i.afn
...
vector.body456:                                   ; preds = %vector.body456, %vector.ph454
  ...
  %wide.load459.a = load <4 x float>, ptr %i.agz, align 4, !tbaa !39, !alias.scope !221
  %i.aha = getelementptr i8, ptr %i.agy, i64 %.reass780.us.1.i
  %wide.load460.a = load <4 x float>, ptr %i.aha, align 4, !tbaa !39, !alias.scope !222
  %i.ahb = getelementptr i8, ptr %i.agx, i64 %.reass785.us.1.i ; 2 uses
  %i.ahc = getelementptr i8, ptr %i.ahb, i64 %.reass780.us.i
  %wide.load461 = load <4 x float>, ptr %i.ahc, align 4, !tbaa !39, !alias.scope !223
  %i.ahd = getelementptr i8, ptr %i.ahb, i64 %.reass780.us.1.i
  %wide.load462 = load <4 x float>, ptr %i.ahd, align 4, !tbaa !39, !alias.scope !224
  ...
  store <16 x float> %interleaved.vec463, ptr %next.gep458, align 4, !tbaa !39, !alias.scope !225, !noalias !226
  %index.next464 = add nuw i64 %index457, 4       ; 2 uses
  %i.ahg = icmp eq i64 %index.next464, %n.vec455
  br i1 %i.ahg, label %middle.block465, label %vector.body456, !llvm.loop !155
...
.preheader675.us.i:                               ; preds = %.preheader675.us.i.prol.loopexit, %.preheader675.us.i
  ...
  br i1 %exitcond976.not.i.1, label %._crit_edge792.us.i, label %.preheader675.us.i, !llvm.loop !156
...
._crit_edge792.us.i:                              ; preds = %.preheader675.us.i.prol.loopexit, %.preheader675.us.i, %middle.block465
  ...
  br i1 %i.aij, label %.preheader678.us.i, label %.preheader680.i, !llvm.loop !157
...
vector.body640:                                   ; preds = %vector.body640, %vector.ph638
  ...
  %wide.load643.a = load <4 x float>, ptr %i.ang, align 4, !tbaa !39, !alias.scope !231
  %i.anh = getelementptr i8, ptr %i.anf, i64 %.reass824.us.1.i
  %wide.load644.a = load <4 x float>, ptr %i.anh, align 4, !tbaa !39, !alias.scope !232
  %i.ani = getelementptr i8, ptr %i.anf, i64 %.reass824.us.2.i
  %wide.load645 = load <4 x float>, ptr %i.ani, align 4, !tbaa !39, !alias.scope !233
  %i.anj = getelementptr i8, ptr %i.anf, i64 %.reass824.us.3.i
  %wide.load646 = load <4 x float>, ptr %i.anj, align 4, !tbaa !39, !alias.scope !234
  ...
  store <16 x float> %interleaved.vec647, ptr %next.gep642, align 4, !tbaa !39, !alias.scope !235, !noalias !236
  %index.next648 = add nuw i64 %index641, 4       ; 2 uses
  %i.anm = icmp eq i64 %index.next648, %n.vec639
  br i1 %i.anm, label %middle.block649, label %vector.body640, !llvm.loop !173
...
.preheader665.us.i:                               ; preds = %.preheader665.us.i.prol.loopexit, %.preheader665.us.i
  ...
  br i1 %exitcond1002.not.i.1, label %._crit_edge830.us.i, label %.preheader665.us.i, !llvm.loop !174
...
._crit_edge830.us.i:                              ; preds = %.preheader665.us.i.prol.loopexit, %.preheader665.us.i, %middle.block649
  ...
  br i1 %i.aon, label %.preheader668.us.i, label %.preheader670.loopexit.i, !llvm.loop !175
...
.preheader670.i:                                  ; preds = %.preheader670.loopexit.i, %.preheader668.lr.ph.i, %.noexc454.i
  ...
  %.0252.lcssa.i = phi i32 [ 0, %.noexc454.i ], [ %i.aoo, %.preheader670.loopexit.i ], [ %i.aad, %.preheader668.lr.ph.i ] ; 5 uses
...
.preheader667.preheader.i:                        ; preds = %.preheader667.lr.ph.i
  %i.aoz = add i32 %.0252.lcssa.i, 2
  %reass.sub166 = sub i32 %17, %.0252.lcssa.i
  %i.apa = and i32 %reass.sub166, -2
  %i.apb = add i32 %i.aoz, %i.apa
...
vector.body590:                                   ; preds = %vector.body590, %vector.ph588
  ...
  %wide.load594.a = load <2 x float>, ptr %i.apz, align 4, !tbaa !39, !alias.scope !237
  %wide.load595.a = load <2 x float>, ptr %i.aqa, align 4, !tbaa !39, !alias.scope !237
  %i.aqb = getelementptr i8, ptr %i.apy, i64 %.reass840.us.1.i ; 2 uses
  %i.aqc = getelementptr i8, ptr %i.aqb, i64 8
  %wide.load596 = load <2 x float>, ptr %i.aqb, align 4, !tbaa !39, !alias.scope !238
  %wide.load597 = load <2 x float>, ptr %i.aqc, align 4, !tbaa !39, !alias.scope !238
  %interleaved.vec598 = shufflevector <2 x float> %wide.load594.a, <2 x float> %wide.load596, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x float> %interleaved.vec598, ptr %next.gep592, align 4, !tbaa !39, !alias.scope !239, !noalias !240
  %interleaved.vec599 = shufflevector <2 x float> %wide.load595.a, <2 x float> %wide.load597, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x float> %interleaved.vec599, ptr %next.gep593, align 4, !tbaa !39, !alias.scope !239, !noalias !240
  %index.next600 = add nuw i64 %index591, 4       ; 2 uses
  %i.aqd = icmp eq i64 %index.next600, %n.vec589
  br i1 %i.aqd, label %middle.block601, label %vector.body590, !llvm.loop !180
...
.preheader.us.i.prol:                             ; preds = %.preheader.us.i.preheader, %.preheader.us.i.prol
  ...
  br i1 %prol.iter682.cmp.not, label %.preheader.us.i.prol.loopexit, label %.preheader.us.i.prol, !llvm.loop !181
...
.preheader.us.i:                                  ; preds = %.preheader.us.i.prol.loopexit, %.preheader.us.i
  ...
  br i1 %exitcond1014.not.i.3, label %._crit_edge846.us.i, label %.preheader.us.i, !llvm.loop !182
...
._crit_edge846.us.i:                              ; preds = %.preheader.us.i.prol.loopexit, %.preheader.us.i, %middle.block601
  ...
  br i1 %i.arf, label %.preheader667.us.i, label %.preheader669.i, !llvm.loop !183
...
bb.ai:                                            ; preds = %bb.u
  ...
  %i.hc = load i32, ptr %i.bk, align 8, !tbaa !70
  %i.hd = mul nsw i32 %i.hc, %i.bi
  %i.he = load i32, ptr %i.o, align 4, !tbaa !60
  %i.hf = load i32, ptr %i.bc, align 4, !tbaa !69
  %i.hg = mul nsw i32 %i.hf, %i.he
  %i.hh = sub nsw i32 %i.hd, %i.hg
  %i.hi = select i1 %i.by, i32 2, i32 0
  %i.hj = shl i32 %i.hh, %i.hi
  store i32 %i.hj, ptr %i.s, align 4, !tbaa !60
  %i.hk = getelementptr inbounds nuw i8, ptr %3, i64 4
  %i.hl = load i32, ptr %i.hk, align 4, !tbaa !81
...
bb.ak:                                            ; preds = %bb.ai, %bb.aj
  ...
  %i.hs = load ptr, ptr %i.fw, align 8, !tbaa !18 ; 2 uses
...
bb.am:                                            ; preds = %bb.al
  %i.hv = load ptr, ptr %i.fx, align 8, !tbaa !19 ; 3 uses
  %.not3.i72 = icmp eq ptr %i.hv, null
  %i.hw = load ptr, ptr %6, align 8, !tbaa !20    ; 3 uses
  br i1 %.not3.i72, label %bb.ao, label %bb.an

bb.an:                                            ; preds = %bb.am
  %i.hx = load ptr, ptr %i.hv, align 8, !tbaa !12
  ...
  invoke void %i.hz(ptr noundef nonnull align 8 dereferenceable(8) %i.hv, ptr noundef %i.hw)
          to label %_ZN4ncnn3MatD2Ev.exit69 unwind label %bb.aq, !inline_history !0
...
_ZN4ncnn3MatD2Ev.exit69:                          ; preds = %bb.al, %bb.ak, %bb.an, %bb.ao, %bb.ap
  ...
  %i.ic = load ptr, ptr %i.eu, align 8, !tbaa !18 ; 2 uses
...
bb.as:                                            ; preds = %bb.ar
  %i.if = load ptr, ptr %i.fc, align 16, !tbaa !19 ; 3 uses
  %.not3.i76 = icmp eq ptr %i.if, null
  %i.ig = load ptr, ptr %5, align 16, !tbaa !20   ; 3 uses
  br i1 %.not3.i76, label %bb.au, label %bb.at

bb.at:                                            ; preds = %bb.as
  %i.ih = load ptr, ptr %i.if, align 8, !tbaa !12
  ...
  invoke void %i.ij(ptr noundef nonnull align 8 dereferenceable(8) %i.if, ptr noundef %i.ig)
          to label %_ZN4ncnn3MatD2Ev.exit68 unwind label %bb.aw, !inline_history !0
...
bb.ax:                                            ; preds = %bb.r
  ...
  %i.io = load i32, ptr %i.an, align 4, !tbaa !67 ; 2 uses
  %i.ip = load i32, ptr %i.au, align 8, !tbaa !68 ; 2 uses
  %i.iq = load i32, ptr %i.bc, align 4, !tbaa !69
  %i.ir = load i32, ptr %i.bk, align 8, !tbaa !70
  ...
  store i32 %i.eo, ptr %i.a, align 4, !tbaa !60
  store i32 %i.ep, ptr %i.b, align 4, !tbaa !60
  store i32 %i.io, ptr %i.c, align 4, !tbaa !60
  store i32 %i.ip, ptr %i.d, align 4, !tbaa !60
  store i32 %i.iq, ptr %i.e, align 4, !tbaa !60
  store i32 %i.ir, ptr %i.f, align 4, !tbaa !60
  store i32 %i.it, ptr %i.g, align 4, !tbaa !60
  %i.iv = load i32, ptr %i.cg, align 8, !tbaa !59 ; 2 uses
  ...
  store i64 %i.iy, ptr %i.h, align 8, !tbaa !82
  ...
  store i32 %i.jb, ptr %i.i, align 4, !tbaa !60
  ...
  store i32 %i.je, ptr %i.j, align 4, !tbaa !60
  call void @llvm.lifetime.start.p0(ptr nonnull %i.k) #10
  store i32 %i.eq, ptr %i.k, align 4, !tbaa !60
  call void @llvm.lifetime.start.p0(ptr nonnull %i.l) #10
  %i.jf = load ptr, ptr %i.in, align 8, !tbaa !20
  store ptr %i.jf, ptr %i.l, align 8, !tbaa !84
  ...
  store i32 %i.jg, ptr %i.m, align 4, !tbaa !60
  ...
  %i.jj = load i32, ptr %i.m, align 4, !tbaa !60
  %i.jk = shl nsw i32 %i.jj, 2
  %i.jl = load i32, ptr %i.n, align 4, !tbaa !60
  %i.jm = add nsw i32 %i.jl, %i.jk                ; 5 uses
  store i32 %i.jm, ptr %i.n, align 4, !tbaa !60
  %i.jn = sub nsw i32 %i.iw, %i.jm                ; 2 uses
  %i.jo = sdiv i32 %i.jn, 2                       ; 3 uses
  store i32 %i.jo, ptr %i.m, align 4, !tbaa !60
...
_ZN4ncnn3MatD2Ev.exit450.lr.ph.i:                 ; preds = %._crit_edge1064.split.i
  ...
  %i.ky = mul i32 %i.kx, %.fr1092.i               ; 9 uses
...
.preheader903.i:                                  ; preds = %._crit_edge.i, %_ZN4ncnn3MatD2Ev.exit457.i
  ...
  %.03821060.i = phi ptr [ %i.me, %_ZN4ncnn3MatD2Ev.exit457.i ], [ %i.xs, %._crit_edge.i ]
  %.03841059.i = phi ptr [ %i.mc, %_ZN4ncnn3MatD2Ev.exit457.i ], [ %i.xr, %._crit_edge.i ]
...
bb.ay:                                            ; preds = %_ZL13activation_ssfiRKN4ncnn3MatE.exit542.i, %.preheader903.i
  %.03801057.i = phi i32 [ 0, %.preheader903.i ], [ %i.xt, %_ZL13activation_ssfiRKN4ncnn3MatE.exit542.i ] ; 4 uses
  %.13831056.i = phi ptr [ %.03821060.i, %.preheader903.i ], [ %i.xs, %_ZL13activation_ssfiRKN4ncnn3MatE.exit542.i ] ; 2 uses
  %.13851055.i = phi ptr [ %.03841059.i, %.preheader903.i ], [ %i.xr, %_ZL13activation_ssfiRKN4ncnn3MatE.exit542.i ] ; 2 uses
...
._crit_edge950.i:                                 ; preds = %._crit_edge.split.us.us.us.i, %.preheader901.lr.ph.i, %_ZN4ncnn3MatD2Ev.exit455.i
  ...
  %.0342.lcssa.i = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit455.i ], [ %i.kk, %.preheader901.lr.ph.i ], [ %i.kr, %._crit_edge.split.us.us.us.i ] ; 7 uses
...
.preheader900.preheader.i:                        ; preds = %.preheader900.lr.ph.i
  %reass.sub = sub i32 %8, %.0342.lcssa.i         ; 2 uses
  %i.qy = lshr i32 %reass.sub, 1
...
.preheader900.us.preheader.i:                     ; preds = %.preheader900.lr.ph.split.us.i
  %reass.sub168 = sub i32 %8, %.0342.lcssa.i      ; 2 uses
  %i.rh = lshr i32 %reass.sub168, 1
...
.preheader900.us.us.i:                            ; preds = %._crit_edge.split.us.us.us1012.i, %.preheader900.us.us.preheader.i
  ...
  %i.rr = phi <2 x float> [ %i.qo, %.preheader900.us.us.preheader.i ], [ %i.tf, %._crit_edge.split.us.us.us1012.i ]
...
bb.bg:                                            ; preds = %..loopexit896_crit_edge.us.us.us.i, %.preheader900.us.us.i
  ...
  %i.rt = phi <2 x float> [ %i.tf, %..loopexit896_crit_edge.us.us.us.i ], [ %i.rr, %.preheader900.us.us.i ] ; 3 uses
...
.preheader895.us.us.us.i:                         ; preds = %bb.bh
  %i.rz = mul nuw nsw i64 %indvars.iv1303.i, %i.rp
  %i.sa = sext i32 %i.ry to i64
  %i.sb = mul nsw i64 %i.sa, %i.kq
  br label %bb.bi
...
bb.bi:                                            ; preds = %.loopexit892.us.us.us.i, %.preheader895.us.us.us.i
  ...
  %i.sc = phi <2 x float> [ %i.te, %.loopexit892.us.us.us.i ], [ %i.rt, %.preheader895.us.us.us.i ] ; 3 uses
  %i.sd = trunc i64 %indvars.iv1298.i to i32
  %i.se = mul i32 %i.qv, %i.sd
  %.reass978.us.us.us.i = add i32 %invariant.op977.i, %i.se ; 3 uses
  %i.sf = icmp slt i32 %.reass978.us.us.us.i, 0
  br i1 %i.sf, label %.loopexit892.us.us.us.i, label %bb.bj

bb.bj:                                            ; preds = %bb.bi
  %i.sg = srem i32 %.reass978.us.us.us.i, %i.qx
  %i.sh = sdiv i32 %.reass978.us.us.us.i, %i.qx   ; 2 uses
  %.not440.us.us.us.i = icmp eq i32 %i.sg, 0
  %.not441.us.us.us.i = icmp slt i32 %i.sh, %i.ju
...
_ZN4ncnn3MatD2Ev.exit452.us.us.us.i:              ; preds = %bb.bj
  %i.si = add nuw nsw i64 %indvars.iv1298.i, %i.rz
  %i.sj = shl i64 %i.si, 2
  %i.sk = and i64 %i.sj, 4294967292
  %i.sl = getelementptr inbounds nuw [4 x i8], ptr %.1346993.us.us.i, i64 %i.sk
  %i.sm = load ptr, ptr %1, align 8, !tbaa !20, !noalias !311
  %i.sn = load i64, ptr %i.ke, align 8, !tbaa !21, !noalias !311
  %i.so = load i64, ptr %i.ak, align 8, !tbaa !55, !noalias !311 ; 2 uses
  %factor.op.mul.us.us.us.i = mul i64 %i.so, %i.sn ; 2 uses
  %i.sp = mul i64 %i.sb, %i.so
  %invariant.gep.us.us.us.i = getelementptr i8, ptr %i.sm, i64 %i.sp
  %i.sq = sext i32 %i.sh to i64
  %invariant.gep967.us.us.us.i = getelementptr [4 x i8], ptr %invariant.gep.us.us.us.i, i64 %i.sq ; 2 uses
  ...
  %i.sr = load float, ptr %gep968.us.us.us.i, align 4, !tbaa !39
  ...
  %i.ss = load float, ptr %gep968.us.us.us.1.i, align 4, !tbaa !39
  %i.st = load <4 x float>, ptr %i.sl, align 4, !tbaa !39 ; 2 uses
  %i.su = shufflevector <4 x float> %i.st, <4 x float> poison, <2 x i32> <i32 0, i32 2>
  %i.sv = insertelement <2 x float> poison, float %i.sr, i64 0
  %i.sw = shufflevector <2 x float> %i.sv, <2 x float> poison, <2 x i32> zeroinitializer
  %i.sx = fmul fast <2 x float> %i.su, %i.sw
  %i.sy = fadd fast <2 x float> %i.sc, %i.sx
  %i.sz = shufflevector <4 x float> %i.st, <4 x float> poison, <2 x i32> <i32 1, i32 3>
  %i.ta = insertelement <2 x float> poison, float %i.ss, i64 0
  %i.tb = shufflevector <2 x float> %i.ta, <2 x float> poison, <2 x i32> zeroinitializer
  %i.tc = fmul fast <2 x float> %i.sz, %i.tb
  %i.td = fadd fast <2 x float> %i.tc, %i.sy
  br label %.loopexit892.us.us.us.i

.loopexit892.us.us.us.i:                          ; preds = %_ZN4ncnn3MatD2Ev.exit452.us.us.us.i, %bb.bj, %bb.bi
  %i.te = phi <2 x float> [ %i.sc, %bb.bi ], [ %i.sc, %bb.bj ], [ %i.td, %_ZN4ncnn3MatD2Ev.exit452.us.us.us.i ] ; 2 uses
...
..loopexit896_crit_edge.us.us.us.i:               ; preds = %.loopexit892.us.us.us.i, %bb.bh, %bb.bg
  %i.tf = phi <2 x float> [ %i.rt, %bb.bg ], [ %i.rt, %bb.bh ], [ %i.te, %.loopexit892.us.us.us.i ] ; 3 uses
...
._crit_edge.split.us.us.us1012.i:                 ; preds = %..loopexit896_crit_edge.us.us.us.i
  ...
  br i1 %i.tj, label %.preheader900.us.us.i, label %.preheader902.i, !llvm.loop !275
...
.preheader902.i:                                  ; preds = %._crit_edge.split.us.us.us1012.i, %.preheader900.us.preheader.i, %.preheader900.preheader.i, %._crit_edge950.i
  ...
  %i.tk = phi <2 x float> [ %i.qo, %._crit_edge950.i ], [ %i.qo, %.preheader900.preheader.i ], [ %i.qo, %.preheader900.us.preheader.i ], [ %i.tf, %._crit_edge.split.us.us.us1012.i ] ; 3 uses
...
.preheader899.us.us.i:                            ; preds = %._crit_edge.split.us.us.us1052.i, %.preheader899.us.us.preheader.i
  ...
  %i.tw = phi <2 x float> [ %i.tk, %.preheader899.us.us.preheader.i ], [ %i.vf, %._crit_edge.split.us.us.us1052.i ]
  br label %bb.bk
...
bb.bk:                                            ; preds = %..loopexit894_crit_edge.us.us.us.i, %.preheader899.us.us.i
  ...
  %i.tx = phi <2 x float> [ %i.vf, %..loopexit894_crit_edge.us.us.us.i ], [ %i.tw, %.preheader899.us.us.i ] ; 3 uses
...
.preheader893.us.us.us.i:                         ; preds = %bb.bl
  %i.ud = mul nuw nsw i64 %indvars.iv1316.i, %i.tu
  %i.ue = sext i32 %i.uc to i64
  %i.uf = mul nsw i64 %i.ue, %i.kq
  br label %bb.bm
...
bb.bm:                                            ; preds = %bb.bo, %.preheader893.us.us.us.i
  ...
  %i.ug = phi <2 x float> [ %i.ve, %bb.bo ], [ %i.tx, %.preheader893.us.us.us.i ] ; 3 uses
  %i.uh = trunc i64 %indvars.iv1311.i to i32
  %i.ui = mul i32 %i.tq, %i.uh
  %.reass.us1031.us.us.i = add i32 %invariant.op1022.i, %i.ui ; 3 uses
  %i.uj = icmp slt i32 %.reass.us1031.us.us.i, 0
  br i1 %i.uj, label %bb.bo, label %bb.bn

bb.bn:                                            ; preds = %bb.bm
  %i.uk = srem i32 %.reass.us1031.us.us.i, %i.ts
  %i.ul = sdiv i32 %.reass.us1031.us.us.i, %i.ts  ; 2 uses
  %.not436.us.us.us.i = icmp eq i32 %i.uk, 0
  %.not437.us.us.us.i = icmp slt i32 %i.ul, %i.ju
...
_ZN4ncnn3MatD2Ev.exit451.us.us.us.i:              ; preds = %bb.bn
  %i.um = add nuw nsw i64 %indvars.iv1311.i, %i.ud
  %.idx.i = shl nuw nsw i64 %i.um, 3
  %i.un = getelementptr inbounds nuw i8, ptr %.23471037.us.us.i, i64 %.idx.i
  %i.uo = load ptr, ptr %1, align 8, !tbaa !20, !noalias !312
  %i.up = load i64, ptr %i.ke, align 8, !tbaa !21, !noalias !312
  %i.uq = mul i64 %i.up, %indvars.iv1321.i
  %i.ur = load i64, ptr %i.ak, align 8, !tbaa !55, !noalias !312 ; 2 uses
  %i.us = mul i64 %i.uq, %i.ur
  %i.ut = getelementptr inbounds nuw i8, ptr %i.uo, i64 %i.us
  %i.uu = mul i64 %i.uf, %i.ur
  %i.uv = getelementptr inbounds nuw i8, ptr %i.ut, i64 %i.uu
  %i.uw = sext i32 %i.ul to i64
  %i.ux = getelementptr inbounds [4 x i8], ptr %i.uv, i64 %i.uw
  %i.uy = load float, ptr %i.ux, align 4, !tbaa !39
  %i.uz = load <2 x float>, ptr %i.un, align 4, !tbaa !39
  %i.va = insertelement <2 x float> poison, float %i.uy, i64 0
  %i.vb = shufflevector <2 x float> %i.va, <2 x float> poison, <2 x i32> zeroinitializer
  %i.vc = fmul fast <2 x float> %i.uz, %i.vb
end_hunk_3
begin_hunk_4_@_ZNK4ncnn17Deconvolution_x867forwardERKNS_3MatERS1_RKNS_6OptionE:bb.a
  %invariant.op1098.i = sub i32 %.neg867.i, %i.yt ; 2 uses
  %i.yu = load i32, ptr %i.f, align 4             ; 4 uses
  %i.yv = load i32, ptr %i.a, align 4
  %.fr1226.i = freeze i32 %i.yv                   ; 2 uses
  %i.yw = load i32, ptr %i.c, align 4             ; 2 uses
  %i.yx = load i32, ptr %i.i, align 4
  %.neg869.i = add nuw nsw i32 %.03291205.i, 1
  %invariant.op1080.i = sub i32 %.neg869.i, %i.yx ; 2 uses
  %i.yy = load i32, ptr %i.e, align 4             ; 4 uses
  %i.yz = icmp sgt i32 %.fr1226.i, 0
  %or.cond1443.i = and i1 %i.yi, %i.yz
...
.preheader889.us.us.preheader.i:                  ; preds = %.preheader889.lr.ph.i
  %i.za = zext nneg i32 %.fr1226.i to i64         ; 4 uses
...
.preheader889.us.us.i:                            ; preds = %._crit_edge1096.split.us.us.us.i, %.preheader889.us.us.preheader.i
  ...
  %.03231110.us.us.i = phi ptr [ %i.yg, %.preheader889.us.us.preheader.i ], [ %i.abo, %._crit_edge1096.split.us.us.us.i ] ; 3 uses
  ...
  %i.zb = lshr exact i64 %indvars.iv1354.i, 2
  %i.zc = or disjoint i64 %indvars.iv1354.i, 1
  %i.zd = or disjoint i64 %indvars.iv1354.i, 2
  %i.ze = or disjoint i64 %indvars.iv1354.i, 3
...
.preheader889.us.us.i.split.us:                   ; preds = %.preheader889.us.us.i, %..loopexit886_crit_edge.us.us.us.i.us
  ...
  %i.zf = trunc i64 %indvars.iv1349.i.us to i32
  %i.zg = mul i32 %i.ys, %i.zf
  %.reass1099.us.us.us.i.us = add i32 %i.zg, %invariant.op1098.i ; 3 uses
  %i.zh = icmp slt i32 %.reass1099.us.us.us.i.us, 0
  br i1 %i.zh, label %..loopexit886_crit_edge.us.us.us.i.us, label %bb.bx

bb.bx:                                            ; preds = %.preheader889.us.us.i.split.us
  %i.zi = srem i32 %.reass1099.us.us.us.i.us, %i.yu
  %i.zj = sdiv i32 %.reass1099.us.us.us.i.us, %i.yu ; 2 uses
  %.not429.us.us.us.i.us = icmp eq i32 %i.zi, 0
  %.not430.us.us.us.i.us = icmp slt i32 %i.zj, %i.la
...
.preheader885.us.us.us.i.us:                      ; preds = %bb.bx
  %i.zk = mul nuw nsw i64 %indvars.iv1349.i.us, %i.za
  %i.zl = sext i32 %i.zj to i64
  %i.zm = mul nsw i64 %i.zl, %i.ly
...
.lr.ph.split.us.us.us.us1129.i.us:                ; preds = %bb.bz, %.preheader885.us.us.us.i.us
  ...
  %i.zn = trunc i64 %indvars.iv1344.i.us to i32
  %i.zo = mul i32 %i.yw, %i.zn
  %.reass1081.us.us.us.us.i.us = add i32 %i.zo, %invariant.op1080.i ; 3 uses
  %i.zp = icmp slt i32 %.reass1081.us.us.us.us.i.us, 0
  br i1 %i.zp, label %bb.bz, label %bb.by

bb.by:                                            ; preds = %.lr.ph.split.us.us.us.us1129.i.us
  %i.zq = srem i32 %.reass1081.us.us.us.us.i.us, %i.yy
  %i.zr = sdiv i32 %.reass1081.us.us.us.us.i.us, %i.yy ; 2 uses
  %.not431.us.us.us.us.i.us = icmp eq i32 %i.zq, 0
  %.not432.us.us.us.us.i.us = icmp slt i32 %i.zr, %i.kz
...
_ZN4ncnn3MatD2Ev.exit448.us.us.us.us.i.us:        ; preds = %bb.by
  %i.zs = add nuw nsw i64 %indvars.iv1344.i.us, %i.zk
  %i.zt = shl i64 %i.zs, 2
  %i.zu = and i64 %i.zt, 4294967292
  %i.zv = getelementptr inbounds nuw [4 x i8], ptr %.03231110.us.us.i, i64 %i.zu
  %i.zw = load ptr, ptr %1, align 8, !tbaa !20, !noalias !313
  %i.zx = load i64, ptr %i.lj, align 8, !tbaa !21, !noalias !313
  %i.zy = mul i64 %i.zx, %i.zb
  %i.zz = load i64, ptr %i.ak, align 8, !tbaa !55, !noalias !313 ; 2 uses
  %i.aaa = mul i64 %i.zy, %i.zz
  %i.aab = getelementptr inbounds nuw i8, ptr %i.zw, i64 %i.aaa
  %i.aac = mul i64 %i.zm, %i.zz
  %i.aad = getelementptr inbounds nuw i8, ptr %i.aab, i64 %i.aac
  %i.aae = shl nsw i32 %i.zr, 2
  %i.aaf = sext i32 %i.aae to i64
  %i.aag = getelementptr inbounds [4 x i8], ptr %i.aad, i64 %i.aaf
  %i.aah = load <4 x float>, ptr %i.aag, align 16, !tbaa !80
  %i.aai = load <4 x float>, ptr %i.zv, align 16, !tbaa !80
  %i.aaj = fmul fast <4 x float> %i.aai, %i.aah
  %i.aak = fadd fast <4 x float> %i.aaj, %.28241077.us.us.us.us.i.us
  br label %bb.bz

bb.bz:                                            ; preds = %_ZN4ncnn3MatD2Ev.exit448.us.us.us.us.i.us, %bb.by, %.lr.ph.split.us.us.us.us1129.i.us
  %.3825.us.us.us.us.i.us = phi nsz <4 x float> [ %.28241077.us.us.us.us.i.us, %.lr.ph.split.us.us.us.us1129.i.us ], [ %.28241077.us.us.us.us.i.us, %bb.by ], [ %i.aak, %_ZN4ncnn3MatD2Ev.exit448.us.us.us.us.i.us ] ; 2 uses
  %indvars.iv.next1345.i.us = add nuw nsw i64 %indvars.iv1344.i.us, 1 ; 2 uses
  %exitcond1348.not.i.us = icmp eq i64 %indvars.iv.next1345.i.us, %i.za
...
.preheader889.us.us.i.split.us155:                ; preds = %.preheader889.us.us.i, %..loopexit886_crit_edge.us.us.us.i.us162
  ...
  %i.aal = trunc i64 %indvars.iv1349.i.us156 to i32
  %i.aam = mul i32 %i.ys, %i.aal
  %.reass1099.us.us.us.i.us158 = add i32 %i.aam, %invariant.op1098.i ; 3 uses
  %i.aan = icmp slt i32 %.reass1099.us.us.us.i.us158, 0
  br i1 %i.aan, label %..loopexit886_crit_edge.us.us.us.i.us162, label %bb.ca

bb.ca:                                            ; preds = %.preheader889.us.us.i.split.us155
  %i.aao = srem i32 %.reass1099.us.us.us.i.us158, %i.yu
  %i.aap = sdiv i32 %.reass1099.us.us.us.i.us158, %i.yu ; 2 uses
  %.not429.us.us.us.i.us159 = icmp eq i32 %i.aao, 0
  %.not430.us.us.us.i.us160 = icmp slt i32 %i.aap, %i.la
...
.preheader885.us.us.us.i.us161:                   ; preds = %bb.ca
  %i.aaq = mul nuw nsw i64 %indvars.iv1349.i.us156, %i.za
  %i.aar = sext i32 %i.aap to i64
  %i.aas = mul nsw i64 %i.aar, %i.ly
...
.lr.ph.split.us1083.us.us.us.i.us:                ; preds = %bb.cc, %.preheader885.us.us.us.i.us161
  ...
  %i.aat = trunc i64 %indvars.iv1339.i.us to i32
  %i.aau = mul i32 %i.yw, %i.aat
  %.reass1081.us1086.us.us.us.i.us = add i32 %i.aau, %invariant.op1080.i ; 3 uses
  %i.aav = icmp slt i32 %.reass1081.us1086.us.us.us.i.us, 0
  br i1 %i.aav, label %bb.cc, label %bb.cb

bb.cb:                                            ; preds = %.lr.ph.split.us1083.us.us.us.i.us
  %i.aaw = srem i32 %.reass1081.us1086.us.us.us.i.us, %i.yy
  %i.aax = sdiv i32 %.reass1081.us1086.us.us.us.i.us, %i.yy ; 2 uses
  %.not431.us1087.us.us.us.i.us = icmp eq i32 %i.aaw, 0
  %.not432.us1088.us.us.us.i.us = icmp slt i32 %i.aax, %i.kz
...
_ZN4ncnn3MatD2Ev.exit447.us.us.us.us.i.us:        ; preds = %bb.cb
  %i.aay = load ptr, ptr %1, align 8, !tbaa !20, !noalias !314
  %i.aaz = load i64, ptr %i.lj, align 8, !tbaa !21, !noalias !314
  %i.aba = load i64, ptr %i.ak, align 8, !tbaa !55, !noalias !314 ; 2 uses
  %factor.op.mul1072.us.us.us.us.i.us = mul i64 %i.aba, %i.aaz ; 4 uses
  %i.abb = mul i64 %i.aas, %i.aba
  %invariant.gep.us.us.us1125.us.i.us = getelementptr i8, ptr %i.aay, i64 %i.abb
  %i.abc = sext i32 %i.aax to i64
  %invariant.gep1074.us.us.us.us.i.us = getelementptr [4 x i8], ptr %invariant.gep.us.us.us1125.us.i.us, i64 %i.abc ; 4 uses
  ...
  %i.abd = load float, ptr %gep1075.us.us.us.us.i.us, align 4, !tbaa !39
  %.sroa.0.0.vec.insert.i.us = insertelement <4 x float> poison, float %i.abd, i64 0
  %.reass1073.us.us.us.us.1.i.us = mul i64 %factor.op.mul1072.us.us.us.us.i.us, %i.zc
  %gep1075.us.us.us.us.1.i.us = getelementptr i8, ptr %invariant.gep1074.us.us.us.us.i.us, i64 %.reass1073.us.us.us.us.1.i.us
  %i.abe = load float, ptr %gep1075.us.us.us.us.1.i.us, align 4, !tbaa !39
  %.sroa.0.4.vec.insert.i.us = insertelement <4 x float> %.sroa.0.0.vec.insert.i.us, float %i.abe, i64 1
  %.reass1073.us.us.us.us.2.i.us = mul i64 %factor.op.mul1072.us.us.us.us.i.us, %i.zd
  %gep1075.us.us.us.us.2.i.us = getelementptr i8, ptr %invariant.gep1074.us.us.us.us.i.us, i64 %.reass1073.us.us.us.us.2.i.us
  %i.abf = load float, ptr %gep1075.us.us.us.us.2.i.us, align 4, !tbaa !39
  %.sroa.0.8.vec.insert.i.us = insertelement <4 x float> %.sroa.0.4.vec.insert.i.us, float %i.abf, i64 2
  %.reass1073.us.us.us.us.3.i.us = mul i64 %factor.op.mul1072.us.us.us.us.i.us, %i.ze
  %gep1075.us.us.us.us.3.i.us = getelementptr i8, ptr %invariant.gep1074.us.us.us.us.i.us, i64 %.reass1073.us.us.us.us.3.i.us
  %i.abg = load float, ptr %gep1075.us.us.us.us.3.i.us, align 4, !tbaa !39
  %.sroa.0.12.vec.insert.i.us = insertelement <4 x float> %.sroa.0.8.vec.insert.i.us, float %i.abg, i64 3
  %i.abh = add nuw nsw i64 %indvars.iv1339.i.us, %i.aaq
  %i.abi = shl i64 %i.abh, 2
  %i.abj = and i64 %i.abi, 4294967292
  %i.abk = getelementptr inbounds nuw [4 x i8], ptr %.03231110.us.us.i, i64 %i.abj
  %i.abl = load <4 x float>, ptr %i.abk, align 16, !tbaa !80
  %i.abm = fmul fast <4 x float> %i.abl, %.sroa.0.12.vec.insert.i.us
  %i.abn = fadd fast <4 x float> %i.abm, %.28241077.us1085.us.us.us.i.us
  br label %bb.cc

bb.cc:                                            ; preds = %_ZN4ncnn3MatD2Ev.exit447.us.us.us.us.i.us, %bb.cb, %.lr.ph.split.us1083.us.us.us.i.us
  %.3825.us1089.us.us.us.i.us = phi nsz <4 x float> [ %.28241077.us1085.us.us.us.i.us, %.lr.ph.split.us1083.us.us.us.i.us ], [ %i.abn, %_ZN4ncnn3MatD2Ev.exit447.us.us.us.us.i.us ], [ %.28241077.us1085.us.us.us.i.us, %bb.cb ] ; 2 uses
  %indvars.iv.next1340.i.us = add nuw nsw i64 %indvars.iv1339.i.us, 1 ; 2 uses
  %exitcond1343.not.i.us = icmp eq i64 %indvars.iv.next1340.i.us, %i.za
...
._crit_edge1096.split.us.us.us.i:                 ; preds = %..loopexit886_crit_edge.us.us.us.i.us162, %..loopexit886_crit_edge.us.us.us.i.us, %.preheader889.us.us.i
  ...
  %i.abo = getelementptr inbounds [4 x i8], ptr %.03231110.us.us.i, i64 %i.yl ; 2 uses
  %indvars.iv.next1355.i = add nuw nsw i64 %indvars.iv1354.i, 4 ; 2 uses
  %i.abp = icmp slt i64 %indvars.iv.next1355.i, %invariant.op1441.i
  br i1 %i.abp, label %.preheader889.us.us.i, label %._crit_edge1114.i, !llvm.loop !290
...
._crit_edge1114.i:                                ; preds = %._crit_edge1096.split.us.us.us.i, %.preheader889.lr.ph.i, %_ZN4ncnn3MatD2Ev.exit449.i
  ...
  %.0323.lcssa.i = phi ptr [ %i.yg, %_ZN4ncnn3MatD2Ev.exit449.i ], [ %scevgep1332.i, %.preheader889.lr.ph.i ], [ %i.abo, %._crit_edge1096.split.us.us.us.i ] ; 4 uses
  %.0322.lcssa.i = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit449.i ], [ %i.lp, %.preheader889.lr.ph.i ], [ %i.lz, %._crit_edge1096.split.us.us.us.i ] ; 7 uses
  %i.abq = shufflevector <4 x float> %.0822.lcssa.i, <4 x float> poison, <4 x i32> <i32 2, i32 3, i32 poison, i32 poison>
  %i.abr = fadd fast <4 x float> %i.abq, %.0822.lcssa.i ; 2 uses
  %i.abs = extractelement <4 x float> %i.abr, i64 1
  %i.abt = extractelement <4 x float> %i.abr, i64 0
  %i.abu = fadd fast float %i.abs, %.0326.i
  %i.abv = fadd fast float %i.abu, %i.abt         ; 4 uses
  %i.abw = or disjoint i32 %.0322.lcssa.i, 1
  %i.abx = icmp slt i32 %i.abw, %i.ky
  br i1 %i.abx, label %.preheader888.lr.ph.i, label %.preheader890.i

.preheader888.lr.ph.i:                            ; preds = %._crit_edge1114.i
  %i.aby = load i32, ptr %i.d, align 4
  %i.abz = load i32, ptr %i.j, align 4
  %invariant.op1149.i = sub i32 %.neg867.i, %i.abz
  %i.aca = load i32, ptr %i.f, align 4            ; 2 uses
  %i.acb = load i32, ptr %i.a, align 4
  %.fr1227.i = freeze i32 %i.acb                  ; 2 uses
  %i.acc = load i32, ptr %i.c, align 4
  %i.acd = load i32, ptr %i.i, align 4
  %.neg865.i = add nuw nsw i32 %.03291205.i, 1
  %invariant.op1142.i = sub i32 %.neg865.i, %i.acd
  %i.ace = load i32, ptr %i.e, align 4            ; 2 uses
  br i1 %i.yi, label %.preheader888.lr.ph.split.us.i, label %.preheader888.preheader.i

.preheader888.preheader.i:                        ; preds = %.preheader888.lr.ph.i
  %reass.sub169 = sub i32 %9, %.0322.lcssa.i      ; 2 uses
  %i.acf = lshr i32 %reass.sub169, 1
  %i.acg = zext nneg i32 %i.acf to i64
  %i.ach = shl nuw nsw i64 %i.acg, 2
  %i.aci = add nuw nsw i64 %i.ach, 4
  %i.acj = mul i64 %i.aci, %i.yn
  %scevgep1358.i = getelementptr i8, ptr %.0323.lcssa.i, i64 %i.acj
  %i.ack = or disjoint i32 %.0322.lcssa.i, 2
  %i.acl = and i32 %reass.sub169, -2
  %i.acm = add i32 %i.ack, %i.acl
  br label %.preheader890.i

.preheader888.lr.ph.split.us.i:                   ; preds = %.preheader888.lr.ph.i
  %i.acn = icmp sgt i32 %.fr1227.i, 0
  br i1 %i.acn, label %.preheader888.us.us.preheader.i, label %.preheader888.us.preheader.i

.preheader888.us.preheader.i:                     ; preds = %.preheader888.lr.ph.split.us.i
  %reass.sub170 = sub i32 %9, %.0322.lcssa.i      ; 2 uses
  %i.aco = lshr i32 %reass.sub170, 1
  %i.acp = zext nneg i32 %i.aco to i64
  %i.acq = shl nuw nsw i64 %i.acp, 2
  %i.acr = add nuw nsw i64 %i.acq, 4
  %i.acs = mul i64 %i.acr, %i.yn
  %scevgep1360.i = getelementptr i8, ptr %.0323.lcssa.i, i64 %i.acs
  %i.act = or disjoint i32 %.0322.lcssa.i, 2
  %i.acu = and i32 %reass.sub170, -2
  %i.acv = add i32 %i.act, %i.acu
  br label %.preheader890.i

.preheader888.us.us.preheader.i:                  ; preds = %.preheader888.lr.ph.split.us.i
  %i.acw = zext nneg i32 %.fr1227.i to i64        ; 2 uses
  %i.acx = zext i32 %.0322.lcssa.i to i64
  br label %.preheader888.us.us.i

.preheader888.us.us.i:                            ; preds = %._crit_edge1147.split.us.us.us.i, %.preheader888.us.us.preheader.i
  %indvars.iv1374.i.a = phi i64 [ %i.acx, %.preheader888.us.us.preheader.i ], [ %indvars.iv.next1375.i.a, %._crit_edge1147.split.us.us.us.i ] ; 3 uses
  %.13241154.us.us.i = phi ptr [ %.0323.lcssa.i, %.preheader888.us.us.preheader.i ], [ %i.aec, %._crit_edge1147.split.us.us.us.i ] ; 2 uses
  %.13271153.us.us.i = phi float [ %i.abv, %.preheader888.us.us.preheader.i ], [ %.8.us.us.us.i, %._crit_edge1147.split.us.us.us.i ]
  %i.acy = or disjoint i64 %indvars.iv1374.i.a, 1
  br label %bb.cd
...
bb.cd:                                            ; preds = %..loopexit884_crit_edge.us.us.us.i, %.preheader888.us.us.i
  ...
  %i.acz = trunc i64 %indvars.iv1369.i to i32
  %i.ada = mul i32 %i.aby, %i.acz
  %.reass1150.us.us.us.i = add i32 %i.ada, %invariant.op1149.i ; 3 uses
  %i.adb = icmp slt i32 %.reass1150.us.us.us.i, 0
  br i1 %i.adb, label %..loopexit884_crit_edge.us.us.us.i, label %bb.ce

bb.ce:                                            ; preds = %bb.cd
  %i.adc = srem i32 %.reass1150.us.us.us.i, %i.aca
  %i.add = sdiv i32 %.reass1150.us.us.us.i, %i.aca ; 2 uses
  %.not425.us.us.us.i = icmp eq i32 %i.adc, 0
  %.not426.us.us.us.i = icmp slt i32 %i.add, %i.la
...
.preheader883.us.us.us.i:                         ; preds = %bb.ce
  %i.ade = mul nuw nsw i64 %indvars.iv1369.i, %i.acw
  %i.adf = sext i32 %i.add to i64
  %i.adg = mul nsw i64 %i.adf, %i.ly
  br label %bb.cf
...
bb.cg:                                            ; preds = %bb.cf
  %i.adk = srem i32 %.reass1143.us.us.us.i, %i.ace
  %i.adl = sdiv i32 %.reass1143.us.us.us.i, %i.ace ; 2 uses
...
_ZN4ncnn3MatD2Ev.exit446.us.us.us.i:              ; preds = %bb.cg
  %i.adm = add nuw nsw i64 %indvars.iv1364.i, %i.ade
  %.idx1431.i = shl nuw nsw i64 %i.adm, 3
  %i.adn = getelementptr inbounds nuw i8, ptr %.13241154.us.us.i, i64 %.idx1431.i ; 2 uses
  %i.ado = load ptr, ptr %1, align 8, !tbaa !20, !noalias !315
  %i.adp = load i64, ptr %i.lj, align 8, !tbaa !21, !noalias !315
  %i.adq = load i64, ptr %i.ak, align 8, !tbaa !55, !noalias !315 ; 2 uses
  %factor.op.mul1133.us.us.us.i = mul i64 %i.adq, %i.adp ; 2 uses
  %i.adr = mul i64 %i.adg, %i.adq
  ...
  %.reass1134.us.us.us.1.i = mul i64 %factor.op.mul1133.us.us.us.i, %i.acy
...
.loopexit.us.us.us.i:                             ; preds = %_ZN4ncnn3MatD2Ev.exit446.us.us.us.i, %bb.cg, %bb.cf
  ...
  %exitcond1368.not.i = icmp eq i64 %indvars.iv.next1365.i, %i.acw
...
._crit_edge1147.split.us.us.us.i:                 ; preds = %..loopexit884_crit_edge.us.us.us.i
  %i.aec = getelementptr inbounds [4 x i8], ptr %.13241154.us.us.i, i64 %i.yn ; 2 uses
  %indvars.iv.next1375.i.a = add nuw nsw i64 %indvars.iv1374.i.a, 2 ; 2 uses
  %i.aed = trunc i64 %indvars.iv.next1375.i.a to i32 ; 2 uses
  %i.aee = or i32 %i.aed, 1
  %i.aef = icmp slt i32 %i.aee, %i.ky
  br i1 %i.aef, label %.preheader888.us.us.i, label %.preheader890.i, !llvm.loop !295
...
.preheader890.i:                                  ; preds = %._crit_edge1147.split.us.us.us.i, %.preheader888.us.preheader.i, %.preheader888.preheader.i, %._crit_edge1114.i
  %.1327.lcssa.i = phi float [ %i.abv, %._crit_edge1114.i ], [ %i.abv, %.preheader888.preheader.i ], [ %i.abv, %.preheader888.us.preheader.i ], [ %.8.us.us.us.i, %._crit_edge1147.split.us.us.us.i ] ; 3 uses
  %.1324.lcssa.i = phi ptr [ %.0323.lcssa.i, %._crit_edge1114.i ], [ %scevgep1358.i, %.preheader888.preheader.i ], [ %scevgep1360.i, %.preheader888.us.preheader.i ], [ %i.aec, %._crit_edge1147.split.us.us.us.i ]
  %.1.lcssa.i = phi i32 [ %.0322.lcssa.i, %._crit_edge1114.i ], [ %i.acm, %.preheader888.preheader.i ], [ %i.acv, %.preheader888.us.preheader.i ], [ %i.aed, %._crit_edge1147.split.us.us.us.i ] ; 2 uses
  %i.aeg = icmp slt i32 %.1.lcssa.i, %i.ky
  br i1 %i.aeg, label %.preheader887.lr.ph.i, label %._crit_edge1193.i

.preheader887.lr.ph.i:                            ; preds = %.preheader890.i
  %i.aeh = load i32, ptr %i.d, align 4
  %i.aei = load i32, ptr %i.j, align 4
  %invariant.op1185.i = sub i32 %.neg867.i, %i.aei
  %i.aej = load i32, ptr %i.f, align 4            ; 2 uses
  %i.aek = load i32, ptr %i.a, align 4
  %.fr1228.i = freeze i32 %i.aek                  ; 2 uses
  %i.ael = load i32, ptr %i.c, align 4
  %i.aem = load i32, ptr %i.i, align 4
  %.neg861.i = add nuw nsw i32 %.03291205.i, 1
  %invariant.op1178.i = sub i32 %.neg861.i, %i.aem
  %i.aen = load i32, ptr %i.e, align 4            ; 2 uses
  %i.aeo = icmp sgt i32 %.fr1228.i, 0
  %or.cond1444.i = and i1 %i.yi, %i.aeo
...
.preheader887.us.us.preheader.i:                  ; preds = %.preheader887.lr.ph.i
  %i.aep = zext nneg i32 %.fr1228.i to i64        ; 2 uses
  %i.aeq = zext i32 %.1.lcssa.i to i64
  br label %.preheader887.us.us.i

.preheader887.us.us.i:                            ; preds = %._crit_edge1183.split.us.us.us.i, %.preheader887.us.us.preheader.i
  %indvars.iv1387.i = phi i64 [ %i.aeq, %.preheader887.us.us.preheader.i ], [ %indvars.iv.next1388.i, %._crit_edge1183.split.us.us.us.i ] ; 2 uses
  %.23251190.us.us.i = phi ptr [ %.1324.lcssa.i, %.preheader887.us.us.preheader.i ], [ %i.afu, %._crit_edge1183.split.us.us.us.i ] ; 2 uses
...
bb.ch:                                            ; preds = %..loopexit882_crit_edge.us.us.us.i, %.preheader887.us.us.i
  ...
  %i.aer = trunc i64 %indvars.iv1382.i to i32
  %i.aes = mul i32 %i.aeh, %i.aer
  %.reass1186.us.us.us.i = add i32 %i.aes, %invariant.op1185.i ; 3 uses
  %i.aet = icmp slt i32 %.reass1186.us.us.us.i, 0
  br i1 %i.aet, label %..loopexit882_crit_edge.us.us.us.i, label %bb.ci

bb.ci:                                            ; preds = %bb.ch
  %i.aeu = srem i32 %.reass1186.us.us.us.i, %i.aej
  %i.aev = sdiv i32 %.reass1186.us.us.us.i, %i.aej ; 2 uses
  %.not421.us.us.us.i = icmp eq i32 %i.aeu, 0
  %.not422.us.us.us.i = icmp slt i32 %i.aev, %i.la
...
.preheader.us.us.us.i:                            ; preds = %bb.ci
  %i.aew = mul nuw nsw i64 %indvars.iv1382.i, %i.aep
  %i.aex = sext i32 %i.aev to i64
  %i.aey = getelementptr inbounds nuw [4 x i8], ptr %.23251190.us.us.i, i64 %i.aew
  %i.aez = mul nsw i64 %i.aex, %i.ly
  br label %bb.cj
...
bb.cj:                                            ; preds = %bb.cl, %.preheader.us.us.us.i
  ...
  %i.afa = trunc i64 %indvars.iv1377.i to i32
  %i.afb = mul i32 %i.ael, %i.afa
  %.reass1179.us.us.us.i = add i32 %invariant.op1178.i, %i.afb ; 3 uses
  %i.afc = icmp slt i32 %.reass1179.us.us.us.i, 0
  br i1 %i.afc, label %bb.cl, label %bb.ck

bb.ck:                                            ; preds = %bb.cj
  %i.afd = srem i32 %.reass1179.us.us.us.i, %i.aen
  %i.afe = sdiv i32 %.reass1179.us.us.us.i, %i.aen ; 2 uses
  %.not423.us.us.us.i = icmp eq i32 %i.afd, 0
  %.not424.us.us.us.i = icmp slt i32 %i.afe, %i.kz
...
_ZN4ncnn3MatD2Ev.exit.us.us.us.i:                 ; preds = %bb.ck
  %i.aff = load ptr, ptr %1, align 8, !tbaa !20, !noalias !316
  %i.afg = load i64, ptr %i.lj, align 8, !tbaa !21, !noalias !316
  %i.afh = mul i64 %i.afg, %indvars.iv1387.i
  %i.afi = load i64, ptr %i.ak, align 8, !tbaa !55, !noalias !316 ; 2 uses
  %i.afj = mul i64 %i.afh, %i.afi
  %i.afk = getelementptr inbounds nuw i8, ptr %i.aff, i64 %i.afj
  %i.afl = mul i64 %i.aez, %i.afi
  %i.afm = getelementptr inbounds nuw i8, ptr %i.afk, i64 %i.afl
  %i.afn = sext i32 %i.afe to i64
  %i.afo = getelementptr inbounds [4 x i8], ptr %i.afm, i64 %i.afn
  %i.afp = load float, ptr %i.afo, align 4, !tbaa !39
  %i.afq = getelementptr inbounds nuw [4 x i8], ptr %i.aey, i64 %indvars.iv1377.i
  %i.afr = load float, ptr %i.afq, align 4, !tbaa !39
  %i.afs = fmul fast float %i.afr, %i.afp
  %i.aft = fadd fast float %i.afs, %.111175.us.us.us.i
  br label %bb.cl

bb.cl:                                            ; preds = %_ZN4ncnn3MatD2Ev.exit.us.us.us.i, %bb.ck, %bb.cj
  %.13.us.us.us.i = phi nsz float [ %.111175.us.us.us.i, %bb.cj ], [ %.111175.us.us.us.i, %bb.ck ], [ %i.aft, %_ZN4ncnn3MatD2Ev.exit.us.us.us.i ] ; 2 uses
  %indvars.iv.next1378.i = add nuw nsw i64 %indvars.iv1377.i, 1 ; 2 uses
  %exitcond1381.not.i = icmp eq i64 %indvars.iv.next1378.i, %i.aep
...
._crit_edge.i:                                    ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  ...
  br i1 %exitcond897.not.i, label %._crit_edge698.split.i, label %.preheader693.i, !llvm.loop !324
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  %indvars.iv.next.i.3 = add nuw nsw i64 %indvars.iv.i, 4 ; 2 uses
  %exitcond.not.i.3 = icmp eq i64 %indvars.iv.next.i.3, %wide.trip.count.i
  br i1 %exitcond.not.i.3, label %._crit_edge.i, label %scalar.ph, !llvm.loop !325
...
.noexc470.lr.ph.i:                                ; preds = %.invoke1069.i
  %i.dz = load ptr, ptr %i.m, align 8, !tbaa !20, !noalias !358
  %i.ea = getelementptr inbounds nuw i8, ptr %0, i64 584
  %i.eb = load i64, ptr %i.ea, align 8, !tbaa !21, !noalias !358
  %i.ec = getelementptr inbounds nuw i8, ptr %0, i64 536
  %i.ed = load i64, ptr %i.ec, align 8, !tbaa !55, !noalias !358
...
.noexc462.lr.ph.i:                                ; preds = %.preheader682.i
  %i.er = load ptr, ptr %i.m, align 8, !tbaa !20, !noalias !359
  %i.es = getelementptr inbounds nuw i8, ptr %0, i64 584
  %i.et = load i64, ptr %i.es, align 8, !tbaa !21, !noalias !359
  %i.eu = getelementptr inbounds nuw i8, ptr %0, i64 536
  %i.ev = load i64, ptr %i.eu, align 8, !tbaa !55, !noalias !359
...
.preheader687.us.i:                               ; preds = %.preheader687.us.i, %.preheader690.us.i
  ...
  store i16 %i.fy, ptr %.1287708.us.i, align 2, !tbaa !86
  ...
  store i16 %i.gc, ptr %i.fz, align 2, !tbaa !86
  ...
  store i16 %i.gg, ptr %i.gd, align 2, !tbaa !86
  ...
  store i16 %i.gk, ptr %i.gh, align 2, !tbaa !86
  ...
  store i16 %i.go, ptr %i.gl, align 2, !tbaa !86
  ...
  store i16 %i.gs, ptr %i.gp, align 2, !tbaa !86
  ...
  store i16 %i.gw, ptr %i.gt, align 2, !tbaa !86
  ...
  store i16 %i.ha, ptr %i.gx, align 2, !tbaa !86
  ...
  store i16 %i.he, ptr %i.hb, align 2, !tbaa !86
  ...
  store i16 %i.hi, ptr %i.hf, align 2, !tbaa !86
  ...
  store i16 %i.hm, ptr %i.hj, align 2, !tbaa !86
  ...
  store i16 %i.hq, ptr %i.hn, align 2, !tbaa !86
  ...
  store i16 %i.hu, ptr %i.hr, align 2, !tbaa !86
  ...
  store i16 %i.hy, ptr %i.hv, align 2, !tbaa !86
  ...
  store i16 %i.ic, ptr %i.hz, align 2, !tbaa !86
  ...
  store i16 %i.ig, ptr %i.id, align 2, !tbaa !86
...
.preheader689.preheader.i:                        ; preds = %.preheader692.i.thread, %.preheader689.lr.ph.i
  ...
  %.0283.lcssa.i711 = phi i32 [ %.0283.lcssa.i, %.preheader689.lr.ph.i ], [ %i.ei, %.preheader692.i.thread ] ; 2 uses
  %i.iq = add i32 %.0283.lcssa.i711, 2
  %reass.sub = sub i32 %4, %.0283.lcssa.i711
...
.preheader689.us.preheader.i:                     ; preds = %.preheader689.lr.ph.i
  ...
  %.reass.us734.i = mul i64 %factor.op.mul716.i, %indvars.iv945.i ; 2 uses
  %i.iv = or disjoint i64 %indvars.iv945.i, 1
  %.reass.us734.1.i = mul i64 %factor.op.mul716.i, %i.iv ; 2 uses
  %i.iw = or disjoint i64 %indvars.iv945.i, 2
  %.reass.us734.2.i = mul i64 %factor.op.mul716.i, %i.iw ; 2 uses
  %i.ix = or disjoint i64 %indvars.iv945.i, 3
  %.reass.us734.3.i = mul i64 %factor.op.mul716.i, %i.ix ; 2 uses
  br label %.preheader689.us.i
...
.preheader686.us.i:                               ; preds = %.preheader686.us.i, %.preheader689.us.i
  ...
  store i16 %i.jb, ptr %.5291726.us.i, align 2, !tbaa !86
  ...
  store i16 %i.jf, ptr %i.jc, align 2, !tbaa !86
  ...
  store i16 %i.jj, ptr %i.jg, align 2, !tbaa !86
  ...
  store i16 %i.jn, ptr %i.jk, align 2, !tbaa !86
  ...
  store i16 %i.jr, ptr %i.jo, align 2, !tbaa !86
  ...
  store i16 %i.jv, ptr %i.js, align 2, !tbaa !86
...
.preheader685.i:                                  ; preds = %.preheader688.i, %.preheader685.i
  ...
  store i16 %i.ku, ptr %.9295743.i, align 2, !tbaa !86
  ...
  store i16 %i.ky, ptr %i.kv, align 2, !tbaa !86
  ...
  store i16 %i.lc, ptr %i.kz, align 2, !tbaa !86
  ...
  store i16 %i.lg, ptr %i.ld, align 2, !tbaa !86
  ...
  store i16 %i.ll, ptr %i.lh, align 2, !tbaa !86
  ...
  store i16 %i.lp, ptr %i.lm, align 2, !tbaa !86
  ...
  store i16 %i.lt, ptr %i.lq, align 2, !tbaa !86
  ...
  store i16 %i.lx, ptr %i.lu, align 2, !tbaa !86
...
.preheader685.i.epil.preheader:                   ; preds = %._crit_edge745.i.unr-lcssa, %.preheader688.i
  ...
  store i16 %i.mb, ptr %.9295743.i.epil.init, align 2, !tbaa !86
  ...
  store i16 %i.mf, ptr %i.mc, align 2, !tbaa !86
  ...
  store i16 %i.mj, ptr %i.mg, align 2, !tbaa !86
  ...
  store i16 %i.mn, ptr %i.mk, align 2, !tbaa !86
...
.noexc454.lr.ph.i:                                ; preds = %.preheader671.i
  %i.mv = load ptr, ptr %i.m, align 8, !tbaa !20, !noalias !360
  %i.mw = getelementptr inbounds nuw i8, ptr %0, i64 584
  %i.mx = load i64, ptr %i.mw, align 8, !tbaa !21, !noalias !360
  %i.my = getelementptr inbounds nuw i8, ptr %0, i64 536
  %i.mz = load i64, ptr %i.my, align 8, !tbaa !55, !noalias !360
...
.preheader676.us.i:                               ; preds = %.preheader676.us.i, %.preheader679.us.i
  ...
  store i16 %i.od, ptr %.1268768.us.i, align 2, !tbaa !86
  ...
  store i16 %i.oh, ptr %i.oe, align 2, !tbaa !86
  ...
  store i16 %i.ol, ptr %i.oi, align 2, !tbaa !86
  ...
  store i16 %i.op, ptr %i.om, align 2, !tbaa !86
  ...
  store i16 %i.ot, ptr %i.oq, align 2, !tbaa !86
  ...
  store i16 %i.ox, ptr %i.ou, align 2, !tbaa !86
  ...
  store i16 %i.pb, ptr %i.oy, align 2, !tbaa !86
  ...
  store i16 %i.pf, ptr %i.pc, align 2, !tbaa !86
  %i.pg = getelementptr inbounds nuw i8, ptr %.1268768.us.i, i64 16 ; 3 uses
  %indvars.iv.next957.i = add nuw nsw i64 %indvars.iv956.i, 1 ; 2 uses
  %exitcond960.not.i = icmp eq i64 %indvars.iv.next957.i, %wide.trip.count959.i
  br i1 %exitcond960.not.i, label %._crit_edge770.us.i, label %.preheader676.us.i, !llvm.loop !339

._crit_edge770.us.i:                              ; preds = %.preheader676.us.i
  %indvars.iv.next962.i = add nuw nsw i64 %indvars.iv961.i, 4 ; 3 uses
  %i.ph = icmp slt i64 %indvars.iv.next962.i, %invariant.op1066.i.a
  br i1 %i.ph, label %.preheader679.us.i, label %.preheader681.loopexit.i, !llvm.loop !340
...
.preheader678.preheader.i:                        ; preds = %.preheader681.i.thread, %.preheader678.lr.ph.i
  ...
  %.0264.lcssa.i1620 = phi i32 [ %.0264.lcssa.i, %.preheader678.lr.ph.i ], [ %i.fb, %.preheader681.i.thread ] ; 2 uses
  %i.pp = add i32 %.0264.lcssa.i1620, 2
  %reass.sub33 = sub i32 %5, %.0264.lcssa.i1620
  %i.pq = and i32 %reass.sub33, -2
  %i.pr = add i32 %i.pp, %i.pq
  br label %.preheader680.i
...
.preheader675.us.i:                               ; preds = %.preheader678.us.i, %.preheader675.us.i
  ...
  store i16 %i.py, ptr %.5272790.us.i, align 2, !tbaa !86
  ...
  store i16 %i.qc, ptr %i.pz, align 2, !tbaa !86
  ...
  store i16 %i.qg, ptr %i.qd, align 2, !tbaa !86
  ...
  store i16 %i.qk, ptr %i.qh, align 2, !tbaa !86
  ...
  store i16 %i.qp, ptr %i.ql, align 2, !tbaa !86
  ...
  store i16 %i.qt, ptr %i.qq, align 2, !tbaa !86
  ...
  store i16 %i.qx, ptr %i.qu, align 2, !tbaa !86
  ...
  store i16 %i.rb, ptr %i.qy, align 2, !tbaa !86
  ...
  br i1 %niter157.ncmp.1, label %._crit_edge792.us.i.unr-lcssa, label %.preheader675.us.i, !llvm.loop !341
...
.preheader675.us.i.epil.preheader:                ; preds = %._crit_edge792.us.i.unr-lcssa, %.preheader678.us.i
  ...
  store i16 %i.rf, ptr %.5272790.us.i.epil.init, align 2, !tbaa !86
  ...
  store i16 %i.rj, ptr %i.rg, align 2, !tbaa !86
  ...
  store i16 %i.rn, ptr %i.rk, align 2, !tbaa !86
  ...
  store i16 %i.rr, ptr %i.ro, align 2, !tbaa !86
...
._crit_edge792.us.i:                              ; preds = %._crit_edge792.us.i.unr-lcssa, %.preheader675.us.i.epil.preheader
  ...
  br i1 %i.rv, label %.preheader678.us.i, label %.preheader680.i, !llvm.loop !342
...
vector.body99:                                    ; preds = %vector.body99, %vector.ph97
  ...
  store <8 x i16> %interleaved.vec, ptr %next.gep, align 2, !tbaa !86
  %index.next103 = add nuw i64 %index100, 4       ; 2 uses
  %i.sl = icmp eq i64 %index.next103, %n.vec98
  br i1 %i.sl, label %middle.block104, label %vector.body99, !llvm.loop !343
...
.preheader674.i:                                  ; preds = %.preheader674.i.preheader, %.preheader674.i
  ...
  store i16 %i.so, ptr %.9808.i, align 2, !tbaa !86
  ...
  store i16 %i.ss, ptr %i.sp, align 2, !tbaa !86
  ...
  br i1 %exitcond987.not.i, label %._crit_edge810.i, label %.preheader674.i, !llvm.loop !344
...
._crit_edge810.i:                                 ; preds = %.preheader674.i, %middle.block104
  ...
  br i1 %i.sv, label %.preheader677.i, label %._crit_edge814.split.i, !llvm.loop !345
...
._crit_edge814.split.i:                           ; preds = %._crit_edge810.i, %.preheader677.lr.ph.i, %.preheader680.i
  ...
  br i1 %i.sw, label %.noexc462.i, label %.preheader671.loopexit.i, !llvm.loop !346
...
.preheader665.us.i:                               ; preds = %.preheader668.us.i, %.preheader665.us.i
  ...
  store i16 %i.tt, ptr %.1254828.us.i, align 2, !tbaa !86
  ...
  store i16 %i.tx, ptr %i.tu, align 2, !tbaa !86
  ...
  store i16 %i.ub, ptr %i.ty, align 2, !tbaa !86
  ...
  store i16 %i.uf, ptr %i.uc, align 2, !tbaa !86
  ...
  store i16 %i.uk, ptr %i.ug, align 2, !tbaa !86
  ...
  store i16 %i.uo, ptr %i.ul, align 2, !tbaa !86
  ...
  store i16 %i.us, ptr %i.up, align 2, !tbaa !86
  ...
  store i16 %i.uw, ptr %i.ut, align 2, !tbaa !86
  ...
  br i1 %niter163.ncmp.1, label %._crit_edge830.us.i.unr-lcssa, label %.preheader665.us.i, !llvm.loop !347
...
.preheader665.us.i.epil.preheader:                ; preds = %._crit_edge830.us.i.unr-lcssa, %.preheader668.us.i
  ...
  store i16 %i.va, ptr %.1254828.us.i.epil.init, align 2, !tbaa !86
  ...
  store i16 %i.ve, ptr %i.vb, align 2, !tbaa !86
  ...
  store i16 %i.vi, ptr %i.vf, align 2, !tbaa !86
  ...
  store i16 %i.vm, ptr %i.vj, align 2, !tbaa !86
...
._crit_edge830.us.i:                              ; preds = %._crit_edge830.us.i.unr-lcssa, %.preheader665.us.i.epil.preheader
  ...
  br i1 %i.vo, label %.preheader668.us.i, label %.preheader670.loopexit.i, !llvm.loop !348
...
.preheader670.i:                                  ; preds = %.preheader670.loopexit.i, %.preheader668.lr.ph.i, %.noexc454.i
  ...
  %.0252.lcssa.i = phi i32 [ 0, %.noexc454.i ], [ %i.vp, %.preheader670.loopexit.i ], [ %i.nf, %.preheader668.lr.ph.i ] ; 5 uses
...
.preheader667.preheader.i:                        ; preds = %.preheader667.lr.ph.i
  %i.wa = add i32 %.0252.lcssa.i, 2
  %reass.sub34 = sub i32 %6, %.0252.lcssa.i
  %i.wb = and i32 %reass.sub34, -2
  %i.wc = add i32 %i.wa, %i.wb
  br label %.preheader669.i
...
vector.body126:                                   ; preds = %vector.body126, %vector.ph124
  ...
  store <8 x i16> %interleaved.vec131, ptr %next.gep128, align 2, !tbaa !86
  %index.next132 = add nuw i64 %index127, 4       ; 2 uses
  %i.wm = icmp eq i64 %index.next132, %n.vec125
  br i1 %i.wm, label %middle.block133, label %vector.body126, !llvm.loop !349
...
.preheader.us.i:                                  ; preds = %.preheader.us.i.preheader, %.preheader.us.i
  ...
  store i16 %i.wp, ptr %.4844.us.i, align 2, !tbaa !86
  ...
  store i16 %i.wt, ptr %i.wq, align 2, !tbaa !86
  ...
  br i1 %exitcond1014.not.i, label %._crit_edge846.us.i, label %.preheader.us.i, !llvm.loop !350
...
._crit_edge846.us.i:                              ; preds = %.preheader.us.i, %middle.block133
  ...
  br i1 %i.wx, label %.preheader667.us.i, label %.preheader669.i, !llvm.loop !351
...
vector.body112:                                   ; preds = %vector.body112, %vector.ph110
  ...
  store <4 x i16> %i.xp, ptr %next.gep114, align 2, !tbaa !86
  store <4 x i16> %i.xq, ptr %i.xr, align 2, !tbaa !86
  %index.next117 = add nuw i64 %index113, 8       ; 2 uses
  %i.xs = icmp eq i64 %index.next117, %n.vec111
  br i1 %i.xs, label %middle.block118, label %vector.body112, !llvm.loop !352
...
._crit_edge857.i:                                 ; preds = %.noexc449.i, %middle.block118
  ...
  br i1 %i.xu, label %.preheader666.i, label %._crit_edge861.split.i, !llvm.loop !353
...
.noexc449.i:                                      ; preds = %.noexc449.i.preheader, %.noexc449.i
  ...
  store i16 %i.xy, ptr %.7855.i, align 2, !tbaa !86
  ...
  br i1 %exitcond1022.not.i, label %._crit_edge857.i, label %.noexc449.i, !llvm.loop !354
...
._crit_edge861.split.i:                           ; preds = %._crit_edge857.i, %.preheader666.lr.ph.i, %.preheader669.i
  ...
  br i1 %exitcond1030.not.i, label %._crit_edge865.i, label %.noexc454.i, !llvm.loop !355

._crit_edge865.i:                                 ; preds = %._crit_edge861.split.i, %.preheader671.i
  %i.ya = getelementptr inbounds nuw i8, ptr %3, i64 8
  %i.yb = load ptr, ptr %i.ya, align 8, !tbaa !18 ; 2 uses
...
bb.u:                                             ; preds = %bb.t
  ...
  %i.yf = load ptr, ptr %i.ye, align 8, !tbaa !19 ; 3 uses
  %.not3.i403.i = icmp eq ptr %i.yf, null
  %i.yg = load ptr, ptr %3, align 8, !tbaa !20    ; 3 uses
  br i1 %.not3.i403.i, label %bb.w, label %bb.v

bb.v:                                             ; preds = %bb.u
  %i.yh = load ptr, ptr %i.yf, align 8, !tbaa !12
  ...
  invoke void %i.yj(ptr noundef nonnull align 8 dereferenceable(8) %i.yf, ptr noundef %i.yg)
          to label %_ZN4ncnn3MatD2Ev.exit345.i unwind label %bb.y, !inline_history !0
...
_ZN4ncnn3MatD2Ev.exit345.i:                       ; preds = %bb.x, %bb.w, %bb.v, %bb.t, %._crit_edge865.i
  ...
  %i.ym = load ptr, ptr %i.p, align 8, !tbaa !18  ; 2 uses
...
begin_hunk_6_@_ZNK4ncnn17Deconvolution_x8613forward_bf16sERKNS_3MatERS1_RKNS_6OptionE:._crit_edge
          cleanup
  %i.cj = load ptr, ptr %i.bh, align 8, !tbaa !18 ; 2 uses
...
bb.h:                                             ; preds = %bb.g
  %i.cm = load ptr, ptr %i.bk, align 16, !tbaa !19 ; 3 uses
  %.not3.i = icmp eq ptr %i.cm, null
  %i.cn = load ptr, ptr %4, align 16, !tbaa !20   ; 3 uses
  br i1 %.not3.i, label %bb.j, label %bb.i

bb.i:                                             ; preds = %bb.h
  %i.co = load ptr, ptr %i.cm, align 8, !tbaa !12
  %i.cp = getelementptr inbounds nuw i8, ptr %i.co, i64 24
  %i.cq = load ptr, ptr %i.cp, align 8
  invoke void %i.cq(ptr noundef nonnull align 8 dereferenceable(8) %i.cm, ptr noundef %i.cn)
          to label %_ZN4ncnn3MatD2Ev.exit32 unwind label %bb.l, !inline_history !0
...
bb.m:                                             ; preds = %bb.e, %bb.d
  ...
  %i.cu = load ptr, ptr %i.ct, align 8, !tbaa !18 ; 2 uses
...
bb.n:                                             ; preds = %bb.m
  ...
  %.pre107 = load ptr, ptr %i.bh, align 8, !tbaa !18 ; 2 uses
...
bb.p:                                             ; preds = %bb.o
  %i.cy = load ptr, ptr %i.bk, align 16, !tbaa !19 ; 3 uses
  %.not3.i.i = icmp eq ptr %i.cy, null
  %i.cz = load ptr, ptr %4, align 16, !tbaa !20   ; 3 uses
  br i1 %.not3.i.i, label %bb.r, label %bb.q

bb.q:                                             ; preds = %bb.p
  %i.da = load ptr, ptr %i.cy, align 8, !tbaa !12
  %i.db = getelementptr inbounds nuw i8, ptr %i.da, i64 24
  %i.dc = load ptr, ptr %i.db, align 8
  invoke void %i.dc(ptr noundef nonnull align 8 dereferenceable(8) %i.cy, ptr noundef %i.cz)
          to label %.thread unwind label %bb.f, !inline_history !1
...
.thread:                                          ; preds = %bb.m, %bb.o, %bb.n, %bb.q, %bb.s, %bb.r
  %i.dd = load <2 x ptr>, ptr %2, align 8, !tbaa !58
  store <2 x ptr> %i.dd, ptr %4, align 16, !tbaa !58
  %i.de = getelementptr inbounds nuw i8, ptr %2, i64 16
  %i.df = load i64, ptr %i.de, align 8, !tbaa !55
  store i64 %i.df, ptr %i.bi, align 16, !tbaa !55
  %i.dg = getelementptr inbounds nuw i8, ptr %2, i64 24
  %i.dh = load i32, ptr %i.dg, align 8, !tbaa !59
  store i32 %i.dh, ptr %i.bj, align 8, !tbaa !59
  %i.di = getelementptr inbounds nuw i8, ptr %2, i64 32
  %i.dj = load ptr, ptr %i.di, align 8, !tbaa !19
  store ptr %i.dj, ptr %i.bk, align 16, !tbaa !19
  %i.dk = getelementptr inbounds nuw i8, ptr %2, i64 40
  %i.dl = load <4 x i32>, ptr %i.dk, align 8, !tbaa !60
  store <4 x i32> %i.dl, ptr %i.bl, align 8, !tbaa !60
  %i.dm = getelementptr inbounds nuw i8, ptr %2, i64 56
  %i.dn = load i32, ptr %i.dm, align 8, !tbaa !61
  store i32 %i.dn, ptr %i.bo, align 8, !tbaa !61
  %i.do = getelementptr inbounds nuw i8, ptr %2, i64 64
  %i.dp = load i64, ptr %i.do, align 8, !tbaa !21
  store i64 %i.dp, ptr %i.bp, align 16, !tbaa !21
...
bb.t:                                             ; preds = %.thread.invoke
  %i.ds = load ptr, ptr %4, align 16, !tbaa !20
...
_ZNK4ncnn3Mat5emptyEv.exit42:                     ; preds = %bb.t
  %i.du = load i64, ptr %i.bp, align 16, !tbaa !21
  %i.dv = load i32, ptr %i.bo, align 8, !tbaa !61
...
bb.u:                                             ; preds = %_ZNK4ncnn3Mat5emptyEv.exit42
  ...
  %i.eb = load i32, ptr %i.u, align 4, !tbaa !47  ; 3 uses
  %i.ec = load i32, ptr %i.ab, align 8, !tbaa !48 ; 3 uses
  %i.ed = load i32, ptr %i.s, align 4, !tbaa !67  ; 2 uses
  %i.ee = load i32, ptr %i.z, align 8, !tbaa !68  ; 2 uses
  %i.ef = load i32, ptr %i.ah, align 4, !tbaa !69
  %i.eg = load i32, ptr %i.ap, align 8, !tbaa !70
  ...
  store i32 %i.eb, ptr %i.a, align 4, !tbaa !60
  store i32 %i.ec, ptr %i.b, align 4, !tbaa !60
  store i32 %i.ed, ptr %i.c, align 4, !tbaa !60
  store i32 %i.ee, ptr %i.d, align 4, !tbaa !60
  store i32 %i.ef, ptr %i.e, align 4, !tbaa !60
  store i32 %i.eg, ptr %i.f, align 4, !tbaa !60
  store i32 %i.ei, ptr %i.g, align 4, !tbaa !60
  %i.el = load i32, ptr %i.bj, align 8, !tbaa !59 ; 2 uses
  %i.em = load i32, ptr %i.bo, align 8, !tbaa !61
  %i.en = mul nsw i32 %i.em, %i.el                ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.h) #10
  %i.eo = load i64, ptr %i.bp, align 16, !tbaa !21
  %i.ep = sext i32 %i.el to i64
  %i.eq = mul i64 %i.eo, %i.ep
  store i64 %i.eq, ptr %i.h, align 8, !tbaa !82
  call void @llvm.lifetime.start.p0(ptr nonnull %i.i) #10
  %i.er = add nsw i32 %i.eb, -1
  %i.es = mul nsw i32 %i.ed, %i.er
  %i.et = add nsw i32 %i.es, 1
  store i32 %i.et, ptr %i.i, align 4, !tbaa !60
  call void @llvm.lifetime.start.p0(ptr nonnull %i.j) #10
  %i.eu = add nsw i32 %i.ec, -1
  %i.ev = mul nsw i32 %i.ee, %i.eu
  %i.ew = add nsw i32 %i.ev, 1
  store i32 %i.ew, ptr %i.j, align 4, !tbaa !60
  call void @llvm.lifetime.start.p0(ptr nonnull %i.k) #10
  %i.ex = mul nsw i32 %i.ec, %i.eb
  store i32 %i.ex, ptr %i.k, align 4, !tbaa !60
  call void @llvm.lifetime.start.p0(ptr nonnull %i.l) #10
  %i.ey = load ptr, ptr %i.ea, align 8, !tbaa !20
  store ptr %i.ey, ptr %i.l, align 8, !tbaa !84
  call void @llvm.lifetime.start.p0(ptr nonnull %i.m) #10
  call void @llvm.lifetime.start.p0(ptr nonnull %i.n) #10
  store i32 0, ptr %i.n, align 4, !tbaa !60
  %i.ez = sdiv i32 %i.en, 4
  store i32 %i.ez, ptr %i.m, align 4, !tbaa !60
  ...
  %i.fc = load i32, ptr %i.m, align 4, !tbaa !60
  %i.fd = shl nsw i32 %i.fc, 2
  %i.fe = load i32, ptr %i.n, align 4, !tbaa !60
  %i.ff = add nsw i32 %i.fe, %i.fd                ; 5 uses
  store i32 %i.ff, ptr %i.n, align 4, !tbaa !60
  %i.fg = sub nsw i32 %i.en, %i.ff                ; 2 uses
  %i.fh = sdiv i32 %i.fg, 2                       ; 3 uses
  store i32 %i.fh, ptr %i.m, align 4, !tbaa !60
...
_ZN4ncnn3MatD2Ev.exit457.lr.ph.i:                 ; preds = %bb.u
  ...
  %i.fm = load i32, ptr %i.fl, align 8, !tbaa !61
  %i.fn = mul i32 %i.fm, %.fr.i                   ; 9 uses
  %i.fo = load i32, ptr %i.o, align 4, !tbaa !54  ; 5 uses
  %i.fp = load i32, ptr %i.q, align 8, !tbaa !65  ; 4 uses
  %i.fq = load i32, ptr %i.bm, align 4, !tbaa !54 ; 2 uses
  %i.fr = load i32, ptr %i.bn, align 16, !tbaa !65 ; 2 uses
...
_ZN4ncnn3MatD2Ev.exit450.lr.ph.i:                 ; preds = %._crit_edge1072.split.i
  ...
  %i.gw = mul i32 %i.gv, %.fr1100.i               ; 9 uses
...
.preheader911.i:                                  ; preds = %._crit_edge.i, %_ZN4ncnn3MatD2Ev.exit457.i
  ...
  %.03821068.i = phi ptr [ %i.if, %_ZN4ncnn3MatD2Ev.exit457.i ], [ %i.vd, %._crit_edge.i ]
  %.03841067.i = phi ptr [ %i.id, %_ZN4ncnn3MatD2Ev.exit457.i ], [ %i.vc, %._crit_edge.i ]
...
bb.v:                                             ; preds = %_ZL13activation_ssfiRKN4ncnn3MatE.exit542.i, %.preheader911.i
  %.03801065.i = phi i32 [ 0, %.preheader911.i ], [ %i.ve, %_ZL13activation_ssfiRKN4ncnn3MatE.exit542.i ] ; 4 uses
  %.13831064.i = phi ptr [ %.03821068.i, %.preheader911.i ], [ %i.vd, %_ZL13activation_ssfiRKN4ncnn3MatE.exit542.i ] ; 2 uses
  %.13851063.i = phi ptr [ %.03841067.i, %.preheader911.i ], [ %i.vc, %_ZL13activation_ssfiRKN4ncnn3MatE.exit542.i ] ; 2 uses
...
._crit_edge958.i:                                 ; preds = %._crit_edge.split.us.us.us.i, %.preheader909.lr.ph.i, %_ZN4ncnn3MatD2Ev.exit455.i
  ...
  %.0342.lcssa.i = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit455.i ], [ %i.gk, %.preheader909.lr.ph.i ], [ %i.go, %._crit_edge.split.us.us.us.i ] ; 7 uses
...
.preheader908.preheader.i:                        ; preds = %.preheader908.lr.ph.i
  %reass.sub = sub i32 %5, %.0342.lcssa.i
...
.preheader908.us.preheader.i:                     ; preds = %.preheader908.lr.ph.split.us.i
  %reass.sub92 = sub i32 %5, %.0342.lcssa.i
...
.preheader908.us.us.i:                            ; preds = %._crit_edge.split.us.us.us1020.i, %.preheader908.us.us.preheader.i
  ...
  %.13461001.us.us.i = phi ptr [ %.0345.lcssa.i, %.preheader908.us.us.preheader.i ], [ %i.qi, %._crit_edge.split.us.us.us1020.i ] ; 2 uses
...
.preheader903.us.us.us.i:                         ; preds = %bb.ae
  %i.ou = mul nuw nsw i64 %indvars.iv1311.i, %i.ok
  %i.ov = sext i32 %i.ot to i64
  %i.ow = mul nsw i64 %i.ov, %i.gn
  br label %bb.af
...
bb.af:                                            ; preds = %.loopexit900.us.us.us.i, %.preheader903.us.us.us.i
  ...
  %i.ox = phi <2 x float> [ %i.qg, %.loopexit900.us.us.us.i ], [ %i.oo, %.preheader903.us.us.us.i ] ; 3 uses
  %i.oy = trunc i64 %indvars.iv1306.i to i32
  %i.oz = mul i32 %i.nw, %i.oy
  %.reass986.us.us.us.i = add i32 %invariant.op985.i, %i.oz ; 3 uses
  %i.pa = icmp slt i32 %.reass986.us.us.us.i, 0
  br i1 %i.pa, label %.loopexit900.us.us.us.i, label %bb.ag

bb.ag:                                            ; preds = %bb.af
  %i.pb = srem i32 %.reass986.us.us.us.i, %i.ny
  %i.pc = sdiv i32 %.reass986.us.us.us.i, %i.ny   ; 2 uses
  %.not440.us.us.us.i = icmp eq i32 %i.pb, 0
  %.not441.us.us.us.i = icmp slt i32 %i.pc, %i.fo
...
_ZN4ncnn3MatD2Ev.exit452.us.us.us.i:              ; preds = %bb.ag
  %i.pd = add nuw nsw i64 %indvars.iv1306.i, %i.ou
  %i.pe = shl i64 %i.pd, 2
  %i.pf = and i64 %i.pe, 4294967292
  %i.pg = getelementptr inbounds nuw [2 x i8], ptr %.13461001.us.us.i, i64 %i.pf
  %i.ph = load ptr, ptr %1, align 8, !tbaa !20, !noalias !415
  %i.pi = load i64, ptr %i.fy, align 8, !tbaa !21, !noalias !415
  %i.pj = load i64, ptr %i.fz, align 8, !tbaa !55, !noalias !415 ; 2 uses
  %factor.op.mul.us.us.us.i = mul i64 %i.pj, %i.pi ; 2 uses
  %i.pk = mul i64 %i.ow, %i.pj
  %invariant.gep.us.us.us.i = getelementptr i8, ptr %i.ph, i64 %i.pk
  %i.pl = sext i32 %i.pc to i64
  %invariant.gep975.us.us.us.i = getelementptr [2 x i8], ptr %invariant.gep.us.us.us.i, i64 %i.pl ; 2 uses
  ...
  %i.pm = load i16, ptr %gep976.us.us.us.i, align 2, !tbaa !86
  ...
  %i.pn = load i16, ptr %gep976.us.us.us.1.i, align 2, !tbaa !86
  %i.po = load <4 x i16>, ptr %i.pg, align 2, !tbaa !86
  %i.pp = freeze <4 x i16> %i.po
  %i.pq = bitcast <4 x i16> %i.pp to <2 x i32>    ; 2 uses
  %i.pr = and <2 x i32> %i.pq, splat (i32 -65536)
  %i.ps = shl <2 x i32> %i.pq, splat (i32 16)
  %i.pt = bitcast <2 x i32> %i.ps to <2 x float>
  %i.pu = insertelement <2 x i16> poison, i16 %i.pn, i64 0
  %i.pv = insertelement <2 x i16> %i.pu, i16 %i.pm, i64 1
  %i.pw = zext <2 x i16> %i.pv to <2 x i32>
  %i.px = shl nuw <2 x i32> %i.pw, splat (i32 16)
  %i.py = bitcast <2 x i32> %i.px to <2 x float>  ; 2 uses
  %i.pz = shufflevector <2 x float> %i.py, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.qa = fmul fast <2 x float> %i.pz, %i.pt
  %i.qb = fadd fast <2 x float> %i.ox, %i.qa
  %i.qc = bitcast <2 x i32> %i.pr to <2 x float>
  %i.qd = shufflevector <2 x float> %i.py, <2 x float> poison, <2 x i32> zeroinitializer
  %i.qe = fmul fast <2 x float> %i.qd, %i.qc
  %i.qf = fadd fast <2 x float> %i.qe, %i.qb
  br label %.loopexit900.us.us.us.i

.loopexit900.us.us.us.i:                          ; preds = %_ZN4ncnn3MatD2Ev.exit452.us.us.us.i, %bb.ag, %bb.af
  %i.qg = phi <2 x float> [ %i.ox, %bb.af ], [ %i.ox, %bb.ag ], [ %i.qf, %_ZN4ncnn3MatD2Ev.exit452.us.us.us.i ] ; 2 uses
...
._crit_edge.split.us.us.us1020.i:                 ; preds = %..loopexit904_crit_edge.us.us.us.i
  %i.qi = getelementptr inbounds [2 x i8], ptr %.13461001.us.us.i, i64 %i.iw ; 2 uses
  %indvars.iv.next1317.i = add nuw nsw i64 %indvars.iv1316.i, 2 ; 2 uses
  %i.qj = trunc i64 %indvars.iv.next1317.i to i32 ; 2 uses
  %i.qk = or i32 %i.qj, 1
  %i.ql = icmp slt i32 %i.qk, %i.fn
  br i1 %i.ql, label %.preheader908.us.us.i, label %.preheader910.i, !llvm.loop !382
...
.preheader910.i:                                  ; preds = %._crit_edge.split.us.us.us1020.i, %.preheader908.us.preheader.i, %.preheader908.preheader.i, %._crit_edge958.i
  %.1346.lcssa.i = phi ptr [ %.0345.lcssa.i, %._crit_edge958.i ], [ %scevgep1300.i, %.preheader908.preheader.i ], [ %scevgep1302.i, %.preheader908.us.preheader.i ], [ %i.qi, %._crit_edge.split.us.us.us1020.i ]
  %.1343.lcssa.i = phi i32 [ %.0342.lcssa.i, %._crit_edge958.i ], [ %i.od, %.preheader908.preheader.i ], [ %i.oj, %.preheader908.us.preheader.i ], [ %i.qj, %._crit_edge.split.us.us.us1020.i ] ; 2 uses
  %i.qm = phi <2 x float> [ %i.np, %._crit_edge958.i ], [ %i.np, %.preheader908.preheader.i ], [ %i.np, %.preheader908.us.preheader.i ], [ %i.qh, %._crit_edge.split.us.us.us1020.i ] ; 3 uses
  %i.qn = icmp slt i32 %.1343.lcssa.i, %i.fn
  br i1 %i.qn, label %.preheader907.lr.ph.i, label %._crit_edge1048.i

.preheader907.lr.ph.i:                            ; preds = %.preheader910.i
  %i.qo = load i32, ptr %i.d, align 4
  %i.qp = load i32, ptr %i.j, align 4
  %invariant.op1037.i = sub i32 %.neg887.i, %i.qp
  %i.qq = load i32, ptr %i.f, align 4             ; 2 uses
  %i.qr = load i32, ptr %i.a, align 4
  %.fr1233.i = freeze i32 %i.qr                   ; 2 uses
  %i.qs = load i32, ptr %i.c, align 4
  %i.qt = load i32, ptr %i.i, align 4
  %.neg881.i = add nuw nsw i32 %.03801065.i, 1
  %invariant.op1030.i = sub i32 %.neg881.i, %i.qt
  %i.qu = load i32, ptr %i.e, align 4             ; 2 uses
  %i.qv = icmp sgt i32 %.fr1233.i, 0
  %or.cond1451.i = and i1 %i.ir, %i.qv
...
.preheader907.us.us.preheader.i:                  ; preds = %.preheader907.lr.ph.i
  %i.qw = zext nneg i32 %.fr1233.i to i64         ; 2 uses
  %i.qx = zext i32 %.1343.lcssa.i to i64
  br label %.preheader907.us.us.i

.preheader907.us.us.i:                            ; preds = %._crit_edge.split.us.us.us1060.i, %.preheader907.us.us.preheader.i
  %indvars.iv1329.i = phi i64 [ %i.qx, %.preheader907.us.us.preheader.i ], [ %indvars.iv.next1330.i, %._crit_edge.split.us.us.us1060.i ] ; 2 uses
  %.23471045.us.us.i = phi ptr [ %.1346.lcssa.i, %.preheader907.us.us.preheader.i ], [ %i.so, %._crit_edge.split.us.us.us1060.i ] ; 2 uses
  %i.qy = phi <2 x float> [ %i.qm, %.preheader907.us.us.preheader.i ], [ %i.sn, %._crit_edge.split.us.us.us1060.i ]
  br label %bb.ah
...
bb.ah:                                            ; preds = %..loopexit902_crit_edge.us.us.us.i, %.preheader907.us.us.i
  ...
  %i.qz = phi <2 x float> [ %i.sn, %..loopexit902_crit_edge.us.us.us.i ], [ %i.qy, %.preheader907.us.us.i ] ; 3 uses
  %i.ra = trunc i64 %indvars.iv1324.i to i32
  %i.rb = mul i32 %i.qo, %i.ra
  %.reass1038.us.us.us.i = add i32 %i.rb, %invariant.op1037.i ; 3 uses
  %i.rc = icmp slt i32 %.reass1038.us.us.us.i, 0
  br i1 %i.rc, label %..loopexit902_crit_edge.us.us.us.i, label %bb.ai

bb.ai:                                            ; preds = %bb.ah
  %i.rd = srem i32 %.reass1038.us.us.us.i, %i.qq
  %i.re = sdiv i32 %.reass1038.us.us.us.i, %i.qq  ; 2 uses
  %.not434.us.us.us.i = icmp eq i32 %i.rd, 0
  %.not435.us.us.us.i = icmp slt i32 %i.re, %i.fp
...
.preheader901.us.us.us.i:                         ; preds = %bb.ai
  %i.rf = mul nuw nsw i64 %indvars.iv1324.i, %i.qw
  %i.rg = sext i32 %i.re to i64
  %i.rh = mul nsw i64 %i.rg, %i.gn
  br label %bb.aj
...
bb.aj:                                            ; preds = %bb.al, %.preheader901.us.us.us.i
  ...
  %i.ri = phi <2 x float> [ %i.sm, %bb.al ], [ %i.qz, %.preheader901.us.us.us.i ] ; 3 uses
  %i.rj = trunc i64 %indvars.iv1319.i to i32
  %i.rk = mul i32 %i.qs, %i.rj
...
bb.ak:                                            ; preds = %bb.aj
  %i.rm = srem i32 %.reass.us1039.us.us.i, %i.qu
  %i.rn = sdiv i32 %.reass.us1039.us.us.i, %i.qu  ; 2 uses
...
_ZN4ncnn3MatD2Ev.exit451.us.us.us.i:              ; preds = %bb.ak
  %i.ro = add nuw nsw i64 %indvars.iv1319.i, %i.rf
  %.idx.i = shl nuw nsw i64 %i.ro, 2
  %i.rp = getelementptr inbounds nuw i8, ptr %.23471045.us.us.i, i64 %.idx.i
  %i.rq = load ptr, ptr %1, align 8, !tbaa !20, !noalias !416
  %i.rr = load i64, ptr %i.fy, align 8, !tbaa !21, !noalias !416
  %i.rs = mul i64 %i.rr, %indvars.iv1329.i
  %i.rt = load i64, ptr %i.fz, align 8, !tbaa !55, !noalias !416 ; 2 uses
  %i.ru = mul i64 %i.rs, %i.rt
  %i.rv = getelementptr inbounds nuw i8, ptr %i.rq, i64 %i.ru
  %i.rw = mul i64 %i.rh, %i.rt
...
.preheader897.us.us.i:                            ; preds = %._crit_edge1104.split.us.us.us.i, %.preheader897.us.us.preheader.i
  ...
  %.03231118.us.us.i = phi ptr [ %i.vr, %.preheader897.us.us.preheader.i ], [ %i.zr, %._crit_edge1104.split.us.us.us.i ] ; 3 uses
  ...
  %i.wm = lshr exact i64 %indvars.iv1362.i, 2
  %i.wn = or disjoint i64 %indvars.iv1362.i, 1
  %i.wo = or disjoint i64 %indvars.iv1362.i, 2
  %i.wp = or disjoint i64 %indvars.iv1362.i, 3
...
.preheader897.us.us.i.split.us:                   ; preds = %.preheader897.us.us.i, %..loopexit894_crit_edge.us.us.us.i.us
  ...
  %i.wq = trunc i64 %indvars.iv1357.i.us to i32
  %i.wr = mul i32 %i.wd, %i.wq
  %.reass1107.us.us.us.i.us = add i32 %i.wr, %invariant.op1106.i ; 3 uses
  %i.ws = icmp slt i32 %.reass1107.us.us.us.i.us, 0
  br i1 %i.ws, label %..loopexit894_crit_edge.us.us.us.i.us, label %bb.au

bb.au:                                            ; preds = %.preheader897.us.us.i.split.us
  %i.wt = srem i32 %.reass1107.us.us.us.i.us, %i.wf
  %i.wu = sdiv i32 %.reass1107.us.us.us.i.us, %i.wf ; 2 uses
  %.not429.us.us.us.i.us = icmp eq i32 %i.wt, 0
  %.not430.us.us.us.i.us = icmp slt i32 %i.wu, %i.gy
...
.preheader893.us.us.us.i.us:                      ; preds = %bb.au
  %i.wv = mul nuw nsw i64 %indvars.iv1357.i.us, %i.wl
  %i.ww = sext i32 %i.wu to i64
  %i.wx = mul nsw i64 %i.ww, %i.hz
...
.lr.ph.split.us.us.us.us1137.i.us:                ; preds = %bb.aw, %.preheader893.us.us.us.i.us
  ...
  %i.wy = trunc i64 %indvars.iv1352.i.us to i32
  %i.wz = mul i32 %i.wh, %i.wy
  %.reass1089.us.us.us.us.i.us = add i32 %i.wz, %invariant.op1088.i ; 3 uses
  %i.xa = icmp slt i32 %.reass1089.us.us.us.us.i.us, 0
  br i1 %i.xa, label %bb.aw, label %bb.av

bb.av:                                            ; preds = %.lr.ph.split.us.us.us.us1137.i.us
  %i.xb = srem i32 %.reass1089.us.us.us.us.i.us, %i.wj
  %i.xc = sdiv i32 %.reass1089.us.us.us.us.i.us, %i.wj ; 2 uses
  %.not431.us.us.us.us.i.us = icmp eq i32 %i.xb, 0
  %.not432.us.us.us.us.i.us = icmp slt i32 %i.xc, %i.gx
...
_ZN4ncnn3MatD2Ev.exit448.us.us.us.us.i.us:        ; preds = %bb.av
  %i.xd = add nuw nsw i64 %indvars.iv1352.i.us, %i.wv
  %i.xe = shl i64 %i.xd, 2
  %i.xf = and i64 %i.xe, 4294967292
  %i.xg = getelementptr inbounds nuw [2 x i8], ptr %.03231118.us.us.i, i64 %i.xf
  %i.xh = load ptr, ptr %1, align 8, !tbaa !20, !noalias !417
  %i.xi = load i64, ptr %i.hh, align 8, !tbaa !21, !noalias !417
  %i.xj = mul i64 %i.xi, %i.wm
  %i.xk = load i64, ptr %i.hi, align 8, !tbaa !55, !noalias !417 ; 2 uses
  %i.xl = mul i64 %i.xj, %i.xk
  %i.xm = getelementptr inbounds nuw i8, ptr %i.xh, i64 %i.xl
  %i.xn = mul i64 %i.wx, %i.xk
  %i.xo = getelementptr inbounds nuw i8, ptr %i.xm, i64 %i.xn
  %i.xp = shl nsw i32 %i.xc, 2
  %i.xq = sext i32 %i.xp to i64
  %i.xr = getelementptr inbounds [2 x i8], ptr %i.xo, i64 %i.xq
  %i.xs = load i64, ptr %i.xr, align 1, !tbaa !80
  %i.xt = insertelement <2 x i64> poison, i64 %i.xs, i64 0
  %i.xu = bitcast <2 x i64> %i.xt to <8 x i16>
  %i.xv = shufflevector <8 x i16> <i16 0, i16 0, i16 0, i16 0, i16 poison, i16 poison, i16 poison, i16 poison>, <8 x i16> %i.xu, <8 x i32> <i32 0, i32 8, i32 1, i32 9, i32 2, i32 10, i32 3, i32 11>
  %i.xw = bitcast <8 x i16> %i.xv to <4 x float>
  %i.xx = load i64, ptr %i.xg, align 1, !tbaa !80
  ...
  %i.yc = fmul fast <4 x float> %i.yb, %i.xw
  %i.yd = fadd fast <4 x float> %i.yc, %.28321085.us.us.us.us.i.us
  br label %bb.aw

bb.aw:                                            ; preds = %_ZN4ncnn3MatD2Ev.exit448.us.us.us.us.i.us, %bb.av, %.lr.ph.split.us.us.us.us1137.i.us
  %.3833.us.us.us.us.i.us = phi nsz <4 x float> [ %.28321085.us.us.us.us.i.us, %.lr.ph.split.us.us.us.us1137.i.us ], [ %.28321085.us.us.us.us.i.us, %bb.av ], [ %i.yd, %_ZN4ncnn3MatD2Ev.exit448.us.us.us.us.i.us ] ; 2 uses
  %indvars.iv.next1353.i.us = add nuw nsw i64 %indvars.iv1352.i.us, 1 ; 2 uses
  %exitcond1356.not.i.us = icmp eq i64 %indvars.iv.next1353.i.us, %i.wl
...
.preheader897.us.us.i.split.us79:                 ; preds = %.preheader897.us.us.i, %..loopexit894_crit_edge.us.us.us.i.us86
  ...
  %i.ye = trunc i64 %indvars.iv1357.i.us80 to i32
  %i.yf = mul i32 %i.wd, %i.ye
  %.reass1107.us.us.us.i.us82 = add i32 %i.yf, %invariant.op1106.i ; 3 uses
  %i.yg = icmp slt i32 %.reass1107.us.us.us.i.us82, 0
  br i1 %i.yg, label %..loopexit894_crit_edge.us.us.us.i.us86, label %bb.ax

bb.ax:                                            ; preds = %.preheader897.us.us.i.split.us79
  %i.yh = srem i32 %.reass1107.us.us.us.i.us82, %i.wf
  %i.yi = sdiv i32 %.reass1107.us.us.us.i.us82, %i.wf ; 2 uses
  %.not429.us.us.us.i.us83 = icmp eq i32 %i.yh, 0
  %.not430.us.us.us.i.us84 = icmp slt i32 %i.yi, %i.gy
...
.preheader893.us.us.us.i.us85:                    ; preds = %bb.ax
  %i.yj = mul nuw nsw i64 %indvars.iv1357.i.us80, %i.wl
  %i.yk = sext i32 %i.yi to i64
  %i.yl = mul nsw i64 %i.yk, %i.hz
...
.lr.ph.split.us1091.us.us.us.i.us:                ; preds = %bb.az, %.preheader893.us.us.us.i.us85
  ...
  %i.ym = trunc i64 %indvars.iv1347.i.us to i32
  %i.yn = mul i32 %i.wh, %i.ym
  %.reass1089.us1094.us.us.us.i.us = add i32 %i.yn, %invariant.op1088.i ; 3 uses
  %i.yo = icmp slt i32 %.reass1089.us1094.us.us.us.i.us, 0
  br i1 %i.yo, label %bb.az, label %bb.ay

bb.ay:                                            ; preds = %.lr.ph.split.us1091.us.us.us.i.us
  %i.yp = srem i32 %.reass1089.us1094.us.us.us.i.us, %i.wj
  %i.yq = sdiv i32 %.reass1089.us1094.us.us.us.i.us, %i.wj ; 2 uses
  %.not431.us1095.us.us.us.i.us = icmp eq i32 %i.yp, 0
  %.not432.us1096.us.us.us.i.us = icmp slt i32 %i.yq, %i.gx
...
_ZN4ncnn3MatD2Ev.exit447.us.us.us.us.i.us:        ; preds = %bb.ay
  %i.yr = load ptr, ptr %1, align 8, !tbaa !20, !noalias !418
  %i.ys = load i64, ptr %i.hh, align 8, !tbaa !21, !noalias !418
  %i.yt = load i64, ptr %i.hi, align 8, !tbaa !55, !noalias !418 ; 2 uses
  %factor.op.mul1080.us.us.us.us.i.us = mul i64 %i.yt, %i.ys ; 4 uses
  %i.yu = mul i64 %i.yl, %i.yt
  %invariant.gep.us.us.us1133.us.i.us = getelementptr i8, ptr %i.yr, i64 %i.yu
  %i.yv = sext i32 %i.yq to i64
  %invariant.gep1082.us.us.us.us.i.us = getelementptr [2 x i8], ptr %invariant.gep.us.us.us1133.us.i.us, i64 %i.yv ; 4 uses
  ...
  %i.yw = load i16, ptr %gep1083.us.us.us.us.i.us, align 2, !tbaa !86
  %.reass1081.us.us.us.us.1.i.us = mul i64 %factor.op.mul1080.us.us.us.us.i.us, %i.wn
  %gep1083.us.us.us.us.1.i.us = getelementptr i8, ptr %invariant.gep1082.us.us.us.us.i.us, i64 %.reass1081.us.us.us.us.1.i.us
  %i.yx = load i16, ptr %gep1083.us.us.us.us.1.i.us, align 2, !tbaa !86
  %.reass1081.us.us.us.us.2.i.us = mul i64 %factor.op.mul1080.us.us.us.us.i.us, %i.wo
  %gep1083.us.us.us.us.2.i.us = getelementptr i8, ptr %invariant.gep1082.us.us.us.us.i.us, i64 %.reass1081.us.us.us.us.2.i.us
  %i.yy = load i16, ptr %gep1083.us.us.us.us.2.i.us, align 2, !tbaa !86
  %.reass1081.us.us.us.us.3.i.us = mul i64 %factor.op.mul1080.us.us.us.us.i.us, %i.wp
  %gep1083.us.us.us.us.3.i.us = getelementptr i8, ptr %invariant.gep1082.us.us.us.us.i.us, i64 %.reass1081.us.us.us.us.3.i.us
  %i.yz = load i16, ptr %gep1083.us.us.us.us.3.i.us, align 2, !tbaa !86
  %i.za = insertelement <4 x i16> poison, i16 %i.yw, i64 0
  %i.zb = insertelement <4 x i16> %i.za, i16 %i.yx, i64 1
  %i.zc = insertelement <4 x i16> %i.zb, i16 %i.yy, i64 2
  %i.zd = insertelement <4 x i16> %i.zc, i16 %i.yz, i64 3
  %i.ze = zext <4 x i16> %i.zd to <4 x i32>
  %i.zf = shl nuw <4 x i32> %i.ze, splat (i32 16)
  %.sroa.0.12.vec.insert.i.us = bitcast <4 x i32> %i.zf to <4 x float>
  %i.zg = add nuw nsw i64 %indvars.iv1347.i.us, %i.yj
  %i.zh = shl i64 %i.zg, 2
  %i.zi = and i64 %i.zh, 4294967292
  %i.zj = getelementptr inbounds nuw [2 x i8], ptr %.03231118.us.us.i, i64 %i.zi
  %i.zk = load i64, ptr %i.zj, align 1, !tbaa !80
  ...
  %i.zp = fmul fast <4 x float> %i.zo, %.sroa.0.12.vec.insert.i.us
  %i.zq = fadd fast <4 x float> %i.zp, %.28321085.us1093.us.us.us.i.us
  br label %bb.az

bb.az:                                            ; preds = %_ZN4ncnn3MatD2Ev.exit447.us.us.us.us.i.us, %bb.ay, %.lr.ph.split.us1091.us.us.us.i.us
  %.3833.us1097.us.us.us.i.us = phi nsz <4 x float> [ %.28321085.us1093.us.us.us.i.us, %.lr.ph.split.us1091.us.us.us.i.us ], [ %i.zq, %_ZN4ncnn3MatD2Ev.exit447.us.us.us.us.i.us ], [ %.28321085.us1093.us.us.us.i.us, %bb.ay ] ; 2 uses
  %indvars.iv.next1348.i.us = add nuw nsw i64 %indvars.iv1347.i.us, 1 ; 2 uses
  %exitcond1351.not.i.us = icmp eq i64 %indvars.iv.next1348.i.us, %i.wl
...
._crit_edge1104.split.us.us.us.i:                 ; preds = %..loopexit894_crit_edge.us.us.us.i.us86, %..loopexit894_crit_edge.us.us.us.i.us, %.preheader897.us.us.i
  ...
  %i.zr = getelementptr inbounds [2 x i8], ptr %.03231118.us.us.i, i64 %i.vw ; 2 uses
  %indvars.iv.next1363.i = add nuw nsw i64 %indvars.iv1362.i, 4 ; 2 uses
  %i.zs = icmp slt i64 %indvars.iv.next1363.i, %invariant.op1450.i
  br i1 %i.zs, label %.preheader897.us.us.i, label %._crit_edge1122.i, !llvm.loop !397
...
._crit_edge1122.i:                                ; preds = %._crit_edge1104.split.us.us.us.i, %.preheader897.lr.ph.i, %_ZN4ncnn3MatD2Ev.exit449.i
  ...
  %.0323.lcssa.i = phi ptr [ %i.vr, %_ZN4ncnn3MatD2Ev.exit449.i ], [ %scevgep1340.i, %.preheader897.lr.ph.i ], [ %i.zr, %._crit_edge1104.split.us.us.us.i ] ; 4 uses
  %.0322.lcssa.i = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit449.i ], [ %i.ht, %.preheader897.lr.ph.i ], [ %i.ia, %._crit_edge1104.split.us.us.us.i ] ; 7 uses
  %i.zt = shufflevector <4 x float> %.0830.lcssa.i, <4 x float> poison, <4 x i32> <i32 2, i32 3, i32 poison, i32 poison>
  %i.zu = fadd fast <4 x float> %i.zt, %.0830.lcssa.i ; 2 uses
  %i.zv = extractelement <4 x float> %i.zu, i64 1
  %i.zw = extractelement <4 x float> %i.zu, i64 0
  %i.zx = fadd fast float %i.zv, %.0326.i
  %i.zy = fadd fast float %i.zx, %i.zw            ; 4 uses
  %i.zz = or disjoint i32 %.0322.lcssa.i, 1
  %i.aaa = icmp slt i32 %i.zz, %i.gw
  br i1 %i.aaa, label %.preheader896.lr.ph.i, label %.preheader898.i

.preheader896.lr.ph.i:                            ; preds = %._crit_edge1122.i
  %i.aab = load i32, ptr %i.d, align 4
  %i.aac = load i32, ptr %i.j, align 4
  %invariant.op1157.i = sub i32 %.neg875.i, %i.aac
  %i.aad = load i32, ptr %i.f, align 4            ; 2 uses
  %i.aae = load i32, ptr %i.a, align 4
  %.fr1235.i = freeze i32 %i.aae                  ; 2 uses
  %i.aaf = load i32, ptr %i.c, align 4
  %i.aag = load i32, ptr %i.i, align 4
  %.neg873.i = add nuw nsw i32 %.03291213.i, 1
  %invariant.op1150.i = sub i32 %.neg873.i, %i.aag
  %i.aah = load i32, ptr %i.e, align 4            ; 2 uses
  br i1 %i.vt, label %.preheader896.lr.ph.split.us.i, label %.preheader896.preheader.i

.preheader896.preheader.i:                        ; preds = %.preheader896.lr.ph.i
  %reass.sub93 = sub i32 %6, %.0322.lcssa.i
  %i.aai = and i32 %reass.sub93, -2               ; 2 uses
  %i.aaj = zext i32 %i.aai to i64
  %i.aak = add nuw nsw i64 %i.aaj, 2
  %i.aal = mul nsw i64 %i.aak, %i.vy
  %scevgep1366.i = getelementptr i8, ptr %.0323.lcssa.i, i64 %i.aal
  %9 = add i32 %.0322.lcssa.i, 2
  %i.aam = add i32 %9, %i.aai
  br label %.preheader898.i

.preheader896.lr.ph.split.us.i:                   ; preds = %.preheader896.lr.ph.i
  %i.aan = icmp sgt i32 %.fr1235.i, 0
  br i1 %i.aan, label %.preheader896.us.us.preheader.i, label %.preheader896.us.preheader.i

.preheader896.us.preheader.i:                     ; preds = %.preheader896.lr.ph.split.us.i
  %reass.sub94 = sub i32 %6, %.0322.lcssa.i
  %i.aao = and i32 %reass.sub94, -2               ; 2 uses
  %i.aap = zext i32 %i.aao to i64
  %i.aaq = add nuw nsw i64 %i.aap, 2
  %i.aar = mul nsw i64 %i.aaq, %i.vy
  %scevgep1368.i = getelementptr i8, ptr %.0323.lcssa.i, i64 %i.aar
  %10 = add i32 %.0322.lcssa.i, 2
  %i.aas = add i32 %10, %i.aao
  br label %.preheader898.i

.preheader896.us.us.preheader.i:                  ; preds = %.preheader896.lr.ph.split.us.i
  %i.aat = zext nneg i32 %.fr1235.i to i64        ; 2 uses
  %i.aau = zext i32 %.0322.lcssa.i to i64
  br label %.preheader896.us.us.i

.preheader896.us.us.i:                            ; preds = %._crit_edge1155.split.us.us.us.i, %.preheader896.us.us.preheader.i
  %indvars.iv1382.i.a = phi i64 [ %i.aau, %.preheader896.us.us.preheader.i ], [ %indvars.iv.next1383.i.a, %._crit_edge1155.split.us.us.us.i ] ; 3 uses
  %.13241162.us.us.i = phi ptr [ %.0323.lcssa.i, %.preheader896.us.us.preheader.i ], [ %i.acg, %._crit_edge1155.split.us.us.us.i ] ; 2 uses
  %.13271161.us.us.i = phi float [ %i.zy, %.preheader896.us.us.preheader.i ], [ %.8.us.us.us.i, %._crit_edge1155.split.us.us.us.i ]
  %i.aav = add nuw nsw i64 %indvars.iv1382.i.a, 1
  br label %bb.ba
...
bb.ba:                                            ; preds = %..loopexit892_crit_edge.us.us.us.i, %.preheader896.us.us.i
  ...
  %i.aaw = trunc i64 %indvars.iv1377.i to i32
  %i.aax = mul i32 %i.aab, %i.aaw
  %.reass1158.us.us.us.i = add i32 %i.aax, %invariant.op1157.i ; 3 uses
  %i.aay = icmp slt i32 %.reass1158.us.us.us.i, 0
  br i1 %i.aay, label %..loopexit892_crit_edge.us.us.us.i, label %bb.bb

bb.bb:                                            ; preds = %bb.ba
  %i.aaz = srem i32 %.reass1158.us.us.us.i, %i.aad
  %i.aba = sdiv i32 %.reass1158.us.us.us.i, %i.aad ; 2 uses
  %.not425.us.us.us.i = icmp eq i32 %i.aaz, 0
  %.not426.us.us.us.i = icmp slt i32 %i.aba, %i.gy
...
.preheader891.us.us.us.i:                         ; preds = %bb.bb
  %i.abb = mul nuw nsw i64 %indvars.iv1377.i, %i.aat
  %i.abc = sext i32 %i.aba to i64
  %i.abd = mul nsw i64 %i.abc, %i.hz
  br label %bb.bc
...
bb.bc:                                            ; preds = %.loopexit.us.us.us.i, %.preheader891.us.us.us.i
  ...
  %i.abe = trunc i64 %indvars.iv1372.i to i32
  %i.abf = mul i32 %i.aaf, %i.abe
  %.reass1151.us.us.us.i = add i32 %invariant.op1150.i, %i.abf ; 3 uses
  %i.abg = icmp slt i32 %.reass1151.us.us.us.i, 0
  br i1 %i.abg, label %.loopexit.us.us.us.i, label %bb.bd

bb.bd:                                            ; preds = %bb.bc
  %i.abh = srem i32 %.reass1151.us.us.us.i, %i.aah
  %i.abi = sdiv i32 %.reass1151.us.us.us.i, %i.aah ; 2 uses
  %.not427.us.us.us.i = icmp eq i32 %i.abh, 0
  %.not428.us.us.us.i = icmp slt i32 %i.abi, %i.gx
...
_ZN4ncnn3MatD2Ev.exit446.us.us.us.i:              ; preds = %bb.bd
  %i.abj = add nuw nsw i64 %indvars.iv1372.i, %i.abb
  %.idx1440.i = shl nuw nsw i64 %i.abj, 2
  %i.abk = getelementptr inbounds nuw i8, ptr %.13241162.us.us.i, i64 %.idx1440.i
  %i.abl = load ptr, ptr %1, align 8, !tbaa !20, !noalias !419
  %i.abm = load i64, ptr %i.hh, align 8, !tbaa !21, !noalias !419
  %i.abn = load i64, ptr %i.hi, align 8, !tbaa !55, !noalias !419 ; 2 uses
  %factor.op.mul1141.us.us.us.i = mul i64 %i.abn, %i.abm ; 2 uses
  %i.abo = mul i64 %i.abd, %i.abn
  %invariant.gep.us.us.us1179.i = getelementptr i8, ptr %i.abl, i64 %i.abo
  %i.abp = sext i32 %i.abi to i64
  %invariant.gep1143.us.us.us.i = getelementptr [2 x i8], ptr %invariant.gep.us.us.us1179.i, i64 %i.abp ; 2 uses
  ...
  %i.abq = load i16, ptr %gep1144.us.us.us.i, align 2, !tbaa !86
  %.reass1142.us.us.us.1.i = mul i64 %factor.op.mul1141.us.us.us.i, %i.aav
  %gep1144.us.us.us.1.i = getelementptr i8, ptr %invariant.gep1143.us.us.us.i, i64 %.reass1142.us.us.us.1.i
  %i.abr = load i16, ptr %gep1144.us.us.us.1.i, align 2, !tbaa !86
  %i.abs = insertelement <2 x i16> poison, i16 %i.abq, i64 0
  %i.abt = insertelement <2 x i16> %i.abs, i16 %i.abr, i64 1
  %i.abu = zext <2 x i16> %i.abt to <2 x i32>
  %i.abv = shl nuw <2 x i32> %i.abu, splat (i32 16)
  %i.abw = bitcast <2 x i32> %i.abv to <2 x float>
  %i.abx = load <2 x i16>, ptr %i.abk, align 2, !tbaa !86
  %i.aby = zext <2 x i16> %i.abx to <2 x i32>
  %i.abz = shl nuw <2 x i32> %i.aby, splat (i32 16)
  %i.aca = bitcast <2 x i32> %i.abz to <2 x float>
  %i.acb = fmul fast <2 x float> %i.aca, %i.abw   ; 2 uses
  %i.acc = extractelement <2 x float> %i.acb, i64 0
  %i.acd = fadd fast float %.31147.us.us.us.i, %i.acc
...
.loopexit.us.us.us.i:                             ; preds = %_ZN4ncnn3MatD2Ev.exit446.us.us.us.i, %bb.bd, %bb.bc
  %.6.us.us.us.i = phi nsz float [ %.31147.us.us.us.i, %bb.bc ], [ %.31147.us.us.us.i, %bb.bd ], [ %i.acf, %_ZN4ncnn3MatD2Ev.exit446.us.us.us.i ] ; 2 uses
  %indvars.iv.next1373.i = add nuw nsw i64 %indvars.iv1372.i, 1 ; 2 uses
  %exitcond1376.not.i = icmp eq i64 %indvars.iv.next1373.i, %i.aat
...
._crit_edge1155.split.us.us.us.i:                 ; preds = %..loopexit892_crit_edge.us.us.us.i
  %i.acg = getelementptr inbounds [2 x i8], ptr %.13241162.us.us.i, i64 %i.vy ; 2 uses
  %indvars.iv.next1383.i.a = add nuw nsw i64 %indvars.iv1382.i.a, 2 ; 2 uses
  %i.ach = trunc i64 %indvars.iv.next1383.i.a to i32 ; 2 uses
  %i.aci = or i32 %i.ach, 1
  %i.acj = icmp slt i32 %i.aci, %i.gw
  br i1 %i.acj, label %.preheader896.us.us.i, label %.preheader898.i, !llvm.loop !402
...
.preheader898.i:                                  ; preds = %._crit_edge1155.split.us.us.us.i, %.preheader896.us.preheader.i, %.preheader896.preheader.i, %._crit_edge1122.i
  %.1327.lcssa.i = phi float [ %i.zy, %._crit_edge1122.i ], [ %i.zy, %.preheader896.preheader.i ], [ %i.zy, %.preheader896.us.preheader.i ], [ %.8.us.us.us.i, %._crit_edge1155.split.us.us.us.i ] ; 3 uses
  %.1324.lcssa.i = phi ptr [ %.0323.lcssa.i, %._crit_edge1122.i ], [ %scevgep1366.i, %.preheader896.preheader.i ], [ %scevgep1368.i, %.preheader896.us.preheader.i ], [ %i.acg, %._crit_edge1155.split.us.us.us.i ]
  %.1.lcssa.i = phi i32 [ %.0322.lcssa.i, %._crit_edge1122.i ], [ %i.aam, %.preheader896.preheader.i ], [ %i.aas, %.preheader896.us.preheader.i ], [ %i.ach, %._crit_edge1155.split.us.us.us.i ] ; 2 uses
  %i.ack = icmp slt i32 %.1.lcssa.i, %i.gw
  br i1 %i.ack, label %.preheader895.lr.ph.i, label %._crit_edge1201.i

.preheader895.lr.ph.i:                            ; preds = %.preheader898.i
  %i.acl = load i32, ptr %i.d, align 4
  %i.acm = load i32, ptr %i.j, align 4
  %invariant.op1193.i = sub i32 %.neg875.i, %i.acm
  %i.acn = load i32, ptr %i.f, align 4            ; 2 uses
  %i.aco = load i32, ptr %i.a, align 4
  %.fr1236.i = freeze i32 %i.aco                  ; 2 uses
  %i.acp = load i32, ptr %i.c, align 4
  %i.acq = load i32, ptr %i.i, align 4
  %.neg869.i = add nuw nsw i32 %.03291213.i, 1
  %invariant.op1186.i = sub i32 %.neg869.i, %i.acq
  %i.acr = load i32, ptr %i.e, align 4            ; 2 uses
  %i.acs = icmp sgt i32 %.fr1236.i, 0
  %or.cond1453.i = and i1 %i.vt, %i.acs
...
.preheader895.us.us.preheader.i:                  ; preds = %.preheader895.lr.ph.i
  %i.act = zext nneg i32 %.fr1236.i to i64        ; 2 uses
  %i.acu = zext i32 %.1.lcssa.i to i64
  br label %.preheader895.us.us.i

.preheader895.us.us.i:                            ; preds = %._crit_edge1191.split.us.us.us.i, %.preheader895.us.us.preheader.i
  %indvars.iv1395.i = phi i64 [ %i.acu, %.preheader895.us.us.preheader.i ], [ %indvars.iv.next1396.i, %._crit_edge1191.split.us.us.us.i ] ; 2 uses
  %.23251198.us.us.i = phi ptr [ %.1324.lcssa.i, %.preheader895.us.us.preheader.i ], [ %i.aee, %._crit_edge1191.split.us.us.us.i ] ; 2 uses
...
bb.be:                                            ; preds = %..loopexit890_crit_edge.us.us.us.i, %.preheader895.us.us.i
  ...
  %i.acv = trunc i64 %indvars.iv1390.i to i32
  %i.acw = mul i32 %i.acl, %i.acv
  %.reass1194.us.us.us.i = add i32 %i.acw, %invariant.op1193.i ; 3 uses
  %i.acx = icmp slt i32 %.reass1194.us.us.us.i, 0
  br i1 %i.acx, label %..loopexit890_crit_edge.us.us.us.i, label %bb.bf

bb.bf:                                            ; preds = %bb.be
  %i.acy = srem i32 %.reass1194.us.us.us.i, %i.acn
  %i.acz = sdiv i32 %.reass1194.us.us.us.i, %i.acn ; 2 uses
  %.not421.us.us.us.i = icmp eq i32 %i.acy, 0
  %.not422.us.us.us.i = icmp slt i32 %i.acz, %i.gy
...
.preheader.us.us.us.i:                            ; preds = %bb.bf
  %i.ada = mul nuw nsw i64 %indvars.iv1390.i, %i.act
  %i.adb = sext i32 %i.acz to i64
  %i.adc = getelementptr inbounds nuw [2 x i8], ptr %.23251198.us.us.i, i64 %i.ada
  %i.add = mul nsw i64 %i.adb, %i.hz
  br label %bb.bg
...
bb.bg:                                            ; preds = %bb.bi, %.preheader.us.us.us.i
  ...
  %i.ade = trunc i64 %indvars.iv1385.i to i32
  %i.adf = mul i32 %i.acp, %i.ade
  %.reass1187.us.us.us.i = add i32 %invariant.op1186.i, %i.adf ; 3 uses
  %i.adg = icmp slt i32 %.reass1187.us.us.us.i, 0
  br i1 %i.adg, label %bb.bi, label %bb.bh

bb.bh:                                            ; preds = %bb.bg
  %i.adh = srem i32 %.reass1187.us.us.us.i, %i.acr
  %i.adi = sdiv i32 %.reass1187.us.us.us.i, %i.acr ; 2 uses
  %.not423.us.us.us.i = icmp eq i32 %i.adh, 0
  %.not424.us.us.us.i = icmp slt i32 %i.adi, %i.gx
...
_ZN4ncnn3MatD2Ev.exit.us.us.us.i:                 ; preds = %bb.bh
  %i.adj = load ptr, ptr %1, align 8, !tbaa !20, !noalias !420
  %i.adk = load i64, ptr %i.hh, align 8, !tbaa !21, !noalias !420
  %i.adl = mul i64 %i.adk, %indvars.iv1395.i
  %i.adm = load i64, ptr %i.hi, align 8, !tbaa !55, !noalias !420 ; 2 uses
  %i.adn = mul i64 %i.adl, %i.adm
  %i.ado = getelementptr inbounds nuw i8, ptr %i.adj, i64 %i.adn
  %i.adp = mul i64 %i.add, %i.adm
  %i.adq = getelementptr inbounds nuw i8, ptr %i.ado, i64 %i.adp
  %i.adr = sext i32 %i.adi to i64
  %i.ads = getelementptr inbounds [2 x i8], ptr %i.adq, i64 %i.adr
  %i.adt = load i16, ptr %i.ads, align 2, !tbaa !86
  %i.adu = zext i16 %i.adt to i32
  %i.adv = shl nuw i32 %i.adu, 16
  %i.adw = bitcast i32 %i.adv to float
  %i.adx = getelementptr inbounds nuw [2 x i8], ptr %i.adc, i64 %indvars.iv1385.i
  %i.ady = load i16, ptr %i.adx, align 2, !tbaa !86
end_hunk_7
begin_hunk_8_@_ZNK4ncnn17Deconvolution_x867forwardERKNS_3MatERS1_RKNS_6OptionE.omp_outlined.1:bb.a
  ...
  br i1 %prol.iter.cmp.not, label %.noexc44.us108.us.prol.loopexit, label %.noexc44.us108.us.prol, !llvm.loop !440
...
.noexc44.us108:                                   ; preds = %.noexc44.us108.preheader, %._ZN4ncnn3Mat4fillEf.exit.preheader_crit_edge.us115
  %indvars.iv = phi i64 [ %i.eq, %.noexc44.us108.preheader ], [ %indvars.iv.next, %._ZN4ncnn3Mat4fillEf.exit.preheader_crit_edge.us115 ] ; 3 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.fs, label %middle.block, label %vector.body, !llvm.loop !441

middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %._ZN4ncnn3Mat4fillEf.exit.preheader_crit_edge.us115, label %scalar.ph.preheader

scalar.ph.preheader:                              ; preds = %.noexc44.us108, %middle.block
  %.0.i55.us113.ph = phi i32 [ 0, %.noexc44.us108 ], [ %i.et, %middle.block ]
  %.05.i54.us114.ph = phi ptr [ %i.fm, %.noexc44.us108 ], [ %i.fp, %middle.block ]
  br label %scalar.ph

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %.0.i55.us113 = phi i32 [ %i.fu, %scalar.ph ], [ %.0.i55.us113.ph, %scalar.ph.preheader ]
  %.05.i54.us114 = phi ptr [ %i.ft, %scalar.ph ], [ %.05.i54.us114.ph, %scalar.ph.preheader ] ; 2 uses
  %i.ft = getelementptr inbounds nuw i8, ptr %.05.i54.us114, i64 4
  store float %i.fo, ptr %.05.i54.us114, align 4, !tbaa !39
  %i.fu = add nuw nsw i32 %.0.i55.us113, 1        ; 2 uses
...
bb.c:                                             ; preds = %.preheader672, %bb.aa
  %.0197788 = phi i32 [ 0, %.preheader672 ], [ %i.th, %bb.aa ] ; 4 uses
...
bb.g:                                             ; preds = %.lr.ph.split.us684.us
  ...
  %i.cu = sdiv i32 %.reass.us690.us, %i.cs        ; 2 uses
...
bb.i:                                             ; preds = %.lr.ph.split.us.us
  ...
  %i.fi = sdiv i32 %.reass.us.us, %i.fg           ; 2 uses
...
.preheader671:                                    ; preds = %.preheader669.preheader, %.preheader671.loopexit, %_ZN4ncnn3MatD2Ev.exit242
  ...
  %.0193.lcssa = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit242 ], [ %i.bg, %.preheader671.loopexit ], [ %i.be, %.preheader669.preheader ] ; 5 uses
...
.preheader668.preheader:                          ; preds = %.preheader668.lr.ph
  %i.hr = sub i32 %20, %.0193.lcssa               ; 2 uses
  ...
  %scevgep818 = getelementptr i8, ptr %.0194.lcssa, i64 %i.hw
...
.preheader668.lr.ph.split.us:                     ; preds = %.preheader668.lr.ph
  %i.ia = load i32, ptr %9, align 4, !tbaa !60
  %i.ib = load i32, ptr %10, align 4, !tbaa !60
  %invariant.op752.us = sub i32 %.neg660, %i.ib
...
.preheader668.us:                                 ; preds = %._crit_edge.us764, %.preheader668.lr.ph.split.us
  %indvars.iv825 = phi i64 [ %indvars.iv.next826, %._crit_edge.us764 ], [ %i.ic, %.preheader668.lr.ph.split.us ] ; 2 uses
  %i.ie = phi i64 [ %i.ki, %._crit_edge.us764 ], [ %i.id, %.preheader668.lr.ph.split.us ]
  %.1195756.us = phi ptr [ %i.kh, %._crit_edge.us764 ], [ %.0194.lcssa, %.preheader668.lr.ph.split.us ] ; 2 uses
...
bb.l:                                             ; preds = %.preheader668.us, %.loopexit664.us
  %.0190748.us = phi i32 [ 0, %.preheader668.us ], [ %i.kc, %.loopexit664.us ] ; 3 uses
  ...
  %i.if = mul nsw i32 %i.ia, %.0190748.us
  %.reass753.us = add i32 %i.if, %invariant.op752.us ; 3 uses
  %i.ig = icmp slt i32 %.reass753.us, 0
  br i1 %i.ig, label %.loopexit664.us, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.ih = load i32, ptr %11, align 4, !tbaa !60   ; 2 uses
  %i.ii = srem i32 %.reass753.us, %i.ih
  %i.ij = sdiv i32 %.reass753.us, %i.ih           ; 2 uses
...
.preheader663.us:                                 ; preds = %bb.m
  %i.ik = load i32, ptr %12, align 4, !tbaa !60   ; 3 uses
  %i.il = icmp sgt i32 %i.ik, 0
  br i1 %i.il, label %.lr.ph.us762, label %.loopexit664.us
...
bb.n:                                             ; preds = %.lr.ph.us762, %bb.p
  ...
  %i.im = trunc i64 %indvars.iv819 to i32
  %i.in = mul i32 %i.kd, %i.im
  %.reass.us = add i32 %i.in, %invariant.op.us763 ; 3 uses
  %i.io = icmp slt i32 %.reass.us, 0
  br i1 %i.io, label %bb.p, label %bb.o

bb.o:                                             ; preds = %bb.n
  %i.ip = load i32, ptr %15, align 4, !tbaa !60   ; 2 uses
  %i.iq = srem i32 %.reass.us, %i.ip
  %i.ir = sdiv i32 %.reass.us, %i.ip              ; 2 uses
  %.not229.us = icmp eq i32 %i.iq, 0
  %.not230.us = icmp slt i32 %i.ir, %i.ad
...
_ZN4ncnn3MatD2Ev.exit236.us:                      ; preds = %bb.o
  %i.is = trunc i64 %indvars.iv819 to i32
  %i.it = add i32 %i.kf, %i.is
  %i.iu = shl nsw i32 %i.it, 3
  %i.iv = zext nneg i32 %i.iu to i64
  %i.iw = getelementptr inbounds nuw [4 x i8], ptr %.1195756.us, i64 %i.iv ; 2 uses
  %i.ix = load i32, ptr %i.n, align 4, !tbaa !54, !noalias !472
  %i.iy = load ptr, ptr %4, align 8, !tbaa !20, !noalias !472 ; 2 uses
  %i.iz = load i64, ptr %i.w, align 8, !tbaa !21, !noalias !472 ; 2 uses
  %i.ja = mul i64 %i.iz, %indvars.iv825
  %i.jb = load i64, ptr %i.x, align 8, !tbaa !55, !noalias !472 ; 3 uses
  %i.jc = mul i64 %i.ja, %i.jb
  %i.jd = getelementptr inbounds nuw i8, ptr %i.iy, i64 %i.jc
  %i.je = sext i32 %i.ix to i64
  %i.jf = mul nsw i64 %i.je, %i.kg
  %i.jg = mul i64 %i.jf, %i.jb                    ; 2 uses
  %i.jh = getelementptr inbounds nuw i8, ptr %i.jd, i64 %i.jg
  %i.ji = mul i64 %i.iz, %i.ie
  %i.jj = mul i64 %i.ji, %i.jb
  %i.jk = getelementptr inbounds nuw i8, ptr %i.iy, i64 %i.jj
  %i.jl = sext i32 %i.ir to i64                   ; 2 uses
  %i.jm = getelementptr inbounds [4 x i8], ptr %i.jh, i64 %i.jl
  %i.jn = getelementptr inbounds nuw i8, ptr %i.jk, i64 %i.jg
  %i.jo = getelementptr inbounds [4 x i8], ptr %i.jn, i64 %i.jl
  %i.jp = load float, ptr %i.jm, align 4, !tbaa !39
  ...
  %i.js = load float, ptr %i.jo, align 4, !tbaa !39
  ...
  %i.jv = load <4 x float>, ptr %i.iw, align 16, !tbaa !80
  %i.jw = fmul fast <4 x float> %i.jr, %i.jv
  %i.jx = fadd fast <4 x float> %i.jw, %.9645742.us
  %i.jy = getelementptr inbounds nuw i8, ptr %i.iw, i64 16
  %i.jz = load <4 x float>, ptr %i.jy, align 16, !tbaa !80
  %i.ka = fmul fast <4 x float> %i.ju, %i.jz
  %i.kb = fadd fast <4 x float> %i.ka, %.8743.us
  br label %bb.p

bb.p:                                             ; preds = %_ZN4ncnn3MatD2Ev.exit236.us, %bb.o, %bb.n
  %.10646.us = phi nsz <4 x float> [ %.9645742.us, %bb.n ], [ %i.jx, %_ZN4ncnn3MatD2Ev.exit236.us ], [ %.9645742.us, %bb.o ] ; 2 uses
  %.9.us = phi nsz <4 x float> [ %.8743.us, %bb.n ], [ %i.kb, %_ZN4ncnn3MatD2Ev.exit236.us ], [ %.8743.us, %bb.o ] ; 2 uses
...
.loopexit664.us:                                  ; preds = %bb.p, %.preheader663.us, %bb.m, %bb.l
  ...
  %i.kc = add nuw nsw i32 %.0190748.us, 1         ; 2 uses
  %exitcond824.not = icmp eq i32 %i.kc, %i.hm
  br i1 %exitcond824.not, label %._crit_edge.us764, label %bb.l, !llvm.loop !460

.lr.ph.us762:                                     ; preds = %.preheader663.us
  %i.kd = load i32, ptr %13, align 4, !tbaa !60
  %i.ke = load i32, ptr %14, align 4, !tbaa !60
  %invariant.op.us763 = sub i32 %.neg658, %i.ke
  %i.kf = mul nuw nsw i32 %i.ik, %.0190748.us
  %i.kg = sext i32 %i.ij to i64
  %wide.trip.count822 = zext nneg i32 %i.ik to i64
  br label %bb.n

._crit_edge.us764:                                ; preds = %.loopexit664.us
  %i.kh = getelementptr inbounds [4 x i8], ptr %.1195756.us, i64 %i.hq ; 2 uses
  %indvars.iv.next826 = add nuw nsw i64 %indvars.iv825, 2 ; 3 uses
  %i.ki = or disjoint i64 %indvars.iv.next826, 1  ; 2 uses
  %i.kj = trunc nuw i64 %i.ki to i32
  %i.kk = icmp sgt i32 %i.ac, %i.kj
  br i1 %i.kk, label %.preheader668.us, label %.preheader670.loopexit, !llvm.loop !461

.preheader670.loopexit:                           ; preds = %._crit_edge.us764
  %i.kl = trunc nuw i64 %indvars.iv.next826 to i32
  br label %.preheader670
...
.preheader670:                                    ; preds = %.preheader668.preheader, %.preheader670.loopexit, %.preheader671
  ...
  %.1195.lcssa = phi ptr [ %.0194.lcssa, %.preheader671 ], [ %i.kh, %.preheader670.loopexit ], [ %scevgep818, %.preheader668.preheader ]
  %.1.lcssa = phi i32 [ %.0193.lcssa, %.preheader671 ], [ %i.kl, %.preheader670.loopexit ], [ %i.hz, %.preheader668.preheader ] ; 2 uses
  %i.km = icmp slt i32 %.1.lcssa, %i.ac
  br i1 %i.km, label %.preheader667.lr.ph, label %._crit_edge779

.preheader667.lr.ph:                              ; preds = %.preheader670
  %i.kn = load i32, ptr %8, align 4, !tbaa !60    ; 2 uses
  %i.ko = icmp sgt i32 %i.kn, 0
  %.neg654 = add nuw nsw i32 %.0197788, 1
  %i.kp = load i32, ptr %16, align 4, !tbaa !60
  %i.kq = shl nsw i32 %i.kp, 2
  %i.kr = sext i32 %i.kq to i64
  br i1 %i.ko, label %.preheader667.lr.ph.split.us, label %._crit_edge779

.preheader667.lr.ph.split.us:                     ; preds = %.preheader667.lr.ph
  %i.ks = load i32, ptr %9, align 4, !tbaa !60
  %i.kt = load i32, ptr %10, align 4, !tbaa !60
  %invariant.op774.us = sub i32 %.neg660, %i.kt
  %i.ku = zext i32 %.1.lcssa to i64
  br label %.preheader667.us

.preheader667.us:                                 ; preds = %._crit_edge.us785, %.preheader667.lr.ph.split.us
  %indvars.iv834 = phi i64 [ %indvars.iv.next835, %._crit_edge.us785 ], [ %i.ku, %.preheader667.lr.ph.split.us ] ; 2 uses
  %.2196777.us = phi ptr [ %i.ml, %._crit_edge.us785 ], [ %.1195.lcssa, %.preheader667.lr.ph.split.us ] ; 2 uses
...
bb.q:                                             ; preds = %.preheader667.us, %.loopexit.us
  %.0188771.us = phi i32 [ 0, %.preheader667.us ], [ %i.mg, %.loopexit.us ] ; 3 uses
  %.13770.us = phi <4 x float> [ %.12776.us, %.preheader667.us ], [ %.16.us, %.loopexit.us ] ; 4 uses
  %i.kv = mul nsw i32 %i.ks, %.0188771.us
  %.reass775.us = add i32 %i.kv, %invariant.op774.us ; 3 uses
  %i.kw = icmp slt i32 %.reass775.us, 0
  br i1 %i.kw, label %.loopexit.us, label %bb.r

bb.r:                                             ; preds = %bb.q
  %i.kx = load i32, ptr %11, align 4, !tbaa !60   ; 2 uses
  %i.ky = srem i32 %.reass775.us, %i.kx
  %i.kz = sdiv i32 %.reass775.us, %i.kx           ; 2 uses
...
.preheader.us:                                    ; preds = %bb.r
  %i.la = load i32, ptr %12, align 4, !tbaa !60   ; 3 uses
  %i.lb = icmp sgt i32 %i.la, 0
  br i1 %i.lb, label %.lr.ph.us782, label %.loopexit.us
...
begin_hunk_9_@_ZN4ncnnL20deconvolution_packedERKNS_3MatERS0_S2_S2_iiiiiiiS2_RKNS_6OptionE.omp_outlined:bb.a
  ...
  %i.sn = fmul fast <4 x float> %i.sm, %i.mp
  br label %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit

bb.y:                                             ; preds = %._crit_edge779
  %i.so = load ptr, ptr %18, align 8, !tbaa !20   ; 2 uses
  ...
  %i.sw = fmul fast <4 x float> %i.sr, %i.mp
  ...
  %i.ta = fmul fast <4 x float> %i.sz, %i.mp
  br label %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit

_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit:      ; preds = %bb.y, %.noexc310, %.noexc309, %bb.x, %.noexc308, %bb.w, %._crit_edge779
  %.0.i = phi nsz <4 x float> [ %i.ta, %bb.y ], [ %i.mr, %bb.w ], [ %i.mz, %.noexc308 ], [ %i.nj, %bb.x ], [ %i.oq, %.noexc309 ], [ %i.sn, %.noexc310 ], [ %i.mp, %._crit_edge779 ] ; 5 uses
...
.thread:                                          ; preds = %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit
  store <4 x float> %.0.i, ptr %.1200787, align 1, !tbaa !80
  %i.tb = getelementptr inbounds nuw i8, ptr %.1200787, i64 16
  br label %bb.aa

bb.z:                                             ; preds = %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit
  %.sroa.0.0.vec.extract = extractelement <4 x float> %.0.i, i64 0
  store float %.sroa.0.0.vec.extract, ptr %.1200787, align 4, !tbaa !39
  %.sroa.0.4.vec.extract = extractelement <4 x float> %.0.i, i64 1
  %i.tc = load i64, ptr %19, align 8, !tbaa !82   ; 3 uses
  %i.td = getelementptr inbounds nuw [4 x i8], ptr %.1200787, i64 %i.tc
  store float %.sroa.0.4.vec.extract, ptr %i.td, align 4, !tbaa !39
  %.sroa.0.8.vec.extract = extractelement <4 x float> %.0.i, i64 2
  %.idx = shl i64 %i.tc, 3
  %i.te = getelementptr inbounds nuw i8, ptr %.1200787, i64 %.idx
  store float %.sroa.0.8.vec.extract, ptr %i.te, align 4, !tbaa !39
  %.sroa.0.12.vec.extract = extractelement <4 x float> %.0.i, i64 3
  %.idx222 = mul i64 %i.tc, 12
  %i.tf = getelementptr inbounds nuw i8, ptr %.1200787, i64 %.idx222
  store float %.sroa.0.12.vec.extract, ptr %i.tf, align 4, !tbaa !39
  %i.tg = getelementptr inbounds nuw i8, ptr %.1200787, i64 4
  br label %bb.aa

bb.aa:                                            ; preds = %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit, %.thread, %bb.z
  %.3 = phi ptr [ %i.tg, %bb.z ], [ %.1200787, %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit ], [ %i.tb, %.thread ] ; 2 uses
  %i.th = add nuw nsw i32 %.0197788, 1            ; 2 uses
  %exitcond837.not = icmp eq i32 %i.th, %i.af
  br i1 %exitcond837.not, label %._crit_edge, label %bb.c, !llvm.loop !467
...
bb.c:                                             ; preds = %.preheader684, %bb.aa
  %.0197800 = phi i32 [ 0, %.preheader684 ], [ %i.wl, %bb.aa ] ; 4 uses
...
bb.g:                                             ; preds = %.lr.ph.split.us696.us
  ...
  %i.cv = sdiv i32 %.reass.us702.us, %i.ct        ; 2 uses
...
bb.i:                                             ; preds = %.lr.ph.split.us.us
  ...
  %i.gl = sdiv i32 %.reass.us.us, %i.gj           ; 2 uses
...
.preheader683:                                    ; preds = %.preheader681.preheader, %.preheader683.loopexit, %_ZN4ncnn3MatD2Ev.exit242
  ...
  %.0193.lcssa = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit242 ], [ %20, %.preheader683.loopexit ], [ %i.be, %.preheader681.preheader ] ; 5 uses
...
.preheader680.preheader:                          ; preds = %.preheader680.lr.ph
  %i.jq = sub i32 %i.bh, %.0193.lcssa             ; 2 uses
  %i.jr = and i32 %i.jq, -2
  %i.js = zext i32 %i.jr to i64
  %i.jt = add nuw nsw i64 %i.js, 2
  %i.ju = mul nsw i64 %i.jt, %i.jp
  %scevgep830 = getelementptr i8, ptr %.0194.lcssa, i64 %i.ju
...
.preheader680.lr.ph.split.us:                     ; preds = %.preheader680.lr.ph
  %i.jy = load i32, ptr %9, align 4, !tbaa !60
  %i.jz = load i32, ptr %10, align 4, !tbaa !60
  %invariant.op764.us = sub i32 %.neg672, %i.jz
...
.preheader680.us:                                 ; preds = %._crit_edge.us776, %.preheader680.lr.ph.split.us
  %indvars.iv837 = phi i64 [ %indvars.iv.next838, %._crit_edge.us776 ], [ %i.ka, %.preheader680.lr.ph.split.us ] ; 2 uses
  %i.kc = phi i64 [ %i.mu, %._crit_edge.us776 ], [ %i.kb, %.preheader680.lr.ph.split.us ]
  %.1195768.us = phi ptr [ %i.mt, %._crit_edge.us776 ], [ %.0194.lcssa, %.preheader680.lr.ph.split.us ] ; 2 uses
...
bb.l:                                             ; preds = %.preheader680.us, %.loopexit676.us
  %.0190760.us = phi i32 [ 0, %.preheader680.us ], [ %i.mo, %.loopexit676.us ] ; 3 uses
  ...
  %i.kd = mul nsw i32 %i.jy, %.0190760.us
  %.reass765.us = add i32 %i.kd, %invariant.op764.us ; 3 uses
  %i.ke = icmp slt i32 %.reass765.us, 0
  br i1 %i.ke, label %.loopexit676.us, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.kf = load i32, ptr %11, align 4, !tbaa !60   ; 2 uses
  %i.kg = srem i32 %.reass765.us, %i.kf
  %i.kh = sdiv i32 %.reass765.us, %i.kf           ; 2 uses
...
.preheader675.us:                                 ; preds = %bb.m
  %i.ki = load i32, ptr %12, align 4, !tbaa !60   ; 3 uses
  %i.kj = icmp sgt i32 %i.ki, 0
  br i1 %i.kj, label %.lr.ph.us774, label %.loopexit676.us
...
bb.n:                                             ; preds = %.lr.ph.us774, %bb.p
  ...
  %i.kk = trunc i64 %indvars.iv831 to i32
  %i.kl = mul i32 %i.mp, %i.kk
  %.reass.us = add i32 %i.kl, %invariant.op.us775 ; 3 uses
  %i.km = icmp slt i32 %.reass.us, 0
  br i1 %i.km, label %bb.p, label %bb.o

bb.o:                                             ; preds = %bb.n
  %i.kn = load i32, ptr %15, align 4, !tbaa !60   ; 2 uses
  %i.ko = srem i32 %.reass.us, %i.kn
  %i.kp = sdiv i32 %.reass.us, %i.kn              ; 2 uses
  %.not229.us = icmp eq i32 %i.ko, 0
  %.not230.us = icmp slt i32 %i.kp, %i.ad
  %or.cond888 = select i1 %.not229.us, i1 %.not230.us, i1 false
  br i1 %or.cond888, label %_ZN4ncnn3MatD2Ev.exit236.us, label %bb.p

_ZN4ncnn3MatD2Ev.exit236.us:                      ; preds = %bb.o
  %i.kq = trunc i64 %indvars.iv831 to i32
  %i.kr = add i32 %i.mr, %i.kq
  %i.ks = shl nsw i32 %i.kr, 3
  %i.kt = zext nneg i32 %i.ks to i64
  %i.ku = getelementptr inbounds nuw [2 x i8], ptr %.1195768.us, i64 %i.kt ; 2 uses
  %i.kv = load i32, ptr %i.n, align 4, !tbaa !54, !noalias !502
  %i.kw = load ptr, ptr %4, align 8, !tbaa !20, !noalias !502 ; 2 uses
  %i.kx = load i64, ptr %i.w, align 8, !tbaa !21, !noalias !502 ; 2 uses
  %i.ky = mul i64 %i.kx, %indvars.iv837
  %i.kz = load i64, ptr %i.x, align 8, !tbaa !55, !noalias !502 ; 3 uses
  %i.la = mul i64 %i.ky, %i.kz
  %i.lb = getelementptr inbounds nuw i8, ptr %i.kw, i64 %i.la
  %i.lc = sext i32 %i.kv to i64
  %i.ld = mul nsw i64 %i.lc, %i.ms
  %i.le = mul i64 %i.ld, %i.kz                    ; 2 uses
  %i.lf = getelementptr inbounds nuw i8, ptr %i.lb, i64 %i.le
  %i.lg = mul i64 %i.kx, %i.kc
  %i.lh = mul i64 %i.lg, %i.kz
  %i.li = getelementptr inbounds nuw i8, ptr %i.kw, i64 %i.lh
  %i.lj = sext i32 %i.kp to i64                   ; 2 uses
  %i.lk = getelementptr inbounds [2 x i8], ptr %i.lf, i64 %i.lj
  %i.ll = getelementptr inbounds nuw i8, ptr %i.li, i64 %i.le
  %i.lm = getelementptr inbounds [2 x i8], ptr %i.ll, i64 %i.lj
  %i.ln = load i16, ptr %i.lk, align 2, !tbaa !86
  %i.lo = zext i16 %i.ln to i32
  %i.lp = shl nuw i32 %i.lo, 16
  %i.lq = insertelement <4 x i32> poison, i32 %i.lp, i64 0
  %i.lr = bitcast <4 x i32> %i.lq to <4 x float>
  %i.ls = shufflevector <4 x float> %i.lr, <4 x float> poison, <4 x i32> zeroinitializer
  %i.lt = load i16, ptr %i.lm, align 2, !tbaa !86
  %i.lu = zext i16 %i.lt to i32
  %i.lv = shl nuw i32 %i.lu, 16
  %i.lw = insertelement <4 x i32> poison, i32 %i.lv, i64 0
  %i.lx = bitcast <4 x i32> %i.lw to <4 x float>
  %i.ly = shufflevector <4 x float> %i.lx, <4 x float> poison, <4 x i32> zeroinitializer
  %i.lz = load i64, ptr %i.ku, align 1, !tbaa !80
  %i.ma = insertelement <2 x i64> poison, i64 %i.lz, i64 0
  %i.mb = bitcast <2 x i64> %i.ma to <8 x i16>
  %i.mc = shufflevector <8 x i16> <i16 0, i16 0, i16 0, i16 0, i16 poison, i16 poison, i16 poison, i16 poison>, <8 x i16> %i.mb, <8 x i32> <i32 0, i32 8, i32 1, i32 9, i32 2, i32 10, i32 3, i32 11>
  %i.md = bitcast <8 x i16> %i.mc to <4 x float>
  %i.me = fmul fast <4 x float> %i.ls, %i.md
  %i.mf = fadd fast <4 x float> %i.me, %.9657754.us
  %i.mg = getelementptr inbounds nuw i8, ptr %i.ku, i64 8
  %i.mh = load i64, ptr %i.mg, align 1, !tbaa !80
  %i.mi = insertelement <2 x i64> poison, i64 %i.mh, i64 0
  %i.mj = bitcast <2 x i64> %i.mi to <8 x i16>
  ...
  %i.ml = bitcast <8 x i16> %i.mk to <4 x float>
  %i.mm = fmul fast <4 x float> %i.ly, %i.ml
  %i.mn = fadd fast <4 x float> %i.mm, %.8755.us
  br label %bb.p

bb.p:                                             ; preds = %_ZN4ncnn3MatD2Ev.exit236.us, %bb.o, %bb.n
  %.10658.us = phi nsz <4 x float> [ %.9657754.us, %bb.n ], [ %i.mf, %_ZN4ncnn3MatD2Ev.exit236.us ], [ %.9657754.us, %bb.o ] ; 2 uses
  %.9.us = phi nsz <4 x float> [ %.8755.us, %bb.n ], [ %i.mn, %_ZN4ncnn3MatD2Ev.exit236.us ], [ %.8755.us, %bb.o ] ; 2 uses
...
.loopexit676.us:                                  ; preds = %bb.p, %.preheader675.us, %bb.m, %bb.l
  ...
  %i.mo = add nuw nsw i32 %.0190760.us, 1         ; 2 uses
  %exitcond836.not = icmp eq i32 %i.mo, %i.jl
  br i1 %exitcond836.not, label %._crit_edge.us776, label %bb.l, !llvm.loop !490

.lr.ph.us774:                                     ; preds = %.preheader675.us
  %i.mp = load i32, ptr %13, align 4, !tbaa !60
  %i.mq = load i32, ptr %14, align 4, !tbaa !60
  %invariant.op.us775 = sub i32 %.neg670, %i.mq
  %i.mr = mul nuw nsw i32 %i.ki, %.0190760.us
  %i.ms = sext i32 %i.kh to i64
  %wide.trip.count834 = zext nneg i32 %i.ki to i64
  br label %bb.n

._crit_edge.us776:                                ; preds = %.loopexit676.us
  %i.mt = getelementptr inbounds [2 x i8], ptr %.1195768.us, i64 %i.jp ; 2 uses
  %indvars.iv.next838 = add nuw nsw i64 %indvars.iv837, 2 ; 3 uses
  %i.mu = or disjoint i64 %indvars.iv.next838, 1  ; 2 uses
  %i.mv = trunc nuw i64 %i.mu to i32
  %i.mw = icmp sgt i32 %i.ac, %i.mv
  br i1 %i.mw, label %.preheader680.us, label %.preheader682.loopexit, !llvm.loop !491

.preheader682.loopexit:                           ; preds = %._crit_edge.us776
  %i.mx = trunc nuw i64 %indvars.iv.next838 to i32
  br label %.preheader682
...
.preheader682:                                    ; preds = %.preheader680.preheader, %.preheader682.loopexit, %.preheader683
  ...
  %.1195.lcssa = phi ptr [ %.0194.lcssa, %.preheader683 ], [ %i.mt, %.preheader682.loopexit ], [ %scevgep830, %.preheader680.preheader ]
  %.1.lcssa = phi i32 [ %.0193.lcssa, %.preheader683 ], [ %i.mx, %.preheader682.loopexit ], [ %i.jx, %.preheader680.preheader ] ; 2 uses
  %i.my = icmp slt i32 %.1.lcssa, %i.ac
  br i1 %i.my, label %.preheader679.lr.ph, label %._crit_edge791

.preheader679.lr.ph:                              ; preds = %.preheader682
  %i.mz = load i32, ptr %8, align 4, !tbaa !60    ; 2 uses
  %i.na = icmp sgt i32 %i.mz, 0
  %.neg666 = add nuw nsw i32 %.0197800, 1
  %i.nb = load i32, ptr %16, align 4, !tbaa !60
  %i.nc = shl nsw i32 %i.nb, 2
  %i.nd = sext i32 %i.nc to i64
  br i1 %i.na, label %.preheader679.lr.ph.split.us, label %._crit_edge791

.preheader679.lr.ph.split.us:                     ; preds = %.preheader679.lr.ph
  %i.ne = load i32, ptr %9, align 4, !tbaa !60
  %i.nf = load i32, ptr %10, align 4, !tbaa !60
  %invariant.op786.us = sub i32 %.neg672, %i.nf
  %i.ng = zext i32 %.1.lcssa to i64
  br label %.preheader679.us

.preheader679.us:                                 ; preds = %._crit_edge.us797, %.preheader679.lr.ph.split.us
  %indvars.iv846 = phi i64 [ %indvars.iv.next847, %._crit_edge.us797 ], [ %i.ng, %.preheader679.lr.ph.split.us ] ; 2 uses
  %.2196789.us = phi ptr [ %i.pe, %._crit_edge.us797 ], [ %.1195.lcssa, %.preheader679.lr.ph.split.us ] ; 2 uses
...
bb.q:                                             ; preds = %.preheader679.us, %.loopexit.us
  %.0188783.us = phi i32 [ 0, %.preheader679.us ], [ %i.oz, %.loopexit.us ] ; 3 uses
  %.13782.us = phi <4 x float> [ %.12788.us, %.preheader679.us ], [ %.16.us, %.loopexit.us ] ; 4 uses
  %i.nh = mul nsw i32 %i.ne, %.0188783.us
  %.reass787.us = add i32 %i.nh, %invariant.op786.us ; 3 uses
  %i.ni = icmp slt i32 %.reass787.us, 0
  br i1 %i.ni, label %.loopexit.us, label %bb.r

bb.r:                                             ; preds = %bb.q
  %i.nj = load i32, ptr %11, align 4, !tbaa !60   ; 2 uses
  %i.nk = srem i32 %.reass787.us, %i.nj
  %i.nl = sdiv i32 %.reass787.us, %i.nj           ; 2 uses
...
.noexc310:                                        ; preds = %._crit_edge791
  ...
  %i.te = fmul fast <4 x float> %i.td, %i.td
  ...
  %i.tv = fmul fast <4 x float> %i.tu, %i.td
  %reass.mul = fmul fast <4 x float> %i.tc, splat (float f0x3F317218)
  %reass.add661 = fadd fast <4 x float> %i.tv, splat (float -5.000000e-01)
  %reass.mul662 = fmul fast <4 x float> %i.te, %reass.add661
  %i.tw = fadd fast <4 x float> %reass.mul, %i.td
  %i.tx = fadd fast <4 x float> %i.tw, %reass.mul662
  %.neg = fmul fast <4 x float> %i.tx, splat (float -2.000000e+00)
  %i.ty = select fast <4 x i1> %i.sp, <4 x float> splat (float +nan(0x3FFFFF)), <4 x float> %.neg
  %i.tz = call fast noundef nofpclass(nan inf) <4 x float> @llvm.x86.sse.min.ps(<4 x float> nofpclass(nan inf) %i.ty, <4 x float> splat (float f0x42B0C0A5))
  %i.ua = call fast noundef nofpclass(nan inf) <4 x float> @llvm.x86.sse.max.ps(<4 x float> nofpclass(nan inf) %i.tz, <4 x float> splat (float f0xC2B0C0A5)) ; 2 uses
  %i.ub = fmul fast <4 x float> %i.ua, splat (float f0x3FB8AA3B)
  %i.uc = fadd fast <4 x float> %i.ub, splat (float 5.000000e-01) ; 2 uses
  %i.ud = call <4 x i32> @llvm.x86.sse2.cvttps2dq(<4 x float> nofpclass(nan inf) %i.uc)
  %i.ue = sitofp fast <4 x i32> %i.ud to <4 x float> ; 2 uses
  %i.uf = fcmp fast olt <4 x float> %i.uc, %i.ue
  %i.ug = select <4 x i1> %i.uf, <4 x float> splat (float 1.000000e+00), <4 x float> zeroinitializer
  %i.uh = fsub fast <4 x float> %i.ue, %i.ug      ; 2 uses
  %i.ui = fmul fast <4 x float> %i.uh, splat (float f0x3F317218)
  %i.uj = fsub fast <4 x float> %i.ua, %i.ui      ; 8 uses
  %i.uk = fmul fast <4 x float> %i.uj, %i.uj
  %i.ul = fmul fast <4 x float> %i.uj, splat (float f0x39506967)
  %i.um = fadd fast <4 x float> %i.ul, splat (float f0x3AB743CE)
  %i.un = fmul fast <4 x float> %i.um, %i.uj
  %i.uo = fadd fast <4 x float> %i.un, splat (float f0x3C088908)
  %i.up = fmul fast <4 x float> %i.uo, %i.uj
  %i.uq = fadd fast <4 x float> %i.up, splat (float f0x3D2AA9C1)
  %i.ur = fmul fast <4 x float> %i.uq, %i.uj
  %i.us = fadd fast <4 x float> %i.ur, splat (float f0x3E2AAAAA)
  %i.ut = fmul fast <4 x float> %i.us, %i.uj
  %i.uu = fadd fast <4 x float> %i.ut, splat (float 5.000000e-01)
  %i.uv = fmul fast <4 x float> %i.uk, %i.uu
  %i.uw = fadd fast <4 x float> %i.uj, %i.uv
  %i.ux = fadd fast <4 x float> %i.uw, splat (float 1.000000e+00)
  %i.uy = call <4 x i32> @llvm.x86.sse2.cvttps2dq(<4 x float> nofpclass(nan inf) %i.uh)
  %i.uz = shl <4 x i32> %i.uy, splat (i32 23)
  %i.va = add <4 x i32> %i.uz, splat (i32 1065353216)
  %i.vb = bitcast <4 x i32> %i.va to <4 x float>
  %i.vc = fmul fast <4 x float> %i.ux, %i.vb
  %i.vd = fadd fast <4 x float> %i.vc, splat (float 1.000000e+00)
  %i.ve = fdiv fast <4 x float> splat (float 2.000000e+00), %i.vd
  %i.vf = fadd fast <4 x float> %i.ve, splat (float -1.000000e+00)
  %i.vg = fmul fast <4 x float> %i.vf, %i.pi
  br label %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit

bb.y:                                             ; preds = %._crit_edge791
  %i.vh = load ptr, ptr %18, align 8, !tbaa !20   ; 2 uses
  %i.vi = load float, ptr %i.vh, align 4, !tbaa !39
  %i.vj = insertelement <4 x float> poison, float %i.vi, i64 0
  %i.vk = shufflevector <4 x float> %i.vj, <4 x float> poison, <4 x i32> zeroinitializer
  %i.vl = getelementptr inbounds nuw i8, ptr %i.vh, i64 4
  %i.vm = load float, ptr %i.vl, align 4, !tbaa !39
  %i.vn = insertelement <4 x float> poison, float %i.vm, i64 0
  %i.vo = shufflevector <4 x float> %i.vn, <4 x float> poison, <4 x i32> zeroinitializer
  %i.vp = fmul fast <4 x float> %i.vk, %i.pi
  %i.vq = fadd fast <4 x float> %i.vp, %i.vo
  %i.vr = call fast noundef nofpclass(nan inf) <4 x float> @llvm.x86.sse.max.ps(<4 x float> nofpclass(nan inf) %i.vq, <4 x float> zeroinitializer)
  %i.vs = call fast noundef nofpclass(nan inf) <4 x float> @llvm.x86.sse.min.ps(<4 x float> nofpclass(nan inf) %i.vr, <4 x float> splat (float 1.000000e+00))
  %i.vt = fmul fast <4 x float> %i.vs, %i.pi
  br label %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit

_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit:      ; preds = %bb.y, %.noexc310, %.noexc309, %bb.x, %.noexc308, %bb.w, %._crit_edge791
  %.0.i = phi nsz <4 x float> [ %i.vt, %bb.y ], [ %i.pk, %bb.w ], [ %i.ps, %.noexc308 ], [ %i.qc, %bb.x ], [ %i.rj, %.noexc309 ], [ %i.vg, %.noexc310 ], [ %i.pi, %._crit_edge791 ] ; 2 uses
  switch i32 %i.ah, label %bb.aa [
    i32 4, label %.thread
    i32 1, label %bb.z
  ]
...
.thread:                                          ; preds = %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit
  %i.vu = bitcast <4 x float> %.0.i to <8 x i16>
  %i.vv = shufflevector <8 x i16> %i.vu, <8 x i16> poison, <8 x i32> <i32 1, i32 3, i32 poison, i32 poison, i32 5, i32 7, i32 poison, i32 poison>
  %i.vw = bitcast <8 x i16> %i.vv to <4 x float>
  %i.vx = shufflevector <4 x float> %i.vw, <4 x float> poison, <4 x i32> <i32 0, i32 2, i32 poison, i32 poison>
  %i.vy = bitcast <4 x float> %i.vx to <2 x i64>
  %i.vz = extractelement <2 x i64> %i.vy, i64 0
  store i64 %i.vz, ptr %.1200799, align 1, !tbaa !80
  %i.wa = getelementptr inbounds nuw i8, ptr %.1200799, i64 8
  br label %bb.aa

bb.z:                                             ; preds = %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit
  %i.wb = bitcast <4 x float> %.0.i to <8 x i16>  ; 4 uses
  %i.wc = extractelement <8 x i16> %i.wb, i64 1
  store i16 %i.wc, ptr %.1200799, align 2, !tbaa !86
  %i.wd = extractelement <8 x i16> %i.wb, i64 3
  %i.we = load i64, ptr %19, align 8, !tbaa !82   ; 3 uses
  %i.wf = getelementptr inbounds nuw [2 x i8], ptr %.1200799, i64 %i.we
  store i16 %i.wd, ptr %i.wf, align 2, !tbaa !86
  %i.wg = extractelement <8 x i16> %i.wb, i64 5
  %.idx = shl i64 %i.we, 2
  %i.wh = getelementptr inbounds nuw i8, ptr %.1200799, i64 %.idx
  store i16 %i.wg, ptr %i.wh, align 2, !tbaa !86
  %i.wi = extractelement <8 x i16> %i.wb, i64 7
  %.idx222 = mul i64 %i.we, 6
  %i.wj = getelementptr inbounds nuw i8, ptr %.1200799, i64 %.idx222
  store i16 %i.wi, ptr %i.wj, align 2, !tbaa !86
  %i.wk = getelementptr inbounds nuw i8, ptr %.1200799, i64 2
  br label %bb.aa

bb.aa:                                            ; preds = %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit, %.thread, %bb.z
  %.3 = phi ptr [ %i.wk, %bb.z ], [ %.1200799, %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit ], [ %i.wa, %.thread ] ; 2 uses
  %i.wl = add nuw nsw i32 %.0197800, 1            ; 2 uses
  %exitcond849.not = icmp eq i32 %i.wl, %i.af
  br i1 %exitcond849.not, label %._crit_edge, label %bb.c, !llvm.loop !497
...
!25 = !{!"_ZTSNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE", !24, i64 0, !15, i64 8, !7, i64 16}
...
!30 = !{!"p1 _ZTSN4ncnn3MatE", !13, i64 0}
!31 = !{!"_ZTSNSt12_Vector_baseIN4ncnn3MatESaIS1_EE17_Vector_impl_dataE", !30, i64 0, !30, i64 8, !30, i64 16}
!32 = !{!"_ZTSNSt12_Vector_baseIN4ncnn3MatESaIS1_EE12_Vector_implE", !31, i64 0}
!33 = !{!"_ZTSSt12_Vector_baseIN4ncnn3MatESaIS1_EE", !32, i64 0}
!34 = !{!"_ZTSSt6vectorIN4ncnn3MatESaIS1_EE", !33, i64 0}
!35 = !{!"_ZTSN4ncnn5LayerE", !22, i64 8, !22, i64 9, !22, i64 10, !22, i64 11, !22, i64 12, !22, i64 13, !22, i64 14, !22, i64 15, !22, i64 16, !22, i64 17, !22, i64 18, !22, i64 19, !22, i64 20, !22, i64 21, !22, i64 22, !22, i64 23, !22, i64 24, !22, i64 25, !22, i64 26, !22, i64 27, !8, i64 28, !13, i64 32, !8, i64 40, !25, i64 48, !25, i64 80, !29, i64 112, !29, i64 136, !34, i64 160, !34, i64 184}
!36 = !{!"_ZTSN4ncnn13DeconvolutionE", !35, i64 0, !8, i64 208, !8, i64 212, !8, i64 216, !8, i64 220, !8, i64 224, !8, i64 228, !8, i64 232, !8, i64 236, !8, i64 240, !8, i64 244, !8, i64 248, !8, i64 252, !8, i64 256, !8, i64 260, !8, i64 264, !8, i64 268, !8, i64 272, !8, i64 276, !17, i64 280, !8, i64 352, !17, i64 360, !17, i64 432}
!37 = !{!36, !8, i64 276}
!38 = !{!"float", !7, i64 0}
!39 = !{!38, !38, i64 0}
!40 = !{!"p1 _ZTSN4ncnn5LayerE", !13, i64 0}
!41 = !{!"_ZTSN4ncnn17Deconvolution_x86E", !36, i64 0, !40, i64 504, !40, i64 512, !17, i64 520}
!42 = !{!41, !40, i64 504}
!43 = !{!"_ZTSN4ncnn6OptionE", !22, i64 0, !22, i64 1, !22, i64 2, !22, i64 3, !8, i64 4, !16, i64 8, !16, i64 16, !8, i64 24, !22, i64 28, !22, i64 29, !22, i64 30, !22, i64 31, !22, i64 32, !22, i64 33, !22, i64 34, !22, i64 35, !22, i64 36, !22, i64 37, !22, i64 38, !22, i64 39, !8, i64 40, !22, i64 44, !22, i64 45, !22, i64 46, !22, i64 47, !7, i64 48, !22, i64 49, !22, i64 50, !22, i64 51, !22, i64 52, !22, i64 53, !22, i64 54, !22, i64 55, !22, i64 56, !22, i64 57, !22, i64 58, !22, i64 59, !22, i64 60, !22, i64 61, !22, i64 62, !22, i64 63}
!44 = !{!43, !22, i64 32}
!45 = !{i8 0, i8 2}
!46 = !{}
!47 = !{!36, !8, i64 212}
...
!90 = !{!89}
!91 = !{ptr @_ZN4ncnn17Deconvolution_x86D2Ev}
!92 = distinct !{null}
!93 = distinct !{!93, !56}
!94 = distinct !{!94, !57}
!95 = distinct !{!95, !56}
...
!99 = distinct !{!99, !98}
!100 = distinct !{!100, !98}
!101 = distinct !{!101, !56, !62, !63}
!102 = distinct !{!102, !57}
!103 = distinct !{!103, !56}
!104 = distinct !{!104, !56, !62}
!105 = distinct !{!105, !"_ZN4ncnn3Mat7channelEi"}
!106 = distinct !{!106, !105, !"_ZN4ncnn3Mat7channelEi: argument 0"}
!107 = distinct !{!107, !"_ZN4ncnn3Mat7channelEi"}
!108 = distinct !{!108, !107, !"_ZN4ncnn3Mat7channelEi: argument 0"}
!109 = distinct !{!109, !56}
!110 = distinct !{!110, !56}
...
!130 = distinct !{!130, !56, !62, !63}
!131 = distinct !{!131, !56, !62}
!132 = distinct !{!132, !56}
!133 = distinct !{!133, !56}
!134 = distinct !{!134, !"_ZN4ncnn3Mat7channelEi"}
!135 = distinct !{!135, !134, !"_ZN4ncnn3Mat7channelEi: argument 0"}
...
!146 = distinct !{!146, !56, !62, !63}
!147 = distinct !{!147, !56, !62}
!148 = distinct !{!148, !56}
