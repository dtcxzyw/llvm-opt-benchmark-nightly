...
.lr.ph249.prol.loopexit:                          ; preds = %.lr.ph249.prol, %.lr.ph249.preheader
  %.168248.unr = phi ptr [ %.168248.ph, %.lr.ph249.preheader ], [ %i.dc, %.lr.ph249.prol ]
  %.170247.unr = phi ptr [ %.170247.ph, %.lr.ph249.preheader ], [ %i.dd, %.lr.ph249.prol ]
  %.172246.unr = phi i32 [ %.172246.ph, %.lr.ph249.preheader ], [ %i.de, %.lr.ph249.prol ]
  %i.df = sub i32 %.172246.ph, %.lcssa
  %i.dg = icmp ugt i32 %i.df, -4
  br i1 %i.dg, label %.loopexit, label %.lr.ph249

.lr.ph:                                           ; preds = %.noexc79, %.lr.ph
  %.067242 = phi ptr [ %i.dk, %.lr.ph ], [ %i.bg, %.noexc79 ] ; 2 uses
  %.069241 = phi ptr [ %i.dl, %.lr.ph ], [ %i.bm, %.noexc79 ] ; 3 uses
  %.071240 = phi i32 [ %i.dm, %.lr.ph ], [ 0, %.noexc79 ]
  %i.dh = load <8 x float>, ptr %.067242, align 1, !tbaa !54
  %i.di = load <8 x float>, ptr %.069241, align 1, !tbaa !54
  %i.dj = fadd fast <8 x float> %i.di, %i.dh
  store <8 x float> %i.dj, ptr %.069241, align 1, !tbaa !54
  %i.dk = getelementptr inbounds nuw i8, ptr %.067242, i64 32 ; 2 uses
  %i.dl = getelementptr inbounds nuw i8, ptr %.069241, i64 32 ; 2 uses
  %i.dm = add nuw nsw i32 %.071240, 8             ; 3 uses
...
.lr.ph249:                                        ; preds = %.lr.ph249.prol.loopexit, %.lr.ph249
  %.168248 = phi ptr [ %i.ei, %.lr.ph249 ], [ %.168248.unr, %.lr.ph249.prol.loopexit ] ; 5 uses
  %.170247 = phi ptr [ %i.ej, %.lr.ph249 ], [ %.170247.unr, %.lr.ph249.prol.loopexit ] ; 6 uses
  %.172246 = phi i32 [ %i.ek, %.lr.ph249 ], [ %.172246.unr, %.lr.ph249.prol.loopexit ]
  %i.dq = load float, ptr %.168248, align 4, !tbaa !46
  %i.dr = load float, ptr %.170247, align 4, !tbaa !46
  %i.ds = fadd fast float %i.dr, %i.dq
  store float %i.ds, ptr %.170247, align 4, !tbaa !46
  %i.dt = getelementptr inbounds nuw i8, ptr %.168248, i64 4
  %i.du = getelementptr inbounds nuw i8, ptr %.170247, i64 4 ; 2 uses
  ...
  %i.dy = getelementptr inbounds nuw i8, ptr %.168248, i64 8
  %i.dz = getelementptr inbounds nuw i8, ptr %.170247, i64 8 ; 2 uses
  ...
  %i.ed = getelementptr inbounds nuw i8, ptr %.168248, i64 12
  %i.ee = getelementptr inbounds nuw i8, ptr %.170247, i64 12 ; 2 uses
  ...
  %i.ei = getelementptr inbounds nuw i8, ptr %.168248, i64 16
  %i.ej = getelementptr inbounds nuw i8, ptr %.170247, i64 16
  %i.ek = add nuw nsw i32 %.172246, 4             ; 2 uses
...
vector.memcheck:                                  ; preds = %.lr.ph264.preheader
  ...
  %bound0312 = icmp ult ptr %.065.lcssa, %scevgep308
  %bound1313 = icmp ult ptr %.063.lcssa, %scevgep304
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %i.ez = add i32 %.062.lcssa, %i.ey
  %i.fa = shl nuw nsw i64 %n.vec, 2               ; 2 uses
  %i.fb = getelementptr i8, ptr %.063.lcssa, i64 %i.fa
  %i.fc = getelementptr i8, ptr %.065.lcssa, i64 %i.fa
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep = getelementptr i8, ptr %.063.lcssa, i64 %i.fi
  %next.gep316 = getelementptr i8, ptr %.065.lcssa, i64 %i.fi ; 2 uses
...
.lr.ph264.preheader366:                           ; preds = %vector.memcheck, %.lr.ph264.preheader, %middle.block
  %.1263.ph = phi i32 [ %.062.lcssa, %vector.memcheck ], [ %.062.lcssa, %.lr.ph264.preheader ], [ %i.ez, %middle.block ] ; 4 uses
  %.164262.ph = phi ptr [ %.063.lcssa, %vector.memcheck ], [ %.063.lcssa, %.lr.ph264.preheader ], [ %i.fb, %middle.block ] ; 3 uses
  %.166261.ph = phi ptr [ %.065.lcssa, %vector.memcheck ], [ %.065.lcssa, %.lr.ph264.preheader ], [ %i.fc, %middle.block ] ; 4 uses
...
.lr.ph264.prol:                                   ; preds = %.lr.ph264.preheader366
  %i.fp = load float, ptr %.166261.ph, align 4, !tbaa !46
  %i.fq = load float, ptr %i.s, align 8, !tbaa !88
  %i.fr = load float, ptr %8, align 4, !tbaa !46
  %i.fs = load float, ptr %.164262.ph, align 4, !tbaa !46
  ...
  store float %i.fy, ptr %.166261.ph, align 4, !tbaa !46
  %i.fz = getelementptr inbounds nuw i8, ptr %.164262.ph, i64 4
  %i.ga = getelementptr inbounds nuw i8, ptr %.166261.ph, i64 4
...
.lr.ph264.prol.loopexit:                          ; preds = %.lr.ph264.prol, %.lr.ph264.preheader366
  ...
  %.164262.unr = phi ptr [ %.164262.ph, %.lr.ph264.preheader366 ], [ %i.fz, %.lr.ph264.prol ]
  %.166261.unr = phi ptr [ %.166261.ph, %.lr.ph264.preheader366 ], [ %i.ga, %.lr.ph264.prol ]
  %i.gc = icmp eq i32 %.lcssa239, %.neg378
  br i1 %i.gc, label %._crit_edge, label %.lr.ph264

.lr.ph256:                                        ; preds = %.noexc75, %.lr.ph256
  %.062255 = phi i32 [ %i.ix, %.lr.ph256 ], [ 0, %.noexc75 ]
  %.063254 = phi ptr [ %i.iv, %.lr.ph256 ], [ %i.al, %.noexc75 ] ; 2 uses
  %.065253 = phi ptr [ %i.iw, %.lr.ph256 ], [ %i.af, %.noexc75 ] ; 3 uses
  %i.gd = load <8 x float>, ptr %.065253, align 1, !tbaa !54
  %i.ge = load <8 x float>, ptr %.063254, align 1, !tbaa !54
  ...
  %i.gw = fmul fast <8 x float> %i.gv, %i.gv
  ...
  %i.hn = fmul fast <8 x float> %i.hm, %i.gv
  %reass.mul.a = fmul fast <8 x float> %i.gu, splat (float f0x3F317218)
  %reass.add236 = fadd fast <8 x float> %i.hn, splat (float -5.000000e-01)
  %reass.mul237 = fmul fast <8 x float> %i.gw, %reass.add236
  %i.ho = fadd fast <8 x float> %reass.mul.a, %i.gv
  ...
  %i.in = fadd fast <8 x float> %i.ia, splat (float 1.000000e+00)
  %i.io = fadd fast <8 x float> %i.in, %i.im
  ...
  store <8 x float> %i.iu, ptr %.065253, align 1, !tbaa !54
  %i.iv = getelementptr inbounds nuw i8, ptr %.063254, i64 32 ; 2 uses
  %i.iw = getelementptr inbounds nuw i8, ptr %.065253, i64 32 ; 2 uses
  %i.ix = add nuw nsw i32 %.062255, 8             ; 3 uses
...
.lr.ph264:                                        ; preds = %.lr.ph264.prol.loopexit, %.lr.ph264
  ...
  %.164262 = phi ptr [ %i.jx, %.lr.ph264 ], [ %.164262.unr, %.lr.ph264.prol.loopexit ] ; 3 uses
  %.166261 = phi ptr [ %i.jy, %.lr.ph264 ], [ %.166261.unr, %.lr.ph264.prol.loopexit ] ; 4 uses
  %i.jb = load float, ptr %.166261, align 4, !tbaa !46
  %i.jc = load float, ptr %i.s, align 8, !tbaa !88
  %i.jd = load float, ptr %8, align 4, !tbaa !46
  %i.je = load float, ptr %.164262, align 4, !tbaa !46
  ...
  store float %i.jk, ptr %.166261, align 4, !tbaa !46
  %i.jl = getelementptr inbounds nuw i8, ptr %.164262, i64 4
  %i.jm = getelementptr inbounds nuw i8, ptr %.166261, i64 4 ; 2 uses
  ...
  %i.jx = getelementptr inbounds nuw i8, ptr %.164262, i64 8
  %i.jy = getelementptr inbounds nuw i8, ptr %.166261, i64 8
...
.preheader.us.us:                                 ; preds = %._crit_edge77.split.us.us.us, %.noexc45.us
  ...
  %.04180.us.us = phi ptr [ %i.cx, %._crit_edge77.split.us.us.us ], [ %i.bb, %.noexc45.us ] ; 2 uses
