...
.loopexit.i.us:                                   ; preds = %.lr.ph184.i.us.prol.loopexit, %.lr.ph184.i.us, %.preheader.i.us
  ...
  %indvars.iv.next239.i.us = add nuw nsw i64 %indvars.iv238.i.us, 1 ; 2 uses
...
.lr.ph32.split.us.preheader:                      ; preds = %.lr.ph32
  ...
  %min.iters.check191 = icmp ult i32 %4, 6
  %n.vec193 = and i64 %i.aa, 2147483644           ; 4 uses
  %i.ab = shl nuw nsw i64 %n.vec193, 3            ; 2 uses
  %i.ac = trunc nuw nsw i64 %n.vec193 to i32
  %cmp.n202 = icmp eq i64 %n.vec193, %i.aa
  br label %.lr.ph32.split.us

.lr.ph32.split.us:                                ; preds = %.lr.ph32.split.us.preheader, %.loopexit.us
  %indvar187 = phi i64 [ 0, %.lr.ph32.split.us.preheader ], [ %indvar.next188, %.loopexit.us ] ; 2 uses
  ...
  %.010731.us186 = ptrtoaddr ptr %.010731.us to i64
  %i.ad = mul i64 %i.z, %indvar187
...
.lr.ph.us.preheader:                              ; preds = %.lr.ph32.split.us
  br i1 %min.iters.check191, label %.lr.ph.us.preheader294, label %vector.memcheck185

vector.memcheck185:                               ; preds = %.lr.ph.us.preheader
  %i.al = add i64 %i.ae, %.010731.us186
  %i.am = sub i64 %i.ag, %i.al
  %diff.check189 = icmp ugt i64 %i.am, -32
  br i1 %diff.check189, label %.lr.ph.us.preheader294, label %vector.ph192

vector.ph192:                                     ; preds = %vector.memcheck185
...
vector.body194:                                   ; preds = %vector.body194, %vector.ph192
  ...
  %i.ap = shl i64 %index195, 3                    ; 2 uses
  %next.gep196 = getelementptr i8, ptr %.010731.us, i64 %i.ap ; 2 uses
  %next.gep197 = getelementptr i8, ptr %i.ak, i64 %i.ap ; 2 uses
  %i.aq = getelementptr i8, ptr %next.gep197, i64 16
  %wide.load198 = load <2 x i64>, ptr %next.gep197, align 1, !tbaa !113
  %wide.load199 = load <2 x i64>, ptr %i.aq, align 1, !tbaa !113
  %i.ar = getelementptr i8, ptr %next.gep196, i64 16
  store <2 x i64> %wide.load198, ptr %next.gep196, align 1, !tbaa !113
  store <2 x i64> %wide.load199, ptr %i.ar, align 1, !tbaa !113
  %index.next200 = add nuw i64 %index195, 4       ; 2 uses
  %i.as = icmp eq i64 %index.next200, %n.vec193
  br i1 %i.as, label %middle.block201, label %vector.body194, !llvm.loop !827

middle.block201:                                  ; preds = %vector.body194
  br i1 %cmp.n202, label %.loopexit4.us, label %.lr.ph.us.preheader294

.lr.ph.us.preheader294:                           ; preds = %vector.memcheck185, %.lr.ph.us.preheader, %middle.block201
  %.17.us.ph = phi ptr [ %.010731.us, %vector.memcheck185 ], [ %.010731.us, %.lr.ph.us.preheader ], [ %i.an, %middle.block201 ] ; 2 uses
  %.01116.us.ph = phi ptr [ %i.ak, %vector.memcheck185 ], [ %i.ak, %.lr.ph.us.preheader ], [ %i.ao, %middle.block201 ] ; 2 uses
  %.01155.us.ph = phi i32 [ 0, %vector.memcheck185 ], [ 0, %.lr.ph.us.preheader ], [ %i.ac, %middle.block201 ] ; 4 uses
  %i.at = sub i32 %4, %.01155.us.ph
  %xtraiter304 = and i32 %i.at, 7                 ; 2 uses
  %lcmp.mod305.not = icmp eq i32 %xtraiter304, 0
  br i1 %lcmp.mod305.not, label %.lr.ph.us.prol.loopexit, label %.lr.ph.us.prol

.lr.ph.us.prol:                                   ; preds = %.lr.ph.us.preheader294, %.lr.ph.us.prol
  %.17.us.prol = phi ptr [ %i.av, %.lr.ph.us.prol ], [ %.17.us.ph, %.lr.ph.us.preheader294 ] ; 2 uses
  %.01116.us.prol = phi ptr [ %i.aw, %.lr.ph.us.prol ], [ %.01116.us.ph, %.lr.ph.us.preheader294 ] ; 2 uses
  %.01155.us.prol = phi i32 [ %i.ax, %.lr.ph.us.prol ], [ %.01155.us.ph, %.lr.ph.us.preheader294 ]
  %prol.iter306 = phi i32 [ %prol.iter306.next, %.lr.ph.us.prol ], [ 0, %.lr.ph.us.preheader294 ]
  ...
  br i1 %prol.iter306.cmp.not, label %.lr.ph.us.prol.loopexit, label %.lr.ph.us.prol, !llvm.loop !828

.lr.ph.us.prol.loopexit:                          ; preds = %.lr.ph.us.prol, %.lr.ph.us.preheader294
  %.lcssa296.unr = phi ptr [ poison, %.lr.ph.us.preheader294 ], [ %i.av, %.lr.ph.us.prol ]
  %.lcssa295.unr = phi ptr [ poison, %.lr.ph.us.preheader294 ], [ %i.aw, %.lr.ph.us.prol ]
  %.17.us.unr = phi ptr [ %.17.us.ph, %.lr.ph.us.preheader294 ], [ %i.av, %.lr.ph.us.prol ]
  %.01116.us.unr = phi ptr [ %.01116.us.ph, %.lr.ph.us.preheader294 ], [ %i.aw, %.lr.ph.us.prol ]
  %.01155.us.unr = phi i32 [ %.01155.us.ph, %.lr.ph.us.preheader294 ], [ %i.ax, %.lr.ph.us.prol ]
...
.loopexit4.us:                                    ; preds = %.lr.ph.us.prol.loopexit, %.lr.ph.us, %middle.block201, %.lr.ph32.split.us
  %.1112.us = phi ptr [ %i.ak, %.lr.ph32.split.us ], [ %i.ao, %middle.block201 ], [ %.lcssa295.unr, %.lr.ph.us.prol.loopexit ], [ %i.bx, %.lr.ph.us ] ; 5 uses
  %.2.us = phi ptr [ %.010731.us, %.lr.ph32.split.us ], [ %i.an, %middle.block201 ], [ %.lcssa296.unr, %.lr.ph.us.prol.loopexit ], [ %i.bw, %.lr.ph.us ] ; 2 uses
...
._crit_edge.us:                                   ; preds = %scalar.ph221.prol.loopexit, %scalar.ph221, %middle.block238
  %.lcssa125 = phi ptr [ %i.kf, %middle.block238 ], [ %.lcssa292.unr, %scalar.ph221.prol.loopexit ], [ %i.lr, %scalar.ph221 ] ; 2 uses
...
.preheader:                                       ; preds = %.lr.ph60.split.preheader, %.preheader.loopexit, %.preheader1
  ...
  %.6.lcssa = phi ptr [ %.0107.lcssa, %.preheader1 ], [ %.lcssa125, %.preheader.loopexit ], [ %.0107.lcssa, %.lr.ph60.split.preheader ]
...
.lr.ph.preheader:                                 ; preds = %.lr.ph72
  ...
  %.neg = mul i64 %i.mg, -2
  %.neg282 = sub i64 %.neg, %i.mb
  %i.mh = mul i64 %i.i, -2
  %i.mi = zext nneg i32 %4 to i64                 ; 5 uses
  %min.iters.check250 = icmp ult i32 %4, 4
  %min.iters.check251 = icmp ult i32 %4, 16
  %i.mj = and i64 %i.mi, 12
  %n.vec253 = and i64 %i.mi, 2147483632           ; 5 uses
  %i.mk = trunc nuw nsw i64 %n.vec253 to i32
  %i.ml = shl nuw nsw i64 %n.vec253, 1            ; 2 uses
  %cmp.n262 = icmp eq i64 %n.vec253, %i.mi
  %min.epilog.iters.check = icmp eq i64 %i.mj, 0
  %n.vec266 = and i64 %i.mi, 2147483644           ; 4 uses
  %i.mm = trunc nuw nsw i64 %n.vec266 to i32
  %i.mn = shl nuw nsw i64 %n.vec266, 1            ; 2 uses
  %cmp.n272 = icmp eq i64 %n.vec266, %i.mi
  br label %iter.check

iter.check:                                       ; preds = %.lr.ph.preheader, %._crit_edge
  %indvar246 = phi i64 [ 0, %.lr.ph.preheader ], [ %indvar.next247, %._crit_edge ] ; 2 uses
  %indvars.iv108 = phi i64 [ %i.mc, %.lr.ph.preheader ], [ %indvars.iv.next109, %._crit_edge ] ; 2 uses
  %.871 = phi ptr [ %.6.lcssa, %.lr.ph.preheader ], [ %.lcssa, %._crit_edge ] ; 7 uses
  %i.mo = add nsw i64 %indvars.iv108, %i.md
  %i.mp = mul i64 %i.i, %i.mo
  %gep = getelementptr [2 x i8], ptr %invariant.gep74, i64 %i.mp ; 6 uses
  br i1 %min.iters.check250, label %vec.epilog.scalar.ph.preheader, label %vector.memcheck244

vector.memcheck244:                               ; preds = %iter.check
  %i.mq = mul i64 %i.mh, %indvar246
  %i.mr = add i64 %.neg282, %i.mq
  %.871245 = ptrtoaddr ptr %.871 to i64
  %i.ms = add i64 %i.mr, %.871245
  %i.mt = add i64 %i.ms, -1
  %diff.check248 = icmp ult i64 %i.mt, 31
  br i1 %diff.check248, label %vec.epilog.scalar.ph.preheader, label %vector.main.loop.iter.check

vector.main.loop.iter.check:                      ; preds = %vector.memcheck244
  br i1 %min.iters.check251, label %vec.epilog.ph, label %vector.ph252

vector.ph252:                                     ; preds = %vector.main.loop.iter.check
...
vector.body254:                                   ; preds = %vector.body254, %vector.ph252
  ...
  %i.mw = shl i64 %index255, 1                    ; 2 uses
  %next.gep256 = getelementptr i8, ptr %gep, i64 %i.mw ; 2 uses
  %next.gep257 = getelementptr i8, ptr %.871, i64 %i.mw ; 2 uses
  %i.mx = getelementptr i8, ptr %next.gep256, i64 16
  %wide.load258 = load <8 x i16>, ptr %next.gep256, align 2, !tbaa !526
  %wide.load259 = load <8 x i16>, ptr %i.mx, align 2, !tbaa !526
  %i.my = getelementptr i8, ptr %next.gep257, i64 16
  store <8 x i16> %wide.load258, ptr %next.gep257, align 2, !tbaa !526
  store <8 x i16> %wide.load259, ptr %i.my, align 2, !tbaa !526
  %index.next260 = add nuw i64 %index255, 16      ; 2 uses
  %i.mz = icmp eq i64 %index.next260, %n.vec253
  br i1 %i.mz, label %middle.block261, label %vector.body254, !llvm.loop !861

middle.block261:                                  ; preds = %vector.body254
  br i1 %cmp.n262, label %._crit_edge, label %vec.epilog.iter.check

vec.epilog.iter.check:                            ; preds = %middle.block261
  br i1 %min.epilog.iters.check, label %vec.epilog.scalar.ph.preheader, label %vec.epilog.ph, !prof !445

vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  %vec.epilog.resume.val = phi i64 [ %n.vec253, %vec.epilog.iter.check ], [ 0, %vector.main.loop.iter.check ]
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.nc = shl i64 %index267, 1                    ; 2 uses
  %next.gep268 = getelementptr i8, ptr %gep, i64 %i.nc
  %next.gep269 = getelementptr i8, ptr %.871, i64 %i.nc
  %wide.load270 = load <4 x i16>, ptr %next.gep268, align 2, !tbaa !526
  store <4 x i16> %wide.load270, ptr %next.gep269, align 2, !tbaa !526
  %index.next271 = add nuw i64 %index267, 4       ; 2 uses
  %i.nd = icmp eq i64 %index.next271, %n.vec266
  br i1 %i.nd, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !862

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  br i1 %cmp.n272, label %._crit_edge, label %vec.epilog.scalar.ph.preheader

vec.epilog.scalar.ph.preheader:                   ; preds = %vector.memcheck244, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %.069.ph = phi i32 [ 0, %iter.check ], [ 0, %vector.memcheck244 ], [ %i.mk, %vec.epilog.iter.check ], [ %i.mm, %vec.epilog.middle.block ] ; 4 uses
  %.010368.ph = phi ptr [ %gep, %iter.check ], [ %gep, %vector.memcheck244 ], [ %i.mu, %vec.epilog.iter.check ], [ %i.na, %vec.epilog.middle.block ] ; 2 uses
  %.967.ph = phi ptr [ %.871, %iter.check ], [ %.871, %vector.memcheck244 ], [ %i.mv, %vec.epilog.iter.check ], [ %i.nb, %vec.epilog.middle.block ] ; 2 uses
  %i.ne = sub i32 %4, %.069.ph
  %xtraiter313 = and i32 %i.ne, 7                 ; 2 uses
  %lcmp.mod314.not = icmp eq i32 %xtraiter313, 0
  br i1 %lcmp.mod314.not, label %vec.epilog.scalar.ph.prol.loopexit, label %vec.epilog.scalar.ph.prol
...
vec.epilog.scalar.ph.prol:                        ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph.prol
  ...
  %prol.iter315 = phi i32 [ %prol.iter315.next, %vec.epilog.scalar.ph.prol ], [ 0, %vec.epilog.scalar.ph.preheader ]
  ...
  %prol.iter315.next = add i32 %prol.iter315, 1   ; 2 uses
  %prol.iter315.cmp.not = icmp eq i32 %prol.iter315.next, %xtraiter313
  br i1 %prol.iter315.cmp.not, label %vec.epilog.scalar.ph.prol.loopexit, label %vec.epilog.scalar.ph.prol, !llvm.loop !863

vec.epilog.scalar.ph.prol.loopexit:               ; preds = %vec.epilog.scalar.ph.prol, %vec.epilog.scalar.ph.preheader
  %.lcssa291.unr = phi ptr [ poison, %vec.epilog.scalar.ph.preheader ], [ %i.ng, %vec.epilog.scalar.ph.prol ]
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph
  ...
  %exitcond107.not.7 = icmp eq i32 %i.oj, %4
  br i1 %exitcond107.not.7, label %._crit_edge, label %vec.epilog.scalar.ph, !llvm.loop !864

._crit_edge:                                      ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph, %vec.epilog.middle.block, %middle.block261
  %.lcssa = phi ptr [ %i.nb, %vec.epilog.middle.block ], [ %i.mv, %middle.block261 ], [ %.lcssa291.unr, %vec.epilog.scalar.ph.prol.loopexit ], [ %i.oh, %vec.epilog.scalar.ph ]
  ...
  br i1 %exitcond111.not, label %._crit_edge73.split, label %iter.check, !llvm.loop !865
...
.lr.ph20.split.us.preheader:                      ; preds = %.lr.ph20
  ...
  %i.t = add i32 %4, -1
  %xtraiter291 = and i32 %4, 3                    ; 3 uses
  %i.u = icmp ult i32 %i.t, 3
  %unroll_iter297 = and i32 %4, 2147483644
  %lcmp.mod293.not = icmp eq i32 %xtraiter291, 0
  %lcmp.mod296 = icmp ne i32 %xtraiter291, 0
...
.lr.ph.us:                                        ; preds = %.lr.ph.us.preheader, %.lr.ph.us
  ...
  %niter298 = phi i32 [ %niter298.next.3, %.lr.ph.us ], [ 0, %.lr.ph.us.preheader ]
...
.loopexit:                                        ; preds = %.lr.ph.prol.loopexit, %.lr.ph, %.lr.ph52.prol.loopexit, %.lr.ph52, %middle.block195, %middle.block, %.loopexit3
  %.9 = phi ptr [ %.554, %.loopexit3 ], [ %i.nr, %.lr.ph52 ], [ %i.md, %middle.block ], [ %i.jw, %middle.block195 ], [ %.lcssa284.unr, %.lr.ph52.prol.loopexit ], [ %.lcssa283.unr, %.lr.ph.prol.loopexit ], [ %i.le, %.lr.ph ] ; 2 uses
...
.preheader:                                       ; preds = %.lr.ph67.split.preheader, %.preheader.loopexit, %.preheader1
  %.10.lcssa = phi ptr [ %.5.lcssa, %.preheader1 ], [ %.lcssa148, %.preheader.loopexit ], [ %.5.lcssa, %.lr.ph67.split.preheader ]
...
.lr.ph75.preheader:                               ; preds = %.lr.ph79
  ...
  %.neg = mul i64 %i.oi, -2
  %.neg273 = sub i64 %.neg, %i.od
  %i.oj = mul i64 %i.k, -2
  %i.ok = zext nneg i32 %4 to i64                 ; 5 uses
  %min.iters.check244 = icmp ult i32 %4, 4
  %min.iters.check245 = icmp ult i32 %4, 16
  %i.ol = and i64 %i.ok, 12
  %n.vec247 = and i64 %i.ok, 2147483632           ; 5 uses
  %i.om = trunc nuw nsw i64 %n.vec247 to i32
  %i.on = shl nuw nsw i64 %n.vec247, 1            ; 2 uses
  %cmp.n256 = icmp eq i64 %n.vec247, %i.ok
  %min.epilog.iters.check = icmp eq i64 %i.ol, 0
  %n.vec260 = and i64 %i.ok, 2147483644           ; 4 uses
  %i.oo = trunc nuw nsw i64 %n.vec260 to i32
  %i.op = shl nuw nsw i64 %n.vec260, 1            ; 2 uses
  %cmp.n266 = icmp eq i64 %n.vec260, %i.ok
  br label %iter.check

iter.check:                                       ; preds = %.lr.ph75.preheader, %._crit_edge
  %indvar240 = phi i64 [ 0, %.lr.ph75.preheader ], [ %indvar.next241, %._crit_edge ] ; 2 uses
  %indvars.iv118 = phi i64 [ %i.oe, %.lr.ph75.preheader ], [ %indvars.iv.next119, %._crit_edge ] ; 2 uses
  %.1277 = phi ptr [ %.10.lcssa, %.lr.ph75.preheader ], [ %.lcssa, %._crit_edge ] ; 7 uses
  %i.oq = add nsw i64 %indvars.iv118, %i.of
  %i.or = mul i64 %i.k, %i.oq
  %gep = getelementptr [2 x i8], ptr %invariant.gep81, i64 %i.or ; 6 uses
  br i1 %min.iters.check244, label %vec.epilog.scalar.ph.preheader, label %vector.memcheck238

vector.memcheck238:                               ; preds = %iter.check
  %i.os = mul i64 %i.oj, %indvar240
  %i.ot = add i64 %.neg273, %i.os
  %.1277239 = ptrtoaddr ptr %.1277 to i64
  %i.ou = add i64 %i.ot, %.1277239
  %i.ov = add i64 %i.ou, -1
  %diff.check242 = icmp ult i64 %i.ov, 31
  br i1 %diff.check242, label %vec.epilog.scalar.ph.preheader, label %vector.main.loop.iter.check

vector.main.loop.iter.check:                      ; preds = %vector.memcheck238
  br i1 %min.iters.check245, label %vec.epilog.ph, label %vector.ph246

vector.ph246:                                     ; preds = %vector.main.loop.iter.check
...
vector.body248:                                   ; preds = %vector.body248, %vector.ph246
  ...
  %i.oy = shl i64 %index249, 1                    ; 2 uses
  %next.gep250 = getelementptr i8, ptr %gep, i64 %i.oy ; 2 uses
  %next.gep251 = getelementptr i8, ptr %.1277, i64 %i.oy ; 2 uses
  %i.oz = getelementptr i8, ptr %next.gep250, i64 16
  %wide.load252 = load <8 x i16>, ptr %next.gep250, align 2, !tbaa !526
  %wide.load253 = load <8 x i16>, ptr %i.oz, align 2, !tbaa !526
  %i.pa = getelementptr i8, ptr %next.gep251, i64 16
  store <8 x i16> %wide.load252, ptr %next.gep251, align 2, !tbaa !526
  store <8 x i16> %wide.load253, ptr %i.pa, align 2, !tbaa !526
  %index.next254 = add nuw i64 %index249, 16      ; 2 uses
  %i.pb = icmp eq i64 %index.next254, %n.vec247
  br i1 %i.pb, label %middle.block255, label %vector.body248, !llvm.loop !904

middle.block255:                                  ; preds = %vector.body248
  br i1 %cmp.n256, label %._crit_edge, label %vec.epilog.iter.check

vec.epilog.iter.check:                            ; preds = %middle.block255
  br i1 %min.epilog.iters.check, label %vec.epilog.scalar.ph.preheader, label %vec.epilog.ph, !prof !445
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index261 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next265, %vec.epilog.vector.body ] ; 2 uses
  %i.pe = shl i64 %index261, 1                    ; 2 uses
  %next.gep262 = getelementptr i8, ptr %gep, i64 %i.pe
  %next.gep263 = getelementptr i8, ptr %.1277, i64 %i.pe
  %wide.load264 = load <4 x i16>, ptr %next.gep262, align 2, !tbaa !526
  store <4 x i16> %wide.load264, ptr %next.gep263, align 2, !tbaa !526
  %index.next265 = add nuw i64 %index261, 4       ; 2 uses
  %i.pf = icmp eq i64 %index.next265, %n.vec260
  br i1 %i.pf, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !905

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  br i1 %cmp.n266, label %._crit_edge, label %vec.epilog.scalar.ph.preheader

vec.epilog.scalar.ph.preheader:                   ; preds = %vector.memcheck238, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %.074.ph = phi i32 [ 0, %iter.check ], [ 0, %vector.memcheck238 ], [ %i.om, %vec.epilog.iter.check ], [ %i.oo, %vec.epilog.middle.block ] ; 4 uses
  %.013073.ph = phi ptr [ %gep, %iter.check ], [ %gep, %vector.memcheck238 ], [ %i.ow, %vec.epilog.iter.check ], [ %i.pc, %vec.epilog.middle.block ] ; 2 uses
  %.1372.ph = phi ptr [ %.1277, %iter.check ], [ %.1277, %vector.memcheck238 ], [ %i.ox, %vec.epilog.iter.check ], [ %i.pd, %vec.epilog.middle.block ] ; 2 uses
  %i.pg = sub i32 %4, %.074.ph
  %xtraiter307 = and i32 %i.pg, 7                 ; 2 uses
  %lcmp.mod308.not = icmp eq i32 %xtraiter307, 0
  br i1 %lcmp.mod308.not, label %vec.epilog.scalar.ph.prol.loopexit, label %vec.epilog.scalar.ph.prol
...
vec.epilog.scalar.ph.prol:                        ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph.prol
  ...
  %prol.iter309 = phi i32 [ %prol.iter309.next, %vec.epilog.scalar.ph.prol ], [ 0, %vec.epilog.scalar.ph.preheader ]
  ...
  br i1 %prol.iter309.cmp.not, label %vec.epilog.scalar.ph.prol.loopexit, label %vec.epilog.scalar.ph.prol, !llvm.loop !906

vec.epilog.scalar.ph.prol.loopexit:               ; preds = %vec.epilog.scalar.ph.prol, %vec.epilog.scalar.ph.preheader
  %.lcssa278.unr = phi ptr [ poison, %vec.epilog.scalar.ph.preheader ], [ %i.pi, %vec.epilog.scalar.ph.prol ]
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph
  ...
  %exitcond117.not.7 = icmp eq i32 %i.ql, %4
  br i1 %exitcond117.not.7, label %._crit_edge, label %vec.epilog.scalar.ph, !llvm.loop !907

._crit_edge:                                      ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph, %vec.epilog.middle.block, %middle.block255
  %.lcssa = phi ptr [ %i.pd, %vec.epilog.middle.block ], [ %i.ox, %middle.block255 ], [ %.lcssa278.unr, %vec.epilog.scalar.ph.prol.loopexit ], [ %i.qj, %vec.epilog.scalar.ph ]
  ...
  br i1 %exitcond121.not, label %._crit_edge80.split, label %iter.check, !llvm.loop !908
