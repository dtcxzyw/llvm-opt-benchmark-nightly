...
.lr.ph116.us153.us.new:                           ; preds = %.lr.ph116.us153.us, %.lr.ph116.us153.us.new
  ...
  %i.or = load <4 x float>, ptr %.0586113.us149.us, align 16, !tbaa !87
  store <4 x float> %i.or, ptr %.13115.us147.us, align 16, !tbaa !87
  ...
  br i1 %niter533.ncmp.7, label %..loopexit5_crit_edge.us154.us.unr-lcssa, label %.lr.ph116.us153.us.new, !llvm.loop !194
...
bb.f:                                             ; preds = %bb.f, %.epil.preheader
  ...
  %i.pp = load <4 x float>, ptr %.0586113.us149.us.epil, align 16, !tbaa !87
  store <4 x float> %i.pp, ptr %.13115.us147.us.epil, align 16, !tbaa !87
  ...
  br i1 %epil.iter528.cmp.not, label %..loopexit5_crit_edge.us154.us, label %bb.f, !llvm.loop !206
...
..loopexit5_crit_edge.us154.us:                   ; preds = %bb.f, %..loopexit5_crit_edge.us154.us.unr-lcssa
  ...
  br i1 %i.ps, label %.lr.ph116.us153.us, label %.preheader3.loopexit200, !llvm.loop !205
...
bb.d:                                             ; preds = %bb.c, %.thread.i, %._crit_edge.i
  ...
  br i1 %i.eh, label %bb.b, label %.preheader77.loopexit.i, !llvm.loop !649
...
.lr.ph102.i:                                      ; preds = %bb.e, %.lr.ph102.i
  ...
  br i1 %i.fr, label %.lr.ph102.i, label %._crit_edge103.i, !llvm.loop !650
...
.lr.ph115.i:                                      ; preds = %.lr.ph115.i.prol.loopexit, %.lr.ph115.i
  ...
  br i1 %exitcond230.not.i.1, label %._crit_edge116.i, label %.lr.ph115.i, !llvm.loop !651
...
bb.g:                                             ; preds = %bb.f, %.thread69.i, %._crit_edge116.i
  ...
  br i1 %i.hy, label %bb.e, label %.preheader76.loopexit.i, !llvm.loop !652
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x float> splat (float +inf), ptr %next.gep, align 4, !tbaa !67, !alias.scope !672, !noalias !673
  store <4 x float> splat (float +inf), ptr %next.gep135, align 4, !tbaa !67, !alias.scope !672, !noalias !673
  store <4 x float> zeroinitializer, ptr %next.gep136, align 4, !tbaa !67, !alias.scope !673
  store <4 x float> zeroinitializer, ptr %next.gep137, align 4, !tbaa !67, !alias.scope !673
  %index.next = add nuw i64 %index, 4             ; 2 uses
...
.loopexit.us:                                     ; preds = %.lr.ph28.us.prol.loopexit, %.lr.ph28.us, %middle.block177, %.preheader2.us
  ...
  br i1 %i.fq, label %.lr.ph32.split.us, label %.preheader1.loopexit, !llvm.loop !839
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.gs, label %middle.block, label %vector.body, !llvm.loop !840
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  ...
  %i.gu = load i64, ptr %.01116.us39.us.prol, align 1, !tbaa !87
  store i64 %i.gu, ptr %.17.us38.us.prol, align 1, !tbaa !87
  ...
  br i1 %prol.iter.cmp.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol, !llvm.loop !841
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  %i.ha = load i64, ptr %.01116.us39.us, align 1, !tbaa !87
  store i64 %i.ha, ptr %.17.us38.us, align 1, !tbaa !87
  ...
  br i1 %exitcond.not.7, label %..loopexit4_crit_edge.us46.us, label %scalar.ph, !llvm.loop !842
...
..loopexit4_crit_edge.us46.us:                    ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  ...
  br i1 %i.ia, label %.preheader3.us42.us, label %.preheader1.loopexit79, !llvm.loop !839
...
.preheader1:                                      ; preds = %.preheader1.loopexit79, %.preheader3.us42.preheader, %.lr.ph32.split.split.preheader, %.preheader1.loopexit, %bb.a
  %.0108.lcssa = phi i32 [ 0, %bb.a ], [ %i.ib, %.preheader1.loopexit ], [ %i.fr, %.lr.ph32.split.split.preheader ], [ %i.gc, %.preheader3.us42.preheader ], [ %i.ic, %.preheader1.loopexit79 ] ; 6 uses
...
vector.body225:                                   ; preds = %vector.body225, %vector.ph223
  ...
  %wide.load231.a = load <4 x i16>, ptr %next.gep228.a, align 2, !tbaa !105, !alias.scope !862
  %wide.load232.a = load <4 x i16>, ptr %i.ki, align 2, !tbaa !105, !alias.scope !862
  %i.kj = getelementptr i8, ptr %next.gep227.a, i64 8
  %wide.load233.a = load <4 x i16>, ptr %next.gep227.a, align 2, !tbaa !105, !alias.scope !863
  %wide.load234 = load <4 x i16>, ptr %i.kj, align 2, !tbaa !105, !alias.scope !863
  ...
  store <8 x i16> %interleaved.vec235.a, ptr %next.gep229.a, align 2, !tbaa !105, !alias.scope !864, !noalias !865
  ...
  store <8 x i16> %interleaved.vec236, ptr %next.gep230, align 2, !tbaa !105, !alias.scope !864, !noalias !865
  %index.next237 = add nuw i64 %index226, 8       ; 2 uses
  %i.kk = icmp eq i64 %index.next237, %n.vec224
  br i1 %i.kk, label %middle.block238, label %vector.body225, !llvm.loop !847
...
scalar.ph221.prol:                                ; preds = %scalar.ph221.preheader, %scalar.ph221.prol
  ...
  br i1 %prol.iter312.cmp.not, label %scalar.ph221.prol.loopexit, label %scalar.ph221.prol, !llvm.loop !848
...
scalar.ph221:                                     ; preds = %scalar.ph221.prol.loopexit, %scalar.ph221
  ...
  br i1 %exitcond103.not.3, label %._crit_edge.us, label %scalar.ph221, !llvm.loop !849
...
._crit_edge.us:                                   ; preds = %scalar.ph221.prol.loopexit, %scalar.ph221, %middle.block238
  ...
  br i1 %i.lu, label %.lr.ph.us63, label %.preheader.loopexit, !llvm.loop !850
...
.lr.ph.us33.us.new:                               ; preds = %.lr.ph.us33.us, %.lr.ph.us33.us.new
  ...
  %i.cs = load i64, ptr %.01439.us28.us, align 1, !tbaa !87
  store i64 %i.cs, ptr %.11508.us29.us, align 1, !tbaa !87
  %i.ct = getelementptr inbounds nuw i8, ptr %.11508.us29.us, i64 8
  %i.cu = load i64, ptr %.014210.us27.us, align 1, !tbaa !87
...
bb.c:                                             ; preds = %bb.c, %.epil.preheader
  ...
  %i.dq = load i64, ptr %.01439.us28.us.epil, align 1, !tbaa !87
  store i64 %i.dq, ptr %.11508.us29.us.epil, align 1, !tbaa !87
  %i.dr = getelementptr inbounds nuw i8, ptr %.11508.us29.us.epil, i64 8
  %i.ds = load i64, ptr %.014210.us27.us.epil, align 1, !tbaa !87
...
vector.body219:                                   ; preds = %vector.body219, %vector.ph217
  ...
  %wide.load225.a = load <4 x i16>, ptr %next.gep222.a, align 2, !tbaa !105, !alias.scope !899
  %wide.load226.a = load <4 x i16>, ptr %i.hw, align 2, !tbaa !105, !alias.scope !899
  %i.hx = getelementptr i8, ptr %next.gep221.a, i64 8
  %wide.load227.a = load <4 x i16>, ptr %next.gep221.a, align 2, !tbaa !105, !alias.scope !900
  %wide.load228 = load <4 x i16>, ptr %i.hx, align 2, !tbaa !105, !alias.scope !900
  ...
  store <8 x i16> %interleaved.vec229.a, ptr %next.gep223.a, align 2, !tbaa !105, !alias.scope !901, !noalias !902
  ...
  store <8 x i16> %interleaved.vec230, ptr %next.gep224, align 2, !tbaa !105, !alias.scope !901, !noalias !902
  %index.next231 = add nuw i64 %index220, 8       ; 2 uses
  %i.hy = icmp eq i64 %index.next231, %n.vec218
  br i1 %i.hy, label %middle.block232, label %vector.body219, !llvm.loop !878
...
scalar.ph215.prol:                                ; preds = %scalar.ph215.preheader, %scalar.ph215.prol
  ...
  br i1 %prol.iter306.cmp.not, label %scalar.ph215.prol.loopexit, label %scalar.ph215.prol, !llvm.loop !879
...
scalar.ph215:                                     ; preds = %scalar.ph215.prol.loopexit, %scalar.ph215
  ...
  br i1 %exitcond113.not.3, label %._crit_edge.us, label %scalar.ph215, !llvm.loop !880
...
._crit_edge.us:                                   ; preds = %scalar.ph215.prol.loopexit, %scalar.ph215, %middle.block232
  ...
  br i1 %i.ji, label %.lr.ph63.us, label %.preheader.loopexit, !llvm.loop !881
...
.noexc84:                                         ; preds = %bb.c
  %i.af = load ptr, ptr %8, align 8, !tbaa !23, !noalias !934
  %i.ag = load i64, ptr %i.l, align 8, !tbaa !24, !noalias !934
  %i.ah = sext i32 %i.ae to i64
  %i.ai = mul i64 %i.ag, %i.ah
  %i.aj = load i64, ptr %i.m, align 8, !tbaa !62, !noalias !934
...
_ZN4ncnn3MatD2Ev.exit58:                          ; preds = %_ZN4ncnn3MatD2Ev.exit58.preheader, %_ZN4ncnn3MatD2Ev.exit58
  ...
  %i.ba = load i32, ptr %i.n, align 4, !tbaa !75, !noalias !935
  %i.bb = load ptr, ptr %11, align 8, !tbaa !23, !noalias !935
  %i.bc = load i64, ptr %i.o, align 8, !tbaa !24, !noalias !935
  %i.bd = sext i32 %i.az to i64
  %i.be = mul i64 %i.bc, %i.bd
  %i.bf = load i64, ptr %i.p, align 8, !tbaa !62, !noalias !935 ; 2 uses
  ...
  %i.bq = load i32, ptr %i.q, align 4, !tbaa !75, !noalias !936
  %i.br = load ptr, ptr %12, align 8, !tbaa !23, !noalias !936
  %i.bs = load i64, ptr %i.r, align 8, !tbaa !24, !noalias !936
  %i.bt = sext i32 %i.bp to i64
  %i.bu = mul i64 %i.bs, %i.bt
  %i.bv = load i64, ptr %i.s, align 8, !tbaa !62, !noalias !936 ; 2 uses
  ...
  br i1 %i.cf, label %_ZN4ncnn3MatD2Ev.exit58, label %_ZN4ncnn3MatD2Ev.exit, !llvm.loop !933
