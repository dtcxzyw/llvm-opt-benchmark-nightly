...
.lr.ph141.split.split.preheader:                  ; preds = %.lr.ph141.split
  ...
  %i.oa = and i32 %i.nz, -4
  %i.ob = add nuw i32 %.1553.lcssa, %i.oa
  %i.oc = add nuw i32 %i.ob, 4
  br label %.preheader3
...
.loopexit5.us151.preheader:                       ; preds = %.lr.ph141.split.split.us
  ...
  %i.og = and i32 %i.of, -4
  %i.oh = add nuw i32 %.1553.lcssa, %i.og
  %i.oi = add nuw i32 %i.oh, 4
  br label %.preheader3
...
.lr.ph1425:                                       ; preds = %.preheader913
  ...
  %i.aav = add nuw nsw i32 %i.aau, 4              ; 5 uses
...
.preheader1104.lr.ph:                             ; preds = %bb.c
  ...
  %i.l = and i32 %i.k, -2
  %i.m = add nuw nsw i32 %i.l, 2                  ; 4 uses
  %i.n = and i32 %6, -8
...
.preheader1095.lr.ph:                             ; preds = %.preheader1096
  ...
  %i.ad = and i32 %i.ac, -2
  %i.ae = add nuw nsw i32 %i.ad, 2                ; 4 uses
  %i.af = and i32 %6, -8
...
.preheader1086.lr.ph:                             ; preds = %.preheader1087
  ...
  %i.od = and i32 %i.oc, -2
  %i.oe = add nuw nsw i32 %i.od, 2                ; 3 uses
  %i.of = and i32 %6, -8
...
.loopexit.i.preheader:                            ; preds = %.lr.ph143.i
  ...
  %i.gr = and i64 %i.gq, -4
  %i.gs = add nuw i64 %i.gr, %i.gl
  %i.gt = add nuw i64 %i.gs, 4
...
.loopexit89.i.us.preheader:                       ; preds = %.lr.ph135.i.split.us
  ...
  %i.dj = and i64 %i.di, -4
  %i.dk = add nuw i64 %i.dj, %i.cz
  %i.dl = add nuw i64 %i.dk, 4
...
.loopexit85.i.us.preheader:                       ; preds = %.lr.ph165.i.split.us
  ...
  %i.jz = and i64 %i.jy, -2
  %i.ka = add nuw i64 %i.jz, %i.jq
  %i.kb = add nuw i64 %i.ka, 2
...
.lr.ph96.split.split.preheader.i:                 ; preds = %.lr.ph96.i
  ...
  %i.jb = and i32 %i.ja, -2
  %i.jc = add nuw i32 %.0234.lcssa.i, 2
  %i.jd = add nuw i32 %i.jc, %i.jb
...
.loopexit43.us106.preheader.i:                    ; preds = %.lr.ph96.split.split.us.i
  ...
  %i.jj = and i32 %i.ji, -2
  %i.jk = add nuw i32 %.0234.lcssa.i, 2
  %i.jl = add nuw i32 %i.jk, %i.jj
  br label %.preheader39.i
...
.preheader247.lr.ph:                              ; preds = %.preheader248
  ...
  %i.hn = and i32 %i.hm, -4
  %i.ho = add nuw nsw i32 %i.hn, 4                ; 4 uses
  %i.hp = and i32 %1, -8
