...
.lr.ph33:                                         ; preds = %bb.d, %.lr.ph33
  ...
  %i.dm = load <4 x float>, ptr %.056731, align 1, !tbaa !87 ; 2 uses
  %i.dn = load <4 x float>, ptr %.056930, align 1, !tbaa !87 ; 2 uses
  %i.do = load <4 x float>, ptr %.057129, align 1, !tbaa !87 ; 2 uses
  %i.dp = load <4 x float>, ptr %.057328, align 1, !tbaa !87 ; 2 uses
  %i.dq = load <4 x float>, ptr %.058727, align 1, !tbaa !87 ; 2 uses
  %i.dr = load <4 x float>, ptr %.058926, align 1, !tbaa !87 ; 2 uses
  %i.ds = load <4 x float>, ptr %.059125, align 1, !tbaa !87 ; 2 uses
  %i.dt = load <4 x float>, ptr %.059324, align 1, !tbaa !87 ; 2 uses
  %i.du = load <4 x float>, ptr %.059523, align 1, !tbaa !87 ; 2 uses
  %i.dv = load <4 x float>, ptr %.059722, align 1, !tbaa !87 ; 2 uses
  %i.dw = load <4 x float>, ptr %.059921, align 1, !tbaa !87 ; 2 uses
  %i.dx = load <4 x float>, ptr %.060120, align 1, !tbaa !87 ; 2 uses
  ...
  store <4 x float> %i.ec, ptr %.332, align 16, !tbaa !87
  %i.ew = getelementptr inbounds nuw i8, ptr %.332, i64 16
  store <4 x float> %i.ek, ptr %i.ew, align 16, !tbaa !87
  %i.ex = getelementptr inbounds nuw i8, ptr %.332, i64 32
  store <4 x float> %i.es, ptr %i.ex, align 16, !tbaa !87
  %i.ey = getelementptr inbounds nuw i8, ptr %.332, i64 48
  store <4 x float> %i.ed, ptr %i.ey, align 16, !tbaa !87
  %i.ez = getelementptr inbounds nuw i8, ptr %.332, i64 64
  store <4 x float> %i.el, ptr %i.ez, align 16, !tbaa !87
  %i.fa = getelementptr inbounds nuw i8, ptr %.332, i64 80
  store <4 x float> %i.et, ptr %i.fa, align 16, !tbaa !87
  %i.fb = getelementptr inbounds nuw i8, ptr %.332, i64 96
  store <4 x float> %i.ee, ptr %i.fb, align 16, !tbaa !87
  %i.fc = getelementptr inbounds nuw i8, ptr %.332, i64 112
  store <4 x float> %i.em, ptr %i.fc, align 16, !tbaa !87
  %i.fd = getelementptr inbounds nuw i8, ptr %.332, i64 128
  store <4 x float> %i.eu, ptr %i.fd, align 16, !tbaa !87
  %i.fe = getelementptr inbounds nuw i8, ptr %.332, i64 144
  store <4 x float> %i.ef, ptr %i.fe, align 16, !tbaa !87
  %i.ff = getelementptr inbounds nuw i8, ptr %.332, i64 160
  store <4 x float> %i.en, ptr %i.ff, align 16, !tbaa !87
  %i.fg = getelementptr inbounds nuw i8, ptr %.332, i64 176
  store <4 x float> %i.ev, ptr %i.fg, align 16, !tbaa !87
  ...
  br i1 %i.fw, label %.lr.ph33, label %.preheader11, !llvm.loop !191
...
.lr.ph62:                                         ; preds = %.preheader11, %.lr.ph62
  ...
  %i.fx = load float, ptr %.156860, align 4, !tbaa !67
  store float %i.fx, ptr %.461, align 4, !tbaa !67
  %i.fy = load float, ptr %.157059, align 4, !tbaa !67
  %i.fz = getelementptr inbounds nuw i8, ptr %.461, i64 4
  store float %i.fy, ptr %i.fz, align 4, !tbaa !67
  %i.ga = load float, ptr %.157258, align 4, !tbaa !67
  %i.gb = getelementptr inbounds nuw i8, ptr %.461, i64 8
  store float %i.ga, ptr %i.gb, align 4, !tbaa !67
  %i.gc = load float, ptr %.157457, align 4, !tbaa !67
  %i.gd = getelementptr inbounds nuw i8, ptr %.461, i64 12
  store float %i.gc, ptr %i.gd, align 4, !tbaa !67
  %i.ge = load float, ptr %.158856, align 4, !tbaa !67
  %i.gf = getelementptr inbounds nuw i8, ptr %.461, i64 16
  store float %i.ge, ptr %i.gf, align 4, !tbaa !67
  %i.gg = load float, ptr %.159055, align 4, !tbaa !67
  %i.gh = getelementptr inbounds nuw i8, ptr %.461, i64 20
  store float %i.gg, ptr %i.gh, align 4, !tbaa !67
  %i.gi = load float, ptr %.159254, align 4, !tbaa !67
  %i.gj = getelementptr inbounds nuw i8, ptr %.461, i64 24
  store float %i.gi, ptr %i.gj, align 4, !tbaa !67
  %i.gk = load float, ptr %.159453, align 4, !tbaa !67
  %i.gl = getelementptr inbounds nuw i8, ptr %.461, i64 28
  store float %i.gk, ptr %i.gl, align 4, !tbaa !67
  %i.gm = load float, ptr %.159652, align 4, !tbaa !67
  %i.gn = getelementptr inbounds nuw i8, ptr %.461, i64 32
  store float %i.gm, ptr %i.gn, align 4, !tbaa !67
  %i.go = load float, ptr %.159851, align 4, !tbaa !67
  %i.gp = getelementptr inbounds nuw i8, ptr %.461, i64 36
  store float %i.go, ptr %i.gp, align 4, !tbaa !67
  %i.gq = load float, ptr %.160050, align 4, !tbaa !67
  %i.gr = getelementptr inbounds nuw i8, ptr %.461, i64 40
  store float %i.gq, ptr %i.gr, align 4, !tbaa !67
  %i.gs = load float, ptr %.160249, align 4, !tbaa !67
  %i.gt = getelementptr inbounds nuw i8, ptr %.461, i64 44
  store float %i.gs, ptr %i.gt, align 4, !tbaa !67
  ...
  br i1 %exitcond255.not, label %.loopexit12, label %.lr.ph62, !llvm.loop !192
...
.lr.ph.epil.preheader:                            ; preds = %.loopexit12.loopexit.unr-lcssa, %.lr.ph.preheader
  ...
  %i.hi = load <4 x float>, ptr %.056317.epil.init, align 16, !tbaa !87
  store <4 x float> %i.hi, ptr %.155118.epil.init, align 16, !tbaa !87
  %i.hj = getelementptr inbounds nuw i8, ptr %.155118.epil.init, i64 16
  %i.hk = load <4 x float>, ptr %.056416.epil.init, align 16, !tbaa !87
  store <4 x float> %i.hk, ptr %i.hj, align 16, !tbaa !87
  %i.hl = getelementptr inbounds nuw i8, ptr %.155118.epil.init, i64 32
  %i.hm = load <4 x float>, ptr %.056515.epil.init, align 16, !tbaa !87
  store <4 x float> %i.hm, ptr %i.hl, align 16, !tbaa !87
...
.loopexit12:                                      ; preds = %.lr.ph62, %.lr.ph.epil.preheader, %.loopexit12.loopexit.unr-lcssa, %bb.b, %bb.c, %.preheader11
  ...
  br i1 %i.hp, label %bb.b, label %.preheader10.loopexit, !llvm.loop !193
...
.preheader6:                                      ; preds = %.preheader6.loopexit, %.preheader10
  %.1553.lcssa = phi i32 [ %.0552.lcssa, %.preheader10 ], [ %i.hq, %.preheader6.loopexit ] ; 10 uses
...
.lr.ph141.split.us:                               ; preds = %.lr.ph141.split.us.preheader, %.loopexit.us
  ...
  %.pre281 = load ptr, ptr %0, align 8, !tbaa !23 ; 5 uses
...
.lr.ph116.us:                                     ; preds = %.lr.ph116.us.preheader, %.lr.ph116.us
  ...
  br i1 %niter540.ncmp.7, label %.loopexit5.us.loopexit.unr-lcssa, label %.lr.ph116.us, !llvm.loop !194
...
.lr.ph116.us.epil:                                ; preds = %.lr.ph116.us.epil, %.lr.ph116.us.epil.preheader
  ...
  %i.jv = load <4 x float>, ptr %.0586113.us.epil, align 16, !tbaa !87
  store <4 x float> %i.jv, ptr %.13115.us.epil, align 16, !tbaa !87
  ...
  br i1 %epil.iter535.cmp.not, label %.loopexit5.us.loopexit, label %.lr.ph116.us.epil, !llvm.loop !195
...
.lr.ph124.us:                                     ; preds = %.loopexit5.us, %.lr.ph124.us
  ...
  %i.kn = load <4 x float>, ptr %.0583118.us, align 1, !tbaa !87 ; 2 uses
  %i.ko = load <4 x float>, ptr %.0581119.us, align 1, !tbaa !87 ; 2 uses
  %i.kp = load <4 x float>, ptr %.0579120.us, align 1, !tbaa !87 ; 2 uses
  %i.kq = load <4 x float>, ptr %.0577121.us, align 1, !tbaa !87 ; 2 uses
  ...
  store <4 x float> %i.kv, ptr %.15123.us, align 16, !tbaa !87
  %i.kz = getelementptr inbounds nuw i8, ptr %.15123.us, i64 16
  store <4 x float> %i.kw, ptr %i.kz, align 16, !tbaa !87
  %i.la = getelementptr inbounds nuw i8, ptr %.15123.us, i64 32
  store <4 x float> %i.kx, ptr %i.la, align 16, !tbaa !87
  %i.lb = getelementptr inbounds nuw i8, ptr %.15123.us, i64 48
  store <4 x float> %i.ky, ptr %i.lb, align 16, !tbaa !87
  ...
  br i1 %i.lj, label %.lr.ph124.us, label %.preheader4.us, !llvm.loop !196
...
.lr.ph137.us:                                     ; preds = %.lr.ph137.us.prol.loopexit, %.lr.ph137.us
  ...
  %i.lk = load float, ptr %.1584131.us, align 4, !tbaa !67
  store float %i.lk, ptr %.16136.us, align 4, !tbaa !67
  %i.ll = load float, ptr %.1582132.us, align 4, !tbaa !67
  %i.lm = getelementptr inbounds nuw i8, ptr %.16136.us, i64 4
  store float %i.ll, ptr %i.lm, align 4, !tbaa !67
  %i.ln = load float, ptr %.1580133.us, align 4, !tbaa !67
  %i.lo = getelementptr inbounds nuw i8, ptr %.16136.us, i64 8
  store float %i.ln, ptr %i.lo, align 4, !tbaa !67
  %i.lp = load float, ptr %.1578134.us, align 4, !tbaa !67
  %i.lq = getelementptr inbounds nuw i8, ptr %.16136.us, i64 12
  store float %i.lp, ptr %i.lq, align 4, !tbaa !67
  ...
  %i.lw = load float, ptr %i.ls, align 4, !tbaa !67
  store float %i.lw, ptr %i.lr, align 4, !tbaa !67
  %i.lx = load float, ptr %i.lt, align 4, !tbaa !67
  %i.ly = getelementptr inbounds nuw i8, ptr %.16136.us, i64 20
  store float %i.lx, ptr %i.ly, align 4, !tbaa !67
  %i.lz = load float, ptr %i.lu, align 4, !tbaa !67
  %i.ma = getelementptr inbounds nuw i8, ptr %.16136.us, i64 24
  store float %i.lz, ptr %i.ma, align 4, !tbaa !67
  %i.mb = load float, ptr %i.lv, align 4, !tbaa !67
  %i.mc = getelementptr inbounds nuw i8, ptr %.16136.us, i64 28
  store float %i.mb, ptr %i.mc, align 4, !tbaa !67
  ...
  br i1 %exitcond268.not.1, label %.loopexit.us, label %.lr.ph137.us, !llvm.loop !197
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x float>, ptr %next.gep409, align 4, !tbaa !67, !alias.scope !227
  %wide.load410.a = load <4 x float>, ptr %next.gep408.a, align 4, !tbaa !67, !alias.scope !228
  %wide.load411.a = load <4 x float>, ptr %next.gep407.a, align 4, !tbaa !67, !alias.scope !229
  %wide.load412 = load <4 x float>, ptr %next.gep406.a, align 4, !tbaa !67, !alias.scope !230
  ...
  store <16 x float> %interleaved.vec, ptr %next.gep, align 4, !tbaa !67, !alias.scope !231, !noalias !232
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ng = icmp eq i64 %index.next, %n.vec
  br i1 %i.ng, label %middle.block, label %vector.body, !llvm.loop !204
...
.lr.ph137.us.prol:                                ; preds = %.lr.ph137.us.preheader482
  %i.ni = load float, ptr %.1584131.us.ph, align 4, !tbaa !67
  store float %i.ni, ptr %.16136.us.ph, align 4, !tbaa !67
  %i.nj = load float, ptr %.1582132.us.ph, align 4, !tbaa !67
  %i.nk = getelementptr inbounds nuw i8, ptr %.16136.us.ph, i64 4
  store float %i.nj, ptr %i.nk, align 4, !tbaa !67
  %i.nl = load float, ptr %.1580133.us.ph, align 4, !tbaa !67
  %i.nm = getelementptr inbounds nuw i8, ptr %.16136.us.ph, i64 8
  store float %i.nl, ptr %i.nm, align 4, !tbaa !67
  %i.nn = load float, ptr %.1578134.us.ph, align 4, !tbaa !67
  %i.no = getelementptr inbounds nuw i8, ptr %.16136.us.ph, i64 12
  store float %i.nn, ptr %i.no, align 4, !tbaa !67
...
.loopexit.us:                                     ; preds = %.lr.ph137.us.prol.loopexit, %.lr.ph137.us, %middle.block, %.preheader4.us
  ...
  br i1 %i.nw, label %.lr.ph141.split.us, label %.preheader3.loopexit, !llvm.loop !205
...
.lr.ph141.split.split.us:                         ; preds = %.lr.ph141.split
  br i1 %i.hw, label %.lr.ph116.us147.us.preheader, label %.loopexit5.us153.preheader

.loopexit5.us153.preheader:                       ; preds = %.lr.ph141.split.split.us
  %6 = add nuw i32 %.1553.lcssa, 7
  %smax262 = tail call i32 @llvm.smax.i32(i32 %2, i32 %6)
  %i.oc = add i32 %smax262, -4
...
.lr.ph116.us147.us.preheader:                     ; preds = %.lr.ph141.split.split.us
  ...
  br label %.lr.ph116.us147.us

.lr.ph116.us147.us:                               ; preds = %.lr.ph116.us147.us.preheader, %..loopexit5_crit_edge.us151.us
  %indvars.iv264 = phi i64 [ %i.oh, %.lr.ph116.us147.us.preheader ], [ %indvars.iv.next265, %..loopexit5_crit_edge.us151.us ] ; 2 uses
  %.12140.us145.us = phi ptr [ %.6.lcssa, %.lr.ph116.us147.us.preheader ], [ %.lcssa490, %..loopexit5_crit_edge.us151.us ] ; 2 uses
  %i.om = load ptr, ptr %0, align 8, !tbaa !23
  ...
  br i1 %i.ol, label %.epil.preheader, label %.lr.ph116.us147.us.new

.lr.ph116.us147.us.new:                           ; preds = %.lr.ph116.us147.us, %.lr.ph116.us147.us.new
  %.13115.us148.us = phi ptr [ %i.pn, %.lr.ph116.us147.us.new ], [ %.12140.us145.us, %.lr.ph116.us147.us ] ; 9 uses
  %.0586113.us150.us = phi ptr [ %i.po, %.lr.ph116.us147.us.new ], [ %i.oq, %.lr.ph116.us147.us ] ; 9 uses
  %niter533 = phi i32 [ %niter533.next.7, %.lr.ph116.us147.us.new ], [ 0, %.lr.ph116.us147.us ]
  %i.or = load <4 x float>, ptr %.0586113.us150.us, align 16, !tbaa !87
  store <4 x float> %i.or, ptr %.13115.us148.us, align 16, !tbaa !87
  %i.os = getelementptr inbounds nuw i8, ptr %.13115.us148.us, i64 16
  %i.ot = getelementptr inbounds nuw i8, ptr %.0586113.us150.us, i64 16
  %i.ou = load <4 x float>, ptr %i.ot, align 16, !tbaa !87
  store <4 x float> %i.ou, ptr %i.os, align 16, !tbaa !87
  %i.ov = getelementptr inbounds nuw i8, ptr %.13115.us148.us, i64 32
  %i.ow = getelementptr inbounds nuw i8, ptr %.0586113.us150.us, i64 32
  %i.ox = load <4 x float>, ptr %i.ow, align 16, !tbaa !87
  store <4 x float> %i.ox, ptr %i.ov, align 16, !tbaa !87
  %i.oy = getelementptr inbounds nuw i8, ptr %.13115.us148.us, i64 48
  %i.oz = getelementptr inbounds nuw i8, ptr %.0586113.us150.us, i64 48
  %i.pa = load <4 x float>, ptr %i.oz, align 16, !tbaa !87
  store <4 x float> %i.pa, ptr %i.oy, align 16, !tbaa !87
  %i.pb = getelementptr inbounds nuw i8, ptr %.13115.us148.us, i64 64
  %i.pc = getelementptr inbounds nuw i8, ptr %.0586113.us150.us, i64 64
  %i.pd = load <4 x float>, ptr %i.pc, align 16, !tbaa !87
  store <4 x float> %i.pd, ptr %i.pb, align 16, !tbaa !87
  %i.pe = getelementptr inbounds nuw i8, ptr %.13115.us148.us, i64 80
  %i.pf = getelementptr inbounds nuw i8, ptr %.0586113.us150.us, i64 80
  %i.pg = load <4 x float>, ptr %i.pf, align 16, !tbaa !87
  store <4 x float> %i.pg, ptr %i.pe, align 16, !tbaa !87
  %i.ph = getelementptr inbounds nuw i8, ptr %.13115.us148.us, i64 96
  %i.pi = getelementptr inbounds nuw i8, ptr %.0586113.us150.us, i64 96
  %i.pj = load <4 x float>, ptr %i.pi, align 16, !tbaa !87
  store <4 x float> %i.pj, ptr %i.ph, align 16, !tbaa !87
  %i.pk = getelementptr inbounds nuw i8, ptr %.13115.us148.us, i64 112
  %i.pl = getelementptr inbounds nuw i8, ptr %.0586113.us150.us, i64 112
  %i.pm = load <4 x float>, ptr %i.pl, align 16, !tbaa !87
  store <4 x float> %i.pm, ptr %i.pk, align 16, !tbaa !87
  %i.pn = getelementptr inbounds nuw i8, ptr %.13115.us148.us, i64 128 ; 3 uses
  %i.po = getelementptr inbounds nuw i8, ptr %.0586113.us150.us, i64 128 ; 2 uses
  %niter533.next.7 = add nuw nsw i32 %niter533, 8 ; 2 uses
  %niter533.ncmp.7 = icmp eq i32 %niter533.next.7, %unroll_iter532
  br i1 %niter533.ncmp.7, label %..loopexit5_crit_edge.us151.us.unr-lcssa, label %.lr.ph116.us147.us.new, !llvm.loop !194

..loopexit5_crit_edge.us151.us.unr-lcssa:         ; preds = %.lr.ph116.us147.us.new
  br i1 %lcmp.mod529.not, label %..loopexit5_crit_edge.us151.us, label %.epil.preheader

.epil.preheader:                                  ; preds = %..loopexit5_crit_edge.us151.us.unr-lcssa, %.lr.ph116.us147.us
  %.13115.us148.us.epil.init = phi ptr [ %.12140.us145.us, %.lr.ph116.us147.us ], [ %i.pn, %..loopexit5_crit_edge.us151.us.unr-lcssa ]
  %.0586113.us150.us.epil.init = phi ptr [ %i.oq, %.lr.ph116.us147.us ], [ %i.po, %..loopexit5_crit_edge.us151.us.unr-lcssa ]
  tail call void @llvm.assume(i1 %lcmp.mod531)
  br label %bb.f

bb.f:                                             ; preds = %bb.f, %.epil.preheader
  %.13115.us148.us.epil = phi ptr [ %.13115.us148.us.epil.init, %.epil.preheader ], [ %i.pq, %bb.f ] ; 2 uses
  %.0586113.us150.us.epil = phi ptr [ %.0586113.us150.us.epil.init, %.epil.preheader ], [ %i.pr, %bb.f ] ; 2 uses
  %epil.iter528 = phi i32 [ 0, %.epil.preheader ], [ %epil.iter528.next, %bb.f ]
  %i.pp = load <4 x float>, ptr %.0586113.us150.us.epil, align 16, !tbaa !87
  store <4 x float> %i.pp, ptr %.13115.us148.us.epil, align 16, !tbaa !87
  %i.pq = getelementptr inbounds nuw i8, ptr %.13115.us148.us.epil, i64 16 ; 2 uses
  %i.pr = getelementptr inbounds nuw i8, ptr %.0586113.us150.us.epil, i64 16
  %epil.iter528.next = add i32 %epil.iter528, 1   ; 2 uses
  %epil.iter528.cmp.not = icmp eq i32 %epil.iter528.next, %xtraiter527
  br i1 %epil.iter528.cmp.not, label %..loopexit5_crit_edge.us151.us, label %bb.f, !llvm.loop !206

..loopexit5_crit_edge.us151.us:                   ; preds = %bb.f, %..loopexit5_crit_edge.us151.us.unr-lcssa
  %.lcssa490 = phi ptr [ %i.pn, %..loopexit5_crit_edge.us151.us.unr-lcssa ], [ %i.pq, %bb.f ] ; 2 uses
  %indvars.iv.next265 = add nuw nsw i64 %indvars.iv264, 4 ; 3 uses
  %i.ps = icmp slt i64 %indvars.iv.next265, %invariant.op341
  br i1 %i.ps, label %.lr.ph116.us147.us, label %.preheader3.loopexit200, !llvm.loop !205
...
.lr.ph73.preheader:                               ; preds = %bb.h
  %i.pt = load ptr, ptr %0, align 8, !tbaa !23    ; 2 uses
...
.lr.ph73:                                         ; preds = %.lr.ph73.preheader, %.lr.ph73
  ...
  %i.qc = load <4 x float>, ptr %.060571, align 16, !tbaa !87
  store <4 x float> %i.qc, ptr %.772, align 16, !tbaa !87
  %i.qd = getelementptr inbounds nuw i8, ptr %.772, i64 16
  %i.qe = load <4 x float>, ptr %.060670, align 16, !tbaa !87
  store <4 x float> %i.qe, ptr %i.qd, align 16, !tbaa !87
  ...
  %i.qi = load <4 x float>, ptr %i.qg, align 16, !tbaa !87
  store <4 x float> %i.qi, ptr %i.qf, align 16, !tbaa !87
  %i.qj = getelementptr inbounds nuw i8, ptr %.772, i64 48
  %i.qk = load <4 x float>, ptr %i.qh, align 16, !tbaa !87
  store <4 x float> %i.qk, ptr %i.qj, align 16, !tbaa !87
  ...
  %i.qo = load <4 x float>, ptr %i.qm, align 16, !tbaa !87
  store <4 x float> %i.qo, ptr %i.ql, align 16, !tbaa !87
  %i.qp = getelementptr inbounds nuw i8, ptr %.772, i64 80
  %i.qq = load <4 x float>, ptr %i.qn, align 16, !tbaa !87
  store <4 x float> %i.qq, ptr %i.qp, align 16, !tbaa !87
  ...
  %i.qu = load <4 x float>, ptr %i.qs, align 16, !tbaa !87
  store <4 x float> %i.qu, ptr %i.qr, align 16, !tbaa !87
  %i.qv = getelementptr inbounds nuw i8, ptr %.772, i64 112
  %i.qw = load <4 x float>, ptr %i.qt, align 16, !tbaa !87
  store <4 x float> %i.qw, ptr %i.qv, align 16, !tbaa !87
  ...
  br i1 %niter526.ncmp.3, label %.loopexit8.loopexit.unr-lcssa, label %.lr.ph73, !llvm.loop !207

bb.i:                                             ; preds = %bb.g
  %i.ra = load ptr, ptr %0, align 8, !tbaa !23    ; 8 uses
...
begin_hunk_1_@_ZN4ncnnL36transpose_compute_A_tile_int8_scalesERKNS_3MatERS0_fS3_ii:bb.a
  store <4 x float> %i.dw, ptr %i.ec, align 16, !tbaa !87
  %i.ed = getelementptr inbounds nuw i8, ptr %.026988.i, i64 48
  store <4 x float> %i.dx, ptr %i.ed, align 16, !tbaa !87
...
bb.d:                                             ; preds = %bb.c, %.thread.i, %._crit_edge.i
  ...
  br i1 %i.eh, label %bb.b, label %.preheader77.loopexit.i, !llvm.loop !648
...
.lr.ph102.i:                                      ; preds = %bb.e, %.lr.ph102.i
  ...
  %i.ev = load <4 x i32>, ptr %.028497.i, align 1, !tbaa !87
  %i.ew = getelementptr inbounds nuw i8, ptr %.028497.i, i64 16
  %i.ex = load <4 x i32>, ptr %i.ew, align 1, !tbaa !87
  %i.ey = getelementptr inbounds nuw [4 x i8], ptr %.028497.i, i64 %i.l ; 2 uses
  %i.ez = load <4 x i32>, ptr %i.ey, align 1, !tbaa !87
  %i.fa = getelementptr inbounds nuw i8, ptr %i.ey, i64 16
  %i.fb = load <4 x i32>, ptr %i.fa, align 1, !tbaa !87
  ...
  br i1 %i.fr, label %.lr.ph102.i, label %._crit_edge103.i, !llvm.loop !649
...
.lr.ph115.i.prol:                                 ; preds = %.lr.ph115.i.preheader
  %i.fv = load <4 x i32>, ptr %.0284.lcssa.i, align 1, !tbaa !87
  %i.fw = getelementptr inbounds nuw i8, ptr %.0284.lcssa.i, i64 16
  %i.fx = load <4 x i32>, ptr %i.fw, align 1, !tbaa !87
...
.lr.ph115.i:                                      ; preds = %.lr.ph115.i.prol.loopexit, %.lr.ph115.i
  ...
  %i.gh = load <4 x i32>, ptr %.1285112.i, align 1, !tbaa !87
  %i.gi = getelementptr inbounds nuw i8, ptr %.1285112.i, i64 16
  %i.gj = load <4 x i32>, ptr %i.gi, align 1, !tbaa !87
  ...
  %i.gr = load <4 x i32>, ptr %i.gq, align 1, !tbaa !87
  %i.gs = getelementptr inbounds nuw i8, ptr %i.gq, i64 16
  %i.gt = load <4 x i32>, ptr %i.gs, align 1, !tbaa !87
  ...
  br i1 %exitcond230.not.i.1, label %._crit_edge116.i, label %.lr.ph115.i, !llvm.loop !650
...
.thread69.i:                                      ; preds = %._crit_edge116.i
  ...
  store <2 x float> %i.hl, ptr %.3121.i, align 4, !tbaa !67
  %i.hm = fmul fast <2 x float> %i.hk, splat (float f0x3C010204)
  %i.hn = fmul fast <2 x float> %i.hm, %i.as
  store <2 x float> %i.hn, ptr %.3272120.i, align 4, !tbaa !67
...
bb.f:                                             ; preds = %._crit_edge116.i
  ...
  store <4 x float> %i.hq, ptr %.3121.i, align 16, !tbaa !87
  %i.hu = getelementptr inbounds nuw i8, ptr %.3121.i, i64 16
  store <4 x float> %i.hr, ptr %i.hu, align 16, !tbaa !87
  store <4 x float> %i.hs, ptr %.3272120.i, align 16, !tbaa !87
  %i.hv = getelementptr inbounds nuw i8, ptr %.3272120.i, i64 16
  store <4 x float> %i.ht, ptr %i.hv, align 16, !tbaa !87
...
bb.g:                                             ; preds = %bb.f, %.thread69.i, %._crit_edge116.i
  ...
  br i1 %i.hy, label %bb.e, label %.preheader76.loopexit.i, !llvm.loop !651

.preheader75.i:                                   ; preds = %bb.k, %.preheader76.i
  %.2288.lcssa.i = phi i32 [ %.1287.lcssa.i, %.preheader76.i ], [ %i.nv, %bb.k ] ; 10 uses
...
.lr.ph178.i:                                      ; preds = %.preheader75.i
  %i.ib = load ptr, ptr %0, align 8, !tbaa !23
...
.lr.ph178.split.i.preheader:                      ; preds = %.lr.ph178.i
  ...
  %min.iters.check = icmp ult i32 %i.ih, 18
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x float> splat (float +inf), ptr %next.gep, align 4, !tbaa !67, !alias.scope !671, !noalias !672
  store <4 x float> splat (float +inf), ptr %next.gep135, align 4, !tbaa !67, !alias.scope !671, !noalias !672
  store <4 x float> zeroinitializer, ptr %next.gep136, align 4, !tbaa !67, !alias.scope !672
  store <4 x float> zeroinitializer, ptr %next.gep137, align 4, !tbaa !67, !alias.scope !672
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.iy = icmp eq i64 %index.next, %n.vec
  br i1 %i.iy, label %middle.block, label %vector.body, !llvm.loop !655
...
.lr.ph171.us.i.new:                               ; preds = %.lr.ph171.us.i, %.lr.ph171.us.i.new
  ...
  %i.jh = load <2 x float>, ptr %.0257168.us.i, align 4, !tbaa !67
  ...
  %i.jl = load <2 x float>, ptr %i.jk, align 4, !tbaa !67
  ...
  %i.jp = load <2 x float>, ptr %i.jo, align 4, !tbaa !67
  ...
  %i.jt = load <2 x float>, ptr %i.js, align 4, !tbaa !67
  ...
  br i1 %niter203.ncmp.3, label %._crit_edge172.us.i.unr-lcssa, label %.lr.ph171.us.i.new, !llvm.loop !656
...
bb.h:                                             ; preds = %bb.h, %.epil.preheader
  ...
  %i.jy = load <2 x float>, ptr %.0257168.us.i.epil, align 4, !tbaa !67
  ...
  br i1 %epil.iter.cmp.not, label %._crit_edge172.us.i, label %bb.h, !llvm.loop !657
...
._crit_edge172.us.i:                              ; preds = %bb.h, %._crit_edge172.us.i.unr-lcssa
  ...
  store <2 x float> %i.kc, ptr %.9177.us.i, align 4, !tbaa !67
  %i.kd = fmul fast <2 x float> %.lcssa, splat (float f0x3C010204)
  %i.ke = fmul fast <2 x float> %i.kd, %i.je
  store <2 x float> %i.ke, ptr %.9278176.us.i, align 4, !tbaa !67
  ...
  br i1 %i.kj, label %.lr.ph171.us.i, label %.preheader.i, !llvm.loop !658
...
bb.i:                                             ; preds = %bb.k, %.lr.ph162.i
  ...
  %i.kk = load ptr, ptr %0, align 8, !tbaa !23
...
.lr.ph133.i:                                      ; preds = %bb.i, %.lr.ph133.i
  ...
  br i1 %i.lj, label %.lr.ph133.i, label %._crit_edge134.i, !llvm.loop !659
...
.lr.ph146.i:                                      ; preds = %._crit_edge134.i, %.lr.ph146.i
  ...
  %i.lo = load <4 x i32>, ptr %.1264142.i, align 1, !tbaa !87
  %i.lp = getelementptr inbounds nuw [4 x i8], ptr %.1264142.i, i64 %i.l
  %i.lq = load <4 x i32>, ptr %i.lp, align 1, !tbaa !87
...
begin_hunk_2_@_ZN4ncnnL16pack_A_tile_bf16ERKNS_3MatERS0_iiii:bb.a
  store i16 %i.fb, ptr %.427.us.ph, align 2, !tbaa !105
  %i.fc = load i16, ptr %.112322.us.ph, align 2, !tbaa !105
  %i.fd = getelementptr inbounds nuw i8, ptr %.427.us.ph, i64 2
  store i16 %i.fc, ptr %i.fd, align 2, !tbaa !105
  %i.fe = load i16, ptr %.112123.us.ph, align 2, !tbaa !105
  %i.ff = getelementptr inbounds nuw i8, ptr %.427.us.ph, i64 4
  store i16 %i.fe, ptr %i.ff, align 2, !tbaa !105
  %i.fg = load i16, ptr %.111924.us.ph, align 2, !tbaa !105
  %i.fh = getelementptr inbounds nuw i8, ptr %.427.us.ph, i64 6
  store i16 %i.fg, ptr %i.fh, align 2, !tbaa !105
...
.loopexit.us:                                     ; preds = %.lr.ph28.us.prol.loopexit, %.lr.ph28.us, %middle.block177, %.preheader2.us
  ...
  br i1 %i.fq, label %.lr.ph32.split.us, label %.preheader1.loopexit, !llvm.loop !838
...
.lr.ph32.split.split.us:                          ; preds = %.lr.ph32.split
  br i1 %i.p, label %.preheader3.us38.preheader, label %.preheader3.us38.us.preheader

.preheader3.us38.us.preheader:                    ; preds = %.lr.ph32.split.split.us
  ...
  br label %.preheader3.us38.us

.preheader3.us38.preheader:                       ; preds = %.lr.ph32.split.split.us
  %i.gc = and i32 %2, 2147483644
  br label %.preheader1

.preheader3.us38.us:                              ; preds = %.preheader3.us38.us.preheader, %..loopexit4_crit_edge.us43.us
  %indvar = phi i64 [ 0, %.preheader3.us38.us.preheader ], [ %indvar.next, %..loopexit4_crit_edge.us43.us ] ; 2 uses
  %indvars.iv = phi i64 [ 0, %.preheader3.us38.us.preheader ], [ %indvars.iv.next, %..loopexit4_crit_edge.us43.us ] ; 2 uses
  %.010731.us36.us = phi ptr [ %.0.val, %.preheader3.us38.us.preheader ], [ %.lcssa134, %..loopexit4_crit_edge.us43.us ] ; 5 uses
  %i.gd = load ptr, ptr %0, align 8, !tbaa !23    ; 2 uses
...
vector.memcheck:                                  ; preds = %.preheader3.us38.us
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %next.gep136, align 1, !tbaa !87
  %wide.load137 = load <2 x i64>, ptr %i.gq, align 1, !tbaa !87
  %i.gr = getelementptr i8, ptr %next.gep, i64 16
  store <2 x i64> %wide.load, ptr %next.gep, align 1, !tbaa !87
  store <2 x i64> %wide.load137, ptr %i.gr, align 1, !tbaa !87
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.gs = icmp eq i64 %index.next, %n.vec
  br i1 %i.gs, label %middle.block, label %vector.body, !llvm.loop !839

middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %..loopexit4_crit_edge.us43.us, label %scalar.ph.preheader

scalar.ph.preheader:                              ; preds = %vector.memcheck, %.preheader3.us38.us, %middle.block
  %.17.us40.us.ph = phi ptr [ %.010731.us36.us, %vector.memcheck ], [ %.010731.us36.us, %.preheader3.us38.us ], [ %i.gn, %middle.block ] ; 2 uses
  %.01116.us41.us.ph = phi ptr [ %i.gh, %vector.memcheck ], [ %i.gh, %.preheader3.us38.us ], [ %i.go, %middle.block ] ; 2 uses
  %.01155.us42.us.ph = phi i32 [ 0, %vector.memcheck ], [ 0, %.preheader3.us38.us ], [ %i.gb, %middle.block ] ; 4 uses
  %i.gt = sub i32 %4, %.01155.us42.us.ph
  %xtraiter = and i32 %i.gt, 7                    ; 2 uses
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  br i1 %lcmp.mod.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol

scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  %.17.us40.us.prol = phi ptr [ %i.gv, %scalar.ph.prol ], [ %.17.us40.us.ph, %scalar.ph.preheader ] ; 2 uses
  %.01116.us41.us.prol = phi ptr [ %i.gw, %scalar.ph.prol ], [ %.01116.us41.us.ph, %scalar.ph.preheader ] ; 2 uses
  %.01155.us42.us.prol = phi i32 [ %i.gx, %scalar.ph.prol ], [ %.01155.us42.us.ph, %scalar.ph.preheader ]
  %prol.iter = phi i32 [ %prol.iter.next, %scalar.ph.prol ], [ 0, %scalar.ph.preheader ]
  %i.gu = load i64, ptr %.01116.us41.us.prol, align 1, !tbaa !87
  store i64 %i.gu, ptr %.17.us40.us.prol, align 1, !tbaa !87
  %i.gv = getelementptr inbounds nuw i8, ptr %.17.us40.us.prol, i64 8 ; 3 uses
  %i.gw = getelementptr inbounds nuw i8, ptr %.01116.us41.us.prol, i64 8 ; 2 uses
  %i.gx = add nuw nsw i32 %.01155.us42.us.prol, 1 ; 2 uses
  %prol.iter.next = add i32 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol, !llvm.loop !840

scalar.ph.prol.loopexit:                          ; preds = %scalar.ph.prol, %scalar.ph.preheader
  %.lcssa303.unr = phi ptr [ poison, %scalar.ph.preheader ], [ %i.gv, %scalar.ph.prol ]
  %.17.us40.us.unr = phi ptr [ %.17.us40.us.ph, %scalar.ph.preheader ], [ %i.gv, %scalar.ph.prol ]
  %.01116.us41.us.unr = phi ptr [ %.01116.us41.us.ph, %scalar.ph.preheader ], [ %i.gw, %scalar.ph.prol ]
  %.01155.us42.us.unr = phi i32 [ %.01155.us42.us.ph, %scalar.ph.preheader ], [ %i.gx, %scalar.ph.prol ]
  %i.gy = sub i32 %.01155.us42.us.ph, %4
  %i.gz = icmp ugt i32 %i.gy, -8
  br i1 %i.gz, label %..loopexit4_crit_edge.us43.us, label %scalar.ph

scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  %.17.us40.us = phi ptr [ %i.hw, %scalar.ph ], [ %.17.us40.us.unr, %scalar.ph.prol.loopexit ] ; 9 uses
  %.01116.us41.us = phi ptr [ %i.hx, %scalar.ph ], [ %.01116.us41.us.unr, %scalar.ph.prol.loopexit ] ; 9 uses
  %.01155.us42.us = phi i32 [ %i.hy, %scalar.ph ], [ %.01155.us42.us.unr, %scalar.ph.prol.loopexit ]
  %i.ha = load i64, ptr %.01116.us41.us, align 1, !tbaa !87
  store i64 %i.ha, ptr %.17.us40.us, align 1, !tbaa !87
  %i.hb = getelementptr inbounds nuw i8, ptr %.17.us40.us, i64 8
  %i.hc = getelementptr inbounds nuw i8, ptr %.01116.us41.us, i64 8
  %i.hd = load i64, ptr %i.hc, align 1, !tbaa !87
  store i64 %i.hd, ptr %i.hb, align 1, !tbaa !87
  %i.he = getelementptr inbounds nuw i8, ptr %.17.us40.us, i64 16
  %i.hf = getelementptr inbounds nuw i8, ptr %.01116.us41.us, i64 16
  %i.hg = load i64, ptr %i.hf, align 1, !tbaa !87
  store i64 %i.hg, ptr %i.he, align 1, !tbaa !87
  %i.hh = getelementptr inbounds nuw i8, ptr %.17.us40.us, i64 24
  %i.hi = getelementptr inbounds nuw i8, ptr %.01116.us41.us, i64 24
  %i.hj = load i64, ptr %i.hi, align 1, !tbaa !87
  store i64 %i.hj, ptr %i.hh, align 1, !tbaa !87
  %i.hk = getelementptr inbounds nuw i8, ptr %.17.us40.us, i64 32
  %i.hl = getelementptr inbounds nuw i8, ptr %.01116.us41.us, i64 32
  %i.hm = load i64, ptr %i.hl, align 1, !tbaa !87
  store i64 %i.hm, ptr %i.hk, align 1, !tbaa !87
  %i.hn = getelementptr inbounds nuw i8, ptr %.17.us40.us, i64 40
  %i.ho = getelementptr inbounds nuw i8, ptr %.01116.us41.us, i64 40
  %i.hp = load i64, ptr %i.ho, align 1, !tbaa !87
  store i64 %i.hp, ptr %i.hn, align 1, !tbaa !87
  %i.hq = getelementptr inbounds nuw i8, ptr %.17.us40.us, i64 48
  %i.hr = getelementptr inbounds nuw i8, ptr %.01116.us41.us, i64 48
  %i.hs = load i64, ptr %i.hr, align 1, !tbaa !87
  store i64 %i.hs, ptr %i.hq, align 1, !tbaa !87
  %i.ht = getelementptr inbounds nuw i8, ptr %.17.us40.us, i64 56
  %i.hu = getelementptr inbounds nuw i8, ptr %.01116.us41.us, i64 56
  %i.hv = load i64, ptr %i.hu, align 1, !tbaa !87
  store i64 %i.hv, ptr %i.ht, align 1, !tbaa !87
  %i.hw = getelementptr inbounds nuw i8, ptr %.17.us40.us, i64 64 ; 2 uses
  %i.hx = getelementptr inbounds nuw i8, ptr %.01116.us41.us, i64 64
  %i.hy = add nuw nsw i32 %.01155.us42.us, 8      ; 2 uses
  %exitcond.not.7 = icmp eq i32 %i.hy, %4
  br i1 %exitcond.not.7, label %..loopexit4_crit_edge.us43.us, label %scalar.ph, !llvm.loop !841

..loopexit4_crit_edge.us43.us:                    ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  ...
  br i1 %i.ia, label %.preheader3.us38.us, label %.preheader1.loopexit79, !llvm.loop !838

.preheader1.loopexit:                             ; preds = %.loopexit.us
  %i.ib = trunc nuw nsw i64 %indvars.iv.next101 to i32
  br label %.preheader1

.preheader1.loopexit79:                           ; preds = %..loopexit4_crit_edge.us43.us
  %i.ic = trunc nuw nsw i64 %indvars.iv.next to i32
  br label %.preheader1

.preheader1:                                      ; preds = %.preheader1.loopexit79, %.preheader3.us38.preheader, %.lr.ph32.split.split.preheader, %.preheader1.loopexit, %bb.a
  %.0108.lcssa = phi i32 [ 0, %bb.a ], [ %i.ib, %.preheader1.loopexit ], [ %i.fr, %.lr.ph32.split.split.preheader ], [ %i.gc, %.preheader3.us38.preheader ], [ %i.ic, %.preheader1.loopexit79 ] ; 6 uses
  %.0107.lcssa = phi ptr [ %.0.val, %bb.a ], [ %.4.lcssa.us, %.preheader1.loopexit ], [ %.0.val, %.lr.ph32.split.split.preheader ], [ %.0.val, %.preheader3.us38.preheader ], [ %.lcssa134, %.preheader1.loopexit79 ] ; 3 uses
...
.lr.ph60:                                         ; preds = %.preheader1
  %i.if = load ptr, ptr %0, align 8, !tbaa !23    ; 5 uses
...
vector.body225:                                   ; preds = %vector.body225, %vector.ph223
  ...
  %wide.load231.a = load <4 x i16>, ptr %next.gep228.a, align 2, !tbaa !105, !alias.scope !861
  %wide.load232.a = load <4 x i16>, ptr %i.ki, align 2, !tbaa !105, !alias.scope !861
  %i.kj = getelementptr i8, ptr %next.gep227.a, i64 8
  %wide.load233.a = load <4 x i16>, ptr %next.gep227.a, align 2, !tbaa !105, !alias.scope !862
  %wide.load234 = load <4 x i16>, ptr %i.kj, align 2, !tbaa !105, !alias.scope !862
  ...
  store <8 x i16> %interleaved.vec235.a, ptr %next.gep229.a, align 2, !tbaa !105, !alias.scope !863, !noalias !864
  ...
  store <8 x i16> %interleaved.vec236, ptr %next.gep230, align 2, !tbaa !105, !alias.scope !863, !noalias !864
  %index.next237 = add nuw i64 %index226, 8       ; 2 uses
  %i.kk = icmp eq i64 %index.next237, %n.vec224
  br i1 %i.kk, label %middle.block238, label %vector.body225, !llvm.loop !846
...
scalar.ph221.prol:                                ; preds = %scalar.ph221.preheader, %scalar.ph221.prol
  ...
  %i.km = load i16, ptr %.010655.us.prol, align 2, !tbaa !105
  store i16 %i.km, ptr %.754.us.prol, align 2, !tbaa !105
  %i.kn = load i16, ptr %.010556.us.prol, align 2, !tbaa !105
  %i.ko = getelementptr inbounds nuw i8, ptr %.754.us.prol, i64 2
  store i16 %i.kn, ptr %i.ko, align 2, !tbaa !105
  ...
  br i1 %prol.iter312.cmp.not, label %scalar.ph221.prol.loopexit, label %scalar.ph221.prol, !llvm.loop !847
...
scalar.ph221:                                     ; preds = %scalar.ph221.prol.loopexit, %scalar.ph221
  ...
  %i.kv = load i16, ptr %.010655.us, align 2, !tbaa !105
  store i16 %i.kv, ptr %.754.us, align 2, !tbaa !105
  %i.kw = load i16, ptr %.010556.us, align 2, !tbaa !105
  %i.kx = getelementptr inbounds nuw i8, ptr %.754.us, i64 2
  store i16 %i.kw, ptr %i.kx, align 2, !tbaa !105
  ...
  %i.lb = load i16, ptr %i.kz, align 2, !tbaa !105
  store i16 %i.lb, ptr %i.ky, align 2, !tbaa !105
  %i.lc = load i16, ptr %i.la, align 2, !tbaa !105
  %i.ld = getelementptr inbounds nuw i8, ptr %.754.us, i64 6
  store i16 %i.lc, ptr %i.ld, align 2, !tbaa !105
  ...
  %i.lh = load i16, ptr %i.lf, align 2, !tbaa !105
  store i16 %i.lh, ptr %i.le, align 2, !tbaa !105
  %i.li = load i16, ptr %i.lg, align 2, !tbaa !105
  %i.lj = getelementptr inbounds nuw i8, ptr %.754.us, i64 10
  store i16 %i.li, ptr %i.lj, align 2, !tbaa !105
  ...
  %i.ln = load i16, ptr %i.ll, align 2, !tbaa !105
  store i16 %i.ln, ptr %i.lk, align 2, !tbaa !105
  %i.lo = load i16, ptr %i.lm, align 2, !tbaa !105
  %i.lp = getelementptr inbounds nuw i8, ptr %.754.us, i64 14
  store i16 %i.lo, ptr %i.lp, align 2, !tbaa !105
  ...
  br i1 %exitcond103.not.3, label %._crit_edge.us, label %scalar.ph221, !llvm.loop !848
...
._crit_edge.us:                                   ; preds = %scalar.ph221.prol.loopexit, %scalar.ph221, %middle.block238
  ...
  br i1 %i.lu, label %.lr.ph.us63, label %.preheader.loopexit, !llvm.loop !849
...
begin_hunk_3_@_ZN4ncnnL16pack_B_tile_bf16ERKNS_3MatERS0_iiii:bb.a
  store i16 %i.bz, ptr %i.ca, align 2, !tbaa !105
  ...
  br i1 %exitcond104.not, label %.loopexit6.us, label %.lr.ph16.us, !llvm.loop !870
...
.loopexit6.us:                                    ; preds = %.lr.ph16.us, %bb.b, %.preheader5.us
  ...
  br i1 %i.cf, label %.lr.ph20.split.us, label %.preheader4.loopexit, !llvm.loop !871
...
.lr.ph20.split.split.us:                          ; preds = %.lr.ph20.split
  br i1 %i.p, label %.lr.ph.us26.us.preheader, label %.loopexit7.us33.preheader

.loopexit7.us33.preheader:                        ; preds = %.lr.ph20.split.split.us
  %i.ch = and i32 %2, 2147483640
  br label %.preheader4

.lr.ph.us26.us.preheader:                         ; preds = %.lr.ph20.split.split.us
  ...
  br label %.lr.ph.us26.us

.lr.ph.us26.us:                                   ; preds = %.lr.ph.us26.us.preheader, %..loopexit7_crit_edge.us31.us
  %indvars.iv = phi i64 [ 0, %.lr.ph.us26.us.preheader ], [ %indvars.iv.next, %..loopexit7_crit_edge.us31.us ] ; 2 uses
  %.014918.us25.us = phi ptr [ %.0.val, %.lr.ph.us26.us.preheader ], [ %.lcssa288, %..loopexit7_crit_edge.us31.us ] ; 2 uses
  %i.cm = load ptr, ptr %0, align 8, !tbaa !23
  ...
  br i1 %i.cl, label %.epil.preheader, label %.lr.ph.us26.us.new

.lr.ph.us26.us.new:                               ; preds = %.lr.ph.us26.us, %.lr.ph.us26.us.new
  %.014210.us28.us = phi ptr [ %i.dp, %.lr.ph.us26.us.new ], [ %i.cr, %.lr.ph.us26.us ] ; 5 uses
  %.01439.us29.us = phi ptr [ %i.do, %.lr.ph.us26.us.new ], [ %i.cq, %.lr.ph.us26.us ] ; 5 uses
  %.11508.us30.us = phi ptr [ %i.dn, %.lr.ph.us26.us.new ], [ %.014918.us25.us, %.lr.ph.us26.us ] ; 9 uses
  %niter = phi i32 [ %niter.next.3, %.lr.ph.us26.us.new ], [ 0, %.lr.ph.us26.us ]
  %i.cs = load i64, ptr %.01439.us29.us, align 1, !tbaa !87
  store i64 %i.cs, ptr %.11508.us30.us, align 1, !tbaa !87
  %i.ct = getelementptr inbounds nuw i8, ptr %.11508.us30.us, i64 8
  %i.cu = load i64, ptr %.014210.us28.us, align 1, !tbaa !87
  store i64 %i.cu, ptr %i.ct, align 1, !tbaa !87
  %i.cv = getelementptr inbounds nuw i8, ptr %.11508.us30.us, i64 16
  %i.cw = getelementptr inbounds nuw i8, ptr %.01439.us29.us, i64 8
  %i.cx = getelementptr inbounds nuw i8, ptr %.014210.us28.us, i64 8
  %i.cy = load i64, ptr %i.cw, align 1, !tbaa !87
  store i64 %i.cy, ptr %i.cv, align 1, !tbaa !87
  %i.cz = getelementptr inbounds nuw i8, ptr %.11508.us30.us, i64 24
  %i.da = load i64, ptr %i.cx, align 1, !tbaa !87
  store i64 %i.da, ptr %i.cz, align 1, !tbaa !87
  %i.db = getelementptr inbounds nuw i8, ptr %.11508.us30.us, i64 32
  %i.dc = getelementptr inbounds nuw i8, ptr %.01439.us29.us, i64 16
  %i.dd = getelementptr inbounds nuw i8, ptr %.014210.us28.us, i64 16
  %i.de = load i64, ptr %i.dc, align 1, !tbaa !87
  store i64 %i.de, ptr %i.db, align 1, !tbaa !87
  %i.df = getelementptr inbounds nuw i8, ptr %.11508.us30.us, i64 40
  %i.dg = load i64, ptr %i.dd, align 1, !tbaa !87
  store i64 %i.dg, ptr %i.df, align 1, !tbaa !87
  %i.dh = getelementptr inbounds nuw i8, ptr %.11508.us30.us, i64 48
  %i.di = getelementptr inbounds nuw i8, ptr %.01439.us29.us, i64 24
  %i.dj = getelementptr inbounds nuw i8, ptr %.014210.us28.us, i64 24
  %i.dk = load i64, ptr %i.di, align 1, !tbaa !87
  store i64 %i.dk, ptr %i.dh, align 1, !tbaa !87
  %i.dl = getelementptr inbounds nuw i8, ptr %.11508.us30.us, i64 56
  %i.dm = load i64, ptr %i.dj, align 1, !tbaa !87
  store i64 %i.dm, ptr %i.dl, align 1, !tbaa !87
  %i.dn = getelementptr inbounds nuw i8, ptr %.11508.us30.us, i64 64 ; 3 uses
  %i.do = getelementptr inbounds nuw i8, ptr %.01439.us29.us, i64 32 ; 2 uses
  %i.dp = getelementptr inbounds nuw i8, ptr %.014210.us28.us, i64 32 ; 2 uses
  %niter.next.3 = add nuw nsw i32 %niter, 4       ; 2 uses
  %niter.ncmp.3 = icmp eq i32 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %..loopexit7_crit_edge.us31.us.unr-lcssa, label %.lr.ph.us26.us.new, !llvm.loop !868

..loopexit7_crit_edge.us31.us.unr-lcssa:          ; preds = %.lr.ph.us26.us.new
  br i1 %lcmp.mod.not, label %..loopexit7_crit_edge.us31.us, label %.epil.preheader

.epil.preheader:                                  ; preds = %..loopexit7_crit_edge.us31.us.unr-lcssa, %.lr.ph.us26.us
  %.014210.us28.us.epil.init = phi ptr [ %i.cr, %.lr.ph.us26.us ], [ %i.dp, %..loopexit7_crit_edge.us31.us.unr-lcssa ]
  %.01439.us29.us.epil.init = phi ptr [ %i.cq, %.lr.ph.us26.us ], [ %i.do, %..loopexit7_crit_edge.us31.us.unr-lcssa ]
  %.11508.us30.us.epil.init = phi ptr [ %.014918.us25.us, %.lr.ph.us26.us ], [ %i.dn, %..loopexit7_crit_edge.us31.us.unr-lcssa ]
  tail call void @llvm.assume(i1 %lcmp.mod290)
  br label %bb.c

bb.c:                                             ; preds = %bb.c, %.epil.preheader
  %.014210.us28.us.epil = phi ptr [ %.014210.us28.us.epil.init, %.epil.preheader ], [ %i.dv, %bb.c ] ; 2 uses
  %.01439.us29.us.epil = phi ptr [ %.01439.us29.us.epil.init, %.epil.preheader ], [ %i.du, %bb.c ] ; 2 uses
  %.11508.us30.us.epil = phi ptr [ %.11508.us30.us.epil.init, %.epil.preheader ], [ %i.dt, %bb.c ] ; 3 uses
  %epil.iter = phi i32 [ 0, %.epil.preheader ], [ %epil.iter.next, %bb.c ]
  %i.dq = load i64, ptr %.01439.us29.us.epil, align 1, !tbaa !87
  store i64 %i.dq, ptr %.11508.us30.us.epil, align 1, !tbaa !87
  %i.dr = getelementptr inbounds nuw i8, ptr %.11508.us30.us.epil, i64 8
  %i.ds = load i64, ptr %.014210.us28.us.epil, align 1, !tbaa !87
  store i64 %i.ds, ptr %i.dr, align 1, !tbaa !87
  %i.dt = getelementptr inbounds nuw i8, ptr %.11508.us30.us.epil, i64 16 ; 2 uses
  %i.du = getelementptr inbounds nuw i8, ptr %.01439.us29.us.epil, i64 8
  %i.dv = getelementptr inbounds nuw i8, ptr %.014210.us28.us.epil, i64 8
  %epil.iter.next = add i32 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %..loopexit7_crit_edge.us31.us, label %bb.c, !llvm.loop !872

..loopexit7_crit_edge.us31.us:                    ; preds = %bb.c, %..loopexit7_crit_edge.us31.us.unr-lcssa
  %.lcssa288 = phi ptr [ %i.dn, %..loopexit7_crit_edge.us31.us.unr-lcssa ], [ %i.dt, %bb.c ] ; 2 uses
  ...
  br i1 %i.dx, label %.lr.ph.us26.us, label %.preheader4.loopexit84, !llvm.loop !871

.preheader4.loopexit:                             ; preds = %.loopexit6.us
  %i.dy = trunc nuw nsw i64 %indvars.iv.next106 to i32
  br label %.preheader4

.preheader4.loopexit84:                           ; preds = %..loopexit7_crit_edge.us31.us
  %i.dz = trunc nuw nsw i64 %indvars.iv.next to i32
  br label %.preheader4

.preheader4:                                      ; preds = %.lr.ph20.split.split.preheader, %.loopexit7.us33.preheader, %.preheader4.loopexit84, %.preheader4.loopexit, %bb.a
  %.0149.lcssa = phi ptr [ %.0.val, %bb.a ], [ %.0.val, %.loopexit7.us33.preheader ], [ %.lcssa288, %.preheader4.loopexit84 ], [ %.3152.lcssa.us, %.preheader4.loopexit ], [ %.0.val, %.lr.ph20.split.split.preheader ] ; 2 uses
  %.0146.lcssa = phi i32 [ 0, %bb.a ], [ %i.ch, %.loopexit7.us33.preheader ], [ %i.dz, %.preheader4.loopexit84 ], [ %i.dy, %.preheader4.loopexit ], [ %i.cg, %.lr.ph20.split.split.preheader ] ; 3 uses
...
.preheader1:                                      ; preds = %.preheader1.loopexit, %.preheader4
  ...
  %.1147.lcssa = phi i32 [ %.0146.lcssa, %.preheader4 ], [ %i.fq, %.preheader1.loopexit ] ; 6 uses
...
.lr.ph67:                                         ; preds = %.preheader1
  %i.ft = load ptr, ptr %0, align 8, !tbaa !23    ; 5 uses
...
vector.body219:                                   ; preds = %vector.body219, %vector.ph217
  ...
  %wide.load225.a = load <4 x i16>, ptr %next.gep222.a, align 2, !tbaa !105, !alias.scope !898
  %wide.load226.a = load <4 x i16>, ptr %i.hw, align 2, !tbaa !105, !alias.scope !898
  %i.hx = getelementptr i8, ptr %next.gep221.a, i64 8
  %wide.load227.a = load <4 x i16>, ptr %next.gep221.a, align 2, !tbaa !105, !alias.scope !899
  %wide.load228 = load <4 x i16>, ptr %i.hx, align 2, !tbaa !105, !alias.scope !899
  ...
  store <8 x i16> %interleaved.vec229.a, ptr %next.gep223.a, align 2, !tbaa !105, !alias.scope !900, !noalias !901
  ...
  store <8 x i16> %interleaved.vec230, ptr %next.gep224, align 2, !tbaa !105, !alias.scope !900, !noalias !901
  %index.next231 = add nuw i64 %index220, 8       ; 2 uses
  %i.hy = icmp eq i64 %index.next231, %n.vec218
  br i1 %i.hy, label %middle.block232, label %vector.body219, !llvm.loop !877
...
scalar.ph215.prol:                                ; preds = %scalar.ph215.preheader, %scalar.ph215.prol
  ...
  %i.ia = load i16, ptr %.013360.us.prol, align 2, !tbaa !105
  store i16 %i.ia, ptr %.1159.us.prol, align 2, !tbaa !105
  %i.ib = load i16, ptr %.013261.us.prol, align 2, !tbaa !105
  %i.ic = getelementptr inbounds nuw i8, ptr %.1159.us.prol, i64 2
  store i16 %i.ib, ptr %i.ic, align 2, !tbaa !105
  ...
  br i1 %prol.iter306.cmp.not, label %scalar.ph215.prol.loopexit, label %scalar.ph215.prol, !llvm.loop !878
...
scalar.ph215:                                     ; preds = %scalar.ph215.prol.loopexit, %scalar.ph215
  ...
  %i.ij = load i16, ptr %.013360.us, align 2, !tbaa !105
  store i16 %i.ij, ptr %.1159.us, align 2, !tbaa !105
  %i.ik = load i16, ptr %.013261.us, align 2, !tbaa !105
  %i.il = getelementptr inbounds nuw i8, ptr %.1159.us, i64 2
  store i16 %i.ik, ptr %i.il, align 2, !tbaa !105
  ...
  %i.ip = load i16, ptr %i.in, align 2, !tbaa !105
  store i16 %i.ip, ptr %i.im, align 2, !tbaa !105
  %i.iq = load i16, ptr %i.io, align 2, !tbaa !105
  %i.ir = getelementptr inbounds nuw i8, ptr %.1159.us, i64 6
  store i16 %i.iq, ptr %i.ir, align 2, !tbaa !105
  ...
  %i.iv = load i16, ptr %i.it, align 2, !tbaa !105
  store i16 %i.iv, ptr %i.is, align 2, !tbaa !105
  %i.iw = load i16, ptr %i.iu, align 2, !tbaa !105
  %i.ix = getelementptr inbounds nuw i8, ptr %.1159.us, i64 10
  store i16 %i.iw, ptr %i.ix, align 2, !tbaa !105
  ...
  %i.jb = load i16, ptr %i.iz, align 2, !tbaa !105
  store i16 %i.jb, ptr %i.iy, align 2, !tbaa !105
  %i.jc = load i16, ptr %i.ja, align 2, !tbaa !105
  %i.jd = getelementptr inbounds nuw i8, ptr %.1159.us, i64 14
  store i16 %i.jc, ptr %i.jd, align 2, !tbaa !105
  ...
  br i1 %exitcond113.not.3, label %._crit_edge.us, label %scalar.ph215, !llvm.loop !879
...
._crit_edge.us:                                   ; preds = %scalar.ph215.prol.loopexit, %scalar.ph215, %middle.block232
  ...
  br i1 %i.ji, label %.lr.ph63.us, label %.preheader.loopexit, !llvm.loop !880
...
.lr.ph84.epil:                                    ; preds = %.lr.ph84.epil, %.lr.ph84.epil.preheader
  ...
  %i.ne = load i64, ptr %.018182.epil, align 1, !tbaa !87
  store i64 %i.ne, ptr %.1681.epil, align 1, !tbaa !87
  ...
  br i1 %epil.iter230.cmp.not, label %.loopexit, label %.lr.ph84.epil, !llvm.loop !924
...
.loopexit:                                        ; preds = %.loopexit.loopexit194.unr-lcssa, %.lr.ph84.epil, %.loopexit.loopexit.unr-lcssa, %.lr.ph90.epil, %.loopexit2
  ...
  br i1 %exitcond152.not, label %._crit_edge, label %bb.e, !llvm.loop !925
...
.noexc84:                                         ; preds = %bb.c
  %i.af = load ptr, ptr %8, align 8, !tbaa !23, !noalias !933
  %i.ag = load i64, ptr %i.l, align 8, !tbaa !24, !noalias !933
  %i.ah = sext i32 %i.ae to i64
  %i.ai = mul i64 %i.ag, %i.ah
  %i.aj = load i64, ptr %i.m, align 8, !tbaa !62, !noalias !933
  %i.ak = mul i64 %i.ai, %i.aj
  %i.al = getelementptr inbounds nuw i8, ptr %i.af, i64 %i.ak ; 2 uses
  %i.am = load i32, ptr %9, align 4, !tbaa !49    ; 2 uses
...
_ZN4ncnn3MatD2Ev.exit:                            ; preds = %_ZN4ncnn3MatD2Ev.exit58, %.noexc84
  %i.ao = load i32, ptr %15, align 4, !tbaa !49
  %i.ap = load float, ptr %16, align 4, !tbaa !67
  %i.aq = load float, ptr %17, align 4, !tbaa !67
  %i.ar = load i32, ptr %18, align 4, !tbaa !49
  %i.as = load i32, ptr %19, align 4, !tbaa !49
  ...
  %i.au = load i32, ptr %i.b, align 4, !tbaa !49
...
_ZN4ncnn3MatD2Ev.exit58:                          ; preds = %_ZN4ncnn3MatD2Ev.exit58.preheader, %_ZN4ncnn3MatD2Ev.exit58
  ...
  %i.ay = load i32, ptr %4, align 4, !tbaa !49
  %i.az = sdiv i32 %i.x, %i.ay
  %i.ba = load i32, ptr %i.n, align 4, !tbaa !75, !noalias !934
  %i.bb = load ptr, ptr %11, align 8, !tbaa !23, !noalias !934
  %i.bc = load i64, ptr %i.o, align 8, !tbaa !24, !noalias !934
  %i.bd = sext i32 %i.az to i64
  %i.be = mul i64 %i.bc, %i.bd
  %i.bf = load i64, ptr %i.p, align 8, !tbaa !62, !noalias !934 ; 2 uses
  ...
  %i.bo = load i32, ptr %5, align 4, !tbaa !49
  %i.bp = sdiv i32 %i.z, %i.bo
  %i.bq = load i32, ptr %i.q, align 4, !tbaa !75, !noalias !935
  %i.br = load ptr, ptr %12, align 8, !tbaa !23, !noalias !935
  %i.bs = load i64, ptr %i.r, align 8, !tbaa !24, !noalias !935
  %i.bt = sext i32 %i.bp to i64
  %i.bu = mul i64 %i.bs, %i.bt
  %i.bv = load i64, ptr %i.s, align 8, !tbaa !62, !noalias !935 ; 2 uses
  ...
  %i.cc = load i32, ptr %10, align 4, !tbaa !49   ; 2 uses
  %i.cd = add nsw i32 %i.cc, %.0161               ; 2 uses
  %i.ce = load i32, ptr %9, align 4, !tbaa !49    ; 2 uses
  %i.cf = icmp slt i32 %i.cd, %i.ce
  br i1 %i.cf, label %_ZN4ncnn3MatD2Ev.exit58, label %_ZN4ncnn3MatD2Ev.exit, !llvm.loop !932
...
.lr.ph:                                           ; preds = %bb.c, %.lr.ph
  ...
  %i.ba = load i64, ptr %.0441264, align 1, !tbaa !87
  ...
  %i.bf = load i64, ptr %.1410265, align 1, !tbaa !87
  ...
  %i.bl = load i64, ptr %i.bk, align 1, !tbaa !87
  ...
  br i1 %exitcond.not, label %._crit_edge.loopexit, label %.lr.ph, !llvm.loop !936
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %bb.c
  ...
  store <4 x float> %.1183.lcssa, ptr %.1404276, align 16, !tbaa !87
  %i.cn = getelementptr inbounds nuw i8, ptr %.1404276, i64 16
  store <4 x float> %.1185.lcssa, ptr %i.cn, align 16, !tbaa !87
  %i.co = getelementptr inbounds nuw i8, ptr %.1404276, i64 32
  store <4 x float> %.1187.lcssa, ptr %i.co, align 16, !tbaa !87
  %i.cp = getelementptr inbounds nuw i8, ptr %.1404276, i64 48
  store <4 x float> %.1189.lcssa, ptr %i.cp, align 16, !tbaa !87
  %i.cq = getelementptr inbounds nuw i8, ptr %.1404276, i64 64
  store <4 x float> %.1191.lcssa, ptr %i.cq, align 16, !tbaa !87
  %i.cr = getelementptr inbounds nuw i8, ptr %.1404276, i64 80
  store <4 x float> %.1193.lcssa, ptr %i.cr, align 16, !tbaa !87
  %i.cs = getelementptr inbounds nuw i8, ptr %.1404276, i64 96
  store <4 x float> %.1195.lcssa, ptr %i.cs, align 16, !tbaa !87
  %i.ct = getelementptr inbounds nuw i8, ptr %.1404276, i64 112
  store <4 x float> %.1197.lcssa, ptr %i.ct, align 16, !tbaa !87
  ...
  br i1 %i.cx, label %.lr.ph277, label %.preheader253, !llvm.loop !937

.preheader252:                                    ; preds = %._crit_edge290, %.preheader253
  %.1438.lcssa = phi i32 [ %.0437.lcssa, %.preheader253 ], [ %i.ft, %._crit_edge290 ] ; 7 uses
...
bb.d:                                             ; preds = %.lr.ph317.split.us
  %i.da = load <4 x float>, ptr %.3316.us, align 16, !tbaa !87
  %i.db = getelementptr inbounds nuw i8, ptr %.3316.us, i64 16
  %i.dc = load <4 x float>, ptr %i.db, align 16, !tbaa !87
...
.lr.ph309.us:                                     ; preds = %.lr.ph309.us.preheader, %.lr.ph309.us
  ...
  %i.dd = load i64, ptr %.0445306.us, align 1, !tbaa !87
  ...
  %i.di = load float, ptr %.5414307.us, align 1, !tbaa !87
  ...
  br i1 %exitcond741.not, label %._crit_edge310.us, label %.lr.ph309.us, !llvm.loop !938
...
._crit_edge310.us:                                ; preds = %.lr.ph309.us
  ...
  store <4 x float> %i.dq, ptr %.3316.us, align 16, !tbaa !87
  %i.dx = getelementptr inbounds nuw i8, ptr %.3316.us, i64 16
  store <4 x float> %i.ds, ptr %i.dx, align 16, !tbaa !87
  ...
  br i1 %i.eb, label %.lr.ph317.split.us, label %.preheader251, !llvm.loop !939
...
.lr.ph317.split.split.us.preheader:               ; preds = %.lr.ph317.split
  %4 = add i32 %.1438.lcssa, 3
  %smax = tail call i32 @llvm.smax.i32(i32 %1, i32 %4)
  %5 = add i32 %smax, -2
  %i.ec = sub i32 %5, %.1438.lcssa                ; 2 uses
  %i.ed = lshr i32 %i.ec, 1
  %i.ee = zext nneg i32 %i.ed to i64
  %i.ef = shl nuw nsw i64 %i.ee, 5                ; 2 uses
  %i.eg = add nuw nsw i64 %i.ef, 32
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(1) %.2405.lcssa, i8 0, i64 %i.eg, i1 false), !tbaa !87
...
bb.e:                                             ; preds = %.lr.ph299
  %i.ek = load <4 x float>, ptr %.2405298, align 16, !tbaa !87
  %i.el = getelementptr inbounds nuw i8, ptr %.2405298, i64 16
  %i.em = load <4 x float>, ptr %i.el, align 16, !tbaa !87
  %i.en = getelementptr inbounds nuw i8, ptr %.2405298, i64 32
  %i.eo = load <4 x float>, ptr %i.en, align 16, !tbaa !87
  %i.ep = getelementptr inbounds nuw i8, ptr %.2405298, i64 48
  %i.eq = load <4 x float>, ptr %i.ep, align 16, !tbaa !87
  br label %bb.f
...
.lr.ph289:                                        ; preds = %bb.f, %.lr.ph289
  ...
  %i.er = load i64, ptr %.0443286, align 1, !tbaa !87
  ...
  %i.ew = load i64, ptr %.3412287, align 1, !tbaa !87
  ...
  br i1 %exitcond736.not, label %._crit_edge290.loopexit, label %.lr.ph289, !llvm.loop !940
...
._crit_edge290:                                   ; preds = %._crit_edge290.loopexit, %bb.f
  ...
  store <4 x float> %.1199.lcssa, ptr %.2405298, align 16, !tbaa !87
  %i.fp = getelementptr inbounds nuw i8, ptr %.2405298, i64 16
  store <4 x float> %.1201.lcssa, ptr %i.fp, align 16, !tbaa !87
  %i.fq = getelementptr inbounds nuw i8, ptr %.2405298, i64 32
  store <4 x float> %.1203.lcssa, ptr %i.fq, align 16, !tbaa !87
  %i.fr = getelementptr inbounds nuw i8, ptr %.2405298, i64 48
  store <4 x float> %.1205.lcssa, ptr %i.fr, align 16, !tbaa !87
  ...
  br i1 %i.fv, label %.lr.ph299, label %.preheader252, !llvm.loop !941
...
bb.g:                                             ; preds = %.lr.ph345.split.us
  %i.fx = load <4 x float>, ptr %.4344.us, align 16, !tbaa !87
...
.lr.ph338.us:                                     ; preds = %.lr.ph338.us.preheader, %.lr.ph338.us
  ...
  %i.fy = load i64, ptr %.0473335.us, align 1, !tbaa !87
  ...
  %i.gd = load i16, ptr %.7416336.us, align 2, !tbaa !105
  ...
  br i1 %exitcond747.not.a, label %._crit_edge339.us, label %.lr.ph338.us, !llvm.loop !942

._crit_edge339.us:                                ; preds = %.lr.ph338.us
  %i.go = getelementptr i8, ptr %.6415343.us, i64 %i.m
  %scevgep746 = getelementptr i8, ptr %i.go, i64 2
  store <4 x float> %i.gk, ptr %.4344.us, align 16, !tbaa !87
  ...
  br i1 %exitcond748.not, label %._crit_edge346, label %.lr.ph345.split.us, !llvm.loop !943
...
.lr.ph345.split.split.us.preheader:               ; preds = %.lr.ph345.split
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(1) %.3.lcssa, i8 0, i64 %i.gx, i1 false), !tbaa !87
...
.lr.ph317.split.split:                            ; preds = %.lr.ph317.split, %.lr.ph317.split.split
  ...
  br i1 %i.hb, label %.lr.ph317.split.split, label %.preheader251, !llvm.loop !939
...
._crit_edge346:                                   ; preds = %._crit_edge339.us, %.lr.ph345.split.split.preheader, %.lr.ph345.split.split.us.preheader, %.preheader251
  ...
  br i1 %i.hf, label %.preheader254, label %.preheader250.loopexit, !llvm.loop !944
