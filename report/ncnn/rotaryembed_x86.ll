...
.lr.ph279:                                        ; preds = %.lr.ph279.preheader460, %.lr.ph279
  ...
  %i.he = bitcast <2 x i32> %i.hc to <2 x float>
  %17 = shufflevector <2 x float> %i.he, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %18 = fmul fast <2 x float> %16, %17            ; 2 uses
  %19 = insertelement <2 x i32> poison, i32 %11, i64 0
  %20 = bitcast <2 x i32> %19 to <2 x float>
  %i.hf = shufflevector <2 x float> %20, <2 x float> poison, <2 x i32> zeroinitializer
  %i.hg = fmul fast <2 x float> %i.hf, %i.hd      ; 2 uses
  %i.hh = fsub fast <2 x float> %i.hg, %18
  %i.hi = fadd fast <2 x float> %i.hg, %18
