...
.lr.ph279:                                        ; preds = %.lr.ph279.preheader460, %.lr.ph279
  ...
  %10 = zext i16 %i.gz to i32
  %11 = zext i16 %i.gx to i32
  %12 = shl nuw i32 %10, 16
  %13 = shl nuw i32 %11, 16
  %14 = insertelement <2 x i32> poison, i32 %12, i64 0
  %i.he = bitcast <2 x i32> %14 to <2 x float>
  %15 = shufflevector <2 x float> %i.he, <2 x float> poison, <2 x i32> zeroinitializer
  %i.hf = bitcast <2 x i32> %i.hc to <2 x float>
  %i.hg = shufflevector <2 x float> %i.hf, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %i.hh = fmul fast <2 x float> %15, %i.hg        ; 2 uses
