...
.lr.ph265.i.i:                                    ; preds = %_ZN17FastDivider_epu32C2Ej.exit.i.i
  ...
  %i.add = insertelement <2 x i32> %i.adb, i32 %i.zi, i64 1 ; 2 uses
  %12 = insertelement <2 x i32> poison, i32 %.scalar451.i.i, i64 0
  %i.ade = insertelement <2 x i32> %12, i32 %i.ack, i64 1 ; 2 uses
  %i.adf = insertelement <2 x i32> poison, i32 %6, i64 0
  %i.adg = insertelement <2 x i32> %i.adf, i32 %i.zi, i64 1
  %i.adh = insertelement <2 x i32> poison, i32 %.scalar451.i.i, i64 0
  %i.adi = insertelement <2 x i32> %i.adh, i32 %i.ack, i64 1
  %i.adj = insertelement <2 x i32> poison, i32 %i.zi, i64 0
  %13 = shufflevector <2 x i32> %i.adj, <2 x i32> poison, <2 x i32> zeroinitializer ; 2 uses
  %14 = insertelement <2 x i32> poison, i32 %6, i64 0
  %15 = shufflevector <2 x i32> %14, <2 x i32> poison, <2 x i32> zeroinitializer
  %16 = insertelement <2 x i64> poison, i64 %i.m, i64 0
...
.lr.ph306.i.i:                                    ; preds = %.preheader216.i.i
  ...
  %i.afa = insertelement <2 x i32> %i.aey, i32 %i.zi, i64 1 ; 2 uses
  %18 = insertelement <2 x i32> poison, i32 %.scalar454.i.i, i64 0
  %i.afb = insertelement <2 x i32> %18, i32 %i.aeh, i64 1 ; 2 uses
  %i.afc = insertelement <2 x i32> poison, i32 %6, i64 0
  %i.afd = insertelement <2 x i32> %i.afc, i32 %i.zi, i64 1
  %i.afe = insertelement <2 x i32> poison, i32 %.scalar454.i.i, i64 0
  %i.aff = insertelement <2 x i32> %i.afe, i32 %i.aeh, i64 1
  %i.afg = insertelement <2 x i32> poison, i32 %i.zi, i64 0
  %19 = shufflevector <2 x i32> %i.afg, <2 x i32> poison, <2 x i32> zeroinitializer ; 2 uses
  %20 = insertelement <2 x i32> poison, i32 %6, i64 0
  %21 = shufflevector <2 x i32> %20, <2 x i32> poison, <2 x i32> zeroinitializer
  %22 = insertelement <2 x i64> poison, i64 %i.m, i64 0
...
bb.l:                                             ; preds = %bb.l, %.lr.ph252.i.i
  ...
  %i.ait = add nsw i32 %.11256250.i.i, %4         ; 2 uses
  %i.aiu = add nsw i32 %i.ait, 1
  %24 = insertelement <2 x i32> poison, i32 %i.ait, i64 0
  %25 = insertelement <2 x i32> %24, i32 %i.aiu, i64 1
  ...
  %i.aiv = sext <2 x i32> %26 to <2 x i64>
  %i.aiw = mul <2 x i64> %17, %i.aiv              ; 2 uses
  %i.aix = mul i32 %31, %.scalar451.i.i
  %38 = extractelement <2 x i32> %32, i64 1
  %i.aiy = mul nsw i32 %38, %8
  ...
  %i.ajf = getelementptr i8, ptr %i.aje, i64 %37
...
.lr.ph234.i50.i:                                  ; preds = %.preheader227.i.i, %.lr.ph234.i50.i
  ...
  %i.apl = srem <2 x i32> %i.apk, %i.adc          ; 2 uses
  %39 = extractelement <2 x i32> %i.apl, i64 0
  %40 = mul nsw i32 %39, %8
  %41 = extractelement <2 x i32> %i.apl, i64 1
  %42 = mul nsw i32 %41, %8
  %i.apm = insertelement <2 x i32> %i.apk, i32 %i.apg, i64 1
  %i.apn = sdiv <2 x i32> %i.apm, %i.add
  %i.apo = mul <2 x i32> %i.apn, %i.ade
  %43 = tail call i32 @llvm.vector.reduce.add.v2i32(<2 x i32> %i.apo)
  %44 = add i32 %43, %40
  %45 = insertelement <8 x i32> poison, i32 %44, i64 0
  %i.app = shufflevector <8 x i32> %45, <8 x i32> poison, <8 x i32> zeroinitializer
  ...
  %i.apt = sdiv <2 x i32> %i.aps, %i.add
  %i.apu = mul <2 x i32> %i.apt, %i.ade
  %46 = tail call i32 @llvm.vector.reduce.add.v2i32(<2 x i32> %i.apu)
  %47 = add i32 %46, %42
  %48 = insertelement <8 x i32> poison, i32 %47, i64 0
  %49 = shufflevector <8 x i32> %48, <8 x i32> poison, <8 x i32> zeroinitializer
  %i.apv = add <8 x i32> %49, %i.age
...
.lr.ph239.i.i:                                    ; preds = %.preheader225.i.i, %.lr.ph239.i.i
  ...
  %i.aqu = sdiv <2 x i32> %i.aqt, %i.adg
  %i.aqv = mul <2 x i32> %i.aqu, %i.adi
...
bb.s:                                             ; preds = %bb.s, %.lr.ph293.i.i
  ...
  %i.axy = add nsw i32 %.11264291.i.i, %4         ; 2 uses
  %i.axz = add nsw i32 %i.axy, 1
  %54 = insertelement <2 x i32> poison, i32 %i.axy, i64 0
  %55 = insertelement <2 x i32> %54, i32 %i.axz, i64 1
  %.frozen621 = freeze <2 x i32> %55              ; 2 uses
  %56 = sdiv <2 x i32> %.frozen621, %19           ; 2 uses
  %57 = mul <2 x i32> %56, %19
  %.decomposed622 = sub <2 x i32> %.frozen621, %57 ; 3 uses
  %58 = extractelement <2 x i32> %.decomposed622, i64 0
  %59 = sdiv i32 %58, %6
  %60 = extractelement <2 x i32> %.decomposed622, i64 1
  %61 = sdiv i32 %60, %6
  %62 = srem <2 x i32> %.decomposed622, %21       ; 2 uses
  %63 = mul i32 %59, %.scalar454.i.i
  %64 = extractelement <2 x i32> %62, i64 0
  %65 = mul nsw i32 %64, %8
  %66 = add nsw i32 %65, %63
  %67 = sext i32 %66 to i64
  %i.aya = sext <2 x i32> %56 to <2 x i64>
  %i.ayb = mul <2 x i64> %23, %i.aya              ; 2 uses
  %i.ayc = mul i32 %61, %.scalar454.i.i
  %68 = extractelement <2 x i32> %62, i64 1
  %i.ayd = mul nsw i32 %68, %8
  ...
  %i.ayk = getelementptr i8, ptr %i.ayj, i64 %67
...
.lr.ph275.i.i:                                    ; preds = %.preheader214.i.i, %.lr.ph275.i.i
  ...
  %i.bek = srem <2 x i32> %i.bej, %i.aez          ; 2 uses
  %69 = extractelement <2 x i32> %i.bek, i64 0
  %70 = mul nsw i32 %69, %8
  %71 = extractelement <2 x i32> %i.bek, i64 1
  %72 = mul nsw i32 %71, %8
  %i.bel = insertelement <2 x i32> %i.bej, i32 %i.bef, i64 1
  %i.bem = sdiv <2 x i32> %i.bel, %i.afa
  %i.ben = mul <2 x i32> %i.bem, %i.afb
  %73 = tail call i32 @llvm.vector.reduce.add.v2i32(<2 x i32> %i.ben)
  %74 = add i32 %73, %70
  %75 = insertelement <4 x i32> poison, i32 %74, i64 0
  %i.beo = shufflevector <4 x i32> %75, <4 x i32> poison, <4 x i32> zeroinitializer
  ...
  %i.bes = sdiv <2 x i32> %i.ber, %i.afa
  %i.bet = mul <2 x i32> %i.bes, %i.afb
  %76 = tail call i32 @llvm.vector.reduce.add.v2i32(<2 x i32> %i.bet)
  %77 = add i32 %76, %72
  %78 = insertelement <4 x i32> poison, i32 %77, i64 0
  %79 = shufflevector <4 x i32> %78, <4 x i32> poison, <4 x i32> zeroinitializer
  %i.beu = add <4 x i32> %79, %i.avn
...
.lr.ph280.i.i:                                    ; preds = %.preheader212.i.i, %.lr.ph280.i.i
  ...
  %i.bfn = sdiv <2 x i32> %i.bfm, %i.afd
  %i.bfo = mul <2 x i32> %i.bfn, %i.aff
...
bb.z:                                             ; preds = %bb.z, %.lr.ph335.i.i
  ...
  %i.bla = add nsw i32 %.11272333.i.i, %4         ; 2 uses
  %i.blb = add nsw i32 %i.bla, 1
  %84 = insertelement <2 x i32> poison, i32 %i.bla, i64 0
  %85 = insertelement <2 x i32> %84, i32 %i.blb, i64 1
  %.frozen626 = freeze <2 x i32> %85              ; 2 uses
  %86 = sdiv <2 x i32> %.frozen626, %51           ; 2 uses
  %87 = mul <2 x i32> %86, %51
  %.decomposed627 = sub <2 x i32> %.frozen626, %87 ; 3 uses
  %88 = extractelement <2 x i32> %.decomposed627, i64 0
  %89 = sdiv i32 %88, %6
  %90 = extractelement <2 x i32> %.decomposed627, i64 1
  %91 = sdiv i32 %90, %6
  %92 = srem <2 x i32> %.decomposed627, %i.aup    ; 2 uses
  %93 = mul i32 %89, %.scalar456.i.i
  %94 = extractelement <2 x i32> %92, i64 0
  %95 = mul nsw i32 %94, %8
  %96 = add nsw i32 %95, %93
  %97 = sext i32 %96 to i64
  %i.blc = sext <2 x i32> %86 to <2 x i64>
  %i.bld = mul <2 x i64> %53, %i.blc              ; 2 uses
  %i.ble = mul i32 %91, %.scalar456.i.i
  %98 = extractelement <2 x i32> %92, i64 1
  %i.blf = mul nsw i32 %98, %8
  ...
  %i.blm = getelementptr i8, ptr %i.bll, i64 %97  ; 2 uses
...
.lr.ph316.i.i:                                    ; preds = %.lr.ph316.i.i.preheader, %.lr.ph316.i.i
  ...
  %99 = load ptr, ptr %0, align 8, !tbaa !28      ; 4 uses
...
bb.ag:                                            ; preds = %bb.ag, %.lr.ph358.i.i
  ...
  %i.byu = add nsw i32 %.11281356.i.i, %4         ; 2 uses
  %i.byv = add nsw i32 %i.byu, 1
  %100 = insertelement <2 x i32> poison, i32 %i.byu, i64 0
  %101 = insertelement <2 x i32> %100, i32 %i.byv, i64 1
  %.frozen631 = freeze <2 x i32> %101             ; 2 uses
  %102 = sdiv <2 x i32> %.frozen631, %81          ; 2 uses
  %103 = mul <2 x i32> %102, %81
  %.decomposed632 = sub <2 x i32> %.frozen631, %103 ; 3 uses
  %104 = extractelement <2 x i32> %.decomposed632, i64 0
  %105 = sdiv i32 %104, %6
  %106 = extractelement <2 x i32> %.decomposed632, i64 1
  %107 = sdiv i32 %106, %6
  %108 = srem <2 x i32> %.decomposed632, %i.bid   ; 2 uses
  %109 = mul i32 %105, %.scalar458.i.i
  %110 = extractelement <2 x i32> %108, i64 0
  %111 = mul nsw i32 %110, %8
  %112 = add nsw i32 %111, %109
  %113 = sext i32 %112 to i64
  %i.byw = sext <2 x i32> %102 to <2 x i64>
  %i.byx = mul <2 x i64> %83, %i.byw              ; 2 uses
  %i.byy = mul i32 %107, %.scalar458.i.i
  %114 = extractelement <2 x i32> %108, i64 1
  %i.byz = mul nsw i32 %114, %8
  ...
  %i.bzg = getelementptr i8, ptr %i.bzf, i64 %113
