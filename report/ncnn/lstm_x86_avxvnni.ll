...
bb.a:
  ...
  %i.e = load i32, ptr %2, align 4, !tbaa !11     ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.h = load i32, ptr %0, align 4, !tbaa !11     ; 2 uses
  call void @__kmpc_for_static_init_4(ptr nonnull @1, i32 %i.h, i32 34, ptr nonnull %i.d, ptr nonnull %i.a, ptr nonnull %i.b, ptr nonnull %i.c, i32 1, i32 1)
  %i.i = load i32, ptr %i.b, align 4, !tbaa !11
  %i.j = call i32 @llvm.smin.i32(i32 %i.i, i32 %i.g) ; 2 uses
  store i32 %i.j, ptr %i.b, align 4, !tbaa !11
...
.noexc981:                                        ; preds = %.noexc981.lr.ph, %_ZN4ncnn3MatD2Ev.exit
  ...
  %i.ai = load i32, ptr %i.l, align 4, !tbaa !20, !noalias !70
  %i.aj = load ptr, ptr %3, align 8, !tbaa !21, !noalias !70
  %i.ak = load i64, ptr %i.m, align 8, !tbaa !22, !noalias !70
  %i.al = mul i64 %i.ak, %indvars.iv1660
  %i.am = load i64, ptr %i.n, align 8, !tbaa !23, !noalias !70 ; 3 uses
  %i.an = mul i64 %i.al, %i.am
  %i.ao = getelementptr inbounds nuw i8, ptr %i.aj, i64 %i.an ; 12 uses
  %i.ap = sext i32 %i.ai to i64                   ; 2 uses
  %i.aq = load i32, ptr %i.o, align 4, !tbaa !20, !noalias !71
  %i.ar = load ptr, ptr %4, align 8, !tbaa !21, !noalias !71
  %i.as = load i64, ptr %i.p, align 8, !tbaa !22, !noalias !71
  %i.at = mul i64 %i.as, %indvars.iv1660
  %i.au = load i64, ptr %i.q, align 8, !tbaa !23, !noalias !71 ; 3 uses
  %i.av = mul i64 %i.at, %i.au
  %i.aw = getelementptr inbounds nuw i8, ptr %i.ar, i64 %i.av ; 12 uses
  %i.ax = sext i32 %i.aq to i64                   ; 2 uses
  %i.ay = load i32, ptr %i.r, align 4, !tbaa !20, !noalias !72
  %i.az = load ptr, ptr %5, align 8, !tbaa !21, !noalias !72
  %i.ba = load i64, ptr %i.s, align 8, !tbaa !22, !noalias !72
  %i.bb = mul i64 %i.ba, %indvars.iv1660
  %i.bc = load i64, ptr %i.t, align 8, !tbaa !23, !noalias !72 ; 2 uses
  %i.bd = mul i64 %i.bb, %i.bc
  %i.be = getelementptr inbounds nuw i8, ptr %i.az, i64 %i.bd ; 6 uses
  %i.bf = sext i32 %i.ay to i64
  %i.bg = load ptr, ptr %6, align 8, !tbaa !21
  %i.bh = load i32, ptr %i.u, align 4, !tbaa !20
  %i.bi = sext i32 %i.bh to i64
  %i.bj = mul nsw i64 %indvars.iv1660, %i.bi
  %i.bk = load i64, ptr %i.v, align 8, !tbaa !23
  %i.bl = mul i64 %i.bj, %i.bk
  %i.bm = getelementptr inbounds nuw i8, ptr %i.bg, i64 %i.bl ; 9 uses
  %i.bn = load ptr, ptr %7, align 8, !tbaa !21
  %i.bo = load i32, ptr %i.w, align 4, !tbaa !20
  %i.bp = sext i32 %i.bo to i64
  %i.bq = mul nsw i64 %indvars.iv1660, %i.bp
  %i.br = load i64, ptr %i.x, align 8, !tbaa !23
  %i.bs = mul i64 %i.bq, %i.br
  %i.bt = getelementptr inbounds nuw i8, ptr %i.bn, i64 %i.bs ; 9 uses
  %i.bu = load i32, ptr %i.y, align 4, !tbaa !20, !noalias !73
  %i.bv = load ptr, ptr %8, align 8, !tbaa !21, !noalias !73
  %i.bw = load i64, ptr %i.z, align 8, !tbaa !22, !noalias !73
  %i.bx = mul i64 %i.bw, %indvars.iv1660
  %i.by = load i64, ptr %i.aa, align 8, !tbaa !23, !noalias !73 ; 3 uses
  %i.bz = mul i64 %i.bx, %i.by
  %i.ca = getelementptr inbounds nuw i8, ptr %i.bv, i64 %i.bz ; 2 uses
  %i.cb = sext i32 %i.bu to i64                   ; 2 uses
  %i.cc = load ptr, ptr %9, align 8, !tbaa !21, !noalias !74
  %i.cd = load i64, ptr %i.ab, align 8, !tbaa !22, !noalias !74
  %i.ce = mul i64 %i.cd, %indvars.iv1660
  %i.cf = load i64, ptr %i.ac, align 8, !tbaa !23, !noalias !74
  %i.cg = mul i64 %i.ce, %i.cf
  %i.ch = getelementptr inbounds nuw i8, ptr %i.cc, i64 %i.cg ; 2 uses
  %i.ci = load i32, ptr %i.ad, align 4, !tbaa !20, !noalias !75
  %i.cj = load ptr, ptr %10, align 8, !tbaa !21, !noalias !75
  %i.ck = load i64, ptr %i.ae, align 8, !tbaa !22, !noalias !75
  %i.cl = mul i64 %i.ck, %indvars.iv1660
  %i.cm = load i64, ptr %i.af, align 8, !tbaa !23, !noalias !75 ; 3 uses
...
bb.c:                                             ; preds = %.lr.ph1446, %._crit_edge1443
  ...
  store float %i.eg, ptr %i.eh, align 4, !tbaa !25
  ...
  %i.eq = shl nuw nsw i32 %i.dj, 1
  %i.er = add nuw nsw i32 %i.eq, %i.el            ; 2 uses
  %14 = zext nneg i32 %i.er to i64                ; 2 uses
  %i.es = mul i64 %i.cx, %14
  %i.et = getelementptr inbounds nuw i8, ptr %i.ao, i64 %i.es ; 9 uses
  %i.eu = mul nuw nsw i32 %i.dj, 3
  %i.ev = add nuw nsw i32 %i.eu, %i.el            ; 2 uses
  %15 = zext nneg i32 %i.ev to i64                ; 2 uses
  ...
  %16 = zext nneg i32 %i.fe to i64                ; 2 uses
  %i.ff = mul i64 %i.cx, %16
  %i.fg = getelementptr inbounds nuw i8, ptr %i.ao, i64 %i.ff ; 9 uses
  %i.fh = add nuw nsw i32 %i.ev, 1
  %17 = zext nneg i32 %i.fh to i64                ; 2 uses
  ...
  %i.gf = load i32, ptr %12, align 4, !tbaa !11   ; 2 uses
...
.lr.ph:                                           ; preds = %bb.c, %.lr.ph
  ...
  %i.gm = load <2 x i64>, ptr %i.gl, align 1, !tbaa !26
  store <2 x i64> %i.gm, ptr %.09561371, align 1, !tbaa !26
  %i.gn = getelementptr inbounds nuw i8, ptr %.09561371, i64 16
  %i.go = getelementptr inbounds nuw i8, ptr %i.ez, i64 %indvars.iv
  %i.gp = load <2 x i64>, ptr %i.go, align 1, !tbaa !26
  store <2 x i64> %i.gp, ptr %i.gn, align 1, !tbaa !26
  %i.gq = getelementptr inbounds nuw i8, ptr %.09561371, i64 32 ; 2 uses
  %i.gr = getelementptr inbounds nuw i8, ptr %i.ep, i64 %indvars.iv
  %i.gs = load <2 x i64>, ptr %i.gr, align 1, !tbaa !26
  store <2 x i64> %i.gs, ptr %i.gq, align 1, !tbaa !26
  %i.gt = getelementptr inbounds nuw i8, ptr %.09561371, i64 48
  %i.gu = getelementptr inbounds nuw i8, ptr %i.fd, i64 %indvars.iv
  %i.gv = load <2 x i64>, ptr %i.gu, align 1, !tbaa !26
  store <2 x i64> %i.gv, ptr %i.gt, align 1, !tbaa !26
  %i.gw = getelementptr inbounds nuw i8, ptr %.09561371, i64 64 ; 2 uses
  %i.gx = getelementptr inbounds nuw i8, ptr %i.et, i64 %indvars.iv
  %i.gy = load <2 x i64>, ptr %i.gx, align 1, !tbaa !26
  store <2 x i64> %i.gy, ptr %i.gw, align 1, !tbaa !26
  %i.gz = getelementptr inbounds nuw i8, ptr %.09561371, i64 80
  %i.ha = getelementptr inbounds nuw i8, ptr %i.fg, i64 %indvars.iv
  %i.hb = load <2 x i64>, ptr %i.ha, align 1, !tbaa !26
  store <2 x i64> %i.hb, ptr %i.gz, align 1, !tbaa !26
  %i.hc = getelementptr inbounds nuw i8, ptr %.09561371, i64 96 ; 2 uses
  %i.hd = getelementptr inbounds nuw i8, ptr %i.ex, i64 %indvars.iv
  %i.he = load <2 x i64>, ptr %i.hd, align 1, !tbaa !26
  store <2 x i64> %i.he, ptr %i.hc, align 1, !tbaa !26
  %i.hf = getelementptr inbounds nuw i8, ptr %.09561371, i64 112
  %i.hg = getelementptr inbounds nuw i8, ptr %i.fj, i64 %indvars.iv
  %i.hh = load <2 x i64>, ptr %i.hg, align 1, !tbaa !26
  store <2 x i64> %i.hh, ptr %i.hf, align 1, !tbaa !26
  %i.hi = load <32 x i8>, ptr %.09561371, align 1, !tbaa !26
  %i.hj = load <32 x i8>, ptr %i.gq, align 1, !tbaa !26
  %i.hk = load <32 x i8>, ptr %i.gw, align 1, !tbaa !26
  %i.hl = load <32 x i8>, ptr %i.hc, align 1, !tbaa !26
  ...
  %i.hs = load i32, ptr %12, align 4, !tbaa !11   ; 2 uses
  %i.ht = sext i32 %i.hs to i64
  %i.hu = icmp slt i64 %i.hr, %i.ht
  br i1 %i.hu, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !48
...
.lr.ph1381:                                       ; preds = %.lr.ph1381.preheader, %.lr.ph1381
  ...
  %i.is = load i64, ptr %i.ir, align 1, !tbaa !26
  store i64 %i.is, ptr %i.iq, align 1, !tbaa !26
  %i.it = getelementptr inbounds nuw i8, ptr %.19571378, i64 40
  %i.iu = getelementptr inbounds nuw i8, ptr %i.ex, i64 %indvars.iv1597
  %i.iv = load i64, ptr %i.iu, align 1, !tbaa !26
  store i64 %i.iv, ptr %i.it, align 1, !tbaa !26
  %i.iw = getelementptr inbounds nuw i8, ptr %.19571378, i64 48
  %i.ix = getelementptr inbounds nuw i8, ptr %i.fg, i64 %indvars.iv1597
  %i.iy = load i64, ptr %i.ix, align 1, !tbaa !26
  store i64 %i.iy, ptr %i.iw, align 1, !tbaa !26
  %i.iz = getelementptr inbounds nuw i8, ptr %.19571378, i64 56
  %i.ja = getelementptr inbounds nuw i8, ptr %i.fj, i64 %indvars.iv1597
  %i.jb = load i64, ptr %i.ja, align 1, !tbaa !26
  store i64 %i.jb, ptr %i.iz, align 1, !tbaa !26
  %i.jc = load <32 x i8>, ptr %.19571378, align 1, !tbaa !26
  %i.jd = load <32 x i8>, ptr %i.iq, align 1, !tbaa !26
  ...
  %i.jh = load i32, ptr %12, align 4, !tbaa !11   ; 2 uses
  %i.ji = trunc i64 %indvars.iv.next1598 to i32
  %i.jj = or i32 %i.ji, 7
  %i.jk = icmp slt i32 %i.jj, %i.jh
  br i1 %i.jk, label %.lr.ph1381, label %._crit_edge1382.loopexit, !llvm.loop !49
