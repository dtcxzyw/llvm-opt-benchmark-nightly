...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %13 = fadd fast <8 x float> %i.do, %vec.phi
  %14 = fadd fast <8 x float> %i.dp, %vec.phi194
  %15 = fadd fast <8 x float> %13, %i.ds
  %16 = fadd fast <8 x float> %14, %i.dt
  %i.ec = fadd fast <8 x float> %15, %i.dw
  %i.ed = fadd fast <8 x float> %16, %i.dx
  %i.ee = fadd fast <8 x float> %i.ec, %i.ea      ; 2 uses
  %i.ef = fadd fast <8 x float> %i.ed, %i.eb      ; 2 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %17 = fadd fast <4 x float> %i.ev, %vec.phi228
  %18 = fadd fast <4 x float> %17, %i.ex
  %i.fc = fadd fast <4 x float> %18, %i.ez
  %i.fd = fadd fast <4 x float> %i.fc, %i.fb      ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %10 = fadd fast <8 x float> %i.ch, %vec.phi
  %11 = fadd fast <8 x float> %i.ci, %vec.phi175
  %12 = fadd fast <8 x float> %10, %i.cl
  %13 = fadd fast <8 x float> %11, %i.cm
  %i.cv = fadd fast <8 x float> %12, %i.cp
  %i.cw = fadd fast <8 x float> %13, %i.cq
  %i.cx = fadd fast <8 x float> %i.cv, %i.ct      ; 2 uses
  %i.cy = fadd fast <8 x float> %i.cw, %i.cu      ; 2 uses
  %index.next = add nuw i64 %index, 16            ; 2 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %14 = fadd fast <4 x float> %i.do, %vec.phi209
  %15 = fadd fast <4 x float> %14, %i.dq
  %i.dv = fadd fast <4 x float> %15, %i.ds
  %i.dw = fadd fast <4 x float> %i.dv, %i.du      ; 2 uses
