...
bb.w:                                             ; preds = %bb.v
  ...
  %i.bw = load ptr, ptr %i.bv, align 8, !tbaa !23 ; 3 uses
  %.not3.i6 = icmp eq ptr %i.bw, null
  %i.bx = load ptr, ptr %i.q, align 8, !tbaa !24  ; 3 uses
  br i1 %.not3.i6, label %bb.y, label %bb.x

bb.x:                                             ; preds = %bb.w
  %i.by = load ptr, ptr %i.bw, align 8, !tbaa !16
  %i.bz = getelementptr inbounds nuw i8, ptr %i.by, i64 24
  %i.ca = load ptr, ptr %i.bz, align 8
  call void %i.ca(ptr noundef nonnull align 8 dereferenceable(8) %i.bw, ptr noundef %i.bx), !inline_history !0
...
bb.ab:                                            ; preds = %bb.aa
  ...
  %i.ci = load ptr, ptr %i.ch, align 8, !tbaa !23 ; 3 uses
  %.not3.i = icmp eq ptr %i.ci, null
  %i.cj = load ptr, ptr %i.s, align 8, !tbaa !24  ; 3 uses
  br i1 %.not3.i, label %bb.ad, label %bb.ac

bb.ac:                                            ; preds = %bb.ab
  %i.ck = load ptr, ptr %i.ci, align 8, !tbaa !16
  %i.cl = getelementptr inbounds nuw i8, ptr %i.ck, i64 24
  %i.cm = load ptr, ptr %i.cl, align 8
  call void %i.cm(ptr noundef nonnull align 8 dereferenceable(8) %i.ci, ptr noundef %i.cj), !inline_history !0
...
.noexc231.lr.ph:                                  ; preds = %bb.b
  ...
  %i.n = load i32, ptr %i.m, align 4, !tbaa !63, !noalias !221
  %i.o = load ptr, ptr %i.l, align 8, !tbaa !24, !noalias !221 ; 20 uses
  %i.p = getelementptr inbounds nuw i8, ptr %3, i64 368
  %i.q = load i64, ptr %i.p, align 8, !tbaa !25, !noalias !221 ; 5 uses
  %i.r = getelementptr inbounds nuw i8, ptr %3, i64 320
  %i.s = load i64, ptr %i.r, align 8, !tbaa !57, !noalias !221 ; 29 uses
  ...
  %i.w = load i32, ptr %i.v, align 4, !tbaa !63, !noalias !222
  %i.x = load ptr, ptr %i.u, align 8, !tbaa !24, !noalias !222
  %i.y = getelementptr inbounds nuw i8, ptr %3, i64 440
  %i.z = load i64, ptr %i.y, align 8, !tbaa !25, !noalias !222
  %i.aa = getelementptr inbounds nuw i8, ptr %3, i64 392
  %i.ab = load i64, ptr %i.aa, align 8, !tbaa !57, !noalias !222 ; 2 uses
  ...
  %i.af = load i32, ptr %i.ae, align 4, !tbaa !63, !noalias !223
  %i.ag = load ptr, ptr %i.ad, align 8, !tbaa !24, !noalias !223 ; 20 uses
  %i.ah = getelementptr inbounds nuw i8, ptr %3, i64 296
  %i.ai = load i64, ptr %i.ah, align 8, !tbaa !25, !noalias !223 ; 5 uses
  %i.aj = getelementptr inbounds nuw i8, ptr %3, i64 248
  %i.ak = load i64, ptr %i.aj, align 8, !tbaa !57, !noalias !223 ; 29 uses
  ...
  %i.ao = load i32, ptr %i.an, align 4, !tbaa !63, !noalias !224
  %i.ap = load ptr, ptr %i.am, align 8, !tbaa !24, !noalias !224 ; 2 uses
  %i.aq = getelementptr inbounds nuw i8, ptr %3, i64 728
  %i.ar = load i64, ptr %i.aq, align 8, !tbaa !25, !noalias !224 ; 3 uses
  %i.as = getelementptr inbounds nuw i8, ptr %3, i64 680
  %i.at = load i64, ptr %i.as, align 8, !tbaa !57, !noalias !224 ; 6 uses
  %factor.op.mul417 = mul i64 %i.ar, %i.at
  %i.au = sext i32 %i.ao to i64                   ; 4 uses
  %i.av = getelementptr inbounds nuw i8, ptr %3, i64 736
  %i.aw = load ptr, ptr %i.av, align 8, !tbaa !24, !noalias !225
  %i.ax = getelementptr inbounds nuw i8, ptr %3, i64 800
  %i.ay = load i64, ptr %i.ax, align 8, !tbaa !25, !noalias !225
  %i.az = getelementptr inbounds nuw i8, ptr %3, i64 752
  %i.ba = load i64, ptr %i.az, align 8, !tbaa !57, !noalias !225
  ...
  %i.bd = load i32, ptr %i.bc, align 4, !tbaa !63, !noalias !226
  %i.be = load ptr, ptr %i.bb, align 8, !tbaa !24, !noalias !226 ; 2 uses
  %i.bf = getelementptr inbounds nuw i8, ptr %3, i64 872
  %i.bg = load i64, ptr %i.bf, align 8, !tbaa !25, !noalias !226 ; 3 uses
  %i.bh = getelementptr inbounds nuw i8, ptr %3, i64 824
  %i.bi = load i64, ptr %i.bh, align 8, !tbaa !57, !noalias !226 ; 6 uses
  ...
  %i.bo = load i32, ptr %i.bn, align 4, !tbaa !45 ; 6 uses
...
.lr.ph396:                                        ; preds = %.noexc231
  ...
  %i.ly = load i32, ptr %4, align 4, !tbaa !43    ; 3 uses
  %i.lz = icmp sgt i32 %i.ly, 0
  %i.ma = load i32, ptr %i.bw, align 8, !tbaa !46 ; 3 uses
...
.lr.ph409:                                        ; preds = %.preheader388
  %i.mk = load i32, ptr %4, align 4, !tbaa !43    ; 3 uses
  %i.ml = icmp sgt i32 %i.mk, 0
  %i.mm = load i32, ptr %i.bw, align 8, !tbaa !46 ; 3 uses
...
bb.c:                                             ; preds = %.lr.ph396, %._crit_edge
  ...
  store float %i.oh, ptr %i.oi, align 4, !tbaa !61
...
vector.body715:                                   ; preds = %vector.body715, %vector.ph713
  ...
  %wide.load718 = load <8 x float>, ptr %i.qd, align 4, !tbaa !61, !alias.scope !227
  %i.qe = getelementptr inbounds nuw [4 x i8], ptr %i.oo, i64 %index716
  %wide.load719 = load <8 x float>, ptr %i.qe, align 4, !tbaa !61, !alias.scope !228
  %i.qf = getelementptr inbounds nuw [4 x i8], ptr %i.or, i64 %index716
  %wide.load720 = load <8 x float>, ptr %i.qf, align 4, !tbaa !61, !alias.scope !229
  %i.qg = getelementptr inbounds nuw [4 x i8], ptr %i.ou, i64 %index716
  %wide.load721 = load <8 x float>, ptr %i.qg, align 4, !tbaa !61, !alias.scope !230
  %i.qh = getelementptr inbounds nuw [4 x i8], ptr %i.ow, i64 %index716
  %wide.load722 = load <8 x float>, ptr %i.qh, align 4, !tbaa !61, !alias.scope !231
  %i.qi = getelementptr inbounds nuw [4 x i8], ptr %i.oz, i64 %index716
  %wide.load723 = load <8 x float>, ptr %i.qi, align 4, !tbaa !61, !alias.scope !232
  %i.qj = getelementptr inbounds nuw [4 x i8], ptr %i.pc, i64 %index716
  %wide.load724 = load <8 x float>, ptr %i.qj, align 4, !tbaa !61, !alias.scope !233
  %i.qk = getelementptr inbounds nuw [4 x i8], ptr %i.pf, i64 %index716
  %wide.load725 = load <8 x float>, ptr %i.qk, align 4, !tbaa !61, !alias.scope !234
  ...
  br i1 %i.qr, label %middle.block728, label %vector.body715, !llvm.loop !189
...
vector.body621:                                   ; preds = %vector.body621, %vector.ph619
  ...
  %wide.load624 = load <8 x float>, ptr %i.qu, align 4, !tbaa !61, !alias.scope !237
  %i.qv = getelementptr inbounds nuw [4 x i8], ptr %i.pj, i64 %index622
  %wide.load625 = load <8 x float>, ptr %i.qv, align 4, !tbaa !61, !alias.scope !238
  %i.qw = getelementptr inbounds nuw [4 x i8], ptr %i.pl, i64 %index622
  %wide.load626 = load <8 x float>, ptr %i.qw, align 4, !tbaa !61, !alias.scope !239
  %i.qx = getelementptr inbounds nuw [4 x i8], ptr %i.pn, i64 %index622
  %wide.load627 = load <8 x float>, ptr %i.qx, align 4, !tbaa !61, !alias.scope !240
  %i.qy = getelementptr inbounds nuw [4 x i8], ptr %i.pp, i64 %index622
  %wide.load628 = load <8 x float>, ptr %i.qy, align 4, !tbaa !61, !alias.scope !241
  %i.qz = getelementptr inbounds nuw [4 x i8], ptr %i.pr, i64 %index622
  %wide.load629 = load <8 x float>, ptr %i.qz, align 4, !tbaa !61, !alias.scope !242
  %i.ra = getelementptr inbounds nuw [4 x i8], ptr %i.pt, i64 %index622
  %wide.load630 = load <8 x float>, ptr %i.ra, align 4, !tbaa !61, !alias.scope !243
  %i.rb = getelementptr inbounds nuw [4 x i8], ptr %i.pv, i64 %index622
  %wide.load631 = load <8 x float>, ptr %i.rb, align 4, !tbaa !61, !alias.scope !244
  ...
  br i1 %i.ri, label %middle.block634, label %vector.body621, !llvm.loop !200
...
.lr.ph:                                           ; preds = %.lr.ph.preheader750, %.lr.ph
  ...
  %i.rk = load float, ptr %i.rj, align 4, !tbaa !61
  store float %i.rk, ptr %.0180389, align 4, !tbaa !61
...
._crit_edge:                                      ; preds = %.lr.ph393, %middle.block634, %.preheader387
  ...
  br i1 %i.sh, label %bb.c, label %.preheader388.loopexit, !llvm.loop !202
...
.lr.ph393:                                        ; preds = %.lr.ph393.preheader749, %.lr.ph393
  ...
  %i.sj = load float, ptr %i.si, align 4, !tbaa !61
  store float %i.sj, ptr %.0179391, align 4, !tbaa !61
  ...
  store float %i.sl, ptr %i.sm, align 4, !tbaa !61
  ...
  store float %i.td, ptr %i.te, align 4, !tbaa !61
...
bb.d:                                             ; preds = %.lr.ph409, %._crit_edge406
  ...
  %i.tv = load float, ptr %i.tu, align 4, !tbaa !61
  store float %i.tv, ptr %.1183407, align 4, !tbaa !61
  ...
  %i.ul = add nuw nsw i64 %indvars.iv443, %5      ; 2 uses
  %i.um = mul i64 %i.bq, %i.ul
  %i.un = getelementptr inbounds nuw i8, ptr %i.ln, i64 %i.um ; 4 uses
  %i.uo = add nuw nsw i64 %indvars.iv443, %6      ; 2 uses
...
vector.body531:                                   ; preds = %vector.body531, %vector.ph529
  ...
  %wide.load534 = load <8 x float>, ptr %i.vl, align 4, !tbaa !61, !alias.scope !247
  %i.vm = getelementptr inbounds nuw [4 x i8], ptr %i.uk, i64 %index532
  %wide.load535 = load <8 x float>, ptr %i.vm, align 4, !tbaa !61, !alias.scope !248
  %i.vn = getelementptr inbounds nuw [4 x i8], ptr %i.un, i64 %index532
  %wide.load536 = load <8 x float>, ptr %i.vn, align 4, !tbaa !61, !alias.scope !249
  %i.vo = getelementptr inbounds nuw [4 x i8], ptr %i.uq, i64 %index532
  %wide.load537 = load <8 x float>, ptr %i.vo, align 4, !tbaa !61, !alias.scope !250
  ...
  br i1 %i.vr, label %middle.block540, label %vector.body531, !llvm.loop !210
...
.lr.ph402.prol:                                   ; preds = %.lr.ph402.preheader748
  ...
  %i.vt = load float, ptr %i.vs, align 4, !tbaa !61
  store float %i.vt, ptr %.0176399.ph, align 4, !tbaa !61
  ...
  store float %i.wb, ptr %i.wc, align 4, !tbaa !61
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <8 x float>, ptr %i.wi, align 4, !tbaa !61, !alias.scope !253
  %i.wj = getelementptr inbounds nuw [4 x i8], ptr %i.uu, i64 %index
  %wide.load488 = load <8 x float>, ptr %i.wj, align 4, !tbaa !61, !alias.scope !254
  %i.wk = getelementptr inbounds nuw [4 x i8], ptr %i.uw, i64 %index
  %wide.load489 = load <8 x float>, ptr %i.wk, align 4, !tbaa !61, !alias.scope !255
  %i.wl = getelementptr inbounds nuw [4 x i8], ptr %i.uy, i64 %index
  %wide.load490 = load <8 x float>, ptr %i.wl, align 4, !tbaa !61, !alias.scope !256
  ...
  br i1 %i.wo, label %middle.block, label %vector.body, !llvm.loop !217
...
.lr.ph405.prol:                                   ; preds = %.lr.ph405.preheader747
  ...
  %i.wq = load float, ptr %i.wp, align 4, !tbaa !61
  store float %i.wq, ptr %.0175403.ph, align 4, !tbaa !61
...
.lr.ph402:                                        ; preds = %.lr.ph402.prol.loopexit, %.lr.ph402
  ...
  %i.xd = load float, ptr %i.xc, align 4, !tbaa !61
  store float %i.xd, ptr %.0176399, align 4, !tbaa !61
