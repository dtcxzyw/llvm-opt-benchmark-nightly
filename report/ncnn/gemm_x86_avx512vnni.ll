...
bb.bd:                                            ; preds = %bb.bc, %.lr.ph2163.i
  %i.cqo = phi <4 x i32> [ %i.cqn, %bb.bc ], [ zeroinitializer, %.lr.ph2163.i ] ; 10 uses
...
vector.ph2129:                                    ; preds = %vector.main.loop.iter.check2127
  ...
  %9 = shufflevector <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, <4 x i32> %i.cqo, <4 x i32> <i32 7, i32 1, i32 2, i32 3>
  %10 = shufflevector <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, <4 x i32> %i.cqo, <4 x i32> <i32 6, i32 1, i32 2, i32 3>
  %11 = shufflevector <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, <4 x i32> %i.cqo, <4 x i32> <i32 5, i32 1, i32 2, i32 3>
  %12 = shufflevector <4 x i32> %i.cqo, <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, <4 x i32> <i32 0, i32 5, i32 6, i32 7>
...
vector.body2131:                                  ; preds = %vector.body2131, %vector.ph2129
  ...
  %vec.phi2148 = phi <4 x i32> [ %9, %vector.ph2129 ], [ %partial.reduce2187, %vector.body2131 ]
  %vec.phi2149 = phi <4 x i32> [ %10, %vector.ph2129 ], [ %partial.reduce2183, %vector.body2131 ]
  %vec.phi2150 = phi <4 x i32> [ %11, %vector.ph2129 ], [ %partial.reduce2179, %vector.body2131 ]
  %vec.phi2151 = phi <4 x i32> [ %12, %vector.ph2129 ], [ %partial.reduce2175, %vector.body2131 ]
  ...
  %13 = sext <16 x i8> %strided.vec2140 to <16 x i32> ; 2 uses
  %i.cqw = mul nsw <16 x i32> %i.cqv, %13
  %partial.reduce2172 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %vec.phi2151, <16 x i32> %i.cqw)
  %14 = zext <16 x i8> %strided.vec2150 to <16 x i32> ; 2 uses
  %15 = sext <16 x i8> %strided.vec2141 to <16 x i32> ; 2 uses
  %i.cqx = mul nsw <16 x i32> %14, %15
  %partial.reduce2173 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce2172, <16 x i32> %i.cqx)
  %16 = zext <16 x i8> %strided.vec2151 to <16 x i32> ; 2 uses
  %17 = sext <16 x i8> %strided.vec2142 to <16 x i32> ; 2 uses
  %i.cqy = mul nsw <16 x i32> %16, %17
  %partial.reduce2174 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce2173, <16 x i32> %i.cqy)
  %18 = zext <16 x i8> %strided.vec2152 to <16 x i32> ; 2 uses
  %19 = sext <16 x i8> %strided.vec2143 to <16 x i32> ; 2 uses
  %i.cqz = mul nsw <16 x i32> %18, %19
  %partial.reduce2175 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce2174, <16 x i32> %i.cqz) ; 2 uses
  %i.cra = zext <16 x i8> %strided.vec2153 to <16 x i32> ; 2 uses
  %i.crb = mul nsw <16 x i32> %i.cra, %13
  %partial.reduce2176 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %vec.phi2150, <16 x i32> %i.crb)
  %i.crc = zext <16 x i8> %strided.vec2154 to <16 x i32> ; 2 uses
  %i.crd = mul nsw <16 x i32> %i.crc, %15
  %partial.reduce2177 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce2176, <16 x i32> %i.crd)
  %i.cre = zext <16 x i8> %strided.vec2155 to <16 x i32> ; 2 uses
  %i.crf = mul nsw <16 x i32> %i.cre, %17
  %partial.reduce2178 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce2177, <16 x i32> %i.crf)
  %i.crg = zext <16 x i8> %strided.vec2156 to <16 x i32> ; 2 uses
  %i.crh = mul nsw <16 x i32> %i.crg, %19
  %partial.reduce2179 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce2178, <16 x i32> %i.crh) ; 2 uses
  %i.cri = sext <16 x i8> %strided.vec2144 to <16 x i32> ; 2 uses
  %i.crj = mul nsw <16 x i32> %i.cri, %i.cqv
  %partial.reduce2180 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %vec.phi2149, <16 x i32> %i.crj)
  %i.crk = sext <16 x i8> %strided.vec2145 to <16 x i32> ; 2 uses
  %i.crl = mul nsw <16 x i32> %i.crk, %14
  %partial.reduce2181 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce2180, <16 x i32> %i.crl)
  %i.crm = sext <16 x i8> %strided.vec2146 to <16 x i32> ; 2 uses
  %i.crn = mul nsw <16 x i32> %i.crm, %16
  %partial.reduce2182 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce2181, <16 x i32> %i.crn)
  %i.cro = sext <16 x i8> %strided.vec2147 to <16 x i32> ; 2 uses
  %i.crp = mul nsw <16 x i32> %i.cro, %18
  %partial.reduce2183 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce2182, <16 x i32> %i.crp) ; 2 uses
  %i.crq = mul nsw <16 x i32> %i.cri, %i.cra
  %partial.reduce2184 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %vec.phi2148, <16 x i32> %i.crq)
  %i.crr = mul nsw <16 x i32> %i.crk, %i.crc
  %partial.reduce2185 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce2184, <16 x i32> %i.crr)
  %i.crs = mul nsw <16 x i32> %i.crm, %i.cre
  %partial.reduce2186 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce2185, <16 x i32> %i.crs)
  %i.crt = mul nsw <16 x i32> %i.cro, %i.crg
  %partial.reduce2187 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce2186, <16 x i32> %i.crt) ; 2 uses
...
middle.block2158:                                 ; preds = %vector.body2131
  %i.crv = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %partial.reduce2187) ; 2 uses
  %i.crw = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %partial.reduce2183) ; 2 uses
  %i.crx = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %partial.reduce2179) ; 2 uses
  %i.cry = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %partial.reduce2175) ; 2 uses
...
vector.ph1880:                                    ; preds = %vector.main.loop.iter.check1878
  ...
  %20 = shufflevector <2 x i32> %i.dga, <2 x i32> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 2 uses
  %21 = shufflevector <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, <4 x i32> %20, <4 x i32> <i32 5, i32 1, i32 2, i32 3>
  %22 = shufflevector <4 x i32> %20, <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, <4 x i32> <i32 0, i32 5, i32 6, i32 7>
...
vector.body1882:                                  ; preds = %vector.body1882, %vector.ph1880
  ...
  %vec.phi1884 = phi <4 x i32> [ %21, %vector.ph1880 ], [ %partial.reduce1933, %vector.body1882 ]
  %vec.phi1885 = phi <4 x i32> [ zeroinitializer, %vector.ph1880 ], [ %partial.reduce1934, %vector.body1882 ]
  %vec.phi1886 = phi <4 x i32> [ %22, %vector.ph1880 ], [ %partial.reduce1925, %vector.body1882 ]
  %vec.phi1887 = phi <4 x i32> [ zeroinitializer, %vector.ph1880 ], [ %partial.reduce1926, %vector.body1882 ]
  ...
  %i.dgi = zext <16 x i8> %strided.vec1911 to <16 x i32> ; 2 uses
  %23 = sext <16 x i8> %strided.vec1893 to <16 x i32>
  %i.dgj = mul nsw <16 x i32> %i.dgi, %23
  %partial.reduce = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %vec.phi1886, <16 x i32> %i.dgj)
  %24 = zext <16 x i8> %strided.vec1916 to <16 x i32> ; 2 uses
  %i.dgk = sext <16 x i8> %strided.vec1902 to <16 x i32>
  %25 = mul nsw <16 x i32> %24, %i.dgk
  %partial.reduce1920 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %vec.phi1887, <16 x i32> %25)
  %i.dgl = zext <16 x i8> %strided.vec1912 to <16 x i32> ; 2 uses
  %26 = sext <16 x i8> %strided.vec1894 to <16 x i32>
  %i.dgm = mul nsw <16 x i32> %i.dgl, %26
  %partial.reduce1921 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce, <16 x i32> %i.dgm)
  %27 = zext <16 x i8> %strided.vec1917 to <16 x i32> ; 2 uses
  %i.dgn = sext <16 x i8> %strided.vec1903 to <16 x i32>
  %28 = mul nsw <16 x i32> %27, %i.dgn
  %partial.reduce1922 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce1920, <16 x i32> %28)
  %i.dgo = zext <16 x i8> %strided.vec1913 to <16 x i32> ; 2 uses
  %29 = sext <16 x i8> %strided.vec1895 to <16 x i32>
  %i.dgp = mul nsw <16 x i32> %i.dgo, %29
  %partial.reduce1923 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce1921, <16 x i32> %i.dgp)
  %30 = zext <16 x i8> %strided.vec1918 to <16 x i32> ; 2 uses
  %i.dgq = sext <16 x i8> %strided.vec1904 to <16 x i32>
  %31 = mul nsw <16 x i32> %30, %i.dgq
  %partial.reduce1924 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce1922, <16 x i32> %31)
  %i.dgr = zext <16 x i8> %strided.vec1914 to <16 x i32> ; 2 uses
  %32 = sext <16 x i8> %strided.vec1896 to <16 x i32>
  %i.dgs = mul nsw <16 x i32> %i.dgr, %32
  %partial.reduce1925 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce1923, <16 x i32> %i.dgs) ; 2 uses
  %33 = zext <16 x i8> %strided.vec1919 to <16 x i32> ; 2 uses
  %i.dgt = sext <16 x i8> %strided.vec1905 to <16 x i32>
  %34 = mul nsw <16 x i32> %33, %i.dgt
  %partial.reduce1926 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce1924, <16 x i32> %34) ; 2 uses
  %i.dgu = sext <16 x i8> %strided.vec1897 to <16 x i32>
  %i.dgv = mul nsw <16 x i32> %i.dgu, %i.dgi
  %partial.reduce1927 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %vec.phi1884, <16 x i32> %i.dgv)
  %35 = sext <16 x i8> %strided.vec1906 to <16 x i32>
  %36 = mul nsw <16 x i32> %35, %24
  %partial.reduce1928 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %vec.phi1885, <16 x i32> %36)
  %i.dgw = sext <16 x i8> %strided.vec1898 to <16 x i32>
  %i.dgx = mul nsw <16 x i32> %i.dgw, %i.dgl
  %partial.reduce1929 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce1927, <16 x i32> %i.dgx)
  %37 = sext <16 x i8> %strided.vec1907 to <16 x i32>
  %38 = mul nsw <16 x i32> %37, %27
  %partial.reduce1930 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce1928, <16 x i32> %38)
  %i.dgy = sext <16 x i8> %strided.vec1899 to <16 x i32>
  %i.dgz = mul nsw <16 x i32> %i.dgy, %i.dgo
  %partial.reduce1931 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce1929, <16 x i32> %i.dgz)
  %39 = sext <16 x i8> %strided.vec1908 to <16 x i32>
  %40 = mul nsw <16 x i32> %39, %30
  %partial.reduce1932 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce1930, <16 x i32> %40)
  %i.dha = sext <16 x i8> %strided.vec1900 to <16 x i32>
  %i.dhb = mul nsw <16 x i32> %i.dha, %i.dgr
  %partial.reduce1933 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce1931, <16 x i32> %i.dhb) ; 2 uses
  %41 = sext <16 x i8> %strided.vec1909 to <16 x i32>
  %42 = mul nsw <16 x i32> %41, %33
  %partial.reduce1934 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce1932, <16 x i32> %42) ; 2 uses
...
middle.block1921:                                 ; preds = %vector.body1882
  %bin.rdx1937 = add <4 x i32> %partial.reduce1934, %partial.reduce1933
  %i.dhd = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx1937) ; 2 uses
  %bin.rdx1938 = add <4 x i32> %partial.reduce1926, %partial.reduce1925
  %i.dhe = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx1938) ; 2 uses
...
vector.ph2503:                                    ; preds = %vector.main.loop.iter.check2501
  ...
  %43 = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %.01814.i, i64 0
  %44 = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %.01819.i, i64 0
...
vector.body2505:                                  ; preds = %vector.body2505, %vector.ph2503
  ...
  %vec.phi2546 = phi <4 x i32> [ %43, %vector.ph2503 ], [ %partial.reduce2596, %vector.body2505 ]
  %vec.phi2547 = phi <4 x i32> [ zeroinitializer, %vector.ph2503 ], [ %partial.reduce2597, %vector.body2505 ]
  %vec.phi2548 = phi <4 x i32> [ %44, %vector.ph2503 ], [ %partial.reduce2588, %vector.body2505 ]
  %vec.phi2549 = phi <4 x i32> [ zeroinitializer, %vector.ph2503 ], [ %partial.reduce2589, %vector.body2505 ]
  ...
  %i.egv = zext <16 x i8> %strided.vec2526 to <16 x i32>
  %45 = sext <16 x i8> %strided.vec2516 to <16 x i32> ; 2 uses
  %i.egw = mul nsw <16 x i32> %i.egv, %45
  %partial.reduce2582 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %vec.phi2548, <16 x i32> %i.egw)
  %46 = zext <16 x i8> %strided.vec2535 to <16 x i32>
  %i.egx = sext <16 x i8> %strided.vec2521 to <16 x i32> ; 2 uses
  %47 = mul nsw <16 x i32> %46, %i.egx
  %partial.reduce2583 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %vec.phi2549, <16 x i32> %47)
  %i.egy = zext <16 x i8> %strided.vec2527.a to <16 x i32>
  %48 = sext <16 x i8> %strided.vec2517 to <16 x i32> ; 2 uses
  %i.egz = mul nsw <16 x i32> %i.egy, %48
  %partial.reduce2584 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce2582, <16 x i32> %i.egz)
  %49 = zext <16 x i8> %strided.vec2536 to <16 x i32>
  %i.eha = sext <16 x i8> %strided.vec2522 to <16 x i32> ; 2 uses
  %50 = mul nsw <16 x i32> %49, %i.eha
  %partial.reduce2585 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce2583, <16 x i32> %50)
  %i.ehb = zext <16 x i8> %strided.vec2528.a to <16 x i32>
  %51 = sext <16 x i8> %strided.vec2518 to <16 x i32> ; 2 uses
  %i.ehc = mul nsw <16 x i32> %i.ehb, %51
  %partial.reduce2586 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce2584, <16 x i32> %i.ehc)
  %52 = zext <16 x i8> %strided.vec2537 to <16 x i32>
  %i.ehd = sext <16 x i8> %strided.vec2523 to <16 x i32> ; 2 uses
  %53 = mul nsw <16 x i32> %52, %i.ehd
  %partial.reduce2587 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce2585, <16 x i32> %53)
  %i.ehe = zext <16 x i8> %strided.vec2529.a to <16 x i32>
  %54 = sext <16 x i8> %strided.vec2519 to <16 x i32> ; 2 uses
  %i.ehf = mul nsw <16 x i32> %i.ehe, %54
  %partial.reduce2588 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce2586, <16 x i32> %i.ehf) ; 2 uses
  %55 = zext <16 x i8> %strided.vec2538 to <16 x i32>
  %56 = sext <16 x i8> %strided.vec2524.a to <16 x i32> ; 2 uses
  %57 = mul nsw <16 x i32> %55, %56
  %partial.reduce2589 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce2587, <16 x i32> %57) ; 2 uses
  %i.ehg = zext <16 x i8> %strided.vec2530.a to <16 x i32>
  %i.ehh = mul nsw <16 x i32> %i.ehg, %45
  %partial.reduce2590 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %vec.phi2546, <16 x i32> %i.ehh)
  %58 = zext <16 x i8> %strided.vec2539 to <16 x i32>
  %59 = mul nsw <16 x i32> %58, %i.egx
  %partial.reduce2591 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %vec.phi2547, <16 x i32> %59)
  %i.ehi = zext <16 x i8> %strided.vec2531 to <16 x i32>
  %i.ehj = mul nsw <16 x i32> %i.ehi, %48
  %partial.reduce2592 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce2590, <16 x i32> %i.ehj)
  %60 = zext <16 x i8> %strided.vec2540 to <16 x i32>
  %61 = mul nsw <16 x i32> %60, %i.eha
  %partial.reduce2593 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce2591, <16 x i32> %61)
  %i.ehk = zext <16 x i8> %strided.vec2532 to <16 x i32>
  %i.ehl = mul nsw <16 x i32> %i.ehk, %51
  %partial.reduce2594 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce2592, <16 x i32> %i.ehl)
  %62 = zext <16 x i8> %strided.vec2541 to <16 x i32>
  %63 = mul nsw <16 x i32> %62, %i.ehd
  %partial.reduce2595 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce2593, <16 x i32> %63)
  %i.ehm = zext <16 x i8> %strided.vec2533 to <16 x i32>
  %i.ehn = mul nsw <16 x i32> %i.ehm, %54
  %partial.reduce2596 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce2594, <16 x i32> %i.ehn) ; 2 uses
  %64 = zext <16 x i8> %strided.vec2542 to <16 x i32>
  %65 = mul nsw <16 x i32> %64, %56
  %partial.reduce2597 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce2595, <16 x i32> %65) ; 2 uses
...
middle.block2544:                                 ; preds = %vector.body2505
  %bin.rdx2600 = add <4 x i32> %partial.reduce2597, %partial.reduce2596
  %i.ehp = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx2600) ; 3 uses
  %bin.rdx2601 = add <4 x i32> %partial.reduce2589, %partial.reduce2588
  %i.ehq = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx2601) ; 3 uses
...
vector.ph2263:                                    ; preds = %vector.main.loop.iter.check2261
  ...
  %66 = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %.01793.i, i64 0
...
vector.body2265:                                  ; preds = %vector.body2265, %vector.ph2263
  ...
  %vec.phi2298 = phi <4 x i32> [ %66, %vector.ph2263 ], [ %partial.reduce2330, %vector.body2265 ]
  %vec.phi2299 = phi <4 x i32> [ zeroinitializer, %vector.ph2263 ], [ %partial.reduce2331, %vector.body2265 ]
  ...
  %67 = sext <16 x i8> %strided.vec2274 to <16 x i32>
  %68 = mul nsw <16 x i32> %i.ess, %67
  %partial.reduce2324 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %vec.phi2298, <16 x i32> %68)
  %i.est = zext <16 x i8> %strided.vec2289 to <16 x i32>
  %69 = sext <16 x i8> %strided.vec2279 to <16 x i32>
  %i.esu = mul nsw <16 x i32> %i.est, %69
  %partial.reduce2325 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %vec.phi2299, <16 x i32> %i.esu)
  %70 = zext <16 x i8> %strided.vec2285 to <16 x i32>
  %i.esv = sext <16 x i8> %strided.vec2275 to <16 x i32>
  %71 = mul nsw <16 x i32> %70, %i.esv
  %partial.reduce2326 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce2324, <16 x i32> %71)
  %i.esw = zext <16 x i8> %strided.vec2290 to <16 x i32>
  %72 = sext <16 x i8> %strided.vec2280 to <16 x i32>
  %i.esx = mul nsw <16 x i32> %i.esw, %72
  %partial.reduce2327 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce2325, <16 x i32> %i.esx)
  %73 = zext <16 x i8> %strided.vec2286 to <16 x i32>
  %i.esy = sext <16 x i8> %strided.vec2276 to <16 x i32>
  %74 = mul nsw <16 x i32> %73, %i.esy
  %partial.reduce2328 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce2326, <16 x i32> %74)
  %i.esz = zext <16 x i8> %strided.vec2291 to <16 x i32>
  %75 = sext <16 x i8> %strided.vec2281 to <16 x i32>
  %i.eta = mul nsw <16 x i32> %i.esz, %75
  %partial.reduce2329 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce2327, <16 x i32> %i.eta)
  %76 = zext <16 x i8> %strided.vec2287 to <16 x i32>
  %i.etb = sext <16 x i8> %strided.vec2277 to <16 x i32>
  %77 = mul nsw <16 x i32> %76, %i.etb
  %partial.reduce2330 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce2328, <16 x i32> %77) ; 2 uses
  %i.etc = zext <16 x i8> %strided.vec2292 to <16 x i32>
  %78 = sext <16 x i8> %strided.vec2282 to <16 x i32>
  %i.etd = mul nsw <16 x i32> %i.etc, %78
  %partial.reduce2331 = tail call <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> %partial.reduce2329, <16 x i32> %i.etd) ; 2 uses
...
middle.block2294:                                 ; preds = %vector.body2265
  %bin.rdx2334 = add <4 x i32> %partial.reduce2331, %partial.reduce2330
  %i.etf = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx2334) ; 3 uses
...
; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare <4 x i32> @llvm.vector.partial.reduce.add.v4i32.v16i32(<4 x i32>, <16 x i32>) #5
