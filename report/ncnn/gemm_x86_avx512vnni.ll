...
iter.check2723:                                   ; preds = %._crit_edge2320.i
  %i.ene = sub i32 %i.cdp, %.01805.lcssa3381.i    ; 3 uses
...
.preheader.i:                                     ; preds = %.lr.ph2332.i, %middle.block2710, %vec.epilog.middle.block2744, %._crit_edge2320.i
  ...
  %.11806.lcssa.i = phi i32 [ %.01805.lcssa3381.i, %._crit_edge2320.i ], [ %i.eqi, %vec.epilog.middle.block2744 ], [ %i.enk, %middle.block2710 ], [ %i.ewk, %.lr.ph2332.i ] ; 7 uses
...
iter.check2608:                                   ; preds = %.preheader.i
  ...
  %i.erk = sub i32 %10, %.11806.lcssa.i           ; 3 uses
...
iter.check2385:                                   ; preds = %._crit_edge2386.i
  ...
  %12 = add i32 %smax, -4
  %i.ffg = sub i32 %12, %.01786.lcssa3391.i       ; 3 uses
