...
.lr.ph.preheader:                                 ; preds = %.lr.ph73
  ...
  %i.eb = insertelement <8 x i64> poison, i64 %6, i64 0
  %7 = insertelement <8 x i64> poison, i64 %i.ao, i64 0
  ...
  %i.ep = or <8 x i64> %i.eb, %7
  %i.eq = and <8 x i1> %i.eo, %i.en
  %i.er = icmp slt <8 x i64> %i.ep, zeroinitializer
  %8 = shufflevector <8 x i1> %i.er, <8 x i1> poison, <8 x i32> zeroinitializer
  %rdx.op = or <8 x i1> %8, %i.eq
...
.noexc72.preheader:                               ; preds = %.noexc72.lr.ph
  ...
  %i.do = insertelement <8 x i64> poison, i64 %6, i64 0
  %7 = insertelement <8 x i64> poison, i64 %i.ak, i64 0
  ...
  %i.ec = or <8 x i64> %i.do, %7
  %i.ed = and <8 x i1> %i.eb, %i.ea
  %i.ee = icmp slt <8 x i64> %i.ec, zeroinitializer
  %8 = shufflevector <8 x i1> %i.ee, <8 x i1> poison, <8 x i32> zeroinitializer
  %rdx.op = or <8 x i1> %8, %i.ed
