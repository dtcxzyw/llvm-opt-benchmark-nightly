...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x float>, ptr %i.ed, align 4, !tbaa !61
  %i.ee = fmul fast <4 x float> %wide.load, %i.da
  %i.ef = getelementptr inbounds nuw [4 x i8], ptr %i.cy, i64 %i.eb
  %wide.load151 = load <4 x float>, ptr %i.ef, align 4, !tbaa !61
  ...
  %wide.load152 = load <4 x float>, ptr %i.ei, align 4, !tbaa !61
  ...
  %wide.load153 = load <4 x float>, ptr %i.el, align 4, !tbaa !61
  ...
  store <4 x float> %i.en, ptr %i.eo, align 4, !tbaa !61
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ep = icmp eq i64 %index.next, %n.vec
  br i1 %i.ep, label %middle.block, label %vector.body, !llvm.loop !121
...
.lr.ph:                                           ; preds = %.lr.ph88.split, %.lr.ph
  ...
  %i.ev = load <4 x float>, ptr %i.eu, align 16, !tbaa !20
  %i.ew = load <4 x float>, ptr %i.er, align 16, !tbaa !20
  %i.ex = getelementptr inbounds [4 x i8], ptr %i.er, i64 %i.es
  %i.ey = load <4 x float>, ptr %i.ex, align 16, !tbaa !20
  %i.ez = shl nuw nsw i32 %i.eq, 1
  %9 = zext nneg i32 %i.ez to i64
  %i.fa = getelementptr inbounds nuw [4 x i8], ptr %i.er, i64 %9
  ...
  %i.fl = load i32, ptr %8, align 4, !tbaa !28    ; 3 uses
  %i.fm = sext i32 %i.fl to i64
  %i.fn = icmp slt i64 %i.fk, %i.fm
  br i1 %i.fn, label %.lr.ph, label %.preheader.loopexit, !llvm.loop !122
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  store float %i.ga, ptr %i.gb, align 4, !tbaa !61
...
._crit_edge:                                      ; preds = %scalar.ph, %middle.block, %.preheader.._crit_edge_crit_edge
  ...
  %i.ge = load i32, ptr %6, align 4, !tbaa !28    ; 3 uses
  %i.gf = sext i32 %i.ge to i64
  %i.gg = icmp slt i64 %indvars.iv.next114, %i.gf
  br i1 %i.gg, label %.lr.ph88.split, label %._crit_edge89, !llvm.loop !124
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <8 x i16>, ptr %i.by, align 2, !tbaa !72
  ...
  %wide.load138 = load <8 x i16>, ptr %i.cd, align 2, !tbaa !72
  ...
  %wide.load139 = load <8 x i16>, ptr %i.cj, align 2, !tbaa !72
  ...
  %wide.load140 = load <8 x i16>, ptr %i.cp, align 2, !tbaa !72
  ...
  store <8 x i16> %i.cx, ptr %i.cy, align 2, !tbaa !72
...
bb.c:                                             ; preds = %.lr.ph, %bb.c
  ...
  %i.df = load i64, ptr %i.de, align 1, !tbaa !20
  ...
  %i.dk = load i64, ptr %i.db, align 1, !tbaa !20
  ...
  %i.dv = shl nuw nsw i32 %i.da, 1
  %9 = zext nneg i32 %i.dv to i64
  %i.dw = getelementptr inbounds nuw [2 x i8], ptr %i.db, i64 %9
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %i.ew = load i16, ptr %i.ev, align 2, !tbaa !72
  ...
  store i16 %i.fm, ptr %i.fn, align 2, !tbaa !72
