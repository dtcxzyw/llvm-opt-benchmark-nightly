...
.lr.ph:                                           ; preds = %.lr.ph88.split, %.lr.ph
  ...
  %i.fj = fadd fast <4 x float> %i.fh, %i.fi
...
.lr.ph419.i:                                      ; preds = %bb.ag, %.lr.ph419.i
  ...
  %i.fl = fadd fast <4 x float> %i.fj, %i.fk
...
.lr.ph416.i:                                      ; preds = %bb.ai, %.lr.ph416.i
  ...
  %i.hk = fadd fast <4 x float> %i.hj, %i.hh
  %i.hl = fmul fast <4 x float> %i.hc, %i.gk
  %i.hm = fadd fast <4 x float> %i.hl, %i.hi
  %i.hn = fmul fast <4 x float> %i.gx, %i.go
  %i.ho = fadd fast <4 x float> %i.hk, %i.hn
  %i.hp = fmul fast <4 x float> %i.he, %i.go
  %i.hq = fadd fast <4 x float> %i.hm, %i.hp
  %i.hr = fmul fast <4 x float> %i.gz, %i.gs
  %i.hs = fadd fast <4 x float> %i.ho, %i.hr
  %i.ht = fmul fast <4 x float> %i.hg, %i.gs
  %i.hu = fadd fast <4 x float> %i.hq, %i.ht
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.abo = fadd fast <4 x float> %i.abn, %i.abl
...
.lr.ph.i.i42:                                     ; preds = %.loopexit.i33, %.lr.ph.i.i42
  ...
  %i.ach = fadd fast <4 x float> %i.acg, %i.acf
  %i.aci = fmul fast <4 x float> %i.acc, %i.aay
  %i.acj = fadd fast <4 x float> %i.ach, %i.aci
  %i.ack = fmul fast <4 x float> %i.ace, %i.aaz
  %i.acl = fadd fast <4 x float> %i.acj, %i.ack
...
bb.c:                                             ; preds = %.lr.ph, %bb.c
  ...
  %i.ej = fadd fast <4 x float> %i.eh, %i.ei
...
.lr.ph429.i:                                      ; preds = %bb.ag, %.lr.ph429.i
  ...
  %i.fw = fadd fast <4 x float> %i.fu, %i.fv
...
.lr.ph426.i:                                      ; preds = %bb.ai, %.lr.ph426.i
  ...
  %i.jb = fadd fast <4 x float> %i.ja, %i.iy
  %i.jc = fmul fast <4 x float> %i.gv, %i.il
  %i.jd = fadd fast <4 x float> %i.jc, %i.iz
  %i.je = fmul fast <4 x float> %i.gz, %i.hu
  %i.jf = fadd fast <4 x float> %i.jb, %i.je
  %i.jg = fmul fast <4 x float> %i.gz, %i.ir
  %i.jh = fadd fast <4 x float> %i.jd, %i.jg
  %i.ji = fmul fast <4 x float> %i.hd, %i.ia
  %i.jj = fadd fast <4 x float> %i.jf, %i.ji
  %i.jk = fmul fast <4 x float> %i.hd, %i.ix
  %i.jl = fadd fast <4 x float> %i.jh, %i.jk
...
bb.al:                                            ; preds = %bb.al, %.lr.ph423.i
  ...
  %i.ln = fadd fast <4 x float> %i.ll, %i.lm
  %i.lo = fmul fast <4 x float> %i.kk, %i.li
  %i.lp = fadd fast <4 x float> %i.ln, %i.lo
  ...
  %i.mq = fadd fast <4 x float> %i.mp, %i.mo
  %i.mr = fmul fast <4 x float> %i.kg, %i.mh
  %i.ms = fadd fast <4 x float> %i.mq, %i.mr
  %i.mt = fmul fast <4 x float> %i.kk, %i.mn
  %i.mu = fadd fast <4 x float> %i.ms, %i.mt
  ...
  %i.nv = fadd fast <4 x float> %i.nu, %i.nt
  %i.nw = fmul fast <4 x float> %i.kg, %i.nm
  %i.nx = fadd fast <4 x float> %i.nv, %i.nw
  %i.ny = fmul fast <4 x float> %i.kk, %i.ns
  %i.nz = fadd fast <4 x float> %i.nx, %i.ny
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ahz = fadd fast <4 x float> %i.ahy, %i.ahw
...
.lr.ph.i.i41:                                     ; preds = %.loopexit.i32, %.lr.ph.i.i41
  ...
  %i.aiv = fadd fast <4 x float> %i.aiu, %i.ait
  %i.aiw = fmul fast <4 x float> %i.aiq, %i.ahn
  %i.aix = fadd fast <4 x float> %i.aiv, %i.aiw
  %i.aiy = fmul fast <4 x float> %i.ais, %i.aho
  %i.aiz = fadd fast <4 x float> %i.aix, %i.aiy
