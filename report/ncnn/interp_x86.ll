...
.lr.ph83:                                         ; preds = %.preheader
  ...
  %invariant.gep135 = getelementptr [4 x i8], ptr %i.cy, i64 %i.dl ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.el = getelementptr [4 x i8], ptr %invariant.gep135, i64 %i.eb
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %gep136 = getelementptr [4 x i8], ptr %invariant.gep135, i64 %indvars.iv108
